...
//! Source: drivers/platform/x86/intel/ishtp_eclite.c
#![no_std]
...
pub const ECLITE_DATA_OPREGION_ID: c_uint = 0x9E;
pub const ECLITE_CMD_OPREGION_ID: c_uint = 0x9F;
pub const ECL_MSG_DATA: c_uint = 0x1;
pub const ECL_MSG_EVENT: c_uint = 0x2;
pub const ECL_ISH_READ: c_uint = 0x1;
pub const ECL_ISH_WRITE: c_uint = 0x2;
pub const ECL_ISH_HEADER_VERSION: c_int = 0;
pub const ECL_CL_RX_RING_SIZE: c_int = 16;
pub const ECL_CL_TX_RING_SIZE: c_int = 8;
pub const ECL_DATA_OPR_BUFLEN: c_int = 384;
pub const ECL_EVENTS_NOTIFY: c_int = 333;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct opregion_cmd {
    pub command: c_uint,
    pub offset: c_uint,
    pub length: c_uint,
    pub event_id: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct opregion_data {
    pub data: [c_char; ECL_DATA_OPR_BUFLEN],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct opregion_context {
    pub cmd_area: opregion_cmd,
    pub data_area: opregion_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ecl_message_header {
    pub version:2: c_uint,
    pub data_type:2: c_uint,
    pub request_type:2: c_uint,
    pub offset:9: c_uint,
    pub data_len:9: c_uint,
    pub event:8: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ecl_message {
    pub header: ecl_message_header,
    pub payload: [c_char; ECL_DATA_OPR_BUFLEN],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ishtp_opregion_dev {
    pub opr_context: opregion_context,
    pub ecl_ishtp_cl: *mut ishtp_cl,
    pub cl_device: *mut ishtp_cl_device,
    pub fw_client: *mut ishtp_fw_client,
    pub rb: *mut ishtp_cl_rb,
    pub adev: *mut acpi_device,
    pub dsm_event_id: c_uint,
    pub ish_link_ready: c_uint,
    pub ish_read_done: c_uint,
    pub acpi_init_done: c_uint,
...
//
#[no_mangle]
unsafe extern "C" fn ecl_ish_cl_read(opr_dev: *mut ishtp_opregion_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ecl_ish_cl_write(opr_dev: *mut ishtp_opregion_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(ECL_ISH_WRITE: cmd->command ==) -> else {
    ...
    {
    struct ishtp_opregion_dev *opr_dev;
    let mut bytes: c_uint = BITS_TO_BYTES(bits);
    void *data_addr;
    if (!region_context || !value64)
    return AE_BAD_PARAMETER;
...
#[no_mangle]
unsafe extern "C" fn acpi_find_eclite_device(opr_dev: *mut ishtp_opregion_dev) -> c_int {
    static int acpi_find_eclite_device(struct ishtp_opregion_dev *opr_dev)
    {
    struct acpi_device *adev;
// Find ECLite device and save reference
    adev = acpi_dev_get_first_match_dev("INTC1035", core::ptr::null_mut(), -1);
    if (!adev) {
...
#[no_mangle]
unsafe extern "C" fn acpi_opregion_init(opr_dev: *mut ishtp_opregion_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_opregion_deinit(opr_dev: *mut ishtp_opregion_dev) {
...
#[no_mangle]
unsafe extern "C" fn ecl_acpi_invoke_dsm(work: *mut work_struct) {
    ...
    opr_dev.dsm_event_id, core::ptr::null_mut());
    if (!obj) {
...
#[no_mangle]
unsafe extern "C" fn ecl_ish_process_rx_data(opr_dev: *mut ishtp_opregion_dev) {
...
#[no_mangle]
unsafe extern "C" fn ecl_ish_process_rx_event(opr_dev: *mut ishtp_opregion_dev) {
...
#[no_mangle]
unsafe extern "C" fn ecl_ishtp_cl_event_cb(cl_device: *mut ishtp_cl_device) {
    ...
    while ((rb = ishtp_cl_rx_get_rb(opr_dev.ecl_ishtp_cl)) != core::ptr::null_mut()) {
    opr_dev.rb = rb;
    header = (struct ecl_message_header *)rb.buffer.data;
    if (header.data_type == ECL_MSG_DATA)
    ecl_ish_process_rx_data(opr_dev);
#[no_mangle]
pub unsafe extern "C" fn if(ECL_MSG_EVENT: header->data_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ecl_ishtp_cl_init(ecl_ishtp_cl: *mut ishtp_cl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecl_ishtp_cl_deinit(ecl_ishtp_cl: *mut ishtp_cl) {
...
#[no_mangle]
unsafe extern "C" fn ecl_ishtp_cl_reset_handler(work: *mut work_struct) {
    ...
    if (rv) {
    ishtp_cl_free(ecl_ishtp_cl);
    opr_dev.ecl_ishtp_cl = core::ptr::null_mut();
    dev_err(cl_data_to_dev(opr_dev),
...
#[no_mangle]
unsafe extern "C" fn ecl_ishtp_cl_probe(cl_device: *mut ishtp_cl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecl_ishtp_cl_remove(cl_device: *mut ishtp_cl_device) {
...
#[no_mangle]
unsafe extern "C" fn ecl_ishtp_cl_reset(cl_device: *mut ishtp_cl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecl_ishtp_cl_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecl_ishtp_cl_resume(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecl_ishtp_init() -> int __init {
    static int __init ecl_ishtp_init(void)
    {
    return ishtp_cl_driver_register(&ecl_ishtp_cl_driver, THIS_MODULE);
    }
#[no_mangle]
unsafe extern "C" fn ecl_ishtp_exit() -> void __exit {
