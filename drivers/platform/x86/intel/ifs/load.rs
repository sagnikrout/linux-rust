...
//! Source: drivers/platform/x86/intel/ifs/load.c
#![no_std]
...
pub const IFS_CHUNK_ALIGNMENT: c_int = 256;
    union meta_data {
    struct {
...
pub const META_TYPE_IFS: c_int = 1;
pub const INVALIDATE_STRIDE: c_uint = 0x1UL;
pub const IFS_GEN_STRIDE_AWARE: c_int = 2;
pub const AUTH_INTERRUPTED_ERROR: c_int = 5;
pub const IFS_AUTH_RETRY_CT: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn hashcopy_err_message(dev: *mut device, err_code: u32) {
...
#[no_mangle]
unsafe extern "C" fn auth_err_message(dev: *mut device, err_code: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn copy_hashes_authenticate_chunks(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn get_num_chunks(gen: c_int, status: union ifs_scan_hashes_status_gen2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn need_copy_scan_hashes(ifsd: *mut ifs_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn copy_hashes_authenticate_chunks_gen2(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_ifs_metadata(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn scan_chunks_sanity_check(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn image_sanity_check(dev: *mut device, data: *const microcode_header_intel) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ifs_load_firmware(dev: *mut device) -> c_int {
