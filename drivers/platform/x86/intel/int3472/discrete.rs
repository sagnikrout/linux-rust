...
//! Source: drivers/platform/x86/intel/int3472/discrete.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn skl_int3472_log_sensor_module_name(int3472: *mut int3472_discrete_device) {
    static void skl_int3472_log_sensor_module_name(struct int3472_discrete_device *int3472)
    {
    union acpi_object *obj;
    obj = acpi_evaluate_dsm_typed(int3472.sensor.handle,
    &cio2_sensor_module_guid, 0x00,
    0x01, core::ptr::null_mut(), ACPI_TYPE_STRING);
    if (obj) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct int3472_gpio_map {
    pub hids: *const *const c_char,
    pub type_from: u8,
    pub type_to: u8,
    pub polarity_low: bool,
    pub enable_time_us: c_uint,
    ...
    .hids = (const char * const[]) { "OVTI08F4", core::ptr::null_mut() },
    ...
    if (acpi_dev_hid_uid_match(adev, hids[i], core::ptr::null_mut()))
    return true;
    }
    return false;
    }
...
//
    ...
    const char *second_sensor = core::ptr::null_mut();
    struct acpi_resource_gpio *agpio;
    unsigned int enable_time_us;
...
#[no_mangle]
pub unsafe extern "C" fn int3472_discrete_parse_crs(int3472: *mut int3472_discrete_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn int3472_discrete_cleanup(int3472: *mut int3472_discrete_device) {
...
#[no_mangle]
unsafe extern "C" fn skl_int3472_discrete_remove(pdev: *mut platform_device) {
    static void skl_int3472_discrete_remove(struct platform_device *pdev)
    {
    int3472_discrete_cleanup(platform_get_drvdata(pdev));
    }
#[no_mangle]
unsafe extern "C" fn skl_int3472_discrete_probe(pdev: *mut platform_device) -> c_int {
    static int skl_int3472_discrete_probe(struct platform_device *pdev)
    {
    struct acpi_device *adev = ACPI_COMPANION(&pdev.dev);
    const struct int3472_discrete_quirks *quirks = core::ptr::null_mut();
