...
//! Source: drivers/platform/x86/intel/pmt/discovery.c
#![no_std]
...
pub const MAX_FEATURE_VERSION: c_int = 0;

pub const PMT_ACCESS_TYPE_RSVD: c_uint = 0xF;
pub const SKIP_FEATURE: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct feature_discovery_table {
    pub access_type:4: u32,
    pub version:8: u32,
    pub size:16: u32,
    pub reserved:4: u32,
    pub id: u32,
...
#[derive(Copy, Clone)]
pub struct command {
    pub max_stream_size:16: u32,
    pub max_command_size:16: u32,
}
...
#[derive(Copy, Clone)]
pub struct rmid {
    pub /: *mut *mut u32 num_rmids:16; / Number of Resource Monitoring IDs,
    pub reserved:16: u32,
    pub watcher: watcher,
}
...
#[derive(Copy, Clone)]
pub struct feature {
    pub table: feature_table,
    pub kobj: kobject,
    pub priv: *mut pmt_features_priv,
    pub list: list_head,
    pub attr_group: *const attribute_group,
    pub id: enum pmt_feature_id,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmt_features_priv {
...
#[no_mangle]
unsafe extern "C" fn pmt_feature_release(kobj: *mut kobject) {
    ...
    let mut caps: u32 = feature.table.caps.caps;
    let mut ret: isize = 0;
    switch (feature.id) {
    ...
    let mut caps_attribute: static struct kobj_attribute = __ATTR_RO(caps);
    ...
    let mut num_rmids_attribute: static struct kobj_attribute = __ATTR_RO(num_rmids);
    ...
    let mut guids_attribute: static struct kobj_attribute = __ATTR_RO(guids);
...
#[no_mangle]
unsafe extern "C" fn pmt_features_add_feat(feature: *mut feature) {
...
#[no_mangle]
unsafe extern "C" fn pmt_features_remove_feat(feature: *mut feature) {
...
#[no_mangle]
unsafe extern "C" fn pmt_features_remove(auxdev: *mut auxiliary_device) {
...
#[no_mangle]
unsafe extern "C" fn pmt_features_probe(auxdev: *mut auxiliary_device, id: *const auxiliary_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmt_get_features(entry: *mut intel_pmt_entry, f: *mut feature) {
    static void pmt_get_features(struct intel_pmt_entry *entry, struct feature *f)
    {
    let mut num_guids: c_int = f.table.header.num_guids;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmt_get_features(entry: *mut intel_pmt_entry) {
