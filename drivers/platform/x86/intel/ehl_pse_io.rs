...
//! Source: drivers/platform/x86/intel/ehl_pse_io.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ehl_pse_io_dev_create(pci: *mut pci_dev, name: *const c_char, idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ehl_pse_io_probe(pci: *mut pci_dev, id: *const pci_device_id) -> c_int {
