...
//! Source: drivers/platform/x86/dell/dell-wmi-sysman/int-attributes.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn alloc_int_data() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn exit_int_attributes() {
    ...
    wmi_priv.integer_data = core::ptr::null_mut();
    }
