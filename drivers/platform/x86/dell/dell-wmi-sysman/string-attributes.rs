...
//! Source: drivers/platform/x86/dell/dell-wmi-sysman/string-attributes.c
#![no_std]
...
unsafe extern "C" fn current_value_show(kobj: *mut kobject, attr: *mut kobj_attribute, buf: *mut c_char) -> isize {
    ...
    {
    let mut instance_id: c_int = get_str_instance_id(kobj);
...
//
#[no_mangle]
unsafe extern "C" fn validate_str_input(instance_id: c_int, buf: *const c_char) -> c_int {
    static int validate_str_input(int instance_id, const char *buf)
    {
    let mut in_len: c_int = strlen(buf);
...
#[no_mangle]
pub unsafe extern "C" fn alloc_str_data() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn populate_str_data(str_obj: *mut union acpi_object, instance_id: c_int, attr_name_kobj: *mut kobject) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn exit_str_attributes() {
    ...
    wmi_priv.str_data = core::ptr::null_mut();
    }
