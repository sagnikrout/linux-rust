...
//! Source: drivers/platform/x86/dell/dell-smbios-base.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct token_sysfs_data {
    pub location_attr: device_attribute,
    pub value_attr: device_attribute,
    pub token: *mut calling_interface_token,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct smbios_device {
    pub list: list_head,
    pub device: *mut device,
    pub priority: c_int,
    pub call_fn: smbios_callback_fn_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct smbios_call {
    pub need_capability: u32,
    pub cmd_class: c_int,
    pub cmd_select: c_int,
}
...
#[no_mangle]
pub unsafe extern "C" fn dell_smbios_error(value: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dell_smbios_register_device(d: *mut device, priority: c_int, call_fn: smbios_callback_fn_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dell_smbios_unregister_device(d: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn dell_smbios_call(buffer: *mut calling_interface_buffer) -> c_int {
    int dell_smbios_call(struct calling_interface_buffer *buffer)
    {
    struct smbios_device *selected = core::ptr::null_mut();
    struct smbios_device *priv;
    int ret;
    mutex_lock(&smbios_mutex);
    list_for_each_entry(priv, &smbios_device_list, list) {
...
#[no_mangle]
pub unsafe extern "C" fn dell_laptop_register_notifier(nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dell_laptop_unregister_notifier(nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dell_laptop_call_notifier(action: c_ulong, data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn dell_smbios_class_is_supported(class: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn parse_da_table(dm: *const dmi_header) -> void __init {
    static void __init parse_da_table(const struct dmi_header *dm)
    {
// Final token is a terminator, so we don't want to copy it
    let mut tokens: c_int = (dm.length-11)/sizeof(struct calling_interface_token)-1;
...
#[no_mangle]
unsafe extern "C" fn zero_duplicates(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn build_tokens_sysfs(dev: *mut platform_device) -> c_int {
...
// add location
    ...
    da_tokens[i].tokenID);
    if (location_name == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn free_group(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dell_smbios_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dell_smbios_exit() -> void __exit {
