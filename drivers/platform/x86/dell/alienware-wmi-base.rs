...
//! Source: drivers/platform/x86/dell/alienware-wmi-base.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn parse_rgb(buf: *const c_char, colors: *mut color_platform) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(LEGACY_SUSPEND: priv->lighting_control_state ==) -> else {
    ...
    val = LEGACY_BOOTING;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(buf, 0: "suspend\n") ==) -> else {
    else if (strcmp(buf, "suspend\n") == 0)
    val = LEGACY_SUSPEND;
#[no_mangle]
pub unsafe extern "C" fn if(LEGACY: alienware_interface ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn zone_group_visible(kobj: *mut kobject) -> bool {
...
#[no_mangle]
unsafe extern "C" fn global_led_get(led_cdev: *mut led_classdev) -> enum led_brightness {
...
//
#[no_mangle]
unsafe extern "C" fn alienfx_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alienware_alienfx_remove(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn alienware_alienfx_setup(pdata: *mut alienfx_platdata) -> c_int {
    int alienware_alienfx_setup(struct alienfx_platdata *pdata)
    {
    struct device *dev = &pdata.wdev.dev;
    struct platform_device *pdev;
    int ret;
    pdev = platform_device_register_data(core::ptr::null_mut(), "alienware-wmi",
...
#[no_mangle]
unsafe extern "C" fn alienware_wmi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn alienware_wmi_exit() -> void __exit {
