...
//! Source: drivers/platform/x86/dell/dell-pc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn thermal_get_mode() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(DELL_COOL_BOTTOM: state &) -> else {
    else if (state & DELL_COOL_BOTTOM)
    return DELL_COOL_BOTTOM;
#[no_mangle]
pub unsafe extern "C" fn if(DELL_QUIET: state &) -> else {
    else if (state & DELL_QUIET)
    return DELL_QUIET;
#[no_mangle]
pub unsafe extern "C" fn if(DELL_PERFORMANCE: state &) -> else {
...
#[no_mangle]
unsafe extern "C" fn thermal_get_supported_modes(supported_bits: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thermal_get_acc_mode(acc_mode: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thermal_set_mode(state: enum thermal_mode_bits) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thermal_platform_profile_probe(drvdata: *mut c_void, choices: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_pc_faux_probe(fdev: *mut faux_device) -> c_int {
    ...
    if (ret < 0)
    return ret;
    ppdev = devm_platform_profile_register(&fdev.dev, "dell-pc", core::ptr::null_mut(),
...
unsafe extern "C" fn dell_init() -> int __init {
    ...
    return -ENODEV;
    dell_pc_fdev = faux_device_create("dell-pc", core::ptr::null_mut(), &dell_pc_faux_ops);
    if (!dell_pc_fdev)
    return -ENODEV;
    return 0;
    }
