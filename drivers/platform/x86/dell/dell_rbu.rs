...
//! Source: drivers/platform/x86/dell/dell_rbu.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
    MODULE_VERSION("3.3");
pub const BIOS_SCAN_LIMIT: c_uint = 0xffffffff;
pub const MAX_IMAGE_LENGTH: c_int = 16;
    ...
    let mut allocation_floor: static unsigned long = 0x100000;
...
pub struct packet_data {
    ...
    static int context;
#[no_mangle]
unsafe extern "C" fn init_packet_head() {
...
#[no_mangle]
unsafe extern "C" fn create_packet(data: *mut c_void, __must_hold(&rbu_data.lock: size_t length)) -> c_int {
    static int create_packet(void *data, size_t length) __must_hold(&rbu_data.lock)
    {
    struct packet_data *newpacket;
    let mut ordernum: c_int = 0;
    let mut retval: c_int = 0;
    let mut packet_array_size: c_uint = 0;
    void **invalid_addr_packet_array = core::ptr::null_mut();
    void *packet_data_temp_buf = core::ptr::null_mut();
...
//
    ...
    packet_data_temp_buf = core::ptr::null_mut();
    }
    }
//
...
#[no_mangle]
unsafe extern "C" fn packetize_data(data: *const u8, length: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn packet_read_list(data: *mut c_char, pread_length: *mut usize) -> c_int {
    static int packet_read_list(char *data, size_t *pread_length)
    {
    struct packet_data *newpacket;
    let mut temp_count: c_int = 0;
    let mut bytes_copied: c_int = 0;
    let mut bytes_read: c_int = 0;
    let mut remaining_bytes: c_int = 0;
    char *pdest = data;
...
#[no_mangle]
unsafe extern "C" fn packet_empty_list() {
...
//
#[no_mangle]
unsafe extern "C" fn img_update_free() {
...
//
    ...
    rbu_data.image_update_buffer = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn img_update_realloc(size: c_ulong) -> c_int {
    static int img_update_realloc(unsigned long size)
    {
    unsigned char *image_update_buffer = core::ptr::null_mut();
...
//
    if ((size != 0) && (rbu_data.image_update_buffer == core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn read_packet_data(buffer: *mut c_char, pos: loff_t, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn read_rbu_mono_data(buffer: *mut c_char, pos: loff_t, count: usize) -> isize {
    static ssize_t read_rbu_mono_data(char *buffer, loff_t pos, size_t count)
    {
// check to see if we have something to return
    if ((rbu_data.image_update_buffer == core::ptr::null_mut()) ||
    (rbu_data.bios_image_size == 0)) {
    ...
    {
    let mut ret_count: isize = 0;
    spin_lock(&rbu_data.lock);
    if (!strcmp(image_type, "mono"))
    ret_count = read_rbu_mono_data(buffer, pos, count);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(image_type, _arg: "packet")) -> else {
...
#[no_mangle]
unsafe extern "C" fn callbackfn_rbu(fw: *const firmware, context: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strstr(buffer, _arg: "packet")) -> else {
    else if (strstr(buffer, "packet"))
    strscpy(image_type, "packet");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strstr(buffer, _arg: "init")) -> else {
//
...
#[no_mangle]
unsafe extern "C" fn dcdrbu_init() -> int __init {
    static int __init dcdrbu_init(void)
    {
    int rc;
    spin_lock_init(&rbu_data.lock);
    init_packet_head();
    rbu_device = platform_device_register_simple("dell_rbu", PLATFORM_DEVID_NONE, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn dcdrbu_exit() -> __exit void {
