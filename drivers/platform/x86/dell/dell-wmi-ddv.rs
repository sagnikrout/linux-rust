...
//! Source: drivers/platform/x86/dell/dell-wmi-ddv.c
#![no_std]
...
pub const DELL_DDV_SUPPORTED_VERSION_MIN: c_int = 2;
pub const DELL_DDV_SUPPORTED_VERSION_MAX: c_int = 3;

// Battery indices 1, 2 and 3
pub const DELL_DDV_NUM_BATTERIES: c_int = 3;

pub const MA_FAILURE_MODE_PERMANENT: c_uint = 0x9;
pub const MA_FAILURE_MODE_OVERHEAT: c_uint = 0xA;
pub const MA_FAILURE_MODE_OVERCURRENT: c_uint = 0xB;

pub const MA_PERMANENT_FAILURE_FUSE_BLOWN: c_uint = 0x0;
pub const MA_PERMANENT_FAILURE_CELL_IMBALANCE: c_uint = 0x1;
pub const MA_PERMANENT_FAILURE_OVERVOLTAGE: c_uint = 0x2;
pub const MA_PERMANENT_FAILURE_FET_FAILURE: c_uint = 0x3;

pub const MA_OVERHEAT_FAILURE_START: c_uint = 0x5;
pub const MA_OVERHEAT_FAILURE_CHARGING: c_uint = 0x7;
pub const MA_OVERHEAT_FAILURE_DISCHARGING: c_uint = 0x8;

pub const MA_OVERCURRENT_FAILURE_CHARGING: c_uint = 0x6;
pub const MA_OVERCURRENT_FAILURE_DISCHARGING: c_uint = 0xB;
pub const DELL_EPPID_LENGTH: c_int = 20;
pub const DELL_EPPID_EXT_LENGTH: c_int = 23;
    static bool force;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dell_wmi_buffer {
    pub raw_size: __le32,
    pub raw_data: [u8; ],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fan_sensor_entry {
    pub type: u8,
    pub rpm: __le16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct thermal_sensor_entry {
    pub type: u8,
    pub now: i8,
    pub min: i8,
    pub max: i8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct combined_channel_info {
    pub info: hwmon_channel_info,
    pub config: [u32; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct combined_chip_info {
    pub chip: hwmon_chip_info,
    pub info: [*const hwmon_channel_info; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dell_wmi_ddv_sensors {
    pub active: bool,
    pub /: *mut *mut mutex lock; / protect caching,
    pub timestamp: c_ulong,
    pub buffer: *mut dell_wmi_buffer,
    pub entries: u64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dell_wmi_ddv_data {
    pub hook: acpi_battery_hook,
    pub eppid_attr: device_attribute,
    pub /: *mut *mut mutex translation_cache_lock; / Protects the translation cache,
    pub translation_cache: [*mut power_supply; DELL_DDV_NUM_BATTERIES],
    pub fans: dell_wmi_ddv_sensors,
    pub temps: dell_wmi_ddv_sensors,
    ...
    {
    let mut arg2: __le32 = cpu_to_le32(arg);
...
//
    ...
    sensors.buffer = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_ddv_hwmon_cache_invalidate(sensors: *mut dell_wmi_ddv_sensors) {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_ddv_hwmon_cache_destroy(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_ddv_hwmon_add(data: *mut dell_wmi_ddv_data) -> c_int {
...
// index = i + 1;
    ...
    for (int i = 0; i < ARRAY_SIZE(data.translation_cache); i++) {
    if (data.translation_cache[i] == battery) {
    data.translation_cache[i] = core::ptr::null_mut();
    return;
    }
    }
    }
#[no_mangle]
unsafe extern "C" fn eppid_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_ddv_add_battery(battery: *mut power_supply, hook: *mut acpi_battery_hook) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_ddv_remove_battery(battery: *mut power_supply, hook: *mut acpi_battery_hook) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_ddv_battery_add(data: *mut dell_wmi_ddv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_ddv_buffer_read(seq: *mut seq_file, method: enum dell_ddv_method) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_ddv_fan_read(seq: *mut seq_file, offset: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_ddv_temp_read(seq: *mut seq_file, offset: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_ddv_debugfs_remove(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_ddv_debugfs_init(wdev: *mut wmi_device) {
    ...
    entry = debugfs_create_dir(name, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_ddv_probe(wdev: *mut wmi_device, context: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_ddv_resume(dev: *mut device) -> c_int {
...
// Force re-reading of all active sensors
    ...
    static DEFINE_SIMPLE_DEV_PM_OPS(dell_wmi_ddv_dev_pm_ops, core::ptr::null_mut(), dell_wmi_ddv_resume);
    static const struct wmi_device_id dell_wmi_ddv_id_table[] = {
    { DELL_DDV_GUID, core::ptr::null_mut() },
    { }
    };
