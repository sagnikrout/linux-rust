...
//! Source: drivers/platform/x86/dell/dell-laptop.c
#![no_std]
...
pub struct quirk_entry {
    pub touchpad_led: bool,
    pub kbd_led_not_present: bool,
    pub kbd_led_levels_off_1: bool,
    pub kbd_missing_ac_tag: bool,
    pub needs_kbd_timeouts: bool,
//
// Ordered list of timeouts expressed in seconds.
// The list must end with -1
//
    pub kbd_timeouts: [c_int; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct battery_mode_info {
    pub token: c_int,
    pub charge_type: enum power_supply_charge_type,
}
...
//
#[no_mangle]
unsafe extern "C" fn dell_rfkill_set(data: *mut c_void, blocked: bool) -> c_int {
    static int dell_rfkill_set(void *data, bool blocked)
    {
    let mut disable: c_int = blocked ? 1 : 0;
    let mut radio: c_ulong = (unsigned long)data;
    let mut hwswitch_bit: c_int = (unsigned long)data - 1;
...
// Has hw-switch, sync sw_state to BIOS
    struct calling_interface_buffer buffer;
    let mut block: c_int = rfkill_blocked(rfkill);
...
#[no_mangle]
unsafe extern "C" fn dell_rfkill_query(rfkill: *mut rfkill, data: *mut c_void) {
    static void dell_rfkill_query(struct rfkill *rfkill, void *data)
    {
    let mut radio: c_int = ((unsigned long)data & 0xF);
    struct calling_interface_buffer buffer;
    int hwswitch;
    int status;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn dell_debugfs_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_update_rfkill(ignored: *mut work_struct) {
    static void dell_update_rfkill(struct work_struct *ignored)
    {
    struct calling_interface_buffer buffer;
    let mut hwswitch: c_int = 0;
    int status;
    int ret;
    dell_fill_request(&buffer, 0, 0, 0, 0);
    ret = dell_send_request(&buffer, CLASS_INFO, SELECT_RFKILL);
...
#[no_mangle]
unsafe extern "C" fn dell_setup_rfkill() -> int __init {
...
//
    ...
    dell_rbtn_notifier_register_func = core::ptr::null_mut();
    }
    }
    if (dell_rbtn_notifier_register_func) {
    ...
    dell_rbtn_notifier_unregister_func = core::ptr::null_mut();
    }
    } else {
    ...
    ret = i8042_install_filter(dell_laptop_i8042_filter, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn dell_cleanup_rfkill() {
...
#[no_mangle]
unsafe extern "C" fn dell_send_intensity(bd: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_get_intensity(bd: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn touchpad_led_on() {
    static void touchpad_led_on(void)
    {
    let mut command: c_int = 0x97;
    let mut data: c_char = 1;
    i8042_command(&data, command | 1 << 12);
    }
#[no_mangle]
unsafe extern "C" fn touchpad_led_off() {
    static void touchpad_led_off(void)
    {
    let mut command: c_int = 0x97;
    let mut data: c_char = 2;
    i8042_command(&data, command | 1 << 12);
    }
...
#[no_mangle]
unsafe extern "C" fn touchpad_led_init(dev: *mut device) -> int __init {
    static int __init touchpad_led_init(struct device *dev)
    {
    return led_classdev_register(dev, &touchpad_led);
    }
#[no_mangle]
unsafe extern "C" fn touchpad_led_exit() {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kbd_state {
    pub mode_bit: u8,
    pub triggers: u8,
    pub timeout_value: u8,
    pub timeout_unit: u8,
    pub timeout_value_ac: u8,
    pub timeout_unit_ac: u8,
    pub als_setting: u8,
    pub als_value: u8,
    pub level: u8,
}
...
//
#[no_mangle]
unsafe extern "C" fn kbd_get_info(info: *mut kbd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbd_get_max_level() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn kbd_get_level(state: *mut kbd_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbd_set_level(state: *mut kbd_state, level: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(KBD_MODE_BIT_OFF: level == 0 && state->mode_bit !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn kbd_get_state(state: *mut kbd_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbd_set_state(state: *mut kbd_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbd_set_state_safe(state: *mut kbd_state, old: *mut kbd_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbd_set_token_bit(bit: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbd_get_token_bit(bit: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbd_get_first_active_token_bit() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbd_get_valid_token_counts() -> c_int {
    static int kbd_get_valid_token_counts(void)
    {
    return hweight16(kbd_token_bits);
    }
#[no_mangle]
pub unsafe extern "C" fn kbd_init_info() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kbd_init_tokens() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn kbd_init() -> void __init {
...
// "trackstick"*/ NULL, /* NOTE: trackstick is just alias for touchpad
    ...
    struct kbd_state new_state;
    struct kbd_state state;
    let mut triggers_enabled: bool = false;
    let mut trigger_bit: c_int = -1;
    char trigger[21];
    int i, ret;
...
#[no_mangle]
unsafe extern "C" fn kbd_led_level_get(led_cdev: *mut led_classdev) -> enum led_brightness {
    ...
    enum led_brightness value)
    {
    let mut new_value: enum led_brightness = value;
    struct kbd_state state;
    struct kbd_state new_state;
    u16 num;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn kbd_led_init(dev: *mut device) -> int __init {
    ...
    kbd_led_groups[1] = core::ptr::null_mut();
    ...
    kbd_led_level = kbd_led_level_get(core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn kbd_led_exit() {
...
#[no_mangle]
unsafe extern "C" fn dell_battery_set_mode(tokenid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_battery_read(tokenid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_battery_mode_is_active(tokenid: u16) -> bool {
...
//
pub const CHARGE_START_MIN: c_int = 50;
pub const CHARGE_START_MAX: c_int = 95;
pub const CHARGE_END_MIN: c_int = 55;
pub const CHARGE_END_MAX: c_int = 100;
pub const CHARGE_MIN_DIFF: c_int = 5;
#[no_mangle]
unsafe extern "C" fn dell_battery_set_custom_charge_start(start: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_battery_set_custom_charge_end(end: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_battery_supported(battery: *mut power_supply) -> bool {
...
#[no_mangle]
unsafe extern "C" fn battery_get_supported_modes() -> u32 __init {
...
#[no_mangle]
unsafe extern "C" fn dell_battery_init(dev: *mut device) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn dell_battery_exit() {
...
#[no_mangle]
unsafe extern "C" fn dell_init() -> int __init {
    static int __init dell_init(void)
    {
    struct calling_interface_buffer buffer;
    let mut max_intensity: c_int = 0;
    int ret;
...
// find if this machine support other functions
    ...
    dell_laptop_dir = debugfs_create_dir("dell_laptop", core::ptr::null_mut());
    debugfs_create_file("rfkill", 0444, dell_laptop_dir, core::ptr::null_mut(),
    &dell_debugfs_fops);
    ...
    dell_backlight_device = core::ptr::null_mut();
    goto fail_backlight;
    }
...
#[no_mangle]
unsafe extern "C" fn dell_exit() -> void __exit {
