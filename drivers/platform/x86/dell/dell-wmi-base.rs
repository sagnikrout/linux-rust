...
//! Source: drivers/platform/x86/dell/dell-wmi-base.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dell_wmi_priv {
    pub input_dev: *mut input_dev,
    pub tabletswitch_dev: *mut input_dev,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dell_bios_keymap_entry {
    pub scancode: u16,
    pub keycode: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dell_bios_hotkey_table {
    pub header: dmi_header,
    pub keymap: [dell_bios_keymap_entry; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dell_dmi_results {
    pub err: c_int,
    pub keymap_size: c_int,
...
// Don't report brightness notifications that will also come via ACPI
    ...
    DELL_LAPTOP_KBD_BACKLIGHT_BRIGHTNESS_CHANGED, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_notify(wdev: *mut wmi_device, buffer: *const wmi_buffer) {
...
#[no_mangle]
unsafe extern "C" fn have_scancode(scancode: u32, keymap: *const key_entry, len: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn handle_dmi_entry(dm: *const dmi_header, opaque: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_input_setup(wdev: *mut wmi_device) -> c_int {
    static int dell_wmi_input_setup(struct wmi_device *wdev)
    {
    struct dell_wmi_priv *priv = dev_get_drvdata(&wdev.dev);
    let mut dmi_results: dell_dmi_results = {};
    struct key_entry *keymap;
    int err, i, pos = 0;
...
//
    ...
    err = sparse_keymap_setup(priv.input_dev, keymap, core::ptr::null_mut());
//
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_input_destroy(wdev: *mut wmi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn dell_wmi_events_set_enabled(enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_probe(wdev: *mut wmi_device, context: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_remove(wdev: *mut wmi_device) {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dell_wmi_exit() -> void __exit {
