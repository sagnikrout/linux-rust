...
//! Source: drivers/platform/x86/x86-android-tablets/other.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn chuwi_hi8_init(dev: *mut device) -> int __init {
...
// BIOS is used.
//
    if (acpi_dev_present("MSSL0001", core::ptr::null_mut(), 1))
    return -ENODEV;
    return 0;
    }
...
pub const CZC_EC_EXTRA_PORT: c_uint = 0x68;
pub const CZC_EC_ANDROID_KEYS: c_uint = 0x63;
#[no_mangle]
unsafe extern "C" fn czc_p10t_init(dev: *mut device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vexia_edu_atla10_9v_init(dev: *mut device) -> int __init {
...
// Enable the Wifi module by setting the wifi_enable pin to 1
    ...
    false, GPIOD_OUT_HIGH, core::ptr::null_mut());
    if (ret)
    return ret;
...
//
pub const XIAOMI_MIPAD2_LED_PERIOD_NS: c_int = 19200;
...
#[no_mangle]
unsafe extern "C" fn xiaomi_mipad2_init(dev: *mut device) -> int __init {
