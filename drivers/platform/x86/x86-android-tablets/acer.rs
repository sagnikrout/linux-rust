...
//! Source: drivers/platform/x86/x86-android-tablets/acer.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn acer_a1_840_init(dev: *mut device) -> int __init {
    static int __init acer_a1_840_init(struct device *dev)
    {
    int ret;
    acer_a1_840_fg_dev = bus_find_device_by_name(&platform_bus_type, core::ptr::null_mut(), "chtdc_ti_battery");
    if (!acer_a1_840_fg_dev)
    return dev_err_probe(dev, -EPROBE_DEFER, "getting chtdc_ti_battery dev\n");
    acer_a1_840_fg_node = fwnode_create_software_node(acer_a1_840_fg_props, core::ptr::null_mut());
    ...
    acer_a1_840_fg_node = core::ptr::null_mut();
    put_device(acer_a1_840_fg_dev);
    acer_a1_840_fg_dev = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn acer_a1_840_exit() {
