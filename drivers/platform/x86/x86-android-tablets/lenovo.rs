...
//! Source: drivers/platform/x86/x86-android-tablets/lenovo.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lenovo_yb1_x90_init(dev: *mut device) -> int __init {
...
// This gets filled by lenovo_yoga_tab2_830_1050_init()
    let mut lenovo_yoga_tab2_830_1050_rmi_pdata: static struct rmi_device_platform_data = { };
...
#[no_mangle]
unsafe extern "C" fn lenovo_yoga_tab2_830_1050_init_touchscreen() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn lenovo_yoga_tab2_830_1050_init_codec() -> int __init {
    static int __init lenovo_yoga_tab2_830_1050_init_codec(void)
    {
    struct device *codec_dev;
    struct pinctrl *pinctrl;
    int ret;
    codec_dev = bus_find_device_by_name(&spi_bus_type, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn lenovo_yoga_tab2_830_1050_power_off(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lenovo_yoga_tab2_830_1050_init(dev: *mut device) -> int __init {
    static int __init lenovo_yoga_tab2_830_1050_init(struct device *dev)
    {
    int ret;
...
// SYS_OFF_PRIO_FIRMWARE + 1 so that it runs before acpi_power_off()
    ...
    lenovo_yoga_tab2_830_1050_power_off, core::ptr::null_mut());
    if (IS_ERR(lenovo_yoga_tab2_830_1050_sys_off_handler))
    return PTR_ERR(lenovo_yoga_tab2_830_1050_sys_off_handler);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn lenovo_yoga_tab2_830_1050_exit() {
    static void lenovo_yoga_tab2_830_1050_exit(void)
    {
...
#[no_mangle]
unsafe extern "C" fn lenovo_yoga_tab2_1380_init(dev: *mut device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn lenovo_yt3_init(dev: *mut device) -> int __init {
...
// /CE pin
    ...
    true, GPIOD_OUT_HIGH, core::ptr::null_mut());
    if (ret < 0)
    return ret;
// OTG pin
    ret = x86_android_tablet_get_gpiod("INT33FF:03", 19, "bq25892_0_otg",
    false, GPIOD_OUT_LOW, core::ptr::null_mut());
    if (ret < 0)
    return ret;
