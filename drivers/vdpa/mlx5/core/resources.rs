...
//! Source: drivers/vdpa/mlx5/core/resources.c
#![no_std]
...
// Copyright (c) 2020 Mellanox Technologies Ltd.
    ...
    let mut mlx5_vdpa_max_iotlb_entries: c_int = 2048;
    module_param_named(max_iotlb_entries, mlx5_vdpa_max_iotlb_entries, int, 0444);
    MODULE_PARM_DESC(max_iotlb_entries,
    "Maximum number of iotlb entries. (default: 2048)");
#[no_mangle]
unsafe extern "C" fn alloc_pd(dev: *mut mlx5_vdpa_dev, pdn: *mut u32, uid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dealloc_pd(dev: *mut mlx5_vdpa_dev, pdn: u32, uid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_null_mkey(dev: *mut mlx5_vdpa_dev, null_mkey: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_uctx(mvdev: *mut mlx5_vdpa_dev, uid: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn destroy_uctx(mvdev: *mut mlx5_vdpa_dev, uid: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_vdpa_create_tis(mvdev: *mut mlx5_vdpa_dev, in: *mut c_void, tisn: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_vdpa_destroy_tis(mvdev: *mut mlx5_vdpa_dev, tisn: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_vdpa_create_rqt(mvdev: *mut mlx5_vdpa_dev, in: *mut c_void, inlen: c_int, rqtn: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_vdpa_modify_rqt(mvdev: *mut mlx5_vdpa_dev, in: *mut c_void, inlen: c_int, rqtn: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_vdpa_destroy_rqt(mvdev: *mut mlx5_vdpa_dev, rqtn: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_vdpa_create_tir(mvdev: *mut mlx5_vdpa_dev, in: *mut c_void, tirn: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_vdpa_destroy_tir(mvdev: *mut mlx5_vdpa_dev, tirn: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_vdpa_alloc_transport_domain(mvdev: *mut mlx5_vdpa_dev, tdn: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_vdpa_dealloc_transport_domain(mvdev: *mut mlx5_vdpa_dev, tdn: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_vdpa_destroy_mkey(mvdev: *mut mlx5_vdpa_dev, mkey: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_ctrl_vq(mvdev: *mut mlx5_vdpa_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cleanup_ctrl_vq(mvdev: *mut mlx5_vdpa_dev) {
    static void cleanup_ctrl_vq(struct mlx5_vdpa_dev *mvdev)
    {
    vhost_iotlb_free(mvdev.cvq.iotlb);
    }
#[no_mangle]
pub unsafe extern "C" fn mlx5_vdpa_alloc_resources(mvdev: *mut mlx5_vdpa_dev) -> c_int {
    int mlx5_vdpa_alloc_resources(struct mlx5_vdpa_dev *mvdev)
    {
    let mut offset: u64 = MLX5_CAP64_DEV_VDPA_EMULATION(mvdev.mdev, doorbell_bar_offset);
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_vdpa_free_resources(mvdev: *mut mlx5_vdpa_dev) {
    ...
    iounmap(res.kick_addr);
    res.kick_addr = core::ptr::null_mut();
    dealloc_pd(mvdev, res.pdn, res.uid);
    destroy_uctx(mvdev, res.uid);
...
#[no_mangle]
unsafe extern "C" fn virtqueue_cmd_callback(status: c_int, context: *mut mlx5_async_work) {
