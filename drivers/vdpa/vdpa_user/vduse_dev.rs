...
pub const VDUSE_DEV_MAX_GROUPS: c_uint = 0xffff;
pub const VDUSE_DEV_MAX_AS: c_uint = 0xffff;

// 128 MB reserved for virtqueue creation

pub const VDUSE_MSG_DEFAULT_TIMEOUT: c_int = 30;
...
pub struct vduse_virtqueue {
    ...
    pub driver_addr: u64,
    pub device_addr: u64,
    pub state: vdpa_vq_state,
    pub ready: bool,
    pub kicked: bool,
    pub group: u32,
    pub kick_lock: spinlock_t,
    pub irq_lock: spinlock_t,
    pub ready_lock: spinlock_t,
    pub kickfd: *mut eventfd_ctx,
    pub cb: vdpa_callback,
    pub inject: work_struct,
    pub kick: work_struct,
    pub irq_effective_cpu: c_int,
    pub irq_affinity: cpumask,
    pub kobj: kobject,
    pub dev: *mut vduse_dev,
}

    struct vduse_dev;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vduse_vdpa {
...
#[derive(Copy, Clone)]
pub struct vduse_as {
    pub domain: *mut vduse_iova_domain,
    pub umem: *mut vduse_umem,
    pub mem_lock: mutex,
}
...
pub struct vduse_vq_group {
    pub as_lock: rwlock_t,
    pub /: *mut *mut *mut vduse_as as; / Protected by as_lock,
    pub dev: *mut vduse_dev,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vduse_dev {
    pub vdev: *mut vduse_vdpa,
    pub dev: *mut device,
    pub vqs: *mut vduse_virtqueue,
    pub as: *mut vduse_as,
    pub name: *mut c_char,
    pub lock: mutex,
    pub msg_lock: spinlock_t,
    pub vduse_features: u64,
    pub msg_unique: u64,
    pub msg_timeout: u32,
    ...
    pub ngroups: u32,
    pub nas: u32,
    pub groups: *mut vduse_vq_group,
    pub bounce_size: c_uint,
    pub domain_lock: mutex,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vduse_dev_msg {
    pub req: vduse_dev_request,
    pub resp: vduse_dev_response,
    pub list: list_head,
    pub waitq: wait_queue_head_t,
    pub completed: bool,
}
...
pub struct vduse_control {
    ...
    {
    struct vduse_dev_msg *msg = core::ptr::null_mut();
    if (!list_empty(head)) {
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_broken(dev: *mut vduse_dev) {
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_set_status(dev: *mut vduse_dev, status: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
    ...
    let mut size: c_int = sizeof(struct vduse_dev_request);
    ssize_t ret;
...
#[no_mangle]
unsafe extern "C" fn is_mem_zero(ptr: *const c_char, size: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_write_iter(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_reset(dev: *mut vduse_dev) {
...
// The coherent mappings are handled in vduse_dev_free_coherent()
    ...
    dev.config_cb.callback = core::ptr::null_mut();
    dev.config_cb.private = core::ptr::null_mut();
    ...
    vq.kickfd = core::ptr::null_mut();
    spin_unlock(&vq.kick_lock);
    spin_lock(&vq.irq_lock);
    vq.cb.callback = core::ptr::null_mut();
    vq.cb.private = core::ptr::null_mut();
    vq.cb.trigger = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn vduse_vq_kick(vq: *mut vduse_virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn vduse_vq_kick_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_kick_vq(vdpa: *mut vdpa_device, idx: u16) {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_set_vq_num(vdpa: *mut vdpa_device, idx: u16, num: u32) {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_get_vq_size(vdpa: *mut vdpa_device, idx: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_get_vq_ready(vdpa: *mut vdpa_device, idx: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vduse_get_vq_group(vdpa: *mut vdpa_device, idx: u16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vduse_get_vq_map(vdpa: *mut vdpa_device, idx: u16) -> union virtio_map {
    static union virtio_map vduse_get_vq_map(struct vdpa_device *vdpa, u16 idx)
    {
    struct vduse_dev *dev = vdpa_to_vduse(vdpa);
    let mut vq_group: u32 = vduse_get_vq_group(vdpa, idx);
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_get_vq_align(vdpa: *mut vdpa_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_get_device_features(vdpa: *mut vdpa_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_set_driver_features(vdpa: *mut vdpa_device, features: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_get_driver_features(vdpa: *mut vdpa_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_get_vq_num_max(vdpa: *mut vdpa_device) -> u16 {
    static u16 vduse_vdpa_get_vq_num_max(struct vdpa_device *vdpa)
    {
    struct vduse_dev *dev = vdpa_to_vduse(vdpa);
    let mut num_max: u16 = 0;
    int i;
    for (i = 0; i < dev.vq_num; i++)
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_get_device_id(vdpa: *mut vdpa_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_get_vendor_id(vdpa: *mut vdpa_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_get_status(vdpa: *mut vdpa_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_set_status(vdpa: *mut vdpa_device, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_get_config_size(vdpa: *mut vdpa_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_reset(vdpa: *mut vdpa_device) -> c_int {
    static int vduse_vdpa_reset(struct vdpa_device *vdpa)
    {
    struct vduse_dev *dev = vdpa_to_vduse(vdpa);
    let mut ret: c_int = vduse_dev_set_status(dev, 0);
    vduse_dev_reset(dev);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_get_generation(vdpa: *mut vdpa_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_suspend(vdpa: *mut vdpa_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vduse_vdpa_free(vdpa: *mut vdpa_device) {
    static void vduse_vdpa_free(struct vdpa_device *vdpa)
    {
    struct vduse_dev *dev = vdpa_to_vduse(vdpa);
    dev.vdev = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_need_sync(token: union virtio_map, dma_addr: dma_addr_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_mapping_error(token: union virtio_map, dma_addr: dma_addr_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_max_mapping_size(token: union virtio_map) -> usize {
...
#[no_mangle]
unsafe extern "C" fn perm_to_file_flags(perm: u8) -> c_uint {
    ...
    {
    struct eventfd_ctx *ctx = core::ptr::null_mut();
    struct vduse_virtqueue *vq;
    u32 index;
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_is_ready(dev: *mut vduse_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_irq_inject(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn vduse_vq_irq_inject(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn vduse_vq_signal_irqfd(vq: *mut vduse_virtqueue) -> bool {
    ...
    dev.as[asid].umem = core::ptr::null_mut();
    ret = 0;
    unlock:
    ...
    {
    struct page **page_list = core::ptr::null_mut();
    struct vduse_umem *umem = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn vduse_vq_update_effective_cpu(vq: *mut vduse_virtqueue) {
    static void vduse_vq_update_effective_cpu(struct vduse_virtqueue *vq)
    {
    let mut curr_cpu: c_int = vq.irq_effective_cpu;
    while (true) {
...
// capability |= VDUSE_IOVA_CAP_UMEM;
    ...
    let mut entry: vduse_iotlb_entry_v2 = {0};
    ...
    break;
    ret = vduse_dev_iotlb_entry(dev, &entry, &f, core::ptr::null_mut());
    if (ret)
    break;
    ret = -EINVAL;
    if (!f)
    ...
    ret = receive_fd(f, core::ptr::null_mut(), perm_to_file_flags(entry.perm));
    fput(f);
    break;
    }
...
//
    ...
    ret = vduse_dev_iotlb_entry(dev, &entry, core::ptr::null_mut(),
    &info.capability);
    if (ret < 0)
    break;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct compat_vduse_iotlb_entry {
    pub offset: compat_u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct compat_vduse_vq_info {
    pub index: __u32,
    pub num: __u32,
    pub desc_addr: compat_u64,
    pub driver_addr: compat_u64,
    pub device_addr: compat_u64,
    union {
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irq_cb_affinity_show(vq: *mut vduse_virtqueue, buf: *mut c_char) -> isize {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vq_sysfs_entry {
    pub attr: attribute,
    pub buf): *mut *mut *mut ssize_t (show)(struct vduse_virtqueue vq, char,
    ssize_t (*store)(struct vduse_virtqueue *vq, const char *buf,
    pub count): usize,
}

    let mut irq_cb_affinity_attr: static struct vq_sysfs_entry = __ATTR_RW(irq_cb_affinity);
...
#[no_mangle]
unsafe extern "C" fn vq_release(kobj: *mut kobject) {
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_deinit_vqs(dev: *mut vduse_dev) {
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_init_vqs(dev: *mut vduse_dev, vq_align: u32, vq_num: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vduse_dev_destroy(dev: *mut vduse_dev) {
...
#[no_mangle]
unsafe extern "C" fn vduse_destroy_dev(name: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn device_is_allowed(device_id: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn features_is_valid(config: *mut vduse_dev_config) -> bool {
...
// Assuming that if the first domain is allocated, all are allocated
    ...
    dev.dev = device_create_with_groups(&vduse_class, core::ptr::null_mut(),
    ...
    let mut size: c_ulong = offsetof(struct vduse_dev_config, config);
    void *buf;
    ret = -EFAULT;
    if (copy_from_user(&config, argp, size))
    break;
...
#[no_mangle]
unsafe extern "C" fn vduse_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vduse_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vduse_mgmt_dev {
    pub mgmt_dev: vdpa_mgmt_dev,
    pub dev: device,
}

    static struct vduse_mgmt_dev *vduse_mgmt;
#[no_mangle]
unsafe extern "C" fn vduse_dev_init_vdpa(dev: *mut vduse_dev, name: *const c_char) -> c_int {
    ...
    dev.as[j].domain = core::ptr::null_mut();
    }
    }
    mutex_unlock(&dev.domain_lock);
...
#[no_mangle]
unsafe extern "C" fn vdpa_dev_del(mdev: *mut vdpa_mgmt_dev, dev: *mut vdpa_device) {
...
#[no_mangle]
unsafe extern "C" fn vduse_mgmtdev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn vduse_mgmtdev_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vduse_mgmtdev_exit() {
...
#[no_mangle]
unsafe extern "C" fn vduse_init() -> c_int {
...
// /dev/vduse/control
    ...
    if (ret)
    goto err_ctrl_cdev;
    vduse_ctrl_dev = device_create(&vduse_class, core::ptr::null_mut(), vduse_major, core::ptr::null_mut(), "control");
    if (IS_ERR(vduse_ctrl_dev)) {
    ret = PTR_ERR(vduse_ctrl_dev);
    vduse_ctrl_dev = core::ptr::null_mut();
    goto err_device;
    }
// /dev/vduse/$DEVICE
