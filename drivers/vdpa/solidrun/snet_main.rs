...
//! Source: drivers/vdpa/solidrun/snet_main.c
#![no_std]
...
// SNET DPU device ID
pub const SNET_DEVICE_ID: c_uint = 0x1000;
// SNET signature
pub const SNET_SIGNATURE: c_uint = 0xD0D06363;
// Max. config version that we can work with
pub const SNET_CFG_VERSION: c_uint = 0x2;
// Queue align

// Kick value to notify that new data is available
pub const SNET_KICK_VAL: c_uint = 0x1;
pub const SNET_CONFIG_OFF: c_uint = 0x0;
// How long we are willing to wait for a SNET device
pub const SNET_DETECT_TIMEOUT: c_int = 5000000;
// How long should we wait for the DPU to read our config
pub const SNET_READ_CFG_TIMEOUT: c_int = 3000000;
// Size of configs written to the DPU
pub const SNET_GENERAL_CFG_LEN: c_int = 36;
pub const SNET_GENERAL_CFG_VQ_LEN: c_int = 40;
    static struct snet *vdpa_to_snet(struct vdpa_device *vdpa)
    {
    return container_of(vdpa, struct snet, vdpa);
    }
#[no_mangle]
unsafe extern "C" fn snet_cfg_irq_hndlr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn snet_vq_irq_hndlr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn snet_free_irqs(snet: *mut snet) {
...
#[no_mangle]
unsafe extern "C" fn snet_set_vq_num(vdev: *mut vdpa_device, idx: u16, num: u32) {
...
#[no_mangle]
unsafe extern "C" fn snet_kick_vq(vdev: *mut vdpa_device, idx: u16) {
...
#[no_mangle]
unsafe extern "C" fn snet_kick_vq_with_data(vdev: *mut vdpa_device, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn snet_set_vq_cb(vdev: *mut vdpa_device, idx: u16, cb: *mut vdpa_callback) {
...
#[no_mangle]
unsafe extern "C" fn snet_set_vq_ready(vdev: *mut vdpa_device, idx: u16, ready: bool) {
...
#[no_mangle]
unsafe extern "C" fn snet_get_vq_ready(vdev: *mut vdpa_device, idx: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn snet_vq_state_is_initial(snet: *mut snet, state: *const vdpa_vq_state) -> bool {
...
#[no_mangle]
unsafe extern "C" fn snet_set_vq_state(vdev: *mut vdpa_device, idx: u16, state: *const vdpa_vq_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snet_get_vq_state(vdev: *mut vdpa_device, idx: u16, state: *mut vdpa_vq_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snet_get_vq_irq(vdev: *mut vdpa_device, idx: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snet_get_vq_align(vdev: *mut vdpa_device) -> u32 {
    static u32 snet_get_vq_align(struct vdpa_device *vdev)
    {
    return (u32)SNET_QUEUE_ALIGNMENT;
    }
#[no_mangle]
unsafe extern "C" fn snet_reset_dev(snet: *mut snet) -> c_int {
...
// Clear VQs
    ...
    if (!snet.vqs[i])
    continue;
    snet.vqs[i].cb.callback = core::ptr::null_mut();
    snet.vqs[i].cb.private = core::ptr::null_mut();
...
// Clear config callback
    snet.cb.callback = core::ptr::null_mut();
    snet.cb.private = core::ptr::null_mut();
// Free IRQs
    snet_free_irqs(snet);
// Reset status
    snet.status = 0;
...
#[no_mangle]
unsafe extern "C" fn snet_reset(vdev: *mut vdpa_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snet_get_config_size(vdev: *mut vdpa_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn snet_get_features(vdev: *mut vdpa_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn snet_set_drv_features(vdev: *mut vdpa_device, features: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snet_get_drv_features(vdev: *mut vdpa_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn snet_get_vq_num_max(vdev: *mut vdpa_device) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn snet_set_config_cb(vdev: *mut vdpa_device, cb: *mut vdpa_callback) {
...
#[no_mangle]
unsafe extern "C" fn snet_get_device_id(vdev: *mut vdpa_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn snet_get_vendor_id(vdev: *mut vdpa_device) -> u32 {
    static u32 snet_get_vendor_id(struct vdpa_device *vdev)
    {
    return (u32)PCI_VENDOR_ID_SOLIDRUN;
    }
#[no_mangle]
unsafe extern "C" fn snet_get_status(vdev: *mut vdpa_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn snet_write_conf(snet: *mut snet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snet_request_irqs(pdev: *mut pci_dev, snet: *mut snet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snet_set_status(vdev: *mut vdpa_device, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn snet_suspend(vdev: *mut vdpa_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snet_resume(vdev: *mut vdpa_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psnet_open_pf_bar(pdev: *mut pci_dev, psnet: *mut psnet) -> c_int {
    static int psnet_open_pf_bar(struct pci_dev *pdev, struct psnet *psnet)
    {
    char *name;
    unsigned short i;
    let mut bars_found: bool = false;
...
#[no_mangle]
unsafe extern "C" fn snet_open_vf_bar(pdev: *mut pci_dev, snet: *mut snet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snet_free_cfg(cfg: *mut snet_cfg) {
...
#[no_mangle]
unsafe extern "C" fn psnet_detect_bar(psnet: *mut psnet, off: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psnet_unmap_unused_bars(pdev: *mut pci_dev, psnet: *mut psnet) {
...
#[no_mangle]
unsafe extern "C" fn psnet_read_cfg(pdev: *mut pci_dev, psnet: *mut psnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psnet_alloc_irq_vector(pdev: *mut pci_dev, psnet: *mut psnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snet_alloc_irq_vector(pdev: *mut pci_dev, snet_cfg: *mut snet_dev_cfg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snet_free_vqs(snet: *mut snet) {
...
#[no_mangle]
unsafe extern "C" fn snet_build_vqs(snet: *mut snet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psnet_get_next_irq_num(psnet: *mut psnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snet_reserve_irq_idx(pdev: *mut pci_dev, snet: *mut snet) {
...
#[no_mangle]
unsafe extern "C" fn snet_vdpa_probe_pf(pdev: *mut pci_dev) -> c_int {
    static int snet_vdpa_probe_pf(struct pci_dev *pdev)
    {
    struct psnet *psnet;
    let mut ret: c_int = 0;
    let mut pf_irqs: bool = false;
...
#[no_mangle]
unsafe extern "C" fn snet_vdpa_probe_vf(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snet_vdpa_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snet_vdpa_remove_pf(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn snet_vdpa_remove_vf(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn snet_vdpa_remove(pdev: *mut pci_dev) {
