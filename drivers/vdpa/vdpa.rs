...
#[no_mangle]
pub unsafe extern "C" fn vdpa_set_status(vdev: *mut vdpa_device, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn vdpa_dev_probe(d: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdpa_dev_remove(d: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn vdpa_dev_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdpa_release_dev(d: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn vdpa_name_match(dev: *mut device, data: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __vdpa_register_device(vdev: *mut vdpa_device, nvqs: u32) -> c_int {
    static int __vdpa_register_device(struct vdpa_device *vdev, u32 nvqs)
    {
    struct device *dev;
    vdev.nvqs = nvqs;
    lockdep_assert_held(&vdpa_dev_lock);
    dev = bus_find_device(&vdpa_bus, core::ptr::null_mut(), dev_name(&vdev.dev), vdpa_name_match);
    if (dev) {
    put_device(dev);
    return -EEXIST;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn _vdpa_register_device(vdev: *mut vdpa_device, nvqs: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vdpa_register_device(vdev: *mut vdpa_device, nvqs: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn _vdpa_unregister_device(vdev: *mut vdpa_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vdpa_unregister_device(vdev: *mut vdpa_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __vdpa_register_driver(drv: *mut vdpa_driver, owner: *mut module) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vdpa_unregister_driver(drv: *mut vdpa_driver) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vdpa_mgmtdev_register(mdev: *mut vdpa_mgmt_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdpa_match_remove(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vdpa_mgmtdev_unregister(mdev: *mut vdpa_mgmt_dev) {
    void vdpa_mgmtdev_unregister(struct vdpa_mgmt_dev *mdev)
    {
    down_write(&vdpa_dev_lock);
    list_del(&mdev.list);
// Filter out all the entries belong to this management device and delete it.
    bus_for_each_dev(&vdpa_bus, core::ptr::null_mut(), mdev, vdpa_match_remove);
    up_write(&vdpa_dev_lock);
    }
...
//
    ...
    const char *busname = core::ptr::null_mut();
    const char *devname;
...
#[no_mangle]
unsafe extern "C" fn vdpa_nl_mgmtdev_handle_fill(msg: *mut sk_buff, mdev: *const vdpa_mgmt_dev) -> c_int {
    ...
    {
    let mut supported_classes: u64 = 0;
    let mut n: c_uint = 0;
...
// nclasses = n;
    ...
    vdpa_mgmtdev_get_classes(mdev, core::ptr::null_mut()),
    VDPA_ATTR_UNSPEC)) {
    err = -EMSGSIZE;
    goto msg_err;
    }
...
#[no_mangle]
unsafe extern "C" fn vdpa_nl_cmd_mgmtdev_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdpa_nl_cmd_dev_add_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    static int vdpa_nl_cmd_dev_add_set_doit(struct sk_buff *skb, struct genl_info *info)
    {
    let mut config: vdpa_dev_set_config = {};
    struct nlattr **nl_attrs = info.attrs;
    struct vdpa_mgmt_dev *mdev;
    let mut ncls: c_uint = 0;
    const u8 *macaddr;
    const char *name;
    u64 classes;
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn vdpa_nl_cmd_dev_del_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    name = nla_data(info.attrs[VDPA_ATTR_DEV_NAME]);
    down_write(&vdpa_dev_lock);
    dev = bus_find_device(&vdpa_bus, core::ptr::null_mut(), name, vdpa_name_match);
    if (!dev) {
...
#[no_mangle]
unsafe extern "C" fn vdpa_nl_cmd_dev_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    return -ENOMEM;
    down_read(&vdpa_dev_lock);
    dev = bus_find_device(&vdpa_bus, core::ptr::null_mut(), devname, vdpa_name_match);
    if (!dev) {
    NL_SET_ERR_MSG_MOD(info.extack, "device not found");
    err = -ENODEV;
    goto err;
...
#[no_mangle]
unsafe extern "C" fn vdpa_dev_dump(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdpa_nl_cmd_dev_get_dumpit(msg: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    ...
    info.idx = 0;
    down_read(&vdpa_dev_lock);
    bus_for_each_dev(&vdpa_bus, core::ptr::null_mut(), &info, vdpa_dev_dump);
    up_read(&vdpa_dev_lock);
    cb.args[0] = info.idx;
    return msg.len;
    }
...
#[no_mangle]
unsafe extern "C" fn vdpa_dev_net_config_fill(vdev: *mut vdpa_device, msg: *mut sk_buff) -> c_int {
    static int vdpa_dev_net_config_fill(struct vdpa_device *vdev, struct sk_buff *msg)
    {
    let mut config: virtio_net_config = {};
    u64 features_device;
...
#[no_mangle]
unsafe extern "C" fn vdpa_dev_blk_ro_config_fill(msg: *mut sk_buff, features: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdpa_dev_blk_flush_config_fill(msg: *mut sk_buff, features: u64) -> c_int {
    ...
    struct sk_buff *msg)
    {
    let mut config: virtio_blk_config = {};
    u64 features_device;
    vdev.config.get_config(vdev, 0, &config, sizeof(config));
    features_device = vdev.config.get_device_features(vdev);
    if (nla_put_u64_64bit(msg, VDPA_ATTR_DEV_FEATURES, features_device,
...
// only read driver features after the feature negotiation is done
    ...
    void *hdr;
    int err;
    let mut portid: u32 = info.snd_portid;
    let mut seq: u32 = info.snd_seq;
    let mut flags: u32 = 0;
    hdr = genlmsg_put(msg, portid, seq, &vdpa_nl_family, flags,
...
#[no_mangle]
unsafe extern "C" fn vdpa_nl_cmd_dev_config_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    {
    let mut set_config: vdpa_dev_set_config = {};
    struct vdpa_mgmt_dev *mdev = vdev.mdev;
    struct nlattr **nl_attrs = info.attrs;
    const u8 *macaddr;
    ...
    classes = vdpa_mgmtdev_get_classes(vdev.mdev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn vdpa_dev_config_dump(dev: *mut device, data: *mut c_void) -> c_int {
    ...
    info.idx = 0;
    down_read(&vdpa_dev_lock);
    bus_for_each_dev(&vdpa_bus, core::ptr::null_mut(), &info, vdpa_dev_config_dump);
    up_read(&vdpa_dev_lock);
    cb.args[0] = info.idx;
    return msg.len;
    }
...
#[no_mangle]
unsafe extern "C" fn vdpa_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdpa_exit() -> void __exit {
