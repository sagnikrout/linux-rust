...
//! Source: drivers/vdpa/octeon_ep/octep_vdpa_main.c
#![no_std]
...
pub const OCTEP_VDPA_NAME_BUFSIZE: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octep_pf {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octep_vdpa_event_wk {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octep_vdpa {
    pub vdpa: vdpa_device,
    pub oct_hw: *mut octep_hw,
    pub pdev: *mut pci_dev,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct octep_vdpa_mgmt_dev {
    pub mdev: vdpa_mgmt_dev,
    pub oct_hw: octep_hw,
    pub pdev: *mut pci_dev,
// Work entry to handle device setup
    pub setup_task: work_struct,
// Device status
    pub status: core::sync::atomic::AtomicI32,
    pub oct_vdpa: *mut octep_vdpa,
    pub event_wk: octep_vdpa_event_wk,
}
...
#[no_mangle]
pub unsafe extern "C" fn octep_vdpa_dev_event_schedule(oct_hw: *mut octep_hw) {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_dev_event_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_intr_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_free_irqs(oct_hw: *mut octep_hw) {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_get_device_features(vdpa_dev: *mut vdpa_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_set_driver_features(vdpa_dev: *mut vdpa_device, features: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_get_driver_features(vdpa_dev: *mut vdpa_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_get_status(vdpa_dev: *mut vdpa_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_set_status(vdpa_dev: *mut vdpa_device, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_reset(vdpa_dev: *mut vdpa_device) -> c_int {
    static int octep_vdpa_reset(struct vdpa_device *vdpa_dev)
    {
    struct octep_hw *oct_hw = vdpa_to_octep_hw(vdpa_dev);
    let mut status: u8 = octep_hw_get_status(oct_hw);
    u16 qid;
    if (status == 0)
    return 0;
    for (qid = 0; qid < oct_hw.nr_vring; qid++) {
    oct_hw.vqs[qid].cb.callback = core::ptr::null_mut();
    oct_hw.vqs[qid].cb.private = core::ptr::null_mut();
    oct_hw.config_cb.callback = core::ptr::null_mut();
    oct_hw.config_cb.private = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_get_vq_num_max(vdpa_dev: *mut vdpa_device) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_set_vq_cb(vdpa_dev: *mut vdpa_device, qid: u16, cb: *mut vdpa_callback) {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_set_vq_ready(vdpa_dev: *mut vdpa_device, qid: u16, ready: bool) {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_get_vq_ready(vdpa_dev: *mut vdpa_device, qid: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_set_vq_num(vdpa_dev: *mut vdpa_device, qid: u16, num: u32) {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_kick_vq(vdpa_dev: *mut vdpa_device, qid: u16) {
    static void octep_vdpa_kick_vq(struct vdpa_device *vdpa_dev, u16 qid)
    {
// Not supported
    }
#[no_mangle]
unsafe extern "C" fn octep_vdpa_kick_vq_with_data(vdpa_dev: *mut vdpa_device, data: u32) {
    static void octep_vdpa_kick_vq_with_data(struct vdpa_device *vdpa_dev, u32 data)
    {
    struct octep_hw *oct_hw = vdpa_to_octep_hw(vdpa_dev);
    let mut idx: u16 = data & 0xFFFF;
    vp_iowrite32(data, oct_hw.vqs[idx].notify_addr);
    }
#[no_mangle]
unsafe extern "C" fn octep_vdpa_get_generation(vdpa_dev: *mut vdpa_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_get_device_id(vdpa_dev: *mut vdpa_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_get_vendor_id(vdpa_dev: *mut vdpa_device) -> u32 {
    static u32 octep_vdpa_get_vendor_id(struct vdpa_device *vdpa_dev)
    {
    return PCI_VENDOR_ID_CAVIUM;
    }
#[no_mangle]
unsafe extern "C" fn octep_vdpa_get_vq_align(vdpa_dev: *mut vdpa_device) -> u32 {
    static u32 octep_vdpa_get_vq_align(struct vdpa_device *vdpa_dev)
    {
    return PAGE_SIZE;
    }
#[no_mangle]
unsafe extern "C" fn octep_vdpa_get_config_size(vdpa_dev: *mut vdpa_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_set_config_cb(vdpa_dev: *mut vdpa_device, cb: *mut vdpa_callback) {
...
#[no_mangle]
unsafe extern "C" fn octep_iomap_region(pdev: *mut pci_dev, tbl: *mut u8 __iomem, bar: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octep_iounmap_region(pdev: *mut pci_dev, tbl: *mut u8 __iomem, bar: u8) {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_pf_bar_shrink(octpf: *mut octep_pf) {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_pf_bar_expand(octpf: *mut octep_pf) {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_remove_pf(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_vf_bar_shrink(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_remove_vf(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_remove(pdev: *mut pci_dev) {
    ...
    core::ptr::null_mut(), 1, 1, core::ptr::null_mut(), false);
    if (IS_ERR(oct_vdpa)) {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_dev_del(mdev: *mut vdpa_mgmt_dev, vdpa_dev: *mut vdpa_device) {
...
#[no_mangle]
unsafe extern "C" fn get_device_ready_status(addr: *mut u8 __iomem) -> bool {
    static bool get_device_ready_status(u8 __iomem *addr)
    {
    let mut signature: u32 = readl(addr + OCTEP_VF_MBOX_DATA(0));
...
#[no_mangle]
unsafe extern "C" fn octep_event_work(work: *mut work_struct) {
    ...
    let mut event: u8 = readb(addr + OCTEP_VF_EVENT_REG(0));
    let mut config: vdpa_dev_set_config = {0};
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_setup_task(work: *mut work_struct) {
...
// Wait for a maximum of 5 sec
    ...
    unmap_region:
    octep_iounmap_region(pdev, oct_hw.base, OCTEP_HW_CAPS_BAR);
    oct_hw.base[OCTEP_HW_CAPS_BAR] = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn octep_vdpa_probe_vf(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_assign_barspace(vf_dev: *mut pci_dev, pf_dev: *mut pci_dev, idx: u8) {
...
#[no_mangle]
unsafe extern "C" fn octep_sriov_enable(pdev: *mut pci_dev, num_vfs: c_int) -> c_int {
    ...
    struct pci_dev *vf_pdev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn octep_sriov_disable(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_sriov_configure(pdev: *mut pci_dev, num_vfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octep_get_vf_devid(pdev: *mut pci_dev) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_pf_setup(octpf: *mut octep_pf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_probe_pf(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octep_vdpa_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
