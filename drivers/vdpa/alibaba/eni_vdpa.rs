...
//! Source: drivers/vdpa/alibaba/eni_vdpa.c
#![no_std]
...
pub const ENI_MSIX_NAME_SIZE: c_int = 256;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct eni_vring {
    pub notify: *mut void __iomem,
    pub msix_name: [c_char; ENI_MSIX_NAME_SIZE],
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_get_device_features(vdpa: *mut vdpa_device) -> u64 {
    static u64 eni_vdpa_get_device_features(struct vdpa_device *vdpa)
    {
    struct virtio_pci_legacy_device *ldev = vdpa_to_ldev(vdpa);
    let mut features: u64 = vp_legacy_get_features(ldev);
    features |= BIT_ULL(VIRTIO_F_ACCESS_PLATFORM);
    features |= BIT_ULL(VIRTIO_F_ORDER_PLATFORM);
    return features;
    }
#[no_mangle]
unsafe extern "C" fn eni_vdpa_set_driver_features(vdpa: *mut vdpa_device, features: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_get_driver_features(vdpa: *mut vdpa_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_get_status(vdpa: *mut vdpa_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_get_vq_irq(vdpa: *mut vdpa_device, idx: u16) -> c_int {
    static int eni_vdpa_get_vq_irq(struct vdpa_device *vdpa, u16 idx)
    {
    struct eni_vdpa *eni_vdpa = vdpa_to_eni(vdpa);
    let mut irq: c_int = eni_vdpa.vring[idx].irq;
    if (irq == VIRTIO_MSI_NO_VECTOR)
    return -EINVAL;
    return irq;
    }
#[no_mangle]
unsafe extern "C" fn eni_vdpa_free_irq(eni_vdpa: *mut eni_vdpa) {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_vq_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_config_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_request_irq(eni_vdpa: *mut eni_vdpa) -> c_int {
    static int eni_vdpa_request_irq(struct eni_vdpa *eni_vdpa)
    {
    struct virtio_pci_legacy_device *ldev = &eni_vdpa.ldev;
    struct pci_dev *pdev = ldev.pci_dev;
    int i, ret, irq;
    let mut queues: c_int = eni_vdpa.queues;
    let mut vectors: c_int = queues + 1;
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_set_status(vdpa: *mut vdpa_device, status: u8) {
    static void eni_vdpa_set_status(struct vdpa_device *vdpa, u8 status)
    {
    struct eni_vdpa *eni_vdpa = vdpa_to_eni(vdpa);
    struct virtio_pci_legacy_device *ldev = &eni_vdpa.ldev;
    let mut s: u8 = eni_vdpa_get_status(vdpa);
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_reset(vdpa: *mut vdpa_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_get_vq_num_max(vdpa: *mut vdpa_device) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_get_vq_num_min(vdpa: *mut vdpa_device) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_get_vq_size(vdpa: *mut vdpa_device, qid: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_get_vq_ready(vdpa: *mut vdpa_device, qid: u16) -> bool {
    ...
    struct virtio_pci_legacy_device *ldev = vdpa_to_ldev(vdpa);
    struct pci_dev *pdev = ldev.pci_dev;
    let mut n: u16 = vp_legacy_get_queue_size(ldev, qid);
...
//
    ...
    {
    struct virtio_pci_legacy_device *ldev = vdpa_to_ldev(vdpa);
    let mut pfn: u32 = desc_area >> VIRTIO_PCI_QUEUE_ADDR_SHIFT;
    vp_legacy_set_queue_address(ldev, qid, pfn);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn eni_vdpa_kick_vq(vdpa: *mut vdpa_device, qid: u16) {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_get_device_id(vdpa: *mut vdpa_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_get_vendor_id(vdpa: *mut vdpa_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_get_vq_align(vdpa: *mut vdpa_device) -> u32 {
    static u32 eni_vdpa_get_vq_align(struct vdpa_device *vdpa)
    {
    return VIRTIO_PCI_VRING_ALIGN;
    }
#[no_mangle]
unsafe extern "C" fn eni_vdpa_get_config_size(vdpa: *mut vdpa_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_get_num_queues(eni_vdpa: *mut eni_vdpa) -> u16 {
    static u16 eni_vdpa_get_num_queues(struct eni_vdpa *eni_vdpa)
    {
    struct virtio_pci_legacy_device *ldev = &eni_vdpa.ldev;
    let mut features: u32 = vp_legacy_get_features(ldev);
    let mut num: u16 = 2;
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    ...
    dev, &eni_vdpa_ops, core::ptr::null_mut(),
    1, 1, core::ptr::null_mut(), false);
    if (IS_ERR(eni_vdpa)) {
...
#[no_mangle]
unsafe extern "C" fn eni_vdpa_remove(pdev: *mut pci_dev) {
