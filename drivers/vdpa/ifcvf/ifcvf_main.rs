...
//! Source: drivers/vdpa/ifcvf/ifcvf_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ifcvf_config_changed(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vq_intr_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vqs_reused_intr_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_dev_intr_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_free_irq_vectors(data: *mut c_void) {
    static void ifcvf_free_irq_vectors(void *data)
    {
    pci_free_irq_vectors(data);
    }
#[no_mangle]
unsafe extern "C" fn ifcvf_free_per_vq_irq(vf: *mut ifcvf_hw) {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_free_vqs_reused_irq(vf: *mut ifcvf_hw) {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_free_vq_irq(vf: *mut ifcvf_hw) {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_free_config_irq(vf: *mut ifcvf_hw) {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_free_irq(vf: *mut ifcvf_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn ifcvf_alloc_vectors(vf: *mut ifcvf_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_request_per_vq_irq(vf: *mut ifcvf_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_request_vqs_reused_irq(vf: *mut ifcvf_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_request_dev_irq(vf: *mut ifcvf_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_request_vq_irq(vf: *mut ifcvf_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_request_config_irq(vf: *mut ifcvf_hw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MSIX_VECTOR_SHARED_VQ_AND_CONFIG: vf->msix_vector_status ==) -> else {
    else if (vf.msix_vector_status ==  MSIX_VECTOR_SHARED_VQ_AND_CONFIG)
// vector 0 for vqs and 1 for config interrupt
    config_vector = 1;
#[no_mangle]
pub unsafe extern "C" fn if(MSIX_VECTOR_DEV_SHARED: vf->msix_vector_status ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_request_irq(vf: *mut ifcvf_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_get_device_features(vdpa_dev: *mut vdpa_device) -> u64 {
    static u64 ifcvf_vdpa_get_device_features(struct vdpa_device *vdpa_dev)
    {
    struct ifcvf_adapter *adapter = vdpa_to_adapter(vdpa_dev);
    struct ifcvf_hw *vf = vdpa_to_vf(vdpa_dev);
    struct pci_dev *pdev = adapter.pdev;
    let mut type: u32 = vf.dev_type;
    u64 features;
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_set_driver_features(vdpa_dev: *mut vdpa_device, features: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_get_driver_features(vdpa_dev: *mut vdpa_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_get_status(vdpa_dev: *mut vdpa_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_set_status(vdpa_dev: *mut vdpa_device, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_reset(vdpa_dev: *mut vdpa_device) -> c_int {
    static int ifcvf_vdpa_reset(struct vdpa_device *vdpa_dev)
    {
    struct ifcvf_hw *vf = vdpa_to_vf(vdpa_dev);
    let mut status: u8 = ifcvf_get_status(vf);
    ifcvf_stop(vf);
    if (status & VIRTIO_CONFIG_S_DRIVER_OK)
    ifcvf_free_irq(vf);
    ifcvf_reset(vf);
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_get_vq_num_max(vdpa_dev: *mut vdpa_device) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_get_vq_num_min(vdpa_dev: *mut vdpa_device) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_get_vq_ready(vdpa_dev: *mut vdpa_device, qid: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_kick_vq(vdpa_dev: *mut vdpa_device, qid: u16) {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_get_generation(vdpa_dev: *mut vdpa_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_get_device_id(vdpa_dev: *mut vdpa_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_get_vendor_id(vdpa_dev: *mut vdpa_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_get_vq_align(vdpa_dev: *mut vdpa_device) -> u32 {
    static u32 ifcvf_vdpa_get_vq_align(struct vdpa_device *vdpa_dev)
    {
    return IFCVF_QUEUE_ALIGNMENT;
    }
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_get_config_size(vdpa_dev: *mut vdpa_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_get_vq_group(vdpa: *mut vdpa_device, idx: u16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn get_dev_type(pdev: *mut pci_dev) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_vdpa_dev_del(mdev: *mut vdpa_mgmt_dev, dev: *mut vdpa_device) {
    static void ifcvf_vdpa_dev_del(struct vdpa_mgmt_dev *mdev, struct vdpa_device *dev)
    {
    struct ifcvf_vdpa_mgmt_dev *ifcvf_mgmt_dev;
    ifcvf_mgmt_dev = container_of(mdev, struct ifcvf_vdpa_mgmt_dev, mdev);
    _vdpa_unregister_device(dev);
    ifcvf_mgmt_dev.adapter = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn ifcvf_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ifcvf_remove(pdev: *mut pci_dev) {
