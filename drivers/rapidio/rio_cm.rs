...
//! Source: drivers/rapidio/rio_cm.c
#![no_std]
...
pub const RIOCM_TX_RING_SIZE: c_int = 128;
pub const RIOCM_RX_RING_SIZE: c_int = 128;

pub const RIOCM_MAX_CHNUM: c_uint = 0xffff /* Use full range of u16 field */;
pub const RIOCM_CHNUM_AUTO: c_int = 0;
pub const RIOCM_MAX_EP_COUNT: c_uint = 0x10000 /* Max number of endpoints */;
    enum rio_cm_state {
    RIO_CM_IDLE,
    RIO_CM_CONNECT,
    RIO_CM_CONNECTED,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rio_ch_base_bhdr {
    pub src_id: u32,
    pub dst_id: u32,
pub const RIO_HDR_LETTER_MASK: c_uint = 0xffff0000;
pub const RIO_HDR_MBOX_MASK: c_uint = 0x0000ffff;
    pub src_mbox: u8,
    pub dst_mbox: u8,
    pub type: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rio_ch_chan_hdr {
    pub bhdr: rio_ch_base_bhdr,
    pub ch_op: u8,
    pub dst_ch: u16,
    pub src_ch: u16,
    pub msg_len: u16,
...
pub struct cm_dev {
    ...
    pub rx_buf: [*mut c_void; RIOCM_RX_RING_SIZE],
    pub rx_slots: c_int,
    pub rx_lock: mutex,
    pub tx_buf: [*mut c_void; RIOCM_TX_RING_SIZE],
    pub tx_slot: c_int,
    pub tx_cnt: c_int,
    pub tx_ack_slot: c_int,
    pub tx_reqs: list_head,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct chan_rx_ring {
    pub buf: [*mut c_void; RIOCM_RX_RING_SIZE],
    pub head: c_int,
    pub tail: c_int,
    pub count: c_int,
// Tracking RX buffers reported to upper level
    pub inuse: [*mut c_void; RIOCM_RX_RING_SIZE],
    pub inuse_cnt: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rio_channel {
    pub /: *mut *mut u16 id; / local channel ID,
    pub /: *mut *mut kref ref; / channel refcount,
    pub filp: *mut file,
    pub /: *mut *mut *mut cm_dev cmdev; / associated CM device object,
    pub /: *mut *mut *mut rio_dev rdev; / remote RapidIO device,
    pub state: enum rio_cm_state,
    pub error: c_int,
    pub lock: spinlock_t,
    pub context: *mut c_void,
    pub /: *mut *mut u32 loc_destid; / local destID,
    pub /: *mut *mut u32 rem_destid; / remote destID,
    pub /: *mut *mut u16 rem_channel; / remote channel ID,
    pub accept_queue: list_head,
    pub ch_node: list_head,
    pub comp: completion,
    pub comp_close: completion,
    pub rx_ring: chan_rx_ring,
}
...
pub struct conn_req {
    pub node: list_head,
    pub /: *mut *mut u32 destid; / requester destID,
    pub /: *mut *mut u16 chan; / requester channel ID,
    pub cmdev: *mut cm_dev,
}
...
#[no_mangle]
unsafe extern "C" fn riocm_cmp(ch: *mut rio_channel, cmp: enum rio_cm_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riocm_put_channel(ch: *mut rio_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn riocm_rx_fill(cm: *mut cm_dev, nent: c_int) {
    ...
    if (cm.rx_buf[i] == core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn riocm_rx_free(cm: *mut cm_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn riocm_req_handler(cm: *mut cm_dev, req_data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn riocm_resp_handler(resp_data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn riocm_close_handler(data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rio_cm_handler(cm: *mut cm_dev, data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn rio_rx_data_handler(cm: *mut cm_dev, buf: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rio_ibmsg_handler(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn rio_txcq_handler(cm: *mut cm_dev, slot: c_int) {
...
//
    ...
    cm.tx_buf[ack_slot] = core::ptr::null_mut();
    ++ack_slot;
...
//
#[no_mangle]
unsafe extern "C" fn riocm_ch_send(ch_id: u16, buf: *mut c_void, len: c_int) -> c_int {
    static int riocm_ch_send(u16 ch_id, void *buf, int len)
    {
    struct rio_channel *ch;
    struct rio_ch_chan_hdr *hdr;
    int ret;
    if (buf == core::ptr::null_mut() || ch_id == 0 || len == 0 || len > RIO_MAX_MSG_SIZE)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn riocm_ch_free_rxbuf(ch: *mut rio_channel, buf: *mut c_void) -> c_int {
    ...
    ch.rx_ring.inuse[i] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn riocm_ch_receive(ch: *mut rio_channel, buf: *mut c_void, timeout: c_long) -> c_int {
    static int riocm_ch_receive(struct rio_channel *ch, void **buf, long timeout)
    {
    void *rxmsg = core::ptr::null_mut();
    int i, ret = 0;
    long wret;
    if (!riocm_cmp(ch, RIO_CM_CONNECTED)) {
    ret = -EAGAIN;
...
//
    ...
    ret = -ETIME;
#[no_mangle]
pub unsafe extern "C" fn if(-ERESTARTSYS: wret ==) -> else {
    ...
    ch.rx_ring.buf[ch.rx_ring.tail] = core::ptr::null_mut();
    ch.rx_ring.count--;
    ch.rx_ring.tail++;
    ch.rx_ring.tail %= RIOCM_RX_RING_SIZE;
    ret = -ENOMEM;
    for (i = 0; i < RIOCM_RX_RING_SIZE; i++) {
    if (ch.rx_ring.inuse[i] == core::ptr::null_mut()) {
...
//
    ...
    {
    struct rio_channel *ch = core::ptr::null_mut();
    struct rio_ch_chan_hdr *hdr;
    int ret;
    long wret;
...
#[no_mangle]
unsafe extern "C" fn riocm_send_ack(ch: *mut rio_channel) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn riocm_ch_listen(ch_id: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn riocm_ch_bind(ch_id: u16, mport_id: u8, context: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn riocm_ch_free(ref: *mut kref) {
    static void riocm_ch_free(struct kref *ref)
    {
    ...
    if (ch.rx_ring.buf[i] != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn riocm_send_close(ch: *mut rio_channel) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn riocm_ch_close(ch: *mut rio_channel) -> c_int {
    static int riocm_ch_close(struct rio_channel *ch)
    {
    let mut tmo: c_ulong = msecs_to_jiffies(3000);
...
//
#[no_mangle]
unsafe extern "C" fn riocm_cdev_open(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn riocm_cdev_release(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cm_ep_get_list_size(arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cm_ep_get_list(arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cm_mport_get_list(arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cm_chan_create(filp: *mut file, arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cm_chan_close(filp: *mut file, arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cm_chan_bind(arg: *mut void __user) -> c_int {
    ...
    return -EINVAL;
    return riocm_ch_bind(chan.id, chan.mport_id, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn cm_chan_listen(arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cm_chan_accept(filp: *mut file, arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cm_chan_connect(arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cm_chan_msg_send(arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cm_chan_msg_rcv(arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn riocm_add_dev(dev: *mut device, sif: *mut subsys_interface) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn riocm_remove_dev(dev: *mut device, sif: *mut subsys_interface) {
...
//
#[no_mangle]
unsafe extern "C" fn riocm_cdev_add(devno: dev_t) -> c_int {
    ...
    riocm_cdev.dev = device_create(&dev_class, core::ptr::null_mut(), devno, core::ptr::null_mut(), DEV_NAME);
...
//
#[no_mangle]
unsafe extern "C" fn riocm_add_mport(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn riocm_remove_mport(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn riocm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn riocm_exit() -> void __exit {
