...
//! Source: drivers/rapidio/devices/tsi721_dma.c
#![no_std]
...
//
    ...
    let mut dma_desc_per_channel: static unsigned int = 128;
...
#[no_mangle]
unsafe extern "C" fn tsi721_bdma_ch_init(bdma_chan: *mut tsi721_bdma_chan, bd_num: c_int) -> c_int {
...
// Free space allocated for DMA descriptors
    ...
    (bd_num + 1) * sizeof(struct tsi721_dma_desc),
    bd_ptr, bd_phys);
    bdma_chan.bd_base = core::ptr::null_mut();
    return -ENOMEM;
    }
...
// Free space allocated for status descriptors
    ...
    sts_size * sizeof(struct tsi721_dma_sts),
    sts_ptr, sts_phys);
    bdma_chan.sts_base = core::ptr::null_mut();
    return -EIO;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn tsi721_bdma_ch_free(bdma_chan: *mut tsi721_bdma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsi721_dma_is_idle(bdma_chan: *mut tsi721_bdma_chan) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn tsi721_bdma_handler(bdma_chan: *mut tsi721_bdma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn tsi721_bdma_msix(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
    static irqreturn_t tsi721_bdma_msix(int irq, void *ptr)
    {
...
#[no_mangle]
unsafe extern "C" fn tsi721_start_dma(bdma_chan: *mut tsi721_bdma_chan) {
...
// Update DMA descriptor
    ...
    let mut callback: dma_async_tx_callback = txd.callback;
...
#[no_mangle]
unsafe extern "C" fn tsi721_clr_stat(bdma_chan: *mut tsi721_bdma_chan) {
...
#[no_mangle]
unsafe extern "C" fn tsi721_submit_sg(desc: *mut tsi721_tx_desc) -> c_int {
    static int tsi721_submit_sg(struct tsi721_tx_desc *desc)
    {
    ...
    unsigned int i;
    let mut err: c_int = 0;
    struct tsi721_dma_desc *bd_ptr = core::ptr::null_mut();
    u32 idx, rd_idx;
...
#[no_mangle]
unsafe extern "C" fn tsi721_dma_tasklet(data: c_ulong) {
...
// Clear interrupt bits
    ...
    bdma_chan.active_tx = core::ptr::null_mut();
    if (bdma_chan.active)
    tsi721_advance_work(bdma_chan, core::ptr::null_mut());
    spin_unlock(&bdma_chan.lock);
    }
    ...
    desc = bdma_chan.active_tx;
    if (desc.sg_len == 0) {
    let mut callback: dma_async_tx_callback = core::ptr::null_mut();
    void *param = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tsi721_tx_submit(txd: *mut dma_async_tx_descriptor) -> dma_cookie_t {
...
#[no_mangle]
unsafe extern "C" fn tsi721_alloc_chan_resources(dchan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsi721_sync_dma_irq(bdma_chan: *mut tsi721_bdma_chan) {
...
#[no_mangle]
unsafe extern "C" fn tsi721_free_chan_resources(dchan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn tsi721_issue_pending(dchan: *mut dma_chan) {
    ...
    rtype = NREAD;
#[no_mangle]
pub unsafe extern "C" fn if(DMA_MEM_TO_DEV: dir ==) -> else {
    switch (rext.wr_type) {
    case RDW_ALL_NWRITE:
    rtype = ALL_NWRITE;
    break;
...
#[no_mangle]
unsafe extern "C" fn tsi721_terminate_all(dchan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsi721_dma_stop(bdma_chan: *mut tsi721_bdma_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn tsi721_dma_stop_all(priv: *mut tsi721_device) {
...
#[no_mangle]
pub unsafe extern "C" fn tsi721_register_dma(priv: *mut tsi721_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tsi721_unregister_dma(priv: *mut tsi721_device) {
