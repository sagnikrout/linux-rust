...
//! Source: drivers/rapidio/devices/rio_mport_cdev.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rio_mport_mapping {
    pub node: list_head,
    pub md: *mut mport_dev,
    pub dir: enum rio_mport_map_dir,
    pub rioid: u16,
    pub rio_addr: u64,
    pub /: *mut *mut dma_addr_t phys_addr; / for mmap,
    pub /: *mut *mut *mut void virt_addr; / kernel address, for dma_free_coherent,
    pub size: u64,
    pub /: *mut *mut kref ref; / refcount of vmas sharing the mapping,
    pub filp: *mut file,
}

pub const MPORT_EVENT_DEPTH: c_int = 10;
//
...
pub struct mport_dev {
    ...
    pub properties: rio_mport_properties,
    pub doorbells: list_head,
    pub db_lock: spinlock_t,
    pub portwrites: list_head,
    pub pw_lock: spinlock_t,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mport_cdev_priv {
    pub md: *mut mport_dev,
    pub async_queue: *mut fasync_struct,
    pub list: list_head,
    pub db_filters: list_head,
    pub pw_filters: list_head,
    pub event_fifo: kfifo,
    pub event_rx_wait: wait_queue_head_t,
    pub fifo_lock: spinlock_t,
    pub /: *mut *mut u32 event_mask; / RIO_DOORBELL, RIO_PORTWRITE,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rio_mport_pw_filter {
    pub md_node: list_head,
    pub priv_node: list_head,
    pub priv: *mut mport_cdev_priv,
    pub filter: rio_pw_filter,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rio_mport_db_filter {
    pub data_node: list_head,
    pub priv_node: list_head,
    pub priv: *mut mport_cdev_priv,
    pub filter: rio_doorbell_filter,
}
...
#[no_mangle]
unsafe extern "C" fn rio_mport_obw_map(filp: *mut file, arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rio_mport_obw_free(filp: *mut file, arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn maint_hdid_set(priv: *mut mport_cdev_priv, arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn maint_comptag_set(priv: *mut mport_cdev_priv, arg: *mut void __user) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mport_dma_req {
    pub refcount: kref,
    pub node: list_head,
    pub filp: *mut file,
    pub priv: *mut mport_cdev_priv,
    pub sync: enum rio_transfer_sync,
    pub sgt: sg_table,
    pub page_list: *mut page,
    pub nr_pages: c_uint,
    pub map: *mut rio_mport_mapping,
    pub dmach: *mut dma_chan,
    pub dir: enum dma_data_direction,
    pub cookie: dma_cookie_t,
    pub status: enum dma_status,
    pub req_comp: completion,
}

#[no_mangle]
unsafe extern "C" fn mport_release_def_dma(dma_ref: *mut kref) {
    ...
    md.dma_chan = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn mport_release_dma(dma_ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn dma_req_free(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn dma_xfer_callback(param: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn get_dma_channel(priv: *mut mport_cdev_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn put_dma_channel(priv: *mut mport_cdev_priv) {
...
//
    ...
    dma_cookie_t cookie;
    let mut tmo: c_ulong = msecs_to_jiffies(dma_timeout);
...
//
    ...
    if (page_list == core::ptr::null_mut()) {
    ret = -ENOMEM;
    goto err_req;
    }
...
#[no_mangle]
unsafe extern "C" fn rio_mport_transfer_ioctl(filp: *mut file, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rio_mport_wait_for_async_dma(filp: *mut file, arg: *mut void __user) -> c_int {
...
// Return request back into async queue
    ...
    if (map.virt_addr == core::ptr::null_mut()) {
    kfree(map);
    return -ENOMEM;
    }
    map.dir = MAP_DMA;
...
#[no_mangle]
unsafe extern "C" fn rio_mport_alloc_dma(filp: *mut file, arg: *mut void __user) -> c_int {
    static int rio_mport_alloc_dma(struct file *filp, void __user *arg)
    {
    struct mport_cdev_priv *priv = filp.private_data;
    struct mport_dev *md = priv.md;
    struct rio_dma_mem map;
    struct rio_mport_mapping *mapping = core::ptr::null_mut();
    int ret;
    if (unlikely(copy_from_user(&map, arg, sizeof(map))))
    return -EFAULT;
...
#[no_mangle]
unsafe extern "C" fn rio_mport_free_dma(filp: *mut file, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rio_mport_transfer_ioctl(filp: *mut file, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rio_mport_map_inbound(filp: *mut file, arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rio_mport_inbound_free(filp: *mut file, arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn maint_port_idx_get(priv: *mut mport_cdev_priv, arg: *mut void __user) -> c_int {
    static int maint_port_idx_get(struct mport_cdev_priv *priv, void __user *arg)
    {
    struct mport_dev *md = priv.md;
    let mut port_idx: u32 = md.mport.index;
    ...
    if (db_filter == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn rio_mport_delete_db_filter(db_filter: *mut rio_mport_db_filter) {
    ...
    struct rio_pw_filter filter;
    unsigned long flags;
    let mut hadd: c_int = 0;
    if (copy_from_user(&filter, arg, sizeof(filter)))
    return -EFAULT;
    pw_filter = kzalloc_obj(*pw_filter);
    if (pw_filter == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn rio_mport_delete_pw_filter(pw_filter: *mut rio_mport_pw_filter) {
...
#[no_mangle]
unsafe extern "C" fn rio_release_net(dev: *mut device) {
...
//
    ...
    dev = bus_find_device_by_name(&rio_bus_type, core::ptr::null_mut(), dev_info.name);
    if (dev) {
    ...
    return -ENOMEM;
    if (mport.net == core::ptr::null_mut()) {
    struct rio_net *net;
...
// hopcount is stored as specified by a caller, regardles of EP or SW
    ...
    rswitch.route_table = core::ptr::null_mut();
    }
    if (strlen(dev_info.name))
    dev_set_name(&rdev.dev, "%s", dev_info.name);
#[no_mangle]
pub unsafe extern "C" fn if(RIO_PEF_SWITCH: rdev->pef &) -> else {
...
#[no_mangle]
unsafe extern "C" fn rio_mport_del_riodev(priv: *mut mport_cdev_priv, arg: *mut void __user) -> c_int {
    static int rio_mport_del_riodev(struct mport_cdev_priv *priv, void __user *arg)
    {
    struct rio_rdev_info dev_info;
    struct rio_dev *rdev = core::ptr::null_mut();
    struct device  *dev;
    struct rio_mport *mport;
    struct rio_net *net;
    if (copy_from_user(&dev_info, arg, sizeof(dev_info)))
...
// If device name is specified, removal by name has priority
    if (strlen(dev_info.name)) {
    dev = bus_find_device_by_name(&rio_bus_type, core::ptr::null_mut(),
    dev_info.name);
    if (dev)
    rdev = to_rio_dev(dev);
    } else {
...
//
#[no_mangle]
unsafe extern "C" fn mport_cdev_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mport_cdev_fasync(fd: c_int, filp: *mut file, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mport_cdev_release_dma(filp: *mut file) {
...
//
#[no_mangle]
unsafe extern "C" fn mport_cdev_release(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mport_release_mapping(ref: *mut kref) {
    static void mport_release_mapping(struct kref *ref)
    {
    struct rio_mport_mapping *map =
...
#[no_mangle]
unsafe extern "C" fn mport_mm_open(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn mport_mm_close(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn mport_cdev_mmap(filp: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MAP_OUTBOUND: map->dir ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mport_cdev_poll(filp: *mut file, wait: *mut poll_table) -> __poll_t {
...
//
#[no_mangle]
unsafe extern "C" fn mport_device_release(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn mport_cdev_terminate_dma(md: *mut mport_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn mport_cdev_kill_fasync(md: *mut mport_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mport_cdev_remove(md: *mut mport_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn mport_add_mport(dev: *mut device) -> c_int {
    static int mport_add_mport(struct device *dev)
    {
    struct rio_mport *mport = core::ptr::null_mut();
    struct mport_dev *chdev = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn mport_remove_mport(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn mport_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn mport_exit() -> void __exit {
