...
//! Source: drivers/rapidio/rio-driver.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn rio_dev_put(rdev: *mut rio_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn rio_device_probe(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rio_device_remove(dev: *mut device) {
    ...
    if (rdrv.remove)
    rdrv.remove(rdev);
    rdev.driver = core::ptr::null_mut();
    }
    rio_dev_put(rdev);
    }
#[no_mangle]
unsafe extern "C" fn rio_device_shutdown(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rio_register_driver(rdrv: *mut rio_driver) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rio_unregister_driver(rdrv: *mut rio_driver) {
    void rio_unregister_driver(struct rio_driver *rdrv)
    {
    driver_unregister(&rdrv.driver);
    }
#[no_mangle]
pub unsafe extern "C" fn rio_attach_device(rdev: *mut rio_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn rio_match_bus(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rio_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rio_bus_init() -> int __init {
