...
//! Source: drivers/rapidio/switches/idtcps.c
#![no_std]
...
pub const CPS_DEFAULT_ROUTE: c_uint = 0xde;
pub const CPS_NO_ROUTE: c_uint = 0xdf;
pub const IDTCPS_RIO_DOMAIN: c_uint = 0xf20020;
    static int
...
// sw_domain = (u8)(regval & 0xff);
    ...
    .em_init = core::ptr::null_mut(),
    .em_handle = core::ptr::null_mut(),
    };
#[no_mangle]
unsafe extern "C" fn idtcps_probe(rdev: *mut rio_dev, id: *const rio_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idtcps_remove(rdev: *mut rio_dev) {
...
#[no_mangle]
unsafe extern "C" fn idtcps_init() -> int __init {
    static int __init idtcps_init(void)
    {
    return rio_register_driver(&idtcps_driver);
    }
#[no_mangle]
unsafe extern "C" fn idtcps_exit() -> void __exit {
