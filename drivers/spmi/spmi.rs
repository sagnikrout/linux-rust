...
#[no_mangle]
unsafe extern "C" fn spmi_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn spmi_ctrl_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn spmi_device_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spmi_device_add(sdev: *mut spmi_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spmi_device_remove(sdev: *mut spmi_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn spmi_register_read(sdev: *mut spmi_device, addr: u8, buf: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spmi_register_write(sdev: *mut spmi_device, addr: u8, data: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spmi_register_zero_write(sdev: *mut spmi_device, data: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spmi_command_reset(sdev: *mut spmi_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spmi_command_sleep(sdev: *mut spmi_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spmi_command_wakeup(sdev: *mut spmi_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spmi_command_shutdown(sdev: *mut spmi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmi_drv_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmi_drv_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn spmi_drv_shutdown(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn spmi_drv_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_spmi_register_devices(ctrl: *mut spmi_controller) {
...
//
#[no_mangle]
pub unsafe extern "C" fn spmi_controller_add(ctrl: *mut spmi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmi_ctrl_remove_device(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spmi_controller_remove(ctrl: *mut spmi_controller) {
    void spmi_controller_remove(struct spmi_controller *ctrl)
    {
    if (!ctrl)
    return;
    device_for_each_child(&ctrl.dev, core::ptr::null_mut(), spmi_ctrl_remove_device);
    device_del(&ctrl.dev);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn __spmi_driver_register(sdrv: *mut spmi_driver, owner: *mut module) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmi_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn spmi_init() -> int __init {
