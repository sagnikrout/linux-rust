...
//! Source: drivers/slimbus/stream.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct segdist_code {
    pub ratem: c_int,
    pub seg_interval: c_int,
    pub segdist_code: c_int,
    pub seg_offset_mask: u32,
}
...
//
    ...
    u8 wbuf[2];
    let mut msg: slim_val_inf = {0, 2, core::ptr::null_mut(), wbuf, core::ptr::null_mut()};
    let mut mc: u8 = SLIM_MSG_MC_CONNECT_SOURCE;
    ...
    struct slim_device *sdev = stream.dev;
    u8 wbuf[1];
    let mut msg: slim_val_inf = {0, 1, core::ptr::null_mut(), wbuf, core::ptr::null_mut()};
    let mut mc: u8 = SLIM_MSG_MC_DISCONNECT_PORT;
    ...
    u8 wbuf[1];
    let mut msg: slim_val_inf = {0, 1, core::ptr::null_mut(), wbuf, core::ptr::null_mut()};
    let mut mc: u8 = SLIM_MSG_MC_NEXT_DEACTIVATE_CHANNEL;
    DEFINE_SLIM_LDEST_TXN(txn, mc, 5, stream.dev.laddr, &msg);
    int ret;
    wbuf[0] = port.ch.id;
...
#[no_mangle]
unsafe extern "C" fn slim_get_prate_code(rate: c_int) -> c_int {
...
//
    ...
    struct slim_device *sdev = stream.dev;
    u8 wbuf[4];
    let mut msg: slim_val_inf = {0, 4, core::ptr::null_mut(), wbuf, core::ptr::null_mut()};
    let mut mc: u8 = SLIM_MSG_MC_NEXT_DEFINE_CONTENT;
...
#[no_mangle]
unsafe extern "C" fn slim_get_segdist_code(ratem: c_int) -> c_int {
    ...
    u8 wbuf[4];
    let mut msg: slim_val_inf = {0, 4, core::ptr::null_mut(), wbuf, core::ptr::null_mut()};
    let mut mc: u8 = SLIM_MSG_MC_NEXT_DEFINE_CHANNEL;
    DEFINE_SLIM_LDEST_TXN(txn, mc, 8, stream.dev.laddr, &msg);
    ...
    u8 wbuf[1];
    let mut msg: slim_val_inf = {0, 1, core::ptr::null_mut(), wbuf, core::ptr::null_mut()};
    let mut mc: u8 = SLIM_MSG_MC_NEXT_ACTIVATE_CHANNEL;
    DEFINE_SLIM_LDEST_TXN(txn, mc, 5, stream.dev.laddr, &msg);
    txn.msg.num_bytes = 1;
    txn.msg.wbuf = wbuf;
    wbuf[0] = port.ch.id;
...
//
#[no_mangle]
pub unsafe extern "C" fn slim_stream_enable(stream: *mut slim_stream_runtime) -> c_int {
    int slim_stream_enable(struct slim_stream_runtime *stream)
    {
    DEFINE_SLIM_BCAST_TXN(txn, SLIM_MSG_MC_BEGIN_RECONFIGURATION,
    3, SLIM_LA_MANAGER, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn slim_stream_disable(stream: *mut slim_stream_runtime) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn slim_stream_unprepare(stream: *mut slim_stream_runtime) -> c_int {
    ...
    kfree(stream.ports);
    stream.ports = core::ptr::null_mut();
    stream.num_ports = 0;
    return 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn slim_stream_free(stream: *mut slim_stream_runtime) -> c_int {
