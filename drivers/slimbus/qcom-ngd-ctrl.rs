...
//! Source: drivers/slimbus/qcom-ngd-ctrl.c
#![no_std]
...
pub const NGD_CFG: c_uint = 0x0;

pub const NGD_STATUS: c_uint = 0x4;

pub const NGD_RX_MSGQ_CFG: c_uint = 0x8;
pub const NGD_INT_EN: c_uint = 0x10;

pub const NGD_INT_STAT: c_uint = 0x14;
pub const NGD_INT_CLR: c_uint = 0x18;

    NGD_INT_MSG_TX_INVAL | NGD_INT_IE_VE_CHG | \
    NGD_INT_DEV_ERR | NGD_INT_TX_MSG_SENT | \
    NGD_INT_RX_MSG_RCVD)
// Slimbus QMI service
pub const SLIMBUS_QMI_SVC_ID: c_uint = 0x0301;
pub const SLIMBUS_QMI_SVC_V1: c_int = 1;
pub const SLIMBUS_QMI_INS_ID: c_int = 0;
pub const SLIMBUS_QMI_SELECT_INSTANCE_REQ_V01: c_uint = 0x0020;
pub const SLIMBUS_QMI_SELECT_INSTANCE_RESP_V01: c_uint = 0x0020;
pub const SLIMBUS_QMI_POWER_REQ_V01: c_uint = 0x0021;
pub const SLIMBUS_QMI_POWER_RESP_V01: c_uint = 0x0021;
pub const SLIMBUS_QMI_CHECK_FRAMER_STATUS_REQ: c_uint = 0x0022;
pub const SLIMBUS_QMI_CHECK_FRAMER_STATUS_RESP: c_uint = 0x0022;
pub const SLIMBUS_QMI_POWER_REQ_MAX_MSG_LEN: c_int = 14;
pub const SLIMBUS_QMI_POWER_RESP_MAX_MSG_LEN: c_int = 7;
pub const SLIMBUS_QMI_SELECT_INSTANCE_REQ_MAX_MSG_LEN: c_int = 14;
pub const SLIMBUS_QMI_SELECT_INSTANCE_RESP_MAX_MSG_LEN: c_int = 7;
pub const SLIMBUS_QMI_CHECK_FRAMER_STAT_RESP_MAX_MSG_LEN: c_int = 7;
// QMI response timeout of 500ms
pub const SLIMBUS_QMI_RESP_TOUT: c_int = 1000;
// User defined commands
pub const SLIM_USR_MC_GENERIC_ACK: c_uint = 0x25;
pub const SLIM_USR_MC_MASTER_CAPABILITY: c_uint = 0x0;
pub const SLIM_USR_MC_REPORT_SATELLITE: c_uint = 0x1;
pub const SLIM_USR_MC_ADDR_QUERY: c_uint = 0xD;
pub const SLIM_USR_MC_ADDR_REPLY: c_uint = 0xE;
pub const SLIM_USR_MC_DEFINE_CHAN: c_uint = 0x20;
pub const SLIM_USR_MC_DEF_ACT_CHAN: c_uint = 0x21;
pub const SLIM_USR_MC_CHAN_CTRL: c_uint = 0x23;
pub const SLIM_USR_MC_RECONFIG_NOW: c_uint = 0x24;
pub const SLIM_USR_MC_REQ_BW: c_uint = 0x28;
pub const SLIM_USR_MC_CONNECT_SRC: c_uint = 0x2C;
pub const SLIM_USR_MC_CONNECT_SINK: c_uint = 0x2D;
pub const SLIM_USR_MC_DISCONNECT_PORT: c_uint = 0x2E;
pub const SLIM_USR_MC_REPEAT_CHANGE_VALUE: c_uint = 0x0;
pub const SLIM_RX_MSGQ_TIMEOUT_VAL: c_uint = 0x10000;
pub const SLIM_LA_MGR: c_uint = 0xFF;
pub const SLIM_ROOT_FREQ: c_int = 24576000;
pub const LADDR_RETRY: c_int = 5;
// Per spec.max 40 bytes per received message
pub const SLIM_MSGQ_BUF_LEN: c_int = 40;
pub const QCOM_SLIM_NGD_DESC_NUM: c_int = 32;

    ((l) | ((mt) << 5) | ((mc) << 8) | ((dt) << 15) | ((ad) << 16))
pub const INIT_MX_RETRIES: c_int = 10;
pub const DEF_RETRY_MS: c_int = 10;
pub const SAT_MAGIC_LSB: c_uint = 0xD9;
pub const SAT_MAGIC_MSB: c_uint = 0xC5;
pub const SAT_MSG_VER: c_uint = 0x1;
pub const SAT_MSG_PROT: c_uint = 0x1;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ngd_reg_offset_data {
    pub size: u32 offset,,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_slim_ngd_qmi {
    pub qmi: qmi_handle,
    pub svc_info: sockaddr_qrtr,
    pub svc_event_hdl: qmi_handle,
    pub resp: qmi_response_type_v01,
    pub handle: *mut qmi_handle,
    pub qmi_comp: completion,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_slim_ngd_dma_desc {
    pub desc: *mut dma_async_tx_descriptor,
    pub ctrl: *mut qcom_slim_ngd_ctrl,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_slim_ngd_ctrl {
    pub framer: slim_framer,
    pub ctrl: slim_controller,
    pub qmi: qcom_slim_ngd_qmi,
    pub ngd: *mut qcom_slim_ngd,
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub dma_rx_channel: *mut dma_chan,
    pub dma_tx_channel: *mut dma_chan,
    pub rx_desc: [qcom_slim_ngd_dma_desc; QCOM_SLIM_NGD_DESC_NUM],
    pub txdesc: [qcom_slim_ngd_dma_desc; QCOM_SLIM_NGD_DESC_NUM],
    pub reconf: completion,
    pub m_work: work_struct,
    pub ngd_up_work: work_struct,
    pub mwq: *mut workqueue_struct,
    pub qmi_up: completion,
    pub tx_buf_lock: spinlock_t,
    pub tx_lock: mutex,
    pub ssr_lock: mutex,
    pub nb: notifier_block,
    pub notifier: *mut c_void,
    pub pdr: *mut pdr_handle,
    pub state: enum qcom_slim_ngd_state,
    pub rx_phys_base: dma_addr_t,
    pub tx_phys_base: dma_addr_t,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct slimbus_select_inst_req_msg_v01 {
    pub instance: u32,
    pub mode_valid: u8,
    pub mode: enum slimbus_mode_enum_type_v01,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct slimbus_select_inst_resp_msg_v01 {
    pub resp: qmi_response_type_v01,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct slimbus_power_req_msg_v01 {
    pub pm_req: enum slimbus_pm_enum_type_v01,
    pub resp_type_valid: u8,
    pub resp_type: enum slimbus_resp_enum_type_v01,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct slimbus_power_resp_msg_v01 {
    pub resp: qmi_response_type_v01,
}
    ...
    {
    let mut resp: slimbus_select_inst_resp_msg_v01 = { { 0, 0 } };
    struct qmi_txn txn;
    int rc;
    ...
    rc = qmi_send_request(ctrl.qmi.handle, core::ptr::null_mut(), &txn,
...
// Check the response
    ...
    {
    let mut resp: slimbus_power_resp_msg_v01 = { { 0, 0 } };
    struct qmi_txn txn;
    int rc;
    rc = qmi_txn_init(ctrl.qmi.handle, &txn,
...
// Check the response
    ...
    core::ptr::null_mut(), qcom_slim_qmi_msg_handlers);
    if (rc < 0) {
...
// Mode indicates the role of the ADSP
    ...
    ctrl.qmi.handle = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_qmi_exit(ctrl: *mut qcom_slim_ngd_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_tx_msg_dma_cb(args: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_rx(ctrl: *mut qcom_slim_ngd_ctrl, buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_rx_msgq_cb(args: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_post_rx_msgq(ctrl: *mut qcom_slim_ngd_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_init_rx_msgq(ctrl: *mut qcom_slim_ngd_ctrl) -> c_int {
    ...
    ctrl.dma_rx_channel = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_init_tx_msgq(ctrl: *mut qcom_slim_ngd_ctrl) -> c_int {
    ...
    ctrl.dma_tx_channel = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_init_dma(ctrl: *mut qcom_slim_ngd_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
    ...
    u32 *pbuf;
    u8 *puc;
    let mut la: u8 = txn.la;
    let mut usr_msg: bool = false;
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_calc_coef(rt: *mut slim_stream_runtime, exp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_enable_stream(rt: *mut slim_stream_runtime) -> c_int {
    static int qcom_slim_ngd_enable_stream(struct slim_stream_runtime *rt)
    {
    struct slim_device *sdev = rt.dev;
    struct slim_controller *ctrl = sdev.ctrl;
    let mut msg: slim_val_inf = {0};
    u8 wbuf[SLIM_MSGQ_BUF_LEN];
    u8 rbuf[SLIM_MSGQ_BUF_LEN];
    let mut txn: slim_msg_txn = {0,};
    int i, ret;
    txn.mt = SLIM_MSG_MT_DEST_REFERRED_USER;
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_exit_dma(ctrl: *mut qcom_slim_ngd_ctrl) -> c_int {
    ...
    ctrl.dma_tx_channel = ctrl.dma_rx_channel = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_setup(ctrl: *mut qcom_slim_ngd_ctrl) {
    static void qcom_slim_ngd_setup(struct qcom_slim_ngd_ctrl *ctrl)
    {
    let mut cfg: u32 = readl_relaxed(ctrl.ngd.base);
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_power_up(ctrl: *mut qcom_slim_ngd_ctrl) -> c_int {
    static int qcom_slim_ngd_power_up(struct qcom_slim_ngd_ctrl *ctrl)
    {
    let mut cur_state: enum qcom_slim_ngd_state = ctrl.state;
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_notify_slaves(ctrl: *mut qcom_slim_ngd_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_master_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_update_device_status(dev: *mut device, null: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_enable(ctrl: *mut qcom_slim_ngd_ctrl, enable: bool) -> c_int {
    static int qcom_slim_ngd_enable(struct qcom_slim_ngd_ctrl *ctrl, bool enable)
    {
    if (enable) {
    let mut ret: c_int = qcom_slim_qmi_init(ctrl, false);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_qmi_svc_event_init(ctrl: *mut qcom_slim_ngd_ctrl) -> c_int {
    ...
    &qcom_slim_ngd_qmi_svc_event_ops, core::ptr::null_mut());
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_qmi_svc_event_deinit(qmi: *mut qcom_slim_ngd_qmi) {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_down(ctrl: *mut qcom_slim_ngd_ctrl) {
    static void qcom_slim_ngd_down(struct qcom_slim_ngd_ctrl *ctrl)
    {
    mutex_lock(&ctrl.ssr_lock);
    device_for_each_child(ctrl.ctrl.dev, core::ptr::null_mut(),
    qcom_slim_ngd_update_device_status);
    qcom_slim_ngd_enable(ctrl, false);
    mutex_unlock(&ctrl.ssr_lock);
    }
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_up_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn slim_pd_status(state: c_int, svc_path: *mut c_char, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_unregister(ctrl: *mut qcom_slim_ngd_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_ctrl_probe(pdev: *mut platform_device) -> c_int {
    ...
    ctrl.base = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
    if (IS_ERR(ctrl.base))
    ...
    ctrl.ctrl.wakeup = core::ptr::null_mut();
    ctrl.state = QCOM_SLIM_NGD_CTRL_DOWN;
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_ctrl_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_remove(pdev: *mut platform_device) {
    ...
    kfree(ctrl.ngd);
    ctrl.ngd = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_runtime_idle(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_slim_ngd_exit() {
