...
//! Source: drivers/slimbus/sched.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn slim_ctrl_clk_pause(ctrl: *mut slim_controller, wakeup: bool, restart: u8) -> c_int {
    int slim_ctrl_clk_pause(struct slim_controller *ctrl, bool wakeup, u8 restart)
    {
    int i, ret = 0;
    unsigned long flags;
    struct slim_sched *sched = &ctrl.sched;
    let mut msg: slim_val_inf = {0, 0, core::ptr::null_mut(), core::ptr::null_mut()};
