...
#[no_mangle]
unsafe extern "C" fn slim_device_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slim_device_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slim_device_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn slim_device_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __slim_driver_register(drv: *mut slim_driver, owner: *mut module) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn slim_driver_unregister(drv: *mut slim_driver) {
...
#[no_mangle]
unsafe extern "C" fn slim_dev_release(dev: *mut device) {
    ...
    sbdev.dev.driver = core::ptr::null_mut();
    sbdev.ctrl = ctrl;
...
#[no_mangle]
unsafe extern "C" fn of_register_slim_devices(ctrl: *mut slim_controller) {
    ...
    const char *compat = core::ptr::null_mut();
    int reg[2], ret;
    int manf_id, prod_code;
    compat = of_get_property(node, "compatible", core::ptr::null_mut());
    if (!compat)
    continue;
...
//
#[no_mangle]
pub unsafe extern "C" fn slim_register_controller(ctrl: *mut slim_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slim_remove_device(sbdev: *mut slim_device) {
    static void slim_remove_device(struct slim_device *sbdev)
    {
    device_unregister(&sbdev.dev);
    }
#[no_mangle]
unsafe extern "C" fn slim_ctrl_remove_device(dev: *mut device, null: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn slim_unregister_controller(ctrl: *mut slim_controller) -> c_int {
    int slim_unregister_controller(struct slim_controller *ctrl)
    {
// Remove all clients
    device_for_each_child(ctrl.dev, core::ptr::null_mut(), slim_ctrl_remove_device);
...
//
#[no_mangle]
pub unsafe extern "C" fn slim_report_absent(sbdev: *mut slim_device) {
...
#[no_mangle]
unsafe extern "C" fn slim_match_dev(dev: *mut device, data: *const c_void) -> c_int {
...
//
    ...
    if (!sbdev) {
    sbdev = slim_alloc_device(ctrl, e_addr, core::ptr::null_mut());
    if (!sbdev)
...
//
#[no_mangle]
pub unsafe extern "C" fn slim_get_logical_addr(sbdev: *mut slim_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slimbus_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn slimbus_init() -> int __init {
