...
pub const SVC_INTF_EJECT_TIMEOUT: c_int = 9000;
pub const SVC_INTF_ACTIVATE_TIMEOUT: c_int = 6000;
pub const SVC_INTF_RESUME_TIMEOUT: c_int = 3000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gb_svc_deferred_request {
...
#[no_mangle]
pub unsafe extern "C" fn if(GB_SVC_WATCHDOG_BITE_RESET_UNIPRO: svc->action ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "reset")) -> else {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_pwrmon_rail_count_get(svc: *mut gb_svc, value: *mut u8) -> c_int {
    ...
    GB_SVC_TYPE_PWRMON_RAIL_COUNT_GET, core::ptr::null_mut(), 0,
...
// value = response.rail_count;
    ...
    int ret;
    ret = gb_operation_sync(svc.connection,
    GB_SVC_TYPE_PWRMON_RAIL_NAMES_GET, core::ptr::null_mut(), 0,
    response, bufsize);
    if (ret) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_svc_intf_device_id(svc: *mut gb_svc, intf_id: u8, device_id: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gb_svc_intf_eject(svc: *mut gb_svc, intf_id: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gb_svc_intf_vsys_set(svc: *mut gb_svc, intf_id: u8, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gb_svc_intf_refclk_set(svc: *mut gb_svc, intf_id: u8, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gb_svc_intf_unipro_set(svc: *mut gb_svc, intf_id: u8, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gb_svc_intf_activate(svc: *mut gb_svc, intf_id: u8, intf_type: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gb_svc_intf_resume(svc: *mut gb_svc, intf_id: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gb_svc_route_destroy(svc: *mut gb_svc, intf1_id: u8, intf2_id: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_svc_intf_set_power_mode_hibernate(svc: *mut gb_svc, intf_id: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gb_svc_ping(svc: *mut gb_svc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_version_request(op: *mut gb_operation) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_pwrmon_debugfs_init(svc: *mut gb_svc) {
    ...
    svc.pwrmon_rails = core::ptr::null_mut();
    err_pwrmon_debugfs:
    debugfs_remove(dent);
    }
#[no_mangle]
unsafe extern "C" fn gb_svc_debugfs_init(svc: *mut gb_svc) {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_debugfs_exit(svc: *mut gb_svc) {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_hello(op: *mut gb_operation) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_process_hello_deferred(operation: *mut gb_operation) {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_process_module_inserted(operation: *mut gb_operation) {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_process_module_removed(operation: *mut gb_operation) {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_process_intf_oops(operation: *mut gb_operation) {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_process_intf_mailbox_event(operation: *mut gb_operation) {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_process_deferred_request(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_queue_deferred_request(operation: *mut gb_operation) -> c_int {
    static int gb_svc_queue_deferred_request(struct gb_operation *operation)
    {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_intf_reset_recv(op: *mut gb_operation) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_module_inserted_recv(op: *mut gb_operation) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_module_removed_recv(op: *mut gb_operation) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_intf_oops_recv(op: *mut gb_operation) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_intf_mailbox_event_recv(op: *mut gb_operation) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_request_handler(op: *mut gb_operation) -> c_int {
    static int gb_svc_request_handler(struct gb_operation *op)
    {
    struct gb_connection *connection = op.connection;
    struct gb_svc *svc = gb_connection_get_data(connection);
    let mut type: u8 = op.type;
    let mut ret: c_int = 0;
//
...
#[no_mangle]
unsafe extern "C" fn gb_svc_release(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_svc_add(svc: *mut gb_svc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_svc_remove_modules(svc: *mut gb_svc) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_svc_del(svc: *mut gb_svc) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_svc_put(svc: *mut gb_svc) {
