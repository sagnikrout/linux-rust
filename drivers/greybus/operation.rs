...
//! Source: drivers/greybus/operation.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn gb_operation_get_active(operation: *mut gb_operation) -> c_int {
...
// Caller holds operation reference.
#[no_mangle]
unsafe extern "C" fn gb_operation_put_active(operation: *mut gb_operation) {
...
#[no_mangle]
unsafe extern "C" fn gb_operation_is_active(operation: *mut gb_operation) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn gb_operation_result_set(operation: *mut gb_operation, result: c_int) -> bool {
...
//
    ...
    spin_unlock_irqrestore(&gb_operations_lock, flags);
    let mut prev: return = = -EINPROGRESS;
    }
#[no_mangle]
pub unsafe extern "C" fn gb_operation_result(operation: *mut gb_operation) -> c_int {
    int gb_operation_result(struct gb_operation *operation)
    {
    let mut result: c_int = operation.errno;
...
//
    ...
    spin_unlock_irqrestore(&connection.lock, flags);
    return found ? operation : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn gb_message_send(message: *mut gb_message, gfp: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_operation_request_handle(operation: *mut gb_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn gb_operation_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn gb_operation_timeout(t: *mut timer_list) {
...
//
    ...
    message.payload = payload_size ? header + 1 : core::ptr::null_mut();
...
//
    ...
    let mut message_size: u16 = (u16)(sizeof(*header) + payload_size);
//
...
//
    ...
    struct gb_message *message;
    struct gb_operation_msg_hdr *header;
    let mut message_size: usize = payload_size + sizeof(*header);
...
#[no_mangle]
unsafe extern "C" fn gb_operation_message_free(message: *mut gb_message) {
...
//
#[no_mangle]
unsafe extern "C" fn gb_operation_status_map(status: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gb_operation_errno_map(errno: c_int) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn gb_operation_get_payload_size_max(connection: *mut gb_connection) -> usize {
    ...
    struct gb_operation *operation;
    size_t request_size;
    let mut flags: c_ulong = GB_OPERATION_FLAG_INCOMING;
...
//
#[no_mangle]
pub unsafe extern "C" fn gb_operation_get(operation: *mut gb_operation) {
...
//
#[no_mangle]
unsafe extern "C" fn _gb_operation_destroy(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gb_operation_put(operation: *mut gb_operation) {
...
#[no_mangle]
unsafe extern "C" fn gb_operation_sync_callback(operation: *mut gb_operation) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gb_operation_cancel(operation: *mut gb_operation, errno: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gb_operation_cancel_incoming(operation: *mut gb_operation, errno: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_operation_init() -> int __init {
    ...
    gb_operation_cache = core::ptr::null_mut();
    err_destroy_message_cache:
    kmem_cache_destroy(gb_message_cache);
    gb_message_cache = core::ptr::null_mut();
    return -ENOMEM;
    }
#[no_mangle]
pub unsafe extern "C" fn gb_operation_exit() {
    void gb_operation_exit(void)
    {
    destroy_workqueue(gb_operation_completion_wq);
    gb_operation_completion_wq = core::ptr::null_mut();
    kmem_cache_destroy(gb_operation_cache);
    gb_operation_cache = core::ptr::null_mut();
    kmem_cache_destroy(gb_message_cache);
    gb_message_cache = core::ptr::null_mut();
