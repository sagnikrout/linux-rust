...
//! Source: drivers/greybus/manifest.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct manifest_desc {
    pub links: list_head,
    pub size: usize,
    pub data: *mut c_void,
    pub type: enum greybus_descriptor_type,
}

#[no_mangle]
unsafe extern "C" fn release_manifest_descriptor(descriptor: *mut manifest_desc) {
...
#[no_mangle]
unsafe extern "C" fn release_manifest_descriptors(intf: *mut gb_interface) {
...
#[no_mangle]
unsafe extern "C" fn release_cport_descriptors(head: *mut list_head, bundle_id: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn gb_manifest_parse_cports(bundle: *mut gb_bundle) -> u32 {
    ...
    LIST_HEAD(list);
    let mut bundle_id: u8 = bundle.id;
    u16 cport_id;
    let mut count: u32 = 0;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn gb_manifest_parse_bundles(intf: *mut gb_interface) -> u32 {
...
// An interface must have at least one bundle descriptor
    ...
    control.product_string = core::ptr::null_mut();
    out_free_vendor_string:
    kfree(control.vendor_string);
    control.vendor_string = core::ptr::null_mut();
    return false;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn gb_manifest_parse(intf: *mut gb_interface, data: *mut c_void, size: usize) -> bool {
    ...
    struct manifest_desc *descriptor;
    struct manifest_desc *interface_desc = core::ptr::null_mut();
    u16 manifest_size;
    let mut found: u32 = 0;
    bool result;
