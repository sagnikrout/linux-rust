...
//! Source: drivers/greybus/interface.c
#![no_std]
...
pub const GB_INTERFACE_MODE_SWITCH_TIMEOUT: c_int = 2000;
pub const GB_INTERFACE_DEVICE_ID_BAD: c_uint = 0xff;
pub const GB_INTERFACE_AUTOSUSPEND_MS: c_int = 3000;
// Time required for interface to enter standby before disabling REFCLK
pub const GB_INTERFACE_SUSPEND_HIBERNATE_DELAY_MS: c_int = 20;
// Don't-care selector index
pub const DME_SELECTOR_INDEX_NULL: c_int = 0;
// DME attributes
// FIXME: remove ES2 support and DME_T_TST_SRC_INCREMENT
pub const DME_T_TST_SRC_INCREMENT: c_uint = 0x4083;
pub const DME_DDBL1_MANUFACTURERID: c_uint = 0x5003;
pub const DME_DDBL1_PRODUCTID: c_uint = 0x5004;
pub const DME_TOSHIBA_GMP_VID: c_uint = 0x6000;
pub const DME_TOSHIBA_GMP_PID: c_uint = 0x6001;
pub const DME_TOSHIBA_GMP_SN0: c_uint = 0x6002;
pub const DME_TOSHIBA_GMP_SN1: c_uint = 0x6003;
pub const DME_TOSHIBA_GMP_INIT_STATUS: c_uint = 0x6101;
// DDBL1 Manufacturer and Product ids
pub const TOSHIBA_DMID: c_uint = 0x0126;
pub const TOSHIBA_ES2_BRIDGE_DPID: c_uint = 0x1000;
pub const TOSHIBA_ES3_APBRIDGE_DPID: c_uint = 0x1001;
pub const TOSHIBA_ES3_GBPHY_DPID: c_uint = 0x1002;
...
#[no_mangle]
unsafe extern "C" fn gb_interface_read_ara_dme(intf: *mut gb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_interface_read_dme(intf: *mut gb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_interface_route_create(intf: *mut gb_interface) -> c_int {
    static int gb_interface_route_create(struct gb_interface *intf)
    {
    struct gb_svc *svc = intf.hd.svc;
    let mut intf_id: u8 = intf.interface_id;
    u8 device_id;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn gb_interface_route_destroy(intf: *mut gb_interface) {
...
#[no_mangle]
unsafe extern "C" fn gb_interface_legacy_mode_switch(intf: *mut gb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_interface_mode_switch_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_interface_request_mode_switch(intf: *mut gb_interface) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gb_interface_read_and_clear_init_status(intf: *mut gb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_interface_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn gb_interface_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_interface_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_interface_runtime_idle(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_interface_vsys_set(intf: *mut gb_interface, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_interface_refclk_set(intf: *mut gb_interface, enable: bool) -> c_int {
    static int gb_interface_refclk_set(struct gb_interface *intf, bool enable)
    {
    struct gb_svc *svc = intf.hd.svc;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn gb_interface_unipro_set(intf: *mut gb_interface, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_interface_hibernate_link(intf: *mut gb_interface) -> c_int {
    static int gb_interface_hibernate_link(struct gb_interface *intf)
    {
    struct gb_svc *svc = intf.hd.svc;
...
//
#[no_mangle]
pub unsafe extern "C" fn gb_interface_activate(intf: *mut gb_interface) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn gb_interface_deactivate(intf: *mut gb_interface) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gb_interface_enable(intf: *mut gb_interface) -> c_int {
...
// Register the control device and any bundles
    ...
    intf.control = core::ptr::null_mut();
    return ret;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn gb_interface_disable(intf: *mut gb_interface) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_interface_add(intf: *mut gb_interface) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gb_interface_del(intf: *mut gb_interface) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_interface_put(intf: *mut gb_interface) {
