...
//! Source: drivers/greybus/connection.c
#![no_std]
...
pub const GB_CONNECTION_CPORT_QUIESCE_TIMEOUT: c_int = 1000;
    static void gb_connection_kref_release(struct kref *kref);
    static DEFINE_SPINLOCK(gb_connections_lock);
    static DEFINE_MUTEX(gb_connection_mutex);
// Caller holds gb_connection_mutex.
#[no_mangle]
unsafe extern "C" fn gb_connection_cport_in_use(intf: *mut gb_interface, cport_id: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gb_connection_get(connection: *mut gb_connection) {
...
#[no_mangle]
unsafe extern "C" fn gb_connection_put(connection: *mut gb_connection) {
...
#[no_mangle]
unsafe extern "C" fn gb_connection_kref_release(kref: *mut kref) {
    static void gb_connection_kref_release(struct kref *kref)
    {
    struct gb_connection *connection;
...
#[no_mangle]
unsafe extern "C" fn gb_connection_init_name(connection: *mut gb_connection) {
    static void gb_connection_init_name(struct gb_connection *connection)
    {
    let mut hd_cport_id: u16 = connection.hd_cport_id;
    let mut cport_id: u16 = 0;
    let mut intf_id: u8 = 0;
    if (connection.intf) {
...
//
    ...
    gb_request_handler_t handler)
    {
    return _gb_connection_create(hd, hd_cport_id, core::ptr::null_mut(), core::ptr::null_mut(), 0, handler,
    GB_CONNECTION_FLAG_HIGH_PRIO);
    }
    struct gb_connection *
    gb_connection_create_control(struct gb_interface *intf)
    {
    return _gb_connection_create(intf.hd, -1, intf, core::ptr::null_mut(), 0, core::ptr::null_mut(),
    ...
    return gb_connection_create_flags(bundle, cport_id, core::ptr::null_mut(), flags);
    }
    EXPORT_SYMBOL_GPL(gb_connection_create_offloaded);
#[no_mangle]
unsafe extern "C" fn gb_connection_hd_cport_enable(connection: *mut gb_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_connection_hd_cport_disable(connection: *mut gb_connection) {
...
#[no_mangle]
unsafe extern "C" fn gb_connection_hd_cport_connected(connection: *mut gb_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_connection_hd_cport_flush(connection: *mut gb_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_connection_hd_cport_quiesce(connection: *mut gb_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_connection_hd_cport_clear(connection: *mut gb_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gb_connection_control_connected(connection: *mut gb_connection) -> c_int {
    static int gb_connection_control_connected(struct gb_connection *connection)
    {
    struct gb_control *control;
    let mut cport_id: u16 = connection.intf_cport_id;
    int ret;
    if (gb_connection_is_static(connection))
    return 0;
...
//
#[no_mangle]
unsafe extern "C" fn _gb_connection_enable(connection: *mut gb_connection, rx: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gb_connection_enable(connection: *mut gb_connection) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gb_connection_enable_tx(connection: *mut gb_connection) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gb_connection_disable_rx(connection: *mut gb_connection) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_connection_mode_switch_prepare(connection: *mut gb_connection) {
    void gb_connection_mode_switch_prepare(struct gb_connection *connection)
    {
    connection.mode_switch = true;
    }
#[no_mangle]
pub unsafe extern "C" fn gb_connection_mode_switch_complete(connection: *mut gb_connection) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_connection_disable(connection: *mut gb_connection) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_connection_disable_forced(connection: *mut gb_connection) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_connection_destroy(connection: *mut gb_connection) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_connection_latency_tag_enable(connection: *mut gb_connection) {
...
#[no_mangle]
pub unsafe extern "C" fn gb_connection_latency_tag_disable(connection: *mut gb_connection) {
