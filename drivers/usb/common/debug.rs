...
//! Source: drivers/usb/common/debug.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn usb_decode_set_address(wValue: __u16, str: *mut c_char, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn usb_decode_get_configuration(wLength: __u16, str: *mut c_char, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn usb_decode_set_configuration(wValue: __u8, str: *mut c_char, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn usb_decode_set_sel(wLength: __u16, str: *mut c_char, size: usize) {
    static void usb_decode_set_sel(__u16 wLength, char *str, size_t size)
    {
    snprintf(str, size, "Set SEL(Length = %d)", wLength);
    }
#[no_mangle]
unsafe extern "C" fn usb_decode_set_isoch_delay(wValue: __u8, str: *mut c_char, size: usize) {
    ...
    __u16 wLength)
    {
    let mut recip: u8 = bRequestType & USB_RECIP_MASK;
    let mut type: u8 = bRequestType & USB_TYPE_MASK;
    snprintf(str, size,
