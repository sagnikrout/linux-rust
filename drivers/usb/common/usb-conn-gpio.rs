...
//! Source: drivers/usb/common/usb-conn-gpio.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usb_conn_info {
    pub dev: *mut device,
    pub /: *mut *mut int conn_id; / store the IDA-allocated ID,
    pub role_sw: *mut usb_role_switch,
    pub last_role: enum usb_role,
    pub vbus: *mut regulator,
    pub dw_det: delayed_work,
...
//
#[no_mangle]
unsafe extern "C" fn usb_conn_detect_cable(work: *mut work_struct) {
...
// check ID and VBUS
    ...
    role = USB_ROLE_HOST;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: vbus) -> else {
    else if (vbus)
...
#[no_mangle]
unsafe extern "C" fn usb_conn_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn usb_conn_psy_register(info: *mut usb_conn_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_conn_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_conn_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn usb_conn_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn usb_conn_resume(dev: *mut device) -> int __maybe_unused {
