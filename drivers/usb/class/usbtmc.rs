...
//! Source: drivers/usb/class/usbtmc.c
#![no_std]
...
pub const USBTMC_HEADER_SIZE: c_int = 12;
pub const USBTMC_MINOR_BASE: c_int = 176;
// Minimum USB timeout (in milliseconds)
pub const USBTMC_MIN_TIMEOUT: c_int = 100;
// Default USB timeout (in milliseconds)
pub const USBTMC_TIMEOUT: c_int = 5000;
// Max number of urbs used in write transfers
pub const MAX_URBS_IN_FLIGHT: c_int = 16;
...
//
pub const USBTMC_MAX_READS_TO_CLEAR_BULK_IN: c_int = 100;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usbtmc_dev_capabilities {
    pub interface_capabilities: __u8,
    pub device_capabilities: __u8,
    pub usb488_interface_capabilities: __u8,
    pub usb488_device_capabilities: __u8,
}
...
pub struct usbtmc_device_data {
    ...
    pub bulk_out: c_uint,
    pub bTag: u8,
    pub /: *mut *mut u8 bTag_last_write; / needed for abort,
    pub /: *mut *mut u8 bTag_last_read; / needed for abort,
...
// data for interrupt in endpoint handling
    ...
    pub ifnum: u16,
    pub iin_bTag: u8,
    pub iin_buffer: *mut u8,
    pub iin_data_valid: core::sync::atomic::AtomicI32,
    pub iin_ep: c_uint,
    pub iin_ep_present: c_int,
    pub iin_interval: c_int,
    pub iin_urb: *mut urb,
    pub iin_wMaxPacketSize: u16,
// coalesced usb488_caps from usbtmc_dev_capabilities
    pub usb488_caps: __u8,
    pub /: *mut *mut bool zombie; / fd of disconnected device,
    pub capabilities: usbtmc_dev_capabilities,
    pub kref: kref,
    pub /: *mut *mut mutex io_mutex; / only one i/o function running at a time,
    pub waitq: wait_queue_head_t,
    pub fasync: *mut fasync_struct,
    pub /: *mut *mut spinlock_t dev_lock; / lock for file_list,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usbtmc_file_data {
    pub data: *mut usbtmc_device_data,
    pub file_elem: list_head,
    pub timeout: u32,
    pub srq_byte: u8,
    pub srq_asserted: core::sync::atomic::AtomicI32,
    pub closing: core::sync::atomic::AtomicI32,
    pub /: *mut *mut u8 bmTransferAttributes; / member of DEV_DEP_MSG_IN,
    pub eom_val: u8,
    pub term_char: u8,
...
// data for generic_write
    pub limit_write_sem: semaphore,
    pub out_transfer_size: u32,
    pub out_status: c_int,
// data for generic_read
    pub in_transfer_size: u32,
    pub in_status: c_int,
    pub in_urbs_used: c_int,
    pub in_anchor: usb_anchor,
    pub wait_bulk_in: wait_queue_head_t,
}
...
#[no_mangle]
unsafe extern "C" fn usbtmc_delete(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_open(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usbtmc_flush(file: *mut file, id: fl_owner_t) -> c_int {
    static int usbtmc_flush(struct file *file, fl_owner_t id)
    {
    struct usbtmc_file_data *file_data;
    struct usbtmc_device_data *data;
    file_data = file.private_data;
    if (file_data == core::ptr::null_mut())
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn usbtmc_release(inode: *mut inode, file: *mut file) -> c_int {
...
// flush anchored URBs
    ...
    file_data.data = core::ptr::null_mut();
    kfree(file_data);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn usbtmc_ioctl_abort_bulk_in(data: *mut usbtmc_device_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_ioctl_abort_bulk_out(data: *mut usbtmc_device_data) -> c_int {
    static int usbtmc_ioctl_abort_bulk_out(struct usbtmc_device_data *data)
    {
    return usbtmc_ioctl_abort_bulk_out_tag(data, data.bTag_last_write);
    }
#[no_mangle]
unsafe extern "C" fn usbtmc_get_stb(file_data: *mut usbtmc_file_data, stb: *mut __u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usbtmc488_ioctl_trigger(file_data: *mut usbtmc_file_data) -> c_int {
...
// Increment bTag -- and increment again if zero
    ...
    {
    let mut bufsize: usize = USBTMC_BUFSIZE;
    u8 *dmabuf = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn usbtmc_read_bulk_cb(urb: *mut urb) {
...
#[no_mangle]
pub unsafe extern "C" fn usbtmc_do_transfer(file_data: *mut usbtmc_file_data) -> bool {
    ...
    let mut done: u32 = 0;
    u32 remaining;
    let mut bufsize: u32 = USBTMC_BUFSIZE;
    let mut retval: c_int = 0;
    u32 max_transfer_size;
    unsigned long expire;
    let mut bufcount: c_int = 1;
...
// urb is anchored. We can release our reference.
    ...
    if (user_buffer == core::ptr::null_mut())
    return -EINVAL;
    expire = msecs_to_jiffies(file_data.timeout);
...
#[no_mangle]
unsafe extern "C" fn usbtmc_write_bulk_cb(urb: *mut urb) {
    static void usbtmc_write_bulk_cb(struct urb *urb)
    {
    struct usbtmc_file_data *file_data = urb.context;
    let mut wakeup: c_int = 0;
    unsigned long flags;
    spin_lock_irqsave(&file_data.err_lock, flags);
...
//
    ...
    usb_free_urb(urb);
    urb = core::ptr::null_mut(); /* urb will be finally released by usb driver */
    remaining -= this_part;
    done += this_part;
    }
...
#[no_mangle]
unsafe extern "C" fn usbtmc_ioctl_clear(data: *mut usbtmc_device_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_ioctl_clear_out_halt(data: *mut usbtmc_device_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_ioctl_clear_in_halt(data: *mut usbtmc_device_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_ioctl_cancel_io(file_data: *mut usbtmc_file_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_ioctl_cleanup_io(file_data: *mut usbtmc_file_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_capabilities(data: *mut usbtmc_device_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_ioctl_indicator_pulse(data: *mut usbtmc_device_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
    static long usbtmc_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
    {
    struct usbtmc_file_data *file_data;
    struct usbtmc_device_data *data;
    let mut retval: c_int = -EBADRQC;
    __u8 tmp_byte;
    file_data = file.private_data;
    data = file_data.data;
    mutex_lock(&data.io_mutex);
...
#[no_mangle]
unsafe extern "C" fn usbtmc_fasync(fd: c_int, file: *mut file, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_interrupt(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_free_int(data: *mut usbtmc_device_data) {
    ...
    data.iin_buffer = core::ptr::null_mut();
    usb_free_urb(data.iin_urb);
    data.iin_urb = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn usbtmc_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_draw_down(file_data: *mut usbtmc_file_data) {
    static void usbtmc_draw_down(struct usbtmc_file_data *file_data)
    {
    int time;
...
#[no_mangle]
unsafe extern "C" fn usbtmc_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_pre_reset(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbtmc_post_reset(intf: *mut usb_interface) -> c_int {
