...
//! Source: drivers/usb/cdns3/cdns3-ep0.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cdns3_prepare_setup_packet(priv_dev: *mut cdns3_device) {
...
//
    ...
    struct usb_ctrlrequest *ctrl_req)
    {
    let mut device_state: enum usb_device_state = priv_dev.gadget.state;
...
#[no_mangle]
pub unsafe extern "C" fn if(EP_WEDGE): !(priv_ep->flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn __pending_setup_status_handler(priv_dev: *mut cdns3_device) {
...
#[no_mangle]
pub unsafe extern "C" fn cdns3_pending_setup_status_handler(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns3_ep0_setup_phase(priv_dev: *mut cdns3_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(CDNS3_STATUS_STAGE: priv_dev->ep0_stage ==) -> else {
    else if (priv_dev.ep0_stage == CDNS3_STATUS_STAGE)
    cdns3_ep0_complete_setup(priv_dev, 0, 1);
    }
#[no_mangle]
unsafe extern "C" fn cdns3_transfer_completed(priv_dev: *mut cdns3_device) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns3_check_new_setup(priv_dev: *mut cdns3_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn cdns3_check_ep0_interrupt_proceed(priv_dev: *mut cdns3_device, dir: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns3_gadget_ep0_disable(ep: *mut usb_ep) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cdns3_gadget_ep0_set_halt(ep: *mut usb_ep, value: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cdns3_gadget_ep_set_wedge(ep: *mut usb_ep) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cdns3_ep0_config(priv_dev: *mut cdns3_device) {
    void cdns3_ep0_config(struct cdns3_device *priv_dev)
    {
    struct cdns3_usb_regs __iomem *regs;
    struct cdns3_endpoint *priv_ep;
    let mut max_packet_size: u32 = 64;
    u32 ep_cfg;
    regs = priv_dev.regs;
    if (priv_dev.gadget.speed == USB_SPEED_SUPER)
    max_packet_size = 512;
