...
//! Source: drivers/usb/cdns3/cdnsp-ring.c
#![no_std]
...
//
    ...
    union cdnsp_trb *trb)
    {
    let mut segment_offset: c_ulong = trb - seg.trbs;
    if (trb < seg.trbs || segment_offset >= TRBS_PER_SEGMENT)
    return 0;
    return seg.dma + (segment_offset * sizeof(*trb));
    }
#[no_mangle]
unsafe extern "C" fn cdnsp_trb_is_noop(trb: *mut union cdnsp_trb) -> bool {
    static bool cdnsp_trb_is_noop(union cdnsp_trb *trb)
    {
    return TRB_TYPE_NOOP_LE32(trb.generic.field[3]);
    }
#[no_mangle]
unsafe extern "C" fn cdnsp_trb_is_link(trb: *mut union cdnsp_trb) -> bool {
    static bool cdnsp_trb_is_link(union cdnsp_trb *trb)
    {
    return TRB_TYPE_LINK_LE32(trb.link.control);
    }
#[no_mangle]
pub unsafe extern "C" fn cdnsp_last_trb_on_seg(seg: *mut cdnsp_segment, trb: *mut union cdnsp_trb) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cdnsp_link_trb_toggles_cycle(trb: *mut union cdnsp_trb) -> bool {
    static bool cdnsp_link_trb_toggles_cycle(union cdnsp_trb *trb)
    {
    return le32_to_cpu(trb.link.control) & LINK_TOGGLE;
    }
#[no_mangle]
unsafe extern "C" fn cdnsp_trb_to_noop(trb: *mut union cdnsp_trb, noop_type: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cdnsp_inc_deq(pdev: *mut cdnsp_device, ring: *mut cdnsp_ring) {
...
//
#[no_mangle]
unsafe extern "C" fn cdnsp_force_l0_go(pdev: *mut cdnsp_device) {
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_ring_cmd_db(pdev: *mut cdnsp_device) {
...
//
    ...
    let mut ep_state: c_uint = pep.ep_state;
...
//
    ...
    {
    let mut td_last_trb_found: bool = false;
...
// Search wrapped around, bail out.
    ...
    state.new_deq_seg = core::ptr::null_mut();
    state.new_deq_ptr = core::ptr::null_mut();
    return;
    }
...
// Restart any rings with pending requests
    ...
    {
    struct cdnsp_dequeue_state deq_state;
    struct cdnsp_td *cur_td = core::ptr::null_mut();
    struct cdnsp_ring *ep_ring;
    struct cdnsp_segment *seg;
    let mut status: c_int = -ECONNRESET;
    let mut ret: c_int = 0;
    u64 hw_deq;
...
unsafe extern "C" fn cdnsp_update_port_id(pdev: *mut cdnsp_device, port_id: u32) -> c_int {
    ...
    cdnsp_set_usb2_hardware_lpm(pdev, core::ptr::null_mut(), 1);
    else
...
//
    ...
    let mut handling_skipped_tds: bool = false;
...
// Something is busted, give up!
    ...
    &status);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: usb_endpoint_xfer_isoc(desc)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn cdnsp_handle_event(pdev: *mut cdnsp_device) -> bool {
    static bool cdnsp_handle_event(struct cdnsp_device *pdev)
    {
    unsigned int comp_code;
    union cdnsp_trb *event;
    let mut update_ptrs: bool = true;
    u32 cycle_bit;
    let mut ret: c_int = 0;
    u32 flags;
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_thread_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_irq_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cdnsp_count_trbs(addr: u64, len: u64) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn count_trbs_needed(preq: *mut cdnsp_request) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn count_sg_trbs_needed(preq: *mut cdnsp_request) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn cdnsp_check_trb_math(preq: *mut cdnsp_request, running_total: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_queue_bulk_tx(pdev: *mut cdnsp_device, preq: *mut cdnsp_request) -> c_int {
    ...
    let mut zero_len_trb: bool = false;
    struct cdnsp_ring *ring;
...
//
    ...
    pep.wa1_nop_trb = core::ptr::null_mut();
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_queue_ctrl_tx(pdev: *mut cdnsp_device, preq: *mut cdnsp_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_cmd_stop_ep(pdev: *mut cdnsp_device, pep: *mut cdnsp_ep) -> c_int {
    int cdnsp_cmd_stop_ep(struct cdnsp_device *pdev, struct cdnsp_ep *pep)
    {
    let mut ep_state: u32 = GET_EP_CTX_STATE(pep.out_ctx);
    let mut ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_queue_slot_control(pdev: *mut cdnsp_device, trb_type: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_queue_reset_device(pdev: *mut cdnsp_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cdnsp_queue_stop_endpoint(pdev: *mut cdnsp_device, ep_index: c_uint) {
...
// Set Transfer Ring Dequeue Pointer command.
    ...
    struct cdnsp_dequeue_state *deq_state)
    {
    let mut trb_stream_id: u32 = STREAM_ID_FOR_TRB(deq_state.stream_id);
    let mut trb_slot_id: u32 = SLOT_ID_FOR_TRB(pdev.slot_id);
    let mut type: u32 = TRB_TYPE(TRB_SET_DEQ);
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_queue_reset_ep(pdev: *mut cdnsp_device, ep_index: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cdnsp_queue_halt_endpoint(pdev: *mut cdnsp_device, ep_index: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_force_header_wakeup(pdev: *mut cdnsp_device, intf_num: c_int) {
