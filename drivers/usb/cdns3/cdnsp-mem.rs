...
//! Source: drivers/usb/cdns3/cdnsp-mem.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cdnsp_remove_stream_mapping(ring: *mut cdnsp_ring) {
...
#[no_mangle]
unsafe extern "C" fn cdnsp_update_stream_mapping(ring: *mut cdnsp_ring) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdnsp_ring_free(pdev: *mut cdnsp_device, ring: *mut cdnsp_ring) {
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_initialize_ring_info(ring: *mut cdnsp_ring) {
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_free_endpoint_rings(pdev: *mut cdnsp_device, pep: *mut cdnsp_ep) {
    void cdnsp_free_endpoint_rings(struct cdnsp_device *pdev, struct cdnsp_ep *pep)
    {
    cdnsp_ring_free(pdev, pep.ring);
    pep.ring = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cdnsp_init_device_ctx(pdev: *mut cdnsp_device) -> c_int {
    static int cdnsp_init_device_ctx(struct cdnsp_device *pdev)
    {
    let mut size: c_int = HCC_64BYTE_CONTEXT(pdev.hcc_params) ? 2048 : 1024;
...
#[no_mangle]
unsafe extern "C" fn cdnsp_free_priv_device(pdev: *mut cdnsp_device) {
    ...
    dma_pool_free(pdev.device_pool, pdev.out_ctx.bytes,
    pdev.out_ctx.dma);
    pdev.in_ctx.bytes = core::ptr::null_mut();
    pdev.out_ctx.bytes = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn cdnsp_alloc_priv_device(pdev: *mut cdnsp_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_copy_ep0_dequeue_into_input_ctx(pdev: *mut cdnsp_device) {
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_setup_addressable_priv_dev(pdev: *mut cdnsp_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cdnsp_get_endpoint_mult(g: *mut usb_gadget, pep: *mut cdnsp_ep) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cdnsp_get_endpoint_type(desc: *const usb_endpoint_descriptor) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(USB_SPEED_SUPER: g->speed >=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_endpoint_zero(pdev: *mut cdnsp_device, pep: *mut cdnsp_ep) {
...
#[no_mangle]
unsafe extern "C" fn cdnsp_free_erst(pdev: *mut cdnsp_device, erst: *mut cdnsp_erst) {
    static void cdnsp_free_erst(struct cdnsp_device *pdev, struct cdnsp_erst *erst)
    {
    let mut size: usize = sizeof(struct cdnsp_erst_entry) * (erst.num_entries);
    struct device *dev = pdev.dev;
    if (erst.entries)
    dma_free_coherent(dev, size, erst.entries,
    erst.erst_dma_addr);
    erst.entries = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn cdnsp_mem_cleanup(pdev: *mut cdnsp_device) {
    ...
    pdev.event_ring = core::ptr::null_mut();
    if (pdev.cmd_ring)
    cdnsp_ring_free(pdev, pdev.cmd_ring);
    pdev.cmd_ring = core::ptr::null_mut();
    dma_pool_destroy(pdev.segment_pool);
    pdev.segment_pool = core::ptr::null_mut();
    dma_pool_destroy(pdev.device_pool);
    pdev.device_pool = core::ptr::null_mut();
    dma_free_coherent(dev, sizeof(*pdev.dcbaa),
    pdev.dcbaa, pdev.dcbaa.dma);
    pdev.dcbaa = core::ptr::null_mut();
    ...
    pdev.active_port = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn cdnsp_set_event_deq(pdev: *mut cdnsp_device) {
...
//
#[no_mangle]
unsafe extern "C" fn cdnsp_setup_port_arrays(pdev: *mut cdnsp_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cdnsp_mem_init(pdev: *mut cdnsp_device) -> c_int {
