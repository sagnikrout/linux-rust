...
//! Source: drivers/usb/cdns3/cdnsp-ep0.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cdnsp_ep0_stall(pdev: *mut cdnsp_device) {
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_status_stage(pdev: *mut cdnsp_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdnsp_w_index_to_ep_index(wIndex: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdnsp_enter_test_mode(pdev: *mut cdnsp_device) {
...
#[no_mangle]
pub unsafe extern "C" fn cdnsp_setup_analyze(pdev: *mut cdnsp_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(CDNSP_STATUS_STAGE: !len && pdev->ep0_stage !=) -> else {
