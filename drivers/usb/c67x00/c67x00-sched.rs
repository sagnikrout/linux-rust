...
//! Source: drivers/usb/c67x00/c67x00-sched.c
#![no_std]
...
//
pub const SETUP_STAGE: c_int = 0;
pub const DATA_STAGE: c_int = 1;
pub const STATUS_STAGE: c_int = 2;
// --------------------------------------------------------------------------
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct c67x00_ep_data {
    pub queue: list_head,
    pub node: list_head,
    pub hep: *mut usb_host_endpoint,
    pub dev: *mut usb_device,
    pub /: *mut *mut u16 next_frame; / For int/isoc transactions,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct c67x00_td {
// HW specific part
    pub /: *mut *mut __le16 ly_base_addr; / Bytes 0-1,
    pub /: *mut *mut __le16 port_length; / Bytes 2-3,
    pub /: *mut *mut u8 pid_ep; / Byte 4,
    pub /: *mut *mut u8 dev_addr; / Byte 5,
    pub /: *mut *mut u8 ctrl_reg; / Byte 6,
    pub /: *mut *mut u8 status; / Byte 7,
    pub /: *mut *mut u8 retry_cnt; / Byte 8,
pub const TT_OFFSET: c_int = 2;
pub const TT_CONTROL: c_int = 0;
pub const TT_ISOCHRONOUS: c_int = 1;
pub const TT_BULK: c_int = 2;
pub const TT_INTERRUPT: c_int = 3;
    pub /: *mut *mut u8 residue; / Byte 9,
    pub /: *mut *mut __le16 next_td_addr; / Bytes 10-11,
// SW part
...
// be fixed
    pub ep_data: *mut c67x00_ep_data,
    pub pipe: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct c67x00_urb_priv {
    pub hep_node: list_head,
    pub urb: *mut urb,
    pub port: c_int,
    pub /: *mut *mut int cnt; / packet number for isoc,
    pub status: c_int,
    pub ep_data: *mut c67x00_ep_data,
}

pub const CY_TD_SIZE: c_int = 12;
pub const TD_PIDEP_OFFSET: c_uint = 0x04;
pub const TD_PIDEPMASK_PID: c_uint = 0xF0;
pub const TD_PIDEPMASK_EP: c_uint = 0x0F;
pub const TD_PORTLENMASK_DL: c_uint = 0x03FF;
pub const TD_PORTLENMASK_PN: c_uint = 0xC000;
pub const TD_STATUS_OFFSET: c_uint = 0x07;
pub const TD_STATUSMASK_ACK: c_uint = 0x01;
pub const TD_STATUSMASK_ERR: c_uint = 0x02;
pub const TD_STATUSMASK_TMOUT: c_uint = 0x04;
pub const TD_STATUSMASK_SEQ: c_uint = 0x08;
pub const TD_STATUSMASK_SETUP: c_uint = 0x10;
pub const TD_STATUSMASK_OVF: c_uint = 0x20;
pub const TD_STATUSMASK_NAK: c_uint = 0x40;
pub const TD_STATUSMASK_STALL: c_uint = 0x80;

    TD_STATUSMASK_STALL)
pub const TD_RETRYCNT_OFFSET: c_uint = 0x08;
pub const TD_RETRYCNTMASK_ACT_FLG: c_uint = 0x10;
pub const TD_RETRYCNTMASK_TX_TYPE: c_uint = 0x0C;
pub const TD_RETRYCNTMASK_RTY_CNT: c_uint = 0x03;
pub const TD_RESIDUE_OVERFLOW: c_uint = 0x80;
pub const TD_PID_IN: c_uint = 0x90;
...
//
#[no_mangle]
unsafe extern "C" fn dbg_td(c67x00: *mut c67x00_hcd, td: *mut c67x00_td, msg: *mut c_char) {
...
// Helper functions
#[no_mangle]
pub unsafe extern "C" fn c67x00_get_current_frame_number(c67x00: *mut c67x00_hcd) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn frame_add(a: u16, b: u16) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn frame_after(a: u16, b: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn frame_after_eq(a: u16, b: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn c67x00_release_urb(c67x00: *mut c67x00_hcd, urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn c67x00_ep_data_free(hep: *mut usb_host_endpoint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn c67x00_endpoint_disable(hcd: *mut usb_hcd, ep: *mut usb_host_endpoint) {
...
// --------------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn get_root_port(dev: *mut usb_device) -> c_int {
    ...
    struct c67x00_urb_priv *urbp;
    struct c67x00_hcd *c67x00 = hcd_to_c67x00_hcd(hcd);
    let mut port: c_int = get_root_port(urb.dev)-1;
...
#[no_mangle]
pub unsafe extern "C" fn c67x00_urb_dequeue(hcd: *mut usb_hcd, urb: *mut urb, status: c_int) -> c_int {
...
//
    ...
    struct c67x00_td *td;
    struct c67x00_urb_priv *urbp = urb.hcpriv;
    let mut active_flag: __u8 = 1, retry_cnt = 3;
    let mut cmd: __u8 = 0;
    let mut tt: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn c67x00_release_td(td: *mut c67x00_td) {
...
// --------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn c67x00_add_data_urb(c67x00: *mut c67x00_hcd, urb: *mut urb) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn c67x00_add_ctrl_urb(c67x00: *mut c67x00_hcd, urb: *mut urb) -> c_int {
    ...
    case STATUS_STAGE:
    pid = !usb_pipeout(urb.pipe) ? USB_PID_OUT : USB_PID_IN;
    ret = c67x00_create_td(c67x00, urb, core::ptr::null_mut(), 0, pid, 1,
    STATUS_STAGE);
    if (ret)
    return ret;
    break;
...
//
#[no_mangle]
unsafe extern "C" fn c67x00_add_int_urb(c67x00: *mut c67x00_hcd, urb: *mut urb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c67x00_add_iso_urb(c67x00: *mut c67x00_hcd, urb: *mut urb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c67x00_fill_frame(c67x00: *mut c67x00_hcd) {
...
#[no_mangle]
unsafe extern "C" fn c67x00_td_to_error(c67x00: *mut c67x00_hcd, td: *mut c67x00_td) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn c67x00_end_of_data(td: *mut c67x00_td) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c67x00_handle_isoc(c67x00: *mut c67x00_hcd, td: *mut c67x00_td) {
...
//
#[no_mangle]
pub unsafe extern "C" fn c67x00_check_td_list(c67x00: *mut c67x00_hcd) {
...
// get the TD
    ...
    urb = td.urb;	/* urb can be core::ptr::null_mut()! */
    ack_ok = 0;
    clear_endpoint = 1;
...
// --------------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn c67x00_all_tds_processed(c67x00: *mut c67x00_hcd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn c67x00_send_td(c67x00: *mut c67x00_hcd, td: *mut c67x00_td) {
    static void c67x00_send_td(struct c67x00_hcd *c67x00, struct c67x00_td *td)
    {
    let mut len: c_int = td_length(td);
...
#[no_mangle]
unsafe extern "C" fn c67x00_send_frame(c67x00: *mut c67x00_hcd) {
...
//
#[no_mangle]
unsafe extern "C" fn c67x00_do_work(c67x00: *mut c67x00_hcd) {
...
// --------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn c67x00_sched_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn c67x00_sched_kick(c67x00: *mut c67x00_hcd) {
    void c67x00_sched_kick(struct c67x00_hcd *c67x00)
    {
    queue_work(system_highpri_wq, &c67x00.work);
    }
#[no_mangle]
pub unsafe extern "C" fn c67x00_sched_start_scheduler(c67x00: *mut c67x00_hcd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn c67x00_sched_stop_scheduler(c67x00: *mut c67x00_hcd) {
