...
//! Source: drivers/usb/mon/mon_text.c
#![no_std]
...
//
pub const DATA_MAX: c_int = 32;
//
// Defined by USB 2.0 clause 9.3, table 9.2.
//
pub const SETUP_MAX: c_int = 8;
//
...
//
pub const ISODESC_MAX: c_int = 5;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mon_iso_desc {
    pub status: c_int,
    pub offset: c_uint,
    pub /: *mut *mut unsigned int length; / Unsigned here, signed in URB. Historic.,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mon_event_text {
    pub e_link: list_head,
    pub /: *mut *mut int type; / submit, complete, etc.,
    pub /: *mut *mut unsigned long id; / From pointer, most of the time,
    pub tstamp: c_uint,
    pub busnum: c_int,
    pub devnum: c_char,
    pub epnum: c_char,
    pub is_in: c_char,
    pub xfertype: c_char,
    pub /: *mut *mut int length; / Depends on type: xfer length or act length,
    pub status: c_int,
    pub interval: c_int,
    pub start_frame: c_int,
    pub error_count: c_int,
    pub setup_flag: c_char,
    pub data_flag: c_char,
    pub /: *mut *mut int numdesc; / Full number,
    pub isodesc: [mon_iso_desc; ISODESC_MAX],
    pub setup: [c_uchar; SETUP_MAX],
    pub data: [c_uchar; DATA_MAX],
}

pub const SLAB_NAME_SZ: c_int = 30;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mon_reader_text {
    pub e_slab: *mut kmem_cache,
    pub nevents: c_int,
    pub e_list: list_head,
    pub /: *mut *mut mon_reader r; / In C, parent class can be placed anywhere,
    pub wait: wait_queue_head_t,
    pub printf_size: c_int,
    pub printf_offset: usize,
    pub printf_togo: usize,
    pub printf_buf: *mut c_char,
    pub printf_lock: mutex,
    pub slab_name: [c_char; SLAB_NAME_SZ],
}
...
#[no_mangle]
pub unsafe extern "C" fn mon_get_timestamp() -> c_uint {
    ...
    (ep = kmem_cache_alloc(rp.e_slab, GFP_ATOMIC)) == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn mon_text_submit(data: *mut c_void, urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn mon_text_complete(data: *mut c_void, urb: *mut urb, status: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mon_text_error(data: *mut c_void, urb: *mut urb, error: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn mon_text_open(inode: *mut inode, file: *mut file) -> c_int {
    ...
    if (rp.printf_buf == core::ptr::null_mut()) {
    rc = -ENOMEM;
    goto err_alloc_pr;
    }
    rp.r.m_bus = mbus;
    ...
    mon_text_ctor);
    if (rp.e_slab == core::ptr::null_mut()) {
    rc = -ENOMEM;
    goto err_slab;
    }
...
// kmem_cache_destroy(rp->e_slab);
    ...
    {
    let mut togo: usize = min(nbytes, rp.printf_togo);
...
// ppos is not advanced since the llseek operation is not permitted.
    ...
    while ((ep = mon_text_fetch(rp, mbus)) == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn mon_text_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mon_text_add(mbus: *mut mon_bus, ubus: *const usb_bus) -> c_int {
    int mon_text_add(struct mon_bus *mbus, const struct usb_bus *ubus)
    {
    enum { NAMESZ = 12 };
    char name[NAMESZ];
    let mut busnum: c_int = ubus? ubus.busnum: 0;
    if (mon_dir == core::ptr::null_mut())
    return 0;
    if (ubus != core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn mon_text_del(mbus: *mut mon_bus) {
...
//
#[no_mangle]
unsafe extern "C" fn mon_text_ctor(mem: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn mon_text_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn mon_text_exit() {
