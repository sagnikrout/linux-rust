...
//! Source: drivers/usb/mon/mon_main.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn mon_reader_add(mbus: *mut mon_bus, r: *mut mon_reader) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mon_reader_del(mbus: *mut mon_bus, r: *mut mon_reader) {
...
//
#[no_mangle]
unsafe extern "C" fn mon_bus_submit(mbus: *mut mon_bus, urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn mon_submit(ubus: *mut usb_bus, urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn mon_bus_submit_error(mbus: *mut mon_bus, urb: *mut urb, error: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mon_submit_error(ubus: *mut usb_bus, urb: *mut urb, error: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn mon_bus_complete(mbus: *mut mon_bus, urb: *mut urb, status: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mon_complete(ubus: *mut usb_bus, urb: *mut urb, status: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn mon_stop(mbus: *mut mon_bus) {
    static void mon_stop(struct mon_bus *mbus)
    {
    struct usb_bus *ubus;
    if (mbus == &mon_bus0) {
...
//
    if (mbus.nreaders == 0 && (ubus = mbus.u_bus) != core::ptr::null_mut())
    ubus.monitored = 0;
    }
    } else {
//
...
//
    if (mon_bus0.nreaders == 0 && (ubus = mbus.u_bus) != core::ptr::null_mut()) {
    ubus.monitored = 0;
    mb();
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn mon_bus_add(ubus: *mut usb_bus) {
...
//
#[no_mangle]
unsafe extern "C" fn mon_bus_remove(ubus: *mut usb_bus) {
...
//
#[no_mangle]
unsafe extern "C" fn mon_dissolve(mbus: *mut mon_bus, ubus: *mut usb_bus) {
    static void mon_dissolve(struct mon_bus *mbus, struct usb_bus *ubus)
    {
    if (ubus.monitored) {
    ubus.monitored = 0;
    ...
    ubus.mon_bus = core::ptr::null_mut();
    mbus.u_bus = core::ptr::null_mut();
    mb();
// We want synchronize_irq() here, but that needs an argument.
    }
//
#[no_mangle]
unsafe extern "C" fn mon_bus_drop(r: *mut kref) {
    static void mon_bus_drop(struct kref *r)
    {
...
//
#[no_mangle]
unsafe extern "C" fn mon_bus_init(ubus: *mut usb_bus) {
    static void mon_bus_init(struct usb_bus *ubus)
    {
    struct mon_bus *mbus;
...
#[no_mangle]
unsafe extern "C" fn mon_bus0_init() {
    ...
    spin_lock_init(&mbus.lock);
    INIT_LIST_HEAD(&mbus.r_list);
    mbus.text_inited = mon_text_add(mbus, core::ptr::null_mut());
    mbus.bin_inited = mon_bin_add(mbus, core::ptr::null_mut());
    }
//
