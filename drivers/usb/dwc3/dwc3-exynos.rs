...
//! Source: drivers/usb/dwc3/dwc3-exynos.c
#![no_std]
...
pub const DWC3_EXYNOS_MAX_CLOCKS: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dwc3_exynos_driverdata {
    pub clk_names: [*const c_char; DWC3_EXYNOS_MAX_CLOCKS],
    pub num_clks: c_int,
    pub suspend_clk_idx: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dwc3_exynos {
    pub dev: *mut device,
    pub clk_names: *const c_char,
    pub clks: [*mut clk; DWC3_EXYNOS_MAX_CLOCKS],
    pub num_clks: c_int,
    pub suspend_clk_idx: c_int,
    pub vdd33: *mut regulator,
    pub vdd10: *mut regulator,
}

#[no_mangle]
unsafe extern "C" fn dwc3_exynos_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_exynos_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_exynos_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_exynos_resume(dev: *mut device) -> c_int {
