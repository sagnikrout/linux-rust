...
//! Source: drivers/usb/dwc3/dwc3-xilinx.c
#![no_std]
...
pub const XLNX_USB_PHY_RST_EN: c_uint = 0x001C;
pub const XLNX_PHY_RST_MASK: c_uint = 0x1;
// Xilinx USB 3.0 IP Register
pub const XLNX_USB_TRAFFIC_ROUTE_CONFIG: c_uint = 0x005C;
pub const XLNX_USB_TRAFFIC_ROUTE_FPD: c_uint = 0x1;
// USB 2.0 IP Register
pub const XLNX_USB2_TRAFFIC_ROUTE_CONFIG: c_uint = 0x0044;
pub const XLNX_USB_FPD_PIPE_CLK: c_uint = 0x7c;
pub const PIPE_CLK_DESELECT: c_int = 1;
pub const PIPE_CLK_SELECT: c_int = 0;
pub const XLNX_USB_FPD_POWER_PRSNT: c_uint = 0x80;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dwc3_xlnx {
    pub num_clocks: c_int,
    pub clks: *mut clk_bulk_data,
    pub dev: *mut device,
    pub regs: *mut void __iomem,
    pub data): *mut *mut int (pltfm_init)(struct dwc3_xlnx,
    pub usb3_phy: *mut phy,
}

#[no_mangle]
unsafe extern "C" fn dwc3_xlnx_mask_phy_rst(priv_data: *mut dwc3_xlnx, mask: bool) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_xlnx_set_coherency(priv_data: *mut dwc3_xlnx, coherency_offset: u32) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_xlnx_init_versal(priv_data: *mut dwc3_xlnx) -> c_int {
    static int dwc3_xlnx_init_versal(struct dwc3_xlnx *priv_data)
    {
    struct device		*dev = priv_data.dev;
    struct reset_control	*crst;
    int			ret;
    crst = devm_reset_control_get_exclusive(dev, core::ptr::null_mut());
    if (IS_ERR(crst))
...
#[no_mangle]
unsafe extern "C" fn dwc3_xlnx_init_zynqmp(priv_data: *mut dwc3_xlnx) -> c_int {
...
unsafe extern "C" fn dwc3_set_swnode(dev: *mut device) -> c_int {
    ...
    of_node_put(dwc3_np);
    if (prop_idx)
    ret = device_create_managed_software_node(dev, props, core::ptr::null_mut());
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn dwc3_xlnx_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_xlnx_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_xlnx_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn dwc3_xlnx_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn dwc3_xlnx_runtime_idle(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn dwc3_xlnx_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn dwc3_xlnx_resume(dev: *mut device) -> int __maybe_unused {
