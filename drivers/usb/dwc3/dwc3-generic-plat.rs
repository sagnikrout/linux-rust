...
//! Source: drivers/usb/dwc3/dwc3-generic-plat.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dwc3_generic_config {
    pub dwc3g): *mut *mut int (init)(struct dwc3_generic,
    pub properties: dwc3_properties,
}

#[no_mangle]
unsafe extern "C" fn dwc3_generic_reset_control_assert(data: *mut c_void) {
    static void dwc3_generic_reset_control_assert(void *data)
    {
    reset_control_assert(data);
    }
#[no_mangle]
unsafe extern "C" fn dwc3_eic7700_init(dwc3g: *mut dwc3_generic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_spacemit_k1_init(dwc3g: *mut dwc3_generic) -> c_int {
    static int dwc3_spacemit_k1_init(struct dwc3_generic *dwc3g)
    {
    struct device *dev = dwc3g.dev;
    if (usb_get_dr_mode(dev) == USB_DR_MODE_HOST) {
    let mut ret: c_int = devm_regulator_get_enable_optional(dev, "vbus");
    if (ret && ret != -ENODEV)
...
#[no_mangle]
unsafe extern "C" fn dwc3_generic_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_generic_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_generic_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_generic_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_generic_runtime_suspend(dev: *mut device) -> c_int {
    static int dwc3_generic_runtime_suspend(struct device *dev)
    {
    return dwc3_runtime_suspend(dev_get_drvdata(dev));
    }
#[no_mangle]
unsafe extern "C" fn dwc3_generic_runtime_resume(dev: *mut device) -> c_int {
    static int dwc3_generic_runtime_resume(struct device *dev)
    {
    return dwc3_runtime_resume(dev_get_drvdata(dev));
    }
#[no_mangle]
unsafe extern "C" fn dwc3_generic_runtime_idle(dev: *mut device) -> c_int {
