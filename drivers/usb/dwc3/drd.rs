...
#[no_mangle]
unsafe extern "C" fn dwc3_otg_disable_events(dwc: *mut dwc3, disable_mask: u32) {
    static void dwc3_otg_disable_events(struct dwc3 *dwc, u32 disable_mask)
    {
    let mut reg: u32 = dwc3_readl(dwc, DWC3_OEVTEN);
    reg &= ~(disable_mask);
    dwc3_writel(dwc, DWC3_OEVTEN, reg);
    }
#[no_mangle]
unsafe extern "C" fn dwc3_otg_enable_events(dwc: *mut dwc3, enable_mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_otg_clear_events(dwc: *mut dwc3) {
    static void dwc3_otg_clear_events(struct dwc3 *dwc)
    {
    let mut reg: u32 = dwc3_readl(dwc, DWC3_OEVT);
    dwc3_writel(dwc, DWC3_OEVTEN, reg);
    }
...
#[no_mangle]
unsafe extern "C" fn dwc3_otg_thread_irq(irq: c_int, _dwc: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dwc3_otg_irq(irq: c_int, _dwc: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dwc3_otgregs_init(dwc: *mut dwc3) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_otg_get_irq(dwc: *mut dwc3) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dwc3_otg_init(dwc: *mut dwc3) {
...
#[no_mangle]
pub unsafe extern "C" fn dwc3_otg_exit(dwc: *mut dwc3) {
...
#[no_mangle]
pub unsafe extern "C" fn dwc3_otg_host_init(dwc: *mut dwc3) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_otg_host_exit(dwc: *mut dwc3) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_otg_device_init(dwc: *mut dwc3) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_otg_device_exit(dwc: *mut dwc3) {
...
#[no_mangle]
pub unsafe extern "C" fn dwc3_otg_update(dwc: *mut dwc3, ignore_idstatus: bool) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_drd_update(dwc: *mut dwc3) {
    ...
    let mut mode: u32 = event ? DWC3_GCTL_PRTCAP_HOST : DWC3_GCTL_PRTCAP_DEVICE;
...
#[no_mangle]
unsafe extern "C" fn dwc3_setup_role_switch(dwc: *mut dwc3) -> c_int {
...
// populate connector entry
    let mut ret: c_int = devm_of_platform_populate(dwc.dev);
    if (ret) {
    usb_role_switch_unregister(dwc.role_sw);
    dwc.role_sw = core::ptr::null_mut();
...
pub const ROLE_SWITCH: c_int = 0;
pub const dwc3_setup_role_switch(x): c_int = 0;

#[no_mangle]
pub unsafe extern "C" fn dwc3_drd_init(dwc: *mut dwc3) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dwc3_drd_exit(dwc: *mut dwc3) {
