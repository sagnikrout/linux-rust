...
//! Source: drivers/usb/dwc3/dwc3-google.c
#![no_std]
...
// HOST CFG registers
pub const HC_STATUS_OFFSET: c_uint = 0x0;

pub const HOST_CFG1_OFFSET: c_uint = 0x4;

pub const HOST_CFG1_PM_POWER_STATE_D0: c_uint = 0x0;
pub const HOST_CFG1_PM_POWER_STATE_D3: c_uint = 0x3;
// USBINT registers
pub const USBINT_CFG1_OFFSET: c_uint = 0x0;

pub const USBINT_STATUS_OFFSET: c_uint = 0x4;

pub const USBCS_TOP_CTRL_CFG1_OFFSET: c_uint = 0xc;

pub const DWC3_GOOGLE_MAX_RESETS: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dwc3_google {
    pub dev: *mut device,
    pub dwc: dwc3,
    pub clks: *mut clk_bulk_data,
    pub num_clks: c_int,
    pub rsts: [reset_control_bulk_data; DWC3_GOOGLE_MAX_RESETS],
    pub num_rsts: c_int,
    pub non_sticky_rst: *mut reset_control,
    pub usb_psw_pd: *mut device,
    pub usb_psw_pd_dl: *mut device_link,
    pub usb_psw_pd_nb: notifier_block,
    pub usb_top_pd: *mut device,
    pub usb_top_pd_dl: *mut device_link,
    pub usb_cfg_regmap: *mut regmap,
    pub host_cfg_offset: c_uint,
    pub usbint_cfg_offset: c_uint,
    pub hs_pme_irq: c_int,
    pub ss_pme_irq: c_int,
    pub is_usb2only: bool,
    pub is_hibernation: bool,
}

#[no_mangle]
unsafe extern "C" fn dwc3_google_rst_init(google: *mut dwc3_google) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_set_pmu_state(google: *mut dwc3_google, state: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dwc3_google_clear_pme_irqs(google: *mut dwc3_google) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_enable_pme_irq(google: *mut dwc3_google) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_disable_pme_irq(google: *mut dwc3_google) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_resume_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    ret = devm_request_threaded_irq(google.dev, irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_usb_psw_pd_notifier(nb: *mut notifier_block, action: c_ulong, d: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_pm_domain_deinit(google: *mut dwc3_google) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_pm_domain_init(google: *mut dwc3_google) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_program_usb2only(google: *mut dwc3_google) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_suspend(google: *mut dwc3_google, msg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_resume(google: *mut dwc3_google, msg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_complete(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_prepare(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_google_runtime_idle(dev: *mut device) -> c_int {
