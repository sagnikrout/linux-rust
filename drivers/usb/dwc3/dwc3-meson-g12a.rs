...
//! Source: drivers/usb/dwc3/dwc3-meson-g12a.c
#![no_std]
...
pub const U2P_REG_SIZE: c_uint = 0x20;
pub const U2P_R0: c_uint = 0x0;

pub const U2P_R1: c_uint = 0x4;

// USB Glue Control Registers
pub const G12A_GLUE_OFFSET: c_uint = 0x80;
pub const USB_R0: c_uint = 0x00;

pub const USB_R1: c_uint = 0x04;

pub const USB_R2: c_uint = 0x08;

pub const USB_R3: c_uint = 0x0c;

pub const USB_R4: c_uint = 0x10;

pub const USB_R5: c_uint = 0x14;

pub const PHY_COUNT: c_int = 3;
pub const USB2_OTG_PHY: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dwc3_meson_g12a_drvdata {
    pub otg_phy_host_port_disable: bool,
    pub clks: *mut clk_bulk_data,
    pub num_clks: c_int,
    pub phy_names: *const *const c_char,
    pub num_phys: c_int,
    pub base): *mut *mut *mut int (setup_regmaps)(struct dwc3_meson_g12a priv, void __iomem,
    ...
    pub mode): enum phy_mode,
    pub priv): *mut *mut int (usb_init)(struct dwc3_meson_g12a,
    pub priv): *mut *mut int (usb_post_init)(struct dwc3_meson_g12a,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dwc3_meson_g12a {
    pub dev: *mut device,
    pub u2p_regmap: [*mut regmap; PHY_COUNT],
    pub usb_glue_regmap: *mut regmap,
    pub reset: *mut reset_control,
    pub phys: [*mut phy; PHY_COUNT],
    pub otg_mode: enum usb_dr_mode,
    pub otg_phy_mode: enum phy_mode,
    pub usb2_ports: c_uint,
    pub usb3_ports: c_uint,
    pub vbus: *mut regulator,
    pub switch_desc: usb_role_switch_desc,
    pub role_switch: *mut usb_role_switch,
    pub drvdata: *const dwc3_meson_g12a_drvdata,
}
...
#[no_mangle]
unsafe extern "C" fn dwc3_meson_g12a_usb3_init(priv: *mut dwc3_meson_g12a) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_meson_g12a_get_phys(priv: *mut dwc3_meson_g12a) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc3_meson_g12a_get_id(priv: *mut dwc3_meson_g12a) -> enum phy_mode {
...
#[no_mangle]
unsafe extern "C" fn dwc3_meson_g12a_role_get(sw: *mut usb_role_switch) -> enum usb_role {
...
#[no_mangle]
unsafe extern "C" fn dwc3_meson_g12a_irq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dwc3_meson_g12a_usb_init(priv: *mut dwc3_meson_g12a) -> c_int {
    static int dwc3_meson_g12a_usb_init(struct dwc3_meson_g12a *priv)
    {
    return dwc3_meson_g12a_usb_init_glue(priv, priv.otg_phy_mode);
    }
#[no_mangle]
unsafe extern "C" fn dwc3_meson_gxl_usb_init(priv: *mut dwc3_meson_g12a) -> c_int {
    static int dwc3_meson_gxl_usb_init(struct dwc3_meson_g12a *priv)
    {
    return dwc3_meson_g12a_usb_init_glue(priv, PHY_MODE_USB_DEVICE);
    }
#[no_mangle]
unsafe extern "C" fn dwc3_meson_gxl_usb_post_init(priv: *mut dwc3_meson_g12a) -> c_int {
    static int dwc3_meson_gxl_usb_post_init(struct dwc3_meson_g12a *priv)
    {
    int ret;
...
#[no_mangle]
unsafe extern "C" fn dwc3_meson_g12a_probe(pdev: *mut platform_device) -> c_int {
    ...
    priv.reset = devm_reset_control_get_shared(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dwc3_meson_g12a_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dwc3_meson_g12a_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn dwc3_meson_g12a_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn dwc3_meson_g12a_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn dwc3_meson_g12a_resume(dev: *mut device) -> int __maybe_unused {
...
// Set PHY Power
    ...
    dwc3_meson_g12a_runtime_resume, core::ptr::null_mut())
    };
