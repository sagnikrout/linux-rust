...
//
#[no_mangle]
pub unsafe extern "C" fn usb_of_has_combined_node(udev: *mut usb_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn usb_of_has_devices_or_graph(hub: *const usb_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_of_get_connect_type(hub: *mut usb_device, port1: c_int) -> enum usb_port_connect_type {
