...
//! Source: drivers/usb/core/ledtrig-usbport.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usbport_trig_data {
    pub led_cdev: *mut led_classdev,
    pub ports: list_head,
    pub nb: notifier_block,
    pub /: *mut *mut int count; / Amount of connected matching devices,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct usbport_trig_port {
    pub data: *mut usbport_trig_data,
    pub hub: *mut usb_device,
    pub portnum: c_int,
...
#[no_mangle]
unsafe extern "C" fn usbport_trig_usb_dev_check(usb_dev: *mut usb_device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usbport_trig_update_count(usbport_data: *mut usbport_trig_data) {
...
//
    ...
    port.observed = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(buf, !strcmp(buf: "1") ||, _arg: "1\n")) -> else {
...
#[no_mangle]
unsafe extern "C" fn usbport_trig_activate(led_cdev: *mut led_classdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbport_trig_deactivate(led_cdev: *mut led_classdev) {
