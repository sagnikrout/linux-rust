...
//! Source: drivers/usb/core/config.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: usb_endpoint_xfer_int(&ep->desc)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(USB_DT_ENDPOINT_SIZE: d->bLength >=) -> else {
...
// find the next endpoint or interface descriptor
    ...
    i = find_next_descriptor(buffer, size, USB_DT_ENDPOINT,
    USB_DT_INTERFACE, core::ptr::null_mut());
    return buffer - buffer0 + i;
    }
#[no_mangle]
pub unsafe extern "C" fn usb_release_interface_cache(ref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_destroy_configuration(dev: *mut usb_device) {
    ...
    dev.rawdescriptors = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_get_configuration(dev: *mut usb_device) -> c_int {
    int usb_get_configuration(struct usb_device *dev)
    {
    struct device *ddev = &dev.dev;
    let mut ncfg: c_int = dev.descriptor.bNumConfigurations;
...
#[no_mangle]
pub unsafe extern "C" fn usb_release_bos_descriptor(dev: *mut usb_device) {
    void usb_release_bos_descriptor(struct usb_device *dev)
    {
    if (dev.bos) {
    kfree(dev.bos.desc);
    kfree(dev.bos);
    dev.bos = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn usb_get_bos_descriptor(dev: *mut usb_device) -> c_int {
