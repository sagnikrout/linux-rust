...
//! Source: drivers/usb/core/usb-acpi.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_acpi_power_manageable(hdev: *mut usb_device, index: c_int) -> bool {
    bool usb_acpi_power_manageable(struct usb_device *hdev, int index)
    {
    acpi_handle port_handle;
    let mut port1: c_int = index + 1;
...
pub const USB_DSM_DISABLE_U1_U2_FOR_PORT: c_int = 5;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_acpi_port_lpm_incapable(hdev: *mut usb_device, index: c_int) -> c_int {
    ...
    USB_DSM_DISABLE_U1_U2_FOR_PORT, core::ptr::null_mut(),
    ACPI_TYPE_INTEGER);
    if (!obj) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_acpi_set_power_state(hdev: *mut usb_device, index: c_int, enable: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usb_acpi_add_usb4_devlink(udev: *mut usb_device) -> c_int {
...
//
    ...
    {
    let mut connect_type: enum usb_port_connect_type = USB_PORT_CONNECT_TYPE_UNKNOWN;
    let mut buffer: acpi_buffer = { ACPI_ALLOCATE_BUFFER, core::ptr::null_mut() };
    union acpi_object *upc = core::ptr::null_mut();
...
//
    ...
    status = acpi_evaluate_object(handle, "_UPC", core::ptr::null_mut(), &buffer);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pld->user_visible) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_usb_port(dev)) -> else {
    else if (is_usb_port(dev))
    return usb_acpi_find_companion_for_port(to_usb_port(dev));
    return core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn usb_acpi_bus_match(dev: *mut device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn usb_acpi_register() -> c_int {
    int usb_acpi_register(void)
    {
    return register_acpi_bus_type(&usb_acpi_bus);
    }
#[no_mangle]
pub unsafe extern "C" fn usb_acpi_unregister() {
