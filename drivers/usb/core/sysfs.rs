...
//! Source: drivers/usb/core/sysfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn add_persist_attributes(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_persist_attributes(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn add_power_attributes(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_power_attributes(dev: *mut device) {
...
pub const add_persist_attributes(dev): c_int = 0;

pub const add_power_attributes(dev): c_int = 0;
...
// To avoid races, first unconfigure and then remove
    ...
    static DEVICE_ATTR_IGNORE_LOCKDEP(remove, S_IWUSR, core::ptr::null_mut(), remove_store);
...
//
    ...
    if (udev.manufacturer == core::ptr::null_mut())
    return 0;
    } else if (a == &dev_attr_product.attr) {
    if (udev.product == core::ptr::null_mut())
    return 0;
    } else if (a == &dev_attr_serial.attr) {
    if (udev.serial == core::ptr::null_mut())
    return 0;
    }
    return a.mode;
    }
...
// Group all the USB bus attributes
    ...
    .name = core::ptr::null_mut(),	/* we want them in the same directory */
    .attrs = usb_bus_attrs,
    };
#[no_mangle]
unsafe extern "C" fn add_default_authorized_attributes(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_default_authorized_attributes(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn usb_create_sysfs_dev_files(udev: *mut usb_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn usb_remove_sysfs_dev_files(udev: *mut usb_device) {
...
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR_RO(_arg: iad_##field) -> static {
...
//
    ...
    struct device *dev = kobj_to_dev(kobj);
    struct usb_interface *intf = to_usb_interface(dev);
    if (intf.intf_assoc == core::ptr::null_mut())
    return 0;
    return a.mode;
    }
...
#[no_mangle]
pub unsafe extern "C" fn usb_update_wireless_status_attr(intf: *mut usb_interface) -> c_int {
    ...
    if (ret < 0)
    return ret;
    sysfs_notify(&dev.kobj, core::ptr::null_mut(), "wireless_status");
...
#[no_mangle]
pub unsafe extern "C" fn usb_create_sysfs_intf_files(intf: *mut usb_interface) {
...
#[no_mangle]
pub unsafe extern "C" fn usb_remove_sysfs_intf_files(intf: *mut usb_interface) {
