...
//! Source: drivers/usb/core/port.c
#![no_std]
...
//
    ...
    let mut port1: c_int = port_dev.portnum;
...
//
    ...
    {
    struct usb_port *port_dev = to_usb_port(dev);
    let mut state: enum usb_device_state = READ_ONCE(port_dev.state);
...
#[no_mangle]
unsafe extern "C" fn usb_port_device_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn usb_port_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_port_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_port_shutdown(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn link_peers(left: *mut usb_port, right: *mut usb_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn link_peers_report(left: *mut usb_port, right: *mut usb_port) {
...
#[no_mangle]
unsafe extern "C" fn unlink_peers(left: *mut usb_port, right: *mut usb_port) {
...
//
    ...
    pm_runtime_get_sync(&hs_port.dev);
    sysfs_remove_link(&left.dev.kobj, "peer");
    right.peer = core::ptr::null_mut();
    sysfs_remove_link(&right.dev.kobj, "peer");
    left.peer = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn match_location(peer_hdev: *mut usb_device, p: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn find_and_link_peer(hub: *mut usb_hub, port1: c_int) {
...
#[no_mangle]
unsafe extern "C" fn connector_bind(dev: *mut device, connector: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn connector_unbind(dev: *mut device, connector: *mut device, data: *mut c_void) {
    ...
    port_dev.connector = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn usb_hub_create_port_device(hub: *mut usb_hub, port1: c_int) -> c_int {
...
// Userspace owns the policy, drop the kernel 'no_poweroff' request.
    ...
    if (retval >= 0) {
    kfree(port_dev.req);
    port_dev.req = core::ptr::null_mut();
    }
    return 0;
    err_put_kn:
...
#[no_mangle]
pub unsafe extern "C" fn usb_hub_remove_port_device(hub: *mut usb_hub, port1: c_int) {
