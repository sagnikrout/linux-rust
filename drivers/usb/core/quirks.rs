...
//! Source: drivers/usb/core/quirks.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn usb_amd_resume_quirk(udev: *mut usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_detect_dynamic_quirks(udev: *mut usb_device) -> u32 {
    static u32 usb_detect_dynamic_quirks(struct usb_device *udev)
    {
    let mut vid: u16 = le16_to_cpu(udev.descriptor.idVendor);
    let mut pid: u16 = le16_to_cpu(udev.descriptor.idProduct);
    int i, flags = 0;
    mutex_lock(&quirk_mutex);
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_detect_quirks(udev: *mut usb_device) {
...
#[no_mangle]
pub unsafe extern "C" fn usb_detect_interface_quirks(udev: *mut usb_device) {
...
#[no_mangle]
pub unsafe extern "C" fn usb_release_quirk_list() {
