...
//! Source: drivers/usb/core/hcd-pci.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn is_ohci_or_uhci(pdev: *mut pci_dev) -> c_int {
...
// Iterate over PCI devices in the same slot as pdev and call fn for each
    ...
    let mut slot: c_uint = PCI_SLOT(pdev.devfn);
//
...
// We are removing an EHCI controller.  Clear the companions' pointers.
    ...
    {
    if (is_ohci_or_uhci(companion))
    companion_hcd.self.hs_companion = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_hcd_pci_probe(dev: *mut pci_dev, driver: *const hc_driver) -> c_int {
    int usb_hcd_pci_probe(struct pci_dev *dev, const struct hc_driver *driver)
    {
    struct usb_hcd		*hcd;
    int			retval;
    let mut hcd_irq: c_int = 0;
    if (usb_disabled())
    return -ENODEV;
    if (!driver)
    return -EINVAL;
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_hcd_pci_remove(dev: *mut pci_dev) {
...
// Not EHCI; just clear the companion pointer
    down_read(&companions_rwsem);
    hcd.self.hs_companion = core::ptr::null_mut();
    usb_remove_hcd(hcd);
    dev_set_drvdata(&dev.dev, core::ptr::null_mut());
    up_read(&companions_rwsem);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_hcd_pci_shutdown(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn powermac_set_asic(pci_dev: *mut pci_dev, enable: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn powermac_set_asic(pci_dev: *mut pci_dev, enable: c_int) {
    static inline void powermac_set_asic(struct pci_dev *pci_dev, int enable)
    {}

#[no_mangle]
unsafe extern "C" fn check_root_hub_suspended(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn suspend_common(dev: *mut device, msg: pm_message_t) -> c_int {
    ...
    do_wakeup = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: PMSG_NO_WAKEUP(msg)) -> else {
...
#[no_mangle]
unsafe extern "C" fn resume_common(dev: *mut device, msg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hcd_pci_suspend(dev: *mut device) -> c_int {
    static int hcd_pci_suspend(struct device *dev)
    {
    return suspend_common(dev, PMSG_SUSPEND);
    }
#[no_mangle]
unsafe extern "C" fn hcd_pci_freeze(dev: *mut device) -> c_int {
    static int hcd_pci_freeze(struct device *dev)
    {
    return suspend_common(dev, PMSG_FREEZE);
    }
#[no_mangle]
unsafe extern "C" fn hcd_pci_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hcd_pci_poweroff_late(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hcd_pci_resume_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hcd_pci_resume(dev: *mut device) -> c_int {
    static int hcd_pci_resume(struct device *dev)
    {
    return resume_common(dev, PMSG_RESUME);
    }
#[no_mangle]
unsafe extern "C" fn hcd_pci_restore(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hcd_pci_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hcd_pci_runtime_resume(dev: *mut device) -> c_int {
