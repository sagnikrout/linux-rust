...
//! Source: drivers/usb/typec/rt1719.c
#![no_std]
...
pub const RT1719_REG_TXCTRL1: c_uint = 0x03;
pub const RT1719_REG_TXCTRL2: c_uint = 0x04;
pub const RT1719_REG_POLICYINFO: c_uint = 0x0E;
pub const RT1719_REG_SRCPDO1: c_uint = 0x11;
pub const RT1719_REG_MASKS: c_uint = 0x2D;
pub const RT1719_REG_EVENTS: c_uint = 0x33;
pub const RT1719_REG_STATS: c_uint = 0x37;
pub const RT1719_REG_PSELINFO: c_uint = 0x3C;
pub const RT1719_REG_USBSETINFO: c_uint = 0x3E;
pub const RT1719_REG_VENID: c_uint = 0x82;
pub const RT1719_UNIQUE_PID: c_uint = 0x1719;

    RT1719_ATTACH_SNK)

pub const RT1719_USB_DFPUFP: c_int = 3;
pub const RT1719_MAX_SRCPDO: c_int = 7;
    enum {
    SNK_PWR_OPEN = 0,
    SNK_PWR_DEF,
    SNK_PWR_1P5A,
...
pub struct rt1719_data {
    ...
    pub attached: bool,
    pub pd_capable: bool,
    pub drswap_support: bool,
    pub voltage: u32,
    pub req_voltage: u32,
    pub max_current: u32,
    pub op_current: u32,
    pub spdos: [u32; RT1719_MAX_SRCPDO],
    pub snkcaps: [u16; RT1719_MAX_SNKCAP],
    pub spdo_num: c_int,
    pub spdo_sel: c_int,
    pub conn_info: u32,
    pub conn_stat: u16,
...
#[no_mangle]
unsafe extern "C" fn rt1719_read16(data: *mut rt1719_data, reg: c_uint, val: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt1719_read32(data: *mut rt1719_data, reg: c_uint, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt1719_write32(data: *mut rt1719_data, reg: c_uint, val: u32) -> c_int {
    static int rt1719_write32(struct rt1719_data *data, unsigned int reg, u32 val)
    {
    let mut regval: __le32 = cpu_to_le32(val);
    return regmap_raw_write(data.regmap, reg, &regval, sizeof(regval));
    }
#[no_mangle]
unsafe extern "C" fn rt1719_get_pwr_opmode(conn: u32, stat: u16) -> enum typec_pwr_opmode {
...
#[no_mangle]
unsafe extern "C" fn rt1719_get_data_role(conn: u32) -> enum typec_data_role {
...
#[no_mangle]
unsafe extern "C" fn rt1719_update_data_role(data: *mut rt1719_data) {
...
#[no_mangle]
unsafe extern "C" fn rt1719_register_partner(data: *mut rt1719_data) {
    static void rt1719_register_partner(struct rt1719_data *data)
    {
    let mut spec_rev: u16 = 0;
    if (data.pd_capable) {
    u32 rev;
...
#[no_mangle]
unsafe extern "C" fn rt1719_attach(data: *mut rt1719_data) {
    static void rt1719_attach(struct rt1719_data *data)
    {
    enum typec_pwr_opmode pwr_opmode;
    enum typec_data_role data_role;
    let mut volt: u32 = 5000, curr = 500;
    ...
    curr = 3000;
#[no_mangle]
pub unsafe extern "C" fn if(TYPEC_PWR_MODE_1_5A: pwr_opmode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rt1719_update_operating_status(data: *mut rt1719_data) {
    static void rt1719_update_operating_status(struct rt1719_data *data)
    {
    let mut usb_type: enum power_supply_usb_type = POWER_SUPPLY_USB_TYPE_PD;
    u32 voltage, max_current, op_current;
    int i, snk_sel;
    for (i = 0; i < data.spdo_num; i++) {
    let mut pdo: u32 = data.spdos[i];
...
#[no_mangle]
unsafe extern "C" fn rt1719_update_pwr_opmode(data: *mut rt1719_data) {
...
#[no_mangle]
unsafe extern "C" fn rt1719_update_source_pdos(data: *mut rt1719_data) {
    static void rt1719_update_source_pdos(struct rt1719_data *data)
    {
    let mut spdo_num: c_int = FIELD_GET(RT1719_SPDONUM_MASK, data.conn_info);
...
#[no_mangle]
unsafe extern "C" fn rt1719_dr_set(port: *mut typec_port, role: enum typec_data_role) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt1719_usbpd_request_voltage(data: *mut rt1719_data) -> c_int {
    ...
    return -EINVAL;
    for (i = 0; i < data.spdo_num; i++) {
    let mut type: enum pd_pdo_type = pdo_type(data.spdos[i]);
...
#[no_mangle]
unsafe extern "C" fn devm_rt1719_psy_register(data: *mut rt1719_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt1719_irq_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rt1719_irq_init(data: *mut rt1719_data) -> c_int {
    ...
    return devm_request_threaded_irq(&i2c.dev, i2c.irq, core::ptr::null_mut(),
    rt1719_irq_handler, IRQF_ONESHOT,
    dev_name(&i2c.dev), data);
    }
#[no_mangle]
unsafe extern "C" fn rt1719_init_attach_state(data: *mut rt1719_data) -> c_int {
    ...
    {
    let mut cap: u16 = RT1719_PSEL_SUPPORT;
...
#[no_mangle]
unsafe extern "C" fn rt1719_gen_snkcap(pselinfo: c_uint, capsel: enum rt1719_snkcap) -> u16 {
    static u16 rt1719_gen_snkcap(unsigned int pselinfo, enum rt1719_snkcap capsel)
    {
    let mut psel: c_int = FIELD_GET(RT1719_LATPSEL_MASK, pselinfo);
    const struct rt1719_psel_cap *psel_cap;
    let mut by_current: bool = false;
...
#[no_mangle]
unsafe extern "C" fn rt1719_get_caps(data: *mut rt1719_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt1719_check_exist(data: *mut rt1719_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt1719_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt1719_remove(i2c: *mut i2c_client) {
