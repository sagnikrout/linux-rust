...
//! Source: drivers/usb/typec/tipd/core.c
#![no_std]
...
// Register offsets
pub const TPS_REG_VID: c_uint = 0x00;
pub const TPS_REG_MODE: c_uint = 0x03;
pub const TPS_REG_CMD1: c_uint = 0x08;
pub const TPS_REG_DATA1: c_uint = 0x09;
pub const TPS_REG_VERSION: c_uint = 0x0F;
pub const TPS_REG_INT_EVENT1: c_uint = 0x14;
pub const TPS_REG_INT_EVENT2: c_uint = 0x15;
pub const TPS_REG_INT_MASK1: c_uint = 0x16;
pub const TPS_REG_INT_MASK2: c_uint = 0x17;
pub const TPS_REG_INT_CLEAR1: c_uint = 0x18;
pub const TPS_REG_INT_CLEAR2: c_uint = 0x19;
pub const TPS_REG_STATUS: c_uint = 0x1a;
pub const TPS_REG_SYSTEM_POWER_STATE: c_uint = 0x20;
pub const TPS_REG_USB4_STATUS: c_uint = 0x24;
pub const TPS_REG_SYSTEM_CONF: c_uint = 0x28;
pub const TPS_REG_CTRL_CONF: c_uint = 0x29;
pub const TPS_REG_BOOT_STATUS: c_uint = 0x2D;
pub const TPS_REG_POWER_STATUS: c_uint = 0x3f;
pub const TPS_REG_PD_STATUS: c_uint = 0x40;
pub const TPS_REG_RX_IDENTITY_SOP: c_uint = 0x48;
pub const TPS_REG_CF_VID_STATUS: c_uint = 0x5e;
pub const TPS_REG_DP_SID_STATUS: c_uint = 0x58;
pub const TPS_REG_INTEL_VID_STATUS: c_uint = 0x59;
pub const TPS_REG_DATA_STATUS: c_uint = 0x5f;
pub const TPS_REG_SLEEP_CONF: c_uint = 0x70;
...
//
pub const TPS_BUNDLE_TIMEOUT: c_uint = 0x32;
// BPMs return code
pub const TPS_TASK_BPMS_INVALID_BUNDLE_SIZE: c_uint = 0x4;
pub const TPS_TASK_BPMS_INVALID_SLAVE_ADDR: c_uint = 0x5;
pub const TPS_TASK_BPMS_INVALID_TIMEOUT: c_uint = 0x6;
// PBMc data out

// reset de-assertion to ready for operation
pub const TPS_SETUP_MS: c_int = 1000;
    enum {
    TPS_PORTINFO_SINK,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps6598x_rx_identity_reg {
    pub status: u8,
    pub identity: usb_pd_identity,
    pub __packed: },
// TPS_REG_USB4_STATUS
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps6598x_usb4_status_reg {
    pub mode_status: u8,
    pub eudo: __le32,
    pub unknown: __le32,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps6598x_dp_sid_status_reg {
    pub mode_status: u8,
    pub status_tx: __le32,
    pub status_rx: __le32,
    pub configure: __le32,
    pub mode_data: __le32,
    pub __packed: },
// TPS_REG_INTEL_VID_STATUS
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps6598x_intel_vid_status_reg {
    pub mode_status: u8,
    pub attention_vdo: __le32,
    pub enter_vdo: __le16,
    pub device_mode: __le16,
    pub cable_mode: __le16,
    pub __packed: },
// Standard Task return codes
pub const TPS_TASK_TIMEOUT: c_int = 1;
pub const TPS_TASK_REJECTED: c_int = 3;
// Debounce delay for mode changes, in milliseconds
pub const CD321X_DEBOUNCE_DELAY_MS: c_int = 500;
    enum {
    TPS_MODE_APP,
    TPS_MODE_BOOT,
    TPS_MODE_BIST,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tipd_data {
    pub irq_handler: irq_handler_t,
    pub irq_mask1: u64,
    pub tps_struct_size: usize,
    pub tps): *mut *mut void (remove)(struct tps6598x,
    pub node): *mut *mut *mut int (register_port)(struct tps6598x tps, struct fwnode_handle,
    pub tps): *mut *mut void (unregister_port)(struct tps6598x,
    pub status): *mut *mut void (trace_data_status)(u32,
    pub status): *mut *mut void (trace_power_status)(u16,
    pub status): *mut *mut void (trace_status)(u32,
    pub tps): *mut *mut int (apply_patch)(struct tps6598x,
    pub tps): *mut *mut int (init)(struct tps6598x,
    pub target_state): *mut *mut *mut int (switch_power_state)(struct tps6598x tps, u8,
    pub tps): *mut *mut bool (read_data_status)(struct tps6598x,
    pub tps): *mut *mut bool (read_power_status)(struct tps6598x,
    pub tps): *mut *mut int (reset)(struct tps6598x,
    pub status): *mut *mut *mut int (connect)(struct tps6598x tps, u32,
}
...
pub struct tps6598x {
    ...
    pub wakeup: c_int,
    pub /: *mut *mut u32 status; / status reg,
    pub data_status: u32,
    pub pwr_status: u16,
    pub wq_poll: delayed_work,
    pub data: *const tipd_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cd321x_status {
    pub status: u32,
    pub pwr_status: u32,
    pub data_status: u32,
    pub status_changed: u32,
    pub partner_identity: usb_pd_identity,
    pub dp_sid_status: tps6598x_dp_sid_status_reg,
    pub intel_vid_status: tps6598x_intel_vid_status_reg,
    pub usb4_status: tps6598x_usb4_status_reg,
}
...
pub struct cd321x {
    ...
    pub intel_vid_status: tps6598x_intel_vid_status_reg,
    pub usb4_status: tps6598x_usb4_status_reg,
    pub port_altmode_dp: *mut typec_altmode,
    pub port_altmode_tbt: *mut typec_altmode,
    pub mux: *mut typec_mux,
    pub state: typec_mux_state,
    pub update_status: cd321x_status,
    pub update_work: delayed_work,
    pub cur_partner_identity: usb_pd_identity,
}
...
//
pub const TPS_MAX_LEN: c_int = 64;
    static int
...
#[no_mangle]
pub unsafe extern "C" fn tps6598x_read8(tps: *mut tps6598x, reg: u8, val: *mut u8) -> c_int {
    static inline int tps6598x_read8(struct tps6598x *tps, u8 reg, u8 *val)
    {
    return tps6598x_block_read(tps, reg, val, sizeof(u8));
    }
#[no_mangle]
pub unsafe extern "C" fn tps6598x_read16(tps: *mut tps6598x, reg: u8, val: *mut u16) -> c_int {
    static inline int tps6598x_read16(struct tps6598x *tps, u8 reg, u16 *val)
    {
    return tps6598x_block_read(tps, reg, val, sizeof(u16));
    }
#[no_mangle]
pub unsafe extern "C" fn tps6598x_read32(tps: *mut tps6598x, reg: u8, val: *mut u32) -> c_int {
    static inline int tps6598x_read32(struct tps6598x *tps, u8 reg, u32 *val)
    {
    return tps6598x_block_read(tps, reg, val, sizeof(u32));
    }
#[no_mangle]
pub unsafe extern "C" fn tps6598x_read64(tps: *mut tps6598x, reg: u8, val: *mut u64) -> c_int {
    static inline int tps6598x_read64(struct tps6598x *tps, u8 reg, u64 *val)
    {
    return tps6598x_block_read(tps, reg, val, sizeof(u64));
    }
#[no_mangle]
pub unsafe extern "C" fn tps6598x_write8(tps: *mut tps6598x, reg: u8, val: u8) -> c_int {
    static inline int tps6598x_write8(struct tps6598x *tps, u8 reg, u8 val)
    {
    return tps6598x_block_write(tps, reg, &val, sizeof(u8));
    }
#[no_mangle]
pub unsafe extern "C" fn tps6598x_write64(tps: *mut tps6598x, reg: u8, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_read_partner_identity(tps: *mut tps6598x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_connect(tps: *mut tps6598x, status: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_disconnect(tps: *mut tps6598x, status: u32) {
    static void tps6598x_disconnect(struct tps6598x *tps, u32 status)
    {
    if (!IS_ERR(tps.partner))
    typec_unregister_partner(tps.partner);
    tps.partner = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tps6598x_dr_set(port: *mut typec_port, role: enum typec_data_role) -> c_int {
    ...
    int ret;
    mutex_lock(&tps.lock);
    ret = tps6598x_exec_cmd(tps, cmd, 0, core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret)
    goto out_unlock;
...
#[no_mangle]
unsafe extern "C" fn tps6598x_pr_set(port: *mut typec_port, role: enum typec_role) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_read_status(tps: *mut tps6598x, status: *mut u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_read_data_status(tps: *mut tps6598x) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cd321x_read_data_status(tps: *mut tps6598x) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_read_power_status(tps: *mut tps6598x) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn tps66993_read_power_status(tps: *mut tps6598x) -> bool {
    static bool tps66993_read_power_status(struct tps6598x *tps)
    {
    let mut pwr_status: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn tps6598x_handle_plug_event(tps: *mut tps6598x, status: u32) {
...
#[no_mangle]
unsafe extern "C" fn cd321x_typec_update_mode(tps: *mut tps6598x, st: *mut cd321x_status) {
    ...
    return;
    cd321x.state.alt = core::ptr::null_mut();
    cd321x.state.mode = TYPEC_STATE_SAFE;
    cd321x.state.data = core::ptr::null_mut();
    ...
    if (cd321x.state.alt == core::ptr::null_mut() && cd321x.state.mode == TYPEC_MODE_USB4)
    return;
    ...
    if (cd321x.state.alt == core::ptr::null_mut() && cd321x.state.mode == TYPEC_STATE_USB)
    return;
    cd321x.state.alt = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cd321x_update_work(work: *mut work_struct) {
    ...
    let mut old_connected: bool = !!tps.partner;
    let mut new_connected: bool = st.status & TPS_STATUS_PLUG_PRESENT;
    let mut was_disconnected: bool = st.status_changed & TPS_STATUS_PLUG_PRESENT;
    bool usb_connection = st.data_status &
    (TPS_DATA_STATUS_USB2_CONNECTION | TPS_DATA_STATUS_USB3_CONNECTION);
    let mut old_role: enum usb_role = usb_role_switch_get_role(tps.role_sw);
    let mut new_role: enum usb_role = USB_ROLE_NONE;
    let mut pwr_opmode: enum typec_pwr_opmode = TYPEC_PWR_MODE_USB;
    let mut orientation: enum typec_orientation = TYPEC_ORIENTATION_NONE;
    if (usb_connection) {
    ...
    let mut is_pd: bool = pwr_opmode == TYPEC_PWR_MODE_PD;
...
#[no_mangle]
unsafe extern "C" fn cd321x_queue_status(cd321x: *mut cd321x) {
...
#[no_mangle]
unsafe extern "C" fn cd321x_connect(tps: *mut tps6598x, status: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cd321x_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_has_role_changed(tps: *mut tps6598x, status: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tps25750_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t tps6598x_interrupt(int irq, void *data)
    {
    let mut intev_len: c_int = TPS_65981_2_6_INTEVENT_LEN;
    struct tps6598x *tps = data;
    u64 event1[2] = { };
    u64 event2[2] = { };
    u32 version;
...
#[no_mangle]
unsafe extern "C" fn tps6598x_poll_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_check_mode(tps: *mut tps6598x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cd321x_switch_power_state(tps: *mut tps6598x, target_state: u8) -> c_int {
    ...
    return 0;
    ret = tps6598x_exec_cmd(tps, "SSPS", sizeof(u8), &target_state, 0, core::ptr::null_mut());
    if (ret)
    return ret;
    ret = tps6598x_read8(tps, TPS_REG_SYSTEM_POWER_STATE, &state);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn devm_tps6598_psy_register(tps: *mut tps6598x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cd321x_register_port_altmodes(cd321x: *mut cd321x) -> c_int {
    ...
    cd321x.port_altmode_dp = core::ptr::null_mut();
    return PTR_ERR(amode);
    }
    ...
    cd321x.port_altmode_dp = core::ptr::null_mut();
    cd321x.port_altmode_tbt = core::ptr::null_mut();
    err_unregister_port:
...
#[no_mangle]
unsafe extern "C" fn tps25750_abort_patch_process(tps: *mut tps6598x) -> c_int {
    static int tps25750_abort_patch_process(struct tps6598x *tps)
    {
    int ret;
    ret = tps6598x_exec_cmd(tps, "PBMe", 0, core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn tps25750_start_patch_burst_mode(tps: *mut tps6598x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps25750_complete_patch_process(tps: *mut tps6598x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps25750_apply_patch(tps: *mut tps6598x) -> c_int {
...
//
    ...
    ret = tps6598x_exec_cmd(tps, "DBfg", 0, core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_apply_patch(tps: *mut tps6598x) -> c_int {
    static int tps6598x_apply_patch(struct tps6598x *tps)
    {
    let mut in: u8 = TPS_PTCS_CONTENT_DEV | TPS_PTCS_CONTENT_APP;
    u8 out[TPS_MAX_LEN] = {0};
    let mut in_len: usize = sizeof(in);
    ...
    ret = tps6598x_exec_cmd(tps, "PTCc", 0, core::ptr::null_mut(), TPS_PTCC_OUT_BYTES, out);
...
#[no_mangle]
unsafe extern "C" fn cd321x_init(tps: *mut tps6598x) -> c_int {
    static int cd321x_init(struct tps6598x *tps)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tps25750_init(tps: *mut tps6598x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_init(tps: *mut tps6598x) -> c_int {
    static int tps6598x_init(struct tps6598x *tps)
    {
    return tps.data.apply_patch(tps);
    }
#[no_mangle]
unsafe extern "C" fn cd321x_reset(tps: *mut tps6598x) -> c_int {
    static int cd321x_reset(struct tps6598x *tps)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tps25750_reset(tps: *mut tps6598x) -> c_int {
    static int tps25750_reset(struct tps6598x *tps)
    {
    return tps6598x_exec_cmd_tmo(tps, "GAID", 0, core::ptr::null_mut(), 0, core::ptr::null_mut(), 2000, 0);
    }
#[no_mangle]
unsafe extern "C" fn tps6598x_reset(tps: *mut tps6598x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cd321x_remove(tps: *mut tps6598x) {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tps6598x_resume(dev: *mut device) -> int __maybe_unused {
