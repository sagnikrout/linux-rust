...
//! Source: drivers/usb/typec/ucsi/ucsi_ccg.c
#![no_std]
...
pub const CCGX_RAB_DEVICE_MODE: c_uint = 0x0000;
pub const CCGX_RAB_INTR_REG: c_uint = 0x0006;

pub const CCGX_RAB_JUMP_TO_BOOT: c_uint = 0x0007;

pub const CCGX_RAB_RESET_REQ: c_uint = 0x0008;

pub const CMD_RESET_I2C: c_uint = 0x0;
pub const CMD_RESET_DEV: c_uint = 0x1;
pub const CCGX_RAB_ENTER_FLASHING: c_uint = 0x000A;

pub const CCGX_RAB_VALIDATE_FW: c_uint = 0x000B;
pub const CCGX_RAB_FLASH_ROW_RW: c_uint = 0x000C;

pub const FLASH_RD_CMD: c_uint = 0x0;
pub const FLASH_WR_CMD: c_uint = 0x1;
pub const FLASH_FWCT1_WR_CMD: c_uint = 0x2;
pub const FLASH_FWCT2_WR_CMD: c_uint = 0x3;
pub const FLASH_FWCT_SIG_WR_CMD: c_uint = 0x4;
pub const CCGX_RAB_READ_ALL_VER: c_uint = 0x0010;
pub const CCGX_RAB_READ_FW2_VER: c_uint = 0x0020;
pub const CCGX_RAB_UCSI_CONTROL: c_uint = 0x0039;

pub const REG_FLASH_RW_MEM: c_uint = 0x0200;

pub const CCGX_RAB_PDPORT_ENABLE: c_uint = 0x002C;

pub const CCGX_RAB_RESPONSE: c_uint = 0x007E;

// CCGx events & async msg codes
pub const RESET_COMPLETE: c_uint = 0x80;

pub const PORT_CONNECT_DET: c_uint = 0x84;
pub const PORT_DISCONNECT_DET: c_uint = 0x85;
pub const ROLE_SWAP_COMPELETE: c_uint = 0x87;
// ccg firmware
pub const CYACD_LINE_SIZE: c_int = 527;
pub const CCG4_ROW_SIZE: c_int = 256;
pub const FW1_METADATA_ROW: c_uint = 0x1FF;
pub const FW2_METADATA_ROW: c_uint = 0x1FE;
pub const FW_CFG_TABLE_SIG_SIZE: c_int = 256;
    let mut secondary_fw_min_ver: static int = 41;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ccg_dev_info {

    pub mode: u8,
    pub bl_mode: u8,
    pub silicon_id: __le16,
    pub bl_last_row: __le16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct version_format {
    pub build: __le16,
    pub patch: u8,
    pub ver: u8,
...
pub struct version_info {
    pub base: version_format,
    pub app: version_format,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fw_config_table {
    pub identity: u32,
    pub table_size: u16,
    pub fwct_version: u8,
    pub is_key_change: u8,
    pub guid: [u8; 16],
    pub base: version_format,
    pub app: version_format,
    pub primary_fw_digest: [u8; 32],
    pub key_exp_length: u32,
    pub key_modulus: [u8; 256],
    pub key_exp: [u8; 4],
}
...
pub struct ccg_cmd {
    ...
    pub data: u32,
    pub len: c_int,
    pub /: *mut *mut u32 delay; / ms delay for cmd timeout,
}
...
pub struct ucsi_ccg_altmode {
    ...
    pub checked: bool,
    pub __packed: },
pub const CCGX_MESSAGE_IN_MAX: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct op_region {
    pub cci: __le32,
    pub message_in: [__le32; CCGX_MESSAGE_IN_MAX],
}
...
pub struct ucsi_ccg {
    ...
    pub info: ccg_dev_info,
// version info for boot, primary and secondary
    pub 1]: version_info version[FW2 +,
    pub fw_version: u32,
// CCG HPI communication flags
    pub flags: c_ulong,
pub const RESET_PENDING: c_int = 0;
pub const DEV_CMD_PENDING: c_int = 1;
    pub dev_resp: ccg_resp,
    pub cmd_resp: u8,
    pub port_num: c_int,
    pub irq: c_int,
    pub work: work_struct,
    pub /: *mut *mut mutex lock; / to sync between user and driver thread,
// fw build with vendor information
    pub fw_build: u16,
    pub pm_work: work_struct,
    pub has_multiple_dp: bool,
    pub orig: [ucsi_ccg_altmode; UCSI_MAX_ALTMODES],
    pub updated: [ucsi_ccg_altmode; UCSI_MAX_ALTMODES],
//
// This spinlock protects op_data which includes CCI and MESSAGE_IN that
// will be updated in ISR
//
    pub op_lock: spinlock_t,
    pub op_data: op_region,
}

#[no_mangle]
unsafe extern "C" fn ccg_read(uc: *mut ucsi_ccg, rab: u16, data: *mut u8, len: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccg_write(uc: *mut ucsi_ccg, rab: u16, data: *const u8, len: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccg_op_region_update(uc: *mut ucsi_ccg, cci: u32) -> c_int {
    static int ccg_op_region_update(struct ucsi_ccg *uc, u32 cci)
    {
    let mut reg: u16 = CCGX_RAB_UCSI_DATA_BLOCK(UCSI_MESSAGE_IN);
    struct op_region *data = &uc.op_data;
    unsigned char *buf;
    let mut size: usize = sizeof(data.message_in);
    buf = kzalloc(size, GFP_ATOMIC);
    if (!buf)
    return -ENOMEM;
    if (UCSI_CCI_LENGTH(cci)) {
    let mut ret: c_int = ccg_read(uc, reg, (void *)buf, size);
    if (ret) {
    kfree(buf);
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn ucsi_ccg_init(uc: *mut ucsi_ccg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ucsi_ccg_update_get_current_cam_cmd(uc: *mut ucsi_ccg, data: *mut u8) {
...
// Didn't find any duplicate DP altmode
    ...
    struct typec_altmode *alt = core::ptr::null_mut();
    u8 new_cam, cam, pin;
    bool enter_new_mode;
    int i, j, k = 0xff;
    port = uc.orig;
...
#[no_mangle]
unsafe extern "C" fn ucsi_ccg_read_version(ucsi: *mut ucsi, version: *mut u16) -> c_int {
    static int ucsi_ccg_read_version(struct ucsi *ucsi, u16 *version)
    {
    struct ucsi_ccg *uc = ucsi_get_drvdata(ucsi);
    let mut reg: u16 = CCGX_RAB_UCSI_DATA_BLOCK(UCSI_VERSION);
    return ccg_read(uc, reg, (u8 *)version, sizeof(*version));
    }
#[no_mangle]
unsafe extern "C" fn ucsi_ccg_read_cci(ucsi: *mut ucsi, cci: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ucsi_ccg_read_message_in(ucsi: *mut ucsi, val: *mut c_void, val_len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ucsi_ccg_async_control(ucsi: *mut ucsi, command: u64) -> c_int {
    static int ucsi_ccg_async_control(struct ucsi *ucsi, u64 command)
    {
    struct ucsi_ccg *uc = ucsi_get_drvdata(ucsi);
    let mut reg: u16 = CCGX_RAB_UCSI_DATA_BLOCK(UCSI_CONTROL);
//
...
#[no_mangle]
unsafe extern "C" fn ccg_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t ccg_irq_handler(int irq, void *data)
    {
    let mut reg: u16 = CCGX_RAB_UCSI_DATA_BLOCK(UCSI_CCI);
    ...
    return IRQ_HANDLED;
#[no_mangle]
pub unsafe extern "C" fn if(UCSI_READ_INT): !(intr_reg &) -> else {
...
#[no_mangle]
unsafe extern "C" fn ccg_request_irq(uc: *mut ucsi_ccg) -> c_int {
    static int ccg_request_irq(struct ucsi_ccg *uc)
    {
    let mut flags: c_ulong = IRQF_ONESHOT;
    if (!dev_fwnode(uc.dev))
    flags |= IRQF_TRIGGER_HIGH;
    return request_threaded_irq(uc.irq, core::ptr::null_mut(), ccg_irq_handler, flags, dev_name(uc.dev), uc);
    }
#[no_mangle]
unsafe extern "C" fn ccg_pm_workaround_work(pm_work: *mut work_struct) {
    static void ccg_pm_workaround_work(struct work_struct *pm_work)
    {
    ccg_irq_handler(0, container_of(pm_work, struct ucsi_ccg, pm_work));
    }
#[no_mangle]
unsafe extern "C" fn get_fw_info(uc: *mut ucsi_ccg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn invalid_async_evt(code: c_int) -> bool {
    static inline bool invalid_async_evt(int code)
    {
    return (code >= CCG_EVENT_MAX) || (code < EVENT_INDEX);
    }
#[no_mangle]
unsafe extern "C" fn ccg_process_response(uc: *mut ucsi_ccg) {
...
#[no_mangle]
unsafe extern "C" fn ccg_read_response(uc: *mut ucsi_ccg) -> c_int {
    static int ccg_read_response(struct ucsi_ccg *uc)
    {
    let mut target: c_ulong = jiffies + msecs_to_jiffies(1000);
    struct device *dev = uc.dev;
    u8 intval;
    int status;
...
#[no_mangle]
unsafe extern "C" fn ccg_send_command(uc: *mut ucsi_ccg, cmd: *mut ccg_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccg_cmd_enter_flashing(uc: *mut ucsi_ccg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccg_cmd_reset(uc: *mut ucsi_ccg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccg_cmd_port_control(uc: *mut ucsi_ccg, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccg_cmd_jump_boot_mode(uc: *mut ucsi_ccg, bl_mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccg_cmd_validate_fw(uc: *mut ucsi_ccg, fwid: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_flash(uc: *mut ucsi_ccg, mode: enum enum_flash_mode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ccg_fw_update(uc: *mut ucsi_ccg, flash_mode: enum enum_flash_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccg_restart(uc: *mut ucsi_ccg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccg_update_firmware(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ucsi_ccg_attrs_is_visible(kobj: *mut kobject, attr: *mut attribute, idx: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn ucsi_ccg_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(fw_name, _arg: "nvidia, _arg: gpu")) -> else {
...
#[no_mangle]
unsafe extern "C" fn ucsi_ccg_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ucsi_ccg_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ucsi_ccg_runtime_suspend(dev: *mut device) -> c_int {
    static int ucsi_ccg_runtime_suspend(struct device *dev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ucsi_ccg_runtime_resume(dev: *mut device) -> c_int {
