...
//! Source: drivers/usb/typec/ucsi/ucsi_huawei_gaokun.c
#![no_std]
...
pub const EC_EVENT_UCSI: c_uint = 0x21;
pub const EC_EVENT_USB: c_uint = 0x22;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gaokun_ucsi_port {
    pub usb_ack: completion,
    pub /: *mut *mut spinlock_t lock; / serializing port resource access,
    pub ucsi: *mut gaokun_ucsi,
    pub bridge: *mut auxiliary_device,
    pub typec_mux: *mut typec_mux,
    pub state: typec_mux_state,
    pub dp_alt: typec_altmode,
    pub idx: c_int,
    pub ccx: enum gaokun_ucsi_ccx,
    pub mux: enum gaokun_ucsi_mux,
    pub mode: u8,
    pub svid: u16,
    pub hpd_state: u8,
    pub hpd_irq: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gaokun_ucsi {
    pub ec: *mut gaokun_ec,
    pub ucsi: *mut ucsi,
    pub ports: *mut gaokun_ucsi_port,
    pub dev: *mut device,
...
// For UCSI
#[no_mangle]
unsafe extern "C" fn gaokun_ucsi_read_version(ucsi: *mut ucsi, version: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaokun_ucsi_read_cci(ucsi: *mut ucsi, cci: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaokun_ucsi_async_control(ucsi: *mut ucsi, command: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaokun_ucsi_update_connector(con: *mut ucsi_connector) {
...
#[no_mangle]
unsafe extern "C" fn gaokun_ucsi_connector_status(con: *mut ucsi_connector) {
...
#[no_mangle]
unsafe extern "C" fn gaokun_ucsi_refresh(uec: *mut gaokun_ucsi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaokun_ucsi_handle_usb_mode(port: *mut gaokun_ucsi_port) {
    static void gaokun_ucsi_handle_usb_mode(struct gaokun_ucsi_port *port)
    {
    struct gaokun_ucsi *uec = port.ucsi;
    let mut idx: c_int = port.idx, ret;
//
...
#[no_mangle]
unsafe extern "C" fn gaokun_ucsi_usb_notify_ind(uec: *mut gaokun_ucsi) {
...
//
#[no_mangle]
unsafe extern "C" fn gaokun_ucsi_complete_usb_ack(uec: *mut gaokun_ucsi) {
...
//
#[no_mangle]
unsafe extern "C" fn gaokun_ucsi_handle_no_usb_event(uec: *mut gaokun_ucsi, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gaokun_ucsi_ports_init(uec: *mut gaokun_ucsi) -> c_int {
    static int gaokun_ucsi_ports_init(struct gaokun_ucsi *uec)
    {
    struct gaokun_ucsi_port *ucsi_port;
    let mut ureg: gaokun_ucsi_reg = {};
...
#[no_mangle]
unsafe extern "C" fn gaokun_ucsi_register_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn gaokun_ucsi_remove(adev: *mut auxiliary_device) {
