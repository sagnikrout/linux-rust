...
//! Source: drivers/usb/typec/ucsi/ucsi_glink.c
#![no_std]
...
pub const MSG_TYPE_REQ_RESP: c_int = 1;
pub const UC_NOTIFY_RECEIVER_UCSI: c_uint = 0x0;
pub const UC_UCSI_READ_BUF_REQ: c_uint = 0x11;
pub const UC_UCSI_WRITE_BUF_REQ: c_uint = 0x12;
pub const UC_UCSI_USBC_NOTIFY_IND: c_uint = 0x13;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ucsi_read_buf_req_msg {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmic_glink_ucsi {
    pub dev: *mut device,
    pub port_orientation: [*mut gpio_desc; PMIC_GLINK_MAX_PORTS],
    pub client: *mut pmic_glink_client,
    pub ucsi: *mut ucsi,
    pub read_ack: completion,
    pub write_ack: completion,
    pub /: *mut *mut mutex lock; / protects concurrent access to PMIC Glink interface,
    pub notify_work: work_struct,
    pub register_work: work_struct,
    pub state_lock: spinlock_t,
    pub ucsi_registered: bool,
    pub pd_running: bool,
    pub read_buf: [u8; UCSI_BUF_V2_SIZE],
}
    ...
    let mut req: ucsi_read_buf_req_msg = {};
    unsigned long left;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn pmic_glink_ucsi_read_version(ucsi: *mut ucsi, version: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmic_glink_ucsi_read_cci(ucsi: *mut ucsi, cci: *mut u32) -> c_int {
    static int pmic_glink_ucsi_read_cci(struct ucsi *ucsi, u32 *cci)
    {
    return pmic_glink_ucsi_read(ucsi, UCSI_CCI, cci, sizeof(*cci));
    }
#[no_mangle]
unsafe extern "C" fn pmic_glink_ucsi_read_message_in(ucsi: *mut ucsi, val: *mut c_void, val_len: usize) -> c_int {
    ...
    {
    let mut req: ucsi_write_buf_req_msg = {};
...
#[no_mangle]
unsafe extern "C" fn pmic_glink_ucsi_async_control(__ucsi: *mut ucsi, command: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmic_glink_ucsi_update_connector(con: *mut ucsi_connector) {
...
#[no_mangle]
unsafe extern "C" fn pmic_glink_ucsi_connector_status(con: *mut ucsi_connector) {
...
#[no_mangle]
unsafe extern "C" fn pmic_glink_ucsi_read_ack(ucsi: *mut pmic_glink_ucsi, data: *const c_void, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pmic_glink_ucsi_write_ack(ucsi: *mut pmic_glink_ucsi, data: *const c_void, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pmic_glink_ucsi_notify(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pmic_glink_ucsi_register(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pmic_glink_ucsi_callback(data: *const c_void, len: usize, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pmic_glink_ucsi_pdr_notify(priv: *mut c_void, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pmic_glink_ucsi_destroy(data: *mut c_void) {
...
// Protect to make sure we're not in a middle of a transaction from a glink callback
    ...
    let mut quirk_sc8180x: static unsigned long = UCSI_NO_PARTNER_PDOS;
    let mut quirk_sc8280xp: static unsigned long = UCSI_NO_PARTNER_PDOS | UCSI_DELAY_DEVICE_PDOS;
    let mut quirk_sm8450: static unsigned long = UCSI_DELAY_DEVICE_PDOS;
    let mut quirk_x1e80100: static unsigned long = UCSI_DELAY_DEVICE_PDOS | UCSI_USB4_IMPLIES_USB;
...
#[no_mangle]
unsafe extern "C" fn pmic_glink_ucsi_remove(adev: *mut auxiliary_device) {
