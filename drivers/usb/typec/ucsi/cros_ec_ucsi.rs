...
//! Source: drivers/usb/typec/ucsi/cros_ec_ucsi.c
#![no_std]
...
//
pub const MAX_EC_DATA_SIZE: c_int = 256;
//
// Maximum time in milliseconds the cros_ec_ucsi driver
// will wait for a response to a command or and ack.
//
pub const WRITE_TMO_MS: c_int = 5000;
// Number of times to attempt recovery from a write timeout before giving up.
pub const WRITE_TMO_CTR_MAX: c_int = 5;
// Delay between mode entry/exit attempts, ms
    let mut mode_selection_delay: static unsigned int = 1000;
// Timeout for a mode entry attempt, ms
    let mut mode_selection_timeout: static unsigned int = 4000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_ucsi_data {
    pub dev: *mut device,
    pub ucsi: *mut ucsi,
    pub ec: *mut cros_ec_device,
    pub nb: notifier_block,
    pub work: work_struct,
    pub write_tmo: delayed_work,
    pub tmo_counter: c_int,
...
#[no_mangle]
unsafe extern "C" fn cros_ucsi_read_version(ucsi: *mut ucsi, version: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ucsi_read_cci(ucsi: *mut ucsi, cci: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ucsi_async_control(ucsi: *mut ucsi, cmd: u64) -> c_int {
    ...
    req, sizeof(ec_buf), core::ptr::null_mut(), 0);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn cros_ucsi_add_partner_altmodes(con: *mut ucsi_connector) {
...
#[no_mangle]
unsafe extern "C" fn cros_ucsi_remove_partner_altmodes(con: *mut ucsi_connector) {
...
#[no_mangle]
unsafe extern "C" fn cros_ucsi_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn cros_ucsi_write_timeout(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn cros_ucsi_destroy(udata: *mut cros_ucsi_data) {
...
#[no_mangle]
unsafe extern "C" fn cros_ucsi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ucsi_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn cros_ucsi_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn cros_ucsi_complete(dev: *mut device) -> void __maybe_unused {
