...
//! Source: drivers/usb/typec/tcpm/tcpci_maxim_core.c
#![no_std]
...
pub const PD_ACTIVITY_TIMEOUT_MS: c_int = 10000;
pub const TCPC_VENDOR_ALERT: c_uint = 0x80;
pub const TCPC_VENDOR_USBSW_CTRL: c_uint = 0x93;
pub const TCPC_VENDOR_USBSW_CTRL_ENABLE_USB_DATA: c_uint = 0x9;
pub const TCPC_VENDOR_USBSW_CTRL_DISABLE_USB_DATA: c_int = 0;
pub const TCPC_RECEIVE_BUFFER_COUNT_OFFSET: c_int = 0;
pub const TCPC_RECEIVE_BUFFER_FRAME_TYPE_OFFSET: c_int = 1;
pub const TCPC_RECEIVE_BUFFER_RX_BYTE_BUF_OFFSET: c_int = 2;
//
...
//
pub const TCPC_RECEIVE_BUFFER_LEN: c_int = 32;
...
#[no_mangle]
unsafe extern "C" fn max_tcpci_init_regs(chip: *mut max_tcpci_chip) {
    static void max_tcpci_init_regs(struct max_tcpci_chip *chip)
    {
    let mut alert_mask: u16 = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn process_rx(chip: *mut max_tcpci_chip, status: u16) {
...
#[no_mangle]
unsafe extern "C" fn get_vbus_regulator_handle(chip: *mut max_tcpci_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max_tcpci_set_vbus(tcpci: *mut tcpci, tdata: *mut tcpci_data, source: bool, sink: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn process_power_status(chip: *mut max_tcpci_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn if(TCPC_POWER_STATUS_SOURCING_VBUS: pwr_status &) -> else {
...
#[no_mangle]
unsafe extern "C" fn max_tcpci_frs_sourcing_vbus(tcpci: *mut tcpci, tdata: *mut tcpci_data) {
...
#[no_mangle]
unsafe extern "C" fn process_tx(chip: *mut max_tcpci_chip, status: u16) {
...
#[no_mangle]
unsafe extern "C" fn _max_tcpci_irq(chip: *mut max_tcpci_chip, status: u16) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max_tcpci_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t max_tcpci_irq(int irq, void *dev_id)
    {
    struct max_tcpci_chip *chip = dev_id;
    u16 status;
    let mut irq_return: irqreturn_t = IRQ_HANDLED;
    int ret;
    if (!chip.port)
    return IRQ_HANDLED;
...
#[no_mangle]
unsafe extern "C" fn max_tcpci_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tcpci_init(tcpci: *mut tcpci, data: *mut tcpci_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max_tcpci_check_contaminant(tcpci: *mut tcpci, tdata: *mut tcpci_data) {
...
#[no_mangle]
unsafe extern "C" fn max_tcpci_attempt_vconn_swap_discovery(tcpci: *mut tcpci, tdata: *mut tcpci_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max_tcpci_unregister_tcpci_port(tcpci: *mut c_void) {
    static void max_tcpci_unregister_tcpci_port(void *tcpci)
    {
    tcpci_unregister_port(tcpci);
    }
#[no_mangle]
unsafe extern "C" fn max_tcpci_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max_tcpci_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max_tcpci_suspend(dev: *mut device) -> c_int {
