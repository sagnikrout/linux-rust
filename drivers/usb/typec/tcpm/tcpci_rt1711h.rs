...
//! Source: drivers/usb/typec/tcpm/tcpci_rt1711h.c
#![no_std]
...
pub const RT1711H_PHYCTRL1: c_uint = 0x80;
pub const RT1711H_PHYCTRL2: c_uint = 0x81;
pub const RT1711H_RTCTRL4: c_uint = 0x93;
// rx threshold of rd/rp: 1b0 for level 0.4V/0.7V, 1b1 for 0.35V/0.75V

pub const RT1711H_RTCTRL8: c_uint = 0x9B;
// Autoidle timeout = (tout * 2 + 1) * 6.4ms

    (((ck300) << 7) | ((ship_off) << 5) | \
    ((auto_idle) << 3) | ((tout) & 0x07))

pub const RT1711H_RTCTRL11: c_uint = 0x9E;
// I2C timeout = (tout + 1) * 12.5ms

    (((en) << 7) | ((tout) & 0x0F))
pub const RT1711H_RTCTRL13: c_uint = 0xA0;
pub const RT1711H_RTCTRL14: c_uint = 0xA1;
pub const RT1711H_RTCTRL15: c_uint = 0xA2;
pub const RT1711H_RTCTRL16: c_uint = 0xA3;
pub const RT1711H_RTCTRL18: c_uint = 0xAF;
// 1b0 as fixed rx threshold of rd/rp 0.55V, 1b1 depends on RTCRTL4[0]

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rt1711h_chip_info {
    pub rxdz_sel: u32,
    pub enable_pd30_extended_message: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rt1711h_chip {
    pub data: tcpci_data,
    pub tcpci: *mut tcpci,
    pub dev: *mut device,
    pub vbus: *mut regulator,
    pub info: *const rt1711h_chip_info,
    pub src_en: bool,
}

#[no_mangle]
unsafe extern "C" fn rt1711h_read16(chip: *mut rt1711h_chip, reg: c_uint, val: *mut u16) -> c_int {
    static int rt1711h_read16(struct rt1711h_chip *chip, unsigned int reg, u16 *val)
    {
    return regmap_raw_read(chip.data.regmap, reg, val, sizeof(u16));
    }
#[no_mangle]
unsafe extern "C" fn rt1711h_write16(chip: *mut rt1711h_chip, reg: c_uint, val: u16) -> c_int {
    static int rt1711h_write16(struct rt1711h_chip *chip, unsigned int reg, u16 val)
    {
    return regmap_raw_write(chip.data.regmap, reg, &val, sizeof(u16));
    }
#[no_mangle]
unsafe extern "C" fn rt1711h_read8(chip: *mut rt1711h_chip, reg: c_uint, val: *mut u8) -> c_int {
    static int rt1711h_read8(struct rt1711h_chip *chip, unsigned int reg, u8 *val)
    {
    return regmap_raw_read(chip.data.regmap, reg, val, sizeof(u8));
    }
#[no_mangle]
unsafe extern "C" fn rt1711h_write8(chip: *mut rt1711h_chip, reg: c_uint, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt1711h_init(tcpci: *mut tcpci, tdata: *mut tcpci_data) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rt1711h_init_cc_params(chip: *mut rt1711h_chip, status: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt1711h_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rt1711h_sw_reset(chip: *mut rt1711h_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt1711h_probe(client: *mut i2c_client) -> c_int {
...
// Disable chip interrupts before requesting irq
    ...
    if (ret)
    return ret;
    ret = devm_request_threaded_irq(chip.dev, client.irq, core::ptr::null_mut(),
    rt1711h_irq,
...
#[no_mangle]
unsafe extern "C" fn rt1711h_unregister_tcpci_port(tcpci: *mut c_void) {
    static void rt1711h_unregister_tcpci_port(void *tcpci)
    {
