...
//! Source: drivers/usb/typec/tcpm/tcpm.c
#![no_std]
...
pub const LOG_BUFFER_ENTRIES: c_int = 1024;
pub const LOG_BUFFER_ENTRY_SIZE: c_int = 128;
// Alternate mode support
pub const SVID_DISCOVERY_MAX: c_int = 16;

pub const GET_SINK_CAP_RETRY_MS: c_int = 100;
pub const SEND_DISCOVERY_VDM_RETRY_MS: c_int = 100;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pd_mode_data {
    pub /: *mut *mut int svid_index; / current SVID index,
    pub nsvids: c_int,
    pub svids: [u16; SVID_DISCOVERY_MAX],
    pub /: *mut *mut int altmodes; / number of alternate modes,
    pub altmode_desc: [typec_altmode_desc; ALTMODE_DISCOVERY_MAX],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pd_pps_data {
    pub min_volt: u32,
    pub req_min_volt: u32,
    pub max_volt: u32,
    pub req_max_volt: u32,
    pub max_curr: u32,
    pub req_max_curr: u32,
    pub req_out_volt: u32,
    pub req_op_curr: u32,
    pub supported: bool,
    pub active: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pd_spr_avs_data {
    pub max_current_ma_9v_to_15v: u32,
    pub max_current_ma_15v_to_20v: u32,
    pub req_op_curr_ma: u32,
    pub req_out_volt_mv: u32,
    pub max_out_volt_mv: u32,
    pub max_current_ma: u32,
    pub port_partner_src_status: enum spr_avs_status,
    pub port_partner_src_pdo_index: c_uint,
    pub port_snk_status: enum spr_avs_status,
    pub port_snk_pdo_index: c_uint,
    pub active: bool,
}
...
pub struct pd_data {
    ...
    pub source_cap: *mut usb_power_delivery_capabilities,
    pub source_desc: usb_power_delivery_capabilities_desc,
    pub sink_cap: *mut usb_power_delivery_capabilities,
    pub sink_desc: usb_power_delivery_capabilities_desc,
    pub operating_snk_mw: c_uint,
}

pub const PD_CAP_REV10: c_uint = 0x1;
pub const PD_CAP_REV20: c_uint = 0x2;
pub const PD_CAP_REV30: c_uint = 0x3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pd_revision_info {
    pub rev_major: u8,
    pub rev_minor: u8,
    pub ver_major: u8,
    pub ver_minor: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pd_timings {
    pub sink_wait_cap_time: u32,
    pub ps_src_off_time: u32,
    pub cc_debounce_time: u32,
    pub snk_bc12_cmpletion_time: u32,
}
...
//
pub const MAX_NUM_FIXED_BATT: c_int = 4;
pub const BATTERY_PROPERTY_UNKNOWN: c_uint = 0xffff;
//
...
pub struct tcpm_port {
    pub dev: *mut device,
    pub /: *mut *mut mutex lock; / tcpm state machine lock,
    pub wq: *mut kthread_worker,
    pub typec_caps: typec_capability,
    pub typec_port: *mut typec_port,
    pub tcpc: *mut tcpc_dev,
    pub role_sw: *mut usb_role_switch,
    pub vconn_role: enum typec_role,
    pub pwr_role: enum typec_role,
    pub data_role: enum typec_data_role,
    pub pwr_opmode: enum typec_pwr_opmode,
    pub partner_ident: usb_pd_identity,
    pub partner_desc: typec_partner_desc,
    pub partner: *mut typec_partner,
    pub cable_ident: usb_pd_identity,
    pub cable_desc: typec_cable_desc,
    pub cable: *mut typec_cable,
    pub plug_prime_desc: typec_plug_desc,
    pub plug_prime: *mut typec_plug,
    pub cc_req: enum typec_cc_status,
    pub /: *mut *mut enum typec_cc_status src_rp; / work only if pd_supported == false,
    pub cc1: enum typec_cc_status,
    pub cc2: enum typec_cc_status,
    pub polarity: enum typec_cc_polarity,
    pub attached: bool,
    pub connected: bool,
    pub registered: bool,
...
//
    pub vbus_vsafe0v: bool,
    pub vbus_never_low: bool,
    pub vbus_source: bool,
    pub vbus_charge: bool,
    pub op_vsafe5v: bool,
    pub try_role: c_int,
    pub try_snk_count: c_int,
    pub try_src_count: c_int,
    pub queued_message: enum pd_msg_request,
    pub enter_state: enum tcpm_state,
    pub prev_state: enum tcpm_state,
    pub state: enum tcpm_state,
    pub delayed_state: enum tcpm_state,
    pub delayed_runtime: ktime_t,
    pub delay_ms: c_ulong,
    pub pd_event_lock: spinlock_t,
    pub pd_events: u32,
    pub event_work: kthread_work,
    pub state_machine_timer: hrtimer,
    pub state_machine: kthread_work,
    pub vdm_state_machine_timer: hrtimer,
    pub vdm_state_machine: kthread_work,
    pub enable_frs_timer: hrtimer,
    pub enable_frs: kthread_work,
    pub vdm_discovery_timer: hrtimer,
    pub vdm_discovery_work: kthread_work,
    pub state_machine_running: bool,
// Set to true when VDM State Machine has following actions.
    pub vdm_sm_running: bool,
    pub tx_complete: completion,
    pub tx_status: enum tcpm_transmit_status,
    pub /: *mut *mut mutex swap_lock; / swap command lock,
    pub swap_pending: bool,
    pub non_pd_role_swap: bool,
    pub swap_complete: completion,
    pub swap_status: c_int,
    pub negotiated_rev: c_uint,
    pub message_id: c_uint,
    pub caps_count: c_uint,
    pub hard_reset_count: c_uint,
    pub pd_capable: bool,
    pub explicit_contract: bool,
    pub rx_msgid: c_uint,
// USB PD objects
    pub pds: *mut usb_power_delivery,
    pub pd_list: *mut pd_data,
    ...
    pub selected_pd: *mut usb_power_delivery,
// Partner capabilities/requests
    pub sink_request: u32,
    pub source_caps: [u32; PDO_MAX_OBJECTS],
    pub nr_source_caps: c_uint,
    pub sink_caps: [u32; PDO_MAX_OBJECTS],
    pub nr_sink_caps: c_uint,
// Local capabilities
    pub pd_count: c_uint,
    pub src_pdo: [u32; PDO_MAX_OBJECTS],
    pub nr_src_pdo: c_uint,
    pub snk_pdo: [u32; PDO_MAX_OBJECTS],
    pub nr_snk_pdo: c_uint,
    pub snk_vdo_v1: [u32; VDO_MAX_OBJECTS],
    pub nr_snk_vdo_v1: c_uint,
    pub snk_vdo: [u32; VDO_MAX_OBJECTS],
    pub nr_snk_vdo: c_uint,
    pub operating_snk_mw: c_uint,
    pub update_sink_caps: bool,
// Requested current / voltage to the port partner
    pub req_current_limit: u32,
    pub req_supply_voltage: u32,
// Actual current / voltage limit of the local port
    pub current_limit: u32,
    pub supply_voltage: u32,
// Used to export TA voltage and current
    pub psy: *mut power_supply,
    pub psy_desc: power_supply_desc,
    pub usb_type: enum power_supply_usb_type,
    pub bist_request: u32,
// VDM Discovery State to determine message sent
    pub vdm_discovery_state: enum vdm_discovery_states,
// PD state for Vendor Defined Messages
    pub vdm_state: enum vdm_states,
    pub vdm_retries: u32,
// next Vendor Defined Message to send
    pub vdo_data: [u32; VDO_MAX_SIZE],
    pub vdo_count: u8,
// VDO to retry if UFP responder replied busy
    pub vdo_retry: u32,
// PPS
    pub pps_data: pd_pps_data,
// SPR AVS
    pub spr_avs_data: pd_spr_avs_data,
// Augmented supply request - PPS; SPR_AVS
    pub aug_supply_req_complete: completion,
    pub aug_supply_req_pending: bool,
    pub aug_supply_req_status: c_int,
// Alternate mode data
    pub mode_data: pd_mode_data,
    pub mode_data_prime: pd_mode_data,
    pub partner_altmode: [*mut typec_altmode; ALTMODE_DISCOVERY_MAX],
    pub plug_prime_altmode: [*mut typec_altmode; ALTMODE_DISCOVERY_MAX],
    pub port_altmode: [*mut typec_altmode; ALTMODE_DISCOVERY_MAX],
// Deadline in jiffies to exit src_try_wait state
    pub max_wait: c_ulong,
// port belongs to a self powered device
    pub self_powered: bool,
// Sink FRS
    pub new_source_frs_current: enum frs_typec_current,
// Sink caps have been queried
    pub sink_cap_done: bool,
// Collision Avoidance and Atomic Message Sequence
    pub upcoming_state: enum tcpm_state,
    pub ams: enum tcpm_ams,
    pub next_ams: enum tcpm_ams,
    pub in_ams: bool,
// Auto vbus discharge status
    pub auto_vbus_discharge_enabled: bool,
//
// When set, port requests PD_P_SNK_STDBY_MW upon entering SNK_DISCOVERY and
// the actual current limit after RX of PD_CTRL_PSRDY for PD link,
// SNK_READY for non-pd link.
//
    pub slow_charger_loop: bool,
//
...
// transitions.
//
    pub potential_contaminant: bool,
// SOP* Related Fields
//
...
//
    pub tx_sop_type: enum tcpm_transmit_type,
//
...
// as well.
//
    pub negotiated_rev_prime: c_uint,
//
// Each SOP* type must maintain their own tx and rx message IDs
//
    pub message_id_prime: c_uint,
    pub rx_msgid_prime: c_uint,
// Timer deadline values configured at runtime
    pub timings: pd_timings,
// Indicates maximum (revision, version) supported
    pub pd_rev: pd_revision_info,
    pub pd_ident: pd_identifier,
    pub sink_caps_ext: sink_caps_ext_data,
    pub fixed_batt: *mut power_supply,
    pub fixed_batt_cnt: u32,
    pub batt_request_id: u32,

    pub dentry: *mut dentry,
    pub /: *mut *mut mutex logbuffer_lock; / log buffer access lock,
    pub logbuffer_head: c_int,
    pub logbuffer_tail: c_int,
    pub logbuffer: [*mut u8; LOG_BUFFER_ENTRIES],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pd_rx_event {
    pub work: kthread_work,
    pub port: *mut tcpm_port,
    pub msg: pd_message,
    pub rx_sop_type: enum tcpm_transmit_type,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct altmode_vdm_event {
    pub work: kthread_work,
    pub port: *mut tcpm_port,
    pub header: u32,
    pub cnt: c_int,
    pub tx_sop_type: enum tcpm_transmit_type,
    pub __counted_by(cnt): u32 data[],
}
...
#[no_mangle]
unsafe extern "C" fn tcpm_default_state(port: *mut tcpm_port) -> enum tcpm_state {
...
#[no_mangle]
pub unsafe extern "C" fn if(TYPEC_SOURCE: port->try_role ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn tcpm_port_is_disconnected(port: *mut tcpm_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcpm_log_full(port: *mut tcpm_port) -> bool {
    ...
    __printf(2, 0)
#[no_mangle]
unsafe extern "C" fn _tcpm_log(port: *mut tcpm_port, fmt: *const c_char, args: va_list) {
    ...
    if (!port.logbuffer[port.logbuffer_head]) {
    dev_warn(port.dev,
    "Log buffer index %d is core::ptr::null_mut()\n", port.logbuffer_head);
    goto abort;
    }
    ...
    __printf(2, 3)
#[no_mangle]
unsafe extern "C" fn tcpm_log(port: *mut tcpm_port, fmt: *const c_char, ...) {
...
// Do not log while disconnected and unattached
    ...
    __printf(2, 3)
#[no_mangle]
unsafe extern "C" fn tcpm_log_force(port: *mut tcpm_port, fmt: *const c_char, ...) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_log_source_caps(port: *mut tcpm_port) {
    static void tcpm_log_source_caps(struct tcpm_port *port)
    {
    int i;
    for (i = 0; i < port.nr_source_caps; i++) {
    let mut pdo: u32 = port.source_caps[i];
    let mut type: enum pd_pdo_type = pdo_type(pdo);
    char msg[64];
    switch (type) {
    case PDO_TYPE_FIXED:
...
#[no_mangle]
pub unsafe extern "C" fn if(APDO_TYPE_EPR_AVS: pdo_apdo_type(pdo) ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(APDO_TYPE_SPR_AVS: pdo_apdo_type(pdo) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn tcpm_debug_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_debugfs_init(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_debugfs_exit(port: *mut tcpm_port) {
    ...
    port.logbuffer[i] = core::ptr::null_mut();
    }
    mutex_unlock(&port.logbuffer_lock);
...
#[no_mangle]
unsafe extern "C" fn tcpm_set_cc(port: *mut tcpm_port, cc: enum typec_cc_status) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_enable_auto_vbus_discharge(port: *mut tcpm_port, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_apply_rc(port: *mut tcpm_port) {
...
//
#[no_mangle]
unsafe extern "C" fn tcpm_rp_cc(port: *mut tcpm_port) -> enum typec_cc_status {
    static enum typec_cc_status tcpm_rp_cc(struct tcpm_port *port)
    {
    const u32 *src_pdo = port.src_pdo;
    let mut nr_pdo: c_int = port.nr_src_pdo;
    int i;
...
//
    for (i = 0; i < nr_pdo; i++) {
    let mut pdo: u32 = src_pdo[i];
    if (pdo_type(pdo) == PDO_TYPE_FIXED &&
    pdo_fixed_voltage(pdo) == 5000) {
    let mut curr: c_uint = pdo_max_current(pdo);
    if (curr >= 3000)
    return TYPEC_CC_RP_3_0;
#[no_mangle]
pub unsafe extern "C" fn if(1500: curr >=) -> else {
    else if (curr >= 1500)
...
#[no_mangle]
unsafe extern "C" fn tcpm_ams_finish(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_set_vconn(port: *mut tcpm_port, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_get_current_limit(port: *mut tcpm_port) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tcpm_set_current_limit(port: *mut tcpm_port, max_ma: u32, mv: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_set_attached_state(port: *mut tcpm_port, attached: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_set_pwr_role(port: *mut tcpm_port, role: enum typec_role) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tcpm_forge_legacy_pdo(port: *mut tcpm_port, pdo: u32, role: enum typec_role) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_send_revision(port: *mut tcpm_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_send_source_caps(port: *mut tcpm_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_send_sink_caps(port: *mut tcpm_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_get_fixed_batt(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_send_sink_cap_ext(port: *mut tcpm_port) -> c_int {
    static int tcpm_pd_send_sink_cap_ext(struct tcpm_port *port)
    {
    let mut operating_snk_watt: u16 = port.operating_snk_mw / 1000;
    struct sink_caps_ext_data *data = &port.sink_caps_ext;
    struct pd_identifier *pd_ident = &port.pd_ident;
    let mut skedb: sink_caps_ext_msg = {0};
    struct pd_message msg;
    u8 data_obj_cnt;
...
#[no_mangle]
unsafe extern "C" fn tcpm_charge_to_energy(charge: c_int, voltage: c_int) -> u16 {
    static u16 tcpm_charge_to_energy(int charge, int voltage)
    {
    let mut energy: u64 = div_u64((u64)charge * voltage, 1000000);
// Battery telemetry is reported in increments of 0.1Wh
    return (u16)UW_TO_W(energy * 10);
    }
#[no_mangle]
unsafe extern "C" fn tcpm_pd_send_batt_status(port: *mut tcpm_port) -> c_int {
    static int tcpm_pd_send_batt_status(struct tcpm_port *port)
    {
    let mut present_charge: u16 = BATTERY_PROPERTY_UNKNOWN;
    let mut batt_present: bool = false, invalid_ref = true;
    let mut batt_id: u32 = port.batt_request_id;
    union power_supply_propval val;
    struct power_supply *batt;
    let mut charging_status: u8 = 0;
    struct pd_message msg;
    int ret, charge_now;
    u32 bsdo;
    tcpm_get_fixed_batt(port);
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_send_batt_cap(port: *mut tcpm_port) -> c_int {
    static int tcpm_pd_send_batt_cap(struct tcpm_port *port)
    {
    let mut design_cap: u16 = BATTERY_PROPERTY_UNKNOWN;
    let mut charge_cap: u16 = BATTERY_PROPERTY_UNKNOWN;
    let mut batt_id: u32 = port.batt_request_id;
    union power_supply_propval val;
    struct batt_cap_ext_msg bcdb;
    struct power_supply *batt;
    let mut invalid_ref: bool = true;
    struct pd_message msg;
    u8 data_obj_cnt;
    int ret, vol;
    tcpm_get_fixed_batt(port);
...
#[no_mangle]
unsafe extern "C" fn mod_tcpm_delayed_work(port: *mut tcpm_port, delay_ms: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mod_vdm_delayed_work(port: *mut tcpm_port, delay_ms: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mod_enable_frs_delayed_work(port: *mut tcpm_port, delay_ms: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mod_vdm_discovery_cancel_delayed_work(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn mod_vdm_discovery_delayed_work(port: *mut tcpm_port, delay_ms: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_vdm_ams(port: *mut tcpm_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcpm_ams_interruptible(port: *mut tcpm_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcpm_ams_start(port: *mut tcpm_port, ams: enum tcpm_ams) -> c_int {
    ...
    let mut cc_req: enum typec_cc_status = port.cc_req;
    port.ams = ams;
    if (ams == HARD_RESET) {
    tcpm_set_cc(port, tcpm_rp_cc(port));
    tcpm_pd_transmit(port, TCPC_TX_HARD_RESET, core::ptr::null_mut());
...
//
    ...
    {
    let mut vdo_hdr: u32 = port.vdo_data[0];
...
#[no_mangle]
unsafe extern "C" fn tcpm_queue_vdm_work(work: *mut kthread_work) {
...
#[no_mangle]
unsafe extern "C" fn svdm_consume_identity(port: *mut tcpm_port, p: *const u32, cnt: c_int) {
    static void svdm_consume_identity(struct tcpm_port *port, const u32 *p, int cnt)
    {
    let mut vdo: u32 = p[VDO_INDEX_IDH];
    let mut product: u32 = p[VDO_INDEX_PRODUCT];
...
#[no_mangle]
unsafe extern "C" fn svdm_consume_identity_sop_prime(port: *mut tcpm_port, p: *const u32, cnt: c_int) {
    static void svdm_consume_identity_sop_prime(struct tcpm_port *port, const u32 *p, int cnt)
    {
    let mut idh: u32 = p[VDO_INDEX_IDH];
    let mut product: u32 = p[VDO_INDEX_PRODUCT];
    int svdm_version;
...
#[no_mangle]
unsafe extern "C" fn tcpm_register_partner_altmodes(port: *mut tcpm_port) {
    ...
    altmode = core::ptr::null_mut();
    }
    port.partner_altmode[i] = altmode;
    }
    }
#[no_mangle]
unsafe extern "C" fn tcpm_register_plug_altmodes(port: *mut tcpm_port) {
...
//
#[no_mangle]
unsafe extern "C" fn tcpm_can_communicate_sop_prime(port: *mut tcpm_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcpm_attempt_vconn_swap_discovery(port: *mut tcpm_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcpm_cable_vdm_supported(port: *mut tcpm_port) -> bool {
    ...
    {
    let mut old_state: enum vdm_discovery_states = port.vdm_discovery_state;
    ...
    let mut svid: u16 = modep.svids[modep.svid_index];
...
// adev_action = ADEV_QUEUE_VDM;
    ...
    enum tcpm_transmit_type rx_sop_type)
    {
    let mut adev_action: enum adev_actions = ADEV_NONE;
    struct typec_altmode *adev;
    u32 p[PD_MAX_PAYLOAD];
    u32 response[8] = { };
    int i, rlen = 0;
    let mut response_tx_sop_type: enum tcpm_transmit_type = TCPC_TX_SOP;
    for (i = 0; i < cnt; i++)
...
//
    ...
    WARN_ON(typec_altmode_notify(adev, TYPEC_STATE_USB, core::ptr::null_mut()));
...
#[no_mangle]
unsafe extern "C" fn vdm_ready_timeout(vdm_hdr: u32) -> c_uint {
    static unsigned int vdm_ready_timeout(u32 vdm_hdr)
    {
    unsigned int timeout;
    let mut cmd: c_int = PD_VDO_CMD(vdm_hdr);
...
#[no_mangle]
unsafe extern "C" fn vdm_run_state_machine(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn vdm_state_machine_work(work: *mut kthread_work) {
...
// The vSafe5V Fixed Supply Object Shall always be the first object
    ...
    let mut type: enum pd_pdo_type = pdo_type(pdo[i]);
    switch (type) {
//
...
//
    ...
    unsigned int nr_pdo)
    {
    let mut err_index: enum pdo_err = tcpm_caps_err(port, pdo, nr_pdo);
...
#[no_mangle]
unsafe extern "C" fn tcpm_altmode_enter(altmode: *mut typec_altmode, vdo: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_altmode_exit(altmode: *mut typec_altmode) -> c_int {
    ...
    header |= VDO_OPOS(altmode.mode);
    return tcpm_queue_vdm_unlocked(port, header, core::ptr::null_mut(), 0, TCPC_TX_SOP);
    }
...
#[no_mangle]
unsafe extern "C" fn tcpm_cable_altmode_exit(altmode: *mut typec_altmode, sop: enum typec_plug_index) -> c_int {
    ...
    header = VDO(altmode.svid, 1, svdm_version, CMD_EXIT_MODE);
    header |= VDO_OPOS(altmode.mode);
    return tcpm_queue_vdm_unlocked(port, header, core::ptr::null_mut(), 0, TCPC_TX_SOP_PRIME);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn ready_state(port: *mut tcpm_port) -> enum tcpm_state {
    ...
    int cnt)
    {
    let mut p0: u32 = le32_to_cpu(payload[0]);
    let mut type: c_uint = usb_pd_ado_type(p0);
    if (!type) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_register_source_caps(port: *mut tcpm_port) -> c_int {
    static int tcpm_register_source_caps(struct tcpm_port *port)
    {
    let mut desc: usb_power_delivery_desc = { port.negotiated_rev };
    let mut caps: usb_power_delivery_capabilities_desc = { };
    struct usb_power_delivery_capabilities *cap = port.partner_source_caps;
    if (!port.partner_pd)
    port.partner_pd = usb_power_delivery_register(core::ptr::null_mut(), &desc);
    ...
    port.partner_source_caps = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn tcpm_register_sink_caps(port: *mut tcpm_port) -> c_int {
    ...
    enum tcpm_transmit_type rx_sop_type)
    {
    let mut type: enum pd_data_msg_type = pd_header_type_le(msg.header);
    let mut cnt: c_uint = pd_header_cnt_le(msg.header);
    let mut rev: c_uint = pd_header_rev_le(msg.header);
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn tcpm_aug_supply_req_complete(port: *mut tcpm_port, result: c_int) {
    ...
    enum tcpm_transmit_type rx_sop_type)
    {
    let mut type: enum pd_ctrl_msg_type = pd_header_type_le(msg.header);
...
// This is an unsupported message if port type is SRC
    ...
    const struct pd_message *msg)
    {
    let mut type: enum pd_ext_msg_type = pd_header_type_le(msg.header);
    let mut data_size: c_uint = pd_ext_header_data_size_le(msg.ext_msg.header);
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_rx_handler(work: *mut kthread_work) {
    ...
    let mut cnt: c_uint = pd_header_cnt_le(msg.header);
    struct tcpm_port *port = event.port;
    let mut rx_sop_type: enum tcpm_transmit_type = event.rx_sop_type;
    mutex_lock(&port.lock);
    tcpm_log(port, "PD RX, header: %#x [%d]", le16_to_cpu(msg.header),
    port.attached);
    if (port.attached) {
    let mut type: enum pd_ctrl_msg_type = pd_header_type_le(msg.header);
    let mut msgid: c_uint = pd_header_msgid_le(msg.header);
//
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cnt) -> else {
    else if (cnt)
...
//
#[no_mangle]
unsafe extern "C" fn tcpm_send_queued_message(port: *mut tcpm_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_check_request(port: *mut tcpm_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: port->pps_data.supported) -> else {
    else if (port.pps_data.supported)
    port.usb_type = POWER_SUPPLY_USB_TYPE_PD_PPS;
#[no_mangle]
pub unsafe extern "C" fn if(SPR_AVS_SUPPORTED: port->spr_avs_data.port_partner_src_status ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_select_pps_apdo(port: *mut tcpm_port) -> c_uint {
    static unsigned int tcpm_pd_select_pps_apdo(struct tcpm_port *port)
    {
    unsigned int i, src_ma, max_temp_mw = 0, max_op_ma, op_mw;
    let mut src_pdo: c_uint = 0;
    u32 pdo, src;
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_select_spr_avs_apdo(port: *mut tcpm_port) -> c_int {
    ...
    let mut snk_max_curr_ma: u32 = 0, src_pdo_index, snk_pdo_index, snk_pdo;
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_build_request(port: *mut tcpm_port, rdo: *mut u32) -> c_int {
    ...
    let mut src_pdo_index: c_int = 0;
    let mut snk_pdo_index: c_int = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_send_request(port: *mut tcpm_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_build_pps_request(port: *mut tcpm_port, rdo: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_build_spr_avs_request(port: *mut tcpm_port, rdo: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_set_vbus(port: *mut tcpm_port, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_set_charge(port: *mut tcpm_port, charge: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_start_toggling(port: *mut tcpm_port, cc: enum typec_cc_status) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcpm_init_vbus(port: *mut tcpm_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_init_vconn(port: *mut tcpm_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_typec_connect(port: *mut tcpm_port) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tcpm_port_is_audio(port)) -> else {
...
#[no_mangle]
unsafe extern "C" fn tcpm_src_attach(port: *mut tcpm_port) -> c_int {
...
//
    ...
    port.partner = core::ptr::null_mut();
    port.attached = true;
...
#[no_mangle]
unsafe extern "C" fn tcpm_typec_disconnect(port: *mut tcpm_port) {
...
//
    ...
    port.plug_prime = core::ptr::null_mut();
    port.cable = core::ptr::null_mut();
    if (port.connected) {
    if (port.partner) {
    typec_partner_set_usb_power_delivery(port.partner, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn tcpm_unregister_altmodes(port: *mut tcpm_port) {
    ...
    port.partner_altmode[i] = core::ptr::null_mut();
    }
    for (i = 0; i < modep_prime.altmodes && i < ALTMODE_DISCOVERY_MAX; i++) {
    typec_unregister_altmode(port.plug_prime_altmode[i]);
    port.plug_prime_altmode[i] = core::ptr::null_mut();
    }
    memset(modep, 0, sizeof(*modep));
    memset(modep_prime, 0, sizeof(*modep_prime));
    }
#[no_mangle]
unsafe extern "C" fn tcpm_set_partner_usb_comm_capable(port: *mut tcpm_port, capable: bool) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_partner_source_caps_reset(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_reset_port(port: *mut tcpm_port) {
...
//
    ...
    port.partner_sink_caps = core::ptr::null_mut();
    tcpm_partner_source_caps_reset(port);
    usb_power_delivery_unregister(port.partner_pd);
    port.partner_pd = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn tcpm_detach(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_src_detach(port: *mut tcpm_port) {
    static void tcpm_src_detach(struct tcpm_port *port)
    {
    tcpm_detach(port);
    }
#[no_mangle]
unsafe extern "C" fn tcpm_snk_attach(port: *mut tcpm_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_snk_detach(port: *mut tcpm_port) {
    static void tcpm_snk_detach(struct tcpm_port *port)
    {
    tcpm_detach(port);
    }
#[no_mangle]
unsafe extern "C" fn tcpm_acc_attach(port: *mut tcpm_port) -> c_int {
    static int tcpm_acc_attach(struct tcpm_port *port)
    {
    int ret;
    enum typec_role role;
    enum typec_data_role data;
    let mut state: c_int = TYPEC_STATE_USB;
    if (port.attached)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn tcpm_acc_detach(port: *mut tcpm_port) {
    static void tcpm_acc_detach(struct tcpm_port *port)
    {
    tcpm_detach(port);
    }
#[no_mangle]
pub unsafe extern "C" fn hard_reset_state(port: *mut tcpm_port) -> enum tcpm_state {
...
#[no_mangle]
pub unsafe extern "C" fn unattached_state(port: *mut tcpm_port) -> enum tcpm_state {
...
#[no_mangle]
unsafe extern "C" fn tcpm_swap_complete(port: *mut tcpm_port, result: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_get_pwr_opmode(cc: enum typec_cc_status) -> enum typec_pwr_opmode {
...
#[no_mangle]
unsafe extern "C" fn tcpm_pwr_opmode_to_rp(opmode: enum typec_pwr_opmode) -> enum typec_cc_status {
...
#[no_mangle]
unsafe extern "C" fn tcpm_set_initial_svdm_version(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_set_initial_negotiated_rev(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn run_state_machine(port: *mut tcpm_port) {
...
pub unsafe extern "C" fn if(_arg: tcpm_port_is_audio(port)) -> else {
    ...
    port.timings.cc_debounce_time);
#[no_mangle]
pub unsafe extern "C" fn if(port->vbus_vsafe0v: tcpm_port_is_source(port) &&) -> else {
...
pub unsafe extern "C" fn if(_arg: tcpm_port_is_audio(port)) -> else {
    ...
    port.timings.cc_debounce_time);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tcpm_port_is_disconnected(port)) -> else {
    ...
    PD_T_PD_DEBOUNCE);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tcpm_port_is_debug_sink(port)) -> else {
...
pub unsafe extern "C" fn if(_arg: tcpm_port_is_audio(port)) -> else {
    ...
    PD_T_CC_DEBOUNCE);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: port->vbus_present) -> else {
...
// SRC -> SNK POWER/FAST_ROLE_SWAP finished
    ...
    case SNK_DISCOVERY:
    if (port.vbus_present) {
    let mut current_lim: u32 = tcpm_get_current_limit(port);
...
//
    ...
    tcpm_pd_transmit(port, TCPC_TX_BIST_MODE_2, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn tcpm_state_machine_work(work: *mut kthread_work) {
...
#[no_mangle]
pub unsafe extern "C" fn if(tcpm_port_is_sink(port): tcpm_port_is_debug_sink(port) ||) -> else {
...
pub unsafe extern "C" fn if(_arg: tcpm_port_is_debug_sink(port)) -> else {
    ...
    tcpm_set_state(port, SRC_UNATTACHED, 0);
#[no_mangle]
pub unsafe extern "C" fn if(old_cc2: cc1 != old_cc1 || cc2 !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn _tcpm_pd_vbus_on(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn _tcpm_pd_vbus_off(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn _tcpm_pd_vbus_vsafe0v(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn _tcpm_pd_hard_reset(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_event_handler(work: *mut kthread_work) {
...
#[no_mangle]
pub unsafe extern "C" fn tcpm_cc_change(port: *mut tcpm_port) {
...
#[no_mangle]
pub unsafe extern "C" fn tcpm_vbus_change(port: *mut tcpm_port) {
...
#[no_mangle]
pub unsafe extern "C" fn tcpm_pd_hard_reset(port: *mut tcpm_port) {
...
#[no_mangle]
pub unsafe extern "C" fn tcpm_sink_frs(port: *mut tcpm_port) {
...
#[no_mangle]
pub unsafe extern "C" fn tcpm_sourcing_vbus(port: *mut tcpm_port) {
...
#[no_mangle]
pub unsafe extern "C" fn tcpm_port_clean(port: *mut tcpm_port) {
...
#[no_mangle]
pub unsafe extern "C" fn tcpm_port_is_toggling(port: *mut tcpm_port) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn tcpm_port_error_recovery(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_enable_frs_work(work: *mut kthread_work) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_vdm_discovery_work(work: *mut kthread_work) {
    ...
    let mut tx_sop_type: enum tcpm_transmit_type = TCPC_TX_SOP;
    struct typec_port *typec = port.typec_port;
    struct pd_mode_data *modep, *modep_prime;
    u32 msg[2] = { };
    int svdm_version;
...
#[no_mangle]
unsafe extern "C" fn tcpm_dr_set(p: *mut typec_port, data: enum typec_data_role) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_pr_set(p: *mut typec_port, role: enum typec_role) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_vconn_set(p: *mut typec_port, role: enum typec_role) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_try_role(p: *mut typec_port, role: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_aug_set_op_curr(port: *mut tcpm_port, req_op_curr_ma: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_aug_set_out_volt(port: *mut tcpm_port, req_out_volt_mv: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_pps_activate(port: *mut tcpm_port, activate: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_spr_avs_activate(port: *mut tcpm_port, activate: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_init(port: *mut tcpm_port) {
...
//
    ...
    port.vbus_vsafe0v = false;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !port->tcpc->is_vbus_vsafe0v) -> else {
...
#[no_mangle]
unsafe extern "C" fn tcpm_port_type_set(p: *mut typec_port, type: enum typec_port_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_pd_set(p: *mut typec_port, pd: *mut usb_power_delivery) -> c_int {
...
//
    ...
    typec_port_set_usb_power_delivery(p, core::ptr::null_mut());
    port.selected_pd = pd;
...
#[no_mangle]
pub unsafe extern "C" fn tcpm_tcpc_reset(port: *mut tcpm_port) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_port_unregister_pd(port: *mut tcpm_port) {
    static void tcpm_port_unregister_pd(struct tcpm_port *port)
    {
    int i;
    port.port_sink_caps = core::ptr::null_mut();
    port.port_source_caps = core::ptr::null_mut();
    for (i = 0; i < port.pd_count; i++) {
    usb_power_delivery_unregister_capabilities(port.pd_list[i].sink_cap);
    usb_power_delivery_unregister_capabilities(port.pd_list[i].source_cap);
    devm_kfree(port.dev, port.pd_list[i]);
    port.pd_list[i] = core::ptr::null_mut();
    usb_power_delivery_unregister(port.pds[i]);
    port.pds[i] = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn tcpm_port_register_pd(port: *mut tcpm_port) -> c_int {
    static int tcpm_port_register_pd(struct tcpm_port *port)
    {
    let mut pd_revision: u16 = port.typec_caps.pd_revision;
    let mut pd_version: u16 = port.pd_rev.ver_major << 8 | port.pd_rev.ver_minor;
    let mut desc: usb_power_delivery_desc = { pd_revision, pd_version };
    struct usb_power_delivery_capabilities *cap;
    int ret, i;
...
#[no_mangle]
unsafe extern "C" fn tcpm_fw_get_timings(port: *mut tcpm_port, fwnode: *mut fwnode_handle) {
...
#[no_mangle]
unsafe extern "C" fn tcpm_fw_get_pd_ident(port: *mut tcpm_port) {
...
// First 3 vdo values contain info regarding USB PID, VID & XID
    ...
    vdo = port.snk_vdo;
#[no_mangle]
pub unsafe extern "C" fn if(3: port->nr_snk_vdo_v1 >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn tcpm_parse_snk_pdos(port: *mut tcpm_port) {
    ...
    ++pdo_itr) {
    let mut pdo: u32 = snk_pdos[pdo_itr];
    let mut curr_snk_pdp: u8 = 0;
    switch (pdo_type(pdo)) {
    case PDO_TYPE_FIXED:
...
#[no_mangle]
unsafe extern "C" fn tcpm_fw_get_caps(port: *mut tcpm_port, fwnode: *mut fwnode_handle) -> c_int {
    static int tcpm_fw_get_caps(struct tcpm_port *port, struct fwnode_handle *fwnode)
    {
    struct fwnode_handle *capabilities, *caps = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tcpm_fw_get_snk_vdos(port: *mut tcpm_port, fwnode: *mut fwnode_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_fw_get_pd_revision(port: *mut tcpm_port, fwnode: *mut fwnode_handle) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: port->spr_avs_data.active) -> else {
    else if (port.spr_avs_data.active)
...
#[no_mangle]
unsafe extern "C" fn tcpm_disable_pps_avs(port: *mut tcpm_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_tcpm_psy_register(port: *mut tcpm_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn state_machine_timer_handler(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn vdm_state_machine_timer_handler(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn enable_frs_timer_handler(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn vdm_discovery_timer_handler(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
pub unsafe extern "C" fn tcpm_unregister_port(port: *mut tcpm_port) {
