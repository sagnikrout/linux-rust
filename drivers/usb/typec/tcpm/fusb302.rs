...
//! Source: drivers/usb/typec/tcpm/fusb302.c
#![no_std]
...
//
pub const T_BC_LVL_DEBOUNCE_DELAY_MS: c_int = 30;
    enum toggling_mode {
    TOGGLING_MODE_OFF,
    TOGGLING_MODE_DRP,
    TOGGLING_MODE_SNK,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fusb302_chip {
    pub dev: *mut device,
    pub i2c_client: *mut i2c_client,
    pub tcpm_port: *mut tcpm_port,
    pub tcpc_dev: tcpc_dev,
    pub vbus: *mut regulator,
    pub irq_lock: spinlock_t,
    pub irq_work: work_struct,
    pub irq_suspended: bool,
    pub irq_while_suspended: bool,
    pub gpio_int_n: *mut gpio_desc,
    pub gpio_int_n_irq: c_int,
    pub extcon: *mut extcon_dev,
    pub wq: *mut workqueue_struct,
    pub bc_lvl_handler: delayed_work,
// lock for sharing chip states
    pub lock: mutex,
// chip status
    pub toggling_mode: enum toggling_mode,
    pub src_current_status: enum src_current_status,
    pub intr_togdone: bool,
    pub intr_bc_lvl: bool,
    pub intr_comp_chng: bool,
// port status
    pub vconn_on: bool,
    pub vbus_on: bool,
    pub charge_on: bool,
...
#[no_mangle]
unsafe extern "C" fn fusb302_log_full(chip: *mut fusb302_chip) -> bool {
    ...
    __printf(2, 3)
#[no_mangle]
unsafe extern "C" fn fusb302_log(chip: *mut fusb302_chip, fmt: *const c_char, ...) {
...
#[no_mangle]
unsafe extern "C" fn fusb302_debug_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fusb302_debugfs_init(chip: *mut fusb302_chip) {
...
#[no_mangle]
unsafe extern "C" fn fusb302_debugfs_exit(chip: *mut fusb302_chip) {
...
#[no_mangle]
unsafe extern "C" fn fusb302_sw_reset(chip: *mut fusb302_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fusb302_enable_tx_auto_retries(chip: *mut fusb302_chip, retry_count: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fusb302_init_interrupt(chip: *mut fusb302_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fusb302_set_power_mode(chip: *mut fusb302_chip, power_mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_init(dev: *mut tcpc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_get_vbus(dev: *mut tcpc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_get_current_limit(dev: *mut tcpc_dev) -> c_int {
    static int tcpm_get_current_limit(struct tcpc_dev *dev)
    {
    struct fusb302_chip *chip = container_of(dev, struct fusb302_chip,
    tcpc_dev);
    let mut current_limit: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn tcpm_set_cc(dev: *mut tcpc_dev, cc: enum typec_cc_status) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpm_set_vconn(dev: *mut tcpc_dev, on: bool) -> c_int {
    static int tcpm_set_vconn(struct tcpc_dev *dev, bool on)
    {
    struct fusb302_chip *chip = container_of(dev, struct fusb302_chip,
    tcpc_dev);
    let mut ret: c_int = 0;
    let mut switches0_data: u8 = 0x00;
...
#[no_mangle]
unsafe extern "C" fn tcpm_set_vbus(dev: *mut tcpc_dev, on: bool, charge: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fusb302_pd_tx_flush(chip: *mut fusb302_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fusb302_pd_rx_flush(chip: *mut fusb302_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fusb302_pd_set_auto_goodcrc(chip: *mut fusb302_chip, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fusb302_pd_set_interrupts(chip: *mut fusb302_chip, on: bool) -> c_int {
    static int fusb302_pd_set_interrupts(struct fusb302_chip *chip, bool on)
    {
    let mut ret: c_int = 0;
    let mut mask_interrupts: u8 = FUSB_REG_MASK_COLLISION;
    u8 maska_interrupts = FUSB_REG_MASKA_RETRYFAIL |
    FUSB_REG_MASKA_HARDSENT |
    FUSB_REG_MASKA_TX_SUCCESS |
    FUSB_REG_MASKA_HARDRESET;
    let mut maskb_interrupts: u8 = FUSB_REG_MASKB_GCRCSENT;
    ret = on ?
...
#[no_mangle]
unsafe extern "C" fn tcpm_set_pd_rx(dev: *mut tcpc_dev, on: bool) -> c_int {
    ...
    let mut switches1_data: u8 = 0x00;
    mutex_lock(&chip.lock);
    if (pwr == TYPEC_SOURCE)
    ...
    struct fusb302_chip *chip = container_of(dev, struct fusb302_chip,
    tcpc_dev);
    let mut mode: enum toggling_mode = TOGGLING_MODE_OFF;
    let mut ret: c_int = 0;
    switch (port_type) {
    case TYPEC_PORT_SRC:
...
#[no_mangle]
unsafe extern "C" fn fusb302_pd_send_hardreset(chip: *mut fusb302_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fusb302_bc_lvl_to_cc(bc_lvl: u8) -> enum typec_cc_status {
...
#[no_mangle]
unsafe extern "C" fn fusb302_bc_lvl_handler_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn init_tcpc_dev(fusb302_tcpc_dev: *mut tcpc_dev) {
...
// On error returns < 0, otherwise a typec_cc_status value
    ...
    enum typec_cc_status *cc)
    {
    let mut ra_mda: u8 = ra_mda_value[chip.src_current_status];
    let mut rd_mda: u8 = rd_mda_value[chip.src_current_status];
...
//
    let mut ret: c_int = 0;
    let mut rd_mda: u8 = rd_mda_value[chip.src_current_status];
    let mut toggling_mode: enum toggling_mode = chip.toggling_mode;
    enum typec_cc_polarity cc_polarity;
...
#[no_mangle]
unsafe extern "C" fn fusb302_handle_togdone(chip: *mut fusb302_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fusb302_pd_reset(chip: *mut fusb302_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fusb302_irq_intn(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fusb302_irq_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn init_gpio(chip: *mut fusb302_chip) -> c_int {
    ...
    if (!fwnode)
    fwnode = fwnode_create_software_node(port_props, core::ptr::null_mut());
    return fwnode;
    }
#[no_mangle]
unsafe extern "C" fn fusb302_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    ret = request_threaded_irq(chip.gpio_int_n_irq, core::ptr::null_mut(), fusb302_irq_intn,
...
#[no_mangle]
unsafe extern "C" fn fusb302_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn fusb302_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fusb302_pm_resume(dev: *mut device) -> c_int {
