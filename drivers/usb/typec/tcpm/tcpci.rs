...
//! Source: drivers/usb/typec/tcpm/tcpci.c
#![no_std]
...
pub const PD_RETRY_COUNT_DEFAULT: c_int = 3;
pub const PD_RETRY_COUNT_3_0_OR_HIGHER: c_int = 2;
pub const AUTO_DISCHARGE_DEFAULT_THRESHOLD_MV: c_int = 3500;
pub const VSINKPD_MIN_IR_DROP_MV: c_int = 750;
pub const VSRC_NEW_MIN_PERCENT: c_int = 95;
pub const VSRC_VALID_MIN_MV: c_int = 500;
pub const VPPS_NEW_MIN_PERCENT: c_int = 95;
pub const VPPS_VALID_MIN_MV: c_int = 100;
pub const VSINKDISCONNECT_PD_MIN_PERCENT: c_int = 90;
pub const VPPS_SHUTDOWN_MIN_PERCENT: c_int = 85;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tcpci {
    pub dev: *mut device,
    ...
    pub alert_mask: c_uint,
    pub rx_type_mask: c_uint,
    pub controls_vbus: bool,
    pub tcpc: tcpc_dev,
    pub data: *mut tcpci_data,
    pub orientation_gpio: *mut gpio_desc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tcpci_chip {
    pub tcpci: *mut tcpci,
    pub data: tcpci_data,
}
...
#[no_mangle]
unsafe extern "C" fn tcpci_read16(tcpci: *mut tcpci, reg: c_uint, val: *mut u16) -> c_int {
    static int tcpci_read16(struct tcpci *tcpci, unsigned int reg, u16 *val)
    {
    return regmap_raw_read(tcpci.regmap, reg, val, sizeof(u16));
    }
#[no_mangle]
unsafe extern "C" fn tcpci_write16(tcpci: *mut tcpci, reg: c_uint, val: u16) -> c_int {
    static int tcpci_write16(struct tcpci *tcpci, unsigned int reg, u16 val)
    {
    return regmap_raw_write(tcpci.regmap, reg, &val, sizeof(u16));
    }
#[no_mangle]
unsafe extern "C" fn tcpci_check_std_output_cap(regmap: *mut regmap, mask: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpci_set_cc(tcpc: *mut tcpc_dev, cc: enum typec_cc_status) -> c_int {
    static int tcpci_set_cc(struct tcpc_dev *tcpc, enum typec_cc_status cc)
    {
    struct tcpci *tcpci = tcpc_to_tcpci(tcpc);
    bool vconn_pres;
    let mut polarity: enum typec_cc_polarity = TYPEC_POLARITY_CC1;
    unsigned int reg;
    int ret;
...
//
    ...
    int ret;
    struct tcpci *tcpci = tcpc_to_tcpci(tcpc);
    let mut reg: c_uint = TCPC_ROLE_CTRL_DRP;
...
#[no_mangle]
pub unsafe extern "C" fn if(TYPEC_CC_RP_DEF: cc2 >=) -> else {
...
// Role control would have the Rp setting when DRP was enabled
    reg |= FIELD_PREP(TCPC_ROLE_CTRL_CC1, TCPC_ROLE_CTRL_CC_RP);
#[no_mangle]
pub unsafe extern "C" fn if(TYPEC_CC_RP_DEF: cc1 >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn tcpci_set_partner_usb_comm_capable(tcpc: *mut tcpc_dev, capable: bool) {
...
#[no_mangle]
unsafe extern "C" fn tcpci_set_vconn(tcpc: *mut tcpc_dev, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpci_enable_auto_vbus_discharge(dev: *mut tcpc_dev, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpci_enable_frs(dev: *mut tcpc_dev, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpci_frs_sourcing_vbus(dev: *mut tcpc_dev) {
...
#[no_mangle]
unsafe extern "C" fn tcpci_check_contaminant(dev: *mut tcpc_dev) {
...
#[no_mangle]
unsafe extern "C" fn tcpci_set_bist_data(tcpc: *mut tcpc_dev, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpci_set_pd_rx(tcpc: *mut tcpc_dev, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpci_get_vbus(tcpc: *mut tcpc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpci_is_vbus_vsafe0v(tcpc: *mut tcpc_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcpci_set_vbus(tcpc: *mut tcpc_dev, source: bool, sink: bool) -> c_int {
...
// Disable both source and sink first before enabling anything
    ...
    {
    struct tcpci *tcpci = tcpc_to_tcpci(tcpc);
    let mut header: u16 = msg ? le16_to_cpu(msg.header) : 0;
...
#[no_mangle]
unsafe extern "C" fn tcpci_cable_comm_capable(tcpc: *mut tcpc_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcpci_attempt_vconn_swap_discovery(tcpc: *mut tcpc_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcpci_init(tcpc: *mut tcpc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tcpci_irq(tcpci: *mut tcpci) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(TCPC_ALERT_TX_DISCARDED: status &) -> else {
    else if (status & TCPC_ALERT_TX_DISCARDED)
    tcpm_pd_transmit_complete(tcpci.port, TCPC_TX_DISCARDED);
#[no_mangle]
pub unsafe extern "C" fn if(TCPC_ALERT_TX_FAILED: status &) -> else {
...
#[no_mangle]
unsafe extern "C" fn _tcpci_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tcpci_parse_config(tcpci: *mut tcpci) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tcpci_unregister_port(tcpci: *mut tcpci) {
...
#[no_mangle]
unsafe extern "C" fn tcpci_probe(client: *mut i2c_client) -> c_int {
    static int tcpci_probe(struct i2c_client *client)
    {
    struct tcpci_chip *chip;
    struct gpio_desc *orient_gpio = core::ptr::null_mut();
    int err;
    let mut val: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn tcpci_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn tcpci_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcpci_resume(dev: *mut device) -> c_int {
