...
//! Source: drivers/usb/typec/mux/pi3usb30532.c
#![no_std]
...
pub const PI3USB30532_CONF: c_uint = 0x00;
pub const PI3USB30532_CONF_OPEN: c_uint = 0x00;
pub const PI3USB30532_CONF_SWAP: c_uint = 0x01;
pub const PI3USB30532_CONF_4LANE_DP: c_uint = 0x02;
pub const PI3USB30532_CONF_USB3: c_uint = 0x04;
pub const PI3USB30532_CONF_USB3_AND_2LANE_DP: c_uint = 0x06;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pi3usb30532 {
    pub client: *mut i2c_client,
    pub /: *mut *mut mutex lock; / protects the cached conf register,
...
#[no_mangle]
unsafe extern "C" fn pi3usb30532_set_conf(pi: *mut pi3usb30532, new_conf: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pi3usb30532_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pi3usb30532_remove(client: *mut i2c_client) {
