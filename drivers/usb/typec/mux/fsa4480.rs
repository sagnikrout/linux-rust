...
//! Source: drivers/usb/typec/mux/fsa4480.c
#![no_std]
...
pub const FSA4480_DEVICE_ID: c_uint = 0x00;

pub const FSA4480_SWITCH_ENABLE: c_uint = 0x04;
pub const FSA4480_SWITCH_SELECT: c_uint = 0x05;
pub const FSA4480_SWITCH_STATUS1: c_uint = 0x07;
pub const FSA4480_SLOW_L: c_uint = 0x08;
pub const FSA4480_SLOW_R: c_uint = 0x09;
pub const FSA4480_SLOW_MIC: c_uint = 0x0a;
pub const FSA4480_SLOW_SENSE: c_uint = 0x0b;
pub const FSA4480_SLOW_GND: c_uint = 0x0c;
pub const FSA4480_DELAY_L_R: c_uint = 0x0d;
pub const FSA4480_DELAY_L_MIC: c_uint = 0x0e;
pub const FSA4480_DELAY_L_SENSE: c_uint = 0x0f;
pub const FSA4480_DELAY_L_AGND: c_uint = 0x10;
pub const FSA4480_FUNCTION_ENABLE: c_uint = 0x12;
pub const FSA4480_RESET: c_uint = 0x1e;
pub const FSA4480_MAX_REGISTER: c_uint = 0x1f;
...
#[no_mangle]
unsafe extern "C" fn fsa4480_set(fsa: *mut fsa4480) -> c_int {
    static int fsa4480_set(struct fsa4480 *fsa)
    {
    let mut reverse: bool = (fsa.orientation == TYPEC_ORIENTATION_REVERSE);
    let mut enable: u8 = FSA4480_ENABLE_DEVICE;
    let mut sel: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn fsa4480_mux_set(mux: *mut typec_mux_dev, state: *mut typec_mux_state) -> c_int {
...
pub const DATA_LANES_COUNT: c_int = 2;
    static const int supported_data_lane_mapping[][DATA_LANES_COUNT] = {
    [NORMAL_LANE_MAPPING] = { 0, 1 },
    [INVERT_LANE_MAPPING] = { 1, 0 },
    };
#[no_mangle]
unsafe extern "C" fn fsa4480_parse_data_lanes_mapping(fsa: *mut fsa4480) -> c_int {
    static int fsa4480_parse_data_lanes_mapping(struct fsa4480 *fsa)
    {
    struct fwnode_handle *ep;
    u32 data_lanes[DATA_LANES_COUNT];
    int ret, i, j;
    ep = fwnode_graph_get_next_endpoint(dev_fwnode(&fsa.client.dev), core::ptr::null_mut());
    if (!ep)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn fsa4480_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsa4480_remove(client: *mut i2c_client) {
