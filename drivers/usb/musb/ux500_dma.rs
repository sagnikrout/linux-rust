...
//! Source: drivers/usb/musb/ux500_dma.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ux500_dma_channel {
    pub channel: dma_channel,
    pub controller: *mut ux500_dma_controller,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ux500_dma_controller {
    pub controller: dma_controller,
    pub rx_channel: [ux500_dma_channel; UX500_MUSB_DMA_NUM_RX_TX_CHANNELS],
    pub tx_channel: [ux500_dma_channel; UX500_MUSB_DMA_NUM_RX_TX_CHANNELS],
    pub private_data: *mut c_void,
    pub phy_base: dma_addr_t,
}

// Work function invoked from DMA callback to handle rx transfers.
#[no_mangle]
unsafe extern "C" fn ux500_dma_callback(private_data: *mut c_void) {
    ...
    struct ux500_dma_channel *ux500_channel = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ux500_dma_channel_release(channel: *mut dma_channel) {
...
#[no_mangle]
unsafe extern "C" fn ux500_dma_channel_abort(channel: *mut dma_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ux500_dma_controller_stop(controller: *mut ux500_dma_controller) {
...
#[no_mangle]
unsafe extern "C" fn ux500_dma_controller_start(controller: *mut ux500_dma_controller) -> c_int {
    ...
    struct dma_channel *dma_channel = core::ptr::null_mut();
    char **chan_names;
    u32 ch_num;
    u8 dir;
    let mut is_tx: u8 = 0;
...
// Prepare the loop for RX channels
    ...
    param_array = data ? data.dma_rx_param_array : core::ptr::null_mut();
...
// Prepare the loop for TX channels
    ...
    param_array = data ? data.dma_tx_param_array : core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ux500_dma_controller_destroy(c: *mut dma_controller) {
