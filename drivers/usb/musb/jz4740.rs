...
//! Source: drivers/usb/musb/jz4740.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn jz4740_musb_interrupt(irq: c_int, __hci: *mut c_void) -> irqreturn_t {
    static irqreturn_t jz4740_musb_interrupt(int irq, void *__hci)
    {
    unsigned long	flags;
    let mut retval: irqreturn_t = IRQ_NONE, retval_dma = IRQ_NONE;
...
#[no_mangle]
unsafe extern "C" fn jz4740_musb_init(musb: *mut musb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jz4740_musb_exit(musb: *mut musb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jz4740_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jz4740_remove(pdev: *mut platform_device) {
