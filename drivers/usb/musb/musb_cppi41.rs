...
//! Source: drivers/usb/musb/musb_cppi41.c
#![no_std]
...
pub const EP_MODE_AUTOREQ_NONE: c_int = 0;
pub const EP_MODE_AUTOREQ_ALL_NEOP: c_int = 1;
pub const EP_MODE_AUTOREQ_ALWAYS: c_int = 3;
pub const EP_MODE_DMA_TRANSPARENT: c_int = 0;
pub const EP_MODE_DMA_RNDIS: c_int = 1;
pub const EP_MODE_DMA_GEN_RNDIS: c_int = 3;
pub const USB_CTRL_TX_MODE: c_uint = 0x70;
pub const USB_CTRL_RX_MODE: c_uint = 0x74;
pub const USB_CTRL_AUTOREQ: c_uint = 0xd0;
pub const USB_TDOWN: c_uint = 0xd8;
pub const MUSB_DMA_NUM_CHANNELS: c_int = 15;
pub const DA8XX_USB_MODE: c_uint = 0x10;
pub const DA8XX_USB_AUTOREQ: c_uint = 0x14;
pub const DA8XX_USB_TEARDOWN: c_uint = 0x1c;
pub const DA8XX_DMA_NUM_CHANNELS: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cppi41_dma_controller {
    pub controller: dma_controller,
    pub rx_channel: *mut cppi41_dma_channel,
    pub tx_channel: *mut cppi41_dma_channel,
    pub early_tx: hrtimer,
    pub early_tx_list: list_head,
    pub rx_mode: u32,
    pub tx_mode: u32,
    pub auto_req: u32,
    pub tdown_reg: u32,
...
#[no_mangle]
unsafe extern "C" fn save_rx_toggle(cppi41_channel: *mut cppi41_dma_channel) {
...
#[no_mangle]
unsafe extern "C" fn update_rx_toggle(cppi41_channel: *mut cppi41_dma_channel) {
...
#[no_mangle]
unsafe extern "C" fn musb_is_tx_fifo_empty(hw_ep: *mut musb_hw_ep) -> bool {
    static bool musb_is_tx_fifo_empty(struct musb_hw_ep *hw_ep)
    {
    let mut epnum: u8 = hw_ep.epnum;
    struct musb	*musb = hw_ep.musb;
...
#[no_mangle]
unsafe extern "C" fn cppi41_trans_done(cppi41_channel: *mut cppi41_dma_channel) {
...
#[no_mangle]
unsafe extern "C" fn cppi41_recheck_tx_req(timer: *mut hrtimer) -> enum hrtimer_restart {
...
//
    ...
    let mut usecs: c_ulong = cppi41_channel.total_len / 10;
...
#[no_mangle]
unsafe extern "C" fn update_ep_mode(ep: unsigned, mode: unsigned, old: u32) -> u32 {
    ...
    let mut use_gen_rndis: unsigned = 0;
...
// fallback mode
    ...
    struct cppi41_dma_controller, controller);
    struct cppi41_dma_channel *cppi41_channel = core::ptr::null_mut();
    let mut ch_num: u8 = hw_ep.epnum - 1;
...
#[no_mangle]
unsafe extern "C" fn cppi41_dma_channel_release(channel: *mut dma_channel) {
...
#[no_mangle]
unsafe extern "C" fn cppi41_dma_channel_abort(channel: *mut dma_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cppi41_release_all_dma_chans(ctrl: *mut cppi41_dma_controller) {
...
#[no_mangle]
unsafe extern "C" fn cppi41_dma_controller_stop(controller: *mut cppi41_dma_controller) {
    static void cppi41_dma_controller_stop(struct cppi41_dma_controller *controller)
    {
    cppi41_release_all_dma_chans(controller);
    }
#[no_mangle]
unsafe extern "C" fn cppi41_dma_controller_start(controller: *mut cppi41_dma_controller) -> c_int {
    ...
    is_tx = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strstarts(str, _arg: "rx")) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn cppi41_dma_controller_destroy(c: *mut dma_controller) {
