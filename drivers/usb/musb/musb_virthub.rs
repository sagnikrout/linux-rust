...
//! Source: drivers/usb/musb/musb_virthub.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn musb_host_finish_resume(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn musb_port_suspend(musb: *mut musb, do_suspend: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn musb_port_reset(musb: *mut musb, do_reset: bool) {
...
//
    if (power &  MUSB_POWER_RESUME) {
    let mut remain: c_long = (unsigned long) musb.rh_timer - jiffies;
...
#[no_mangle]
pub unsafe extern "C" fn musb_root_disconnect(musb: *mut musb) {
...
#[no_mangle]
pub unsafe extern "C" fn musb_hub_status_data(hcd: *mut usb_hcd, buf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn musb_has_gadget(musb: *mut musb) -> c_int {
