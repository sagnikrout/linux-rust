...
//! Source: drivers/usb/musb/ux500.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ux500_musb_set_vbus(musb: *mut musb, is_on: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ux500_musb_interrupt(irq: c_int, __hci: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ux500_musb_init(musb: *mut musb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ux500_musb_exit(musb: *mut musb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ux500_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ux500_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ux500_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ux500_resume(dev: *mut device) -> c_int {
