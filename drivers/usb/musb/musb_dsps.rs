...
//! Source: drivers/usb/musb/musb_dsps.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dsps_musb_wrapper {
    pub revision: u16,
    pub control: u16,
    pub status: u16,
    pub epintr_set: u16,
    pub epintr_clear: u16,
    pub epintr_status: u16,
    pub coreintr_set: u16,
    pub coreintr_clear: u16,
    pub coreintr_status: u16,
    pub phy_utmi: u16,
    pub mode: u16,
    pub tx_mode: u16,
    pub rx_mode: u16,
// bit positions for control
    pub reset:5: unsigned,
// bit positions for interrupt
    pub usb_shift:5: unsigned,
    pub usb_mask: u32,
    pub usb_bitmap: u32,
    pub drvvbus:5: unsigned,
    pub txep_shift:5: unsigned,
    pub txep_mask: u32,
    pub txep_bitmap: u32,
    pub rxep_shift:5: unsigned,
    pub rxep_mask: u32,
    pub rxep_bitmap: u32,
// bit positions for phy_utmi
    pub otg_disable:5: unsigned,
// bit positions for mode
    pub iddig:5: unsigned,
    pub iddig_mux:5: unsigned,
// miscellaneous stuff
    pub poll_timeout: unsigned,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dsps_glue {
    pub dev: *mut device,
    pub /: *mut *mut *mut platform_device musb; / child musb pdev,
    pub /: *const *const *const dsps_musb_wrapper wrp; / wrapper register offsets,
    pub /: *mut *mut int vbus_irq; / optional vbus irq,
    pub /: *mut *mut unsigned long last_timer; / last timer data for each instance,
    pub sw_babble_enabled: bool,
    pub usbss_base: *mut void __iomem,
    pub context: dsps_context,
...
#[no_mangle]
unsafe extern "C" fn dsps_mod_timer(glue: *mut dsps_glue, wait_ms: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn dsps_mod_timer_optional(glue: *mut dsps_glue) {
...
// USBSS  / USB AM335x
pub const USBSS_IRQ_STATUS: c_uint = 0x28;
pub const USBSS_IRQ_ENABLER: c_uint = 0x2c;
pub const USBSS_IRQ_CLEARR: c_uint = 0x30;

//
// dsps_musb_enable - enable interrupts
//
#[no_mangle]
unsafe extern "C" fn dsps_musb_enable(musb: *mut musb) {
...
//
#[no_mangle]
unsafe extern "C" fn dsps_musb_disable(musb: *mut musb) {
...
#[no_mangle]
unsafe extern "C" fn dsps_check_status(musb: *mut musb, unused: *mut c_void) -> c_int {
...
unsafe extern "C" fn otg_timer(t: *mut timer_list) {
    ...
    err = musb_queue_resume_work(musb, dsps_check_status, core::ptr::null_mut());
    if (err < 0)
...
#[no_mangle]
unsafe extern "C" fn dsps_musb_clear_ep_rxintr(musb: *mut musb, epnum: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dsps_interrupt(irq: c_int, hci: *mut c_void) -> irqreturn_t {
...
// Get usb core interrupts
    ...
    let mut drvvbus: c_int = musb_readl(reg_base, wrp.status);
    void __iomem *mregs = musb.mregs;
    let mut devctl: u8 = musb_readb(mregs, MUSB_DEVCTL);
    int err;
...
#[no_mangle]
unsafe extern "C" fn dsps_musb_dbg_init(musb: *mut musb, glue: *mut dsps_glue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsps_musb_init(musb: *mut musb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsps_musb_exit(musb: *mut musb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsps_musb_set_mode(musb: *mut musb, mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsps_sw_babble_control(musb: *mut musb) -> bool {
    static bool dsps_sw_babble_control(struct musb *musb)
    {
    u8 babble_ctl;
    let mut session_restart: bool = false;
...
#[no_mangle]
unsafe extern "C" fn dsps_musb_recover(musb: *mut musb) -> c_int {
    static int dsps_musb_recover(struct musb *musb)
    {
    struct device *dev = musb.controller;
    struct dsps_glue *glue = dev_get_drvdata(dev.parent);
    let mut session_restart: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn dsps_read_fifo32(hw_ep: *mut musb_hw_ep, len: u16, dst: *mut u8) {
...
// Read any remaining 1 to 3 bytes
    if (len > 0) {
    let mut val: u32 = musb_readl(fifo, 0);
    memcpy(dst, &val, len);
    }
    }

#[no_mangle]
unsafe extern "C" fn dsps_dma_controller_callback(c: *mut dma_controller) {
...
#[no_mangle]
unsafe extern "C" fn dsps_dma_controller_suspend(glue: *mut dsps_glue) {
...
#[no_mangle]
unsafe extern "C" fn dsps_dma_controller_resume(glue: *mut dsps_glue) {
    ...
    let mut musb_dmamask: static u64 = DMA_BIT_MASK(32);
#[no_mangle]
unsafe extern "C" fn get_int_prop(dn: *mut device_node, s: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsps_vbus_threaded_irq(irq: c_int, priv: *mut c_void) -> irqreturn_t {
    ...
    core::ptr::null_mut(), dsps_vbus_threaded_irq,
    IRQF_SHARED,
    "vbus", glue);
    if (error) {
    glue.vbus_irq = 0;
...
#[no_mangle]
unsafe extern "C" fn dsps_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsps_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dsps_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsps_resume(dev: *mut device) -> c_int {
