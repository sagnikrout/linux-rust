...
//! Source: drivers/usb/chipidea/ci_hdrc_msm.c
#![no_std]
...
pub const HS_PHY_AHB_MODE: c_uint = 0x0098;
pub const HS_PHY_GENCONFIG: c_uint = 0x009c;

pub const HS_PHY_GENCONFIG_2: c_uint = 0x00a0;

// Vendor base starts at 0x200 beyond CI base
pub const HS_PHY_CTRL: c_uint = 0x0040;
pub const HS_PHY_SEC_CTRL: c_uint = 0x0078;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ci_hdrc_msm {
...
#[no_mangle]
unsafe extern "C" fn ci_hdrc_msm_notify_event(ci: *mut ci_hdrc, event: unsigned) -> c_int {
    ...
    let mut val: u32 = readl_relaxed(msm_ci.base + HS_PHY_SEC_CTRL);
...
#[no_mangle]
unsafe extern "C" fn ci_hdrc_msm_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (ulpi_node) {
    phy_node = of_get_next_available_child(ulpi_node, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ci_hdrc_msm_remove(pdev: *mut platform_device) {
