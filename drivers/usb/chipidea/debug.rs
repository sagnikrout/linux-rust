...
//! Source: drivers/usb/chipidea/debug.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ci_device_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ci_port_test_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ci_port_test_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ci_qheads_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ci_requests_show(s: *mut seq_file, data: *mut c_void) -> c_int {
    static int ci_requests_show(struct seq_file *s, void *data)
    {
    struct ci_hdrc *ci = s.private;
    unsigned long flags;
    struct ci_hw_req *req = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ci_otg_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ci_registers_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dbg_create_files(ci: *mut ci_hdrc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dbg_remove_files(ci: *mut ci_hdrc) {
