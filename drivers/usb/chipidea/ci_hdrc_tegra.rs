...
//! Source: drivers/usb/chipidea/ci_hdrc_tegra.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_usb {
    pub data: ci_hdrc_platform_data,
    pub dev: *mut platform_device,
    pub soc: *const tegra_usb_soc_info,
    pub phy: *mut usb_phy,
    pub clk: *mut clk,
    pub needs_double_reset: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_usb_soc_info {
    pub flags: c_ulong,
    pub txfifothresh: c_uint,
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_reset_controller(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_notify_event(ci: *mut ci_hdrc, event: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_enter_lpm(ci: *mut ci_hdrc, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_probe(pdev: *mut platform_device) -> c_int {
    ...
    "failed to get PHY");
    usb.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(usb.clk))
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_runtime_suspend(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(tegra_usb_runtime_suspend, tegra_usb_runtime_resume, core::ptr::null_mut())
    };
