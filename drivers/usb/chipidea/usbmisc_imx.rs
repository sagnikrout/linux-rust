...
//! Source: drivers/usb/chipidea/usbmisc_imx.c
#![no_std]
...
pub const MX25_USB_PHY_CTRL_OFFSET: c_uint = 0x08;

pub const MX25_OTG_SIC_SHIFT: c_int = 29;

pub const MX25_H1_SIC_SHIFT: c_int = 21;

pub const MX53_USB_OTG_PHY_CTRL_0_OFFSET: c_uint = 0x08;
pub const MX53_USB_OTG_PHY_CTRL_1_OFFSET: c_uint = 0x0c;
pub const MX53_USB_CTRL_1_OFFSET: c_uint = 0x10;

pub const MX53_USB_UH2_CTRL_OFFSET: c_uint = 0x14;
pub const MX53_USB_UH3_CTRL_OFFSET: c_uint = 0x18;
pub const MX53_USB_CLKONOFF_CTRL_OFFSET: c_uint = 0x24;

pub const MX53_USB_PHYCTRL1_PLLDIV_MASK: c_uint = 0x3;
pub const MX53_USB_PLL_DIV_24_MHZ: c_uint = 0x01;

pub const MX6_USB_HSIC_CTRL_OFFSET: c_uint = 0x10;
...
pub const MX6_USB_OTG1_PHY_CTRL: c_uint = 0x18;
// For imx6dql, it is host-only controller, for later imx6, it is otg's
pub const MX6_USB_OTG2_PHY_CTRL: c_uint = 0x1c;

pub const MX7D_USBNC_USB_CTRL2: c_uint = 0x4;
pub const MX7D_USB_VBUS_WAKEUP_SOURCE_MASK: c_uint = 0x3;

// The default DM/DP value is pull-down

    BIT(14) | BIT(15))

pub const MX7D_USB_OTG_PHY_CFG2: c_uint = 0x34;
pub const MX7D_USB_OTG_PHY_STATUS: c_uint = 0x3c;

pub const MX7D_USB_OTG_PHY_CFG1: c_uint = 0x30;
pub const TXPREEMPAMPTUNE0_BIT: c_int = 28;

pub const TXRISETUNE0_BIT: c_int = 24;

pub const TXVREFTUNE0_BIT: c_int = 20;

    MX6_BM_ID_WAKEUP | MX6SX_BM_DPDM_WAKEUP_EN)
//
// HSIO Block Control Register
//
pub const BLKCTL_USB_WAKEUP_CTRL: c_uint = 0x0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usbmisc_ops {
// It's called once when probe a usb device
    pub data): *mut *mut int (init)(struct imx_usbmisc_data,
// It's called once after adding a usb device
    pub data): *mut *mut int (post)(struct imx_usbmisc_data,
// It's called when we need to enable/disable usb wakeup
    pub enabled): *mut *mut *mut int (set_wakeup)(struct imx_usbmisc_data data, bool,
// It's called before setting portsc.suspendM
    pub data): *mut *mut int (hsic_set_connect)(struct imx_usbmisc_data,
// It's called during suspend/resume
    pub enabled): *mut *mut *mut int (hsic_set_clk)(struct imx_usbmisc_data data, bool,
// usb charger detection
    pub data): *mut *mut int (charger_detection)(struct imx_usbmisc_data,
// It's called when system resume from usb power lost
    pub data): *mut *mut int (power_lost_check)(struct imx_usbmisc_data,
// It's called when device controller changed pullup status
    pub on): *mut *mut *mut void (pullup)(struct imx_usbmisc_data data, bool,
// It's called during suspend/resume to save power
    pub on): *mut *mut *mut void (vbus_comparator_on)(struct imx_usbmisc_data data, bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_usbmisc {
    pub base: *mut void __iomem,
    pub blkctl: *mut void __iomem,
    pub lock: spinlock_t,
    pub ops: *const usbmisc_ops,
}

    static inline bool is_imx53_usbmisc(struct imx_usbmisc_data *data);
#[no_mangle]
unsafe extern "C" fn usbmisc_imx25_init(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx25_post(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx27_init(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx53_init(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_wakeup_setting(data: *mut imx_usbmisc_data) -> u32 {
    static u32 usbmisc_wakeup_setting(struct imx_usbmisc_data *data)
    {
    let mut wakeup_setting: u32 = MX6_USB_OTG_WAKEUP_BITS;
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx6q_init(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: data->oc_pol_configured) -> else {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx6_hsic_get_reg_offset(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx6_hsic_set_connect(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx6_hsic_set_clk(data: *mut imx_usbmisc_data, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx6sx_init(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_vf610_init(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_s32g_set_wakeup(data: *mut imx_usbmisc_data, enabled: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_s32g_init(data: *mut imx_usbmisc_data, extra_flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_s32g2_init(data: *mut imx_usbmisc_data) -> c_int {
    static int usbmisc_s32g2_init(struct imx_usbmisc_data *data)
    {
    return usbmisc_s32g_init(data, S32G_UCMALLBE);
    }
#[no_mangle]
unsafe extern "C" fn usbmisc_s32g3_init(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx7d_init(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7d_charger_secondary_detection(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7_disable_charger_detector(data: *mut imx_usbmisc_data) {
...
#[no_mangle]
unsafe extern "C" fn imx7d_charger_data_contact_detect(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7d_charger_primary_detection(data: *mut imx_usbmisc_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imx7d_charger_detection(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx7ulp_init(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx7d_pullup(data: *mut imx_usbmisc_data, on: bool) {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx7d_power_lost_check(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx6sx_power_lost_check(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_s32g_power_lost_check(data: *mut imx_usbmisc_data) -> c_int {
    static int usbmisc_s32g_power_lost_check(struct imx_usbmisc_data *data)
    {
    return 1;
    }
#[no_mangle]
unsafe extern "C" fn usbmisc_blkctl_wakeup_setting(data: *mut imx_usbmisc_data) -> u32 {
    static u32 usbmisc_blkctl_wakeup_setting(struct imx_usbmisc_data *data)
    {
    let mut wakeup_setting: u32 = BLKCTL_WAKEUP_SOURCE;
    if (data.ext_id || data.available_role != USB_DR_MODE_OTG)
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx95_set_wakeup(data: *mut imx_usbmisc_data, enabled: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_imx53_usbmisc(data: *mut imx_usbmisc_data) -> bool {
    static inline bool is_imx53_usbmisc(struct imx_usbmisc_data *data)
    {
    struct imx_usbmisc *usbmisc = dev_get_drvdata(data.dev);
...
#[no_mangle]
pub unsafe extern "C" fn imx_usbmisc_init(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn imx_usbmisc_init_post(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn imx_usbmisc_hsic_set_connect(data: *mut imx_usbmisc_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn imx_usbmisc_charger_detection(data: *mut imx_usbmisc_data, connect: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn imx_usbmisc_pullup(data: *mut imx_usbmisc_data, on: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn imx_usbmisc_suspend(data: *mut imx_usbmisc_data, wakeup: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn imx_usbmisc_resume(data: *mut imx_usbmisc_data, wakeup: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbmisc_imx_probe(pdev: *mut platform_device) -> c_int {
