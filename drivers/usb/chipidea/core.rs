...
//! Source: drivers/usb/chipidea/core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hw_alloc_regmap(ci: *mut ci_hdrc, is_lpm: bool) {
...
#[no_mangle]
unsafe extern "C" fn ci_get_revision(ci: *mut ci_hdrc) -> enum ci_revision {
    static enum ci_revision ci_get_revision(struct ci_hdrc *ci)
    {
    let mut ver: c_int = hw_read_id_reg(ci, ID_ID, VERSION) >> __ffs(VERSION);
    let mut rev: enum ci_revision = CI_REVISION_UNKNOWN;
    if (ver == 0x2) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hw_read_intr_enable(ci: *mut ci_hdrc) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn hw_read_intr_status(ci: *mut ci_hdrc) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn hw_port_test_set(ci: *mut ci_hdrc, mode: u8) -> c_int {
    int hw_port_test_set(struct ci_hdrc *ci, u8 mode)
    {
    let mut TEST_MODE_MAX: u8 = 7;
...
//
#[no_mangle]
pub unsafe extern "C" fn hw_port_test_get(ci: *mut ci_hdrc) -> u8 {
    u8 hw_port_test_get(struct ci_hdrc *ci)
    {
    return hw_read(ci, OP_PORTSC, PORTSC_PTC) >> __ffs(PORTSC_PTC);
    }
#[no_mangle]
unsafe extern "C" fn hw_wait_phy_stable() {
...
#[no_mangle]
unsafe extern "C" fn ci_hdrc_enter_lpm_common(ci: *mut ci_hdrc, enable: bool) {
    static void ci_hdrc_enter_lpm_common(struct ci_hdrc *ci, bool enable)
    {
    let mut reg: enum ci_hw_regs = ci.hw_bank.lpm ? OP_DEVLC : OP_PORTSC;
    let mut lpm: bool = !!(hw_read(ci, reg, PORTSC_PHCD(ci.hw_bank.lpm)));
    if (enable && !lpm)
    hw_write(ci, reg, PORTSC_PHCD(ci.hw_bank.lpm),
    PORTSC_PHCD(ci.hw_bank.lpm));
#[no_mangle]
pub unsafe extern "C" fn if(lpm: !enable &&) -> else {
    else if (!enable && lpm)
    hw_write(ci, reg, PORTSC_PHCD(ci.hw_bank.lpm),
    0);
    }
#[no_mangle]
unsafe extern "C" fn ci_hdrc_enter_lpm(ci: *mut ci_hdrc, enable: bool) {
    static void ci_hdrc_enter_lpm(struct ci_hdrc *ci, bool enable)
    {
    return ci.platdata.enter_lpm(ci, enable);
    }
#[no_mangle]
unsafe extern "C" fn hw_device_init(ci: *mut ci_hdrc, base: *mut void __iomem) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hw_phymode_configure(ci: *mut ci_hdrc) {
...
//
#[no_mangle]
unsafe extern "C" fn _ci_usb_phy_init(ci: *mut ci_hdrc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ci_usb_phy_exit(ci: *mut ci_hdrc) {
...
//
#[no_mangle]
unsafe extern "C" fn ci_usb_phy_init(ci: *mut ci_hdrc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ci_platform_configure(ci: *mut ci_hdrc) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_controller_reset(ci: *mut ci_hdrc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hw_device_reset(ci: *mut ci_hdrc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ci_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ci_irq(ci: *mut ci_hdrc) {
...
#[no_mangle]
unsafe extern "C" fn ci_usb_role_switch_get(sw: *mut usb_role_switch) -> enum usb_role {
...
#[no_mangle]
unsafe extern "C" fn ci_get_role(ci: *mut ci_hdrc) -> enum ci_role {
...
// no vbus regulator is needed
    platdata.reg_vbus = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ci_extcon_register(ci: *mut ci_hdrc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ci_power_lost_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn ci_hdrc_remove_device(pdev: *mut platform_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ci_hdrc_query_available_role(pdev: *mut platform_device) -> enum usb_dr_mode {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ci->roles[CI_ROLE_HOST]) -> else {
    else if (ci.roles[CI_ROLE_HOST])
    return USB_DR_MODE_HOST;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ci->roles[CI_ROLE_GADGET]) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ci_role_destroy(ci: *mut ci_hdrc) {
...
#[no_mangle]
unsafe extern "C" fn ci_get_otg_capable(ci: *mut ci_hdrc) {
...
// Disable and clear all OTG irq
    ...
    ATTRIBUTE_GROUPS(ci);
#[no_mangle]
unsafe extern "C" fn ci_hdrc_probe(pdev: *mut platform_device) -> c_int {
    static int ci_hdrc_probe(struct platform_device *pdev)
    {
    let mut ci_role_switch: usb_role_switch_desc = {};
...
#[no_mangle]
unsafe extern "C" fn ci_hdrc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ci_otg_fsm_suspend_for_srp(ci: *mut ci_hdrc) {
...
#[no_mangle]
unsafe extern "C" fn ci_otg_fsm_wakeup_by_srp(ci: *mut ci_hdrc) {
...
#[no_mangle]
unsafe extern "C" fn ci_controller_suspend(ci: *mut ci_hdrc) {
...
//
#[no_mangle]
unsafe extern "C" fn ci_extcon_wakeup_int(ci: *mut ci_hdrc) {
    static void ci_extcon_wakeup_int(struct ci_hdrc *ci)
    {
    struct ci_hdrc_cable *cable_id, *cable_vbus;
    let mut otgsc: u32 = hw_read_otgsc(ci, ~0);
...
#[no_mangle]
unsafe extern "C" fn ci_controller_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ci_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ci_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ci_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ci_runtime_resume(dev: *mut device) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(ci_runtime_suspend, ci_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn ci_hdrc_platform_register() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ci_hdrc_platform_unregister() -> void __exit {
