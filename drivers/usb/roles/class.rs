...
//! Source: drivers/usb/roles/class.c
#![no_std]
...
pub struct usb_role_switch {
    ...
    pub lock*/: *mut *mut mutex lock; / device,
    pub /: *mut *mut *mut module module; / the module this device depends on,
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_role_switch_set_role(sw: *mut usb_role_switch, role: enum usb_role) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_role_switch_get_role(sw: *mut usb_role_switch) -> enum usb_role {
...
//
    ...
    if (!sw)
    sw = device_connection_find_match(dev, "usb-role-switch", core::ptr::null_mut(),
...
//
    ...
    core::ptr::null_mut(), usb_role_switch_match);
    if (!IS_ERR_OR_NULL(sw))
    WARN_ON(!try_module_get(sw.module));
    return sw;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_role_switch_put(sw: *mut usb_role_switch) {
...
//
    ...
    {
    struct device *dev;
    struct usb_role_switch *sw = core::ptr::null_mut();
    if (!fwnode)
    return core::ptr::null_mut();
    dev = class_find_device_by_fwnode(&role_class, fwnode);
    if (dev) {
    ...
    {
    struct usb_role_switch *sw = to_role_switch(dev);
    let mut role: enum usb_role = usb_role_switch_get_role(sw);
...
#[no_mangle]
unsafe extern "C" fn usb_role_switch_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_role_switch_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_role_switch_unregister(sw: *mut usb_role_switch) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_role_switch_set_drvdata(sw: *mut usb_role_switch, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn usb_roles_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn usb_roles_exit() -> void __exit {
