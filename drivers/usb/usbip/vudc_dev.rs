...
//! Source: drivers/usb/usbip/vudc_dev.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn free_urb(urb: *mut urb) {
    static void free_urb(struct urb *urb)
    {
    if (!urb)
    return;
    kfree(urb.setup_packet);
    urb.setup_packet = core::ptr::null_mut();
    ...
    if (!urb_p)
    return urb_p;
    urb_p.urb = core::ptr::null_mut();
    urb_p.ep = core::ptr::null_mut();
    INIT_LIST_HEAD(&urb_p.urb_entry);
    return urb_p;
    }
#[no_mangle]
unsafe extern "C" fn free_urbp(urb_p: *mut urbp) {
    static void free_urbp(struct urbp *urb_p)
    {
    kfree(urb_p);
    }
#[no_mangle]
pub unsafe extern "C" fn free_urbp_and_urb(urb_p: *mut urbp) {
...
#[no_mangle]
unsafe extern "C" fn nuke(udc: *mut vudc, ep: *mut vep) {
...
#[no_mangle]
unsafe extern "C" fn stop_activity(udc: *mut vudc) {
...
// gadget ops
#[no_mangle]
unsafe extern "C" fn vgadget_get_frame(_gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgadget_set_selfpowered(_gadget: *mut usb_gadget, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgadget_pullup(_gadget: *mut usb_gadget, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgadget_udc_stop(g: *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vep_disable(_ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vep_free_request(_ep: *mut usb_ep, _req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn vep_dequeue(_ep: *mut usb_ep, _req: *mut usb_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vep_set_wedge(_ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vudc_shutdown(ud: *mut usbip_device) {
    static void vudc_shutdown(struct usbip_device *ud)
    {
    struct vudc *udc = container_of(ud, struct vudc, ud);
    let mut call_disconnect: c_int = 0;
    unsigned long flags;
    ...
    ud.tcp_rx = core::ptr::null_mut();
    }
    if (ud.tcp_tx) {
    kthread_stop_put(ud.tcp_tx);
    ud.tcp_tx = core::ptr::null_mut();
    }
    if (ud.tcp_socket) {
...
#[no_mangle]
unsafe extern "C" fn vudc_device_reset(ud: *mut usbip_device) {
...
#[no_mangle]
unsafe extern "C" fn vudc_device_unusable(ud: *mut usbip_device) {
...
// device setup / cleanup
    ...
    if (!udc_dev.pdev) {
    kfree(udc_dev);
    udc_dev = core::ptr::null_mut();
    }
    return udc_dev;
    }
#[no_mangle]
pub unsafe extern "C" fn put_vudc_device(udc_dev: *mut vudc_device) {
...
#[no_mangle]
unsafe extern "C" fn init_vudc_hw(udc: *mut vudc) -> c_int {
...
// create ep0 and 15 in, 15 out general purpose eps
    for (i = 0; i < VIRTUAL_ENDPOINTS; ++i) {
    let mut is_out: c_int = i % 2;
    let mut num: c_int = (i + 1) / 2;
    ep = &udc.ep[i];
...
#[no_mangle]
unsafe extern "C" fn cleanup_vudc_hw(udc: *mut vudc) {
...
// platform driver ops
#[no_mangle]
pub unsafe extern "C" fn vudc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vudc_remove(pdev: *mut platform_device) {
