...
//! Source: drivers/usb/usbip/vhci_sysfs.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn port_show_vhci(out: *mut c_char, hub: c_int, port: c_int, vdev: *mut vhci_device) {
...
#[no_mangle]
unsafe extern "C" fn status_show_not_ready(pdev_nr: c_int, out: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn status_show_vhci(pdev_nr: c_int, out: *mut c_char) -> isize {
    ...
    if (!hcd) {
    usbip_dbg_vhci_sysfs("show status error (hcd is core::ptr::null_mut())\n");
...
#[no_mangle]
unsafe extern "C" fn status_name_to_id(name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhci_port_disconnect(vhci_hcd: *mut vhci_hcd, rhport: __u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn valid_port(pdev_nr: *mut __u32, rhport: *mut __u32) -> c_int {
...
// rhport = array_index_nospec(*rhport, VHCI_HC_PORTS);
    ...
    {
    let mut port: __u32 = 0, pdev_nr = 0, rhport = 0;
    struct usb_hcd *hcd;
    struct vhci_hcd *vhci_hcd;
    int ret;
...
//
    ...
    let mut port: __u32 = 0, pdev_nr = 0, rhport = 0, devid = 0, speed = 0;
    struct usb_hcd *hcd;
    struct vhci_hcd *vhci_hcd;
    ...
    int err;
    unsigned long flags;
    struct task_struct *tcp_rx = core::ptr::null_mut();
    struct task_struct *tcp_tx = core::ptr::null_mut();
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct status_attr {
    pub attr: device_attribute,
    pub name: [c_char; MAX_STATUS_NAME+1],
}

    static struct status_attr *status_attrs;
#[no_mangle]
unsafe extern "C" fn set_status_attr(id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn init_status_attrs() -> c_int {
    static int init_status_attrs(void)
    {
    int id;
    status_attrs = kzalloc_objs(struct status_attr, vhci_num_controllers);
    if (status_attrs == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn finish_status_attrs() {
...
#[no_mangle]
pub unsafe extern "C" fn vhci_init_attr_group() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vhci_finish_attr_group() {
