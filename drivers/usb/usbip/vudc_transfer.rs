...
//! Source: drivers/usb/usbip/vudc_transfer.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_frame_limit(speed: enum usb_device_speed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v_timer(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn v_init_timer(udc: *mut vudc) {
...
#[no_mangle]
pub unsafe extern "C" fn v_start_timer(udc: *mut vudc) {
...
#[no_mangle]
pub unsafe extern "C" fn v_kick_timer(udc: *mut vudc, time: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn v_stop_timer(udc: *mut vudc) {
