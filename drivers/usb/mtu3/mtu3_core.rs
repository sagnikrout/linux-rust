...
//! Source: drivers/usb/mtu3/mtu3_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ep_fifo_alloc(mep: *mut mtu3_ep, seg_size: u32) -> c_int {
    static int ep_fifo_alloc(struct mtu3_ep *mep, u32 seg_size)
    {
    struct mtu3_fifo_info *fifo = mep.fifo;
    let mut num_bits: u32 = DIV_ROUND_UP(seg_size, MTU3_EP_FIFO_UNIT);
    u32 start_bit;
...
#[no_mangle]
unsafe extern "C" fn ep_fifo_free(mep: *mut mtu3_ep) {
    static void ep_fifo_free(struct mtu3_ep *mep)
    {
    struct mtu3_fifo_info *fifo = mep.fifo;
    let mut addr: u32 = mep.fifo_addr;
    let mut bits: u32 = mep.fifo_size / MTU3_EP_FIFO_UNIT;
    u32 start_bit;
...
#[no_mangle]
pub unsafe extern "C" fn mtu3_ss_func_set(mtu: *mut mtu3, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mtu3_hs_softconn_set(mtu: *mut mtu3, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_device_enable(mtu: *mut mtu3) -> c_int {
    static int mtu3_device_enable(struct mtu3 *mtu)
    {
    void __iomem *ibase = mtu.ippc_base;
    let mut check_clk: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn mtu3_device_disable(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_dev_power_on(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_dev_power_down(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_device_reset(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_intr_status_clear(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_intr_disable(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_intr_enable(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_set_speed(mtu: *mut mtu3, speed: enum usb_device_speed) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_csr_init(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_ep_reset(mep: *mut mtu3_ep) {
    static void mtu3_ep_reset(struct mtu3_ep *mep)
    {
    struct mtu3 *mtu = mep.mtu;
    let mut rst_bit: u32 = EP_RST(mep.is_in, mep.epnum);
...
#[no_mangle]
pub unsafe extern "C" fn mtu3_ep_stall_set(mep: *mut mtu3_ep, set: bool) {
    void mtu3_ep_stall_set(struct mtu3_ep *mep, bool set)
    {
    struct mtu3 *mtu = mep.mtu;
    void __iomem *mbase = mtu.mac_base;
    let mut epnum: u8 = mep.epnum;
    u32 csr;
    if (mep.is_in) {	/* TX */
...
#[no_mangle]
pub unsafe extern "C" fn mtu3_dev_on_off(mtu: *mut mtu3, is_on: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn mtu3_start(mtu: *mut mtu3) {
...
#[no_mangle]
pub unsafe extern "C" fn mtu3_stop(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_dev_suspend(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_dev_resume(mtu: *mut mtu3) {
...
// for non-ep0
    ...
    {
    void __iomem *mbase = mtu.mac_base;
    let mut gen2cp: bool = mtu.gen2cp;
    let mut epnum: c_int = mep.epnum;
    u32 csr0, csr1, csr2;
...
// for non-ep0
#[no_mangle]
pub unsafe extern "C" fn mtu3_deconfig_ep(mtu: *mut mtu3, mep: *mut mtu3_ep) {
...
//
#[no_mangle]
unsafe extern "C" fn get_ep_fifo_config(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_ep0_setup(mtu: *mut mtu3) {
    static void mtu3_ep0_setup(struct mtu3 *mtu)
    {
    let mut maxpacket: u32 = mtu.g.ep0.maxpacket;
    u32 csr;
...
#[no_mangle]
unsafe extern "C" fn mtu3_mem_alloc(mtu: *mut mtu3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_mem_free(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_regs_init(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_link_isr(mtu: *mut mtu3) -> irqreturn_t {
    static irqreturn_t mtu3_link_isr(struct mtu3 *mtu)
    {
    void __iomem *mbase = mtu.mac_base;
    enum usb_device_speed udev_speed;
    let mut maxpkt: u32 = 64;
    u32 link;
    u32 speed;
...
#[no_mangle]
unsafe extern "C" fn mtu3_u3_ltssm_isr(mtu: *mut mtu3) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mtu3_u2_common_isr(mtu: *mut mtu3) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mtu3_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mtu3_check_params(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_hw_init(mtu: *mut mtu3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_hw_exit(mtu: *mut mtu3) {
...
//
#[no_mangle]
unsafe extern "C" fn mtu3_set_dma_mask(mtu: *mut mtu3) -> c_int {
    static int mtu3_set_dma_mask(struct mtu3 *mtu)
    {
    struct device *dev = mtu.dev;
    let mut is_36bit: bool = false;
    let mut ret: c_int = 0;
    u32 value;
...
#[no_mangle]
pub unsafe extern "C" fn ssusb_gadget_init(ssusb: *mut ssusb_mtk) -> c_int {
    int ssusb_gadget_init(struct ssusb_mtk *ssusb)
    {
    struct device *dev = ssusb.dev;
    struct platform_device *pdev = to_platform_device(dev);
    struct mtu3 *mtu = core::ptr::null_mut();
...
// for backward compatibility
    ...
    ret = devm_request_threaded_irq(dev, mtu.irq, core::ptr::null_mut(), mtu3_irq,
...
// power down device IP for power saving by default
    ...
    irq_err:
    mtu3_hw_exit(mtu);
    ssusb.u3d = core::ptr::null_mut();
    dev_err(dev, " %s() fail...\n", __func__);
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn ssusb_gadget_exit(ssusb: *mut ssusb_mtk) {
...
#[no_mangle]
pub unsafe extern "C" fn ssusb_gadget_ip_sleep_check(ssusb: *mut ssusb_mtk) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ssusb_gadget_suspend(ssusb: *mut ssusb_mtk, msg: pm_message_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ssusb_gadget_resume(ssusb: *mut ssusb_mtk, msg: pm_message_t) -> c_int {
