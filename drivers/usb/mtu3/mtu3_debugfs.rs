...
//! Source: drivers/usb/mtu3/mtu3_debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mtu3_link_state_show(sf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_ep_used_show(sf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_ep_info_show(sf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_fifo_show(sf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_qmu_ring_show(sf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_qmu_gpd_show(sf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_ep_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_probe_show(sf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_probe_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_debugfs_create_prb_files(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_debugfs_create_ep_dirs(mtu: *mut mtu3) {
...
#[no_mangle]
pub unsafe extern "C" fn ssusb_dev_debugfs_init(ssusb: *mut ssusb_mtk) {
...
#[no_mangle]
unsafe extern "C" fn ssusb_mode_show(sf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssusb_mode_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssusb_vbus_show(sf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssusb_vbus_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ssusb_dr_debugfs_init(ssusb: *mut ssusb_mtk) {
...
#[no_mangle]
pub unsafe extern "C" fn ssusb_debugfs_create_root(ssusb: *mut ssusb_mtk) {
...
#[no_mangle]
pub unsafe extern "C" fn ssusb_debugfs_remove_root(ssusb: *mut ssusb_mtk) {
    void ssusb_debugfs_remove_root(struct ssusb_mtk *ssusb)
    {
    debugfs_remove_recursive(ssusb.dbgfs_root);
    ssusb.dbgfs_root = core::ptr::null_mut();
    }
