...
//! Source: drivers/usb/mtu3/mtu3_host.c
#![no_std]
...
// mt8173 etc
pub const PERI_WK_CTRL1: c_uint = 0x4;

// mt8183
pub const PERI_WK_CTRL0: c_uint = 0x0;

// mt8192

// mt8195
pub const PERI_WK_CTRL0_8195: c_uint = 0x04;

pub const PERI_WK_CTRL1_8195: c_uint = 0x20;

// mt8196
pub const PERI_WK_CTRL0_8196: c_uint = 0x08;

pub const PERI_WK_CTRL1_8196: c_uint = 0x10;

// mt2712 etc
pub const PERI_SSUSB_SPM_CTRL: c_uint = 0x0;
...
//
#[no_mangle]
unsafe extern "C" fn ssusb_wakeup_ip_sleep_set(ssusb: *mut ssusb_mtk, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn ssusb_wakeup_set(ssusb: *mut ssusb_mtk, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn host_ports_num_get(ssusb: *mut ssusb_mtk) {
...
#[no_mangle]
unsafe extern "C" fn ssusb_host_enable(ssusb: *mut ssusb_mtk) -> c_int {
    static int ssusb_host_enable(struct ssusb_mtk *ssusb)
    {
    void __iomem *ibase = ssusb.ippc_base;
    let mut num_u3p: c_int = ssusb.u3_ports;
    let mut num_u2p: c_int = ssusb.u2_ports;
...
#[no_mangle]
unsafe extern "C" fn ssusb_host_disable(ssusb: *mut ssusb_mtk) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ssusb_host_resume(ssusb: *mut ssusb_mtk, p0_skipped: bool) -> c_int {
    int ssusb_host_resume(struct ssusb_mtk *ssusb, bool p0_skipped)
    {
    void __iomem *ibase = ssusb.ippc_base;
    let mut u3p_skip_msk: c_int = ssusb.u3p_dis_msk;
    let mut u2p_skip_msk: c_int = ssusb.u2p_dis_msk;
    let mut num_u3p: c_int = ssusb.u3_ports;
    let mut num_u2p: c_int = ssusb.u2_ports;
    u32 value;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn ssusb_host_suspend(ssusb: *mut ssusb_mtk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssusb_host_setup(ssusb: *mut ssusb_mtk) {
...
#[no_mangle]
unsafe extern "C" fn ssusb_host_cleanup(ssusb: *mut ssusb_mtk) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ssusb_host_init(ssusb: *mut ssusb_mtk, parent_dn: *mut device_node) -> c_int {
    int ssusb_host_init(struct ssusb_mtk *ssusb, struct device_node *parent_dn)
    {
    struct device *parent_dev = ssusb.dev;
    int ret;
    ssusb_host_setup(ssusb);
    ret = of_platform_populate(parent_dn, core::ptr::null_mut(), core::ptr::null_mut(), parent_dev);
    if (ret) {
...
#[no_mangle]
pub unsafe extern "C" fn ssusb_host_exit(ssusb: *mut ssusb_mtk) {
