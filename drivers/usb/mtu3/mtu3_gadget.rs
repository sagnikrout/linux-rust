...
//! Source: drivers/usb/mtu3/mtu3_gadget.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nuke(mep: *mut mtu3_ep, status: c_int) {
    static void nuke(struct mtu3_ep *mep, const int status)
    {
    struct mtu3_request *mreq = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mtu3_ep_enable(mep: *mut mtu3_ep) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: usb_endpoint_xfer_int(desc)) -> else {
...
#[no_mangle]
unsafe extern "C" fn mtu3_ep_disable(mep: *mut mtu3_ep) -> c_int {
...
// abort all pending requests
    ...
    mep.desc = core::ptr::null_mut();
    mep.ep.desc = core::ptr::null_mut();
    mep.comp_desc = core::ptr::null_mut();
    mep.type = 0;
    mep.flags = 0;
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn mtu3_gadget_ep_disable(ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtu3_free_request(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_gadget_dequeue(ep: *mut usb_ep, req: *mut usb_request) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mtu3_gadget_ep_set_halt(ep: *mut usb_ep, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_gadget_ep_set_wedge(ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_gadget_get_frame(gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn function_wake_notif(mtu: *mut mtu3, intf: u8) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_gadget_wakeup(gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_gadget_pullup(gadget: *mut usb_gadget, is_on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stop_activity(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_gadget_stop(g: *mut usb_gadget) -> c_int {
    ...
    spin_lock_irqsave(&mtu.lock, flags);
    stop_activity(mtu);
    mtu.gadget_driver = core::ptr::null_mut();
    if (mtu.ssusb.dr_mode == USB_DR_MODE_PERIPHERAL)
    mtu3_stop(mtu);
    spin_unlock_irqrestore(&mtu.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn mtu3_gadget_async_callbacks(g: *mut usb_gadget, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_state_reset(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn mtu3_gadget_init_eps(mtu: *mut mtu3) {
...
#[no_mangle]
pub unsafe extern "C" fn mtu3_gadget_setup(mtu: *mut mtu3) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtu3_gadget_cleanup(mtu: *mut mtu3) {
    void mtu3_gadget_cleanup(struct mtu3 *mtu)
    {
    usb_del_gadget_udc(&mtu.g);
    }
#[no_mangle]
pub unsafe extern "C" fn mtu3_gadget_resume(mtu: *mut mtu3) {
...
#[no_mangle]
pub unsafe extern "C" fn mtu3_gadget_suspend(mtu: *mut mtu3) {
...
#[no_mangle]
pub unsafe extern "C" fn mtu3_gadget_disconnect(mtu: *mut mtu3) {
...
#[no_mangle]
pub unsafe extern "C" fn mtu3_gadget_reset(mtu: *mut mtu3) {
