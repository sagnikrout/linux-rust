...
//! Source: drivers/usb/mtu3/mtu3_gadget_ep0.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ep0_req_giveback(mtu: *mut mtu3, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn ep0_write_fifo(mep: *mut mtu3_ep, src: *const u8, len: u16) {
...
#[no_mangle]
unsafe extern "C" fn ep0_read_fifo(mep: *mut mtu3_ep, dst: *mut u8, len: u16) {
...
#[no_mangle]
unsafe extern "C" fn ep0_load_test_packet(mtu: *mut mtu3) {
...
//
#[no_mangle]
unsafe extern "C" fn ep0_stall_set(mep0: *mut mtu3_ep, set: bool, pktrdy: u32) {
...
#[no_mangle]
unsafe extern "C" fn ep0_do_status_stage(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn ep0_dummy_complete(ep: *mut usb_ep, req: *mut usb_request) {
    static void ep0_dummy_complete(struct usb_ep *ep, struct usb_request *req)
    {}
#[no_mangle]
unsafe extern "C" fn ep0_set_sel_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn ep0_set_sel(mtu: *mut mtu3, setup: *mut usb_ctrlrequest) -> c_int {
    static int ep0_set_sel(struct mtu3 *mtu, struct usb_ctrlrequest *setup)
    {
    int ret;
    let mut length: u16 = le16_to_cpu(setup.wLength);
    ...
    {
    struct mtu3_ep *mep = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn handle_test_mode(mtu: *mut mtu3, setup: *mut usb_ctrlrequest) -> c_int {
...
//
    ...
    {
    void __iomem *mbase = mtu.mac_base;
    let mut state: enum usb_device_state = mtu.g.state;
    let mut handled: c_int = -EINVAL;
    u32 dev_conf;
    u16 value;
    value = le16_to_cpu(setup.wValue);
...
#[no_mangle]
unsafe extern "C" fn ep0_rx_state(mtu: *mut mtu3) {
...
// read packet and ack; or stall because of gadget driver bug
    ...
    let mut len: c_uint = req.length - req.actual;
// read the buffer
...
#[no_mangle]
unsafe extern "C" fn ep0_tx_state(mtu: *mut mtu3) {
...
#[no_mangle]
unsafe extern "C" fn ep0_read_setup(mtu: *mut mtu3, setup: *mut usb_ctrlrequest) {
...
#[no_mangle]
unsafe extern "C" fn ep0_handle_setup(mtu: *mut mtu3) -> c_int {
    ...
    goto stall;
#[no_mangle]
pub unsafe extern "C" fn if(0: handled >) -> else {
    else if (handled > 0)
    goto finish;
...
#[no_mangle]
pub unsafe extern "C" fn mtu3_ep0_isr(mtu: *mut mtu3) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mtu3_ep0_disable(ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ep0_queue(mep: *mut mtu3_ep, mreq: *mut mtu3_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_ep0_dequeue(ep: *mut usb_ep, req: *mut usb_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_ep0_halt(ep: *mut usb_ep, value: c_int) -> c_int {
