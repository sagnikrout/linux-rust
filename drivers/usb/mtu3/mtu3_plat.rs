...
//! Source: drivers/usb/mtu3/mtu3_plat.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ssusb_check_clocks(ssusb: *mut ssusb_mtk, ex_clks: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wait_for_ip_sleep(ssusb: *mut ssusb_mtk) -> c_int {
    static int wait_for_ip_sleep(struct ssusb_mtk *ssusb)
    {
    let mut sleep_check: bool = true;
    u32 value;
    int ret;
    if (!ssusb.is_host)
...
#[no_mangle]
unsafe extern "C" fn ssusb_phy_init(ssusb: *mut ssusb_mtk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssusb_phy_exit(ssusb: *mut ssusb_mtk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssusb_phy_power_on(ssusb: *mut ssusb_mtk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssusb_phy_power_off(ssusb: *mut ssusb_mtk) {
...
#[no_mangle]
unsafe extern "C" fn ssusb_rscs_init(ssusb: *mut ssusb_mtk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssusb_rscs_exit(ssusb: *mut ssusb_mtk) {
...
#[no_mangle]
unsafe extern "C" fn ssusb_ip_sw_reset(ssusb: *mut ssusb_mtk) {
...
#[no_mangle]
unsafe extern "C" fn ssusb_u3_drd_check(ssusb: *mut ssusb_mtk) {
...
#[no_mangle]
unsafe extern "C" fn get_ssusb_rscs(pdev: *mut platform_device, ssusb: *mut ssusb_mtk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_ENABLED(CONFIG_USB_MTU3_GADGET)) -> else {
...
#[no_mangle]
unsafe extern "C" fn mtu3_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn resume_ip_and_ports(ssusb: *mut ssusb_mtk, msg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_suspend_common(dev: *mut device, msg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_resume_common(dev: *mut device, msg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtu3_suspend(dev: *mut device) -> int __maybe_unused {
    static int __maybe_unused mtu3_suspend(struct device *dev)
    {
    return mtu3_suspend_common(dev, PMSG_SUSPEND);
    }
#[no_mangle]
unsafe extern "C" fn mtu3_resume(dev: *mut device) -> int __maybe_unused {
    static int __maybe_unused mtu3_resume(struct device *dev)
    {
    return mtu3_resume_common(dev, PMSG_SUSPEND);
    }
#[no_mangle]
unsafe extern "C" fn mtu3_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mtu3_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    mtu3_runtime_resume, core::ptr::null_mut())
    };
