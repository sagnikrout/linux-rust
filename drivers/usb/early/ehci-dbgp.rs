...
//! Source: drivers/usb/early/ehci-dbgp.c
#![no_std]
...
//
    let mut dbgp_phys_port: static int = 1;
...
pub const USB_DEBUG_DEVNUM: c_int = 127;

#[no_mangle]
unsafe extern "C" fn dbgp_ehci_status(str: *mut c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn dbgp_len_update(x: u32, len: u32) -> u32 {
...
pub const USB_PID_NYET: c_uint = 0x96;
// data
pub const USB_PID_DATA0: c_uint = 0xc3;
pub const USB_PID_DATA1: c_uint = 0x4b;
pub const USB_PID_DATA2: c_uint = 0x87;
pub const USB_PID_MDATA: c_uint = 0x0f;
// Special
pub const USB_PID_PREAMBLE: c_uint = 0x3c;
pub const USB_PID_ERR: c_uint = 0x3c;
pub const USB_PID_SPLIT: c_uint = 0x78;
pub const USB_PID_PING: c_uint = 0xb4;
pub const USB_PID_UNDEF_0: c_uint = 0xf0;
pub const USB_PID_DATA_TOGGLE: c_uint = 0x88;

pub const PCI_CAP_ID_EHCI_DEBUG: c_uint = 0xa;

pub const HUB_SHORT_RESET_TIME: c_int = 10;
pub const HUB_LONG_RESET_TIME: c_int = 200;
pub const HUB_RESET_TIMEOUT: c_int = 500;
pub const DBGP_MAX_PACKET: c_int = 8;

pub const DBGP_LOOPS: c_int = 1000;
#[no_mangle]
pub unsafe extern "C" fn dbgp_pid_write_update(x: u32, tok: u32) -> u32 {
    static inline u32 dbgp_pid_write_update(u32 x, u32 tok)
    {
    let mut data0: static int = USB_PID_DATA1;
    data0 ^= USB_PID_DATA_TOGGLE;
    return (x & 0xffff0000) | (data0 << 8) | (tok & 0xff);
    }
#[no_mangle]
pub unsafe extern "C" fn dbgp_pid_read_update(x: u32, tok: u32) -> u32 {
    static inline u32 dbgp_pid_read_update(u32 x, u32 tok)
    {
    return (x & 0xffff0000) | (USB_PID_DATA0 << 8) | (tok & 0xff);
    }
#[no_mangle]
unsafe extern "C" fn dbgp_wait_until_complete() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dbgp_mdelay(ms: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dbgp_breath() {
    static void dbgp_breath(void)
    {
// Sleep to give the debug port a chance to breathe
    }
#[no_mangle]
unsafe extern "C" fn dbgp_wait_until_done(ctrl: unsigned, loop: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dbgp_set_data(buf: *const c_void, size: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn dbgp_get_data(buf: *mut c_void, size: c_int) {
...
#[no_mangle]
unsafe extern "C" fn find_cap(num: u32, slot: u32, func: u32, cap: c_int) -> u32 __init {
...
#[no_mangle]
unsafe extern "C" fn __find_dbgp(bus: u32, slot: u32, func: u32) -> u32 __init {
...
#[no_mangle]
unsafe extern "C" fn find_dbgp(ehci_num: c_int, rbus: *mut u32, rslot: *mut u32, rfunc: *mut u32) -> u32 __init {
...
#[no_mangle]
unsafe extern "C" fn dbgp_ehci_startup() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dbgp_ehci_controller_reset() -> c_int {
    static int dbgp_ehci_controller_reset(void)
    {
    let mut loop: c_int = 250 * 1000;
    u32 cmd;
...
//
#[no_mangle]
unsafe extern "C" fn _dbgp_external_startup() -> c_int {
    ...
    int ret;
    u32 ctrl, portsc, cmd;
    let mut dbg_port: c_int = dbgp_phys_port;
    let mut tries: c_int = 3;
    let mut reset_port_tries: c_int = 1;
    let mut try_hard_once: c_int = 1;
...
// Move the device to 127 if it isn't already there
    ...
    USB_REQ_SET_ADDRESS, USB_DEBUG_DEVNUM, 0, core::ptr::null_mut(), 0);
    if (ret < 0) {
...
// Enable the debug interface
    ...
    USB_DIR_OUT | USB_TYPE_STANDARD | USB_RECIP_DEVICE,
    USB_REQ_SET_FEATURE, USB_DEVICE_DEBUG_MODE, 0, core::ptr::null_mut(), 0);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn ehci_reset_port(port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ehci_wait_for_port(port: c_int) -> c_int {
    static int ehci_wait_for_port(int port)
    {
    u32 status;
    int ret, reps;
...
#[no_mangle]
unsafe extern "C" fn default_set_debug_port(port: c_int) -> void __init {
    static void __init default_set_debug_port(int port)
    {
    }
    let mut set_debug_port: static set_debug_port_t __initdata = default_set_debug_port;
#[no_mangle]
unsafe extern "C" fn nvidia_set_debug_port(port: c_int) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn detect_set_debug_port() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn early_ehci_bios_handoff() -> void __init {
    static void __init early_ehci_bios_handoff(void)
    {
    let mut hcc_params: u32 = readl(&ehci_caps.hcc_params);
    let mut offset: c_int = (hcc_params >> 8) & 0xff;
    u32 cap;
    int msec;
    if (!offset)
    return;
...
#[no_mangle]
unsafe extern "C" fn ehci_setup() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn early_dbgp_init(s: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn early_dbgp_write(con: *mut console, str: *const c_char, n: u32) {
    static void early_dbgp_write(struct console *con, const char *str, u32 n)
    {
    int chunk;
    char buf[DBGP_MAX_PACKET];
    let mut use_cr: c_int = 0;
    u32 cmd, ctrl;
    let mut reset_run: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn dbgp_reset_prep(hcd: *mut usb_hcd) -> c_int {
    int dbgp_reset_prep(struct usb_hcd *hcd)
    {
    let mut ret: c_int = xen_dbgp_reset_prep(hcd);
    u32 ctrl;
    if (ret)
    return ret;
    dbgp_not_safe = 1;
...
#[no_mangle]
pub unsafe extern "C" fn dbgp_external_startup(hcd: *mut usb_hcd) -> c_int {
    ...
    let mut kgdbdbgp_loop_cnt: static int = DBGP_LOOPS;
#[no_mangle]
unsafe extern "C" fn kgdbdbgp_read_char() -> c_int {
    static int kgdbdbgp_read_char(void)
    {
    int ret;
    if (kgdbdbgp_buf_idx < kgdbdbgp_buf_sz) {
    let mut ch: c_char = kgdbdbgp_buf[kgdbdbgp_buf_idx++];
    return ch;
    }
...
#[no_mangle]
unsafe extern "C" fn kgdbdbgp_write_char(chr: u8) {
    static void kgdbdbgp_write_char(u8 chr)
    {
    early_dbgp_write(core::ptr::null_mut(), &chr, 1);
    }
    static struct kgdb_io kgdbdbgp_io_ops = {
    .name = "kgdbdbgp",
...
#[no_mangle]
unsafe extern "C" fn kgdbdbgp_parse_config(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn kgdbdbgp_reader_thread(ptr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdbdbgp_start_thread() -> int __init {
    static int __init kgdbdbgp_start_thread(void)
    {
    if (dbgp_kgdb_mode && kgdbdbgp_wait_time)
    kthread_run(kgdbdbgp_reader_thread, core::ptr::null_mut(), "%s", "dbgp");
    return 0;
    }
