...
//! Source: drivers/usb/storage/cypress_atacb.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn cypress_atacb_passthrough(srb: *mut scsi_cmnd, us: *mut us_data) {
...
// build the command for reading the ATA registers
    scsi_eh_prep_cmnd(srb, &ses, core::ptr::null_mut(), 0, sizeof(regs));
//
