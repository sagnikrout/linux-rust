...
//! Source: drivers/usb/storage/shuttle_usbat.c
#![no_std]
...
pub const USBAT_DEV_HP8200: c_uint = 0x01;
pub const USBAT_DEV_FLASH: c_uint = 0x02;
pub const USBAT_EPP_PORT: c_uint = 0x10;
pub const USBAT_EPP_REGISTER: c_uint = 0x30;
pub const USBAT_ATA: c_uint = 0x40;
pub const USBAT_ISA: c_uint = 0x50;
// Commands (need to be logically OR'd with an access type
pub const USBAT_CMD_READ_REG: c_uint = 0x00;
pub const USBAT_CMD_WRITE_REG: c_uint = 0x01;
pub const USBAT_CMD_READ_BLOCK: c_uint = 0x02;
pub const USBAT_CMD_WRITE_BLOCK: c_uint = 0x03;
pub const USBAT_CMD_COND_READ_BLOCK: c_uint = 0x04;
pub const USBAT_CMD_COND_WRITE_BLOCK: c_uint = 0x05;
pub const USBAT_CMD_WRITE_REGS: c_uint = 0x07;
// Commands (these don't need an access type)
pub const USBAT_CMD_EXEC_CMD: c_uint = 0x80;
pub const USBAT_CMD_SET_FEAT: c_uint = 0x81;
pub const USBAT_CMD_UIO: c_uint = 0x82;
// Methods of accessing UIO register
pub const USBAT_UIO_READ: c_int = 1;
pub const USBAT_UIO_WRITE: c_int = 0;
// Qualifier bits
pub const USBAT_QUAL_FCQ: c_uint = 0x20	/* full compare */;
pub const USBAT_QUAL_ALQ: c_uint = 0x10	/* auto load subcount */;
// USBAT Flash Media status types
pub const USBAT_FLASH_MEDIA_NONE: c_int = 0;
pub const USBAT_FLASH_MEDIA_CF: c_int = 1;
// USBAT Flash Media change types
pub const USBAT_FLASH_MEDIA_SAME: c_int = 0;
pub const USBAT_FLASH_MEDIA_CHANGED: c_int = 1;
// USBAT ATA registers
pub const USBAT_ATA_DATA: c_uint = 0x10  /* read/write data (R/W) */;
pub const USBAT_ATA_FEATURES: c_uint = 0x11  /* set features (W) */;
pub const USBAT_ATA_ERROR: c_uint = 0x11  /* error (R) */;
pub const USBAT_ATA_SECCNT: c_uint = 0x12  /* sector count (R/W) */;
pub const USBAT_ATA_SECNUM: c_uint = 0x13  /* sector number (R/W) */;
pub const USBAT_ATA_LBA_ME: c_uint = 0x14  /* cylinder low (R/W) */;
pub const USBAT_ATA_LBA_HI: c_uint = 0x15  /* cylinder high (R/W) */;
pub const USBAT_ATA_DEVICE: c_uint = 0x16  /* head/device selection (R/W) */;
pub const USBAT_ATA_STATUS: c_uint = 0x17  /* device status (R) */;
pub const USBAT_ATA_CMD: c_uint = 0x17  /* device command (W) */;
pub const USBAT_ATA_ALTSTATUS: c_uint = 0x0E  /* status (no clear IRQ) (R) */;
// USBAT User I/O Data registers
pub const USBAT_UIO_EPAD: c_uint = 0x80 /* Enable Peripheral Control Signals */;
pub const USBAT_UIO_CDT: c_uint = 0x40 /* Card Detect (Read Only) */;
// CDT = ACKD & !UI1 & !UI0
pub const USBAT_UIO_1: c_uint = 0x20 /* I/O 1 */;
pub const USBAT_UIO_0: c_uint = 0x10 /* I/O 0 */;
pub const USBAT_UIO_EPP_ATA: c_uint = 0x08 /* 1=EPP mode, 0=ATA mode */;
pub const USBAT_UIO_UI1: c_uint = 0x04 /* Input 1 */;
pub const USBAT_UIO_UI0: c_uint = 0x02 /* Input 0 */;
pub const USBAT_UIO_INTR_ACK: c_uint = 0x01 /* Interrupt (ATA/ISA)/Acknowledge (EPP) */;
// USBAT User I/O Enable registers
pub const USBAT_UIO_DRVRST: c_uint = 0x80 /* Reset Peripheral */;
pub const USBAT_UIO_ACKD: c_uint = 0x40 /* Enable Card Detect */;
pub const USBAT_UIO_OE1: c_uint = 0x20 /* I/O 1 set=output/clr=input */;
// If ACKD=1, set OE1 to 1 also.
pub const USBAT_UIO_OE0: c_uint = 0x10 /* I/O 0 set=output/clr=input */;
pub const USBAT_UIO_ADPRST: c_uint = 0x01 /* Reset SCM chip */;
// USBAT Features
pub const USBAT_FEAT_ETEN: c_uint = 0x80	/* External trigger enable */;
pub const USBAT_FEAT_U1: c_uint = 0x08;
pub const USBAT_FEAT_U0: c_uint = 0x04;
pub const USBAT_FEAT_ET1: c_uint = 0x02;
pub const USBAT_FEAT_ET2: c_uint = 0x01;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usbat_info {
    pub devicetype: c_int,
// Used for Flash readers only
    pub /: *mut *mut unsigned long sectors; / total sector count,
    pub /: *mut *mut unsigned long ssize; / sector size in bytes,
    ...
    let mut transferred: static int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn usbat_get_device_type(us: *mut us_data) -> c_int {
...
//
    ...
    return usb_stor_bulk_transfer_sg(us, us.recv_bulk_pipe, buf, len, use_sg, core::ptr::null_mut());
    }
//
...
//
    ...
    return USB_STOR_XFER_GOOD;
    usb_stor_dbg(us, "len = %d\n", len);
    return usb_stor_bulk_transfer_sg(us, us.send_bulk_pipe, buf, len, use_sg, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn usbat_get_status(us: *mut us_data, status: *mut c_uchar) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usbat_check_status(us: *mut us_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usbat_wait_not_busy(us: *mut us_data, minutes: c_int) -> c_int {
...
//
    ...
    msleep(10); /* 5 seconds */
#[no_mangle]
pub unsafe extern "C" fn if(_arg: i<700) -> else {
    else if (i<700)
    msleep(50); /* 10 seconds */
#[no_mangle]
pub unsafe extern "C" fn if(_arg: i<1200) -> else {
    else if (i<1200)
...
// Conditionally read or write blocks
    ...
    pipe, buf, len, use_sg, core::ptr::null_mut());
//
...
//
#[no_mangle]
unsafe extern "C" fn usbat_read_user_io(us: *mut us_data, data_flags: *mut c_uchar) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usbat_device_reset(us: *mut us_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usbat_device_enable_cdt(us: *mut us_data) -> c_int {
...
//
    ...
    {
    let mut result: c_int = USB_STOR_TRANSPORT_GOOD;
    unsigned char *buffer;
    unsigned int len;
    unsigned int sector;
    let mut sg_offset: c_uint = 0;
...
//
    ...
    if (buffer == core::ptr::null_mut()) /* bloody hell! */
    return USB_STOR_TRANSPORT_FAILED;
...
#[no_mangle]
unsafe extern "C" fn usbat_select_and_test_registers(us: *mut us_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn init_usbat(us: *mut us_data, devicetype: c_int) -> c_int {
    static int init_usbat(struct us_data *us, int devicetype)
    {
    int rc;
    struct usbat_info *info;
    let mut subcountH: c_uchar = USBAT_ATA_LBA_HI;
    let mut subcountL: c_uchar = USBAT_ATA_LBA_ME;
    unsigned char *status = us.iobuf;
...
//
#[no_mangle]
unsafe extern "C" fn usbat_hp8200e_transport(srb: *mut scsi_cmnd, us: *mut us_data) -> c_int {
    static int usbat_hp8200e_transport(struct scsi_cmnd *srb, struct us_data *us)
    {
    int result;
    unsigned char *status = us.iobuf;
...
//
#[no_mangle]
unsafe extern "C" fn usbat_flash_transport(srb: *mut *mut scsi_cmnd, us: *mut us_data) -> c_int {
    static int usbat_flash_transport(struct scsi_cmnd * srb, struct us_data *us)
    {
    int rc;
...
#[no_mangle]
unsafe extern "C" fn init_usbat_cd(us: *mut us_data) -> c_int {
    static int init_usbat_cd(struct us_data *us)
    {
    return init_usbat(us, USBAT_DEV_HP8200);
    }
#[no_mangle]
unsafe extern "C" fn init_usbat_flash(us: *mut us_data) -> c_int {
    static int init_usbat_flash(struct us_data *us)
    {
