...
//! Source: drivers/usb/storage/realtek_cr.c
#![no_std]
...
//
    ...
    let mut auto_delink_en: static int = 1;
    module_param(auto_delink_en, int, S_IRUGO | S_IWUSR);
    MODULE_PARM_DESC(auto_delink_en, "auto delink mode (0=firmware, 1=software [default])");

    let mut ss_en: static int = 1;
    module_param(ss_en, int, S_IRUGO | S_IWUSR);
    MODULE_PARM_DESC(ss_en, "enable selective suspend");
    let mut ss_delay: static int = 50;
...
pub const POLLING_INTERVAL: c_int = 50;

    ((chip).state = (enum RTS51X_STAT)(stat))

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rts51x_status {
    pub vid: u16,
    pub pid: u16,
    pub cur_lun: u8,
    pub card_type: u8,
    ...
    pub log_exist: u8,
    union {
    pub detailed_type1: u8,
    pub detailed_type2: u8,
    pub detailed_type: },
    pub function: [u8; 2],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rts51x_chip {
    pub vendor_id: u16,
    pub product_id: u16,
    pub max_lun: c_char,
    pub status: *mut rts51x_status,
    pub status_len: c_int,
    pub flag: u32,
    pub us: *mut us_data,

    pub rts51x_suspend_timer: timer_list,
    pub timer_expires: c_ulong,
    pub pwr_state: c_int,
    pub lun_ready: u8,
    pub state: enum RTS51X_STAT,
    pub support_auto_delink: c_int,

// used to back up the protocol chosen in probe1 phase
    pub proto_handler_backup: proto_cmnd,
}

// flag definition
pub const FLIDX_AUTO_DELINK: c_uint = 0x01;

// Bit Operation

pub const STATUS_SUCCESS: c_int = 0;
pub const STATUS_FAIL: c_int = 1;
...
//
    ...
    unsigned int cswlen;
    let mut cbwlen: c_uint = US_BULK_CB_WRAP_LEN;
...
#[no_mangle]
unsafe extern "C" fn rts51x_get_max_lun(us: *mut us_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts51x_read_mem(us: *mut us_data, addr: u16, data: *mut u8, len: u16) -> c_int {
    ...
    buf, len, DMA_FROM_DEVICE, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rts51x_write_mem(us: *mut us_data, addr: u16, data: *mut u8, len: u16) -> c_int {
    ...
    cmnd[5] = (u8) len;
    retval = rts51x_bulk_transport(us, 0, cmnd, 12,
    buf, len, DMA_TO_DEVICE, core::ptr::null_mut());
    kfree(buf);
    if (retval != USB_STOR_TRANSPORT_GOOD)
    return -EIO;
    return 0;
...
#[no_mangle]
unsafe extern "C" fn rts51x_check_status(us: *mut us_data, lun: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enable_oscillator(us: *mut us_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __do_config_autodelink(us: *mut us_data, data: *mut u8, len: u16) -> c_int {
    ...
    cmnd[4] = (u8)(len >> 8);
    cmnd[5] = (u8)len;
    retval = rts51x_bulk_transport_special(us, 0, cmnd, 12, buf, len, DMA_TO_DEVICE, core::ptr::null_mut());
    kfree(buf);
    if (retval != USB_STOR_TRANSPORT_GOOD) {
    return -EIO;
    }
...
#[no_mangle]
unsafe extern "C" fn do_config_autodelink(us: *mut us_data, enable: c_int, force: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn config_autodelink_after_power_on(us: *mut us_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn config_autodelink_before_power_down(us: *mut us_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fw5895_init(us: *mut us_data) {
...
#[no_mangle]
unsafe extern "C" fn fw5895_set_mmc_wp(us: *mut us_data) {
...
#[no_mangle]
unsafe extern "C" fn rts51x_modi_suspend_timer(chip: *mut rts51x_chip) {
...
#[no_mangle]
unsafe extern "C" fn rts51x_suspend_timer_fn(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn working_scsi(srb: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts51x_invoke_transport(srb: *mut scsi_cmnd, us: *mut us_data) {
    static void rts51x_invoke_transport(struct scsi_cmnd *srb, struct us_data *us)
    {
    struct rts51x_chip *chip = (struct rts51x_chip *)(us.extra);
    let mut card_first_show: static int = 1;
    ...
    let mut prevent: c_int = srb.cmnd[4] & 0x1;
    if (prevent) {
    srb.result = SAM_STAT_CHECK_CONDITION;
    memcpy(srb.sense_buffer,
    invalid_cmd_field,
...
#[no_mangle]
unsafe extern "C" fn realtek_cr_autosuspend_setup(us: *mut us_data) -> c_int {
    static int realtek_cr_autosuspend_setup(struct us_data *us)
    {
    struct rts51x_chip *chip;
    struct rts51x_status *status = core::ptr::null_mut();
    u8 buf[16];
    int retval;
...
#[no_mangle]
unsafe extern "C" fn realtek_cr_destructor(extra: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn realtek_cr_suspend(iface: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn realtek_cr_resume(iface: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_realtek_cr(us: *mut us_data) -> c_int {
    static int init_realtek_cr(struct us_data *us)
    {
    struct rts51x_chip *chip;
    int size, i, retval;
