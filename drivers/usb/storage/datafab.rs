...
//! Source: drivers/usb/storage/datafab.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn datafab_info_destructor(extra: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn datafab_transport(srb: *mut scsi_cmnd, us: *mut us_data) -> c_int {
