...
//! Source: drivers/usb/storage/jumpshot.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn jumpshot_get_status(us: *mut us_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jumpshot_info_destructor(extra: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn jumpshot_transport(srb: *mut scsi_cmnd, us: *mut us_data) -> c_int {
