...
//! Source: drivers/usb/gadget/legacy/nokia.c
#![no_std]
...
// Defines
pub const NOKIA_VERSION_NUM: c_uint = 0x0211;
...
pub const NOKIA_VENDOR_ID: c_uint = 0x0421	/* Nokia */;
pub const NOKIA_PRODUCT_ID: c_uint = 0x01c8	/* Nokia Gadget */;
...
#[no_mangle]
unsafe extern "C" fn nokia_bind_config(c: *mut usb_configuration) -> c_int {
    static int nokia_bind_config(struct usb_configuration *c)
    {
    struct usb_function *f_acm;
    struct usb_function *f_phonet = core::ptr::null_mut();
    struct usb_function *f_obex1 = core::ptr::null_mut();
    struct usb_function *f_ecm;
    struct usb_function *f_obex2 = core::ptr::null_mut();
    struct usb_function *f_msg;
    let mut status: c_int = 0;
    let mut obex1_stat: c_int = -1;
    let mut obex2_stat: c_int = -1;
    let mut phonet_stat: c_int = -1;
    if (!IS_ERR(fi_phonet)) {
...
#[no_mangle]
unsafe extern "C" fn nokia_bind(cdev: *mut usb_composite_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nokia_unbind(cdev: *mut usb_composite_dev) -> c_int {
