...
//! Source: drivers/usb/gadget/legacy/zero.c
#![no_std]
...
//
    let mut loopdefault: static bool = 0;
...
pub const DRIVER_VENDOR_NUM: c_uint = 0x0525		/* NetChip */;
pub const DRIVER_PRODUCT_NUM: c_uint = 0xa4a0		/* Linux-USB "Gadget Zero" */;
pub const DEFAULT_AUTORESUME: c_int = 0;

pub const DRIVER_VENDOR_NUM: c_uint = 0x1a0a		/* OTG test device IDs */;
pub const DRIVER_PRODUCT_NUM: c_uint = 0xbadd;
pub const DEFAULT_AUTORESUME: c_int = 5;

// If the optional "autoresume" mode is enabled, it provides good
// functional coverage for the "USBCV" test harness from USB-IF.
// It's always set if OTG mode is enabled.
//
    let mut autoresume: static unsigned = DEFAULT_AUTORESUME;
...
#[no_mangle]
unsafe extern "C" fn zero_autoresume(unused: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn zero_suspend(cdev: *mut usb_composite_dev) {
...
#[no_mangle]
unsafe extern "C" fn zero_resume(cdev: *mut usb_composite_dev) {
...
#[no_mangle]
unsafe extern "C" fn zero_bind(cdev: *mut usb_composite_dev) -> c_int {
...
// support autoresume for remote wakeup testing
    ...
    sourcesink_driver.descriptors = core::ptr::null_mut();
    loopback_driver.descriptors = core::ptr::null_mut();
    if (autoresume) {
    sourcesink_driver.bmAttributes |= USB_CONFIG_ATT_WAKEUP;
    loopback_driver.bmAttributes |= USB_CONFIG_ATT_WAKEUP;
    autoresume_step_ms = autoresume * 1000;
...
//
    ...
    func_lb = core::ptr::null_mut();
    err_put_func_inst_lb:
    usb_put_function_instance(func_inst_lb);
    func_inst_lb = core::ptr::null_mut();
    err_put_func_ss:
    usb_put_function(func_ss);
    func_ss = core::ptr::null_mut();
    err_put_func_inst_ss:
    usb_put_function_instance(func_inst_ss);
    func_inst_ss = core::ptr::null_mut();
    return status;
    }
#[no_mangle]
unsafe extern "C" fn zero_unbind(cdev: *mut usb_composite_dev) -> c_int {
