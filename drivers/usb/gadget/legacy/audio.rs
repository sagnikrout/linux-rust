...
//! Source: drivers/usb/gadget/legacy/audio.c
#![no_std]
...
// Playback Default 48 KHz
    ...
    MODULE_PARM_DESC(p_srate, "Playback Sampling Rates (array)");
// Playback Default 16bits/sample
    let mut p_ssize: static int = UAC1_DEF_PSSIZE;
    module_param(p_ssize, uint, 0444);
    MODULE_PARM_DESC(p_ssize, "Playback Sample Size(bytes)");
// Capture(USB-OUT) Default Stereo - Fl/Fr
    let mut c_chmask: static int = UAC1_DEF_CCHMASK;
    module_param(c_chmask, uint, 0444);
    MODULE_PARM_DESC(c_chmask, "Capture Channel Mask");
// Capture Default 48 KHz
    ...
    MODULE_PARM_DESC(c_srate, "Capture Sampling Rates (array)");
// Capture Default 16bits/sample
    let mut c_ssize: static int = UAC1_DEF_CSSIZE;
    module_param(c_ssize, uint, 0444);
    MODULE_PARM_DESC(c_ssize, "Capture Sample Size(bytes)");
    ...
    let mut req_buf_size: static int = UAC1_OUT_EP_MAX_PACKET_SIZE;
    module_param(req_buf_size, int, 0444);
    MODULE_PARM_DESC(req_buf_size, "ISO OUT endpoint request buffer size");
    let mut req_count: static int = UAC1_REQ_COUNT;
    module_param(req_count, int, 0444);
    MODULE_PARM_DESC(req_count, "ISO OUT endpoint request count");
    let mut audio_buf_size: static int = UAC1_AUDIO_BUF_SIZE;
...
pub const AUDIO_VENDOR_NUM: c_uint = 0x1d6b	/* Linux Foundation */;
pub const AUDIO_PRODUCT_NUM: c_uint = 0x0101	/* Linux-USB Audio Gadget */;
// -------------------------------------------------------------------------
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn audio_do_config(c: *mut usb_configuration) -> c_int {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn audio_bind(cdev: *mut usb_composite_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn audio_unbind(cdev: *mut usb_composite_dev) -> c_int {
