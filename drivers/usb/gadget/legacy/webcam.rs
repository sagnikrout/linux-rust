...
//! Source: drivers/usb/gadget/legacy/webcam.c
#![no_std]
...
// module parameters specific to the Video streaming endpoint
    let mut streaming_interval: static unsigned int = 1;
    module_param(streaming_interval, uint, S_IRUGO|S_IWUSR);
    MODULE_PARM_DESC(streaming_interval, "1 - 16");
    let mut streaming_maxpacket: static unsigned int = 1024;
...
// Device descriptor
//
pub const WEBCAM_VENDOR_ID: c_uint = 0x1d6b	/* Linux Foundation */;
pub const WEBCAM_PRODUCT_ID: c_uint = 0x0102	/* Webcam A/V gadget */;
pub const WEBCAM_DEVICE_BCD: c_uint = 0x0010	/* 0.10 */;
...
pub const UVCG_WIDTH_360P: c_int = 640;
pub const UVCG_HEIGHT_360P: c_int = 360;
pub const UVCG_MIN_BITRATE_360P: c_int = 18432000;
pub const UVCG_MAX_BITRATE_360P: c_int = 55296000;
pub const UVCG_MAX_VIDEO_FB_SZ_360P: c_int = 460800;
pub const UVCG_FRM_INTERV_0_360P: c_int = 666666;
pub const UVCG_FRM_INTERV_1_360P: c_int = 1000000;
pub const UVCG_FRM_INTERV_2_360P: c_int = 5000000;
...
pub const UVCG_WIDTH_720P: c_int = 1280;
pub const UVCG_HEIGHT_720P: c_int = 720;
pub const UVCG_MIN_BITRATE_720P: c_int = 29491200;
pub const UVCG_MAX_BITRATE_720P: c_int = 29491200;
pub const UVCG_MAX_VIDEO_FB_SZ_720P: c_int = 1843200;
pub const UVCG_FRM_INTERV_0_720P: c_int = 5000000;
