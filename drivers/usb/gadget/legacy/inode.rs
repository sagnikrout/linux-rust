...
//! Source: drivers/usb/gadget/legacy/inode.c
#![no_std]
...
// ----------------------------------------------------------------------
pub const GADGETFS_MAGIC: c_uint = 0xaee71ee7;
...
pub const N_EVENT: c_int = 5;
pub const RBUF_SIZE: c_int = 256;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dev_data {
    pub lock: spinlock_t,
    ...
    pub udc_usage: c_int,
    pub /: *mut *mut enum ep0_state state; / P: lock,
    pub [N_EVENT]: usb_gadgetfs_event event,
    pub ev_next: unsigned,
...
//
    ...
    setup_out_error : 1,
    setup_abort : 1,
    pub 1: gadget_registered :,
    pub setup_wLength: unsigned,
// the rest is basically write-once
    pub hs_config: *mut *mut usb_config_descriptor config,,
    pub dev: *mut usb_device_descriptor,
    pub req: *mut usb_request,
    pub gadget: *mut usb_gadget,
    pub epfiles: list_head,
    pub buf: *mut c_void,
...
#[no_mangle]
pub unsafe extern "C" fn get_dev(data: *mut dev_data) {
    static inline void get_dev (struct dev_data *data)
    {
    refcount_inc (&data.count);
    }
#[no_mangle]
unsafe extern "C" fn put_dev(data: *mut dev_data) {
...
pub struct ep_data {
    ...
    pub count: refcount_t,
    pub dev: *mut dev_data,
// must hold dev->lock before accessing ep or req
    pub ep: *mut usb_ep,
    pub req: *mut usb_request,
    pub status: isize,
    pub [16]: char name,
    pub hs_desc: usb_endpoint_descriptor desc,,
    pub epfiles: list_head,
    pub wait: wait_queue_head_t,
}

#[no_mangle]
pub unsafe extern "C" fn get_ep(data: *mut ep_data) {
    static inline void get_ep (struct ep_data *data)
    {
    refcount_inc (&data.count);
    }
#[no_mangle]
unsafe extern "C" fn put_ep(data: *mut ep_data) {
...
//
#[no_mangle]
unsafe extern "C" fn epio_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
// case STATE_EP_DISABLED:		/* "can't happen"
    ...
    if (likely (epdata.ep != core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn ep_ioctl(fd: *mut file, code: unsigned, value: c_ulong) -> c_long {
    ...
    if (likely (data.ep != core::ptr::null_mut())) {
    switch (code) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kiocb_priv {
    pub req: *mut usb_request,
    pub epdata: *mut ep_data,
    pub iocb: *mut kiocb,
...
#[no_mangle]
unsafe extern "C" fn ep_aio_cancel(iocb: *mut kiocb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ep_user_copy_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ep_aio_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
// lock against disconnect (and ideally, cancel)
    ...
    priv.epdata = core::ptr::null_mut();
// if this was a write or a read returning no data then we
// don't need to copy anything to userspace, so we can
// complete the aio request immediately.
//
    if (priv.to_free == core::ptr::null_mut() || unlikely(req.actual == 0)) {
    mmdrop(priv.mm);
    kfree(req.buf);
    kfree(priv.to_free);
    kfree(priv);
...
//
    spin_lock_irq(&epdata.dev.lock);
    value = -ENODEV;
    if (unlikely(epdata.ep == core::ptr::null_mut()))
    goto fail;
...
// fails if caller didn't provide that descriptor...
    ...
    value = -ENOENT;
#[no_mangle]
pub unsafe extern "C" fn if(STATE_EP_DISABLED: data->state ==) -> else {
    value = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn ep0_readable(dev: *mut dev_data) {
...
#[no_mangle]
unsafe extern "C" fn clean_req(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn ep0_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn setup_req(ep: *mut usb_ep, req: *mut usb_request, len: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gadget_dev_ioctl(fd: *mut file, code: unsigned, value: c_ulong) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn make_qualifier(dev: *mut dev_data) {
...
// temp = cpu_to_le16(RBUF_SIZE);
    ...
    && dev.hs_config == core::ptr::null_mut()) {
...
// queued to EP0.
//
    let mut w_length: return = = 0 ? USB_GADGET_DELAYED_STATUS : 0;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn destroy_ep_files(dev: *mut dev_data) {
...
// break link to controller
    ...
    ep.ep = core::ptr::null_mut();
    mutex_unlock(&ep.lock);
    wake_up (&ep.wait);
// break link to dcache
    simple_remove_by_name(dev.sb.s_root, ep.name, core::ptr::null_mut());
    put_ep (ep);
    spin_lock_irq (&dev.lock);
    }
    spin_unlock_irq (&dev.lock);
...
#[no_mangle]
unsafe extern "C" fn activate_ep_files(dev: *mut dev_data) -> c_int {
    ...
    spin_unlock_irq (&dev.lock);
    destroy_ep_files (dev);
    gadget.ep0.driver_data = core::ptr::null_mut();
...
// preallocate control response and buffer
    ...
    if (!dev.req)
    goto enomem;
    dev.req.context = core::ptr::null_mut();
...
//
    ...
    return value;
    fail:
    dev.config = core::ptr::null_mut();
    dev.hs_config = core::ptr::null_mut();
    dev.dev = core::ptr::null_mut();
    spin_unlock_irq (&dev.lock);
...
//
    ...
    let mut default_perm: static unsigned = S_IRUSR | S_IWUSR;
...
// root inode
    ...
    core::ptr::null_mut(), &simple_dir_operations,
...
#[no_mangle]
unsafe extern "C" fn gadgetfs_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gadgetfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
// ----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn gadgetfs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gadgetfs_cleanup() -> void __exit {
