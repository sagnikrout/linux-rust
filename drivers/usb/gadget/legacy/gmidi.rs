...
//! Source: drivers/usb/gadget/legacy/gmidi.c
#![no_std]
...
// -------------------------------------------------------------------------
    ...
    let mut buflen: static unsigned int = 512;
    module_param(buflen, uint, S_IRUGO);
    MODULE_PARM_DESC(buflen, "MIDI buffer length");
    let mut qlen: static unsigned int = 32;
    module_param(qlen, uint, S_IRUGO);
    MODULE_PARM_DESC(qlen, "USB read and write request queue length");
    let mut in_ports: static unsigned int = 1;
    module_param(in_ports, uint, S_IRUGO);
    MODULE_PARM_DESC(in_ports, "Number of MIDI input ports");
    let mut out_ports: static unsigned int = 1;
...
//
pub const DRIVER_VENDOR_NUM: c_uint = 0x17b3		/* Grey Innovation */;
pub const DRIVER_PRODUCT_NUM: c_uint = 0x0004		/* Linux-USB "MIDI Gadget" */;
...
#[no_mangle]
unsafe extern "C" fn midi_unbind(dev: *mut usb_composite_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn midi_bind_config(c: *mut usb_configuration) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn midi_bind(cdev: *mut usb_composite_dev) -> c_int {
