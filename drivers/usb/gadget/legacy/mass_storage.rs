...
//! Source: drivers/usb/gadget/legacy/mass_storage.c
#![no_std]
...
//
pub const FSG_VENDOR_ID: c_uint = 0x0525	/* NetChip */;
pub const FSG_PRODUCT_ID: c_uint = 0xa4a5	/* Linux-USB File-backed Storage Gadget */;
...
#[no_mangle]
unsafe extern "C" fn msg_do_config(c: *mut usb_configuration) -> c_int {
...
// Gadget Bind
#[no_mangle]
unsafe extern "C" fn msg_bind(cdev: *mut usb_composite_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msg_unbind(cdev: *mut usb_composite_dev) -> c_int {
