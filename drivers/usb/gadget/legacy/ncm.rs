...
//! Source: drivers/usb/gadget/legacy/ncm.c
#![no_std]
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ncm_do_config(c: *mut usb_configuration) -> c_int {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn gncm_bind(cdev: *mut usb_composite_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gncm_unbind(cdev: *mut usb_composite_dev) -> c_int {
