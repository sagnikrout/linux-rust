...
//! Source: drivers/usb/gadget/legacy/hid.c
#![no_std]
...
// -------------------------------------------------------------------------
pub const HIDG_VENDOR_NUM: c_uint = 0x0525	/* XXX NetChip */;
pub const HIDG_PRODUCT_NUM: c_uint = 0xa4ac	/* Linux-USB HID gadget */;
// -------------------------------------------------------------------------
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidg_func_node {
    pub fi: *mut usb_function_instance,
    pub f: *mut usb_function,
    pub node: list_head,
    pub func: *mut hidg_func_descriptor,
}
...
// Configurations
#[no_mangle]
unsafe extern "C" fn do_config(c: *mut usb_configuration) -> c_int {
...
// Gadget Bind
#[no_mangle]
unsafe extern "C" fn hid_bind(cdev: *mut usb_composite_dev) -> c_int {
    static int hid_bind(struct usb_composite_dev *cdev)
    {
    struct usb_gadget *gadget = cdev.gadget;
    struct hidg_func_node *n = core::ptr::null_mut(), *m, *iter_n;
...
#[no_mangle]
unsafe extern "C" fn hid_unbind(cdev: *mut usb_composite_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidg_plat_driver_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidg_plat_driver_remove(pdev: *mut platform_device) {
...
// Some noise
    ...
    MODULE_LICENSE("GPL");
#[no_mangle]
unsafe extern "C" fn hidg_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hidg_cleanup() -> void __exit {
