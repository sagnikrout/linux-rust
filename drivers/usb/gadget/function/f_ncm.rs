...
//! Source: drivers/usb/gadget/function/f_ncm.c
#![no_std]
...
pub const NCM_NDP_HDR_CRC: c_uint = 0x01000000;
...
pub struct f_ncm {
    ...
    pub ethaddr: [c_char; 14],
    pub notify: *mut usb_ep,
    pub notify_req: *mut usb_request,
    pub notify_state: u8,
    pub notify_count: core::sync::atomic::AtomicI32,
    pub is_open: bool,
    pub parser_opts: *const ndp_parser_opts,
    pub is_crc: bool,
    pub ndp_sign: u32,
//
...
// For multi-frame NDP TX
    pub skb_tx_data: *mut sk_buff,
    pub skb_tx_ndp: *mut sk_buff,
    pub ndp_dgram_count: u16,
    pub task_timer: hrtimer,
}
...
//
pub const NTB_DEFAULT_IN_SIZE: c_int = 16384;
pub const NTB_OUT_SIZE: c_int = 16384;
...
//
pub const TX_MAX_NUM_DPE: c_int = 32;
// Delay for the transmit to wait before sending an unfilled NTB frame.
pub const TX_TIMEOUT_NSECS: c_int = 300000;
//
...
//
pub const MAX_DATAGRAM_SIZE: c_int = 8000;
...
//
pub const NCM_STATUS_INTERVAL_MS: c_int = 32;
...
// string descriptors:
pub const STRING_CTRL_IDX: c_int = 0;
pub const STRING_MAC_IDX: c_int = 1;
pub const STRING_DATA_IDX: c_int = 2;
pub const STRING_IAD_IDX: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ndp_parser_opts {
    pub nth_sign: u32,
    pub ndp_sign: u32,
    pub nth_size: unsigned,
    pub ndp_size: unsigned,
    pub dpe_size: unsigned,
    pub ndplen_align: unsigned,
// sizes in u16 units
    pub /: *mut *mut unsigned dgram_item_len; / index or length,
    pub block_length: unsigned,
    pub ndp_index: unsigned,
    pub reserved1: unsigned,
    pub reserved2: unsigned,
    pub next_ndp_index: unsigned,
}
...
#[no_mangle]
pub unsafe extern "C" fn put_ncm(p: *mut __le16, size: unsigned, val: unsigned) {
...
#[no_mangle]
pub unsafe extern "C" fn get_ncm(p: *mut __le16, size: unsigned) -> unsigned {
...
// -------------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn ncm_reset_values(ncm: *mut f_ncm) {
...
//
#[no_mangle]
unsafe extern "C" fn ncm_do_notify(ncm: *mut f_ncm) {
...
//
#[no_mangle]
unsafe extern "C" fn ncm_notify(ncm: *mut f_ncm) {
...
#[no_mangle]
unsafe extern "C" fn ncm_notify_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn ncm_ep0out_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn ncm_setup(f: *mut usb_function, ctrl: *const usb_ctrlrequest) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncm_set_alt(f: *mut usb_function, intf: unsigned, alt: unsigned) -> c_int {
...
//
    ...
    ncm.port.out_ep)) {
    ncm.port.in_ep.desc = core::ptr::null_mut();
    ncm.port.out_ep.desc = core::ptr::null_mut();
    goto fail;
    }
    }
// TODO
...
//
#[no_mangle]
unsafe extern "C" fn ncm_get_alt(f: *mut usb_function, intf: unsigned) -> c_int {
    ...
    let mut ndp_align: c_int = le16_to_cpu(ntb_parameters.wNdpInAlignment);
    let mut dgram_idx_len: c_int = 2 * 2 * opts.dgram_item_len;
// Stop the timer
...
// Merge the skbs
    ...
    ncm.skb_tx_data = core::ptr::null_mut();
    }
...
// Copy NTB across.
    ...
    ncm.skb_tx_ndp = core::ptr::null_mut();
// Insert zero'd datagram.
    ...
    struct sk_buff	*skb2 = core::ptr::null_mut();
    if (skb) {
    let mut ncb_len: c_int = 0;
    __le16		*ntb_data;
    __le16		*ntb_ndp;
    int		dgram_pad;
    let mut max_size: unsigned = ncm.port.fixed_in_len;
    const struct ndp_parser_opts *opts = ncm.parser_opts;
    let mut ndp_align: c_int = le16_to_cpu(ntb_parameters.wNdpInAlignment);
    let mut div: c_int = le16_to_cpu(ntb_parameters.wNdpInDivisor);
    let mut rem: c_int = le16_to_cpu(ntb_parameters.wNdpInPayloadRemainder);
    let mut dgram_idx_len: c_int = 2 * 2 * opts.dgram_item_len;
...
//
#[no_mangle]
unsafe extern "C" fn ncm_tx_timeout(data: *mut hrtimer) -> enum hrtimer_restart {
...
//
    netdev.netdev_ops.ndo_start_xmit(core::ptr::null_mut(), netdev);
    }
    ...
    let mut ntb_max: unsigned = le32_to_cpu(ntb_parameters.dwNtbOutMaxSize);
    unsigned	frame_max;
    const struct ndp_parser_opts *opts = ncm.parser_opts;
    let mut crc_len: unsigned = ncm.is_crc ? sizeof(uint32_t) : 0;
    int		dgram_counter;
    let mut to_process: c_int = skb.len;
...
#[no_mangle]
unsafe extern "C" fn ncm_disable(f: *mut usb_function) {
    ...
    usb_ep_disable(ncm.notify);
    ncm.notify.desc = core::ptr::null_mut();
    }
    }
// -------------------------------------------------------------------------
//
...
//
#[no_mangle]
unsafe extern "C" fn ncm_open(geth: *mut gether) {
...
#[no_mangle]
unsafe extern "C" fn ncm_close(geth: *mut gether) {
...
#[no_mangle]
unsafe extern "C" fn ncm_bind(c: *mut usb_configuration, f: *mut usb_function) -> c_int {
    ...
    struct usb_ep		*ep;
    struct f_ncm_opts	*ncm_opts;
    struct usb_os_desc_table	*os_desc_table __free(kfree) = core::ptr::null_mut();
    struct net_device		*net __free(detach_gadget) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ncm_free_inst(f: *mut usb_function_instance) {
...
#[no_mangle]
unsafe extern "C" fn ncm_free(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn ncm_unbind(c: *mut usb_configuration, f: *mut usb_function) {
