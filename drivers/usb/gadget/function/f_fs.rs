...
//! Source: drivers/usb/gadget/function/f_fs.c
#![no_std]
...
pub const FUNCTIONFS_MAGIC: c_uint = 0xa647361 /* Chosen by a honest dice roll ;) */;

pub const DMABUF_ENQUEUE_TIMEOUT_MS: c_int = 5000;
...
#[no_mangle]
unsafe extern "C" fn ffs_data_new(dev_name: *const c_char) -> *mut ffs_data __must_check {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ffs_function {
    pub conf: *mut usb_configuration,
    pub gadget: *mut usb_gadget,
    pub ffs: *mut ffs_data,
    pub eps: *mut ffs_ep,
    pub eps_revmap: [u8; 16],
    pub interfaces_nums: *mut c_short,
    pub function: usb_function,
    pub cur_alt: [c_int; MAX_CONFIG_INTERFACES],
}
...
#[derive(Copy, Clone)]
pub struct ffs_ep {
    pub /: *mut *mut *mut usb_ep ep; / P: ffs->eps_lock,
    pub /: *mut *mut *mut usb_request req; / P: epfile->mutex,
// [0]: full speed, [1]: high speed, [2]: super speed
    pub descs: [*mut usb_endpoint_descriptor; 3],
    pub num: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ffs_dmabuf_priv {
    pub entry: list_head,
    pub ref: kref,
    pub ffs: *mut ffs_data,
    ...
    pub lock: spinlock_t,
    pub context: u64,
    pub /: *mut *mut *mut usb_request req; / P: ffs->eps_lock,
    pub /: *mut *mut *mut usb_ep ep; / P: ffs->eps_lock,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ffs_dma_fence {
    pub base: dma_fence,
    pub priv: *mut ffs_dmabuf_priv,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ffs_epfile {
// Protects ep->ep and ep->req.
    pub mutex: mutex,
    pub ffs: *mut ffs_data,
    pub /: *mut *mut *mut ffs_ep ep; / P: ffs->eps_lock,
    pub /: *mut *mut *mut ffs_epfile epfile_in; / P: ffs->eps_lock,
    pub /: *mut *mut *mut ffs_epfile epfile_out; / P: ffs->eps_lock,
//
...
//
    pub read_buffer: *mut ffs_buffer,
    pub name: [c_char; 8],
    pub /: *mut *mut unsigned char in; / P: ffs->eps_lock,
    pub /: *mut *mut unsigned char isoc; / P: ffs->eps_lock,
    pub /: *mut *mut u8 zlp_enabled; / P: ffs->eps_lock,
    pub is_rw_proxy: bool,
// Protects dmabufs
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ffs_buffer {
    pub length: usize,
    pub data: *mut c_char,
    pub __counted_by(length): char storage[],
}

// ffs_io_data structure
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ffs_io_data {
    pub aio: bool,
    pub read: bool,
    pub kiocb: *mut kiocb,
    pub data: iov_iter,
    pub to_free: *const c_void,
    pub buf: *mut c_char,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ffs_desc_helper {
    pub ffs: *mut ffs_data,
    pub interfaces_count: unsigned,
    pub eps_count: unsigned,
}
...
#[no_mangle]
unsafe extern "C" fn ffs_mutex_lock(mutex: *mut mutex, nonblock: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ffs_ep0_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn __ffs_ep0_queue_wait(ffs: *mut ffs_data, data: *mut c_char, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ffs_ep0_stall(ffs: *mut ffs_data) -> c_int {
...
//
    ...
    let mut size: usize = n * sizeof *events;
...
#[no_mangle]
unsafe extern "C" fn ffs_ep0_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ffs_ep0_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ffs_ep0_ioctl(file: *mut file, code: unsigned, value: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn ffs_ep0_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
    static __poll_t ffs_ep0_poll(struct file *file, poll_table *wait)
    {
    struct ffs_data *ffs = file.private_data;
    let mut mask: __poll_t = EPOLLWRNORM;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ffs_epfile_io_complete(_ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn ffs_copy_to_iter(data: *mut c_void, data_len: c_int, iter: *mut iov_iter) -> isize {
    static ssize_t ffs_copy_to_iter(void *data, int data_len, struct iov_iter *iter)
    {
    let mut ret: isize = copy_to_iter(data, data_len, iter);
    if (ret == data_len)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn ffs_free_buffer(io_data: *mut ffs_io_data) {
...
#[no_mangle]
unsafe extern "C" fn ffs_user_copy_worker(work: *mut work_struct) {
    static void ffs_user_copy_worker(struct work_struct *work)
    {
    struct ffs_io_data *io_data = container_of(work, struct ffs_io_data,
    work);
    let mut ret: c_int = io_data.status;
    let mut kiocb_has_eventfd: bool = io_data.kiocb.ki_flags & IOCB_EVENTFD;
...
#[no_mangle]
unsafe extern "C" fn __ffs_epfile_read_buffer_free(epfile: *mut ffs_epfile) {
...
//
    struct ffs_buffer *buf = xchg(&epfile.read_buffer, core::ptr::null_mut());
    ssize_t ret;
    if (!buf || buf == READ_BUFFER_DROP)
    return 0;
    ...
    if (cmpxchg(&epfile.read_buffer, core::ptr::null_mut(), buf))
    kfree(buf);
    return ret;
    }
// Assumes epfile->mutex is held.
...
#[no_mangle]
unsafe extern "C" fn ffs_epfile_io(file: *mut file, io_data: *mut ffs_io_data) -> isize {
    ...
    int halt;
    let mut is_rw_proxy: bool = epfile.is_rw_proxy;
// Are we still active?
...
//
    ...
    ret = -EINTR;
#[no_mangle]
pub unsafe extern "C" fn if(0: io_data->read && io_data->status >) -> else {
...
#[no_mangle]
unsafe extern "C" fn ffs_aio_cancel(kiocb: *mut kiocb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ffs_epfile_write_iter(kiocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn ffs_epfile_read_iter(kiocb: *mut kiocb, to: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn ffs_dmabuf_release(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn ffs_dmabuf_get(attach: *mut dma_buf_attachment) {
...
#[no_mangle]
unsafe extern "C" fn ffs_dmabuf_put(attach: *mut dma_buf_attachment) {
...
#[no_mangle]
unsafe extern "C" fn ffs_dmabuf_cleanup(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ffs_dmabuf_signal_done(dma_fence: *mut ffs_dma_fence, ret: c_int) {
    static void ffs_dmabuf_signal_done(struct ffs_dma_fence *dma_fence, int ret)
    {
    struct ffs_dmabuf_priv *priv = dma_fence.priv;
    struct dma_fence *fence = &dma_fence.base;
    let mut cookie: bool = dma_fence_begin_signalling();
    dma_fence_get(fence);
    fence.error = ret;
...
#[no_mangle]
unsafe extern "C" fn ffs_dmabuf_fence_release(fence: *mut dma_fence) {
...
#[no_mangle]
unsafe extern "C" fn ffs_dma_resv_lock(dmabuf: *mut dma_buf, nonblock: bool) -> c_int {
    static int ffs_dma_resv_lock(struct dma_buf *dmabuf, bool nonblock)
    {
    if (!nonblock)
    return dma_resv_lock_interruptible(dmabuf.resv, core::ptr::null_mut());
    ...
    struct dma_buf_attachment *attach = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ffs_dmabuf_attach(file: *mut file, fd: c_int) -> c_int {
    static int ffs_dmabuf_attach(struct file *file, int fd)
    {
    let mut nonblock: bool = file.f_flags & O_NONBLOCK;
    struct ffs_epfile *epfile = file.private_data;
...
#[no_mangle]
unsafe extern "C" fn ffs_dmabuf_detach(file: *mut file, fd: c_int) -> c_int {
...
//
    ...
    inode = new_inode(sb);
    if (inode) {
    let mut ts: timespec64 = inode_set_ctime_current(inode);
...
// Create "regular" file
    ...
    struct inode	*inode;
    inode = ffs_sb_make_inode(sb, data, fops, core::ptr::null_mut(), &ffs.file_perms);
    if (!inode)
    return -ENOMEM;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ffs_sb_fill_data {
    pub perms: ffs_file_perms,
    pub root_mode: umode_t,
...
#[no_mangle]
unsafe extern "C" fn ffs_sb_fill(sb: *mut super_block, fc: *mut fs_context) -> c_int {
    ...
    ffs.sb              = sb;
    data.ffs_data       = core::ptr::null_mut();
    sb.s_fs_info        = ffs;
...
// Root inode
    ...
    inode = ffs_sb_make_inode(sb, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn ffs_fs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ffs_fs_get_tree(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ffs_fs_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn ffs_fs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn functionfs_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn functionfs_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn ffs_data_get(ffs: *mut ffs_data) {
    static void ffs_data_get(struct ffs_data *ffs)
    {
    refcount_inc(&ffs.ref);
    }
#[no_mangle]
unsafe extern "C" fn ffs_data_put(ffs: *mut ffs_data) {
    static void ffs_data_put(struct ffs_data *ffs)
    {
...
#[no_mangle]
unsafe extern "C" fn ffs_data_closed(ffs: *mut ffs_data) {
    static void ffs_data_closed(struct ffs_data *ffs)
    {
    spin_lock_irq(&ffs.eps_lock);
...
#[no_mangle]
unsafe extern "C" fn ffs_data_clear(ffs: *mut ffs_data) {
    static void ffs_data_clear(struct ffs_data *ffs)
    {
    struct ffs_epfile *epfiles;
    unsigned long flags;
...
//
    ...
    ffs.ffs_eventfd = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn ffs_data_reset(ffs: *mut ffs_data) {
    static void ffs_data_reset(struct ffs_data *ffs)
    {
    ffs_data_clear(ffs);
    spin_lock_irq(&ffs.eps_lock);
    ffs.raw_descs_data = core::ptr::null_mut();
    ffs.raw_descs = core::ptr::null_mut();
    ffs.raw_strings = core::ptr::null_mut();
    ffs.stringtabs = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn functionfs_bind(ffs: *mut ffs_data, cdev: *mut usb_composite_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn functionfs_unbind(ffs: *mut ffs_data) {
...
// dequeue before freeing ep0req
    ...
    ffs.ep0req = core::ptr::null_mut();
    ffs.gadget = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ffs_epfiles_create(ffs: *mut ffs_data) -> c_int {
    ...
    let mut ep1_in: bool = ffs.eps_addrmap[i + 1] & USB_ENDPOINT_DIR_MASK;
    comp.ffs = ffs;
...
#[no_mangle]
unsafe extern "C" fn clear_one(dentry: *mut dentry) {
    static void clear_one(struct dentry *dentry)
    {
    smp_store_release(&dentry.d_inode.i_private, core::ptr::null_mut());
    }
    static void ffs_epfiles_destroy(struct super_block *sb,
    struct ffs_epfile *epfiles, unsigned count)
    {
...
#[no_mangle]
unsafe extern "C" fn ffs_func_eps_disable(func: *mut ffs_function) {
    static void ffs_func_eps_disable(struct ffs_function *func)
    {
    struct ffs_ep *ep;
    struct ffs_epfile *epfile;
...
#[no_mangle]
unsafe extern "C" fn ffs_func_eps_enable(func: *mut ffs_function) -> c_int {
...
pub const __entity_check_INTERFACE(val): c_int = 1;
...
// We should never be here
    ...
    {
    let mut _len: unsigned = len;
    let mut num: c_ulong = 0;
    let mut current_class: c_int = -1;
    let mut current_subclass: c_int = -1;
    for (;;) {
    int ret;
    if (num == count)
    data = core::ptr::null_mut();
...
// Check if descriptors for any speed were already parsed
    ...
    {
    let mut bcd_version: u16 = le16_to_cpu(desc.bcdVersion);
    let mut w_index: u16 = le16_to_cpu(desc.wIndex);
    if (bcd_version == 0x1) {
...
// property name reported to the host as "WCHAR"s
    ...
    let mut os_descs_count: unsigned = 0, counts[3], flags;
...
// For each language
    ...
    let mut needed: unsigned = needed_count;
    let mut str_per_lang: u32 = str_count;
    if (len < 3)
    goto error_free;
...
// For each string
    ...
    let mut length: usize = strnlen(data, len);
    if (length == len)
    goto error_free;
//
...
// Discard everything other then power management.
    ...
    let mut n: unsigned = ffs.ev.count;
    for (; n; --n, ++ev)
...
#[no_mangle]
unsafe extern "C" fn ffs_ep_addr2idx(ffs: *mut ffs_data, endpoint_address: u8) -> c_int {
...
// Handled in previous pass by __ffs_func_bind_do_descs()
    ...
    let mut id: c_int = usb_interface_id(func.conf, &func.function);
    if (id < 0)
    return id;
...
//
    ...
    let mut full: c_int = !!func.ffs.fs_descs_count;
    let mut high: c_int = !!func.ffs.hs_descs_count;
    let mut super: c_int = !!func.ffs.ss_descs_count;
...
#[no_mangle]
unsafe extern "C" fn ffs_reset_work(work: *mut work_struct) {
    static void ffs_reset_work(struct work_struct *work)
    {
    ...
    {
    struct ffs_function *func = ffs_func_from_usb(f);
    let mut intf: c_int = ffs_func_revmap_intf(func, interface);
...
#[no_mangle]
unsafe extern "C" fn ffs_func_disable(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn ffs_func_suspend(f: *mut usb_function) {
    static void ffs_func_suspend(struct usb_function *f)
    {
    ffs_event_add(ffs_func_from_usb(f).ffs, FUNCTIONFS_SUSPEND);
    }
#[no_mangle]
unsafe extern "C" fn ffs_func_resume(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn ffs_func_revmap_ep(func: *mut ffs_function, num: u8) -> c_int {
    static int ffs_func_revmap_ep(struct ffs_function *func, u8 num)
    {
...
#[no_mangle]
unsafe extern "C" fn ffs_func_revmap_intf(func: *mut ffs_function, intf: u8) -> c_int {
    static int ffs_func_revmap_intf(struct ffs_function *func, u8 intf)
    {
    short *nums = func.interfaces_nums;
    let mut count: unsigned = func.ffs.interfaces_count;
...
#[no_mangle]
unsafe extern "C" fn f_fs_opts_ready_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn ffs_attr_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn ffs_free_inst(f: *mut usb_function_instance) {
...
#[no_mangle]
unsafe extern "C" fn ffs_set_inst_name(fi: *mut usb_function_instance, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ffs_free(f: *mut usb_function) {
    ...
    let mut count: unsigned = ffs.eps_count;
    unsigned long flags;
    if (ffs.func == func) {
...
// cleanup after autoconfig
    ...
    spin_unlock_irqrestore(&func.ffs.eps_lock, flags);
    kfree(func.eps);
    func.eps = core::ptr::null_mut();
//
// eps, descriptors and interfaces_nums are allocated in the
// same chunk so only one free is required.
//
    func.function.fs_descriptors = core::ptr::null_mut();
    func.function.hs_descriptors = core::ptr::null_mut();
    func.function.ss_descriptors = core::ptr::null_mut();
    func.function.ssp_descriptors = core::ptr::null_mut();
    func.interfaces_nums = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn ffs_name_dev(dev: *mut ffs_dev, name: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ffs_single_dev(dev: *mut ffs_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _ffs_free_dev(dev: *mut ffs_dev) {
    static void _ffs_free_dev(struct ffs_dev *dev)
    {
    list_del(&dev.entry);
    kfree(dev);
...
#[no_mangle]
unsafe extern "C" fn ffs_acquire_dev(dev_name: *const c_char, ffs_data: *mut ffs_data) -> c_int {
    static int ffs_acquire_dev(const char *dev_name, struct ffs_data *ffs_data)
    {
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ffs_release_dev(ffs_dev: *mut ffs_dev) {
    static void ffs_release_dev(struct ffs_dev *ffs_dev)
    {
    ffs_dev_lock();
    ...
    if (ffs_dev.ffs_data) {
    ffs_dev.ffs_data.private_data = core::ptr::null_mut();
    ffs_dev.ffs_data = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn ffs_ready(ffs: *mut ffs_data) -> c_int {
    static int ffs_ready(struct ffs_data *ffs)
    {
...
#[no_mangle]
unsafe extern "C" fn ffs_closed(ffs: *mut ffs_data) {
    static void ffs_closed(struct ffs_data *ffs)
    {
    struct ffs_dev *ffs_obj;
    struct f_fs_opts *opts;
