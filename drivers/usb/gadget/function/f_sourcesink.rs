...
//! Source: drivers/usb/gadget/function/f_sourcesink.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct f_sourcesink {
    pub function: usb_function,
    pub in_ep: *mut usb_ep,
    pub out_ep: *mut usb_ep,
    pub iso_in_ep: *mut usb_ep,
    pub iso_out_ep: *mut usb_ep,
    pub cur_alt: c_int,
...
pub const FS_ALT_IFC_1_OFFSET: c_int = 3;
    (struct usb_descriptor_header *) &fs_sink_desc,
    (struct usb_descriptor_header *) &fs_source_desc,
...
// high speed support:
    ...
    (struct usb_descriptor_header *) &source_sink_intf_alt1,
pub const HS_ALT_IFC_1_OFFSET: c_int = 3;
    (struct usb_descriptor_header *) &hs_source_desc,
    (struct usb_descriptor_header *) &hs_sink_desc,
...
// super speed support:
    ...
    (struct usb_descriptor_header *) &source_sink_intf_alt1,
pub const SS_ALT_IFC_1_OFFSET: c_int = 5;
    (struct usb_descriptor_header *) &ss_source_desc,
    (struct usb_descriptor_header *) &ss_source_comp_desc,
    (struct usb_descriptor_header *) &ss_sink_desc,
    (struct usb_descriptor_header *) &ss_sink_comp_desc,
...
// allocate iso endpoints
    ...
    ss.iso_in_ep = core::ptr::null_mut();
    no_iso:
//
...
// them and continue.
//
    fs_source_sink_descs[FS_ALT_IFC_1_OFFSET] = core::ptr::null_mut();
    hs_source_sink_descs[HS_ALT_IFC_1_OFFSET] = core::ptr::null_mut();
    ss_source_sink_descs[SS_ALT_IFC_1_OFFSET] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn check_read_data(ss: *mut f_sourcesink, req: *mut usb_request) -> c_int {
    static int check_read_data(struct f_sourcesink *ss, struct usb_request *req)
    {
    unsigned		i;
    u8			*buf = req.buf;
    struct usb_composite_dev *cdev = ss.function.config.cdev;
    let mut max_packet_size: c_int = le16_to_cpu(ss.out_ep.desc.wMaxPacketSize);
    if (ss.pattern == 2)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn reinit_write_data(ep: *mut usb_ep, req: *mut usb_request) {
    static void reinit_write_data(struct usb_ep *ep, struct usb_request *req)
    {
    unsigned	i;
    u8		*buf = req.buf;
    let mut max_packet_size: c_int = le16_to_cpu(ep.desc.wMaxPacketSize);
...
#[no_mangle]
unsafe extern "C" fn source_sink_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
pub unsafe extern "C" fn if(2: ss->pattern !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn disable_source_sink(ss: *mut f_sourcesink) {
    ...
    let mut speed: c_int = cdev.gadget.speed;
    struct usb_ep				*ep;
...
#[no_mangle]
unsafe extern "C" fn sourcesink_get_alt(f: *mut usb_function, intf: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sourcesink_disable(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn ss_attr_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn f_ss_opts_pattern_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn f_ss_opts_isoc_interval_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn f_ss_opts_isoc_maxpacket_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn f_ss_opts_isoc_mult_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn f_ss_opts_isoc_maxburst_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn f_ss_opts_bulk_maxburst_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn f_ss_opts_bulk_buflen_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn f_ss_opts_bulk_qlen_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn f_ss_opts_iso_qlen_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn source_sink_free_instance(fi: *mut usb_function_instance) {
...
#[no_mangle]
unsafe extern "C" fn sslb_modinit() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sslb_modexit() -> void __exit {
