...
//! Source: drivers/usb/gadget/function/f_ecm.c
#![no_std]
...
//
pub const ECM_STATUS_INTERVAL_MS: c_int = 32;
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ecm_do_notify(ecm: *mut f_ecm) {
...
#[no_mangle]
unsafe extern "C" fn ecm_notify(ecm: *mut f_ecm) {
...
#[no_mangle]
unsafe extern "C" fn ecm_notify_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn ecm_setup(f: *mut usb_function, ctrl: *const usb_ctrlrequest) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecm_set_alt(f: *mut usb_function, intf: unsigned, alt: unsigned) -> c_int {
...
// Data interface has two altsettings, 0 and 1
    ...
    ecm.port.out_ep)) {
    ecm.port.in_ep.desc = core::ptr::null_mut();
    ecm.port.out_ep.desc = core::ptr::null_mut();
    goto fail;
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn ecm_get_alt(f: *mut usb_function, intf: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecm_disable(f: *mut usb_function) {
    ...
    usb_ep_disable(ecm.notify);
    ecm.notify.desc = core::ptr::null_mut();
    }
// -------------------------------------------------------------------------
//
...
//
#[no_mangle]
unsafe extern "C" fn ecm_open(geth: *mut gether) {
...
#[no_mangle]
unsafe extern "C" fn ecm_close(geth: *mut gether) {
...
#[no_mangle]
unsafe extern "C" fn ecm_free_inst(f: *mut usb_function_instance) {
...
#[no_mangle]
unsafe extern "C" fn ecm_suspend(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn ecm_resume(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn ecm_get_status(f: *mut usb_function) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecm_free(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn ecm_unbind(c: *mut usb_configuration, f: *mut usb_function) {
