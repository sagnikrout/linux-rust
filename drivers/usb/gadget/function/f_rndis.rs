...
//! Source: drivers/usb/gadget/function/f_rndis.c
#![no_std]
...
pub struct f_rndis {
    ...
    pub ethaddr: [u8; ETH_ALEN],
    pub vendorID: u32,
    pub manufacturer: *const c_char,
    pub params: *mut rndis_params,
...
// -------------------------------------------------------------------------
//
pub const RNDIS_STATUS_INTERVAL_MS: c_int = 32;
...
#[no_mangle]
unsafe extern "C" fn rndis_response_available(_rndis: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rndis_response_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn rndis_command_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn rndis_set_alt(f: *mut usb_function, intf: unsigned, alt: unsigned) -> c_int {
...
// we know alt == 0
    ...
    rndis.port.out_ep)) {
    rndis.port.in_ep.desc = core::ptr::null_mut();
    rndis.port.out_ep.desc = core::ptr::null_mut();
    goto fail;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn rndis_disable(f: *mut usb_function) {
    ...
    gether_disconnect(&rndis.port);
    usb_ep_disable(rndis.notify);
    rndis.notify.desc = core::ptr::null_mut();
    }
// -------------------------------------------------------------------------
//
...
//
#[no_mangle]
unsafe extern "C" fn rndis_open(geth: *mut gether) {
...
#[no_mangle]
unsafe extern "C" fn rndis_close(geth: *mut gether) {
...
#[no_mangle]
pub unsafe extern "C" fn can_support_rndis(c: *mut usb_configuration) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn rndis_borrow_net(f: *mut usb_function_instance, net: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rndis_free_inst(f: *mut usb_function_instance) {
...
#[no_mangle]
unsafe extern "C" fn rndis_free(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn rndis_unbind(c: *mut usb_configuration, f: *mut usb_function) {
