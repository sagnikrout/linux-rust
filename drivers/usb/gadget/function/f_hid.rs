...
//! Source: drivers/usb/gadget/function/f_hid.c
#![no_std]
...
//
pub const GET_REPORT_TIMEOUT_MS: c_int = 2500;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct report_entry {
    pub report_data: usb_hidg_report,
    pub node: list_head,
}
...
//
    pub use_out_ep: bool,
// recv report
    pub read_spinlock: spinlock_t,
    pub read_queue: wait_queue_head_t,
    pub disabled: bool,
// recv report - interrupt out only (use_out_ep == 1)
    pub completed_out_req: list_head,
    pub qlen: c_uint,
// recv report - setup set_report only (use_out_ep == 0)
    pub set_report_buf: *mut c_char,
    pub set_report_length: c_uint,
// send report
    pub write_spinlock: spinlock_t,
    pub write_pending: bool,
    pub write_queue: wait_queue_head_t,
    pub req: *mut usb_request,
// get report
    pub get_req: *mut usb_request,
    pub get_report: usb_hidg_report,
    pub get_report_returned: bool,
    pub get_report_req_report_id: c_int,
    pub get_report_req_report_length: c_int,
    pub get_report_spinlock: spinlock_t,
    pub /: *mut *mut wait_queue_head_t get_queue; / Waiting for userspace response,
    pub /: *mut *mut wait_queue_head_t get_id_queue; / Get ID came in,
...
#[no_mangle]
unsafe extern "C" fn hidg_release(dev: *mut device) {
...
// -------------------------------------------------------------------------
// Strings
pub const CT_FUNC_HID_IDX: c_int = 0;
...
//
    ...
    {
    struct f_hidg *hidg = file.private_data;
    char *tmp_buf = core::ptr::null_mut();
    unsigned long flags;
    if (!count)
    return 0;
    spin_lock_irqsave(&hidg.read_spinlock, flags);
    ...
    hidg.set_report_buf = core::ptr::null_mut();
    spin_unlock_irqrestore(&hidg.read_spinlock, flags);
    if (tmp_buf != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn f_hidg_req_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
// write queue
    ...
    spin_unlock_irqrestore(&hidg.write_spinlock, flags);
    if (!req) {
    ERROR(hidg.func.config.cdev, "hidg.req is core::ptr::null_mut()\n");
    status = -ESHUTDOWN;
...
#[no_mangle]
unsafe extern "C" fn get_report_workqueue_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn f_hidg_get_report_id(file: *mut file, buffer: *mut __u8 __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f_hidg_get_report(file: *mut file, buffer: *mut usb_hidg_report __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f_hidg_ioctl(file: *mut file, code: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn f_hidg_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn f_hidg_release(inode: *mut inode, fd: *mut file) -> c_int {
    static int f_hidg_release(struct inode *inode, struct file *fd)
    {
    fd.private_data = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn f_hidg_open(inode: *mut inode, fd: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidg_intout_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn hidg_ssreport_complete(ep: *mut usb_ep, req: *mut usb_request) {
    static void hidg_ssreport_complete(struct usb_ep *ep, struct usb_request *req)
    {
    struct f_hidg *hidg = (struct f_hidg *)req.context;
    struct usb_composite_dev *cdev = hidg.func.config.cdev;
    char *new_buf = core::ptr::null_mut();
    unsigned long flags;
    if (req.status != 0 || req.buf == core::ptr::null_mut() || req.actual == 0) {
    ERROR(cdev,
...
#[no_mangle]
unsafe extern "C" fn hidg_get_report_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
//
    ...
    case HID_DT_HID:
    {
    let mut hidg_desc_copy: hid_descriptor = hidg_desc;
...
#[no_mangle]
unsafe extern "C" fn hidg_disable(f: *mut usb_function) {
    ...
    hidg.get_req = core::ptr::null_mut();
    hidg.get_report_returned = true;
    }
    spin_unlock_irqrestore(&hidg.get_report_spinlock, flags);
    spin_lock_irqsave(&hidg.read_spinlock, flags);
    ...
    hidg.req = core::ptr::null_mut();
    spin_unlock_irqrestore(&hidg.write_spinlock, flags);
    }
#[no_mangle]
unsafe extern "C" fn hidg_set_alt(f: *mut usb_function, intf: unsigned, alt: unsigned) -> c_int {
    static int hidg_set_alt(struct usb_function *f, unsigned intf, unsigned alt)
    {
    struct usb_composite_dev		*cdev = f.config.cdev;
    struct f_hidg				*hidg = func_to_hidg(f);
    struct usb_request			*req_in = core::ptr::null_mut();
    unsigned long				flags;
    int i, status = 0;
    VDBG(cdev, "hidg_set_alt intf:%d alt:%d\n", intf, alt);
    if (hidg.in_ep != core::ptr::null_mut()) {
// restart endpoint
    usb_ep_disable(hidg.in_ep);
    ...
    if (hidg.use_out_ep && hidg.out_ep != core::ptr::null_mut()) {
// restart endpoint
    usb_ep_disable(hidg.out_ep);
    status = config_ep_by_speed(f.config.cdev.gadget, f,
    hidg.out_ep);
...
#[no_mangle]
unsafe extern "C" fn hidg_bind(c: *mut usb_configuration, f: *mut usb_function) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hidg_get_minor() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_attr_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn f_hid_opts_report_desc_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn f_hid_opts_interval_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn f_hid_opts_dev_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn hidg_put_minor(minor: c_int) {
    static inline void hidg_put_minor(int minor)
    {
    ida_free(&hidg_ida, minor);
    }
#[no_mangle]
unsafe extern "C" fn hidg_free_inst(f: *mut usb_function_instance) {
    ...
    mutex_lock(&hidg_ida_lock);
    if (ida_is_empty(&hidg_ida)) {
    status = ghid_setup(core::ptr::null_mut(), HIDG_MINORS);
    if (status)  {
    ret = ERR_PTR(status);
    kfree(opts);
    goto unlock;
...
#[no_mangle]
unsafe extern "C" fn hidg_free(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn hidg_unbind(c: *mut usb_configuration, f: *mut usb_function) {
...
#[no_mangle]
pub unsafe extern "C" fn ghid_setup(g: *mut usb_gadget, count: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ghid_cleanup() {
