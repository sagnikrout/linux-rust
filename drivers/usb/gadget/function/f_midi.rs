...
//! Source: drivers/usb/gadget/function/f_midi.c
#![no_std]
...
pub struct f_midi {
    ...
    pub ms_id: u8,
    pub out_substream: [*mut snd_rawmidi_substream; MAX_PORTS],
    pub out_triggered: c_ulong,
    pub work: work_struct,
    pub in_ports: c_uint,
    pub out_ports: c_uint,
    pub index: c_int,
    pub id: *mut c_char,
    pub qlen: unsigned int buflen,,
// This fifo is used as a buffer ring for pre-allocated IN usb_requests
    pub ): *mut DECLARE_KFIFO_PTR(in_req_fifo, struct usb_request,
    pub transmit_lock: spinlock_t,
    pub in_last_port: c_uint,
    pub free_ref: c_uchar,
    pub __counted_by(in_ports): gmidi_in_port in_ports_array[],
}
...
pub const STRING_FUNC_IDX: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn f_midi_handle_out_data(ep: *mut usb_ep, req: *mut usb_request) {
    ...
    if (buf[i] != 0) {
    let mut cable: c_int = buf[i] >> 4;
    let mut length: c_int = f_midi_cin_length[buf[i] & 0x0f];
...
#[no_mangle]
unsafe extern "C" fn f_midi_drop_out_substreams(midi: *mut f_midi) {
...
#[no_mangle]
unsafe extern "C" fn f_midi_set_alt(f: *mut usb_function, intf: unsigned, alt: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f_midi_disable(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn f_midi_snd_free(device: *mut snd_device) -> c_int {
...
//
    ...
    let mut next_state: u8 = STATE_INITIAL;
    switch (b) {
    case 0xf8 ... 0xff:
...
// States where we have to write into the USB request
    ...
    port.state == STATE_REAL_TIME) {
    let mut length: c_uint = req.length;
...
#[no_mangle]
unsafe extern "C" fn f_midi_do_transmit(midi: *mut f_midi, ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f_midi_transmit(midi: *mut f_midi) {
    static void f_midi_transmit(struct f_midi *midi)
    {
...
#[no_mangle]
unsafe extern "C" fn f_midi_in_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn f_midi_in_open(substream: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f_midi_in_close(substream: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f_midi_in_trigger(substream: *mut snd_rawmidi_substream, up: c_int) {
...
#[no_mangle]
unsafe extern "C" fn f_midi_out_open(substream: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f_midi_out_close(substream: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f_midi_out_trigger(substream: *mut snd_rawmidi_substream, up: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn f_midi_unregister_card(midi: *mut f_midi) {
    static inline void f_midi_unregister_card(struct f_midi *midi)
    {
    if (midi.card) {
    snd_card_free(midi.card);
    midi.card = core::ptr::null_mut();
    }
    }
// register as a sound "card"
#[no_mangle]
unsafe extern "C" fn f_midi_register_card(midi: *mut f_midi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f_midi_bind(c: *mut usb_configuration, f: *mut usb_function) -> c_int {
...
// ... and add them to the list
    ...
    midi_function[i++] = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn midi_attr_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn f_midi_free_inst(f: *mut usb_function_instance) {
    static void f_midi_free_inst(struct usb_function_instance *f)
    {
    struct f_midi_opts *opts;
    ...
    opts.id = core::ptr::null_mut();
    opts.interface_string = core::ptr::null_mut();
    opts.buflen = 512;
    opts.qlen = 32;
    opts.in_ports = 1;
    opts.out_ports = 1;
...
#[no_mangle]
unsafe extern "C" fn f_midi_free(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn f_midi_rmidi_free(rmidi: *mut snd_rawmidi) {
    static void f_midi_rmidi_free(struct snd_rawmidi *rmidi)
    {
    f_midi_free(rmidi.private_data);
    }
#[no_mangle]
unsafe extern "C" fn f_midi_unbind(c: *mut usb_configuration, f: *mut usb_function) {
...
// just to be sure
    ...
    {
    struct f_midi *midi = core::ptr::null_mut();
    struct f_midi_opts *opts;
    int status, i;
