...
//! Source: drivers/usb/gadget/function/f_printer.c
#![no_std]
...
pub const PRINTER_MINORS: c_int = 4;
pub const GET_DEVICE_ID: c_int = 0;
pub const GET_PORT_STATUS: c_int = 1;
pub const SOFT_RESET: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct printer_dev {
    pub /: *mut *mut spinlock_t lock; / lock this structure,
// lock buffer lists during read/write calls
    pub lock_printer_io: mutex,
    pub gadget: *mut usb_gadget,
    pub interface: i8,
    pub out_ep: *mut *mut usb_ep in_ep,,
    pub kref: kref,
    pub /: *mut *mut list_head rx_reqs; / List of free RX structs,
    pub /: *mut *mut list_head rx_reqs_active; / List of Active RX xfers,
    pub /: *mut *mut list_head rx_buffers; / List of completed xfers,
// wait until there is data to be read.
    pub rx_wait: wait_queue_head_t,
    pub /: *mut *mut list_head tx_reqs; / List of free TX structs,
    pub /: *mut *mut list_head tx_reqs_active; / List of Active TX xfers,
// Wait until there are write buffers available to use.
    pub tx_wait: wait_queue_head_t,
// Wait until all write buffers have been sent.
    pub tx_flush_wait: wait_queue_head_t,
    pub current_rx_req: *mut usb_request,
    pub current_rx_bytes: usize,
    pub current_rx_buf: *mut u8,
    pub printer_status: u8,
    pub reset_printer: u8,
    pub minor: c_int,
    pub printer_cdev: cdev,
    pub printer_cdev_open: u8,
    pub wait: wait_queue_head_t,
    pub q_len: unsigned,
    pub /: *mut *mut *mut *mut char pnp_string; / We don't own memory!,
...
pub const USB_DESC_BUFSIZE: c_int = 256;
pub const USB_BUFSIZE: c_int = 8192;
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn printer_dev_free(kref: *mut kref) {
    ...
    {
    if (ep != core::ptr::null_mut() && req != core::ptr::null_mut()) {
    kfree(req.buf);
    usb_ep_free_request(ep, req);
    }
    }
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn rx_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn tx_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: list_empty(&req->list)) -> else {
...
// this dropped the lock - need to retest
    ...
    dev.current_rx_req = core::ptr::null_mut();
    dev.current_rx_bytes = 0;
    dev.current_rx_buf = core::ptr::null_mut();
...
//
    ...
    list_add(&current_rx_req.list, &dev.rx_reqs);
    current_rx_bytes = 0;
    current_rx_buf = core::ptr::null_mut();
    current_rx_req = core::ptr::null_mut();
    }
    }
    dev.current_rx_req = current_rx_req;
    dev.current_rx_bytes = current_rx_bytes;
...
// on error, disable any endpoints
    ...
    dev.in_ep.desc = core::ptr::null_mut();
    dev.out_ep.desc = core::ptr::null_mut();
    }
// caller is responsible for cleanup on error
    return result;
    }
#[no_mangle]
unsafe extern "C" fn printer_reset_interface(dev: *mut printer_dev) {
...
#[no_mangle]
unsafe extern "C" fn set_interface(dev: *mut printer_dev, number: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn printer_soft_reset(dev: *mut printer_dev) {
    ...
    if (dev.current_rx_req != core::ptr::null_mut()) {
...
// -------------------------------------------------------------------------
    ...
    let mut w_index: return = = dev.interface;
    }
//
...
//
    ...
    let mut wIndex: u16 = le16_to_cpu(ctrl.wIndex);
    let mut wValue: u16 = le16_to_cpu(ctrl.wValue);
    let mut wLength: u16 = le16_to_cpu(ctrl.wLength);
...
// host either stalls (value < 0) or reports success
    ...
    struct usb_ep *in_ep;
    struct usb_ep *out_ep = core::ptr::null_mut();
    struct usb_request *req;
    dev_t devt;
    int id;
    int ret;
...
// Setup the sysfs files for the printer gadget.
    ...
    pdev = device_create(&usb_gadget_class, core::ptr::null_mut(), devt,
    core::ptr::null_mut(), "g_printer%d", dev.minor);
    if (IS_ERR(pdev)) {
...
#[no_mangle]
unsafe extern "C" fn printer_func_disable(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn printer_attr_release(item: *mut config_item) {
...
#[no_mangle]
pub unsafe extern "C" fn gprinter_get_minor() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gprinter_put_minor(minor: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gprinter_free_inst(f: *mut usb_function_instance) {
...
#[no_mangle]
unsafe extern "C" fn gprinter_free(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn gprinter_setup(count: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gprinter_cleanup() {
    static void gprinter_cleanup(void)
    {
    if (major) {
