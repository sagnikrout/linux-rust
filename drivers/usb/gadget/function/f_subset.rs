...
//! Source: drivers/usb/gadget/function/f_subset.c
#![no_std]
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn geth_set_alt(f: *mut usb_function, intf: unsigned, alt: unsigned) -> c_int {
...
// we know alt == 0, so this is an activation or a reset
    ...
    geth.port.in_ep.desc = core::ptr::null_mut();
    geth.port.out_ep.desc = core::ptr::null_mut();
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn geth_disable(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn geth_free_inst(f: *mut usb_function_instance) {
...
#[no_mangle]
unsafe extern "C" fn geth_free(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn geth_unbind(c: *mut usb_configuration, f: *mut usb_function) {
