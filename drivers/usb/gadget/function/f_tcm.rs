...
//! Source: drivers/usb/gadget/function/f_tcm.c
#![no_std]
...
pub const TPG_INSTANCES: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpg_instance {
    pub func_inst: *mut usb_function_instance,
...
// Start bot.c code
#[no_mangle]
unsafe extern "C" fn bot_enqueue_cmd_cbw(fu: *mut f_uas) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bot_status_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn bot_enqueue_sense_code(fu: *mut f_uas, cmd: *mut usbg_cmd) {
...
#[no_mangle]
unsafe extern "C" fn bot_err_compl(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn bot_send_bad_status(cmd: *mut usbg_cmd) {
...
#[no_mangle]
unsafe extern "C" fn bot_send_status(cmd: *mut usbg_cmd, moved_data: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bot_send_status_response(cmd: *mut usbg_cmd) -> c_int {
    static int bot_send_status_response(struct usbg_cmd *cmd)
    {
    let mut moved_data: bool = false;
    if (!cmd.is_read)
    moved_data = true;
...
#[no_mangle]
unsafe extern "C" fn bot_read_compl(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn bot_send_read_response(cmd: *mut usbg_cmd) -> c_int {
    ...
    fu.bot_req_in.buf = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn bot_send_write_request(cmd: *mut usbg_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bot_cmd_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn bot_prepare_reqs(fu: *mut f_uas) -> c_int {
    ...
    err_queue:
    kfree(fu.cmd[0].buf);
    fu.cmd[0].buf = core::ptr::null_mut();
    err_buf:
    usb_ep_free_request(fu.ep_in, fu.bot_status.req);
    err_sts:
    usb_ep_free_request(fu.ep_out, fu.cmd[0].req);
    fu.cmd[0].req = core::ptr::null_mut();
    err_cmd:
    usb_ep_free_request(fu.ep_out, fu.bot_req_out);
    fu.bot_req_out = core::ptr::null_mut();
    err_out:
    usb_ep_free_request(fu.ep_in, fu.bot_req_in);
    fu.bot_req_in = core::ptr::null_mut();
    err:
    pr_err("BOT: endpoint setup failed\n");
    return -ENOMEM;
    }
#[no_mangle]
unsafe extern "C" fn bot_cleanup_old_alt(fu: *mut f_uas) {
    ...
    fu.bot_req_out = core::ptr::null_mut();
    fu.cmd[0].req = core::ptr::null_mut();
    fu.bot_status.req = core::ptr::null_mut();
    fu.cmd[0].buf = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn bot_set_alt(fu: *mut f_uas) {
...
// Start uas.c code
#[no_mangle]
unsafe extern "C" fn tcm_to_uasp_response(code: enum tcm_tmrsp_table) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uasp_to_tcm_func(code: c_int) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn uasp_cleanup_one_stream(fu: *mut f_uas, stream: *mut uas_stream) {
...
// We have either all three allocated or none
    ...
    stream.req_in = core::ptr::null_mut();
    stream.req_out = core::ptr::null_mut();
    stream.req_status = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn uasp_free_cmdreq(fu: *mut f_uas) {
    ...
    kfree(fu.cmd[i].buf);
    fu.cmd[i].req = core::ptr::null_mut();
    fu.cmd[i].buf = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn uasp_cleanup_old_alt(fu: *mut f_uas) {
...
#[no_mangle]
unsafe extern "C" fn uasp_prepare_r_request(cmd: *mut usbg_cmd) -> c_int {
    ...
    stream.req_in.buf = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn uasp_prepare_status(cmd: *mut usbg_cmd) {
...
#[no_mangle]
unsafe extern "C" fn uasp_prepare_response(cmd: *mut usbg_cmd) {
...
#[no_mangle]
unsafe extern "C" fn uasp_status_data_cmpl(ep: *mut usb_ep, req: *mut usb_request) {
    static void uasp_status_data_cmpl(struct usb_ep *ep, struct usb_request *req)
    {
    struct usbg_cmd *cmd = req.context;
    struct f_uas *fu = cmd.fu;
...
#[no_mangle]
unsafe extern "C" fn uasp_send_status_response(cmd: *mut usbg_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uasp_send_tm_response(cmd: *mut usbg_cmd) -> c_int {
    static int uasp_send_tm_response(struct usbg_cmd *cmd)
    {
    struct f_uas *fu = cmd.fu;
    struct uas_stream *stream = &fu.stream[cmd.se_cmd.map_tag];
...
#[no_mangle]
unsafe extern "C" fn uasp_send_read_response(cmd: *mut usbg_cmd) -> c_int {
    ...
    pr_err("%s(%d) => %d\n", __func__, __LINE__, ret);
    kfree(cmd.data_buf);
    cmd.data_buf = core::ptr::null_mut();
    }
    } else {
...
#[no_mangle]
unsafe extern "C" fn uasp_send_write_request(cmd: *mut usbg_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uasp_cmd_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn uasp_alloc_stream_res(fu: *mut f_uas, stream: *mut uas_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uasp_alloc_cmd(fu: *mut f_uas, i: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uasp_prepare_reqs(fu: *mut f_uas) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uasp_set_alt(fu: *mut f_uas) {
...
#[no_mangle]
unsafe extern "C" fn get_cmd_dir(cdb: *const c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbg_data_write_cmpl(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn usbg_prepare_w_request(cmd: *mut usbg_cmd, req: *mut usb_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbg_send_status_response(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbg_send_write_request(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbg_send_read_response(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbg_submit_tmr(cmd: *mut usbg_cmd) {
    static void usbg_submit_tmr(struct usbg_cmd *cmd)
    {
    struct se_session *se_sess;
    struct se_cmd *se_cmd;
    let mut flags: c_int = TARGET_SCF_ACK_KREF;
    se_cmd = &cmd.se_cmd;
    se_sess = cmd.fu.tpg.tpg_nexus.tvn_se_sess;
    target_submit_tmr(se_cmd, se_sess,
    cmd.response_iu.add_response_info,
    cmd.unpacked_lun, core::ptr::null_mut(), uasp_to_tcm_func(cmd.tmr_func),
    GFP_ATOMIC, cmd.tag, flags);
    }
#[no_mangle]
unsafe extern "C" fn usbg_submit_cmd(cmd: *mut usbg_cmd) {
...
//
    ...
    cmd.unpacked_lun, core::ptr::null_mut());
    transport_send_check_condition_and_sense(se_cmd,
    TCM_UNSUPPORTED_SCSI_OPCODE, 0);
    }
#[no_mangle]
unsafe extern "C" fn usbg_cmd_work(work: *mut work_struct) {
...
//
    ...
    struct f_uas *fu = cmd.fu;
    struct se_session *se_sess;
    struct uas_stream *stream = core::ptr::null_mut();
    struct hlist_node *tmp;
    struct usbg_cmd *active_cmd = core::ptr::null_mut();
    se_sess = cmd.fu.tpg.tpg_nexus.tvn_se_sess;
    hash_for_each_possible_safe(fu.stream_hash, stream, tmp, node, cmd.tag) {
    let mut i: c_int = stream - &fu.stream[0];
...
#[no_mangle]
unsafe extern "C" fn usbg_submit_command(fu: *mut f_uas, req: *mut usb_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bot_cmd_work(work: *mut work_struct) {
...
// Start fabric.c code
#[no_mangle]
unsafe extern "C" fn usbg_check_true(se_tpg: *mut se_portal_group) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbg_get_tag(se_tpg: *mut se_portal_group) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn usbg_release_cmd(se_cmd: *mut se_cmd) {
    static void usbg_release_cmd(struct se_cmd *se_cmd)
    {
    struct usbg_cmd *cmd = container_of(se_cmd, struct usbg_cmd,
    se_cmd);
...
#[no_mangle]
unsafe extern "C" fn usbg_queue_tm_rsp(se_cmd: *mut se_cmd) {
...
#[no_mangle]
unsafe extern "C" fn usbg_aborted_task(se_cmd: *mut se_cmd) {
    static void usbg_aborted_task(struct se_cmd *se_cmd)
    {
    struct usbg_cmd *cmd = container_of(se_cmd, struct usbg_cmd, se_cmd);
    struct f_uas *fu = cmd.fu;
...
#[no_mangle]
pub unsafe extern "C" fn if(-EINPROGRESS: stream->req_in->status ==) -> else {
    else if (stream.req_in.status == -EINPROGRESS)
    ret = usb_ep_dequeue(fu.ep_in, stream.req_in);
#[no_mangle]
pub unsafe extern "C" fn if(-EINPROGRESS: stream->req_status->status ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn usbg_init_nodeacl(se_nacl: *mut se_node_acl, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbg_drop_tpg(se_tpg: *mut se_portal_group) {
    ...
    break;
    if (i < TPG_INSTANCES) {
    tpg_instances[i].tpg = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn usbg_drop_tport(wwn: *mut se_wwn) {
...
//
#[no_mangle]
unsafe extern "C" fn usbg_wwn_version_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn usbg_enable_tpg(se_tpg: *mut se_portal_group, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcm_usbg_tpg_nexus_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tcm_usbg_make_nexus(tpg: *mut usbg_tpg, name: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcm_usbg_drop_nexus(tpg: *mut usbg_tpg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbg_port_link(se_tpg: *mut se_portal_group, lun: *mut se_lun) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbg_check_stop_free(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcm_bind(c: *mut usb_configuration, f: *mut usb_function) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcm_cleanup_old_alt(fu: *mut f_uas) {
    static void tcm_cleanup_old_alt(struct f_uas *fu)
    {
    if (fu.flags & USBG_IS_UAS)
    uasp_cleanup_old_alt(fu);
#[no_mangle]
pub unsafe extern "C" fn if(USBG_IS_BOT: fu->flags &) -> else {
    else if (fu.flags & USBG_IS_BOT)
    bot_cleanup_old_alt(fu);
    fu.flags = 0;
    }
#[no_mangle]
unsafe extern "C" fn tcm_delayed_set_alt_done(fu: *mut f_uas) {
...
#[no_mangle]
unsafe extern "C" fn tcm_delayed_set_alt_cancelled(fu: *mut f_uas) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcm_complete_delayed_status(fu: *mut f_uas) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcm_cancel_delayed_set_alt(fu: *mut f_uas) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcm_cancel_delayed_set_alt_sync(fu: *mut f_uas) {
...
#[no_mangle]
unsafe extern "C" fn tcm_delayed_set_alt(wq: *mut work_struct) {
    ...
    bot_set_alt(fu);
#[no_mangle]
pub unsafe extern "C" fn if(USB_G_ALT_INT_UAS: alt ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn tcm_get_alt(f: *mut usb_function, intf: unsigned) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(USBG_IS_UAS: fu->flags &) -> else {
    else if (fu.flags & USBG_IS_UAS)
    return USB_G_ALT_INT_UAS;
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn tcm_set_alt(f: *mut usb_function, intf: unsigned, alt: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcm_disable(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn tcm_attr_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn tcm_free_inst(f: *mut usb_function_instance) {
    ...
    break;
    if (i < TPG_INSTANCES)
    tpg_instances[i].func_inst = core::ptr::null_mut();
    mutex_unlock(&tpg_instances_lock);
    kfree(opts);
    }
#[no_mangle]
unsafe extern "C" fn tcm_register_callback(f: *mut usb_function_instance) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcm_unregister_callback(f: *mut usb_function_instance) {
...
#[no_mangle]
unsafe extern "C" fn usbg_attach(tpg: *mut usbg_tpg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbg_detach(tpg: *mut usbg_tpg) {
...
#[no_mangle]
unsafe extern "C" fn tcm_set_name(f: *mut usb_function_instance, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcm_free(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn tcm_unbind(c: *mut usb_configuration, f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn tcm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tcm_exit() -> void __exit {
