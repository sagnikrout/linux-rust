...
//! Source: drivers/usb/gadget/function/f_eem.c
#![no_std]
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn eem_setup(f: *mut usb_function, ctrl: *const usb_ctrlrequest) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eem_set_alt(f: *mut usb_function, intf: unsigned, alt: unsigned) -> c_int {
...
// we know alt == 0, so this is an activation or a reset
    ...
    eem.port.out_ep)) {
    eem.port.in_ep.desc = core::ptr::null_mut();
    eem.port.out_ep.desc = core::ptr::null_mut();
    goto fail;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn eem_disable(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn eem_bind(c: *mut usb_configuration, f: *mut usb_function) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eem_cmd_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn eem_free_inst(f: *mut usb_function_instance) {
...
#[no_mangle]
unsafe extern "C" fn eem_free(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn eem_unbind(c: *mut usb_configuration, f: *mut usb_function) {
