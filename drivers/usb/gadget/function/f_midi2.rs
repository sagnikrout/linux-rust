...
//! Source: drivers/usb/gadget/function/f_midi2.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct f_midi2_req_ctx {
    pub /: *mut *mut *mut f_midi2_usb_ep usb_ep; / belonging USB EP,
    pub /: *mut *mut unsigned int index; / array index: 0-31,
    pub /: *mut *mut *mut usb_request req; / assigned request,
}

// Resources for a USB Endpoint
#[repr(C)]
#[derive(Copy, Clone)]
pub struct f_midi2_usb_ep {
    pub /: *mut *mut *mut f_midi2 card; / belonging card,
    pub /: *mut *mut *mut f_midi2_ep ep; / belonging UMP EP (optional),
    pub /: *mut *mut *mut usb_ep usb_ep; / assigned USB EP,
    pub req): *mut *mut *mut void (complete)(struct usb_ep usb_ep, struct usb_request,
    pub /: *mut *mut unsigned long free_reqs; / bitmap for unused requests,
    pub /: *mut *mut unsigned int num_reqs; / number of allocated requests,
    pub /: *mut *mut *mut f_midi2_req_ctx reqs; / request context array,
}

// Resources for UMP Function Block (and USB Group Terminal Block)
#[repr(C)]
#[derive(Copy, Clone)]
pub struct f_midi2_block {
    pub /: *mut *mut f_midi2_block_info info; / FB info, copied from configfs,
    pub /: *mut *mut *mut snd_ump_block fb; / assigned FB,
    pub /: *mut *mut unsigned int gtb_id; / assigned GTB id,
    pub /: *mut *mut unsigned int string_id; / assigned string id,
}

// Temporary buffer for altset 0 MIDI 1.0 handling
#[repr(C)]
#[derive(Copy, Clone)]
pub struct f_midi2_midi1_port {
    pub /: *mut *mut unsigned int pending; / pending bytes on the input buffer,
    pub /: *mut *mut u8 buf[32]; / raw MIDI 1.0 byte input,
    pub /: *mut *mut u8 state; / running status,
    pub /: *mut *mut u8 data[2]; / rendered USB MIDI 1.0 packet data,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct f_midi2_ep {
    pub /: *mut *mut *mut snd_ump_endpoint ump; / assigned UMP EP,
    pub /: *mut *mut *mut f_midi2 card; / belonging MIDI 2.0 device,
    pub /: *mut *mut f_midi2_ep_info info; / UMP EP info, copied from configfs,
    pub /: *mut *mut unsigned int num_blks; / number of FBs,
    pub /: *mut *mut f_midi2_block blks[SNDRV_UMP_MAX_BLOCKS]; / UMP FBs,
    pub /: *mut *mut f_midi2_usb_ep ep_in; / USB MIDI EP-in,
    pub /: *mut *mut f_midi2_usb_ep ep_out; / USB MIDI EP-out,
    pub /: *mut *mut u8 in_group_to_cable[SNDRV_UMP_MAX_GROUPS]; / map to cable; 1-based!,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct midi1_cable_mapping {
    pub ep: *mut f_midi2_ep,
    pub block: c_uchar,
    pub group: c_uchar,
}
...
// MIDI 1.0 in/out USB EPs
    pub midi1_ep_in: f_midi2_usb_ep,
    pub midi1_ep_out: f_midi2_usb_ep,
// number of MIDI 1.0 I/O cables
    pub num_midi1_in: c_uint,
    pub num_midi1_out: c_uint,
// conversion for MIDI 1.0 EP-in
    pub midi1_port: [f_midi2_midi1_port; MAX_CABLES],
// conversion for MIDI 1.0 EP-out
    pub midi1_ump_cvt: ump_cvt_to_ump,
// mapping between cables and UMP groups
    pub in_cable_mapping: [midi1_cable_mapping; MAX_CABLES],
    pub out_cable_mapping: [midi1_cable_mapping; MAX_CABLES],
    pub /: *mut *mut int midi_if; / USB MIDI interface number,
    pub /: *mut *mut int operation_mode; / current operation mode,
    pub queue_lock: spinlock_t,
    pub /: *mut *mut f_midi2_card_info info; / card info, copied from configfs,
    pub num_eps: c_uint,
    pub midi2_eps: [f_midi2_ep; MAX_UMP_EPS],
    pub /: *mut *mut unsigned int total_blocks; / total number of blocks of all EPs,
    pub string_defs: *mut usb_string,
...
pub const EP_MAX_PACKET_INT: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn put_empty_request(req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn queue_request_ep_raw(req: *mut usb_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn queue_request_ep_in(req: *mut usb_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reply_ep_in(ep: *mut f_midi2_ep, buf: *const c_void, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reply_ump_stream_ep_info(ep: *mut f_midi2_ep) {
...
#[no_mangle]
unsafe extern "C" fn reply_ump_stream_ep_device(ep: *mut f_midi2_ep) {
...
#[no_mangle]
unsafe extern "C" fn reply_ump_stream_ep_name(ep: *mut f_midi2_ep) {
...
#[no_mangle]
unsafe extern "C" fn reply_ump_stream_ep_pid(ep: *mut f_midi2_ep) {
...
#[no_mangle]
unsafe extern "C" fn reply_ump_stream_ep_config(ep: *mut f_midi2_ep) {
...
// Reply a UMP FB info
#[no_mangle]
unsafe extern "C" fn reply_ump_stream_fb_info(ep: *mut f_midi2_ep, blk: c_int) {
...
#[no_mangle]
unsafe extern "C" fn reply_ump_stream_fb_name(ep: *mut f_midi2_ep, blk: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn process_ump_stream_msg(ep: *mut f_midi2_ep, data: *const u32) {
...
#[no_mangle]
unsafe extern "C" fn process_ump(ep: *mut f_midi2_ep, req: *const usb_request) {
    static void process_ump(struct f_midi2_ep *ep, const struct usb_request *req)
    {
    const u32 *data = (u32 *)req.buf;
    let mut len: c_int = req.actual >> 2;
...
#[no_mangle]
unsafe extern "C" fn process_ump_transmit(ep: *mut f_midi2_ep) {
...
//
    ...
    let mut next_state: c_int = STATE_INITIAL;
...
#[no_mangle]
unsafe extern "C" fn process_midi1_transmit(midi2: *mut f_midi2) {
...
#[no_mangle]
unsafe extern "C" fn f_midi2_drop_reqs(usb_ep: *mut f_midi2_usb_ep) {
...
#[no_mangle]
unsafe extern "C" fn f_midi2_alloc_ep_reqs(usb_ep: *mut f_midi2_usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f_midi2_free_ep_reqs(usb_ep: *mut f_midi2_usb_ep) {
    ...
    usb_ep.reqs[i].req = core::ptr::null_mut();
    }
    }
// Initialize EP
...
// Free EP
#[no_mangle]
unsafe extern "C" fn f_midi2_free_ep(usb_ep: *mut f_midi2_usb_ep) {
    ...
    usb_ep.num_reqs = 0;
    usb_ep.free_reqs = 0;
    usb_ep.reqs = core::ptr::null_mut();
    }
// Queue requests for EP-out at start
#[no_mangle]
unsafe extern "C" fn f_midi2_queue_out_reqs(usb_ep: *mut f_midi2_usb_ep) {
...
#[no_mangle]
unsafe extern "C" fn f_midi2_get_alt(fn: *mut usb_function, intf: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ump_to_usb_dir(ump_dir: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn f_midi2_disable(fn: *mut usb_function) {
...
//
#[no_mangle]
unsafe extern "C" fn f_midi2_ump_open(ump: *mut snd_ump_endpoint, dir: c_int) -> c_int {
    static int f_midi2_ump_open(struct snd_ump_endpoint *ump, int dir)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn f_midi2_ump_close(ump: *mut snd_ump_endpoint, dir: c_int) {
    static void f_midi2_ump_close(struct snd_ump_endpoint *ump, int dir)
    {
    }
#[no_mangle]
unsafe extern "C" fn f_midi2_ump_trigger(ump: *mut snd_ump_endpoint, dir: c_int, up: c_int) {
...
#[no_mangle]
unsafe extern "C" fn f_midi2_ump_drain(ump: *mut snd_ump_endpoint, dir: c_int) {
...
#[no_mangle]
unsafe extern "C" fn f_midi2_create_card(midi2: *mut f_midi2) -> c_int {
    ...
    int i, id, blk, err;
    __be32 sw;
    err = snd_card_new(&midi2.gadget.dev, -1, core::ptr::null_mut(), THIS_MODULE, 0,
    &card);
    if (err < 0)
    return err;
    midi2.card = card;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct f_midi2_usb_config {
    pub list: *mut usb_descriptor_header,
    pub size: c_uint,
    pub alloc: c_uint,
// MIDI 1.0 jacks
    pub jack_id: unsigned char jack_in, jack_out,,
    pub jack_ins: [usb_midi_in_jack_descriptor; MAX_CABLES],
    pub jack_outs: [usb_midi_out_jack_descriptor_1; MAX_CABLES],
}

#[no_mangle]
unsafe extern "C" fn append_config(config: *mut f_midi2_usb_config, d: *mut c_void) -> c_int {
    ...
    config.size++;
    config.list[config.size] = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn append_configs(config: *mut f_midi2_usb_config, d: *mut c_void) -> c_int {
    ...
    let mut id: c_int = ++config.jack_id;
    int err;
    jack.bLength = 0x06;
...
#[no_mangle]
unsafe extern "C" fn f_midi2_free_usb_configs(config: *mut f_midi2_usb_config) {
...
#[no_mangle]
unsafe extern "C" fn f_midi2_init_midi2_ep_in(midi2: *mut f_midi2, index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f_midi2_init_midi2_ep_out(midi2: *mut f_midi2, index: c_int) -> c_int {
...
// allocate instance-specific endpoints
    ...
    status = f_midi2_init_ep(midi2, core::ptr::null_mut(), &midi2.midi1_ep_in,
    &midi2_midi1_ep_in_desc,
    ...
    status = f_midi2_init_ep(midi2, core::ptr::null_mut(), &midi2.midi1_ep_out,
    &midi2_midi1_ep_out_desc,
...
#[no_mangle]
unsafe extern "C" fn f_midi2_unbind(c: *mut usb_configuration, f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn make_name_string(s: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn f_midi2_block_opts_release(item: *mut config_item) {
...
// drop_item callback for a block
    ...
    block_opts.ep.blks[block_opts.id] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn f_midi2_ep_opts_release(item: *mut config_item) {
...
// drop_item callback for an EP
    ...
    mutex_lock(&ep_opts.opts.lock);
    ep_opts.opts.eps[ep_opts.index] = core::ptr::null_mut();
    mutex_unlock(&ep_opts.opts.lock);
    config_item_put(item);
    }
//
...
#[no_mangle]
unsafe extern "C" fn f_midi2_opts_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn f_midi2_free_inst(f: *mut usb_function_instance) {
...
#[no_mangle]
unsafe extern "C" fn do_f_midi2_free(midi2: *mut f_midi2, opts: *mut f_midi2_opts) {
...
#[no_mangle]
unsafe extern "C" fn f_midi2_free(f: *mut usb_function) {
...
//
#[no_mangle]
unsafe extern "C" fn verify_parameters(opts: *mut f_midi2_opts) -> c_int {
