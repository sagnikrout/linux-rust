...
//! Source: drivers/usb/gadget/function/f_phonet.c
#![no_std]
...
pub const MAXPACKET: c_int = 512;

// -------------------------------------------------------------------------
#[repr(C)]
#[derive(Copy, Clone)]
pub struct phonet_port {
    pub usb: *mut f_phonet,
    pub lock: spinlock_t,
}
...
pub struct f_phonet {
    ...
    pub out_reqv: [*mut usb_request; ],
}

    let mut phonet_rxq_size: static int = 17;
    static inline struct f_phonet *func_to_pn(struct usb_function *f)
    {
    return container_of(f, struct f_phonet, function);
    }
// -------------------------------------------------------------------------
pub const USB_CDC_SUBCLASS_PHONET: c_uint = 0xfe;
pub const USB_CDC_PHONET_TYPE: c_uint = 0xab;
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn pn_net_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pn_net_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pn_tx_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn pn_net_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn pn_net_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn pn_rx_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn __pn_reset(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn pn_set_alt(f: *mut usb_function, intf: unsigned, alt: unsigned) -> c_int {
...
// data intf (0: inactive, 1: active)
    ...
    fp.in_ep.desc = core::ptr::null_mut();
    fp.out_ep.desc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pn_get_alt(f: *mut usb_function, intf: unsigned) -> c_int {
    ...
    u8 alt;
    spin_lock(&port.lock);
    alt = port.usb != core::ptr::null_mut();
    spin_unlock(&port.lock);
    return alt;
    }
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn pn_disconnect(f: *mut usb_function) {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn pn_bind(c: *mut usb_configuration, f: *mut usb_function) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phonet_attr_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn f_phonet_ifname_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn phonet_free_inst(f: *mut usb_function_instance) {
...
#[no_mangle]
unsafe extern "C" fn phonet_free(f: *mut usb_function) {
...
#[no_mangle]
unsafe extern "C" fn pn_unbind(c: *mut usb_configuration, f: *mut usb_function) {
...
#[no_mangle]
pub unsafe extern "C" fn gphonet_set_gadget(net: *mut net_device, g: *mut usb_gadget) {
    void gphonet_set_gadget(struct net_device *net, struct usb_gadget *g)
    {
    SET_NETDEV_DEV(net, &g.dev);
    }
#[no_mangle]
pub unsafe extern "C" fn gphonet_register_netdev(net: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gphonet_cleanup(dev: *mut net_device) {
