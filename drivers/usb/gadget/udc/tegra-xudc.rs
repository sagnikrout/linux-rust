...
//! Source: drivers/usb/gadget/udc/tegra-xudc.c
#![no_std]
...
// XUSB_DEV registers
pub const DB: c_uint = 0x004;

pub const ERSTSZ: c_uint = 0x008;

pub const ERDPLO: c_uint = 0x020;

pub const ERDPHI: c_uint = 0x024;
pub const EREPLO: c_uint = 0x028;

pub const EREPHI: c_uint = 0x02c;
pub const CTRL: c_uint = 0x030;

pub const ST: c_uint = 0x034;

pub const RT_IMOD: c_uint = 0x038;

pub const PORTSC: c_uint = 0x03c;

pub const PORTSC_PLS_SHIFT: c_int = 5;

pub const PORTSC_PLS_U0: c_uint = 0x0;
pub const PORTSC_PLS_U2: c_uint = 0x2;
pub const PORTSC_PLS_U3: c_uint = 0x3;
pub const PORTSC_PLS_DISABLED: c_uint = 0x4;
pub const PORTSC_PLS_RXDETECT: c_uint = 0x5;
pub const PORTSC_PLS_INACTIVE: c_uint = 0x6;
pub const PORTSC_PLS_RESUME: c_uint = 0xf;

pub const PORTSC_PS_SHIFT: c_int = 10;

pub const PORTSC_PS_UNDEFINED: c_uint = 0x0;
pub const PORTSC_PS_FS: c_uint = 0x1;
pub const PORTSC_PS_LS: c_uint = 0x2;
pub const PORTSC_PS_HS: c_uint = 0x3;
pub const PORTSC_PS_SS: c_uint = 0x4;

    PORTSC_PLC | PORTSC_CEC)
pub const ECPLO: c_uint = 0x040;
pub const ECPHI: c_uint = 0x044;
pub const MFINDEX: c_uint = 0x048;
pub const MFINDEX_FRAME_SHIFT: c_int = 3;

pub const PORTPM: c_uint = 0x04c;

pub const PORTPM_L1S_DROP: c_uint = 0x0;
pub const PORTPM_L1S_ACCEPT: c_uint = 0x1;
pub const PORTPM_L1S_NYET: c_uint = 0x2;
pub const PORTPM_L1S_STALL: c_uint = 0x3;

pub const EP_HALT: c_uint = 0x050;
pub const EP_PAUSE: c_uint = 0x054;
pub const EP_RELOAD: c_uint = 0x058;
pub const EP_STCHG: c_uint = 0x05c;
pub const DEVNOTIF_LO: c_uint = 0x064;

pub const DEVNOTIF_LO_TYPE_FUNCTION_WAKE: c_uint = 0x1;
pub const DEVNOTIF_HI: c_uint = 0x068;
pub const PORTHALT: c_uint = 0x06c;

pub const PORT_TM: c_uint = 0x070;
pub const EP_THREAD_ACTIVE: c_uint = 0x074;
pub const EP_STOPPED: c_uint = 0x078;
pub const HSFSPI_COUNT0: c_uint = 0x100;
pub const HSFSPI_COUNT13: c_uint = 0x134;

    HSFSPI_COUNT13_U2_RESUME_K_DURATION_MASK)
pub const BLCG: c_uint = 0x840;
pub const SSPX_CORE_CNT0: c_uint = 0x610;

pub const SSPX_CORE_CNT30: c_uint = 0x688;

    SSPX_CORE_CNT30_LMPITP_TIMER_MASK)
pub const SSPX_CORE_CNT32: c_uint = 0x690;

    SSPX_CORE_CNT32_POLL_TBURST_MAX_MASK)
pub const SSPX_CORE_CNT56: c_uint = 0x6fc;

    SSPX_CORE_CNT56_SCD_BIT0_TRPT_MAX_MASK)
pub const SSPX_CORE_CNT57: c_uint = 0x700;

    SSPX_CORE_CNT57_SCD_BIT1_TRPT_MAX_MASK)
pub const SSPX_CORE_CNT65: c_uint = 0x720;

    SSPX_CORE_CNT65_TX_SCD_END_TRPT_MID_MASK)
pub const SSPX_CORE_CNT66: c_uint = 0x724;

    SSPX_CORE_CNT66_TX_SCD_BIT0_TRPT_MID_MASK)
pub const SSPX_CORE_CNT67: c_uint = 0x728;

    SSPX_CORE_CNT67_TX_SCD_BIT1_TRPT_MID_MASK)
pub const SSPX_CORE_CNT72: c_uint = 0x73c;

    SSPX_CORE_CNT72_SCD_LFPS_TIMEOUT_MASK)
pub const SSPX_CORE_PADCTL4: c_uint = 0x750;

    SSPX_CORE_PADCTL4_RXDAT_VLD_TIMEOUT_U3_MASK)

pub const BLCG_ALL: c_uint = 0x1ff;
pub const CFG_DEV_SSPI_XFER: c_uint = 0x858;

    CFG_DEV_SSPI_XFER_ACKTIMEOUT_MASK)
pub const CFG_DEV_FE: c_uint = 0x85c;

pub const CFG_DEV_FE_PORTREGSEL_SS_PI: c_int = 1;
pub const CFG_DEV_FE_PORTREGSEL_HSFS_PI: c_int = 2;

// FPCI registers
pub const XUSB_DEV_CFG_1: c_uint = 0x004;

pub const XUSB_DEV_CFG_4: c_uint = 0x010;

pub const XUSB_DEV_CFG_5: c_uint = 0x014;
// IPFS registers
pub const XUSB_DEV_CONFIGURATION_0: c_uint = 0x180;

pub const XUSB_DEV_INTR_MASK_0: c_uint = 0x188;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xudc_ep_context {
    pub info0: __le32,
    pub info1: __le32,
    pub deq_lo: __le32,
    pub deq_hi: __le32,
...
pub const EP_TYPE_INVALID: c_int = 0;
pub const EP_TYPE_ISOCH_OUT: c_int = 1;
pub const EP_TYPE_BULK_OUT: c_int = 2;
pub const EP_TYPE_INTERRUPT_OUT: c_int = 3;
pub const EP_TYPE_CONTROL: c_int = 4;
pub const EP_TYPE_ISCOH_IN: c_int = 5;
pub const EP_TYPE_BULK_IN: c_int = 6;
pub const EP_TYPE_INTERRUPT_IN: c_int = 7;
...
#[no_mangle]
pub unsafe extern "C" fn ep_ctx_read_deq_ptr(ctx: *mut tegra_xudc_ep_context) -> u64 {
...
pub const TRB_TYPE_RSVD: c_int = 0;
pub const TRB_TYPE_NORMAL: c_int = 1;
pub const TRB_TYPE_SETUP_STAGE: c_int = 2;
pub const TRB_TYPE_DATA_STAGE: c_int = 3;
pub const TRB_TYPE_STATUS_STAGE: c_int = 4;
pub const TRB_TYPE_ISOCH: c_int = 5;
pub const TRB_TYPE_LINK: c_int = 6;
pub const TRB_TYPE_TRANSFER_EVENT: c_int = 32;
pub const TRB_TYPE_PORT_STATUS_CHANGE_EVENT: c_int = 34;
pub const TRB_TYPE_STREAM: c_int = 48;
pub const TRB_TYPE_SETUP_PACKET_EVENT: c_int = 63;
pub const TRB_CMPL_CODE_INVALID: c_int = 0;
pub const TRB_CMPL_CODE_SUCCESS: c_int = 1;
pub const TRB_CMPL_CODE_DATA_BUFFER_ERR: c_int = 2;
pub const TRB_CMPL_CODE_BABBLE_DETECTED_ERR: c_int = 3;
pub const TRB_CMPL_CODE_USB_TRANS_ERR: c_int = 4;
pub const TRB_CMPL_CODE_TRB_ERR: c_int = 5;
pub const TRB_CMPL_CODE_STALL: c_int = 6;
pub const TRB_CMPL_CODE_INVALID_STREAM_TYPE_ERR: c_int = 10;
pub const TRB_CMPL_CODE_SHORT_PACKET: c_int = 13;
pub const TRB_CMPL_CODE_RING_UNDERRUN: c_int = 14;
pub const TRB_CMPL_CODE_RING_OVERRUN: c_int = 15;
pub const TRB_CMPL_CODE_EVENT_RING_FULL_ERR: c_int = 21;
pub const TRB_CMPL_CODE_STOPPED: c_int = 26;
pub const TRB_CMPL_CODE_ISOCH_BUFFER_OVERRUN: c_int = 31;
pub const TRB_CMPL_CODE_STREAM_NUMP_ERROR: c_int = 219;
pub const TRB_CMPL_CODE_PRIME_PIPE_RECEIVED: c_int = 220;
pub const TRB_CMPL_CODE_HOST_REJECTED: c_int = 221;
pub const TRB_CMPL_CODE_CTRL_DIR_ERR: c_int = 222;
pub const TRB_CMPL_CODE_CTRL_SEQNUM_ERR: c_int = 223;
...
#[no_mangle]
pub unsafe extern "C" fn trb_read_data_ptr(trb: *mut tegra_xudc_trb) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn trb_write_data_ptr(trb: *mut tegra_xudc_trb, addr: u64) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xudc_request {
    pub usb_req: usb_request,
    pub buf_queued: usize,
    pub trbs_queued: c_uint,
    pub trbs_needed: c_uint,
    pub need_zlp: bool,
    pub first_trb: *mut tegra_xudc_trb,
    pub last_trb: *mut tegra_xudc_trb,
    pub list: list_head,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xudc_ep {
    pub xudc: *mut tegra_xudc,
    pub usb_ep: usb_ep,
    pub index: c_uint,
    pub name: [c_char; 8],
    pub context: *mut tegra_xudc_ep_context,
pub const XUDC_TRANSFER_RING_SIZE: c_int = 64;
    pub transfer_ring: *mut tegra_xudc_trb,
    pub transfer_ring_phys: dma_addr_t,
    pub enq_ptr: c_uint,
    pub deq_ptr: c_uint,
    pub pcs: bool,
    pub ring_full: bool,
    pub stream_rejected: bool,
    pub queue: list_head,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xudc_sel_timing {
    pub u1sel: __u8,
    pub u1pel: __u8,
    pub u2sel: __le16,
    pub u2pel: __le16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xudc_setup_packet {
    pub ctrl_req: usb_ctrlrequest,
    pub seq_num: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xudc_save_regs {
    pub ctrl: u32,
    pub portpm: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xudc {
    pub dev: *mut device,
    pub soc: *const tegra_xudc_soc,
    pub padctl: *mut tegra_xusb_padctl,
    pub lock: spinlock_t,
    pub gadget: usb_gadget,
    pub driver: *mut usb_gadget_driver,
pub const XUDC_NR_EVENT_RINGS: c_int = 2;
pub const XUDC_EVENT_RING_SIZE: c_int = 4096;
    pub event_ring: [*mut tegra_xudc_trb; XUDC_NR_EVENT_RINGS],
    pub event_ring_phys: [dma_addr_t; XUDC_NR_EVENT_RINGS],
    pub event_ring_index: c_uint,
    pub event_ring_deq_ptr: c_uint,
    pub ccs: bool,
pub const XUDC_NR_EPS: c_int = 32;
    pub ep: [tegra_xudc_ep; XUDC_NR_EPS],
    pub ep_context: *mut tegra_xudc_ep_context,
    pub ep_context_phys: dma_addr_t,
    pub genpd_dev_device: *mut device,
    pub genpd_dev_ss: *mut device,
    pub genpd_dl_device: *mut device_link,
    pub genpd_dl_ss: *mut device_link,
    pub transfer_ring_pool: *mut dma_pool,
    pub queued_setup_packet: bool,
    pub setup_packet: tegra_xudc_setup_packet,
    pub setup_state: enum tegra_xudc_setup_state,
    pub setup_seq_num: u16,
    pub dev_addr: u16,
    pub isoch_delay: u16,
    pub sel_timing: tegra_xudc_sel_timing,
    pub test_mode_pattern: u8,
    pub status_buf: u16,
    pub ep0_req: *mut tegra_xudc_request,
    pub pullup: bool,
    pub nr_enabled_eps: c_uint,
    pub nr_isoch_eps: c_uint,
    pub device_state: c_uint,
    pub resume_state: c_uint,
    pub irq: c_int,
    pub base: *mut void __iomem,
    pub phys_base: resource_size_t,
    pub ipfs: *mut void __iomem,
    pub fpci: *mut void __iomem,
    pub supplies: *mut regulator_bulk_data,
    pub clks: *mut clk_bulk_data,
    pub device_mode: bool,
    pub current_device_mode: bool,
    pub usb_role_sw_work: work_struct,
    pub usb3_phy: *mut phy,
    pub curr_usb3_phy: *mut phy,
    pub utmi_phy: *mut phy,
    pub curr_utmi_phy: *mut phy,
    pub saved_regs: tegra_xudc_save_regs,
    pub suspended: bool,
    pub powergated: bool,
    pub usbphy: *mut usb_phy,
    pub curr_usbphy: *mut usb_phy,
    pub vbus_nb: notifier_block,
    pub disconnect_complete: completion,
    pub selfpowered: bool,
pub const TOGGLE_VBUS_WAIT_MS: c_int = 100;
    pub plc_reset_work: delayed_work,
    pub wait_csc: bool,
    pub port_reset_war_work: delayed_work,
    pub wait_for_sec_prc: bool,
}

pub const XUDC_TRB_MAX_BUFFER_SIZE: c_int = 65536;
pub const XUDC_MAX_ISOCH_EPS: c_int = 4;
pub const XUDC_INTERRUPT_MODERATION_US: c_int = 0;
...
pub struct tegra_xudc_soc {
    ...
    pub u2_enable: bool,
    pub lpm_enable: bool,
    pub invalid_seq_num: bool,
    pub pls_quirk: bool,
    pub port_reset_quirk: bool,
    pub port_speed_quirk: bool,
    pub has_ipfs: bool,
}

#[no_mangle]
pub unsafe extern "C" fn fpci_readl(xudc: *mut tegra_xudc, offset: c_uint) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ipfs_readl(xudc: *mut tegra_xudc, offset: c_uint) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn xudc_readl(xudc: *mut tegra_xudc, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_limit_port_speed(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_restore_port_speed(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_device_mode_on(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_device_mode_off(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_usb_role_sw_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_plc_reset_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_port_reset_war_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ep_reload(xudc: *mut tegra_xudc, ep: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ep_pause(xudc: *mut tegra_xudc, ep: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ep_unpause(xudc: *mut tegra_xudc, ep: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ep_unpause_all(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn ep_halt(xudc: *mut tegra_xudc, ep: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ep_unhalt(xudc: *mut tegra_xudc, ep: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ep_unhalt_all(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn ep_wait_for_stopped(xudc: *mut tegra_xudc, ep: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ep_wait_for_inactive(xudc: *mut tegra_xudc, ep: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_ep_nuke(ep: *mut tegra_xudc_ep, status: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ep_available_trbs(ep: *mut tegra_xudc_ep) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_ep_ring_doorbell(ep: *mut tegra_xudc_ep) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_ep_kick_queue(ep: *mut tegra_xudc_ep) {
    static void tegra_xudc_ep_kick_queue(struct tegra_xudc_ep *ep)
    {
    struct tegra_xudc_request *req;
    let mut trbs_queued: bool = false;
    ...
    req.first_trb = core::ptr::null_mut();
    req.last_trb = core::ptr::null_mut();
    req.buf_queued = 0;
    req.trbs_queued = 0;
    req.need_zlp = false;
    ...
    let mut pcs_enq: bool = trb_read_cycle(trb);
    bool pcs;
//
...
//
    ...
    {
    struct tegra_xudc *xudc = ep.xudc;
    struct tegra_xudc_request *r = core::ptr::null_mut(), *iter;
...
#[no_mangle]
unsafe extern "C" fn __tegra_xudc_ep_set_halt(ep: *mut tegra_xudc_ep, halt: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_ep_set_halt(usb_ep: *mut usb_ep, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_ep_context_setup(ep: *mut tegra_xudc_ep) {
...
#[no_mangle]
unsafe extern "C" fn __tegra_xudc_ep_disable(ep: *mut tegra_xudc_ep) -> c_int {
    ...
    if (usb_endpoint_xfer_isoc(ep.desc))
    xudc.nr_isoch_eps--;
    ep.desc = core::ptr::null_mut();
    ep.comp_desc = core::ptr::null_mut();
    memset(ep.context, 0, sizeof(*ep.context));
    ep_unpause(xudc, ep.index);
    ep_unhalt(xudc, ep.index);
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_ep_disable(usb_ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_ep0_disable(usb_ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_gadget_get_frame(gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_resume_device_state(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_gadget_wakeup(gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_gadget_pullup(gadget: *mut usb_gadget, is_on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_gadget_stop(gadget: *mut usb_gadget) -> c_int {
    ...
    for (i = 0; i < xudc.soc.num_phys; i++)
    if (xudc.usbphy[i])
    otg_set_peripheral(xudc.usbphy[i].otg, core::ptr::null_mut());
    val = xudc_readl(xudc, CTRL);
    val &= ~(CTRL_IE | CTRL_ENABLE);
    xudc_writel(xudc, val, CTRL);
    __tegra_xudc_ep_disable(&xudc.ep[0]);
    xudc.driver = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_set_selfpowered(gadget: *mut usb_gadget, is_on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn no_op_complete(ep: *mut usb_ep, req: *mut usb_request) {
    ...
    {
    xudc.ep0_req.usb_req.buf = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_ep0_req_done(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn set_feature_complete(ep: *mut usb_ep, req: *mut usb_request) {
    ...
    struct usb_ctrlrequest *ctrl)
    {
    let mut set: bool = (ctrl.bRequest == USB_REQ_SET_FEATURE);
    let mut feature: u32 = le16_to_cpu(ctrl.wValue);
    let mut index: u32 = le16_to_cpu(ctrl.wIndex);
    u32 val, ep;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn set_sel_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn set_isoch_delay_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
// Nothing to do with isoch delay
    ...
    struct usb_ctrlrequest *ctrl)
    {
    let mut delay: u32 = le16_to_cpu(ctrl.wValue);
    if (ctrl.bRequestType != (USB_DIR_OUT | USB_RECIP_DEVICE |
    USB_TYPE_STANDARD))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn set_address_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
//
    ...
    let mut seq_num: u16 = trb_read_seq_num(event);
...
//
    ...
    struct tegra_xudc_trb *event)
    {
    let mut ep_index: c_uint = trb_read_endpoint_id(event);
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_reset(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_port_connect(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_port_disconnect(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_port_reset(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_port_suspend(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_port_resume(xudc: *mut tegra_xudc) {
...
#[no_mangle]
pub unsafe extern "C" fn clear_port_change(xudc: *mut tegra_xudc, flag: u32) {
...
#[no_mangle]
unsafe extern "C" fn __tegra_xudc_handle_port_status(xudc: *mut tegra_xudc) {
...
pub const TOGGLE_VBUS_WAIT_MS: c_int = 100;
    ...
    let mut pls: u32 = (portsc & PORTSC_PLS_MASK) >> PORTSC_PLS_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_handle_port_status(xudc: *mut tegra_xudc) {
    ...
    struct tegra_xudc_trb *event)
    {
    let mut type: u32 = trb_read_type(event);
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_process_event_ring(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_alloc_ep(xudc: *mut tegra_xudc, index: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_free_ep(xudc: *mut tegra_xudc, index: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_alloc_eps(xudc: *mut tegra_xudc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_init_eps(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_free_eps(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_alloc_event_ring(xudc: *mut tegra_xudc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_init_event_ring(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_free_event_ring(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_fpci_ipfs_init(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_device_params_init(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_phy_get(xudc: *mut tegra_xudc) -> c_int {
    static int tegra_xudc_phy_get(struct tegra_xudc *xudc)
    {
    let mut err: c_int = 0, usb3_companion_port;
    unsigned int i, j;
...
// Get USB3 phy
    ...
    clean_up:
    for (i = 0; i < xudc.soc.num_phys; i++) {
    xudc.usb3_phy[i] = core::ptr::null_mut();
    xudc.utmi_phy[i] = core::ptr::null_mut();
    xudc.usbphy[i] = core::ptr::null_mut();
    }
    return err;
    }
#[no_mangle]
unsafe extern "C" fn tegra_xudc_phy_exit(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_phy_init(xudc: *mut tegra_xudc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_powerdomain_remove(xudc: *mut tegra_xudc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_powerdomain_init(xudc: *mut tegra_xudc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_powergate(xudc: *mut tegra_xudc) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_unpowergate(xudc: *mut tegra_xudc) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_xudc_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    tegra_xudc_runtime_resume, core::ptr::null_mut())
    };
