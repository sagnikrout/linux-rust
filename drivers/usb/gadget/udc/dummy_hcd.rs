...
//! Source: drivers/usb/gadget/udc/dummy_hcd.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dummy_hcd_module_parameters {
...
pub struct dummy_ep {
    pub queue: list_head,
    pub /: *mut *mut unsigned long last_io; / jiffies timestamp,
    ...
    pub stream_en:1: unsigned,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dummy_request {
...
pub struct urbp {
    pub urb: *mut urb,
    pub urbp_list: list_head,
    pub miter: sg_mapping_iter,
    pub miter_started: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dummy_hcd {
    pub dum: *mut dummy,
    pub rh_state: enum dummy_rh_state,
    pub timer: hrtimer,
    pub port_status: u32,
    pub old_status: u32,
    ...
    pub urbp_list: list_head,
    pub next_frame_urbp: *mut urbp,
    pub stream_en_ep: u32,
    pub 2]: u8 num_stream[30 /,
    pub timer_pending:1: unsigned,
    pub active:1: unsigned,
    pub old_active:1: unsigned,
...
//
    pub ep: [dummy_ep; DUMMY_ENDPOINTS],
    pub address: c_int,
    pub callback_usage: c_int,
    pub gadget: usb_gadget,
    pub driver: *mut usb_gadget_driver,
    pub fifo_req: dummy_request,
    pub fifo_buf: [u8; FIFO_SIZE],
    pub devstatus: u16,
    pub ints_enabled:1: unsigned,
    pub udc_suspended:1: unsigned,
    pub pullup:1: unsigned,
    pub fifo_req_busy:1: unsigned,
//
// HOST side support
//
    pub hs_hcd: *mut dummy_hcd,
    pub ss_hcd: *mut dummy_hcd,
}
...
//
    ...
    {
    let mut fifo: bool = req == &dum.fifo_req;
...
#[no_mangle]
unsafe extern "C" fn nuke(dum: *mut dummy, ep: *mut dummy_ep) {
...
#[no_mangle]
unsafe extern "C" fn stop_activity(dum: *mut dummy) {
...
//
#[no_mangle]
unsafe extern "C" fn set_link_state_by_speed(dum_hcd: *mut dummy_hcd) {
...
// caller must hold lock
#[no_mangle]
unsafe extern "C" fn set_link_state(dum_hcd: *mut dummy_hcd) {
...
#[no_mangle]
pub unsafe extern "C" fn if(dum->driver->resume: !dum_hcd->old_active &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn dummy_disable(_ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_free_request(_ep: *mut usb_ep, _req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn fifo_complete(ep: *mut usb_ep, req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn dummy_dequeue(_ep: *mut usb_ep, _req: *mut usb_request) -> c_int {
    ...
    unsigned long		flags;
    struct dummy_request	*req = core::ptr::null_mut(), *iter;
    if (!_ep || !_req)
    return retval;
    ep = usb_ep_to_dummy_ep(_ep);
    dum = ep_to_dummy(ep);
...
#[no_mangle]
unsafe extern "C" fn dummy_set_wedge(_ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_g_get_frame(_gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_wakeup(_gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_set_selfpowered(_gadget: *mut usb_gadget, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_udc_update_ep0(dum: *mut dummy) {
...
#[no_mangle]
unsafe extern "C" fn dummy_pullup(_gadget: *mut usb_gadget, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_udc_async_callbacks(_gadget: *mut usb_gadget, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn dummy_udc_stop(g: *mut usb_gadget) -> c_int {
    static int dummy_udc_stop(struct usb_gadget *g)
    {
    struct dummy_hcd	*dum_hcd = gadget_to_dummy_hcd(g);
    struct dummy		*dum = dum_hcd.dum;
...
#[no_mangle]
unsafe extern "C" fn init_dummy_udc_hw(dum: *mut dummy) {
...
#[no_mangle]
unsafe extern "C" fn dummy_udc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: mod_data.is_high_speed) -> else {
...
#[no_mangle]
unsafe extern "C" fn dummy_udc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dummy_udc_suspend(pdev: *mut platform_device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_udc_resume(pdev: *mut platform_device) -> c_int {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn dummy_get_ep_idx(desc: *const usb_endpoint_descriptor) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn dummy_ep_stream_en(dum_hcd: *mut dummy_hcd, urb: *mut urb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_validate_stream(dum_hcd: *mut dummy_hcd, urb: *mut urb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_urb_dequeue(hcd: *mut usb_hcd, urb: *mut urb, status: c_int) -> c_int {
...
// so make sure the callback happens
    ...
    let mut flags: u32 = SG_MITER_ATOMIC;
    if (to_host)
...
#[no_mangle]
unsafe extern "C" fn periodic_bytes(dum: *mut dummy, ep: *mut dummy_ep) -> c_int {
    static int periodic_bytes(struct dummy *dum, struct dummy_ep *ep)
    {
    let mut limit: c_int = ep.ep.maxpacket;
...
//
#[no_mangle]
unsafe extern "C" fn dummy_timer(t: *mut hrtimer) -> enum hrtimer_restart {
...
// look at each urb queued by the host side driver
    ...
    dum_hcd.next_frame_urbp = core::ptr::null_mut();
    for (i = 0; i < DUMMY_ENDPOINTS; i++) {
    if (!ep_info[i].name)
    break;
    ...
    struct dummy_request	*req;
    u8			address;
    struct dummy_ep		*ep = core::ptr::null_mut();
...
// stop when we reach URBs queued after the timer interrupt
    ...
    goto return_urb;
#[no_mangle]
pub unsafe extern "C" fn if(DUMMY_RH_RUNNING: dum_hcd->rh_state !=) -> else {
...
// incomplete transfer?
    ...
    dum_hcd.udev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dummy_hub_status(hcd: *mut usb_hcd, buf: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hub_descriptor(desc: *mut usb_hub_descriptor) {
...
#[no_mangle]
unsafe extern "C" fn dummy_bus_suspend(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_bus_resume(hcd: *mut usb_hcd) -> c_int {
...
// -------------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn show_urb(buf: *mut c_char, size: usize, urb: *mut urb) -> isize {
    static inline ssize_t show_urb(char *buf, size_t size, struct urb *urb)
    {
    let mut ep: c_int = usb_pipeendpoint(urb.pipe);
...
#[no_mangle]
unsafe extern "C" fn dummy_start_ss(dum_hcd: *mut dummy_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_start(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_stop(hcd: *mut usb_hcd) {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn dummy_h_get_frame(hcd: *mut usb_hcd) -> c_int {
    static int dummy_h_get_frame(struct usb_hcd *hcd)
    {
    return dummy_g_get_frame(core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn dummy_setup(hcd: *mut usb_hcd) -> c_int {
...
// Change a group of bulk endpoints to support multiple stream IDs
    ...
    unsigned long flags;
    int max_stream;
    let mut ret_streams: c_int = num_streams;
    unsigned int index;
    unsigned int i;
    if (!num_eps)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn dummy_hcd_probe(pdev: *mut platform_device) -> c_int {
...
pub unsafe extern "C" fn if(_arg: mod_data.is_high_speed) -> else {
    ...
    put_usb2_hcd:
    usb_put_hcd(hs_hcd);
    dum.hs_hcd = dum.ss_hcd = core::ptr::null_mut();
    return retval;
    }
#[no_mangle]
unsafe extern "C" fn dummy_hcd_remove(pdev: *mut platform_device) {
    ...
    dum.hs_hcd = core::ptr::null_mut();
    dum.ss_hcd = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn dummy_hcd_suspend(pdev: *mut platform_device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_hcd_resume(pdev: *mut platform_device) -> c_int {
...
// -------------------------------------------------------------------------
pub const MAX_NUM_UDC: c_int = 32;
    static struct platform_device *the_udc_pdev[MAX_NUM_UDC];
    static struct platform_device *the_hcd_pdev[MAX_NUM_UDC];
#[no_mangle]
unsafe extern "C" fn dummy_hcd_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dummy_hcd_cleanup() -> void __exit {
