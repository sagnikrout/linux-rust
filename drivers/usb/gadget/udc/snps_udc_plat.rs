...
//! Source: drivers/usb/gadget/udc/snps_udc_plat.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn start_udc(udc: *mut udc) {
...
#[no_mangle]
unsafe extern "C" fn stop_udc(udc: *mut udc) {
...
#[no_mangle]
unsafe extern "C" fn udc_drd_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn udc_plat_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udc_plat_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn udc_plat_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udc_plat_resume(dev: *mut device) -> c_int {
