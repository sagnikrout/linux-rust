...
//! Source: drivers/usb/gadget/udc/fsl_udc_core.c
#![no_std]
...
// it is initialized in probe()
    static struct fsl_udc *udc_controller = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn _fsl_readl_be(p: *const unsigned __iomem) -> u32 {
    static u32 _fsl_readl_be(const unsigned __iomem *p)
    {
    return in_be32(p);
    }
#[no_mangle]
unsafe extern "C" fn _fsl_readl_le(p: *const unsigned __iomem) -> u32 {
    static u32 _fsl_readl_le(const unsigned __iomem *p)
    {
    return in_le32(p);
    }
#[no_mangle]
unsafe extern "C" fn _fsl_writel_be(v: u32, p: *mut unsigned __iomem) {
    static void _fsl_writel_be(u32 v, unsigned __iomem *p)
    {
    out_be32(p, v);
    }
#[no_mangle]
unsafe extern "C" fn _fsl_writel_le(v: u32, p: *mut unsigned __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn fsl_set_accessors(pdata: *mut fsl_usb2_platform_data) {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_to_hc32(x: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn hc32_to_cpu(x: u32) -> u32 {
...
// --------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn done(ep: *mut fsl_ep, req: *mut fsl_req, status: c_int) {
    static void done(struct fsl_ep *ep, struct fsl_req *req, int status)
    __releases(ep.udc.lock)
    __acquires(ep.udc.lock)
    {
    struct fsl_udc *udc = core::ptr::null_mut();
    let mut stopped: c_uchar = ep.stopped;
...
// --------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn nuke(ep: *mut fsl_ep, status: c_int) {
...
// Whether this eq has request linked
    ...
    struct fsl_req *req = core::ptr::null_mut();
...
// ------------------------------------------------------------------
    ...
    ------------------------------------------------------------------*/
#[no_mangle]
unsafe extern "C" fn dr_controller_setup(udc: *mut fsl_udc) -> c_int {
...
pub const FSL_UDC_RESET_TIMEOUT: c_int = 1000;
...
#[no_mangle]
unsafe extern "C" fn dr_controller_run(udc: *mut fsl_udc) {
...
#[no_mangle]
unsafe extern "C" fn dr_controller_stop(udc: *mut fsl_udc) {
...
#[no_mangle]
unsafe extern "C" fn dr_ep_get_stall(ep_num: c_uchar, dir: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ep0_setup(udc: *mut fsl_udc) {
...
// ep0 doesn't use this routine. It is always enabled.
    ...
    {
    struct fsl_udc *udc = core::ptr::null_mut();
    struct fsl_ep *ep = core::ptr::null_mut();
    let mut max: c_ushort = 0;
    let mut mult: c_uchar = 0, zlt;
...
// ---------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn fsl_ep_disable(_ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_free_request(_ep: *mut usb_ep, _req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn fsl_prime_ep(ep: *mut fsl_ep, td: *mut ep_td_struct) {
...
#[no_mangle]
unsafe extern "C" fn fsl_queue_td(ep: *mut fsl_ep, req: *mut fsl_req) {
...
#[no_mangle]
unsafe extern "C" fn fsl_req_to_dtd(req: *mut fsl_req, gfp_flags: gfp_t) -> c_int {
    static int fsl_req_to_dtd(struct fsl_req *req, gfp_t gfp_flags)
    {
    unsigned	count;
    int		is_last;
    let mut is_first: c_int = 1;
    struct ep_td_struct	*last_dtd = core::ptr::null_mut(), *dtd;
    dma_addr_t dma;
    do {
...
#[no_mangle]
unsafe extern "C" fn fsl_ep_dequeue(_ep: *mut usb_ep, _req: *mut usb_request) -> c_int {
...
// ----------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn fsl_ep_set_halt(_ep: *mut usb_ep, value: c_int) -> c_int {
    static int fsl_ep_set_halt(struct usb_ep *_ep, int value)
    {
    struct fsl_ep *ep = core::ptr::null_mut();
    unsigned long flags;
    int status = -EOPNOTSUPP;	/* operation not supported */
    let mut ep_dir: c_uchar = 0, ep_num = 0;
    struct fsl_udc *udc = core::ptr::null_mut();
    ep = container_of(_ep, struct fsl_ep, ep);
    udc = ep.udc;
    if (!_ep || !ep.ep.desc) {
...
#[no_mangle]
unsafe extern "C" fn fsl_ep_fifo_status(_ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_ep_fifo_flush(_ep: *mut usb_ep) {
    static void fsl_ep_fifo_flush(struct usb_ep *_ep)
    {
    struct fsl_ep *ep;
    int ep_num, ep_dir;
    u32 bits;
    unsigned long timeout;
pub const FSL_UDC_FLUSH_TIMEOUT: c_int = 1000;
    if (!_ep) {
    return;
    } else {
    ep = container_of(_ep, struct fsl_ep, ep);
    ...
    bits = (1 << 16) | 1;
#[no_mangle]
pub unsafe extern "C" fn if(USB_SEND: ep_dir ==) -> else {
...
// ----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn fsl_get_frame(gadget: *mut usb_gadget) -> c_int {
...
// Tries to wake up the host connected to this gadget
    -----------------------------------------------------------------------*/
#[no_mangle]
unsafe extern "C" fn fsl_wakeup(gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn can_pullup(udc: *mut fsl_udc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_vbus_session(gadget: *mut usb_gadget, is_active: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_vbus_draw(gadget: *mut usb_gadget, mA: unsigned) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_pullup(gadget: *mut usb_gadget, is_on: c_int) -> c_int {
...
// Set protocol stall on ep0, protocol stall will automatically be cleared
    on new transaction */
#[no_mangle]
unsafe extern "C" fn ep0stall(udc: *mut fsl_udc) {
...
#[no_mangle]
unsafe extern "C" fn ep0_prime_status(udc: *mut fsl_udc, direction: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udc_reset_ep_queue(udc: *mut fsl_udc, pipe: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn ch9setaddress(udc: *mut fsl_udc, value: u16, index: u16, length: u16) {
...
// prime the data phase
    ...
    __acquires(udc.lock)
    {
    let mut wValue: u16 = le16_to_cpu(setup.wValue);
    let mut wIndex: u16 = le16_to_cpu(setup.wIndex);
    let mut wLength: u16 = le16_to_cpu(setup.wLength);
...
// Status phase from udc
    ...
    let mut pipe: c_int = get_pipe_by_windex(wIndex);
    struct fsl_ep *ep;
...
// This will be set when OTG support is added
    ...
    ptc = wIndex >> 8;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: gadget_is_otg(&udc->gadget)) -> else {
    if (setup.bRequest ==
...
// Set the new address
    let mut new_address: u32 = (u32) udc.device_address;
...
#[no_mangle]
unsafe extern "C" fn tripwire_handler(udc: *mut fsl_udc, ep_num: u8, buffer_ptr: *mut u8) {
...
// process-ep_req(): free the completed Tds for this req
    ...
    let mut direction: c_int = pipe % 2;
...
#[no_mangle]
unsafe extern "C" fn dtd_complete_irq(udc: *mut fsl_udc) {
...
#[no_mangle]
pub unsafe extern "C" fn portscx_device_speed(reg: u32) -> enum usb_device_speed {
...
#[no_mangle]
unsafe extern "C" fn port_change_irq(udc: *mut fsl_udc) {
...
#[no_mangle]
unsafe extern "C" fn suspend_irq(udc: *mut fsl_udc) {
...
#[no_mangle]
unsafe extern "C" fn bus_resume(udc: *mut fsl_udc) {
...
#[no_mangle]
unsafe extern "C" fn reset_queues(udc: *mut fsl_udc, bus_reset: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reset_irq(udc: *mut fsl_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_udc_irq(irq: c_int, _udc: *mut c_void) -> irqreturn_t {
...
// connect to bus through transceiver
    ...
    udc_controller.driver = core::ptr::null_mut();
    return retval;
    }
    }
    } else {
...
#[no_mangle]
unsafe extern "C" fn fsl_udc_stop(g: *mut usb_gadget) -> c_int {
    static int fsl_udc_stop(struct usb_gadget *g)
    {
    struct fsl_ep *loop_ep;
    unsigned long flags;
    if (!IS_ERR_OR_NULL(udc_controller.transceiver))
    otg_set_peripheral(udc_controller.transceiver.otg, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn fsl_proc_read(m: *mut seq_file, v: *mut c_void) -> c_int {
...
// other gadget->eplist ep
    ...
    proc_create_single(proc_filename, 0, core::ptr::null_mut(), fsl_proc_read)

// -------------------------------------------------------------------------
// Release udc structures
#[no_mangle]
unsafe extern "C" fn fsl_udc_release(dev: *mut device) {
...
// initialized QHs, take care of alignment
    ...
    size = QH_ALIGNMENT;
#[no_mangle]
pub unsafe extern "C" fn if(0: (size % QH_ALIGNMENT) !=) -> else {
    size += QH_ALIGNMENT + 1;
    size &= ~(QH_ALIGNMENT - 1);
    }
...
// FIXME: fsl_alloc_request() ignores ep argument
    udc.status_req = container_of(fsl_alloc_request(core::ptr::null_mut(), GFP_KERNEL),
    struct fsl_req, req);
    if (!udc.status_req) {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_udc_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (udc_controller == core::ptr::null_mut())
    return -ENOMEM;
...
// use dma_pool for TD management
    ...
    if (udc_controller.td_pool == core::ptr::null_mut()) {
    ret = -ENOMEM;
    goto err_free_irq;
    }
    ...
    err_kfree:
    kfree(udc_controller);
    udc_controller = core::ptr::null_mut();
    return ret;
    }
...
//
#[no_mangle]
unsafe extern "C" fn fsl_udc_remove(pdev: *mut platform_device) {
...
// Used by OTG statemachine to disable gadget temporarily
    -----------------------------------------------------------------*/
#[no_mangle]
unsafe extern "C" fn fsl_udc_suspend(pdev: *mut platform_device, state: pm_message_t) -> c_int {
...
// -----------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn fsl_udc_resume(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_udc_otg_suspend(dev: *mut device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_udc_otg_resume(dev: *mut device) -> c_int {
...
//
    ...
    return fsl_udc_resume(core::ptr::null_mut());
    }
// -------------------------------------------------------------------------
