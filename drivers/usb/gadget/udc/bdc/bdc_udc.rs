...
//! Source: drivers/usb/gadget/udc/bdc/bdc_udc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn srr_dqp_index_advc(bdc: *mut bdc, srr_num: u32) {
...
// connect sr
#[no_mangle]
unsafe extern "C" fn bdc_uspc_connected(bdc: *mut bdc) {
...
#[no_mangle]
unsafe extern "C" fn bdc_uspc_disconnected(bdc: *mut bdc, reinit: bool) {
...
#[no_mangle]
unsafe extern "C" fn bdc_func_wake_timer(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn handle_link_state_change(bdc: *mut bdc, uspc: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn bdc_sr_uspc(bdc: *mut bdc, sreport: *mut bdc_sr) {
    void bdc_sr_uspc(struct bdc *bdc, struct bdc_sr *sreport)
    {
    let mut clear_flags: u32 = 0;
    u32 uspc;
    let mut connected: bool = false;
    let mut disconn: bool = false;
...
// Vbus not present, and not connected to Downstream port
    ...
    disconn = true;
#[no_mangle]
pub unsafe extern "C" fn if(!BDC_PST(uspc): (uspc & BDC_PCS) &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn bdc_udc_interrupt(irq: c_int, _bdc: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bdc_udc_stop(gadget: *mut usb_gadget) -> c_int {
    ...
    spin_lock_irqsave(&bdc.lock, flags);
    bdc_stop(bdc);
    bdc.gadget_driver = core::ptr::null_mut();
    bdc.gadget.dev.driver = core::ptr::null_mut();
    spin_unlock_irqrestore(&bdc.lock, flags);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn bdc_udc_pullup(gadget: *mut usb_gadget, is_on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdc_udc_wakeup(gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bdc_udc_init(bdc: *mut bdc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bdc_udc_exit(bdc: *mut bdc) {
