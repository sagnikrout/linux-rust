...
//! Source: drivers/usb/gadget/udc/bdc/bdc_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn poll_oip(bdc: *mut bdc, usec: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bdc_stop(bdc: *mut bdc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bdc_reset(bdc: *mut bdc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bdc_run(bdc: *mut bdc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bdc_softconn(bdc: *mut bdc) {
...
#[no_mangle]
pub unsafe extern "C" fn bdc_softdisconn(bdc: *mut bdc) {
...
#[no_mangle]
unsafe extern "C" fn scratchpad_setup(bdc: *mut bdc) -> c_int {
...
// Refer to BDC spec, Table 4 for description of SPB
    ...
    return 0;
    fail:
    bdc.scratchpad.buff = core::ptr::null_mut();
    return -ENOMEM;
    }
// Allocate the status report ring
#[no_mangle]
unsafe extern "C" fn setup_srr(bdc: *mut bdc, interrupter: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdc_mem_init(bdc: *mut bdc, reinit: bool) {
...
#[no_mangle]
unsafe extern "C" fn bdc_mem_free(bdc: *mut bdc) {
...
// Free the bdc_ep array
    ...
    bdc.srr.sr_bds = core::ptr::null_mut();
    bdc.scratchpad.buff = core::ptr::null_mut();
    bdc.bd_table_pool = core::ptr::null_mut();
    bdc.bdc_ep_array = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn bdc_reinit(bdc: *mut bdc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdc_mem_alloc(bdc: *mut bdc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdc_hw_exit(bdc: *mut bdc) {
...
#[no_mangle]
unsafe extern "C" fn bdc_hw_init(bdc: *mut bdc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdc_phy_init(bdc: *mut bdc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdc_phy_exit(bdc: *mut bdc) {
...
#[no_mangle]
unsafe extern "C" fn bdc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn bdc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdc_resume(dev: *mut device) -> c_int {
