...
//! Source: drivers/usb/gadget/udc/renesas_usb3.c
#![no_std]
...
pub const USB3_AXI_INT_STA: c_uint = 0x008;
pub const USB3_AXI_INT_ENA: c_uint = 0x00c;
pub const USB3_DMA_INT_STA: c_uint = 0x010;
pub const USB3_DMA_INT_ENA: c_uint = 0x014;

pub const USB3_USB_COM_CON: c_uint = 0x200;
pub const USB3_USB20_CON: c_uint = 0x204;
pub const USB3_USB30_CON: c_uint = 0x208;
pub const USB3_USB_STA: c_uint = 0x210;

pub const USB3_USB_INT_STA_1: c_uint = 0x220;
pub const USB3_USB_INT_STA_2: c_uint = 0x224;
pub const USB3_USB_INT_ENA_1: c_uint = 0x228;
pub const USB3_USB_INT_ENA_2: c_uint = 0x22c;
pub const USB3_STUP_DAT_0: c_uint = 0x230;
pub const USB3_STUP_DAT_1: c_uint = 0x234;

pub const USB3_P0_MOD: c_uint = 0x280;
pub const USB3_P0_CON: c_uint = 0x288;
pub const USB3_P0_STA: c_uint = 0x28c;
pub const USB3_P0_INT_STA: c_uint = 0x290;
pub const USB3_P0_INT_ENA: c_uint = 0x294;
pub const USB3_P0_LNG: c_uint = 0x2a0;
pub const USB3_P0_READ: c_uint = 0x2a4;
pub const USB3_P0_WRITE: c_uint = 0x2a8;
pub const USB3_PIPE_COM: c_uint = 0x2b0;
pub const USB3_PN_MOD: c_uint = 0x2c0;
pub const USB3_PN_RAMMAP: c_uint = 0x2c4;
pub const USB3_PN_CON: c_uint = 0x2c8;
pub const USB3_PN_STA: c_uint = 0x2cc;
pub const USB3_PN_INT_STA: c_uint = 0x2d0;
pub const USB3_PN_INT_ENA: c_uint = 0x2d4;
pub const USB3_PN_LNG: c_uint = 0x2e0;
pub const USB3_PN_READ: c_uint = 0x2e4;
pub const USB3_PN_WRITE: c_uint = 0x2e8;
pub const USB3_SSIFCMD: c_uint = 0x340;
...
pub const DMA_CON_PIPE_NO_SHIFT: c_int = 8;
...
pub const USB_COM_CON_DEV_ADDR_SHIFT: c_int = 8;

    USB_COM_CON_DEV_ADDR_MASK)

// USB20_CON

pub const USB20_CON_B2_TSTMOD_SHIFT: c_int = 8;

    USB20_CON_B2_TSTMOD_MASK)

// USB30_CON
pub const USB30_CON_POW_SEL_SHIFT: c_int = 24;

pub const USB30_CON_POW_SEL_IN_DISCON: c_int = 0;

pub const USB30_CON_POW_SEL_P0_TO_P2: c_int = 0;

// USB_STA

pub const USB_STA_SPEED_SS: c_int = 0;
...
pub const PX_CON_BYTE_EN_SHIFT: c_int = 9;

    PX_CON_BYTE_EN_MASK)

// P0_CON

pub const P0_CON_ST_RES_FORCE_NRDY: c_int = 0;

pub const P0_CON_OT_RES_FORCE_NRDY: c_int = 0;

pub const P0_CON_IN_RES_FORCE_NRDY: c_int = 0;
...
pub const PN_MOD_TYPE_SHIFT: c_int = 4;

    PN_MOD_TYPE_MASK)

// PN_RAMMAP
pub const PN_RAMMAP_RAMAREA_SHIFT: c_int = 29;

pub const PN_RAMMAP_RAMAREA_1KB: c_int = 0;
pub const PN_RAMMAP_MPKT_SHIFT: c_int = 16;

    PN_RAMMAP_MPKT_MASK)
pub const PN_RAMMAP_RAMIF_SHIFT: c_int = 14;
...
pub const PN_CON_RES_FORCE_NRDY: c_int = 0;

// PN_INT_STA and PN_INT_ENA

// USB3_SSIFCMD

pub const USB3_EP0_SS_MAX_PACKET_SIZE: c_int = 512;
pub const USB3_EP0_HSFS_MAX_PACKET_SIZE: c_int = 64;
pub const USB3_EP0_BUF_SIZE: c_int = 8;

pub const USB3_WAIT_US: c_int = 3;
pub const USB3_DMA_NUM_SETTING_AREA: c_int = 4;
//
...
// 32768 bytes.
//
pub const USB3_DMA_MAX_XFER_SIZE: c_int = 32768;
pub const USB3_DMA_PRD_SIZE: c_int = 4096;
    struct renesas_usb3;
// Physical Region Descriptor Table
#[repr(C)]
#[derive(Copy, Clone)]
pub struct renesas_usb3_prd {
    pub word1: u32,

pub const USB3_PRD1_MPS_8: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct renesas_usb3_dma {
    pub prd: *mut renesas_usb3_prd,
    pub prd_dma: dma_addr_t,
    pub /: *mut *mut int num; / Setting area number (from 1 to 4),
    pub used: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct renesas_usb3_request {
    pub req: usb_request,
    pub queue: list_head,
}

pub const USB3_EP_NAME_SIZE: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct renesas_usb3_ep {
    pub ep: usb_ep,
    pub usb3: *mut renesas_usb3,
    pub dma: *mut renesas_usb3_dma,
    pub num: c_int,
    pub ep_name: [c_char; USB3_EP_NAME_SIZE],
    pub queue: list_head,
    pub rammap_val: u32,
    pub dir_in: bool,
    pub halt: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct renesas_usb3_priv {
    pub /: *mut *mut int ramsize_per_ramif; / unit = bytes,
    pub num_ramif: c_int,
    pub /: *mut *mut int ramsize_per_pipe; / unit = bytes,
    pub /: *mut *mut bool workaround_for_vbus; / if true, don't check vbus signal,
    pub /: *mut *mut bool is_rzv2m; / if true, RZ/V2M SoC,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct renesas_usb3 {
    pub reg: *mut void __iomem,
    pub drd_reg: *mut void __iomem,
    pub usbp_rstc: *mut reset_control,
    ...
    pub usb3_ep: *mut renesas_usb3_ep,
    pub num_usb3_eps: c_int,
    pub dma: [renesas_usb3_dma; USB3_DMA_NUM_SETTING_AREA],
    pub lock: spinlock_t,
    pub disabled_count: c_int,
    pub ep0_req: *mut usb_request,
    pub connection_state: enum usb_role,
    pub test_mode: u16,
    pub ep0_buf: [u8; USB3_EP0_BUF_SIZE],
    pub softconnect: bool,
    pub workaround_for_vbus: bool,
    pub /: *mut *mut bool extcon_host; / check id and set EXTCON_USB_HOST,
    pub /: *mut *mut bool extcon_usb; / check vbus and set EXTCON_USB,
    pub forced_b_device: bool,
    pub start_to_connect: bool,
    pub role_sw_by_connector: bool,
    pub is_rzv2m: bool,
}
    ...
    let mut use_dma: static bool = 1;
    module_param(use_dma, bool, 0644);
    MODULE_PARM_DESC(use_dma, "use dedicated DMAC");
#[no_mangle]
unsafe extern "C" fn usb3_write(usb3: *mut renesas_usb3, data: u32, offs: u32) {
    static void usb3_write(struct renesas_usb3 *usb3, u32 data, u32 offs)
    {
    iowrite32(data, usb3.reg + offs);
    }
#[no_mangle]
unsafe extern "C" fn usb3_read(usb3: *mut renesas_usb3, offs: u32) -> u32 {
    static u32 usb3_read(struct renesas_usb3 *usb3, u32 offs)
    {
    return ioread32(usb3.reg + offs);
    }
#[no_mangle]
unsafe extern "C" fn usb3_set_bit(usb3: *mut renesas_usb3, bits: u32, offs: u32) {
    static void usb3_set_bit(struct renesas_usb3 *usb3, u32 bits, u32 offs)
    {
    let mut val: u32 = usb3_read(usb3, offs);
    val |= bits;
    usb3_write(usb3, val, offs);
    }
#[no_mangle]
unsafe extern "C" fn usb3_clear_bit(usb3: *mut renesas_usb3, bits: u32, offs: u32) {
...
#[no_mangle]
unsafe extern "C" fn usb3_drd_write(usb3: *mut renesas_usb3, data: u32, offs: u32) {
...
#[no_mangle]
unsafe extern "C" fn usb3_drd_read(usb3: *mut renesas_usb3, offs: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn usb3_drd_set_bit(usb3: *mut renesas_usb3, bits: u32, offs: u32) {
    static void usb3_drd_set_bit(struct renesas_usb3 *usb3, u32 bits, u32 offs)
    {
    let mut val: u32 = usb3_drd_read(usb3, offs);
    val |= bits;
    usb3_drd_write(usb3, val, offs);
    }
#[no_mangle]
unsafe extern "C" fn usb3_drd_clear_bit(usb3: *mut renesas_usb3, bits: u32, offs: u32) {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_extcon_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn usb3_is_host(usb3: *mut renesas_usb3) -> bool {
    static bool usb3_is_host(struct renesas_usb3 *usb3)
    {
    return !(usb3_drd_read(usb3, USB3_DRD_CON(usb3)) & DRD_CON_PERI_CON);
    }
#[no_mangle]
unsafe extern "C" fn usb3_init_axi_bridge(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_init_epc_registers(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_wakeup_usb2_phy(usb3: *mut renesas_usb3) -> bool {
...
#[no_mangle]
unsafe extern "C" fn usb3_usb2_pullup(usb3: *mut renesas_usb3, pullup: c_int) {
    static void usb3_usb2_pullup(struct renesas_usb3 *usb3, int pullup)
    {
    let mut bits: u32 = USB20_CON_B2_PUE | USB20_CON_B2_CONNECT;
...
#[no_mangle]
unsafe extern "C" fn usb3_set_test_mode(usb3: *mut renesas_usb3) {
    static void usb3_set_test_mode(struct renesas_usb3 *usb3)
    {
    let mut val: u32 = usb3_read(usb3, USB3_USB20_CON);
...
#[no_mangle]
unsafe extern "C" fn usb3_start_usb2_connection(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_is_usb3_phy_in_u3(usb3: *mut renesas_usb3) -> c_int {
    static int usb3_is_usb3_phy_in_u3(struct renesas_usb3 *usb3)
    {
    return usb3_read(usb3, USB3_USB30_CON) & USB30_CON_POW_SEL_IN_U3;
    }
#[no_mangle]
unsafe extern "C" fn usb3_wakeup_usb3_phy(usb3: *mut renesas_usb3) -> bool {
...
#[no_mangle]
unsafe extern "C" fn usb3_feature_get_un_enabled(usb3: *mut renesas_usb3) -> u16 {
    static u16 usb3_feature_get_un_enabled(struct renesas_usb3 *usb3)
    {
    let mut mask_u2: u32 = SSIFCMD_UDIR_U2 | SSIFCMD_UREQ_U2;
    let mut mask_u1: u32 = SSIFCMD_UDIR_U1 | SSIFCMD_UREQ_U1;
    let mut val: u32 = usb3_read(usb3, USB3_SSIFCMD);
    let mut ret: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn usb3_feature_u2_enable(usb3: *mut renesas_usb3, enable: bool) {
    static void usb3_feature_u2_enable(struct renesas_usb3 *usb3, bool enable)
    {
    let mut bits: u32 = SSIFCMD_UDIR_U2 | SSIFCMD_UREQ_U2;
...
#[no_mangle]
unsafe extern "C" fn usb3_feature_u1_enable(usb3: *mut renesas_usb3, enable: bool) {
    static void usb3_feature_u1_enable(struct renesas_usb3 *usb3, bool enable)
    {
    let mut bits: u32 = SSIFCMD_UDIR_U1 | SSIFCMD_UREQ_U1;
...
#[no_mangle]
unsafe extern "C" fn usb3_start_operation_for_usb3(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_start_usb3_connection(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_stop_usb3_connection(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_connect(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_reset_epc(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_disconnect(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_check_vbus(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_role_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn usb3_set_mode(usb3: *mut renesas_usb3, host: bool) {
...
#[no_mangle]
unsafe extern "C" fn usb3_set_mode_by_role_sw(usb3: *mut renesas_usb3, host: bool) {
...
#[no_mangle]
unsafe extern "C" fn usb3_vbus_out(usb3: *mut renesas_usb3, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn usb3_mode_config(usb3: *mut renesas_usb3, host: bool, a_dev: bool) {
...
#[no_mangle]
unsafe extern "C" fn usb3_is_a_device(usb3: *mut renesas_usb3) -> bool {
    static bool usb3_is_a_device(struct renesas_usb3 *usb3)
    {
    return !(usb3_drd_read(usb3, USB3_USB_OTG_STA(usb3)) & USB_OTG_IDMON(usb3));
    }
#[no_mangle]
unsafe extern "C" fn usb3_check_id(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_init_controller(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_stop_controller(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_int_1_pll_wakeup(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_int_1_linkup_success(usb3: *mut renesas_usb3) {
    static void usb3_irq_epc_int_1_linkup_success(struct renesas_usb3 *usb3)
    {
    usb3_transition_to_default_state(usb3, true);
    }
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_int_1_resume(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_int_1_suspend(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_int_1_disable(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_int_1_bus_reset(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_int_1_vbus_change(usb3: *mut renesas_usb3) {
    static void usb3_irq_epc_int_1_vbus_change(struct renesas_usb3 *usb3)
    {
    usb3_check_vbus(usb3);
    }
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_int_1_hot_reset(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_int_1_warm_reset(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_int_1_speed(usb3: *mut renesas_usb3) {
    static void usb3_irq_epc_int_1_speed(struct renesas_usb3 *usb3)
    {
    let mut speed: u32 = usb3_read(usb3, USB3_USB_STA) & USB_STA_SPEED_MASK;
    switch (speed) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_int_1(usb3: *mut renesas_usb3, int_sta_1: u32) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_pipe0_status_end(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_set_p0_con_update_res(usb3: *mut renesas_usb3, res: u32) {
    static void usb3_set_p0_con_update_res(struct renesas_usb3 *usb3, u32 res)
    {
    let mut val: u32 = usb3_read(usb3, USB3_P0_CON);
    val &= ~(P0_CON_ST_RES_MASK | P0_CON_OT_RES_MASK | P0_CON_IN_RES_MASK);
    val |= res | P0_CON_RES_WEN;
    usb3_write(usb3, val, USB3_P0_CON);
    }
#[no_mangle]
unsafe extern "C" fn usb3_set_p0_con_for_ctrl_read_data(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_set_p0_con_for_ctrl_read_status(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_set_p0_con_for_ctrl_write_data(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_set_p0_con_for_ctrl_write_status(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_set_p0_con_for_no_data(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_set_p0_con_stall(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_set_p0_con_stop(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_pn_change(usb3: *mut renesas_usb3, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb3_set_pn_con_update_res(usb3: *mut renesas_usb3, res: u32) {
    static void usb3_set_pn_con_update_res(struct renesas_usb3 *usb3, u32 res)
    {
    let mut val: u32 = usb3_read(usb3, USB3_PN_CON);
    val &= ~PN_CON_RES_MASK;
...
#[no_mangle]
unsafe extern "C" fn usb3_wait_pipe_status(usb3_ep: *mut renesas_usb3_ep, mask: u32) -> c_int {
    static int usb3_wait_pipe_status(struct renesas_usb3_ep *usb3_ep, u32 mask)
    {
    struct renesas_usb3 *usb3 = usb3_ep_to_usb3(usb3_ep);
    let mut sta_reg: u32 = usb3_ep.num ? USB3_PN_STA : USB3_P0_STA;
    ...
    {
    struct renesas_usb3 *usb3 = usb3_ep_to_usb3(usb3_ep);
    let mut con_reg: u32 = usb3_ep.num ? USB3_PN_CON : USB3_P0_CON;
    let mut val: u32 = usb3_read(usb3, con_reg);
    ...
    let mut tmp: u32 = 0;
    let mut is_last: bool = !len ? true : false;
...
#[no_mangle]
unsafe extern "C" fn usb3_get_received_length(usb3_ep: *mut renesas_usb3_ep) -> u32 {
    static u32 usb3_get_received_length(struct renesas_usb3_ep *usb3_ep)
    {
    struct renesas_usb3 *usb3 = usb3_ep_to_usb3(usb3_ep);
    let mut lng_reg: u32 = usb3_ep.num ? USB3_PN_LNG : USB3_P0_LNG;
...
// The driver doesn't handle zero-length packet via dmac
    ...
    let mut remain: u32 = usb3_req.req.length;
    let mut dma: u32 = usb3_req.req.dma;
    u32 len;
    let mut i: c_int = 0;
    do {
...
#[no_mangle]
unsafe extern "C" fn usb3_dma_kick_prd(usb3_ep: *mut renesas_usb3_ep) {
    static void usb3_dma_kick_prd(struct renesas_usb3_ep *usb3_ep)
    {
    struct renesas_usb3_dma *dma = usb3_ep.dma;
    struct renesas_usb3 *usb3 = usb3_ep_to_usb3(usb3_ep);
    let mut dma_con: u32 = DMA_COM_PIPE_NO(usb3_ep.num) | DMA_CON_PRD_EN;
    if (usb3_ep.dir_in)
...
#[no_mangle]
unsafe extern "C" fn usb3_dma_stop_prd(usb3_ep: *mut renesas_usb3_ep) {
...
#[no_mangle]
unsafe extern "C" fn usb3_set_device_address(usb3: *mut renesas_usb3, addr: u16) {
...
#[no_mangle]
unsafe extern "C" fn usb3_set_halt_p0(usb3_ep: *mut renesas_usb3_ep, halt: bool) -> c_int {
    ...
    bool set)
    {
    let mut num: c_int = le16_to_cpu(ctrl.wIndex) & USB_ENDPOINT_NUMBER_MASK;
    struct renesas_usb3_ep *usb3_ep;
    struct renesas_usb3_request *usb3_req;
...
// TODO
    ...
    usb_req_to_usb3_req(usb3.ep0_req));
    usb3_pipe0_internal_xfer(usb3, core::ptr::null_mut(), 6, usb3_pipe0_set_sel_completion);
    return false;
    }
...
#[no_mangle]
unsafe extern "C" fn usb3_p0_con_clear_buffer(usb3: *mut renesas_usb3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_pipe0_setup(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_pipe0_bfrdy(usb3: *mut renesas_usb3) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_pipe0(usb3: *mut renesas_usb3) {
    static void usb3_irq_epc_pipe0(struct renesas_usb3 *usb3)
    {
    let mut p0_int_sta: u32 = usb3_read(usb3, USB3_P0_INT_STA);
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_pipen_lsttr(usb3: *mut renesas_usb3, num: c_int) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_pipen_bfrdy(usb3: *mut renesas_usb3, num: c_int) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_pipen(usb3: *mut renesas_usb3, num: c_int) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc_int_2(usb3: *mut renesas_usb3, int_sta_2: u32) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_idmon_change(usb3: *mut renesas_usb3) {
    static void usb3_irq_idmon_change(struct renesas_usb3 *usb3)
    {
    usb3_check_id(usb3);
    }
#[no_mangle]
unsafe extern "C" fn usb3_irq_otg_int(usb3: *mut renesas_usb3) {
    static void usb3_irq_otg_int(struct renesas_usb3 *usb3)
    {
    let mut otg_int_sta: u32 = usb3_drd_read(usb3, USB3_USB_OTG_INT_STA(usb3));
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_epc(usb3: *mut renesas_usb3) {
    static void usb3_irq_epc(struct renesas_usb3 *usb3)
    {
    let mut int_sta_1: u32 = usb3_read(usb3, USB3_USB_INT_STA_1);
    let mut int_sta_2: u32 = usb3_read(usb3, USB3_USB_INT_STA_2);
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_dma_int(usb3: *mut renesas_usb3, dma_sta: u32) {
...
#[no_mangle]
unsafe extern "C" fn usb3_irq_dma(usb3: *mut renesas_usb3) {
    static void usb3_irq_dma(struct renesas_usb3 *usb3)
    {
    let mut dma_sta: u32 = usb3_read(usb3, USB3_DMA_INT_STA);
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_irq(irq: c_int, _usb3: *mut c_void) -> irqreturn_t {
    static irqreturn_t renesas_usb3_irq(int irq, void *_usb3)
    {
    struct renesas_usb3 *usb3 = _usb3;
    let mut ret: irqreturn_t = IRQ_NONE;
    let mut axi_int_sta: u32 = usb3_read(usb3, USB3_AXI_INT_STA);
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_otg_irq(irq: c_int, _usb3: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn usb3_calc_ramarea(ram_size: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(SZ_2K: ram_size <=) -> else {
    else if (ram_size <= SZ_2K)
    return PN_RAMMAP_RAMAREA_2KB;
#[no_mangle]
pub unsafe extern "C" fn if(SZ_4K: ram_size <=) -> else {
    else if (ram_size <= SZ_4K)
    return PN_RAMMAP_RAMAREA_4KB;
#[no_mangle]
pub unsafe extern "C" fn if(SZ_8K: ram_size <=) -> else {
    ...
    let mut mpkt: u32 = PN_RAMMAP_MPKT(1024);
...
#[no_mangle]
unsafe extern "C" fn usb3_disable_pipe_n(usb3_ep: *mut renesas_usb3_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_ep_disable(_ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __renesas_usb3_ep_free_request(_req: *mut usb_request) {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_ep_dequeue(_ep: *mut usb_ep, _req: *mut usb_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_ep_set_halt(_ep: *mut usb_ep, value: c_int) -> c_int {
    static int renesas_usb3_ep_set_halt(struct usb_ep *_ep, int value)
    {
    return usb3_set_halt(usb_ep_to_usb3_ep(_ep), !!value, false);
    }
#[no_mangle]
unsafe extern "C" fn renesas_usb3_ep_set_wedge(_ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_ep_fifo_flush(_ep: *mut usb_ep) {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_stop(gadget: *mut usb_gadget) -> c_int {
    static int renesas_usb3_stop(struct usb_gadget *gadget)
    {
    struct renesas_usb3 *usb3 = gadget_to_renesas_usb3(gadget);
    usb3.softconnect = false;
    usb3.gadget.speed = USB_SPEED_UNKNOWN;
    usb3.driver = core::ptr::null_mut();
    if (usb3.is_rzv2m)
    rzv2m_usb3drd_reset(usb3_to_dev(usb3).parent, false);
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_get_frame(_gadget: *mut usb_gadget) -> c_int {
    static int renesas_usb3_get_frame(struct usb_gadget *_gadget)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn renesas_usb3_pullup(gadget: *mut usb_gadget, is_on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_set_selfpowered(gadget: *mut usb_gadget, is_self: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_role_switch_get(sw: *mut usb_role_switch) -> enum usb_role {
    ...
    let mut cur_role: enum usb_role = renesas_usb3_role_switch_get(usb3.role_sw);
    switch (role) {
    case USB_ROLE_NONE:
    usb3.connection_state = USB_ROLE_NONE;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "peripheral")) -> else {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_b_device_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_b_device_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(buf, _arg: "1", _arg: 1)) -> else {
...
// ------- platform_driver ------------------------------------------------
#[no_mangle]
unsafe extern "C" fn renesas_usb3_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_probe(pdev: *mut platform_device) -> c_int {
...
// If not found, this driver will not use a role sw
    usb_role_switch_unregister(usb3.role_sw);
    usb3.role_sw = core::ptr::null_mut();
    }
    } else {
    usb3.role_sw = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_usb3_resume(dev: *mut device) -> c_int {
