...
//! Source: drivers/usb/gadget/udc/pch_udc.c
#![no_std]
...
pub const UDC_EP_REG_SHIFT: c_uint = 0x20	/* Offset to next EP */;
pub const UDC_EPCTL_ADDR: c_uint = 0x00	/* Endpoint control */;
pub const UDC_EPSTS_ADDR: c_uint = 0x04	/* Endpoint status */;
pub const UDC_BUFIN_FRAMENUM_ADDR: c_uint = 0x08	/* buffer size in / frame number out */;
pub const UDC_BUFOUT_MAXPKT_ADDR: c_uint = 0x0C	/* buffer size out / maxpkt in */;
pub const UDC_SUBPTR_ADDR: c_uint = 0x10	/* setup buffer pointer */;
pub const UDC_DESPTR_ADDR: c_uint = 0x14	/* Data descriptor pointer */;
pub const UDC_CONFIRM_ADDR: c_uint = 0x18	/* Write/Read confirmation */;
pub const UDC_DEVCFG_ADDR: c_uint = 0x400	/* Device configuration */;
pub const UDC_DEVCTL_ADDR: c_uint = 0x404	/* Device control */;
pub const UDC_DEVSTS_ADDR: c_uint = 0x408	/* Device status */;
pub const UDC_DEVIRQSTS_ADDR: c_uint = 0x40C	/* Device irq status */;
pub const UDC_DEVIRQMSK_ADDR: c_uint = 0x410	/* Device irq mask */;
pub const UDC_EPIRQSTS_ADDR: c_uint = 0x414	/* Endpoint irq status */;
pub const UDC_EPIRQMSK_ADDR: c_uint = 0x418	/* Endpoint irq mask */;
pub const UDC_DEVLPM_ADDR: c_uint = 0x41C	/* LPM control / status */;
pub const UDC_CSR_BUSY_ADDR: c_uint = 0x4f0	/* UDC_CSR_BUSY Status register */;
pub const UDC_SRST_ADDR: c_uint = 0x4fc	/* SOFT RESET register */;
pub const UDC_CSR_ADDR: c_uint = 0x500	/* USB_DEVICE endpoint register */;
// Endpoint control register
// Bit position

pub const UDC_EPCTL_ET_SHIFT: c_int = 4;
// Mask patern
...
pub const UDC_EPSTS_OUT_SHIFT: c_int = 4;
// Mask patern
pub const UDC_EPSTS_OUT_MASK: c_uint = 0x00000030;
pub const UDC_EPSTS_ALL_CLR_MASK: c_uint = 0x1F0006F0;
// Value for OUT field
...
// Bit position
pub const UDC_DEVCTL_THLEN_SHIFT: c_int = 24;
pub const UDC_DEVCTL_BRLEN_SHIFT: c_int = 16;

// Device status register
// Bit position
pub const UDC_DEVSTS_TS_SHIFT: c_int = 18;
pub const UDC_DEVSTS_ENUM_SPEED_SHIFT: c_int = 13;
pub const UDC_DEVSTS_ALT_SHIFT: c_int = 8;
pub const UDC_DEVSTS_INTF_SHIFT: c_int = 4;
pub const UDC_DEVSTS_CFG_SHIFT: c_int = 0;
// Mask patern
...
pub const UDC_DEVSTS_ENUM_SPEED_LOW: c_int = 2;
pub const UDC_DEVSTS_ENUM_SPEED_FULLX: c_int = 3;
// Device irq register
// Bit position
...
// Bit position
pub const UDC_EPINT_IN_SHIFT: c_int = 0;
pub const UDC_EPINT_OUT_SHIFT: c_int = 16;
...
// Bit position
pub const UDC_CSR_NE_NUM_SHIFT: c_int = 0;
pub const UDC_CSR_NE_DIR_SHIFT: c_int = 4;
pub const UDC_CSR_NE_TYPE_SHIFT: c_int = 5;
pub const UDC_CSR_NE_CFG_SHIFT: c_int = 7;
pub const UDC_CSR_NE_INTF_SHIFT: c_int = 11;
pub const UDC_CSR_NE_ALT_SHIFT: c_int = 15;
pub const UDC_CSR_NE_MAX_PKT_SHIFT: c_int = 19;
// Mask patern
...
// Index of endpoint
pub const UDC_EP0IN_IDX: c_int = 0;
pub const UDC_EP0OUT_IDX: c_int = 1;

pub const PCH_UDC_EP0: c_int = 0;
pub const PCH_UDC_EP1: c_int = 1;
pub const PCH_UDC_EP2: c_int = 2;
pub const PCH_UDC_EP3: c_int = 3;
// Number of endpoint

// Length Value
pub const PCH_UDC_BRLEN: c_uint = 0x0F	/* Burst length */;
pub const PCH_UDC_THLEN: c_uint = 0x1F	/* Threshold length */;
// Value of EP Buffer Size
pub const UDC_EP0IN_BUFF_SIZE: c_int = 16;
pub const UDC_EPIN_BUFF_SIZE: c_int = 256;
pub const UDC_EP0OUT_BUFF_SIZE: c_int = 16;
pub const UDC_EPOUT_BUFF_SIZE: c_int = 256;
// Value of EP maximum packet size
pub const UDC_EP0IN_MAX_PKT_SIZE: c_int = 64;
pub const UDC_EP0OUT_MAX_PKT_SIZE: c_int = 64;
pub const UDC_BULK_MAX_PKT_SIZE: c_int = 512;
// DMA
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pch_udc_data_dma_desc {
    pub status: u32,
    pub reserved: u32,
    pub dataptr: u32,
    pub next: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pch_udc_stp_dma_desc {
    pub status: u32,
    pub reserved: u32,
...
// Buffer status
pub const PCH_UDC_BUFF_STS: c_uint = 0xC0000000;
pub const PCH_UDC_BS_HST_RDY: c_uint = 0x00000000;
pub const PCH_UDC_BS_DMA_BSY: c_uint = 0x40000000;
pub const PCH_UDC_BS_DMA_DONE: c_uint = 0x80000000;
pub const PCH_UDC_BS_HST_BSY: c_uint = 0xC0000000;
// Rx/Tx Status
pub const PCH_UDC_RXTX_STS: c_uint = 0x30000000;
pub const PCH_UDC_RTS_SUCC: c_uint = 0x00000000;
pub const PCH_UDC_RTS_DESERR: c_uint = 0x10000000;
pub const PCH_UDC_RTS_BUFERR: c_uint = 0x30000000;
// Last Descriptor Indication
pub const PCH_UDC_DMA_LAST: c_uint = 0x08000000;
// Number of Rx/Tx Bytes Mask
pub const PCH_UDC_RXTX_BYTES: c_uint = 0x0000ffff;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pch_udc_ep {
    pub ep: usb_ep,
    pub td_stp_phys: dma_addr_t,
    pub td_data_phys: dma_addr_t,
    pub td_stp: *mut pch_udc_stp_dma_desc,
    pub td_data: *mut pch_udc_data_dma_desc,
    pub dev: *mut pch_udc_dev,
    pub offset_addr: c_ulong,
    pub queue: list_head,
    unsigned			num:5,
    in:1,
    pub epsts: c_ulong,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pch_vbus_gpio_data {
    pub port: *mut gpio_desc,
    pub intr: c_int,
    pub irq_work_fall: work_struct,
    pub irq_work_rise: work_struct,
}
...
pub struct pch_udc_dev {
    ...
    pub setup_data: usb_ctrlrequest,
    pub base_addr: *mut void __iomem,
    pub bar: c_ushort,
    pub cfg_data: pch_udc_cfg_data,
    pub vbus_gpio: pch_vbus_gpio_data,
}

pub const PCH_UDC_PCI_BAR_QUARK_X1000: c_int = 0;
pub const PCH_UDC_PCI_BAR: c_int = 1;
pub const PCI_DEVICE_ID_INTEL_QUARK_X1000_UDC: c_uint = 0x0939;
pub const PCI_DEVICE_ID_INTEL_EG20T_UDC: c_uint = 0x8808;
pub const PCI_DEVICE_ID_ML7213_IOH_UDC: c_uint = 0x801D;
pub const PCI_DEVICE_ID_ML7831_IOH_UDC: c_uint = 0x8808;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pch_udc_request {
    pub req: usb_request,
    pub td_data_phys: dma_addr_t,
    pub td_data: *mut pch_udc_data_dma_desc,
    pub td_data_last: *mut pch_udc_data_dma_desc,
    pub queue: list_head,
...
#[no_mangle]
pub unsafe extern "C" fn pch_udc_readl(dev: *mut pch_udc_dev, reg: c_ulong) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn pch_udc_ep_readl(ep: *mut pch_udc_ep, reg: c_ulong) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_csr_busy(dev: *mut pch_udc_dev) {
    static void pch_udc_csr_busy(struct pch_udc_dev *dev)
    {
    let mut count: c_uint = 200;
// Wait till idle
...
//
    ...
    unsigned int ep)
    {
    let mut reg: c_ulong = PCH_UDC_CSR(ep);
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_read_csr(dev: *mut pch_udc_dev, ep: c_uint) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_rmt_wakeup(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_get_frame(dev: *mut pch_udc_dev) -> c_int {
    static inline int pch_udc_get_frame(struct pch_udc_dev *dev)
    {
    let mut frame: u32 = pch_udc_readl(dev, UDC_DEVSTS_ADDR);
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_clear_selfpowered(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_set_selfpowered(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_set_disconnect(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_clear_disconnect(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_reconnect(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_ep_set_stall(ep: *mut pch_udc_ep) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_ep_clear_stall(ep: *mut pch_udc_ep) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_ep_set_maxpkt(ep: *mut pch_udc_ep, pkt_size: u32) {
    static void pch_udc_ep_set_maxpkt(struct pch_udc_ep *ep, u32 pkt_size)
    {
    let mut data: u32 = pch_udc_ep_readl(ep, UDC_BUFOUT_MAXPKT_ADDR);
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_ep_set_subptr(ep: *mut pch_udc_ep, addr: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_ep_set_ddptr(ep: *mut pch_udc_ep, addr: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_ep_set_pd(ep: *mut pch_udc_ep) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_ep_set_rrdy(ep: *mut pch_udc_ep) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_ep_clear_rrdy(ep: *mut pch_udc_ep) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_set_dma(dev: *mut pch_udc_dev, dir: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_clear_dma(dev: *mut pch_udc_dev, dir: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_set_csr_done(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_read_device_interrupts(dev: *mut pch_udc_dev) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_read_ep_interrupts(dev: *mut pch_udc_dev) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_read_device_status(dev: *mut pch_udc_dev) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_read_ep_control(ep: *mut pch_udc_ep) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_clear_ep_control(ep: *mut pch_udc_ep) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_read_ep_status(ep: *mut pch_udc_ep) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_udc_ep_set_nak(ep: *mut pch_udc_ep) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_ep_clear_nak(ep: *mut pch_udc_ep) {
    static void pch_udc_ep_clear_nak(struct pch_udc_ep *ep)
    {
    let mut loopcnt: c_uint = 0;
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_ep_fifo_flush(ep: *mut pch_udc_ep, dir: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_ep_disable(ep: *mut pch_udc_ep) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_wait_ep_stall(ep: *mut pch_udc_ep) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_init(dev: *mut pch_udc_dev) {
    static void pch_udc_init(struct pch_udc_dev *dev)
    {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_exit(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_pcd_get_frame(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_pcd_wakeup(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_pcd_selfpowered(gadget: *mut usb_gadget, value: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_pcd_pullup(gadget: *mut usb_gadget, is_on: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_pcd_vbus_session(gadget: *mut usb_gadget, is_active: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_pcd_vbus_draw(gadget: *mut usb_gadget, mA: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_vbus_gpio_get_value(dev: *mut pch_udc_dev) -> c_int {
    static int pch_vbus_gpio_get_value(struct pch_udc_dev *dev)
    {
    let mut vbus: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn pch_vbus_gpio_work_fall(irq_work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_vbus_gpio_work_rise(irq_work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_vbus_gpio_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn pch_vbus_gpio_init(dev: *mut pch_udc_dev) -> c_int {
    ...
    dev.vbus_gpio.port = core::ptr::null_mut();
    dev.vbus_gpio.intr = 0;
// Retrieve the GPIO line from the USB gadget device
    gpiod = devm_gpiod_get_optional(d, core::ptr::null_mut(), GPIOD_IN);
    if (IS_ERR(gpiod))
...
//
#[no_mangle]
unsafe extern "C" fn pch_vbus_gpio_free(dev: *mut pch_udc_dev) {
...
//
    ...
    {
    struct pch_udc_dev	*dev;
    let mut halted: unsigned = ep.halted;
...
//
#[no_mangle]
unsafe extern "C" fn empty_req_queue(ep: *mut pch_udc_ep) {
...
//
    ...
    let mut i: unsigned = req.chain_len;
    dma_addr_t addr2;
    let mut addr: dma_addr_t = (dma_addr_t)td.next;
    td.next = 0x00;
    for (; i > 1; --i) {
...
//
    ...
    let mut bytes: c_ulong = req.req.length, i = 0;
    dma_addr_t dma_addr;
    let mut len: unsigned = 1;
    if (req.chain_len > 1)
...
//
#[no_mangle]
unsafe extern "C" fn process_zlp(ep: *mut pch_udc_ep, req: *mut pch_udc_request) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_pcd_ep_disable(usbep: *mut usb_ep) -> c_int {
...
//
    ...
    if (req.td_data != core::ptr::null_mut()) {
    if (req.chain_len > 1)
    pch_udc_free_dma_chain(ep.dev, req);
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_pcd_set_halt(usbep: *mut usb_ep, halt: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_pcd_set_wedge(usbep: *mut usb_ep) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_pcd_fifo_flush(usbep: *mut usb_ep) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_init_setup_buff(td_stp: *mut pch_udc_stp_dma_desc) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_start_next_txrequest(ep: *mut pch_udc_ep) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_complete_transfer(ep: *mut pch_udc_ep) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_complete_receiver(ep: *mut pch_udc_ep) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_svc_data_in(dev: *mut pch_udc_dev, ep_num: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_svc_data_out(dev: *mut pch_udc_dev, ep_num: c_int) {
    static void pch_udc_svc_data_out(struct pch_udc_dev *dev, int ep_num)
    {
    u32			epsts;
    struct pch_udc_ep		*ep;
    struct pch_udc_request		*req = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pch_udc_gadget_setup(dev: *mut pch_udc_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_svc_control_in(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_svc_control_out(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_postsvc_epinters(dev: *mut pch_udc_dev, ep_num: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_read_all_epstatus(dev: *mut pch_udc_dev, ep_intr: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_activate_control_ep(dev: *mut pch_udc_dev) {
...
// Initialize the IN EP Descriptor
    ep.td_data      = core::ptr::null_mut();
    ep.td_stp       = core::ptr::null_mut();
    ep.td_data_phys = 0;
    ep.td_stp_phys  = 0;
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_svc_ur_interrupt(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_svc_enum_interrupt(dev: *mut pch_udc_dev) {
    static void pch_udc_svc_enum_interrupt(struct pch_udc_dev *dev)
    {
    u32 dev_stat, dev_speed;
    let mut speed: u32 = USB_SPEED_FULL;
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_svc_intf_interrupt(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_svc_cfg_interrupt(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_dev_isr(dev: *mut pch_udc_dev, dev_intr: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_isr(irq: c_int, pdev: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_setup_ep0(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_pcd_reinit(dev: *mut pch_udc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_udc_pcd_init(dev: *mut pch_udc_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn init_dma_pools(dev: *mut pch_udc_dev) -> c_int {
...
// data: 0 packets !?
    ...
    dev.ep[UDC_EP0IN_IDX].td_stp = core::ptr::null_mut();
    dev.ep[UDC_EP0IN_IDX].td_stp_phys = 0;
    dev.ep[UDC_EP0IN_IDX].td_data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pch_udc_stop(g: *mut usb_gadget) -> c_int {
    static int pch_udc_stop(struct usb_gadget *g)
    {
    struct pch_udc_dev	*dev = to_pch_udc(g);
...
#[no_mangle]
unsafe extern "C" fn pch_vbus_gpio_remove_table(table: *mut c_void) {
    static void pch_vbus_gpio_remove_table(void *table)
    {
    gpiod_remove_lookup_table(table);
    }
#[no_mangle]
unsafe extern "C" fn pch_vbus_gpio_add_table(d: *mut device, table: *mut c_void) -> c_int {
    ...
    .dev_id		= "0000:02:02.4",
    .table		= {
    GPIO_LOOKUP("sch_gpio.33158", 12, core::ptr::null_mut(), GPIO_ACTIVE_HIGH),
    {}
    },
    };
#[no_mangle]
unsafe extern "C" fn pch_udc_minnow_platform_init(d: *mut device) -> c_int {
    static int pch_udc_minnow_platform_init(struct device *d)
    {
    return pch_vbus_gpio_add_table(d, &pch_udc_minnow_vbus_gpio_table);
    }
#[no_mangle]
unsafe extern "C" fn pch_udc_quark_platform_init(d: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pch_udc_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pch_udc_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pch_udc_suspend(d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn pch_udc_resume(d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn pch_udc_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    static int pch_udc_probe(struct pci_dev *pdev, const struct pci_device_id *id)
    {
    let mut platform_init: platform_init_fn = (platform_init_fn)id.driver_data;
    int			retval;
    struct pch_udc_dev	*dev;
// init
