...
//! Source: drivers/usb/gadget/udc/bcm63xx_udc.c
#![no_std]
...
pub const BCM63XX_NUM_EP: c_int = 5;
pub const BCM63XX_NUM_IUDMA: c_int = 6;
pub const BCM63XX_NUM_FIFO_PAIRS: c_int = 3;
pub const IUDMA_RESET_TIMEOUT_US: c_int = 10000;
pub const IUDMA_EP0_RXCHAN: c_int = 0;
pub const IUDMA_EP0_TXCHAN: c_int = 1;
pub const IUDMA_MAX_FRAGMENT: c_int = 2048;
pub const BCM63XX_MAX_CTRL_PKT: c_int = 64;
pub const BCMEP_CTRL: c_uint = 0x00;
pub const BCMEP_ISOC: c_uint = 0x01;
pub const BCMEP_BULK: c_uint = 0x02;
pub const BCMEP_INTR: c_uint = 0x03;
pub const BCMEP_OUT: c_uint = 0x00;
pub const BCMEP_IN: c_uint = 0x01;
pub const BCM63XX_SPD_FULL: c_int = 1;
pub const BCM63XX_SPD_HIGH: c_int = 0;
pub const IUDMA_DMAC_OFFSET: c_uint = 0x200;
pub const IUDMA_DMAS_OFFSET: c_uint = 0x400;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iudma_ch_cfg {
    pub ep_num: c_int,
    pub n_bds: c_int,
    pub ep_type: c_int,
    pub dir: c_int,
    pub n_fifo_slots: c_int,
    pub max_pkt_hs: c_int,
    pub max_pkt_fs: c_int,
}
...
#[no_mangle]
pub unsafe extern "C" fn limitations(channels: FIFO sizing and number of DMA) -> the hardware {
...
pub struct iudma_ch {
    ...
    pub max_pkt: c_int,
    pub is_tx: bool,
    pub bep: *mut bcm63xx_ep,
    pub udc: *mut bcm63xx_udc,
    pub read_bd: *mut bcm_enet_desc,
    pub write_bd: *mut bcm_enet_desc,
    pub end_bd: *mut bcm_enet_desc,
    pub n_bds_used: c_int,
    pub bd_ring: *mut bcm_enet_desc,
    pub bd_ring_dma: dma_addr_t,
    pub n_bds: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm63xx_ep {
    pub ep_num: c_uint,
    pub iudma: *mut iudma_ch,
    pub ep: usb_ep,
    pub udc: *mut bcm63xx_udc,
    pub queue: list_head,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm63xx_req {
    pub /: *mut *mut list_head queue; / ep's requests,
    pub req: usb_request,
    pub offset: c_uint,
    pub bd_bytes: c_uint,
    pub iudma: *mut iudma_ch,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm63xx_udc {
    pub lock: spinlock_t,
    pub dev: *mut device,
    pub pd: *mut bcm63xx_usbd_platform_data,
    pub usbd_clk: *mut clk,
    pub usbh_clk: *mut clk,
    pub gadget: usb_gadget,
    pub driver: *mut usb_gadget_driver,
    pub usbd_regs: *mut void __iomem,
    pub iudma_regs: *mut void __iomem,
    pub bep: [bcm63xx_ep; BCM63XX_NUM_EP],
    pub iudma: [iudma_ch; BCM63XX_NUM_IUDMA],
    pub cfg: c_int,
    pub iface: c_int,
    pub alt_iface: c_int,
    pub ep0_ctrl_req: bcm63xx_req,
    pub ep0_ctrl_buf: *mut u8,
    pub ep0state: c_int,
    pub ep0_wq: work_struct,
    pub wedgemap: c_ulong,
    pub ep0_req_reset:1: unsigned,
    pub ep0_req_set_cfg:1: unsigned,
    pub ep0_req_set_iface:1: unsigned,
    pub ep0_req_shutdown:1: unsigned,
    pub ep0_req_completed:1: unsigned,
    pub ep0_reply: *mut usb_request,
    pub ep0_request: *mut usb_request,
}
...
#[no_mangle]
pub unsafe extern "C" fn usb_dmas_readl(udc: *mut bcm63xx_udc, off: u32, chan: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn set_clocks(udc: *mut bcm63xx_udc, is_enabled: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_ep_dma_select(udc: *mut bcm63xx_udc, idx: c_int) {
    static void bcm63xx_ep_dma_select(struct bcm63xx_udc *udc, int idx)
    {
    let mut val: u32 = usbd_readl(udc, USBD_CONTROL_REG);
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_fifo_setup(udc: *mut bcm63xx_udc) {
    static void bcm63xx_fifo_setup(struct bcm63xx_udc *udc)
    {
    let mut is_hs: c_int = udc.gadget.speed == USB_SPEED_HIGH;
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_fifo_reset_ep(udc: *mut bcm63xx_udc, ep_num: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_fifo_reset(udc: *mut bcm63xx_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_ep_init(udc: *mut bcm63xx_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_ep_setup(udc: *mut bcm63xx_udc) {
...
//
    ...
    {
    let mut first_bd: c_int = 1, last_bd = 0, extra_zero_pkt = 0;
    let mut bytes_left: c_uint = breq.req.length - breq.offset;
...
//
#[no_mangle]
unsafe extern "C" fn iudma_read(udc: *mut bcm63xx_udc, iudma: *mut iudma_ch) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iudma_reset_channel(udc: *mut bcm63xx_udc, iudma: *mut iudma_ch) {
    static void iudma_reset_channel(struct bcm63xx_udc *udc, struct iudma_ch *iudma)
    {
    let mut timeout: c_int = IUDMA_RESET_TIMEOUT_US;
    struct bcm_enet_desc *d;
    let mut ch_idx: c_int = iudma.ch_idx;
    if (!iudma.is_tx)
...
//
#[no_mangle]
unsafe extern "C" fn iudma_init_channel(udc: *mut bcm63xx_udc, ch_idx: c_uint) -> c_int {
    ...
    let mut n_bds: c_uint = cfg.n_bds;
    struct bcm63xx_ep *bep = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn iudma_init(udc: *mut bcm63xx_udc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iudma_uninit(udc: *mut bcm63xx_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_set_ctrl_irqs(udc: *mut bcm63xx_udc, enable_irqs: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_select_phy_mode(udc: *mut bcm63xx_udc, is_device: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_select_pullup(udc: *mut bcm63xx_udc, is_on: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_uninit_udc_hw(udc: *mut bcm63xx_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_init_udc_hw(udc: *mut bcm63xx_udc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_ep_disable(ep: *mut usb_ep) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_udc_dequeue(ep: *mut usb_ep, req: *mut usb_request) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_udc_set_halt(ep: *mut usb_ep, value: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_udc_set_wedge(ep: *mut usb_ep) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_ep0_spoof_set_cfg(udc: *mut bcm63xx_udc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_ep0_spoof_set_iface(udc: *mut bcm63xx_udc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_ep0_read_complete(udc: *mut bcm63xx_udc) -> c_int {
...
//
    ...
    req.length = length;
    req.complete = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_ep0_do_setup(udc: *mut bcm63xx_udc) -> enum bcm63xx_ep0_state {
...
// Process new SETUP packet arriving on ep0
    ...
    return EP0_REQUEUE;
#[no_mangle]
pub unsafe extern "C" fn if(USB_DIR_IN: ctrl->bRequestType &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_ep0_do_idle(udc: *mut bcm63xx_udc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_ep0_one_round(udc: *mut bcm63xx_udc) -> c_int {
    static int bcm63xx_ep0_one_round(struct bcm63xx_udc *udc)
    {
    let mut ep0state: enum bcm63xx_ep0_state = udc.ep0state;
    let mut shutdown: bool = udc.ep0_req_reset || udc.ep0_req_shutdown;
    switch (udc.ep0state) {
    case EP0_REQUEUE:
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_ep0_process(w: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_udc_get_frame(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_udc_pullup(gadget: *mut usb_gadget, is_on: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_udc_stop(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_update_cfg_iface(udc: *mut bcm63xx_udc) {
    static void bcm63xx_update_cfg_iface(struct bcm63xx_udc *udc)
    {
    let mut reg: u32 = usbd_readl(udc, USBD_STATUS_REG);
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_update_link_speed(udc: *mut bcm63xx_udc) -> c_int {
    static int bcm63xx_update_link_speed(struct bcm63xx_udc *udc)
    {
    let mut reg: u32 = usbd_readl(udc, USBD_STATUS_REG);
    let mut oldspeed: enum usb_device_speed = udc.gadget.speed;
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_update_wedge(udc: *mut bcm63xx_udc, new_status: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_udc_ctrl_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t bcm63xx_udc_ctrl_isr(int irq, void *dev_id)
    {
    struct bcm63xx_udc *udc = dev_id;
    u32 stat;
    let mut disconnected: bool = false, bus_reset = false;
...
#[no_mangle]
pub unsafe extern "C" fn if(udc->driver: bus_reset &&) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_udc_data_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    struct usb_request *req = core::ptr::null_mut();
    struct bcm63xx_req *breq = core::ptr::null_mut();
    int rc;
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_usbd_dbg_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_iudma_dbg_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_udc_init_debugfs(udc: *mut bcm63xx_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_udc_cleanup_debugfs(udc: *mut bcm63xx_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_udc_probe(pdev: *mut platform_device) -> c_int {
    static int bcm63xx_udc_probe(struct platform_device *pdev)
    {
    struct device *dev = &pdev.dev;
    struct bcm63xx_usbd_platform_data *pd = dev_get_platdata(dev);
    struct bcm63xx_udc *udc;
    let mut rc: c_int = -ENOMEM, i, irq;
...
//
#[no_mangle]
unsafe extern "C" fn bcm63xx_udc_remove(pdev: *mut platform_device) {
