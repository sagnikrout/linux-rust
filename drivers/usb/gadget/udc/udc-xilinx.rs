...
//! Source: drivers/usb/gadget/udc/udc-xilinx.c
#![no_std]
...
pub const XUSB_EP0_CONFIG_OFFSET: c_uint = 0x0000  /* EP0 Config Reg Offset */;
pub const XUSB_SETUP_PKT_ADDR_OFFSET: c_uint = 0x0080  /* Setup Packet Address */;
pub const XUSB_ADDRESS_OFFSET: c_uint = 0x0100  /* Address Register */;
pub const XUSB_CONTROL_OFFSET: c_uint = 0x0104  /* Control Register */;
pub const XUSB_STATUS_OFFSET: c_uint = 0x0108  /* Status Register */;
pub const XUSB_FRAMENUM_OFFSET: c_uint = 0x010C	/* Frame Number Register */;
pub const XUSB_IER_OFFSET: c_uint = 0x0110	/* Interrupt Enable Register */;
pub const XUSB_BUFFREADY_OFFSET: c_uint = 0x0114	/* Buffer Ready Register */;
pub const XUSB_TESTMODE_OFFSET: c_uint = 0x0118	/* Test Mode Register */;
pub const XUSB_DMA_RESET_OFFSET: c_uint = 0x0200  /* DMA Soft Reset Register */;
pub const XUSB_DMA_CONTROL_OFFSET: c_uint = 0x0204	/* DMA Control Register */;
pub const XUSB_DMA_DSAR_ADDR_OFFSET: c_uint = 0x0208	/* DMA source Address Reg */;
pub const XUSB_DMA_DDAR_ADDR_OFFSET: c_uint = 0x020C	/* DMA destination Addr Reg */;
pub const XUSB_DMA_LENGTH_OFFSET: c_uint = 0x0210	/* DMA Length Register */;
pub const XUSB_DMA_STATUS_OFFSET: c_uint = 0x0214	/* DMA Status Register */;
// Endpoint Configuration Space offsets
pub const XUSB_EP_CFGSTATUS_OFFSET: c_uint = 0x00	/* Endpoint Config Status  */;
pub const XUSB_EP_BUF0COUNT_OFFSET: c_uint = 0x08	/* Buffer 0 Count */;
pub const XUSB_EP_BUF1COUNT_OFFSET: c_uint = 0x0C	/* Buffer 1 Count */;
pub const XUSB_CONTROL_USB_READY_MASK: c_uint = 0x80000000 /* USB ready Mask */;
pub const XUSB_CONTROL_USB_RMTWAKE_MASK: c_uint = 0x40000000 /* Remote wake up mask */;
// Interrupt register related masks.
pub const XUSB_STATUS_GLOBAL_INTR_MASK: c_uint = 0x80000000 /* Global Intr Enable */;
pub const XUSB_STATUS_DMADONE_MASK: c_uint = 0x04000000 /* DMA done Mask */;
pub const XUSB_STATUS_DMAERR_MASK: c_uint = 0x02000000 /* DMA Error Mask */;
pub const XUSB_STATUS_DMABUSY_MASK: c_uint = 0x80000000 /* DMA Error Mask */;
pub const XUSB_STATUS_RESUME_MASK: c_uint = 0x01000000 /* USB Resume Mask */;
pub const XUSB_STATUS_RESET_MASK: c_uint = 0x00800000 /* USB Reset Mask */;
pub const XUSB_STATUS_SUSPEND_MASK: c_uint = 0x00400000 /* USB Suspend Mask */;
pub const XUSB_STATUS_DISCONNECT_MASK: c_uint = 0x00200000 /* USB Disconnect Mask */;
pub const XUSB_STATUS_FIFO_BUFF_RDY_MASK: c_uint = 0x00100000 /* FIFO Buff Ready Mask */;
pub const XUSB_STATUS_FIFO_BUFF_FREE_MASK: c_uint = 0x00080000 /* FIFO Buff Free Mask */;
pub const XUSB_STATUS_SETUP_PACKET_MASK: c_uint = 0x00040000 /* Setup packet received */;
pub const XUSB_STATUS_EP1_BUFF2_COMP_MASK: c_uint = 0x00000200 /* EP 1 Buff 2 Processed */;
pub const XUSB_STATUS_EP1_BUFF1_COMP_MASK: c_uint = 0x00000002 /* EP 1 Buff 1 Processed */;
pub const XUSB_STATUS_EP0_BUFF2_COMP_MASK: c_uint = 0x00000100 /* EP 0 Buff 2 Processed */;
pub const XUSB_STATUS_EP0_BUFF1_COMP_MASK: c_uint = 0x00000001 /* EP 0 Buff 1 Processed */;
pub const XUSB_STATUS_HIGH_SPEED_MASK: c_uint = 0x00010000 /* USB Speed Mask */;
// Suspend,Reset,Suspend and Disconnect Mask
pub const XUSB_STATUS_INTR_EVENT_MASK: c_uint = 0x01E00000;
// Buffers  completion Mask
pub const XUSB_STATUS_INTR_BUFF_COMP_ALL_MASK: c_uint = 0x0000FEFF;
// Mask for buffer 0 and buffer 1 completion for all Endpoints
pub const XUSB_STATUS_INTR_BUFF_COMP_SHIFT_MASK: c_uint = 0x00000101;

// Endpoint Configuration Status Register
pub const XUSB_EP_CFG_VALID_MASK: c_uint = 0x80000000 /* Endpoint Valid bit */;
pub const XUSB_EP_CFG_STALL_MASK: c_uint = 0x40000000 /* Endpoint Stall bit */;
pub const XUSB_EP_CFG_DATA_TOGGLE_MASK: c_uint = 0x08000000 /* Endpoint Data toggle */;
// USB device specific global configuration constants.

// DPRAM is the source address for DMA transfer
pub const XUSB_DMA_READ_FROM_DPRAM: c_uint = 0x80000000;
pub const XUSB_DMA_DMASR_BUSY: c_uint = 0x80000000 /* DMA busy */;
pub const XUSB_DMA_DMASR_ERROR: c_uint = 0x40000000 /* DMA Error */;
//
// When this bit is set, the DMA buffer ready bit is set by hardware upon
// DMA transfer completion.
//
pub const XUSB_DMA_BRR_CTRL: c_uint = 0x40000000 /* DMA bufready ctrl bit */;
// Phase States
pub const SETUP_PHASE: c_uint = 0x0000	/* Setup Phase */;
pub const DATA_PHASE: c_uint = 0x0001  /* Data Phase */;
pub const STATUS_PHASE: c_uint = 0x0002  /* Status Phase */;
...
pub struct xusb_ep {
    ...
    pub epnumber: u16,
    pub maxpacket: u16,
    pub buffer0count: u16,
    pub buffer1count: u16,
    pub curbufnum: u8,
    pub buffer0ready: bool,
    pub buffer1ready: bool,
    pub is_in: bool,
    pub is_iso: bool,
}
...
pub struct xusb_udc {
    ...
    pub clk: *mut clk,
    pub reg): *mut *mut unsigned int (read_fn)(void __iomem,
    pub u32): *mut *mut *mut void (write_fn)(void __iomem , u32,,
}
...
//
#[no_mangle]
unsafe extern "C" fn xudc_write32(addr: *mut void __iomem, offset: u32, val: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_read32(addr: *mut void __iomem) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_write32_be(addr: *mut void __iomem, offset: u32, val: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_read32_be(addr: *mut void __iomem) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_wrstatus(udc: *mut xusb_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_epconfig(ep: *mut xusb_ep, udc: *mut xusb_udc) {
...
// Get the Buffer address and copy the transmit data.
    eprambase = (u32  *)(udc.addr + ep.rambase);
...
//
#[no_mangle]
unsafe extern "C" fn xudc_done(ep: *mut xusb_ep, req: *mut xusb_req, status: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_read_fifo(ep: *mut xusb_ep, req: *mut xusb_req) -> c_int {
    static int xudc_read_fifo(struct xusb_ep *ep, struct xusb_req *req)
    {
    u8 *buf;
    u32 is_short, count, bufferspace;
    u8 bufoffset;
    let mut two_pkts: u8 = 0;
    int ret;
    let mut retval: c_int = -EAGAIN;
    struct xusb_udc *udc = ep.udc;
...
//
#[no_mangle]
unsafe extern "C" fn xudc_write_fifo(ep: *mut xusb_ep, req: *mut xusb_req) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_nuke(ep: *mut xusb_ep, status: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_ep_set_halt(_ep: *mut usb_ep, value: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_ep_disable(_ep: *mut usb_ep) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_free_request(_ep: *mut usb_ep, _req: *mut usb_request) {
...
//
#[no_mangle]
unsafe extern "C" fn __xudc_ep0_queue(ep0: *mut xusb_ep, req: *mut xusb_req) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_ep_dequeue(_ep: *mut usb_ep, _req: *mut usb_request) -> c_int {
    static int xudc_ep_dequeue(struct usb_ep *_ep, struct usb_request *_req)
    {
    struct xusb_ep *ep	= to_xusb_ep(_ep);
    struct xusb_req *req	= core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn xudc_ep0_disable(ep: *mut usb_ep) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_get_frame(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_wakeup(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_pullup(gadget: *mut usb_gadget, is_on: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_eps_init(udc: *mut xusb_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_stop_activity(udc: *mut xusb_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_stop(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_clear_stall_all_ep(udc: *mut xusb_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_startup_handler(udc: *mut xusb_udc, intrstatus: u32) {
...
// Enable the reset, resume and disconnect
    ...
    let mut condition: bool = (udc.usb_state != USB_STATE_SUSPENDED);
...
//
#[no_mangle]
unsafe extern "C" fn xudc_ep0_stall(udc: *mut xusb_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_setaddress(udc: *mut xusb_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_getstatus(udc: *mut xusb_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_set_clear_feature(udc: *mut xusb_udc) {
    ...
    u8 outinbit;
    u32 epcfgreg;
    let mut flag: c_int = (udc.setup.bRequest == USB_REQ_SET_FEATURE ? 1 : 0);
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn xudc_handle_setup(udc: *mut xusb_udc) {
...
// Load up the chapter 9 command buffer.
    ep0rambase = (u32  *) (udc.addr + XUSB_SETUP_PKT_ADDR_OFFSET);
    memcpy_toio((void __iomem *)&setup, ep0rambase, 8);
    udc.setup = setup;
    udc.setup.wValue = cpu_to_le16((u16 )setup.wValue);
    udc.setup.wIndex = cpu_to_le16((u16 )setup.wIndex);
    udc.setup.wLength = cpu_to_le16((u16 )setup.wLength);
...
//
#[no_mangle]
unsafe extern "C" fn xudc_ep0_out(udc: *mut xusb_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_ep0_in(udc: *mut xusb_udc) {
    ...
    u16 length;
    u8 *ep0rambase;
    let mut test_mode: u8 = le16_to_cpu(udc.setup.wIndex) >> 8;
    req = list_first_entry(&ep0.queue, struct xusb_req, queue);
...
//
#[no_mangle]
unsafe extern "C" fn xudc_ctrl_ep_handler(udc: *mut xusb_udc, intrstatus: u32) {
    ...
    xudc_ep0_out(udc);
#[no_mangle]
pub unsafe extern "C" fn if(XUSB_STATUS_FIFO_BUFF_FREE_MASK: intrstatus &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_irq(irq: c_int, _udc: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xudc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn xudc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xudc_resume(dev: *mut device) -> c_int {
