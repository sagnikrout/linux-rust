...
//! Source: drivers/usb/gadget/udc/cdns2/cdns2-ep0.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cdns2_w_index_to_ep_index(wIndex: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns2_check_new_setup(pdev: *mut cdns2_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cdns2_ep0_delegate_req(pdev: *mut cdns2_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns2_ep0_stall(pdev: *mut cdns2_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: preq) -> else {
    else if (preq)
...
#[no_mangle]
unsafe extern "C" fn cdns2_status_stage(pdev: *mut cdns2_device) {
    ...
    {
    let mut state: enum usb_device_state = pdev.gadget.state;
    let mut config: u32 = le16_to_cpu(ctrl_req.wValue);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn cdns2_req_ep0_set_address(pdev: *mut cdns2_device, addr: u32) -> c_int {
    static int cdns2_req_ep0_set_address(struct cdns2_device *pdev, u32 addr)
    {
    let mut device_state: enum usb_device_state = pdev.gadget.state;
    u8 reg;
...
#[no_mangle]
unsafe extern "C" fn cdns2_ep0_std_request(pdev: *mut cdns2_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __pending_setup_status_handler(pdev: *mut cdns2_device) {
...
#[no_mangle]
pub unsafe extern "C" fn cdns2_pending_setup_status_handler(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn cdns2_handle_setup_packet(pdev: *mut cdns2_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(CDNS2_STATUS_STAGE: pdev->ep0_stage ==) -> else {
    else if (pdev.ep0_stage == CDNS2_STATUS_STAGE)
    cdns2_status_stage(pdev);
    }
#[no_mangle]
unsafe extern "C" fn cdns2_transfer_completed(pdev: *mut cdns2_device) {
...
#[no_mangle]
pub unsafe extern "C" fn cdns2_handle_ep0_interrupt(pdev: *mut cdns2_device, dir: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns2_gadget_ep0_disable(ep: *mut usb_ep) -> c_int {
    static int cdns2_gadget_ep0_disable(struct usb_ep *ep)
    {
    return -EINVAL;
    }
#[no_mangle]
unsafe extern "C" fn cdns2_gadget_ep0_set_halt(ep: *mut usb_ep, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns2_gadget_ep0_set_wedge(ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cdns2_ep0_config(pdev: *mut cdns2_device) {
    ...
    struct cdns2_endpoint *pep)
    {
    let mut maxpacket: u16 = le16_to_cpu(cdns2_gadget_ep0_desc.wMaxPacketSize);
