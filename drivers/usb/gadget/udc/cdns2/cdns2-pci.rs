...
//! Source: drivers/usb/gadget/udc/cdns2/cdns2-pci.c
#![no_std]
...
pub const PCI_BAR_DEV: c_int = 0;
pub const PCI_DEV_FN_DEVICE: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn cdns2_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn cdns2_pci_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns2_pci_resume(dev: *mut device) -> c_int {
