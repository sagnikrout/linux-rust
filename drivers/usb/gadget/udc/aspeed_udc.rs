...
//! Source: drivers/usb/gadget/udc/aspeed_udc.c
#![no_std]
...
//
pub const AST_UDC_FUNC_CTRL: c_uint = 0x00	/* Root Function Control & Status Register */;
pub const AST_UDC_CONFIG: c_uint = 0x04	/* Root Configuration Setting Register */;
pub const AST_UDC_IER: c_uint = 0x08	/* Interrupt Control Register */;
pub const AST_UDC_ISR: c_uint = 0x0C	/* Interrupt Status Register */;
pub const AST_UDC_EP_ACK_IER: c_uint = 0x10	/* Programmable ep Pool ACK Interrupt Enable Reg */;
pub const AST_UDC_EP_NAK_IER: c_uint = 0x14	/* Programmable ep Pool NAK Interrupt Enable Reg */;
pub const AST_UDC_EP_ACK_ISR: c_uint = 0x18	/* Programmable ep Pool ACK Interrupt Status Reg */;
pub const AST_UDC_EP_NAK_ISR: c_uint = 0x1C	/* Programmable ep Pool NAK Interrupt Status Reg */;
pub const AST_UDC_DEV_RESET: c_uint = 0x20	/* Device Controller Soft Reset Enable Register */;
pub const AST_UDC_STS: c_uint = 0x24	/* USB Status Register */;
pub const AST_VHUB_EP_DATA: c_uint = 0x28	/* Programmable ep Pool Data Toggle Value Set */;
pub const AST_VHUB_ISO_TX_FAIL: c_uint = 0x2C	/* Isochronous Transaction Fail Accumulator */;
pub const AST_UDC_EP0_CTRL: c_uint = 0x30	/* Endpoint 0 Control/Status Register */;
pub const AST_UDC_EP0_DATA_BUFF: c_uint = 0x34	/* Base Address of ep0 IN/OUT Data Buffer Reg */;
pub const AST_UDC_SETUP0: c_uint = 0x80    /* Root Device Setup Data Buffer0 */;
pub const AST_UDC_SETUP1: c_uint = 0x84    /* Root Device Setup Data Buffer1 */;
// Main control reg
...
//
pub const AST_UDC_EP_CONFIG: c_uint = 0x00	/* Endpoint Configuration Register */;
pub const AST_UDC_EP_DMA_CTRL: c_uint = 0x04	/* DMA Descriptor List Control/Status Register */;
pub const AST_UDC_EP_DMA_BUFF: c_uint = 0x08	/* DMA Descriptor/Buffer Base Address */;
pub const AST_UDC_EP_DMA_STS: c_uint = 0x0C	/* DMA Descriptor List R/W Pointer and Status */;
pub const AST_UDC_EP_BASE: c_uint = 0x200;
pub const AST_UDC_EP_OFFSET: c_uint = 0x10;
// EP config reg

// EP DMA ctrl reg

pub const EP_DMA_CTRL_STS_RX_IDLE: c_uint = 0x0;
pub const EP_DMA_CTRL_STS_TX_IDLE: c_uint = 0x8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast_udc_request {
    pub req: usb_request,
    pub queue: list_head,
    pub mapped:1: unsigned,
    pub actual_dma_length: c_uint,
    pub saved_dma_wptr: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast_dma_desc {
    pub des_0: u32,
    pub des_1: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast_udc_ep {
    pub ep: usb_ep,
// Request queue
    pub queue: list_head,
    pub udc: *mut ast_udc_dev,
    pub ep_reg: *mut void __iomem,
    pub epn_buf: *mut c_void,
    pub epn_buf_dma: dma_addr_t,
    pub desc: *const usb_endpoint_descriptor,
// DMA Descriptors
    pub descs: *mut ast_dma_desc,
    pub descs_dma: dma_addr_t,
    pub descs_wptr: u32,
    pub chunk_max: u32,
    pub dir_in:1: bool,
    pub stopped:1: unsigned,
    pub desc_mode:1: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast_udc_dev {
...
// EP0 DMA buffers allocated in one chunk
    pub ep0_buf: *mut c_void,
    pub ep0_buf_dma: dma_addr_t,
    pub ep: [ast_udc_ep; AST_UDC_NUM_ENDPOINTS],
    pub gadget: usb_gadget,
    pub driver: *mut usb_gadget_driver,
    pub creq: *mut void __iomem,
    pub suspended_from: enum usb_device_state,
    pub desc_mode: c_int,
// Force full speed only
    pub force_usb1:1: bool,
    pub is_control_tx:1: unsigned,
    pub wakeup_en:1: bool,
}
...
// Macro flag: #define AST_UDC_DEBUG
// Macro flag: #define AST_SETUP_DEBUG
// Macro flag: #define AST_EP_DEBUG
// Macro flag: #define AST_ISR_DEBUG
...
#[no_mangle]
unsafe extern "C" fn ast_udc_nuke(ep: *mut ast_udc_ep, status: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn ast_udc_stop_activity(udc: *mut ast_udc_dev) {
    ...
    {
    let mut maxpacket: u16 = usb_endpoint_maxp(desc);
    struct ast_udc_ep *ep = to_ast_ep(_ep);
    struct ast_udc_dev *udc = ep.udc;
    let mut epnum: u8 = usb_endpoint_num(desc);
    unsigned long flags;
    let mut ep_conf: u32 = 0;
    u8 dir_in;
    u8 type;
...
#[no_mangle]
unsafe extern "C" fn ast_udc_ep_disable(_ep: *mut usb_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_epn_kick(ep: *mut ast_udc_ep, req: *mut ast_udc_request) {
...
// EP0 request enqueue
    if (ep.ep.desc == core::ptr::null_mut()) {
    if ((req.req.dma % 4) != 0) {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_ep_dequeue(_ep: *mut usb_ep, _req: *mut usb_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_ep_set_halt(_ep: *mut usb_ep, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_ep0_rx(udc: *mut ast_udc_dev) {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_ep0_tx(udc: *mut ast_udc_dev) {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_ep0_out(udc: *mut ast_udc_dev) {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_ep0_in(udc: *mut ast_udc_dev) {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_epn_handle(udc: *mut ast_udc_dev, ep_num: u16) {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_epn_handle_desc(udc: *mut ast_udc_dev, ep_num: u16) {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_ep0_data_tx(udc: *mut ast_udc_dev, tx_data: *mut u8, len: u32) {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_getstatus(udc: *mut ast_udc_dev) {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_ep0_handle_setup(udc: *mut ast_udc_dev) {
    static void ast_udc_ep0_handle_setup(struct ast_udc_dev *udc)
    {
    struct ast_udc_ep *ep = &udc.ep[0];
    struct ast_udc_request *req;
    struct usb_ctrlrequest crq;
    let mut req_num: c_int = 0;
    let mut rc: c_int = 0;
    u32 reg;
    memcpy_fromio(&crq, udc.creq, sizeof(crq));
...
#[no_mangle]
unsafe extern "C" fn ast_udc_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_gadget_getframe(gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_wake_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_wakeup_all(udc: *mut ast_udc_dev) {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_wakeup(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ast_udc_pullup(gadget: *mut usb_gadget, is_on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_stop(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ast_udc_init_ep(udc: *mut ast_udc_dev) {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_init_dev(udc: *mut ast_udc_dev) {
    static void ast_udc_init_dev(struct ast_udc_dev *udc)
    {
    INIT_WORK(&udc.wake_work, ast_udc_wake_work);
    }
#[no_mangle]
unsafe extern "C" fn ast_udc_init_hw(udc: *mut ast_udc_dev) {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_cleanup(pdev: *mut platform_device) {
...
// Disable upstream port connection
    ...
    udc.ep0_buf,
    udc.ep0_buf_dma);
    udc.ep0_buf = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ast_udc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ast_udc_probe(pdev: *mut platform_device) -> c_int {
    ...
    udc.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(udc.clk)) {
    rc = PTR_ERR(udc.clk);
    goto err;
    }
