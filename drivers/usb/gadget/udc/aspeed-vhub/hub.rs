...
//! Source: drivers/usb/gadget/udc/aspeed-vhub/hub.c
#![no_std]
...
// Shoot it from the EP buffer
    return ast_vhub_reply(ep, core::ptr::null_mut(), len);
    }
...
// Shoot it from the EP buffer
    ...
    return ast_vhub_reply(ep, core::ptr::null_mut(), min_t(u16, rc, len));
    }
...
// First packet, grab speed
    ...
    let mut ustat: u32 = readl(vhub.regs + AST_VHUB_USBSTS);
...
// Update HW EP1 response
    let mut reg: u32 = readl(vhub.regs + AST_VHUB_EP1_STS_CHG);
    let mut pmask: u32 = (1 << (port + 1));
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_send_host_wakeup(vhub: *mut ast_vhub) {
    static void ast_vhub_send_host_wakeup(struct ast_vhub *vhub)
    {
    let mut reg: u32 = readl(vhub.regs + AST_VHUB_CTRL);
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_wake_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_hub_wake_all(vhub: *mut ast_vhub) {
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_port_reset(vhub: *mut ast_vhub, port: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_hub_suspend(vhub: *mut ast_vhub) {
...
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_hub_resume(vhub: *mut ast_vhub) {
...
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_hub_reset(vhub: *mut ast_vhub) {
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_fixup_usb1_dev_desc(vhub: *mut ast_vhub) {
...
// dest_array = *src_array;
    ...
    str = of_get_property(child, str_id_map[i].name, core::ptr::null_mut());
    if (str) {
    ...
    str_array[offset].s = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_init_desc(vhub: *mut ast_vhub) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_init_hub(vhub: *mut ast_vhub) -> c_int {
