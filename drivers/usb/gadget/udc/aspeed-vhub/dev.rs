...
//! Source: drivers/usb/gadget/udc/aspeed-vhub/dev.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_dev_irq(d: *mut ast_vhub_dev) {
    void ast_vhub_dev_irq(struct ast_vhub_dev *d)
    {
    let mut istat: u32 = readl(d.regs + AST_VHUB_DEV_ISR);
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_dev_enable(d: *mut ast_vhub_dev) {
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_dev_disable(d: *mut ast_vhub_dev) {
...
// Then disable device
    ...
    u16 wIndex, u16 wValue)
    {
    let mut ep_num: c_int = wIndex & USB_ENDPOINT_NUMBER_MASK;
    struct ast_vhub_ep *ep;
    let mut st0: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_dev_set_address(d: *mut ast_vhub_dev, addr: u8) {
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_udc_wakeup(gadget: *mut *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_udc_get_frame(gadget: *mut *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_dev_nuke(d: *mut ast_vhub_dev) {
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_udc_pullup(gadget: *mut *mut usb_gadget, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_udc_stop(gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_dev_suspend(d: *mut ast_vhub_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_dev_resume(d: *mut ast_vhub_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_dev_reset(d: *mut ast_vhub_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_del_dev(d: *mut ast_vhub_dev) {
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_dev_release(dev: *mut device) {
    static void ast_vhub_dev_release(struct device *dev)
    {
    kfree(dev);
    }
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_init_dev(vhub: *mut ast_vhub, idx: c_uint) -> c_int {
