...
//! Source: drivers/usb/gadget/udc/aspeed-vhub/ep0.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_reply(ep: *mut ast_vhub_ep, ptr: *mut c_char, len: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __ast_vhub_simple_reply(ep: *mut ast_vhub_ep, len: c_int, ...) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_ep0_handle_setup(ep: *mut ast_vhub_ep) {
...
// If this is the vHub, we handle requests differently
    ...
    if (ep.dev == core::ptr::null_mut()) {
    if ((crq.bRequestType & USB_TYPE_MASK) == USB_TYPE_STANDARD)
    std_req_rc = ast_vhub_std_hub_request(ep, &crq);
#[no_mangle]
pub unsafe extern "C" fn if(USB_TYPE_CLASS: (crq.bRequestType & USB_TYPE_MASK) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_ep0_rx_prime(ep: *mut ast_vhub_ep) {
...
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_ep0_handle_ack(ep: *mut ast_vhub_ep, in_ack: bool) {
...
#[no_mangle]
unsafe extern "C" fn ast_vhub_ep0_dequeue(u_ep: *mut *mut usb_ep, u_req: *mut usb_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ast_vhub_reset_ep0(dev: *mut ast_vhub_dev) {
