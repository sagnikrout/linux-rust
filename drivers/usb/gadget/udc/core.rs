...
//! Source: drivers/usb/gadget/udc/core.c
#![no_std]
...
pub struct usb_udc {
    ...
    pub dev): *mut *mut void (gadget_release)(struct device,
    pub dev: device,
    pub list: list_head,
    pub vbus: bool,
    pub started: bool,
    pub allow_connect: bool,
    pub vbus_work: work_struct,
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_ep_enable(ep: *mut usb_ep) -> c_int {
...
// UDC drivers can't handle endpoints with maxpacket size 0
    ...
    (!ep.desc) ? "core::ptr::null_mut() descriptor" : "maxpacket 0");
    ret = -EINVAL;
    goto out;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_ep_disable(ep: *mut usb_ep) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_ep_dequeue(ep: *mut usb_ep, req: *mut usb_request) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_ep_set_halt(ep: *mut usb_ep) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_ep_clear_halt(ep: *mut usb_ep) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_ep_set_wedge(ep: *mut usb_ep) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_ep_fifo_status(ep: *mut usb_ep) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_ep_fifo_flush(ep: *mut usb_ep) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_frame_number(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_wakeup(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_set_remote_wakeup(gadget: *mut usb_gadget, set: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_set_selfpowered(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_clear_selfpowered(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_vbus_connect(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_vbus_draw(gadget: *mut usb_gadget, mA: unsigned) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_vbus_disconnect(gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_gadget_connect_locked(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_connect(gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_gadget_disconnect_locked(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_disconnect(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_deactivate(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_activate(gadget: *mut usb_gadget) -> c_int {
...
// -------------------------------------------------------------------------
    ...
    u8		type;
    u16		max;
    let mut num_req_streams: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_check_config(gadget: *mut usb_gadget) -> c_int {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn usb_gadget_state_work(work: *mut work_struct) {
    static void usb_gadget_state_work(struct work_struct *work)
    {
    struct usb_gadget *gadget = work_to_gadget(work);
    struct usb_udc *udc = gadget.udc;
    if (udc)
    sysfs_notify(&udc.dev.kobj, core::ptr::null_mut(), "state");
    }
...
#[no_mangle]
unsafe extern "C" fn usb_udc_connect_control_locked(__must_hold(&udc->connect_lock: *mut *mut usb_udc udc)) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vbus_event_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_udc_vbus_handler(gadget: *mut usb_gadget, status: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_udc_start_locked(udc: *mut usb_udc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_udc_stop_locked(udc: *mut usb_udc) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: gadget->ops->udc_set_speed) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_enable_async_callbacks(udc: *mut usb_udc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_disable_async_callbacks(udc: *mut usb_udc) {
...
//
#[no_mangle]
unsafe extern "C" fn usb_udc_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn usb_udc_nop_release(dev: *mut device) {
    static void usb_udc_nop_release(struct device *dev)
    {
    dev_vdbg(dev, "%s\n", __func__);
    }
#[no_mangle]
unsafe extern "C" fn usb_gadget_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_add_gadget(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_add_gadget_udc(parent: *mut device, gadget: *mut usb_gadget) -> c_int {
    int usb_add_gadget_udc(struct device *parent, struct usb_gadget *gadget)
    {
    return usb_add_gadget_udc_release(parent, gadget, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_del_gadget(gadget: *mut usb_gadget) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_del_gadget_udc(gadget: *mut usb_gadget) {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn gadget_match_driver(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gadget_bind_driver(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gadget_unbind_driver(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn usb_gadget_unregister_driver(driver: *mut usb_gadget_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_udc_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_udc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn usb_udc_exit() -> void __exit {
