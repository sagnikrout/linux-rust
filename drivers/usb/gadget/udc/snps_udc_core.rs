...
//! Source: drivers/usb/gadget/udc/snps_udc_core.c
#![no_std]
...
// tx buffer size for high speed
    let mut hs_tx_buf: static unsigned long = UDC_EPIN_BUFF_SIZE;
// ---------------------------------------------------------------------------
// Prints UDC device registers and endpoint irq registers
#[no_mangle]
unsafe extern "C" fn print_regs(dev: *mut udc) {
...
#[no_mangle]
pub unsafe extern "C" fn udc_mask_unused_interrupts(dev: *mut udc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udc_enable_ep0_interrupts(dev: *mut udc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn udc_enable_dev_setup_interrupts(dev: *mut udc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udc_set_txfifo_addr(ep: *mut udc_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn UDC_QUEUE_CNAK(ep: *mut udc_ep, num: unsigned) {
...
// Resets endpoint
#[no_mangle]
unsafe extern "C" fn ep_init(regs: *mut udc_regs __iomem, ep: *mut udc_ep) {
...
#[no_mangle]
unsafe extern "C" fn udc_ep_disable(usbep: *mut usb_ep) -> c_int {
    static int udc_ep_disable(struct usb_ep *usbep)
    {
    struct udc_ep	*ep = core::ptr::null_mut();
    unsigned long	iflags;
    if (!usbep)
    return -EINVAL;
    ep = container_of(usbep, struct udc_ep, ep);
...
// prevent from using desc. - set HOST BUSY
    ...
    req.td_data_last = core::ptr::null_mut();
    req.chain_len = 1;
    }
    return &req.req;
    }
...
#[no_mangle]
unsafe extern "C" fn udc_free_dma_chain(dev: *mut udc, req: *mut udc_request) {
    static void udc_free_dma_chain(struct udc *dev, struct udc_request *req)
    {
    struct udc_data_dma *td = req.td_data;
    unsigned int i;
    let mut addr_next: dma_addr_t = 0x00;
...
#[no_mangle]
unsafe extern "C" fn udc_init_bna_dummy(req: *mut udc_request) {
...
// Allocate BNA dummy descriptor
    static struct udc_request *udc_alloc_bna_dummy(struct udc_ep *ep)
    {
    struct udc_request *req = core::ptr::null_mut();
    struct usb_request *_req = core::ptr::null_mut();
...
// Write data to TX fifo for IN packets
    ...
    u32			*buf;
    int			i, j;
    let mut bytes: unsigned = 0;
    let mut remaining: unsigned = 0;
    if (!req || !ep)
    return;
...
#[no_mangle]
unsafe extern "C" fn udc_rxfifo_read_dwords(dev: *mut udc, buf: *mut u32, dwords: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udc_rxfifo_read_bytes(dev: *mut udc, buf: *mut u8, bytes: c_int) -> c_int {
...
// Creates or re-inits a DMA chain
    ...
    {
    let mut bytes: c_ulong = req.req.length;
    unsigned int i;
    dma_addr_t dma_addr;
    struct udc_data_dma	*td = core::ptr::null_mut();
    struct udc_data_dma	*last = core::ptr::null_mut();
    unsigned long txbytes;
    let mut create_new_chain: unsigned = 0;
    unsigned len;
...
#[no_mangle]
unsafe extern "C" fn prep_dma(ep: *mut udc_ep, req: *mut udc_request, gfp: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udc_get_ppbdu_rxbytes(req: *mut udc_request) -> u32 {
...
// Enabling RX DMA
#[no_mangle]
unsafe extern "C" fn udc_set_rde(dev: *mut udc) {
...
#[no_mangle]
pub unsafe extern "C" fn empty_req_queue(ep: *mut udc_ep) {
...
#[no_mangle]
unsafe extern "C" fn udc_dequeue(usbep: *mut usb_ep, usbreq: *mut usb_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udc_get_frame(gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udc_remote_wakeup(dev: *mut udc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udc_wakeup(gadget: *mut usb_gadget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn make_ep_lists(dev: *mut udc) {
...
#[no_mangle]
pub unsafe extern "C" fn if(USB_SPEED_HIGH: dev->gadget.speed ==) -> else {
...
// Inits UDC context
#[no_mangle]
pub unsafe extern "C" fn udc_basic_init(dev: *mut udc) {
...
#[no_mangle]
unsafe extern "C" fn startup_registers(dev: *mut udc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udc_setup_endpoints(dev: *mut udc) {
    static void udc_setup_endpoints(struct udc *dev)
    {
    struct udc_ep	*ep;
    u32	tmp;
...
#[no_mangle]
pub unsafe extern "C" fn if(UDC_DEVSTS_ENUM_SPEED_FULL: tmp ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn usb_connect(dev: *mut udc) {
...
//
#[no_mangle]
unsafe extern "C" fn usb_disconnect(dev: *mut udc) {
...
// Reset the UDC core
#[no_mangle]
unsafe extern "C" fn udc_soft_reset(dev: *mut udc) {
    static void udc_soft_reset(struct udc *dev)
    {
    unsigned long	flags;
    DBG(dev, "Soft reset\n");
...
#[no_mangle]
unsafe extern "C" fn udc_timer_function(unused: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn udc_handle_halt_state(ep: *mut udc_ep) {
...
#[no_mangle]
unsafe extern "C" fn udc_pollstall_timer_function(unused: *mut timer_list) {
    static void udc_pollstall_timer_function(struct timer_list *unused)
    {
    struct udc_ep *ep;
    let mut halted: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn activate_control_endpoints(dev: *mut udc) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: use_dma_ppb_du) -> else {
...
#[no_mangle]
unsafe extern "C" fn setup_ep0(dev: *mut udc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd5536_udc_stop(g: *mut usb_gadget) -> c_int {
    static int amd5536_udc_stop(struct usb_gadget *g)
    {
    struct udc *dev = to_amd5536_udc(g);
    unsigned long flags;
    ...
    spin_lock_irqsave(&dev.lock, flags);
    udc_mask_unused_interrupts(dev);
    shutdown(dev, core::ptr::null_mut());
    spin_unlock_irqrestore(&dev.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn udc_process_cnak_queue(dev: *mut udc) {
...
#[no_mangle]
unsafe extern "C" fn udc_ep0_set_rde(dev: *mut udc) {
...
#[no_mangle]
unsafe extern "C" fn udc_data_out_isr(dev: *mut udc, ep_ix: c_int) -> irqreturn_t {
    static irqreturn_t udc_data_out_isr(struct udc *dev, int ep_ix)
    {
    let mut ret_val: irqreturn_t = IRQ_NONE;
    u32			tmp;
    struct udc_ep		*ep;
    struct udc_request	*req;
    unsigned int		count;
...
#[no_mangle]
unsafe extern "C" fn udc_data_in_isr(dev: *mut udc, ep_ix: c_int) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn udc_control_out_isr(dev: *mut udc) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn udc_control_in_isr(dev: *mut udc) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn udc_dev_isr(dev: *mut udc, dev_irq: u32) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn udc_irq(irq: c_int, pdev: *mut c_void) -> irqreturn_t {
...
// Tears down device
#[no_mangle]
pub unsafe extern "C" fn gadget_release(pdev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn udc_remove(dev: *mut udc) {
...
// remove pollstall timer
    ...
    udc = core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(udc_remove);
// free all the dma pools
#[no_mangle]
pub unsafe extern "C" fn free_dma_pools(dev: *mut udc) {
...
#[no_mangle]
pub unsafe extern "C" fn init_dma_pools(dev: *mut udc) -> c_int {
...
// data: 0 packets !?
    ...
    err_alloc_dma:
    dma_pool_destroy(dev.stp_requests);
    dev.stp_requests = core::ptr::null_mut();
    err_create_dma_pool:
    dma_pool_destroy(dev.data_requests);
    dev.data_requests = core::ptr::null_mut();
    return retval;
    }
    EXPORT_SYMBOL_GPL(init_dma_pools);
// general probe
#[no_mangle]
pub unsafe extern "C" fn udc_probe(dev: *mut udc) -> c_int {
