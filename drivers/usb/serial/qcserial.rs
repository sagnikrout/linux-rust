...
//! Source: drivers/usb/serial/qcserial.c
#![no_std]
...
pub const QUECTEL_EC20_PID: c_uint = 0x9215;
...
#[no_mangle]
unsafe extern "C" fn handle_quectel_ec20(dev: *mut device, ifnum: c_int) -> c_int {
    static int handle_quectel_ec20(struct device *dev, int ifnum)
    {
    let mut altsetting: c_int = 0;
//
...
#[no_mangle]
unsafe extern "C" fn qcprobe(serial: *mut usb_serial, id: *const usb_device_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(2: serial->interface->num_altsetting >) -> else {
...
#[no_mangle]
unsafe extern "C" fn qc_attach(serial: *mut usb_serial) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qc_release(serial: *mut usb_serial) {
