...
//! Source: drivers/usb/serial/generic.c
#![no_std]
...
//
    ...
    let mut vendor: static __u16 = 0x05f9;
    let mut product: static __u16 = 0xffff;
    ...
    &usb_serial_generic_device, core::ptr::null_mut()
    };

#[no_mangle]
pub unsafe extern "C" fn usb_serial_generic_register() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn usb_serial_generic_open(tty: *mut tty_struct, port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn usb_serial_generic_tiocmiwait(tty: *mut tty_struct, arg: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn usb_serial_handle_sysrq_char(port: *mut usb_serial_port, ch: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn usb_serial_handle_break(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(!C_CLOCAL(tty): tty &&) -> else {
    else if (tty && !C_CLOCAL(tty))
    tty_hangup(tty);
    }
    EXPORT_SYMBOL_GPL(usb_serial_handle_dcd_change);
#[no_mangle]
pub unsafe extern "C" fn usb_serial_generic_resume(serial: *mut usb_serial) -> c_int {
