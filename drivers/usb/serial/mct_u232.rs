...
//! Source: drivers/usb/serial/mct_u232.h
#![no_std]
...
//
pub const MCT_U232_VID: c_uint = 0x0711	/* Vendor Id */;
pub const MCT_U232_PID: c_uint = 0x0210	/* Original MCT Product Id */;
// U232-P25, Sitecom
pub const MCT_U232_SITECOM_PID: c_uint = 0x0230	/* Sitecom Product Id */;
// DU-H3SP USB BAY hub
pub const MCT_U232_DU_H3SP_PID: c_uint = 0x0200	/* D-Link DU-H3SP USB BAY */;
// Belkin badge the MCT U232-P9 as the F5U109
pub const MCT_U232_BELKIN_F5U109_VID: c_uint = 0x050d	/* Vendor Id */;
pub const MCT_U232_BELKIN_F5U109_PID: c_uint = 0x0109	/* Product Id */;
//
// Vendor Request Interface
//
pub const MCT_U232_SET_REQUEST_TYPE: c_uint = 0x40;
pub const MCT_U232_GET_REQUEST_TYPE: c_uint = 0xc0;
// Get Modem Status Register (MSR)
pub const MCT_U232_GET_MODEM_STAT_REQUEST: c_int = 2;
pub const MCT_U232_GET_MODEM_STAT_SIZE: c_int = 1;
// Get Line Control Register (LCR)
// ... not used by this driver
pub const MCT_U232_GET_LINE_CTRL_REQUEST: c_int = 6;
pub const MCT_U232_GET_LINE_CTRL_SIZE: c_int = 1;
// Set Baud Rate Divisor
pub const MCT_U232_SET_BAUD_RATE_REQUEST: c_int = 5;
pub const MCT_U232_SET_BAUD_RATE_SIZE: c_int = 4;
// Set Line Control Register (LCR)
pub const MCT_U232_SET_LINE_CTRL_REQUEST: c_int = 7;
pub const MCT_U232_SET_LINE_CTRL_SIZE: c_int = 1;
// Set Modem Control Register (MCR)
pub const MCT_U232_SET_MODEM_CTRL_REQUEST: c_int = 10;
pub const MCT_U232_SET_MODEM_CTRL_SIZE: c_int = 1;
//
...
pub const MCT_U232_SET_UNKNOWN1_SIZE: c_int = 1;
//
...
//
pub const MCT_U232_SET_CTS_REQUEST: c_int = 12;
pub const MCT_U232_SET_CTS_SIZE: c_int = 1;
...
//
pub const MCT_U232_SET_BREAK: c_uint = 0x40;
pub const MCT_U232_PARITY_SPACE: c_uint = 0x38;
pub const MCT_U232_PARITY_MARK: c_uint = 0x28;
pub const MCT_U232_PARITY_EVEN: c_uint = 0x18;
pub const MCT_U232_PARITY_ODD: c_uint = 0x08;
pub const MCT_U232_PARITY_NONE: c_uint = 0x00;
pub const MCT_U232_DATA_BITS_5: c_uint = 0x00;
pub const MCT_U232_DATA_BITS_6: c_uint = 0x01;
pub const MCT_U232_DATA_BITS_7: c_uint = 0x02;
pub const MCT_U232_DATA_BITS_8: c_uint = 0x03;
pub const MCT_U232_STOP_BITS_2: c_uint = 0x04;
pub const MCT_U232_STOP_BITS_1: c_uint = 0x00;
//
// Modem Control Register (MCR)
//
pub const MCT_U232_MCR_NONE: c_uint = 0x8     /* Deactivate DTR and RTS */;
pub const MCT_U232_MCR_RTS: c_uint = 0xa     /* Activate RTS */;
pub const MCT_U232_MCR_DTR: c_uint = 0x9     /* Activate DTR */;
//
// Modem Status Register (MSR)
//
pub const MCT_U232_MSR_INDEX: c_uint = 0x0     /* data[index] */;
pub const MCT_U232_MSR_CD: c_uint = 0x80    /* Current CD */;
pub const MCT_U232_MSR_RI: c_uint = 0x40    /* Current RI */;
pub const MCT_U232_MSR_DSR: c_uint = 0x20    /* Current DSR */;
pub const MCT_U232_MSR_CTS: c_uint = 0x10    /* Current CTS */;
pub const MCT_U232_MSR_DCD: c_uint = 0x08    /* Delta CD */;
pub const MCT_U232_MSR_DRI: c_uint = 0x04    /* Delta RI */;
pub const MCT_U232_MSR_DDSR: c_uint = 0x02    /* Delta DSR */;
pub const MCT_U232_MSR_DCTS: c_uint = 0x01    /* Delta CTS */;
//
// Line Status Register (LSR)
//

pub const MCT_U232_LSR_ERR: c_uint = 0x80	/* OE | PE | FE | BI */;
pub const MCT_U232_LSR_TEMT: c_uint = 0x40	/* transmit register empty */;
pub const MCT_U232_LSR_THRE: c_uint = 0x20	/* transmit holding register empty */;
pub const MCT_U232_LSR_BI: c_uint = 0x10	/* break indicator */;
pub const MCT_U232_LSR_FE: c_uint = 0x08	/* framing error */;
pub const MCT_U232_LSR_OE: c_uint = 0x02	/* overrun error */;
pub const MCT_U232_LSR_PE: c_uint = 0x04	/* parity error */;
pub const MCT_U232_LSR_OE: c_uint = 0x02	/* overrun error */;
pub const MCT_U232_LSR_DR: c_uint = 0x01	/* receive data ready */;
// -----------------------------------------------------------------------------
