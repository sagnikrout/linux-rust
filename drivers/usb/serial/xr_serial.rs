...
//! Source: drivers/usb/serial/xr_serial.c
#![no_std]
...
pub const XR21V141X_UART_REG_BLOCK: c_int = 0;
pub const XR21V141X_UM_REG_BLOCK: c_int = 4;
pub const XR21V141X_UART_CUSTOM_BLOCK: c_uint = 0x66;
// XR21V141X UART registers
pub const XR21V141X_CLOCK_DIVISOR_0: c_uint = 0x04;
pub const XR21V141X_CLOCK_DIVISOR_1: c_uint = 0x05;
pub const XR21V141X_CLOCK_DIVISOR_2: c_uint = 0x06;
pub const XR21V141X_TX_CLOCK_MASK_0: c_uint = 0x07;
pub const XR21V141X_TX_CLOCK_MASK_1: c_uint = 0x08;
pub const XR21V141X_RX_CLOCK_MASK_0: c_uint = 0x09;
pub const XR21V141X_RX_CLOCK_MASK_1: c_uint = 0x0a;
pub const XR21V141X_REG_FORMAT: c_uint = 0x0b;
// XR21V141X UART Manager registers
pub const XR21V141X_UM_FIFO_ENABLE_REG: c_uint = 0x10;
pub const XR21V141X_UM_ENABLE_TX_FIFO: c_uint = 0x01;
pub const XR21V141X_UM_ENABLE_RX_FIFO: c_uint = 0x02;
pub const XR21V141X_UM_RX_FIFO_RESET: c_uint = 0x18;
pub const XR21V141X_UM_TX_FIFO_RESET: c_uint = 0x1c;
pub const XR_UART_ENABLE_TX: c_uint = 0x1;
pub const XR_UART_ENABLE_RX: c_uint = 0x2;

pub const XR_UART_DATA_7: c_uint = 0x7;
pub const XR_UART_DATA_8: c_uint = 0x8;

pub const XR_UART_PARITY_SHIFT: c_int = 4;

pub const XR_UART_STOP_SHIFT: c_int = 7;

pub const XR_UART_FLOW_MODE_NONE: c_uint = 0x0;
pub const XR_UART_FLOW_MODE_HW: c_uint = 0x1;
pub const XR_UART_FLOW_MODE_SW: c_uint = 0x2;

pub const XR_GPIO_MODE_SEL_RTS_CTS: c_uint = 0x1;
pub const XR_GPIO_MODE_SEL_DTR_DSR: c_uint = 0x2;
pub const XR_GPIO_MODE_SEL_RS485: c_uint = 0x3;
pub const XR_GPIO_MODE_SEL_RS485_ADDR: c_uint = 0x4;
pub const XR_GPIO_MODE_RS485_TX_H: c_uint = 0x8;
pub const XR_GPIO_MODE_TX_TOGGLE: c_uint = 0x100;
pub const XR_GPIO_MODE_RX_TOGGLE: c_uint = 0x200;
pub const XR_FIFO_RESET: c_uint = 0x1;
pub const XR_CUSTOM_DRIVER_ACTIVE: c_uint = 0x1;
...
pub struct xr_type {
    ...
    pub tx_break: u16,
    pub gpio_mode: u16,
    pub gpio_direction: u16,
    pub gpio_set: u16,
    pub gpio_clear: u16,
    pub gpio_status: u16,
    pub tx_fifo_reset: u16,
    pub rx_fifo_reset: u16,
    pub custom_driver: u16,
    pub have_5_6_bit_mode: bool,
    pub have_xmit_toggle: bool,
    pub port): *mut *mut int (enable)(struct usb_serial_port,
    pub port): *mut *mut int (disable)(struct usb_serial_port,
    pub port): *mut *mut int (fifo_reset)(struct usb_serial_port,
    void (*set_line_settings)(struct tty_struct *tty,
    struct usb_serial_port *port,
    pub old_termios): *const ktermios,
}
...
#[derive(Copy, Clone)]
pub struct xr_data {
    pub type: *const xr_type,
    pub /: *mut *mut u8 channel; / zero-based index or interface number,
    pub rs485: serial_rs485,
}

#[no_mangle]
unsafe extern "C" fn xr_set_reg(port: *mut usb_serial_port, channel: u8, reg: u16, val: u16) -> c_int {
    ...
    val, (channel << 8) | reg, core::ptr::null_mut(), 0,
...
#[no_mangle]
unsafe extern "C" fn xr_get_reg(port: *mut usb_serial_port, channel: u8, reg: u16, val: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xr_set_reg_uart(port: *mut usb_serial_port, reg: u16, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xr_get_reg_uart(port: *mut usb_serial_port, reg: u16, val: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xr_set_reg_um(port: *mut usb_serial_port, reg_base: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __xr_uart_enable(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __xr_uart_disable(port: *mut usb_serial_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xr21v141x_uart_enable(port: *mut usb_serial_port) -> c_int {
    static int xr21v141x_uart_enable(struct usb_serial_port *port)
    {
    int ret;
...
#[no_mangle]
unsafe extern "C" fn xr21v141x_uart_disable(port: *mut usb_serial_port) -> c_int {
    static int xr21v141x_uart_disable(struct usb_serial_port *port)
    {
    int ret;
...
#[no_mangle]
unsafe extern "C" fn xr_uart_enable(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xr_uart_disable(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xr21v141x_fifo_reset(port: *mut usb_serial_port) -> c_int {
    static int xr21v141x_fifo_reset(struct usb_serial_port *port)
    {
    int ret;
...
#[no_mangle]
unsafe extern "C" fn xr_fifo_reset(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xr_tiocmget(tty: *mut tty_struct) -> c_int {
...
//
    ...
    struct xr_data *data = usb_get_serial_port_data(port);
    const struct xr_type *type = data.type;
    let mut gpio_set: u16 = 0;
    let mut gpio_clr: u16 = 0;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn xr_dtr_rts(port: *mut usb_serial_port, on: c_int) {
...
#[no_mangle]
unsafe extern "C" fn xr_break_ctl(tty: *mut tty_struct, break_state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xr21v141x_set_baudrate(tty: *mut tty_struct, port: *mut usb_serial_port) -> c_int {
...
// Set GPIO mode for controlling the pins manually by default.
    ...
    let mut start_char: u8 = START_CHAR(tty);
    let mut stop_char: u8 = STOP_CHAR(tty);
...
#[no_mangle]
unsafe extern "C" fn xr_sanitize_serial_rs485(rs485: *mut serial_rs485) {
...
// Only the flags are implemented at the moment
    ...
    data.rs485 = rs485;
    xr_set_flow_mode(tty, port, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn xr_ioctl(tty: *mut tty_struct, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xr_open(tty: *mut tty_struct, port: *mut usb_serial_port) -> c_int {
...
// Setup termios
    if (tty)
    xr_set_termios(tty, port, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn xr_close(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn xr_probe(serial: *mut usb_serial, id: *const usb_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xr_gpio_init(port: *mut usb_serial_port, type: *const xr_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xr_port_probe(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xr_port_remove(port: *mut usb_serial_port) {
