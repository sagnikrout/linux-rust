...
//! Source: drivers/usb/serial/f81232.c
#![no_std]
...
pub const F81232_MAX_BAUDRATE: c_int = 1500000;
pub const F81232_DEF_BAUDRATE: c_int = 9600;
// USB Control EP parameter
pub const F81232_REGISTER_REQUEST: c_uint = 0xa0;
pub const F81232_GET_REGISTER: c_uint = 0xc0;
pub const F81232_SET_REGISTER: c_uint = 0x40;
pub const SERIAL_BASE_ADDRESS: c_uint = 0x0120;
...
// 11: 14.77MHz.
//
pub const F81232_CLK_REGISTER: c_uint = 0x106;
pub const F81232_CLK_1_846_MHZ: c_int = 0;

pub const F81534A_MODE_REG: c_uint = 0x107;

// Serial port self GPIO control, 2bytes [control&output data][input data]
pub const F81534A_GPIO_REG: c_uint = 0x10e;

pub const F81534A_CTRL_CMD_ENABLE_PORT: c_uint = 0x116;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct f81232_private {
    pub lock: mutex,
    pub modem_control: u8,
    pub modem_status: u8,
    pub shadow_lcr: u8,
    pub baud_base: speed_t,
...
#[no_mangle]
unsafe extern "C" fn calc_baud_divisor(baudrate: speed_t, clockrate: speed_t) -> c_int {
    static int calc_baud_divisor(speed_t baudrate, speed_t clockrate)
    {
    return DIV_ROUND_CLOSEST(clockrate, baudrate);
    }
#[no_mangle]
unsafe extern "C" fn f81232_get_register(port: *mut usb_serial_port, reg: u16, val: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f81232_set_register(port: *mut usb_serial_port, reg: u16, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f81232_read_msr(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn f81232_read_int_callback(urb: *mut urb) {
    static void f81232_read_int_callback(struct urb *urb)
    {
    struct usb_serial_port *port =  urb.context;
    unsigned char *data = urb.transfer_buffer;
    let mut actual_length: c_uint = urb.actual_length;
...
#[no_mangle]
unsafe extern "C" fn f81232_handle_lsr(port: *mut usb_serial_port, lsr: u8) -> c_char {
    static char f81232_handle_lsr(struct usb_serial_port *port, u8 lsr)
    {
    struct f81232_private *priv = usb_get_serial_port_data(port);
    let mut tty_flag: c_char = TTY_NORMAL;
...
#[no_mangle]
unsafe extern "C" fn f81232_process_read_urb(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn f81534a_process_read_urb(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn f81232_break_ctl(tty: *mut tty_struct, break_state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f81232_find_clk(baudrate: speed_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f81232_port_enable(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f81232_port_disable(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f81232_tiocmget(tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f81232_open(tty: *mut tty_struct, port: *mut usb_serial_port) -> c_int {
...
// Setup termios
    if (tty)
    f81232_set_termios(tty, port, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn f81534a_open(tty: *mut tty_struct, port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f81232_close(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn f81232_dtr_rts(port: *mut usb_serial_port, on: c_int) {
...
#[no_mangle]
unsafe extern "C" fn f81232_tx_empty(port: *mut usb_serial_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn f81232_carrier_raised(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f81232_get_serial(tty: *mut tty_struct, ss: *mut serial_struct) {
...
#[no_mangle]
unsafe extern "C" fn f81232_interrupt_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn f81232_lsr_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn f81534a_ctrl_enable_all_ports(intf: *mut usb_interface, en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f81534a_ctrl_disconnect(intf: *mut usb_interface) {
    static void f81534a_ctrl_disconnect(struct usb_interface *intf)
    {
    f81534a_ctrl_enable_all_ports(intf, false);
    }
#[no_mangle]
unsafe extern "C" fn f81534a_ctrl_resume(intf: *mut usb_interface) -> c_int {
    static int f81534a_ctrl_resume(struct usb_interface *intf)
    {
    return f81534a_ctrl_enable_all_ports(intf, true);
    }
#[no_mangle]
unsafe extern "C" fn f81232_port_probe(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f81534a_port_probe(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f81232_suspend(serial: *mut usb_serial, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f81232_resume(serial: *mut usb_serial) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f81232_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn f81232_exit() -> void __exit {
