...
//! Source: drivers/usb/serial/opticon.c
#![no_std]
...
pub const CONTROL_RTS: c_uint = 0x02;
pub const RESEND_CTS_STATE: c_uint = 0x03;
// max number of write urbs in flight
pub const URB_UPPER_LIMIT: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn opticon_process_read_urb(urb: *mut urb) {
    ...
    let mut data_len: usize = urb.actual_length - 2;
...
#[no_mangle]
unsafe extern "C" fn opticon_open(tty: *mut tty_struct, port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opticon_close(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn opticon_write_control_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn opticon_write_room(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn opticon_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn opticon_tiocmget(tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opticon_port_probe(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opticon_port_remove(port: *mut usb_serial_port) {
    ...
    &opticon_device, core::ptr::null_mut()
    };
