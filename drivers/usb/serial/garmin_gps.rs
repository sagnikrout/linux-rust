...
//! Source: drivers/usb/serial/garmin_gps.c
#![no_std]
...
pub const GARMIN_LAYERID_TRANSPORT: c_int = 0;
pub const GARMIN_LAYERID_APPL: c_int = 20;
// our own layer-id to use for some control mechanisms
pub const GARMIN_LAYERID_PRIVATE: c_uint = 0x01106E4B;
pub const GARMIN_PKTID_PVT_DATA: c_int = 51;
pub const GARMIN_PKTID_L001_COMMAND_DATA: c_int = 10;
pub const CMND_ABORT_TRANSFER: c_int = 0;
// packet ids used in private layer
pub const PRIV_PKTID_SET_DEBUG: c_int = 1;
pub const PRIV_PKTID_SET_MODE: c_int = 2;
pub const PRIV_PKTID_INFO_REQ: c_int = 3;
pub const PRIV_PKTID_INFO_RESP: c_int = 4;
pub const PRIV_PKTID_RESET_REQ: c_int = 5;
pub const PRIV_PKTID_SET_DEF_MODE: c_int = 6;
pub const ETX: c_uint = 0x03;
pub const DLE: c_uint = 0x10;
pub const ACK: c_uint = 0x06;
pub const NAK: c_uint = 0x15;
// structure used to queue incoming packets
#[repr(C)]
#[derive(Copy, Clone)]
pub struct garmin_packet {
    pub list: list_head,
    pub seq: c_int,
// the real size of the data array, always > 0
    pub size: c_int,
    pub __counted_by(size): __u8 data[],
}

// structure used to keep the current state of the driver
#[repr(C)]
#[derive(Copy, Clone)]
pub struct garmin_data {
    pub state: __u8,
    pub flags: __u16,
    pub mode: __u8,
    pub count: __u8,
    pub pkt_id: __u8,
    pub serial_num: __u32,
    pub timer: timer_list,
    pub port: *mut usb_serial_port,
    pub seq_counter: c_int,
    pub insize: c_int,
    pub outsize: c_int,
    pub /: *mut *mut __u8 inbuffer [GPS_IN_BUFSIZ]; / tty -> usb,
    pub /: *mut *mut __u8 outbuffer[GPS_OUT_BUFSIZ]; / usb -> tty,
    pub privpkt: [*mut __u8; 4*6],
    pub lock: spinlock_t,
    pub pktlist: list_head,
    pub write_urbs: usb_anchor,
}

pub const STATE_NEW: c_int = 0;
pub const STATE_INITIAL_DELAY: c_int = 1;
pub const STATE_TIMEOUT: c_int = 2;
pub const STATE_SESSION_REQ1: c_int = 3;
pub const STATE_SESSION_REQ2: c_int = 4;
pub const STATE_ACTIVE: c_int = 5;
pub const STATE_RESET: c_int = 8;
pub const STATE_DISCONNECTED: c_int = 9;
pub const STATE_WAIT_TTY_ACK: c_int = 10;
pub const STATE_GSP_WAIT_DATA: c_int = 11;
pub const MODE_NATIVE: c_int = 0;
pub const MODE_GARMIN_SERIAL: c_int = 1;
// Flags used in garmin_data.flags:
pub const FLAGS_SESSION_REPLY_MASK: c_uint = 0x00C0;
pub const FLAGS_SESSION_REPLY1_SEEN: c_uint = 0x0080;
pub const FLAGS_SESSION_REPLY2_SEEN: c_uint = 0x0040;
pub const FLAGS_BULK_IN_ACTIVE: c_uint = 0x0020;
pub const FLAGS_BULK_IN_RESTART: c_uint = 0x0010;
pub const FLAGS_THROTTLED: c_uint = 0x0008;
pub const APP_REQ_SEEN: c_uint = 0x0004;
pub const APP_RESP_SEEN: c_uint = 0x0002;
pub const CLEAR_HALT_REQUIRED: c_uint = 0x0001;
pub const FLAGS_QUEUING: c_uint = 0x0100;
pub const FLAGS_DROP_DATA: c_uint = 0x0800;
pub const FLAGS_GSP_SKIP: c_uint = 0x1000;
pub const FLAGS_GSP_DLESEEN: c_uint = 0x2000;
// function prototypes
...
#[no_mangle]
pub unsafe extern "C" fn getLayerId(usbPacket: *const __u8) -> c_int {
    static inline int getLayerId(const __u8 *usbPacket)
    {
    return __le32_to_cpup((__le32 *)(usbPacket));
    }
#[no_mangle]
pub unsafe extern "C" fn getPacketId(usbPacket: *const __u8) -> c_int {
    static inline int getPacketId(const __u8 *usbPacket)
    {
    return __le32_to_cpup((__le32 *)(usbPacket+4));
    }
#[no_mangle]
pub unsafe extern "C" fn getDataLength(usbPacket: *const __u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn isAbortTrfCmnd(buf: *const c_uchar) -> c_int {
...
// get the next pending packet
    ...
    {
    unsigned long flags;
    struct garmin_packet *result = core::ptr::null_mut();
    spin_lock_irqsave(&garmin_data_p.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn pkt_clear(garmin_data_p: *mut garmin_data) {
...
#[no_mangle]
unsafe extern "C" fn gsp_send_ack(garmin_data_p: *mut garmin_data, pkt_id: __u8) -> c_int {
    static int gsp_send_ack(struct garmin_data *garmin_data_p, __u8 pkt_id)
    {
    __u8 pkt[10];
    let mut cksum: __u8 = 0;
    __u8 *ptr = pkt;
    let mut l: unsigned = 0;
...
//
#[no_mangle]
unsafe extern "C" fn gsp_rec_packet(garmin_data_p: *mut garmin_data, count: c_int) -> c_int {
    ...
    let mut cksum: c_int = 0;
    let mut n: c_int = 0;
    let mut pktid: c_int = recpkt[0];
    let mut size: c_int = recpkt[1];
...
//
    ...
    let mut ack_or_nak_seen: c_int = 0;
    __u8 *dest;
    int size;
...
//
#[no_mangle]
unsafe extern "C" fn gsp_next_packet(garmin_data_p: *mut garmin_data) -> c_int {
    static int gsp_next_packet(struct garmin_data *garmin_data_p)
    {
    let mut result: c_int = 0;
    struct garmin_packet *pkt = core::ptr::null_mut();
    while ((pkt = pkt_pop(garmin_data_p)) != core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn priv_status_resp(port: *mut usb_serial_port) {
...
//
#[no_mangle]
unsafe extern "C" fn process_resetdev_request(port: *mut usb_serial_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn garmin_clear(garmin_data_p: *mut garmin_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn garmin_init_session(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn garmin_open(tty: *mut tty_struct, port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn garmin_close(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn garmin_write_bulk_callback(urb: *mut urb) {
...
// free up the transfer buffer, as usb_free_urb() does not do this
    ...
    dismiss_ack ? core::ptr::null_mut() : port);
...
#[no_mangle]
unsafe extern "C" fn garmin_write_room(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn garmin_read_bulk_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn garmin_read_int_callback(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn garmin_flush_queue(garmin_data_p: *mut garmin_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn garmin_throttle(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn garmin_unthrottle(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn timeout_handler(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn garmin_port_probe(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn garmin_port_remove(port: *mut usb_serial_port) {
...
// All of the device info needed
    ...
    &garmin_device, core::ptr::null_mut()
    };
