...
//! Source: drivers/usb/serial/ir-usb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ir_xbof_change(xbof: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ir_startup(serial: *mut usb_serial) -> c_int {
    static int ir_startup(struct usb_serial *serial)
    {
...
#[no_mangle]
unsafe extern "C" fn ir_write_bulk_callback(urb: *mut urb) {
    static void ir_write_bulk_callback(struct urb *urb)
    {
...
#[no_mangle]
unsafe extern "C" fn ir_write_room(tty: *mut tty_struct) -> c_uint {
    static unsigned int ir_write_room(struct tty_struct *tty)
    {
...
#[no_mangle]
unsafe extern "C" fn ir_process_read_urb(urb: *mut urb) {
    static void ir_process_read_urb(struct urb *urb)
    {
    struct usb_serial_port *port = urb.context;
...
#[no_mangle]
unsafe extern "C" fn ir_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ir_exit() -> void __exit {
