...
//! Source: drivers/usb/serial/sierra.c
#![no_std]
...
pub const SWIMS_USB_REQUEST_SetPower: c_uint = 0x00;
pub const SWIMS_USB_REQUEST_SetNmea: c_uint = 0x07;
pub const N_IN_URB_HM: c_int = 8;
pub const N_OUT_URB_HM: c_int = 64;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sierra_iface_list {
    pub /: *const *const *const u8 nums; / array of interface numbers,
    pub /: *mut *mut size_t count; / number of elements in array,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sierra_intf_private {
...
#[no_mangle]
unsafe extern "C" fn sierra_set_power_state(udev: *mut usb_device, swiState: __u16) -> c_int {
    ...
    0,				/* __u16 index       */
    core::ptr::null_mut(),				/* void *data        */
    0,				/* __u16 size 	     */
    USB_CTRL_SET_TIMEOUT);		/* int timeout 	     */
    }
#[no_mangle]
unsafe extern "C" fn sierra_vsc_set_nmea(udev: *mut usb_device, enable: __u16) -> c_int {
...
// Dummy interface present on some SKUs should be ignored
    ...
    num_ports = 0;
#[no_mangle]
pub unsafe extern "C" fn if(3: numendpoints <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn is_listed(ifnum: u8, list: *const sierra_iface_list) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sierra_interface_num(serial: *mut usb_serial) -> u8 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sierra_port_private {
    pub /: *mut *mut spinlock_t lock; / lock the structure,
    pub /: *mut *mut int outstanding_urbs; / number of out urbs in flight,
    pub active: usb_anchor,
    pub delayed: usb_anchor,
    pub num_out_urbs: c_int,
    pub num_in_urbs: c_int,
// Input endpoints and buffers for this port
    pub in_urbs: [*mut urb; N_IN_URB_HM],
...
#[no_mangle]
unsafe extern "C" fn sierra_send_setup(port: *mut usb_serial_port) -> c_int {
    static int sierra_send_setup(struct usb_serial_port *port)
    {
    struct usb_serial *serial = port.serial;
    struct sierra_port_private *portdata;
    let mut interface: __u16 = 0;
    let mut val: c_int = 0;
    let mut do_send: c_int = 0;
    int retval;
...
// Otherwise the need to do non-composite mapping
    ...
    interface = 0;
#[no_mangle]
pub unsafe extern "C" fn if(4: port->bulk_out_endpointAddress ==) -> else {
    else if (port.bulk_out_endpointAddress == 4)
    interface = 1;
#[no_mangle]
pub unsafe extern "C" fn if(5: port->bulk_out_endpointAddress ==) -> else {
    ...
    0x22, 0x21, val, interface, core::ptr::null_mut(), 0, USB_CTRL_SET_TIMEOUT);
    usb_autopm_put_interface(serial.interface);
    return retval;
    }
#[no_mangle]
unsafe extern "C" fn sierra_tiocmget(tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sierra_release_urb(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn sierra_outdat_callback(urb: *mut urb) {
...
// Write
    ...
    struct urb *urb;
    let mut writesize: usize = min_t(size_t, count, MAX_TRANSFER);
...
#[no_mangle]
unsafe extern "C" fn sierra_indat_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn sierra_instat_callback(urb: *mut urb) {
    ...
    if (!req_pkt) {
    dev_dbg(&port.dev, "%s: core::ptr::null_mut() req_pkt\n",
    __func__);
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn sierra_write_room(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn sierra_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn sierra_stop_rx_urbs(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn sierra_submit_rx_urbs(port: *mut usb_serial_port, mem_flags: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sierra_close(port: *mut usb_serial_port) {
...
//
    ...
    portdata.in_urbs[i] = core::ptr::null_mut();
    }
    usb_autopm_get_interface_no_resume(serial.interface);
    }
#[no_mangle]
unsafe extern "C" fn sierra_open(tty: *mut tty_struct, port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sierra_dtr_rts(port: *mut usb_serial_port, on: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sierra_startup(serial: *mut usb_serial) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sierra_release(serial: *mut usb_serial) {
...
#[no_mangle]
unsafe extern "C" fn sierra_port_probe(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sierra_port_remove(port: *mut usb_serial_port) {
    static void sierra_port_remove(struct usb_serial_port *port)
    {
    struct sierra_port_private *portdata;
    portdata = usb_get_serial_port_data(port);
    usb_set_serial_port_data(port, core::ptr::null_mut());
    kfree(portdata);
    }

#[no_mangle]
unsafe extern "C" fn stop_read_write_urbs(serial: *mut usb_serial) {
...
#[no_mangle]
unsafe extern "C" fn sierra_suspend(serial: *mut usb_serial, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sierra_submit_delayed_urbs(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sierra_resume(serial: *mut usb_serial) -> c_int {
    ...
    &sierra_device, core::ptr::null_mut()
    };
