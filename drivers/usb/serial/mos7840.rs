...
//! Source: drivers/usb/serial/mos7840.c
#![no_std]
...
pub const MOS7840_MSR_CTS: c_uint = 0x10	/* Current state of CTS */;
pub const MOS7840_MSR_DSR: c_uint = 0x20	/* Current state of DSR */;
pub const MOS7840_MSR_RI: c_uint = 0x40	/* Current state of RI */;
pub const MOS7840_MSR_CD: c_uint = 0x80	/* Current state of CD */;
//
// Defines used for sending commands to port
//

// Requests
pub const MCS_RD_RTYPE: c_uint = 0xC0;
pub const MCS_WR_RTYPE: c_uint = 0x40;
pub const MCS_RDREQ: c_uint = 0x0D;
pub const MCS_WRREQ: c_uint = 0x0E;

pub const ZLP_REG1: c_uint = 0x3A		/* Zero_Flag_Reg1    58 */;
pub const ZLP_REG5: c_uint = 0x3E		/* Zero_Flag_Reg5    62 */;
//
// Vendor id and device id defines
//
// NOTE: Do not add new defines, add entries directly to the id_table instead.
//
pub const USB_VENDOR_ID_BANDB: c_uint = 0x0856;
pub const BANDB_DEVICE_ID_USO9ML2_2: c_uint = 0xAC22;
pub const BANDB_DEVICE_ID_USO9ML2_2P: c_uint = 0xBC00;
pub const BANDB_DEVICE_ID_USO9ML2_4: c_uint = 0xAC24;
pub const BANDB_DEVICE_ID_USO9ML2_4P: c_uint = 0xBC01;
pub const BANDB_DEVICE_ID_US9ML2_2: c_uint = 0xAC29;
pub const BANDB_DEVICE_ID_US9ML2_4: c_uint = 0xAC30;
pub const BANDB_DEVICE_ID_USPTL4_2: c_uint = 0xAC31;
pub const BANDB_DEVICE_ID_USPTL4_4: c_uint = 0xAC32;
pub const BANDB_DEVICE_ID_USOPTL4_2: c_uint = 0xAC42;
pub const BANDB_DEVICE_ID_USOPTL4_2P: c_uint = 0xBC02;
pub const BANDB_DEVICE_ID_USOPTL4_4: c_uint = 0xAC44;
pub const BANDB_DEVICE_ID_USOPTL4_4P: c_uint = 0xBC03;
...
//
pub const SERIAL_LSR_DR: c_uint = 0x0001;
pub const SERIAL_LSR_OE: c_uint = 0x0002;
pub const SERIAL_LSR_PE: c_uint = 0x0004;
pub const SERIAL_LSR_FE: c_uint = 0x0008;
pub const SERIAL_LSR_BI: c_uint = 0x0010;
pub const MOS_MSR_DELTA_CTS: c_uint = 0x10;
pub const MOS_MSR_DELTA_DSR: c_uint = 0x20;
pub const MOS_MSR_DELTA_RI: c_uint = 0x40;
pub const MOS_MSR_DELTA_CD: c_uint = 0x80;
...
pub const LED_ON_MS: c_int = 500;
pub const LED_OFF_MS: c_int = 500;
    enum mos7840_flag {
...
pub struct moschip_port {
    pub /: *mut *mut int port_num; /Actual port number in the device(1,2,etc),
    pub /: *mut *mut *mut urb read_urb; / read URB for this port,
    pub /: *mut *mut __u8 shadowLCR; / last LCR value received,
    pub /: *mut *mut __u8 shadowMCR; / last MCR value received,
    pub /: *mut *mut *mut usb_serial_port port; / loop back to the owner of this object,
// Offsets
    pub SpRegOffset: __u8,
    pub ControlRegOffset: __u8,
    pub DcrRegOffset: __u8,
    pub pool_lock: spinlock_t,
    pub write_urb_pool: [*mut urb; NUM_URBS],
    pub busy: [c_char; NUM_URBS],
    pub read_urb_busy: bool,
// For device(s) with LED indicator
    pub has_led: bool,
    pub /: *mut *mut timer_list led_timer1; / Timer for LED on,
    pub /: *mut *mut timer_list led_timer2; / Timer for LED off,
    pub led_urb: *mut urb,
    pub led_dr: *mut usb_ctrlrequest,
    pub flags: c_ulong,
}
...
//
    ...
    MCS_WR_RTYPE, val, reg, core::ptr::null_mut(), 0,
    MOS_WDR_TIMEOUT);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn mos7840_set_led_callback(urb: *mut urb) {
...
// This urb is terminated, clean up
    ...
    (unsigned char *)dr, core::ptr::null_mut(), 0, mos7840_set_led_callback, core::ptr::null_mut());
    ...
    val, reg, core::ptr::null_mut(), 0, MOS_WDR_TIMEOUT);
    }
#[no_mangle]
unsafe extern "C" fn mos7840_led_off(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn mos7840_led_flag_off(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn mos7840_led_activity(port: *mut usb_serial_port) {
...
//
#[no_mangle]
unsafe extern "C" fn mos7840_bulk_in_callback(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn mos7840_bulk_out_data_callback(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn mos7840_open(tty: *mut tty_struct, port: *mut usb_serial_port) -> c_int {
...
// Initialising the write urb pool
    ...
    usb_free_urb(urb);
    mos7840_port.write_urb_pool[j] = core::ptr::null_mut();
    continue;
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn mos7840_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn mos7840_close(port: *mut usb_serial_port) {
...
//
#[no_mangle]
unsafe extern "C" fn mos7840_break(tty: *mut tty_struct, break_state: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mos7840_write_room(tty: *mut tty_struct) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn mos7840_throttle(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn mos7840_unthrottle(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn mos7840_tiocmget(tty: *mut tty_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mos7810_check(serial: *mut usb_serial) -> c_int {
    static int mos7810_check(struct usb_serial *serial)
    {
    int i, pass_count = 0;
    u8 *buf;
    let mut data: __u16 = 0, mcr_data = 0;
    let mut test_pattern: __u16 = 0x55AA;
    int res;
    buf = kmalloc(VENDOR_READ_LENGTH, GFP_KERNEL);
    if (!buf)
...
// Send the 1-bit test pattern out to MCS7810 test pin
    ...
    MODEM_CONTROL_REGISTER, core::ptr::null_mut(), 0, MOS_WDR_TIMEOUT);
...
// Restore MCR setting
    ...
    MCS_WR_RTYPE, 0x0300 | mcr_data, MODEM_CONTROL_REGISTER, core::ptr::null_mut(),
    0, MOS_WDR_TIMEOUT);
    kfree(buf);
    if (pass_count == 16)
    return 1;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: mos7810_check(serial)) -> else {
    ...
    {
    let mut device_flags: c_ulong = (unsigned long)usb_get_serial_data(serial);
    let mut num_ports: c_int = MCS_PORTS(device_flags);
...
#[no_mangle]
unsafe extern "C" fn mos7840_attach(serial: *mut usb_serial) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mos7840_port_probe(port: *mut usb_serial_port) -> c_int {
...
// to index device instances
    ...
    let mut phy_num: u8 = mos7840_port.port_num;
...
#[no_mangle]
unsafe extern "C" fn mos7840_port_remove(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn mos7840_suspend(serial: *mut usb_serial, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mos7840_resume(serial: *mut usb_serial) -> c_int {
    ...
    &moschip7840_4port_device, core::ptr::null_mut()
    };
