...
//! Source: drivers/usb/serial/mos7720.c
#![no_std]
...
// default urb timeout
pub const MOS_WDR_TIMEOUT: c_int = 5000;
pub const MOS_MAX_PORT: c_uint = 0x02;
pub const MOS_WRITE: c_uint = 0x0E;
pub const MOS_READ: c_uint = 0x0D;
// Interrupt Routines Defines
pub const SERIAL_IIR_RLS: c_uint = 0x06;
pub const SERIAL_IIR_RDA: c_uint = 0x04;
pub const SERIAL_IIR_CTI: c_uint = 0x0c;
pub const SERIAL_IIR_THR: c_uint = 0x02;
pub const SERIAL_IIR_MS: c_uint = 0x00;

// This structure holds all of the local serial port information
#[repr(C)]
#[derive(Copy, Clone)]
pub struct moschip_port {
    pub /: *mut *mut __u8 shadowLCR; / last LCR value received,
    pub /: *mut *mut __u8 shadowMCR; / last MCR value received,
    pub /: *mut *mut __u8 shadowMSR; / last MSR value received,
    pub open: c_char,
    pub /: *mut *mut *mut usb_serial_port port; / loop back to the owner,
    pub write_urb_pool: [*mut urb; NUM_URBS],
}

pub const USB_VENDOR_ID_MOSCHIP: c_uint = 0x9710;
pub const MOSCHIP_DEVICE_ID_7720: c_uint = 0x7720;
pub const MOSCHIP_DEVICE_ID_7715: c_uint = 0x7715;
...
pub const DCR_INIT_VAL: c_uint = 0x0c	/* SLCTIN, nINIT */;
pub const ECR_INIT_VAL: c_uint = 0x00	/* SPP mode */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mos7715_parport {
    pub /: *mut *mut *mut parport pp; / back to containing struct,
    pub /: *mut *mut kref ref_count; / to instance of this struct,
    pub /: *mut *mut bool msg_pending; / usb sync call pending,
    pub /: *mut *mut completion syncmsg_compl; / usb sync call completed,
    pub /: *mut *mut work_work; / restore deferred writes,
    pub /: *mut *mut *mut usb_serial serial; / back to containing struct,
    pub /: *mut *mut __u8 shadowECR; / parallel port regs...,
    pub shadowDCR: __u8,
    pub /: *mut *mut atomic_t shadowDSR; / updated in int-in callback,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn get_reg_index(reg: enum mos_regs) -> __u16 {
...
//
    ...
    let mut pipe: c_uint = usb_sndctrlpipe(usbdev, 0);
    let mut request: __u8 = (__u8)0x0e;
    let mut requesttype: __u8 = (__u8)0x40;
    let mut index: __u16 = get_reg_index(reg);
    let mut value: __u16 = get_reg_value(reg, serial_portnum) + data;
    int status = usb_control_msg(usbdev, pipe, request, requesttype, value,
    index, core::ptr::null_mut(), 0, MOS_WDR_TIMEOUT);
    if (status < 0)
    dev_err(&usbdev.dev,
...
//
    ...
    {
    struct usb_device *usbdev = serial.dev;
    let mut pipe: c_uint = usb_rcvctrlpipe(usbdev, 0);
    let mut request: __u8 = (__u8)0x0d;
    let mut requesttype: __u8 = (__u8)0xc0;
    let mut index: __u16 = get_reg_index(reg);
    let mut value: __u16 = get_reg_value(reg, serial_portnum);
    u8 *buf;
    int status;
...
#[no_mangle]
unsafe extern "C" fn destroy_mos_parport(kref: *mut kref) {
...
//
#[no_mangle]
unsafe extern "C" fn parport_prologue(pp: *mut parport) -> c_int {
    static int parport_prologue(struct parport *pp)
    {
    struct mos7715_parport *mos_parport;
    spin_lock(&release_lock);
    mos_parport = pp.private_data;
    if (unlikely(mos_parport == core::ptr::null_mut())) {
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_epilogue(pp: *mut parport) {
...
#[no_mangle]
unsafe extern "C" fn deferred_restore_writes(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn parport_mos7715_write_data(pp: *mut parport, d: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn parport_mos7715_read_data(pp: *mut parport) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn parport_mos7715_write_control(pp: *mut parport, d: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn parport_mos7715_read_control(pp: *mut parport) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn parport_mos7715_read_status(pp: *mut parport) -> c_uchar {
    ...
    spin_lock(&release_lock);
    mos_parport = pp.private_data;
    if (unlikely(mos_parport == core::ptr::null_mut())) {	/* release called */
    spin_unlock(&release_lock);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn parport_mos7715_enable_irq(pp: *mut parport) {
    static void parport_mos7715_enable_irq(struct parport *pp)
    {
    }
#[no_mangle]
unsafe extern "C" fn parport_mos7715_disable_irq(pp: *mut parport) {
    static void parport_mos7715_disable_irq(struct parport *pp)
    {
    }
#[no_mangle]
unsafe extern "C" fn parport_mos7715_data_forward(pp: *mut parport) {
...
#[no_mangle]
unsafe extern "C" fn parport_mos7715_data_reverse(pp: *mut parport) {
...
//
#[no_mangle]
unsafe extern "C" fn mos7715_parport_init(serial: *mut usb_serial) -> c_int {
...
// register with parport core
    ...
    PARPORT_DMA_NONE,
    &parport_mos7715_ops);
    if (mos_parport.pp == core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn mos7720_interrupt_callback(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn mos7715_interrupt_callback(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn mos7720_bulk_in_callback(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn mos7720_bulk_out_data_callback(urb: *mut urb) {
    ...
    if (!mos7720_port) {
    dev_dbg(&urb.dev.dev, "core::ptr::null_mut() mos7720_port pointer\n");
    return ;
    }
    ...
    {
    let mut product: u16 = le16_to_cpu(serial.dev.descriptor.idProduct);
...
#[no_mangle]
unsafe extern "C" fn mos7720_open(tty: *mut tty_struct, port: *mut usb_serial_port) -> c_int {
    ...
    int port_number;
    __u8 data;
    let mut allocated_urbs: c_int = 0;
    int j;
    serial = port.serial;
    mos7720_port = usb_get_serial_port_data(port);
    if (mos7720_port == core::ptr::null_mut())
    return -ENODEV;
...
// Initialising the write urb pool
    ...
    mos7720_port.write_urb_pool[j] = core::ptr::null_mut();
    continue;
    }
    allocated_urbs++;
    }
...
//
#[no_mangle]
unsafe extern "C" fn mos7720_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
    static unsigned int mos7720_chars_in_buffer(struct tty_struct *tty)
    {
    struct usb_serial_port *port = tty.driver_data;
    struct moschip_port *mos7720_port = usb_get_serial_port_data(port);
    int i;
    let mut chars: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn mos7720_close(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn mos7720_break(tty: *mut tty_struct, break_state: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mos7720_write_room(tty: *mut tty_struct) -> c_uint {
    static unsigned int mos7720_write_room(struct tty_struct *tty)
    {
    struct usb_serial_port *port = tty.driver_data;
    struct moschip_port *mos7720_port = usb_get_serial_port_data(port);
    let mut room: c_uint = 0;
    int i;
// FIXME: Locking
    for (i = 0; i < NUM_URBS; ++i) {
    if (mos7720_port.write_urb_pool[i] &&
...
// try to find a free urb in the list
    ...
    if (urb.transfer_buffer == core::ptr::null_mut()) {
    urb.transfer_buffer = kmalloc(URB_TRANSFER_BUFFER_SIZE,
    GFP_ATOMIC);
    if (!urb.transfer_buffer) {
    bytes_sent = -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn mos7720_throttle(tty: *mut tty_struct) {
...
// if we are implementing XON/XOFF, send the stop character
    if (I_IXOFF(tty)) {
    let mut stop_char: c_uchar = STOP_CHAR(tty);
...
#[no_mangle]
unsafe extern "C" fn mos7720_unthrottle(tty: *mut tty_struct) {
...
// if we are implementing XON/XOFF, send the start character
    if (I_IXOFF(tty)) {
    let mut start_char: c_uchar = START_CHAR(tty);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct divisor_table_entry {
    pub baudrate: __u32,
    pub divisor: __u16,
}
...
//
#[no_mangle]
unsafe extern "C" fn calc_baud_rate_divisor(port: *mut usb_serial_port, baudrate: c_int, divisor: *mut c_int) -> c_int {
...
//
    ...
    let mut port_number: c_int = port.port_number;
    int count;
...
#[no_mangle]
unsafe extern "C" fn mos7720_tiocmget(tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mos7720_startup(serial: *mut usb_serial) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mos7720_release(serial: *mut usb_serial) {
...
// prevent NULL ptr dereference in port callbacks
    spin_lock(&release_lock);
    mos_parport.pp.private_data = core::ptr::null_mut();
    spin_unlock(&release_lock);
...
//
    ...
    mos_parport.serial = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mos7720_port_probe(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mos7720_port_remove(port: *mut usb_serial_port) {
    ...
    &moschip7720_2port_driver, core::ptr::null_mut()
    };
