...
//! Source: drivers/usb/serial/usb-serial.c
#![no_std]
...
pub const USB_SERIAL_TTY_MAJOR: c_int = 188;
...
#[no_mangle]
unsafe extern "C" fn allocate_minors(serial: *mut usb_serial, num_ports: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn release_minors(serial: *mut usb_serial) {
...
#[no_mangle]
pub unsafe extern "C" fn usb_serial_claim_interface(serial: *mut usb_serial, intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn release_sibling(serial: *mut usb_serial, intf: *mut usb_interface) {
    ...
    usb_set_intfdata(sibling, core::ptr::null_mut());
    usb_driver_release_interface(driver, sibling);
    }
#[no_mangle]
unsafe extern "C" fn destroy_serial(kref: *mut kref) {
...
//
#[no_mangle]
unsafe extern "C" fn serial_install(driver: *mut tty_driver, tty: *mut tty_struct) -> c_int {
    ...
    goto err_put_serial;
    init_termios = (driver.termios[idx] == core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn serial_port_activate(tport: *mut tty_port, tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_open(tty: *mut tty_struct, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn serial_port_shutdown(tport: *mut tty_port) {
...
#[no_mangle]
unsafe extern "C" fn serial_hangup(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn serial_close(tty: *mut tty_struct, filp: *mut file) {
...
//
#[no_mangle]
unsafe extern "C" fn serial_cleanup(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn serial_write(tty: *mut tty_struct, buf: *const u8, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn serial_write_room(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn serial_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn serial_wait_until_sent(tty: *mut tty_struct, timeout: c_int) {
...
#[no_mangle]
unsafe extern "C" fn serial_throttle(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn serial_unthrottle(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn serial_get_serial(tty: *mut tty_struct, ss: *mut serial_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_set_serial(tty: *mut tty_struct, ss: *mut serial_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_break(tty: *mut tty_struct, break_state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_proc_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_tiocmget(tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_serial_port_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn usb_serial_port_poison_urbs(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn usb_serial_port_unpoison_urbs(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn usb_serial_port_release(dev: *mut device) {
...
// Caller must hold table_lock
    ...
    {
    const struct usb_device_id *id = core::ptr::null_mut();
    struct usb_serial_driver *drv;
...
#[no_mangle]
unsafe extern "C" fn serial_port_carrier_raised(port: *mut tty_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn serial_port_dtr_rts(port: *mut tty_port, on: bool) {
    ...
    let mut addr: u8 = epd.bEndpointAddress;
    ...
    struct usb_serial *serial = core::ptr::null_mut();
    struct usb_serial_port *port;
    struct usb_serial_endpoints *epds;
    struct usb_serial_driver *type = core::ptr::null_mut();
    int retval;
    int i;
...
#[no_mangle]
unsafe extern "C" fn usb_serial_disconnect(interface: *mut usb_interface) {
...
#[no_mangle]
pub unsafe extern "C" fn usb_serial_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_serial_unpoison_port_urbs(serial: *mut usb_serial) {
...
#[no_mangle]
pub unsafe extern "C" fn usb_serial_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_serial_reset_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_serial_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn usb_serial_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn usb_serial_operations_init(device: *mut usb_serial_driver) {
...
#[no_mangle]
unsafe extern "C" fn usb_serial_register(driver: *mut usb_serial_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_serial_deregister(device: *mut usb_serial_driver) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_serial_deregister_drivers(serial_drivers[]: *const *const usb_serial_driver) {
