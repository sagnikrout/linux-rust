...
//! Source: drivers/usb/serial/keyspan_pda.c
#![no_std]
...
pub const KEYSPAN_TX_THRESHOLD: c_int = 128;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct keyspan_pda_private {
    pub tx_room: c_int,
    pub unthrottle_work: work_struct,
    pub port: *mut usb_serial_port,
    pub throttled: bool,
    pub throttle_req: bool,
}

    static int keyspan_pda_write_start(struct usb_serial_port *port);
pub const KEYSPAN_VENDOR_ID: c_uint = 0x06cd;
pub const KEYSPAN_PDA_FAKE_ID: c_uint = 0x0103;
pub const KEYSPAN_PDA_ID: c_uint = 0x0104 /* no clue */;
// For Xircom PGSDB9 and older Entrega version of the same device
pub const XIRCOM_VENDOR_ID: c_uint = 0x085a;
pub const XIRCOM_FAKE_ID: c_uint = 0x8027;
pub const XIRCOM_FAKE_ID_2: c_uint = 0x8025 /* "PGMFHUB" serial */;
pub const ENTREGA_VENDOR_ID: c_uint = 0x1645;
pub const ENTREGA_FAKE_ID: c_uint = 0x8093;
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_get_write_room(priv: *mut keyspan_pda_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_request_unthrottle(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_rx_interrupt(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_rx_throttle(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_rx_unthrottle(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_setbaud(serial: *mut usb_serial, baud: speed_t) -> speed_t {
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_break_ctl(tty: *mut tty_struct, break_state: c_int) -> c_int {
    ...
    value, 0, core::ptr::null_mut(), 0, 2000);
    if (result < 0) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_tiocmget(tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_write_start(port: *mut usb_serial_port) -> c_int {
    static int keyspan_pda_write_start(struct usb_serial_port *port)
    {
    struct keyspan_pda_private *priv = usb_get_serial_port_data(port);
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_write_bulk_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_dtr_rts(port: *mut usb_serial_port, on: c_int) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_close(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_fake_startup(serial: *mut usb_serial) -> c_int {
    static int keyspan_pda_fake_startup(struct usb_serial *serial)
    {
    let mut vid: c_uint = le16_to_cpu(serial.dev.descriptor.idVendor);
    const char *fw_name;
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_port_probe(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keyspan_pda_port_remove(port: *mut usb_serial_port) {
