...
//! Source: drivers/usb/serial/ark3116.c
#![no_std]
...
pub const ARK_TIMEOUT: c_int = 1000;
...
#[no_mangle]
unsafe extern "C" fn is_irda(serial: *mut usb_serial) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ark3116_private {
    pub /: *mut *mut int irda; / 1 for irda device,
// protects hw register updates
    pub hw_lock: mutex,
    pub /: *mut *mut int quot; / baudrate divisor,
    pub /: *mut *mut __u32 lcr; / line control register value,
    pub (0x8): *mut *mut __u32 hcr; / handshake control register,
// value
    pub /: *mut *mut __u32 mcr; / modem control register value,
// protects the status values below
    pub status_lock: spinlock_t,
    pub /: *mut *mut __u32 msr; / modem status register value,
    pub /: *mut *mut __u32 lsr; / line status register value,
}
...
// 0xfe 0x40 are magic values taken from original driver
    ...
    0xfe, 0x40, val, reg,
    core::ptr::null_mut(), 0, ARK_TIMEOUT);
    if (result)
    return result;
    return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn calc_divisor(bps: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ark3116_port_probe(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ark3116_port_remove(port: *mut usb_serial_port) {
...
// device is closed, so URBs and DMA should be down
    ...
    let mut bps: c_int = tty_get_baud_rate(tty);
    int quot;
    __u8 lcr, hcr, eval;
// set data bit count
...
#[no_mangle]
unsafe extern "C" fn ark3116_close(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn ark3116_open(tty: *mut tty_struct, port: *mut usb_serial_port) -> c_int {
...
// setup termios
    if (tty)
    ark3116_set_termios(tty, port, core::ptr::null_mut());
    kfree(buf);
    return 0;
    err_close:
    usb_serial_generic_close(port);
...
#[no_mangle]
unsafe extern "C" fn ark3116_tiocmget(tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ark3116_break_ctl(tty: *mut tty_struct, break_state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ark3116_update_msr(port: *mut usb_serial_port, msr: __u8) {
...
#[no_mangle]
unsafe extern "C" fn ark3116_update_lsr(port: *mut usb_serial_port, lsr: __u8) {
...
#[no_mangle]
unsafe extern "C" fn ark3116_read_int_callback(urb: *mut urb) {
...
// discovered this by trail and error...
    ...
    let mut id: __u8 = data[1]&UART_IIR_ID;
...
//
#[no_mangle]
unsafe extern "C" fn ark3116_process_read_urb(urb: *mut urb) {
...
// update line status
    ...
    tty_flag = TTY_BREAK;
#[no_mangle]
pub unsafe extern "C" fn if(UART_LSR_PE: lsr &) -> else {
...
// overrun is special, not associated with a char
    ...
    &ark3116_device, core::ptr::null_mut()
    };
