...
//! Source: drivers/usb/serial/safe_serial.c
#![no_std]
...
//
    ...
    let mut safe: static bool = true;
    let mut padded: static bool = IS_ENABLED(CONFIG_USB_SERIAL_SAFE_PADDED);
...
pub const CDC_DEVICE_CLASS: c_uint = 0x02;
pub const CDC_INTERFACE_CLASS: c_uint = 0x02;
pub const CDC_INTERFACE_SUBCLASS: c_uint = 0x06;
pub const LINEO_INTERFACE_CLASS: c_uint = 0xff;
pub const LINEO_INTERFACE_SUBCLASS_SAFENET: c_uint = 0x01;
pub const LINEO_SAFENET_CRC: c_uint = 0x01;
pub const LINEO_SAFENET_CRC_PADDED: c_uint = 0x02;
pub const LINEO_INTERFACE_SUBCLASS_SAFESERIAL: c_uint = 0x02;
pub const LINEO_SAFESERIAL_CRC: c_uint = 0x01;
pub const LINEO_SAFESERIAL_CRC_PADDED: c_uint = 0x02;
...
pub const CRC10_INITFCS: c_uint = 0x000	/* Initial FCS value */;
pub const CRC10_GOODFCS: c_uint = 0x000	/* Good final FCS value */;
...
//
#[no_mangle]
pub unsafe extern "C" fn fcs_compute10(sp: *mut c_uchar, len: c_int, fcs: __u16) -> __u16 {
...
#[no_mangle]
unsafe extern "C" fn safe_process_read_urb(urb: *mut urb) {
    static void safe_process_read_urb(struct urb *urb)
    {
    struct usb_serial_port *port = urb.context;
    unsigned char *data = urb.transfer_buffer;
    let mut length: c_uchar = urb.actual_length;
    int actual_length;
    __u16 fcs;
    if (!length)
    return;
...
#[no_mangle]
unsafe extern "C" fn safe_startup(serial: *mut usb_serial) -> c_int {
