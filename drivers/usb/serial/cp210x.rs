...
//! Source: drivers/usb/serial/cp210x.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp210x_serial_private {

    pub gc: gpio_chip,
    pub gpio_registered: bool,
    pub gpio_pushpull: u16,
    pub gpio_altfunc: u16,
    pub gpio_input: u16,

    pub partnum: u8,
    pub fw_version: u32,
    pub min_speed: speed_t,
    pub max_speed: speed_t,
    pub use_actual_rate: bool,
    pub no_flow_control: bool,
    pub no_event_mode: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp210x_port_private {
    pub bInterfaceNumber: u8,
    pub event_mode: bool,
    pub event_state: enum cp210x_event_state,
    pub lsr: u8,
    pub mutex: mutex,
    pub crtscts: bool,
    pub dtr: bool,
    ...
    &cp210x_device, core::ptr::null_mut()
    };
// Config request types
pub const REQTYPE_HOST_TO_INTERFACE: c_uint = 0x41;
pub const REQTYPE_INTERFACE_TO_HOST: c_uint = 0xc1;
pub const REQTYPE_HOST_TO_DEVICE: c_uint = 0x40;
pub const REQTYPE_DEVICE_TO_HOST: c_uint = 0xc0;
// Config request codes
pub const CP210X_IFC_ENABLE: c_uint = 0x00;
pub const CP210X_SET_BAUDDIV: c_uint = 0x01;
pub const CP210X_GET_BAUDDIV: c_uint = 0x02;
pub const CP210X_SET_LINE_CTL: c_uint = 0x03;
pub const CP210X_GET_LINE_CTL: c_uint = 0x04;
pub const CP210X_SET_BREAK: c_uint = 0x05;
pub const CP210X_IMM_CHAR: c_uint = 0x06;
pub const CP210X_SET_MHS: c_uint = 0x07;
pub const CP210X_GET_MDMSTS: c_uint = 0x08;
pub const CP210X_SET_XON: c_uint = 0x09;
pub const CP210X_SET_XOFF: c_uint = 0x0A;
pub const CP210X_SET_EVENTMASK: c_uint = 0x0B;
pub const CP210X_GET_EVENTMASK: c_uint = 0x0C;
pub const CP210X_SET_CHAR: c_uint = 0x0D;
pub const CP210X_GET_CHARS: c_uint = 0x0E;
pub const CP210X_GET_PROPS: c_uint = 0x0F;
pub const CP210X_GET_COMM_STATUS: c_uint = 0x10;
pub const CP210X_RESET: c_uint = 0x11;
pub const CP210X_PURGE: c_uint = 0x12;
pub const CP210X_SET_FLOW: c_uint = 0x13;
pub const CP210X_GET_FLOW: c_uint = 0x14;
pub const CP210X_EMBED_EVENTS: c_uint = 0x15;
pub const CP210X_GET_EVENTSTATE: c_uint = 0x16;
pub const CP210X_SET_CHARS: c_uint = 0x19;
pub const CP210X_GET_BAUDRATE: c_uint = 0x1D;
pub const CP210X_SET_BAUDRATE: c_uint = 0x1E;
pub const CP210X_VENDOR_SPECIFIC: c_uint = 0xFF;
// CP210X_IFC_ENABLE
pub const UART_ENABLE: c_uint = 0x0001;
pub const UART_DISABLE: c_uint = 0x0000;
// CP210X_(SET|GET)_BAUDDIV
pub const BAUD_RATE_GEN_FREQ: c_uint = 0x384000;
// CP210X_(SET|GET)_LINE_CTL

pub const BITS_PARITY_MASK: c_uint = 0x00f0;
pub const BITS_PARITY_NONE: c_uint = 0x0000;
pub const BITS_PARITY_ODD: c_uint = 0x0010;
pub const BITS_PARITY_EVEN: c_uint = 0x0020;
pub const BITS_PARITY_MARK: c_uint = 0x0030;
pub const BITS_PARITY_SPACE: c_uint = 0x0040;
pub const BITS_STOP_MASK: c_uint = 0x000f;
pub const BITS_STOP_1: c_uint = 0x0000;
pub const BITS_STOP_1_5: c_uint = 0x0001;
pub const BITS_STOP_2: c_uint = 0x0002;
// CP210X_SET_BREAK
pub const BREAK_ON: c_uint = 0x0001;
pub const BREAK_OFF: c_uint = 0x0000;
// CP210X_(SET_MHS|GET_MDMSTS)
pub const CONTROL_DTR: c_uint = 0x0001;
pub const CONTROL_RTS: c_uint = 0x0002;
pub const CONTROL_CTS: c_uint = 0x0010;
pub const CONTROL_DSR: c_uint = 0x0020;
pub const CONTROL_RING: c_uint = 0x0040;
pub const CONTROL_DCD: c_uint = 0x0080;
pub const CONTROL_WRITE_DTR: c_uint = 0x0100;
pub const CONTROL_WRITE_RTS: c_uint = 0x0200;
// CP210X_(GET|SET)_CHARS
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp210x_special_chars {
    pub bEofChar: u8,
    pub bErrorChar: u8,
    pub bBreakChar: u8,
    pub bEventChar: u8,
...
pub const CP210X_GET_FW_VER: c_uint = 0x000E;
pub const CP210X_READ_2NCONFIG: c_uint = 0x000E;
pub const CP210X_GET_FW_VER_2N: c_uint = 0x0010;
pub const CP210X_READ_LATCH: c_uint = 0x00C2;
pub const CP210X_GET_PARTNUM: c_uint = 0x370B;
pub const CP210X_GET_PORTCONFIG: c_uint = 0x370C;
pub const CP210X_GET_DEVICEMODE: c_uint = 0x3711;
pub const CP210X_WRITE_LATCH: c_uint = 0x37E1;
// Part number definitions
pub const CP210X_PARTNUM_CP2101: c_uint = 0x01;
pub const CP210X_PARTNUM_CP2102: c_uint = 0x02;
pub const CP210X_PARTNUM_CP2103: c_uint = 0x03;
pub const CP210X_PARTNUM_CP2104: c_uint = 0x04;
pub const CP210X_PARTNUM_CP2105: c_uint = 0x05;
pub const CP210X_PARTNUM_CP2108: c_uint = 0x08;
pub const CP210X_PARTNUM_CP2102N_QFN28: c_uint = 0x20;
pub const CP210X_PARTNUM_CP2102N_QFN24: c_uint = 0x21;
pub const CP210X_PARTNUM_CP2102N_QFN20: c_uint = 0x22;
pub const CP210X_PARTNUM_UNKNOWN: c_uint = 0xFF;
// CP210X_GET_COMM_STATUS returns these 0x13 bytes
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp210x_comm_status {
    pub ulErrors: __le32,
    pub ulHoldReasons: __le32,
    pub ulAmountInInQueue: __le32,
    pub ulAmountInOutQueue: __le32,
    pub bEofReceived: u8,
    pub bWaitForImmediate: u8,
    pub bReserved: u8,
    pub __packed: },
//
...
//
pub const PURGE_ALL: c_uint = 0x000f;
// CP210X_EMBED_EVENTS
pub const CP210X_ESCCHAR: c_uint = 0xec;

// CP210X_GET_FLOW/CP210X_SET_FLOW read/write these 0x10 bytes
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp210x_flow_ctl {
    pub ulControlHandshake: __le32,
    pub ulFlowReplace: __le32,
    pub ulXonLimit: __le32,
    pub ulXoffLimit: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp210x_pin_mode {
    pub eci: u8,
    pub sci: u8,
}

pub const CP210X_PIN_MODE_MODEM: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp210x_dual_port_config {
    pub gpio_mode: __le16,
    pub __pad0: [u8; 2],
    pub reset_state: __le16,
    pub __pad1: [u8; 4],
    pub suspend_state: __le16,
    pub sci_cfg: u8,
    pub eci_cfg: u8,
    pub device_cfg: u8,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp210x_single_port_config {
    pub gpio_mode: __le16,
    pub __pad0: [u8; 2],
    pub reset_state: __le16,
    pub __pad1: [u8; 4],
    ...
    pub __packed: },
// GPIO modes
pub const CP210X_SCI_GPIO_MODE_OFFSET: c_int = 9;

pub const CP210X_ECI_GPIO_MODE_OFFSET: c_int = 2;

pub const CP210X_GPIO_MODE_OFFSET: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp210x_quad_port_state {
    pub gpio_mode_pb0: __le16,
    pub gpio_mode_pb1: __le16,
    pub gpio_mode_pb2: __le16,
    pub gpio_mode_pb3: __le16,
    pub gpio_mode_pb4: __le16,
    pub gpio_lowpower_pb0: __le16,
    pub gpio_lowpower_pb1: __le16,
    pub gpio_lowpower_pb2: __le16,
    pub gpio_lowpower_pb3: __le16,
    pub gpio_lowpower_pb4: __le16,
    pub gpio_latch_pb0: __le16,
    pub gpio_latch_pb1: __le16,
    pub gpio_latch_pb2: __le16,
    pub gpio_latch_pb3: __le16,
    pub gpio_latch_pb4: __le16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp210x_quad_port_config {
    pub reset_state: cp210x_quad_port_state,
    pub suspend_state: cp210x_quad_port_state,
    pub ipdelay_ifc: [u8; 4],
    pub enhancedfxn_ifc: [u8; 4],
    pub enhancedfxn_device: u8,
    pub extclkfreq: [u8; 4],
    pub __packed: },
pub const CP2108_EF_IFC_GPIO_TXLED: c_uint = 0x01;
pub const CP2108_EF_IFC_GPIO_RXLED: c_uint = 0x02;
pub const CP2108_EF_IFC_GPIO_RS485: c_uint = 0x04;
pub const CP2108_EF_IFC_GPIO_RS485_LOGIC: c_uint = 0x08;
pub const CP2108_EF_IFC_GPIO_CLOCK: c_uint = 0x10;
pub const CP2108_EF_IFC_DYNAMIC_SUSPEND: c_uint = 0x40;
// CP2102N configuration array indices
pub const CP210X_2NCONFIG_CONFIG_VERSION_IDX: c_int = 2;
pub const CP210X_2NCONFIG_GPIO_MODE_IDX: c_int = 581;
pub const CP210X_2NCONFIG_GPIO_RSTLATCH_IDX: c_int = 587;
pub const CP210X_2NCONFIG_GPIO_CONTROL_IDX: c_int = 600;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp210x_gpio_write16 {
    pub mask: __le16,
    pub state: __le16,
}
...
//
#[no_mangle]
unsafe extern "C" fn cp210x_interface_num(serial: *mut usb_serial) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn cp210x_read_u8_reg(port: *mut usb_serial_port, req: u8, val: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cp210x_write_u16_reg(port: *mut usb_serial_port, req: u8, val: u16) -> c_int {
    ...
    port_priv.bInterfaceNumber, core::ptr::null_mut(), 0,
...
//
#[no_mangle]
unsafe extern "C" fn cp210x_write_u32_reg(port: *mut usb_serial_port, req: u8, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp210x_open(tty: *mut tty_struct, port: *mut usb_serial_port) -> c_int {
    ...
    if (tty)
    cp210x_set_termios(tty, port, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cp210x_close(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn cp210x_process_lsr(port: *mut usb_serial_port, lsr: c_uchar, flag: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn cp210x_process_char(port: *mut usb_serial_port, ch: *mut c_uchar, flag: *mut c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cp210x_process_read_urb(urb: *mut urb) {
    static void cp210x_process_read_urb(struct urb *urb)
    {
...
#[no_mangle]
unsafe extern "C" fn cp210x_tx_empty(port: *mut usb_serial_port) -> bool {
    static bool cp210x_tx_empty(struct usb_serial_port *port)
    {
    int err;
    u32 count;
...
//
#[no_mangle]
unsafe extern "C" fn cp210x_get_an205_rate(baud: speed_t) -> speed_t {
...
#[no_mangle]
unsafe extern "C" fn cp210x_get_actual_rate(baud: speed_t) -> speed_t {
    static speed_t cp210x_get_actual_rate(speed_t baud)
    {
    let mut prescale: c_uint = 1;
    unsigned int div;
    if (baud <= 365)
    prescale = 4;
...
#[no_mangle]
pub unsafe extern "C" fn if(1000000: baud <) -> else {
...
#[no_mangle]
unsafe extern "C" fn cp210x_enable_event_mode(port: *mut usb_serial_port) {
    static void cp210x_enable_event_mode(struct usb_serial_port *port)
    {
...
#[no_mangle]
unsafe extern "C" fn cp210x_disable_event_mode(port: *mut usb_serial_port) {
    static void cp210x_disable_event_mode(struct usb_serial_port *port)
    {
    struct cp210x_port_private *port_priv = usb_get_serial_port_data(port);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn cp210x_termios_change(a: *const ktermios, b: *const ktermios) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cp210x_dtr_rts(port: *mut usb_serial_port, on: c_int) {
    static void cp210x_dtr_rts(struct usb_serial_port *port, int on)
    {
    if (on)
...
#[no_mangle]
unsafe extern "C" fn cp210x_tiocmget(tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp210x_break_ctl(tty: *mut tty_struct, break_state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp210x_gpio_get(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp210x_gpio_set(gc: *mut gpio_chip, gpio: c_uint, value: c_int) -> c_int {
    ...
    CP210X_WRITE_LATCH,
    wIndex,
    core::ptr::null_mut(), 0, USB_CTRL_SET_TIMEOUT);
    break;
    }
    usb_autopm_put_interface(serial.interface);
    out:
...
#[no_mangle]
unsafe extern "C" fn cp210x_gpio_direction_get(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp210x_gpio_direction_input(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
// Succeed only if in correct mode (this can't be set at runtime)
    ...
    let mut altfunc_mask: c_ulong = priv.gpio_altfunc;
...
//
#[no_mangle]
unsafe extern "C" fn cp2105_gpioconf_init(serial: *mut usb_serial) -> c_int {
    static int cp2105_gpioconf_init(struct usb_serial *serial)
    {
    struct cp210x_serial_private *priv = usb_get_serial_data(serial);
    struct cp210x_pin_mode mode;
    struct cp210x_dual_port_config config;
    let mut intf_num: u8 = cp210x_interface_num(serial);
    u8 iface_config;
    int result;
...
#[no_mangle]
unsafe extern "C" fn cp2104_gpioconf_init(serial: *mut usb_serial) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp2108_gpio_init(serial: *mut usb_serial) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp2102n_gpioconf_init(serial: *mut usb_serial) -> c_int {
    static int cp2102n_gpioconf_init(struct usb_serial *serial)
    {
    struct cp210x_serial_private *priv = usb_get_serial_data(serial);
    let mut config_size: u16 = 0x02a6;
    u8 gpio_rst_latch;
    u8 config_version;
    u8 gpio_pushpull;
    u8 *config_buf;
...
#[no_mangle]
unsafe extern "C" fn cp210x_gpio_init(serial: *mut usb_serial) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp210x_gpio_remove(serial: *mut usb_serial) {
...
#[no_mangle]
unsafe extern "C" fn cp210x_port_probe(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp210x_port_remove(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn cp210x_init_max_speed(serial: *mut usb_serial) {
    static void cp210x_init_max_speed(struct usb_serial *serial)
    {
    struct cp210x_serial_private *priv = usb_get_serial_data(serial);
    let mut use_actual_rate: bool = false;
    let mut min: speed_t = 300;
    speed_t max;
    switch (priv.partnum) {
...
#[no_mangle]
unsafe extern "C" fn cp2102_determine_quirks(serial: *mut usb_serial) {
...
#[no_mangle]
unsafe extern "C" fn cp210x_get_fw_version(serial: *mut usb_serial, value: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp210x_determine_type(serial: *mut usb_serial) {
...
#[no_mangle]
unsafe extern "C" fn cp210x_attach(serial: *mut usb_serial) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp210x_disconnect(serial: *mut usb_serial) {
    static void cp210x_disconnect(struct usb_serial *serial)
    {
    cp210x_gpio_remove(serial);
    }
#[no_mangle]
unsafe extern "C" fn cp210x_release(serial: *mut usb_serial) {
