...
//! Source: drivers/usb/serial/keyspan.c
#![no_std]
...
pub const keyspan_usa18x_pre_product_id: c_uint = 0x0105;
pub const keyspan_usa19_pre_product_id: c_uint = 0x0103;
pub const keyspan_usa19qi_pre_product_id: c_uint = 0x010b;
pub const keyspan_mpr_pre_product_id: c_uint = 0x011b;
pub const keyspan_usa19qw_pre_product_id: c_uint = 0x0118;
pub const keyspan_usa19w_pre_product_id: c_uint = 0x0106;
pub const keyspan_usa28_pre_product_id: c_uint = 0x0101;
pub const keyspan_usa28x_pre_product_id: c_uint = 0x0102;
pub const keyspan_usa28xa_pre_product_id: c_uint = 0x0114;
pub const keyspan_usa28xb_pre_product_id: c_uint = 0x0113;
pub const keyspan_usa49w_pre_product_id: c_uint = 0x0109;
pub const keyspan_usa49wlc_pre_product_id: c_uint = 0x011a;
//
...
//
pub const keyspan_usa18x_product_id: c_uint = 0x0112;
pub const keyspan_usa19_product_id: c_uint = 0x0107;
pub const keyspan_usa19qi_product_id: c_uint = 0x010c;
pub const keyspan_usa19hs_product_id: c_uint = 0x0121;
pub const keyspan_mpr_product_id: c_uint = 0x011c;
pub const keyspan_usa19qw_product_id: c_uint = 0x0119;
pub const keyspan_usa19w_product_id: c_uint = 0x0108;
pub const keyspan_usa28_product_id: c_uint = 0x010f;
pub const keyspan_usa28x_product_id: c_uint = 0x0110;
pub const keyspan_usa28xa_product_id: c_uint = 0x0115;
pub const keyspan_usa28xb_product_id: c_uint = 0x0110;
pub const keyspan_usa28xg_product_id: c_uint = 0x0135;
pub const keyspan_usa49w_product_id: c_uint = 0x010a;
pub const keyspan_usa49wlc_product_id: c_uint = 0x012a;
pub const keyspan_usa49wg_product_id: c_uint = 0x0131;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct keyspan_device_details {
// product ID value
    pub product_id: c_int,
    pub msg_format: enum {msg_usa26, msg_usa28, msg_usa49, msg_usa90, msg_usa67},
// Number of physical ports
    pub num_ports: c_int,
// 1 if endpoint flipping used on input, 0 if not
    pub indat_endp_flip: c_int,
// 1 if endpoint flipping used on output, 0 if not
    pub outdat_endp_flip: c_int,
//
// Table mapping input data endpoint IDs to physical port
// number and flip if used
//
    pub indat_endpoints: [c_int; KEYSPAN_MAX_NUM_PORTS],
// Same for output endpoints
    pub outdat_endpoints: [c_int; KEYSPAN_MAX_NUM_PORTS],
// Input acknowledge endpoints
    pub inack_endpoints: [c_int; KEYSPAN_MAX_NUM_PORTS],
// Output control endpoints
    pub outcont_endpoints: [c_int; KEYSPAN_MAX_NUM_PORTS],
// Endpoint used for input status
    pub instat_endpoint: c_int,
// Endpoint used for input data 49WG only
    pub indat_endpoint: c_int,
// Endpoint used for global control functions
    pub glocont_endpoint: c_int,
...
pub const INSTAT_BUFLEN: c_int = 32;
pub const GLOCONT_BUFLEN: c_int = 64;
pub const INDAT49W_BUFLEN: c_int = 512;
pub const IN_BUFLEN: c_int = 64;
pub const OUT_BUFLEN: c_int = 64;
pub const INACK_BUFLEN: c_int = 1;
pub const OUTCONT_BUFLEN: c_int = 64;
// Per device and per port private data
#[repr(C)]
#[derive(Copy, Clone)]
pub struct keyspan_serial_private {
    pub device_details: *const keyspan_device_details,
    pub instat_urb: *mut urb,
    pub instat_buf: *mut c_char,
// added to support 49wg, where data from all 4 ports comes in
    on 1 EP and high-speed supported */
    pub indat_urb: *mut urb,
    pub indat_buf: *mut c_char,
// XXX this one probably will need a lock
    pub glocont_urb: *mut urb,
    pub glocont_buf: *mut c_char,
    pub /: *mut *mut *mut char ctrl_buf; / for EP0 control message,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct keyspan_port_private {
...
// Input endpoints and buffer for this port
    pub in_urbs: [*mut urb; 2],
    pub in_buffer: [*mut c_char; 2],
// Output endpoints and buffer for this port
    pub out_urbs: [*mut urb; 2],
    pub out_buffer: [*mut c_char; 2],
// Input ack endpoint
    pub inack_urb: *mut urb,
    pub inack_buffer: *mut c_char,
// Output control endpoint
    pub outcont_urb: *mut urb,
    pub outcont_buffer: *mut c_char,
// Settings for the port
    pub baud: c_int,
    pub old_baud: c_int,
    pub cflag: c_uint,
    pub old_cflag: c_uint,
    pub flow_control: enum {flow_none, flow_cts, flow_xon},
    ...
    pub ri_state: c_int,
    pub break_on: c_int,
    pub tx_start_time: [c_ulong; 2],
    pub /: *mut *mut int resend_cont; / need to resend control packet,
}
...
#[no_mangle]
unsafe extern "C" fn keyspan_break_ctl(tty: *mut tty_struct, break_state: c_int) -> c_int {
...
// If no match or invalid, don't change
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), device_port) == KEYSPAN_BAUD_RATE_OK) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_tiocmget(tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usa26_indat_callback(urb: *mut urb) {
...
// some bytes had errors, every byte has status
    ...
    let mut stat: c_int = data[i];
    let mut flag: c_int = TTY_NORMAL;
...
// XXX should handle break (0x10)
    ...
    flag = TTY_PARITY;
#[no_mangle]
pub unsafe extern "C" fn if(RXERROR_FRAMING: stat &) -> else {
...
#[no_mangle]
unsafe extern "C" fn usa2x_outdat_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usa26_inack_callback(urb: *mut urb) {
    static void	usa26_inack_callback(struct urb *urb)
    {
    }
#[no_mangle]
unsafe extern "C" fn usa26_outcont_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usa26_instat_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usa26_glocont_callback(urb: *mut urb) {
    static void	usa26_glocont_callback(struct urb *urb)
    {
    }
#[no_mangle]
unsafe extern "C" fn usa28_indat_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usa28_inack_callback(urb: *mut urb) {
    static void	usa28_inack_callback(struct urb *urb)
    {
    }
#[no_mangle]
unsafe extern "C" fn usa28_outcont_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usa28_instat_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usa28_glocont_callback(urb: *mut urb) {
    static void	usa28_glocont_callback(struct urb *urb)
    {
    }
#[no_mangle]
unsafe extern "C" fn usa49_glocont_callback(urb: *mut urb) {
...
// This is actually called glostat in the Keyspan
    doco */
#[no_mangle]
unsafe extern "C" fn usa49_instat_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usa49_inack_callback(urb: *mut urb) {
    static void	usa49_inack_callback(struct urb *urb)
    {
    }
#[no_mangle]
unsafe extern "C" fn usa49_indat_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usa49wg_indat_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usa49_outcont_callback(urb: *mut urb) {
    static void usa49_outcont_callback(struct urb *urb)
    {
    }
#[no_mangle]
unsafe extern "C" fn usa90_indat_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usa90_instat_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usa90_outcont_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usa67_instat_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usa67_glocont_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_write_room(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn keyspan_open(tty: *mut tty_struct, port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keyspan_dtr_rts(port: *mut usb_serial_port, on: c_int) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_close(port: *mut usb_serial_port) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_fake_startup(serial: *mut usb_serial) -> c_int {
...
// Helper functions used by keyspan_setup_urbs
    ...
    if (endpoint == -1)
    return core::ptr::null_mut();		/* endpoint not needed */
...
#[no_mangle]
unsafe extern "C" fn keyspan_setup_urbs(serial: *mut usb_serial) {
...
// Closing port
#[no_mangle]
pub unsafe extern "C" fn if(2: reset_port ==) -> else {
    msg._txOn = 0;
    msg._txOff = 1;
    msg.txFlush = 0;
    msg.txBreak = 0;
...
// Save reset port val for resend.
    ...
    msg.setBaudRate = 1;
    if (d_details.calculate_baud_rate(port, p_priv.baud, d_details.baudclk,
    &msg.baudHi, &msg.baudLo, core::ptr::null_mut(),
    device_port) == KEYSPAN_INVALID_BAUD_RATE) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_send_setup(port: *mut usb_serial_port, reset_port: c_int) {
    static void keyspan_send_setup(struct usb_serial_port *port, int reset_port)
    {
...
#[no_mangle]
unsafe extern "C" fn keyspan_startup(serial: *mut usb_serial) -> c_int {
    static int keyspan_startup(struct usb_serial *serial)
    {
    int				i, err;
    struct keyspan_serial_private 	*s_priv;
    const struct keyspan_device_details	*d_details;
    for (i = 0; (d_details = keyspan_devices[i]) != core::ptr::null_mut(); ++i)
    if (d_details.product_id ==
    le16_to_cpu(serial.dev.descriptor.idProduct))
    break;
    if (d_details == core::ptr::null_mut()) {
...
// Setup private data for serial driver
    ...
    if (s_priv.instat_urb != core::ptr::null_mut()) {
    err = usb_submit_urb(s_priv.instat_urb, GFP_KERNEL);
    if (err != 0)
    dev_dbg(&serial.dev.dev, "%s - submit instat urb failed %d\n", __func__, err);
    }
    if (s_priv.indat_urb != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_disconnect(serial: *mut usb_serial) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_release(serial: *mut usb_serial) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_port_probe(port: *mut usb_serial_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keyspan_port_remove(port: *mut usb_serial_port) {
...
// Structs for the devices, pre and post renumeration.
    ...
    &keyspan_2port_device, &keyspan_4port_device, core::ptr::null_mut()
    };
