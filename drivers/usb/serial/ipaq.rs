...
//! Source: drivers/usb/serial/ipaq.c
#![no_std]
...
pub const KP_RETRIES: c_int = 100;

    let mut connect_retries: static int = KP_RETRIES;
...
// All of the device info needed for the Compaq iPAQ
    ...
    let mut retries: c_int = connect_retries;
...
#[no_mangle]
unsafe extern "C" fn ipaq_startup(serial: *mut usb_serial) -> c_int {
    static int ipaq_startup(struct usb_serial *serial)
    {
