...
//! Source: drivers/usb/atm/xusbatm.c
#![no_std]
...
pub const XUSBATM_DRIVERS_MAX: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn xusbatm_release_intf(usb_dev: *mut usb_device, intf: *mut usb_interface, claimed: c_int) {
    ...
    let mut drv_ix: c_int = id.driver_info;
    let mut rx_alt: c_int = rx_altsetting[drv_ix];
    let mut tx_alt: c_int = tx_altsetting[drv_ix];
...
#[no_mangle]
unsafe extern "C" fn xusbatm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn xusbatm_exit() -> void __exit {
