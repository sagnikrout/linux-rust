...
//! Source: drivers/usb/atm/speedtch.c
#![no_std]
...
pub const SIZE_7: c_int = 1;
pub const SIZE_b: c_int = 8;
pub const SIZE_d: c_int = 4;
pub const SIZE_e: c_int = 1;
pub const SIZE_f: c_int = 1;

pub const DEFAULT_BULK_ALTSETTING: c_int = 1;
pub const DEFAULT_ISOC_ALTSETTING: c_int = 3;
pub const DEFAULT_DL_512_FIRST: c_int = 0;
pub const DEFAULT_ENABLE_ISOC: c_int = 0;
pub const DEFAULT_SW_BUFFERING: c_int = 0;
    static unsigned int altsetting = 0; /* zero means: use the default */
    let mut dl_512_first: static bool = DEFAULT_DL_512_FIRST;
    let mut enable_isoc: static bool = DEFAULT_ENABLE_ISOC;
    let mut sw_buffering: static bool = DEFAULT_SW_BUFFERING;
pub const DEFAULT_B_MAX_DSL: c_int = 8128;
pub const DEFAULT_MODEM_MODE: c_int = 11;
pub const MODEM_OPTION_LENGTH: c_int = 16;
    ...
    let mut BMaxDSL: static unsigned int = DEFAULT_B_MAX_DSL;
    let mut ModemMode: static unsigned char = DEFAULT_MODEM_MODE;
...
pub const INTERFACE_DATA: c_int = 1;
pub const ENDPOINT_INT: c_uint = 0x81;
pub const ENDPOINT_BULK_DATA: c_uint = 0x07;
pub const ENDPOINT_ISOC_DATA: c_uint = 0x07;
pub const ENDPOINT_FIRMWARE: c_uint = 0x05;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct speedtch_params {
    pub altsetting: c_uint,
    pub BMaxDSL: c_uint,
    pub ModemMode: c_uchar,
    pub ModemOption: [c_uchar; MODEM_OPTION_LENGTH],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct speedtch_instance_data {
    pub usbatm: *mut usbatm_data,
    pub /: *mut *mut speedtch_params params; / set in probe, constant afterwards,
    pub status_check_timer: timer_list,
    pub status_check_work: work_struct,
    pub last_status: c_uchar,
    pub /: *mut *mut int poll_delay; / milliseconds,
    pub resubmit_timer: timer_list,
    pub int_urb: *mut urb,
    pub int_data: [c_uchar; 16],
    pub scratch_buffer: [c_uchar; 16],
}
...
//
#[no_mangle]
unsafe extern "C" fn speedtch_set_swbuff(instance: *mut speedtch_instance_data, state: c_int) {
    ...
    0x32, 0x40, state ? 0x01 : 0x00, 0x00, core::ptr::null_mut(), 0, CTRL_TIMEOUT);
    if (ret < 0)
    usb_warn(usbatm,
...
#[no_mangle]
unsafe extern "C" fn speedtch_test_sequence(instance: *mut speedtch_instance_data) {
...
// URB 8 : both leds are static green
    ...
    let mut thislen: c_int = min_t(int, PAGE_SIZE, fw1.size - offset);
...
// URBs 12 to 139 - USB led blinking green, ADSL led off
    ...
    let mut thislen: c_int = min_t(int, PAGE_SIZE, fw2.size - offset);
...
// Magic spell; don't ask us what this does
    ...
    let mut bcdDevice: u16 = le16_to_cpu(interface_to_usbdev(intf).descriptor.bcdDevice);
    let mut major_revision: u8 = bcdDevice >> 8;
    let mut minor_revision: u8 = bcdDevice & 0xff;
    char buf[24];
...
#[no_mangle]
unsafe extern "C" fn speedtch_heavy_init(usbatm: *mut usbatm_data, intf: *mut usb_interface) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn speedtch_read_status(instance: *mut speedtch_instance_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn speedtch_start_synchro(instance: *mut speedtch_instance_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn speedtch_check_status(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn speedtch_status_poll(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn speedtch_resubmit_int(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn speedtch_handle_int(int_urb: *mut urb) {
    static void speedtch_handle_int(struct urb *int_urb)
    {
    struct speedtch_instance_data *instance = int_urb.context;
    struct usbatm_data *usbatm = instance.usbatm;
    let mut count: c_uint = int_urb.actual_length;
    let mut status: c_int = int_urb.status;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn speedtch_atm_start(usbatm: *mut usbatm_data, atm_dev: *mut atm_dev) -> c_int {
...
// Doesn't matter; we'll poll anyway
    ...
    instance.int_urb = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn speedtch_atm_stop(usbatm: *mut usbatm_data, atm_dev: *mut atm_dev) {
...
//
    instance.int_urb = core::ptr::null_mut(); /* signal shutdown */
    mb();
...
#[no_mangle]
unsafe extern "C" fn speedtch_pre_reset(intf: *mut usb_interface) -> c_int {
    static int speedtch_pre_reset(struct usb_interface *intf)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn speedtch_post_reset(intf: *mut usb_interface) -> c_int {
...
//
    ...
    if (cur_intf) {
    usb_set_intfdata(cur_intf, core::ptr::null_mut());
    ...
    let mut num_interfaces: c_int = usb_dev.actconfig.desc.bNumInterfaces;
    int i, ret;
    int use_isoc;
    usb_dbg(usbatm, "%s entered\n", __func__);
// sanity checks
...
// module parameters may change at any moment, so take a snapshot
    ...
    let mut target_address: __u8 = USB_DIR_IN | usbatm.driver.isoc_in;
...
#[no_mangle]
unsafe extern "C" fn speedtch_unbind(usbatm: *mut usbatm_data, intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn speedtch_usb_probe(intf: *mut usb_interface, id: *const usb_device_id) -> c_int {
