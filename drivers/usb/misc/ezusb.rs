...
//! Source: drivers/usb/misc/ezusb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ezusb_fx_type {
// EZ-USB Control and Status Register.  Bit 0 controls 8051 reset
    pub cpucs_reg: c_ushort,
    pub max_internal_adress: c_ushort,
}
...
pub const WRITE_INT_RAM: c_uint = 0xA0;
pub const WRITE_EXT_RAM: c_uint = 0xA3;
    ...
    {
    let mut response: c_int = ezusb_writememory(dev, cpucs_reg, &reset_bit, 1, WRITE_INT_RAM);
    if (response < 0)
...
#[no_mangle]
pub unsafe extern "C" fn ezusb_fx1_set_reset(dev: *mut usb_device, reset_bit: c_uchar) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ezusb_fx2_set_reset(dev: *mut usb_device, reset_bit: c_uchar) -> c_int {
