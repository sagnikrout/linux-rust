...
//! Source: drivers/usb/misc/apple-mfi-fastcharge.c
#![no_std]
...
// Standard include files
    ...
    MODULE_LICENSE("GPL");
pub const TRICKLE_CURRENT_MA: c_int = 0;
pub const FAST_CURRENT_MA: c_int = 2500;
pub const APPLE_VENDOR_ID: c_uint = 0x05ac	/* Apple */;
...
pub struct mfi_device {
    ...
    core::ptr::null_mut(), 0, USB_CTRL_GET_TIMEOUT);
    if (retval) {
...
#[no_mangle]
unsafe extern "C" fn mfi_fc_match(udev: *mut usb_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mfi_fc_probe(udev: *mut usb_device) -> c_int {
    static int mfi_fc_probe(struct usb_device *udev)
    {
    let mut battery_cfg: power_supply_config = {};
    struct mfi_device *mfi = core::ptr::null_mut();
    char *battery_name;
    int err;
...
#[no_mangle]
unsafe extern "C" fn mfi_fc_disconnect(udev: *mut usb_device) {
