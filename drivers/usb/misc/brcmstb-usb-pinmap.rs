...
//! Source: drivers/usb/misc/brcmstb-usb-pinmap.c
#![no_std]
...
pub struct in_pin {
    ...
    pub gpiod: *mut gpio_desc,
    pub name: *const c_char,
    pub pdata: *mut brcmstb_usb_pinmap_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcmstb_usb_pinmap_data {
    pub regs: *mut void __iomem,
    pub in_count: c_int,
    pub in_pins: *mut in_pin,
    pub out_count: c_int,
    pub out_pins: *mut out_pin,
}

#[no_mangle]
unsafe extern "C" fn pinmap_set(reg: *mut void __iomem, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn pinmap_unset(reg: *mut void __iomem, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn sync_in_pin(pin: *mut in_pin) {
...
//
#[no_mangle]
unsafe extern "C" fn brcmstb_usb_pinmap_ovr_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn brcmstb_usb_pinmap_gpio_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sync_all_pins(pdata: *mut brcmstb_usb_pinmap_data) {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_usb_pinmap_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_usb_pinmap_init() -> int __init {
