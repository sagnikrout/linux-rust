...
//! Source: drivers/usb/misc/adutux.c
#![no_std]
...
pub const ADU_VENDOR_ID: c_uint = 0x0a07;
pub const ADU_PRODUCT_ID: c_uint = 0x0064;
...
pub const ADU_MINOR_BASE: c_int = 0;

pub const ADU_MINOR_BASE: c_int = 67;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adu_device {
    pub mtx: mutex,
    pub /: *mut *mut *mut usb_device udev; / save off the usb device pointer,
    pub interface: *mut usb_interface,
    pub /: *mut *mut unsigned int minor; / the starting minor number for this device,
    pub serial_number: [c_char; 8],
    pub /: *mut *mut int open_count; / number of times this port has been opened,
    pub disconnected:1: c_ulong,
    pub read_buffer_primary: *mut c_char,
    pub read_buffer_length: c_int,
    pub read_buffer_secondary: *mut c_char,
    pub secondary_head: c_int,
    pub secondary_tail: c_int,
...
//
#[no_mangle]
unsafe extern "C" fn adu_abort_transfers(dev: *mut adu_device) {
...
#[no_mangle]
unsafe extern "C" fn adu_delete(dev: *mut adu_device) {
...
#[no_mangle]
unsafe extern "C" fn adu_interrupt_in_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn adu_interrupt_out_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn adu_open(inode: *mut inode, file: *mut file) -> c_int {
    static int adu_open(struct inode *inode, struct file *file)
    {
    struct adu_device *dev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn adu_release_internal(dev: *mut adu_device) {
...
#[no_mangle]
unsafe extern "C" fn adu_release(inode: *mut inode, file: *mut file) -> c_int {
...
// the device was unplugged before the file was released
    ...
    let mut bytes_to_read: usize = count;
    let mut retval: c_int = 0;
    let mut timeout: c_int = 0;
    let mut should_submit: c_int = 0;
    unsigned long flags;
...
// verify that some data was requested
    ...
    while (bytes_to_read) {
    let mut data_in_secondary: usize = dev.secondary_tail - dev.secondary_head;
    dev_dbg(&dev.udev.dev,
...
// drain secondary buffer
    let mut amount: usize = min(bytes_to_read, data_in_secondary);
...
//
#[no_mangle]
unsafe extern "C" fn adu_disconnect(interface: *mut usb_interface) {
