...
//! Source: drivers/usb/misc/lvstest.c
#![no_std]
...
// urb buffer
    pub buffer: [u8; 8],
// class descriptor
    pub descriptor: usb_hub_descriptor,
// urb for polling interrupt pipe
    pub urb: *mut urb,
// LVH RH work
    pub rh_work: work_struct,
// RH port status
    pub port_status: usb_port_status,
}
...
#[no_mangle]
unsafe extern "C" fn destroy_lvs_device(udev: *mut usb_device) {
...
#[no_mangle]
unsafe extern "C" fn lvs_rh_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn lvs_rh_irq(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn lvs_rh_disconnect(intf: *mut usb_interface) {
