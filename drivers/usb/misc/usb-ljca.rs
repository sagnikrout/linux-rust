...
//! Source: drivers/usb/misc/usb-ljca.c
#![no_std]
...
pub const LJCA_WRITE_TIMEOUT_MS: c_int = 200;
pub const LJCA_WRITE_ACK_TIMEOUT_MS: c_int = 500;
pub const LJCA_ENUM_CLIENT_TIMEOUT_MS: c_int = 20;
// ljca client type
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ljca_i2c_descriptor {
    pub num: u8,
    pub __counted_by(num): ljca_i2c_ctr_info info[],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ljca_spi_ctr_info {
    pub id: u8,
    pub capacity: u8,
    pub intr_pin: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ljca_spi_descriptor {
    pub num: u8,
    pub __counted_by(num): ljca_spi_ctr_info info[],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ljca_bank_descriptor {
    pub bank_id: u8,
    pub pin_num: u8,
// 1 bit for each gpio, 1 means valid
    pub valid_pins: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ljca_gpio_descriptor {
    pub pins_per_bank: u8,
    pub bank_num: u8,
    pub __counted_by(bank_num): ljca_bank_descriptor bank_desc[],
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ljca_match_ids_walk_data {
...
#[no_mangle]
unsafe extern "C" fn ljca_handle_cmd_ack(adap: *mut ljca_adapter, header: *mut ljca_msg) {
...
#[no_mangle]
unsafe extern "C" fn ljca_recv(urb: *mut urb) {
...
// rx urb is terminated
    ...
    {
    let mut msg_len: c_uint = sizeof(struct ljca_msg) + obuf_len;
    ...
    obuf_len, core::ptr::null_mut(), 0, false, LJCA_WRITE_ACK_TIMEOUT_MS);
    }
...
#[no_mangle]
pub unsafe extern "C" fn ljca_unregister_event_cb(client: *mut ljca_client) {
    void ljca_unregister_event_cb(struct ljca_client *client)
    {
    unsigned long flags;
    spin_lock_irqsave(&client.event_cb_lock, flags);
    client.event_cb = core::ptr::null_mut();
    client.context = core::ptr::null_mut();
    spin_unlock_irqrestore(&client.event_cb_lock, flags);
    }
    EXPORT_SYMBOL_NS_GPL(ljca_unregister_event_cb, "LJCA");
#[no_mangle]
unsafe extern "C" fn ljca_match_device_ids(adev: *mut acpi_device, data: *mut c_void) -> c_int {
...
// bind auxiliary device to acpi device
    ...
    u64 adr, u8 id)
    {
    let mut wd: ljca_match_ids_walk_data = { 0 };
...
#[no_mangle]
unsafe extern "C" fn ljca_auxdev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ljca_enumerate_gpio(adap: *mut ljca_adapter) -> c_int {
    ...
    int ret, gpio_num;
    unsigned int i;
    ret = ljca_send(adap, LJCA_CLIENT_MNG, LJCA_MNG_ENUM_GPIO, core::ptr::null_mut(), 0, buf,
...
#[no_mangle]
unsafe extern "C" fn ljca_enumerate_i2c(adap: *mut ljca_adapter) -> c_int {
    ...
    unsigned int i;
    int ret;
    ret = ljca_send(adap, LJCA_CLIENT_MNG, LJCA_MNG_ENUM_I2C, core::ptr::null_mut(), 0, buf,
    sizeof(buf), true, LJCA_ENUM_CLIENT_TIMEOUT_MS);
    if (ret < 0)
    return ret;
// check firmware response
...
#[no_mangle]
unsafe extern "C" fn ljca_enumerate_spi(adap: *mut ljca_adapter) -> c_int {
...
// Not all LJCA chips implement SPI, a timeout reading the descriptors is normal
    ret = ljca_send(adap, LJCA_CLIENT_MNG, LJCA_MNG_ENUM_SPI, core::ptr::null_mut(), 0, buf,
    sizeof(buf), true, LJCA_ENUM_CLIENT_TIMEOUT_MS);
    if (ret < 0)
...
#[no_mangle]
unsafe extern "C" fn ljca_reset_handshake(adap: *mut ljca_adapter) -> c_int {
    static int ljca_reset_handshake(struct ljca_adapter *adap)
    {
    let mut reset_id: __le32 = cpu_to_le32(adap.reset_id);
    let mut reset_id_ret: __le32 = 0;
    int ret;
    adap.reset_id++;
...
#[no_mangle]
unsafe extern "C" fn ljca_enumerate_clients(adap: *mut ljca_adapter) -> c_int {
...
// ignore any others.
//
    ret = usb_find_common_endpoints(alt, &ep_in, &ep_out, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn ljca_disconnect(interface: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn ljca_suspend(interface: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ljca_resume(interface: *mut usb_interface) -> c_int {
