...
//! Source: drivers/usb/phy/phy-ab8500-usb.c
#![no_std]
...
pub const AB8500_MAIN_WD_CTRL_REG: c_uint = 0x01;
// Bank AB8500_USB
pub const AB8500_USB_LINE_STAT_REG: c_uint = 0x80;
pub const AB8505_USB_LINE_STAT_REG: c_uint = 0x94;
pub const AB8500_USB_PHY_CTRL_REG: c_uint = 0x8A;
// Bank AB8500_DEVELOPMENT
pub const AB8500_BANK12_ACCESS: c_uint = 0x00;
// Bank AB8500_DEBUG
pub const AB8500_USB_PHY_TUNE1: c_uint = 0x05;
pub const AB8500_USB_PHY_TUNE2: c_uint = 0x06;
pub const AB8500_USB_PHY_TUNE3: c_uint = 0x07;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_usb {
    pub phy: usb_phy,
    pub dev: *mut device,
    pub ab8500: *mut ab8500,
    pub vbus_draw: unsigned,
    pub phy_dis_work: work_struct,
    pub mode: enum ab8500_usb_mode,
    pub sysclk: *mut clk,
    pub v_ape: *mut regulator,
    pub v_musb: *mut regulator,
    pub v_ulpi: *mut regulator,
    pub saved_v_ulpi: c_int,
    pub previous_link_status_state: c_int,
    pub pinctrl: *mut pinctrl,
    pub pins_sleep: *mut pinctrl_state,
    pub enabled_charging_detection: bool,
    pub flags: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_wd_workaround(ab: *mut ab8500_usb) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_regulator_enable(ab: *mut ab8500_usb) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_regulator_disable(ab: *mut ab8500_usb) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_wd_linkstatus(ab: *mut ab8500_usb, bit: u8) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_phy_enable(ab: *mut ab8500_usb, sel_host: bool) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_phy_disable(ab: *mut ab8500_usb, sel_host: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pinctrl_select_state(ab->pinctrl, _arg: ab->pins_sleep)) -> else {
...
//
    ...
    {
    let mut event: enum ux500_musb_vbus_id_status = 0;
...
//
#[no_mangle]
unsafe extern "C" fn abx500_usb_link_status_update(ab: *mut ab8500_usb) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_usb_disconnect_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t ab8500_usb_disconnect_irq(int irq, void *data)
    {
    struct ab8500_usb *ab = (struct ab8500_usb *) data;
    let mut event: enum usb_phy_events = USB_EVENT_NONE;
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_link_status_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_phy_disable_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_set_suspend(x: *mut usb_phy, suspend: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_set_host(otg: *mut usb_otg, host: *mut usb_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_restart_phy(ab: *mut ab8500_usb) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_regulator_get(ab: *mut ab8500_usb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_set_ab8500_tuning_values(ab: *mut ab8500_usb) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_set_ab8505_tuning_values(ab: *mut ab8500_usb) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_ab8505(ab->ab8500)) -> else {
    else if (is_ab8505(ab.ab8500))
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_remove(pdev: *mut platform_device) {
    ...
    ab8500_usb_host_phy_dis(ab);
#[no_mangle]
pub unsafe extern "C" fn if(USB_PERIPHERAL: ab->mode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ab8500_usb_exit() -> void __exit {
