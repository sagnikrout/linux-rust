...
pub const DEFAULT_SDP_CUR_MIN: c_int = 2;
pub const DEFAULT_SDP_CUR_MAX: c_int = 500;
pub const DEFAULT_SDP_CUR_MIN_SS: c_int = 150;
pub const DEFAULT_SDP_CUR_MAX_SS: c_int = 900;
pub const DEFAULT_DCP_CUR_MIN: c_int = 500;
pub const DEFAULT_DCP_CUR_MAX: c_int = 5000;
pub const DEFAULT_CDP_CUR_MIN: c_int = 1500;
pub const DEFAULT_CDP_CUR_MAX: c_int = 5000;
pub const DEFAULT_ACA_CUR_MIN: c_int = 1500;
pub const DEFAULT_ACA_CUR_MAX: c_int = 5000;
...
pub struct phy_devm {
    ...
    {
    struct usb_phy  *phy = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn usb_phy_set_default_current(usb_phy: *mut usb_phy) {
...
//
#[no_mangle]
unsafe extern "C" fn usb_phy_notify_charger_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn usb_phy_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __usb_phy_get_charger_type(usb_phy: *mut usb_phy) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_phy_set_charger_current(usb_phy: *mut usb_phy, mA: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn devm_usb_phy_release(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn devm_usb_phy_release2(dev: *mut device, _res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn usb_charger_init(usb_phy: *mut usb_phy) {
...
#[no_mangle]
unsafe extern "C" fn usb_add_extcon(x: *mut usb_phy) -> c_int {
...
//
    ...
    phy = devm_usb_get_phy_by_node(dev, node, core::ptr::null_mut());
    of_node_put(node);
    return phy;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_put_phy(x: *mut usb_phy) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_add_phy(x: *mut usb_phy, type: enum usb_phy_type) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_add_phy_dev(x: *mut usb_phy) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_remove_phy(x: *mut usb_phy) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb_phy_set_event(x: *mut usb_phy, event: c_ulong) {
