...
//! Source: drivers/usb/phy/phy-tegra-usb.c
#![no_std]
...
pub const USB_TXFILLTUNING: c_uint = 0x154;

pub const USB_FIFO_TXFILL_MASK: c_uint = 0x1f0000;
pub const ULPI_VIEWPORT: c_uint = 0x170;
// PORTSC PTS/PHCD bits, Tegra20 only
pub const TEGRA_USB_PORTSC1: c_uint = 0x184;

// HOSTPC1 PTS/PHCD bits, Tegra30 and above
pub const TEGRA30_USB_PORTSC1: c_uint = 0x174;
pub const TEGRA_USB_HOSTPC1_DEVLC: c_uint = 0x1b4;

pub const TEGRA_USB_HOSTPC1_DEVLC_PTS_HSIC: c_int = 4;
// Bits of PORTSC1, which will get cleared by writing 1 into them

pub const USB_SUSP_CTRL: c_uint = 0x400;

pub const USB_PHY_VBUS_SENSORS: c_uint = 0x404;

pub const USB_PHY_VBUS_WAKEUP_ID: c_uint = 0x408;

pub const USB1_LEGACY_CTRL: c_uint = 0x410;

    (1 << 1)

pub const ULPI_TIMING_CTRL_0: c_uint = 0x424;

pub const ULPI_TIMING_CTRL_1: c_uint = 0x428;

pub const UTMIP_PLL_CFG1: c_uint = 0x804;

pub const UTMIP_XCVR_CFG0: c_uint = 0x808;

pub const UTMIP_BIAS_CFG0: c_uint = 0x80c;

pub const UTMIP_HSRX_CFG0: c_uint = 0x810;

pub const UTMIP_HSRX_CFG1: c_uint = 0x814;

pub const UTMIP_TX_CFG0: c_uint = 0x820;

pub const UTMIP_MISC_CFG0: c_uint = 0x824;

pub const UTMIP_MISC_CFG1: c_uint = 0x828;

pub const UTMIP_DEBOUNCE_CFG0: c_uint = 0x82c;

pub const UTMIP_BAT_CHRG_CFG0: c_uint = 0x830;

pub const UTMIP_SPARE_CFG0: c_uint = 0x834;

pub const UTMIP_XCVR_CFG1: c_uint = 0x838;

pub const UTMIP_BIAS_CFG1: c_uint = 0x83c;
...
//
pub const UHSIC_PLL_CFG1: c_uint = 0x804;

pub const UHSIC_HSRX_CFG0: c_uint = 0x808;

pub const UHSIC_HSRX_CFG1: c_uint = 0x80c;

pub const UHSIC_TX_CFG0: c_uint = 0x810;

pub const UHSIC_MISC_CFG0: c_uint = 0x814;

pub const UHSIC_MISC_CFG1: c_uint = 0x818;

pub const UHSIC_PADS_CFG0: c_uint = 0x81c;
pub const UHSIC_TX_RTUNEN: c_uint = 0xf000;

pub const UHSIC_PADS_CFG1: c_uint = 0x820;

pub const UHSIC_CMD_CFG0: c_uint = 0x824;

pub const UHSIC_STAT_CFG0: c_uint = 0x828;

// For Tegra30 and above only, the address is different in Tegra20
pub const USB_USBMODE: c_uint = 0x1f8;
...
pub struct tegra_xtal_freq {
    ...
    pub stable_count: u8,
    pub active_delay: u8,
    pub utmi_xtal_freq_count: u8,
    pub hsic_xtal_freq_count: u16,
    pub debounce: u16,
}
...
#[no_mangle]
unsafe extern "C" fn set_pts(phy: *mut tegra_usb_phy, pts_val: u8) {
...
#[no_mangle]
unsafe extern "C" fn set_phcd(phy: *mut tegra_usb_phy, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn utmip_pad_open(phy: *mut tegra_usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn utmip_pad_close(phy: *mut tegra_usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn utmip_pad_power_on(phy: *mut tegra_usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn utmip_pad_power_off(phy: *mut tegra_usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn utmi_wait_register(reg: *mut void __iomem, mask: u32, result: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn utmi_phy_clk_disable(phy: *mut tegra_usb_phy) {
...
#[no_mangle]
unsafe extern "C" fn utmi_phy_clk_enable(phy: *mut tegra_usb_phy) {
...
#[no_mangle]
unsafe extern "C" fn utmi_phy_power_on(phy: *mut tegra_usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn utmi_phy_power_off(phy: *mut tegra_usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ulpi_phy_power_on(phy: *mut tegra_usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ulpi_phy_power_off(phy: *mut tegra_usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_hsic_readl(phy: *mut tegra_usb_phy, reg: u32) -> u32 {
    static u32 tegra_hsic_readl(struct tegra_usb_phy *phy, u32 reg)
    {
    void __iomem *base = phy.regs;
    let mut shift: u32 = phy.soc_config.uhsic_registers_offset;
    return readl_relaxed(base + shift + reg);
    }
#[no_mangle]
unsafe extern "C" fn tegra_hsic_writel(phy: *mut tegra_usb_phy, reg: u32, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn uhsic_phy_power_on(phy: *mut tegra_usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uhsic_phy_power_off(phy: *mut tegra_usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_phy_power_on(phy: *mut tegra_usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_phy_power_off(phy: *mut tegra_usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_phy_shutdown(u_phy: *mut usb_phy) {
    ...
    phy.freq = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn tegra_usb_phy_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_phy_set_wakeup(u_phy: *mut usb_phy, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_phy_set_suspend(u_phy: *mut usb_phy, suspend: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_phy_configure_pmc(phy: *mut tegra_usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_phy_init(u_phy: *mut usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_phy_put_pmc_device(dev: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_phy_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_usb_phy_remove(pdev: *mut platform_device) {
