...
//! Source: drivers/usb/phy/phy-mxs-usb.c
#![no_std]
...
// Register Macro
pub const HW_USBPHY_PWD: c_uint = 0x00;
pub const HW_USBPHY_TX: c_uint = 0x10;
pub const HW_USBPHY_CTRL: c_uint = 0x30;
pub const HW_USBPHY_CTRL_SET: c_uint = 0x34;
pub const HW_USBPHY_CTRL_CLR: c_uint = 0x38;
pub const HW_USBPHY_DEBUG_SET: c_uint = 0x54;
pub const HW_USBPHY_DEBUG_CLR: c_uint = 0x58;
pub const HW_USBPHY_IP: c_uint = 0x90;
pub const HW_USBPHY_IP_SET: c_uint = 0x94;
pub const HW_USBPHY_IP_CLR: c_uint = 0x98;

// imx7ulp
pub const HW_USBPHY_PLL_SIC: c_uint = 0xa0;
pub const HW_USBPHY_PLL_SIC_SET: c_uint = 0xa4;
pub const HW_USBPHY_PLL_SIC_CLR: c_uint = 0xa8;

// imx7ulp

// Anatop Registers
pub const ANADIG_REG_1P1_SET: c_uint = 0x114;
pub const ANADIG_REG_1P1_CLR: c_uint = 0x118;
pub const ANADIG_ANA_MISC0: c_uint = 0x150;
pub const ANADIG_ANA_MISC0_SET: c_uint = 0x154;
pub const ANADIG_ANA_MISC0_CLR: c_uint = 0x158;
pub const ANADIG_USB1_CHRG_DETECT_SET: c_uint = 0x1b4;
pub const ANADIG_USB1_CHRG_DETECT_CLR: c_uint = 0x1b8;
pub const ANADIG_USB2_CHRG_DETECT_SET: c_uint = 0x214;

pub const ANADIG_USB1_VBUS_DET_STAT: c_uint = 0x1c0;

pub const ANADIG_USB1_CHRG_DET_STAT: c_uint = 0x1d0;

pub const ANADIG_USB2_VBUS_DET_STAT: c_uint = 0x220;
pub const ANADIG_USB1_LOOPBACK_SET: c_uint = 0x1e4;
pub const ANADIG_USB1_LOOPBACK_CLR: c_uint = 0x1e8;

pub const ANADIG_USB2_LOOPBACK_SET: c_uint = 0x244;
pub const ANADIG_USB2_LOOPBACK_CLR: c_uint = 0x248;
pub const ANADIG_USB1_MISC: c_uint = 0x1f0;
pub const ANADIG_USB2_MISC: c_uint = 0x250;

// System Integration Module (SIM) Registers
pub const SIM_GPR1: c_uint = 0x30;
...
pub const MXS_PHY_TX_CAL45_MIN: c_int = 35;
pub const MXS_PHY_TX_CAL45_MAX: c_int = 54;
pub const MXS_PHY_TX_D_CAL_MIN: c_int = 79;
pub const MXS_PHY_TX_D_CAL_MAX: c_int = 119;
//
...
pub struct mxs_phy {
    pub phy: usb_phy,
    pub clk: *mut clk,
    pub data: *const mxs_phy_data,
    pub regmap_anatop: *mut regmap,
    pub regmap_sim: *mut regmap,
    pub port_id: c_int,
    pub tx_reg_set: u32,
    pub tx_reg_mask: u32,
    pub phy_3p0: *mut regulator,
}

#[no_mangle]
pub unsafe extern "C" fn is_imx6q_phy(mxs_phy: *mut mxs_phy) -> bool {
    static inline bool is_imx6q_phy(struct mxs_phy *mxs_phy)
    {
    return mxs_phy.data == &imx6q_phy_data;
    }
#[no_mangle]
pub unsafe extern "C" fn is_imx6sl_phy(mxs_phy: *mut mxs_phy) -> bool {
    static inline bool is_imx6sl_phy(struct mxs_phy *mxs_phy)
    {
    return mxs_phy.data == &imx6sl_phy_data;
    }
#[no_mangle]
pub unsafe extern "C" fn is_imx7ulp_phy(mxs_phy: *mut mxs_phy) -> bool {
    static inline bool is_imx7ulp_phy(struct mxs_phy *mxs_phy)
    {
    return mxs_phy.data == &imx7ulp_phy_data;
    }
#[no_mangle]
pub unsafe extern "C" fn is_imx6ul_phy(mxs_phy: *mut mxs_phy) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn mxs_phy_clock_switch_delay() {
    static void mxs_phy_clock_switch_delay(void)
    {
    usleep_range(300, 400);
    }
#[no_mangle]
unsafe extern "C" fn mxs_phy_tx_init(mxs_phy: *mut mxs_phy) {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_pll_enable(base: *mut void __iomem, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_hw_init(mxs_phy: *mut mxs_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_get_vbus_status(mxs_phy: *mut mxs_phy) -> bool {
    static bool mxs_phy_get_vbus_status(struct mxs_phy *mxs_phy)
    {
    let mut vbus_value: c_uint = 0;
    if (!mxs_phy.regmap_anatop)
    return false;
    ...
    &vbus_value);
#[no_mangle]
pub unsafe extern "C" fn if(1: mxs_phy->port_id ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn __mxs_phy_disconnect_line(mxs_phy: *mut mxs_phy, disconnect: bool) {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_is_otg_host(mxs_phy: *mut mxs_phy) -> bool {
    static bool mxs_phy_is_otg_host(struct mxs_phy *mxs_phy)
    {
    return mxs_phy.phy.last_event == USB_EVENT_ID;
    }
#[no_mangle]
unsafe extern "C" fn mxs_phy_disconnect_line(mxs_phy: *mut mxs_phy, on: bool) {
    static void mxs_phy_disconnect_line(struct mxs_phy *mxs_phy, bool on)
    {
    let mut vbus_is_on: bool = false;
    let mut last_event: enum usb_phy_events = mxs_phy.phy.last_event;
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_init(phy: *mut usb_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_shutdown(phy: *mut usb_phy) {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_is_low_speed_connection(mxs_phy: *mut mxs_phy) -> bool {
...
// bit definition is the same for all controllers
    ...
    let mut reg: c_uint = ANADIG_USB1_MISC;
// If the SoCs don't have anatop, quit
    if (!mxs_phy.regmap_anatop)
    return false;
    if (mxs_phy.port_id == 0)
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_suspend(x: *mut usb_phy, suspend: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_set_wakeup(x: *mut usb_phy, enabled: bool) -> c_int {
...
pub const MXS_USB_CHARGER_DATA_CONTACT_TIMEOUT: c_int = 100;
#[no_mangle]
unsafe extern "C" fn mxs_charger_data_contact_detect(x: *mut mxs_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_charger_primary_detection(x: *mut mxs_phy) -> enum usb_charger_type {
    static enum usb_charger_type mxs_charger_primary_detection(struct mxs_phy *x)
    {
    struct regmap *regmap = x.regmap_anatop;
    let mut chgr_type: enum usb_charger_type = UNKNOWN_TYPE;
    u32 val;
//
...
//
#[no_mangle]
unsafe extern "C" fn mxs_charger_secondary_detection(x: *mut mxs_phy) -> enum usb_charger_type {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_charger_detect(phy: *mut usb_phy) -> enum usb_charger_type {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_probe(pdev: *mut platform_device) -> c_int {
...
// Currently, only imx7ulp has SIM module
    if (of_get_property(np, "nxp,sim", core::ptr::null_mut())) {
...
// not exist
    mxs_phy.phy_3p0 = core::ptr::null_mut();
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_ERR(mxs_phy->phy_3p0)) -> else {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_wakeup_enable(mxs_phy: *mut mxs_phy, on: bool) {
    static void mxs_phy_wakeup_enable(struct mxs_phy *mxs_phy, bool on)
    {
    let mut mask: u32 = USB_PHY_VLLS_WAKEUP_EN;
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_enable_ldo_in_suspend(mxs_phy: *mut mxs_phy, on: bool) {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_system_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_system_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mxs_phy_module_exit() -> void __exit {
