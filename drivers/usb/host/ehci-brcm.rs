...
//! Source: drivers/usb/host/ehci-brcm.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn ehci_brcm_wait_for_sof(ehci: *mut ehci_hcd, delay: u32) {
    static inline void ehci_brcm_wait_for_sof(struct ehci_hcd *ehci, u32 delay)
    {
    let mut frame_idx: u32 = ehci_readl(ehci, &ehci.regs.frame_index);
    u32 val;
    int res;
...
#[no_mangle]
unsafe extern "C" fn ehci_brcm_reset(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ehci_brcm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ehci_brcm_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ehci_brcm_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn ehci_brcm_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn ehci_brcm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ehci_brcm_exit() -> void __exit {
