...
//! Source: drivers/usb/host/uhci-hub.c
#![no_std]
...
pub const UHCI_RH_MAXCHILD: c_int = 7;
...
//
#[no_mangle]
unsafe extern "C" fn any_ports_active(uhci: *mut uhci_hcd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_hub_status_data(uhci: *mut uhci_hcd, buf: *mut c_char) -> c_int {
    static inline int get_hub_status_data(struct uhci_hcd *uhci, char *buf)
    {
    int port;
    let mut mask: c_int = RWC_BITS;
...
//
#[no_mangle]
unsafe extern "C" fn wait_for_HP(uhci: *mut uhci_hcd, port_addr: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn uhci_check_ports(uhci: *mut uhci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn uhci_hub_status_data(hcd: *mut usb_hcd, buf: *mut c_char) -> c_int {
...
// size of returned buffer is part of USB spec
    ...
    let mut port: c_uint = wIndex - 1;
    let mut port_addr: c_ulong = USBPORTSC1 + 2 * port;
