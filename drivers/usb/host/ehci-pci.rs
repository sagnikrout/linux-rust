...
//! Source: drivers/usb/host/ehci-pci.c
#![no_std]
...
pub const PCI_DEVICE_ID_INTEL_CE4100_USB: c_uint = 0x2e70;
pub const PCI_DEVICE_ID_ASPEED_EHCI: c_uint = 0x2603;
// -------------------------------------------------------------------------
pub const PCI_DEVICE_ID_INTEL_QUARK_X1000_SOC: c_uint = 0x0939;
#[no_mangle]
pub unsafe extern "C" fn is_intel_quark_x1000(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_bypassed_id(pdev: *mut pci_dev) -> bool {
...
pub const INTEL_QUARK_X1000_EHCI_MAX_THRESHOLD: c_uint = 0x007f007f;
// called after powerup, by probe or system-pm "wakeup"
#[no_mangle]
unsafe extern "C" fn ehci_pci_reinit(ehci: *mut ehci_hcd, pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ehci_pci_setup(hcd: *mut usb_hcd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ehci_pci_resume(hcd: *mut usb_hcd, msg: pm_message_t) -> c_int {
    static int ehci_pci_resume(struct usb_hcd *hcd, pm_message_t msg)
    {
    struct ehci_hcd		*ehci = hcd_to_ehci(hcd);
    struct pci_dev		*pdev = to_pci_dev(hcd.self.controller);
    let mut hibernated: bool = (msg.event == PM_EVENT_RESTORE);
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ehci_pci_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ehci_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn ehci_pci_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ehci_pci_cleanup() -> void __exit {
