...
//! Source: drivers/usb/host/xhci-dbgtty.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dbc_do_start_tx(port: *mut dbc_port) -> c_int {
    ...
    let mut do_tty_wake: bool = false;
...
#[no_mangle]
unsafe extern "C" fn dbc_start_tx(port: *mut dbc_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dbc_start_rx(port: *mut dbc_port) {
...
//
#[no_mangle]
unsafe extern "C" fn dbc_rx_push_buffer(port: *mut dbc_port, req: *mut dbc_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dbc_write_complete(dbc: *mut xhci_dbc, req: *mut dbc_request) {
...
#[no_mangle]
unsafe extern "C" fn xhci_dbc_free_req(req: *mut dbc_request) {
...
#[no_mangle]
unsafe extern "C" fn dbc_tty_install(driver: *mut tty_driver, tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dbc_tty_open(tty: *mut tty_struct, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dbc_tty_close(tty: *mut tty_struct, file: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn dbc_tty_put_char(tty: *mut tty_struct, ch: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dbc_tty_flush_chars(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn dbc_tty_write_room(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn dbc_tty_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn dbc_tty_unthrottle(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn dbc_rx_push(t: *mut tasklet_struct) {
...
#[no_mangle]
unsafe extern "C" fn dbc_port_activate(_port: *mut tty_port, tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xhci_dbc_tty_register_device(dbc: *mut xhci_dbc) -> c_int {
    ...
    dbc_tty_driver, port.minor, core::ptr::null_mut());
    if (IS_ERR(tty_dev)) {
    ret = PTR_ERR(tty_dev);
    goto err_free_requests;
    }
...
#[no_mangle]
unsafe extern "C" fn xhci_dbc_tty_unregister_device(dbc: *mut xhci_dbc) {
...
#[no_mangle]
pub unsafe extern "C" fn xhci_dbc_tty_probe(dev: *mut device, base: *mut void __iomem, xhci: *mut xhci_hcd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn xhci_dbc_tty_remove(dbc: *mut xhci_dbc) {
...
#[no_mangle]
pub unsafe extern "C" fn dbc_tty_init() -> c_int {
    ...
    dbc_tty_driver = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn dbc_tty_exit() {
