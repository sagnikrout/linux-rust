...
//! Source: drivers/usb/host/ohci-ps3.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ps3_ohci_hc_reset(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_ohci_hc_start(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_ohci_probe(dev: *mut ps3_system_bus_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_ohci_remove(dev: *mut ps3_system_bus_device) {
...
#[no_mangle]
unsafe extern "C" fn ps3_ohci_driver_register(drv: *mut ps3_system_bus_driver) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ps3_ohci_driver_unregister(drv: *mut ps3_system_bus_driver) {
