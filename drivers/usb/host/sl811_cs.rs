...
//! Source: drivers/usb/host/sl811_cs.c
#![no_std]
...
// ====================================================================
#[no_mangle]
unsafe extern "C" fn release_platform_dev(dev: *mut *mut device) {
...
// ====================================================================
#[no_mangle]
unsafe extern "C" fn sl811_cs_detach(link: *mut pcmcia_device) {
...
#[no_mangle]
unsafe extern "C" fn sl811_cs_release(link: *mut *mut pcmcia_device) {
    static void sl811_cs_release(struct pcmcia_device * link)
    {
...
#[no_mangle]
unsafe extern "C" fn sl811_cs_config_check(p_dev: *mut pcmcia_device, priv_data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sl811_cs_config(link: *mut pcmcia_device) -> c_int {
    ...
    if (pcmcia_loop_config(link, sl811_cs_config_check, core::ptr::null_mut()))
    goto failed;
...
#[no_mangle]
unsafe extern "C" fn sl811_cs_probe(link: *mut pcmcia_device) -> c_int {
