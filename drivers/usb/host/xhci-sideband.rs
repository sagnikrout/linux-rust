...
//! Source: drivers/usb/host/xhci-sideband.c
#![no_std]
...
//
    ...
    ep.sideband = core::ptr::null_mut();
    sb.eps[ep.ep_index] = core::ptr::null_mut();
    }
// Caller must hold sb->mutex
    static void
...
//
#[no_mangle]
pub unsafe extern "C" fn xhci_sideband_check(hcd: *mut usb_hcd) -> bool {
...
//
    ...
    __xhci_sideband_remove_interrupter(sb);
    sb.vdev = core::ptr::null_mut();
    }
    spin_lock_irq(&xhci.lock);
    sb.xhci = core::ptr::null_mut();
    vdev.sideband = core::ptr::null_mut();
    spin_unlock_irq(&xhci.lock);
    kfree(sb);
    }
