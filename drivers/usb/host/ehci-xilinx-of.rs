...
//! Source: drivers/usb/host/ehci-xilinx-of.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ehci_xilinx_port_handed_over(hcd: *mut usb_hcd, portnum: c_int) -> c_int {
...
//
    ...
    .relinquish_port	= core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn ehci_hcd_xilinx_of_probe(op: *mut platform_device) -> c_int {
...
//
    value = (int *)of_get_property(dn, "xlnx,support-usb-fs", core::ptr::null_mut());
    if (value && (*value == 1)) {
...
//
#[no_mangle]
unsafe extern "C" fn ehci_hcd_xilinx_of_remove(op: *mut platform_device) {
