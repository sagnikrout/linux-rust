...
//! Source: drivers/usb/host/uhci-pci.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn uhci_pci_reset_hc(uhci: *mut uhci_hcd) {
...
//
#[no_mangle]
unsafe extern "C" fn uhci_pci_check_and_reset_hc(uhci: *mut uhci_hcd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uhci_pci_configure_hc(uhci: *mut uhci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn uhci_pci_resume_detect_interrupts_are_broken(uhci: *mut uhci_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uhci_pci_global_suspend_mode_is_broken(uhci: *mut uhci_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uhci_pci_init(hcd: *mut usb_hcd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uhci_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn uhci_pci_suspend(hcd: *mut usb_hcd, do_wakeup: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uhci_pci_resume(hcd: *mut usb_hcd, msg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uhci_pci_probe(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
