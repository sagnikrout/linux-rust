...
//! Source: drivers/usb/host/xhci-mem.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn xhci_segment_free(xhci: *mut xhci_hcd, seg: *mut xhci_segment) {
    static void xhci_segment_free(struct xhci_hcd *xhci, struct xhci_segment *seg)
    {
    if (seg.trbs) {
    dma_pool_free(xhci.segment_pool, seg.trbs, seg.dma);
    seg.trbs = core::ptr::null_mut();
    }
    kfree(seg.bounce_buf);
    kfree(seg);
    }
#[no_mangle]
unsafe extern "C" fn xhci_ring_segments_free(xhci: *mut xhci_hcd, ring: *mut xhci_ring) {
    static void xhci_ring_segments_free(struct xhci_hcd *xhci, struct xhci_ring *ring)
    {
    struct xhci_segment *seg, *next;
    ring.last_seg.next = core::ptr::null_mut();
    seg = ring.first_seg;
    while (seg) {
    next = seg.next;
...
//
#[no_mangle]
unsafe extern "C" fn xhci_set_link_trb(seg: *mut xhci_segment, chain_links: bool) {
...
#[no_mangle]
unsafe extern "C" fn xhci_initialize_ring_segments(xhci: *mut xhci_hcd, ring: *mut xhci_ring) {
...
#[no_mangle]
pub unsafe extern "C" fn xhci_ring_init(xhci: *mut xhci_hcd, ring: *mut xhci_ring) {
...
//
#[no_mangle]
unsafe extern "C" fn xhci_link_rings(xhci: *mut xhci_hcd, src: *mut xhci_ring, dst: *mut xhci_ring) {
...
// Skip any segments that were already added.
    ...
    int ret;
    if (WARN_ON_ONCE(trb_address_map == core::ptr::null_mut()))
    return 0;
...
#[no_mangle]
unsafe extern "C" fn xhci_remove_stream_mapping(ring: *mut xhci_ring) {
    static void xhci_remove_stream_mapping(struct xhci_ring *ring)
    {
    struct xhci_segment *seg;
    if (WARN_ON_ONCE(ring.trb_address_map == core::ptr::null_mut()))
    return;
    xhci_for_each_ring_seg(ring.first_seg, seg)
    xhci_remove_segment_mapping(ring.trb_address_map, seg);
    }
#[no_mangle]
unsafe extern "C" fn xhci_update_stream_mapping(ring: *mut xhci_ring, mem_flags: gfp_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xhci_ring_free(xhci: *mut xhci_hcd, ring: *mut xhci_ring) {
...
#[no_mangle]
pub unsafe extern "C" fn xhci_initialize_ring_info(ring: *mut xhci_ring) {
...
#[no_mangle]
unsafe extern "C" fn xhci_alloc_segments_for_ring(xhci: *mut xhci_hcd, ring: *mut xhci_ring, flags: gfp_t) -> c_int {
...
//
    ...
    virt_dev.eps[ep_index].ring = core::ptr::null_mut();
    }
//
...
// Streams structures manipulation
    ...
    {
    struct device *dev = xhci_to_hcd(xhci).self.sysdev;
    let mut size: usize = array_size(sizeof(struct xhci_stream_ctx), num_stream_ctxs);
    if (size > MEDIUM_STREAM_ARRAY_SIZE)
    dma_free_coherent(dev, size, stream_ctx, dma);
#[no_mangle]
pub unsafe extern "C" fn if(SMALL_STREAM_ARRAY_SIZE: size >) -> else {
...
// Set deq ptr, cycle bit, and stream context type
    ...
    stream_info.stream_rings[cur_stream] = core::ptr::null_mut();
    goto cleanup_rings;
    }
    }
...
//
    ...
    {
    int i;
    let mut old_active_eps: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn xhci_free_virt_devices_depth_first(xhci: *mut xhci_hcd, slot_id: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn xhci_setup_addressable_virt_dev(xhci: *mut xhci_hcd, udev: *mut usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xhci_get_endpoint_type(ep: *mut usb_host_endpoint) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn xhci_clear_endpoint_bw_info(bw_info: *mut xhci_bw_info) {
...
#[no_mangle]
unsafe extern "C" fn scratchpad_alloc(xhci: *mut xhci_hcd, flags: gfp_t) -> c_int {
    static int scratchpad_alloc(struct xhci_hcd *xhci, gfp_t flags)
    {
    int i;
    struct device *dev = xhci_to_hcd(xhci).self.sysdev;
    let mut num_sp: c_int = HCS_MAX_SCRATCHPAD(xhci.hcs_params2);
    ...
    xhci.scratchpad = core::ptr::null_mut();
    fail_sp:
    return -ENOMEM;
    }
#[no_mangle]
unsafe extern "C" fn scratchpad_free(xhci: *mut xhci_hcd) {
...
#[no_mangle]
pub unsafe extern "C" fn xhci_urb_free_priv(urb_priv: *mut urb_priv) {
...
//
    ...
    ir.erst.entries = core::ptr::null_mut();
// free interrupter event ring
    if (ir.event_ring)
    xhci_ring_free(xhci, ir.event_ring);
    ir.event_ring = core::ptr::null_mut();
    kfree(ir);
    }
#[no_mangle]
pub unsafe extern "C" fn xhci_remove_secondary_interrupter(hcd: *mut usb_hcd, ir: *mut xhci_interrupter) {
...
//
    ...
    xhci.interrupters[intr_num] = core::ptr::null_mut();
    spin_unlock_irq(&xhci.lock);
...
#[no_mangle]
pub unsafe extern "C" fn xhci_rh_bw_cleanup(xhci: *mut xhci_hcd) {
...
#[no_mangle]
pub unsafe extern "C" fn xhci_mem_cleanup(xhci: *mut xhci_hcd) {
    ...
    xhci.interrupters[i] = core::ptr::null_mut();
    }
    }
    xhci_dbg_trace(xhci, trace_xhci_dbg_init, "Freed interrupters");
    if (xhci.cmd_ring)
    xhci_ring_free(xhci, xhci.cmd_ring);
    xhci.cmd_ring = core::ptr::null_mut();
    ...
    xhci.segment_pool = core::ptr::null_mut();
    xhci_dbg_trace(xhci, trace_xhci_dbg_init, "Freed segment pool");
    dma_pool_destroy(xhci.device_pool);
    xhci.device_pool = core::ptr::null_mut();
    xhci_dbg_trace(xhci, trace_xhci_dbg_init, "Freed device context pool");
    dma_pool_destroy(xhci.small_streams_pool);
    xhci.small_streams_pool = core::ptr::null_mut();
    xhci_dbg_trace(xhci, trace_xhci_dbg_init,
    "Freed small stream array pool");
    dma_pool_destroy(xhci.port_bw_pool);
    xhci.port_bw_pool = core::ptr::null_mut();
    xhci_dbg_trace(xhci, trace_xhci_dbg_init,
    "Freed xhci port bw array pool");
    dma_pool_destroy(xhci.medium_streams_pool);
    xhci.medium_streams_pool = core::ptr::null_mut();
    xhci_dbg_trace(xhci, trace_xhci_dbg_init,
    ...
    dcbaa.ctx_array = core::ptr::null_mut();
    }
    ...
    xhci.usb2_rhub.ports = core::ptr::null_mut();
    xhci.usb3_rhub.ports = core::ptr::null_mut();
    xhci.hw_ports = core::ptr::null_mut();
    xhci.rh_bw = core::ptr::null_mut();
    xhci.port_caps = core::ptr::null_mut();
    xhci.interrupters = core::ptr::null_mut();
    xhci.devs = core::ptr::null_mut();
    xhci.usb2_rhub.bus_state.bus_suspended = 0;
    xhci.usb3_rhub.bus_state.bus_suspended = 0;
    }
#[no_mangle]
unsafe extern "C" fn xhci_set_hc_event_deq(xhci: *mut xhci_hcd, ir: *mut xhci_interrupter) {
...
//
#[no_mangle]
unsafe extern "C" fn xhci_setup_port_arrays(xhci: *mut xhci_hcd, flags: gfp_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xhci_add_interrupter(xhci: *mut xhci_hcd, intr_num: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn xhci_mem_init(xhci: *mut xhci_hcd, flags: gfp_t) -> c_int {
