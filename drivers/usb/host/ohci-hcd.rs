...
//! Source: drivers/usb/host/ohci-hcd.c
#![no_std]
...
pub const IO_WATCHDOG_OFF: c_uint = 0xffffff00;
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn number_of_tds(urb: *mut urb) -> c_int {
...
// Start up the I/O watchdog timer, if it's not running
    ...
    let mut frame: u16 = ohci_frame_no(ohci);
// delay a few frames before the first TD
    ...
    let mut next: u16 = ohci_frame_no(ohci) + 1;
    let mut frame: u16 = ed.last_iso + ed.interval;
    let mut length: u16 = ed.interval * (size - 1);
...
//
#[no_mangle]
unsafe extern "C" fn ohci_urb_dequeue(hcd: *mut usb_hcd, urb: *mut urb, status: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ohci_get_frame(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ohci_usb_reset(ohci: *mut ohci_hcd) {
...
//
#[no_mangle]
unsafe extern "C" fn _ohci_shutdown(hcd: *mut usb_hcd) {
...
#[no_mangle]
unsafe extern "C" fn ohci_shutdown(hcd: *mut usb_hcd) {
...
#[no_mangle]
unsafe extern "C" fn ohci_init(ohci: *mut ohci_hcd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ohci_run(ohci: *mut ohci_hcd) -> c_int {
    static int ohci_run (struct ohci_hcd *ohci)
    {
    u32			mask, val;
    let mut first: c_int = ohci.fminterval == 0;
    struct usb_hcd		*hcd = ohci_to_hcd(ohci);
    ohci.rh_state = OHCI_RH_HALTED;
...
#[no_mangle]
pub unsafe extern "C" fn ohci_setup(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ohci_start(hcd: *mut usb_hcd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn io_watchdog_func(t: *mut timer_list) {
    static void io_watchdog_func(struct timer_list *t)
    {
    struct ohci_hcd	*ohci = timer_container_of(ohci, t,
    io_watchdog);
    let mut takeback_all_pending: bool = false;
    u32		status;
    u32		head;
    struct ed	*ed;
...
// Check every ED which might have pending TDs
    ...
    let mut tmp: unsigned = hc32_to_cpu(ohci, ed.hwINFO);
...
#[no_mangle]
unsafe extern "C" fn ohci_irq(hcd: *mut usb_hcd) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(OHCI_INTR_RD: ints &) -> else {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ohci_stop(hcd: *mut usb_hcd) {
    static void ohci_stop (struct usb_hcd *hcd)
    {
    struct ohci_hcd		*ohci = hcd_to_ohci (hcd);
    ohci_dump(ohci);
...
#[no_mangle]
pub unsafe extern "C" fn ohci_restart(ohci: *mut ohci_hcd) -> c_int {
...
// no EDs to remove
    ohci.ed_rm_list = core::ptr::null_mut();
// empty control and bulk lists
    ohci.ed_controltail = core::ptr::null_mut();
    ohci.ed_bulktail    = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ohci_suspend(hcd: *mut usb_hcd, do_wakeup: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ohci_resume(hcd: *mut usb_hcd, hibernated: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ohci_hcd_mod_init() -> int __init {
...
// Error path
    ...
    ohci_debug_root = core::ptr::null_mut();
    return retval;
    }
    module_init(ohci_hcd_mod_init);
#[no_mangle]
unsafe extern "C" fn ohci_hcd_mod_exit() -> void __exit {
