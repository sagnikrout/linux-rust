...
//! Source: drivers/usb/host/ehci-timer.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ehci_set_command_bit(ehci: *mut ehci_hcd, bit: u32) {
...
#[no_mangle]
unsafe extern "C" fn ehci_clear_command_bit(ehci: *mut ehci_hcd, bit: u32) {
...
#[no_mangle]
unsafe extern "C" fn ehci_poll_ASS(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn ehci_disable_ASE(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn ehci_poll_PSS(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn ehci_disable_PSE(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn ehci_handle_controller_death(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn ehci_handle_start_intr_unlinks(ehci: *mut ehci_hcd) {
    static void ehci_handle_start_intr_unlinks(struct ehci_hcd *ehci)
    {
    let mut stopped: bool = (ehci.rh_state < EHCI_RH_RUNNING);
//
...
#[no_mangle]
unsafe extern "C" fn ehci_handle_intr_unlinks(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn start_free_itds(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn end_free_itds(ehci: *mut ehci_hcd) {
    static void end_free_itds(struct ehci_hcd *ehci)
    {
    struct ehci_itd		*itd, *n;
    struct ehci_sitd	*sitd, *sn;
    if (ehci.rh_state < EHCI_RH_RUNNING) {
    ehci.last_itd_to_free = core::ptr::null_mut();
    ehci.last_sitd_to_free = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn ehci_iaa_watchdog(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn turn_on_io_watchdog(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn ehci_hrtimer_func(t: *mut hrtimer) -> enum hrtimer_restart {
