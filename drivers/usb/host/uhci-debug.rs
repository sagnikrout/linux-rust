...
//! Source: drivers/usb/host/uhci-debug.c
#![no_std]
...
pub const EXTRA_SPACE: c_int = 1024;
    static struct dentry *uhci_debugfs_root;

// Handle REALLY large printks so we don't overflow buffers
#[no_mangle]
unsafe extern "C" fn lprintk(buf: *mut c_char) {
...
// p = 0;
    ...
    char *out = buf;
    int i, nurbs;
    let mut element: __hc32 = qh_element(qh);
    char *qtype;
    switch (qh.type) {
...
#[no_mangle]
pub unsafe extern "C" fn if(USB_ENDPOINT_XFER_INT: qh->type ==) -> else {
    ...
    out += sprintf(out, "%*s  Element is core::ptr::null_mut() (bug?)\n", space, "");
    if (out - buf > len)
    goto done;
...
#[no_mangle]
unsafe extern "C" fn uhci_show_sc(port: c_int, status: c_ushort, buf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uhci_show_root_hub_state(uhci: *mut uhci_hcd, buf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uhci_show_status(uhci: *mut uhci_hcd, buf: *mut c_char, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uhci_sprint_schedule(uhci: *mut uhci_hcd, buf: *mut c_char, len: c_int) -> c_int {
...
// Last QH is the Terminating QH, it's different
    ...
    ;
#[no_mangle]
pub unsafe extern "C" fn if(SKEL_ASYNC: i <) -> else {
    else if (i < SKEL_ASYNC)
    link = LINK_TO_QH(uhci, uhci.skel_async_qh);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !uhci->fsbr_is_on) -> else {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uhci_debug {
    pub size: c_int,
    pub data: *mut c_char,
}

#[no_mangle]
unsafe extern "C" fn uhci_debug_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uhci_debug_lseek(file: *mut file, off: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn uhci_debug_release(inode: *mut inode, file: *mut file) -> c_int {
...
// Macro flag: #define UHCI_DEBUG_OPS

#[no_mangle]
pub unsafe extern "C" fn lprintk(buf: *mut c_char) {
