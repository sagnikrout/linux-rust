...
//! Source: drivers/usb/host/ehci-grlib.c
#![no_std]
...
pub const GRUSBHC_HCIVERSION: c_uint = 0x0100 /* Known value of cap. reg. HCIVERSION */;
...
#[no_mangle]
unsafe extern "C" fn ehci_hcd_grlib_probe(op: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ehci_hcd_grlib_remove(op: *mut platform_device) {
