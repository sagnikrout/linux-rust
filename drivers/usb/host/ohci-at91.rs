...
//! Source: drivers/usb/host/ohci-at91.c
#![no_std]
...
pub const AT91_MAX_USBH_PORTS: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct at91_usbh_data {
    pub vbus_pin: [*mut gpio_desc; AT91_MAX_USBH_PORTS],
    pub overcurrent_pin: [*mut gpio_desc; AT91_MAX_USBH_PORTS],
    pub /: *mut *mut u8 ports; / number of ports on root hub,
    pub overcurrent_supported: u8,
    pub overcurrent_status: [u8; AT91_MAX_USBH_PORTS],
    pub overcurrent_changed: [u8; AT91_MAX_USBH_PORTS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ohci_at91_priv {
    pub iclk: *mut clk,
    pub fclk: *mut clk,
    pub hclk: *mut clk,
    pub clocked: bool,
    pub /: *mut *mut bool wakeup; / Saved wake-up state for resume,
    pub sfr_regmap: *mut regmap,
    pub suspend_smc_id: u32,
}
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn at91_start_clock(ohci_at91: *mut ohci_at91_priv) {
...
#[no_mangle]
unsafe extern "C" fn at91_stop_clock(ohci_at91: *mut ohci_at91_priv) {
...
#[no_mangle]
unsafe extern "C" fn at91_start_hc(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn at91_stop_hc(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn at91_dt_suspend_smc(dev: *mut device) -> u32 {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ohci_at91_usb_set_power(pdata: *mut at91_usbh_data, port: c_int, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ohci_at91_usb_get_power(pdata: *mut at91_usbh_data, port: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ohci_at91_hub_status_data(hcd: *mut usb_hcd, buf: *mut c_char) -> c_int {
    static int ohci_at91_hub_status_data(struct usb_hcd *hcd, char *buf)
    {
    struct at91_usbh_data *pdata = hcd.self.controller.platform_data;
    let mut length: c_int = ohci_hub_status_data(hcd, buf);
    int port;
...
#[no_mangle]
unsafe extern "C" fn ohci_at91_port_suspend(ohci_at91: *mut ohci_at91_priv, set: u8) -> c_int {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ohci_hcd_at91_overcurrent_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ohci_hcd_at91_drv_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ohci_hcd_at91_drv_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ohci_at91_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ohci_at91_cleanup() -> void __exit {
