...
//! Source: drivers/usb/host/bcma-hcd.c
#![no_std]
...
pub const USB_BCMA_CLKCTLST_USB_CLK_REQ: c_uint = 0x00000100;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcma_hcd_device {
    pub core: *mut bcma_device,
    pub ehci_dev: *mut platform_device,
    pub ohci_dev: *mut platform_device,
    pub gpio_desc: *mut gpio_desc,
}
...
#[no_mangle]
unsafe extern "C" fn bcma_hcd_4716wa(dev: *mut bcma_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(453000000: tmp ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn bcma_hcd_init_chip_mips(dev: *mut bcma_device) {
...
//
#[no_mangle]
unsafe extern "C" fn bcma_hcd_usb20_old_arm_init(usb_dev: *mut bcma_hcd_device) -> c_int {
...
// Take controller out of reset
    ...
    usleep_range(25, 50);
    of_platform_default_populate(dev.of_node, core::ptr::null_mut(), dev);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn bcma_hcd_usb20_ns_init_hc(dev: *mut bcma_device) {
...
//
#[no_mangle]
unsafe extern "C" fn bcma_hcd_usb20_ns_init(bcma_hcd: *mut bcma_hcd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcma_hci_platform_power_gpio(dev: *mut bcma_device, val: bool) {
...
#[no_mangle]
unsafe extern "C" fn bcma_hcd_usb20_init(usb_dev: *mut bcma_hcd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcma_hcd_usb30_init(bcma_hcd: *mut bcma_hcd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcma_hcd_probe(core: *mut bcma_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_ENABLED(CONFIG_MIPS)) -> else {
...
#[no_mangle]
unsafe extern "C" fn bcma_hcd_remove(dev: *mut bcma_device) {
...
#[no_mangle]
unsafe extern "C" fn bcma_hcd_shutdown(dev: *mut bcma_device) {
...
#[no_mangle]
unsafe extern "C" fn bcma_hcd_suspend(dev: *mut bcma_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcma_hcd_resume(dev: *mut bcma_device) -> c_int {
