...
//! Source: drivers/usb/host/ohci-sm501.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ohci_sm501_init(hcd: *mut usb_hcd) -> c_int {
    static int ohci_sm501_init(struct usb_hcd *hcd)
    {
    return ohci_init(hcd_to_ohci(hcd));
    }
#[no_mangle]
unsafe extern "C" fn ohci_sm501_start(hcd: *mut usb_hcd) -> c_int {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ohci_hcd_sm501_drv_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ohci_hcd_sm501_drv_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ohci_sm501_suspend(pdev: *mut platform_device, msg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ohci_sm501_resume(pdev: *mut platform_device) -> c_int {
