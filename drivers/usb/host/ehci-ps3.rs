...
//! Source: drivers/usb/host/ehci-ps3.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ps3_ehci_setup_insnreg(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn ps3_ehci_hc_reset(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_ehci_probe(dev: *mut ps3_system_bus_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_ehci_remove(dev: *mut ps3_system_bus_device) {
...
#[no_mangle]
unsafe extern "C" fn ps3_ehci_driver_register(drv: *mut ps3_system_bus_driver) -> int __init {
    static int __init ps3_ehci_driver_register(struct ps3_system_bus_driver *drv)
    {
#[no_mangle]
pub unsafe extern "C" fn firmware_has_feature(_arg: FW_FEATURE_PS3_LV1) -> return {
    return firmware_has_feature(FW_FEATURE_PS3_LV1)
    ? ps3_system_bus_driver_register(drv)
    : 0;
    }
#[no_mangle]
unsafe extern "C" fn ps3_ehci_driver_unregister(drv: *mut ps3_system_bus_driver) {
