...
//! Source: drivers/usb/host/ohci-omap.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ohci_omap_priv {
    pub usb_host_ck: *mut clk,
    pub usb_dc_ck: *mut clk,
    pub power: *mut gpio_desc,
    pub overcurrent: *mut gpio_desc,
}
...
#[no_mangle]
unsafe extern "C" fn omap_ohci_clock_power(priv: *mut ohci_omap_priv, on: c_int) {
...
#[no_mangle]
unsafe extern "C" fn start_hnp(ohci: *mut ohci_hcd) {
    static void start_hnp(struct ohci_hcd *ohci)
    {
    struct usb_hcd *hcd = ohci_to_hcd(ohci);
    let mut port: unsigned = hcd.self.otg_port - 1;
    unsigned long	flags;
    u32 l;
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ohci_omap_reset(hcd: *mut usb_hcd) -> c_int {
    static int ohci_omap_reset(struct usb_hcd *hcd)
    {
    struct ohci_hcd		*ohci = hcd_to_ohci(hcd);
    struct omap_usb_config	*config = dev_get_platdata(hcd.self.controller);
    struct ohci_omap_priv	*priv = hcd_to_ohci_omap_priv(hcd);
    let mut need_transceiver: c_int = (config.otg != 0);
    int			ret;
...
//
#[no_mangle]
unsafe extern "C" fn ohci_hcd_omap_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ohci_hcd_omap_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ohci_omap_suspend(pdev: *mut platform_device, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ohci_omap_resume(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ohci_omap_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ohci_omap_cleanup() -> void __exit {
