...
//! Source: drivers/usb/host/ehci-dbg.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn dbg_hcs_params(ehci: *mut ehci_hcd, label: *mut c_char) {
    static void dbg_hcs_params(struct ehci_hcd *ehci, char *label)
    {
    let mut params: u32 = ehci_readl(ehci, &ehci.caps.hcs_params);
    ehci_dbg(ehci,
...
//
#[no_mangle]
unsafe extern "C" fn dbg_hcc_params(ehci: *mut ehci_hcd, label: *mut c_char) {
    static void dbg_hcc_params(struct ehci_hcd *ehci, char *label)
    {
    let mut params: u32 = ehci_readl(ehci, &ehci.caps.hcc_params);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct debug_buffer {
    pub /: *mut *mut *mut *mut ssize_t (fill_func)(struct debug_buffer ); / fill method,
    pub bus: *mut usb_bus,
    pub /: *mut *mut mutex mutex; / protect filling of buffer,
    pub /: *mut *mut size_t count; / number of characters filled into buffer,
    pub output_buf: *mut c_char,
    pub alloc_size: usize,
}

#[no_mangle]
pub unsafe extern "C" fn speed_char(info1: u32) -> c_char {
...
#[no_mangle]
pub unsafe extern "C" fn token_mark(ehci: *mut ehci_hcd, token: __hc32) -> c_char {
    static inline char token_mark(struct ehci_hcd *ehci, __hc32 token)
    {
    let mut v: __u32 = hc32_to_cpu(ehci, token);
    if (v & QTD_STS_ACTIVE)
    return '*';
    if (v & QTD_STS_HALT)
    return '-';
...
// tries to advance through hw_alt_next
    ...
    struct ehci_qtd		*td;
    unsigned		temp;
    let mut size: unsigned = *sizep;
    char			*next = *nextp;
    char			mark;
    let mut list_end: __le32 = EHCI_LIST_END(ehci);
    struct ehci_qh_hw	*hw = qh.hw;
    ...
    mark = '#';	/* blocked */
#[no_mangle]
pub unsafe extern "C" fn if(list_end: hw->hw_alt_next ==) -> else {
...
// hc may be modifying the list as we read it ...
    ...
    mark = '#';
#[no_mangle]
pub unsafe extern "C" fn if(list_end: td->hw_alt_next !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn fill_async_buffer(buf: *mut debug_buffer) -> isize {
...
#[no_mangle]
unsafe extern "C" fn fill_bandwidth_buffer(buf: *mut debug_buffer) -> isize {
...
// Dump all the FS/LS tables
    ...
    {
    let mut scratch: u32 = hc32_to_cpup(ehci, &hw.hw_info1);
    struct ehci_qtd		*qtd;
    char			*type = "";
    let mut temp: unsigned = 0;
...
pub const DBG_SCHED_LIMIT: c_int = 64;
#[no_mangle]
unsafe extern "C" fn fill_periodic_buffer(buf: *mut debug_buffer) -> isize {
...
#[no_mangle]
unsafe extern "C" fn fill_registers_buffer(buf: *mut debug_buffer) -> isize {
...
#[no_mangle]
unsafe extern "C" fn fill_buffer(buf: *mut debug_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debug_async_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debug_bandwidth_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debug_periodic_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debug_registers_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn create_debug_files(ehci: *mut ehci_hcd) {
...
#[no_mangle]
pub unsafe extern "C" fn remove_debug_files(ehci: *mut ehci_hcd) {
