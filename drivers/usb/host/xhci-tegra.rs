...
//! Source: drivers/usb/host/xhci-tegra.c
#![no_std]
...
pub const TEGRA_XHCI_SS_HIGH_SPEED: c_int = 120000000;
pub const TEGRA_XHCI_SS_LOW_SPEED: c_int = 12000000;
// FPCI CFG registers
pub const XUSB_CFG_1: c_uint = 0x004;

pub const XUSB_CFG_4: c_uint = 0x010;
pub const XUSB_BASE_ADDR_SHIFT: c_int = 15;
pub const XUSB_BASE_ADDR_MASK: c_uint = 0x1ffff;
pub const XUSB_CFG_7: c_uint = 0x01c;
pub const XUSB_BASE2_ADDR_SHIFT: c_int = 16;
pub const XUSB_BASE2_ADDR_MASK: c_uint = 0xffff;
pub const XUSB_CFG_16: c_uint = 0x040;
pub const XUSB_CFG_24: c_uint = 0x060;
pub const XUSB_CFG_AXI_CFG: c_uint = 0x0f8;
pub const XUSB_CFG_ARU_C11_CSBRANGE: c_uint = 0x41c;
pub const XUSB_CFG_ARU_CONTEXT: c_uint = 0x43c;
pub const XUSB_CFG_ARU_CONTEXT_HS_PLS: c_uint = 0x478;
pub const XUSB_CFG_ARU_CONTEXT_FS_PLS: c_uint = 0x47c;
pub const XUSB_CFG_ARU_CONTEXT_HSFS_SPEED: c_uint = 0x480;
pub const XUSB_CFG_ARU_CONTEXT_HSFS_PP: c_uint = 0x484;
pub const XUSB_CFG_CSB_BASE_ADDR: c_uint = 0x800;
// FPCI mailbox registers
// XUSB_CFG_ARU_MBOX_CMD

// XUSB_CFG_ARU_MBOX_DATA_IN and XUSB_CFG_ARU_MBOX_DATA_OUT
pub const CMD_DATA_SHIFT: c_int = 0;
pub const CMD_DATA_MASK: c_uint = 0xffffff;
pub const CMD_TYPE_SHIFT: c_int = 24;
pub const CMD_TYPE_MASK: c_uint = 0xff;
// XUSB_CFG_ARU_MBOX_OWNER
pub const MBOX_OWNER_NONE: c_int = 0;
pub const MBOX_OWNER_FW: c_int = 1;
pub const MBOX_OWNER_SW: c_int = 2;
pub const XUSB_CFG_ARU_SMI_INTR: c_uint = 0x428;

// BAR2 registers
pub const XUSB_BAR2_ARU_MBOX_CMD: c_uint = 0x004;
pub const XUSB_BAR2_ARU_MBOX_DATA_IN: c_uint = 0x008;
pub const XUSB_BAR2_ARU_MBOX_DATA_OUT: c_uint = 0x00c;
pub const XUSB_BAR2_ARU_MBOX_OWNER: c_uint = 0x010;
pub const XUSB_BAR2_ARU_SMI_INTR: c_uint = 0x014;
pub const XUSB_BAR2_ARU_SMI_ARU_FW_SCRATCH_DATA0: c_uint = 0x01c;
pub const XUSB_BAR2_ARU_IFRDMA_CFG0: c_uint = 0x0e0;
pub const XUSB_BAR2_ARU_IFRDMA_CFG1: c_uint = 0x0e4;
pub const XUSB_BAR2_ARU_IFRDMA_STREAMID_FIELD: c_uint = 0x0e8;
pub const XUSB_BAR2_ARU_C11_CSBRANGE: c_uint = 0x9c;
pub const XUSB_BAR2_ARU_FW_SCRATCH: c_uint = 0x1000;
pub const XUSB_BAR2_CSB_BASE_ADDR: c_uint = 0x2000;
// IPFS registers
pub const IPFS_XUSB_HOST_MSI_BAR_SZ_0: c_uint = 0x0c0;
pub const IPFS_XUSB_HOST_MSI_AXI_BAR_ST_0: c_uint = 0x0c4;
pub const IPFS_XUSB_HOST_MSI_FPCI_BAR_ST_0: c_uint = 0x0c8;
pub const IPFS_XUSB_HOST_MSI_VEC0_0: c_uint = 0x100;
pub const IPFS_XUSB_HOST_MSI_EN_VEC0_0: c_uint = 0x140;
pub const IPFS_XUSB_HOST_CONFIGURATION_0: c_uint = 0x180;

pub const IPFS_XUSB_HOST_FPCI_ERROR_MASKS_0: c_uint = 0x184;
pub const IPFS_XUSB_HOST_INTR_MASK_0: c_uint = 0x188;

pub const IPFS_XUSB_HOST_INTR_ENABLE_0: c_uint = 0x198;
pub const IPFS_XUSB_HOST_UFPCI_CONFIG_0: c_uint = 0x19c;
pub const IPFS_XUSB_HOST_CLKGATE_HYSTERESIS_0: c_uint = 0x1bc;
pub const IPFS_XUSB_HOST_MCCIF_FIFOCTRL_0: c_uint = 0x1dc;
pub const CSB_PAGE_SELECT_MASK: c_uint = 0x7fffff;
pub const CSB_PAGE_SELECT_SHIFT: c_int = 9;
pub const CSB_PAGE_OFFSET_MASK: c_uint = 0x1ff;

    CSB_PAGE_SELECT_MASK)

// Falcon CSB registers
pub const XUSB_FALC_CPUCTL: c_uint = 0x100;

pub const XUSB_FALC_BOOTVEC: c_uint = 0x104;
pub const XUSB_FALC_DMACTL: c_uint = 0x10c;
pub const XUSB_FALC_IMFILLRNG1: c_uint = 0x154;
pub const IMFILLRNG1_TAG_MASK: c_uint = 0xffff;
pub const IMFILLRNG1_TAG_LO_SHIFT: c_int = 0;
pub const IMFILLRNG1_TAG_HI_SHIFT: c_int = 16;
pub const XUSB_FALC_IMFILLCTL: c_uint = 0x158;
// CSB ARU registers
pub const XUSB_CSB_ARU_SCRATCH0: c_uint = 0x100100;
// MP CSB registers
pub const XUSB_CSB_MP_ILOAD_ATTR: c_uint = 0x101a00;
pub const XUSB_CSB_MP_ILOAD_BASE_LO: c_uint = 0x101a04;
pub const XUSB_CSB_MP_ILOAD_BASE_HI: c_uint = 0x101a08;
pub const XUSB_CSB_MP_L2IMEMOP_SIZE: c_uint = 0x101a10;
pub const L2IMEMOP_SIZE_SRC_OFFSET_SHIFT: c_int = 8;
pub const L2IMEMOP_SIZE_SRC_OFFSET_MASK: c_uint = 0x3ff;
pub const L2IMEMOP_SIZE_SRC_COUNT_SHIFT: c_int = 24;
pub const L2IMEMOP_SIZE_SRC_COUNT_MASK: c_uint = 0xff;
pub const XUSB_CSB_MP_L2IMEMOP_TRIG: c_uint = 0x101a14;
pub const L2IMEMOP_ACTION_SHIFT: c_int = 24;

pub const XUSB_CSB_MEMPOOL_L2IMEMOP_RESULT: c_uint = 0x101a18;

pub const XUSB_CSB_MP_APMAP: c_uint = 0x10181c;

pub const IMEM_BLOCK_SIZE: c_int = 256;
pub const FW_IOCTL_TYPE_SHIFT: c_int = 24;
pub const FW_IOCTL_CFGTBL_READ: c_int = 17;
pub const WAKE_IRQ_START_INDEX: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xusb_fw_header {
    pub boot_loadaddr_in_imem: __le32,
    pub boot_codedfi_offset: __le32,
    pub boot_codetag: __le32,
    pub boot_codesize: __le32,
    pub phys_memaddr: __le32,
    pub reqphys_memsize: __le16,
    pub alloc_phys_memsize: __le16,
    pub rodata_img_offset: __le32,
    pub rodata_section_start: __le32,
    pub rodata_section_end: __le32,
    pub main_fnaddr: __le32,
    pub fwimg_cksum: __le32,
    pub fwimg_created_time: __le32,
    pub imem_resident_start: __le32,
    pub imem_resident_end: __le32,
    pub idirect_start: __le32,
    pub idirect_end: __le32,
    pub l2_imem_start: __le32,
    pub l2_imem_end: __le32,
    pub version_id: __le32,
    pub init_ddirect: u8,
    pub reserved: [u8; 3],
    pub phys_addr_log_buffer: __le32,
    pub total_log_entries: __le32,
    pub dequeue_ptr: __le32,
    pub dummy_var: [__le32; 2],
    pub fwimg_len: __le32,
    pub magic: [u8; 8],
    pub ss_low_power_entry_timeout: __le32,
    pub num_hsic_port: u8,
    pub /: *mut *mut u8 padding[139]; / Pad to 256 bytes,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xusb_phy_type {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xusb_mbox_regs {
    pub cmd: u16,
    pub data_in: u16,
    pub data_out: u16,
    pub owner: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xusb_context_soc {
    struct {
    pub offsets: *const c_uint,
    pub num_offsets: c_uint,
    pub ipfs: },
    struct {
    pub offsets: *const c_uint,
    pub num_offsets: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xusb_soc_ops {
    pub offset): *mut *mut *mut u32 (mbox_reg_readl)(struct tegra_xusb tegra, unsigned int,
    pub offset): *mut *mut *mut void (mbox_reg_writel)(struct tegra_xusb tegra, u32 value, unsigned int,
    pub offset): *mut *mut *mut u32 (csb_reg_readl)(struct tegra_xusb tegra, unsigned int,
    pub offset): *mut *mut *mut void (csb_reg_writel)(struct tegra_xusb tegra, u32 value, unsigned int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xusb_soc {
    pub firmware: *const c_char,
    pub supply_names: *const *const c_char,
    pub num_supplies: c_uint,
    pub phy_types: *const tegra_xusb_phy_type,
    pub num_types: c_uint,
    pub max_num_wakes: c_uint,
    pub context: *const tegra_xusb_context_soc,
    struct {
    struct {
    pub offset: c_uint,
    pub count: c_uint,
    ...
    pub ports: },
    pub mbox: tegra_xusb_mbox_regs,
    pub ops: *const tegra_xusb_soc_ops,
    pub scale_ss_clock: bool,
    pub has_ipfs: bool,
    pub lpm_support: bool,
    pub otg_reset_sspi: bool,
    pub otg_set_port_power: bool,
    pub has_bar2: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xusb_context {
    pub ipfs: *mut u32,
    pub fpci: *mut u32,
}
...
pub struct tegra_xusb {
    ...
    pub xhci_irq: c_int,
    pub mbox_irq: c_int,
    pub padctl_irq: c_int,
    pub wake_irqs: *mut c_int,
    pub ipfs_base: *mut void __iomem,
    pub fpci_base: *mut void __iomem,
    pub bar2_base: *mut void __iomem,
    pub bar2: *mut resource,
    pub soc: *const tegra_xusb_soc,
    pub supplies: *mut regulator_bulk_data,
    pub padctl: *mut tegra_xusb_padctl,
    pub host_clk: *mut clk,
    pub falcon_clk: *mut clk,
    pub ss_clk: *mut clk,
    pub ss_src_clk: *mut clk,
    pub hs_src_clk: *mut clk,
    pub fs_src_clk: *mut clk,
    pub pll_u_480m: *mut clk,
    pub clk_m: *mut clk,
    pub pll_e: *mut clk,
    pub host_rst: *mut reset_control,
    pub ss_rst: *mut reset_control,
    pub pmc: *mut tegra_pmc,
    pub genpd_dev_host: *mut device,
    pub genpd_dev_ss: *mut device,
    pub use_genpd: bool,
    pub phys: *mut phy,
    pub num_phys: c_uint,
    pub usbphy: *mut usb_phy,
    pub num_usb_phys: c_uint,
    pub otg_usb2_port: c_int,
    pub otg_usb3_port: c_int,
    pub host_mode: bool,
    pub id_nb: notifier_block,
    pub id_work: work_struct,
// Firmware loading related
    ...
    pub fw: },
    pub suspended: bool,
    pub context: tegra_xusb_context,
    pub lp0_utmi_pad_mask: u8,
    pub num_wakes: c_int,
}

    static struct hc_driver __read_mostly tegra_xhci_hc_driver;
#[no_mangle]
pub unsafe extern "C" fn fpci_readl(tegra: *mut tegra_xusb, offset: c_uint) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ipfs_readl(tegra: *mut tegra_xusb, offset: c_uint) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn bar2_readl(tegra: *mut tegra_xusb, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn csb_readl(tegra: *mut tegra_xusb, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fpci_csb_readl(tegra: *mut tegra_xusb, offset: c_uint) -> u32 {
    static u32 fpci_csb_readl(struct tegra_xusb *tegra, unsigned int offset)
    {
    let mut page: u32 = CSB_PAGE_SELECT(offset);
    let mut ofs: u32 = CSB_PAGE_OFFSET(offset);
...
#[no_mangle]
unsafe extern "C" fn bar2_csb_readl(tegra: *mut tegra_xusb, offset: c_uint) -> u32 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_xusb_mbox_msg {
    pub cmd: u32,
    pub data: u32,
}

#[no_mangle]
pub unsafe extern "C" fn tegra_xusb_mbox_pack(msg: *const tegra_xusb_mbox_msg) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_mbox_cmd_requires_ack(cmd: enum tegra_xusb_mbox_cmd) -> bool {
    ...
    {
    const struct tegra_xusb_soc_ops *ops = tegra.soc.ops;
    let mut wait_for_idle: bool = false;
    u32 value;
//
...
//
    ...
    if (wait_for_idle) {
    let mut timeout: c_ulong = jiffies + msecs_to_jiffies(250);
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_mbox_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_mbox_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_config(tegra: *mut tegra_xusb) {
    static void tegra_xusb_config(struct tegra_xusb *tegra)
    {
    let mut regs: u32 = tegra.hcd.rsrc_start;
    u32 value;
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_clk_enable(tegra: *mut tegra_xusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_clk_disable(tegra: *mut tegra_xusb) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_phy_enable(tegra: *mut tegra_xusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_phy_disable(tegra: *mut tegra_xusb) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_init_context(tegra: *mut tegra_xusb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_xusb_init_context(tegra: *mut tegra_xusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_request_firmware(tegra: *mut tegra_xusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_wait_for_falcon(tegra: *mut tegra_xusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_load_firmware_rom(tegra: *mut tegra_xusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_read_firmware_header(tegra: *mut tegra_xusb, offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_init_ifr_firmware(tegra: *mut tegra_xusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_load_firmware(tegra: *mut tegra_xusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_unpowergate_partitions(tegra: *mut tegra_xusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_powergate_partitions(tegra: *mut tegra_xusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __tegra_xusb_enable_firmware_messages(tegra: *mut tegra_xusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_padctl_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_enable_firmware_messages(tegra: *mut tegra_xusb) -> c_int {
    ...
    let mut wait: c_uint = (!main && !set) ? 1000 : 10;
    let mut typeReq: u16 = set ? SetPortFeature : ClearPortFeature;
    let mut wIndex: u16 = main ? tegra.otg_usb2_port + 1 : tegra.otg_usb3_port + 1;
    u32 status;
    let mut stat_power: u32 = main ? USB_PORT_STAT_POWER : USB_SS_PORT_STAT_POWER;
    let mut status_val: u32 = set ? stat_power : 0;
...
#[no_mangle]
unsafe extern "C" fn tegra_xhci_id_work(work: *mut work_struct) {
    ...
    tegra.otg_usb2_port);
    let mut host_mode: bool = tegra.host_mode;
    u32 status;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn is_usb2_otg_phy(tegra: *mut tegra_xusb, index: c_uint) -> bool {
    static bool is_usb2_otg_phy(struct tegra_xusb *tegra, unsigned int index)
    {
    return (tegra.usbphy[index] != core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn is_usb3_otg_phy(tegra: *mut tegra_xusb, index: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_host_mode_phy(tegra: *mut tegra_xusb, phy_type: c_uint, index: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_init_usb_phy(tegra: *mut tegra_xusb) -> c_int {
...
//
    tegra.usbphy[i] = core::ptr::null_mut();
    }
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tegra_xusb_deinit_usb_phy(tegra: *mut tegra_xusb) {
    ...
    for (i = 0; i < tegra.num_usb_phys; i++)
    if (tegra.usbphy[i])
    otg_set_host(tegra.usbphy[i].otg, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tegra_xusb_setup_wakeup(pdev: *mut platform_device, tegra: *mut tegra_xusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    core::ptr::null_mut(), tegra_xusb_padctl_irq,
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_disable(tegra: *mut tegra_xusb) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn xhci_hub_ports_suspended(hub: *mut xhci_hub) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_check_ports(tegra: *mut tegra_xusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_save_context(tegra: *mut tegra_xusb) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_restore_context(tegra: *mut tegra_xusb) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xhci_portsc_to_speed(tegra: *mut tegra_xusb, portsc: u32) -> enum usb_device_speed {
...
#[no_mangle]
unsafe extern "C" fn tegra_xhci_enable_phy_sleepwalk_wake(tegra: *mut tegra_xusb) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xhci_disable_phy_wake(tegra: *mut tegra_xusb) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xhci_disable_phy_sleepwalk(tegra: *mut tegra_xusb) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xhci_program_utmi_power_lp0_exit(tegra: *mut tegra_xusb) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_enter_elpg(tegra: *mut tegra_xusb, is_auto_resume: bool) -> c_int {
    static int tegra_xusb_enter_elpg(struct tegra_xusb *tegra, bool is_auto_resume)
    {
    struct xhci_hcd *xhci = hcd_to_xhci(tegra.hcd);
    struct device *dev = tegra.dev;
    let mut wakeup: bool = is_auto_resume ? true : device_may_wakeup(dev);
    unsigned int i;
    int err;
    u32 usbcmd;
    u32 portsc;
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_exit_elpg(tegra: *mut tegra_xusb, is_auto_resume: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_suspend(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_resume(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_runtime_suspend(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_runtime_resume(dev: *mut device) -> __maybe_unused int {
    ...
    tegra_xusb_runtime_resume, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn tegra_xhci_quirks(dev: *mut device, xhci: *mut xhci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn tegra_xhci_setup(hcd: *mut usb_hcd) -> c_int {
    ...
    let mut port: c_int = (index & 0xff) - 1;
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tegra_xusb_exit() -> void __exit {
