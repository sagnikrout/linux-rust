...
//! Source: drivers/usb/host/ohci-st.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st_ohci_platform_priv {
...
#[no_mangle]
unsafe extern "C" fn st_ohci_platform_power_on(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_ohci_platform_power_off(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn st_ohci_platform_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_ohci_platform_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn st_ohci_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_ohci_resume(dev: *mut device) -> c_int {
