...
//! Source: drivers/usb/host/xhci-ring.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn trb_is_noop(trb: *mut union xhci_trb) -> bool {
    static bool trb_is_noop(union xhci_trb *trb)
    {
    return TRB_TYPE_NOOP_LE32(trb.generic.field[3]);
    }
#[no_mangle]
unsafe extern "C" fn trb_is_link(trb: *mut union xhci_trb) -> bool {
    static bool trb_is_link(union xhci_trb *trb)
    {
    return TRB_TYPE_LINK_LE32(trb.link.control);
    }
#[no_mangle]
unsafe extern "C" fn last_trb_on_seg(seg: *mut xhci_segment, trb: *mut union xhci_trb) -> bool {
    static bool last_trb_on_seg(struct xhci_segment *seg, union xhci_trb *trb)
    {
    let mut trb: return = = &seg.trbs[TRBS_PER_SEGMENT - 1];
    }
...
#[no_mangle]
unsafe extern "C" fn link_trb_toggles_cycle(trb: *mut union xhci_trb) -> bool {
    static bool link_trb_toggles_cycle(union xhci_trb *trb)
    {
    return le32_to_cpu(trb.link.control) & LINK_TOGGLE;
    }
#[no_mangle]
unsafe extern "C" fn last_td_in_urb(td: *mut xhci_td) -> bool {
...
#[no_mangle]
unsafe extern "C" fn unhandled_event_trb(ring: *mut xhci_ring) -> bool {
...
#[no_mangle]
unsafe extern "C" fn inc_td_cnt(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn trb_to_noop(trb: *mut union xhci_trb, noop_type: u32, unchain_links: bool) {
...
#[no_mangle]
unsafe extern "C" fn trb_to_pos(seg: *mut xhci_segment, trb: *mut union xhci_trb) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn inc_deq(xhci: *mut xhci_hcd, ring: *mut xhci_ring) {
    void inc_deq(struct xhci_hcd *xhci, struct xhci_ring *ring)
    {
    let mut link_trb_count: c_uint = 0;
...
//
#[no_mangle]
unsafe extern "C" fn inc_enq_past_link(xhci: *mut xhci_hcd, ring: *mut xhci_ring, chain: u32) {
...
#[no_mangle]
unsafe extern "C" fn trb_in_td(td: *mut xhci_td, suspect_dma: dma_addr_t) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn xhci_num_trbs_free(ring: *mut xhci_ring) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn xhci_ring_cmd_db(xhci: *mut xhci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn xhci_mod_cmd_timer(xhci: *mut xhci_hcd) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xhci_abort_cmd_ring(xhci: *mut xhci_hcd, flags: c_ulong) -> c_int {
...
//
    ...
    let mut ep_state: c_uint = ep.ep_state;
...
//
    ...
    ep.queued_deq_seg = core::ptr::null_mut();
    ep.queued_deq_ptr = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn xhci_giveback_invalidated_tds(xhci: *mut xhci_hcd, ep: *mut xhci_virt_ep) {
    ...
    let mut slot_id: c_uint = ep.vdev.slot_id;
    int err;
//
...
//
#[no_mangle]
unsafe extern "C" fn xhci_invalidate_cancelled_tds(xhci: *mut xhci_hcd, ep: *mut xhci_virt_ep) -> c_int {
    static int xhci_invalidate_cancelled_tds(struct xhci_hcd *xhci, struct xhci_virt_ep *ep)
    {
    struct xhci_td		*td = core::ptr::null_mut();
    struct xhci_td		*tmp_td = core::ptr::null_mut();
    struct xhci_td		*cached_td = core::ptr::null_mut();
    struct xhci_ring	*ring;
    u64			hw_deq;
    int			err;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn xhci_process_cancelled_tds(xhci: *mut xhci_hcd, ep: *mut xhci_virt_ep) {
...
#[no_mangle]
unsafe extern "C" fn xhci_kill_ring_urbs(xhci: *mut xhci_hcd, ring: *mut xhci_ring) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xhci_hc_died(xhci: *mut xhci_hcd) {
...
// Delete default control endpoint resources
    ...
    xhci.devs[slot_id] = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn xhci_handle_cmd_config_ep(xhci: *mut xhci_hcd, slot_id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn xhci_handle_cmd_addr_dev(xhci: *mut xhci_hcd, slot_id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn xhci_handle_cmd_reset_dev(xhci: *mut xhci_hcd, slot_id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn xhci_complete_del_and_free_cmd(cmd: *mut xhci_command, comp_code: u32, comp_param: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn xhci_cleanup_command_queue(xhci: *mut xhci_hcd) {
    void xhci_cleanup_command_queue(struct xhci_hcd *xhci)
    {
    struct xhci_command *cur_cmd, *tmp_cmd;
    xhci.current_cmd = core::ptr::null_mut();
    list_for_each_entry_safe(cur_cmd, tmp_cmd, &xhci.cmd_list, cmd_list)
    xhci_complete_del_and_free_cmd(cur_cmd, COMP_COMMAND_ABORTED, 0);
    }
#[no_mangle]
pub unsafe extern "C" fn xhci_handle_command_timeout(work: *mut work_struct) {
...
// command timeout on stopped ring, ring can't be aborted
    ...
    struct xhci_event_cmd *event)
    {
    let mut slot_id: c_uint = TRB_TO_SLOT_ID(le32_to_cpu(event.flags));
    let mut status: u32 = le32_to_cpu(event.status);
    u64 cmd_dma;
...
//
#[no_mangle]
unsafe extern "C" fn xhci_cavium_reset_phy_quirk(xhci: *mut xhci_hcd) {
    static void xhci_cavium_reset_phy_quirk(struct xhci_hcd *xhci)
    {
    struct usb_hcd *hcd = xhci_to_hcd(xhci);
    u32 pll_lock_check;
    let mut retry_count: u32 = 4;
    do {
// Assert PHY reset
...
#[no_mangle]
unsafe extern "C" fn handle_port_status(xhci: *mut xhci_hcd, event: *mut union xhci_trb) {
    static void handle_port_status(struct xhci_hcd *xhci, union xhci_trb *event)
    {
    struct xhci_virt_device *vdev = core::ptr::null_mut();
    struct xhci_bus_state *bus_state;
    struct xhci_port *port;
    struct usb_hcd *hcd;
    let mut bogus_port_status: bool = false;
...
// We might get interrupts after shared_hcd is removed
    if (port.rhub == &xhci.usb3_rhub && xhci_get_usb3_hcd(xhci) == core::ptr::null_mut()) {
...
//
    ...
    {
    let mut ep_type: c_int = CTX_TO_EP_TYPE(le32_to_cpu(ep_ctx.ep_info2));
    switch (comp_code) {
...
#[no_mangle]
pub unsafe extern "C" fn xhci_is_vendor_info_code(xhci: *mut xhci_hcd, trb_comp_code: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sum_trb_lengths(td: *mut xhci_td, stop_trb: *mut union xhci_trb) -> u32 {
...
// Did we transfer part of the data (middle) phase?
    ...
    td.urb.actual_length = requested - remaining;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !td->urb_length_set) -> else {
...
//
    ...
    u32 trb_comp_code;
    let mut sum_trbs_for_length: bool = false;
...
// Transfer events which don't point to a transfer TRB, see xhci 4.17.4
    ...
    xhci_handle_halted_endpoint(xhci, ep, core::ptr::null_mut(), EP_HARD_RESET);
    else
    xhci_handle_halted_endpoint(xhci, ep, core::ptr::null_mut(), EP_SOFT_RESET);
    break;
...
//
    ...
    let mut status: c_int = -EINPROGRESS;
    struct xhci_ep_ctx *ep_ctx;
    u32 trb_comp_code;
    let mut ring_xrun_event: bool = false;
...
// find the transfer trb this events points to
    ep_trb = xhci_dma_to_trb(ep_ring.deq_seg, ep_trb_dma, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: usb_endpoint_xfer_isoc(&td->urb->ep->desc)) -> else {
...
#[no_mangle]
unsafe extern "C" fn xhci_clear_interrupt_pending(ir: *mut xhci_interrupter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xhci_irq(hcd: *mut usb_hcd) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn xhci_msi_irq(irq: c_int, hcd: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn count_trbs(addr: u64, len: u64) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn count_trbs_needed(urb: *mut urb) -> c_uint {
    static inline unsigned int count_trbs_needed(struct urb *urb)
    {
    return count_trbs(urb.transfer_dma, urb.transfer_buffer_length);
    }
#[no_mangle]
unsafe extern "C" fn count_sg_trbs_needed(urb: *mut urb) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn count_isoc_trbs_needed(urb: *mut urb, i: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn check_trb_math(urb: *mut urb, running_total: c_int) {
...
#[no_mangle]
unsafe extern "C" fn check_interval(urb: *mut urb, ep_ctx: *mut xhci_ep_ctx) {
...
// This is very similar to what ehci-q.c qtd_fill() does
    ...
    let mut more_trbs_coming: bool = true;
    let mut need_zero_pkt: bool = false;
    let mut first_trb: bool = true;
    unsigned int num_trbs;
...
#[no_mangle]
unsafe extern "C" fn xhci_ist_microframes(xhci: *mut xhci_hcd) -> c_int {
    static int xhci_ist_microframes(struct xhci_hcd *xhci)
    {
    let mut ist: c_int = FIELD_GET(HCS_IST_VALUE, xhci.hcs_params2);
...
//
#[no_mangle]
unsafe extern "C" fn xhci_frame_in_range(frame: u32, start: u32, end: u32) -> bool {
...
// This is for isoc transfer
    ...
    let mut uinterval: c_int = urb.interval;
    int start_uframe;
...
//
    ...
    u32 field3, u32 field4, bool command_must_succeed)
    {
    let mut reserved_trbs: c_int = xhci.cmd_ring_reserved_trbs;
    struct usb_hcd *hcd = xhci_to_hcd(xhci);
    int ret;
    if ((xhci.xhc_state & XHCI_STATE_DYING) ||
    (xhci.xhc_state & XHCI_STATE_HALTED)) {
...
//
    ...
    {
    let mut trb_slot_id: u32 = SLOT_ID_FOR_TRB(slot_id);
    let mut trb_ep_index: u32 = EP_INDEX_FOR_TRB(ep_index);
    let mut type: u32 = TRB_TYPE(TRB_STOP_RING);
    let mut trb_suspend: u32 = SUSPEND_PORT_FOR_TRB(suspend);
    return queue_command(xhci, cmd, 0, 0, 0,
    ...
    let mut trb_slot_id: u32 = SLOT_ID_FOR_TRB(slot_id);
    let mut trb_ep_index: u32 = EP_INDEX_FOR_TRB(ep_index);
    let mut type: u32 = TRB_TYPE(TRB_RESET_EP);
