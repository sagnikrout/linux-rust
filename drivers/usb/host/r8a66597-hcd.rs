...
//! Source: drivers/usb/host/r8a66597-hcd.c
#![no_std]
...
// this function must be called with interrupt disabled
    ...
    {
    u16 val;
    let mut devadd_reg: c_ulong = get_devadd_addr(r8a66597_address);
    val = (upphub << 11) | (hubport << 8) | (usbspd << 6) | (port & 0x0001);
    r8a66597_write(r8a66597, val, devadd_reg);
    }
#[no_mangle]
unsafe extern "C" fn r8a66597_clock_enable(r8a66597: *mut r8a66597) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_clock_disable(r8a66597: *mut r8a66597) {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_enable_port(r8a66597: *mut r8a66597, port: c_int) {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_disable_port(r8a66597: *mut r8a66597, port: c_int) {
...
#[no_mangle]
unsafe extern "C" fn enable_controller(r8a66597: *mut r8a66597) -> c_int {
    static int enable_controller(struct r8a66597 *r8a66597)
    {
    int ret, port;
    let mut vif: u16 = r8a66597.pdata.vif ? LDRV : 0;
    let mut irq_sense: u16 = r8a66597.irq_sense_low ? INTL : 0;
    let mut endian: u16 = r8a66597.pdata.endian ? BIGEND : 0;
...
#[no_mangle]
unsafe extern "C" fn disable_controller(r8a66597: *mut r8a66597) {
...
#[no_mangle]
unsafe extern "C" fn is_child_device(devpath: *mut c_char) -> c_int {
    static int is_child_device(char *devpath)
    {
    return (devpath[2] ? 1 : 0);
    }
#[no_mangle]
unsafe extern "C" fn is_hub_limit(devpath: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_r8a66597_usb_speed(speed: enum usb_device_speed) -> u16 {
    static u16 get_r8a66597_usb_speed(enum usb_device_speed speed)
    {
    let mut usbspd: u16 = 0;
    switch (speed) {
    case USB_SPEED_LOW:
    usbspd = LSMODE;
    break;
...
#[no_mangle]
unsafe extern "C" fn set_child_connect_map(r8a66597: *mut r8a66597, address: c_int) {
...
#[no_mangle]
unsafe extern "C" fn put_child_connect_map(r8a66597: *mut r8a66597, address: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_pipe_reg_addr(pipe: *mut r8a66597_pipe, dma_ch: u8) {
    static void set_pipe_reg_addr(struct r8a66597_pipe *pipe, u8 dma_ch)
    {
    let mut pipenum: u16 = pipe.info.pipenum;
...
// this function must be called with interrupt disabled
#[no_mangle]
unsafe extern "C" fn alloc_usb_address(r8a66597: *mut r8a66597, urb: *mut urb) -> u8 {
...
//
    if (reset)
    dev_set_drvdata(&dev.udev.dev, core::ptr::null_mut());
    list_del(&dev.device_list);
    kfree(dev);
    for (port = 0; port < r8a66597.max_root_hub; port++) {
    if (r8a66597.root_hub[port].dev == dev) {
    r8a66597.root_hub[port].dev = core::ptr::null_mut();
    break;
    }
    }
    }
...
// this function must be called with interrupt disabled
#[no_mangle]
unsafe extern "C" fn pipe_start(r8a66597: *mut r8a66597, pipe: *mut r8a66597_pipe) {
...
// this function must be called with interrupt disabled
#[no_mangle]
unsafe extern "C" fn pipe_stop(r8a66597: *mut r8a66597, pipe: *mut r8a66597_pipe) {
...
#[no_mangle]
pub unsafe extern "C" fn mbw_value(r8a66597: *mut r8a66597) -> c_ushort {
...
// this function must be called with interrupt disabled
#[no_mangle]
pub unsafe extern "C" fn cfifo_change(r8a66597: *mut r8a66597, pipenum: u16) {
    static inline void cfifo_change(struct r8a66597 *r8a66597, u16 pipenum)
    {
    let mut mbw: c_ushort = mbw_value(r8a66597);
...
#[no_mangle]
unsafe extern "C" fn r8a66597_get_pipenum(urb: *mut urb, hep: *mut usb_host_endpoint) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn get_urb_to_r8a66597_addr(r8a66597: *mut r8a66597, urb: *mut urb) -> u16 {
...
// this function must be called with interrupt disabled
    ...
    {
    struct r8a66597_device *dev = get_urb_to_r8a66597_dev(r8a66597, urb);
    let mut endpoint: c_uchar = usb_pipeendpoint(urb.pipe);
...
// this function must be called with interrupt disabled
#[no_mangle]
unsafe extern "C" fn pipe_setting(r8a66597: *mut r8a66597, td: *mut r8a66597_td) {
...
#[no_mangle]
unsafe extern "C" fn get_r8a66597_type(type: __u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn get_bufnum(pipenum: u16) -> u16 {
    static u16 get_bufnum(u16 pipenum)
    {
    let mut bufnum: u16 = 0;
    if (pipenum == 0)
    bufnum = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: check_bulk_or_isoc(pipenum)) -> else {
    else if (check_bulk_or_isoc(pipenum))
    bufnum = 8 + (pipenum - 1) * R8A66597_BUF_BSIZE*2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: check_interrupt(pipenum)) -> else {
...
#[no_mangle]
unsafe extern "C" fn get_buf_bsize(pipenum: u16) -> u16 {
    static u16 get_buf_bsize(u16 pipenum)
    {
    let mut buf_bsize: u16 = 0;
    if (pipenum == 0)
    buf_bsize = 3;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: check_bulk_or_isoc(pipenum)) -> else {
...
// this function must be called with interrupt disabled
#[no_mangle]
unsafe extern "C" fn force_dequeue(r8a66597: *mut r8a66597, pipenum: u16, address: u16) {
...
#[no_mangle]
unsafe extern "C" fn get_interval(urb: *mut urb, interval: __u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn get_timer_interval(urb: *mut urb, interval: __u8) -> c_ulong {
    static unsigned long get_timer_interval(struct urb *urb, __u8 interval)
    {
    __u8 i;
    let mut time: c_ulong = 1;
...
#[no_mangle]
unsafe extern "C" fn init_pipe_config(r8a66597: *mut r8a66597, urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn pipe_irq_disable(r8a66597: *mut r8a66597, pipenum: u16) {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_root_hub_start_polling(r8a66597: *mut r8a66597) {
...
// this function must be called with interrupt disabled
    ...
    r8a66597_bset(r8a66597, HSE, get_syscfg_reg(port));
#[no_mangle]
pub unsafe extern "C" fn if(LS_JSTS: syssts ==) -> else {
...
// this function must be called with interrupt disabled
#[no_mangle]
unsafe extern "C" fn r8a66597_usb_connect(r8a66597: *mut r8a66597, port: c_int) {
    static void r8a66597_usb_connect(struct r8a66597 *r8a66597, int port)
    {
    let mut speed: u16 = get_rh_usb_speed(r8a66597, port);
    struct r8a66597_root_hub *rh = &r8a66597.root_hub[port];
    rh.port &= ~(USB_PORT_STAT_HIGH_SPEED | USB_PORT_STAT_LOW_SPEED);
    if (speed == HSMODE)
    rh.port |= USB_PORT_STAT_HIGH_SPEED;
#[no_mangle]
pub unsafe extern "C" fn if(LSMODE: speed ==) -> else {
...
// this function must be called with interrupt disabled
#[no_mangle]
unsafe extern "C" fn r8a66597_usb_disconnect(r8a66597: *mut r8a66597, port: c_int) {
...
// this function must be called with interrupt disabled
    ...
    let mut setup_addr: c_ulong = USBREQ;
...
#[no_mangle]
unsafe extern "C" fn is_set_address(setup_packet: *mut c_uchar) -> c_int {
...
// this function must be called with interrupt disabled
#[no_mangle]
unsafe extern "C" fn start_transfer(r8a66597: *mut r8a66597, td: *mut r8a66597_td) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_transfer_finish(td: *mut r8a66597_td, urb: *mut urb) -> c_int {
...
// this function must be called with interrupt disabled
#[no_mangle]
unsafe extern "C" fn set_td_timer(r8a66597: *mut r8a66597, td: *mut r8a66597_td) {
...
#[no_mangle]
unsafe extern "C" fn packet_read(r8a66597: *mut r8a66597, pipenum: u16) {
...
#[no_mangle]
unsafe extern "C" fn packet_write(r8a66597: *mut r8a66597, pipenum: u16) {
    static void packet_write(struct r8a66597 *r8a66597, u16 pipenum)
    {
    u16 tmp;
    int bufsize, size;
...
#[no_mangle]
unsafe extern "C" fn check_next_phase(r8a66597: *mut r8a66597, status: c_int) {
    ...
    td.type = USB_PID_ACK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: usb_pipeout(urb->pipe)) -> else {
...
#[no_mangle]
unsafe extern "C" fn get_urb_error(r8a66597: *mut r8a66597, pipenum: u16) -> c_int {
    static int get_urb_error(struct r8a66597 *r8a66597, u16 pipenum)
    {
    struct r8a66597_td *td = r8a66597_get_td(r8a66597, pipenum);
    if (td) {
    let mut pid: u16 = r8a66597_read(r8a66597, td.pipe.pipectr) & PID;
    if (pid == PID_NAK)
    return -ECONNRESET;
    else
    return -EPIPE;
...
#[no_mangle]
unsafe extern "C" fn irq_pipe_ready(r8a66597: *mut r8a66597) {
...
#[no_mangle]
pub unsafe extern "C" fn if(USB_PID_OUT: td->type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn irq_pipe_empty(r8a66597: *mut r8a66597) {
...
#[no_mangle]
unsafe extern "C" fn irq_pipe_nrdy(r8a66597: *mut r8a66597) {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_irq(hcd: *mut usb_hcd) -> irqreturn_t {
...
// this function must be called with interrupt disabled
#[no_mangle]
unsafe extern "C" fn r8a66597_root_hub_control(r8a66597: *mut r8a66597, port: c_int) {
    static void r8a66597_root_hub_control(struct r8a66597 *r8a66597, int port)
    {
    u16 tmp;
    struct r8a66597_root_hub *rh = &r8a66597.root_hub[port];
    if (rh.port & USB_PORT_STAT_RESET) {
    let mut dvstctr_reg: c_ulong = get_dvstctr_reg(port);
...
#[no_mangle]
unsafe extern "C" fn r8a66597_interval_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_td_timer(t: *mut timer_list) {
    ...
    unsigned long flags;
    u16 pipenum;
    struct r8a66597_td *td, *new_td = core::ptr::null_mut();
    struct r8a66597_pipe *pipe;
    spin_lock_irqsave(&r8a66597.lock, flags);
    for (pipenum = 0; pipenum < R8A66597_MAX_NUM_PIPE; pipenum++) {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn check_pipe_config(r8a66597: *mut r8a66597, urb: *mut urb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_start(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_stop(hcd: *mut usb_hcd) {
...
#[no_mangle]
unsafe extern "C" fn set_address_zero(r8a66597: *mut r8a66597, urb: *mut urb) {
    static void set_address_zero(struct r8a66597 *r8a66597, struct urb *urb)
    {
    let mut usb_address: c_uint = usb_pipedevice(urb.pipe);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: usb_pipein(urb->pipe)) -> else {
    ...
    struct r8a66597 *r8a66597 = hcd_to_r8a66597(hcd);
    struct r8a66597_td *td = core::ptr::null_mut();
    int ret, request = 0;
    unsigned long flags;
    spin_lock_irqsave(&r8a66597.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn r8a66597_get_frame(hcd: *mut usb_hcd) -> c_int {
    static int r8a66597_get_frame(struct usb_hcd *hcd)
    {
    struct r8a66597 *r8a66597 = hcd_to_r8a66597(hcd);
...
#[no_mangle]
unsafe extern "C" fn collect_usb_address_map(udev: *mut usb_device, map: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_hub_status_data(hcd: *mut usb_hcd, buf: *mut c_char) -> c_int {
...
// buf |= 1 << (i + 1);
    ...
    struct r8a66597 *r8a66597 = hcd_to_r8a66597(hcd);
    int ret;
    let mut port: c_int = (wIndex & 0x00FF) - 1;
    struct r8a66597_root_hub *rh = &r8a66597.root_hub[port];
    unsigned long flags;
    ret = 0;
    spin_lock_irqsave(&r8a66597.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn r8a66597_bus_suspend(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_bus_resume(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn r8a66597_probe(pdev: *mut platform_device) -> c_int {
    static int r8a66597_probe(struct platform_device *pdev)
    {
    char clk_name[8];
    struct resource *res = core::ptr::null_mut(), *ires;
    let mut irq: c_int = -1;
    ...
    if (pdev.dev.platform_data == core::ptr::null_mut()) {
