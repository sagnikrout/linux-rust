...
//! Source: drivers/usb/host/ohci-s3c2410.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn s3c2410_start_hc(dev: *mut platform_device, hcd: *mut usb_hcd) {
    ...
    if (info.enable_oc != core::ptr::null_mut())
    (info.enable_oc)(info, 1);
    }
    }
#[no_mangle]
unsafe extern "C" fn s3c2410_stop_hc(dev: *mut platform_device) {
    static void s3c2410_stop_hc(struct platform_device *dev)
    {
    struct s3c2410_hcd_info *info = dev_get_platdata(&dev.dev);
    dev_dbg(&dev.dev, "s3c2410_stop_hc:\n");
    if (info != core::ptr::null_mut()) {
    info.report_oc = core::ptr::null_mut();
    info.hcd	= core::ptr::null_mut();
    if (info.enable_oc != core::ptr::null_mut())
...
//
    ...
    if (info == core::ptr::null_mut())
    return;
    if (info.power_control != core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn s3c2410_hcd_oc(info: *mut s3c2410_hcd_info, port_oc: c_int) {
    static void s3c2410_hcd_oc(struct s3c2410_hcd_info *info, int port_oc)
    {
    struct s3c2410_hcd_port *port;
    unsigned long flags;
...
//
#[no_mangle]
unsafe extern "C" fn ohci_hcd_s3c2410_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ohci_hcd_s3c2410_drv_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ohci_hcd_s3c2410_drv_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ohci_s3c2410_init() -> int __init {
    static int __init ohci_s3c2410_init(void)
    {
    if (usb_disabled())
    return -ENODEV;
    ohci_init_driver(&ohci_s3c2410_hc_driver, core::ptr::null_mut());
//
...
#[no_mangle]
unsafe extern "C" fn ohci_s3c2410_cleanup() -> void __exit {
