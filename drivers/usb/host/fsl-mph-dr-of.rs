...
//! Source: drivers/usb/host/fsl-mph-dr-of.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_usb2_dev_data {
    pub /: *mut *mut *mut char dr_mode; / controller mode,
    pub /: *mut *mut *mut char drivers[3]; / drivers to instantiate for this mode,
    pub /: *mut *mut enum fsl_usb2_operating_modes op_mode; / operating mode,
}

    static struct fsl_usb2_dev_data dr_mode_data[] = {
    {
    .dr_mode = "host",
    .drivers = { "fsl-ehci", core::ptr::null_mut(), core::ptr::null_mut(), },
    ...
    {
    .dr_mode = "peripheral",
    .drivers = { "fsl-usb2-udc", core::ptr::null_mut(), core::ptr::null_mut(), },
    ...
    int i;
    prop = of_get_property(np, "dr_mode", core::ptr::null_mut());
    if (prop) {
...
#[no_mangle]
unsafe extern "C" fn determine_usb_phy(phy_type: *const c_char) -> enum fsl_usb2_phy_modes {
    ...
    let mut num: c_uint = ofdev.num_resources;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn usb_get_ver_info(np: *mut device_node) -> enum fsl_usb2_controller_ver {
    static enum fsl_usb2_controller_ver usb_get_ver_info(struct device_node *np)
    {
    let mut ver: enum fsl_usb2_controller_ver = FSL_USB_VER_NONE;
//
...
//
    ...
    ver = FSL_USB_VER_1_6;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(np, _arg: "fsl-usb2-dr-v2.2")) -> else {
    else if (of_device_is_compatible(np, "fsl-usb2-dr-v2.2"))
    ver = FSL_USB_VER_2_2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(np, _arg: "fsl-usb2-dr-v2.4")) -> else {
    else if (of_device_is_compatible(np, "fsl-usb2-dr-v2.4"))
    ver = FSL_USB_VER_2_4;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(np, _arg: "fsl-usb2-dr-v2.5")) -> else {
    ...
    ver = FSL_USB_VER_1_6;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(np, _arg: "fsl-usb2-mph-v2.2")) -> else {
    else if (of_device_is_compatible(np, "fsl-usb2-mph-v2.2"))
    ver = FSL_USB_VER_2_2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(np, _arg: "fsl-usb2-mph-v2.4")) -> else {
    else if (of_device_is_compatible(np, "fsl-usb2-mph-v2.4"))
    ver = FSL_USB_VER_2_4;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(np, _arg: "fsl-usb2-mph-v2.5")) -> else {
...
#[no_mangle]
unsafe extern "C" fn fsl_usb2_mph_dr_of_probe(ofdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __unregister_subdev(dev: *mut device, d: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_usb2_mph_dr_of_remove(ofdev: *mut platform_device) {
    static void fsl_usb2_mph_dr_of_remove(struct platform_device *ofdev)
    {
    device_for_each_child(&ofdev.dev, core::ptr::null_mut(), __unregister_subdev);
    }

pub const USBGENCTRL: c_uint = 0x200		/* NOTE: big endian */;

pub const ISIPHYCTRL: c_uint = 0x204		/* NOTE: big endian */;

#[no_mangle]
unsafe extern "C" fn fsl_usb2_mpc5121_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_usb2_mpc5121_exit(pdev: *mut platform_device) {
    static void fsl_usb2_mpc5121_exit(struct platform_device *pdev)
    {
    struct fsl_usb2_platform_data *pdata = dev_get_platdata(&pdev.dev);
    pdata.regs = core::ptr::null_mut();
