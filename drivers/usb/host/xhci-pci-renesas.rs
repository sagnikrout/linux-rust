...
//! Source: drivers/usb/host/xhci-pci-renesas.c
#![no_std]
...
pub const RENESAS_FW_VERSION: c_uint = 0x6C;
pub const RENESAS_ROM_CONFIG: c_uint = 0xF0;
pub const RENESAS_FW_STATUS: c_uint = 0xF4;
pub const RENESAS_FW_STATUS_MSB: c_uint = 0xF5;
pub const RENESAS_ROM_STATUS: c_uint = 0xF6;
pub const RENESAS_ROM_STATUS_MSB: c_uint = 0xF7;
pub const RENESAS_DATA0: c_uint = 0xF8;
pub const RENESAS_DATA1: c_uint = 0xFC;

pub const RENESAS_FW_VERSION_OFFSET: c_int = 8;

pub const RENESAS_FW_STATUS_INVALID: c_int = 0;

pub const RENESAS_ROM_STATUS_NO_RESULT: c_int = 0;

pub const RENESAS_ROM_ERASE_MAGIC: c_uint = 0x5A65726F;
pub const RENESAS_ROM_WRITE_MAGIC: c_uint = 0x53524F4D;

pub const RENESAS_DELAY: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn renesas_check_rom(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn renesas_check_rom_state(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_fw_check_running(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_rom_erase(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn renesas_setup_rom(pdev: *mut pci_dev, fw: *const firmware) -> bool {
...
#[no_mangle]
unsafe extern "C" fn renesas_load_fw(pdev: *mut pci_dev, fw: *const firmware) -> c_int {
