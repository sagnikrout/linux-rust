...
//! Source: drivers/usb/host/fhci-hub.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fhci_gpio_set_value(fhci: *mut fhci_hcd, gpio_nr: c_int, on: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_port_disable(fhci: *mut fhci_hcd) {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_port_enable(lld: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_io_port_generate_reset(fhci: *mut fhci_hcd) {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_port_reset(lld: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_hub_status_data(hcd: *mut usb_hcd, buf: *mut c_char) -> c_int {
