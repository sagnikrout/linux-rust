...
//! Source: drivers/usb/host/sl811-hcd.c
#![no_std]
...
// #define	QUIRK2
// Macro flag: #define	QUIRK3
    static const char hcd_name[] = "sl811-hcd";
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn port_power(sl811: *mut sl811, is_on: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn sofirq_on(sl811: *mut sl811) {
...
#[no_mangle]
pub unsafe extern "C" fn sofirq_off(sl811: *mut sl811) {
...
// use endpoint at schedule head
    ...
    ep = sl811.next_async;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !list_empty(&sl811->async)) -> else {
...
//
    ...
    sl811.next_async = core::ptr::null_mut();
    else
...
#[no_mangle]
pub unsafe extern "C" fn start_transfer(sl811: *mut sl811) {
    static inline void start_transfer(struct sl811 *sl811)
    {
    if (sl811.port1 & USB_PORT_STAT_SUSPEND)
    return;
    if (sl811.active_a == core::ptr::null_mut()) {
    sl811.active_a = start(sl811, SL811_EP_A(SL811_HOST_BUF));
    if (sl811.active_a != core::ptr::null_mut())
    sl811.jiffies_a = jiffies + MIN_JIFFIES;
    }

    if (sl811.active_b == core::ptr::null_mut()) {
...
// we might turn SOFs back on again for the async schedule
    ...
    u8			status;
    struct urb		*urb;
    let mut urbstat: c_int = -EINPROGRESS;
    if (unlikely(!ep))
    return;
...
// error? retry, until "3 strikes"
    ...
    urbstat = -ETIME;
#[no_mangle]
pub unsafe extern "C" fn if(SL11H_STATMASK_OVF: status &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn checkdone(sl811: *mut sl811) -> u8 {
    static inline u8 checkdone(struct sl811 *sl811)
    {
    u8	ctl;
    let mut irqstat: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn sl811h_irq(hcd: *mut usb_hcd) -> irqreturn_t {
    static irqreturn_t sl811h_irq(struct usb_hcd *hcd)
    {
    struct sl811	*sl811 = hcd_to_sl811(hcd);
    u8		irqstat;
    let mut ret: irqreturn_t = IRQ_NONE;
    let mut retries: unsigned = 5;
    spin_lock(&sl811.lock);
    retry:
...
#[no_mangle]
unsafe extern "C" fn balance(sl811: *mut sl811, period: u16, load: u16) -> c_int {
...
// -------------------------------------------------------------------------
    ...
    struct sl811h_ep	*ep = core::ptr::null_mut();
    unsigned long		flags;
    int			i;
    int			retval;
...
// don't submit to a dead or disabled port
    ...
    ep.nextpid = USB_PID_SETUP;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_out) -> else {
    else if (is_out)
    ep.nextpid = USB_PID_OUT;
    else
    ep.nextpid = USB_PID_IN;
...
#[no_mangle]
unsafe extern "C" fn sl811h_urb_dequeue(hcd: *mut usb_hcd, urb: *mut urb, status: c_int) -> c_int {
...
// ports removable, and legacy PortPwrCtrlMask
    ...
    unsigned long	flags;
    u8		irqstat;
    let mut signaling: u8 = sl811.ctrl1 & SL11H_CTL1MASK_FORCE;
...
// usbcore nukes all pending transactions on disconnect
    ...
    if (sl811.port1 & USB_PORT_STAT_CONNECTION) {
    let mut ctrl2: u8 = SL811HS_CTL2_INIT;
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn dump_irq(s: *mut seq_file, label: *mut c_char, mask: u8) {
...
#[no_mangle]
unsafe extern "C" fn sl811h_debug_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    let mut t: u8 = sl811_read(sl811, SL11H_CTLREG1);
...
#[no_mangle]
unsafe extern "C" fn create_debug_file(sl811: *mut sl811) {
...
#[no_mangle]
unsafe extern "C" fn remove_debug_file(sl811: *mut sl811) {
