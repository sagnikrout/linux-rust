...
//! Source: drivers/usb/host/ehci-q.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn if(!urb->unlinked: last_status == -EINPROGRESS &&) -> else {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn enable_async(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn disable_async(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn qh_link_async(ehci: *mut ehci_hcd, qh: *mut ehci_qh) {
    static void qh_link_async (struct ehci_hcd *ehci, struct ehci_qh *qh)
    {
    let mut dma: __hc32 = QH_NEXT(ehci, qh.qh_dma);
    struct ehci_qh	*head;
...
//
    ...
    let mut qh_addr_mask: __hc32 = cpu_to_hc32(ehci, 0x7f);
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn single_unlink_async(ehci: *mut ehci_hcd, qh: *mut ehci_qh) {
...
#[no_mangle]
unsafe extern "C" fn start_iaa_cycle(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn end_iaa_cycle(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn end_unlink_async(ehci: *mut ehci_hcd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(QH_STATE_UNLINK: qh->qh_state ==) -> else {
//
...
#[no_mangle]
pub unsafe extern "C" fn if(cpu_to_hc32(ehci: qh->hw->hw_token &, _arg: QTD_STS_HALT)) -> else {
...
#[no_mangle]
unsafe extern "C" fn unlink_empty_async(ehci: *mut ehci_hcd) {
    static void unlink_empty_async(struct ehci_hcd *ehci)
    {
    struct ehci_qh		*qh;
    struct ehci_qh		*qh_to_unlink = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn unlink_empty_async_suspended(ehci: *mut ehci_hcd) {
...
#[no_mangle]
unsafe extern "C" fn start_unlink_async(ehci: *mut ehci_hcd, qh: *mut ehci_qh) {
    static void start_unlink_async(struct ehci_hcd *ehci, struct ehci_qh *qh)
    {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn scan_async(ehci: *mut ehci_hcd) {
    static void scan_async (struct ehci_hcd *ehci)
    {
    struct ehci_qh		*qh;
    let mut check_unlinks_later: bool = false;
