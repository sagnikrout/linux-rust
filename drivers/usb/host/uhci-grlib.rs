...
//! Source: drivers/usb/host/uhci-grlib.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn uhci_grlib_init(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uhci_hcd_grlib_probe(op: *mut platform_device) -> c_int {
    static int uhci_hcd_grlib_probe(struct platform_device *op)
    {
    struct device_node *dn = op.dev.of_node;
    struct usb_hcd *hcd;
    struct uhci_hcd	*uhci = core::ptr::null_mut();
    struct resource res;
    int irq;
    int rv;
    if (usb_disabled())
...
#[no_mangle]
unsafe extern "C" fn uhci_hcd_grlib_remove(op: *mut platform_device) {
...
//
#[no_mangle]
unsafe extern "C" fn uhci_hcd_grlib_shutdown(op: *mut platform_device) {
