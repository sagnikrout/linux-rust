...
//! Source: drivers/usb/host/fhci-sched.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn recycle_frame(usb: *mut fhci_usb, pkt: *mut packet) {
    static void recycle_frame(struct fhci_usb *usb, struct packet *pkt)
    {
    pkt.data = core::ptr::null_mut();
    pkt.len = 0;
    pkt.status = USB_TD_OK;
    pkt.info = 0;
    pkt.priv_data = core::ptr::null_mut();
    cq_put(&usb.ep0.empty_frame_Q, pkt);
    }
// confirm submitted packet
#[no_mangle]
pub unsafe extern "C" fn fhci_transaction_confirm(usb: *mut fhci_usb, pkt: *mut packet) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fhci_flush_all_transmissions(usb: *mut fhci_usb) {
    ...
    fhci_flush_bds(usb);
    while ((td = fhci_peek_td_from_frame(usb.actual_frame)) != core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn add_packet(usb: *mut fhci_usb, ed: *mut ed, td: *mut td) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn move_head_to_tail(list: *mut list_head) {
...
//
    ...
    struct td *td;
    let mut ans: c_int = 1;
    let mut save_transaction_time: u32 = usb.sw_transaction_time;
...
#[no_mangle]
unsafe extern "C" fn rotate_frames(usb: *mut fhci_usb) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn fhci_schedule_transactions(usb: *mut fhci_usb) {
...
#[no_mangle]
unsafe extern "C" fn sof_interrupt(fhci: *mut fhci_hcd) {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_device_disconnected_interrupt(fhci: *mut fhci_hcd) {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_device_connected_interrupt(fhci: *mut fhci_hcd) {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_frame_limit_timer_irq(irq: c_int, _hcd: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn abort_transmission(usb: *mut fhci_usb) {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_irq(hcd: *mut usb_hcd) -> irqreturn_t {
    irqreturn_t fhci_irq(struct usb_hcd *hcd)
    {
    struct fhci_hcd *fhci = hcd_to_fhci(hcd);
    struct fhci_usb *usb;
    let mut usb_er: u16 = 0;
    unsigned long flags;
...
//
#[no_mangle]
unsafe extern "C" fn process_done_list(data: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_transfer_confirm_callback(fhci: *mut fhci_hcd) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn fhci_queue_urb(fhci: *mut fhci_hcd, urb: *mut urb) {
    void fhci_queue_urb(struct fhci_hcd *fhci, struct urb *urb)
    {
    struct ed *ed = urb.ep.hcpriv;
    struct urb_priv *urb_priv = urb.hcpriv;
    let mut data_len: u32 = urb.transfer_buffer_length;
    let mut urb_state: c_int = 0;
    let mut toggle: c_int = 0;
    u8 *data;
    let mut cnt: u16 = 0;
    if (ed == core::ptr::null_mut()) {
...
//
    ...
    usb_pipeout(urb.pipe) ? FHCI_TA_OUT :
    FHCI_TA_IN,
    USB_TD_TOGGLE_CARRY, core::ptr::null_mut(), 0, 0, 0, true);
    cnt++;
    }
    break;
    case FHCI_TF_INTR:
...
// status stage
    ...
    let mut frame: u16 = urb.start_frame;
//
