...
//! Source: drivers/usb/host/ehci-ppc-of.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ehci_hcd_ppc_of_probe(op: *mut platform_device) -> c_int {
    static int ehci_hcd_ppc_of_probe(struct platform_device *op)
    {
    struct device_node *dn = op.dev.of_node;
    struct usb_hcd *hcd;
    struct ehci_hcd	*ehci = core::ptr::null_mut();
    struct resource res;
    int irq;
    int rv;
    ...
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "ibm,usb-ohci-440epx");
...
#[no_mangle]
unsafe extern "C" fn ehci_hcd_ppc_of_remove(op: *mut platform_device) {
