...
//! Source: drivers/usb/host/isp116x-hcd.c
#![no_std]
...
//
// Macro flag: #define USE_PLATFORM_DELAY
// #define USE_NDELAY
// #define DEBUG
// #define VERBOSE
...
//
#[no_mangle]
unsafe extern "C" fn write_ptddata_to_fifo(isp116x: *mut isp116x, buf: *mut c_void, len: c_int) {
    static void write_ptddata_to_fifo(struct isp116x *isp116x, void *buf, int len)
    {
    u8 *dp = (u8 *) buf;
    u16 *dp2 = (u16 *) buf;
    u16 w;
    let mut quot: c_int = len % 4;
...
//
#[no_mangle]
unsafe extern "C" fn read_ptddata_from_fifo(isp116x: *mut isp116x, buf: *mut c_void, len: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pack_fifo(isp116x: *mut isp116x) {
...
//
#[no_mangle]
unsafe extern "C" fn unpack_fifo(isp116x: *mut isp116x) {
...
//
#[no_mangle]
unsafe extern "C" fn preproc_atl_queue(isp116x: *mut isp116x) {
    ...
    u16 len;
    for (ep = isp116x.atl_active; ep; ep = ep.active) {
    let mut toggle: u16 = 0, dir = PTD_DIR_SETUP;
...
//
#[no_mangle]
unsafe extern "C" fn postproc_atl_queue(isp116x: *mut isp116x) {
...
// Take into account idiosyncracies of the isp116x chip
    ...
    ^ (ep.error_count > 0));
#[no_mangle]
pub unsafe extern "C" fn if(USB_PID_IN: ep->nextpid ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn start_atl_transfers(isp116x: *mut isp116x) {
    static void start_atl_transfers(struct isp116x *isp116x)
    {
    struct isp116x_ep *last_ep = core::ptr::null_mut(), *ep;
    struct urb *urb;
    let mut load: u16 = 0;
...
// FIFO not empty?
    ...
    return;
    isp116x.atl_active = core::ptr::null_mut();
...
// Bring all int transfers for this frame
    ...
    last_ep.active = core::ptr::null_mut();
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn finish_atl_transfers(isp116x: *mut isp116x) {
...
#[no_mangle]
unsafe extern "C" fn isp116x_irq(hcd: *mut usb_hcd) -> irqreturn_t {
    ...
    let mut intstat: u32 = isp116x_read_reg32(isp116x, HCINTSTAT);
...
//
// out of 1000 us
pub const MAX_PERIODIC_LOAD: c_int = 600;
#[no_mangle]
unsafe extern "C" fn balance(isp116x: *mut isp116x, period: u16, load: u16) -> c_int {
...
// -----------------------------------------------------------------
    ...
    let mut pipe: c_uint = urb.pipe;
    let mut is_out: c_int = !usb_pipein(pipe);
    let mut type: c_int = usb_pipetype(pipe);
    let mut epnum: c_int = usb_pipeendpoint(pipe);
    struct usb_host_endpoint *hep = urb.ep;
    struct isp116x_ep *ep = core::ptr::null_mut();
    unsigned long flags;
    int i;
    let mut ret: c_int = 0;
    urb_dbg(urb, "Enqueue");
...
#[no_mangle]
unsafe extern "C" fn isp116x_get_frame(hcd: *mut usb_hcd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn isp116x_hub_status_data(hcd: *mut usb_hcd, buf: *mut c_char) -> c_int {
...
// Report no status change now, if we are scheduled to be
    ...
    buf[0] = 0;
    for (i = 0; i < ports; i++) {
    let mut status: u32 = isp116x_read_reg32(isp116x, i ? HCRHPORT2 : HCRHPORT1);
    ...
    {
    let mut reg: u32 = isp116x.rhdesca;
...
//
#[no_mangle]
pub unsafe extern "C" fn root_port_reset(isp116x: *mut isp116x, port: unsigned) {
...
// Adapted from ohci-hub.c
    ...
    let mut ret: c_int = 0;
    unsigned long flags;
    let mut ports: c_int = isp116x.rhdesca & RH_A_NDP;
    let mut tmp: u32 = 0;
    switch (typeReq) {
...
#[no_mangle]
unsafe extern "C" fn dump_irq(s: *mut seq_file, label: *mut c_char, mask: u16) {
...
#[no_mangle]
unsafe extern "C" fn dump_int(s: *mut seq_file, label: *mut c_char, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn isp116x_debug_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_debug_file(isp116x: *mut isp116x) {
...
#[no_mangle]
unsafe extern "C" fn remove_debug_file(isp116x: *mut isp116x) {
...
//
#[no_mangle]
unsafe extern "C" fn isp116x_sw_reset(isp116x: *mut isp116x) -> c_int {
    static int isp116x_sw_reset(struct isp116x *isp116x)
    {
    let mut retries: c_int = 15;
    unsigned long flags;
    let mut ret: c_int = 0;
    spin_lock_irqsave(&isp116x.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn isp116x_reset(hcd: *mut usb_hcd) -> c_int {
    static int isp116x_reset(struct usb_hcd *hcd)
    {
    struct isp116x *isp116x = hcd_to_isp116x(hcd);
    unsigned long t;
    let mut clkrdy: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn isp116x_stop(hcd: *mut usb_hcd) {
...
//
#[no_mangle]
unsafe extern "C" fn isp116x_start(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isp116x_bus_suspend(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isp116x_bus_resume(hcd: *mut usb_hcd) -> c_int {
...
// HCCONTROL_USB_RESET: this may happen, when during
    ...
    USB_PORT_FEAT_POWER, 1, core::ptr::null_mut(), 0);
    if ((isp116x.rhdesca & RH_A_NDP) == 2)
    isp116x_hub_control(hcd, SetPortFeature,
    USB_PORT_FEAT_POWER, 2, core::ptr::null_mut(), 0);
    return 0;
    }
...
// ----------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn isp116x_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn isp116x_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn isp116x_suspend(dev: *mut platform_device, state: pm_message_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn isp116x_resume(dev: *mut platform_device) -> c_int {
