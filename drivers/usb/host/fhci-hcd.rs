...
//! Source: drivers/usb/host/fhci-hcd.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn fhci_start_sof_timer(fhci: *mut fhci_hcd) {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_stop_sof_timer(fhci: *mut fhci_hcd) {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_get_sof_timer_count(usb: *mut fhci_usb) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_usb_enable_interrupt(usb: *mut fhci_usb) {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_usb_disable_interrupt(usb: *mut fhci_usb) {
...
#[no_mangle]
unsafe extern "C" fn fhci_usb_enable(fhci: *mut fhci_hcd) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fhci_usb_disable(fhci: *mut fhci_hcd) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn fhci_ioports_check_bus_state(fhci: *mut fhci_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fhci_mem_free(fhci: *mut fhci_hcd) {
    ...
    fhci.vroot_hub = core::ptr::null_mut();
    kfree(fhci.hc_list);
    fhci.hc_list = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn fhci_mem_init(fhci: *mut fhci_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fhci_usb_free(lld: *mut c_void) {
...
// initialize the USB
#[no_mangle]
unsafe extern "C" fn fhci_usb_init(fhci: *mut fhci_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fhci_start(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fhci_stop(hcd: *mut usb_hcd) {
    ...
    fhci.usb_lld = core::ptr::null_mut();
    fhci_mem_free(fhci);
    }
...
// dequeue FHCI URB
#[no_mangle]
unsafe extern "C" fn fhci_urb_dequeue(hcd: *mut usb_hcd, urb: *mut urb, status: c_int) -> c_int {
...
// already pending?
    ...
    ed = ep.hcpriv;
    if (ed) {
    while (ed.td_head != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn fhci_get_frame_number(hcd: *mut usb_hcd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_fhci_probe(ofdev: *mut platform_device) -> c_int {
    ...
    if (usb_disabled())
    return -ENODEV;
    sprop = of_get_property(node, "mode", core::ptr::null_mut());
...
// Clocks.
    sprop = of_get_property(node, "fsl,fullspeed-clock", core::ptr::null_mut());
    if (sprop) {
    ...
    sprop = of_get_property(node, "fsl,lowspeed-clock", core::ptr::null_mut());
    if (sprop) {
...
#[no_mangle]
unsafe extern "C" fn fhci_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn of_fhci_remove(ofdev: *mut platform_device) {
