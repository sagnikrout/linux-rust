...
//! Source: drivers/usb/dwc2/params.c
#![no_std]
...
pub const PCI_PRODUCT_ID_HAPS_HSOTG: c_uint = 0xabc0;
pub const PCI_DEVICE_ID_LOONGSON_DWC2: c_uint = 0x7a04;
#[no_mangle]
unsafe extern "C" fn dwc2_set_bcm_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_his_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_jz4775_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_loongson_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_x1600_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_x2000_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_s3c6400_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_socfpga_agilex_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_rk_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_ltq_danube_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_ltq_ase_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_ltq_xrx200_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_amlogic_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_amlogic_g12a_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_amlogic_a1_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_amcc_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_cv1800_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_stm32f4x9_fsotg_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_stm32f7_hsotg_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_stm32mp15_fsotg_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_stm32mp15_hsotg_params(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_param_otg_cap(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_param_phy_type(hsotg: *mut dwc2_hsotg) {
    static void dwc2_set_param_phy_type(struct dwc2_hsotg *hsotg)
    {
    int val;
    let mut hs_phy_type: u32 = hsotg.hw_params.hs_phy_type;
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_param_speed(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_param_phy_utmi_width(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_param_tx_fifo_sizes(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_param_power_down(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: hsotg->hw_params.power_optimized) -> else {
...
#[no_mangle]
unsafe extern "C" fn dwc2_set_param_lpm(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_set_default_params(hsotg: *mut dwc2_hsotg) {
    static void dwc2_set_default_params(struct dwc2_hsotg *hsotg)
    {
    struct dwc2_hw_params *hw = &hsotg.hw_params;
    struct dwc2_core_params *p = &hsotg.params;
    let mut dma_capable: bool = !(hw.arch == GHWCFG2_SLAVE_ONLY_ARCH);
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_get_device_properties(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_check_param_otg_cap(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_check_param_phy_type(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_check_param_speed(hsotg: *mut dwc2_hsotg) {
    static void dwc2_check_param_speed(struct dwc2_hsotg *hsotg)
    {
    let mut valid: c_int = 1;
    let mut phy_type: c_int = hsotg.params.phy_type;
    let mut speed: c_int = hsotg.params.speed;
    switch (speed) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_check_param_phy_utmi_width(hsotg: *mut dwc2_hsotg) {
    static void dwc2_check_param_phy_utmi_width(struct dwc2_hsotg *hsotg)
    {
    let mut valid: c_int = 0;
    let mut param: c_int = hsotg.params.phy_utmi_width;
    let mut width: c_int = hsotg.hw_params.utmi_phy_data_width;
    switch (width) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_check_param_power_down(hsotg: *mut dwc2_hsotg) {
    static void dwc2_check_param_power_down(struct dwc2_hsotg *hsotg)
    {
    let mut param: c_int = hsotg.params.power_down;
    switch (param) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_check_param_tx_fifo_sizes(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_check_param_eusb2_disc(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_check_params(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_get_host_hwparams(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_get_dev_hwparams(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_get_hwparams(hsotg: *mut dwc2_hsotg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc2_limit_speed(hsotg: *mut dwc2_hsotg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_init_params(hsotg: *mut dwc2_hsotg) -> c_int {
