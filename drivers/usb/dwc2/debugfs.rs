...
//! Source: drivers/usb/dwc2/debugfs.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn testmode_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn testmode_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn state_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fifo_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
    static int fifo_show(struct seq_file *seq, void *v)
    {
    struct dwc2_hsotg *hsotg = seq.private;
    let mut fifo_count: c_int = dwc2_hsotg_tx_fifo_count(hsotg);
    u32 val;
    int idx;
...
//
#[no_mangle]
unsafe extern "C" fn ep_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
    static int ep_show(struct seq_file *seq, void *v)
    {
    struct dwc2_hsotg_ep *ep = seq.private;
    struct dwc2_hsotg *hsotg = ep.parent;
    struct dwc2_hsotg_req *req;
    let mut index: c_int = ep.index;
    let mut show_limit: c_int = 15;
    unsigned long flags;
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_create_debug(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
unsafe extern "C" fn params_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hw_params_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_mode_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_debugfs_init(hsotg: *mut dwc2_hsotg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_debugfs_exit(hsotg: *mut dwc2_hsotg) {
    void dwc2_debugfs_exit(struct dwc2_hsotg *hsotg)
    {
    debugfs_remove_recursive(hsotg.debug_root);
    hsotg.debug_root = core::ptr::null_mut();
    }
