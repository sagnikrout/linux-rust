...
#[no_mangle]
unsafe extern "C" fn dwc2_ovr_init(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
pub unsafe extern "C" fn if(USB_DR_MODE_PERIPHERAL: hsotg->role_sw_default_mode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn dwc2_ovr_avalid(hsotg: *mut dwc2_hsotg, valid: bool) -> c_int {
    static int dwc2_ovr_avalid(struct dwc2_hsotg *hsotg, bool valid)
    {
    let mut gotgctl: u32 = dwc2_readl(hsotg, GOTGCTL);
...
#[no_mangle]
unsafe extern "C" fn dwc2_ovr_bvalid(hsotg: *mut dwc2_hsotg, valid: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc2_drd_role_sw_set(sw: *mut usb_role_switch, role: enum usb_role) -> c_int {
    static int dwc2_drd_role_sw_set(struct usb_role_switch *sw, enum usb_role role)
    {
    struct dwc2_hsotg *hsotg = usb_role_switch_get_drvdata(sw);
    unsigned long flags;
    let mut already: c_int = 0;
...
//
    ...
    let mut ret: c_int = clk_prepare_enable(hsotg.clk);
    if (ret)
    return ret;
    }
    spin_lock_irqsave(&hsotg.lock, flags);
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_drd_init(hsotg: *mut dwc2_hsotg) -> c_int {
    int dwc2_drd_init(struct dwc2_hsotg *hsotg)
    {
    let mut role_sw_desc: usb_role_switch_desc = {0};
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_drd_suspend(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_drd_resume(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
pub unsafe extern "C" fn if(USB_ROLE_DEVICE: role ==) -> else {
    else if (role == USB_ROLE_DEVICE)
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_drd_exit(hsotg: *mut dwc2_hsotg) {
