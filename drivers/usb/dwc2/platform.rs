...
//! Source: drivers/usb/dwc2/platform.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_get_dr_mode(hsotg: *mut dwc2_hsotg) -> c_int {
    ...
    mode = USB_DR_MODE_HOST;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_ENABLED(CONFIG_USB_DWC2_PERIPHERAL)) -> else {
...
#[no_mangle]
unsafe extern "C" fn __dwc2_lowlevel_hw_enable(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_lowlevel_hw_enable(hsotg: *mut dwc2_hsotg) -> c_int {
    int dwc2_lowlevel_hw_enable(struct dwc2_hsotg *hsotg)
    {
    let mut ret: c_int = __dwc2_lowlevel_hw_enable(hsotg);
    if (ret == 0)
    hsotg.ll_hw_enabled = true;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn __dwc2_lowlevel_hw_disable(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_lowlevel_hw_disable(hsotg: *mut dwc2_hsotg) -> c_int {
    int dwc2_lowlevel_hw_disable(struct dwc2_hsotg *hsotg)
    {
    let mut ret: c_int = __dwc2_lowlevel_hw_disable(hsotg);
    if (ret == 0)
    hsotg.ll_hw_enabled = false;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn dwc2_reset_control_assert(data: *mut c_void) {
    static void dwc2_reset_control_assert(void *data)
    {
    reset_control_assert(data);
    }
#[no_mangle]
unsafe extern "C" fn dwc2_lowlevel_hw_init(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_driver_remove(dev: *mut platform_device) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_driver_shutdown(dev: *mut platform_device) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_check_core_endianness(hsotg: *mut dwc2_hsotg) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_check_core_version(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_driver_probe(dev: *mut platform_device) -> c_int {
...
//
    ...
    hsotg.vbus_supply = core::ptr::null_mut();
    if (retval != -ENODEV)
    return retval;
    }
...
// Postponed adding a new gadget to the udc class driver list
    ...
    if (retval) {
    hsotg.gadget.udc = core::ptr::null_mut();
    dwc2_hsotg_remove(hsotg);
    goto error_debugfs;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn dwc2_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn dwc2_restore_critical_registers(hsotg: *mut dwc2_hsotg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc2_resume(dev: *mut device) -> int __maybe_unused {
