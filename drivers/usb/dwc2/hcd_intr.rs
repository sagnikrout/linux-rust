...
//! Source: drivers/usb/dwc2/hcd_intr.c
#![no_std]
...
//
pub const DWC2_NAKS_BEFORE_DELAY: c_int = 3;
// This function is for debug only
#[no_mangle]
unsafe extern "C" fn dwc2_track_missed_sofs(hsotg: *mut dwc2_hsotg) {
    static void dwc2_track_missed_sofs(struct dwc2_hsotg *hsotg)
    {
    let mut curr_frame_number: u16 = hsotg.frame_number;
    let mut expected: u16 = dwc2_frame_num_inc(hsotg.last_frame_num, 1);
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_sof_intr(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_rx_fifo_level_intr(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_np_tx_fifo_empty_intr(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_perio_tx_fifo_empty_intr(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_port_intr(hsotg: *mut dwc2_hsotg) {
...
//
    ...
    {
    u32 hctsiz;
    let mut xfer_done: c_int = 0;
    let mut short_read: c_int = 0;
...
//
    ...
    struct dwc2_qtd *qtd)
    {
    let mut hctsiz: u32 = dwc2_readl(hsotg, HCTSIZ(chnum));
    let mut pid: u32 = (hctsiz & TSIZ_SC_MC_PID_MASK) >> TSIZ_SC_MC_PID_SHIFT;
...
//
    ...
    chan, chnum, qtd, halt_status, core::ptr::null_mut());
    break;
...
//
    ...
    int free_qtd)
    {
    let mut continue_split: c_int = 0;
    struct dwc2_qtd *qtd;
    if (dbg_qh(qh))
...
// Flush any outstanding requests from the Tx queue
    ...
    DWC2_HC_XFER_COMPLETE, core::ptr::null_mut());
...
//
    ...
    {
    struct dwc2_hcd_urb *urb = qtd.urb;
    let mut halt_status: enum dwc2_halt_status = DWC2_HC_XFER_COMPLETE;
    int pipe_type;
    int urb_xfer_done;
    if (dbg_hc(chan))
    dev_vdbg(hsotg.dev,
...
//
    ...
    qtd, halt_status, core::ptr::null_mut());
    u32 hctsiz;
    if (urb.actual_length + xfer_length > urb.length) {
...
//
    ...
    {
    if (!qtd) {
    dev_dbg(hsotg.dev, "%s: qtd is core::ptr::null_mut()\n", __func__);
    return;
    }
    if (!qtd.urb) {
    dev_dbg(hsotg.dev, "%s: qtd.urb is core::ptr::null_mut()\n", __func__);
    return;
    }
    if (dbg_hc(chan))
...
//
    ...
    bool past_end;
    if (!hsotg.params.uframe_sched) {
    let mut frnum: c_int = dwc2_hcd_get_frame_number(hsotg);
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_check_qtd_still_ok(qtd: *mut dwc2_qtd, qh: *mut dwc2_qh) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dwc2_hc_n_intr(hsotg: *mut dwc2_hsotg, chnum: c_int) {
    ...
    if (!chan) {
    dev_err(hsotg.dev, "## hc_ptr_array for channel is core::ptr::null_mut() ##\n");
    return;
    }
    if (dbg_hc(chan)) {
...
//
    ...
    dwc2_release_channel(hsotg, chan, core::ptr::null_mut(),
    chan.halt_status);
    return;
    }
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hc_intr(hsotg: *mut dwc2_hsotg) {
...
//
    ...
    let mut hc_num: c_int = chan.hc_num;
    if (haint & (1 << hc_num)) {
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_handle_hcd_intr(hsotg: *mut dwc2_hsotg) -> irqreturn_t {
