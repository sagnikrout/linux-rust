...
//! Source: drivers/usb/dwc2/gadget.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_set_bit(hsotg: *mut dwc2_hsotg, offset: u32, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_clear_bit(hsotg: *mut dwc2_hsotg, offset: u32, val: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn using_dma(hsotg: *mut dwc2_hsotg) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn using_desc_dma(hsotg: *mut dwc2_hsotg) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_gadget_incr_frame_num(hs_ep: *mut dwc2_hsotg_ep) {
    static inline void dwc2_gadget_incr_frame_num(struct dwc2_hsotg_ep *hs_ep)
    {
    struct dwc2_hsotg *hsotg = hs_ep.parent;
    let mut limit: u16 = DSTS_SOFFN_LIMIT;
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_gadget_dec_frame_num_by_one(hs_ep: *mut dwc2_hsotg_ep) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_en_gsint(hsotg: *mut dwc2_hsotg, ints: u32) {
    static void dwc2_hsotg_en_gsint(struct dwc2_hsotg *hsotg, u32 ints)
    {
    let mut gsintmsk: u32 = dwc2_readl(hsotg, GINTMSK);
    u32 new_gsintmsk;
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_disable_gsint(hsotg: *mut dwc2_hsotg, ints: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_hsotg_tx_fifo_count(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_hsotg_tx_fifo_total_depth(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_wkup_alert_handler(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_hsotg_tx_fifo_average_depth(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_init_fifo(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_ep_periodic(hs_ep: *mut dwc2_hsotg_ep) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_alloc_ctrl_desc_chains(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
    ...
    struct dwc2_hsotg_req *hs_req)
    {
    let mut periodic: bool = is_ep_periodic(hs_ep);
    let mut gnptxsts: u32 = dwc2_readl(hsotg, GNPTXSTS);
    let mut buf_pos: c_int = hs_req.req.actual;
    let mut to_write: c_int = hs_ep.size_loaded;
    void *data;
    int can_write;
    int pkt_round;
    int max_transfer;
...
// if there's nothing to write, get out early
    ...
    let mut epsize: u32 = dwc2_readl(hsotg, DIEPTSIZ(hs_ep.index));
    int size_left;
    int size_done;
//
...
//
#[no_mangle]
unsafe extern "C" fn get_ep_limit(hs_ep: *mut dwc2_hsotg_ep) -> c_uint {
    static unsigned int get_ep_limit(struct dwc2_hsotg_ep *hs_ep)
    {
    let mut index: c_int = hs_ep.index;
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_read_frameno(hsotg: *mut dwc2_hsotg) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_get_chain_limit(hs_ep: *mut dwc2_hsotg_ep) -> c_uint {
    static unsigned int dwc2_gadget_get_chain_limit(struct dwc2_hsotg_ep *hs_ep)
    {
    const struct usb_endpoint_descriptor *ep_desc = hs_ep.ep.desc;
    let mut is_isoc: c_int = hs_ep.isochronous;
    unsigned int maxsize;
    let mut mps: u32 = hs_ep.ep.maxpacket;
    let mut dir_in: c_int = hs_ep.dir_in;
    if (is_isoc)
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_get_desc_params(hs_ep: *mut dwc2_hsotg_ep, mask: *mut u32) -> u32 {
...
//
    ...
    unsigned int len)
    {
    struct usb_request *ureq = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_start_isoc_ddma(hs_ep: *mut dwc2_hsotg_ep) {
...
// Initialize descriptor chain by Host Busy status
    ...
    let mut dma_addr: dma_addr_t = hs_req.req.dma;
...
// If endpoint is stalled, we will restart request later
    ...
    if (length > maxreq) {
    let mut round: c_int = maxreq % hs_ep.ep.maxpacket;
...
// Adjust length: EP0 - MPS, other OUT EPs - multiple of MPS
    ...
    length = mps;
#[no_mangle]
pub unsafe extern "C" fn if(mps: length %) -> else {
    else if (length % mps)
...
// Free bounce buffer
    ...
    hs_req.saved_req_buf = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_target_frame_elapsed(hs_ep: *mut dwc2_hsotg_ep) -> bool {
    static bool dwc2_gadget_target_frame_elapsed(struct dwc2_hsotg_ep *hs_ep)
    {
    struct dwc2_hsotg *hsotg = hs_ep.parent;
    let mut target_frame: u32 = hs_ep.target_frame;
    let mut current_frame: u32 = hsotg.frame_number;
    let mut frame_overrun: bool = hs_ep.frame_overrun;
    let mut limit: u16 = DSTS_SOFFN_LIMIT;
    if (hsotg.gadget.speed != USB_SPEED_HIGH)
    limit >>= 3;
...
//
    ...
    u32 windex)
    {
    let mut dir: c_int = (windex & USB_DIR_IN) ? 1 : 0;
    let mut idx: c_int = windex & 0x7F;
    if (windex >= 0x100)
    return core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_hsotg_set_test_mode(hsotg: *mut dwc2_hsotg, testmode: c_int) -> c_int {
    int dwc2_hsotg_set_test_mode(struct dwc2_hsotg *hsotg, int testmode)
    {
    let mut dctl: c_int = dwc2_readl(hsotg, DCTL);
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_start_next_request(hs_ep: *mut dwc2_hsotg_ep) {
...
//
    ...
    ret = dwc2_hsotg_send_reply(hsotg, ep0, core::ptr::null_mut(), 0);
    if (ret) {
    dev_err(hsotg.dev,
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_stall_ep0(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_enqueue_setup(hsotg: *mut dwc2_hsotg) {
    static void dwc2_hsotg_enqueue_setup(struct dwc2_hsotg *hsotg)
    {
...
//
    ...
    {
    u32 ctrl;
    let mut index: u8 = hs_ep.index;
    let mut epctl_reg: u32 = hs_ep.dir_in ? DIEPCTL(index) : DOEPCTL(index);
    let mut epsiz_reg: u32 = hs_ep.dir_in ? DIEPTSIZ(index) : DOEPTSIZ(index);
    if (hs_ep.dir_in)
...
// Not specific buffer needed for ep0 ZLP
    let mut dma: dma_addr_t = hs_ep.desc_list_dma;
    if (!index)
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_complete_isoc_request_ddma(hs_ep: *mut dwc2_hsotg_ep) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_handle_isoc_bna(hs_ep: *mut dwc2_hsotg_ep) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_rx_data(hsotg: *mut dwc2_hsotg, ep_idx: c_int, size: c_int) {
    ...
    int read_ptr;
    if (!hs_req) {
    let mut epctl: u32 = dwc2_readl(hsotg, DOEPCTL(ep_idx));
    int ptr;
    dev_dbg(hsotg.dev,
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_ep0_zlp(hsotg: *mut dwc2_hsotg, dir_in: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_get_xfersize_ddma(hs_ep: *mut dwc2_hsotg_ep) -> c_uint {
    static unsigned int dwc2_gadget_get_xfersize_ddma(struct dwc2_hsotg_ep *hs_ep)
    {
    const struct usb_endpoint_descriptor *ep_desc = hs_ep.ep.desc;
    struct dwc2_hsotg *hsotg = hs_ep.parent;
    let mut bytes_rem: c_uint = 0;
    let mut bytes_rem_correction: c_uint = 0;
    struct dwc2_dma_desc *desc = hs_ep.desc_list;
    int i;
    u32 status;
    let mut mps: u32 = hs_ep.ep.maxpacket;
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_handle_outdone(hsotg: *mut dwc2_hsotg, epnum: c_int) {
    static void dwc2_hsotg_handle_outdone(struct dwc2_hsotg *hsotg, int epnum)
    {
    let mut epsize: u32 = dwc2_readl(hsotg, DOEPTSIZ(epnum));
    struct dwc2_hsotg_ep *hs_ep = hsotg.eps_out[epnum];
    struct dwc2_hsotg_req *hs_req = hs_ep.req;
    struct usb_request *req = &hs_req.req;
    let mut size_left: c_uint = DXEPTSIZ_XFERSIZE_GET(epsize);
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_handle_rx(hsotg: *mut dwc2_hsotg) {
    static void dwc2_hsotg_handle_rx(struct dwc2_hsotg *hsotg)
    {
    let mut grxstsr: u32 = dwc2_readl(hsotg, GRXSTSP);
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_ep0_mps(mps: c_uint) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_txfifo_flush(hsotg: *mut dwc2_hsotg, idx: c_uint) {
...
//
    ...
    {
    let mut epmsk_reg: u32 = dir_in ? DIEPMSK : DOEPMSK;
    let mut epint_reg: u32 = dir_in ? DIEPINT(idx) : DOEPINT(idx);
    u32 ints;
    u32 mask;
    u32 diepempmsk;
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_handle_ep_disabled(hs_ep: *mut dwc2_hsotg_ep) {
    static void dwc2_gadget_handle_ep_disabled(struct dwc2_hsotg_ep *hs_ep)
    {
    struct dwc2_hsotg *hsotg = hs_ep.parent;
    struct dwc2_hsotg_req *hs_req;
    let mut idx: c_uchar = hs_ep.index;
    let mut dir_in: c_int = hs_ep.dir_in;
    let mut epctl_reg: u32 = dir_in ? DIEPCTL(idx) : DOEPCTL(idx);
    let mut dctl: c_int = dwc2_readl(hsotg, DCTL);
    dev_dbg(hsotg.dev, "%s: EPDisbld\n", __func__);
    if (dir_in) {
    let mut epctl: c_int = dwc2_readl(hsotg, epctl_reg);
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_handle_out_token_ep_disabled(ep: *mut dwc2_hsotg_ep) {
    static void dwc2_gadget_handle_out_token_ep_disabled(struct dwc2_hsotg_ep *ep)
    {
    struct dwc2_hsotg *hsotg = ep.parent;
    struct dwc2_hsotg_req *hs_req;
    let mut dir_in: c_int = ep.dir_in;
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_handle_nak(hs_ep: *mut dwc2_hsotg_ep) {
...
//
    ...
    let mut epint_reg: u32 = dir_in ? DIEPINT(idx) : DOEPINT(idx);
    let mut epctl_reg: u32 = dir_in ? DIEPCTL(idx) : DOEPCTL(idx);
    let mut epsiz_reg: u32 = dir_in ? DIEPTSIZ(idx) : DOEPTSIZ(idx);
    u32 ints;
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_irq_enumdone(hsotg: *mut dwc2_hsotg) {
    static void dwc2_hsotg_irq_enumdone(struct dwc2_hsotg *hsotg)
    {
    let mut dsts: u32 = dwc2_readl(hsotg, DSTS);
    let mut ep0_mps: c_int = 0, ep_mps = 8;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_hsotg_disconnect(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_irq_fifoempty(hsotg: *mut dwc2_hsotg, periodic: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_hsotg_core_disconnect(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_hsotg_core_connect(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_handle_incomplete_isoc_in(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_handle_incomplete_isoc_out(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_irq(irq: c_int, pw: *mut c_void) -> irqreturn_t {
    static irqreturn_t dwc2_hsotg_irq(int irq, void *pw)
    {
    struct dwc2_hsotg *hsotg = pw;
    let mut retry_count: c_int = 8;
    u32 gintsts;
    u32 gintmsk;
...
// Exit gadget mode clock gating.
    ...
    let mut usb_status: u32 = dwc2_readl(hsotg, GOTGCTL);
    let mut connected: u32 = hsotg.connected;
...
// Reset device address to zero
    ...
    let mut daint: u32 = dwc2_readl(hsotg, DAINT);
    let mut daintmsk: u32 = dwc2_readl(hsotg, DAINTMSK);
...
//
    ...
    struct dwc2_hsotg *hsotg = hs_ep.parent;
    unsigned long flags;
    let mut index: c_uint = hs_ep.index;
    u32 epctrl_reg;
    u32 epctrl;
    u32 mps;
    u32 mc;
...
//
    ...
    let mut fifo_count: unsigned = dwc2_hsotg_tx_fifo_count(hsotg);
    let mut fifo_index: u32 = 0;
    let mut fifo_size: u32 = UINT_MAX;
...
// and HS_IOT_1.00a.
//
    let mut gsnpsid: u32 = dwc2_readl(hsotg, GSNPSID);
...
// enable the endpoint interrupt
    ...
    hs_ep.desc_list = core::ptr::null_mut();
    }
    return ret;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_ep_disable(ep: *mut usb_ep) -> c_int {
    static int dwc2_hsotg_ep_disable(struct usb_ep *ep)
    {
    struct dwc2_hsotg_ep *hs_ep = our_ep(ep);
    struct dwc2_hsotg *hsotg = hs_ep.parent;
...
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_ep_disable_lock(ep: *mut usb_ep) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn on_list(ep: *mut dwc2_hsotg_ep, test: *mut dwc2_hsotg_req) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_ep_dequeue(ep: *mut usb_ep, req: *mut usb_request) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_ep_set_wedge(ep: *mut usb_ep) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_ep_sethalt(ep: *mut usb_ep, value: c_int, now: bool) -> c_int {
    static int dwc2_hsotg_ep_sethalt(struct usb_ep *ep, int value, bool now)
    {
    struct dwc2_hsotg_ep *hs_ep = our_ep(ep);
    struct dwc2_hsotg *hs = hs_ep.parent;
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_ep_sethalt_lock(ep: *mut usb_ep, value: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_init(hsotg: *mut dwc2_hsotg) {
...
//
    ...
    return 0;
    err:
    hsotg.driver = core::ptr::null_mut();
    return ret;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_udc_stop(gadget: *mut usb_gadget) -> c_int {
...
// all endpoints should be shutdown
    ...
    spin_lock_irqsave(&hsotg.lock, flags);
    hsotg.driver = core::ptr::null_mut();
    hsotg.gadget.dev.of_node = core::ptr::null_mut();
    hsotg.gadget.speed = USB_SPEED_UNKNOWN;
    hsotg.enabled = 0;
    spin_unlock_irqrestore(&hsotg.lock, flags);
    if (!IS_ERR_OR_NULL(hsotg.uphy))
    otg_set_peripheral(hsotg.uphy.otg, core::ptr::null_mut());
    if (hsotg.dr_mode == USB_DR_MODE_PERIPHERAL)
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_gadget_getframe(gadget: *mut usb_gadget) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_pullup(gadget: *mut usb_gadget, is_on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_vbus_session(gadget: *mut usb_gadget, is_active: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_vbus_draw(gadget: *mut usb_gadget, mA: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc2_gadget_set_speed(g: *mut usb_gadget, speed: enum usb_device_speed) {
...
//
    ...
    dir = "";
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dir_in) -> else {
    else if (dir_in)
    dir = "in";
    else
    dir = "out";
...
//
    if (using_dma(hsotg)) {
    let mut next: u32 = DXEPCTL_NEXTEP((epnum + 1) % 15);
    if (dir_in)
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_hw_cfg(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_hsotg_dump(hsotg: *mut dwc2_hsotg) {
    static void dwc2_hsotg_dump(struct dwc2_hsotg *hsotg)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_gadget_init(hsotg: *mut dwc2_hsotg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(USB_DR_MODE_PERIPHERAL: hsotg->dr_mode ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_hsotg_remove(hsotg: *mut dwc2_hsotg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_hsotg_suspend(hsotg: *mut dwc2_hsotg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_hsotg_resume(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_backup_device_registers(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_restore_device_registers(hsotg: *mut dwc2_hsotg, flags: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_gadget_init_lpm(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_gadget_program_ref_clk(hsotg: *mut dwc2_hsotg) {
...
#[no_mangle]
pub unsafe extern "C" fn dwc2_gadget_backup_critical_registers(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_gadget_enter_hibernation(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_gadget_enter_partial_power_down(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_gadget_enter_clock_gating(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_gadget_exit_clock_gating(hsotg: *mut dwc2_hsotg, rem_wakeup: c_int) {
