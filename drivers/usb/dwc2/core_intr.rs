...
//! Source: drivers/usb/dwc2/core_intr.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_handle_usb_port_intr(hsotg: *mut dwc2_hsotg) {
    static void dwc2_handle_usb_port_intr(struct dwc2_hsotg *hsotg)
    {
    let mut hprt0: u32 = dwc2_readl(hsotg, HPRT0);
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_handle_mode_mismatch_intr(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_handle_otg_intr(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_handle_conn_id_status_change_intr(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_handle_session_req_intr(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_wakeup_from_lpm_l1(hsotg: *mut dwc2_hsotg, remotewakeup: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_handle_wakeup_detected_intr(hsotg: *mut dwc2_hsotg) {
...
// Clear interrupt
    ...
    if (hsotg.in_ppd) {
    let mut dctl: u32 = dwc2_readl(hsotg, DCTL);
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_handle_disconnect_intr(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_handle_usb_suspend_intr(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_handle_lpm_intr(hsotg: *mut dwc2_hsotg) {
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_read_common_intr(hsotg: *mut dwc2_hsotg) -> u32 {
    static u32 dwc2_read_common_intr(struct dwc2_hsotg *hsotg)
    {
    u32 gintsts;
    u32 gintmsk;
    u32 gahbcfg;
    let mut gintmsk_common: u32 = GINTMSK_COMMON;
...
//
#[no_mangle]
unsafe extern "C" fn dwc2_handle_gpwrdn_intr(hsotg: *mut dwc2_hsotg) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_handle_common_intr(irq: c_int, dev: *mut c_void) -> irqreturn_t {
