...
//! Source: drivers/usb/dwc2/hcd_ddma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dwc2_frame_list_idx(frame: u16) -> u16 {
    static u16 dwc2_frame_list_idx(u16 frame)
    {
    return frame & (FRLISTEN_64_SIZE - 1);
    }
#[no_mangle]
unsafe extern "C" fn dwc2_desclist_idx_inc(idx: u16, inc: u16, speed: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn dwc2_desclist_idx_dec(idx: u16, inc: u16, speed: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn dwc2_max_desc_num(qh: *mut dwc2_qh) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn dwc2_frame_incr_val(qh: *mut dwc2_qh) -> u16 {
    ...
    qh.desc_list = core::ptr::null_mut();
    return -ENOMEM;
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn dwc2_desc_list_free(hsotg: *mut dwc2_hsotg, qh: *mut dwc2_qh) {
    ...
    kfree(qh.n_bytes);
    qh.n_bytes = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn dwc2_frame_list_alloc(hsotg: *mut dwc2_hsotg, mem_flags: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc2_frame_list_free(hsotg: *mut dwc2_hsotg) {
    ...
    hsotg.frame_list = core::ptr::null_mut();
    spin_unlock_irqrestore(&hsotg.lock, flags);
    }
#[no_mangle]
unsafe extern "C" fn dwc2_per_sched_enable(hsotg: *mut dwc2_hsotg, fr_list_en: u32) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_per_sched_disable(hsotg: *mut dwc2_hsotg) {
...
//
    ...
    chan.qh = core::ptr::null_mut();
    }
    qh.channel = core::ptr::null_mut();
    qh.ntd = 0;
    if (qh.desc_list)
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_hcd_qh_free_ddma(hsotg: *mut dwc2_hsotg, qh: *mut dwc2_qh) {
...
#[no_mangle]
unsafe extern "C" fn dwc2_frame_to_desc_idx(qh: *mut dwc2_qh, frame_idx: u16) -> u8 {
...
// Macro flag: #define ISOC_URB_GIVEBACK_ASAP
pub const MAX_ISOC_XFER_SIZE_FS: c_int = 1023;
pub const MAX_ISOC_XFER_SIZE_HS: c_int = 3072;
pub const DESCNUM_THRESHOLD: c_int = 4;
...
//
    ...
    let mut len: c_int = chan.xfer_len;
...
//
#[no_mangle]
pub unsafe extern "C" fn dwc2_hcd_start_xfer_ddma(hsotg: *mut dwc2_hsotg, qh: *mut dwc2_qh) {
    void dwc2_hcd_start_xfer_ddma(struct dwc2_hsotg *hsotg, struct dwc2_qh *qh)
    {
// Channel is already assigned
    struct dwc2_host_chan *chan = qh.channel;
    let mut skip_frames: u16 = 0;
    switch (chan.ep_type) {
...
pub const DWC2_CMPL_DONE: c_int = 1;
pub const DWC2_CMPL_STOP: c_int = 2;
...
//
    ...
    struct dwc2_qh *qh = chan.qh;
    struct dwc2_qtd *qtd = core::ptr::null_mut();
    int xfer_done;
    let mut desc_num: c_int = 0;
    if (chan.halt_status == DWC2_HC_XFER_URB_DEQUEUE) {
    list_for_each_entry(qtd, &qh.qtd_list, qtd_list_entry)
    qtd.in_process = 0;
    return;
...
//
    ...
    dwc2_hcd_save_data_toggle(hsotg, chan, chnum, core::ptr::null_mut());
    }
...
//
    ...
    {
    struct dwc2_qh *qh = chan.qh;
    let mut continue_isoc_xfer: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(DWC2_TRANSACTION_NON_PERIODIC: tr_type ==) -> else {
