...
//
    ...
    return dev ? to_platform_device(dev) : core::ptr::null_mut();
    }
    EXPORT_SYMBOL(of_find_device_by_node);
#[no_mangle]
pub unsafe extern "C" fn of_device_add(ofdev: *mut platform_device) -> c_int {
    int of_device_add(struct platform_device *ofdev)
    {
    BUG_ON(ofdev.dev.of_node == core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn of_device_register(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn of_device_unregister(ofdev: *mut platform_device) {
...
//
    ...
    struct device *parent)
    {
    return of_platform_device_create_pdata(np, bus_id, core::ptr::null_mut(), parent);
    }
    ...
    return core::ptr::null_mut();
    dev = amba_device_alloc(core::ptr::null_mut(), 0, 0);
    if (!dev)
    goto err_clear_flag;
...
//
    ...
    const struct of_dev_auxdata *auxdata;
    struct platform_device *dev;
    const char *bus_id = core::ptr::null_mut();
    void *platform_data = core::ptr::null_mut();
    let mut rc: c_int = 0;
...
// Do a self check of bus type, if there's a match, create children
    ...
    rc = of_platform_bus_create(root, matches, core::ptr::null_mut(), parent, false);
    } else {
    for_each_child_of_node_scoped(root, child) {
    if (!of_match_node(matches, child))
    continue;
    rc = of_platform_bus_create(child, matches, core::ptr::null_mut(), parent, false);
    if (rc)
    break;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn of_platform_default_populate_init() -> int __init {
    static int __init of_platform_default_populate_init(void)
    {
    struct device_node *node, *reserved;
    device_links_supplier_sync_state_pause();
    if (IS_ENABLED(CONFIG_PPC)) {
    struct device_node *boot_display = core::ptr::null_mut();
    struct platform_device *dev;
    let mut display_number: c_int = 0;
    int ret;
...
//
    ...
    continue;
    dev = of_platform_device_create(node, "of-display", core::ptr::null_mut());
    of_node_put(node);
    if (WARN_ON(!dev))
    return -ENOMEM;
    boot_display = node;
    ...
    if (ret < sizeof(buf))
    of_platform_device_create(node, buf, core::ptr::null_mut());
    }
    } else {
//
...
//
    ...
    of_platform_device_create(node, core::ptr::null_mut(), core::ptr::null_mut());
    }
    of_node_put(reserved);
    }
    node = of_find_node_by_path("/firmware");
    if (node) {
    of_platform_default_populate(node, core::ptr::null_mut(), core::ptr::null_mut());
    of_node_put(node);
    }
...
//
    sysfb_disable(core::ptr::null_mut());
    of_platform_device_create(node, core::ptr::null_mut(), core::ptr::null_mut());
    of_node_put(node);
    }
...
#[no_mangle]
unsafe extern "C" fn of_platform_sync_state_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn of_platform_device_destroy(dev: *mut device, data: *mut c_void) -> c_int {
...
// Recurse for any nodes that were treated as busses
    ...
    device_for_each_child(dev, core::ptr::null_mut(), of_platform_device_destroy);
...
#[no_mangle]
pub unsafe extern "C" fn if(&amba_bustype: dev->bus ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_platform_depopulate(parent: *mut device) {
    void of_platform_depopulate(struct device *parent)
    {
    if (parent.of_node && of_node_check_flag(parent.of_node, OF_POPULATED_BUS)) {
    device_for_each_child_reverse(parent, core::ptr::null_mut(), of_platform_device_destroy);
    of_node_clear_flag(parent.of_node, OF_POPULATED_BUS);
    }
    }
    EXPORT_SYMBOL_GPL(of_platform_depopulate);
#[no_mangle]
unsafe extern "C" fn devm_of_platform_populate_release(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_of_platform_populate(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_of_platform_match(dev: *mut device, res: *mut c_void, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_of_platform_depopulate(dev: *mut device) {
...
// pdev_parent may be NULL when no bus platform device
    ...
    pdev = of_platform_device_create(rd.dn, core::ptr::null_mut(),
    pdev_parent ? &pdev_parent.dev : core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn of_platform_register_reconfig_notifier() {
