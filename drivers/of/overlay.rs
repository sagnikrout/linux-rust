...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct overlay_changeset {
    pub id: c_int,
    pub ovcs_list: list_head,
    pub new_fdt: *const c_void,
    pub overlay_mem: *const c_void,
    pub overlay_root: *mut device_node,
    pub notify_state: enum of_overlay_notify_action,
    pub count: c_int,
    pub fragments: *mut fragment,
    pub symbols_fragment: bool,
    pub cset: of_changeset,
}

// flags are sticky - once set, do not reset
    static int devicetree_state_flags;
pub const DTSF_APPLY_FAIL: c_uint = 0x01;
pub const DTSF_REVERT_FAIL: c_uint = 0x02;
#[no_mangle]
unsafe extern "C" fn of_prop_val_eq(p1: *const property, p2: *const property) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn devicetree_corrupt() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn of_overlay_mutex_lock() {
    void of_overlay_mutex_lock(void)
    {
    mutex_lock(&of_overlay_phandle_mutex);
    }
#[no_mangle]
pub unsafe extern "C" fn of_overlay_mutex_unlock() {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_overlay_notifier_register(nb: *mut notifier_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_overlay_notifier_unregister(nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn overlay_fw_devlink_refresh(ovcs: *mut overlay_changeset) {
...
//
    ...
    if (k >= ovcs.count)
    return core::ptr::null_mut();
    overlay_name_len = snprintf(core::ptr::null_mut(), 0, "%pOF", fragment.overlay);
...
//
    ...
    {
    struct property *new_prop = core::ptr::null_mut();
    ...
    return 0;
    if (target.in_livetree)
    prop = of_find_property(target.np, overlay_prop.name, core::ptr::null_mut());
    else
...
//
    ...
    break;
    if (!tchild) {
    tchild = __of_node_dup(core::ptr::null_mut(), node_kbasename);
    if (!tchild)
    return -ENOMEM;
    tchild.parent = target.np;
    tchild.name = __of_get_property(node, "name", core::ptr::null_mut());
    if (!tchild.name)
    tchild.name = "<core::ptr::null_mut()>";
...
//
#[no_mangle]
unsafe extern "C" fn changeset_dup_entry_check(ovcs: *mut overlay_changeset) -> c_int {
    static int changeset_dup_entry_check(struct overlay_changeset *ovcs)
    {
    struct of_changeset_entry *ce_1;
    let mut dup_entry: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn build_changeset(ovcs: *mut overlay_changeset) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_overlay_changeset(ovcs: *mut overlay_changeset) {
...
//
    ...
    {
    let mut ret: c_int = 0, ret_revert, ret_tmp;
...
//
    ...
    overlay_mem = of_fdt_unflatten_tree(new_fdt_align, core::ptr::null_mut(),
    &ovcs.overlay_root);
    if (!overlay_mem) {
...
//
#[no_mangle]
unsafe extern "C" fn find_node(tree: *const device_node, np: *mut device_node) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn overlay_removal_is_ok(remove_ovcs: *mut overlay_changeset) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_overlay_remove(ovcs_id: *mut c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_overlay_remove_all() -> c_int {
