...
#[no_mangle]
unsafe extern "C" fn live_tree_max_phandle() -> phandle {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_resolve_phandles(overlay: *mut device_node) -> c_int {
    int of_resolve_phandles(struct device_node *overlay)
    {
    struct device_node *child, *refnode;
    struct device_node *overlay_fixups;
    struct device_node __free(device_node) *local_fixups = core::ptr::null_mut();
    ...
    if (err)
    return err;
    overlay_fixups = core::ptr::null_mut();
    for_each_child_of_node(overlay, child) {
