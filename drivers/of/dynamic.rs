...
//
#[no_mangle]
pub unsafe extern "C" fn of_node_put(node: *mut device_node) {
...
#[no_mangle]
pub unsafe extern "C" fn of_reconfig_notifier_register(nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn of_reconfig_notifier_unregister(nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_property_status_ok(prop: *const property) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn of_reconfig_notify(action: c_ulong, p: *mut of_reconfig_data) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_reconfig_get_state_change(action: c_ulong, pr: *mut of_reconfig_data) -> c_int {
    int of_reconfig_get_state_change(unsigned long action, struct of_reconfig_data *pr)
    {
    struct property *prop, *old_prop = core::ptr::null_mut();
    int is_status, status_state, old_status_state, prev_state, new_state;
// figure out if a device should be created or destroyed
    switch (action) {
    case OF_RECONFIG_ATTACH_NODE:
    case OF_RECONFIG_DETACH_NODE:
    prop = of_find_property(pr.dn, "status", core::ptr::null_mut());
    break;
...
#[no_mangle]
unsafe extern "C" fn __of_attach_node(np: *mut device_node) {
    ...
    np.name = __of_get_property(np, "name", core::ptr::null_mut());
    if (!np.name)
...
//
#[no_mangle]
pub unsafe extern "C" fn of_attach_node(np: *mut device_node) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __of_detach_node(np: *mut device_node) {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_detach_node(np: *mut device_node) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __of_prop_free(prop: *mut property) {
...
#[no_mangle]
unsafe extern "C" fn property_list_free(prop_list: *mut property) {
    static void property_list_free(struct property *prop_list)
    {
    struct property *prop, *next;
    for (prop = prop_list; prop != core::ptr::null_mut(); prop = next) {
    next = prop.next;
    __of_prop_free(prop);
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn of_node_release(kobj: *mut kobject) {
...
//
    ...
    int ret;
    np = __of_node_dup(core::ptr::null_mut(), full_name);
    if (!np)
    return core::ptr::null_mut();
    np.parent = parent;
...
#[no_mangle]
unsafe extern "C" fn __of_changeset_entry_destroy(ce: *mut of_changeset_entry) {
...
#[no_mangle]
unsafe extern "C" fn __of_changeset_entry_apply(ce: *mut of_changeset_entry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __of_changeset_entry_revert(ce: *const of_changeset_entry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_changeset_init(ocs: *mut of_changeset) {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_changeset_destroy(ocs: *mut of_changeset) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __of_changeset_apply_entries(ocs: *mut of_changeset, ret_revert: *mut c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __of_changeset_apply_notify(ocs: *mut of_changeset) -> c_int {
    int __of_changeset_apply_notify(struct of_changeset *ocs)
    {
    struct of_changeset_entry *ce;
    let mut ret: c_int = 0, ret_tmp;
...
//
#[no_mangle]
unsafe extern "C" fn __of_changeset_apply(ocs: *mut of_changeset) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_changeset_apply(ocs: *mut of_changeset) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __of_changeset_revert_entries(ocs: *mut of_changeset, ret_apply: *mut c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __of_changeset_revert_notify(ocs: *mut of_changeset) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __of_changeset_revert(ocs: *mut of_changeset) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_changeset_revert(ocs: *mut of_changeset) -> c_int {
