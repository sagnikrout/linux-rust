...
//
#[no_mangle]
pub unsafe extern "C" fn of_get_cpu_hwid(cpun: *mut device_node, thread: c_uint) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn arch_match_cpu_phys_id(cpu: c_int, phys_id: u64) -> bool __weak {
...
//
    ...
    if (!cpu_dev)
    return of_get_cpu_node(cpu, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn of_cpu_node_to_id(cpu_node: *mut device_node) -> c_int {
