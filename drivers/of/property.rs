...
//
#[no_mangle]
pub unsafe extern "C" fn of_property_read_bool(np: *const device_node, propname: *const c_char) -> bool {
    bool of_property_read_bool(const struct device_node *np, const char *propname)
    {
    struct property *prop = of_find_property(np, propname, core::ptr::null_mut());
//
...
//
#[no_mangle]
pub unsafe extern "C" fn of_graph_is_present(node: *const device_node) -> bool {
...
//
    ...
    {
    const struct property *prop = of_find_property(np, propname, core::ptr::null_mut());
    if (!prop)
    return -EINVAL;
    if (!prop.value)
    return -ENODATA;
...
//
    if (!prev) {
    port = of_graph_get_next_port(parent, core::ptr::null_mut());
    if (!port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_graph_get_endpoint_count(np: *const device_node) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_graph_get_port_count(np: *mut device_node) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn of_fwnode_put(fwnode: *mut fwnode_handle) {
    static void of_fwnode_put(struct fwnode_handle *fwnode)
    {
    of_node_put(to_of_node(fwnode));
    }
#[no_mangle]
unsafe extern "C" fn of_fwnode_device_is_available(fwnode: *const fwnode_handle) -> bool {
    static bool of_fwnode_device_is_available(const struct fwnode_handle *fwnode)
    {
    return of_device_is_available(to_of_node(fwnode));
    }
#[no_mangle]
unsafe extern "C" fn of_fwnode_device_dma_supported(fwnode: *const fwnode_handle) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct supplier_bindings {
    struct device_node *(*parse_prop)(struct device_node *np,
    pub index): *const *const char prop_name, int,
    pub np): *mut *mut *mut device_node (get_con_dev)(device_node,
    pub optional: bool,
    pub fwlink_flags: u8,
}
    ...
    DEFINE_SIMPLE_PROP(extcon, "extcon", core::ptr::null_mut())
    DEFINE_SIMPLE_PROP(nvmem_cells, "nvmem-cells", "#nvmem-cell-cells")
    DEFINE_SIMPLE_PROP(phys, "phys", "#phy-cells")
    DEFINE_SIMPLE_PROP(wakeup_parent, "wakeup-parent", core::ptr::null_mut())
    DEFINE_SIMPLE_PROP(pwms, "pwms", "#pwm-cells")
    DEFINE_SIMPLE_PROP(resets, "resets", "#reset-cells")
    DEFINE_SIMPLE_PROP(leds, "leds", core::ptr::null_mut())
    DEFINE_SIMPLE_PROP(backlight, "backlight", core::ptr::null_mut())
    DEFINE_SIMPLE_PROP(panel, "panel", core::ptr::null_mut())
    DEFINE_SIMPLE_PROP(msi_parent, "msi-parent", "#msi-cells")
    DEFINE_SIMPLE_PROP(post_init_providers, "post-init-providers", core::ptr::null_mut())
    DEFINE_SIMPLE_PROP(access_controllers, "access-controllers", "#access-controller-cells")
    DEFINE_SIMPLE_PROP(pses, "pses", "#pse-cells")
    DEFINE_SIMPLE_PROP(power_supplies, "power-supplies", core::ptr::null_mut())
    DEFINE_SIMPLE_PROP(mmc_pwrseq, "mmc-pwrseq", core::ptr::null_mut())
    DEFINE_SUFFIX_PROP(regulators, "-supply", core::ptr::null_mut())
...
//
    ...
    return core::ptr::null_mut();
    return of_irq_parse_one(np, index, &sup_args) ? core::ptr::null_mut() : sup_args.np;
    }
...
//
#[no_mangle]
unsafe extern "C" fn of_link_property(con_np: *mut device_node, prop_name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_is_fwnode_add_links_supported() -> bool {
    static bool of_is_fwnode_add_links_supported(void)
    {
    let mut is_supported: static int = -1;
...
#[no_mangle]
unsafe extern "C" fn of_fwnode_add_links(fwnode: *mut fwnode_handle) -> c_int {
