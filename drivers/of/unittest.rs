...
pub const OF_KREF_READ(NODE): c_int = 1;
...
//
    ...
    printk(level pr_fmt("EXPECT_NOT / : ") fmt, ##__VA_ARGS__)
#[no_mangle]
unsafe extern "C" fn of_unittest_find_node_by_name() -> void __init {
...
// Test if trailing '/' works on aliases
    ...
    of_node_put(np);
    np = of_find_node_opts_by_path("/testcase-data:testoption", core::ptr::null_mut());
    unittest(np, "core::ptr::null_mut() option path test failed\n");
    of_node_put(np);
    ...
    of_node_put(np);
    kfree(name);
    np = of_find_node_opts_by_path("testcase-alias:testaliasoption", core::ptr::null_mut());
    unittest(np, "core::ptr::null_mut() option alias path test failed\n");
    of_node_put(np);
    options = "testoption";
...
#[no_mangle]
unsafe extern "C" fn of_unittest_dynamic() -> void __init {
...
// Adding very large property - should pass
    ...
    unittest(prop.value != core::ptr::null_mut(), "Unable to allocate large buffer\n");
    if (prop.value)
    unittest(of_add_property(np, prop) == 0,
    "Adding a large property should have passed\n");
    }
#[no_mangle]
unsafe extern "C" fn of_unittest_check_node_linkage(np: *mut device_node) -> int __init {
    static int __init of_unittest_check_node_linkage(struct device_node *np)
    {
    let mut count: c_int = 0, rc;
...
#[no_mangle]
unsafe extern "C" fn of_unittest_check_tree_linkage() -> void __init {
    static void __init of_unittest_check_tree_linkage(void)
    {
    struct device_node *np;
    let mut allnode_count: c_int = 0, child_count;
    if (!of_root)
    return;
...
#[no_mangle]
unsafe extern "C" fn of_unittest_printf() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_check_phandles() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_parse_phandle_with_args() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_parse_phandle_with_args_map() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_property_string() -> void __init {
...
// of_property_read_string_index() tests
    ...
    strings[0] = core::ptr::null_mut();
    rc = of_property_read_string_index(np, "string-property", 1, strings);
    unittest(rc == -ENODATA && strings[0] == core::ptr::null_mut(), "of_property_read_string_index() failure; rc=%i\n", rc);
    ...
    unittest(rc == -EILSEQ && strings[0] == core::ptr::null_mut(), "of_property_read_string_index() failure; rc=%i\n", rc);
    rc = of_property_read_string_index(np, "unterminated-string-list", 0, strings);
    unittest(rc == 0 && !strcmp(strings[0], "first"), "of_property_read_string_index() failure; rc=%i\n", rc);
    strings[0] = core::ptr::null_mut();
    rc = of_property_read_string_index(np, "unterminated-string-list", 2, strings); /* should fail */
    unittest(rc == -EILSEQ && strings[0] == core::ptr::null_mut(), "of_property_read_string_index() failure; rc=%i\n", rc);
    strings[1] = core::ptr::null_mut();
...
// -- parsing the correctly formed strings should still work:
    strings[2] = core::ptr::null_mut();
    rc = of_property_read_string_array(np, "unterminated-string-list", strings, 2);
    unittest(rc == 2 && strings[2] == core::ptr::null_mut(), "of_property_read_string_array() failure; rc=%i\n", rc);
    strings[1] = core::ptr::null_mut();
    rc = of_property_read_string_array(np, "phandle-list-names", strings, 1);
    unittest(rc == 1 && strings[1] == core::ptr::null_mut(), "Overwrote end of string array; rc=%i, str='%s'\n", rc, strings[1]);
// of_prop_next_string() tests
    prop = of_find_property(np, "phandle-list-names", core::ptr::null_mut());
    strings[0] = of_prop_next_string(prop, core::ptr::null_mut());
    ...
    strings[0] = of_prop_next_string(prop, strings[0]);
    unittest(!strings[0],
    "of_prop_next_string() should return core::ptr::null_mut() at end of list\n");
    prop = of_find_property(np, "unterminated-string", core::ptr::null_mut());
    strings[0] = of_prop_next_string(prop, core::ptr::null_mut());
    unittest(!strings[0],
    "of_prop_next_string() should reject unterminated first string\n");
    prop = of_find_property(np, "unterminated-string-list", core::ptr::null_mut());
    strings[0] = of_prop_next_string(prop, core::ptr::null_mut());
    unittest(strings[0] && !strcmp(strings[0], "first"),
    "of_prop_next_string() failure; got '%s'\n", strings[0]);
    strings[0] = of_prop_next_string(prop, strings[0]);
...
#[no_mangle]
unsafe extern "C" fn of_unittest_property_copy() -> void __init {
    static void __init of_unittest_property_copy(void)
    {

    let mut p1: property = { .name = "p1", .length = 0, .value = "" };
    let mut p2: property = { .name = "p2", .length = 5, .value = "abcd" };
    struct property *new;
...
#[no_mangle]
unsafe extern "C" fn of_unittest_changeset() -> void __init {
    ...
    const char *propstr = core::ptr::null_mut();
    n1 = __of_node_dup(core::ptr::null_mut(), "n1");
    unittest(n1, "testcase setup failure\n");
    n2 = __of_node_dup(core::ptr::null_mut(), "n2");
    unittest(n2, "testcase setup failure\n");
    n21 = __of_node_dup(core::ptr::null_mut(), "n21");
    ...
    n2.parent = parent;
    n21.parent = n2;
    ppremove = of_find_property(parent, "prop-remove", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn of_unittest_changeset_prop() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_dma_get_max_cpu_address() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_parse_dma_ranges() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_pci_dma_ranges() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_pci_empty_dma_ranges() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_bus_ranges() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_bus_3cell_ranges() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_reg() -> void __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct of_unittest_expected_res {
    pub index: c_int,
    pub res: resource,
}
...
#[no_mangle]
unsafe extern "C" fn of_unittest_translate_addr() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_parse_interrupts() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_parse_interrupts_extended() -> void __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct of_unittest_expected_imap_item {
    pub child_imap_count: u32,
    pub child_imap: [u32; 2],
    pub parent_path: *const c_char,
    pub parent_args_count: c_int,
    pub parent_args: [u32; 3],
}
...
#[no_mangle]
unsafe extern "C" fn of_unittest_parse_interrupt_map() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_irq_refcount() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_match_node() -> void __init {
    ...
    let mut test_bus_res: static struct resource = DEFINE_RES_MEM(0xfffffff8, 2);
    static const struct platform_device_info test_bus_info = {
    .name = "unittest-bus",
    };
#[no_mangle]
unsafe extern "C" fn of_unittest_platform_populate() -> void __init {
...
//
    ...
    of_platform_populate(np, match, core::ptr::null_mut(), &test_bus.dev);
...
//
    for (prop = np.properties; prop != core::ptr::null_mut(); prop = save_next) {
    save_next = prop.next;
...
//
#[no_mangle]
unsafe extern "C" fn attach_node_and_children(np: *mut device_node) {
...
//
#[no_mangle]
unsafe extern "C" fn unittest_data_add() -> int __init {
    static int __init unittest_data_add(void)
    {
    void *unittest_data_align;
    struct device_node *unittest_data_node = core::ptr::null_mut(), *np;
//
...
//
    ...
    let mut size: c_int = __dtbo_testcases_end - __dtbo_testcases_begin;
    int rc;
    void *ret;
    if (!size) {
...
// creating copy
    ...
    ret = of_fdt_unflatten_tree(unittest_data_align, core::ptr::null_mut(), &unittest_data_node);
    if (!ret) {
...
#[no_mangle]
unsafe extern "C" fn unittest_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unittest_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn of_path_platform_device_exists(path: *const c_char) -> c_int {
    static int of_path_platform_device_exists(const char *path)
    {
    struct platform_device *pdev;
    pdev = of_path_to_platform_device(path);
    platform_device_put(pdev);
    return pdev != core::ptr::null_mut();
    }

#[repr(C)]
#[derive(Copy, Clone)]
pub struct unittest_gpio_dev {
    pub chip: gpio_chip,
}
...
#[no_mangle]
unsafe extern "C" fn unittest_gpio_chip_request(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unittest_gpio_probe(pdev: *mut platform_device) -> c_int {
    ...
    ret = gpiochip_add_data(&devptr.chip, core::ptr::null_mut());
    unittest(!ret,
...
#[no_mangle]
unsafe extern "C" fn unittest_gpio_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_gpio() -> void __init {
...
//
    unittest(overlay_data_apply("overlay_gpio_01", core::ptr::null_mut()),
    "Adding overlay 'overlay_gpio_01' failed\n");
    unittest(overlay_data_apply("overlay_gpio_02a", core::ptr::null_mut()),
    "Adding overlay 'overlay_gpio_02a' failed\n");
    unittest(overlay_data_apply("overlay_gpio_02b", core::ptr::null_mut()),
...
//
    ...
    chip_request_count = unittest_gpio_chip_request_count;
// overlay_gpio_03 contains gpio node and child gpio hog node
    unittest(overlay_data_apply("overlay_gpio_03", core::ptr::null_mut()),
...
//
    ...
    chip_request_count = unittest_gpio_chip_request_count;
// overlay_gpio_04a contains gpio node
    unittest(overlay_data_apply("overlay_gpio_04a", core::ptr::null_mut()),
...
//
// overlay_gpio_04b contains child gpio hog node
    unittest(overlay_data_apply("overlay_gpio_04b", core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn of_path_i2c_client_exists(path: *const c_char) -> c_int {
    ...
    return client != core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn of_unittest_device_exists(unittest_nr: c_int, ovtype: enum overlay_type) -> c_int {
...
pub const MAX_TRACK_OVCS_IDS: c_int = 256;
...
#[no_mangle]
unsafe extern "C" fn of_unittest_track_overlay(ovcs_id: c_int, overlay_nr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_untrack_overlay(ovcs_id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_remove_tracked_overlays() {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_apply_overlay(overlay_nr: c_int, ovcs_id: *mut c_int) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_0() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_1() -> void __init {
...
// test activation of device
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_2() -> void __init {
...
// test deactivation of device
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_3() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_4() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_5() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_6() -> void __init {
    static void __init of_unittest_overlay_6(void)
    {
    int i, save_ovcs_id[2], ovcs_id;
    let mut overlay_nr: c_int = 6, unittest_nr = 6;
    let mut before: c_int = 0, after = 1;
    const char *overlay_name;
    int ret;
// unittest device must be in before state
    for (i = 0; i < 2; i++) {
...
// test overlay application in sequence
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_8() -> void __init {
    static void __init of_unittest_overlay_8(void)
    {
    int i, save_ovcs_id[2], ovcs_id;
    let mut overlay_nr: c_int = 8, unittest_nr = 8;
    const char *overlay_name;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_10() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_11() -> void __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct unittest_i2c_bus_data {
...
#[no_mangle]
unsafe extern "C" fn unittest_i2c_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn unittest_i2c_bus_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unittest_i2c_bus_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn unittest_i2c_dev_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unittest_i2c_dev_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn unittest_i2c_mux_select_chan(muxc: *mut i2c_mux_core, chan: u32) -> c_int {
    static int unittest_i2c_mux_select_chan(struct i2c_mux_core *muxc, u32 chan)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn unittest_i2c_mux_probe(client: *mut i2c_client) -> c_int {
    ...
    unittest_i2c_mux_select_chan, core::ptr::null_mut());
    if (!muxc)
    return -ENOMEM;
    for (i = 0; i < nchans; i++) {
...
#[no_mangle]
unsafe extern "C" fn unittest_i2c_mux_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_i2c_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_i2c_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_i2c_12() -> void __init {
...
// test deactivation of device
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_i2c_13() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_i2c_14() {
    static void of_unittest_overlay_i2c_14(void)
    {
    }
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_i2c_15() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_notify() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay() -> void __init {
    static void __init of_unittest_overlay(void)
    {
    struct device_node *bus_np = core::ptr::null_mut();
    unsigned int i;
    ...
    if (bus_np == core::ptr::null_mut()) {
    unittest(0, "could not find bus_path \"%s\"\n", bus_path);
    goto out;
    }
    if (of_platform_default_populate(bus_np, core::ptr::null_mut(), core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_lifecycle() -> void __init {
    static void __init of_unittest_lifecycle(void)
    {

    unsigned int refcount;
    let mut found_refcount_one: c_int = 0;
    let mut put_count: c_int = 0;
    struct device_node *np;
...
pub struct overlay_info {
    pub dtbo_begin: *mut u8,
    pub dtbo_end: *mut u8,
    pub expected_result: c_int,
    pub /: *mut *mut int expected_result_remove; / if apply failed,
    pub ovcs_id: c_int,
    pub name: *mut c_char,
}
...
#[no_mangle]
unsafe extern "C" fn dt_alloc_memory(size: u64, align: u64) -> *mut void  __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn unittest_unflatten_overlay_base() -> void __init {
    ...
    __unflatten_device_tree(new_fdt, core::ptr::null_mut(), &overlay_base_root,
...
//
#[no_mangle]
unsafe extern "C" fn overlay_data_apply(overlay_name: *const c_char, ovcs_id: *mut c_int) -> int __init {
    static int __init overlay_data_apply(const char *overlay_name, int *ovcs_id)
    {
    struct overlay_info *info;
    let mut passed: c_int = 1;
    let mut found: c_int = 0;
    int ret, ret2;
    u32 size;
    for (info = overlays; info && info.name; info++) {
...
//
#[no_mangle]
unsafe extern "C" fn of_unittest_overlay_high_level() -> __init void {
...
// ---  overlay  ---
    ...
    ret = overlay_data_apply("overlay", core::ptr::null_mut());
    EXPECT_END(KERN_ERR,
    "OF: overlay: WARNING: memory leak will occur if overlay removed, property: /__symbols__/ride_200_right");
    EXPECT_END(KERN_ERR,
    "OF: overlay: WARNING: memory leak will occur if overlay removed, property: /__symbols__/ride_200_left");
...
// ---  overlay_bad_add_dup_node  ---
    ...
    unittest(overlay_data_apply("overlay_bad_add_dup_node", core::ptr::null_mut()),
...
// ---  overlay_bad_add_dup_prop  ---
    ...
    EXPECT_BEGIN(KERN_ERR,
    "OF: Error reverting changeset (-19)");
    unittest(overlay_data_apply("overlay_bad_add_dup_prop", core::ptr::null_mut()),
    ...
    "OF: overlay: ERROR: multiple fragments add and/or delete node /testcase-data-2/substation@100/motor-1/electric");
// ---  overlay_bad_phandle  ---
    unittest(overlay_data_apply("overlay_bad_phandle", core::ptr::null_mut()),
...
// ---  overlay_bad_symbol  ---
    ...
    EXPECT_BEGIN(KERN_ERR,
    "OF: Error reverting changeset (-19)");
    unittest(overlay_data_apply("overlay_bad_symbol", core::ptr::null_mut()),
...
// ---  overlay_bad_unresolved  ---
    ...
    unittest(overlay_data_apply("overlay_bad_unresolved", core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn testdrv_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    ...
    if (ret)
    return ret;
    of_platform_default_populate(dn, core::ptr::null_mut(), &pdev.dev);
    pci_set_drvdata(pdev, (void *)(uintptr_t)ovcs_id);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn testdrv_remove(pdev: *mut pci_dev) {
    static void testdrv_remove(struct pci_dev *pdev)
    {
    let mut ovcs_id: c_int = (int)(uintptr_t)pci_get_drvdata(pdev);
...
#[no_mangle]
unsafe extern "C" fn unittest_pci_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_unittest_pci_node_verify(pdev: *mut pci_dev, add: bool) -> c_int {
    static int of_unittest_pci_node_verify(struct pci_dev *pdev, bool add)
    {
    struct device_node *pnp, *np = core::ptr::null_mut();
    ...
    reg = of_get_property(np, "reg", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn of_unittest_pci_node() -> void __init {
    ...
    while ((pdev = pci_get_device(PCI_VENDOR_ID_REDHAT, 0x5, pdev)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn of_unittest() -> int __init {
