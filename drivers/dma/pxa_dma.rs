...
pub const DALGN(n): c_uint = 0x00a0;
...
pub const PXA_DCMD_LENGTH: c_uint = 0x01fff		/* length mask (max = 8K - 1) */;
pub const PDMA_ALIGNMENT: c_int = 3;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pxad_desc_hw {
...
pub struct pxad_desc_sw {
    pub /: *mut *mut virt_dma_desc vd; / Virtual descriptor,
    pub /: *mut *mut int nb_desc; / Number of hw. descriptors,
    pub /: *mut *mut size_t len; / Number of bytes xfered,
    pub /: *mut *mut dma_addr_t first; / First descriptor's addr,
// At least one descriptor has an src/dst address not multiple of 8
    pub misaligned: bool,
    pub cyclic: bool,
    pub /: *mut *mut *mut dma_pool desc_pool; / Channel's used allocator,
    pub __counted_by(nb_desc): *mut *mut pxad_desc_hw hw_desc[],
...
pub struct pxad_phy {
    ...
    pub vchan: *mut pxad_chan,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pxad_chan {
    pub /: *mut *mut virt_dma_chan vc; / Virtual channel,
    pub /: *mut *mut u32 drcmr; / Requestor of the channel,
    pub /: *mut *mut enum pxad_chan_prio prio; / Required priority of phy,
//
...
//
    pub misaligned: bool,
    pub /: *mut *mut dma_slave_config cfg; / Runtime config,
// protected by vc->lock
    pub phy: *mut pxad_phy,
    pub /: *mut *mut *mut dma_pool desc_pool; / Descriptors pool,
    pub bus_error: dma_cookie_t,
    pub wq_state: wait_queue_head_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pxad_device {
    pub slave: dma_device,
    pub nr_chans: c_int,
    pub nr_requestors: c_int,
    pub base: *mut void __iomem,
    pub phys: *mut pxad_phy,
    pub /: *mut *mut spinlock_t phy_lock; / Phy association,

    pub dbgfs_root: *mut dentry,
    pub dbgfs_chan: *mut dentry,
...
#[no_mangle]
unsafe extern "C" fn pxad_drcmr(line: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn requester_chan_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dbg_burst_from_dcmd(dcmd: u32) -> c_int {
    static inline int dbg_burst_from_dcmd(u32 dcmd)
    {
    let mut burst: c_int = (dcmd >> 16) & 0x3;
    return burst ? 4 << burst : 0;
    }
#[no_mangle]
unsafe extern "C" fn is_phys_valid(addr: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn descriptors_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chan_state_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn state_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxad_init_debugfs(pdev: *mut pxad_device) {
    ...
    if (!pdev.dbgfs_chan)
    return;
    pdev.dbgfs_root = debugfs_create_dir(dev_name(pdev.slave.dev), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn pxad_cleanup_debugfs(pdev: *mut pxad_device) {
    ...
    struct pxad_phy *phy, *found = core::ptr::null_mut();
    unsigned long flags;
//
...
#[no_mangle]
unsafe extern "C" fn pxad_free_phy(chan: *mut pxad_chan) {
...
// clear the channel mapping in DRCMR
    ...
    spin_lock_irqsave(&pdev.phy_lock, flags);
    chan.phy.vchan = core::ptr::null_mut();
    chan.phy = core::ptr::null_mut();
    spin_unlock_irqrestore(&pdev.phy_lock, flags);
    }
#[no_mangle]
unsafe extern "C" fn is_chan_running(chan: *mut pxad_chan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_running_chan_misaligned(chan: *mut pxad_chan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn phy_enable(phy: *mut pxad_phy, misaligned: bool) {
...
#[no_mangle]
unsafe extern "C" fn phy_disable(phy: *mut pxad_phy) {
...
//
    ...
    let mut dma: dma_addr_t = sw_desc.hw_desc[sw_desc.nb_desc - 2].ddadr;
...
#[no_mangle]
unsafe extern "C" fn is_desc_completed(vd: *mut virt_dma_desc) -> bool {
    ...
    {
    struct virt_dma_desc *vd_last_issued = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn clear_chan_irq(phy: *mut pxad_phy) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn pxad_chan_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    unsigned int dcsr;
    bool vd_completed;
    let mut last_started: dma_cookie_t = 0;
    BUG_ON(!chan);
...
#[no_mangle]
unsafe extern "C" fn pxad_int_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pxad_alloc_chan_resources(dchan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxad_free_chan_resources(dchan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn pxad_free_desc(vd: *mut virt_dma_desc) {
...
#[no_mangle]
unsafe extern "C" fn pxad_tx_submit(tx: *mut dma_async_tx_descriptor) -> dma_cookie_t {
    static dma_cookie_t pxad_tx_submit(struct dma_async_tx_descriptor *tx)
    {
    struct virt_dma_chan *vc = to_virt_chan(tx.chan);
    struct pxad_chan *chan = to_pxad_chan(&vc.chan);
    struct virt_dma_desc *vd_chained = core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn pxad_issue_pending(dchan: *mut dma_chan) {
    ...
    {
    let mut maxburst: u32 = 0, dev_addr = 0;
...
// dcmd |= PXA_DCMD_BURST32;
    ...
    len, flags);
    pxad_get_config(chan, DMA_MEM_TO_MEM, &dcmd, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn pxad_terminate_all(dchan: *mut dma_chan) -> c_int {
    ...
    {
    struct virt_dma_desc *vd = core::ptr::null_mut();
    struct pxad_desc_sw *sw_desc = core::ptr::null_mut();
    struct pxad_desc_hw *hw_desc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pxad_synchronize(dchan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn pxad_free_channels(dmadev: *mut dma_device) {
...
#[no_mangle]
unsafe extern "C" fn pxad_remove(op: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn pxad_probe(op: *mut platform_device) -> c_int {
    static int pxad_probe(struct platform_device *op)
    {
    struct pxad_device *pdev;
    const struct dma_slave_map *slave_map = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pxad_filter_fn(chan: *mut dma_chan, param: *mut c_void) -> bool {
    static bool pxad_filter_fn(struct dma_chan *chan, void *param)
    {
