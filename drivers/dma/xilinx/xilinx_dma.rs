...
//! Source: drivers/dma/xilinx/xilinx_dma.c
#![no_std]
...
pub const XILINX_DMA_MM2S_CTRL_OFFSET: c_uint = 0x0000;
pub const XILINX_DMA_S2MM_CTRL_OFFSET: c_uint = 0x0030;
pub const XILINX_VDMA_MM2S_DESC_OFFSET: c_uint = 0x0050;
pub const XILINX_VDMA_S2MM_DESC_OFFSET: c_uint = 0x00a0;
// Control Registers
pub const XILINX_DMA_REG_DMACR: c_uint = 0x0000;
pub const XILINX_DMA_DMACR_DELAY_MAX: c_uint = 0xff;
pub const XILINX_DMA_DMACR_DELAY_SHIFT: c_int = 24;
pub const XILINX_DMA_DMACR_FRAME_COUNT_MAX: c_uint = 0xff;
pub const XILINX_DMA_DMACR_FRAME_COUNT_SHIFT: c_int = 16;

pub const XILINX_DMA_DMACR_MASTER_SHIFT: c_int = 8;
pub const XILINX_DMA_DMACR_FSYNCSRC_SHIFT: c_int = 5;

pub const XILINX_DMA_REG_DMASR: c_uint = 0x0004;

pub const XILINX_DMA_REG_CURDESC: c_uint = 0x0008;
pub const XILINX_DMA_REG_TAILDESC: c_uint = 0x0010;
pub const XILINX_DMA_REG_REG_INDEX: c_uint = 0x0014;
pub const XILINX_DMA_REG_FRMSTORE: c_uint = 0x0018;
pub const XILINX_DMA_REG_THRESHOLD: c_uint = 0x001c;
pub const XILINX_DMA_REG_FRMPTR_STS: c_uint = 0x0024;
pub const XILINX_DMA_REG_PARK_PTR: c_uint = 0x0028;
pub const XILINX_DMA_PARK_PTR_WR_REF_SHIFT: c_int = 8;

pub const XILINX_DMA_PARK_PTR_RD_REF_SHIFT: c_int = 0;

pub const XILINX_DMA_REG_VDMA_VERSION: c_uint = 0x002c;
// Register Direct Mode Registers
pub const XILINX_DMA_REG_VSIZE: c_uint = 0x0000;

pub const XILINX_DMA_REG_HSIZE: c_uint = 0x0004;

pub const XILINX_DMA_REG_FRMDLY_STRIDE: c_uint = 0x0008;
pub const XILINX_DMA_FRMDLY_STRIDE_FRMDLY_SHIFT: c_int = 24;
pub const XILINX_DMA_FRMDLY_STRIDE_STRIDE_SHIFT: c_int = 0;

pub const XILINX_VDMA_REG_ENABLE_VERTICAL_FLIP: c_uint = 0x00ec;

// HW specific definitions
pub const XILINX_MCDMA_MAX_CHANS_PER_DEVICE: c_uint = 0x20;
pub const XILINX_DMA_MAX_CHANS_PER_DEVICE: c_uint = 0x2;
pub const XILINX_CDMA_MAX_CHANS_PER_DEVICE: c_uint = 0x1;
pub const XILINX_DMA_DFAULT_ADDRWIDTH: c_uint = 0x20;
...
pub const XILINX_DMA_FLUSH_S2MM: c_int = 3;
pub const XILINX_DMA_FLUSH_MM2S: c_int = 2;
pub const XILINX_DMA_FLUSH_BOTH: c_int = 1;
// Timeout for polling various registers
pub const XILINX_DMA_POLL_TIMEOUT_US: c_int = 1000000;
// Delay between polls (avoid a delay of 0 to prevent CPU stalls)
pub const XILINX_DMA_POLL_DELAY_US: c_int = 10;
// AXI DMA Specific Registers/Offsets
pub const XILINX_DMA_REG_SRCDSTADDR: c_uint = 0x18;
pub const XILINX_DMA_REG_BTT: c_uint = 0x28;
// AXI DMA Specific Masks/Bit fields
pub const XILINX_DMA_MAX_TRANS_LEN_MIN: c_int = 8;
pub const XILINX_DMA_MAX_TRANS_LEN_MAX: c_int = 23;
pub const XILINX_DMA_V2_MAX_TRANS_LEN_MAX: c_int = 26;

pub const XILINX_DMA_CR_COALESCE_SHIFT: c_int = 16;
pub const XILINX_DMA_CR_DELAY_SHIFT: c_int = 24;

pub const XILINX_DMA_COALESCE_MAX: c_int = 255;
pub const XILINX_DMA_NUM_DESCS: c_int = 512;
pub const XILINX_DMA_NUM_APP_WORDS: c_int = 5;
// AXI CDMA Specific Registers/Offsets
pub const XILINX_CDMA_REG_SRCADDR: c_uint = 0x18;
pub const XILINX_CDMA_REG_DSTADDR: c_uint = 0x20;
// AXI CDMA Specific Masks

    ((dma_addr_t)((u64)addr##_##msb << 32 | (addr)))
// AXI MCDMA Specific Registers/Offsets
pub const XILINX_MCDMA_MM2S_CTRL_OFFSET: c_uint = 0x0000;
pub const XILINX_MCDMA_S2MM_CTRL_OFFSET: c_uint = 0x0500;
pub const XILINX_MCDMA_CHEN_OFFSET: c_uint = 0x0008;
pub const XILINX_MCDMA_CH_ERR_OFFSET: c_uint = 0x0010;
pub const XILINX_MCDMA_RXINT_SER_OFFSET: c_uint = 0x0020;
pub const XILINX_MCDMA_TXINT_SER_OFFSET: c_uint = 0x0028;

// AXI MCDMA Specific Masks/Shifts
pub const XILINX_MCDMA_COALESCE_SHIFT: c_int = 16;
pub const XILINX_MCDMA_COALESCE_MAX: c_int = 24;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_vdma_desc_hw {
    pub next_desc: u32,
    pub pad1: u32,
    pub buf_addr: u32,
    pub buf_addr_msb: u32,
    pub vsize: u32,
    pub hsize: u32,
    pub stride: u32,
    pub __aligned(64): },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_axidma_desc_hw {
    pub next_desc: u32,
    pub next_desc_msb: u32,
    pub buf_addr: u32,
    pub buf_addr_msb: u32,
    pub reserved1: u32,
    pub reserved2: u32,
    pub control: u32,
    pub status: u32,
    pub app: [u32; XILINX_DMA_NUM_APP_WORDS],
    pub __aligned(64): },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_aximcdma_desc_hw {
    pub next_desc: u32,
    pub next_desc_msb: u32,
    pub buf_addr: u32,
    pub buf_addr_msb: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_cdma_desc_hw {
    pub next_desc: u32,
    pub next_desc_msb: u32,
    pub src_addr: u32,
    pub src_addr_msb: u32,
    pub dest_addr: u32,
    pub dest_addr_msb: u32,
    pub control: u32,
    pub status: u32,
    pub __aligned(64): },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_vdma_tx_segment {
    pub hw: xilinx_vdma_desc_hw,
    pub node: list_head,
    pub phys: dma_addr_t,
    pub __aligned(64): },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_axidma_tx_segment {
    pub hw: xilinx_axidma_desc_hw,
    pub node: list_head,
    pub phys: dma_addr_t,
    pub __aligned(64): },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_aximcdma_tx_segment {
    pub hw: xilinx_aximcdma_desc_hw,
    pub node: list_head,
    pub phys: dma_addr_t,
    pub __aligned(64): },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_cdma_tx_segment {
    pub hw: xilinx_cdma_desc_hw,
    pub node: list_head,
    pub phys: dma_addr_t,
    pub __aligned(64): },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_dma_tx_descriptor {
    pub async_tx: dma_async_tx_descriptor,
    pub segments: list_head,
    pub node: list_head,
    pub cyclic: bool,
    pub err: bool,
    pub residue: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_dma_chan {
    pub xdev: *mut xilinx_dma_device,
    pub ctrl_offset: u32,
    pub desc_offset: u32,
    pub lock: spinlock_t,
    ...
    pub config: xilinx_vdma_config,
    pub flush_on_fsync: bool,
    pub desc_pendingcount: u32,
    pub ext_addr: bool,
    pub desc_submitcount: u32,
    pub seg_v: *mut xilinx_axidma_tx_segment,
    pub seg_mv: *mut xilinx_aximcdma_tx_segment,
    pub seg_p: dma_addr_t,
    pub cyclic_seg_v: *mut xilinx_axidma_tx_segment,
    pub cyclic_seg_p: dma_addr_t,
    pub chan): *mut *mut void (start_transfer)(struct xilinx_dma_chan,
    pub chan): *mut *mut int (stop_transfer)(struct xilinx_dma_chan,
    pub tdest: u16,
    pub has_vflip: bool,
    pub irq_delay: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_dma_config {
    pub dmatype: enum xdma_ip_type,
    int (*clk_init)(struct platform_device *pdev, struct clk **axi_clk,
    struct clk **tx_clk, struct clk **txs_clk,
    pub rxs_clk): *mut *mut *mut clk rx_clk, clk,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_dma_device {
    pub regs: *mut void __iomem,
    pub dev: *mut device,
    pub common: dma_device,
    pub chan: [*mut xilinx_dma_chan; XILINX_MCDMA_MAX_CHANS_PER_DEVICE],
    pub flush_on_fsync: u32,
    pub ext_addr: bool,
    pub pdev: *mut platform_device,
    pub dma_config: *const xilinx_dma_config,
    pub axi_clk: *mut clk,
    pub tx_clk: *mut clk,
    pub txs_clk: *mut clk,
    pub rx_clk: *mut clk,
    pub rxs_clk: *mut clk,
    pub s2mm_chan_id: u32,
    pub mm2s_chan_id: u32,
    pub max_buffer_len: u32,
    pub has_axistream_connected: bool,
}
...
// IO accessors
#[no_mangle]
pub unsafe extern "C" fn dma_read(chan: *mut xilinx_dma_chan, reg: u32) -> u32 {
    static inline u32 dma_read(struct xilinx_dma_chan *chan, u32 reg)
    {
    return ioread32(chan.xdev.regs + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn dma_write(chan: *mut xilinx_dma_chan, reg: u32, value: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn dma_ctrl_read(chan: *mut xilinx_dma_chan, reg: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn dma_writeq(chan: *mut xilinx_dma_chan, reg: u32, value: u64) {
...
//
    ...
    {
    struct xilinx_axidma_tx_segment *segment = core::ptr::null_mut();
    unsigned long flags;
...
//
    ...
    {
    struct xilinx_aximcdma_tx_segment *segment = core::ptr::null_mut();
    unsigned long flags;
    spin_lock_irqsave(&chan.lock, flags);
    if (!list_empty(&chan.free_seg_list)) {
    segment = list_first_entry(&chan.free_seg_list,
...
#[no_mangle]
unsafe extern "C" fn xilinx_dma_clean_hw_desc(hw: *mut xilinx_axidma_desc_hw) {
    static void xilinx_dma_clean_hw_desc(struct xilinx_axidma_desc_hw *hw)
    {
    let mut next_desc: u32 = hw.next_desc;
    let mut next_desc_msb: u32 = hw.next_desc_msb;
    memset(hw, 0, sizeof(struct xilinx_axidma_desc_hw));
    hw.next_desc = next_desc;
    hw.next_desc_msb = next_desc_msb;
    }
#[no_mangle]
unsafe extern "C" fn xilinx_mcdma_clean_hw_desc(hw: *mut xilinx_aximcdma_desc_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_free_descriptors(chan: *mut xilinx_dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_free_chan_resources(dchan: *mut dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_chan_desc_cleanup(chan: *mut xilinx_dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_do_tasklet(t: *mut tasklet_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_alloc_chan_resources(dchan: *mut dma_chan) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_stop_transfer(chan: *mut xilinx_dma_chan) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_cdma_stop_transfer(chan: *mut xilinx_dma_chan) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_start(chan: *mut xilinx_dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_vdma_start_transfer(chan: *mut xilinx_dma_chan) {
    static void xilinx_vdma_start_transfer(struct xilinx_dma_chan *chan)
    {
    struct xilinx_vdma_config *config = &chan.config;
    struct xilinx_dma_tx_descriptor *desc;
    u32 reg, j;
    struct xilinx_vdma_tx_segment *segment, *last = core::ptr::null_mut();
    let mut i: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_cdma_start_transfer(chan: *mut xilinx_dma_chan) {
    static void xilinx_cdma_start_transfer(struct xilinx_dma_chan *chan)
    {
    struct xilinx_dma_tx_descriptor *head_desc, *tail_desc;
    struct xilinx_cdma_tx_segment *tail_segment;
    let mut ctrl_reg: u32 = dma_read(chan, XILINX_DMA_REG_DMACR);
    if (chan.err)
    return;
    if (!chan.idle)
    return;
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_start_transfer(chan: *mut xilinx_dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_mcdma_start_transfer(chan: *mut xilinx_dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_issue_pending(dchan: *mut dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_complete_descriptor(chan: *mut xilinx_dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_reset(chan: *mut xilinx_dma_chan) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_chan_reset(chan: *mut xilinx_dma_chan) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_mcdma_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
    let mut errors: u32 = status & XILINX_DMA_DMASR_ALL_ERR_MASK;
    dma_ctrl_write(chan, XILINX_DMA_REG_DMASR,
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_tx_submit(tx: *mut dma_async_tx_descriptor) -> dma_cookie_t {
...
//
    ...
    struct xilinx_dma_chan *chan = to_xilinx_chan(dchan);
    struct xilinx_dma_tx_descriptor *desc;
    struct xilinx_axidma_tx_segment *segment, *head, *prev = core::ptr::null_mut();
    size_t copy;
    size_t sg_used;
    unsigned int i;
...
//
    ...
    struct xilinx_dma_chan *chan = to_xilinx_chan(dchan);
    struct xilinx_dma_tx_descriptor *desc;
    struct xilinx_axidma_tx_segment *segment, *head_segment, *prev = core::ptr::null_mut();
    size_t copy, sg_used;
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_terminate_all(dchan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xilinx_dma_synchronize(dchan: *mut dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_chan_remove(chan: *mut xilinx_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn xdma_disable_allclks(xdev: *mut xilinx_dma_device) {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(XDMA_TYPE_CDMA: xdev->dma_config->dmatype ==) -> else {
    else if (xdev.dma_config.dmatype == XDMA_TYPE_CDMA)
    dev_info(&pdev.dev, "Xilinx AXI CDMA Engine Driver Probed!!\n");
#[no_mangle]
pub unsafe extern "C" fn if(XDMA_TYPE_AXIMCDMA: xdev->dma_config->dmatype ==) -> else {
    else if (xdev.dma_config.dmatype == XDMA_TYPE_AXIMCDMA)
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_dma_remove(pdev: *mut platform_device) {
