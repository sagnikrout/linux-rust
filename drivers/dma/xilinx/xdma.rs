...
//! Source: drivers/dma/xilinx/xdma.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xdma_chan {
    pub vchan: virt_dma_chan,
    pub xdev_hdl: *mut c_void,
    pub base: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xdma_desc {
    pub vdesc: virt_dma_desc,
    pub chan: *mut xdma_chan,
    pub dir: enum dma_transfer_direction,
    pub desc_blocks: *mut xdma_desc_block,
    pub dblk_num: u32,
    pub desc_num: u32,
    pub completed_desc_num: u32,
    pub cyclic: bool,
    pub interleaved_dma: bool,
    pub periods: u32,
    pub period_size: u32,
    pub frames_left: u32,
    pub error: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xdma_device {
    pub pdev: *mut platform_device,
    pub dma_dev: dma_device,
    pub rmap: *mut regmap,
    pub h2c_chans: *mut xdma_chan,
    pub c2h_chans: *mut xdma_chan,
    pub h2c_chan_num: u32,
    pub c2h_chan_num: u32,
    pub irq_start: u32,
    pub irq_num: u32,
    pub status: u32,
}
...
//
#[no_mangle]
unsafe extern "C" fn xdma_link_sg_desc_blocks(sw_desc: *mut xdma_desc) {
...
//
#[no_mangle]
unsafe extern "C" fn xdma_link_cyclic_desc_blocks(sw_desc: *mut xdma_desc) {
...
//
#[no_mangle]
unsafe extern "C" fn xdma_channel_init(chan: *mut xdma_chan) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xdma_free_desc(vdesc: *mut virt_dma_desc) {
...
//
#[no_mangle]
unsafe extern "C" fn xdma_xfer_start(xchan: *mut xdma_chan) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xdma_xfer_stop(xchan: *mut xdma_chan) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xdma_issue_pending(chan: *mut dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn xdma_terminate_all(chan: *mut dma_chan) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xdma_synchronize(chan: *mut dma_chan) {
...
//
    ...
    {
    let mut left: u32 = size, len, desc_num = filled_descs_num;
...
//
    ...
    struct xdma_chan *xdma_chan = to_xdma_chan(chan);
    struct xdma_device *xdev = xdma_chan.xdev_hdl;
    let mut periods: c_uint = size / period_size;
    struct dma_async_tx_descriptor *tx_desc;
    struct xdma_desc *sw_desc;
    u64 addr, dev_addr, *src, *dst;
    u32 desc_num;
...
//
    ...
    {
    int i;
    let mut desc_num: u32 = 0, period_size = 0;
    struct dma_async_tx_descriptor *tx_desc;
...
//
#[no_mangle]
unsafe extern "C" fn xdma_free_chan_resources(chan: *mut dma_chan) {
    ...
    xdma_chan.desc_pool = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn xdma_alloc_chan_resources(chan: *mut dma_chan) -> c_int {
    ...
    {
    struct xdma_chan *xdma_chan = to_xdma_chan(chan);
    struct xdma_desc *desc = core::ptr::null_mut();
    struct virt_dma_desc *vd;
    enum dma_status ret;
    unsigned long flags;
...
//
#[no_mangle]
unsafe extern "C" fn xdma_channel_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t xdma_channel_isr(int irq, void *dev_id)
    {
    struct xdma_chan *xchan = dev_id;
    let mut complete_desc_num: u32 = 0;
    struct xdma_device *xdev = xchan.xdev_hdl;
...
//
#[no_mangle]
unsafe extern "C" fn xdma_irq_fini(xdev: *mut xdma_device) {
...
//
#[no_mangle]
unsafe extern "C" fn xdma_irq_init(xdev: *mut xdma_device) -> c_int {
    static int xdma_irq_init(struct xdma_device *xdev)
    {
    let mut irq: u32 = xdev.irq_start;
    u32 user_irq_start;
    int i, j, ret;
...
#[no_mangle]
unsafe extern "C" fn xdma_filter_fn(chan: *mut dma_chan, param: *mut c_void) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn xdma_disable_user_irq(pdev: *mut platform_device, irq_num: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xdma_enable_user_irq(pdev: *mut platform_device, irq_num: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn xdma_get_user_irq(pdev: *mut platform_device, user_irq_index: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xdma_remove(pdev: *mut platform_device) {
...
//
#[no_mangle]
unsafe extern "C" fn xdma_probe(pdev: *mut platform_device) -> c_int {
