...
pub const FSL_QDMA_DMR: c_uint = 0x0;
pub const FSL_QDMA_DSR: c_uint = 0x4;
pub const FSL_QDMA_DEIER: c_uint = 0xe00;
pub const FSL_QDMA_DEDR: c_uint = 0xe04;
pub const FSL_QDMA_DECFDW0R: c_uint = 0xe10;
pub const FSL_QDMA_DECFDW1R: c_uint = 0xe14;
pub const FSL_QDMA_DECFDW2R: c_uint = 0xe18;
pub const FSL_QDMA_DECFDW3R: c_uint = 0xe1c;
pub const FSL_QDMA_DECFQIDR: c_uint = 0xe30;
pub const FSL_QDMA_DECBR: c_uint = 0xe34;

pub const FSL_QDMA_SQDPAR: c_uint = 0x80c;
pub const FSL_QDMA_SQEPAR: c_uint = 0x814;
pub const FSL_QDMA_BSQMR: c_uint = 0x800;
pub const FSL_QDMA_BSQSR: c_uint = 0x804;
pub const FSL_QDMA_BSQICR: c_uint = 0x828;
pub const FSL_QDMA_CQMR: c_uint = 0xa00;
pub const FSL_QDMA_CQDSCR1: c_uint = 0xa08;
pub const FSL_QDMA_CQDSCR2: c_uint = 0xa0c;
pub const FSL_QDMA_CQIER: c_uint = 0xa10;
pub const FSL_QDMA_CQEDR: c_uint = 0xa14;
pub const FSL_QDMA_SQCCMR: c_uint = 0xa20;
// Registers for bit and genmask

// Size related definition
pub const FSL_QDMA_QUEUE_MAX: c_int = 8;
pub const FSL_QDMA_COMMAND_BUFFER_SIZE: c_int = 64;
pub const FSL_QDMA_DESCRIPTOR_BUFFER_SIZE: c_int = 32;
pub const FSL_QDMA_CIRCULAR_DESC_SIZE_MIN: c_int = 64;
pub const FSL_QDMA_CIRCULAR_DESC_SIZE_MAX: c_int = 16384;
pub const FSL_QDMA_QUEUE_NUM_MAX: c_int = 8;
// Field definition for CMD
pub const FSL_QDMA_CMD_RWTTYPE: c_uint = 0x4;
pub const FSL_QDMA_CMD_LWC: c_uint = 0x2;
pub const FSL_QDMA_CMD_RWTTYPE_OFFSET: c_int = 28;
pub const FSL_QDMA_CMD_NS_OFFSET: c_int = 27;
pub const FSL_QDMA_CMD_DQOS_OFFSET: c_int = 24;
pub const FSL_QDMA_CMD_WTHROTL_OFFSET: c_int = 20;
pub const FSL_QDMA_CMD_DSEN_OFFSET: c_int = 19;
pub const FSL_QDMA_CMD_LWC_OFFSET: c_int = 16;
...
pub const QDMA_CCDF_OFFSET: c_int = 20;

// Field definition for safe loop count
pub const FSL_QDMA_HALT_COUNT: c_int = 1500;
pub const FSL_QDMA_MAX_SIZE: c_int = 16385;
pub const FSL_QDMA_COMP_TIMEOUT: c_int = 1000;
pub const FSL_COMMAND_QUEUE_OVERFLLOW: c_int = 10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_qdma_chan {
    pub vchan: virt_dma_chan,
    pub vdesc: virt_dma_desc,
    pub status: enum dma_status,
    pub qdma: *mut fsl_qdma_engine,
    pub queue: *mut fsl_qdma_queue,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_qdma_queue {
    pub virt_head: *mut fsl_qdma_format,
    pub virt_tail: *mut fsl_qdma_format,
    pub comp_used: list_head,
    pub comp_free: list_head,
    pub comp_pool: *mut dma_pool,
    pub desc_pool: *mut dma_pool,
    pub queue_lock: spinlock_t,
    pub bus_addr: dma_addr_t,
    pub n_cq: u32,
    pub id: u32,
    pub cq: *mut fsl_qdma_format,
    pub block_base: *mut void __iomem,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_qdma_comp {
    pub bus_addr: dma_addr_t,
    pub desc_bus_addr: dma_addr_t,
    pub virt_addr: *mut fsl_qdma_format,
    pub desc_virt_addr: *mut fsl_qdma_format,
    pub qchan: *mut fsl_qdma_chan,
    pub vdesc: virt_dma_desc,
    pub list: list_head,
}
...
pub struct fsl_qdma_engine {
    ...
    pub n_chans: u32,
    pub n_queues: u32,
    pub fsl_qdma_mutex: mutex,
    pub error_irq: c_int,
    pub queue_irq: *mut c_int,
    pub feature: u32,
    pub queue: *mut fsl_qdma_queue,
    pub status: *mut fsl_qdma_queue,
    pub chans: *mut fsl_qdma_chan,
    pub block_number: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn qdma_csgf_set_len(csgf: *mut fsl_qdma_format, len: c_int) {
    static inline void qdma_csgf_set_len(struct fsl_qdma_format *csgf, int len)
    {
    csgf.cfg = cpu_to_le32(len & QDMA_SG_LEN_MASK);
    }
#[no_mangle]
pub unsafe extern "C" fn qdma_csgf_set_f(csgf: *mut fsl_qdma_format, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qdma_readl(qdma: *mut fsl_qdma_engine, addr: *mut void __iomem) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fsl_qdma_free_chan_resources(chan: *mut dma_chan) {
    ...
    fsl_queue.comp_pool = core::ptr::null_mut();
    fsl_queue.desc_pool = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn fsl_qdma_pre_request_enqueue_desc(queue: *mut fsl_qdma_queue) -> c_int {
...
// fsl_qdma_request_enqueue_desc(struct fsl_qdma_chan *fsl_chan)
    ...
    let mut timeout: c_int = FSL_QDMA_COMP_TIMEOUT;
...
//
    ...
    status_head.comp_pool = core::ptr::null_mut();
    return status_head;
    }
#[no_mangle]
unsafe extern "C" fn fsl_qdma_halt(fsl_qdma: *mut fsl_qdma_engine) -> c_int {
...
//
    ...
    struct fsl_qdma_comp *fsl_comp = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fsl_qdma_error_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fsl_qdma_queue_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fsl_qdma_reg_init(fsl_qdma: *mut fsl_qdma_engine) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_qdma_enqueue_desc(fsl_chan: *mut fsl_qdma_chan) {
...
#[no_mangle]
unsafe extern "C" fn fsl_qdma_free_desc(vdesc: *mut virt_dma_desc) {
...
#[no_mangle]
unsafe extern "C" fn fsl_qdma_issue_pending(chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn fsl_qdma_synchronize(chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn fsl_qdma_terminate_all(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_qdma_alloc_chan_resources(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_qdma_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_qdma_cleanup_vchan(dmadev: *mut dma_device) {
...
#[no_mangle]
unsafe extern "C" fn fsl_qdma_remove(pdev: *mut platform_device) {
