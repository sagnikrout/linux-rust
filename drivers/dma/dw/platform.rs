...
//! Source: drivers/dma/dw/platform.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dw_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dw_suspend_late(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_resume_early(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dw_exit() -> void __exit {
