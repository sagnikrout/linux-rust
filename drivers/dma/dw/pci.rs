...
#[no_mangle]
unsafe extern "C" fn dw_pci_probe(pdev: *mut pci_dev, pid: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn dw_pci_suspend_late(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pci_resume_early(dev: *mut device) -> c_int {
