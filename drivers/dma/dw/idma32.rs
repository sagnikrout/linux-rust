...
//! Source: drivers/dma/dw/idma32.c
#![no_std]
...
pub const CTL_CH_TRANSFER_MODE_S2S: c_int = 0;
pub const CTL_CH_TRANSFER_MODE_S2D: c_int = 1;
pub const CTL_CH_TRANSFER_MODE_D2S: c_int = 2;
pub const CTL_CH_TRANSFER_MODE_D2D: c_int = 3;

pub const XBAR_SEL_RX_TX_SHIFT: c_int = 16;

#[no_mangle]
unsafe extern "C" fn idma32_get_slave_devfn(dwc: *mut dw_dma_chan) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn idma32_initialize_chan_generic(dwc: *mut dw_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn idma32_suspend_chan(dwc: *mut dw_dma_chan, drain: bool) {
...
#[no_mangle]
unsafe extern "C" fn idma32_resume_chan(dwc: *mut dw_dma_chan, drain: bool) {
...
#[no_mangle]
unsafe extern "C" fn idma32_block2bytes(dwc: *mut dw_dma_chan, block: u32, width: u32) -> usize {
    static size_t idma32_block2bytes(struct dw_dma_chan *dwc, u32 block, u32 width)
    {
    return IDMA32C_CTLH_BLOCK_TS(block);
    }
#[no_mangle]
pub unsafe extern "C" fn idma32_encode_maxburst(maxburst: u32) -> u8 {
    static inline u8 idma32_encode_maxburst(u32 maxburst)
    {
    return maxburst > 1 ? fls(maxburst) - 1 : 0;
    }
#[no_mangle]
unsafe extern "C" fn idma32_prepare_ctllo(dwc: *mut dw_dma_chan) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(DMA_DEV_TO_MEM: dwc->direction ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn idma32_set_device_name(dw: *mut dw_dma, id: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn idma32_fifo_partition(dw: *mut dw_dma) {
...
#[no_mangle]
unsafe extern "C" fn idma32_disable(dw: *mut dw_dma) {
...
#[no_mangle]
unsafe extern "C" fn idma32_enable(dw: *mut dw_dma) {
...
#[no_mangle]
pub unsafe extern "C" fn idma32_dma_probe(chip: *mut dw_dma_chip) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn idma32_dma_remove(chip: *mut dw_dma_chip) -> c_int {
