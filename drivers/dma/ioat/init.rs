...
//! Source: drivers/dma/ioat/init.c
#![no_std]
...
// I/OAT v3.4 platforms
    ...
    let mut ioat_dca_enabled: static int = 1;
    module_param(ioat_dca_enabled, int, 0644);
    MODULE_PARM_DESC(ioat_dca_enabled, "control support of dca service (default: 1)");
    let mut ioat_pending_level: c_int = 7;
...
#[no_mangle]
unsafe extern "C" fn is_jf_ioat(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_snb_ioat(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_ivb_ioat(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_hsw_ioat(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_bdx_ioat(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_skx_ioat(pdev: *mut pci_dev) -> bool {
    static inline bool is_skx_ioat(struct pci_dev *pdev)
    {
    return (pdev.device == PCI_DEVICE_ID_INTEL_IOAT_SKX) ? true : false;
    }
#[no_mangle]
unsafe extern "C" fn is_xeon_cb32(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_bwd_ioat(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_bwd_noraid(pdev: *mut pci_dev) -> bool {
...
//
pub const IOAT_TEST_SIZE: c_int = 2000;
#[no_mangle]
unsafe extern "C" fn ioat_dma_test_callback(dma_async_param: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn ioat_dma_self_test(ioat_dma: *mut ioatdma_device) -> c_int {
...
// Start copy, using first DMA channel
    ...
    if (tmo == 0 ||
    dma.device_tx_status(dma_chan, cookie, core::ptr::null_mut())
    != DMA_COMPLETE) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ioat_dma_setup_interrupts(ioat_dma: *mut ioatdma_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioat_disable_interrupts(ioat_dma: *mut ioatdma_device) {
...
#[no_mangle]
unsafe extern "C" fn ioat_probe(ioat_dma: *mut ioatdma_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioat_dma_remove(ioat_dma: *mut ioatdma_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ioat_enumerate_channels(ioat_dma: *mut ioatdma_device) {
    static void ioat_enumerate_channels(struct ioatdma_device *ioat_dma)
    {
    struct ioatdma_chan *ioat_chan;
    struct device *dev = &ioat_dma.pdev.dev;
...
//
#[no_mangle]
unsafe extern "C" fn ioat_free_chan_resources(c: *mut dma_chan) {
    static void ioat_free_chan_resources(struct dma_chan *c)
    {
    struct ioatdma_chan *ioat_chan = to_ioat_chan(c);
    struct ioatdma_device *ioat_dma = ioat_chan.ioat_dma;
    struct ioat_ring_ent *desc;
    let mut total_descs: c_int = 1 << ioat_chan.alloc_order;
    int descs;
    int i;
...
// Put LTR to idle
    ...
    ioat_chan.descs[i].virt = core::ptr::null_mut();
    ioat_chan.descs[i].hw = 0;
    }
    ioat_chan.desc_chunks = 0;
    kfree(ioat_chan.ring);
    ioat_chan.ring = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ioat_alloc_chan_resources(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioat_xor_val_self_test(ioat_dma: *mut ioatdma_device) -> c_int {
...
// test xor
    ...
    tmo = wait_for_completion_timeout(&cmp, msecs_to_jiffies(3000));
    if (tmo == 0 ||
    dma.device_tx_status(dma_chan, cookie, core::ptr::null_mut()) != DMA_COMPLETE) {
...
#[no_mangle]
unsafe extern "C" fn ioat3_dma_self_test(ioat_dma: *mut ioatdma_device) -> c_int {
    static int ioat3_dma_self_test(struct ioatdma_device *ioat_dma)
    {
    int rc;
...
#[no_mangle]
unsafe extern "C" fn ioat_intr_quirk(ioat_dma: *mut ioatdma_device) {
    static void ioat_intr_quirk(struct ioatdma_device *ioat_dma)
    {
...
#[no_mangle]
unsafe extern "C" fn ioat3_dma_probe(ioat_dma: *mut ioatdma_device, dca: c_int) -> c_int {
    static int ioat3_dma_probe(struct ioatdma_device *ioat_dma, int dca)
    {
    struct pci_dev *pdev = ioat_dma.pdev;
    let mut dca_en: c_int = system_has_dca_enabled(pdev);
    struct dma_device *dma;
    struct dma_chan *c;
    struct ioatdma_chan *ioat_chan;
    int err;
...
#[no_mangle]
unsafe extern "C" fn ioat_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn ioat_resume(ioat_dma: *mut ioatdma_device) {
...
#[no_mangle]
unsafe extern "C" fn ioat_pcie_error_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
    static pci_ers_result_t ioat_pcie_error_slot_reset(struct pci_dev *pdev)
    {
    let mut result: pci_ers_result_t = PCI_ERS_RESULT_RECOVERED;
...
#[no_mangle]
unsafe extern "C" fn ioat_pcie_error_resume(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn release_ioatdma(device: *mut dma_device) {
...
#[no_mangle]
unsafe extern "C" fn ioat_pci_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    static int ioat_pci_probe(struct pci_dev *pdev, const struct pci_device_id *id)
    {
...
#[no_mangle]
unsafe extern "C" fn ioat_remove(pdev: *mut pci_dev) {
    static void ioat_remove(struct pci_dev *pdev)
    {
    ...
    device.dca = core::ptr::null_mut();
    }
    ioat_dma_remove(device);
    }
#[no_mangle]
unsafe extern "C" fn ioat_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ioat_exit_module() -> void __exit {
