...
pub const NBPF_REG_CHAN_OFFSET: c_int = 0;
pub const NBPF_REG_CHAN_SIZE: c_uint = 0x40;
// Channel Current Transaction Byte register
pub const NBPF_CHAN_CUR_TR_BYTE: c_uint = 0x20;
// Channel Status register
pub const NBPF_CHAN_STAT: c_uint = 0x24;
pub const NBPF_CHAN_STAT_EN: c_int = 1;
pub const NBPF_CHAN_STAT_TACT: c_int = 4;
pub const NBPF_CHAN_STAT_ERR: c_uint = 0x10;
pub const NBPF_CHAN_STAT_END: c_uint = 0x20;
pub const NBPF_CHAN_STAT_TC: c_uint = 0x40;
pub const NBPF_CHAN_STAT_DER: c_uint = 0x400;
// Channel Control register
pub const NBPF_CHAN_CTRL: c_uint = 0x28;
pub const NBPF_CHAN_CTRL_SETEN: c_int = 1;
pub const NBPF_CHAN_CTRL_CLREN: c_int = 2;
pub const NBPF_CHAN_CTRL_STG: c_int = 4;
pub const NBPF_CHAN_CTRL_SWRST: c_int = 8;
pub const NBPF_CHAN_CTRL_CLRRQ: c_uint = 0x10;
pub const NBPF_CHAN_CTRL_CLREND: c_uint = 0x20;
pub const NBPF_CHAN_CTRL_CLRTC: c_uint = 0x40;
pub const NBPF_CHAN_CTRL_SETSUS: c_uint = 0x100;
pub const NBPF_CHAN_CTRL_CLRSUS: c_uint = 0x200;
// Channel Configuration register
pub const NBPF_CHAN_CFG: c_uint = 0x2c;

pub const NBPF_CHAN_CFG_LOEN: c_uint = 0x10		/* LOw ENable: low DMA request line is: 0: inactive, 1: active */;
pub const NBPF_CHAN_CFG_HIEN: c_uint = 0x20		/* HIgh ENable: high DMA request line is: 0: inactive, 1: active */;
pub const NBPF_CHAN_CFG_LVL: c_uint = 0x40		/* LeVeL: DMA request line is sensed as 0: edge, 1: level */;
pub const NBPF_CHAN_CFG_AM: c_uint = 0x700		/* ACK Mode: 0: Pulse mode, 1: Level mode, b'1x: Bus Cycle */;
pub const NBPF_CHAN_CFG_SDS: c_uint = 0xf000		/* Source Data Size: 0: 8 bits,... , 7: 1024 bits */;
pub const NBPF_CHAN_CFG_DDS: c_uint = 0xf0000		/* Destination Data Size: as above */;
pub const NBPF_CHAN_CFG_SAD: c_uint = 0x100000	/* Source ADdress counting: 0: increment, 1: fixed */;
pub const NBPF_CHAN_CFG_DAD: c_uint = 0x200000	/* Destination ADdress counting: 0: increment, 1: fixed */;
pub const NBPF_CHAN_CFG_TM: c_uint = 0x400000	/* Transfer Mode: 0: single, 1: block TM */;
pub const NBPF_CHAN_CFG_DEM: c_uint = 0x1000000	/* DMAEND interrupt Mask */;
pub const NBPF_CHAN_CFG_TCM: c_uint = 0x2000000	/* DMATCO interrupt Mask */;
pub const NBPF_CHAN_CFG_SBE: c_uint = 0x8000000	/* Sweep Buffer Enable */;
pub const NBPF_CHAN_CFG_RSEL: c_uint = 0x10000000	/* RM: Register Set sELect */;
pub const NBPF_CHAN_CFG_RSW: c_uint = 0x20000000	/* RM: Register Select sWitch */;
pub const NBPF_CHAN_CFG_REN: c_uint = 0x40000000	/* RM: Register Set Enable */;
pub const NBPF_CHAN_CFG_DMS: c_uint = 0x80000000	/* 0: register mode (RM), 1: link mode (LM) */;
pub const NBPF_CHAN_NXLA: c_uint = 0x38;
pub const NBPF_CHAN_CRLA: c_uint = 0x3c;
// Link Header field
pub const NBPF_HEADER_LV: c_int = 1;
pub const NBPF_HEADER_LE: c_int = 2;
pub const NBPF_HEADER_WBD: c_int = 4;
pub const NBPF_HEADER_DIM: c_int = 8;
pub const NBPF_CTRL: c_uint = 0x300;

pub const NBPF_DSTAT_ER: c_uint = 0x314;
pub const NBPF_DSTAT_END: c_uint = 0x318;
...
pub struct nbpf_link_reg {
    ...
    pub next: u32,
    pub __packed: },
    pub nbpf_device: struct,
    pub nbpf_channel: struct,
    pub nbpf_desc: struct,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nbpf_link_desc {
    pub hwdesc: *mut nbpf_link_reg,
    pub hwdesc_dma_addr: dma_addr_t,
    pub desc: *mut nbpf_desc,
    pub node: list_head,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nbpf_desc_page {
    pub node: list_head,
    pub desc: [nbpf_desc; NBPF_DESCS_PER_PAGE],
    pub ldesc: [nbpf_link_desc; NBPF_SEGMENTS_PER_PAGE],
    pub hwdesc: [nbpf_link_reg; NBPF_SEGMENTS_PER_PAGE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nbpf_channel {
    pub dma_chan: dma_chan,
    pub tasklet: tasklet_struct,
    pub base: *mut void __iomem,
    pub nbpf: *mut nbpf_device,
    pub name: [c_char; 16],
    pub irq: c_int,
    pub slave_src_addr: dma_addr_t,
    pub slave_src_width: usize,
    pub slave_src_burst: usize,
    pub slave_dst_addr: dma_addr_t,
    pub slave_dst_width: usize,
    pub slave_dst_burst: usize,
    pub terminal: c_uint,
    pub dmarq_cfg: u32,
    pub flags: c_ulong,
    pub lock: spinlock_t,
    pub free_links: list_head,
    pub free: list_head,
    pub queued: list_head,
    pub active: list_head,
    pub done: list_head,
    pub desc_page: list_head,
    pub running: *mut nbpf_desc,
    pub paused: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nbpf_device {
    pub dma_dev: dma_device,
    pub base: *mut void __iomem,
    pub max_burst_mem_read: u32,
    pub max_burst_mem_write: u32,
    pub clk: *mut clk,
    pub config: *const nbpf_config,
    pub eirq: c_uint,
    pub chan: [nbpf_channel; ],
}
...
// Hardware-specific part
    ...
    unsigned int offset)
    {
    let mut data: u32 = ioread32(chan.base + offset);
    ...
    unsigned int offset)
    {
    let mut data: u32 = ioread32(nbpf.base + offset);
...
#[no_mangle]
unsafe extern "C" fn nbpf_error_clear(chan: *mut nbpf_channel) {
...
#[no_mangle]
unsafe extern "C" fn nbpf_start(desc: *mut nbpf_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbpf_chan_prepare(chan: *mut nbpf_channel) {
...
#[no_mangle]
unsafe extern "C" fn nbpf_chan_prepare_default(chan: *mut nbpf_channel) {
...
#[no_mangle]
unsafe extern "C" fn nbpf_chan_configure(chan: *mut nbpf_channel) {
...
//
    ...
    {
    let mut max_burst: c_int = nbpf.config.buffer_size * 8;
...
#[no_mangle]
unsafe extern "C" fn nbpf_bytes_left(chan: *mut nbpf_channel) -> usize {
    static size_t nbpf_bytes_left(struct nbpf_channel *chan)
    {
    return nbpf_chan_read(chan, NBPF_CHAN_CUR_TR_BYTE);
    }
#[no_mangle]
unsafe extern "C" fn nbpf_configure(nbpf: *mut nbpf_device) {
...
#[no_mangle]
unsafe extern "C" fn nbpf_issue_pending(dchan: *mut dma_chan) {
    ...
    {
    struct nbpf_channel *chan = nbpf_to_chan(dchan);
    let mut status: enum dma_status = dma_cookie_status(dchan, cookie, state);
    if (state) {
...
#[no_mangle]
unsafe extern "C" fn nbpf_tx_submit(tx: *mut dma_async_tx_descriptor) -> dma_cookie_t {
...
#[no_mangle]
unsafe extern "C" fn nbpf_desc_page_alloc(chan: *mut nbpf_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbpf_desc_put(desc: *mut nbpf_desc) {
...
#[no_mangle]
unsafe extern "C" fn nbpf_scan_acked(chan: *mut nbpf_channel) {
...
//
    ...
    {
    struct nbpf_desc *desc = core::ptr::null_mut();
    struct nbpf_link_desc *ldesc, *prev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn nbpf_chan_idle(chan: *mut nbpf_channel) {
    ...
    chan.running = core::ptr::null_mut();
    spin_unlock_irqrestore(&chan.lock, flags);
    list_for_each_entry_safe(desc, tmp, &head, node) {
...
#[no_mangle]
unsafe extern "C" fn nbpf_pause(dchan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbpf_terminate_all(dchan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbpf_alloc_chan_resources(dchan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbpf_free_chan_resources(dchan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn nbpf_chan_tasklet(t: *mut tasklet_struct) {
    ...
    let mut found: bool = false, must_put, recycling = false;
    spin_lock_irq(&chan.lock);
    list_for_each_entry_safe(desc, tmp, &chan.done, node) {
    if (!desc.user_wait) {
...
#[no_mangle]
unsafe extern "C" fn nbpf_chan_irq(irq: c_int, dev: *mut c_void) -> irqreturn_t {
    static irqreturn_t nbpf_chan_irq(int irq, void *dev)
    {
    struct nbpf_channel *chan = dev;
    let mut done: bool = nbpf_status_get(chan);
    struct nbpf_desc *desc;
    irqreturn_t ret;
    let mut bh: bool = false;
    if (!done)
    return IRQ_NONE;
...
#[no_mangle]
unsafe extern "C" fn nbpf_err_irq(irq: c_int, dev: *mut c_void) -> irqreturn_t {
    static irqreturn_t nbpf_err_irq(int irq, void *dev)
    {
    struct nbpf_device *nbpf = dev;
    let mut error: u32 = nbpf_error_get(nbpf);
...
#[no_mangle]
unsafe extern "C" fn nbpf_chan_probe(nbpf: *mut nbpf_device, n: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbpf_probe(pdev: *mut platform_device) -> c_int {
...
// DT only
    ...
    nbpf.clk = devm_clk_get(dev, core::ptr::null_mut());
    if (IS_ERR(nbpf.clk))
...
#[no_mangle]
unsafe extern "C" fn nbpf_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn nbpf_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbpf_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(nbpf_runtime_suspend, nbpf_runtime_resume, core::ptr::null_mut())
    };
