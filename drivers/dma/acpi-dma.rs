...
//
    ...
    let mut mem: resource_size_t = 0, irq = 0;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn if(IORESOURCE_IRQ: resource_type(rentry->res) ==) -> else {
...
//
    ret = acpi_register_gsi(core::ptr::null_mut(), si.gsi_interrupt, si.interrupt_mode, si.interrupt_polarity);
    if (ret < 0)
    return 0;
...
//
#[no_mangle]
unsafe extern "C" fn acpi_dma_parse_csrt(adev: *mut acpi_device, adma: *mut acpi_dma) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_dma_controller_free(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_acpi_dma_free(dev: *mut c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_dma_parser_data {
    pub dma_spec: acpi_dma_spec,
    pub index: usize,
    pub n: usize,
}
...
//
#[no_mangle]
unsafe extern "C" fn acpi_dma_parse_fixed_dma(res: *mut acpi_resource, data: *mut c_void) -> c_int {
...
//
    ...
    index = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(name, _arg: "rx")) -> else {
