...
//! Source: drivers/dma/sh/shdma-base.c
#![no_std]
...
pub const NR_DESCS_PER_CHANNEL: c_int = 32;
...
#[no_mangle]
unsafe extern "C" fn shdma_tx_submit(tx: *mut dma_async_tx_descriptor) -> dma_cookie_t {
    static dma_cookie_t shdma_tx_submit(struct dma_async_tx_descriptor *tx)
    {
    struct shdma_desc *chunk, *c, *desc =
    container_of(tx, struct shdma_desc, async_tx);
    struct shdma_chan *schan = to_shdma_chan(tx.chan);
    let mut callback: dma_async_tx_callback = tx.callback;
    dma_cookie_t cookie;
    bool power_up;
...
// Callback goes to the last chunk
    chunk.async_tx.callback = core::ptr::null_mut();
    }
    chunk.cookie = cookie;
...
#[no_mangle]
unsafe extern "C" fn shdma_setup_slave(schan: *mut shdma_chan, slave_addr: dma_addr_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn shdma_alloc_chan_resources(chan: *mut dma_chan) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn shdma_chan_filter(chan: *mut dma_chan, arg: *mut c_void) -> bool {
    bool shdma_chan_filter(struct dma_chan *chan, void *arg)
    {
    struct shdma_chan *schan;
    struct shdma_dev *sdev;
    let mut slave_id: c_int = (long)arg;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn __ld_cleanup(schan: *mut shdma_chan, all: bool) -> dma_async_tx_callback {
    static dma_async_tx_callback __ld_cleanup(struct shdma_chan *schan, bool all)
    {
    struct shdma_desc *desc, *_desc;
// Is the "exposed" head of a chain acked?
    let mut head_acked: bool = false;
    let mut cookie: dma_cookie_t = 0;
...
//
#[no_mangle]
unsafe extern "C" fn shdma_chan_ld_cleanup(schan: *mut shdma_chan, all: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn shdma_free_chan_resources(chan: *mut dma_chan) {
...
//
    ...
    struct shdma_desc *first = core::ptr::null_mut(), *new = core::ptr::null_mut() /* compiler... */;
    LIST_HEAD(tx_list);
    int chunks;
...
// Put them back on the free list, so, they don't get lost
    ...
    struct shdma_dev *sdev = to_shdma_dev(schan.dma_chan.device);
    const struct shdma_ops *ops = sdev.ops;
    let mut slave_id: c_int = schan.slave_id;
...
pub const SHDMA_MAX_SG_LEN: c_int = 32;
    ...
    const struct shdma_ops *ops = sdev.ops;
    let mut sg_len: c_uint = buf_len / period_len;
    let mut slave_id: c_int = schan.slave_id;
    dma_addr_t slave_addr;
...
#[no_mangle]
unsafe extern "C" fn shdma_terminate_all(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn shdma_issue_pending(chan: *mut dma_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn shdma_reset(sdev: *mut shdma_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn chan_irq(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn chan_irqt(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn shdma_chan_remove(schan: *mut shdma_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn shdma_cleanup(sdev: *mut shdma_dev) {
...
#[no_mangle]
unsafe extern "C" fn shdma_enter() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn shdma_exit() -> void __exit {
