...
//! Source: drivers/dma/sh/rcar-dmac.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_dmac_xfer_chunk {
    pub node: list_head,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_dmac_desc {
    pub async_tx: dma_async_tx_descriptor,
    pub direction: enum dma_transfer_direction,
    pub xfer_shift: c_uint,
    pub chcr: u32,
    pub node: list_head,
    pub chunks: list_head,
    pub running: *mut rcar_dmac_xfer_chunk,
    pub nchunks: c_uint,
    struct {
    pub use: bool,
    pub mem: *mut rcar_dmac_hw_desc,
    pub dma: dma_addr_t,
    pub size: usize,
    pub hwdescs: },
    pub size: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_dmac_desc_page {
    pub node: list_head,
    union {
    pub descs): DECLARE_FLEX_ARRAY(struct rcar_dmac_desc,,
    pub chunks): DECLARE_FLEX_ARRAY(struct rcar_dmac_xfer_chunk,,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_dmac_chan_slave {
    pub slave_addr: phys_addr_t,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_dmac_chan_map {
    pub addr: dma_addr_t,
    pub dir: enum dma_data_direction,
    pub slave: rcar_dmac_chan_slave,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_dmac_chan {
    pub chan: dma_chan,
    pub iomem: *mut void __iomem,
    pub index: c_uint,
    pub irq: c_int,
    pub src: rcar_dmac_chan_slave,
    pub dst: rcar_dmac_chan_slave,
    pub map: rcar_dmac_chan_map,
    pub mid_rid: c_int,
    pub lock: spinlock_t,
    struct {
    pub free: list_head,
    ...
    pub done: list_head,
    pub wait: list_head,
    pub running: *mut rcar_dmac_desc,
    pub chunks_free: list_head,
    pub pages: list_head,
    pub desc: },
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_dmac {
    pub engine: dma_device,
    pub dev: *mut device,
    pub dmac_base: *mut void __iomem,
    pub chan_base: *mut void __iomem,
    pub n_channels: c_uint,
    pub channels: *mut rcar_dmac_chan,
    pub channels_mask: u32,
    pub 256): DECLARE_BITMAP(modules,,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_dmac_of_data {
    pub chan_offset_base: u32,
    pub chan_offset_stride: u32,
}

// -----------------------------------------------------------------------------
// Registers
//
pub const RCAR_DMAISTA: c_uint = 0x0020;
pub const RCAR_DMASEC: c_uint = 0x0030;
pub const RCAR_DMAOR: c_uint = 0x0060;

pub const RCAR_DMACHCLR: c_uint = 0x0080	/* Not on R-Car Gen4 */;
pub const RCAR_DMADPSEC: c_uint = 0x00a0;
pub const RCAR_DMASAR: c_uint = 0x0000;
pub const RCAR_DMADAR: c_uint = 0x0004;
pub const RCAR_DMATCR: c_uint = 0x0008;
pub const RCAR_DMATCR_MASK: c_uint = 0x00ffffff;
pub const RCAR_DMATSR: c_uint = 0x0028;
pub const RCAR_DMACHCR: c_uint = 0x000c;

pub const RCAR_DMATCRB: c_uint = 0x0018;
pub const RCAR_DMATSRB: c_uint = 0x0038;
pub const RCAR_DMACHCRB: c_uint = 0x001c;

pub const RCAR_DMACHCRB_DPTR_SHIFT: c_int = 16;

pub const RCAR_DMARS: c_uint = 0x0040;
pub const RCAR_DMABUFCR: c_uint = 0x0048;

pub const RCAR_DMADPBASE: c_uint = 0x0050;
pub const RCAR_DMADPBASE_MASK: c_uint = 0xfffffff0;

pub const RCAR_DMADPCR: c_uint = 0x0054;

pub const RCAR_DMAFIXSAR: c_uint = 0x0010;
pub const RCAR_DMAFIXDAR: c_uint = 0x0014;
pub const RCAR_DMAFIXDPBASE: c_uint = 0x0060;
// For R-Car Gen4
pub const RCAR_GEN4_DMACHCLR: c_uint = 0x0100;
// Hardcode the MEMCPY transfer size to 4 bytes.
pub const RCAR_DMAC_MEMCPY_XFER_SIZE: c_int = 4;
// -----------------------------------------------------------------------------
// Device access
//
#[no_mangle]
unsafe extern "C" fn rcar_dmac_write(dmac: *mut rcar_dmac, reg: u32, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_read(dmac: *mut rcar_dmac, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_chan_read(chan: *mut rcar_dmac_chan, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_chan_write(chan: *mut rcar_dmac_chan, reg: u32, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_chan_clear_all(dmac: *mut rcar_dmac) {
...
//
#[no_mangle]
unsafe extern "C" fn rcar_dmac_chan_is_busy(chan: *mut rcar_dmac_chan) -> bool {
    static bool rcar_dmac_chan_is_busy(struct rcar_dmac_chan *chan)
    {
    let mut chcr: u32 = rcar_dmac_chan_read(chan, RCAR_DMACHCR);
    return !!(chcr & (RCAR_DMACHCR_DE | RCAR_DMACHCR_TE));
    }
#[no_mangle]
unsafe extern "C" fn rcar_dmac_chan_start_xfer(chan: *mut rcar_dmac_chan) {
    static void rcar_dmac_chan_start_xfer(struct rcar_dmac_chan *chan)
    {
    struct rcar_dmac_desc *desc = chan.desc.running;
    let mut chcr: u32 = desc.chcr;
...
//
#[no_mangle]
pub unsafe extern "C" fn if(_arg: desc->async_tx.callback) -> else {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_init(dmac: *mut rcar_dmac) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rcar_dmac_tx_submit(tx: *mut dma_async_tx_descriptor) -> dma_cookie_t {
...
//
#[no_mangle]
unsafe extern "C" fn rcar_dmac_desc_alloc(chan: *mut rcar_dmac_chan, gfp: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_desc_recycle_acked(chan: *mut rcar_dmac_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn rcar_dmac_xfer_chunk_alloc(chan: *mut rcar_dmac_chan, gfp: gfp_t) -> c_int {
...
//
    ...
    desc.hwdescs.mem = core::ptr::null_mut();
    desc.hwdescs.size = 0;
    }
    if (!size)
    return;
...
//
#[no_mangle]
unsafe extern "C" fn rcar_dmac_chcr_de_barrier(chan: *mut rcar_dmac_chan) {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_clear_chcr_de(chan: *mut rcar_dmac_chan) {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_chan_halt(chan: *mut rcar_dmac_chan) {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_chan_reinit(chan: *mut rcar_dmac_chan) {
...
// Move all non-free descriptors to the local lists.
    ...
    chan.desc.running = core::ptr::null_mut();
    spin_unlock_irqrestore(&chan.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_stop_all_chan(dmac: *mut rcar_dmac) {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_chan_pause(chan: *mut dma_chan) -> c_int {
...
//
    ...
    let mut nchunks: c_uint = 0;
    unsigned int max_chunk_size;
    let mut full_size: c_uint = 0;
    let mut cross_boundary: bool = false;
    unsigned int i;
...
//
    ...
    let mut mem_addr: dma_addr_t = sg_dma_address(sg);
    ...
    while (len) {
    let mut size: c_uint = min(len, max_chunk_size);
...
//
#[no_mangle]
unsafe extern "C" fn rcar_dmac_alloc_chan_resources(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_free_chan_resources(chan: *mut dma_chan) {
...
// The caller is holding dma_list_mutex
    ...
    rchan.desc.running = core::ptr::null_mut();
...
pub const RCAR_DMAC_MAX_SG_LEN: c_int = 32;
    static struct dma_async_tx_descriptor *
...
//
    ...
    for (i = 0; i < sg_len; ++i) {
    let mut src: dma_addr_t = buf_addr + (period_len * i);
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_chan_terminate_all(chan: *mut dma_chan) -> c_int {
...
//
    ...
    {
    struct rcar_dmac_desc *desc = chan.desc.running;
    struct rcar_dmac_xfer_chunk *running = core::ptr::null_mut();
    struct rcar_dmac_xfer_chunk *chunk;
    enum dma_status status;
    let mut residue: c_uint = 0;
    let mut dptr: c_uint = 0;
    unsigned int chcrb;
    unsigned int tcrb;
    unsigned int i;
    if (!desc)
...
// now be complete.
//
    status = dma_cookie_status(&chan.chan, cookie, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_issue_pending(chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_device_synchronize(chan: *mut dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn rcar_dmac_isr_desc_stage_end(chan: *mut rcar_dmac_chan) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_isr_transfer_end(chan: *mut rcar_dmac_chan) -> irqreturn_t {
    static irqreturn_t rcar_dmac_isr_transfer_end(struct rcar_dmac_chan *chan)
    {
    struct rcar_dmac_desc *desc = chan.desc.running;
    let mut ret: irqreturn_t = IRQ_WAKE_THREAD;
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_isr_channel(irq: c_int, dev: *mut c_void) -> irqreturn_t {
    static irqreturn_t rcar_dmac_isr_channel(int irq, void *dev)
    {
    let mut mask: u32 = RCAR_DMACHCR_DSE | RCAR_DMACHCR_TE;
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_isr_channel_thread(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn rcar_dmac_chan_filter(chan: *mut dma_chan, arg: *mut c_void) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn rcar_dmac_runtime_resume(dev: *mut device) -> c_int {
...
//
    ...
    RUNTIME_PM_OPS(core::ptr::null_mut(), rcar_dmac_runtime_resume, core::ptr::null_mut())
    };
// -----------------------------------------------------------------------------
// Probe and remove
//
...
pub const RCAR_DMAC_MAX_CHANNELS: c_int = 32;
#[no_mangle]
unsafe extern "C" fn rcar_dmac_parse_of(dev: *mut device, dmac: *mut rcar_dmac) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rcar_dmac_shutdown(pdev: *mut platform_device) {
