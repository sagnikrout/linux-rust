...
//! Source: drivers/dma/xgene-dma.c
#![no_std]
...
pub const XGENE_DMA_RING_CONFIG: c_uint = 0x04;

pub const XGENE_DMA_RING_ID: c_uint = 0x08;

pub const XGENE_DMA_RING_ID_BUF: c_uint = 0x0C;

pub const XGENE_DMA_RING_THRESLD0_SET1: c_uint = 0x30;

pub const XGENE_DMA_RING_THRESLD1_SET1: c_uint = 0x34;
pub const XGENE_DMA_RING_THRESLD1_SET1_VAL: c_uint = 0xC8;
pub const XGENE_DMA_RING_HYSTERESIS: c_uint = 0x68;
pub const XGENE_DMA_RING_HYSTERESIS_VAL: c_uint = 0xFFFFFFFF;
pub const XGENE_DMA_RING_STATE: c_uint = 0x6C;
pub const XGENE_DMA_RING_STATE_WR_BASE: c_uint = 0x70;
pub const XGENE_DMA_RING_NE_INT_MODE: c_uint = 0x017C;

    ((m) = ((m) & ~BIT(31 - (v))) | BIT(31 - (v)))

    ((m) &= (~BIT(31 - (v))))
pub const XGENE_DMA_RING_CLKEN: c_uint = 0xC208;
pub const XGENE_DMA_RING_SRST: c_uint = 0xC200;
pub const XGENE_DMA_RING_MEM_RAM_SHUTDOWN: c_uint = 0xD070;
pub const XGENE_DMA_RING_BLK_MEM_RDY: c_uint = 0xD074;
pub const XGENE_DMA_RING_BLK_MEM_RDY_VAL: c_uint = 0xFFFFFFFF;

pub const XGENE_DMA_RING_CMD_OFFSET: c_uint = 0x2C;
...
pub const XGENE_DMA_IPBRR: c_uint = 0x0;

pub const XGENE_DMA_GCR: c_uint = 0x10;

    ((v) = ((v) & ~0x000FFFFF) | 0x000AAFFF)

pub const XGENE_DMA_RAID6_CONT: c_uint = 0x14;

pub const XGENE_DMA_INT: c_uint = 0x70;
pub const XGENE_DMA_INT_MASK: c_uint = 0x74;
pub const XGENE_DMA_INT_ALL_MASK: c_uint = 0xFFFFFFFF;
pub const XGENE_DMA_INT_ALL_UNMASK: c_uint = 0x0;
pub const XGENE_DMA_INT_MASK_SHIFT: c_uint = 0x14;
pub const XGENE_DMA_RING_INT0_MASK: c_uint = 0x90A0;
pub const XGENE_DMA_RING_INT1_MASK: c_uint = 0x90A8;
pub const XGENE_DMA_RING_INT2_MASK: c_uint = 0x90B0;
pub const XGENE_DMA_RING_INT3_MASK: c_uint = 0x90B8;
pub const XGENE_DMA_RING_INT4_MASK: c_uint = 0x90C0;
pub const XGENE_DMA_CFG_RING_WQ_ASSOC: c_uint = 0x90E0;
pub const XGENE_DMA_ASSOC_RING_MNGR1: c_uint = 0xFFFFFFFF;
pub const XGENE_DMA_MEM_RAM_SHUTDOWN: c_uint = 0xD070;
pub const XGENE_DMA_BLK_MEM_RDY: c_uint = 0xD074;
pub const XGENE_DMA_BLK_MEM_RDY_VAL: c_uint = 0xFFFFFFFF;
pub const XGENE_DMA_RING_CMD_SM_OFFSET: c_uint = 0x8000;
// X-Gene SoC EFUSE csr register and bit defination
pub const XGENE_SOC_JTAG1_SHADOW: c_uint = 0x18;

// X-Gene DMA Descriptor format

pub const XGENE_DMA_DESC_ELERR_POS: c_int = 46;
pub const XGENE_DMA_DESC_RTYPE_POS: c_int = 56;
pub const XGENE_DMA_DESC_LERR_POS: c_int = 60;
pub const XGENE_DMA_DESC_BUFLEN_POS: c_int = 48;
pub const XGENE_DMA_DESC_HOENQ_NUM_POS: c_int = 48;
...
pub const XGENE_DMA_RING_NUM: c_int = 512;
pub const XGENE_DMA_BUFNUM: c_uint = 0x0;
pub const XGENE_DMA_CPU_BUFNUM: c_uint = 0x18;
pub const XGENE_DMA_RING_OWNER_DMA: c_uint = 0x03;
pub const XGENE_DMA_RING_OWNER_CPU: c_uint = 0x0F;
pub const XGENE_DMA_RING_TYPE_REGULAR: c_uint = 0x01;

pub const XGENE_DMA_RING_NUM_CONFIG: c_int = 5;
pub const XGENE_DMA_MAX_CHANNEL: c_int = 4;
pub const XGENE_DMA_XOR_CHANNEL: c_int = 0;
pub const XGENE_DMA_PQ_CHANNEL: c_int = 1;
pub const XGENE_DMA_MAX_BYTE_CNT: c_uint = 0x4000	/* 16 KB */;
pub const XGENE_DMA_MAX_64B_DESC_BYTE_CNT: c_uint = 0x14000	/* 80 KB */;
pub const XGENE_DMA_MAX_XOR_SRC: c_int = 5;
pub const XGENE_DMA_16K_BUFFER_LEN_CODE: c_uint = 0x0;
pub const XGENE_DMA_INVALID_LEN_CODE: c_uint = 0x7800000000000000ULL;
// X-Gene DMA descriptor error codes
pub const ERR_DESC_AXI: c_uint = 0x01;
pub const ERR_BAD_DESC: c_uint = 0x02;
pub const ERR_READ_DATA_AXI: c_uint = 0x03;
pub const ERR_WRITE_DATA_AXI: c_uint = 0x04;
pub const ERR_FBP_TIMEOUT: c_uint = 0x05;
pub const ERR_ECC: c_uint = 0x06;
pub const ERR_DIFF_SIZE: c_uint = 0x08;
pub const ERR_SCT_GAT_LEN: c_uint = 0x09;
pub const ERR_CRC_ERR: c_uint = 0x11;
pub const ERR_CHKSUM: c_uint = 0x12;
pub const ERR_DIF: c_uint = 0x13;
// X-Gene DMA error interrupt codes
pub const ERR_DIF_SIZE_INT: c_uint = 0x0;
pub const ERR_GS_ERR_INT: c_uint = 0x1;
pub const ERR_FPB_TIMEO_INT: c_uint = 0x2;
pub const ERR_WFIFO_OVF_INT: c_uint = 0x3;
pub const ERR_RFIFO_OVF_INT: c_uint = 0x4;
pub const ERR_WR_TIMEO_INT: c_uint = 0x5;
pub const ERR_RD_TIMEO_INT: c_uint = 0x6;
pub const ERR_WR_ERR_INT: c_uint = 0x7;
pub const ERR_RD_ERR_INT: c_uint = 0x8;
pub const ERR_BAD_DESC_INT: c_uint = 0x9;
pub const ERR_DESC_DST_INT: c_uint = 0xA;
pub const ERR_DESC_SRC_INT: c_uint = 0xB;
// X-Gene DMA flyby operation code
pub const FLYBY_2SRC_XOR: c_uint = 0x80;
pub const FLYBY_3SRC_XOR: c_uint = 0x90;
pub const FLYBY_4SRC_XOR: c_uint = 0xA0;
pub const FLYBY_5SRC_XOR: c_uint = 0xB0;
...
pub struct xgene_dma_ring {
    ...
    pub state: [u32; XGENE_DMA_RING_NUM_CONFIG],
    pub cfgsize: enum xgene_dma_ring_cfgsize,
    union {
    pub desc_vaddr: *mut c_void,
    pub desc_hw: *mut xgene_dma_desc_hw,
}

    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgene_dma_desc_sw {
    pub desc1: xgene_dma_desc_hw,
    pub desc2: xgene_dma_desc_hw,
    pub flags: u32,
    pub node: list_head,
...
pub struct xgene_dma_chan {
    ...
    pub lock: spinlock_t,
    pub pending: c_int,
    pub max_outstanding: c_int,
    pub ld_pending: list_head,
    pub ld_running: list_head,
    pub ld_completed: list_head,
    pub desc_pool: *mut dma_pool,
    pub tasklet: tasklet_struct,
    pub tx_ring: xgene_dma_ring,
    pub rx_ring: xgene_dma_ring,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgene_dma {
    pub dev: *mut device,
    pub clk: *mut clk,
    pub err_irq: c_int,
    pub ring_num: c_int,
    pub csr_dma: *mut void __iomem,
    pub csr_ring: *mut void __iomem,
    pub csr_ring_cmd: *mut void __iomem,
    pub csr_efuse: *mut void __iomem,
    pub dma_dev: [dma_device; XGENE_DMA_MAX_CHANNEL],
    pub chan: [xgene_dma_chan; XGENE_DMA_MAX_CHANNEL],
}
...
#[no_mangle]
unsafe extern "C" fn is_pq_enabled(pdma: *mut xgene_dma) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_encode_len(len: usize) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_encode_xor_flyby(src_cnt: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_tx_submit(tx: *mut dma_async_tx_descriptor) -> dma_cookie_t {
...
//
#[no_mangle]
unsafe extern "C" fn xgene_dma_clean_completed_descriptor(chan: *mut xgene_dma_chan) {
...
// Run the link descriptor callback function
    dmaengine_desc_get_callback_invoke(tx, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn xgene_chan_xfer_ld_pending(chan: *mut xgene_dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn xgene_dma_cleanup_descriptors(chan: *mut xgene_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_alloc_chan_resources(dchan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_free_chan_resources(dchan: *mut dma_chan) {
...
// Delete this channel DMA pool
    ...
    {
    struct xgene_dma_desc_sw *first = core::ptr::null_mut(), *new;
    struct xgene_dma_chan *chan;
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_issue_pending(dchan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_tasklet_cb(t: *mut tasklet_struct) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_chan_ring_isr(irq: c_int, id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_err_isr(irq: c_int, id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_wr_ring_state(ring: *mut xgene_dma_ring) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_clr_ring_state(ring: *mut xgene_dma_ring) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_setup_ring(ring: *mut xgene_dma_ring) {
    static void xgene_dma_setup_ring(struct xgene_dma_ring *ring)
    {
    void *ring_cfg = ring.state;
    let mut addr: u64 = ring.desc_paddr;
    u32 i, val;
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_clear_ring(ring: *mut xgene_dma_ring) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_set_ring_cmd(ring: *mut xgene_dma_ring) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_delete_ring_one(ring: *mut xgene_dma_ring) {
...
// De-allocate DMA ring descriptor
    ...
    ring.desc_vaddr = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn xgene_dma_delete_chan_rings(chan: *mut xgene_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_create_chan_rings(chan: *mut xgene_dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_init_rings(pdma: *mut xgene_dma) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_enable(pdma: *mut xgene_dma) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_disable(pdma: *mut xgene_dma) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_mask_interrupts(pdma: *mut xgene_dma) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_unmask_interrupts(pdma: *mut xgene_dma) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_init_hw(pdma: *mut xgene_dma) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_init_ring_mngr(pdma: *mut xgene_dma) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_init_mem(pdma: *mut xgene_dma) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_request_irqs(pdma: *mut xgene_dma) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_free_irqs(pdma: *mut xgene_dma) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_async_register(pdma: *mut xgene_dma, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_init_async(pdma: *mut xgene_dma) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_async_unregister(pdma: *mut xgene_dma) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_init_channels(pdma: *mut xgene_dma) {
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (ret)
    return ret;
    pdma.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn xgene_dma_remove(pdev: *mut platform_device) {
