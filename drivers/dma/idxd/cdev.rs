...
//! Source: drivers/dma/idxd/cdev.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cr_faults_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn pid_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn cdev_file_attr_visible(kobj: *mut kobject, a: *mut attribute, n: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn idxd_file_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_cdev_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_xa_pasid_remove(ctx: *mut idxd_user_context) {
    static void idxd_xa_pasid_remove(struct idxd_user_context *ctx)
    {
    struct idxd_wq *wq = ctx.wq;
    void *ptr;
    mutex_lock(&wq.uc_lock);
    ptr = xa_cmpxchg(&wq.upasid_xa, ctx.pasid, ctx, core::ptr::null_mut(), GFP_KERNEL);
    if (ptr != (void *)ctx)
...
#[no_mangle]
pub unsafe extern "C" fn idxd_user_counter_increment(wq: *mut idxd_wq, pasid: u32, index: c_int) {
...
#[no_mangle]
unsafe extern "C" fn idxd_cdev_open(inode: *mut inode, filp: *mut file) -> c_int {
    ...
    let mut rc: c_int = 0;
    struct iommu_sva *sva = core::ptr::null_mut();
    unsigned int pasid;
...
#[no_mangle]
unsafe extern "C" fn idxd_cdev_evl_drain_pasid(wq: *mut idxd_wq, pasid: u32) {
    static void idxd_cdev_evl_drain_pasid(struct idxd_wq *wq, u32 pasid)
    {
    struct idxd_device *idxd = wq.idxd;
    ...
    u16 h, t, size;
    let mut ent_size: c_int = evl_ent_size(idxd);
...
#[no_mangle]
unsafe extern "C" fn idxd_cdev_release(node: *mut inode, filep: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_cdev_mmap(filp: *mut file, vma: *mut vm_area_struct) -> c_int {
    ...
    let mut base: phys_addr_t = pci_resource_start(pdev, IDXD_WQ_BAR);
    unsigned long pfn;
    int rc;
...
//
    ...
    let mut comp_addr_align: u64 = is_dsa_dev(idxd_dev) ? 0x20 : 0x40;
...
//
    ...
    let mut rc: c_int = idxd_submit_user_descriptor(ctx, udesc + i);
    if (rc)
...
#[no_mangle]
pub unsafe extern "C" fn idxd_cdev_get_major(idxd: *mut idxd_device) -> c_int {
    int idxd_cdev_get_major(struct idxd_device *idxd)
    {
    return MAJOR(ictx[idxd.data.type].devt);
    }
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_add_cdev(wq: *mut idxd_wq) -> c_int {
    ...
    err:
    put_device(dev);
    wq.idxd_cdev = core::ptr::null_mut();
    return rc;
    }
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_del_cdev(wq: *mut idxd_wq) {
...
#[no_mangle]
unsafe extern "C" fn idxd_user_drv_probe(idxd_dev: *mut idxd_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_user_drv_remove(idxd_dev: *mut idxd_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_cdev_register() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_cdev_remove() {
...
//
    ...
    {
    struct device *dev = &wq.idxd.pdev.dev;
    let mut left: c_int = len, status_size = 1;
    struct idxd_user_context *ctx;
    struct mm_struct *mm;
    mutex_lock(&wq.uc_lock);
    ctx = xa_load(&wq.upasid_xa, pasid);
