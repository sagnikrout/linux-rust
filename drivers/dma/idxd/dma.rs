...
#[no_mangle]
unsafe extern "C" fn op_flag_setup(flags: c_ulong, desc_flags: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn idxd_dma_alloc_chan_resources(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_dma_free_chan_resources(chan: *mut dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn idxd_dma_issue_pending(dma_chan: *mut dma_chan) {
    static void idxd_dma_issue_pending(struct dma_chan *dma_chan)
    {
    }
#[no_mangle]
unsafe extern "C" fn idxd_dma_tx_submit(tx: *mut dma_async_tx_descriptor) -> dma_cookie_t {
...
#[no_mangle]
unsafe extern "C" fn idxd_dma_release(device: *mut dma_device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_dma_terminate_all(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_dma_synchronize(c: *mut dma_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_register_dma_device(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_unregister_dma_device(idxd: *mut idxd_device) {
    void idxd_unregister_dma_device(struct idxd_device *idxd)
    {
    dma_async_device_unregister(&idxd.idxd_dma.dma);
    }
#[no_mangle]
unsafe extern "C" fn idxd_register_dma_channel(wq: *mut idxd_wq) -> c_int {
    ...
    rc = dma_async_device_channel_register(dma, chan, core::ptr::null_mut());
    if (rc < 0) {
    kfree(idxd_chan);
    return rc;
    }
...
#[no_mangle]
unsafe extern "C" fn idxd_unregister_dma_channel(wq: *mut idxd_wq) {
...
#[no_mangle]
unsafe extern "C" fn idxd_dmaengine_drv_probe(idxd_dev: *mut idxd_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_dmaengine_drv_remove(idxd_dev: *mut idxd_dev) {
