...
//! Source: drivers/dma/idxd/device.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn idxd_unmask_error_interrupts(idxd: *mut idxd_device) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_mask_error_interrupts(idxd: *mut idxd_device) {
...
#[no_mangle]
unsafe extern "C" fn free_hw_descs(wq: *mut idxd_wq) {
...
#[no_mangle]
unsafe extern "C" fn alloc_hw_descs(wq: *mut idxd_wq, num: c_int) -> c_int {
    static int alloc_hw_descs(struct idxd_wq *wq, int num)
    {
    struct device *dev = &wq.idxd.pdev.dev;
    int i;
    let mut node: c_int = dev_to_node(dev);
...
#[no_mangle]
unsafe extern "C" fn free_descs(wq: *mut idxd_wq) {
...
#[no_mangle]
unsafe extern "C" fn alloc_descs(wq: *mut idxd_wq, num: c_int) -> c_int {
...
// WQ control bits
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_alloc_resources(wq: *mut idxd_wq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IDXD_TYPE_IAX: idxd->data->type ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_free_resources(wq: *mut idxd_wq) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_enable(wq: *mut idxd_wq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_disable(wq: *mut idxd_wq, reset_config: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_drain(wq: *mut idxd_wq) {
    ...
    operand = BIT(wq.id % 16) | ((wq.id / 16) << 16);
    idxd_cmd_exec(idxd, IDXD_CMD_DRAIN_WQ, operand, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_reset(wq: *mut idxd_wq) {
    ...
    operand = BIT(wq.id % 16) | ((wq.id / 16) << 16);
    idxd_cmd_exec(idxd, IDXD_CMD_RESET_WQ, operand, core::ptr::null_mut());
    idxd_wq_disable_cleanup(wq);
    }
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_map_portal(wq: *mut idxd_wq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_unmap_portal(wq: *mut idxd_wq) {
    void idxd_wq_unmap_portal(struct idxd_wq *wq)
    {
    struct device *dev = &wq.idxd.pdev.dev;
    devm_iounmap(dev, wq.portal);
    wq.portal = core::ptr::null_mut();
    wq.portal_offset = 0;
    }
#[no_mangle]
pub unsafe extern "C" fn idxd_wqs_unmap_portal(idxd: *mut idxd_device) {
...
#[no_mangle]
unsafe extern "C" fn __idxd_wq_set_pasid_locked(wq: *mut idxd_wq, pasid: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_set_pasid(wq: *mut idxd_wq, pasid: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_disable_pasid(wq: *mut idxd_wq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_wq_disable_cleanup(wq: *mut idxd_wq) {
    static void idxd_wq_disable_cleanup(struct idxd_wq *wq)
    {
    struct idxd_device *idxd = wq.idxd;
...
#[no_mangle]
unsafe extern "C" fn idxd_wq_device_reset_cleanup(wq: *mut idxd_wq) {
    static void idxd_wq_device_reset_cleanup(struct idxd_wq *wq)
    {
    lockdep_assert_held(&wq.wq_lock);
    wq.size = 0;
    wq.group = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn idxd_wq_ref_release(ref: *mut percpu_ref) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_init_percpu_ref(wq: *mut idxd_wq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __idxd_wq_quiesce(wq: *mut idxd_wq) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_quiesce(wq: *mut idxd_wq) {
...
// Device control bits
#[no_mangle]
pub unsafe extern "C" fn idxd_is_enabled(idxd: *mut idxd_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_device_is_halted(idxd: *mut idxd_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn idxd_device_init_reset(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_device_enable(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_device_disable(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_device_reset(idxd: *mut idxd_device) {
    void idxd_device_reset(struct idxd_device *idxd)
    {
    idxd_cmd_exec(idxd, IDXD_CMD_RESET_DEVICE, 0, core::ptr::null_mut());
    idxd_device_clear_state(idxd);
    spin_lock(&idxd.dev_lock);
...
#[no_mangle]
pub unsafe extern "C" fn idxd_device_drain_pasid(idxd: *mut idxd_device, pasid: c_int) {
    ...
    idxd_cmd_exec(idxd, IDXD_CMD_DRAIN_PASID, operand, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn idxd_engines_clear_state(idxd: *mut idxd_device) {
    ...
    engine.group = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn idxd_groups_clear_state(idxd: *mut idxd_device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_device_wqs_clear_state(idxd: *mut idxd_device) {
    static void idxd_device_wqs_clear_state(struct idxd_device *idxd)
    {
    int i;
    for (i = 0; i < idxd.max_wqs; i++) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_device_clear_state(idxd: *mut idxd_device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_device_evl_setup(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_device_evl_free(idxd: *mut idxd_device) {
    ...
    evl_dma = evl.dma;
    evl.log = core::ptr::null_mut();
    evl.size = IDXD_EVL_SIZE_MIN;
    mutex_unlock(&evl.lock);
    dma_free_coherent(dev, evl_log_size, evl_log, evl_dma);
    }
#[no_mangle]
unsafe extern "C" fn idxd_group_config_write(group: *mut idxd_group) {
...
#[no_mangle]
unsafe extern "C" fn idxd_groups_config_write(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_device_pasid_priv_enabled(idxd: *mut idxd_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn idxd_wq_config_write(wq: *mut idxd_wq) -> c_int {
    static int idxd_wq_config_write(struct idxd_wq *wq)
    {
    struct idxd_device *idxd = wq.idxd;
    struct device *dev = &idxd.pdev.dev;
...
// bytes 32-63
    ...
    let mut pos: c_int = n % BITS_PER_LONG_LONG;
    let mut idx: c_int = n / BITS_PER_LONG_LONG;
...
#[no_mangle]
unsafe extern "C" fn idxd_wqs_config_write(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_group_flags_setup(idxd: *mut idxd_device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_engines_setup(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_wqs_setup(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_device_config(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_wq_load_config(wq: *mut idxd_wq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_group_load_config(group: *mut idxd_group) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_device_load_config(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_flush_pending_descs(ie: *mut idxd_irq_entry) {
...
//
    tx = &desc.txd;
    tx.callback = core::ptr::null_mut();
    tx.callback_result = core::ptr::null_mut();
    idxd_dma_complete_txd(desc, ctype, true, core::ptr::null_mut(), core::ptr::null_mut());
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_free_irq(wq: *mut idxd_wq) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_flush_descs(wq: *mut idxd_wq) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_request_irq(wq: *mut idxd_wq) -> c_int {
    ...
    rc = request_threaded_irq(ie.vector, core::ptr::null_mut(), idxd_wq_thread, 0, "idxd-portal", ie);
    if (rc < 0) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_drv_enable_wq(wq: *mut idxd_wq) -> c_int {
...
//
    ...
    let mut pasid: u32 = wq_dedicated(wq) ? idxd.pasid : 0;
    __idxd_wq_set_pasid_locked(wq, pasid);
    }
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn idxd_drv_disable_wq(wq: *mut idxd_wq) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_device_drv_probe(idxd_dev: *mut idxd_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_device_drv_remove(idxd_dev: *mut idxd_dev) {
