...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct idxd_resubmit {
    pub work: work_struct,
    pub desc: *mut idxd_desc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct idxd_int_handle_revoke {
    pub work: work_struct,
    pub idxd: *mut idxd_device,
}

#[no_mangle]
unsafe extern "C" fn idxd_device_reinit(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn idxd_int_handle_revoke_drain(ie: *mut idxd_irq_entry) {
    static void idxd_int_handle_revoke_drain(struct idxd_irq_entry *ie)
    {
    struct idxd_wq *wq = ie_to_wq(ie);
    struct idxd_device *idxd = wq.idxd;
    struct device *dev = &idxd.pdev.dev;
    let mut desc: dsa_hw_desc = {};
    void __iomem *portal;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn idxd_abort_invalid_int_handle_descs(ie: *mut idxd_irq_entry) {
...
#[no_mangle]
unsafe extern "C" fn idxd_int_handle_revoke(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn idxd_evl_fault_work(work: *mut work_struct) {
    ...
    let mut cr_size: c_int = idxd.data.compl_size;
...
#[no_mangle]
unsafe extern "C" fn process_evl_entries(idxd: *mut idxd_device) {
    ...
    let mut ent_size: c_uint = evl_ent_size(idxd);
    u32 size;
    evl_status.bits = 0;
...
#[no_mangle]
unsafe extern "C" fn idxd_device_flr(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn idxd_wqs_flush_descs(idxd: *mut idxd_device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_halt(idxd: *mut idxd_device) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_misc_thread(vec: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    let mut id: c_int = idxd.sw_err.wq_idx;
...
#[no_mangle]
unsafe extern "C" fn idxd_int_handle_resubmit_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_queue_int_handle_resubmit(desc: *mut idxd_desc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn irq_process_pending_llist(irq_entry: *mut idxd_irq_entry) {
    ...
    let mut status: u8 = desc.completion.status & DSA_COMP_STATUS_MASK;
    if (status) {
//
...
#[no_mangle]
unsafe extern "C" fn irq_process_work_list(irq_entry: *mut idxd_irq_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_wq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
