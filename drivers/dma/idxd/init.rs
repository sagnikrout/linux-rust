...
//! Source: drivers/dma/idxd/init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn idxd_setup_interrupts(idxd: *mut idxd_device) -> c_int {
    ...
    rc = request_threaded_irq(ie.vector, core::ptr::null_mut(), idxd_misc_thread, 0, "idxd-misc", ie);
    if (rc < 0) {
...
#[no_mangle]
unsafe extern "C" fn idxd_cleanup_interrupts(idxd: *mut idxd_device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_clean_wqs(idxd: *mut idxd_device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_setup_wqs(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_clean_engines(idxd: *mut idxd_device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_setup_engines(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_clean_groups(idxd: *mut idxd_device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_setup_groups(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_cleanup_internals(idxd: *mut idxd_device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_init_evl(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_setup_internals(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_read_table_offsets(idxd: *mut idxd_device) {
...
#[no_mangle]
pub unsafe extern "C" fn multi_u64_to_bmap(bmap: *mut c_ulong, val: *mut u64, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn idxd_read_caps(idxd: *mut idxd_device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_free(idxd: *mut idxd_device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_enable_system_pasid(idxd: *mut idxd_device) -> c_int {
...
//
    ret = iommu_attach_device_pasid(domain, dev, pasid, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn idxd_disable_system_pasid(idxd: *mut idxd_device) {
    ...
    idxd.sva = core::ptr::null_mut();
    idxd.pasid = IOMMU_PASID_INVALID;
    }
#[no_mangle]
unsafe extern "C" fn idxd_probe(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_cleanup(idxd: *mut idxd_device) {
...
//
#[no_mangle]
unsafe extern "C" fn idxd_bind(drv: *mut device_driver, buf: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idxd_unbind(drv: *mut device_driver, buf: *const c_char) {
...
//
    ...
    if (!saved_group) {
// Free saved groups
    idxd_free_saved(saved_groups, core::ptr::null_mut(), core::ptr::null_mut(), idxd);
    return -ENOMEM;
    }
...
// Free saved groups and engines
    idxd_free_saved(saved_groups, saved_engines, core::ptr::null_mut(),
    idxd);
    return -ENOMEM;
    }
...
// Free saved groups and engines
    idxd_free_saved(saved_groups, saved_engines, core::ptr::null_mut(), idxd);
    return -ENOMEM;
    }
...
#[no_mangle]
unsafe extern "C" fn idxd_reset_prepare(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn idxd_reset_done(pdev: *mut pci_dev) {
...
//
    idxd_pci_probe_alloc(idxd, core::ptr::null_mut(), core::ptr::null_mut());
...
//
    ...
    idxd.idxd_saved = core::ptr::null_mut();
    }
...
//
    ...
    {
    let mut alloc_idxd: bool = idxd ? false : true;
    struct idxd_driver_data *data;
    struct device *dev;
    int rc;
    pdev = idxd ? idxd.pdev : pdev;
    dev = &pdev.dev;
    data = id ? (struct idxd_driver_data *)id.driver_data : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn idxd_pci_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    static int idxd_pci_probe(struct pci_dev *pdev, const struct pci_device_id *id)
    {
    return idxd_pci_probe_alloc(core::ptr::null_mut(), pdev, id);
    }
#[no_mangle]
pub unsafe extern "C" fn idxd_wqs_quiesce(idxd: *mut idxd_device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn idxd_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn idxd_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn idxd_exit_module() -> void __exit {
