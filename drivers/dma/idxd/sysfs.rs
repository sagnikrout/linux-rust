...
//! Source: drivers/dma/idxd/sysfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn idxd_conf_engine_release(dev: *mut device) {
...
// Group attributes
#[no_mangle]
unsafe extern "C" fn idxd_set_free_rdbufs(idxd: *mut idxd_device) {
    ...
    __ATTR(engines, 0444, group_engines_show, core::ptr::null_mut());
    ...
    __ATTR(work_queues, 0444, group_work_queues_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn idxd_conf_group_release(dev: *mut device) {
...
// IDXD work queue attribs
    ...
    __ATTR(clients, 0444, wq_clients_show, core::ptr::null_mut());
    ...
    __ATTR(state, 0444, wq_state_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn total_claimed_wq_size(idxd: *mut idxd_device) -> c_int {
    static int total_claimed_wq_size(struct idxd_device *idxd)
    {
    int i;
    let mut wq_size: c_int = 0;
    for (i = 0; i < idxd.max_wqs; i++) {
    struct idxd_wq *wq = idxd.wqs[i];
    wq_size += wq.size;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: idxd_wq_type_names[IDXD_WQT_KERNEL])) -> else {
    else if (sysfs_streq(buf, idxd_wq_type_names[IDXD_WQT_KERNEL]))
    wq.type = IDXD_WQT_KERNEL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: idxd_wq_type_names[IDXD_WQT_USER])) -> else {
...
// If we are changing queue type, clear the name
    ...
    __ATTR(cdev_minor, 0444, wq_cdev_minor_show, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn __get_sysfs_u64(buf: *const c_char, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wq_max_batch_size_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn wq_ats_disable_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn wq_prs_disable_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn wq_occupancy_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    __ATTR(occupancy, 0444, wq_occupancy_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn op_cap_show_common(dev: *mut device, buf: *mut c_char, opcap_bmap: *mut c_ulong) -> isize {
    ...
    let mut val: c_ulong = opcap_bmap[i];
...
#[no_mangle]
unsafe extern "C" fn idxd_verify_supported_opcap(idxd: *mut idxd_device, opmask: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wq_driver_name_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn idxd_conf_wq_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_conf_device_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn idxd_register_engine_devices(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_register_group_devices(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idxd_register_wq_devices(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_register_devices(idxd: *mut idxd_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn idxd_unregister_devices(idxd: *mut idxd_device) {
