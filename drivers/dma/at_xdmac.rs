...
// Global registers
pub const AT_XDMAC_GTYPE: c_uint = 0x00	/* Global Type Register */;

pub const AT_XDMAC_GCFG: c_uint = 0x04	/* Global Configuration Register */;

    AT_XDMAC_WRHP(0x5))
pub const AT_XDMAC_GWAC: c_uint = 0x08	/* Global Weighted Arbiter Configuration Register */;

pub const AT_XDMAC_GWAC_M2M: c_int = 0;

pub const AT_XDMAC_GIE: c_uint = 0x0C	/* Global Interrupt Enable Register */;
pub const AT_XDMAC_GID: c_uint = 0x10	/* Global Interrupt Disable Register */;
pub const AT_XDMAC_GIM: c_uint = 0x14	/* Global Interrupt Mask Register */;
pub const AT_XDMAC_GIS: c_uint = 0x18	/* Global Interrupt Status Register */;
pub const AT_XDMAC_GE: c_uint = 0x1C	/* Global Channel Enable Register */;
pub const AT_XDMAC_GD: c_uint = 0x20	/* Global Channel Disable Register */;
pub const AT_XDMAC_GS: c_uint = 0x24	/* Global Channel Status Register */;
pub const AT_XDMAC_VERSION: c_uint = 0xFFC	/* XDMAC Version Register */;
// Channel relative registers offsets
pub const AT_XDMAC_CIE: c_uint = 0x00	/* Channel Interrupt Enable Register */;

pub const AT_XDMAC_CID: c_uint = 0x04	/* Channel Interrupt Disable Register */;

pub const AT_XDMAC_CIM: c_uint = 0x08	/* Channel Interrupt Mask Register */;

pub const AT_XDMAC_CIS: c_uint = 0x0C	/* Channel Interrupt Status Register */;

pub const AT_XDMAC_CSA: c_uint = 0x10	/* Channel Source Address Register */;
pub const AT_XDMAC_CDA: c_uint = 0x14	/* Channel Destination Address Register */;
pub const AT_XDMAC_CNDA: c_uint = 0x18	/* Channel Next Descriptor Address Register */;

pub const AT_XDMAC_CNDC: c_uint = 0x1C	/* Channel Next Descriptor Control Register */;

pub const AT_XDMAC_CUBC: c_uint = 0x20	/* Channel Microblock Control Register */;
pub const AT_XDMAC_CBC: c_uint = 0x24	/* Channel Block Control Register */;
pub const AT_XDMAC_CC: c_uint = 0x28	/* Channel Configuration Register */;

pub const AT_XDMAC_CC_DWIDTH_OFFSET: c_int = 11;

pub const AT_XDMAC_CC_DWIDTH_BYTE: c_uint = 0x0;
pub const AT_XDMAC_CC_DWIDTH_HALFWORD: c_uint = 0x1;
pub const AT_XDMAC_CC_DWIDTH_WORD: c_uint = 0x2;
pub const AT_XDMAC_CC_DWIDTH_DWORD: c_uint = 0x3;

pub const AT_XDMAC_CDS_MSP: c_uint = 0x2C	/* Channel Data Stride Memory Set Pattern */;
pub const AT_XDMAC_CSUS: c_uint = 0x30	/* Channel Source Microblock Stride */;
pub const AT_XDMAC_CDUS: c_uint = 0x34	/* Channel Destination Microblock Stride */;
// Microblock control members
pub const AT_XDMAC_MBR_UBC_UBLEN_MAX: c_uint = 0xFFFFFFUL	/* Maximum Microblock Length */;

pub const AT_XDMAC_MAX_CHAN: c_uint = 0x20;

pub const AT_XDMAC_RESIDUE_MAX_RETRIES: c_int = 5;
// Macro flag: #define AT_XDMAC_DMA_BUSWIDTHS\
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct at_xdmac_chan {
    pub chan: dma_chan,
    pub ch_regs: *mut void __iomem,
    pub /: *mut *mut u32 mask; / Channel Mask,
    pub /: *mut *mut u32 cfg; / Channel Configuration Register,
    pub /: *mut *mut u8 perid; / Peripheral ID,
    pub /: *mut *mut u8 perif; / Peripheral Interface,
    pub /: *mut *mut u8 memif; / Memory Interface,
    pub save_cc: u32,
    pub save_cim: u32,
    pub save_cnda: u32,
    pub save_cndc: u32,
...
pub struct at_xdmac {
    ...
    pub save_gim: u32,
    pub save_gs: u32,
    pub at_xdmac_desc_pool: *mut dma_pool,
    pub layout: *const at_xdmac_layout,
    pub chan: [at_xdmac_chan; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct at_xdmac_lld {
    pub /: *mut *mut u32 mbr_nda; / Next Descriptor Member,
    pub /: *mut *mut u32 mbr_ubc; / Microblock Control Member,
    pub /: *mut *mut u32 mbr_sa; / Source Address Member,
    pub /: *mut *mut u32 mbr_da; / Destination Address Member,
    pub /: *mut *mut u32 mbr_cfg; / Configuration Register,
    pub /: *mut *mut u32 mbr_bc; / Block Control Register,
    pub /: *mut *mut u32 mbr_ds; / Data Stride Register,
    pub /: *mut *mut u32 mbr_sus; / Source Microblock Stride Register,
    pub /: *mut *mut u32 mbr_dus; / Destination Microblock Stride Register,
}

// 64-bit alignment needed to update CNDA and CUBC registers in an atomic way.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct at_xdmac_desc {
    pub lld: at_xdmac_lld,
    pub direction: enum dma_transfer_direction,
    pub tx_dma_desc: dma_async_tx_descriptor,
    pub desc_node: list_head,
// Following members are only used by the first descriptor
    pub active_xfer: bool,
    pub xfer_size: c_uint,
    pub descs_list: list_head,
    pub xfer_node: list_head,
...
#[no_mangle]
pub unsafe extern "C" fn at_xdmac_chan_is_cyclic(atchan: *mut at_xdmac_chan) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn at_xdmac_chan_is_paused(atchan: *mut at_xdmac_chan) -> c_int {
    static inline int at_xdmac_chan_is_paused(struct at_xdmac_chan *atchan)
    {
    return test_bit(AT_XDMAC_CHAN_IS_PAUSED, &atchan.status);
    }
#[no_mangle]
pub unsafe extern "C" fn at_xdmac_chan_is_paused_internal(atchan: *mut at_xdmac_chan) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn at_xdmac_chan_is_peripheral_xfer(cfg: u32) -> bool {
    static inline bool at_xdmac_chan_is_peripheral_xfer(u32 cfg)
    {
    return cfg & AT_XDMAC_CC_TYPE_PER_TRAN;
    }
#[no_mangle]
pub unsafe extern "C" fn at_xdmac_get_dwidth(cfg: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_runtime_suspend_descriptors(atchan: *mut at_xdmac_chan) {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_runtime_resume_descriptors(atchan: *mut at_xdmac_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_chan_is_enabled(atchan: *mut at_xdmac_chan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_off(atxdmac: *mut at_xdmac, suspend_descriptors: bool) {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_tx_submit(tx: *mut dma_async_tx_descriptor) -> dma_cookie_t {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_init_used_desc(desc: *mut at_xdmac_desc) {
...
//
#[no_mangle]
unsafe extern "C" fn at_xdmac_check_slave_config(sconfig: *mut dma_slave_config) -> c_int {
    ...
    {
    struct at_xdmac_chan		*atchan = to_at_xdmac_chan(chan);
    struct at_xdmac_desc		*first = core::ptr::null_mut(), *prev = core::ptr::null_mut();
    struct scatterlist		*sg;
    int				i;
    let mut xfer_size: c_uint = 0;
    unsigned long			irqflags;
    struct dma_async_tx_descriptor	*ret = core::ptr::null_mut();
    if (!sgl)
    return core::ptr::null_mut();
...
// Prepare descriptors.
    ...
    struct at_xdmac_desc	*desc = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn at_xdmac_align_width(chan: *mut dma_chan, addr: dma_addr_t) -> u32 {
...
// Chain lld.
    ...
    {
    struct at_xdmac_chan	*atchan = to_at_xdmac_chan(chan);
    struct at_xdmac_desc	*prev = core::ptr::null_mut(), *first = core::ptr::null_mut();
    dma_addr_t		dst_addr, src_addr;
    let mut src_skip: usize = 0, dst_skip = 0, len = 0;
    struct data_chunk	*chunk;
    int			i;
...
// Length of the block is (BLEN+1) microblocks.
    ...
    let mut src_icg: usize = 0, dst_icg = 0;
    struct at_xdmac_desc *desc;
    chunk = xt.sgl + i;
    ...
    struct at_xdmac_chan	*atchan = to_at_xdmac_chan(chan);
    struct at_xdmac_desc	*first = core::ptr::null_mut(), *prev = core::ptr::null_mut();
    let mut remaining_size: usize = len, xfer_size = 0, ublen;
    let mut src_addr: dma_addr_t = src, dst_addr = dest;
    u32			dwidth;
//
...
// Only the first byte of value is to be used according to dmaengine
    ...
    {
    struct at_xdmac_chan	*atchan = to_at_xdmac_chan(chan);
    struct at_xdmac_desc	*desc, *pdesc = core::ptr::null_mut(),
// ppdesc = NULL, *first = NULL;
    struct scatterlist	*sg, *psg = core::ptr::null_mut(), *ppsg = core::ptr::null_mut();
    let mut stride: usize = 0, pstride = 0, len = 0;
    int			i;
    if (!sgl)
    return core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_advance_work(atchan: *mut at_xdmac_chan) {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_handle_cyclic(atchan: *mut at_xdmac_chan) {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_handle_error(atchan: *mut at_xdmac_chan) {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_tasklet(t: *mut tasklet_struct) {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_issue_pending(chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_device_pause_internal(atchan: *mut at_xdmac_chan) {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_device_pause(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_device_resume_internal(atchan: *mut at_xdmac_chan) {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_device_resume(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_device_terminate_all(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_alloc_chan_resources(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_free_chan_resources(chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_axi_config(pdev: *mut platform_device) {
    static void at_xdmac_axi_config(struct platform_device *pdev)
    {
    struct at_xdmac	*atxdmac = (struct at_xdmac *)platform_get_drvdata(pdev);
    let mut dev_m2m: bool = false;
    u32 dma_requests;
...
#[no_mangle]
unsafe extern "C" fn atmel_xdmac_prepare(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn atmel_xdmac_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn atmel_xdmac_resume(dev: *mut device) -> int __maybe_unused {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(_arg: at_xdmac_chan_is_paused(atchan)) -> else {
...
#[no_mangle]
unsafe extern "C" fn atmel_xdmac_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn atmel_xdmac_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_remove(pdev: *mut platform_device) {
    ...
    atmel_xdmac_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn at_xdmac_exit() -> void __exit {
