...
//! Source: drivers/dma/fsl-edma-main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fsl_edma_synchronize(chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma_tx_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma3_err_check(fsl_chan: *mut fsl_edma_chan) {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma3_err_handler_per_chan(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma3_err_handler_shared(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma3_tx_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma2_tx_handler(irq: c_int, devi_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma3_tx_0_15_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t fsl_edma3_tx_0_15_handler(int irq, void *dev_id)
    {
    return fsl_edma3_or_tx_handler(irq, dev_id, 0, 16);
    }
#[no_mangle]
unsafe extern "C" fn fsl_edma3_tx_16_31_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t fsl_edma3_tx_16_31_handler(int irq, void *dev_id)
    {
    return fsl_edma3_or_tx_handler(irq, dev_id, 16, 32);
    }
#[no_mangle]
unsafe extern "C" fn fsl_edma3_or_err_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma_err_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma_srcid_in_use(fsl_edma: *mut fsl_edma_engine, srcid: u32) -> bool {
    ...
    struct fsl_edma_chan *fsl_chan;
    let mut dmamux_nr: u32 = fsl_edma.drvdata.dmamuxs;
    let mut chans_per_mux: c_ulong = fsl_edma.n_chans / dmamux_nr;
...
#[no_mangle]
unsafe extern "C" fn fsl_edma3_irq_init(pdev: *mut platform_device, fsl_edma: *mut fsl_edma_engine) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_disable_clocks(fsl_edma: *mut fsl_edma_engine, nr_clocks: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma3_detach_pd(fsl_edma: *mut fsl_edma_engine) {
...
#[no_mangle]
unsafe extern "C" fn devm_fsl_edma3_detach_pd(data: *mut c_void) {
    static void devm_fsl_edma3_detach_pd(void *data)
    {
    fsl_edma3_detach_pd(data);
    }
#[no_mangle]
unsafe extern "C" fn fsl_edma3_attach_pd(pdev: *mut platform_device, fsl_edma: *mut fsl_edma_engine) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma_probe(pdev: *mut platform_device) -> c_int {
    static int fsl_edma_probe(struct platform_device *pdev)
    {
    struct device_node *np = pdev.dev.of_node;
    struct fsl_edma_engine *fsl_edma;
    const struct fsl_edma_drvdata *drvdata = core::ptr::null_mut();
    u32 chan_mask[2] = {0, 0};
    char clk_name[36];
...
#[no_mangle]
unsafe extern "C" fn fsl_edma_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma_suspend_late(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma_resume_early(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fsl_edma_exit() -> void __exit {
