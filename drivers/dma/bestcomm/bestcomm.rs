...
//! Source: drivers/dma/bestcomm/bestcomm.c
#![no_std]
...
// MPC5200 device tree match tables
    ...
    struct bcom_engine *bcom_eng = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn bcom_engine_init() -> c_int {
...
// ========================================================================
#[no_mangle]
unsafe extern "C" fn mpc52xx_bcom_probe(op: *mut platform_device) -> c_int {
...
// Prepare SRAM
    ofn_sram = of_find_matching_node(core::ptr::null_mut(), mpc52xx_sram_ids);
    if (!ofn_sram) {
    printk(KERN_ERR DRIVER_NAME ": "
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_bcom_remove(op: *mut platform_device) {
