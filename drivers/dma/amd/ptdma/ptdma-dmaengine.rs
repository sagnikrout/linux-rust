...
//! Source: drivers/dma/amd/ptdma/ptdma-dmaengine.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ae4_log_error(d: *mut pt_device, e: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(15: e > 7 && e <=) -> else {
    else if (e > 7 && e <= 15)
    dev_info(d.dev, "AE4DMA error: %s (0x%x)\n", "INVALID DESCRIPTOR", e);
// ERR 16 - 31 represents Firmware errors
#[no_mangle]
pub unsafe extern "C" fn if(31: e > 15 && e <=) -> else {
    else if (e > 15 && e <= 31)
    dev_info(d.dev, "AE4DMA error: %s (0x%x)\n", "FIRMWARE ERROR", e);
// ERR 32 - 63 represents Fatal errors
#[no_mangle]
pub unsafe extern "C" fn if(63: e > 31 && e <=) -> else {
    else if (e > 31 && e <= 63)
    dev_info(d.dev, "AE4DMA error: %s (0x%x)\n", "FATAL ERROR", e);
// ERR 64 - 255 represents PTE errors
#[no_mangle]
pub unsafe extern "C" fn if(255: e > 63 && e <=) -> else {
    else if (e > 63 && e <= 255)
    dev_info(d.dev, "AE4DMA error: %s (0x%x)\n", "PTE ERROR", e);
    else
...
#[no_mangle]
pub unsafe extern "C" fn ae4_check_status_error(ae4cmd_q: *mut ae4_cmd_queue, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pt_free_chan_resources(dma_chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn pt_synchronize(dma_chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn pt_do_cleanup(vd: *mut virt_dma_desc) {
...
#[no_mangle]
unsafe extern "C" fn ae4_core_execute_cmd(desc: *mut ae4dma_desc, ae4cmd_q: *mut ae4_cmd_queue) -> c_int {
    static int ae4_core_execute_cmd(struct ae4dma_desc *desc, struct ae4_cmd_queue *ae4cmd_q)
    {
    let mut soc: bool = FIELD_GET(DWORD0_SOC, desc.dwouv.dw0);
    struct pt_cmd_queue *cmd_q = &ae4cmd_q.cmd_q;
    if (soc) {
...
#[no_mangle]
unsafe extern "C" fn pt_dma_start_desc(desc: *mut pt_dma_desc, chan: *mut pt_dma_chan) -> c_int {
...
// Get the next DMA descriptor on the active list
    ...
    return vd ? to_pt_desc(vd) : core::ptr::null_mut();
    }
...
// Don't handle it twice
    ...
    dmaengine_desc_get_callback_invoke(tx_desc, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn ae4_core_queue_full(cmd_q: *mut pt_cmd_queue) -> bool {
    static inline bool ae4_core_queue_full(struct pt_cmd_queue *cmd_q)
    {
    let mut front_wi: u32 = readl(cmd_q.reg_control + AE4_WR_IDX_OFF);
    let mut rear_ri: u32 = readl(cmd_q.reg_control + AE4_RD_IDX_OFF);
    if (((MAX_CMD_QLEN + front_wi - rear_ri) % MAX_CMD_QLEN)  >= (MAX_CMD_QLEN - 1))
    return true;
    return false;
    }
#[no_mangle]
unsafe extern "C" fn pt_cmd_callback(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pt_cmd_callback_work(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pt_issue_pending(dma_chan: *mut dma_chan) {
    ...
    struct pt_device *pt;
    unsigned long flags;
    let mut engine_is_idle: bool = true;
    pt = chan.pt;
    spin_lock_irqsave(&chan.vc.lock, flags);
    desc = pt_next_dma_desc(chan);
...
#[no_mangle]
unsafe extern "C" fn pt_check_status_trans_ae4(pt: *mut pt_device, cmd_q: *mut pt_cmd_queue) {
...
#[no_mangle]
unsafe extern "C" fn pt_pause(dma_chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt_resume(dma_chan: *mut dma_chan) -> c_int {
    static int pt_resume(struct dma_chan *dma_chan)
    {
    struct pt_dma_chan *chan = to_pt_chan(dma_chan);
    struct pt_dma_desc *desc = core::ptr::null_mut();
    struct pt_device *pt = chan.pt;
    struct pt_cmd_queue *cmd_q;
    unsigned long flags;
    spin_lock_irqsave(&chan.vc.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn pt_terminate_all(dma_chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pt_dmaengine_register(pt: *mut pt_device) -> c_int {
    int pt_dmaengine_register(struct pt_device *pt)
    {
    struct dma_device *dma_dev = &pt.dma_dev;
    struct ae4_cmd_queue *ae4cmd_q = core::ptr::null_mut();
    struct ae4_device *ae4 = core::ptr::null_mut();
    struct pt_dma_chan *chan;
...
#[no_mangle]
pub unsafe extern "C" fn pt_dmaengine_unregister(pt: *mut pt_device) {
