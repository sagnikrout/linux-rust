...
//! Source: drivers/dma/amd/ptdma/ptdma-dev.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pt_log_error(d: *mut pt_device, e: c_int) {
    static void pt_log_error(struct pt_device *d, int e)
    {
    dev_err(d.dev, "PTDMA error: %s (0x%x)\n", pt_error_codes[e], e);
    }
#[no_mangle]
pub unsafe extern "C" fn pt_start_queue(cmd_q: *mut pt_cmd_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn pt_stop_queue(cmd_q: *mut pt_cmd_queue) {
...
#[no_mangle]
unsafe extern "C" fn pt_core_execute_cmd(desc: *mut ptdma_desc, cmd_q: *mut pt_cmd_queue) -> c_int {
    static int pt_core_execute_cmd(struct ptdma_desc *desc, struct pt_cmd_queue *cmd_q)
    {
    let mut soc: bool = FIELD_GET(DWORD0_SOC, desc.dw0);
...
#[no_mangle]
unsafe extern "C" fn pt_do_cmd_complete(data: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn pt_check_status_trans(pt: *mut pt_device, cmd_q: *mut pt_cmd_queue) {
...
#[no_mangle]
unsafe extern "C" fn pt_core_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn pt_core_init(pt: *mut pt_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pt_core_destroy(pt: *mut pt_device) {
