...
//! Source: drivers/dma/amd/ptdma/ptdma-debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pt_debugfs_info_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pt_debugfs_stats_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt_debugfs_queue_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ptdma_debugfs_setup(pt: *mut pt_device) {
