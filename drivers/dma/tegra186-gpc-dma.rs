...
//! Source: drivers/dma/tegra186-gpc-dma.c
#![no_std]
...
pub const TEGRA_GPCDMA_MCSEQ_WRAP_NONE: c_int = 0;
...
pub const TEGRA_GPCDMA_MMIOSEQ_BURST_SHIFT: c_int = 23;

    (GENMASK((fls(bs) - 2), 0) << TEGRA_GPCDMA_MMIOSEQ_BURST_SHIFT)

// Error Status Register
pub const TEGRA_GPCDMA_CHAN_ERR_TYPE_SHIFT: c_int = 8;
pub const TEGRA_GPCDMA_CHAN_ERR_TYPE_MASK: c_uint = 0xF;

    ((err) >> TEGRA_GPCDMA_CHAN_ERR_TYPE_SHIFT) &	\
    TEGRA_GPCDMA_CHAN_ERR_TYPE_MASK)
pub const TEGRA_DMA_BM_FIFO_FULL_ERR: c_uint = 0xF;
pub const TEGRA_DMA_PERIPH_FIFO_FULL_ERR: c_uint = 0xE;
pub const TEGRA_DMA_PERIPH_ID_ERR: c_uint = 0xD;
pub const TEGRA_DMA_STREAM_ID_ERR: c_uint = 0xC;
pub const TEGRA_DMA_MC_SLAVE_ERR: c_uint = 0xB;
pub const TEGRA_DMA_MMIO_SLAVE_ERR: c_uint = 0xA;
//
// If any burst is in flight and DMA paused then this is the time to complete
// on-flight burst and update DMA status register.
//
pub const TEGRA_GPCDMA_BURST_COMPLETE_TIME: c_int = 10;

// Channel base address offset from GPCDMA base address
pub const TEGRA_GPCDMA_CHANNEL_BASE_ADDR_OFFSET: c_uint = 0x10000;
// Default channel mask reserving channel0
pub const TEGRA_GPCDMA_DEFAULT_CHANNEL_MASK: c_uint = 0xfffffffe;
    struct tegra_dma;
...
pub struct tegra_dma_chip_data {
    pub hw_support_pause: bool,
    pub addr_bits: c_uint,
    pub nr_channels: c_uint,
    pub channel_reg_size: c_uint,
    pub max_dma_count: c_uint,
    pub channel_regs: *const tegra_dma_channel_regs,
    pub tdc): *mut *mut int (terminate)(struct tegra_dma_channel,
}
...
pub struct tegra_dma_desc {
    pub cyclic: bool,
    pub bytes_req: c_uint,
    pub bytes_xfer: c_uint,
    pub sg_idx: c_uint,
    pub sg_count: c_uint,
    pub vd: virt_dma_desc,
    pub tdc: *mut tegra_dma_channel,
    pub __counted_by(sg_count): tegra_dma_sg_req sg_req[],
}
...
pub struct tegra_dma {
    ...
    pub sid_m2d_reserved: c_ulong,
    pub sid_d2m_reserved: c_ulong,
    pub chan_mask: u32,
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_dump_chan_regs(tdc: *mut tegra_dma_channel) {
    ...
    let mut sid: c_int = tdc.slave_id;
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_sid_free(tdc: *mut tegra_dma_channel) {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_desc_free(vd: *mut virt_dma_desc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_pause(tdc: *mut tegra_dma_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_device_pause(dc: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_device_resume(dc: *mut dma_chan) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_dma_pause_noerr(tdc: *mut tegra_dma_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_disable(tdc: *mut tegra_dma_channel) {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_configure_next_sg(tdc: *mut tegra_dma_channel) {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_start(tdc: *mut tegra_dma_channel) {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_stop_client(tdc: *mut tegra_dma_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_get_residual(tdc: *mut tegra_dma_channel) -> c_int {
...
// csr = TEGRA_GPCDMA_CSR_DMA_IO2MEM_FC;
    ...
    {
    struct tegra_dma_channel *tdc = to_tegra_dma_chan(dc);
    let mut max_dma_count: c_uint = tdc.tdma.chip_data.max_dma_count;
    struct tegra_dma_sg_req *sg_req;
    struct tegra_dma_desc *dma_desc;
    u32 csr, mc_seq;
...
// Word count reg takes value as (N +1) words
    ...
    struct tegra_dma_channel *tdc = to_tegra_dma_chan(dc);
    let mut max_dma_count: c_uint = tdc.tdma.chip_data.max_dma_count;
    let mut slave_bw: enum dma_slave_buswidth = DMA_SLAVE_BUSWIDTH_UNDEFINED;
    u32 csr, mc_seq, mmio_seq = 0;
    let mut apb_ptr: dma_addr_t = 0;
    struct tegra_dma_sg_req *sg_req;
    struct tegra_dma_desc *dma_desc;
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_chan_synchronize(dc: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_program_sid(tdc: *mut tegra_dma_channel, stream_id: c_int) -> c_int {
    static int tegra_dma_program_sid(struct tegra_dma_channel *tdc, int stream_id)
    {
    let mut reg_val: c_uint = tdc_read(tdc, tdc.regs.mc_seq);
...
unsafe extern "C" fn tegra_dma_probe(pdev: *mut platform_device) -> c_int {
    ...
    {
    const struct tegra_dma_chip_data *cdata = core::ptr::null_mut();
    struct tegra_dma_channel *tdc;
    struct tegra_dma *tdma;
    struct dma_chan *chan;
    struct device *chdev;
    let mut use_iommu_map: bool = false;
    unsigned int i;
    u32 stream_id;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_pm_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_pm_resume(dev: *mut device) -> int __maybe_unused {
