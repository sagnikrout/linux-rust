...
//
pub const AT_DMA_MAX_NR_CHANNELS: c_int = 8;
// Global Configuration Register
pub const AT_DMA_GCFG: c_uint = 0x00;

// Controller Enable Register
pub const AT_DMA_EN: c_uint = 0x04;

// Software Single Request Register
pub const AT_DMA_SREQ: c_uint = 0x08;

// Software Chunk Transfer Request Register
pub const AT_DMA_CREQ: c_uint = 0x0c;

// Software Last Transfer Flag Register
pub const AT_DMA_LAST: c_uint = 0x10;

// Request Synchronization Register
pub const AT_DMA_SYNC: c_uint = 0x14;

// Error, Chained Buffer transfer completed and Buffer transfer completed Interrupt registers
pub const AT_DMA_EBCIER: c_uint = 0x18			/* Enable register */;
pub const AT_DMA_EBCIDR: c_uint = 0x1c			/* Disable register */;
pub const AT_DMA_EBCIMR: c_uint = 0x20			/* Mask Register */;
pub const AT_DMA_EBCISR: c_uint = 0x24			/* Status Register */;
pub const AT_DMA_CBTC_OFFSET: c_int = 8;
pub const AT_DMA_ERR_OFFSET: c_int = 16;

// Channel Handler Enable Register
pub const AT_DMA_CHER: c_uint = 0x28;

// Channel Handler Disable Register
pub const AT_DMA_CHDR: c_uint = 0x2c;

// Channel Handler Status Register
pub const AT_DMA_CHSR: c_uint = 0x30;

// Channel registers base address
pub const AT_DMA_CH_REGS_BASE: c_uint = 0x3c;

// Hardware register offset for each channel
pub const ATC_SADDR_OFFSET: c_uint = 0x00	/* Source Address Register */;
pub const ATC_DADDR_OFFSET: c_uint = 0x04	/* Destination Address Register */;
pub const ATC_DSCR_OFFSET: c_uint = 0x08	/* Descriptor Address Register */;
pub const ATC_CTRLA_OFFSET: c_uint = 0x0c	/* Control A Register */;
pub const ATC_CTRLB_OFFSET: c_uint = 0x10	/* Control B Register */;
pub const ATC_CFG_OFFSET: c_uint = 0x14	/* Configuration Register */;
pub const ATC_SPIP_OFFSET: c_uint = 0x18	/* Src PIP Configuration Register */;
pub const ATC_DPIP_OFFSET: c_uint = 0x1c	/* Dst PIP Configuration Register */;
...
pub const AT_DMA_MEM_IF: c_uint = 0x0		/* interface 0 as memory interface */;
pub const AT_DMA_PER_IF: c_uint = 0x1		/* interface 1 as peripheral interface */;

pub const ATC_FC_MEM2MEM: c_uint = 0x0		/* Mem-to-Mem (DMA) */;
pub const ATC_FC_MEM2PER: c_uint = 0x1		/* Mem-to-Periph (DMA) */;
pub const ATC_FC_PER2MEM: c_uint = 0x2		/* Periph-to-Mem (DMA) */;
pub const ATC_FC_PER2PER: c_uint = 0x3		/* Periph-to-Periph (DMA) */;
pub const ATC_FC_PER2MEM_PER: c_uint = 0x4		/* Periph-to-Mem (Peripheral) */;
pub const ATC_FC_MEM2PER_PER: c_uint = 0x5		/* Mem-to-Periph (Peripheral) */;
pub const ATC_FC_PER2PER_SRCPER: c_uint = 0x6		/* Periph-to-Periph (Src Peripheral) */;
pub const ATC_FC_PER2PER_DSTPER: c_uint = 0x7		/* Periph-to-Periph (Dst Peripheral) */;

pub const ATC_SRC_ADDR_MODE_INCR: c_uint = 0x0		/* Incrementing Mode */;
pub const ATC_SRC_ADDR_MODE_DECR: c_uint = 0x1		/* Decrementing Mode */;
pub const ATC_SRC_ADDR_MODE_FIXED: c_uint = 0x2		/* Fixed Mode */;

pub const ATC_DST_ADDR_MODE_INCR: c_uint = 0x0		/* Incrementing Mode */;
pub const ATC_DST_ADDR_MODE_DECR: c_uint = 0x1		/* Decrementing Mode */;
pub const ATC_DST_ADDR_MODE_FIXED: c_uint = 0x2		/* Fixed Mode */;

// Bitfields in CFG

pub const ATC_FIFOCFG_LARGESTBURST: c_uint = 0x0;
pub const ATC_FIFOCFG_HALFFIFO: c_uint = 0x1;
pub const ATC_FIFOCFG_ENOUGHSPACE: c_uint = 0x2;
// Bitfields in SPIP
...
// more values that are not changed by hardware
    pub ctrlb: u32,
    pub /: *mut *mut u32 dscr; / chain to next lli,
}
...
// Memset temporary buffer
    pub memset_buffer: bool,
    pub memset_paddr: dma_addr_t,
    pub memset_vaddr: *mut c_int,
    pub __counted_by(sglen): atdma_sg sg[],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct at_dma_chan {
    pub vc: virt_dma_chan,
    pub atdma: *mut at_dma,
...
//
#[no_mangle]
pub unsafe extern "C" fn convert_burst(maxburst: *mut u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn convert_buswidth(addr_width: enum dma_slave_buswidth) -> u8 {
...
pub struct at_dma {
    ...
    pub memset_pool: *mut dma_pool,
// AT THE END channels table
    pub chan: [at_dma_chan; ],
}
...
#[no_mangle]
unsafe extern "C" fn vdbg_dump_regs(atchan: *mut at_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn atc_dump_lli(atchan: *mut at_dma_chan, lli: *mut at_lli) {
...
#[no_mangle]
unsafe extern "C" fn atc_setup_irq(atdma: *mut at_dma, chan_id: c_int, on: c_int) {
...
#[no_mangle]
unsafe extern "C" fn atc_enable_chan_irq(atdma: *mut at_dma, chan_id: c_int) {
    static void atc_enable_chan_irq(struct at_dma *atdma, int chan_id)
    {
    atc_setup_irq(atdma, chan_id, 1);
    }
#[no_mangle]
unsafe extern "C" fn atc_disable_chan_irq(atdma: *mut at_dma, chan_id: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn atc_chan_is_enabled(atchan: *mut at_dma_chan) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn atc_chan_is_paused(atchan: *mut at_dma_chan) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn atc_chan_is_cyclic(atchan: *mut at_dma_chan) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn set_lli_eol(desc: *mut at_desc, i: c_uint) {
    static void set_lli_eol(struct at_desc *desc, unsigned int i)
    {
    let mut ctrlb: u32 = desc.sg[i].lli.ctrlb;
    ctrlb &= ~ATC_IEN;
...
// Macro flag: #define ATC_DMA_BUSWIDTHS\
    (BIT(DMA_SLAVE_BUSWIDTH_UNDEFINED) |\
    BIT(DMA_SLAVE_BUSWIDTH_1_BYTE) |\
    BIT(DMA_SLAVE_BUSWIDTH_2_BYTES) |\
    BIT(DMA_SLAVE_BUSWIDTH_4_BYTES))
pub const ATC_MAX_DSCR_TRIALS: c_int = 10;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct at_dma_platform_data {
...
pub struct at_dma_slave {
    ...
    width = 2;
#[no_mangle]
pub unsafe extern "C" fn if(1): !((src | dst | len) &) -> else {
...
#[no_mangle]
unsafe extern "C" fn atdma_lli_chain(desc: *mut at_desc, i: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn atdma_desc_free(vd: *mut virt_dma_desc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn atc_calc_bytes_left(current_len: u32, ctrla: u32) -> u32 {
    static inline u32 atc_calc_bytes_left(u32 current_len, u32 ctrla)
    {
    let mut btsize: u32 = FIELD_GET(ATC_BTSIZE, ctrla);
    let mut src_width: u32 = FIELD_GET(ATC_SRC_WIDTH, ctrla);
//
...
//
    ...
    struct at_desc *desc = core::ptr::null_mut();
    u32 len, ctrla;
    vd = vchan_find_desc(&atchan.vc, cookie);
    if (vd)
    desc = to_atdma_desc(&vd.tx);
#[no_mangle]
pub unsafe extern "C" fn if(cookie: atchan->desc && atchan->desc->vd.tx.cookie ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn atc_handle_error(atchan: *mut at_dma_chan, i: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn at_dma_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// set end-of-link to the last link descriptor of list
    ...
    struct at_lli *lli;
    size_t xfer_count;
    let mut ctrla: u32 = FIELD_PREP(ATC_SRC_WIDTH, 2) | FIELD_PREP(ATC_DST_WIDTH, 2);
...
// (u32*)vaddr = value;
    ...
    let mut dest: dma_addr_t = sg_dma_address(sg);
...
#[no_mangle]
unsafe extern "C" fn atc_pause(chan: *mut dma_chan) -> c_int {
    static int atc_pause(struct dma_chan *chan)
    {
    struct at_dma_chan	*atchan = to_at_dma_chan(chan);
    struct at_dma		*atdma = to_at_dma(chan.device);
    let mut chan_id: c_int = atchan.vc.chan.chan_id;
    unsigned long		flags;
    dev_vdbg(chan2dev(chan), "%s\n", __func__);
...
#[no_mangle]
unsafe extern "C" fn atc_resume(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atc_terminate_all(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atc_issue_pending(chan: *mut dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn atc_alloc_chan_resources(chan: *mut dma_chan) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atc_free_chan_resources(chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn at_dma_filter(chan: *mut dma_chan, slave: *mut c_void) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn at_dma_off(atdma: *mut at_dma) {
...
#[no_mangle]
unsafe extern "C" fn at_dma_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn at_dma_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn at_dma_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn at_dma_prepare(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atc_suspend_cyclic(atchan: *mut at_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn at_dma_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atc_resume_cyclic(atchan: *mut at_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn at_dma_resume_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at_dma_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn at_dma_exit() -> void __exit {
