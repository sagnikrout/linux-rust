...
//! Source: drivers/dma/ti/dma-crossbar.c
#![no_std]
...
pub const TI_XBAR_DRA7: c_int = 0;
pub const TI_XBAR_AM335X: c_int = 1;
...
pub const TI_AM335X_XBAR_LINES: c_int = 64;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_am335x_xbar_data {
    pub iomem: *mut void __iomem,
    pub dmarouter: dma_router,
    pub /: *mut *mut u32 xbar_events; / maximum number of events to select in xbar,
    pub /: *mut *mut u32 dma_requests; / number of DMA requests on eDMA,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_am335x_xbar_map {
    pub dma_line: u16,
    pub mux_val: u8,
}

#[no_mangle]
pub unsafe extern "C" fn ti_am335x_xbar_write(iomem: *mut void __iomem, event: c_int, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn ti_am335x_xbar_free(dev: *mut device, route_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ti_am335x_xbar_probe(pdev: *mut platform_device) -> c_int {
...
pub const TI_DRA7_XBAR_OUTPUTS: c_int = 127;
pub const TI_DRA7_XBAR_INPUTS: c_int = 256;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_dra7_xbar_data {
    pub iomem: *mut void __iomem,
    pub dmarouter: dma_router,
    pub mutex: mutex,
    pub dma_inuse: *mut c_ulong,
    pub /: *mut *mut u16 safe_val; / Value to rest the crossbar lines,
    pub /: *mut *mut u32 xbar_requests; / number of DMA requests connected to XBAR,
    pub /: *mut *mut u32 dma_requests; / number of DMA requests forwarded to DMA,
    pub dma_offset: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_dra7_xbar_map {
    pub xbar_in: u16,
    pub xbar_out: c_int,
}

#[no_mangle]
pub unsafe extern "C" fn ti_dra7_xbar_write(iomem: *mut void __iomem, xbar: c_int, val: u16) {
    static inline void ti_dra7_xbar_write(void __iomem *iomem, int xbar, u16 val)
    {
    writew_relaxed(val, iomem + (xbar * 2));
    }
#[no_mangle]
unsafe extern "C" fn ti_dra7_xbar_free(dev: *mut device, route_data: *mut c_void) {
...
pub const TI_XBAR_EDMA_OFFSET: c_int = 0;
pub const TI_XBAR_SDMA_OFFSET: c_int = 1;
...
#[no_mangle]
pub unsafe extern "C" fn ti_dra7_xbar_reserve(offset: c_int, len: c_int, p: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn ti_dra7_xbar_probe(pdev: *mut platform_device) -> c_int {
    ...
    u32 (*rsv_events)[2];
    let mut nelm: usize = sz / sizeof(*rsv_events);
    int i;
    if (!nelm)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn ti_dma_xbar_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_dmaxbar_init() -> c_int {
