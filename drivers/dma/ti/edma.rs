...
pub const PARM_OPT: c_uint = 0x00;
pub const PARM_SRC: c_uint = 0x04;
pub const PARM_A_B_CNT: c_uint = 0x08;
pub const PARM_DST: c_uint = 0x0c;
pub const PARM_SRC_DST_BIDX: c_uint = 0x10;
pub const PARM_LINK_BCNTRLD: c_uint = 0x14;
pub const PARM_SRC_DST_CIDX: c_uint = 0x18;
pub const PARM_CCNT: c_uint = 0x1c;
pub const PARM_SIZE: c_uint = 0x20;
// Offsets for EDMA CC global channel registers and their shadows
pub const SH_ER: c_uint = 0x00	/* 64 bits */;
pub const SH_ECR: c_uint = 0x08	/* 64 bits */;
pub const SH_ESR: c_uint = 0x10	/* 64 bits */;
pub const SH_CER: c_uint = 0x18	/* 64 bits */;
pub const SH_EER: c_uint = 0x20	/* 64 bits */;
pub const SH_EECR: c_uint = 0x28	/* 64 bits */;
pub const SH_EESR: c_uint = 0x30	/* 64 bits */;
pub const SH_SER: c_uint = 0x38	/* 64 bits */;
pub const SH_SECR: c_uint = 0x40	/* 64 bits */;
pub const SH_IER: c_uint = 0x50	/* 64 bits */;
pub const SH_IECR: c_uint = 0x58	/* 64 bits */;
pub const SH_IESR: c_uint = 0x60	/* 64 bits */;
pub const SH_IPR: c_uint = 0x68	/* 64 bits */;
pub const SH_ICR: c_uint = 0x70	/* 64 bits */;
pub const SH_IEVAL: c_uint = 0x78;
pub const SH_QER: c_uint = 0x80;
pub const SH_QEER: c_uint = 0x84;
pub const SH_QEECR: c_uint = 0x88;
pub const SH_QEESR: c_uint = 0x8c;
pub const SH_QSER: c_uint = 0x90;
pub const SH_QSECR: c_uint = 0x94;
pub const SH_SIZE: c_uint = 0x200;
// Offsets for EDMA CC global registers
pub const EDMA_REV: c_uint = 0x0000;
pub const EDMA_CCCFG: c_uint = 0x0004;
pub const EDMA_QCHMAP: c_uint = 0x0200	/* 8 registers */;
pub const EDMA_DMAQNUM: c_uint = 0x0240	/* 8 registers (4 on OMAP-L1xx) */;
pub const EDMA_QDMAQNUM: c_uint = 0x0260;
pub const EDMA_QUETCMAP: c_uint = 0x0280;
pub const EDMA_QUEPRI: c_uint = 0x0284;
pub const EDMA_EMR: c_uint = 0x0300	/* 64 bits */;
pub const EDMA_EMCR: c_uint = 0x0308	/* 64 bits */;
pub const EDMA_QEMR: c_uint = 0x0310;
pub const EDMA_QEMCR: c_uint = 0x0314;
pub const EDMA_CCERR: c_uint = 0x0318;
pub const EDMA_CCERRCLR: c_uint = 0x031c;
pub const EDMA_EEVAL: c_uint = 0x0320;
pub const EDMA_DRAE: c_uint = 0x0340	/* 4 x 64 bits*/;
pub const EDMA_QRAE: c_uint = 0x0380	/* 4 registers */;
pub const EDMA_QUEEVTENTRY: c_uint = 0x0400	/* 2 x 16 registers */;
pub const EDMA_QSTAT: c_uint = 0x0600	/* 2 registers */;
pub const EDMA_QWMTHRA: c_uint = 0x0620;
pub const EDMA_QWMTHRB: c_uint = 0x0624;
pub const EDMA_CCSTAT: c_uint = 0x0640;
pub const EDMA_M: c_uint = 0x1000	/* global channel registers */;
pub const EDMA_ECR: c_uint = 0x1008;
pub const EDMA_ECRH: c_uint = 0x100C;
pub const EDMA_SHADOW0: c_uint = 0x2000	/* 4 shadow regions */;
pub const EDMA_PARM: c_uint = 0x4000	/* PaRAM entries */;

pub const EDMA_DCHMAP: c_uint = 0x0100  /* 64 registers */;
// CCCFG register
...
//
pub const MAX_NR_SG: c_int = 20;

pub const EDMA_DESCRIPTORS: c_int = 16;

pub const EDMA_CONT_PARAMS_ANY: c_int = 1001;
pub const EDMA_CONT_PARAMS_FIXED_EXACT: c_int = 1002;
pub const EDMA_CONT_PARAMS_FIXED_NOT_EXACT: c_int = 1003;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct edma_pset {
    pub len: u32,
    pub addr: dma_addr_t,
    pub param: edmacc_param,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct edma_desc {
...
// completion callback.
//
    pub processed_stat: c_int,
    pub sg_len: u32,
    pub residue: u32,
    pub residue_stat: u32,
    pub __counted_by(pset_nr): edma_pset pset[],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct edma_chan {
    pub vchan: virt_dma_chan,
    pub node: list_head,
    pub edesc: *mut edma_desc,
    pub ecc: *mut edma_cc,
    pub tc: *mut edma_tc,
    pub ch_num: c_int,
    pub alloced: bool,
    pub hw_triggered: bool,
    pub slot: [c_int; EDMA_MAX_SLOTS],
    pub missed: c_int,
...
pub struct edma_cc {
    pub dev: *mut device,
    pub info: *mut edma_soc_info,
    pub base: *mut void __iomem,
    pub id: c_int,
    pub legacy_mode: bool,
// eDMA3 resource information
    pub num_channels: unsigned,
    pub num_qchannels: unsigned,
    pub num_region: unsigned,
    pub num_slots: unsigned,
    pub num_tc: unsigned,
    pub chmap_exist: bool,
    pub default_queue: enum dma_event_q,
    pub ccint: c_uint,
    pub ccerrint: c_uint,
//
...
//
    pub channels_mask: *mut c_ulong,
    pub dma_slave: dma_device,
    pub dma_memcpy: *mut dma_device,
    pub slave_chans: *mut edma_chan,
    pub tc_list: *mut edma_tc,
    pub dummy_slot: c_int,
}
...
pub const EDMA_BINDING_LEGACY: c_int = 0;
pub const EDMA_BINDING_TPCC: c_int = 1;
...
#[no_mangle]
pub unsafe extern "C" fn edma_read(ecc: *mut edma_cc, offset: c_int) -> c_uint {
    static inline unsigned int edma_read(struct edma_cc *ecc, int offset)
    {
    return (unsigned int)__raw_readl(ecc.base + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn edma_write(ecc: *mut edma_cc, offset: c_int, val: c_int) {
    ...
    unsigned or)
    {
    let mut val: unsigned = edma_read(ecc, offset);
    val &= and;
    val |= or;
    edma_write(ecc, offset, val);
    }
#[no_mangle]
pub unsafe extern "C" fn edma_or(ecc: *mut edma_cc, offset: c_int, or: unsigned) {
    ...
    int priority)
    {
    let mut bit: c_int = queue_no * 4;
    edma_modify(ecc, EDMA_QUEPRI, ~(0x7 << bit), ((priority & 0x7) << bit));
    }
#[no_mangle]
unsafe extern "C" fn edma_set_chmap(echan: *mut edma_chan, slot: c_int) {
    static void edma_set_chmap(struct edma_chan *echan, int slot)
    {
    struct edma_cc *ecc = echan.ecc;
    let mut channel: c_int = EDMA_CHAN_SLOT(echan.ch_num);
    if (ecc.chmap_exist) {
...
#[no_mangle]
unsafe extern "C" fn edma_setup_interrupt(echan: *mut edma_chan, enable: bool) {
    static void edma_setup_interrupt(struct edma_chan *echan, bool enable)
    {
    struct edma_cc *ecc = echan.ecc;
    let mut channel: c_int = EDMA_CHAN_SLOT(echan.ch_num);
    let mut idx: c_int = EDMA_REG_ARRAY_INDEX(channel);
    let mut ch_bit: c_int = EDMA_CHANNEL_BIT(channel);
    if (enable) {
...
//
#[no_mangle]
unsafe extern "C" fn edma_alloc_slot(ecc: *mut edma_cc, slot: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edma_free_slot(ecc: *mut edma_cc, slot: unsigned) {
...
//
#[no_mangle]
unsafe extern "C" fn edma_link(ecc: *mut edma_cc, from: unsigned, to: unsigned) {
...
//
#[no_mangle]
unsafe extern "C" fn edma_start(echan: *mut edma_chan) {
...
#[no_mangle]
unsafe extern "C" fn edma_stop(echan: *mut edma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn edma_pause(echan: *mut edma_chan) {
...
#[no_mangle]
unsafe extern "C" fn edma_resume(echan: *mut edma_chan) {
...
#[no_mangle]
unsafe extern "C" fn edma_trigger_channel(echan: *mut edma_chan) {
...
#[no_mangle]
unsafe extern "C" fn edma_clean_channel(echan: *mut edma_chan) {
...
// Move channel to a specific event queue
    ...
    struct edma_cc *ecc = echan.ecc;
    let mut channel: c_int = EDMA_CHAN_SLOT(echan.ch_num);
    let mut bit: c_int = (channel & 0x7) * 4;
...
#[no_mangle]
unsafe extern "C" fn edma_free_channel(echan: *mut edma_chan) {
...
#[no_mangle]
unsafe extern "C" fn edma_desc_free(vdesc: *mut virt_dma_desc) {
...
#[no_mangle]
unsafe extern "C" fn edma_execute(echan: *mut edma_chan) {
...
#[no_mangle]
unsafe extern "C" fn edma_terminate_all(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edma_synchronize(chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn edma_dma_pause(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edma_dma_resume(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MAX_NR_SG): !((i+1) %) -> else {
...
// Enable transfer complete interrupt if requested
    ...
    enum dma_slave_buswidth dev_width;
    let mut use_intermediate: bool = false;
    u32 burst;
    int i, ret, nslots;
...
#[no_mangle]
unsafe extern "C" fn edma_completion_handler(echan: *mut edma_chan) {
...
#[no_mangle]
unsafe extern "C" fn dma_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn edma_error_handler(echan: *mut edma_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn edma_error_pending(ecc: *mut edma_cc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dma_ccerr_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn edma_alloc_chan_resources(chan: *mut dma_chan) -> c_int {
    static int edma_alloc_chan_resources(struct dma_chan *chan)
    {
    struct edma_chan *echan = to_edma_chan(chan);
    struct edma_cc *ecc = echan.ecc;
    struct device *dev = ecc.dev;
    let mut eventq_no: enum dma_event_q = EVENTQ_DEFAULT;
    int ret;
    if (echan.tc) {
...
#[no_mangle]
unsafe extern "C" fn edma_free_chan_resources(chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn edma_issue_pending(chan: *mut dma_chan) {
...
//
pub const EDMA_MAX_TR_WAIT_LOOPS: c_int = 1000;
#[no_mangle]
unsafe extern "C" fn edma_residue(edesc: *mut edma_desc) -> u32 {
    static u32 edma_residue(struct edma_desc *edesc)
    {
    let mut dst: bool = edesc.direction == DMA_DEV_TO_MEM;
    let mut loop_count: c_int = EDMA_MAX_TR_WAIT_LOOPS;
...
#[no_mangle]
unsafe extern "C" fn edma_is_memcpy_channel(ch_num: c_int, memcpy_channels: *mut i32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn edma_dma_init(ecc: *mut edma_cc, legacy_mode: bool) {
    static void edma_dma_init(struct edma_cc *ecc, bool legacy_mode)
    {
    struct dma_device *s_ddev = &ecc.dma_slave;
    struct dma_device *m_ddev = core::ptr::null_mut();
    ...
    memcpy_channels = core::ptr::null_mut();
    goto ch_setup;
    }
...
// Default queue has the lowest priority
    ...
    void __iomem *xbar;
    s16 (*xbar_chans)[2];
    let mut nelm: usize = sz / sizeof(s16);
...
// Get the list of channels allocated to be used for memcpy
    ...
    let mut nelm: usize = sz / sizeof(s32);
    s32 *memcpy_ch;
    ...
    u32 (*tmp)[2];
    s16 (*rsv_slots)[2];
    let mut nelm: usize = sz / sizeof(*tmp);
    ...
    struct dma_chan *chan = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn edma_probe(pdev: *mut platform_device) -> c_int {
...
// Reset only unused - not reserved - paRAM slots
    ...
    if (!ecc.legacy_mode) {
    let mut lowest_priority: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(-ENODATA: ret == -EOVERFLOW || ret ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn edma_cleanupp_vchan(dmadev: *mut dma_device) {
...
#[no_mangle]
unsafe extern "C" fn edma_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn edma_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edma_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edma_tptc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edma_filter_fn(chan: *mut dma_chan, param: *mut c_void) -> bool {
    static bool edma_filter_fn(struct dma_chan *chan, void *param)
    {
    let mut match: bool = false;
    if (chan.device.dev.driver == &edma_driver.driver) {
    struct edma_chan *echan = to_edma_chan(chan);
    let mut ch_req: unsigned = *(unsigned *)param;
...
#[no_mangle]
unsafe extern "C" fn edma_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edma_exit() -> void __exit {
