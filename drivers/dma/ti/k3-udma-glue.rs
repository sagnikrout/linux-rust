...
//! Source: drivers/dma/ti/k3-udma-glue.c
#![no_std]
...
pub struct k3_udma_glue_tx_channel {
    ...
    pub virq: c_int,
    pub free_pkts: core::sync::atomic::AtomicI32,
...
pub struct k3_udma_glue_rx_channel {
    ...
    pub flow_num: u32,
    pub flows_ready: u32,
    pub /: *mut *mut bool single_fdq; / one FDQ for all flows,
}

#[no_mangle]
unsafe extern "C" fn k3_udma_chan_dev_release(dev: *mut device) {
...
pub const K3_UDMAX_TDOWN_TIMEOUT_US: c_int = 1000;
    static int of_k3_udma_glue_parse(struct device_node *udmax_np,
    struct k3_udma_glue_common *common)
    {
    common.udmax = of_xudma_dev_get(udmax_np, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn k3_udma_glue_dump_tx_chn(tx_chn: *mut k3_udma_glue_tx_channel) {
...
#[no_mangle]
unsafe extern "C" fn k3_udma_glue_cfg_tx_chn(tx_chn: *mut k3_udma_glue_tx_channel) -> c_int {
...
// request and cfg UDMAP TX channel
    ...
    tx_chn.common.chan_dev.parent = core::ptr::null_mut();
    return ret;
    }
    if (xudma_is_pktdma(tx_chn.common.udmax)) {
...
#[no_mangle]
pub unsafe extern "C" fn k3_udma_glue_release_tx_chn(tx_chn: *mut k3_udma_glue_tx_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn k3_udma_glue_enable_tx_chn(tx_chn: *mut k3_udma_glue_tx_channel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn k3_udma_glue_disable_tx_chn(tx_chn: *mut k3_udma_glue_tx_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn k3_udma_glue_tx_get_hdesc_size(tx_chn: *mut k3_udma_glue_tx_channel) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn k3_udma_glue_tx_get_txcq_id(tx_chn: *mut k3_udma_glue_tx_channel) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn k3_udma_glue_tx_get_irq(tx_chn: *mut k3_udma_glue_tx_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k3_udma_glue_cfg_rx_chn(rx_chn: *mut k3_udma_glue_rx_channel) -> c_int {
...
// Default flow + extra ones
    ...
    flow.udma_rflow = core::ptr::null_mut();
    rx_chn.flows_ready--;
    }
...
#[no_mangle]
unsafe extern "C" fn k3_udma_glue_dump_rx_chn(chn: *mut k3_udma_glue_rx_channel) {
...
// request and cfg UDMAP RX channel
    ...
    rx_chn.common.chan_dev.parent = core::ptr::null_mut();
    goto err;
    }
    if (xudma_is_pktdma(rx_chn.common.udmax)) {
// prepare the channel device as coherent
    ...
    if (xudma_is_pktdma(rx_chn.common.udmax)) {
    let mut flow_start: c_int = cfg.flow_id_base;
    int flow_end;
    if (flow_start == -1)
...
#[no_mangle]
pub unsafe extern "C" fn k3_udma_glue_release_rx_chn(rx_chn: *mut k3_udma_glue_rx_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn k3_udma_glue_rx_get_flow_id_base(rx_chn: *mut k3_udma_glue_rx_channel) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn k3_udma_glue_enable_rx_chn(rx_chn: *mut k3_udma_glue_rx_channel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn k3_udma_glue_disable_rx_chn(rx_chn: *mut k3_udma_glue_rx_channel) {
...
#[no_mangle]
unsafe extern "C" fn k3_udma_glue_class_init() -> int __init {
