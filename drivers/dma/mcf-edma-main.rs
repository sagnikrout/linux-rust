...
//! Source: drivers/dma/mcf-edma-main.c
#![no_std]
...
pub const EDMA_CHANNELS: c_int = 64;

#[no_mangle]
unsafe extern "C" fn mcf_edma_tx_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mcf_edma_err_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mcf_edma_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcf_edma_remove(pdev: *mut platform_device) {
...
#[no_mangle]
pub unsafe extern "C" fn mcf_edma_filter_fn(chan: *mut dma_chan, param: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mcf_edma_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mcf_edma_exit() -> void __exit {
