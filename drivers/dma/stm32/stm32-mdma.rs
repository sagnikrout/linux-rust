...
//! Source: drivers/dma/stm32/stm32-mdma.c
#![no_std]
...
pub const STM32_MDMA_GISR0: c_uint = 0x0000 /* MDMA Int Status Reg 1 */;
...
pub const STM32_MDMA_MAX_BUF_LEN: c_int = 128;
pub const STM32_MDMA_MAX_BLOCK_LEN: c_int = 65536;
pub const STM32_MDMA_MAX_CHANNELS: c_int = 32;
pub const STM32_MDMA_MAX_REQUESTS: c_int = 256;
pub const STM32_MDMA_MAX_BURST: c_int = 128;
pub const STM32_MDMA_VERY_HIGH_PRIORITY: c_uint = 0x3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_mdma_chan_config {
    pub request: u32,
    pub priority_level: u32,
    pub transfer_config: u32,
    pub mask_addr: u32,
    pub mask_data: u32,
    pub /: *mut *mut bool m2m_hw; / True when MDMA is triggered by STM32 DMA,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_mdma_hwdesc {
    pub ctcr: u32,
    pub cbndtr: u32,
    pub csar: u32,
    pub cdar: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_mdma_desc_node {
    pub hwdesc: *mut stm32_mdma_hwdesc,
    pub hwdesc_phys: dma_addr_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_mdma_desc {
    pub vdesc: virt_dma_desc,
    pub ccr: u32,
    pub cyclic: bool,
    pub count: u32,
    pub __counted_by(count): stm32_mdma_desc_node node[],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_mdma_dma_config {
    pub /: *mut *mut u32 request; / STM32 DMA channel stream id, triggering MDMA,
    pub /: *mut *mut u32 cmar; / STM32 DMA interrupt flag clear register address,
    pub /: *mut *mut u32 cmdr; / STM32 DMA Transfer Complete flag,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_mdma_chan {
    pub vchan: virt_dma_chan,
    pub desc_pool: *mut dma_pool,
    pub id: u32,
    pub desc: *mut stm32_mdma_desc,
    pub curr_hwdesc: u32,
    pub dma_config: dma_slave_config,
    pub chan_config: stm32_mdma_chan_config,
    pub busy: bool,
    pub mem_burst: u32,
    pub mem_width: u32,
}
...
pub struct stm32_mdma_device {
    ...
    pub nr_channels: u32,
    pub nr_requests: u32,
    pub nr_ahb_addr_masks: u32,
    pub chan_reserved: u32,
    pub chan: [stm32_mdma_chan; STM32_MDMA_MAX_CHANNELS],
    pub __counted_by(nr_ahb_addr_masks): u32 ahb_addr_masks[],
}
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_read(dmadev: *mut stm32_mdma_device, reg: u32) -> u32 {
    static u32 stm32_mdma_read(struct stm32_mdma_device *dmadev, u32 reg)
    {
    return readl_relaxed(dmadev.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn stm32_mdma_write(dmadev: *mut stm32_mdma_device, reg: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_desc_free(vdesc: *mut virt_dma_desc) {
    ...
    {
    let mut max_width: enum dma_slave_buswidth = DMA_SLAVE_BUSWIDTH_8_BYTES;
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_disable_chan(chan: *mut stm32_mdma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_stop(chan: *mut stm32_mdma_chan) {
...
// mdma_ctbr = ctbr;
    ...
    let mut m2m_hw_period: u32 = 0, ccr = 0, ctcr, ctbr;
    int i, ret = 0;
    if (chan_config.m2m_hw)
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_dump_reg(chan: *mut stm32_mdma_chan) {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_start_transfer(chan: *mut stm32_mdma_chan) {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_issue_pending(c: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_pause(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_resume(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_terminate_all(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_synchronize(c: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_xfer_end(chan: *mut stm32_mdma_chan) {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_irq_handler(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_alloc_chan_resources(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_free_chan_resources(c: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_filter_fn(c: *mut dma_chan, fn_param: *mut c_void) -> bool {
...
// Check if chan is marked Secure
    ...
    let mut mask: dma_cap_mask_t = dmadev.ddev.cap_mask;
    struct stm32_mdma_chan *chan;
    struct dma_chan *c;
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_pm_resume(dev: *mut device) -> c_int {
    ...
    stm32_mdma_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn stm32_mdma_init() -> int __init {
