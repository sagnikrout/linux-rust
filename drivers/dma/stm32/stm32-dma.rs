...
//! Source: drivers/dma/stm32/stm32-dma.c
#![no_std]
...
pub const STM32_DMA_LISR: c_uint = 0x0000 /* DMA Low Int Status Reg */;
pub const STM32_DMA_HISR: c_uint = 0x0004 /* DMA High Int Status Reg */;

pub const STM32_DMA_LIFCR: c_uint = 0x0008 /* DMA Low Int Flag Clear Reg */;
pub const STM32_DMA_HIFCR: c_uint = 0x000c /* DMA High Int Flag Clear Reg */;
...
// DMA direction
pub const STM32_DMA_DEV_TO_MEM: c_uint = 0x00;
pub const STM32_DMA_MEM_TO_DEV: c_uint = 0x01;
pub const STM32_DMA_MEM_TO_MEM: c_uint = 0x02;
// DMA priority level
pub const STM32_DMA_PRIORITY_LOW: c_uint = 0x00;
pub const STM32_DMA_PRIORITY_MEDIUM: c_uint = 0x01;
pub const STM32_DMA_PRIORITY_HIGH: c_uint = 0x02;
pub const STM32_DMA_PRIORITY_VERY_HIGH: c_uint = 0x03;
// DMA FIFO threshold selection
pub const STM32_DMA_FIFO_THRESHOLD_1QUARTERFULL: c_uint = 0x00;
pub const STM32_DMA_FIFO_THRESHOLD_HALFFULL: c_uint = 0x01;
pub const STM32_DMA_FIFO_THRESHOLD_3QUARTERSFULL: c_uint = 0x02;
pub const STM32_DMA_FIFO_THRESHOLD_FULL: c_uint = 0x03;
pub const STM32_DMA_FIFO_THRESHOLD_NONE: c_uint = 0x04;
pub const STM32_DMA_MAX_DATA_ITEMS: c_uint = 0xffff;
//
...
pub const STM32_DMA_MAX_CHANNELS: c_uint = 0x08;
pub const STM32_DMA_MAX_REQUEST_ID: c_uint = 0x08;
pub const STM32_DMA_MAX_DATA_PARAM: c_uint = 0x03;

pub const STM32_DMA_MIN_BURST: c_int = 4;
pub const STM32_DMA_MAX_BURST: c_int = 16;
// DMA Features
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_dma_sg_req {
    pub len: u32,
    pub chan_reg: stm32_dma_chan_reg,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_dma_desc {
    pub vdesc: virt_dma_desc,
    pub cyclic: bool,
    pub num_sgs: u32,
    pub __counted_by(num_sgs): stm32_dma_sg_req sg_req[],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_dma_mdma_config {
    pub stream_id: u32,
    pub ifcr: u32,
    pub tcf: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_dma_chan {
    pub vchan: virt_dma_chan,
    pub config_init: bool,
    pub busy: bool,
    pub id: u32,
    pub irq: u32,
    pub desc: *mut stm32_dma_desc,
    pub next_sg: u32,
    ...
    pub trig_mdma: bool,
    pub mdma_config: stm32_dma_mdma_config,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_dma_device {
    pub ddev: dma_device,
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub mem2mem: bool,
    pub chan: [stm32_dma_chan; STM32_DMA_MAX_CHANNELS],
}
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_read(dmadev: *mut stm32_dma_device, reg: u32) -> u32 {
    static u32 stm32_dma_read(struct stm32_dma_device *dmadev, u32 reg)
    {
    return readl_relaxed(dmadev.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn stm32_dma_write(dmadev: *mut stm32_dma_device, reg: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_is_burst_possible(buf_len: u32, threshold: u32) -> bool {
...
//
    ...
    enum dma_slave_buswidth width)
    {
    let mut best_burst: u32 = max_burst;
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_get_burst(chan: *mut stm32_dma_chan, maxburst: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_irq_status(chan: *mut stm32_dma_chan) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_irq_clear(chan: *mut stm32_dma_chan, flags: u32) {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_disable_chan(chan: *mut stm32_dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_stop(chan: *mut stm32_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_terminate_all(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_synchronize(c: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_dump_reg(chan: *mut stm32_dma_chan) {
    static void stm32_dma_dump_reg(struct stm32_dma_chan *chan)
    {
    struct stm32_dma_device *dmadev = stm32_dma_get_dev(chan);
    let mut scr: u32 = stm32_dma_read(dmadev, STM32_DMA_SCR(chan.id));
    let mut ndtr: u32 = stm32_dma_read(dmadev, STM32_DMA_SNDTR(chan.id));
    let mut spar: u32 = stm32_dma_read(dmadev, STM32_DMA_SPAR(chan.id));
    let mut sm0ar: u32 = stm32_dma_read(dmadev, STM32_DMA_SM0AR(chan.id));
    let mut sm1ar: u32 = stm32_dma_read(dmadev, STM32_DMA_SM1AR(chan.id));
    let mut sfcr: u32 = stm32_dma_read(dmadev, STM32_DMA_SFCR(chan.id));
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_sg_inc(chan: *mut stm32_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_start_transfer(chan: *mut stm32_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_configure_next_sg(chan: *mut stm32_dma_chan) {
    static void stm32_dma_configure_next_sg(struct stm32_dma_chan *chan)
    {
    struct stm32_dma_device *dmadev = stm32_dma_get_dev(chan);
    struct stm32_dma_sg_req *sg_req;
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_handle_chan_paused(chan: *mut stm32_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_post_resume_reconfigure(chan: *mut stm32_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_handle_chan_done(chan: *mut stm32_dma_chan, scr: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn if(2: scr & STM32_DMA_SCR_DBM && chan->desc->num_sgs >) -> else {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_chan_irq(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_issue_pending(c: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_pause(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_resume(c: *mut dma_chan) -> c_int {
    static int stm32_dma_resume(struct dma_chan *c)
    {
    struct stm32_dma_chan *chan = to_stm32_dma_chan(c);
    struct stm32_dma_device *dmadev = stm32_dma_get_dev(chan);
    let mut chan_reg: stm32_dma_chan_reg = chan.chan_reg;
    let mut id: u32 = chan.id, scr, ndtr, offset, spar, sm0ar, sm1ar;
    struct stm32_dma_sg_req *sg_req;
    unsigned long flags;
    if (chan.status != DMA_PAUSED)
    return -EPERM;
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_clear_reg(regs: *mut stm32_dma_chan_reg) {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_get_remaining_bytes(chan: *mut stm32_dma_chan) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn stm32_dma_is_current_sg(chan: *mut stm32_dma_chan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_alloc_chan_resources(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_free_chan_resources(c: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_desc_free(vdesc: *mut virt_dma_desc) {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_probe(pdev: *mut platform_device) -> c_int {
    ...
    dmadev.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_pm_resume(dev: *mut device) -> c_int {
    ...
    stm32_dma_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn stm32_dma_init() -> int __init {
