...
//! Source: drivers/dma/tegra20-apb-dma.c
#![no_std]
...
pub const TEGRA_APBDMA_GENERAL: c_uint = 0x0;

pub const TEGRA_APBDMA_CONTROL: c_uint = 0x010;
pub const TEGRA_APBDMA_IRQ_MASK: c_uint = 0x01c;
pub const TEGRA_APBDMA_IRQ_MASK_SET: c_uint = 0x020;
// CSR register
pub const TEGRA_APBDMA_CHAN_CSR: c_uint = 0x00;

pub const TEGRA_APBDMA_CSR_REQ_SEL_SHIFT: c_int = 16;
pub const TEGRA_APBDMA_CSR_REQ_SEL_MASK: c_uint = 0x1F;
pub const TEGRA_APBDMA_CSR_WCOUNT_MASK: c_uint = 0xFFFC;
// STATUS register
pub const TEGRA_APBDMA_CHAN_STATUS: c_uint = 0x004;

pub const TEGRA_APBDMA_STATUS_COUNT_SHIFT: c_int = 2;
pub const TEGRA_APBDMA_STATUS_COUNT_MASK: c_uint = 0xFFFC;
pub const TEGRA_APBDMA_CHAN_CSRE: c_uint = 0x00C;

// AHB memory address
pub const TEGRA_APBDMA_CHAN_AHBPTR: c_uint = 0x010;
// AHB sequence register
pub const TEGRA_APBDMA_CHAN_AHBSEQ: c_uint = 0x14;

pub const TEGRA_APBDMA_AHBSEQ_WRAP_SHIFT: c_int = 16;
pub const TEGRA_APBDMA_AHBSEQ_WRAP_NONE: c_int = 0;
// APB address
pub const TEGRA_APBDMA_CHAN_APBPTR: c_uint = 0x018;
// APB sequence register
pub const TEGRA_APBDMA_CHAN_APBSEQ: c_uint = 0x01c;

// Tegra148 specific registers
pub const TEGRA_APBDMA_CHAN_WCOUNT: c_uint = 0x20;
pub const TEGRA_APBDMA_CHAN_WORD_TRANSFER: c_uint = 0x24;
//
// If any burst is in flight and DMA paused then this is the time to complete
// on-flight burst and update DMA status register.
//
pub const TEGRA_APBDMA_BURST_COMPLETE_TIME: c_int = 20;
// Channel base address offset from APBDMA base address
pub const TEGRA_APBDMA_CHANNEL_BASE_ADD_OFFSET: c_uint = 0x1000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_dma_chip_data {
    pub nr_channels: c_uint,
    pub channel_reg_size: c_uint,
    pub max_dma_count: c_uint,
    pub support_channel_pause: bool,
    pub support_separate_wcount_reg: bool,
}

// DMA channel registers
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_dma_channel_regs {
    pub csr: u32,
    pub ahb_ptr: u32,
    pub apb_ptr: u32,
    pub ahb_seq: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_dma_sg_req {
    pub ch_regs: tegra_dma_channel_regs,
    pub req_len: c_uint,
    pub configured: bool,
    pub last_sg: bool,
    pub node: list_head,
    pub dma_desc: *mut tegra_dma_desc,
    pub words_xferred: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_dma_desc {
    pub txd: dma_async_tx_descriptor,
    pub bytes_requested: c_uint,
    pub bytes_transferred: c_uint,
    pub dma_status: enum dma_status,
    pub node: list_head,
    pub tx_list: list_head,
    pub cb_node: list_head,
    pub cb_count: c_uint,
}
...
pub struct tegra_dma_channel {
    ...
    pub lock: spinlock_t,
    pub busy: bool,
    pub tdma: *mut tegra_dma,
    pub cyclic: bool,
// Different lists for managing the requests
    pub free_sg_req: list_head,
    pub pending_sg_req: list_head,
    pub free_dma_desc: list_head,
    pub cb_desc: list_head,
// ISR handler and tasklet for bottom half of isr handling
    pub isr_handler: dma_isr_handler,
    pub tasklet: tasklet_struct,
// Channel-slave specific configuration
    pub slave_id: c_uint,
    pub dma_sconfig: dma_slave_config,
    pub channel_reg: tegra_dma_channel_regs,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_dma {
    pub dma_dev: dma_device,
    pub dev: *mut device,
    pub dma_clk: *mut clk,
    pub rst: *mut reset_control,
    pub global_lock: spinlock_t,
    pub base_addr: *mut void __iomem,
    pub chip_data: *const tegra_dma_chip_data,
//
// Counter for managing global pausing of the DMA controller.
// Only applicable for devices that don't support individual
// channel pausing.
//
    pub global_pause_count: u32,
// Last member of the structure
    pub channels: [tegra_dma_channel; ],
}

#[no_mangle]
pub unsafe extern "C" fn tdma_write(tdma: *mut tegra_dma, reg: u32, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn tdc_read(tdc: *mut tegra_dma_channel, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_global_resume(tdc: *mut tegra_dma_channel) {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_resume(tdc: *mut tegra_dma_channel) {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_stop(tdc: *mut tegra_dma_channel) {
...
#[no_mangle]
unsafe extern "C" fn tdc_start_head_req(tdc: *mut tegra_dma_channel) {
...
#[no_mangle]
unsafe extern "C" fn tdc_configure_next_head_desc(tdc: *mut tegra_dma_channel) {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_abort_all(tdc: *mut tegra_dma_channel) {
...
// Add in cb list if it is not there.
    ...
    tdc.isr_handler = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_tasklet(t: *mut tasklet_struct) {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_tx_submit(txd: *mut dma_async_tx_descriptor) -> dma_cookie_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_issue_pending(dc: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_terminate_all(dc: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_eoc_interrupt_deasserted(tdc: *mut tegra_dma_channel) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_synchronize(dc: *mut dma_chan) {
...
pub unsafe extern "C" fn if(0x1: (len >> 4) &) -> else {
    ...
    return TEGRA_APBDMA_AHBSEQ_BURST_1;
#[no_mangle]
pub unsafe extern "C" fn if(8: burst_ahb_width <) -> else {
...
// csr = 0;
    ...
    u32 len)
    {
    let mut len_field: u32 = (len - 4) & 0xFFFC;
    if (tdc.tdma.chip_data.support_separate_wcount_reg)
    ...
    {
    struct tegra_dma_channel *tdc = to_tegra_dma_chan(dc);
    struct tegra_dma_sg_req *sg_req = core::ptr::null_mut();
...
//
    ...
    enum dma_slave_buswidth slave_bw;
    struct tegra_dma_desc *dma_desc;
    let mut mem: dma_addr_t = buf_addr;
    unsigned int burst_size;
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_alloc_chan_resources(dc: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_free_chan_resources(dc: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_init_hw(tdma: *mut tegra_dma) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_probe(pdev: *mut platform_device) -> c_int {
    ...
    tdma.dma_clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_dev_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_dma_dev_resume(dev: *mut device) -> int __maybe_unused {
