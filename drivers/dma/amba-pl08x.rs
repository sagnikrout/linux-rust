...
//! Source: drivers/dma/amba-pl08x.c
#![no_std]
...
pub struct pl08x_phy_chan {
    ...
    pub reg_config: *mut void __iomem,
    pub reg_control: *mut void __iomem,
    pub reg_src: *mut void __iomem,
    pub reg_dst: *mut void __iomem,
    pub reg_lli: *mut void __iomem,
    pub reg_busy: *mut void __iomem,
    pub lock: spinlock_t,
...
pub struct pl08x_txd {
    ...
    pub dsg_list: list_head,
    pub llis_bus: dma_addr_t,
    pub llis_va: *mut u32,
...
pub struct pl08x_dma_chan {
    ...
    pub cd: *mut pl08x_channel_data,
    pub cfg: dma_slave_config,
    pub at: *mut pl08x_txd,
    pub host: *mut pl08x_driver_data,
    pub state: enum pl08x_dma_chan_state,
    pub slave: bool,
    pub signal: c_int,
    pub mux_use: unsigned,
    pub waiting_at: c_ulong,
}
...
pub struct pl08x_driver_data {
    ...
    pub memcpy: dma_device,
    pub has_slave: bool,
    pub base: *mut void __iomem,
    pub adev: *mut amba_device,
    pub vd: *const vendor_data,
    pub pd: *mut pl08x_platform_data,
...
pub const PL080_LLI_SRC: c_int = 0;
pub const PL080_LLI_DST: c_int = 1;
pub const PL080_LLI_LLI: c_int = 2;
pub const PL080_LLI_CCTL: c_int = 3;
pub const PL080S_LLI_CCTL2: c_int = 4;
// Total words in an LLI.
pub const PL080_LLI_WORDS: c_int = 4;
pub const PL080S_LLI_WORDS: c_int = 8;
//
// Number of LLIs in each LLI buffer allocated for one transfer
// (maximum times we call dma_pool_alloc on this pool without freeing)
//
pub const MAX_NUM_TSFR_LLIS: c_int = 512;
pub const PL08X_ALIGN: c_int = 8;
...
//
#[no_mangle]
unsafe extern "C" fn pl08x_request_mux(plchan: *mut pl08x_dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl08x_release_mux(plchan: *mut pl08x_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn pl08x_phy_channel_busy(ch: *mut pl08x_phy_chan) -> c_int {
...
//
    ...
    let mut llictl: u32 = lli[PL080_LLI_CCTL];
    let mut val: u32 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn pl08x_start_next_txd(plchan: *mut pl08x_dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn pl08x_pause_phy_chan(ch: *mut pl08x_phy_chan) {
...
#[no_mangle]
unsafe extern "C" fn pl08x_resume_phy_chan(ch: *mut pl08x_phy_chan) {
...
#[no_mangle]
unsafe extern "C" fn get_bytes_in_phy_channel(ch: *mut pl08x_phy_chan) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn get_bytes_in_lli(ch: *mut pl08x_phy_chan, llis_va: *const u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pl08x_getbytes_chan(plchan: *mut pl08x_dma_chan) -> u32 {
...
//
    ...
    {
    struct pl08x_phy_chan *ch = core::ptr::null_mut();
    unsigned long flags;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn pl08x_phy_alloc_and_start(plchan: *mut pl08x_dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn pl08x_phy_free(plchan: *mut pl08x_dma_chan) {
...
// No more jobs, so free up the physical channel
    ...
    plchan.phychan = core::ptr::null_mut();
...
//
    ...
    {
    let mut offset: u32 = num_llis * pl08x.lli_words;
    u32 *llis_va = bd.txd.llis_va + offset;
    let mut llis_bus: dma_addr_t = bd.txd.llis_bus;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !IS_BUS_ALIGNED(mbus)) -> else {
...
#[no_mangle]
unsafe extern "C" fn pl08x_desc_free(vd: *mut virt_dma_desc) {
...
//
#[no_mangle]
unsafe extern "C" fn pl08x_free_chan_resources(chan: *mut dma_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn pl08x_select_bus(ftdmac020: bool, src: u8, dst: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pl08x_cctl(cctl: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pl08x_width(width: enum dma_slave_buswidth) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pl08x_burst(maxburst: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn pl08x_issue_pending(chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn pl08x_memcpy_cctl(pl08x: *mut pl08x_driver_data) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pl08x_ftdmac020_memcpy_cctl(pl08x: *mut pl08x_driver_data) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pl08x_terminate_all(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl08x_synchronize(chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn pl08x_pause(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl08x_resume(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pl08x_filter_id(chan: *mut dma_chan, chan_id: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pl08x_filter_fn(chan: *mut dma_chan, chan_id: *mut c_void) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn pl08x_ensure_on(pl08x: *mut pl08x_driver_data) {
...
#[no_mangle]
unsafe extern "C" fn pl08x_irq(irq: c_int, dev: *mut c_void) -> irqreturn_t {
    static irqreturn_t pl08x_irq(int irq, void *dev)
    {
    struct pl08x_driver_data *pl08x = dev;
    let mut mask: u32 = 0, err, tc, i;
...
#[no_mangle]
unsafe extern "C" fn pl08x_dma_slave_init(chan: *mut pl08x_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn pl08x_free_virtual_channels(dmadev: *mut dma_device) {
    static void pl08x_free_virtual_channels(struct dma_device *dmadev)
    {
    struct pl08x_dma_chan *chan = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pl08x_debugfs_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_pl08x_debugfs(pl08x: *mut pl08x_driver_data) {
    static void init_pl08x_debugfs(struct pl08x_driver_data *pl08x)
    {
// Expose a simple debugfs interface to view all clocks
    debugfs_create_file(dev_name(&pl08x.adev.dev), S_IFREG | S_IRUGO,
    core::ptr::null_mut(), pl08x, &pl08x_debugfs_fops);
    }

#[no_mangle]
pub unsafe extern "C" fn init_pl08x_debugfs(pl08x: *mut pl08x_driver_data) {
...
// Augment channel data for applicable AHB buses
    ...
    struct pl08x_channel_data *chanp = core::ptr::null_mut();
    u32 val;
    int ret;
    int i;
...
#[no_mangle]
unsafe extern "C" fn pl08x_probe(adev: *mut amba_device, id: *const amba_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl08x_init() -> int __init {
