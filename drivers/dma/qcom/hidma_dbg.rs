...
//! Source: drivers/dma/qcom/hidma_dbg.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hidma_ll_chstats(s: *mut seq_file, llhndl: *mut c_void, tre_ch: u32) {
...
#[no_mangle]
unsafe extern "C" fn hidma_ll_devstats(s: *mut seq_file, llhndl: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn hidma_chan_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hidma_dma_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hidma_debug_uninit(dmadev: *mut hidma_dev) {
    void hidma_debug_uninit(struct hidma_dev *dmadev)
    {
    debugfs_remove_recursive(dmadev.debugfs);
    }
#[no_mangle]
pub unsafe extern "C" fn hidma_debug_init(dmadev: *mut hidma_dev) {
    void hidma_debug_init(struct hidma_dev *dmadev)
    {
    let mut chidx: c_int = 0;
    struct list_head *position = core::ptr::null_mut();
    struct dentry *dir;
