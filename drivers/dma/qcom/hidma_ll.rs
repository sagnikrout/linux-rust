...
//! Source: drivers/dma/qcom/hidma_ll.c
#![no_std]
...
pub const HIDMA_TRCA_CTRLSTS_REG: c_uint = 0x000;
pub const HIDMA_TRCA_RING_LOW_REG: c_uint = 0x008;
pub const HIDMA_TRCA_RING_HIGH_REG: c_uint = 0x00C;
pub const HIDMA_TRCA_RING_LEN_REG: c_uint = 0x010;
pub const HIDMA_TRCA_DOORBELL_REG: c_uint = 0x400;
pub const HIDMA_EVCA_CTRLSTS_REG: c_uint = 0x000;
pub const HIDMA_EVCA_INTCTRL_REG: c_uint = 0x004;
pub const HIDMA_EVCA_RING_LOW_REG: c_uint = 0x008;
pub const HIDMA_EVCA_RING_HIGH_REG: c_uint = 0x00C;
pub const HIDMA_EVCA_RING_LEN_REG: c_uint = 0x010;
pub const HIDMA_EVCA_WRITE_PTR_REG: c_uint = 0x020;
pub const HIDMA_EVCA_DOORBELL_REG: c_uint = 0x400;
pub const HIDMA_EVCA_IRQ_STAT_REG: c_uint = 0x100;
pub const HIDMA_EVCA_IRQ_CLR_REG: c_uint = 0x108;
pub const HIDMA_EVCA_IRQ_EN_REG: c_uint = 0x110;
pub const HIDMA_EVRE_CFG_IDX: c_int = 0;
pub const HIDMA_EVRE_ERRINFO_BIT_POS: c_int = 24;
pub const HIDMA_EVRE_CODE_BIT_POS: c_int = 28;

pub const HIDMA_CH_STATE_BIT_POS: c_uint = 0x8;
pub const HIDMA_IRQ_EV_CH_EOB_IRQ_BIT_POS: c_int = 0;
pub const HIDMA_IRQ_EV_CH_WR_RESP_BIT_POS: c_int = 1;
pub const HIDMA_IRQ_TR_CH_TRE_RD_RSP_ER_BIT_POS: c_int = 9;
pub const HIDMA_IRQ_TR_CH_DATA_RD_ER_BIT_POS: c_int = 10;
pub const HIDMA_IRQ_TR_CH_DATA_WR_ER_BIT_POS: c_int = 11;
pub const HIDMA_IRQ_TR_CH_INVALID_TRE_BIT_POS: c_int = 14;
...
#[no_mangle]
unsafe extern "C" fn hidma_is_chan_enabled(state: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hidma_ll_free(lldev: *mut hidma_lldev, tre_ch: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn hidma_ll_tre_complete(t: *mut tasklet_struct) {
...
// call the user if it has been read by the hardware
    ...
    lldev.pending_tre_list[tre.tre_index] = core::ptr::null_mut();
//
...
//
#[no_mangle]
unsafe extern "C" fn hidma_handle_tre_completion(lldev: *mut hidma_lldev) -> c_int {
    static int hidma_handle_tre_completion(struct hidma_lldev *lldev)
    {
    let mut evre_ring_size: u32 = lldev.evre_ring_size;
...
#[no_mangle]
unsafe extern "C" fn hidma_ll_reset(lldev: *mut hidma_lldev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hidma_ll_int_handler_internal(lldev: *mut hidma_lldev, cause: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn hidma_ll_inthandler(chirq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn hidma_ll_inthandler_msi(chirq: c_int, arg: *mut c_void, cause: c_int) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn hidma_ll_enable(lldev: *mut hidma_lldev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hidma_ll_start(lldev: *mut hidma_lldev) {
...
#[no_mangle]
pub unsafe extern "C" fn hidma_ll_isenabled(lldev: *mut hidma_lldev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn hidma_ll_queue_request(lldev: *mut hidma_lldev, tre_ch: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hidma_ll_disable(lldev: *mut hidma_lldev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hidma_ll_setup(lldev: *mut hidma_lldev) -> c_int {
    int hidma_ll_setup(struct hidma_lldev *lldev)
    {
    int rc;
    u64 addr;
    u32 val;
    let mut nr_tres: u32 = lldev.nr_tres;
    atomic_set(&lldev.pending_tre_count, 0);
...
#[no_mangle]
pub unsafe extern "C" fn hidma_ll_setup_irq(lldev: *mut hidma_lldev, msi: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn hidma_ll_uninit(lldev: *mut hidma_lldev) -> c_int {
    ...
    lldev.trepool = core::ptr::null_mut();
    atomic_set(&lldev.pending_tre_count, 0);
    lldev.tre_write_offset = 0;
    rc = hidma_ll_reset(lldev);
//
...
#[no_mangle]
pub unsafe extern "C" fn hidma_ll_status(lldev: *mut hidma_lldev, tre_ch: u32) -> enum dma_status {
    enum dma_status hidma_ll_status(struct hidma_lldev *lldev, u32 tre_ch)
    {
    let mut ret: enum dma_status = DMA_ERROR;
    struct hidma_tre *tre;
    unsigned long flags;
    u8 err_code;
    spin_lock_irqsave(&lldev.lock, flags);
    ...
    ret = DMA_COMPLETE;
#[no_mangle]
pub unsafe extern "C" fn if(HIDMA_EVRE_STATUS_ERROR: err_code &) -> else {
