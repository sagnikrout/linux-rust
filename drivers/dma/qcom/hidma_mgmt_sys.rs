...
//! Source: drivers/dma/qcom/hidma_mgmt_sys.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidma_chan_attr {
    pub mdev: *mut hidma_mgmt_dev,
    pub index: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidma_mgmt_fileinfo {
    pub name: *mut c_char,
    pub mode: c_int,
    pub mdev): *mut *mut int (get)(struct hidma_mgmt_dev,
    pub val): *mut *mut *mut int (set)(struct hidma_mgmt_dev mdev, u64,
}
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(attr->attr.name, 0: "weight") ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn create_sysfs_entry(dev: *mut hidma_mgmt_dev, name: *mut c_char, mode: c_int) -> c_int {
