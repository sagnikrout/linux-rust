...
//! Source: drivers/dma/milbeaut-hdmac.c
#![no_std]
...
pub const MLB_HDMAC_DMACR: c_uint = 0x0	/* global */;

pub const MLB_HDMAC_CH_STRIDE: c_uint = 0x10;
pub const MLB_HDMAC_DMACA: c_uint = 0x0	/* channel */;

pub const MLB_HDMAC_DMACB: c_uint = 0x4;

pub const HDMAC_PAUSE: c_uint = 0x7;

pub const MLB_HDMAC_DMACSA: c_uint = 0x8;
pub const MLB_HDMAC_DMACDA: c_uint = 0xc;

    BIT(DMA_SLAVE_BUSWIDTH_2_BYTES) | \
    BIT(DMA_SLAVE_BUSWIDTH_4_BYTES))
#[repr(C)]
#[derive(Copy, Clone)]
pub struct milbeaut_hdmac_desc {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct milbeaut_hdmac_chan {
    pub vc: virt_dma_chan,
    pub mdev: *mut milbeaut_hdmac_device,
    pub md: *mut milbeaut_hdmac_desc,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct milbeaut_hdmac_device {
    pub ddev: dma_device,
    pub clk: *mut clk,
    pub reg_base: *mut void __iomem,
    pub channels: [milbeaut_hdmac_chan; ],
}
...
#[no_mangle]
pub unsafe extern "C" fn if(8: burst ==) -> else {
    else if (burst == 8)
    ca |= FIELD_PREP(MLB_HDMAC_BT, 0xd);
#[no_mangle]
pub unsafe extern "C" fn if(4: burst ==) -> else {
    else if (burst == 4)
...
// mc->vc.lock must be held by caller
#[no_mangle]
unsafe extern "C" fn milbeaut_hdmac_start(mc: *mut milbeaut_hdmac_chan) {
...
#[no_mangle]
unsafe extern "C" fn milbeaut_hdmac_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn milbeaut_hdmac_free_chan_resources(chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn milbeaut_hdmac_chan_pause(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn milbeaut_hdmac_chan_resume(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn milbeaut_hdmac_terminate_all(chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn milbeaut_hdmac_synchronize(chan: *mut dma_chan) {
    ...
    struct milbeaut_hdmac_desc *md = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn milbeaut_hdmac_issue_pending(chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn milbeaut_hdmac_desc_free(vd: *mut virt_dma_desc) {
...
#[no_mangle]
unsafe extern "C" fn milbeaut_hdmac_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn milbeaut_hdmac_remove(pdev: *mut platform_device) {
