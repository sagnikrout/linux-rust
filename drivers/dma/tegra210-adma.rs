...
//! Source: drivers/dma/tegra210-adma.c
#![no_std]
...
pub const ADMA_CH_CMD: c_uint = 0x00;
pub const ADMA_CH_STATUS: c_uint = 0x0c;

pub const ADMA_CH_INT_STATUS: c_uint = 0x10;

pub const ADMA_CH_INT_CLEAR: c_uint = 0x1c;
pub const ADMA_CH_CTRL: c_uint = 0x24;

pub const ADMA_CH_CTRL_DIR_AHUB2MEM: c_int = 2;
pub const ADMA_CH_CTRL_DIR_MEM2AHUB: c_int = 4;

pub const ADMA_CH_CTRL_XFER_PAUSE_SHIFT: c_int = 0;
pub const ADMA_CH_CONFIG: c_uint = 0x28;

pub const ADMA_CH_CONFIG_BURST_SIZE_SHIFT: c_int = 20;
pub const ADMA_CH_CONFIG_MAX_BURST_SIZE: c_int = 16;

pub const ADMA_CH_CONFIG_MAX_BUFS: c_int = 8;

pub const ADMA_GLOBAL_CH_CONFIG: c_uint = 0x400;

pub const TEGRA186_ADMA_GLOBAL_PAGE_CHGRP: c_uint = 0x30;
pub const TEGRA186_ADMA_GLOBAL_PAGE_RX_REQ: c_uint = 0x70;
pub const TEGRA186_ADMA_GLOBAL_PAGE_TX_REQ: c_uint = 0x84;
pub const TEGRA264_ADMA_GLOBAL_PAGE_CHGRP_0: c_uint = 0x44;
pub const TEGRA264_ADMA_GLOBAL_PAGE_CHGRP_1: c_uint = 0x48;
pub const TEGRA264_ADMA_GLOBAL_PAGE_RX_REQ_0: c_uint = 0x100;
pub const TEGRA264_ADMA_GLOBAL_PAGE_RX_REQ_1: c_uint = 0x104;
pub const TEGRA264_ADMA_GLOBAL_PAGE_TX_REQ_0: c_uint = 0x180;
pub const TEGRA264_ADMA_GLOBAL_PAGE_TX_REQ_1: c_uint = 0x184;
pub const TEGRA264_ADMA_GLOBAL_PAGE_OFFSET: c_uint = 0x8;
pub const ADMA_CH_FIFO_CTRL: c_uint = 0x2c;
pub const ADMA_CH_TX_FIFO_SIZE_SHIFT: c_int = 8;
pub const ADMA_CH_RX_FIFO_SIZE_SHIFT: c_int = 0;
pub const ADMA_GLOBAL_CH_FIFO_CTRL: c_uint = 0x300;
pub const ADMA_CH_LOWER_SRC_ADDR: c_uint = 0x34;
pub const ADMA_CH_LOWER_TRG_ADDR: c_uint = 0x3c;
pub const ADMA_CH_TC: c_uint = 0x44;
pub const ADMA_CH_TC_COUNT_MASK: c_uint = 0x3ffffffc;
pub const ADMA_CH_XFER_STATUS: c_uint = 0x54;
pub const ADMA_CH_XFER_STATUS_COUNT_MASK: c_uint = 0xffff;
pub const ADMA_GLOBAL_CMD: c_uint = 0x00;
pub const ADMA_GLOBAL_SOFT_RESET: c_uint = 0x04;
pub const TEGRA_ADMA_BURST_COMPLETE_TIME: c_int = 20;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_adma_chip_data {
    pub burst_size): *mut *mut unsigned int (adma_get_burst_config)(unsigned int,
    pub global_reg_offset: c_uint,
    pub global_int_clear: c_uint,
    pub global_ch_fifo_base: c_uint,
    pub global_ch_config_base: c_uint,
    pub ch_req_tx_shift: c_uint,
    pub ch_req_rx_shift: c_uint,
    pub ch_dir_shift: c_uint,
    pub ch_mode_shift: c_uint,
    pub ch_base_offset: c_uint,
    pub ch_tc_offset_diff: c_uint,
    pub ch_fifo_ctrl: c_uint,
    pub ch_config: c_uint,
    pub ch_req_mask: c_uint,
    pub ch_dir_mask: c_uint,
    pub ch_req_max: c_uint,
    pub ch_reg_size: c_uint,
    pub nr_channels: c_uint,
    pub ch_fifo_size_mask: c_uint,
    pub sreq_index_offset: c_uint,
    pub max_page: c_uint,
    pub tdma): *mut *mut void (set_global_pg_config)(struct tegra_adma,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_adma_chan_regs {
    pub ctrl: c_uint,
    pub config: c_uint,
    pub global_config: c_uint,
    pub src_addr: c_uint,
    pub trg_addr: c_uint,
    pub fifo_ctrl: c_uint,
    pub cmd: c_uint,
    pub tc: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_adma_desc {
    pub vd: virt_dma_desc,
    pub ch_regs: tegra_adma_chan_regs,
    pub buf_len: usize,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_adma_chan {
    pub vc: virt_dma_chan,
    pub desc: *mut tegra_adma_desc,
    pub tdma: *mut tegra_adma,
    pub irq: c_int,
    pub chan_addr: *mut void __iomem,
// Slave channel configuration info
    pub sconfig: dma_slave_config,
    pub sreq_dir: enum dma_transfer_direction,
    pub sreq_index: c_uint,
    pub sreq_reserved: bool,
    pub ch_regs: tegra_adma_chan_regs,
// Transfer count and position info
    pub tx_buf_count: c_uint,
    pub tx_buf_pos: c_uint,
    pub global_ch_fifo_offset: c_uint,
    pub global_ch_config_offset: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_adma {
    pub dma_dev: dma_device,
    pub dev: *mut device,
    pub base_addr: *mut void __iomem,
    pub ch_base_addr: *mut void __iomem,
    pub ahub_clk: *mut clk,
    pub nr_channels: c_uint,
    pub dma_chan_mask: *mut c_ulong,
    pub rx_requests_reserved: c_ulong,
    pub tx_requests_reserved: c_ulong,
// Used to store global command register state when suspending
    pub global_cmd: c_uint,
    pub ch_page_no: c_uint,
    pub cdata: *const tegra_adma_chip_data,
// Last member of the structure
    pub __counted_by(nr_channels): tegra_adma_chan channels[],
}

#[no_mangle]
pub unsafe extern "C" fn tdma_write(tdma: *mut tegra_adma, reg: u32, val: u32) {
    static inline void tdma_write(struct tegra_adma *tdma, u32 reg, u32 val)
    {
    writel(val, tdma.base_addr + tdma.cdata.global_reg_offset + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn tdma_read(tdma: *mut tegra_adma, reg: u32) -> u32 {
    static inline u32 tdma_read(struct tegra_adma *tdma, u32 reg)
    {
    return readl(tdma.base_addr + tdma.cdata.global_reg_offset + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn tdma_ch_global_write(tdma: *mut tegra_adma, reg: u32, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn tdma_ch_write(tdc: *mut tegra_adma_chan, reg: u32, val: u32) {
    static inline void tdma_ch_write(struct tegra_adma_chan *tdc, u32 reg, u32 val)
    {
    writel(val, tdc.chan_addr + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn tdma_ch_read(tdc: *mut tegra_adma_chan, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_desc_free(vd: *mut virt_dma_desc) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_adma_global_page_config(tdma: *mut tegra_adma) {
...
#[no_mangle]
unsafe extern "C" fn tegra264_adma_global_page_config(tdma: *mut tegra_adma) {
    static void tegra264_adma_global_page_config(struct tegra_adma *tdma)
    {
    let mut global_page_offset: u32 = tdma.ch_page_no * TEGRA264_ADMA_GLOBAL_PAGE_OFFSET;
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_init(tdma: *mut tegra_adma) -> c_int {
...
// Enable global ADMA registers
    ...
    let mut sreq_index: c_uint = tdc.sreq_index;
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_request_free(tdc: *mut tegra_adma_chan) {
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_irq_status(tdc: *mut tegra_adma_chan) -> u32 {
    static u32 tegra_adma_irq_status(struct tegra_adma_chan *tdc)
    {
    let mut status: u32 = tdma_ch_read(tdc, ADMA_CH_INT_STATUS);
    return status & ADMA_CH_INT_STATUS_XFER_DONE;
    }
#[no_mangle]
unsafe extern "C" fn tegra_adma_irq_clear(tdc: *mut tegra_adma_chan) -> u32 {
    static u32 tegra_adma_irq_clear(struct tegra_adma_chan *tdc)
    {
    let mut status: u32 = tegra_adma_irq_status(tdc);
    if (status)
    tdma_ch_write(tdc, ADMA_CH_INT_CLEAR, status);
    return status;
    }
#[no_mangle]
unsafe extern "C" fn tegra_adma_stop(tdc: *mut tegra_adma_chan) {
...
// Clear interrupt status
    ...
    tdc.desc = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn tegra_adma_synchronize(dc: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_start(tdc: *mut tegra_adma_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tdc->global_ch_fifo_offset) -> else {
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_get_residue(tdc: *mut tegra_adma_chan) -> c_uint {
    static unsigned int tegra_adma_get_residue(struct tegra_adma_chan *tdc)
    {
    struct tegra_adma_desc *desc = tdc.desc;
    let mut max: c_uint = ADMA_CH_XFER_STATUS_COUNT_MASK + 1;
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_issue_pending(dc: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_is_paused(tdc: *mut tegra_adma_chan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_pause(dc: *mut dma_chan) -> c_int {
    static int tegra_adma_pause(struct dma_chan *dc)
    {
    struct tegra_adma_chan *tdc = to_tegra_adma_chan(dc);
    struct tegra_adma_desc *desc = tdc.desc;
    struct tegra_adma_chan_regs *ch_regs = &desc.ch_regs;
    let mut dcnt: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_resume(dc: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_terminate_all(dc: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_adma_get_burst_config(burst_size: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn tegra186_adma_get_burst_config(burst_size: c_uint) -> c_uint {
...
//
    ...
    {
    struct tegra_adma_chan *tdc = to_tegra_adma_chan(dc);
    struct tegra_adma_desc *desc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_alloc_chan_resources(dc: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_free_chan_resources(dc: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
pub unsafe extern "C" fn if(_arg: tdc->global_ch_fifo_offset) -> else {
    ...
    .sreq_index_offset	= 2,
    .max_page		= 0,
    .set_global_pg_config	= core::ptr::null_mut(),
    };
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_adma_remove(pdev: *mut platform_device) {
    ...
    tegra_adma_runtime_resume, core::ptr::null_mut())
