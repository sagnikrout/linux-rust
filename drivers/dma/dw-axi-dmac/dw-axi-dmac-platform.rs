...
//! Source: drivers/dma/dw-axi-dmac/dw-axi-dmac-platform.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn axi_dma_ioread32(chip: *mut axi_dma_chip, reg: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn axi_dma_ioread64(chip: *mut axi_dma_chip, reg: u32) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn axi_chan_ioread32(chan: *mut axi_dma_chan, reg: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn axi_dma_disable(chip: *mut axi_dma_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn axi_dma_enable(chip: *mut axi_dma_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn axi_dma_irq_disable(chip: *mut axi_dma_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn axi_dma_irq_enable(chip: *mut axi_dma_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn axi_chan_irq_disable(chan: *mut axi_dma_chan, irq_mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn axi_chan_irq_set(chan: *mut axi_dma_chan, irq_mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn axi_chan_irq_sig_set(chan: *mut axi_dma_chan, irq_mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn axi_chan_irq_clear(chan: *mut axi_dma_chan, irq_mask: u32) {
    static inline void axi_chan_irq_clear(struct axi_dma_chan *chan, u32 irq_mask)
    {
    axi_chan_iowrite32(chan, CH_INTCLEAR, irq_mask);
    }
#[no_mangle]
pub unsafe extern "C" fn axi_chan_irq_read(chan: *mut axi_dma_chan) -> u32 {
    static inline u32 axi_chan_irq_read(struct axi_dma_chan *chan)
    {
    return axi_chan_ioread32(chan, CH_INTSTATUS);
    }
#[no_mangle]
pub unsafe extern "C" fn axi_chan_disable(chan: *mut axi_dma_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn axi_chan_enable(chan: *mut axi_dma_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn axi_chan_is_hw_enable(chan: *mut axi_dma_chan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn axi_dma_hw_init(chip: *mut axi_dma_chip) {
    ...
    {
    let mut max_width: u32 = chan.chip.dw.hdata.m_data_width;
...
#[no_mangle]
unsafe extern "C" fn axi_desc_put(desc: *mut axi_dma_desc) {
    static void axi_desc_put(struct axi_dma_desc *desc)
    {
    struct axi_dma_chan *chan = desc.chan;
    let mut count: c_int = desc.nr_hw_descs;
...
#[no_mangle]
unsafe extern "C" fn vchan_desc_put(vdesc: *mut virt_dma_desc) {
...
#[no_mangle]
unsafe extern "C" fn write_desc_llp(desc: *mut axi_dma_hw_desc, adr: dma_addr_t) {
    static void write_desc_llp(struct axi_dma_hw_desc *desc, dma_addr_t adr)
    {
    desc.lli.llp = cpu_to_le64(adr);
    }
#[no_mangle]
unsafe extern "C" fn write_chan_llp(chan: *mut axi_dma_chan, adr: dma_addr_t) {
    static void write_chan_llp(struct axi_dma_chan *chan, dma_addr_t adr)
    {
    axi_chan_iowrite64(chan, CH_LLP, adr);
    }
#[no_mangle]
unsafe extern "C" fn dw_axi_dma_set_byte_halfword(chan: *mut axi_dma_chan, set: bool) {
    static void dw_axi_dma_set_byte_halfword(struct axi_dma_chan *chan, bool set)
    {
    let mut offset: u32 = DMAC_APB_BYTE_WR_CH_EN;
    u32 reg_width, val;
...
// Called in chan locked context
    ...
    {
    let mut priority: u32 = chan.chip.dw.hdata.priority[chan.id];
    let mut config: axi_dma_chan_config = {};
    u32 irq_mask;
...
#[no_mangle]
unsafe extern "C" fn axi_chan_start_first_queued(chan: *mut axi_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn dma_chan_issue_pending(dchan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn dw_axi_dma_synchronize(dchan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn dma_chan_alloc_chan_resources(dchan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_chan_free_chan_resources(dchan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn dw_axi_dma_set_hw_channel(chan: *mut axi_dma_chan, set: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn set_desc_last(desc: *mut axi_dma_hw_desc) {
...
#[no_mangle]
unsafe extern "C" fn write_desc_sar(desc: *mut axi_dma_hw_desc, adr: dma_addr_t) {
    static void write_desc_sar(struct axi_dma_hw_desc *desc, dma_addr_t adr)
    {
    desc.lli.sar = cpu_to_le64(adr);
    }
#[no_mangle]
unsafe extern "C" fn write_desc_dar(desc: *mut axi_dma_hw_desc, adr: dma_addr_t) {
    static void write_desc_dar(struct axi_dma_hw_desc *desc, dma_addr_t adr)
    {
    desc.lli.dar = cpu_to_le64(adr);
    }
#[no_mangle]
unsafe extern "C" fn set_desc_src_master(desc: *mut axi_dma_hw_desc) {
...
// Select AXI1 for source master if available
    ...
    {
    let mut data_width: c_uint = BIT(chan.chip.dw.hdata.m_data_width);
    ...
    {
    struct axi_dma_chan *chan = dchan_to_axi_dma_chan(dchan);
    struct axi_dma_hw_desc *hw_desc = core::ptr::null_mut();
    struct axi_dma_desc *desc = core::ptr::null_mut();
    let mut src_addr: dma_addr_t = dma_addr;
...
//
    ...
    if (chan.chip.dw.hdata.restrict_axi_burst_len) {
    let mut burst_len: u32 = chan.chip.dw.hdata.axi_rw_burst_len;
...
// Managed transfer list
    ...
    {
    if (!desc.lli) {
    dev_err(dchan2dev(&chan.vc.chan), "core::ptr::null_mut() LLI\n");
    return;
    }
    ...
    {
    let mut count: c_int = atomic_read(&chan.descs_allocated);
    int i;
    for (i = 0; i < count; i++)
    axi_chan_dump_lli(chan, &desc_head.hw_desc[i]);
    }
#[no_mangle]
unsafe extern "C" fn axi_chan_handle_err(chan: *mut axi_dma_chan, status: u32) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn axi_chan_block_xfer_complete(chan: *mut axi_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn dw_axi_dma_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(DWAXIDMAC_IRQ_DMA_TRF: status &) -> else {
...
#[no_mangle]
unsafe extern "C" fn dma_chan_terminate_all(dchan: *mut dma_chan) -> c_int {
    static int dma_chan_terminate_all(struct dma_chan *dchan)
    {
    struct axi_dma_chan *chan = dchan_to_axi_dma_chan(dchan);
    let mut chan_active: u32 = BIT(chan.id) << DMAC_CHAN_EN_SHIFT;
    unsigned long flags;
    u32 val;
    int ret;
    LIST_HEAD(head);
...
#[no_mangle]
unsafe extern "C" fn dma_chan_pause(dchan: *mut dma_chan) -> c_int {
...
// Called in chan locked context
#[no_mangle]
pub unsafe extern "C" fn axi_chan_resume(chan: *mut axi_dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn dma_chan_resume(dchan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_dma_suspend(chip: *mut axi_dma_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_dma_resume(chip: *mut axi_dma_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_dma_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn axi_dma_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    struct of_dma *ofdma)
    {
    let mut handshake: c_uint = dma_spec.args[0];
    struct dw_axi_dma *dw = ofdma.of_dma_data;
    struct axi_dma_chan *chan = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn parse_device_properties(chip: *mut axi_dma_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_req_irqs(pdev: *mut platform_device, chip: *mut axi_dma_chip) -> c_int {
    static int axi_req_irqs(struct platform_device *pdev, struct axi_dma_chip *chip)
    {
    let mut irq_count: c_int = platform_irq_count(pdev);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn dw_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_remove(pdev: *mut platform_device) {
...
// Enable clk before accessing to registers
    ...
    SET_RUNTIME_PM_OPS(axi_dma_runtime_suspend, axi_dma_runtime_resume, core::ptr::null_mut())
    };
