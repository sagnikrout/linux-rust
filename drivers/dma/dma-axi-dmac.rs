...
//! Source: drivers/dma/dma-axi-dmac.c
#![no_std]
...
//
pub const AXI_DMAC_REG_INTERFACE_DESC: c_uint = 0x10;

pub const AXI_DMAC_REG_COHERENCY_DESC: c_uint = 0x14;

pub const AXI_DMAC_REG_IRQ_MASK: c_uint = 0x80;
pub const AXI_DMAC_REG_IRQ_PENDING: c_uint = 0x84;
pub const AXI_DMAC_REG_IRQ_SOURCE: c_uint = 0x88;
pub const AXI_DMAC_REG_CTRL: c_uint = 0x400;
pub const AXI_DMAC_REG_TRANSFER_ID: c_uint = 0x404;
pub const AXI_DMAC_REG_START_TRANSFER: c_uint = 0x408;
pub const AXI_DMAC_REG_FLAGS: c_uint = 0x40c;
pub const AXI_DMAC_REG_DEST_ADDRESS: c_uint = 0x410;
pub const AXI_DMAC_REG_DEST_ADDRESS_HIGH: c_uint = 0x490;
pub const AXI_DMAC_REG_SRC_ADDRESS: c_uint = 0x414;
pub const AXI_DMAC_REG_SRC_ADDRESS_HIGH: c_uint = 0x494;
pub const AXI_DMAC_REG_X_LENGTH: c_uint = 0x418;
pub const AXI_DMAC_REG_Y_LENGTH: c_uint = 0x41c;
pub const AXI_DMAC_REG_DEST_STRIDE: c_uint = 0x420;
pub const AXI_DMAC_REG_SRC_STRIDE: c_uint = 0x424;
pub const AXI_DMAC_REG_TRANSFER_DONE: c_uint = 0x428;
pub const AXI_DMAC_REG_ACTIVE_TRANSFER_ID: c_uint = 0x42c;
pub const AXI_DMAC_REG_STATUS: c_uint = 0x430;
pub const AXI_DMAC_REG_CURRENT_SRC_ADDR: c_uint = 0x434;
pub const AXI_DMAC_REG_CURRENT_DEST_ADDR: c_uint = 0x438;
pub const AXI_DMAC_REG_PARTIAL_XFER_LEN: c_uint = 0x44c;
pub const AXI_DMAC_REG_PARTIAL_XFER_ID: c_uint = 0x450;
pub const AXI_DMAC_REG_CURRENT_SG_ID: c_uint = 0x454;
pub const AXI_DMAC_REG_SG_ADDRESS: c_uint = 0x47c;
pub const AXI_DMAC_REG_SG_ADDRESS_HIGH: c_uint = 0x4bc;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct axi_dmac_hw_desc {
    pub flags: u32,
    pub id: u32,
    pub dest_addr: u64,
    pub src_addr: u64,
    pub next_sg_addr: u64,
    pub y_len: u32,
    pub x_len: u32,
    pub src_stride: u32,
    pub dst_stride: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct axi_dmac_sg {
    pub partial_len: c_uint,
    pub schedule_when_free: bool,
    pub hw: *mut axi_dmac_hw_desc,
    pub hw_phys: dma_addr_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct axi_dmac_desc {
    pub vdesc: virt_dma_desc,
    pub chan: *mut axi_dmac_chan,
    pub cyclic: bool,
    pub cyclic_eot: bool,
    pub have_partial_xfer: bool,
    pub num_submitted: c_uint,
    pub num_completed: c_uint,
    pub num_sgs: c_uint,
    pub __counted_by(num_sgs): axi_dmac_sg sg[],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct axi_dmac_chan {
    pub vchan: virt_dma_chan,
    pub next_desc: *mut axi_dmac_desc,
    pub pool: *mut c_void,
    pub active_descs: list_head,
    pub direction: enum dma_transfer_direction,
    pub src_width: c_uint,
    pub dest_width: c_uint,
    pub src_type: c_uint,
    pub dest_type: c_uint,
    pub max_length: c_uint,
    pub address_align_mask: c_uint,
    pub length_align_mask: c_uint,
    pub hw_partial_xfer: bool,
    pub hw_cyclic: bool,
    pub hw_2d: bool,
    pub hw_sg: bool,
    pub hw_cyclic_hotfix: bool,
}
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_check_addr(chan: *mut axi_dmac_chan, addr: dma_addr_t) -> bool {
...
//
    ...
    if (chan.hw_sg) {
    let mut flags: c_ulong = AXI_DMAC_HW_FLAG_IRQ | AXI_DMAC_HW_FLAG_LAST;
//
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_start_transfer(chan: *mut axi_dmac_chan) {
...
// Already queued in cyclic mode. Wait for it to finish
    ...
    if (chan.hw_sg) {
    chan.next_desc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_dequeue_partial_xfers(chan: *mut axi_dmac_chan) {
...
// Check if we have any more partial transfers
    ...
    let mut start: c_uint = active.num_completed - 1;
    struct axi_dmac_sg *sg;
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_interrupt_handler(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_terminate_all(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_synchronize(c: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_issue_pending(c: *mut dma_chan) {
    static void axi_dmac_issue_pending(struct dma_chan *c)
    {
    struct axi_dmac_chan *chan = to_axi_dmac_chan(c);
    struct axi_dmac *dmac = chan_to_axi_dmac(chan);
    unsigned long flags;
    let mut ctrl: u32 = AXI_DMAC_CTRL_ENABLE;
    if (chan.hw_sg)
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_free_desc(desc: *mut axi_dmac_desc) {
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_alloc_chan_resources(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_free_chan_resources(c: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_desc_free(vdesc: *mut virt_dma_desc) {
    static void axi_dmac_desc_free(struct virt_dma_desc *vdesc)
    {
    axi_dmac_free_desc(to_axi_dmac_desc(vdesc));
    }
#[no_mangle]
unsafe extern "C" fn axi_dmac_regmap_rdwr(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_adjust_chan_params(chan: *mut axi_dmac_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn if(axi_dmac_src_is_mem(chan): !axi_dmac_dest_is_mem(chan) &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_parse_dt(dev: *mut device, dmac: *mut axi_dmac) -> c_int {
    static int axi_dmac_parse_dt(struct device *dev, struct axi_dmac *dmac)
    {
    int ret;
    struct device_node *of_channels __free(device_node) = of_get_child_by_name(dev.of_node,
    "adi,channels");
    if (of_channels == core::ptr::null_mut())
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_read_chan_config(dev: *mut device, dmac: *mut axi_dmac) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_detect_caps(dmac: *mut axi_dmac, version: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_dmac_tasklet_kill(task: *mut c_void) {
    static void axi_dmac_tasklet_kill(void *task)
    {
    tasklet_kill(task);
    }
#[no_mangle]
unsafe extern "C" fn axi_dmac_free_dma_controller(of_node: *mut c_void) {
    static void axi_dmac_free_dma_controller(void *of_node)
    {
    of_dma_controller_free(of_node);
    }
#[no_mangle]
unsafe extern "C" fn axi_dmac_probe(pdev: *mut platform_device) -> c_int {
