...
//! Source: drivers/dma/mediatek/mtk-cqdma.c
#![no_std]
...
pub const MTK_CQDMA_USEC_POLL: c_int = 10;
pub const MTK_CQDMA_TIMEOUT_POLL: c_int = 1000;

pub const MTK_CQDMA_ALIGN_SIZE: c_int = 1;
// The default number of virtual channel
pub const MTK_CQDMA_NR_VCHANS: c_int = 32;
// The default number of physical channel
pub const MTK_CQDMA_NR_PCHANS: c_int = 3;
// Registers for underlying dma manipulation
pub const MTK_CQDMA_INT_FLAG: c_uint = 0x0;
pub const MTK_CQDMA_INT_EN: c_uint = 0x4;
pub const MTK_CQDMA_EN: c_uint = 0x8;
pub const MTK_CQDMA_RESET: c_uint = 0xc;
pub const MTK_CQDMA_FLUSH: c_uint = 0x14;
pub const MTK_CQDMA_SRC: c_uint = 0x1c;
pub const MTK_CQDMA_DST: c_uint = 0x20;
pub const MTK_CQDMA_LEN1: c_uint = 0x24;
pub const MTK_CQDMA_LEN2: c_uint = 0x28;
pub const MTK_CQDMA_SRC2: c_uint = 0x60;
pub const MTK_CQDMA_DST2: c_uint = 0x64;
// Registers setting
...
pub struct mtk_cqdma_vdesc {
    ...
    pub ch: *mut dma_chan,
    pub node: list_head,
    pub parent: *mut mtk_cqdma_vdesc,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_cqdma_vchan {
    pub vc: virt_dma_chan,
    pub pc: *mut mtk_cqdma_pchan,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_cqdma_device {
    pub ddev: dma_device,
    pub clk: *mut clk,
    pub dma_requests: u32,
    pub dma_channels: u32,
    pub vc: *mut mtk_cqdma_vchan,
    pub pc: *mut mtk_cqdma_pchan,
}
...
#[no_mangle]
unsafe extern "C" fn mtk_dma_read(pc: *mut mtk_cqdma_pchan, reg: u32) -> u32 {
    static u32 mtk_dma_read(struct mtk_cqdma_pchan *pc, u32 reg)
    {
    return readl(pc.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn mtk_dma_write(pc: *mut mtk_cqdma_pchan, reg: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dma_set(pc: *mut mtk_cqdma_pchan, reg: u32, val: u32) {
    static void mtk_dma_set(struct mtk_cqdma_pchan *pc, u32 reg, u32 val)
    {
    mtk_dma_rmw(pc, reg, 0, val);
    }
#[no_mangle]
unsafe extern "C" fn mtk_dma_clr(pc: *mut mtk_cqdma_pchan, reg: u32, val: u32) {
    static void mtk_dma_clr(struct mtk_cqdma_pchan *pc, u32 reg, u32 val)
    {
    mtk_dma_rmw(pc, reg, val, 0);
    }
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_vdesc_free(vd: *mut virt_dma_desc) {
    static void mtk_cqdma_vdesc_free(struct virt_dma_desc *vd)
    {
    kfree(to_cqdma_vdesc(vd));
    }
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_poll_engine_done(pc: *mut mtk_cqdma_pchan, atomic: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_hard_reset(pc: *mut mtk_cqdma_pchan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_issue_vchan_pending(cvc: *mut mtk_cqdma_vchan) {
    static void mtk_cqdma_issue_vchan_pending(struct mtk_cqdma_vchan *cvc)
    {
    struct virt_dma_desc *vd, *vd2;
    struct mtk_cqdma_pchan *pc = cvc.pc;
    struct mtk_cqdma_vdesc *cvd;
    let mut trigger_engine: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_is_vchan_active(cvc: *mut mtk_cqdma_vchan) -> bool {
...
// mtk_cqdma_consume_work_queue(struct mtk_cqdma_pchan *pc)
    ...
    struct mtk_cqdma_vdesc *cvd, *ret = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_irq(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_issue_pending(c: *mut dma_chan) {
...
// acquire PC's lock before VS's lock for lock dependency in tasklet
    ...
    {
    struct mtk_cqdma_vdesc **cvd;
    struct dma_async_tx_descriptor *tx = core::ptr::null_mut(), *prev_tx = core::ptr::null_mut();
    size_t i, tlen, nr_vd;
//
...
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_free_inactive_desc(c: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_free_active_desc(c: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_terminate_all(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_alloc_chan_resources(c: *mut dma_chan) -> c_int {
    ...
    struct mtk_cqdma_pchan *pc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_free_chan_resources(c: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_hw_init(cqdma: *mut mtk_cqdma_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_hw_deinit(cqdma: *mut mtk_cqdma_device) {
...
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_cqdma_remove(pdev: *mut platform_device) {
