...
//! Source: drivers/dma/mediatek/mtk-hsdma.c
#![no_std]
...
pub const MTK_HSDMA_USEC_POLL: c_int = 20;
pub const MTK_HSDMA_TIMEOUT_POLL: c_int = 200000;

// The default number of virtual channel
pub const MTK_HSDMA_NR_VCHANS: c_int = 3;
// Only one physical channel supported
pub const MTK_HSDMA_NR_MAX_PCHANS: c_int = 1;
// Macro for physical descriptor (PD) manipulation
// The number of PD which must be 2 of power
pub const MTK_DMA_SIZE: c_int = 64;

pub const MTK_HSDMA_MAX_LEN: c_uint = 0x3f80;
pub const MTK_HSDMA_ALIGN_SIZE: c_int = 4;
pub const MTK_HSDMA_PLEN_MASK: c_uint = 0x3fff;

// Registers for underlying ring manipulation
pub const MTK_HSDMA_TX_BASE: c_uint = 0x0;
pub const MTK_HSDMA_TX_CNT: c_uint = 0x4;
pub const MTK_HSDMA_TX_CPU: c_uint = 0x8;
pub const MTK_HSDMA_TX_DMA: c_uint = 0xc;
pub const MTK_HSDMA_RX_BASE: c_uint = 0x100;
pub const MTK_HSDMA_RX_CNT: c_uint = 0x104;
pub const MTK_HSDMA_RX_CPU: c_uint = 0x108;
pub const MTK_HSDMA_RX_DMA: c_uint = 0x10c;
// Registers for global setup
pub const MTK_HSDMA_GLO: c_uint = 0x204;
...
// Registers for reset
pub const MTK_HSDMA_RESET: c_uint = 0x208;

// Registers for interrupt control
pub const MTK_HSDMA_DLYINT: c_uint = 0x20c;
...
pub const MTK_HSDMA_INT_STATUS: c_uint = 0x220;
pub const MTK_HSDMA_INT_ENABLE: c_uint = 0x228;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_hsdma_cb {
    pub vd: *mut virt_dma_desc,
    pub flag: enum mtk_hsdma_vdesc_flag,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_hsdma_ring {
    pub txd: *mut mtk_hsdma_pdesc,
    pub rxd: *mut mtk_hsdma_pdesc,
    pub cb: *mut mtk_hsdma_cb,
    pub tphys: dma_addr_t,
    pub rphys: dma_addr_t,
    pub cur_tptr: u16,
    pub cur_rptr: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_hsdma_pchan {
    pub ring: mtk_hsdma_ring,
    pub sz_ring: usize,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_hsdma_vchan {
    pub vc: virt_dma_chan,
    pub issue_completion: completion,
    pub issue_synchronize: bool,
    pub desc_hw_processing: list_head,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_hsdma_device {
    pub ddev: dma_device,
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub irq: u32,
    pub dma_requests: u32,
    pub vc: *mut mtk_hsdma_vchan,
    pub pc: *mut mtk_hsdma_pchan,
    pub pc_refcnt: refcount_t,
// Lock used to protect against multiple VCs access PC
    pub lock: spinlock_t,
    pub soc: *const mtk_hsdma_soc,
}
...
#[no_mangle]
unsafe extern "C" fn mtk_dma_read(hsdma: *mut mtk_hsdma_device, reg: u32) -> u32 {
    static u32 mtk_dma_read(struct mtk_hsdma_device *hsdma, u32 reg)
    {
    return readl(hsdma.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn mtk_dma_write(hsdma: *mut mtk_hsdma_device, reg: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hsdma_free_rooms_in_ring(hsdma: *mut mtk_hsdma_device) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hsdma_irq(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mtk_hsdma_issue_pending(c: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hsdma_free_inactive_desc(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hsdma_free_active_desc(c: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hsdma_terminate_all(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hsdma_alloc_chan_resources(c: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hsdma_free_chan_resources(c: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hsdma_hw_init(hsdma: *mut mtk_hsdma_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hsdma_hw_deinit(hsdma: *mut mtk_hsdma_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hsdma_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hsdma_remove(pdev: *mut platform_device) {
