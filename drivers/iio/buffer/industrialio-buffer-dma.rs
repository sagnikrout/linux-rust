...
//! Source: drivers/iio/buffer/industrialio-buffer-dma.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn iio_buffer_block_release(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn iio_buffer_block_get(block: *mut iio_dma_buffer_block) {
    static void iio_buffer_block_get(struct iio_dma_buffer_block *block)
    {
    kref_get(&block.kref);
    }
#[no_mangle]
unsafe extern "C" fn iio_buffer_block_put(block: *mut iio_dma_buffer_block) {
...
#[no_mangle]
unsafe extern "C" fn iio_dma_buffer_cleanup_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iio_buffer_block_release_atomic(kref: *mut kref) {
...
//
#[no_mangle]
unsafe extern "C" fn iio_buffer_block_put_atomic(block: *mut iio_dma_buffer_block) {
...
#[no_mangle]
unsafe extern "C" fn _iio_dma_buffer_block_done(block: *mut iio_dma_buffer_block) {
...
#[no_mangle]
unsafe extern "C" fn iio_dma_buffer_queue_wake(queue: *mut iio_dma_buffer_queue) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_dma_buffer_block_done(block: *mut iio_dma_buffer_block) {
...
#[no_mangle]
unsafe extern "C" fn iio_dma_block_reusable(block: *mut iio_dma_buffer_block) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iio_dma_buffer_can_use_fileio(queue: *mut iio_dma_buffer_queue) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_dma_buffer_request_update(buffer: *mut iio_buffer) -> c_int {
    int iio_dma_buffer_request_update(struct iio_buffer *buffer)
    {
    struct iio_dma_buffer_queue *queue = iio_buffer_to_queue(buffer);
    struct iio_dma_buffer_block *block;
    let mut try_reuse: bool = false;
    size_t size;
    int i;
//
...
// Allocations are page aligned
    ...
    queue.fileio.active_block = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn iio_dma_buffer_fileio_free(queue: *mut iio_dma_buffer_queue) {
    ...
    queue.fileio.blocks[i] = core::ptr::null_mut();
    }
    queue.fileio.active_block = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_dma_buffer_enable(buffer: *mut iio_buffer, indio_dev: *mut iio_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_dma_buffer_disable(buffer: *mut iio_buffer, indio_dev: *mut iio_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_dma_buffer_usage(buf: *mut iio_buffer) -> usize {
    size_t iio_dma_buffer_usage(struct iio_buffer *buf)
    {
    struct iio_dma_buffer_queue *queue = iio_buffer_to_queue(buf);
    struct iio_dma_buffer_block *block;
    let mut data_available: usize = 0;
    unsigned int i;
//
...
#[no_mangle]
unsafe extern "C" fn iio_dma_can_enqueue_block(block: *mut iio_dma_buffer_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_dma_buffer_lock_queue(buffer: *mut iio_buffer) {
...
#[no_mangle]
pub unsafe extern "C" fn iio_dma_buffer_unlock_queue(buffer: *mut iio_buffer) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_dma_buffer_set_bytes_per_datum(buffer: *mut iio_buffer, bpd: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_dma_buffer_set_length(buffer: *mut iio_buffer, length: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_dma_buffer_exit(queue: *mut iio_dma_buffer_queue) {
    void iio_dma_buffer_exit(struct iio_dma_buffer_queue *queue)
    {
    guard(mutex)(&queue.lock);
    iio_dma_buffer_fileio_free(queue);
    queue.ops = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_dma_buffer_release(queue: *mut iio_dma_buffer_queue) {
