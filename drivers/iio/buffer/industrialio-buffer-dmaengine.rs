...
//! Source: drivers/iio/buffer/industrialio-buffer-dmaengine.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmaengine_buffer {
    pub queue: iio_dma_buffer_queue,
...
//
#[no_mangle]
unsafe extern "C" fn iio_dmaengine_buffer_has_active_cyclic(dmaengine_buffer: *mut dmaengine_buffer) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iio_dmaengine_buffer_abort(queue: *mut iio_dma_buffer_queue) {
...
#[no_mangle]
unsafe extern "C" fn iio_dmaengine_buffer_release(buf: *mut iio_buffer) {
    ...
    iio_dmaengine_buffer_get_length_align, core::ptr::null_mut(), 0);
...
//
#[no_mangle]
unsafe extern "C" fn iio_dmaengine_buffer_free(buffer: *mut iio_buffer) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_dmaengine_buffer_teardown(buffer: *mut iio_buffer) {
...
#[no_mangle]
unsafe extern "C" fn devm_iio_dmaengine_buffer_teardown(buffer: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn devm_iio_dmaengine_buffer_free(buffer: *mut c_void) {
