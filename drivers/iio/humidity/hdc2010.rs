...
//! Source: drivers/iio/humidity/hdc2010.c
#![no_std]
...
pub const HDC2010_REG_TEMP_LOW: c_uint = 0x00;
pub const HDC2010_REG_TEMP_HIGH: c_uint = 0x01;
pub const HDC2010_REG_HUMIDITY_LOW: c_uint = 0x02;
pub const HDC2010_REG_HUMIDITY_HIGH: c_uint = 0x03;
pub const HDC2010_REG_INTERRUPT_DRDY: c_uint = 0x04;
pub const HDC2010_REG_TEMP_MAX: c_uint = 0x05;
pub const HDC2010_REG_HUMIDITY_MAX: c_uint = 0x06;
pub const HDC2010_REG_INTERRUPT_EN: c_uint = 0x07;
pub const HDC2010_REG_TEMP_OFFSET_ADJ: c_uint = 0x08;
pub const HDC2010_REG_HUMIDITY_OFFSET_ADJ: c_uint = 0x09;
pub const HDC2010_REG_TEMP_THR_L: c_uint = 0x0a;
pub const HDC2010_REG_TEMP_THR_H: c_uint = 0x0b;
pub const HDC2010_REG_RH_THR_L: c_uint = 0x0c;
pub const HDC2010_REG_RH_THR_H: c_uint = 0x0d;
pub const HDC2010_REG_RESET_DRDY_INT_CONF: c_uint = 0x0e;
pub const HDC2010_REG_MEASUREMENT_CONF: c_uint = 0x0f;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdc2010_data {
    pub client: *mut i2c_client,
    pub lock: mutex,
    pub measurement_config: u8,
    pub drdy_config: u8,
}
...
pub struct hdc2010_reg_record {
    ...
    char mask, char val)
    {
    let mut tmp: u8 = (~mask & data.drdy_config) | val;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn hdc2010_get_heater_status(data: *mut hdc2010_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdc2010_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdc2010_remove(client: *mut i2c_client) {
