...
//! Source: drivers/iio/humidity/hts221_core.c
#![no_std]
...
pub const HTS221_REG_WHOAMI_ADDR: c_uint = 0x0f;
pub const HTS221_REG_WHOAMI_VAL: c_uint = 0xbc;
pub const HTS221_REG_CNTRL1_ADDR: c_uint = 0x20;
pub const HTS221_REG_CNTRL2_ADDR: c_uint = 0x21;
pub const HTS221_ODR_MASK: c_uint = 0x03;

// calibration registers
pub const HTS221_REG_0RH_CAL_X_H: c_uint = 0x36;
pub const HTS221_REG_1RH_CAL_X_H: c_uint = 0x3a;
pub const HTS221_REG_0RH_CAL_Y_H: c_uint = 0x30;
pub const HTS221_REG_1RH_CAL_Y_H: c_uint = 0x31;
pub const HTS221_REG_0T_CAL_X_L: c_uint = 0x3c;
pub const HTS221_REG_1T_CAL_X_L: c_uint = 0x3e;
pub const HTS221_REG_0T_CAL_Y_H: c_uint = 0x32;
pub const HTS221_REG_1T_CAL_Y_H: c_uint = 0x33;
pub const HTS221_REG_T1_T0_CAL_Y_H: c_uint = 0x35;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hts221_odr {
    pub hz: u8,
    pub val: u8,
}

pub const HTS221_AVG_DEPTH: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hts221_avg {
    pub addr: u8,
    pub mask: u8,
    pub avg_avl: [u16; HTS221_AVG_DEPTH],
}
...
#[no_mangle]
unsafe extern "C" fn hts221_check_whoami(hw: *mut hts221_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hts221_update_odr(hw: *mut hts221_hw, odr: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hts221_set_enable(hw: *mut hts221_hw, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hts221_parse_temp_caldata(hw: *mut hts221_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hts221_parse_rh_caldata(hw: *mut hts221_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hts221_read_oneshot(hw: *mut hts221_hw, addr: u8, val: *mut c_int) -> c_int {
...
// val = avg->avg_avl[idx];
    ...
    hts221_sysfs_rh_oversampling_avail, core::ptr::null_mut(), 0);
    static IIO_DEVICE_ATTR(in_temp_oversampling_ratio_available, S_IRUGO,
    hts221_sysfs_temp_oversampling_avail, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn hts221_init_regulators(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hts221_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hts221_resume(dev: *mut device) -> c_int {
