...
//! Source: drivers/iio/humidity/hid-sensor-humidity.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hid_humidity_state {
    pub common_attributes: hid_sensor_common,
    pub humidity_attr: hid_sensor_hub_attribute_info,
    struct {
    pub humidity_data: i32,
...
#[no_mangle]
unsafe extern "C" fn hid_humidity_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_humidity_remove(pdev: *mut platform_device) {
