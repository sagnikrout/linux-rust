...
//! Source: drivers/iio/humidity/htu21.c
#![no_std]
...
pub const HTU21_RESET: c_uint = 0xFE;
    enum {
    HTU21,
    MS8607
    };
...
//
    ...
    htu21_show_battery_low, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn htu21_probe(client: *mut i2c_client) -> c_int {
