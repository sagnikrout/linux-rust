...
//! Source: drivers/iio/industrialio-backend.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iio_backend_buffer_pair {
...
//
    ...
    case 2:
    ret = iio_backend_op_call(back, debugfs_reg_access,
    back.cached_reg_addr, val, core::ptr::null_mut());
    if (ret)
    return ret;
    return count;
    default:
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_backend_chan_enable(back: *mut iio_backend, chan: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_backend_chan_disable(back: *mut iio_backend, chan: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __iio_backend_disable(back: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_backend_disable(back: *mut iio_backend) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_backend_enable(back: *mut iio_backend) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_iio_backend_enable(dev: *mut device, back: *mut iio_backend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_backend_free_buffer(arg: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_backend_data_size_set(back: *mut iio_backend, size: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_backend_has_caps(back: *mut iio_backend, caps: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iio_backend_release(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __devm_iio_backend_get(dev: *mut device, back: *mut iio_backend) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_backend_interface_data_align(back: *mut iio_backend, timeout_us: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_backend_num_lanes_set(back: *mut iio_backend, num_lanes: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_backend_ddr_enable(back: *mut iio_backend) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_backend_ddr_disable(back: *mut iio_backend) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_backend_data_stream_enable(back: *mut iio_backend) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_backend_data_stream_disable(back: *mut iio_backend) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_backend_data_transfer_addr(back: *mut iio_backend, address: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_backend_unregister(arg: *mut c_void) {
