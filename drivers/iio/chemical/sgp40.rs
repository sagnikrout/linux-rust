...
//! Source: drivers/iio/chemical/sgp40.c
#![no_std]
...
//
pub const SGP40_CALC_POWER: c_int = 14;
pub const SGP40_CRC8_POLYNOMIAL: c_uint = 0x31;
pub const SGP40_CRC8_INIT: c_uint = 0xff;
    DECLARE_CRC8_TABLE(sgp40_crc8_table);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sgp40_data {
    pub dev: *mut device,
    pub client: *mut i2c_client,
    pub rht: c_int,
    pub temp: c_int,
    pub res_calibbias: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sgp40_tg_measure {
    pub command: [u8; 2],
    pub rht_ticks: __be16,
    pub rht_crc: u8,
    pub temp_ticks: __be16,
    pub temp_crc: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sgp40_tg_result {
    pub res_ticks: __be16,
    pub res_crc: u8,
    pub __packed: },
...
//
#[no_mangle]
unsafe extern "C" fn sgp40_exp(exp: c_int, power: u32, rounds: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sgp40_calc_voc(data: *mut sgp40_data, resistance_raw: u16, voc: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgp40_measure_resistance_raw(data: *mut sgp40_data, resistance_raw: *mut u16) -> c_int {
    ...
    u16 ticks16;
    u8 crc;
    let mut tg: sgp40_tg_measure = {.command = {0x26, 0x0F}};
...
#[no_mangle]
unsafe extern "C" fn sgp40_probe(client: *mut i2c_client) -> c_int {
