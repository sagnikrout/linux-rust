...
//! Source: drivers/iio/chemical/bme680_spi.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bme680_spi_bus_context {
...
#[no_mangle]
unsafe extern "C" fn bme680_spi_probe(spi: *mut spi_device) -> c_int {
