...
//! Source: drivers/iio/chemical/ccs811.c
#![no_std]
...
pub const CCS811_STATUS: c_uint = 0x00;
pub const CCS811_MEAS_MODE: c_uint = 0x01;
pub const CCS811_ALG_RESULT_DATA: c_uint = 0x02;
pub const CCS811_RAW_DATA: c_uint = 0x03;
pub const CCS811_HW_ID: c_uint = 0x20;
pub const CCS811_HW_ID_VALUE: c_uint = 0x81;
pub const CCS811_HW_VERSION: c_uint = 0x21;
pub const CCS811_HW_VERSION_VALUE: c_uint = 0x10;
pub const CCS811_HW_VERSION_MASK: c_uint = 0xF0;
pub const CCS811_ERR: c_uint = 0xE0;
// Used to transition from boot to application mode
pub const CCS811_APP_START: c_uint = 0xF4;
pub const CCS811_SW_RESET: c_uint = 0xFF;
...
// Measurement modes
pub const CCS811_MODE_IDLE: c_uint = 0x00;
pub const CCS811_MODE_IAQ_1SEC: c_uint = 0x10;
pub const CCS811_MODE_IAQ_10SEC: c_uint = 0x20;
pub const CCS811_MODE_IAQ_60SEC: c_uint = 0x30;
pub const CCS811_MODE_RAW_DATA: c_uint = 0x40;

pub const CCS811_VOLTAGE_MASK: c_uint = 0x3FF;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ccs811_reading {
    pub co2: __be16,
    pub voc: __be16,
    pub status: u8,
    pub error: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ccs811_data {
    pub client: *mut i2c_client,
    pub /: *mut *mut mutex lock; / Protect readings,
    pub buffer: ccs811_reading,
    pub drdy_trig: *mut iio_trigger,
    pub wakeup_gpio: *mut gpio_desc,
    pub drdy_trig_on: bool,
...
//
#[no_mangle]
unsafe extern "C" fn ccs811_start_sensor_application(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccs811_setup(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccs811_set_wakeup(data: *mut ccs811_data, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn ccs811_get_measurement(data: *mut ccs811_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccs811_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ccs811_data_rdy_trigger_poll(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ccs811_reset(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccs811_probe(client: *mut i2c_client) -> c_int {
...
// Check hardware id (should be 0x81 for this family of devices)
    ...
    ccs811_trigger_handler, core::ptr::null_mut());
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn ccs811_remove(client: *mut i2c_client) {
