...
//! Source: drivers/iio/chemical/bme680_core.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bme680_data {
    pub regmap: *mut regmap,
    pub bme680: bme680_calib,
    pub /: *mut *mut mutex lock; / Protect multiple serial R/W ops to device.,
    pub oversampling_temp: u8,
    pub oversampling_press: u8,
    pub oversampling_humid: u8,
    pub preheat_curr_mA: u8,
    pub heater_dur: u16,
    pub heater_temp: u16,
    struct {
    pub chan: [i32; BME680_NUM_CHANNELS],
    pub ts: aligned_s64,
    pub scan: },
    union {
    pub buf: [u8; BME680_NUM_BULK_READ_REGS],
    pub check: c_uint,
    pub be16: __be16,
    pub bme680_cal_buf_1: [u8; BME680_CALIB_RANGE_1_LEN],
    pub bme680_cal_buf_2: [u8; BME680_CALIB_RANGE_2_LEN],
    pub bme680_cal_buf_3: [u8; BME680_CALIB_RANGE_3_LEN],
}
...
#[no_mangle]
unsafe extern "C" fn bme680_read_temp_adc(data: *mut bme680_data, adc_temp: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bme680_calc_t_fine(data: *mut bme680_data, adc_temp: u32) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn bme680_get_t_fine(data: *mut bme680_data, t_fine: *mut i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme680_read_press_adc(data: *mut bme680_data, adc_press: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme680_read_humid_adc(data: *mut bme680_data, adc_humidity: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bme680_calc_heater_res(data: *mut bme680_data, temp: u16) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn bme680_calc_heater_dur(dur: u16) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn bme680_calc_heater_preheat_current(curr: u8) -> u8 {
    static u8 bme680_calc_heater_preheat_current(u8 curr)
    {
    return 8 * curr - 1;
    }
#[no_mangle]
unsafe extern "C" fn bme680_set_mode(data: *mut bme680_data, mode: enum bme680_op_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme680_oversampling_to_reg(val: u8) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn bme680_wait_for_eoc(data: *mut bme680_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme680_chip_config(data: *mut bme680_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme680_preheat_curr_config(data: *mut bme680_data, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme680_gas_config(data: *mut bme680_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme680_read_temp(data: *mut bme680_data, comp_temp: *mut i16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme680_read_press(data: *mut bme680_data, comp_press: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme680_read_humid(data: *mut bme680_data, comp_humidity: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme680_read_gas(data: *mut bme680_data, comp_gas_res: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme680_is_valid_oversampling(rate: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bme680_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bme680_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme680_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme680_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme680_runtime_resume(dev: *mut device) -> c_int {
    ...
    bme680_runtime_resume, core::ptr::null_mut());
