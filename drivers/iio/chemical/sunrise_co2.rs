...
//! Source: drivers/iio/chemical/sunrise_co2.c
#![no_std]
...
pub const SUNRISE_ERROR_STATUS_REG: c_uint = 0x00;
pub const SUNRISE_CO2_FILTERED_COMP_REG: c_uint = 0x06;
pub const SUNRISE_CHIP_TEMPERATURE_REG: c_uint = 0x08;
pub const SUNRISE_CALIBRATION_STATUS_REG: c_uint = 0x81;
pub const SUNRISE_CALIBRATION_COMMAND_REG: c_uint = 0x82;
pub const SUNRISE_CALIBRATION_FACTORY_CMD: c_uint = 0x7c02;
pub const SUNRISE_CALIBRATION_BACKGROUND_CMD: c_uint = 0x7c06;
//
...
// Custom regmap read/write operations: perform unlocked access to the i2c bus.
    ...
    let mut data: union i2c_smbus_data = { };
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sunrise_regmap_write(context: *mut c_void, val_buf: *const c_void, count: usize) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sunrise_read_byte(sunrise: *mut sunrise_dev, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunrise_read_word(sunrise: *mut sunrise_dev, reg: u8, val: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunrise_write_byte(sunrise: *mut sunrise_dev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunrise_write_word(sunrise: *mut sunrise_dev, reg: u8, data: u16) -> c_int {
    static int sunrise_write_word(struct sunrise_dev *sunrise, u8 reg, u16 data)
    {
    const struct i2c_client *client = sunrise.client;
    const struct device *dev = &client.dev;
    let mut be_data: __be16 = cpu_to_be16(data);
    int ret;
    i2c_lock_bus(client.adapter, I2C_LOCK_SEGMENT);
...
#[no_mangle]
unsafe extern "C" fn sunrise_probe(client: *mut i2c_client) -> c_int {
