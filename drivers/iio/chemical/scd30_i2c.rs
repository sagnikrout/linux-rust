...
//! Source: drivers/iio/chemical/scd30_i2c.c
#![no_std]
...
pub const SCD30_I2C_MAX_BUF_SIZE: c_int = 18;
pub const SCD30_I2C_CRC8_POLYNOMIAL: c_uint = 0x31;
...
#[no_mangle]
unsafe extern "C" fn scd30_i2c_probe(client: *mut i2c_client) -> c_int {
    ...
    return scd30_probe(&client.dev, client.irq, client.name, core::ptr::null_mut(), scd30_i2c_command);
    }
