...
//! Source: drivers/iio/chemical/scd4x.c
#![no_std]
...
pub const SCD4X_CRC8_POLYNOMIAL: c_uint = 0x31;
pub const SCD4X_TIMEOUT_ERR: c_int = 1000;
pub const SCD4X_READ_BUF_SIZE: c_int = 9;
pub const SCD4X_COMMAND_BUF_SIZE: c_int = 2;
pub const SCD4X_WRITE_BUF_SIZE: c_int = 5;
pub const SCD4X_FRC_MIN_PPM: c_int = 0;
pub const SCD4X_FRC_MAX_PPM: c_int = 2000;
pub const SCD4X_PRESSURE_COMP_MIN_MBAR: c_int = 700;
pub const SCD4X_PRESSURE_COMP_MAX_MBAR: c_int = 1200;
pub const SCD4X_READY_MASK: c_uint = 0x01;
// Commands SCD4X
    enum scd4x_cmd {
...
#[no_mangle]
unsafe extern "C" fn scd4x_send_command(state: *mut scd4x_state, cmd: enum scd4x_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scd4x_write(state: *mut scd4x_state, cmd: enum scd4x_cmd, arg: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scd4x_read_meas(state: *mut scd4x_state, meas: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scd4x_wait_meas_poll(state: *mut scd4x_state) -> c_int {
    static int scd4x_wait_meas_poll(struct scd4x_state *state)
    {
    struct i2c_client *client = state.client;
    let mut tries: c_int = 6;
    int ret;
    do {
    __be16 bval;
    uint16_t val;
...
#[no_mangle]
unsafe extern "C" fn scd4x_read_poll(state: *mut scd4x_state, buf: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scd4x_read_channel(state: *mut scd4x_state, chan: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scd4x_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scd4x_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scd4x_stop_meas(state: *mut c_void) {
    static void scd4x_stop_meas(void *state)
    {
    scd4x_send_command(state, CMD_STOP_MEAS);
    }
#[no_mangle]
unsafe extern "C" fn scd4x_disable_regulator(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn scd4x_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn scd4x_probe(client: *mut i2c_client) -> c_int {
...
// execution time
    msleep_interruptible(500);
    ret = devm_iio_triggered_buffer_setup(dev, indio_dev, core::ptr::null_mut(), scd4x_trigger_handler, core::ptr::null_mut());
    if (ret)
    return ret;
    ret = scd4x_send_command(state, CMD_START_MEAS);
    if (ret) {
