...
//! Source: drivers/iio/health/afe4403.c
#![no_std]
...
// AFE4403 Registers
pub const AFE4403_TIAGAIN: c_uint = 0x20;
pub const AFE4403_TIA_AMB_GAIN: c_uint = 0x21;
    enum afe4403_fields {
// Gains
    F_RF_LED1, F_CF_LED1,
    F_RF_LED, F_CF_LED,
...
#[no_mangle]
unsafe extern "C" fn afe4403_read(afe: *mut afe4403_data, reg: c_uint, val: *mut u32) -> c_int {
...
// Enable reading from the device
    ret = spi_write_then_read(afe.spi, tx, 4, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
...
// val2 = 800000;
    ...
    {
    struct afe4403_data *afe = iio_priv(indio_dev);
    let mut field: c_uint = afe4403_channel_leds[chan.address];
    switch (chan.type) {
    case IIO_CURRENT:
    switch (mask) {
    case IIO_CHAN_INFO_RAW:
...
#[no_mangle]
unsafe extern "C" fn afe4403_trigger_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn afe4403_regulator_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn afe4403_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afe4403_resume(dev: *mut device) -> c_int {
    ...
    afe4403_resume);
#[no_mangle]
unsafe extern "C" fn afe4403_probe(spi: *mut spi_device) -> c_int {
    ...
    afe4403_trigger_handler, core::ptr::null_mut());
    if (ret) {
