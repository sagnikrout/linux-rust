...
//! Source: drivers/iio/health/afe4404.c
#![no_std]
...
// AFE4404 registers
pub const AFE4404_TIA_GAIN_SEP: c_uint = 0x20;
pub const AFE4404_TIA_GAIN: c_uint = 0x21;
pub const AFE4404_PROG_TG_STC: c_uint = 0x34;
pub const AFE4404_PROG_TG_ENDC: c_uint = 0x35;
pub const AFE4404_LED3LEDSTC: c_uint = 0x36;
pub const AFE4404_LED3LEDENDC: c_uint = 0x37;
pub const AFE4404_CLKDIV_PRF: c_uint = 0x39;
pub const AFE4404_OFFDAC: c_uint = 0x3a;
pub const AFE4404_DEC: c_uint = 0x3d;
pub const AFE4404_AVG_LED2_ALED2VAL: c_uint = 0x3f;
pub const AFE4404_AVG_LED1_ALED1VAL: c_uint = 0x40;
...
#[no_mangle]
unsafe extern "C" fn afe4404_trigger_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn afe4404_regulator_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn afe4404_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afe4404_resume(dev: *mut device) -> c_int {
    ...
    afe4404_resume);
#[no_mangle]
unsafe extern "C" fn afe4404_probe(client: *mut i2c_client) -> c_int {
    ...
    afe4404_trigger_handler, core::ptr::null_mut());
    if (ret) {
