...
//! Source: drivers/iio/adc/ad7944.c
#![no_std]
...
pub const AD7944_INTERNAL_REF_MV: c_int = 4096;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7944_timing_spec {
// Normal mode max conversion time (t_{CONV}).
    pub conv_ns: c_uint,
// TURBO mode max conversion time (t_{CONV}).
    pub turbo_conv_ns: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7944_adc {
    pub spi: *mut spi_device,
    pub spi_mode: enum ad7944_spi_mode,
    pub xfers: [spi_transfer; 3],
    pub msg: spi_message,
    pub offload_xfers: [spi_transfer; 2],
    ...
    pub chain_mode_buf: *mut c_void,
// Chip-specific timing specifications.
    pub timing_spec: *const ad7944_timing_spec,
// GPIO connected to CNV pin.
    pub cnv: *mut gpio_desc,
// Optional GPIO to enable turbo mode.
    pub turbo: *mut gpio_desc,
// Indicates TURBO is hard-wired to be always enabled.
    pub always_turbo: bool,
...
pub const AD7944_T_QUIET_NS: c_int = 20;
// minimum CNV high time to trigger conversion
pub const AD7944_T_CNVH_NS: c_int = 10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7944_chip_info {
    pub name: *const c_char,
    pub timing_spec: *const ad7944_timing_spec,
    pub max_sample_rate_hz: u32,
    pub channels: [iio_chan_spec; 2],
    pub offload_channels: [iio_chan_spec; 1],
}
...
//
#[no_mangle]
unsafe extern "C" fn ad7944_convert_and_acquire(adc: *mut ad7944_adc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7944_set_sample_freq(adc: *mut ad7944_adc, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7944_offload_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7944_offload_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7944_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad7944_probe(spi: *mut spi_device) -> c_int {
