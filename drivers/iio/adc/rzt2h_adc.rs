...
//! Source: drivers/iio/adc/rzt2h_adc.c
#![no_std]
...
pub const RZT2H_ADCSR_REG: c_uint = 0x00;

pub const RZT2H_ADANSA0_REG: c_uint = 0x04;

pub const RZT2H_ADCALCTL_REG: c_uint = 0x1f0;

pub const RZT2H_ADC_MAX_CHANNELS: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzt2h_adc {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_adc_start(adc: *mut rzt2h_adc, conversion_type: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_adc_stop(adc: *mut rzt2h_adc) {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_adc_read_single(adc: *mut rzt2h_adc, ch: c_uint, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_adc_set_cal(adc: *mut rzt2h_adc, cal: bool) {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_adc_calibrate(adc: *mut rzt2h_adc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_adc_isr(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_adc_parse_properties(adc: *mut rzt2h_adc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_adc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_adc_pm_runtime_resume(dev: *mut device) -> c_int {
...
//
    ...
    RUNTIME_PM_OPS(core::ptr::null_mut(), rzt2h_adc_pm_runtime_resume, core::ptr::null_mut())
    };
