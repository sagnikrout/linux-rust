...
//! Source: drivers/iio/adc/sun20i-gpadc-iio.c
#![no_std]
...
pub const SUN20I_GPADC_SR: c_uint = 0x00;
pub const SUN20I_GPADC_CTRL: c_uint = 0x04;
pub const SUN20I_GPADC_CS_EN: c_uint = 0x08;
pub const SUN20I_GPADC_FIFO_INTC: c_uint = 0x0c;
pub const SUN20I_GPADC_FIFO_INTS: c_uint = 0x10;

pub const SUN20I_GPADC_DATAL_INTC: c_uint = 0x20;
pub const SUN20I_GPADC_DATAH_INTC: c_uint = 0x24;
pub const SUN20I_GPADC_DATA_INTC: c_uint = 0x28;
pub const SUN20I_GPADC_DATAL_INTS: c_uint = 0x30;
pub const SUN20I_GPADC_DATAH_INTS: c_uint = 0x34;
pub const SUN20I_GPADC_DATA_INTS: c_uint = 0x38;

pub const SUN20I_GPADC_WORK_MODE_SINGLE: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun20i_gpadc_iio {
...
#[no_mangle]
unsafe extern "C" fn sun20i_gpadc_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sun20i_gpadc_reset_assert(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sun20i_gpadc_probe(pdev: *mut platform_device) -> c_int {
