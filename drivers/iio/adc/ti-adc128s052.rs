...
//! Source: drivers/iio/adc/ti-adc128s052.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adc128_configuration {
    pub channels: *const iio_chan_spec,
    pub num_channels: u8,
    pub refname: *const c_char,
    pub num_other_regulators: c_int,
    pub (*other_regulators)[]: *const *const c_char,
}
...
#[no_mangle]
unsafe extern "C" fn adc128_adc_conversion(adc: *mut adc128, channel: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adc128_probe(spi: *mut spi_device) -> c_int {
