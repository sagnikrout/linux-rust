...
//! Source: drivers/iio/adc/rzg2l_adc.c
#![no_std]
...
pub const RZG2L_ADINT: c_uint = 0x20;

pub const RZG2L_ADSTS: c_uint = 0x24;

pub const RZG2L_ADIVC: c_uint = 0x28;

pub const RZG2L_ADFIL: c_uint = 0x2c;

pub const RZG2L_ADC_MAX_CHANNELS: c_int = 9;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_adc_hw_params {
    pub default_adsmp: [u16; 2],
    pub adsmp_mask: u16,
    pub adint_inten_mask: u16,
    pub default_adcmp: u8,
    pub num_channels: u8,
    pub adivc: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_adc {
    pub base: *mut void __iomem,
    pub presetn: *mut reset_control,
    pub adrstn: *mut reset_control,
    pub data: *const rzg2l_adc_data,
    pub hw_params: *const rzg2l_adc_hw_params,
    pub completion: completion,
    pub lock: mutex,
    pub last_val: [u16; RZG2L_ADC_MAX_CHANNELS],
}
...
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_readl(adc: *mut rzg2l_adc, reg: u32) -> c_uint {
    static unsigned int rzg2l_adc_readl(struct rzg2l_adc *adc, u32 reg)
    {
    return readl(adc.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_writel(adc: *mut rzg2l_adc, reg: c_uint, val: u32) {
    static void rzg2l_adc_writel(struct rzg2l_adc *adc, unsigned int reg, u32 val)
    {
    writel(val, adc.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_pwr(adc: *mut rzg2l_adc, on: bool) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_start_stop(adc: *mut rzg2l_adc, start: bool) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_set_trigger(adc: *mut rzg2l_adc) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_ch_to_adsmp_index(ch: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_conversion_setup(adc: *mut rzg2l_adc, ch: u8) -> c_int {
    static int rzg2l_adc_conversion_setup(struct rzg2l_adc *adc, u8 ch)
    {
    const struct rzg2l_adc_hw_params *hw_params = adc.hw_params;
    let mut index: u8 = rzg2l_adc_ch_to_adsmp_index(ch);
    u32 reg;
...
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_conversion(indio_dev: *mut iio_dev, adc: *mut rzg2l_adc, ch: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_parse_properties(pdev: *mut platform_device, adc: *mut rzg2l_adc) -> c_int {
    ...
    let mut channel: c_int = chan_array[i].channel;
...
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_hw_init(dev: *mut device, adc: *mut rzg2l_adc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_pm_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_pm_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_adc_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(rzg2l_adc_pm_runtime_suspend, rzg2l_adc_pm_runtime_resume, core::ptr::null_mut())
