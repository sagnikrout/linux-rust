...
//! Source: drivers/iio/adc/twl6030-gpadc.c
#![no_std]
...
//
pub const TWL6030_GPADC_USED_CHANNELS: c_int = 13;
pub const TWL6030_GPADC_MAX_CHANNELS: c_int = 15;
pub const TWL6032_GPADC_USED_CHANNELS: c_int = 15;
pub const TWL6032_GPADC_MAX_CHANNELS: c_int = 19;
pub const TWL6030_GPADC_NUM_TRIM_REGS: c_int = 16;
pub const TWL6030_GPADC_CTRL_P1: c_uint = 0x05;
pub const TWL6032_GPADC_GPSELECT_ISB: c_uint = 0x07;
pub const TWL6032_GPADC_CTRL_P1: c_uint = 0x08;
pub const TWL6032_GPADC_GPCH0_LSB: c_uint = 0x0d;
pub const TWL6032_GPADC_GPCH0_MSB: c_uint = 0x0e;

pub const TWL6030_GPADC_TRIM1: c_uint = 0xCD;
pub const TWL6030_REG_TOGGLE1: c_uint = 0x90;

pub const USB_VBUS_CTRL_SET: c_uint = 0x04;
pub const USB_ID_CTRL_SET: c_uint = 0x06;
pub const TWL6030_MISC1: c_uint = 0xE4;
pub const VBUS_MEAS: c_uint = 0x01;
pub const ID_MEAS: c_uint = 0x01;
pub const VAC_MEAS: c_uint = 0x04;
pub const VBAT_MEAS: c_uint = 0x02;
pub const BB_MEAS: c_uint = 0x01;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct twl6030_gpadc_platform_data {
    pub nchannels: c_int,
    pub iio_channels: *const iio_chan_spec,
    pub ideal: *const twl6030_ideal_code,
    pub channel): *mut *mut int (start_conversion)(int,
    pub channel): *mut *mut u8 (channel_to_reg)(int,
    pub gpadc): *mut *mut int (calibrate)(struct twl6030_gpadc_data,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct twl6030_gpadc_data {
    pub dev: *mut device,
    pub lock: mutex,
    pub irq_complete: completion,
    pub twl6030_cal_tbl: *mut twl6030_chnl_calib,
    pub pdata: *const twl6030_gpadc_platform_data,
}
...
#[no_mangle]
unsafe extern "C" fn twl6030_gpadc_disable_irq(mask: u8) {
...
#[no_mangle]
unsafe extern "C" fn twl6030_gpadc_irq_handler(irq: c_int, indio_dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn twl6030_start_conversion(channel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl6032_start_conversion(channel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl6030_channel_to_reg(channel: c_int) -> u8 {
    static u8 twl6030_channel_to_reg(int channel)
    {
    return TWL6030_GPADC_GPCH0_LSB + 2 * channel;
    }
#[no_mangle]
unsafe extern "C" fn twl6032_channel_to_reg(channel: c_int) -> u8 {
...
// not calibrated channels have 0 in all structure members
    ...
    int channel, int *res)
    {
    let mut reg: u8 = gpadc.pdata.channel_to_reg(channel);
    __le16 val;
    int raw_code;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn twl6030_gpadc_get_trim_offset(d: i8) -> c_int {
...
//
    let mut temp: __u32 = ((d & 0x7f) >> 1) | ((d & 1) << 6);
    return sign_extend32(temp, 6);
    }
#[no_mangle]
unsafe extern "C" fn twl6030_calibration(gpadc: *mut twl6030_gpadc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl6032_calibration(gpadc: *mut twl6030_gpadc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl6030_gpadc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl6030_gpadc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn twl6030_gpadc_suspend(pdev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl6030_gpadc_resume(pdev: *mut device) -> c_int {
