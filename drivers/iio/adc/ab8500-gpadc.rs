...
//! Source: drivers/iio/adc/ab8500-gpadc.c
#![no_std]
...
pub const AB8500_GPADC_CTRL1_REG: c_uint = 0x00;
// GPADC control register 1 bits
pub const AB8500_GPADC_CTRL1_DISABLE: c_uint = 0x00;

// 0 = use rising edge, 1 = use falling edge

// 0 = use VTVOUT, 1 = use VRTC as pull-up supply for battery temp NTC

pub const AB8500_GPADC_CTRL2_REG: c_uint = 0x01;
pub const AB8500_GPADC_CTRL3_REG: c_uint = 0x02;
//
// GPADC control register 2 and 3 bits
// the bit layout is the same for SW and HW conversion set-up
//
pub const AB8500_GPADC_CTRL2_AVG_1: c_uint = 0x00;
...
pub const AB8500_GPADC_AUTO_TIMER_REG: c_uint = 0x03;
pub const AB8500_GPADC_STAT_REG: c_uint = 0x04;

pub const AB8500_GPADC_MANDATAL_REG: c_uint = 0x05;
pub const AB8500_GPADC_MANDATAH_REG: c_uint = 0x06;
pub const AB8500_GPADC_AUTODATAL_REG: c_uint = 0x07;
pub const AB8500_GPADC_AUTODATAH_REG: c_uint = 0x08;
pub const AB8500_GPADC_MUX_CTRL_REG: c_uint = 0x09;
pub const AB8540_GPADC_MANDATA2L_REG: c_uint = 0x09;
pub const AB8540_GPADC_MANDATA2H_REG: c_uint = 0x0A;
pub const AB8540_GPADC_APEAAX_REG: c_uint = 0x10;
pub const AB8540_GPADC_APEAAT_REG: c_uint = 0x11;
pub const AB8540_GPADC_APEAAM_REG: c_uint = 0x12;
pub const AB8540_GPADC_APEAAH_REG: c_uint = 0x13;
pub const AB8540_GPADC_APEAAL_REG: c_uint = 0x14;
//
// OTP register offsets
// Bank : 0x15
//
pub const AB8500_GPADC_CAL_1: c_uint = 0x0F;
pub const AB8500_GPADC_CAL_2: c_uint = 0x10;
pub const AB8500_GPADC_CAL_3: c_uint = 0x11;
pub const AB8500_GPADC_CAL_4: c_uint = 0x12;
pub const AB8500_GPADC_CAL_5: c_uint = 0x13;
pub const AB8500_GPADC_CAL_6: c_uint = 0x14;
pub const AB8500_GPADC_CAL_7: c_uint = 0x15;
// New calibration for 8540
pub const AB8540_GPADC_OTP4_REG_7: c_uint = 0x38;
pub const AB8540_GPADC_OTP4_REG_6: c_uint = 0x39;
pub const AB8540_GPADC_OTP4_REG_5: c_uint = 0x3A;
pub const AB8540_GPADC_DIS_ZERO: c_uint = 0x00;
pub const AB8540_GPADC_EN_VBIAS_XTAL_TEMP: c_uint = 0x02;
// GPADC constants from AB8500 spec, UM0836
pub const AB8500_ADC_RESOLUTION: c_int = 1024;
pub const AB8500_ADC_CH_BTEMP_MIN: c_int = 0;
pub const AB8500_ADC_CH_BTEMP_MAX: c_int = 1350;
pub const AB8500_ADC_CH_DIETEMP_MIN: c_int = 0;
pub const AB8500_ADC_CH_DIETEMP_MAX: c_int = 1350;
pub const AB8500_ADC_CH_CHG_V_MIN: c_int = 0;
pub const AB8500_ADC_CH_CHG_V_MAX: c_int = 20030;
pub const AB8500_ADC_CH_ACCDET2_MIN: c_int = 0;
pub const AB8500_ADC_CH_ACCDET2_MAX: c_int = 2500;
pub const AB8500_ADC_CH_VBAT_MIN: c_int = 2300;
pub const AB8500_ADC_CH_VBAT_MAX: c_int = 4800;
pub const AB8500_ADC_CH_CHG_I_MIN: c_int = 0;
pub const AB8500_ADC_CH_CHG_I_MAX: c_int = 1500;
pub const AB8500_ADC_CH_BKBAT_MIN: c_int = 0;
pub const AB8500_ADC_CH_BKBAT_MAX: c_int = 3200;
// GPADC constants from AB8540 spec

pub const AB8500_ADC_CH_IBAT_MAX: c_int = 6000;

pub const AB8500_ADC_CH_IBAT_MAX_V: c_int = 60;

pub const AB8500_GPADC_IBAT_VDROP_H: c_int = 56;
// This is used to not lose precision when dividing to get gain and offset
pub const AB8500_GPADC_CALIB_SCALE: c_int = 1000;
//
// Number of bits shift used to not lose precision
// when dividing to get ibat gain.
//
pub const AB8500_GPADC_CALIB_SHIFT_IBAT: c_int = 20;
// Time in ms before disabling regulator
pub const AB8500_GPADC_AUTOSUSPEND_DELAY: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_adc_cal_data {
    pub gain: i64,
    pub offset: i64,
    pub otp_calib_hi: u16,
    pub otp_calib_lo: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_gpadc_chan_info {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_gpadc {
    pub dev: *mut device,
    pub ab8500: *mut ab8500,
    pub chans: *mut ab8500_gpadc_chan_info,
    pub nchans: c_uint,
    pub complete: completion,
    pub vddadc: *mut regulator,
    pub irq_sw: c_int,
    pub irq_hw: c_int,
    pub cal_data: [ab8500_adc_cal_data; AB8500_CAL_NR],
}
...
// Here we can use calibration
    ...
    {
    int ret;
    let mut looplimit: c_int = 0;
    unsigned long completion_timeout;
    u8 val;
    u8 low_data, high_data, low_data2, high_data2;
    u8 ctrl1;
    u8 ctrl23;
    let mut delay_min: c_uint = 0;
    let mut delay_max: c_uint = 0;
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_bm_gpadcconvend_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ab8500_gpadc_read_calibration_data(gpadc: *mut ab8500_gpadc) {
...
// Calculate gain and offset for VBAT if all reads succeeded
    ...
    raw_val = ab8500_gpadc_read(gpadc, ch, core::ptr::null_mut());
    if (raw_val < 0)
    return raw_val;
...
#[no_mangle]
unsafe extern "C" fn ab8500_gpadc_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_gpadc_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_gpadc_probe(pdev: *mut platform_device) -> c_int {
...
// Request interrupts
    ret = devm_request_threaded_irq(dev, gpadc.irq_sw, core::ptr::null_mut(),
    ...
    if (gpadc.irq_hw) {
    ret = devm_request_threaded_irq(dev, gpadc.irq_hw, core::ptr::null_mut(),
    ab8500_bm_gpadcconvend_handler,	IRQF_NO_SUSPEND | IRQF_ONESHOT,
...
#[no_mangle]
unsafe extern "C" fn ab8500_gpadc_remove(pdev: *mut platform_device) {
    ...
    ab8500_gpadc_runtime_resume, core::ptr::null_mut());
