...
//! Source: drivers/iio/adc/ad7768-1.c
#![no_std]
...
pub const AD7768_REG_CHIP_TYPE: c_uint = 0x3;
pub const AD7768_REG_PROD_ID_L: c_uint = 0x4;
pub const AD7768_REG_PROD_ID_H: c_uint = 0x5;
pub const AD7768_REG_CHIP_GRADE: c_uint = 0x6;
pub const AD7768_REG_SCRATCH_PAD: c_uint = 0x0A;
pub const AD7768_REG_VENDOR_L: c_uint = 0x0C;
pub const AD7768_REG_VENDOR_H: c_uint = 0x0D;
pub const AD7768_REG_INTERFACE_FORMAT: c_uint = 0x14;
pub const AD7768_REG_POWER_CLOCK: c_uint = 0x15;
pub const AD7768_REG_ANALOG: c_uint = 0x16;
pub const AD7768_REG_ANALOG2: c_uint = 0x17;
pub const AD7768_REG_CONVERSION: c_uint = 0x18;
pub const AD7768_REG_DIGITAL_FILTER: c_uint = 0x19;
pub const AD7768_REG_SINC3_DEC_RATE_MSB: c_uint = 0x1A;
pub const AD7768_REG_SINC3_DEC_RATE_LSB: c_uint = 0x1B;
pub const AD7768_REG_DUTY_CYCLE_RATIO: c_uint = 0x1C;
pub const AD7768_REG_SYNC_RESET: c_uint = 0x1D;
pub const AD7768_REG_GPIO_CONTROL: c_uint = 0x1E;
pub const AD7768_REG_GPIO_WRITE: c_uint = 0x1F;
pub const AD7768_REG_GPIO_READ: c_uint = 0x20;
pub const AD7768_REG_OFFSET_HI: c_uint = 0x21;
pub const AD7768_REG_OFFSET_MID: c_uint = 0x22;
pub const AD7768_REG_OFFSET_LO: c_uint = 0x23;
pub const AD7768_REG_GAIN_HI: c_uint = 0x24;
pub const AD7768_REG_GAIN_MID: c_uint = 0x25;
pub const AD7768_REG_GAIN_LO: c_uint = 0x26;
pub const AD7768_REG_SPI_DIAG_ENABLE: c_uint = 0x28;
pub const AD7768_REG_ADC_DIAG_ENABLE: c_uint = 0x29;
pub const AD7768_REG_DIG_DIAG_ENABLE: c_uint = 0x2A;
pub const AD7768_REG24_ADC_DATA: c_uint = 0x2C;
pub const AD7768_REG_MASTER_STATUS: c_uint = 0x2D;
pub const AD7768_REG_SPI_DIAG_STATUS: c_uint = 0x2E;
pub const AD7768_REG_ADC_DIAG_STATUS: c_uint = 0x2F;
pub const AD7768_REG_DIG_DIAG_STATUS: c_uint = 0x30;
pub const AD7768_REG_MCLK_COUNTER: c_uint = 0x31;
pub const AD7768_REG_COEFF_CONTROL: c_uint = 0x32;
pub const AD7768_REG24_COEFF_DATA: c_uint = 0x33;
pub const AD7768_REG_ACCESS_KEY: c_uint = 0x34;
...
pub const AD7768_VCM_OFF: c_uint = 0x07;

pub const ADAQ776X_MAX_GAIN_MODES: c_int = 8;
pub const AD7768_TRIGGER_SOURCE_SYNC_IDX: c_int = 0;
pub const AD7768_MAX_CHANNELS: c_int = 1;
pub const ADAQ7768_PGA_PINS: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7768_chip_info {
    pub name: *const c_char,
    pub channel_spec: *const iio_chan_spec,
    pub num_channels: c_int,
    pub pga_gains: *const c_int,
    pub num_pga_modes: c_int,
    pub default_pga_mode: c_int,
    pub pgia_mode2pin_offset: c_int,
    pub has_pga: bool,
    pub has_variable_aaf: bool,
    pub has_vcm_regulator: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7768_state {
    pub spi: *mut spi_device,
    pub offload: *mut spi_offload,
    pub offload_trigger: *mut spi_offload_trigger,
    pub regmap: *mut regmap,
    pub regmap24: *mut regmap,
    pub vref_uv: c_int,
    pub vcm_rdev: *mut regulator_dev,
    pub vcm_output_sel: c_uint,
    pub mclk: *mut clk,
    pub mclk_freq: c_uint,
    pub oversampling_ratio: c_uint,
    pub filter_type: enum ad7768_filter_type,
    pub samp_freq: c_uint,
    pub samp_freq_avail: [c_uint; ARRAY_SIZE(ad7768_mclk_div_rates)],
    pub samp_freq_avail_len: c_uint,
    pub pga_gain_mode: c_uint,
    pub aaf_gain: c_uint,
    pub scale_tbl: [c_int; ADAQ776X_MAX_GAIN_MODES][2],
    pub completion: completion,
    pub trig: *mut iio_trigger,
    pub pga_gpios: *mut gpio_descs,
    pub gpio_sync_in: *mut gpio_desc,
    pub gpio_reset: *mut gpio_desc,
    pub labels: [*const c_char; AD7768_MAX_CHANNELS],
    pub gpiochip: gpio_chip,
    pub offload_xfer: spi_transfer,
    pub offload_msg: spi_message,
    pub chip: *const ad7768_chip_info,
    pub en_spi_sync: bool,
    pub /: *mut *mut mutex pga_lock; / protect device internal state (PGA),
//
...
#[no_mangle]
unsafe extern "C" fn ad7768_send_sync_pulse(st: *mut ad7768_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_fill_samp_freq_tbl(st: *mut ad7768_state) {
...
#[no_mangle]
unsafe extern "C" fn ad7768_set_mclk_div(st: *mut ad7768_state, mclk_div: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_scan_direct(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_fill_scale_tbl(dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: dec_rate_idx ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ad7768_setup_pga(dev: *mut device, st: *mut ad7768_state) -> c_int {
    ...
    int gain_mode)
    {
    let mut pgia_pins_value: c_int = abs(gain_mode - st.chip.pgia_mode2pin_offset);
...
#[no_mangle]
unsafe extern "C" fn ad7768_gpio_direction_input(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_gpio_set(chip: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_gpio_init(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_update_dec_rate(dev: *mut iio_dev, dec_rate: c_uint) -> c_int {
...
// First, try getting the GPIO trigger source
    ...
    st.gpio_sync_in = devm_fwnode_gpiod_get_index(dev, ref, core::ptr::null_mut(), 0,
    GPIOD_OUT_LOW,
    "sync-in");
...
#[no_mangle]
unsafe extern "C" fn ad7768_setup(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad7768_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad7768_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_offload_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_offload_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_set_trigger_state(trig: *mut iio_trigger, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_triggered_buffer_alloc(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_vcm_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_vcm_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_vcm_is_enabled(rdev: *mut regulator_dev) -> c_int {
    ...
    {
    let mut regval: c_uint = AD7768_REG_ANALOG2_VCM(selector + 1);
    struct iio_dev *indio_dev = rdev_get_drvdata(rdev);
    struct ad7768_state *st = iio_priv(indio_dev);
    int ret;
    if (!iio_device_claim_direct(indio_dev))
...
#[no_mangle]
unsafe extern "C" fn ad7768_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_parse_aaf_gain(dev: *mut device, st: *mut ad7768_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7768_probe(spi: *mut spi_device) -> c_int {
