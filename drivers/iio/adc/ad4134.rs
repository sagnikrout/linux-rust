...
//! Source: drivers/iio/adc/ad4134.c
#![no_std]
...
pub const AD4134_SPI_MAX_XFER_LEN: c_int = 3;

pub const AD4134_NUM_CHANNELS: c_int = 4;
pub const AD4134_CHAN_PRECISION_BITS: c_int = 24;
pub const AD4134_IFACE_CONFIG_A_REG: c_uint = 0x00;
pub const AD4134_IFACE_CONFIG_B_REG: c_uint = 0x01;

pub const AD4134_DEVICE_CONFIG_REG: c_uint = 0x02;

pub const AD4134_POWER_MODE_HIGH_PERF: c_uint = 0x1;
pub const AD4134_SILICON_REV_REG: c_uint = 0x07;
pub const AD4134_SCRATCH_PAD_REG: c_uint = 0x0A;
pub const AD4134_STREAM_MODE_REG: c_uint = 0x0E;
pub const AD4134_SDO_PIN_SRC_SEL_REG: c_uint = 0x10;

pub const AD4134_DATA_PACKET_CONFIG_REG: c_uint = 0x11;

pub const AD4134_DATA_PACKET_24BIT_FRAME: c_uint = 0x2;
pub const AD4134_DIG_IF_CFG_REG: c_uint = 0x12;

pub const AD4134_DATA_FORMAT_SINGLE_CH_MODE: c_uint = 0x0;
pub const AD4134_PW_DOWN_CTRL_REG: c_uint = 0x13;
pub const AD4134_DEVICE_STATUS_REG: c_uint = 0x15;
pub const AD4134_ODR_VAL_INT_LSB_REG: c_uint = 0x16;
pub const AD4134_CH3_OFFSET_MSB_REG: c_uint = 0x3E;
pub const AD4134_AIN_OR_ERROR_REG: c_uint = 0x48;
//
...
pub const AD4134_SPI_CRC_POLYNOM: c_uint = 0x07;
pub const AD4134_SPI_CRC_INIT_VALUE: c_uint = 0xA5;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4134_state {
    pub spi: *mut spi_device,
    pub regmap: *mut regmap,
    pub sys_clk_hz: c_ulong,
    pub odr_gpio: *mut gpio_desc,
    pub refin_mv: c_int,
//
// DMA (thus cache coherency maintenance) requires the transfer buffers
// to live in their own cache lines.
//
    pub __aligned(IIO_DMA_MINALIGN): u8 rx_buf[AD4134_SPI_MAX_XFER_LEN],
    pub tx_buf: [u8; AD4134_SPI_MAX_XFER_LEN],
}
...
#[no_mangle]
unsafe extern "C" fn ad4134_calc_spi_crc(inst: u8, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4134_prepare_spi_tx_buf(inst: u8, data: u8, buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn ad4134_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
//
    ...
    ret = spi_write_then_read(st.spi, core::ptr::null_mut(), 0, st.rx_buf,
...
#[no_mangle]
unsafe extern "C" fn ad4134_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4134_min_io_mode_setup(st: *mut ad4134_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4134_regulator_setup(st: *mut ad4134_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4134_clock_select(st: *mut ad4134_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4134_probe(spi: *mut spi_device) -> c_int {
    ...
    st.regmap = devm_regmap_init(dev, core::ptr::null_mut(), st, &ad4134_regmap_config);
    if (IS_ERR(st.regmap))
