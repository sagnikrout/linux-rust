...
//! Source: drivers/iio/adc/max1363.c
#![no_std]
...
pub const MAX1363_SETUP_AIN3_IS_AIN3_REF_IS_VDD: c_uint = 0x00;
pub const MAX1363_SETUP_AIN3_IS_REF_EXT_TO_REF: c_uint = 0x20;
pub const MAX1363_SETUP_AIN3_IS_AIN3_REF_IS_INT: c_uint = 0x40;
pub const MAX1363_SETUP_AIN3_IS_REF_REF_IS_INT: c_uint = 0x60;
pub const MAX1363_SETUP_POWER_UP_INT_REF: c_uint = 0x10;
pub const MAX1363_SETUP_POWER_DOWN_INT_REF: c_uint = 0x00;
// think about including max11600 etc - more settings
pub const MAX1363_SETUP_EXT_CLOCK: c_uint = 0x08;
pub const MAX1363_SETUP_INT_CLOCK: c_uint = 0x00;
pub const MAX1363_SETUP_UNIPOLAR: c_uint = 0x00;
pub const MAX1363_SETUP_BIPOLAR: c_uint = 0x04;
pub const MAX1363_SETUP_RESET: c_uint = 0x00;
pub const MAX1363_SETUP_NORESET: c_uint = 0x02;
...
//
pub const MAX1363_SETUP_MONITOR_SETUP: c_uint = 0x01;
// Specific to the max1363

pub const MAX1363_MON_INT_ENABLE: c_uint = 0x01;
// defined for readability reasons
// All chips

pub const MAX1363_CONFIG_SE: c_uint = 0x01;
pub const MAX1363_CONFIG_DE: c_uint = 0x00;
pub const MAX1363_CONFIG_SCAN_TO_CS: c_uint = 0x00;
pub const MAX1363_CONFIG_SCAN_SINGLE_8: c_uint = 0x20;
pub const MAX1363_CONFIG_SCAN_MONITOR_MODE: c_uint = 0x40;
pub const MAX1363_CONFIG_SCAN_SINGLE_1: c_uint = 0x60;
// max123{6-9} only
pub const MAX1236_SCAN_MID_TO_CHANNEL: c_uint = 0x40;
// max1363 only - merely part of channel selects or don't care for others
pub const MAX1363_CONFIG_EN_MON_MODE_READ: c_uint = 0x18;

// max1363 strictly 0x06 - but doesn't matter
pub const MAX1363_CHANNEL_SEL_MASK: c_uint = 0x1E;
pub const MAX1363_SCAN_MASK: c_uint = 0x60;
pub const MAX1363_SE_DE_MASK: c_uint = 0x01;
pub const MAX1363_MAX_CHANNELS: c_int = 25;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max1363_mode {
    pub conf: i8,
    pub MAX1363_MAX_CHANNELS): DECLARE_BITMAP(modemask,,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max1363_chip_info {
    pub info: *const iio_info,
    pub channels: *const iio_chan_spec,
    pub num_channels: c_int,
    pub mode_list: *const enum max1363_modes,
    pub default_mode: enum max1363_modes,
    pub int_vref_mv: u16,
    pub num_modes: u8,
    pub bits: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max1363_state {
    pub client: *mut i2c_client,
    pub setupbyte: u8,
    pub configbyte: u8,
    pub chip_info: *const max1363_chip_info,
    pub current_mode: *const max1363_mode,
    pub lock: mutex,
// Using monitor modes and buffer at the same time is
    currently not supported */
    pub monitor_on: bool,
    pub monitor_speed:3: c_uint,
    pub mask_high: u8,
    pub mask_low: u8,
// 4x unipolar first then the fours bipolar ones
    pub thresh_high: [i16; 8],
    pub thresh_low: [i16; 8],
    pub vref: *mut regulator,
    pub vref_uv: u32,
    int				(*send)(const struct i2c_client *client,
    pub count): *const *const char buf, int,
    int				(*recv)(const struct i2c_client *client,
    pub count): *mut *mut char buf, int,
    struct {
    pub 2]: *mut *mut u8 buf[MAX1363_MAX_CHANNELS,
    pub ts: aligned_s64,
    pub data: },
}
...
#[no_mangle]
unsafe extern "C" fn max1363_write_basic_config(st: *mut max1363_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max1363_set_scan_mode(st: *mut max1363_state) -> c_int {
...
// bipolar channel
    ...
    MAX1363_4X_CHANS(8, core::ptr::null_mut(), 0);
    static const struct iio_chan_spec max1136_channels[] =
    MAX1363_4X_CHANS(10, core::ptr::null_mut(), 0);
    static const struct iio_chan_spec max1236_channels[] =
    MAX1363_4X_CHANS(12, core::ptr::null_mut(), 0);
...
// Applies to max1238, max1239
    ...
    MAX1363_CHAN_U(0, _s0, 0, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_U(1, _s1, 1, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_U(2, _s2, 2, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_U(3, _s3, 3, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_U(4, _s4, 4, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_U(5, _s5, 5, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_U(6, _s6, 6, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_U(7, _s7, 7, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_U(8, _s8, 8, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_U(9, _s9, 9, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_U(10, _s10, 10, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_U(11, _s11, 11, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_B(0, 1, d0m1, 12, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_B(2, 3, d2m3, 13, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_B(4, 5, d4m5, 14, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_B(6, 7, d6m7, 15, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_B(8, 9, d8m9, 16, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_B(10, 11, d10m11, 17, bits, core::ptr::null_mut(), 0),	\
    MAX1363_CHAN_B(1, 0, d1m0, 18, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_B(3, 2, d3m2, 19, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_B(5, 4, d5m4, 20, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_B(7, 6, d7m6, 21, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_B(9, 8, d9m8, 22, bits, core::ptr::null_mut(), 0),		\
    MAX1363_CHAN_B(11, 10, d11m10, 23, bits, core::ptr::null_mut(), 0),	\
    ...
    MAX1363_CHAN_U(0, _s0, 0, bits, core::ptr::null_mut(), 0),	\
    MAX1363_CHAN_U(1, _s1, 1, bits, core::ptr::null_mut(), 0),	\
    MAX1363_CHAN_B(0, 1, d0m1, 2, bits, core::ptr::null_mut(), 0),	\
    MAX1363_CHAN_B(1, 0, d1m0, 3, bits, core::ptr::null_mut(), 0),	\
...
#[no_mangle]
unsafe extern "C" fn max1363_event_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
    ...
    struct max1363_state *st = iio_priv(indio_dev);
    int val;
    let mut number: c_int = chan.channel;
    guard(mutex)(&st.lock);
    if (dir == IIO_EV_DIR_FALLING)
...
#[no_mangle]
unsafe extern "C" fn max1363_monitor_mode_update(st: *mut max1363_state, enabled: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __max1363_check_event_mask(thismask: c_int, checkmask: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max1363_initial_setup(st: *mut max1363_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max1363_alloc_scan_masks(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max1363_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max1363_probe(client: *mut i2c_client) -> c_int {
    ...
    &max1363_trigger_handler, core::ptr::null_mut());
    if (ret)
    return ret;
    if (client.irq) {
