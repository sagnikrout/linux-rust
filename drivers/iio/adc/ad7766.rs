...
//! Source: drivers/iio/adc/ad7766.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7766_chip_info {
    pub decimation_factor: c_uint,
}
...
#[derive(Copy, Clone)]
pub struct ad7766 {
    pub chip_info: *const ad7766_chip_info,
    pub spi: *mut spi_device,
    pub mclk: *mut clk,
    pub pd_gpio: *mut gpio_desc,
    pub reg: [regulator_bulk_data; AD7766_NUM_SUPPLIES],
...
//
    pub __aligned(IIO_DMA_MINALIGN): unsigned char data[ALIGN(3, sizeof(s64)) + sizeof(s64)],
}
...
#[no_mangle]
unsafe extern "C" fn ad7766_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad7766_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7766_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7766_set_trigger_state(trig: *mut iio_trigger, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7766_probe(spi: *mut spi_device) -> c_int {
