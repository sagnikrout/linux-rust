...
//! Source: drivers/iio/adc/at91_adc.c
#![no_std]
...
// Registers
pub const AT91_ADC_CR: c_uint = 0x00		/* Control Register */;

pub const AT91_ADC_MR: c_uint = 0x04		/* Mode Register */;

pub const AT91_ADC_TSR: c_uint = 0x0C;

pub const AT91_ADC_CHER: c_uint = 0x10		/* Channel Enable Register */;
pub const AT91_ADC_CHDR: c_uint = 0x14		/* Channel Disable Register */;
pub const AT91_ADC_CHSR: c_uint = 0x18		/* Channel Status Register */;

pub const AT91_ADC_SR: c_uint = 0x1C		/* Status Register */;

pub const AT91_ADC_SR_9X5: c_uint = 0x30		/* Status Register for 9x5 */;

pub const AT91_ADC_LCDR: c_uint = 0x20		/* Last Converted Data Register */;

pub const AT91_ADC_IER: c_uint = 0x24		/* Interrupt Enable Register */;
pub const AT91_ADC_IDR: c_uint = 0x28		/* Interrupt Disable Register */;
pub const AT91_ADC_IMR: c_uint = 0x2C		/* Interrupt Mask Register */;

pub const AT91_ADC_ACR: c_uint = 0x94	/* Analog Control Register */;

pub const AT91_ADC_TSMR: c_uint = 0xB0;

pub const AT91_ADC_TSXPOSR: c_uint = 0xB4;
pub const AT91_ADC_TSYPOSR: c_uint = 0xB8;
pub const AT91_ADC_TSPRESSR: c_uint = 0xBC;

pub const AT91_ADC_TRGR_9G45: c_uint = 0x08;
pub const AT91_ADC_TRGR_9X5: c_uint = 0xC0;
...
pub const MAX_POS_BITS: c_int = 12;

pub const TOUCH_PEN_DETECT_DEBOUNCE_US: c_int = 200;
pub const MAX_RLPOS_BITS: c_int = 10;

pub const TOUCH_SHTIM: c_uint = 0xa;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct at91_adc_reg_desc {
    pub channel_base: u8,
    pub drdy_mask: u32,
    pub status_register: u8,
    pub trigger_register: u8,
    pub mr_prescal_mask: u32,
    pub mr_startup_mask: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct at91_adc_caps {
    pub /: *mut *mut bool has_ts; / Support touch screen,
    pub /: *mut *mut bool has_tsmr; / only at91sam9x5, sama5d3 have TSMR reg,
//
// Numbers of sampling data will be averaged. Can be 0~3.
// Hardware can average (2 ^ ts_filter_average) sample data.
//
    pub ts_filter_average: u8,
// Pen Detection input pull-up resistor, can be 0~3
    pub ts_pen_detect_sensitivity: u8,
// startup time calculate function
    pub adc_clk_khz): *mut *mut u32 (calc_startup_ticks)(u32 startup_time, u32,
    pub num_channels: u8,
    pub low_res_bits: u8,
    pub high_res_bits: u8,
    pub trigger_number: u32,
    pub triggers: *const at91_adc_trigger,
    pub registers: at91_adc_reg_desc,
}
...
pub struct at91_adc_state {
    ...
    pub registers: *const at91_adc_reg_desc,
    pub startup_time: u32,
    pub sample_hold_time: u8,
    pub sleep_mode: bool,
    pub trig: *mut iio_trigger,
    pub use_external: bool,
    pub vref_mv: u32,
    pub /: *mut *mut u32 res; / resolution used for conversions,
    pub wq_data_avail: wait_queue_head_t,
    pub caps: *const at91_adc_caps,
//
...
//
    ...
    pub touchscreen_type: enum atmel_adc_ts_type,
    pub ts_input: *mut input_dev,
    pub ts_sample_period_val: u16,
    pub ts_pressure_threshold: u32,
    pub ts_pendbc: u16,
    pub ts_bufferedmeasure: bool,
    pub ts_prev_absx: u32,
    pub ts_prev_absy: u32,
}
...
#[no_mangle]
unsafe extern "C" fn handle_adc_eoc_trigger(irq: c_int, idev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn at91_ts_sample(idev: *mut iio_dev) {
    static void at91_ts_sample(struct iio_dev *idev)
    {
    struct at91_adc_state *st = iio_priv(idev);
    unsigned int xscale, yscale, reg, z1, z2;
    unsigned int x, y, pres, xpos, ypos;
    let mut rxp: c_uint = 1;
    let mut factor: c_uint = 1000;
    let mut xyz_mask_bits: c_uint = st.res;
    let mut xyz_mask: c_uint = (1 << xyz_mask_bits) - 1;
// calculate position
...
#[no_mangle]
unsafe extern "C" fn at91_adc_rl_interrupt(irq: c_int, private: *mut c_void) -> irqreturn_t {
    static irqreturn_t at91_adc_rl_interrupt(int irq, void *private)
    {
    struct iio_dev *idev = private;
    struct at91_adc_state *st = iio_priv(idev);
    let mut status: u32 = at91_adc_readl(st, st.registers.status_register);
    unsigned int reg;
...
#[no_mangle]
unsafe extern "C" fn at91_adc_9x5_interrupt(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn at91_adc_channel_init(idev: *mut iio_dev) -> c_int {
    static int at91_adc_channel_init(struct iio_dev *idev)
    {
    struct at91_adc_state *st = iio_priv(idev);
    struct iio_chan_spec *chan_array;
    int bit, idx = 0;
    let mut rsvd_mask: c_ulong = 0;
// If touchscreen is enable, then reserve the adc channels
    if (st.touchscreen_type == ATMEL_ADC_TOUCHSCREEN_4WIRE)
    rsvd_mask = CHAN_MASK_TOUCHSCREEN_4WIRE;
#[no_mangle]
pub unsafe extern "C" fn if(ATMEL_ADC_TOUCHSCREEN_5WIRE: st->touchscreen_type ==) -> else {
...
unsafe extern "C" fn at91_adc_configure_trigger(trig: *mut iio_trigger, state: bool) -> c_int {
    ...
    let mut status: u32 = at91_adc_readl(st, reg.trigger_register);
    int value;
    u8 bit;
    ...
    if (st.buffer == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn at91_adc_trigger_init(idev: *mut iio_dev) -> c_int {
    ...
    st.caps.triggers + i);
    if (st.trig[i] == core::ptr::null_mut()) {
    dev_err(&idev.dev,
...
#[no_mangle]
unsafe extern "C" fn at91_adc_trigger_remove(idev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn at91_adc_buffer_init(idev: *mut iio_dev) -> c_int {
    static int at91_adc_buffer_init(struct iio_dev *idev)
    {
    return iio_triggered_buffer_setup(idev, &iio_pollfunc_store_time,
    &at91_adc_trigger_handler, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn at91_adc_buffer_remove(idev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn calc_startup_ticks_9260(startup_time: u32, adc_clk_khz: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn calc_startup_ticks_9x5(startup_time: u32, adc_clk_khz: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn atmel_ts_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_ts_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn at91_ts_hw_init(idev: *mut iio_dev, adc_clk_khz: u32) -> c_int {
    static int at91_ts_hw_init(struct iio_dev *idev, u32 adc_clk_khz)
    {
    struct at91_adc_state *st = iio_priv(idev);
    let mut reg: u32 = 0;
    let mut tssctim: u32 = 0;
    let mut i: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn at91_ts_unregister(st: *mut at91_adc_state) {
