...
//! Source: drivers/iio/adc/ad7606_par.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ad7606_par_bus_reg_read(st: *mut ad7606_state, addr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7606_par_probe(pdev: *mut platform_device) -> c_int {
...
//
    return ad7606_probe(&pdev.dev, 0, core::ptr::null_mut(),
    chip_info,
    &ad7606_bi_bops);
    } else {
