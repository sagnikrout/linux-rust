...
//! Source: drivers/iio/adc/qcom-vadc-common.c
#![no_std]
...
// scale_voltage = 0;
    ...
    int *result_uv)
    {
    let mut voltage: i64 = 0, result = 0;
...
// (ADC code * vref_vadc (1.875V)) / full_scale_code
    ...
    u16 adc_code, int *result_mdec)
    {
    let mut resistance: i64 = adc_code;
    int ret, result;
...
#[no_mangle]
pub unsafe extern "C" fn qcom_adc_tm5_gen2_temp_res_scale(temp: c_int) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn qcom_adc5_prescaling_from_dt(numerator: u32, denominator: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qcom_adc5_avg_samples_from_dt(value: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qcom_adc5_decimation_from_dt(value: u32, decimation: *const c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qcom_vadc_decimation_from_dt(value: u32) -> c_int {
