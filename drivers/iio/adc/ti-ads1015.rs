...
//! Source: drivers/iio/adc/ti-ads1015.c
#![no_std]
...
pub const ADS1015_CHANNELS: c_int = 8;
pub const ADS1015_CONV_REG: c_uint = 0x00;
pub const ADS1015_CFG_REG: c_uint = 0x01;
pub const ADS1015_LO_THRESH_REG: c_uint = 0x02;
pub const ADS1015_HI_THRESH_REG: c_uint = 0x03;
pub const ADS1015_CFG_COMP_QUE_SHIFT: c_int = 0;
pub const ADS1015_CFG_COMP_LAT_SHIFT: c_int = 2;
pub const ADS1015_CFG_COMP_POL_SHIFT: c_int = 3;
pub const ADS1015_CFG_COMP_MODE_SHIFT: c_int = 4;
pub const ADS1015_CFG_DR_SHIFT: c_int = 5;
pub const ADS1015_CFG_MOD_SHIFT: c_int = 8;
pub const ADS1015_CFG_PGA_SHIFT: c_int = 9;
pub const ADS1015_CFG_MUX_SHIFT: c_int = 12;

// Comparator queue and disable field
pub const ADS1015_CFG_COMP_DISABLE: c_int = 3;
// Comparator polarity field
pub const ADS1015_CFG_COMP_POL_LOW: c_int = 0;
pub const ADS1015_CFG_COMP_POL_HIGH: c_int = 1;
// Comparator mode field
pub const ADS1015_CFG_COMP_MODE_TRAD: c_int = 0;
pub const ADS1015_CFG_COMP_MODE_WINDOW: c_int = 1;
// device operating modes
pub const ADS1015_CONTINUOUS: c_int = 0;
pub const ADS1015_SINGLESHOT: c_int = 1;
pub const ADS1015_SLEEP_DELAY_MS: c_int = 2000;
pub const ADS1015_DEFAULT_PGA: c_int = 2;
pub const ADS1015_DEFAULT_DATA_RATE: c_int = 4;
pub const ADS1015_DEFAULT_CHAN: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads1015_chip_data {
    pub channels: *const iio_chan_spec,
    pub num_channels: c_int,
    pub info: *const iio_info,
    pub data_rate: *const c_int,
    pub data_rate_len: c_int,
    pub scale: *const c_int,
    pub scale_len: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads1015_channel_data {
    pub pga: c_uint,
    pub data_rate: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads1015_thresh_data {
    pub comp_queue: c_uint,
...
//
    pub lock: mutex,
    pub channel_data: [ads1015_channel_data; ADS1015_CHANNELS],
    pub event_channel: c_uint,
    pub comp_mode: c_uint,
    pub thresh_data: [ads1015_thresh_data; ADS1015_CHANNELS],
    pub chip: *const ads1015_chip_data,
//
// Set to true when the ADC is switched to the continuous-conversion
// mode and exits from a power-down state.  This flag is used to avoid
// getting the stale result from the conversion register.
//
    pub conv_invalid: bool,
}

#[no_mangle]
unsafe extern "C" fn ads1015_event_channel_enabled(data: *mut ads1015_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ads1015_event_channel_disable(data: *mut ads1015_data, chan: c_int) {
    ...
    ADS1015_V_DIFF_CHAN(0, 1, ADS1015_AIN0_AIN1, 12, 4, core::ptr::null_mut(), 0),
    ADS1015_V_DIFF_CHAN(0, 3, ADS1015_AIN0_AIN3, 12, 4, core::ptr::null_mut(), 0),
    ADS1015_V_DIFF_CHAN(1, 3, ADS1015_AIN1_AIN3, 12, 4, core::ptr::null_mut(), 0),
    ADS1015_V_DIFF_CHAN(2, 3, ADS1015_AIN2_AIN3, 12, 4, core::ptr::null_mut(), 0),
    ADS1015_V_CHAN(0, ADS1015_AIN0, 12, 4, core::ptr::null_mut(), 0),
    ADS1015_V_CHAN(1, ADS1015_AIN1, 12, 4, core::ptr::null_mut(), 0),
    ADS1015_V_CHAN(2, ADS1015_AIN2, 12, 4, core::ptr::null_mut(), 0),
    ADS1015_V_CHAN(3, ADS1015_AIN3, 12, 4, core::ptr::null_mut(), 0),
    IIO_CHAN_SOFT_TIMESTAMP(ADS1015_TIMESTAMP),
    };

#[no_mangle]
unsafe extern "C" fn ads1015_set_power_state(data: *mut ads1015_data, on: bool) -> c_int {
...
unsafe extern "C" fn ads1015_set_power_state(data: *mut ads1015_data, on: bool) -> c_int {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn ads1015_get_adc_result(data: *mut ads1015_data, chan: c_int, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1015_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ads1015_set_data_rate(data: *mut ads1015_data, chan: c_int, rate: c_int) -> c_int {
...
// val2 = period % USEC_PER_SEC;
    ...
    struct ads1015_data *data = iio_priv(indio_dev);
    const int *data_rate = data.chip.data_rate;
    let mut realbits: c_int = chan.scan_type.realbits;
    long long period;
    int i;
    int dr;
    guard(mutex)(&data.lock);
    ...
    {
    let mut low_thresh: c_int = data.thresh_data[chan.address].low_thresh;
    let mut high_thresh: c_int = data.thresh_data[chan.address].high_thresh;
    int ret;
    unsigned int val;
    if (ads1015_event_channel_enabled(data)) {
    if (data.event_channel != chan.address ||
...
#[no_mangle]
unsafe extern "C" fn ads1015_event_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ads1015_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1015_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1015_client_get_channels_config(client: *mut i2c_client) -> c_int {
    ...
    let mut pga: c_uint = ADS1015_DEFAULT_PGA;
    let mut data_rate: c_uint = ADS1015_DEFAULT_DATA_RATE;
...
#[no_mangle]
unsafe extern "C" fn ads1015_get_channels_config(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ads1015_set_conv_mode(data: *mut ads1015_data, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1015_power_down(p: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ads1015_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    let mut realbits: c_int = indio_dev.channels[i].scan_type.realbits;
...
// we need to keep this ABI the same as used by hwmon ADS1015 driver
    ...
    let mut irq_trig: c_ulong = irq_get_trigger_type(client.irq);
    ...
    core::ptr::null_mut(), ads1015_event_handler,
...
#[no_mangle]
unsafe extern "C" fn ads1015_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1015_runtime_resume(dev: *mut device) -> c_int {
    ...
    ads1015_runtime_resume, core::ptr::null_mut())
    };
