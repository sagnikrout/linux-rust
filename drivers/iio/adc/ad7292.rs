...
//! Source: drivers/iio/adc/ad7292.c
#![no_std]
...
pub const ADI_VENDOR_ID: c_uint = 0x0018;
pub const AD7292_INTERNAL_REF_MV: c_int = 1250;
// AD7292 registers definition
pub const AD7292_REG_VENDOR_ID: c_uint = 0x00;
pub const AD7292_REG_CONF_BANK: c_uint = 0x05;
pub const AD7292_REG_CONV_COMM: c_uint = 0x0E;

// AD7292 configuration bank subregisters definition
pub const AD7292_BANK_REG_VIN_RNG0: c_uint = 0x10;
pub const AD7292_BANK_REG_VIN_RNG1: c_uint = 0x11;
pub const AD7292_BANK_REG_SAMP_MODE: c_uint = 0x12;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7292_state {
    pub spi: *mut spi_device,
    pub vref_mv: c_ushort,
    pub __aligned(IIO_DMA_MINALIGN): __be16 d16,
    pub d8: [u8; 2],
}

#[no_mangle]
unsafe extern "C" fn ad7292_spi_reg_read(st: *mut ad7292_state, addr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7292_vin_range_multiplier(st: *mut ad7292_state, channel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7292_probe(spi: *mut spi_device) -> c_int {
    static int ad7292_probe(struct spi_device *spi)
    {
    struct device *dev = &spi.dev;
    struct ad7292_state *st;
    struct iio_dev *indio_dev;
    let mut diff_channels: bool = false;
    int ret;
