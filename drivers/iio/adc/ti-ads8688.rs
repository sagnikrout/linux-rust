...
//! Source: drivers/iio/adc/ti-ads8688.c
#![no_std]
...
pub const ADS8688_CMD_REG_NOOP: c_uint = 0x00;
pub const ADS8688_CMD_REG_RST: c_uint = 0x85;

pub const ADS8688_CMD_DONT_CARE_BITS: c_int = 16;

pub const ADS8688_PROG_DONT_CARE_BITS: c_int = 8;
pub const ADS8688_REG_PLUSMINUS25VREF: c_int = 0;
pub const ADS8688_REG_PLUSMINUS125VREF: c_int = 1;
pub const ADS8688_REG_PLUSMINUS0625VREF: c_int = 2;
pub const ADS8688_REG_PLUS25VREF: c_int = 5;
pub const ADS8688_REG_PLUS125VREF: c_int = 6;
pub const ADS8688_VREF_MV: c_int = 4096;
pub const ADS8688_REALBITS: c_int = 16;
pub const ADS8688_MAX_CHANNELS: c_int = 8;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads8688_state {
    pub lock: mutex,
    pub chip_info: *const ads8688_chip_info,
    pub spi: *mut spi_device,
    pub vref_mv: c_uint,
    pub scale_avail: [c_int; 3][2],
    pub range: [enum ads8688_range; 8],
    union {
    pub d32: __be32,
    pub d8: [u8; 4],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads8688_ranges {
    pub range: enum ads8688_range,
    pub scale: c_uint,
    pub offset: c_int,
    pub reg: u8,
}
...
#[no_mangle]
unsafe extern "C" fn ads8688_reset(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads8688_read(indio_dev: *mut iio_dev, chan: c_uint) -> c_int {
...
// val = offset;
    ...
    let mut ret: c_int = -EINVAL, i, offset = 0;
    mutex_lock(&st.lock);
    switch (mask) {
    case IIO_CHAN_INFO_SCALE:
...
#[no_mangle]
unsafe extern "C" fn ads8688_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ads8688_probe(spi: *mut spi_device) -> c_int {
    ...
    ads8688_trigger_handler, core::ptr::null_mut());
    if (ret < 0)
