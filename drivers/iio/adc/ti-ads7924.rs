...
//! Source: drivers/iio/adc/ti-ads7924.c
#![no_std]
...
pub const ADS7924_CHANNELS: c_int = 4;
pub const ADS7924_BITS: c_int = 12;
pub const ADS7924_DATA_SHIFT: c_int = 4;
// Registers.
pub const ADS7924_MODECNTRL_REG: c_uint = 0x00;
pub const ADS7924_INTCNTRL_REG: c_uint = 0x01;
pub const ADS7924_DATA0_U_REG: c_uint = 0x02;
pub const ADS7924_DATA0_L_REG: c_uint = 0x03;
pub const ADS7924_DATA1_U_REG: c_uint = 0x04;
pub const ADS7924_DATA1_L_REG: c_uint = 0x05;
pub const ADS7924_DATA2_U_REG: c_uint = 0x06;
pub const ADS7924_DATA2_L_REG: c_uint = 0x07;
pub const ADS7924_DATA3_U_REG: c_uint = 0x08;
pub const ADS7924_DATA3_L_REG: c_uint = 0x09;
pub const ADS7924_ULR0_REG: c_uint = 0x0A;
pub const ADS7924_LLR0_REG: c_uint = 0x0B;
pub const ADS7924_ULR1_REG: c_uint = 0x0C;
pub const ADS7924_LLR1_REG: c_uint = 0x0D;
pub const ADS7924_ULR2_REG: c_uint = 0x0E;
pub const ADS7924_LLR2_REG: c_uint = 0x0F;
pub const ADS7924_ULR3_REG: c_uint = 0x10;
pub const ADS7924_LLR3_REG: c_uint = 0x11;
pub const ADS7924_INTCONFIG_REG: c_uint = 0x12;
pub const ADS7924_SLPCONFIG_REG: c_uint = 0x13;
pub const ADS7924_ACQCONFIG_REG: c_uint = 0x14;
pub const ADS7924_PWRCONFIG_REG: c_uint = 0x15;
pub const ADS7924_RESET_REG: c_uint = 0x16;
//
...
pub const ADS7924_CFG_INTPOL_BIT: c_int = 1;
pub const ADS7924_CFG_INTTRIG_BIT: c_int = 0;

// Interrupt pin polarity
pub const ADS7924_CFG_INTPOL_LOW: c_int = 0;
pub const ADS7924_CFG_INTPOL_HIGH: c_int = 1;
// Interrupt pin signaling
pub const ADS7924_CFG_INTTRIG_LEVEL: c_int = 0;
pub const ADS7924_CFG_INTTRIG_EDGE: c_int = 1;
// Mode control values
pub const ADS7924_MODECNTRL_IDLE: c_uint = 0x00;
pub const ADS7924_MODECNTRL_AWAKE: c_uint = 0x20;
pub const ADS7924_MODECNTRL_MANUAL_SINGLE: c_uint = 0x30;
pub const ADS7924_MODECNTRL_MANUAL_SCAN: c_uint = 0x32;
pub const ADS7924_MODECNTRL_AUTO_SINGLE: c_uint = 0x31;
pub const ADS7924_MODECNTRL_AUTO_SCAN: c_uint = 0x33;
pub const ADS7924_MODECNTRL_AUTO_SINGLE_SLEEP: c_uint = 0x39;
pub const ADS7924_MODECNTRL_AUTO_SCAN_SLEEP: c_uint = 0x3B;
pub const ADS7924_MODECNTRL_AUTO_BURST_SLEEP: c_uint = 0x3F;
...
// time of 6us.
//
pub const ADS7924_ACQTIME_US: c_int = 6;
// The conversion time is always 4μs and cannot be programmed by the user.
pub const ADS7924_CONVTIME_US: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn ads7924_is_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ads7924_get_channels_config(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7924_set_conv_mode(data: *mut ads7924_data, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7924_reset(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7924_reg_disable(data: *mut c_void) {
    static void ads7924_reg_disable(void *data)
    {
    regulator_disable(data);
    }
#[no_mangle]
unsafe extern "C" fn ads7924_set_idle_mode(data: *mut c_void) {
    static void ads7924_set_idle_mode(void *data)
    {
    ads7924_set_conv_mode(data, ADS7924_MODECNTRL_IDLE);
    }
#[no_mangle]
unsafe extern "C" fn ads7924_probe(client: *mut i2c_client) -> c_int {
