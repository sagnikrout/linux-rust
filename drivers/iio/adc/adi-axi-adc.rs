...
//! Source: drivers/iio/adc/adi-axi-adc.c
#![no_std]
...
//
// ADC controls
pub const ADI_AXI_REG_RSTN: c_uint = 0x0040;

pub const ADI_AXI_ADC_REG_CONFIG: c_uint = 0x000c;

pub const ADI_AXI_ADC_REG_CTRL: c_uint = 0x0044;

pub const ADI_AXI_ADC_REG_CNTRL_3: c_uint = 0x004c;

pub const AXI_AD485X_PACKET_FORMAT_20BIT: c_uint = 0x0;
pub const AXI_AD485X_PACKET_FORMAT_24BIT: c_uint = 0x1;
pub const AXI_AD485X_PACKET_FORMAT_32BIT: c_uint = 0x2;

pub const AXI_AD408X_PACKET_FORMAT_20BIT: c_uint = 0x0;
pub const AXI_AD408X_PACKET_FORMAT_16BIT: c_uint = 0x1;
pub const AXI_AD408X_PACKET_FORMAT_14BIT: c_uint = 0x2;
pub const ADI_AXI_ADC_REG_SYNC_STATUS: c_uint = 0x0068;

pub const ADI_AXI_ADC_REG_DRP_STATUS: c_uint = 0x0074;
...
pub const ADI_AXI_REG_CONFIG_WR: c_uint = 0x0080;
pub const ADI_AXI_REG_CONFIG_RD: c_uint = 0x0084;
pub const ADI_AXI_REG_CONFIG_CTRL: c_uint = 0x008c;
pub const ADI_AXI_REG_CONFIG_CTRL_READ: c_uint = 0x03;
pub const ADI_AXI_REG_CONFIG_CTRL_WRITE: c_uint = 0x01;
pub const ADI_AXI_ADC_MAX_IO_NUM_LANES: c_int = 15;

    (ADI_AXI_REG_CHAN_CTRL_FMT_SIGNEXT |	\
    ADI_AXI_REG_CHAN_CTRL_FMT_EN |		\
    ADI_AXI_REG_CHAN_CTRL_ENABLE)
pub const ADI_AXI_REG_READ_BIT: c_uint = 0x8000;
pub const ADI_AXI_REG_ADDRESS_MASK: c_uint = 0xff00;
pub const ADI_AXI_REG_VALUE_MASK: c_uint = 0x00ff;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct axi_adc_info {
    pub version: c_uint,
    pub backend_info: *const iio_backend_info,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adi_axi_adc_state {
    pub info: *const axi_adc_info,
...
#[no_mangle]
unsafe extern "C" fn axi_adc_enable(back: *mut iio_backend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_adc_disable(back: *mut iio_backend) {
...
#[no_mangle]
unsafe extern "C" fn axi_adc_chan_enable(back: *mut iio_backend, chan: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_adc_chan_disable(back: *mut iio_backend, chan: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_adc_raw_write(back: *mut iio_backend, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_adc_raw_read(back: *mut iio_backend, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7606_bus_reg_read(back: *mut iio_backend, reg: u32, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7606_bus_reg_write(back: *mut iio_backend, reg: u32, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_adc_child_remove(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn adi_axi_adc_probe(pdev: *mut platform_device) -> c_int {
