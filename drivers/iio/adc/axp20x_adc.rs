...
//! Source: drivers/iio/adc/axp20x_adc.c
#![no_std]
...
pub const AXP717_ADC_DATA_TS: c_uint = 0x00;
pub const AXP717_ADC_DATA_TEMP: c_uint = 0x01;
pub const AXP717_ADC_DATA_VMID: c_uint = 0x02;
pub const AXP717_ADC_DATA_BKUP_BATT: c_uint = 0x03;
...
#[no_mangle]
unsafe extern "C" fn axp192_adc_scale_voltage(channel: c_int, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp20x_adc_scale_voltage(channel: c_int, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp22x_adc_scale_voltage(channel: c_int, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp813_adc_scale_voltage(channel: c_int, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp20x_adc_scale_current(channel: c_int, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp20x_adc_rate(info: *mut axp20x_adc_iio, rate: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp22x_adc_rate(info: *mut axp20x_adc_iio, rate: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp813_adc_rate(info: *mut axp20x_adc_iio, rate: c_int) -> c_int {
...
pub struct axp_data {
    ...
    pub adc_en1: c_ulong,
    pub adc_en1_mask: c_ulong,
    pub adc_en2: c_ulong,
    pub adc_en2_mask: c_ulong,
    int				(*adc_rate)(struct axp20x_adc_iio *info,
    pub rate): c_int,
    pub maps: *const iio_map,
}
...
#[no_mangle]
unsafe extern "C" fn axp20x_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp20x_remove(pdev: *mut platform_device) {
