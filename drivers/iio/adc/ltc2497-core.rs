...
//! Source: drivers/iio/adc/ltc2497-core.c
#![no_std]
...
pub const LTC2497_DIFF: c_int = 0;

#[no_mangle]
unsafe extern "C" fn ltc2497core_wait_conv(ddata: *mut ltc2497core_driverdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2497core_read(ddata: *mut ltc2497core_driverdata, address: u8, val: *mut c_int) -> c_int {
    ...
    ret = ddata.result_and_measure(ddata, address, core::ptr::null_mut());
    if (ret < 0)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn ltc2497core_probe(dev: *mut device, indio_dev: *mut iio_dev) -> c_int {
...
//
    ...
    ret = ddata.result_and_measure(ddata, LTC2497_CONFIG_DEFAULT, core::ptr::null_mut());
    if (ret < 0)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn ltc2497core_remove(indio_dev: *mut iio_dev) {
