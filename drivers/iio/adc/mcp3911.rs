...
//! Source: drivers/iio/adc/mcp3911.c
#![no_std]
...
pub const MCP3911_REG_CHANNEL0: c_uint = 0x00;
pub const MCP3911_REG_CHANNEL1: c_uint = 0x03;
pub const MCP3911_REG_MOD: c_uint = 0x06;
pub const MCP3911_REG_PHASE: c_uint = 0x07;
pub const MCP3911_REG_GAIN: c_uint = 0x09;

pub const MCP3911_REG_STATUSCOM: c_uint = 0x0a;

pub const MCP3911_REG_CONFIG: c_uint = 0x0c;

pub const MCP3911_REG_OFFCAL_CH0: c_uint = 0x0e;
pub const MCP3911_REG_GAINCAL_CH0: c_uint = 0x11;
pub const MCP3911_REG_OFFCAL_CH1: c_uint = 0x14;
pub const MCP3911_REG_GAINCAL_CH1: c_uint = 0x17;
pub const MCP3911_REG_VREFCAL: c_uint = 0x1a;

// Internal voltage reference in mV
pub const MCP3911_INT_VREF_MV: c_int = 1200;

pub const MCP3911_NUM_SCALES: c_int = 6;
// Registers compatible with MCP3910
pub const MCP3910_REG_STATUSCOM: c_uint = 0x0c;

pub const MCP3910_REG_GAIN: c_uint = 0x0b;
pub const MCP3910_REG_CONFIG0: c_uint = 0x0d;

pub const MCP3910_REG_CONFIG1: c_uint = 0x0e;

pub const MCP3910_REG_OFFCAL_CH0: c_uint = 0x0f;

// Maximal number of channels used by the MCP39XX family
pub const MCP39XX_MAX_NUM_CHANNELS: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp3911_chip_info {
    pub channels: *const iio_chan_spec,
    pub num_channels: c_uint,
    pub external_vref): *mut *mut *mut int (config)(struct mcp3911 adc, bool,
    pub val): *mut *mut *mut int (get_osr)(struct mcp3911 adc, u32,
    pub val): *mut *mut *mut int (set_osr)(struct mcp3911 adc, u32,
    pub enable): *mut *mut *mut int (enable_offset)(struct mcp3911 adc, bool,
    pub val): *mut *mut *mut int (get_offset)(struct mcp3911 adc, int channel, int,
    pub val): *mut *mut *mut int (set_offset)(struct mcp3911 adc, int channel, int,
    pub val): *mut *mut *mut int (set_scale)(struct mcp3911 adc, int channel, u32,
    pub val): *mut *mut *mut int (get_raw)(struct mcp3911 adc, int channel, int,
}
...
pub struct mcp3911 {
    ...
    pub gain: [u32; MCP39XX_MAX_NUM_CHANNELS],
    pub chip: *const mcp3911_chip_info,
    struct {
    pub channels: [u32; MCP39XX_MAX_NUM_CHANNELS],
    pub ts: aligned_s64,
    pub scan: },
    pub __aligned(IIO_DMA_MINALIGN): u8 tx_buf,
    pub 3]: *mut *mut u8 rx_buf[MCP39XX_MAX_NUM_CHANNELS,
}

#[no_mangle]
unsafe extern "C" fn mcp3911_read(adc: *mut mcp3911, reg: u8, val: *mut u32, len: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp3911_write(adc: *mut mcp3911, reg: u8, val: u32, len: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp3911_update(adc: *mut mcp3911, reg: u8, mask: u32, val: u32, len: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp3911_read_s24(adc: *const *const mcp3911, reg: u8 const, val: *const *const i32) -> c_int {
    static int mcp3911_read_s24(struct mcp3911 *const adc, u8 const reg, s32 *const val)
    {
    u32 uval;
    let mut ret: int const = mcp3911_read(adc, reg, &uval, 3);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn mcp3910_enable_offset(adc: *mut mcp3911, enable: bool) -> c_int {
    static int mcp3910_enable_offset(struct mcp3911 *adc, bool enable)
    {
    let mut mask: c_uint = MCP3910_CONFIG0_EN_OFFCAL;
    let mut value: c_uint = enable ? mask : 0;
    return mcp3911_update(adc, MCP3910_REG_CONFIG0, mask, value, 3);
    }
#[no_mangle]
unsafe extern "C" fn mcp3910_get_offset(adc: *mut mcp3911, channel: c_int, val: *mut c_int) -> c_int {
    static int mcp3910_get_offset(struct mcp3911 *adc, int channel, int *val)
    {
    return mcp3911_read(adc, MCP3910_OFFCAL(channel), val, 3);
    }
#[no_mangle]
unsafe extern "C" fn mcp3910_set_offset(adc: *mut mcp3911, channel: c_int, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp3910_get_raw(adc: *mut mcp3911, channel: c_int, val: *mut i32) -> c_int {
    static int mcp3910_get_raw(struct mcp3911 *adc, int channel, s32 *val)
    {
    return mcp3911_read_s24(adc, MCP3910_CHANNEL(channel), val);
    }
#[no_mangle]
unsafe extern "C" fn mcp3911_enable_offset(adc: *mut mcp3911, enable: bool) -> c_int {
    static int mcp3911_enable_offset(struct mcp3911 *adc, bool enable)
    {
    let mut mask: c_uint = MCP3911_STATUSCOM_EN_OFFCAL;
    let mut value: c_uint = enable ? mask : 0;
    return mcp3911_update(adc, MCP3911_REG_STATUSCOM, mask, value, 2);
    }
#[no_mangle]
unsafe extern "C" fn mcp3911_get_offset(adc: *mut mcp3911, channel: c_int, val: *mut c_int) -> c_int {
    static int mcp3911_get_offset(struct mcp3911 *adc, int channel, int *val)
    {
    return mcp3911_read(adc, MCP3911_OFFCAL(channel), val, 3);
    }
#[no_mangle]
unsafe extern "C" fn mcp3911_set_offset(adc: *mut mcp3911, channel: c_int, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp3911_get_raw(adc: *mut mcp3911, channel: c_int, val: *mut i32) -> c_int {
    static int mcp3911_get_raw(struct mcp3911 *adc, int channel, s32 *val)
    {
    return mcp3911_read_s24(adc, MCP3911_CHANNEL(channel), val);
    }
#[no_mangle]
unsafe extern "C" fn mcp3910_get_osr(adc: *mut mcp3911, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp3910_set_osr(adc: *mut mcp3911, val: u32) -> c_int {
    static int mcp3910_set_osr(struct mcp3911 *adc, u32 val)
    {
    let mut osr: c_uint = FIELD_PREP(MCP3910_CONFIG0_OSR, val);
    let mut mask: c_uint = MCP3910_CONFIG0_OSR;
    return mcp3911_update(adc, MCP3910_REG_CONFIG0, mask, osr, 3);
    }
#[no_mangle]
unsafe extern "C" fn mcp3911_set_osr(adc: *mut mcp3911, val: u32) -> c_int {
    static int mcp3911_set_osr(struct mcp3911 *adc, u32 val)
    {
    let mut osr: c_uint = FIELD_PREP(MCP3911_CONFIG_OSR, val);
    let mut mask: c_uint = MCP3911_CONFIG_OSR;
    return mcp3911_update(adc, MCP3911_REG_CONFIG, mask, osr, 2);
    }
#[no_mangle]
unsafe extern "C" fn mcp3911_get_osr(adc: *mut mcp3911, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp3910_set_scale(adc: *mut mcp3911, channel: c_int, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp3911_set_scale(adc: *mut mcp3911, channel: c_int, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp3911_calc_scale_table(vref_mv: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp3911_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mcp3911_config(adc: *mut mcp3911, external_vref: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp3910_config(adc: *mut mcp3911, external_vref: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp3911_set_trigger_state(trig: *mut iio_trigger, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp3911_probe(spi: *mut spi_device) -> c_int {
    ...
    adc.clki = devm_clk_get_enabled(dev, core::ptr::null_mut());
    if (IS_ERR(adc.clki)) {
    if (PTR_ERR(adc.clki) == -ENOENT) {
    adc.clki = core::ptr::null_mut();
    } else {
...
//
    ...
    mcp3911_trigger_handler, core::ptr::null_mut());
    if (ret)
    return ret;
