...
//! Source: drivers/iio/adc/ad7380.c
#![no_std]
...
pub const MAX_NUM_CHANNELS: c_int = 8;
// 2.5V internal reference voltage
pub const AD7380_INTERNAL_REF_MV: c_int = 2500;
// 3.3V internal reference voltage for ADAQ
pub const ADAQ4380_INTERNAL_REF_MV: c_int = 3300;
// reading and writing registers is more reliable at lower than max speed
pub const AD7380_REG_WR_SPEED_HZ: c_int = 10000000;

pub const AD7380_REG_ADDR_NOP: c_uint = 0x0;
pub const AD7380_REG_ADDR_CONFIG1: c_uint = 0x1;
pub const AD7380_REG_ADDR_CONFIG2: c_uint = 0x2;
pub const AD7380_REG_ADDR_ALERT: c_uint = 0x3;
pub const AD7380_REG_ADDR_ALERT_LOW_TH: c_uint = 0x4;
pub const AD7380_REG_ADDR_ALERT_HIGH_TH: c_uint = 0x5;

pub const AD7380_CONFIG2_RESET_SOFT: c_uint = 0x3C;
pub const AD7380_CONFIG2_RESET_HARD: c_uint = 0xFF;

pub const AD7380_DEFAULT_GAIN_MILLI: c_int = 1000;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7380_timing_specs {
    pub /: *const *const unsigned int t_csh_ns; / CS minimum high time,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7380_chip_info {
    pub name: *const c_char,
    pub channels: *const iio_chan_spec,
    pub offload_channels: *const iio_chan_spec,
    pub num_channels: c_uint,
    pub num_simult_channels: c_uint,
    pub has_hardware_gain: bool,
    pub has_mux: bool,
    pub supplies: *const *const c_char,
    pub num_supplies: c_uint,
    pub external_ref_only: bool,
    pub internal_ref_only: bool,
    pub internal_ref_mv: c_uint,
    pub vcm_supplies: *const *const c_char,
    pub num_vcm_supplies: c_uint,
    pub available_scan_masks: *const c_ulong,
    pub timing_specs: *const ad7380_timing_specs,
    pub max_conversion_rate_hz: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7380_state {
    pub chip_info: *const ad7380_chip_info,
...
// How many SDO lines are wired up.
    pub num_sdo_lines: u8,
    pub vref_mv: c_uint,
    pub vcm_mv: [c_uint; MAX_NUM_CHANNELS],
    pub gain_milli: [c_uint; MAX_NUM_CHANNELS],
// xfers, message an buffer for reading sample data
    pub normal_xfer: [spi_transfer; 2],
    pub normal_msg: spi_message,
    pub seq_xfer: [spi_transfer; 4],
    pub seq_msg: spi_message,
    ...
    pub offload_trigger_hz: c_ulong,
...
//
    pub sizeof(u32)): *mut *mut IIO_DECLARE_DMA_BUFFER_WITH_TS(u8, scan_data, MAX_NUM_CHANNELS,
...
//
#[no_mangle]
unsafe extern "C" fn ad7380_regval_to_osr(regval: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7380_get_osr(st: *mut ad7380_state, val: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ad7380_set_ch(st: *mut ad7380_state, ch: c_uint) -> c_int {
...
//
    ...
    let mut t_convert: c_uint = T_CONVERT_NS;
    int oversampling_ratio, ret;
//
...
#[no_mangle]
unsafe extern "C" fn ad7380_set_sample_freq(st: *mut ad7380_state, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7380_offload_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7380_offload_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7380_triggered_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7380_triggered_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7380_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
    ...
    {
    let mut index: c_uint = scan_index;
    int ret;
    if (st.chip_info.has_mux) {
    let mut ch: c_uint = 0;
...
//
#[no_mangle]
unsafe extern "C" fn ad7380_osr_to_regval(ratio: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7380_set_oversampling_ratio(st: *mut ad7380_state, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7380_init(st: *mut ad7380_state, external_ref_en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7380_probe(spi: *mut spi_device) -> c_int {
...
//
    ...
    st.regmap = devm_regmap_init(dev, core::ptr::null_mut(), st, &ad7380_regmap_config);
    if (IS_ERR(st.regmap))
