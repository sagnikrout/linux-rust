...
//! Source: drivers/iio/adc/stm32-dfsdm-core.c
#![no_std]
...
pub const STM32H7_DFSDM_NUM_FILTERS: c_int = 4;
pub const STM32H7_DFSDM_NUM_CHANNELS: c_int = 8;
#[no_mangle]
unsafe extern "C" fn stm32_dfsdm_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dfsdm_priv {
    pub /: *mut *mut *mut platform_device pdev; / platform device,
    pub /: *mut *mut stm32_dfsdm dfsdm; / common data exported for all instances,
    pub /: *mut *mut unsigned int spi_clk_out_div; / SPI clkout divider value,
    pub /: *mut *mut atomic_t n_active_ch; / number of current active channels,
    pub /: *mut *mut *mut clk clk; / DFSDM clock,
    pub /: *mut *mut *mut clk aclk; / audio clock,
}
...
#[no_mangle]
unsafe extern "C" fn stm32_dfsdm_clk_prepare_enable(dfsdm: *mut stm32_dfsdm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dfsdm_clk_disable_unprepare(dfsdm: *mut stm32_dfsdm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn stm32_dfsdm_start_dfsdm(dfsdm: *mut stm32_dfsdm) -> c_int {
    int stm32_dfsdm_start_dfsdm(struct stm32_dfsdm *dfsdm)
    {
    struct dfsdm_priv *priv = to_stm32_dfsdm_priv(dfsdm);
    struct device *dev = &priv.pdev.dev;
    let mut clk_div: c_uint = priv.spi_clk_out_div, clk_src;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn stm32_dfsdm_stop_dfsdm(dfsdm: *mut stm32_dfsdm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dfsdm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dfsdm_core_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn stm32_dfsdm_core_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dfsdm_core_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dfsdm_core_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dfsdm_core_runtime_resume(dev: *mut device) -> c_int {
