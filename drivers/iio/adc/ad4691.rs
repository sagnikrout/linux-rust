...
//! Source: drivers/iio/adc/ad4691.c
#![no_std]
...
pub const AD4691_VREF_uV_MIN: c_int = 2400000;
pub const AD4691_VREF_uV_MAX: c_int = 5250000;
pub const AD4691_VREF_2P5_uV_MAX: c_int = 2750000;
pub const AD4691_VREF_3P0_uV_MAX: c_int = 3250000;
pub const AD4691_VREF_3P3_uV_MAX: c_int = 3750000;
pub const AD4691_VREF_4P096_uV_MAX: c_int = 4500000;
pub const AD4691_CNV_DUTY_CYCLE_NS: c_int = 380;
pub const AD4691_CNV_HIGH_TIME_NS: c_int = 430;
//
...
pub const AD4691_SPI_CONFIG_A_REG: c_uint = 0x000;

pub const AD4691_STATUS_REG: c_uint = 0x014;
pub const AD4691_CLAMP_STATUS1_REG: c_uint = 0x01A;
pub const AD4691_CLAMP_STATUS2_REG: c_uint = 0x01B;
pub const AD4691_DEVICE_SETUP: c_uint = 0x020;

pub const AD4691_REF_CTRL: c_uint = 0x021;

pub const AD4691_OSC_FREQ_REG: c_uint = 0x023;

pub const AD4691_STD_SEQ_CONFIG: c_uint = 0x025;
pub const AD4691_SEQ_ALL_CHANNELS_OFF: c_uint = 0x00;
pub const AD4691_SPARE_CONTROL: c_uint = 0x02A;
pub const AD4691_MAX_CHANNELS: c_int = 16;
pub const AD4691_NOOP: c_uint = 0x00;

pub const AD4691_EXIT_COMMAND: c_uint = 0x5000;
pub const AD4691_OSC_EN_REG: c_uint = 0x180;
pub const AD4691_STATE_RESET_REG: c_uint = 0x181;

pub const AD4691_ADC_SETUP: c_uint = 0x182;

pub const AD4691_CNV_BURST_MODE: c_uint = 0x01;
pub const AD4691_AUTONOMOUS_MODE: c_uint = 0x02;
//
...
//
pub const AD4691_ACC_MASK_REG: c_uint = 0x185;

pub const AD4691_GPIO_MODE1_REG: c_uint = 0x196;
pub const AD4691_GPIO_MODE2_REG: c_uint = 0x197;

pub const AD4691_GP_MODE_DATA_READY: c_uint = 0x06;
pub const AD4691_GPIO_READ: c_uint = 0x1A0;
pub const AD4691_ACC_STATUS_FULL1_REG: c_uint = 0x1B0;
pub const AD4691_ACC_STATUS_FULL2_REG: c_uint = 0x1B1;
pub const AD4691_ACC_STATUS_OVERRUN1_REG: c_uint = 0x1B2;
pub const AD4691_ACC_STATUS_OVERRUN2_REG: c_uint = 0x1B3;
pub const AD4691_ACC_STATUS_SAT1_REG: c_uint = 0x1B4;
pub const AD4691_ACC_STATUS_SAT2_REG: c_uint = 0x1BE;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4691_channel_info {
    pub __counted_by_ptr(num_channels): *const *const iio_chan_spec channels,
    pub __counted_by_ptr(num_channels): *const *const iio_chan_spec manual_channels,
    pub num_channels: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4691_chip_info {
    pub name: *const c_char,
    pub max_rate: c_uint,
    pub sw_info: *const ad4691_channel_info,
    pub offload_info: *const ad4691_channel_info,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4691_state {
    pub info: *const ad4691_chip_info,
    pub regmap: *mut regmap,
    pub spi: *mut spi_device,
    pub conv_trigger: *mut pwm_device,
    pub irq: c_int,
    pub vref_uV: c_int,
    pub cnv_period_ns: u32,
//
...
//
    pub samp_freq_avail: [c_int; ARRAY_SIZE(ad4691_oversampling_ratios)][ARRAY_SIZE(ad4691_osc_freqs_Hz)],
    pub samp_freq_avail_len: [c_int; ARRAY_SIZE(ad4691_oversampling_ratios)],
...
// transfers in one go.
//
    pub scan_msg: spi_message,
//
// max 16 + 1 NOOP (manual) or 2*16 + 1 state-reset (CNV burst).
//
    pub scan_xfers: [spi_transfer; 34],
//
...
//
    pub __aligned(IIO_DMA_MINALIGN): u16 scan_tx[17],
//
...
//
    pub __aligned(IIO_DMA_MINALIGN): u8 scan_tx_reset[4],
//
...
//
    pub 16): IIO_DECLARE_DMA_BUFFER_WITH_TS(__be16, vals,,
}
...
//
#[no_mangle]
unsafe extern "C" fn ad4691_gpio_setup(st: *mut ad4691_state, gp_num: c_uint) -> c_int {
    static int ad4691_gpio_setup(struct ad4691_state *st, unsigned int gp_num)
    {
    let mut bit_off: c_uint = gp_num % 2;
    let mut reg_off: c_uint = gp_num / 2;
    let mut shift: c_uint = 4 * bit_off;
    ...
    u64 *args, u32 nargs)
    {
    let mut type: return = = SPI_OFFLOAD_TRIGGER_DATA_READY && nargs == 1 && args[0] <= 3;
    }
...
#[no_mangle]
unsafe extern "C" fn ad4691_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
    ...
    return -EINVAL;
    tx[2] = val;
    return spi_write_then_read(spi, tx, 3, core::ptr::null_mut(), 0);
    case AD4691_ACC_MASK_REG:
    case AD4691_STD_SEQ_CONFIG:
    if (val > U16_MAX)
    return -EINVAL;
    put_unaligned_be16(val, &tx[2]);
    return spi_write_then_read(spi, tx, 4, core::ptr::null_mut(), 0);
    default:
    return -EINVAL;
    }
    }
#[no_mangle]
unsafe extern "C" fn ad4691_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ad4691_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ad4691_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ad4691_samp_freq_start(info: *const ad4691_chip_info) -> c_uint {
...
//
    ...
    unsigned int osr)
    {
    let mut start: c_uint = ad4691_samp_freq_start(st.info);
...
#[no_mangle]
unsafe extern "C" fn ad4691_write_osc_freq(st: *mut ad4691_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_osr_index(osr: c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn ad4691_precompute_samp_freq_avail(st: *mut ad4691_state) {
    ...
    let mut osr: c_uint = ad4691_oversampling_ratios[i];
    let mut n: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ad4691_set_sampling_freq(st: *mut ad4691_state, freq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_set_pwm_freq(st: *mut ad4691_state, freq: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_sampling_enable(st: *mut ad4691_state, enable: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ad4691_enter_conversion_mode(st: *mut ad4691_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_transfer(st: *mut ad4691_state, cmd: u16) -> c_int {
    static int ad4691_transfer(struct ad4691_state *st, u16 cmd)
    {
    u8 buf[2];
    put_unaligned_be16(cmd, buf);
    return spi_write_then_read(st.spi, buf, sizeof(buf), core::ptr::null_mut(), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ad4691_exit_conversion_mode(st: *mut ad4691_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_manual_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
//
    st.scan_xfers[k].rx_buf = (k == 0) ? core::ptr::null_mut() : &st.vals[k - 1];
...
#[no_mangle]
unsafe extern "C" fn ad4691_manual_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_cnv_burst_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_cnv_burst_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_cnv_burst_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_cnv_burst_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_manual_offload_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
    ...
    let mut bpw: c_uint = indio_dev.channels[0].scan_type.realbits;
    unsigned int bit, k;
    int ret;
    ret = ad4691_enter_conversion_mode(st);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn ad4691_manual_offload_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_cnv_burst_offload_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_cnv_burst_offload_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_irq(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad4691_trigger_reenable(trig: *mut iio_trigger) {
...
#[no_mangle]
unsafe extern "C" fn ad4691_read_scan(indio_dev: *mut iio_dev, ts: i64) {
...
#[no_mangle]
unsafe extern "C" fn ad4691_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad4691_pwm_setup(st: *mut ad4691_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_regulator_setup(st: *mut ad4691_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_reset(st: *mut ad4691_state) -> c_int {
    static int ad4691_reset(struct ad4691_state *st)
    {
    struct device *dev = regmap_get_device(st.regmap);
    struct reset_control *rst;
    int ret;
    rst = devm_reset_control_get_optional_exclusive(dev, core::ptr::null_mut());
    if (IS_ERR(rst))
...
#[no_mangle]
unsafe extern "C" fn ad4691_config(st: *mut ad4691_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4691_probe(spi: *mut spi_device) -> c_int {
    ...
    if (ret)
    return ret;
    st.regmap = devm_regmap_init(dev, core::ptr::null_mut(), spi, &ad4691_regmap_config);
    if (IS_ERR(st.regmap))
