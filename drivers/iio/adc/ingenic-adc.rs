...
//! Source: drivers/iio/adc/ingenic-adc.c
#![no_std]
...
pub const JZ_ADC_REG_ENABLE: c_uint = 0x00;
pub const JZ_ADC_REG_CFG: c_uint = 0x04;
pub const JZ_ADC_REG_CTRL: c_uint = 0x08;
pub const JZ_ADC_REG_STATUS: c_uint = 0x0c;
pub const JZ_ADC_REG_ADSAME: c_uint = 0x10;
pub const JZ_ADC_REG_ADWAIT: c_uint = 0x14;
pub const JZ_ADC_REG_ADTCH: c_uint = 0x18;
pub const JZ_ADC_REG_ADBDAT: c_uint = 0x1c;
pub const JZ_ADC_REG_ADSDAT: c_uint = 0x20;
pub const JZ_ADC_REG_ADCMD: c_uint = 0x24;
pub const JZ_ADC_REG_ADCLK: c_uint = 0x28;

pub const JZ_ADC_REG_ADCLK_CLKDIV_LSB: c_int = 0;
pub const JZ4725B_ADC_REG_ADCLK_CLKDIV10US_LSB: c_int = 16;
pub const JZ4770_ADC_REG_ADCLK_CLKDIV10US_LSB: c_int = 8;
pub const JZ4770_ADC_REG_ADCLK_CLKDIVMS_LSB: c_int = 16;

pub const JZ_ADC_AUX_VREF: c_int = 3300;
pub const JZ_ADC_AUX_VREF_BITS: c_int = 12;
pub const JZ_ADC_BATTERY_LOW_VREF: c_int = 2500;
pub const JZ_ADC_BATTERY_LOW_VREF_BITS: c_int = 12;
pub const JZ4725B_ADC_BATTERY_HIGH_VREF: c_int = 7500;
pub const JZ4725B_ADC_BATTERY_HIGH_VREF_BITS: c_int = 10;

pub const JZ4740_ADC_BATTERY_HIGH_VREF_BITS: c_int = 12;
pub const JZ4760_ADC_BATTERY_VREF: c_int = 2500;
pub const JZ4770_ADC_BATTERY_VREF: c_int = 1200;
pub const JZ4770_ADC_BATTERY_VREF_BITS: c_int = 12;

    struct ingenic_adc;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingenic_adc_soc_data {
    pub battery_high_vref: c_uint,
    pub battery_high_vref_bits: c_uint,
    pub battery_raw_avail: *const c_int,
    pub battery_raw_avail_size: usize,
    pub battery_scale_avail: *const c_int,
    pub battery_scale_avail_size: usize,
    pub 1: unsigned int battery_vref_mode:,
    pub 1: unsigned int has_aux_md:,
    pub channels: *const iio_chan_spec,
    pub num_channels: c_uint,
    pub adc): *mut *mut *mut int (init_clk_div)(struct device dev, struct ingenic_adc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingenic_adc {
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub lock: mutex,
    pub aux_lock: mutex,
    pub soc_data: *const ingenic_adc_soc_data,
    pub low_vref_mode: bool,
}

#[no_mangle]
unsafe extern "C" fn ingenic_adc_set_adcmd(iio_dev: *mut iio_dev, mask: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn jz4725b_adc_init_clk_div(dev: *mut device, adc: *mut ingenic_adc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jz4770_adc_init_clk_div(dev: *mut device, adc: *mut ingenic_adc) -> c_int {
...
// And another, which produces a 1ms clock.
    ...
    .channels = jz4740_channels,
    .num_channels = ARRAY_SIZE(jz4740_channels),
    .init_clk_div = core::ptr::null_mut(), /* no ADCLK register on JZ4740 */
    };
...
#[no_mangle]
unsafe extern "C" fn ingenic_adc_buffer_enable(iio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ingenic_adc_buffer_disable(iio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ingenic_adc_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t ingenic_adc_irq(int irq, void *data)
    {
    struct iio_dev *iio_dev = data;
    struct ingenic_adc *adc = iio_priv(iio_dev);
    let mut mask: c_ulong = iio_dev.active_scan_mask[0];
    unsigned int i;
    u32 tdat[3];
...
#[no_mangle]
unsafe extern "C" fn ingenic_adc_probe(pdev: *mut platform_device) -> c_int {
