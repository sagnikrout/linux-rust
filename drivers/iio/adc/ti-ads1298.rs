...
//! Source: drivers/iio/adc/ti-ads1298.c
#![no_std]
...
// Commands
pub const ADS1298_CMD_WAKEUP: c_uint = 0x02;
pub const ADS1298_CMD_STANDBY: c_uint = 0x04;
pub const ADS1298_CMD_RESET: c_uint = 0x06;
pub const ADS1298_CMD_START: c_uint = 0x08;
pub const ADS1298_CMD_STOP: c_uint = 0x0a;
pub const ADS1298_CMD_RDATAC: c_uint = 0x10;
pub const ADS1298_CMD_SDATAC: c_uint = 0x11;
pub const ADS1298_CMD_RDATA: c_uint = 0x12;
pub const ADS1298_CMD_RREG: c_uint = 0x20;
pub const ADS1298_CMD_WREG: c_uint = 0x40;
// Registers
pub const ADS1298_REG_ID: c_uint = 0x00;

pub const ADS1298_ID_FAMILY_ADS129X: c_uint = 0x90;
pub const ADS1298_ID_FAMILY_ADS129XR: c_uint = 0xd0;
pub const ADS1298_REG_CONFIG1: c_uint = 0x01;

pub const ADS1298_SHIFT_DR_HR: c_int = 6;
pub const ADS1298_SHIFT_DR_LP: c_int = 7;
pub const ADS1298_LOWEST_DR: c_uint = 0x06;
pub const ADS1298_REG_CONFIG2: c_uint = 0x02;

pub const ADS1298_MASK_CONFIG2_TEST_FREQ_SLOW: c_int = 0;

pub const ADS1298_REG_CONFIG3: c_uint = 0x03;

pub const ADS1298_REG_LOFF: c_uint = 0x04;

pub const ADS1298_REG_LOFF_STATP: c_uint = 0x12;
pub const ADS1298_REG_LOFF_STATN: c_uint = 0x13;
pub const ADS1298_REG_CONFIG4: c_uint = 0x17;

pub const ADS1298_REG_WCT1: c_uint = 0x18;
pub const ADS1298_REG_WCT2: c_uint = 0x19;
pub const ADS1298_MAX_CHANNELS: c_int = 8;
pub const ADS1298_BITS_PER_SAMPLE: c_int = 24;
pub const ADS1298_CLK_RATE_HZ: c_int = 2048000;
...
pub const ADS1298_SPI_CMD_BUFFER_SIZE: c_int = 3;
// Outputs status word and 'n' 24-bit samples, plus the command byte

    ADS1298_SPI_RDATA_BUFFER_SIZE(ADS1298_MAX_CHANNELS)
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads1298_private {
    pub chip_info: *const ads1298_chip_info,
    pub spi: *mut spi_device,
    pub reg_avdd: *mut regulator,
    pub reg_vref: *mut regulator,
    pub clk: *mut clk,
    pub regmap: *mut regmap,
    pub completion: completion,
    pub trig: *mut iio_trigger,
    pub rdata_xfer: spi_transfer,
    pub rdata_msg: spi_message,
    pub /: *mut *mut spinlock_t irq_busy_lock; / Handshake between SPI and DRDY irqs,
//
...
//
    pub rdata_xfer_busy: c_uint,
// Temporary storage for demuxing data after SPI transfer
    pub bounce_buffer: [u32; ADS1298_MAX_CHANNELS],
// For synchronous SPI exchanges (read/write registers)
    pub __aligned(IIO_DMA_MINALIGN): u8 cmd_buffer[ADS1298_SPI_CMD_BUFFER_SIZE],
// Buffer used for incoming SPI data
    pub rx_buffer: [u8; ADS1298_SPI_RDATA_BUFFER_SIZE_MAX],
// Contains the RDATA command and zeroes to clock out
    pub tx_buffer: [u8; ADS1298_SPI_RDATA_BUFFER_SIZE_MAX],
}
...
#[no_mangle]
unsafe extern "C" fn ads1298_write_cmd(priv: *mut ads1298_private, command: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1298_read_one(priv: *mut ads1298_private, chan_index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1298_get_samp_freq(priv: *mut ads1298_private, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1298_set_samp_freq(priv: *mut ads1298_private, val: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: factor) -> else {
    else if (factor)
...
#[no_mangle]
unsafe extern "C" fn ads1298_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1298_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1298_rdata_unmark_busy(priv: *mut ads1298_private) {
...
#[no_mangle]
unsafe extern "C" fn ads1298_rdata_release_busy_or_restart(priv: *mut ads1298_private) {
...
#[no_mangle]
unsafe extern "C" fn ads1298_rdata_complete(context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ads1298_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ads1298_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1298_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1298_reg_disable(reg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ads1298_init(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1298_probe(spi: *mut spi_device) -> c_int {
...
// VREF can be supplied externally, otherwise use internal reference
    ...
    priv.reg_vref = core::ptr::null_mut();
    } else {
    ...
    priv.regmap = devm_regmap_init(dev, core::ptr::null_mut(), priv, &ads1298_regmap_config);
