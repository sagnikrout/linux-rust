...
//! Source: drivers/iio/adc/ad4851.c
#![no_std]
...
pub const AD4851_REG_INTERFACE_CONFIG_A: c_uint = 0x00;
pub const AD4851_REG_INTERFACE_CONFIG_B: c_uint = 0x01;
pub const AD4851_REG_PRODUCT_ID_L: c_uint = 0x04;
pub const AD4851_REG_PRODUCT_ID_H: c_uint = 0x05;
pub const AD4851_REG_DEVICE_CTRL: c_uint = 0x25;
pub const AD4851_REG_PACKET: c_uint = 0x26;
pub const AD4851_REG_OVERSAMPLE: c_uint = 0x27;
pub const AD4851_REG_CH_CONFIG_BASE: c_uint = 0x2A;

pub const AD4851_PACKET_FORMAT_0: c_int = 0;
pub const AD4851_PACKET_FORMAT_1: c_int = 1;

pub const AD4858_PACKET_SIZE_20: c_int = 0;
pub const AD4858_PACKET_SIZE_24: c_int = 1;
pub const AD4858_PACKET_SIZE_32: c_int = 2;
pub const AD4857_PACKET_SIZE_16: c_int = 0;
pub const AD4857_PACKET_SIZE_24: c_int = 1;
pub const AD4851_TESTPAT_0_DEFAULT: c_uint = 0x2A;
pub const AD4851_TESTPAT_1_DEFAULT: c_uint = 0x3C;
pub const AD4851_TESTPAT_2_DEFAULT: c_uint = 0xCE;

pub const AD4851_SOFTSPAN_0V_2V5: c_int = 0;
pub const AD4851_SOFTSPAN_N2V5_2V5: c_int = 1;
pub const AD4851_SOFTSPAN_0V_5V: c_int = 2;
pub const AD4851_SOFTSPAN_N5V_5V: c_int = 3;
pub const AD4851_SOFTSPAN_0V_6V25: c_int = 4;
pub const AD4851_SOFTSPAN_N6V25_6V25: c_int = 5;
pub const AD4851_SOFTSPAN_0V_10V: c_int = 6;
pub const AD4851_SOFTSPAN_N10V_10V: c_int = 7;
pub const AD4851_SOFTSPAN_0V_12V5: c_int = 8;
pub const AD4851_SOFTSPAN_N12V5_12V5: c_int = 9;
pub const AD4851_SOFTSPAN_0V_20V: c_int = 10;
pub const AD4851_SOFTSPAN_N20V_20V: c_int = 11;
pub const AD4851_SOFTSPAN_0V_25V: c_int = 12;
pub const AD4851_SOFTSPAN_N25V_25V: c_int = 13;
pub const AD4851_SOFTSPAN_0V_40V: c_int = 14;
pub const AD4851_SOFTSPAN_N40V_40V: c_int = 15;
pub const AD4851_MAX_LANES: c_int = 8;
pub const AD4851_MAX_IODELAY: c_int = 32;
pub const AD4851_T_CNVH_NS: c_int = 40;
pub const AD4851_T_CNVH_NS_MARGIN: c_int = 10;
pub const AD4841_MAX_SCALE_AVAIL: c_int = 8;
pub const AD4851_MAX_CH_NR: c_int = 8;
pub const AD4851_CH_START: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4851_scale {
    pub scale_val: c_uint,
    pub reg_val: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4851_chip_info {
    pub name: *const c_char,
    pub product_id: c_uint,
    pub num_scales: c_int,
    pub max_sample_rate_hz: c_ulong,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4851_state {
    pub spi: *mut spi_device,
    pub cnv: *mut pwm_device,
...
//
    ...
    pub info: *const ad4851_chip_info,
    pub pd_gpio: *mut gpio_desc,
    pub resolution_boost_enabled: bool,
    pub cnv_trigger_rate_hz: c_ulong,
    pub osr: c_uint,
    pub vrefbuf_en: bool,
    pub vrefio_en: bool,
    pub bipolar_ch: [bool; AD4851_MAX_CH_NR],
    pub scales_unipolar: [c_uint; AD4841_MAX_SCALE_AVAIL][2],
    pub scales_bipolar: [c_uint; AD4841_MAX_SCALE_AVAIL][2],
}
...
#[no_mangle]
unsafe extern "C" fn ad4851_set_sampling_freq(st: *mut ad4851_state, freq: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4851_osr_to_regval(ratio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4851_scale_fill(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4851_get_oversampling_ratio(st: *mut ad4851_state, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4851_pwm_disable(data: *mut c_void) {
    static void ad4851_pwm_disable(void *data)
    {
    pwm_disable(data);
    }
#[no_mangle]
unsafe extern "C" fn ad4851_setup(st: *mut ad4851_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4851_calibrate(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4851_get_calibscale(st: *mut ad4851_state, ch: c_int, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4851_get_calibbias(st: *mut ad4851_state, ch: c_int, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4851_set_calibbias(st: *mut ad4851_state, ch: c_int, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4857_parse_channels(indio_dev: *mut iio_dev) -> c_int {
    static int ad4857_parse_channels(struct iio_dev *indio_dev)
    {
    struct iio_chan_spec *ad4851_channels;
    let mut ad4851_chan: iio_chan_spec = AD4857_IIO_CHANNEL;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ad4858_parse_channels(indio_dev: *mut iio_dev) -> c_int {
    static int ad4858_parse_channels(struct iio_dev *indio_dev)
    {
    struct ad4851_state *st = iio_priv(indio_dev);
    struct device *dev = &st.spi.dev;
    struct iio_chan_spec *ad4851_channels;
    let mut ad4851_chan: iio_chan_spec = AD4858_IIO_CHANNEL;
    int ret, i = 0;
    ret = ad4851_parse_channels_common(indio_dev, &ad4851_channels,
    ad4851_chan);
    if (ret < 0)
...
#[no_mangle]
unsafe extern "C" fn ad4851_probe(spi: *mut spi_device) -> c_int {
    ...
    st.cnv = devm_pwm_get(dev, core::ptr::null_mut());
    if (IS_ERR(st.cnv))
