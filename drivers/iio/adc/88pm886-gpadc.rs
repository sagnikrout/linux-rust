...
//! Source: drivers/iio/adc/88pm886-gpadc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gpadc_get_raw(iio: *mut iio_dev, chan: enum pm886_gpadc_channel) -> c_int {
    ...
    {
    let mut gpadc_num: c_uint = chan - GPADC0_CHAN;
    let mut bits: c_uint = BIT(gpadc_num + 4) | BIT(gpadc_num);
    ...
    {
    struct pm886_gpadc *gpadc = iio_priv(iio);
    let mut gpadc_num: c_uint = chan.channel - GPADC0_CHAN;
    let mut reg: c_uint = PM886_REG_GPADC_CONFIG(0xb + gpadc_num);
    let mut lsb: c_ulong = chan.address;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn pm886_gpadc_hw_enable(map: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm886_gpadc_hw_disable(map: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm886_gpadc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm886_gpadc_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm886_gpadc_runtime_suspend(dev: *mut device) -> c_int {
    ...
    pm886_gpadc_runtime_resume, core::ptr::null_mut());
