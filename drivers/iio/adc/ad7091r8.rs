...
//! Source: drivers/iio/adc/ad7091r8.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ad7091r8_set_mode(st: *mut ad7091r_state, mode: enum ad7091r_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7091r8_reg_result_chan_id(val: c_uint) -> c_uint {
    ...
    AD7091R_CHANNEL(0, 12, core::ptr::null_mut(), 0),
    AD7091R_CHANNEL(1, 12, core::ptr::null_mut(), 0),
    };
    static const struct iio_chan_spec ad7091r4_channels[] = {
    AD7091R_CHANNEL(0, 12, core::ptr::null_mut(), 0),
    AD7091R_CHANNEL(1, 12, core::ptr::null_mut(), 0),
    AD7091R_CHANNEL(2, 12, core::ptr::null_mut(), 0),
    AD7091R_CHANNEL(3, 12, core::ptr::null_mut(), 0),
    };
    ...
    AD7091R_CHANNEL(2, 12, core::ptr::null_mut(), 0),
    AD7091R_CHANNEL(3, 12, core::ptr::null_mut(), 0),
    AD7091R_CHANNEL(4, 12, core::ptr::null_mut(), 0),
    AD7091R_CHANNEL(5, 12, core::ptr::null_mut(), 0),
    AD7091R_CHANNEL(6, 12, core::ptr::null_mut(), 0),
    AD7091R_CHANNEL(7, 12, core::ptr::null_mut(), 0),
    };
...
#[no_mangle]
unsafe extern "C" fn ad7091r_pulse_convst(st: *mut ad7091r_state) {
...
//
    ...
    let mut ad7091r2_reg_conf: static struct regmap_config = AD7091R_SPI_REGMAP_CONFIG(2);
    let mut ad7091r4_reg_conf: static struct regmap_config = AD7091R_SPI_REGMAP_CONFIG(4);
    let mut ad7091r8_reg_conf: static struct regmap_config = AD7091R_SPI_REGMAP_CONFIG(8);
...
#[no_mangle]
unsafe extern "C" fn ad7091r8_gpio_setup(st: *mut ad7091r_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7091r8_spi_probe(spi: *mut spi_device) -> c_int {
