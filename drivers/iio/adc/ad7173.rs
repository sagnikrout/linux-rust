...
//! Source: drivers/iio/adc/ad7173.c
#![no_std]
...
pub const AD7173_REG_COMMS: c_uint = 0x00;
pub const AD7173_REG_ADC_MODE: c_uint = 0x01;
pub const AD7173_REG_INTERFACE_MODE: c_uint = 0x02;
pub const AD7173_REG_CRC: c_uint = 0x03;
pub const AD7173_REG_DATA: c_uint = 0x04;
pub const AD7173_REG_GPIO: c_uint = 0x06;
pub const AD7173_REG_ID: c_uint = 0x07;

pub const AD7173_NO_AINS_PER_CHANNEL: c_int = 2;

    (FIELD_PREP(AD7173_CH_SETUP_AINPOS_MASK, pos) | \
    FIELD_PREP(AD7173_CH_SETUP_AINNEG_MASK, neg))
pub const AD7173_AIN_TEMP_POS: c_int = 17;
pub const AD7173_AIN_TEMP_NEG: c_int = 18;
pub const AD7173_AIN_POW_MON_POS: c_int = 19;
pub const AD7173_AIN_POW_MON_NEG: c_int = 20;
pub const AD7173_AIN_REF_POS: c_int = 21;
pub const AD7173_AIN_REF_NEG: c_int = 22;

    (x) == AD7173_AIN_REF_NEG)
pub const AD7172_2_ID: c_uint = 0x00d0;
pub const AD7176_ID: c_uint = 0x0c90;
pub const AD7175_ID: c_uint = 0x0cd0;
pub const AD7175_2_ID: c_uint = 0x0cd0;
pub const AD7172_4_ID: c_uint = 0x2050;
pub const AD7173_ID: c_uint = 0x30d0;

pub const AD4113_ID: c_uint = 0x31d0;
pub const AD4116_ID: c_uint = 0x34d0;
pub const AD4115_ID: c_uint = 0x38d0;
pub const AD7175_8_ID: c_uint = 0x3cd0;
pub const AD7177_ID: c_uint = 0x4fd0;

pub const AD7173_ADC_MODE_CLOCKSEL_INT: c_uint = 0x0;
pub const AD7173_ADC_MODE_CLOCKSEL_INT_OUTPUT: c_uint = 0x1;
pub const AD7173_ADC_MODE_CLOCKSEL_EXT: c_uint = 0x2;
pub const AD7173_ADC_MODE_CLOCKSEL_XTAL: c_uint = 0x3;

    FIELD_PREP(AD7173_INTERFACE_DATA_STAT, x)

pub const AD7173_SETUP_REF_SEL_AVDD1_AVSS: c_uint = 0x3;
pub const AD7173_SETUP_REF_SEL_INT_REF: c_uint = 0x2;
pub const AD7173_SETUP_REF_SEL_EXT_REF2: c_uint = 0x1;
pub const AD7173_SETUP_REF_SEL_EXT_REF: c_uint = 0x0;
pub const AD7173_VOLTAGE_INT_REF_uV: c_int = 2500000;
pub const AD7173_TEMP_SENSIIVITY_uV_per_C: c_int = 477;
pub const AD7177_ODR_START_VALUE: c_uint = 0x07;
pub const AD4111_SHUNT_RESISTOR_OHM: c_int = 50;
pub const AD4111_DIVIDER_RATIO: c_int = 10;
pub const AD4111_CURRENT_CHAN_CUTOFF: c_int = 16;
pub const AD4111_VINCOM_INPUT: c_uint = 0x10;
...
pub const AD7173_MAX_CONFIGS: c_int = 8;
pub const AD4111_OW_DET_THRSH_MV: c_int = 300;
pub const AD7173_MODE_CAL_INT_ZERO: c_uint = 0x4 /* Internal Zero-Scale Calibration */;
pub const AD7173_MODE_CAL_INT_FULL: c_uint = 0x5 /* Internal Full-Scale Calibration */;
pub const AD7173_MODE_CAL_SYS_ZERO: c_uint = 0x6 /* System Zero-Scale Calibration */;
pub const AD7173_MODE_CAL_SYS_FULL: c_uint = 0x7 /* System Full-Scale Calibration */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7173_device_info {
    pub sinc5_data_rates: *const c_uint,
    pub num_sinc5_data_rates: c_uint,
    pub odr_start_value: c_uint,
//
...
//
    pub num_voltage_in_div: c_uint,
    pub num_channels: c_uint,
    pub num_configs: c_uint,
    pub num_voltage_in: c_uint,
    pub clock: c_uint,
    pub id: c_uint,
    pub name: *mut c_char,
    pub sd_info: *const ad_sigma_delta_info,
    pub has_current_inputs: bool,
    pub has_vincom_input: bool,
    pub has_temp: bool,
// ((AVDD1 − AVSS)/5)
    pub has_pow_supply_monitoring: bool,
    pub data_reg_only_16bit: bool,
    pub has_input_buf: bool,
    pub has_int_ref: bool,
    pub has_ref2: bool,
    pub has_internal_fs_calibration: bool,
    pub has_openwire_det: bool,
    pub higher_gpio_bits: bool,
    pub num_gpios: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7173_channel_config {
// Openwire detection threshold
    pub openwire_thrsh_raw: c_uint,
    pub openwire_comp_chan: c_int,
    pub cfg_slot: u8,
    pub live: bool,
//
...
//
    ...
    pub bipolar: bool,
    pub input_buf: bool,
    pub sinc3_odr_div: u16,
    pub sinc5_odr_index: u8,
    pub ref_sel: u8,
    pub filter_type: enum ad7173_filter_type,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7173_channel {
    pub ain: c_uint,
    pub cfg: ad7173_channel_config,
    pub syscalib_mode: u8,
    pub openwire_det_en: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7173_state {
    pub sd: ad_sigma_delta,
    pub info: *const ad7173_device_info,
    pub channels: *mut ad7173_channel,
    pub regulators: [regulator_bulk_data; 3],
    pub adc_mode: c_uint,
    pub interface_mode: c_uint,
    pub num_channels: c_uint,
    pub cfg_slots_status: ida,
    pub config_usage_counter: c_ulonglong,
    pub config_cnts: *mut c_ulonglong,
    pub int_clk_hw: clk_hw,
    pub reg_gpiocon_regmap: *mut regmap,
    pub gpio_regmap: *mut gpio_regmap,
}
...
//
#[no_mangle]
unsafe extern "C" fn ad7173_sinc3_odr_div_from_odr(odr_millihz: u32) -> u16 {
...
//
    let mut div: u32 = DIV_ROUND_CLOSEST(MEGA * MILLI, odr_millihz * 32 * 3);
...
#[no_mangle]
unsafe extern "C" fn ad7173_calibrate_all(st: *mut ad7173_state, indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7173_gpio_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ad7173_gpio_init(st: *mut ad7173_state) -> c_int {
    static int ad7173_gpio_init(struct ad7173_state *st)
    {
    let mut gpio_regmap: gpio_regmap_config = {};
...
#[no_mangle]
unsafe extern "C" fn ad7173_ida_destroy(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ad7173_reset_usage_cnts(st: *mut ad7173_state) {
...
#[no_mangle]
unsafe extern "C" fn ad7173_free_config_slot_lru(st: *mut ad7173_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7173_config_channel(st: *mut ad7173_state, addr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7173_set_channel(sd: *mut ad_sigma_delta, channel: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7173_append_status(sd: *mut ad_sigma_delta, append: bool) -> c_int {
    static int ad7173_append_status(struct ad_sigma_delta *sd, bool append)
    {
    struct ad7173_state *st = ad_sigma_delta_to_ad7173(sd);
    let mut interface_mode: c_uint = st.interface_mode;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ad7173_disable_all(sd: *mut ad_sigma_delta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7173_disable_one(sd: *mut ad_sigma_delta, chan: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7173_setup(indio_dev: *mut iio_dev) -> c_int {
...
// reset the serial interface
    ...
    ret = spi_write_then_read(st.sd.spi, buf, sizeof(buf), core::ptr::null_mut(), 0);
    if (ret < 0)
    return ret;
...
//
    ...
    {
    struct ad7173_state *st = iio_priv(indio_dev);
    let mut sinc3_count: u16 = 0;
    let mut sinc3_div: u16 = 0;
    int i, j, k, ret;
...
#[no_mangle]
unsafe extern "C" fn ad7173_disable_regulators(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ad7173_clk_output_is_enabled(hw: *mut clk_hw) -> c_int {
    static int ad7173_clk_output_is_enabled(struct clk_hw *hw)
    {
    struct ad7173_state *st = clk_hw_to_ad7173(hw);
    u32 clk_sel;
    clk_sel = FIELD_GET(AD7173_ADC_MODE_CLOCKSEL_MASK, st.adc_mode);
    let mut clk_sel: return = = AD7173_ADC_MODE_CLOCKSEL_INT_OUTPUT;
    }
#[no_mangle]
unsafe extern "C" fn ad7173_clk_output_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7173_clk_output_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn ad7173_register_clk_provider(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7173_validate_reference(st: *mut ad7173_state, ref_sel: c_int) -> c_int {
...
//
    ...
    let mut ain1: return = = AD4111_VINCOM_INPUT;
    }
...
#[no_mangle]
unsafe extern "C" fn ad7173_fw_parse_channel_config(indio_dev: *mut iio_dev) -> c_int {
    ...
    let mut is_current_chan: bool = false;
...
#[no_mangle]
unsafe extern "C" fn ad7173_fw_parse_device_config(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7173_probe(spi: *mut spi_device) -> c_int {
