...
//! Source: drivers/iio/adc/qcom-pm8xxx-xoadc.c
#![no_std]
...
pub const ADC_ARB_BTM_CNTRL1: c_uint = 0x17e;

pub const ADC_ARB_BTM_AMUX_CNTRL: c_uint = 0x17f;
pub const ADC_ARB_BTM_ANA_PARAM: c_uint = 0x180;
pub const ADC_ARB_BTM_DIG_PARAM: c_uint = 0x181;
pub const ADC_ARB_BTM_RSV: c_uint = 0x182;
pub const ADC_ARB_BTM_DATA1: c_uint = 0x183;
pub const ADC_ARB_BTM_DATA0: c_uint = 0x184;
pub const ADC_ARB_BTM_BAT_COOL_THR1: c_uint = 0x185;
pub const ADC_ARB_BTM_BAT_COOL_THR0: c_uint = 0x186;
pub const ADC_ARB_BTM_BAT_WARM_THR1: c_uint = 0x187;
pub const ADC_ARB_BTM_BAT_WARM_THR0: c_uint = 0x188;
pub const ADC_ARB_BTM_CNTRL2: c_uint = 0x18c;
// Proper ADC registers
pub const ADC_ARB_USRP_CNTRL: c_uint = 0x197;

pub const ADC_ARB_USRP_AMUX_CNTRL: c_uint = 0x198;
//
// The channel mask includes the bits selecting channel mux and prescaler
// on PM8058, or channel mux and premux on PM8921.
//
pub const ADC_ARB_USRP_AMUX_CNTRL_CHAN_MASK: c_uint = 0xfc;

// On PM8058 this is prescaling, on PM8921 this is premux

pub const ADC_AMUX_PREMUX_SHIFT: c_int = 2;
pub const ADC_AMUX_SEL_SHIFT: c_int = 4;
// We know very little about the bits in this register
pub const ADC_ARB_USRP_ANA_PARAM: c_uint = 0x199;
pub const ADC_ARB_USRP_ANA_PARAM_DIS: c_uint = 0xFE;
pub const ADC_ARB_USRP_ANA_PARAM_EN: c_uint = 0xFF;
pub const ADC_ARB_USRP_DIG_PARAM: c_uint = 0x19A;
...
pub const ADC_DIG_PARAM_DEC_SHIFT: c_int = 5;
pub const ADC_ARB_USRP_RSV: c_uint = 0x19B;

pub const ADC_RSV_IP_SEL_SHIFT: c_int = 4;
pub const ADC_ARB_USRP_DATA0: c_uint = 0x19D;
pub const ADC_ARB_USRP_DATA1: c_uint = 0x19C;
//
...
//
pub const PM8XXX_CHANNEL_INTERNAL: c_uint = 0x0c;
pub const PM8XXX_CHANNEL_125V: c_uint = 0x0d;
pub const PM8XXX_CHANNEL_INTERNAL_2: c_uint = 0x0e;
pub const PM8XXX_CHANNEL_MUXOFF: c_uint = 0x0f;
//
// PM8058 AMUX premux scaling, two bits. This is done of the channel before
// reaching the AMUX.
//
pub const PM8058_AMUX_PRESCALE_0: c_uint = 0x0 /* No scaling on the signal */;
pub const PM8058_AMUX_PRESCALE_1: c_uint = 0x1 /* Unity scaling selected by the user */;
pub const PM8058_AMUX_PRESCALE_1_DIV3: c_uint = 0x2 /* 1/3 prescaler on the input */;
// Defines reference voltage for the XOADC
pub const AMUX_RSV0: c_uint = 0x0 /* XO_IN/XOADC_GND, special selection to read XO temp */;
pub const AMUX_RSV1: c_uint = 0x1 /* PMIC_IN/XOADC_GND */;
pub const AMUX_RSV2: c_uint = 0x2 /* PMIC_IN/BMS_CSP */;
pub const AMUX_RSV3: c_uint = 0x3 /* not used */;
pub const AMUX_RSV4: c_uint = 0x4 /* XOADC_GND/XOADC_GND */;
pub const AMUX_RSV5: c_uint = 0x5 /* XOADC_VREF/XOADC_GND */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xoadc_channel {
    pub datasheet_name: *const c_char,
    pub pre_scale_mux:2: u8,
    pub amux_channel:4: u8,
    pub prescale: u32_fract,
    pub type: enum iio_chan_type,
    pub scale_fn_type: enum vadc_scale_fn_type,
    pub amux_ip_rsv:3: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xoadc_variant {
    pub name: [c_char; 16],
    pub channels: *const xoadc_channel,
    pub broken_ratiometric: bool,
    pub prescaling: bool,
    pub second_level_mux: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pm8xxx_chan_info {
    pub label: *const c_char,
    pub hwchan: *const xoadc_channel,
    pub calibration: enum vadc_calibration,
    pub decimation:2: u8,
    pub amux_ip_rsv:3: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pm8xxx_xoadc {
    pub dev: *mut device,
    pub map: *mut regmap,
    pub variant: *const xoadc_variant,
    pub vref: *mut regulator,
    pub nchans: c_uint,
    pub chans: *mut pm8xxx_chan_info,
    pub iio_chans: *mut iio_chan_spec,
    pub graph: [vadc_linear_graph; 2],
    pub complete: completion,
    pub lock: mutex,
}

#[no_mangle]
unsafe extern "C" fn pm8xxx_eoc_irq(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_calibrate_device(adc: *mut pm8xxx_xoadc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_xoadc_parse_channels(adc: *mut pm8xxx_xoadc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_xoadc_probe(pdev: *mut platform_device) -> c_int {
...
// Bring up regulator
    ...
    pm8xxx_eoc_irq, core::ptr::null_mut(), 0, variant.name, indio_dev);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_xoadc_remove(pdev: *mut platform_device) {
