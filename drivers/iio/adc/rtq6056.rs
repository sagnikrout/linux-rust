...
//! Source: drivers/iio/adc/rtq6056.c
#![no_std]
...
pub const RTQ6056_REG_CONFIG: c_uint = 0x00;
pub const RTQ6056_REG_SHUNTVOLT: c_uint = 0x01;
pub const RTQ6056_REG_BUSVOLT: c_uint = 0x02;
pub const RTQ6056_REG_POWER: c_uint = 0x03;
pub const RTQ6056_REG_CURRENT: c_uint = 0x04;
pub const RTQ6056_REG_CALIBRATION: c_uint = 0x05;
pub const RTQ6056_REG_MASKENABLE: c_uint = 0x06;
pub const RTQ6056_REG_ALERTLIMIT: c_uint = 0x07;
pub const RTQ6056_REG_MANUFACTID: c_uint = 0xFE;
pub const RTQ6056_REG_DIEID: c_uint = 0xFF;
pub const RTQ6056_VENDOR_ID: c_uint = 0x1214;
pub const RTQ6056_DEFAULT_CONFIG: c_uint = 0x4127;
pub const RTQ6056_CONT_ALLON: c_int = 7;
pub const RTQ6059_DEFAULT_CONFIG: c_uint = 0x3C47;
pub const RTQ6059_VBUS_LSB_OFFSET: c_int = 3;
pub const RTQ6059_AVG_BASE: c_int = 8;
    enum {
    RTQ6056_CH_VSHUNT = 0,
    RTQ6056_CH_VBUS,
    RTQ6056_CH_POWER,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct richtek_dev_data {
    pub fixed_samp_freq: bool,
    pub vbus_offset: u8,
    pub default_conv_time_us: c_int,
    pub default_config: c_uint,
    pub calib_coefficient: c_uint,
    pub avg_sample_list: *const c_int,
    pub avg_sample_list_length: c_int,
    pub reg_fields: *const reg_field,
    pub channels: *const iio_chan_spec,
    pub num_channels: c_int,
    pub val2): *const *const *const *const int (read_scale)(struct iio_chan_spec ch, int val, int,
    pub val): *mut *mut *mut int (set_average)(struct rtq6056_priv priv, int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtq6056_priv {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub rm_fields: [*mut regmap_field; F_MAX_FIELDS],
    pub devdata: *const richtek_dev_data,
    pub shunt_resistor_uohm: u32,
    pub vshuntct_us: c_int,
    pub vbusct_us: c_int,
    pub avg_sample: c_int,
}
...
//
    ...
    let mut addr: c_uint = ch.address;
    unsigned int regval;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rtq6056_adc_set_average(priv: *mut rtq6056_priv, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtq6059_adc_set_average(priv: *mut rtq6056_priv, val: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(RTQ6056_REG_BUSVOLT: ch->address ==) -> else {
    else if (ch.address == RTQ6056_REG_BUSVOLT)
...
#[no_mangle]
unsafe extern "C" fn rtq6056_buffer_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
    ...
    unsigned int raw;
    let mut i: c_int = 0, bit, ret;
    pm_runtime_get_sync(dev);
    iio_for_each_active_channel(indio_dev, bit) {
    let mut addr: c_uint = rtq6056_channels[bit].address;
...
#[no_mangle]
unsafe extern "C" fn rtq6056_enter_shutdown_state(dev: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rtq6056_is_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rtq6056_is_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rtq6056_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtq6056_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtq6056_runtime_resume(dev: *mut device) -> c_int {
    ...
    rtq6056_runtime_resume, core::ptr::null_mut());
