...
//! Source: drivers/iio/adc/ti-ads7138.c
#![no_std]
...
//
pub const ADS7138_RES_BITS: c_int = 16;
// ADS7138 operation codes
pub const ADS7138_OPCODE_SINGLE_WRITE: c_uint = 0x08;
pub const ADS7138_OPCODE_SET_BIT: c_uint = 0x18;
pub const ADS7138_OPCODE_CLEAR_BIT: c_uint = 0x20;
pub const ADS7138_OPCODE_BLOCK_WRITE: c_uint = 0x28;
pub const ADS7138_OPCODE_BLOCK_READ: c_uint = 0x30;
// ADS7138 registers
pub const ADS7138_REG_GENERAL_CFG: c_uint = 0x01;
pub const ADS7138_REG_OSR_CFG: c_uint = 0x03;
pub const ADS7138_REG_OPMODE_CFG: c_uint = 0x04;
pub const ADS7138_REG_SEQUENCE_CFG: c_uint = 0x10;
pub const ADS7138_REG_AUTO_SEQ_CH_SEL: c_uint = 0x12;
pub const ADS7138_REG_ALERT_CH_SEL: c_uint = 0x14;
pub const ADS7138_REG_EVENT_FLAG: c_uint = 0x18;
pub const ADS7138_REG_EVENT_HIGH_FLAG: c_uint = 0x1A;
pub const ADS7138_REG_EVENT_LOW_FLAG: c_uint = 0x1C;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads7138_data {
// Protects RMW access to the I2C interface
    pub lock: mutex,
    pub client: *mut i2c_client,
    pub vref_regu: *mut regulator,
    pub chip_data: *const ads7138_chip_data,
}
...
#[no_mangle]
unsafe extern "C" fn ads7138_i2c_write(client: *const i2c_client, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7138_i2c_set_bit(client: *const i2c_client, reg: u8, bits: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7138_i2c_clear_bit(client: *const i2c_client, reg: u8, bits: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7138_i2c_read(client: *const i2c_client, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7138_freq_to_bits(freq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7138_bits_to_freq(bits: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7138_osr_to_bits(osr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7138_event_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ads7138_init_hw(data: *mut ads7138_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7138_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), ads7138_event_handler,
    IRQF_TRIGGER_LOW |
...
#[no_mangle]
unsafe extern "C" fn ads7138_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7138_runtime_resume(dev: *mut device) -> c_int {
