...
//! Source: drivers/iio/adc/ti-ads7950.c
#![no_std]
...
//
pub const TI_ADS7950_VA_MV_ACPI_DEFAULT: c_int = 5000;

pub const TI_ADS7950_MAX_CHAN: c_int = 16;
pub const TI_ADS7950_NUM_GPIOS: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_ads7950_state {
    pub spi: *mut spi_device,
    pub ring_xfer: spi_transfer,
    pub scan_single_xfer: [spi_transfer; 3],
    pub ring_msg: spi_message,
...
//
    pub cmd_settings_bitmask: c_uint,
//
...
// [10-11] N/A
//
    pub gpio_cmd_settings_bitmask: c_uint,
//
// DMA (thus cache coherency maintenance) may require the
// transfer buffers to live in their own cache lines.
//
    pub __aligned(IIO_DMA_MINALIGN): u16 rx_buf[TI_ADS7950_MAX_CHAN + 2],
    pub 2]: u16 tx_buf[TI_ADS7950_MAX_CHAN +,
    pub single_tx: u16,
    pub single_rx: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_ads7950_chip_info {
...
#[no_mangle]
unsafe extern "C" fn ti_ads7950_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ti_ads7950_scan_direct(indio_dev: *mut iio_dev, ch: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_ads7950_get_range(st: *mut ti_ads7950_state) -> c_uint {
    static unsigned int ti_ads7950_get_range(struct ti_ads7950_state *st)
    {
    let mut vref: c_uint = st.vref_mv;
...
#[no_mangle]
unsafe extern "C" fn ti_ads7950_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_ads7950_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_ads7950_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(BIT(offset)): !input && !(st->gpio_cmd_settings_bitmask &) -> else {
...
#[no_mangle]
unsafe extern "C" fn ti_ads7950_init_hw(st: *mut ti_ads7950_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_ads7950_probe(spi: *mut spi_device) -> c_int {
