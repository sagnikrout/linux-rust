...
//! Source: drivers/iio/adc/rohm-bd79124.c
#![no_std]
...
pub const BD79124_I2C_MULTI_READ: c_uint = 0x30;
pub const BD79124_I2C_MULTI_WRITE: c_uint = 0x28;
pub const BD79124_REG_MAX: c_uint = 0xaf;
pub const BD79124_REG_SYSTEM_STATUS: c_uint = 0x00;
pub const BD79124_REG_GEN_CFG: c_uint = 0x01;
pub const BD79124_REG_OPMODE_CFG: c_uint = 0x04;
pub const BD79124_REG_PINCFG: c_uint = 0x05;
pub const BD79124_REG_GPO_VAL: c_uint = 0x0B;
pub const BD79124_REG_SEQ_CFG: c_uint = 0x10;
pub const BD79124_REG_MANUAL_CHANNELS: c_uint = 0x11;
pub const BD79124_REG_AUTO_CHANNELS: c_uint = 0x12;
pub const BD79124_REG_ALERT_CH_SEL: c_uint = 0x14;
pub const BD79124_REG_EVENT_FLAG: c_uint = 0x18;
pub const BD79124_REG_EVENT_FLAG_HI: c_uint = 0x1a;
pub const BD79124_REG_EVENT_FLAG_LO: c_uint = 0x1c;
pub const BD79124_REG_HYSTERESIS_CH0: c_uint = 0x20;
pub const BD79124_REG_EVENTCOUNT_CH0: c_uint = 0x22;
pub const BD79124_REG_RECENT_CH0_LSB: c_uint = 0xa0;
pub const BD79124_REG_RECENT_CH7_MSB: c_uint = 0xaf;
pub const BD79124_ADC_BITS: c_int = 12;
// Masks for the BD79124_REG_OPMODE_CFG

pub const BD79124_CONV_MODE_MANSEQ: c_int = 0;
pub const BD79124_CONV_MODE_AUTO: c_int = 1;

pub const BD79124_INTERVAL_750_US: c_int = 0;
// Masks for the BD79124_REG_GEN_CFG

// Masks for the BD79124_REG_SEQ_CFG

pub const BD79124_MSK_SEQ_MANUAL: c_int = 0;
pub const BD79124_MSK_SEQ_SEQ: c_int = 1;

pub const BD79124_LOW_LIMIT_MIN: c_int = 0;
...
pub const BD79124_MAX_NUM_CHANNELS: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd79124_data {
    pub timestamp: i64,
    pub map: *mut regmap,
    pub dev: *mut device,
    pub vmax: c_int,
...
// to be started.
//
    pub alarm_monitored: [c_int; BD79124_MAX_NUM_CHANNELS],
//
...
//
    pub alarm_r_limit: [u16; BD79124_MAX_NUM_CHANNELS],
    pub alarm_f_limit: [u16; BD79124_MAX_NUM_CHANNELS],
// Bitmask of disabled events (for rate limiting) for each channel.
    pub alarm_suppressed: [c_int; BD79124_MAX_NUM_CHANNELS],
//
...
//
    pub mutex: mutex,
    pub alm_enable_work: delayed_work,
    pub gc: gpio_chip,
    pub gpio_valid_mask: u8,
}
...
#[no_mangle]
unsafe extern "C" fn bd79124gpo_direction_get(gc: *mut gpio_chip, offset: c_uint) -> c_int {
    static int bd79124gpo_direction_get(struct gpio_chip *gc, unsigned int offset)
    {
    return GPIO_LINE_DIRECTION_OUT;
    }
#[no_mangle]
unsafe extern "C" fn bd79124gpo_set(gc: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd79124_raw {
    pub /: *mut *mut u8 val_bit3_0; / Is set in high bits of the byte,
    pub val_bit11_4: u8,
}
...
//
    ...
    unsigned int val)
    {
    let mut raw: bd79124_raw = BD79124_INT_TO_RAW(val);
    unsigned int tmp;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn bd79124_start_measurement(data: *mut bd79124_data, chan: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd79124_stop_measurement(data: *mut bd79124_data, chan: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd79124_single_chan_seq(data: *mut bd79124_data, chan: c_int, old: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd79124_single_chan_seq_end(data: *mut bd79124_data, old: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd79124_re_enable_lo(data: *mut bd79124_data, channel: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn bd79124_re_enable_hi(data: *mut bd79124_data, channel: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn bd79124_alm_enable_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn bd79124_event_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd79124_irq_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd79124_chan_init(data: *mut bd79124_data, channel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd79124_get_gpio_pins(cs: *const iio_chan_spec, num_channels: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd79124_hw_init(data: *mut bd79124_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd79124_probe(i2c: *mut i2c_client) -> c_int {
