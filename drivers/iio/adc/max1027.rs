...
//! Source: drivers/iio/adc/max1027.c
#![no_std]
...
// setup register
pub const MAX1027_UNIPOLAR: c_uint = 0x02;
pub const MAX1027_BIPOLAR: c_uint = 0x03;

// averaging register
pub const MAX1027_NSCAN_4: c_uint = 0x00;
pub const MAX1027_NSCAN_8: c_uint = 0x01;
pub const MAX1027_NSCAN_12: c_uint = 0x02;
pub const MAX1027_NSCAN_16: c_uint = 0x03;

// Device can achieve 300ksps so we assume a 3.33us conversion delay
pub const MAX1027_CONVERSION_UDELAY: c_int = 4;
    enum max1027_id {
    max1027,
    max1029,
    max1031,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max1027_state {
    pub info: *const max1027_chip_info,
    pub spi: *mut spi_device,
    pub trig: *mut iio_trigger,
    pub buffer: *mut __be16,
    pub lock: mutex,
    pub complete: completion,
    pub __aligned(IIO_DMA_MINALIGN): u8 reg,
}

#[no_mangle]
unsafe extern "C" fn max1027_wait_eoc(indio_dev: *mut iio_dev) -> c_int {
    static int max1027_wait_eoc(struct iio_dev *indio_dev)
    {
    struct max1027_state *st = iio_priv(indio_dev);
    let mut conversion_time: c_uint = MAX1027_CONVERSION_UDELAY;
    int ret;
    if (st.spi.irq) {
...
#[no_mangle]
unsafe extern "C" fn max1027_configure_chans_and_start(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max1027_enable_trigger(indio_dev: *mut iio_dev, enable: bool) -> c_int {
...
// val2 = chan->scan_type.realbits;
    ...
    u8 *val = (u8 *)st.buffer;
    if (readval) {
    let mut ret: c_int = spi_read(st.spi, val, 2);
...
#[no_mangle]
unsafe extern "C" fn max1027_set_cnvst_trigger_state(trig: *mut iio_trigger, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max1027_read_scan(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max1027_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max1027_trigger_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max1027_probe(spi: *mut spi_device) -> c_int {
