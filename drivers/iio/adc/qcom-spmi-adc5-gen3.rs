...
//! Source: drivers/iio/adc/qcom-spmi-adc5-gen3.c
#![no_std]
...
pub const ADC5_GEN3_VADC_SDAM: c_uint = 0x0;
    struct adc5_chip;
//
...
#[no_mangle]
unsafe extern "C" fn adc5_gen3_read_voltage_data(adc: *mut adc5_chip, data: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adc5_gen3_update_dig_param(prop: *mut adc5_channel_common_prop, data: *mut u8) {
...
// accordingly.
//
pub const ADC5_GEN3_HS_DELAY_US: c_int = 100;
pub const ADC5_GEN3_HS_RETRY_COUNT: c_int = 150;
    int adc5_gen3_poll_wait_hs(struct adc5_device_data *adc,
    unsigned int sdam_index)
    {
    let mut conv_req: u8 = ADC5_GEN3_CONV_REQ_REQ;
    int ret, count;
    let mut status: u8 = 0;
...
//
pub const ADC5_GEN3_CONV_TIMEOUT_MS: c_int = 501;
...
#[no_mangle]
unsafe extern "C" fn adc5_gen3_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn adc5_gen3_uninit_aux(data: *mut c_void) {
    static void adc5_gen3_uninit_aux(void *data)
    {
    auxiliary_device_uninit(data);
    }
#[no_mangle]
unsafe extern "C" fn adc5_gen3_delete_aux(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn adc5_gen3_add_aux_tm_device(adc: *mut adc5_chip) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adc5_gen3_mutex_lock(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn adc5_gen3_mutex_unlock(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn adc5_gen3_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    core::ptr::null_mut(), adc5_gen3_isr, IRQF_ONESHOT | IRQF_SHARED,
