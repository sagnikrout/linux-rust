...
//! Source: drivers/iio/adc/axp288_adc.c
#![no_std]
...
//
pub const AXP288_ADC_EN_MASK: c_uint = 0xF0;
pub const AXP288_ADC_TS_ENABLE: c_uint = 0x01;
...
#[no_mangle]
unsafe extern "C" fn axp288_adc_initialize(info: *mut axp288_adc_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp288_adc_probe(pdev: *mut platform_device) -> c_int {
