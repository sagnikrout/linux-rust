...
//! Source: drivers/iio/adc/mp2629_adc.c
#![no_std]
...
pub const MP2629_REG_ADC_CTRL: c_uint = 0x03;
pub const MP2629_REG_BATT_VOLT: c_uint = 0x0e;
pub const MP2629_REG_SYSTEM_VOLT: c_uint = 0x0f;
pub const MP2629_REG_INPUT_VOLT: c_uint = 0x11;
pub const MP2629_REG_BATT_CURRENT: c_uint = 0x12;
pub const MP2629_REG_INPUT_CURRENT: c_uint = 0x13;
...
#[no_mangle]
unsafe extern "C" fn mp2629_adc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp2629_adc_remove(pdev: *mut platform_device) {
