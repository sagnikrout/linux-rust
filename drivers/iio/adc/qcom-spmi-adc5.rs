...
//! Source: drivers/iio/adc/qcom-spmi-adc5.c
#![no_std]
...
pub const ADC5_USR_REVISION1: c_uint = 0x0;
pub const ADC5_USR_STATUS1: c_uint = 0x8;

pub const ADC5_USR_STATUS1_REQ_STS_EOC_MASK: c_uint = 0x3;
pub const ADC5_USR_STATUS2: c_uint = 0x9;
pub const ADC5_USR_STATUS2_CONV_SEQ_MASK: c_uint = 0x70;
pub const ADC5_USR_STATUS2_CONV_SEQ_MASK_SHIFT: c_uint = 0x5;
pub const ADC5_USR_IBAT_MEAS: c_uint = 0xf;

pub const ADC5_USR_DIG_PARAM: c_uint = 0x42;

pub const ADC5_USR_DIG_PARAM_CAL_VAL_SHIFT: c_int = 6;
pub const ADC5_USR_DIG_PARAM_CAL_SEL: c_uint = 0x30;
pub const ADC5_USR_DIG_PARAM_CAL_SEL_SHIFT: c_int = 4;
pub const ADC5_USR_DIG_PARAM_DEC_RATIO_SEL: c_uint = 0xc;
pub const ADC5_USR_DIG_PARAM_DEC_RATIO_SEL_SHIFT: c_int = 2;
pub const ADC5_USR_FAST_AVG_CTL: c_uint = 0x43;

pub const ADC5_USR_FAST_AVG_CTL_SAMPLES_MASK: c_uint = 0x7;
pub const ADC5_USR_CH_SEL_CTL: c_uint = 0x44;
pub const ADC5_USR_DELAY_CTL: c_uint = 0x45;
pub const ADC5_USR_HW_SETTLE_DELAY_MASK: c_uint = 0xf;
pub const ADC5_USR_EN_CTL1: c_uint = 0x46;

pub const ADC5_USR_CONV_REQ: c_uint = 0x47;

pub const ADC5_USR_DATA0: c_uint = 0x50;
pub const ADC5_USR_DATA1: c_uint = 0x51;
pub const ADC5_USR_IBAT_DATA0: c_uint = 0x52;
pub const ADC5_USR_IBAT_DATA1: c_uint = 0x53;
pub const ADC_CHANNEL_OFFSET: c_uint = 0x8;
...
//
pub const ADC5_CONV_TIME_MIN_US: c_int = 263;
pub const ADC5_CONV_TIME_MAX_US: c_int = 264;
pub const ADC5_CONV_TIME_RETRY: c_int = 400;

// Digital version >= 5.3 supports hw_settle_2
pub const ADC5_HW_SETTLE_DIFF_MINOR: c_int = 3;
pub const ADC5_HW_SETTLE_DIFF_MAJOR: c_int = 5;
// For PMIC7
pub const ADC_APP_SID: c_uint = 0x40;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adc5_channel_prop {
    pub channel: c_uint,
    pub cal_method: enum adc5_cal_method,
    pub cal_val: enum adc5_cal_val,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adc5_chip {
    pub regmap: *mut regmap,
    pub dev: *mut device,
    pub base: u16,
    pub nchannels: c_uint,
    pub chan_props: *mut adc5_channel_prop,
    pub iio_chans: *mut iio_chan_spec,
    pub poll_eoc: bool,
    pub complete: completion,
    pub lock: mutex,
    pub data: *const adc5_data,
}

#[no_mangle]
unsafe extern "C" fn adc5_read(adc: *mut adc5_chip, offset: u16, data: *mut u8, len: c_int) -> c_int {
    static int adc5_read(struct adc5_chip *adc, u16 offset, u8 *data, int len)
    {
    return regmap_bulk_read(adc.regmap, adc.base + offset, data, len);
    }
#[no_mangle]
unsafe extern "C" fn adc5_write(adc: *mut adc5_chip, offset: u16, data: *mut u8, len: c_int) -> c_int {
    static int adc5_write(struct adc5_chip *adc, u16 offset, u8 *data, int len)
    {
    return regmap_bulk_write(adc.regmap, adc.base + offset, data, len);
    }
#[no_mangle]
unsafe extern "C" fn adc5_masked_write(adc: *mut adc5_chip, offset: u16, mask: u8, val: u8) -> c_int {
    static int adc5_masked_write(struct adc5_chip *adc, u16 offset, u8 mask, u8 val)
    {
    return regmap_update_bits(adc.regmap, adc.base + offset, mask, val);
    }
#[no_mangle]
unsafe extern "C" fn adc5_read_voltage_data(adc: *mut adc5_chip, data: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adc5_poll_wait_eoc(adc: *mut adc5_chip) -> c_int {
...
// No support for polling mode at present
    ...
    u16 *data_volt, u16 *data_cur);
#[no_mangle]
unsafe extern "C" fn adc5_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
pub struct adc5_channels {
    ...
    pub prescale_index: c_uint,
    pub type: enum iio_chan_type,
    pub info_mask: c_long,
    pub scale_fn_type: enum vadc_scale_fn_type,
}
...
#[no_mangle]
unsafe extern "C" fn adc5_get_fw_data(adc: *mut adc5_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adc5_probe(pdev: *mut platform_device) -> c_int {
