...
//! Source: drivers/iio/adc/sc27xx_adc.c
#![no_std]
...
pub const SC2731_MODULE_EN: c_uint = 0xc08;

pub const SC2721_ARM_CLK_EN: c_uint = 0xc0c;
pub const SC2730_ARM_CLK_EN: c_uint = 0x180c;
pub const SC2731_ARM_CLK_EN: c_uint = 0xc10;

// ADC controller registers definition
pub const SC27XX_ADC_CTL: c_uint = 0x0;
pub const SC27XX_ADC_CH_CFG: c_uint = 0x4;
pub const SC27XX_ADC_DATA: c_uint = 0x4c;
pub const SC27XX_ADC_INT_EN: c_uint = 0x50;
pub const SC27XX_ADC_INT_CLR: c_uint = 0x54;
pub const SC27XX_ADC_INT_STS: c_uint = 0x58;
pub const SC27XX_ADC_INT_RAW: c_uint = 0x5c;
// Bits and mask definition for SC27XX_ADC_CTL register

pub const SC27XX_ADC_RUN_NUM_SHIFT: c_int = 4;
// Bits and mask definition for SC27XX_ADC_CH_CFG register

pub const SC27XX_ADC_SCALE_SHIFT: c_int = 9;
pub const SC2721_ADC_SCALE_SHIFT: c_int = 5;
...
pub const SC27XX_ADC_HWLOCK_TIMEOUT: c_int = 5000;
// Timeout (us) for ADC data conversion according to ADC datasheet
pub const SC27XX_ADC_RDY_TIMEOUT: c_int = 1000000;
pub const SC27XX_ADC_POLL_RAW_STATUS: c_int = 500;
// Maximum ADC channel number
pub const SC27XX_ADC_CHANNEL_MAX: c_int = 32;
// ADC voltage ratio definition

    (((n) << SC27XX_RATIO_NUMERATOR_OFFSET) | (d))
pub const SC27XX_RATIO_NUMERATOR_OFFSET: c_int = 16;

// ADC specific channel reference voltage 3.5V
pub const SC27XX_ADC_REFVOL_VDD35: c_int = 3500000;
// ADC default channel reference voltage is 2.8V
pub const SC27XX_ADC_REFVOL_VDD28: c_int = 2800000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sc27xx_adc_data {
    pub dev: *mut device,
    pub volref: *mut regulator,
...
//
    ...
    pub channel_scale: [c_int; SC27XX_ADC_CHANNEL_MAX],
    pub base: u32,
    pub irq: c_int,
    pub var_data: *const sc27xx_adc_variant_data,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sc27xx_adc_variant_data {
    pub module_en: u32,
    pub clk_en: u32,
    pub scale_shift: u32,
    pub scale_mask: u32,
    pub bscale_cal: *const sc27xx_adc_linear_graph,
    pub sscale_cal: *const sc27xx_adc_linear_graph,
    pub data): *mut *mut void (init_scale)(struct sc27xx_adc_data,
    pub scale): *mut *mut int (get_ratio)(int channel, int,
    pub set_volref: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sc27xx_adc_linear_graph {
    pub volt0: c_int,
    pub adc0: c_int,
    pub volt1: c_int,
    pub adc1: c_int,
...
#[no_mangle]
unsafe extern "C" fn sc27xx_adc_get_calib_data(calib_data: u32, calib_adc: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adc_nvmem_cell_calib_data(data: *mut sc27xx_adc_data, cell_name: *const c_char) -> c_int {
    static int adc_nvmem_cell_calib_data(struct sc27xx_adc_data *data, const char *cell_name)
    {
    struct nvmem_cell *cell;
    void *buf;
    let mut origin_calib_data: u32 = 0;
    size_t len;
    if (!data)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn sc2720_adc_get_ratio(channel: c_int, scale: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc2721_adc_get_ratio(channel: c_int, scale: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc2730_adc_get_ratio(channel: c_int, scale: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc2731_adc_get_ratio(channel: c_int, scale: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sc2720_adc_scale_init(data: *mut sc27xx_adc_data) {
...
#[no_mangle]
unsafe extern "C" fn sc2730_adc_scale_init(data: *mut sc27xx_adc_data) {
...
#[no_mangle]
unsafe extern "C" fn sc2731_adc_scale_init(data: *mut sc27xx_adc_data) {
...
// val = sc27xx_adc_convert_volt(data, channel, scale, raw_adc);
    ...
    let mut scale: c_int = data.channel_scale[chan.channel];
    int ret, tmp;
    switch (mask) {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_adc_enable(data: *mut sc27xx_adc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_adc_disable(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_adc_probe(pdev: *mut platform_device) -> c_int {
    ...
    sc27xx_data.regmap = dev_get_regmap(dev.parent, core::ptr::null_mut());
