...
pub const STM32H7_LINCALFACT_NUM: c_int = 6;
// BOOST bit must be set on STM32H7 when ADC clock is above 20MHz

pub const STM32_ADC_TIMEOUT_US: c_int = 100000;

pub const STM32_ADC_HW_STOP_DELAY_MS: c_int = 100;
pub const STM32_ADC_VREFINT_VOLTAGE: c_int = 3300;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_adc_trig_info {
    pub name: *const c_char,
    pub extsel: enum stm32_adc_extsel,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_adc_calib {
    pub lincalfact: [u32; STM32H7_LINCALFACT_NUM],
    pub lincal_saved: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_adc_vrefint {
    pub vrefint_cal: u32,
    pub vrefint_data: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_adc_regspec {
    pub dr: u32,
    pub ier_eoc: stm32_adc_regs,
    pub ier_ovr: stm32_adc_regs,
    pub isr_eoc: stm32_adc_regs,
    pub isr_ovr: stm32_adc_regs,
    pub sqr: *const stm32_adc_regs,
    pub exten: stm32_adc_regs,
    pub extsel: stm32_adc_regs,
    pub res: stm32_adc_regs,
    pub difsel: stm32_adc_regs,
    pub smpr: [u32; 2],
    pub smp_bits: *const stm32_adc_regs,
    pub or_vddcore: stm32_adc_regs,
    pub or_vddcpu: stm32_adc_regs,
    pub or_vddq_ddr: stm32_adc_regs,
    pub ccr_vbat: stm32_adc_regs,
    pub ccr_vref: stm32_adc_regs,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_adc_cfg {
    pub regs: *const stm32_adc_regspec,
    pub adc_info: *const stm32_adc_info,
    pub trigs: *const stm32_adc_trig_info,
    pub clk_required: bool,
    pub has_vregready: bool,
    pub has_boostmode: bool,
    pub has_linearcal: bool,
    pub has_presel: bool,
    pub has_oversampling: bool,
    pub ): *mut *mut int (prepare)(struct iio_dev,
    pub dma): *mut *mut *mut void (start_conv)(struct iio_dev , bool,
    pub ): *mut *mut void (stop_conv)(struct iio_dev,
    pub ): *mut *mut void (unprepare)(struct iio_dev,
    pub msk): *mut *mut *mut void (irq_clear)(struct iio_dev indio_dev, u32,
    pub ovs_idx): *mut *mut *mut void (set_ovs)(struct iio_dev indio_dev, u32,
    pub smp_cycles: *const c_uint,
    pub ts_int_ch: *const c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_adc {
    pub common: *mut stm32_adc_common,
    pub offset: u32,
    pub cfg: *const stm32_adc_cfg,
    pub completion: completion,
    pub __aligned(8): u16 buffer[STM32_ADC_MAX_SQ + 4],
    pub clk: *mut clk,
    pub irq: c_int,
    pub /: *mut *mut spinlock_t lock; / interrupt lock,
    pub bufi: c_uint,
    pub num_conv: c_uint,
    pub res: u32,
    pub trigger_polarity: u32,
    ...
    pub pcsel: u32,
    pub smpr_val: [u32; 2],
    pub cal: stm32_adc_calib,
    pub vrefint: stm32_adc_vrefint,
    pub chan_name: [c_char; STM32_ADC_CH_MAX][STM32_ADC_CH_SZ],
    pub num_diff: u32,
    pub int_ch: [c_int; STM32_ADC_INT_CH_NB],
    pub nsmps: c_int,
    pub ovs_idx: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_adc_diff_channel {
    pub vinp: u32,
    pub vinn: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_adc_info {
    pub max_channels: c_int,
    pub resolutions: *const c_uint,
    pub oversampling: *const c_uint,
    pub num_res: c_uint,
    pub num_ovs: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn stm32_adc_readl(adc: *mut stm32_adc, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_readw(adc: *mut stm32_adc, reg: u32) -> u16 {
    static u16 stm32_adc_readw(struct stm32_adc *adc, u32 reg)
    {
    return readw_relaxed(adc.common.base + adc.offset + reg);
    }
#[no_mangle]
unsafe extern "C" fn stm32_adc_writel(adc: *mut stm32_adc, reg: u32, val: u32) {
    static void stm32_adc_writel(struct stm32_adc *adc, u32 reg, u32 val)
    {
    writel_relaxed(val, adc.common.base + adc.offset + reg);
    }
#[no_mangle]
unsafe extern "C" fn stm32_adc_set_bits(adc: *mut stm32_adc, reg: u32, bits: u32) {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_set_bits_common(adc: *mut stm32_adc, reg: u32, bits: u32) {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_clr_bits(adc: *mut stm32_adc, reg: u32, bits: u32) {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_clr_bits_common(adc: *mut stm32_adc, reg: u32, bits: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32_adc_conv_irq_enable(adc: *mut stm32_adc) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32_adc_conv_irq_disable(adc: *mut stm32_adc) {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_ovr_irq_enable(adc: *mut stm32_adc) {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_ovr_irq_disable(adc: *mut stm32_adc) {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_set_res(adc: *mut stm32_adc) {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_hw_stop(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_hw_start(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_int_ch_enable(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_int_ch_disable(adc: *mut stm32_adc) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f4_adc_start_conv(indio_dev: *mut iio_dev, dma: bool) {
...
#[no_mangle]
unsafe extern "C" fn stm32f4_adc_stop_conv(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32f4_adc_irq_clear(indio_dev: *mut iio_dev, msk: u32) {
...
#[no_mangle]
unsafe extern "C" fn stm32h7_adc_start_conv(indio_dev: *mut iio_dev, dma: bool) {
...
#[no_mangle]
unsafe extern "C" fn stm32h7_adc_stop_conv(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32h7_adc_irq_clear(indio_dev: *mut iio_dev, msk: u32) {
...
#[no_mangle]
unsafe extern "C" fn stm32mp13_adc_start_conv(indio_dev: *mut iio_dev, dma: bool) {
...
#[no_mangle]
unsafe extern "C" fn stm32h7_adc_set_ovs(indio_dev: *mut iio_dev, ovs_idx: u32) {
...
#[no_mangle]
unsafe extern "C" fn stm32mp13_adc_set_ovs(indio_dev: *mut iio_dev, ovs_idx: u32) {
...
#[no_mangle]
unsafe extern "C" fn stm32h7_adc_exit_pwr_down(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32h7_adc_enter_pwr_down(adc: *mut stm32_adc) {
...
#[no_mangle]
unsafe extern "C" fn stm32h7_adc_enable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32h7_adc_disable(indio_dev: *mut iio_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_adc_read_selfcalib(indio_dev: *mut iio_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_adc_restore_selfcalib(indio_dev: *mut iio_dev) -> c_int {
...
//
pub const STM32H7_ADC_CALIB_TIMEOUT_US: c_int = 100000;
//
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_adc_selfcalib(indio_dev: *mut iio_dev, do_lincal: c_int) -> c_int {
    static int stm32h7_adc_selfcalib(struct iio_dev *indio_dev, int do_lincal)
    {
    struct stm32_adc *adc = iio_priv(indio_dev);
    int ret;
    let mut msk: u32 = STM32H7_ADCALDIF;
    u32 val;
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_adc_check_selfcalib(indio_dev: *mut iio_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32h7_adc_prepare(indio_dev: *mut iio_dev) -> c_int {
    static int stm32h7_adc_prepare(struct iio_dev *indio_dev)
    {
    struct stm32_adc *adc = iio_priv(indio_dev);
    let mut lincal_done: c_int = false;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn stm32h7_adc_unprepare(indio_dev: *mut iio_dev) {
...
// res = adc->buffer[0];
    ...
    struct stm32_adc *adc = iio_priv(indio_dev);
    struct device *dev = indio_dev.dev.parent;
    let mut nb: c_int = adc.cfg.adc_info.num_ovs;
    unsigned int idx;
    int ret;
    switch (mask) {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_irq_clear(indio_dev: *mut iio_dev, msk: u32) {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_threaded_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t stm32_adc_threaded_isr(int irq, void *data)
    {
    struct iio_dev *indio_dev = data;
    struct stm32_adc *adc = iio_priv(indio_dev);
    const struct stm32_adc_regspec *regs = adc.cfg.regs;
    let mut status: u32 = stm32_adc_readl(adc, regs.isr_eoc.reg);
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_set_watermark(indio_dev: *mut iio_dev, val: c_uint) -> c_int {
    static int stm32_adc_set_watermark(struct iio_dev *indio_dev, unsigned int val)
    {
    struct stm32_adc *adc = iio_priv(indio_dev);
    let mut watermark: c_uint = STM32_DMA_BUFFER_SIZE / 2;
    let mut rx_buf_sz: c_uint = STM32_DMA_BUFFER_SIZE;
//
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_dma_residue(adc: *mut stm32_adc) -> c_uint {
...
// Residue is size in bytes from end of buffer
    let mut i: c_uint = adc.rx_buf_sz - state.residue;
    unsigned int size;
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_dma_buffer_done(data: *mut c_void) {
    static void stm32_adc_dma_buffer_done(void *data)
    {
    struct iio_dev *indio_dev = data;
    struct stm32_adc *adc = iio_priv(indio_dev);
    let mut residue: c_int = stm32_adc_dma_residue(adc);
//
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_dma_start(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
// Reset adc buffer index
    ...
    return 0;
    err_clr_trig:
    stm32_adc_set_trig(indio_dev, core::ptr::null_mut());
    err_pm_put:
    pm_runtime_put_autosuspend(dev);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn stm32_adc_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
    ...
    if (adc.dma_chan)
    dmaengine_terminate_sync(adc.dma_chan);
    if (stm32_adc_set_trig(indio_dev, core::ptr::null_mut()))
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_debugfs_init(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_fw_get_resolution(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_smpr_init(adc: *mut stm32_adc, channel: c_int, smp_ns: u32) {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_get_legacy_chan_count(indio_dev: *mut iio_dev, adc: *mut stm32_adc) -> c_int {
    static int stm32_adc_get_legacy_chan_count(struct iio_dev *indio_dev, struct stm32_adc *adc)
    {
    struct device *dev = &indio_dev.dev;
    const struct stm32_adc_info *adc_info = adc.cfg.adc_info;
    let mut num_channels: c_int = 0, ret;
...
// Optional sample time is provided either for each, or all channels
    ...
    struct device *dev = &indio_dev.dev;
    let mut num_diff: u32 = adc.num_diff;
    let mut num_se: c_int = nchans - num_diff;
    let mut size: c_int = num_diff * sizeof(*diff) / sizeof(u32);
    let mut scan_index: c_int = 0, ret, i, c;
    let mut smp: u32 = 0, smps[STM32_ADC_CH_MAX], chans[STM32_ADC_CH_MAX];
    if (num_diff) {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_chan_fw_init(indio_dev: *mut iio_dev, timestamping: bool) -> c_int {
    static int stm32_adc_chan_fw_init(struct iio_dev *indio_dev, bool timestamping)
    {
    struct stm32_adc *adc = iio_priv(indio_dev);
    const struct stm32_adc_info *adc_info = adc.cfg.adc_info;
    struct iio_chan_spec *channels;
    let mut scan_index: c_int = 0, num_channels = 0, ret, i;
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_dma_request(dev: *mut device, indio_dev: *mut iio_dev) -> c_int {
...
// DMA is optional: fall back to IRQ mode
    adc.dma_chan = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_probe(pdev: *mut platform_device) -> c_int {
    static int stm32_adc_probe(struct platform_device *pdev)
    {
    struct iio_dev *indio_dev;
    struct device *dev = &pdev.dev;
    irqreturn_t (*handler)(int irq, void *p) = core::ptr::null_mut();
    struct stm32_adc *adc;
    let mut timestamping: bool = false;
    int ret;
    ...
    adc.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(adc.clk)) {
    ret = PTR_ERR(adc.clk);
    if (ret == -ENOENT && !adc.cfg.clk_required) {
    adc.clk = core::ptr::null_mut();
    } else {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_adc_runtime_suspend(dev: *mut device) -> c_int {
    static int stm32_adc_runtime_suspend(struct device *dev)
    {
    return stm32_adc_hw_stop(dev);
    }
#[no_mangle]
unsafe extern "C" fn stm32_adc_runtime_resume(dev: *mut device) -> c_int {
