...
//! Source: drivers/iio/adc/twl4030-madc.c
#![no_std]
...
pub const TWL4030_MADC_MAX_CHANNELS: c_int = 16;
pub const TWL4030_MADC_CTRL1: c_uint = 0x00;
pub const TWL4030_MADC_CTRL2: c_uint = 0x01;
pub const TWL4030_MADC_RTSELECT_LSB: c_uint = 0x02;
pub const TWL4030_MADC_SW1SELECT_LSB: c_uint = 0x06;
pub const TWL4030_MADC_SW2SELECT_LSB: c_uint = 0x0A;
pub const TWL4030_MADC_RTAVERAGE_LSB: c_uint = 0x04;
pub const TWL4030_MADC_SW1AVERAGE_LSB: c_uint = 0x08;
pub const TWL4030_MADC_SW2AVERAGE_LSB: c_uint = 0x0C;
pub const TWL4030_MADC_CTRL_SW1: c_uint = 0x12;
pub const TWL4030_MADC_CTRL_SW2: c_uint = 0x13;
pub const TWL4030_MADC_RTCH0_LSB: c_uint = 0x17;
pub const TWL4030_MADC_GPCH0_LSB: c_uint = 0x37;
...
pub const TEMP_STEP_SIZE: c_int = 147;
pub const TEMP_PSR_R: c_int = 100;
pub const CURR_STEP_SIZE: c_int = 147;
pub const CURR_PSR_R1: c_int = 44;
pub const CURR_PSR_R2: c_int = 88;
pub const TWL4030_BCI_BCICTL1: c_uint = 0x23;
pub const TWL4030_BCI_CGAIN: c_uint = 0x020;

pub const REG_BCICTL2: c_uint = 0x024;
pub const TWL4030_BCI_ITHSENS: c_uint = 0x007;
// Register and bits for GPBR1 register
pub const TWL4030_REG_GPBR1: c_uint = 0x0c;

pub const TWL4030_USB_CARKIT_ANA_CTRL: c_uint = 0xBB;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct twl4030_madc_conversion_method {
    pub sel: u8,
    pub avg: u8,
    pub rbase: u8,
    pub ctrl: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct twl4030_madc_request {
    ...
    pub raw: bool,
    pub rbuf: [c_int; TWL4030_MADC_MAX_CHANNELS],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct twl4030_madc_data {
    pub dev: *mut device,
    pub lock: mutex,
    pub usb3v1: *mut regulator,
    pub requests: [twl4030_madc_request; TWL4030_MADC_NUM_METHODS],
    pub use_second_irq: bool,
    pub imr: u8,
    pub isr: u8,
}
...
//
#[no_mangle]
unsafe extern "C" fn twl4030_madc_channel_raw_read(madc: *mut twl4030_madc_data, reg: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn twl4030battery_temperature(raw_volt: c_int) -> c_int {
...
// calculating temperature
    ...
    let mut actual: c_int = twl4030_therm_tbl[temp];
    if ((actual - res) >= 0)
    break;
    }
    return temp + 1;
...
#[no_mangle]
unsafe extern "C" fn twl4030battery_current(raw_volt: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn twl4030_madc_disable_irq(madc: *mut twl4030_madc_data, id: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030_madc_threaded_irq_handler(irq: c_int, _madc: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn twl4030_madc_conversion(req: *mut twl4030_madc_request) -> c_int {
    static int twl4030_madc_conversion(struct twl4030_madc_request *req)
    {
    const struct twl4030_madc_conversion_method *method;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn twl4030_madc_set_power(madc: *mut twl4030_madc_data, on: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn twl4030_madc_probe(pdev: *mut platform_device) -> c_int {
    ...
    int irq, ret;
    u8 regval;
    struct iio_dev *iio_dev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn twl4030_madc_remove(pdev: *mut platform_device) {
