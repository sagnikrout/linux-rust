...
//! Source: drivers/iio/adc/ad4130.c
#![no_std]
...
pub const AD4130_STATUS_REG: c_uint = 0x00;
pub const AD4130_ADC_CONTROL_REG: c_uint = 0x01;

pub const AD4130_INT_REF_2_5V: c_int = 2500000;
pub const AD4130_INT_REF_1_25V: c_int = 1250000;

pub const AD4130_MCLK_FREQ_76_8KHZ: c_int = 76800;
pub const AD4130_MCLK_FREQ_153_6KHZ: c_int = 153600;
pub const AD4130_DATA_REG: c_uint = 0x02;
pub const AD4130_IO_CONTROL_REG: c_uint = 0x03;

pub const AD4130_VBIAS_REG: c_uint = 0x04;
pub const AD4130_ID_REG: c_uint = 0x05;
pub const AD4130_ERROR_REG: c_uint = 0x06;
pub const AD4130_ERROR_EN_REG: c_uint = 0x07;
pub const AD4130_MCLK_COUNT_REG: c_uint = 0x08;

pub const AD4130_FILTER_SELECT_MIN: c_int = 1;

pub const AD4130_MISC_REG: c_uint = 0x39;
pub const AD4130_FIFO_CONTROL_REG: c_uint = 0x3a;

pub const AD4130_WATERMARK_256: c_int = 0;
pub const AD4130_FIFO_STATUS_REG: c_uint = 0x3b;
pub const AD4130_FIFO_THRESHOLD_REG: c_uint = 0x3c;
pub const AD4130_FIFO_DATA_REG: c_uint = 0x3d;
pub const AD4130_FIFO_SIZE: c_int = 256;
pub const AD4130_FIFO_MAX_SAMPLE_SIZE: c_int = 3;
pub const AD4130_MAX_ANALOG_PINS: c_int = 16;
pub const AD4130_MAX_CHANNELS: c_int = 16;
pub const AD4130_MAX_DIFF_INPUTS: c_int = 30;
pub const AD4130_MAX_GPIOS: c_int = 4;
pub const AD4130_MAX_ODR: c_int = 2400;
pub const AD4130_MAX_PGA: c_int = 8;
pub const AD4130_MAX_SETUPS: c_int = 8;
pub const AD4130_AIN2_P1: c_uint = 0x2;
pub const AD4130_AIN3_P2: c_uint = 0x3;
pub const AD4130_RESET_BUF_SIZE: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4130_chip_info {
    pub name: *const c_char,
    pub max_analog_pins: c_uint,
    pub num_gpios: c_uint,
    pub info: *const iio_info,
    pub reg_size: *const c_uint,
    pub reg_size_length: c_uint,
    pub pin_map: *const u8,
    pub has_fifo: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4130_setup_info {
    pub iout0_val: c_uint,
    pub iout1_val: c_uint,
    pub burnout: c_uint,
    pub pga: c_uint,
    pub fs: c_uint,
    pub ref_sel: u32,
    pub filter_type: enum ad4130_filter_type,
    pub ref_bufp: bool,
    pub ref_bufm: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4130_slot_info {
    pub setup: ad4130_setup_info,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4130_filter_config {
    pub filter_type: enum ad4130_filter_type,
    pub odr_div: c_uint,
    pub fs_max: c_uint,
    pub samp_freq_avail_type: enum iio_available_type,
    pub samp_freq_avail_len: c_int,
    pub samp_freq_avail: [c_int; 3][2],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4130_state {
    pub regmap: *mut regmap,
    pub spi: *mut spi_device,
    pub mclk: *mut clk,
    pub chip_info: *const ad4130_chip_info,
    pub regulators: [regulator_bulk_data; 4],
    pub irq_trigger: u32,
    pub inv_irq_trigger: u32,
//
...
//
    ...
    pub chans: [iio_chan_spec; AD4130_MAX_CHANNELS],
    pub chans_info: [ad4130_chan_info; AD4130_MAX_CHANNELS],
    pub slots_info: [ad4130_slot_info; AD4130_MAX_SETUPS],
    pub pins_fn: [enum ad4130_pin_function; AD4130_MAX_ANALOG_PINS],
    pub vbias_pins: [u32; AD4130_MAX_ANALOG_PINS],
    pub num_vbias_pins: u32,
    pub scale_tbls: [c_int; AD4130_REF_SEL_MAX][AD4130_MAX_PGA][2],
    pub gc: gpio_chip,
    ...
    pub int_ref_en: bool,
    pub bipolar: bool,
    pub buffer_wait_for_irq: bool,
    pub num_enabled_channels: c_uint,
    pub effective_watermark: c_uint,
...
//
    pub __aligned(IIO_DMA_MINALIGN): u8 reset_buf[AD4130_RESET_BUF_SIZE],
    pub reg_write_tx_buf: [u8; 4],
    pub reg_read_tx_buf: [u8; 1],
    pub reg_read_rx_buf: [u8; 3],
    union {
    struct {
    pub fifo_tx_buf: [u8; 2],
    pub AD4130_FIFO_MAX_SAMPLE_SIZE]: *mut *mut u8 fifo_rx_buf[AD4130_FIFO_SIZE,
}
...
#[no_mangle]
unsafe extern "C" fn ad4130_data_reg_size(st: *mut ad4130_state) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ad4130_resolution(st: *mut ad4130_state) -> c_uint {
    static unsigned int ad4130_resolution(struct ad4130_state *st)
    {
    return ad4130_data_reg_size(st) * BITS_PER_BYTE;
    }
#[no_mangle]
unsafe extern "C" fn ad4130_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4130_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
//
    for (i = 0; i < ngpios; i++) {
    let mut pin: c_uint = i + AD4130_AIN2_P1;
    let mut valid: bool = st.pins_fn[pin] == AD4130_PIN_FN_NONE;
    __assign_bit(i, valid_mask, valid);
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ad4130_gpio_get_direction(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4130_set_mode(st: *mut ad4130_state, mode: enum ad4130_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4130_set_watermark_interrupt_en(st: *mut ad4130_state, en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4130_watermark_reg_val(val: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ad4130_push_fifo_data(indio_dev: *mut iio_dev) {
    static void ad4130_push_fifo_data(struct iio_dev *indio_dev)
    {
    struct ad4130_state *st = iio_priv(indio_dev);
    let mut data_reg_size: c_uint = ad4130_data_reg_size(st);
    let mut transfer_len: c_uint = st.effective_watermark * data_reg_size;
    let mut set_size: c_uint = st.num_enabled_channels * data_reg_size;
    unsigned int i;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ad4130_irq_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: st->buffer_wait_for_irq) -> else {
...
#[no_mangle]
unsafe extern "C" fn ad4130_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad4130_unlink_channel(st: *mut ad4130_state, channel: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ad4130_unlink_slot(st: *mut ad4130_state, slot: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(filter_config->fs_max: temp >) -> else {
...
// val = div_u64_rem(temp, NANO, val2);
    ...
    {
    struct ad4130_state *st = iio_priv(indio_dev);
    let mut channel: c_uint = chan.scan_index;
    struct ad4130_chan_info *chan_info = &st.chans_info[channel];
    struct ad4130_setup_info *setup_info = &chan_info.setup;
...
#[no_mangle]
unsafe extern "C" fn ad4130_set_fifo_watermark(indio_dev: *mut iio_dev, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4130_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4130_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4130_triggered_buffer_setup(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4130_validate_diff_channel(st: *mut ad4130_state, pin: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4130_validate_excitation_pin(st: *mut ad4130_state, pin: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4130_validate_vbias_pin(st: *mut ad4130_state, pin: u32) -> c_int {
    ...
    {
    struct ad4130_state *st = iio_priv(indio_dev);
    let mut resolution: c_uint = ad4130_resolution(st);
    let mut index: c_uint = indio_dev.num_channels++;
    struct device *dev = &st.spi.dev;
...
#[no_mangle]
unsafe extern "C" fn ad4130_parse_fw_children(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4310_parse_fw(indio_dev: *mut iio_dev) -> c_int {
    static int ad4310_parse_fw(struct iio_dev *indio_dev)
    {
    struct ad4130_state *st = iio_priv(indio_dev);
    struct device *dev = &st.spi.dev;
    let mut ext_clk_freq: u32 = AD4130_MCLK_FREQ_76_8KHZ;
    unsigned int i;
    int avdd_uv;
    int irq;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: st->mclk) -> else {
    else if (st.mclk)
...
#[no_mangle]
unsafe extern "C" fn ad4130_fill_scale_tbls(st: *mut ad4130_state) {
    static void ad4130_fill_scale_tbls(struct ad4130_state *st)
    {
    let mut pow: c_uint = ad4130_resolution(st) - st.bipolar;
    unsigned int i, j;
...
#[no_mangle]
unsafe extern "C" fn ad4130_clk_disable_unprepare(clk: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ad4130_int_clk_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4130_int_clk_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4130_int_clk_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn ad4130_setup_int_clk(st: *mut ad4130_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4130_setup(indio_dev: *mut iio_dev) -> c_int {
    static int ad4130_setup(struct iio_dev *indio_dev)
    {
    struct ad4130_state *st = iio_priv(indio_dev);
    struct device *dev = &st.spi.dev;
    unsigned int int_ref_val;
    let mut rate: c_ulong = AD4130_MCLK_FREQ_76_8KHZ;
    unsigned int val;
    unsigned int i;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ad4130_soft_reset(st: *mut ad4130_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4130_disable_regulators(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ad4130_probe(spi: *mut spi_device) -> c_int {
...
//
    ...
    st.regmap = devm_regmap_init(dev, core::ptr::null_mut(), st, &ad4130_regmap_config);
    if (IS_ERR(st.regmap))
    ...
    if (ret)
    return ret;
    ret = devm_request_threaded_irq(dev, spi.irq, core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn if(IRQF_TRIGGER_FALLING: st->irq_trigger &) -> else {
