...
//! Source: drivers/iio/adc/ad7291.c
#![no_std]
...
//
pub const AD7291_COMMAND: c_uint = 0x00;
pub const AD7291_VOLTAGE: c_uint = 0x01;
pub const AD7291_T_SENSE: c_uint = 0x02;
pub const AD7291_T_AVERAGE: c_uint = 0x03;

pub const AD7291_VOLTAGE_ALERT_STATUS: c_uint = 0x1F;
pub const AD7291_T_ALERT_STATUS: c_uint = 0x20;
pub const AD7291_BITS: c_int = 12;
pub const AD7291_VOLTAGE_LIMIT_COUNT: c_int = 8;
//
// AD7291 command
//

pub const AD7291_VOLTAGE_OFFSET: c_int = 8;
//
// AD7291 value masks
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7291_chip_info {
    pub client: *mut i2c_client,
    pub reg: *mut regulator,
    pub command: u16,
    pub /: *mut *mut u16 c_mask; / Active voltage channels for events,
    pub state_lock: mutex,
}

#[no_mangle]
unsafe extern "C" fn ad7291_i2c_read(chip: *mut ad7291_chip_info, reg: u8, data: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7291_i2c_write(chip: *mut ad7291_chip_info, reg: u8, data: u16) -> c_int {
    static int ad7291_i2c_write(struct ad7291_chip_info *chip, u8 reg, u16 data)
    {
    return i2c_smbus_write_word_swapped(chip.client, reg, data);
    }
#[no_mangle]
unsafe extern "C" fn ad7291_event_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
//
    ...
    chip.c_mask &= ~mask;
#[no_mangle]
pub unsafe extern "C" fn if(mask)): state && (!(chip->c_mask &) -> else {
...
#[no_mangle]
unsafe extern "C" fn ad7291_reg_disable(reg: *mut c_void) {
    static void ad7291_reg_disable(void *reg)
    {
    regulator_disable(reg);
    }
#[no_mangle]
unsafe extern "C" fn ad7291_probe(client: *mut i2c_client) -> c_int {
