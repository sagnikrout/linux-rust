...
//! Source: drivers/iio/adc/ad7793.c
#![no_std]
...
pub const AD7793_CONF_CHAN_MASK: c_uint = 0xf /* Channel select mask */;

// ID Register Bit Designations (AD7793_REG_ID)
pub const AD7785_ID: c_uint = 0x3;
pub const AD7792_ID: c_uint = 0xA;
pub const AD7793_ID: c_uint = 0xB;
pub const AD7794_ID: c_uint = 0xF;
pub const AD7795_ID: c_uint = 0xF;
pub const AD7796_ID: c_uint = 0xA;
pub const AD7797_ID: c_uint = 0xB;
pub const AD7798_ID: c_uint = 0x8;
pub const AD7799_ID: c_uint = 0x9;
pub const AD7793_ID_MASK: c_uint = 0xF;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7793_chip_info {
    pub id: c_uint,
    pub channels: *const iio_chan_spec,
    pub num_channels: c_uint,
    pub flags: c_uint,
    pub iio_info: *const iio_info,
    pub sample_freq_avail: *const u16,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7793_state {
    pub chip_info: *const ad7793_chip_info,
    pub mode: u16,
    pub conf: u16,
...
#[no_mangle]
unsafe extern "C" fn ad7793_set_channel(sd: *mut ad_sigma_delta, channel: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7793_calibrate_all(st: *mut ad7793_state) -> c_int {
...
// length = ARRAY_SIZE(st->scale_avail) * 2;
    ...
    int ret;
    unsigned long long scale_uv;
    let mut unipolar: bool = !!(st.conf & AD7793_CONF_UNIPOLAR);
    switch (m) {
...
// val = st->chip_info
    ...
    _storagebits, _shift, core::ptr::null_mut(), IIO_TEMP, \
    0, \
    BIT(IIO_CHAN_INFO_SAMP_FREQ))
...
#[no_mangle]
unsafe extern "C" fn ad7793_probe(spi: *mut spi_device) -> c_int {
