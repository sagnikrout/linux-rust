...
//! Source: drivers/iio/adc/xilinx-xadc-core.c
#![no_std]
...
//
    ...
    let mut XADC_ZYNQ_UNMASK_TIMEOUT: static unsigned int = 500;
// ZYNQ register definitions
pub const XADC_ZYNQ_REG_CFG: c_uint = 0x00;
pub const XADC_ZYNQ_REG_INTSTS: c_uint = 0x04;
pub const XADC_ZYNQ_REG_INTMSK: c_uint = 0x08;
pub const XADC_ZYNQ_REG_STATUS: c_uint = 0x0c;
pub const XADC_ZYNQ_REG_CFIFO: c_uint = 0x10;
pub const XADC_ZYNQ_REG_DFIFO: c_uint = 0x14;
pub const XADC_ZYNQ_REG_CTL: c_uint = 0x18;

pub const XADC_ZYNQ_CFG_CFIFOTH_OFFSET: c_int = 20;

pub const XADC_ZYNQ_CFG_DFIFOTH_OFFSET: c_int = 16;

pub const XADC_ZYNQ_CFG_IGAP_MASK: c_uint = 0x1f;

pub const XADC_ZYNQ_INT_ALARM_MASK: c_uint = 0xff;
pub const XADC_ZYNQ_INT_ALARM_OFFSET: c_int = 0;

pub const XADC_ZYNQ_STATUS_CFIFO_LVL_OFFSET: c_int = 16;

pub const XADC_ZYNQ_STATUS_DFIFO_LVL_OFFSET: c_int = 12;

pub const XADC_ZYNQ_CMD_NOP: c_uint = 0x00;
pub const XADC_ZYNQ_CMD_READ: c_uint = 0x01;
pub const XADC_ZYNQ_CMD_WRITE: c_uint = 0x02;

// AXI register definitions
pub const XADC_AXI_REG_RESET: c_uint = 0x00;
pub const XADC_AXI_REG_STATUS: c_uint = 0x04;
pub const XADC_AXI_REG_ALARM_STATUS: c_uint = 0x08;
pub const XADC_AXI_REG_CONVST: c_uint = 0x0c;
pub const XADC_AXI_REG_XADC_RESET: c_uint = 0x10;
pub const XADC_AXI_REG_GIER: c_uint = 0x5c;
pub const XADC_AXI_REG_IPISR: c_uint = 0x60;
pub const XADC_AXI_REG_IPIER: c_uint = 0x68;
// 7 Series
pub const XADC_7S_AXI_ADC_REG_OFFSET: c_uint = 0x200;
// UltraScale
pub const XADC_US_AXI_ADC_REG_OFFSET: c_uint = 0x400;
pub const XADC_AXI_RESET_MAGIC: c_uint = 0xa;

pub const XADC_AXI_INT_ALARM_MASK: c_uint = 0x3c0f;
...
//
pub const XADC_MAX_SAMPLERATE: c_int = 150000;
...
#[no_mangle]
unsafe extern "C" fn xadc_zynq_drain_fifo(xadc: *mut xadc) {
...
#[no_mangle]
unsafe extern "C" fn xadc_zynq_transform_alarm(alarm: c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn xadc_zynq_unmask_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn xadc_zynq_interrupt_handler(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
pub const XADC_ZYNQ_TCK_RATE_MAX: c_int = 50000000;
pub const XADC_ZYNQ_IGAP_DEFAULT: c_int = 20;
pub const XADC_ZYNQ_PCAP_RATE_MAX: c_int = 200000000;
...
#[no_mangle]
pub unsafe extern "C" fn if(7: div <=) -> else {
    else if (div <= 7)
    tck_div = XADC_ZYNQ_CFG_TCKRATE_DIV4;
#[no_mangle]
pub unsafe extern "C" fn if(15: div <=) -> else {
    else if (div <= 15)
...
#[no_mangle]
unsafe extern "C" fn xadc_zynq_get_dclk_rate(xadc: *mut xadc) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn xadc_zynq_update_alarm(xadc: *mut xadc, alarm: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn xadc_axi_interrupt_handler(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xadc_axi_update_alarm(xadc: *mut xadc, alarm: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn xadc_axi_get_dclk(xadc: *mut xadc) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn xadc_get_dclk_rate(xadc: *mut xadc) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn xadc_scan_index_to_channel(scan_index: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn xadc_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xadc_trigger_set_state(trigger: *mut iio_trigger, state: bool) -> c_int {
...
// Only one of the two triggers can be active at a time.
    if (xadc.trigger != core::ptr::null_mut()) {
    ret = -EBUSY;
    goto err_out;
    } else {
    ...
    xadc.trigger = core::ptr::null_mut();
    }
    spin_lock_irqsave(&xadc.lock, flags);
    xadc_read_reg(xadc, XADC_AXI_REG_IPIER, &val);
...
#[no_mangle]
unsafe extern "C" fn xadc_power_adc_b(xadc: *mut xadc, seq_mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xadc_get_seq_mode(xadc: *mut xadc, scan_mode: c_ulong) -> c_int {
    static int xadc_get_seq_mode(struct xadc *xadc, unsigned long scan_mode)
    {
    let mut aux_scan_mode: c_uint = scan_mode >> 16;
...
#[no_mangle]
unsafe extern "C" fn xadc_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xadc_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xadc_read_samplerate(xadc: *mut xadc) -> c_int {
    ...
    {
    struct xadc *xadc = iio_priv(indio_dev);
    let mut bits: c_uint = chan.scan_type.realbits;
    uint16_t val16;
    int ret;
    switch (info) {
...
#[no_mangle]
unsafe extern "C" fn xadc_write_samplerate(xadc: *mut xadc, val: c_int) -> c_int {
    static int xadc_write_samplerate(struct xadc *xadc, int val)
    {
    let mut clk_rate: c_ulong = xadc_get_dclk_rate(xadc);
    unsigned int div;
    if (!clk_rate)
    return -EINVAL;
    if (val <= 0)
...
//
    ...
    div = 2;
#[no_mangle]
pub unsafe extern "C" fn if(0xff: div >) -> else {
    else if (div > 0xff)
    div = 0xff;
...
// Separate values for upper and lower thresholds, but only a shared enabled
    ...
    BIT(IIO_CHAN_INFO_SCALE), \
    .info_mask_shared_by_all = BIT(IIO_CHAN_INFO_SAMP_FREQ), \
    .event_spec = (_alarm) ? xadc_voltage_events : core::ptr::null_mut(), \
...
// 7 Series
    ...
    XADC_7S_CHAN_VOLTAGE(8, 11, XADC_REG_VPVN, core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(9, 16, XADC_REG_VAUX(0), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(10, 17, XADC_REG_VAUX(1), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(11, 18, XADC_REG_VAUX(2), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(12, 19, XADC_REG_VAUX(3), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(13, 20, XADC_REG_VAUX(4), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(14, 21, XADC_REG_VAUX(5), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(15, 22, XADC_REG_VAUX(6), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(16, 23, XADC_REG_VAUX(7), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(17, 24, XADC_REG_VAUX(8), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(18, 25, XADC_REG_VAUX(9), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(19, 26, XADC_REG_VAUX(10), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(20, 27, XADC_REG_VAUX(11), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(21, 28, XADC_REG_VAUX(12), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(22, 29, XADC_REG_VAUX(13), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(23, 30, XADC_REG_VAUX(14), core::ptr::null_mut(), false),
    XADC_7S_CHAN_VOLTAGE(24, 31, XADC_REG_VAUX(15), core::ptr::null_mut(), false),
    };
// UltraScale
    ...
    XADC_US_CHAN_VOLTAGE(8, 11, XADC_REG_VPVN, core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(9, 16, XADC_REG_VAUX(0), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(10, 17, XADC_REG_VAUX(1), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(11, 18, XADC_REG_VAUX(2), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(12, 19, XADC_REG_VAUX(3), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(13, 20, XADC_REG_VAUX(4), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(14, 21, XADC_REG_VAUX(5), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(15, 22, XADC_REG_VAUX(6), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(16, 23, XADC_REG_VAUX(7), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(17, 24, XADC_REG_VAUX(8), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(18, 25, XADC_REG_VAUX(9), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(19, 26, XADC_REG_VAUX(10), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(20, 27, XADC_REG_VAUX(11), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(21, 28, XADC_REG_VAUX(12), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(22, 29, XADC_REG_VAUX(13), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(23, 30, XADC_REG_VAUX(14), core::ptr::null_mut(), false),
    XADC_US_CHAN_VOLTAGE(24, 31, XADC_REG_VAUX(15), core::ptr::null_mut(), false),
    };
...
#[no_mangle]
unsafe extern "C" fn xadc_parse_dt(indio_dev: *mut iio_dev, conf: *mut c_uint, irq: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcasecmp(external_mux, 0: "single") ==) -> else {
    else if (strcasecmp(external_mux, "single") == 0)
    xadc.external_mux_mode = XADC_EXTERNAL_MUX_SINGLE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcasecmp(external_mux, 0: "dual") ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(16: ext_mux_chan <=) -> else {
...
// No IRQ => no events
    ...
    channels[i].event_spec = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn xadc_cancel_delayed_work(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn xadc_probe(pdev: *mut platform_device) -> c_int {
    ...
    xadc.clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
    if (IS_ERR(xadc.clk))
