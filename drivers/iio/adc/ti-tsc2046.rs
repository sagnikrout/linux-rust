...
//! Source: drivers/iio/adc/ti-tsc2046.c
#![no_std]
...
pub const TI_TSC2046_MAX_SAMPLE_RATE: c_int = 125000;

    BITS_PER_TYPE(struct tsc2046_adc_atom)

    (TI_TSC2046_MAX_SAMPLE_RATE * TI_TSC2046_SAMPLE_BITS)
pub const TI_TSC2046_SAMPLE_INTERVAL_US: c_int = 10000;

pub const TI_TSC2046_ADDR_TEMP1: c_int = 7;
pub const TI_TSC2046_ADDR_AUX: c_int = 6;
pub const TI_TSC2046_ADDR_X: c_int = 5;
pub const TI_TSC2046_ADDR_Z2: c_int = 4;
pub const TI_TSC2046_ADDR_Z1: c_int = 3;
pub const TI_TSC2046_ADDR_VBAT: c_int = 2;
pub const TI_TSC2046_ADDR_Y: c_int = 1;
pub const TI_TSC2046_ADDR_TEMP0: c_int = 0;
//
...
pub const TI_TSC2046_MAX_CHAN: c_int = 8;
pub const TI_TSC2046_MIN_POLL_CNT: c_int = 3;
pub const TI_TSC2046_EXT_POLL_CNT: c_int = 3;

    (TI_TSC2046_MIN_POLL_CNT + TI_TSC2046_EXT_POLL_CNT)
pub const TI_TSC2046_INT_VREF: c_int = 2500;
// Represents a HW sample
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tsc2046_adc_atom {
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tsc2046_adc_group_layout {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tsc2046_adc_priv {
    pub spi: *mut spi_device,
    pub internal_vref: bool,
    pub trig: *mut iio_trigger,
    pub trig_timer: hrtimer,
    pub state: enum tsc2046_state,
    pub poll_cnt: c_int,
...
// Scan data for each channel
    pub data: [u16; TI_TSC2046_MAX_CHAN],
// Timestamp
    pub ts: aligned_s64,
    pub scan_buf: },
//
...
//
    pub slock: mutex,
    pub l: [tsc2046_adc_group_layout; TI_TSC2046_MAX_CHAN],
    pub rx: *mut tsc2046_adc_atom,
    pub tx: *mut tsc2046_adc_atom,
    pub count: c_uint,
    pub groups: c_uint,
    pub effective_speed_hz: u32,
    pub scan_interval_us: u32,
    pub time_per_scan_us: u32,
    pub time_per_bit_ns: u32,
    pub vref_mv: c_uint,
    pub ch_cfg: [tsc2046_adc_ch_cfg; TI_TSC2046_MAX_CHAN],
}
...
#[no_mangle]
unsafe extern "C" fn tsc2046_adc_get_value(buf: *mut tsc2046_adc_atom) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn tsc2046_adc_get_val(priv: *mut tsc2046_adc_priv, group: c_int) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn tsc2046_adc_scan(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsc2046_adc_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
    ...
    ret = tsc2046_adc_read_one(priv, chan.channel, core::ptr::null_mut());
    if (ret < 0)
    return ret;
// val = ret;
    return IIO_VAL_INT;
...
#[no_mangle]
unsafe extern "C" fn tsc2046_adc_timer(hrtimer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn tsc2046_adc_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tsc2046_adc_reenable_trigger(trig: *mut iio_trigger) {
...
#[no_mangle]
unsafe extern "C" fn tsc2046_adc_set_trigger_state(trig: *mut iio_trigger, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsc2046_adc_setup_spi_msg(priv: *mut tsc2046_adc_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsc2046_adc_parse_fwnode(priv: *mut tsc2046_adc_priv) {
...
#[no_mangle]
unsafe extern "C" fn tsc2046_adc_probe(spi: *mut spi_device) -> c_int {
    ...
    &tsc2046_adc_trigger_handler, core::ptr::null_mut());
    if (ret) {
