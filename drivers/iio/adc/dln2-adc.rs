...
//! Source: drivers/iio/adc/dln2-adc.c
#![no_std]
...
pub const DLN2_ADC_ID: c_uint = 0x06;

pub const DLN2_ADC_EVENT_NONE: c_int = 0;
pub const DLN2_ADC_EVENT_BELOW: c_int = 1;
pub const DLN2_ADC_EVENT_LEVEL_ABOVE: c_int = 2;
pub const DLN2_ADC_EVENT_OUTSIDE: c_int = 3;
pub const DLN2_ADC_EVENT_INSIDE: c_int = 4;
pub const DLN2_ADC_EVENT_ALWAYS: c_int = 5;
pub const DLN2_ADC_MAX_CHANNELS: c_int = 8;
pub const DLN2_ADC_DATA_BITS: c_int = 10;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dln2_adc_demux_table {
    pub from: c_uint,
    pub to: c_uint,
    pub length: c_uint,
}
...
pub struct dln2_adc {
    ...
    pub 1]: iio_chan_spec iio_channels[DLN2_ADC_MAX_CHANNELS +,
    pub trigger_chan: int port,,
    pub trig: *mut iio_trigger,
    pub mutex: mutex,
// Cached sample period in milliseconds
    pub sample_period: c_uint,
// Demux table
    pub demux_count: c_uint,
    pub demux: [dln2_adc_demux_table; DLN2_ADC_MAX_CHANNELS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dln2_adc_port_chan {
    pub port: u8,
    pub chan: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dln2_adc_get_all_vals {
    pub channel_mask: __le16,
    pub values: [__le16; DLN2_ADC_MAX_CHANNELS],
}
    ...
    &dln2.demux[dln2.demux_count - 1] : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dln2_adc_update_demux(dln2: *mut dln2_adc) {
    static void dln2_adc_update_demux(struct dln2_adc *dln2)
    {
    let mut in_ind: c_int = -1, out_ind;
...
#[no_mangle]
unsafe extern "C" fn dln2_adc_get_chan_count(dln2: *mut dln2_adc) -> c_int {
    static int dln2_adc_get_chan_count(struct dln2_adc *dln2)
    {
    int ret;
    let mut port: u8 = dln2.port;
    u8 count;
    let mut olen: c_int = sizeof(count);
...
#[no_mangle]
unsafe extern "C" fn dln2_adc_set_port_resolution(dln2: *mut dln2_adc) -> c_int {
    ...
    let mut cmd: u16 = enable ? DLN2_ADC_CHANNEL_ENABLE : DLN2_ADC_CHANNEL_DISABLE;
    ...
    let mut port: u8 = dln2.port;
    __le16 conflict;
    let mut olen: c_int = sizeof(conflict);
    let mut cmd: u16 = enable ? DLN2_ADC_ENABLE : DLN2_ADC_DISABLE;
    if (conflict_out)
// conflict_out = 0;
...
#[no_mangle]
unsafe extern "C" fn dln2_adc_read(dln2: *mut dln2_adc, channel: c_uint) -> c_int {
    static int dln2_adc_read(struct dln2_adc *dln2, unsigned int channel)
    {
    int ret, i;
    u16 conflict;
    __le16 value;
    let mut olen: c_int = sizeof(value);
    struct dln2_adc_port_chan port_chan = {
    .port = dln2.port,
    .chan = channel,
    };
...
//
    ...
    disable_port:
    dln2_adc_set_port_enabled(dln2, false, core::ptr::null_mut());
    disable_chan:
    ...
    {
    int ret;
    let mut port: __u8 = dln2.port;
    let mut olen: c_int = sizeof(*get_all_vals);
...
//
    ...
    {
    struct dln2_adc *dln2 = iio_priv(indio_dev);
    let mut chan_count: c_int = indio_dev.num_channels - 1;
    int ret, i, j;
    mutex_lock(&dln2.mutex);
...
#[no_mangle]
unsafe extern "C" fn dln2_adc_trigger_h(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dln2_adc_triggered_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dln2_adc_triggered_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
// Disable ADC
    ret = dln2_adc_set_port_enabled(dln2, false, core::ptr::null_mut());
    mutex_unlock(&dln2.mutex);
    if (ret < 0)
    dev_dbg(&dln2.pdev.dev, "Problem in %s\n", __func__);
    return ret;
...
#[no_mangle]
unsafe extern "C" fn dln2_adc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dln2_adc_remove(pdev: *mut platform_device) {
