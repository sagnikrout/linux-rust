...
//! Source: drivers/iio/adc/qcom-spmi-vadc.c
#![no_std]
...
pub const VADC_REVISION2: c_uint = 0x1;
pub const VADC_REVISION2_SUPPORTED_VADC: c_int = 1;
pub const VADC_PERPH_TYPE: c_uint = 0x4;
pub const VADC_PERPH_TYPE_ADC: c_int = 8;
pub const VADC_PERPH_SUBTYPE: c_uint = 0x5;
pub const VADC_PERPH_SUBTYPE_VADC: c_int = 1;
pub const VADC_STATUS1: c_uint = 0x8;
pub const VADC_STATUS1_OP_MODE: c_int = 4;

pub const VADC_STATUS1_REQ_STS_EOC_MASK: c_uint = 0x3;
pub const VADC_MODE_CTL: c_uint = 0x40;
pub const VADC_OP_MODE_SHIFT: c_int = 3;
pub const VADC_OP_MODE_NORMAL: c_int = 0;

pub const VADC_EN_CTL1: c_uint = 0x46;

pub const VADC_ADC_CH_SEL_CTL: c_uint = 0x48;
pub const VADC_ADC_DIG_PARAM: c_uint = 0x50;
pub const VADC_ADC_DIG_DEC_RATIO_SEL_SHIFT: c_int = 2;
pub const VADC_HW_SETTLE_DELAY: c_uint = 0x51;
pub const VADC_CONV_REQ: c_uint = 0x52;

pub const VADC_FAST_AVG_CTL: c_uint = 0x5a;
pub const VADC_FAST_AVG_EN: c_uint = 0x5b;

pub const VADC_ACCESS: c_uint = 0xd0;
pub const VADC_ACCESS_DATA: c_uint = 0xa5;
pub const VADC_PERH_RESET_CTL3: c_uint = 0xda;

pub const VADC_DATA: c_uint = 0x60	/* 16 bits */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vadc_priv {
    pub regmap: *mut regmap,
    pub dev: *mut device,
    pub base: u16,
    pub nchannels: c_uint,
    pub chan_props: *mut vadc_channel_prop,
    pub iio_chans: *mut iio_chan_spec,
    pub are_ref_measured: bool,
    pub poll_eoc: bool,
...
#[no_mangle]
unsafe extern "C" fn vadc_read(vadc: *mut vadc_priv, offset: u16, data: *mut u8) -> c_int {
    static int vadc_read(struct vadc_priv *vadc, u16 offset, u8 *data)
    {
    return regmap_bulk_read(vadc.regmap, vadc.base + offset, data, 1);
    }
#[no_mangle]
unsafe extern "C" fn vadc_write(vadc: *mut vadc_priv, offset: u16, data: u8) -> c_int {
    static int vadc_write(struct vadc_priv *vadc, u16 offset, u8 data)
    {
    return regmap_write(vadc.regmap, vadc.base + offset, data);
    }
#[no_mangle]
unsafe extern "C" fn vadc_reset(vadc: *mut vadc_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vadc_set_state(vadc: *mut vadc_priv, state: bool) -> c_int {
    static int vadc_set_state(struct vadc_priv *vadc, bool state)
    {
    return vadc_write(vadc, VADC_EN_CTL1, state ? VADC_EN_CTL1_SET : 0);
    }
#[no_mangle]
unsafe extern "C" fn vadc_show_status(vadc: *mut vadc_priv) {
...
#[no_mangle]
unsafe extern "C" fn vadc_poll_wait_eoc(vadc: *mut vadc_priv, interval_us: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vadc_read_result(vadc: *mut vadc_priv, data: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vadc_measure_ref_points(vadc: *mut vadc_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vadc_prescaling_from_dt(numerator: u32, denominator: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vadc_hw_settle_time_from_dt(value: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vadc_avg_samples_from_dt(value: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vadc_get_fw_data(vadc: *mut vadc_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vadc_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vadc_check_revision(vadc: *mut vadc_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vadc_probe(pdev: *mut platform_device) -> c_int {
