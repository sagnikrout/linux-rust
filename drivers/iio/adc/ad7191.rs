...
//! Source: drivers/iio/adc/ad7191.c
#![no_std]
...
pub const AD7191_TEMP_CODES_PER_DEGREE: c_int = 2815;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7191_state {
    pub sd: ad_sigma_delta,
    pub /: *mut *mut mutex lock; / Protect device state,
    pub odr_gpios: *mut gpio_descs,
    pub pga_gpios: *mut gpio_descs,
    pub temp_gpio: *mut gpio_desc,
    pub chan_gpio: *mut gpio_desc,
    pub int_vref_mv: u16,
    pub (*scale_avail)[2]: *const u32,
    pub scale_avail_size: usize,
    pub scale_index: u32,
    pub samp_freq_avail: *const u32,
    pub samp_freq_avail_size: usize,
    pub samp_freq_index: u32,
    pub mclk: *mut clk,
}

#[no_mangle]
unsafe extern "C" fn ad7191_set_channel(sd: *mut ad_sigma_delta, address: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7191_set_cs(sigma_delta: *mut ad_sigma_delta, assert: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7191_init_regulators(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7191_config_setup(indio_dev: *mut iio_dev) -> c_int {
...
// Gain options, see Table 7
    ...
    st.odr_gpios = core::ptr::null_mut();
    } else {
    ...
    st.pga_gpios = core::ptr::null_mut();
    } else {
...
#[no_mangle]
unsafe extern "C" fn ad7191_clock_setup(st: *mut ad7191_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7191_setup(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7191_set_gain(st: *mut ad7191_state, gain_index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7191_set_samp_freq(st: *mut ad7191_state, samp_freq_index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7191_probe(spi: *mut spi_device) -> c_int {
