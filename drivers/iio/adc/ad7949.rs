...
//! Source: drivers/iio/adc/ad7949.c
#![no_std]
...
pub const AD7949_CFG_VAL_INCC_UNIPOLAR_GND: c_int = 7;
pub const AD7949_CFG_VAL_INCC_UNIPOLAR_COMM: c_int = 6;
pub const AD7949_CFG_VAL_INCC_UNIPOLAR_DIFF: c_int = 4;
pub const AD7949_CFG_VAL_INCC_TEMP: c_int = 3;
pub const AD7949_CFG_VAL_INCC_BIPOLAR: c_int = 2;
pub const AD7949_CFG_VAL_INCC_BIPOLAR_DIFF: c_int = 0;
...
pub const AD7949_CFG_VAL_REF_EXT_TEMP_BUF: c_int = 3;
pub const AD7949_CFG_VAL_REF_EXT_TEMP: c_int = 2;
pub const AD7949_CFG_VAL_REF_INT_4096: c_int = 1;
pub const AD7949_CFG_VAL_REF_INT_2500: c_int = 0;
...
pub struct ad7949_adc_chip {
    ...
    pub resolution: u8,
    pub cfg: u16,
    pub current_channel: c_uint,
    pub __aligned(IIO_DMA_MINALIGN): u16 buffer,
    pub buf8b: __be16,
}
...
#[no_mangle]
unsafe extern "C" fn ad7949_spi_init(ad7949_adc: *mut ad7949_adc_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7949_disable_reg(reg: *mut c_void) {
    static void ad7949_disable_reg(void *reg)
    {
    regulator_disable(reg);
    }
#[no_mangle]
unsafe extern "C" fn ad7949_spi_probe(spi: *mut spi_device) -> c_int {
