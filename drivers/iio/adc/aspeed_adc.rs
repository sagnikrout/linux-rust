...
//! Source: drivers/iio/adc/aspeed_adc.c
#![no_std]
...
pub const ASPEED_RESOLUTION_BITS: c_int = 10;
pub const ASPEED_CLOCKS_PER_SAMPLE: c_int = 12;
pub const ASPEED_REG_ENGINE_CONTROL: c_uint = 0x00;
pub const ASPEED_REG_INTERRUPT_CONTROL: c_uint = 0x04;
pub const ASPEED_REG_VGA_DETECT_CONTROL: c_uint = 0x08;
pub const ASPEED_REG_CLOCK_CONTROL: c_uint = 0x0C;
pub const ASPEED_REG_COMPENSATION_TRIM: c_uint = 0xC4;
//
// The register offset between 0xC8~0xCC can be read and won't affect the
// hardware logic in each version of ADC.
//
pub const ASPEED_REG_MAX: c_uint = 0xD0;

pub const ASPEED_ADC_OP_MODE_PWR_DOWN: c_int = 0;
pub const ASPEED_ADC_OP_MODE_STANDBY: c_int = 1;
pub const ASPEED_ADC_OP_MODE_NORMAL: c_int = 7;
...
pub const ASPEED_ADC_REF_VOLTAGE_2500mV: c_int = 0;
pub const ASPEED_ADC_REF_VOLTAGE_1200mV: c_int = 1;
pub const ASPEED_ADC_REF_VOLTAGE_EXT_HIGH: c_int = 2;
pub const ASPEED_ADC_REF_VOLTAGE_EXT_LOW: c_int = 3;

pub const ASPEED_ADC_BAT_SENSING_DIV_2_3: c_int = 0;
pub const ASPEED_ADC_BAT_SENSING_DIV_1_3: c_int = 1;

pub const ASPEED_ADC_CH7_NORMAL: c_int = 0;
pub const ASPEED_ADC_CH7_BAT: c_int = 1;

pub const ASPEED_ADC_INIT_POLLING_TIME: c_int = 500;
pub const ASPEED_ADC_INIT_TIMEOUT: c_int = 500000;
// Battery sensing is typically on the last channel
pub const ASPEED_ADC_BATTERY_CHANNEL: c_int = 7;
//
...
//
pub const ASPEED_ADC_DEF_SAMPLING_RATE: c_int = 65000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_adc_trim_locate {
    pub offset: c_uint,
    pub field: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_adc_model_data {
    pub model_name: *const c_char,
    pub Hz: unsigned int min_sampling_rate; //,
    pub Hz: unsigned int max_sampling_rate; //,
    pub vref_fixed_mv: c_uint,
    pub wait_init_sequence: bool,
    pub need_prescaler: bool,
    pub bat_sense_sup: bool,
    pub scaler_bit_width: u8,
    pub num_channels: c_uint,
    pub trim_locate: *const aspeed_adc_trim_locate,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_adc_data {
    pub dev: *mut device,
    pub model_data: *const aspeed_adc_model_data,
    pub base: *mut void __iomem,
    pub clk_lock: spinlock_t,
    pub fixed_div_clk: *mut clk_hw,
    pub clk_prescaler: *mut clk_hw,
    pub clk_scaler: *mut clk_hw,
    pub rst: *mut reset_control,
    pub vref_mv: c_int,
    pub sample_period_ns: u32,
    pub cv: c_int,
    pub battery_sensing: bool,
    pub battery_mode_gain: adc_gain,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn aspeed_adc_channels_mask(num_channels: c_uint) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn aspeed_adc_get_active_channels(data: *const aspeed_adc_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn aspeed_adc_set_trim_data(indio_dev: *mut iio_dev) -> c_int {
    ...
    syscon = of_find_node_by_name(core::ptr::null_mut(), "syscon");
...
#[no_mangle]
unsafe extern "C" fn aspeed_adc_compensation(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_adc_set_sampling_rate(indio_dev: *mut iio_dev, rate: u32) -> c_int {
...
//
    ...
    let mut ctrl_reg: u32 = adc_engine_control_reg_val & ~ASPEED_ADC_CTRL_CHANNEL;
...
#[no_mangle]
unsafe extern "C" fn aspeed_adc_unregister_fixed_divider(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_adc_reset_assert(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_adc_clk_disable_unprepare(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_adc_power_down(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_adc_vref_config(indio_dev: *mut iio_dev) -> c_int {
    ...
    data.base + ASPEED_REG_ENGINE_CONTROL);
#[no_mangle]
pub unsafe extern "C" fn if(1650): (data->vref_mv >= 900) && (data->vref_mv <=) -> else {
...
// Conversion from uV to mV
    ...
    data.base + ASPEED_REG_ENGINE_CONTROL);
#[no_mangle]
pub unsafe extern "C" fn if(1200: data->vref_mv ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn aspeed_adc_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut scaler_flags: c_ulong = 0;
...
//
    ...
    data.rst = devm_reset_control_get_shared(dev, core::ptr::null_mut());
    if (IS_ERR(data.rst))
