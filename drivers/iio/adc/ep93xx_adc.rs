...
//! Source: drivers/iio/adc/ep93xx_adc.c
#![no_std]
...
pub const EP93XX_ADC_RESULT: c_uint = 0x08;

pub const EP93XX_ADC_SWITCH: c_uint = 0x18;
pub const EP93XX_ADC_SW_LOCK: c_uint = 0x20;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ep93xx_adc_priv {
    pub clk: *mut clk,
...
#[no_mangle]
unsafe extern "C" fn ep93xx_adc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_adc_remove(pdev: *mut platform_device) {
