...
//! Source: drivers/iio/adc/ti-adc0832.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn adc0831_adc_conversion(adc: *mut adc0832) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adc0832_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn adc0832_reg_disable(reg: *mut c_void) {
    static void adc0832_reg_disable(void *reg)
    {
    regulator_disable(reg);
    }
#[no_mangle]
unsafe extern "C" fn adc0832_probe(spi: *mut spi_device) -> c_int {
    ...
    adc0832_trigger_handler, core::ptr::null_mut());
    if (ret)
    return ret;
