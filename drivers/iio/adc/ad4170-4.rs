...
//! Source: drivers/iio/adc/ad4170-4.c
#![no_std]
...
//
pub const AD4170_CONFIG_A_REG: c_uint = 0x00;
pub const AD4170_DATA_24B_REG: c_uint = 0x1E;
pub const AD4170_PIN_MUXING_REG: c_uint = 0x69;
pub const AD4170_CLOCK_CTRL_REG: c_uint = 0x6B;
pub const AD4170_ADC_CTRL_REG: c_uint = 0x71;
pub const AD4170_CHAN_EN_REG: c_uint = 0x79;

pub const AD4170_V_BIAS_REG: c_uint = 0x135;

pub const AD4170_GPIO_MODE_REG: c_uint = 0x191;
pub const AD4170_GPIO_OUTPUT_REG: c_uint = 0x193;
pub const AD4170_GPIO_INPUT_REG: c_uint = 0x195;
pub const AD4170_ADC_CTRL_CONT_READ_EXIT_REG: c_uint = 0x200 /* virtual reg */;
...
pub const AD4170_CLOCK_CTRL_CLOCKSEL_INT: c_uint = 0x0;
pub const AD4170_CLOCK_CTRL_CLOCKSEL_INT_OUT: c_uint = 0x1;
pub const AD4170_CLOCK_CTRL_CLOCKSEL_EXT: c_uint = 0x2;
pub const AD4170_CLOCK_CTRL_CLOCKSEL_EXT_XTAL: c_uint = 0x3;
// AD4170_CHAN_MAP_REG constants

pub const AD4170_CHAN_MAP_TEMP_SENSOR: c_int = 17;
pub const AD4170_CHAN_MAP_AVDD_AVSS_P: c_int = 18;
pub const AD4170_CHAN_MAP_AVDD_AVSS_N: c_int = 18;
pub const AD4170_CHAN_MAP_IOVDD_DGND_P: c_int = 19;
pub const AD4170_CHAN_MAP_IOVDD_DGND_N: c_int = 19;
pub const AD4170_CHAN_MAP_AVSS: c_int = 23;
pub const AD4170_CHAN_MAP_DGND: c_int = 24;
pub const AD4170_CHAN_MAP_REFIN1_P: c_int = 25;
pub const AD4170_CHAN_MAP_REFIN1_N: c_int = 26;
pub const AD4170_CHAN_MAP_REFIN2_P: c_int = 27;
pub const AD4170_CHAN_MAP_REFIN2_N: c_int = 28;
pub const AD4170_CHAN_MAP_REFOUT: c_int = 29;
// AD4170_MISC_REG constants
pub const AD4170_MISC_CHOP_IEXC_PAIR1: c_uint = 0x1;
pub const AD4170_MISC_CHOP_IEXC_PAIR2: c_uint = 0x2;
pub const AD4170_MISC_CHOP_IEXC_BOTH: c_uint = 0x3;
// AD4170_PIN_MUXING_REG constants
pub const AD4170_PIN_MUXING_DIG_AUX1_DISABLED: c_uint = 0x0;
pub const AD4170_PIN_MUXING_DIG_AUX1_RDY: c_uint = 0x1;
// AD4170_ADC_CTRL_REG constants
pub const AD4170_ADC_CTRL_MODE_CONT: c_uint = 0x0;
pub const AD4170_ADC_CTRL_MODE_SINGLE: c_uint = 0x4;
pub const AD4170_ADC_CTRL_MODE_IDLE: c_uint = 0x7;
pub const AD4170_ADC_CTRL_CONT_READ_DISABLE: c_uint = 0x0;
pub const AD4170_ADC_CTRL_CONT_READ_ENABLE: c_uint = 0x1;
// AD4170_FILTER_REG constants
pub const AD4170_FILTER_FILTER_TYPE_SINC5_AVG: c_uint = 0x0;
pub const AD4170_FILTER_FILTER_TYPE_SINC5: c_uint = 0x4;
pub const AD4170_FILTER_FILTER_TYPE_SINC3: c_uint = 0x6;
// AD4170_CURRENT_SRC_REG constants

// AD4170_GPIO_MODE_REG constants
pub const AD4170_GPIO_MODE_GPIO_INPUT: c_int = 1;
pub const AD4170_GPIO_MODE_GPIO_OUTPUT: c_int = 2;
// Device properties and auxiliary constants
pub const AD4170_NUM_ANALOG_PINS: c_int = 9;
pub const AD4170_NUM_GPIO_PINS: c_int = 4;
pub const AD4170_MAX_ADC_CHANNELS: c_int = 16;

pub const AD4170_MAX_ANALOG_PINS: c_int = 8;
pub const AD4170_MAX_SETUPS: c_int = 8;
pub const AD4170_INVALID_SETUP: c_int = 9;
pub const AD4170_SPI_INST_PHASE_LEN: c_int = 2;
pub const AD4170_SPI_MAX_XFER_LEN: c_int = 6;
pub const AD4170_NUM_CURRENT_SRC: c_int = 4;

pub const AD4170_INT_REF_2_5V: c_int = 2500000;
// Internal and external clock properties

pub const AD4170_NUM_PGA_OPTIONS: c_int = 10;
// Digital filter properties
pub const AD4170_SINC3_MIN_FS: c_int = 4;
pub const AD4170_SINC3_MAX_FS: c_int = 65532;
pub const AD4170_SINC5_MIN_FS: c_int = 1;
pub const AD4170_SINC5_MAX_FS: c_int = 256;
pub const AD4170_GAIN_REG_DEFAULT: c_uint = 0x555555;
pub const AD4170_ADC_CTRL_CONT_READ_EXIT: c_uint = 0xA5;
// Analog pin functions
pub const AD4170_PIN_UNASSIGNED: c_uint = 0x00;
pub const AD4170_PIN_ANALOG_IN: c_uint = 0x01;
pub const AD4170_PIN_CURRENT_OUT: c_uint = 0x02;
pub const AD4170_PIN_VBIAS: c_uint = 0x04;
// GPIO pin functions
pub const AD4170_GPIO_UNASSIGNED: c_uint = 0x00;
pub const AD4170_GPIO_AC_EXCITATION: c_uint = 0x02;
pub const AD4170_GPIO_OUTPUT: c_uint = 0x04;
// Current source
pub const AD4170_CURRENT_SRC_DISABLED: c_uint = 0xFF;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4170_setup {
    pub misc: u16,
    pub afe: u16,
    pub filter: u16,
    pub filter_fs: u16,
    pub /: *mut *mut u32 offset; / For calibration purposes,
    pub /: *mut *mut u32 gain; / For calibration purposes,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4170_setup_info {
    pub setup: ad4170_setup,
    pub enabled_channels: c_uint,
    pub channels: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4170_chan_info {
    pub input_range_uv: c_uint,
    pub /: *mut *mut unsigned int setup_num; / Index to access state setup_infos array,
    pub /: *mut *mut ad4170_setup setup; / cached setup,
    pub offset_tbl: [c_int; 10],
    pub scale_tbl: [u32; 10][2],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4170_state {
    pub /: *mut *mut mutex lock; / Protect read-modify-write and multi write sequences,
    pub vrefs_uv: [c_int; AD4170_MAX_SUP],
    pub mclk_hz: u32,
    pub setup_infos: [ad4170_setup_info; AD4170_MAX_SETUPS],
    pub chan_infos: [ad4170_chan_info; AD4170_MAX_ADC_CHANNELS],
    pub completion: completion,
    pub chans: [iio_chan_spec; AD4170_MAX_IIO_CHANNELS],
    pub spi: *mut spi_device,
    pub regmap: *mut regmap,
    pub sps_tbl: [c_int; ARRAY_SIZE(ad4170_filt_names)][AD4170_MAX_FS_TBL_SIZE][2],
    pub bounce_buffer: [__be32; AD4170_MAX_ADC_CHANNELS],
    pub msg: spi_message,
    pub xfer: spi_transfer,
    pub trig: *mut iio_trigger,
    pub int_clk_hw: clk_hw,
    pub clock_ctrl: c_uint,
    pub pins_fn: [c_uint; AD4170_NUM_ANALOG_PINS],
    pub gpio_fn: [c_int; AD4170_NUM_GPIO_PINS],
    pub cur_src_pins: [c_uint; AD4170_NUM_CURRENT_SRC],
    pub gpiochip: gpio_chip,
//
// DMA (thus cache coherency maintenance) requires the transfer buffers
// to live in their own cache lines.
//
    pub __aligned(IIO_DMA_MINALIGN): u8 rx_buf[4],
}

#[no_mangle]
unsafe extern "C" fn ad4170_fill_sps_tbl(st: *mut ad4170_state) {
...
#[no_mangle]
unsafe extern "C" fn ad4170_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
// Write continuous read exit code
    ...
    return spi_write_then_read(st.spi, tx_buf, 1, core::ptr::null_mut(), 0);
    default:
    return -EINVAL;
    }
    return spi_write_then_read(st.spi, tx_buf,
    AD4170_SPI_INST_PHASE_LEN + size, core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn ad4170_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_setup_eq(a: *mut ad4170_setup, b: *mut ad4170_setup) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ad4170_unlink_channel(st: *mut ad4170_state, channel: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ad4170_unlink_setup(st: *mut ad4170_state, setup_num: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ad4170_get_filter_type(filter: c_uint) -> c_int {
    static int __ad4170_get_filter_type(unsigned int filter)
    {
    let mut f_conf: u16 = FIELD_GET(AD4170_FILTER_FILTER_TYPE_MSK, filter);
    switch (f_conf) {
...
//
    ...
    let mut v_diff: c_int = st.vrefs_uv[AD4170_AVDD_SUP] - st.vrefs_uv[AD4170_AVSS_SUP];
...
#[no_mangle]
unsafe extern "C" fn ad4170_validate_analog_input(st: *mut ad4170_state, pin: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_validate_channel_input(st: *mut ad4170_state, pin: c_int, com: bool) -> c_int {
...
//
    ...
    {
    let mut bipolar: bool = chan.scan_type.sign == 's';
    struct device *dev = &st.spi.dev;
...
// val = setup->gain;
    ...
    struct ad4170_chan_info *chan_info = &st.chan_infos[chan.address];
    struct device *dev = &st.spi.dev;
    let mut bipolar: c_int = chan.scan_type.sign == 's' ? 1 : 0;
    let mut precision_bits: c_int = chan.scan_type.realbits;
...
// length = ARRAY_SIZE(ad4170_sinc5_filt_fs_tbl) * 2;
    ...
    struct ad4170_chan_info *chan_info = &st.chan_infos[chan.address];
    struct ad4170_setup *setup = &chan_info.setup;
    let mut f_type: enum ad4170_filter_type = __ad4170_get_filter_type(setup.filter);
...
#[no_mangle]
unsafe extern "C" fn ad4170_soft_reset(st: *mut ad4170_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_gpio_get(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_gpio_set(gc: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_gpio_get_direction(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_gpio_direction_input(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
// Only expose GPIOs that were not assigned any other function.
    for (i = 0; i < ngpios; i++) {
    let mut valid: bool = st.gpio_fn[i] == AD4170_GPIO_UNASSIGNED;
    __assign_bit(i, valid_mask, valid);
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ad4170_gpio_init(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_validate_excitation_pin(st: *mut ad4170_state, pin: u32) -> c_int {
...
// Check the pin is available
    ...
    let mut gpio: c_uint = pin - AD4170_CURRENT_SRC_I_OUT_PIN_GPIO(0);
...
// num_exc_pins = num_pins;
    ...
    int ret;
    for (i = 0; i < num_exc_pins; i++) {
    let mut exc_cur: c_uint = exc_curs[i];
    let mut pin: c_uint = exc_pins[i];
    let mut current_src: c_uint = 0;
...
// Parse pseudo-differential channel configuration
    ...
    {
    struct ad4170_state *st = iio_priv(indio_dev);
    let mut s_type: c_uint = AD4170_ADC_SENSOR;
    struct device *dev = &st.spi.dev;
...
#[no_mangle]
unsafe extern "C" fn ad4170_parse_channels(indio_dev: *mut iio_dev) -> c_int {
...
// Add timestamp channel
    let mut ts_chan: iio_chan_spec = IIO_CHAN_SOFT_TIMESTAMP(chan_num);
...
#[no_mangle]
unsafe extern "C" fn ad4170_clk_output_is_enabled(hw: *mut clk_hw) -> c_int {
    ...
    let mut clk_sel: return = = AD4170_CLOCK_CTRL_CLOCKSEL_INT_OUT;
    }
#[no_mangle]
unsafe extern "C" fn ad4170_clk_output_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_clk_output_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn ad4170_register_clk_provider(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_clock_select(indio_dev: *mut iio_dev) -> c_int {
    ...
    struct clk *ext_clk;
    int ret;
    ext_clk = devm_clk_get_optional_enabled(dev, core::ptr::null_mut());
    if (IS_ERR(ext_clk))
...
#[no_mangle]
unsafe extern "C" fn ad4170_parse_firmware(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_initial_config(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_prepare_spi_message(st: *mut ad4170_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
//
    ...
    {
    let mut masklength: c_uint = iio_get_masklength(indio_dev);
...
#[no_mangle]
unsafe extern "C" fn ad4170_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad4170_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad4170_trigger_setup(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_regulator_setup(st: *mut ad4170_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4170_probe(spi: *mut spi_device) -> c_int {
    ...
    st.regmap = devm_regmap_init(dev, core::ptr::null_mut(), st, &ad4170_regmap_config);
    if (IS_ERR(st.regmap))
