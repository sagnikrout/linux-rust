...
//! Source: drivers/iio/adc/ti-adc108s102.c
#![no_std]
...
//
pub const ADC108S102_VA_MV_ACPI_DEFAULT: c_int = 5000;
//
...
//
pub const ADC108S102_BITS: c_int = 12;
pub const ADC108S102_MAX_CHANNELS: c_int = 8;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adc108s102_state {
    pub spi: *mut spi_device,
    pub va_millivolt: u32,
// SPI transfer used by triggered buffer handler
    pub ring_xfer: spi_transfer,
// SPI transfer used by direct scan
    pub scan_single_xfer: spi_transfer,
...
//
    pub __aligned(IIO_DMA_MINALIGN): __be16 rx_buf[9],
    pub __aligned(IIO_DMA_MINALIGN): __be16 tx_buf[9],
}
...
#[no_mangle]
unsafe extern "C" fn adc108s102_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn adc108s102_scan_direct(st: *mut adc108s102_state, ch: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adc108s102_probe(spi: *mut spi_device) -> c_int {
