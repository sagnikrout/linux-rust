...
//! Source: drivers/iio/adc/ad7606_spi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ad7616_spi_rd_wr_cmd(addr: c_int, is_write_op: c_char) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn ad7606b_spi_rd_wr_cmd(addr: c_int, is_write_op: c_char) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn ad7606_spi_reg_read(st: *mut ad7606_state, addr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7606b_sw_mode_config(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7606_spi_offload_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7606_spi_offload_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
// Use offload ops.
    ...
    struct ad7606_state *st = iio_priv(indio_dev);
    if (st.offload_en) {
    let mut num_adc_ch: c_uint = st.chip_info.num_adc_channels;
//
...
#[no_mangle]
unsafe extern "C" fn ad7606_spi_probe(spi: *mut spi_device) -> c_int {
    static int ad7606_spi_probe(struct spi_device *spi)
    {
    const struct ad7606_bus_info *bus_info = spi_get_device_match_data(spi);
    return ad7606_probe(&spi.dev, spi.irq, core::ptr::null_mut(),
