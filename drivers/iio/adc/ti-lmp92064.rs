...
//! Source: drivers/iio/adc/ti-lmp92064.c
#![no_std]
...
pub const TI_LMP92064_REG_CONFIG_A: c_uint = 0x0000;
pub const TI_LMP92064_REG_CONFIG_B: c_uint = 0x0001;
pub const TI_LMP92064_REG_CHIP_REV: c_uint = 0x0006;
pub const TI_LMP92064_REG_MFR_ID1: c_uint = 0x000C;
pub const TI_LMP92064_REG_MFR_ID2: c_uint = 0x000D;
pub const TI_LMP92064_REG_REG_UPDATE: c_uint = 0x000F;
pub const TI_LMP92064_REG_CONFIG_REG: c_uint = 0x0100;
pub const TI_LMP92064_REG_STATUS: c_uint = 0x0103;
pub const TI_LMP92064_REG_DATA_VOUT_LSB: c_uint = 0x0200;
pub const TI_LMP92064_REG_DATA_VOUT_MSB: c_uint = 0x0201;
pub const TI_LMP92064_REG_DATA_COUT_LSB: c_uint = 0x0202;
pub const TI_LMP92064_REG_DATA_COUT_MSB: c_uint = 0x0203;
pub const TI_LMP92064_VAL_CONFIG_A: c_uint = 0x99;
pub const TI_LMP92064_VAL_CONFIG_B: c_uint = 0x00;
pub const TI_LMP92064_VAL_STATUS_OK: c_uint = 0x01;
//
// Channel number definitions for the two channels of the device
// - IN Current (INC)
// - IN Voltage (INV)
//
pub const TI_LMP92064_CHAN_INC: c_int = 0;
pub const TI_LMP92064_CHAN_INV: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lmp92064_adc_priv {
    pub shunt_resistor_uohm: c_int,
...
#[no_mangle]
unsafe extern "C" fn lmp92064_read_meas(priv: *mut lmp92064_adc_priv, res: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmp92064_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn lmp92064_adc_probe(spi: *mut spi_device) -> c_int {
...
//
    ...
    lmp92064_trigger_handler, core::ptr::null_mut());
    if (ret)
