...
//! Source: drivers/iio/adc/ti-ads131m02.c
#![no_std]
...
pub const ADS131M_MAX_CHANNELS: c_int = 8;
// Section 6.7, t_REGACQ (min time after reset) is 5us
pub const ADS131M_RESET_DELAY_US: c_int = 5;
pub const ADS131M_WORD_SIZE_BYTES: c_int = 3;
pub const ADS131M_RESPONSE_WORDS: c_int = 1;
pub const ADS131M_CRC_WORDS: c_int = 1;
//
...
pub const ADS131M_CMD_NULL: c_uint = 0x0000;
pub const ADS131M_CMD_RESET: c_uint = 0x0011;

pub const ADS131M_CMD_RREG_OP: c_uint = 0xa000;
pub const ADS131M_CMD_WREG_OP: c_uint = 0x6000;
...
pub const ADS131M_REG_MODE: c_uint = 0x02;

pub const ADS131M_REG_CLOCK: c_uint = 0x03;

// 1.2V internal reference, in millivolts, for IIO_VAL_FRACTIONAL_LOG2
pub const ADS131M_VREF_INTERNAL_mV: c_int = 1200;
// 24-bit resolution
pub const ADS131M_RESOLUTION_BITS: c_int = 24;
// Signed data uses (RESOLUTION_BITS - 1) magnitude bits

// External ref FSR = Vref * 0.96
pub const ADS131M_EXTREF_SCALE_NUM: c_int = 96;
pub const ADS131M_EXTREF_SCALE_DEN: c_int = 100;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads131m_configuration {
    pub channels: *const iio_chan_spec,
    pub name: *const c_char,
    pub reset_ack: u16,
    pub num_channels: u8,
    pub supports_extref:1: u8,
    pub supports_xtal:1: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads131m_priv {
    pub indio_dev: *mut iio_dev,
    pub spi: *mut spi_device,
    pub config: *const ads131m_configuration,
    pub use_external_ref: bool,
    pub scale_val: c_int,
    pub scale_val2: c_int,
...
// DMA-safe buffers should be placed at the end of the struct.
    ...
    pub rx_buffer: [u8; ADS131M_FRAME_BYTES(ADS131M_MAX_CHANNELS)],
}
...
//
#[no_mangle]
unsafe extern "C" fn ads131m_tx_frame_unlocked(priv: *mut ads131m_priv, command: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ads131m_rx_frame_unlocked(priv: *mut ads131m_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ads131m_check_status_crc_err(priv: *mut ads131m_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ads131m_write_reg_unlocked(priv: *mut ads131m_priv, reg: u8, val: u16) -> c_int {
    static int ads131m_write_reg_unlocked(struct ads131m_priv *priv, u8 reg, u16 val)
    {
    struct iio_dev *indio_dev = priv.indio_dev;
    u16 command, expected_ack, response, crc;
    struct device *dev = &priv.spi.dev;
    let mut ret_crc_err: c_int = 0;
    int ret;
    lockdep_assert_held(&priv.lock);
...
//
#[no_mangle]
unsafe extern "C" fn ads131m_read_reg_unlocked(priv: *mut ads131m_priv, reg: u8, val: *mut u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ads131m_rmw_reg(priv: *mut ads131m_priv, reg: u8, clear: u16, set: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ads131m_verify_output_crc(priv: *mut ads131m_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ads131m_adc_read(priv: *mut ads131m_priv, channel: u8, val: *mut i32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ads131m_prepare_message(priv: *mut ads131m_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ads131m_sw_reset(priv: *mut ads131m_priv) -> c_int {
    static int ads131m_sw_reset(struct ads131m_priv *priv)
    {
    let mut expected_ack: u16 = priv.config.reset_ack;
    struct device *dev = &priv.spi.dev;
    u16 response;
    int ret;
    guard(mutex)(&priv.lock);
...
//
#[no_mangle]
unsafe extern "C" fn ads131m_reset(priv: *mut ads131m_priv, rstc: *mut reset_control) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads131m_power_init(priv: *mut ads131m_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ads131m_parse_clock(priv: *mut ads131m_priv, is_xtal: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads131m_probe(spi: *mut spi_device) -> c_int {
