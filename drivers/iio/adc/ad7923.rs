...
//! Source: drivers/iio/adc/ad7923.c
#![no_std]
...
pub const AD7923_SHIFT_REGISTER: c_int = 4;
// val = value, dec = left shift, bits = number of bits of the mask

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7923_state {
    pub spi: *mut spi_device,
    pub ring_xfer: [spi_transfer; 9],
    pub scan_single_xfer: [spi_transfer; 2],
...
#[no_mangle]
unsafe extern "C" fn ad7923_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad7923_scan_direct(st: *mut ad7923_state, ch: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7923_get_range(st: *mut ad7923_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7923_regulator_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ad7923_probe(spi: *mut spi_device) -> c_int {
    static int ad7923_probe(struct spi_device *spi)
    {
    let mut ad7923_range: u32 = AD7923_RANGE;
...
// Setup default message
    ...
    &ad7923_trigger_handler, core::ptr::null_mut());
    if (ret)
    return ret;
