...
//! Source: drivers/iio/adc/lpc32xx_adc.c
#![no_std]
...
pub const LPC32XXAD_REFm: c_uint = 0x00000200;
// constant, always write this value!
pub const LPC32XXAD_REFp: c_uint = 0x00000080;
// multiple of this is the channel number: 0, 1, 2
pub const LPC32XXAD_IN: c_uint = 0x00000010;
// constant, always write this value!
pub const LPC32XXAD_INTERNAL: c_uint = 0x00000004;
// Bit definitions for LPC32XXAD_CTRL:
pub const LPC32XXAD_STROBE: c_uint = 0x00000002;
pub const LPC32XXAD_PDN_CTRL: c_uint = 0x00000004;
// Bit definitions for LPC32XXAD_VALUE:
pub const LPC32XXAD_VALUE_MASK: c_uint = 0x000003FF;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc32xx_adc_state {
    pub adc_base: *mut void __iomem,
    pub clk: *mut clk,
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_adc_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_adc_probe(pdev: *mut platform_device) -> c_int {
    static int lpc32xx_adc_probe(struct platform_device *pdev)
    {
    struct lpc32xx_adc_state *st = core::ptr::null_mut();
    struct resource *res;
    let mut retval: c_int = -ENODEV;
    struct iio_dev *iodev = core::ptr::null_mut();
    int irq;
    ...
    st.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(st.clk)) {
