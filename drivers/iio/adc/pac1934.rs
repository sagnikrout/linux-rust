...
//! Source: drivers/iio/adc/pac1934.c
#![no_std]
...
//
pub const PAC1934_MAX_RFSH_LIMIT_MS: c_int = 60000;
// 50msec is the timeout for validity of the cached registers
pub const PAC1934_MIN_POLLING_TIME_MS: c_int = 50;
//
// 1000usec is the minimum wait time for normal conversions when sample
// rate doesn't change
//
pub const PAC1934_MIN_UPDATE_WAIT_TIME_US: c_int = 1000;
// 32000mV
pub const PAC1934_VOLTAGE_MILLIVOLTS_MAX: c_int = 32000;
// voltage bits resolution when set for unsigned values
pub const PAC1934_VOLTAGE_U_RES: c_int = 16;
// voltage bits resolution when set for signed values
pub const PAC1934_VOLTAGE_S_RES: c_int = 15;
//
...
pub const PAC1934_MAX_NUM_CHANNELS: c_int = 4;
pub const PAC1934_MEAS_REG_LEN: c_int = 76;
pub const PAC1934_CTRL_REG_LEN: c_int = 12;
pub const PAC1934_DEFAULT_CHIP_SAMP_SPEED_HZ: c_int = 1024;
// I2C address map
pub const PAC1934_REFRESH_REG_ADDR: c_uint = 0x00;
pub const PAC1934_CTRL_REG_ADDR: c_uint = 0x01;
pub const PAC1934_ACC_COUNT_REG_ADDR: c_uint = 0x02;
pub const PAC1934_VPOWER_ACC_1_ADDR: c_uint = 0x03;
pub const PAC1934_VPOWER_ACC_2_ADDR: c_uint = 0x04;
pub const PAC1934_VPOWER_ACC_3_ADDR: c_uint = 0x05;
pub const PAC1934_VPOWER_ACC_4_ADDR: c_uint = 0x06;
pub const PAC1934_VBUS_1_ADDR: c_uint = 0x07;
pub const PAC1934_VBUS_2_ADDR: c_uint = 0x08;
pub const PAC1934_VBUS_3_ADDR: c_uint = 0x09;
pub const PAC1934_VBUS_4_ADDR: c_uint = 0x0A;
pub const PAC1934_VSENSE_1_ADDR: c_uint = 0x0B;
pub const PAC1934_VSENSE_2_ADDR: c_uint = 0x0C;
pub const PAC1934_VSENSE_3_ADDR: c_uint = 0x0D;
pub const PAC1934_VSENSE_4_ADDR: c_uint = 0x0E;
pub const PAC1934_VBUS_AVG_1_ADDR: c_uint = 0x0F;
pub const PAC1934_VBUS_AVG_2_ADDR: c_uint = 0x10;
pub const PAC1934_VBUS_AVG_3_ADDR: c_uint = 0x11;
pub const PAC1934_VBUS_AVG_4_ADDR: c_uint = 0x12;
pub const PAC1934_VSENSE_AVG_1_ADDR: c_uint = 0x13;
pub const PAC1934_VSENSE_AVG_2_ADDR: c_uint = 0x14;
pub const PAC1934_VSENSE_AVG_3_ADDR: c_uint = 0x15;
pub const PAC1934_VSENSE_AVG_4_ADDR: c_uint = 0x16;
pub const PAC1934_VPOWER_1_ADDR: c_uint = 0x17;
pub const PAC1934_VPOWER_2_ADDR: c_uint = 0x18;
pub const PAC1934_VPOWER_3_ADDR: c_uint = 0x19;
pub const PAC1934_VPOWER_4_ADDR: c_uint = 0x1A;
pub const PAC1934_REFRESH_V_REG_ADDR: c_uint = 0x1F;
pub const PAC1934_SLOW_REG_ADDR: c_uint = 0x20;
pub const PAC1934_CTRL_STAT_REGS_ADDR: c_uint = 0x1C;
pub const PAC1934_PID_REG_ADDR: c_uint = 0xFD;
pub const PAC1934_MID_REG_ADDR: c_uint = 0xFE;
pub const PAC1934_RID_REG_ADDR: c_uint = 0xFF;
// PRODUCT ID REGISTER + MANUFACTURER ID REGISTER + REVISION ID REGISTER
pub const PAC1934_ID_REG_LEN: c_int = 3;
pub const PAC1934_PID_IDX: c_int = 0;
pub const PAC1934_MID_IDX: c_int = 1;
pub const PAC1934_RID_IDX: c_int = 2;
pub const PAC1934_ACPI_GET_NAMES_AND_MOHMS_VALS: c_int = 1;
pub const PAC1934_ACPI_GET_UOHMS_VALS: c_int = 2;
pub const PAC1934_ACPI_GET_BIPOLAR_SETTINGS: c_int = 4;
pub const PAC1934_ACPI_GET_SAMP: c_int = 5;
pub const PAC1934_SAMPLE_RATE_SHIFT: c_int = 6;
pub const PAC1934_VBUS_SENSE_REG_LEN: c_int = 2;
pub const PAC1934_ACC_REG_LEN: c_int = 3;
pub const PAC1934_VPOWER_REG_LEN: c_int = 4;
pub const PAC1934_VPOWER_ACC_REG_LEN: c_int = 6;
pub const PAC1934_MAX_REGISTER_LENGTH: c_int = 6;
pub const PAC1934_CUSTOM_ATTR_FOR_CHANNEL: c_int = 1;
//
...
//
pub const PAC1934_CHANNEL_DIS_REG_OFF: c_int = 0;
pub const PAC1934_NEG_PWR_REG_OFF: c_int = 1;
//
...
//
pub const PAC1934_SLOW_REG_OFF: c_int = 2;
pub const PAC1934_CTRL_ACT_REG_OFF: c_int = 3;
pub const PAC1934_CHANNEL_DIS_ACT_REG_OFF: c_int = 4;
pub const PAC1934_NEG_PWR_ACT_REG_OFF: c_int = 5;
pub const PAC1934_CTRL_LAT_REG_OFF: c_int = 6;
pub const PAC1934_CHANNEL_DIS_LAT_REG_OFF: c_int = 7;
pub const PAC1934_NEG_PWR_LAT_REG_OFF: c_int = 8;
pub const PAC1934_PID_REG_OFF: c_int = 9;
pub const PAC1934_MID_REG_OFF: c_int = 10;
pub const PAC1934_REV_REG_OFF: c_int = 11;
pub const PAC1934_CTRL_STATUS_INFO_LEN: c_int = 12;
pub const PAC1934_MID: c_uint = 0x5D;
pub const PAC1931_PID: c_uint = 0x58;
pub const PAC1932_PID: c_uint = 0x59;
pub const PAC1933_PID: c_uint = 0x5A;
pub const PAC1934_PID: c_uint = 0x5B;
// Scale constant = (10^3 * 3.2 * 10^9 / 2^28) for mili Watt-second
pub const PAC1934_SCALE_CONSTANT: c_int = 11921;
pub const PAC1934_MAX_VPOWER_RSHIFTED_BY_28B: c_int = 11921;
pub const PAC1934_MAX_VSENSE_RSHIFTED_BY_16B: c_int = 1525;
...
#[derive(Copy, Clone)]
pub struct reg_data {
    pub meas_regs: [u8; PAC1934_MEAS_REG_LEN],
    pub ctrl_regs: [u8; PAC1934_CTRL_REG_LEN],
    pub energy_sec_acc: [i64; PAC1934_MAX_NUM_CHANNELS],
    pub vpower_acc: [i64; PAC1934_MAX_NUM_CHANNELS],
    pub vpower: [i32; PAC1934_MAX_NUM_CHANNELS],
    pub vbus: [i32; PAC1934_MAX_NUM_CHANNELS],
    pub vbus_avg: [i32; PAC1934_MAX_NUM_CHANNELS],
    pub vsense: [i32; PAC1934_MAX_NUM_CHANNELS],
    pub vsense_avg: [i32; PAC1934_MAX_NUM_CHANNELS],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pac1934_chip_info {
    pub client: *mut i2c_client,
    pub /: *mut *mut mutex lock; / synchronize access to driver's state members,
    pub work_chip_rfsh: delayed_work,
    pub phys_channels: u8,
    pub active_channels: [bool; PAC1934_MAX_NUM_CHANNELS],
    pub enable_energy: [bool; PAC1934_MAX_NUM_CHANNELS],
    pub bi_dir: [bool; PAC1934_MAX_NUM_CHANNELS],
    pub chip_variant: u8,
    pub chip_revision: u8,
    pub shunts: [u32; PAC1934_MAX_NUM_CHANNELS],
    pub chip_reg_data: reg_data,
    pub sample_rate_value: i32,
    pub labels: [*mut c_char; PAC1934_MAX_NUM_CHANNELS],
...
// this function only sends REFRESH or REFRESH_V
    ...
    int ret;
    u8 bidir_reg;
    let mut revision_bug: bool = false;
...
#[no_mangle]
unsafe extern "C" fn pac1934_work_periodic_rfsh(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pac1934_read_revision(info: *mut pac1934_chip_info, buf: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pac1934_chip_identify(info: *mut pac1934_chip_info) -> c_int {
...
//
    ...
    rez = acpi_evaluate_dsm(handle, &guid, 0, PAC1934_ACPI_GET_NAMES_AND_MOHMS_VALS, core::ptr::null_mut());
    if (!rez)
    return -EINVAL;
    ...
    ACPI_FREE(rez);
    rez = acpi_evaluate_dsm(handle, &guid, 1, PAC1934_ACPI_GET_UOHMS_VALS, core::ptr::null_mut());
    if (!rez) {
//
...
//
    ...
    ACPI_FREE(rez);
    rez = acpi_evaluate_dsm(handle, &guid, 1, PAC1934_ACPI_GET_BIPOLAR_SETTINGS, core::ptr::null_mut());
    if (!rez)
    return -EINVAL;
    ...
    ACPI_FREE(rez);
    rez = acpi_evaluate_dsm(handle, &guid, 1, PAC1934_ACPI_GET_SAMP, core::ptr::null_mut());
    if (!rez)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn pac1934_cancel_delayed_work(dwork: *mut c_void) {
    static void pac1934_cancel_delayed_work(void *dwork)
    {
    cancel_delayed_work_sync(dwork);
    }
#[no_mangle]
unsafe extern "C" fn pac1934_chip_configure(info: *mut pac1934_chip_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pac1934_prep_iio_channels(info: *mut pac1934_chip_info, indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pac1934_probe(client: *mut i2c_client) -> c_int {
