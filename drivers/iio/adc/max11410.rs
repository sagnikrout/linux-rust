...
//! Source: drivers/iio/adc/max11410.c
#![no_std]
...
pub const MAX11410_REG_CONV_START: c_uint = 0x01;
pub const MAX11410_CONV_TYPE_SINGLE: c_uint = 0x00;
pub const MAX11410_CONV_TYPE_CONTINUOUS: c_uint = 0x01;
pub const MAX11410_REG_CAL_START: c_uint = 0x03;
pub const MAX11410_CAL_START_SELF: c_uint = 0x00;
pub const MAX11410_CAL_START_PGA: c_uint = 0x01;

pub const MAX11410_GPIO_INTRB: c_uint = 0xC1;
pub const MAX11410_REG_FILTER: c_uint = 0x08;

pub const MAX11410_FILTER_RATE_MAX: c_uint = 0x0F;

pub const MAX11410_REG_CTRL: c_uint = 0x09;

pub const MAX11410_REG_MUX_CTRL0: c_uint = 0x0B;
pub const MAX11410_REG_PGA: c_uint = 0x0E;

pub const MAX11410_PGA_SIG_PATH_BUFFERED: c_uint = 0x00;
pub const MAX11410_PGA_SIG_PATH_BYPASS: c_uint = 0x01;
pub const MAX11410_PGA_SIG_PATH_PGA: c_uint = 0x02;
pub const MAX11410_REG_DATA0: c_uint = 0x30;
pub const MAX11410_REG_STATUS: c_uint = 0x38;

pub const MAX11410_REFSEL_AVDD_AGND: c_uint = 0x03;
pub const MAX11410_REFSEL_MAX: c_uint = 0x06;
pub const MAX11410_SIG_PATH_MAX: c_uint = 0x02;
pub const MAX11410_CHANNEL_INDEX_MAX: c_uint = 0x0A;
pub const MAX11410_AINP_AVDD: c_uint = 0x0A;
pub const MAX11410_AINN_GND: c_uint = 0x0A;
pub const MAX11410_CONVERSION_TIMEOUT_MS: c_int = 2000;
pub const MAX11410_CALIB_TIMEOUT_MS: c_int = 2000;
pub const MAX11410_SCALE_AVAIL_SIZE: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max11410_channel_config {
    pub settling_time_us: u32,
    pub scale_avail: *mut u32,
    pub refsel: u8,
    pub sig_path: u8,
    pub gain: u8,
    pub bipolar: bool,
    pub buffered_vrefp: bool,
    pub buffered_vrefn: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct max11410_state {
    pub spi_dev: *mut spi_device,
    pub trig: *mut iio_trigger,
    pub completion: completion,
    pub /: *mut *mut mutex lock; / Prevent changing channel config during sampling,
    pub regmap: *mut regmap,
    pub avdd: *mut regulator,
    pub vrefp: [*mut regulator; 3],
    pub vrefn: [*mut regulator; 3],
    pub channels: *mut max11410_channel_config,
    pub irq: c_int,
    struct {
    pub __aligned(IIO_DMA_MINALIGN): u32 data,
    pub ts: aligned_s64,
    pub scan: },
}
...
#[no_mangle]
unsafe extern "C" fn max11410_reg_size(reg: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn max11410_set_input_mux(st: *mut max11410_state, ainp: u8, ainn: u8) -> c_int {
    ...
    {
    let mut cfg: max11410_channel_config = st.channels[chan.address];
    unsigned int regval;
    int ret;
...
// Read ADC Data
    ...
    {
    struct max11410_state *state = iio_priv(indio_dev);
    let mut cfg: max11410_channel_config = state.channels[chan.address];
...
#[no_mangle]
unsafe extern "C" fn max11410_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max11410_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max11410_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max11410_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    {
    let mut chanspec: iio_chan_spec = chanspec_template;
...
#[no_mangle]
unsafe extern "C" fn max11410_disable_reg(reg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn max11410_calibrate(st: *mut max11410_state, cal_type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max11410_self_calibrate(st: *mut max11410_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max11410_probe(spi: *mut spi_device) -> c_int {
...
//
    ...
    if (ret)
    return ret;
    ret = devm_request_threaded_irq(dev, st.irq, core::ptr::null_mut(),
    &max11410_interrupt,
