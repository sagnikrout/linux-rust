...
//! Source: drivers/iio/adc/qcom-spmi-rradc.c
#![no_std]
...
pub const RR_ADC_EN_CTL: c_uint = 0x46;
pub const RR_ADC_SKIN_TEMP_LSB: c_uint = 0x50;
pub const RR_ADC_SKIN_TEMP_MSB: c_uint = 0x51;
pub const RR_ADC_CTL: c_uint = 0x52;

pub const RR_ADC_LOG: c_uint = 0x53;

pub const RR_ADC_FAKE_BATT_LOW_LSB: c_uint = 0x58;
pub const RR_ADC_FAKE_BATT_LOW_MSB: c_uint = 0x59;
pub const RR_ADC_FAKE_BATT_HIGH_LSB: c_uint = 0x5A;
pub const RR_ADC_FAKE_BATT_HIGH_MSB: c_uint = 0x5B;
pub const RR_ADC_BATT_ID_CTRL: c_uint = 0x60;

pub const RR_ADC_BATT_ID_TRIGGER: c_uint = 0x61;
pub const RR_ADC_BATT_ID_STS: c_uint = 0x62;
pub const RR_ADC_BATT_ID_CFG: c_uint = 0x63;

pub const RR_ADC_BATT_ID_5_LSB: c_uint = 0x66;
pub const RR_ADC_BATT_ID_5_MSB: c_uint = 0x67;
pub const RR_ADC_BATT_ID_15_LSB: c_uint = 0x68;
pub const RR_ADC_BATT_ID_15_MSB: c_uint = 0x69;
pub const RR_ADC_BATT_ID_150_LSB: c_uint = 0x6A;
pub const RR_ADC_BATT_ID_150_MSB: c_uint = 0x6B;
pub const RR_ADC_BATT_THERM_CTRL: c_uint = 0x70;
pub const RR_ADC_BATT_THERM_TRIGGER: c_uint = 0x71;
pub const RR_ADC_BATT_THERM_STS: c_uint = 0x72;
pub const RR_ADC_BATT_THERM_CFG: c_uint = 0x73;
pub const RR_ADC_BATT_THERM_LSB: c_uint = 0x74;
pub const RR_ADC_BATT_THERM_MSB: c_uint = 0x75;
pub const RR_ADC_BATT_THERM_FREQ: c_uint = 0x76;
pub const RR_ADC_AUX_THERM_CTRL: c_uint = 0x80;
pub const RR_ADC_AUX_THERM_TRIGGER: c_uint = 0x81;
pub const RR_ADC_AUX_THERM_STS: c_uint = 0x82;
pub const RR_ADC_AUX_THERM_CFG: c_uint = 0x83;
pub const RR_ADC_AUX_THERM_LSB: c_uint = 0x84;
pub const RR_ADC_AUX_THERM_MSB: c_uint = 0x85;
pub const RR_ADC_SKIN_HOT: c_uint = 0x86;
pub const RR_ADC_SKIN_TOO_HOT: c_uint = 0x87;
pub const RR_ADC_AUX_THERM_C1: c_uint = 0x88;
pub const RR_ADC_AUX_THERM_C2: c_uint = 0x89;
pub const RR_ADC_AUX_THERM_C3: c_uint = 0x8A;
pub const RR_ADC_AUX_THERM_HALF_RANGE: c_uint = 0x8B;
pub const RR_ADC_USB_IN_V_CTRL: c_uint = 0x90;
pub const RR_ADC_USB_IN_V_TRIGGER: c_uint = 0x91;
pub const RR_ADC_USB_IN_V_STS: c_uint = 0x92;
pub const RR_ADC_USB_IN_V_LSB: c_uint = 0x94;
pub const RR_ADC_USB_IN_V_MSB: c_uint = 0x95;
pub const RR_ADC_USB_IN_I_CTRL: c_uint = 0x98;
pub const RR_ADC_USB_IN_I_TRIGGER: c_uint = 0x99;
pub const RR_ADC_USB_IN_I_STS: c_uint = 0x9A;
pub const RR_ADC_USB_IN_I_LSB: c_uint = 0x9C;
pub const RR_ADC_USB_IN_I_MSB: c_uint = 0x9D;
pub const RR_ADC_DC_IN_V_CTRL: c_uint = 0xA0;
pub const RR_ADC_DC_IN_V_TRIGGER: c_uint = 0xA1;
pub const RR_ADC_DC_IN_V_STS: c_uint = 0xA2;
pub const RR_ADC_DC_IN_V_LSB: c_uint = 0xA4;
pub const RR_ADC_DC_IN_V_MSB: c_uint = 0xA5;
pub const RR_ADC_DC_IN_I_CTRL: c_uint = 0xA8;
pub const RR_ADC_DC_IN_I_TRIGGER: c_uint = 0xA9;
pub const RR_ADC_DC_IN_I_STS: c_uint = 0xAA;
pub const RR_ADC_DC_IN_I_LSB: c_uint = 0xAC;
pub const RR_ADC_DC_IN_I_MSB: c_uint = 0xAD;
pub const RR_ADC_PMI_DIE_TEMP_CTRL: c_uint = 0xB0;
pub const RR_ADC_PMI_DIE_TEMP_TRIGGER: c_uint = 0xB1;
pub const RR_ADC_PMI_DIE_TEMP_STS: c_uint = 0xB2;
pub const RR_ADC_PMI_DIE_TEMP_CFG: c_uint = 0xB3;
pub const RR_ADC_PMI_DIE_TEMP_LSB: c_uint = 0xB4;
pub const RR_ADC_PMI_DIE_TEMP_MSB: c_uint = 0xB5;
pub const RR_ADC_CHARGER_TEMP_CTRL: c_uint = 0xB8;
pub const RR_ADC_CHARGER_TEMP_TRIGGER: c_uint = 0xB9;
pub const RR_ADC_CHARGER_TEMP_STS: c_uint = 0xBA;
pub const RR_ADC_CHARGER_TEMP_CFG: c_uint = 0xBB;
pub const RR_ADC_CHARGER_TEMP_LSB: c_uint = 0xBC;
pub const RR_ADC_CHARGER_TEMP_MSB: c_uint = 0xBD;
pub const RR_ADC_CHARGER_HOT: c_uint = 0xBE;
pub const RR_ADC_CHARGER_TOO_HOT: c_uint = 0xBF;
pub const RR_ADC_GPIO_CTRL: c_uint = 0xC0;
pub const RR_ADC_GPIO_TRIGGER: c_uint = 0xC1;
pub const RR_ADC_GPIO_STS: c_uint = 0xC2;
pub const RR_ADC_GPIO_LSB: c_uint = 0xC4;
pub const RR_ADC_GPIO_MSB: c_uint = 0xC5;
pub const RR_ADC_ATEST_CTRL: c_uint = 0xC8;
pub const RR_ADC_ATEST_TRIGGER: c_uint = 0xC9;
pub const RR_ADC_ATEST_STS: c_uint = 0xCA;
pub const RR_ADC_ATEST_LSB: c_uint = 0xCC;
pub const RR_ADC_ATEST_MSB: c_uint = 0xCD;
pub const RR_ADC_SEC_ACCESS: c_uint = 0xD0;
pub const RR_ADC_PERPH_RESET_CTL2: c_uint = 0xD9;
pub const RR_ADC_PERPH_RESET_CTL3: c_uint = 0xDA;
pub const RR_ADC_PERPH_RESET_CTL4: c_uint = 0xDB;
pub const RR_ADC_INT_TEST1: c_uint = 0xE0;
pub const RR_ADC_INT_TEST_VAL: c_uint = 0xE1;
pub const RR_ADC_TM_TRIGGER_CTRLS: c_uint = 0xE2;
pub const RR_ADC_TM_ADC_CTRLS: c_uint = 0xE3;
pub const RR_ADC_TM_CNL_CTRL: c_uint = 0xE4;
pub const RR_ADC_TM_BATT_ID_CTRL: c_uint = 0xE5;
pub const RR_ADC_TM_THERM_CTRL: c_uint = 0xE6;
pub const RR_ADC_TM_CONV_STS: c_uint = 0xE7;
pub const RR_ADC_TM_ADC_READ_LSB: c_uint = 0xE8;
pub const RR_ADC_TM_ADC_READ_MSB: c_uint = 0xE9;
pub const RR_ADC_TM_ATEST_MUX_1: c_uint = 0xEA;
pub const RR_ADC_TM_ATEST_MUX_2: c_uint = 0xEB;
pub const RR_ADC_TM_REFERENCES: c_uint = 0xED;
pub const RR_ADC_TM_MISC_CTL: c_uint = 0xEE;
pub const RR_ADC_TM_RR_CTRL: c_uint = 0xEF;

pub const RR_ADC_BATT_ID_RANGE: c_int = 820;
pub const RR_ADC_BITS: c_int = 10;

pub const RR_ADC_FS_VOLTAGE_MV: c_int = 2500;
// BATT_THERM 0.25K/LSB
pub const RR_ADC_BATT_THERM_LSB_K: c_int = 4;
pub const RR_ADC_TEMP_FS_VOLTAGE_NUM: c_int = 5000000;
pub const RR_ADC_TEMP_FS_VOLTAGE_DEN: c_int = 3;
pub const RR_ADC_DIE_TEMP_OFFSET: c_int = 601400;
pub const RR_ADC_DIE_TEMP_SLOPE: c_int = 2;
pub const RR_ADC_DIE_TEMP_OFFSET_MILLI_DEGC: c_int = 25000;
pub const RR_ADC_CHG_TEMP_GF_OFFSET_UV: c_int = 1303168;
pub const RR_ADC_CHG_TEMP_GF_SLOPE_UV_PER_C: c_int = 3784;
pub const RR_ADC_CHG_TEMP_SMIC_OFFSET_UV: c_int = 1338433;
pub const RR_ADC_CHG_TEMP_SMIC_SLOPE_UV_PER_C: c_int = 3655;
pub const RR_ADC_CHG_TEMP_660_GF_OFFSET_UV: c_int = 1309001;
pub const RR_ADC_CHG_TEMP_660_GF_SLOPE_UV_PER_C: c_int = 3403;
pub const RR_ADC_CHG_TEMP_660_SMIC_OFFSET_UV: c_int = 1295898;
pub const RR_ADC_CHG_TEMP_660_SMIC_SLOPE_UV_PER_C: c_int = 3596;
pub const RR_ADC_CHG_TEMP_660_MGNA_OFFSET_UV: c_int = 1314779;
pub const RR_ADC_CHG_TEMP_660_MGNA_SLOPE_UV_PER_C: c_int = 3496;
pub const RR_ADC_CHG_TEMP_OFFSET_MILLI_DEGC: c_int = 25000;
pub const RR_ADC_CHG_THRESHOLD_SCALE: c_int = 4;
pub const RR_ADC_VOLT_INPUT_FACTOR: c_int = 8;
pub const RR_ADC_CURR_INPUT_FACTOR: c_int = 2000;
pub const RR_ADC_CURR_USBIN_INPUT_FACTOR_MIL: c_int = 1886;
pub const RR_ADC_CURR_USBIN_660_FACTOR_MIL: c_int = 9;
pub const RR_ADC_CURR_USBIN_660_UV_VAL: c_int = 579500;
pub const RR_ADC_GPIO_FS_RANGE: c_int = 5000;
pub const RR_ADC_COHERENT_CHECK_RETRY: c_int = 5;
pub const RR_ADC_CHAN_MAX_CONTINUOUS_BUFFER_LEN: c_int = 16;

pub const RR_ADC_TP_REV_VERSION1: c_int = 21;
pub const RR_ADC_TP_REV_VERSION2: c_int = 29;
pub const RR_ADC_TP_REV_VERSION3: c_int = 32;
pub const RRADC_BATT_ID_DELAY_MAX: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rradc_channel {
    pub label: *const c_char,
    pub lsb: u8,
    pub status: u8,
    pub size: c_int,
    pub trigger_addr: c_int,
    pub trigger_mask: c_int,
    pub result): *mut *mut *mut int (scale_fn)(struct rradc_chip chip, u16 adc_code, int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rradc_chip {
    pub dev: *mut device,
    pub pmic: *const qcom_spmi_pmic,
//
// Lock held while doing channel conversion
// involving multiple register read/writes
//
    pub conversion_lock: mutex,
    pub regmap: *mut regmap,
    pub base: u32,
    pub batt_id_delay: c_int,
    pub batt_id_data: u16,
}
...
#[no_mangle]
unsafe extern "C" fn rradc_read(chip: *mut rradc_chip, addr: u16, buf: *mut __le16, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rradc_enable_continuous_mode(chip: *mut rradc_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rradc_disable_continuous_mode(chip: *mut rradc_chip) -> c_int {
...
//
    ...
    let mut batt_id_150: u16 = le16_to_cpu(buf[2]);
    let mut batt_id_15: u16 = le16_to_cpu(buf[1]);
    let mut batt_id_5: u16 = le16_to_cpu(buf[0]);
...
#[no_mangle]
unsafe extern "C" fn rradc_read_offset(chip: *mut rradc_chip, chan_address: c_int, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rradc_probe(pdev: *mut platform_device) -> c_int {
