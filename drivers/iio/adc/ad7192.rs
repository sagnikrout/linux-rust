...
//! Source: drivers/iio/adc/ad7192.c
#![no_std]
...
pub const AD7193_CH_AIN1P_AIN2M: c_uint = 0x001  /* AIN1(+) - AIN2(-) */;
pub const AD7193_CH_AIN3P_AIN4M: c_uint = 0x002  /* AIN3(+) - AIN4(-) */;
pub const AD7193_CH_AIN5P_AIN6M: c_uint = 0x004  /* AIN5(+) - AIN6(-) */;
pub const AD7193_CH_AIN7P_AIN8M: c_uint = 0x008  /* AIN7(+) - AIN8(-) */;
pub const AD7193_CH_TEMP: c_uint = 0x100 /* Temp senseor */;
pub const AD7193_CH_AIN2P_AIN2M: c_uint = 0x200 /* AIN2(+) - AIN2(-) */;
pub const AD7193_CH_AIN1: c_uint = 0x401 /* AIN1 - AINCOM */;
pub const AD7193_CH_AIN2: c_uint = 0x402 /* AIN2 - AINCOM */;
pub const AD7193_CH_AIN3: c_uint = 0x404 /* AIN3 - AINCOM */;
pub const AD7193_CH_AIN4: c_uint = 0x408 /* AIN4 - AINCOM */;
pub const AD7193_CH_AIN5: c_uint = 0x410 /* AIN5 - AINCOM */;
pub const AD7193_CH_AIN6: c_uint = 0x420 /* AIN6 - AINCOM */;
pub const AD7193_CH_AIN7: c_uint = 0x440 /* AIN7 - AINCOM */;
pub const AD7193_CH_AIN8: c_uint = 0x480 /* AIN7 - AINCOM */;
pub const AD7193_CH_AINCOM: c_uint = 0x600 /* AINCOM - AINCOM */;

// 10th bit corresponds to CON18(Pseudo)

pub const AD7194_CH_TEMP: c_uint = 0x100;
pub const AD7194_CH_BASE_NR: c_int = 2;
pub const AD7194_CH_AIN_START: c_int = 1;
pub const AD7194_CH_AIN_NR: c_int = 16;
pub const AD7194_CH_MAX_NR: c_int = 272;
// ID Register Bit Designations (AD7192_REG_ID)
pub const CHIPID_AD7190: c_uint = 0x4;
pub const CHIPID_AD7192: c_uint = 0x0;
pub const CHIPID_AD7193: c_uint = 0x2;
pub const CHIPID_AD7194: c_uint = 0x3;
pub const CHIPID_AD7195: c_uint = 0x6;

// GPOCON Register Bit Designations (AD7192_REG_GPOCON)

pub const AD7192_EXT_FREQ_MHZ_MIN: c_int = 2457600;
pub const AD7192_EXT_FREQ_MHZ_MAX: c_int = 5120000;
pub const AD7192_INT_FREQ_MHZ: c_int = 4915200;
pub const AD7192_NO_SYNC_FILTER: c_int = 1;
pub const AD7192_SYNC3_FILTER: c_int = 3;
pub const AD7192_SYNC4_FILTER: c_int = 4;
// NOTE:
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7192_chip_info {
    pub chip_id: c_uint,
    pub name: *const c_char,
    pub channels: *const iio_chan_spec,
    pub num_channels: u8,
    pub sigma_delta_info: *const ad_sigma_delta_info,
    pub info: *const iio_info,
    pub indio_dev): *mut *mut int (parse_channels)(struct iio_dev,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7192_state {
    pub chip_info: *const ad7192_chip_info,
    pub mclk: *mut clk,
    ...
    pub mode: u32,
    pub conf: u32,
    pub scale_avail: [u32; 8][2],
    pub filter_freq_avail: [u32; 4][2],
    pub oversampling_ratio_avail: [u32; 4],
    pub gpocon: u8,
    pub clock_sel: u8,
    pub /: *mut *mut mutex lock; / protect sensor state,
    pub syscalib_mode: [u8; 8],
...
#[no_mangle]
unsafe extern "C" fn ad7192_set_channel(sd: *mut ad_sigma_delta, channel: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7192_append_status(sd: *mut ad_sigma_delta, append: bool) -> c_int {
    static int ad7192_append_status(struct ad_sigma_delta *sd, bool append)
    {
    struct ad7192_state *st = ad_sigma_delta_to_ad7192(sd);
    let mut mode: c_uint = st.mode;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ad7192_disable_all(sd: *mut ad_sigma_delta) -> c_int {
    static int ad7192_disable_all(struct ad_sigma_delta *sd)
    {
    struct ad7192_state *st = ad_sigma_delta_to_ad7192(sd);
    let mut conf: u32 = st.conf;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ad7192_calibrate_all(st: *mut ad7192_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ad7192_valid_external_frequency(freq: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ad7192_clk_output_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7192_clk_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7192_clk_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn ad7192_register_clk_provider(st: *mut ad7192_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7192_clock_setup(st: *mut ad7192_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7192_setup(indio_dev: *mut iio_dev, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7192_compute_f_order(st: *mut ad7192_state, sinc3_en: bool, chop_en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7192_get_f_order(st: *mut ad7192_state) -> c_int {
    ...
    bool chop_en)
    {
    let mut f_order: c_uint = ad7192_compute_f_order(st, sinc3_en, chop_en);
    return DIV_ROUND_CLOSEST(st.fclk,
    f_order * FIELD_GET(AD7192_MODE_RATE_MASK, st.mode));
    }
#[no_mangle]
unsafe extern "C" fn ad7192_get_f_adc(st: *mut ad7192_state) -> c_int {
    static int ad7192_get_f_adc(struct ad7192_state *st)
    {
    let mut f_order: c_uint = ad7192_get_f_order(st);
    return DIV_ROUND_CLOSEST(st.fclk,
    f_order * FIELD_GET(AD7192_MODE_RATE_MASK, st.mode));
    }
#[no_mangle]
unsafe extern "C" fn ad7192_update_filter_freq_avail(st: *mut ad7192_state) {
...
#[no_mangle]
unsafe extern "C" fn ad7192_get_temp_scale(unipolar: bool) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ad7192_get_3db_filter_freq(st: *mut ad7192_state) -> c_int {
    ...
    {
    struct ad7192_state *st = iio_priv(indio_dev);
    let mut unipolar: bool = FIELD_GET(AD7192_CONF_UNIPOLAR, st.conf);
    let mut gain: u8 = FIELD_GET(AD7192_CONF_GAIN_MASK, st.conf);
    switch (m) {
...
#[no_mangle]
unsafe extern "C" fn ad7192_update_scan_mode(indio_dev: *mut iio_dev, scan_mask: *const c_ulong) -> c_int {
    ...
    __AD719x_CHANNEL(_si, 0, -1, _address, IIO_TEMP, 0, 0, 0, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn ad7194_validate_ain_channel(dev: *mut device, ain: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ad7194_parse_channels(indio_dev: *mut iio_dev) -> c_int {
    static int ad7194_parse_channels(struct iio_dev *indio_dev)
    {
    struct device *dev = indio_dev.dev.parent;
    struct iio_chan_spec *ad7194_channels;
    let mut ad7194_chan: iio_chan_spec = AD7193_CHANNEL(0, 0, 0);
    let mut ad7194_chan_diff: iio_chan_spec = AD7193_DIFF_CHANNEL(0, 0, 0, 0);
    let mut ad7194_chan_temp: iio_chan_spec = AD719x_TEMP_CHANNEL(0, 0);
    let mut ad7194_chan_timestamp: iio_chan_spec = IIO_CHAN_SOFT_TIMESTAMP(0);
...
#[no_mangle]
unsafe extern "C" fn ad7192_probe(spi: *mut spi_device) -> c_int {
