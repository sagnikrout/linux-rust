...
//! Source: drivers/iio/adc/rzn1-adc.c
#![no_std]
...
pub const RZN1_ADC_CONTROL_REG: c_uint = 0x02c;

pub const RZN1_ADC_FORCE_REG: c_uint = 0x030;
pub const RZN1_ADC_SET_FORCE_REG: c_uint = 0x034;
pub const RZN1_ADC_CLEAR_FORCE_REG: c_uint = 0x038;

pub const RZN1_ADC_CONFIG_REG: c_uint = 0x040;
...
pub struct rzn1_adc {
    ...
    pub /: *mut *mut mutex lock; / ADC lock,
    pub /: *mut *mut int adc1_vref_mV; / ADC1 Vref in mV. Negative if ADC1 is not used,
    pub /: *mut *mut int adc2_vref_mV; / ADC2 Vref in mV. Negative if ADC2 is not used,
}

#[no_mangle]
unsafe extern "C" fn rzn1_adc_power(rzn1_adc: *mut rzn1_adc, power: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzn1_adc_vc_start_conversion(rzn1_adc: *mut rzn1_adc, ch: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzn1_adc_vc_stop_conversion(rzn1_adc: *mut rzn1_adc, ch: u32) {
...
#[no_mangle]
unsafe extern "C" fn rzn1_adc_read_raw_ch(rzn1_adc: *mut rzn1_adc, chan: c_uint, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzn1_adc_get_vref_mV(rzn1_adc: *mut rzn1_adc, chan: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzn1_adc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzn1_adc_pm_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzn1_adc_pm_runtime_resume(dev: *mut device) -> c_int {
