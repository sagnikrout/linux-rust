...
//! Source: drivers/iio/adc/ina2xx-adc.c
#![no_std]
...
pub const INA2XX_MAX_REGISTERS: c_int = 8;
// settings - depend on use case
pub const INA219_CONFIG_DEFAULT: c_uint = 0x399F	/* PGA=1/8, BRNG=32V */;
pub const INA219_DEFAULT_IT: c_int = 532;

pub const INA226_CONFIG_DEFAULT: c_uint = 0x4327;
pub const INA226_DEFAULT_AVG: c_int = 4;
pub const INA226_DEFAULT_IT: c_int = 1110;
...
pub const INA219_BUS_VOLTAGE_SHIFT: c_int = 3;
// Cosmetic macro giving the sampling period for a full P=UxI cycle

// c->avg)
#[no_mangle]
unsafe extern "C" fn ina2xx_is_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
    static bool ina2xx_is_writeable_reg(struct device *dev, unsigned int reg)
    {
    return (reg == INA2XX_CONFIG) || (reg > INA2XX_CURRENT);
    }
#[no_mangle]
unsafe extern "C" fn ina2xx_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
    static bool ina2xx_is_volatile_reg(struct device *dev, unsigned int reg)
    {
    return (reg != INA2XX_CONFIG);
    }
#[no_mangle]
pub unsafe extern "C" fn is_signed_reg(reg: c_uint) -> bool {
...
pub struct ina2xx_config {
    ...
    pub /: *mut *mut int shunt_voltage_lsb; / nV,
    pub /: *mut *mut int bus_voltage_shift; / position of lsb,
    pub /: *mut *mut int bus_voltage_lsb; / uV,
// fixed relation between current and power lsb, uW/uA
    pub power_lsb_factor: c_int,
    pub chip_id: enum ina2xx_ids,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ina2xx_chip_info {
    ...
    pub avg: c_int,
    pub /: *mut *mut int int_time_vbus; / Bus voltage integration time uS,
    pub /: *mut *mut int int_time_vshunt; / Shunt voltage integration time uS,
    pub /: *mut *mut int range_vbus; / Bus voltage maximum in V,
    pub /: *mut *mut int pga_gain_vshunt; / Shunt voltage PGA gain,
    pub allow_async_readout: bool,
...
#[no_mangle]
unsafe extern "C" fn ina219_lookup_int_time(val_us: *mut c_uint, bits: *mut c_int) -> c_int {
...
// bits |= 0x8;
    ...
    {
    int bits, ret;
    let mut val_us_best: c_uint = val_us;
...
// config |= INA219_SHIFT_ITS(bits) & INA219_ITS_MASK;
    ...
    chip.range_vbus = 32;
#[no_mangle]
pub unsafe extern "C" fn if(2: range ==) -> else {
    else if (range == 2)
    chip.range_vbus = 16;
    else
    return -EINVAL;
...
//
#[no_mangle]
unsafe extern "C" fn ina2xx_set_calibration(chip: *mut ina2xx_chip_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_shunt_resistor(chip: *mut ina2xx_chip_info, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina2xx_conversion_ready(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina2xx_work_buffer(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina2xx_capture_thread(data: *mut c_void) -> c_int {
    static int ina2xx_capture_thread(void *data)
    {
    struct iio_dev *indio_dev = data;
    struct ina2xx_chip_info *chip = iio_priv(indio_dev);
    let mut sampling_us: c_int = SAMPLING_PERIOD(chip);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ina2xx_buffer_enable(indio_dev: *mut iio_dev) -> c_int {
    static int ina2xx_buffer_enable(struct iio_dev *indio_dev)
    {
    struct ina2xx_chip_info *chip = iio_priv(indio_dev);
    let mut sampling_us: c_uint = SAMPLING_PERIOD(chip);
...
#[no_mangle]
unsafe extern "C" fn ina2xx_buffer_disable(indio_dev: *mut iio_dev) -> c_int {
    static int ina2xx_buffer_disable(struct iio_dev *indio_dev)
    {
    struct ina2xx_chip_info *chip = iio_priv(indio_dev);
    if (chip.task) {
    kthread_stop(chip.task);
    chip.task = core::ptr::null_mut();
    }
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn ina2xx_init(chip: *mut ina2xx_chip_info, config: c_uint) -> c_int {
    static int ina2xx_init(struct ina2xx_chip_info *chip, unsigned int config)
    {
    let mut ret: c_int = regmap_write(chip.regmap, INA2XX_CONFIG, config);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn ina2xx_remove(client: *mut i2c_client) {
