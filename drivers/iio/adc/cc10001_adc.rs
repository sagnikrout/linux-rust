...
//! Source: drivers/iio/adc/cc10001_adc.c
#![no_std]
...
// Registers
pub const CC10001_ADC_CONFIG: c_uint = 0x00;

pub const CC10001_ADC_DDATA_OUT: c_uint = 0x04;
pub const CC10001_ADC_EOC: c_uint = 0x08;

pub const CC10001_ADC_CHSEL_SAMPLED: c_uint = 0x0c;
pub const CC10001_ADC_POWER_DOWN: c_uint = 0x10;

pub const CC10001_ADC_DEBUG: c_uint = 0x14;
pub const CC10001_ADC_DATA_COUNT: c_uint = 0x20;

pub const CC10001_ADC_NUM_CHANNELS: c_int = 8;

pub const CC10001_INVALID_SAMPLED: c_uint = 0xffff;
pub const CC10001_MAX_POLL_COUNT: c_int = 20;
//
...
// intentionally here.
//
pub const CC10001_WAIT_CYCLES: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cc10001_adc_device {
    ...
    pub shared: bool,
    pub lock: mutex,
    pub start_delay_ns: c_uint,
    pub eoc_delay_ns: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn cc10001_adc_power_up(adc_dev: *mut cc10001_adc_device) {
...
#[no_mangle]
unsafe extern "C" fn cc10001_adc_power_down(adc_dev: *mut cc10001_adc_device) {
...
#[no_mangle]
unsafe extern "C" fn cc10001_adc_trigger_h(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cc10001_reg_disable(priv: *mut c_void) {
    static void cc10001_reg_disable(void *priv)
    {
    regulator_disable(priv);
    }
#[no_mangle]
unsafe extern "C" fn cc10001_pd_cb(priv: *mut c_void) {
    static void cc10001_pd_cb(void *priv)
    {
    cc10001_adc_power_down(priv);
    }
#[no_mangle]
unsafe extern "C" fn cc10001_adc_probe(pdev: *mut platform_device) -> c_int {
...
// Setup the ADC channels available on the device
    ...
    &cc10001_adc_trigger_h, core::ptr::null_mut());
    if (ret < 0)
    return ret;
