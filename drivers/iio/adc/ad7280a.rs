...
//! Source: drivers/iio/adc/ad7280a.c
#![no_std]
...
// Registers
pub const AD7280A_CELL_VOLTAGE_1_REG: c_uint = 0x0  /* D11 to D0, Read only */;
pub const AD7280A_CELL_VOLTAGE_2_REG: c_uint = 0x1  /* D11 to D0, Read only */;
pub const AD7280A_CELL_VOLTAGE_3_REG: c_uint = 0x2  /* D11 to D0, Read only */;
pub const AD7280A_CELL_VOLTAGE_4_REG: c_uint = 0x3  /* D11 to D0, Read only */;
pub const AD7280A_CELL_VOLTAGE_5_REG: c_uint = 0x4  /* D11 to D0, Read only */;
pub const AD7280A_CELL_VOLTAGE_6_REG: c_uint = 0x5  /* D11 to D0, Read only */;
pub const AD7280A_AUX_ADC_1_REG: c_uint = 0x6  /* D11 to D0, Read only */;
pub const AD7280A_AUX_ADC_2_REG: c_uint = 0x7  /* D11 to D0, Read only */;
pub const AD7280A_AUX_ADC_3_REG: c_uint = 0x8  /* D11 to D0, Read only */;
pub const AD7280A_AUX_ADC_4_REG: c_uint = 0x9  /* D11 to D0, Read only */;
pub const AD7280A_AUX_ADC_5_REG: c_uint = 0xA  /* D11 to D0, Read only */;
pub const AD7280A_AUX_ADC_6_REG: c_uint = 0xB  /* D11 to D0, Read only */;
pub const AD7280A_SELF_TEST_REG: c_uint = 0xC  /* D11 to D0, Read only */;
pub const AD7280A_CTRL_HB_REG: c_uint = 0xD  /* D15 to D8, Read/write */;

pub const AD7280A_CTRL_HB_CONV_INPUT_ALL: c_int = 0;
pub const AD7280A_CTRL_HB_CONV_INPUT_6CELL_AUX1_3_5: c_int = 1;
pub const AD7280A_CTRL_HB_CONV_INPUT_6CELL: c_int = 2;
pub const AD7280A_CTRL_HB_CONV_INPUT_SELF_TEST: c_int = 3;

pub const AD7280A_CTRL_HB_CONV_RREAD_ALL: c_int = 0;
pub const AD7280A_CTRL_HB_CONV_RREAD_6CELL_AUX1_3_5: c_int = 1;
pub const AD7280A_CTRL_HB_CONV_RREAD_6CELL: c_int = 2;
pub const AD7280A_CTRL_HB_CONV_RREAD_NO: c_int = 3;

pub const AD7280A_CTRL_HB_CONV_START_CNVST: c_int = 0;
pub const AD7280A_CTRL_HB_CONV_START_CS: c_int = 1;

pub const AD7280A_CTRL_HB_CONV_AVG_DIS: c_int = 0;
pub const AD7280A_CTRL_HB_CONV_AVG_2: c_int = 1;
pub const AD7280A_CTRL_HB_CONV_AVG_4: c_int = 2;
pub const AD7280A_CTRL_HB_CONV_AVG_8: c_int = 3;

pub const AD7280A_CTRL_LB_REG: c_uint = 0xE  /* D7 to D0, Read/write */;

pub const AD7280A_CTRL_LB_ACQ_TIME_400ns: c_int = 0;
pub const AD7280A_CTRL_LB_ACQ_TIME_800ns: c_int = 1;
pub const AD7280A_CTRL_LB_ACQ_TIME_1200ns: c_int = 2;
pub const AD7280A_CTRL_LB_ACQ_TIME_1600ns: c_int = 3;

pub const AD7280A_CELL_OVERVOLTAGE_REG: c_uint = 0xF  /* D7 to D0, Read/write */;
pub const AD7280A_CELL_UNDERVOLTAGE_REG: c_uint = 0x10 /* D7 to D0, Read/write */;
pub const AD7280A_AUX_ADC_OVERVOLTAGE_REG: c_uint = 0x11 /* D7 to D0, Read/write */;
pub const AD7280A_AUX_ADC_UNDERVOLTAGE_REG: c_uint = 0x12 /* D7 to D0, Read/write */;
pub const AD7280A_ALERT_REG: c_uint = 0x13 /* D7 to D0, Read/write */;

pub const AD7280A_CELL_BALANCE_REG: c_uint = 0x14 /* D7 to D0, Read/write */;

pub const AD7280A_CB1_TIMER_REG: c_uint = 0x15 /* D7 to D0, Read/write */;

pub const AD7280A_CB2_TIMER_REG: c_uint = 0x16 /* D7 to D0, Read/write */;
pub const AD7280A_CB3_TIMER_REG: c_uint = 0x17 /* D7 to D0, Read/write */;
pub const AD7280A_CB4_TIMER_REG: c_uint = 0x18 /* D7 to D0, Read/write */;
pub const AD7280A_CB5_TIMER_REG: c_uint = 0x19 /* D7 to D0, Read/write */;
pub const AD7280A_CB6_TIMER_REG: c_uint = 0x1A /* D7 to D0, Read/write */;
pub const AD7280A_PD_TIMER_REG: c_uint = 0x1B /* D7 to D0, Read/write */;
pub const AD7280A_READ_REG: c_uint = 0x1C /* D7 to D0, Read/write */;

pub const AD7280A_CNVST_CTRL_REG: c_uint = 0x1D /* D7 to D0, Read/write */;
// Transfer fields

pub const AD7280A_TRANS_WRITE_RES_PATTERN: c_uint = 0x2;
// Layouts differ for channel vs other registers

// Magic value used to indicate this special case

pub const AD7280A_MAX_CHAIN: c_int = 8;
pub const AD7280A_CELLS_PER_DEV: c_int = 6;
pub const AD7280A_BITS: c_int = 12;
...
pub const AD7280A_DEVADDR_MASTER: c_int = 0;
pub const AD7280A_DEVADDR_ALL: c_uint = 0x1F;
...
#[no_mangle]
unsafe extern "C" fn ad7280a_devaddr(addr: c_uint) -> c_uint {
...
//
pub const AD7280A_READ_TXVAL: c_uint = 0xF800030A;
//
// AD7280 CRC
//
// P(x) = x^8 + x^5 + x^3 + x^2 + x^1 + x^0 = 0b100101111 => 0x2F
//
pub const POLYNOM: c_uint = 0x2F;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7280_state {
    pub spi: *mut spi_device,
    pub channels: *mut iio_chan_spec,
    pub chain_last_alert_ignore: c_uint,
    pub thermistor_term_en: bool,
    pub slave_num: c_int,
    pub scan_cnt: c_int,
    pub readback_delay_us: c_int,
    pub crc_tab: [c_uchar; CRC8_TABLE_SIZE],
    pub oversampling_ratio: u8,
    pub acquisition_time: u8,
    pub ctrl_lb: c_uchar,
    pub cell_threshhigh: c_uchar,
    pub cell_threshlow: c_uchar,
    pub aux_threshhigh: c_uchar,
    pub aux_threshlow: c_uchar,
    pub cb_mask: [c_uchar; AD7280A_MAX_CHAIN],
...
#[no_mangle]
unsafe extern "C" fn ad7280_calc_crc8(crc_tab: *mut c_uchar, val: c_uint) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn ad7280_check_crc(st: *mut ad7280_state, val: c_uint) -> c_int {
    static int ad7280_check_crc(struct ad7280_state *st, unsigned int val)
    {
    let mut crc: c_uchar = ad7280_calc_crc8(st.crc_tab, val >> 10);
    if (crc != ((val >> 2) & 0xFF))
    return -EIO;
    return 0;
    }
...
//
#[no_mangle]
unsafe extern "C" fn ad7280_delay(st: *mut ad7280_state) {
...
#[no_mangle]
unsafe extern "C" fn __ad7280_read32(st: *mut ad7280_state, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7280_sw_power_down(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ad7280_chain_setup(st: *mut ad7280_state) -> c_int {
    ...
    {
    struct ad7280_state *st = iio_priv(indio_dev);
    let mut devaddr: u8 = chan.address >> 8;
    let mut ch: u8 = chan.address & 0xFF;
    unsigned int msecs;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ad7280_channel_init(st: *mut ad7280_state, irq_present: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7280_event_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad7280_update_delay(st: *mut ad7280_state) {
...
// Convert to usecs
    ...
    ret = ad7280_read_all_channels(st, st.scan_cnt, core::ptr::null_mut());
    else
...
#[no_mangle]
unsafe extern "C" fn ad7280_probe(spi: *mut spi_device) -> c_int {
