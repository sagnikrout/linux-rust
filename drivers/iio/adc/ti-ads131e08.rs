...
//! Source: drivers/iio/adc/ti-ads131e08.c
#![no_std]
...
// Commands
pub const ADS131E08_CMD_RESET: c_uint = 0x06;
pub const ADS131E08_CMD_START: c_uint = 0x08;
pub const ADS131E08_CMD_STOP: c_uint = 0x0A;
pub const ADS131E08_CMD_OFFSETCAL: c_uint = 0x1A;
pub const ADS131E08_CMD_SDATAC: c_uint = 0x11;
pub const ADS131E08_CMD_RDATA: c_uint = 0x12;

// Registers
pub const ADS131E08_ADR_CFG1R: c_uint = 0x01;
pub const ADS131E08_ADR_CFG3R: c_uint = 0x03;
pub const ADS131E08_ADR_CH0R: c_uint = 0x05;
...
// ADC  misc
pub const ADS131E08_DEFAULT_DATA_RATE: c_int = 1;
pub const ADS131E08_DEFAULT_PGA_GAIN: c_int = 1;
pub const ADS131E08_DEFAULT_MUX: c_int = 0;
pub const ADS131E08_VREF_2V4_mV: c_int = 2400;
pub const ADS131E08_VREF_4V_mV: c_int = 4000;
pub const ADS131E08_WAIT_RESET_CYCLES: c_int = 18;
pub const ADS131E08_WAIT_SDECODE_CYCLES: c_int = 4;
pub const ADS131E08_WAIT_OFFSETCAL_MS: c_int = 153;
pub const ADS131E08_MAX_SETTLING_TIME_MS: c_int = 6;
pub const ADS131E08_NUM_STATUS_BYTES: c_int = 3;
pub const ADS131E08_NUM_DATA_BYTES_MAX: c_int = 24;

pub const ADS131E08_NUM_STORAGE_BYTES: c_int = 4;
    enum ads131e08_ids {
    ads131e04,
    ads131e06,
    ads131e08,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads131e08_channel_config {
    pub pga_gain: c_uint,
    pub mux: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads131e08_state {
    pub info: *const ads131e08_info,
    pub spi: *mut spi_device,
    pub trig: *mut iio_trigger,
    pub adc_clk: *mut clk,
    pub vref_reg: *mut regulator,
    pub channel_config: *mut ads131e08_channel_config,
    pub data_rate: c_uint,
    pub vref_mv: c_uint,
    pub sdecode_delay_us: c_uint,
    pub reset_delay_us: c_uint,
    pub readback_len: c_uint,
    pub completion: completion,
    struct {
    pub data: [u8; ADS131E08_NUM_DATA_BYTES_MAX],
    pub ts: aligned_s64,
    pub tmp_buf: },
    pub __aligned(IIO_DMA_MINALIGN): u8 tx_buf[3],
//
// Add extra one padding byte to be able to access the last channel
// value using u32 pointer
//
    u8 rx_buf[ADS131E08_NUM_STATUS_BYTES +
    pub 1]: ADS131E08_NUM_DATA_BYTES_MAX +,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads131e08_data_rate_desc {
    pub /: *mut *mut unsigned int rate; / data rate in kSPS,
    pub /: *mut *mut u8 reg; / reg value,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads131e08_pga_gain_desc {
    pub /: *mut *mut unsigned int gain; / PGA gain value,
    pub /: *mut *mut u8 reg; / field value,
}
...
#[no_mangle]
unsafe extern "C" fn ads131e08_exec_cmd(st: *mut ads131e08_state, cmd: u8) -> c_int {
    static int ads131e08_exec_cmd(struct ads131e08_state *st, u8 cmd)
    {
    int ret;
    ret = spi_write_then_read(st.spi, &cmd, 1, core::ptr::null_mut(), 0);
    if (ret)
    dev_err(&st.spi.dev, "Exec cmd(%02x) failed\n", cmd);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn ads131e08_read_reg(st: *mut ads131e08_state, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads131e08_write_reg(st: *mut ads131e08_state, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads131e08_read_data(st: *mut ads131e08_state, rx_len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads131e08_set_data_rate(st: *mut ads131e08_state, data_rate: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads131e08_config_reference_voltage(st: *mut ads131e08_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads131e08_initial_config(indio_dev: *mut iio_dev) -> c_int {
    ...
    let mut active_channels: c_ulong = 0;
    int ret, i;
...
#[no_mangle]
unsafe extern "C" fn ads131e08_pool_data(st: *mut ads131e08_state) -> c_int {
...
// value = st->data_rate;
    ...
    struct ads131e08_state *st = iio_priv(indio_dev);
    if (readval) {
    let mut ret: c_int = ads131e08_read_reg(st, reg);
// readval = ret;
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn ads131e08_set_trigger_state(trig: *mut iio_trigger, state: bool) -> c_int {
    static int ads131e08_set_trigger_state(struct iio_trigger *trig, bool state)
    {
    struct iio_dev *indio_dev = iio_trigger_get_drvdata(trig);
    struct ads131e08_state *st = iio_priv(indio_dev);
    let mut cmd: u8 = state ? ADS131E08_CMD_START : ADS131E08_CMD_STOP;
...
#[no_mangle]
unsafe extern "C" fn ads131e08_trigger_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
//
    let mut num_bytes: c_uint = ADS131E08_NUM_DATA_BYTES(st.data_rate);
    let mut tweak_offset: u8 = num_bytes == 2 ? 1 : 0;
...
#[no_mangle]
unsafe extern "C" fn ads131e08_interrupt(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ads131e08_alloc_channels(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads131e08_regulator_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ads131e08_probe(spi: *mut spi_device) -> c_int {
    ...
    core::ptr::null_mut(), &ads131e08_trigger_handler, core::ptr::null_mut());
    if (ret) {
