...
//! Source: drivers/iio/adc/max11100.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn max11100_read_single(indio_dev: *mut iio_dev, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max11100_regulator_disable(reg: *mut c_void) {
    static void max11100_regulator_disable(void *reg)
    {
    regulator_disable(reg);
    }
#[no_mangle]
unsafe extern "C" fn max11100_probe(spi: *mut spi_device) -> c_int {
