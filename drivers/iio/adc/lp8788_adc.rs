...
//! Source: drivers/iio/adc/lp8788_adc.c
#![no_std]
...
// register address
pub const LP8788_ADC_CONF: c_uint = 0x60;
pub const LP8788_ADC_RAW: c_uint = 0x61;
pub const LP8788_ADC_DONE: c_uint = 0x63;
pub const ADC_CONV_START: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lp8788_adc {
    pub lp: *mut lp8788,
    ...
    u8 data;
    u8 rawdata[2];
    let mut size: c_int = ARRAY_SIZE(rawdata);
...
// val = result;
    ...
    let mut id: enum lp8788_adc_id = chan.channel;
    int ret;
    mutex_lock(&adc.lock);
    switch (mask) {
...
#[no_mangle]
unsafe extern "C" fn lp8788_adc_probe(pdev: *mut platform_device) -> c_int {
