...
//! Source: drivers/iio/adc/ad4000.c
#![no_std]
...
pub const AD4000_READ_COMMAND: c_uint = 0x54;
pub const AD4000_WRITE_COMMAND: c_uint = 0x14;
pub const AD4000_CONFIG_REG_DEFAULT: c_uint = 0xE1;
// AD4000 Configuration Register programmable bits

pub const AD4000_SCALE_OPTIONS: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4000_time_spec {
    pub t_conv_ns: c_int,
    pub t_quiet2_ns: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4000_chip_info {
    pub dev_name: *const c_char,
    pub chan_spec: [iio_chan_spec; 2],
    pub reg_access_chan_spec: [iio_chan_spec; 2],
    pub offload_chan_spec: iio_chan_spec,
    pub reg_access_offload_chan_spec: iio_chan_spec,
    pub time_spec: *const ad4000_time_spec,
    pub has_hardware_gain: bool,
    pub max_rate_hz: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad4000_state {
    pub spi: *mut spi_device,
    pub cnv_gpio: *mut gpio_desc,
    pub xfers: [spi_transfer; 2],
    pub msg: spi_message,
    ...
    pub using_offload: bool,
    pub offload_trigger_hz: c_ulong,
    pub max_rate_hz: c_int,
    pub /: *mut *mut mutex lock; / Protect read modify write cycle,
    pub vref_mv: c_int,
    pub sdi_pin: enum ad4000_sdi,
    pub span_comp: bool,
    pub gain_milli: u16,
    pub scale_tbl: [c_int; AD4000_SCALE_OPTIONS][2],
    pub time_spec: *const ad4000_time_spec,
//
...
#[no_mangle]
unsafe extern "C" fn ad4000_write_reg(st: *mut ad4000_state, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4000_read_reg(st: *mut ad4000_state, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4000_set_sampling_freq(st: *mut ad4000_state, freq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4000_convert_and_acquire(st: *mut ad4000_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4000_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad4000_offload_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4000_offload_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad4000_config(st: *mut ad4000_state) -> c_int {
    static int ad4000_config(struct ad4000_state *st)
    {
    let mut reg_val: c_uint = AD4000_CONFIG_REG_DEFAULT;
...
#[no_mangle]
unsafe extern "C" fn ad4000_probe(spi: *mut spi_device) -> c_int {
