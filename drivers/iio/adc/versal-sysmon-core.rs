...
//! Source: drivers/iio/adc/versal-sysmon-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sysmon_q8p7_to_millicelsius(raw_data: i16, val: *mut c_int) {
    static void sysmon_q8p7_to_millicelsius(s16 raw_data, int *val)
    {
// val = (raw_data * MILLIDEGREE_PER_DEGREE) >> SYSMON_FRACTIONAL_SHIFT;
    }
#[no_mangle]
unsafe extern "C" fn sysmon_millicelsius_to_q8p7(raw_data: *mut u32, val: c_int) {
    static void sysmon_millicelsius_to_q8p7(u32 *raw_data, int val)
    {
// raw_data = (val << SYSMON_FRACTIONAL_SHIFT) / MILLIDEGREE_PER_DEGREE;
    }
#[no_mangle]
unsafe extern "C" fn sysmon_supply_rawtoprocessed(raw_data: c_int, val: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn sysmon_supply_processedtoraw(val: c_int, reg_val: u32, raw_data: *mut u32) {
    static void sysmon_supply_processedtoraw(int val, u32 reg_val, u32 *raw_data)
    {
    let mut exponent: c_int = FIELD_GET(SYSMON_MODE_MASK, reg_val);
    let mut format: c_int = FIELD_GET(SYSMON_FMT_MASK, reg_val);
    int scale, tmp;
...
#[no_mangle]
unsafe extern "C" fn sysmon_supply_thresh_offset(address: c_ulong, dir: enum iio_event_direction) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysmon_get_event_mask(chan: *const iio_chan_spec) -> u32 {
    ...
    {
    let mut shift: u32 = address % SYSMON_ALARM_BITS_PER_REG;
    let mut offset: u32 = SYSMON_ALARM_OFFSET(address);
    ...
    {
    struct sysmon *sysmon = iio_priv(indio_dev);
    let mut mask: u32 = sysmon_get_event_mask(chan);
    unsigned int imr;
    int config_value;
    int ret;
...
//
    ...
    bool state)
    {
    let mut offset: u32 = SYSMON_ALARM_OFFSET(chan.address);
    struct sysmon *sysmon = iio_priv(indio_dev);
    let mut mask: u32 = sysmon_get_event_mask(chan);
...
//
#[no_mangle]
unsafe extern "C" fn sysmon_update_temp_lower(sysmon: *mut sysmon) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysmon_osr_write_temp(sysmon: *mut sysmon, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysmon_osr_write_supply(sysmon: *mut sysmon, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysmon_push_event(indio_dev: *mut iio_dev, address: u32) {
...
#[no_mangle]
unsafe extern "C" fn sysmon_handle_event(indio_dev: *mut iio_dev, event: u32) -> c_int {
    static int sysmon_handle_event(struct iio_dev *indio_dev, u32 event)
    {
    let mut alarm_flag_offset: u32 = SYSMON_ALARM_FLAG + event * SYSMON_REG_STRIDE;
    let mut alarm_reg_offset: u32 = SYSMON_ALARM_REG + event * SYSMON_REG_STRIDE;
    struct sysmon *sysmon = iio_priv(indio_dev);
...
#[no_mangle]
unsafe extern "C" fn sysmon_unmask_temp(sysmon: *mut sysmon, isr: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn sysmon_unmask_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sysmon_iio_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sysmon_disable_interrupts(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn sysmon_init_hysteresis(sysmon: *mut sysmon, hysteresis: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sysmon_parse_fw(indio_dev: *mut iio_dev, dev: *mut device, irq: c_int) -> c_int {
...
// Supply channels from DT
    ...
    BIT(IIO_CHAN_INFO_OVERSAMPLING_RATIO),
    .event_spec = irq > 0 ?
    sysmon_supply_events : core::ptr::null_mut(),
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_versal_sysmon_core_probe(dev: *mut device, regmap: *mut regmap) -> c_int {
