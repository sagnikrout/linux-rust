...
//! Source: drivers/iio/adc/sun4i-gpadc-iio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sun4i_gpadc_chan_select(chan: c_uint) -> c_uint {
    static unsigned int sun4i_gpadc_chan_select(unsigned int chan)
    {
    return SUN4I_GPADC_CTRL1_ADC_CHAN_SELECT(chan);
    }
#[no_mangle]
unsafe extern "C" fn sun6i_gpadc_chan_select(chan: c_uint) -> c_uint {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpadc_data {
    pub temp_offset: c_int,
    pub temp_scale: c_int,
    pub tp_mode_en: c_uint,
    pub tp_adc_select: c_uint,
    pub chan): *mut *mut unsigned int (adc_chan_select)(unsigned int,
    pub adc_chan_mask: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun4i_gpadc_iio {
    pub indio_dev: *mut iio_dev,
    pub completion: completion,
    pub temp_data: c_int,
    pub adc_data: u32,
    pub regmap: *mut regmap,
    pub fifo_data_irq: c_uint,
    pub ignore_fifo_data_irq: core::sync::atomic::AtomicI32,
    pub temp_data_irq: c_uint,
    pub ignore_temp_data_irq: core::sync::atomic::AtomicI32,
    pub data: *const gpadc_data,
    pub no_irq: bool,
// prevents concurrent reads of temperature and ADC
    pub mutex: mutex,
    pub tzd: *mut thermal_zone_device,
    pub sensor_device: *mut device,
}
    ...
    IIO_MAP("temp_adc", "iio_hwmon.0", core::ptr::null_mut()),
    { }
    };
...
#[no_mangle]
unsafe extern "C" fn sun4i_gpadc_temp_read(indio_dev: *mut iio_dev, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_gpadc_temp_offset(indio_dev: *mut iio_dev, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_gpadc_temp_scale(indio_dev: *mut iio_dev, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_gpadc_temp_data_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sun4i_gpadc_fifo_data_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sun4i_gpadc_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_gpadc_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_gpadc_get_temp(tz: *mut thermal_zone_device, temp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_gpadc_remove(pdev: *mut platform_device) {
