...
//! Source: drivers/iio/adc/da9150-gpadc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn da9150_gpadc_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn da9150_gpadc_read_adc(gpadc: *mut da9150_gpadc, hw_chan: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn da9150_gpadc_gpio_6v_voltage_now(raw_val: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn da9150_gpadc_ibus_current_avg(raw_val: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn da9150_gpadc_vbus_21v_voltage_now(raw_val: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn da9150_gpadc_vsys_6v_voltage_now(raw_val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9150_gpadc_read_scale(channel: c_int, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9150_gpadc_read_offset(channel: c_int, val: *mut c_int) -> c_int {
...
// Supported channels
    ...
    DA9150_GPADC_CHANNEL_PROCESSED(GPIOA, GPIOA_6V, IIO_VOLTAGE, core::ptr::null_mut()),
    DA9150_GPADC_CHANNEL_PROCESSED(GPIOB, GPIOB_6V, IIO_VOLTAGE, core::ptr::null_mut()),
    DA9150_GPADC_CHANNEL_PROCESSED(GPIOC, GPIOC_6V, IIO_VOLTAGE, core::ptr::null_mut()),
    DA9150_GPADC_CHANNEL_PROCESSED(GPIOD, GPIOD_6V, IIO_VOLTAGE, core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn da9150_gpadc_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (irq < 0)
    return irq;
    ret = devm_request_threaded_irq(dev, irq, core::ptr::null_mut(), da9150_gpadc_irq,
