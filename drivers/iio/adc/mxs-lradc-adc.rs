...
//! Source: drivers/iio/adc/mxs-lradc-adc.c
#![no_std]
...
//
pub const LRADC_DELAY_TIMER_PER: c_int = 200;
pub const LRADC_DELAY_TIMER_LOOP: c_int = 5;
pub const VREF_MV_BASE: c_int = 1850;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxs_lradc_adc {
    pub lradc: *mut mxs_lradc,
    pub dev: *mut device,
    pub base: *mut void __iomem,
// Maximum of 8 channels + 8 byte ts
    pub __aligned(8): u32 buffer[10],
    pub trig: *mut iio_trigger,
    pub completion: completion,
    pub lock: spinlock_t,
    pub vref_mv: *const u32,
    pub scale_avail: [mxs_lradc_scale; LRADC_MAX_TOTAL_CHANS][2],
    pub is_divided: c_ulong,
}
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_adc_read_temp(iio_dev: *mut iio_dev, val: *mut c_int) -> c_int {
...
// Macro flag: #define SHOW_SCALE_AVAILABLE_ATTR(ch)\
    IIO_DEVICE_ATTR(in_voltage##ch##_scale_available, 0444,\
    mxs_lradc_adc_show_scale_avail, core::ptr::null_mut(), ch)
...
// IRQ Handling
#[no_mangle]
unsafe extern "C" fn mxs_lradc_adc_handle_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t mxs_lradc_adc_handle_irq(int irq, void *data)
    {
    struct iio_dev *iio = data;
    struct mxs_lradc_adc *adc = iio_priv(iio);
    struct mxs_lradc *lradc = adc.lradc;
    let mut reg: c_ulong = readl(adc.base + LRADC_CTRL1);
    unsigned long flags;
...
// Trigger handling
#[no_mangle]
unsafe extern "C" fn mxs_lradc_adc_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_adc_configure_trigger(trig: *mut iio_trigger, state: bool) -> c_int {
    static int mxs_lradc_adc_configure_trigger(struct iio_trigger *trig, bool state)
    {
    struct iio_dev *iio = iio_trigger_get_drvdata(trig);
    struct mxs_lradc_adc *adc = iio_priv(iio);
    let mut st: u32 = state ? STMP_OFFSET_REG_SET : STMP_OFFSET_REG_CLR;
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_adc_trigger_init(iio: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_adc_trigger_remove(iio: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_adc_buffer_preenable(iio: *mut iio_dev) -> c_int {
    ...
    let mut ctrl4_set: u32 = 0;
    let mut ctrl4_clr: u32 = 0;
    let mut ctrl1_irq: u32 = 0;
    const u32 chan_value = LRADC_CH_ACCUMULATE |
    ((LRADC_DELAY_TIMER_LOOP - 1) << LRADC_CH_NUM_SAMPLES_OFFSET);
    if (lradc.soc == IMX28_LRADC)
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_adc_buffer_postdisable(iio: *mut iio_dev) -> c_int {
    ...
    struct mxs_lradc_adc *adc = iio_priv(iio);
    struct mxs_lradc *lradc = adc.lradc;
    let mut map_chans: c_int = bitmap_weight(mask, LRADC_MAX_TOTAL_CHANS);
    let mut rsvd_chans: c_int = 0;
...
// Hidden channel to keep indexes
    ...
    MXS_ADC_CHAN(10, IIO_VOLTAGE, core::ptr::null_mut()),
    MXS_ADC_CHAN(11, IIO_VOLTAGE, core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_adc_hw_init(adc: *mut mxs_lradc_adc) {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_adc_hw_stop(adc: *mut mxs_lradc_adc) {
    static void mxs_lradc_adc_hw_stop(struct mxs_lradc_adc *adc)
    {
    writel(0, adc.base + LRADC_DELAY(0));
    }
#[no_mangle]
unsafe extern "C" fn mxs_lradc_adc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_adc_remove(pdev: *mut platform_device) {
