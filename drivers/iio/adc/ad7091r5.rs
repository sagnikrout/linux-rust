...
//! Source: drivers/iio/adc/ad7091r5.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ad7091r5_set_mode(st: *mut ad7091r_state, mode: enum ad7091r_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7091r5_reg_result_chan_id(val: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ad7091r5_i2c_probe(i2c: *mut i2c_client) -> c_int {
