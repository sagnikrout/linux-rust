...
//! Source: drivers/iio/adc/hx711.c
#![no_std]
...
pub const HX711_DATA_BITS: c_int = 24;
// gain to pulse and scale conversion
pub const HX711_GAIN_MAX: c_int = 3;
pub const HX711_RESET_GAIN: c_int = 128;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hx711_gain_to_scale {
    pub gain: c_int,
    pub gain_pulse: c_int,
    pub channel: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn hx711_get_gain_to_pulse(gain: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx711_get_gain_to_scale(gain_scale: *const c_int, gain: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx711_get_scale_to_gain(gain_scale: *const c_int, scale: c_int) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hx711_data {
    pub dev: *mut device,
    pub gpiod_pd_sck: *mut gpio_desc,
    pub gpiod_dout: *mut gpio_desc,
    pub /: *mut *mut int gain_set; / gain set on device,
    pub /: *mut *mut int gain_chan_a; / gain for channel A,
    pub gain_scale: [c_int; HX711_GAIN_MAX],
    pub chip_info: *const hx711_chip_info,
    pub lock: mutex,
//
// triggered buffer
...
//
    pub data_ready_delay_ns: u32,
    pub clock_frequency: u32,
}

#[no_mangle]
unsafe extern "C" fn hx711_cycle(hx711_data: *mut hx711_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx711_read(hx711_data: *mut hx711_data, trailing_pulses: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx711_wait_for_ready(hx711_data: *mut hx711_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx711_reset(hx711_data: *mut hx711_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx711_set_gain_for_channel(hx711_data: *mut hx711_data, chan: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx711_trigger(irq: c_int, p: *mut c_void) -> irqreturn_t {
    ...
    let mut channel: c_int = iio_attr.address;
    int i, len = 0;
    for (i = 0; i < HX711_GAIN_MAX; i++)
    ...
    hx711_scale_available_show, core::ptr::null_mut(), 0);
    static IIO_DEVICE_ATTR(in_voltage1_scale_available, S_IRUGO,
    hx711_scale_available_show, core::ptr::null_mut(), 1);
...
#[no_mangle]
unsafe extern "C" fn hx711_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    hx711_trigger, core::ptr::null_mut());
    if (ret < 0)
