...
//! Source: drivers/iio/adc/ad7405.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7405_chip_info {
    pub name: *const c_char,
    pub full_scale_mv: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7405_state {
    pub back: *mut iio_backend,
    pub info: *const ad7405_chip_info,
    pub ref_frequency: c_uint,
    pub dec_rate: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn ad7405_probe(pdev: *mut platform_device) -> c_int {
