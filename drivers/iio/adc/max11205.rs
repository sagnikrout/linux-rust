...
//! Source: drivers/iio/adc/max11205.c
#![no_std]
...
pub const MAX11205_BIT_SCALE: c_int = 15;
pub const MAX11205A_OUT_DATA_RATE: c_int = 116;
pub const MAX11205B_OUT_DATA_RATE: c_int = 13;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max11205_chip_info {
    pub out_data_rate: c_uint,
    pub name: *const c_char,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct max11205_state {
    pub chip_info: *const max11205_chip_info,
...
#[no_mangle]
unsafe extern "C" fn max11205_reg_disable(reg: *mut c_void) {
    static void max11205_reg_disable(void *reg)
    {
    regulator_disable(reg);
    }
#[no_mangle]
unsafe extern "C" fn max11205_probe(spi: *mut spi_device) -> c_int {
