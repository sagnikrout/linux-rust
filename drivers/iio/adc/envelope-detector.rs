...
//! Source: drivers/iio/adc/envelope-detector.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct envelope {
    pub /: *mut *mut spinlock_t comp_lock; / protects comp,
    pub comp: c_int,
    pub /: *mut *mut mutex read_lock; / protects everything else,
    pub comp_irq: c_int,
    pub comp_irq_trigger: u32,
    pub comp_irq_trigger_inv: u32,
    pub dac: *mut iio_channel,
    pub comp_timeout: delayed_work,
    pub comp_interval: c_uint,
    pub invert: bool,
    pub dac_max: u32,
    pub high: c_int,
    pub level: c_int,
...
//
#[no_mangle]
unsafe extern "C" fn envelope_detector_comp_latch(env: *mut envelope) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn envelope_detector_comp_isr(irq: c_int, ctx: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn envelope_detector_setup_compare(env: *mut envelope) {
...
#[no_mangle]
unsafe extern "C" fn envelope_detector_timeout(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn envelope_detector_probe(pdev: *mut platform_device) -> c_int {
