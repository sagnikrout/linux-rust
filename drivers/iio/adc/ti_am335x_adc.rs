...
//! Source: drivers/iio/adc/ti_am335x_adc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tiadc_dma {
    pub conf: dma_slave_config,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tiadc_device {
    pub mfd_tscadc: *mut ti_tscadc_dev,
    pub dma: tiadc_dma,
    pub /: *mut *mut mutex fifo1_lock; / to protect fifo access,
    pub channels: c_int,
    pub total_ch_enabled: c_int,
    pub channel_line: [u8; 8],
    pub channel_step: [u8; 8],
    pub buffer_en_ch_steps: c_int,
    pub data: [u16; 8],
    pub step_avg: [u32 open_delay[8], sample_delay[8],; 8],
}

#[no_mangle]
unsafe extern "C" fn tiadc_readl(adc: *mut tiadc_device, reg: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn get_adc_step_mask(adc_dev: *mut tiadc_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn get_adc_step_bit(adc_dev: *mut tiadc_device, chan: c_int) -> u32 {
    static u32 get_adc_step_bit(struct tiadc_device *adc_dev, int chan)
    {
    return 1 << adc_dev.channel_step[chan];
    }
#[no_mangle]
unsafe extern "C" fn tiadc_wait_idle(adc_dev: *mut tiadc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tiadc_step_config(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn tiadc_irq_h(irq: c_int, private: *mut c_void) -> irqreturn_t {
    static irqreturn_t tiadc_irq_h(int irq, void *private)
    {
    struct iio_dev *indio_dev = private;
    struct tiadc_device *adc_dev = iio_priv(indio_dev);
    unsigned int status, config, adc_fsm;
    let mut count: c_ushort = 0;
...
#[no_mangle]
unsafe extern "C" fn tiadc_worker_h(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tiadc_dma_rx_complete(param: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tiadc_start_dma(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tiadc_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tiadc_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
    static int tiadc_buffer_postenable(struct iio_dev *indio_dev)
    {
    struct tiadc_device *adc_dev = iio_priv(indio_dev);
    struct tiadc_dma *dma = &adc_dev.dma;
    unsigned int irq_enable;
    let mut enb: c_uint = 0;
    u8 bit;
...
#[no_mangle]
unsafe extern "C" fn tiadc_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tiadc_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
// Get a channel for RX
    ...
    if (IS_ERR(dma.chan)) {
    let mut ret: c_int = PTR_ERR(dma.chan);
    dma.chan = core::ptr::null_mut();
    return ret;
    }
// RX buffer
...
#[no_mangle]
unsafe extern "C" fn tiadc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tiadc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tiadc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tiadc_resume(dev: *mut device) -> c_int {
