...
//! Source: drivers/iio/adc/ltc2471.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltc2471_data {
    pub client: *mut i2c_client,
}

// Reference voltage is 1.25V
pub const LTC2471_VREF: c_int = 1250;
// Read two bytes from the I2C bus to obtain the ADC result
#[no_mangle]
unsafe extern "C" fn ltc2471_get_value(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2471_i2c_probe(client: *mut i2c_client) -> c_int {
