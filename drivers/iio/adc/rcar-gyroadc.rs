...
//! Source: drivers/iio/adc/rcar-gyroadc.c
#![no_std]
...
// GyroADC registers.
pub const RCAR_GYROADC_MODE_SELECT: c_uint = 0x00;
pub const RCAR_GYROADC_MODE_SELECT_1_MB88101A: c_uint = 0x0;
pub const RCAR_GYROADC_MODE_SELECT_2_ADCS7476: c_uint = 0x1;
pub const RCAR_GYROADC_MODE_SELECT_3_MAX1162: c_uint = 0x3;
pub const RCAR_GYROADC_START_STOP: c_uint = 0x04;

pub const RCAR_GYROADC_CLOCK_LENGTH: c_uint = 0x08;
pub const RCAR_GYROADC_1_25MS_LENGTH: c_uint = 0x0c;

pub const RCAR_GYROADC_FIFO_STATUS: c_uint = 0x70;

pub const RCAR_GYROADC_INTR: c_uint = 0x74;

pub const RCAR_GYROADC_INTENR: c_uint = 0x78;

pub const RCAR_GYROADC_RUNTIME_PM_DELAY_MS: c_int = 2000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_gyroadc {
    pub dev: *mut device,
    pub regs: *mut void __iomem,
    pub clk: *mut clk,
    pub vref: [*mut regulator; 8],
    pub num_channels: c_uint,
    pub model: enum rcar_gyroadc_model,
    pub mode: c_uint,
    pub sample_width: c_uint,
}

#[no_mangle]
unsafe extern "C" fn rcar_gyroadc_hw_init(priv: *mut rcar_gyroadc) {
    static void rcar_gyroadc_hw_init(struct rcar_gyroadc *priv)
    {
    let mut clk_mhz: c_ulong = clk_get_rate(priv.clk) / 1000000;
    const unsigned long clk_mul =
    (priv.mode == RCAR_GYROADC_MODE_SELECT_1_MB88101A) ? 10 : 5;
    let mut clk_len: c_ulong = clk_mhz * clk_mul;
//
...
#[no_mangle]
unsafe extern "C" fn rcar_gyroadc_hw_start(priv: *mut rcar_gyroadc) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gyroadc_hw_stop(priv: *mut rcar_gyroadc) {
...
// Stop the GyroADC.
    ...
    let mut datareg: c_uint = RCAR_GYROADC_REALTIME_DATA(chan.channel);
    unsigned int vref;
    int ret;
//
...
// val = RCAR_GYROADC_SAMPLE_RATE;
    ...
    {
    struct rcar_gyroadc *priv = iio_priv(indio_dev);
    let mut maxreg: c_uint = RCAR_GYROADC_FIFO_STATUS;
...
#[no_mangle]
unsafe extern "C" fn rcar_gyroadc_parse_subdevs(indio_dev: *mut iio_dev) -> c_int {
    ...
    unsigned int reg;
    let mut adcmode: c_uint = -1, childmode;
...
#[no_mangle]
unsafe extern "C" fn rcar_gyroadc_deinit_supplies(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gyroadc_init_supplies(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gyroadc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gyroadc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gyroadc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gyroadc_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(rcar_gyroadc_suspend, rcar_gyroadc_resume, core::ptr::null_mut())
    };
