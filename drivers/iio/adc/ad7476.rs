...
//! Source: drivers/iio/adc/ad7476.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7476_chip_info {
    pub int_vref_mv: c_uint,
    pub channel: [iio_chan_spec; 2],
    pub ): *mut *mut void (reset)(struct ad7476_state,
    pub st): *mut *mut void (conversion_pre_op)(struct ad7476_state,
    pub st): *mut *mut void (conversion_post_op)(struct ad7476_state,
    pub has_vref: bool,
    pub has_vdrive: bool,
    pub convstart_required: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7476_state {
    pub spi: *mut spi_device,
    pub chip_info: *const ad7476_chip_info,
...
//
    pub __aligned(IIO_DMA_MINALIGN): unsigned char data[ALIGN(2, sizeof(s64)) + sizeof(s64)],
}

#[no_mangle]
unsafe extern "C" fn ad7091_convst(st: *mut ad7476_state) {
...
#[no_mangle]
unsafe extern "C" fn bd79105_convst_disable(st: *mut ad7476_state) {
    static void bd79105_convst_disable(struct ad7476_state *st)
    {
    gpiod_set_value_cansleep(st.convst_gpio, 0);
    }
#[no_mangle]
unsafe extern "C" fn bd79105_convst_enable(st: *mut ad7476_state) {
...
#[no_mangle]
unsafe extern "C" fn ad7476_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad7091_reset(st: *mut ad7476_state) {
...
#[no_mangle]
unsafe extern "C" fn ad7476_scan_direct(st: *mut ad7476_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7476_probe(spi: *mut spi_device) -> c_int {
...
// Setup default message
    ...
    &ad7476_trigger_handler, core::ptr::null_mut());
    if (ret)
    return ret;
