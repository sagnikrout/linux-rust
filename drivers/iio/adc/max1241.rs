...
//! Source: drivers/iio/adc/max1241.c
#![no_std]
...
pub const MAX1241_SHUTDOWN_DELAY_USEC: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max1241 {
...
#[no_mangle]
unsafe extern "C" fn max1241_read(adc: *mut max1241) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max1241_disable_vref_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn max1241_probe(spi: *mut spi_device) -> c_int {
