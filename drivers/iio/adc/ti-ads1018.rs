...
//! Source: drivers/iio/adc/ti-ads1018.c
#![no_std]
...
pub const ADS1018_PGA_DEFAULT: c_int = 2;

pub const ADS1018_MODE_CONTINUOUS: c_int = 0;
pub const ADS1018_MODE_ONESHOT: c_int = 1;

pub const ADS1018_DRATE_DEFAULT: c_int = 4;
pub const ADS1018_NUM_PGA_MODES: c_int = 6;
pub const ADS1018_CHANNELS_MAX: c_int = 10;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads1018_chan_data {
    pub pga_mode: u8,
    pub data_rate_mode: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads1018_chip_info {
    pub name: *const c_char,
    pub channels: *const iio_chan_spec,
    pub num_channels: c_ulong,
// IIO_VAL_INT
    pub data_rate_mode_to_hz: *const u32,
    pub num_data_rate_mode_to_hz: c_ulong,
//
...
// { 0, 187500000 }
//
    pub pga_mode_to_gain: [u32; ADS1018_NUM_PGA_MODES][2],
// IIO_VAL_INT_PLUS_MICRO
    pub temp_scale: [u32; 2],
}
...
pub struct ads1018 {
    ...
    pub drdy_gpiod: *mut gpio_desc,
    pub drdy_irq: c_int,
    pub chan_data: [ads1018_chan_data; ADS1018_CHANNELS_MAX],
    pub chip_info: *const ads1018_chip_info,
    pub msg_read: spi_message,
    pub xfer: spi_transfer,
    pub __aligned(IIO_DMA_MINALIGN): __be16 tx_buf[2],
    pub rx_buf: [__be16; 2],
}
...
//
#[no_mangle]
unsafe extern "C" fn ads1018_calc_delay(hz: c_uint) -> u32 {
...
//
    ...
    {
    let mut max_drate_mode: u8 = ads1018.chip_info.num_data_rate_mode_to_hz - 1;
    let mut drate: u32 = ads1018.chip_info.data_rate_mode_to_hz[max_drate_mode];
    let mut pga_mode: u8 = ads1018.chan_data[chan.scan_index].pga_mode;
...
// cnv = be16_to_cpu(ads1018->rx_buf[0]);
    ...
    let mut addr: u8 = chan.scan_index;
...
#[no_mangle]
unsafe extern "C" fn ads1018_set_trigger_enable(ads1018: *mut ads1018) {
    static void ads1018_set_trigger_enable(struct ads1018 *ads1018)
    {
    spi_bus_lock(ads1018.spi.controller);
    ads1018_spi_read_exclusive(ads1018, core::ptr::null_mut(), true);
    enable_irq(ads1018.drdy_irq);
    }
#[no_mangle]
unsafe extern "C" fn ads1018_set_trigger_disable(ads1018: *mut ads1018) {
    static void ads1018_set_trigger_disable(struct ads1018 *ads1018)
    {
    disable_irq(ads1018.drdy_irq);
    ads1018_spi_read_exclusive(ads1018, core::ptr::null_mut(), false);
    spi_bus_unlock(ads1018.spi.controller);
    }
#[no_mangle]
unsafe extern "C" fn ads1018_set_trigger_state(trig: *mut iio_trigger, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1018_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1018_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads1018_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ads1018_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ads1018_trigger_setup(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ads1018->drdy_gpiod) -> else {
...
#[no_mangle]
unsafe extern "C" fn ads1018_spi_probe(spi: *mut spi_device) -> c_int {
