...
//! Source: drivers/iio/adc/fsl-imx25-gcq.c
#![no_std]
...
//
    ...
    let mut driver_name: *const static char  const = "mx25-gcq";
    enum mx25_gcq_cfgs {
    MX25_CFG_XP = 0,
    MX25_CFG_YP,
    MX25_CFG_XN,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mx25_gcq_priv {
    pub regs: *mut regmap,
    pub completed: completion,
    pub clk: *mut clk,
    pub irq: c_int,
    pub vref: [*mut regulator; 4],
    pub channel_vref_mv: [u32; MX25_NUM_CFGS],
//
...
#[no_mangle]
unsafe extern "C" fn mx25_gcq_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
    ...
    u32 reg;
    let mut refp: u32 = MX25_ADCQ_CFG_REFP_INT;
    let mut refn: u32 = MX25_ADCQ_CFG_REFN_NGND2;
...
#[no_mangle]
unsafe extern "C" fn mx25_gcq_reg_disable(reg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mx25_gcq_clk_disable(clk: *mut c_void) {
    static void mx25_gcq_clk_disable(void *clk)
    {
    clk_disable_unprepare(clk);
    }
#[no_mangle]
unsafe extern "C" fn mx25_gcq_probe(pdev: *mut platform_device) -> c_int {
