...
//! Source: drivers/iio/adc/ad7625.c
#![no_std]
...
pub const AD7625_INTERNAL_REF_MV: c_int = 4096;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7625_timing_spec {
// Max conversion high time (t_{CNVH}).
    pub conv_high_ns: c_uint,
// Max conversion to MSB delay (t_{MSB}).
    pub conv_msb_ns: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7625_chip_info {
    pub name: *const c_char,
    pub max_sample_freq_hz: c_uint,
    pub timing_spec: *const ad7625_timing_spec,
    pub chan_spec: iio_chan_spec,
    pub has_power_down_state: bool,
    pub has_bandwidth_control: bool,
    pub has_internal_vref: bool,
}
...
//
    pub en_gpios: [*mut gpio_desc; 4],
    pub can_power_down: bool,
    pub can_refin: bool,
    pub can_ref_4v096: bool,
//
// Indicate whether the bandwidth can be narrow (9MHz).
// When true, device sample rate must also be < 2MSPS.
//
    pub can_narrow_bandwidth: bool,
// Indicate whether the bandwidth can be wide (28MHz).
    pub can_wide_bandwidth: bool,
    pub can_ref_5v: bool,
    pub can_snooze: bool,
    pub can_test_pattern: bool,
...
#[no_mangle]
unsafe extern "C" fn ad7625_set_sampling_freq(st: *mut ad7625_state, freq: u32) -> c_int {
    static int ad7625_set_sampling_freq(struct ad7625_state *st, u32 freq)
    {
    let mut clk_gate_wf: pwm_waveform = { }, cnv_wf = { };
...
#[no_mangle]
unsafe extern "C" fn ad7625_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad7625_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
// Preemptively disable the PWM in case it was enabled at boot
    pwm_disable(st.clk_gate_pwm);
    ref_clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
    if (IS_ERR(ref_clk))
...
#[no_mangle]
unsafe extern "C" fn ad7625_probe(pdev: *mut platform_device) -> c_int {
