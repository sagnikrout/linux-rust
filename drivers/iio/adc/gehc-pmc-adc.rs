...
//! Source: drivers/iio/adc/gehc-pmc-adc.c
#![no_std]
...
pub const PMC_ADC_CMD_REQUEST_PROTOCOL_VERSION: c_uint = 0x01;
...
#[no_mangle]
unsafe extern "C" fn pmc_adc_read_raw_ch(pmc_adc: *mut pmc_adc, cmd: u8, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmc_adc_probe(client: *mut i2c_client) -> c_int {
