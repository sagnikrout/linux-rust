...
//! Source: drivers/iio/adc/versal-sysmon-i2c.c
#![no_std]
...
// [7]    reserved
//
pub const SYSMON_I2C_DATA_OFS: c_int = 0;
pub const SYSMON_I2C_REG_OFS: c_int = 4;
pub const SYSMON_I2C_INSTR_OFS: c_int = 6;
...
#[no_mangle]
unsafe extern "C" fn sysmon_i2c_probe(client: *mut i2c_client) -> c_int {
    static int sysmon_i2c_probe(struct i2c_client *client)
    {
    struct device *dev = &client.dev;
    struct regmap *regmap;
    regmap = devm_regmap_init(dev, core::ptr::null_mut(), client, &sysmon_i2c_regmap_config);
    if (IS_ERR(regmap))
