...
//! Source: drivers/iio/frequency/adf4350.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adf4350_state {
    pub spi: *mut spi_device,
    pub lock_detect_gpiod: *mut gpio_desc,
    pub pdata: *mut adf4350_platform_data,
    pub clk: *mut clk,
    pub clkout: *mut clk,
    pub clk_out_name: *const c_char,
    pub hw: clk_hw,
    pub clkin: c_ulong,
    pub /: *mut *mut unsigned long chspc; / Channel Spacing,
    pub /: *mut *mut unsigned long fpfd; / Phase Frequency Detector,
    pub min_out_freq: c_ulong,
    pub r0_fract: unsigned,
    pub r0_int: unsigned,
    pub r1_mod: unsigned,
    pub r4_rf_div_sel: unsigned,
    pub regs: [c_ulong; 6],
    pub regs_hw: [c_ulong; 6],
    pub freq_req: c_ulonglong,
//
...
//
    pub __aligned(IIO_DMA_MINALIGN): __be32 val,
}
...
#[no_mangle]
unsafe extern "C" fn adf4350_sync_config(st: *mut adf4350_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adf4350_tune_r_cnt(st: *mut adf4350_state, r_cnt: c_ushort) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adf4350_set_freq(st: *mut adf4350_state, freq: c_ulonglong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adf4350_clk_del_provider(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn adf4350_clk_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adf4350_clk_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn adf4350_clk_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adf4350_clk_register(st: *mut adf4350_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adf4350_power_down(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn adf4350_probe(spi: *mut spi_device) -> c_int {
    ...
    st.lock_detect_gpiod = devm_gpiod_get_optional(&spi.dev, core::ptr::null_mut(),
    GPIOD_IN);
