...
//! Source: drivers/iio/frequency/admv1014.c
#![no_std]
...
pub const ADMV1014_REG_SPI_CONTROL: c_uint = 0x00;
pub const ADMV1014_REG_ALARM: c_uint = 0x01;
pub const ADMV1014_REG_ALARM_MASKS: c_uint = 0x02;
pub const ADMV1014_REG_ENABLE: c_uint = 0x03;
pub const ADMV1014_REG_QUAD: c_uint = 0x04;
pub const ADMV1014_REG_LO_AMP_PHASE_ADJUST1: c_uint = 0x05;
pub const ADMV1014_REG_MIXER: c_uint = 0x07;
pub const ADMV1014_REG_IF_AMP: c_uint = 0x08;
pub const ADMV1014_REG_IF_AMP_BB_AMP: c_uint = 0x09;
pub const ADMV1014_REG_BB_AMP_AGC: c_uint = 0x0A;
pub const ADMV1014_REG_VVA_TEMP_COMP: c_uint = 0x0B;
// ADMV1014_REG_SPI_CONTROL Map

pub const ADMV1014_CHIP_ID: c_uint = 0x9;
...
pub const ADMV1014_NUM_REGULATORS: c_int = 9;
    enum {
    ADMV1014_IQ_MODE,
    ADMV1014_IF_MODE,
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct admv1014_state {
    pub spi: *mut spi_device,
    pub clkin: *mut clk,
    pub nb: notifier_block,
// Protect against concurrent accesses to the device and to data
    pub lock: mutex,
    pub regulators: [regulator_bulk_data; ADMV1014_NUM_REGULATORS],
    pub input_mode: c_uint,
    pub quad_se_mode: c_uint,
    pub p1db_comp: c_uint,
    pub det_en: bool,
...
#[no_mangle]
unsafe extern "C" fn admv1014_update_quad_filters(st: *mut admv1014_state) -> c_int {
    static int admv1014_update_quad_filters(struct admv1014_state *st)
    {
    unsigned int filt_raw;
    let mut rate: u64 = clk_get_rate(st.clkin);
    if (rate >= (5400 * HZ_PER_MHZ) && rate <= (7000 * HZ_PER_MHZ))
    filt_raw = 15;
#[no_mangle]
pub unsafe extern "C" fn if(HZ_PER_MHZ): *mut *mut *mut rate > (7000  HZ_PER_MHZ) && rate <= (8000) -> else {
    else if (rate > (7000 * HZ_PER_MHZ) && rate <= (8000 * HZ_PER_MHZ))
    filt_raw = 10;
#[no_mangle]
pub unsafe extern "C" fn if(HZ_PER_MHZ): *mut *mut *mut rate > (8000  HZ_PER_MHZ) && rate <= (9200) -> else {
...
#[no_mangle]
unsafe extern "C" fn admv1014_update_vcm_settings(st: *mut admv1014_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn admv1014_freq_change(nb: *mut notifier_block, action: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn admv1014_clk_disable(data: *mut c_void) {
    static void admv1014_clk_disable(void *data)
    {
    clk_disable_unprepare(data);
    }
#[no_mangle]
unsafe extern "C" fn admv1014_reg_disable(data: *mut c_void) {
    static void admv1014_reg_disable(void *data)
    {
    regulator_bulk_disable(ADMV1014_NUM_REGULATORS, data);
    }
#[no_mangle]
unsafe extern "C" fn admv1014_powerdown(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn admv1014_init(st: *mut admv1014_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn admv1014_properties_parse(st: *mut admv1014_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn admv1014_probe(spi: *mut spi_device) -> c_int {
