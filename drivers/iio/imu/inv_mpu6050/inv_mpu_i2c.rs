...
//! Source: drivers/iio/imu/inv_mpu6050/inv_mpu_i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn inv_mpu6050_select_bypass(muxc: *mut i2c_mux_core, chan_id: u32) -> c_int {
    static int inv_mpu6050_select_bypass(struct i2c_mux_core *muxc, u32 chan_id)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn inv_mpu_i2c_aux_bus(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn inv_mpu_i2c_aux_setup(indio_dev: *mut iio_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn inv_mpu_probe(client: *mut i2c_client) -> c_int {
...
// declare i2c auxiliary bus
    ...
    inv_mpu6050_select_bypass, core::ptr::null_mut());
    if (!st.muxc)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn inv_mpu_remove(client: *mut i2c_client) {
