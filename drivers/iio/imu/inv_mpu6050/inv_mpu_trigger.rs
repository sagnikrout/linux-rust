...
//! Source: drivers/iio/imu/inv_mpu6050/inv_mpu_trigger.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn inv_scan_query_mpu6050(indio_dev: *mut iio_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn inv_scan_query_mpu9x50(indio_dev: *mut iio_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn inv_scan_query(indio_dev: *mut iio_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn inv_compute_skip_samples(st: *const inv_mpu6050_state) -> c_uint {
    static unsigned int inv_compute_skip_samples(const struct inv_mpu6050_state *st)
    {
    let mut skip_samples: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn inv_mpu6050_prepare_fifo(st: *mut inv_mpu6050_state, enable: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn inv_mpu6050_set_enable(indio_dev: *mut iio_dev, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_mpu6050_interrupt_timestamp(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn inv_mpu6050_interrupt_handle(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn inv_mpu6050_probe_trigger(indio_dev: *mut iio_dev, irq_type: c_int) -> c_int {
