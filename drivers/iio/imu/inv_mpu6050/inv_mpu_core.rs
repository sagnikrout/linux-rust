...
//! Source: drivers/iio/imu/inv_mpu6050/inv_mpu_core.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn inv_mpu6050_init_config(indio_dev: *mut iio_dev) -> c_int {
...
// magn chip init, noop if not present in the chip
    ...
    {
    int ind;
    let mut d: __be16 = cpu_to_be16(val);
...
#[no_mangle]
unsafe extern "C" fn inv_mpu6050_convert_wom_to_roc(threshold: c_uint, freq_div: c_uint) -> u64 {
...
// 4mg per LSB converted in m/s² in micro (1000000)
    let mut convert: c_uint = 4U * 9807U;
    u64 value;
...
#[no_mangle]
unsafe extern "C" fn inv_mpu6050_convert_roc_to_wom(roc: u64, freq_div: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn inv_mpu6050_set_wom_int(st: *mut inv_mpu6050_state, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_mpu6050_set_wom_lp(st: *mut inv_mpu6050_state, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_mpu6050_enable_wom(st: *mut inv_mpu6050_state, en: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn inv_mpu6050_set_lpf(st: *mut inv_mpu6050_state, rate: c_int) -> c_int {
...
// Deprecated: kept for userspace backward compatibility.
    static IIO_DEVICE_ATTR(in_gyro_matrix, S_IRUGO, inv_attr_show, core::ptr::null_mut(),
    ATTR_GYRO_MATRIX);
    static IIO_DEVICE_ATTR(in_accel_matrix, S_IRUGO, inv_attr_show, core::ptr::null_mut(),
    ATTR_ACCL_MATRIX);
...
//
#[no_mangle]
unsafe extern "C" fn inv_check_and_setup_chip(st: *mut inv_mpu6050_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_mpu_core_enable_regulator_vddio(st: *mut inv_mpu6050_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_mpu_core_disable_regulator_vddio(st: *mut inv_mpu6050_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_mpu_core_disable_regulator_action(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn inv_mpu_pm_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn inv_mpu_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_mpu_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_mpu_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_mpu_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(inv_mpu_runtime_suspend, inv_mpu_runtime_resume, core::ptr::null_mut())
    };
