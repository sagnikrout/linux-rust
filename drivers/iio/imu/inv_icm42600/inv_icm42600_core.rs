...
//! Source: drivers/iio/imu/inv_icm42600/inv_icm42600_core.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct inv_icm42600_hw {
    pub whoami: u8,
    pub name: *const c_char,
    pub conf: *const inv_icm42600_conf,
}
...
#[no_mangle]
pub unsafe extern "C" fn inv_icm42600_odr_to_period(odr: enum inv_icm42600_odr) -> u32 {
...
// 500Hz
    ...
    {
    let mut oldgyro: enum inv_icm42600_sensor_mode = st.conf.gyro.mode;
    let mut oldaccel: enum inv_icm42600_sensor_mode = st.conf.accel.mode;
    let mut oldtemp: bool = st.conf.temp_en;
...
#[no_mangle]
pub unsafe extern "C" fn inv_icm42600_enable_wom(st: *mut inv_icm42600_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn inv_icm42600_disable_wom(st: *mut inv_icm42600_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42600_irq_timestamp(irq: c_int, _data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42600_irq_handler(irq: c_int, _data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42600_timestamp_setup(st: *mut inv_icm42600_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42600_enable_regulator_vddio(st: *mut inv_icm42600_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42600_disable_vddio_reg(_data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn inv_icm42600_suspend(dev: *mut device) -> c_int {
...
// disable APEX features and accel if wakeup disabled
    ...
    accel_conf, false, core::ptr::null_mut());
    if (ret)
    return ret;
...
//
#[no_mangle]
unsafe extern "C" fn inv_icm42600_resume(dev: *mut device) -> c_int {
...
// restore sensors state
    ...
    st.suspended.accel,
    st.suspended.temp, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn inv_icm42600_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42600_runtime_resume(dev: *mut device) -> c_int {
    ...
    inv_icm42600_runtime_resume, core::ptr::null_mut())
    };
