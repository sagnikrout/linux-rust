...
//! Source: drivers/iio/imu/inv_icm42600/inv_icm42600_gyro.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct inv_icm42600_gyro_buffer {
    pub gyro: inv_icm42600_fifo_sensor_data,
    pub temp: i16,
...
// enable gyro sensor
    conf.mode = INV_ICM42600_SENSOR_MODE_LOW_NOISE;
    ret = inv_icm42600_set_gyro_conf(st, &conf, core::ptr::null_mut());
    if (ret)
    goto exit;
...
#[no_mangle]
pub unsafe extern "C" fn inv_icm42600_gyro_parse_fifo(indio_dev: *mut iio_dev) -> c_int {
...
// buffer is copied to userspace, zeroing it to avoid any data leak
    let mut buffer: inv_icm42600_gyro_buffer = { };
...
// skip packet if no gyro data or data is invalid
    if (gyro == core::ptr::null_mut() || !inv_icm42600_fifo_is_data_valid(gyro))
    continue;
// update odr
