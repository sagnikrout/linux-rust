...
//! Source: drivers/iio/imu/inv_icm42600/inv_icm42600_i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn inv_icm42600_i2c_bus_setup(st: *mut inv_icm42600_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42600_probe(client: *mut i2c_client) -> c_int {
