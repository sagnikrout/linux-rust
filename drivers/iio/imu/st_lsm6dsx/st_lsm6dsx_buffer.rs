...
//! Source: drivers/iio/imu/st_lsm6dsx/st_lsm6dsx_buffer.c
#![no_std]
...
pub const ST_LSM6DSX_REG_FIFO_MODE_ADDR: c_uint = 0x0a;

pub const ST_LSM6DSX_REG_FIFO_OUTL_ADDR: c_uint = 0x3e;
pub const ST_LSM6DSX_REG_FIFO_OUT_TAG_ADDR: c_uint = 0x78;
pub const ST_LSM6DSX_REG_TS_RESET_ADDR: c_uint = 0x42;
pub const ST_LSM6DSX_MAX_FIFO_ODR_VAL: c_uint = 0x08;
pub const ST_LSM6DSX_TS_RESET_VAL: c_uint = 0xaa;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st_lsm6dsx_decimator_entry {
    pub decimator: u8,
    pub val: u8,
}
    ...
    {
    let mut max_size: c_int = ARRAY_SIZE(st_lsm6dsx_decimator_table);
    let mut decimator: u32 = max_odr / sensor.hwfifo_odr_mHz;
    int i;
    if (decimator > 1)
    ...
    let mut i: return = = max_size ? 0 : st_lsm6dsx_decimator_table[i].val;
    }
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_get_sip(sensor: *mut st_lsm6dsx_sensor, min_odr: u32) -> u8 {
    static u8 st_lsm6dsx_get_sip(struct st_lsm6dsx_sensor *sensor, u32 min_odr)
    {
    let mut sip: u8 = sensor.hwfifo_odr_mHz / min_odr;
    return sip > 1 ? round_down(sip, 2) : sip;
    }
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_update_decimators(hw: *mut st_lsm6dsx_hw) -> c_int {
    static int st_lsm6dsx_update_decimators(struct st_lsm6dsx_hw *hw)
    {
    const struct st_lsm6dsx_reg *ts_dec_reg;
    struct st_lsm6dsx_sensor *sensor;
    let mut sip: u16 = 0, ts_sip = 0;
    u32 max_odr, min_odr;
...
// update fifo decimators and sample in pattern
    ...
    if (dec_reg.addr) {
    let mut val: c_int = ST_LSM6DSX_SHIFT_VAL(data, dec_reg.mask);
...
#[no_mangle]
pub unsafe extern "C" fn st_lsm6dsx_update_watermark(sensor: *mut st_lsm6dsx_sensor, watermark: u16) -> c_int {
    int st_lsm6dsx_update_watermark(struct st_lsm6dsx_sensor *sensor, u16 watermark)
    {
    let mut fifo_watermark: u16 = ~0, cur_watermark, fifo_th_mask;
    struct st_lsm6dsx_hw *hw = sensor.hw;
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_reset_hw_ts(hw: *mut st_lsm6dsx_hw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn st_lsm6dsx_resume_fifo(hw: *mut st_lsm6dsx_hw) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn st_lsm6dsx_read_fifo(hw: *mut st_lsm6dsx_hw) -> c_int {
    int st_lsm6dsx_read_fifo(struct st_lsm6dsx_hw *hw)
    {
    struct st_lsm6dsx_sensor *acc_sensor, *gyro_sensor, *ext_sensor = core::ptr::null_mut();
    int err, sip, acc_sip, gyro_sip, ts_sip, ext_sip, read_len, offset;
    u16 fifo_len, pattern_len = hw.sip * ST_LSM6DSX_SAMPLE_SIZE;
    let mut fifo_diff_mask: u16 = hw.settings.fifo_ops.fifo_diff.mask;
    let mut reset_ts: bool = false;
    __le16 fifo_status;
    let mut ts: i64 = 0;
...
pub const ST_LSM6DSX_INVALID_SAMPLE: c_uint = 0x7ffd;
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_check_data(tag: u8, data: *mut __le16) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(BIT(ST_LSM6DSX_ID_EXT1): hw->enable_mask &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn st_lsm6dsx_read_tagged_fifo(hw: *mut st_lsm6dsx_hw) -> c_int {
    int st_lsm6dsx_read_tagged_fifo(struct st_lsm6dsx_hw *hw)
    {
    let mut pattern_len: u16 = hw.sip * ST_LSM6DSX_TAGGED_SAMPLE_SIZE;
...
#[no_mangle]
pub unsafe extern "C" fn st_lsm6dsx_flush_fifo(hw: *mut st_lsm6dsx_hw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn st_lsm6dsx_update_fifo(sensor: *mut st_lsm6dsx_sensor, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_buffer_preenable(iio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_buffer_postdisable(iio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn st_lsm6dsx_fifo_setup(hw: *mut st_lsm6dsx_hw) -> c_int {
...
//
    attrs = i == ST_LSM6DSX_ID_ACC ? st_lsm6dsx_buffer_attrs : core::ptr::null_mut();
