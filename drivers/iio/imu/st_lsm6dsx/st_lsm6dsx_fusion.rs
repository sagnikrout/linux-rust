...
//! Source: drivers/iio/imu/st_lsm6dsx/st_lsm6dsx_fusion.c
#![no_std]
...
//
    ...
    u32 odr_mHz, u8 *val)
    {
    let mut odr_hz: c_int = odr_mHz / MILLI;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_fusion_page_enable(hw: *mut st_lsm6dsx_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_fusion_page_disable(hw: *mut st_lsm6dsx_hw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn st_lsm6dsx_fusion_set_enable(sensor: *mut st_lsm6dsx_sensor, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn st_lsm6dsx_fusion_set_odr(sensor: *mut st_lsm6dsx_sensor, enable: bool) -> c_int {
...
// val2 = (sensor->hwfifo_odr_mHz % MILLI) * (MICRO / MILLI);
    ...
    switch (mask) {
    case IIO_CHAN_INFO_SAMP_FREQ: {
    let mut odr_mHz: u32 = val * MILLI + val2 * (MILLI / MICRO);
    u8 odr_val;
...
#[no_mangle]
pub unsafe extern "C" fn st_lsm6dsx_fusion_probe(hw: *mut st_lsm6dsx_hw, name: *const c_char) -> c_int {
