...
//! Source: drivers/iio/imu/st_lsm6dsx/st_lsm6dsx_core.c
#![no_std]
...
pub const ST_LSM6DSX_REG_WHOAMI_ADDR: c_uint = 0x0f;
...
#[no_mangle]
pub unsafe extern "C" fn st_lsm6dsx_set_page(hw: *mut st_lsm6dsx_hw, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn st_lsm6dsx_check_odr(sensor: *mut st_lsm6dsx_sensor, odr: u32, val: *mut u8) -> c_int {
...
// device already configured
    ...
    {
    struct st_lsm6dsx_hw *hw = sensor.hw;
    let mut odr: u32 = enable ? sensor.odr : 0;
    int err;
...
//
    ...
    int *val, int *val2)
    {
    let mut event: enum st_lsm6dsx_event_id = st_lsm6dsx_get_event_id(type);
    struct st_lsm6dsx_sensor *sensor = iio_priv(iio_dev);
    struct st_lsm6dsx_hw *hw = sensor.hw;
    const struct st_lsm6dsx_reg *reg;
    u8 data;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !st_lsm6dsx_check_other_events(hw, _arg: event)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn st_lsm6dsx_set_watermark(iio_dev: *mut iio_dev, val: c_uint) -> c_int {
    ...
    st_lsm6dsx_sysfs_scale_avail, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_init_shub(hw: *mut st_lsm6dsx_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_init_hw_timer(hw: *mut st_lsm6dsx_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_reset_device(hw: *mut st_lsm6dsx_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_init_device(hw: *mut st_lsm6dsx_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_report_motion_event(hw: *mut st_lsm6dsx_hw) -> bool {
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_handler_thread(irq: c_int, private: *mut c_void) -> irqreturn_t {
    static irqreturn_t st_lsm6dsx_handler_thread(int irq, void *private)
    {
    struct st_lsm6dsx_hw *hw = private;
    let mut fifo_len: c_int = 0, len;
    bool event;
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_irq_setup(hw: *mut st_lsm6dsx_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_sw_buffer_preenable(iio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_sw_buffer_postdisable(iio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_sw_buffers_setup(hw: *mut st_lsm6dsx_hw) -> c_int {
    ...
    hw.iio_devs[i], core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_init_regulators(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_lsm6dsx_resume(dev: *mut device) -> c_int {
