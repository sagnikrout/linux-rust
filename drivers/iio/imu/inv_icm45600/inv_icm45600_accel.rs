...
//! Source: drivers/iio/imu/inv_icm45600/inv_icm45600_accel.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct inv_icm45600_accel_buffer {
    pub accel: inv_icm45600_fifo_sensor_data,
    pub temp: i16,
...
#[no_mangle]
unsafe extern "C" fn _inv_icm45600_accel_write_odr(indio_dev: *mut iio_dev, odr: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn inv_icm45600_accel_parse_fifo(indio_dev: *mut iio_dev) -> c_int {
...
// parse all fifo packets
    ...
    let mut buffer: inv_icm45600_accel_buffer = { };
...
// skip packet if no accel data or data is invalid
    if (accel == core::ptr::null_mut() || !inv_icm45600_fifo_is_data_valid(accel))
    continue;
// update odr
