...
//! Source: drivers/iio/imu/inv_icm45600/inv_icm45600_gyro.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct inv_icm45600_gyro_buffer {
    pub gyro: inv_icm45600_fifo_sensor_data,
    pub temp: i16,
...
// enable gyro sensor
    conf.mode = gyro_st.power_mode;
    ret = inv_icm45600_set_gyro_conf(st, &conf, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn _inv_icm45600_gyro_write_odr(indio_dev: *mut iio_dev, odr: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn inv_icm45600_gyro_parse_fifo(indio_dev: *mut iio_dev) -> c_int {
...
// parse all fifo packets
    ...
    let mut buffer: inv_icm45600_gyro_buffer = { };
...
// skip packet if no gyro data or data is invalid
    if (gyro == core::ptr::null_mut() || !inv_icm45600_fifo_is_data_valid(gyro))
    continue;
// update odr
