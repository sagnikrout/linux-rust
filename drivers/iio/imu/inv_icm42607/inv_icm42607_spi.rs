...
//! Source: drivers/iio/imu/inv_icm42607/inv_icm42607_spi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn inv_icm42607_spi_bus_setup(st: *mut inv_icm42607_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42607_probe(spi: *mut spi_device) -> c_int {
