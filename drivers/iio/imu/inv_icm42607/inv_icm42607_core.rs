...
//! Source: drivers/iio/imu/inv_icm42607/inv_icm42607_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn inv_icm42607_is_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42607_is_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42607_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42607_odr_to_period_us(odr: enum inv_icm42607_odr) -> u32 {
...
//
    ...
    s16 *val)
    {
    let mut conf: inv_icm42607_sensor_conf = INV_ICM42607_SENSOR_CONF_INIT;
...
#[no_mangle]
unsafe extern "C" fn inv_icm42607_enable_vddio_reg(st: *mut inv_icm42607_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42607_sensors_off(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42607_disable_vddio_reg(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42607_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42607_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inv_icm42607_runtime_suspend(dev: *mut device) -> c_int {
...
//
    ...
    RUNTIME_PM_OPS(inv_icm42607_runtime_suspend, core::ptr::null_mut(), core::ptr::null_mut())
    };
