...
//! Source: drivers/iio/imu/smi240.c
#![no_std]
...
pub const SMI240_CHIP_ID: c_uint = 0x0024;

pub const SMI240_CHIP_ID_REG: c_uint = 0x00;
pub const SMI240_SOFT_CONFIG_REG: c_uint = 0x0A;
pub const SMI240_TEMP_CUR_REG: c_uint = 0x10;
pub const SMI240_ACCEL_X_CUR_REG: c_uint = 0x11;
pub const SMI240_GYRO_X_CUR_REG: c_uint = 0x14;
pub const SMI240_DATA_CAP_FIRST_REG: c_uint = 0x17;
pub const SMI240_CMD_REG: c_uint = 0x2F;
pub const SMI240_SOFT_RESET_CMD: c_uint = 0xB6;
pub const SMI240_BITE_SEQUENCE_DELAY_US: c_int = 140000;
pub const SMI240_FILTER_FLUSH_DELAY_US: c_int = 60000;
pub const SMI240_DIGITAL_STARTUP_DELAY_US: c_int = 120000;
pub const SMI240_MECH_STARTUP_DELAY_US: c_int = 100000;
pub const SMI240_BUS_ID: c_uint = 0x00;
pub const SMI240_CRC_INIT: c_uint = 0x05;
pub const SMI240_CRC_POLY: c_uint = 0x0B;

// T°C = (temp / 256) + 25

pub const SMI240_LOW_BANDWIDTH_HZ: c_int = 50;
pub const SMI240_HIGH_BANDWIDTH_HZ: c_int = 400;
pub const SMI240_BUILT_IN_SELF_TEST_COUNT: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct smi240_data {
    pub regmap: *mut regmap,
    pub accel_filter_freq: u16,
    pub anglvel_filter_freq: u16,
    pub built_in_self_test_count: u8,
    pub capture: enum capture_mode,
//
...
//
    pub __aligned(8): s16 buf[12],
    pub __aligned(IIO_DMA_MINALIGN): __be32 spi_buf,
}
...
#[no_mangle]
unsafe extern "C" fn smi240_crc3(data: u32, init: u8, poly: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn smi240_sensor_data_is_valid(data: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn smi240_soft_reset(data: *mut smi240_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi240_soft_config(data: *mut smi240_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi240_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
    static irqreturn_t smi240_trigger_handler(int irq, void *p)
    {
    struct iio_poll_func *pf = p;
    struct iio_dev *indio_dev = pf.indio_dev;
    struct smi240_data *data = iio_priv(indio_dev);
    let mut base: c_int = SMI240_DATA_CAP_FIRST_REG, i = 0;
    int ret, chan, sample;
...
#[no_mangle]
unsafe extern "C" fn smi240_init(data: *mut smi240_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi240_probe(spi: *mut spi_device) -> c_int {
    ...
    smi240_trigger_handler, core::ptr::null_mut());
    if (ret)
    return dev_err_probe(dev, ret,
