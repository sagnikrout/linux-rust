...
//! Source: drivers/iio/imu/bmi270/bmi270_core.c
#![no_std]
...
pub const BMI270_CHIP_ID_REG: c_uint = 0x00;
// Checked to prevent sending incompatible firmware to BMI160 devices
pub const BMI160_CHIP_ID_VAL: c_uint = 0xD1;
pub const BMI260_CHIP_ID_VAL: c_uint = 0x27;
pub const BMI270_CHIP_ID_VAL: c_uint = 0x24;

pub const BMI270_ACCEL_X_REG: c_uint = 0x0c;
pub const BMI270_ANG_VEL_X_REG: c_uint = 0x12;
pub const BMI270_INT_STATUS_0_REG: c_uint = 0x1c;

pub const BMI270_INT_STATUS_1_REG: c_uint = 0x1d;

pub const BMI270_SC_OUT_0_REG: c_uint = 0x1e;
pub const BMI270_INTERNAL_STATUS_REG: c_uint = 0x21;

pub const BMI270_INTERNAL_STATUS_MSG_INIT_OK: c_uint = 0x01;

pub const BMI270_TEMPERATURE_0_REG: c_uint = 0x22;
pub const BMI270_FEAT_PAGE_REG: c_uint = 0x2f;
pub const BMI270_ACC_CONF_REG: c_uint = 0x40;

pub const BMI270_ACC_CONF_ODR_100HZ: c_uint = 0x08;

pub const BMI270_ACC_CONF_BWP_NORMAL_MODE: c_uint = 0x02;

pub const BMI270_ACC_CONF_RANGE_REG: c_uint = 0x41;

pub const BMI270_GYR_CONF_REG: c_uint = 0x42;

pub const BMI270_GYR_CONF_ODR_200HZ: c_uint = 0x09;

pub const BMI270_GYR_CONF_BWP_NORMAL_MODE: c_uint = 0x02;

pub const BMI270_GYR_CONF_RANGE_REG: c_uint = 0x43;

pub const BMI270_INT1_IO_CTRL_REG: c_uint = 0x53;
pub const BMI270_INT2_IO_CTRL_REG: c_uint = 0x54;

pub const BMI270_INT_LATCH_REG: c_uint = 0x55;

pub const BMI270_INT1_MAP_FEAT_REG: c_uint = 0x56;
pub const BMI270_INT2_MAP_FEAT_REG: c_uint = 0x57;

pub const BMI270_INT_MAP_DATA_REG: c_uint = 0x58;

pub const BMI270_INIT_CTRL_REG: c_uint = 0x59;

pub const BMI270_INIT_DATA_REG: c_uint = 0x5e;
pub const BMI270_PWR_CONF_REG: c_uint = 0x7c;

pub const BMI270_PWR_CTRL_REG: c_uint = 0x7d;

// See pages 92 and 93 of the datasheet

pub const BMI270_MOTION_DURAT_SCALE: c_int = 50;
pub const BMI270_MOTION_DURAT_MAX: c_int = 162;
// 9.81 * 1000000 m/s^2
pub const BMI270_G_MICRO_M_S_2: c_int = 9810000;
// See datasheet section 4.6.14, Temperature Sensor
pub const BMI270_TEMP_OFFSET: c_int = 11776;
pub const BMI270_TEMP_SCALE: c_int = 1953125;
// See page 90 of datasheet. The step counter "holds implicitly a 20x factor"
pub const BMI270_STEP_COUNTER_FACTOR: c_int = 20;
pub const BMI270_STEP_COUNTER_MAX: c_int = 20460;
...
pub struct bmi270_data {
    ...
    pub chip_info: *const bmi270_chip_info,
    pub irq_pin: enum bmi270_irq_pin,
...
//
    pub __aligned(IIO_DMA_MINALIGN): __le16 regval,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bmi270_scale_item {
    pub tbl: *const bmi270_scale,
    pub num: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bmi270_odr_item {
    pub tbl: *const bmi270_odr,
    pub vals: *const u8,
    pub num: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn bmi270_enable_steps(data: *mut bmi270_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi270_read_steps(data: *mut bmi270_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi270_int_map_reg(pin: enum bmi270_irq_pin) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi270_step_wtrmrk_en(data: *mut bmi270_data, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi270_motion_reg(type: enum iio_event_type, info: enum iio_event_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi270_nomotion_event_en(data: *mut bmi270_data, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi270_set_scale(data: *mut bmi270_data, chan_type: c_int, uscale: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi270_irq_thread_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bmi270_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bmi270_validate_chip_id(data: *mut bmi270_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(bmi270_chip_info.chip_id: chip_id ==) -> else {
    else if (chip_id == bmi270_chip_info.chip_id)
    data.chip_info = &bmi270_chip_info;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn bmi270_write_calibration_data(data: *mut bmi270_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi270_configure_imu(data: *mut bmi270_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi270_chip_init(data: *mut bmi270_data) -> c_int {
    ...
    bmi270_trigger_handler, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn bmi270_core_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi270_core_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(bmi270_core_runtime_suspend, bmi270_core_runtime_resume, core::ptr::null_mut())
    };
