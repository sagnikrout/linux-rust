...
//! Source: drivers/iio/imu/adis16480.c
#![no_std]
...
pub const ADIS16480_PAGE_SIZE: c_uint = 0x80;

pub const ADIS16480_REG_PAGE_ID: c_uint = 0x00 /* Same address on each page */;
...
pub const ADIS16495_GYRO_ACCEL_BURST_ID: c_uint = 0xA5A5;
pub const ADIS16545_DELTA_ANG_VEL_BURST_ID: c_uint = 0xC3C3;
// total number of segments in burst
pub const ADIS16495_BURST_MAX_DATA: c_int = 20;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adis16480_chip_info {
    ...
    pub temp_scale: c_uint,
    pub deltang_max_val: c_uint,
    pub deltvel_max_val: c_uint,
    pub int_clk: c_uint,
    pub max_dec_rate: c_uint,
    pub filter_freqs: *const c_uint,
    pub has_pps_clk_mode: bool,
    pub has_sleep_cnt: bool,
    pub has_burst_delta_data: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adis16480 {
    pub chip_info: *const adis16480_chip_info,
    pub adis: adis,
    pub ext_clk: *mut clk,
    pub clk_mode: enum adis16480_clock_mode,
    pub clk_freq: c_uint,
    pub burst_id: u16,
// Alignment needed for the timestamp
    pub __aligned(8): __be16 data[ADIS16495_BURST_MAX_DATA],
}
...
#[no_mangle]
unsafe extern "C" fn adis16480_show_serial_number(arg: *mut c_void, val: *mut u64) -> c_int {
...
// val = serial;
    ...
    adis16480_show_serial_number, core::ptr::null_mut(), "0x%.4llx\n");
#[no_mangle]
unsafe extern "C" fn adis16480_show_product_id(arg: *mut c_void, val: *mut u64) -> c_int {
...
// val = prod_id;
    ...
    adis16480_show_product_id, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn adis16480_show_flash_count(arg: *mut c_void, val: *mut u64) -> c_int {
...
// val = flash_count;
    ...
    adis16480_show_flash_count, core::ptr::null_mut(), "%lld\n");
#[no_mangle]
unsafe extern "C" fn adis16480_debugfs_init(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn adis16480_set_freq(indio_dev: *mut iio_dev, val: c_int, val2: c_int) -> c_int {
...
//
    ...
    let mut scaled_rate: c_ulong = lcm(st.clk_freq, t);
    int sync_scale;
//
...
#[no_mangle]
unsafe extern "C" fn adis16480_get_freq(indio_dev: *mut iio_dev, val: *mut c_int, val2: *mut c_int) -> c_int {
...
// val2 = (freq % 1000) * 1000;
    ...
    {
    let mut reg: c_uint = adis16480_calibbias_regs[chan.scan_index];
    struct adis16480 *st = iio_priv(indio_dev);
    switch (chan.type) {
    case IIO_MAGN:
    case IIO_PRESSURE:
...
// bias = sign_extend32(val32, 31);
    ...
    {
    let mut reg: c_uint = adis16480_calibscale_regs[chan.scan_index];
    struct adis16480 *st = iio_priv(indio_dev);
...
pub const ADIS16480_DIAG_STAT_XGYRO_FAIL: c_int = 0;
pub const ADIS16480_DIAG_STAT_YGYRO_FAIL: c_int = 1;
pub const ADIS16480_DIAG_STAT_ZGYRO_FAIL: c_int = 2;
pub const ADIS16480_DIAG_STAT_XACCL_FAIL: c_int = 3;
pub const ADIS16480_DIAG_STAT_YACCL_FAIL: c_int = 4;
pub const ADIS16480_DIAG_STAT_ZACCL_FAIL: c_int = 5;
pub const ADIS16480_DIAG_STAT_XMAGN_FAIL: c_int = 8;
pub const ADIS16480_DIAG_STAT_YMAGN_FAIL: c_int = 9;
pub const ADIS16480_DIAG_STAT_ZMAGN_FAIL: c_int = 10;
pub const ADIS16480_DIAG_STAT_BARO_FAIL: c_int = 11;
...
#[no_mangle]
unsafe extern "C" fn adis16480_validate_crc(buf: *const u16, n_elem: u8, crc: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn adis16480_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
//
    ...
    let mut curr: u16 = be16_to_cpu(buffer[offset]);
    let mut next: u16 = be16_to_cpu(buffer[offset + 1]);
...
#[no_mangle]
unsafe extern "C" fn adis16480_stop_device(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16480_enable_irq(adis: *mut adis, enable: bool) -> c_int {
    static int adis16480_enable_irq(struct adis *adis, bool enable)
    {
    uint16_t val;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn adis16480_config_irq_pin(st: *mut adis16480) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16480_fw_get_ext_clk_pin(st: *mut adis16480) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16480_ext_clk_config(st: *mut adis16480, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16480_get_ext_clocks(st: *mut adis16480) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16480_stop(data: *mut c_void) {
    static void adis16480_stop(void *data)
    {
    adis16480_stop_device(data);
    }
#[no_mangle]
unsafe extern "C" fn adis16480_clk_disable(data: *mut c_void) {
    static void adis16480_clk_disable(void *data)
    {
    clk_disable_unprepare(data);
    }
#[no_mangle]
unsafe extern "C" fn adis16480_probe(spi: *mut spi_device) -> c_int {
    static int adis16480_probe(struct spi_device *spi)
    {
    const struct spi_device_id *id = spi_get_device_id(spi);
    const struct adis_data *adis16480_data;
    let mut trigger_handler: irq_handler_t = core::ptr::null_mut();
