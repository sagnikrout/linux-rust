...
//! Source: drivers/iio/imu/bmi323/bmi323_core.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bmi323_hw {
    pub data: u8,
    pub config: u8,
    pub (*scale_table)[2]: *const c_int,
    pub scale_table_len: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bmi323_regs_runtime_pm {
    pub reg_settings: [c_uint; ARRAY_SIZE(bmi323_reg_savestate)],
    pub ext_reg_settings: [c_uint; ARRAY_SIZE(bmi323_ext_reg_savestate)],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bmi323_data {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub orientation: iio_mount_matrix,
    pub irq_pin: enum bmi323_irq_pin,
    pub trig: *mut iio_trigger,
    pub state: enum bmi323_state,
    pub old_fifo_tstamp: s64 fifo_tstamp,,
    pub odrns: [u32; BMI323_SENSORS_CNT],
    pub odrhz: [u32; BMI323_SENSORS_CNT],
    pub feature_events: c_uint,
    pub runtime_pm_status: bmi323_regs_runtime_pm,
//
...
//
    pub mutex: mutex,
    pub watermark: c_int,
    pub __aligned(IIO_DMA_MINALIGN): __le16 fifo_buff[BMI323_FIFO_FULL_IN_WORDS],
    struct {
    pub channels: [__le16; BMI323_CHAN_MAX],
    pub ts: aligned_s64,
    pub buffer: },
    pub steps_count: [__le16; BMI323_STEP_LEN],
}
...
#[no_mangle]
unsafe extern "C" fn bmi323_iio_to_sensor(iio_type: enum iio_chan_type) -> enum bmi323_sensor_type {
...
#[no_mangle]
unsafe extern "C" fn bmi323_get_error_status(data: *mut bmi323_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_step_wtrmrk_en(data: *mut bmi323_data, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_motion_config_reg(dir: enum iio_event_direction) -> c_int {
    ...
    {
    let mut state_value: c_uint = state ? BMI323_FEAT_XYZ_MSK : 0;
...
#[no_mangle]
unsafe extern "C" fn __bmi323_fifo_flush(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_set_watermark(indio_dev: *mut iio_dev, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_fifo_disable(data: *mut bmi323_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_update_watermark(data: *mut bmi323_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_fifo_enable(data: *mut bmi323_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_irq_thread_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bmi323_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
// Lock to protect the data->buffer
    ...
    {
    let mut raw: c_int = ARRAY_SIZE(bmi323_accel_gyro_avrg);
    while (raw--)
...
#[no_mangle]
unsafe extern "C" fn bmi323_enable_steps(data: *mut bmi323_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_read_steps(data: *mut bmi323_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_get_temp_data(data: *mut bmi323_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_feature_engine_enable(data: *mut bmi323_data, en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_disable(data_ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn bmi323_init(data: *mut bmi323_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_init_reset(data: *mut bmi323_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bmi323_core_probe(dev: *mut device) -> c_int {
    ...
    int ret;
    regmap = dev_get_regmap(dev, core::ptr::null_mut());
    if (!regmap)
...
#[no_mangle]
unsafe extern "C" fn bmi323_core_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmi323_core_runtime_resume(dev: *mut device) -> c_int {
...
//
    ...
    bmi323_core_runtime_resume, core::ptr::null_mut())
    };
