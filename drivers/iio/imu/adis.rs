...
//
    ...
    unsigned int size)
    {
    let mut page: c_uint = reg / ADIS_PAGE_SIZE;
    int ret, i;
...
//
#[no_mangle]
pub unsafe extern "C" fn __adis_enable_irq(adis: *mut adis, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __adis_check_status(adis: *mut adis) -> c_int {
    int __adis_check_status(struct adis *adis)
    {
    unsigned int status;
    int diag_stat_bits;
    let mut status_16: u16 = 0;
    int ret;
    int i;
...
//
#[no_mangle]
pub unsafe extern "C" fn __adis_reset(adis: *mut adis) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis_self_test(adis: *mut adis) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __adis_initial_startup(adis: *mut adis) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(!adis->ops->reset: !adis->ops->write || !adis->ops->read ||) -> else {
