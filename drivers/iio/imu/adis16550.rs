...
//! Source: drivers/iio/imu/adis16550.c
#![no_std]
...
pub const ADIS16550_REG_BURST_GYRO_ACCEL: c_uint = 0x0a;
pub const ADIS16550_REG_BURST_DELTA_ANG_VEL: c_uint = 0x0b;

pub const ADIS16550_REG_STATUS: c_uint = 0x0e;
pub const ADIS16550_REG_TEMP: c_uint = 0x10;
pub const ADIS16550_REG_X_GYRO: c_uint = 0x12;
pub const ADIS16550_REG_Y_GYRO: c_uint = 0x14;
pub const ADIS16550_REG_Z_GYRO: c_uint = 0x16;
pub const ADIS16550_REG_X_ACCEL: c_uint = 0x18;
pub const ADIS16550_REG_Y_ACCEL: c_uint = 0x1a;
pub const ADIS16550_REG_Z_ACCEL: c_uint = 0x1c;
pub const ADIS16550_REG_X_DELTANG_L: c_uint = 0x1E;
pub const ADIS16550_REG_Y_DELTANG_L: c_uint = 0x20;
pub const ADIS16550_REG_Z_DELTANG_L: c_uint = 0x22;
pub const ADIS16550_REG_X_DELTVEL_L: c_uint = 0x24;
pub const ADIS16550_REG_Y_DELTVEL_L: c_uint = 0x26;
pub const ADIS16550_REG_Z_DELTVEL_L: c_uint = 0x28;
pub const ADIS16550_REG_X_GYRO_SCALE: c_uint = 0x30;
pub const ADIS16550_REG_Y_GYRO_SCALE: c_uint = 0x32;
pub const ADIS16550_REG_Z_GYRO_SCALE: c_uint = 0x34;
pub const ADIS16550_REG_X_ACCEL_SCALE: c_uint = 0x36;
pub const ADIS16550_REG_Y_ACCEL_SCALE: c_uint = 0x38;
pub const ADIS16550_REG_Z_ACCEL_SCALE: c_uint = 0x3a;
pub const ADIS16550_REG_X_GYRO_BIAS: c_uint = 0x40;
pub const ADIS16550_REG_Y_GYRO_BIAS: c_uint = 0x42;
pub const ADIS16550_REG_Z_GYRO_BIAS: c_uint = 0x44;
pub const ADIS16550_REG_X_ACCEL_BIAS: c_uint = 0x46;
pub const ADIS16550_REG_Y_ACCEL_BIAS: c_uint = 0x48;
pub const ADIS16550_REG_Z_ACCEL_BIAS: c_uint = 0x4a;
pub const ADIS16550_REG_COMMAND: c_uint = 0x50;
pub const ADIS16550_REG_CONFIG: c_uint = 0x52;

    (ADIS16550_SYNC_EN_MASK | ADIS16550_SYNC_MODE_MASK)

// max of 4000 SPS in scale sync

pub const ADIS16550_REG_DEC_RATE: c_uint = 0x54;
pub const ADIS16550_REG_SYNC_SCALE: c_uint = 0x56;
pub const ADIS16550_REG_SERIAL_NUM: c_uint = 0x76;
pub const ADIS16550_REG_FW_REV: c_uint = 0x7A;
pub const ADIS16550_REG_FW_DATE: c_uint = 0x7C;
pub const ADIS16550_REG_PROD_ID: c_uint = 0x7E;
pub const ADIS16550_REG_FLASH_CNT: c_uint = 0x72;
// SPI protocol

// burst read
pub const ADIS16550_BURST_N_ELEM: c_int = 12;

pub const ADIS16550_MAX_SCAN_DATA: c_int = 12;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adis16550_sync {
    pub sync_mode: u16,
    pub min_rate: u16,
    pub max_rate: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adis16550 {
    pub adis: adis,
    pub clk_freq_hz: c_ulong,
    pub sync_mode: u32,
    pub xfer: [spi_transfer; 2],
    pub __aligned(IIO_DMA_MINALIGN): u8 buffer[ADIS16550_BURST_DATA_LEN + sizeof(u32)],
    pub din: [__be32; 2],
    pub dout: [__be32; 2],
}
...
//
#[no_mangle]
unsafe extern "C" fn spi_crc4(val: u32) -> u8 {
    static u8 spi_crc4(const u32 val)
    {
    int i;
    let mut bits: c_int = 28;
    let mut crc: u8 = 0xa;
// ignore 4lsb
    let mut __val: u32 = val >> 4;
...
// din = cpu_to_be32(__din);
    ...
    let mut wr: bool = readval ? false : true;
...
// readval = (*readval & GENMASK(31, 16)) | data;
    ...
    {
    return adis16550_spi_xfer(adis, reg, len, core::ptr::null_mut(), value);
    }
...
#[no_mangle]
unsafe extern "C" fn adis16550_show_serial_number(arg: *mut c_void, val: *mut u64) -> c_int {
...
// val = serial;
    ...
    adis16550_show_serial_number, core::ptr::null_mut(), "0x%.8llx\n");
#[no_mangle]
unsafe extern "C" fn adis16550_show_product_id(arg: *mut c_void, val: *mut u64) -> c_int {
...
// val = prod_id;
    ...
    adis16550_show_product_id, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn adis16550_show_flash_count(arg: *mut c_void, val: *mut u64) -> c_int {
...
// val = flash_count;
    ...
    adis16550_show_flash_count, core::ptr::null_mut(), "%lld\n");
#[no_mangle]
unsafe extern "C" fn adis16550_debugfs_init(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn adis16550_get_freq(st: *mut adis16550, freq: *mut u32) -> c_int {
    static int adis16550_get_freq(struct adis16550 *st, u32 *freq)
    {
    int ret;
    let mut dec: u16 = 0;
    let mut sample_rate: u32 = st.clk_freq_hz;
...
#[no_mangle]
unsafe extern "C" fn adis16550_set_freq_hz(st: *mut adis16550, freq_hz: u32) -> c_int {
...
//
    let mut max_sample_rate: u32 = 4000 * 1000 + 500000;
    let mut min_sample_rate: u32 = 4000 * 1000 - 1000000;
    if (!freq_hz)
    return -EINVAL;
    adis_dev_auto_lock(&st.adis);
    if (st.sync_mode == ADIS16550_SYNC_MODE_SCALED) {
    let mut scaled_rate: c_ulong = lcm(st.clk_freq_hz, freq_hz);
    int sync_scale;
...
#[no_mangle]
unsafe extern "C" fn adis16550_get_accl_filter_freq(st: *mut adis16550, freq_hz: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16550_set_accl_filter_freq(st: *mut adis16550, freq_hz: c_int) -> c_int {
    static int adis16550_set_accl_filter_freq(struct adis16550 *st, int freq_hz)
    {
    let mut en: u8 = freq_hz ? 1 : 0;
    let mut val: u16 = FIELD_PREP(ADIS16550_ACCL_FIR_EN_MASK, en);
    return __adis_update_bits(&st.adis, ADIS16550_REG_CONFIG,
    ADIS16550_ACCL_FIR_EN_MASK, val);
    }
#[no_mangle]
unsafe extern "C" fn adis16550_get_gyro_filter_freq(st: *mut adis16550, freq_hz: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16550_set_gyro_filter_freq(st: *mut adis16550, freq_hz: c_int) -> c_int {
    static int adis16550_set_gyro_filter_freq(struct adis16550 *st, int freq_hz)
    {
    let mut en: u8 = freq_hz ? 1 : 0;
    let mut val: u16 = FIELD_PREP(ADIS16550_GYRO_FIR_EN_MASK, en);
    return __adis_update_bits(&st.adis, ADIS16550_REG_CONFIG,
    ...
    {
    struct adis16550 *st = iio_priv(indio_dev);
    let mut idx: c_int = chan.scan_index;
    u16 scale;
    int ret;
    u32 tmp;
    switch (info) {
...
#[no_mangle]
unsafe extern "C" fn adis16550_validate_crc(buffer: *mut __be32, n_elem: u8) -> u32 {
    static u32 adis16550_validate_crc(__be32 *buffer, const u8 n_elem)
    {
    int i;
    u32 crc_calc;
    u32 crc_buf[ADIS16550_BURST_N_ELEM - 2];
    let mut crc: u32 = be32_to_cpu(buffer[ADIS16550_BURST_N_ELEM - 1]);
//
...
#[no_mangle]
unsafe extern "C" fn adis16550_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
// copy the temperature together with sensor data
    ...
    {
    let mut burst_length: u16 = ADIS16550_BURST_DATA_LEN;
    struct adis16550 *st = iio_priv(indio_dev);
    u8 burst_cmd;
    u8 *tx;
...
#[no_mangle]
unsafe extern "C" fn adis16550_reset(adis: *mut adis) -> c_int {
    static int adis16550_reset(struct adis *adis)
    {
    return __adis_write_reg_16(adis, ADIS16550_REG_COMMAND, BIT(15));
    }
#[no_mangle]
unsafe extern "C" fn adis16550_config_sync(st: *mut adis16550) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16550_probe(spi: *mut spi_device) -> c_int {
