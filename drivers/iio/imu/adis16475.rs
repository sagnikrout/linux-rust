...
//! Source: drivers/iio/imu/adis16475.c
#![no_std]
...
pub const ADIS16475_REG_DIAG_STAT: c_uint = 0x02;
pub const ADIS16475_REG_X_GYRO_L: c_uint = 0x04;
pub const ADIS16475_REG_Y_GYRO_L: c_uint = 0x08;
pub const ADIS16475_REG_Z_GYRO_L: c_uint = 0x0C;
pub const ADIS16475_REG_X_ACCEL_L: c_uint = 0x10;
pub const ADIS16475_REG_Y_ACCEL_L: c_uint = 0x14;
pub const ADIS16475_REG_Z_ACCEL_L: c_uint = 0x18;
pub const ADIS16475_REG_TEMP_OUT: c_uint = 0x1c;
pub const ADIS16475_REG_X_DELTANG_L: c_uint = 0x24;
pub const ADIS16475_REG_Y_DELTANG_L: c_uint = 0x28;
pub const ADIS16475_REG_Z_DELTANG_L: c_uint = 0x2C;
pub const ADIS16475_REG_X_DELTVEL_L: c_uint = 0x30;
pub const ADIS16475_REG_Y_DELTVEL_L: c_uint = 0x34;
pub const ADIS16475_REG_Z_DELTVEL_L: c_uint = 0x38;
pub const ADIS16475_REG_X_GYRO_BIAS_L: c_uint = 0x40;
pub const ADIS16475_REG_Y_GYRO_BIAS_L: c_uint = 0x44;
pub const ADIS16475_REG_Z_GYRO_BIAS_L: c_uint = 0x48;
pub const ADIS16475_REG_X_ACCEL_BIAS_L: c_uint = 0x4c;
pub const ADIS16475_REG_Y_ACCEL_BIAS_L: c_uint = 0x50;
pub const ADIS16475_REG_Z_ACCEL_BIAS_L: c_uint = 0x54;
pub const ADIS16475_REG_FILT_CTRL: c_uint = 0x5c;

pub const ADIS16475_REG_MSG_CTRL: c_uint = 0x60;

    FIELD_PREP(ADIS16475_MSG_CTRL_DR_POL_MASK, x)

pub const ADIS16475_REG_UP_SCALE: c_uint = 0x62;
pub const ADIS16475_REG_DEC_RATE: c_uint = 0x64;
pub const ADIS16475_REG_GLOB_CMD: c_uint = 0x68;
pub const ADIS16475_REG_FIRM_REV: c_uint = 0x6c;
pub const ADIS16475_REG_FIRM_DM: c_uint = 0x6e;
pub const ADIS16475_REG_FIRM_Y: c_uint = 0x70;
pub const ADIS16475_REG_PROD_ID: c_uint = 0x72;
pub const ADIS16475_REG_SERIAL_NUM: c_uint = 0x74;
pub const ADIS16475_REG_FLASH_CNT: c_uint = 0x7c;

// number of data elements in burst mode
pub const ADIS16475_BURST32_MAX_DATA_NO_TS32: c_int = 32;
pub const ADIS16575_BURST32_DATA_TS32: c_int = 34;
pub const ADIS16475_BURST_MAX_DATA: c_int = 20;
pub const ADIS16475_MAX_SCAN_DATA: c_int = 20;
// spi max speed in brust mode
pub const ADIS16475_BURST_MAX_SPEED: c_int = 1000000;
pub const ADIS16575_BURST_MAX_SPEED: c_int = 8000000;
pub const ADIS16475_LSB_DEC_MASK: c_int = 0;
pub const ADIS16475_LSB_FIR_MASK: c_int = 1;

pub const ADIS16475_REG_FIFO_CTRL: c_uint = 0x5A;

pub const ADIS16575_REG_FIFO_CNT: c_uint = 0x3C;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adis16475_chip_info {
    pub channels: *const iio_chan_spec,
    pub sync: *const adis16475_sync,
    pub adis_data: adis_data,
    pub name: *const c_char,

    pub flags: c_long,
    pub num_channels: u32,
    pub gyro_max_val: u32,
    pub gyro_max_scale: u32,
    pub accel_max_val: u32,
    pub accel_max_scale: u32,
    pub temp_scale: u32,
    pub deltang_max_val: u32,
    pub deltvel_max_val: u32,
    pub int_clk: u32,
    pub max_dec: u16,
    pub num_sync: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adis16475 {
    pub info: *const adis16475_chip_info,
    pub adis: adis,
    pub clk_freq: u32,
    pub burst32: bool,
    pub lsb_flag: c_ulong,
    pub sync_mode: u16,
    pub fifo_watermark: u16,
// Alignment needed for the timestamp
    pub __aligned(8): __be16 data[ADIS16475_MAX_SCAN_DATA],
}
...
#[no_mangle]
unsafe extern "C" fn adis16475_show_serial_number(arg: *mut c_void, val: *mut u64) -> c_int {
...
// val = serial;
    ...
    adis16475_show_serial_number, core::ptr::null_mut(), "0x%.4llx\n");
#[no_mangle]
unsafe extern "C" fn adis16475_show_product_id(arg: *mut c_void, val: *mut u64) -> c_int {
...
// val = prod_id;
    ...
    adis16475_show_product_id, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn adis16475_show_flash_count(arg: *mut c_void, val: *mut u64) -> c_int {
...
// val = flash_count;
    ...
    adis16475_show_flash_count, core::ptr::null_mut(), "%lld\n");
#[no_mangle]
unsafe extern "C" fn adis16475_debugfs_init(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn adis16475_get_freq(st: *mut adis16475, freq: *mut u32) -> c_int {
    static int adis16475_get_freq(struct adis16475 *st, u32 *freq)
    {
    int ret;
    u16 dec;
    let mut sample_rate: u32 = st.clk_freq;
...
#[no_mangle]
unsafe extern "C" fn adis16475_set_freq(st: *mut adis16475, freq: u32) -> c_int {
...
// The optimal sample rate for the supported IMUs is between int_clk - 100 and int_clk + 100.
    let mut max_sample_rate: u32 = st.info.int_clk * 1000 + 100000;
    let mut min_sample_rate: u32 = st.info.int_clk * 1000 - 100000;
    if (!freq)
    return -EINVAL;
    adis_dev_auto_lock(&st.adis);
//
...
//
    if (st.sync_mode == ADIS16475_SYNC_SCALED) {
    let mut scaled_rate: c_ulong = lcm(st.clk_freq, freq);
    int sync_scale;
//
...
#[no_mangle]
unsafe extern "C" fn adis16475_get_filter(st: *mut adis16475, filter: *mut u32) -> c_int {
    static int adis16475_get_filter(struct adis16475 *st, u32 *filter)
    {
    u16 filter_sz;
    int ret;
    let mut mask: c_int = ADIS16475_FILT_CTRL_MASK;
...
#[no_mangle]
unsafe extern "C" fn adis16475_set_filter(st: *mut adis16475, filter: u32) -> c_int {
    static int adis16475_set_filter(struct adis16475 *st, const u32 filter)
    {
    let mut i: c_int = ARRAY_SIZE(adis16475_3db_freqs);
    int ret;
    while (--i) {
...
//
    ...
    adis16475_get_fifo_watermark, core::ptr::null_mut(), 0);
    static IIO_DEVICE_ATTR(hwfifo_enabled, 0444,
    adis16475_get_fifo_enabled, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn adis16475_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16475_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16475_set_watermark(indio_dev: *mut iio_dev, val: c_uint) -> c_int {
...
//
    ...
    let mut en: u16 = ADIS16500_BURST32(0);
    ret = __adis_update_bits(&st.adis, ADIS16475_REG_MSG_CTRL,
    ADIS16500_BURST32_MASK, en);
    if (ret)
    return;
...
#[no_mangle]
unsafe extern "C" fn adis16475_push_single_sample(pf: *mut iio_poll_func) -> c_int {
    ...
    u16 crc;
    bool valid;
    let mut crc_offset: u8 = 9;
    let mut burst_size: u16 = ADIS16475_BURST_MAX_DATA;
    let mut start_idx: u16 = (st.info.flags & ADIS16475_HAS_TIMESTAMP32) ? 2 : 0;
// offset until the first element after gyro and accel
    let mut offset: u8 = st.burst32 ? 13 : 7;
    if (st.burst32) {
...
#[no_mangle]
unsafe extern "C" fn adis16475_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn adis16575_update_msg_for_burst(adis: *mut adis, burst_req: u8) {
...
#[no_mangle]
unsafe extern "C" fn adis16575_custom_burst_read(pf: *mut iio_poll_func, burst_req: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adis16475_trigger_handler_with_fifo(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn adis16475_config_sync_mode(st: *mut adis16475) -> c_int {
    ...
    u32 sync_mode;
    let mut max_sample_rate: u16 = st.info.int_clk + 100;
    u16 val;
...
// All the other modes require external input signal
    ...
    struct clk *clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
    if (IS_ERR(clk))
    return PTR_ERR(clk);
...
#[no_mangle]
unsafe extern "C" fn adis16475_config_irq_pin(st: *mut adis16475) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16475_probe(spi: *mut spi_device) -> c_int {
