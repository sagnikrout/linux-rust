...
//! Source: drivers/iio/imu/smi330/smi330_core.c
#![no_std]
...
// Register map
pub const SMI330_CHIP_ID_REG: c_uint = 0x00;
pub const SMI330_ERR_REG: c_uint = 0x01;
pub const SMI330_STATUS_REG: c_uint = 0x02;
pub const SMI330_ACCEL_X_REG: c_uint = 0x03;
pub const SMI330_GYRO_X_REG: c_uint = 0x06;
pub const SMI330_TEMP_REG: c_uint = 0x09;
pub const SMI330_INT1_STATUS_REG: c_uint = 0x0D;
pub const SMI330_ACCEL_CFG_REG: c_uint = 0x20;
pub const SMI330_GYRO_CFG_REG: c_uint = 0x21;
pub const SMI330_IO_INT_CTRL_REG: c_uint = 0x38;
pub const SMI330_INT_CONF_REG: c_uint = 0x39;
pub const SMI330_INT_MAP1_REG: c_uint = 0x3A;
pub const SMI330_INT_MAP2_REG: c_uint = 0x3B;
pub const SMI330_CMD_REG: c_uint = 0x7E;
// Register mask

// Register values

pub const SMI330_CMD_SOFT_RESET: c_uint = 0xDEAF;
// T°C = (temp / 512) + 23

pub const SMI330_CHIP_ID: c_uint = 0x42;
pub const SMI330_SOFT_RESET_DELAY: c_int = 2000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct smi330_attributes {
    pub reg_vals: *mut c_int,
    pub vals: *mut c_int,
    pub len: c_int,
    pub type: c_int,
    pub mask: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct smi330_cfg {
    pub op_mode: enum smi330_operation_mode,
    pub data_irq: enum smi330_int_out,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct smi330_data {
    pub regmap: *mut regmap,
    pub cfg: smi330_cfg,
    pub trig: *mut iio_trigger,
    pub SMI330_SCAN_LEN): IIO_DECLARE_BUFFER_WITH_TS(__le16, buf,,
}
...
#[no_mangle]
unsafe extern "C" fn smi330_get_config_reg(sensor: enum smi330_sensor, reg: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi330_soft_reset(data: *mut smi330_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi330_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn smi330_irq_thread_handler(irq: c_int, indio_dev_: *mut c_void) -> irqreturn_t {
    ...
    if (ret)
    return ret;
    return devm_request_threaded_irq(dev, irq, core::ptr::null_mut(),
    smi330_irq_thread_handler,
    irq_type | IRQF_ONESHOT,
    indio_dev.name, indio_dev);
    }
#[no_mangle]
unsafe extern "C" fn smi330_register_irq(dev: *mut device, indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi330_set_drdy_trigger_state(trig: *mut iio_trigger, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi330_dev_init(data: *mut smi330_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smi330_core_probe(dev: *mut device, regmap: *mut regmap) -> c_int {
...
// Set default operation mode to data ready.
    ...
    smi330_trigger_handler, core::ptr::null_mut());
    if (ret)
