...
//! Source: drivers/iio/imu/adis_buffer.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn adis_paging_trigger_handler(adis: *mut adis) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn adis_buffer_cleanup(arg: *mut c_void) {
