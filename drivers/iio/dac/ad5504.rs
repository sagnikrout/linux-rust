...
//! Source: drivers/iio/dac/ad5504.c
#![no_std]
...
pub const AD5504_CMD_WRITE: c_int = 0;

// Registers
pub const AD5504_ADDR_NOOP: c_int = 0;

pub const AD5504_ADDR_ALL_DAC: c_int = 5;
pub const AD5504_ADDR_CTRL: c_int = 7;
// Control Register

pub const AD5504_DAC_PWRDN_20K: c_int = 0;
pub const AD5504_DAC_PWRDN_3STATE: c_int = 1;
//
...
#[no_mangle]
unsafe extern "C" fn ad5504_spi_write(st: *mut ad5504_state, addr: u8, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5504_spi_read(st: *mut ad5504_state, addr: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5504_event_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad5504_probe(spi: *mut spi_device) -> c_int {
