...
//! Source: drivers/iio/dac/rohm-bd79703.c
#![no_std]
...
pub const BD79703_MAX_REGISTER: c_uint = 0xf;
pub const BD79703_DAC_BITS: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn bd79703_probe(spi: *mut spi_device) -> c_int {
