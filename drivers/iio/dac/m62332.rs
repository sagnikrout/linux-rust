...
//! Source: drivers/iio/dac/m62332.c
#![no_std]
...
pub const M62332_CHANNELS: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct m62332_data {
    pub client: *mut i2c_client,
    pub vcc: *mut regulator,
    pub mutex: mutex,
    pub raw: [u8; M62332_CHANNELS],
    pub save: [u8; M62332_CHANNELS],
}

#[no_mangle]
unsafe extern "C" fn m62332_set_value(indio_dev: *mut iio_dev, val: u8, channel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m62332_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m62332_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m62332_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m62332_remove(client: *mut i2c_client) {
