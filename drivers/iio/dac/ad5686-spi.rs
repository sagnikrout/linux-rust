...
//! Source: drivers/iio/dac/ad5686-spi.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5686_spi_data {
    pub msg: spi_message,
    pub size: c_uint,
    pub capacity: c_uint,
    pub __counted_by(capacity): spi_transfer xfers[],
}
...
//
    ...
    let mut buf: auto = &st.data[bus_data.size];
...
#[no_mangle]
unsafe extern "C" fn ad5686_spi_sync(st: *mut ad5686_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5686_spi_read(st: *mut ad5686_state, addr: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5686_spi_probe(spi: *mut spi_device) -> c_int {
