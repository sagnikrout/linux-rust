...
//! Source: drivers/iio/dac/mcf54415_dac.c
#![no_std]
...
pub const MCF54415_DAC_CR: c_uint = 0x00;

pub const MCF54415_DAC_DATA: c_uint = 0x02;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcf54415_dac {
    pub map: *mut regmap,
    pub clk: *mut clk,
}
...
#[no_mangle]
unsafe extern "C" fn mcf54415_dac_init(info: *mut mcf54415_dac) -> c_int {
    static int mcf54415_dac_init(struct mcf54415_dac *info)
    {
    let mut val: u16 = MCF54415_DAC_CR_FILT | FIELD_PREP(MCF54415_DAC_CR_WMLVL, 1);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mcf54415_dac_exit(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mcf54415_dac_probe(pdev: *mut platform_device) -> c_int {
