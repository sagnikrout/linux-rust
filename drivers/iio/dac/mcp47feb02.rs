...
//! Source: drivers/iio/dac/mcp47feb02.c
#![no_std]
...
pub const MCP47FEB02_DAC0_REG_ADDR: c_uint = 0x00;
pub const MCP47FEB02_VREF_REG_ADDR: c_uint = 0x40;
pub const MCP47FEB02_POWER_DOWN_REG_ADDR: c_uint = 0x48;

pub const MCP47FEB02_GAIN_CTRL_STATUS_REG_ADDR: c_uint = 0x50;

pub const MCP47FEB02_WIPERLOCK_STATUS_REG_ADDR: c_uint = 0x58;
pub const MCP47FEB02_NV_DAC0_REG_ADDR: c_uint = 0x80;
pub const MCP47FEB02_NV_VREF_REG_ADDR: c_uint = 0xC0;
pub const MCP47FEB02_NV_POWER_DOWN_REG_ADDR: c_uint = 0xC8;
pub const MCP47FEB02_NV_GAIN_CTRL_I2C_SLAVE_REG_ADDR: c_uint = 0xD0;
...
pub const MCP47FEB02_MAX_CH: c_int = 8;
pub const MCP47FEB02_MAX_SCALES_CH: c_int = 3;
pub const MCP47FEB02_DAC_WIPER_UNLOCKED: c_int = 0;
pub const MCP47FEB02_NORMAL_OPERATION: c_int = 0;
pub const MCP47FEB02_INTERNAL_BAND_GAP_uV: c_int = 2440000;
pub const NV_DAC_ADDR_OFFSET: c_uint = 0x10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp47feb02_features {
    pub name: *const c_char,
    pub phys_channels: c_uint,
    pub resolution: c_uint,
    pub have_ext_vref1: bool,
    pub have_eeprom: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp47feb02_channel_data {
    pub ref_mode: u8,
    pub use_2x_gain: bool,
    pub powerdown: bool,
    pub powerdown_mode: u8,
    pub dac_data: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp47feb02_data {
    pub chdata: [mcp47feb02_channel_data; MCP47FEB02_MAX_CH],
    pub /: *mut *mut mutex lock; / prevents concurrent reads/writes to driver's state members,
    pub chip_features: *const mcp47feb02_features,
    pub MCP47FEB02_MAX_SCALES_CH]: *mut *mut int scale_1[2,
    pub MCP47FEB02_MAX_SCALES_CH]: *mut *mut int scale[2,
    pub active_channels_mask: c_ulong,
    pub regmap: *mut regmap,
    pub labels: [*const c_char; MCP47FEB02_MAX_CH],
    pub phys_channels: u16,
    pub vref1_buffered: bool,
...
#[no_mangle]
unsafe extern "C" fn mcp47feb02_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp47feb02_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp47feb02_get_scale(ch: c_int, data: *mut mcp47feb02_data, val: *mut c_int, val2: *mut c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: data->chdata[ch].use_2x_gain) -> else {
...
#[no_mangle]
unsafe extern "C" fn mcp47feb02_check_scale(data: *mut mcp47feb02_data, val: c_int, val2: c_int, scale[]: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp47feb02_ch_scale(data: *mut mcp47feb02_data, ch: c_int, scale: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mcp47feb02_set_scale(data: *mut mcp47feb02_data, ch: c_int, scale: c_int) -> c_int {
    ...
    {
    let mut chanspec: iio_chan_spec = mcp47febxx_ch_template;
    struct mcp47feb02_data *data = iio_priv(indio_dev);
    struct device *dev = regmap_get_device(data.regmap);
    struct iio_chan_spec *channels;
    u32 num_channels;
    let mut chan_idx: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn mcp47feb02_init_ctrl_regs(data: *mut mcp47feb02_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp47feb02_probe(client: *mut i2c_client) -> c_int {
