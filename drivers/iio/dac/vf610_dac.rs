...
//! Source: drivers/iio/dac/vf610_dac.c
#![no_std]
...
pub const VF610_DACx_STATCTRL: c_uint = 0x20;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vf610_dac {
    pub clk: *mut clk,
    pub dev: *mut device,
    pub conv_mode: enum vf610_conversion_mode_sel,
    pub regs: *mut void __iomem,
    pub lock: mutex,
}

#[no_mangle]
unsafe extern "C" fn vf610_dac_init(info: *mut vf610_dac) {
...
#[no_mangle]
unsafe extern "C" fn vf610_dac_exit(info: *mut vf610_dac) {
...
#[no_mangle]
unsafe extern "C" fn vf610_dac_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vf610_dac_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn vf610_dac_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vf610_dac_resume(dev: *mut device) -> c_int {
