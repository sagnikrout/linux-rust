...
//! Source: drivers/iio/dac/ad5696-i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ad5686_i2c_read(st: *mut ad5686_state, addr: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5686_i2c_probe(i2c: *mut i2c_client) -> c_int {
    ...
    if (!info)
    return -ENODATA;
    return ad5686_probe(&i2c.dev, info, i2c.name, &ad5686_i2c_ops, core::ptr::null_mut());
    }
