...
//! Source: drivers/iio/dac/ti-dac5571.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dac5571_data {
    pub client: *mut i2c_client,
    pub lock: mutex,
    pub vref: *mut regulator,
    pub val: [u16; 4],
    pub powerdown: [bool; 4],
    pub powerdown_mode: [u8; 4],
    pub spec: *const dac5571_spec,
    pub val): *mut *mut *mut int (dac5571_cmd)(struct dac5571_data data, int channel, u16,
    pub pwrdwn): *mut *mut *mut int (dac5571_pwrdwn)(struct dac5571_data data, int channel, u8,
    pub __aligned(IIO_DMA_MINALIGN): u8 buf[3],
}

pub const DAC5571_CHANNEL_SELECT: c_int = 1;

pub const DAC5571_SINGLE_PWRDWN_BITS: c_int = 4;
pub const DAC5571_QUAD_PWRDWN_BITS: c_int = 6;
#[no_mangle]
unsafe extern "C" fn dac5571_cmd_single(data: *mut dac5571_data, channel: c_int, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dac5571_cmd_quad(data: *mut dac5571_data, channel: c_int, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dac5571_pwrdwn_single(data: *mut dac5571_data, channel: c_int, pwrdwn: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dac5571_pwrdwn_quad(data: *mut dac5571_data, channel: c_int, pwrdwn: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dac5571_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dac5571_remove(i2c: *mut i2c_client) {
