...
//! Source: drivers/iio/dac/ad5064.c
#![no_std]
...
pub const AD5064_MAX_DAC_CHANNELS: c_int = 8;
pub const AD5064_MAX_VREFS: c_int = 4;

pub const AD5064_ADDR_ALL_DAC: c_uint = 0xF;
pub const AD5064_CMD_WRITE_INPUT_N: c_uint = 0x0;
pub const AD5064_CMD_UPDATE_DAC_N: c_uint = 0x1;
pub const AD5064_CMD_WRITE_INPUT_N_UPDATE_ALL: c_uint = 0x2;
pub const AD5064_CMD_WRITE_INPUT_N_UPDATE_N: c_uint = 0x3;
pub const AD5064_CMD_POWERDOWN_DAC: c_uint = 0x4;
pub const AD5064_CMD_CLEAR: c_uint = 0x5;
pub const AD5064_CMD_LDAC_MASK: c_uint = 0x6;
pub const AD5064_CMD_RESET: c_uint = 0x7;
pub const AD5064_CMD_CONFIG: c_uint = 0x8;
pub const AD5064_CMD_RESET_V2: c_uint = 0x5;
pub const AD5064_CMD_CONFIG_V2: c_uint = 0x7;

pub const AD5064_LDAC_PWRDN_NONE: c_uint = 0x0;
pub const AD5064_LDAC_PWRDN_1K: c_uint = 0x1;
pub const AD5064_LDAC_PWRDN_100K: c_uint = 0x2;
pub const AD5064_LDAC_PWRDN_3STATE: c_uint = 0x3;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5064_chip_info {
    pub shared_vref: bool,
    pub internal_vref: c_ulong,
    pub channels: *const iio_chan_spec,
    pub num_channels: c_uint,
    pub regmap_type: enum ad5064_regmap_type,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5064_state {
    pub dev: *mut device,
    pub chip_info: *const ad5064_chip_info,
    pub vref_reg: [regulator_bulk_data; AD5064_MAX_VREFS],
    pub pwr_down: [bool; AD5064_MAX_DAC_CHANNELS],
    pub pwr_down_mode: [u8; AD5064_MAX_DAC_CHANNELS],
    pub dac_cache: [c_uint; AD5064_MAX_DAC_CHANNELS],
    pub use_internal_vref: bool,
    pub write: ad5064_write_func,
    pub lock: mutex,
//
...
#[no_mangle]
pub unsafe extern "C" fn ad5064_num_vref(st: *mut ad5064_state) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ad5064_set_config(st: *mut ad5064_state, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5064_request_vref(st: *mut ad5064_state, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5064_bulk_reg_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ad5064_spi_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5064_spi_register_driver() -> int __init {
    static int __init ad5064_spi_register_driver(void)
    {
    return spi_register_driver(&ad5064_spi_driver);
    }
#[no_mangle]
unsafe extern "C" fn ad5064_spi_unregister_driver() {
...
#[no_mangle]
unsafe extern "C" fn ad5064_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5064_i2c_register_driver() -> int __init {
    static int __init ad5064_i2c_register_driver(void)
    {
    return i2c_add_driver(&ad5064_i2c_driver);
    }
#[no_mangle]
unsafe extern "C" fn ad5064_i2c_unregister_driver() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn ad5064_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ad5064_exit() -> void __exit {
