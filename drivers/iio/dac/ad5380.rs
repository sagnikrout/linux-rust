...
//! Source: drivers/iio/dac/ad5380.c
#![no_std]
...
pub const AD5380_CTRL_PWR_DOWN_MODE_OFFSET: c_int = 13;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5380_state {
    pub regmap: *mut regmap,
    pub chip_info: *const ad5380_chip_info,
    pub vref: c_int,
    pub pwr_down: bool,
    pub lock: mutex,
}
    ...
    {
    let mut max_val: c_uint = (1 << chan.scan_type.realbits);
    struct ad5380_state *st = iio_priv(indio_dev);
    switch (info) {
    case IIO_CHAN_INFO_RAW:
    case IIO_CHAN_INFO_CALIBSCALE:
...
#[no_mangle]
unsafe extern "C" fn ad5380_alloc_channels(dev: *mut device, indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5380_reg_false(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ad5380_spi_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ad5380_spi_register_driver() -> c_int {
    static inline int ad5380_spi_register_driver(void)
    {
    return spi_register_driver(&ad5380_spi_driver);
    }
#[no_mangle]
pub unsafe extern "C" fn ad5380_spi_unregister_driver() {
...
#[no_mangle]
unsafe extern "C" fn ad5380_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ad5380_i2c_register_driver() -> c_int {
    static inline int ad5380_i2c_register_driver(void)
    {
    return i2c_add_driver(&ad5380_i2c_driver);
    }
#[no_mangle]
pub unsafe extern "C" fn ad5380_i2c_unregister_driver() {
...
#[no_mangle]
unsafe extern "C" fn ad5380_spi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ad5380_spi_exit() -> void __exit {
