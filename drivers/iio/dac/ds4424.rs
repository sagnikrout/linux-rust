...
//! Source: drivers/iio/dac/ds4424.c
#![no_std]
...
pub const DS4422_MAX_DAC_CHANNELS: c_int = 2;
pub const DS4424_MAX_DAC_CHANNELS: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ds4424_data {
    pub regmap: *mut regmap,
    pub vcc_reg: *mut regulator,
    pub chip_info: *const ds4424_chip_info,
    pub rfs_ohms: [u32; DS4424_MAX_DAC_CHANNELS],
    pub has_rfs: bool,
}
...
#[no_mangle]
unsafe extern "C" fn ds4424_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds4424_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds4424_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds4424_remove(client: *mut i2c_client) {
