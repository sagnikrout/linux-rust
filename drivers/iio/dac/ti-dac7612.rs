...
//! Source: drivers/iio/dac/ti-dac7612.c
#![no_std]
...
pub const DAC7612_RESOLUTION: c_int = 12;
pub const DAC7612_ADDRESS: c_int = 4;
pub const DAC7612_START: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dac7612 {
    pub spi: *mut spi_device,
    pub loaddacs: *mut gpio_desc,
    pub cache: [u16; 2],
//
...
//
    pub __aligned(IIO_DMA_MINALIGN): uint8_t data[2],
}

#[no_mangle]
unsafe extern "C" fn dac7612_cmd_single(priv: *mut dac7612, channel: c_int, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dac7612_probe(spi: *mut spi_device) -> c_int {
