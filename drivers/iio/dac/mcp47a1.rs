...
//! Source: drivers/iio/dac/mcp47a1.c
#![no_std]
...
pub const MCP47A1_CMD_CODE: c_uint = 0x00;
pub const MCP47A1_MAX_STEPS: c_int = 64;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp47a1_data {
...
#[no_mangle]
unsafe extern "C" fn mcp47a1_probe(client: *mut i2c_client) -> c_int {
