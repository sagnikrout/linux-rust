...
//! Source: drivers/iio/dac/ad8460.c
#![no_std]
...
pub const AD8460_DEFAULT_FAULT_PROTECT: c_uint = 0x00;
pub const AD8460_DATA_BYTE_WORD_LENGTH: c_int = 2;
pub const AD8460_NUM_DATA_WORDS: c_int = 16;
pub const AD8460_NOMINAL_VOLTAGE_SPAN: c_int = 80;
pub const AD8460_MIN_EXT_RESISTOR_OHMS: c_int = 2000;
pub const AD8460_MAX_EXT_RESISTOR_OHMS: c_int = 20000;
pub const AD8460_MIN_VREFIO_UV: c_int = 120000;
pub const AD8460_MAX_VREFIO_UV: c_int = 1200000;
pub const AD8460_ABS_MAX_OVERVOLTAGE_UV: c_int = 55000000;
pub const AD8460_ABS_MAX_OVERCURRENT_UA: c_int = 1000000;
pub const AD8460_MAX_OVERTEMPERATURE_MC: c_int = 150000;
pub const AD8460_MIN_OVERTEMPERATURE_MC: c_int = 20000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad8460_state {
    pub spi: *mut spi_device,
    pub regmap: *mut regmap,
    pub tmp_adc_channel: *mut iio_channel,
    pub sync_clk: *mut clk,
// lock to protect against multiple access to the device and shared data
    pub lock: mutex,
    pub refio_1p2v_mv: c_int,
    pub ext_resistor_ohms: u32,
//
// DMA (thus cache coherency maintenance) requires the
// transfer buffers to live in their own cache lines.
//
    pub __aligned(IIO_DMA_MINALIGN): __le16 spi_tx_buf,
}

#[no_mangle]
unsafe extern "C" fn ad8460_hv_reset(state: *mut ad8460_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad8460_reset(state: *const ad8460_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad8460_enable_apg_mode(state: *mut ad8460_state, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad8460_read_shutdown_flag(state: *mut ad8460_state, flag: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad8460_get_hvdac_word(state: *mut ad8460_state, index: c_int, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad8460_set_hvdac_word(state: *mut ad8460_state, index: c_int, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad8460_set_sample(state: *mut ad8460_state, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad8460_select_fault_type(chan_type: c_int, dir: enum iio_event_direction) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad8460_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad8460_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad8460_probe(spi: *mut spi_device) -> c_int {
    ...
    if (ret)
    return ret;
    state.sync_clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
