...
//! Source: drivers/iio/dac/ad5791.c
#![no_std]
...
pub const AD5791_CMD_WRITE: c_int = 0;

// Registers
pub const AD5791_ADDR_NOOP: c_int = 0;
pub const AD5791_ADDR_DAC0: c_int = 1;
pub const AD5791_ADDR_CTRL: c_int = 2;
pub const AD5791_ADDR_CLRCODE: c_int = 3;
pub const AD5791_ADDR_SW_CTRL: c_int = 4;
// Control Register

pub const AD5791_LINCOMP_0_10: c_int = 0;
pub const AD5791_LINCOMP_10_12: c_int = 1;
pub const AD5791_LINCOMP_12_16: c_int = 2;
pub const AD5791_LINCOMP_16_19: c_int = 3;
pub const AD5791_LINCOMP_19_20: c_int = 12;
pub const AD5780_LINCOMP_0_10: c_int = 0;
pub const AD5780_LINCOMP_10_20: c_int = 12;
// Software Control Register

pub const AD5791_DAC_PWRDN_6K: c_int = 0;
pub const AD5791_DAC_PWRDN_3STATE: c_int = 1;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5791_chip_info {
    pub name: *const c_char,
    pub channel: iio_chan_spec,
    pub channel_offload: iio_chan_spec,
    pub span): *mut *mut int (get_lin_comp)(unsigned int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5791_state {
    pub spi: *mut spi_device,
    pub gpio_reset: *mut gpio_desc,
    pub gpio_clear: *mut gpio_desc,
    pub gpio_ldac: *mut gpio_desc,
    pub chip_info: *const ad5791_chip_info,
    ...
    pub offload_trigger_hz: c_uint,
    pub vref_mv: c_ushort,
    pub vref_neg_mv: c_uint,
    pub ctrl: unsigned,
...
#[no_mangle]
unsafe extern "C" fn ad5791_spi_write(st: *mut ad5791_state, addr: u8, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5791_spi_read(st: *mut ad5791_state, addr: u8, val: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(AD5791_DAC_PWRDN_3STATE: st->pwr_down_mode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ad5791_get_lin_comp(span: c_uint) -> c_int {
    static int ad5791_get_lin_comp(unsigned int span)
    {
    if (span <= 10000)
    return AD5791_LINCOMP_0_10;
#[no_mangle]
pub unsafe extern "C" fn if(12000: span <=) -> else {
    else if (span <= 12000)
    return AD5791_LINCOMP_10_12;
#[no_mangle]
pub unsafe extern "C" fn if(16000: span <=) -> else {
    else if (span <= 16000)
    return AD5791_LINCOMP_12_16;
#[no_mangle]
pub unsafe extern "C" fn if(19000: span <=) -> else {
    else if (span <= 19000)
...
#[no_mangle]
unsafe extern "C" fn ad5780_get_lin_comp(span: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5791_set_sample_freq(st: *mut ad5791_state, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5791_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5791_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5791_offload_setup(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5791_probe(spi: *mut spi_device) -> c_int {
