...
//! Source: drivers/iio/dac/ad5758.c
#![no_std]
...
pub const AD5758_NOP: c_uint = 0x00;
pub const AD5758_DAC_INPUT: c_uint = 0x01;
pub const AD5758_DAC_OUTPUT: c_uint = 0x02;
pub const AD5758_CLEAR_CODE: c_uint = 0x03;
pub const AD5758_USER_GAIN: c_uint = 0x04;
pub const AD5758_USER_OFFSET: c_uint = 0x05;
pub const AD5758_DAC_CONFIG: c_uint = 0x06;
pub const AD5758_SW_LDAC: c_uint = 0x07;
pub const AD5758_KEY: c_uint = 0x08;
pub const AD5758_GP_CONFIG1: c_uint = 0x09;
pub const AD5758_GP_CONFIG2: c_uint = 0x0A;
pub const AD5758_DCDC_CONFIG1: c_uint = 0x0B;
pub const AD5758_DCDC_CONFIG2: c_uint = 0x0C;
pub const AD5758_WDT_CONFIG: c_uint = 0x0F;
pub const AD5758_DIGITAL_DIAG_CONFIG: c_uint = 0x10;
pub const AD5758_ADC_CONFIG: c_uint = 0x11;
pub const AD5758_FAULT_PIN_CONFIG: c_uint = 0x12;
pub const AD5758_TWO_STAGE_READBACK_SELECT: c_uint = 0x13;
pub const AD5758_DIGITAL_DIAG_RESULTS: c_uint = 0x14;
pub const AD5758_ANALOG_DIAG_RESULTS: c_uint = 0x15;
pub const AD5758_STATUS: c_uint = 0x16;
pub const AD5758_CHIP_ID: c_uint = 0x17;
pub const AD5758_FREQ_MONITOR: c_uint = 0x18;
pub const AD5758_DEVICE_ID_0: c_uint = 0x19;
pub const AD5758_DEVICE_ID_1: c_uint = 0x1A;
pub const AD5758_DEVICE_ID_2: c_uint = 0x1B;
pub const AD5758_DEVICE_ID_3: c_uint = 0x1C;
// AD5758_DAC_CONFIG

// AD5758_KEY
pub const AD5758_KEY_CODE_RESET_1: c_uint = 0x15FA;
pub const AD5758_KEY_CODE_RESET_2: c_uint = 0xAF51;
pub const AD5758_KEY_CODE_SINGLE_ADC_CONV: c_uint = 0x1ADC;
pub const AD5758_KEY_CODE_RESET_WDT: c_uint = 0x0D06;
pub const AD5758_KEY_CODE_CALIB_MEM_REFRESH: c_uint = 0xFCBA;
// AD5758_DCDC_CONFIG1
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5758_state {
    pub spi: *mut spi_device,
    pub lock: mutex,
    pub gpio_reset: *mut gpio_desc,
    pub out_range: ad5758_range,
    pub dc_dc_mode: c_uint,
    pub dc_dc_ilim: c_uint,
    pub slew_time: c_uint,
    pub pwr_down: bool,
    pub d32: [__be32; 3],
}
...
#[no_mangle]
unsafe extern "C" fn ad5758_spi_reg_read(st: *mut ad5758_state, addr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmpfunc(a: *const c_void, b: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5758_calib_mem_refresh(st: *mut ad5758_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5758_soft_reset(st: *mut ad5758_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5758_set_dc_dc_ilim(st: *mut ad5758_state, ilim: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5758_slew_rate_config(st: *mut ad5758_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5758_set_out_range(st: *mut ad5758_state, range: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5758_internal_buffers_en(st: *mut ad5758_state, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5758_reset(st: *mut ad5758_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5758_is_valid_mode(mode: enum ad5758_dc_dc_mode) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ad5758_crc_disable(st: *mut ad5758_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5758_parse_dt(st: *mut ad5758_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5758_init(st: *mut ad5758_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5758_probe(spi: *mut spi_device) -> c_int {
