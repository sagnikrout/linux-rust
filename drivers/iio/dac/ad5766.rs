...
//! Source: drivers/iio/dac/ad5766.c
#![no_std]
...
pub const AD5766_CMD_NOP_MUX_OUT: c_uint = 0x00;
pub const AD5766_CMD_SDO_CNTRL: c_uint = 0x01;

pub const AD5766_CMD_SW_LDAC: c_uint = 0x30;
pub const AD5766_CMD_SPAN_REG: c_uint = 0x40;
pub const AD5766_CMD_WR_PWR_DITHER: c_uint = 0x51;
pub const AD5766_CMD_WR_DAC_REG_ALL: c_uint = 0x60;
pub const AD5766_CMD_SW_FULL_RESET: c_uint = 0x70;

pub const AD5766_CMD_DITHER_SIG_1: c_uint = 0x90;
pub const AD5766_CMD_DITHER_SIG_2: c_uint = 0xA0;
pub const AD5766_CMD_INV_DITHER: c_uint = 0xB0;
pub const AD5766_CMD_DITHER_SCALE_1: c_uint = 0xC0;
pub const AD5766_CMD_DITHER_SCALE_2: c_uint = 0xD0;
pub const AD5766_FULL_RESET_CODE: c_uint = 0x1234;
    enum ad5766_type {
    ID_AD5766,
    ID_AD5767,
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5766_state {
    pub spi: *mut spi_device,
    pub lock: mutex,
    pub chip_info: *const ad5766_chip_info,
    pub gpio_reset: *mut gpio_desc,
    pub crt_range: enum ad5766_voltage_range,
    pub dither_enable: u16,
    pub dither_invert: u16,
    pub dither_source: u32,
...
#[no_mangle]
unsafe extern "C" fn __ad5766_spi_read(st: *mut ad5766_state, dac: u8, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ad5766_spi_write(st: *mut ad5766_state, command: u8, data: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5766_read(indio_dev: *mut iio_dev, dac: u8, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5766_write(indio_dev: *mut iio_dev, dac: u8, data: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5766_reset(st: *mut ad5766_state) -> c_int {
...
// val2 = st->chip_info->channels[0].scan_type.realbits;
    ...
    case IIO_CHAN_INFO_RAW:
    {
    let mut max_val: c_int = GENMASK(chan.scan_type.realbits - 1, 0);
...
#[no_mangle]
unsafe extern "C" fn ad5766_get_output_range(st: *mut ad5766_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5766_default_setup(st: *mut ad5766_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5766_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad5766_probe(spi: *mut spi_device) -> c_int {
...
// Configure trigger buffer
    ret = devm_iio_triggered_buffer_setup_ext(&spi.dev, indio_dev, core::ptr::null_mut(),
