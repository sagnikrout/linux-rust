...
//! Source: drivers/iio/dac/adi-axi-dac.c
#![no_std]
...
//
// Base controls
pub const AXI_DAC_CONFIG_REG: c_uint = 0x0c;

// DAC controls
pub const AXI_DAC_RSTN_REG: c_uint = 0x0040;

pub const AXI_DAC_CNTRL_1_REG: c_uint = 0x0044;

pub const AXI_DAC_CNTRL_2_REG: c_uint = 0x0048;

pub const AXI_DAC_STATUS_1_REG: c_uint = 0x0054;
pub const AXI_DAC_STATUS_2_REG: c_uint = 0x0058;
pub const AXI_DAC_DRP_STATUS_REG: c_uint = 0x0074;

pub const AXI_DAC_CUSTOM_RD_REG: c_uint = 0x0080;
pub const AXI_DAC_CUSTOM_WR_REG: c_uint = 0x0084;

pub const AXI_DAC_UI_STATUS_REG: c_uint = 0x0088;

pub const AXI_DAC_CUSTOM_CTRL_REG: c_uint = 0x008C;

    AXI_DAC_CUSTOM_CTRL_STREAM)
// DAC Channel controls

pub const AXI_DAC_CHAN_CNTRL_MAX: c_int = 15;

// 360 degrees in rad
pub const AXI_DAC_2_PI_MEGA: c_int = 6283190;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct axi_dac_info {
    pub version: c_uint,
    pub backend_info: *const iio_backend_info,
    pub has_dac_clk: bool,
    pub has_child_nodes: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct axi_dac_state {
...
//
    pub lock: mutex,
    pub info: *const axi_dac_info,
    pub dac_clk: u64,
    pub reg_config: u32,
    pub dac_clk_rate: c_int,
}

#[no_mangle]
unsafe extern "C" fn axi_dac_enable(back: *mut iio_backend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_dac_disable(back: *mut iio_backend) {
...
#[no_mangle]
unsafe extern "C" fn axi_dac_ddr_enable(back: *mut iio_backend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_dac_ddr_disable(back: *mut iio_backend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_dac_wait_bus_free(st: *mut axi_dac_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_dac_data_stream_enable(back: *mut iio_backend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_dac_data_stream_disable(back: *mut iio_backend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_dac_data_transfer_addr(back: *mut iio_backend, address: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_dac_child_remove(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn axi_dac_probe(pdev: *mut platform_device) -> c_int {
