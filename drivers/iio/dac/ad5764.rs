...
//! Source: drivers/iio/dac/ad5764.c
#![no_std]
...
pub const AD5764_REG_SF_NOP: c_uint = 0x0;
pub const AD5764_REG_SF_CONFIG: c_uint = 0x1;
pub const AD5764_REG_SF_CLEAR: c_uint = 0x4;
pub const AD5764_REG_SF_LOAD: c_uint = 0x5;

pub const AD5764_NUM_CHANNELS: c_int = 4;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5764_state {
    pub spi: *mut spi_device,
    pub chip_info: *const ad5764_chip_info,
    pub vref_reg: [regulator_bulk_data; 2],
    pub lock: mutex,
//
...
#[no_mangle]
unsafe extern "C" fn ad5764_chan_info_to_reg(chan: *const iio_chan_spec, info: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5764_probe(spi: *mut spi_device) -> c_int {
    static int ad5764_probe(struct spi_device *spi)
    {
    let mut type: enum ad5764_type = spi_get_device_id(spi).driver_data;
...
#[no_mangle]
unsafe extern "C" fn ad5764_remove(spi: *mut spi_device) {
