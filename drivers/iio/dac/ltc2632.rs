...
//! Source: drivers/iio/dac/ltc2632.c
#![no_std]
...
pub const LTC2632_CMD_WRITE_INPUT_N: c_uint = 0x0;
pub const LTC2632_CMD_UPDATE_DAC_N: c_uint = 0x1;
pub const LTC2632_CMD_WRITE_INPUT_N_UPDATE_ALL: c_uint = 0x2;
pub const LTC2632_CMD_WRITE_INPUT_N_UPDATE_N: c_uint = 0x3;
pub const LTC2632_CMD_POWERDOWN_DAC_N: c_uint = 0x4;
pub const LTC2632_CMD_POWERDOWN_CHIP: c_uint = 0x5;
pub const LTC2632_CMD_INTERNAL_REFER: c_uint = 0x6;
pub const LTC2632_CMD_EXTERNAL_REFER: c_uint = 0x7;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltc2632_state {
    pub spi_dev: *mut spi_device,
    pub powerdown_cache_mask: c_uint,
    pub vref_mv: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn ltc2632_probe(spi: *mut spi_device) -> c_int {
