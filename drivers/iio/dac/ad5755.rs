...
//! Source: drivers/iio/dac/ad5755.c
#![no_std]
...
pub const AD5755_NUM_CHANNELS: c_int = 4;

pub const AD5755_READ_REG_STATUS: c_uint = 0x18;
pub const AD5755_READ_REG_MAIN: c_uint = 0x19;
pub const AD5755_READ_REG_DC_DC: c_uint = 0x1a;
pub const AD5755_CTRL_REG_SLEW: c_uint = 0x0;
pub const AD5755_CTRL_REG_MAIN: c_uint = 0x1;
pub const AD5755_CTRL_REG_DAC: c_uint = 0x2;
pub const AD5755_CTRL_REG_DC_DC: c_uint = 0x3;
pub const AD5755_CTRL_REG_SW: c_uint = 0x4;
pub const AD5755_READ_FLAG: c_uint = 0x800000;
pub const AD5755_NOOP: c_uint = 0x1CE000;

pub const AD5755_DC_DC_MAXV: c_int = 0;
pub const AD5755_DC_DC_FREQ_SHIFT: c_int = 2;
pub const AD5755_DC_DC_PHASE_SHIFT: c_int = 4;

pub const AD5755_SLEW_STEP_SIZE_SHIFT: c_int = 0;
pub const AD5755_SLEW_RATE_SHIFT: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5755_platform_data {
    pub ext_dc_dc_compenstation_resistor: bool,
    pub dc_dc_phase: enum ad5755_dc_dc_phase,
    pub dc_dc_freq: enum ad5755_dc_dc_freq,
    pub dc_dc_maxv: enum ad5755_dc_dc_maxv,
    struct {
    pub mode: enum ad5755_mode,
    pub ext_current_sense_resistor: bool,
    pub enable_voltage_overrange: bool,
    struct {
    pub enable: bool,
    pub rate: enum ad5755_slew_rate,
    pub step_size: enum ad5755_slew_step_size,
    pub slew: },
    pub dac: [}; 4],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5755_chip_info {
    pub channel_template: iio_chan_spec,
    pub calib_shift: c_uint,
    pub has_voltage_out: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5755_state {
    pub spi: *mut spi_device,
    pub chip_info: *const ad5755_chip_info,
    pub pwr_down: c_uint,
    pub ctrl: [c_uint; AD5755_NUM_CHANNELS],
    pub channels: [iio_chan_spec; AD5755_NUM_CHANNELS],
    pub lock: mutex,
//
...
#[no_mangle]
unsafe extern "C" fn ad5755_read(indio_dev: *mut iio_dev, addr: c_uint) -> c_int {
    ...
    {
    struct ad5755_state *st = iio_priv(indio_dev);
    let mut mask: c_uint = BIT(channel);
    mutex_lock(&st.lock);
    ...
    {
    let mut mode: enum ad5755_mode = st.ctrl[chan.channel] & 7;
...
#[no_mangle]
unsafe extern "C" fn ad5755_is_valid_mode(st: *mut ad5755_state, mode: enum ad5755_mode) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ad5755_is_voltage_mode(mode: enum ad5755_mode) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ad5755_probe(spi: *mut spi_device) -> c_int {
