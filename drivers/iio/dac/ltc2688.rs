...
//! Source: drivers/iio/dac/ltc2688.c
#![no_std]
...
pub const LTC2688_DAC_CHANNELS: c_int = 16;

pub const LTC2688_CMD_CONFIG: c_uint = 0x70;
pub const LTC2688_CMD_POWERDOWN: c_uint = 0x71;
pub const LTC2688_CMD_A_B_SELECT: c_uint = 0x72;
pub const LTC2688_CMD_SW_TOGGLE: c_uint = 0x73;
pub const LTC2688_CMD_TOGGLE_DITHER_EN: c_uint = 0x74;
pub const LTC2688_CMD_THERMAL_STAT: c_uint = 0x77;
pub const LTC2688_CMD_UPDATE_ALL: c_uint = 0x7C;
pub const LTC2688_CMD_NOOP: c_uint = 0xFF;
pub const LTC2688_READ_OPERATION: c_uint = 0x80;
// Channel Settings

pub const LTC2688_CH_TGP_MAX: c_int = 3;

// Configuration register

pub const LTC2688_DITHER_FREQ_AVAIL_N: c_int = 5;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltc2688_chan {
    pub dither_frequency: [c_long; LTC2688_DITHER_FREQ_AVAIL_N],
    pub overrange: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltc2688_state {
    pub spi: *mut spi_device,
    pub regmap: *mut regmap,
    pub channels: [ltc2688_chan; LTC2688_DAC_CHANNELS],
...
//
    pub __aligned(IIO_DMA_MINALIGN): u8 tx_data[6],
    pub rx_data: [u8; 3],
}
...
#[no_mangle]
unsafe extern "C" fn ltc2688_spi_write(context: *mut c_void, data: *const c_void, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2688_span_get(st: *const ltc2688_state, c: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2688_scale_get(st: *const ltc2688_state, c: c_int, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2688_offset_get(st: *const ltc2688_state, c: c_int, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2688_clk_disable(clk: *mut c_void) {
    ...
    struct clk *clk;
    int ret, f;
    clk = devm_get_clk_from_child(dev, to_of_node(node), core::ptr::null_mut());
    if (IS_ERR(clk))
...
#[no_mangle]
unsafe extern "C" fn ltc2688_span_lookup(st: *const ltc2688_state, min: c_int, max: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2688_channel_config(st: *mut ltc2688_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2688_setup(st: *mut ltc2688_state, has_external_vref: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2688_reg_readable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ltc2688_reg_writable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ltc2688_probe(spi: *mut spi_device) -> c_int {
