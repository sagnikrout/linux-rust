...
//! Source: drivers/iio/dac/ti-dac082s085.c
#![no_std]
...
pub const WRITE_ALL_UPDATE: c_uint = 0x20;

#[no_mangle]
unsafe extern "C" fn ti_dac_cmd(ti_dac: *mut ti_dac_chip, cmd: u8, val: u16) -> c_int {
    static int ti_dac_cmd(struct ti_dac_chip *ti_dac, u8 cmd, u16 val)
    {
    let mut shift: u8 = 12 - ti_dac.resolution;
