...
//! Source: drivers/iio/dac/max22007.c
#![no_std]
...
//
    ...
    struct device;
pub const MAX22007_NUM_CHANNELS: c_int = 4;
pub const MAX22007_REV_ID_REG: c_uint = 0x00;
pub const MAX22007_STAT_INTR_REG: c_uint = 0x01;
pub const MAX22007_INTERRUPT_EN_REG: c_uint = 0x02;
pub const MAX22007_CONFIG_REG: c_uint = 0x03;
pub const MAX22007_CONTROL_REG: c_uint = 0x04;
pub const MAX22007_CHANNEL_MODE_REG: c_uint = 0x05;
pub const MAX22007_SOFT_RESET_REG: c_uint = 0x06;

pub const MAX22007_GPIO_CTRL_REG: c_uint = 0x0B;
pub const MAX22007_GPIO_DATA_REG: c_uint = 0x0C;
pub const MAX22007_GPI_EDGE_INT_CTRL_REG: c_uint = 0x0D;
pub const MAX22007_GPI_INT_STATUS_REG: c_uint = 0x0E;
// Channel mask definitions

    MAX22007_SW_CLR_MASK)

pub const MAX22007_CRC8_POLYNOMIAL: c_uint = 0x8C;

pub const MAX22007_CRC_OVERHEAD: c_int = 1;
pub const MAX22007_NUM_SUPPLIES: c_int = 3;
pub const MAX22007_REF_MV: c_int = 2500;
...
#[no_mangle]
unsafe extern "C" fn max22007_spi_write(context: *mut c_void, data: *const c_void, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max22007_reg_readable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max22007_reg_writable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max22007_parse_channel_cfg(st: *mut max22007_state, num_channels: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max22007_probe(spi: *mut spi_device) -> c_int {
