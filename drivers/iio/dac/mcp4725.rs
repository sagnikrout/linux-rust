...
//! Source: drivers/iio/dac/mcp4725.c
#![no_std]
...
pub const MCP472X_REF_VDD: c_uint = 0x00;
pub const MCP472X_REF_VREF_UNBUFFERED: c_uint = 0x02;
pub const MCP472X_REF_VREF_BUFFERED: c_uint = 0x03;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp4725_chip_info {
    pub chan_spec: *const iio_chan_spec,
    pub dac_reg_offset: u8,
    pub use_ext_ref_voltage: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp4725_data {
    pub client: *mut i2c_client,
    pub ref_mode: unsigned,
    pub vref_buffered: bool,
    pub dac_value: u16,
    pub powerdown: bool,
    pub powerdown_mode: unsigned,
    pub vdd_reg: *mut regulator,
    pub vref_reg: *mut regulator,
}

#[no_mangle]
unsafe extern "C" fn mcp4725_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp4725_resume(dev: *mut device) -> c_int {
...
pub unsafe extern "C" fn if(3: ret !=) -> else {
    ...
    static IIO_DEVICE_ATTR(store_eeprom, S_IWUSR, core::ptr::null_mut(), mcp4725_store_eeprom, 0);
...
#[no_mangle]
unsafe extern "C" fn mcp4725_set_value(indio_dev: *mut iio_dev, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp4726_set_cfg(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp4725_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp4725_remove(client: *mut i2c_client) {
