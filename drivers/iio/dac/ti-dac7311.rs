...
//! Source: drivers/iio/dac/ti-dac7311.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ti_dac_get_power(ti_dac: *mut ti_dac_chip, powerdown: bool) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ti_dac_cmd(ti_dac: *mut ti_dac_chip, power: u8, val: u16) -> c_int {
    static int ti_dac_cmd(struct ti_dac_chip *ti_dac, u8 power, u16 val)
    {
    let mut shift: u8 = 14 - ti_dac.resolution;
...
// val2 = ti_dac->resolution;
    ...
    {
    struct ti_dac_chip *ti_dac = iio_priv(indio_dev);
    let mut power: u8 = ti_dac_get_power(ti_dac, ti_dac.powerdown);
    int ret;
    switch (mask) {
    case IIO_CHAN_INFO_RAW:
    if (ti_dac.val == val)
...
#[no_mangle]
unsafe extern "C" fn ti_dac_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_dac_remove(spi: *mut spi_device) {
