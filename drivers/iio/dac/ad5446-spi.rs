...
//! Source: drivers/iio/dac/ad5446-spi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ad5446_write(st: *mut ad5446_state, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5660_write(st: *mut ad5446_state, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5446_spi_probe(spi: *mut spi_device) -> c_int {
