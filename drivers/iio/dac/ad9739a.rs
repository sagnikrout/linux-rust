...
//! Source: drivers/iio/dac/ad9739a.c
#![no_std]
...
pub const AD9739A_REG_MODE: c_int = 0;

pub const AD9739A_REG_FSC_1: c_uint = 0x06;
pub const AD9739A_REG_FSC_2: c_uint = 0x07;

pub const AD9739A_REG_DEC_CNT: c_uint = 0x8;
pub const AD9739A_NORMAL_MODE: c_int = 0;
pub const AD9739A_MIXED_MODE: c_int = 2;

pub const AD9739A_REG_LVDS_REC_CNT1: c_uint = 0x10;

pub const AD9739A_REG_LVDS_REC_CNT4: c_uint = 0x13;

pub const AD9739A_REG_LVDS_REC_STAT9: c_uint = 0x21;

pub const AD9739A_REG_CROSS_CNT1: c_uint = 0x22;
pub const AD9739A_REG_CROSS_CNT2: c_uint = 0x23;
pub const AD9739A_REG_PHS_DET: c_uint = 0x24;
pub const AD9739A_REG_MU_DUTY: c_uint = 0x25;
pub const AD9739A_REG_MU_CNT1: c_uint = 0x26;

pub const AD9739A_REG_MU_CNT2: c_uint = 0x27;
pub const AD9739A_REG_MU_CNT3: c_uint = 0x28;
pub const AD9739A_REG_MU_CNT4: c_uint = 0x29;
pub const AD9739A_MU_CNT4_DEFAULT: c_uint = 0xcb;
pub const AD9739A_REG_MU_STAT1: c_uint = 0x2A;

pub const AD9739A_REG_ANA_CNT_1: c_uint = 0x32;
pub const AD9739A_REG_ID: c_uint = 0x35;
pub const AD9739A_ID: c_uint = 0x24;

    ((reg) == 0x5 || (reg) == 0x9 || (reg) == 0x0E || (reg) == 0x0D || \
    (reg) == 0x2B || (reg) == 0x2C || (reg) == 0x34)
pub const AD9739A_FSC_MIN: c_int = 8580;
pub const AD9739A_FSC_MAX: c_int = 31700;

// as recommended by the datasheet
pub const AD9739A_LOCK_N_TRIES: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad9739a_state {
    pub back: *mut iio_backend,
    pub regmap: *mut regmap,
    pub sample_rate: c_ulong,
}
...
#[no_mangle]
unsafe extern "C" fn ad9739a_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad9739a_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad9739a_reg_accessible(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ad9739a_reset(dev: *mut device, st: *const ad9739a_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad9739a_init(dev: *mut device, st: *const ad9739a_state) -> c_int {
    static int ad9739a_init(struct device *dev, const struct ad9739a_state *st)
    {
    let mut i: c_uint = 0, lock, fsc;
    u32 fsc_raw;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ad9739a_probe(spi: *mut spi_device) -> c_int {
