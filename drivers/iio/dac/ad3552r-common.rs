...
//! Source: drivers/iio/dac/ad3552r-common.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ad3552r_calc_custom_gain(p: u8, n: u8, goffs: i16) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn ad3552r_get_ref_voltage(dev: *mut device, val: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ad3552r_get_drive_strength(dev: *mut device, val: *mut u32) -> c_int {
