...
//! Source: drivers/iio/dac/ad5360.c
#![no_std]
...
pub const AD5360_CMD_WRITE_DATA: c_uint = 0x3;
pub const AD5360_CMD_WRITE_OFFSET: c_uint = 0x2;
pub const AD5360_CMD_WRITE_GAIN: c_uint = 0x1;
pub const AD5360_CMD_SPECIAL_FUNCTION: c_uint = 0x0;
// Special function register addresses
pub const AD5360_REG_SF_NOP: c_uint = 0x0;
pub const AD5360_REG_SF_CTRL: c_uint = 0x1;

pub const AD5360_REG_SF_READBACK: c_uint = 0x5;

pub const AD5360_READBACK_X1A: c_uint = 0x0;
pub const AD5360_READBACK_X1B: c_uint = 0x1;
pub const AD5360_READBACK_OFFSET: c_uint = 0x2;
pub const AD5360_READBACK_GAIN: c_uint = 0x3;
pub const AD5360_READBACK_SF: c_uint = 0x4;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5360_chip_info {
    pub channel_template: iio_chan_spec,
    pub num_channels: c_uint,
    pub channels_per_group: c_uint,
    pub num_vrefs: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5360_state {
    pub spi: *mut spi_device,
    pub chip_info: *const ad5360_chip_info,
    pub vref_reg: [regulator_bulk_data; 3],
    pub ctrl: c_uint,
    pub lock: mutex,
//
...
// share the last vref
    ...
    unsigned int channel)
    {
    let mut i: c_uint = ad5360_get_channel_vref_index(st, channel);
    ...
    {
    struct ad5360_state *st = iio_priv(indio_dev);
    let mut max_val: c_int = (1 << chan.scan_type.realbits);
...
#[no_mangle]
unsafe extern "C" fn ad5360_alloc_channels(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5360_probe(spi: *mut spi_device) -> c_int {
    static int ad5360_probe(struct spi_device *spi)
    {
    let mut type: enum ad5360_type = spi_get_device_id(spi).driver_data;
...
#[no_mangle]
unsafe extern "C" fn ad5360_remove(spi: *mut spi_device) {
