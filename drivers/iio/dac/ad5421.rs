...
//! Source: drivers/iio/dac/ad5421.c
#![no_std]
...
pub const AD5421_REG_DAC_DATA: c_uint = 0x1;
pub const AD5421_REG_CTRL: c_uint = 0x2;
pub const AD5421_REG_OFFSET: c_uint = 0x3;
pub const AD5421_REG_GAIN: c_uint = 0x4;
...
pub const AD5421_REG_LOAD_DAC: c_uint = 0x5;
pub const AD5421_REG_FAULT: c_uint = 0x5;
pub const AD5421_REG_FORCE_ALARM_CURRENT: c_uint = 0x6;
pub const AD5421_REG_RESET: c_uint = 0x7;
pub const AD5421_REG_START_CONVERSION: c_uint = 0x8;
pub const AD5421_REG_NOOP: c_uint = 0x9;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad5421_state {
    pub spi: *mut spi_device,
    pub ctrl: c_uint,
    pub current_range: enum ad5421_current_range,
    pub fault_mask: c_uint,
    pub lock: mutex,
//
...
#[no_mangle]
unsafe extern "C" fn ad5421_read(indio_dev: *mut iio_dev, reg: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad5421_fault_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t ad5421_fault_handler(int irq, void *data)
    {
    struct iio_dev *indio_dev = data;
    struct ad5421_state *st = iio_priv(indio_dev);
    unsigned int fault;
    let mut old_fault: c_uint = 0;
    unsigned int events;
...
#[no_mangle]
pub unsafe extern "C" fn ad5421_get_offset(st: *mut ad5421_state) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ad5421_probe(spi: *mut spi_device) -> c_int {
