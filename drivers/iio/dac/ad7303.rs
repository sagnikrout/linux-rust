...
//! Source: drivers/iio/dac/ad7303.c
#![no_std]
...
pub const AD7303_CFG_ADDR_OFFSET: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn ad7303_reg_disable(reg: *mut c_void) {
    static void ad7303_reg_disable(void *reg)
    {
    regulator_disable(reg);
    }
#[no_mangle]
unsafe extern "C" fn ad7303_probe(spi: *mut spi_device) -> c_int {
