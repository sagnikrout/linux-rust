...
//! Source: drivers/iio/afe/iio-rescale.c
#![no_std]
...
//
    ...
    {
    u32 sense;
    let mut gain_mult: u32 = 1;
    let mut gain_div: u32 = 1;
    u32 factor;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rescale_probe(pdev: *mut platform_device) -> c_int {
    ...
    int i;
    int ret;
    source = devm_iio_channel_get(dev, core::ptr::null_mut());
    if (IS_ERR(source))
