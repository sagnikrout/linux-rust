...
//! Source: drivers/iio/flow/slf3s.c
#![no_std]
...
pub const SLF3S_CRC8_POLY: c_uint = 0x31;
pub const SLF3S_CRC8_INIT: c_uint = 0xff;
pub const SLF3S_PRODUCT_ID_LEN: c_int = 18;
pub const SLF3S_PRODUCT_FAMILY_BYTE: c_int = 1;
pub const SLF3S_PRODUCT_SUBTYPE_BYTE: c_int = 3;
pub const SLF3S_PRODUCT_FAMILY_ID: c_uint = 0x03;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct slf3s_data {
    pub client: *mut i2c_client,
    pub vdd: *mut regulator,
    pub variant: *const slf3s_variant,
    pub medium: enum slf3s_medium,
    pub lock: mutex,
    pub crc_table: [u8; CRC8_TABLE_SIZE],
}

#[no_mangle]
unsafe extern "C" fn slf3s_send_cmd(client: *mut i2c_client, cmd: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slf3s_start_meas(sf: *mut slf3s_data, medium: enum slf3s_medium) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slf3s_crc_valid(sf: *const slf3s_data, block: *const u8) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn slf3s_detect_variant(sf: *mut slf3s_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slf3s_read_sample(sf: *mut slf3s_data, flow: *mut c_int, temp: *mut c_int) -> c_int {
...
//
    ...
    let mut num: i64 = (s64)v.scale.numerator * (FEMTO / MILLI);
...
#[no_mangle]
unsafe extern "C" fn slf3s_stop_meas(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn slf3s_disable_vdd(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn slf3s_probe(client: *mut i2c_client) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn slf3s_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slf3s_resume(dev: *mut device) -> c_int {
