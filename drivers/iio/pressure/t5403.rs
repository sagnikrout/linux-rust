...
//! Source: drivers/iio/pressure/t5403.c
#![no_std]
...
pub const T5403_DATA: c_uint = 0xf5 /* data, LSB first, 16 bit */;
pub const T5403_CALIB_DATA: c_uint = 0x8e /* 10 calibration coeff., LSB first, 16 bit */;
pub const T5403_SLAVE_ADDR: c_uint = 0x88 /* I2C slave address, 0x77 */;
pub const T5403_COMMAND: c_uint = 0xf1;
// command bits

pub const T5403_MODE_LOW: c_int = 0;
pub const T5403_MODE_STANDARD: c_int = 1;
pub const T5403_MODE_HIGH: c_int = 2;
pub const T5403_MODE_ULTRA_HIGH: c_int = 3;

pub const T5403_I2C_ADDR: c_uint = 0x77;
    static const int t5403_pressure_conv_ms[] = {2, 8, 16, 66};
#[repr(C)]
#[derive(Copy, Clone)]
pub struct t5403_data {
...
#[no_mangle]
unsafe extern "C" fn t5403_read(data: *mut t5403_data, pressure: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn t5403_comp_pressure(data: *mut t5403_data, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn t5403_comp_temp(data: *mut t5403_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn t5403_probe(client: *mut i2c_client) -> c_int {
