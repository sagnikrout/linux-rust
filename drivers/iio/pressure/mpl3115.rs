...
//! Source: drivers/iio/pressure/mpl3115.c
#![no_std]
...
pub const MPL3115_STATUS: c_uint = 0x00;
pub const MPL3115_OUT_PRESS: c_uint = 0x01 /* MSB first, 20 bit */;
pub const MPL3115_OUT_TEMP: c_uint = 0x04 /* MSB first, 12 bit */;
pub const MPL3115_WHO_AM_I: c_uint = 0x0c;
pub const MPL3115_INT_SOURCE: c_uint = 0x12;
pub const MPL3115_PT_DATA_CFG: c_uint = 0x13;
pub const MPL3115_PRESS_TGT: c_uint = 0x16 /* MSB first, 16 bit */;
pub const MPL3115_TEMP_TGT: c_uint = 0x18;
pub const MPL3115_CTRL_REG1: c_uint = 0x26;
pub const MPL3115_CTRL_REG2: c_uint = 0x27;
pub const MPL3115_CTRL_REG3: c_uint = 0x28;
pub const MPL3115_CTRL_REG4: c_uint = 0x29;
pub const MPL3115_CTRL_REG5: c_uint = 0x2a;
pub const MPL3115_DEVICE_ID: c_uint = 0xc4;
...
#[no_mangle]
unsafe extern "C" fn mpl3115_request(data: *mut mpl3115_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpl3115_fill_trig_buffer(indio_dev: *mut iio_dev, buffer: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpl3115_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mpl3115_interrupt_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mpl3115_set_trigger_state(trig: *mut iio_trigger, state: bool) -> c_int {
...
// val = sign_extend32(ret, 7);
    ...
    ret = devm_request_threaded_irq(&data.client.dev, irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn mpl3115_probe(client: *mut i2c_client) -> c_int {
...
// software reset, I2C transfer is aborted (fails)
    ...
    mpl3115_trigger_handler, core::ptr::null_mut());
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn mpl3115_standby(data: *mut mpl3115_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpl3115_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn mpl3115_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpl3115_resume(dev: *mut device) -> c_int {
