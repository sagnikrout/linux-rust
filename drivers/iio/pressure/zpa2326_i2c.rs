...
//! Source: drivers/iio/pressure/zpa2326_i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn zpa2326_i2c_hwid(client: *const i2c_client) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn zpa2326_probe_i2c(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zpa2326_remove_i2c(client: *mut i2c_client) {
