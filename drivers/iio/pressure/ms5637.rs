...
//! Source: drivers/iio/pressure/ms5637.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ms5637_show_samp_freq(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn ms5637_probe(client: *mut i2c_client) -> c_int {
    ...
    let mut ms5637_data: static struct ms_tp_data = { .name = "ms5637", .hw = &ms5637_hw_data };
    let mut ms5803_data: static struct ms_tp_data = { .name = "ms5803", .hw = &ms5803_hw_data };
    let mut ms5805_data: static struct ms_tp_data = { .name = "ms5805", .hw = &ms5637_hw_data };
    let mut ms5837_data: static struct ms_tp_data = { .name = "ms5837", .hw = &ms5637_hw_data };
