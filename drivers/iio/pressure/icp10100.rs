...
//! Source: drivers/iio/pressure/icp10100.c
#![no_std]
...
pub const ICP10100_ID_REG: c_uint = 0x08;
pub const ICP10100_RESPONSE_WORD_LENGTH: c_int = 3;
pub const ICP10100_CRC8_WORD_LENGTH: c_int = 2;
pub const ICP10100_CRC8_POLYNOMIAL: c_uint = 0x31;
pub const ICP10100_CRC8_INIT: c_uint = 0xFF;
    enum icp10100_mode {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct icp10100_state {
    pub lock: mutex,
    pub client: *mut i2c_client,
    pub vdd: *mut regulator,
    pub mode: enum icp10100_mode,
    pub cal: [i16; 4],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct icp10100_command {
    pub cmd: __be16,
    pub wait_us: c_ulong,
    pub wait_max_us: c_ulong,
    pub response_word_nb: usize,
}
    ...
    {
    let mut size: usize = cmd.response_word_nb * ICP10100_RESPONSE_WORD_LENGTH;
    uint8_t data[16];
    uint8_t *ptr;
    ...
    (buf == core::ptr::null_mut() || buf_len < (cmd.response_word_nb * 2)))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn icp10100_read_cal_otp(st: *mut icp10100_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icp10100_init_chip(st: *mut icp10100_state) -> c_int {
...
// read calibration data from OTP
    ...
    return ret;
// reset chip
    return icp10100_send_cmd(st, &icp10100_cmd_soft_reset, core::ptr::null_mut(), 0);
    }
...
// temperature = be16_to_cpu(measures[2]);
    ...
    let mut lut_lower: static int32_t = 3670016;
    let mut lut_upper: static int32_t = 12058624;
    let mut inv_quadr_factor: static int32_t = 16777216;
    let mut offset_factor: static int32_t = 2048;
    int64_t val1, val2;
    int32_t p_lut[3];
    int32_t t, t_square;
    int64_t a, b, c;
...
#[no_mangle]
unsafe extern "C" fn icp10100_enable_regulator(st: *mut icp10100_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icp10100_disable_regulator_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn icp10100_pm_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn icp10100_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icp10100_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icp10100_resume(dev: *mut device) -> c_int {
    ...
    goto out_unlock;
// reset chip
    ret = icp10100_send_cmd(st, &icp10100_cmd_soft_reset, core::ptr::null_mut(), 0);
    out_unlock:
    mutex_unlock(&st.lock);
    return ret;
    }
