...
//! Source: drivers/iio/pressure/bmp280-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bmp280_read_calib(data: *mut bmp280_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme280_read_calib(data: *mut bmp280_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme280_read_humid_adc(data: *mut bmp280_data, adc_humidity: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp280_read_temp_adc(data: *mut bmp280_data, adc_temp: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bmp280_calc_t_fine(data: *mut bmp280_data, adc_temp: u32) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn bmp280_get_t_fine(data: *mut bmp280_data, t_fine: *mut i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp280_compensate_temp(data: *mut bmp280_data, adc_temp: u32) -> i32 {
    static s32 bmp280_compensate_temp(struct bmp280_data *data, u32 adc_temp)
    {
    return (bmp280_calc_t_fine(data, adc_temp) * 5 + 128) / 256;
    }
#[no_mangle]
unsafe extern "C" fn bmp280_read_press_adc(data: *mut bmp280_data, adc_press: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp280_read_temp(data: *mut bmp280_data, comp_temp: *mut i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp280_read_press(data: *mut bmp280_data, comp_press: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bme280_read_humid(data: *mut bmp280_data, comp_humidity: *mut u32) -> c_int {
...
// val = (1 << data->iir_filter_coeff) - 1;
    ...
    let mut n: c_int = data.chip_info.num_oversampling_humid_avail;
    int ret, prev;
    int i;
    for (i = 0; i < n; i++) {
    if (avail[i] == val) {
    ...
    let mut n: c_int = data.chip_info.num_oversampling_temp_avail;
    int ret, prev;
    int i;
    for (i = 0; i < n; i++) {
    if (avail[i] == val) {
    ...
    let mut n: c_int = data.chip_info.num_oversampling_press_avail;
    int ret, prev;
    int i;
    for (i = 0; i < n; i++) {
    if (avail[i] == val) {
    ...
    let mut n: c_int = data.chip_info.num_sampling_freq_avail;
    int ret, prev;
    int i;
    for (i = 0; i < n; i++) {
...
#[no_mangle]
unsafe extern "C" fn bmp280_write_iir_filter_coeffs(data: *mut bmp280_data, val: c_int) -> c_int {
    ...
    let mut n: c_int = data.chip_info.num_iir_filter_coeffs_avail;
    int ret, prev;
    int i;
    for (i = 0; i < n; i++) {
    if (avail[i] - 1  == val) {
...
#[no_mangle]
unsafe extern "C" fn bmp280_preinit(data: *mut bmp280_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp280_set_mode(data: *mut bmp280_data, mode: enum bmp280_op_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp280_wait_conv(data: *mut bmp280_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp280_chip_config(data: *mut bmp280_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp280_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bme280_chip_config(data: *mut bmp280_data) -> c_int {
    static int bme280_chip_config(struct bmp280_data *data)
    {
    let mut osrs: u8 = FIELD_PREP(BME280_OSRS_HUMIDITY_MASK, data.oversampling_humid + 1);
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn bme280_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
// Humidity calculations
    ...
    ret = devm_request_threaded_irq(data.dev, irq, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn bmp380_cmd(data: *mut bmp280_data, cmd: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp380_read_temp_adc(data: *mut bmp280_data, adc_temp: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bmp380_calc_t_fine(data: *mut bmp280_data, adc_temp: u32) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn bmp380_get_t_fine(data: *mut bmp280_data, t_fine: *mut i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp380_compensate_temp(data: *mut bmp280_data, adc_temp: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp380_read_press_adc(data: *mut bmp280_data, adc_press: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp380_read_temp(data: *mut bmp280_data, comp_temp: *mut i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp380_read_press(data: *mut bmp280_data, comp_press: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp380_read_calib(data: *mut bmp280_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp380_preinit(data: *mut bmp280_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp380_set_mode(data: *mut bmp280_data, mode: enum bmp280_op_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp380_wait_conv(data: *mut bmp280_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp380_chip_config(data: *mut bmp280_data) -> c_int {
    static int bmp380_chip_config(struct bmp280_data *data)
    {
    let mut change: bool = false, aux;
    unsigned int tmp;
    u8 osrs;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn bmp380_int_pin_config(data: *mut bmp280_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp380_irq_thread_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bmp380_trigger_probe(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp380_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bmp580_soft_reset(data: *mut bmp280_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bmp580_nvm_operation(data: *mut bmp280_data, is_write: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bmp580_read_temp(data: *mut bmp280_data, raw_temp: *mut i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp580_read_press(data: *mut bmp280_data, raw_press: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp580_preinit(data: *mut bmp280_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp580_set_mode(data: *mut bmp280_data, mode: enum bmp280_op_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp580_wait_conv(data: *mut bmp280_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp580_chip_config(data: *mut bmp280_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp580_int_pin_config(data: *mut bmp280_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp580_irq_thread_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bmp580_trigger_probe(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp580_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bmp180_wait_for_eoc(data: *mut bmp280_data, ctrl_meas: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp180_read_temp_adc(data: *mut bmp280_data, adc_temp: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp180_read_calib(data: *mut bmp280_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bmp180_calc_t_fine(data: *mut bmp280_data, adc_temp: u32) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn bmp180_get_t_fine(data: *mut bmp280_data, t_fine: *mut i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp180_compensate_temp(data: *mut bmp280_data, adc_temp: u32) -> i32 {
    static s32 bmp180_compensate_temp(struct bmp280_data *data, u32 adc_temp)
    {
    return (bmp180_calc_t_fine(data, adc_temp) + 8) / 16;
    }
#[no_mangle]
unsafe extern "C" fn bmp180_read_temp(data: *mut bmp280_data, comp_temp: *mut i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp180_read_press_adc(data: *mut bmp280_data, adc_press: *mut u32) -> c_int {
    static int bmp180_read_press_adc(struct bmp280_data *data, u32 *adc_press)
    {
    let mut oss: u8 = data.oversampling_press;
    int ret;
    ret = bmp180_wait_for_eoc(data,
...
//
    ...
    {
    struct bmp180_calib *calib = &data.calib.bmp180;
    let mut oss: i32 = data.oversampling_press;
    s32 x1, x2, x3, p;
    s32 b3, b6;
    u32 b4, b7;
    b6 = t_fine - 4000;
...
#[no_mangle]
unsafe extern "C" fn bmp180_read_press(data: *mut bmp280_data, comp_press: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp180_set_mode(data: *mut bmp280_data, mode: enum bmp280_op_mode) -> c_int {
...
// Keep compatibility with newer generations of the sensor
#[no_mangle]
unsafe extern "C" fn bmp180_wait_conv(data: *mut bmp280_data) -> c_int {
...
// Keep compatibility with newer generations of the sensor
#[no_mangle]
unsafe extern "C" fn bmp180_chip_config(data: *mut bmp280_data) -> c_int {
    static int bmp180_chip_config(struct bmp280_data *data)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn bmp180_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bmp085_eoc_irq(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bmp085_trigger_probe(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp280_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp280_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp280_pm_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn bmp280_regulators_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn bmp280_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmp280_runtime_resume(dev: *mut device) -> c_int {
    ...
    bmp280_runtime_resume, core::ptr::null_mut());
