...
//! Source: drivers/iio/pressure/adp810.c
#![no_std]
...
//
pub const ADP810_CRC8_POLYNOMIAL: c_uint = 0x31;
...
#[no_mangle]
unsafe extern "C" fn adp810_measure(data: *mut adp810_data, buf: *mut adp810_read_buf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp810_probe(client: *mut i2c_client) -> c_int {
