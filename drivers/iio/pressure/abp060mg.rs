...
//! Source: drivers/iio/pressure/abp060mg.c
#![no_std]
...
pub const ABP060MG_ERROR_MASK: c_uint = 0xC000;
pub const ABP060MG_RESP_TIME_MS: c_int = 40;
...
#[no_mangle]
unsafe extern "C" fn abp060mg_get_measurement(state: *mut abp_state, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abp060mg_init_device(indio_dev: *mut iio_dev, id: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn abp060mg_probe(client: *mut i2c_client) -> c_int {
    static int abp060mg_probe(struct i2c_client *client)
    {
    const struct i2c_device_id *id = i2c_client_get_device_id(client);
    struct iio_dev *indio_dev;
    struct abp_state *state;
    let mut cfg_id: c_ulong = id.driver_data;
