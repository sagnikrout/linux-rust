...
//! Source: drivers/iio/pressure/hp03.c
#![no_std]
...
//
pub const HP03_EEPROM_ADDR: c_uint = 0x50;
pub const HP03_ADC_ADDR: c_uint = 0x77;
pub const HP03_EEPROM_CX_OFFSET: c_uint = 0x10;
pub const HP03_EEPROM_AB_OFFSET: c_uint = 0x1e;
pub const HP03_EEPROM_CD_OFFSET: c_uint = 0x20;
pub const HP03_ADC_WRITE_REG: c_uint = 0xff;
pub const HP03_ADC_READ_REG: c_uint = 0xfd;
pub const HP03_ADC_READ_PRESSURE: c_uint = 0xf0	/* D1 in datasheet */;
pub const HP03_ADC_READ_TEMP: c_uint = 0xe8	/* D2 in datasheet */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hp03_priv {
    pub client: *mut i2c_client,
    pub lock: mutex,
    pub xclr_gpio: *mut gpio_desc,
    pub eeprom_client: *mut i2c_client,
    pub eeprom_regmap: *mut regmap,
    pub /: *mut *mut s32 pressure; / kPa,
    pub /: *mut *mut s32 temp; / Deg. C,
}
...
#[no_mangle]
unsafe extern "C" fn hp03_is_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
    static bool hp03_is_writeable_reg(struct device *dev, unsigned int reg)
    {
    return false;
    }
#[no_mangle]
unsafe extern "C" fn hp03_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hp03_get_temp_pressure(priv: *mut hp03_priv, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hp03_update_temp_pressure(priv: *mut hp03_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hp03_probe(client: *mut i2c_client) -> c_int {
