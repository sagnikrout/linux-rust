...
//! Source: drivers/iio/pressure/st_pressure_core.c
#![no_std]
...
//
pub const MCELSIUS_PER_CELSIUS: c_int = 1000;
...
// FULLSCALE
pub const ST_PRESS_FS_AVL_1100MB: c_int = 1100;
pub const ST_PRESS_FS_AVL_1260MB: c_int = 1260;
pub const ST_PRESS_1_OUT_XL_ADDR: c_uint = 0x28;
pub const ST_TEMP_1_OUT_L_ADDR: c_uint = 0x2b;
...
pub const ST_PRESS_LPS001WP_OUT_L_ADDR: c_uint = 0x28;
pub const ST_TEMP_LPS001WP_OUT_L_ADDR: c_uint = 0x2a;
// LPS25H pressure and temp L addresses
pub const ST_PRESS_LPS25H_OUT_XL_ADDR: c_uint = 0x28;
pub const ST_TEMP_LPS25H_OUT_L_ADDR: c_uint = 0x2b;
...
#[no_mangle]
pub unsafe extern "C" fn st_press_common_probe(indio_dev: *mut iio_dev) -> c_int {
