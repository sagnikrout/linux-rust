...
//! Source: drivers/iio/pressure/sdp500.c
#![no_std]
...
pub const SDP500_CRC8_POLYNOMIAL: c_uint = 0x31   /* x8+x5+x4+1 (normalized to 0x31) */;
pub const SDP500_READ_SIZE: c_int = 3;
pub const SDP500_I2C_START_MEAS: c_uint = 0xF1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdp500_data {
    pub dev: *mut device,
}

    DECLARE_CRC8_TABLE(sdp500_crc8_table);
#[no_mangle]
unsafe extern "C" fn sdp500_start_measurement(data: *mut sdp500_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdp500_probe(client: *mut i2c_client) -> c_int {
