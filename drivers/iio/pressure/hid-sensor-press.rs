...
//! Source: drivers/iio/pressure/hid-sensor-press.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hid_press_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_press_remove(pdev: *mut platform_device) {
