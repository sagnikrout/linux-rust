...
//! Source: drivers/iio/pressure/rohm-bm1390.c
#![no_std]
...
pub const BM1390_REG_MANUFACT_ID: c_uint = 0x0f;
pub const BM1390_REG_PART_ID: c_uint = 0x10;
pub const BM1390_REG_POWER: c_uint = 0x12;

pub const BM1390_POWER_OFF: c_uint = 0x00;
pub const BM1390_REG_RESET: c_uint = 0x13;

pub const BM1390_RESET: c_uint = 0x00;
pub const BM1390_REG_MODE_CTRL: c_uint = 0x14;

//
// Data-sheet states that when the IIR is used, the AVE_NUM must be set to
// value 110b
//
pub const BM1390_IIR_AVE_NUM: c_uint = 0x06;
pub const BM1390_REG_FIFO_CTRL: c_uint = 0x15;

pub const BM1390_IIR_MODE_OFF: c_uint = 0x0;
pub const BM1390_IIR_MODE_WEAK: c_uint = 0x1;
pub const BM1390_IIR_MODE_MID: c_uint = 0x2;
pub const BM1390_IIR_MODE_STRONG: c_uint = 0x3;

pub const BM1390_WMI_MIN: c_int = 2;
pub const BM1390_WMI_MAX: c_int = 3;
pub const BM1390_REG_FIFO_LVL: c_uint = 0x18;

pub const BM1390_REG_STATUS: c_uint = 0x19;
pub const BM1390_REG_PRESSURE_BASE: c_uint = 0x1a;
pub const BM1390_REG_TEMP_HI: c_uint = 0x1d;
pub const BM1390_REG_TEMP_LO: c_uint = 0x1e;

pub const BM1390_ID: c_uint = 0x34;
// Regmap configs
...
pub const BM1390_FIFO_LENGTH: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bm1390_data {
    pub old_timestamp: s64 timestamp,,
    pub trig: *mut iio_trigger,
    pub regmap: *mut regmap,
    pub dev: *mut device,
    pub buf: bm1390_data_buf,
    pub irq: c_int,
    pub state: c_uint,
...
#[no_mangle]
unsafe extern "C" fn bm1390_read_temp(data: *mut bm1390_data, temp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm1390_pressure_read(data: *mut bm1390_data, pressure: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm1390_meas_set(data: *mut bm1390_data, mode: enum bm1390_meas_mode) -> c_int {
...
//
pub const BM1390_MAX_MEAS_TIME_MS: c_int = 205;
...
#[no_mangle]
unsafe extern "C" fn bm1390_fifo_flush(idev: *mut iio_dev, samples: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm1390_set_watermark(idev: *mut iio_dev, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm1390_chip_init(data: *mut bm1390_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm1390_fifo_set_wmi(data: *mut bm1390_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm1390_fifo_enable(idev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm1390_fifo_disable(idev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm1390_buffer_postenable(idev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm1390_buffer_predisable(idev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm1390_handle_trigger(idev: *mut iio_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bm1390_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bm1390_irq_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bm1390_irq_thread_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bm1390_set_drdy_irq(data: *mut bm1390_data, en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm1390_setup_buffer(data: *mut bm1390_data, idev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm1390_probe(i2c: *mut i2c_client) -> c_int {
