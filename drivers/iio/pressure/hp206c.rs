...
//! Source: drivers/iio/pressure/hp206c.c
#![no_std]
...
// I2C commands:
pub const HP206C_CMD_SOFT_RST: c_uint = 0x06;
pub const HP206C_CMD_ADC_CVT: c_uint = 0x40;
pub const HP206C_CMD_ADC_CVT_OSR_4096: c_uint = 0x00;
pub const HP206C_CMD_ADC_CVT_OSR_2048: c_uint = 0x04;
pub const HP206C_CMD_ADC_CVT_OSR_1024: c_uint = 0x08;
pub const HP206C_CMD_ADC_CVT_OSR_512: c_uint = 0x0c;
pub const HP206C_CMD_ADC_CVT_OSR_256: c_uint = 0x10;
pub const HP206C_CMD_ADC_CVT_OSR_128: c_uint = 0x14;
pub const HP206C_CMD_ADC_CVT_CHNL_PT: c_uint = 0x00;
pub const HP206C_CMD_ADC_CVT_CHNL_T: c_uint = 0x02;
pub const HP206C_CMD_READ_P: c_uint = 0x30;
pub const HP206C_CMD_READ_T: c_uint = 0x32;
pub const HP206C_CMD_READ_REG: c_uint = 0x80;
pub const HP206C_CMD_WRITE_REG: c_uint = 0xc0;
pub const HP206C_REG_INT_EN: c_uint = 0x0b;
pub const HP206C_REG_INT_CFG: c_uint = 0x0c;
pub const HP206C_REG_INT_SRC: c_uint = 0x0d;
pub const HP206C_FLAG_DEV_RDY: c_uint = 0x40;
pub const HP206C_REG_PARA: c_uint = 0x0f;
pub const HP206C_FLAG_CMPS_EN: c_uint = 0x80;
// Maximum spin for DEV_RDY
pub const HP206C_MAX_DEV_RDY_WAIT_COUNT: c_int = 20;
pub const HP206C_DEV_RDY_WAIT_US: c_int = 20000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hp206c_data {
    pub mutex: mutex,
    pub client: *mut i2c_client,
    pub temp_osr_index: c_int,
    pub pres_osr_index: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hp206c_osr_setting {
    pub osr_mask: u8,
    pub temp_conv_time_us: c_uint,
    pub pres_conv_time_us: c_uint,
}
...
#[no_mangle]
pub unsafe extern "C" fn hp206c_read_reg(client: *mut i2c_client, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hp206c_write_reg(client: *mut i2c_client, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hp206c_read_20bit(client: *mut i2c_client, cmd: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hp206c_wait_dev_rdy(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hp206c_set_compensation(client: *mut i2c_client, enabled: bool) -> c_int {
...
// Do a soft reset
#[no_mangle]
unsafe extern "C" fn hp206c_soft_reset(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hp206c_probe(client: *mut i2c_client) -> c_int {
