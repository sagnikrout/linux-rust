...
//! Source: drivers/iio/pressure/ms5611_i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ms5611_i2c_reset(st: *mut ms5611_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ms5611_i2c_read_adc(st: *mut ms5611_state, val: *mut i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ms5611_i2c_probe(client: *mut i2c_client) -> c_int {
