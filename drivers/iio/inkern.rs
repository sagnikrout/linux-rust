...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iio_map_internal {
    pub indio_dev: *mut iio_dev,
    pub map: *const iio_map,
    pub l: list_head,
}
...
#[no_mangle]
unsafe extern "C" fn iio_map_array_unregister_locked(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_map_array_register(indio_dev: *mut iio_dev, maps: *const iio_map) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_map_array_unregister(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_map_array_unregister_cb(indio_dev: *mut c_void) {
...
// iio_chan_spec_from_name(const struct iio_dev *indio_dev, const char *name)
    {
    int i;
    const struct iio_chan_spec *chan = core::ptr::null_mut();
...
// Search for FW matches
    ...
    {
    struct iio_map_internal *c_i = core::ptr::null_mut(), *c = core::ptr::null_mut();
    int err;
...
// first find matching entry the channel map
    ...
    const char *channel_name)
    {
    const char *name = dev ? dev_name(dev) : core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn iio_channel_release(channel: *mut iio_channel) {
...
#[no_mangle]
unsafe extern "C" fn devm_iio_channel_free(iio_channel: *mut c_void) {
    ...
    {
    const char *name;
    struct iio_map_internal *c = core::ptr::null_mut();
    struct iio_channel *fw_chans;
    let mut nummaps: c_int = 0;
    let mut mapind: c_int = 0;
    int i, ret;
    if (!dev)
    return ERR_PTR(-EINVAL);
...
#[no_mangle]
pub unsafe extern "C" fn iio_channel_release_all(channels: *mut iio_channel) {
...
#[no_mangle]
unsafe extern "C" fn devm_iio_channel_free_all(iio_channels: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn iio_read_channel_raw(chan: *mut iio_channel, val: *mut c_int) -> c_int {
    ...
    return -ENODEV;
    return iio_channel_read(chan, val, core::ptr::null_mut(), IIO_CHAN_INFO_RAW);
    }
    EXPORT_SYMBOL_NS_GPL(iio_read_channel_raw, "IIO_CONSUMER");
#[no_mangle]
pub unsafe extern "C" fn iio_read_channel_average_raw(chan: *mut iio_channel, val: *mut c_int) -> c_int {
    ...
    if (!chan.indio_dev.info)
    return -ENODEV;
    return iio_channel_read(chan, val, core::ptr::null_mut(), IIO_CHAN_INFO_AVERAGE_RAW);
    }
...
#[no_mangle]
pub unsafe extern "C" fn iio_read_channel_offset(chan: *mut iio_channel, val: *mut c_int, val2: *mut c_int) -> c_int {
    ...
    ret = iio_channel_read(chan, val, core::ptr::null_mut(), IIO_CHAN_INFO_RAW);
    if (ret < 0)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn iio_read_channel_processed(chan: *mut iio_channel, val: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_read_channel_scale(chan: *mut iio_channel, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_read_max_channel_raw(chan: *mut iio_channel, val: *mut c_int) -> c_int {
    ...
    if (!chan.indio_dev.info)
    return -ENODEV;
    return iio_channel_read_max(chan, val, core::ptr::null_mut(), &type, IIO_CHAN_INFO_RAW);
    }
...
#[no_mangle]
pub unsafe extern "C" fn iio_read_min_channel_raw(chan: *mut iio_channel, val: *mut c_int) -> c_int {
    ...
    if (!chan.indio_dev.info)
    return -ENODEV;
    return iio_channel_read_min(chan, val, core::ptr::null_mut(), &type, IIO_CHAN_INFO_RAW);
    }
    EXPORT_SYMBOL_NS_GPL(iio_read_min_channel_raw, "IIO_CONSUMER");
#[no_mangle]
pub unsafe extern "C" fn iio_get_channel_type(chan: *mut iio_channel, type: *mut enum iio_chan_type) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_write_channel_raw(chan: *mut iio_channel, val: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_get_channel_ext_info_count(chan: *mut iio_channel) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn iio_read_channel_label(chan: *mut iio_channel, buf: *mut c_char) -> isize {
