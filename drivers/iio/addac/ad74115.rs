...
//! Source: drivers/iio/addac/ad74115.c
#![no_std]
...
pub const AD74115_CH_FUNC_SETUP_REG: c_uint = 0x01;
pub const AD74115_ADC_CONFIG_REG: c_uint = 0x02;

pub const AD74115_PWR_OPTIM_CONFIG_REG: c_uint = 0x03;
pub const AD74115_DIN_CONFIG1_REG: c_uint = 0x04;

pub const AD74115_DIN_CONFIG2_REG: c_uint = 0x05;

pub const AD74115_OUTPUT_CONFIG_REG: c_uint = 0x06;

pub const AD74115_RTD3W4W_CONFIG_REG: c_uint = 0x07;
pub const AD74115_BURNOUT_CONFIG_REG: c_uint = 0x0a;

pub const AD74115_DAC_CODE_REG: c_uint = 0x0b;
pub const AD74115_DAC_ACTIVE_REG: c_uint = 0x0d;

pub const AD74115_CHARGE_PUMP_REG: c_uint = 0x3a;
pub const AD74115_ADC_CONV_CTRL_REG: c_uint = 0x3b;

pub const AD74115_DIN_COMP_OUT_REG: c_uint = 0x40;
pub const AD74115_LIVE_STATUS_REG: c_uint = 0x42;

pub const AD74115_READ_SELECT_REG: c_uint = 0x64;
pub const AD74115_CMD_KEY_REG: c_uint = 0x78;
pub const AD74115_CMD_KEY_RESET1: c_uint = 0x15fa;
pub const AD74115_CMD_KEY_RESET2: c_uint = 0xaf51;
pub const AD74115_CRC_POLYNOMIAL: c_uint = 0x7;
    DECLARE_CRC8_TABLE(ad74115_crc8_table);

pub const AD74115_DAC_VOLTAGE_MAX: c_int = 12000;
pub const AD74115_DAC_CURRENT_MAX: c_int = 25;

pub const AD74115_COMP_THRESH_MAX: c_int = 98;
pub const AD74115_SENSE_RESISTOR_OHMS: c_int = 100;
pub const AD74115_REF_RESISTOR_OHMS: c_int = 2100;
pub const AD74115_DIN_SINK_LOW_STEP: c_int = 120;
pub const AD74115_DIN_SINK_HIGH_STEP: c_int = 240;
pub const AD74115_DIN_SINK_MAX: c_int = 31;
pub const AD74115_FRAME_SIZE: c_int = 4;
pub const AD74115_GPIO_NUM: c_int = 4;
pub const AD74115_CONV_TIME_US: c_int = 1000000;
    enum ad74115_dac_ch {
    AD74115_DAC_CH_MAIN,
...
//
    pub lock: mutex,
    pub gc: gpio_chip,
    pub comp_gc: gpio_chip,
    pub irq: c_int,
    pub avdd_mv: c_uint,
    pub gpio_valid_mask: c_ulong,
    pub dac_bipolar: bool,
    pub dac_hart_slew: bool,
    pub rtd_mode_4_wire: bool,
    pub ch_func: enum ad74115_ch_func,
    pub din_threshold_mode: enum ad74115_din_threshold_mode,
    pub adc_data_completion: completion,
    pub adc_samples_msg: spi_message,
    pub 1]: spi_transfer adc_samples_xfer[AD74115_ADC_CH_NUM +,
//
// DMA (thus cache coherency maintenance) requires the
// transfer buffers to live in their own cache lines.
//
    pub __aligned(IIO_DMA_MINALIGN): u8 reg_tx_buf[AD74115_FRAME_SIZE],
    pub reg_rx_buf: [u8; AD74115_FRAME_SIZE],
    pub AD74115_ADC_CH_NUM]: *mut *mut u8 adc_samples_tx_buf[AD74115_FRAME_SIZE,
    pub AD74115_ADC_CH_NUM]: *mut *mut u8 adc_samples_rx_buf[AD74115_FRAME_SIZE,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad74115_fw_prop {
    ...
    pub reg: c_uint,
    pub mask: c_uint,
    pub lookup_tbl: *const c_uint,
    pub lookup_tbl_len: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn ad74115_crc(buf: *mut u8) -> c_int {
    static int ad74115_crc(u8 *buf)
    {
    return crc8(ad74115_crc8_table, buf, 3, 0);
    }
#[no_mangle]
unsafe extern "C" fn ad74115_format_reg_write(reg: u8, val: u16, buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn ad74115_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_crc_check(st: *mut ad74115_state, buf: *mut u8) -> c_int {
    static int ad74115_crc_check(struct ad74115_state *st, u8 *buf)
    {
    struct device *dev = &st.spi.dev;
    let mut expected_crc: u8 = ad74115_crc(buf);
...
#[no_mangle]
unsafe extern "C" fn ad74115_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_gpio_get_direction(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_gpio_direction_input(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_gpio_get(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_set_comp_debounce(st: *mut ad74115_state, val: c_uint) -> c_int {
    static int ad74115_set_comp_debounce(struct ad74115_state *st, unsigned int val)
    {
    let mut len: c_uint = ARRAY_SIZE(ad74115_debounce_tbl);
    unsigned int i;
    for (i = 0; i < len; i++)
...
#[no_mangle]
unsafe extern "C" fn ad74115_comp_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad74115_adc_data_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    {
    let mut mask: c_uint = ad74115_adc_ch_en_bit_tbl[channel];
...
#[no_mangle]
unsafe extern "C" fn ad74115_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_adc_code_to_resistance(code: c_int, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_get_dac_rate(st: *mut ad74115_state, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_set_dac_rate(st: *mut ad74115_state, val: c_int) -> c_int {
...
// Add 0.2 Ohm to the final result for 3-wire RTD.
    let mut v: c_uint = 2 * ad74115_adc_gain_tbl[range][0];
    if (ad74115_adc_bipolar_tbl[range])
...
// val = -AD74115_ADC_CODE_HALF;
#[no_mangle]
pub unsafe extern "C" fn if(AD74115_ADC_RANGE_2_5V_NEG: range ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(prop->max: prop->max && val >) -> else {
...
#[no_mangle]
unsafe extern "C" fn ad74115_setup_adc_conv2_range(st: *mut ad74115_state) -> c_int {
    static int ad74115_setup_adc_conv2_range(struct ad74115_state *st)
    {
    let mut tbl_len: c_uint = ARRAY_SIZE(ad74115_adc_range_tbl);
...
#[no_mangle]
unsafe extern "C" fn ad74115_setup_iio_channels(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_setup_gpio_chip(st: *mut ad74115_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_setup_comp_gpio_chip(st: *mut ad74115_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_setup(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_reset(st: *mut ad74115_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_setup_trigger(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_probe(spi: *mut spi_device) -> c_int {
...
//
    ...
    if (ret)
    return ret;
    st.regmap = devm_regmap_init(dev, core::ptr::null_mut(), st, &ad74115_regmap_config);
    if (IS_ERR(st.regmap))
...
#[no_mangle]
unsafe extern "C" fn ad74115_unregister_driver(spi: *mut spi_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74115_register_driver(spi: *mut spi_driver) -> int __init {
