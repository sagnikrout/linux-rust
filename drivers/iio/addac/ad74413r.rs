...
//! Source: drivers/iio/addac/ad74413r.c
#![no_std]
...
pub const AD74413R_CRC_POLYNOMIAL: c_uint = 0x7;
    DECLARE_CRC8_TABLE(ad74413r_crc8_table);
pub const AD74413R_CHANNEL_MAX: c_int = 4;
pub const AD74413R_FRAME_SIZE: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad74413r_chip_info {
    pub name: *const c_char,
    pub hart_support: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad74413r_channel_config {
    pub func: u32,
    pub drive_strength: u32,
    pub gpo_comparator: bool,
    pub initialized: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad74413r_channels {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad74413r_state {
    pub channel_configs: [ad74413r_channel_config; AD74413R_CHANNEL_MAX],
    pub gpo_gpio_offsets: [c_uint; AD74413R_CHANNEL_MAX],
    pub comp_gpio_offsets: [c_uint; AD74413R_CHANNEL_MAX],
    pub gpo_gpiochip: gpio_chip,
    pub comp_gpiochip: gpio_chip,
    pub adc_data_completion: completion,
    pub num_gpo_gpios: c_uint,
    pub num_comparator_gpios: c_uint,
    pub sense_resistor_ohms: u32,
    pub refin_reg_uv: c_int,
//
// Synchronize consecutive operations when doing a one-shot
// conversion and when updating the ADC samples SPI message.
//
    pub lock: mutex,
    pub chip_info: *const ad74413r_chip_info,
    pub spi: *mut spi_device,
    pub regmap: *mut regmap,
    pub dev: *mut device,
    pub trig: *mut iio_trigger,
    pub adc_active_channels: usize,
    pub adc_samples_msg: spi_message,
    pub 1]: spi_transfer adc_samples_xfer[AD74413R_CHANNEL_MAX +,
//
// DMA (thus cache coherency maintenance) may require the
// transfer buffers to live in their own cache lines.
//
    struct {
    pub AD74413R_CHANNEL_MAX]: *mut *mut u8 rx_buf[AD74413R_FRAME_SIZE,
    pub timestamp: aligned_s64,
    pub __aligned(IIO_DMA_MINALIGN): } adc_samples_buf,
    pub AD74413R_CHANNEL_MAX]: *mut *mut u8 adc_samples_tx_buf[AD74413R_FRAME_SIZE,
    pub reg_tx_buf: [u8; AD74413R_FRAME_SIZE],
    pub reg_rx_buf: [u8; AD74413R_FRAME_SIZE],
}

pub const AD74413R_REG_NOP: c_uint = 0x00;

pub const AD74413R_DAC_VOLTAGE_MAX: c_int = 11000;
pub const AD74413R_REG_GPO_PAR_DATA: c_uint = 0x0d;

pub const AD74413R_REG_ADC_CONV_CTRL: c_uint = 0x23;

pub const AD74413R_REG_DIN_COMP_OUT: c_uint = 0x25;

pub const AD74413R_REG_READ_SELECT: c_uint = 0x41;
pub const AD74413R_REG_CMD_KEY: c_uint = 0x44;
pub const AD74413R_CMD_KEY_LDAC: c_uint = 0x953a;
pub const AD74413R_CMD_KEY_RESET1: c_uint = 0x15fa;
pub const AD74413R_CMD_KEY_RESET2: c_uint = 0xaf51;
...
#[no_mangle]
unsafe extern "C" fn ad74413r_crc(buf: *mut u8) -> c_int {
    static int ad74413r_crc(u8 *buf)
    {
    return crc8(ad74413r_crc8_table, buf, 3, 0);
    }
#[no_mangle]
unsafe extern "C" fn ad74413r_format_reg_write(reg: u8, val: u16, buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn ad74413r_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74413r_crc_check(st: *mut ad74413r_state, buf: *mut u8) -> c_int {
    static int ad74413r_crc_check(struct ad74413r_state *st, u8 *buf)
    {
    let mut expected_crc: u8 = ad74413r_crc(buf);
...
#[no_mangle]
unsafe extern "C" fn ad74413r_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
// val = get_unaligned_be16(&st->reg_rx_buf[1]);
    ...
    {
    let mut val: c_uint = AD74413R_DIN_DEBOUNCE_LEN - 1;
    unsigned int i;
    ...
    let mut real_offset: c_uint = st.gpo_gpio_offsets[offset];
    int ret;
    ...
    {
    struct ad74413r_state *st = gpiochip_get_data(chip);
    let mut real_mask: c_ulong = 0;
    let mut real_bits: c_ulong = 0;
    unsigned int offset;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ad74413r_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
    static int ad74413r_gpio_get(struct gpio_chip *chip, unsigned int offset)
    {
    struct ad74413r_state *st = gpiochip_get_data(chip);
    let mut real_offset: c_uint = st.comp_gpio_offsets[offset];
    unsigned int status;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ad74413r_reset(st: *mut ad74413r_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74413r_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad74413r_adc_data_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad74413r_adc_to_resistance_result(adc_result: c_int, val: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn ad74413r_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74413r_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74413r_parse_channel_configs(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74413r_setup_channels(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74413r_setup_gpios(st: *mut ad74413r_state) -> c_int {
    static int ad74413r_setup_gpios(struct ad74413r_state *st)
    {
    struct ad74413r_channel_config *config;
    let mut comp_gpio_i: c_uint = 0;
    let mut gpo_gpio_i: c_uint = 0;
    unsigned int i;
    u8 gpo_config;
    u32 strength;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ad74413r_probe(spi: *mut spi_device) -> c_int {
    ...
    st.regmap = devm_regmap_init(st.dev, core::ptr::null_mut(), st,
...
#[no_mangle]
unsafe extern "C" fn ad74413r_unregister_driver(spi: *mut spi_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad74413r_register_driver(spi: *mut spi_driver) -> int __init {
