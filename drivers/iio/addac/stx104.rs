...
//! Source: drivers/iio/addac/stx104.c
#![no_std]
...
pub const STX104_NUM_OUT_CHAN: c_int = 2;
pub const STX104_EXTENT: c_int = 16;
    static unsigned int base[max_num_isa_dev(STX104_EXTENT)];
    static unsigned int num_stx104;
    module_param_hw_array(base, uint, ioport, &num_stx104, 0);
    MODULE_PARM_DESC(base, "Apex Embedded Systems STX104 base addresses");
pub const STX104_AIO_BASE: c_uint = 0x0;

pub const STX104_AIO_DATA_STRIDE: c_int = 2;
...
pub const STX104_DIFFERENTIAL: c_int = 1;
// ADC Control

// ADC Configuration

pub const STX104_BIPOLAR: c_int = 0;
pub const STX104_GAIN_X1: c_int = 0;
pub const STX104_GAIN_X2: c_int = 1;
pub const STX104_GAIN_X4: c_int = 2;
pub const STX104_GAIN_X8: c_int = 3;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stx104_iio {
    pub lock: mutex,
    pub aio_data_map: *mut regmap,
    pub aio_ctl_map: *mut regmap,
}
    ...
    {
    let mut priv: *mut stx104_iio const = iio_priv(indio_dev);
    int err;
...
pub const STX104_NGPIO: c_int = 8;
    static const char *stx104_names[STX104_NGPIO] = {
    "DIN0", "DIN1", "DIN2", "DIN3", "DOUT0", "DOUT1", "DOUT2", "DOUT3"
    };
#[no_mangle]
unsafe extern "C" fn bank_select_i8254(map: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stx104_init_hw(priv: *const *const stx104_iio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stx104_probe(dev: *mut device, id: c_uint) -> c_int {
