...
//! Source: drivers/iio/position/hid-sensor-custom-intel-hinge.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hinge_state {
    pub indio_dev: *mut iio_dev,
    pub hinge: [hid_sensor_hub_attribute_info; CHANNEL_SCAN_INDEX_MAX],
    pub callbacks: hid_sensor_hub_callbacks,
    pub common_attributes: hid_sensor_common,
    pub labels: [*const c_char; CHANNEL_SCAN_INDEX_MAX],
    struct {
    pub hinge_val: [u32; 3],
...
#[no_mangle]
unsafe extern "C" fn hid_hinge_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_hinge_remove(pdev: *mut platform_device) {
