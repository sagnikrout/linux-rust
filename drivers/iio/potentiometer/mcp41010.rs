...
//! Source: drivers/iio/potentiometer/mcp41010.c
#![no_std]
...
pub const MCP41010_MAX_WIPERS: c_int = 2;

pub const MCP41010_WIPER_MAX: c_int = 255;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp41010_cfg {
    pub name: [c_char; 16],
    pub wipers: c_int,
    pub kohms: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp41010_data {
    pub spi: *mut spi_device,
    pub cfg: *const mcp41010_cfg,
    pub /: *mut *mut mutex lock; / Protect write sequences,
    pub /: *mut *mut unsigned int value[MCP41010_MAX_WIPERS]; / Cache wiper values,
...
#[no_mangle]
unsafe extern "C" fn mcp41010_probe(spi: *mut spi_device) -> c_int {
