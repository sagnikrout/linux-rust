...
//! Source: drivers/iio/potentiometer/max5481.c
#![no_std]
...
pub const MAX5481_MAX_POS: c_int = 1023;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max5481_data {
    pub spi: *mut spi_device,
    pub cfg: *const max5481_cfg,
    pub __aligned(IIO_DMA_MINALIGN): u8 msg[3],
}
...
#[no_mangle]
unsafe extern "C" fn max5481_write_cmd(data: *mut max5481_data, cmd: u8, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max5481_wiper_save(data: *mut c_void) {
    static void max5481_wiper_save(void *data)
    {
    max5481_write_cmd(data, MAX5481_COPY_AB_TO_NV, 0);
    }
#[no_mangle]
unsafe extern "C" fn max5481_probe(spi: *mut spi_device) -> c_int {
