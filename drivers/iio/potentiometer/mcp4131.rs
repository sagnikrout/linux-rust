...
//! Source: drivers/iio/potentiometer/mcp4131.c
#![no_std]
...
pub const MCP4131_WIPER_SHIFT: c_int = 4;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp4131_cfg {
    pub wipers: c_int,
    pub max_pos: c_int,
    pub kohms: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp4131_data {
    pub spi: *mut spi_device,
    pub cfg: *const mcp4131_cfg,
    pub lock: mutex,
...
#[no_mangle]
unsafe extern "C" fn mcp4131_read(spi: *mut spi_device, buf: *mut c_void, len: usize) -> c_int {
    ...
    let mut address: c_int = chan.channel;
    switch (mask) {
...
// val2 = data->cfg->max_pos;
    ...
    int err;
    struct mcp4131_data *data = iio_priv(indio_dev);
    let mut address: c_int = chan.channel << MCP4131_WIPER_SHIFT;
    switch (mask) {
    case IIO_CHAN_INFO_RAW:
...
#[no_mangle]
unsafe extern "C" fn mcp4131_probe(spi: *mut spi_device) -> c_int {
