...
//! Source: drivers/iio/potentiometer/mcp4531.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp4531_data {
    pub client: *mut i2c_client,
    pub cfg: *const mcp4531_cfg,
}
    ...
    let mut address: c_int = chan.channel << MCP4531_WIPER_SHIFT;
    s32 ret;
    switch (mask) {
...
#[no_mangle]
unsafe extern "C" fn mcp4531_probe(client: *mut i2c_client) -> c_int {
