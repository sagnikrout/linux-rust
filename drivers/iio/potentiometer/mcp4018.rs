...
//! Source: drivers/iio/potentiometer/mcp4018.c
#![no_std]
...
pub const MCP4018_WIPER_MAX: c_int = 127;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp4018_cfg {
    pub kohms: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp4018_data {
    pub client: *mut i2c_client,
    pub cfg: *const mcp4018_cfg,
}
...
#[no_mangle]
unsafe extern "C" fn mcp4018_probe(client: *mut i2c_client) -> c_int {
