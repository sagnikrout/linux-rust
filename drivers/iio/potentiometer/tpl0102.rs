...
//! Source: drivers/iio/potentiometer/tpl0102.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpl0102_data {
    pub regmap: *mut regmap,
    pub cfg: *const tpl0102_cfg,
}
    ...
    let mut ret: c_int = regmap_read(data.regmap, chan.channel, val);
...
#[no_mangle]
unsafe extern "C" fn tpl0102_probe(client: *mut i2c_client) -> c_int {
