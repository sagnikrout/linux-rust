...
//! Source: drivers/iio/light/rpr0521.c
#![no_std]
...
pub const RPR0521_REG_SYSTEM_CTRL: c_uint = 0x40;
pub const RPR0521_REG_MODE_CTRL: c_uint = 0x41;
pub const RPR0521_REG_ALS_CTRL: c_uint = 0x42;
pub const RPR0521_REG_PXS_CTRL: c_uint = 0x43;
pub const RPR0521_REG_PXS_DATA: c_uint = 0x44 /* 16-bit, little endian */;
pub const RPR0521_REG_ALS_DATA0: c_uint = 0x46 /* 16-bit, little endian */;
pub const RPR0521_REG_ALS_DATA1: c_uint = 0x48 /* 16-bit, little endian */;
pub const RPR0521_REG_INTERRUPT: c_uint = 0x4A;
pub const RPR0521_REG_PS_OFFSET_LSB: c_uint = 0x53;
pub const RPR0521_REG_ID: c_uint = 0x92;

pub const RPR0521_ALS_DATA0_GAIN_SHIFT: c_int = 4;

pub const RPR0521_ALS_DATA1_GAIN_SHIFT: c_int = 2;

pub const RPR0521_PXS_GAIN_SHIFT: c_int = 4;

pub const RPR0521_MODE_ALS_DISABLE: c_uint = 0x00;

pub const RPR0521_MODE_PXS_DISABLE: c_uint = 0x00;
pub const RPR0521_PXS_PERSISTENCE_DRDY: c_uint = 0x00;

pub const RPR0521_INTERRUPT_INT_TRIG_PS_DISABLE: c_uint = 0x00;

pub const RPR0521_INTERRUPT_INT_TRIG_ALS_DISABLE: c_uint = 0x00;

pub const RPR0521_INTERRUPT_INT_REASSERT_DISABLE: c_uint = 0x00;
pub const RPR0521_MANUFACT_ID: c_uint = 0xE0;
pub const RPR0521_DEFAULT_MEAS_TIME: c_uint = 0x06 /* ALS - 100ms, PXS - 100ms */;

pub const RPR0521_SLEEP_DELAY_MS: c_int = 2000;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpr0521_gain {
    pub scale: c_int,
    pub uscale: c_int,
}
...
// device active status
    pub als_dev_en: bool,
    pub pxs_dev_en: bool,
    pub drdy_trigger0: *mut iio_trigger,
    pub irq_timestamp: i64,
// optimize runtime pm ops - enable/disable device only if needed
    pub als_ps_need_en: bool,
    pub pxs_ps_need_en: bool,
    pub als_need_dis: bool,
    pub pxs_need_dis: bool,
...
#[no_mangle]
unsafe extern "C" fn rpr0521_als_enable(data: *mut rpr0521_data, status: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_pxs_enable(data: *mut rpr0521_data, status: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rpr0521_is_triggered(data: *mut rpr0521_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_drdy_irq_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_drdy_irq_thread(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_trigger_consumer_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_write_int_enable(data: *mut rpr0521_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_write_int_disable(data: *mut rpr0521_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_read_ps_offset(data: *mut rpr0521_data, offset: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_write_ps_offset(data: *mut rpr0521_data, offset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_init(data: *mut rpr0521_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_poweroff(data: *mut rpr0521_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpr0521_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(rpr0521_runtime_suspend, rpr0521_runtime_resume, core::ptr::null_mut())
    };
