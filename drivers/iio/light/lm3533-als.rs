...
//! Source: drivers/iio/light/lm3533-als.c
#![no_std]
...
pub const LM3533_ALS_RESISTOR_MIN: c_int = 1;
pub const LM3533_ALS_RESISTOR_MAX: c_int = 127;
pub const LM3533_ALS_CHANNEL_CURRENT_MAX: c_int = 2;
pub const LM3533_ALS_THRESH_MAX: c_int = 3;
pub const LM3533_ALS_ZONE_MAX: c_int = 4;
pub const LM3533_REG_ALS_RESISTOR_SELECT: c_uint = 0x30;
pub const LM3533_REG_ALS_CONF: c_uint = 0x31;
pub const LM3533_REG_ALS_ZONE_INFO: c_uint = 0x34;
pub const LM3533_REG_ALS_READ_ADC_RAW: c_uint = 0x37;
pub const LM3533_REG_ALS_READ_ADC_AVERAGE: c_uint = 0x38;
pub const LM3533_REG_ALS_BOUNDARY_BASE: c_uint = 0x50;
pub const LM3533_REG_ALS_TARGET_BASE: c_uint = 0x60;
pub const LM3533_ALS_ENABLE_MASK: c_uint = 0x01;
pub const LM3533_ALS_INPUT_MODE_MASK: c_uint = 0x02;
pub const LM3533_ALS_INT_ENABLE_MASK: c_uint = 0x01;
pub const LM3533_ALS_ZONE_SHIFT: c_int = 2;
pub const LM3533_ALS_ZONE_MASK: c_uint = 0x1c;
pub const LM3533_ALS_FLAG_INT_ENABLED: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm3533_als {
    pub lm3533: *mut lm3533,
    pub pdev: *mut platform_device,
    pub flags: c_ulong,
    pub irq: c_int,
    pub zone: core::sync::atomic::AtomicI32,
    pub thresh_mutex: mutex,
}
...
#[no_mangle]
unsafe extern "C" fn _lm3533_als_get_zone(indio_dev: *mut iio_dev, zone: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3533_als_get_zone(indio_dev: *mut iio_dev, zone: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn lm3533_als_get_target_reg(channel: unsigned, zone: unsigned) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn lm3533_als_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn lm3533_als_set_int_mode(indio_dev: *mut iio_dev, enable: c_int) -> c_int {
    static int lm3533_als_set_int_mode(struct iio_dev *indio_dev, int enable)
    {
    struct lm3533_als *als = iio_priv(indio_dev);
    let mut mask: u8 = LM3533_ALS_INT_ENABLE_MASK;
    u8 val;
    int ret;
    if (enable)
    val = mask;
...
#[no_mangle]
unsafe extern "C" fn lm3533_als_get_int_mode(indio_dev: *mut iio_dev, enable: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lm3533_als_get_threshold_reg(nr: unsigned, raising: bool) -> u8 {
    static inline u8 lm3533_als_get_threshold_reg(unsigned nr, bool raising)
    {
    let mut offset: u8 = !raising;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm3533_als_attribute {
    pub dev_attr: device_attribute,
    pub type: enum lm3533_als_attribute_type,
    pub val1: u8,
    pub val2: u8,
}
...
//
    ...
    S_IRUGO, show_als_attr, core::ptr::null_mut(),			\
...
//
    ...
    DEVICE_ATTR(in_illuminance0_##_name, S_IRUGO, show_##_name, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn lm3533_als_set_input_mode(als: *mut lm3533_als, pwm_mode: bool) -> c_int {
    static int lm3533_als_set_input_mode(struct lm3533_als *als, bool pwm_mode)
    {
    let mut mask: u8 = LM3533_ALS_INPUT_MODE_MASK;
    u8 val;
    int ret;
    if (pwm_mode)
    val = mask;	/* pwm input */
...
#[no_mangle]
unsafe extern "C" fn lm3533_als_set_resistor(als: *mut lm3533_als, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3533_als_setup_irq(als: *mut lm3533_als, dev: *mut c_void) -> c_int {
...
// Make sure interrupts are disabled.
    ...
    ret = request_threaded_irq(als.irq, core::ptr::null_mut(), lm3533_als_isr,
...
#[no_mangle]
unsafe extern "C" fn lm3533_als_enable(als: *mut lm3533_als) -> c_int {
    static int lm3533_als_enable(struct lm3533_als *als)
    {
    let mut mask: u8 = LM3533_ALS_ENABLE_MASK;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn lm3533_als_disable(als: *mut lm3533_als) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3533_als_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3533_als_remove(pdev: *mut platform_device) {
