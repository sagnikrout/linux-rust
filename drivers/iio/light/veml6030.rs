...
//! Source: drivers/iio/light/veml6030.c
#![no_std]
...
// Device registers
pub const VEML6030_REG_ALS_CONF: c_uint = 0x00;
pub const VEML6030_REG_ALS_WH: c_uint = 0x01;
pub const VEML6030_REG_ALS_WL: c_uint = 0x02;
pub const VEML6030_REG_ALS_PSM: c_uint = 0x03;
pub const VEML6030_REG_ALS_DATA: c_uint = 0x04;
pub const VEML6030_REG_WH_DATA: c_uint = 0x05;
pub const VEML6030_REG_ALS_INT: c_uint = 0x06;
...
pub const VEML6030_MAX_SCALE: c_int = 21504;
pub const VEML6035_MAX_SCALE: c_int = 4096;
    enum veml6030_scan {
    VEML6030_SCAN_ALS,
    VEML6030_SCAN_WH,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct veml6030_rf {
    pub it: *mut regmap_field,
    pub gain: *mut regmap_field,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct veml603x_chip {
    pub name: *const c_char,
    pub channels: *const iio_chan_spec,
    pub num_channels: c_int,
    pub gain_rf: reg_field,
    pub it_rf: reg_field,
    pub max_scale: c_int,
    pub dev): *mut *mut *mut int (hw_init)(struct iio_dev indio_dev, struct device,
    pub indio_dev): *mut *mut int (set_info)(struct iio_dev,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct veml6030_data {
    pub client: *mut i2c_client,
    pub regmap: *mut regmap,
    pub rf: veml6030_rf,
    pub chip: *const veml603x_chip,
    pub gts: iio_gts,
}

pub const VEML6030_SEL_IT_25MS: c_uint = 0x0C;
pub const VEML6030_SEL_IT_50MS: c_uint = 0x08;
pub const VEML6030_SEL_IT_100MS: c_uint = 0x00;
pub const VEML6030_SEL_IT_200MS: c_uint = 0x01;
pub const VEML6030_SEL_IT_400MS: c_uint = 0x02;
pub const VEML6030_SEL_IT_800MS: c_uint = 0x03;
...
//
pub const VEML6030_SEL_MILLI_GAIN_X125: c_int = 2;
pub const VEML6030_SEL_MILLI_GAIN_X250: c_int = 3;
pub const VEML6030_SEL_MILLI_GAIN_X1000: c_int = 0;
pub const VEML6030_SEL_MILLI_GAIN_X2000: c_int = 1;
...
pub const VEML6035_SEL_MILLI_GAIN_X125: c_int = 4;
pub const VEML6035_SEL_MILLI_GAIN_X250: c_int = 5;
pub const VEML6035_SEL_MILLI_GAIN_X500: c_int = 7;
pub const VEML6035_SEL_MILLI_GAIN_X1000: c_int = 0;
pub const VEML6035_SEL_MILLI_GAIN_X2000: c_int = 1;
pub const VEML6035_SEL_MILLI_GAIN_X4000: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn veml6030_als_pwr_on(data: *mut veml6030_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6030_als_shut_down(data: *mut veml6030_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6030_als_shut_down_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn veml6030_get_it(data: *mut veml6030_data, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6030_set_it(indio_dev: *mut iio_dev, val: c_int, val2: c_int) -> c_int {
...
// val2 = period % 1000000;
    ...
    period = 1600000 / y;
#[no_mangle]
pub unsafe extern "C" fn if(200000): (val == 3) && (val2 ==) -> else {
    else if ((val == 3) && (val2 == 200000))
    period = 3200000 / y;
#[no_mangle]
pub unsafe extern "C" fn if(400000): (val == 6) && (val2 ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn veml6030_set_scale(indio_dev: *mut iio_dev, val: c_int, val2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6030_get_total_gain(data: *mut veml6030_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6030_get_scale(data: *mut veml6030_data, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6030_event_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn veml6030_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn veml6030_set_info(indio_dev: *mut iio_dev) -> c_int {
    ...
    core::ptr::null_mut(), veml6030_event_handler,
...
#[no_mangle]
unsafe extern "C" fn veml7700_set_info(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6030_regfield_init(indio_dev: *mut iio_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn veml6030_hw_init(indio_dev: *mut iio_dev, dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn veml6035_hw_init(indio_dev: *mut iio_dev, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6030_probe(client: *mut i2c_client) -> c_int {
    ...
    veml6030_trigger_handler, core::ptr::null_mut());
    if (ret)
    return dev_err_probe(&client.dev, ret,
...
#[no_mangle]
unsafe extern "C" fn veml6030_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6030_runtime_resume(dev: *mut device) -> c_int {
    ...
    veml6030_runtime_resume, core::ptr::null_mut());
