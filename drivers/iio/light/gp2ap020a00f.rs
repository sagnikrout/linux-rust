...
//! Source: drivers/iio/light/gp2ap020a00f.c
#![no_std]
...
// Registers
pub const GP2AP020A00F_OP_REG: c_uint = 0x00 /* Basic operations */;
pub const GP2AP020A00F_ALS_REG: c_uint = 0x01 /* ALS related settings */;
pub const GP2AP020A00F_PS_REG: c_uint = 0x02 /* PS related settings */;
pub const GP2AP020A00F_LED_REG: c_uint = 0x03 /* LED reg */;
pub const GP2AP020A00F_TL_L_REG: c_uint = 0x04 /* ALS: Threshold low LSB */;
pub const GP2AP020A00F_TL_H_REG: c_uint = 0x05 /* ALS: Threshold low MSB */;
pub const GP2AP020A00F_TH_L_REG: c_uint = 0x06 /* ALS: Threshold high LSB */;
pub const GP2AP020A00F_TH_H_REG: c_uint = 0x07 /* ALS: Threshold high MSB */;
pub const GP2AP020A00F_PL_L_REG: c_uint = 0x08 /* PS: Threshold low LSB */;
pub const GP2AP020A00F_PL_H_REG: c_uint = 0x09 /* PS: Threshold low MSB */;
pub const GP2AP020A00F_PH_L_REG: c_uint = 0x0a /* PS: Threshold high LSB */;
pub const GP2AP020A00F_PH_H_REG: c_uint = 0x0b /* PS: Threshold high MSB */;
pub const GP2AP020A00F_D0_L_REG: c_uint = 0x0c /* ALS result: Clear/Illuminance LSB */;
pub const GP2AP020A00F_D0_H_REG: c_uint = 0x0d /* ALS result: Clear/Illuminance MSB */;
pub const GP2AP020A00F_D1_L_REG: c_uint = 0x0e /* ALS result: IR LSB */;
pub const GP2AP020A00F_D1_H_REG: c_uint = 0x0f /* ALS result: IR LSB */;
pub const GP2AP020A00F_D2_L_REG: c_uint = 0x10 /* PS result LSB */;
pub const GP2AP020A00F_D2_H_REG: c_uint = 0x11 /* PS result MSB */;
pub const GP2AP020A00F_NUM_REGS: c_uint = 0x12 /* Number of registers */;
// OP_REG bits
pub const GP2AP020A00F_OP3_MASK: c_uint = 0x80 /* Software shutdown */;
pub const GP2AP020A00F_OP3_SHUTDOWN: c_uint = 0x00;
pub const GP2AP020A00F_OP3_OPERATION: c_uint = 0x80;
pub const GP2AP020A00F_OP2_MASK: c_uint = 0x40 /* Auto shutdown/Continuous mode */;
pub const GP2AP020A00F_OP2_AUTO_SHUTDOWN: c_uint = 0x00;
pub const GP2AP020A00F_OP2_CONT_OPERATION: c_uint = 0x40;
pub const GP2AP020A00F_OP_MASK: c_uint = 0x30 /* Operating mode selection  */;
pub const GP2AP020A00F_OP_ALS_AND_PS: c_uint = 0x00;
pub const GP2AP020A00F_OP_ALS: c_uint = 0x10;
pub const GP2AP020A00F_OP_PS: c_uint = 0x20;
pub const GP2AP020A00F_OP_DEBUG: c_uint = 0x30;
pub const GP2AP020A00F_PROX_MASK: c_uint = 0x08 /* PS: detection/non-detection */;
pub const GP2AP020A00F_PROX_NON_DETECT: c_uint = 0x00;
pub const GP2AP020A00F_PROX_DETECT: c_uint = 0x08;
pub const GP2AP020A00F_FLAG_P: c_uint = 0x04 /* PS: interrupt result  */;
pub const GP2AP020A00F_FLAG_A: c_uint = 0x02 /* ALS: interrupt result  */;
pub const GP2AP020A00F_TYPE_MASK: c_uint = 0x01 /* Output data type selection */;
pub const GP2AP020A00F_TYPE_MANUAL_CALC: c_uint = 0x00;
pub const GP2AP020A00F_TYPE_AUTO_CALC: c_uint = 0x01;
// ALS_REG bits
pub const GP2AP020A00F_PRST_MASK: c_uint = 0xc0 /* Number of measurement cycles */;
pub const GP2AP020A00F_PRST_ONCE: c_uint = 0x00;
pub const GP2AP020A00F_PRST_4_CYCLES: c_uint = 0x40;
pub const GP2AP020A00F_PRST_8_CYCLES: c_uint = 0x80;
pub const GP2AP020A00F_PRST_16_CYCLES: c_uint = 0xc0;
pub const GP2AP020A00F_RES_A_MASK: c_uint = 0x38 /* ALS: Resolution */;
pub const GP2AP020A00F_RES_A_800ms: c_uint = 0x00;
pub const GP2AP020A00F_RES_A_400ms: c_uint = 0x08;
pub const GP2AP020A00F_RES_A_200ms: c_uint = 0x10;
pub const GP2AP020A00F_RES_A_100ms: c_uint = 0x18;
pub const GP2AP020A00F_RES_A_25ms: c_uint = 0x20;
pub const GP2AP020A00F_RES_A_6_25ms: c_uint = 0x28;
pub const GP2AP020A00F_RES_A_1_56ms: c_uint = 0x30;
pub const GP2AP020A00F_RES_A_0_39ms: c_uint = 0x38;
pub const GP2AP020A00F_RANGE_A_MASK: c_uint = 0x07 /* ALS: Max measurable range */;
pub const GP2AP020A00F_RANGE_A_x1: c_uint = 0x00;
pub const GP2AP020A00F_RANGE_A_x2: c_uint = 0x01;
pub const GP2AP020A00F_RANGE_A_x4: c_uint = 0x02;
pub const GP2AP020A00F_RANGE_A_x8: c_uint = 0x03;
pub const GP2AP020A00F_RANGE_A_x16: c_uint = 0x04;
pub const GP2AP020A00F_RANGE_A_x32: c_uint = 0x05;
pub const GP2AP020A00F_RANGE_A_x64: c_uint = 0x06;
pub const GP2AP020A00F_RANGE_A_x128: c_uint = 0x07;
// PS_REG bits
pub const GP2AP020A00F_ALC_MASK: c_uint = 0x80 /* Auto light cancel */;
pub const GP2AP020A00F_ALC_ON: c_uint = 0x80;
pub const GP2AP020A00F_ALC_OFF: c_uint = 0x00;
pub const GP2AP020A00F_INTTYPE_MASK: c_uint = 0x40 /* Interrupt type setting */;
pub const GP2AP020A00F_INTTYPE_LEVEL: c_uint = 0x00;
pub const GP2AP020A00F_INTTYPE_PULSE: c_uint = 0x40;
pub const GP2AP020A00F_RES_P_MASK: c_uint = 0x38 /* PS: Resolution */;
pub const GP2AP020A00F_RES_P_800ms_x2: c_uint = 0x00;
pub const GP2AP020A00F_RES_P_400ms_x2: c_uint = 0x08;
pub const GP2AP020A00F_RES_P_200ms_x2: c_uint = 0x10;
pub const GP2AP020A00F_RES_P_100ms_x2: c_uint = 0x18;
pub const GP2AP020A00F_RES_P_25ms_x2: c_uint = 0x20;
pub const GP2AP020A00F_RES_P_6_25ms_x2: c_uint = 0x28;
pub const GP2AP020A00F_RES_P_1_56ms_x2: c_uint = 0x30;
pub const GP2AP020A00F_RES_P_0_39ms_x2: c_uint = 0x38;
pub const GP2AP020A00F_RANGE_P_MASK: c_uint = 0x07 /* PS: Max measurable range */;
pub const GP2AP020A00F_RANGE_P_x1: c_uint = 0x00;
pub const GP2AP020A00F_RANGE_P_x2: c_uint = 0x01;
pub const GP2AP020A00F_RANGE_P_x4: c_uint = 0x02;
pub const GP2AP020A00F_RANGE_P_x8: c_uint = 0x03;
pub const GP2AP020A00F_RANGE_P_x16: c_uint = 0x04;
pub const GP2AP020A00F_RANGE_P_x32: c_uint = 0x05;
pub const GP2AP020A00F_RANGE_P_x64: c_uint = 0x06;
pub const GP2AP020A00F_RANGE_P_x128: c_uint = 0x07;
// LED reg bits
pub const GP2AP020A00F_INTVAL_MASK: c_uint = 0xc0 /* Intermittent operating */;
pub const GP2AP020A00F_INTVAL_0: c_uint = 0x00;
pub const GP2AP020A00F_INTVAL_4: c_uint = 0x40;
pub const GP2AP020A00F_INTVAL_8: c_uint = 0x80;
pub const GP2AP020A00F_INTVAL_16: c_uint = 0xc0;
pub const GP2AP020A00F_IS_MASK: c_uint = 0x30 /* ILED drive peak current */;
pub const GP2AP020A00F_IS_13_8mA: c_uint = 0x00;
pub const GP2AP020A00F_IS_27_5mA: c_uint = 0x10;
pub const GP2AP020A00F_IS_55mA: c_uint = 0x20;
pub const GP2AP020A00F_IS_110mA: c_uint = 0x30;
pub const GP2AP020A00F_PIN_MASK: c_uint = 0x0c /* INT terminal setting */;
pub const GP2AP020A00F_PIN_ALS_OR_PS: c_uint = 0x00;
pub const GP2AP020A00F_PIN_ALS: c_uint = 0x04;
pub const GP2AP020A00F_PIN_PS: c_uint = 0x08;
pub const GP2AP020A00F_PIN_PS_DETECT: c_uint = 0x0c;
pub const GP2AP020A00F_FREQ_MASK: c_uint = 0x02 /* LED modulation frequency */;
pub const GP2AP020A00F_FREQ_327_5kHz: c_uint = 0x00;
pub const GP2AP020A00F_FREQ_81_8kHz: c_uint = 0x02;
pub const GP2AP020A00F_RST: c_uint = 0x01 /* Software reset */;
pub const GP2AP020A00F_SCAN_MODE_LIGHT_CLEAR: c_int = 0;
pub const GP2AP020A00F_SCAN_MODE_LIGHT_IR: c_int = 1;
pub const GP2AP020A00F_SCAN_MODE_PROXIMITY: c_int = 2;
pub const GP2AP020A00F_CHAN_TIMESTAMP: c_int = 3;

pub const GP2AP020A00F_SUBTRACT_MODE: c_int = 0;
pub const GP2AP020A00F_ADD_MODE: c_int = 1;
pub const GP2AP020A00F_MAX_CHANNELS: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gp2ap020a00f_data {
    pub client: *mut i2c_client,
    pub lock: mutex,
    pub buffer: *mut c_char,
    pub vled_reg: *mut regulator,
    pub flags: c_ulong,
    pub cur_opmode: enum gp2ap020a00f_opmode,
    pub trig: *mut iio_trigger,
    pub regmap: *mut regmap,
    pub thresh_val: [c_uint; 4],
    pub work: irq_work,
...
#[no_mangle]
unsafe extern "C" fn gp2ap020a00f_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gp2ap020a00f_als_enabled(data: *mut gp2ap020a00f_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gp2ap020a00f_prox_detect_enabled(data: *mut gp2ap020a00f_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wait_conversion_complete_irq(data: *mut gp2ap020a00f_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gp2ap020a00f_iio_trigger_work(work: *mut irq_work) {
...
#[no_mangle]
unsafe extern "C" fn gp2ap020a00f_prox_sensing_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gp2ap020a00f_thresh_event_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gp2ap020a00f_trigger_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
    ...
    if (state)
    err = request_threaded_irq(data.client.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn gp2ap020a00f_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gp2ap020a00f_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gp2ap020a00f_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gp2ap020a00f_remove(client: *mut i2c_client) {
