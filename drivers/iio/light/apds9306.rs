...
//! Source: drivers/iio/light/apds9306.c
#![no_std]
...
pub const APDS9306_MAIN_CTRL_REG: c_uint = 0x00;
pub const APDS9306_ALS_MEAS_RATE_REG: c_uint = 0x04;
pub const APDS9306_ALS_GAIN_REG: c_uint = 0x05;
pub const APDS9306_PART_ID_REG: c_uint = 0x06;
pub const APDS9306_MAIN_STATUS_REG: c_uint = 0x07;
pub const APDS9306_CLEAR_DATA_0_REG: c_uint = 0x0A;
pub const APDS9306_CLEAR_DATA_1_REG: c_uint = 0x0B;
pub const APDS9306_CLEAR_DATA_2_REG: c_uint = 0x0C;
pub const APDS9306_ALS_DATA_0_REG: c_uint = 0x0D;
pub const APDS9306_ALS_DATA_1_REG: c_uint = 0x0E;
pub const APDS9306_ALS_DATA_2_REG: c_uint = 0x0F;
pub const APDS9306_INT_CFG_REG: c_uint = 0x19;
pub const APDS9306_INT_PERSISTENCE_REG: c_uint = 0x1A;
pub const APDS9306_ALS_THRES_UP_0_REG: c_uint = 0x21;
pub const APDS9306_ALS_THRES_UP_1_REG: c_uint = 0x22;
pub const APDS9306_ALS_THRES_UP_2_REG: c_uint = 0x23;
pub const APDS9306_ALS_THRES_LOW_0_REG: c_uint = 0x24;
pub const APDS9306_ALS_THRES_LOW_1_REG: c_uint = 0x25;
pub const APDS9306_ALS_THRES_LOW_2_REG: c_uint = 0x26;
pub const APDS9306_ALS_THRES_VAR_REG: c_uint = 0x27;

pub const APDS9306_ALS_THRES_VAR_NUM_VALS: c_int = 8;
pub const APDS9306_ALS_PERSIST_NUM_VALS: c_int = 16;

pub const APDS9306_NUM_REPEAT_RATES: c_int = 7;
pub const APDS9306_INT_SRC_CLEAR: c_int = 0;
pub const APDS9306_INT_SRC_ALS: c_int = 1;
pub const APDS9306_SAMP_FREQ_10HZ: c_int = 0;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct part_id_gts_multiplier {
    pub part_id: c_int,
    pub max_scale_int: c_int,
    pub max_scale_nano: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apds9306_regfields {
    pub sw_reset: *mut regmap_field,
    pub en: *mut regmap_field,
    pub intg_time: *mut regmap_field,
    pub repeat_rate: *mut regmap_field,
    pub gain: *mut regmap_field,
    pub int_src: *mut regmap_field,
    pub int_thresh_var_en: *mut regmap_field,
    pub int_en: *mut regmap_field,
    pub int_persist_val: *mut regmap_field,
    pub int_thresh_var_val: *mut regmap_field,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apds9306_data {
    pub dev: *mut device,
    pub gts: iio_gts,
    pub mutex: mutex,
    pub regmap: *mut regmap,
    pub rf: apds9306_regfields,
    pub read_data_available: c_int,
}
...
//
pub const APDS9306_GSEL_1X: c_uint = 0x00;
pub const APDS9306_GSEL_3X: c_uint = 0x01;
pub const APDS9306_GSEL_6X: c_uint = 0x02;
pub const APDS9306_GSEL_9X: c_uint = 0x03;
pub const APDS9306_GSEL_18X: c_uint = 0x04;
...
pub const APDS9306_MEAS_MODE_400MS: c_uint = 0x00;
pub const APDS9306_MEAS_MODE_200MS: c_uint = 0x01;
pub const APDS9306_MEAS_MODE_100MS: c_uint = 0x02;
pub const APDS9306_MEAS_MODE_50MS: c_uint = 0x03;
pub const APDS9306_MEAS_MODE_25MS: c_uint = 0x04;
pub const APDS9306_MEAS_MODE_3125US: c_uint = 0x05;
...
#[no_mangle]
unsafe extern "C" fn apds9306_regfield_init(data: *mut apds9306_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_power_state(data: *mut apds9306_data, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_read_data(data: *mut apds9306_data, val: *mut c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_intg_time_get(data: *mut apds9306_data, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_intg_time_set(data: *mut apds9306_data, val2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_scale_get(data: *mut apds9306_data, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_scale_set(data: *mut apds9306_data, val: c_int, val2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_event_period_get(data: *mut apds9306_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_event_period_set(data: *mut apds9306_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_get_thresh_reg(dir: c_int) -> c_int {
    static int apds9306_get_thresh_reg(int dir)
    {
    if (dir == IIO_EV_DIR_RISING)
    return APDS9306_ALS_THRES_UP_0_REG;
#[no_mangle]
pub unsafe extern "C" fn if(IIO_EV_DIR_FALLING: dir ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn apds9306_event_thresh_adaptive_get(data: *mut apds9306_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_event_thresh_adaptive_set(data: *mut apds9306_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_irq_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(IIO_INTENSITY: chan->type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn apds9306_init_iio_gts(data: *mut apds9306_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_powerdown(ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn apds9306_device_init(data: *mut apds9306_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_pm_init(data: *mut apds9306_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9306_runtime_resume(dev: *mut device) -> c_int {
