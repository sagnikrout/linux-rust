...
//! Source: drivers/iio/light/opt4001.c
#![no_std]
...
pub const OPT4001_LIGHT1_MSB: c_uint = 0x00;
pub const OPT4001_LIGHT1_LSB: c_uint = 0x01;
pub const OPT4001_CTRL: c_uint = 0x0A;
pub const OPT4001_DEVICE_ID: c_uint = 0x11;
...
// OPT4001 constants
pub const OPT4001_DEVICE_ID_VAL: c_uint = 0x121;
// OPT4001 operating modes
pub const OPT4001_CTRL_OPER_MODE_OFF: c_uint = 0x0;
pub const OPT4001_CTRL_OPER_MODE_FORCED: c_uint = 0x1;
pub const OPT4001_CTRL_OPER_MODE_ONE_SHOT: c_uint = 0x2;
pub const OPT4001_CTRL_OPER_MODE_CONTINUOUS: c_uint = 0x3;
// OPT4001 conversion control register definitions
pub const OPT4001_CTRL_CONVERSION_0_6MS: c_uint = 0x0;
pub const OPT4001_CTRL_CONVERSION_1MS: c_uint = 0x1;
pub const OPT4001_CTRL_CONVERSION_1_8MS: c_uint = 0x2;
pub const OPT4001_CTRL_CONVERSION_3_4MS: c_uint = 0x3;
pub const OPT4001_CTRL_CONVERSION_6_5MS: c_uint = 0x4;
pub const OPT4001_CTRL_CONVERSION_12_7MS: c_uint = 0x5;
pub const OPT4001_CTRL_CONVERSION_25MS: c_uint = 0x6;
pub const OPT4001_CTRL_CONVERSION_50MS: c_uint = 0x7;
pub const OPT4001_CTRL_CONVERSION_100MS: c_uint = 0x8;
pub const OPT4001_CTRL_CONVERSION_200MS: c_uint = 0x9;
pub const OPT4001_CTRL_CONVERSION_400MS: c_uint = 0xa;
pub const OPT4001_CTRL_CONVERSION_800MS: c_uint = 0xb;
// OPT4001 scale light level range definitions
pub const OPT4001_CTRL_LIGHT_SCALE_AUTO: c_int = 12;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct opt4001_chip {
    pub regmap: *mut regmap,
    pub client: *mut i2c_client,
    pub int_time: u8,
    pub chip_info: *const opt4001_chip_info,
}
...
#[no_mangle]
unsafe extern "C" fn opt4001_als_time_to_index(als_integration_time: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4001_calculate_crc(exp: u8, mantissa: u32, count: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn opt4001_set_conf(chip: *mut opt4001_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4001_chip_off_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn opt4001_load_defaults(chip: *mut opt4001_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4001_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn opt4001_writable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn opt4001_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn opt4001_probe(client: *mut i2c_client) -> c_int {
