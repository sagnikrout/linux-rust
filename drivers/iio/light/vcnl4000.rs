...
//! Source: drivers/iio/light/vcnl4000.c
#![no_std]
...
pub const VCNL4000_PROD_ID: c_uint = 0x01;
pub const VCNL4010_PROD_ID: c_uint = 0x02 /* for VCNL4020, VCNL4010 */;
pub const VCNL4040_PROD_ID: c_uint = 0x86;
pub const VCNL4200_PROD_ID: c_uint = 0x58;
pub const VCNL4000_COMMAND: c_uint = 0x80 /* Command register */;
pub const VCNL4000_PROD_REV: c_uint = 0x81 /* Product ID and Revision ID */;
pub const VCNL4010_PROX_RATE: c_uint = 0x82 /* Proximity rate */;
pub const VCNL4000_LED_CURRENT: c_uint = 0x83 /* IR LED current for proximity mode */;
pub const VCNL4000_AL_PARAM: c_uint = 0x84 /* Ambient light parameter register */;
pub const VCNL4010_ALS_PARAM: c_uint = 0x84 /* ALS rate */;
pub const VCNL4000_AL_RESULT_HI: c_uint = 0x85 /* Ambient light result register, MSB */;
pub const VCNL4000_AL_RESULT_LO: c_uint = 0x86 /* Ambient light result register, LSB */;
pub const VCNL4000_PS_RESULT_HI: c_uint = 0x87 /* Proximity result register, MSB */;
pub const VCNL4000_PS_RESULT_LO: c_uint = 0x88 /* Proximity result register, LSB */;
pub const VCNL4000_PS_MEAS_FREQ: c_uint = 0x89 /* Proximity test signal frequency */;
pub const VCNL4010_INT_CTRL: c_uint = 0x89 /* Interrupt control */;
pub const VCNL4000_PS_MOD_ADJ: c_uint = 0x8a /* Proximity modulator timing adjustment */;
pub const VCNL4010_LOW_THR_HI: c_uint = 0x8a /* Low threshold, MSB */;
pub const VCNL4010_LOW_THR_LO: c_uint = 0x8b /* Low threshold, LSB */;
pub const VCNL4010_HIGH_THR_HI: c_uint = 0x8c /* High threshold, MSB */;
pub const VCNL4010_HIGH_THR_LO: c_uint = 0x8d /* High threshold, LSB */;
pub const VCNL4010_ISR: c_uint = 0x8e /* Interrupt status */;
pub const VCNL4200_AL_CONF: c_uint = 0x00 /* Ambient light configuration */;
pub const VCNL4200_PS_CONF1: c_uint = 0x03 /* Proximity configuration */;
pub const VCNL4200_PS_CONF3: c_uint = 0x04 /* Proximity configuration */;
pub const VCNL4040_PS_THDL_LM: c_uint = 0x06 /* Proximity threshold low */;
pub const VCNL4040_PS_THDH_LM: c_uint = 0x07 /* Proximity threshold high */;
pub const VCNL4040_ALS_THDL_LM: c_uint = 0x02 /* Ambient light threshold low */;
pub const VCNL4040_ALS_THDH_LM: c_uint = 0x01 /* Ambient light threshold high */;
pub const VCNL4200_PS_DATA: c_uint = 0x08 /* Proximity data */;
pub const VCNL4200_AL_DATA: c_uint = 0x09 /* Ambient light data */;
pub const VCNL4040_INT_FLAGS: c_uint = 0x0b /* Interrupt register */;
pub const VCNL4200_INT_FLAGS: c_uint = 0x0d /* Interrupt register */;
pub const VCNL4200_DEV_ID: c_uint = 0x0e /* Device ID, slave address and version */;
pub const VCNL4040_DEV_ID: c_uint = 0x0c /* Device ID and version */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vcnl4200_channel {
    pub reg: u8,
    pub last_measurement: ktime_t,
    pub sampling_rate: ktime_t,
    pub lock: mutex,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vcnl4000_data {
    pub client: *mut i2c_client,
    pub rev: c_int,
    pub al_scale: c_int,
    pub ps_scale: c_int,
    pub /: *mut *mut u8 ps_int; / proximity interrupt mode,
    pub mode*/: *mut *mut u8 als_int; / ambient light interrupt,
    pub chip_spec: *const vcnl4000_chip_spec,
    pub vcnl4000_lock: mutex,
    pub vcnl4200_al: vcnl4200_channel,
    pub vcnl4200_ps: vcnl4200_channel,
    pub near_level: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vcnl4000_chip_spec {
    pub prod: *const c_char,
    pub channels: *const iio_chan_spec,
    pub num_channels: c_int,
    pub info: *const iio_info,
    pub buffer_setup_ops: *const iio_buffer_setup_ops,
    pub data): *mut *mut int (init)(struct vcnl4000_data,
    pub val): *mut *mut *mut int (measure_light)(struct vcnl4000_data data, int,
    pub val): *mut *mut *mut int (measure_proximity)(struct vcnl4000_data data, int,
    pub on): *mut *mut *mut int (set_power_state)(struct vcnl4000_data data, bool,
    pub priv): *mut *mut irqreturn_t (irq_thread)(int irq, void,
    pub priv): *mut *mut irqreturn_t (trig_buffer_func)(int irq, void,
    pub int_reg: u8,
    pub int(*ps_it_times)[][2]: *const ,
    pub num_ps_it_times: c_int,
    pub int(*als_it_times)[][2]: *const ,
    pub num_als_it_times: c_int,
    pub ulux_step: c_uint,
    pub prod_id: c_int,
}

#[no_mangle]
unsafe extern "C" fn vcnl4000_set_power_state(data: *mut vcnl4000_data, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4000_init(data: *mut vcnl4000_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4000_write_als_enable(data: *mut vcnl4000_data, en: bool) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vcnl4000_write_ps_enable(data: *mut vcnl4000_data, en: bool) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vcnl4200_set_power_state(data: *mut vcnl4000_data, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4200_init(data: *mut vcnl4000_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4000_read_data(data: *mut vcnl4000_data, data_reg: u8, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4000_write_data(data: *mut vcnl4000_data, data_reg: u8, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4000_measure_light(data: *mut vcnl4000_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4200_measure_light(data: *mut vcnl4000_data, val: *mut c_int) -> c_int {
    static int vcnl4200_measure_light(struct vcnl4000_data *data, int *val)
    {
    return vcnl4200_measure(data, &data.vcnl4200_al, val);
    }
#[no_mangle]
unsafe extern "C" fn vcnl4000_measure_proximity(data: *mut vcnl4000_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4200_measure_proximity(data: *mut vcnl4000_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4010_is_in_periodic_mode(data: *mut vcnl4000_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vcnl4040_read_als_it(data: *mut vcnl4000_data, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4040_write_als_it(data: *mut vcnl4000_data, val: c_int) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vcnl4040_read_ps_it(data: *mut vcnl4000_data, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4040_write_ps_it(data: *mut vcnl4000_data, val: c_int) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vcnl4040_read_als_period(data: *mut vcnl4000_data, val: *mut c_int, val2: *mut c_int) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vcnl4040_write_als_period(data: *mut vcnl4000_data, val: c_int, val2: c_int) -> isize {
    static ssize_t vcnl4040_write_als_period(struct vcnl4000_data *data, int val, int val2)
    {
    unsigned int i;
    int ret, it;
    u16 regval;
    let mut val_n: u64 = mul_u32_u32(val, MICRO) + val2;
    ret = i2c_smbus_read_word_data(data.client, VCNL4200_AL_CONF);
    if (ret < 0)
    return ret;
    it = FIELD_GET(VCNL4040_ALS_CONF_IT, ret);
...
#[no_mangle]
unsafe extern "C" fn vcnl4040_read_ps_period(data: *mut vcnl4000_data, val: *mut c_int, val2: *mut c_int) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vcnl4040_write_ps_period(data: *mut vcnl4000_data, val: c_int, val2: c_int) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vcnl4040_read_ps_oversampling_ratio(data: *mut vcnl4000_data, val: *mut c_int) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vcnl4040_write_ps_oversampling_ratio(data: *mut vcnl4000_data, val: c_int) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vcnl4040_read_ps_calibbias(data: *mut vcnl4000_data, val: *mut c_int, val2: *mut c_int) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vcnl4040_write_ps_calibbias(data: *mut vcnl4000_data, val: c_int) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vcnl4010_is_thr_enabled(data: *mut vcnl4000_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vcnl4010_config_threshold_enable(data: *mut vcnl4000_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4010_config_threshold_disable(data: *mut vcnl4000_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4010_config_threshold(indio_dev: *mut iio_dev, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4040_irq_thread(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vcnl4010_irq_thread(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vcnl4010_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vcnl4010_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4010_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4010_probe_trigger(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4000_cleanup(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn vcnl4000_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4000_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4000_runtime_resume(dev: *mut device) -> c_int {
    ...
    vcnl4000_runtime_resume, core::ptr::null_mut());
