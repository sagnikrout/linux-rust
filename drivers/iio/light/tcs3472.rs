...
//! Source: drivers/iio/light/tcs3472.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tcs3472_data {
    pub client: *mut i2c_client,
    pub lock: mutex,
    pub target_freq_hz: c_int,
    pub target_freq_uhz: c_int,
    pub low_thresh: u16,
    pub high_thresh: u16,
    pub enable: u8,
    pub enable_pre_suspend: u8,
    pub control: u8,
    pub atime: u8,
    pub apers: u8,
    pub wtime: u8,
    ...
    .event_spec = _si ? core::ptr::null_mut() : tcs3472_events, \
...
//
#[no_mangle]
unsafe extern "C" fn tcs3472_cycle_time_us(data: *mut tcs3472_data) -> c_uint {
    static unsigned int tcs3472_cycle_time_us(struct tcs3472_data *data)
    {
    let mut atime_us: c_uint = TCS3472_ATIME_TO_US(data.atime);
    let mut init_us: c_uint = 2400;
    unsigned int wtime_us;
    if (!(data.enable & TCS3472_ENABLE_WEN))
    wtime_us = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: data->wlong) -> else {
    else if (data.wlong)
...
//
#[no_mangle]
unsafe extern "C" fn tcs3472_cycle_to_freq(cycle_us: c_uint, val: *mut c_int, val2: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn tcs3472_req_data(data: *mut tcs3472_data) -> c_int {
...
//
    ...
    if (wait_us < 2400) {
    if (data.enable & TCS3472_ENABLE_WEN) {
    let mut enable: u8 = data.enable & ~TCS3472_ENABLE_WEN;
...
#[no_mangle]
unsafe extern "C" fn tcs3472_event_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tcs3472_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
// Ensure timestamp is naturally aligned
    ...
    let mut ret: c_int = tcs3472_req_data(data);
    if (ret < 0)
    goto done;
...
#[no_mangle]
unsafe extern "C" fn tcs3472_powerdown(data: *mut tcs3472_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcs3472_powerdown_action(data: *mut c_void) {
    static void tcs3472_powerdown_action(void *data)
    {
    tcs3472_powerdown(data);
    }
#[no_mangle]
unsafe extern "C" fn tcs3472_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x4d: ret ==) -> else {
    else if (ret == 0x4d)
...
//
    ...
    tcs3472_trigger_handler, core::ptr::null_mut());
    if (ret < 0)
    return ret;
    if (client.irq) {
...
#[no_mangle]
unsafe extern "C" fn tcs3472_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcs3472_resume(dev: *mut device) -> c_int {
