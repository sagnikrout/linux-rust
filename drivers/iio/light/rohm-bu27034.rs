...
//! Source: drivers/iio/light/rohm-bu27034.c
#![no_std]
...
pub const BU27034_REG_SYSTEM_CONTROL: c_uint = 0x40;

pub const BU27034_ID: c_uint = 0x19;
pub const BU27034_REG_MODE_CONTROL1: c_uint = 0x41;

pub const BU27034_REG_MODE_CONTROL2: c_uint = 0x42;

pub const BU27034_REG_MODE_CONTROL3: c_uint = 0x43;
pub const BU27034_REG_MODE_CONTROL4: c_uint = 0x44;

pub const BU27034_NUM_HW_DATA_CHANS: c_int = 2;
pub const BU27034_REG_DATA0_LO: c_uint = 0x50;
pub const BU27034_REG_DATA1_LO: c_uint = 0x52;
pub const BU27034_REG_DATA1_HI: c_uint = 0x53;
pub const BU27034_REG_MANUFACTURER_ID: c_uint = 0x92;
...
//
pub const BU27034_MEAS_WAIT_PREMATURE_MS: c_int = 5;
pub const BU27034_DATA_WAIT_TIME_US: c_int = 1000;

pub const BU27034_RETRY_LIMIT: c_int = 18;
    enum {
    BU27034_CHAN_ALS,
    BU27034_CHAN_DATA0,
    BU27034_CHAN_DATA1,
...
//
pub const BU27034_SCALE_1X: c_int = 16;
// See the data sheet for the "Gain Setting" table
pub const BU27034_GSEL_1X: c_uint = 0x00 /* 00000 */;
pub const BU27034_GSEL_4X: c_uint = 0x08 /* 01000 */;
pub const BU27034_GSEL_32X: c_uint = 0x0b /* 01011 */;
pub const BU27034_GSEL_256X: c_uint = 0x18 /* 11000 */;
pub const BU27034_GSEL_512X: c_uint = 0x19 /* 11001 */;
pub const BU27034_GSEL_1024X: c_uint = 0x1a /* 11010 */;
...
//
pub const BU27034_MEAS_MODE_100MS: c_int = 0;
pub const BU27034_MEAS_MODE_55MS: c_int = 1;
pub const BU27034_MEAS_MODE_200MS: c_int = 2;
pub const BU27034_MEAS_MODE_400MS: c_int = 4;
...
//
    ...
    pub raw: [__le16; BU27034_NUM_HW_DATA_CHANS],
    struct {
    pub mlux: u32,
    pub channels: [__le16; BU27034_NUM_HW_DATA_CHANS],
    pub ts: aligned_s64,
    pub scan: },
}
...
#[no_mangle]
unsafe extern "C" fn bu27034_get_gain_sel(data: *mut bu27034_data, chan: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bu27034_get_gain(data: *mut bu27034_data, chan: c_int, gain: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bu27034_get_int_time(data: *mut bu27034_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bu27034_write_gain_sel(data: *mut bu27034_data, chan: c_int, sel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bu27034_set_gain(data: *mut bu27034_data, chan: c_int, gain: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bu27034_set_int_time(data: *mut bu27034_data, time: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bu27034_try_set_int_time(data: *mut bu27034_data, time_us: c_int) -> c_int {
    ...
    let mut numg: c_int = ARRAY_SIZE(gains);
...
#[no_mangle]
pub unsafe extern "C" fn if(BU27034_CHAN_DATA1: chan ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn bu27034_has_valid_sample(data: *mut bu27034_data) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn bu27034_invalidate_read_data(data: *mut bu27034_data) {
    static void bu27034_invalidate_read_data(struct bu27034_data *data)
    {
    bu27034_has_valid_sample(data);
    }
#[no_mangle]
unsafe extern "C" fn bu27034_read_result(data: *mut bu27034_data, chan: c_int, res: *mut c_int) -> c_int {
...
// res = le16_to_cpu(val);
    ...
    int size)
    {
    let mut ret: c_int = 0, retry_cnt = 0;
    retry:
...
#[no_mangle]
unsafe extern "C" fn bu27034_meas_set(data: *mut bu27034_data, en: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bu27034_calc_mlux(data: *mut bu27034_data, res: *mut __le16, val: *mut c_int) -> c_int {
...
// val = 0;
    ...
    let mut div: c_uint = (unsigned int)ch0 * gain1;
    do_div(helper64, div);
...
#[no_mangle]
unsafe extern "C" fn bu27034_get_mlux(data: *mut bu27034_data, chan: c_int, val: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IIO_LIGHT: chan->type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn bu27034_chip_init(data: *mut bu27034_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bu27034_wait_for_data(data: *mut bu27034_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bu27034_buffer_thread(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bu27034_buffer_enable(idev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bu27034_buffer_disable(idev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bu27034_probe(i2c: *mut i2c_client) -> c_int {
