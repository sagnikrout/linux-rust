...
//! Source: drivers/iio/light/opt4060.c
#![no_std]
...
pub const OPT4060_RED_MSB: c_uint = 0x00;
pub const OPT4060_RED_LSB: c_uint = 0x01;
pub const OPT4060_GREEN_MSB: c_uint = 0x02;
pub const OPT4060_GREEN_LSB: c_uint = 0x03;
pub const OPT4060_BLUE_MSB: c_uint = 0x04;
pub const OPT4060_BLUE_LSB: c_uint = 0x05;
pub const OPT4060_CLEAR_MSB: c_uint = 0x06;
pub const OPT4060_CLEAR_LSB: c_uint = 0x07;
pub const OPT4060_THRESHOLD_LOW: c_uint = 0x08;
pub const OPT4060_THRESHOLD_HIGH: c_uint = 0x09;
pub const OPT4060_CTRL: c_uint = 0x0a;
pub const OPT4060_INT_CTRL: c_uint = 0x0b;
pub const OPT4060_RES_CTRL: c_uint = 0x0c;
pub const OPT4060_DEVICE_ID: c_uint = 0x11;
...
pub const OPT4060_INT_CTRL_THRESHOLD: c_uint = 0x0;
pub const OPT4060_INT_CTRL_NEXT_CH: c_uint = 0x1;
pub const OPT4060_INT_CTRL_ALL_CH: c_uint = 0x3;
// OPT4060 result control register masks

// OPT4060 constants
pub const OPT4060_DEVICE_ID_VAL: c_uint = 0x821;
// OPT4060 operating modes
pub const OPT4060_CTRL_OPER_MODE_OFF: c_uint = 0x0;
pub const OPT4060_CTRL_OPER_MODE_FORCED: c_uint = 0x1;
pub const OPT4060_CTRL_OPER_MODE_ONE_SHOT: c_uint = 0x2;
pub const OPT4060_CTRL_OPER_MODE_CONTINUOUS: c_uint = 0x3;
// OPT4060 conversion control register definitions
pub const OPT4060_CTRL_CONVERSION_0_6MS: c_uint = 0x0;
pub const OPT4060_CTRL_CONVERSION_1MS: c_uint = 0x1;
pub const OPT4060_CTRL_CONVERSION_1_8MS: c_uint = 0x2;
pub const OPT4060_CTRL_CONVERSION_3_4MS: c_uint = 0x3;
pub const OPT4060_CTRL_CONVERSION_6_5MS: c_uint = 0x4;
pub const OPT4060_CTRL_CONVERSION_12_7MS: c_uint = 0x5;
pub const OPT4060_CTRL_CONVERSION_25MS: c_uint = 0x6;
pub const OPT4060_CTRL_CONVERSION_50MS: c_uint = 0x7;
pub const OPT4060_CTRL_CONVERSION_100MS: c_uint = 0x8;
pub const OPT4060_CTRL_CONVERSION_200MS: c_uint = 0x9;
pub const OPT4060_CTRL_CONVERSION_400MS: c_uint = 0xa;
pub const OPT4060_CTRL_CONVERSION_800MS: c_uint = 0xb;
// OPT4060 fault count control register definitions
pub const OPT4060_CTRL_FAULT_COUNT_1: c_uint = 0x0;
pub const OPT4060_CTRL_FAULT_COUNT_2: c_uint = 0x1;
pub const OPT4060_CTRL_FAULT_COUNT_4: c_uint = 0x2;
pub const OPT4060_CTRL_FAULT_COUNT_8: c_uint = 0x3;
// OPT4060 scale light level range definitions
pub const OPT4060_CTRL_LIGHT_SCALE_AUTO: c_int = 12;
...
//
    pub irq_setting_lock: mutex,
//
// Mutex for protecting event enabling.
//
    pub event_enabling_lock: mutex,
    pub completion: completion,
    pub thresh_event_lo_active: bool,
    pub thresh_event_hi_active: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct opt4060_channel_factor {
    pub mul: u32,
    pub div: u32,
}
...
#[no_mangle]
unsafe extern "C" fn opt4060_als_time_to_index(als_integration_time: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4060_calculate_crc(exp: u8, mantissa: u32, count: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn opt4060_set_int_state(chip: *mut opt4060_chip, state: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4060_event_active(chip: *mut opt4060_chip) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn opt4060_trigger_set_state(trig: *mut iio_trigger, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4060_trigger_new_samples(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4060_calc_illuminance(chip: *mut opt4060_chip, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4060_set_int_time(chip: *mut opt4060_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4060_power_down(chip: *mut opt4060_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4060_chip_off_action(chip: *mut c_void) {
    ...
    _OPT4060_COLOR_CHANNEL(_color, _mask, core::ptr::null_mut(), 0)				\
...
#[no_mangle]
unsafe extern "C" fn opt4060_calc_th_reg(adc_val: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(20: bits >) -> else {
    else if (bits > 20)
    th_exp = bits - 20;
    else
    th_exp = 0;
...
#[no_mangle]
unsafe extern "C" fn opt4060_calc_val_from_th_reg(th_reg: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(2: *mut *mut uval <= int_time) -> else {
    else if (uval <= int_time * 2)
    fault_count_val = OPT4060_CTRL_FAULT_COUNT_2;
#[no_mangle]
pub unsafe extern "C" fn if(4: *mut *mut uval <= int_time) -> else {
...
#[no_mangle]
unsafe extern "C" fn opt4060_get_channel_sel(chip: *mut opt4060_chip, ch_sel: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4060_set_channel_sel(chip: *mut opt4060_chip, ch_sel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4060_get_thresholds(chip: *mut opt4060_chip, th_lo: *mut u32, th_hi: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4060_set_thresholds(chip: *mut opt4060_chip, th_lo: u32, th_hi: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4060_load_defaults(chip: *mut opt4060_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opt4060_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
    static bool opt4060_volatile_reg(struct device *dev, unsigned int reg)
    {
    return reg <= OPT4060_CLEAR_LSB || reg == OPT4060_RES_CTRL;
    }
#[no_mangle]
unsafe extern "C" fn opt4060_writable_reg(dev: *mut device, reg: c_uint) -> bool {
    static bool opt4060_writable_reg(struct device *dev, unsigned int reg)
    {
    return reg >= OPT4060_THRESHOLD_LOW || reg >= OPT4060_INT_CTRL;
    }
#[no_mangle]
unsafe extern "C" fn opt4060_readonly_reg(dev: *mut device, reg: c_uint) -> bool {
    static bool opt4060_readonly_reg(struct device *dev, unsigned int reg)
    {
    let mut reg: return = = OPT4060_DEVICE_ID;
    }
#[no_mangle]
unsafe extern "C" fn opt4060_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn opt4060_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn opt4060_irq_thread(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn opt4060_setup_buffer(chip: *mut opt4060_chip, idev: *mut iio_dev) -> c_int {
    ...
    opt4060_trigger_handler, core::ptr::null_mut());
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn opt4060_setup_trigger(chip: *mut opt4060_chip, idev: *mut iio_dev) -> c_int {
...
//
    ...
    if (!name)
    return -ENOMEM;
    ret = devm_request_threaded_irq(chip.dev, chip.irq, core::ptr::null_mut(), opt4060_irq_thread,
...
#[no_mangle]
unsafe extern "C" fn opt4060_probe(client: *mut i2c_client) -> c_int {
