...
//! Source: drivers/iio/light/hid-sensor-als.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct als_state {
    pub callbacks: hid_sensor_hub_callbacks,
    pub common_attributes: hid_sensor_common,
    pub als: [hid_sensor_hub_attribute_info; CHANNEL_SCAN_INDEX_MAX],
    pub 1]: iio_chan_spec channels[CHANNEL_SCAN_INDEX_MAX +,
    struct {
    pub illum: [u32; CHANNEL_SCAN_INDEX_MAX],
    pub timestamp: aligned_s64,
    pub scan: },
    pub scale_pre_decml: [c_int; CHANNEL_SCAN_INDEX_MAX],
    pub scale_post_decml: [c_int; CHANNEL_SCAN_INDEX_MAX],
    pub scale_precision: [c_int; CHANNEL_SCAN_INDEX_MAX],
    pub value_offset: c_int,
    pub num_channels: c_int,
    pub timestamp: i64,
    pub als_scan_mask: [c_ulong; 2],
}
...
// Capture samples in local storage
    ...
    let mut sample_data: u32 = *(u32 *)raw_data;
    switch (usage_id) {
...
#[no_mangle]
unsafe extern "C" fn hid_als_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_als_remove(pdev: *mut platform_device) {
