...
//! Source: drivers/iio/light/bh1780.c
#![no_std]
...
pub const BH1780_REG_CONTROL: c_uint = 0x00;
pub const BH1780_REG_PARTID: c_uint = 0x0A;
pub const BH1780_REG_MANFID: c_uint = 0x0B;
pub const BH1780_REG_DLOW: c_uint = 0x0C;
pub const BH1780_REG_DHIGH: c_uint = 0x0D;

// power on settling time in ms
pub const BH1780_PON_DELAY: c_int = 2;
// max time before value available in ms
pub const BH1780_INTERVAL: c_int = 250;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bh1780_data {
    pub client: *mut i2c_client,
}

#[no_mangle]
unsafe extern "C" fn bh1780_write(bh1780: *mut bh1780_data, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bh1780_read(bh1780: *mut bh1780_data, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bh1780_read_word(bh1780: *mut bh1780_data, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bh1780_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bh1780_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn bh1780_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bh1780_runtime_resume(dev: *mut device) -> c_int {
...
// Wait for power on, then for a value to be available
    ...
    bh1780_runtime_resume, core::ptr::null_mut());
