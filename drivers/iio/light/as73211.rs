...
//! Source: drivers/iio/light/as73211.c
#![no_std]
...
pub const AS73211_REG_OSR: c_uint = 0x0;
pub const AS73211_REG_AGEN: c_uint = 0x2;
pub const AS73211_REG_CREG1: c_uint = 0x6;
pub const AS73211_REG_CREG2: c_uint = 0x7;
pub const AS73211_REG_CREG3: c_uint = 0x8;
// AS73211 output register bank
pub const AS73211_OUT_OSR_STATUS: c_int = 0;
pub const AS73211_OUT_TEMP: c_int = 1;
pub const AS73211_OUT_MRES1: c_int = 2;
pub const AS73211_OUT_MRES2: c_int = 3;
pub const AS73211_OUT_MRES3: c_int = 4;

pub const AS73211_CREG1_GAIN_1: c_int = 11;

pub const AS73211_SAMPLE_FREQ_BASE: c_int = 1024000;
pub const AS73211_SAMPLE_TIME_NUM: c_int = 15;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct as73211_spec_dev_data {
    pub val2): *mut *mut *mut *mut int (intensity_scale)(struct as73211_data data, int chan, int val, int,
...
pub struct as73211_data {
    ...
    pub 2]: *mut *mut int int_time_avail[AS73211_SAMPLE_TIME_NUM,
    pub spec_dev: *const as73211_spec_dev_data,
}
...
pub const AS73211_OFFSET_TEMP_MICRO: c_int = 900000;
pub const AS73211_SCALE_TEMP_INT: c_int = 0;
pub const AS73211_SCALE_TEMP_MICRO: c_int = 50000;

// Channel order MUST match devices result register order
pub const AS73211_SCAN_INDEX_TEMP: c_int = 0;
pub const AS73211_SCAN_INDEX_X: c_int = 1;
pub const AS73211_SCAN_INDEX_Y: c_int = 2;
pub const AS73211_SCAN_INDEX_Z: c_int = 3;
pub const AS73211_SCAN_INDEX_TS: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn as73211_integration_time_1024cyc(data: *mut as73211_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn as73211_req_data(data: *mut as73211_data) -> c_int {
...
// gain can be calculated from CREG1 as 2^(11 - CREG1_GAIN)
    ...
    case IIO_CHAN_INFO_INT_TIME: {
    let mut val_us: c_int = val * USEC_PER_SEC + val2;
    int time_ms;
    int reg_bits;
// f_samp is configured in CREG3 in powers of 2 (x 1.024 MHz)
    let mut f_samp_1_024mhz: c_int = BIT(FIELD_GET(AS73211_CREG3_CCLK_MASK, data.creg3));
//
...
#[no_mangle]
unsafe extern "C" fn as73211_ready_handler(__always_unused: int irq, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn as73211_trigger_handler(__always_unused: int irq, p: *mut c_void) -> irqreturn_t {
...
// Optimization for reading all (color + temperature) channels
    let mut addr: u8 = as73211_channels[0].address;
    struct i2c_msg msgs[] = {
    {
...
#[no_mangle]
unsafe extern "C" fn as73211_power(indio_dev: *mut iio_dev, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as73211_power_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn as73211_probe(client: *mut i2c_client) -> c_int {
...
// At the time of writing this driver, only DEVID 2 and MUT 1 are known.
    ...
    if (ret)
    return ret;
    ret = devm_iio_triggered_buffer_setup(dev, indio_dev, core::ptr::null_mut(), as73211_trigger_handler, core::ptr::null_mut());
    if (ret)
    return ret;
    if (client.irq) {
...
#[no_mangle]
unsafe extern "C" fn as73211_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as73211_resume(dev: *mut device) -> c_int {
