...
//! Source: drivers/iio/light/tsl2772.c
#![no_std]
...
// Cal defs
pub const PROX_STAT_CAL: c_int = 0;
pub const PROX_STAT_SAMP: c_int = 1;
pub const MAX_SAMPLES_CAL: c_int = 200;
// TSL2772 Device ID
pub const TRITON_ID: c_uint = 0x00;
pub const SWORDFISH_ID: c_uint = 0x30;
pub const HALIBUT_ID: c_uint = 0x20;
// Lux calculation constants
pub const TSL2772_LUX_CALC_OVER_FLOW: c_int = 65535;
//
// TAOS Register definitions - Note: depending on device, some of these register
// are not used and the register address is benign.
//
// Register offsets
pub const TSL2772_MAX_CONFIG_REG: c_int = 16;
// Device Registers and Masks
pub const TSL2772_CNTRL: c_uint = 0x00;

pub const TSL2772_PRX_TIME: c_uint = 0x02;
pub const TSL2772_WAIT_TIME: c_uint = 0x03;

pub const TSL2772_PERSISTENCE: c_uint = 0x0C;
pub const TSL2772_ALS_PRX_CONFIG: c_uint = 0x0D;
pub const TSL2772_PRX_COUNT: c_uint = 0x0E;
pub const TSL2772_GAIN: c_uint = 0x0F;
pub const TSL2772_NOTUSED: c_uint = 0x10;
pub const TSL2772_REVID: c_uint = 0x11;
pub const TSL2772_CHIPID: c_uint = 0x12;
pub const TSL2772_STATUS: c_uint = 0x13;
pub const TSL2772_ALS_CHAN0LO: c_uint = 0x14;
pub const TSL2772_ALS_CHAN0HI: c_uint = 0x15;
pub const TSL2772_ALS_CHAN1LO: c_uint = 0x16;
pub const TSL2772_ALS_CHAN1HI: c_uint = 0x17;
pub const TSL2772_PRX_LO: c_uint = 0x18;
pub const TSL2772_PRX_HI: c_uint = 0x19;
// tsl2772 cmd reg masks
pub const TSL2772_CMD_REG: c_uint = 0x80;
pub const TSL2772_CMD_SPL_FN: c_uint = 0x60;
pub const TSL2772_CMD_REPEAT_PROTO: c_uint = 0x00;
pub const TSL2772_CMD_AUTOINC_PROTO: c_uint = 0x20;

pub const TSL2772_CMD_ALS_INT_CLR: c_uint = 0x06;

// tsl2772 cntrl reg masks
pub const TSL2772_CNTL_ADC_ENBL: c_uint = 0x02;
pub const TSL2772_CNTL_PWR_ON: c_uint = 0x01;
// tsl2772 status reg masks
pub const TSL2772_STA_ADC_VALID: c_uint = 0x01;
pub const TSL2772_STA_PRX_VALID: c_uint = 0x02;

    TSL2772_STA_PRX_VALID)
pub const TSL2772_STA_ALS_INTR: c_uint = 0x10;
pub const TSL2772_STA_PRX_INTR: c_uint = 0x20;
// tsl2772 cntrl reg masks
pub const TSL2772_CNTL_REG_CLEAR: c_uint = 0x00;

pub const TSL2772_CNTL_PWRON: c_uint = 0x01;
pub const TSL2772_CNTL_ALSPON_ENBL: c_uint = 0x03;
pub const TSL2772_CNTL_INTALSPON_ENBL: c_uint = 0x13;
pub const TSL2772_CNTL_PROXPON_ENBL: c_uint = 0x0F;
pub const TSL2772_CNTL_INTPROXPON_ENBL: c_uint = 0x2F;
pub const TSL2772_ALS_GAIN_TRIM_MIN: c_int = 250;
pub const TSL2772_ALS_GAIN_TRIM_MAX: c_int = 4000;
pub const TSL2772_MAX_PROX_LEDS: c_int = 2;
pub const TSL2772_BOOT_MIN_SLEEP_TIME: c_int = 10000;
pub const TSL2772_BOOT_MAX_SLEEP_TIME: c_int = 28000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tsl2772_chip_info {
    pub chan_table_elements: c_int,
    pub channel_with_events: [iio_chan_spec; 4],
    pub channel_without_events: [iio_chan_spec; 4],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tsl2772_chip {
    pub id: kernel_ulong_t,
    pub prox_mutex: mutex,
    pub als_mutex: mutex,
    pub client: *mut i2c_client,
    pub supplies: [regulator_bulk_data; TSL2772_NUM_SUPPLIES],
    pub prox_data: u16,
    pub als_cur_info: tsl2772_als_info,
    pub settings: tsl2772_settings,
    pub pdata: *mut tsl2772_platform_data,
    pub als_gain_time_scale: c_int,
    pub als_saturation: c_int,
    pub tsl2772_chip_status: c_int,
    pub tsl2772_config: [u8; TSL2772_MAX_CONFIG_REG],
    pub chip_info: *const tsl2772_chip_info,
    pub info: *const iio_info,
...
//
    pub tsl2772_device_lux: [tsl2772_lux; TSL2772_MAX_LUX_TABLE_SIZE],
}
...
#[no_mangle]
unsafe extern "C" fn tsl2772_read_status(chip: *mut tsl2772_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsl2772_write_control_reg(chip: *mut tsl2772_chip, data: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tsl2772_get_lux(indio_dev: *mut iio_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tsl2772_get_prox(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsl2772_read_prox_led_current(chip: *mut tsl2772_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsl2772_read_prox_diodes(chip: *mut tsl2772_chip) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: leds[i] ==) -> else {
    else if (leds[i] == 1)
...
#[no_mangle]
unsafe extern "C" fn tsl2772_parse_dt(chip: *mut tsl2772_chip) {
...
//
#[no_mangle]
unsafe extern "C" fn tsl2772_defaults(chip: *mut tsl2772_chip) {
...
//
#[no_mangle]
unsafe extern "C" fn tsl2772_als_calibrate(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsl2772_disable_regulators_action(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tsl2772_chip_on(indio_dev: *mut iio_dev) -> c_int {
...
//
    ...
    let mut reg: c_int = TSL2772_CMD_REG + i;
...
#[no_mangle]
unsafe extern "C" fn tsl2772_chip_off(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsl2772_chip_off_action(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn tsl2772_invoke_change(indio_dev: *mut iio_dev) -> c_int {
    static int tsl2772_invoke_change(struct iio_dev *indio_dev)
    {
    struct tsl2772_chip *chip = iio_priv(indio_dev);
    let mut device_status: c_int = chip.tsl2772_chip_status;
    int ret;
    mutex_lock(&chip.als_mutex);
    mutex_lock(&chip.prox_mutex);
...
#[no_mangle]
unsafe extern "C" fn tsl2772_prox_cal(indio_dev: *mut iio_dev) -> c_int {
...
// Zero out the table
    ...
    {
    struct tsl2772_chip *chip = iio_priv(indio_dev);
    let mut ret: c_int = -EINVAL, count, persistence;
    u8 time;
    switch (info) {
...
#[no_mangle]
unsafe extern "C" fn tsl2772_device_id_verif(id: c_int, target: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsl2772_event_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tsl2772_probe(clientp: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsl2772_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsl2772_resume(dev: *mut device) -> c_int {
