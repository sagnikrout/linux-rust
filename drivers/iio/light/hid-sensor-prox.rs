...
//! Source: drivers/iio/light/hid-sensor-prox.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct prox_state {
    pub callbacks: hid_sensor_hub_callbacks,
    pub common_attributes: hid_sensor_common,
    pub prox_attr: [hid_sensor_hub_attribute_info; MAX_CHANNELS],
    pub channels: [iio_chan_spec; MAX_CHANNELS],
    pub channel2usage: [u32; MAX_CHANNELS],
    pub human_presence: [u32; MAX_CHANNELS],
    pub scale_pre_decml: [c_int; MAX_CHANNELS],
    pub scale_post_decml: [c_int; MAX_CHANNELS],
    pub scale_precision: [c_int; MAX_CHANNELS],
    pub /: *mut *mut unsigned long scan_mask[2]; / One entry plus one terminator.,
...
// Parse report which is specific to an usage id
    ...
    let mut usage_id: u32 = prox_usage_ids[i];
...
#[no_mangle]
unsafe extern "C" fn hid_prox_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_prox_remove(pdev: *mut platform_device) {
