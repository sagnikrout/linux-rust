...
//! Source: drivers/iio/light/cm3232.c
#![no_std]
...
// Registers Address
pub const CM3232_REG_ADDR_CMD: c_uint = 0x00;
pub const CM3232_REG_ADDR_ALS: c_uint = 0x50;
pub const CM3232_REG_ADDR_ID: c_uint = 0x53;

pub const CM3232_CMD_ALS_IT_SHIFT: c_int = 2;

pub const CM3232_HW_ID: c_uint = 0x32;
pub const CM3232_CALIBSCALE_DEFAULT: c_int = 100000;
pub const CM3232_CALIBSCALE_RESOLUTION: c_int = 100000;
pub const CM3232_MLUX_PER_LUX: c_int = 1000;
pub const CM3232_MLUX_PER_BIT_DEFAULT: c_int = 64;
pub const CM3232_MLUX_PER_BIT_BASE_IT: c_int = 100000;
    static const struct {
    int val;
    int val2;
    u8 it;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cm3232_als_info {
    pub regs_cmd_default: u8,
    pub hw_id: u8,
    pub mlux_per_bit: c_int,
    pub mlux_per_bit_base_it: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cm3232_chip {
    pub client: *mut i2c_client,
    pub als_info: *const cm3232_als_info,
...
//
#[no_mangle]
unsafe extern "C" fn cm3232_reg_init(chip: *mut cm3232_chip) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cm3232_read_als_it(chip: *mut cm3232_chip, val: *mut c_int, val2: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cm3232_write_als_it(chip: *mut cm3232_chip, val: c_int, val2: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cm3232_get_lux(chip: *mut cm3232_chip) -> c_int {
...
//
    ...
    S_IRUGO, cm3232_get_it_available, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn cm3232_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm3232_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn cm3232_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm3232_resume(dev: *mut device) -> c_int {
