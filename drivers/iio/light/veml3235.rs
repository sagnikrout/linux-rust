...
//! Source: drivers/iio/light/veml3235.c
#![no_std]
...
pub const VEML3235_REG_CONF: c_uint = 0x00;
pub const VEML3235_REG_WH_DATA: c_uint = 0x04;
pub const VEML3235_REG_ALS_DATA: c_uint = 0x05;
pub const VEML3235_REG_ID: c_uint = 0x09;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct veml3235_rf {
    pub it: *mut regmap_field,
    pub gain: *mut regmap_field,
    pub id: *mut regmap_field,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct veml3235_data {
...
//
pub const VEML3235_SEL_GAIN_X1: c_int = 0;
pub const VEML3235_SEL_GAIN_X2: c_int = 1;
pub const VEML3235_SEL_GAIN_X4: c_int = 3;
pub const VEML3235_SEL_GAIN_X8: c_int = 7;
...
#[no_mangle]
unsafe extern "C" fn veml3235_power_on(data: *mut veml3235_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml3235_shut_down(data: *mut veml3235_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml3235_shut_down_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn veml3235_get_it(data: *mut veml3235_data, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml3235_set_it(indio_dev: *mut iio_dev, val: c_int, val2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml3235_set_scale(indio_dev: *mut iio_dev, val: c_int, val2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml3235_get_scale(data: *mut veml3235_data, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml3235_read_id(data: *mut veml3235_data) {
...
#[no_mangle]
unsafe extern "C" fn veml3235_regfield_init(data: *mut veml3235_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml3235_hw_init(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml3235_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml3235_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml3235_runtime_resume(dev: *mut device) -> c_int {
    ...
    veml3235_runtime_resume, core::ptr::null_mut());
