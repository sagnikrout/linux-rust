...
//! Source: drivers/iio/light/isl29018.c
#![no_std]
...
pub const ISL29018_CONV_TIME_MS: c_int = 100;
pub const ISL29018_REG_ADD_COMMAND1: c_uint = 0x00;
pub const ISL29018_CMD1_OPMODE_SHIFT: c_int = 5;

pub const ISL29018_CMD1_OPMODE_POWER_DOWN: c_int = 0;
pub const ISL29018_CMD1_OPMODE_ALS_ONCE: c_int = 1;
pub const ISL29018_CMD1_OPMODE_IR_ONCE: c_int = 2;
pub const ISL29018_CMD1_OPMODE_PROX_ONCE: c_int = 3;
pub const ISL29018_REG_ADD_COMMAND2: c_uint = 0x01;
pub const ISL29018_CMD2_RESOLUTION_SHIFT: c_int = 2;

pub const ISL29018_CMD2_RANGE_SHIFT: c_int = 0;

pub const ISL29018_CMD2_SCHEME_SHIFT: c_int = 7;

pub const ISL29018_REG_ADD_DATA_LSB: c_uint = 0x02;
pub const ISL29018_REG_ADD_DATA_MSB: c_uint = 0x03;
pub const ISL29018_REG_TEST: c_uint = 0x08;
pub const ISL29018_TEST_SHIFT: c_int = 0;

pub const ISL29035_REG_DEVICE_ID: c_uint = 0x0F;
pub const ISL29035_DEVICE_ID_SHIFT: c_uint = 0x03;

pub const ISL29035_DEVICE_ID: c_uint = 0x5;
pub const ISL29035_BOUT_SHIFT: c_uint = 0x07;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct isl29018_chip {
    pub regmap: *mut regmap,
    pub lock: mutex,
    pub type: c_int,
    pub calibscale: c_uint,
    pub ucalibscale: c_uint,
    pub int_time: c_uint,
    pub scale: isl29018_scale,
    pub prox_scheme: c_int,
    pub suspended: bool,
...
#[no_mangle]
unsafe extern "C" fn isl29018_set_scale(chip: *mut isl29018_chip, scale: c_int, uscale: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl29018_read_sensor_input(chip: *mut isl29018_chip, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl29018_read_lux(chip: *mut isl29018_chip, lux: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl29018_read_ir(chip: *mut isl29018_chip, ir: *mut c_int) -> c_int {
...
// ir = ir_data;
    ...
    {
    int status;
    let mut prox_data: c_int = -1;
    let mut ir_data: c_int = -1;
    struct device *dev = regmap_get_device(chip.regmap);
...
#[no_mangle]
unsafe extern "C" fn isl29018_chip_init(chip: *mut isl29018_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl29018_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct isl29018_chip_info {
    pub channels: *const iio_chan_spec,
    pub num_channels: c_int,
    pub indio_info: *const iio_info,
...
#[no_mangle]
unsafe extern "C" fn isl29018_disable_regulator_action(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn isl29018_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl29018_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl29018_resume(dev: *mut device) -> c_int {
