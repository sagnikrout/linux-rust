...
//! Source: drivers/iio/light/veml3328.c
#![no_std]
...
pub const VEML3328_REG_CONF: c_uint = 0x00;
pub const VEML3328_REG_ID: c_uint = 0x0c;
pub const VEML3328_REG_DATA_C: c_uint = 0x04;
pub const VEML3328_REG_DATA_R: c_uint = 0x05;
pub const VEML3328_REG_DATA_G: c_uint = 0x06;
pub const VEML3328_REG_DATA_B: c_uint = 0x07;
pub const VEML3328_REG_DATA_IR: c_uint = 0x08;

pub const VEML3328_ID_VAL: c_uint = 0x28;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct veml3328_data {
...
#[no_mangle]
unsafe extern "C" fn veml3328_power_down(data: *mut veml3328_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml3328_power_up(data: *mut veml3328_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml3328_power_down_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn veml3328_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml3328_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml3328_runtime_resume(dev: *mut device) -> c_int {
