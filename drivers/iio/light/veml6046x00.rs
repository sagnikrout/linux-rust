...
//! Source: drivers/iio/light/veml6046x00.c
#![no_std]
...
//
pub const VEML6046X00_REG_CONF0: c_uint = 0x00;
pub const VEML6046X00_REG_CONF1: c_uint = 0x01;
pub const VEML6046X00_REG_THDH: c_uint = 0x04;
pub const VEML6046X00_REG_THDL: c_uint = 0x06;
pub const VEML6046X00_REG_R: c_uint = 0x10;
pub const VEML6046X00_REG_G: c_uint = 0x12;
pub const VEML6046X00_REG_B: c_uint = 0x14;
pub const VEML6046X00_REG_IR: c_uint = 0x16;
pub const VEML6046X00_REG_ID: c_uint = 0x18;
pub const VEML6046X00_REG_INT: c_uint = 0x1A;
pub const VEML6046X00_REG_INT_H: c_uint = 0x1B;
// Bit masks for specific functionality

    (VEML6046X00_INT_TH_H | VEML6046X00_INT_TH_L | VEML6046X00_INT_DRDY)
pub const VEML6046X00_GAIN_1: c_uint = 0x0;
pub const VEML6046X00_GAIN_2: c_uint = 0x1;
pub const VEML6046X00_GAIN_0_66: c_uint = 0x2;
pub const VEML6046X00_GAIN_0_5: c_uint = 0x3;
pub const VEML6046X00_PD_2_2: c_uint = 0x0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct veml6046x00_rf {
    pub int_en: *mut regmap_field,
    pub mode: *mut regmap_field,
    pub trig: *mut regmap_field,
    pub it: *mut regmap_field,
    pub pers: *mut regmap_field,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct veml6046x00_data {
    pub regmap: *mut regmap,
    pub trig: *mut iio_trigger,
    pub rf: veml6046x00_rf,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct veml6046x00_gain_pd {
    pub gain_sen: c_uint,
    pub pd: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn veml6046x00_power_on(data: *mut veml6046x00_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn veml6046x00_shutdown(data: *mut veml6046x00_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_shutdown_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_regfield_init(data: *mut veml6046x00_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_get_it_index(data: *mut veml6046x00_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_get_it_usec(data: *mut veml6046x00_data, it_usec: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_set_it(iio: *mut iio_dev, val: c_int, val2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_get_gain_idx(data: *mut veml6046x00_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_set_scale(iio: *mut iio_dev, val: c_int, val2: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn veml6046x00_read_data_ready(data: *mut veml6046x00_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn veml6046x00_wait_data_available(iio: *mut iio_dev, usecs: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_buffer_preenable(iio: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_buffer_postdisable(iio: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_trig_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_validate_part_id(data: *mut veml6046x00_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_setup_device(iio: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_probe(i2c: *mut i2c_client) -> c_int {
...
// bring device in a known state and switch device on
    ...
    ret = devm_iio_triggered_buffer_setup(dev, iio, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veml6046x00_runtime_resume(dev: *mut device) -> c_int {
    ...
    veml6046x00_runtime_resume, core::ptr::null_mut());
