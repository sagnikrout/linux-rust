...
//! Source: drivers/iio/light/si1133.c
#![no_std]
...
pub const SI1133_REG_PART_ID: c_uint = 0x00;
pub const SI1133_REG_REV_ID: c_uint = 0x01;
pub const SI1133_REG_MFR_ID: c_uint = 0x02;
pub const SI1133_REG_INFO0: c_uint = 0x03;
pub const SI1133_REG_INFO1: c_uint = 0x04;
pub const SI1133_PART_ID: c_uint = 0x33;
pub const SI1133_REG_HOSTIN0: c_uint = 0x0A;
pub const SI1133_REG_COMMAND: c_uint = 0x0B;
pub const SI1133_REG_IRQ_ENABLE: c_uint = 0x0F;
pub const SI1133_REG_RESPONSE1: c_uint = 0x10;
pub const SI1133_REG_RESPONSE0: c_uint = 0x11;
pub const SI1133_REG_IRQ_STATUS: c_uint = 0x12;
pub const SI1133_REG_MEAS_RATE: c_uint = 0x1A;
pub const SI1133_IRQ_CHANNEL_ENABLE: c_uint = 0xF;
pub const SI1133_CMD_RESET_CTR: c_uint = 0x00;
pub const SI1133_CMD_RESET_SW: c_uint = 0x01;
pub const SI1133_CMD_FORCE: c_uint = 0x11;
pub const SI1133_CMD_START_AUTONOMOUS: c_uint = 0x13;
pub const SI1133_CMD_PARAM_SET: c_uint = 0x80;
pub const SI1133_CMD_PARAM_QUERY: c_uint = 0x40;
pub const SI1133_CMD_PARAM_MASK: c_uint = 0x3F;

pub const SI1133_CMD_SEQ_MASK: c_uint = 0xF;
pub const SI1133_MAX_CMD_CTR: c_uint = 0xF;
pub const SI1133_PARAM_REG_CHAN_LIST: c_uint = 0x01;

pub const SI1133_ADCMUX_MASK: c_uint = 0x1F;

pub const SI1133_ADCSENS_SCALE_MASK: c_uint = 0x70;
pub const SI1133_ADCSENS_SCALE_SHIFT: c_int = 4;

pub const SI1133_ADCSENS_HSIG_SHIFT: c_int = 7;
pub const SI1133_ADCSENS_HW_GAIN_MASK: c_uint = 0xF;

pub const SI1133_PARAM_ADCMUX_SMALL_IR: c_uint = 0x0;
pub const SI1133_PARAM_ADCMUX_MED_IR: c_uint = 0x1;
pub const SI1133_PARAM_ADCMUX_LARGE_IR: c_uint = 0x2;
pub const SI1133_PARAM_ADCMUX_WHITE: c_uint = 0xB;
pub const SI1133_PARAM_ADCMUX_LARGE_WHITE: c_uint = 0xD;
pub const SI1133_PARAM_ADCMUX_UV: c_uint = 0x18;
pub const SI1133_PARAM_ADCMUX_UV_DEEP: c_uint = 0x19;
pub const SI1133_ERR_INVALID_CMD: c_uint = 0x0;
pub const SI1133_ERR_INVALID_LOCATION_CMD: c_uint = 0x1;
pub const SI1133_ERR_SATURATION_ADC_OR_OVERFLOW_ACCUMULATION: c_uint = 0x2;
pub const SI1133_ERR_OUTPUT_BUFFER_OVERFLOW: c_uint = 0x3;
pub const SI1133_COMPLETION_TIMEOUT_MS: c_int = 500;
pub const SI1133_CMD_MINSLEEP_US_LOW: c_int = 5000;
pub const SI1133_CMD_MINSLEEP_US_HIGH: c_int = 7500;
pub const SI1133_CMD_TIMEOUT_MS: c_int = 25;

pub const SI1133_X_ORDER_MASK: c_uint = 0x0070;
pub const SI1133_Y_ORDER_MASK: c_uint = 0x0007;

pub const SI1133_LUX_ADC_MASK: c_uint = 0xE;
pub const SI1133_ADC_THRESHOLD: c_int = 16000;
pub const SI1133_INPUT_FRACTION_HIGH: c_int = 7;
pub const SI1133_INPUT_FRACTION_LOW: c_int = 15;
pub const SI1133_LUX_OUTPUT_FRACTION: c_int = 12;
pub const SI1133_LUX_BUFFER_SIZE: c_int = 9;
pub const SI1133_MEASURE_BUFFER_SIZE: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct si1133_lux_coeff {
    pub coeff_high: [si1133_coeff; 4],
    pub coeff_low: [si1133_coeff; 9],
}
...
#[no_mangle]
unsafe extern "C" fn si1133_cmd_reset_sw(data: *mut si1133_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si1133_parse_response_err(dev: *mut device, resp: u32, cmd: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si1133_cmd_reset_counter(data: *mut si1133_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si1133_command(data: *mut si1133_data, cmd: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si1133_param_set(data: *mut si1133_data, param: u8, value: u32) -> c_int {
    static int si1133_param_set(struct si1133_data *data, u8 param, u32 value)
    {
    let mut err: c_int = regmap_write(data.regmap, SI1133_REG_HOSTIN0, value);
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn si1133_param_query(data: *mut si1133_data, param: u8, result: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si1133_get_int_time_index(milliseconds: c_int, nanoseconds: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si1133_set_chlist(data: *mut si1133_data, scan_mask: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si1133_set_adcmux(data: *mut si1133_data, adc: u8, mux: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si1133_force_measurement(data: *mut si1133_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si1133_threaded_irq_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn si1133_scale_to_swgain(scale_integer: c_int, scale_fractional: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si1133_get_lux(data: *mut si1133_data, val: *mut c_int) -> c_int {
...
// val = lux >> SI1133_LUX_OUTPUT_FRACTION;
    ...
    {
    struct si1133_data *data = iio_priv(iio_dev);
    let mut adc_sens: u8 = data.adc_sens[0];
    int err;
    switch (mask) {
...
//
#[no_mangle]
unsafe extern "C" fn si1133_init_lux_channels(data: *mut si1133_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si1133_initialize(data: *mut si1133_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si1133_validate_ids(iio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si1133_probe(client: *mut i2c_client) -> c_int {
