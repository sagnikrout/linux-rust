...
//! Source: drivers/iio/light/apds9300.c
#![no_std]
...
// Register set
pub const APDS9300_CONTROL: c_uint = 0x00 /* Control of basic functions */;
pub const APDS9300_THRESHLOWLOW: c_uint = 0x02 /* Low byte of low interrupt threshold */;
pub const APDS9300_THRESHHIGHLOW: c_uint = 0x04 /* Low byte of high interrupt threshold */;
pub const APDS9300_INTERRUPT: c_uint = 0x06 /* Interrupt control */;
pub const APDS9300_DATA0LOW: c_uint = 0x0c /* Low byte of ADC channel 0 */;
pub const APDS9300_DATA1LOW: c_uint = 0x0e /* Low byte of ADC channel 1 */;
// Power on/off value for APDS9300_CONTROL register
pub const APDS9300_POWER_ON: c_uint = 0x03;
pub const APDS9300_POWER_OFF: c_uint = 0x00;
// Interrupts
pub const APDS9300_INTR_ENABLE: c_uint = 0x10;
// Interrupt Persist Function: Any value outside of threshold range
pub const APDS9300_THRESH_INTR: c_uint = 0x01;
pub const APDS9300_THRESH_MAX: c_uint = 0xffff /* Max threshold value */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apds9300_data {
    pub client: *mut i2c_client,
    pub mutex: mutex,
    pub power_state: bool,
    pub thresh_low: c_int,
    pub thresh_hi: c_int,
    pub intr_en: bool,
}
...
#[no_mangle]
unsafe extern "C" fn apds9300_calculate_lux(ch0: u16, ch1: u16) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn apds9300_get_adc_val(data: *mut apds9300_data, adc_number: c_int) -> c_int {
    static int apds9300_get_adc_val(struct apds9300_data *data, int adc_number)
    {
    int ret;
    let mut flags: u8 = APDS9300_CMD | APDS9300_WORD;
    if (!data.power_state)
    return -EBUSY;
...
#[no_mangle]
unsafe extern "C" fn apds9300_set_thresh_low(data: *mut apds9300_data, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9300_set_thresh_hi(data: *mut apds9300_data, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9300_set_intr_state(data: *mut apds9300_data, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9300_set_power_state(data: *mut apds9300_data, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9300_clear_intr(data: *mut apds9300_data) {
...
#[no_mangle]
unsafe extern "C" fn apds9300_chip_init(data: *mut apds9300_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9300_interrupt_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn apds9300_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), apds9300_interrupt_handler,
...
#[no_mangle]
unsafe extern "C" fn apds9300_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn apds9300_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apds9300_resume(dev: *mut device) -> c_int {
