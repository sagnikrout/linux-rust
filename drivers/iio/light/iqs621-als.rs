...
//! Source: drivers/iio/light/iqs621-als.c
#![no_std]
...
pub const IQS621_ALS_UI_OUT: c_uint = 0x17;
pub const IQS621_ALS_THRESH_DARK: c_uint = 0x80;
pub const IQS621_ALS_THRESH_LIGHT: c_uint = 0x81;
pub const IQS622_IR_RANGE: c_uint = 0x15;
pub const IQS622_IR_FLAGS: c_uint = 0x16;

pub const IQS622_IR_UI_OUT: c_uint = 0x17;
pub const IQS622_IR_THRESH_PROX: c_uint = 0x91;
pub const IQS622_IR_THRESH_TOUCH: c_uint = 0x92;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs621_als_private {
...
#[no_mangle]
unsafe extern "C" fn iqs621_als_init(iqs621_als: *mut iqs621_als_private) -> c_int {
...
// IQS621 only
    ...
    timestamp);
#[no_mangle]
pub unsafe extern "C" fn if(light_old: iqs621_als->light_en && !light_new &&) -> else {
...
// IQS621 and IQS622
    ...
    timestamp);
#[no_mangle]
pub unsafe extern "C" fn if(range_old): iqs621_als->range_en && (range_new <) -> else {
...
// IQS622 only
    ...
    timestamp);
#[no_mangle]
pub unsafe extern "C" fn if(prox_old: iqs621_als->prox_en && !prox_new &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn iqs621_als_notifier_unregister(context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn iqs621_als_probe(pdev: *mut platform_device) -> c_int {
