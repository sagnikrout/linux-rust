...
//! Source: drivers/iio/light/stk3310.c
#![no_std]
...
pub const STK3310_REG_STATE: c_uint = 0x00;
pub const STK3310_REG_PSCTRL: c_uint = 0x01;
pub const STK3310_REG_ALSCTRL: c_uint = 0x02;
pub const STK3310_REG_INT: c_uint = 0x04;
pub const STK3310_REG_THDH_PS: c_uint = 0x06;
pub const STK3310_REG_THDL_PS: c_uint = 0x08;
pub const STK3310_REG_FLAG: c_uint = 0x10;
pub const STK3310_REG_PS_DATA_MSB: c_uint = 0x11;
pub const STK3310_REG_PS_DATA_LSB: c_uint = 0x12;
pub const STK3310_REG_ALS_DATA_MSB: c_uint = 0x13;
pub const STK3310_REG_ALS_DATA_LSB: c_uint = 0x14;
pub const STK3310_REG_ID: c_uint = 0x3E;
pub const STK3310_MAX_REG: c_uint = 0x80;

pub const STK3310_STATE_STANDBY: c_uint = 0x00;
pub const STK3013_CHIP_ID_VAL: c_uint = 0x31;
pub const STK3310_CHIP_ID_VAL: c_uint = 0x13;
pub const STK3311_CHIP_ID_VAL: c_uint = 0x1D;
pub const STK3311A_CHIP_ID_VAL: c_uint = 0x15;
pub const STK3311S34_CHIP_ID_VAL: c_uint = 0x1E;
pub const STK3311X_CHIP_ID_VAL: c_uint = 0x12;
pub const STK3335_CHIP_ID_VAL: c_uint = 0x51;
pub const STK3310_PSINT_EN: c_uint = 0x01;
pub const STK3310_PS_MAX_VAL: c_uint = 0xFFFF;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stk3310_data {
    pub client: *mut i2c_client,
    pub lock: mutex,
    pub timestamp: u64,
    pub regmap: *mut regmap,
    pub reg_state: *mut regmap_field,
    pub reg_als_gain: *mut regmap_field,
    pub reg_ps_gain: *mut regmap_field,
    pub reg_als_it: *mut regmap_field,
    pub reg_ps_it: *mut regmap_field,
    pub reg_int_ps: *mut regmap_field,
    pub reg_flag_psint: *mut regmap_field,
    pub reg_flag_nf: *mut regmap_field,
    pub ps_thdl: u32,
    pub ps_thdh: u32,
    pub ps_near_level: u32,
    pub als_enabled: bool,
    pub ps_enabled: bool,
    pub ps_int_enabled: bool,
}
...
#[no_mangle]
unsafe extern "C" fn stk3310_check_chip_id(chip_id: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk3310_set_state(data: *mut stk3310_data, state: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk3310_init(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk3310_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stk3310_regmap_init(data: *mut stk3310_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk3310_irq_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stk3310_irq_event_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stk3310_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk3310_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn stk3310_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk3310_resume(dev: *mut device) -> c_int {
