...
//! Source: drivers/iio/light/bh1750.c
#![no_std]
...
pub const BH1750_POWER_DOWN: c_uint = 0x00;
pub const BH1750_ONE_TIME_H_RES_MODE: c_uint = 0x20 /* auto-mode for BH1721 */;
pub const BH1750_CHANGE_INT_TIME_H_BIT: c_uint = 0x40;
pub const BH1750_CHANGE_INT_TIME_L_BIT: c_uint = 0x60;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bh1750_data {
    pub client: *mut i2c_client,
    pub lock: mutex,
    pub chip_info: *const bh1750_chip_info,
    pub mtreg: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bh1750_chip_info {
    pub mtreg_min: u16,
    pub mtreg_max: u16,
    pub mtreg_default: u16,
    pub mtreg_to_usec: c_int,
    pub mtreg_to_scale: c_int,
//
...
//
    pub inc: c_int,
    pub int_time_low_mask: u16,
    pub int_time_high_mask: u16,
}
...
#[no_mangle]
unsafe extern "C" fn bh1750_change_int_time(data: *mut bh1750_data, usec: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bh1750_read(data: *mut bh1750_data, val: *mut c_int) -> c_int {
    static int bh1750_read(struct bh1750_data *data, int *val)
    {
    int ret;
    __be16 result;
    const struct bh1750_chip_info *chip_info = data.chip_info;
    let mut delay: c_ulong = chip_info.mtreg_to_usec * data.mtreg;
//
...
#[no_mangle]
unsafe extern "C" fn bh1750_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bh1750_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn bh1750_suspend(dev: *mut device) -> c_int {
...
//
    ...
    static DEFINE_SIMPLE_DEV_PM_OPS(bh1750_pm_ops, bh1750_suspend, core::ptr::null_mut());
