...
//! Source: drivers/iio/light/tsl2583.c
#![no_std]
...
pub const TSL2583_CNTRL: c_uint = 0x00;

pub const TSL2583_INTERRUPT: c_uint = 0x02;
pub const TSL2583_GAIN: c_uint = 0x07;
pub const TSL2583_REVID: c_uint = 0x11;
pub const TSL2583_CHIPID: c_uint = 0x12;
pub const TSL2583_ALS_CHAN0LO: c_uint = 0x14;
pub const TSL2583_ALS_CHAN0HI: c_uint = 0x15;
pub const TSL2583_ALS_CHAN1LO: c_uint = 0x16;
pub const TSL2583_ALS_CHAN1HI: c_uint = 0x17;
pub const TSL2583_TMR_LO: c_uint = 0x18;
pub const TSL2583_TMR_HI: c_uint = 0x19;
// tsl2583 cmd reg masks
pub const TSL2583_CMD_REG: c_uint = 0x80;
pub const TSL2583_CMD_SPL_FN: c_uint = 0x60;
pub const TSL2583_CMD_ALS_INT_CLR: c_uint = 0x01;
// tsl2583 cntrl reg masks
pub const TSL2583_CNTL_ADC_ENBL: c_uint = 0x02;
pub const TSL2583_CNTL_PWR_OFF: c_uint = 0x00;
pub const TSL2583_CNTL_PWR_ON: c_uint = 0x01;
// tsl2583 status reg masks
pub const TSL2583_STA_ADC_VALID: c_uint = 0x01;
pub const TSL2583_STA_ADC_INTR: c_uint = 0x10;
// Lux calculation constants
pub const TSL2583_LUX_CALC_OVER_FLOW: c_int = 65535;
pub const TSL2583_INTERRUPT_DISABLED: c_uint = 0x00;
pub const TSL2583_CHIP_ID: c_uint = 0x90;
pub const TSL2583_CHIP_ID_MASK: c_uint = 0xf0;
pub const TSL2583_POWER_OFF_DELAY_MS: c_int = 2000;
// Per-device data
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tsl2583_als_info {
    pub als_ch0: u16,
    pub als_ch1: u16,
    pub lux: u16,
}
...
pub const TSL2583_MAX_LUX_TABLE_ENTRIES: c_int = 11;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tsl2583_settings {
    pub als_time: c_int,
    pub als_gain: c_int,
...
//
    pub als_device_lux: [tsl2583_lux; TSL2583_MAX_LUX_TABLE_ENTRIES],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tsl2583_chip {
    pub als_mutex: mutex,
    pub client: *mut i2c_client,
    pub als_cur_info: tsl2583_als_info,
    pub als_settings: tsl2583_settings,
    pub als_time_scale: c_int,
...
//
#[no_mangle]
unsafe extern "C" fn tsl2583_defaults(chip: *mut tsl2583_chip) {
...
//
#[no_mangle]
unsafe extern "C" fn tsl2583_get_lux(indio_dev: *mut iio_dev) -> c_int {
...
// is data new & valid
    ...
    for (i = 0; i < 4; i++) {
    let mut reg: c_int = TSL2583_CMD_REG | (TSL2583_ALS_CHAN0LO + i);
...
//
#[no_mangle]
unsafe extern "C" fn tsl2583_als_calibrate(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsl2583_set_als_time(chip: *mut tsl2583_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsl2583_set_als_gain(chip: *mut tsl2583_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsl2583_set_power_state(chip: *mut tsl2583_chip, state: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tsl2583_chip_init_and_power_on(indio_dev: *mut iio_dev) -> c_int {
...
//
    ...
    struct iio_dev *indio_dev = dev_to_iio_dev(dev);
    struct tsl2583_chip *chip = iio_priv(indio_dev);
    let mut max_ints: c_uint = TSL2583_MAX_LUX_TABLE_ENTRIES * 3;
...
#[no_mangle]
unsafe extern "C" fn tsl2583_probe(clientp: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsl2583_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn tsl2583_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsl2583_resume(dev: *mut device) -> c_int {
    ...
    tsl2583_resume, core::ptr::null_mut());
