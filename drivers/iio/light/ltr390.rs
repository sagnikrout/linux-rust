...
//! Source: drivers/iio/light/ltr390.c
#![no_std]
...
pub const LTR390_MAIN_CTRL: c_uint = 0x00;
pub const LTR390_ALS_UVS_MEAS_RATE: c_uint = 0x04;
pub const LTR390_ALS_UVS_GAIN: c_uint = 0x05;
pub const LTR390_PART_ID: c_uint = 0x06;
pub const LTR390_MAIN_STATUS: c_uint = 0x07;
pub const LTR390_ALS_DATA: c_uint = 0x0D;

pub const LTR390_UVS_DATA: c_uint = 0x10;

pub const LTR390_INT_CFG: c_uint = 0x19;
pub const LTR390_INT_PST: c_uint = 0x1A;
pub const LTR390_THRESH_UP: c_uint = 0x21;

pub const LTR390_THRESH_LOW: c_uint = 0x24;

pub const LTR390_PART_NUMBER_ID: c_uint = 0xb;

pub const LTR390_FRACTIONAL_PRECISION: c_int = 100;
//
...
//
pub const LTR390_COUNTS_PER_UVI: c_int = 96;
//
...
//
pub const LTR390_WINDOW_FACTOR: c_int = 1;
    enum ltr390_mode {
    LTR390_SET_ALS_MODE,
    LTR390_SET_UVS_MODE,
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltr390_data {
    pub regmap: *mut regmap,
    pub client: *mut i2c_client,
// Protects device from simultaneous reads
    pub lock: mutex,
    pub mode: enum ltr390_mode,
    pub gain: c_int,
    pub int_time_us: c_int,
...
#[no_mangle]
unsafe extern "C" fn ltr390_register_read(data: *mut ltr390_data, register_address: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltr390_set_mode(data: *mut ltr390_data, mode: enum ltr390_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltr390_counts_per_uvi(data: *mut ltr390_data) -> c_int {
    static int ltr390_counts_per_uvi(struct ltr390_data *data)
    {
    let mut orig_gain: c_int = 18;
    let mut orig_int_time: c_int = 400;
...
#[no_mangle]
unsafe extern "C" fn ltr390_set_gain(data: *mut ltr390_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltr390_set_int_time(data: *mut ltr390_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltr390_set_samp_freq(data: *mut ltr390_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltr390_read_intr_prst(data: *mut ltr390_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltr390_write_intr_prst(data: *mut ltr390_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltr390_interrupt_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ltr390_powerdown(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ltr390_pm_init(data: *mut ltr390_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltr390_probe(client: *mut i2c_client) -> c_int {
...
// Wait for the registers to reset before proceeding
    ...
    core::ptr::null_mut(), ltr390_interrupt_handler,
    IRQF_ONESHOT,
    "ltr390_thresh_event",
    indio_dev);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn ltr390_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltr390_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltr390_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltr390_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(ltr390_runtime_suspend, ltr390_runtime_resume, core::ptr::null_mut())
    };
