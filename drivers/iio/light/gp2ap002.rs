...
//! Source: drivers/iio/light/gp2ap002.c
#![no_std]
...
pub const GP2AP002_PROX_CHANNEL: c_int = 0;
pub const GP2AP002_ALS_CHANNEL: c_int = 1;
// ------------------------------------------------------------------------
...
pub const GP2AP002_PROX: c_uint = 0x00;
pub const GP2AP002_GAIN: c_uint = 0x01;
pub const GP2AP002_HYS: c_uint = 0x02;
pub const GP2AP002_CYCLE: c_uint = 0x03;
pub const GP2AP002_OPMOD: c_uint = 0x04;
pub const GP2AP002_CON: c_uint = 0x06;
...
//
pub const GP2AP002_HYS_HYSD_SHIFT: c_int = 7;

pub const GP2AP002_HYS_HYSC_SHIFT: c_int = 5;

pub const GP2AP002_HYS_HYSF_SHIFT: c_int = 0;
...
//
pub const GP2AP002_CYCLE_CYCL_SHIFT: c_int = 3;
...
// 1: ineffective
//
pub const GP2AP002_CYCLE_OSC_EFFECTIVE: c_int = 0;
...
// 3: force to go High
//
pub const GP2AP002_CON_OCON_SHIFT: c_int = 3;
...
pub struct gp2ap002 {
    ...
    pub alsout: *mut iio_channel,
    pub hys_far: u8,
    pub hys_close: u8,
    pub is_gp2ap002s00f: bool,
    pub irq: c_int,
    pub enabled: bool,
}

#[no_mangle]
unsafe extern "C" fn gp2ap002_prox_irq(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gp2ap002_get_lux(gp2ap002: *mut gp2ap002) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gp2ap002_init(gp2ap002: *mut gp2ap002) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gp2ap002_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gp2ap002_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn gp2ap002_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gp2ap002_runtime_resume(dev: *mut device) -> c_int {
...
// Re-activate the IRQ
    ...
    gp2ap002_runtime_resume, core::ptr::null_mut());
