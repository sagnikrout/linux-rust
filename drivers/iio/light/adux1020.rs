...
//! Source: drivers/iio/light/adux1020.c
#![no_std]
...
// System registers
pub const ADUX1020_REG_CHIP_ID: c_uint = 0x08;
pub const ADUX1020_REG_SLAVE_ADDRESS: c_uint = 0x09;
pub const ADUX1020_REG_SW_RESET: c_uint = 0x0f;
pub const ADUX1020_REG_INT_ENABLE: c_uint = 0x1c;
pub const ADUX1020_REG_INT_POLARITY: c_uint = 0x1d;
pub const ADUX1020_REG_PROX_TH_ON1: c_uint = 0x2a;
pub const ADUX1020_REG_PROX_TH_OFF1: c_uint = 0x2b;
pub const ADUX1020_REG_PROX_TYPE: c_uint = 0x2f;
pub const ADUX1020_REG_TEST_MODES_3: c_uint = 0x32;
pub const ADUX1020_REG_FORCE_MODE: c_uint = 0x33;
pub const ADUX1020_REG_FREQUENCY: c_uint = 0x40;
pub const ADUX1020_REG_LED_CURRENT: c_uint = 0x41;
pub const ADUX1020_REG_OP_MODE: c_uint = 0x45;
pub const ADUX1020_REG_INT_MASK: c_uint = 0x48;
pub const ADUX1020_REG_INT_STATUS: c_uint = 0x49;
pub const ADUX1020_REG_DATA_BUFFER: c_uint = 0x60;
// Chip ID bits

pub const ADUX1020_CHIP_ID: c_uint = 0x03fc;

pub const ADUX1020_INT_ENABLE: c_uint = 0x2094;
pub const ADUX1020_INT_DISABLE: c_uint = 0x2090;
pub const ADUX1020_PROX_INT_ENABLE: c_uint = 0x00f0;

pub const ADUX1020_FIFO_INT_ENABLE: c_uint = 0x7f;
pub const ADUX1020_MODE_INT_DISABLE: c_uint = 0xff;

pub const ADUX1020_INT_CLEAR: c_uint = 0xff;

pub const ADUX1020_FORCE_CLOCK_ON: c_uint = 0x0f4f;
pub const ADUX1020_FORCE_CLOCK_RESET: c_uint = 0x0040;
pub const ADUX1020_ACTIVE_4_STATE: c_uint = 0x0008;
...
#[no_mangle]
unsafe extern "C" fn adux1020_flush_fifo(data: *mut adux1020_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adux1020_read_fifo(data: *mut adux1020_data, buf: *mut u16, buf_len: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adux1020_interrupt_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn adux1020_chip_init(data: *mut adux1020_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adux1020_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), adux1020_interrupt_handler,
