...
//! Source: drivers/iio/light/us5182d.c
#![no_std]
...
pub const US5182D_REG_CFG0: c_uint = 0x00;

pub const US5182D_REG_CFG1: c_uint = 0x01;

pub const US5182D_CFG1_AGAIN_DEFAULT: c_uint = 0x00;
pub const US5182D_REG_CFG2: c_uint = 0x02;

pub const US5182D_REG_CFG3: c_uint = 0x03;

pub const US5182D_REG_CFG4: c_uint = 0x10;
//
...
//
pub const US5182D_REG_UDARK_TH: c_uint = 0x27;
pub const US5182D_REG_DARK_AUTO_EN: c_uint = 0x2b;
pub const US5182D_REG_AUTO_LDARK_GAIN: c_uint = 0x29;
pub const US5182D_REG_AUTO_HDARK_GAIN: c_uint = 0x2a;
// Thresholds for events: px low (0x08-l, 0x09-h), px high (0x0a-l 0x0b-h)
pub const US5182D_REG_PXL_TH: c_uint = 0x08;
pub const US5182D_REG_PXH_TH: c_uint = 0x0a;
pub const US5182D_REG_PXL_TH_DEFAULT: c_int = 1000;
pub const US5182D_REG_PXH_TH_DEFAULT: c_int = 30000;
pub const US5182D_OPMODE_ALS: c_uint = 0x01;
pub const US5182D_OPMODE_PX: c_uint = 0x02;
pub const US5182D_OPMODE_SHIFT: c_int = 4;
pub const US5182D_REG_DARK_AUTO_EN_DEFAULT: c_uint = 0x80;
pub const US5182D_REG_AUTO_LDARK_GAIN_DEFAULT: c_uint = 0x16;
pub const US5182D_REG_AUTO_HDARK_GAIN_DEFAULT: c_uint = 0x00;
pub const US5182D_REG_ADL: c_uint = 0x0c;
pub const US5182D_REG_PDL: c_uint = 0x0e;
pub const US5182D_REG_MODE_STORE: c_uint = 0x21;
pub const US5182D_STORE_MODE: c_uint = 0x01;
pub const US5182D_REG_CHIPID: c_uint = 0xb2;

pub const US5182D_AGAIN_MASK: c_uint = 0x07;
pub const US5182D_RESET_CHIP: c_uint = 0x01;
pub const US5182D_CHIPID: c_uint = 0x26;

pub const US5182D_GA_RESOLUTION: c_int = 1000;
pub const US5182D_READ_BYTE: c_int = 1;
pub const US5182D_READ_WORD: c_int = 2;

pub const US5182D_PXH_TH_DISABLE: c_uint = 0xffff;
pub const US5182D_PXL_TH_DISABLE: c_uint = 0x0000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct us5182d_data {
    pub client: *mut i2c_client,
    pub lock: mutex,
// Glass attenuation factor
    pub ga: u32,
// Dark gain tuning
    pub lower_dark_gain: u8,
    pub upper_dark_gain: u8,
    pub us5182d_dark_ths: *mut u16,
    pub px_low_th: u16,
    pub px_high_th: u16,
    pub rising_en: c_int,
    pub falling_en: c_int,
    pub opmode: u8,
    pub power_mode: u8,
...
#[no_mangle]
unsafe extern "C" fn us5182d_oneshot_en(data: *mut us5182d_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us5182d_set_opmode(data: *mut us5182d_data, mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us5182d_als_enable(data: *mut us5182d_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us5182d_px_enable(data: *mut us5182d_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us5182d_get_als(data: *mut us5182d_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us5182d_get_px(data: *mut us5182d_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us5182d_shutdown_en(data: *mut us5182d_data, state: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us5182d_set_power_state(data: *mut us5182d_data, on: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn us5182d_update_dark_th(data: *mut us5182d_data, index: c_int) -> c_int {
    static int us5182d_update_dark_th(struct us5182d_data *data, int index)
    {
    let mut dark_th: __be16 = cpu_to_be16(data.us5182d_dark_ths[index]);
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn us5182d_apply_scale(data: *mut us5182d_data, index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us5182d_reset(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us5182d_init(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us5182d_get_platform_data(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn us5182d_dark_gain_config(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us5182d_irq_thread_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn us5182d_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us5182d_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn us5182d_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us5182d_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(us5182d_suspend, us5182d_resume, core::ptr::null_mut())
    };
