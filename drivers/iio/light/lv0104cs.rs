...
//! Source: drivers/iio/light/lv0104cs.c
#![no_std]
...
pub const LV0104CS_REGVAL_MEASURE: c_uint = 0xE0;
pub const LV0104CS_REGVAL_SLEEP: c_uint = 0x00;
pub const LV0104CS_SCALE_0_25X: c_int = 0;
pub const LV0104CS_SCALE_1X: c_int = 1;
pub const LV0104CS_SCALE_2X: c_int = 2;
pub const LV0104CS_SCALE_8X: c_int = 3;
pub const LV0104CS_SCALE_SHIFT: c_int = 3;
pub const LV0104CS_INTEG_12_5MS: c_int = 0;
pub const LV0104CS_INTEG_100MS: c_int = 1;
pub const LV0104CS_INTEG_200MS: c_int = 2;
pub const LV0104CS_INTEG_SHIFT: c_int = 1;
pub const LV0104CS_CALIBSCALE_UNITY: c_int = 31;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lv0104cs_private {
...
#[no_mangle]
unsafe extern "C" fn lv0104cs_write_reg(client: *mut i2c_client, regval: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lv0104cs_read_adc(client: *mut i2c_client, adc_output: *mut u16) -> c_int {
...
// adc_output = be16_to_cpu(regval);
    ...
    int *val, int *val2)
    {
    let mut regval: u8 = LV0104CS_REGVAL_MEASURE;
    u16 adc_output;
    int ret;
...
// val2 = lv0104cs_int_times[lv0104cs->int_time].val2;
    ...
    int val, int val2)
    {
    let mut calibscale: c_int = val * 1000000 + val2;
    int floor, ceil, mid;
    int ret, i, index;
...
// hard matching
    ...
    lv0104cs_show_calibscale_avail, core::ptr::null_mut(), 0);
    static IIO_DEVICE_ATTR(scale_available, 0444,
    lv0104cs_show_scale_avail, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn lv0104cs_probe(client: *mut i2c_client) -> c_int {
