...
//! Source: drivers/iio/light/vcnl4035.c
#![no_std]
...
// Device registers
pub const VCNL4035_ALS_CONF: c_uint = 0x00;
pub const VCNL4035_ALS_THDH: c_uint = 0x01;
pub const VCNL4035_ALS_THDL: c_uint = 0x02;
pub const VCNL4035_ALS_DATA: c_uint = 0x0B;
pub const VCNL4035_WHITE_DATA: c_uint = 0x0C;
pub const VCNL4035_INT_FLAG: c_uint = 0x0D;
pub const VCNL4035_DEV_ID: c_uint = 0x0E;
// Register masks

// Default values

pub const VCNL4035_MODE_ALS_DISABLE: c_uint = 0x00;

pub const VCNL4035_MODE_ALS_INT_DISABLE: c_int = 0;
pub const VCNL4035_DEV_ID_VAL: c_uint = 0x80;
pub const VCNL4035_ALS_IT_DEFAULT: c_uint = 0x01;
pub const VCNL4035_ALS_PERS_DEFAULT: c_uint = 0x00;
pub const VCNL4035_ALS_THDH_DEFAULT: c_int = 5000;
pub const VCNL4035_ALS_THDL_DEFAULT: c_int = 100;
pub const VCNL4035_SLEEP_DELAY_MS: c_int = 2000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vcnl4035_data {
    pub client: *mut i2c_client,
    pub regmap: *mut regmap,
    pub als_it_val: c_uint,
    pub als_persistence: c_uint,
    pub als_thresh_low: c_uint,
    pub als_thresh_high: c_uint,
    pub drdy_trigger0: *mut iio_trigger,
}

#[no_mangle]
pub unsafe extern "C" fn vcnl4035_is_triggered(data: *mut vcnl4035_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vcnl4035_drdy_irq_thread(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
// Triggered buffer
#[no_mangle]
unsafe extern "C" fn vcnl4035_trigger_consumer_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vcnl4035_set_als_power_state(data: *mut vcnl4035_data, status: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4035_init(data: *mut vcnl4035_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4035_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vcnl4035_probe_trigger(indio_dev: *mut iio_dev) -> c_int {
...
// Trigger setup
    ...
    core::ptr::null_mut(), vcnl4035_trigger_consumer_handler,
...
// IRQ to trigger mapping
    ...
    core::ptr::null_mut(), vcnl4035_drdy_irq_thread,
...
#[no_mangle]
unsafe extern "C" fn vcnl4035_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4035_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn vcnl4035_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl4035_runtime_resume(dev: *mut device) -> c_int {
...
// wait for 1 ALS integration cycle
    ...
    vcnl4035_runtime_resume, core::ptr::null_mut());
