...
//! Source: drivers/iio/light/cros_ec_light_prox.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_ec_light_prox_state {
// Shared by all sensors
    pub core: cros_ec_sensors_core_state,
    pub channels: [iio_chan_spec; CROS_EC_LIGHT_PROX_MAX_CHANNELS],
}
...
#[no_mangle]
unsafe extern "C" fn cros_ec_light_prox_probe(pdev: *mut platform_device) -> c_int {
