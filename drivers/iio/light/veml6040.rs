...
//! Source: drivers/iio/light/veml6040.c
#![no_std]
...
// IT: Integration Time
//
pub const VEML6040_CONF_REG: c_uint = 0x000;

pub const VEML6040_CONF_IT_40_MS: c_int = 0;
pub const VEML6040_CONF_IT_80_MS: c_int = 1;
pub const VEML6040_CONF_IT_160_MS: c_int = 2;
pub const VEML6040_CONF_IT_320_MS: c_int = 3;
pub const VEML6040_CONF_IT_640_MS: c_int = 4;
pub const VEML6040_CONF_IT_1280_MS: c_int = 5;
// VEML6040 Read Only Registers
pub const VEML6040_REG_R: c_uint = 0x08;
pub const VEML6040_REG_G: c_uint = 0x09;
pub const VEML6040_REG_B: c_uint = 0x0A;
pub const VEML6040_REG_W: c_uint = 0x0B;
...
#[no_mangle]
unsafe extern "C" fn veml6040_shutdown_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn veml6040_probe(client: *mut i2c_client) -> c_int {
