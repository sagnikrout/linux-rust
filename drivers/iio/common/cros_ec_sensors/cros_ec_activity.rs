...
//! Source: drivers/iio/common/cros_ec_sensors/cros_ec_activity.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_ec_sensors_state {
// Shared by all sensors
    pub core: cros_ec_sensors_core_state,
    pub channels: *mut iio_chan_spec,
    pub body_detection_channel_index: c_int,
    pub sig_motion_channel_index: c_int,
}
...
// val = !st->core.resp->get_activity.state;
    ...
    let mut activity: enum motionsensor_activity = activity_data.activity;
    let mut state: u8 = activity_data.state;
...
#[no_mangle]
unsafe extern "C" fn cros_ec_activity_capture(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_sensors_probe(pdev: *mut platform_device) -> c_int {
