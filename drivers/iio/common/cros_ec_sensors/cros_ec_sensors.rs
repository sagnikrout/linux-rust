...
//! Source: drivers/iio/common/cros_ec_sensors/cros_ec_sensors.c
#![no_std]
...
pub const CROS_EC_SENSORS_MAX_CHANNELS: c_int = 4;
...
// Shared by all sensors
    ...
    pub channels: [iio_chan_spec; CROS_EC_SENSORS_MAX_CHANNELS],
}
...
// There is only enough room for accel and gyro in the io space
    if ((state.core.ec.cmd_readmem != core::ptr::null_mut()) &&
