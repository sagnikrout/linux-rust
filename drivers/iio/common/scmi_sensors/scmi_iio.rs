...
//! Source: drivers/iio/common/scmi_sensors/scmi_iio.c
#![no_std]
...
pub const SCMI_IIO_NUM_OF_AXIS: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_iio_priv {
    pub sensor_ops: *const scmi_sensor_proto_ops,
    pub ph: *mut scmi_protocol_handle,
    pub sensor_info: *const scmi_sensor_info,
    pub indio_dev: *mut iio_dev,
// lock to protect against multiple access to the device
    pub lock: mutex,
// adding one additional channel for timestamp
    pub 1]: s64 iio_buf[SCMI_IIO_NUM_OF_AXIS +,
    pub sensor_update_nb: notifier_block,
    pub freq_avail: *mut u32,
}
...
#[no_mangle]
unsafe extern "C" fn scmi_iio_buffer_preenable(iio_dev: *mut iio_dev) -> c_int {
    static int scmi_iio_buffer_preenable(struct iio_dev *iio_dev)
    {
    struct scmi_iio_priv *sensor = iio_priv(iio_dev);
    let mut sensor_config: u32 = 0;
    int err;
    if (sensor.sensor_info.timestamped)
...
#[no_mangle]
unsafe extern "C" fn scmi_iio_buffer_postdisable(iio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_iio_set_odr_val(iio_dev: *mut iio_dev, val: c_int, val2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn convert_ns_to_freq(interval_ns: u64, hz: *mut u64, uhz: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn scmi_iio_get_odr_val(iio_dev: *mut iio_dev, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_iio_get_chan_type(scmi_type: u8, iio_type: *mut enum iio_chan_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_iio_convert_interval_to_ns(val: u32) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn scmi_iio_set_sampling_freq_avail(iio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_iio_dev_probe(sdev: *mut scmi_device) -> c_int {
