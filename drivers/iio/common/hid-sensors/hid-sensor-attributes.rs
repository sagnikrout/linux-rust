...
//! Source: drivers/iio/common/hid-sensors/hid-sensor-attributes.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn simple_div(dividend: c_int, divisor: c_int, whole: *mut c_int, micro_frac: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn split_micro_fraction(no: c_uint, exp: c_int, val1: *mut c_int, val2: *mut c_int) {
    static void split_micro_fraction(unsigned int no, int exp, int *val1, int *val2)
    {
    let mut divisor: c_int = int_pow(10, exp);
// val1 = no / divisor;
...
#[no_mangle]
unsafe extern "C" fn convert_to_vtf_format(size: c_int, exp: c_int, val1: c_int, val2: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn hid_sensor_read_poll_value(st: *mut hid_sensor_common) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(HID_USAGE_SENSOR_UNITS_SECOND: st->poll.units ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn hid_sensor_get_report_latency(st: *mut hid_sensor_common) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hid_sensor_set_report_latency(st: *mut hid_sensor_common, latency_ms: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hid_sensor_batch_mode_supported(st: *mut hid_sensor_common) -> bool {
