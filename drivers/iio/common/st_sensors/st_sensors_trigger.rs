...
//! Source: drivers/iio/common/st_sensors/st_sensors_trigger.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn st_sensors_irq_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn st_sensors_irq_thread(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
//
    ...
    indio_dev.name);
    if (sdata.trig == core::ptr::null_mut()) {
