...
//! Source: drivers/iio/common/ssp_sensors/ssp_dev.c
#![no_std]
...
pub const SSP_WDT_TIME: c_int = 10000;
pub const SSP_LIMIT_RESET_CNT: c_int = 20;
pub const SSP_LIMIT_TIMEOUT_CNT: c_int = 3;
// It is possible that it is max clk rate for version 1.0 of bootcode
pub const SSP_BOOT_SPI_HZ: c_int = 400000;
//
...
#[no_mangle]
unsafe extern "C" fn ssp_toggle_mcu_reset_gpio(data: *mut ssp_data) {
...
#[no_mangle]
unsafe extern "C" fn ssp_sync_available_sensors(data: *mut ssp_data) {
...
#[no_mangle]
unsafe extern "C" fn ssp_enable_mcu(data: *mut ssp_data, enable: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn ssp_check_fwbl(data: *mut ssp_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssp_reset_mcu(data: *mut ssp_data) {
...
#[no_mangle]
unsafe extern "C" fn ssp_wdt_work_func(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ssp_wdt_timer_func(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn ssp_enable_wdt_timer(data: *mut ssp_data) {
    static void ssp_enable_wdt_timer(struct ssp_data *data)
    {
    mod_timer(&data.wdt_timer, jiffies + msecs_to_jiffies(SSP_WDT_TIME));
    }
#[no_mangle]
unsafe extern "C" fn ssp_disable_wdt_timer(data: *mut ssp_data) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ssp_get_sensor_delay(data: *mut ssp_data, type: enum ssp_sensor_type) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ssp_disable_sensor(data: *mut ssp_data, type: enum ssp_sensor_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssp_irq_thread_fn(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ssp_initialize_mcu(data: *mut ssp_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ssp_refresh_task(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn ssp_queue_ssp_refresh_task(data: *mut ssp_data, delay: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ssp_register_consumer(indio_dev: *mut iio_dev, type: enum ssp_sensor_type) {
...
#[no_mangle]
unsafe extern "C" fn ssp_probe(spi: *mut spi_device) -> c_int {
    ...
    ARRAY_SIZE(sensorhub_sensor_devs), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret < 0) {
    ...
    ret = request_threaded_irq(data.spi.irq, core::ptr::null_mut(),
    ssp_irq_thread_fn,
...
#[no_mangle]
unsafe extern "C" fn ssp_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn ssp_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssp_resume(dev: *mut device) -> c_int {
