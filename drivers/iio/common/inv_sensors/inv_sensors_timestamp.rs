...
//! Source: drivers/iio/common/inv_sensors/inv_sensors_timestamp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn inv_update_acc(acc: *mut inv_sensors_timestamp_acc, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn inv_validate_period(ts: *mut inv_sensors_timestamp, period: u32) -> bool {
...
// update chip internal period estimation
    ...
    {
    let mut period_min: i64 = (s64)ts.min_period * ts.mult;
    let mut period_max: i64 = (s64)ts.max_period * ts.mult;
    s64 new_period;
