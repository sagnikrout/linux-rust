...
//! Source: drivers/iio/temperature/tsys02d.c
#![no_std]
...
pub const TSYS02D_RESET: c_uint = 0xFE;
...
// val = tsys02d_samp_freq[dev_data->res_index];
    ...
    tsys02_read_battery_low, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn tsys02d_probe(client: *mut i2c_client) -> c_int {
