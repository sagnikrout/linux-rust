...
//! Source: drivers/iio/temperature/mlx90635.c
#![no_std]
...
pub const MLX90635_ADDR_RAM: c_uint = 0x0000 /* Start address of ram */;
pub const MLX90635_ADDR_EEPROM: c_uint = 0x0018 /* Start address of user eeprom */;
// EEPROM addresses - used at startup
pub const MLX90635_EE_I2C_CFG: c_uint = 0x0018 /* I2C address register initial value */;
pub const MLX90635_EE_CTRL1: c_uint = 0x001A /* Control register1 initial value */;
pub const MLX90635_EE_CTRL2: c_uint = 0x001C /* Control register2 initial value */;
pub const MLX90635_EE_Ha: c_uint = 0x001E /* Ha customer calib value reg 16bit */;
pub const MLX90635_EE_Hb: c_uint = 0x0020 /* Hb customer calib value reg 16bit */;
pub const MLX90635_EE_Fa: c_uint = 0x0026 /* Fa calibration register 32bit */;
pub const MLX90635_EE_FASCALE: c_uint = 0x002A /* Scaling coefficient for Fa register 16bit */;
pub const MLX90635_EE_Ga: c_uint = 0x002C /* Ga calibration register 16bit */;
pub const MLX90635_EE_Fb: c_uint = 0x002E /* Fb calibration register 16bit */;
pub const MLX90635_EE_Ea: c_uint = 0x0030 /* Ea calibration register 32bit */;
pub const MLX90635_EE_Eb: c_uint = 0x0034 /* Eb calibration register 32bit */;
pub const MLX90635_EE_P_G: c_uint = 0x0038 /* P_G calibration register 16bit */;
pub const MLX90635_EE_P_O: c_uint = 0x003A /* P_O calibration register 16bit */;
pub const MLX90635_EE_Aa: c_uint = 0x003C /* Aa calibration register 16bit */;
pub const MLX90635_EE_VERSION: c_uint = 0x003E /* Version bits 4:7 and 12:15 */;
pub const MLX90635_EE_Gb: c_uint = 0x0040 /* Gb calibration register 16bit */;
// Device status register - volatile
pub const MLX90635_REG_STATUS: c_uint = 0x0000;

// EEPROM control register address - volatile
pub const MLX90635_REG_EE: c_uint = 0x000C;

pub const MLX90635_REG_CMD: c_uint = 0x0010 /* Command register address */;
// Control register1 address - volatile
pub const MLX90635_REG_CTRL1: c_uint = 0x0014;

// Control register2 address - volatile
pub const MLX90635_REG_CTRL2: c_uint = 0x0016;

// PowerModes statuses
pub const MLX90635_PWR_STATUS_HALT: c_int = 0;
pub const MLX90635_PWR_STATUS_SLEEP_STEP: c_int = 1;
pub const MLX90635_PWR_STATUS_STEP: c_int = 2;
pub const MLX90635_PWR_STATUS_CONTINUOUS: c_int = 3;
// Measurement data addresses
pub const MLX90635_RESULT_1: c_uint = 0x0002;
pub const MLX90635_RESULT_2: c_uint = 0x0004;
pub const MLX90635_RESULT_3: c_uint = 0x0006;
pub const MLX90635_RESULT_4: c_uint = 0x0008;
pub const MLX90635_RESULT_5: c_uint = 0x000A;
// Timings (ms)

// Magic constants
pub const MLX90635_ID_DSPv1: c_uint = 0x01 /* EEPROM DSP version */;
pub const MLX90635_RESET_CMD: c_uint = 0x0006 /* Reset sensor (address or global) */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx90635_data {
    pub client: *mut i2c_client,
    pub lock: mutex,
    pub regmap: *mut regmap,
    pub regmap_ee: *mut regmap,
    pub emissivity: u16,
    ...
    .reg_bits = 16,
    .val_bits = 16,
    .volatile_table = core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn mlx90635_reset_delay() {
    static void mlx90635_reset_delay(void)
    {
    usleep_range(MLX90635_TIMING_RST_MIN, MLX90635_TIMING_RST_MAX);
    }
#[no_mangle]
unsafe extern "C" fn mlx90635_pwr_sleep_step(data: *mut mlx90635_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_pwr_continuous(data: *mut mlx90635_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_read_ee_ambient(regmap: *mut regmap, PG: *mut i16, PO: *mut i16, Gb: *mut i16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_calculate_dataset_ready_time(data: *mut mlx90635_data, refresh_time: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_perform_measurement_burst(data: *mut mlx90635_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_read_object_raw(regmap: *mut regmap, object_raw: *mut i16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_calc_ta4(TAdut: i64, scale: i64) -> i64 {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_calc_object(data: *mut mlx90635_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_calc_ambient(data: *mut mlx90635_data, val: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mlx90635_pm_interaction_wakeup(data: *mut mlx90635_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_sleep(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_suspend(data: *mut mlx90635_data) -> c_int {
    static int mlx90635_suspend(struct mlx90635_data *data)
    {
    return mlx90635_pwr_sleep_step(data);
    }
#[no_mangle]
unsafe extern "C" fn mlx90635_wakeup(data: *mut mlx90635_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_disable_regulator(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_enable_regulator(data: *mut mlx90635_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90635_pm_runtime_suspend(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(mlx90635_pm_runtime_suspend, core::ptr::null_mut(), core::ptr::null_mut())
    };
