...
//! Source: drivers/iio/temperature/hid-sensor-temperature.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct temperature_state {
    pub common_attributes: hid_sensor_common,
    pub temperature_attr: hid_sensor_hub_attribute_info,
    struct {
    pub temperature_data: i32,
...
#[no_mangle]
unsafe extern "C" fn hid_temperature_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_temperature_remove(pdev: *mut platform_device) {
