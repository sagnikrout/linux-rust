...
//! Source: drivers/iio/temperature/mcp9600.c
#![no_std]
...
// MCP9600 registers
pub const MCP9600_HOT_JUNCTION: c_uint = 0x00;
pub const MCP9600_COLD_JUNCTION: c_uint = 0x02;
pub const MCP9600_STATUS: c_uint = 0x04;

pub const MCP9600_SENSOR_CFG: c_uint = 0x05;

pub const MCP9600_ALERT_CFG1: c_uint = 0x08;

pub const MCP9600_ALERT_HYSTERESIS1: c_uint = 0x0c;

pub const MCP9600_ALERT_LIMIT1: c_uint = 0x10;

pub const MCP9600_DEVICE_ID: c_uint = 0x20;
// MCP9600 device id value
pub const MCP9600_DEVICE_ID_MCP9600: c_uint = 0x40;
pub const MCP9600_DEVICE_ID_MCP9601: c_uint = 0x41;
pub const MCP9600_ALERT_COUNT: c_int = 4;

pub const MCP9600_MAX_TEMP_HOT_JUNCTION_MICRO: c_int = 1800000000;

pub const MCP9600_MAX_TEMP_COLD_JUNCTION_MICRO: c_int = 125000000;
    enum mcp9600_alert {
    MCP9600_ALERT1,
    MCP9600_ALERT2,
    MCP9600_ALERT3,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp9600_data {
    pub client: *mut i2c_client,
    pub thermocouple_type: u32,
}

#[no_mangle]
unsafe extern "C" fn mcp9600_config(data: *mut mcp9600_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp9600_get_alert_index(channel2: c_int, dir: enum iio_event_direction) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp9600_alert1_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mcp9600_alert2_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mcp9600_alert3_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mcp9600_alert4_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mcp9600_probe_alerts(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp9600_probe(client: *mut i2c_client) -> c_int {
