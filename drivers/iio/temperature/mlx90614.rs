...
//! Source: drivers/iio/temperature/mlx90614.c
#![no_std]
...
pub const MLX90614_OP_RAM: c_uint = 0x00;
pub const MLX90614_OP_EEPROM: c_uint = 0x20;
pub const MLX90614_OP_SLEEP: c_uint = 0xff;
pub const MLX90615_OP_EEPROM: c_uint = 0x10;
pub const MLX90615_OP_RAM: c_uint = 0x20;
pub const MLX90615_OP_SLEEP: c_uint = 0xc6;
...
pub const MLX90614_CONST_FIR: c_uint = 0x7 /* Fixed value for FIR part of low pass filter */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx_chip_info {
// EEPROM offsets with 16-bit data, MSB first
// emissivity correction coefficient
    pub op_eeprom_emissivity: u8,
    pub op_eeprom_config1: u8,
...
// support for two input channels (MLX90614 only)
    pub dual_channel: u8,
    pub wakeup_delay_ms: u8,
    pub emissivity_max: u16,
    pub fir_config_mask: u16,
    pub iir_config_mask: u16,
    pub iir_valid_offset: c_int,
    pub iir_values: [u16; 8],
    pub iir_freqs: [c_int; 8][2],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx90614_data {
    pub client: *mut i2c_client,
    pub /: *mut *mut mutex lock; / for EEPROM access only,
    pub /: *mut *mut *mut gpio_desc wakeup_gpio; / NULL to disable sleep/wake-up,
    pub /: *const *const *const mlx_chip_info chip_info; / Chip hardware details,
    pub /: *mut *mut unsigned long ready_timestamp; / in jiffies,
}
...
//
#[no_mangle]
unsafe extern "C" fn mlx90614_power_get(data: *mut mlx90614_data, startup: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90614_power_put(data: *mut mlx90614_data) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx90614_power_get(data: *mut mlx90614_data, startup: bool) -> c_int {
    static inline int mlx90614_power_get(struct mlx90614_data *data, bool startup)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn mlx90614_power_put(data: *mut mlx90614_data) {
...
#[no_mangle]
unsafe extern "C" fn mlx90614_sleep(data: *mut mlx90614_data) -> c_int {
    ...
    I2C_SMBUS_BYTE, core::ptr::null_mut());
    mutex_unlock(&data.lock);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn mlx90614_wakeup(data: *mut mlx90614_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx90614_sleep(data: *mut mlx90614_data) -> c_int {
    static inline int mlx90614_sleep(struct mlx90614_data *data)
    {
    return -ENOSYS;
    }
#[no_mangle]
pub unsafe extern "C" fn mlx90614_wakeup(data: *mut mlx90614_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90614_probe_num_ir_sensors(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90614_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90614_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn mlx90614_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90614_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90614_pm_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90614_pm_runtime_resume(dev: *mut device) -> c_int {
    ...
    mlx90614_pm_runtime_resume, core::ptr::null_mut())
    };
