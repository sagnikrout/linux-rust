...
//! Source: drivers/iio/temperature/max31856.c
#![no_std]
...
pub const MAX31856_AVERAGING_SHIFT: c_int = 4;

// The MAX31856 registers
pub const MAX31856_CR0_REG: c_uint = 0x00;
pub const MAX31856_CR1_REG: c_uint = 0x01;
pub const MAX31856_MASK_REG: c_uint = 0x02;
pub const MAX31856_CJHF_REG: c_uint = 0x03;
pub const MAX31856_CJLF_REG: c_uint = 0x04;
pub const MAX31856_LTHFTH_REG: c_uint = 0x05;
pub const MAX31856_LTHFTL_REG: c_uint = 0x06;
pub const MAX31856_LTLFTH_REG: c_uint = 0x07;
pub const MAX31856_LTLFTL_REG: c_uint = 0x08;
pub const MAX31856_CJTO_REG: c_uint = 0x09;
pub const MAX31856_CJTH_REG: c_uint = 0x0A;
pub const MAX31856_CJTL_REG: c_uint = 0x0B;
pub const MAX31856_LTCBH_REG: c_uint = 0x0C;
pub const MAX31856_LTCBM_REG: c_uint = 0x0D;
pub const MAX31856_LTCBL_REG: c_uint = 0x0E;
pub const MAX31856_SR_REG: c_uint = 0x0F;
...
#[no_mangle]
unsafe extern "C" fn max31856_init(data: *mut max31856_data) -> c_int {
...
unsafe extern "C" fn show_fault(dev: *mut device, faultbit: u8, buf: *mut c_char) -> isize {
    ...
    static IIO_DEVICE_ATTR(fault_oc, 0444, show_fault_oc, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn max31856_probe(spi: *mut spi_device) -> c_int {
