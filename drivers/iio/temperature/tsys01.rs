...
//! Source: drivers/iio/temperature/tsys01.c
#![no_std]
...
// TSYS01 Commands
pub const TSYS01_RESET: c_uint = 0x1E;
pub const TSYS01_CONVERSION_START: c_uint = 0x48;
pub const TSYS01_ADC_READ: c_uint = 0x00;
pub const TSYS01_PROM_READ: c_uint = 0xA0;
pub const TSYS01_PROM_WORDS_NB: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tsys01_dev {
    pub client: *mut c_void,
    pub /: *mut *mut mutex lock; / lock during conversion,
    pub delay): *mut *mut *mut int (reset)(void cli, u8 cmd, unsigned int,
    int (*convert_and_read)(void *cli, u8 conv, u8 rd,
    pub adc): *mut unsigned int delay, u32,
    pub word): *mut *mut *mut int (read_prom_word)(void cli, int cmd, u16,
    pub prom: [u16; TSYS01_PROM_WORDS_NB],
}
...
#[no_mangle]
unsafe extern "C" fn tsys01_crc_valid(n_prom: *mut u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tsys01_read_prom(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsys01_probe(indio_dev: *mut iio_dev, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsys01_i2c_probe(client: *mut i2c_client) -> c_int {
