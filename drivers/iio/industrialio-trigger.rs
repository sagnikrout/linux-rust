...
//! Source: drivers/iio/industrialio-trigger.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn iio_trigger_register(trig_info: *mut iio_trigger) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_trigger_set_immutable(indio_dev: *mut iio_dev, trig: *mut iio_trigger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_reenable_work_fn(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn iio_trigger_notify_done_atomic(trig: *mut iio_trigger) {
...
#[no_mangle]
pub unsafe extern "C" fn iio_trigger_generic_data_rdy_poll(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn iio_trigger_notify_done(trig: *mut iio_trigger) {
...
#[no_mangle]
unsafe extern "C" fn iio_trigger_get_irq(trig: *mut iio_trigger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_trigger_put_irq(trig: *mut iio_trigger, irq: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn iio_pollfunc_store_time(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn iio_dealloc_pollfunc(pf: *mut iio_poll_func) {
...
#[no_mangle]
unsafe extern "C" fn iio_trig_release(device: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn iio_trig_subirqmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn iio_trig_subirqunmask(d: *mut irq_data) {
...
pub unsafe extern "C" fn __printf(_arg: 3, _arg: 0) -> static {
    ...
    if (trig.name == core::ptr::null_mut())
    goto free_descs;
...
#[no_mangle]
unsafe extern "C" fn devm_iio_trigger_release(trig: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn devm_iio_trigger_unreg(trigger_info: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_validate_own_trigger(idev: *mut iio_dev, trig: *mut iio_trigger) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_device_register_trigger_consumer(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_device_unregister_trigger_consumer(indio_dev: *mut iio_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn iio_device_suspend_triggering(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_device_resume_triggering(indio_dev: *mut iio_dev) -> c_int {
