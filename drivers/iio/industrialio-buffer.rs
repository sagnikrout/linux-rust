...
//! Source: drivers/iio/industrialio-buffer.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn iio_buffer_is_active(buf: *mut iio_buffer) -> bool {
    static bool iio_buffer_is_active(struct iio_buffer *buf)
    {
    return !list_empty(&buf.buffer_list);
    }
#[no_mangle]
unsafe extern "C" fn iio_buffer_data_available(buf: *mut iio_buffer) -> usize {
...
#[no_mangle]
unsafe extern "C" fn iio_buffer_space_available(buf: *mut iio_buffer) -> usize {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_buffer_wakeup_poll(indio_dev: *mut iio_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn iio_pop_from_buffer(buffer: *mut iio_buffer, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_buffer_init(buffer: *mut iio_buffer) {
...
#[no_mangle]
pub unsafe extern "C" fn iio_device_detach_buffers(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn iio_scan_mask_clear(buffer: *mut iio_buffer, bit: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_storage_bytes_for_timestamp(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_buffer_deactivate(buffer: *mut iio_buffer) {
...
#[no_mangle]
unsafe extern "C" fn iio_buffer_deactivate_all(indio_dev: *mut iio_dev) {
    ...
    buffer.scan_timestamp, &bytes, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iio_device_config {
    pub mode: c_uint,
    pub watermark: c_uint,
    pub scan_mask: *const c_ulong,
    pub scan_bytes: c_uint,
    pub scan_timestamp_offset: c_uint,
    ...
    let mut strict_scanmask: bool = false;
    struct iio_buffer *buffer;
    bool scan_timestamp;
    unsigned int modes;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn iio_buffer_demux_free(buffer: *mut iio_buffer) {
...
// p = kmalloc_obj(**p);
    ...
    let mut in_loc: c_uint = 0, out_loc = 0;
    struct iio_demux_table *p = core::ptr::null_mut();
// Clear out any old demux
    iio_buffer_demux_free(buffer);
    kfree(buffer.demux_bounce);
    buffer.demux_bounce = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn iio_update_demux(indio_dev: *mut iio_dev) -> c_int {
    ...
    {
    struct iio_dev_opaque *iio_dev_opaque = to_iio_dev_opaque(indio_dev);
    struct iio_buffer *buffer, *tmp = core::ptr::null_mut();
    int ret;
...
// Wind up again
    ...
    indio_dev.active_scan_mask = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn iio_disable_buffers(indio_dev: *mut iio_dev) -> c_int {
...
//
    ...
    insert_buffer = core::ptr::null_mut();
    if (remove_buffer && !iio_buffer_is_active(remove_buffer))
    remove_buffer = core::ptr::null_mut();
    if (!insert_buffer && !remove_buffer)
    return 0;
    if (!indio_dev.info)
    return -ENODEV;
...
#[no_mangle]
pub unsafe extern "C" fn iio_disable_all_buffers(indio_dev: *mut iio_dev) {
...
// Already in desired state
    ...
    return len;
    if (requested_state)
    ret = __iio_update_buffers(indio_dev, buffer, core::ptr::null_mut());
    else
    ret = __iio_update_buffers(indio_dev, core::ptr::null_mut(), buffer);
    if (ret)
    return ret;
    return len;
    }
    ...
    let mut dev_attr_length_ro: static struct device_attribute = __ATTR_RO(length);
    static DEVICE_ATTR_RW(enable);
    static DEVICE_ATTR_RW(watermark);
    let mut dev_attr_watermark_ro: static struct device_attribute = __ATTR_RO(watermark);
...
#[no_mangle]
unsafe extern "C" fn iio_buffer_unregister_legacy_sysfs_groups(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn iio_buffer_dmabuf_release(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn iio_buffer_dmabuf_get(attach: *mut dma_buf_attachment) {
...
#[no_mangle]
unsafe extern "C" fn iio_buffer_dmabuf_put(attach: *mut dma_buf_attachment) {
...
#[no_mangle]
unsafe extern "C" fn iio_buffer_chrdev_release(inode: *mut inode, filep: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_dma_resv_lock(dmabuf: *mut dma_buf, nonblock: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_buffer_cleanup(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn iio_buffer_signal_dmabuf_done(fence: *mut dma_fence, ret: c_int) {
...
//
    ...
    let mut nonblock: bool = filp.f_flags & O_NONBLOCK;
    switch (cmd) {
...
#[no_mangle]
unsafe extern "C" fn iio_device_buffer_getfd(indio_dev: *mut iio_dev, arg: c_ulong) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn iio_buffers_alloc_sysfs_and_mask(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_buffers_free_sysfs_and_mask(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn iio_push_to_buffer(buffer: *mut iio_buffer, data: *const c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_push_to_buffers(indio_dev: *mut iio_dev, data: *const c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iio_buffer_release(ref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_buffer_put(buffer: *mut iio_buffer) {
...
//
    ...
    let mut cnt: c_uint = iio_dev_opaque.attached_buffers_cnt;
    cnt++;
