...
//! Source: drivers/iio/accel/adxl313_core.c
#![no_std]
...
pub const ADXL313_INT1: c_int = 1;
pub const ADXL313_INT2: c_int = 2;

pub const ADXL313_COUPLING_DC: c_int = 0;
pub const ADXL313_COUPLING_AC: c_int = 1;
// activity/inactivity
...
#[no_mangle]
pub unsafe extern "C" fn adxl313_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn adxl313_set_measure_en(data: *mut adxl313_data, en: bool) -> c_int {
...
// type = IIO_VAL_INT_PLUS_MICRO;
    ...
    let mut val: c_uint = min(val_s, max_boundary);
...
//
    ...
    let mut coupling: return = = ADXL313_COUPLING_DC;
    case ADXL313_ACTIVITY_AC:
    case ADXL313_INACTIVITY_AC:
    let mut coupling: return = = ADXL313_COUPLING_AC;
    default:
    return -EINVAL;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn adxl313_set_act_inact_linkbit(data: *mut adxl313_data, en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl313_set_watermark(indio_dev: *mut iio_dev, value: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl313_get_samples(data: *mut adxl313_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl313_fifo_transfer(data: *mut adxl313_data, samples: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adxl313_fifo_reset(data: *mut adxl313_data) {
...
#[no_mangle]
unsafe extern "C" fn adxl313_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl313_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl313_fifo_push(indio_dev: *mut iio_dev, samples: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl313_push_events(indio_dev: *mut iio_dev, int_stat: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl313_irq_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn adxl313_get_int_type(dev: *mut device, irq: *mut c_int) -> c_uint {
