...
//! Source: drivers/iio/accel/hid-sensor-accel-3d.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct accel_3d_state {
    pub callbacks: hid_sensor_hub_callbacks,
    pub common_attributes: hid_sensor_common,
    pub accel: [hid_sensor_hub_attribute_info; ACCEL_3D_CHANNEL_MAX],
...
#[no_mangle]
unsafe extern "C" fn hid_accel_3d_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_accel_3d_remove(pdev: *mut platform_device) {
