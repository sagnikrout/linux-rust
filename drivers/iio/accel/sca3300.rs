...
//! Source: drivers/iio/accel/sca3300.c
#![no_std]
...
pub const SCA3300_CRC8_POLYNOMIAL: c_uint = 0x1d;
// Device mode register
pub const SCA3300_REG_MODE: c_uint = 0xd;
pub const SCA3300_MODE_SW_RESET: c_uint = 0x20;
// Last register in map
pub const SCA3300_REG_SELBANK: c_uint = 0x1f;
// Device status and mask
pub const SCA3300_REG_STATUS: c_uint = 0x6;

// Device ID
pub const SCA3300_REG_WHOAMI: c_uint = 0x10;
pub const SCA3300_WHOAMI_ID: c_uint = 0x51;
pub const SCL3300_WHOAMI_ID: c_uint = 0xC1;
// Device return status and mask
pub const SCA3300_VALUE_RS_ERROR: c_uint = 0x3;

pub const SCL3300_REG_ANG_CTRL: c_uint = 0x0C;
pub const SCL3300_ANG_ENABLE: c_uint = 0x1F;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sca3300_chip_info {
    pub name: *const c_char,
    pub scan_masks: *const c_ulong,
    pub channels: *const iio_chan_spec,
    pub num_channels: u8,
    pub num_accel_scales: u8,
    pub (*accel_scale)[2]: *const c_int,
    pub accel_scale_map: *const c_int,
    pub (*incli_scale)[2]: *const c_int,
    pub incli_scale_map: *const c_int,
    pub num_incli_scales: u8,
    pub num_freqs: u8,
    pub freq_table: *const c_int,
    pub freq_map: *const c_int,
    pub avail_modes_table: *const c_int,
    pub num_avail_modes: u8,
    pub chip_id: u8,
    pub angle_supported: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sca3300_data {
    pub spi: *mut spi_device,
    pub lock: mutex,
    pub chip: *const sca3300_chip_info,
    pub __aligned(IIO_DMA_MINALIGN): u8 txbuf[4],
    pub rxbuf: [u8; 4],
}
...
#[no_mangle]
unsafe extern "C" fn sca3300_transfer(sca_data: *mut sca3300_data, val: *mut c_int) -> c_int {
    static int sca3300_transfer(struct sca3300_data *sca_data, int *val)
    {
// Consecutive requests min. 10 us delay (Datasheet section 5.1.2)
    let mut delay: spi_delay = { .value = 10, .unit = SPI_DELAY_UNIT_USECS };
    int32_t ret;
    int rs;
    u8 crc;
...
#[no_mangle]
unsafe extern "C" fn sca3300_error_handler(sca_data: *mut sca3300_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sca3300_read_reg(sca_data: *mut sca3300_data, reg: u8, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sca3300_write_reg(sca_data: *mut sca3300_data, reg: u8, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sca3300_set_op_mode(sca_data: *mut sca3300_data, index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sca3300_get_op_mode(sca_data: *mut sca3300_data, index: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sca3300_set_frequency(data: *mut sca3300_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sca3300_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sca3300_probe(spi: *mut spi_device) -> c_int {
    ...
    sca3300_trigger_handler, core::ptr::null_mut());
    if (ret) {
    dev_err(&spi.dev,
