...
//! Source: drivers/iio/accel/dmard10.c
#![no_std]
...
pub const DMARD10_REG_ACTR: c_uint = 0x00;
pub const DMARD10_REG_AFEM: c_uint = 0x0c;
pub const DMARD10_REG_STADR: c_uint = 0x12;
pub const DMARD10_REG_STAINT: c_uint = 0x1c;
pub const DMARD10_REG_MISC2: c_uint = 0x1f;
pub const DMARD10_REG_PD: c_uint = 0x21;
pub const DMARD10_MODE_OFF: c_uint = 0x00;
pub const DMARD10_MODE_STANDBY: c_uint = 0x02;
pub const DMARD10_MODE_ACTIVE: c_uint = 0x06;
pub const DMARD10_MODE_READ_OTP: c_uint = 0x12;
pub const DMARD10_MODE_RESET_DATA_PATH: c_uint = 0x82;
// AFEN set 1, ATM[2:0]=b'000 (normal), EN_Z/Y/X/T=1
pub const DMARD10_VALUE_AFEM_AFEN_NORMAL: c_uint = 0x8f;
// ODR[3:0]=b'0111 (100Hz), CCK[3:0]=b'0100 (204.8kHZ)
pub const DMARD10_VALUE_CKSEL_ODR_100_204: c_uint = 0x74;
// INTC[6:5]=b'00
pub const DMARD10_VALUE_INTC: c_uint = 0x00;
// TAP1/TAP2 Average 2
pub const DMARD10_VALUE_TAPNS_AVE_2: c_uint = 0x11;
pub const DMARD10_VALUE_STADR: c_uint = 0x55;
pub const DMARD10_VALUE_STAINT: c_uint = 0xaa;
pub const DMARD10_VALUE_MISC2_OSCA_EN: c_uint = 0x08;
pub const DMARD10_VALUE_PD_RST: c_uint = 0x52;
// Offsets into the buffer read in dmard10_read_raw()
pub const DMARD10_X_OFFSET: c_int = 1;
pub const DMARD10_Y_OFFSET: c_int = 2;
pub const DMARD10_Z_OFFSET: c_int = 3;
//
// a value of + or -128 corresponds to + or - 1G
// scale = 9.81 / 128 = 0.076640625
//
    let mut dmard10_nscale: static int = 76640625;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmard10_data {
    pub client: *mut i2c_client,
}

// Init sequence taken from the android driver
#[no_mangle]
unsafe extern "C" fn dmard10_reset(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmard10_shutdown(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmard10_shutdown_cleanup(client: *mut c_void) {
    static void dmard10_shutdown_cleanup(void *client)
    {
    dmard10_shutdown(client);
    }
#[no_mangle]
unsafe extern "C" fn dmard10_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmard10_suspend(dev: *mut device) -> c_int {
    static int dmard10_suspend(struct device *dev)
    {
    return dmard10_shutdown(to_i2c_client(dev));
    }
#[no_mangle]
unsafe extern "C" fn dmard10_resume(dev: *mut device) -> c_int {
