...
//! Source: drivers/iio/accel/adxl345_core.c
#![no_std]
...
pub const ADXL345_FIFO_BYPASS: c_int = 0;
pub const ADXL345_FIFO_FIFO: c_int = 1;
pub const ADXL345_FIFO_STREAM: c_int = 2;
pub const ADXL345_DIRS: c_int = 3;
pub const ADXL345_INT_NONE: c_uint = 0xff;
pub const ADXL345_INT1: c_int = 0;
pub const ADXL345_INT2: c_int = 1;

pub const ADXL345_ACT_INACT_NO_AXIS_EN: c_uint = 0x00;

pub const ADXL345_COUPLING_DC: c_int = 0;
pub const ADXL345_COUPLING_AC: c_int = 1;
pub const ADXL345_REG_NO_ACDC: c_uint = 0x00;
// single/double tap
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adxl345_state {
    pub info: *const adxl345_chip_info,
    pub regmap: *mut regmap,
    pub /: *mut *mut bool fifo_delay; / delay: delay is needed for SPI,
    pub watermark: u8,
    pub fifo_mode: u8,
    pub inact_threshold: u8,
    pub inact_time_ms: u32,
    pub tap_duration_us: u32,
    pub tap_latent_us: u32,
    pub tap_window_us: u32,
    pub __aligned(IIO_DMA_MINALIGN): *mut *mut __le16 fifo_buf[ADXL345_DIRS  ADXL345_FIFO_SIZE + 1],
}
...
#[no_mangle]
pub unsafe extern "C" fn adxl345_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn adxl345_set_measure_en(st: *mut adxl345_state, en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl345_set_default_time(st: *mut adxl345_state) -> c_int {
    static int adxl345_set_default_time(struct adxl345_state *st)
    {
    let mut max_boundary: c_int = U8_MAX;
    let mut min_boundary: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn adxl345_set_inactivity_time(st: *mut adxl345_state, val_int: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl345_set_freefall_time(st: *mut adxl345_state, val_fract: u32) -> c_int {
...
//
    ...
    let mut coupling: return = = ADXL345_COUPLING_DC;
    case ADXL345_ACTIVITY_AC:
    case ADXL345_INACTIVITY_AC:
    let mut coupling: return = = ADXL345_COUPLING_AC;
    default:
    return -EINVAL;
    }
    }
...
// tap
    ...
    {
    let mut int_map: c_uint = 0x00;
    unsigned int tap_threshold;
    bool axis_valid;
    let mut singletap_args_valid: bool = false;
    let mut doubletap_args_valid: bool = false;
...
#[no_mangle]
unsafe extern "C" fn adxl345_set_doubletap_en(st: *mut adxl345_state, en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl345_set_odr(st: *mut adxl345_state, odr: enum adxl345_odr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl345_set_range(st: *mut adxl345_state, range: enum adxl345_range) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl345_set_watermark(indio_dev: *mut iio_dev, value: c_uint) -> c_int {
    static int adxl345_set_watermark(struct iio_dev *indio_dev, unsigned int value)
    {
    struct adxl345_state *st = iio_priv(indio_dev);
    let mut fifo_mask: c_uint = 0x1F, watermark_mask = 0x02;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn adxl345_powerdown(ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn adxl345_set_fifo(st: *mut adxl345_state) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adxl345_get_samples(st: *mut adxl345_state) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adxl345_fifo_transfer(st: *mut adxl345_state, samples: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adxl345_fifo_reset(st: *mut adxl345_state) {
...
#[no_mangle]
unsafe extern "C" fn adxl345_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl345_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adxl345_irq_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
    static irqreturn_t adxl345_irq_handler(int irq, void *p)
    {
    struct iio_dev *indio_dev = p;
    struct adxl345_state *st = iio_priv(indio_dev);
    unsigned int regval;
    let mut tap_dir: enum iio_modifier = IIO_NO_MOD;
    let mut act_dir: enum iio_modifier = IIO_NO_MOD;
    u32 axis_ctrl;
    int int_stat;
    int ret;
    ret = regmap_read(st.regmap, ADXL345_REG_TAP_AXIS, &axis_ctrl);
    ...
    tap_dir = IIO_MOD_Z;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: FIELD_GET(ADXL345_TAP_Y_EN, _arg: regval)) -> else {
    else if (FIELD_GET(ADXL345_TAP_Y_EN, regval))
    tap_dir = IIO_MOD_Y;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: FIELD_GET(ADXL345_TAP_X_EN, _arg: regval)) -> else {
    else if (FIELD_GET(ADXL345_TAP_X_EN, regval))
    tap_dir = IIO_MOD_X;
    if (FIELD_GET(ADXL345_ACT_Z_EN, regval))
    act_dir = IIO_MOD_Z;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: FIELD_GET(ADXL345_ACT_Y_EN, _arg: regval)) -> else {
    else if (FIELD_GET(ADXL345_ACT_Y_EN, regval))
    act_dir = IIO_MOD_Y;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: FIELD_GET(ADXL345_ACT_X_EN, _arg: regval)) -> else {
...
#[no_mangle]
unsafe extern "C" fn adxl345_get_int_line(dev: *mut device, irq: *mut c_int) -> c_int {
