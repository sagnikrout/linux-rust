...
//! Source: drivers/iio/accel/adxl355_core.c
#![no_std]
...
pub const ADXL355_DEVID_AD_REG: c_uint = 0x00;
pub const ADXL355_DEVID_MST_REG: c_uint = 0x01;
pub const ADXL355_PARTID_REG: c_uint = 0x02;
pub const ADXL355_STATUS_REG: c_uint = 0x04;
pub const ADXL355_FIFO_ENTRIES_REG: c_uint = 0x05;
pub const ADXL355_TEMP2_REG: c_uint = 0x06;
pub const ADXL355_XDATA3_REG: c_uint = 0x08;
pub const ADXL355_YDATA3_REG: c_uint = 0x0B;
pub const ADXL355_ZDATA3_REG: c_uint = 0x0E;
pub const ADXL355_FIFO_DATA_REG: c_uint = 0x11;
pub const ADXL355_OFFSET_X_H_REG: c_uint = 0x1E;
pub const ADXL355_OFFSET_Y_H_REG: c_uint = 0x20;
pub const ADXL355_OFFSET_Z_H_REG: c_uint = 0x22;
pub const ADXL355_ACT_EN_REG: c_uint = 0x24;
pub const ADXL355_ACT_THRESH_H_REG: c_uint = 0x25;
pub const ADXL355_ACT_THRESH_L_REG: c_uint = 0x26;
pub const ADXL355_ACT_COUNT_REG: c_uint = 0x27;
pub const ADXL355_FILTER_REG: c_uint = 0x28;

pub const ADXL355_FIFO_SAMPLES_REG: c_uint = 0x29;
pub const ADXL355_INT_MAP_REG: c_uint = 0x2A;
pub const ADXL355_SYNC_REG: c_uint = 0x2B;
pub const ADXL355_RANGE_REG: c_uint = 0x2C;
pub const ADXL355_POWER_CTL_REG: c_uint = 0x2D;

pub const ADXL355_SELF_TEST_REG: c_uint = 0x2E;
pub const ADXL355_RESET_REG: c_uint = 0x2F;
pub const ADXL355_BASE_ADDR_SHADOW_REG: c_uint = 0x50;
pub const ADXL355_SHADOW_REG_COUNT: c_int = 5;
pub const ADXL355_DEVID_AD_VAL: c_uint = 0xAD;
pub const ADXL355_DEVID_MST_VAL: c_uint = 0x1D;
pub const ADXL355_PARTID_VAL: c_uint = 0xED;
pub const ADXL359_PARTID_VAL: c_uint = 0xE9;
pub const ADXL355_RESET_CODE: c_uint = 0x52;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adxl355_data {
    pub chip_info: *const adxl355_chip_info,
    pub regmap: *mut regmap,
    pub dev: *mut device,
    pub /: *mut *mut mutex lock; / lock to protect op_mode,
    pub op_mode: enum adxl355_op_mode,
    pub odr: enum adxl355_odr,
    pub hpf_3db: enum adxl355_hpf_3db,
    pub calibbias: [c_int; 3],
    pub adxl355_hpf_3db_table: [c_int; 7][2],
...
#[no_mangle]
unsafe extern "C" fn adxl355_fill_3db_frequency_table(data: *mut adxl355_data) {
...
#[no_mangle]
unsafe extern "C" fn adxl355_setup(data: *mut adxl355_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl355_get_temp_data(data: *mut adxl355_data, addr: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl355_read_axis(data: *mut adxl355_data, addr: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxl355_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn adxl355_probe_trigger(indio_dev: *mut iio_dev, irq: c_int) -> c_int {
    ...
    &adxl355_trigger_handler, core::ptr::null_mut());
    if (ret)
