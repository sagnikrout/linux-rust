...
//! Source: drivers/iio/accel/bmc150-accel-i2c.c
#![no_std]
...
pub const DUAL250E_SET_ANGLE_FN_INDEX: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dual250e_set_angle_args {
    pub aux0: u32,
    pub ang0: u32,
    pub rawx: u32,
    pub rawy: u32,
    ...
    pub __packed: },
#[no_mangle]
unsafe extern "C" fn bmc150_acpi_set_angle_dsm(client: *mut i2c_client, aux0: u32, ang0: u32) -> bool {
    static bool bmc150_acpi_set_angle_dsm(struct i2c_client *client, u32 aux0, u32 ang0)
    {
    pub ACPI_COMPANION(&client->dev): *mut *mut acpi_device adev =,
    ...
    guid_t guid;
    if (!acpi_dev_hid_uid_match(adev, "DUAL250E", core::ptr::null_mut()))
    return false;
...
#[no_mangle]
unsafe extern "C" fn bmc150_acpi_enable_keyboard(client: *mut i2c_client) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bmc150_acpi_resume_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn bmc150_acpi_resume_handler(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn bmc150_acpi_dual_accel_probe(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn bmc150_acpi_dual_accel_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn bmc150_accel_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bmc150_accel_remove(client: *mut i2c_client) {
