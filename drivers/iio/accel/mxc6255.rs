...
//! Source: drivers/iio/accel/mxc6255.c
#![no_std]
...
pub const MXC6255_REG_XOUT: c_uint = 0x00;
pub const MXC6255_REG_YOUT: c_uint = 0x01;
pub const MXC6255_REG_CHIP_ID: c_uint = 0x08;
pub const MXC6255_CHIP_ID: c_uint = 0x05;
//
...
//
pub const MXC6255_SCALE: c_int = 153829;
    enum mxc6255_axis {
    AXIS_X,
    AXIS_Y,
    };
...
#[no_mangle]
unsafe extern "C" fn mxc6255_is_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mxc6255_probe(client: *mut i2c_client) -> c_int {
