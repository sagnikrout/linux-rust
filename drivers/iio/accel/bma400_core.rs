...
//! Source: drivers/iio/accel/bma400_core.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bma400_data {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub /: *mut *mut mutex mutex; / data register lock,
    pub orientation: iio_mount_matrix,
    pub power_mode: enum bma400_power_mode,
    pub sample_freq: bma400_sample_freq,
    pub oversampling_ratio: c_int,
    pub scale: c_int,
    pub trig: *mut iio_trigger,
    pub steps_enabled: c_int,
    pub step_event_en: bool,
    pub activity_event_en: bool,
    pub generic_event_en: c_uint,
    pub tap_event_en_bitmask: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bma400_genintr_info {
    pub genintr: enum bma400_generic_intr,
    pub intrmask: c_uint,
    pub dir: enum iio_event_direction,
    pub detect_mode: enum bma400_detect_criterion,
}
...
#[no_mangle]
unsafe extern "C" fn bma400_is_writable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bma400_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn usec_to_tapreg_raw(usec: c_int, time_list: *const c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma400_get_temp_reg(data: *mut bma400_data, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma400_get_accel_output_data_rate(data: *mut bma400_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma400_get_accel_oversampling_ratio(data: *mut bma400_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma400_get_accel_scale(data: *mut bma400_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma400_set_accel_scale(data: *mut bma400_data, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma400_get_power_mode(data: *mut bma400_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma400_enable_steps(data: *mut bma400_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma400_get_steps_reg(data: *mut bma400_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma400_init_tables() {
...
#[no_mangle]
unsafe extern "C" fn bma400_power_disable(data_ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn bma400_act_to_mod(activity: enum bma400_activity) -> enum iio_modifier {
...
#[no_mangle]
unsafe extern "C" fn bma400_init(data: *mut bma400_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma400_steps_event_enable(data: *mut bma400_data, state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma400_disable_adv_interrupt(data: *mut bma400_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma400_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bma400_interrupt(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
//
    ...
    &bma400_trigger_handler, core::ptr::null_mut());
    if (ret)
    return dev_err_probe(data.dev, ret,
