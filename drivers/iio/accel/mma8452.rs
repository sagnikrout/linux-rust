...
//! Source: drivers/iio/accel/mma8452.c
#![no_std]
...
pub const MMA8452_STATUS: c_uint = 0x00;

pub const MMA8452_OUT_X: c_uint = 0x01 /* MSB first */;
pub const MMA8452_OUT_Y: c_uint = 0x03;
pub const MMA8452_OUT_Z: c_uint = 0x05;
pub const MMA8452_INT_SRC: c_uint = 0x0c;
pub const MMA8452_WHO_AM_I: c_uint = 0x0d;
pub const MMA8452_DATA_CFG: c_uint = 0x0e;

pub const MMA8452_DATA_CFG_FS_2G: c_int = 0;
pub const MMA8452_DATA_CFG_FS_4G: c_int = 1;
pub const MMA8452_DATA_CFG_FS_8G: c_int = 2;

pub const MMA8452_HP_FILTER_CUTOFF: c_uint = 0x0f;

pub const MMA8452_FF_MT_CFG: c_uint = 0x15;

pub const MMA8452_FF_MT_SRC: c_uint = 0x16;

pub const MMA8452_FF_MT_THS: c_uint = 0x17;
pub const MMA8452_FF_MT_THS_MASK: c_uint = 0x7f;
pub const MMA8452_FF_MT_COUNT: c_uint = 0x18;
pub const MMA8452_FF_MT_CHAN_SHIFT: c_int = 3;
pub const MMA8452_TRANSIENT_CFG: c_uint = 0x1d;

pub const MMA8452_TRANSIENT_SRC: c_uint = 0x1e;

pub const MMA8452_TRANSIENT_THS: c_uint = 0x1f;

pub const MMA8452_TRANSIENT_COUNT: c_uint = 0x20;
pub const MMA8452_TRANSIENT_CHAN_SHIFT: c_int = 1;
pub const MMA8452_CTRL_REG1: c_uint = 0x2a;

pub const MMA8452_CTRL_DR_SHIFT: c_int = 3;
pub const MMA8452_CTRL_DR_DEFAULT: c_uint = 0x4 /* 50 Hz sample frequency */;
pub const MMA8452_CTRL_REG2: c_uint = 0x2b;

pub const MMA8452_CTRL_REG2_MODS_SHIFT: c_int = 3;
pub const MMA8452_CTRL_REG2_MODS_MASK: c_uint = 0x1b;
pub const MMA8452_CTRL_REG4: c_uint = 0x2d;
pub const MMA8452_CTRL_REG5: c_uint = 0x2e;
pub const MMA8452_OFF_X: c_uint = 0x2f;
pub const MMA8452_OFF_Y: c_uint = 0x30;
pub const MMA8452_OFF_Z: c_uint = 0x31;
pub const MMA8452_MAX_REG: c_uint = 0x31;

pub const MMA8451_DEVICE_ID: c_uint = 0x1a;
pub const MMA8452_DEVICE_ID: c_uint = 0x2a;
pub const MMA8453_DEVICE_ID: c_uint = 0x3a;
pub const MMA8652_DEVICE_ID: c_uint = 0x4a;
pub const MMA8653_DEVICE_ID: c_uint = 0x5a;
pub const FXLS8471_DEVICE_ID: c_uint = 0x6a;
pub const MMA8452_AUTO_SUSPEND_DELAY_MS: c_int = 2000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mma8452_data {
    pub client: *mut i2c_client,
    pub lock: mutex,
    pub orientation: iio_mount_matrix,
    pub ctrl_reg1: u8,
    pub data_cfg: u8,
    pub chip_info: *const mma_chip_info,
    pub sleep_val: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mma8452_event_regs {
    pub ev_cfg: u8,
    pub ev_cfg_ele: u8,
    pub ev_cfg_chan_shift: u8,
    pub ev_src: u8,
    pub ev_ths: u8,
    pub ev_ths_mask: u8,
    pub ev_count: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mma_chip_info {
    pub name: *const c_char,
    pub chip_id: u8,
    pub channels: *const iio_chan_spec,
    pub num_channels: c_int,
    pub mma_scales: [c_int; 3][2],
    pub all_events: c_int,
    pub enabled_events: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn mma8452_drdy(data: *mut mma8452_data) -> c_int {
    static int mma8452_drdy(struct mma8452_data *data)
    {
    let mut tries: c_int = 150;
    while (tries-- > 0) {
...
#[no_mangle]
unsafe extern "C" fn mma8452_set_runtime_pm_state(client: *mut i2c_client, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma8452_read(data: *mut mma8452_data, buf[3]: __be16) -> c_int {
    static int mma8452_read(struct mma8452_data *data, __be16 buf[3])
    {
    let mut ret: c_int = mma8452_drdy(data);
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn mma8452_get_odr_index(data: *mut mma8452_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mma8452_get_power_mode(data: *mut mma8452_data) -> c_int {
    ...
    struct iio_dev *indio_dev = dev_to_iio_dev(dev);
    struct mma8452_data *data = iio_priv(indio_dev);
    let mut i: c_int = mma8452_get_odr_index(data);
    int j;
    let mut val: u16 = 0;
    let mut len: usize = 0;
    ...
    mma8452_show_scale_avail, core::ptr::null_mut(), 0);
    static IIO_DEVICE_ATTR(in_accel_filter_high_pass_3db_frequency_available,
    0444, mma8452_show_hp_cutoff_avail, core::ptr::null_mut(), 0);
    static IIO_DEVICE_ATTR(in_accel_oversampling_ratio_available, 0444,
    mma8452_show_os_ratio_avail, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn mma8452_get_scale_index(data: *mut mma8452_data, val: c_int, val2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma8452_read_hp_filter(data: *mut mma8452_data, hz: *mut c_int, uHz: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma8452_calculate_sleep(data: *mut mma8452_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma8452_standby(data: *mut mma8452_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma8452_active(data: *mut mma8452_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma8452_is_active(data: *mut mma8452_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma8452_change_config(data: *mut mma8452_data, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma8452_set_power_mode(data: *mut mma8452_data, mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma8452_freefall_mode_enabled(data: *mut mma8452_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma8452_set_freefall_mode(data: *mut mma8452_data, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma8452_transient_interrupt(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn mma8452_interrupt(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mma8452_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mma8452_trigger_setup(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma8452_trigger_cleanup(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn mma8452_reset(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma8452_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    mma8452_trigger_handler, core::ptr::null_mut());
    if (ret < 0)
    goto trigger_cleanup;
    if (client.irq) {
    ret = request_threaded_irq(client.irq, core::ptr::null_mut(), mma8452_interrupt,
...
#[no_mangle]
unsafe extern "C" fn mma8452_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn mma8452_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma8452_runtime_resume(dev: *mut device) -> c_int {
    ...
    mma8452_runtime_resume, core::ptr::null_mut())
    };
