...
//! Source: drivers/iio/accel/adxl313_i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn adxl313_i2c_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    return adxl313_core_probe(dev, regmap, chip_data, core::ptr::null_mut());
    }
