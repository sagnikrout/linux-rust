...
//! Source: drivers/iio/accel/mma9553.c
#![no_std]
...
pub const MMA9553_REG_CONF_SLEEPMIN: c_uint = 0x00;
pub const MMA9553_REG_CONF_SLEEPMAX: c_uint = 0x02;
pub const MMA9553_REG_CONF_SLEEPTHD: c_uint = 0x04;

pub const MMA9553_REG_CONF_CONF_STEPLEN: c_uint = 0x06;

pub const MMA9553_REG_CONF_HEIGHT_WEIGHT: c_uint = 0x08;

pub const MMA9553_REG_CONF_FILTER: c_uint = 0x0A;

pub const MMA9553_REG_CONF_SPEED_STEP: c_uint = 0x0C;

pub const MMA9553_REG_CONF_ACTTHD: c_uint = 0x0E;

// Pedometer status registers (R-only)
pub const MMA9553_REG_STATUS: c_uint = 0x00;

pub const MMA9553_REG_STEPCNT: c_uint = 0x02;
pub const MMA9553_REG_DISTANCE: c_uint = 0x04;
pub const MMA9553_REG_SPEED: c_uint = 0x06;
pub const MMA9553_REG_CALORIES: c_uint = 0x08;
pub const MMA9553_REG_SLEEPCNT: c_uint = 0x0A;
// Pedometer events are always mapped to this pin.

pub const MMA9553_DEFAULT_GPIO_POLARITY: c_int = 0;
...
pub const MMA9553_CONFIG_RETRIES: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mma9553_event {
    pub info: *const mma9553_event_info,
    pub enabled: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mma9553_conf_regs {
    pub sleepmin: u16,
    pub sleepmax: u16,
    pub sleepthd: u16,
    pub config: u16,
    pub height_weight: u16,
    pub filter: u16,
    pub speed_step: u16,
    pub actthd: u16,
    pub __packed: },
...
//
    pub mutex: mutex,
    pub conf: mma9553_conf_regs,
    pub events: [mma9553_event; MMA9553_EVENTS_INFO_SIZE],
...
#[no_mangle]
unsafe extern "C" fn mma9553_get_bits(val: u16, mask: u16) -> u8 {
    static u8 mma9553_get_bits(u16 val, u16 mask)
    {
    return (val & mask) >> (ffs(mask) - 1);
    }
#[no_mangle]
unsafe extern "C" fn mma9553_set_bits(current_val: u16, val: u16, mask: u16) -> u16 {
    static u16 mma9553_set_bits(u16 current_val, u16 val, u16 mask)
    {
    return (current_val & ~mask) | (val << (ffs(mask) - 1));
    }
#[no_mangle]
unsafe extern "C" fn mma9553_activity_to_mod(activity: enum activity_level) -> enum iio_modifier {
...
#[no_mangle]
unsafe extern "C" fn mma9553_init_events(data: *mut mma9553_data) {
...
#[no_mangle]
unsafe extern "C" fn mma9553_conf_gpio(data: *mut mma9553_data) -> c_int {
    static int mma9553_conf_gpio(struct mma9553_data *data)
    {
    let mut bitnum: u8 = 0, appid = MMA9551_APPID_PEDOMETER;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ev_step_detect->enabled) -> else {
    else if (ev_step_detect.enabled)
    bitnum = MMA9553_STATUS_TO_BITNUM(MMA9553_MASK_STATUS_STEPCHG);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: activity_enabled) -> else {
...
#[no_mangle]
unsafe extern "C" fn mma9553_init(data: *mut mma9553_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma9553_irq_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mma9553_event_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mma9553_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma9553_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn mma9553_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma9553_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma9553_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma9553_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(mma9553_runtime_suspend, mma9553_runtime_resume, core::ptr::null_mut())
    };
