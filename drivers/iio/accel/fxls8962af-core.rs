...
//! Source: drivers/iio/accel/fxls8962af-core.c
#![no_std]
...
pub const FXLS8962AF_INT_STATUS: c_uint = 0x00;

pub const FXLS8962AF_TEMP_OUT: c_uint = 0x01;
pub const FXLS8962AF_VECM_LSB: c_uint = 0x02;
pub const FXLS8962AF_OUT_X_LSB: c_uint = 0x04;
pub const FXLS8962AF_OUT_Y_LSB: c_uint = 0x06;
pub const FXLS8962AF_OUT_Z_LSB: c_uint = 0x08;
pub const FXLS8962AF_BUF_STATUS: c_uint = 0x0b;

pub const FXLS8962AF_BUF_X_LSB: c_uint = 0x0c;
pub const FXLS8962AF_BUF_Y_LSB: c_uint = 0x0e;
pub const FXLS8962AF_BUF_Z_LSB: c_uint = 0x10;
pub const FXLS8962AF_PROD_REV: c_uint = 0x12;
pub const FXLS8962AF_WHO_AM_I: c_uint = 0x13;
pub const FXLS8962AF_SYS_MODE: c_uint = 0x14;
pub const FXLS8962AF_SENS_CONFIG1: c_uint = 0x15;

pub const FXLS8962AF_SENS_CONFIG2: c_uint = 0x16;
pub const FXLS8962AF_SENS_CONFIG3: c_uint = 0x17;

pub const FXLS8962AF_SENS_CONFIG4: c_uint = 0x18;

pub const FXLS8962AF_SENS_CONFIG5: c_uint = 0x19;
pub const FXLS8962AF_WAKE_IDLE_LSB: c_uint = 0x1b;
pub const FXLS8962AF_SLEEP_IDLE_LSB: c_uint = 0x1c;
pub const FXLS8962AF_ASLP_COUNT_LSB: c_uint = 0x1e;
pub const FXLS8962AF_INT_EN: c_uint = 0x20;

pub const FXLS8962AF_INT_PIN_SEL: c_uint = 0x21;

pub const FXLS8962AF_INT_PIN_SEL_INT1: c_uint = 0x00;

pub const FXLS8962AF_OFF_X: c_uint = 0x22;
pub const FXLS8962AF_OFF_Y: c_uint = 0x23;
pub const FXLS8962AF_OFF_Z: c_uint = 0x24;
pub const FXLS8962AF_BUF_CONFIG1: c_uint = 0x26;

pub const FXLS8962AF_BUF_CONFIG2: c_uint = 0x27;

pub const FXLS8962AF_ORIENT_STATUS: c_uint = 0x28;
pub const FXLS8962AF_ORIENT_CONFIG: c_uint = 0x29;
pub const FXLS8962AF_ORIENT_DBCOUNT: c_uint = 0x2a;
pub const FXLS8962AF_ORIENT_BF_ZCOMP: c_uint = 0x2b;
pub const FXLS8962AF_ORIENT_THS_REG: c_uint = 0x2c;
pub const FXLS8962AF_SDCD_INT_SRC1: c_uint = 0x2d;

pub const FXLS8962AF_SDCD_INT_SRC2: c_uint = 0x2e;
pub const FXLS8962AF_SDCD_CONFIG1: c_uint = 0x2f;

pub const FXLS8962AF_SDCD_CONFIG2: c_uint = 0x30;

pub const FXLS8962AF_SDCD_OT_DBCNT: c_uint = 0x31;
pub const FXLS8962AF_SDCD_WT_DBCNT: c_uint = 0x32;
pub const FXLS8962AF_SDCD_LTHS_LSB: c_uint = 0x33;
pub const FXLS8962AF_SDCD_UTHS_LSB: c_uint = 0x35;
pub const FXLS8962AF_SELF_TEST_CONFIG1: c_uint = 0x37;
pub const FXLS8962AF_SELF_TEST_CONFIG2: c_uint = 0x38;
pub const FXLS8962AF_MAX_REG: c_uint = 0x38;
pub const FXLS8962AF_DEVICE_ID: c_uint = 0x62;
pub const FXLS8964AF_DEVICE_ID: c_uint = 0x84;
pub const FXLS8974CF_DEVICE_ID: c_uint = 0x86;
pub const FXLS8967AF_DEVICE_ID: c_uint = 0x87;
// Raw temp channel offset
pub const FXLS8962AF_TEMP_CENTER_VAL: c_int = 25;
pub const FXLS8962AF_AUTO_SUSPEND_DELAY_MS: c_int = 2000;
pub const FXLS8962AF_FIFO_LENGTH: c_int = 32;
pub const FXLS8962AF_SCALE_TABLE_LEN: c_int = 4;
pub const FXLS8962AF_SAMP_FREQ_TABLE_LEN: c_int = 13;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fxls8962af_chip_info {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fxls8962af_data {
    pub regmap: *mut regmap,
    pub chip_info: *const fxls8962af_chip_info,
    struct {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_power_on(data: *mut fxls8962af_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_power_off(data: *mut fxls8962af_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_standby(data: *mut fxls8962af_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_active(data: *mut fxls8962af_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_is_active(data: *mut fxls8962af_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_set_full_scale(data: *mut fxls8962af_data, scale: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_event_setup(data: *mut fxls8962af_data, state: c_int) -> c_int {
    static int fxls8962af_event_setup(struct fxls8962af_data *data, int state)
    {
// Enable wakeup interrupt
    let mut mask: c_int = FXLS8962AF_INT_EN_SDCD_OT_EN;
    let mut value: c_int = state ? mask : 0;
    return regmap_update_bits(data.regmap, FXLS8962AF_INT_EN, mask, value);
    }
#[no_mangle]
unsafe extern "C" fn fxls8962af_set_watermark(indio_dev: *mut iio_dev, val: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_reset(data: *mut fxls8962af_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __fxls8962af_fifo_set_mode(data: *mut fxls8962af_data, onoff: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
    static int fxls8962af_buffer_preenable(struct iio_dev *indio_dev)
    {
    return fxls8962af_power_on(iio_priv(indio_dev));
    }
#[no_mangle]
unsafe extern "C" fn fxls8962af_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
    ...
    {
    struct device *dev = regmap_get_device(data.regmap);
    let mut sample_length: c_int = 3 * sizeof(*buffer);
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_fifo_flush(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_event_interrupt(indio_dev: *mut iio_dev) -> c_int {
    static int fxls8962af_event_interrupt(struct iio_dev *indio_dev)
    {
    struct fxls8962af_data *data = iio_priv(indio_dev);
    let mut ts: i64 = iio_get_time_ns(indio_dev);
    unsigned int reg;
    u64 ev_code;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_interrupt(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_pm_disable(dev_ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_irq_setup(indio_dev: *mut iio_dev, irq: c_int) -> c_int {
    ...
    irq,
    core::ptr::null_mut(), fxls8962af_interrupt,
    irq_type | IRQF_ONESHOT,
    indio_dev.name, indio_dev);
    }
#[no_mangle]
pub unsafe extern "C" fn fxls8962af_core_probe(dev: *mut device, regmap: *mut regmap, irq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxls8962af_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(fxls8962af_runtime_suspend, fxls8962af_runtime_resume, core::ptr::null_mut())
    };
