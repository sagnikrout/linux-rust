...
//! Source: drivers/iio/accel/st_accel_core.c
#![no_std]
...
pub const ST_ACCEL_NUMBER_DATA_CHANNELS: c_int = 3;
// DEFAULT VALUE FOR SENSORS
pub const ST_ACCEL_DEFAULT_OUT_X_L_ADDR: c_uint = 0x28;
pub const ST_ACCEL_DEFAULT_OUT_Y_L_ADDR: c_uint = 0x2a;
pub const ST_ACCEL_DEFAULT_OUT_Z_L_ADDR: c_uint = 0x2c;
// FULLSCALE
pub const ST_ACCEL_FS_AVL_2G: c_int = 2;
pub const ST_ACCEL_FS_AVL_4G: c_int = 4;
pub const ST_ACCEL_FS_AVL_6G: c_int = 6;
pub const ST_ACCEL_FS_AVL_8G: c_int = 8;
pub const ST_ACCEL_FS_AVL_16G: c_int = 16;
pub const ST_ACCEL_FS_AVL_100G: c_int = 100;
pub const ST_ACCEL_FS_AVL_200G: c_int = 200;
pub const ST_ACCEL_FS_AVL_400G: c_int = 400;
...
//
#[no_mangle]
unsafe extern "C" fn apply_acpi_orientation(indio_dev: *mut iio_dev) -> c_int {
...
// Read _ONT data, which should be a package of 6 integers.
    status = acpi_evaluate_object(adev.handle, "_ONT", core::ptr::null_mut(), &buffer);
...
// Convert our integer matrix to a string-based iio_mount_matrix
    for (i = 0; i < 3; i++) {
    for (j = 0; j < 3; j++) {
    let mut matrix_val: c_int = final_ont[i][j];
    char *str_value;
    switch (matrix_val) {
    case -1:
    str_value = "-1";
...
#[no_mangle]
pub unsafe extern "C" fn st_accel_common_probe(indio_dev: *mut iio_dev) -> c_int {
