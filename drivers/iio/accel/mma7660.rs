...
//! Source: drivers/iio/accel/mma7660.c
#![no_std]
...
pub const MMA7660_REG_XOUT: c_uint = 0x00;
pub const MMA7660_REG_YOUT: c_uint = 0x01;
pub const MMA7660_REG_ZOUT: c_uint = 0x02;

pub const MMA7660_REG_MODE: c_uint = 0x07;

pub const MMA7660_I2C_READ_RETRIES: c_int = 5;
//
...
//
    ...
    let mut mma7660_nscale: static int = 467142857;
    enum mma7660_mode {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mma7660_data {
    pub client: *mut i2c_client,
    pub lock: mutex,
    pub mode: enum mma7660_mode,
...
#[no_mangle]
unsafe extern "C" fn mma7660_read_accel(data: *mut mma7660_data, address: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma7660_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma7660_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn mma7660_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma7660_resume(dev: *mut device) -> c_int {
