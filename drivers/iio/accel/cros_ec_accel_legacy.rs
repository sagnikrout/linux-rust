...
//! Source: drivers/iio/accel/cros_ec_accel_legacy.c
#![no_std]
...
pub const CROS_EC_SENSOR_LEGACY_NUM: c_int = 2;
//
// Sensor scale hard coded at 10 bits per g, computed as:
// g / (2^10 - 1) = 0.009586168; with g = 9.80665 m.s^-2
//
pub const ACCEL_LEGACY_NSCALE: c_int = 9586168;
//
...
#[no_mangle]
unsafe extern "C" fn cros_ec_accel_legacy_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (state.ec.cmd_readmem != core::ptr::null_mut())
