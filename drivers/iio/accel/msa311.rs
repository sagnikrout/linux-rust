...
//! Source: drivers/iio/accel/msa311.c
#![no_std]
...
pub const MSA311_SOFT_RESET_REG: c_uint = 0x00;
pub const MSA311_PARTID_REG: c_uint = 0x01;
pub const MSA311_ACC_X_REG: c_uint = 0x02;
pub const MSA311_ACC_Y_REG: c_uint = 0x04;
pub const MSA311_ACC_Z_REG: c_uint = 0x06;
pub const MSA311_MOTION_INT_REG: c_uint = 0x09;
pub const MSA311_DATA_INT_REG: c_uint = 0x0A;
pub const MSA311_TAP_ACTIVE_STS_REG: c_uint = 0x0B;
pub const MSA311_ORIENT_STS_REG: c_uint = 0x0C;
pub const MSA311_RANGE_REG: c_uint = 0x0F;
pub const MSA311_ODR_REG: c_uint = 0x10;
pub const MSA311_PWR_MODE_REG: c_uint = 0x11;
pub const MSA311_SWAP_POLARITY_REG: c_uint = 0x12;
pub const MSA311_INT_SET_0_REG: c_uint = 0x16;
pub const MSA311_INT_SET_1_REG: c_uint = 0x17;
pub const MSA311_INT_MAP_0_REG: c_uint = 0x19;
pub const MSA311_INT_MAP_1_REG: c_uint = 0x1A;
pub const MSA311_INT_CONFIG_REG: c_uint = 0x20;
pub const MSA311_INT_LATCH_REG: c_uint = 0x21;
pub const MSA311_FREEFALL_DUR_REG: c_uint = 0x22;
pub const MSA311_FREEFALL_TH_REG: c_uint = 0x23;
pub const MSA311_FREEFALL_HY_REG: c_uint = 0x24;
pub const MSA311_ACTIVE_DUR_REG: c_uint = 0x27;
pub const MSA311_ACTIVE_TH_REG: c_uint = 0x28;
pub const MSA311_TAP_DUR_REG: c_uint = 0x2A;
pub const MSA311_TAP_TH_REG: c_uint = 0x2B;
pub const MSA311_ORIENT_HY_REG: c_uint = 0x2C;
pub const MSA311_Z_BLOCK_REG: c_uint = 0x2D;
pub const MSA311_OFFSET_X_REG: c_uint = 0x38;
pub const MSA311_OFFSET_Y_REG: c_uint = 0x39;
pub const MSA311_OFFSET_Z_REG: c_uint = 0x3A;
    enum msa311_fields {
// Soft_Reset
...
pub const MSA311_WHO_AM_I: c_uint = 0x13;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iio_decimal_fract {
    pub integral: c_int,
    pub microfract: c_int,
}
...
// Autosuspend delay
pub const MSA311_PWR_SLEEP_DELAY_MS: c_int = 2000;
...
//
#[no_mangle]
unsafe extern "C" fn msa311_get_odr(msa311: *mut msa311_priv, odr: *mut c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn msa311_set_odr(msa311: *mut msa311_priv, odr: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn msa311_wait_for_next_data(msa311: *mut msa311_priv) -> c_int {
    static int msa311_wait_for_next_data(struct msa311_priv *msa311)
    {
    let mut unintr_thresh_ms: static unsigned int = 20;
    struct device *dev = msa311.dev;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: msleep_interruptible(wait_ms)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn msa311_set_pwr_mode(msa311: *mut msa311_priv, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msa311_read_scale(indio_dev: *mut iio_dev, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msa311_write_scale(indio_dev: *mut iio_dev, val: c_int, val2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msa311_write_samp_freq(indio_dev: *mut iio_dev, val: c_int, val2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msa311_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msa311_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msa311_set_new_data_trig_state(trig: *mut iio_trigger, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msa311_buffer_thread(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn msa311_irq_thread(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn msa311_check_partid(msa311: *mut msa311_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msa311_soft_reset(msa311: *mut msa311_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msa311_chip_init(msa311: *mut msa311_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msa311_setup_interrupts(msa311: *mut msa311_priv) -> c_int {
...
// Keep going without interrupts if no initialized I2C IRQ
    if (i2c.irq <= 0)
    return 0;
    err = devm_request_threaded_irq(&i2c.dev, i2c.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn msa311_regmap_init(msa311: *mut msa311_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msa311_powerdown(msa311: *mut c_void) {
    static void msa311_powerdown(void *msa311)
    {
    msa311_set_pwr_mode(msa311, MSA311_PWR_MODE_SUSPEND);
    }
#[no_mangle]
unsafe extern "C" fn msa311_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msa311_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msa311_runtime_resume(dev: *mut device) -> c_int {
    ...
    msa311_runtime_resume, core::ptr::null_mut());
