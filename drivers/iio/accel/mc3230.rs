...
//! Source: drivers/iio/accel/mc3230.c
#![no_std]
...
pub const MC3230_REG_XOUT: c_uint = 0x00;
pub const MC3230_REG_YOUT: c_uint = 0x01;
pub const MC3230_REG_ZOUT: c_uint = 0x02;
pub const MC3230_REG_MODE: c_uint = 0x07;
pub const MC3230_MODE_OPCON_MASK: c_uint = 0x03;
pub const MC3230_MODE_OPCON_WAKE: c_uint = 0x01;
pub const MC3230_MODE_OPCON_STANDBY: c_uint = 0x03;
pub const MC3230_REG_CHIP_ID: c_uint = 0x18;
pub const MC3230_REG_PRODUCT_CODE: c_uint = 0x3b;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mc3230_data {
    pub chip_info: *const mc3230_chip_info,
...
#[no_mangle]
unsafe extern "C" fn mc3230_set_opcon(data: *mut mc3230_data, opcon: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc3230_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc3230_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn mc3230_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc3230_resume(dev: *mut device) -> c_int {
