...
//! Source: drivers/iio/accel/mma9551.c
#![no_std]
...
pub const MMA9551_GPIO_COUNT: c_int = 4;
// Tilt application (inclination in IIO terms).
pub const MMA9551_TILT_XZ_ANG_REG: c_uint = 0x00;
pub const MMA9551_TILT_YZ_ANG_REG: c_uint = 0x01;
pub const MMA9551_TILT_XY_ANG_REG: c_uint = 0x02;

pub const MMA9551_TILT_QUAD_REG: c_uint = 0x03;
pub const MMA9551_TILT_XY_QUAD_SHIFT: c_int = 0;
pub const MMA9551_TILT_YZ_QUAD_SHIFT: c_int = 2;
pub const MMA9551_TILT_XZ_QUAD_SHIFT: c_int = 4;
pub const MMA9551_TILT_CFG_REG: c_uint = 0x01;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mma9551_data {
    pub client: *mut i2c_client,
    pub mutex: mutex,
    pub event_enabled: [bool; 3],
    pub irqs: [c_int; MMA9551_GPIO_COUNT],
}
...
#[no_mangle]
unsafe extern "C" fn mma9551_event_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mma9551_init(data: *mut mma9551_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma9551_gpio_probe(indio_dev: *mut iio_dev) -> c_int {
    ...
    gpio = devm_gpiod_get_index(dev, core::ptr::null_mut(), i, GPIOD_IN);
    if (IS_ERR(gpio)) {
    ...
    core::ptr::null_mut(), mma9551_event_handler,
...
#[no_mangle]
unsafe extern "C" fn mma9551_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma9551_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn mma9551_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma9551_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma9551_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma9551_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(mma9551_runtime_suspend, mma9551_runtime_resume, core::ptr::null_mut())
    };
