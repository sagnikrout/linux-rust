...
//! Source: drivers/iio/accel/sca3000.c
#![no_std]
...
pub const SCA3000_REG_REVID_ADDR: c_uint = 0x00;

pub const SCA3000_REG_STATUS_ADDR: c_uint = 0x02;

// All reads done using register decrement so no need to directly access LSBs
pub const SCA3000_REG_X_MSB_ADDR: c_uint = 0x05;
pub const SCA3000_REG_Y_MSB_ADDR: c_uint = 0x07;
pub const SCA3000_REG_Z_MSB_ADDR: c_uint = 0x09;
pub const SCA3000_REG_RING_OUT_ADDR: c_uint = 0x0f;
// Temp read untested - the e05 doesn't have the sensor
pub const SCA3000_REG_TEMP_MSB_ADDR: c_uint = 0x13;
pub const SCA3000_REG_MODE_ADDR: c_uint = 0x14;
pub const SCA3000_MODE_PROT_MASK: c_uint = 0x28;
...
pub const SCA3000_REG_MODE_MEAS_MODE_NORMAL: c_uint = 0x00;
pub const SCA3000_REG_MODE_MEAS_MODE_OP_1: c_uint = 0x01;
pub const SCA3000_REG_MODE_MEAS_MODE_OP_2: c_uint = 0x02;
//
// In motion detection mode the accelerations are band pass filtered
// (approx 1 - 25Hz) and then a programmable threshold used to trigger
// and interrupt.
//
pub const SCA3000_REG_MODE_MEAS_MODE_MOT_DET: c_uint = 0x03;
pub const SCA3000_REG_MODE_MODE_MASK: c_uint = 0x03;
pub const SCA3000_REG_BUF_COUNT_ADDR: c_uint = 0x15;
pub const SCA3000_REG_INT_STATUS_ADDR: c_uint = 0x16;

// Used to allow access to multiplexed registers
pub const SCA3000_REG_CTRL_SEL_ADDR: c_uint = 0x18;
// Only available for SCA3000-D03 and SCA3000-D01
pub const SCA3000_REG_CTRL_SEL_I2C_DISABLE: c_uint = 0x01;
pub const SCA3000_REG_CTRL_SEL_MD_CTRL: c_uint = 0x02;
pub const SCA3000_REG_CTRL_SEL_MD_Y_TH: c_uint = 0x03;
pub const SCA3000_REG_CTRL_SEL_MD_X_TH: c_uint = 0x04;
pub const SCA3000_REG_CTRL_SEL_MD_Z_TH: c_uint = 0x05;
//
// BE VERY CAREFUL WITH THIS, IF 3 BITS ARE NOT SET the device
// will not function
//
pub const SCA3000_REG_CTRL_SEL_OUT_CTRL: c_uint = 0x0B;
pub const SCA3000_REG_OUT_CTRL_PROT_MASK: c_uint = 0xE0;
pub const SCA3000_REG_OUT_CTRL_BUF_X_EN: c_uint = 0x10;
pub const SCA3000_REG_OUT_CTRL_BUF_Y_EN: c_uint = 0x08;
pub const SCA3000_REG_OUT_CTRL_BUF_Z_EN: c_uint = 0x04;
pub const SCA3000_REG_OUT_CTRL_BUF_DIV_MASK: c_uint = 0x03;
pub const SCA3000_REG_OUT_CTRL_BUF_DIV_4: c_uint = 0x02;
pub const SCA3000_REG_OUT_CTRL_BUF_DIV_2: c_uint = 0x01;
//
// Control which motion detector interrupts are on.
// For now only OR combinations are supported.
//
pub const SCA3000_MD_CTRL_PROT_MASK: c_uint = 0xC0;
...
//
pub const SCA3000_REG_UNLOCK_ADDR: c_uint = 0x1e;
pub const SCA3000_REG_INT_MASK_ADDR: c_uint = 0x21;
pub const SCA3000_REG_INT_MASK_PROT_MASK: c_uint = 0x1C;

pub const SCA3000_REG_INT_MASK_ALL_INTS: c_uint = 0x02;
pub const SCA3000_REG_INT_MASK_ACTIVE_HIGH: c_uint = 0x01;
pub const SCA3000_REG_INT_MASK_ACTIVE_LOW: c_uint = 0x00;
// Values of multiplexed registers (write to ctrl_data after select)
pub const SCA3000_REG_CTRL_DATA_ADDR: c_uint = 0x22;
//
...
//
pub const SCA3000_OP_MODE_BYPASS: c_uint = 0x01;
pub const SCA3000_OP_MODE_NARROW: c_uint = 0x02;
pub const SCA3000_OP_MODE_WIDE: c_uint = 0x04;
pub const SCA3000_MAX_TX: c_int = 6;
pub const SCA3000_MAX_RX: c_int = 2;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sca3000_state {
    pub us: *mut spi_device,
    pub info: *const sca3000_chip_info,
    pub mo_det_use_count: c_int,
    pub lock: mutex,
// Can these share a cacheline ?
    pub __aligned(IIO_DMA_MINALIGN): u8 rx[384],
    pub __aligned(IIO_DMA_MINALIGN): u8 tx[6],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sca3000_chip_info {
    pub name: *const c_char,
    pub scale: c_uint,
    pub temp_output: bool,
    pub measurement_mode_freq: c_int,
    pub measurement_mode_3db_freq: c_int,
    pub option_mode_1: c_int,
    pub option_mode_1_freq: c_int,
    pub option_mode_1_3db_freq: c_int,
    pub option_mode_2: c_int,
    pub option_mode_2_freq: c_int,
    pub option_mode_2_3db_freq: c_int,
    pub mot_det_mult_xz: [c_int; 6],
    pub mot_det_mult_y: [c_int; 7],
}
...
#[no_mangle]
unsafe extern "C" fn sca3000_write_reg(st: *mut sca3000_state, address: u8, val: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sca3000_reg_lock_on(st: *mut sca3000_state) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __sca3000_unlock_reg_lock(st: *mut sca3000_state) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sca3000_print_rev(indio_dev: *mut iio_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sca3000_read_raw_samp_freq(st: *mut sca3000_state, val: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sca3000_write_raw_samp_freq(st: *mut sca3000_state, val: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(base_freq: val !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn sca3000_read_3db_freq(st: *mut sca3000_state, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sca3000_write_3db_freq(st: *mut sca3000_state, val: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sca3000_ring_int_process(val: u8, indio_dev: *mut iio_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn sca3000_event_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
    static irqreturn_t sca3000_event_handler(int irq, void *private)
    {
    struct iio_dev *indio_dev = private;
    struct sca3000_state *st = iio_priv(indio_dev);
    int ret, val;
    let mut last_timestamp: i64 = iio_get_time_ns(indio_dev);
//
...
#[no_mangle]
unsafe extern "C" fn sca3000_freefall_set_state(indio_dev: *mut iio_dev, state: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(SCA3000_REG_MODE_FREE_FALL_DETECT): !state && (st->rx[0] &) -> else {
...
//
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn __sca3000_hw_ring_state_set(indio_dev: *mut iio_dev, state: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sca3000_hw_ring_preenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sca3000_hw_ring_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sca3000_clean_setup(st: *mut sca3000_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sca3000_stop_all_interrupts(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sca3000_probe(spi: *mut spi_device) -> c_int {
