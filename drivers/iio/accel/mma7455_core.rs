...
//! Source: drivers/iio/accel/mma7455_core.c
#![no_std]
...
pub const MMA7455_REG_XOUTL: c_uint = 0x00;
pub const MMA7455_REG_XOUTH: c_uint = 0x01;
pub const MMA7455_REG_YOUTL: c_uint = 0x02;
pub const MMA7455_REG_YOUTH: c_uint = 0x03;
pub const MMA7455_REG_ZOUTL: c_uint = 0x04;
pub const MMA7455_REG_ZOUTH: c_uint = 0x05;
pub const MMA7455_REG_STATUS: c_uint = 0x09;

pub const MMA7455_REG_WHOAMI: c_uint = 0x0f;
pub const MMA7455_WHOAMI_ID: c_uint = 0x55;
pub const MMA7455_REG_MCTL: c_uint = 0x16;
pub const MMA7455_MCTL_MODE_STANDBY: c_uint = 0x00;
pub const MMA7455_MCTL_MODE_MEASURE: c_uint = 0x01;
pub const MMA7455_REG_CTL1: c_uint = 0x18;

pub const MMA7455_CTL1_DFBW_62_5HZ: c_int = 0;
pub const MMA7455_REG_TW: c_uint = 0x1e;
//
...
//
pub const MMA7455_10BIT_SCALE: c_int = 153229;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mma7455_data {
...
#[no_mangle]
unsafe extern "C" fn mma7455_drdy(mma7455: *mut mma7455_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mma7455_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: val == 125 && val2 ==) -> else {
...
// In 10-bit mode there is only one scale available
    ...
    mma7455_trigger_handler, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
pub unsafe extern "C" fn mma7455_core_remove(dev: *mut device) {
