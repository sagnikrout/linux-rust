...
//! Source: drivers/iio/resolver/ad2s1200.c
#![no_std]
...
pub const AD2S1200_HZ: c_int = 8192000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad2s1200_state {
    pub lock: mutex,
    pub sdev: *mut spi_device,
    pub sample: *mut gpio_desc,
    pub rdvel: *mut gpio_desc,
    pub __aligned(IIO_DMA_MINALIGN): __be16 rx,
}
...
#[no_mangle]
unsafe extern "C" fn ad2s1200_probe(spi: *mut spi_device) -> c_int {
