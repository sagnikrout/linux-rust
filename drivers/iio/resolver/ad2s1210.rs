...
//! Source: drivers/iio/resolver/ad2s1210.c
#![no_std]
...
pub const AD2S1210_REG_POSITION_MSB: c_uint = 0x80;
pub const AD2S1210_REG_POSITION_LSB: c_uint = 0x81;
pub const AD2S1210_REG_VELOCITY_MSB: c_uint = 0x82;
pub const AD2S1210_REG_VELOCITY_LSB: c_uint = 0x83;
pub const AD2S1210_REG_LOS_THRD: c_uint = 0x88;
pub const AD2S1210_REG_DOS_OVR_THRD: c_uint = 0x89;
pub const AD2S1210_REG_DOS_MIS_THRD: c_uint = 0x8A;
pub const AD2S1210_REG_DOS_RST_MAX_THRD: c_uint = 0x8B;
pub const AD2S1210_REG_DOS_RST_MIN_THRD: c_uint = 0x8C;
pub const AD2S1210_REG_LOT_HIGH_THRD: c_uint = 0x8D;
pub const AD2S1210_REG_LOT_LOW_THRD: c_uint = 0x8E;
pub const AD2S1210_REG_EXCIT_FREQ: c_uint = 0x91;
pub const AD2S1210_REG_CONTROL: c_uint = 0x92;
pub const AD2S1210_REG_SOFT_RESET: c_uint = 0xF0;
pub const AD2S1210_REG_FAULT: c_uint = 0xFF;
pub const AD2S1210_MIN_CLKIN: c_int = 6144000;
pub const AD2S1210_MAX_CLKIN: c_int = 10240000;
pub const AD2S1210_MIN_EXCIT: c_int = 2000;
pub const AD2S1210_DEF_EXCIT: c_int = 10000;
pub const AD2S1210_MAX_EXCIT: c_int = 20000;
pub const AD2S1210_MIN_FCW: c_uint = 0x4;
pub const AD2S1210_MAX_FCW: c_uint = 0x50;
// 44 degrees ~= 0.767945 radians
pub const PHASE_44_DEG_TO_RAD_INT: c_int = 0;
pub const PHASE_44_DEG_TO_RAD_MICRO: c_int = 767945;
// 360 degrees ~= 6.283185 radians
pub const PHASE_360_DEG_TO_RAD_INT: c_int = 6;
pub const PHASE_360_DEG_TO_RAD_MICRO: c_int = 283185;
// Threshold voltage registers have 1 LSB == 38 mV
pub const THRESHOLD_MILLIVOLT_PER_LSB: c_int = 38;
...
#[no_mangle]
unsafe extern "C" fn ad2s1210_set_mode(st: *mut ad2s1210_state, mode: enum ad2s1210_mode) -> c_int {
    static int ad2s1210_set_mode(struct ad2s1210_state *st, enum ad2s1210_mode mode)
    {
    struct gpio_descs *gpios = st.mode_gpios;
    DECLARE_BITMAP(bitmap, 2) = { };
    if (!gpios)
    let mut mode: return = = st.fixed_mode ? 0 : -EOPNOTSUPP;
...
//
#[no_mangle]
unsafe extern "C" fn ad2s1210_toggle_sample_line(st: *mut ad2s1210_state) {
...
#[no_mangle]
unsafe extern "C" fn ad2s1210_get_hysteresis(st: *mut ad2s1210_state, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad2s1210_set_hysteresis(st: *mut ad2s1210_state, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad2s1210_get_excitation_frequency(st: *mut ad2s1210_state, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad2s1210_set_excitation_frequency(st: *mut ad2s1210_state, val: c_int) -> c_int {
...
// cosine input
    ...
    {
    struct ad2s1210_state *st = iio_priv(dev_to_iio_dev(dev));
    let mut step: c_int = ad2s1210_lot_threshold_urad_per_lsb[st.resolution];
...
#[no_mangle]
unsafe extern "C" fn ad2s1210_initial(st: *mut ad2s1210_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad2s1210_scan_to_buffers(indio_dev: *mut iio_dev, timestamp: i64) {
...
#[no_mangle]
unsafe extern "C" fn ad2s1210_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad2s1210_setup_properties(st: *mut ad2s1210_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad2s1210_setup_clocks(st: *mut ad2s1210_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad2s1210_setup_gpios(st: *mut ad2s1210_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad2s1210_setup_regmap(st: *mut ad2s1210_state) -> c_int {
    ...
    st.regmap = devm_regmap_init(dev, core::ptr::null_mut(), st, &config);
    if (IS_ERR(st.regmap))
...
#[no_mangle]
unsafe extern "C" fn ad2s1210_probe(spi: *mut spi_device) -> c_int {
    ...
    &ad2s1210_trigger_handler, core::ptr::null_mut());
    if (ret < 0)
