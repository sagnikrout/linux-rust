...
//! Source: drivers/iio/industrialio-core.c
#![no_std]
...
pub const IIO_DEV_MAX: c_int = 256;
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_device_id(indio_dev: *mut iio_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_buffer_enabled(indio_dev: *mut iio_dev) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_device_set_clock(indio_dev: *mut iio_dev, clock_id: clockid_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_device_get_clock(indio_dev: *const iio_dev) -> clockid_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_get_time_ns(indio_dev: *const iio_dev) -> i64 {
...
#[no_mangle]
unsafe extern "C" fn iio_init() -> int __init {
...
// Register sysfs bus
    ...
    iio_debugfs_dentry = debugfs_create_dir("iio", core::ptr::null_mut());
    return 0;
...
#[no_mangle]
unsafe extern "C" fn iio_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn iio_device_unregister_debugfs(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn iio_device_register_debugfs(indio_dev: *mut iio_dev) {
    static void iio_device_register_debugfs(struct iio_dev *indio_dev)
    {
    struct iio_dev_opaque *iio_dev_opaque;
    if (indio_dev.info.debugfs_reg_access == core::ptr::null_mut())
    return;
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_read_mount_matrix(dev: *mut device, matrix: *mut iio_mount_matrix) -> c_int {
    int iio_read_mount_matrix(struct device *dev, struct iio_mount_matrix *matrix)
    {
    let mut len: usize = ARRAY_SIZE(iio_mount_idmatrix.rotation);
    int err;
...
// Matrix was not declared at all: fallback to identity.
    ...
    {
    let mut scale: c_int = type - IIO_VAL_DECIMAL64_BASE;
    s64 frac;
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_format_value(buf: *mut c_char, type: c_uint, size: c_int, vals: *mut c_int) -> isize {
    ...
    this_attr.address);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: indio_dev->info->read_raw) -> else {
...
#[no_mangle]
unsafe extern "C" fn iio_format_avail_range(buf: *mut c_char, vals: *const c_int, type: c_int) -> isize {
...
//
    ...
    {
    let mut i: c_int = 0, f = 0;
    let mut integer_part: bool = true, negative = false;
    if (fract_mult == 0) {
// fract = 0;
...
// Build up postfix of <extend_name>_<modifier>_postfix
    ...
    if (chan.extend_name == core::ptr::null_mut() || shared_by != IIO_SEPARATE)
    ...
    if (full_postfix == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn __iio_device_attr_deinit(dev_attr: *mut device_attribute) {
    ...
    chan,
    ext_info.read ?
    &iio_read_channel_ext_info : core::ptr::null_mut(),
    ext_info.write ?
    &iio_write_channel_ext_info : core::ptr::null_mut(),
    i,
    ext_info.shared,
    &indio_dev.dev,
    core::ptr::null_mut(),
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_free_chan_devattr_list(attr_list: *mut list_head) {
    ...
    let mut clk: clockid_t = iio_device_get_clock(indio_dev);
    switch (clk) {
    case CLOCK_REALTIME:
    case CLOCK_MONOTONIC:
    case CLOCK_MONOTONIC_RAW:
    ...
    let mut cnt: c_uint = iio_dev_opaque.groupcounter;
    new = krealloc_array(old, cnt + 2, sizeof(*new), GFP_KERNEL);
    if (!new)
    return -ENOMEM;
    new[iio_dev_opaque.groupcounter++] = group;
    new[iio_dev_opaque.groupcounter] = core::ptr::null_mut();
    iio_dev_opaque.groups = new;
    return 0;
    }
    static DEVICE_ATTR_RW(current_timestamp_clock);
#[no_mangle]
unsafe extern "C" fn iio_device_register_sysfs(indio_dev: *mut iio_dev) -> c_int {
    static int iio_device_register_sysfs(struct iio_dev *indio_dev)
    {
    struct iio_dev_opaque *iio_dev_opaque = to_iio_dev_opaque(indio_dev);
    int i, ret = 0, attrcount, attrn, attrcount_orig = 0;
    struct iio_dev_attr *p;
    struct attribute **attr, *clk = core::ptr::null_mut();
// First count elements in any existing group
    if (indio_dev.info.attrs) {
    attr = indio_dev.info.attrs.attrs;
    while (*attr++ != core::ptr::null_mut())
    attrcount_orig++;
    }
...
//
    ...
    attrcount + 1);
    if (iio_dev_opaque.chan_attr_group.attrs == core::ptr::null_mut()) {
    ret = -ENOMEM;
    goto error_clear_attrs;
    }
...
// Add all elements from the list.
    ...
    iio_dev_opaque.chan_attr_group.attrs = core::ptr::null_mut();
    error_clear_attrs:
    iio_free_chan_devattr_list(&iio_dev_opaque.channel_attr_list);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn iio_device_unregister_sysfs(indio_dev: *mut iio_dev) {
    ...
    iio_dev_opaque.groups = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn iio_dev_release(device: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_device_free(dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn devm_iio_device_release(iio_dev: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn iio_chrdev_open(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iio_chrdev_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_device_ioctl_handler_unregister(h: *mut iio_ioctl_handler) {
    void iio_device_ioctl_handler_unregister(struct iio_ioctl_handler *h)
    {
    list_del(&h.entry);
    }
#[no_mangle]
unsafe extern "C" fn iio_ioctl(filp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn iio_check_unique_scan_index(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_check_extended_name(indio_dev: *const iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_sanity_check_avail_scan_masks(indio_dev: *mut iio_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_active_scan_mask_index(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __iio_device_register(indio_dev: *mut iio_dev, this_mod: *mut module) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: indio_dev->dev.parent) -> else {
    ...
    if ((indio_dev.modes & INDIO_ALL_BUFFER_MODES) &&
    indio_dev.setup_ops == core::ptr::null_mut())
    indio_dev.setup_ops = &noop_ring_setup_ops;
    if (iio_dev_opaque.attached_buffers_cnt)
    cdev_init(&iio_dev_opaque.chrdev, &iio_buffer_fileops);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: iio_dev_opaque->event_interface) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_device_unregister(indio_dev: *mut iio_dev) {
    ...
    indio_dev.info = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn devm_iio_device_unreg(indio_dev: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __iio_dev_mode_lock(indio_dev: *mut iio_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __iio_dev_mode_unlock(indio_dev: *mut iio_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_device_get_current_mode(indio_dev: *mut iio_dev) -> c_int {
