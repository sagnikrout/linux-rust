...
//! Source: drivers/iio/dummy/iio_simple_dummy_events.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn iio_simple_dummy_get_timestamp(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn iio_simple_dummy_event_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_simple_dummy_events_register(indio_dev: *mut iio_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_simple_dummy_events_unregister(indio_dev: *mut iio_dev) {
