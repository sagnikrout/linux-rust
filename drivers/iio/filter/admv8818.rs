...
//! Source: drivers/iio/filter/admv8818.c
#![no_std]
...
pub const ADMV8818_REG_SPI_CONFIG_A: c_uint = 0x0;
pub const ADMV8818_REG_SPI_CONFIG_B: c_uint = 0x1;
pub const ADMV8818_REG_CHIPTYPE: c_uint = 0x3;
pub const ADMV8818_REG_PRODUCT_ID_L: c_uint = 0x4;
pub const ADMV8818_REG_PRODUCT_ID_H: c_uint = 0x5;
pub const ADMV8818_REG_FAST_LATCH_POINTER: c_uint = 0x10;
pub const ADMV8818_REG_FAST_LATCH_STOP: c_uint = 0x11;
pub const ADMV8818_REG_FAST_LATCH_START: c_uint = 0x12;
pub const ADMV8818_REG_FAST_LATCH_DIRECTION: c_uint = 0x13;
pub const ADMV8818_REG_FAST_LATCH_STATE: c_uint = 0x14;
pub const ADMV8818_REG_WR0_SW: c_uint = 0x20;
pub const ADMV8818_REG_WR0_FILTER: c_uint = 0x21;
pub const ADMV8818_REG_WR1_SW: c_uint = 0x22;
pub const ADMV8818_REG_WR1_FILTER: c_uint = 0x23;
pub const ADMV8818_REG_WR2_SW: c_uint = 0x24;
pub const ADMV8818_REG_WR2_FILTER: c_uint = 0x25;
pub const ADMV8818_REG_WR3_SW: c_uint = 0x26;
pub const ADMV8818_REG_WR3_FILTER: c_uint = 0x27;
pub const ADMV8818_REG_WR4_SW: c_uint = 0x28;
pub const ADMV8818_REG_WR4_FILTER: c_uint = 0x29;
pub const ADMV8818_REG_LUT0_SW: c_uint = 0x100;
pub const ADMV8818_REG_LUT0_FILTER: c_uint = 0x101;
pub const ADMV8818_REG_LUT127_SW: c_uint = 0x1FE;
pub const ADMV8818_REG_LUT127_FILTER: c_uint = 0x1FF;
...
pub const ADMV8818_BAND_BYPASS: c_int = 0;
pub const ADMV8818_BAND_MIN: c_int = 1;
pub const ADMV8818_BAND_MAX: c_int = 4;
pub const ADMV8818_BAND_CORNER_LOW: c_int = 0;
pub const ADMV8818_BAND_CORNER_HIGH: c_int = 1;
pub const ADMV8818_STATE_MIN: c_int = 0;
pub const ADMV8818_STATE_MAX: c_int = 15;
pub const ADMV8818_NUM_STATES: c_int = 16;
    enum {
    ADMV8818_BW_FREQ,
...
// Protect against concurrent accesses to the device and data content
    pub lock: mutex,
    pub filter_mode: c_uint,
    pub cf_hz: u64,
    pub lpf_margin_hz: u64,
    pub hpf_margin_hz: u64,
}
...
#[no_mangle]
unsafe extern "C" fn __admv8818_hpf_select(st: *mut admv8818_state, freq: u64) -> c_int {
    static int __admv8818_hpf_select(struct admv8818_state *st, u64 freq)
    {
    int band, state, ret;
    let mut hpf_state: c_uint = ADMV8818_STATE_MIN, hpf_band = ADMV8818_BAND_BYPASS;
...
#[no_mangle]
unsafe extern "C" fn admv8818_hpf_select(st: *mut admv8818_state, freq: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __admv8818_lpf_select(st: *mut admv8818_state, freq: u64) -> c_int {
    static int __admv8818_lpf_select(struct admv8818_state *st, u64 freq)
    {
    int band, state, ret;
    let mut lpf_state: c_uint = ADMV8818_STATE_MIN, lpf_band = ADMV8818_BAND_BYPASS;
    u64 freq_error, min_freq_error, freq_corner, freq_step;
...
#[no_mangle]
unsafe extern "C" fn admv8818_lpf_select(st: *mut admv8818_state, freq: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn admv8818_rfin_band_select(st: *mut admv8818_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __admv8818_read_hpf_freq(st: *mut admv8818_state, hpf_freq: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn admv8818_read_hpf_freq(st: *mut admv8818_state, hpf_freq: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __admv8818_read_lpf_freq(st: *mut admv8818_state, lpf_freq: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn admv8818_read_lpf_freq(st: *mut admv8818_state, lpf_freq: *mut u64) -> c_int {
    ...
    let mut freq: u64 = ((u64)val2 << 32 | (u32)val);
    if ((s64)freq < 0)
    return -EINVAL;
    switch (info) {
    case IIO_CHAN_INFO_LOW_PASS_FILTER_3DB_FREQUENCY:
...
#[no_mangle]
unsafe extern "C" fn admv8818_filter_bypass(st: *mut admv8818_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn admv8818_freq_change(nb: *mut notifier_block, action: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn admv8818_clk_notifier_unreg(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn admv8818_clk_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn admv8818_init(st: *mut admv8818_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn admv8818_clk_setup(st: *mut admv8818_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !st->clkin) -> else {
    else if (!st.clkin)
    return 0;
    ret = clk_prepare_enable(st.clkin);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn admv8818_read_properties(st: *mut admv8818_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(-EINVAL: ret ==) -> else {
    else if (ret == -EINVAL)
    st.lpf_margin_hz = 0;
    else
    return ret;
...
#[no_mangle]
unsafe extern "C" fn admv8818_probe(spi: *mut spi_device) -> c_int {
