...
//! Source: drivers/iio/industrialio-sw-device.c
#![no_std]
...
//
    ...
    unsigned int len)
    {
    struct iio_sw_device_type *d = core::ptr::null_mut(), *iter;
...
#[no_mangle]
pub unsafe extern "C" fn iio_register_sw_device_type(d: *mut iio_sw_device_type) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_unregister_sw_device_type(dt: *mut iio_sw_device_type) {
...
#[no_mangle]
pub unsafe extern "C" fn iio_sw_device_destroy(d: *mut iio_sw_device) {
...
#[no_mangle]
unsafe extern "C" fn iio_sw_device_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn iio_sw_device_exit() -> void __exit {
