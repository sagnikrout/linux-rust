...
//! Source: drivers/iio/industrialio-sw-trigger.c
#![no_std]
...
//
    ...
    unsigned int len)
    {
    struct iio_sw_trigger_type *t = core::ptr::null_mut(), *iter;
...
#[no_mangle]
pub unsafe extern "C" fn iio_register_sw_trigger_type(t: *mut iio_sw_trigger_type) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iio_unregister_sw_trigger_type(t: *mut iio_sw_trigger_type) {
...
#[no_mangle]
pub unsafe extern "C" fn iio_sw_trigger_destroy(t: *mut iio_sw_trigger) {
...
#[no_mangle]
unsafe extern "C" fn iio_sw_trigger_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn iio_sw_trigger_exit() -> void __exit {
