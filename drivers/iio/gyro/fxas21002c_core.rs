...
//! Source: drivers/iio/gyro/fxas21002c_core.c
#![no_std]
...
pub const FXAS21002C_CHIP_ID_1: c_uint = 0xD6;
pub const FXAS21002C_CHIP_ID_2: c_uint = 0xD7;
    enum fxas21002c_mode_state {
    FXAS21002C_MODE_STANDBY,
    FXAS21002C_MODE_READY,
    FXAS21002C_MODE_ACTIVE,
    };
pub const FXAS21002C_STANDBY_ACTIVE_TIME_MS: c_int = 62;
pub const FXAS21002C_READY_ACTIVE_TIME_MS: c_int = 7;
pub const FXAS21002C_ODR_LIST_MAX: c_int = 10;
pub const FXAS21002C_SCALE_FRACTIONAL: c_int = 32;
pub const FXAS21002C_RANGE_LIMIT_DOUBLE: c_int = 2000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fxas21002c_data {
    pub chip_id: u8,
    pub mode: enum fxas21002c_mode_state,
    pub prev_mode: enum fxas21002c_mode_state,
    pub /: *mut *mut mutex lock; / serialize data access,
    pub regmap: *mut regmap,
    pub regmap_fields: [*mut regmap_field; F_MAX_FIELDS],
...
//
    pub __aligned(IIO_DMA_MINALIGN): s16 buffer[8],
}
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_odr_hz_from_value(data: *mut fxas21002c_data, value: u8) -> c_int {
    static int fxas21002c_odr_hz_from_value(struct fxas21002c_data *data, u8 value)
    {
    let mut odr_value_max: c_int = ARRAY_SIZE(fxas21002c_odr_values) - 1;
    ...
    unsigned int hz)
    {
    let mut odr_table_size: c_int = ARRAY_SIZE(fxas21002c_odr_values);
    int i;
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_lpf_bw_from_value(data: *mut fxas21002c_data, value: u8) -> c_int {
    static int fxas21002c_lpf_bw_from_value(struct fxas21002c_data *data, u8 value)
    {
    let mut lpf_value_max: c_int = ARRAY_SIZE(fxas21002c_lpf_values) - 1;
    ...
    unsigned int hz)
    {
    let mut lpf_table_size: c_int = ARRAY_SIZE(fxas21002c_lpf_values);
    int i;
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_hpf_sel_from_value(data: *mut fxas21002c_data, value: u8) -> c_int {
    static int fxas21002c_hpf_sel_from_value(struct fxas21002c_data *data, u8 value)
    {
    let mut hpf_value_max: c_int = ARRAY_SIZE(fxas21002c_hpf_values) - 1;
    ...
    unsigned int hz)
    {
    let mut hpf_table_size: c_int = ARRAY_SIZE(fxas21002c_hpf_values);
    int i;
    ...
    u8 value)
    {
    let mut range_value_max: c_int = ARRAY_SIZE(fxas21002c_range_values) - 1;
...
// We need to check if FS_DOUBLE is enabled to offset the value
    ...
    unsigned int range)
    {
    let mut range_table_size: c_int = ARRAY_SIZE(fxas21002c_range_values);
    let mut found: bool = false;
    let mut fs_double: c_int = 0;
    int ret;
    int i;
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_mode_get(data: *mut fxas21002c_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_pm_get(data: *mut fxas21002c_data) -> c_int {
    static int  fxas21002c_pm_get(struct fxas21002c_data *data)
    {
    return pm_runtime_resume_and_get(regmap_get_device(data.regmap));
    }
#[no_mangle]
unsafe extern "C" fn fxas21002c_pm_put(data: *mut fxas21002c_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_temp_get(data: *mut fxas21002c_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_odr_get(data: *mut fxas21002c_data, odr: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_odr_set(data: *mut fxas21002c_data, odr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_lpf_get(data: *mut fxas21002c_data, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_lpf_set(data: *mut fxas21002c_data, bw: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_hpf_get(data: *mut fxas21002c_data, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_hpf_set(data: *mut fxas21002c_data, sel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_scale_get(data: *mut fxas21002c_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_scale_set(data: *mut fxas21002c_data, range: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_chip_init(data: *mut fxas21002c_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_data_rdy_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_data_rdy_thread(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_trigger_probe(data: *mut fxas21002c_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_power_enable(data: *mut fxas21002c_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_power_disable(data: *mut fxas21002c_data) {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_power_disable_action(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_regulators_get(data: *mut fxas21002c_data) -> c_int {
    ...
    fxas21002c_trigger_handler, core::ptr::null_mut());
    if (ret < 0)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn fxas21002c_core_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxas21002c_runtime_resume(dev: *mut device) -> c_int {
