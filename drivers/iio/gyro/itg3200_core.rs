...
//! Source: drivers/iio/gyro/itg3200_core.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn itg3200_reset(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn itg3200_enable_full_scale(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn itg3200_initial_setup(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn itg3200_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn itg3200_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn itg3200_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn itg3200_resume(dev: *mut device) -> c_int {
