...
//! Source: drivers/iio/gyro/adxrs290.c
#![no_std]
...
pub const ADXRS290_ADI_ID: c_uint = 0xAD;
pub const ADXRS290_MEMS_ID: c_uint = 0x1D;
pub const ADXRS290_DEV_ID: c_uint = 0x92;
pub const ADXRS290_REG_ADI_ID: c_uint = 0x00;
pub const ADXRS290_REG_MEMS_ID: c_uint = 0x01;
pub const ADXRS290_REG_DEV_ID: c_uint = 0x02;
pub const ADXRS290_REG_REV_ID: c_uint = 0x03;
pub const ADXRS290_REG_SN0: c_uint = 0x04 /* Serial Number Registers, 4 bytes */;
pub const ADXRS290_REG_DATAX0: c_uint = 0x08 /* Roll Rate o/p Data Regs, 2 bytes */;
pub const ADXRS290_REG_DATAY0: c_uint = 0x0A /* Pitch Rate o/p Data Regs, 2 bytes */;
pub const ADXRS290_REG_TEMP0: c_uint = 0x0C;
pub const ADXRS290_REG_POWER_CTL: c_uint = 0x10;
pub const ADXRS290_REG_FILTER: c_uint = 0x11;
pub const ADXRS290_REG_DATA_RDY: c_uint = 0x12;

pub const ADXRS290_MAX_TRANSITION_TIME_MS: c_int = 100;
    enum adxrs290_mode {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adxrs290_state {
    pub spi: *mut spi_device,
// Serialize reads and their subsequent processing
    pub lock: mutex,
    pub mode: enum adxrs290_mode,
    pub lpf_3db_freq_idx: c_uint,
    pub hpf_3db_freq_idx: c_uint,
...
#[no_mangle]
unsafe extern "C" fn adxrs290_get_rate_data(indio_dev: *mut iio_dev, cmd: u8, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxrs290_get_temp_data(indio_dev: *mut iio_dev, val: *mut c_int) -> c_int {
    static int adxrs290_get_temp_data(struct iio_dev *indio_dev, int *val)
    {
    let mut cmd: u8 = ADXRS290_READ_REG(ADXRS290_REG_TEMP0);
    struct adxrs290_state *st = iio_priv(indio_dev);
    int temp;
    guard(mutex)(&st.lock);
    temp = spi_w8r16(st.spi, cmd);
...
#[no_mangle]
unsafe extern "C" fn adxrs290_get_3db_freq(indio_dev: *mut iio_dev, val: *mut u8, val2: *mut u8) -> c_int {
    static int adxrs290_get_3db_freq(struct iio_dev *indio_dev, u8 *val, u8 *val2)
    {
    let mut cmd: u8 = ADXRS290_READ_REG(ADXRS290_REG_FILTER);
    struct adxrs290_state *st = iio_priv(indio_dev);
    short temp;
    guard(mutex)(&st.lock);
...
// val2 = FIELD_GET(ADXRS290_HPF_MASK, temp);
    ...
    buf[0] = reg;
    buf[1] = val;
    return spi_write_then_read(spi, buf, ARRAY_SIZE(buf), core::ptr::null_mut(), 0);
    }
...
#[no_mangle]
unsafe extern "C" fn adxrs290_set_mode(indio_dev: *mut iio_dev, mode: enum adxrs290_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxrs290_chip_off_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn adxrs290_initial_setup(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxrs290_reset_trig(trig: *mut iio_trigger) {
...
#[no_mangle]
unsafe extern "C" fn adxrs290_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
    static irqreturn_t adxrs290_trigger_handler(int irq, void *p)
    {
    struct iio_poll_func *pf = p;
    struct iio_dev *indio_dev = pf.indio_dev;
    struct adxrs290_state *st = iio_priv(indio_dev);
    let mut tx: u8 = ADXRS290_READ_REG(ADXRS290_REG_DATAX0);
    int ret;
    do {
    guard(mutex)(&st.lock);
...
#[no_mangle]
unsafe extern "C" fn adxrs290_probe_trigger(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adxrs290_probe(spi: *mut spi_device) -> c_int {
...
// max transition time to measurement mode
    ...
    &adxrs290_trigger_handler, core::ptr::null_mut());
    if (ret < 0)
