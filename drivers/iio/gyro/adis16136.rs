...
//! Source: drivers/iio/gyro/adis16136.c
#![no_std]
...
pub const ADIS16136_REG_FLASH_CNT: c_uint = 0x00;
pub const ADIS16136_REG_TEMP_OUT: c_uint = 0x02;
pub const ADIS16136_REG_GYRO_OUT2: c_uint = 0x04;
pub const ADIS16136_REG_GYRO_OUT: c_uint = 0x06;
pub const ADIS16136_REG_GYRO_OFF2: c_uint = 0x08;
pub const ADIS16136_REG_GYRO_OFF: c_uint = 0x0A;
pub const ADIS16136_REG_ALM_MAG1: c_uint = 0x10;
pub const ADIS16136_REG_ALM_MAG2: c_uint = 0x12;
pub const ADIS16136_REG_ALM_SAMPL1: c_uint = 0x14;
pub const ADIS16136_REG_ALM_SAMPL2: c_uint = 0x16;
pub const ADIS16136_REG_ALM_CTRL: c_uint = 0x18;
pub const ADIS16136_REG_GPIO_CTRL: c_uint = 0x1A;
pub const ADIS16136_REG_MSC_CTRL: c_uint = 0x1C;
pub const ADIS16136_REG_SMPL_PRD: c_uint = 0x1E;
pub const ADIS16136_REG_AVG_CNT: c_uint = 0x20;
pub const ADIS16136_REG_DEC_RATE: c_uint = 0x22;
pub const ADIS16136_REG_SLP_CTRL: c_uint = 0x24;
pub const ADIS16136_REG_DIAG_STAT: c_uint = 0x26;
pub const ADIS16136_REG_GLOB_CMD: c_uint = 0x28;
pub const ADIS16136_REG_LOT1: c_uint = 0x32;
pub const ADIS16136_REG_LOT2: c_uint = 0x34;
pub const ADIS16136_REG_LOT3: c_uint = 0x36;
pub const ADIS16136_REG_PROD_ID: c_uint = 0x38;
pub const ADIS16136_REG_SERIAL_NUM: c_uint = 0x3A;
pub const ADIS16136_DIAG_STAT_FLASH_UPDATE_FAIL: c_int = 2;
pub const ADIS16136_DIAG_STAT_SPI_FAIL: c_int = 3;
pub const ADIS16136_DIAG_STAT_SELF_TEST_FAIL: c_int = 5;
pub const ADIS16136_DIAG_STAT_FLASH_CHKSUM_FAIL: c_int = 6;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct adis16136_chip_info {
    pub precision: c_uint,
    pub fullscale: c_uint,
    pub adis_data: adis_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct adis16136 {
    pub chip_info: *const adis16136_chip_info,
    pub adis: adis,
}
...
#[no_mangle]
unsafe extern "C" fn adis16136_show_product_id(arg: *mut c_void, val: *mut u64) -> c_int {
...
// val = prod_id;
    ...
    adis16136_show_product_id, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn adis16136_show_flash_count(arg: *mut c_void, val: *mut u64) -> c_int {
...
// val = flash_count;
    ...
    adis16136_show_flash_count, core::ptr::null_mut(), "%lld\n");
#[no_mangle]
unsafe extern "C" fn adis16136_debugfs_init(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16136_set_freq(adis16136: *mut adis16136, freq: c_uint) -> c_int {
    ...
    t = 0xf;
#[no_mangle]
pub unsafe extern "C" fn if(0xffff: t >) -> else {
    else if (t > 0xffff)
    t = 0xffff;
    else
    t--;
...
#[no_mangle]
unsafe extern "C" fn __adis16136_get_freq(adis16136: *mut adis16136, freq: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16136_set_filter(indio_dev: *mut iio_dev, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16136_get_filter(indio_dev: *mut iio_dev, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16136_stop_device(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16136_initial_setup(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adis16136_stop(data: *mut c_void) {
    static void adis16136_stop(void *data)
    {
    adis16136_stop_device(data);
    }
#[no_mangle]
unsafe extern "C" fn adis16136_probe(spi: *mut spi_device) -> c_int {
    ...
    if (ret)
    return ret;
    ret = devm_adis_setup_buffer_and_trigger(&adis16136.adis, indio_dev, core::ptr::null_mut());
    if (ret)
    return ret;
