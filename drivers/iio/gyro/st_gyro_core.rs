...
//! Source: drivers/iio/gyro/st_gyro_core.c
#![no_std]
...
pub const ST_GYRO_NUMBER_DATA_CHANNELS: c_int = 3;
// DEFAULT VALUE FOR SENSORS
pub const ST_GYRO_DEFAULT_OUT_X_L_ADDR: c_uint = 0x28;
pub const ST_GYRO_DEFAULT_OUT_Y_L_ADDR: c_uint = 0x2a;
pub const ST_GYRO_DEFAULT_OUT_Z_L_ADDR: c_uint = 0x2c;
// FULLSCALE
pub const ST_GYRO_FS_AVL_245DPS: c_int = 245;
pub const ST_GYRO_FS_AVL_250DPS: c_int = 250;
pub const ST_GYRO_FS_AVL_500DPS: c_int = 500;
pub const ST_GYRO_FS_AVL_2000DPS: c_int = 2000;
...
#[no_mangle]
pub unsafe extern "C" fn st_gyro_common_probe(indio_dev: *mut iio_dev) -> c_int {
