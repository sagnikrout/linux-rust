...
//! Source: drivers/iio/gyro/adis16080.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adis16080_chip_info {
    pub scale_val: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adis16080_state {
    pub us: *mut spi_device,
    pub info: *const adis16080_chip_info,
    pub lock: mutex,
...
#[no_mangle]
unsafe extern "C" fn adis16080_probe(spi: *mut spi_device) -> c_int {
