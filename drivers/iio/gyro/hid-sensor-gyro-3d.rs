...
//! Source: drivers/iio/gyro/hid-sensor-gyro-3d.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gyro_3d_state {
    pub callbacks: hid_sensor_hub_callbacks,
    pub common_attributes: hid_sensor_common,
    pub gyro: [hid_sensor_hub_attribute_info; GYRO_3D_CHANNEL_MAX],
    struct {
    pub gyro_val: [u32; GYRO_3D_CHANNEL_MAX],
...
#[no_mangle]
unsafe extern "C" fn hid_gyro_3d_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_gyro_3d_remove(pdev: *mut platform_device) {
