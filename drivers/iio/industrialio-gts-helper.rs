...
//! Source: drivers/iio/industrialio-gts-helper.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn iio_gts_get_gain(max: u64, scale: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iio_gts_purge_avail_scale_table(gts: *mut iio_gts) {
    ...
    gts.per_time_avail_scale_tables = core::ptr::null_mut();
    }
    kfree(gts.avail_all_scales_table);
    gts.avail_all_scales_table = core::ptr::null_mut();
    gts.num_avail_all_scales = 0;
    }
#[no_mangle]
unsafe extern "C" fn scale_eq(sc1: *mut c_int, sc2: *mut c_int) -> c_int {
    static int scale_eq(int *sc1, int *sc2)
    {
    return sc1[0] == sc2[0] && sc1[1] == sc2[1];
    }
#[no_mangle]
unsafe extern "C" fn scale_smaller(sc1: *mut c_int, sc2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_gts_free_int_table_array(arr: *mut c_int, num_tables: c_int) {
...
#[no_mangle]
unsafe extern "C" fn iio_gts_alloc_int_table_array(arr: *mut c_int, num_tables: c_int, num_table_items: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_gts_gain_cmp(a: *const c_void, b: *const c_void) -> c_int {
    static int iio_gts_gain_cmp(const void *a, const void *b)
    {
    return *(int *)a - *(int *)b;
    }
#[no_mangle]
unsafe extern "C" fn fill_and_sort_scaletables(gts: *mut iio_gts, gains: *mut c_int, scales: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn compute_per_time_gains(gts: *mut iio_gts, gains: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn compute_per_time_tables(gts: *mut iio_gts, scales: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iio_gts_build_avail_scale_table(gts: *mut iio_gts) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iio_gts_build_avail_time_table(gts: *mut iio_gts) -> c_int {
...
// Sort times from all tables to one and remove duplicates
    ...
    let mut new: c_int = gts.itime_table[i].time_us;
...
//
#[no_mangle]
unsafe extern "C" fn iio_gts_build_avail_tables(gts: *mut iio_gts) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iio_gts_purge_avail_tables(gts: *mut iio_gts) {
...
#[no_mangle]
unsafe extern "C" fn devm_iio_gts_avail_all_drop(res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sanity_check_time(t: *const iio_itime_sel_mul) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sanity_check_gain(g: *const iio_gain_sel_pair) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_gts_sanity_check(gts: *mut iio_gts) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_gts_find_sel_by_gain(gts: *mut iio_gts, gain: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_gts_find_gain_by_sel(gts: *mut iio_gts, sel: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_gts_get_min_gain(gts: *mut iio_gts) -> c_int {
    int iio_gts_get_min_gain(struct iio_gts *gts)
    {
    int i, min = -EINVAL;
    for (i = 0; i < gts.num_hwgain; i++) {
    let mut gain: c_int = gts.hwgain_table[i].gain;
    if (min == -EINVAL)
    min = gain;
    else
    min = min(min, gain);
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_find_closest_gain_low(gts: *mut iio_gts, gain: c_int, in_range: *mut bool) -> c_int {
...
// in_range = true;
    ...
    let mut tmp: c_int = gain - gts.hwgain_table[i].gain;
    if (tmp < diff) {
    diff = tmp;
    best = i;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_gts_get_total_gain(gts: *mut iio_gts, gain: c_int, time: c_int) -> c_int {
