...
//! Source: drivers/iio/trigger/stm32-timer-trigger.c
#![no_std]
...
pub const MAX_TRIGGERS: c_int = 7;
pub const MAX_VALIDS: c_int = 5;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_timer_trigger_regs {
    pub cr1: u32,
    pub cr2: u32,
    pub psc: u32,
    pub arr: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_timer_trigger {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub clk: *mut clk,
    pub enabled: bool,
    pub max_arr: u32,
    pub triggers: *const c_void,
    pub valids: *const c_void,
    pub has_trgo2: bool,
    pub /: *mut *mut mutex lock; / concurrent sysfs configuration,
    pub tr_list: list_head,
    pub bak: stm32_timer_trigger_regs,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_timer_trigger_cfg {
    pub (*valids_table)[MAX_VALIDS]: *const c_void,
    pub num_valids_table: c_uint,
}

#[no_mangle]
unsafe extern "C" fn stm32_timer_is_trgo2_name(name: *const c_char) -> bool {
    static bool stm32_timer_is_trgo2_name(const char *name)
    {
    return !!strstr(name, "trgo2");
    }
#[no_mangle]
unsafe extern "C" fn stm32_timer_is_trgo_name(name: *const c_char) -> bool {
...
pub const MASTER_MODE_MAX: c_int = 7;
pub const MASTER_MODE2_MAX: c_int = 15;
...
// replace trailing space by newline
    ...
    stm32_tt_show_master_mode_avail, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn stm32_unregister_iio_triggers(priv: *mut stm32_timer_trigger) {
...
#[no_mangle]
unsafe extern "C" fn stm32_register_iio_triggers(priv: *mut stm32_timer_trigger) -> c_int {
    ...
    while (cur && *cur) {
    struct iio_trigger *trig;
    let mut cur_is_trgo: bool = stm32_timer_is_trgo_name(*cur);
    let mut cur_is_trgo2: bool = stm32_timer_is_trgo2_name(*cur);
...
#[no_mangle]
unsafe extern "C" fn stm32_enable_mode2sms(mode: c_int) -> c_int {
    ...
    {
    struct stm32_timer_trigger *priv = iio_priv(indio_dev);
    let mut sms: c_int = stm32_enable_mode2sms(mode);
    int ret;
    if (sms < 0)
    return sms;
//
...
#[no_mangle]
unsafe extern "C" fn stm32_sms2enable_mode(mode: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_stm32_timer_trigger(trig: *mut iio_trigger) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stm32_timer_detect_trgo2(priv: *mut stm32_timer_trigger) {
...
#[no_mangle]
unsafe extern "C" fn stm32_timer_trigger_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_timer_trigger_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn stm32_timer_trigger_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_timer_trigger_resume(dev: *mut device) -> c_int {
