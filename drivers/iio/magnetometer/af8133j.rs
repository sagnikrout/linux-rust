...
//! Source: drivers/iio/magnetometer/af8133j.c
#![no_std]
...
pub const AF8133J_REG_OUT: c_uint = 0x03;
pub const AF8133J_REG_PCODE: c_uint = 0x00;
pub const AF8133J_REG_PCODE_VAL: c_uint = 0x5e;
pub const AF8133J_REG_STATUS: c_uint = 0x02;

pub const AF8133J_REG_STATE: c_uint = 0x0a;
pub const AF8133J_REG_STATE_STBY: c_uint = 0x00;
pub const AF8133J_REG_STATE_WORK: c_uint = 0x01;
pub const AF8133J_REG_RANGE: c_uint = 0x0b;
pub const AF8133J_REG_RANGE_22G: c_uint = 0x12;
pub const AF8133J_REG_RANGE_12G: c_uint = 0x34;
pub const AF8133J_REG_SWR: c_uint = 0x11;
pub const AF8133J_REG_SWR_PERFORM: c_uint = 0x81;
...
//
    ...
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(af8133j_supply_names)],
    pub range: u8,
}
...
#[no_mangle]
unsafe extern "C" fn af8133j_product_check(data: *mut af8133j_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af8133j_reset(data: *mut af8133j_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af8133j_power_down(data: *mut af8133j_data) {
...
#[no_mangle]
unsafe extern "C" fn af8133j_power_up(data: *mut af8133j_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af8133j_take_measurement(data: *mut af8133j_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af8133j_read_measurement(data: *mut af8133j_data, buf[3]: __le16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(val2: af8133j_scales[1][0] == val && af8133j_scales[1][1] ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn af8133j_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn af8133j_power_down_action(ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn af8133j_probe(client: *mut i2c_client) -> c_int {
    ...
    &af8133j_trigger_handler, core::ptr::null_mut());
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn af8133j_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af8133j_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(af8133j_runtime_suspend, af8133j_runtime_resume, core::ptr::null_mut())
    };
