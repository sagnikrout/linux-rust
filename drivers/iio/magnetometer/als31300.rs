...
//! Source: drivers/iio/magnetometer/als31300.c
#![no_std]
...
//
pub const ALS31300_EEPROM_CONFIG: c_uint = 0x02;
pub const ALS31300_EEPROM_INTERRUPT: c_uint = 0x03;
pub const ALS31300_EEPROM_CUSTOMER_1: c_uint = 0x0d;
pub const ALS31300_EEPROM_CUSTOMER_2: c_uint = 0x0e;
pub const ALS31300_EEPROM_CUSTOMER_3: c_uint = 0x0f;
pub const ALS31300_VOL_MODE: c_uint = 0x27;

pub const ALS31300_LPDCM_INACTIVE_0_5_MS: c_int = 0;
pub const ALS31300_LPDCM_INACTIVE_1_0_MS: c_int = 1;
pub const ALS31300_LPDCM_INACTIVE_5_0_MS: c_int = 2;
pub const ALS31300_LPDCM_INACTIVE_10_0_MS: c_int = 3;
pub const ALS31300_LPDCM_INACTIVE_50_0_MS: c_int = 4;
pub const ALS31300_LPDCM_INACTIVE_100_0_MS: c_int = 5;
pub const ALS31300_LPDCM_INACTIVE_500_0_MS: c_int = 6;
pub const ALS31300_LPDCM_INACTIVE_1000_0_MS: c_int = 7;

pub const ALS31300_VOL_MODE_ACTIVE_MODE: c_int = 0;
pub const ALS31300_VOL_MODE_SLEEP_MODE: c_int = 1;
pub const ALS31300_VOL_MODE_LPDCM_MODE: c_int = 2;
pub const ALS31300_VOL_MSB: c_uint = 0x28;

pub const ALS31300_VOL_LSB: c_uint = 0x29;

pub const ALS31300_CUSTOMER_ACCESS: c_uint = 0x35;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct als31300_variant_info {
    pub sensitivity: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct als31300_data {
    pub dev: *mut device,
// protects power on/off the device and access HW
    pub mutex: mutex,
    pub variant_info: *const als31300_variant_info,
    pub map: *mut regmap,
}
...
#[no_mangle]
unsafe extern "C" fn als31300_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn als31300_power_down(data: *mut c_void) {
    static void als31300_power_down(void *data)
    {
    als31300_set_operating_mode(data, ALS31300_VOL_MODE_SLEEP_MODE);
    }
    let mut als31300_setup_ops: static struct iio_buffer_setup_ops = {};
    static const unsigned long als31300_scan_masks[] = { GENMASK(3, 0), 0 };
#[no_mangle]
unsafe extern "C" fn als31300_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
    static bool als31300_volatile_reg(struct device *dev, unsigned int reg)
    {
    let mut reg: return = = ALS31300_VOL_MSB || reg == ALS31300_VOL_LSB;
    }
...
#[no_mangle]
unsafe extern "C" fn als31300_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn als31300_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn als31300_runtime_resume(dev: *mut device) -> c_int {
