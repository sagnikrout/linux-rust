...
//! Source: drivers/iio/magnetometer/hmc5843_i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hmc5843_i2c_probe(cli: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmc5843_i2c_remove(client: *mut i2c_client) {
