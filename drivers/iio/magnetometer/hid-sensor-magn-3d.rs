...
//! Source: drivers/iio/magnetometer/hid-sensor-magn-3d.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct magn_3d_state {
    pub callbacks: hid_sensor_hub_callbacks,
    pub magn_flux_attributes: hid_sensor_common,
    pub rot_attributes: hid_sensor_common,
    pub magn: [hid_sensor_hub_attribute_info; MAGN_3D_CHANNEL_MAX],
// dynamically sized array to hold sensor values
    pub iio_vals: *mut u32,
// array of pointers to sensor value
    pub magn_val_addr: [*mut u32; MAGN_3D_CHANNEL_MAX],
    pub magn_flux_attr: common_attributes,
    pub rot_attr: common_attributes,
    pub timestamp: i64,
}
...
#[no_mangle]
unsafe extern "C" fn hid_magn_3d_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_magn_3d_remove(pdev: *mut platform_device) {
