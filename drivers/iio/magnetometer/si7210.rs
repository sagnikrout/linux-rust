...
//! Source: drivers/iio/magnetometer/si7210.c
#![no_std]
...
pub const SI7210_REG_DSPSIGM: c_uint = 0xC1;
pub const SI7210_REG_DSPSIGL: c_uint = 0xC2;

pub const SI7210_REG_DSPSIGSEL: c_uint = 0xC3;

pub const SI7210_REG_POWER_CTRL: c_uint = 0xC4;

pub const SI7210_REG_ARAUTOINC: c_uint = 0xC5;
pub const SI7210_REG_A0: c_uint = 0xCA;
pub const SI7210_REG_A1: c_uint = 0xCB;
pub const SI7210_REG_A2: c_uint = 0xCC;
pub const SI7210_REG_A3: c_uint = 0xCE;
pub const SI7210_REG_A4: c_uint = 0xCF;
pub const SI7210_REG_A5: c_uint = 0xD0;
pub const SI7210_REG_OTP_ADDR: c_uint = 0xE1;
pub const SI7210_REG_OTP_DATA: c_uint = 0xE2;

pub const SI7210_REG_OTP_CTRL: c_uint = 0xE3;
// OTP data registers offsets
pub const SI7210_OTPREG_TMP_OFF: c_uint = 0x1D;
pub const SI7210_OTPREG_TMP_GAIN: c_uint = 0x1E;
pub const SI7210_OTPREG_A0_20: c_uint = 0x21;
pub const SI7210_OTPREG_A1_20: c_uint = 0x22;
pub const SI7210_OTPREG_A2_20: c_uint = 0x23;
pub const SI7210_OTPREG_A3_20: c_uint = 0x24;
pub const SI7210_OTPREG_A4_20: c_uint = 0x25;
pub const SI7210_OTPREG_A5_20: c_uint = 0x26;
pub const SI7210_OTPREG_A0_200: c_uint = 0x27;
pub const SI7210_OTPREG_A1_200: c_uint = 0x28;
pub const SI7210_OTPREG_A2_200: c_uint = 0x29;
pub const SI7210_OTPREG_A3_200: c_uint = 0x2A;
pub const SI7210_OTPREG_A4_200: c_uint = 0x2B;
pub const SI7210_OTPREG_A5_200: c_uint = 0x2C;
pub const A_REGS_COUNT: c_int = 6;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct si7210_data {
    pub regmap: *mut regmap,
    pub client: *mut i2c_client,
    pub /: *mut *mut mutex fetch_lock; / lock for a single measurement fetch,
    pub vdd_uV: c_uint,
    pub temp_offset: i8,
    pub temp_gain: i8,
    pub scale_20_a: [i8; A_REGS_COUNT],
    pub scale_200_a: [i8; A_REGS_COUNT],
    pub curr_scale: u8,
}
    ...
    u16 *buf)
    {
    let mut dspsigsel: u8 = chan.type == IIO_MAGN ? 0 : 1;
    int ret;
    __be16 result;
...
#[no_mangle]
unsafe extern "C" fn si7210_set_scale(data: *mut si7210_data, scale: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(200: scale ==) -> else {
    else if (scale == 200)
...
// Write the registers 0xCE - 0xD0
    ...
    scale = 20;
#[no_mangle]
pub unsafe extern "C" fn if(125000: val == 0 && val2 ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn si7210_read_otpreg_val(data: *mut si7210_data, otpreg: c_uint, val: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn si7210_device_wake(data: *mut si7210_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si7210_device_init(data: *mut si7210_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si7210_probe(client: *mut i2c_client) -> c_int {
