...
//! Source: drivers/iio/magnetometer/mmc5983.c
#![no_std]
...
pub const MMC5983_REG_XOUT0: c_uint = 0x00;
pub const MMC5983_REG_XOUT1: c_uint = 0x01;
pub const MMC5983_REG_YOUT0: c_uint = 0x02;
pub const MMC5983_REG_YOUT1: c_uint = 0x03;
pub const MMC5983_REG_ZOUT0: c_uint = 0x04;
pub const MMC5983_REG_ZOUT1: c_uint = 0x05;
pub const MMC5983_REG_XYZOUT2: c_uint = 0x06;
pub const MMC5983_REG_STATUS: c_uint = 0x08;
pub const MMC5983_REG_CTRL0: c_uint = 0x09;
pub const MMC5983_REG_CTRL1: c_uint = 0x0A;
pub const MMC5983_REG_CTRL2: c_uint = 0x0B;
pub const MMC5983_REG_CTRL3: c_uint = 0x0C;
pub const MMC5983_REG_ID: c_uint = 0x2F;
pub const MMC5983_PRODUCT_ID: c_uint = 0x30;
...
#[no_mangle]
unsafe extern "C" fn mmc5983_pulse_coil(data: *mut mmc5983_data, coil_bit: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc5983_take_measurement(data: *mut mmc5983_data, m[3]: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc5983_is_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mmc5983_is_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mmc5983_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mmc5983_init(data: *mut mmc5983_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc5983_probe(i2c: *mut i2c_client) -> c_int {
