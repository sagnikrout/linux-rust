...
//! Source: drivers/iio/magnetometer/mmc5633.c
#![no_std]
...
pub const MMC5633_REG_XOUT0: c_uint = 0x00;
pub const MMC5633_REG_XOUT1: c_uint = 0x01;
pub const MMC5633_REG_YOUT0: c_uint = 0x02;
pub const MMC5633_REG_YOUT1: c_uint = 0x03;
pub const MMC5633_REG_ZOUT0: c_uint = 0x04;
pub const MMC5633_REG_ZOUT1: c_uint = 0x05;
pub const MMC5633_REG_XOUT2: c_uint = 0x06;
pub const MMC5633_REG_YOUT2: c_uint = 0x07;
pub const MMC5633_REG_ZOUT2: c_uint = 0x08;
pub const MMC5633_REG_TOUT: c_uint = 0x09;
pub const MMC5633_REG_STATUS1: c_uint = 0x18;
pub const MMC5633_REG_STATUS0: c_uint = 0x19;
pub const MMC5633_REG_CTRL0: c_uint = 0x1b;
pub const MMC5633_REG_CTRL1: c_uint = 0x1c;
pub const MMC5633_REG_CTRL2: c_uint = 0x1d;
pub const MMC5633_REG_ID: c_uint = 0x39;

pub const MMC5633_HDR_CTRL0_MEAS_M: c_uint = 0x01;
pub const MMC5633_HDR_CTRL0_MEAS_T: c_uint = 0x03;
pub const MMC5633_HDR_CTRL0_SET: c_uint = 0x05;
pub const MMC5633_HDR_CTRL0_RESET: c_uint = 0x07;
    enum mmc5633_axis {
    MMC5633_AXIS_X,
    MMC5633_AXIS_Y,
    MMC5633_AXIS_Z,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mmc5633_data {
    pub regmap: *mut regmap,
    pub i3cdev: *mut i3c_device,
    pub /: *mut *mut mutex mutex; / protect to finish one whole measurement,
}
...
#[no_mangle]
unsafe extern "C" fn mmc5633_init(data: *mut mmc5633_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc5633_take_measurement(data: *mut mmc5633_data, address: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc5633_is_support_hdr(data: *mut mmc5633_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mmc5633_read_measurement(data: *mut mmc5633_data, address: c_int, buf: *mut c_void, sz: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc5633_get_raw(data: *mut mmc5633_data, index: c_int, buf: *mut c_uchar, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc5633_is_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mmc5633_is_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mmc5633_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mmc5633_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc5633_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc5633_i2c_probe(client: *mut i2c_client) -> c_int {
    ...
    return mmc5633_common_probe(regmap, client.name, core::ptr::null_mut());
    }
    ...
    I3C_DEVICE(0x0251, 0x0000, core::ptr::null_mut()),
    { }
    };
    MODULE_DEVICE_TABLE(i3c, mmc5633_i3c_ids);
#[no_mangle]
unsafe extern "C" fn mmc5633_i3c_probe(i3cdev: *mut i3c_device) -> c_int {
