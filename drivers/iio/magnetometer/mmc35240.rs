...
//! Source: drivers/iio/magnetometer/mmc35240.c
#![no_std]
...
pub const MMC35240_REG_XOUT_L: c_uint = 0x00;
pub const MMC35240_REG_XOUT_H: c_uint = 0x01;
pub const MMC35240_REG_YOUT_L: c_uint = 0x02;
pub const MMC35240_REG_YOUT_H: c_uint = 0x03;
pub const MMC35240_REG_ZOUT_L: c_uint = 0x04;
pub const MMC35240_REG_ZOUT_H: c_uint = 0x05;
pub const MMC35240_REG_STATUS: c_uint = 0x06;
pub const MMC35240_REG_CTRL0: c_uint = 0x07;
pub const MMC35240_REG_CTRL1: c_uint = 0x08;
pub const MMC35240_REG_ID: c_uint = 0x20;

// output resolution bits

    MMC35240_CTRL1_BW1_BIT)
pub const MMC35240_CTRL1_BW_SHIFT: c_int = 0;
...
pub const MMC35240_OTP_START_ADDR: c_uint = 0x1B;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mmc35240_data {
    pub client: *mut i2c_client,
    pub mutex: mutex,
    pub regmap: *mut regmap,
    pub res: enum mmc35240_resolution,
// OTP compensation
    pub axis_coef: [c_int; 3],
    pub axis_scale: [c_int; 3],
}
...
#[no_mangle]
unsafe extern "C" fn mmc35240_hw_set(data: *mut mmc35240_data, set: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc35240_init(data: *mut mmc35240_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc35240_take_measurement(data: *mut mmc35240_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc35240_read_measurement(data: *mut mmc35240_data, buf[3]: __le16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc35240_is_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mmc35240_is_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mmc35240_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mmc35240_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc35240_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc35240_resume(dev: *mut device) -> c_int {
