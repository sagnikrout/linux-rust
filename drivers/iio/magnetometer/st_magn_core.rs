...
//! Source: drivers/iio/magnetometer/st_magn_core.c
#![no_std]
...
pub const ST_MAGN_NUMBER_DATA_CHANNELS: c_int = 3;
// DEFAULT VALUE FOR SENSORS
pub const ST_MAGN_DEFAULT_OUT_X_H_ADDR: c_uint = 0x03;
pub const ST_MAGN_DEFAULT_OUT_Y_H_ADDR: c_uint = 0x07;
pub const ST_MAGN_DEFAULT_OUT_Z_H_ADDR: c_uint = 0x05;
// FULLSCALE
pub const ST_MAGN_FS_AVL_1300MG: c_int = 1300;
pub const ST_MAGN_FS_AVL_1900MG: c_int = 1900;
pub const ST_MAGN_FS_AVL_2000MG: c_int = 2000;
pub const ST_MAGN_FS_AVL_2500MG: c_int = 2500;
pub const ST_MAGN_FS_AVL_4000MG: c_int = 4000;
pub const ST_MAGN_FS_AVL_4700MG: c_int = 4700;
pub const ST_MAGN_FS_AVL_5600MG: c_int = 5600;
pub const ST_MAGN_FS_AVL_8000MG: c_int = 8000;
pub const ST_MAGN_FS_AVL_8100MG: c_int = 8100;
pub const ST_MAGN_FS_AVL_12000MG: c_int = 12000;
pub const ST_MAGN_FS_AVL_15000MG: c_int = 15000;
pub const ST_MAGN_FS_AVL_16000MG: c_int = 16000;
// Special L addresses for Sensor 2
pub const ST_MAGN_2_OUT_X_L_ADDR: c_uint = 0x28;
pub const ST_MAGN_2_OUT_Y_L_ADDR: c_uint = 0x2a;
pub const ST_MAGN_2_OUT_Z_L_ADDR: c_uint = 0x2c;
// Special L addresses for sensor 3
pub const ST_MAGN_3_OUT_X_L_ADDR: c_uint = 0x68;
pub const ST_MAGN_3_OUT_Y_L_ADDR: c_uint = 0x6a;
pub const ST_MAGN_3_OUT_Z_L_ADDR: c_uint = 0x6c;
// Special L addresses for sensor 4
pub const ST_MAGN_4_OUT_X_L_ADDR: c_uint = 0x08;
pub const ST_MAGN_4_OUT_Y_L_ADDR: c_uint = 0x0a;
pub const ST_MAGN_4_OUT_Z_L_ADDR: c_uint = 0x0c;
...
#[no_mangle]
pub unsafe extern "C" fn st_magn_common_probe(indio_dev: *mut iio_dev) -> c_int {
