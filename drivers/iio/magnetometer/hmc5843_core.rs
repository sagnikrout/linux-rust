...
//! Source: drivers/iio/magnetometer/hmc5843_core.c
#![no_std]
...
//
pub const HMC5843_RANGE_GAIN_OFFSET: c_uint = 0x05;
pub const HMC5843_RANGE_GAIN_DEFAULT: c_uint = 0x01;
pub const HMC5843_RANGE_GAIN_MASK: c_uint = 0xe0;
// Device status
pub const HMC5843_DATA_READY: c_uint = 0x01;
pub const HMC5843_DATA_OUTPUT_LOCK: c_uint = 0x02;
// Mode register configuration
pub const HMC5843_MODE_CONVERSION_CONTINUOUS: c_uint = 0x00;
pub const HMC5843_MODE_CONVERSION_SINGLE: c_uint = 0x01;
pub const HMC5843_MODE_IDLE: c_uint = 0x02;
pub const HMC5843_MODE_SLEEP: c_uint = 0x03;
pub const HMC5843_MODE_MASK: c_uint = 0x03;
//
// HMC5843: Minimum data output rate
// HMC5883: Typical data output rate
//
pub const HMC5843_RATE_OFFSET: c_uint = 0x02;
pub const HMC5843_RATE_DEFAULT: c_uint = 0x04;
pub const HMC5843_RATE_MASK: c_uint = 0x1c;
// Device measurement configuration
pub const HMC5843_MEAS_CONF_NORMAL: c_uint = 0x00;
pub const HMC5843_MEAS_CONF_POSITIVE_BIAS: c_uint = 0x01;
pub const HMC5843_MEAS_CONF_NEGATIVE_BIAS: c_uint = 0x02;
pub const HMC5843_MEAS_CONF_MASK: c_uint = 0x03;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hmc5843_chip_info {
    pub channels: *const iio_chan_spec,
    pub (*regval_to_samp_freq)[2]: *const c_int,
    pub n_regval_to_samp_freq: c_int,
    pub regval_to_nanoscale: *const c_int,
    pub n_regval_to_nanoscale: c_int,
}

// The lower two bits contain the current conversion mode
#[no_mangle]
unsafe extern "C" fn hmc5843_set_mode(data: *mut hmc5843_data, operating_mode: u8) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn hmc5843_wait_measurement(data: *mut hmc5843_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmc5843_set_meas_conf(data: *mut hmc5843_data, meas_conf: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmc5843_set_samp_freq(data: *mut hmc5843_data, rate: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmc5843_set_range_gain(data: *mut hmc5843_data, range: u8) -> c_int {
...
// replace trailing space by newline
    ...
    hmc5843_show_scale_avail, core::ptr::null_mut(), 0);
#[no_mangle]
unsafe extern "C" fn hmc5843_get_scale_index(data: *mut hmc5843_data, val: c_int, val2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmc5843_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn hmc5843_init(data: *mut hmc5843_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmc5843_common_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmc5843_common_resume(dev: *mut device) -> c_int {
...
// default settings at probe
    ...
    hmc5843_trigger_handler, core::ptr::null_mut());
    if (ret < 0)
...
#[no_mangle]
pub unsafe extern "C" fn hmc5843_common_remove(dev: *mut device) {
