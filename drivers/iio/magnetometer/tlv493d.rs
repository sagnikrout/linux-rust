...
//! Source: drivers/iio/magnetometer/tlv493d.c
#![no_std]
...
//
pub const TLV493D_RD_REG_BX: c_uint = 0x00;
pub const TLV493D_RD_REG_BY: c_uint = 0x01;
pub const TLV493D_RD_REG_BZ: c_uint = 0x02;
pub const TLV493D_RD_REG_TEMP: c_uint = 0x03;
pub const TLV493D_RD_REG_BX2: c_uint = 0x04;
pub const TLV493D_RD_REG_BZ2: c_uint = 0x05;
pub const TLV493D_RD_REG_TEMP2: c_uint = 0x06;
pub const TLV493D_RD_REG_RES1: c_uint = 0x07;
pub const TLV493D_RD_REG_RES2: c_uint = 0x08;
pub const TLV493D_RD_REG_RES3: c_uint = 0x09;
pub const TLV493D_RD_REG_MAX: c_uint = 0x0a;
pub const TLV493D_WR_REG_MODE1: c_uint = 0x01;
pub const TLV493D_WR_REG_MODE2: c_uint = 0x03;
pub const TLV493D_WR_REG_MAX: c_uint = 0x04;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tlv493d_data {
    pub client: *mut i2c_client,
// protects from simultaneous sensor access and register readings
    pub lock: mutex,
    pub mode: enum tlv493d_op_mode,
    pub wr_regs: [u8; TLV493D_WR_REG_MAX],
}
...
#[no_mangle]
unsafe extern "C" fn tlv493d_write_all_regs(data: *mut tlv493d_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tlv493d_set_operating_mode(data: *mut tlv493d_data, mode: enum tlv493d_op_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tlv493d_get_channel_data(b: *mut u8, ch: enum tlv493d_channels) -> i16 {
    ...
    int err, ret;
    struct device *dev = &data.client.dev;
    let mut sleep_us: u32 = tlv493d_sample_rate_us[data.mode];
...
#[no_mangle]
unsafe extern "C" fn tlv493d_init(data: *mut tlv493d_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tlv493d_trigger_handler(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tlv493d_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tlv493d_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tlv493d_runtime_resume(dev: *mut device) -> c_int {
    ...
    tlv493d_runtime_resume, core::ptr::null_mut());
