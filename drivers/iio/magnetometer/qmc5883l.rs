...
//! Source: drivers/iio/magnetometer/qmc5883l.c
#![no_std]
...
pub const QMC5883L_REG_X_LSB: c_uint = 0x00;
pub const QMC5883L_REG_STATUS1: c_uint = 0x06;
pub const QMC5883L_REG_CTRL1: c_uint = 0x09;
pub const QMC5883L_REG_CTRL2: c_uint = 0x0A;
pub const QMC5883L_REG_SET_RESET: c_uint = 0x0B;
pub const QMC5883L_REG_ID: c_uint = 0x0D;
pub const QMC5883L_CHIP_ID: c_uint = 0xFF;

pub const QMC5883L_MODE_STANDBY: c_uint = 0x00;
pub const QMC5883L_MODE_CONT: c_uint = 0x01;
pub const QMC5883L_ODR_10HZ: c_uint = 0x00;
pub const QMC5883L_ODR_50HZ: c_uint = 0x01;
pub const QMC5883L_ODR_100HZ: c_uint = 0x02;
pub const QMC5883L_ODR_200HZ: c_uint = 0x03;
pub const QMC5883L_RNG_2G: c_uint = 0x00;
pub const QMC5883L_RNG_8G: c_uint = 0x01;
pub const QMC5883L_OSR_512: c_uint = 0x00;
pub const QMC5883L_OSR_256: c_uint = 0x01;
pub const QMC5883L_OSR_128: c_uint = 0x02;
pub const QMC5883L_OSR_64: c_uint = 0x03;

pub const QMC5883L_PORT_US: c_int = 350;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmc5883l_data {
...
// val = 512;
    ...
    rng = QMC5883L_RNG_2G;
#[no_mangle]
pub unsafe extern "C" fn if(qmc5883l_scales[QMC5883L_RNG_8G][1]: val2 ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn qmc5883l_init(data: *mut qmc5883l_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc5883l_power_down_action(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qmc5883l_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
    static bool qmc5883l_volatile_reg(struct device *dev, unsigned int reg)
    {
    return reg <= QMC5883L_REG_STATUS1;
    }
#[no_mangle]
unsafe extern "C" fn qmc5883l_writable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qmc5883l_probe(client: *mut i2c_client) -> c_int {
