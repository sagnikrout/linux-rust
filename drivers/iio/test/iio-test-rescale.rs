...
//! Source: drivers/iio/test/iio-test-rescale.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rescale_tc_data {
    pub name: *const c_char,
    pub numerator: i32,
    pub denominator: i32,
    pub offset: i32,
    pub schan_val: c_int,
    pub schan_val2: c_int,
    pub schan_off: c_int,
    pub schan_scale_type: c_int,
    pub expected: *const c_char,
    pub expected_off: *const c_char,
}
...
#[no_mangle]
unsafe extern "C" fn case_to_desc(t: *const rescale_tc_data, desc: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn iio_str_to_nano(str: *const c_char, nano: *mut i64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iio_test_relative_error_ppm(real_str: *const c_char, exp_str: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_rescale_test_scale(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn iio_rescale_test_offset(test: *mut kunit) {
