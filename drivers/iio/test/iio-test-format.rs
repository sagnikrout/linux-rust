...
//! Source: drivers/iio/test/iio-test-format.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn iio_test_iio_format_value_integer(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn iio_test_iio_format_value_fixedpoint(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn iio_test_iio_format_value_fractional(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn iio_test_iio_format_value_fractional_log2(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn iio_test_iio_format_value_multiple(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn iio_test_iio_format_value_integer_64(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn iio_test_iio_format_value_decimal_64(test: *mut kunit) {
