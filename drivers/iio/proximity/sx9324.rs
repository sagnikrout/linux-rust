...
//! Source: drivers/iio/proximity/sx9324.c
#![no_std]
...
pub const SX9324_REG_STAT0: c_uint = 0x01;
pub const SX9324_REG_STAT1: c_uint = 0x02;
pub const SX9324_REG_STAT2: c_uint = 0x03;

pub const SX9324_REG_STAT3: c_uint = 0x04;
pub const SX9324_REG_IRQ_MSK: c_uint = 0x05;

pub const SX9324_REG_IRQ_CFG0: c_uint = 0x06;
pub const SX9324_REG_IRQ_CFG1: c_uint = 0x07;
pub const SX9324_REG_IRQ_CFG1_FAILCOND: c_uint = 0x80;
pub const SX9324_REG_IRQ_CFG2: c_uint = 0x08;
pub const SX9324_REG_GNRL_CTRL0: c_uint = 0x10;

pub const SX9324_REG_GNRL_CTRL0_SCANPERIOD_100MS: c_uint = 0x16;
pub const SX9324_REG_GNRL_CTRL1: c_uint = 0x11;

pub const SX9324_REG_GNRL_CTRL1_PAUSECTRL: c_uint = 0x20;
pub const SX9324_REG_I2C_ADDR: c_uint = 0x14;
pub const SX9324_REG_CLK_SPRD: c_uint = 0x15;
pub const SX9324_REG_AFE_CTRL0: c_uint = 0x20;
pub const SX9324_REG_AFE_CTRL0_RINT_SHIFT: c_int = 6;

    GENMASK(SX9324_REG_AFE_CTRL0_RINT_SHIFT + 1, \
    SX9324_REG_AFE_CTRL0_RINT_SHIFT)
pub const SX9324_REG_AFE_CTRL0_RINT_LOWEST: c_uint = 0x00;
pub const SX9324_REG_AFE_CTRL0_CSIDLE_SHIFT: c_int = 4;

    GENMASK(SX9324_REG_AFE_CTRL0_CSIDLE_SHIFT + 1, \
    SX9324_REG_AFE_CTRL0_CSIDLE_SHIFT)
pub const SX9324_REG_AFE_CTRL0_RINT_LOWEST: c_uint = 0x00;
pub const SX9324_REG_AFE_CTRL1: c_uint = 0x21;
pub const SX9324_REG_AFE_CTRL2: c_uint = 0x22;
pub const SX9324_REG_AFE_CTRL3: c_uint = 0x23;
pub const SX9324_REG_AFE_CTRL4: c_uint = 0x24;
pub const SX9324_REG_AFE_CTRL4_FREQ_83_33HZ: c_uint = 0x40;

pub const SX9324_REG_AFE_CTRL4_RES_100: c_uint = 0x04;
pub const SX9324_REG_AFE_CTRL5: c_uint = 0x25;
pub const SX9324_REG_AFE_CTRL6: c_uint = 0x26;
pub const SX9324_REG_AFE_CTRL7: c_uint = 0x27;
pub const SX9324_REG_AFE_PH0: c_uint = 0x28;

    GENMASK(2 * (_pin) + 1, 2 * (_pin))
pub const SX9324_REG_AFE_PH1: c_uint = 0x29;
pub const SX9324_REG_AFE_PH2: c_uint = 0x2a;
pub const SX9324_REG_AFE_PH3: c_uint = 0x2b;
pub const SX9324_REG_AFE_CTRL8: c_uint = 0x2c;
pub const SX9324_REG_AFE_CTRL8_RESERVED: c_uint = 0x10;
pub const SX9324_REG_AFE_CTRL8_RESFILTIN_4KOHM: c_uint = 0x02;

pub const SX9324_REG_AFE_CTRL9: c_uint = 0x2d;

pub const SX9324_REG_AFE_CTRL9_AGAIN_1: c_uint = 0x08;
pub const SX9324_REG_PROX_CTRL0: c_uint = 0x30;

pub const SX9324_REG_PROX_CTRL0_GAIN_SHIFT: c_int = 3;
pub const SX9324_REG_PROX_CTRL0_GAIN_RSVD: c_uint = 0x0;
pub const SX9324_REG_PROX_CTRL0_GAIN_1: c_uint = 0x1;
pub const SX9324_REG_PROX_CTRL0_GAIN_8: c_uint = 0x4;

pub const SX9324_REG_PROX_CTRL0_RAWFILT_1P50: c_uint = 0x01;
pub const SX9324_REG_PROX_CTRL1: c_uint = 0x31;
pub const SX9324_REG_PROX_CTRL2: c_uint = 0x32;
pub const SX9324_REG_PROX_CTRL2_AVGNEG_THRESH_16K: c_uint = 0x20;
pub const SX9324_REG_PROX_CTRL3: c_uint = 0x33;
pub const SX9324_REG_PROX_CTRL3_AVGDEB_2SAMPLES: c_uint = 0x40;
pub const SX9324_REG_PROX_CTRL3_AVGPOS_THRESH_16K: c_uint = 0x20;
pub const SX9324_REG_PROX_CTRL4: c_uint = 0x34;

pub const SX9324_REG_PROX_CTRL4_AVGNEG_FILT_2: c_uint = 0x08;

pub const SX9324_REG_PROX_CTRL4_AVGPOS_FILT_256: c_uint = 0x04;
pub const SX9324_REG_PROX_CTRL5: c_uint = 0x35;

pub const SX9324_REG_PROX_CTRL6: c_uint = 0x36;
pub const SX9324_REG_PROX_CTRL6_PROXTHRESH_32: c_uint = 0x08;
pub const SX9324_REG_PROX_CTRL7: c_uint = 0x37;
pub const SX9324_REG_ADV_CTRL0: c_uint = 0x40;
pub const SX9324_REG_ADV_CTRL1: c_uint = 0x41;
pub const SX9324_REG_ADV_CTRL2: c_uint = 0x42;
pub const SX9324_REG_ADV_CTRL3: c_uint = 0x43;
pub const SX9324_REG_ADV_CTRL4: c_uint = 0x44;
pub const SX9324_REG_ADV_CTRL5: c_uint = 0x45;

pub const SX9324_REG_ADV_CTRL5_STARTUP_SENSOR_1: c_uint = 0x04;
pub const SX9324_REG_ADV_CTRL5_STARTUP_METHOD_1: c_uint = 0x01;
pub const SX9324_REG_ADV_CTRL6: c_uint = 0x46;
pub const SX9324_REG_ADV_CTRL7: c_uint = 0x47;
pub const SX9324_REG_ADV_CTRL8: c_uint = 0x48;
pub const SX9324_REG_ADV_CTRL9: c_uint = 0x49;
pub const SX9324_REG_ADV_CTRL10: c_uint = 0x4a;
pub const SX9324_REG_ADV_CTRL11: c_uint = 0x4b;
pub const SX9324_REG_ADV_CTRL12: c_uint = 0x4c;
pub const SX9324_REG_ADV_CTRL13: c_uint = 0x4d;
pub const SX9324_REG_ADV_CTRL14: c_uint = 0x4e;
pub const SX9324_REG_ADV_CTRL15: c_uint = 0x4f;
pub const SX9324_REG_ADV_CTRL16: c_uint = 0x50;
pub const SX9324_REG_ADV_CTRL17: c_uint = 0x51;
pub const SX9324_REG_ADV_CTRL18: c_uint = 0x52;
pub const SX9324_REG_ADV_CTRL19: c_uint = 0x53;
pub const SX9324_REG_ADV_CTRL20: c_uint = 0x54;
pub const SX9324_REG_ADV_CTRL19_HIGHT_FAILURE_THRESH_SATURATION: c_uint = 0xf0;
pub const SX9324_REG_PHASE_SEL: c_uint = 0x60;
pub const SX9324_REG_USEFUL_MSB: c_uint = 0x61;
pub const SX9324_REG_USEFUL_LSB: c_uint = 0x62;
pub const SX9324_REG_AVG_MSB: c_uint = 0x63;
pub const SX9324_REG_AVG_LSB: c_uint = 0x64;
pub const SX9324_REG_DIFF_MSB: c_uint = 0x65;
pub const SX9324_REG_DIFF_LSB: c_uint = 0x66;
pub const SX9324_REG_OFFSET_MSB: c_uint = 0x67;
pub const SX9324_REG_OFFSET_LSB: c_uint = 0x68;
pub const SX9324_REG_SAR_MSB: c_uint = 0x69;
pub const SX9324_REG_SAR_LSB: c_uint = 0x6a;
pub const SX9324_REG_RESET: c_uint = 0x9f;
// Write this to REG_RESET to do a soft reset.
pub const SX9324_SOFT_RESET: c_uint = 0xde;
pub const SX9324_REG_WHOAMI: c_uint = 0xfa;
pub const SX9324_WHOAMI_VALUE: c_uint = 0x23;
pub const SX9324_REG_REVISION: c_uint = 0xfe;
// 4 channels, as defined in STAT0: PH0, PH1, PH2 and PH3.
pub const SX9324_NUM_CHANNELS: c_int = 4;
// 3 CS pins: CS0, CS1, CS2.
pub const SX9324_NUM_PINS: c_int = 3;
...
//
#[no_mangle]
unsafe extern "C" fn sx9324_wait_for_sample(data: *mut sx_common_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9324_read_far_debounce(data: *mut sx_common_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9324_read_close_debounce(data: *mut sx_common_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9324_write_far_debounce(data: *mut sx_common_data, _val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9324_write_close_debounce(data: *mut sx_common_data, _val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9324_init_compensation(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9324_resume(dev: *mut device) -> c_int {
