...
//! Source: drivers/iio/proximity/srf08.c
#![no_std]
...
pub const SRF08_WRITE_COMMAND: c_uint = 0x00	/* Command Register */;
pub const SRF08_WRITE_MAX_GAIN: c_uint = 0x01	/* Max Gain Register: 0 .. 31 */;
pub const SRF08_WRITE_RANGE: c_uint = 0x02	/* Range Register: 0 .. 255 */;
pub const SRF08_READ_SW_REVISION: c_uint = 0x00	/* Software Revision */;
pub const SRF08_READ_LIGHT: c_uint = 0x01	/* Light Sensor during last echo */;
pub const SRF08_READ_ECHO_1_HIGH: c_uint = 0x02	/* Range of first echo received */;
pub const SRF08_READ_ECHO_1_LOW: c_uint = 0x03	/* Range of first echo received */;
pub const SRF08_CMD_RANGING_CM: c_uint = 0x51	/* Ranging Mode - Result in cm */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct srf08_chip_info {
    pub sensitivity_avail: *const c_int,
    pub num_sensitivity_avail: c_int,
    pub sensitivity_default: c_int,
// default value of Range in mm
    pub range_default: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct srf08_data {
...
// max. Range in mm
    ...
    pub lock: mutex,
// Sensor-Type
    pub sensor_type: enum srf08_sensor_type,
// Chip-specific information
    pub chip_info: *const srf08_chip_info,
}
...
//
    ...
    .sensitivity_avail	= core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn srf08_read_ranging(data: *mut srf08_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn srf08_trigger_handler(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
// val2 = 10000;
    ...
    srf08_show_range_mm_available, core::ptr::null_mut(), 0);
...
//
#[no_mangle]
unsafe extern "C" fn srf08_write_range_mm(data: *mut srf08_data, val: c_uint) -> isize {
    ...
    srf08_show_sensitivity_available, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn srf08_probe(client: *mut i2c_client) -> c_int {
    ...
    iio_pollfunc_store_time, srf08_trigger_handler, core::ptr::null_mut());
    if (ret < 0) {
