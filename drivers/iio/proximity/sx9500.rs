...
//! Source: drivers/iio/proximity/sx9500.c
#![no_std]
...
pub const SX9500_REG_IRQ_SRC: c_uint = 0x00;
pub const SX9500_REG_STAT: c_uint = 0x01;
pub const SX9500_REG_IRQ_MSK: c_uint = 0x03;
pub const SX9500_REG_PROX_CTRL0: c_uint = 0x06;
pub const SX9500_REG_PROX_CTRL1: c_uint = 0x07;
pub const SX9500_REG_PROX_CTRL2: c_uint = 0x08;
pub const SX9500_REG_PROX_CTRL3: c_uint = 0x09;
pub const SX9500_REG_PROX_CTRL4: c_uint = 0x0a;
pub const SX9500_REG_PROX_CTRL5: c_uint = 0x0b;
pub const SX9500_REG_PROX_CTRL6: c_uint = 0x0c;
pub const SX9500_REG_PROX_CTRL7: c_uint = 0x0d;
pub const SX9500_REG_PROX_CTRL8: c_uint = 0x0e;
pub const SX9500_REG_SENSOR_SEL: c_uint = 0x20;
pub const SX9500_REG_USE_MSB: c_uint = 0x21;
pub const SX9500_REG_USE_LSB: c_uint = 0x22;
pub const SX9500_REG_AVG_MSB: c_uint = 0x23;
pub const SX9500_REG_AVG_LSB: c_uint = 0x24;
pub const SX9500_REG_DIFF_MSB: c_uint = 0x25;
pub const SX9500_REG_DIFF_LSB: c_uint = 0x26;
pub const SX9500_REG_OFFSET_MSB: c_uint = 0x27;
pub const SX9500_REG_OFFSET_LSB: c_uint = 0x28;
pub const SX9500_REG_RESET: c_uint = 0x7f;
// Write this to REG_RESET to do a soft reset.
pub const SX9500_SOFT_RESET: c_uint = 0xde;

pub const SX9500_SCAN_PERIOD_SHIFT: c_int = 4;
//
// These serve for identifying IRQ source in the IRQ_SRC register, and
// also for masking the IRQs in the IRQ_MSK register.
//

pub const SX9500_PROXSTAT_SHIFT: c_int = 4;

pub const SX9500_NUM_CHANNELS: c_int = 4;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sx9500_data {
    pub mutex: mutex,
...
//
    pub prox_stat: [bool; SX9500_NUM_CHANNELS],
    pub event_enabled: [bool; SX9500_NUM_CHANNELS],
    pub trigger_enabled: bool,
// Remember enabled channels and sample rate during suspend.
    pub suspend_ctrl0: c_uint,
    pub completion: completion,
    pub close_far_users: int data_rdy_users,,
    pub channel_users: [c_int; SX9500_NUM_CHANNELS],
}
...
#[no_mangle]
unsafe extern "C" fn sx9500_inc_chan_users(data: *mut sx9500_data, chan: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9500_dec_chan_users(data: *mut sx9500_data, chan: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9500_inc_data_rdy_users(data: *mut sx9500_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9500_dec_data_rdy_users(data: *mut sx9500_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9500_inc_close_far_users(data: *mut sx9500_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9500_dec_close_far_users(data: *mut sx9500_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sx9500_wait_for_sample(data: *mut sx9500_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9500_irq_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sx9500_push_events(indio_dev: *mut iio_dev) {
    ...
    int dir;
    u64 ev;
    let mut new_prox: bool = val & BIT(chan);
...
#[no_mangle]
unsafe extern "C" fn sx9500_irq_thread_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sx9500_trigger_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sx9500_buffer_postenable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9500_buffer_predisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9500_init_compensation(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9500_init_device(indio_dev: *mut iio_dev) -> c_int {
    ...
    let mut interrupt_gpios: static struct acpi_gpio_params = { 2, 0, false };
...
//
    ...
    data.gpiod_rst = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn sx9500_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9500_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn sx9500_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx9500_resume(dev: *mut device) -> c_int {
