...
//! Source: drivers/iio/proximity/vcnl3020.c
#![no_std]
...
pub const VCNL3020_PROD_ID: c_uint = 0x21;
pub const VCNL_COMMAND: c_uint = 0x80 /* Command register */;
pub const VCNL_PROD_REV: c_uint = 0x81 /* Product ID and Revision ID */;
pub const VCNL_PROXIMITY_RATE: c_uint = 0x82 /* Rate of Proximity Measurement */;
pub const VCNL_LED_CURRENT: c_uint = 0x83 /* IR LED current for proximity mode */;
pub const VCNL_PS_RESULT_HI: c_uint = 0x87 /* Proximity result register, MSB */;
pub const VCNL_PS_RESULT_LO: c_uint = 0x88 /* Proximity result register, LSB */;
pub const VCNL_PS_ICR: c_uint = 0x89 /* Interrupt Control Register */;
pub const VCNL_PS_LO_THR_HI: c_uint = 0x8a /* High byte of low threshold value */;
pub const VCNL_PS_LO_THR_LO: c_uint = 0x8b /* Low byte of low threshold value */;
pub const VCNL_PS_HI_THR_HI: c_uint = 0x8c /* High byte of high threshold value */;
pub const VCNL_PS_HI_THR_LO: c_uint = 0x8d /* Low byte of high threshold value */;
pub const VCNL_ISR: c_uint = 0x8e /* Interrupt Status Register */;
pub const VCNL_PS_MOD_ADJ: c_uint = 0x8f /* Proximity Modulator Timing Adjustment */;
...
pub const VCNL_ON_DEMAND_TIMEOUT_US: c_int = 100000;
pub const VCNL_POLL_US: c_int = 20000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vcnl3020_property {
    pub name: *const c_char,
    pub reg: u32,
    pub val): *mut *mut u32 (conversion_func)(u32,
}

#[no_mangle]
unsafe extern "C" fn microamp_to_reg(val: *mut u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vcnl3020_init(data: *mut vcnl3020_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl3020_is_in_periodic_mode(data: *mut vcnl3020_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vcnl3020_measure_proximity(data: *mut vcnl3020_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl3020_is_thr_enabled(data: *mut vcnl3020_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vcnl3020_config_threshold(indio_dev: *mut iio_dev, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcnl3020_handle_irq_thread(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vcnl3020_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), vcnl3020_handle_irq_thread,
