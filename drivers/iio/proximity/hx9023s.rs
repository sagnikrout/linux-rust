...
//! Source: drivers/iio/proximity/hx9023s.c
#![no_std]
...
pub const HX9023S_CHIP_ID: c_uint = 0x1D;
pub const HX9023S_CH_NUM: c_int = 5;
pub const HX9023S_POS: c_uint = 0x03;
pub const HX9023S_NEG: c_uint = 0x02;
pub const HX9023S_NOT_CONNECTED: c_int = 16;
pub const HX9023S_GLOBAL_CTRL0: c_uint = 0x00;
pub const HX9023S_PRF_CFG: c_uint = 0x02;
pub const HX9023S_CH0_CFG_7_0: c_uint = 0x03;
pub const HX9023S_CH4_CFG_9_8: c_uint = 0x0C;
pub const HX9023S_RANGE_7_0: c_uint = 0x0D;
pub const HX9023S_RANGE_9_8: c_uint = 0x0E;
pub const HX9023S_RANGE_18_16: c_uint = 0x0F;
pub const HX9023S_AVG0_NOSR0_CFG: c_uint = 0x10;
pub const HX9023S_NOSR12_CFG: c_uint = 0x11;
pub const HX9023S_NOSR34_CFG: c_uint = 0x12;
pub const HX9023S_AVG12_CFG: c_uint = 0x13;
pub const HX9023S_AVG34_CFG: c_uint = 0x14;
pub const HX9023S_OFFSET_DAC0_7_0: c_uint = 0x15;
pub const HX9023S_OFFSET_DAC4_9_8: c_uint = 0x1E;
pub const HX9023S_SAMPLE_NUM_7_0: c_uint = 0x1F;
pub const HX9023S_INTEGRATION_NUM_7_0: c_uint = 0x21;
pub const HX9023S_CH_NUM_CFG: c_uint = 0x24;
pub const HX9023S_LP_ALP_4_CFG: c_uint = 0x29;
pub const HX9023S_LP_ALP_1_0_CFG: c_uint = 0x2A;
pub const HX9023S_LP_ALP_3_2_CFG: c_uint = 0x2B;
pub const HX9023S_UP_ALP_1_0_CFG: c_uint = 0x2C;
pub const HX9023S_UP_ALP_3_2_CFG: c_uint = 0x2D;
pub const HX9023S_DN_UP_ALP_0_4_CFG: c_uint = 0x2E;
pub const HX9023S_DN_ALP_2_1_CFG: c_uint = 0x2F;
pub const HX9023S_DN_ALP_4_3_CFG: c_uint = 0x30;
pub const HX9023S_RAW_BL_RD_CFG: c_uint = 0x38;
pub const HX9023S_INTERRUPT_CFG: c_uint = 0x39;
pub const HX9023S_INTERRUPT_CFG1: c_uint = 0x3A;
pub const HX9023S_CALI_DIFF_CFG: c_uint = 0x3B;
pub const HX9023S_DITHER_CFG: c_uint = 0x3C;
pub const HX9023S_DEVICE_ID: c_uint = 0x60;
pub const HX9023S_PROX_STATUS: c_uint = 0x6B;
pub const HX9023S_PROX_INT_HIGH_CFG: c_uint = 0x6C;
pub const HX9023S_PROX_INT_LOW_CFG: c_uint = 0x6D;
pub const HX9023S_PROX_HIGH_DIFF_CFG_CH0_0: c_uint = 0x80;
pub const HX9023S_PROX_LOW_DIFF_CFG_CH0_0: c_uint = 0x88;
pub const HX9023S_PROX_LOW_DIFF_CFG_CH3_1: c_uint = 0x8F;
pub const HX9023S_PROX_HIGH_DIFF_CFG_CH4_0: c_uint = 0x9E;
pub const HX9023S_PROX_HIGH_DIFF_CFG_CH4_1: c_uint = 0x9F;
pub const HX9023S_PROX_LOW_DIFF_CFG_CH4_0: c_uint = 0xA2;
pub const HX9023S_PROX_LOW_DIFF_CFG_CH4_1: c_uint = 0xA3;
pub const HX9023S_CAP_INI_CH4_0: c_uint = 0xB3;
pub const HX9023S_LP_DIFF_CH4_2: c_uint = 0xBA;
pub const HX9023S_RAW_BL_CH4_0: c_uint = 0xB5;
pub const HX9023S_LP_DIFF_CH4_0: c_uint = 0xB8;
pub const HX9023S_DSP_CONFIG_CTRL1: c_uint = 0xC8;
pub const HX9023S_CAP_INI_CH0_0: c_uint = 0xE0;
pub const HX9023S_RAW_BL_CH0_0: c_uint = 0xE8;
pub const HX9023S_LP_DIFF_CH0_0: c_uint = 0xF4;
pub const HX9023S_LP_DIFF_CH3_2: c_uint = 0xFF;

pub const FW_VER_OFFSET: c_int = 2;
pub const FW_REG_CNT_OFFSET: c_int = 3;
pub const FW_DATA_OFFSET: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hx9023s_bin {
    pub reg_count: u16,
    pub fw_size: u16,
    pub fw_ver: u8,
    pub __counted_by(fw_size): u8 data[],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hx9023s_ch_data {
    pub Data*/: *mut *mut s16 raw; / Raw,
    pub Data*/: *mut *mut s16 lp; / Low Pass Filter,
    pub /: *mut *mut s16 bl; / Base Line Data,
    pub /: *mut *mut s16 diff; / Difference of Low Pass Data and Base Line Data,
    struct {
    pub near: c_uint,
    pub far: c_uint,
    pub thres: },
    pub dac: u16,
    pub channel_positive: u8,
    pub channel_negative: u8,
    pub sel_bl: bool,
    pub sel_raw: bool,
    pub sel_diff: bool,
    pub sel_lp: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hx9023s_data {
    pub trig: *mut iio_trigger,
    pub regmap: *mut regmap,
    pub chan_prox_stat: c_ulong,
    pub chan_read: c_ulong,
    pub chan_event: c_ulong,
    pub ch_en_stat: c_ulong,
    pub chan_in_use: c_ulong,
    pub prox_state_reg: c_uint,
    pub trigger_enabled: bool,
    struct {
    pub channels: [__le16; HX9023S_CH_NUM],
    pub ts: aligned_s64,
    pub buffer: },
//
...
//
    pub mutex: mutex,
    pub ch_data: [hx9023s_ch_data; HX9023S_CH_NUM],
}
...
#[no_mangle]
unsafe extern "C" fn hx9023s_interrupt_enable(data: *mut hx9023s_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_interrupt_disable(data: *mut hx9023s_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_data_lock(data: *mut hx9023s_data, locked: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_ch_cfg(data: *mut hx9023s_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_write_far_debounce(data: *mut hx9023s_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_write_near_debounce(data: *mut hx9023s_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_read_far_debounce(data: *mut hx9023s_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_read_near_debounce(data: *mut hx9023s_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_get_thres_near(data: *mut hx9023s_data, ch: u8, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_get_thres_far(data: *mut hx9023s_data, ch: u8, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_set_thres_near(data: *mut hx9023s_data, ch: u8, val: c_int) -> c_int {
    static int hx9023s_set_thres_near(struct hx9023s_data *data, u8 ch, int val)
    {
    let mut val_le16: __le16 = cpu_to_le16((val / 32) & GENMASK(9, 0));
    unsigned int reg;
...
#[no_mangle]
unsafe extern "C" fn hx9023s_set_thres_far(data: *mut hx9023s_data, ch: u8, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_get_prox_state(data: *mut hx9023s_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_data_select(data: *mut hx9023s_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_sample(data: *mut hx9023s_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_ch_en(data: *mut hx9023s_data, ch_id: u8, en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_property_get(data: *mut hx9023s_data) -> c_int {
    ...
    {
    unsigned int i;
    let mut channels: c_ulong = chan_read | chan_event;
...
#[no_mangle]
unsafe extern "C" fn hx9023s_get_samp_freq(data: *mut hx9023s_data, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_set_samp_freq(data: *mut hx9023s_data, val: c_int, val2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_irq_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_push_events(indio_dev: *mut iio_dev) {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_irq_thread_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_set_trigger_state(trig: *mut iio_trigger, state: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !data->chan_read) -> else {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_trigger_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_buffer_preenable(indio_dev: *mut iio_dev) -> c_int {
    static int hx9023s_buffer_preenable(struct iio_dev *indio_dev)
    {
    struct hx9023s_data *data = iio_priv(indio_dev);
    let mut channels: c_ulong = 0;
    unsigned int bit;
    guard(mutex)(&data.mutex);
    iio_for_each_active_channel(indio_dev, bit)
...
#[no_mangle]
unsafe extern "C" fn hx9023s_buffer_postdisable(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_id_check(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_bin_load(data: *mut hx9023s_data, bin: *mut hx9023s_bin) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_send_cfg(fw: *const firmware, data: *mut hx9023s_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_cfg_update(fw: *const firmware, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx9023s_resume(dev: *mut device) -> c_int {
