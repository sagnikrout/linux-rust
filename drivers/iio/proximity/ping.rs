...
//! Source: drivers/iio/proximity/ping.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct ping_cfg {
    pub /: *mut *mut unsigned long trigger_pulse_us; / length of trigger pulse,
    pub /: *mut *mut int laserping_error; / support error code in,
// pulse width of laser
// ping sensors
    pub /: *mut *mut s64 timeout_ns; / timeout in ns,
}
...
#[no_mangle]
unsafe extern "C" fn ping_handle_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ping_read(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ping_probe(pdev: *mut platform_device) -> c_int {
