...
//! Source: drivers/iio/proximity/srf04.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct srf04_cfg {
    pub trigger_pulse_us: c_ulong,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct srf04_data {
    pub dev: *mut device,
    pub gpiod_trig: *mut gpio_desc,
    pub gpiod_echo: *mut gpio_desc,
    pub gpiod_power: *mut gpio_desc,
    pub lock: mutex,
    pub irqnr: c_int,
    pub ts_rising: ktime_t,
    pub ts_falling: ktime_t,
    pub rising: completion,
    pub falling: completion,
    pub cfg: *const srf04_cfg,
    pub startup_time_ms: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn srf04_handle_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn srf04_read(data: *mut srf04_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn srf04_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn srf04_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn srf04_pm_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn srf04_pm_runtime_resume(dev: *mut device) -> c_int {
    ...
    srf04_pm_runtime_resume, core::ptr::null_mut())
    };
