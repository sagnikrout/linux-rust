...
//! Source: drivers/iio/proximity/d3323aa.c
#![no_std]
...
pub const D3323AA_REG_BIT_F65: c_int = 25;
...
pub const D3323AA_THRESH_DEFAULT_VAL: c_int = 56;
pub const D3323AA_FILTER_GAIN_DEFAULT_IDX: c_int = 1;
pub const D3323AA_LP_FILTER_FREQ_DEFAULT_IDX: c_int = 1;
//
// The pattern is 0b01101, but store it reversed (0b10110) due to writing from
// LSB on the wire (c.f. d3323aa_write_settings()).
//
pub const D3323AA_SETTING_END_PATTERN: c_uint = 0x16;
pub const D3323AA_SETTING_END_PATTERN_NR_BITS: c_int = 5;
//
...
// many milliseconds.
//
pub const D3323AA_CONFIG_TIMEOUT: c_int = 1400;
// Number of IRQs needed for configuration stage after reset.
pub const D3323AA_IRQ_RESET_COUNT: c_int = 2;
//
...
//
    pub statevar_lock: mutex,
    pub dev: *mut device,
// Supply voltage.
    pub regulator_vdd: *mut regulator,
// Input clock or output detection signal (Vout).
    pub gpiod_clkin_detectout: *mut gpio_desc,
// Input (setting) or output data.
    pub gpiod_data: *mut gpio_desc,
//
...
//
    pub lp_filter_freq_idx: usize,
    pub filter_gain_idx: usize,
    pub detect_thresh: u8,
    pub irq_reset_count: u8,
...
#[no_mangle]
unsafe extern "C" fn d3323aa_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn d3323aa_reset(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn d3323aa_set_filter_gain(indio_dev: *mut iio_dev, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn d3323aa_set_threshold(indio_dev: *mut iio_dev, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn d3323aa_disable_regulator(indata: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn d3323aa_probe(pdev: *mut platform_device) -> c_int {
