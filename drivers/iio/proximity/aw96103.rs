...
//! Source: drivers/iio/proximity/aw96103.c
#![no_std]
...
pub const AW_DATA_PROCESS_FACTOR: c_int = 1024;
pub const AW96103_CHIP_ID: c_uint = 0xa961;
pub const AW96103_BIN_VALID_DATA_OFFSET: c_int = 64;
pub const AW96103_BIN_DATA_LEN_OFFSET: c_int = 16;
pub const AW96103_BIN_DATA_REG_NUM_SIZE: c_int = 4;
pub const AW96103_BIN_CHIP_TYPE_SIZE: c_int = 8;
pub const AW96103_BIN_CHIP_TYPE_OFFSET: c_int = 24;
pub const AW96103_REG_SCANCTRL0: c_uint = 0x0000;
pub const AW96103_REG_STAT0: c_uint = 0x0090;
pub const AW96103_REG_BLFILT_CH0: c_uint = 0x00A8;
pub const AW96103_REG_BLRSTRNG_CH0: c_uint = 0x00B4;
pub const AW96103_REG_DIFF_CH0: c_uint = 0x0240;
pub const AW96103_REG_FWVER2: c_uint = 0x0410;
pub const AW96103_REG_CMD: c_uint = 0xF008;
pub const AW96103_REG_IRQSRC: c_uint = 0xF080;
pub const AW96103_REG_IRQEN: c_uint = 0xF084;
pub const AW96103_REG_RESET: c_uint = 0xFF0C;
pub const AW96103_REG_CHIPID: c_uint = 0xFF10;
pub const AW96103_REG_EEDA0: c_uint = 0x0408;
pub const AW96103_REG_EEDA1: c_uint = 0x040C;
pub const AW96103_REG_PROXCTRL_CH0: c_uint = 0x00B0;
pub const AW96103_REG_PROXTH0_CH0: c_uint = 0x00B8;
pub const AW96103_PROXTH_CH_STEP: c_uint = 0x3C;

pub const AW96103_BLFILT_CH_STEP: c_uint = 0x3C;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aw_channels_info {
    pub used: bool,
    pub old_irq_status: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aw_chip_info {
...
//
    pub channels_arr: [aw_channels_info; 6],
...
#[no_mangle]
unsafe extern "C" fn aw96103_parsing_bin_file(bin: *mut aw_bin) {
...
#[no_mangle]
unsafe extern "C" fn aw96103_channel_scan_start(aw96103: *mut aw96103) -> c_int {
...
//
    ...
    {
    let mut start_addr: c_uint = aw_bin_data_s.valid_data_addr;
    u32 i, reg_data;
    u16 reg_addr;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn aw96103_para_loaded(aw96103: *mut aw96103) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(AW96103_REG_SCANCTRL0: aw96103_reg_default[i] ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn aw96103_cfg_update(fw: *const firmware, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn aw96103_sw_reset(aw96103: *mut aw96103) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw96103_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
    ...
    if (ret)
    return ret;
    ret = devm_request_threaded_irq(aw96103.dev, i2c.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn aw96103_wait_chip_init(aw96103: *mut aw96103) -> c_int {
    static int aw96103_wait_chip_init(struct aw96103 *aw96103)
    {
    let mut cnt: c_uint = 20;
    u32 reg_data;
    int ret;
    while (cnt--) {
//
...
#[no_mangle]
unsafe extern "C" fn aw96103_read_chipid(aw96103: *mut aw96103) -> c_int {
    static int aw96103_read_chipid(struct aw96103 *aw96103)
    {
    let mut cnt: c_uchar = 0;
...
#[no_mangle]
unsafe extern "C" fn aw96103_i2c_probe(i2c: *mut i2c_client) -> c_int {
