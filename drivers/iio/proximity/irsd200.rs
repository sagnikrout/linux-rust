...
//! Source: drivers/iio/proximity/irsd200.c
#![no_std]
...
// Registers.
pub const IRS_REG_OP: c_uint = 0x00	/* Operation mode. */;
pub const IRS_REG_DATA_LO: c_uint = 0x02	/* Sensor data LSB. */;
pub const IRS_REG_DATA_HI: c_uint = 0x03	/* Sensor data MSB. */;
pub const IRS_REG_STATUS: c_uint = 0x04	/* Interrupt status. */;
pub const IRS_REG_COUNT: c_uint = 0x05	/* Count of exceeding threshold. */;
pub const IRS_REG_DATA_RATE: c_uint = 0x06	/* Output data rate. */;
pub const IRS_REG_FILTER: c_uint = 0x07	/* High-pass and low-pass filter. */;
pub const IRS_REG_INTR: c_uint = 0x09	/* Interrupt mode. */;
pub const IRS_REG_NR_COUNT: c_uint = 0x0a	/* Number of counts before interrupt. */;
pub const IRS_REG_THR_HI: c_uint = 0x0b	/* Upper threshold. */;
pub const IRS_REG_THR_LO: c_uint = 0x0c	/* Lower threshold. */;
pub const IRS_REG_TIMER_LO: c_uint = 0x0d	/* Timer setting LSB. */;
pub const IRS_REG_TIMER_HI: c_uint = 0x0e	/* Timer setting MSB. */;
// Interrupt status bits.

// Operation states.
pub const IRS_OP_ACTIVE: c_uint = 0x00;
pub const IRS_OP_SLEEP: c_uint = 0x01;
//
// Quantization scale value for threshold. Used for conversion from/to register
// value.
//
pub const IRS_THR_QUANT_SCALE: c_int = 128;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct irsd200_data {
    pub regmap: *mut regmap,
    pub regfields: [*mut regmap_field; IRS_REGF_MAX],
    pub dev: *mut device,
}

#[no_mangle]
unsafe extern "C" fn irsd200_setup(data: *mut irsd200_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irsd200_read_data(data: *mut irsd200_data, val: *mut i16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irsd200_read_data_rate(data: *mut irsd200_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irsd200_write_data_rate(data: *mut irsd200_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irsd200_read_timer(data: *mut irsd200_data, val: *mut c_int, val2: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irsd200_write_timer(data: *mut irsd200_data, val: c_int, val2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irsd200_read_nr_count(data: *mut irsd200_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irsd200_write_nr_count(data: *mut irsd200_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irsd200_read_lp_filter(data: *mut irsd200_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irsd200_write_lp_filter(data: *mut irsd200_data, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irsd200_write_hp_filter(data: *mut irsd200_data, val: c_int, val2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irsd200_irq_thread(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(lower_count: !upper_count &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn irsd200_trigger_handler(irq: c_int, pollf: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn irsd200_set_trigger_state(trig: *mut iio_trigger, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irsd200_probe(client: *mut i2c_client) -> c_int {
    ...
    ret = devm_iio_triggered_buffer_setup(data.dev, indio_dev, core::ptr::null_mut(),
    irsd200_trigger_handler, core::ptr::null_mut());
    if (ret)
    return dev_err_probe(data.dev, ret,
