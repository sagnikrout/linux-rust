...
//! Source: drivers/iio/industrialio-event.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iio_event_interface {
    pub wait: wait_queue_head_t,
    pub 16): DECLARE_KFIFO(det_events, struct iio_event_data,,
    pub dev_attr_list: list_head,
    pub flags: c_ulong,
    pub group: attribute_group,
    pub read_lock: mutex,
    pub ioctl_handler: iio_ioctl_handler,
}

#[no_mangle]
pub unsafe extern "C" fn iio_event_enabled(ev_int: *const iio_event_interface) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_push_event(indio_dev: *mut iio_dev, ev_code: u64, timestamp: i64) -> c_int {
...
//
    ...
    if (ret)
    return ret;
    if (indio_dev.info == core::ptr::null_mut())
    return -ENODEV;
    }
...
#[no_mangle]
unsafe extern "C" fn iio_event_chrdev_release(inode: *mut inode, filep: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_event_getfd(indio_dev: *mut iio_dev) -> c_int {
    static int iio_event_getfd(struct iio_dev *indio_dev)
    {
    struct iio_dev_opaque *iio_dev_opaque = to_iio_dev_opaque(indio_dev);
    struct iio_event_interface *ev_int = iio_dev_opaque.event_interface;
    int fd;
    if (ev_int == core::ptr::null_mut())
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn iio_ev_attr_dir(attr: *mut iio_dev_attr) -> enum iio_event_direction {
    static enum iio_event_direction iio_ev_attr_dir(struct iio_dev_attr *attr)
    {
    return attr.c.event_spec[attr.address & 0xffff].dir;
    }
#[no_mangle]
unsafe extern "C" fn iio_ev_attr_type(attr: *mut iio_dev_attr) -> enum iio_event_type {
    static enum iio_event_type iio_ev_attr_type(struct iio_dev_attr *attr)
    {
    return attr.c.event_spec[attr.address & 0xffff].type;
    }
#[no_mangle]
unsafe extern "C" fn iio_ev_attr_info(attr: *mut iio_dev_attr) -> enum iio_event_info {
    ...
    if (postfix == core::ptr::null_mut())
    return -ENOMEM;
    ret = __iio_add_chan_devattr(postfix, chan, &iio_ev_label_show, core::ptr::null_mut(),
    spec_index, IIO_SEPARATE, &indio_dev.dev, core::ptr::null_mut(),
    &iio_dev_opaque.event_interface.dev_attr_list);
    kfree(postfix);
    if (ret < 0)
    return ret;
    ...
    {
    let mut ret: c_int = 0, i, attrcount = 0;
    enum iio_event_direction dir;
    enum iio_event_type type;
...
#[no_mangle]
pub unsafe extern "C" fn __iio_add_event_config_attrs(indio_dev: *mut iio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iio_check_for_dynamic_events(indio_dev: *mut iio_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iio_setup_ev_int(ev_int: *mut iio_event_interface) {
...
#[no_mangle]
pub unsafe extern "C" fn iio_device_register_eventset(indio_dev: *mut iio_dev) -> c_int {
    int iio_device_register_eventset(struct iio_dev *indio_dev)
    {
    struct iio_dev_opaque *iio_dev_opaque = to_iio_dev_opaque(indio_dev);
    struct iio_event_interface *ev_int;
    struct iio_dev_attr *p;
    let mut ret: c_int = 0, attrcount_orig = 0, attrcount, attrn;
    ...
    if (indio_dev.info.event_attrs != core::ptr::null_mut()) {
    ...
    attrcount + 1);
    if (ev_int.group.attrs == core::ptr::null_mut()) {
    ret = -ENOMEM;
    goto error_free_setup_event_lines;
    }
    if (indio_dev.info.event_attrs)
...
// Add all elements from the list.
    ...
    kfree(ev_int);
    iio_dev_opaque.event_interface = core::ptr::null_mut();
    return ret;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn iio_device_wakeup_eventset(indio_dev: *mut iio_dev) {
    void iio_device_wakeup_eventset(struct iio_dev *indio_dev)
    {
    struct iio_dev_opaque *iio_dev_opaque = to_iio_dev_opaque(indio_dev);
    if (iio_dev_opaque.event_interface == core::ptr::null_mut())
    return;
    wake_up(&iio_dev_opaque.event_interface.wait);
    }
#[no_mangle]
pub unsafe extern "C" fn iio_device_unregister_eventset(indio_dev: *mut iio_dev) {
