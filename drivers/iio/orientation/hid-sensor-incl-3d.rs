...
//! Source: drivers/iio/orientation/hid-sensor-incl-3d.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct incl_3d_state {
    pub callbacks: hid_sensor_hub_callbacks,
    pub common_attributes: hid_sensor_common,
    pub incl: [hid_sensor_hub_attribute_info; INCLI_3D_CHANNEL_MAX],
    struct {
    pub incl_val: [u32; INCLI_3D_CHANNEL_MAX],
...
#[no_mangle]
unsafe extern "C" fn incl_3d_adjust_channel_bit_mask(chan: *mut iio_chan_spec, size: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hid_incl_3d_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_incl_3d_remove(pdev: *mut platform_device) {
