...
//! Source: drivers/iio/cdc/ad7150.c
#![no_std]
...
pub const AD7150_STATUS_REG: c_int = 0;

pub const AD7150_CH1_DATA_HIGH_REG: c_int = 1;
pub const AD7150_CH2_DATA_HIGH_REG: c_int = 3;
pub const AD7150_CH1_AVG_HIGH_REG: c_int = 5;
pub const AD7150_CH2_AVG_HIGH_REG: c_int = 7;
pub const AD7150_CH1_SENSITIVITY_REG: c_int = 9;
pub const AD7150_CH1_THR_HOLD_H_REG: c_int = 9;
pub const AD7150_CH1_TIMEOUT_REG: c_int = 10;

pub const AD7150_CH1_SETUP_REG: c_int = 11;
pub const AD7150_CH2_SENSITIVITY_REG: c_int = 12;
pub const AD7150_CH2_THR_HOLD_H_REG: c_int = 12;
pub const AD7150_CH2_TIMEOUT_REG: c_int = 13;
pub const AD7150_CH2_SETUP_REG: c_int = 14;
pub const AD7150_CFG_REG: c_int = 15;

pub const AD7150_CFG_TT_NEG: c_uint = 0x0;
pub const AD7150_CFG_TT_POS: c_uint = 0x1;
pub const AD7150_CFG_TT_IN_WINDOW: c_uint = 0x2;
pub const AD7150_CFG_TT_OUT_WINDOW: c_uint = 0x3;
pub const AD7150_PD_TIMER_REG: c_int = 16;
pub const AD7150_CH1_CAPDAC_REG: c_int = 17;
pub const AD7150_CH2_CAPDAC_REG: c_int = 18;
pub const AD7150_SN3_REG: c_int = 19;
pub const AD7150_SN2_REG: c_int = 20;
pub const AD7150_SN1_REG: c_int = 21;
pub const AD7150_SN0_REG: c_int = 22;
pub const AD7150_ID_REG: c_int = 23;
    enum {
    AD7150,
    AD7151,
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7150_chip_info {
    pub client: *mut i2c_client,
    pub threshold: [u16; 2][2],
    pub thresh_sensitivity: [u8; 2][2],
    pub thresh_timeout: [u8; 2][2],
    pub state_lock: mutex,
    pub interrupts: [c_int; 2],
    pub int_enabled: [bool; 2],
    pub type: enum iio_event_type,
    ...
    let mut channel: c_int = chan.channel;
    int ret;
    switch (mask) {
...
// state_lock should be held to ensure consistent state
    ...
    {
    struct ad7150_chip_info *chip = iio_priv(indio_dev);
    let mut rising: c_int = (dir == IIO_EV_DIR_RISING);
...
// Note completely different from the adaptive versions
    case IIO_EV_TYPE_THRESH: {
    let mut value: u16 = chip.threshold[rising][chan];
...
//
    let mut timeout: c_int = val2 / 10000;
...
#[no_mangle]
unsafe extern "C" fn ad7150_event_handler_ch1(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad7150_event_handler_ch2(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ad7150_probe(client: *mut i2c_client) -> c_int {
    static int ad7150_probe(struct i2c_client *client)
    {
    const struct i2c_device_id *id = i2c_client_get_device_id(client);
    struct ad7150_chip_info *chip;
    struct iio_dev *indio_dev;
    let mut use_irq: bool = true;
    int ret;
    ...
    use_irq = false;
#[no_mangle]
pub unsafe extern "C" fn if(AD7150: id->driver_data ==) -> else {
