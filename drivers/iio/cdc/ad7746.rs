...
//! Source: drivers/iio/cdc/ad7746.c
#![no_std]
...
pub const AD7746_REG_STATUS: c_int = 0;
pub const AD7746_REG_CAP_DATA_HIGH: c_int = 1;
pub const AD7746_REG_VT_DATA_HIGH: c_int = 4;
pub const AD7746_REG_CAP_SETUP: c_int = 7;
pub const AD7746_REG_VT_SETUP: c_int = 8;
pub const AD7746_REG_EXC_SETUP: c_int = 9;
pub const AD7746_REG_CFG: c_int = 10;
pub const AD7746_REG_CAPDACA: c_int = 11;
pub const AD7746_REG_CAPDACB: c_int = 12;
pub const AD7746_REG_CAP_OFFH: c_int = 13;
pub const AD7746_REG_CAP_GAINH: c_int = 15;
pub const AD7746_REG_VOLT_GAINH: c_int = 17;
...
pub const AD7746_VTSETUP_VTMD_INT_TEMP: c_int = 0;
pub const AD7746_VTSETUP_VTMD_EXT_TEMP: c_int = 1;
pub const AD7746_VTSETUP_VTMD_VDD_MON: c_int = 2;
pub const AD7746_VTSETUP_VTMD_EXT_VIN: c_int = 3;

// Excitation Setup Register Bit Designations (AD7746_REG_EXC_SETUP)

// Config Register Bit Designations (AD7746_REG_CFG)

pub const AD7746_CONF_MODE_IDLE: c_int = 0;
pub const AD7746_CONF_MODE_CONT_CONV: c_int = 1;
pub const AD7746_CONF_MODE_SINGLE_CONV: c_int = 2;
pub const AD7746_CONF_MODE_PWRDN: c_int = 3;
pub const AD7746_CONF_MODE_OFFS_CAL: c_int = 5;
pub const AD7746_CONF_MODE_GAIN_CAL: c_int = 6;
// CAPDAC Register Bit Designations (AD7746_REG_CAPDACx)

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7746_chip_info {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7746_chan_info {
    pub addr: u8,
    union {
    pub vtmd: u8,
    struct { /* CAP SETUP fields */
    pub 1: unsigned int cin2 :,
    pub 1: unsigned int capdiff :,
}
...
#[no_mangle]
unsafe extern "C" fn ad7746_set_capdac(chip: *mut ad7746_chip_info, channel: c_int) -> c_int {
    ...
    0200, core::ptr::null_mut(), ad7746_start_offset_calib, CIN1);
    static IIO_DEVICE_ATTR(in_capacitance1_calibbias_calibration,
    0200, core::ptr::null_mut(), ad7746_start_offset_calib, CIN2);
    static IIO_DEVICE_ATTR(in_capacitance0_calibscale_calibration,
    0200, core::ptr::null_mut(), ad7746_start_gain_calib, CIN1);
    static IIO_DEVICE_ATTR(in_capacitance1_calibscale_calibration,
    0200, core::ptr::null_mut(), ad7746_start_gain_calib, CIN2);
    static IIO_DEVICE_ATTR(in_voltage0_calibscale_calibration,
    0200, core::ptr::null_mut(), ad7746_start_gain_calib, VIN);
...
#[no_mangle]
unsafe extern "C" fn ad7746_probe(client: *mut i2c_client) -> c_int {
