...
//! Source: drivers/iio/amplifiers/ad8366.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad8366_state {
    pub spi: *mut spi_device,
    pub /: *mut *mut mutex lock; / protect sensor state,
    pub ch: [c_uchar; 2],
    pub info: *const ad8366_info,
//
// DMA (thus cache coherency maintenance) may require the
// transfer buffers to live in their own cache lines.
//
    pub __aligned(IIO_DMA_MINALIGN): unsigned char data[2],
}

    static size_t ad8366_pack_code(const unsigned char *code, size_t num_channels,
    unsigned char *data)
    {
    let mut ch_a: u8 = bitrev8(code[0]) >> 2;
    let mut ch_b: u8 = bitrev8(code[1]) >> 2;
...
#[no_mangle]
unsafe extern "C" fn ad8366_write_code(st: *mut ad8366_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad8366_probe(spi: *mut spi_device) -> c_int {
