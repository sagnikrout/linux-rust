...
pub const GNSS_MINORS: c_int = 16;
    static DEFINE_IDA(gnss_minors);
    static dev_t gnss_first;
// FIFO size must be a power of two
pub const GNSS_READ_FIFO_SIZE: c_int = 4096;
pub const GNSS_WRITE_BUF_SIZE: c_int = 1024;

#[no_mangle]
unsafe extern "C" fn gnss_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gnss_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gnss_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn gnss_device_release(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn gnss_put_device(gdev: *mut gnss_device) {
...
#[no_mangle]
pub unsafe extern "C" fn gnss_register_device(gdev: *mut gnss_device) -> c_int {
    int gnss_register_device(struct gnss_device *gdev)
    {
    int ret;
// Set a flag which can be accessed without holding the rwsem.
    if (gdev.ops.write_raw != core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn gnss_deregister_device(gdev: *mut gnss_device) {
...
#[no_mangle]
unsafe extern "C" fn gnss_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gnss_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gnss_module_exit() -> void __exit {
