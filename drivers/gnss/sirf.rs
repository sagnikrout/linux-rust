...
pub const SIRF_BOOT_DELAY: c_int = 500;
pub const SIRF_ON_OFF_PULSE_TIME: c_int = 100;
pub const SIRF_ACTIVATE_TIMEOUT: c_int = 200;
pub const SIRF_HIBERNATE_TIMEOUT: c_int = 200;
//
...
//
pub const SIRF_REPORT_CYCLE: c_int = 2000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sirf_data {
    pub gdev: *mut gnss_device,
    pub serdev: *mut serdev_device,
    pub speed: speed_t,
    pub vcc: *mut regulator,
    pub lna: *mut regulator,
    pub on_off: *mut gpio_desc,
    pub wakeup: *mut gpio_desc,
    pub irq: c_int,
    pub active: bool,
    pub gdev_mutex: mutex,
    pub open: bool,
    pub serdev_mutex: mutex,
    pub serdev_count: c_int,
    pub power_wait: wait_queue_head_t,
}

#[no_mangle]
unsafe extern "C" fn sirf_serdev_open(data: *mut sirf_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sirf_serdev_close(data: *mut sirf_data) {
...
#[no_mangle]
unsafe extern "C" fn sirf_open(gdev: *mut gnss_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sirf_close(gdev: *mut gnss_device) {
...
#[no_mangle]
unsafe extern "C" fn sirf_wakeup_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sirf_pulse_on_off(data: *mut sirf_data) {
...
#[no_mangle]
unsafe extern "C" fn sirf_set_active(data: *mut sirf_data, active: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sirf_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sirf_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sirf_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn sirf_resume(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(sirf_runtime_suspend, sirf_runtime_resume, core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn sirf_parse_dt(serdev: *mut serdev_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sirf_probe(serdev: *mut serdev_device) -> c_int {
...
// Wait for chip to boot into hibernate mode.
    ...
    goto err_disable_vcc;
    data.irq = ret;
    ret = request_threaded_irq(data.irq, core::ptr::null_mut(), sirf_wakeup_handler,
...
#[no_mangle]
unsafe extern "C" fn sirf_remove(serdev: *mut serdev_device) {
