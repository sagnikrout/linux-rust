...
pub const GNSS_USB_READ_BUF_LEN: c_int = 512;
pub const GNSS_USB_WRITE_TIMEOUT: c_int = 1000;
...
#[no_mangle]
unsafe extern "C" fn gnss_usb_open(gdev: *mut gnss_device) -> c_int {
...
unsafe extern "C" fn gnss_usb_close(gdev: *mut gnss_device) {
    ...
    if (!tbuf)
    return -ENOMEM;
    ret = usb_bulk_msg(gusb.udev, gusb.write_pipe, tbuf, count, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn gnss_usb_probe(intf: *mut usb_interface, id: *const usb_device_id) -> c_int {
