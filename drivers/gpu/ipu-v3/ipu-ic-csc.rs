...
//! Source: drivers/gpu/ipu-v3/ipu-ic-csc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn calc_csc_coeffs(csc: *mut ipu_ic_csc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __ipu_ic_calc_csc(csc: *mut ipu_ic_csc) -> c_int {
