...
//! Source: drivers/gpu/ipu-v3/ipu-common.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ipu_cm_read(ipu: *mut ipu_soc, offset: unsigned) -> u32 {
    static inline u32 ipu_cm_read(struct ipu_soc *ipu, unsigned offset)
    {
    return readl(ipu.cm_reg + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn ipu_cm_write(ipu: *mut ipu_soc, value: u32, offset: unsigned) {
    static inline void ipu_cm_write(struct ipu_soc *ipu, u32 value, unsigned offset)
    {
    writel(value, ipu.cm_reg + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn ipu_get_num(ipu: *mut ipu_soc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_srm_dp_update(ipu: *mut ipu_soc, sync: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_drm_fourcc_to_colorspace(drm_fourcc: u32) -> enum ipu_color_space {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_pixelformat_to_colorspace(pixelformat: u32) -> enum ipu_color_space {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_idmac_put(channel: *mut ipuv3_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn __ipu_idmac_reset_current_buffer(channel: *mut ipuv3_channel) {
    static void __ipu_idmac_reset_current_buffer(struct ipuv3_channel *channel)
    {
    struct ipu_soc *ipu = channel.ipu;
    let mut chno: c_uint = channel.num;
...
#[no_mangle]
pub unsafe extern "C" fn ipu_idmac_lock_enable(channel: *mut ipuv3_channel, num_bursts: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_module_enable(ipu: *mut ipu_soc, mask: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_module_disable(ipu: *mut ipu_soc, mask: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_idmac_get_current_buffer(channel: *mut ipuv3_channel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_idmac_buffer_is_ready(channel: *mut ipuv3_channel, buf_num: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_idmac_select_buffer(channel: *mut ipuv3_channel, buf_num: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_idmac_clear_buffer(channel: *mut ipuv3_channel, buf_num: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_idmac_enable_channel(channel: *mut ipuv3_channel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_idmac_wait_busy(channel: *mut ipuv3_channel, ms: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_idmac_disable_channel(channel: *mut ipuv3_channel) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ipu_idmac_enable_watermark(channel: *mut ipuv3_channel, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn ipu_memory_reset(ipu: *mut ipu_soc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ipu_set_csi_src_mux(ipu: *mut ipu_soc, csi_id: c_int, mipi_csi2: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ipu_set_ic_src_mux(ipu: *mut ipu_soc, csi_id: c_int, vdi: bool) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsu_link_info {
    pub src: fsu_link_reg_info,
    pub sink: fsu_link_reg_info,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn ipu_fsu_link(ipu: *mut ipu_soc, src_ch: c_int, sink_ch: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ipu_fsu_unlink(ipu: *mut ipu_soc, src_ch: c_int, sink_ch: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_idmac_link(src: *mut ipuv3_channel, sink: *mut ipuv3_channel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_idmac_unlink(src: *mut ipuv3_channel, sink: *mut ipuv3_channel) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ipu_devtype {
    pub name: *const c_char,
    pub cm_ofs: c_ulong,
    pub cpmem_ofs: c_ulong,
    pub srm_ofs: c_ulong,
    pub tpm_ofs: c_ulong,
    pub csi0_ofs: c_ulong,
    pub csi1_ofs: c_ulong,
    pub ic_ofs: c_ulong,
    pub disp0_ofs: c_ulong,
    pub disp1_ofs: c_ulong,
    pub dc_tmpl_ofs: c_ulong,
    pub vdi_ofs: c_ulong,
    pub type: enum ipuv3_type,
}
...
#[no_mangle]
unsafe extern "C" fn ipu_irq_handle(ipu: *mut ipu_soc, regs: *const c_int, num_regs: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ipu_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn ipu_err_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_map_irq(ipu: *mut ipu_soc, irq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipu_submodules_exit(ipu: *mut ipu_soc) {
...
#[no_mangle]
unsafe extern "C" fn platform_remove_devices_fn(dev: *mut device, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn platform_device_unregister_children(pdev: *mut platform_device) {
    static void platform_device_unregister_children(struct platform_device *pdev)
    {
    device_for_each_child(&pdev.dev, core::ptr::null_mut(), platform_remove_devices_fn);
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ipu_platform_reg {
    pub pdata: ipu_client_platformdata,
    pub name: *const c_char,
}
...
#[no_mangle]
unsafe extern "C" fn ipu_add_client_devices(ipu: *mut ipu_soc, ipu_base: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipu_irq_init(ipu: *mut ipu_soc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipu_irq_exit(ipu: *mut ipu_soc) {
    static void ipu_irq_exit(struct ipu_soc *ipu)
    {
    int i, irq;
    irq_set_chained_handler_and_data(ipu.irq_err, core::ptr::null_mut(), core::ptr::null_mut());
    irq_set_chained_handler_and_data(ipu.irq_sync, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn ipu_dump(ipu: *mut ipu_soc) {
...
#[no_mangle]
unsafe extern "C" fn ipu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipu_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn imx_ipu_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn imx_ipu_exit() -> void __exit {
