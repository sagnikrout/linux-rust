...
//! Source: drivers/gpu/host1x/hw/channel_hw.c
#![no_std]
...
//
    ...
    let mut num_words: u32 = min(words - i, TRACE_MAX_LENGTH);
...
#[no_mangle]
unsafe extern "C" fn submit_wait(job: *mut host1x_job, id: u32, threshold: u32) {
...
#[no_mangle]
unsafe extern "C" fn submit_setclass(job: *mut host1x_job, next_class: u32) {
...
//
    ...
    let mut addr: dma_addr_t = g.base + g.offset;
    u32 op2, op3;
    ...
    let mut op1: u32 = host1x_opcode_gather_wide(g.words);
    let mut op4: u32 = HOST1X_OPCODE_NOP;
    ...
    let mut op1: u32 = host1x_opcode_gather(g.words);
...
#[no_mangle]
pub unsafe extern "C" fn synchronize_syncpt_base(job: *mut host1x_job) {
...
#[no_mangle]
unsafe extern "C" fn host1x_channel_set_streamid(channel: *mut host1x_channel) {
...
#[no_mangle]
unsafe extern "C" fn host1x_enable_gather_filter(ch: *mut host1x_channel) {
...
#[no_mangle]
unsafe extern "C" fn channel_program_cdma(job: *mut host1x_job) {
...
#[no_mangle]
unsafe extern "C" fn job_complete_callback(fence: *mut dma_fence, cb: *mut dma_fence_cb) {
...
#[no_mangle]
unsafe extern "C" fn channel_submit(job: *mut host1x_job) -> c_int {
