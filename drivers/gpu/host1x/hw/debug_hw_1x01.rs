...
//! Source: drivers/gpu/host1x/hw/debug_hw_1x01.c
#![no_std]
...
//
    ...
    data_count = show_channel_command(o, val, core::ptr::null_mut());
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: HOST1X_SYNC_MLOCK_OWNER_CPU_OWNS_V(owner)) -> else {
