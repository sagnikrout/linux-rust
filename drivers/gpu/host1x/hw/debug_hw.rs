...
//! Source: drivers/gpu/host1x/hw/debug_hw.c
#![no_std]
...
pub const HOST1X_DEBUG_MAX_PAGE_OFFSET: c_int = 102400;
    enum {
...
pub const INVALID_PAYLOAD: c_uint = 0xffffffff;
...
// payload = val & 0xffff;
    ...
    val & 0xff);
#[no_mangle]
pub unsafe extern "C" fn if(HOST1X_OPCODE_EXTEND_RELEASE_MLOCK: subop ==) -> else {
...
// Map dmaget cursor to corresponding mem handle
    let mut offset: u32 = phys_addr - pin_addr;
    let mut data_count: c_uint = 0, i;
...
//
    ...
    for (i = 0; i < words; i++) {
    let mut addr: dma_addr_t = phys_addr + i * 4;
    let mut voffset: u32 = offset + i * 4;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn show_channel_gathers(o: *mut output, cdma: *mut host1x_cdma) {
    ...
    show_gather(o, g.base + g.offset, g.words, core::ptr::null_mut(),
    g.base, mapped);
    if (!job.gather_copy_mapped)
