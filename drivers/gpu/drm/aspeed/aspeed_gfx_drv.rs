...
//! Source: drivers/gpu/drm/aspeed/aspeed_gfx_drv.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_gfx_config {
    pub /: *mut *mut u32 dac_reg; / DAC register in SCU,
    pub /: *mut *mut u32 int_clear_reg; / Interrupt clear register,
    pub /: *mut *mut u32 vga_scratch_reg; / VGA scratch register in SCU,
    pub /: *mut *mut u32 throd_val; / Default Threshold Seting,
    pub /: *mut *mut u32 scan_line_max; / Max memory size of one scan line,
}
...
#[no_mangle]
unsafe extern "C" fn aspeed_gfx_setup_mode_config(drm: *mut drm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gfx_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gfx_load(drm: *mut drm_device) -> c_int {
    ...
    priv.rst = devm_reset_control_get_exclusive(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(priv.rst)) {
    dev_err(&pdev.dev,
    ...
    priv.clk = devm_clk_get(drm.dev, core::ptr::null_mut());
    if (IS_ERR(priv.clk)) {
    dev_err(&pdev.dev,
...
#[no_mangle]
unsafe extern "C" fn aspeed_gfx_unload(drm: *mut drm_device) {
...
#[no_mangle]
unsafe extern "C" fn dac_mux_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gfx_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (ret)
    goto err_unload;
    drm_client_setup(&priv.drm, core::ptr::null_mut());
    return 0;
    err_unload:
...
#[no_mangle]
unsafe extern "C" fn aspeed_gfx_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gfx_shutdown(pdev: *mut platform_device) {
