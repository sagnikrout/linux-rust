...
//! Source: drivers/gpu/drm/rockchip/rockchip_vop2_reg.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vop2_alpha {
    pub src_color_ctrl: union vop2_alpha_ctrl,
    pub dst_color_ctrl: union vop2_alpha_ctrl,
    pub src_alpha_ctrl: union vop2_alpha_ctrl,
    pub dst_alpha_ctrl: union vop2_alpha_ctrl,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vop2_alpha_config {
    pub src_premulti_en: bool,
    pub dst_premulti_en: bool,
    pub src_pixel_alpha_en: bool,
    pub dst_pixel_alpha_en: bool,
    pub src_glb_alpha_value: u16,
    pub dst_glb_alpha_value: u16,
}
...
#[no_mangle]
unsafe extern "C" fn rk3568_set_intf_mux(vp: *mut vop2_video_port, id: c_int, polflags: u32) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn rk3576_set_intf_mux(vp: *mut vop2_video_port, id: c_int, polflags: u32) -> c_ulong {
    ...
    let mut port_pix_rate: u8 = vp.data.pixel_rate;
...
//
#[no_mangle]
unsafe extern "C" fn rk3588_calc_dclk(child_clk: c_ulong, max_dclk: c_ulong) -> c_ulong {
    static unsigned long rk3588_calc_dclk(unsigned long child_clk, unsigned long max_dclk)
    {
    if (child_clk * 4 <= max_dclk)
    return child_clk * 4;
#[no_mangle]
pub unsafe extern "C" fn if(max_dclk: *mut *mut child_clk  2 <=) -> else {
    else if (child_clk * 2 <= max_dclk)
    return child_clk * 2;
#[no_mangle]
pub unsafe extern "C" fn if(max_dclk: child_clk <=) -> else {
...
//
    ...
    struct drm_display_mode *adjusted_mode = &crtc.state.adjusted_mode;
    struct rockchip_crtc_state *vcstate = to_rockchip_crtc_state(crtc.state);
    let mut output_mode: c_int = vcstate.output_mode;
    unsigned long v_pixclk = adjusted_mode.crtc_clock * 1000LL; /* video timing pixclk */
    let mut dclk_core_rate: c_ulong = v_pixclk >> 2;
    let mut dclk_rate: c_ulong = v_pixclk;
...
//
#[no_mangle]
unsafe extern "C" fn rk3588_get_mipi_port_mux(vp_id: c_int) -> u32 {
    static u32 rk3588_get_mipi_port_mux(int vp_id)
    {
    if (vp_id == 1)
    return 3;
#[no_mangle]
pub unsafe extern "C" fn if(3: vp_id ==) -> else {
    else if (vp_id == 3)
    return 1;
    else
    return 0;
...
#[no_mangle]
unsafe extern "C" fn rk3588_get_hdmi_pol(flags: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rk3588_set_intf_mux(vp: *mut vop2_video_port, id: c_int, polflags: u32) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn is_opaque(alpha: u16) -> bool {
    ...
    {
    let mut src_glb_alpha_en: c_int = is_opaque(alpha_config.src_glb_alpha_value) ? 0 : 1;
    let mut dst_glb_alpha_en: c_int = is_opaque(alpha_config.dst_glb_alpha_value) ? 0 : 1;
...
#[no_mangle]
pub unsafe extern "C" fn if(!src_glb_alpha_en: alpha_config->src_pixel_alpha_en &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn vop2_find_start_mixer_id_for_vp(vp: *mut vop2_video_port) -> c_int {
    static int vop2_find_start_mixer_id_for_vp(struct vop2_video_port *vp)
    {
    struct vop2 *vop2 = vp.vop2;
    struct vop2_win *win;
    let mut layer_sel: u32 = vop2.old_layer_sel;
    let mut used_layer: u32 = 0;
    let mut win_mask: c_ulong = vp.win_mask;
...
#[no_mangle]
unsafe extern "C" fn vop2_setup_cluster_alpha(vop2: *mut vop2, main_win: *mut vop2_win) {
    static void vop2_setup_cluster_alpha(struct vop2 *vop2, struct vop2_win *main_win)
    {
    struct vop2_alpha_config alpha_config;
    struct vop2_alpha alpha;
    struct drm_plane_state *bottom_win_pstate;
    let mut src_pixel_alpha_en: bool = false;
    u16 src_glb_alpha_val, dst_glb_alpha_val;
    u32 src_color_ctrl_reg, dst_color_ctrl_reg, src_alpha_ctrl_reg, dst_alpha_ctrl_reg;
    let mut offset: u32 = 0;
    let mut premulti_en: bool = false;
...
#[no_mangle]
unsafe extern "C" fn vop2_setup_alpha(vp: *mut vop2_video_port) {
    ...
    u32 src_color_ctrl_reg, dst_color_ctrl_reg, src_alpha_ctrl_reg, dst_alpha_ctrl_reg;
    u32 offset;
    let mut bottom_layer_alpha_en: bool = false;
    let mut dst_global_alpha: u32 = DRM_BLEND_ALPHA_OPAQUE;
    if (vop2.version <= VOP_VERSION_RK3588)
...
//
    ...
    drm_atomic_crtc_for_each_plane(plane, &vp.crtc) {
    struct vop2_win *win = to_vop2_win(plane);
    let mut zpos: c_int = plane.state.normalized_zpos;
//
...
#[no_mangle]
unsafe extern "C" fn rk3568_vop2_read_port_mux(vop2: *mut vop2) -> u32 {
    static u32 rk3568_vop2_read_port_mux(struct vop2 *vop2)
    {
    return vop2_readl(vop2, RK3568_OVL_PORT_SEL);
    }
#[no_mangle]
unsafe extern "C" fn rk3568_vop2_wait_for_port_mux_done(vop2: *mut vop2) {
...
#[no_mangle]
unsafe extern "C" fn rk3568_vop2_read_layer_cfg(vop2: *mut vop2) -> u32 {
    static u32 rk3568_vop2_read_layer_cfg(struct vop2 *vop2)
    {
    return vop2_readl(vop2, RK3568_OVL_LAYER_SEL);
    }
#[no_mangle]
unsafe extern "C" fn rk3568_vop2_wait_for_layer_cfg_done(vop2: *mut vop2) {
...
#[no_mangle]
unsafe extern "C" fn rk3568_vop2_setup_layer_mixer(vp: *mut vop2_video_port) {
...
#[no_mangle]
unsafe extern "C" fn rk3568_vop2_setup_dly_for_windows(vp: *mut vop2_video_port) {
    static void rk3568_vop2_setup_dly_for_windows(struct vop2_video_port *vp)
    {
    struct vop2 *vop2 = vp.vop2;
    struct vop2_win *win;
    let mut i: c_int = 0;
    let mut cdly: u32 = 0, sdly = 0;
    for (i = 0; i < vop2.data.win_size; i++) {
    u32 dly;
    win = &vop2.win[i];
    dly = win.delay;
...
#[no_mangle]
unsafe extern "C" fn rk3568_vop2_setup_overlay(vp: *mut vop2_video_port) {
...
#[no_mangle]
unsafe extern "C" fn rk3576_vop2_setup_layer_mixer(vp: *mut vop2_video_port) {
...
#[no_mangle]
unsafe extern "C" fn rk3576_vop2_setup_dly_for_windows(vp: *mut vop2_video_port) {
...
#[no_mangle]
unsafe extern "C" fn rk3576_vop2_setup_overlay(vp: *mut vop2_video_port) {
...
#[no_mangle]
unsafe extern "C" fn rk3568_vop2_setup_bg_dly(vp: *mut vop2_video_port) {
    static void rk3568_vop2_setup_bg_dly(struct vop2_video_port *vp)
    {
    struct drm_crtc *crtc = &vp.crtc;
    struct drm_display_mode *mode = &crtc.state.adjusted_mode;
    let mut hdisplay: u16 = mode.crtc_hdisplay;
    let mut hsync_len: u16 = mode.crtc_hsync_end - mode.crtc_hsync_start;
    u32 bg_dly;
    u32 pre_scan_dly;
...
#[no_mangle]
unsafe extern "C" fn rk3576_vop2_setup_bg_dly(vp: *mut vop2_video_port) {
...
#[no_mangle]
unsafe extern "C" fn vop2_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vop2_remove(pdev: *mut platform_device) {
