...
//! Source: drivers/gpu/drm/rockchip/dw_hdmi_qp-rockchip.c
#![no_std]
...
pub const RK3576_IOC_MISC_CON0: c_uint = 0xa400;

pub const RK3576_IOC_HDMI_HPD_STATUS: c_uint = 0xa440;

pub const RK3576_VO0_GRF_SOC_CON1: c_uint = 0x0004;

pub const RK3576_VO0_GRF_SOC_CON8: c_uint = 0x0020;

pub const RK3576_8BPC: c_uint = 0x0;
pub const RK3576_10BPC: c_uint = 0x6;

pub const RK3576_VO0_GRF_SOC_CON14: c_uint = 0x0038;

pub const RK3588_GRF_SOC_CON2: c_uint = 0x0308;

pub const RK3588_GRF_SOC_CON7: c_uint = 0x031c;

pub const RK3588_GRF_SOC_STATUS1: c_uint = 0x0384;

pub const RK3588_GRF_VO1_CON3: c_uint = 0x000c;
pub const RK3588_GRF_VO1_CON6: c_uint = 0x0018;

pub const RK3588_8BPC: c_uint = 0x0;
pub const RK3588_10BPC: c_uint = 0x6;

pub const RK3588_GRF_VO1_CON9: c_uint = 0x0024;

pub const HOTPLUG_DEBOUNCE_MS: c_int = 150;
pub const MAX_HDMI_PORT_NUM: c_int = 2;
pub const RK_COLOR_FMT_RGB: c_uint = 0x0;
pub const RK_COLOR_FMT_YUV422: c_uint = 0x1;
pub const RK_COLOR_FMT_YUV444: c_uint = 0x2;
pub const RK_COLOR_FMT_YUV420: c_uint = 0x3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_hdmi_qp {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub vo_regmap: *mut regmap,
    pub encoder: rockchip_encoder,
    pub hdmi: *mut dw_hdmi_qp,
    pub phy: *mut phy,
    pub frl_enable_gpio: *mut gpio_desc,
    pub hpd_work: delayed_work,
    pub port_id: c_int,
    pub ctrl_ops: *const rockchip_hdmi_qp_ctrl_ops,
    pub tmds_char_rate: c_ulonglong,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_hdmi_qp_ctrl_ops {
    pub hdmi): *mut *mut void (io_init)(struct rockchip_hdmi_qp,
    pub state): *mut *mut *mut void (enc_init)(struct rockchip_hdmi_qp hdmi, struct rockchip_crtc_state,
    pub dev_id): *mut *mut irqreturn_t (irq_callback)(int irq, void,
    pub dev_id): *mut *mut irqreturn_t (hardirq_callback)(int irq, void,
}
...
//
#[no_mangle]
unsafe extern "C" fn dw_hdmi_qp_rockchip_bus_fmt_to_reg(bus_fmt: u32) -> int __pure {
...
#[no_mangle]
unsafe extern "C" fn dw_hdmi_qp_rockchip_encoder_enable(encoder: *mut drm_encoder) {
...
//
    ...
    struct rockchip_hdmi_qp *hdmi = to_rockchip_hdmi_qp(encoder);
    let mut phy_cfg: union phy_configure_opts = {};
    int ingest_fmt;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn dw_hdmi_qp_rk3588_phy_init(dw_hdmi: *mut dw_hdmi_qp, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_hdmi_qp_rk3588_setup_hpd(dw_hdmi: *mut dw_hdmi_qp, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dw_hdmi_qp_rk3576_setup_hpd(dw_hdmi: *mut dw_hdmi_qp, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dw_hdmi_qp_rk3588_hpd_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn dw_hdmi_qp_rk3576_hardirq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dw_hdmi_qp_rk3576_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dw_hdmi_qp_rk3588_hardirq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dw_hdmi_qp_rk3588_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dw_hdmi_qp_rk3576_io_init(hdmi: *mut rockchip_hdmi_qp) {
...
#[no_mangle]
unsafe extern "C" fn dw_hdmi_qp_rk3588_io_init(hdmi: *mut rockchip_hdmi_qp) {
    ...
    {
    let mut color: c_int = dw_hdmi_qp_rockchip_bus_fmt_to_reg(state.bus_format);
    u32 val;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_hdmi_qp_cfg {
    pub num_ports: c_uint,
    pub port_ids: [c_uint; MAX_HDMI_PORT_NUM],
    pub ctrl_ops: *const rockchip_hdmi_qp_ctrl_ops,
    ...
    let mut plat_data: dw_hdmi_qp_plat_data = {};
...
#[no_mangle]
unsafe extern "C" fn dw_hdmi_qp_rockchip_resume(dev: *mut device) -> int __maybe_unused {
