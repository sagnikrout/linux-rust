...
//! Source: drivers/gpu/drm/rockchip/analogix_dp-rockchip.c
#![no_std]
...
pub const PSR_WAIT_LINE_FLAG_TIMEOUT_MS: c_int = 100;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_grf_reg_field {
    pub reg: u32,
    pub lsb: u32,
    pub msb: u32,
    pub valid: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_dp_chip_data {
    pub lcdc_sel: rockchip_grf_reg_field,
    pub edp_mode: rockchip_grf_reg_field,
    pub chip_type: u32,
    pub reg: u32,
}
...
pub struct rockchip_dp_device {
    ...
    pub apbrst: *mut reset_control,
    pub data: *const rockchip_dp_chip_data,
...
#[no_mangle]
unsafe extern "C" fn rockchip_grf_write(grf: *mut regmap, reg: u32, mask: u32, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dp_pre_init(dp: *mut rockchip_dp_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dp_poweron(plat_data: *mut analogix_dp_plat_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dp_powerdown(plat_data: *mut analogix_dp_plat_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dp_of_probe(dp: *mut rockchip_dp_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dp_drm_create_encoder(dp: *mut rockchip_dp_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dp_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dp_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dp_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dp_resume(dev: *mut device) -> c_int {
    ...
    rockchip_dp_resume, core::ptr::null_mut());
