...
//! Source: drivers/gpu/drm/rockchip/dw-mipi-dsi2-rockchip.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_dw_dsi2_chip_data {
    pub reg: u32,
    pub grf_regs: *const dsigrf_reg,
    pub max_bit_rate_per_lane: c_ulonglong,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw_mipi_dsi2_rockchip {
    pub dev: *mut device,
    ...
    pub dmd: *mut dw_mipi_dsi2,
    pub pdata: dw_mipi_dsi2_plat_data,
    pub cdata: *const rockchip_dw_dsi2_chip_data,
}
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_dsi2_phy_init(priv_data: *mut c_void) -> c_int {
    static int dw_mipi_dsi2_phy_init(void *priv_data)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn dw_mipi_dsi2_phy_power_on(priv_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_dsi2_phy_power_off(priv_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_dsi2_phy_get_iface(priv_data: *mut c_void, iface: *mut dw_mipi_dsi2_phy_iface) {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_dsi2_rockchip_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_dsi2_rockchip_remove(pdev: *mut platform_device) {
