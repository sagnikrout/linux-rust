...
//! Source: drivers/gpu/drm/mxsfb/mxsfb_kms.c
#![no_std]
...
pub const RESET_TIMEOUT: c_int = 1000000;
// -----------------------------------------------------------------------------
// CRTC
//
#[no_mangle]
unsafe extern "C" fn set_hsync_pulse_width(mxsfb: *mut mxsfb_drm_private, val: u32) -> u32 {
...
//
    ...
    let mut format: u32 = mxsfb.crtc.primary.state.fb.format.format;
    u32 ctrl, ctrl1;
...
#[no_mangle]
unsafe extern "C" fn mxsfb_set_mode(mxsfb: *mut mxsfb_drm_private, bus_flags: u32) {
...
#[no_mangle]
unsafe extern "C" fn mxsfb_enable_controller(mxsfb: *mut mxsfb_drm_private) {
...
#[no_mangle]
unsafe extern "C" fn mxsfb_disable_controller(mxsfb: *mut mxsfb_drm_private) {
...
//
#[no_mangle]
unsafe extern "C" fn clear_poll_bit(addr: *mut void __iomem, mask: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxsfb_reset_block(mxsfb: *mut mxsfb_drm_private) -> c_int {
...
// Clear the FIFOs
    ...
    struct drm_display_mode *m = &mxsfb.crtc.state.adjusted_mode;
    let mut bus_flags: u32 = mxsfb.connector.display_info.bus_flags;
    int err;
...
// TODO: Is this needed ?
    ...
    crtc.primary);
    struct drm_bridge_state *bridge_state = core::ptr::null_mut();
    struct drm_device *drm = mxsfb.drm;
    let mut bus_format: u32 = 0;
    dma_addr_t dma_addr;
...
#[no_mangle]
unsafe extern "C" fn mxsfb_crtc_enable_vblank(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxsfb_crtc_disable_vblank(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn mxsfb_crtc_set_crc_source(crtc: *mut drm_crtc, source: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !source) -> else {
    else if (!source)
...
//
#[no_mangle]
pub unsafe extern "C" fn mxsfb_kms_init(mxsfb: *mut mxsfb_drm_private) -> c_int {
    ...
    &mxsfb.planes.primary, core::ptr::null_mut(),
    &mxsfb_crtc_with_crc_funcs,
    core::ptr::null_mut());
    } else {
    ret = drm_crtc_init_with_planes(mxsfb.drm, crtc,
    &mxsfb.planes.primary, core::ptr::null_mut(),
    &mxsfb_crtc_funcs, core::ptr::null_mut());
    }
    if (ret)
    return ret;
