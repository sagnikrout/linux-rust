...
//! Source: drivers/gpu/drm/imx/dc/dc-lb.c
#![no_std]
...
pub const BLENDCONTROL: c_uint = 0x10;
...
pub const POSITION: c_uint = 0x14;
...
#[no_mangle]
pub unsafe extern "C" fn dc_lb_get_link_id(lb: *mut dc_lb) -> enum dc_link_id {
    enum dc_link_id dc_lb_get_link_id(struct dc_lb *lb)
    {
    return lb.link;
    }
#[no_mangle]
pub unsafe extern "C" fn dc_lb_pec_dynamic_prim_sel(lb: *mut dc_lb, prim: enum dc_link_id) {
    void dc_lb_pec_dynamic_prim_sel(struct dc_lb *lb, enum dc_link_id prim)
    {
    let mut fixed_sels_num: c_int = ARRAY_SIZE(prim_sels) - 4;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn dc_lb_pec_dynamic_sec_sel(lb: *mut dc_lb, sec: enum dc_link_id) {
...
#[no_mangle]
pub unsafe extern "C" fn dc_lb_pec_clken(lb: *mut dc_lb, clken: enum dc_pec_clken) {
...
#[no_mangle]
pub unsafe extern "C" fn dc_lb_enable_shden(lb: *mut dc_lb) {
    static inline void dc_lb_enable_shden(struct dc_lb *lb)
    {
    regmap_write_bits(lb.reg_cfg, STATICCONTROL, SHDEN, SHDEN);
    }
#[no_mangle]
pub unsafe extern "C" fn dc_lb_shdtoksel(lb: *mut dc_lb, sel: enum dc_lb_shadow_sel) {
...
#[no_mangle]
pub unsafe extern "C" fn dc_lb_shdldsel(lb: *mut dc_lb, sel: enum dc_lb_shadow_sel) {
...
#[no_mangle]
pub unsafe extern "C" fn dc_lb_mode(lb: *mut dc_lb, mode: enum dc_lb_mode) {
    void dc_lb_mode(struct dc_lb *lb, enum dc_lb_mode mode)
    {
    regmap_write_bits(lb.reg_cfg, CONTROL, CTRL_MODE_MASK, mode);
    }
#[no_mangle]
pub unsafe extern "C" fn dc_lb_blendcontrol(lb: *mut dc_lb) {
...
#[no_mangle]
pub unsafe extern "C" fn dc_lb_position(lb: *mut dc_lb, x: c_int, y: c_int) {
    void dc_lb_position(struct dc_lb *lb, int x, int y)
    {
    regmap_write(lb.reg_cfg, POSITION, XPOS(x) | YPOS(y));
    }
#[no_mangle]
pub unsafe extern "C" fn dc_lb_get_id(lb: *mut dc_lb) -> c_int {
    int dc_lb_get_id(struct dc_lb *lb)
    {
    return lb.id;
    }
#[no_mangle]
pub unsafe extern "C" fn dc_lb_init(lb: *mut dc_lb) {
...
#[no_mangle]
unsafe extern "C" fn dc_lb_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dc_lb_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dc_lb_remove(pdev: *mut platform_device) {
