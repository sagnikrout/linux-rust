...
//! Source: drivers/gpu/drm/imx/dc/dc-ic.c
#![no_std]
...
pub const IRQ_COUNT: c_int = 49;
pub const IRQ_RESERVED: c_int = 35;
pub const REG_NUM: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dc_ic_data {
    pub regs: *mut regmap,
    pub clk_axi: *mut clk,
    pub irq: [c_int; IRQ_COUNT],
    pub domain: *mut irq_domain,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dc_ic_entry {
    pub data: *mut dc_ic_data,
    pub irq: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn dc_ic_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn dc_ic_probe(pdev: *mut platform_device) -> c_int {
    ...
    data.clk_axi = devm_clk_get(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dc_ic_remove(pdev: *mut platform_device) {
    ...
    if (i == IRQ_RESERVED)
    continue;
    irq_set_chained_handler_and_data(data.irq[i], core::ptr::null_mut(), core::ptr::null_mut());
    }
    irq_domain_remove(data.domain);
    pm_runtime_put_sync(&pdev.dev);
    }
#[no_mangle]
unsafe extern "C" fn dc_ic_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dc_ic_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(dc_ic_runtime_suspend, dc_ic_runtime_resume, core::ptr::null_mut())
    };
