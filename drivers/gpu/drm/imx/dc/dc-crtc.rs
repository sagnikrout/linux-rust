...
//! Source: drivers/gpu/drm/imx/dc/dc-crtc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dc_crtc_get_vblank_counter(crtc: *mut drm_crtc) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn dc_crtc_enable_vblank(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dc_crtc_disable_vblank(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn dc_crtc_queue_state_event(crtc_state: *mut drm_crtc_state) {
...
// request display engine power-off when CRTC is disabled
    ...
    {
    struct dc_crtc *dc_crtc = to_dc_crtc(crtc);
    let mut vdisplay: c_int = mode.crtc_vdisplay;
    let mut vtotal: c_int = mode.crtc_vtotal;
    bool reliable;
    int line;
    int idx;
    if (stime)
...
#[no_mangle]
unsafe extern "C" fn dc_crtc_irq_handler_dec_framecomplete(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    dc_crtc.event = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dc_crtc_irq_handler_dec_shdload_done(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dc_crtc_request_irqs(drm: *mut drm_device, dc_crtc: *mut dc_crtc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dc_crtc_init(dc_drm: *mut dc_drm_device, crtc_index: c_int) -> c_int {
    ...
    core::ptr::null_mut(), &dc_crtc_funcs, core::ptr::null_mut());
    if (ret)
    dev_err(de.dev, "failed to add CRTC: %d\n", ret);
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn dc_crtc_post_init(dc_drm: *mut dc_drm_device, crtc_index: c_int) -> c_int {
