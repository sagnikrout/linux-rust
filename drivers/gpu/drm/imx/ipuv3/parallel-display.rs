...
//! Source: drivers/gpu/drm/imx/ipuv3/parallel-display.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_parallel_display_encoder {
    pub encoder: drm_encoder,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_parallel_display {
    pub dev: *mut device,
    pub bus_format: u32,
...
#[no_mangle]
unsafe extern "C" fn imx_pd_format_supported(output_fmt: u32) -> bool {
...
//
    ...
    struct drm_display_info *di = &conn_state.connector.display_info;
    struct drm_bridge_state *next_bridge_state = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn imx_pd_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
    ...
    if (ret)
    return ret;
    drm_bridge_attach(encoder, bridge, core::ptr::null_mut(), DRM_BRIDGE_ATTACH_NO_CONNECTOR);
...
#[no_mangle]
unsafe extern "C" fn imx_pd_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(fmt, _arg: "rgb565")) -> else {
    else if (!strcmp(fmt, "rgb565"))
    bus_format = MEDIA_BUS_FMT_RGB565_1X16;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(fmt, _arg: "bgr666")) -> else {
    else if (!strcmp(fmt, "bgr666"))
    bus_format = MEDIA_BUS_FMT_RGB666_1X18;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(fmt, _arg: "lvds666")) -> else {
...
#[no_mangle]
unsafe extern "C" fn imx_pd_remove(pdev: *mut platform_device) {
