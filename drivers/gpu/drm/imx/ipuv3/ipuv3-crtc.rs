...
//! Source: drivers/gpu/drm/imx/ipuv3/ipuv3-crtc.c
#![no_std]
...
// plane[0] is the full plane, plane[1] is the partial plane
    ...
    {
    let mut disable_partial: bool = false;
    let mut disable_full: bool = false;
...
#[no_mangle]
unsafe extern "C" fn imx_drm_crtc_reset(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn ipu_enable_vblank(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipu_disable_vblank(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn ipu_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    ipu_crtc.event = core::ptr::null_mut();
    ...
    crtc);
    let mut primary_plane_mask: u32 = drm_plane_mask(crtc.primary);
...
#[no_mangle]
unsafe extern "C" fn ipu_crtc_mode_set_nofb(crtc: *mut drm_crtc) {
    ...
    let mut sig_cfg: ipu_di_signal_cfg = {};
    let mut encoder_types: c_ulong = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(BIT(DRM_MODE_ENCODER_TVDAC): encoder_types &) -> else {
...
// Default to driving pixel data on negative clock edges
    ...
    let mut new_hactive: c_uint = ALIGN(sig_cfg.mode.hactive, 8);
...
#[no_mangle]
unsafe extern "C" fn ipu_put_resources(dev: *mut drm_device, ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ipu_drm_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
    ...
    &primary_plane.base, core::ptr::null_mut(),
    &ipu_crtc_funcs, core::ptr::null_mut());
    if (IS_ERR(ipu_crtc))
...
// If this crtc is using the DP, add an overlay plane
    ...
    ipu_crtc.plane[1] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn ipu_drm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipu_drm_remove(pdev: *mut platform_device) {
