...
//! Source: drivers/gpu/drm/imx/ipuv3/imx-drm-core.c
#![no_std]
...
pub const MAX_CRTC: c_int = 4;
    let mut legacyfb_depth: static int = 16;
...
#[no_mangle]
unsafe extern "C" fn imx_drm_atomic_commit_tail(state: *mut drm_atomic_commit) {
    static void imx_drm_atomic_commit_tail(struct drm_atomic_commit *state)
    {
    struct drm_device *dev = state.dev;
    struct drm_plane *plane;
    struct drm_plane_state *old_plane_state, *new_plane_state;
    let mut plane_disabling: bool = false;
    int i;
...
//
    ...
    {
    let mut crtc_mask: u32 = drm_of_find_possible_crtcs(drm, np);
//
...
#[no_mangle]
unsafe extern "C" fn compare_of(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_drm_bind(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_drm_unbind(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn imx_drm_platform_probe(pdev: *mut platform_device) -> c_int {
    static int imx_drm_platform_probe(struct platform_device *pdev)
    {
    let mut ret: c_int = drm_of_component_probe(&pdev.dev, compare_of, &imx_drm_ops);
    if (!ret)
    ret = dma_set_coherent_mask(&pdev.dev, DMA_BIT_MASK(32));
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn imx_drm_platform_remove(pdev: *mut platform_device) {
    static void imx_drm_platform_remove(struct platform_device *pdev)
    {
    component_master_del(&pdev.dev, &imx_drm_ops);
    }
#[no_mangle]
unsafe extern "C" fn imx_drm_platform_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn imx_drm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_drm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_drm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn imx_drm_exit() -> void __exit {
