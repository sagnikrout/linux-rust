...
//! Source: drivers/gpu/drm/imx/ipuv3/imx-tve.c
#![no_std]
...
pub const TVE_COM_CONF_REG: c_uint = 0x00;
pub const TVE_TVDAC0_CONT_REG: c_uint = 0x28;
pub const TVE_TVDAC1_CONT_REG: c_uint = 0x2c;
pub const TVE_TVDAC2_CONT_REG: c_uint = 0x30;
pub const TVE_CD_CONT_REG: c_uint = 0x34;
pub const TVE_INT_CONT_REG: c_uint = 0x64;
pub const TVE_STAT_REG: c_uint = 0x68;
pub const TVE_TST_MODE_REG: c_uint = 0x6c;
pub const TVE_MV_CONT_REG: c_uint = 0xdc;
// TVE_COM_CONF_REG

pub const TVE_IPU_CLK_EN_OFS: c_int = 3;

pub const TVE_DAC_SAMP_RATE_OFS: c_int = 1;
pub const TVE_DAC_SAMP_RATE_WIDTH: c_int = 2;
...
pub const IMX_TVE_DAC_VOLTAGE: c_int = 2750000;
    enum {
    TVE_MODE_TVOUT,
    TVE_MODE_VGA,
    };
...
pub struct imx_tve {
    pub dev: *mut device,
    pub mode: c_int,
    pub di_hsync_pin: c_int,
    pub di_vsync_pin: c_int,
    pub regmap: *mut regmap,
    pub dac_reg: *mut regulator,
    pub ddc: *mut i2c_adapter,
    pub clk: *mut clk,
    pub di_sel_clk: *mut clk,
    pub clk_hw_di: clk_hw,
    pub di_clk: *mut clk,
}
...
#[no_mangle]
unsafe extern "C" fn tve_enable(tve: *mut imx_tve) {
...
#[no_mangle]
unsafe extern "C" fn tve_disable(tve: *mut imx_tve) {
...
#[no_mangle]
unsafe extern "C" fn tve_setup_tvout(tve: *mut imx_tve) -> c_int {
    static int tve_setup_tvout(struct imx_tve *tve)
    {
    return -ENOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn tve_setup_vga(tve: *mut imx_tve) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_tve_connector_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_tve_encoder_enable(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn imx_tve_encoder_disable(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn imx_tve_connector_destroy(connector: *mut drm_connector) {
...
#[no_mangle]
unsafe extern "C" fn imx_tve_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(2: div >=) -> else {
    else if (div >= 2)
...
#[no_mangle]
unsafe extern "C" fn tve_clk_init(tve: *mut imx_tve, base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_tve_disable_regulator(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn imx_tve_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn of_get_tve_mode(np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_tve_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_tve_put_device(_dev: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn imx_tve_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_tve_remove(pdev: *mut platform_device) {
