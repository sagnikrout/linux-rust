...
//! Source: drivers/gpu/drm/imx/dcss/dcss-crtc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dcss_enable_vblank(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dcss_disable_vblank(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn dcss_crtc_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn dcss_crtc_init(crtc: *mut dcss_crtc, drm: *mut drm_device) -> c_int {
    ...
    core::ptr::null_mut(), &dcss_crtc_funcs, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
pub unsafe extern "C" fn dcss_crtc_deinit(crtc: *mut dcss_crtc, drm: *mut drm_device) {
