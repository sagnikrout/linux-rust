...
//! Source: drivers/gpu/drm/drm_fbdev_ttm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn drm_fbdev_ttm_fb_open(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_fbdev_ttm_fb_release(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_fbdev_ttm_fb_destroy(info: *mut fb_info) {
