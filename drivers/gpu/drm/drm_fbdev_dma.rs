...
//! Source: drivers/gpu/drm/drm_fbdev_dma.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn drm_fbdev_dma_fb_open(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_fbdev_dma_fb_release(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_fbdev_dma_fb_mmap(info: *mut fb_info, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_fbdev_dma_fb_destroy(info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn drm_fbdev_dma_shadowed_fb_destroy(info: *mut fb_info) {
...
//
    ...
    let mut offset: usize = clip.y1 * fb.pitches[0];
    let mut len: usize = clip.x2 - clip.x1;
    unsigned int y;
    void *src;
...
//
    ...
    let mut map: iosys_map = buffer.map;
...
// screen
    ...
    struct drm_client_buffer *buffer = fb_helper.buffer;
    struct fb_info *info = fb_helper.info;
    let mut screen_size: usize = buffer.gem.size;
    void *screen_buffer;
    int ret;
//
