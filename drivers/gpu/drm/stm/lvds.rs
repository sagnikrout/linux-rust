...
//! Source: drivers/gpu/drm/stm/lvds.c
#![no_std]
...
// LVDS Host registers
pub const LVDS_CR: c_uint = 0x0000  /* configuration register */;
pub const LVDS_DMLCR0: c_uint = 0x0004  /* data mapping lsb configuration register 0 */;
pub const LVDS_DMMCR0: c_uint = 0x0008  /* data mapping msb configuration register 0 */;
pub const LVDS_DMLCR1: c_uint = 0x000C  /* data mapping lsb configuration register 1 */;
pub const LVDS_DMMCR1: c_uint = 0x0010  /* data mapping msb configuration register 1 */;
pub const LVDS_DMLCR2: c_uint = 0x0014  /* data mapping lsb configuration register 2 */;
pub const LVDS_DMMCR2: c_uint = 0x0018  /* data mapping msb configuration register 2 */;
pub const LVDS_DMLCR3: c_uint = 0x001C  /* data mapping lsb configuration register 3 */;
pub const LVDS_DMMCR3: c_uint = 0x0020  /* data mapping msb configuration register 3 */;
pub const LVDS_DMLCR4: c_uint = 0x0024  /* data mapping lsb configuration register 4 */;
pub const LVDS_DMMCR4: c_uint = 0x0028  /* data mapping msb configuration register 4 */;
pub const LVDS_CDL1CR: c_uint = 0x002C  /* channel distrib link 1 configuration register */;
pub const LVDS_CDL2CR: c_uint = 0x0030  /* channel distrib link 2 configuration register */;
pub const CDL1CR_DEFAULT: c_uint = 0x04321 /* Default value for CDL1CR */;
pub const CDL2CR_DEFAULT: c_uint = 0x59876 /* Default value for CDL2CR */;

// LVDS Wrapper registers
pub const LVDS_WCLKCR: c_uint = 0x11B0  /* Wrapper clock control register */;
pub const LVDS_HWCFGR: c_uint = 0x1FF0  /* HW configuration register	*/;
pub const LVDS_VERR: c_uint = 0x1FF4  /* Version register	*/;
pub const LVDS_IPIDR: c_uint = 0x1FF8  /* Identification register	*/;
pub const LVDS_SIDR: c_uint = 0x1FFC  /* Size Identification register	*/;
...
pub const SLEEP_US: c_int = 1000;
pub const TIMEOUT_US: c_int = 200000;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct phy_reg_offsets {
    pub /: *mut *mut u32 GCR; / Global Control Register,
    pub /: *mut *mut u32 CMCR1; / Current Mode Control Register 1,
    pub /: *mut *mut u32 CMCR2; / Current Mode Control Register 2,
    pub /: *mut *mut u32 SCR; / Serial Control Register,
    pub /: *mut *mut u32 BCR1; / Bias Control Register 1,
    pub /: *mut *mut u32 BCR2; / Bias Control Register 2,
    pub /: *mut *mut u32 BCR3; / Bias Control Register 3,
    pub /: *mut *mut u32 MPLCR; / Monitor PLL Lock Control Register,
    pub /: *mut *mut u32 DCR; / Debug Control Register,
    pub /: *mut *mut u32 SSR1; / Spare Status Register 1,
    pub /: *mut *mut u32 CFGCR; / Configuration Control Register,
    pub /: *mut *mut u32 PLLCR1; / PLL_MODE 1 Control Register,
    pub /: *mut *mut u32 PLLCR2; / PLL_MODE 2 Control Register,
    pub /: *mut *mut u32 PLLSR; / PLL Status Register,
    pub /: *mut *mut u32 PLLSDCR1; / PLL_SD_1 Control Register,
    pub /: *mut *mut u32 PLLSDCR2; / PLL_SD_2 Control Register,
    pub /: *mut *mut u32 PLLTWGCR1;/ PLL_TWG_1 Control Register,
    pub /: *mut *mut u32 PLLTWGCR2;/ PLL_TWG_2 Control Register,
    pub /: *mut *mut u32 PLLCPCR; / PLL_CP Control Register,
    pub /: *mut *mut u32 PLLTESTCR;/ PLL_TEST Control Register,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lvds_phy_info {
    pub base: u32,
    pub ofs: phy_reg_offsets,
}
...
pub struct stm_lvds {
    ...
    pub dev: *mut device,
    pub /: *mut *mut *mut clk pclk; / APB peripheral clock,
    pub /: *mut *mut *mut clk pllref_clk; / Reference clock for the internal PLL,
    pub /: *mut *mut clk_hw lvds_ck_px; / Pixel clock,
    pub /: *mut *mut u32 pixel_clock_rate; / Pixel clock rate,
    pub primary: *mut lvds_phy_info,
    pub secondary: *mut lvds_phy_info,
    pub lvds_bridge: drm_bridge,
...
//
#[no_mangle]
unsafe extern "C" fn lvds_pll_enable(lvds: *mut stm_lvds, phy: *mut lvds_phy_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pll_get_clkout_khz(clkin_khz: c_int, bdiv: c_int, mdiv: c_int, ndiv: c_int) -> c_int {
    static int pll_get_clkout_khz(int clkin_khz, int bdiv, int mdiv, int ndiv)
    {
    let mut divisor: c_int = ndiv * bdiv;
// Prevents from division by 0
    if (!divisor)
    return 0;
    return clkin_khz * mdiv / divisor;
    }
pub const TDIV: c_int = 70;
pub const NDIV_MIN: c_int = 2;
pub const NDIV_MAX: c_int = 6;
pub const BDIV_MIN: c_int = 2;
pub const BDIV_MAX: c_int = 6;
pub const MDIV_MIN: c_int = 1;
pub const MDIV_MAX: c_int = 1023;
...
#[no_mangle]
unsafe extern "C" fn lvds_pll_config(lvds: *mut stm_lvds, phy: *mut lvds_phy_info) {
...
#[no_mangle]
unsafe extern "C" fn lvds_pixel_clk_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lvds_pixel_clk_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn lvds_pixel_clk_unregister(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn lvds_pixel_clk_register(lvds: *mut stm_lvds) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lvds_config_data_mapping(lvds: *mut stm_lvds) {
...
#[no_mangle]
unsafe extern "C" fn lvds_config_mode(lvds: *mut stm_lvds) {
...
#[no_mangle]
unsafe extern "C" fn lvds_connector_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lvds_probe(pdev: *mut platform_device) -> c_int {
...
//
    remote = of_get_next_available_child(port1, core::ptr::null_mut());
    if (remote) {
    if (of_graph_get_remote_endpoint(remote)) {
    lvds.link_type = LVDS_SINGLE_LINK_PRIMARY;
    lvds.primary = &lvds_phy_16ff_primary;
    lvds.secondary = core::ptr::null_mut();
    } else {
    ret = -EINVAL;
    }
    of_node_put(remote);
    }
    remote = of_get_next_available_child(port2, core::ptr::null_mut());
    if (remote) {
    if (of_graph_get_remote_endpoint(remote)) {
    lvds.link_type = LVDS_SINGLE_LINK_SECONDARY;
    lvds.primary = core::ptr::null_mut();
    lvds.secondary = &lvds_phy_16ff_secondary;
    } else {
...
#[no_mangle]
unsafe extern "C" fn lvds_remove(pdev: *mut platform_device) {
