...
//! Source: drivers/gpu/drm/stm/dw_mipi_dsi-stm.c
#![no_std]
...
pub const HWVER_130: c_uint = 0x31333000	/* IP version 1.30 */;
...
pub const DSI_WCFGR: c_uint = 0x0400		/* Wrapper ConFiGuration Reg */;

pub const DSI_WCR: c_uint = 0x0404		/* Wrapper Control Reg */;

pub const DSI_WISR: c_uint = 0x040C		/* Wrapper Interrupt and Status Reg */;

pub const DSI_WPCR0: c_uint = 0x0418		/* Wrapper Phy Conf Reg 0 */;

pub const DSI_WRPCR: c_uint = 0x0430		/* Wrapper Regulator & Pll Ctrl Reg */;

pub const IDF_MIN: c_int = 1;
pub const IDF_MAX: c_int = 7;
pub const NDIV_MIN: c_int = 10;
pub const NDIV_MAX: c_int = 125;
pub const ODF_MIN: c_int = 1;
pub const ODF_MAX: c_int = 8;
...
pub const LANE_MIN_KBPS: c_int = 31250;
pub const LANE_MAX_KBPS: c_int = 500000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw_mipi_dsi_stm {
    pub base: *mut void __iomem,
    pub dev: *mut device,
    pub pllref_clk: *mut clk,
    pub pclk: *mut clk,
    pub txbyte_clk: clk_hw,
    pub dsi: *mut dw_mipi_dsi,
    pub pdata: dw_mipi_dsi_plat_data,
    pub hw_version: u32,
    pub lane_min_kbps: c_int,
    pub lane_max_kbps: c_int,
    pub vdd_supply: *mut regulator,
}

#[no_mangle]
pub unsafe extern "C" fn dsi_write(dsi: *mut dw_mipi_dsi_stm, reg: u32, val: u32) {
    static inline void dsi_write(struct dw_mipi_dsi_stm *dsi, u32 reg, u32 val)
    {
    writel(val, dsi.base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn dsi_read(dsi: *mut dw_mipi_dsi_stm, reg: u32) -> u32 {
    static inline u32 dsi_read(struct dw_mipi_dsi_stm *dsi, u32 reg)
    {
    return readl(dsi.base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn dsi_set(dsi: *mut dw_mipi_dsi_stm, reg: u32, mask: u32) {
    static inline void dsi_set(struct dw_mipi_dsi_stm *dsi, u32 reg, u32 mask)
    {
    dsi_write(dsi, reg, dsi_read(dsi, reg) | mask);
    }
#[no_mangle]
pub unsafe extern "C" fn dsi_clear(dsi: *mut dw_mipi_dsi_stm, reg: u32, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn dsi_color_from_mipi(fmt: enum mipi_dsi_pixel_format) -> enum dsi_color {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_get_clkout_khz(clkin_khz: c_int, idf: c_int, ndiv: c_int, odf: c_int) -> c_int {
    static int dsi_pll_get_clkout_khz(int clkin_khz, int idf, int ndiv, int odf)
    {
    let mut divisor: c_int = idf * odf;
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_dsi_clk_disable(clk: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_dsi_clk_enable(clk: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_dsi_clk_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_dsi_clk_unregister(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_dsi_stm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_dsi_stm_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_dsi_stm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_dsi_stm_resume(dev: *mut device) -> c_int {
    ...
    dw_mipi_dsi_stm_resume, core::ptr::null_mut())
    };
