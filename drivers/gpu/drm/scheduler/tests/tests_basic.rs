...
//! Source: drivers/gpu/drm/scheduler/tests/tests_basic.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn drm_sched_basic_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_sched_basic_exit(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_sched_timeout_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_sched_basic_submit(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_sched_basic_params {
...
#[no_mangle]
unsafe extern "C" fn drm_sched_basic_entity_cleanup(test: *mut kunit) {
    static void drm_sched_basic_entity_cleanup(struct kunit *test)
    {
    struct drm_mock_sched_job *job, *mid, *prev = core::ptr::null_mut();
    struct drm_mock_scheduler *sched = test.priv;
    struct drm_mock_sched_entity *entity[4];
    let mut qd: c_uint = 100;
    unsigned int i, cur_ent = 0;
    bool done;
//
...
#[no_mangle]
unsafe extern "C" fn drm_sched_basic_cancel(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sched_concurrent_context {
    pub sched: *mut drm_mock_scheduler,
    pub sub_wq: *mut workqueue_struct,
    pub test: *mut kunit,
    pub wait_go: completion,
}
...
#[no_mangle]
unsafe extern "C" fn complete_destroy_workqueue(context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn drm_sched_concurrent_init(test: *mut kunit) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_sched_parallel_params {
    pub description: *const c_char,
    pub num_jobs: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct parallel_worker {
    pub work: work_struct,
    pub ctx: *mut sched_concurrent_context,
    pub entity: *mut drm_mock_sched_entity,
    pub jobs: *mut drm_mock_sched_job,
    pub id: c_uint,
}

#[no_mangle]
unsafe extern "C" fn drm_sched_parallel_worker(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_sched_parallel_submit_test(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_sched_interleaved_params {
    pub description: *const c_char,
    pub test_duration_ms: c_uint,
    pub job_base_duration_us: c_uint,
    pub num_workers: c_uint,
    pub num_in_flight_jobs: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct interleaved_worker {
    pub work: work_struct,
    pub ctx: *mut sched_concurrent_context,
    pub entity: *mut drm_mock_sched_entity,
    pub jobs: *mut drm_mock_sched_job,
    pub id: c_uint,
    pub job_count: c_uint,
    pub job_duration_us: c_uint,
}

#[no_mangle]
unsafe extern "C" fn drm_sched_interleaved_worker(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_sched_interleaved_submit_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_sched_basic_timeout(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_sched_skip_reset(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_sched_priorities(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_sched_change_priority(test: *mut kunit) {
    static void drm_sched_change_priority(struct kunit *test)
    {
    struct drm_mock_sched_entity *entity[DRM_SCHED_PRIORITY_COUNT];
    struct drm_mock_scheduler *sched = test.priv;
    struct drm_mock_sched_job *job;
    let mut qd: c_uint = 1000;
    unsigned int i, cur_ent = 0;
    enum drm_sched_priority p;
//
// Submit a bunch of jobs against entities configured with different
...
#[no_mangle]
unsafe extern "C" fn drm_sched_test_modify_sched(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_sched_test_credits(test: *mut kunit) {
