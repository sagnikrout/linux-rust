...
//! Source: drivers/gpu/drm/scheduler/tests/mock_scheduler.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mock_sched_entity_free(entity: *mut drm_mock_sched_entity) {
    void drm_mock_sched_entity_free(struct drm_mock_sched_entity *entity)
    {
    drm_sched_entity_destroy(&entity.base);
    }
#[no_mangle]
unsafe extern "C" fn drm_mock_sched_job_complete(job: *mut drm_mock_sched_job) {
...
#[no_mangle]
unsafe extern "C" fn drm_mock_sched_hw_fence_release(fence: *mut dma_fence) {
...
// Containing job is freed by the kunit framework
    ...
    if (job.duration_us) {
    let mut prev_finish_at: ktime_t = 0;
...
#[no_mangle]
unsafe extern "C" fn mock_sched_free_job(sched_job: *mut drm_sched_job) {
...
#[no_mangle]
unsafe extern "C" fn mock_sched_cancel_job(sched_job: *mut drm_sched_job) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mock_sched_fini(sched: *mut drm_mock_scheduler) {
