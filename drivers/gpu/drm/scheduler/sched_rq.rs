...
//! Source: drivers/gpu/drm/scheduler/sched_rq.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn drm_sched_rq_update_prio(rq: *mut drm_sched_rq) {
    static void drm_sched_rq_update_prio(struct drm_sched_rq *rq)
    {
    let mut prio: enum drm_sched_priority = DRM_SCHED_PRIORITY_INVALID;
    struct rb_node *rb;
...
//
    ...
    let mut prio: enum drm_sched_priority = entity.priority;
...
#[no_mangle]
unsafe extern "C" fn drm_sched_entity_update_vruntime(entity: *mut drm_sched_entity) -> ktime_t {
...
#[no_mangle]
unsafe extern "C" fn drm_sched_entity_get_job_ts(entity: *mut drm_sched_entity) -> ktime_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_sched_rq_pop_entity(entity: *mut drm_sched_entity) {
...
#[no_mangle]
pub unsafe extern "C" fn if(DRM_SCHED_POLICY_FIFO: drm_sched_policy ==) -> else {
...
//
    ...
    spin_unlock(&rq.lock);
    return rb ? rb_entry(rb, struct drm_sched_entity, rb_tree_node) : core::ptr::null_mut();
    }
