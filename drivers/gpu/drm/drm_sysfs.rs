...
//! Source: drivers/gpu/drm/drm_sysfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn drm_connector_acpi_bus_match(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn drm_sysfs_acpi_register() {
    static void drm_sysfs_acpi_register(void)
    {
    register_acpi_bus_type(&drm_connector_acpi_bus);
    }
#[no_mangle]
unsafe extern "C" fn drm_sysfs_acpi_unregister() {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_sysfs_init() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_sysfs_destroy() {
...
#[no_mangle]
unsafe extern "C" fn drm_sysfs_release(dev: *mut device) {
...
//
    ...
    connector.force = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "on")) -> else {
    else if (sysfs_streq(buf, "on"))
    connector.force = DRM_FORCE_ON;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "on-digital")) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn drm_sysfs_connector_add(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drm_sysfs_connector_add_late(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drm_sysfs_connector_remove_early(connector: *mut drm_connector) {
...
#[no_mangle]
pub unsafe extern "C" fn drm_sysfs_connector_remove(connector: *mut drm_connector) {
    ...
    connector.kdev = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn drm_sysfs_lease_event(dev: *mut drm_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_sysfs_hotplug_event(dev: *mut drm_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_sysfs_connector_hotplug_event(connector: *mut drm_connector) {
    void drm_sysfs_connector_hotplug_event(struct drm_connector *connector)
    {
    struct drm_device *dev = connector.dev;
    char hotplug_str[] = "HOTPLUG=1", conn_id[21];
    char *envp[] = { hotplug_str, conn_id, core::ptr::null_mut() };
...
//
    ...
    char *envp[4] = { hotplug_str, conn_id, prop_id, core::ptr::null_mut() };
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_class_device_register(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_class_device_unregister(dev: *mut device) {
