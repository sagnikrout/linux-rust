...
//! Source: drivers/gpu/drm/sitronix/st7920.c
#![no_std]
...
pub const ST7920_PITCH: c_int = 16;
pub const ST7920_SCANLINES: c_int = 64;

pub const BYTES_IN_SEGMENT: c_int = 2;

pub const ST7920_DEFAULT_WIDTH: c_int = 128;
pub const ST7920_DEFAULT_HEIGHT: c_int = 64;
// Sync sequence
pub const SYNC_BITS: c_uint = 0xF8;
pub const RW_HIGH: c_uint = 0x04;
pub const RS_HIGH: c_uint = 0x02;
// Commands
pub const SET_DISPLAY_ON: c_uint = 0x0C;
pub const SET_DISPLAY_OFF: c_uint = 0x08;
pub const SET_DISPLAY_CLEAR: c_uint = 0x01;
pub const SET_BASIC_INSTRUCTION_SET: c_uint = 0x30;
pub const SET_EXT_INSTRUCTION_SET: c_uint = 0x34;
pub const SET_GRAPHICS_DISPLAY: c_uint = 0x36;
pub const SET_GDRAM_ADDRESS: c_uint = 0x80;
pub const SET_GDRAM_DATA: c_uint = 0xFF /* Driver internal command */;
// Masks
pub const HIGH_DATA_MASK: c_uint = 0xF0;
pub const LOW_DATA_MASK: c_uint = 0x0F;
pub const TOP_VERTICAL_ADDRESS: c_uint = 0x80;
pub const BOTTOM_VERTICAL_ADDRESS: c_uint = 0x60;
pub const TOP_HORIZONTAL_ADDRESS: c_uint = 0x00;
pub const BOTTOM_HORIZONTAL_ADDRESS: c_uint = 0x80;
pub const CMD_SIZE: c_int = 35;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spi7920_error {
    pub errno: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct st7920_device {
    pub drm: drm_device,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st7920_crtc_state {
    pub base: drm_crtc_state,
// Buffer to store pixels in HW format and written to the panel
    pub data_array: *mut u8,
}
...
#[no_mangle]
unsafe extern "C" fn st7920_store_gdram_address(data: *const c_void, reg: *mut u8) -> c_int {
    static int st7920_store_gdram_address(const void *data, u8 *reg)
    {
    let mut y_addr: u8 = *(const u8 *)data;
    let mut bottom_screen: bool = (y_addr >= 32);
    let mut i: c_int = 0;
    reg[i++] = SYNC_BITS;
...
#[no_mangle]
unsafe extern "C" fn st7920_store_gdram_data(data: *const c_void, reg: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7920_store_others(cmd: c_int, data: *const c_void, reg: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(SET_GDRAM_DATA: cmd ==) -> else {
...
// st7920 family
    ...
    {
    st7920_spi_write(st7920.spi, SET_DISPLAY_ON, core::ptr::null_mut(), 72, err);
    }
    static void st7920_power_off(struct st7920_device *st7920,
    struct spi7920_error *err)
    {
    st7920_spi_write(st7920.spi, SET_DISPLAY_CLEAR, core::ptr::null_mut(), 1600, err);
    st7920_spi_write(st7920.spi, SET_DISPLAY_OFF, core::ptr::null_mut(), 72, err);
    }
#[no_mangle]
unsafe extern "C" fn st7920_hw_reset(st7920: *mut st7920_device) {
...
#[no_mangle]
unsafe extern "C" fn st7920_init(st7920: *mut st7920_device) -> c_int {
    static int st7920_init(struct st7920_device *st7920)
    {
    let mut err: spi7920_error = {0};
    st7920_spi_write(st7920.spi, SET_BASIC_INSTRUCTION_SET, core::ptr::null_mut(), 72, &err);
    st7920_power_on(st7920, &err);
    st7920_spi_write(st7920.spi, SET_GRAPHICS_DISPLAY, core::ptr::null_mut(), 72, &err);
    st7920_spi_write(st7920.spi, SET_DISPLAY_CLEAR, core::ptr::null_mut(), 1600, &err);
    return err.errno;
    }
...
#[no_mangle]
unsafe extern "C" fn st7920_clear_screen(st7920: *mut st7920_device, data_array: *mut u8) {
...
// Align y to display page boundaries
    ...
    struct drm_crtc_state *crtc_state = core::ptr::null_mut();
    ...
    return ret;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !plane_state->visible) -> else {
...
#[no_mangle]
unsafe extern "C" fn st7920_primary_plane_reset(plane: *mut drm_plane) {
...
#[no_mangle]
unsafe extern "C" fn st7920_crtc_reset(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn st7920_connector_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7920_init_modeset(st7920: *mut st7920_device) -> c_int {
...
// CRTC
    crtc = &st7920.crtc;
    ret = drm_crtc_init_with_planes(drm, crtc, primary_plane, core::ptr::null_mut(),
    &st7920_crtc_funcs, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn st7920_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7920_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn st7920_shutdown(spi: *mut spi_device) {
