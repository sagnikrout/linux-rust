...
//! Source: drivers/gpu/drm/sitronix/st7586.c
#![no_std]
...
pub const ST7586_DISP_MODE_GRAY: c_uint = 0x38;
pub const ST7586_DISP_MODE_MONO: c_uint = 0x39;
pub const ST7586_ENABLE_DDRAM: c_uint = 0x3a;
pub const ST7586_SET_DISP_DUTY: c_uint = 0xb0;
pub const ST7586_SET_PART_DISP: c_uint = 0xb4;
pub const ST7586_SET_NLINE_INV: c_uint = 0xb5;
pub const ST7586_SET_VOP: c_uint = 0xc0;
pub const ST7586_SET_BIAS_SYSTEM: c_uint = 0xc3;
pub const ST7586_SET_BOOST_LEVEL: c_uint = 0xc4;
pub const ST7586_SET_VOP_OFFSET: c_uint = 0xc7;
pub const ST7586_ENABLE_ANALOG: c_uint = 0xd0;
pub const ST7586_AUTO_READ_CTRL: c_uint = 0xd7;
pub const ST7586_OTP_RW_CTRL: c_uint = 0xe0;
pub const ST7586_OTP_CTRL_OUT: c_uint = 0xe1;
pub const ST7586_OTP_READ: c_uint = 0xe3;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct st7586_device {
...
//
    ...
    {
    let mut len: usize = (clip.x2 - clip.x1) * (clip.y2 - clip.y1);
    unsigned int x, y;
    u8 *src, *buf, val;
    ...
    drm_fb_xrgb8888_to_gray8(&dst_map, core::ptr::null_mut(), &vmap, fb, clip, fmtcnv_state);
    src = buf;
...
#[no_mangle]
unsafe extern "C" fn st7586_probe(spi: *mut spi_device) -> c_int {
...
// Cannot read from this controller via SPI
    ...
    crtc = &st7586.crtc;
    ret = drm_crtc_init_with_planes(drm, crtc, plane, core::ptr::null_mut(), &st7586_crtc_funcs, core::ptr::null_mut());
    if (ret)
    return ret;
    drm_crtc_helper_add(crtc, &st7586_crtc_helper_funcs);
    encoder = &st7586.encoder;
    ret = drm_encoder_init(drm, encoder, &st7586_encoder_funcs, DRM_MODE_ENCODER_NONE, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn st7586_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn st7586_shutdown(spi: *mut spi_device) {
