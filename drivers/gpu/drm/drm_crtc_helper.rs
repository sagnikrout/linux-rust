...
//! Source: drivers/gpu/drm/drm_crtc_helper.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_helper_encoder_in_use(encoder: *mut drm_encoder) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_helper_crtc_in_use(crtc: *mut drm_crtc) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: encoder_funcs->dpms) -> else {
    else if (encoder_funcs.dpms)
    (*encoder_funcs.dpms)(encoder, DRM_MODE_DPMS_OFF);
    }
#[no_mangle]
unsafe extern "C" fn __drm_helper_disable_unused_functions(dev: *mut drm_device) {
...
// disconnect encoder from any connector
    encoder.crtc = core::ptr::null_mut();
    }
    }
    ...
    crtc.primary.fb = core::ptr::null_mut();
    }
    }
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_helper_disable_unused_functions(dev: *mut drm_device) {
...
// Disable unused encoders
    if (encoder.crtc == core::ptr::null_mut())
    drm_encoder_disable(encoder);
    }
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_crtc_helper_atomic_check(crtc: *mut drm_crtc, state: *mut drm_atomic_commit) -> c_int {
...
//
    ...
    struct drm_connector *connector;
    struct drm_connector_list_iter conn_iter;
    let mut count: c_int = 0, ro, fail = 0;
...
// If we have no fb then treat it as a full mode set
    if (set.crtc.primary.fb == core::ptr::null_mut()) {
...
// if we can't get an encoder for a connector
    ...
    if (new_encoder == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn drm_helper_choose_encoder_dpms(encoder: *mut drm_encoder) -> c_int {
    static int drm_helper_choose_encoder_dpms(struct drm_encoder *encoder)
    {
    let mut dpms: c_int = DRM_MODE_DPMS_OFF;
    struct drm_connector *connector;
    struct drm_connector_list_iter conn_iter;
    struct drm_device *dev = encoder.dev;
    drm_connector_list_iter_begin(dev, &conn_iter);
...
#[no_mangle]
unsafe extern "C" fn drm_helper_encoder_dpms(encoder: *mut drm_encoder, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn drm_helper_choose_crtc_dpms(crtc: *mut drm_crtc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_helper_connector_dpms(connector: *mut drm_connector, mode: c_int) -> c_int {
    int drm_helper_connector_dpms(struct drm_connector *connector, int mode)
    {
    struct drm_encoder *encoder = connector.encoder;
    struct drm_crtc *crtc = encoder ? encoder.crtc : core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_helper_resume_force_mode(dev: *mut drm_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_helper_force_disable_all(dev: *mut drm_device) -> c_int {
