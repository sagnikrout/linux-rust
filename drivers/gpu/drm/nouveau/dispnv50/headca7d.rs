...
//! Source: drivers/gpu/drm/nouveau/dispnv50/headca7d.c
#![no_std]
...
//
    ...
    {
    struct nvif_push *push = &head.disp.core.chan.push;
    let mut curs_hi: u32 = upper_32_bits(asyh.curs.offset);
    let mut curs_lo: u32 = lower_32_bits(asyh.curs.offset);
    let mut i: c_int = head.base.index;
    int ret;
    ...
    {
    struct nvif_push *push = &head.disp.core.chan.push;
    let mut olut_hi: u32 = upper_32_bits(asyh.olut.offset);
    let mut olut_lo: u32 = lower_32_bits(asyh.olut.offset);
    let mut i: c_int = head.base.index;
    int ret;
