...
//! Source: drivers/gpu/drm/nouveau/nvkm/engine/disp/gb202.c
#![no_std]
...
// Generic infoframe unit 1, the slot NVIDIA's driver uses for the VSI.
    let mut ctrl: u32 = 0x6f0138 + hoff;
    u8 buf[36] = {};
    int i;
...
//
    ...
    let mut hoff: u32 = (state == &head.arm) * 0x8000 + head.id * 0x800;
    u32 data;
...
//
    ...
    let mut ret: irqreturn_t = tu102_disp_intr(inth);
