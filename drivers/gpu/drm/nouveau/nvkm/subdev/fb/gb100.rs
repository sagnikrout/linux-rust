...
//! Source: drivers/gpu/drm/nouveau/nvkm/subdev/fb/gb100.c
#![no_std]
...
//
    ...
    {
    let mut addr_hi: u32 = upper_32_bits(fb.sysmem.flush_page_addr);
    let mut addr_lo: u32 = lower_32_bits(fb.sysmem.flush_page_addr);
    let mut hshub: u32 = DRF_LO(NV_PFB_HSHUB0);
