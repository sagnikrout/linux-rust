...
//! Source: drivers/gpu/drm/nouveau/nvkm/subdev/gsp/rm/r570/gsp.c
#![no_std]
...
//
    ...
    r535_gsp_msg_ntfy_add(gsp, NV_VGPU_MSG_EVENT_GSP_POST_NOCAT_RECORD, core::ptr::null_mut(), core::ptr::null_mut());
    r535_gsp_msg_ntfy_add(gsp, NV_VGPU_MSG_EVENT_GSP_LOCKDOWN_NOTICE, core::ptr::null_mut(), core::ptr::null_mut());
    }
    }
    static bool
