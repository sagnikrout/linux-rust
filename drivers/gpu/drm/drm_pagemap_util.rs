...
//! Source: drivers/gpu/drm/drm_pagemap_util.c
#![no_std]
...
// @dpagemaps: List of unused dpagemaps.
    pub dpagemaps: list_head,
// @num_dpagemaps: Number of unused dpagemaps in @dpagemaps.
    pub num_dpagemaps: core::sync::atomic::AtomicI32,
...
#[no_mangle]
unsafe extern "C" fn drm_pagemap_cache_fini(arg: *mut c_void) {
    ...
    cache.dpagemap = core::ptr::null_mut();
    if (dpagemap && !drm_pagemap_shrinker_cancel(dpagemap))
    dpagemap = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_pagemap_cache_lock_lookup(cache: *mut drm_pagemap_cache) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_pagemap_cache_unlock_lookup(cache: *mut drm_pagemap_cache) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_pagemap_cache_set_pagemap(cache: *mut drm_pagemap_cache, dpagemap: *mut drm_pagemap) {
...
#[no_mangle]
unsafe extern "C" fn drm_pagemap_shrinker_cancel(dpagemap: *mut drm_pagemap) -> bool {
    static bool drm_pagemap_shrinker_cancel(struct drm_pagemap *dpagemap)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_pagemap_shrinker_might_lock(dpagemap: *mut drm_pagemap) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_pagemap_shrinker_add(dpagemap: *mut drm_pagemap) {
...
//
    ...
    let mut count: c_ulong = atomic_read(&shrinker.num_dpagemaps);
...
#[no_mangle]
unsafe extern "C" fn drm_pagemap_shrinker_fini(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn drm_pagemap_owner_release(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_pagemap_release_owner(peer: *mut drm_pagemap_peer) {
...
//
    ...
    struct drm_pagemap_owner *owner = core::ptr::null_mut();
    let mut interconnect: bool = false;
    mutex_lock(&owner_list.lock);
