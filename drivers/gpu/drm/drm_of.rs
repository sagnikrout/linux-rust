...
//! Source: drivers/gpu/drm/drm_of.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn if(90: rotation ==) -> else {
    else if (rotation == 90)
// orientation = DRM_MODE_PANEL_ORIENTATION_RIGHT_UP;
#[no_mangle]
pub unsafe extern "C" fn if(180: rotation ==) -> else {
    else if (rotation == 180)
// orientation = DRM_MODE_PANEL_ORIENTATION_BOTTOM_UP;
#[no_mangle]
pub unsafe extern "C" fn if(270: rotation ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn drm_of_lvds_get_port_pixels_type(port_node: *mut device_node) -> c_int {
    ...
    {
    struct device_node *endpoint = core::ptr::null_mut();
    let mut pixels_type: c_int = -EPIPE;
...
#[no_mangle]
unsafe extern "C" fn __drm_of_lvds_get_dual_link_pixel_order(p1_pt: c_int, p2_pt: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_of_lvds_get_data_mapping(port: *const device_node) -> c_int {
