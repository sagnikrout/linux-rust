...
//! Source: drivers/gpu/drm/drm_blend.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_plane_create_alpha_property(plane: *mut drm_plane) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_atomic_commit_zpos_cmp(a: *const c_void, b: *const c_void) -> c_int {
    ...
    let mut total_planes: c_int = dev.mode_config.num_total_plane;
...
//
    ...
    sort(states, n, sizeof(*states), drm_atomic_commit_zpos_cmp, core::ptr::null_mut());
    for (i = 0; i < n; i++) {
...
#[no_mangle]
pub unsafe extern "C" fn if(BIT(DRM_MODE_BLEND_COVERAGE): supported_modes &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_crtc_attach_background_color_property(crtc: *mut drm_crtc) {
