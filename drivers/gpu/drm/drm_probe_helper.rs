...
//! Source: drivers/gpu/drm/drm_probe_helper.c
#![no_std]
...
//
    let mut drm_kms_helper_poll: static bool = true;
...
#[no_mangle]
unsafe extern "C" fn drm_helper_probe_add_cmdline_mode(connector: *mut drm_connector) -> c_int {
...
// status = MODE_OK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: connector_funcs->mode_valid_ctx) -> else {
    else if (connector_funcs.mode_valid_ctx)
    ret = connector_funcs.mode_valid_ctx(connector, mode, ctx,
    status);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: connector_funcs->mode_valid) -> else {
...
#[no_mangle]
unsafe extern "C" fn drm_kms_helper_disable_hpd(dev: *mut drm_device) {
...
#[no_mangle]
unsafe extern "C" fn drm_kms_helper_enable_hpd(dev: *mut drm_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn reschedule_output_poll_work(dev: *mut drm_device) {
    static void reschedule_output_poll_work(struct drm_device *dev)
    {
    let mut delay: c_ulong = DRM_OUTPUT_POLL_PERIOD;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_kms_helper_poll_enable(dev: *mut drm_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_kms_helper_poll_reschedule(dev: *mut drm_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: connector->funcs->detect) -> else {
...
#[no_mangle]
unsafe extern "C" fn drm_helper_probe_get_modes(connector: *mut drm_connector) -> c_int {
...
//
    ...
    connector.base.id, connector.name);
    drm_connector_update_edid_property(connector, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_kms_helper_hotplug_event(dev: *mut drm_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_kms_helper_connector_hotplug_event(connector: *mut drm_connector) {
...
unsafe extern "C" fn output_poll_execute(work: *mut work_struct) {
    ...
    struct drm_connector_list_iter conn_iter;
    enum drm_connector_status old_status;
    let mut repoll: bool = false, changed = false;
...
// if we are connected and don't want to poll for disconnect
    ...
    connector.status = drm_helper_probe_detect(connector, core::ptr::null_mut(), false);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_kms_helper_is_poll_worker() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_kms_helper_poll_disable(dev: *mut drm_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_kms_helper_poll_init(dev: *mut drm_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_kms_helper_poll_fini(dev: *mut drm_device) {
...
#[no_mangle]
unsafe extern "C" fn drm_kms_helper_poll_init_release(dev: *mut drm_device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drmm_kms_helper_poll_init(dev: *mut drm_device) {
...
#[no_mangle]
unsafe extern "C" fn check_connector_changed(connector: *mut drm_connector) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_helper_hpd_irq_event(connector: *mut drm_connector) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_helper_hpd_irq_event(dev: *mut drm_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(fixed_mode->hdisplay: mode->hdisplay !=) -> else {
    else if (mode.hdisplay != fixed_mode.hdisplay)
    return MODE_ONE_WIDTH;
#[no_mangle]
pub unsafe extern "C" fn if(fixed_mode->vdisplay: mode->vdisplay !=) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_helper_get_modes(connector: *mut drm_connector) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_helper_tv_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(DRM_MODE_TV_MODE_PAL: tv_modes[i] ==) -> else {
