...
//! Source: drivers/gpu/drm/omapdrm/dss/dispc.h
#![no_std]
...
pub const DISPC_GAMMA_TABLE0: c_uint = 0x0630;
pub const DISPC_GAMMA_TABLE1: c_uint = 0x0634;
pub const DISPC_GAMMA_TABLE2: c_uint = 0x0638;
pub const DISPC_GAMMA_TABLE3: c_uint = 0x0850;
