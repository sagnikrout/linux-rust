...
//! Source: drivers/gpu/drm/omapdrm/dss/hdmi4_core.h
#![no_std]
...
extern "C" {
    pub fn hdmi4_core_ddc_init(core: *mut hdmi_core_data) -> c_int;
}
extern "C" {
    pub fn hdmi4_core_ddc_read(data: *mut c_void, buf: *mut u8, block: c_uint, len: usize) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn hdmi4_core_enable(core: *mut hdmi_core_data) -> c_int;
}
extern "C" {
    pub fn hdmi4_core_disable(core: *mut hdmi_core_data);
}
extern "C" {
    pub fn hdmi4_core_powerdown_disable(core: *mut hdmi_core_data);
}
extern "C" {
