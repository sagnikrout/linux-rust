...
//! Source: drivers/gpu/drm/omapdrm/dss/venc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct venc_device {
    pub pdev: *mut platform_device,
    pub base: *mut void __iomem,
    pub vdda_dac_reg: *mut regulator,
    pub dss: *mut dss_device,
    pub debugfs: *mut dss_debugfs_entry,
    pub tv_dac_clk: *mut clk,
    pub config: *const venc_config,
    pub type: enum omap_dss_venc_type,
    pub invert_polarity: bool,
    pub requires_tv_dac_clk: bool,
    pub output: omap_dss_device,
    pub bridge: drm_bridge,
}

#[no_mangle]
pub unsafe extern "C" fn venc_write_reg(venc: *mut venc_device, idx: c_int, val: u32) {
    static inline void venc_write_reg(struct venc_device *venc, int idx, u32 val)
    {
    __raw_writel(val, venc.base + idx);
    }
#[no_mangle]
pub unsafe extern "C" fn venc_read_reg(venc: *mut venc_device, idx: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn venc_reset(venc: *mut venc_device) {
...
#[no_mangle]
unsafe extern "C" fn venc_runtime_get(venc: *mut venc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_runtime_put(venc: *mut venc_device) {
...
#[no_mangle]
unsafe extern "C" fn venc_power_on(venc: *mut venc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_power_off(venc: *mut venc_device) {
...
#[no_mangle]
unsafe extern "C" fn venc_get_videomode(mode: *const drm_display_mode) -> enum venc_videomode {
...
#[no_mangle]
unsafe extern "C" fn venc_dump_regs(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_get_clocks(venc: *mut venc_device) -> c_int {
...
//
    ...
    {
    struct venc_device *venc = drm_bridge_to_venc(bridge);
    let mut venc_mode: enum venc_videomode = venc_get_videomode(adjusted_mode);
    switch (venc_mode) {
    default:
    WARN_ON_ONCE(1);
    fallthrough;
...
#[no_mangle]
unsafe extern "C" fn venc_bridge_init(venc: *mut venc_device) {
...
#[no_mangle]
unsafe extern "C" fn venc_bridge_cleanup(venc: *mut venc_device) {
...
//
#[no_mangle]
unsafe extern "C" fn venc_init_output(venc: *mut venc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_uninit_output(venc: *mut venc_device) {
...
#[no_mangle]
unsafe extern "C" fn venc_probe_of(venc: *mut venc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_runtime_suspend(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn venc_runtime_resume(dev: *mut device) -> __maybe_unused int {
    ...
    SET_RUNTIME_PM_OPS(venc_runtime_suspend, venc_runtime_resume, core::ptr::null_mut())
