...
//! Source: drivers/gpu/drm/omapdrm/dss/dpi.c
#![no_std]
...
pub struct dpi_data {
    ...
    pub dss_model: enum dss_model,
    pub dss: *mut dss_device,
    pub id: c_uint,
    pub vdds_dsi_reg: *mut regulator,
    pub clk_src: enum dss_clk_source,
    pub pll: *mut dss_pll,
...
#[no_mangle]
unsafe extern "C" fn dpi_get_clk_src(dpi: *mut dpi_data) -> enum dss_clk_source {
    static enum dss_clk_source dpi_get_clk_src(struct dpi_data *dpi)
    {
    let mut channel: enum omap_channel = dpi.output.dispc_channel;
//
...
pub struct dpi_clk_calc_ctx {
    pub dpi: *mut dpi_data,
    pub clkout_idx: c_uint,
// inputs
    pub pck_max: unsigned long pck_min,,
// outputs
    pub pll_cinfo: dss_pll_clock_info,
    pub fck: c_ulong,
...
#[no_mangle]
unsafe extern "C" fn dpi_set_pll_clk(dpi: *mut dpi_data, pck_req: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpi_set_dispc_clk(dpi: *mut dpi_data, pck_req: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpi_clock_update(dpi: *mut dpi_data, clock: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpi_verify_pll(pll: *mut dss_pll) -> c_int {
...
//
    ...
    {
    struct dpi_data *dpi = drm_bridge_to_dpi(bridge);
    let mut clock: c_ulong = mode.clock * 1000;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn dpi_bridge_init(dpi: *mut dpi_data) {
...
#[no_mangle]
unsafe extern "C" fn dpi_bridge_cleanup(dpi: *mut dpi_data) {
...
//
#[no_mangle]
unsafe extern "C" fn dpi_get_channel(dpi: *mut dpi_data) -> enum omap_channel {
...
#[no_mangle]
unsafe extern "C" fn dpi_init_output_port(dpi: *mut dpi_data, port: *mut device_node) -> c_int {
