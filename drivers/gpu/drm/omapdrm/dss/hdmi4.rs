...
//! Source: drivers/gpu/drm/omapdrm/dss/hdmi4.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hdmi_runtime_get(hdmi: *mut omap_hdmi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_runtime_put(hdmi: *mut omap_hdmi) {
...
//
    ...
    let mut intr4: u32 = hdmi_read_reg(hdmi.core.base, HDMI_CORE_SYS_INTR4);
...
#[no_mangle]
unsafe extern "C" fn hdmi_power_on_core(hdmi: *mut omap_hdmi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_power_off_core(hdmi: *mut omap_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_power_on_full(hdmi: *mut omap_hdmi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_power_off_full(hdmi: *mut omap_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_dump_regs(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hdmi4_core_enable(core: *mut hdmi_core_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hdmi4_core_disable(core: *mut hdmi_core_data) {
...
//
    ...
    {
    struct omap_hdmi *hdmi = drm_bridge_to_hdmi(bridge);
    const struct drm_edid *drm_edid = core::ptr::null_mut();
...
//
    ...
    let mut len: c_uint = (edid.extensions + 1) * EDID_LENGTH;
    cec_addr = cec_get_edid_phys_addr((u8 *)edid, len, core::ptr::null_mut());
    } else {
...
#[no_mangle]
unsafe extern "C" fn hdmi4_bridge_init(hdmi: *mut omap_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn hdmi4_bridge_cleanup(hdmi: *mut omap_hdmi) {
...
//
    ...
    mutex_lock(&hd.lock);
    WARN_ON(hd.audio_abort_cb != core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn hdmi_audio_register(hdmi: *mut omap_hdmi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hdmi4_init_output(hdmi: *mut omap_hdmi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi4_uninit_output(hdmi: *mut omap_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn hdmi4_probe_of(hdmi: *mut omap_hdmi) -> c_int {
