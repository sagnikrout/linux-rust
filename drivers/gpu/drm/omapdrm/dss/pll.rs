...
//! Source: drivers/gpu/drm/omapdrm/dss/pll.c
#![no_std]
...
pub const PLL_CONTROL: c_uint = 0x0000;
pub const PLL_STATUS: c_uint = 0x0004;
pub const PLL_GO: c_uint = 0x0008;
pub const PLL_CONFIGURATION1: c_uint = 0x000C;
pub const PLL_CONFIGURATION2: c_uint = 0x0010;
pub const PLL_CONFIGURATION3: c_uint = 0x0014;
pub const PLL_SSC_CONFIGURATION1: c_uint = 0x0018;
pub const PLL_SSC_CONFIGURATION2: c_uint = 0x001C;
pub const PLL_CONFIGURATION4: c_uint = 0x0020;
#[no_mangle]
pub unsafe extern "C" fn dss_pll_register(dss: *mut dss_device, pll: *mut dss_pll) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dss_pll_unregister(pll: *mut dss_pll) {
    ...
    for (i = 0; i < ARRAY_SIZE(dss.plls); ++i) {
    if (dss.plls[i] == pll) {
    dss.plls[i] = core::ptr::null_mut();
    pll.dss = core::ptr::null_mut();
    return;
    }
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn dss_pll_get_clkout_idx_for_src(src: enum dss_clk_source) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn dss_pll_enable(pll: *mut dss_pll) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dss_pll_disable(pll: *mut dss_pll) {
...
#[no_mangle]
pub unsafe extern "C" fn dss_pll_set_config(pll: *mut dss_pll, cinfo: *const dss_pll_clock_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wait_for_bit_change(reg: *mut void __iomem, bitnum: c_int, value: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dss_pll_wait_reset_done(pll: *mut dss_pll) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dss_wait_hsdiv_ack(pll: *mut dss_pll, hsdiv_ack_mask: u32) -> c_int {
    static int dss_wait_hsdiv_ack(struct dss_pll *pll, u32 hsdiv_ack_mask)
    {
    let mut t: c_int = 100;
    while (t-- > 0) {
    let mut v: u32 = readl_relaxed(pll.base + PLL_STATUS);
    v &= hsdiv_ack_mask;
    if (v == hsdiv_ack_mask)
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn pll_is_locked(stat: u32) -> bool {
...
// M7
    ...
    let mut f: u32 = cinfo.clkdco < hw.clkdco_low ? 0x2 : 0x4;
    ...
    let mut cnt: c_int = 0;
    u32 sleep_time;
    let mut max_lock_retries: u32 = 20;
//
