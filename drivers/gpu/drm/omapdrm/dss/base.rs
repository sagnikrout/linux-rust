...
//! Source: drivers/gpu/drm/omapdrm/dss/base.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn omapdss_device_register(dssdev: *mut omap_dss_device) {
...
#[no_mangle]
pub unsafe extern "C" fn omapdss_device_unregister(dssdev: *mut omap_dss_device) {
...
#[no_mangle]
unsafe extern "C" fn omapdss_device_is_registered(node: *mut device_node) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn omapdss_device_put(dssdev: *mut omap_dss_device) {
...
#[no_mangle]
unsafe extern "C" fn omapdss_device_is_connected(dssdev: *mut omap_dss_device) -> bool {
    ...
    dst ? dev_name(dst.dev) : "core::ptr::null_mut()");
    if (!dst)
    return -EINVAL;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omapdss_comp_node {
    pub list: list_head,
    pub node: *mut device_node,
    pub dss_core_component: bool,
    pub compat: *const c_char,
}

#[no_mangle]
unsafe extern "C" fn omapdss_list_contains(node: *const device_node) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn omapdss_gather_components(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn omapdss_component_is_loaded(comp: *mut omapdss_comp_node) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn omapdss_stack_is_ready() -> bool {
