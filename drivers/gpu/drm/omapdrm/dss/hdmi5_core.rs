...
//! Source: drivers/gpu/drm/omapdrm/dss/hdmi5_core.h
#![no_std]
...
extern "C" {
    pub fn hdmi5_core_ddc_init(core: *mut hdmi_core_data);
}
extern "C" {
    pub fn hdmi5_core_ddc_read(data: *mut c_void, buf: *mut u8, block: c_uint, len: usize) -> c_int;
}
extern "C" {
    pub fn hdmi5_core_ddc_uninit(core: *mut hdmi_core_data);
}
extern "C" {
