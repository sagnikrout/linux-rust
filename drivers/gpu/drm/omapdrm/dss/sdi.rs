...
//! Source: drivers/gpu/drm/omapdrm/dss/sdi.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdi_device {
    pub pdev: *mut platform_device,
    pub dss: *mut dss_device,
    pub update_enabled: bool,
    pub vdds_sdi_reg: *mut regulator,
...
#[no_mangle]
unsafe extern "C" fn sdi_config_lcd_manager(sdi: *mut sdi_device) {
...
//
    ...
    {
    struct sdi_device *sdi = drm_bridge_to_sdi(bridge);
    let mut pixelclock: c_ulong = mode.clock * 1000;
    struct dispc_clock_info dispc_cinfo;
    unsigned long fck;
    int ret;
    if (pixelclock == 0)
...
#[no_mangle]
unsafe extern "C" fn sdi_bridge_init(sdi: *mut sdi_device) {
...
#[no_mangle]
unsafe extern "C" fn sdi_bridge_cleanup(sdi: *mut sdi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn sdi_init_output(sdi: *mut sdi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdi_uninit_output(sdi: *mut sdi_device) {
