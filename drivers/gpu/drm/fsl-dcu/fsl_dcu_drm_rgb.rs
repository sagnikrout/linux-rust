...
//! Source: drivers/gpu/drm/fsl-dcu/fsl_dcu_drm_rgb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fsl_dcu_drm_connector_destroy(connector: *mut drm_connector) {
...
#[no_mangle]
unsafe extern "C" fn fsl_dcu_drm_connector_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_dcu_panel_put_action(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn fsl_dcu_create_outputs(fsl_dev: *mut fsl_dcu_drm_device) -> c_int {
...
// This is for backward compatibility
    ...
    return drm_bridge_attach(&fsl_dev.encoder, bridge, core::ptr::null_mut(), 0);
    }
