...
//! Source: drivers/gpu/drm/ast/ast_dp501.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ast_release_firmware(data: *mut c_void) {
    static void ast_release_firmware(void *data)
    {
    struct ast_device *ast = data;
    release_firmware(ast.dp501_fw);
    ast.dp501_fw = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ast_load_dp501_microcode(ast: *mut ast_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_ack(ast: *mut ast_device) {
...
#[no_mangle]
unsafe extern "C" fn send_nack(ast: *mut ast_device) {
...
#[no_mangle]
unsafe extern "C" fn wait_ack(ast: *mut ast_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wait_nack(ast: *mut ast_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn set_cmd_trigger(ast: *mut ast_device) {
    static void set_cmd_trigger(struct ast_device *ast)
    {
    ast_set_index_reg_mask(ast, AST_IO_VGACRI, 0x9b, ~0x40, 0x40);
    }
#[no_mangle]
unsafe extern "C" fn clear_cmd_trigger(ast: *mut ast_device) {
...
#[no_mangle]
unsafe extern "C" fn wait_fw_ready(ast: *mut ast_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ast_write_cmd(ast: *mut ast_device, data: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ast_write_data(ast: *mut ast_device, data: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ast_read_data(dev: *mut drm_device, data: *mut u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn clear_cmd(ast: *mut ast_device) {
...
#[no_mangle]
unsafe extern "C" fn ast_set_dp501_video_output(ast: *mut ast_device, mode: u8) {
...
#[no_mangle]
unsafe extern "C" fn get_fw_base(ast: *mut ast_device) -> u32 {
    static u32 get_fw_base(struct ast_device *ast)
    {
    return ast_mindwm(ast, AST_REG_SCU104) & 0x7fffffff;
    }
#[no_mangle]
pub unsafe extern "C" fn ast_backup_fw(ast: *mut ast_device, addr: *mut u8, size: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ast_launch_m68k(ast: *mut ast_device) -> bool {
    static bool ast_launch_m68k(struct ast_device *ast)
    {
    u32 i, data, len = 0;
    u32 boot_address;
    u8 *fw_addr = core::ptr::null_mut();
    u8 jreg;
    if (ast.config_mode != ast_use_p2a)
    return false;
    data = ast_mindwm(ast, AST_REG_SCU100) & 0x01;
...
#[no_mangle]
unsafe extern "C" fn ast_dp501_is_connected(ast: *mut ast_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ast_dp512_read_edid_block(data: *mut c_void, buf: *mut u8, block: c_uint, len: usize) -> c_int {
    static int ast_dp512_read_edid_block(void *data, u8 *buf, unsigned int block, size_t len)
    {
    struct ast_device *ast = data;
    let mut rdlen: usize = round_up(len, 4);
...
#[no_mangle]
unsafe extern "C" fn ast_init_dvo(ast: *mut ast_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ast_init_analog(ast: *mut ast_device) {
...
#[no_mangle]
pub unsafe extern "C" fn ast_init_3rdtx(ast: *mut ast_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ast_dp501_connector_helper_get_modes(connector: *mut drm_connector) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ast_dp501_output_init(ast: *mut ast_device) -> c_int {
