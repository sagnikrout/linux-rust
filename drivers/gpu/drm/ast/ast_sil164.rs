...
//! Source: drivers/gpu/drm/ast/ast_sil164.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ast_sil164_connector_helper_get_modes(connector: *mut drm_connector) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ast_sil164_output_init(ast: *mut ast_device) -> c_int {
