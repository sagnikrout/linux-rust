...
//! Source: drivers/gpu/drm/ast/ast_dp.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast_astdp_mode_index_table_entry {
    pub hdisplay: c_uint,
    pub vdisplay: c_uint,
    pub mode_index: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast_astdp_connector_state {
    pub base: drm_connector_state,
    pub mode_index: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn ast_astdp_get_mode_index(hdisplay: c_uint, vdisplay: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ast_astdp_is_connected(ast: *mut ast_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ast_astdp_read_edid_block(data: *mut c_void, buf: *mut u8, block: c_uint, len: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ast_dp_launch(ast: *mut ast_device) -> c_int {
    int ast_dp_launch(struct ast_device *ast)
    {
    struct drm_device *dev = &ast.base;
    let mut i: c_uint = 10;
    while (i) {
    let mut vgacrd1: u8 = ast_get_index_reg(ast, AST_IO_VGACRI, 0xd1);
...
#[no_mangle]
unsafe extern "C" fn ast_dp_get_phy_sleep(ast: *mut ast_device) -> bool {
    static bool ast_dp_get_phy_sleep(struct ast_device *ast)
    {
    let mut vgacre3: u8 = ast_get_index_reg(ast, AST_IO_VGACRI, 0xe3);
    return (vgacre3 & AST_IO_VGACRE3_DP_PHY_SLEEP);
    }
#[no_mangle]
unsafe extern "C" fn ast_dp_set_phy_sleep(ast: *mut ast_device, sleep: bool) {
    static void ast_dp_set_phy_sleep(struct ast_device *ast, bool sleep)
    {
    let mut vgacre3: u8 = 0x00;
    if (sleep)
...
#[no_mangle]
unsafe extern "C" fn ast_dp_link_training(ast: *mut ast_device) {
...
#[no_mangle]
unsafe extern "C" fn __ast_dp_wait_enable(ast: *mut ast_device, enabled: bool) -> bool {
    static bool __ast_dp_wait_enable(struct ast_device *ast, bool enabled)
    {
    let mut vgacrdf_test: u8 = 0x00;
    u8 vgacrdf;
    unsigned int i;
    if (enabled)
...
#[no_mangle]
unsafe extern "C" fn ast_dp_set_enable(ast: *mut ast_device, enabled: bool) {
...
//
    ...
    let mut mode_index: c_int = astdp_conn_state.mode_index;
...
//
#[no_mangle]
unsafe extern "C" fn ast_astdp_connector_helper_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ast_astdp_connector_reset(connector: *mut drm_connector) {
    ...
    __drm_atomic_helper_connector_reset(connector, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn ast_astdp_output_init(ast: *mut ast_device) -> c_int {
