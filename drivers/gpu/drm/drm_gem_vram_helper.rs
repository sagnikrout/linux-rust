...
//! Source: drivers/gpu/drm/drm_gem_vram_helper.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn drm_gem_vram_cleanup(gbo: *mut drm_gem_vram_object) {
...
#[no_mangle]
unsafe extern "C" fn drm_gem_vram_destroy(gbo: *mut drm_gem_vram_object) {
...
#[no_mangle]
unsafe extern "C" fn ttm_buffer_object_destroy(bo: *mut ttm_buffer_object) {
...
//
    ...
    &gbo.placement, pg_align, false, core::ptr::null_mut(), core::ptr::null_mut(),
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_vram_put(gbo: *mut drm_gem_vram_object) {
...
#[no_mangle]
unsafe extern "C" fn drm_gem_vram_pg_offset(gbo: *mut drm_gem_vram_object) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_vram_offset(gbo: *mut drm_gem_vram_object) -> i64 {
...
#[no_mangle]
unsafe extern "C" fn drm_gem_vram_pin(gbo: *mut drm_gem_vram_object, pl_flag: c_ulong) -> c_int {
    static int drm_gem_vram_pin(struct drm_gem_vram_object *gbo, unsigned long pl_flag)
    {
    int ret;
    ret = ttm_bo_reserve(&gbo.bo, true, false, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn drm_gem_vram_unpin_locked(gbo: *mut drm_gem_vram_object) {
...
#[no_mangle]
unsafe extern "C" fn drm_gem_vram_unpin(gbo: *mut drm_gem_vram_object) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_vram_vmap(gbo: *mut drm_gem_vram_object, map: *mut iosys_map) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn drm_is_gem_vram(bo: *mut ttm_buffer_object) -> bool {
...
#[no_mangle]
unsafe extern "C" fn drm_gem_vram_bo_driver_move_notify(gbo: *mut drm_gem_vram_object) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_gem_vram_object_free(gem: *mut drm_gem_object) {
...
//
#[no_mangle]
unsafe extern "C" fn bo_driver_ttm_tt_destroy(bdev: *mut ttm_device, tt: *mut ttm_tt) {
...
#[no_mangle]
unsafe extern "C" fn bo_driver_delete_mem_notify(bo: *mut ttm_buffer_object) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_vram_mm_debugfs(m: *mut seq_file, data: *mut c_void) -> c_int {
    ...
    { "vram-mm", drm_vram_mm_debugfs, 0, core::ptr::null_mut() },
    };
//
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_vram_mm_debugfs_init(minor: *mut drm_minor) {
...
#[no_mangle]
unsafe extern "C" fn drm_vram_mm_cleanup(vmm: *mut drm_vram_mm) {
...
//
    ...
    err_kfree:
    kfree(dev.vram_mm);
    dev.vram_mm = core::ptr::null_mut();
    return ERR_PTR(ret);
    }
#[no_mangle]
unsafe extern "C" fn drm_vram_helper_release_mm(dev: *mut drm_device) {
...
#[no_mangle]
unsafe extern "C" fn drm_vram_mm_release(dev: *mut drm_device, ptr: *mut c_void) {
...
//
    ...
    return drmm_add_action_or_reset(dev, drm_vram_mm_release, core::ptr::null_mut());
    }
