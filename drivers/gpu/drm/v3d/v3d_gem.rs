...
//! Source: drivers/gpu/drm/v3d/v3d_gem.c
#![no_std]
...
//
    ...
    {
    let mut version: c_int = V3D_BRIDGE_READ(V3D_TOP_GR_BRIDGE_REVISION);
...
// Re-arm the global perfmon HW counters that the reset zeroed.
    ...
    {
    if (v3d.ver < V3D_GEN_41) {
    let mut gca_ctrl: u32 = V3D_GCA_READ(V3D_GCA_CACHE_CTRL);
