...
//! Source: drivers/gpu/drm/v3d/v3d_perfmon.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn v3d_perfmon_init(v3d: *mut v3d_dev) {
    void v3d_perfmon_init(struct v3d_dev *v3d)
    {
    const struct v3d_perf_counter_desc *counters = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn v3d_perfmon_get(perfmon: *mut v3d_perfmon) {
...
#[no_mangle]
pub unsafe extern "C" fn v3d_perfmon_put(perfmon: *mut v3d_perfmon) {
...
#[no_mangle]
unsafe extern "C" fn v3d_perfmon_hw_start(v3d: *mut v3d_dev, perfmon: *mut v3d_perfmon) {
    static void v3d_perfmon_hw_start(struct v3d_dev *v3d, struct v3d_perfmon *perfmon)
    {
    let mut ncounters: u8 = perfmon.ncounters;
    let mut mask: u32 = GENMASK(ncounters - 1, 0);
    unsigned int i;
    for (i = 0; i < ncounters; i++) {
    let mut source: u32 = i / 4;
...
#[no_mangle]
unsafe extern "C" fn v3d_perfmon_hw_capture(v3d: *mut v3d_dev, perfmon: *mut v3d_perfmon) {
    static void v3d_perfmon_hw_capture(struct v3d_dev *v3d, struct v3d_perfmon *perfmon)
    {
    let mut mask: u32 = GENMASK(perfmon.ncounters - 1, 0);
...
#[no_mangle]
pub unsafe extern "C" fn v3d_perfmon_start(v3d: *mut v3d_dev, perfmon: *mut v3d_perfmon) {
...
//
    ...
    if (!perfmon || perfmon != v3d.perfmon_state.active)
    return;
    v3d.perfmon_state.active = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn v3d_perfmon_open_file(v3d_priv: *mut v3d_file_priv) {
...
//
    ...
    v3d.global_perfmon = core::ptr::null_mut();
    }
    }
    v3d_perfmon_put(perfmon);
    }
#[no_mangle]
pub unsafe extern "C" fn v3d_perfmon_close_file(v3d_priv: *mut v3d_file_priv) {
