...
//! Source: drivers/gpu/drm/v3d/v3d_sched.c
#![no_std]
...
pub const V3D_CSD_CFG012_WG_COUNT_SHIFT: c_int = 16;
...
#[no_mangle]
pub unsafe extern "C" fn v3d_stats_release(refcount: *mut kref) {
...
//
    ...
    out_clean_job:
    spin_lock_irqsave(&queue.queue_lock, irqflags);
    queue.active_job = core::ptr::null_mut();
    spin_unlock_irqrestore(&queue.queue_lock, irqflags);
    return fence;
    }
...
//
    ...
    return fence;
    out_clean_job:
    v3d.queue[V3D_RENDER].active_job = core::ptr::null_mut();
    return fence;
    }
...
// ICFG kicks off the job.
    ...
    return fence;
    out_clean_job:
    v3d.queue[V3D_TFU].active_job = core::ptr::null_mut();
    return fence;
    }
    static struct dma_fence *
...
// CFG0 write kicks off the job.
    ...
    return fence;
    out_clean_job:
    v3d.queue[V3D_CSD].active_job = core::ptr::null_mut();
    return fence;
    }
    static void
...
// 0xffffffff indicates that the uniform rewrite is not needed
    ...
    let mut uniform_idx: u32 = indirect_csd.wg_uniform_offsets[i];
...
// ((u64 *)value_addr) = 0;
    drm_syncobj_replace_fence(queries[i].syncobj, core::ptr::null_mut());
    }
    v3d_put_bo_vaddr(bo);
    }
#[no_mangle]
unsafe extern "C" fn write_to_buffer_32(dst: *mut u32, idx: c_uint, value: u32) {
    static void write_to_buffer_32(u32 *dst, unsigned int idx, u32 value)
    {
    dst[idx] = value;
    }
#[no_mangle]
unsafe extern "C" fn write_to_buffer_64(dst: *mut u64, idx: c_uint, value: u64) {
    ...
    drm_syncobj_replace_fence(performance_query.queries[i].syncobj, core::ptr::null_mut());
    }
    }
    static void
...
// Unblock schedulers and restart their jobs.
    ...
    struct v3d_job *job = to_v3d_job(sched_job);
    struct v3d_dev *v3d = job.v3d;
    let mut ctca: u32 = V3D_CORE_READ(0, V3D_CLE_CTNCA(q));
    let mut ctra: u32 = V3D_CORE_READ(0, V3D_CLE_CTNRA(q));
...
// timedout_ctra = ctra;
    ...
    struct v3d_csd_job *job = to_csd_job(sched_job);
    struct v3d_dev *v3d = job.base.v3d;
    let mut batches: u32 = V3D_CORE_READ(0, V3D_CSD_CURRENT_CFG4(v3d.ver));
