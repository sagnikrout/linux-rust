...
//! Source: drivers/gpu/drm/v3d/v3d_debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn v3d_v3d_debugfs_regs(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v3d_v3d_debugfs_ident(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v3d_debugfs_bo_stats(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v3d_measure_clock(m: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    let mut measure_ms: c_int = 1000;
    int ret;
    ret = v3d_pm_runtime_get(v3d);
    if (ret)
    return ret;
    if (v3d.ver >= V3D_GEN_41) {
    let mut cycle_count_reg: c_int = V3D_PCTR_CYCLE_COUNT(v3d.ver);
...
#[no_mangle]
unsafe extern "C" fn v3d_debugfs_mm(m: *mut seq_file, unused: *mut c_void) -> c_int {
