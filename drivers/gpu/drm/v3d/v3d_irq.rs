...
//! Source: drivers/gpu/drm/v3d/v3d_irq.c
#![no_std]
...
//
    ...
    struct v3d_bo *bo = v3d_bo_create(dev, core::ptr::null_mut() /* XXX: GMP */, 256 * 1024);
...
// Acknowledge the interrupts we're handling here.
    ...
    V3D_HUB_INT_MMU_PTI |
    V3D_HUB_INT_MMU_CAP)) {
    let mut axi_id: u32 = V3D_READ(V3D_MMU_VIO_ID);
...
#[no_mangle]
pub unsafe extern "C" fn v3d_irq_reset(v3d: *mut v3d_dev) {
