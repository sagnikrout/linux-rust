...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_init(dev: *mut drm_device, shmem: *mut drm_gem_shmem_object, size: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __drm_gem_shmem_free_sgt_locked(shmem: *mut drm_gem_shmem_object) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_release(shmem: *mut drm_gem_shmem_object) {
    ...
    dma_resv_lock(shmem.base.resv, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_free(shmem: *mut drm_gem_shmem_object) {
...
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_get_pages_locked(shmem: *mut drm_gem_shmem_object) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_put_pages_locked(shmem: *mut drm_gem_shmem_object) {
...
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_pin_locked(shmem: *mut drm_gem_shmem_object) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_unpin_locked(shmem: *mut drm_gem_shmem_object) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_pin(shmem: *mut drm_gem_shmem_object) -> c_int {
    ...
    if (refcount_inc_not_zero(&shmem.pages_pin_count))
    return 0;
    ret = dma_resv_lock_interruptible(shmem.base.resv, core::ptr::null_mut());
    if (ret)
    return ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_unpin(shmem: *mut drm_gem_shmem_object) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_madvise_locked(shmem: *mut drm_gem_shmem_object, madv: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_purge_locked(shmem: *mut drm_gem_shmem_object) {
...
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_record_mkwrite(vmf: *mut vm_fault) {
    static void drm_gem_shmem_record_mkwrite(struct vm_fault *vmf)
    {
    struct vm_area_struct *vma = vmf.vma;
    struct drm_gem_object *obj = vma.vm_private_data;
    struct drm_gem_shmem_object *shmem = to_drm_gem_shmem_obj(obj);
    let mut num_pages: loff_t = obj.size >> PAGE_SHIFT;
    ...
    let mut paddr: c_ulong = pfn << PAGE_SHIFT;
    struct vm_area_struct *vma = vmf.vma;
    let mut start: c_ulong = ALIGN_DOWN(vmf.address, PMD_SIZE);
    let mut end: c_ulong = start + PMD_SIZE;
    let mut in_range: bool = vma.vm_start <= start && end <= vma.vm_end;
    let mut aligned: bool = (vmf.address & ~PMD_MASK) == (paddr & ~PMD_MASK);
    if (aligned && in_range &&
...
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_any_fault(vmf: *mut vm_fault, order: c_uint) -> vm_fault_t {
    ...
    return VM_FAULT_FALLBACK;
    dma_resv_lock(obj.resv, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_fault(vmf: *mut vm_fault) -> vm_fault_t {
    static vm_fault_t drm_gem_shmem_fault(struct vm_fault *vmf)
    {
    return drm_gem_shmem_any_fault(vmf, 0);
    }
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_vm_open(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_vm_close(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_pfn_mkwrite(vmf: *mut vm_fault) -> vm_fault_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_mmap(shmem: *mut drm_gem_shmem_object, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_vmap(shmem: *mut drm_gem_shmem_object, map: *mut iosys_map) -> c_int {
    int drm_gem_shmem_vmap(struct drm_gem_shmem_object *shmem, struct iosys_map *map)
    {
    struct drm_gem_object *obj = &shmem.base;
    int ret;
    ret = dma_resv_lock_interruptible(obj.resv, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_vunmap(shmem: *mut drm_gem_shmem_object, map: *mut iosys_map) {
    void drm_gem_shmem_vunmap(struct drm_gem_shmem_object *shmem, struct iosys_map *map)
    {
    struct drm_gem_object *obj = &shmem.base;
    dma_resv_lock_interruptible(obj.resv, core::ptr::null_mut());
    drm_gem_shmem_vunmap_locked(shmem, map);
    dma_resv_unlock(obj.resv);
    }
    EXPORT_SYMBOL_IF_KUNIT(drm_gem_shmem_vunmap);
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_madvise(shmem: *mut drm_gem_shmem_object, madv: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drm_gem_shmem_purge(shmem: *mut drm_gem_shmem_object) -> c_int {
