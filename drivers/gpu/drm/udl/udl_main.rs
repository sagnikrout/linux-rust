...
//! Source: drivers/gpu/drm/udl/udl_main.c
#![no_std]
...
pub const UDL_SKU_PIXEL_LIMIT_DEFAULT: c_int = 2080000;
...
#[no_mangle]
unsafe extern "C" fn udl_parse_vendor_descriptor(udl: *mut udl_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn udl_select_std_channel(udl: *mut udl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn udl_urb_completion(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn udl_free_urb_list(udl: *mut udl_device) {
...
#[no_mangle]
unsafe extern "C" fn udl_alloc_urb_list(udl: *mut udl_device, count: c_int, size: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn udl_submit_urb(udl: *mut udl_device, urb: *mut urb, len: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn udl_sync_pending_urbs(udl: *mut udl_device) {
...
#[no_mangle]
pub unsafe extern "C" fn udl_init(udl: *mut udl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn udl_drop_usb(udl: *mut udl_device) -> c_int {
