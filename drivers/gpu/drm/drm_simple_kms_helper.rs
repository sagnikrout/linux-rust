...
//! Source: drivers/gpu/drm/drm_simple_kms_helper.c
#![no_std]
...
//
    ...
    encoder_type, core::ptr::null_mut());
    }
    EXPORT_SYMBOL(drm_simple_encoder_init);
    void *__drmm_simple_encoder_alloc(struct drm_device *dev, size_t size,
    size_t offset, int encoder_type)
    {
    return __drmm_encoder_alloc(dev, size, offset, core::ptr::null_mut(), encoder_type,
    core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn drm_simple_kms_crtc_reset(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn drm_simple_kms_crtc_destroy_state(crtc: *mut drm_crtc, state: *mut drm_crtc_state) {
...
#[no_mangle]
unsafe extern "C" fn drm_simple_kms_crtc_enable_vblank(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_simple_kms_crtc_disable_vblank(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn drm_simple_kms_plane_reset(plane: *mut drm_plane) {
    ...
    {
    return drm_bridge_attach(&pipe.encoder, bridge, core::ptr::null_mut(), 0);
    }
    ...
    &drm_simple_kms_crtc_funcs, core::ptr::null_mut());
    if (ret)
    return ret;
