...
//! Source: drivers/gpu/drm/tiny/appletbdrm.c
#![no_std]
...
pub const APPLETBDRM_BITS_PER_PIXEL: c_int = 24;

pub const APPLETBDRM_BULK_MSG_TIMEOUT: c_int = 1000;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct appletbdrm_msg_request_header {
    pub unk_00: __le16,
    pub unk_02: __le16,
    pub unk_04: __le32,
    pub unk_08: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct appletbdrm_msg_response_header {
    pub unk_00: [u8; 16],
    pub msg: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct appletbdrm_msg_simple_request {
    pub header: appletbdrm_msg_request_header,
    pub msg: __le32,
    pub unk_14: [u8; 8],
    pub size: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct appletbdrm_msg_information {
    pub header: appletbdrm_msg_response_header,
    pub unk_14: [u8; 12],
    pub width: __le32,
    pub height: __le32,
    pub bits_per_pixel: u8,
    pub bytes_per_row: __le32,
    pub orientation: __le32,
    pub bitmap_info: __le32,
    pub pixel_format: __le32,
    pub /: *mut *mut __le32 width_inches; / floating point,
    pub /: *mut *mut __le32 height_inches; / floating point,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct appletbdrm_frame {
    pub begin_x: __le16,
    pub begin_y: __le16,
    pub width: __le16,
    pub height: __le16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct appletbdrm_fb_request_footer {
    pub unk_00: [u8; 12],
    pub unk_0c: __le32,
    pub unk_10: [u8; 12],
    pub unk_1c: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct appletbdrm_fb_request {
    pub header: appletbdrm_msg_request_header,
    pub unk_10: __le16,
    pub msg_id: u8,
    pub unk_13: [u8; 29],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct appletbdrm_fb_request_response {
    pub header: appletbdrm_msg_response_header,
    pub unk_14: [u8; 12],
    pub timestamp: __le64,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct appletbdrm_plane_state {
    pub base: drm_shadow_plane_state,
    pub request: *mut appletbdrm_fb_request,
    pub response: *mut appletbdrm_fb_request_response,
    ...
    struct drm_device *drm = &adev.drm;
    int ret, actual_size;
    let mut readiness_signal_received: bool = false;
    retry:
...
#[no_mangle]
unsafe extern "C" fn appletbdrm_send_msg(adev: *mut appletbdrm_device, msg: __le32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn appletbdrm_clear_display(adev: *mut appletbdrm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn appletbdrm_signal_readiness(adev: *mut appletbdrm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn appletbdrm_get_information(adev: *mut appletbdrm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rect_size(rect: *mut drm_rect) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn appletbdrm_connector_helper_get_modes(connector: *mut drm_connector) -> c_int {
...
pub unsafe extern "C" fn if(_arg: !new_plane_state->visible) -> else {
    ...
    let mut timestamp: u64 = ktime_get_ns();
    struct drm_rect damage;
    let mut frames_size: usize = appletbdrm_state.frames_size;
    let mut request_size: usize = appletbdrm_state.request_size;
    int ret;
    if (!frames_size)
    return 0;
    ...
    drm_atomic_for_each_plane_damage(&iter, &damage) {
    let mut dst_clip: drm_rect = state.dst;
    let mut dst: iosys_map = IOSYS_MAP_INIT_VADDR(frame.buf);
    let mut buf_size: u32 = rect_size(&damage);
...
//
    ...
    drm_fb_xrgb8888_to_bgr888(&dst, core::ptr::null_mut(), &shadow_plane_state.data[0], fb, &damage, &shadow_plane_state.fmtcnv_state);
    break;
    default:
    drm_fb_memcpy(&dst, core::ptr::null_mut(), &shadow_plane_state.data[0], fb, &damage);
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn appletbdrm_primary_plane_reset(plane: *mut drm_plane) {
...
// Request and response are not duplicated and are allocated in .atomic_check
    appletbdrm_state.request = core::ptr::null_mut();
    appletbdrm_state.response = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn appletbdrm_setup_mode_config(adev: *mut appletbdrm_device) -> c_int {
    ...
    &appletbdrm_crtc_funcs, core::ptr::null_mut());
    if (ret) {
...
//
    ...
    struct drm_device *drm = core::ptr::null_mut();
    struct device *dma_dev;
    int ret;
    ret = usb_find_common_endpoints(intf.cur_altsetting, &bulk_in, &bulk_out, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn appletbdrm_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn appletbdrm_shutdown(intf: *mut usb_interface) {
