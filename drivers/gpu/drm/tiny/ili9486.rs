...
//! Source: drivers/gpu/drm/tiny/ili9486.c
#![no_std]
...
pub const ILI9486_ITFCTR1: c_uint = 0xb0;
pub const ILI9486_PWCTRL1: c_uint = 0xc2;
pub const ILI9486_VMCTRL1: c_uint = 0xc5;
pub const ILI9486_PGAMCTRL: c_uint = 0xe0;
pub const ILI9486_NGAMCTRL: c_uint = 0xe1;
pub const ILI9486_DGAMCTRL: c_uint = 0xe2;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ili9486_device {
...
#[no_mangle]
unsafe extern "C" fn ili9486_probe(spi: *mut spi_device) -> c_int {
    ...
    crtc = &ili9486.crtc;
    ret = drm_crtc_init_with_planes(drm, crtc, plane, core::ptr::null_mut(), &ili9486_crtc_funcs, core::ptr::null_mut());
    if (ret)
    return ret;
    drm_crtc_helper_add(crtc, &ili9486_crtc_helper_funcs);
    encoder = &ili9486.encoder;
    ret = drm_encoder_init(drm, encoder, &ili9486_encoder_funcs, DRM_MODE_ENCODER_NONE, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn ili9486_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn ili9486_shutdown(spi: *mut spi_device) {
