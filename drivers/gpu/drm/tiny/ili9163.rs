...
//! Source: drivers/gpu/drm/tiny/ili9163.c
#![no_std]
...
pub const ILI9163_FRMCTR1: c_uint = 0xb1;
pub const ILI9163_PWCTRL1: c_uint = 0xc0;
pub const ILI9163_PWCTRL2: c_uint = 0xc1;
pub const ILI9163_VMCTRL1: c_uint = 0xc5;
pub const ILI9163_VMCTRL2: c_uint = 0xc7;
pub const ILI9163_PWCTRLA: c_uint = 0xcb;
pub const ILI9163_PWCTRLB: c_uint = 0xcf;
pub const ILI9163_EN3GAM: c_uint = 0xf2;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ili9163_device {
...
#[no_mangle]
unsafe extern "C" fn ili9163_probe(spi: *mut spi_device) -> c_int {
    ...
    crtc = &ili9163.crtc;
    ret = drm_crtc_init_with_planes(drm, crtc, plane, core::ptr::null_mut(), &ili9163_crtc_funcs, core::ptr::null_mut());
    if (ret)
    return ret;
    drm_crtc_helper_add(crtc, &ili9163_crtc_helper_funcs);
    encoder = &ili9163.encoder;
    ret = drm_encoder_init(drm, encoder, &ili9163_encoder_funcs, DRM_MODE_ENCODER_NONE, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn ili9163_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn ili9163_shutdown(spi: *mut spi_device) {
