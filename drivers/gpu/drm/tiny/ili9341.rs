...
//! Source: drivers/gpu/drm/tiny/ili9341.c
#![no_std]
...
unsafe extern "C" fn ili9341_probe(spi: *mut spi_device) -> c_int {
    ...
    crtc = &ili9341.crtc;
    ret = drm_crtc_init_with_planes(drm, crtc, plane, core::ptr::null_mut(), &ili9341_crtc_funcs, core::ptr::null_mut());
    if (ret)
    return ret;
    drm_crtc_helper_add(crtc, &ili9341_crtc_helper_funcs);
    encoder = &ili9341.encoder;
    ret = drm_encoder_init(drm, encoder, &ili9341_encoder_funcs, DRM_MODE_ENCODER_NONE, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn ili9341_shutdown(spi: *mut spi_device) {
