...
//! Source: drivers/gpu/drm/tiny/sharp-memory.c
#![no_std]
...
pub const SHARP_MODE_PERIOD: c_int = 8;
pub const SHARP_ADDR_PERIOD: c_int = 8;
pub const SHARP_DUMMY_PERIOD: c_int = 8;
pub const SHARP_MEMORY_DISPLAY_MAINTAIN_MODE: c_int = 0;
pub const SHARP_MEMORY_DISPLAY_UPDATE_MODE: c_int = 1;
pub const SHARP_MEMORY_DISPLAY_CLEAR_MODE: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sharp_memory_device {
    pub drm: drm_device,
    ...
    pub sw_vcom_signal: *mut task_struct,
    pub pwm_vcom_signal: *mut pwm_device,
    pub vcom_mode: enum sharp_memory_vcom_mode,
    pub vcom: u8,
    pub pitch: u32,
...
#[no_mangle]
pub unsafe extern "C" fn sharp_memory_spi_write(spi: *mut spi_device, buf: *mut c_void, len: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sharp_memory_set_tx_buffer_mode(buffer: *mut u8, mode: u8, vcom: u8) {
...
// buffer = mode | (vcom << 1);
    ...
    {
    int ret;
    let mut pitch: u32 = smd.pitch;
    let mut vcom: u8 = smd.vcom;
    u8 *tx_buffer = smd.tx_buffer;
    let mut tx_buffer_size: u32 = smd.tx_buffer_size;
...
#[no_mangle]
unsafe extern "C" fn sharp_memory_maintain_display(smd: *mut sharp_memory_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_memory_clear_display(smd: *mut sharp_memory_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_memory_sw_vcom_signal_thread(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_memory_connector_get_modes(connector: *mut drm_connector) -> c_int {
    ...
    ret = drm_crtc_init_with_planes(dev, crtc, plane, core::ptr::null_mut(),
    &sharp_memory_crtc_funcs, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn sharp_memory_init_pwm_vcom_signal(smd: *mut sharp_memory_device) -> c_int {
    static int sharp_memory_init_pwm_vcom_signal(struct sharp_memory_device *smd)
    {
    int ret;
    struct device *dev = &smd.spi.dev;
    struct pwm_state pwm_state;
    smd.pwm_vcom_signal = devm_pwm_get(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sharp_memory_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_memory_remove(spi: *mut spi_device) {
