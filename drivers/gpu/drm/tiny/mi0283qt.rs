...
//! Source: drivers/gpu/drm/tiny/mi0283qt.c
#![no_std]
...
pub const ILI9341_FRMCTR1: c_uint = 0xb1;
pub const ILI9341_DISCTRL: c_uint = 0xb6;
pub const ILI9341_ETMOD: c_uint = 0xb7;
pub const ILI9341_PWCTRL1: c_uint = 0xc0;
pub const ILI9341_PWCTRL2: c_uint = 0xc1;
pub const ILI9341_VMCTRL1: c_uint = 0xc5;
pub const ILI9341_VMCTRL2: c_uint = 0xc7;
pub const ILI9341_PWCTRLA: c_uint = 0xcb;
pub const ILI9341_PWCTRLB: c_uint = 0xcf;
pub const ILI9341_PGAMCTRL: c_uint = 0xe0;
pub const ILI9341_NGAMCTRL: c_uint = 0xe1;
pub const ILI9341_DTCTRLA: c_uint = 0xe8;
pub const ILI9341_DTCTRLB: c_uint = 0xea;
pub const ILI9341_PWRSEQ: c_uint = 0xed;
pub const ILI9341_EN3GAM: c_uint = 0xf2;
pub const ILI9341_PUMPCTRL: c_uint = 0xf7;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mi0283qt_device {
...
#[no_mangle]
unsafe extern "C" fn mi0283qt_probe(spi: *mut spi_device) -> c_int {
    ...
    crtc = &mi0283qt.crtc;
    ret = drm_crtc_init_with_planes(drm, crtc, plane, core::ptr::null_mut(), &mi0283qt_crtc_funcs, core::ptr::null_mut());
    if (ret)
    return ret;
    drm_crtc_helper_add(crtc, &mi0283qt_crtc_helper_funcs);
    encoder = &mi0283qt.encoder;
    ret = drm_encoder_init(drm, encoder, &mi0283qt_encoder_funcs, DRM_MODE_ENCODER_NONE, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn mi0283qt_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn mi0283qt_shutdown(spi: *mut spi_device) {
    static void mi0283qt_shutdown(struct spi_device *spi)
    {
    drm_atomic_helper_shutdown(spi_get_drvdata(spi));
    }
#[no_mangle]
unsafe extern "C" fn mi0283qt_pm_suspend(dev: *mut device) -> int __maybe_unused {
    static int __maybe_unused mi0283qt_pm_suspend(struct device *dev)
    {
    return drm_mode_config_helper_suspend(dev_get_drvdata(dev));
    }
#[no_mangle]
unsafe extern "C" fn mi0283qt_pm_resume(dev: *mut device) -> int __maybe_unused {
