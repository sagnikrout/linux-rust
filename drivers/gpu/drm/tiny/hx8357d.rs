...
//! Source: drivers/gpu/drm/tiny/hx8357d.c
#![no_std]
...
pub const HX8357D_SETOSC: c_uint = 0xb0;
pub const HX8357D_SETPOWER: c_uint = 0xb1;
pub const HX8357D_SETRGB: c_uint = 0xb3;
pub const HX8357D_SETCYC: c_uint = 0xb3;
pub const HX8357D_SETCOM: c_uint = 0xb6;
pub const HX8357D_SETEXTC: c_uint = 0xb9;
pub const HX8357D_SETSTBA: c_uint = 0xc0;
pub const HX8357D_SETPANEL: c_uint = 0xcc;
pub const HX8357D_SETGAMMA: c_uint = 0xe0;
pub const HX8357D_MADCTL_MY: c_uint = 0x80;
pub const HX8357D_MADCTL_MX: c_uint = 0x40;
pub const HX8357D_MADCTL_MV: c_uint = 0x20;
pub const HX8357D_MADCTL_ML: c_uint = 0x10;
pub const HX8357D_MADCTL_RGB: c_uint = 0x00;
pub const HX8357D_MADCTL_BGR: c_uint = 0x08;
pub const HX8357D_MADCTL_MH: c_uint = 0x04;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hx8357d_device {
...
#[no_mangle]
unsafe extern "C" fn hx8357d_probe(spi: *mut spi_device) -> c_int {
    ...
    crtc = &hx8357d.crtc;
    ret = drm_crtc_init_with_planes(drm, crtc, plane, core::ptr::null_mut(), &hx8357d_crtc_funcs, core::ptr::null_mut());
    if (ret)
    return ret;
    drm_crtc_helper_add(crtc, &hx8357d_crtc_helper_funcs);
    encoder = &hx8357d.encoder;
    ret = drm_encoder_init(drm, encoder, &hx8357d_encoder_funcs, DRM_MODE_ENCODER_NONE, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn hx8357d_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn hx8357d_shutdown(spi: *mut spi_device) {
