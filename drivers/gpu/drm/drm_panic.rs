...
//! Source: drivers/gpu/drm/drm_panic.c
#![no_std]
...
pub struct drm_panic_line {
    ...
    let mut panic_msg_lines: static size_t = ARRAY_SIZE(panic_msg);
    ...
    let mut logo_ascii_lines: static size_t = ARRAY_SIZE(logo_ascii);

    static const struct linux_logo *logo_mono;
#[no_mangle]
unsafe extern "C" fn drm_panic_setup_logo() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_panic_write_pixel16(vaddr: *mut c_void, offset: c_uint, color: u16) {
...
#[no_mangle]
unsafe extern "C" fn drm_panic_write_pixel24(vaddr: *mut c_void, offset: c_uint, color: u32) {
...
#[no_mangle]
unsafe extern "C" fn drm_panic_write_pixel32(vaddr: *mut c_void, offset: c_uint, color: u32) {
...
#[no_mangle]
unsafe extern "C" fn drm_panic_write_pixel(vaddr: *mut c_void, offset: c_uint, color: u32, cpp: c_uint) {
...
//
    ...
    {
    unsigned int y, x;
    let mut page: c_uint = ~0;
    let mut height: c_uint = drm_rect_height(clip);
    let mut width: c_uint = drm_rect_width(clip);
...
#[no_mangle]
unsafe extern "C" fn get_max_line_len(lines: *const drm_panic_line, len: c_int) -> c_uint {
...
//
    ...
    let mut line_len: usize = min(msg[i].len, drm_rect_width(clip) / font.width);
...
#[no_mangle]
unsafe extern "C" fn drm_panic_logo_rect(rect: *mut drm_rect, font: *const font_desc) {
    ...
    let mut logo_width: c_int = get_max_line_len(logo_ascii, logo_ascii_lines) * font.width;
...
#[no_mangle]
unsafe extern "C" fn draw_panic_screen_user(sb: *mut drm_scanout_buffer) {
    ...
    sb.format.format);
    const struct font_desc *font = get_default_font(sb.width, sb.height, core::ptr::null_mut(), core::ptr::null_mut());
...
//
    ...
    {
    let mut chars_per_row: c_int = sb.width / font.width;
    let mut r_txt: drm_rect = DRM_RECT_INIT(0, yoffset, sb.width, font.height);
...
//
#[no_mangle]
unsafe extern "C" fn draw_panic_screen_kmsg(sb: *mut drm_scanout_buffer) {
    ...
    sb.format.format);
    const struct font_desc *font = get_default_font(sb.width, sb.height, core::ptr::null_mut(), core::ptr::null_mut());
    let mut r_screen: drm_rect = DRM_RECT_INIT(0, 0, sb.width, sb.height);
...
//
    let mut panic_qr_version: static uint = CONFIG_DRM_PANIC_SCREEN_QR_VERSION;
    module_param(panic_qr_version, uint, 0644);
    MODULE_PARM_DESC(panic_qr_version, "maximum version (size) of the QR code");
pub const MAX_QR_DATA: c_int = 2956;
pub const MAX_ZLIB_RATIO: c_int = 3;

pub const QR_BUFFER2_SIZE: c_int = 4096;
...
#[no_mangle]
unsafe extern "C" fn drm_panic_qr_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn drm_panic_qr_exit() {
    static void drm_panic_qr_exit(void)
    {
    kfree(qrbuf1);
    qrbuf1 = core::ptr::null_mut();
    kfree(qrbuf2);
    qrbuf2 = core::ptr::null_mut();
    kfree(stream.workspace);
    stream.workspace = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn drm_panic_get_qr_code_url(qr_image: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_panic_get_qr_code_raw(qr_image: *mut u8) -> c_int {
    ...
    return -ENODATA;
// qr_image = qrbuf1;
    return drm_panic_qr_generate(core::ptr::null_mut(), qrbuf1, kmsg_len, QR_BUFFER1_SIZE,
    qrbuf2, QR_BUFFER2_SIZE);
    }
#[no_mangle]
unsafe extern "C" fn drm_panic_get_qr_code(qr_image: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _draw_panic_screen_qr_code(sb: *mut drm_scanout_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn draw_panic_screen_qr_code(sb: *mut drm_scanout_buffer) {
    ...
    let mut drm_panic_type: static enum drm_panic_type = -1;
...
#[no_mangle]
unsafe extern "C" fn drm_panic_type_set(val: *const c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_panic_type_get(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
    ...
    module_param_cb(panic_screen, &drm_panic_ops, core::ptr::null_mut(), 0644);
...
//
#[no_mangle]
unsafe extern "C" fn drm_panic_is_format_supported(format: *const drm_format_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn draw_panic_dispatch(sb: *mut drm_scanout_buffer) {
...
#[no_mangle]
unsafe extern "C" fn drm_panic_set_description(description: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn drm_panic_clear_description() {
    static void drm_panic_clear_description(void)
    {
    struct drm_panic_line *desc_line = &panic_msg[panic_msg_lines - 1];
    desc_line.len = 0;
    desc_line.txt = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn draw_panic_plane(plane: *mut drm_plane, description: *const c_char) {
    static void draw_panic_plane(struct drm_plane *plane, const char *description)
    {
    let mut sb: drm_scanout_buffer = { };
    int ret;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn drm_panic(dumper: *mut kmsg_dumper, detail: *mut kmsg_dump_detail) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_register_plane(plane: *mut drm_plane, index: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_panic_is_enabled(dev: *mut drm_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_panic_register(dev: *mut drm_device) {
    void drm_panic_register(struct drm_device *dev)
    {
    struct drm_plane *plane;
    let mut registered_plane: c_int = 0;
    if (!dev.mode_config.num_total_plane)
    return;
    drm_for_each_plane(plane, dev) {
    if (!plane.helper_private || !plane.helper_private.get_scanout_buffer)
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_panic_unregister(dev: *mut drm_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_panic_init() -> void __init {
    void __init drm_panic_init(void)
    {
    if (drm_panic_type == -1 && drm_panic_type_set(CONFIG_DRM_PANIC_SCREEN, core::ptr::null_mut())) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_panic_exit() {
