...
//! Source: drivers/gpu/drm/verisilicon/vs_cursor_plane.c
#![no_std]
...
pub const VSDC_MIN_CURSOR_SIZE: c_int = 32;
pub const VSDC_MAX_CURSOR_SIZE: c_int = 256;

#[no_mangle]
unsafe extern "C" fn vs_cursor_plane_check_coord(coord: i32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vs_cursor_plane_commit(dc: *mut vs_dc, output: c_uint) {
    ...
    let mut output: c_uint = vcrtc.id;
...
//
    ...
    struct vs_dc *dc)
    {
    let mut max_cursor_size: i32 = dc.identity.max_cursor_size;
