...
//! Source: drivers/gpu/drm/drm_gem_framebuffer_helper.c
#![no_std]
...
pub const AFBC_HDR_ALIGN: c_int = 64;
pub const AFBC_SUPERBLOCK_PIXELS: c_int = 256;
pub const AFBC_SUPERBLOCK_ALIGNMENT: c_int = 128;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: drm_WARN_ON_ONCE(dev, _arg: !fb->obj[plane])) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_fb_destroy(fb: *mut drm_framebuffer) {
...
//
    ...
    let mut width: c_uint = drm_format_info_plane_width(info, mode_cmd.width, i);
    let mut height: c_uint = drm_format_info_plane_height(info, mode_cmd.height, i);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_fb_vunmap(fb: *mut drm_framebuffer, map: *mut iosys_map) {
    void drm_gem_fb_vunmap(struct drm_framebuffer *fb, struct iosys_map *map)
    {
    let mut i: c_uint = fb.format.num_planes;
    struct drm_gem_object *obj;
    while (i) {
    --i;
    obj = drm_gem_fb_get_obj(fb, i);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_fb_begin_cpu_access(fb: *mut drm_framebuffer, dir: enum dma_data_direction) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_fb_end_cpu_access(fb: *mut drm_framebuffer, dir: enum dma_data_direction) {
