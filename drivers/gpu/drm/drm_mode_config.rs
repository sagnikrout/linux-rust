...
//! Source: drivers/gpu/drm/drm_mode_config.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn drm_modeset_register_all(dev: *mut drm_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drm_modeset_unregister_all(dev: *mut drm_device) {
...
#[no_mangle]
unsafe extern "C" fn drm_mode_config_plane_create_state(plane: *mut drm_plane) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_mode_config_plane_reset_with_create_state(plane: *mut drm_plane) -> c_int {
    static int drm_mode_config_plane_reset_with_create_state(struct drm_plane *plane)
    {
    if (plane.state) {
    plane.funcs.atomic_destroy_state(plane, plane.state);
    plane.state = core::ptr::null_mut();
    }
    return drm_mode_config_plane_create_state(plane);
    }
#[no_mangle]
unsafe extern "C" fn drm_mode_config_crtc_create_state(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_mode_config_crtc_reset_with_create_state(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_mode_config_connector_create_state(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_mode_config_connector_reset_with_create_state(connector: *mut drm_connector) -> c_int {
    ...
    connector.state = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_config_reset(dev: *mut drm_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: plane->funcs->atomic_create_state) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: crtc->funcs->atomic_create_state) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: connector->funcs->atomic_create_state) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_config_create_initial_state(dev: *mut drm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_mode_create_standard_properties(dev: *mut drm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_mode_config_init_release(dev: *mut drm_device, ptr: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drmm_mode_config_init(dev: *mut drm_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_config_cleanup(dev: *mut drm_device) {
...
//
    ...
    let mut p: drm_printer = drm_dbg_printer(dev, DRM_UT_KMS, "[leaked fb]");
...
#[no_mangle]
unsafe extern "C" fn full_encoder_mask(dev: *mut drm_device) -> u32 {
    static u32 full_encoder_mask(struct drm_device *dev)
    {
    struct drm_encoder *encoder;
    let mut encoder_mask: u32 = 0;
    drm_for_each_encoder(encoder, dev)
...
//
#[no_mangle]
unsafe extern "C" fn fixup_encoder_possible_clones(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn validate_encoder_possible_clones(encoder: *mut drm_encoder) {
    static void validate_encoder_possible_clones(struct drm_encoder *encoder)
    {
    struct drm_device *dev = encoder.dev;
    let mut encoder_mask: u32 = full_encoder_mask(dev);
...
#[no_mangle]
unsafe extern "C" fn full_crtc_mask(dev: *mut drm_device) -> u32 {
    static u32 full_crtc_mask(struct drm_device *dev)
    {
    struct drm_crtc *crtc;
    let mut crtc_mask: u32 = 0;
    drm_for_each_crtc(crtc, dev)
    crtc_mask |= drm_crtc_mask(crtc);
    return crtc_mask;
    }
#[no_mangle]
unsafe extern "C" fn validate_encoder_possible_crtcs(encoder: *mut drm_encoder) {
    static void validate_encoder_possible_crtcs(struct drm_encoder *encoder)
    {
    let mut crtc_mask: u32 = full_crtc_mask(encoder.dev);
...
#[no_mangle]
unsafe extern "C" fn validate_blend_mode_for_alpha_formats(plane: *mut drm_plane) {
...
#[no_mangle]
pub unsafe extern "C" fn drm_mode_config_validate(dev: *mut drm_device) {
    void drm_mode_config_validate(struct drm_device *dev)
    {
    struct drm_encoder *encoder;
    struct drm_crtc *crtc;
    struct drm_plane *plane;
    let mut primary_with_crtc: u32 = 0, cursor_with_crtc = 0;
    let mut num_primary: c_uint = 0;
    if (!drm_core_check_feature(dev, DRIVER_MODESET))
    return;
    drm_for_each_encoder(encoder, dev)
