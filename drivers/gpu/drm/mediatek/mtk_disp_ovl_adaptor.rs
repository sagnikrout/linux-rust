...
//! Source: drivers/gpu/drm/mediatek/mtk_disp_ovl_adaptor.c
#![no_std]
...
pub const MTK_OVL_ADAPTOR_RDMA_MAX_WIDTH: c_int = 1920;
pub const MTK_OVL_ADAPTOR_LAYER_NUM: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ovl_adaptor_comp_match {
    pub type: enum mtk_ovl_adaptor_comp_type,
    pub comp_id: enum mtk_ddp_comp_id,
    pub alias_id: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_disp_ovl_adaptor {
    pub ovl_adaptor_comp: [*mut device; OVL_ADAPTOR_ID_MAX],
    pub mmsys_dev: *mut device,
    pub children_bound: bool,
}
    ...
    let mut rdma_config: mtk_mdp_rdma_cfg = {0};
    struct device *rdma_l;
    struct device *rdma_r;
    struct device *merge;
    struct device *ethdr;
    const struct drm_format_info *fmt_info = drm_format_info(pending.format);
    let mut use_dual_pipe: bool = false;
    unsigned int align_width;
    let mut l_w: c_uint = 0;
    let mut r_w: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_start(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_stop(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn power_off(dev: *mut device, num: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_power_off(dev: *mut device) {
    void mtk_ovl_adaptor_power_off(struct device *dev)
    {
    power_off(dev, OVL_ADAPTOR_ID_MAX);
    }
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_clk_enable(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_clk_disable(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_layer_nr(dev: *mut device) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_unregister_vblank_cb(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_enable_vblank(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_disable_vblank(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_get_blend_modes(dev: *mut device) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_get_num_formats(dev: *mut device) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_add_comp(dev: *mut device, mutex: *mut mtk_mutex) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_remove_comp(dev: *mut device, mutex: *mut mtk_mutex) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_connect(dev: *mut device, mmsys_dev: *mut device, next: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_disconnect(dev: *mut device, mmsys_dev: *mut device, next: c_uint) {
    ...
    {
    let mut alias_id: c_int = of_alias_get_id(node, private_comp_stem[type]);
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ovl_adaptor_is_comp_present(node: *mut device_node) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ovl_adaptor_put_device(_dev: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ovl_adaptor_comp_init(dev: *mut device, match: *mut component_match) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_disp_ovl_adaptor_master_bind(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_disp_ovl_adaptor_master_unbind(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn mtk_disp_ovl_adaptor_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_disp_ovl_adaptor_remove(pdev: *mut platform_device) {
