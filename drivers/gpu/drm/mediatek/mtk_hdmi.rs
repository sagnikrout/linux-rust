...
//! Source: drivers/gpu/drm/mediatek/mtk_hdmi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_vid_black(hdmi: *mut mtk_hdmi, black: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_make_reg_writable(hdmi: *mut mtk_hdmi, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_1p4_version_enable(hdmi: *mut mtk_hdmi, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_aud_mute(hdmi: *mut mtk_hdmi) {
    static void mtk_hdmi_hw_aud_mute(struct mtk_hdmi *hdmi)
    {
    regmap_set_bits(hdmi.regs, GRL_AUDIO_CFG, AUDIO_ZERO);
    }
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_aud_unmute(hdmi: *mut mtk_hdmi) {
    static void mtk_hdmi_hw_aud_unmute(struct mtk_hdmi *hdmi)
    {
    regmap_clear_bits(hdmi.regs, GRL_AUDIO_CFG, AUDIO_ZERO);
    }
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_reset(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_enable_notice(hdmi: *mut mtk_hdmi, enable_notice: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_write_int_mask(hdmi: *mut mtk_hdmi, int_mask: u32) {
    static void mtk_hdmi_hw_write_int_mask(struct mtk_hdmi *hdmi, u32 int_mask)
    {
    regmap_write(hdmi.regs, GRL_INT_MASK, int_mask);
    }
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_enable_dvi_mode(hdmi: *mut mtk_hdmi, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_send_aud_packet(hdmi: *mut mtk_hdmi, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_config_sys(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_set_deep_color_mode(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_send_av_mute(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_send_av_unmute(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_ncts_enable(hdmi: *mut mtk_hdmi, on: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_audio_config(hdmi: *mut mtk_hdmi, dst: bool) {
    static void mtk_hdmi_hw_audio_config(struct mtk_hdmi *hdmi, bool dst)
    {
    let mut mask: u8 = HIGH_BIT_RATE | DST_NORMAL_DOUBLE | SACD_DST | DSD_SEL;
    u8 val;
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_aud_src_reenable(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hw_aud_src_disable(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_aud_get_chnl_count(channel_type: enum hdmi_aud_channel_type) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_video_change_vpll(hdmi: *mut mtk_hdmi, clock: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_aud_set_input(hdmi: *mut mtk_hdmi) {
    ...
    {
    let mut sample_rate: c_uint = hdmi.aud_param.codec_params.sample_rate;
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_setup_spd_infoframe(hdmi: *mut mtk_hdmi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_setup_audio_infoframe(hdmi: *mut mtk_hdmi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_audio_enable(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_audio_disable(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_clk_enable_audio(hdmi: *mut mtk_hdmi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_clk_disable_audio(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_detect(hdmi: *mut mtk_hdmi) -> enum drm_connector_status {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hpd_event(hpd: bool, dev: *mut device) {
...
//
    ...
    hdmi.curr_conn = core::ptr::null_mut();
    hdmi.enabled = false;
    }
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_audio_startup(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_audio_shutdown(dev: *mut device, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_suspend(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_resume(dev: *mut device) -> __maybe_unused int {
