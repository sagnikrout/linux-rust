...
//! Source: drivers/gpu/drm/mediatek/mtk_hdmi_v2.c
#![no_std]
...
pub const MTK_HDMI_V2_CLOCK_MIN: c_int = 27000;
pub const MTK_HDMI_V2_CLOCK_MAX: c_int = 594000;
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_v2_hwirq_disable(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_v2_enable_hpd_pord_irq(hdmi: *mut mtk_hdmi, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_v2_set_sw_hpd(hdmi: *mut mtk_hdmi, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_v2_enable_scrambling(hdmi: *mut mtk_hdmi, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_hw_vid_mute(hdmi: *mut mtk_hdmi, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_hw_aud_mute(hdmi: *mut mtk_hdmi, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_hw_reset(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_v2_format_hw_packet(buffer: *const u8, len: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_yuv420_downsampling(hdmi: *mut mtk_hdmi, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_setup_audio_infoframe(hdmi: *mut mtk_hdmi) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_v2_hw_gcp_avmute(hdmi: *mut mtk_hdmi, mute: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_hw_ncts_enable(hdmi: *mut mtk_hdmi, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_hw_aud_set_channel_status(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_hw_aud_enable(hdmi: *mut mtk_hdmi, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_v2_hw_i2s_fifo_map(hdmi: *mut mtk_hdmi, fifo_mapping: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_v2_hw_i2s_ch_number(hdmi: *mut mtk_hdmi, chnum: u8) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_hw_i2s_ch_mapping(hdmi: *mut mtk_hdmi, chnum: u8, mapping: u8) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_i2s_data_fmt(hdmi: *mut mtk_hdmi, fmt: c_uchar) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_i2s_sck_edge_rise(hdmi: *mut mtk_hdmi, rise: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_i2s_cbit_order(hdmi: *mut mtk_hdmi, cbit: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_i2s_vbit(hdmi: *mut mtk_hdmi, vbit: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_i2s_data_direction(hdmi: *mut mtk_hdmi, is_lsb: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_v2_hw_audio_type(hdmi: *mut mtk_hdmi, spdif_i2s: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_get_i2s_ch_mapping(hdmi: *mut mtk_hdmi, channel_type: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_v2_hw_i2s_ch_swap(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_hbr_config(hdmi: *mut mtk_hdmi, dsd_bypass: bool) {
    static void mtk_hdmi_hbr_config(struct mtk_hdmi *hdmi, bool dsd_bypass)
    {
    let mut hbr_mask: u32 = SPDIF_EN | DSD_EN | HBRA_ON;
    if (dsd_bypass) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_v2_hw_spdif_config(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_aud_set_input(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_hdmi_v2_hw_audio_input_enable(hdmi: *mut mtk_hdmi, ena: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_aip_ctrl_init(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_audio_reset(hdmi: *mut mtk_hdmi, reset: bool) {
    static void mtk_hdmi_v2_audio_reset(struct mtk_hdmi *hdmi, bool reset)
    {
    let mut arst_bits: u32 = RST4AUDIO | RST4AUDIO_FIFO | RST4AUDIO_ACR;
    if (reset)
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_clk_enable(hdmi: *mut mtk_hdmi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_clk_disable(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_hpd_pord_status(hdmi: *mut mtk_hdmi) -> enum hdmi_hpd_state {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: hpd_pin_sta) -> else {
    else if (hpd_pin_sta)
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_isr(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn __mtk_hdmi_v2_isr_thread(hdmi: *mut mtk_hdmi) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_isr_thread(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_enable(hdmi: *mut mtk_hdmi) -> c_int {
    static int mtk_hdmi_v2_enable(struct mtk_hdmi *hdmi)
    {
    let mut was_active: bool = pm_runtime_active(hdmi.dev);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_disable(hdmi: *mut mtk_hdmi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_bridge_detach(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_handle_plugged_change(hdmi: *mut mtk_hdmi, plugged: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_hpd_enable(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_hpd_disable(bridge: *mut drm_bridge) {
...
#[no_mangle]
pub unsafe extern "C" fn if(MTK_HDMI_V2_CLOCK_MAX: mode->clock >) -> else {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_hdmi_clear_audio_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_hdmi_clear_avi_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_hdmi_clear_spd_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_hdmi_clear_hdmi_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_set_abist(hdmi: *mut mtk_hdmi, enable: bool) -> c_int {
    static int mtk_hdmi_v2_set_abist(struct mtk_hdmi *hdmi, bool enable)
    {
    struct drm_display_mode *mode = &hdmi.mode;
    let mut abist_format: c_int = -EINVAL;
    bool interlaced;
    if (!enable) {
    ...
    abist_format = 2;
#[no_mangle]
pub unsafe extern "C" fn if(576: mode->vdisplay ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_debug_abist_show(m: *mut seq_file, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_debug_abist_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_debugfs_init(bridge: *mut drm_bridge, root: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_audio_startup(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_audio_shutdown(dev: *mut device, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_audio_mute(dev: *mut device, data: *mut c_void, enable: bool, dir: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_suspend(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_resume(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_v2_probe(pdev: *mut platform_device) -> c_int {
