...
//! Source: drivers/gpu/drm/mediatek/mtk_hdmi_ddc_v2.c
#![no_std]
...
pub const SI2C_ADDR_READ: c_uint = 0xf4;
pub const SCDC_I2C_SLAVE_ADDRESS: c_uint = 0x54;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
unsafe extern "C" fn mtk_ddc_check_and_rise_low_bus(ddc: *mut mtk_hdmi_ddc) -> c_int {
...
// Fill transfer fifo with payload data
    ...
    FIELD_PREP(DDC_CTRL_DIN_CNT, wr_data == core::ptr::null_mut() ? 0 : data_cnt) |
...
// Abort transfer if it is still in progress
    ...
    let mut read_idx: c_uint = i * 16 + uc_idx;
    regmap_write(ddc.regs, SI2C_CTRL,
    FIELD_PREP(SI2C_ADDR, SI2C_ADDR_READ) |
    SI2C_RD);
...
#[no_mangle]
pub unsafe extern "C" fn if(req_data_cnt: read_data_cnt !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_ddc_v2_xfer(adapter: *mut i2c_adapter, msgs: *mut i2c_msg, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_ddc_v2_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mtk_hdmi_ddc_v2_probe(pdev: *mut platform_device) -> c_int {
    ...
    "Cannot get regmap\n");
    ddc.clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
    if (IS_ERR(ddc.clk))
