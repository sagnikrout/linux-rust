...
//! Source: drivers/gpu/drm/mediatek/mtk_dp.c
#![no_std]
...
pub const MTK_DP_4P1T: c_int = 4;
pub const MTK_DP_HDE: c_int = 2;
pub const MTK_DP_PIX_PER_ADDR: c_int = 2;
pub const MTK_DP_AUX_WAIT_REPLY_COUNT: c_int = 20;
pub const MTK_DP_TBC_BUF_READ_START_ADDR: c_uint = 0x8;
pub const MTK_DP_TRAIN_VOLTAGE_LEVEL_RETRY: c_int = 5;
pub const MTK_DP_TRAIN_DOWNSCALE_RETRY: c_int = 10;
pub const MTK_DP_VERSION: c_uint = 0x11;
pub const MTK_DP_SDP_AUI: c_uint = 0x4;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_dp_train_info {
    pub sink_ssc: bool,
    pub cable_plugged_in: bool,
// link_rate is in multiple of 0.27Gbps
    pub link_rate: c_int,
    pub lane_count: c_int,
    pub channel_eq_pattern: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_dp_audio_cfg {
    pub detect_monitor: bool,
    pub sad_count: c_int,
    pub sample_rate: c_int,
    pub word_length_bits: c_int,
    pub channels: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_dp_info {
    pub format: enum dp_pixelformat,
    pub vm: videomode,
    pub audio_cur_cfg: mtk_dp_audio_cfg,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_dp_efuse_fmt {
    pub idx: c_ushort,
    pub shift: c_ushort,
    pub mask: c_ushort,
    pub min_val: c_ushort,
    pub max_val: c_ushort,
    pub default_val: c_ushort,
}
...
pub struct mtk_dp {
    pub enabled: bool,
    pub need_debounce: bool,
    pub irq: c_int,
    pub max_lanes: u8,
    pub max_linkrate: u8,
    pub rx_cap: [u8; DP_RECEIVER_CAP_SIZE],
    pub cal_data: [u32; MTK_DP_CAL_MAX],
    pub irq_thread_handle: u32,
// irq_thread_lock is used to protect irq_thread_handle
    pub irq_thread_lock: spinlock_t,
    pub dev: *mut device,
    ...
    pub aux: drm_dp_aux,
    pub data: *const mtk_dp_data,
    pub info: mtk_dp_info,
    pub train_info: mtk_dp_train_info,
    pub phy_dev: *mut platform_device,
    pub phy: *mut phy,
    pub regs: *mut regmap,
    pub debounce_timer: timer_list,
// For audio
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_dp_data {
    pub bridge_type: c_int,
    pub smc_cmd: c_uint,
    pub efuse_fmt: *const mtk_dp_efuse_fmt,
    pub audio_supported: bool,
    pub audio_pkt_in_hblank_area: bool,
    pub audio_m_div2_bit: u16,
}
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_read(mtk_dp: *mut mtk_dp, offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_write(mtk_dp: *mut mtk_dp, offset: u32, val: u32) -> c_int {
    static int mtk_dp_write(struct mtk_dp *mtk_dp, u32 offset, u32 val)
    {
    let mut ret: c_int = regmap_write(mtk_dp.regs, offset, val);
    if (ret)
    dev_err(mtk_dp.dev,
    ...
    u32 val, u32 mask)
    {
    let mut ret: c_int = regmap_update_bits(mtk_dp.regs, offset, mask, val);
    if (ret)
    dev_err(mtk_dp.dev,
...
// 2 bytes per register
    ...
    let mut val: u32 = buf[i] | (i + 1 < length ? buf[i + 1] << 8 : 0);
    if (mtk_dp_write(mtk_dp, offset + i * 2, val))
    return;
    }
    }
#[no_mangle]
unsafe extern "C" fn mtk_dp_msa_bypass_enable(mtk_dp: *mut mtk_dp, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_set_msa(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_set_color_depth(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_config_mn_mode(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_set_sram_read_start(mtk_dp: *mut mtk_dp, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_setup_encoder(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_pg_enable(mtk_dp: *mut mtk_dp, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_audio_set_divider(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_sdp_trigger_aui(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_sdp_set_data(mtk_dp: *mut mtk_dp, data_bytes: *mut u8) {
    ...
    {
    let mut db_addr: u32 = MTK_DP_ENC0_P0_30D8 + (MTK_DP_SDP_AUI - 1) * 8;
    mtk_dp_bulk_16bit_write(mtk_dp, db_addr, (u8 *)header, 4);
    }
#[no_mangle]
unsafe extern "C" fn mtk_dp_disable_sdp_aui(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_aux_irq_clear(mtk_dp: *mut mtk_dp) {
    static void mtk_dp_aux_irq_clear(struct mtk_dp *mtk_dp)
    {
    mtk_dp_write(mtk_dp, MTK_DP_AUX_P0_3640, DP_AUX_P0_3640_VAL);
    }
#[no_mangle]
unsafe extern "C" fn mtk_dp_aux_set_cmd(mtk_dp: *mut mtk_dp, cmd: u8, addr: u32) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_aux_clear_fifo(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_aux_request_ready(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_aux_set_length(mtk_dp: *mut mtk_dp, length: usize) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_aux_wait_for_completion(mtk_dp: *mut mtk_dp, is_read: bool) -> c_int {
    static int mtk_dp_aux_wait_for_completion(struct mtk_dp *mtk_dp, bool is_read)
    {
    let mut wait_reply: c_int = MTK_DP_AUX_WAIT_REPLY_COUNT;
    while (--wait_reply) {
    u32 aux_irq_status;
    if (is_read) {
    let mut fifo_status: u32 = mtk_dp_read(mtk_dp, MTK_DP_AUX_P0_3618);
    if (fifo_status &
...
// reply_cmd = mtk_dp_read(mtk_dp, MTK_DP_AUX_P0_3624) &
    ...
    {
    let mut lane_shift: u32 = lane_num * DP_TX1_VOLT_SWING_SHIFT;
    dev_dbg(mtk_dp.dev,
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_reset_swing_pre_emphasis(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_swirq_get_clear(mtk_dp: *mut mtk_dp) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_hwirq_get_clear(mtk_dp: *mut mtk_dp) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_hwirq_enable(mtk_dp: *mut mtk_dp, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_initialize_settings(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_initialize_hpd_detect_settings(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_initialize_aux_settings(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_initialize_digital_settings(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_digital_sw_reset(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_sdp_path_reset(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_set_lanes(mtk_dp: *mut mtk_dp, lanes: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_get_calibration_data(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_set_calibration_data(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_set_idle_pattern(mtk_dp: *mut mtk_dp, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_train_set_pattern(mtk_dp: *mut mtk_dp, pattern: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_set_enhanced_frame_mode(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_training_set_scramble(mtk_dp: *mut mtk_dp, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_video_mute(mtk_dp: *mut mtk_dp, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_audio_mute(mtk_dp: *mut mtk_dp, mute: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_aux_panel_poweron(mtk_dp: *mut mtk_dp, pwron: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_power_enable(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_power_disable(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_initialize_priv_data(mtk_dp: *mut mtk_dp) {
    static void mtk_dp_initialize_priv_data(struct mtk_dp *mtk_dp)
    {
    let mut plugged_in: bool = (mtk_dp.bridge.type == DRM_MODE_CONNECTOR_eDP);
    ...
    u32 sram_read_start)
    {
    let mut sdp_down_cnt_init: u32 = 0;
    struct drm_display_mode mode;
    struct videomode *vm = &mtk_dp.info.vm;
    drm_display_mode_from_videomode(vm, &mode);
    if (mode.clock > 0)
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_sdp_set_down_cnt_init_in_hblank(mtk_dp: *mut mtk_dp) {
    static void mtk_dp_sdp_set_down_cnt_init_in_hblank(struct mtk_dp *mtk_dp)
    {
    int pix_clk_mhz;
    u32 dc_offset;
    let mut spd_down_cnt_init: u32 = 0;
    struct drm_display_mode mode;
    struct videomode *vm = &mtk_dp.info.vm;
    drm_display_mode_from_videomode(vm, &mode);
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_audio_sample_arrange_disable(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_setup_tu(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_set_tx_out(mtk_dp: *mut mtk_dp) {
    ...
    u8 swing;
    u8 preemphasis;
    let mut index: c_int = lane / 2;
    let mut shift: c_int = lane % 2 ? DP_ADJUST_VOLTAGE_SWING_LANE1_SHIFT : 0;
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_pattern(mtk_dp: *mut mtk_dp, is_tps1: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_train_cr(mtk_dp: *mut mtk_dp, target_lane_count: u8) -> c_int {
    static int mtk_dp_train_cr(struct mtk_dp *mtk_dp, u8 target_lane_count)
    {
    u8 lane_adjust[2] = {};
    u8 link_status[DP_LINK_STATUS_SIZE] = {};
    let mut prev_lane_adjust: u8 = 0xff;
    let mut train_retries: c_int = 0;
    let mut voltage_retries: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_train_eq(mtk_dp: *mut mtk_dp, target_lane_count: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_parse_capabilities(mtk_dp: *mut mtk_dp) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: drm_dp_tps3_supported(mtk_dp->rx_cap)) -> else {
...
// Clear DP_DEVICE_SERVICE_IRQ_VECTOR_ESI0
    ...
    drm_info(mtk_dp.drm_dev, "The SADs is core::ptr::null_mut()\n");
    return false;
    }
    return true;
    }
#[no_mangle]
unsafe extern "C" fn mtk_dp_train_change_mode(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_training(mtk_dp: *mut mtk_dp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_video_enable(mtk_dp: *mut mtk_dp, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_video_config(mtk_dp: *mut mtk_dp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_init_port(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_hpd_event_thread(hpd: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_hpd_event(hpd: c_int, dev: *mut c_void) -> irqreturn_t {
    static irqreturn_t mtk_dp_hpd_event(int hpd, void *dev)
    {
    struct mtk_dp *mtk_dp = dev;
    let mut cable_sta_chg: bool = false;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_wait_hpd_asserted(mtk_aux: *mut drm_dp_aux, wait_us: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_update_plugged_status(mtk_dp: *mut mtk_dp) {
    ...
    let mut enabled: bool = mtk_dp.enabled;
    if (!mtk_dp.train_info.cable_plugged_in)
    return ret;
    if (!enabled)
    mtk_dp_aux_panel_poweron(mtk_dp, true);
...
//
    ...
    bool is_read;
    u8 request;
    let mut accessed_bytes: usize = 0;
    int ret;
    if (mtk_dp.bridge.type != DRM_MODE_CONNECTOR_eDP &&
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_poweron(mtk_dp: *mut mtk_dp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_poweroff(mtk_dp: *mut mtk_dp) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_bridge_detach(bridge: *mut drm_bridge) {
    ...
    mtk_dp.drm_dev = core::ptr::null_mut();
    mtk_dp_poweroff(mtk_dp);
    drm_dp_aux_unregister(&mtk_dp.aux);
    }
...
// Ensure the sink is muted
    ...
    {
    struct mtk_dp *mtk_dp = mtk_dp_from_bridge(bridge);
    let mut bpp: u32 = info.color_formats & BIT(DRM_OUTPUT_COLOR_FORMAT_YCBCR422) ? 16 : 24;
    let mut lane_count_min: u32 = mtk_dp.train_info.lane_count;
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_debounce_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_audio_startup(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_audio_shutdown(dev: *mut device, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_register_audio_driver(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_register_phy(mtk_dp: *mut mtk_dp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_edp_link_panel(mtk_aux: *mut drm_dp_aux) -> c_int {
...
// Power off the DP and AUX: either detection is done, or no panel present
    ...
    mtk_dp.next_bridge = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dp_resume(dev: *mut device) -> c_int {
