...
//! Source: drivers/gpu/drm/mediatek/mtk_dpi.c
#![no_std]
...
pub struct mtk_dpi {
    ...
    pub conf: *const mtk_dpi_conf,
    pub color_format: enum mtk_dpi_out_color_format,
    pub yc_map: enum mtk_dpi_out_yc_map,
    pub bit_num: enum mtk_dpi_out_bit_num,
    pub channel_swap: enum mtk_dpi_out_channel_swap,
    pub pinctrl: *mut pinctrl,
    pub pins_gpio: *mut pinctrl_state,
    pub pins_dpi: *mut pinctrl_state,
    pub output_fmt: u32,
    pub refcount: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_dpi_polarities {
    pub de_pol: enum mtk_dpi_polarity,
    pub ck_pol: enum mtk_dpi_polarity,
    pub hsync_pol: enum mtk_dpi_polarity,
    pub vsync_pol: enum mtk_dpi_polarity,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_dpi_sync_param {
    pub sync_width: u32,
    pub front_porch: u32,
    pub back_porch: u32,
    pub shift_half_line: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_dpi_yc_limit {
    pub y_top: u16,
    pub y_bottom: u16,
    pub c_top: u16,
    pub c_bottom: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_dpi_conf {
    pub dpi_factor: *const mtk_dpi_factor,
    pub num_dpi_factor: u8,
    pub reg_h_fre_con: u32,
    pub max_clock_khz: u32,
    pub edge_sel_en: bool,
    pub output_fmts: *const u32,
    pub num_output_fmts: u32,
    pub is_ck_de_pol: bool,
    pub swap_input_support: bool,
    pub support_direct_pin: bool,
    pub dimension_mask: u32,
    pub hvsize_mask: u32,
    pub channel_swap_shift: u32,
    pub yuv422_en_bit: u32,
    pub csc_enable_bit: u32,
    pub input_2p_en_bit: u32,
    pub pixels_per_iter: u32,
    pub edge_cfg_in_mmsys: bool,
    pub clocked_by_hdmi: bool,
    pub output_1pixel: bool,
}

#[no_mangle]
unsafe extern "C" fn mtk_dpi_mask(dpi: *mut mtk_dpi, offset: u32, val: u32, mask: u32) {
    static void mtk_dpi_mask(struct mtk_dpi *dpi, u32 offset, u32 val, u32 mask)
    {
    let mut tmp: u32 = readl(dpi.regs + offset) & ~mask;
    tmp |= (val & mask);
    writel(tmp, dpi.regs + offset);
    }
#[no_mangle]
unsafe extern "C" fn mtk_dpi_test_pattern_en(dpi: *mut mtk_dpi, type: u8, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_sw_reset(dpi: *mut mtk_dpi, reset: bool) {
    static void mtk_dpi_sw_reset(struct mtk_dpi *dpi, bool reset)
    {
    mtk_dpi_mask(dpi, DPI_RET, reset ? RST : 0, RST);
    }
#[no_mangle]
unsafe extern "C" fn mtk_dpi_enable(dpi: *mut mtk_dpi) {
    static void mtk_dpi_enable(struct mtk_dpi *dpi)
    {
    mtk_dpi_mask(dpi, DPI_EN, EN, EN);
    }
#[no_mangle]
unsafe extern "C" fn mtk_dpi_disable(dpi: *mut mtk_dpi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_config_3d(dpi: *mut mtk_dpi, en_3d: bool) {
    static void mtk_dpi_config_3d(struct mtk_dpi *dpi, bool en_3d)
    {
    mtk_dpi_mask(dpi, DPI_CON, en_3d ? TDFP_EN : 0, TDFP_EN);
    }
#[no_mangle]
unsafe extern "C" fn mtk_dpi_config_interface(dpi: *mut mtk_dpi, inter: bool) {
    static void mtk_dpi_config_interface(struct mtk_dpi *dpi, bool inter)
    {
    mtk_dpi_mask(dpi, DPI_CON, inter ? INTL_EN : 0, INTL_EN);
    }
#[no_mangle]
unsafe extern "C" fn mtk_dpi_config_fb_size(dpi: *mut mtk_dpi, width: u32, height: u32) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_config_channel_limit(dpi: *mut mtk_dpi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_config_yuv422_enable(dpi: *mut mtk_dpi, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_config_csc_enable(dpi: *mut mtk_dpi, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_config_swap_input(dpi: *mut mtk_dpi, enable: bool) {
    static void mtk_dpi_config_swap_input(struct mtk_dpi *dpi, bool enable)
    {
    mtk_dpi_mask(dpi, DPI_CON, enable ? IN_RB_SWAP : 0, IN_RB_SWAP);
    }
#[no_mangle]
unsafe extern "C" fn mtk_dpi_config_2n_h_fre(dpi: *mut mtk_dpi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_config_disable_edge(dpi: *mut mtk_dpi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_dual_edge(dpi: *mut mtk_dpi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_power_off(dpi: *mut mtk_dpi) {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_power_on(dpi: *mut mtk_dpi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_calculate_factor(dpi: *mut mtk_dpi, mode_clk: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_set_pixel_clk(dpi: *mut mtk_dpi, vm: *mut videomode, mode_clk: c_int) {
...
//
    ...
    let mut vsync_lodd: mtk_dpi_sync_param = { 0 };
    let mut vsync_leven: mtk_dpi_sync_param = { 0 };
    let mut vsync_rodd: mtk_dpi_sync_param = { 0 };
    let mut vsync_reven: mtk_dpi_sync_param = { 0 };
    let mut vm: videomode = { 0 };
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_bus_fmt_bit_num(out_bus_format: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_bus_fmt_channel_swap(out_bus_format: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_bus_fmt_color_format(out_bus_format: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_debug_tp_show(m: *mut seq_file, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_debug_tp_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_debugfs_init(bridge: *mut drm_bridge, root: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_dpi_start(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_dpi_stop(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_dpi_encoder_index(dev: *mut device) -> c_uint {
    unsigned int mtk_dpi_encoder_index(struct device *dev)
    {
    struct mtk_dpi *dpi = dev_get_drvdata(dev);
    let mut encoder_index: c_uint = drm_encoder_index(&dpi.encoder);
    dev_dbg(dev, "encoder index:%d\n", encoder_index);
    return encoder_index;
    }
#[no_mangle]
unsafe extern "C" fn mtk_dpi_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
    ...
    ret = drm_bridge_attach(&dpi.encoder, &dpi.bridge, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_probe(pdev: *mut platform_device) -> c_int {
    ...
    dpi.pinctrl = core::ptr::null_mut();
    dev_dbg(&pdev.dev, "Cannot find pinctrl!\n");
    }
    if (dpi.pinctrl) {
    dpi.pins_gpio = pinctrl_lookup_state(dpi.pinctrl, "sleep");
    if (IS_ERR(dpi.pins_gpio)) {
    dpi.pins_gpio = core::ptr::null_mut();
    ...
    dpi.pins_dpi = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mtk_dpi_remove(pdev: *mut platform_device) {
