...
//! Source: drivers/gpu/drm/bridge/display-connector.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn display_connector_destroy(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn display_connector_detect(bridge: *mut drm_bridge) -> enum drm_connector_status {
...
#[no_mangle]
unsafe extern "C" fn display_connector_hpd_enable(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn display_connector_hpd_disable(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn display_connector_hpd_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn display_connector_hpd_irq(irq: c_int, arg: *mut c_void) -> irqreturn_t {
    ...
    conn.supply = core::ptr::null_mut();
    return PTR_ERR_OR_ZERO(conn.supply);
    }
#[no_mangle]
unsafe extern "C" fn display_connector_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    core::ptr::null_mut(), display_connector_hpd_irq,
    IRQF_TRIGGER_RISING |
...
#[no_mangle]
unsafe extern "C" fn display_connector_remove(pdev: *mut platform_device) {
