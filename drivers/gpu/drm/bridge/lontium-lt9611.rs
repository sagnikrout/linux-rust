...
//! Source: drivers/gpu/drm/bridge/lontium-lt9611.c
#![no_std]
...
pub const EDID_SEG_SIZE: c_int = 256;
pub const EDID_LEN: c_int = 32;
pub const EDID_LOOP: c_int = 8;
pub const KEY_DDC_ACCS_DONE: c_uint = 0x02;
pub const DDC_NO_ACK: c_uint = 0x50;
pub const LT9611_4LANES: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lt9611 {
    pub dev: *mut device,
    ...
    pub dsi0_node: *mut device_node,
    pub dsi1_node: *mut device_node,
    pub dsi0: *mut mipi_dsi_device,
    pub dsi1: *mut mipi_dsi_device,
    pub ac_mode: bool,
    ...
    pub status: enum drm_connector_status,
    pub edid_buf: [u8; EDID_SEG_SIZE],
}

pub const LT9611_PAGE_CONTROL: c_uint = 0xff;
...
#[no_mangle]
unsafe extern "C" fn lt9611_mipi_input_analog(lt9611: *mut lt9611) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611_pcr_setup(lt9611: *mut lt9611, mode: *const drm_display_mode, postdiv: c_uint) {
    static void lt9611_pcr_setup(struct lt9611 *lt9611, const struct drm_display_mode *mode, unsigned int postdiv)
    {
    let mut pcr_m: c_uint = mode.clock * 5 * postdiv / 27000;
    const struct reg_sequence reg_cfg[] = {
    { 0x830b, 0x01 },
    { 0x830c, 0x10 },
    { 0x8348, 0x00 },
...
// dual port: configure hact for combining two DSI inputs
    ...
    let mut hact: c_uint = mode.hdisplay;
    hact >>= 2;
    hact += 0x50;
...
#[no_mangle]
unsafe extern "C" fn lt9611_pll_setup(lt9611: *mut lt9611, mode: *const drm_display_mode, postdiv: *mut c_uint) -> c_int {
    static int lt9611_pll_setup(struct lt9611 *lt9611, const struct drm_display_mode *mode, unsigned int *postdiv)
    {
    let mut pclk: c_uint = mode.clock;
    const struct reg_sequence reg_cfg[] = {
// txpll init
    { 0x8123, 0x40 },
    { 0x8124, 0x64 },
...
#[no_mangle]
unsafe extern "C" fn lt9611_read_video_check(lt9611: *mut lt9611, reg: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611_video_check(lt9611: *mut lt9611) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611_hdmi_tx_digital(lt9611: *mut lt9611, is_hdmi: bool) {
...
#[no_mangle]
unsafe extern "C" fn lt9611_hdmi_tx_phy(lt9611: *mut lt9611) {
...
#[no_mangle]
unsafe extern "C" fn lt9611_irq_thread_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t lt9611_irq_thread_handler(int irq, void *dev_id)
    {
    struct lt9611 *lt9611 = dev_id;
    let mut irq_flag0: c_uint = 0;
    let mut irq_flag3: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn lt9611_enable_hpd_interrupts(lt9611: *mut lt9611) {
...
#[no_mangle]
unsafe extern "C" fn lt9611_sleep_setup(lt9611: *mut lt9611) {
...
#[no_mangle]
unsafe extern "C" fn lt9611_power_on(lt9611: *mut lt9611) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611_power_off(lt9611: *mut lt9611) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611_reset(lt9611: *mut lt9611) {
...
#[no_mangle]
unsafe extern "C" fn lt9611_assert_5v(lt9611: *mut lt9611) {
...
#[no_mangle]
unsafe extern "C" fn lt9611_regulator_init(lt9611: *mut lt9611) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611_regulator_enable(lt9611: *mut lt9611) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611_read_edid(lt9611: *mut lt9611) -> c_int {
...
// Disable HDMI output
    ...
    {
    let mut info: mipi_dsi_device_info = { "lt9611", 0, lt9611.dev.of_node};
...
#[no_mangle]
unsafe extern "C" fn lt9611_bridge_hpd_enable(bridge: *mut drm_bridge) {
...
// - 0x04, 0x84c0
//
pub const LT9611_INFOFRAME_AUDIO: c_uint = 0x02;
pub const LT9611_INFOFRAME_AVI: c_uint = 0x08;
pub const LT9611_INFOFRAME_SPD: c_uint = 0x10;
pub const LT9611_INFOFRAME_HDMI: c_uint = 0x20;
#[no_mangle]
unsafe extern "C" fn lt9611_hdmi_clear_audio_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611_hdmi_clear_avi_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611_hdmi_clear_spd_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611_hdmi_clear_hdmi_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(96000: hparms->sample_rate ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn lt9611_gpio_init(lt9611: *mut lt9611) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611_read_device_rev(lt9611: *mut lt9611) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611_remove(client: *mut i2c_client) {
