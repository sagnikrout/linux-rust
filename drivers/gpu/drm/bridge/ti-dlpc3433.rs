...
//! Source: drivers/gpu/drm/bridge/ti-dlpc3433.c
#![no_std]
...
pub const DSI_PORT_EN: c_int = 0;
pub const EXT_SOURCE_FMT_DSI: c_int = 0;

pub const MAX_BYTE_SIZE: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dlpc {
    pub dev: *mut device,
    ...
    pub vcc_intf: *mut regulator,
    pub vcc_flsh: *mut regulator,
    pub regmap: *mut regmap,
    pub dsi_lanes: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn dlpc_writeable_noinc_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dlpc3433_parse_dt(dlpc: *mut dlpc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpc_host_attach(dlpc: *mut dlpc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpc3433_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpc3433_remove(client: *mut i2c_client) {
