...
//! Source: drivers/gpu/drm/bridge/lontium-lt9611uxc.c
#![no_std]
...
pub const EDID_NUM_BLOCKS: c_int = 2;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lt9611uxc {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_lock(lt9611uxc: *mut lt9611uxc) {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_unlock(lt9611uxc: *mut lt9611uxc) {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_irq_thread_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t lt9611uxc_irq_thread_handler(int irq, void *dev_id)
    {
    struct lt9611uxc *lt9611uxc = dev_id;
    let mut irq_status: c_uint = 0;
    let mut hpd_status: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_hpd_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_reset(lt9611uxc: *mut lt9611uxc) {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_assert_5v(lt9611uxc: *mut lt9611uxc) {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_regulator_init(lt9611uxc: *mut lt9611uxc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_regulator_enable(lt9611uxc: *mut lt9611uxc) -> c_int {
    ...
    {
    let mut info: mipi_dsi_device_info = { "lt9611uxc", 0, core::ptr::null_mut() };
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_wait_for_edid(lt9611uxc: *mut lt9611uxc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_get_edid_block(data: *mut c_void, buf: *mut u8, block: c_uint, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_gpio_init(lt9611uxc: *mut lt9611uxc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_read_device_rev(lt9611uxc: *mut lt9611uxc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_read_version(lt9611uxc: *mut lt9611uxc) -> c_int {
...
pub const LT9611UXC_FW_PAGE_SIZE: c_int = 32;
#[no_mangle]
unsafe extern "C" fn lt9611uxc_firmware_write_page(lt9611uxc: *mut lt9611uxc, addr: u16, buf: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_firmware_read_page(lt9611uxc: *mut lt9611uxc, addr: u16, buf: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_firmware_update(lt9611uxc: *mut lt9611uxc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_firmware_store(dev: *mut device, attr: *mut device_attribute, buf: *const c_char, len: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_firmware_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_probe(client: *mut i2c_client) -> c_int {
    static int lt9611uxc_probe(struct i2c_client *client)
    {
    struct lt9611uxc *lt9611uxc;
    struct device *dev = &client.dev;
    int ret;
    let mut fw_updated: bool = false;
...
#[no_mangle]
unsafe extern "C" fn lt9611uxc_remove(client: *mut i2c_client) {
