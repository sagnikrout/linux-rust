...
//! Source: drivers/gpu/drm/bridge/parade-ps8640.c
#![no_std]
...
pub const PAGE0_AUXCH_CFG3: c_uint = 0x76;
pub const AUXCH_CFG3_RESET: c_uint = 0xff;
pub const PAGE0_SWAUX_ADDR_7_0: c_uint = 0x7d;
pub const PAGE0_SWAUX_ADDR_15_8: c_uint = 0x7e;
pub const PAGE0_SWAUX_ADDR_23_16: c_uint = 0x7f;

pub const PAGE0_SWAUX_LENGTH: c_uint = 0x80;

pub const PAGE0_SWAUX_WDATA: c_uint = 0x81;
pub const PAGE0_SWAUX_RDATA: c_uint = 0x82;
pub const PAGE0_SWAUX_CTRL: c_uint = 0x83;

pub const PAGE0_SWAUX_STATUS: c_uint = 0x84;

pub const PAGE2_GPIO_H: c_uint = 0xa7;

pub const PAGE2_I2C_BYPASS: c_uint = 0xea;
pub const I2C_BYPASS_EN: c_uint = 0xd0;
pub const PAGE2_MCS_EN: c_uint = 0xf3;

pub const PAGE3_SET_ADD: c_uint = 0xfe;
pub const VDO_CTL_ADD: c_uint = 0x13;
pub const VDO_DIS: c_uint = 0x18;
pub const VDO_EN: c_uint = 0x1c;
pub const NUM_MIPI_LANES: c_int = 4;
...
pub struct ps8640 {
    ...
    pub page: [*mut i2c_client; MAX_DEVS],
    pub regmap: [*mut regmap; MAX_DEVS],
...
#[no_mangle]
unsafe extern "C" fn _ps8640_wait_hpd_asserted(ps_bridge: *mut ps8640, wait_us: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps8640_wait_hpd_asserted(aux: *mut drm_dp_aux, wait_us: c_ulong) -> c_int {
...
//
    ...
    u8 i;
    let mut is_native_aux: bool = false;
...
#[no_mangle]
unsafe extern "C" fn ps8640_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn ps8640_suspend(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(ps8640_suspend, ps8640_resume, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn ps8640_bridge_detach(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn ps8640_runtime_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ps8640_bridge_get_dsi_resources(dev: *mut device, ps_bridge: *mut ps8640) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps8640_bridge_link_panel(aux: *mut drm_dp_aux) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps8640_probe(client: *mut i2c_client) -> c_int {
