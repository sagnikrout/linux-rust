...
//! Source: drivers/gpu/drm/bridge/panel.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn panel_bridge_connector_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn panel_bridge_detach(bridge: *mut drm_bridge) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_bridge_is_panel(bridge: *const drm_bridge) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_panel_bridge_remove(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn devm_drm_panel_bridge_release(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn drmm_drm_panel_bridge_release(drm: *mut drm_device, ptr: *mut c_void) {
