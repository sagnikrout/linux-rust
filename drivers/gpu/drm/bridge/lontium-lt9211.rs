...
//! Source: drivers/gpu/drm/bridge/lontium-lt9211.c
#![no_std]
...
pub const REG_CHIPID0: c_uint = 0x8100;
pub const REG_CHIPID0_VALUE: c_uint = 0x18;
pub const REG_CHIPID1: c_uint = 0x8101;
pub const REG_CHIPID1_VALUE: c_uint = 0x01;
pub const REG_CHIPID2: c_uint = 0x8102;
pub const REG_CHIPID2_VALUE: c_uint = 0xe3;
pub const REG_DSI_LANE: c_uint = 0xd000;
...
#[no_mangle]
unsafe extern "C" fn lt9211_read_chipid(ctx: *mut lt9211) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9211_system_init(ctx: *mut lt9211) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9211_configure_rx(ctx: *mut lt9211) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9211_parse_dt(ctx: *mut lt9211) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9211_host_attach(ctx: *mut lt9211) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9211_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt9211_remove(client: *mut i2c_client) {
