...
//! Source: drivers/gpu/drm/bridge/imx/imx8qxp-pxl2dpi.c
#![no_std]
...
pub const PXL2DPI_CTRL: c_uint = 0x40;
pub const CFG1_16BIT: c_uint = 0x0;
pub const CFG2_16BIT: c_uint = 0x1;
pub const CFG3_16BIT: c_uint = 0x2;
pub const CFG1_18BIT: c_uint = 0x3;
pub const CFG2_18BIT: c_uint = 0x4;
pub const CFG_24BIT: c_uint = 0x5;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx8qxp_pxl2dpi {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pxl2dpi_bridge_destroy(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pxl2dpi_bus_output_fmt_supported(fmt: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pxl2dpi_find_next_bridge(p2d: *mut imx8qxp_pxl2dpi) -> c_int {
    static int imx8qxp_pxl2dpi_find_next_bridge(struct imx8qxp_pxl2dpi *p2d)
    {
    struct device_node *ep __free(device_node) = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pxl2dpi_set_pixel_link_sel(p2d: *mut imx8qxp_pxl2dpi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pxl2dpi_parse_dt_companion(p2d: *mut imx8qxp_pxl2dpi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pxl2dpi_bridge_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pxl2dpi_bridge_remove(pdev: *mut platform_device) {
