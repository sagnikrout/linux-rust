...
//! Source: drivers/gpu/drm/bridge/imx/imx8mp-hdmi-tx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx8mp_hdmi_phy_disable(dw_hdmi: *mut dw_hdmi, data: *mut c_void) {
    static void imx8mp_hdmi_phy_disable(struct dw_hdmi *dw_hdmi, void *data)
    {
    }
#[no_mangle]
unsafe extern "C" fn im8mp_hdmi_phy_setup_hpd(hdmi: *mut dw_hdmi, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn imx8mp_dw_hdmi_bind(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mp_dw_hdmi_unbind(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn imx8mp_dw_hdmi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mp_dw_hdmi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn imx8mp_dw_hdmi_pm_suspend(dev: *mut device) -> c_int {
    static int imx8mp_dw_hdmi_pm_suspend(struct device *dev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn imx8mp_dw_hdmi_pm_resume(dev: *mut device) -> c_int {
