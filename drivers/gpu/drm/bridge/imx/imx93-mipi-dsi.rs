...
//! Source: drivers/gpu/drm/bridge/imx/imx93-mipi-dsi.c
#![no_std]
...
pub const DSI_REG: c_uint = 0x4c;

pub const DSI_WRITE_REG0: c_uint = 0x50;

pub const DSI_WRITE_REG1: c_uint = 0x54;

// display mux control register
pub const DISPLAY_MUX: c_uint = 0x60;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx93_dsi {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub clk_pixel: *mut clk,
    pub clk_ref: *mut clk,
    pub clk_cfg: *mut clk,
    pub dmd: *mut dw_mipi_dsi,
    pub pdata: dw_mipi_dsi_plat_data,
    pub phy_cfg: union phy_configure_opts,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dphy_pll_cfg {
    pub /: *mut *mut u32 m; / PLL Feedback Multiplication Ratio,
    pub /: *mut *mut u32 n; / PLL Input Frequency Division Ratio,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dphy_pll_vco_prop {
    pub max_fout: c_ulong,
    pub vco_cntl: u8,
    pub prop_cntl: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dphy_pll_hsfreqrange {
    pub max_mbps: c_ulong,
    pub hsfreqrange: u8,
}
...
#[no_mangle]
unsafe extern "C" fn dphy_pll_write(dsi: *mut imx93_dsi, reg: c_uint, value: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn data_rate_to_fout(data_rate: c_ulong) -> c_ulong {
...
// Fout is half of data rate
    ...
    let mut fin: c_ulong = dsi.ref_clk_rate;
    unsigned long fout;
    let mut best_fout: c_ulong = 0;
...
#[no_mangle]
unsafe extern "C" fn dphy_pll_clear_shadow(dsi: *mut imx93_dsi) {
...
#[no_mangle]
unsafe extern "C" fn dphy_pll_get_cfgclkrange(dsi: *mut imx93_dsi) -> c_ulong {
...
//
    ...
    {
    let mut mbps: c_ulong = dphy_opts.hs_clk_rate / MHZ(1);
    int i;
...
#[no_mangle]
unsafe extern "C" fn dphy_pll_get_vco(dphy_opts: *mut phy_configure_opts_mipi_dphy) -> u8 {
    static u8 dphy_pll_get_vco(struct phy_configure_opts_mipi_dphy *dphy_opts)
    {
    let mut fout: c_ulong = data_rate_to_fout(dphy_opts.hs_clk_rate) / MHZ(1);
    int i;
...
#[no_mangle]
unsafe extern "C" fn dphy_pll_get_prop(dphy_opts: *mut phy_configure_opts_mipi_dphy) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn dphy_pll_update(dsi: *mut imx93_dsi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dphy_pll_configure(dsi: *mut imx93_dsi, opts: *mut union phy_configure_opts) -> c_int {
    static int dphy_pll_configure(struct imx93_dsi *dsi, union phy_configure_opts *opts)
    {
    let mut cfg: dphy_pll_cfg = { 0 };
    u32 val;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn dphy_pll_clear_reg(dsi: *mut imx93_dsi) {
...
#[no_mangle]
unsafe extern "C" fn dphy_pll_init(dsi: *mut imx93_dsi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dphy_pll_uninit(dsi: *mut imx93_dsi) {
...
#[no_mangle]
unsafe extern "C" fn dphy_pll_power_off(dsi: *mut imx93_dsi) {
    ...
    let mut pixel_clock_rate: c_ulong = mode.clock * 1000;
...
#[no_mangle]
unsafe extern "C" fn imx93_dsi_phy_init(priv_data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx93_dsi_phy_power_off(priv_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn imx93_dsi_host_attach(priv_data: *mut c_void, device: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx93_dsi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx93_dsi_remove(pdev: *mut platform_device) {
