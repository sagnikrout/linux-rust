...
//! Source: drivers/gpu/drm/bridge/imx/imx8qxp-pixel-link.c
#![no_std]
...
pub const PL_MAX_MST_ADDR: c_int = 3;
pub const PL_MAX_NEXT_BRIDGES: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx8qxp_pixel_link {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pixel_link_enable_mst_en(pl: *mut imx8qxp_pixel_link) {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pixel_link_enable_mst_vld(pl: *mut imx8qxp_pixel_link) {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pixel_link_enable_sync(pl: *mut imx8qxp_pixel_link) {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pixel_link_disable_mst_en(pl: *mut imx8qxp_pixel_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pixel_link_disable_mst_vld(pl: *mut imx8qxp_pixel_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pixel_link_disable_sync(pl: *mut imx8qxp_pixel_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pixel_link_set_mst_addr(pl: *mut imx8qxp_pixel_link) {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pixel_link_bus_output_fmt_supported(fmt: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pixel_link_disable_all_controls(pl: *mut imx8qxp_pixel_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pixel_link_find_next_bridge(pl: *mut imx8qxp_pixel_link) -> c_int {
    static int imx8qxp_pixel_link_find_next_bridge(struct imx8qxp_pixel_link *pl)
    {
    struct device_node *np = pl.dev.of_node;
    struct device_node *port;
    u32 port_id;
    let mut found_port: bool = false;
    int reg;
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pixel_link_bridge_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_pixel_link_bridge_remove(pdev: *mut platform_device) {
