...
//! Source: drivers/gpu/drm/bridge/imx/imx8qxp-ldb.c
#![no_std]
...
pub const SS_CTRL: c_uint = 0x20;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx8qxp_ldb_channel {
    pub base: ldb_channel,
    pub phy: *mut phy,
    pub di_id: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx8qxp_ldb {
    pub base: ldb,
    pub dev: *mut device,
    pub channel: [*mut imx8qxp_ldb_channel; MAX_LDB_CHAN_NUM],
    pub clk_pixel: *mut clk,
    pub clk_bypass: *mut clk,
    pub companion: *mut drm_bridge,
    pub active_chno: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_ldb_bridge_destroy(bridge: *mut drm_bridge) {
    ...
    let mut di_clk: c_ulong = adj.clock * 1000;
    let mut is_split: bool = ldb_channel_is_split_link(ldb_ch);
    ...
    let mut di_clk: c_ulong = adjusted_mode.clock * 1000;
    let mut is_split: bool = ldb_channel_is_split_link(ldb_ch);
    let mut opts: union phy_configure_opts = { };
    struct phy_configure_opts_lvds *phy_cfg = &opts.lvds;
    let mut chno: u32 = ldb_ch.chno;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn if(DRM_MODE_FLAG_PVSYNC: adjusted_mode->flags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(DRM_MODE_FLAG_PHSYNC: adjusted_mode->flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_ldb_bus_output_fmt_supported(fmt: u32) -> bool {
...
// num_output_fmts = ARRAY_SIZE(imx8qxp_ldb_bus_output_fmts);
    ...
    {
    struct ldb_channel *ldb_ch = bridge.driver_private;
    let mut is_single: bool = ldb_channel_is_single_link(ldb_ch);
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_ldb_set_di_id(imx8qxp_ldb: *mut imx8qxp_ldb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_ldb_parse_dt_companion(imx8qxp_ldb: *mut imx8qxp_ldb) -> c_int {
    ...
    struct device_node *companion_port = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_ldb_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_ldb_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_ldb_runtime_resume(dev: *mut device) -> c_int {
...
// disable LDB by resetting the control register to POR default
    ...
    RUNTIME_PM_OPS(core::ptr::null_mut(), imx8qxp_ldb_runtime_resume, core::ptr::null_mut())
    };
