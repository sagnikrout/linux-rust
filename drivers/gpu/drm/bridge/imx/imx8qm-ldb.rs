...
//! Source: drivers/gpu/drm/bridge/imx/imx8qm-ldb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx8qm_ldb {
    pub base: ldb,
    pub dev: *mut device,
    pub channel: [*mut imx8qm_ldb_channel; MAX_LDB_CHAN_NUM],
...
#[no_mangle]
unsafe extern "C" fn imx8qm_ldb_bus_output_fmt_supported(fmt: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn imx8qm_ldb_get_phy(imx8qm_ldb: *mut imx8qm_ldb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8qm_ldb_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8qm_ldb_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn imx8qm_ldb_runtime_suspend(dev: *mut device) -> c_int {
    static int imx8qm_ldb_runtime_suspend(struct device *dev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn imx8qm_ldb_runtime_resume(dev: *mut device) -> c_int {
...
// disable LDB by resetting the control register to POR default
    ...
    RUNTIME_PM_OPS(imx8qm_ldb_runtime_suspend, imx8qm_ldb_runtime_resume, core::ptr::null_mut())
    };
