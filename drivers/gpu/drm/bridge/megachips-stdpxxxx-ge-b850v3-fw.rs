...
//! Source: drivers/gpu/drm/bridge/megachips-stdpxxxx-ge-b850v3-fw.c
#![no_std]
...
pub const EDID_EXT_BLOCK_CNT: c_uint = 0x7E;
pub const STDP4028_IRQ_OUT_CONF_REG: c_uint = 0x02;
pub const STDP4028_DPTX_IRQ_EN_REG: c_uint = 0x3C;
pub const STDP4028_DPTX_IRQ_STS_REG: c_uint = 0x3D;
pub const STDP4028_DPTX_STS_REG: c_uint = 0x3E;
pub const STDP4028_DPTX_DP_IRQ_EN: c_uint = 0x1000;
pub const STDP4028_DPTX_HOTPLUG_IRQ_EN: c_uint = 0x0400;
pub const STDP4028_DPTX_LINK_CH_IRQ_EN: c_uint = 0x2000;

    (STDP4028_DPTX_LINK_CH_IRQ_EN | STDP4028_DPTX_HOTPLUG_IRQ_EN)
pub const STDP4028_DPTX_HOTPLUG_STS: c_uint = 0x0200;
pub const STDP4028_DPTX_LINK_STS: c_uint = 0x1000;

    (STDP4028_DPTX_HOTPLUG_STS | STDP4028_DPTX_LINK_STS)
pub const STDP4028_DPTX_HOTPLUG_CH_STS: c_uint = 0x0400;
pub const STDP4028_DPTX_LINK_CH_STS: c_uint = 0x2000;

    (STDP4028_DPTX_LINK_CH_STS | STDP4028_DPTX_HOTPLUG_CH_STS)
    static DEFINE_MUTEX(ge_b850v3_lvds_dev_mutex);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ge_b850v3_lvds {
    pub connector: drm_connector,
    pub bridge: drm_bridge,
    pub stdp4028_i2c: *mut i2c_client,
    pub stdp2690_i2c: *mut i2c_client,
}

    static struct ge_b850v3_lvds *ge_b850v3_lvds_ptr;
#[no_mangle]
unsafe extern "C" fn stdp2690_read_block(context: *mut c_void, buf: *mut u8, block: c_uint, len: usize) -> c_int {
    static int stdp2690_read_block(void *context, u8 *buf, unsigned int block, size_t len)
    {
    struct i2c_client *client = context;
    struct i2c_adapter *adapter = client.adapter;
    let mut start: c_uchar = block * EDID_LENGTH;
    struct i2c_msg msgs[] = {
    {
    .addr	= client.addr,
    .flags	= 0,
...
#[no_mangle]
unsafe extern "C" fn ge_b850v3_lvds_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ge_b850v3_lvds_create_connector(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ge_b850v3_lvds_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ge_b850v3_lvds_init(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ge_b850v3_lvds_remove() {
...
//
    ...
    ge_b850v3_lvds_ptr = core::ptr::null_mut();
    out:
    mutex_unlock(&ge_b850v3_lvds_dev_mutex);
    }
#[no_mangle]
unsafe extern "C" fn ge_b850v3_register() -> c_int {
...
// Clear pending interrupts since power up.
    ...
    stdp4028_i2c.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn stdp4028_ge_b850v3_fw_probe(stdp4028_i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stdp4028_ge_b850v3_fw_remove(stdp4028_i2c: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn stdp2690_ge_b850v3_fw_probe(stdp2690_i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stdp2690_ge_b850v3_fw_remove(stdp2690_i2c: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn stdpxxxx_ge_b850v3_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn stdpxxxx_ge_b850v3_exit() -> void __exit {
