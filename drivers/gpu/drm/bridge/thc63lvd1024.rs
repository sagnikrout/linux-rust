...
//! Source: drivers/gpu/drm/bridge/thc63lvd1024.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct thc63_dev {
    pub dev: *mut device,
    pub vcc: *mut regulator,
    pub pdwn: *mut gpio_desc,
...
#[no_mangle]
unsafe extern "C" fn thc63_parse_dt(thc63: *mut thc63_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thc63_gpio_init(thc63: *mut thc63_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thc63_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thc63_remove(pdev: *mut platform_device) {
