...
//! Source: drivers/gpu/drm/bridge/ti-sn65dsi86.c
#![no_std]
...
pub const SN_DEVICE_ID_REGS: c_uint = 0x00	/* up to 0x07 */;
pub const SN_DEVICE_REV_REG: c_uint = 0x08;
pub const SN_DPPLL_SRC_REG: c_uint = 0x0A;

pub const SN_PLL_ENABLE_REG: c_uint = 0x0D;
pub const SN_DSI_LANES_REG: c_uint = 0x10;

pub const SN_DSIA_CLK_FREQ_REG: c_uint = 0x12;
pub const SN_CHA_ACTIVE_LINE_LENGTH_LOW_REG: c_uint = 0x20;
pub const SN_CHA_VERTICAL_DISPLAY_SIZE_LOW_REG: c_uint = 0x24;
pub const SN_CHA_HSYNC_PULSE_WIDTH_LOW_REG: c_uint = 0x2C;
pub const SN_CHA_HSYNC_PULSE_WIDTH_HIGH_REG: c_uint = 0x2D;

pub const SN_CHA_VSYNC_PULSE_WIDTH_LOW_REG: c_uint = 0x30;
pub const SN_CHA_VSYNC_PULSE_WIDTH_HIGH_REG: c_uint = 0x31;

pub const SN_CHA_HORIZONTAL_BACK_PORCH_REG: c_uint = 0x34;
pub const SN_CHA_VERTICAL_BACK_PORCH_REG: c_uint = 0x36;
pub const SN_CHA_HORIZONTAL_FRONT_PORCH_REG: c_uint = 0x38;
pub const SN_CHA_VERTICAL_FRONT_PORCH_REG: c_uint = 0x3A;
pub const SN_LN_ASSIGN_REG: c_uint = 0x59;
pub const LN_ASSIGN_WIDTH: c_int = 2;
pub const SN_ENH_FRAME_REG: c_uint = 0x5A;

pub const LN_POLRS_OFFSET: c_int = 4;
pub const LN_POLRS_MASK: c_uint = 0xf0;
pub const SN_DATA_FORMAT_REG: c_uint = 0x5B;

pub const SN_HPD_DISABLE_REG: c_uint = 0x5C;

pub const SN_GPIO_IO_REG: c_uint = 0x5E;
pub const SN_GPIO_INPUT_SHIFT: c_int = 4;
pub const SN_GPIO_OUTPUT_SHIFT: c_int = 0;
pub const SN_GPIO_CTRL_REG: c_uint = 0x5F;
pub const SN_GPIO_MUX_INPUT: c_int = 0;
pub const SN_GPIO_MUX_OUTPUT: c_int = 1;
pub const SN_GPIO_MUX_SPECIAL: c_int = 2;
pub const SN_GPIO_MUX_MASK: c_uint = 0x3;

pub const SN_AUX_ADDR_19_16_REG: c_uint = 0x74;
pub const SN_AUX_ADDR_15_8_REG: c_uint = 0x75;
pub const SN_AUX_ADDR_7_0_REG: c_uint = 0x76;

pub const SN_AUX_LENGTH_REG: c_uint = 0x77;
pub const SN_AUX_CMD_REG: c_uint = 0x78;

pub const SN_SSC_CONFIG_REG: c_uint = 0x93;

pub const SN_DATARATE_CONFIG_REG: c_uint = 0x94;

pub const SN_TRAINING_SETTING_REG: c_uint = 0x95;

pub const SN_ML_TX_MODE_REG: c_uint = 0x96;
pub const ML_TX_MAIN_LINK_OFF: c_int = 0;

pub const SN_PWM_PRE_DIV_REG: c_uint = 0xA0;
pub const SN_BACKLIGHT_SCALE_REG: c_uint = 0xA1;
pub const BACKLIGHT_SCALE_MAX: c_uint = 0xFFFF;
pub const SN_BACKLIGHT_REG: c_uint = 0xA3;
pub const SN_PWM_EN_INV_REG: c_uint = 0xA5;

pub const SN_IRQ_EN_REG: c_uint = 0xE0;

pub const SN_IRQ_EVENTS_EN_REG: c_uint = 0xE6;

pub const SN_AUX_CMD_STATUS_REG: c_uint = 0xF4;

pub const SN_IRQ_STATUS_REG: c_uint = 0xF5;

pub const MIN_DSI_CLK_FREQ_MHZ: c_int = 40;
// fudge factor required to account for 8b/10b encoding
pub const DP_CLK_FUDGE_NUM: c_int = 10;
pub const DP_CLK_FUDGE_DEN: c_int = 8;
// Matches DP_AUX_MAX_PAYLOAD_BYTES (for now)
pub const SN_AUX_MAX_PAYLOAD_BYTES: c_int = 16;
pub const SN_REGULATOR_SUPPLY_NUM: c_int = 4;
pub const SN_MAX_DP_LANES: c_int = 4;
pub const SN_NUM_GPIOS: c_int = 4;
pub const SN_GPIO_PHYSICAL_OFFSET: c_int = 1;
pub const SN_LINK_TRAINING_TRIES: c_int = 10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_sn65dsi86 {
    pub bridge_aux: *mut auxiliary_device,
    pub gpio_aux: *mut auxiliary_device,
    pub aux_aux: *mut auxiliary_device,
    pub pwm_aux: *mut auxiliary_device,
    pub dev: *mut device,
    ...
    pub supplies: [regulator_bulk_data; SN_REGULATOR_SUPPLY_NUM],
    pub dp_lanes: c_int,
    pub ln_assign: u8,
    pub ln_polrs: u8,
    pub comms_enabled: bool,
    pub hpd_enabled: bool,
    pub comms_mutex: mutex,
    pub hpd_mutex: mutex,

    pub gchip: gpio_chip,
    pub SN_NUM_GPIOS): DECLARE_BITMAP(gchip_output,,

    pub pchip: *mut pwm_chip,
    pub pwm_enabled: bool,
    pub pwm_pin_busy: core::sync::atomic::AtomicI32,

    pub pwm_refclk_freq: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn ti_sn65dsi86_disable_comms(pdata: *mut ti_sn65dsi86) {
...
#[no_mangle]
unsafe extern "C" fn ti_sn65dsi86_resume(dev: *mut device) -> int __maybe_unused {
...
//
    if (pdata.refclk)
    ti_sn65dsi86_enable_comms(pdata, core::ptr::null_mut());
    if (client.irq) {
...
#[no_mangle]
unsafe extern "C" fn ti_sn65dsi86_suspend(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(ti_sn65dsi86_suspend, ti_sn65dsi86_resume, core::ptr::null_mut())
...
//
    ...
    let mut request: u32 = msg.request & ~(DP_AUX_I2C_MOT | DP_AUX_I2C_WRITE_STATUS_UPDATE);
    let mut request_val: u32 = AUX_CMD_REQ(msg.request);
    u8 *buf = msg.buffer;
    let mut len: c_uint = msg.size;
...
#[no_mangle]
unsafe extern "C" fn ti_sn_aux_wait_hpd_asserted(aux: *mut drm_dp_aux, wait_us: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_attach_host(adev: *mut auxiliary_device, pdata: *mut ti_sn65dsi86) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_bridge_detach(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_bridge_get_bpp(connector: *mut drm_connector) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_bridge_read_valid_rates(pdata: *mut ti_sn65dsi86) -> c_uint {
    static unsigned int ti_sn_bridge_read_valid_rates(struct ti_sn65dsi86 *pdata)
    {
    let mut valid_rates: c_uint = 0;
...
// On older versions best we can do is use DP_MAX_LINK_RATE
    ...
    struct drm_display_mode *mode =
    get_new_adjusted_display_mode(&pdata.bridge, state);
    let mut hsync_polarity: u8 = 0, vsync_polarity = 0;
...
#[no_mangle]
unsafe extern "C" fn ti_sn_get_max_lanes(pdata: *mut ti_sn65dsi86) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ti_sn65dsi86_debugfs_init(bridge: *mut drm_bridge, root: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_bridge_hpd_enable(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_bridge_hpd_disable(bridge: *mut drm_bridge) {
    ...
    let mut ln_assign: u8 = 0;
    let mut ln_polrs: u8 = 0;
    int dp_lanes;
    int i;
//
...
#[no_mangle]
unsafe extern "C" fn ti_sn_bridge_parse_dsi_host(pdata: *mut ti_sn65dsi86) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_bridge_interrupt(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_bridge_remove(adev: *mut auxiliary_device) {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_pwm_pin_request(pdata: *mut ti_sn65dsi86) -> c_int {
    static int ti_sn_pwm_pin_request(struct ti_sn65dsi86 *pdata)
    {
    return atomic_xchg(&pdata.pwm_pin_busy, 1) ? -EBUSY : 0;
    }
#[no_mangle]
unsafe extern "C" fn ti_sn_pwm_pin_release(pdata: *mut ti_sn65dsi86) {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_pwm_request(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_pwm_free(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_pwm_remove(adev: *mut auxiliary_device) {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_bridge_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_bridge_gpio_request(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_sn_bridge_gpio_free(chip: *mut gpio_chip, offset: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn ti_sn65dsi86_runtime_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ti_sn65dsi86_parse_regulators(pdata: *mut ti_sn65dsi86) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_sn65dsi86_probe(client: *mut i2c_client) -> c_int {
...
// The ID string is stored backwards
    ...
    if (client.irq) {
    ret = devm_request_threaded_irq(pdata.dev, client.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn ti_sn65dsi86_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ti_sn65dsi86_exit() -> void __exit {
