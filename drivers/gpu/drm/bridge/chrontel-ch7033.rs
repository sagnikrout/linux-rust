...
//! Source: drivers/gpu/drm/bridge/chrontel-ch7033.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ch7033_connector_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ch7033_hpd_event(arg: *mut c_void, status: enum drm_connector_status) {
...
#[no_mangle]
unsafe extern "C" fn ch7033_bridge_detach(bridge: *mut drm_bridge) {
    ...
    {
    struct ch7033_priv *priv = bridge_to_ch7033_priv(bridge);
    let mut hbporch: c_int = mode.hsync_start - mode.hdisplay;
    let mut hsynclen: c_int = mode.hsync_end - mode.hsync_start;
    let mut vbporch: c_int = mode.vsync_start - mode.vdisplay;
    let mut vsynclen: c_int = mode.vsync_end - mode.vsync_start;
//
// Page 4
//
    regmap_write(priv.regmap, 0x03, 0x04);
...
#[no_mangle]
unsafe extern "C" fn ch7033_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ch7033_remove(client: *mut i2c_client) {
