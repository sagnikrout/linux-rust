...
//! Source: drivers/gpu/drm/bridge/analogix/analogix-anx6345.c
#![no_std]
...
pub const I2C_IDX_DPTX: c_int = 0;
pub const I2C_IDX_TXCOM: c_int = 1;
...
pub struct anx6345 {
    ...
    pub dvdd12: *mut regulator,
    pub dvdd25: *mut regulator,
    pub gpiod_reset: *mut gpio_desc,
    pub /: *mut *mut mutex lock; / protect EDID access,
// I2C Slave addresses of ANX6345 are mapped as DPTX and SYS
    pub i2c_clients: [*mut i2c_client; I2C_NUM_ADDRESSES],
    pub map: [*mut regmap; I2C_NUM_ADDRESSES],
    pub chipid: u16,
...
#[no_mangle]
unsafe extern "C" fn anx6345_set_bits(map: *mut regmap, reg: u8, mask: u8) -> c_int {
    static int anx6345_set_bits(struct regmap *map, u8 reg, u8 mask)
    {
    return regmap_update_bits(map, reg, mask, mask);
    }
#[no_mangle]
unsafe extern "C" fn anx6345_clear_bits(map: *mut regmap, reg: u8, mask: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn anx6345_dp_link_training(anx6345: *mut anx6345) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn anx6345_tx_initialization(anx6345: *mut anx6345) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn anx6345_poweron(anx6345: *mut anx6345) {
...
#[no_mangle]
unsafe extern "C" fn anx6345_poweroff(anx6345: *mut anx6345) {
...
#[no_mangle]
unsafe extern "C" fn anx6345_start(anx6345: *mut anx6345) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn anx6345_config_dp_output(anx6345: *mut anx6345) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn anx6345_get_downstream_info(anx6345: *mut anx6345) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn anx6345_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn anx6345_bridge_detach(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn unregister_i2c_dummy_clients(anx6345: *mut anx6345) {
...
#[no_mangle]
unsafe extern "C" fn anx6345_get_chip_id(anx6345: *mut anx6345) -> bool {
...
#[no_mangle]
unsafe extern "C" fn anx6345_panel_put_action(data: *mut c_void) {
    static void anx6345_panel_put_action(void *data)
    {
    drm_panel_put(data);
    }
#[no_mangle]
unsafe extern "C" fn anx6345_i2c_probe(client: *mut i2c_client) -> c_int {
    ...
    &anx6345.panel, core::ptr::null_mut());
    if (err == -EPROBE_DEFER)
    return err;
    if (err)
...
#[no_mangle]
unsafe extern "C" fn anx6345_i2c_remove(client: *mut i2c_client) {
