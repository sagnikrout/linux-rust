...
//! Source: drivers/gpu/drm/bridge/waveshare-dsi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ws_bridge_attach_dsi(ws: *mut ws_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ws_bridge_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ws_bridge_probe(i2c: *mut i2c_client) -> c_int {
    ...
    ret = drm_of_find_panel_or_bridge(dev.of_node, 1, -1, &panel, core::ptr::null_mut());
    if (ret)
