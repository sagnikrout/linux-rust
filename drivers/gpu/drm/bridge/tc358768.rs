...
//! Source: drivers/gpu/drm/bridge/tc358768.c
#![no_std]
...
pub const TC358768_CHIPID: c_uint = 0x0000;
pub const TC358768_SYSCTL: c_uint = 0x0002;
pub const TC358768_CONFCTL: c_uint = 0x0004;
pub const TC358768_VSDLY: c_uint = 0x0006;
pub const TC358768_DATAFMT: c_uint = 0x0008;
pub const TC358768_GPIOEN: c_uint = 0x000E;
pub const TC358768_GPIODIR: c_uint = 0x0010;
pub const TC358768_GPIOIN: c_uint = 0x0012;
pub const TC358768_GPIOOUT: c_uint = 0x0014;
pub const TC358768_PLLCTL0: c_uint = 0x0016;
pub const TC358768_PLLCTL1: c_uint = 0x0018;
pub const TC358768_CMDBYTE: c_uint = 0x0022;
pub const TC358768_PP_MISC: c_uint = 0x0032;
pub const TC358768_DSITX_DT: c_uint = 0x0050;
pub const TC358768_FIFOSTATUS: c_uint = 0x00F8;
// Debug (16-bit addressable)
pub const TC358768_VBUFCTRL: c_uint = 0x00E0;

pub const TC358768_DBG_WIDTH: c_uint = 0x00E2;
pub const TC358768_DBG_VBLANK: c_uint = 0x00E4;
pub const TC358768_DBG_DATA: c_uint = 0x00E8;
// TX PHY (32-bit addressable)
pub const TC358768_CLW_DPHYCONTTX: c_uint = 0x0100;
pub const TC358768_D0W_DPHYCONTTX: c_uint = 0x0104;
pub const TC358768_D1W_DPHYCONTTX: c_uint = 0x0108;
pub const TC358768_D2W_DPHYCONTTX: c_uint = 0x010C;
pub const TC358768_D3W_DPHYCONTTX: c_uint = 0x0110;
pub const TC358768_CLW_CNTRL: c_uint = 0x0140;
pub const TC358768_D0W_CNTRL: c_uint = 0x0144;
pub const TC358768_D1W_CNTRL: c_uint = 0x0148;
pub const TC358768_D2W_CNTRL: c_uint = 0x014C;
pub const TC358768_D3W_CNTRL: c_uint = 0x0150;
// TX PPI (32-bit addressable)
pub const TC358768_STARTCNTRL: c_uint = 0x0204;
pub const TC358768_DSITXSTATUS: c_uint = 0x0208;
pub const TC358768_LINEINITCNT: c_uint = 0x0210;
pub const TC358768_LPTXTIMECNT: c_uint = 0x0214;
pub const TC358768_TCLK_HEADERCNT: c_uint = 0x0218;
pub const TC358768_TCLK_TRAILCNT: c_uint = 0x021C;
pub const TC358768_THS_HEADERCNT: c_uint = 0x0220;
pub const TC358768_TWAKEUP: c_uint = 0x0224;
pub const TC358768_TCLK_POSTCNT: c_uint = 0x0228;
pub const TC358768_THS_TRAILCNT: c_uint = 0x022C;
pub const TC358768_HSTXVREGCNT: c_uint = 0x0230;
pub const TC358768_HSTXVREGEN: c_uint = 0x0234;
pub const TC358768_TXOPTIONCNTRL: c_uint = 0x0238;
pub const TC358768_BTACNTRL1: c_uint = 0x023C;
// TX CTRL (32-bit addressable)
pub const TC358768_DSI_CONTROL: c_uint = 0x040C;
pub const TC358768_DSI_STATUS: c_uint = 0x0410;
pub const TC358768_DSI_INT: c_uint = 0x0414;
pub const TC358768_DSI_INT_ENA: c_uint = 0x0418;
pub const TC358768_DSICMD_RDFIFO: c_uint = 0x0430;
pub const TC358768_DSI_ACKERR: c_uint = 0x0434;
pub const TC358768_DSI_ACKERR_INTENA: c_uint = 0x0438;
pub const TC358768_DSI_ACKERR_HALT: c_uint = 0x043c;
pub const TC358768_DSI_RXERR: c_uint = 0x0440;
pub const TC358768_DSI_RXERR_INTENA: c_uint = 0x0444;
pub const TC358768_DSI_RXERR_HALT: c_uint = 0x0448;
pub const TC358768_DSI_ERR: c_uint = 0x044C;
pub const TC358768_DSI_ERR_INTENA: c_uint = 0x0450;
pub const TC358768_DSI_ERR_HALT: c_uint = 0x0454;
pub const TC358768_DSI_CONFW: c_uint = 0x0500;
pub const TC358768_DSI_LPCMD: c_uint = 0x0500;
pub const TC358768_DSI_RESET: c_uint = 0x0504;
pub const TC358768_DSI_INT_CLR: c_uint = 0x050C;
pub const TC358768_DSI_START: c_uint = 0x0518;
// DSITX CTRL (16-bit addressable)
pub const TC358768_DSICMD_TX: c_uint = 0x0600;
pub const TC358768_DSICMD_TYPE: c_uint = 0x0602;
pub const TC358768_DSICMD_WC: c_uint = 0x0604;
pub const TC358768_DSICMD_WD0: c_uint = 0x0610;
pub const TC358768_DSICMD_WD1: c_uint = 0x0612;
pub const TC358768_DSICMD_WD2: c_uint = 0x0614;
pub const TC358768_DSICMD_WD3: c_uint = 0x0616;
pub const TC358768_DSI_EVENT: c_uint = 0x0620;
pub const TC358768_DSI_VSW: c_uint = 0x0622;
pub const TC358768_DSI_VBPR: c_uint = 0x0624;
pub const TC358768_DSI_VACT: c_uint = 0x0626;
pub const TC358768_DSI_HSW: c_uint = 0x0628;
pub const TC358768_DSI_HBPR: c_uint = 0x062A;
pub const TC358768_DSI_HACT: c_uint = 0x062C;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tc358768_dsi_output {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tc358768_priv {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub reset_gpio: *mut gpio_desc,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(tc358768_supplies)],
    pub refclk: *mut clk,
    pub enabled: c_int,
    pub error: c_int,
    pub dsi_host: mipi_dsi_host,
    pub bridge: drm_bridge,
    pub output: tc358768_dsi_output,
    pub /: *mut *mut u32 pd_lines; / number of Parallel Port Input Data Lines,
    pub /: *mut *mut u32 dsi_lanes; / number of DSI Lanes,
    pub /: *mut *mut u32 dsi_bpp; / number of Bits Per Pixel over DSI,
// Parameters for PLL programming
    pub /: *mut *mut u32 fbd; / PLL feedback divider,
    pub /: *mut *mut u32 prd; / PLL input divider,
    pub /: *mut *mut u32 frs; / PLL Freqency range for HSCK (post divider),
    pub /: *mut *mut u32 dsiclk; / pll_clk / 2,
    pub /: *mut *mut u32 pclk; / incoming pclk rate,
}
...
#[no_mangle]
unsafe extern "C" fn tc358768_clear_error(priv: *mut tc358768_priv) -> c_int {
    static int tc358768_clear_error(struct tc358768_priv *priv)
    {
    let mut ret: c_int = priv.error;
    priv.error = 0;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn tc358768_write(priv: *mut tc358768_priv, reg: u32, val: u32) {
    static void tc358768_write(struct tc358768_priv *priv, u32 reg, u32 val)
    {
// work around https://gcc.gnu.org/bugzilla/show_bug.cgi?id=81715
    let mut tmpval: c_int = val;
...
#[no_mangle]
unsafe extern "C" fn tc358768_read(priv: *mut tc358768_priv, reg: u32, val: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn tc358768_dsicmd_tx(priv: *mut tc358768_priv) {
...
#[no_mangle]
unsafe extern "C" fn tc358768_sw_reset(priv: *mut tc358768_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc358768_hw_enable(priv: *mut tc358768_priv) {
...
#[no_mangle]
unsafe extern "C" fn tc358768_hw_disable(priv: *mut tc358768_priv) {
...
#[no_mangle]
unsafe extern "C" fn tc358768_pll_to_pclk(priv: *mut tc358768_priv, pll_clk: u32) -> u32 {
    static u32 tc358768_pll_to_pclk(struct tc358768_priv *priv, u32 pll_clk)
    {
    return (u32)div_u64((u64)pll_clk * priv.dsi_lanes, priv.dsi_bpp);
    }
#[no_mangle]
unsafe extern "C" fn tc358768_pclk_to_pll(priv: *mut tc358768_priv, pclk: u32) -> u32 {
...
// get input ep (port0/endpoint0)
    ...
    let mut val: u16 = packet.payload[i];
...
#[no_mangle]
unsafe extern "C" fn tc358768_ns_to_cnt(ns: u32, period_ps: u32) -> u32 {
    static u32 tc358768_ns_to_cnt(u32 ns, u32 period_ps)
    {
    return DIV_ROUND_UP(ns * 1000, period_ps);
    }
#[no_mangle]
unsafe extern "C" fn tc358768_ps_to_ns(ps: u32) -> u32 {
    static u32 tc358768_ps_to_ns(u32 ps)
    {
    return ps / 1000;
    }
#[no_mangle]
unsafe extern "C" fn tc358768_dpi_to_ns(val: u32, pclk: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tc358768_dpi_to_dsi_bytes(priv: *mut tc358768_priv, val: u32) -> u32 {
    static u32 tc358768_dpi_to_dsi_bytes(struct tc358768_priv *priv, u32 val)
    {
    let mut m: u64 = (u64)val * priv.dsiclk / 4 * priv.dsi_lanes;
    let mut n: u64 = priv.pclk;
    return (u32)div_u64(m + n - 1, n);
    }
#[no_mangle]
unsafe extern "C" fn tc358768_dsi_bytes_to_ns(priv: *mut tc358768_priv, val: u32) -> u32 {
    static u32 tc358768_dsi_bytes_to_ns(struct tc358768_priv *priv, u32 val)
    {
    let mut m: u64 = (u64)val * NANO;
    let mut n: u64 = priv.dsiclk / 4 * priv.dsi_lanes;
...
//
    ...
    let mut old_hfp: u32 = dsi_hfp;
    let mut old_hsw: u32 = dsi_hsw;
    let mut tot: u32 = dsi_hfp + dsi_hsw + dsi_hss;
    dsi_hsw = tot / 3;
//
...
#[no_mangle]
unsafe extern "C" fn tc358768_config_video_format(priv: *mut tc358768_priv) {
...
#[no_mangle]
unsafe extern "C" fn tc358768_is_reserved_reg(reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tc358768_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tc358768_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tc358768_get_regulators(priv: *mut tc358768_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc358768_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc358768_i2c_remove(client: *mut i2c_client) {
