...
//! Source: drivers/gpu/drm/bridge/synopsys/dw-hdmi-i2s-audio.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn hdmi_read(audio: *mut dw_hdmi_i2s_audio_data, offset: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn dw_hdmi_i2s_audio_startup(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_hdmi_i2s_audio_shutdown(dev: *mut device, data: *mut c_void) {
