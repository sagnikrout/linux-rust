...
//! Source: drivers/gpu/drm/bridge/synopsys/dw-dp.c
#![no_std]
...
pub const DW_DP_VERSION_NUMBER: c_uint = 0x0000;
pub const DW_DP_VERSION_TYPE: c_uint = 0x0004;
pub const DW_DP_ID: c_uint = 0x0008;
pub const DW_DP_CONFIG_REG1: c_uint = 0x0100;
pub const DW_DP_CONFIG_REG2: c_uint = 0x0104;
pub const DW_DP_CONFIG_REG3: c_uint = 0x0108;
pub const DW_DP_CCTL: c_uint = 0x0200;

pub const DW_DP_SOFT_RESET_CTRL: c_uint = 0x0204;

pub const DW_DP_VSAMPLE_CTRL: c_uint = 0x0300;

pub const DW_DP_VSAMPLE_STUFF_CTRL1: c_uint = 0x0304;
pub const DW_DP_VSAMPLE_STUFF_CTRL2: c_uint = 0x0308;
pub const DW_DP_VINPUT_POLARITY_CTRL: c_uint = 0x030c;

pub const DW_DP_VIDEO_CONFIG1: c_uint = 0x0310;

pub const DW_DP_VIDEO_CONFIG2: c_uint = 0x0314;

pub const DW_DP_VIDEO_CONFIG3: c_uint = 0x0318;

pub const DW_DP_VIDEO_CONFIG4: c_uint = 0x031c;

pub const DW_DP_VIDEO_CONFIG5: c_uint = 0x0320;

pub const DW_DP_VIDEO_MSA1: c_uint = 0x0324;

pub const DW_DP_VIDEO_MSA2: c_uint = 0x0328;

pub const DW_DP_VIDEO_MSA3: c_uint = 0x032c;

pub const DW_DP_VIDEO_HBLANK_INTERVAL: c_uint = 0x0330;

pub const DW_DP_AUD_CONFIG1: c_uint = 0x0400;

pub const DW_DP_SDP_VERTICAL_CTRL: c_uint = 0x0500;

pub const DW_DP_SDP_HORIZONTAL_CTRL: c_uint = 0x0504;

pub const DW_DP_SDP_STATUS_REGISTER: c_uint = 0x0508;
pub const DW_DP_SDP_MANUAL_CTRL: c_uint = 0x050c;
pub const DW_DP_SDP_STATUS_EN: c_uint = 0x0510;
pub const DW_DP_SDP_REGISTER_BANK: c_uint = 0x0600;

pub const DW_DP_PHYIF_CTRL: c_uint = 0x0a00;

pub const DW_DP_PHY_TX_EQ: c_uint = 0x0a04;
pub const DW_DP_CUSTOMPAT0: c_uint = 0x0a08;
pub const DW_DP_CUSTOMPAT1: c_uint = 0x0a0c;
pub const DW_DP_CUSTOMPAT2: c_uint = 0x0a10;
pub const DW_DP_HBR2_COMPLIANCE_SCRAMBLER_RESET: c_uint = 0x0a14;
pub const DW_DP_PHYIF_PWRDOWN_CTRL: c_uint = 0x0a18;
pub const DW_DP_AUX_CMD: c_uint = 0x0b00;

pub const DW_DP_AUX_STATUS: c_uint = 0x0b04;

pub const DW_DP_AUX_DATA0: c_uint = 0x0b08;
pub const DW_DP_AUX_DATA1: c_uint = 0x0b0c;
pub const DW_DP_AUX_DATA2: c_uint = 0x0b10;
pub const DW_DP_AUX_DATA3: c_uint = 0x0b14;
pub const DW_DP_GENERAL_INTERRUPT: c_uint = 0x0d00;

pub const DW_DP_GENERAL_INTERRUPT_ENABLE: c_uint = 0x0d04;

pub const DW_DP_HPD_STATUS: c_uint = 0x0d08;

pub const DW_DP_HPD_INTERRUPT_ENABLE: c_uint = 0x0d0c;

pub const DW_DP_HDCP_CFG: c_uint = 0x0e00;

pub const DW_DP_HDCP_OBS: c_uint = 0x0e04;

pub const DW_DP_HDCP_APIINTCLR: c_uint = 0x0e08;
pub const DW_DP_HDCP_APIINTSTAT: c_uint = 0x0e0c;
pub const DW_DP_HDCP_APIINTMSK: c_uint = 0x0e10;

pub const DW_DP_HDCP_KSVMEMCTRL: c_uint = 0x0e18;

pub const DW_DP_HDCP_REG_BKSV0: c_uint = 0x3600;
pub const DW_DP_HDCP_REG_BKSV1: c_uint = 0x3604;
pub const DW_DP_HDCP_REG_ANCONF: c_uint = 0x3608;

pub const DW_DP_HDCP_REG_AN0: c_uint = 0x360c;
pub const DW_DP_HDCP_REG_AN1: c_uint = 0x3610;
pub const DW_DP_HDCP_REG_RMLCTL: c_uint = 0x3614;

pub const DW_DP_HDCP_REG_RMLSTS: c_uint = 0x3618;

pub const DW_DP_HDCP_REG_SEED: c_uint = 0x361c;
pub const DW_DP_HDCP_REG_DPK0: c_uint = 0x3620;
pub const DW_DP_HDCP_REG_DPK1: c_uint = 0x3624;
pub const DW_DP_HDCP22_GPIOSTS: c_uint = 0x3628;
pub const DW_DP_HDCP22_GPIOCHNGSTS: c_uint = 0x362c;
pub const DW_DP_HDCP_REG_DPK_CRC: c_uint = 0x3630;

pub const SDP_REG_BANK_SIZE: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw_dp_link_caps {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw_dp_link_train_set {
    pub voltage_swing: [c_uint; 4],
    pub pre_emphasis: [c_uint; 4],
    pub voltage_max_reached: [bool; 4],
    pub pre_max_reached: [bool; 4],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw_dp_link_train {
    pub adjust: dw_dp_link_train_set,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw_dp_link {
    pub dpcd: [u8; DP_RECEIVER_CAP_SIZE],
    pub revision: c_uchar,
    pub rate: c_uint,
    pub lanes: c_uint,
    pub sink_count: u8,
    pub vsc_sdp_supported: u8,
    pub caps: dw_dp_link_caps,
    pub train: dw_dp_link_train,
    pub desc: drm_dp_desc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw_dp_bridge_state {
    pub base: drm_bridge_state,
    pub mode: drm_display_mode,
    pub video_mapping: u8,
    pub color_format: u8,
    pub bpc: u8,
    pub bpp: u8,
}
...
pub struct dw_dp {
    ...
    pub hdcp_clk: *mut clk,
    pub rstc: *mut reset_control,
    pub complete: completion,
    pub irq: c_int,
    pub hpd_work: work_struct,
    pub hotplug: dw_dp_hotplug,
// Serialize hpd status access
    pub irq_lock: mutex,
    pub aux: drm_dp_aux,
    pub link: dw_dp_link,
    pub plat_data: dw_dp_plat_data,
    pub pixel_mode: u8,
    pub SDP_REG_BANK_SIZE): DECLARE_BITMAP(sdp_reg_bank,,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw_dp_output_format {
    pub bus_format: u32,
    pub color_format: enum drm_output_color_format,
    pub video_mapping: u8,
    pub bpc: u8,
    pub bpp: u8,
}
...
#[no_mangle]
pub unsafe extern "C" fn dw_dp_phy_set_pattern(dp: *mut dw_dp, pattern: u32) {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_phy_xmit_enable(dp: *mut dw_dp, lanes: u32) {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_hpd_detect(dp: *mut dw_dp) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_caps_reset(caps: *mut dw_dp_link_caps) {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_reset(link: *mut dw_dp_link) {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_parse(dp: *mut dw_dp, connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_configure(dp: *mut dw_dp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_train_init(train: *mut dw_dp_link_train) {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_train_valid(train: *const dw_dp_link_train) -> bool {
    static bool dw_dp_link_train_valid(const struct dw_dp_link_train *train)
    {
    return train.clock_recovered && train.channel_equalized;
    }
#[no_mangle]
unsafe extern "C" fn dw_dp_link_train_set_pattern(dp: *mut dw_dp, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_voltage_max(preemph: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_clock_recovery(dp: *mut dw_dp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_channel_equalization(dp: *mut dw_dp) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: link->caps.tps3_supported) -> else {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_downgrade(dp: *mut dw_dp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_train_full(dp: *mut dw_dp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_train_fast(dp: *mut dw_dp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_train(dp: *mut dw_dp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_send_sdp(dp: *mut dw_dp, sdp: *mut dw_dp_sdp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_send_vsc_sdp(dp: *mut dw_dp) -> c_int {
    static int dw_dp_send_vsc_sdp(struct dw_dp *dp)
    {
    struct dw_dp_bridge_state *state;
    let mut sdp: dw_dp_sdp = {};
    let mut vsc: drm_dp_vsc_sdp = {};
    state = dw_dp_get_bridge_state(dp);
    if (!state)
    return -EINVAL;
    vsc.bpc = state.bpc;
...
#[no_mangle]
unsafe extern "C" fn dw_dp_video_set_pixel_mode(dp: *mut dw_dp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_video_need_vsc_sdp(dp: *mut dw_dp) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_video_disable(dp: *mut dw_dp) {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_video_enable(dp: *mut dw_dp) -> c_int {
...
// Configure DW_DP_VIDEO_CONFIG5 register
    ...
    init_threshold = 32;
#[no_mangle]
pub unsafe extern "C" fn if(DRM_OUTPUT_COLOR_FORMAT_YCBCR420: hblank <= 80 && color_format !=) -> else {
    else if (hblank <= 80 && color_format != DRM_OUTPUT_COLOR_FORMAT_YCBCR420)
    init_threshold = 12;
#[no_mangle]
pub unsafe extern "C" fn if(DRM_OUTPUT_COLOR_FORMAT_YCBCR420: hblank <= 40 && color_format ==) -> else {
    else if (hblank <= 40 && color_format == DRM_OUTPUT_COLOR_FORMAT_YCBCR420)
    init_threshold = 3;
    else
    init_threshold = 16;
    } else {
    let mut t1: u32 = 0, t2 = 0, t3 = 0;
    switch (bpc) {
    case 6:
...
#[no_mangle]
unsafe extern "C" fn dw_dp_hpd_init(dp: *mut dw_dp) {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_aux_init(dp: *mut dw_dp) {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_init_hw(dp: *mut dw_dp) {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_aux_write_data(dp: *mut dw_dp, buffer: *const u8, size: usize) -> c_int {
    static int dw_dp_aux_write_data(struct dw_dp *dp, const u8 *buffer, size_t size)
    {
    size_t i, j;
    for (i = 0; i < DIV_ROUND_UP(size, 4); i++) {
    let mut num: usize = min_t(size_t, size - i * 4, 4);
    let mut value: u32 = 0;
    for (j = 0; j < num; j++)
...
#[no_mangle]
unsafe extern "C" fn dw_dp_aux_read_data(dp: *mut dw_dp, buffer: *mut u8, size: usize) -> c_int {
    ...
    let mut timeout: c_ulong = msecs_to_jiffies(10);
    u32 status, value;
    let mut ret: isize = 0;
    ...
    let mut count: usize = FIELD_GET(AUX_BYTES_READ, value) - 1;
    if (count != msg.size)
    return -EBUSY;
...
//
    ...
    struct drm_display_mode *mode;
    let mut min_hbp: c_int = 16;
    let mut min_hsync: c_int = 9;
    ...
    min_bpp = 12;
#[no_mangle]
pub unsafe extern "C" fn if(BIT(DRM_OUTPUT_COLOR_FORMAT_YCBCR422): info->color_formats &) -> else {
    else if (info.color_formats & BIT(DRM_OUTPUT_COLOR_FORMAT_YCBCR422))
    min_bpp = 16;
#[no_mangle]
pub unsafe extern "C" fn if(BIT(DRM_OUTPUT_COLOR_FORMAT_RGB444): info->color_formats &) -> else {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_needs_link_retrain(dp: *mut dw_dp) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_disable(dp: *mut dw_dp) {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_enable(dp: *mut dw_dp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_reset(dp: *mut dw_dp) {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_hpd_detect_link(dp: *mut dw_dp, connector: *mut drm_connector) -> bool {
    ...
    let mut mode: drm_display_mode = crtc_state.mode;
    const struct dw_dp_output_format *fmt;
    u32 i, j = 0;
    u32 *output_fmts;
// num_output_fmts = 0;
...
#[no_mangle]
unsafe extern "C" fn dw_dp_link_retrain(dp: *mut dw_dp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_hpd_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_handle_hpd_event(dp: *mut dw_dp) {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dw_dp_phy_exit(data: *mut c_void) {
    ...
    dp.phy = devm_of_phy_get(dev, dev.of_node, core::ptr::null_mut());
    if (IS_ERR(dp.phy)) {
    ...
    dp.rstc = devm_reset_control_get(dev, core::ptr::null_mut());
    if (IS_ERR(dp.rstc)) {
    ...
    ret = drm_bridge_attach(encoder, bridge, core::ptr::null_mut(), DRM_BRIDGE_ATTACH_NO_CONNECTOR);
    if (ret) {
    ...
    ret = devm_request_threaded_irq(dev, dp.irq, core::ptr::null_mut(), dw_dp_irq,
...
#[no_mangle]
pub unsafe extern "C" fn dw_dp_unbind(dp: *mut dw_dp) {
