...
//! Source: drivers/gpu/drm/bridge/ti-sn65dsi83.c
#![no_std]
...
pub const REG_RC_RESET: c_uint = 0x09;

pub const REG_RC_LVDS_PLL: c_uint = 0x0a;

pub const REG_RC_DSI_CLK: c_uint = 0x0b;

pub const REG_RC_PLL_EN: c_uint = 0x0d;

// DSI registers
pub const REG_DSI_LANE: c_uint = 0x10;

pub const REG_DSI_EQ: c_uint = 0x11;

pub const REG_DSI_CLK: c_uint = 0x12;

// LVDS registers
pub const REG_LVDS_FMT: c_uint = 0x18;

pub const REG_LVDS_VCOM: c_uint = 0x19;

pub const REG_LVDS_LANE: c_uint = 0x1a;

pub const REG_LVDS_CM: c_uint = 0x1b;

// Video registers
pub const REG_VID_CHA_ACTIVE_LINE_LENGTH_LOW: c_uint = 0x20;
pub const REG_VID_CHA_ACTIVE_LINE_LENGTH_HIGH: c_uint = 0x21;
pub const REG_VID_CHA_VERTICAL_DISPLAY_SIZE_LOW: c_uint = 0x24;
pub const REG_VID_CHA_VERTICAL_DISPLAY_SIZE_HIGH: c_uint = 0x25;
pub const REG_VID_CHA_SYNC_DELAY_LOW: c_uint = 0x28;
pub const REG_VID_CHA_SYNC_DELAY_HIGH: c_uint = 0x29;
pub const REG_VID_CHA_HSYNC_PULSE_WIDTH_LOW: c_uint = 0x2c;
pub const REG_VID_CHA_HSYNC_PULSE_WIDTH_HIGH: c_uint = 0x2d;
pub const REG_VID_CHA_VSYNC_PULSE_WIDTH_LOW: c_uint = 0x30;
pub const REG_VID_CHA_VSYNC_PULSE_WIDTH_HIGH: c_uint = 0x31;
pub const REG_VID_CHA_HORIZONTAL_BACK_PORCH: c_uint = 0x34;
pub const REG_VID_CHA_VERTICAL_BACK_PORCH: c_uint = 0x36;
pub const REG_VID_CHA_HORIZONTAL_FRONT_PORCH: c_uint = 0x38;
pub const REG_VID_CHA_VERTICAL_FRONT_PORCH: c_uint = 0x3a;
pub const REG_VID_CHA_TEST_PATTERN: c_uint = 0x3c;

// IRQ registers
pub const REG_IRQ_GLOBAL: c_uint = 0xe0;

pub const REG_IRQ_EN: c_uint = 0xe1;

pub const REG_IRQ_STAT: c_uint = 0xe5;
...
pub struct sn65dsi83 {
    ...
    pub lvds_dual_link_even_odd_swap: bool,
    pub lvds_vod_swing_conf: [c_int; 2],
    pub lvds_term_conf: [c_int; 2],
    pub irq: c_int,
...
#[no_mangle]
unsafe extern "C" fn sn65dsi83_detach(bridge: *mut drm_bridge) {
    static void sn65dsi83_detach(struct drm_bridge *bridge)
    {
    struct sn65dsi83 *ctx = bridge_to_sn65dsi83(bridge);
    if (!ctx.dsi)
    return;
    ctx.dsi = core::ptr::null_mut();
    }
...
// as follows:
//
    let mut mode_clock: c_int = mode.clock;
...
#[no_mangle]
unsafe extern "C" fn sn65dsi83_get_dsi_div(ctx: *mut sn65dsi83) -> u8 {
    static u8 sn65dsi83_get_dsi_div(struct sn65dsi83 *ctx)
    {
// The divider is (DSI_CLK / LVDS_CLK) - 1, which really is:
    let mut dsi_div: c_uint = mipi_dsi_pixel_format_to_bpp(ctx.dsi.format);
...
#[no_mangle]
unsafe extern "C" fn sn65dsi83_reset_pipe(sn65dsi83: *mut sn65dsi83) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sn65dsi83_reset_work(ws: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sn65dsi83_handle_errors(ctx: *mut sn65dsi83) {
...
#[no_mangle]
unsafe extern "C" fn sn65dsi83_monitor_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sn65dsi83_monitor_start(ctx: *mut sn65dsi83) {
    static void sn65dsi83_monitor_start(struct sn65dsi83 *ctx)
    {
    schedule_delayed_work(&ctx.monitor_work, msecs_to_jiffies(1000));
    }
#[no_mangle]
unsafe extern "C" fn sn65dsi83_monitor_stop(ctx: *mut sn65dsi83) {
...
//
#[no_mangle]
unsafe extern "C" fn sn65dsi83_release_resources(data: *mut c_void) {
...
// Put the chip in reset, pull EN line low, and assure 10ms reset low timing.
    ...
    {
    struct sn65dsi83 *ctx = bridge_to_sn65dsi83(bridge);
    let mut dual_factor: c_uint = ctx.lvds_dual_link ? 2 : 1;
    const struct drm_bridge_state *bridge_state;
    const struct drm_crtc_state *crtc_state;
    const struct drm_display_mode *mode;
    struct drm_connector *connector;
    struct drm_crtc *crtc;
    let mut test_pattern: bool = sn65dsi83_test_pattern;
...
#[no_mangle]
unsafe extern "C" fn sn65dsi83_parse_lvds_endpoint(ctx: *mut sn65dsi83, channel: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(200: lvds_term ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn sn65dsi83_parse_dt(ctx: *mut sn65dsi83, model: enum sn65dsi83_model) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sn65dsi83_host_attach(ctx: *mut sn65dsi83) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sn65dsi83_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sn65dsi83_probe(client: *mut i2c_client) -> c_int {
...
// Put the chip in reset, pull EN line low, and assure 10ms reset low timing.
    ...
    if (client.irq) {
    ctx.irq = client.irq;
    ret = devm_request_threaded_irq(ctx.dev, ctx.irq, core::ptr::null_mut(), sn65dsi83_irq,
...
#[no_mangle]
unsafe extern "C" fn sn65dsi83_remove(client: *mut i2c_client) {
