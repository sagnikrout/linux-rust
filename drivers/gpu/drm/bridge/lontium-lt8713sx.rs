...
//! Source: drivers/gpu/drm/bridge/lontium-lt8713sx.c
#![no_std]
...
pub const REG_PAGE_CONTROL: c_uint = 0xff;
pub const LT8713SX_PAGE_SIZE: c_int = 256;
...
// Protects all accesses to registers by stopping the on-chip MCU
    ...
    pub fw_buffer: *mut u8,
    pub main_crc_value: u32,
    pub bank_crc_value: [u32; 17],
    pub bank_num: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_config_parameters(lt8713sx: *mut lt8713sx) {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_wren(lt8713sx: *mut lt8713sx) {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_wrdi(lt8713sx: *mut lt8713sx) {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_fifo_reset(lt8713sx: *mut lt8713sx) {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_disable_sram_write(lt8713sx: *mut lt8713sx) {
    static void lt8713sx_disable_sram_write(struct lt8713sx *lt8713sx)
    {
    regmap_write(lt8713sx.regmap, 0xe055, 0x00);
    }
#[no_mangle]
unsafe extern "C" fn lt8713sx_sram_to_flash(lt8713sx: *mut lt8713sx) {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_i2c_to_sram(lt8713sx: *mut lt8713sx) {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_read_flash_status(lt8713sx: *mut lt8713sx) -> u8 {
    static u8 lt8713sx_read_flash_status(struct lt8713sx *lt8713sx)
    {
    let mut flash_status: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_block_erase(lt8713sx: *mut lt8713sx) {
    static void lt8713sx_block_erase(struct lt8713sx *lt8713sx)
    {
    let mut i: u32 = 0;
    let mut flash_status: u8 = 0;
    let mut blocknum: u8 = 0x00;
    let mut flashaddr: u32 = 0x00;
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_load_main_fw_to_sram(lt8713sx: *mut lt8713sx) {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_load_bank_fw_to_sram(lt8713sx: *mut lt8713sx, addr: u64) {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_write_data(lt8713sx: *mut lt8713sx, data: *const u8, filesize: u64) -> c_int {
    static int lt8713sx_write_data(struct lt8713sx *lt8713sx, const u8 *data, u64 filesize)
    {
    let mut page: c_int = 0, num = 0, i = 0, val;
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_main_upgrade_result(lt8713sx: *mut lt8713sx) {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_bank_upgrade_result(lt8713sx: *mut lt8713sx, banknum: u8) {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_bank_result_check(lt8713sx: *mut lt8713sx) {
    static void lt8713sx_bank_result_check(struct lt8713sx *lt8713sx)
    {
    int i;
    let mut addr: u64 = 0x010000;
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_firmware_upgrade(lt8713sx: *mut lt8713sx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_firmware_update(lt8713sx: *mut lt8713sx) -> c_int {
...
// Validate CRC
    ...
    lt8713sx.fw_buffer = core::ptr::null_mut();
    if (lt8713sx.fw) {
    release_firmware(lt8713sx.fw);
    lt8713sx.fw = core::ptr::null_mut();
    }
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn lt8713sx_reset(lt8713sx: *mut lt8713sx) {
    static void lt8713sx_reset(struct lt8713sx *lt8713sx)
    {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_regulator_enable(lt8713sx: *mut lt8713sx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_gpio_init(lt8713sx: *mut lt8713sx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8713sx_remove(client: *mut i2c_client) {
