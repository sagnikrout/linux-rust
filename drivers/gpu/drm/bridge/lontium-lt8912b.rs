...
//! Source: drivers/gpu/drm/bridge/lontium-lt8912b.c
#![no_std]
...
pub const I2C_MAIN: c_int = 0;
pub const I2C_ADDR_MAIN: c_uint = 0x48;
pub const I2C_CEC_DSI: c_int = 1;
pub const I2C_ADDR_CEC_DSI: c_uint = 0x49;
pub const I2C_MAX_IDX: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lt8912 {
    pub dev: *mut device,
    ...
    pub i2c_client: [*mut i2c_client; I2C_MAX_IDX],
    pub regmap: [*mut regmap; I2C_MAX_IDX],
    pub host_node: *mut device_node,
    pub dsi: *mut mipi_dsi_device,
    pub gp_reset: *mut gpio_desc,
    pub mode: videomode,
    pub supplies: [regulator_bulk_data; 7],
    pub data_lanes: u8,
    pub is_power_on: bool,
}

#[no_mangle]
unsafe extern "C" fn lt8912_write_init_config(lt: *mut lt8912) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_write_mipi_basic_config(lt: *mut lt8912) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_write_dds_config(lt: *mut lt8912) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_write_rxlogicres_config(lt: *mut lt8912) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_write_lvds_config(lt: *mut lt8912) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_init_i2c(lt: *mut lt8912, client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_free_i2c(lt: *mut lt8912) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_hard_power_on(lt: *mut lt8912) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_hard_power_off(lt: *mut lt8912) {
...
#[no_mangle]
unsafe extern "C" fn lt8912_video_setup(lt: *mut lt8912) -> c_int {
    static int lt8912_video_setup(struct lt8912 *lt)
    {
    u32 hactive, h_total, hpw, hfp, hbp;
    u32 vactive, v_total, vpw, vfp, vbp;
    let mut settle: u8 = 0x08;
    ...
    settle = 0x04;
#[no_mangle]
pub unsafe extern "C" fn if(1080: vactive ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn lt8912_soft_power_on(lt: *mut lt8912) -> c_int {
    static int lt8912_soft_power_on(struct lt8912 *lt)
    {
    if (!lt.is_power_on) {
    let mut lanes: u32 = lt.data_lanes;
...
#[no_mangle]
unsafe extern "C" fn lt8912_video_on(lt: *mut lt8912) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_check_cable_status(lt: *mut lt8912) -> enum drm_connector_status {
...
#[no_mangle]
unsafe extern "C" fn lt8912_connector_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_attach_dsi(lt: *mut lt8912) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_bridge_hpd_cb(data: *mut c_void, status: enum drm_connector_status) {
...
#[no_mangle]
unsafe extern "C" fn lt8912_bridge_connector_init(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_bridge_detach(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn lt8912_bridge_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_bridge_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_get_regulators(lt: *mut lt8912) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_parse_dt(lt: *mut lt8912) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_put_dt(lt: *mut lt8912) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt8912_remove(client: *mut i2c_client) {
