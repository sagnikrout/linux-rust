...
//! Source: drivers/gpu/drm/bridge/adv7511/adv7533.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn adv7533_dsi_config_timing_gen(adv: *mut adv7511) {
...
#[no_mangle]
pub unsafe extern "C" fn adv7533_dsi_power_on(adv: *mut adv7511) {
...
#[no_mangle]
pub unsafe extern "C" fn adv7533_dsi_power_off(adv: *mut adv7511) {
...
// disable internal timing generator
    ...
    {
    struct mipi_dsi_device *dsi = adv.dsi;
    let mut bpp: u8 = mipi_dsi_pixel_format_to_bpp(dsi.format);
...
#[no_mangle]
pub unsafe extern "C" fn adv7533_patch_registers(adv: *mut adv7511) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adv7533_patch_cec_registers(adv: *mut adv7511) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adv7533_attach_dsi(adv: *mut adv7511) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adv7533_parse_dt(np: *mut device_node, adv: *mut adv7511) -> c_int {
