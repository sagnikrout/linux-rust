...
//! Source: drivers/gpu/drm/bridge/adv7511/adv7511_drv.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn adv7511_register_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn adv7511_packet_enable(adv7511: *mut adv7511, packet: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7511_packet_disable(adv7511: *mut adv7511, packet: c_uint) -> c_int {
...
// TODO Support input ID 6
    ...
    ? 5 : 0;
#[no_mangle]
pub unsafe extern "C" fn if(ADV7511_INPUT_CLOCK_DDR: config->input_clock ==) -> else {
    else if (config.input_clock == ADV7511_INPUT_CLOCK_DDR)
    input_id = config.embedded_sync ? 8 : 7;
#[no_mangle]
pub unsafe extern "C" fn if(ADV7511_INPUT_CLOCK_2X: config->input_clock ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn __adv7511_power_on(adv7511: *mut adv7511) {
...
#[no_mangle]
unsafe extern "C" fn adv7511_power_on(adv7511: *mut adv7511) {
...
#[no_mangle]
unsafe extern "C" fn __adv7511_power_off(adv7511: *mut adv7511) {
...
#[no_mangle]
unsafe extern "C" fn adv7511_power_off(adv7511: *mut adv7511) {
...
//
#[no_mangle]
unsafe extern "C" fn adv7511_hpd(adv7511: *mut adv7511) -> bool {
...
#[no_mangle]
unsafe extern "C" fn adv7511_hpd_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ADV7511_STATUS_HPD: val &) -> else {
...
#[no_mangle]
unsafe extern "C" fn adv7511_irq_process(adv7511: *mut adv7511, process_hpd: bool) -> c_int {
    static int adv7511_irq_process(struct adv7511 *adv7511, bool process_hpd)
    {
    unsigned int irq0, irq1;
    int ret;
    let mut cec_status: c_int = IRQ_NONE;
...
#[no_mangle]
unsafe extern "C" fn adv7511_irq_handler(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn adv7511_wait_for_edid(adv7511: *mut adv7511, timeout: c_int) -> c_int {
...
// Renable HPD sensing
    ...
    let mut hsync_polarity: c_uint = 0;
    let mut vsync_polarity: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(25: drm_mode_vrefresh(adj_mode) <=) -> else {
    else if (drm_mode_vrefresh(adj_mode) <= 25)
    low_refresh_rate = ADV7511_LOW_REFRESH_RATE_25HZ;
#[no_mangle]
pub unsafe extern "C" fn if(30: drm_mode_vrefresh(adj_mode) <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn adv7511_connector_init(adv: *mut adv7511) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7511_bridge_hdmi_clear_audio_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7511_bridge_hdmi_clear_avi_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7511_bridge_hdmi_clear_spd_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7511_bridge_hdmi_clear_hdmi_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7511_init_regulators(adv: *mut adv7511) -> c_int {
    static int adv7511_init_regulators(struct adv7511 *adv)
    {
    const char * const *supply_names = adv.info.supply_names;
    let mut num_supplies: c_uint = adv.info.num_supplies;
...
#[no_mangle]
unsafe extern "C" fn adv7511_uninit_regulators(adv: *mut adv7511) {
    static void adv7511_uninit_regulators(struct adv7511 *adv)
    {
    regulator_bulk_disable(adv.info.num_supplies, adv.supplies);
    }
#[no_mangle]
unsafe extern "C" fn adv7511_cec_register_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn adv7511_init_cec_regmap(adv: *mut adv7511) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "yuv422")) -> else {
    else if (!strcmp(str, "yuv422"))
    config.input_colorspace = HDMI_COLORSPACE_YUV422;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "yuv444")) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "2x")) -> else {
    else if (!strcmp(str, "2x"))
    config.input_clock = ADV7511_INPUT_CLOCK_2X;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "ddr")) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "evenly")) -> else {
    else if (!strcmp(str, "evenly"))
    config.input_justification =
    ADV7511_INPUT_JUSTIFICATION_EVENLY;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "right")) -> else {
...
#[no_mangle]
unsafe extern "C" fn adv7511_probe(i2c: *mut i2c_client) -> c_int {
    ...
    adv7511.bridge.next_bridge = core::ptr::null_mut();
    else
...
//
    ...
    ret = devm_request_threaded_irq(dev, i2c.irq, core::ptr::null_mut(),
    adv7511_irq_handler,
...
#[no_mangle]
unsafe extern "C" fn adv7511_remove(i2c: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn adv7511_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn adv7511_exit() -> void __exit {
