...
//! Source: drivers/gpu/drm/bridge/sii902x.c
#![no_std]
...
pub const SII902X_TPI_VIDEO_DATA: c_uint = 0x0;
pub const SII902X_TPI_PIXEL_REPETITION: c_uint = 0x8;

pub const SII902X_TPI_AVI_PIXEL_REP_4X: c_int = 3;
pub const SII902X_TPI_AVI_PIXEL_REP_2X: c_int = 1;
pub const SII902X_TPI_AVI_PIXEL_REP_NONE: c_int = 0;

pub const SII902X_TPI_AVI_IN_FORMAT: c_uint = 0x9;

pub const SII902X_TPI_AVI_INFOFRAME: c_uint = 0x0c;
pub const SII902X_SYS_CTRL_DATA: c_uint = 0x1a;

pub const SII902X_SYS_CTRL_OUTPUT_HDMI: c_int = 1;
pub const SII902X_SYS_CTRL_OUTPUT_DVI: c_int = 0;

pub const SII902X_PWR_STATE_CTRL: c_uint = 0x1e;

// Audio
pub const SII902X_TPI_I2S_ENABLE_MAPPING_REG: c_uint = 0x1f;

pub const SII902X_TPI_I2S_INPUT_CONFIG_REG: c_uint = 0x20;

pub const SII902X_TPI_I2S_STRM_HDR_BASE: c_uint = 0x21;
pub const SII902X_TPI_I2S_STRM_HDR_SIZE: c_int = 5;
pub const SII902X_TPI_AUDIO_CONFIG_BYTE2_REG: c_uint = 0x26;

pub const SII902X_TPI_AUDIO_CONFIG_BYTE3_REG: c_uint = 0x27;

pub const SII902X_TPI_AUDIO_CONFIG_BYTE4_REG: c_uint = 0x28;
pub const SII902X_INT_ENABLE: c_uint = 0x3c;
pub const SII902X_INT_STATUS: c_uint = 0x3d;

pub const SII902X_REG_TPI_RQB: c_uint = 0xc7;
// Indirect internal register access
pub const SII902X_IND_SET_PAGE: c_uint = 0xbc;
pub const SII902X_IND_OFFSET: c_uint = 0xbd;
pub const SII902X_IND_VALUE: c_uint = 0xbe;
pub const SII902X_TPI_MISC_INFOFRAME_BASE: c_uint = 0xbf;
pub const SII902X_TPI_MISC_INFOFRAME_END: c_uint = 0xde;

    (SII902X_TPI_MISC_INFOFRAME_END - SII902X_TPI_MISC_INFOFRAME_BASE)
pub const SII902X_I2C_BUS_ACQUISITION_TIMEOUT_MS: c_int = 500;
pub const SII902X_AUDIO_PORT_INDEX: c_int = 3;
//
// The maximum resolution supported by the HDMI bridge is 1080p@60Hz
// and 1920x1200 requiring a pixel clock of 165MHz and the minimum
// resolution supported is 480p@60Hz requiring a pixel clock of 25MHz
//
pub const SII902X_MIN_PIXEL_CLOCK_KHZ: c_int = 25000;
pub const SII902X_MAX_PIXEL_CLOCK_KHZ: c_int = 165000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sii902x {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sii902x_audio {
    pub pdev: *mut platform_device,
    pub mclk: *mut clk,
    pub i2s_fifo_sequence: [u32; 4],
    pub audio: },
}

#[no_mangle]
unsafe extern "C" fn sii902x_read_unlocked(i2c: *mut i2c_client, reg: u8, val: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sii902x_write_unlocked(i2c: *mut i2c_client, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sii902x_reset(sii902x: *mut sii902x) {
...
#[no_mangle]
unsafe extern "C" fn sii902x_detect(sii902x: *mut sii902x) -> enum drm_connector_status {
...
#[no_mangle]
unsafe extern "C" fn sii902x_get_modes(connector: *mut drm_connector) -> c_int {
    ...
    struct sii902x *sii902x = bridge_to_sii902x(bridge);
    struct drm_connector *connector;
    let mut output_mode: u8 = SII902X_SYS_CTRL_OUTPUT_DVI;
    ...
    let mut pixel_clock_10kHz: u16 = adj.clock / 10;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sii902x_mute(sii902x: *mut sii902x, mute: bool) -> c_int {
    ...
    unsigned int mclk)
    {
    let mut div: c_int = mclk / rate;
    let mut distance: c_int = 100000;
    u8 i, nearest = 0;
    for (i = 0; i < ARRAY_SIZE(sii902x_mclk_div_table); i++) {
    let mut d: c_uint = abs(div - sii902x_mclk_div_table[i]);
    if (d >= distance)
    continue;
    nearest = i;
    distance = d;
...
#[no_mangle]
unsafe extern "C" fn sii902x_audio_shutdown(dev: *mut device, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sii902x_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn sii902x_i2c_bypass_select(mux: *mut i2c_mux_core, chan_id: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sii902x_i2c_bypass_deselect(mux: *mut i2c_mux_core, chan_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sii902x_init(sii902x: *mut sii902x) -> c_int {
...
// Clear all pending interrupts
    ...
    ret = devm_request_threaded_irq(dev, sii902x.i2c.irq, core::ptr::null_mut(),
    sii902x_interrupt,
...
#[no_mangle]
unsafe extern "C" fn sii902x_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sii902x_remove(client: *mut i2c_client) {
