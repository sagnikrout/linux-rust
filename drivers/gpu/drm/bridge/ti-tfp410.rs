...
//! Source: drivers/gpu/drm/bridge/ti-tfp410.c
#![no_std]
...
pub struct tfp410 {
    ...
    pub timings: drm_bridge_timings,
    pub dev: *mut device,
}
...
#[no_mangle]
unsafe extern "C" fn tfp410_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tfp410_hpd_work_func(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tfp410_hpd_callback(arg: *mut c_void, status: enum drm_connector_status) {
...
#[no_mangle]
unsafe extern "C" fn tfp410_detach(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn tfp410_parse_timings(dvi: *mut tfp410, i2c: bool) -> c_int {
    static int tfp410_parse_timings(struct tfp410 *dvi, bool i2c)
    {
    struct drm_bridge_timings *timings = &dvi.timings;
    struct device_node *ep;
    let mut pclk_sample: u32 = 0;
    let mut bus_width: u32 = 24;
    let mut deskew: u32 = 0;
// Start with defaults.
...
#[no_mangle]
unsafe extern "C" fn tfp410_init(dev: *mut device, i2c: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tfp410_fini(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn tfp410_probe(pdev: *mut platform_device) -> c_int {
    static int tfp410_probe(struct platform_device *pdev)
    {
    return tfp410_init(&pdev.dev, false);
    }
#[no_mangle]
unsafe extern "C" fn tfp410_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tfp410_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tfp410_i2c_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn tfp410_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tfp410_module_exit() -> void __exit {
