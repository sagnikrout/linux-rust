...
//! Source: drivers/gpu/drm/bridge/lvds-codec.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lvds_codec_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lvds_codec_remove(pdev: *mut platform_device) {
