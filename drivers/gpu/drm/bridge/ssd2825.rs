...
//! Source: drivers/gpu/drm/bridge/ssd2825.c
#![no_std]
...
pub const SSD2825_DEVICE_ID_REG: c_uint = 0xb0;
pub const SSD2825_RGB_INTERFACE_CTRL_REG_1: c_uint = 0xb1;
pub const SSD2825_RGB_INTERFACE_CTRL_REG_2: c_uint = 0xb2;
pub const SSD2825_RGB_INTERFACE_CTRL_REG_3: c_uint = 0xb3;
pub const SSD2825_RGB_INTERFACE_CTRL_REG_4: c_uint = 0xb4;
pub const SSD2825_RGB_INTERFACE_CTRL_REG_5: c_uint = 0xb5;
pub const SSD2825_RGB_INTERFACE_CTRL_REG_6: c_uint = 0xb6;

pub const SSD2825_CONFIGURATION_REG: c_uint = 0xb7;

pub const SSD2825_VC_CTRL_REG: c_uint = 0xb8;
pub const SSD2825_PLL_CTRL_REG: c_uint = 0xb9;
pub const SSD2825_PLL_CONFIGURATION_REG: c_uint = 0xba;
pub const SSD2825_CLOCK_CTRL_REG: c_uint = 0xbb;
pub const SSD2825_PACKET_SIZE_CTRL_REG_1: c_uint = 0xbc;
pub const SSD2825_PACKET_SIZE_CTRL_REG_2: c_uint = 0xbd;
pub const SSD2825_PACKET_SIZE_CTRL_REG_3: c_uint = 0xbe;
pub const SSD2825_PACKET_DROP_REG: c_uint = 0xbf;
pub const SSD2825_OPERATION_CTRL_REG: c_uint = 0xc0;
pub const SSD2825_MAX_RETURN_SIZE_REG: c_uint = 0xc1;
pub const SSD2825_RETURN_DATA_COUNT_REG: c_uint = 0xc2;
pub const SSD2825_ACK_RESPONSE_REG: c_uint = 0xc3;
pub const SSD2825_LINE_CTRL_REG: c_uint = 0xc4;
pub const SSD2825_INTERRUPT_CTRL_REG: c_uint = 0xc5;
pub const SSD2825_INTERRUPT_STATUS_REG: c_uint = 0xc6;
pub const SSD2825_ERROR_STATUS_REG: c_uint = 0xc7;
pub const SSD2825_DATA_FORMAT_REG: c_uint = 0xc8;
pub const SSD2825_DELAY_ADJ_REG_1: c_uint = 0xc9;
pub const SSD2825_DELAY_ADJ_REG_2: c_uint = 0xca;
pub const SSD2825_DELAY_ADJ_REG_3: c_uint = 0xcb;
pub const SSD2825_DELAY_ADJ_REG_4: c_uint = 0xcc;
pub const SSD2825_DELAY_ADJ_REG_5: c_uint = 0xcd;
pub const SSD2825_DELAY_ADJ_REG_6: c_uint = 0xce;
pub const SSD2825_HS_TX_TIMER_REG_1: c_uint = 0xcf;
pub const SSD2825_HS_TX_TIMER_REG_2: c_uint = 0xd0;
pub const SSD2825_LP_RX_TIMER_REG_1: c_uint = 0xd1;
pub const SSD2825_LP_RX_TIMER_REG_2: c_uint = 0xd2;
pub const SSD2825_TE_STATUS_REG: c_uint = 0xd3;
pub const SSD2825_SPI_READ_REG: c_uint = 0xd4;
pub const SSD2825_SPI_READ_REG_RESET: c_uint = 0xfa;
pub const SSD2825_PLL_LOCK_REG: c_uint = 0xd5;
pub const SSD2825_TEST_REG: c_uint = 0xd6;
pub const SSD2825_TE_COUNT_REG: c_uint = 0xd7;
pub const SSD2825_ANALOG_CTRL_REG_1: c_uint = 0xd8;
pub const SSD2825_ANALOG_CTRL_REG_2: c_uint = 0xd9;
pub const SSD2825_ANALOG_CTRL_REG_3: c_uint = 0xda;
pub const SSD2825_ANALOG_CTRL_REG_4: c_uint = 0xdb;
pub const SSD2825_INTERRUPT_OUT_CTRL_REG: c_uint = 0xdc;
pub const SSD2825_RGB_INTERFACE_CTRL_REG_7: c_uint = 0xdd;
pub const SSD2825_LANE_CONFIGURATION_REG: c_uint = 0xde;
pub const SSD2825_DELAY_ADJ_REG_7: c_uint = 0xdf;
pub const SSD2825_INPUT_PIN_CTRL_REG_1: c_uint = 0xe0;
pub const SSD2825_INPUT_PIN_CTRL_REG_2: c_uint = 0xe1;
pub const SSD2825_BIDIR_PIN_CTRL_REG_1: c_uint = 0xe2;
pub const SSD2825_BIDIR_PIN_CTRL_REG_2: c_uint = 0xe3;
pub const SSD2825_BIDIR_PIN_CTRL_REG_3: c_uint = 0xe4;
pub const SSD2825_BIDIR_PIN_CTRL_REG_4: c_uint = 0xe5;
pub const SSD2825_BIDIR_PIN_CTRL_REG_5: c_uint = 0xe6;
pub const SSD2825_BIDIR_PIN_CTRL_REG_6: c_uint = 0xe7;
pub const SSD2825_BIDIR_PIN_CTRL_REG_7: c_uint = 0xe8;
pub const SSD2825_CABC_BRIGHTNESS_CTRL_REG_1: c_uint = 0xe9;
pub const SSD2825_CABC_BRIGHTNESS_CTRL_REG_2: c_uint = 0xea;
pub const SSD2825_CABC_BRIGHTNESS_STATUS_REG: c_uint = 0xeb;
pub const SSD2825_READ_REG: c_uint = 0xff;
pub const SSD2825_COM_BYTE: c_uint = 0x00;
pub const SSD2825_DAT_BYTE: c_uint = 0x01;
...
pub struct ssd2825_priv {
    ...
    pub output: ssd2825_dsi_output,
    pub /: *mut *mut mutex mlock; / for host transfer operations,
    pub /: *mut *mut u32 pd_lines; / number of Parallel Port Input Data Lines,
    pub /: *mut *mut u32 dsi_lanes; / number of DSI Lanes,
// Parameters for PLL programming
    pub /: *mut *mut u32 pll_freq_kbps; / PLL in kbps,
    pub /: *mut *mut u32 nibble_freq_khz; / PLL div by 4,
    pub ns*/: *mut *mut u32 hzd; / HS Zero Delay in,
    pub /: *mut *mut u32 hpd; / HS Prepare Delay is ns,
}
...
#[no_mangle]
unsafe extern "C" fn ssd2825_write_raw(priv: *mut ssd2825_priv, high_byte: u8, low_byte: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssd2825_write_reg(priv: *mut ssd2825_priv, reg: u8, command: u16) -> c_int {
    static int ssd2825_write_reg(struct ssd2825_priv *priv, u8 reg, u16 command)
    {
    let mut datal: u8 = (command & 0x00FF);
    let mut datah: u8 = (command & 0xFF00) >> 8;
    int ret;
// Command write cycle
...
#[no_mangle]
unsafe extern "C" fn ssd2825_write_dsi(priv: *mut ssd2825_priv, command: *const u8, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssd2825_read_raw(priv: *mut ssd2825_priv, cmd: u8, data: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssd2825_read_reg(priv: *mut ssd2825_priv, reg: u8, data: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssd2825_dsi_host_attach(host: *mut mipi_dsi_host, dev: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssd2825_dsi_host_detach(host: *mut mipi_dsi_host, dev: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssd2825_hw_reset(priv: *mut ssd2825_priv) {
...
//
    ...
    {
    let mut div_factor: u32 = 1, mul_factor, fr = 0;
    ...
    fr = 3;
#[no_mangle]
pub unsafe extern "C" fn if(251000: priv->pll_freq_kbps >=) -> else {
    else if (priv.pll_freq_kbps >= 251000)
    fr = 2;
#[no_mangle]
pub unsafe extern "C" fn if(126000: priv->pll_freq_kbps >=) -> else {
...
// Enable PLL
    ...
    let mut input_bus_flags: u32 = bridge.timings.input_bus_flags;
    let mut flags: u16 = 0, config;
    u8 pixel_format;
    int ret;
// Power Sequence
...
#[no_mangle]
unsafe extern "C" fn ssd2825_probe(spi: *mut spi_device) -> c_int {
...
// Driver supports only 8 bit 3 Wire mode
    ...
    priv.tx_clk = devm_clk_get_optional(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ssd2825_remove(spi: *mut spi_device) {
