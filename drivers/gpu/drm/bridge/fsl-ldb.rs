...
//! Source: drivers/gpu/drm/bridge/fsl-ldb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_ldb_devdata {
    pub ldb_ctrl: u32,
    pub lvds_ctrl: u32,
    pub lvds_en_bit: bool,
    pub single_ctrl_reg: bool,
}
...
pub struct fsl_ldb {
    ...
    pub devdata: *const fsl_ldb_devdata,
    pub ch0_enabled: bool,
    pub ch1_enabled: bool,
    pub use_termination_resistor: bool,
}

#[no_mangle]
unsafe extern "C" fn fsl_ldb_is_dual(fsl_ldb: *const fsl_ldb) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fsl_ldb_link_frequency(fsl_ldb: *mut fsl_ldb, clock: c_int) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn fsl_ldb_probe(pdev: *mut platform_device) -> c_int {
...
// Locate the remote ports and the panel node
    ...
    fsl_ldb.ch0_enabled = (remote1 != core::ptr::null_mut());
    fsl_ldb.ch1_enabled = (remote2 != core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn fsl_ldb_remove(pdev: *mut platform_device) {
