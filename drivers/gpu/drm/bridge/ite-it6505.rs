...
//! Source: drivers/gpu/drm/bridge/ite-it6505.c
#![no_std]
...
pub const REG_IC_VER: c_uint = 0x04;
pub const REG_RESET_CTRL: c_uint = 0x05;

pub const INT_STATUS_01: c_uint = 0x06;
pub const INT_MASK_01: c_uint = 0x09;
pub const INT_HPD_CHANGE: c_int = 0;
pub const INT_RECEIVE_HPD_IRQ: c_int = 1;
pub const INT_SCDT_CHANGE: c_int = 2;
pub const INT_HDCP_FAIL: c_int = 3;
pub const INT_HDCP_DONE: c_int = 4;

pub const INT_STATUS_02: c_uint = 0x07;
pub const INT_MASK_02: c_uint = 0x0A;
pub const INT_AUX_CMD_FAIL: c_int = 0;
pub const INT_HDCP_KSV_CHECK: c_int = 1;
pub const INT_AUDIO_FIFO_ERROR: c_int = 2;

pub const INT_STATUS_03: c_uint = 0x08;
pub const INT_MASK_03: c_uint = 0x0B;
pub const INT_LINK_TRAIN_FAIL: c_int = 4;
pub const INT_VID_FIFO_ERROR: c_int = 5;
pub const INT_IO_LATCH_FIFO_OVERFLOW: c_int = 7;

pub const REG_SYSTEM_STS: c_uint = 0x0D;

pub const REG_LINK_TRAIN_STS: c_uint = 0x0E;

pub const REG_BANK_SEL: c_uint = 0x0F;
pub const REG_CLK_CTRL0: c_uint = 0x10;
pub const M_PCLK_DELAY: c_uint = 0x03;
pub const REG_AUX_OPT: c_uint = 0x11;

pub const REG_DATA_CTRL0: c_uint = 0x12;

pub const REG_PCLK_COUNTER_VALUE: c_uint = 0x13;
pub const REG_501_FIFO_CTRL: c_uint = 0x15;

pub const REG_TRAIN_CTRL0: c_uint = 0x16;

pub const LANE_COUNT_MASK: c_uint = 0x06;

pub const REG_TRAIN_CTRL1: c_uint = 0x17;

pub const REG_AUX_CTRL: c_uint = 0x23;

pub const REG_AUX_ADR_0_7: c_uint = 0x24;
pub const REG_AUX_ADR_8_15: c_uint = 0x25;
pub const REG_AUX_ADR_16_19: c_uint = 0x26;
pub const REG_AUX_OUT_DATA0: c_uint = 0x27;
pub const REG_AUX_CMD_REQ: c_uint = 0x2B;
pub const M_AUX_REQ_CMD: c_uint = 0x0F;

pub const REG_AUX_DATA_0_7: c_uint = 0x2C;
pub const REG_AUX_DATA_8_15: c_uint = 0x2D;
pub const REG_AUX_DATA_16_23: c_uint = 0x2E;
pub const REG_AUX_DATA_24_31: c_uint = 0x2F;
pub const REG_AUX_DATA_FIFO: c_uint = 0x2F;
pub const REG_AUX_ERROR_STS: c_uint = 0x9F;
pub const M_AUX_REQ_FAIL: c_uint = 0x03;
pub const REG_HDCP_CTRL1: c_uint = 0x38;

pub const REG_HDCP_TRIGGER: c_uint = 0x39;

pub const REG_HDCP_CTRL2: c_uint = 0x3A;

pub const REG_M0_0_7: c_uint = 0x4C;
pub const REG_AN_0_7: c_uint = 0x4C;
pub const REG_SP_CTRL0: c_uint = 0x58;
pub const REG_IP_CTRL1: c_uint = 0x59;
pub const REG_IP_CTRL2: c_uint = 0x5A;
pub const REG_LINK_DRV: c_uint = 0x5C;

pub const REG_DRV_LN_DATA_SEL: c_uint = 0x5D;
pub const REG_AUX: c_uint = 0x5E;
pub const REG_VID_BUS_CTRL0: c_uint = 0x60;

pub const REG_VID_BUS_CTRL1: c_uint = 0x61;

pub const REG_INPUT_CTRL: c_uint = 0xA0;

pub const REG_INPUT_HTOTAL: c_uint = 0xA1;
pub const REG_INPUT_HACTIVE_START: c_uint = 0xA3;
pub const REG_INPUT_HACTIVE_WIDTH: c_uint = 0xA5;
pub const REG_INPUT_HFRONT_PORCH: c_uint = 0xA7;
pub const REG_INPUT_HSYNC_WIDTH: c_uint = 0xA9;
pub const REG_INPUT_VTOTAL: c_uint = 0xAB;
pub const REG_INPUT_VACTIVE_START: c_uint = 0xAD;
pub const REG_INPUT_VACTIVE_WIDTH: c_uint = 0xAF;
pub const REG_INPUT_VFRONT_PORCH: c_uint = 0xB1;
pub const REG_INPUT_VSYNC_WIDTH: c_uint = 0xB3;
pub const REG_AUDIO_SRC_CTRL: c_uint = 0xB8;
pub const M_AUDIO_I2S_EN: c_uint = 0x0F;

pub const REG_AUDIO_FMT: c_uint = 0xB9;
pub const REG_AUDIO_FIFO_SEL: c_uint = 0xBA;
pub const REG_AUDIO_CTRL0: c_uint = 0xBB;

pub const REG_AUDIO_CTRL1: c_uint = 0xBC;
pub const REG_AUDIO_INPUT_FREQ: c_uint = 0xBE;
pub const REG_IEC958_STS0: c_uint = 0xBF;
pub const REG_IEC958_STS1: c_uint = 0xC0;
pub const REG_IEC958_STS2: c_uint = 0xC1;
pub const REG_IEC958_STS3: c_uint = 0xC2;
pub const REG_IEC958_STS4: c_uint = 0xC3;
pub const REG_HPD_IRQ_TIME: c_uint = 0xC9;
pub const REG_AUX_DEBUG_MODE: c_uint = 0xCA;
pub const REG_AUX_OPT2: c_uint = 0xCB;
pub const REG_HDCP_OPT: c_uint = 0xCE;
pub const REG_USER_DRV_PRE: c_uint = 0xCF;
pub const REG_DATA_MUTE_CTRL: c_uint = 0xD3;

pub const REG_TIME_STMP_CTRL: c_uint = 0xD4;

pub const M_STAMP_STEP: c_uint = 0x30;

pub const REG_INFOFRAME_CTRL: c_uint = 0xE8;

pub const REG_AUDIO_N_0_7: c_uint = 0xDE;
pub const REG_AUDIO_N_8_15: c_uint = 0xDF;
pub const REG_AUDIO_N_16_23: c_uint = 0xE0;
pub const REG_AVI_INFO_DB1: c_uint = 0xE9;
pub const REG_AVI_INFO_DB2: c_uint = 0xEA;
pub const REG_AVI_INFO_DB3: c_uint = 0xEB;
pub const REG_AVI_INFO_DB4: c_uint = 0xEC;
pub const REG_AVI_INFO_DB5: c_uint = 0xED;
pub const REG_AVI_INFO_SUM: c_uint = 0xF6;
pub const REG_AUD_INFOFRAM_DB1: c_uint = 0xF7;
pub const REG_AUD_INFOFRAM_DB2: c_uint = 0xF8;
pub const REG_AUD_INFOFRAM_DB3: c_uint = 0xF9;
pub const REG_AUD_INFOFRAM_DB4: c_uint = 0xFA;
pub const REG_AUD_INFOFRAM_SUM: c_uint = 0xFB;
// the following six registers are in bank1
pub const REG_DRV_0_DB_800_MV: c_uint = 0x17E;
pub const REG_PRE_0_DB_800_MV: c_uint = 0x17F;
pub const REG_PRE_3P5_DB_800_MV: c_uint = 0x181;
pub const REG_SSC_CTRL0: c_uint = 0x188;
pub const REG_SSC_CTRL1: c_uint = 0x189;
pub const REG_SSC_CTRL2: c_uint = 0x18A;
pub const REG_AUX_USER_CTRL: c_uint = 0x190;

pub const REG_AUX_USER_DATA_REC: c_uint = 0x191;
pub const M_AUX_IN_REC: c_uint = 0xF0;
pub const M_AUX_OUT_REC: c_uint = 0x0F;
pub const REG_AUX_USER_REPLY: c_uint = 0x19A;

pub const DPCD_V_1_1: c_uint = 0x11;
pub const MISC_VERB: c_uint = 0xF0;
pub const MISC_VERC: c_uint = 0x70;
pub const I2S_INPUT_FORMAT_STANDARD: c_int = 0;
pub const I2S_INPUT_FORMAT_32BIT: c_int = 1;
pub const I2S_INPUT_LEFT_JUSTIFIED: c_int = 0;
pub const I2S_INPUT_RIGHT_JUSTIFIED: c_int = 1;
pub const I2S_DATA_1T_DELAY: c_int = 0;
pub const I2S_DATA_NO_DELAY: c_int = 1;
pub const I2S_WS_LEFT_CHANNEL: c_int = 0;
pub const I2S_WS_RIGHT_CHANNEL: c_int = 1;
pub const I2S_DATA_MSB_FIRST: c_int = 0;
pub const I2S_DATA_LSB_FIRST: c_int = 1;
pub const WORD_LENGTH_16BIT: c_int = 0;
pub const WORD_LENGTH_18BIT: c_int = 1;
pub const WORD_LENGTH_20BIT: c_int = 2;
pub const WORD_LENGTH_24BIT: c_int = 3;

pub const READ_BUFFER_SIZE: c_int = 400;
// Vendor option
pub const HDCP_DESIRED: c_int = 1;
pub const MAX_LANE_COUNT: c_int = 4;

pub const AUTO_TRAIN_RETRY: c_int = 3;
pub const MAX_HDCP_DOWN_STREAM_COUNT: c_int = 127;
pub const MAX_CR_LEVEL: c_uint = 0x03;
pub const MAX_EQ_LEVEL: c_uint = 0x03;
pub const AUX_WAIT_TIMEOUT_MS: c_int = 15;
pub const AUX_FIFO_MAX_SIZE: c_int = 16;
pub const AUX_I2C_MAX_SIZE: c_int = 4;
pub const AUX_I2C_DEFER_RETRY: c_int = 4;
pub const PIXEL_CLK_DELAY: c_int = 1;
pub const PIXEL_CLK_INVERSE: c_int = 0;
pub const ADJUST_PHASE_THRESHOLD: c_int = 80000;
pub const DPI_PIXEL_CLK_MAX: c_int = 95000;

pub const DEFAULT_PWR_ON: c_int = 0;
pub const DEFAULT_DRV_HOLD: c_int = 0;

pub const AUDIO_CHANNEL_COUNT: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct it6505_platform_data {
    pub pwr18: *mut regulator,
    pub ovdd: *mut regulator,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct it6505_audio_data {
    pub select: enum it6505_audio_select,
    pub sample_rate: enum it6505_audio_sample_rate,
    pub type: enum it6505_audio_type,
    pub word_length: u8,
    pub channel_count: u8,
    pub i2s_input_format: u8,
    pub i2s_justified: u8,
    pub i2s_data_delay: u8,
    pub i2s_ws_channel: u8,
    pub i2s_data_sequence: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct it6505_audio_sample_rate_map {
    pub rate: enum it6505_audio_sample_rate,
    pub sample_rate_value: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct it6505_drm_dp_link {
...
pub struct it6505 {
    ...
    pub dev: *mut device,
    pub link: it6505_drm_dp_link,
    pub pdata: it6505_platform_data,
//
// Mutex protects extcon and interrupt functions from interfering
// each other.
//
    pub extcon_lock: mutex,
    pub /: *mut *mut mutex mode_lock; / used to bridge_detect,
    pub /: *mut *mut mutex aux_lock; / used to aux data transfers,
    pub regmap: *mut regmap,
    pub source_output_mode: drm_display_mode,
    pub video_info: drm_display_mode,
    pub event_nb: notifier_block,
    pub extcon: *mut extcon_dev,
    pub extcon_wq: work_struct,
    pub extcon_state: c_int,
    pub connector_status: enum drm_connector_status,
    pub link_state: enum link_train_status,
    pub link_works: work_struct,
    pub dpcd: [u8; DP_RECEIVER_CAP_SIZE],
    pub lane_count: u8,
    pub link_rate_bw_code: u8,
    pub sink_count: u8,
    pub step_train: bool,
    pub branch_device: bool,
    pub enable_ssc: bool,
    pub lane_swap_disabled: bool,
    pub lane_swap: bool,
    pub powered: bool,
    pub hpd_state: bool,
    pub afe_setting: u32,
    pub max_dpi_pixel_clock: u32,
    pub max_lane_count: u32,
    pub hdcp_status: enum hdcp_state,
    pub hdcp_work: delayed_work,
    pub hdcp_wait_ksv_list: work_struct,
    pub extcon_completion: completion,
    pub auto_train_retry: u8,
    pub hdcp_desired: bool,
    pub is_repeater: bool,
    pub hdcp_down_stream_count: u8,
    pub bksvs: [u8; DRM_HDCP_KSV_LEN],
    pub sha1_input: [u8; HDCP_SHA1_FIFO_LEN],
    pub enable_enhanced_frame: bool,
    pub plugged_cb: hdmi_codec_plugged_cb,
    pub codec_dev: *mut device,
    pub delayed_audio: delayed_work,
    pub audio: it6505_audio_data,
    pub debugfs: *mut dentry,
// it6505 driver hold option
    pub enable_drv_hold: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct it6505_step_train_para {
    pub voltage_swing: [u8; MAX_LANE_COUNT],
    pub pre_emphasis: [u8; MAX_LANE_COUNT],
}
...
#[no_mangle]
unsafe extern "C" fn it6505_read(it6505: *mut it6505, reg_addr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it6505_dpcd_read(it6505: *mut it6505, offset: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it6505_get_dpcd(it6505: *mut it6505, offset: c_int, dpcd: *mut u8, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it6505_dump(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_get_sink_hpd_status(it6505: *mut it6505) -> bool {
...
#[no_mangle]
unsafe extern "C" fn it6505_read_word(it6505: *mut it6505, reg: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it6505_calc_video_info(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_clear_int(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_int_mask_enable(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_int_mask_disable(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_lane_termination_on(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_lane_termination_off(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_lane_power_on(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_lane_power_off(it6505: *mut it6505) {
    static void it6505_lane_power_off(struct it6505 *it6505)
    {
    it6505_set_bits(it6505, REG_LINK_DRV, 0xF0, 0x00);
    }
#[no_mangle]
unsafe extern "C" fn it6505_lane_off(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_aux_termination_on(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_aux_power_on(it6505: *mut it6505) {
    static void it6505_aux_power_on(struct it6505 *it6505)
    {
    it6505_set_bits(it6505, REG_AUX, 0x02, 0x02);
    }
#[no_mangle]
unsafe extern "C" fn it6505_aux_on(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_aux_reset(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_reset_logic(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_aux_op_finished(it6505: *mut it6505) -> bool {
    static bool it6505_aux_op_finished(struct it6505 *it6505)
    {
    let mut reg2b: c_int = it6505_read(it6505, REG_AUX_CMD_REQ);
    if (reg2b < 0)
    return false;
    return (reg2b & AUX_BUSY) == 0;
    }
#[no_mangle]
unsafe extern "C" fn it6505_aux_wait(it6505: *mut it6505) -> c_int {
    ...
    {
    int i, ret;
    let mut aux_write_check: bool = false;
...
#[no_mangle]
unsafe extern "C" fn it6505_aux_i2c_reply_defer(reply: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn it6505_aux_i2c_reply_nack(reply: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn it6505_aux_i2c_wait(it6505: *mut it6505, reply: *mut u8) -> c_int {
...
// reply = it6505_read(it6505, REG_AUX_USER_REPLY) >> 4;
    ...
    err = -EBUSY;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: *mut it6505_aux_i2c_reply_nack(reply)) -> else {
...
#[no_mangle]
unsafe extern "C" fn it6505_aux_i2c_readb(it6505: *mut it6505, buf: *mut u8, size: usize, reply: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it6505_aux_i2c_writeb(it6505: *mut it6505, buf: *mut u8, size: usize, reply: *mut u8) -> c_int {
...
// IIC data transfer
    ...
    struct it6505 *it6505 = container_of(aux, struct it6505, aux);
    u8 cmd;
    let mut is_i2c: bool = !(msg.request & DP_AUX_NATIVE_WRITE);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn it6505_get_ksvlist(it6505: *mut it6505, buf: *mut u8, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it6505_variable_config(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_get_extcon_property(it6505: *mut it6505) {
    ...
    {
    let mut clock: c_int = mode.clock;
...
#[no_mangle]
unsafe extern "C" fn it6505_link_reset_step_train(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_init(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_video_disable(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_video_reset(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_audio_input(it6505: *mut it6505) -> bool {
...
#[no_mangle]
unsafe extern "C" fn it6505_setup_audio_channel_status(it6505: *mut it6505) {
    static void it6505_setup_audio_channel_status(struct it6505 *it6505)
    {
    let mut sample_rate: enum it6505_audio_sample_rate = it6505.audio.sample_rate;
...
#[no_mangle]
unsafe extern "C" fn it6505_setup_audio_format(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_enable_audio_source(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_enable_audio_infoframe(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_disable_audio(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_enable_audio(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_use_step_train_check(it6505: *mut it6505) -> bool {
...
#[no_mangle]
unsafe extern "C" fn it6505_parse_link_capabilities(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_setup_ssc(it6505: *mut it6505) {
...
#[no_mangle]
pub unsafe extern "C" fn it6505_link_rate_setup(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_lane_count_setup(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_link_training_setup(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_link_start_auto_train(it6505: *mut it6505) -> bool {
    static bool it6505_link_start_auto_train(struct it6505 *it6505)
    {
    let mut timeout: c_int = 500, link_training_state;
...
#[no_mangle]
unsafe extern "C" fn it6505_drm_dp_link_configure(it6505: *mut it6505) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it6505_check_voltage_swing_max(lane_voltage_swing_pre_emphasis: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn it6505_check_pre_emphasis_max(lane_voltage_swing_pre_emphasis: u8) -> bool {
...
// lane_voltage_pre_emphasis,
    ...
    {
    let mut loop_count: u8 = 0, i = 0, j;
    u8 link_status[DP_LINK_STATUS_SIZE] = { 0 };
    u8 lane_level_config[MAX_LANE_COUNT] = { 0 };
    let mut pre_emphasis_adjust: c_int = -1, voltage_swing_adjust = -1;
    ...
    struct it6505_step_train_para *lane_voltage_pre_emphasis)
    {
    let mut loop_count: u8 = 0, i, link_status[DP_LINK_STATUS_SIZE] = { 0 };
    u8 lane_level_config[MAX_LANE_COUNT] = { 0 };
    const struct drm_dp_aux *aux = &it6505.aux;
    it6505_dpcd_write(it6505, DP_TRAINING_PATTERN_SET,
...
#[no_mangle]
unsafe extern "C" fn it6505_link_start_step_train(it6505: *mut it6505) -> bool {
...
#[no_mangle]
unsafe extern "C" fn it6505_get_video_status(it6505: *mut it6505) -> bool {
...
#[no_mangle]
unsafe extern "C" fn it6505_reset_hdcp(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_start_hdcp(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_stop_hdcp(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_hdcp_is_ksv_valid(ksv: *mut u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn it6505_hdcp_part1_auth(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_setup_sha1_input(it6505: *mut it6505, sha1_input: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it6505_hdcp_part2_ksvlist_check(it6505: *mut it6505) -> bool {
...
#[no_mangle]
unsafe extern "C" fn it6505_hdcp_wait_ksv_list(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn it6505_hdcp_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn it6505_show_hdcp_info(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_stop_link_train(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_link_train_ok(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_link_step_train_process(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_link_training_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn it6505_plugged_status_to_codec(it6505: *mut it6505) {
    static void it6505_plugged_status_to_codec(struct it6505 *it6505)
    {
    let mut status: enum drm_connector_status = it6505.connector_status;
    if (it6505.plugged_cb && it6505.codec_dev)
    it6505.plugged_cb(it6505.codec_dev,
    status == connector_status_connected);
    }
#[no_mangle]
unsafe extern "C" fn it6505_remove_edid(it6505: *mut it6505) {
    static void it6505_remove_edid(struct it6505 *it6505)
    {
    drm_edid_free(it6505.cached_edid);
    it6505.cached_edid = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn it6505_process_hpd_irq(it6505: *mut it6505) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it6505_irq_hpd(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_irq_hpd_irq(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_irq_scdt(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_irq_hdcp_done(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_irq_hdcp_fail(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_irq_aux_cmd_fail(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_irq_hdcp_ksv_check(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_irq_audio_fifo_error(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_irq_link_train_fail(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_test_bit(bit: c_uint, addr: *const c_uint) -> bool {
    static bool it6505_test_bit(unsigned int bit, const unsigned int *addr)
    {
    return 1 & (addr[bit / BITS_PER_BYTE] >> (bit % BITS_PER_BYTE));
    }
#[no_mangle]
unsafe extern "C" fn it6505_irq_video_handler(it6505: *mut it6505, int_status: *const c_int) {
...
#[no_mangle]
unsafe extern "C" fn it6505_int_threaded_handler(unused: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn it6505_poweron(it6505: *mut it6505) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it6505_poweroff(it6505: *mut it6505) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it6505_detect(it6505: *mut it6505) -> enum drm_connector_status {
...
#[no_mangle]
unsafe extern "C" fn it6505_extcon_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn it6505_use_notifier_module(it6505: *mut it6505) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it6505_remove_notifier_module(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn it6505_delayed_audio(work: *mut work_struct) -> void __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn it6505_audio_shutdown(dev: *mut device, data: *mut c_void) -> void __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn it6505_bridge_detach(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn it6505_bridge_resume(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn it6505_bridge_suspend(dev: *mut device) -> __maybe_unused int {
    ...
    SET_RUNTIME_PM_OPS(it6505_bridge_suspend, it6505_bridge_resume, core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn it6505_init_pdata(it6505: *mut it6505) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it6505_parse_dt(it6505: *mut it6505) {
    static void it6505_parse_dt(struct it6505 *it6505)
    {
    struct device *dev = it6505.dev;
    struct device_node *np = dev.of_node, *ep = core::ptr::null_mut();
    int len;
...
#[no_mangle]
unsafe extern "C" fn force_power_on_off_debugfs_write(data: *mut c_void, value: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enable_drv_hold_debugfs_show(data: *mut c_void, buf: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enable_drv_hold_debugfs_write(data: *mut c_void, drv_hold: u64) -> c_int {
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(fops_force_power, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn debugfs_create_files(it6505: *mut it6505) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_init(it6505: *mut it6505) {
    static void debugfs_init(struct it6505 *it6505)
    {
    struct device *dev = it6505.dev;
    it6505.debugfs = debugfs_create_dir(DEBUGFS_DIR_NAME, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn it6505_debugfs_remove(it6505: *mut it6505) {
    static void it6505_debugfs_remove(struct it6505 *it6505)
    {
    debugfs_remove_recursive(it6505.debugfs);
    }
#[no_mangle]
unsafe extern "C" fn it6505_shutdown(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn it6505_i2c_probe(client: *mut i2c_client) -> c_int {
...
// get extcon device from DTS
    ...
    err = devm_request_threaded_irq(&client.dev, it6505.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn it6505_i2c_remove(client: *mut i2c_client) {
