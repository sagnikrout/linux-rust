...
//! Source: drivers/gpu/drm/hyperv/hyperv_drm_drv.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hv_drm_pci_remove(pdev: *mut pci_dev) {
...
// If DRM panic path is stubbed out VMBus code must do the unload
    ...
    err_hv_set_drv_data:
    hv_set_drvdata(hdev, core::ptr::null_mut());
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn hv_drm_vmbus_remove(hdev: *mut hv_device) {
...
#[no_mangle]
unsafe extern "C" fn hv_drm_vmbus_shutdown(hdev: *mut hv_device) {
    static void hv_drm_vmbus_shutdown(struct hv_device *hdev)
    {
    drm_atomic_helper_shutdown(hv_get_drvdata(hdev));
    }
#[no_mangle]
unsafe extern "C" fn hv_drm_vmbus_suspend(hdev: *mut hv_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_drm_vmbus_resume(hdev: *mut hv_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_drm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hv_drm_exit() -> void __exit {
