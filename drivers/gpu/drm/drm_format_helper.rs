...
//! Source: drivers/gpu/drm/drm_format_helper.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_format_conv_state_init(state: *mut drm_format_conv_state) {
    void drm_format_conv_state_init(struct drm_format_conv_state *state)
    {
    state.tmp.mem = core::ptr::null_mut();
    state.tmp.size = 0;
...
//
    ...
    goto out;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: state->tmp.preallocated) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_format_conv_state_release(state: *mut drm_format_conv_state) {
...
#[no_mangle]
unsafe extern "C" fn clip_offset(clip: *const drm_rect, pitch: c_uint, cpp: c_uint) -> c_uint {
...
// TODO: Make this function work with multi-plane formats.
    ...
    {
    let mut linepixels: c_ulong = drm_rect_width(clip);
    let mut lines: c_ulong = drm_rect_height(clip);
    let mut sbuf_len: usize = linepixels * fb.format.cpp[0];
    void *stmp = core::ptr::null_mut();
    unsigned long i;
    const void *sbuf;
//
...
// TODO: Make this function work with multi-plane formats.
    ...
    let mut linepixels: c_ulong = drm_rect_width(clip);
    let mut lines: c_ulong = drm_rect_height(clip);
    let mut dbuf_len: usize = linepixels * dst_pixsize;
...
// write trailing pixel
    dbuf8 = (u8  *)dbuf32;
    while (sbuf32 < send32) {
    let mut val24: u32 = xfrm_pixel(le32_to_cpup(sbuf32++));
...
//
    ...
    let mut bpp_i: c_uint = drm_format_info_bpp(format, i);
    let mut cpp_i: c_uint = DIV_ROUND_UP(bpp_i, 8);
    let mut len_i: usize = DIV_ROUND_UP(drm_rect_width(clip) * bpp_i, 8);
    let mut dst_pitch_i: c_uint = dst_pitch[i];
    let mut dst_i: iosys_map = dst[i];
    let mut src_i: iosys_map = src[i];
    if (!dst_pitch_i)
    dst_pitch_i = len_i;
...
#[no_mangle]
unsafe extern "C" fn drm_fb_swab16_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_swab32_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
//
    ...
    {
    const struct drm_format_info *format = fb.format;
    let mut cpp: u8 = DIV_ROUND_UP(drm_format_info_bpp(format, 0), 8);
...
#[no_mangle]
unsafe extern "C" fn drm_fb_xrgb8888_to_rgb332_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_xrgb8888_to_rgb565_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_xrgb8888_to_xrgb1555_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_xrgb8888_to_argb1555_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_xrgb8888_to_rgba5551_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_xrgb8888_to_rgb888_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_xrgb8888_to_bgr888_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_xrgb8888_to_argb8888_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_xrgb8888_to_abgr8888_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_xrgb8888_to_xbgr8888_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_xrgb8888_to_bgrx8888_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_xrgb8888_to_xrgb2101010_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_xrgb8888_to_argb2101010_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_xrgb8888_to_gray8_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_argb8888_to_argb4444_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_gray8_to_gray2_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_fb_gray8_to_mono_line(dbuf: *mut c_void, sbuf: *const c_void, pixels: c_uint) {
...
//
    ...
    let mut linepixels: c_uint = drm_rect_width(clip);
    let mut lines: c_uint = drm_rect_height(clip);
    let mut cpp: c_uint = fb.format.cpp[0];
    let mut len_src32: c_uint = linepixels * cpp;
