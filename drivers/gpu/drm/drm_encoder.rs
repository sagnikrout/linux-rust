...
//! Source: drivers/gpu/drm/drm_encoder.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn drm_encoder_register_all(dev: *mut drm_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drm_encoder_unregister_all(dev: *mut drm_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_encoder_cleanup(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn drmm_encoder_alloc_release(dev: *mut drm_device, ptr: *mut c_void) {
...
//
    ...
    struct drm_device *dev = encoder.dev;
    let mut uses_atomic: bool = false;
