...
//! Source: drivers/gpu/drm/drm_framebuffer.c
#![no_std]
...
// convert to new format and call new ioctl
    ...
    let mut width: c_uint = drm_format_info_plane_width(info, r.width, i);
    let mut height: c_uint = drm_format_info_plane_height(info, r.height, i);
    let mut block_size: c_uint = info.char_per_block[i];
    let mut min_pitch: u64 = drm_format_info_min_pitch(info, i, width);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_mode_rmfb_work {
    pub work: work_struct,
    pub fbs: list_head,
}

#[no_mangle]
unsafe extern "C" fn drm_mode_rmfb_work_fn(w: *mut work_struct) {
...
//
    ...
    struct drm_clip_rect *clips = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_fb_release(priv: *mut drm_file) {
...
#[no_mangle]
pub unsafe extern "C" fn drm_framebuffer_free(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_framebuffer_unregister_private(fb: *mut drm_framebuffer) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_framebuffer_cleanup(fb: *mut drm_framebuffer) {
...
#[no_mangle]
unsafe extern "C" fn atomic_remove_fb(fb: *mut drm_framebuffer) -> c_int {
    ...
    int i, ret;
    unsigned plane_mask;
    let mut disable_crtcs: bool = false;
    retry_disable:
...
#[no_mangle]
unsafe extern "C" fn legacy_remove_fb(fb: *mut drm_framebuffer) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_framebuffer_remove(fb: *mut drm_framebuffer) {
...
//
    ...
    let mut ret: c_int = atomic_remove_fb(fb);
...
#[no_mangle]
unsafe extern "C" fn drm_framebuffer_info(m: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drm_framebuffer_debugfs_init(dev: *mut drm_device) {
