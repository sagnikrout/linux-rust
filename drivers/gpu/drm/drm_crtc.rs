...
#[no_mangle]
pub unsafe extern "C" fn drm_crtc_force_disable(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drm_crtc_register_all(dev: *mut drm_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drm_crtc_unregister_all(dev: *mut drm_device) {
...
#[no_mangle]
unsafe extern "C" fn drm_crtc_crc_init(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_crtc_crc_fini(crtc: *mut drm_crtc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_crtc_cleanup(crtc: *mut drm_crtc) {
...
//
    ...
    crtc.gamma_store = core::ptr::null_mut();
...
//
    ...
    plane.crtc = fb ? crtc : core::ptr::null_mut();
    plane.fb = fb;
    }
    drm_for_each_crtc(tmp, crtc.dev) {
    struct drm_plane *plane = tmp.primary;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_set_config_internal(set: *mut drm_mode_set) -> c_int {
    int drm_mode_set_config_internal(struct drm_mode_set *set)
    {
    WARN_ON(drm_drv_uses_atomic_modeset(set.crtc.dev));
    return __drm_mode_set_config_internal(set, core::ptr::null_mut());
    }
...
//
    ...
    struct drm_crtc *crtc;
    struct drm_plane *plane;
    struct drm_connector **connector_set = core::ptr::null_mut(), *connector;
...
// Avoid unbounded kernel memory allocation
    ...
    connector_set[i] = core::ptr::null_mut();
...
// In case we need to retry...
    connector_set = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn drm_crtc_create_sharpness_strength_property(crtc: *mut drm_crtc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_crtc_in_clone_mode(crtc_state: *mut drm_crtc_state) -> bool {
