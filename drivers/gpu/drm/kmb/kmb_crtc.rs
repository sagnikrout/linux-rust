...
//! Source: drivers/gpu/drm/kmb/kmb_crtc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn kmb_crtc_enable_vblank(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_crtc_disable_vblank(crtc: *mut drm_crtc) {
...
// due to hw limitations, planes need to be off when crtc is off
    ...
    int refresh;
    struct drm_device *dev = crtc.dev;
    let mut vfp: c_int = mode.vsync_start - mode.vdisplay;
...
#[no_mangle]
pub unsafe extern "C" fn kmb_setup_crtc(drm: *mut drm_device) -> c_int {
    ...
    core::ptr::null_mut(), &kmb_crtc_funcs, core::ptr::null_mut());
    if (ret) {
