...
//! Source: drivers/gpu/drm/panel/panel-leadtek-ltk500hd1829.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltk500hd1829_desc {
    pub mode: *const drm_display_mode,
    pub init: *const ltk500hd1829_cmd,
    pub num_init: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltk500hd1829 {
    pub dev: *mut device,
    pub panel: drm_panel,
    pub reset_gpio: *mut gpio_desc,
    pub vcc: *mut regulator,
    pub iovcc: *mut regulator,
    pub panel_desc: *const ltk500hd1829_desc,
}
...
#[no_mangle]
unsafe extern "C" fn ltk500hd1829_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltk500hd1829_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltk500hd1829_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltk500hd1829_remove(dsi: *mut mipi_dsi_device) {
