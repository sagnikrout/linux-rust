...
//! Source: drivers/gpu/drm/panel/panel-boe-bf060y8m-aj0.c
#![no_std]
...
pub const DCS_ALLOW_HBM_RANGE: c_uint = 0x0c;
pub const DCS_DISALLOW_HBM_RANGE: c_uint = 0x08;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct boe_bf060y8m_aj0 {
    pub panel: drm_panel,
    pub dsi: *mut mipi_dsi_device,
    pub vregs: [regulator_bulk_data; BF060Y8M_VREG_MAX],
...
#[no_mangle]
unsafe extern "C" fn boe_bf060y8m_aj0_reset(boe: *mut boe_bf060y8m_aj0) {
...
#[no_mangle]
unsafe extern "C" fn boe_bf060y8m_aj0_on(boe: *mut boe_bf060y8m_aj0) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_bf060y8m_aj0_off(boe: *mut boe_bf060y8m_aj0) {
...
#[no_mangle]
unsafe extern "C" fn boe_bf060y8m_aj0_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_bf060y8m_aj0_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_bf060y8m_aj0_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_bf060y8m_aj0_bl_get_brightness(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_bf060y8m_aj0_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_bf060y8m_aj0_remove(dsi: *mut mipi_dsi_device) {
