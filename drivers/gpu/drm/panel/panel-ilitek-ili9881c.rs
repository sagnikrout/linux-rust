...
//! Source: drivers/gpu/drm/panel/panel-ilitek-ili9881c.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ili9881c_instr {
    pub op: enum ili9881c_op,
    union arg {
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cmd {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ili9881c_desc {
    pub init: *const ili9881c_instr,
    pub init_length: usize,
    pub mode: *const drm_display_mode,
    pub mode_flags: c_ulong,
    pub default_address_mode: u8,
    pub lanes: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn ili9881c_switch_page(mctx: *mut mipi_dsi_multi_context, page: u8) {
...
#[no_mangle]
unsafe extern "C" fn ili9881c_send_cmd_data(mctx: *mut mipi_dsi_multi_context, cmd: u8, data: u8) {
...
#[no_mangle]
unsafe extern "C" fn ili9881c_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(ILI9881C_COMMAND: instr->op ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ili9881c_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9881c_get_orientation(panel: *mut drm_panel) -> enum drm_panel_orientation {
...
#[no_mangle]
unsafe extern "C" fn ili9881c_dsi_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9881c_dsi_remove(dsi: *mut mipi_dsi_device) {
