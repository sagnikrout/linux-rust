...
//! Source: drivers/gpu/drm/panel/panel-novatek-nt36672a.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nt36672a_panel_desc {
    pub display_mode: *const drm_display_mode,
    pub panel_name: *const c_char,
    pub width_mm: c_uint,
    pub height_mm: c_uint,
    pub mode_flags: c_ulong,
    pub format: enum mipi_dsi_pixel_format,
    pub lanes: c_uint,
    pub dsi_ctx): *mut *mut void (send_init_cmds_1)(struct mipi_dsi_multi_context,
    pub dsi_ctx): *mut *mut void (send_init_cmds_2)(struct mipi_dsi_multi_context,
    pub dsi_ctx): *mut *mut void (send_deinit_cmds)(struct mipi_dsi_multi_context,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nt36672a_panel {
    pub base: drm_panel,
    pub link: *mut mipi_dsi_device,
    pub desc: *const nt36672a_panel_desc,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(nt36672a_regulator_names)],
...
#[no_mangle]
unsafe extern "C" fn nt36672a_panel_power_off(panel: *mut drm_panel) {
...
#[no_mangle]
unsafe extern "C" fn nt36672a_panel_unprepare(panel: *mut drm_panel) -> c_int {
    static int nt36672a_panel_unprepare(struct drm_panel *panel)
    {
    struct nt36672a_panel *pinfo = to_nt36672a_panel(panel);
    let mut dsi_ctx: mipi_dsi_multi_context = { .dsi = pinfo.link };
// send off cmds
...
#[no_mangle]
unsafe extern "C" fn nt36672a_panel_power_on(pinfo: *mut nt36672a_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36672a_panel_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tianma_fhd_video_send_init_cmds_1(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn tianma_fhd_video_send_init_cmds_2(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn tianma_fhd_video_send_deinit_cmds(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn nt36672a_panel_add(pinfo: *mut nt36672a_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36672a_panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36672a_panel_remove(dsi: *mut mipi_dsi_device) {
