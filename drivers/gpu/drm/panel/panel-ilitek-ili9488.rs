...
//! Source: drivers/gpu/drm/panel/panel-ilitek-ili9488.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn e35gh_i_mw800cb_init(ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn ili9488_power_on(ili: *mut ili9488) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9488_power_off(ili: *mut ili9488) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9488_activate(ili: *mut ili9488) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9488_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9488_deactivate(ili: *mut ili9488) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9488_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9488_get_modes(panel: *mut drm_panel, connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9488_get_orientation(panel: *mut drm_panel) -> enum drm_panel_orientation {
...
#[no_mangle]
unsafe extern "C" fn ili9488_dsi_probe(dsi: *mut mipi_dsi_device) -> c_int {
