...
//! Source: drivers/gpu/drm/panel/panel-novatek-nt39016.c
#![no_std]
...
pub struct nt39016 {
    ...
    pub panel_info: *const nt39016_panel_info,
...
#[no_mangle]
unsafe extern "C" fn nt39016_prepare(drm_panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt39016_unprepare(drm_panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt39016_enable(drm_panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt39016_disable(drm_panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt39016_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt39016_remove(spi: *mut spi_device) {
