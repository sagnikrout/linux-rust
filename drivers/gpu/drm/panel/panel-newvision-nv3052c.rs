...
//! Source: drivers/gpu/drm/panel/panel-newvision-nv3052c.c
#![no_std]
...
pub struct nv3052c {
    ...
    pub panel: drm_panel,
    pub dbi: mipi_dbi,
    pub panel_info: *const nv3052c_panel_info,
...
#[no_mangle]
unsafe extern "C" fn nv3052c_prepare(panel: *mut drm_panel) -> c_int {
    static int nv3052c_prepare(struct drm_panel *panel)
    {
    struct nv3052c *priv = to_nv3052c(panel);
    const struct nv3052c_reg *panel_regs = priv.panel_info.panel_regs;
    let mut panel_regs_len: c_uint = priv.panel_info.panel_regs_len;
...
#[no_mangle]
unsafe extern "C" fn nv3052c_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nv3052c_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nv3052c_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nv3052c_probe(spi: *mut spi_device) -> c_int {
    ...
    err = mipi_dbi_spi_init(spi, &priv.dbi, core::ptr::null_mut());
    if (err)
    return dev_err_probe(dev, err, "MIPI DBI init failed\n");
    priv.dbi.read_commands = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn nv3052c_remove(spi: *mut spi_device) {
