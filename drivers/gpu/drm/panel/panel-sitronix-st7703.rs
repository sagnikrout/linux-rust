...
//! Source: drivers/gpu/drm/panel/panel-sitronix-st7703.c
#![no_std]
...
pub const ST7703_CMD_ALL_PIXEL_OFF: c_uint = 0x22;
pub const ST7703_CMD_ALL_PIXEL_ON: c_uint = 0x23;
pub const ST7703_CMD_SETAPID: c_uint = 0xB1;
pub const ST7703_CMD_SETDISP: c_uint = 0xB2;
pub const ST7703_CMD_SETRGBIF: c_uint = 0xB3;
pub const ST7703_CMD_SETCYC: c_uint = 0xB4;
pub const ST7703_CMD_SETBGP: c_uint = 0xB5;
pub const ST7703_CMD_SETVCOM: c_uint = 0xB6;
pub const ST7703_CMD_SETOTP: c_uint = 0xB7;
pub const ST7703_CMD_SETPOWER_EXT: c_uint = 0xB8;
pub const ST7703_CMD_SETEXTC: c_uint = 0xB9;
pub const ST7703_CMD_SETMIPI: c_uint = 0xBA;
pub const ST7703_CMD_SETVDC: c_uint = 0xBC;
pub const ST7703_CMD_UNKNOWN_BF: c_uint = 0xBF;
pub const ST7703_CMD_SETSCR: c_uint = 0xC0;
pub const ST7703_CMD_SETPOWER: c_uint = 0xC1;
pub const ST7703_CMD_SETECO: c_uint = 0xC6;
pub const ST7703_CMD_SETIO: c_uint = 0xC7;
pub const ST7703_CMD_SETCABC: c_uint = 0xC8;
pub const ST7703_CMD_SETPANEL: c_uint = 0xCC;
pub const ST7703_CMD_SETGAMMA: c_uint = 0xE0;
pub const ST7703_CMD_UNKNOWN_E1: c_uint = 0xE1;
pub const ST7703_CMD_SETEQ: c_uint = 0xE3;
pub const ST7703_CMD_SETGIP1: c_uint = 0xE9;
pub const ST7703_CMD_SETGIP2: c_uint = 0xEA;
pub const ST7703_CMD_UNKNOWN_EF: c_uint = 0xEF;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st7703 {
    pub dev: *mut device,
    ...
    pub desc: *const st7703_panel_desc,
    pub orientation: enum drm_panel_orientation,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct st7703_panel_desc {
...
#[no_mangle]
unsafe extern "C" fn jh057n_init_sequence(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn xbd599_init_sequence(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn rg353v2_init_sequence(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn rgb30panel_init_sequence(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn rgb10max3_panel_init_sequence(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn gameforcechi_init_sequence(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn ayaneo_pocket_ds_lower_init_sequence(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn st7703_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7703_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7703_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7703_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7703_get_orientation(panel: *mut drm_panel) -> enum drm_panel_orientation {
...
#[no_mangle]
unsafe extern "C" fn allpixelson_set(data: *mut c_void, val: u64) -> c_int {
...
//
    ...
    DEFINE_SIMPLE_ATTRIBUTE(allpixelson_fops, core::ptr::null_mut(),
    allpixelson_set, "%llu\n");
#[no_mangle]
unsafe extern "C" fn st7703_debugfs_init(ctx: *mut st7703) {
    static void st7703_debugfs_init(struct st7703 *ctx)
    {
    ctx.debugfs = debugfs_create_dir(DRV_NAME, core::ptr::null_mut());
    debugfs_create_file("allpixelson", 0600, ctx.debugfs, ctx,
    &allpixelson_fops);
    }
#[no_mangle]
unsafe extern "C" fn st7703_debugfs_remove(ctx: *mut st7703) {
    static void st7703_debugfs_remove(struct st7703 *ctx)
    {
    debugfs_remove_recursive(ctx.debugfs);
    ctx.debugfs = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn st7703_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7703_remove(dsi: *mut mipi_dsi_device) {
