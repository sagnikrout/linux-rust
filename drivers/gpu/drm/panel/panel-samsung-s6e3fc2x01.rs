...
//! Source: drivers/gpu/drm/panel/panel-samsung-s6e3fc2x01.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn s6e3fc2x01_reset(ctx: *mut samsung_s6e3fc2x01) {
...
#[no_mangle]
unsafe extern "C" fn s6e3fc2x01_on(ctx: *mut samsung_s6e3fc2x01) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fc2x01_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fc2x01_off(ctx: *mut samsung_s6e3fc2x01) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fc2x01_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fc2x01_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fc2x01_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fc2x01_panel_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fc2x01_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fc2x01_remove(dsi: *mut mipi_dsi_device) {
