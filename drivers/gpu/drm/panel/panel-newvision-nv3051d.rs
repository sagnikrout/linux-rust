...
//! Source: drivers/gpu/drm/panel/panel-newvision-nv3051d.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct panel_nv3051d {
    pub dev: *mut device,
    pub panel: drm_panel,
    pub reset_gpio: *mut gpio_desc,
    pub panel_info: *const nv3051d_panel_info,
...
#[no_mangle]
unsafe extern "C" fn panel_nv3051d_init_sequence(ctx: *mut panel_nv3051d) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn panel_nv3051d_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn panel_nv3051d_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn panel_nv3051d_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn panel_nv3051d_shutdown(dsi: *mut mipi_dsi_device) {
...
#[no_mangle]
unsafe extern "C" fn panel_nv3051d_remove(dsi: *mut mipi_dsi_device) {
