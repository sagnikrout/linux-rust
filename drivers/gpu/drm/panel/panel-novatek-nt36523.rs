...
//! Source: drivers/gpu/drm/panel/panel-novatek-nt36523.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn elish_boe_init_sequence(pinfo: *mut panel_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elish_csot_init_sequence(pinfo: *mut panel_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn j606f_boe_init_sequence(pinfo: *mut panel_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36523_reset(pinfo: *mut panel_info) {
...
#[no_mangle]
unsafe extern "C" fn nt36523_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36523_disable(panel: *mut drm_panel) -> c_int {
    static int nt36523_disable(struct drm_panel *panel)
    {
    struct panel_info *pinfo = to_panel_info(panel);
    int i;
    for (i = 0; i < DSI_NUM_MIN + pinfo.desc.is_dual_dsi; i++) {
    let mut dsi_ctx: mipi_dsi_multi_context = { .dsi = pinfo.dsi[i]};
...
#[no_mangle]
unsafe extern "C" fn nt36523_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36523_remove(dsi: *mut mipi_dsi_device) {
...
#[no_mangle]
unsafe extern "C" fn nt36523_get_orientation(panel: *mut drm_panel) -> enum drm_panel_orientation {
...
#[no_mangle]
unsafe extern "C" fn nt36523_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36523_bl_get_brightness(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36523_probe(dsi: *mut mipi_dsi_device) -> c_int {
