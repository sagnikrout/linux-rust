...
//! Source: drivers/gpu/drm/panel/panel-boe-himax8279d.c
#![no_std]
...
pub struct panel_desc {
    ...
    pub lanes: c_uint,
    pub on_cmds: *const panel_cmd,
    pub on_cmds_num: c_uint,
}
...
pub struct panel_info {
    ...
    pub pp33_gpio: *mut gpio_desc,
    pub pp18_gpio: *mut gpio_desc,
}
...
#[no_mangle]
unsafe extern "C" fn disable_gpios(pinfo: *mut panel_info) {
...
#[no_mangle]
unsafe extern "C" fn send_mipi_cmds(panel: *mut drm_panel, cmds: *const panel_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn panel_add(pinfo: *mut panel_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn panel_remove(dsi: *mut mipi_dsi_device) {
