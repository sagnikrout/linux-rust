...
//! Source: drivers/gpu/drm/panel/panel-jdi-lt070me05000.c
#![no_std]
...
pub struct jdi_panel {
    ...
    pub dcdc_en_gpio: *mut gpio_desc,
...
#[no_mangle]
unsafe extern "C" fn jdi_panel_init(jdi: *mut jdi_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jdi_panel_on(jdi: *mut jdi_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jdi_panel_off(jdi: *mut jdi_panel) {
...
unsafe extern "C" fn dsi_dcs_bl_get_brightness(bl: *mut backlight_device) -> c_int {
    ...
    int ret;
    let mut brightness: u16 = bl.props.brightness;
    dsi.mode_flags &= ~MIPI_DSI_MODE_LPM;
...
#[no_mangle]
unsafe extern "C" fn jdi_panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jdi_panel_remove(dsi: *mut mipi_dsi_device) {
