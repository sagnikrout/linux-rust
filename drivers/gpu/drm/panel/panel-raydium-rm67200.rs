...
//! Source: drivers/gpu/drm/panel/panel-raydium-rm67200.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct raydium_rm67200_panel_info {
    pub mode: drm_display_mode,
    pub regulators: *const regulator_bulk_data,
    pub num_regulators: c_int,
    pub ctx): *mut *mut void (panel_setup)(struct mipi_dsi_multi_context,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct raydium_rm67200 {
    pub panel: drm_panel,
    pub panel_info: *const raydium_rm67200_panel_info,
...
#[no_mangle]
unsafe extern "C" fn raydium_rm67200_reset(ctx: *mut raydium_rm67200) {
...
#[no_mangle]
unsafe extern "C" fn w552793baa_setup(ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn raydium_rm67200_prepare(panel: *mut drm_panel) -> c_int {
    static int raydium_rm67200_prepare(struct drm_panel *panel)
    {
    struct raydium_rm67200 *ctx = to_raydium_rm67200(panel);
    let mut mctx: mipi_dsi_multi_context = { .dsi = ctx.dsi };
    int ret;
...
#[no_mangle]
unsafe extern "C" fn raydium_rm67200_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raydium_rm67200_disable(panel: *mut drm_panel) -> c_int {
    static int raydium_rm67200_disable(struct drm_panel *panel)
    {
    struct raydium_rm67200 *rm67200 = to_raydium_rm67200(panel);
    let mut ctx: mipi_dsi_multi_context = { .dsi = rm67200.dsi };
...
#[no_mangle]
unsafe extern "C" fn raydium_rm67200_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raydium_rm67200_remove(dsi: *mut mipi_dsi_device) {
