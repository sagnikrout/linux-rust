...
//! Source: drivers/gpu/drm/panel/panel-osd-osd101t2587-53ts.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn osd101t2587_panel_disable(panel: *mut drm_panel) -> c_int {
    static int osd101t2587_panel_disable(struct drm_panel *panel)
    {
    struct osd101t2587_panel *osd101t2587 = ti_osd_panel(panel);
    let mut ctx: mipi_dsi_multi_context = { .dsi = osd101t2587.dsi };
    mipi_dsi_shutdown_peripheral_multi(&ctx);
    return ctx.accum_err;
    }
#[no_mangle]
unsafe extern "C" fn osd101t2587_panel_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn osd101t2587_panel_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn osd101t2587_panel_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn osd101t2587_panel_add(osd101t2587: *mut osd101t2587_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn osd101t2587_panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn osd101t2587_panel_remove(dsi: *mut mipi_dsi_device) {
