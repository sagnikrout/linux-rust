...
//! Source: drivers/gpu/drm/panel/panel-samsung-s6e63j0x03.c
#![no_std]
...
pub const MCS_LEVEL2_KEY: c_uint = 0xf0;
pub const MCS_MTP_KEY: c_uint = 0xf1;
pub const MCS_MTP_SET3: c_uint = 0xd4;
pub const MAX_BRIGHTNESS: c_int = 100;
pub const DEFAULT_BRIGHTNESS: c_int = 80;
pub const NUM_GAMMA_STEPS: c_int = 9;
pub const GAMMA_CMD_CNT: c_int = 28;
pub const FIRST_COLUMN: c_int = 20;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s6e63j0x03 {
    pub dev: *mut device,
    pub panel: drm_panel,
...
#[no_mangle]
pub unsafe extern "C" fn s6e63j0x03_enable_lv2_command(ctx: *mut s6e63j0x03) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn s6e63j0x03_apply_mtp_key(ctx: *mut s6e63j0x03, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e63j0x03_power_on(ctx: *mut s6e63j0x03) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e63j0x03_power_off(ctx: *mut s6e63j0x03) -> c_int {
    static int s6e63j0x03_power_off(struct s6e63j0x03 *ctx)
    {
    return regulator_bulk_disable(ARRAY_SIZE(ctx.supplies), ctx.supplies);
    }
#[no_mangle]
unsafe extern "C" fn s6e63j0x03_get_brightness_index(brightness: c_uint) -> c_uint {
    ...
    let mut index: c_uint = s6e63j0x03_get_brightness_index(brightness);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn s6e63j0x03_set_brightness(bl_dev: *mut backlight_device) -> c_int {
    static int s6e63j0x03_set_brightness(struct backlight_device *bl_dev)
    {
    struct s6e63j0x03 *ctx = bl_get_data(bl_dev);
    let mut brightness: c_uint = bl_dev.props.brightness;
...
#[no_mangle]
unsafe extern "C" fn s6e63j0x03_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e63j0x03_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e63j0x03_panel_init(ctx: *mut s6e63j0x03) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e63j0x03_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e63j0x03_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e63j0x03_probe(dsi: *mut mipi_dsi_device) -> c_int {
    ...
    &s6e63j0x03_bl_ops, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn s6e63j0x03_remove(dsi: *mut mipi_dsi_device) {
