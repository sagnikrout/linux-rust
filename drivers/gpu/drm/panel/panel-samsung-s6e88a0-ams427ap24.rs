...
//! Source: drivers/gpu/drm/panel/panel-samsung-s6e88a0-ams427ap24.c
#![no_std]
...
pub const NUM_STEPS_CANDELA: c_int = 54;
pub const NUM_STEPS_AID: c_int = 39;
pub const NUM_STEPS_ELVSS: c_int = 17;
// length of the payload data, thereof fixed and variable
pub const FIX_LEN_AID: c_int = 4;
pub const FIX_LEN_ELVSS: c_int = 2;
pub const FIX_LEN_GAMMA: c_int = 1;
pub const VAR_LEN_AID: c_int = 2;
pub const VAR_LEN_ELVSS: c_int = 1;
pub const VAR_LEN_GAMMA: c_int = 33;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct s6e88a0_ams427ap24 {
    pub panel: drm_panel,
...
#[no_mangle]
unsafe extern "C" fn s6e88a0_ams427ap24_set_brightness(bd: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e88a0_ams427ap24_reset(ctx: *mut s6e88a0_ams427ap24) {
...
#[no_mangle]
unsafe extern "C" fn s6e88a0_ams427ap24_on(ctx: *mut s6e88a0_ams427ap24) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e88a0_ams427ap24_off(ctx: *mut s6e88a0_ams427ap24) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e88a0_ams427ap24_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e88a0_ams427ap24_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e88a0_ams427ap24_register_backlight(ctx: *mut s6e88a0_ams427ap24) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e88a0_ams427ap24_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e88a0_ams427ap24_remove(dsi: *mut mipi_dsi_device) {
