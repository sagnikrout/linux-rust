...
//! Source: drivers/gpu/drm/panel/panel-jadard-jd9365da-h3.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct jadard_panel_desc {
    pub mode_4ln: *const drm_display_mode,
    pub mode_2ln: *const drm_display_mode,
    pub lanes: c_uint,
    pub format: enum mipi_dsi_pixel_format,
    pub jadard): *mut *mut int (init)(struct jadard,
    pub lp11_before_reset: bool,
    pub reset_before_power_off_vcioo: bool,
    pub vcioo_to_lp11_delay_ms: c_uint,
    pub lp11_to_reset_delay_ms: c_uint,
    pub backlight_off_to_display_off_delay_ms: c_uint,
    pub display_off_to_enter_sleep_delay_ms: c_uint,
    pub enter_sleep_to_reset_down_delay_ms: c_uint,
...
pub struct jadard {
    ...
    pub desc: *const jadard_panel_desc,
...
pub const JD9365DA_DCS_SWITCH_PAGE: c_uint = 0xe0;

    mipi_dsi_dcs_write_seq_multi(dsi_ctx, JD9365DA_DCS_SWITCH_PAGE, (page))
#[no_mangle]
unsafe extern "C" fn jadard_enable_standard_cmds(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn jadard_disable(panel: *mut drm_panel) -> c_int {
    static int jadard_disable(struct drm_panel *panel)
    {
    struct jadard *jadard = panel_to_jadard(panel);
    let mut dsi_ctx: mipi_dsi_multi_context = { .dsi = jadard.dsi };
...
#[no_mangle]
unsafe extern "C" fn jadard_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jadard_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jadard_panel_get_orientation(panel: *mut drm_panel) -> enum drm_panel_orientation {
...
#[no_mangle]
unsafe extern "C" fn radxa_display_8hd_ad002_init_cmds(jadard: *mut jadard) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cz101b4001_init_cmds(jadard: *mut jadard) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kingdisplay_kd101ne3_init_cmds(jadard: *mut jadard) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn melfas_lmfbx101117480_init_cmds(jadard: *mut jadard) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn anbernic_rgds_init_cmds(jadard: *mut jadard) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn taiguan_xti05101_01a_init_cmds(jadard: *mut jadard) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn waveshare_3_4_c_init(jadard: *mut jadard) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn waveshare_4_0_c_init(jadard: *mut jadard) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn waveshare_8_0_a_init(jadard: *mut jadard) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn waveshare_10_1_a_init(jadard: *mut jadard) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn waveshare_10_1_b_init(jadard: *mut jadard) -> c_int {
    static int waveshare_10_1_b_init(struct jadard *jadard)
    {
    let mut dsi_ctx: mipi_dsi_multi_context = { .dsi = jadard.dsi };
    jd9365da_switch_page(&dsi_ctx, 0x00);
...
#[no_mangle]
unsafe extern "C" fn dcltek_dt300250_init_cmds(jadard: *mut jadard) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jadard_dsi_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jadard_dsi_remove(dsi: *mut mipi_dsi_device) {
