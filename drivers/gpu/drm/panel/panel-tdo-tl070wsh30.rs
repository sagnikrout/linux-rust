...
//! Source: drivers/gpu/drm/panel/panel-tdo-tl070wsh30.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tdo_tl070wsh30_panel {
    pub base: drm_panel,
...
#[no_mangle]
unsafe extern "C" fn tdo_tl070wsh30_panel_prepare(panel: *mut drm_panel) -> c_int {
    ...
    let mut dsi_ctx: mipi_dsi_multi_context = { .dsi = tdo_tl070wsh30.link };
    int err;
...
#[no_mangle]
unsafe extern "C" fn tdo_tl070wsh30_panel_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdo_tl070wsh30_panel_add(tdo_tl070wsh30: *mut tdo_tl070wsh30_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdo_tl070wsh30_panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdo_tl070wsh30_panel_remove(dsi: *mut mipi_dsi_device) {
