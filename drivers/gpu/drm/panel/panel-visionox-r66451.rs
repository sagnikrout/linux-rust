...
//! Source: drivers/gpu/drm/panel/panel-visionox-r66451.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn visionox_r66451_reset(ctx: *mut visionox_r66451) {
...
#[no_mangle]
unsafe extern "C" fn visionox_r66451_on(ctx: *mut visionox_r66451) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_r66451_off(ctx: *mut visionox_r66451) {
    static void visionox_r66451_off(struct visionox_r66451 *ctx)
    {
    ctx.dsi.mode_flags &= ~MIPI_DSI_MODE_LPM;
    }
#[no_mangle]
unsafe extern "C" fn visionox_r66451_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_r66451_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_r66451_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_r66451_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_r66451_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_r66451_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_r66451_remove(dsi: *mut mipi_dsi_device) {
