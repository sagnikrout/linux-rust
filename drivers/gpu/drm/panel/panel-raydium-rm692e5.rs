...
//! Source: drivers/gpu/drm/panel/panel-raydium-rm692e5.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rm692e5_reset(ctx: *mut rm692e5_panel) {
...
#[no_mangle]
unsafe extern "C" fn rm692e5_on(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn rm692e5_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rm692e5_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rm692e5_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rm692e5_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rm692e5_bl_get_brightness(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rm692e5_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rm692e5_remove(dsi: *mut mipi_dsi_device) {
