...
//! Source: drivers/gpu/drm/panel/panel-tpo-tpg110.c
#![no_std]
...
pub const TPG110_TEST: c_uint = 0x00;
pub const TPG110_CHIPID: c_uint = 0x01;
pub const TPG110_CTRL1: c_uint = 0x02;

pub const TPG110_RES_800X480: c_uint = 0x07;
pub const TPG110_RES_640X480: c_uint = 0x06;
pub const TPG110_RES_480X272: c_uint = 0x05;
pub const TPG110_RES_480X640: c_uint = 0x04;
pub const TPG110_RES_480X272_D: c_uint = 0x01 /* Dual scan: outputs 800x480 */;
pub const TPG110_RES_400X240_D: c_uint = 0x00 /* Dual scan: outputs 800x480 */;
pub const TPG110_CTRL2: c_uint = 0x03;
...
//
    pub panel_mode: *const tpg110_panel_mode,
//
...
#[no_mangle]
unsafe extern "C" fn tpg110_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpg110_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpg110_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpg110_remove(spi: *mut spi_device) {
