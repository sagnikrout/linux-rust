...
//! Source: drivers/gpu/drm/panel/panel-orisetech-ota5601a.c
#![no_std]
...
pub const OTA5601A_CTL: c_uint = 0x01;
pub const OTA5601A_CTL_OFF: c_uint = 0x00;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ota5601a_panel_info {
...
#[derive(Copy, Clone)]
pub struct ota5601a {
    pub drm_panel: drm_panel,
    pub map: *mut regmap,
    pub supply: *mut regulator,
    pub panel_info: *const ota5601a_panel_info,
...
#[no_mangle]
unsafe extern "C" fn ota5601a_prepare(drm_panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ota5601a_unprepare(drm_panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ota5601a_enable(drm_panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ota5601a_disable(drm_panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ota5601a_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ota5601a_remove(spi: *mut spi_device) {
