...
//! Source: drivers/gpu/drm/panel/panel-ilitek-ili7807s.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ili7807s_reset(ctx: *mut ili7807s) {
...
#[no_mangle]
unsafe extern "C" fn dlc0697_init_sequence(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn ili7807s_on(ctx: *mut ili7807s) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili7807s_off(ctx: *mut ili7807s) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili7807s_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili7807s_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili7807s_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili7807s_probe(dsi: *mut mipi_dsi_device) -> c_int {
