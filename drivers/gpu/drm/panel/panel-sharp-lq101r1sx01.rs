...
//! Source: drivers/gpu/drm/panel/panel-sharp-lq101r1sx01.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sharp_wait_frames(sharp: *mut sharp_panel, frames: c_uint) {
    static void sharp_wait_frames(struct sharp_panel *sharp, unsigned int frames)
    {
    let mut refresh: c_uint = drm_mode_vrefresh(sharp.mode);
    if (WARN_ON(frames > refresh))
    return;
    msleep(1000 / (refresh / frames));
    }
#[no_mangle]
unsafe extern "C" fn sharp_panel_write(sharp: *mut sharp_panel, offset: u16, value: u8) -> c_int {
...
unsafe extern "C" fn sharp_panel_prepare(panel: *mut drm_panel) -> c_int {
    ...
    {
    struct sharp_panel *sharp = to_sharp_panel(panel);
    let mut format: u8 = MIPI_DCS_PIXEL_FMT_24BIT;
    int err;
...
#[no_mangle]
unsafe extern "C" fn sharp_panel_add(sharp: *mut sharp_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_panel_del(sharp: *mut sharp_panel) {
