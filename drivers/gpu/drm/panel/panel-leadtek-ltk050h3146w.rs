...
//! Source: drivers/gpu/drm/panel/panel-leadtek-ltk050h3146w.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltk050h3146w_desc {
    pub mode_flags: c_ulong,
    pub mode: *const drm_display_mode,
    pub dsi_ctx): *mut *mut void (init)(struct mipi_dsi_multi_context,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltk050h3146w {
    pub dev: *mut device,
    pub panel: drm_panel,
    pub reset_gpio: *mut gpio_desc,
    pub vci: *mut regulator,
    pub iovcc: *mut regulator,
    pub panel_desc: *const ltk050h3146w_desc,
}
...
#[no_mangle]
unsafe extern "C" fn ltk050h3148w_init_sequence(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn ltk050h3146w_init_sequence(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn ltk050h3146w_a2_select_page(dsi_ctx: *mut mipi_dsi_multi_context, page: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ltk050h3146w_a2_init_sequence(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn ltk050h3146w_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltk050h3146w_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltk050h3146w_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltk050h3146w_remove(dsi: *mut mipi_dsi_device) {
