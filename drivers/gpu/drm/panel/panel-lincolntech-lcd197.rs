...
//! Source: drivers/gpu/drm/panel/panel-lincolntech-lcd197.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lincoln_lcd197_panel {
    pub panel: drm_panel,
...
#[no_mangle]
unsafe extern "C" fn lincoln_lcd197_panel_prepare(panel: *mut drm_panel) -> c_int {
    ...
    let mut ctx: mipi_dsi_multi_context = { .dsi = lcd.dsi };
    int err;
...
#[no_mangle]
unsafe extern "C" fn lincoln_lcd197_panel_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lincoln_lcd197_panel_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lincoln_lcd197_panel_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lincoln_lcd197_panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lincoln_lcd197_panel_remove(dsi: *mut mipi_dsi_device) {
