...
//! Source: drivers/gpu/drm/panel/panel-samsung-ams581vf01.c
#![no_std]
...
pub const MCS_PASSWD: c_uint = 0xf0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ams581vf01 {
    pub panel: drm_panel,
...
#[no_mangle]
unsafe extern "C" fn ams581vf01_reset(ctx: *mut ams581vf01) {
...
#[no_mangle]
unsafe extern "C" fn ams581vf01_on(ctx: *mut ams581vf01) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ams581vf01_off(ctx: *mut ams581vf01) {
...
#[no_mangle]
unsafe extern "C" fn ams581vf01_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ams581vf01_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ams581vf01_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ams581vf01_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ams581vf01_remove(dsi: *mut mipi_dsi_device) {
