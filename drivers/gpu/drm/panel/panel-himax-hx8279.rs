...
//! Source: drivers/gpu/drm/panel/panel-himax-hx8279.c
#![no_std]
...
// Page selection
pub const HX8279_REG_PAGE: c_uint = 0xb0;

// Page 0 - Driver/Module Configuration
pub const HX8279_P0_VGHS: c_uint = 0xbf;
pub const HX8279_P0_VGLS: c_uint = 0xc0;
pub const HX8279_P0_VGPHS: c_uint = 0xc2;
pub const HX8279_P0_VGNHS: c_uint = 0xc4;

pub const HX8279_VGH_MIN_MV: c_int = 8700;
pub const HX8279_VGH_STEP_MV: c_int = 300;
pub const HX8279_VGL_MIN_MV: c_int = 6700;
pub const HX8279_VGL_STEP_MV: c_int = 300;
pub const HX8279_VGPNH_MIN_MV: c_int = 4000;
pub const HX8279_VGPNX_STEP_MV: c_int = 50;

// Page 1 - Gate driver On Array (GOA) Mux
pub const HX8279_P1_REG_GOA_L: c_uint = 0xc0;

pub const HX8279_P1_REG_GOA_R: c_uint = 0xd4;

// Page 2 - Analog Gamma Configuration
pub const HX8279_P2_REG_ANALOG_GAMMA: c_uint = 0xc0;

// Page 3 - Gate driver On Array (GOA) Configuration
pub const HX8279_P3_REG_UNKNOWN_BA: c_uint = 0xba;
pub const HX8279_P3_REG_GOA_CKV_FALL_PREC: c_uint = 0xbc;
pub const HX8279_P3_REG_GOA_TIMING_ODD: c_uint = 0xc2;

pub const HX8279_P3_REG_GOA_STVL: c_uint = 0xc8;

pub const HX8279_P3_REG_GOA_CKVL: c_uint = 0xc9;

pub const HX8279_P3_REG_GOA_CKVD: c_uint = 0xca;

pub const HX8279_P3_REG_GOA_CKV_RISE_PREC: c_uint = 0xcb;
pub const HX8279_P3_REG_GOA_CLR1_W_ADJ: c_uint = 0xd2;
pub const HX8279_P3_REG_GOA_CLR234_W_ADJ: c_uint = 0xd3;
pub const HX8279_P3_REG_GOA_CLR1_CFG: c_uint = 0xd4;

pub const HX8279_P3_REG_GOA_TIMING_EVEN: c_uint = 0xdd;

pub const HX8279_P3_REG_UNKNOWN_E4: c_uint = 0xe4;
pub const HX8279_P3_REG_UNKNOWN_E5: c_uint = 0xe5;
// Page 5 - MIPI
pub const HX8279_P5_REG_TIMING: c_uint = 0xb3;

pub const HX8279_P5_REG_UNKNOWN_B8: c_uint = 0xb8;
pub const HX8279_P5_REG_UNKNOWN_BC: c_uint = 0xbc;
pub const HX8279_P5_REG_UNKNOWN_D6: c_uint = 0xd6;
// Page 6 - Engineer
pub const HX8279_P6_REG_ENGINEER_PWD: c_uint = 0xb8;
pub const HX8279_P6_REG_INHOUSE_FUNC: c_uint = 0xc0;
pub const HX8279_P6_ENG_UNLOCK_WORD: c_uint = 0xa5;
pub const HX8279_P6_REG_GAMMA_CHOPPER: c_uint = 0xbc;

pub const HX8279_P6_REG_VOLT_ADJ: c_uint = 0xc7;
// For VCCIFS and VCCS - 0: 1450, 1: 1500, 2: 1550, 3: 1600 uV

pub const HX8279_P6_REG_DLY_TIME_ADJ: c_uint = 0xd5;
// Page 7...12 - Digital Gamma Adjustment
pub const HX8279_PG_DIGITAL_GAMMA: c_uint = 0xb1;

pub const HX8279_PG_DGAMMA_NUM_LO_BYTES: c_int = 24;
pub const HX8279_PG_DGAMMA_NUM_HI_BYTES: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hx8279 {
    pub panel: drm_panel,
    ...
    pub desc: *const hx8279_panel_desc,
    pub last_page: u8,
    pub skip_voltage_config: bool,
    pub skip_goa_config: bool,
    pub skip_goa_timing: bool,
    pub skip_goa_even_timing: bool,
    pub skip_mipi_timing: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hx8279_panel_mode {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hx8279_analog_gamma {
    pub pos: [u8; 17],
    pub neg: [u8; 17],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hx8279_digital_gamma {
    pub HX8279_PG_DGAMMA_NUM_HI_BYTES]: u8 r[HX8279_PG_DGAMMA_NUM_LO_BYTES +,
    pub HX8279_PG_DGAMMA_NUM_HI_BYTES]: u8 g[HX8279_PG_DGAMMA_NUM_LO_BYTES +,
    pub HX8279_PG_DGAMMA_NUM_HI_BYTES]: u8 b[HX8279_PG_DGAMMA_NUM_LO_BYTES +,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hx8279_panel_desc {
    pub dsi_info: mipi_dsi_device_info,
    pub mode_data: *const hx8279_panel_mode,
    pub num_lanes: u8,
    pub num_modes: u8,
// Page 0
    pub vgh_mv: c_uint,
    ...
    pub vgnh_mv: c_uint,
// Page 1
    pub gmux: *const hx8279_goa_mux,
// Page 2
    pub agamma: *const hx8279_analog_gamma,
// Page 3
    pub goa_unk_ba: u8,
    pub goa_odd_timing: [u8; 6],
    pub goa_even_timing: [u8; 6],
    pub goa_stv_lead_time_ck: u8,
    pub goa_ckv_lead_time_ck: u8,
    pub goa_ckv_dummy_vblank_num: u8,
    pub goa_ckv_rise_precharge: u8,
    pub goa_ckv_fall_precharge: u8,
    pub goa_ckv_non_overlap_ctl: bool,
    pub goa_clr1_width_adj: u8,
    pub goa_clr234_width_adj: u8,
    pub goa_clr_polarity: [i8; 4],
    pub goa_clr_start_pos: [c_int; 4],
    pub goa_unk_e4: u8,
    pub goa_unk_e5: u8,
// Page 5
    pub bta_tlpx: u8,
    pub lhs_settle_time_by_osc25: bool,
    pub ths_settle_time: u8,
    pub timing_unk_b8: u8,
    pub timing_unk_bc: u8,
    pub timing_unk_d6: u8,
// Page 6
    pub gamma_ctl: u8,
    pub volt_adj: u8,
    pub src_delay_time_adj_ck: u8,
// Page 7..12
    pub dgamma: *const hx8279_digital_gamma,
}
...
#[no_mangle]
unsafe extern "C" fn hx8279_on(hx: *mut hx8279) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx8279_power_off(hx: *mut hx8279) {
...
#[no_mangle]
unsafe extern "C" fn hx8279_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx8279_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx8279_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx8279_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx8279_get_modes(panel: *mut drm_panel, connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx8279_init_vregs(hx: *mut hx8279, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx8279_check_gmux_config(hx: *mut hx8279, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx8279_check_goa_config(hx: *mut hx8279, dev: *mut device) -> c_int {
...
//
    ...
    continue;
#[no_mangle]
pub unsafe extern "C" fn if(HX8279_P3_GOA_CLR_CFG_STARTPOS: desc->goa_clr_start_pos[i] >) -> else {
    ...
    continue;
#[no_mangle]
pub unsafe extern "C" fn if(1: desc->goa_clr_polarity[i] >) -> else {
...
#[no_mangle]
unsafe extern "C" fn hx8279_check_dig_gamma(hx: *mut hx8279, dev: *mut device, component: *const u8) -> c_int {
    static int hx8279_check_dig_gamma(struct hx8279 *hx, struct device *dev, const u8 *component)
    {
    u8 gamma_high_bits[4];
    let mut prev_val: u16 = 0;
    int i, j, k, x;
//
...
//
    ...
    do {
    let mut cur_val: u16 = component[j] | (gamma_high_bits[x] << 8);
    if (cur_val < prev_val)
    return dev_err_probe(dev, -EINVAL,
...
#[no_mangle]
unsafe extern "C" fn hx8279_check_params(hx: *mut hx8279, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx8279_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx8279_remove(dsi: *mut mipi_dsi_device) {
