...
//! Source: drivers/gpu/drm/panel/panel-olimex-lcd-olinuxino.c
#![no_std]
...
pub const LCD_OLINUXINO_HEADER_MAGIC: c_uint = 0x4F4CB727;
pub const LCD_OLINUXINO_DATA_LEN: c_int = 256;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lcd_olinuxino_mode {
    pub pixelclock: u32,
    pub hactive: u32,
    pub hfp: u32,
    pub hbp: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lcd_olinuxino_eeprom {
    pub header: u32,
    pub id: u32,
    pub revision: [c_char; 4],
    pub serial: u32,
    pub info: lcd_olinuxino_info,
    pub num_modes: u32,
    pub reserved: [u8; 180],
    pub checksum: u32,
    pub __attribute__((__packed__)): },
...
pub struct lcd_olinuxino {
    ...
    pub eeprom: lcd_olinuxino_eeprom,
}
...
#[no_mangle]
unsafe extern "C" fn lcd_olinuxino_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lcd_olinuxino_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lcd_olinuxino_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lcd_olinuxino_remove(client: *mut i2c_client) {
