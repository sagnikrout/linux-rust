...
//! Source: drivers/gpu/drm/panel/panel-ilitek-ili9341.c
#![no_std]
...
pub const ILI9341_RGB_INTERFACE: c_uint = 0xb0   /* RGB Interface Signal Control */;
pub const ILI9341_FRC: c_uint = 0xb1   /* Frame Rate Control register */;
pub const ILI9341_DFC: c_uint = 0xb6   /* Display Function Control register */;
pub const ILI9341_POWER1: c_uint = 0xc0   /* Power Control 1 register */;
pub const ILI9341_POWER2: c_uint = 0xc1   /* Power Control 2 register */;
pub const ILI9341_VCOM1: c_uint = 0xc5   /* VCOM Control 1 register */;
pub const ILI9341_VCOM2: c_uint = 0xc7   /* VCOM Control 2 register */;
pub const ILI9341_POWERA: c_uint = 0xcb   /* Power control A register */;
pub const ILI9341_POWERB: c_uint = 0xcf   /* Power control B register */;
pub const ILI9341_PGAMMA: c_uint = 0xe0   /* Positive Gamma Correction register */;
pub const ILI9341_NGAMMA: c_uint = 0xe1   /* Negative Gamma Correction register */;
pub const ILI9341_DTCA: c_uint = 0xe8   /* Driver timing control A */;
pub const ILI9341_DTCB: c_uint = 0xea   /* Driver timing control B */;
pub const ILI9341_POWER_SEQ: c_uint = 0xed   /* Power on sequence register */;
pub const ILI9341_3GAMMA_EN: c_uint = 0xf2   /* 3 Gamma enable register */;
pub const ILI9341_INTERFACE: c_uint = 0xf6   /* Interface control register */;
pub const ILI9341_PRC: c_uint = 0xf7   /* Pump ratio control register */;
pub const ILI9341_ETMOD: c_uint = 0xb7   /* Entry mode set */;

pub const ILI9341_POWER_B_LEN: c_int = 3;
pub const ILI9341_POWER_SEQ_LEN: c_int = 4;
pub const ILI9341_DTCA_LEN: c_int = 3;
pub const ILI9341_DTCB_LEN: c_int = 2;
pub const ILI9341_POWER_A_LEN: c_int = 5;
pub const ILI9341_DFC_1_LEN: c_int = 2;
pub const ILI9341_FRC_LEN: c_int = 2;
pub const ILI9341_VCOM_1_LEN: c_int = 2;
pub const ILI9341_DFC_2_LEN: c_int = 4;
pub const ILI9341_COLUMN_ADDR_LEN: c_int = 4;
pub const ILI9341_PAGE_ADDR_LEN: c_int = 4;
pub const ILI9341_INTERFACE_LEN: c_int = 3;
pub const ILI9341_PGAMMA_LEN: c_int = 15;
pub const ILI9341_NGAMMA_LEN: c_int = 15;
pub const ILI9341_CA_LEN: c_int = 3;

pub const ILI9341_IF_BIG_ENDIAN: c_uint = 0x00;

pub const ILI9341_IF_DM_INTERNAL: c_uint = 0x00;

pub const ILI9341_IF_RIM_RGB: c_uint = 0x00;
pub const ILI9341_COLUMN_ADDR: c_uint = 0x00ef;
pub const ILI9341_PAGE_ADDR: c_uint = 0x013f;

pub const ILI9341_DBI_VCOMH_4P6V: c_uint = 0x23;
pub const ILI9341_DBI_PWR_2_DEFAULT: c_uint = 0x10;
pub const ILI9341_DBI_PRC_NORMAL: c_uint = 0x20;
pub const ILI9341_DBI_VCOM_1_VMH_4P25V: c_uint = 0x3e;
pub const ILI9341_DBI_VCOM_1_VML_1P5V: c_uint = 0x28;
pub const ILI9341_DBI_VCOM_2_DEC_58: c_uint = 0x86;
pub const ILI9341_DBI_FRC_DIVA: c_uint = 0x00;
pub const ILI9341_DBI_FRC_RTNA: c_uint = 0x1b;

// struct ili9341_config - the system specific ILI9341 configuration
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ili9341_config {
    pub max_spi_speed: u32,
// mode: the drm display mode
    pub mode: drm_display_mode,
// ca: TODO: need comments for this register
    pub ca: [u8; ILI9341_CA_LEN],
// power_b: Power control B (CFh)
    pub power_b: [u8; ILI9341_POWER_B_LEN],
// power_seq: Power on sequence control (EDh)
    pub power_seq: [u8; ILI9341_POWER_SEQ_LEN],
// dtca: Driver timing control A (E8h)
    pub dtca: [u8; ILI9341_DTCA_LEN],
// dtcb: Driver timing control B (EAh)
    pub dtcb: [u8; ILI9341_DTCB_LEN],
// power_a: Power control A (CBh)
    pub power_a: [u8; ILI9341_POWER_A_LEN],
// frc: Frame Rate Control (In Normal Mode/Full Colors) (B1h)
    pub frc: [u8; ILI9341_FRC_LEN],
// prc: Pump ratio control (F7h)
    pub prc: u8,
// dfc_1: B6h DISCTRL (Display Function Control)
    pub dfc_1: [u8; ILI9341_DFC_1_LEN],
// power_1: Power Control 1 (C0h)
    pub power_1: u8,
// power_2: Power Control 2 (C1h)
    pub power_2: u8,
// vcom_1: VCOM Control 1(C5h)
    pub vcom_1: [u8; ILI9341_VCOM_1_LEN],
...
// rgb_interface: RGB Interface Signal Control (B0h)
    pub rgb_interface: u8,
// dfc_2: refer to dfc_1
    pub dfc_2: [u8; ILI9341_DFC_2_LEN],
// column_addr: Column Address Set (2Ah)
    pub column_addr: [u8; ILI9341_COLUMN_ADDR_LEN],
// page_addr: Page Address Set (2Bh)
    pub page_addr: [u8; ILI9341_PAGE_ADDR_LEN],
// interface: Interface Control (F6h)
    pub interface: [u8; ILI9341_INTERFACE_LEN],
//
...
// pgamma: Positive Gamma Correction (E0h)
    pub pgamma: [u8; ILI9341_PGAMMA_LEN],
// ngamma: Negative Gamma Correction (E1h)
    pub ngamma: [u8; ILI9341_NGAMMA_LEN],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ili9341 {
    pub conf: *const ili9341_config,
    pub panel: drm_panel,
    pub reset_gpio: *mut gpio_desc,
    pub dc_gpio: *mut gpio_desc,
    pub dbi: *mut mipi_dbi,
    pub max_spi_speed: u32,
...
#[no_mangle]
unsafe extern "C" fn ili9341_dpi_init(ili: *mut ili9341) {
...
#[no_mangle]
unsafe extern "C" fn ili9341_dpi_power_on(ili: *mut ili9341) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9341_dpi_power_off(ili: *mut ili9341) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9341_dpi_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9341_dpi_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9341_dpi_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9341_dpi_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9341_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9341_remove(spi: *mut spi_device) {
