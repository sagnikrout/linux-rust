...
//! Source: drivers/gpu/drm/panel/panel-sharp-ls060t1sx01.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sharp_ls060 {
    pub panel: drm_panel,
    pub dsi: *mut mipi_dsi_device,
    pub vddi_supply: *mut regulator,
    pub vddh_supply: *mut regulator,
    pub avdd_supply: *mut regulator,
    pub avee_supply: *mut regulator,
...
#[no_mangle]
unsafe extern "C" fn sharp_ls060_reset(ctx: *mut sharp_ls060) {
...
#[no_mangle]
unsafe extern "C" fn sharp_ls060_on(ctx: *mut sharp_ls060) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_ls060_off(ctx: *mut sharp_ls060) {
...
#[no_mangle]
unsafe extern "C" fn sharp_ls060_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_ls060_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_ls060_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_ls060_remove(dsi: *mut mipi_dsi_device) {
