...
//! Source: drivers/gpu/drm/panel/panel-samsung-s6e3fa7.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn s6e3fa7_panel_reset(ctx: *mut s6e3fa7_panel) {
...
#[no_mangle]
unsafe extern "C" fn s6e3fa7_panel_on(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fa7_panel_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fa7_panel_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fa7_panel_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fa7_panel_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fa7_panel_bl_get_brightness(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fa7_panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3fa7_panel_remove(dsi: *mut mipi_dsi_device) {
