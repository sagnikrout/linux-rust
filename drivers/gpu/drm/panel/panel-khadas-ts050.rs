...
//! Source: drivers/gpu/drm/panel/panel-khadas-ts050.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct khadas_ts050_panel {
    pub base: drm_panel,
    pub link: *mut mipi_dsi_device,
    pub supply: *mut regulator,
    pub reset_gpio: *mut gpio_desc,
    pub enable_gpio: *mut gpio_desc,
    pub panel_data: *mut khadas_ts050_panel_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct khadas_ts050_panel_cmd {
    pub cmd: u8,
    pub data: [u8; 55],
    pub size: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct khadas_ts050_panel_data {
    pub init_code: *mut khadas_ts050_panel_cmd,
    pub len: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn khadas_ts050_panel_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn khadas_ts050_panel_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn khadas_ts050_panel_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn khadas_ts050_panel_add(khadas_ts050: *mut khadas_ts050_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn khadas_ts050_panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn khadas_ts050_panel_remove(dsi: *mut mipi_dsi_device) {
