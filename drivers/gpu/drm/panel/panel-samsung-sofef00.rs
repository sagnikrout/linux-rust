...
//! Source: drivers/gpu/drm/panel/panel-samsung-sofef00.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sofef00_panel_reset(ctx: *mut sofef00_panel) {
...
#[no_mangle]
unsafe extern "C" fn sofef00_panel_on(ctx: *mut sofef00_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sofef00_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sofef00_panel_off(ctx: *mut sofef00_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sofef00_panel_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sofef00_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sofef00_panel_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sofef00_panel_get_modes(panel: *mut drm_panel, connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sofef00_panel_bl_update_status(bl: *mut backlight_device) -> c_int {
    ...
    int err;
    let mut brightness: u16 = (u16)backlight_get_brightness(bl);
...
#[no_mangle]
unsafe extern "C" fn sofef00_panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sofef00_panel_remove(dsi: *mut mipi_dsi_device) {
