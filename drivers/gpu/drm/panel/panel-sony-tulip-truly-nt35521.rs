...
//! Source: drivers/gpu/drm/panel/panel-sony-tulip-truly-nt35521.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct truly_nt35521 {
    pub panel: drm_panel,
    pub dsi: *mut mipi_dsi_device,
    pub supplies: [regulator_bulk_data; 2],
    pub reset_gpio: *mut gpio_desc,
    pub blen_gpio: *mut gpio_desc,
}

pub const NT35521_DCS_SWITCH_PAGE: c_uint = 0xf0;
...
#[no_mangle]
unsafe extern "C" fn truly_nt35521_reset(ctx: *mut truly_nt35521) {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35521_on(ctx: *mut truly_nt35521) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35521_off(ctx: *mut truly_nt35521) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35521_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35521_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35521_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35521_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35521_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35521_bl_get_brightness(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35521_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35521_remove(dsi: *mut mipi_dsi_device) {
