...
//! Source: drivers/gpu/drm/panel/panel-raydium-rm69380.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rm69380_reset(ctx: *mut rm69380_panel) {
...
#[no_mangle]
unsafe extern "C" fn rm69380_on(ctx: *mut rm69380_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rm69380_off(ctx: *mut rm69380_panel) {
...
#[no_mangle]
unsafe extern "C" fn rm69380_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rm69380_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rm69380_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rm69380_bl_get_brightness(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rm69380_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rm69380_remove(dsi: *mut mipi_dsi_device) {
