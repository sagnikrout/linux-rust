...
//! Source: drivers/gpu/drm/panel/panel-dsi-cm.c
#![no_std]
...
pub const DCS_REGULATOR_SUPPLY_NUM: c_int = 2;
    static const struct of_device_id dsicm_of_match[];
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dsic_panel_data {
    pub xres: u32,
    pub yres: u32,
    pub refresh: u32,
    pub width_mm: u32,
...
pub struct panel_drv_data {
    ...
    pub extbldev: *mut backlight_device,
...
//
    ...
    pub panel_data: *const dsic_panel_data,
    pub reset_gpio: *mut gpio_desc,
    pub supplies: [regulator_bulk_data; DCS_REGULATOR_SUPPLY_NUM],
...
#[no_mangle]
unsafe extern "C" fn dsicm_bl_power(ddata: *mut panel_drv_data, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ddata->extbldev) -> else {
...
#[no_mangle]
unsafe extern "C" fn dsicm_set_update_window(ddata: *mut panel_drv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsicm_power_off(ddata: *mut panel_drv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsicm_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsicm_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsicm_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsicm_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsicm_probe_of(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsicm_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsicm_remove(dsi: *mut mipi_dsi_device) {
