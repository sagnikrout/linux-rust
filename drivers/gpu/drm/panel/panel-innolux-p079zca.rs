...
//! Source: drivers/gpu/drm/panel/panel-innolux-p079zca.c
#![no_std]
...
pub struct panel_desc {
    ...
    pub innolux): *mut *mut int (init)(struct innolux_panel,
    pub lanes: c_uint,
    pub supply_names: *const *const c_char,
    pub num_supplies: c_uint,
    pub sleep_mode_delay: c_uint,
    pub power_down_delay: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct innolux_panel {
    pub base: drm_panel,
...
#[no_mangle]
unsafe extern "C" fn innolux_panel_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn innolux_panel_prepare(panel: *mut drm_panel) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn innolux_p097pfg_init(innolux: *mut innolux_panel) -> c_int {
    static int innolux_p097pfg_init(struct innolux_panel *innolux)
    {
    let mut ctx: mipi_dsi_multi_context = { .dsi = innolux.link };
    ...
    innolux.enable_gpio = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn innolux_panel_del(innolux: *mut innolux_panel) {
    static void innolux_panel_del(struct innolux_panel *innolux)
    {
    drm_panel_remove(&innolux.base);
    }
#[no_mangle]
unsafe extern "C" fn innolux_panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn innolux_panel_remove(dsi: *mut mipi_dsi_device) {
