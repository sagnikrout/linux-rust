...
//! Source: drivers/gpu/drm/panel/panel-samsung-s6e3ha2.c
#![no_std]
...
pub const S6E3HA2_MIN_BRIGHTNESS: c_int = 0;
pub const S6E3HA2_MAX_BRIGHTNESS: c_int = 100;
pub const S6E3HA2_DEFAULT_BRIGHTNESS: c_int = 80;
pub const S6E3HA2_NUM_GAMMA_STEPS: c_int = 46;
pub const S6E3HA2_GAMMA_CMD_CNT: c_int = 35;
pub const S6E3HA2_VINT_STATUS_MAX: c_int = 10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s6e3ha2_panel_desc {
    pub mode: *const drm_display_mode,
    pub type: enum s6e3ha2_type,
}
...
pub struct s6e3ha2 {
    ...
    pub desc: *const s6e3ha2_panel_desc,
}

#[no_mangle]
unsafe extern "C" fn s6e3ha2_dcs_write(ctx: *mut s6e3ha2, data: *const c_void, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_test_key_on_f0(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_test_key_off_f0(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_test_key_on_fc(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_test_key_off_fc(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_single_dsi_set(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_freq_calibration(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_aor_control(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_caps_elvss_set(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_acl_off(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_acl_off_opr(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_test_global(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_test(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_touch_hsync_on1(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_pentile_control(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_poc_global(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_poc_setting(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_pcd_set_off(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_err_fg_set(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_hbm_off(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_te_start_setting(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_gamma_update(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_get_brightness(bl_dev: *mut backlight_device) -> c_int {
    static int s6e3ha2_get_brightness(struct backlight_device *bl_dev)
    {
    return bl_dev.props.brightness;
    }
#[no_mangle]
unsafe extern "C" fn s6e3ha2_set_vint(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_get_brightness_index(brightness: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_update_gamma(ctx: *mut s6e3ha2, brightness: c_uint) -> c_int {
    static int s6e3ha2_update_gamma(struct s6e3ha2 *ctx, unsigned int brightness)
    {
    struct backlight_device *bl_dev = ctx.bl_dev;
    let mut index: c_uint = s6e3ha2_get_brightness_index(brightness);
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_set_brightness(bl_dev: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_panel_init(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_power_off(ctx: *mut s6e3ha2) -> c_int {
    static int s6e3ha2_power_off(struct s6e3ha2 *ctx)
    {
    return regulator_bulk_disable(ARRAY_SIZE(ctx.supplies), ctx.supplies);
    }
#[no_mangle]
unsafe extern "C" fn s6e3ha2_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_power_on(ctx: *mut s6e3ha2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_probe(dsi: *mut mipi_dsi_device) -> c_int {
    ...
    &s6e3ha2_bl_ops, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn s6e3ha2_remove(dsi: *mut mipi_dsi_device) {
