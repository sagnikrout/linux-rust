...
//! Source: drivers/gpu/drm/panel/panel-novatek-nt36536.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn novatek_reset(ctx: *mut novatek) {
...
#[no_mangle]
unsafe extern "C" fn novatek_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn novatek_off(dsi_ctx: *mut mipi_dsi_multi_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn novatek_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn novatek_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn csot_pp8807hb1_1_init_seq(dsi_ctx: *mut mipi_dsi_multi_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn novatek_probe(dsi: *mut mipi_dsi_device) -> c_int {
