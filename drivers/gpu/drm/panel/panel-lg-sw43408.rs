...
//! Source: drivers/gpu/drm/panel/panel-lg-sw43408.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sw43408_unprepare(panel: *mut drm_panel) -> c_int {
    static int sw43408_unprepare(struct drm_panel *panel)
    {
    struct sw43408_panel *sw43408 = to_panel_info(panel);
    let mut ctx: mipi_dsi_multi_context = { .dsi = sw43408.link };
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sw43408_program(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sw43408_reset(ctx: *mut sw43408_panel) {
...
#[no_mangle]
unsafe extern "C" fn sw43408_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sw43408_backlight_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sw43408_backlight_init(ctx: *mut sw43408_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sw43408_add(ctx: *mut sw43408_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sw43408_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sw43408_remove(dsi: *mut mipi_dsi_device) {
