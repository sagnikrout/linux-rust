...
//! Source: drivers/gpu/drm/panel/panel-visionox-g2647fb105.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct visionox_g2647fb105 {
    pub panel: drm_panel,
...
#[no_mangle]
unsafe extern "C" fn visionox_g2647fb105_reset(ctx: *mut visionox_g2647fb105) {
...
#[no_mangle]
unsafe extern "C" fn visionox_g2647fb105_on(ctx: *mut visionox_g2647fb105) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_g2647fb105_off(ctx: *mut visionox_g2647fb105) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_g2647fb105_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_g2647fb105_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_g2647fb105_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_g2647fb105_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_g2647fb105_remove(dsi: *mut mipi_dsi_device) {
