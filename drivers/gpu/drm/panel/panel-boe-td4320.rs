...
//! Source: drivers/gpu/drm/panel/panel-boe-td4320.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn boe_td4320_reset(ctx: *mut boe_td4320) {
...
#[no_mangle]
unsafe extern "C" fn boe_td4320_on(ctx: *mut boe_td4320) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_td4320_off(ctx: *mut boe_td4320) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_td4320_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_td4320_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_td4320_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_td4320_remove(dsi: *mut mipi_dsi_device) {
