...
//! Source: drivers/gpu/drm/panel/panel-ilitek-ili9806e-spi.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ili9806e_spi_panel {
    pub spi: *mut spi_device,
    pub dbi: mipi_dbi,
    pub desc: *const ili9806e_spi_panel_desc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ili9806e_spi_panel_desc {
    pub display_mode: *const drm_display_mode,
    pub bus_format: u32,
    pub bus_flags: u32,
    pub ctx): *mut *mut void (init_sequence)(struct ili9806e_spi_panel,
}

#[no_mangle]
unsafe extern "C" fn ili9806e_spi_off(ctx: *mut ili9806e_spi_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9806e_spi_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9806e_spi_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9806e_spi_probe(spi: *mut spi_device) -> c_int {
    ...
    err = mipi_dbi_spi_init(spi, &ctx.dbi, core::ptr::null_mut());
    if (err)
...
#[no_mangle]
unsafe extern "C" fn ili9806e_spi_remove(spi: *mut spi_device) {
    static void ili9806e_spi_remove(struct spi_device *spi)
    {
    ili9806e_remove(&spi.dev);
    }
#[no_mangle]
unsafe extern "C" fn rk050hr345_ct106a_init(ctx: *mut ili9806e_spi_panel) {
