...
//! Source: drivers/gpu/drm/panel/panel-orisetech-otm8009a.c
#![no_std]
...
pub const OTM8009A_BACKLIGHT_DEFAULT: c_int = 240;
pub const OTM8009A_BACKLIGHT_MAX: c_int = 255;
// Manufacturer Command Set
pub const MCS_ADRSFT: c_uint = 0x0000	/* Address Shift Function */;
pub const MCS_PANSET: c_uint = 0xB3A6	/* Panel Type Setting */;
pub const MCS_SD_CTRL: c_uint = 0xC0A2	/* Source Driver Timing Setting */;
pub const MCS_P_DRV_M: c_uint = 0xC0B4	/* Panel Driving Mode */;
pub const MCS_OSC_ADJ: c_uint = 0xC181	/* Oscillator Adjustment for Idle/Normal mode */;
pub const MCS_RGB_VID_SET: c_uint = 0xC1A1	/* RGB Video Mode Setting */;
pub const MCS_SD_PCH_CTRL: c_uint = 0xC480	/* Source Driver Precharge Control */;
pub const MCS_NO_DOC1: c_uint = 0xC48A	/* Command not documented */;
pub const MCS_PWR_CTRL1: c_uint = 0xC580	/* Power Control Setting 1 */;
pub const MCS_PWR_CTRL2: c_uint = 0xC590	/* Power Control Setting 2 for Normal Mode */;
pub const MCS_PWR_CTRL4: c_uint = 0xC5B0	/* Power Control Setting 4 for DC Voltage */;
pub const MCS_PANCTRLSET1: c_uint = 0xCB80	/* Panel Control Setting 1 */;
pub const MCS_PANCTRLSET2: c_uint = 0xCB90	/* Panel Control Setting 2 */;
pub const MCS_PANCTRLSET3: c_uint = 0xCBA0	/* Panel Control Setting 3 */;
pub const MCS_PANCTRLSET4: c_uint = 0xCBB0	/* Panel Control Setting 4 */;
pub const MCS_PANCTRLSET5: c_uint = 0xCBC0	/* Panel Control Setting 5 */;
pub const MCS_PANCTRLSET6: c_uint = 0xCBD0	/* Panel Control Setting 6 */;
pub const MCS_PANCTRLSET7: c_uint = 0xCBE0	/* Panel Control Setting 7 */;
pub const MCS_PANCTRLSET8: c_uint = 0xCBF0	/* Panel Control Setting 8 */;
pub const MCS_PANU2D1: c_uint = 0xCC80	/* Panel U2D Setting 1 */;
pub const MCS_PANU2D2: c_uint = 0xCC90	/* Panel U2D Setting 2 */;
pub const MCS_PANU2D3: c_uint = 0xCCA0	/* Panel U2D Setting 3 */;
pub const MCS_PAND2U1: c_uint = 0xCCB0	/* Panel D2U Setting 1 */;
pub const MCS_PAND2U2: c_uint = 0xCCC0	/* Panel D2U Setting 2 */;
pub const MCS_PAND2U3: c_uint = 0xCCD0	/* Panel D2U Setting 3 */;
pub const MCS_GOAVST: c_uint = 0xCE80	/* GOA VST Setting */;
pub const MCS_GOACLKA1: c_uint = 0xCEA0	/* GOA CLKA1 Setting */;
pub const MCS_GOACLKA3: c_uint = 0xCEB0	/* GOA CLKA3 Setting */;
pub const MCS_GOAECLK: c_uint = 0xCFC0	/* GOA ECLK Setting */;
pub const MCS_NO_DOC2: c_uint = 0xCFD0	/* Command not documented */;
pub const MCS_GVDDSET: c_uint = 0xD800	/* GVDD/NGVDD */;
pub const MCS_VCOMDC: c_uint = 0xD900	/* VCOM Voltage Setting */;
pub const MCS_GMCT2_2P: c_uint = 0xE100	/* Gamma Correction 2.2+ Setting */;
pub const MCS_GMCT2_2N: c_uint = 0xE200	/* Gamma Correction 2.2- Setting */;
pub const MCS_NO_DOC3: c_uint = 0xF5B6	/* Command not documented */;
pub const MCS_CMD2_ENA1: c_uint = 0xFF00	/* Enable Access Command2 "CMD2" */;
pub const MCS_CMD2_ENA2: c_uint = 0xFF80	/* Enable Access Orise Command2 */;
pub const OTM8009A_HDISPLAY: c_int = 480;
pub const OTM8009A_VDISPLAY: c_int = 800;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct otm8009a {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn otm8009a_init_sequence(ctx: *mut otm8009a) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otm8009a_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otm8009a_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otm8009a_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otm8009a_enable(panel: *mut drm_panel) -> c_int {
    ...
    let mut num_modes: c_uint = ARRAY_SIZE(modes);
    unsigned int i;
...
//
#[no_mangle]
unsafe extern "C" fn otm8009a_backlight_update_status(bd: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otm8009a_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otm8009a_remove(dsi: *mut mipi_dsi_device) {
