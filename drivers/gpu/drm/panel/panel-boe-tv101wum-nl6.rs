...
//! Source: drivers/gpu/drm/panel/panel-boe-tv101wum-nl6.c
#![no_std]
...
pub const NT36523_DCS_SWITCH_PAGE: c_uint = 0xff;

    mipi_dsi_dcs_write_seq_multi(ctx, NT36523_DCS_SWITCH_PAGE, (page))
#[no_mangle]
unsafe extern "C" fn nt36523_enable_reload_cmds(ctx: *mut mipi_dsi_multi_context) {
    static void nt36523_enable_reload_cmds(struct mipi_dsi_multi_context *ctx)
    {
    mipi_dsi_dcs_write_seq_multi(ctx, 0xfb, 0x01);
    }
#[no_mangle]
unsafe extern "C" fn boe_tv110c9m_init(boe: *mut boe_panel) -> c_int {
    static int boe_tv110c9m_init(struct boe_panel *boe)
    {
    let mut ctx: mipi_dsi_multi_context = { .dsi = boe.dsi };
...
#[no_mangle]
unsafe extern "C" fn inx_hj110iz_init(boe: *mut boe_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_init(boe: *mut boe_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn auo_kd101n80_45na_init(boe: *mut boe_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn auo_b101uan08_3_init(boe: *mut boe_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starry_qfh032011_53g_init(boe: *mut boe_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_panel_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_panel_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_panel_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_panel_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_panel_get_orientation(panel: *mut drm_panel) -> enum drm_panel_orientation {
...
#[no_mangle]
unsafe extern "C" fn boe_panel_add(boe: *mut boe_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_panel_remove(dsi: *mut mipi_dsi_device) {
