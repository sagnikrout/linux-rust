...
//! Source: drivers/gpu/drm/panel/panel-nec-nl8048hl11.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nl8048_init(lcd: *mut nl8048_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nl8048_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nl8048_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nl8048_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn nl8048_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn nl8048_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nl8048_remove(spi: *mut spi_device) {
