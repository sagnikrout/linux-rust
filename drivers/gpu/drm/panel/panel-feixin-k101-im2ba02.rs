...
//! Source: drivers/gpu/drm/panel/panel-feixin-k101-im2ba02.c
#![no_std]
...
pub const K101_IM2BA02_INIT_CMD_LEN: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k101_im2ba02_init_cmd {
    pub data: [u8; K101_IM2BA02_INIT_CMD_LEN],
}
...
#[no_mangle]
unsafe extern "C" fn k101_im2ba02_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k101_im2ba02_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k101_im2ba02_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k101_im2ba02_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k101_im2ba02_dsi_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k101_im2ba02_dsi_remove(dsi: *mut mipi_dsi_device) {
