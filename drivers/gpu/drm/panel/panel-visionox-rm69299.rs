...
//! Source: drivers/gpu/drm/panel/panel-visionox-rm69299.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct visionox_rm69299_panel_desc {
    pub mode: *const drm_display_mode,
    pub init_seq: *const u8,
    pub init_seq_len: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct visionox_rm69299 {
    pub panel: drm_panel,
    pub supplies: *mut regulator_bulk_data,
    pub reset_gpio: *mut gpio_desc,
    pub dsi: *mut mipi_dsi_device,
    pub desc: *const visionox_rm69299_panel_desc,
}
...
#[no_mangle]
unsafe extern "C" fn visionox_rm69299_power_on(ctx: *mut visionox_rm69299) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_rm69299_power_off(ctx: *mut visionox_rm69299) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_rm69299_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_rm69299_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_rm69299_bl_get_brightness(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_rm69299_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_rm69299_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visionox_rm69299_remove(dsi: *mut mipi_dsi_device) {
