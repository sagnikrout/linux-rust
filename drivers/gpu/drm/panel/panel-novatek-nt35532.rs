...
//! Source: drivers/gpu/drm/panel/panel-novatek-nt35532.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct novatek_nt35532 {
    pub panel: drm_panel,
    pub dsi: *mut mipi_dsi_device,
    pub supplies: *mut regulator_bulk_data,
    pub reset_gpio: *mut gpio_desc,
    pub desc: *const nt35532_panel_desc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nt35532_panel_desc {
    pub mode: *const drm_display_mode,
    pub ctx): *mut *mut int (on)(struct novatek_nt35532,
}
...
#[no_mangle]
unsafe extern "C" fn nt35532_reset(ctx: *mut novatek_nt35532) {
...
#[no_mangle]
unsafe extern "C" fn rimob_panel_on(ctx: *mut novatek_nt35532) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt35532_off(ctx: *mut novatek_nt35532) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt35532_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt35532_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt35532_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt35532_remove(dsi: *mut mipi_dsi_device) {
