...
//! Source: drivers/gpu/drm/panel/panel-samsung-s6e8aa5x01-ams561ra01.c
#![no_std]
...
pub const MCS_AIDCTL: c_uint = 0xb2;
pub const MCS_ADAPTIVECTL: c_uint = 0xb5;
pub const MCS_ELVSS: c_uint = 0xb6;
pub const MCS_TEMPERCTL: c_uint = 0xb8;
pub const MCS_PENTILE: c_uint = 0xc0;
pub const MCS_GAMMACTL: c_uint = 0xca;
pub const MCS_LTPSCTL: c_uint = 0xcb;
pub const MCS_PCD: c_uint = 0xcc;
pub const MCS_ERRFLAG: c_uint = 0xe7;
pub const MCS_ACCESSPROT: c_uint = 0xf0;
pub const MCS_DISPCTL: c_uint = 0xf2;
pub const MCS_GAMMAUPD: c_uint = 0xf7;
pub const GAMMA_CMD_LEN: c_int = 34;
pub const AID_CMD_LEN: c_int = 3;
    static const struct {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s6e8aa5x01_ams561ra01_ctx {
    pub panel: drm_panel,
...
#[no_mangle]
unsafe extern "C" fn s6e8aa5x01_ams561ra01_update_status(bl: *mut backlight_device) -> c_int {
    ...
    let mut lvl: u16 = backlight_get_brightness(bl);
...
#[no_mangle]
unsafe extern "C" fn s6e8aa5x01_ams561ra01_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa5x01_ams561ra01_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa5x01_ams561ra01_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa5x01_ams561ra01_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa5x01_ams561ra01_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa5x01_ams561ra01_remove(dsi: *mut mipi_dsi_device) {
