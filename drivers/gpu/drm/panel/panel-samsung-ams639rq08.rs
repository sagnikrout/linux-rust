...
//! Source: drivers/gpu/drm/panel/panel-samsung-ams639rq08.c
#![no_std]
...
pub const MCS_ACCESS_PROT_OFF: c_uint = 0xb0;
pub const MCS_UNKNOWN_B7: c_uint = 0xb7;
pub const MCS_BIAS_CURRENT_CTRL: c_uint = 0xd1;
pub const MCS_PASSWD1: c_uint = 0xf0;
pub const MCS_PASSWD2: c_uint = 0xfc;
pub const MCS_UNKNOWN_FF: c_uint = 0xff;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ams639rq08 {
    pub panel: drm_panel,
...
#[no_mangle]
unsafe extern "C" fn ams639rq08_reset(ctx: *mut ams639rq08) {
...
#[no_mangle]
unsafe extern "C" fn ams639rq08_on(ctx: *mut ams639rq08) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ams639rq08_off(ctx: *mut ams639rq08) {
...
#[no_mangle]
unsafe extern "C" fn ams639rq08_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ams639rq08_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ams639rq08_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ams639rq08_bl_get_brightness(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ams639rq08_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ams639rq08_remove(dsi: *mut mipi_dsi_device) {
