...
//! Source: drivers/gpu/drm/panel/panel-kingdisplay-kd097d04.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kingdisplay_panel_cmd {
    pub cmd: c_char,
    pub data: c_char,
}
...
#[no_mangle]
unsafe extern "C" fn kingdisplay_panel_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kingdisplay_panel_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kingdisplay_panel_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kingdisplay_panel_add(kingdisplay: *mut kingdisplay_panel) -> c_int {
    ...
    kingdisplay.enable_gpio = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn kingdisplay_panel_del(kingdisplay: *mut kingdisplay_panel) {
    static void kingdisplay_panel_del(struct kingdisplay_panel *kingdisplay)
    {
    drm_panel_remove(&kingdisplay.base);
    }
#[no_mangle]
unsafe extern "C" fn kingdisplay_panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kingdisplay_panel_remove(dsi: *mut mipi_dsi_device) {
