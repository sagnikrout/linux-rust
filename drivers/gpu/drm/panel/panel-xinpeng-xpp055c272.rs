...
//! Source: drivers/gpu/drm/panel/panel-xinpeng-xpp055c272.c
#![no_std]
...
pub const XPP055C272_CMD_ALL_PIXEL_OFF: c_uint = 0x22;
pub const XPP055C272_CMD_ALL_PIXEL_ON: c_uint = 0x23;
pub const XPP055C272_CMD_SETDISP: c_uint = 0xb2;
pub const XPP055C272_CMD_SETRGBIF: c_uint = 0xb3;
pub const XPP055C272_CMD_SETCYC: c_uint = 0xb4;
pub const XPP055C272_CMD_SETBGP: c_uint = 0xb5;
pub const XPP055C272_CMD_SETVCOM: c_uint = 0xb6;
pub const XPP055C272_CMD_SETOTP: c_uint = 0xb7;
pub const XPP055C272_CMD_SETPOWER_EXT: c_uint = 0xb8;
pub const XPP055C272_CMD_SETEXTC: c_uint = 0xb9;
pub const XPP055C272_CMD_SETMIPI: c_uint = 0xbA;
pub const XPP055C272_CMD_SETVDC: c_uint = 0xbc;
pub const XPP055C272_CMD_SETPCR: c_uint = 0xbf;
pub const XPP055C272_CMD_SETSCR: c_uint = 0xc0;
pub const XPP055C272_CMD_SETPOWER: c_uint = 0xc1;
pub const XPP055C272_CMD_SETECO: c_uint = 0xc6;
pub const XPP055C272_CMD_SETPANEL: c_uint = 0xcc;
pub const XPP055C272_CMD_SETGAMMA: c_uint = 0xe0;
pub const XPP055C272_CMD_SETEQ: c_uint = 0xe3;
pub const XPP055C272_CMD_SETGIP1: c_uint = 0xe9;
pub const XPP055C272_CMD_SETGIP2: c_uint = 0xea;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xpp055c272 {
    pub dev: *mut device,
    pub panel: drm_panel,
    pub reset_gpio: *mut gpio_desc,
    pub vci: *mut regulator,
...
#[no_mangle]
unsafe extern "C" fn xpp055c272_init_sequence(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn xpp055c272_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xpp055c272_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xpp055c272_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xpp055c272_remove(dsi: *mut mipi_dsi_device) {
