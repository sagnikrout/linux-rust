...
//! Source: drivers/gpu/drm/panel/panel-novatek-nt36672e.c
#![no_std]
...
pub const NT36672E_DCS_SWITCH_PAGE: c_uint = 0xff;

    mipi_dsi_dcs_write_seq_multi(ctx, NT36672E_DCS_SWITCH_PAGE, (page))
#[no_mangle]
unsafe extern "C" fn nt36672e_enable_reload_cmds(ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn nt36672e_1080x2408_60hz_init(ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn nt36672e_power_on(ctx: *mut nt36672e_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36672e_power_off(ctx: *mut nt36672e_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36672e_on(nt36672e: *mut nt36672e_panel) -> c_int {
    static int nt36672e_on(struct nt36672e_panel *nt36672e)
    {
    let mut ctx: mipi_dsi_multi_context = { .dsi = nt36672e.dsi };
...
#[no_mangle]
unsafe extern "C" fn nt36672e_off(panel: *mut nt36672e_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36672e_panel_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36672e_panel_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36672e_panel_get_modes(panel: *mut drm_panel, connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36672e_panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt36672e_panel_remove(dsi: *mut mipi_dsi_device) {
