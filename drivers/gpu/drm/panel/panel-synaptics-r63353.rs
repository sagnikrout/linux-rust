...
//! Source: drivers/gpu/drm/panel/panel-synaptics-r63353.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct r63353_desc {
    pub name: *const c_char,
    pub init: *const r63353_instr,
...
#[no_mangle]
unsafe extern "C" fn r63353_panel_power_on(rpanel: *mut r63353_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r63353_panel_power_off(rpanel: *mut r63353_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r63353_panel_activate(rpanel: *mut r63353_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r63353_panel_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r63353_panel_deactivate(rpanel: *mut r63353_panel) {
...
#[no_mangle]
unsafe extern "C" fn r63353_panel_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r63353_panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r63353_panel_remove(dsi: *mut mipi_dsi_device) {
...
#[no_mangle]
unsafe extern "C" fn r63353_panel_shutdown(dsi: *mut mipi_dsi_device) {
