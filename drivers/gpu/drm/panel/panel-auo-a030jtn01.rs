...
//! Source: drivers/gpu/drm/panel/panel-auo-a030jtn01.c
#![no_std]
...
pub const REG05: c_uint = 0x05;
pub const REG06: c_uint = 0x06;
pub const REG07: c_uint = 0x07;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct a030jtn01_info {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct a030jtn01 {
    pub panel: drm_panel,
    pub spi: *mut spi_device,
    pub map: *mut regmap,
    pub panel_info: *const a030jtn01_info,
...
#[no_mangle]
unsafe extern "C" fn a030jtn01_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn a030jtn01_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn a030jtn01_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn a030jtn01_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn a030jtn01_has_reg(dev: *mut device, reg: c_uint) -> bool {
    static bool a030jtn01_has_reg(struct device *dev, unsigned int reg)
    {
    let mut a030jtn01_regs_mask: static u32 = 0x001823f1fb;
...
#[no_mangle]
unsafe extern "C" fn a030jtn01_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn a030jtn01_remove(spi: *mut spi_device) {
