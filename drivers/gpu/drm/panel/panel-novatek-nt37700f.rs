...
//! Source: drivers/gpu/drm/panel/panel-novatek-nt37700f.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nt37700f_tianma_reset(ctx: *mut nt37700f_tianma) {
...
#[no_mangle]
unsafe extern "C" fn nt37700f_tianma_on(ctx: *mut nt37700f_tianma) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt37700f_tianma_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt37700f_tianma_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt37700f_tianma_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt37700f_tianma_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt37700f_tianma_bl_get_brightness(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt37700f_tianma_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt37700f_tianma_remove(dsi: *mut mipi_dsi_device) {
