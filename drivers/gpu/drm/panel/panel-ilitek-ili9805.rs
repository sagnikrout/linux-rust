...
//! Source: drivers/gpu/drm/panel/panel-ilitek-ili9805.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ili9805_desc {
    pub ctx): *mut *mut void (init)(struct mipi_dsi_multi_context,
...
#[no_mangle]
unsafe extern "C" fn gpm1780a0_init(ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn tm041xdhg01_init(ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn ili9805_power_on(ctx: *mut ili9805) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9805_power_off(ctx: *mut ili9805) {
...
#[no_mangle]
unsafe extern "C" fn ili9805_activate(ctx: *mut ili9805) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9805_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9805_deactivate(ctx: *mut ili9805) {
...
#[no_mangle]
unsafe extern "C" fn ili9805_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9805_dsi_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9805_dsi_remove(dsi: *mut mipi_dsi_device) {
