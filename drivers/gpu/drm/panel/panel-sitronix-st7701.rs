...
//! Source: drivers/gpu/drm/panel/panel-sitronix-st7701.c
#![no_std]
...
pub const ST7701_CMD2BKX_SEL: c_uint = 0xFF;
pub const ST7701_CMD1: c_int = 0;

// Command2, BK0 commands
pub const ST7701_CMD2_BK0_PVGAMCTRL: c_uint = 0xB0 /* Positive Voltage Gamma Control */;
pub const ST7701_CMD2_BK0_NVGAMCTRL: c_uint = 0xB1 /* Negative Voltage Gamma Control */;
pub const ST7701_CMD2_BK0_LNESET: c_uint = 0xC0 /* Display Line setting */;
pub const ST7701_CMD2_BK0_PORCTRL: c_uint = 0xC1 /* Porch control */;
pub const ST7701_CMD2_BK0_INVSEL: c_uint = 0xC2 /* Inversion selection, Frame Rate Control */;
// Command2, BK1 commands
pub const ST7701_CMD2_BK1_VRHS: c_uint = 0xB0 /* Vop amplitude setting */;
pub const ST7701_CMD2_BK1_VCOM: c_uint = 0xB1 /* VCOM amplitude setting */;
pub const ST7701_CMD2_BK1_VGHSS: c_uint = 0xB2 /* VGH Voltage setting */;
pub const ST7701_CMD2_BK1_TESTCMD: c_uint = 0xB3 /* TEST Command Setting */;
pub const ST7701_CMD2_BK1_VGLS: c_uint = 0xB5 /* VGL Voltage setting */;
pub const ST7701_CMD2_BK1_PWCTLR1: c_uint = 0xB7 /* Power Control 1 */;
pub const ST7701_CMD2_BK1_PWCTLR2: c_uint = 0xB8 /* Power Control 2 */;
pub const ST7701_CMD2_BK1_SPD1: c_uint = 0xC1 /* Source pre_drive timing set1 */;
pub const ST7701_CMD2_BK1_SPD2: c_uint = 0xC2 /* Source EQ2 Setting */;
pub const ST7701_CMD2_BK1_MIPISET1: c_uint = 0xD0 /* MIPI Setting 1 */;
// Command2, BK0 bytes
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st7701_panel_desc {
    pub mode: *const drm_display_mode,
    pub lanes: c_uint,
    pub format: enum mipi_dsi_pixel_format,
    pub panel_sleep_delay: c_uint,
// TFT matrix driver configuration, panel specific.
    pub /: *const *const u8 pv_gamma[16]; / Positive voltage gamma control,
    pub /: *const *const u8 nv_gamma[16]; / Negative voltage gamma control,
    pub /: *const *const u8 nlinv; / Inversion selection,
    pub /: *const *const u32 vop_uv; / Vop in uV,
    pub /: *const *const u32 vcom_uv; / Vcom in uV,
    pub /: *const *const u16 vgh_mv; / Vgh in mV,
    pub /: *const *const s16 vgl_mv; / Vgl in mV,
    pub /: *const *const u16 avdd_mv; / Avdd in mV,
    pub /: *const *const s16 avcl_mv; / Avcl in mV,
    pub gamma_op_bias: enum op_bias,
    pub input_op_bias: enum op_bias,
    pub output_op_bias: enum op_bias,
    pub /: *const *const u16 t2d_ns; / T2D in ns,
    pub /: *const *const u16 t3d_ns; / T3D in ns,
    pub eot_en: bool,
// GIP sequence, fully custom and undocumented.
    pub st7701): *mut *mut void (gip_sequence)(struct st7701,
}
...
#[no_mangle]
unsafe extern "C" fn st7701_vgls_map(st7701: *mut st7701) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn st7701_switch_cmd_bkx(st7701: *mut st7701, cmd2: bool, bkx: u8) {
...
#[no_mangle]
unsafe extern "C" fn st7701_init_sequence(st7701: *mut st7701) {
    static void st7701_init_sequence(struct st7701 *st7701)
    {
    const struct st7701_panel_desc *desc = st7701.desc;
    const struct drm_display_mode *mode = desc.mode;
    let mut linecount8: u8 = mode.vdisplay / 8;
    let mut linecountrem2: u8 = (mode.vdisplay % 8) / 2;
...
#[no_mangle]
unsafe extern "C" fn ts8550b_gip_sequence(st7701: *mut st7701) {
...
#[no_mangle]
unsafe extern "C" fn dmt028vghmcmi_1a_gip_sequence(st7701: *mut st7701) {
...
#[no_mangle]
unsafe extern "C" fn kd50t048a_gip_sequence(st7701: *mut st7701) {
...
#[no_mangle]
unsafe extern "C" fn rg_arc_gip_sequence(st7701: *mut st7701) {
...
#[no_mangle]
unsafe extern "C" fn rg28xx_gip_sequence(st7701: *mut st7701) {
...
#[no_mangle]
unsafe extern "C" fn wf40eswaa6mnn0_gip_sequence(st7701: *mut st7701) {
...
#[no_mangle]
unsafe extern "C" fn st7701_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7701_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7701_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7701_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7701_get_orientation(panel: *mut drm_panel) -> enum drm_panel_orientation {
...
#[no_mangle]
unsafe extern "C" fn st7701_cleanup(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn st7701_probe(dev: *mut device, connector_type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7701_dsi_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7701_spi_probe(spi: *mut spi_device) -> c_int {
    ...
    st7701.dbi.read_commands = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn st7701_dsi_remove(dsi: *mut mipi_dsi_device) {
...
#[no_mangle]
unsafe extern "C" fn st7701_driver_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn st7701_driver_exit() -> void __exit {
