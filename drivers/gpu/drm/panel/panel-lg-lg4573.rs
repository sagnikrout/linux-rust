...
//! Source: drivers/gpu/drm/panel/panel-lg-lg4573.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lg4573_spi_write_u16(ctx: *mut lg4573, data: u16) -> c_int {
    static int lg4573_spi_write_u16(struct lg4573 *ctx, u16 data)
    {
    struct spi_transfer xfer = {
    .len = 2,
    };
    let mut temp: __be16 = cpu_to_be16(data);
...
#[no_mangle]
unsafe extern "C" fn lg4573_spi_write_dcs(ctx: *mut lg4573, dcs: u8) -> c_int {
    static int lg4573_spi_write_dcs(struct lg4573 *ctx, u8 dcs)
    {
    return lg4573_spi_write_u16(ctx, (0x70 << 8 | dcs));
    }
#[no_mangle]
unsafe extern "C" fn lg4573_display_on(ctx: *mut lg4573) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg4573_display_off(ctx: *mut lg4573) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg4573_display_mode_settings(ctx: *mut lg4573) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg4573_power_settings(ctx: *mut lg4573) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg4573_gamma_settings(ctx: *mut lg4573) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg4573_init(ctx: *mut lg4573) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg4573_power_on(ctx: *mut lg4573) -> c_int {
    static int lg4573_power_on(struct lg4573 *ctx)
    {
    return lg4573_display_on(ctx);
    }
#[no_mangle]
unsafe extern "C" fn lg4573_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg4573_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg4573_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg4573_remove(spi: *mut spi_device) {
