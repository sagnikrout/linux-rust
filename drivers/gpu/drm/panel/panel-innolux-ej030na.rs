...
//! Source: drivers/gpu/drm/panel/panel-innolux-ej030na.c
#![no_std]
...
pub struct ej030na {
    ...
    pub map: *mut regmap,
    pub panel_info: *const ej030na_info,
...
#[no_mangle]
unsafe extern "C" fn ej030na_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ej030na_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ej030na_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ej030na_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ej030na_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ej030na_remove(spi: *mut spi_device) {
