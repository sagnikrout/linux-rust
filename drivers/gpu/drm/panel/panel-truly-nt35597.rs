...
//! Source: drivers/gpu/drm/panel/panel-truly-nt35597.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nt35597_config {
    pub width_mm: u32,
    pub height_mm: u32,
    pub panel_name: *const c_char,
    pub panel_on_cmds: *const cmd_set,
    pub num_on_cmds: u32,
    pub dm: *const drm_display_mode,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct truly_nt35597 {
    pub dev: *mut device,
    pub panel: drm_panel,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(regulator_names)],
    pub reset_gpio: *mut gpio_desc,
    pub mode_gpio: *mut gpio_desc,
    pub backlight: *mut backlight_device,
    pub dsi: [*mut mipi_dsi_device; 2],
    pub config: *const nt35597_config,
}
...
#[no_mangle]
unsafe extern "C" fn truly_dcs_write(panel: *mut drm_panel, command: u32) -> c_int {
    static int truly_dcs_write(struct drm_panel *panel, u32 command)
    {
    struct truly_nt35597 *ctx = panel_to_ctx(panel);
    int i, ret;
    for (i = 0; i < ARRAY_SIZE(ctx.dsi); i++) {
    ret = mipi_dsi_dcs_write(ctx.dsi[i], command, core::ptr::null_mut(), 0);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn truly_35597_power_on(ctx: *mut truly_nt35597) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35597_power_off(ctx: *mut truly_nt35597) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35597_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35597_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35597_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35597_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35597_panel_add(ctx: *mut truly_nt35597) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35597_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truly_nt35597_remove(dsi: *mut mipi_dsi_device) {
