...
//! Source: drivers/gpu/drm/panel/panel-samsung-s6d16d0.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn s6d16d0_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6d16d0_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6d16d0_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6d16d0_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6d16d0_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6d16d0_remove(dsi: *mut mipi_dsi_device) {
