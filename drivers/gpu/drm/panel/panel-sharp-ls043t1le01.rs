...
//! Source: drivers/gpu/drm/panel/panel-sharp-ls043t1le01.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sharp_nt_panel_init(sharp_nt: *mut sharp_nt_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_nt_panel_on(sharp_nt: *mut sharp_nt_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_nt_panel_off(sharp_nt: *mut sharp_nt_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_nt_panel_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_nt_panel_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_nt_panel_add(sharp_nt: *mut sharp_nt_panel) -> c_int {
    ...
    sharp_nt.reset_gpio = core::ptr::null_mut();
    } else {
    gpiod_set_value(sharp_nt.reset_gpio, 0);
    }
...
#[no_mangle]
unsafe extern "C" fn sharp_nt_panel_del(sharp_nt: *mut sharp_nt_panel) {
...
#[no_mangle]
unsafe extern "C" fn sharp_nt_panel_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharp_nt_panel_remove(dsi: *mut mipi_dsi_device) {
