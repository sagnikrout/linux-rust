...
//! Source: drivers/gpu/drm/panel/panel-ilitek-ili9882t.c
#![no_std]
...
//
    ...
    pub boe): *mut *mut int (init)(struct ili9882t,
    pub lanes: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn starry_ili9882t_init(ili: *mut ili9882t) -> c_int {
    static int starry_ili9882t_init(struct ili9882t *ili)
    {
    let mut ctx: mipi_dsi_multi_context = { .dsi = ili.dsi };
...
#[no_mangle]
unsafe extern "C" fn tianma_il79900a_init(ili: *mut ili9882t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9882t_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9882t_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9882t_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9882t_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9882t_get_orientation(panel: *mut drm_panel) -> enum drm_panel_orientation {
...
#[no_mangle]
unsafe extern "C" fn ili9882t_add(ili: *mut ili9882t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9882t_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili9882t_remove(dsi: *mut mipi_dsi_device) {
