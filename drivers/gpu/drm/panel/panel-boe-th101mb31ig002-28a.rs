...
//! Source: drivers/gpu/drm/panel/panel-boe-th101mb31ig002-28a.c
#![no_std]
...
pub struct panel_desc {
    ...
    pub ctx): *mut *mut int (init)(struct boe_th101mb31ig002,
    pub lanes: c_uint,
    ...
    pub power_off_delay_ms: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct boe_th101mb31ig002 {
    pub panel: drm_panel,
...
#[no_mangle]
unsafe extern "C" fn boe_th101mb31ig002_reset(ctx: *mut boe_th101mb31ig002) {
...
#[no_mangle]
unsafe extern "C" fn boe_th101mb31ig002_enable(ctx: *mut boe_th101mb31ig002) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starry_er88577_init_cmd(ctx: *mut boe_th101mb31ig002) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_th101mb31ig002_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_th101mb31ig002_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_th101mb31ig002_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_th101mb31ig002_dsi_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_th101mb31ig002_dsi_remove(dsi: *mut mipi_dsi_device) {
