...
//! Source: drivers/gpu/drm/panel/panel-samsung-db7430.c
#![no_std]
...
pub const DB7430_ACCESS_PROT_OFF: c_uint = 0xb0;
pub const DB7430_UNKNOWN_B4: c_uint = 0xb4;
pub const DB7430_USER_SELECT: c_uint = 0xb5;
pub const DB7430_UNKNOWN_B7: c_uint = 0xb7;
pub const DB7430_UNKNOWN_B8: c_uint = 0xb8;
pub const DB7430_PANEL_DRIVING: c_uint = 0xc0;
pub const DB7430_SOURCE_CONTROL: c_uint = 0xc1;
pub const DB7430_GATE_INTERFACE: c_uint = 0xc4;
pub const DB7430_DISPLAY_H_TIMING: c_uint = 0xc5;
pub const DB7430_RGB_SYNC_OPTION: c_uint = 0xc6;
pub const DB7430_GAMMA_SET_RED: c_uint = 0xc8;
pub const DB7430_GAMMA_SET_GREEN: c_uint = 0xc9;
pub const DB7430_GAMMA_SET_BLUE: c_uint = 0xca;
pub const DB7430_BIAS_CURRENT_CTRL: c_uint = 0xd1;
pub const DB7430_DDV_CTRL: c_uint = 0xd2;
pub const DB7430_GAMMA_CTRL_REF: c_uint = 0xd3;
pub const DB7430_UNKNOWN_D4: c_uint = 0xd4;
pub const DB7430_DCDC_CTRL: c_uint = 0xd5;
pub const DB7430_VCL_CTRL: c_uint = 0xd6;
pub const DB7430_UNKNOWN_F8: c_uint = 0xf8;
pub const DB7430_UNKNOWN_FC: c_uint = 0xfc;
pub const DATA_MASK: c_uint = 0x100;
//
...
#[no_mangle]
unsafe extern "C" fn db7430_power_on(db: *mut db7430) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn db7430_power_off(db: *mut db7430) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn db7430_unprepare(panel: *mut drm_panel) -> c_int {
    static int db7430_unprepare(struct drm_panel *panel)
    {
    return db7430_power_off(to_db7430(panel));
    }
#[no_mangle]
unsafe extern "C" fn db7430_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn db7430_prepare(panel: *mut drm_panel) -> c_int {
    static int db7430_prepare(struct drm_panel *panel)
    {
    return db7430_power_on(to_db7430(panel));
    }
#[no_mangle]
unsafe extern "C" fn db7430_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn db7430_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn db7430_remove(spi: *mut spi_device) {
