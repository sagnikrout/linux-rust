...
//! Source: drivers/gpu/drm/panel/panel-samsung-s6e8aa0.c
#![no_std]
...
pub const LDI_MTP_LENGTH: c_int = 24;
pub const GAMMA_LEVEL_NUM: c_int = 25;
pub const GAMMA_TABLE_LEN: c_int = 26;

    typedef u8 s6e8aa0_gamma_table[GAMMA_TABLE_LEN];
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s6e8aa0_variant {
    pub version: u8,
    pub gamma_tables: *const s6e8aa0_gamma_table,
}
...
pub struct s6e8aa0 {
    ...
    pub version: u8,
    pub id: u8,
    pub variant: *const s6e8aa0_variant,
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_clear_error(ctx: *mut s6e8aa0) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_dcs_write(ctx: *mut s6e8aa0, data: *const c_void, len: usize) {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_dcs_read(ctx: *mut s6e8aa0, cmd: u8, data: *mut c_void, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_apply_level_1_key(ctx: *mut s6e8aa0) {
    static void s6e8aa0_apply_level_1_key(struct s6e8aa0 *ctx)
    {
    s6e8aa0_dcs_write_seq_static(ctx, 0xf0, 0x5a, 0x5a);
    }
#[no_mangle]
unsafe extern "C" fn s6e8aa0_panel_cond_set_v142(ctx: *mut s6e8aa0) {
    static void s6e8aa0_panel_cond_set_v142(struct s6e8aa0 *ctx)
    {
    static const u8 aids[] = {
    0x04, 0x04, 0x04, 0x04, 0x04, 0x60, 0x80, 0xA0
    };
    let mut aid: u8 = aids[ctx.id >> 5];
    let mut cfg: u8 = 0x3d;
    let mut clk_con: u8 = 0xc8;
    let mut int_con: u8 = 0x08;
    let mut bictl_con: u8 = 0x48;
    let mut em_clk1_con: u8 = 0xff;
    let mut em_clk2_con: u8 = 0xff;
    let mut em_int_con: u8 = 0xc8;
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_panel_cond_set(ctx: *mut s6e8aa0) {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_etc_power_control(ctx: *mut s6e8aa0) {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_etc_elvss_control(ctx: *mut s6e8aa0) {
    static void s6e8aa0_etc_elvss_control(struct s6e8aa0 *ctx)
    {
    let mut id: u8 = ctx.id ? 0 : 0x95;
    s6e8aa0_dcs_write_seq(ctx, 0xb1, 0x04, id);
    }
#[no_mangle]
unsafe extern "C" fn s6e8aa0_elvss_nvm_set_v142(ctx: *mut s6e8aa0) {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_elvss_nvm_set(ctx: *mut s6e8aa0) {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_apply_level_2_key(ctx: *mut s6e8aa0) {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_brightness_set(ctx: *mut s6e8aa0) {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_panel_init(ctx: *mut s6e8aa0) {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_read_mtp_id(ctx: *mut s6e8aa0) {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_set_sequence(ctx: *mut s6e8aa0) {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_power_on(ctx: *mut s6e8aa0) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_power_off(ctx: *mut s6e8aa0) -> c_int {
    static int s6e8aa0_power_off(struct s6e8aa0 *ctx)
    {
    return regulator_bulk_disable(ARRAY_SIZE(ctx.supplies), ctx.supplies);
    }
#[no_mangle]
unsafe extern "C" fn s6e8aa0_disable(panel: *mut drm_panel) -> c_int {
    static int s6e8aa0_disable(struct drm_panel *panel)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn s6e8aa0_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_parse_dt(ctx: *mut s6e8aa0) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s6e8aa0_remove(dsi: *mut mipi_dsi_device) {
