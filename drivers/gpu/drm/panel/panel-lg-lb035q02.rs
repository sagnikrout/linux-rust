...
//! Source: drivers/gpu/drm/panel/panel-lg-lb035q02.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lb035q02_write(lcd: *mut lb035q02_device, reg: u16, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lb035q02_init(lcd: *mut lb035q02_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lb035q02_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lb035q02_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lb035q02_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lb035q02_remove(spi: *mut spi_device) {
