...
//! Source: drivers/gpu/drm/panel/panel-himax-hx83121a.c
#![no_std]
...
pub struct panel_desc {
    ...
    pub dsc_cfg: *const drm_dsc_config,
    pub dsc_modes: *const drm_display_mode,
    pub num_dsc_modes: c_uint,
    pub modes: *const drm_display_mode,
    pub num_modes: c_uint,
    pub dsi_ctx): *mut *mut int (init_sequence_dsc)(struct mipi_dsi_multi_context,
    pub dsi_ctx): *mut *mut int (init_sequence)(struct mipi_dsi_multi_context,
    pub is_dual_dsi: bool,
    pub has_dcs_backlight: bool,
}
...
#[no_mangle]
unsafe extern "C" fn himax_reset(ctx: *mut himax) {
...
#[no_mangle]
unsafe extern "C" fn himax_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ctx->desc->init_sequence) -> else {
...
#[no_mangle]
unsafe extern "C" fn himax_off(dsi_ctx: *mut mipi_dsi_multi_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn himax_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn himax_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_ppc357db1_4_dsc_init_seq(dsi_ctx: *mut mipi_dsi_multi_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn boe_ppc357db1_4_init_seq(dsi_ctx: *mut mipi_dsi_multi_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn csot_ppc357db1_4_dsc_init_seq(dsi_ctx: *mut mipi_dsi_multi_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn csot_ppc357db1_4_init_seq(dsi_ctx: *mut mipi_dsi_multi_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn himax_probe(dsi: *mut mipi_dsi_device) -> c_int {
    static int himax_probe(struct mipi_dsi_device *dsi)
    {
    let mut dsi_info: mipi_dsi_device_info = {"dsi-secondary", 0, core::ptr::null_mut()};
    struct mipi_dsi_host *dsi1_host;
    struct device *dev = &dsi.dev;
    const struct panel_desc *desc;
    struct device_node *dsi1;
    struct himax *ctx;
    let mut num_dsi: c_int = 1;
    int ret, i;
    ...
    ctx.dsi[i].dsc = enable_dsc ? &ctx.dsc : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn himax_remove(dsi: *mut mipi_dsi_device) {
