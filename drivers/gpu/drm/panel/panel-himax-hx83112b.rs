...
//! Source: drivers/gpu/drm/panel/panel-himax-hx83112b.c
#![no_std]
...
pub const HX83112B_SETPOWER1: c_uint = 0xb1;
pub const HX83112B_SETDISP: c_uint = 0xb2;
pub const HX83112B_SETDRV: c_uint = 0xb4;
pub const HX83112B_SETEXTC: c_uint = 0xb9;
pub const HX83112B_SETBANK: c_uint = 0xbd;
pub const HX83112B_SETDGCLUT: c_uint = 0xc1;
pub const HX83112B_SETDISMO: c_uint = 0xc2;
pub const HX83112B_UNKNOWN1: c_uint = 0xc6;
pub const HX83112B_SETPANEL: c_uint = 0xcc;
pub const HX83112B_UNKNOWN2: c_uint = 0xd1;
pub const HX83112B_SETPOWER2: c_uint = 0xd2;
pub const HX83112B_SETGIP0: c_uint = 0xd3;
pub const HX83112B_SETGIP1: c_uint = 0xd5;
pub const HX83112B_SETGIP2: c_uint = 0xd6;
pub const HX83112B_SETGIP3: c_uint = 0xd8;
pub const HX83112B_SETIDLE: c_uint = 0xdd;
pub const HX83112B_UNKNOWN3: c_uint = 0xe7;
pub const HX83112B_UNKNOWN4: c_uint = 0xe9;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hx83112b_panel {
    pub panel: drm_panel,
...
#[no_mangle]
unsafe extern "C" fn hx83112b_reset(ctx: *mut hx83112b_panel) {
...
#[no_mangle]
unsafe extern "C" fn hx83112b_on(ctx: *mut hx83112b_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx83112b_off(ctx: *mut hx83112b_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx83112b_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx83112b_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx83112b_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx83112b_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hx83112b_remove(dsi: *mut mipi_dsi_device) {
