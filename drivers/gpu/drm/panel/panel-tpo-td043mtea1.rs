...
//! Source: drivers/gpu/drm/panel/panel-tpo-td043mtea1.c
#![no_std]
...
pub struct td043mtea1_panel {
    ...
    pub vmirror: bool,
    pub powered_on: bool,
    pub spi_suspended: bool,
    pub power_on_resume: bool,
}
...
//
#[no_mangle]
unsafe extern "C" fn td043mtea1_write(lcd: *mut td043mtea1_panel, addr: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn td043mtea1_write_gamma(lcd: *mut td043mtea1_panel) {
...
#[no_mangle]
unsafe extern "C" fn td043mtea1_write_mirror(lcd: *mut td043mtea1_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn td043mtea1_power_on(lcd: *mut td043mtea1_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn td043mtea1_power_off(lcd: *mut td043mtea1_panel) {
...
//
#[no_mangle]
unsafe extern "C" fn td043mtea1_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn td043mtea1_prepare(panel: *mut drm_panel) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn td043mtea1_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn td043mtea1_resume(dev: *mut device) -> int __maybe_unused {
    ...
    td043mtea1_resume);
#[no_mangle]
unsafe extern "C" fn td043mtea1_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn td043mtea1_remove(spi: *mut spi_device) {
