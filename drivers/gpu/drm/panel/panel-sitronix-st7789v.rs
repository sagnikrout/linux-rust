...
//! Source: drivers/gpu/drm/panel/panel-sitronix-st7789v.c
#![no_std]
...
pub const ST7789V_RAMCTRL_CMD: c_uint = 0xb0;

pub const ST7789V_RGBCTRL_CMD: c_uint = 0xb1;

pub const ST7789V_PORCTRL_CMD: c_uint = 0xb2;

pub const ST7789V_GCTRL_CMD: c_uint = 0xb7;

pub const ST7789V_VCOMS_CMD: c_uint = 0xbb;
pub const ST7789V_LCMCTRL_CMD: c_uint = 0xc0;

pub const ST7789V_VDVVRHEN_CMD: c_uint = 0xc2;

pub const ST7789V_VRHS_CMD: c_uint = 0xc3;
pub const ST7789V_VDVS_CMD: c_uint = 0xc4;
pub const ST7789V_FRCTRL2_CMD: c_uint = 0xc6;
pub const ST7789V_PWCTRL1_CMD: c_uint = 0xd0;
pub const ST7789V_PWCTRL1_MAGIC: c_uint = 0xa4;

pub const ST7789V_PVGAMCTRL_CMD: c_uint = 0xe0;

pub const ST7789V_NVGAMCTRL_CMD: c_uint = 0xe1;
...
pub const ST7789V_IDS_SIZE: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st7789_panel_info {
    pub mode: *const drm_display_mode,
    pub bus_format: u32,
    pub bus_flags: u32,
    pub invert_mode: bool,
    pub partial_mode: bool,
    pub partial_start: u16,
    pub partial_end: u16,
}
...
pub struct st7789v {
    pub panel: drm_panel,
    pub info: *const st7789_panel_info,
    ...
    let mut txbuf: u16 = ((prefix & 1) << 8) | data;
    xfer.tx_buf = &txbuf;
    xfer.len = sizeof(txbuf);
    return spi_sync_transfer(ctx.spi, &xfer, 1);
    }
#[no_mangle]
unsafe extern "C" fn st7789v_write_command(ctx: *mut st7789v, cmd: u8) -> c_int {
    static int st7789v_write_command(struct st7789v *ctx, u8 cmd)
    {
    return st7789v_spi_write(ctx, ST7789V_COMMAND, cmd);
    }
#[no_mangle]
unsafe extern "C" fn st7789v_write_data(ctx: *mut st7789v, cmd: u8) -> c_int {
    ...
    let mut txbuf: u16 = ((ST7789V_COMMAND & 1) << 8) | cmd;
    u16 rxbuf[4] = {};
    let mut bit9: u8 = 0;
    int ret, i;
    switch (len) {
...
#[no_mangle]
unsafe extern "C" fn st7789v_get_orientation(p: *mut drm_panel) -> enum drm_panel_orientation {
...
#[no_mangle]
unsafe extern "C" fn st7789v_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7789v_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7789v_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7789v_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7789v_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st7789v_remove(spi: *mut spi_device) {
