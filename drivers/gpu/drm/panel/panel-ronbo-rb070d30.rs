...
//! Source: drivers/gpu/drm/panel/panel-ronbo-rb070d30.c
#![no_std]
...
pub struct rb070d30_panel {
    ...
    pub updn: *mut gpio_desc,
    pub shlr: *mut gpio_desc,
    pub gpios: },
}
...
#[no_mangle]
unsafe extern "C" fn rb070d30_panel_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rb070d30_panel_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rb070d30_panel_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rb070d30_panel_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rb070d30_panel_dsi_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rb070d30_panel_dsi_remove(dsi: *mut mipi_dsi_device) {
