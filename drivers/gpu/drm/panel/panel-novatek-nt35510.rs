...
//! Source: drivers/gpu/drm/panel/panel-novatek-nt35510.c
#![no_std]
...
pub const MCS_CMD_READ_ID1: c_uint = 0xDA;
pub const MCS_CMD_READ_ID2: c_uint = 0xDB;
pub const MCS_CMD_READ_ID3: c_uint = 0xDC;
pub const MCS_CMD_MTP_READ_SETTING: c_uint = 0xF8 /* Uncertain about name */;
pub const MCS_CMD_MTP_READ_PARAM: c_uint = 0xFF /* Uncertain about name */;
//
// These manufacturer commands are available after we enable manufacturer
// command set (MCS) for page 0.
//
pub const NT35510_P0_DOPCTR: c_uint = 0xB1;
pub const NT35510_P0_SDHDTCTR: c_uint = 0xB6;
pub const NT35510_P0_GSEQCTR: c_uint = 0xB7;
pub const NT35510_P0_SDEQCTR: c_uint = 0xB8;
pub const NT35510_P0_SDVPCTR: c_uint = 0xBA;
pub const NT35510_P0_DPFRCTR1: c_uint = 0xBD;
pub const NT35510_P0_DPFRCTR2: c_uint = 0xBE;
pub const NT35510_P0_DPFRCTR3: c_uint = 0xBF;
pub const NT35510_P0_DPMCTR12: c_uint = 0xCC;
pub const NT35510_P0_DOPCTR_LEN: c_int = 2;
pub const NT35510_P0_GSEQCTR_LEN: c_int = 2;
pub const NT35510_P0_SDEQCTR_LEN: c_int = 4;
pub const NT35510_P0_SDVPCTR_LEN: c_int = 1;
pub const NT35510_P0_DPFRCTR1_LEN: c_int = 5;
pub const NT35510_P0_DPFRCTR2_LEN: c_int = 5;
pub const NT35510_P0_DPFRCTR3_LEN: c_int = 5;
pub const NT35510_P0_DPMCTR12_LEN: c_int = 3;

//
// These manufacturer commands are available after we enable manufacturer
// command set (MCS) for page 1.
//
pub const NT35510_P1_SETAVDD: c_uint = 0xB0;
pub const NT35510_P1_SETAVEE: c_uint = 0xB1;
pub const NT35510_P1_SETVCL: c_uint = 0xB2;
pub const NT35510_P1_SETVGH: c_uint = 0xB3;
pub const NT35510_P1_SETVRGH: c_uint = 0xB4;
pub const NT35510_P1_SETVGL: c_uint = 0xB5;
pub const NT35510_P1_BT1CTR: c_uint = 0xB6;
pub const NT35510_P1_BT2CTR: c_uint = 0xB7;
pub const NT35510_P1_BT3CTR: c_uint = 0xB8;
pub const NT35510_P1_BT4CTR: c_uint = 0xB9 /* VGH boosting times/freq */;
pub const NT35510_P1_BT5CTR: c_uint = 0xBA;
pub const NT35510_P1_PFMCTR: c_uint = 0xBB;
pub const NT35510_P1_SETVGP: c_uint = 0xBC;
pub const NT35510_P1_SETVGN: c_uint = 0xBD;
pub const NT35510_P1_SETVCMOFF: c_uint = 0xBE;
pub const NT35510_P1_VGHCTR: c_uint = 0xBF /* VGH output ctrl */;
pub const NT35510_P1_SET_GAMMA_RED_POS: c_uint = 0xD1;
pub const NT35510_P1_SET_GAMMA_GREEN_POS: c_uint = 0xD2;
pub const NT35510_P1_SET_GAMMA_BLUE_POS: c_uint = 0xD3;
pub const NT35510_P1_SET_GAMMA_RED_NEG: c_uint = 0xD4;
pub const NT35510_P1_SET_GAMMA_GREEN_NEG: c_uint = 0xD5;
pub const NT35510_P1_SET_GAMMA_BLUE_NEG: c_uint = 0xD6;
// AVDD and AVEE setting 3 bytes
pub const NT35510_P1_AVDD_LEN: c_int = 3;
pub const NT35510_P1_AVEE_LEN: c_int = 3;
pub const NT35510_P1_VCL_LEN: c_int = 3;
pub const NT35510_P1_VGH_LEN: c_int = 3;
pub const NT35510_P1_VGL_LEN: c_int = 3;
pub const NT35510_P1_VGP_LEN: c_int = 3;
pub const NT35510_P1_VGN_LEN: c_int = 3;
pub const NT35510_P1_VCMOFF_LEN: c_int = 2;
// BT1CTR thru BT5CTR setting 3 bytes
pub const NT35510_P1_BT1CTR_LEN: c_int = 3;
pub const NT35510_P1_BT2CTR_LEN: c_int = 3;
pub const NT35510_P1_BT3CTR_LEN: c_int = 3;
pub const NT35510_P1_BT4CTR_LEN: c_int = 3;
pub const NT35510_P1_BT5CTR_LEN: c_int = 3;
// 52 gamma parameters times two per color: positive and negative
pub const NT35510_P1_GAMMA_LEN: c_int = 52;

pub const NT35510_WRCABC_OFF: c_int = 0;
pub const NT35510_WRCABC_UI_MODE: c_int = 1;
pub const NT35510_WRCABC_STILL_MODE: c_int = 2;
pub const NT35510_WRCABC_MOVING_MODE: c_int = 3;
//
...
//
    pub avdd: [u8; NT35510_P1_AVDD_LEN],
//
...
//
    pub bt1ctr: [u8; NT35510_P1_BT1CTR_LEN],
//
// @avee: setting for AVEE ranging from 0x00 = -6.5V to 0x14 = -4.5V
// in 0.1V steps the default is 0x05 which means -6.0V
//
    pub avee: [u8; NT35510_P1_AVEE_LEN],
//
...
//
    pub bt5ctr: [u8; NT35510_P1_BT5CTR_LEN],
//
...
//
    pub vcmoff: [u8; NT35510_P1_VCMOFF_LEN],
//
...
// The default is 0.
//
    pub dopctr: [u8; NT35510_P0_DOPCTR_LEN],
//
...
// The default is 0x07 = 3.5us
//
    pub gseqctr: [u8; NT35510_P0_GSEQCTR_LEN],
//
...
// is 0x07 = 3.5 us.
//
    pub sdeqctr: [u8; NT35510_P0_SDEQCTR_LEN],
//
...
pub const NT35510_ROTATE_0_SETTING: c_uint = 0x02;
pub const NT35510_ROTATE_180_SETTING: c_uint = 0x00;
    static int nt35510_send_long(struct nt35510 *nt, struct mipi_dsi_device *dsi,
    u8 cmd, u8 cmdlen, const u8 *seq)
    {
    const u8 *seqp = seq;
    let mut cmdwritten: c_int = 0;
    let mut chunk: c_int = cmdlen;
    int ret;
    if (chunk > 15)
    chunk = 15;
...
#[no_mangle]
unsafe extern "C" fn nt35510_read_id(nt: *mut nt35510) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nt35510_setup_power(nt: *mut nt35510) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nt35510_setup_display(nt: *mut nt35510) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt35510_set_brightness(bl: *mut backlight_device) -> c_int {
    static int nt35510_set_brightness(struct backlight_device *bl)
    {
    struct nt35510 *nt = bl_get_data(bl);
    struct mipi_dsi_device *dsi = to_mipi_dsi_device(nt.dev);
    let mut brightness: u8 = bl.props.brightness;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn nt35510_power_on(nt: *mut nt35510) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt35510_power_off(nt: *mut nt35510) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt35510_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt35510_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nt35510_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
//
    ...
    &nt35510_bl_ops, core::ptr::null_mut());
    if (IS_ERR(bl)) {
...
#[no_mangle]
unsafe extern "C" fn nt35510_remove(dsi: *mut mipi_dsi_device) {
...
// to 0x03FE.
//
pub const NT35510_GAMMA_POS_DEFAULT: c_uint = 0x00, 0x01, 0x00, 0x43, 0x00, \;
...
pub const NT35510_GAMMA_NEG_DEFAULT: c_uint = 0x00, 0x01, 0x00, 0x43, 0x00, \;
    0x6B, 0x00, 0x87, 0x00, 0xA3, 0x00, 0xCE, 0x00, 0xF1, 0x01, \
    0x27, 0x01, 0x53, 0x01, 0x98, 0x01, 0xCE, 0x02, 0x22, 0x02, \
