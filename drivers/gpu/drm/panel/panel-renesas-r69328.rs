...
//! Source: drivers/gpu/drm/panel/panel-renesas-r69328.c
#![no_std]
...
pub const R69328_MACP: c_uint = 0xb0 /* Manufacturer Access CMD Protect */;
pub const R69328_MACP_ON: c_uint = 0x03;
pub const R69328_MACP_OFF: c_uint = 0x04;
pub const R69328_GAMMA_SET_A: c_uint = 0xc8 /* Gamma Setting A */;
pub const R69328_GAMMA_SET_B: c_uint = 0xc9 /* Gamma Setting B */;
pub const R69328_GAMMA_SET_C: c_uint = 0xca /* Gamma Setting C */;
pub const R69328_POWER_SET: c_uint = 0xd1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct renesas_r69328 {
    pub panel: drm_panel,
...
#[no_mangle]
unsafe extern "C" fn renesas_r69328_reset(priv: *mut renesas_r69328) {
...
#[no_mangle]
unsafe extern "C" fn renesas_r69328_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_r69328_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_r69328_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_r69328_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_r69328_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_r69328_remove(dsi: *mut mipi_dsi_device) {
