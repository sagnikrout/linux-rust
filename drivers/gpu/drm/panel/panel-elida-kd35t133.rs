...
//! Source: drivers/gpu/drm/panel/panel-elida-kd35t133.c
#![no_std]
...
pub const KD35T133_CMD_INTERFACEMODECTRL: c_uint = 0xb0;
pub const KD35T133_CMD_FRAMERATECTRL: c_uint = 0xb1;
pub const KD35T133_CMD_DISPLAYINVERSIONCTRL: c_uint = 0xb4;
pub const KD35T133_CMD_DISPLAYFUNCTIONCTRL: c_uint = 0xb6;
pub const KD35T133_CMD_POWERCONTROL1: c_uint = 0xc0;
pub const KD35T133_CMD_POWERCONTROL2: c_uint = 0xc1;
pub const KD35T133_CMD_VCOMCONTROL: c_uint = 0xc5;
pub const KD35T133_CMD_POSITIVEGAMMA: c_uint = 0xe0;
pub const KD35T133_CMD_NEGATIVEGAMMA: c_uint = 0xe1;
pub const KD35T133_CMD_SETIMAGEFUNCTION: c_uint = 0xe9;
pub const KD35T133_CMD_ADJUSTCONTROL3: c_uint = 0xf7;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kd35t133 {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn kd35t133_init_sequence(dsi_ctx: *mut mipi_dsi_multi_context) {
...
#[no_mangle]
unsafe extern "C" fn kd35t133_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kd35t133_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kd35t133_get_orientation(panel: *mut drm_panel) -> enum drm_panel_orientation {
...
#[no_mangle]
unsafe extern "C" fn kd35t133_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kd35t133_remove(dsi: *mut mipi_dsi_device) {
