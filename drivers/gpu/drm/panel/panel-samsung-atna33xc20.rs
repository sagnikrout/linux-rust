...
//! Source: drivers/gpu/drm/panel/panel-samsung-atna33xc20.c
#![no_std]
...
pub const HPD_MAX_MS: c_int = 200;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct atana33xc20_panel {
    pub base: drm_panel,
    pub el3_was_on: bool,
    pub no_hpd: bool,
    pub hpd_gpio: *mut gpio_desc,
    pub supply: *mut regulator,
    pub el_on3_gpio: *mut gpio_desc,
    pub aux: *mut drm_dp_aux,
    pub drm_edid: *const drm_edid,
    pub powered_off_time: ktime_t,
    pub powered_on_time: ktime_t,
    pub el_on3_off_time: ktime_t,
}
...
#[no_mangle]
unsafe extern "C" fn atana33xc20_wait(start_ktime: ktime_t, min_ms: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn atana33xc20_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atana33xc20_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atana33xc20_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atana33xc20_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atana33xc20_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atana33xc20_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atana33xc20_runtime_disable(data: *mut c_void) {
    static void atana33xc20_runtime_disable(void *data)
    {
    pm_runtime_disable(data);
    }
#[no_mangle]
unsafe extern "C" fn atana33xc20_dont_use_autosuspend(data: *mut c_void) {
    static void atana33xc20_dont_use_autosuspend(void *data)
    {
    pm_runtime_dont_use_autosuspend(data);
    }
#[no_mangle]
unsafe extern "C" fn atana33xc20_probe(aux_ep: *mut dp_aux_ep_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atana33xc20_remove(aux_ep: *mut dp_aux_ep_device) {
    ...
    SET_RUNTIME_PM_OPS(atana33xc20_suspend, atana33xc20_resume, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn atana33xc20_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn atana33xc20_exit() -> void __exit {
