...
//! Source: drivers/gpu/drm/panel/panel-renesas-r61307.c
#![no_std]
...
pub const R61307_MACP: c_uint = 0xb0 /* Manufacturer CMD Protect */;
pub const R61307_MACP_ON: c_uint = 0x03;
pub const R61307_MACP_OFF: c_uint = 0x04;
pub const R61307_INVERSION: c_uint = 0xc1;
pub const R61307_GAMMA_SET_A: c_uint = 0xc8 /* Gamma Setting A */;
pub const R61307_GAMMA_SET_B: c_uint = 0xc9 /* Gamma Setting B */;
pub const R61307_GAMMA_SET_C: c_uint = 0xca /* Gamma Setting C */;
pub const R61307_CONTRAST_SET: c_uint = 0xcc;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct renesas_r61307 {
    pub panel: drm_panel,
    pub dsi: *mut mipi_dsi_device,
    pub vcc_supply: *mut regulator,
    pub iovcc_supply: *mut regulator,
    pub reset_gpio: *mut gpio_desc,
    pub dig_cont_adj: bool,
    pub inversion: bool,
    pub gamma: u32,
}
...
#[no_mangle]
unsafe extern "C" fn renesas_r61307_reset(priv: *mut renesas_r61307) {
...
#[no_mangle]
unsafe extern "C" fn renesas_r61307_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_r61307_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_r61307_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_r61307_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_r61307_probe(dsi: *mut mipi_dsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_r61307_remove(dsi: *mut mipi_dsi_device) {
