...
//! Source: drivers/gpu/drm/panel/panel-sony-acx565akm.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn acx565akm_cmd(lcd: *mut acx565akm_panel, cmd: c_int) {
    static inline void acx565akm_cmd(struct acx565akm_panel *lcd, int cmd)
    {
    acx565akm_transfer(lcd, cmd, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0);
    }
    static inline void acx565akm_write(struct acx565akm_panel *lcd,
    int reg, const u8 *buf, int len)
    {
    acx565akm_transfer(lcd, reg, buf, len, core::ptr::null_mut(), 0);
    }
    static inline void acx565akm_read(struct acx565akm_panel *lcd,
    int reg, u8 *buf, int len)
    {
    acx565akm_transfer(lcd, reg, core::ptr::null_mut(), 0, buf, len);
    }
// -----------------------------------------------------------------------------
// Auto Brightness Control Via sysfs
//
#[no_mangle]
unsafe extern "C" fn acx565akm_get_cabc_mode(lcd: *mut acx565akm_panel) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn acx565akm_get_hw_cabc_mode(lcd: *mut acx565akm_panel) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn acx565akm_get_actual_brightness(lcd: *mut acx565akm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acx565akm_set_brightness(lcd: *mut acx565akm_panel, level: c_int) {
...
#[no_mangle]
unsafe extern "C" fn acx565akm_backlight_init(lcd: *mut acx565akm_panel) -> c_int {
    ...
    lcd.backlight = core::ptr::null_mut();
    return ret;
    }
    if (lcd.has_cabc) {
...
#[no_mangle]
unsafe extern "C" fn acx565akm_backlight_cleanup(lcd: *mut acx565akm_panel) {
...
//
#[no_mangle]
unsafe extern "C" fn acx565akm_set_sleep_mode(lcd: *mut acx565akm_panel, on: c_int) {
    static void acx565akm_set_sleep_mode(struct acx565akm_panel *lcd, int on)
    {
    let mut cmd: c_int = on ? MIPI_DCS_ENTER_SLEEP_MODE : MIPI_DCS_EXIT_SLEEP_MODE;
    unsigned long wait;
//
...
//
    ...
    int enabled)
    {
    let mut cmd: c_int = enabled ? MIPI_DCS_SET_DISPLAY_ON : MIPI_DCS_SET_DISPLAY_OFF;
    acx565akm_cmd(lcd, cmd);
    }
#[no_mangle]
unsafe extern "C" fn acx565akm_power_on(lcd: *mut acx565akm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acx565akm_power_off(lcd: *mut acx565akm_panel) {
...
#[no_mangle]
unsafe extern "C" fn acx565akm_disable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acx565akm_enable(panel: *mut drm_panel) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn acx565akm_detect(lcd: *mut acx565akm_panel) -> c_int {
