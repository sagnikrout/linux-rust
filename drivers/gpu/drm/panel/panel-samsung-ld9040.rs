...
//! Source: drivers/gpu/drm/panel/panel-samsung-ld9040.c
#![no_std]
...
pub const MCS_MANPWR: c_uint = 0xb0;
pub const MCS_ELVSS_ON: c_uint = 0xb1;
pub const MCS_USER_SETTING: c_uint = 0xf0;
pub const MCS_DISPCTL: c_uint = 0xf2;
pub const MCS_POWER_CTRL: c_uint = 0xf4;
pub const MCS_GTCON: c_uint = 0xf7;
pub const MCS_PANEL_CONDITION: c_uint = 0xf8;
pub const MCS_GAMMA_SET1: c_uint = 0xf9;
pub const MCS_GAMMA_CTRL: c_uint = 0xfb;
...
#[no_mangle]
unsafe extern "C" fn ld9040_clear_error(ctx: *mut ld9040) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ld9040_spi_write_word(ctx: *mut ld9040, data: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ld9040_dcs_write(ctx: *mut ld9040, data: *const u8, len: usize) {
...
#[no_mangle]
unsafe extern "C" fn ld9040_brightness_set(ctx: *mut ld9040) {
...
#[no_mangle]
unsafe extern "C" fn ld9040_init(ctx: *mut ld9040) {
...
#[no_mangle]
unsafe extern "C" fn ld9040_power_on(ctx: *mut ld9040) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ld9040_power_off(ctx: *mut ld9040) -> c_int {
    static int ld9040_power_off(struct ld9040 *ctx)
    {
    return regulator_bulk_disable(ARRAY_SIZE(ctx.supplies), ctx.supplies);
    }
#[no_mangle]
unsafe extern "C" fn ld9040_disable(panel: *mut drm_panel) -> c_int {
    static int ld9040_disable(struct drm_panel *panel)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ld9040_unprepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ld9040_prepare(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ld9040_enable(panel: *mut drm_panel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ld9040_parse_dt(ctx: *mut ld9040) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ld9040_bl_update_status(dev: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ld9040_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ld9040_remove(spi: *mut spi_device) {
