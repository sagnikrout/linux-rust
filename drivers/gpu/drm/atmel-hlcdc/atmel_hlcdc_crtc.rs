...
//! Source: drivers/gpu/drm/atmel-hlcdc/atmel_hlcdc_crtc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_hlcdc_crtc_state {
    pub base: drm_crtc_state,
    pub output_mode: c_uint,
    pub dpi: u8,
}
...
#[no_mangle]
unsafe extern "C" fn atmel_hlcdc_crtc_mode_set_nofb(c: *mut drm_crtc) {
    static void atmel_hlcdc_crtc_mode_set_nofb(struct drm_crtc *c)
    {
    struct atmel_hlcdc_crtc *crtc = drm_crtc_to_atmel_hlcdc_crtc(c);
    struct regmap *regmap = crtc.dc.hlcdc.regmap;
    struct drm_display_mode *adj = &c.state.adjusted_mode;
    struct drm_encoder *encoder = core::ptr::null_mut(), *en_iter;
    ...
    struct videomode vm;
    unsigned long prate;
    let mut mask: c_uint = ATMEL_HLCDC_CLKDIV_MASK | ATMEL_HLCDC_CLKPOL;
...
// The divider ended up too big, try a lower base rate.
    ...
    let mut div_low: c_int = prate / mode_rate;
    if (div_low >= 2 &&
...
//
    ...
    {
    int j;
    let mut supported_fmts: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn atmel_hlcdc_connector_output_mode(state: *mut drm_connector_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_hlcdc_crtc_select_output_mode(state: *mut drm_crtc_state) -> c_int {
...
// check if MIPI DPI bit needs to be set
    ...
    c.state.event = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn atmel_hlcdc_crtc_finish_page_flip(crtc: *mut atmel_hlcdc_crtc) {
    ...
    crtc.event = core::ptr::null_mut();
    }
    spin_unlock_irqrestore(&dev.event_lock, flags);
    }
#[no_mangle]
pub unsafe extern "C" fn atmel_hlcdc_crtc_irq(c: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn atmel_hlcdc_crtc_reset(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn atmel_hlcdc_crtc_enable_vblank(c: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_hlcdc_crtc_disable_vblank(c: *mut drm_crtc) {
...
#[no_mangle]
pub unsafe extern "C" fn atmel_hlcdc_crtc_create(dev: *mut drm_device) -> c_int {
    int atmel_hlcdc_crtc_create(struct drm_device *dev)
    {
    struct atmel_hlcdc_plane *primary = core::ptr::null_mut(), *cursor = core::ptr::null_mut();
