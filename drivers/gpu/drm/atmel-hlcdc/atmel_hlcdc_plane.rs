...
//! Source: drivers/gpu/drm/atmel-hlcdc/atmel_hlcdc_plane.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_hlcdc_plane_state {
...
// These fields are private and should not be touched
    pub bpp: [c_int; ATMEL_HLCDC_LAYER_MAX_PLANES],
    pub offsets: [c_uint; ATMEL_HLCDC_LAYER_MAX_PLANES],
    pub xstride: [c_int; ATMEL_HLCDC_LAYER_MAX_PLANES],
    pub pstride: [c_int; ATMEL_HLCDC_LAYER_MAX_PLANES],
    pub nplanes: c_int,
// DMA descriptors.
    pub dscrs: [*mut atmel_hlcdc_dma_channel_dscr; ATMEL_HLCDC_LAYER_MAX_PLANES],
}
...
#[no_mangle]
unsafe extern "C" fn atmel_hlcdc_format_to_plane_mode(format: u32, mode: *mut u32) -> c_int {
...
pub const ATMEL_HLCDC_XPHIDEF: c_int = 4;
pub const ATMEL_HLCDC_YPHIDEF: c_int = 4;
...
// YCbCr 4:2:0
    ...
    struct atmel_hlcdc_plane_state *state)
    {
    let mut cfg: c_uint = ATMEL_HLCDC_LAYER_DMA_BLEN_INCR16 | state.ahb_id;
    const struct atmel_hlcdc_layer_desc *desc = plane.layer.desc;
...
#[no_mangle]
pub unsafe extern "C" fn atmel_hlcdc_plane_prepare_ahb_routing(c_state: *mut drm_crtc_state) -> c_int {
    ...
    {
    let mut disc_x: c_int = 0, disc_y = 0, disc_w = 0, disc_h = 0;
...
// TODO: implement a smarter hidden area detection
    ...
    let mut xdiv: c_int = i ? fb.format.hsub : 1;
    let mut ydiv: c_int = i ? fb.format.vsub : 1;
...
#[no_mangle]
unsafe extern "C" fn atmel_hlcdc_plane_init_properties(plane: *mut atmel_hlcdc_plane) -> c_int {
    ...
    const struct atmel_hlcdc_layer_desc *desc)
    {
    let mut isr: u32 = atmel_hlcdc_layer_read_reg(&plane.layer, ATMEL_HLCDC_LAYER_ISR);
//
...
//
    ...
    const struct atmel_hlcdc_layer_desc *desc)
    {
    let mut isr: u32 = atmel_hlcdc_layer_read_reg(&plane.layer, ATMEL_XLCDC_LAYER_ISR);
//
// There's not much we can do in case of overrun except informing
// the user. However, we are in interrupt context here, hence the
// use of dev_dbg().
...
#[no_mangle]
pub unsafe extern "C" fn atmel_hlcdc_plane_irq(plane: *mut atmel_hlcdc_plane) {
...
#[no_mangle]
unsafe extern "C" fn atmel_hlcdc_plane_reset(p: *mut drm_plane) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ATMEL_HLCDC_CURSOR_LAYER: desc->type ==) -> else {
    ...
    desc.formats.nformats, core::ptr::null_mut(), type, core::ptr::null_mut());
    if (IS_ERR(plane))
...
#[no_mangle]
pub unsafe extern "C" fn atmel_hlcdc_create_planes(dev: *mut drm_device) -> c_int {
    int atmel_hlcdc_create_planes(struct drm_device *dev)
    {
    struct atmel_hlcdc_dc *dc = dev.dev_private;
    const struct atmel_hlcdc_layer_desc *descs = dc.desc.layers;
    let mut nlayers: c_int = dc.desc.nlayers;
    int i, ret;
