...
//! Source: drivers/gpu/drm/drm_self_refresh_helper.c
#![no_std]
...
//
pub const SELF_REFRESH_AVG_SEED_MS: c_int = 200;
    DECLARE_EWMA(psr_time, 4, 4)
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_self_refresh_data {
    pub crtc: *mut drm_crtc,
    pub entry_work: delayed_work,
    pub avg_mutex: mutex,
    pub entry_avg_ms: ewma_psr_time,
    pub exit_avg_ms: ewma_psr_time,
}

#[no_mangle]
unsafe extern "C" fn drm_self_refresh_helper_entry_work(work: *mut work_struct) {
...
//
    ...
    let mut new_self_refresh_active: bool = new_self_refresh_mask & BIT(i);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_self_refresh_helper_alter_state(state: *mut drm_atomic_commit) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_self_refresh_helper_init(crtc: *mut drm_crtc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_self_refresh_helper_cleanup(crtc: *mut drm_crtc) {
...
// Helper is already uninitialized
    if (!sr_data)
    return;
    crtc.self_refresh_data = core::ptr::null_mut();
