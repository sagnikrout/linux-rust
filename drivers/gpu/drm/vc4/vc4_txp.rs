...
//! Source: drivers/gpu/drm/vc4/vc4_txp.c
#![no_std]
...
//
pub const TXP_DST_PTR: c_uint = 0x00;
// Pitch in bytes for raster images, 16-byte aligned.  For tiled, it's
// the width in tiles.
//
pub const TXP_DST_PITCH: c_uint = 0x04;
...
//
pub const TXP_DIM: c_uint = 0x08;

pub const TXP_DST_CTRL: c_uint = 0x0c;
// These bits are set to 0x54
pub const TXP_PILOT_SHIFT: c_int = 24;

// Bits 22-23 are set to 0x01
pub const TXP_VERSION_SHIFT: c_int = 22;
...
pub const TXP_PROGRESS: c_uint = 0x10;
pub const TXP_DST_PTR_HIGH_MOPLET: c_uint = 0x1c;
pub const TXP_DST_PTR_HIGH_MOP: c_uint = 0x24;
...
pub struct vc4_txp {
    pub base: vc4_crtc,
    pub data: *const vc4_txp_data,
    pub pdev: *mut platform_device,
    pub encoder: vc4_encoder,
    pub connector: drm_writeback_connector,
...
#[no_mangle]
unsafe extern "C" fn vc4_txp_connector_get_modes(connector: *mut drm_connector) -> c_int {
    ...
    let mut w: c_int = mode.hdisplay, h = mode.vdisplay;
...
#[no_mangle]
unsafe extern "C" fn vc4_txp_armed(state: *mut drm_crtc_state) {
...
#[no_mangle]
unsafe extern "C" fn vc4_txp_encoder_disable(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn vc4_txp_enable_vblank(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc4_txp_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vc4_txp_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
    ...
    ret = drmm_encoder_init(drm, encoder, core::ptr::null_mut(), DRM_MODE_ENCODER_VIRTUAL, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn vc4_txp_probe(pdev: *mut platform_device) -> c_int {
    static int vc4_txp_probe(struct platform_device *pdev)
    {
    return component_add(&pdev.dev, &vc4_txp_ops);
    }
#[no_mangle]
unsafe extern "C" fn vc4_txp_remove(pdev: *mut platform_device) {
