...
//! Source: drivers/gpu/drm/vc4/vc4_kms.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc4_ctm_state {
    pub base: drm_private_state,
    pub ctm: *mut drm_color_ctm,
    pub fifo: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc4_load_tracker_state {
    pub base: drm_private_state,
    pub hvs_load: u64,
    pub membus_load: u64,
}
...
#[no_mangle]
unsafe extern "C" fn vc4_ctm_obj_fini(dev: *mut drm_device, unused: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn vc4_ctm_obj_init(vc4: *mut vc4_dev) -> c_int {
    static int vc4_ctm_obj_init(struct vc4_dev *vc4)
    {
    drm_modeset_lock_init(&vc4.ctm_state_lock);
    drm_atomic_private_obj_init(&vc4.base, &vc4.ctm_manager,
    &vc4_ctm_state_funcs);
    return drmm_add_action_or_reset(&vc4.base, vc4_ctm_obj_fini, core::ptr::null_mut());
    }
// Converts a DRM S31.32 value to the HW S0.9 format.
#[no_mangle]
unsafe extern "C" fn vc4_ctm_s31_32_to_s0_9(in: u64) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn vc4_atomic_commit_tail(state: *mut drm_atomic_commit) {
    ...
    old_hvs_state.fifo_state[channel].pending_commit = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn vc4_atomic_commit_setup(state: *mut drm_atomic_commit) -> c_int {
...
//
    ...
    {
    struct vc4_dev *vc4 = to_vc4_dev(dev);
    struct vc4_ctm_state *ctm_state = core::ptr::null_mut();
    struct drm_crtc *crtc;
...
// fifo is 1-based since 0 disables CTM.
    let mut fifo: c_int = vc4_crtc_state.assigned_channel + 1;
...
#[no_mangle]
unsafe extern "C" fn vc4_load_tracker_atomic_check(state: *mut drm_atomic_commit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc4_load_tracker_obj_fini(dev: *mut drm_device, unused: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn vc4_load_tracker_obj_init(vc4: *mut vc4_dev) -> c_int {
    static int vc4_load_tracker_obj_init(struct vc4_dev *vc4)
    {
    drm_atomic_private_obj_init(&vc4.base, &vc4.load_tracker,
    &vc4_load_tracker_state_funcs);
    return drmm_add_action_or_reset(&vc4.base, vc4_load_tracker_obj_fini, core::ptr::null_mut());
    }
    static struct drm_private_state *
...
#[no_mangle]
unsafe extern "C" fn vc4_hvs_channels_obj_fini(dev: *mut drm_device, unused: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn vc4_hvs_channels_obj_init(vc4: *mut vc4_dev) -> c_int {
    static int vc4_hvs_channels_obj_init(struct vc4_dev *vc4)
    {
    drm_atomic_private_obj_init(&vc4.base, &vc4.hvs_channels,
    &vc4_hvs_state_funcs);
    return drmm_add_action_or_reset(&vc4.base, vc4_hvs_channels_obj_fini, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn cmp_vc4_crtc_hvs_output(a: *const c_void, b: *const c_void) -> c_int {
...
//
    ...
    struct drm_crtc *crtc;
    let mut unassigned_channels: c_uint = 0;
    unsigned int i;
    int ret;
...
//
    ...
    sorted_crtcs[i++] = crtc;
    sort(sorted_crtcs, i, sizeof(*sorted_crtcs), cmp_vc4_crtc_hvs_output, core::ptr::null_mut());
...
// If we're disabling our CRTC, we put back our channel
    ...
    let mut channel: c_uint = old_vc4_state.assigned_channel;
    hvs_new_state.fifo_state[channel].fifo_load = 0;
    }
    if (new_crtc_state.active) {
    struct vc4_crtc_state *new_vc4_state =
    to_vc4_crtc_state(new_crtc_state);
    let mut channel: c_uint = new_vc4_state.assigned_channel;
...
#[no_mangle]
pub unsafe extern "C" fn vc4_kms_load(dev: *mut drm_device) -> c_int {
