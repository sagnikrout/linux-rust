...
//! Source: drivers/gpu/drm/vc4/vc4_v3d.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vc4_v3d_debugfs_ident(m: *mut seq_file, unused: *mut c_void) -> c_int {
    static int vc4_v3d_debugfs_ident(struct seq_file *m, void *unused)
    {
    struct drm_debugfs_entry *entry = m.private;
    struct drm_device *dev = entry.dev;
    struct vc4_dev *vc4 = to_vc4_dev(dev);
    let mut ret: c_int = vc4_v3d_pm_get(vc4);
    if (ret == 0) {
    let mut ident1: u32 = V3D_READ(V3D_IDENT1);
    let mut nslc: u32 = VC4_GET_FIELD(ident1, V3D_IDENT1_NSLC);
    let mut tups: u32 = VC4_GET_FIELD(ident1, V3D_IDENT1_TUPS);
    let mut qups: u32 = VC4_GET_FIELD(ident1, V3D_IDENT1_QUPS);
...
//
    ...
    let mut ret: c_int = pm_runtime_get_sync(&vc4.v3d.pdev.dev);
    if (ret < 0) {
    vc4.power_refcount--;
...
#[no_mangle]
unsafe extern "C" fn vc4_v3d_init_hw(dev: *mut drm_device) {
...
#[no_mangle]
pub unsafe extern "C" fn vc4_v3d_get_bin_slot(vc4: *mut vc4_dev) -> c_int {
...
//
    ...
    spin_unlock_irqrestore(&vc4.job_lock, irqflags);
    if (seqno) {
    let mut ret: c_int = vc4_wait_for_seqno(dev, seqno, ~0ull, true);
    if (ret == 0)
    goto try_again;
    return ret;
    }
...
//
#[no_mangle]
unsafe extern "C" fn bin_bo_alloc(vc4: *mut vc4_dev) -> c_int {
    static int bin_bo_alloc(struct vc4_dev *vc4)
    {
    struct vc4_v3d *v3d = vc4.v3d;
    let mut size: u32 = 16 * 1024 * 1024;
    let mut ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn vc4_v3d_bin_bo_get(vc4: *mut vc4_dev, used: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bin_bo_release(ref: *mut kref) {
    ...
    vc4.bin_bo = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn vc4_v3d_bin_bo_put(vc4: *mut vc4_dev) {
...
#[no_mangle]
unsafe extern "C" fn vc4_v3d_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc4_v3d_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vc4_v3d_debugfs_init(minor: *mut drm_minor) -> c_int {
    ...
    if (!vc4.v3d)
    return -ENODEV;
    drm_debugfs_add_file(drm, "v3d_ident", vc4_v3d_debugfs_ident, core::ptr::null_mut());
    vc4_debugfs_add_regset32(drm, "v3d_regs", &v3d.regset);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn vc4_v3d_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
    static int vc4_v3d_bind(struct device *dev, struct device *master, void *data)
    {
    struct platform_device *pdev = to_platform_device(dev);
    struct drm_device *drm = dev_get_drvdata(master);
    struct vc4_dev *vc4 = to_vc4_dev(drm);
    struct vc4_v3d *v3d = core::ptr::null_mut();
    int ret;
    ...
    vc4.v3d = v3d;
    v3d.vc4 = vc4;
    v3d.clk = devm_clk_get_optional(dev, core::ptr::null_mut());
    if (IS_ERR(v3d.clk))
...
//
    V3D_WRITE(V3D_BPOA, 0);
    V3D_WRITE(V3D_BPOS, 0);
    vc4.v3d = core::ptr::null_mut();
    }
    static const struct dev_pm_ops vc4_v3d_pm_ops = {
    SET_RUNTIME_PM_OPS(vc4_v3d_runtime_suspend, vc4_v3d_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn vc4_v3d_dev_probe(pdev: *mut platform_device) -> c_int {
    static int vc4_v3d_dev_probe(struct platform_device *pdev)
    {
    return component_add(&pdev.dev, &vc4_v3d_ops);
    }
#[no_mangle]
unsafe extern "C" fn vc4_v3d_dev_remove(pdev: *mut platform_device) {
