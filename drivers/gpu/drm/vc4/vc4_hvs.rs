...
#[no_mangle]
pub unsafe extern "C" fn vc4_hvs_dump_state(hvs: *mut vc4_hvs) {
    void vc4_hvs_dump_state(struct vc4_hvs *hvs)
    {
    struct drm_device *drm = &hvs.vc4.base;
    let mut p: drm_printer = drm_info_printer(&hvs.pdev.dev);
    int idx, i;
...
#[no_mangle]
unsafe extern "C" fn vc4_hvs_debugfs_underrun(m: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc4_hvs_debugfs_dlist(m: *mut seq_file, data: *mut c_void) -> c_int {
    ...
    let mut p: drm_printer = drm_seq_file_printer(m);
    let mut dlist_mem_size: c_uint = hvs.dlist_mem_size;
...
#[no_mangle]
unsafe extern "C" fn vc6_hvs_debugfs_dlist(m: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc6_hvs_debugfs_upm_allocs(m: *mut seq_file, data: *mut c_void) -> c_int {
...
pub const VC4_LINEAR_PHASE_KERNEL_DWORDS: c_int = 6;
...
//
    ...
    let mut length: u32 = drm_color_lut_size(crtc_state.gamma_lut);
    u32 i;
    for (i = 0; i < length; i++) {
...
#[no_mangle]
pub unsafe extern "C" fn vc4_hvs_get_fifo_frame_count(hvs: *mut vc4_hvs, fifo: c_uint) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn vc4_hvs_get_fifo_from_output(hvs: *mut vc4_hvs, output: c_uint) -> c_int {
...
//
    ...
    let mut chan: c_uint = vc4_crtc_state.assigned_channel;
    let mut interlace: bool = mode.flags & DRM_MODE_FLAG_INTERLACE;
    u32 dispbkgndx;
    u32 dispctrl;
    int idx;
    WARN_ON_ONCE(vc4.gen > VC4_GEN_5);
...
#[no_mangle]
unsafe extern "C" fn __vc4_hvs_stop_channel(hvs: *mut vc4_hvs, chan: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn __vc6_hvs_stop_channel(hvs: *mut vc4_hvs, chan: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn vc4_hvs_stop_channel(hvs: *mut vc4_hvs, chan: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn vc4_hvs_atomic_check(crtc: *mut drm_crtc, state: *mut drm_atomic_commit) -> c_int {
...
//
    ...
    let mut plane_dlist_count: u32 = vc4_plane_dlist_size(plane_state);
...
#[no_mangle]
unsafe extern "C" fn vc4_hvs_install_dlist(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn vc4_hvs_update_dlist(crtc: *mut drm_crtc) {
    ...
    struct vc4_crtc *vc4_crtc = to_vc4_crtc(crtc);
    let mut oneshot: bool = vc4_crtc.feeds_txp;
    ...
    let mut chan: c_uint = vc4_state.assigned_channel;
    ...
    struct vc4_crtc *vc4_crtc = to_vc4_crtc(crtc);
    struct vc4_crtc_state *vc4_state = to_vc4_crtc_state(crtc.state);
    let mut channel: c_uint = vc4_state.assigned_channel;
    struct drm_plane *plane;
    struct vc4_plane_state *vc4_plane_state;
    let mut debug_dump_regs: bool = false;
    let mut enable_bg_fill: bool = true;
    u32 __iomem *dlist_start = vc4.hvs.dlist + vc4_state.mm.start;
    u32 __iomem *dlist_next = dlist_start;
    let mut zpos: c_uint = 0;
...
//
    ...
    let mut dispbkgndx: u32 = HVS_READ(SCALER_DISPBKGNDX(channel));
    WARN_ON_ONCE(vc4.gen > VC4_GEN_5);
...
#[no_mangle]
pub unsafe extern "C" fn vc4_hvs_mask_underrun(hvs: *mut vc4_hvs, channel: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn vc4_hvs_unmask_underrun(hvs: *mut vc4_hvs, channel: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vc4_hvs_report_underrun(dev: *mut drm_device) {
...
#[no_mangle]
unsafe extern "C" fn vc4_hvs_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t vc4_hvs_irq_handler(int irq, void *data)
    {
    struct drm_device *dev = data;
    struct vc4_dev *vc4 = to_vc4_dev(dev);
    struct vc4_hvs *hvs = vc4.hvs;
    let mut irqret: irqreturn_t = IRQ_NONE;
    int channel;
    u32 control;
    u32 status;
    u32 dspeislur;
...
#[no_mangle]
pub unsafe extern "C" fn vc4_hvs_debugfs_init(minor: *mut drm_minor) -> c_int {
    ...
    if (vc4.gen >= VC4_GEN_6_C) {
    drm_debugfs_add_file(drm, "hvs_dlists", vc6_hvs_debugfs_dlist, core::ptr::null_mut());
    drm_debugfs_add_file(drm, "hvs_upm", vc6_hvs_debugfs_upm_allocs, core::ptr::null_mut());
    } else {
    drm_debugfs_add_file(drm, "hvs_dlists", vc4_hvs_debugfs_dlist, core::ptr::null_mut());
    }
    drm_debugfs_add_file(drm, "hvs_underrun", vc4_hvs_debugfs_underrun, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn vc4_hvs_hw_init(hvs: *mut vc4_hvs) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc6_csc_coeff_entry {
    pub csc: [u32; 3][5],
}
...
#[no_mangle]
unsafe extern "C" fn vc6_hvs_hw_init(hvs: *mut vc4_hvs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc4_hvs_cob_init(hvs: *mut vc4_hvs) -> c_int {
...
// channel 0.
//
pub const VC4_COB_SIZE: c_int = 20736;
pub const VC4_COB_LINE_WIDTH: c_int = 2048;
pub const VC4_COB_NUM_LINES: c_int = 3;
    reg = 0;
...
// lines. to channel 0.
//
pub const VC5_COB_SIZE: c_int = 44416;
pub const VC5_COB_LINE_WIDTH: c_int = 4096;
pub const VC5_COB_NUM_LINES: c_int = 3;
    reg = 0;
    ...
    case VC4_GEN_6_C:
    case VC4_GEN_6_D:
pub const VC6_COB_LINE_WIDTH: c_int = 3840;
pub const VC6_COB_NUM_LINES: c_int = 4;
    base = 0;
    top = 3840;
...
#[no_mangle]
unsafe extern "C" fn vc4_hvs_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
    static int vc4_hvs_bind(struct device *dev, struct device *master, void *data)
    {
    struct platform_device *pdev = to_platform_device(dev);
    struct drm_device *drm = dev_get_drvdata(master);
    struct vc4_dev *vc4 = to_vc4_dev(drm);
    struct vc4_hvs *hvs = core::ptr::null_mut();
    void __iomem *regs;
    int ret;
    ...
    (vc4.gen >= VC4_GEN_6_C) ? "core" : core::ptr::null_mut());
    if (IS_ERR(hvs.core_clk)) {
    dev_err(&pdev.dev, "Couldn't get core clock\n");
    return PTR_ERR(hvs.core_clk);
    }
    hvs.disp_clk = devm_clk_get(&pdev.dev,
    (vc4.gen >= VC4_GEN_6_C) ? "disp" : core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn vc4_hvs_dev_probe(pdev: *mut platform_device) -> c_int {
    static int vc4_hvs_dev_probe(struct platform_device *pdev)
    {
    return component_add(&pdev.dev, &vc4_hvs_ops);
    }
#[no_mangle]
unsafe extern "C" fn vc4_hvs_dev_remove(pdev: *mut platform_device) {
