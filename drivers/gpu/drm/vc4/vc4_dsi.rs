...
//! Source: drivers/gpu/drm/vc4/vc4_dsi.c
#![no_std]
...
pub const DSI_CMD_FIFO_DEPTH: c_int = 16;
pub const DSI_PIX_FIFO_DEPTH: c_int = 256;
pub const DSI_PIX_FIFO_WIDTH: c_int = 4;
pub const DSI0_CTRL: c_uint = 0x00;
// Command packet control.
pub const DSI0_TXPKT1C: c_uint = 0x04 /* AKA PKTC */;
pub const DSI1_TXPKT1C: c_uint = 0x04;
...
pub const DSI0_TXPKT1H: c_uint = 0x08 /* AKA PKTH */;
pub const DSI1_TXPKT1H: c_uint = 0x08;

pub const DSI0_RXPKT1H: c_uint = 0x0c /* AKA RX1_PKTH */;
pub const DSI1_RXPKT1H: c_uint = 0x14;

// Byte count if DSI_RXPKT1H_PKT_TYPE_LONG

// Short return bytes if !DSI_RXPKT1H_PKT_TYPE_LONG

pub const DSI0_RXPKT2H: c_uint = 0x10 /* AKA RX2_PKTH */;
pub const DSI1_RXPKT2H: c_uint = 0x18;

pub const DSI0_TXPKT_CMD_FIFO: c_uint = 0x14 /* AKA CMD_DATAF */;
pub const DSI1_TXPKT_CMD_FIFO: c_uint = 0x1c;
pub const DSI0_DISP0_CTRL: c_uint = 0x18;
...
pub const DSI0_DISP1_CTRL: c_uint = 0x1c;
pub const DSI1_DISP1_CTRL: c_uint = 0x2c;
// Format of the data written to TXPKT_PIX_FIFO.

// DISP1 is always command mode.

pub const DSI0_TXPKT_PIX_FIFO: c_uint = 0x20 /* AKA PIX_FIFO */;
pub const DSI0_INT_STAT: c_uint = 0x24;
pub const DSI0_INT_EN: c_uint = 0x28;
...
// Signaled after each TXPKT1 repeat is scheduled.
    ...
    DSI1_INT_TA_TO |	 \
    DSI1_INT_PR_TO)
pub const DSI0_STAT: c_uint = 0x2c;
pub const DSI0_HSTX_TO_CNT: c_uint = 0x30;
pub const DSI0_LPRX_TO_CNT: c_uint = 0x34;
pub const DSI0_TA_TO_CNT: c_uint = 0x38;
pub const DSI0_PR_TO_CNT: c_uint = 0x3c;
pub const DSI0_PHYC: c_uint = 0x40;

pub const DSI0_HS_CLT0: c_uint = 0x44;
pub const DSI0_HS_CLT1: c_uint = 0x48;
pub const DSI0_HS_CLT2: c_uint = 0x4c;
pub const DSI0_HS_DLT3: c_uint = 0x50;
pub const DSI0_HS_DLT4: c_uint = 0x54;
pub const DSI0_HS_DLT5: c_uint = 0x58;
pub const DSI0_HS_DLT6: c_uint = 0x5c;
pub const DSI0_HS_DLT7: c_uint = 0x60;
pub const DSI0_PHY_AFEC0: c_uint = 0x64;

pub const DSI0_PHY_AFEC1: c_uint = 0x68;

pub const DSI0_TST_SEL: c_uint = 0x6c;
pub const DSI0_TST_MON: c_uint = 0x70;
pub const DSI0_ID: c_uint = 0x74;

pub const DSI1_CTRL: c_uint = 0x00;
    ...
    DSI1_CTRL_CLR_PDF | \
    DSI1_CTRL_CLR_CDF)
pub const DSI1_TXPKT2C: c_uint = 0x0c;
pub const DSI1_TXPKT2H: c_uint = 0x10;
pub const DSI1_TXPKT_PIX_FIFO: c_uint = 0x20;
pub const DSI1_RXPKT_FIFO: c_uint = 0x24;
pub const DSI1_DISP0_CTRL: c_uint = 0x28;
pub const DSI1_INT_STAT: c_uint = 0x30;
pub const DSI1_INT_EN: c_uint = 0x34;
// State reporting bits.  These mostly behave like INT_STAT, where
// writing a 1 clears the bit.
//
pub const DSI1_STAT: c_uint = 0x38;

// Set when in forward direction

pub const DSI1_HSTX_TO_CNT: c_uint = 0x3c;
pub const DSI1_LPRX_TO_CNT: c_uint = 0x40;
pub const DSI1_TA_TO_CNT: c_uint = 0x44;
pub const DSI1_PR_TO_CNT: c_uint = 0x48;
pub const DSI1_PHYC: c_uint = 0x4c;
pub const DSI1_HS_CLT0: c_uint = 0x50;

pub const DSI1_HS_CLT1: c_uint = 0x54;

pub const DSI1_HS_CLT2: c_uint = 0x58;

pub const DSI1_HS_DLT3: c_uint = 0x5c;

pub const DSI1_HS_DLT4: c_uint = 0x60;

pub const DSI1_HS_DLT5: c_uint = 0x64;

pub const DSI1_HS_DLT6: c_uint = 0x68;

pub const DSI1_HS_DLT7: c_uint = 0x6c;

pub const DSI1_PHY_AFEC0: c_uint = 0x70;
pub const DSI1_PHY_AFEC1: c_uint = 0x74;

pub const DSI1_TST_SEL: c_uint = 0x78;
pub const DSI1_TST_MON: c_uint = 0x7c;
pub const DSI1_PHY_TST1: c_uint = 0x80;
pub const DSI1_PHY_TST2: c_uint = 0x84;
pub const DSI1_PHY_FIFO_STAT: c_uint = 0x88;
// Actually, all registers in the range that aren't otherwise claimed
// will return the ID.
//
pub const DSI1_ID: c_uint = 0x8c;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc4_dsi_variant {
// Whether we're on bcm2835's DSI0 or DSI1.
    pub port: c_uint,
    pub broken_axi_workaround: bool,
...
pub struct vc4_dsi {
    ...
    pub out_bridge: *mut drm_bridge,
    pub bridge: drm_bridge,
    pub regs: *mut void __iomem,
    pub reg_dma_chan: *mut dma_chan,
    pub reg_dma_paddr: dma_addr_t,
    pub reg_dma_mem: *mut u32,
    pub reg_paddr: dma_addr_t,
    pub variant: *const vc4_dsi_variant,
...
#[no_mangle]
unsafe extern "C" fn vc4_dsi_latch_ulps(dsi: *mut vc4_dsi, latch: bool) {
    static void vc4_dsi_latch_ulps(struct vc4_dsi *dsi, bool latch)
    {
    let mut afec0: u32 = DSI_PORT_READ(PHY_AFEC0);
    if (latch)
...
#[no_mangle]
unsafe extern "C" fn vc4_dsi_ulps(dsi: *mut vc4_dsi, ulps: bool) {
    static void vc4_dsi_ulps(struct vc4_dsi *dsi, bool ulps)
    {
    let mut non_continuous: bool = dsi.mode_flags & MIPI_DSI_CLOCK_NON_CONTINUOUS;
...
pub const ESC_TIME_NS: c_int = 10;
    static u32
...
//
    ...
    let mut parent_rate: c_ulong = clk_get_rate(phy_parent);
    let mut pixel_clock_hz: c_ulong = mode.clock * 1000;
    let mut pll_clock: c_ulong = pixel_clock_hz * dsi.divider;
    int divider;
...
// Given the new pixel clock, adjust HFP to keep vrefresh the same.
    ...
    let mut debug_dump_regs: bool = false;
    unsigned long hs_clock;
    struct drm_crtc *crtc;
    u32 ui_ns;
// Minimum LP state duration in escape clock cycles.
    let mut lpx: u32 = dsi_esc_timing(60);
    ...
    if (debug_dump_regs) {
    let mut p: drm_printer = drm_info_printer(&dsi.pdev.dev);
...
// Attach the panel or bridge to the dsi bridge
    ...
    let mut pkth: u32 = 0, pktc = 0;
    int i, ret;
    let mut is_long: bool = mipi_dsi_packet_format_is_long(msg.type);
    let mut cmd_fifo_len: u32 = 0, pix_fifo_len = 0;
...
// Send the packet.
    ...
    if (ret == 0 && msg.rx_len) {
    let mut rxpkt1h: u32 = DSI_PORT_READ(RXPKT1H);
...
#[no_mangle]
unsafe extern "C" fn vc4_dsi_late_register(encoder: *mut drm_encoder) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vc4_dsi_irq_defer_to_thread_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t vc4_dsi_irq_defer_to_thread_handler(int irq, void *data)
    {
    struct vc4_dsi *dsi = data;
    let mut stat: u32 = DSI_PORT_READ(INT_STAT);
    if (!stat)
    return IRQ_NONE;
...
//
#[no_mangle]
unsafe extern "C" fn vc4_dsi_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vc4_dsi_dma_mem_release(ptr: *mut c_void) {
    static void vc4_dsi_dma_mem_release(void *ptr)
    {
    struct vc4_dsi *dsi = ptr;
    struct device *dev = &dsi.pdev.dev;
    dma_free_coherent(dev, 4, dsi.reg_dma_mem, dsi.reg_dma_paddr);
    dsi.reg_dma_mem = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn vc4_dsi_dma_chan_release(ptr: *mut c_void) {
    static void vc4_dsi_dma_chan_release(void *ptr)
    {
    struct vc4_dsi *dsi = ptr;
    dma_release_channel(dsi.reg_dma_chan);
    dsi.reg_dma_chan = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn vc4_dsi_release_action(drm: *mut drm_device, ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn vc4_dsi_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
...
// The esc clock rate is supposed to always be 100Mhz.
    ...
    if (ret)
    return ret;
    ret = drm_bridge_attach(encoder, &dsi.bridge, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn vc4_dsi_dev_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc4_dsi_dev_remove(pdev: *mut platform_device) {
