...
//! Source: drivers/gpu/drm/vc4/vc4_bo.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn is_user_label(label: c_int) -> bool {
    static bool is_user_label(int label)
    {
    return label >= VC4_BO_TYPE_COUNT;
    }
#[no_mangle]
unsafe extern "C" fn vc4_bo_stats_print(p: *mut drm_printer, vc4: *mut vc4_dev) {
...
#[no_mangle]
unsafe extern "C" fn vc4_bo_stats_debugfs(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vc4_get_user_label(vc4: *mut vc4_dev, name: *const c_char) -> c_int {
    ...
    let mut new_label_count: u32 = vc4.num_labels + 1;
...
#[no_mangle]
unsafe extern "C" fn vc4_bo_set_label(gem_obj: *mut drm_gem_object, label: c_int) {
...
//
    ...
    vc4.bo_labels[bo.label].name = core::ptr::null_mut();
    }
    bo.label = label;
    }
#[no_mangle]
unsafe extern "C" fn bo_page_index(size: usize) -> u32 {
    static uint32_t bo_page_index(size_t size)
    {
    return (size / PAGE_SIZE) - 1;
    }
#[no_mangle]
unsafe extern "C" fn vc4_bo_destroy(bo: *mut vc4_bo) {
    ...
    bo.validated_shader = core::ptr::null_mut();
    }
    mutex_destroy(&bo.madv_lock);
    drm_gem_dma_free(&bo.base);
    }
#[no_mangle]
unsafe extern "C" fn vc4_bo_remove_from_cache(bo: *mut vc4_bo) {
    ...
    {
    struct vc4_dev *vc4 = to_vc4_dev(dev);
    let mut page_index: u32 = bo_page_index(size);
...
#[no_mangle]
unsafe extern "C" fn vc4_bo_cache_purge(dev: *mut drm_device) {
...
#[no_mangle]
pub unsafe extern "C" fn vc4_bo_add_to_purgeable_pool(bo: *mut vc4_bo) {
...
#[no_mangle]
unsafe extern "C" fn vc4_bo_remove_from_purgeable_pool_locked(bo: *mut vc4_bo) {
...
#[no_mangle]
pub unsafe extern "C" fn vc4_bo_remove_from_purgeable_pool(bo: *mut vc4_bo) {
...
#[no_mangle]
unsafe extern "C" fn vc4_bo_purge(obj: *mut drm_gem_object) {
    ...
    bo.base.vaddr = core::ptr::null_mut();
    bo.madv = __VC4_MADV_PURGED;
    }
#[no_mangle]
unsafe extern "C" fn vc4_bo_userspace_cache_purge(dev: *mut drm_device) {
...
//
    ...
    {
    let mut size: usize = roundup(unaligned_size, PAGE_SIZE);
    struct vc4_dev *vc4 = to_vc4_dev(dev);
...
//
    ...
    if (IS_ERR(dma_obj)) {
    let mut p: drm_printer = drm_info_printer(vc4.base.dev);
...
#[no_mangle]
unsafe extern "C" fn vc4_bo_cache_free_old(dev: *mut drm_device) {
    static void vc4_bo_cache_free_old(struct drm_device *dev)
    {
    struct vc4_dev *vc4 = to_vc4_dev(dev);
    let mut expire_time: c_ulong = jiffies - msecs_to_jiffies(1000);
    lockdep_assert_held(&vc4.bo_lock);
    while (!list_empty(&vc4.bo_cache.time_list)) {
    struct vc4_bo *bo = list_last_entry(&vc4.bo_cache.time_list,
    struct vc4_bo, unref_head);
...
//
#[no_mangle]
unsafe extern "C" fn vc4_free_object(gem_bo: *mut drm_gem_object) {
...
#[no_mangle]
unsafe extern "C" fn vc4_bo_cache_time_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn vc4_bo_inc_usecnt(bo: *mut vc4_bo) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vc4_bo_dec_usecnt(bo: *mut vc4_bo) {
...
#[no_mangle]
unsafe extern "C" fn vc4_bo_cache_time_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn vc4_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn vc4_gem_object_mmap(obj: *mut drm_gem_object, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc4_grab_bin_bo(vc4: *mut vc4_dev, vc4file: *mut vc4_file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vc4_bo_debugfs_init(minor: *mut drm_minor) -> c_int {
    ...
    if (!vc4.v3d)
    return -ENODEV;
    drm_debugfs_add_file(drm, "bo_stats", vc4_bo_stats_debugfs, core::ptr::null_mut());
    return 0;
    }
    static void vc4_bo_cache_destroy(struct drm_device *dev, void *unused);
#[no_mangle]
pub unsafe extern "C" fn vc4_bo_cache_init(dev: *mut drm_device) -> c_int {
...
//
    ...
    return drmm_add_action_or_reset(dev, vc4_bo_cache_destroy, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn vc4_bo_cache_destroy(dev: *mut drm_device, unused: *mut c_void) {
    static void vc4_bo_cache_destroy(struct drm_device *dev, void *unused)
    {
    struct vc4_dev *vc4 = to_vc4_dev(dev);
    int i;
