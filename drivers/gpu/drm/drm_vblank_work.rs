...
//! Source: drivers/gpu/drm/drm_vblank_work.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_handle_vblank_works(vblank: *mut drm_vblank_crtc) {
    void drm_handle_vblank_works(struct drm_vblank_crtc *vblank)
    {
    struct drm_vblank_work *work, *next;
    let mut count: u64 = atomic64_read(&vblank.count);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_vblank_cancel_pending_works(vblank: *mut drm_vblank_crtc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_vblank_work_cancel_sync(work: *mut drm_vblank_work) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_vblank_work_flush(work: *mut drm_vblank_work) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_vblank_work_flush_all(crtc: *mut drm_crtc) {
...
#[no_mangle]
pub unsafe extern "C" fn drm_vblank_worker_init(vblank: *mut drm_vblank_crtc) -> c_int {
