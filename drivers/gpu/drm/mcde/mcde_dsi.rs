...
//! Source: drivers/gpu/drm/mcde/mcde_dsi.c
#![no_std]
...
pub const DSI_DEFAULT_LP_FREQ_HZ: c_int = 19200000;
pub const DSI_DEFAULT_HS_FREQ_HZ: c_int = 420160000;
// PRCMU DSI reset registers
pub const PRCM_DSI_SW_RESET: c_uint = 0x324;
...
#[no_mangle]
pub unsafe extern "C" fn mcde_dsi_irq(mdsi: *mut mipi_dsi_device) -> bool {
    bool mcde_dsi_irq(struct mipi_dsi_device *mdsi)
    {
    struct mcde_dsi *d;
    u32 val;
    let mut te_received: bool = false;
...
#[no_mangle]
unsafe extern "C" fn mcde_dsi_attach_to_mcde(d: *mut mcde_dsi) {
...
// MIPI_DSI_FMT_RGB88 etc
    ...
    {
    struct mcde_dsi *d = host_to_mcde_dsi(host);
    d.mdsi = core::ptr::null_mut();
    if (d.mcde)
    d.mcde.mdsi = core::ptr::null_mut();
    return 0;
    }
    ...
    u32 loop_counter;
    let mut txlen: usize = msg.tx_len;
    let mut rxlen: usize = msg.rx_len;
    int i;
    u32 val;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn mcde_dsi_te_request(mdsi: *mut mipi_dsi_device) {
...
// cpp, characters per pixel, number of bytes per pixel
    let mut cpp: u8 = mipi_dsi_pixel_format_to_bpp(d.mdsi.format) / 8;
    u64 pclk;
    u64 bpl;
    int hfp;
    int hbp;
...
#[no_mangle]
unsafe extern "C" fn mcde_dsi_start(d: *mut mcde_dsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mcde_dsi_enable(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn mcde_dsi_wait_for_command_mode_stop(d: *mut mcde_dsi) {
...
#[no_mangle]
unsafe extern "C" fn mcde_dsi_wait_for_video_mode_stop(d: *mut mcde_dsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mcde_dsi_disable(bridge: *mut drm_bridge) {
...
// Attach the DSI bridge to the output (panel etc) bridge
    ...
    struct drm_panel *panel = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mcde_dsi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcde_dsi_remove(pdev: *mut platform_device) {
