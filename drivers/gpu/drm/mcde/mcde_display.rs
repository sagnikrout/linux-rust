...
//! Source: drivers/gpu/drm/mcde/mcde_display.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mcde_display_irq(mcde: *mut mcde) {
    void mcde_display_irq(struct mcde *mcde)
    {
    u32 mispp, misovl, mischnl;
    let mut vblank: bool = false;
// Handle display IRQs
...
#[no_mangle]
pub unsafe extern "C" fn mcde_display_disable_irqs(mcde: *mut mcde) {
...
// Clear any pending IRQs
    ...
    if (fb) {
    let mut offset: u32 = drm_fb_dma_get_gem_addr(fb, pstate, 0);
...
#[no_mangle]
unsafe extern "C" fn mcde_enable_fifo(mcde: *mut mcde, fifo: enum mcde_fifo) {
...
#[no_mangle]
unsafe extern "C" fn mcde_dsi_get_pkt_div(ppl: c_int, fifo_size: c_int) -> c_int {
...
//
    int div;
    let mut max_div: c_int = DIV_ROUND_UP(MCDE_MAX_WIDTH, fifo_size);
...
// dsi_formatter_frame = formatter_frame;
    ...
    let mut format: u32 = fb.format.format;
    int dsi_pkt_size;
    int fifo_wtrmrk;
    let mut cpp: c_int = fb.format.cpp[0];
...
#[no_mangle]
unsafe extern "C" fn mcde_display_disable(pipe: *mut drm_simple_display_pipe) {
...
#[no_mangle]
unsafe extern "C" fn mcde_start_flow(mcde: *mut mcde) {
...
#[no_mangle]
unsafe extern "C" fn mcde_set_extsrc(mcde: *mut mcde, buffer_address: u32) {
...
#[no_mangle]
unsafe extern "C" fn mcde_display_enable_vblank(pipe: *mut drm_simple_display_pipe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcde_display_disable_vblank(pipe: *mut drm_simple_display_pipe) {
...
#[no_mangle]
pub unsafe extern "C" fn mcde_display_init(drm: *mut drm_device) -> c_int {
