...
//! Source: drivers/gpu/drm/mcde/mcde_drv.c
#![no_std]
...
pub const MCDE_PID: c_uint = 0x000001FC;
pub const MCDE_PID_METALFIX_VERSION_SHIFT: c_int = 0;
pub const MCDE_PID_METALFIX_VERSION_MASK: c_uint = 0x000000FF;
pub const MCDE_PID_DEVELOPMENT_VERSION_SHIFT: c_int = 8;
pub const MCDE_PID_DEVELOPMENT_VERSION_MASK: c_uint = 0x0000FF00;
pub const MCDE_PID_MINOR_VERSION_SHIFT: c_int = 16;
pub const MCDE_PID_MINOR_VERSION_MASK: c_uint = 0x00FF0000;
pub const MCDE_PID_MAJOR_VERSION_SHIFT: c_int = 24;
pub const MCDE_PID_MAJOR_VERSION_MASK: c_uint = 0xFF000000;
...
#[no_mangle]
unsafe extern "C" fn mcde_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mcde_modeset_init(drm: *mut drm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcde_drm_bind(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcde_drm_unbind(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn mcde_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcde_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mcde_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mcde_drm_register() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mcde_drm_unregister() -> void __exit {
