...
//! Source: drivers/gpu/drm/tilcdc/tilcdc_crtc.c
#![no_std]
...
pub const TILCDC_VBLANK_SAFETY_THRESHOLD_US: c_int = 1000;
pub const TILCDC_PALETTE_SIZE: c_int = 32;
pub const TILCDC_PALETTE_FIRST_ENTRY: c_uint = 0x4000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tilcdc_crtc {
    pub base: drm_crtc,
    pub primary: *mut tilcdc_plane,
    pub event: *mut drm_pending_vblank_event,
    pub enable_lock: mutex,
    pub enabled: bool,
    pub shutdown: bool,
    pub frame_done_wq: wait_queue_head_t,
    pub frame_done: bool,
    pub irq_lock: spinlock_t,
    pub lcd_fck_rate: c_uint,
    pub last_vblank: ktime_t,
    pub hvtotal_us: c_uint,
    pub next_fb: *mut drm_framebuffer,
    pub sync_lost_count: c_int,
    pub frame_intact: bool,
    pub recover_work: work_struct,
    pub palette_dma_handle: dma_addr_t,
    pub palette_base: *mut u16,
    pub palette_loaded: completion,
}

#[no_mangle]
unsafe extern "C" fn set_scanout(crtc: *mut drm_crtc, fb: *mut drm_framebuffer) {
...
//
#[no_mangle]
unsafe extern "C" fn tilcdc_crtc_load_palette(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn tilcdc_crtc_enable_irqs(dev: *mut drm_device) {
...
#[no_mangle]
unsafe extern "C" fn tilcdc_crtc_disable_irqs(dev: *mut drm_device) {
...
#[no_mangle]
unsafe extern "C" fn reset(crtc: *mut drm_crtc) {
...
//
    ...
    {
    let mut r: c_int = rate / 100, rr = real_rate / 100;
    return (unsigned int)(abs(((rr - r) * 100) / r));
    }
#[no_mangle]
unsafe extern "C" fn tilcdc_crtc_set_clk(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn tilcdc_mode_hvtotal(mode: *const drm_display_mode) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn tilcdc_crtc_set_mode(crtc: *mut drm_crtc) {
...
// Use 16 bit DMA burst size by default
    ...
    if (priv.fifo_th) {
    let mut fifo_th_val: c_int = ilog2(priv.fifo_th) - 3;
    reg |= (fifo_th_val << 8);
    }
...
#[no_mangle]
unsafe extern "C" fn tilcdc_crtc_enable(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn tilcdc_crtc_off(crtc: *mut drm_crtc, shutdown: bool) {
...
#[no_mangle]
unsafe extern "C" fn tilcdc_crtc_disable(crtc: *mut drm_crtc) {
...
#[no_mangle]
pub unsafe extern "C" fn tilcdc_crtc_shutdown(crtc: *mut drm_crtc) {
    void tilcdc_crtc_shutdown(struct drm_crtc *crtc)
    {
    tilcdc_crtc_off(crtc, true);
    }
#[no_mangle]
unsafe extern "C" fn tilcdc_crtc_is_on(crtc: *mut drm_crtc) -> bool {
    static bool tilcdc_crtc_is_on(struct drm_crtc *crtc)
    {
    return crtc.state && crtc.state.enable && crtc.state.active;
    }
#[no_mangle]
unsafe extern "C" fn tilcdc_crtc_recover_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tilcdc_crtc_destroy(dev: *mut drm_device, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tilcdc_crtc_enable_vblank(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tilcdc_crtc_disable_vblank(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn tilcdc_crtc_reset(crtc: *mut drm_crtc) {
...
#[no_mangle]
pub unsafe extern "C" fn tilcdc_crtc_update_clk(crtc: *mut drm_crtc) {
...
pub const SYNC_LOST_COUNT_LIMIT: c_int = 50;
#[no_mangle]
pub unsafe extern "C" fn tilcdc_crtc_irq(crtc: *mut drm_crtc) -> irqreturn_t {
    ...
    tilcdc_crtc.next_fb = core::ptr::null_mut();
    skip_event = true;
    }
    ...
    tilcdc_crtc.event = core::ptr::null_mut();
    if (event)
...
#[no_mangle]
pub unsafe extern "C" fn tilcdc_crtc_create(dev: *mut drm_device) -> c_int {
