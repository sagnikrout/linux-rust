...
//! Source: drivers/gpu/drm/armada/armada_overlay.c
#![no_std]
...
pub const DEFAULT_BRIGHTNESS: c_int = 0;
pub const DEFAULT_CONTRAST: c_uint = 0x4000;
pub const DEFAULT_SATURATION: c_uint = 0x4000;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct armada_overlay_state {
    pub base: armada_plane_state,
    pub colorkey_yr: u32,
    pub colorkey_ug: u32,
    pub colorkey_vb: u32,
    pub colorkey_mode: u32,
    pub colorkey_enable: u32,
    pub brightness: i16,
    pub contrast: u16,
    pub saturation: u16,
}
...
#[no_mangle]
pub unsafe extern "C" fn armada_spu_contrast(state: *mut drm_plane_state) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn armada_spu_saturation(state: *mut drm_plane_state) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn armada_csc(state: *mut drm_plane_state) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn armada_overlay_reset(plane: *mut drm_plane) {
...
#[no_mangle]
unsafe extern "C" fn armada_overlay_create_properties(dev: *mut drm_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn armada_overlay_plane_create(dev: *mut drm_device, crtcs: c_ulong) -> c_int {
