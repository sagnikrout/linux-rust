...
//! Source: drivers/gpu/drm/armada/armada_drv.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn armada_drm_bind(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada_drm_unbind(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn armada_drm_probe(pdev: *mut platform_device) -> c_int {
    ...
    for (i = 0; devices[i]; i++) {
    d = bus_find_device_by_name(&platform_bus_type, core::ptr::null_mut(),
    devices[i]);
    if (d && d.of_node)
...
#[no_mangle]
unsafe extern "C" fn armada_drm_remove(pdev: *mut platform_device) {
    static void armada_drm_remove(struct platform_device *pdev)
    {
    component_master_del(&pdev.dev, &armada_master_ops);
    }
#[no_mangle]
unsafe extern "C" fn armada_drm_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn armada_drm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn armada_drm_exit() -> void __exit {
