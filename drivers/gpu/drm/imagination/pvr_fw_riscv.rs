...
//! Source: drivers/gpu/drm/imagination/pvr_fw_riscv.c
#![no_std]
...
// Copyright (c) 2024 Imagination Technologies Ltd.
    ...
    let mut code_addr: u64 = pvr_fw_obj_get_gpu_addr(pvr_dev.fw_dev.mem.code_obj);
    let mut data_addr: u64 = pvr_fw_obj_get_gpu_addr(pvr_dev.fw_dev.mem.data_obj);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rogue_riscv_fw_boot_data {
    pub coremem_code_dev_vaddr: u64,
    pub coremem_data_dev_vaddr: u64,
    pub coremem_code_fw_addr: u32,
    pub coremem_data_fw_addr: u32,
    pub coremem_code_size: u32,
    pub coremem_data_size: u32,
    pub flags: u32,
    pub reserved: u32,
}
    ...
    {
    let mut fw_addr: u32 = fw_obj.fw_addr_offset + offset;
