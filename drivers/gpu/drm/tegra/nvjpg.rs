...
//! Source: drivers/gpu/drm/tegra/nvjpg.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nvjpg_init(client: *mut host1x_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvjpg_exit(client: *mut host1x_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvjpg_load_falcon_firmware(nvjpg: *mut nvjpg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvjpg_runtime_resume(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn nvjpg_runtime_suspend(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn nvjpg_can_use_memory_ctx(client: *mut tegra_drm_client, supported: *mut bool) -> c_int {
...
// supported = false;
    ...
    .get_streamid_offset = core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn nvjpg_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvjpg_remove(pdev: *mut platform_device) {
    ...
    RUNTIME_PM_OPS(nvjpg_runtime_suspend, nvjpg_runtime_resume, core::ptr::null_mut())
