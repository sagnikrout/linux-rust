...
//! Source: drivers/gpu/drm/tegra/fb.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn tegra_fb_is_bottom_up(framebuffer: *mut drm_framebuffer) -> bool {
    ...
    {
    let mut modifier: u64 = framebuffer.modifier;
    ...
    let mut width: c_uint = cmd.width / (i ? info.hsub : 1);
    let mut height: c_uint = cmd.height / (i ? info.vsub : 1);
