...
//! Source: drivers/gpu/drm/tegra/nvdec.c
#![no_std]
...
pub const NVDEC_FALCON_DEBUGINFO: c_uint = 0x1094;
pub const NVDEC_TFBIF_TRANSCFG: c_uint = 0x2c44;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvdec_config {
    pub firmware: *const c_char,
    pub version: c_uint,
    pub supports_sid: bool,
    pub has_riscv: bool,
    pub has_extra_clocks: bool,
}
...
pub struct nvdec {
    ...
    pub client: tegra_drm_client,
    pub channel: *mut host1x_channel,
    pub dev: *mut device,
    pub clks: [clk_bulk_data; 3],
    pub num_clks: c_uint,
    pub reset: *mut reset_control,
// Platform configuration
    pub config: *const nvdec_config,
// RISC-V specific data
    pub riscv: tegra_drm_riscv,
    pub carveout_base: phys_addr_t,
}
...
#[no_mangle]
unsafe extern "C" fn nvdec_boot_falcon(nvdec: *mut nvdec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvdec_wait_debuginfo(nvdec: *mut nvdec, phase: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvdec_boot_riscv(nvdec: *mut nvdec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvdec_init(client: *mut host1x_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvdec_exit(client: *mut host1x_client) -> c_int {
...
// avoid a dangling pointer just in case this disappears
    client.dev.dma_parms = core::ptr::null_mut();
    ...
    host1x_channel_put(nvdec.channel);
    host1x_client_iommu_detach(client);
    nvdec.channel = core::ptr::null_mut();
    if (client.group) {
...
#[no_mangle]
unsafe extern "C" fn nvdec_load_falcon_firmware(nvdec: *mut nvdec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvdec_runtime_resume(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn nvdec_runtime_suspend(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn nvdec_close_channel(context: *mut tegra_drm_context) {
    static void nvdec_close_channel(struct tegra_drm_context *context)
    {
    host1x_channel_put(context.channel);
    }
#[no_mangle]
unsafe extern "C" fn nvdec_can_use_memory_ctx(client: *mut tegra_drm_client, supported: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvdec_probe(pdev: *mut platform_device) -> c_int {
...
// inherit DMA mask from host1x parent
    ...
    if (!syncpts)
    return -ENOMEM;
    nvdec.regs = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
    ...
    err = tegra_mc_get_carveout_info(mc, 1, &nvdec.carveout_base, core::ptr::null_mut());
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn nvdec_remove(pdev: *mut platform_device) {
    ...
    SET_RUNTIME_PM_OPS(nvdec_runtime_suspend, nvdec_runtime_resume, core::ptr::null_mut())
