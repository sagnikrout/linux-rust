...
//! Source: drivers/gpu/drm/tegra/rgb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_rgb {
    pub output: tegra_output,
    pub dc: *mut tegra_dc,
    pub pll_d_out0: *mut clk,
    pub pll_d2_out0: *mut clk,
...
#[no_mangle]
unsafe extern "C" fn tegra_rgb_encoder_disable(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn tegra_rgb_encoder_enable(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn tegra_rgb_pll_rate_change_allowed(rgb: *mut tegra_rgb) -> bool {
    ...
    let mut pclk: c_ulong = crtc_state.mode.clock * 1000;
    struct tegra_rgb *rgb = to_rgb(output);
    unsigned int div;
    int err;
//
...
#[no_mangle]
unsafe extern "C" fn tegra_dc_of_node_put(data: *mut c_void) {
    static void tegra_dc_of_node_put(void *data)
    {
    of_node_put(data);
    }
#[no_mangle]
pub unsafe extern "C" fn tegra_dc_rgb_probe(dc: *mut tegra_dc) -> c_int {
    ...
    if (err < 0)
    return err;
    rgb.clk = devm_clk_get(dc.dev, core::ptr::null_mut());
    if (IS_ERR(rgb.clk)) {
    ...
    rgb.pll_d_out0 = clk_get_sys(core::ptr::null_mut(), "pll_d_out0");
    ...
    rgb.pll_d2_out0 = clk_get_sys(core::ptr::null_mut(), "pll_d2_out0");
...
#[no_mangle]
pub unsafe extern "C" fn tegra_dc_rgb_remove(dc: *mut tegra_dc) {
    ...
    dc.rgb = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn tegra_dc_rgb_init(drm: *mut drm_device, dc: *mut tegra_dc) -> c_int {
...
//
    ...
    core::ptr::null_mut(), DRM_BRIDGE_ATTACH_NO_CONNECTOR);
    if (err)
    return err;
...
#[no_mangle]
pub unsafe extern "C" fn tegra_dc_rgb_exit(dc: *mut tegra_dc) -> c_int {
