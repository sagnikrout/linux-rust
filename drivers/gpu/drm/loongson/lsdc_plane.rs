...
//! Source: drivers/gpu/drm/loongson/lsdc_plane.c
#![no_std]
...
//
    ...
    {
    let mut offset: c_uint = fb.offsets[0];
    offset += fb.format.cpp[0] * (state.src_x >> 16);
    offset += fb.pitches[0] * (state.src_y >> 16);
    return offset;
    }
#[no_mangle]
unsafe extern "C" fn lsdc_fb_base_addr(fb: *mut drm_framebuffer) -> u64 {
    ...
    let mut fb_addr: u64 = lsdc_fb_base_addr(new_fb);
...
//
    ...
    drm_dbg(plane.dev, "%s: state is core::ptr::null_mut()\n", plane.name);
    return -EINVAL;
    }
...
// ls7a1000 cursor plane helpers
    ...
    struct drm_framebuffer *old_fb = old_plane_state.fb;
    const struct lsdc_cursor_plane_ops *ops = cursor.ops;
    let mut addr: u64 = lsdc_fb_base_addr(new_fb);
...
#[no_mangle]
unsafe extern "C" fn lsdc_primary0_update_fb_addr(primary: *mut lsdc_primary, addr: u64) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_primary0_update_fb_stride(primary: *mut lsdc_primary, stride: u32) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_primary1_update_fb_addr(primary: *mut lsdc_primary, addr: u64) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_primary1_update_fb_stride(primary: *mut lsdc_primary, stride: u32) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_cursor0_update_bo_addr(cursor: *mut lsdc_cursor, addr: u64) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_cursor0_update_position(cursor: *mut lsdc_cursor, x: c_int, y: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_cursor1_update_bo_addr(cursor: *mut lsdc_cursor, addr: u64) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_cursor1_update_position(cursor: *mut lsdc_cursor, x: c_int, y: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_cursor1_update_bo_addr_quirk(cursor: *mut lsdc_cursor, addr: u64) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_cursor1_update_position_quirk(cursor: *mut lsdc_cursor, x: c_int, y: c_int) {
