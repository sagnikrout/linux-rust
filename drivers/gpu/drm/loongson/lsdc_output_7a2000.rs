...
//! Source: drivers/gpu/drm/loongson/lsdc_output_7a2000.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ls7a2000_connector_get_modes(connector: *mut drm_connector) -> c_int {
...
// debugfs
    ...
    {core::ptr::null_mut(), 0},  /* MUST be {core::ptr::null_mut(), 0} terminated */
    };
...
#[no_mangle]
unsafe extern "C" fn ls7a2000_hdmi_encoder_regs_show(m: *mut seq_file, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ls7a2000_hdmi0_encoder_reset(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn ls7a2000_hdmi1_encoder_reset(encoder: *mut drm_encoder) {
...
#[no_mangle]
pub unsafe extern "C" fn if(85000: fin >=) -> else {
    else if (fin >= 85000)
    val = (8 << HDMI_PLL_IDF_SHIFT) |
    (40 << HDMI_PLL_LF_SHIFT) |
    (1 << HDMI_PLL_ODF_SHIFT);
#[no_mangle]
pub unsafe extern "C" fn if(42500: fin >=) -> else {
    else if (fin >= 42500)
    val = (4 << HDMI_PLL_IDF_SHIFT) |
    (40 << HDMI_PLL_LF_SHIFT) |
    (2 << HDMI_PLL_ODF_SHIFT);
#[no_mangle]
pub unsafe extern "C" fn if(21250: fin >=) -> else {
    else if  (fin >= 21250)
