...
//! Source: drivers/gpu/drm/loongson/lsdc_crtc.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn lsdc_crtc0_soft_reset(lcrtc: *mut lsdc_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc1_soft_reset(lcrtc: *mut lsdc_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc0_enable(lcrtc: *mut lsdc_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc0_disable(lcrtc: *mut lsdc_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc1_enable(lcrtc: *mut lsdc_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc1_disable(lcrtc: *mut lsdc_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc0_scan_pos(lcrtc: *mut lsdc_crtc, hpos: *mut c_int, vpos: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc1_scan_pos(lcrtc: *mut lsdc_crtc, hpos: *mut c_int, vpos: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc0_enable_vblank(lcrtc: *mut lsdc_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc0_disable_vblank(lcrtc: *mut lsdc_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc1_enable_vblank(lcrtc: *mut lsdc_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc1_disable_vblank(lcrtc: *mut lsdc_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc0_flip(lcrtc: *mut lsdc_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc1_flip(lcrtc: *mut lsdc_crtc) {
...
//
#[no_mangle]
unsafe extern "C" fn lsdc_crtc0_clone(lcrtc: *mut lsdc_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc1_clone(lcrtc: *mut lsdc_crtc) {
...
//
#[no_mangle]
unsafe extern "C" fn lsdc_crtc0_reset(lcrtc: *mut lsdc_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc1_reset(lcrtc: *mut lsdc_crtc) {
...
//
#[no_mangle]
unsafe extern "C" fn lsdc_crtc0_get_vblank_count(lcrtc: *mut lsdc_crtc) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc1_get_vblank_count(lcrtc: *mut lsdc_crtc) -> u32 {
...
//
    ...
    {
    struct lsdc_device *ldev = lcrtc.ldev;
    let mut val: u32 = lsdc_rreg32(ldev, LSDC_CRTC0_CFG_REG);
    ...
    {
    struct lsdc_device *ldev = lcrtc.ldev;
    let mut val: u32 = lsdc_rreg32(ldev, LSDC_CRTC1_CFG_REG);
    val &= ~CFG_DMA_STEP_MASK;
    val |= dma_step << CFG_DMA_STEP_SHIFT;
    lsdc_wreg32(ldev, LSDC_CRTC1_CFG_REG, val);
    }
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc_reset(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc_get_vblank_counter(crtc: *mut drm_crtc) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc_enable_vblank(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc_disable_vblank(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc_show_regs(m: *mut seq_file, arg: *mut c_void) -> c_int {
    ...
    let mut offset: u32 = preg.offset;
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc_show_scan_position(m: *mut seq_file, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc_show_vblank_counter(m: *mut seq_file, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lsdc_pixpll_show_clock(m: *mut seq_file, arg: *mut c_void) -> c_int {
    ...
    [0] = {
    { "regs", lsdc_crtc_show_regs, 0, core::ptr::null_mut() },
    { "pixclk", lsdc_pixpll_show_clock, 0, core::ptr::null_mut() },
    { "scanpos", lsdc_crtc_show_scan_position, 0, core::ptr::null_mut() },
    { "vblanks", lsdc_crtc_show_vblank_counter, 0, core::ptr::null_mut() },
    },
    [1] = {
    { "regs", lsdc_crtc_show_regs, 0, core::ptr::null_mut() },
    { "pixclk", lsdc_pixpll_show_clock, 0, core::ptr::null_mut() },
...
// operate manually
#[no_mangle]
unsafe extern "C" fn lsdc_crtc_man_op_show(m: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc_man_op_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "enable")) -> else {
    else if (sysfs_streq(buf, "enable"))
    ops.enable(lcrtc);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "disable")) -> else {
    else if (sysfs_streq(buf, "disable"))
    ops.disable(lcrtc);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "flip")) -> else {
    else if (sysfs_streq(buf, "flip"))
    ops.flip(lcrtc);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "clone")) -> else {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc_late_register(crtc: *mut drm_crtc) -> c_int {
    static int lsdc_crtc_late_register(struct drm_crtc *crtc)
    {
    struct lsdc_display_pipe *dispipe = crtc_to_display_pipe(crtc);
    struct lsdc_crtc *lcrtc = to_lsdc_crtc(crtc);
    struct drm_minor *minor = crtc.dev.primary;
    let mut index: c_uint = dispipe.index;
    unsigned int i;
...
// 4 for DRM_FORMAT_XRGB8888
    ...
    struct lsdc_crtc_state *priv_state = to_lsdc_crtc_state(state);
    let mut clock: c_uint = state.mode.clock;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc_mode_set_nofb(crtc: *mut drm_crtc) {
    ...
    let mut width_in_bytes: c_uint = mode.hdisplay * 4;
    enum lsdc_dma_steps dma_step;
//
...
#[no_mangle]
pub unsafe extern "C" fn if(0: width_in_bytes % 128 ==) -> else {
    else if (width_in_bytes % 128 == 0)
    dma_step = LSDC_DMA_STEP_128_BYTES;
#[no_mangle]
pub unsafe extern "C" fn if(0: width_in_bytes % 64 ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn lsdc_crtc_send_vblank(crtc: *mut drm_crtc) {
