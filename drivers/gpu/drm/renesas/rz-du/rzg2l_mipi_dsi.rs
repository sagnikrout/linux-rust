...
//! Source: drivers/gpu/drm/renesas/rz-du/rzg2l_mipi_dsi.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_mipi_dsi_hw_info {
    pub hsfreq_millihz): *mut *mut *mut int (dphy_init)(struct rzg2l_mipi_dsi dsi, u64,
    pub dsi): *mut *mut void (dphy_startup_late_init)(struct rzg2l_mipi_dsi,
    pub dsi): *mut *mut void (dphy_exit)(struct rzg2l_mipi_dsi,
    int (*dphy_conf_clks)(struct rzg2l_mipi_dsi *dsi, unsigned long mode_freq,
    pub hsfreq_millihz): *mut u64,
    unsigned int (*dphy_mode_clk_check)(struct rzg2l_mipi_dsi *dsi,
    pub mode_freq): c_ulong,
    struct {
    pub limits: *const rzv2h_pll_limits,
    pub table: *const u8,
    pub table_size: u8,
    pub cpg_plldsi: },
    pub phy_reg_offset: u32,
    pub link_reg_offset: u32,
    pub min_dclk: c_ulong,
    pub max_dclk: c_ulong,
    pub features: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzv2h_dsi_mode_calc {
    pub mode_freq_khz: c_ulong,
    pub dsi_parameters: rzv2h_pll_pars,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_mipi_dsi {
    pub dev: *mut device,
    pub mmio: *mut void __iomem,
    pub info: *const rzg2l_mipi_dsi_hw_info,
    pub rstc: *mut reset_control,
    pub arstc: *mut reset_control,
    pub prstc: *mut reset_control,
    ...
    pub mode_calc: rzv2h_dsi_mode_calc,
// DCS buffer pointers when using external memory.
    pub dcs_buf_phys: dma_addr_t,
    pub dcs_buf_virt: *mut u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_mipi_dsi_timings {
    pub hsfreq_max: c_ulong,
    pub t_init: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzv2h_mipi_dsi_timings {
    pub hsfreq: *const u8,
    pub len: u8,
    pub base_value: u8,
}
...
//
#[no_mangle]
unsafe extern "C" fn rzv2h_dphy_find_ulpsexit(freq: c_ulong) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn rzv2h_dphy_find_timings_val(freq: c_ulong, index: u8) -> u16 {
...
//
    ...
    let mut hsfreq: c_ulong = timings.hsfreq[i] * 10 * MEGA;
    if (freq <= hsfreq)
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn rzg2l_mipi_dsi_phy_write(dsi: *mut rzg2l_mipi_dsi, reg: u32, data: u32) {
    static void rzg2l_mipi_dsi_phy_write(struct rzg2l_mipi_dsi *dsi, u32 reg, u32 data)
    {
    iowrite32(data, dsi.mmio + dsi.info.phy_reg_offset + reg);
    }
#[no_mangle]
unsafe extern "C" fn rzg2l_mipi_dsi_link_write(dsi: *mut rzg2l_mipi_dsi, reg: u32, data: u32) {
    static void rzg2l_mipi_dsi_link_write(struct rzg2l_mipi_dsi *dsi, u32 reg, u32 data)
    {
    iowrite32(data, dsi.mmio + dsi.info.link_reg_offset + reg);
    }
#[no_mangle]
unsafe extern "C" fn rzg2l_mipi_dsi_phy_read(dsi: *mut rzg2l_mipi_dsi, reg: u32) -> u32 {
    static u32 rzg2l_mipi_dsi_phy_read(struct rzg2l_mipi_dsi *dsi, u32 reg)
    {
    return ioread32(dsi.mmio + dsi.info.phy_reg_offset + reg);
    }
#[no_mangle]
unsafe extern "C" fn rzg2l_mipi_dsi_link_read(dsi: *mut rzg2l_mipi_dsi, reg: u32) -> u32 {
...
//
    ...
    u64 hsfreq_millihz)
    {
    let mut hsfreq: c_ulong = DIV_ROUND_CLOSEST_ULL(hsfreq_millihz, MILLI);
...
#[no_mangle]
unsafe extern "C" fn rzg2l_mipi_dsi_dphy_exit(dsi: *mut rzg2l_mipi_dsi) {
...
// hsfreq_millihz = dsi_parameters->freq_millihz;
    ...
    {
    struct rzv2h_pll_pars *dsi_parameters = &dsi.mode_calc.dsi_parameters;
    let mut lpclk_rate: c_ulong = clk_get_rate(dsi.lpclk);
...
#[no_mangle]
unsafe extern "C" fn rzv2h_mipi_dsi_dphy_startup_late_init(dsi: *mut rzg2l_mipi_dsi) {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_mipi_dsi_dphy_exit(dsi: *mut rzg2l_mipi_dsi) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_mipi_dsi_stop(dsi: *mut rzg2l_mipi_dsi) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_mipi_dsi_start_hs_clock(dsi: *mut rzg2l_mipi_dsi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_mipi_dsi_stop_hs_clock(dsi: *mut rzg2l_mipi_dsi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_mipi_dsi_start_video(dsi: *mut rzg2l_mipi_dsi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_mipi_dsi_stop_video(dsi: *mut rzg2l_mipi_dsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rzg2l_mipi_pm_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_mipi_pm_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(rzg2l_mipi_pm_runtime_suspend, rzg2l_mipi_pm_runtime_resume, core::ptr::null_mut())
    };
// -----------------------------------------------------------------------------
// Probe & Remove
//
#[no_mangle]
unsafe extern "C" fn rzg2l_mipi_dsi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_mipi_dsi_remove(pdev: *mut platform_device) {
