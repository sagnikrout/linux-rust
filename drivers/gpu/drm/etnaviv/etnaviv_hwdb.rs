...
//! Source: drivers/gpu/drm/etnaviv/etnaviv_hwdb.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn etnaviv_fill_identity_from_hwdb(gpu: *mut etnaviv_gpu) -> bool {
    bool etnaviv_fill_identity_from_hwdb(struct etnaviv_gpu *gpu)
    {
    struct etnaviv_chip_identity *ident = &gpu.identity;
    let mut product_id: u32 = ident.product_id;
    let mut customer_id: u32 = ident.customer_id;
    let mut eco_id: u32 = ident.eco_id;
    int i;
