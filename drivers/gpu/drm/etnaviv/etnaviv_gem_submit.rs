...
//! Source: drivers/gpu/drm/etnaviv/etnaviv_gem_submit.c
#![no_std]
...
pub const BO_LOCKED: c_uint = 0x4000;
pub const BO_PINNED: c_uint = 0x2000;
...
#[no_mangle]
unsafe extern "C" fn submit_unlock_object(submit: *mut etnaviv_gem_submit, i: c_int) {
...
#[no_mangle]
unsafe extern "C" fn submit_fence_sync(submit: *mut etnaviv_gem_submit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn submit_attach_object_fences(submit: *mut etnaviv_gem_submit) {
    static void submit_attach_object_fences(struct etnaviv_gem_submit *submit)
    {
    int i;
    for (i = 0; i < submit.nr_bos; i++) {
    struct drm_gem_object *obj = &submit.bos[i].obj.base;
    let mut write: bool = submit.bos[i].flags & ETNA_SUBMIT_BO_WRITE;
...
#[no_mangle]
unsafe extern "C" fn submit_pin_objects(submit: *mut etnaviv_gem_submit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn submit_cleanup(kref: *mut kref) {
...
// unpin all objects
    ...
    submit.bos[i].mapping = core::ptr::null_mut();
    submit.bos[i].flags &= ~BO_PINNED;
    }
...
#[no_mangle]
pub unsafe extern "C" fn etnaviv_submit_put(submit: *mut etnaviv_gem_submit) {
