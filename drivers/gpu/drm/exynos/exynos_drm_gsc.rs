...
//! Source: drivers/gpu/drm/exynos/exynos_drm_gsc.c
#![no_std]
...
//
pub const GSC_MAX_CLOCKS: c_int = 8;
pub const GSC_MAX_SRC: c_int = 4;
pub const GSC_MAX_DST: c_int = 16;
pub const GSC_RESET_TIMEOUT: c_int = 50;
pub const GSC_BUF_STOP: c_int = 1;
pub const GSC_BUF_START: c_int = 2;
pub const GSC_REG_SZ: c_int = 16;
pub const GSC_WIDTH_ITU_709: c_int = 1280;
pub const GSC_SC_UP_MAX_RATIO: c_int = 65536;
pub const GSC_SC_DOWN_RATIO_7_8: c_int = 74898;
pub const GSC_SC_DOWN_RATIO_6_8: c_int = 87381;
pub const GSC_SC_DOWN_RATIO_5_8: c_int = 104857;
pub const GSC_SC_DOWN_RATIO_4_8: c_int = 131072;
pub const GSC_SC_DOWN_RATIO_3_8: c_int = 174762;
pub const GSC_SC_DOWN_RATIO_2_8: c_int = 262144;
pub const GSC_CROP_MAX: c_int = 8192;
pub const GSC_CROP_MIN: c_int = 32;
pub const GSC_SCALE_MAX: c_int = 4224;
pub const GSC_SCALE_MIN: c_int = 32;
pub const GSC_COEF_RATIO: c_int = 7;
pub const GSC_COEF_PHASE: c_int = 9;
pub const GSC_COEF_ATTR: c_int = 16;
pub const GSC_COEF_H_8T: c_int = 8;
pub const GSC_COEF_V_4T: c_int = 4;
pub const GSC_COEF_DEPTH: c_int = 3;
pub const GSC_AUTOSUSPEND_DELAY: c_int = 2000;
...
pub struct gsc_scaler {
    ...
    pub pre_hratio: u32,
    pub pre_vratio: u32,
    pub main_hratio: c_ulong,
    pub main_vratio: c_ulong,
}
...
#[no_mangle]
unsafe extern "C" fn gsc_sw_reset(ctx: *mut gsc_context) -> c_int {
    static int gsc_sw_reset(struct gsc_context *ctx)
    {
    u32 cfg;
    let mut count: c_int = GSC_RESET_TIMEOUT;
// s/w reset
...
#[no_mangle]
unsafe extern "C" fn gsc_src_set_fmt(ctx: *mut gsc_context, fmt: u32, tiled: bool) {
...
#[no_mangle]
unsafe extern "C" fn gsc_src_set_transf(ctx: *mut gsc_context, rotation: c_uint) {
    static void gsc_src_set_transf(struct gsc_context *ctx, unsigned int rotation)
    {
    let mut degree: c_uint = rotation & DRM_MODE_ROTATE_MASK;
    u32 cfg;
    cfg = gsc_read(GSC_IN_CON);
    cfg &= ~GSC_IN_ROT_MASK;
    switch (degree) {
...
// original size
    ...
    bool enqueue)
    {
    let mut masked: bool = !enqueue;
    u32 cfg;
    let mut mask: u32 = 0x00000001 << buf_id;
// mask register set
    cfg = gsc_read(GSC_IN_BASE_ADDR_Y_MASK);
// sequence id
    cfg &= ~mask;
...
#[no_mangle]
unsafe extern "C" fn gsc_dst_set_fmt(ctx: *mut gsc_context, fmt: u32, tiled: bool) {
...
// ratio = 4;
#[no_mangle]
pub unsafe extern "C" fn if(2: *mut *mut src >= dst) -> else {
    else if (src >= dst * 2)
// ratio = 2;
    else
// ratio = 1;
...
#[no_mangle]
unsafe extern "C" fn gsc_get_prescaler_shfactor(hratio: u32, vratio: u32, shfactor: *mut u32) {
...
// shfactor = 2;
#[no_mangle]
pub unsafe extern "C" fn if(1: hratio == 1 && vratio ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn gsc_set_h_coef(ctx: *mut gsc_context, main_hratio: c_ulong) {
    ...
    sc_ratio = 0;
#[no_mangle]
pub unsafe extern "C" fn if(GSC_SC_DOWN_RATIO_7_8: main_hratio <=) -> else {
    else if (main_hratio <= GSC_SC_DOWN_RATIO_7_8)
    sc_ratio = 1;
#[no_mangle]
pub unsafe extern "C" fn if(GSC_SC_DOWN_RATIO_6_8: main_hratio <=) -> else {
    else if (main_hratio <= GSC_SC_DOWN_RATIO_6_8)
    sc_ratio = 2;
#[no_mangle]
pub unsafe extern "C" fn if(GSC_SC_DOWN_RATIO_5_8: main_hratio <=) -> else {
    else if (main_hratio <= GSC_SC_DOWN_RATIO_5_8)
    sc_ratio = 3;
#[no_mangle]
pub unsafe extern "C" fn if(GSC_SC_DOWN_RATIO_4_8: main_hratio <=) -> else {
    else if (main_hratio <= GSC_SC_DOWN_RATIO_4_8)
    sc_ratio = 4;
#[no_mangle]
pub unsafe extern "C" fn if(GSC_SC_DOWN_RATIO_3_8: main_hratio <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn gsc_set_v_coef(ctx: *mut gsc_context, main_vratio: c_ulong) {
    ...
    sc_ratio = 0;
#[no_mangle]
pub unsafe extern "C" fn if(GSC_SC_DOWN_RATIO_7_8: main_vratio <=) -> else {
    else if (main_vratio <= GSC_SC_DOWN_RATIO_7_8)
    sc_ratio = 1;
#[no_mangle]
pub unsafe extern "C" fn if(GSC_SC_DOWN_RATIO_6_8: main_vratio <=) -> else {
    else if (main_vratio <= GSC_SC_DOWN_RATIO_6_8)
    sc_ratio = 2;
#[no_mangle]
pub unsafe extern "C" fn if(GSC_SC_DOWN_RATIO_5_8: main_vratio <=) -> else {
    else if (main_vratio <= GSC_SC_DOWN_RATIO_5_8)
    sc_ratio = 3;
#[no_mangle]
pub unsafe extern "C" fn if(GSC_SC_DOWN_RATIO_4_8: main_vratio <=) -> else {
    else if (main_vratio <= GSC_SC_DOWN_RATIO_4_8)
    sc_ratio = 4;
#[no_mangle]
pub unsafe extern "C" fn if(GSC_SC_DOWN_RATIO_3_8: main_vratio <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn gsc_set_scaler(ctx: *mut gsc_context, sc: *mut gsc_scaler) {
...
#[no_mangle]
unsafe extern "C" fn gsc_dst_get_buf_seq(ctx: *mut gsc_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gsc_get_src_buf_index(ctx: *mut gsc_context) -> c_int {
    static int gsc_get_src_buf_index(struct gsc_context *ctx)
    {
    u32 cfg, curr_index, i;
    let mut buf_id: u32 = GSC_MAX_SRC;
...
#[no_mangle]
unsafe extern "C" fn gsc_get_dst_buf_index(ctx: *mut gsc_context) -> c_int {
    static int gsc_get_dst_buf_index(struct gsc_context *ctx)
    {
    u32 cfg, curr_index, i;
    let mut buf_id: u32 = GSC_MAX_DST;
    DRM_DEV_DEBUG_KMS(ctx.dev, "gsc id[%d]\n", ctx.id);
    cfg = gsc_read(GSC_OUT_BASE_ADDR_Y_MASK);
...
#[no_mangle]
unsafe extern "C" fn gsc_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gsc_reset(ctx: *mut gsc_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gsc_start(ctx: *mut gsc_context) {
...
#[no_mangle]
unsafe extern "C" fn gsc_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gsc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gsc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn gsc_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn gsc_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(gsc_runtime_suspend, gsc_runtime_resume, core::ptr::null_mut())
    };
