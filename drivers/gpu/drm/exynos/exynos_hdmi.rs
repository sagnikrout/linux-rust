...
//! Source: drivers/gpu/drm/exynos/exynos_hdmi.c
#![no_std]
...
pub const HOTPLUG_DEBOUNCE_MS: c_int = 1100;
    enum hdmi_type {
    HDMI_TYPE13,
    HDMI_TYPE14,
    HDMI_TYPE_COUNT
    };
pub const HDMI_MAPPED_BASE: c_uint = 0xffff0000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdmiphy_config {
    pub pixel_clock: c_int,
    pub conf: [u8; 32],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdmiphy_configs {
    pub count: c_int,
    pub data: *const hdmiphy_config,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct string_array_spec {
    pub count: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdmi_driver_data {
    pub type: c_uint,
    pub is_apb_phy:1: c_uint,
    pub has_sysreg:1: c_uint,
    pub phy_confs: hdmiphy_configs,
    pub clk_gates: string_array_spec,
//
...
//
    pub clk_muxes: string_array_spec,
}
...
pub struct hdmi_audio {
    ...
    pub infoframe: hdmi_audio_infoframe,
    pub params: hdmi_codec_params,
    pub mute: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdmi_context {
    ...
    pub drv_data: *const hdmi_driver_data,
    pub regs: *mut void __iomem,
    pub regs_hdmiphy: *mut void __iomem,
    pub hdmiphy_port: *mut i2c_client,
    pub ddc_adpt: *mut i2c_adapter,
    pub hpd_gpio: *mut gpio_desc,
    pub irq: c_int,
    pub pmureg: *mut regmap,
    pub sysreg: *mut regmap,
    pub clk_gates: *mut clk,
    pub clk_muxes: *mut clk,
    pub regul_bulk: [regulator_bulk_data; ARRAY_SIZE(supply)],
    pub reg_hdmi_en: *mut regulator,
    pub phy_clk: exynos_drm_clk,
...
#[no_mangle]
pub unsafe extern "C" fn hdmi_map_reg(hdata: *mut hdmi_context, reg_id: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn hdmi_reg_read(hdata: *mut hdmi_context, reg_id: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hdmi_clk_enable_gates(hdata: *mut hdmi_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_clk_disable_gates(hdata: *mut hdmi_context) {
    static void hdmi_clk_disable_gates(struct hdmi_context *hdata)
    {
    let mut i: c_int = hdata.drv_data.clk_gates.count;
    while (i--)
    clk_disable_unprepare(hdata.clk_gates[i]);
    }
#[no_mangle]
unsafe extern "C" fn hdmi_clk_set_parents(hdata: *mut hdmi_context, to_phy: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_audio_infoframe_apply(hdata: *mut hdmi_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_reg_infoframes(hdata: *mut hdmi_context) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_connector_destroy(connector: *mut drm_connector) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_find_phy_conf(hdata: *mut hdmi_context, pixel_clock: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_create_connector(encoder: *mut drm_encoder) -> c_int {
    ...
    if (hdata.bridge)
    ret = drm_bridge_attach(encoder, hdata.bridge, core::ptr::null_mut(), 0);
    cec_fill_conn_info_from_drm(&conn_info, connector);
    hdata.notifier = cec_notifier_conn_register(hdata.dev, core::ptr::null_mut(),
    &conn_info);
    if (!hdata.notifier) {
    ret = -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn hdmi_reg_acr(hdata: *mut hdmi_context, freq: u32) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_audio_config(hdata: *mut hdmi_context) {
    static void hdmi_audio_config(struct hdmi_context *hdata)
    {
    let mut bit_ch: u32 = 1;
    u32 data_num, val;
    int i;
...
#[no_mangle]
unsafe extern "C" fn hdmi_audio_control(hdata: *mut hdmi_context) {
    static void hdmi_audio_control(struct hdmi_context *hdata)
    {
    let mut enable: bool = !hdata.audio.mute;
    if (hdata.dvi_mode)
    return;
...
#[no_mangle]
unsafe extern "C" fn hdmi_start(hdata: *mut hdmi_context, start: bool) {
    static void hdmi_start(struct hdmi_context *hdata, bool start)
    {
    struct drm_display_mode *m = &hdata.encoder.crtc.state.mode;
    let mut val: u32 = start ? HDMI_TG_EN : 0;
...
#[no_mangle]
unsafe extern "C" fn hdmi_conf_init(hdata: *mut hdmi_context) {
...
#[no_mangle]
unsafe extern "C" fn hdmiphy_wait_for_pll(hdata: *mut hdmi_context) {
    static void hdmiphy_wait_for_pll(struct hdmi_context *hdata)
    {
    int tries;
    for (tries = 0; tries < 10; ++tries) {
    let mut val: u32 = hdmi_reg_read(hdata, HDMI_PHY_STATUS);
...
#[no_mangle]
unsafe extern "C" fn hdmi_v13_mode_apply(hdata: *mut hdmi_context) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_v14_mode_apply(hdata: *mut hdmi_context) {
    static void hdmi_v14_mode_apply(struct hdmi_context *hdata)
    {
    struct drm_display_mode *m = &hdata.encoder.crtc.state.mode;
    struct drm_display_mode *am =
    &hdata.encoder.crtc.state.adjusted_mode;
    let mut hquirk: c_int = 0;
//
...
#[no_mangle]
unsafe extern "C" fn hdmi_mode_apply(hdata: *mut hdmi_context) {
...
#[no_mangle]
unsafe extern "C" fn hdmiphy_conf_reset(hdata: *mut hdmi_context) {
...
#[no_mangle]
unsafe extern "C" fn hdmiphy_enable_mode_set(hdata: *mut hdmi_context, enable: bool) {
    static void hdmiphy_enable_mode_set(struct hdmi_context *hdata, bool enable)
    {
    let mut v: u8 = enable ? HDMI_PHY_ENABLE_MODE_SET : HDMI_PHY_DISABLE_MODE_SET;
    if (hdata.drv_data == &exynos5433_hdmi_driver_data)
    writel(v, hdata.regs_hdmiphy + HDMIPHY5433_MODE_SET_DONE);
    }
#[no_mangle]
unsafe extern "C" fn hdmiphy_conf_apply(hdata: *mut hdmi_context) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_conf_apply(hdata: *mut hdmi_context) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_set_refclk(hdata: *mut hdmi_context, on: bool) {
...
// Should be called with hdata->mutex mutex held.
#[no_mangle]
unsafe extern "C" fn hdmiphy_enable(hdata: *mut hdmi_context) {
...
// Should be called with hdata->mutex mutex held.
#[no_mangle]
unsafe extern "C" fn hdmiphy_disable(hdata: *mut hdmi_context) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_enable(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_disable(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_audio_shutdown(dev: *mut device, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_register_audio_device(hdata: *mut hdmi_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_hotplug_work_func(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_irq_thread(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn hdmi_clk_init(hdata: *mut hdmi_context) -> c_int {
    static int hdmi_clk_init(struct hdmi_context *hdata)
    {
    const struct hdmi_driver_data *drv_data = hdata.drv_data;
    let mut count: c_int = drv_data.clk_gates.count + drv_data.clk_muxes.count;
    struct device *dev = hdata.dev;
    struct clk **clks;
    int ret;
    if (!count)
...
#[no_mangle]
unsafe extern "C" fn hdmiphy_clk_enable(clk: *mut exynos_drm_clk, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_bridge_init(hdata: *mut hdmi_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_resources_init(hdata: *mut hdmi_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_unbind(dev: *mut device, master: *mut device, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_get_ddc_adapter(hdata: *mut hdmi_context) -> c_int {
    static int hdmi_get_ddc_adapter(struct hdmi_context *hdata)
    {
    const char *compatible_str = "samsung,exynos4210-hdmiddc";
    struct device_node *np;
    struct i2c_adapter *adpt;
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), compatible_str);
    if (np)
...
#[no_mangle]
unsafe extern "C" fn hdmi_get_phy_io(hdata: *mut hdmi_context) -> c_int {
    static int hdmi_get_phy_io(struct hdmi_context *hdata)
    {
    const char *compatible_str = "samsung,exynos4212-hdmiphy";
    struct device_node *np __free(device_node) =
    of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), compatible_str);
    if (!np) {
...
#[no_mangle]
unsafe extern "C" fn hdmi_probe(pdev: *mut platform_device) -> c_int {
    ...
    ret = devm_request_threaded_irq(dev, hdata.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn hdmi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn exynos_hdmi_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn exynos_hdmi_resume(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(exynos_hdmi_suspend, exynos_hdmi_resume, core::ptr::null_mut())
