...
//! Source: drivers/gpu/drm/exynos/exynos_drm_dsi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn exynos_dsi_te_irq_handler(dsim: *mut samsung_dsim) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn exynos_dsi_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exynos_dsi_unbind(dev: *mut device, master: *mut device, data: *mut c_void) {
    static void exynos_dsi_unbind(struct device *dev, struct device *master, void *data)
    {
    struct samsung_dsim *dsim = dev_get_drvdata(dev);
    dsim.bridge.funcs.atomic_disable(&dsim.bridge, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn exynos_dsi_register_host(dsim: *mut samsung_dsim) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exynos_dsi_unregister_host(dsim: *mut samsung_dsim) {
