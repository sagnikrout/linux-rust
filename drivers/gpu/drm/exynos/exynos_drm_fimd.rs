...
//! Source: drivers/gpu/drm/exynos/exynos_drm_fimd.c
#![no_std]
...
// CPU Interface.
//
pub const MIN_FB_WIDTH_FOR_16WORD_BURST: c_int = 128;
...
pub const TRIGCON: c_uint = 0x1A4;
...
pub const VIDOUT_CON: c_uint = 0x000;

// I80 interface control for main LDI register

// FIMD has totally five hardware windows.
pub const WINDOWS_NR: c_int = 5;
// HW trigger flag on i80 panel.

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fimd_driver_data {
    pub timing_base: c_uint,
    pub lcdblk_offset: c_uint,
    pub lcdblk_vt_shift: c_uint,
    pub lcdblk_bypass_shift: c_uint,
    pub lcdblk_mic_bypass_shift: c_uint,
    pub trg_type: c_uint,
    pub has_shadowcon:1: c_uint,
    pub has_clksel:1: c_uint,
    pub has_limited_fmt:1: c_uint,
    pub has_vidoutcon:1: c_uint,
    pub has_vtsel:1: c_uint,
    pub has_mic_bypass:1: c_uint,
    pub has_dp_clk:1: c_uint,
    pub has_hw_trigger:1: c_uint,
    pub has_trigger_per_te:1: c_uint,
    pub has_bgr_support:1: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fimd_context {
    pub dev: *mut device,
    pub drm_dev: *mut drm_device,
    pub dma_priv: *mut c_void,
    pub crtc: *mut exynos_drm_crtc,
    pub planes: [exynos_drm_plane; WINDOWS_NR],
    pub configs: [exynos_drm_plane_config; WINDOWS_NR],
    pub bus_clk: *mut clk,
    pub lcd_clk: *mut clk,
    ...
    pub i80_if: bool,
    pub suspended: bool,
    pub dp_clk_enabled: bool,
    pub wait_vsync_queue: wait_queue_head_t,
    pub wait_vsync_event: core::sync::atomic::AtomicI32,
    pub win_updated: core::sync::atomic::AtomicI32,
    pub triggering: core::sync::atomic::AtomicI32,
    pub clkdiv: u32,
    pub driver_data: *const fimd_driver_data,
    pub encoder: *mut drm_encoder,
    pub dp_clk: exynos_drm_clk,
}
...
#[no_mangle]
unsafe extern "C" fn fimd_enable_vblank(crtc: *mut exynos_drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fimd_disable_vblank(crtc: *mut exynos_drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn fimd_wait_for_vblank(crtc: *mut exynos_drm_crtc) {
...
//
    ...
    bool enable)
    {
    let mut val: u32 = readl(ctx.regs + WINCON(win));
    if (enable)
    val |= WINCONx_ENWIN;
    else
    val &= ~WINCONx_ENWIN;
    ...
    bool enable)
    {
    let mut val: u32 = readl(ctx.regs + SHADOWCON);
    if (enable)
...
#[no_mangle]
unsafe extern "C" fn fimd_clear_channels(crtc: *mut exynos_drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fimd_setup_trigger(ctx: *mut fimd_context) {
    static void fimd_setup_trigger(struct fimd_context *ctx)
    {
    void __iomem *timing_base = ctx.regs + ctx.driver_data.timing_base;
    let mut trg_type: u32 = ctx.driver_data.trg_type;
    let mut val: u32 = readl(timing_base + TRIGCON);
    val &= ~(TRGMODE_ENABLE);
...
#[no_mangle]
unsafe extern "C" fn fimd_commit(crtc: *mut exynos_drm_crtc) {
...
//
    ...
    {
    let mut mask: u32 = BLENDEQ_A_FUNC_F(0xf) | BLENDEQ_B_FUNC_F(0xf);
    let mut val: u32 = 0;
    switch (pixel_alpha) {
    ...
    unsigned int alpha, unsigned int pixel_alpha)
    {
    let mut win_alpha_l: u32 = (alpha >> 8) & 0xf;
    let mut win_alpha_h: u32 = alpha >> 12;
    let mut val: u32 = 0;
    switch (pixel_alpha) {
    case DRM_MODE_BLEND_PIXEL_NONE:
    break;
...
// OSD alpha
    ...
    let mut alpha: c_uint = state.base.alpha;
    let mut val: u32 = WINCONx_ENWIN;
...
#[no_mangle]
unsafe extern "C" fn fimd_win_set_colkey(ctx: *mut fimd_context, win: c_uint) {
    static void fimd_win_set_colkey(struct fimd_context *ctx, unsigned int win)
    {
    let mut keycon0: c_uint = 0, keycon1 = 0;
...
#[no_mangle]
unsafe extern "C" fn fimd_atomic_begin(crtc: *mut exynos_drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn fimd_atomic_flush(crtc: *mut exynos_drm_crtc) {
    ...
    let mut pitch: c_uint = fb.pitches[0];
    if (ctx.suspended)
    return;
...
// OSD size
    if (win != 3 && win != 4) {
    let mut offset: u32 = VIDOSD_D(win);
    if (win == 0)
    offset = VIDOSD_C(win);
...
#[no_mangle]
unsafe extern "C" fn fimd_atomic_enable(crtc: *mut exynos_drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn fimd_atomic_disable(crtc: *mut exynos_drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn fimd_trigger(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn fimd_te_handler(crtc: *mut exynos_drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn fimd_dp_clock_enable(clk: *mut exynos_drm_clk, enable: bool) {
    static void fimd_dp_clock_enable(struct exynos_drm_clk *clk, bool enable)
    {
    struct fimd_context *ctx = container_of(clk, struct fimd_context,
    dp_clk);
    let mut val: u32 = enable ? DP_MIE_CLK_DP_ENABLE : DP_MIE_CLK_DISABLE;
...
#[no_mangle]
unsafe extern "C" fn fimd_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fimd_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fimd_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fimd_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn exynos_fimd_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exynos_fimd_resume(dev: *mut device) -> c_int {
    ...
    exynos_fimd_resume, core::ptr::null_mut());
