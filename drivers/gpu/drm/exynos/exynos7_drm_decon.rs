...
//! Source: drivers/gpu/drm/exynos/exynos7_drm_decon.c
#![no_std]
...
pub const WINDOWS_NR: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct decon_data {
    pub vidw_buf_start_base: c_uint,
    pub shadowcon_win_protect_shift: c_uint,
    pub wincon_burstlen_shift: c_uint,
}
...
//
    ...
    {
    u32 bits, val;
    let mut shift: c_uint = ctx.data.shadowcon_win_protect_shift;
...
#[no_mangle]
unsafe extern "C" fn decon_wait_for_vblank(ctx: *mut decon_context) {
...
#[no_mangle]
unsafe extern "C" fn decon_clear_channels(ctx: *mut decon_context) {
...
#[no_mangle]
unsafe extern "C" fn decon_ctx_remove(ctx: *mut decon_context) {
...
// detach this sub driver from iommu mapping if supported.
    ...
    {
    let mut ideal_clk: c_ulong = mode.clock * 1000;
    u32 clkdiv;
...
unsafe extern "C" fn decon_disable_vblank(crtc: *mut exynos_drm_crtc) {
    ...
    unsigned long val;
    int padding;
    let mut shift: c_uint = ctx.data.wincon_burstlen_shift;
    val = readl(ctx.regs + WINCON(win));
...
#[no_mangle]
unsafe extern "C" fn decon_win_set_colkey(ctx: *mut decon_context, win: c_uint) {
...
unsafe extern "C" fn decon_atomic_begin(crtc: *mut exynos_drm_crtc) {
    ...
    let mut vidw_addr0_base: c_uint = ctx.data.vidw_buf_start_base;
//
...
#[no_mangle]
unsafe extern "C" fn decon_init(ctx: *mut decon_context) {
...
#[no_mangle]
unsafe extern "C" fn decon_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decon_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn exynos7_decon_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exynos7_decon_resume(dev: *mut device) -> c_int {
    ...
    exynos7_decon_resume, core::ptr::null_mut());
