...
//! Source: drivers/gpu/drm/exynos/exynos_drm_fimc.c
#![no_std]
...
pub const FIMC_MAX_SRC: c_int = 2;
pub const FIMC_MAX_DST: c_int = 32;
pub const FIMC_SHFACTOR: c_int = 10;
pub const FIMC_BUF_STOP: c_int = 1;
pub const FIMC_BUF_START: c_int = 2;
pub const FIMC_WIDTH_ITU_709: c_int = 1280;
pub const FIMC_AUTOSUSPEND_DELAY: c_int = 2000;
    let mut fimc_mask: static unsigned int = 0xc;
...
pub struct fimc_context {
    ...
    pub lock: spinlock_t,
    pub clocks: [*mut clk; FIMC_CLKS_MAX],
    pub sc: fimc_scaler,
    pub id: c_int,
    pub irq: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn fimc_read(ctx: *mut fimc_context, reg: u32) -> u32 {
    static u32 fimc_read(struct fimc_context *ctx, u32 reg)
    {
    return readl(ctx.regs + reg);
    }
#[no_mangle]
unsafe extern "C" fn fimc_write(ctx: *mut fimc_context, val: u32, reg: u32) {
    static void fimc_write(struct fimc_context *ctx, u32 val, u32 reg)
    {
    writel(val, ctx.regs + reg);
    }
#[no_mangle]
unsafe extern "C" fn fimc_set_bits(ctx: *mut fimc_context, reg: u32, bits: u32) {
...
#[no_mangle]
unsafe extern "C" fn fimc_clear_bits(ctx: *mut fimc_context, reg: u32, bits: u32) {
...
#[no_mangle]
unsafe extern "C" fn fimc_sw_reset(ctx: *mut fimc_context) {
...
#[no_mangle]
unsafe extern "C" fn fimc_set_type_ctrl(ctx: *mut fimc_context) {
...
#[no_mangle]
unsafe extern "C" fn fimc_handle_jpeg(ctx: *mut fimc_context, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn fimc_mask_irq(ctx: *mut fimc_context, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn fimc_clear_irq(ctx: *mut fimc_context) {
    static void fimc_clear_irq(struct fimc_context *ctx)
    {
    fimc_set_bits(ctx, EXYNOS_CIGCTRL, EXYNOS_CIGCTRL_IRQ_CLR);
    }
#[no_mangle]
unsafe extern "C" fn fimc_check_ovf(ctx: *mut fimc_context) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fimc_check_frame_end(ctx: *mut fimc_context) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fimc_get_buf_id(ctx: *mut fimc_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fimc_handle_lastend(ctx: *mut fimc_context, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn fimc_src_set_fmt_order(ctx: *mut fimc_context, fmt: u32) {
...
#[no_mangle]
unsafe extern "C" fn fimc_src_set_fmt(ctx: *mut fimc_context, fmt: u32, tiled: bool) {
...
#[no_mangle]
unsafe extern "C" fn fimc_src_set_transf(ctx: *mut fimc_context, rotation: c_uint) {
    ...
    {
    let mut real_width: c_uint = buf.buf.pitch[0] / buf.format.cpp[0];
    u32 cfg, h1, h2, v1, v2;
// cropped image
    h1 = buf.rect.x;
...
#[no_mangle]
unsafe extern "C" fn fimc_dst_set_fmt_order(ctx: *mut fimc_context, fmt: u32) {
...
#[no_mangle]
unsafe extern "C" fn fimc_dst_set_fmt(ctx: *mut fimc_context, fmt: u32, tiled: bool) {
...
#[no_mangle]
unsafe extern "C" fn fimc_dst_set_transf(ctx: *mut fimc_context, rotation: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn fimc_set_scaler(ctx: *mut fimc_context, sc: *mut fimc_scaler) {
...
#[no_mangle]
pub unsafe extern "C" fn if(FIMC_BUF_STOP: !enqueue && buf_num <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn fimc_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fimc_clear_addr(ctx: *mut fimc_context) {
...
#[no_mangle]
unsafe extern "C" fn fimc_reset(ctx: *mut fimc_context) {
...
#[no_mangle]
unsafe extern "C" fn fimc_start(ctx: *mut fimc_context) {
...
#[no_mangle]
unsafe extern "C" fn fimc_stop(ctx: *mut fimc_context) {
    static void fimc_stop(struct fimc_context *ctx)
    {
    u32 cfg;
// Source clear
...
#[no_mangle]
unsafe extern "C" fn fimc_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fimc_put_clocks(ctx: *mut fimc_context) {
...
#[no_mangle]
unsafe extern "C" fn fimc_setup_clocks(ctx: *mut fimc_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn exynos_drm_check_fimc_device(dev: *mut device) -> c_int {
    int exynos_drm_check_fimc_device(struct device *dev)
    {
    let mut id: c_int = of_alias_get_id(dev.of_node, "fimc");
...
#[no_mangle]
unsafe extern "C" fn fimc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fimc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn fimc_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fimc_runtime_resume(dev: *mut device) -> c_int {
    ...
    fimc_runtime_resume, core::ptr::null_mut());
