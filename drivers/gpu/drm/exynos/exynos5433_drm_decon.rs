...
//! Source: drivers/gpu/drm/exynos/exynos5433_drm_decon.c
#![no_std]
...
pub const PRIMARY_WIN: c_int = 2;
pub const CURSON_WIN: c_int = 4;
...
pub struct decon_context {
    ...
    pub clks: [*mut clk; ARRAY_SIZE(decon_clks_name)],
    pub irq: c_uint,
    pub irq_vsync: c_uint,
    pub irq_lcd_sys: c_uint,
    pub te_irq: c_uint,
    pub out_type: c_ulong,
    pub first_win: c_int,
...
#[no_mangle]
unsafe extern "C" fn decon_enable_vblank(crtc: *mut exynos_drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decon_disable_vblank(crtc: *mut exynos_drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn decon_get_frame_count(ctx: *mut decon_context, end: bool) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn decon_setup_trigger(ctx: *mut decon_context) {
...
#[no_mangle]
unsafe extern "C" fn decon_commit(crtc: *mut exynos_drm_crtc) {
    static void decon_commit(struct exynos_drm_crtc *crtc)
    {
    struct decon_context *ctx = crtc.ctx;
    struct drm_display_mode *m = &crtc.base.mode;
    let mut interlaced: bool = false;
    u32 val;
...
// lcd on and use command if
    ...
    if (!crtc.i80_mode) {
    let mut vbp: c_int = m.crtc_vtotal - m.crtc_vsync_end;
    let mut vfp: c_int = m.crtc_vsync_start - m.crtc_vdisplay;
    if (interlaced)
    vbp = vbp / 2 - 1;
...
// enable output and display signal
    ...
    {
    let mut mask: u32 = BLENDERQ_A_FUNC_F(0xf) | BLENDERQ_B_FUNC_F(0xf);
    let mut val: u32 = 0;
    switch (pixel_alpha) {
...
#[no_mangle]
unsafe extern "C" fn decon_shadow_protect(ctx: *mut decon_context, protect: bool) {
...
#[no_mangle]
unsafe extern "C" fn decon_atomic_begin(crtc: *mut exynos_drm_crtc) {
    ...
    let mut dma_addr: dma_addr_t = exynos_drm_fb_dma_addr(fb, 0);
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn decon_atomic_flush(crtc: *mut exynos_drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn decon_swreset(ctx: *mut decon_context) {
...
#[no_mangle]
unsafe extern "C" fn decon_atomic_enable(crtc: *mut exynos_drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn decon_atomic_disable(crtc: *mut exynos_drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn decon_te_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn decon_clear_channels(crtc: *mut exynos_drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn decon_bind(dev: *mut device, master: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decon_unbind(dev: *mut device, master: *mut device, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn decon_handle_vblank(ctx: *mut decon_context) {
...
#[no_mangle]
unsafe extern "C" fn decon_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn exynos5433_decon_suspend(dev: *mut device) -> c_int {
    static int exynos5433_decon_suspend(struct device *dev)
    {
    struct decon_context *ctx = dev_get_drvdata(dev);
    let mut i: c_int = ARRAY_SIZE(decon_clks_name);
    while (--i >= 0)
    clk_disable_unprepare(ctx.clks[i]);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn exynos5433_decon_resume(dev: *mut device) -> c_int {
    ...
    exynos5433_decon_resume, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn exynos5433_decon_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exynos5433_decon_remove(pdev: *mut platform_device) {
