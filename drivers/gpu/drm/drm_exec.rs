...
//! Source: drivers/gpu/drm/drm_exec.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn drm_exec_unlock_all(exec: *mut drm_exec) {
    ...
    exec.prelocked = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_exec_init(exec: *mut drm_exec, flags: u32, nr: unsigned) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_exec_fini(exec: *mut drm_exec) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_exec_cleanup(exec: *mut drm_exec) -> bool {
    ...
    exec.contended = core::ptr::null_mut();
...
// Track the locked object in the array
    ...
    let mut size: usize = exec.max_objects * sizeof(void *);
    void *tmp;
...
#[no_mangle]
unsafe extern "C" fn drm_exec_lock_contended(exec: *mut drm_exec) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_exec_lock_obj(exec: *mut drm_exec, obj: *mut drm_gem_object) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_exec_unlock_obj(exec: *mut drm_exec, obj: *mut drm_gem_object) {
