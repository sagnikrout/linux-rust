...
//! Source: drivers/gpu/drm/drm_mipi_dbi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mipi_dbi_command_is_read(dbi: *mut mipi_dbi, cmd: u8) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mipi_dbi_command_read(dbi: *mut mipi_dbi, cmd: u8, val: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mipi_dbi_command_buf(dbi: *mut mipi_dbi, cmd: u8, data: *mut u8, len: usize) -> c_int {
...
//
    ...
    let mut dst_map: iosys_map = IOSYS_MAP_INIT_VADDR(dst);
    int ret;
    ...
    if (swap)
    drm_fb_swab(&dst_map, core::ptr::null_mut(), src, fb, clip, !drm_gem_is_imported(gem),
    fmtcnv_state);
    else
    drm_fb_memcpy(&dst_map, core::ptr::null_mut(), src, fb, clip);
    break;
    ...
    case DRM_FORMAT_RGB565:
    if (swap) {
    drm_fb_xrgb8888_to_rgb565be(&dst_map, core::ptr::null_mut(), src, fb, clip,
    fmtcnv_state);
    } else {
    drm_fb_xrgb8888_to_rgb565(&dst_map, core::ptr::null_mut(), src, fb, clip,
    fmtcnv_state);
    }
    break;
    case DRM_FORMAT_RGB888:
    drm_fb_xrgb8888_to_rgb888(&dst_map, core::ptr::null_mut(), src, fb, clip, fmtcnv_state);
    break;
    }
    break;
    default:
...
#[no_mangle]
unsafe extern "C" fn mipi_dbi_blank(dbidev: *mut mipi_dbi_dev) {
    static void mipi_dbi_blank(struct mipi_dbi_dev *dbidev)
    {
    struct drm_device *drm = &dbidev.drm;
    let mut height: u16 = drm.mode_config.min_height;
    let mut width: u16 = drm.mode_config.min_width;
    struct mipi_dbi *dbi = &dbidev.dbi;
    const struct drm_format_info *dst_format;
    size_t len;
    int idx;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mipi_dbi_crtc_helper_atomic_check(crtc: *mut drm_crtc, state: *mut drm_atomic_commit) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mipi_dbi_connector_helper_get_modes(connector: *mut drm_connector) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mipi_dbi_hw_reset(dbi: *mut mipi_dbi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mipi_dbi_display_is_on(dbi: *mut mipi_dbi) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mipi_dbi_poweron_reset_conditional(dbidev: *mut mipi_dbi_dev, cond: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mipi_dbi_poweron_reset(dbidev: *mut mipi_dbi_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mipi_dbi_poweron_conditional_reset(dbidev: *mut mipi_dbi_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mipi_dbi_spi_cmd_max_speed(spi: *mut spi_device, len: usize) -> u32 {
...
//
    ...
    unsigned int bpw)
    {
    let mut swap_bytes: bool = (bpw == 16);
...
// dst++ = src[7];
    ...
    tr.tx_buf = dst16;
    while (len) {
    let mut chunk: usize = min(len, max_chunk);
    unsigned int i;
    if (bpw == 16) {
...
//
    ...
    {
    let mut max_chunk: usize = spi_max_transfer_size(spi);
    struct spi_transfer tr = {
    .bits_per_word = bpw,
    .speed_hz = speed_hz,
    };
...
#[no_mangle]
unsafe extern "C" fn mipi_dbi_debugfs_command_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mipi_dbi_debugfs_init(minor: *mut drm_minor) {
    void mipi_dbi_debugfs_init(struct drm_minor *minor)
    {
    struct mipi_dbi_dev *dbidev = drm_to_mipi_dbi_dev(minor.dev);
    let mut mode: umode_t = S_IFREG | S_IWUSR;
