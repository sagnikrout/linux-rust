...
//! Source: drivers/gpu/drm/drm_gem_dma_helper.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_dma_free(dma_obj: *mut drm_gem_dma_object) {
    void drm_gem_dma_free(struct drm_gem_dma_object *dma_obj)
    {
    struct drm_gem_object *gem_obj = &dma_obj.base;
    let mut map: iosys_map = IOSYS_MAP_INIT_VADDR(dma_obj.vaddr);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_dma_mmap(dma_obj: *mut drm_gem_dma_object, vma: *mut vm_area_struct) -> c_int {
