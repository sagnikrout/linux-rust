...
//! Source: drivers/gpu/drm/i915/selftests/i915_active.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct live_active {
    pub base: i915_active,
    pub ref: kref,
    pub retired: bool,
}

#[no_mangle]
unsafe extern "C" fn __live_get(active: *mut live_active) {
    static void __live_get(struct live_active *active)
    {
    kref_get(&active.ref);
    }
#[no_mangle]
unsafe extern "C" fn __live_free(active: *mut live_active) {
...
#[no_mangle]
unsafe extern "C" fn __live_release(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn __live_put(active: *mut live_active) {
    static void __live_put(struct live_active *active)
    {
    kref_put(&active.ref, __live_release);
    }
#[no_mangle]
unsafe extern "C" fn __live_active(base: *mut i915_active) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __live_retire(base: *mut i915_active) {
...
#[no_mangle]
unsafe extern "C" fn live_active_wait(arg: *mut c_void) -> c_int {
...
// Check that we get a callback when requests retire upon waiting
    ...
    let mut p: drm_printer = drm_err_printer(&i915.drm, __func__);
...
#[no_mangle]
unsafe extern "C" fn live_active_retire(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_active_barrier(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_active_live_selftests(i915: *mut drm_i915_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_active_print(ref: *mut i915_active, m: *mut drm_printer) {
...
#[no_mangle]
unsafe extern "C" fn spin_unlock_wait(lock: *mut spinlock_t) {
    ...
    fence = xchg(__active_fence_slot(active), core::ptr::null_mut());
    if (!fence)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn i915_active_unlock_wait(ref: *mut i915_active) {
