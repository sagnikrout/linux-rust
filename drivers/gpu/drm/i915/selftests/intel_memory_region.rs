...
//! Source: drivers/gpu/drm/i915/selftests/intel_memory_region.c
#![no_std]
...
unsafe extern "C" fn igt_mock_fill(arg: *mut c_void) -> c_int {
    ...
    let mut total: resource_size_t = resource_size(&mem.region);
    ...
    let mut size: resource_size_t = page_num * page_size;
...
#[no_mangle]
unsafe extern "C" fn igt_object_release(obj: *mut drm_i915_gem_object) {
...
#[no_mangle]
unsafe extern "C" fn is_contiguous(obj: *mut drm_i915_gem_object) -> bool {
    static bool is_contiguous(struct drm_i915_gem_object *obj)
    {
    struct scatterlist *sg;
    let mut addr: dma_addr_t = -1;
...
#[no_mangle]
unsafe extern "C" fn igt_mock_reserve(arg: *mut c_void) -> c_int {
    static int igt_mock_reserve(void *arg)
    {
    struct intel_memory_region *mem = arg;
    struct drm_i915_private *i915 = mem.i915;
    let mut avail: resource_size_t = resource_size(&mem.region);
    struct drm_i915_gem_object *obj;
    let mut chunk_size: u32 = SZ_32M;
...
// Reserve a bunch of ranges within the region
    for (i = 0; i < count; ++i) {
    let mut start: u64 = order[i] * chunk_size;
    let mut size: u64 = i915_prandom_u32_max_state(chunk_size, &prng);
...
// Try to see if we can allocate from the remaining space
    ...
    cur_avail = avail;
    do {
    let mut size: u32 = i915_prandom_u32_max_state(cur_avail, &prng);
...
#[no_mangle]
unsafe extern "C" fn igt_mock_contiguous(arg: *mut c_void) -> c_int {
...
//
    do {
    let mut should_fail: bool = target > min;
    obj = igt_object_create(mem, &objects, target,
    I915_BO_ALLOC_CONTIGUOUS);
...
#[no_mangle]
unsafe extern "C" fn igt_mock_splintered_region(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_mock_max_segment(arg: *mut c_void) -> c_int {
...
//
    ...
    for (sg = obj.mm.pages.sgl; sg; sg = sg_next(sg)) {
    let mut daddr: dma_addr_t = sg_dma_address(sg);
...
#[no_mangle]
unsafe extern "C" fn igt_object_mappable_total(obj: *mut drm_i915_gem_object) -> u64 {
    ...
    let mut end: u64 = start + gpu_buddy_block_size(mm, block);
...
#[no_mangle]
unsafe extern "C" fn igt_mock_io_size(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_cpu_check(obj: *mut drm_i915_gem_object, dword: u32, val: u32) -> c_int {
    ...
    do {
    let mut rng: u32 = prandom_u32_state(&prng);
    let mut dword: u32 = offset_in_page(rng) / 4;
...
#[no_mangle]
unsafe extern "C" fn igt_lmem_create(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_lmem_create_with_ps(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_lmem_create_cleared_cpu(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_lmem_write_gpu(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_lmem_write_cpu(arg: *mut c_void) -> c_int {
...
// Put the pages into a known state -- from the gpu for added fun
    ...
    err = intel_context_migrate_clear(engine.gt.migrate.context, core::ptr::null_mut(),
    obj.mm.pages.sgl,
...
#[no_mangle]
unsafe extern "C" fn wrap_ktime_compare(A: *const c_void, B: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_memcpy_long(dst: *mut c_void, src: *const c_void, size: usize) {
...
#[no_mangle]
pub unsafe extern "C" fn igt_memcpy(dst: *mut c_void, src: *const c_void, size: usize) {
    static inline void igt_memcpy(void *dst, const void *src, size_t size)
    {
    memcpy(dst, src, size);
    }
#[no_mangle]
pub unsafe extern "C" fn igt_memcpy_from_wc(dst: *mut c_void, src: *const c_void, size: usize) {
    ...
    sort(t, ARRAY_SIZE(t), sizeof(*t), wrap_ktime_compare, core::ptr::null_mut());
    if (t[0] <= 0) {
...
#[no_mangle]
unsafe extern "C" fn perf_memcpy(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_memory_region_mock_selftests() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_memory_region_live_selftests(i915: *mut drm_i915_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_memory_region_perf_selftests(i915: *mut drm_i915_private) -> c_int {
