...
//! Source: drivers/gpu/drm/i915/selftests/i915_perf.c
#![no_std]
...
//
    ...
    {
    struct i915_oa_config *oa_config = core::ptr::null_mut(), *tmp;
    int id;
    mutex_lock(&perf.metrics_lock);
    ...
    {
    let mut param: drm_i915_perf_open_param = {};
...
#[no_mangle]
unsafe extern "C" fn stream_destroy(stream: *mut i915_perf_stream) {
...
#[no_mangle]
unsafe extern "C" fn poll_status(rq: *mut i915_request, slot: c_int) -> ktime_t {
...
#[no_mangle]
unsafe extern "C" fn live_noa_delay(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_noa_gpr(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_perf_live_selftests(i915: *mut drm_i915_private) -> c_int {
