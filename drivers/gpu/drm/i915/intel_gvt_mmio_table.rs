...
//! Source: drivers/gpu/drm/i915/intel_gvt_mmio_table.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn iterate_generic_mmio(iter: *mut intel_gvt_mmio_table_iter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iterate_bdw_only_mmio(iter: *mut intel_gvt_mmio_table_iter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iterate_bdw_plus_mmio(iter: *mut intel_gvt_mmio_table_iter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iterate_pre_skl_mmio(iter: *mut intel_gvt_mmio_table_iter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iterate_skl_plus_mmio(iter: *mut intel_gvt_mmio_table_iter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iterate_bxt_mmio(iter: *mut intel_gvt_mmio_table_iter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_gvt_iterate_mmio_table(iter: *mut intel_gvt_mmio_table_iter) -> c_int {
