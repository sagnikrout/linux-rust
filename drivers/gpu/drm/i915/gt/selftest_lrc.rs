...
//! Source: drivers/gpu/drm/i915/gt/selftest_lrc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn emit_semaphore_signal(ce: *mut intel_context, slot: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn context_flush(ce: *mut intel_context, timeout: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_lri_mask(engine: *mut intel_engine_cs, lri: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_lrc_layout(arg: *mut c_void) -> c_int {
...
//
    ...
    dw = 0;
    do {
    let mut lri: u32 = READ_ONCE(hw[dw]);
    u32 lri_mask;
    if (lri == 0) {
    dw++;
    continue;
...
//
    ...
    dw++;
    while (lri) {
    let mut offset: u32 = READ_ONCE(hw[dw]);
...
#[no_mangle]
unsafe extern "C" fn find_offset(lri: *const u32, offset: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_lrc_fixed(arg: *mut c_void) -> c_int {
...
//
    ...
    hw += LRC_STATE_OFFSET / sizeof(*hw);
    for (t = tbl; t.name; t++) {
    let mut dw: c_int = find_offset(hw, t.reg);
    if (dw != t.offset) {
...
#[no_mangle]
unsafe extern "C" fn live_lrc_state(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpr_make_dirty(ce: *mut intel_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_lrc_gpr(arg: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lrc_timestamp {
    pub engine: *mut intel_engine_cs,
    pub ce: [*mut intel_context; 2],
    pub poison: u32,
}

#[no_mangle]
unsafe extern "C" fn timestamp_advanced(start: u32, end: u32) -> bool {
    static bool timestamp_advanced(u32 start, u32 end)
    {
    return (s32)(end - start) > 0;
    }
#[no_mangle]
unsafe extern "C" fn __lrc_timestamp(arg: *const lrc_timestamp, preempt: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_lrc_timestamp(arg: *mut c_void) -> c_int {
    static int live_lrc_timestamp(void *arg)
    {
    let mut data: lrc_timestamp = {};
    struct intel_gt *gt = arg;
    enum intel_engine_id id;
    const u32 poison[] = {
    0,
...
#[no_mangle]
unsafe extern "C" fn safe_poison(offset: u32, poison: u32) -> u32 {
...
//
    ...
    hw += LRC_STATE_OFFSET / sizeof(*hw);
    do {
    let mut len: u32 = hw[dw] & LRI_LENGTH_MASK;
//
...
#[no_mangle]
unsafe extern "C" fn poison_registers(ce: *mut intel_context, poison: u32, sema: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_moving(a: u32, b: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __lrc_isolation(engine: *mut intel_engine_cs, poison: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn skip_isolation(engine: *const intel_engine_cs) -> bool {
...
#[no_mangle]
unsafe extern "C" fn live_lrc_isolation(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wabb_ctx_submit_req(ce: *mut intel_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_ring_start(ce: *mut intel_context, per_ctx: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wabb_ctx_check(ce: *mut intel_context, per_ctx: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __lrc_wabb_ctx(engine: *mut intel_engine_cs, per_ctx: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lrc_wabb_ctx(arg: *mut c_void, per_ctx: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_lrc_indirect_ctx_bb(arg: *mut c_void) -> c_int {
    static int live_lrc_indirect_ctx_bb(void *arg)
    {
    return lrc_wabb_ctx(arg, false);
    }
#[no_mangle]
unsafe extern "C" fn live_lrc_per_ctx_bb(arg: *mut c_void) -> c_int {
    ...
    struct i915_request *rq)
    {
    let mut bit: c_uint = I915_RESET_ENGINE + engine.id;
...
#[no_mangle]
unsafe extern "C" fn __lrc_garbage(engine: *mut intel_engine_cs, prng: *mut rnd_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_lrc_garbage(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __live_pphwsp_runtime(engine: *mut intel_engine_cs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_pphwsp_runtime(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_lrc_live_selftests(i915: *mut drm_i915_private) -> c_int {
