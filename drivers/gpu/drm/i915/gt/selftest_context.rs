...
//! Source: drivers/gpu/drm/i915/gt/selftest_context.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn request_sync(rq: *mut i915_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __live_context_size(engine: *mut intel_engine_cs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_context_size(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __live_active_context(engine: *mut intel_engine_cs) -> c_int {
...
// Wait for the barrier and in the process wait for engine to park
    ...
    DRM_UT_DRIVER, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn live_active_context(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __remote_sync(ce: *mut intel_context, remote: *mut intel_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __live_remote_context(engine: *mut intel_engine_cs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_remote_context(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_context_live_selftests(i915: *mut drm_i915_private) -> c_int {
