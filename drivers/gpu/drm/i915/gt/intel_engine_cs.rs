...
//! Source: drivers/gpu/drm/i915/gt/intel_engine_cs.c
#![no_std]
...
pub const MAX_MMIO_BASES: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct engine_mmio_base {
    pub 8: u32 graphics_ver :,
    pub 24: u32 base :,
    pub mmio_bases: [}; MAX_MMIO_BASES],
}
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_engine_context_size(gt: *mut intel_gt, class: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __sprint_engine_name(engine: *mut intel_engine_cs) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_engine_set_hwsp_writemask(engine: *mut intel_engine_cs, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn intel_engine_sanitize_mmio(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn nop_irq_handler(engine: *mut intel_engine_cs, iir: u16) {
    static void nop_irq_handler(struct intel_engine_cs *engine, u16 iir)
    {
    GEM_DEBUG_WARN_ON(iir);
    }
#[no_mangle]
unsafe extern "C" fn get_reset_domain(ver: u8, id: enum intel_engine_id) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn intel_clamp_heartbeat_interval_ms(engine: *mut intel_engine_cs, value: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn intel_clamp_max_busywait_duration_ns(engine: *mut intel_engine_cs, value: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn intel_clamp_preempt_timeout_ms(engine: *mut intel_engine_cs, value: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn intel_clamp_stop_timeout_ms(engine: *mut intel_engine_cs, value: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn intel_clamp_timeslice_duration_ms(engine: *mut intel_engine_cs, value: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn __setup_engine_capabilities(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn intel_setup_engine_capabilities(gt: *mut intel_gt) {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_engines_release(gt: *mut intel_gt) {
...
// Decouple the backend; but keep the layout for late GPU resets
    ...
    engine.release = core::ptr::null_mut();
    memset(&engine.reset, 0, sizeof(engine.reset));
    }
    llist_del_all(&gt.i915.uabi_engines_llist);
    }
#[no_mangle]
pub unsafe extern "C" fn intel_engine_free_request_pool(engine: *mut intel_engine_cs) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_engines_free(gt: *mut intel_gt) {
...
//
    ...
    return false;
#[no_mangle]
pub unsafe extern "C" fn if(12: MEDIA_VER(i915) >=) -> else {
    else if (MEDIA_VER(i915) >= 12)
    return (physical_vdbox % 2 == 0) ||
    !(BIT(physical_vdbox - 1) & vdbox_mask);
#[no_mangle]
pub unsafe extern "C" fn if(11: MEDIA_VER(i915) ==) -> else {
    else if (MEDIA_VER(i915) == 11)
    return logical_vdbox % 2 == 0;
    return false;
    }
#[no_mangle]
unsafe extern "C" fn engine_mask_apply_media_fuses(gt: *mut intel_gt) {
    static void engine_mask_apply_media_fuses(struct intel_gt *gt)
    {
    struct drm_i915_private *i915 = gt.i915;
    let mut logical_vdbox: c_uint = 0;
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn engine_mask_apply_compute_fuses(gt: *mut intel_gt) {
    static void engine_mask_apply_compute_fuses(struct intel_gt *gt)
    {
    struct drm_i915_private *i915 = gt.i915;
    struct intel_gt_info *info = &gt.info;
    let mut ss_per_ccs: c_int = info.sseu.max_subslices / I915_MAX_CCS;
...
//
#[no_mangle]
unsafe extern "C" fn init_engine_mask(gt: *mut intel_gt) -> intel_engine_mask_t {
...
//
    if (IS_DG2(gt.i915)) {
    let mut first_ccs: u8 = __ffs(CCS_MASK(gt));
//
...
// Put back in the first CCS engine
    ...
    {
    int i, j;
    let mut current_logical_id: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn setup_logical_ids(gt: *mut intel_gt, logical_ids: *mut u8, class: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_engines_init_mmio(gt: *mut intel_gt) -> c_int {
    int intel_engines_init_mmio(struct intel_gt *gt)
    {
    struct drm_i915_private *i915 = gt.i915;
    let mut engine_mask: c_uint = init_engine_mask(gt);
    ...
    for (i = 0; i < ARRAY_SIZE(intel_engines); ++i) {
    let mut instance: u8 = intel_engines[i].instance;
...
#[no_mangle]
pub unsafe extern "C" fn intel_engine_init_execlists(engine: *mut intel_engine_cs) {
    void intel_engine_init_execlists(struct intel_engine_cs *engine)
    {
    let mut execlists: *mut intel_engine_execlists  const = &engine.execlists;
...
#[no_mangle]
unsafe extern "C" fn cleanup_status_page(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn init_status_page(engine: *mut intel_engine_cs) -> c_int {
...
//
    ...
    vma = i915_vma_instance(obj, &engine.gt.ggtt.vm, core::ptr::null_mut());
    if (IS_ERR(vma)) {
    ret = PTR_ERR(vma);
    goto err_put;
    }
...
#[no_mangle]
unsafe extern "C" fn intel_engine_init_tlb_invalidation(engine: *mut intel_engine_cs) -> c_int {
    ...
    struct drm_i915_private *i915 = engine.i915;
    let mut instance: c_uint = engine.instance;
    let mut class: c_uint = engine.class;
...
#[no_mangle]
unsafe extern "C" fn engine_setup_common(engine: *mut intel_engine_cs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn measure_breadcrumb_dw(ce: *mut intel_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_engine_destroy_pinned_context(ce: *mut intel_context) {
...
//
#[no_mangle]
unsafe extern "C" fn engine_init_common(engine: *mut intel_engine_cs) -> c_int {
    static int engine_init_common(struct intel_engine_cs *engine)
    {
    struct intel_context *ce, *bce = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn intel_engines_init(gt: *mut intel_gt) -> c_int {
...
// The backend should now be responsible for cleanup
    GEM_BUG_ON(engine.release == core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_engine_cleanup_common(engine: *mut intel_engine_cs) {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_engine_resume(engine: *mut intel_engine_cs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_engine_get_active_head(engine: *const intel_engine_cs) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn if(4: GRAPHICS_VER(i915) >=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn intel_engine_get_last_batch_head(engine: *const intel_engine_cs) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn stop_timeout(engine: *const intel_engine_cs) -> c_ulong {
...
//
    ...
    let mut mode: i915_reg_t = RING_MI_MODE(engine.mmio_base);
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn intel_engine_stop_cs(engine: *mut intel_engine_cs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_engine_cancel_stop_cs(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn __cs_pending_mi_force_wakes(engine: *mut intel_engine_cs) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __gpm_wait_for_fw_complete(gt: *mut intel_gt, fw_mask: u32) {
...
// Wait for forcewake request to complete in GPM
    ...
    fw_mask, fw_mask, 5000, 0, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_engine_wait_for_pending_mi_fw(engine: *mut intel_engine_cs) {
    void intel_engine_wait_for_pending_mi_fw(struct intel_engine_cs *engine)
    {
    let mut fw_pending: u32 = __cs_pending_mi_force_wakes(engine);
    if (fw_pending)
...
// NB: please notice the memset
    ...
    struct drm_i915_private *i915 = engine.i915;
    struct intel_uncore *uncore = engine.uncore;
    let mut mmio_base: u32 = engine.mmio_base;
    int slice;
    int subslice;
    int iter;
...
#[no_mangle]
unsafe extern "C" fn ring_is_idle(engine: *mut intel_engine_cs) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn __intel_engine_flush_submission(engine: *mut intel_engine_cs, sync: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_engine_is_idle(engine: *mut intel_engine_cs) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn intel_engines_are_idle(gt: *mut intel_gt) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn intel_engine_irq_enable(engine: *mut intel_engine_cs) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn intel_engine_irq_disable(engine: *mut intel_engine_cs) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_engines_reset_default_submission(gt: *mut intel_gt) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_engine_can_store_dword(engine: *mut intel_engine_cs) -> bool {
...
#[no_mangle]
unsafe extern "C" fn print_ring(buf: *mut c_char, sz: c_int, rq: *mut i915_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hexdump(m: *mut drm_printer, buf: *const c_void, len: usize) {
    static void hexdump(struct drm_printer *m, const void *buf, size_t len)
    {
    let mut rowsize: usize = 8 * sizeof(u32);
    const void *prev = core::ptr::null_mut();
...
pub unsafe extern "C" fn if(4: GRAPHICS_VER(i915) >=) -> else {
    ...
    let mut num_entries: u8 = execlists.csb_size;
    unsigned int idx;
    u8 read, write;
...
#[no_mangle]
unsafe extern "C" fn print_request_ring(m: *mut drm_printer, rq: *mut i915_request) {
...
#[no_mangle]
unsafe extern "C" fn read_ul(p: *mut c_void, x: usize) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn engine_dump_request(rq: *mut i915_request, m: *mut drm_printer, msg: *const c_char) {
    ...
    struct drm_printer *m)
    {
    struct intel_context *hung_ce = core::ptr::null_mut();
    struct i915_request *hung_rq = core::ptr::null_mut();
//
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: hung_ce) -> else {
    else if (hung_ce)
    ...
    const char *header, ...)
    {
    let mut error: *mut i915_gpu_error  const = &engine.i915.gpu_error;
    struct i915_request *rq;
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_engine_get_busy_time(engine: *mut intel_engine_cs, now: *mut ktime_t) -> ktime_t {
    ...
    {
    struct i915_request *request, *active = core::ptr::null_mut();
//
...
#[no_mangle]
pub unsafe extern "C" fn xehp_enable_ccs_engines(engine: *mut intel_engine_cs) {
