...
//! Source: drivers/gpu/drm/i915/gt/selftest_migrate.c
#![no_std]
...
//
    ...
    let mut x: c_int = i * 1024 + i915_prandom_u32_max_state(1024, prng);
    if (vaddr[x] != x) {
    ...
    struct i915_request **out)
    {
    let mut src_access: u8 = write_to_ccs ? DIRECT_ACCESS : INDIRECT_ACCESS;
    let mut dst_access: u8 = write_to_ccs ? INDIRECT_ACCESS : DIRECT_ACCESS;
    let mut it: sgt_dma = sg_sgt(sg);
    struct i915_request *rq;
    u32 offset;
    int err;
...
// Write the obj data into ccs surface
    err = intel_migrate_ccs_copy(migrate, &ww, core::ptr::null_mut(),
    obj.mm.pages.sgl,
    obj.pat_index,
    true, &rq);
    if (rq && !err) {
...
// Verify the set/clear of the obj mem
    ...
    let mut ccs_bytes_left: c_int = (ccs_bytes - i * PAGE_SIZE) / sizeof(u32);
    ...
    struct i915_request **out)
    {
    return intel_migrate_copy(migrate, ww, core::ptr::null_mut(),
    ...
    struct i915_request **out)
    {
    return intel_context_migrate_copy(migrate.context, core::ptr::null_mut(),
    src.mm.pages.sgl, src.pat_index,
    i915_gem_object_is_lmem(src),
    dst.mm.pages.sgl, dst.pat_index,
    i915_gem_object_is_lmem(dst),
    ...
    struct i915_request **out)
    {
    return intel_migrate_clear(migrate, ww, core::ptr::null_mut(),
    obj.mm.pages.sgl,
    obj.pat_index,
    ...
    struct i915_request **out)
    {
    return intel_context_migrate_clear(migrate.context, core::ptr::null_mut(),
    obj.mm.pages.sgl,
    obj.pat_index,
    i915_gem_object_is_lmem(obj),
    value, out);
...
#[no_mangle]
unsafe extern "C" fn live_migrate_copy(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_migrate_clear(arg: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spinner_timer {
    pub timer: timer_list,
    pub spin: igt_spinner,
}

#[no_mangle]
unsafe extern "C" fn spinner_kill(timer: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn live_emit_pte_full_ring(arg: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct threaded_migrate {
    pub migrate: *mut intel_migrate,
    ...
    unsigned int flags)
    {
    let mut n_cpus: c_uint = num_online_cpus() + 1;
...
#[no_mangle]
unsafe extern "C" fn __thread_migrate_copy(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thread_migrate_copy(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __thread_global_copy(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thread_global_copy(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __thread_migrate_clear(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __thread_global_clear(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thread_migrate_clear(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thread_global_clear(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_migrate_live_selftests(i915: *mut drm_i915_private) -> c_int {
    ...
    i915_gem_object_trylock(obj, core::ptr::null_mut());
...
unsafe extern "C" fn wrap_ktime_compare(A: *const c_void, B: *const c_void) -> c_int {
    ...
    ktime_t t0, t1;
    t0 = ktime_get();
    err = intel_context_migrate_clear(ce, core::ptr::null_mut(), sg, pat_index,
    is_lmem, 0, &rq);
    if (rq) {
...
#[no_mangle]
unsafe extern "C" fn perf_clear_blt(arg: *mut c_void) -> c_int {
    ...
    ktime_t t0, t1;
    t0 = ktime_get();
    err = intel_context_migrate_copy(ce, core::ptr::null_mut(),
    src, src_pat_index,
    src_is_lmem,
    dst, dst_pat_index,
    dst_is_lmem,
...
#[no_mangle]
unsafe extern "C" fn perf_copy_blt(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_migrate_perf_selftests(i915: *mut drm_i915_private) -> c_int {
