...
//! Source: drivers/gpu/drm/i915/gt/selftest_mocs.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct live_mocs {
    pub table: drm_i915_mocs_table,
    pub mocs: *mut drm_i915_mocs_table,
    pub l3cc: *mut drm_i915_mocs_table,
...
#[no_mangle]
unsafe extern "C" fn live_mocs_init(arg: *mut live_mocs, gt: *mut intel_gt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_mocs_fini(arg: *mut live_mocs) {
...
// offset += sizeof(u32);
    ...
    u32 *offset)
    {
    let mut addr: u32 = i915_mmio_reg_offset(GEN9_LNCFCMOCS(0));
    if (!table)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn mcr_range(i915: *mut drm_i915_private, offset: u32) -> bool {
...
// Can we read the MCR range 0xb00 directly? See intel_workarounds!
    let mut reg: u32 = i915_mmio_reg_offset(GEN9_LNCFCMOCS(0));
    unsigned int i;
    u32 expect;
    if (!table)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn live_mocs_kernel(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_mocs_clean(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_mocs_reset(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_mocs_live_selftests(i915: *mut drm_i915_private) -> c_int {
