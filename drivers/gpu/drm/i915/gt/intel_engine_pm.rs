...
//! Source: drivers/gpu/drm/i915/gt/intel_engine_pm.h
#![no_std]
...
extern "C" {
    pub fn intel_wakeref_is_active(_arg: &engine->wakeref) -> return;
}
extern "C" {
    pub fn intel_wakeref_get_if_active(_arg: &engine->wakeref) -> return;
}
//
...
//
extern "C" {
    pub fn intel_engine_init__pm(engine: *mut intel_engine_cs);
}
extern "C" {
    pub fn intel_engine_reset_pinned_contexts(engine: *mut intel_engine_cs);
}
