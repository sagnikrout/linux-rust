...
//! Source: drivers/gpu/drm/i915/gt/selftest_execlists.c
#![no_std]
...
pub const NUM_GPR: c_int = 16;

#[no_mangle]
unsafe extern "C" fn is_active(rq: *mut i915_request) -> bool {
...
// Ignore our own attempts to suppress excess tasklets
    ...
    timeout += jiffies;
    do {
    let mut done: bool = time_after(jiffies, timeout);
...
#[no_mangle]
unsafe extern "C" fn live_sanitycheck(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_unlite_restore(gt: *mut intel_gt, prio: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_unlite_switch(arg: *mut c_void) -> c_int {
    static int live_unlite_switch(void *arg)
    {
    return live_unlite_restore(arg, 0);
    }
#[no_mangle]
unsafe extern "C" fn live_unlite_preempt(arg: *mut c_void) -> c_int {
    static int live_unlite_preempt(void *arg)
    {
    return live_unlite_restore(arg, I915_PRIORITY_MAX);
    }
#[no_mangle]
unsafe extern "C" fn live_unlite_ring(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_pin_rewind(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn engine_lock_reset_tasklet(engine: *mut intel_engine_cs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn engine_unlock_reset_tasklet(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn live_hold_reset(arg: *mut c_void) -> c_int {
...
// We have our request executing, now remove it and reset
    ...
    __intel_engine_reset_bh(engine, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn live_error_interrupt(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_timeslice_preempt(arg: *mut c_void) -> c_int {
...
//
    ...
    if (IS_ERR(obj))
    return PTR_ERR(obj);
    vma = i915_vma_instance(obj, &gt.ggtt.vm, core::ptr::null_mut());
    if (IS_ERR(vma)) {
    err = PTR_ERR(vma);
    goto err_obj;
    }
...
#[no_mangle]
unsafe extern "C" fn live_timeslice_rewind(arg: *mut c_void) -> c_int {
...
//
    ...
    rq[A1] = create_rewinder(ce, core::ptr::null_mut(), slot, X);
    if (IS_ERR(rq[A1])) {
    intel_context_put(ce);
    goto err;
    }
    rq[A2] = create_rewinder(ce, core::ptr::null_mut(), slot, Y);
    intel_context_put(ce);
    if (IS_ERR(rq[A2]))
    goto err;
...
// Release the hounds!
    ...
    for (i = 1; i <= 3; i++) {
    let mut timeout: c_ulong = jiffies + HZ / 2;
...
#[no_mangle]
unsafe extern "C" fn slice_timeout(engine: *mut intel_engine_cs) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn live_timeslice_queue(arg: *mut c_void) -> c_int {
...
//
    ...
    goto err_pin;
    for_each_engine(engine, gt, id) {
    let mut attr: i915_sched_attr = { .priority = I915_PRIORITY_MAX };
...
#[no_mangle]
unsafe extern "C" fn live_timeslice_nopreempt(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_busywait_preempt(arg: *mut c_void) -> c_int {
...
//
    ctx_hi = kernel_context(gt.i915, core::ptr::null_mut());
    if (IS_ERR(ctx_hi))
    return PTR_ERR(ctx_hi);
    ctx_hi.sched.priority = I915_CONTEXT_MAX_USER_PRIORITY;
    ctx_lo = kernel_context(gt.i915, core::ptr::null_mut());
    if (IS_ERR(ctx_lo)) {
    err = PTR_ERR(ctx_lo);
    goto err_ctx_hi;
    }
...
// cs++ = 0;
    ...
    let mut p: drm_printer = drm_info_printer(gt.i915.drm.dev);
...
#[no_mangle]
unsafe extern "C" fn live_preempt(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_late_preempt(arg: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct preempt_client {
    pub spin: igt_spinner,
    pub ctx: *mut i915_gem_context,
}

#[no_mangle]
unsafe extern "C" fn preempt_client_init(gt: *mut intel_gt, c: *mut preempt_client) -> c_int {
    static int preempt_client_init(struct intel_gt *gt, struct preempt_client *c)
    {
    c.ctx = kernel_context(gt.i915, core::ptr::null_mut());
    if (!c.ctx)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn preempt_client_fini(c: *mut preempt_client) {
...
#[no_mangle]
unsafe extern "C" fn live_nopreempt(arg: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct live_preempt_cancel {
    pub engine: *mut intel_engine_cs,
    pub b: preempt_client a,,
}

#[no_mangle]
unsafe extern "C" fn __cancel_active0(arg: *mut live_preempt_cancel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __cancel_active1(arg: *mut live_preempt_cancel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __cancel_queued(arg: *mut live_preempt_cancel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __cancel_hostile(arg: *mut live_preempt_cancel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn force_reset_timeout(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn cancel_reset_timeout(engine: *mut intel_engine_cs) {
    static void cancel_reset_timeout(struct intel_engine_cs *engine)
    {
    memset(&engine.reset_timeout, 0, sizeof(engine.reset_timeout));
    }
#[no_mangle]
unsafe extern "C" fn __cancel_fail(arg: *mut live_preempt_cancel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_preempt_cancel(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_suppress_self_preempt(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_chain_preempt(arg: *mut c_void) -> c_int {
...
// cs++ = upper_32_bits(i915_vma_offset(vma));
    if (*prev) {
    let mut offset: u64 = i915_vma_offset((*prev).batch);
...
#[no_mangle]
unsafe extern "C" fn live_preempt_ring(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_preempt_gang(arg: *mut c_void) -> c_int {
...
//
    ...
    return -EIO;
    do {
    let mut attr: i915_sched_attr = { .priority = prio++ };
...
// Submit each spinner at increasing priority
    ...
    !__igt_timeout(end_time, core::ptr::null_mut()));
...
// cs = 0;
    ...
    if (IS_ERR(obj))
    return ERR_CAST(obj);
    vma = i915_vma_instance(obj, result.vm, core::ptr::null_mut());
    if (IS_ERR(vma)) {
    i915_gem_object_put(obj);
    return vma;
    }
...
// cs++ = MI_BATCH_BUFFER_END;
    ...
    err = i915_ggtt_pin(vma, core::ptr::null_mut(), 0, 0);
    if (err) {
    i915_vma_put(vma);
    return ERR_PTR(err);
    }
    ...
    if (IS_ERR(ce))
    return ERR_CAST(ce);
    vma = i915_vma_instance(global.obj, ce.vm, core::ptr::null_mut());
    if (IS_ERR(vma)) {
    err = PTR_ERR(vma);
    goto out_ce;
    }
...
#[no_mangle]
unsafe extern "C" fn live_preempt_user(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_preempt_timeout(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn random_range(rnd: *mut rnd_state, min: c_int, max: c_int) -> c_int {
    static int random_range(struct rnd_state *rnd, int min, int max)
    {
    return i915_prandom_u32_max_state(max - min, rnd) + min;
    }
#[no_mangle]
unsafe extern "C" fn random_priority(rnd: *mut rnd_state) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct preempt_smoke {
    pub gt: *mut intel_gt,
    pub work: kthread_work,
    pub contexts: *mut i915_gem_context,
    pub engine: *mut intel_engine_cs,
    pub batch: *mut drm_i915_gem_object,
    pub ncontext: c_uint,
    pub prng: rnd_state,
    pub count: c_ulong,
    pub result: c_int,
    ...
    {
    struct i915_request *rq;
    struct i915_vma *vma = core::ptr::null_mut();
    let mut err: c_int = 0;
    if (batch) {
    struct i915_address_space *vm;
    vm = i915_gem_context_get_eb_vm(ctx);
    vma = i915_vma_instance(batch, vm, core::ptr::null_mut());
    i915_vm_put(vm);
    if (IS_ERR(vma))
    return PTR_ERR(vma);
    err = i915_vma_pin(vma, 0, 0, PIN_USER);
...
#[no_mangle]
unsafe extern "C" fn smoke_crescendo_work(work: *mut kthread_work) {
...
#[no_mangle]
unsafe extern "C" fn smoke_crescendo(smoke: *mut preempt_smoke, flags: c_uint) -> c_int {
    ...
    if (!(flags & BATCH))
    arg[id].batch = core::ptr::null_mut();
    arg[id].count = 0;
...
#[no_mangle]
unsafe extern "C" fn smoke_random(smoke: *mut preempt_smoke, flags: c_uint) -> c_int {
    ...
    flags & BATCH ? smoke.batch : core::ptr::null_mut());
    if (err)
    return err;
    count++;
    }
    } while (count < smoke.ncontext && !__igt_timeout(end_time, core::ptr::null_mut()));
    pr_info("Submitted %lu random:%x requests across %d engines and %d contexts\n",
    count, flags, smoke.gt.info.num_engines, smoke.ncontext);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn live_preempt_smoke(arg: *mut c_void) -> c_int {
    ...
    smoke.contexts[n] = kernel_context(smoke.gt.i915, core::ptr::null_mut());
    if (!smoke.contexts[n])
    goto err_ctx;
    }
    ...
    for (nc = 0; nc < nctx; nc++) {
    i915_request_put(request[nc]);
    request[nc] = core::ptr::null_mut();
    }
    if (__igt_timeout(end_time, core::ptr::null_mut()))
    break;
    }
    ...
    struct intel_engine_cs **siblings)
    {
    return __select_siblings(gt, class, siblings, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn live_virtual_engine(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_virtual_mask(arg: *mut c_void) -> c_int {
    ...
    unsigned int nsibling)
    {
    let mut timeout: c_long = slice_timeout(siblings[0]);
    struct intel_context *ce;
    struct i915_request *rq;
    struct igt_spinner spin;
    unsigned int n;
...
#[no_mangle]
unsafe extern "C" fn live_virtual_slice(arg: *mut c_void) -> c_int {
    ...
    unsigned int nsibling)
    {
    struct i915_request *last = core::ptr::null_mut();
    struct intel_context *ve;
...
#[no_mangle]
unsafe extern "C" fn live_virtual_preserved(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_virtual_reset(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_execlists_live_selftests(i915: *mut drm_i915_private) -> c_int {
