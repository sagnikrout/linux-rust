...
//! Source: drivers/gpu/drm/i915/gt/selftest_engine_pm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn trifilter(a: *mut u64) -> u64 {
    static u64 trifilter(u64 *a)
    {
    sort(a, COUNT, sizeof(*a), cmp_u64, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn write_semaphore(x: *mut u32, value: u32) {
    ...
    let mut offset: u32 = i915_ggtt_offset(engine.status_page.vma);
...
#[no_mangle]
unsafe extern "C" fn __live_engine_timestamps(engine: *mut intel_engine_cs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_engine_timestamps(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __spin_until_busier(engine: *mut intel_engine_cs, busyness: ktime_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_engine_busy_stats(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_engine_pm(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn live_engine_pm_selftests(gt: *mut intel_gt) -> c_int {
