...
//! Source: drivers/gpu/drm/i915/gt/intel_ring_submission.c
#![no_std]
...
//
pub const LEGACY_REQUEST_SIZE: c_int = 200;
#[no_mangle]
unsafe extern "C" fn set_hwstam(engine: *mut intel_engine_cs, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn set_hws_pga(engine: *mut intel_engine_cs, phys: phys_addr_t) {
...
#[no_mangle]
unsafe extern "C" fn ring_setup_phys_status_page(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn set_hwsp(engine: *mut intel_engine_cs, offset: u32) {
...
#[no_mangle]
unsafe extern "C" fn flush_cs_tlb(engine: *mut intel_engine_cs) {
...
// ring should be idle before issuing a sync flush
    ...
    INSTPM_SYNC_FLUSH, 0,
    2000, 0, core::ptr::null_mut()))
    ENGINE_TRACE(engine,
    "wait for SyncFlush to complete for TLB invalidation timed out\n");
    }
#[no_mangle]
unsafe extern "C" fn ring_setup_status_page(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn pp_dir(vm: *mut i915_address_space) -> u32 {
    static u32 pp_dir(struct i915_address_space *vm)
    {
    return to_gen6_ppgtt(i915_vm_to_ppgtt(vm)).pp_dir;
    }
#[no_mangle]
unsafe extern "C" fn set_pp_dir(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn stop_ring(engine: *mut intel_engine_cs) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xcs_resume(engine: *mut intel_engine_cs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sanitize_hwsp(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn xcs_sanitize(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn reset_prepare(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn reset_rewind(engine: *mut intel_engine_cs, stalled: bool) {
...
#[no_mangle]
unsafe extern "C" fn reset_finish(engine: *mut intel_engine_cs) {
    static void reset_finish(struct intel_engine_cs *engine)
    {
    }
#[no_mangle]
unsafe extern "C" fn reset_cancel(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn i9xx_submit_request(request: *mut i915_request) {
...
#[no_mangle]
unsafe extern "C" fn __ring_context_fini(ce: *mut intel_context) {
    static void __ring_context_fini(struct intel_context *ce)
    {
    i915_vma_put(ce.state);
    }
#[no_mangle]
unsafe extern "C" fn ring_context_destroy(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn __context_unpin_ppgtt(ce: *mut intel_context) {
...
#[no_mangle]
unsafe extern "C" fn ring_context_unpin(ce: *mut intel_context) {
    static void ring_context_unpin(struct intel_context *ce)
    {
    }
#[no_mangle]
unsafe extern "C" fn ring_context_post_unpin(ce: *mut intel_context) {
...
#[no_mangle]
unsafe extern "C" fn ring_context_alloc(ce: *mut intel_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ring_context_pin(ce: *mut intel_context, unused: *mut c_void) -> c_int {
    static int ring_context_pin(struct intel_context *ce, void *unused)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ring_context_reset(ce: *mut intel_context) {
    ...
    struct i915_request *rq)
    {
    struct intel_engine_cs *engine = core::ptr::null_mut();
    ...
    u32 valid)
    {
    let mut engine: *const intel_engine_cs  const = rq.engine;
    u32 *cs;
...
// cs++ = REG_MASKED_FIELD_ENABLE(INSTPM_TLB_INVALIDATE);
    ...
    let mut force_restore: bool = false;
    int len;
    u32 *cs;
    len = 4;
...
#[no_mangle]
pub unsafe extern "C" fn if(5: GRAPHICS_VER(i915) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn remap_l3_slice(rq: *mut i915_request, slice: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remap_l3(rq: *mut i915_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn switch_mm(rq: *mut i915_request, vm: *mut i915_address_space) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clear_residuals(rq: *mut i915_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn switch_context(rq: *mut i915_request) -> c_int {
    static int switch_context(struct i915_request *rq)
    {
    struct intel_engine_cs *engine = rq.engine;
    struct intel_context *ce = rq.context;
    void **residuals = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ring_request_alloc(request: *mut i915_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gen6_bsd_submit_request(request: *mut i915_request) {
...
#[no_mangle]
unsafe extern "C" fn i9xx_set_default_submission(engine: *mut intel_engine_cs) {
    static void i9xx_set_default_submission(struct intel_engine_cs *engine)
    {
    engine.submit_request = i9xx_submit_request;
    }
#[no_mangle]
unsafe extern "C" fn gen6_bsd_set_default_submission(engine: *mut intel_engine_cs) {
    static void gen6_bsd_set_default_submission(struct intel_engine_cs *engine)
    {
    engine.submit_request = gen6_bsd_submit_request;
    }
#[no_mangle]
unsafe extern "C" fn ring_release(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn irq_handler(engine: *mut intel_engine_cs, iir: u16) {
    static void irq_handler(struct intel_engine_cs *engine, u16 iir)
    {
    intel_engine_signal_breadcrumbs(engine);
    }
#[no_mangle]
unsafe extern "C" fn setup_irq(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn add_to_engine(rq: *mut i915_request) {
...
#[no_mangle]
unsafe extern "C" fn remove_from_engine(rq: *mut i915_request) {
...
#[no_mangle]
unsafe extern "C" fn setup_common(engine: *mut intel_engine_cs) {
...
#[no_mangle]
pub unsafe extern "C" fn if(IS_I845G(i915): IS_I830(i915) ||) -> else {
...
#[no_mangle]
unsafe extern "C" fn setup_rcs(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn setup_vcs(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn setup_bcs(engine: *mut intel_engine_cs) {
...
#[no_mangle]
unsafe extern "C" fn setup_vecs(engine: *mut intel_engine_cs) {
    ...
    err = gen7_ctx_switch_bb_setup(engine, core::ptr::null_mut() /* probe size */);
    if (err < 0)
    return ERR_PTR(err);
    if (!err)
    return core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn intel_ring_submission_setup(engine: *mut intel_engine_cs) -> c_int {
