...
//! Source: drivers/gpu/drm/i915/gt/selftest_reset.c
#![no_std]
...
//
    ...
    let mut dma: dma_addr_t = (dma_addr_t)dsm.start + (page << PAGE_SHIFT);
    void __iomem *s;
    void *in;
    ...
    for_each_engine(engine, gt, id) {
    if (mask & engine.mask)
    intel_engine_reset(engine, core::ptr::null_mut());
    }
    }
    max = -1;
    count = 0;
...
#[no_mangle]
unsafe extern "C" fn igt_reset_device_stolen(arg: *mut c_void) -> c_int {
    static int igt_reset_device_stolen(void *arg)
    {
    return __igt_reset_stolen(arg, ALL_ENGINES, "device");
    }
#[no_mangle]
unsafe extern "C" fn igt_reset_engines_stolen(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_global_reset(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_wedged_reset(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_atomic_reset(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_atomic_engine_reset(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_reset_live_selftests(i915: *mut drm_i915_private) -> c_int {
