...
//! Source: drivers/gpu/drm/i915/gt/uc/abi/guc_actions_abi.h
#![no_std]
...
pub const INTEL_GUC_SLEEP_STATE_INVALID_MASK: c_uint = 0x80000000;
}
...
pub const INTEL_GUC_STATE_CAPTURE_EVENT_STATUS_MASK: c_uint = 0x000000FF;
