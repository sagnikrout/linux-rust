...
//! Source: drivers/gpu/drm/i915/gt/uc/selftest_guc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn intel_guc_scrub_ctbs(arg: *mut c_void) -> c_int {
    static int intel_guc_scrub_ctbs(void *arg)
    {
    struct intel_gt *gt = arg;
    let mut ret: c_int = 0;
    int i;
    struct i915_request *last[3] = {core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut()}, *rq;
...
// Submit requests and inject errors forcing G2H to be dropped
    ...
    rq = nop_user_request(ce, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn intel_guc_steal_guc_ids(arg: *mut c_void) -> c_int {
    ...
    struct i915_request *spin_rq = core::ptr::null_mut(), *rq, *last = core::ptr::null_mut();
    let mut number_guc_id_stolen: c_int = guc.number_guc_id_stolen;
...
// Create spinner to block requests in below loop
    ...
    ce[context_index] = core::ptr::null_mut();
    goto err_wakeref;
    }
...
// Try to steal guc_id
    rq = nop_user_request(ce[context_index], core::ptr::null_mut());
    if (IS_ERR(rq)) {
    ret = PTR_ERR(rq);
...
//
#[no_mangle]
unsafe extern "C" fn bad_h2g(guc: *mut intel_guc) -> c_int {
...
//
pub const FAST_RESPONSE_TIMEOUT_MS: c_int = 1000;
#[no_mangle]
unsafe extern "C" fn intel_guc_fast_request(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_guc_live_selftests(i915: *mut drm_i915_private) -> c_int {
