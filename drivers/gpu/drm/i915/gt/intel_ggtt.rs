...
//! Source: drivers/gpu/drm/i915/gt/intel_ggtt.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ggtt_init_hw(ggtt: *mut i915_ggtt) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i915_ggtt_init_hw(i915: *mut drm_i915_private) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i915_ggtt_suspend_vm(vm: *mut i915_address_space, evict_all: bool) {
...
// unlikely to race when GPU is idle, so no worry about slowpath..
    if (WARN_ON(!i915_gem_object_trylock(obj, core::ptr::null_mut()))) {
//
...
#[no_mangle]
pub unsafe extern "C" fn i915_ggtt_suspend(ggtt: *mut i915_ggtt) {
...
#[no_mangle]
pub unsafe extern "C" fn gen6_ggtt_invalidate(ggtt: *mut i915_ggtt) {
...
#[no_mangle]
unsafe extern "C" fn needs_wc_ggtt_mapping(i915: *mut drm_i915_private) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gen8_ggtt_invalidate(ggtt: *mut i915_ggtt) {
...
#[no_mangle]
unsafe extern "C" fn guc_ggtt_ct_invalidate(gt: *mut intel_gt) {
...
#[no_mangle]
unsafe extern "C" fn guc_ggtt_invalidate(ggtt: *mut i915_ggtt) {
...
#[no_mangle]
pub unsafe extern "C" fn if(12: GRAPHICS_VER(i915) >=) -> else {
    ...
    u32 flags)
    {
    let mut pte: gen8_pte_t = addr | GEN8_PAGE_PRESENT;
...
#[no_mangle]
unsafe extern "C" fn gen8_ggtt_pte_decode(pte: u64, is_present: *mut bool, is_local: *mut bool) -> dma_addr_t {
...
#[no_mangle]
unsafe extern "C" fn should_update_ggtt_with_bind(ggtt: *mut i915_ggtt) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gen8_ggtt_bind_put_ce(ce: *mut intel_context, wakeref: intel_wakeref_t) {
    ...
    struct intel_gt *gt = ggtt.vm.gt;
    let mut scratch_pte: gen8_pte_t = ggtt.vm.scratch[0].encode;
...
//
    let mut n_ptes: u32 = min_t(u32, 511, num_entries);
...
#[no_mangle]
unsafe extern "C" fn gen8_set_pte(addr: *mut void __iomem, pte: gen8_pte_t) {
    static void gen8_set_pte(void __iomem *addr, gen8_pte_t pte)
    {
    writeq(pte, addr);
    }
#[no_mangle]
unsafe extern "C" fn gen8_get_pte(addr: *mut void __iomem) -> gen8_pte_t {
    ...
    gen8_ggtt_bind_ptes(ggtt, offset, core::ptr::null_mut(), 1, pte))
    ...
    {
    struct i915_ggtt *ggtt = i915_vm_to_ggtt(vm);
    let mut pte_encode: gen8_pte_t = ggtt.vm.pte_encode(0, pat_index, flags);
...
//
    ...
    {
    struct i915_ggtt *ggtt = i915_vm_to_ggtt(vm);
    let mut scratch_pte: gen8_pte_t = vm.scratch[0].encode;
    ...
    if (!gen8_ggtt_bind_ptes(ggtt, start, core::ptr::null_mut(), end - start, scratch_pte))
    goto err;
    start = end;
    end += (vma_res.node_size + vma_res.guard) / I915_GTT_PAGE_SIZE;
    ...
    {
    struct i915_ggtt *ggtt = i915_vm_to_ggtt(vm);
    let mut first_entry: c_uint = start / I915_GTT_PAGE_SIZE;
    let mut num_entries: c_uint = length / I915_GTT_PAGE_SIZE;
    let mut scratch_pte: gen8_pte_t = vm.scratch[0].encode;
    gen8_pte_t __iomem *gtt_base =
    (gen8_pte_t __iomem *)ggtt.gsm + first_entry;
    let mut max_entries: c_int = ggtt_total_entries(ggtt) - first_entry;
    int i;
    ...
    core::ptr::null_mut(), num_entries, scratch_pte))
    return ggtt.invalidate(ggtt);
...
#[no_mangle]
unsafe extern "C" fn bxt_vtd_ggtt_wa(vm: *mut i915_address_space) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct insert_page {
    pub vm: *mut i915_address_space,
    pub addr: dma_addr_t,
    pub offset: u64,
    pub pat_index: c_uint,
}

#[no_mangle]
unsafe extern "C" fn bxt_vtd_ggtt_insert_page__cb(_arg: *mut c_void) -> c_int {
    ...
    u32 unused)
    {
    let mut arg: insert_page = { vm, addr, offset, pat_index };
    stop_machine(bxt_vtd_ggtt_insert_page__cb, &arg, core::ptr::null_mut());
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct insert_entries {
    pub vm: *mut i915_address_space,
...
#[no_mangle]
unsafe extern "C" fn bxt_vtd_ggtt_insert_entries__cb(_arg: *mut c_void) -> c_int {
    ...
    u32 flags)
    {
    let mut arg: insert_entries = { vm, vma_res, pat_index, flags };
    stop_machine(bxt_vtd_ggtt_insert_entries__cb, &arg, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn ggtt_reserve_guc_top(ggtt: *mut i915_ggtt) -> c_int {
    ...
    ret = i915_gem_gtt_reserve(&ggtt.vm, core::ptr::null_mut(), &ggtt.uc_fw,
...
#[no_mangle]
unsafe extern "C" fn ggtt_release_guc_top(ggtt: *mut i915_ggtt) {
...
#[no_mangle]
unsafe extern "C" fn cleanup_init_ggtt(ggtt: *mut i915_ggtt) {
...
#[no_mangle]
unsafe extern "C" fn init_ggtt(ggtt: *mut i915_ggtt) -> c_int {
...
//
    ...
    if (drm_mm_node_allocated(&ggtt.error_capture)) {
    let mut start: u64 = ggtt.error_capture.start;
    let mut size: u64 = ggtt.error_capture.size;
...
#[no_mangle]
unsafe extern "C" fn init_aliasing_ppgtt(ggtt: *mut i915_ggtt) -> c_int {
    static int init_aliasing_ppgtt(struct i915_ggtt *ggtt)
    {
    let mut stash: i915_vm_pt_stash = {};
    ...
    if (err)
    goto err_ppgtt;
    i915_gem_object_lock(ppgtt.vm.scratch[0], core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn fini_aliasing_ppgtt(ggtt: *mut i915_ggtt) {
...
#[no_mangle]
pub unsafe extern "C" fn i915_init_ggtt(i915: *mut drm_i915_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ggtt_cleanup_hw(ggtt: *mut i915_ggtt) {
    ...
    struct drm_i915_gem_object *obj = vma.obj;
    bool trylock;
    trylock = i915_gem_object_trylock(obj, core::ptr::null_mut());
    WARN_ON(!trylock);
...
//
#[no_mangle]
pub unsafe extern "C" fn i915_ggtt_driver_release(i915: *mut drm_i915_private) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i915_ggtt_driver_late_release(i915: *mut drm_i915_private) {
...
#[no_mangle]
unsafe extern "C" fn gen6_get_total_gtt_size(snb_gmch_ctl: u16) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gen8_get_total_gtt_size(bdw_gmch_ctl: u16) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn chv_get_total_gtt_size(gmch_ctrl: u16) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gen6_gttmmadr_size(i915: *mut drm_i915_private) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gen6_gttadr_offset(i915: *mut drm_i915_private) -> c_uint {
    static unsigned int gen6_gttadr_offset(struct drm_i915_private *i915)
    {
    return gen6_gttmmadr_size(i915) / 2;
    }
#[no_mangle]
unsafe extern "C" fn ggtt_probe_common(ggtt: *mut i915_ggtt, size: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gen6_gmch_remove(vm: *mut i915_address_space) {
...
#[no_mangle]
unsafe extern "C" fn pci_resource(pdev: *mut pci_dev, bar: c_int) -> resource {
...
#[no_mangle]
unsafe extern "C" fn gen8_gmch_probe(ggtt: *mut i915_ggtt) -> c_int {
...
//
    ...
    u32 flags)
    {
    let mut pte: gen6_pte_t = GEN6_PTE_ADDR_ENCODE(addr) | GEN6_PTE_VALID;
    switch (pat_index) {
    ...
    u32 flags)
    {
    let mut pte: gen6_pte_t = HSW_PTE_ADDR_ENCODE(addr) | GEN6_PTE_VALID;
    if (pat_index != I915_CACHE_NONE)
    pte |= HSW_WB_LLC_AGE3;
    return pte;
    }
...
#[no_mangle]
unsafe extern "C" fn gen6_pte_decode(pte: u64, is_present: *mut bool, is_local: *mut bool) -> dma_addr_t {
...
#[no_mangle]
unsafe extern "C" fn gen6_gmch_probe(ggtt: *mut i915_ggtt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_HASWELL(i915)) -> else {
    else if (IS_HASWELL(i915))
    ggtt.vm.pte_encode = hsw_pte_encode;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_VALLEYVIEW(i915)) -> else {
    else if (IS_VALLEYVIEW(i915))
    ggtt.vm.pte_encode = byt_pte_encode;
#[no_mangle]
pub unsafe extern "C" fn if(7: GRAPHICS_VER(i915) >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn ggtt_probe_hw(ggtt: *mut i915_ggtt, gt: *mut intel_gt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(6: GRAPHICS_VER(i915) >=) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn i915_ggtt_probe_hw(i915: *mut drm_i915_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_ggtt_enable_hw(i915: *mut drm_i915_private) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i915_ggtt_resume_vm(vm: *mut i915_address_space, all_evicted: bool) -> bool {
    bool i915_ggtt_resume_vm(struct i915_address_space *vm, bool all_evicted)
    {
    struct i915_vma *vma;
    let mut write_domain_objs: bool = false;
    drm_WARN_ON(&vm.i915.drm, !vm.is_ggtt && !vm.is_dpt);
    if (all_evicted) {
...
//
    ...
    vma.ops.bind_vma(vm, core::ptr::null_mut(), vma.resource,
    obj ? obj.pat_index :
...
#[no_mangle]
pub unsafe extern "C" fn i915_ggtt_resume(ggtt: *mut i915_ggtt) {
