...
//! Source: drivers/gpu/drm/i915/gt/selftest_timeline.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hwsp_cacheline(tl: *mut intel_timeline) -> c_ulong {
    static unsigned long hwsp_cacheline(struct intel_timeline *tl)
    {
    let mut address: c_ulong = (unsigned long)page_address(hwsp_page(tl));
    return (address + offset_in_page(tl.hwsp_offset)) / TIMELINE_SEQNO_BYTES;
    }
#[no_mangle]
unsafe extern "C" fn selftest_tl_pin(tl: *mut intel_timeline) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mock_hwsp_freelist {
    pub gt: *mut intel_gt,
    pub cachelines: radix_tree_root,
    pub history: *mut intel_timeline,
    pub max: unsigned long count,,
    pub prng: rnd_state,
}
    ...
    while (count--) {
    idx = --state.count % state.max;
    __mock_hwsp_record(state, idx, core::ptr::null_mut());
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mock_hwsp_freelist(arg: *mut c_void) -> c_int {
...
//
    ...
    __mock_hwsp_record(&state, na, core::ptr::null_mut());
    kfree(state.history);
    err_put:
...
#[no_mangle]
unsafe extern "C" fn igt_sync(arg: *mut c_void) -> c_int {
    ...
    let mut ctx: u64 = BIT_ULL(order) + offset;
...
#[no_mangle]
unsafe extern "C" fn random_engine(rnd: *mut rnd_state) -> c_uint {
    static unsigned int random_engine(struct rnd_state *rnd)
    {
    return i915_prandom_u32_max_state(I915_NUM_ENGINES, rnd);
    }
#[no_mangle]
unsafe extern "C" fn bench_sync(arg: *mut c_void) -> c_int {
...
// Benchmark (only) setting random context ids
    ...
    end_time = jiffies + HZ/10;
    do {
    let mut id: u64 = i915_prandom_u64_state(&prng);
...
// Benchmark searching for a random context id and maybe changing it
    ...
    end_time = jiffies + HZ/10;
    do {
    let mut id: u32 = random_engine(&prng);
    let mut seqno: u32 = prandom_u32_state(&prng);
...
// Benchmark searching for a known context id and changing the seqno
    ...
    let mut mask: c_uint = BIT(order) - 1;
    mock_timeline_init(&tl, 0);
    count = 0;
    kt = ktime_get();
    end_time = jiffies + HZ/10;
...
// (if any)!
//
    let mut id: u64 = (u64)(count & mask) << order;
...
#[no_mangle]
pub unsafe extern "C" fn intel_timeline_mock_selftests() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emit_ggtt_store_dw(rq: *mut i915_request, addr: u32, value: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_hwsp_engine(arg: *mut c_void) -> c_int {
    static int live_hwsp_engine(void *arg)
    {
pub const NUM_TIMELINES: c_int = 4096;
...
#[no_mangle]
unsafe extern "C" fn live_hwsp_alternate(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_hwsp_wrap(arg: *mut c_void) -> c_int {
...
// hwsp_seqno[0], *hwsp_seqno[1],
    ...
    u32 *addr)
    {
    let mut gpr: u32 = i915_mmio_reg_offset(GEN8_RING_CS_GPR(rq.engine.mmio_base, 0));
    u32 *cs;
...
#[no_mangle]
unsafe extern "C" fn cmp_lt(a: u32, b: u32) -> bool {
    static bool cmp_lt(u32 a, u32 b)
    {
    return a < b;
    }
#[no_mangle]
unsafe extern "C" fn cmp_gte(a: u32, b: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn switch_tl_lock(from: *mut i915_request, to: *mut i915_request) {
...
// some light mutex juggling required; think co-routines
    ...
    switch_tl_lock(w.rq, core::ptr::null_mut());
    return 0;
    }
    ...
    i915_request_get(rq);
    switch_tl_lock(core::ptr::null_mut(), rq);
    i915_request_add(rq);
...
#[no_mangle]
unsafe extern "C" fn cleanup_watcher(w: *mut hwsp_watcher) {
    static void cleanup_watcher(struct hwsp_watcher *w)
    {
    if (w.rq) {
    switch_tl_lock(core::ptr::null_mut(), w.rq);
    i915_request_add(w.rq);
    }
    i915_vma_unpin_and_release(&w.vma, I915_VMA_RELEASE_MAP);
    }
#[no_mangle]
unsafe extern "C" fn retire_requests(tl: *mut intel_timeline) -> bool {
    ...
    let mut seqno: u32 = rq.fence.seqno;
...
#[no_mangle]
unsafe extern "C" fn live_hwsp_read(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_hwsp_rollover_kernel(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_hwsp_rollover_user(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn live_hwsp_recycle(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_timeline_live_selftests(i915: *mut drm_i915_private) -> c_int {
