...
//! Source: drivers/gpu/drm/i915/gt/intel_ppgtt.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn free_px(vm: *mut i915_address_space, pt: *mut i915_page_table, lvl: c_int) {
    ...
    {
    let mut vaddr: *mut u64  const = __px_vaddr(pdma);
...
// Each thread pre-pins the pd, and we may have a thread per pde.
    ...
    pd.entry[idx] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn i915_ppgtt_init_hw(gt: *mut intel_gt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pd_count(size: u64, shift: c_int) -> c_ulong {
