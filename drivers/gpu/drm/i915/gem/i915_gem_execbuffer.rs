...
//! Source: drivers/gpu/drm/i915/gem/i915_gem_execbuffer.c
#![no_std]
...
// This vma's place in the execbuf reservation list
    pub exec: *mut drm_i915_gem_exec_object2,
    pub bind_link: list_head,
    pub reloc_link: list_head,
    pub node: hlist_node,
    pub handle: u32,
}
...
#[derive(Copy, Clone)]
pub struct eb_fence {
    pub /: *mut *mut *mut drm_syncobj syncobj; / Use with ptr_mask_bits(),
    pub dma_fence: *mut dma_fence,
    pub value: u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i915_execbuffer {
    pub /: *mut *mut *mut *mut drm_i915_private i915; / i915 backpointer,
    pub /: *mut *mut *mut *mut drm_file file; / per-file lookup tables and limits,
    pub /: *mut *mut *mut *mut drm_i915_gem_execbuffer2 args; / ioctl parameters,
    pub /: *mut *mut *mut *mut drm_i915_gem_exec_object2 exec; / ioctl execobj[],
    pub vma: *mut eb_vma,
    pub /: *mut *mut *mut intel_gt gt; / gt for the execbuf,
    pub /: *mut *mut *mut intel_context context; / logical state for the request,
    pub /: *mut *mut *mut *mut i915_gem_context gem_context; / caller's context,
    pub wakeref: intel_wakeref_t,
    pub wakeref_gt0: intel_wakeref_t,
// our requests to build
    pub 1]: *mut *mut i915_request requests[MAX_ENGINE_INSTANCE +,
// identity of the batch obj/vma
    pub 1]: *mut *mut eb_vma batches[MAX_ENGINE_INSTANCE +,
    pub /: *mut *mut *mut *mut i915_vma trampoline; / trampoline used for chaining,
// used for excl fence in dma_resv objects when > 1 BB submitted
    pub composite_fence: *mut dma_fence,
// actual size of execobj[] as we may extend it for the cmdparser
    pub buffer_count: c_uint,
// number of batches in execbuf IOCTL
    pub num_batches: c_uint,
// list of vma not yet bound during reservation phase
    pub unbound: list_head,
// list of vma that have execobj.relocation_count
    pub relocs: list_head,
    pub ww: i915_gem_ww_ctx,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct reloc_cache {
    pub /: *mut *mut *mut drm_mm_node node; / temporary GTT binding,
    pub /: *mut *mut *mut unsigned long vaddr; / Current kmap address,
    pub /: *mut *mut *mut unsigned long page; / Currently mapped page index,
    pub /: *mut *mut *mut unsigned int graphics_ver; / Cached value of GRAPHICS_VER,
    pub 1: bool use_64bit_reloc :,
    pub 1: bool has_llc :,
    pub 1: bool has_fence :,
    pub 1: bool needs_unfenced :,
    pub reloc_cache: },
    pub /: *mut *mut *mut u64 invalid_flags; / Set of execobj.flags that are invalid,
// Length of batch within object
    pub 1]: u64 batch_len[MAX_ENGINE_INSTANCE +,
    pub /: *mut *mut *mut u32 batch_start_offset; / Location within object of batch,
    pub /: *mut *mut *mut u32 batch_flags; / Flags composed for emit_bb_start(),
    pub /: *mut *mut *mut *mut intel_gt_buffer_pool_node batch_pool; / pool node for batch buffer,
//
...
//
    pub lut_size: c_int,
    pub /: *mut *mut *mut *mut hlist_head buckets; / ht for relocation handles,
    pub fences: *mut eb_fence,
    pub num_fences: c_ulong,

    pub 1]: *mut *mut i915_capture_list capture_lists[MAX_ENGINE_INSTANCE +,
...
#[no_mangle]
unsafe extern "C" fn eb_use_cmdparser(eb: *const i915_execbuffer) -> bool {
...
#[no_mangle]
unsafe extern "C" fn eb_create(eb: *mut i915_execbuffer) -> c_int {
    static int eb_create(struct i915_execbuffer *eb)
    {
    if (!(eb.args.flags & I915_EXEC_HANDLE_LUT)) {
    let mut size: c_uint = 1 + ilog2(eb.buffer_count);
//
...
//
    ...
    unsigned int flags)
    {
    let mut start: u64 = i915_vma_offset(vma);
    let mut size: u64 = i915_vma_size(vma);
...
#[no_mangle]
pub unsafe extern "C" fn if(__EXEC_OBJECT_NEEDS_BIAS: exec_flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn eb_unbind(eb: *mut i915_execbuffer, force: bool) -> bool {
    static bool eb_unbind(struct i915_execbuffer *eb, bool force)
    {
    let mut count: c_uint = eb.buffer_count;
    unsigned int i;
    struct list_head last;
    let mut unpinned: bool = false;
// Resort *all* the objects into priority order
    INIT_LIST_HEAD(&eb.unbound);
    INIT_LIST_HEAD(&last);
    for (i = 0; i < count; i++) {
    struct eb_vma *ev = &eb.vma[i];
    let mut flags: c_uint = ev.flags;
...
#[no_mangle]
pub unsafe extern "C" fn if(__EXEC_OBJECT_NEEDS_MAP: flags &) -> else {
    else if (flags & __EXEC_OBJECT_NEEDS_MAP)
// Map require the lowest 256MiB (aperture)
    list_add_tail(&ev.bind_link, &eb.unbound);
#[no_mangle]
pub unsafe extern "C" fn if(EXEC_OBJECT_SUPPORTS_48B_ADDRESS): !(flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn eb_reserve(eb: *mut i915_execbuffer) -> c_int {
...
//
    ...
    let mut pin_flags: c_int = PIN_USER | PIN_VALIDATE;
    if (pass == 0)
    ...
    if (!err) {
    err = i915_gem_evict_vm(eb.context.vm, &eb.ww, core::ptr::null_mut());
    ...
    err = mutex_lock_interruptible(&eb.context.vm.mutex);
    if (!err) {
    struct drm_i915_gem_object *busy_bo = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn eb_select_context(eb: *mut i915_execbuffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eb_lookup_vmas(eb: *mut i915_execbuffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eb_lock_vmas(eb: *mut i915_execbuffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eb_validate_vmas(eb: *mut i915_execbuffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eb_release_vmas(eb: *mut i915_execbuffer, final: bool) {
...
#[no_mangle]
unsafe extern "C" fn eb_destroy(eb: *const i915_execbuffer) {
...
#[no_mangle]
unsafe extern "C" fn unmask_flags(p: c_ulong) -> c_uint {
    static unsigned int unmask_flags(unsigned long p)
    {
    return p & ~PAGE_MASK;
    }
pub const KMAP: c_uint = 0x4 /* after CLFLUSH_FLAGS */;
...
#[no_mangle]
unsafe extern "C" fn reloc_cache_unmap(cache: *mut reloc_cache) {
...
#[no_mangle]
unsafe extern "C" fn reloc_cache_reset(cache: *mut reloc_cache, eb: *mut i915_execbuffer) {
    ...
    if (cache.vaddr) {
    intel_gt_flush_ggtt_writes(ggtt.vm.gt);
    io_mapping_unmap_atomic((void  __iomem *) unmask_page(cache.vaddr));
    } else {
...
//
    ...
    vma = i915_gem_object_ggtt_pin_ww(obj, &eb.ww, core::ptr::null_mut(), 0, 0,
    PIN_MAPPABLE |
    PIN_NONBLOCK /* NOWARN */ |
    PIN_NOEVICT);
    }
    ...
    vaddr = (void  *)io_mapping_map_atomic_wc(&ggtt.iomap,
    offset);
    cache.page = page;
...
#[no_mangle]
unsafe extern "C" fn clflush_write32(addr: *mut u32, value: u32, flushes: c_uint) {
...
// addr = value;
    ...
    const struct i915_vma *target)
    {
    let mut target_addr: u64 = relocation_target(reloc, target);
    let mut offset: u64 = reloc.offset;
    let mut wide: bool = eb.reloc_cache.use_64bit_reloc;
    void *vaddr;
    repeat:
...
//
    ...
    PIN_GLOBAL, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn eb_relocate_vma(eb: *mut i915_execbuffer, ev: *mut eb_vma) -> c_int {
    ...
    let mut remain: c_ulong = entry.relocation_count;
...
//
    ...
    remain -= count;
    do {
    let mut offset: u64 = eb_relocate_entry(eb, ev, r);
    if (likely(offset == 0))
    continue;
    if ((s64)offset < 0) {
    remain = (int)offset;
...
//
    ...
    let mut offset: u64 = eb_relocate_entry(eb, ev, &relocs[i]);
    if ((s64)offset < 0) {
    err = (int)offset;
    goto err;
    }
...
#[no_mangle]
unsafe extern "C" fn check_relocations(entry: *const drm_i915_gem_exec_object2) -> c_int {
    ...
    let mut err: c_int = __get_user(c, addr);
    if (err)
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn eb_copy_relocations(eb: *const i915_execbuffer) -> c_int {
    ...
    int err;
    for (i = 0; i < count; i++) {
    let mut nreloc: c_uint = eb.exec[i].relocation_count;
    struct drm_i915_gem_relocation_entry __user *urelocs;
    unsigned long size;
...
#[no_mangle]
unsafe extern "C" fn eb_prefault_relocations(eb: *const i915_execbuffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eb_reinit_userptr(eb: *mut i915_execbuffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eb_relocate_parse_slow(eb: *mut i915_execbuffer) -> noinline int {
    static noinline int eb_relocate_parse_slow(struct i915_execbuffer *eb)
    {
    let mut have_copy: bool = false;
    struct eb_vma *ev;
    let mut err: c_int = 0;
    repeat:
...
#[no_mangle]
unsafe extern "C" fn eb_relocate_parse(eb: *mut i915_execbuffer) -> c_int {
    static int eb_relocate_parse(struct i915_execbuffer *eb)
    {
    int err;
    let mut throttle: bool = true;
    retry:
...
#[no_mangle]
unsafe extern "C" fn eb_capture_stage(eb: *mut i915_execbuffer) -> c_int {
    static int eb_capture_stage(struct i915_execbuffer *eb)
    {
    let mut count: c_uint = eb.buffer_count;
    let mut i: c_uint = count, j;
    while (i--) {
    struct eb_vma *ev = &eb.vma[i];
    struct i915_vma *vma = ev.vma;
    let mut flags: c_uint = ev.flags;
...
#[no_mangle]
unsafe extern "C" fn eb_capture_commit(eb: *mut i915_execbuffer) {
...
//
#[no_mangle]
unsafe extern "C" fn eb_capture_release(eb: *mut i915_execbuffer) {
    static void eb_capture_release(struct i915_execbuffer *eb)
    {
    unsigned int j;
    for_each_batch_create_order(eb, j) {
...
#[no_mangle]
unsafe extern "C" fn eb_capture_list_clear(eb: *mut i915_execbuffer) {
...
#[no_mangle]
unsafe extern "C" fn eb_move_to_gpu(eb: *mut i915_execbuffer) -> c_int {
    static int eb_move_to_gpu(struct i915_execbuffer *eb)
    {
    let mut count: c_uint = eb.buffer_count;
    let mut i: c_uint = count;
    let mut err: c_int = 0, j;
    while (i--) {
    struct eb_vma *ev = &eb.vma[i];
    struct i915_vma *vma = ev.vma;
    let mut flags: c_uint = ev.flags;
...
#[no_mangle]
unsafe extern "C" fn i915_reset_gen7_sol_offsets(rq: *mut i915_request) -> c_int {
...
// hsw should have this fixed, but bdw mucks it up again.
    ...
    return i915_gem_object_ggtt_pin_ww(vma.obj, &eb.ww, core::ptr::null_mut(), 0, 0, PIN_VALIDATE);
    return core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn eb_parse(eb: *mut i915_execbuffer) -> c_int {
    static int eb_parse(struct i915_execbuffer *eb)
    {
    struct drm_i915_private *i915 = eb.i915;
...
#[no_mangle]
unsafe extern "C" fn eb_submit(eb: *mut i915_execbuffer) -> c_int {
...
//
    ...
    return core::ptr::null_mut(); /* weird, we will check again later for real */
    ...
    struct i915_request *rq = core::ptr::null_mut();
//
...
//
    ...
    if (rq) {
    let mut nonblock: bool = eb.file.filp.f_flags & O_NONBLOCK;
    let mut timeout: c_long = nonblock ? 0 : MAX_SCHEDULE_TIMEOUT;
...
#[no_mangle]
unsafe extern "C" fn eb_pin_engine(eb: *mut i915_execbuffer, throttle: bool) -> c_int {
    static int eb_pin_engine(struct i915_execbuffer *eb, bool throttle)
    {
...
#[no_mangle]
unsafe extern "C" fn eb_unpin_engine(eb: *mut i915_execbuffer) {
    static void eb_unpin_engine(struct i915_execbuffer *eb)
    {
    struct intel_context *ce = eb.context, *child;
    ...
    let mut user_ring_id: c_uint = args.flags & I915_EXEC_RING_MASK;
    ...
    let mut bsd_idx: c_uint = args.flags & I915_EXEC_BSD_MASK;
...
#[no_mangle]
unsafe extern "C" fn add_fence_array(eb: *mut i915_execbuffer) -> c_int {
    static int add_fence_array(struct i915_execbuffer *eb)
    {
    struct drm_i915_gem_execbuffer2 *args = eb.args;
    struct drm_i915_gem_exec_fence __user *user;
    let mut num_fences: c_ulong = args.num_cliprects;
    struct eb_fence *f;
...
#[no_mangle]
unsafe extern "C" fn put_fence_array(fences: *mut eb_fence, num_fences: c_int) {
...
// timeline.
//
    eb.fences[n].chain_fence = core::ptr::null_mut();
    } else {
...
#[no_mangle]
unsafe extern "C" fn retire_requests(tl: *mut intel_timeline, end: *mut i915_request) {
    ...
    {
    let mut tl: *mut intel_timeline  const = i915_request_timeline(rq);
    let mut attr: i915_sched_attr = {};
...
#[no_mangle]
unsafe extern "C" fn eb_requests_add(eb: *mut i915_execbuffer, err: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eb_requests_get(eb: *mut i915_execbuffer) {
...
#[no_mangle]
unsafe extern "C" fn eb_requests_put(eb: *mut i915_execbuffer) {
    ...
    {
    struct sync_file *out_fence = core::ptr::null_mut();
...
//
    ...
    struct i915_execbuffer eb;
    struct dma_fence *in_fence = core::ptr::null_mut();
    struct sync_file *out_fence = core::ptr::null_mut();
    let mut out_fence_fd: c_int = -1;
    int err;
...
#[no_mangle]
unsafe extern "C" fn eb_element_size() -> usize {
    static size_t eb_element_size(void)
    {
    return sizeof(struct drm_i915_gem_exec_object2) + sizeof(struct eb_vma);
    }
#[no_mangle]
unsafe extern "C" fn check_buffer_count(count: usize) -> bool {
    static bool check_buffer_count(size_t count)
    {
    let mut sz: usize = eb_element_size();
//
...
//
    ...
    let mut count: usize = args.buffer_count;
    int err;
...
//
    ...
    __GFP_NOWARN | GFP_KERNEL);
    if (exec2_list == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn sizeof(_arg: *mut user_exec_list))) -> *mut count {
