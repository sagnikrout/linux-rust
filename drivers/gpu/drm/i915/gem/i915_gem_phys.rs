...
//! Source: drivers/gpu/drm/i915/gem/i915_gem_phys.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __set_phys_vaddr(sg: *mut scatterlist, vaddr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn i915_gem_object_get_pages_phys(obj: *mut drm_i915_gem_object) -> c_int {
...
// We're no longer struct page backed
    ...
    {
    let mut dma: dma_addr_t = sg_dma_address(pages.sgl);
...
#[no_mangle]
unsafe extern "C" fn i915_gem_object_shmem_to_phys(obj: *mut drm_i915_gem_object) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_object_attach_phys(obj: *mut drm_i915_gem_object, align: c_int) -> c_int {
