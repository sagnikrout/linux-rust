...
//! Source: drivers/gpu/drm/i915/gem/i915_gem_wait.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_fence_wait_priority_display(fence: *mut dma_fence) {
    void i915_gem_fence_wait_priority_display(struct dma_fence *fence)
    {
    let mut attr: i915_sched_attr = { .priority = I915_PRIORITY_DISPLAY };
...
#[no_mangle]
pub unsafe extern "C" fn nsecs_to_jiffies_timeout(n: u64) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn to_wait_timeout(timeout_ns: i64) -> c_ulong {
