...
//! Source: drivers/gpu/drm/i915/gem/selftests/i915_gem_coherency.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cpu_set(ctx: *mut context, offset: c_ulong, v: u32) -> c_int {
    ...
    u32 *cpu;
    int err;
    i915_gem_object_lock(ctx.obj, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cpu_get(ctx: *mut context, offset: c_ulong, v: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gtt_set(ctx: *mut context, offset: c_ulong, v: u32) -> c_int {
    ...
    if (err)
    return err;
    vma = i915_gem_object_ggtt_pin(ctx.obj, core::ptr::null_mut(), 0, 0, PIN_MAPPABLE);
    if (IS_ERR(vma))
    return PTR_ERR(vma);
...
#[no_mangle]
unsafe extern "C" fn gtt_get(ctx: *mut context, offset: c_ulong, v: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wc_set(ctx: *mut context, offset: c_ulong, v: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wc_get(ctx: *mut context, offset: c_ulong, v: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpu_set(ctx: *mut context, offset: c_ulong, v: u32) -> c_int {
    ...
    u32 *cs;
    int err;
    vma = i915_gem_object_ggtt_pin(ctx.obj, core::ptr::null_mut(), 0, 0, 0);
    if (IS_ERR(vma))
    return PTR_ERR(vma);
    i915_gem_object_lock(ctx.obj, core::ptr::null_mut());
    err = i915_gem_object_set_to_gtt_domain(ctx.obj, true);
...
#[no_mangle]
unsafe extern "C" fn always_valid(ctx: *mut context) -> bool {
    static bool always_valid(struct context *ctx)
    {
    return true;
    }
#[no_mangle]
unsafe extern "C" fn needs_fence_registers(ctx: *mut context) -> bool {
...
#[no_mangle]
unsafe extern "C" fn needs_mi_store_dword(ctx: *mut context) -> bool {
    ...
    { "gpu", gpu_set, core::ptr::null_mut(), needs_mi_store_dword },
    { },
    };
...
#[no_mangle]
unsafe extern "C" fn igt_gem_coherency(arg: *mut c_void) -> c_int {
    static int igt_gem_coherency(void *arg)
    {
    let mut ncachelines: c_uint = PAGE_SIZE/64;
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_coherency_live_selftests(i915: *mut drm_i915_private) -> c_int {
