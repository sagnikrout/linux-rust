...
//! Source: drivers/gpu/drm/i915/gem/selftests/huge_pages.c
#![no_std]
...
//
    ...
    let mut page_size: c_uint = page_sizes[i];
...
#[no_mangle]
unsafe extern "C" fn huge_pages_free_pages(st: *mut sg_table) {
...
#[no_mangle]
unsafe extern "C" fn get_huge_pages(obj: *mut drm_i915_gem_object) -> c_int {
    static int get_huge_pages(struct drm_i915_gem_object *obj)
    {

    let mut page_mask: c_uint = obj.mm.page_mask;
    struct sg_table *st;
    struct scatterlist *sg;
...
//
    do {
    let mut bit: c_uint = ilog2(page_mask);
    let mut page_size: c_uint = BIT(bit);
    let mut order: c_int = get_order(page_size);
    do {
    struct page *page;
    ...
    return 0;
    err:
    sg_set_page(sg, core::ptr::null_mut(), 0, 0);
    sg_mark_end(sg);
...
#[no_mangle]
unsafe extern "C" fn fake_get_huge_pages(obj: *mut drm_i915_gem_object) -> c_int {
    static int fake_get_huge_pages(struct drm_i915_gem_object *obj)
    {
    struct drm_i915_private *i915 = to_i915(obj.base.dev);
    let mut max_len: u64 = rounddown_pow_of_two(UINT_MAX);
    struct sg_table *st;
    struct scatterlist *sg;
    u64 rem;
// restricted by sg_alloc_table
...
// Use optimal page sized chunks to fill in the sg table
    ...
    st.nents = 0;
    do {
    let mut page_size: c_uint = get_largest_page_size(i915, rem);
...
#[no_mangle]
unsafe extern "C" fn fake_get_huge_pages_single(obj: *mut drm_i915_gem_object) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_check_page_sizes(vma: *mut i915_vma) -> c_int {
    static int igt_check_page_sizes(struct i915_vma *vma)
    {
    struct drm_i915_private *i915 = vma.vm.i915;
    let mut supported: c_uint = RUNTIME_INFO(i915).page_sizes;
...
#[no_mangle]
unsafe extern "C" fn igt_mock_exhaust_device_supported_pages(arg: *mut c_void) -> c_int {
    static int igt_mock_exhaust_device_supported_pages(void *arg)
    {
    struct i915_ppgtt *ppgtt = arg;
    struct drm_i915_private *i915 = ppgtt.vm.i915;
    let mut saved_mask: c_uint = RUNTIME_INFO(i915).page_sizes;
    struct drm_i915_gem_object *obj;
    struct i915_vma *vma;
    int i, j, single;
    int err;
...
//
    ...
    vma = i915_vma_instance(obj, &ppgtt.vm, core::ptr::null_mut());
    if (IS_ERR(vma)) {
    err = PTR_ERR(vma);
    goto out_put;
    }
...
#[no_mangle]
unsafe extern "C" fn igt_mock_memory_region_huge_pages(arg: *mut c_void) -> c_int {
    static int igt_mock_memory_region_huge_pages(void *arg)
    {
    const unsigned int flags[] = { 0, I915_BO_ALLOC_CONTIGUOUS };
    struct i915_ppgtt *ppgtt = arg;
    struct drm_i915_private *i915 = ppgtt.vm.i915;
    let mut supported: c_ulong = RUNTIME_INFO(i915).page_sizes;
...
#[no_mangle]
unsafe extern "C" fn igt_mock_ppgtt_misaligned_dma(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn close_object_list(objects: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn igt_ppgtt_huge_fill(arg: *mut c_void) -> c_int {
    static int igt_ppgtt_huge_fill(void *arg)
    {
    struct drm_i915_private *i915 = arg;
    let mut supported: c_uint = RUNTIME_INFO(i915).page_sizes;
    let mut has_pte64: bool = GRAPHICS_VER_FULL(i915) >= IP_VER(12, 55);
    struct i915_address_space *vm;
    ...
    struct drm_i915_gem_object *obj;
    let mut size: u64 = page_num << PAGE_SHIFT;
    struct i915_vma *vma;
    let mut expected_gtt: c_uint = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn igt_ppgtt_64K(arg: *mut c_void) -> c_int {
...
//
    ...
    let mut size: c_uint = objects[i].size;
    let mut expected_gtt: c_uint = objects[i].gtt;
    let mut offset: c_uint = objects[i].offset;
    let mut flags: c_uint = PIN_USER;
//
...
//
    ...
    {
    int err;
    i915_gem_object_lock(vma.obj, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn __cpu_check_vmap(obj: *mut drm_i915_gem_object, dword: u32, val: u32) -> c_int {
    static int __cpu_check_vmap(struct drm_i915_gem_object *obj, u32 dword, u32 val)
    {
    let mut n: c_ulong = obj.base.size >> PAGE_SHIFT;
    u32 *ptr;
    int err;
...
#[no_mangle]
unsafe extern "C" fn cpu_check(obj: *mut drm_i915_gem_object, dword: u32, val: u32) -> c_int {
...
//
    ...
    let mut offset_low: u64 = num * max_page_size;
    let mut offset_high: u64 = (max - num) * max_page_size;
    let mut dword: u32 = offset_in_page(num) / 4;
    struct intel_context *ce;
...
#[no_mangle]
pub unsafe extern "C" fn igt_can_allocate_thp(i915: *mut drm_i915_private) -> bool {
...
#[no_mangle]
unsafe extern "C" fn igt_ppgtt_smoke_huge(arg: *mut c_void) -> c_int {
...
//
    ...
    let mut min: u32 = backends[i].min;
    let mut max: u32 = backends[i].max;
...
#[no_mangle]
unsafe extern "C" fn igt_ppgtt_sanity_check(arg: *mut c_void) -> c_int {
...
//
    ...
    struct drm_i915_gem_object *obj;
    let mut size: u32 = combos[j].size;
    let mut pages: u32 = combos[j].pages;
...
#[no_mangle]
unsafe extern "C" fn igt_ppgtt_compact(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_ppgtt_mixed(arg: *mut c_void) -> c_int {
...
//
    ...
    let mut rnd: u32 = i915_prandom_u32_max_state(UINT_MAX, &prng);
...
#[no_mangle]
unsafe extern "C" fn igt_tmpfs_fallback(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_shrink_thp(arg: *mut c_void) -> c_int {
...
//
    i915_gem_shrink(core::ptr::null_mut(), i915, -1UL, core::ptr::null_mut(),
    I915_SHRINK_BOUND |
    I915_SHRINK_UNBOUND |
    I915_SHRINK_ACTIVE);
    i915_vma_unpin(vma);
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_huge_page_mock_selftests() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_huge_page_live_selftests(i915: *mut drm_i915_private) -> c_int {
