...
//! Source: drivers/gpu/drm/i915/gem/selftests/i915_gem_context.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn live_nop_switch(arg: *mut c_void) -> c_int {
    static int live_nop_switch(void *arg)
    {
    let mut nctx: c_uint = 1024;
...
#[no_mangle]
unsafe extern "C" fn __live_parallel_switch1(work: *mut kthread_work) {
    ...
    i915_request_put(rq);
    count++;
    } while (!arg.result && !__igt_timeout(end_time, core::ptr::null_mut()));
    pr_info("%s: %lu switches (sync) <%d>\n",
    arg.ce[0].engine.name, count, arg.result);
    }
#[no_mangle]
unsafe extern "C" fn __live_parallel_switchN(work: *mut kthread_work) {
...
#[no_mangle]
unsafe extern "C" fn live_parallel_switch(arg: *mut c_void) -> c_int {
    ...
    struct parallel_switch *data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn real_page_count(obj: *mut drm_i915_gem_object) -> c_ulong {
    static unsigned long real_page_count(struct drm_i915_gem_object *obj)
    {
    return huge_gem_object_phys_size(obj) >> PAGE_SHIFT;
    }
#[no_mangle]
unsafe extern "C" fn fake_page_count(obj: *mut drm_i915_gem_object) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn cpu_fill(obj: *mut drm_i915_gem_object, value: u32) -> c_int {
    static int cpu_fill(struct drm_i915_gem_object *obj, u32 value)
    {
    let mut has_llc: bool = HAS_LLC(to_i915(obj.base.dev));
...
#[no_mangle]
unsafe extern "C" fn file_add_object(file: *mut file, obj: *mut drm_i915_gem_object) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max_dwords(obj: *mut drm_i915_gem_object) -> c_ulong {
    static unsigned long max_dwords(struct drm_i915_gem_object *obj)
    {
    let mut npages: c_ulong = fake_page_count(obj);
    GEM_BUG_ON(!IS_ALIGNED(npages, DW_PER_PAGE));
    return npages / DW_PER_PAGE;
    }
#[no_mangle]
unsafe extern "C" fn throttle_release(q: *mut i915_request, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn igt_ctx_exec(arg: *mut c_void) -> c_int {
...
//
    ...
    return 0;
    for_each_uabi_engine(engine, i915) {
    struct drm_i915_gem_object *obj = core::ptr::null_mut();
    ...
    struct i915_gem_context *ctx;
    struct intel_context *ce;
    ctx = kernel_context(i915, core::ptr::null_mut());
    if (IS_ERR(ctx)) {
    err = PTR_ERR(ctx);
    goto out_file;
    }
...
#[no_mangle]
unsafe extern "C" fn igt_shared_ctx_exec(arg: *mut c_void) -> c_int {
...
// cmd = MI_BATCH_BUFFER_END;
    ...
    batch = i915_vma_instance(rpcs, ce.vm, core::ptr::null_mut());
    if (IS_ERR(batch)) {
    err = PTR_ERR(batch);
    goto err_put;
    }
...
// rpcs = val;
    ...
    struct igt_spinner *spin)
    {
    let mut slices: c_uint = hweight32(ce.engine.sseu.slice_mask);
    let mut rpcs: u32 = 0;
    let mut ret: c_int = 0;
    if (flags & TEST_RESET) {
    ...
    flags & TEST_RESET ? core::ptr::null_mut() : spin, &rpcs);
    ret = __check_rpcs(name, rpcs, ret, expected, "Context", "!");
    if (ret)
    goto out;
    ret = __read_slice_count(ce.engine.kernel_context, obj, core::ptr::null_mut(), &rpcs);
    ...
    if (ret)
    return ret;
    ret = __read_slice_count(ce, obj, core::ptr::null_mut(), &rpcs);
    ...
    {
    struct igt_spinner *spin = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn igt_ctx_sseu(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_ctx_readonly(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_scratch(vm: *mut i915_address_space, offset: u64) -> c_int {
...
// cmd = MI_BATCH_BUFFER_END;
    ...
    return err;
    if (GRAPHICS_VER(i915) >= 8) {
    let mut GPR0: u32 = engine.mmio_base + 0x600;
    vm = i915_gem_context_get_eb_vm(ctx);
    vma = i915_vma_instance(obj, vm, core::ptr::null_mut());
    if (IS_ERR(vma)) {
    err = PTR_ERR(vma);
...
// cmd = MI_BATCH_BUFFER_END;
    ...
    let mut reg: u32 = engine.mmio_base + 0x420;
...
#[no_mangle]
unsafe extern "C" fn check_scratch_page(ctx: *mut i915_gem_context, out: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_vm_isolation(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_context_live_selftests(i915: *mut drm_i915_private) -> c_int {
