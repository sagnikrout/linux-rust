...
//! Source: drivers/gpu/drm/i915/gem/selftests/i915_gem_client_blt.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn linear_x_y_to_ftiled_pos(x: c_int, y: c_int, stride: u32, bpp: c_int) -> c_int {
    static int linear_x_y_to_ftiled_pos(int x, int y, u32 stride, int bpp)
    {
    int tile_base;
    int tile_x, tile_y;
    int swizzle, subtile;
    let mut pixel_size: c_int = bpp / 8;
    int pos;
//
...
pub const WIDTH: c_int = 512;
pub const HEIGHT: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct blit_buffer {
    pub vma: *mut i915_vma,
    pub start_val: u32,
    pub tiling: enum client_tiling,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tiled_blits {
    pub ce: *mut intel_context,
    pub buffers: [blit_buffer; 3],
    pub scratch: blit_buffer,
    pub batch: *mut i915_vma,
    pub hole: u64,
    pub align: u64,
    pub width: u32,
    pub height: u32,
...
#[no_mangle]
unsafe extern "C" fn fastblit_supports_x_tiling(i915: *const drm_i915_private) -> bool {
    static bool fastblit_supports_x_tiling(const struct drm_i915_private *i915)
    {
    struct intel_display *display = i915.display;
    let mut gen: c_int = GRAPHICS_VER(i915);
...
#[no_mangle]
unsafe extern "C" fn fast_blit_ok(buf: *const blit_buffer) -> bool {
...
// filter out platforms with unsupported X-tile support in fastblit
    ...
    {
    let mut ver: c_int = GRAPHICS_VER(to_i915(batch.base.dev));
    let mut use_64b_reloc: bool = ver >= 8;
    ...
    let mut src_tiles: u32 = 0, dst_tiles = 0;
    let mut src_4t: u32 = 0, dst_4t = 0;
...
#[no_mangle]
unsafe extern "C" fn tiled_blits_destroy_buffers(t: *mut tiled_blits) {
    ...
    if (IS_ERR(obj))
    return ERR_CAST(obj);
    vma = i915_vma_instance(obj, t.ce.vm, core::ptr::null_mut());
    if (IS_ERR(vma))
...
#[no_mangle]
unsafe extern "C" fn fill_scratch(t: *mut tiled_blits, vaddr: *mut u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn pin_buffer(vma: *mut i915_vma, addr: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tiled_blits_destroy(t: *mut tiled_blits) {
    ...
    struct rnd_state *prng)
    {
    let mut offset: u64 = round_up(t.width * t.height * 4, t.align);
    u32 *map;
    int err;
    int i;
...
#[no_mangle]
unsafe extern "C" fn tiled_blits_bounce(t: *mut tiled_blits, prng: *mut rnd_state) -> c_int {
    static int tiled_blits_bounce(struct tiled_blits *t, struct rnd_state *prng)
    {
    let mut offset: u64 = round_up(t.width * t.height * 4, 2 * t.align);
    int err;
...
#[no_mangle]
unsafe extern "C" fn has_bit17_swizzle(sw: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bad_swizzling(i915: *mut drm_i915_private) -> bool {
...
#[no_mangle]
unsafe extern "C" fn igt_client_tiled_blits(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_client_blt_live_selftests(i915: *mut drm_i915_private) -> c_int {
