...
//! Source: drivers/gpu/drm/i915/gem/selftests/i915_gem_dmabuf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn igt_dmabuf_export(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_dmabuf_import_self(arg: *mut c_void) -> c_int {
    ...
    i915_gem_object_lock(import_obj, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn igt_dmabuf_import_same_driver_lmem(arg: *mut c_void) -> c_int {
...
//
    ...
    if (!ce)
    goto out_file;
    vma = i915_vma_instance(import_obj, ce.vm, core::ptr::null_mut());
    if (IS_ERR(vma)) {
    err = PTR_ERR(vma);
    goto out_file;
    }
...
#[no_mangle]
unsafe extern "C" fn igt_dmabuf_import_same_driver_smem(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_dmabuf_import_same_driver_lmem_smem(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_dmabuf_import(arg: *mut c_void) -> c_int {
    ...
    dma_map = err ? core::ptr::null_mut() : map.vaddr;
    if (!dma_map) {
...
#[no_mangle]
unsafe extern "C" fn igt_dmabuf_import_ownership(arg: *mut c_void) -> c_int {
    ...
    return PTR_ERR(dmabuf);
    err = dma_buf_vmap_unlocked(dmabuf, &map);
    ptr = err ? core::ptr::null_mut() : map.vaddr;
    if (!ptr) {
    pr_err("dma_buf_vmap failed\n");
    err = -ENOMEM;
    goto err_dmabuf;
...
#[no_mangle]
unsafe extern "C" fn igt_dmabuf_export_vmap(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_dmabuf_mock_selftests() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_dmabuf_live_selftests(i915: *mut drm_i915_private) -> c_int {
