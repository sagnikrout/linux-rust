...
//! Source: drivers/gpu/drm/i915/gem/selftests/i915_gem_mman.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn swizzle_bit(bit: c_uint, offset: u64) -> u64 {
    static u64 swizzle_bit(unsigned int bit, u64 offset)
    {
    return (offset & BIT_ULL(bit)) >> (bit - 6);
    }
#[no_mangle]
unsafe extern "C" fn tiled_offset(tile: *const tile, v: u64) -> u64 {
    ...
    let mut ytile_span: c_uint = 16;
    let mut ytile_height: c_uint = 512;
    v += y * ytile_span;
    v += div64_u64_rem(x, ytile_span, &x) * ytile_height;
    v += x;
    } else {
    let mut ytile_span: c_uint = 32;
    let mut ytile_height: c_uint = 256;
    v += y * ytile_span;
    v += div64_u64_rem(x, ytile_span, &x) * ytile_height;
    v += x;
    }
    ...
    {
    let mut npages: c_ulong = obj.base.size / PAGE_SIZE;
...
// cpu = 0;
    ...
    {
    let mut nreal: c_uint = obj.scratch / PAGE_SIZE;
    let mut npages: c_ulong = obj.base.size / PAGE_SIZE;
    struct drm_i915_private *i915 = to_i915(obj.base.dev);
    struct i915_vma *vma;
    unsigned long page;
...
#[no_mangle]
unsafe extern "C" fn igt_partial_tiling(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_smoke_tiling(arg: *mut c_void) -> c_int {
...
//
    ...
    continue;
    if (tile.tiling != I915_TILING_NONE) {
    let mut max_pitch: c_uint = setup_tile_size(&tile, i915);
    tile.stride =
    ...
    break;
    count++;
    } while (!__igt_timeout(end, core::ptr::null_mut()));
...
#[no_mangle]
unsafe extern "C" fn make_obj_busy(obj: *mut drm_i915_gem_object) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn default_mapping(i915: *mut drm_i915_private) -> enum i915_mmap_type {
    ...
    ret = __assign_mmap_offset(obj, default_mapping(i915), &offset, core::ptr::null_mut());
    i915_gem_object_put(obj);
    let mut ret: return = = expected;
    }
#[no_mangle]
unsafe extern "C" fn disable_retire_worker(i915: *mut drm_i915_private) {
...
#[no_mangle]
unsafe extern "C" fn restore_retire_worker(i915: *mut drm_i915_private) {
...
#[no_mangle]
unsafe extern "C" fn mmap_offset_lock(i915: *mut drm_i915_private) {
...
#[no_mangle]
unsafe extern "C" fn mmap_offset_unlock(i915: *mut drm_i915_private) {
...
#[no_mangle]
unsafe extern "C" fn igt_mmap_offset_exhaustion(arg: *mut c_void) -> c_int {
    ...
    int loop, err = 0;
    u64 offset;
    let mut enospc: c_int = HAS_LMEM(i915) ? -ENXIO : -ENOSPC;
...
// Fill the hole, further allocation attempts should then fail
    ...
    err = __assign_mmap_offset(obj, default_mapping(i915), &offset, core::ptr::null_mut());
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn gtt_set(obj: *mut drm_i915_gem_object) -> c_int {
    ...
    void __iomem *map;
    let mut err: c_int = 0;
    vma = i915_gem_object_ggtt_pin(obj, core::ptr::null_mut(), 0, 0, PIN_MAPPABLE);
    if (IS_ERR(vma))
    return PTR_ERR(vma);
...
#[no_mangle]
unsafe extern "C" fn gtt_check(obj: *mut drm_i915_gem_object) -> c_int {
    ...
    if (memchr_inv((void  *)map, POISON_FREE, obj.base.size)) {
...
#[no_mangle]
unsafe extern "C" fn wc_set(obj: *mut drm_i915_gem_object) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wc_check(obj: *mut drm_i915_gem_object) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn can_mmap(obj: *mut drm_i915_gem_object, type: enum i915_mmap_type) -> bool {
    static bool can_mmap(struct drm_i915_gem_object *obj, enum i915_mmap_type type)
    {
    struct drm_i915_private *i915 = to_i915(obj.base.dev);
    bool no_map;
    if (obj.ops.mmap_offset)
    let mut type: return = = I915_MMAP_TYPE_FIXED;
#[no_mangle]
pub unsafe extern "C" fn if(I915_MMAP_TYPE_FIXED: type ==) -> else {
    ...
    if (err)
    return err;
    err = __assign_mmap_offset(obj, type, &offset, core::ptr::null_mut());
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn igt_mmap(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_make_evictable(objects: *mut list_head) {
    ...
    obj.flags |= I915_BO_ALLOC_GPU_ONLY;
    err = __assign_mmap_offset(obj, I915_MMAP_TYPE_FIXED, &offset, core::ptr::null_mut());
    if (err)
    goto out_put;
//
...
//
    ...
    err = i915_gem_object_lock(obj, core::ptr::null_mut());
    if (err)
    goto out_addr;
    ...
    err = intel_context_migrate_clear(to_gt(i915).migrate.context, core::ptr::null_mut(),
...
//
    ...
    intel_gt_reset(gt, ALL_ENGINES, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn igt_mmap_migrate(arg: *mut c_void) -> c_int {
...
//
    ...
    let mut io_size: resource_size_t = resource_size(&mr.io);
...
#[no_mangle]
unsafe extern "C" fn can_access(obj: *mut drm_i915_gem_object) -> bool {
...
#[no_mangle]
unsafe extern "C" fn igt_mmap_access(arg: *mut c_void) -> c_int {
...
//
    ...
    struct i915_vma *vma;
    struct i915_gem_ww_ctx ww;
    vma = i915_vma_instance(obj, engine.kernel_context.vm, core::ptr::null_mut());
    if (IS_ERR(vma)) {
    err = PTR_ERR(vma);
    goto out_unmap;
    }
...
#[no_mangle]
unsafe extern "C" fn igt_mmap_gpu(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_present_pte(pte: *mut pte_t, addr: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_absent_pte(pte: *mut pte_t, addr: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_present(addr: c_ulong, len: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_absent(addr: c_ulong, len: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prefault_range(start: u64, len: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_mmap_revoke(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_mman_live_selftests(i915: *mut drm_i915_private) -> c_int {
