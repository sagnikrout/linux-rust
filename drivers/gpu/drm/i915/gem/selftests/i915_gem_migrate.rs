...
//! Source: drivers/gpu/drm/i915/gem/selftests/i915_gem_migrate.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn igt_smem_create_migrate(arg: *mut c_void) -> c_int {
    static int igt_smem_create_migrate(void *arg)
    {
    return igt_create_migrate(arg, INTEL_REGION_LMEM_0, INTEL_REGION_SMEM);
    }
#[no_mangle]
unsafe extern "C" fn igt_lmem_create_migrate(arg: *mut c_void) -> c_int {
    static int igt_lmem_create_migrate(void *arg)
    {
    return igt_create_migrate(arg, INTEL_REGION_SMEM, INTEL_REGION_LMEM_0);
    }
#[no_mangle]
unsafe extern "C" fn igt_same_create_migrate(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igt_lmem_pages_failsafe_migrate(arg: *mut c_void) -> c_int {
    ...
    fail_alloc);
    ret = __igt_lmem_pages_migrate(gt, core::ptr::null_mut(), core::ptr::null_mut(),
    ...
    intel_gt_reset(__gt, ALL_ENGINES, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn igt_async_migrate(gt: *mut intel_gt) -> c_int {
...
//
pub const ASYNC_FAIL_ALLOC: c_int = 1;
#[no_mangle]
unsafe extern "C" fn igt_lmem_async_migrate(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_migrate_live_selftests(i915: *mut drm_i915_private) -> c_int {
