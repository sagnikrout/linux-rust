...
//! Source: drivers/gpu/drm/i915/gem/i915_gem_pages.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ____i915_gem_object_get_pages(obj: *mut drm_i915_gem_object) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __i915_gem_object_get_pages(obj: *mut drm_i915_gem_object) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_object_pin_pages_unlocked(obj: *mut drm_i915_gem_object) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_object_truncate(obj: *mut drm_i915_gem_object) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __i915_gem_object_reset_page_iter(obj: *mut drm_i915_gem_object) {
...
#[no_mangle]
unsafe extern "C" fn unmap_object(obj: *mut drm_i915_gem_object, ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn flush_tlb_invalidate(obj: *mut drm_i915_gem_object) {
    ...
    obj.mm.mapping = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn __i915_gem_object_put_pages(obj: *mut drm_i915_gem_object) -> c_int {
...
// The 'mapping' part of i915_gem_object_pin_map() below
    ...
    {
    let mut n_pages: c_ulong = obj.base.size >> PAGE_SHIFT, i;
...
// Too big for stack -- allocate temporary array instead
    ...
    let mut n_pfn: c_ulong = obj.base.size >> PAGE_SHIFT;
...
//
    ...
    ptr = obj.mm.mapping = core::ptr::null_mut();
    }
    if (!ptr) {
    ...
    ptr = ERR_PTR(-ENODEV);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: i915_gem_object_has_struct_page(obj)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn __i915_gem_object_release_map(obj: *mut drm_i915_gem_object) {
...
// offset = 0;
    ...
    let mut base: c_ulong = xa_to_value(sg);
...
// len = sg_dma_len(sg) - (offset << PAGE_SHIFT);
    ...
    {
    return i915_gem_object_get_dma_address_len(obj, n, core::ptr::null_mut());
    }
