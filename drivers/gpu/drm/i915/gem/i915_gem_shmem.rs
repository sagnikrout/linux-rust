...
//! Source: drivers/gpu/drm/i915/gem/i915_gem_shmem.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn check_release_folio_batch(fbatch: *mut folio_batch) {
...
//
    ...
    i915_gem_shrink(core::ptr::null_mut(), i915, 2 * page_count, core::ptr::null_mut(), *s++);
//
...
#[no_mangle]
unsafe extern "C" fn shmem_get_pages(obj: *mut drm_i915_gem_object) -> c_int {
    static int shmem_get_pages(struct drm_i915_gem_object *obj)
    {
    struct drm_i915_private *i915 = to_i915(obj.base.dev);
    struct intel_memory_region *mem = obj.mm.region;
    struct address_space *mapping = obj.base.filp.f_mapping;
    let mut max_segment: c_uint = i915_sg_segment_size(i915.drm.dev);
    struct sg_table *st;
    int ret;
//
...
#[no_mangle]
pub unsafe extern "C" fn __shmem_writeback(size: usize, mapping: *mut address_space) {
...
#[no_mangle]
unsafe extern "C" fn shmem_shrink(obj: *mut drm_i915_gem_object, flags: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_object_put_pages_shmem(obj: *mut drm_i915_gem_object, pages: *mut sg_table) {
...
#[no_mangle]
unsafe extern "C" fn shmem_release(obj: *mut drm_i915_gem_object) {
    ...
    unsigned int flags)
    {
    let mut shmem_flags: vma_flags_t = mk_vma_flags(VMA_NORESERVE_BIT);
...
#[no_mangle]
unsafe extern "C" fn init_shmem(mem: *mut intel_memory_region) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i915_gem_object_is_shmem(obj: *const drm_i915_gem_object) -> bool {
