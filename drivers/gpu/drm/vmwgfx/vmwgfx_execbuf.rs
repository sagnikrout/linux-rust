...
//! Source: drivers/gpu/drm/vmwgfx/vmwgfx_execbuf.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vmw_relocation {
    pub head: list_head,
    pub vbo: *mut vmw_bo,
    union {
    pub mob_loc: *mut SVGAMobId,
    pub location: *mut SVGAGuestPtr,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vmw_resource_relocation {
    pub head: list_head,
    pub res: *const vmw_resource,
    pub offset:29: u32,
    pub rel_type:3: enum vmw_resource_relocation_type,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vmw_ctx_validation_info {
    pub head: list_head,
    pub ctx: *mut vmw_resource,
    pub cur: *mut vmw_ctx_binding_state,
    pub staged: *mut vmw_ctx_binding_state,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vmw_cmd_entry {
    int (*func) (struct vmw_private *, struct vmw_sw_context *,
    pub ): *mut SVGA3dCmdHeader,
    pub user_allow: bool,
    pub gb_disable: bool,
    pub gb_enable: bool,
...
//
#[no_mangle]
unsafe extern "C" fn vmw_ptr_diff(a: *mut c_void, b: *mut c_void) -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn vmw_bind_dx_query_mob(sw_context: *mut vmw_sw_context) {
...
//
    ...
    sw_context.staged_bindings = core::ptr::null_mut();
    goto out_err;
    }
    }
...
//
    ...
    int ret;
    let mut res_type: enum vmw_res_type = vmw_res_type(res);
    ...
    (void **)&ctx_info, core::ptr::null_mut());
    if (ret)
    return ret;
    } else {
...
//
#[no_mangle]
unsafe extern "C" fn vmw_resource_relocations_free(list: *mut list_head) {
...
//
#[no_mangle]
unsafe extern "C" fn vmw_resources_reserve(sw_context: *mut vmw_sw_context) -> c_int {
...
//
    ...
    struct vmw_resource *res;
    let mut ret: c_int = 0;
    let mut needs_unref: bool = false;
    if (p_res)
// p_res = NULL;
    ...
    let mut size: c_uint = vmw_execbuf_res_size(dev_priv, res_type);
...
//
#[no_mangle]
unsafe extern "C" fn vmw_rebind_all_dx_query(ctx_res: *mut vmw_resource) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vmw_rebind_contexts(sw_context: *mut vmw_sw_context) -> c_int {
...
//
    ...
    struct vmw_resource *view = core::ptr::null_mut();
...
//
    ...
    &cmd.body.src.sid, core::ptr::null_mut());
    if (ret)
    return ret;
    return vmw_cmd_res_check(dev_priv, sw_context, vmw_res_surface,
    VMW_RES_DIRTY_SET, user_surface_converter,
    &cmd.body.dest.sid, core::ptr::null_mut());
    }
    ...
    ret = vmw_cmd_res_check(dev_priv, sw_context, vmw_res_surface,
    VMW_RES_DIRTY_NONE, user_surface_converter,
    &cmd.body.src, core::ptr::null_mut());
    if (ret != 0)
    return ret;
    return vmw_cmd_res_check(dev_priv, sw_context, vmw_res_surface,
    VMW_RES_DIRTY_SET, user_surface_converter,
    &cmd.body.dest, core::ptr::null_mut());
    }
    ...
    ret = vmw_cmd_res_check(dev_priv, sw_context, vmw_res_surface,
    VMW_RES_DIRTY_NONE, user_surface_converter,
    &cmd.body.srcSid, core::ptr::null_mut());
    if (ret != 0)
    return ret;
    return vmw_cmd_res_check(dev_priv, sw_context, vmw_res_surface,
    VMW_RES_DIRTY_SET, user_surface_converter,
    &cmd.body.dstSid, core::ptr::null_mut());
    }
    ...
    return vmw_cmd_res_check(dev_priv, sw_context, vmw_res_surface,
    VMW_RES_DIRTY_NONE, user_surface_converter,
    &cmd.body.srcImage.sid, core::ptr::null_mut());
    }
    ...
    return vmw_cmd_res_check(dev_priv, sw_context, vmw_res_surface,
    VMW_RES_DIRTY_NONE, user_surface_converter,
    &cmd.body.sid, core::ptr::null_mut());
    }
//
...
//
    ...
    if (unlikely(sw_context.cur_query_bo != core::ptr::null_mut())) {
...
//
    ...
    BUG_ON(sw_context.last_query_ctx == core::ptr::null_mut());
...
//
    ...
    return vmw_cmd_res_check(dev_priv, sw_context, vmw_res_context,
    VMW_RES_DIRTY_SET, user_context_converter,
    &cmd.body.cid, core::ptr::null_mut());
    }
//
...
//
    ...
    SVGA3dCmdHeader *header)
    {
    struct vmw_bo *vmw_bo = core::ptr::null_mut();
    struct vmw_resource *res;
    struct vmw_surface *srf = core::ptr::null_mut();
...
// Make sure DMA doesn't cross BO boundaries.
    ...
    &decl.array.surfaceId, core::ptr::null_mut());
    if (unlikely(ret != 0))
    return ret;
    }
    ...
    VMW_RES_DIRTY_NONE,
    user_surface_converter,
    &range.indexArray.surfaceId, core::ptr::null_mut());
    if (unlikely(ret != 0))
    return ret;
    }
    return 0;
...
//
    ...
    return vmw_cmd_res_check(dev_priv, sw_context, vmw_res_surface,
    VMW_RES_DIRTY_NONE, user_surface_converter,
    &cmd.body.image.sid, core::ptr::null_mut());
    }
//
...
//
    ...
    if (unlikely(ret != 0))
    return ret;
    return vmw_resource_relocation_add(sw_context, core::ptr::null_mut(),
    vmw_ptr_diff(sw_context.buf_start,
    &cmd.header.id),
    vmw_res_rel_nop);
    }
...
//
    ...
    struct vmw_resource *ctx, *res = core::ptr::null_mut();
    struct vmw_ctx_validation_info *ctx_info;
    int ret;
    cmd = container_of(header, typeof(*cmd), header);
...
//
    ...
    struct vmw_resource *res = core::ptr::null_mut();
    struct vmw_ctx_validation_info *ctx_node = VMW_GET_CTX_NODE(sw_context);
...
//
    ...
    let mut view_type: enum vmw_view_type = vmw_view_cmd_to_type(header.id);
    struct vmw_resource *view;
    int ret;
    if (!ctx_node)
    return -EINVAL;
...
//
    ...
    return vmw_cmd_res_check(dev_priv, sw_context, vmw_res_surface,
    VMW_RES_DIRTY_SET, user_surface_converter,
    &cmd.body.destSid, core::ptr::null_mut());
    }
//
...
//
    ...
    return vmw_cmd_res_check(dev_priv, sw_context, vmw_res_surface,
    VMW_RES_DIRTY_SET, user_surface_converter,
    &cmd.body.surface.sid, core::ptr::null_mut());
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vmw_draw_indexed_instanced_indirect_cmd {
    pub header: SVGA3dCmdHeader,
    pub body: SVGA3dCmdDXDrawIndexedInstancedIndirect,
    pub header): *mut *mut *mut } cmd = container_of(header, typeof(cmd),,
    if (!has_sm5_context(dev_priv))
    pub -EINVAL: return,
    return vmw_cmd_res_check(dev_priv, sw_context, vmw_res_surface,
    VMW_RES_DIRTY_NONE, user_surface_converter,
    pub NULL): &cmd->body.argsBufferSid,,
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vmw_draw_instanced_indirect_cmd {
    pub header: SVGA3dCmdHeader,
    pub body: SVGA3dCmdDXDrawInstancedIndirect,
    pub header): *mut *mut *mut } cmd = container_of(header, typeof(cmd),,
    if (!has_sm5_context(dev_priv))
    pub -EINVAL: return,
    return vmw_cmd_res_check(dev_priv, sw_context, vmw_res_surface,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vmw_dispatch_indirect_cmd {
    pub header: SVGA3dCmdHeader,
    pub body: SVGA3dCmdDXDispatchIndirect,
    pub header): *mut *mut *mut } cmd = container_of(header, typeof(cmd),,
    if (!has_sm5_context(dev_priv))
    pub -EINVAL: return,
    return vmw_cmd_res_check(dev_priv, sw_context, vmw_res_surface,
    ...
    {
    pub size: *mut uint32_t size_remaining =,
    pub cmd_id: u32,
    pub )buf)[0]: *mut cmd_id = ((uint32_t,
    switch (cmd_id) {
...
// size = sizeof(uint32_t) + sizeof(SVGAFifoCmdBlitGMRFBToScreen);
    default:
    pub cmd_id): VMW_DEBUG_USER("Unsupported SVGA command: %u.\n",,
    pub -EINVAL: return,
    }
    ...
    pub cmd_id): VMW_DEBUG_USER("Kernel only SVGA command: %u.\n",,
    pub -EPERM: return,
    }
    if (cmd_id == SVGA_CMD_DEFINE_GMRFB)
    pub buf): return vmw_cmd_check_define_gmrfb(dev_priv, sw_context,,
    pub 0: return,
    }
...
#[no_mangle]
pub unsafe extern "C" fn vmw_cmd_describe(buf: *const c_void, size: *mut u32, cmd: *const c_char) -> bool {
    bool vmw_cmd_describe(const void *buf, u32 *size, char const **cmd)
    {
    let mut cmd_id: u32 = ((u32 *) buf)[0];
...
// size = 0;
    ...
    int ret;
    const struct vmw_cmd_entry *entry;
    let mut gb: bool = dev_priv.capabilities & SVGA_CAP_GBOBJECTS;
...
#[no_mangle]
unsafe extern "C" fn vmw_free_relocations(sw_context: *mut vmw_sw_context) {
...
#[no_mangle]
unsafe extern "C" fn vmw_apply_relocations(sw_context: *mut vmw_sw_context) {
...
// reloc->mob_loc = bo->resource->start;
    ...
    if (sw_context.cmd_bounce == core::ptr::null_mut()) {
...
// p_handle implies file_priv.
    BUG_ON(p_handle != core::ptr::null_mut() && file_priv == core::ptr::null_mut());
    ret = vmw_cmd_send_fence(dev_priv, &sequence);
    if (unlikely(ret != 0)) {
    VMW_DEBUG_USER("Fence submission error. Syncing.\n");
    synced = true;
    }
    if (p_handle != core::ptr::null_mut())
...
//
    ...
    if (user_fence_rep == core::ptr::null_mut())
    return 0;
    memset(&fence_rep, 0, sizeof(fence_rep));
    fence_rep.error = ret;
    fence_rep.fd = out_fence_fd;
    if (ret == 0) {
    BUG_ON(fence == core::ptr::null_mut());
...
// header = NULL;
    ...
    struct vmw_fence_obj *fence = core::ptr::null_mut();
    struct vmw_cmdbuf_header *header;
    let mut handle: u32 = 0;
    int ret;
    let mut out_fence_fd: i32 = -1;
    struct sync_file *sync_file = core::ptr::null_mut();
    ...
    if (kernel_commands == core::ptr::null_mut()) {
    ...
    sw_context.last_query_ctx = core::ptr::null_mut();
    sw_context.needs_post_query_barrier = false;
    sw_context.dx_ctx_node = core::ptr::null_mut();
    sw_context.dx_query_mob = core::ptr::null_mut();
    sw_context.dx_query_ctx = core::ptr::null_mut();
    ...
    (user_fence_rep) ? &handle : core::ptr::null_mut());
//
...
//
    ...
    if (unlikely(dev_priv.pinned_bo != core::ptr::null_mut() && !dev_priv.query_cid_valid))
...
// Don't unreference when handing fence out
    if (unlikely(out_fence != core::ptr::null_mut())) {
// out_fence = fence;
    fence = core::ptr::null_mut();
    } else if (likely(fence != core::ptr::null_mut())) {
...
//
    ...
    vmw_free_relocations(sw_context);
    if (unlikely(dev_priv.pinned_bo != core::ptr::null_mut() && !dev_priv.query_cid_valid))
    __vmw_execbuf_release_pinned_bo(dev_priv, core::ptr::null_mut());
    out_unlock:
...
//
#[no_mangle]
unsafe extern "C" fn vmw_execbuf_unpin_panic(dev_priv: *mut vmw_private) {
...
//
    ...
    {
    let mut ret: c_int = 0;
    struct vmw_fence_obj *lfence = core::ptr::null_mut();
    DECLARE_VAL_CONTEXT(val_ctx, core::ptr::null_mut(), 0);
    if (dev_priv.pinned_bo == core::ptr::null_mut())
    goto out_unlock;
    ...
    (void) vmw_execbuf_fence_commands(core::ptr::null_mut(), dev_priv, &lfence,
    core::ptr::null_mut());
    fence = lfence;
    }
    vmw_validation_bo_fence(&val_ctx, fence);
    if (lfence != core::ptr::null_mut())
...
//
#[no_mangle]
pub unsafe extern "C" fn vmw_execbuf_release_pinned_bo(dev_priv: *mut vmw_private) {
...
// If imported a fence FD from elsewhere, then wait on it
    ...
    core::ptr::null_mut(), arg.command_size, arg.throttle_us,
    arg.context_handle,
    (void __user *)(unsigned long)arg.fence_rep,
    core::ptr::null_mut(), arg.flags);
    if (unlikely(ret != 0))
    goto out;
    out:
    if (in_fence)
