...
//! Source: drivers/gpu/drm/amd/display/dc/dpp/dcn50/dcn50_dpp.h
#![no_std]
...
// Macro flag: #define TO_DCN50_DPP(dpp)\
// Macro flag: #define DPP_REG_LIST_SH_MASK_DCN50_COMMON(mask_sh)\
