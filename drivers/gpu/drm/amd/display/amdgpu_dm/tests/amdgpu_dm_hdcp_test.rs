...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_hdcp_test.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_get_cp_disabled_returns_desired(test: *mut kunit) {
    static void dm_test_hdcp_get_cp_disabled_returns_desired(struct kunit *test)
    {
    let mut content_protection: c_uint = DRM_MODE_CONTENT_PROTECTION_UNDESIRED;
    bool update;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_get_cp_type0_returns_enabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_get_cp_type1_returns_enabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_get_cp_type1_rejects_type0_status(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_get_cp_type0_rejects_type1_status(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_get_adjustments_disable_authentication(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_get_adjustments_type0_policy(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_get_adjustments_type1_policy(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_get_adjustments_fused_io_enables_fw_check(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_process_output_property_validate_always_scheduled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_process_output_callback_needed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_process_output_callback_stop(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_process_output_watchdog_needed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_process_output_watchdog_stop(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_process_output_callback_and_watchdog_needed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_process_output_callback_stop_and_needed_requeues(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_process_output_watchdog_stop_and_needed_requeues(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_property_update_skips_null_connector(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_property_update_skips_disconnected(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_property_update_skips_null_state(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_property_update_skips_null_dev(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_property_update_desired_when_off(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_property_update_enabled_when_encrypted(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_callback_cancels_callback_dwork(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_callback_schedules_property_validate(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_property_validate_skips_null_connector(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_property_validate_skips_disconnected(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_property_validate_skips_null_state(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_property_validate_updates_on_status_change(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_property_validate_no_update_when_unchanged(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_watchdog_timer_cancels_watchdog_dwork(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_watchdog_timer_schedules_property_validate(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_cpirq_schedules_property_validate(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_event_cpirq_leaves_callback_and_watchdog_idle(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_handle_cpirq_schedules_work(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_handle_cpirq_selects_link_index(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_update_display_enable_schedules_property_validate(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_update_display_disable_resets_status_and_cancels_validate(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_create_workqueue_zero_max_links_returns_null(test: *mut kunit) {
    static void dm_test_hdcp_create_workqueue_zero_max_links_returns_null(struct kunit *test)
    {
    let mut cp_psp: cp_psp = {0};
    struct dc *dc;
    struct hdcp_workqueue *work;
    dc = kunit_kzalloc(test, sizeof(*dc), GFP_KERNEL);
    KUNIT_ASSERT_NOT_NULL(test, dc);
    dc.caps.max_links = 0;
    work = hdcp_create_workqueue(core::ptr::null_mut(), &cp_psp, dc);
    KUNIT_EXPECT_PTR_EQ(test, work, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_create_workqueue_initializes_work(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_create_workqueue_sets_dtm_v3_for_dcn31(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_create_workqueue_initializes_all_links(test: *mut kunit) {
...
//
    ...
    struct kobject *kobj;
    int ret;
    kobj = kobject_create_and_add("amdgpu_dm_hdcp_test", core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_destroy_frees_and_removes_sysfs(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_destroy_zero_links_null_srm(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_NULL(test, work);
    work.max_link = 0;
    work.srm = core::ptr::null_mut();
    work.srm_temp = core::ptr::null_mut();
    kobj = setup_destroy_sysfs(test, work);
    hdcp_destroy(kobj, work);
    kobject_put(kobj);
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_link_lock_locks_and_unlocks_all_links(test: *mut kunit) {
    static void dm_test_link_lock_locks_and_unlocks_all_links(struct kunit *test)
    {
    let mut num_links: c_int = 3;
    struct hdcp_workqueue *work;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_link_lock_zero_links_is_noop(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_psp_get_srm_uninitialized_returns_null(test: *mut kunit) {
    static void dm_test_psp_get_srm_uninitialized_returns_null(struct kunit *test)
    {
    struct psp_context *psp;
    let mut srm_version: u32 = 0xdead;
    let mut srm_size: u32 = 0xbeef;
    uint8_t *srm;
...
// kzalloc leaves hdcp_context.context.initialized == false
    ...
    KUNIT_EXPECT_PTR_EQ(test, srm, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_psp_set_srm_uninitialized_returns_einval(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_psp_set_srm_initialized_stages_command(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_srm_data_write_uninitialized_ta_keeps_srm(test: *mut kunit) {
...
// kzalloc leaves hdcp_context.context.initialized == false
    ...
    KUNIT_ASSERT_NOT_NULL(test, work.srm);
    ret = srm_data_write(core::ptr::null_mut(), core::ptr::null_mut(), &work.attr, buf, 0, sizeof(buf));
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_srm_data_read_uninitialized_ta_returns_einval(test: *mut kunit) {
...
// kzalloc leaves hdcp_context.context.initialized == false
    work.hdcp.config.psp.handle = psp;
    ret = srm_data_read(core::ptr::null_mut(), core::ptr::null_mut(), &work.attr, buf, 0, sizeof(buf));
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_srm_data_read_empty_srm_returns_zero(test: *mut kunit) {
...
//
pub const FAKE_DDC_MAX_MSGS: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn fake_i2c_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fake_i2c_trylock_bus(adap: *mut i2c_adapter, flags: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_lp_write_i2c_builds_single_write_payload(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_lp_read_i2c_builds_offset_then_read(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_lp_write_dpcd_forwards_native_write(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_lp_read_dpcd_forwards_native_read(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_lp_write_i2c_no_connector_returns_false(test: *mut kunit) {
    static void dm_test_lp_write_i2c_no_connector_returns_false(struct kunit *test)
    {
    struct dc_link *link = alloc_test_ddc_link(test);
    u8 data[2] = {0x01, 0x02};
    bool ok;
    link.priv = core::ptr::null_mut();
    memset(&fake_i2c_cap, 0, sizeof(fake_i2c_cap));
    ok = lp_write_i2c(link, 0x3a, data, sizeof(data));
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_lp_read_dpcd_no_connector_returns_false(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_lp_atomic_i2c_null_handle_returns_false(test: *mut kunit) {
    static void dm_test_lp_atomic_i2c_null_handle_returns_false(struct kunit *test)
    {
    let mut op: mod_hdcp_atomic_op_i2c = { 0 };
    KUNIT_EXPECT_FALSE(test,
    lp_atomic_write_poll_read_i2c(core::ptr::null_mut(), &op, &op, &op, 0, 0));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_lp_atomic_i2c_oversized_op_returns_false(test: *mut kunit) {
    static void dm_test_lp_atomic_i2c_oversized_op_returns_false(struct kunit *test)
    {
    struct amdgpu_dm_connector *aconnector = alloc_test_connector(test, 0);
    let mut write: mod_hdcp_atomic_op_i2c = { .size = 0x100 };
    let mut op: mod_hdcp_atomic_op_i2c = { 0 };
    struct dc_link *link;
    KUNIT_ASSERT_NOT_NULL(test, aconnector);
    link = aconnector.dc_link;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_lp_atomic_aux_null_handle_returns_false(test: *mut kunit) {
    static void dm_test_lp_atomic_aux_null_handle_returns_false(struct kunit *test)
    {
    let mut op: mod_hdcp_atomic_op_aux = { 0 };
    KUNIT_EXPECT_FALSE(test,
    lp_atomic_write_poll_read_aux(core::ptr::null_mut(), &op, &op, &op, 0, 0));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_lp_atomic_aux_oversized_op_returns_false(test: *mut kunit) {
    static void dm_test_lp_atomic_aux_oversized_op_returns_false(struct kunit *test)
    {
    struct amdgpu_dm_connector *aconnector = alloc_test_connector(test, 0);
    let mut write: mod_hdcp_atomic_op_aux = { .size = 0x100 };
    let mut op: mod_hdcp_atomic_op_aux = { 0 };
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_update_display_enable_registers_connector(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_update_display_disable_sets_status_off(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_remove_display_enabled_resets_cp(test: *mut kunit) {
    ...
    KUNIT_EXPECT_EQ(test, conn_state.content_protection,
    DRM_MODE_CONTENT_PROTECTION_DESIRED);
    KUNIT_EXPECT_PTR_EQ(test, work.aconnector[1], core::ptr::null_mut());
    cancel_delayed_work_sync(&work.property_validate_dwork);
    cancel_delayed_work_sync(&work.callback_dwork);
    cancel_delayed_work_sync(&work.watchdog_timer_dwork);
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_remove_display_null_state_clears_connector(test: *mut kunit) {
    static void dm_test_hdcp_remove_display_null_state_clears_connector(struct kunit *test)
    {
    struct hdcp_workqueue *work = alloc_test_workqueue_locked(test);
    struct amdgpu_dm_connector *aconnector = alloc_test_connector(test, 0);
    aconnector.base.state = core::ptr::null_mut();
    work.aconnector[0] = aconnector;
    hdcp_remove_display(work, 0, aconnector);
    KUNIT_EXPECT_PTR_EQ(test, work.aconnector[0], core::ptr::null_mut());
    cancel_delayed_work_sync(&work.property_validate_dwork);
    cancel_delayed_work_sync(&work.callback_dwork);
    cancel_delayed_work_sync(&work.watchdog_timer_dwork);
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdcp_reset_display_clears_all_state(test: *mut kunit) {
    ...
    KUNIT_EXPECT_EQ(test, work.encryption_status[4],
    MOD_HDCP_ENCRYPTION_STATUS_HDCP_OFF);
    KUNIT_EXPECT_PTR_EQ(test, work.aconnector[4], core::ptr::null_mut());
    cancel_delayed_work_sync(&work.property_validate_dwork);
    cancel_delayed_work_sync(&work.callback_dwork);
    cancel_delayed_work_sync(&work.watchdog_timer_dwork);
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_enable_assr_uninitialized_dtm_returns_false(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_enable_assr_uninitialized_dtm_ignores_link(test: *mut kunit) {
...
// link is not dereferenced before the initialized check.
    ret = enable_assr(work, core::ptr::null_mut());
    KUNIT_EXPECT_FALSE(test, ret);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_enable_assr_initialized_builds_command_and_fails(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_config_null_connector_is_noop(test: *mut kunit) {
    static void dm_test_update_config_null_connector_is_noop(struct kunit *test)
    {
    struct hdcp_workqueue *work = alloc_test_workqueue_locked(test);
    let mut config: cp_psp_stream_config = {0};
    config.dm_stream_ctx = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_config_null_dc_link_is_noop(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_config_dpms_off_removes_display(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_config_populates_display_and_link(test: *mut kunit) {
