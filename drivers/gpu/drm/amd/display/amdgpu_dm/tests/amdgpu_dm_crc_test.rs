...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_crc_test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_crc_dc_fixture {
    pub dc: *mut dc,
    pub dc_ctx: *mut dc_context,
    pub dc_state: *mut dc_state,
    ...
    pub dm_state: *mut dm_crtc_state,
    pub crc_params: crc_params,
    pub dyn_expansion: enum dc_dynamic_expansion,
    pub dither_option: enum dc_dither_option,
    pub crc_r: u32,
    pub crc_g: u32,
    pub crc_b: u32,
    pub configure_crc_called: bool,
    pub dyn_expansion_called: bool,
    pub bit_depth_reduction_called: bool,
    pub configure_crc_return: bool,
    pub get_crc_called: bool,
    pub get_crc_return: bool,
}
...
#[no_mangle]
unsafe extern "C" fn dm_test_crc_connector_cleanup(data: *mut c_void) {
    static void dm_test_crc_connector_cleanup(void *data)
    {
    drm_connector_cleanup(data);
    }
#[no_mangle]
unsafe extern "C" fn dm_test_parse_crc_source_none(test: *mut kunit) {
    ...
    KUNIT_EXPECT_EQ(test, AMDGPU_DM_PIPE_CRC_SOURCE_NONE, dm_parse_crc_source(core::ptr::null_mut()));
    }
#[no_mangle]
unsafe extern "C" fn dm_test_parse_crc_source_crtc(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_parse_crc_source_dprx(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_parse_crc_source_crtc_dither(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_parse_crc_source_dprx_dither(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_parse_crc_source_invalid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_is_crc_source_crtc(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_is_crc_source_dprx(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_need_crc_dither(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_is_valid_crc_source(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_get_crc_sources(test: *mut kunit) {
    static void dm_test_crtc_get_crc_sources(struct kunit *test)
    {
    const char *const *sources;
    let mut count: usize = 0;
    sources = amdgpu_dm_crtc_get_crc_sources(core::ptr::null_mut(), &count);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_verify_crc_source_valid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_verify_crc_source_invalid(test: *mut kunit) {
    static void dm_test_crtc_verify_crc_source_invalid(struct kunit *test)
    {
    struct amdgpu_device *adev = dm_kunit_alloc_adev(test);
    struct amdgpu_crtc *acrtc = dm_test_alloc_crc_crtc(test, adev);
    let mut values_cnt: usize = 7;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_configure_crc_source_no_stream(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_configure_crc_source_dprx(test: *mut kunit) {
    ...
    dm_test_crc_dc_ctx = core::ptr::null_mut();
    KUNIT_EXPECT_EQ(test, ret, 0);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_configure_crc_source_dprx_dither(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_configure_crc_source_crtc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_configure_crc_source_crtc_dcn36_poly(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_configure_crc_source_crtc_configure_fails(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_configure_crc_source_none(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_set_crc_source_invalid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_set_crc_source_none_no_stream(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_set_crc_source_none_commit(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_set_crc_source_dprx_no_connector(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_handle_crc_irq_early_returns(test: *mut kunit) {
    static void dm_test_crtc_handle_crc_irq_early_returns(struct kunit *test)
    {
    struct amdgpu_device *adev = dm_kunit_alloc_adev(test);
    struct amdgpu_crtc *acrtc = dm_test_alloc_crc_crtc(test, adev);
    struct dm_crtc_state *dm_state;
    amdgpu_dm_crtc_handle_crc_irq(core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_handle_crc_irq_disabled_source(test: *mut kunit) {
    ...
    dm_state = kunit_kzalloc(test, sizeof(*dm_state), GFP_KERNEL);
    KUNIT_ASSERT_NOT_NULL(test, dm_state);
    dm_state.stream = dm_kunit_alloc_stream(test, core::ptr::null_mut());
    acrtc.base.state = &dm_state.base;
    acrtc.dm_irq_params.crc_src = AMDGPU_DM_PIPE_CRC_SOURCE_NONE;
    amdgpu_dm_crtc_handle_crc_irq(&acrtc.base);
    KUNIT_EXPECT_EQ(test, dm_state.crc_skip_count, 0);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_handle_crc_irq_skips_initial_frames(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_handle_crc_irq_dprx_after_skip(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_handle_crc_irq_get_crc_fails(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_need_dp_aux(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crc_source_should_start_dprx(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crc_source_should_stop_dprx(test: *mut kunit) {
