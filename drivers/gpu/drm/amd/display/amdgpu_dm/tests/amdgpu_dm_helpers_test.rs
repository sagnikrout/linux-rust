...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_helpers_test.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_edid_extract_panel_id_basic(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_edid_extract_panel_id_zeros(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_edid_quirks_dpcd_poweroff_delay(test: *mut kunit) {
    static void dm_test_apply_edid_quirks_dpcd_poweroff_delay(struct kunit *test)
    {
    let mut edid_caps: dc_edid_caps = {0};
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_edid_quirks_disable_fams(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_edid_quirks_remove_sink_ext_caps(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_edid_quirks_disable_colorimetry(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_edid_quirks_skip_phy_ssc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_edid_quirks_unknown_noop(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_base_edid(dc_edid: *mut dc_edid, good_checksum: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_parse_edid_caps_null_edid(test: *mut kunit) {
    static void dm_test_parse_edid_caps_null_edid(struct kunit *test)
    {
    let mut edid_caps: dc_edid_caps = {0};
    struct dc_link *link = dm_test_quirk_link(test);
    KUNIT_EXPECT_EQ(test, dm_helpers_parse_edid_caps(link, core::ptr::null_mut(), &edid_caps), EDID_BAD_INPUT);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_parse_edid_caps_null_caps(test: *mut kunit) {
    ...
    KUNIT_EXPECT_EQ(test, dm_helpers_parse_edid_caps(link, dc_edid, core::ptr::null_mut()), EDID_BAD_INPUT);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_parse_edid_caps_valid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_parse_edid_caps_bad_checksum(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_parse_edid_caps_hdmi_frl(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_parse_edid_caps_hdmi_frl_dsc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_cea_edid(dc_edid: *mut dc_edid, with_speaker: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_parse_edid_caps_cea_audio(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_parse_edid_caps_cea_no_speaker(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_probe_acpi_edid_no_companion(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_acpi_edid_debug_mask_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_acpi_edid_non_panel_connector(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_acpi_edid_force_off(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_vbios_edid {
    pub bios: dc_bios,
    pub result: enum bp_result,
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_vbios_edid_non_embedded(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_vbios_edid_missing_callback(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_vbios_edid_callback_error(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_vbios_edid_missing_fake_edid(test: *mut kunit) {
    ...
    struct dc_link *link;
    dm_test_setup_vbios_link(test, &link, &aconnector, &fixture);
    fixture.fake_edid = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_vbios_edid_invalid_fake_edid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_vbios_edid_valid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_freesync_pcon_whitelist_all_known(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_freesync_pcon_whitelist_not_in_list(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_freesync_pcon_whitelist_zero(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_populate_hdmi_scdc_present_true(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_populate_hdmi_scdc_present_false(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_populate_hdmi_frl_dsc_10bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_populate_hdmi_frl_dsc_12bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_populate_hdmi_frl_dsc_unknown_values(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_adaptive_sync_type_none_default(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_adaptive_sync_type_converter_no_conditions(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_adaptive_sync_type_converter_partial_conditions(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_adaptive_sync_type_pcon_whitelist(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_adaptive_sync_type_converter_nonwhitelist(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_helpers_is_fullscreen_returns_false(test: *mut kunit) {
    static void dm_test_helpers_is_fullscreen_returns_false(struct kunit *test)
    {
// Stub — always returns false
    KUNIT_EXPECT_FALSE(test, dm_helpers_is_fullscreen(core::ptr::null_mut(), core::ptr::null_mut()));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_helpers_is_hdr_on_returns_false(test: *mut kunit) {
    static void dm_test_helpers_is_hdr_on_returns_false(struct kunit *test)
    {
// Stub — always returns false
    KUNIT_EXPECT_FALSE(test, dm_helpers_is_hdr_on(core::ptr::null_mut(), core::ptr::null_mut()));
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_max_frl_rate_3lanes_3gbps(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_max_frl_rate_3lanes_6gbps(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_max_frl_rate_4lanes_6gbps(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_max_frl_rate_4lanes_8gbps(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_max_frl_rate_4lanes_10gbps(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_max_frl_rate_4lanes_12gbps(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_max_frl_rate_unknown(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dtn_log_buffer_accumulates(test: *mut kunit) {
    static void dm_test_dtn_log_buffer_accumulates(struct kunit *test)
    {
    let mut log_ctx: dc_log_buffer_ctx = {0};
    dm_dtn_log_begin(core::ptr::null_mut(), &log_ctx);
    dm_dtn_log_append_v(core::ptr::null_mut(), &log_ctx, "x=%d\n", 7);
    dm_dtn_log_end(core::ptr::null_mut(), &log_ctx);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dtn_log_null_ctx_no_crash(test: *mut kunit) {
...
// NULL log_ctx redirects to dmesg and must not dereference a buffer
    dm_dtn_log_begin(core::ptr::null_mut(), core::ptr::null_mut());
    dm_dtn_log_append_v(core::ptr::null_mut(), core::ptr::null_mut(), "value %d\n", 1);
    dm_dtn_log_end(core::ptr::null_mut(), core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_read_dpcd_null_priv(test: *mut kunit) {
...
// link->priv (aconnector) is NULL → early return false
    ...
    dm_helpers_dp_read_dpcd(core::ptr::null_mut(), link, 0, &data, sizeof(data)));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_write_dpcd_null_priv(test: *mut kunit) {
...
// link->priv (aconnector) is NULL → early return false
    KUNIT_EXPECT_FALSE(test,
    dm_helpers_dp_write_dpcd(core::ptr::null_mut(), link, 0, &data, sizeof(data)));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_read_dpcd_success(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_write_dpcd_success(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_execute_fused_io_null_dmub_srv(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_synaptics_aux {
    pub aux: drm_dp_aux,
    pub fail_address: u32,
    pub last_dpcd_write_address: u32,
    pub rc_result: u8,
    pub dpcd_read_value: u8,
    pub dpcd_write_value: u8,
    pub last_rc_data: [u8; 16],
    pub read_rc_data: [u8; 16],
    pub last_rc_command: u8,
    pub rc_commands: [u8; 32],
    pub dsc_enable_values: [u8; 8],
    pub last_rc_offset: u32,
    pub last_rc_length: u32,
    pub rc_data_writes: c_uint,
    pub rc_data_reads: c_uint,
    pub rc_command_reads: c_uint,
    pub rc_result_reads: c_uint,
    pub rc_command_count: c_uint,
    pub downspread_reads: c_uint,
    pub downspread_writes: c_uint,
    pub dsc_enable_writes: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_execute_synaptics_rc_command_write_success(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_execute_synaptics_rc_command_read_success(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_execute_synaptics_rc_command_write_fail(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_synaptics_fifo_reset_wa_full(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_synaptics_fifo_reset_wa_first_fail(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_write_dsc_enable_synaptics_enable_inactive(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_write_dsc_enable_synaptics_enable_active(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_write_dsc_enable_synaptics_disable_inactive(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_write_dsc_enable_synaptics_disable_active(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_write_dsc_enable_synaptics_enable_non_synaptics(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_write_dsc_enable_routes_synaptics(test: *mut kunit) {
    ...
    KUNIT_EXPECT_TRUE(test, dm_helpers_dp_write_dsc_enable(core::ptr::null_mut(), stream, true));
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_start_top_mgr_null_priv(test: *mut kunit) {
    static void dm_test_mst_start_top_mgr_null_priv(struct kunit *test)
    {
    struct dc_link *link;
    link = kunit_kzalloc(test, sizeof(*link), GFP_KERNEL);
    KUNIT_ASSERT_NOT_NULL(test, link);
    KUNIT_EXPECT_FALSE(test, dm_helpers_dp_mst_start_top_mgr(core::ptr::null_mut(), link, false));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_stop_top_mgr_null_priv(test: *mut kunit) {
    static void dm_test_mst_stop_top_mgr_null_priv(struct kunit *test)
    {
    struct dc_link *link;
    link = kunit_kzalloc(test, sizeof(*link), GFP_KERNEL);
    KUNIT_ASSERT_NOT_NULL(test, link);
    KUNIT_EXPECT_FALSE(test, dm_helpers_dp_mst_stop_top_mgr(core::ptr::null_mut(), link));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_start_top_mgr_boot(test: *mut kunit) {
    ...
    aconnector = dm_kunit_alloc_connector(test, adev, core::ptr::null_mut());
    link.priv = aconnector;
    KUNIT_EXPECT_TRUE(test, dm_helpers_dp_mst_start_top_mgr(core::ptr::null_mut(), link, true));
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_write_hblank_reduction_false(test: *mut kunit) {
    static void dm_test_dp_write_hblank_reduction_false(struct kunit *test)
    {
    KUNIT_EXPECT_FALSE(test, dm_helpers_dp_write_hblank_reduction(core::ptr::null_mut(), core::ptr::null_mut()));
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_dsc_max_slices_1_340(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_dsc_max_slices_2_340(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_dsc_max_slices_4_340(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_dsc_max_slices_8_340(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_dsc_max_slices_8_400(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_dsc_max_slices_12_400(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_dsc_max_slices_16_400(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_dsc_max_slices_unknown(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_init_panel_settings_pps(test: *mut kunit) {
    static void dm_test_init_panel_settings_pps(struct kunit *test)
    {
    let mut panel_config: dc_panel_config = {0};
    struct dc_sink *sink;
    ...
    dm_helpers_init_panel_settings(core::ptr::null_mut(), &panel_config, sink);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_init_panel_settings_dsc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_override_panel_settings_debug_mask_disables_dsc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_override_panel_settings_second_edp_disables_psr(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_mst_payload_table_enable(test: *mut kunit) {
    static void dm_test_fill_mst_payload_table_enable(struct kunit *test)
    {
    struct dc_link *link;
    let mut payload: drm_dp_mst_atomic_payload = {0};
    let mut table: dc_dp_mst_stream_allocation_table = {0};
    link = kunit_kzalloc(test, sizeof(*link), GFP_KERNEL);
    KUNIT_ASSERT_NOT_NULL(test, link);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_mst_payload_table_disable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_mst_payload_table_empty(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_submit_i2c_null_priv(test: *mut kunit) {
    static void dm_test_submit_i2c_null_priv(struct kunit *test)
    {
    struct dc_link *link;
    let mut cmd: i2c_command = {0};
    link = kunit_kzalloc(test, sizeof(*link), GFP_KERNEL);
    KUNIT_ASSERT_NOT_NULL(test, link);
    KUNIT_EXPECT_FALSE(test, dm_helpers_submit_i2c(core::ptr::null_mut(), link, &cmd));
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_i2c_adapter {
    pub base: i2c_adapter,
    pub test: *mut kunit,
    pub expected_payloads: *mut i2c_payload,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_mccs_i2c_adapter {
    pub base: i2c_adapter,
    pub write_data: [u8; 16],
    pub read_reply: [u8; 11],
    pub write_ret: c_int,
    pub read_ret: c_int,
    pub write_len: c_uint,
    pub writes: c_uint,
    pub reads: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn dm_test_mccs_checksum(data: *const u8, len: c_uint) -> u8 {
    static u8 dm_test_mccs_checksum(const u8 *data, unsigned int len)
    {
    let mut checksum: u8 = 0x6e;
    unsigned int i;
    for (i = 0; i < len; i++)
    checksum ^= data[i];
    return checksum;
    ...
    link.priv = aconnector;
    KUNIT_EXPECT_EQ(test, dm_helpers_submit_i2c(core::ptr::null_mut(), link, &cmd), full_transfer);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_submit_i2c_success(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_submit_i2c_partial_transfer(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_aux_transfer_sync_hpd_discon(test: *mut kunit) {
    static void dm_test_dmub_aux_transfer_sync_hpd_discon(struct kunit *test)
    {
    struct dc_link *link;
    struct dc_context *ctx;
    let mut payload: aux_payload = {0};
    let mut result: enum aux_return_code_type = AUX_RET_SUCCESS;
    int ret;
    link = kunit_kzalloc(test, sizeof(*link), GFP_KERNEL);
    KUNIT_ASSERT_NOT_NULL(test, link);
    ctx = kunit_kzalloc(test, sizeof(*ctx), GFP_KERNEL);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_update_branch_info_no_crash(test: *mut kunit) {
    static void dm_test_dp_update_branch_info_no_crash(struct kunit *test)
    {
    dm_helpers_dp_update_branch_info(core::ptr::null_mut(), core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, true);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_poll_pending_down_reply_no_crash(test: *mut kunit) {
    static void dm_test_mst_poll_pending_down_reply_no_crash(struct kunit *test)
    {
    dm_helpers_dp_mst_poll_pending_down_reply(core::ptr::null_mut(), core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, true);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_clear_payload_alloc_table_no_crash(test: *mut kunit) {
    static void dm_test_mst_clear_payload_alloc_table_no_crash(struct kunit *test)
    {
    dm_helpers_dp_mst_clear_payload_allocation_table(core::ptr::null_mut(), core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, true);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_dcn_clocks_no_crash(test: *mut kunit) {
    static void dm_test_set_dcn_clocks_no_crash(struct kunit *test)
    {
    dm_set_dcn_clocks(core::ptr::null_mut(), core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, true);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmu_timeout_no_crash(test: *mut kunit) {
    static void dm_test_dmu_timeout_no_crash(struct kunit *test)
    {
    dm_helpers_dmu_timeout(core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, true);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_smu_timeout_no_crash(test: *mut kunit) {
    static void dm_test_smu_timeout_no_crash(struct kunit *test)
    {
    dm_helpers_smu_timeout(core::ptr::null_mut(), 0, 0, 0);
    KUNIT_EXPECT_TRUE(test, true);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_phyd32clk_no_crash(test: *mut kunit) {
    static void dm_test_set_phyd32clk_no_crash(struct kunit *test)
    {
    dm_set_phyd32clk(core::ptr::null_mut(), 0);
    KUNIT_EXPECT_TRUE(test, true);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_update_branch_bandwidth_no_crash(test: *mut kunit) {
    static void dm_test_mst_update_branch_bandwidth_no_crash(struct kunit *test)
    {
    dm_helpers_dp_mst_update_branch_bandwidth(core::ptr::null_mut(), core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, true);
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_write_payload_alloc_table_null_ctx(test: *mut kunit) {
...
// dm_stream_context is NULL → aconnector is NULL → return false
    KUNIT_EXPECT_FALSE(test,
    dm_helpers_dp_mst_write_payload_allocation_table(core::ptr::null_mut(), stream, core::ptr::null_mut(), true));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_poll_for_act_null_ctx(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_NULL(test, stream);
    KUNIT_EXPECT_EQ(test,
    (int)dm_helpers_dp_mst_poll_for_allocation_change_trigger(core::ptr::null_mut(), stream),
    (int)ACT_FAILED);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_send_payload_alloc_null_ctx(test: *mut kunit) {
...
// Should early-return without crash
    dm_helpers_dp_mst_send_payload_allocation(core::ptr::null_mut(), stream);
    KUNIT_EXPECT_TRUE(test, true);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_update_mgr_dealloc_null_ctx(test: *mut kunit) {
    static void dm_test_mst_update_mgr_dealloc_null_ctx(struct kunit *test)
    {
    struct dc_stream_state *stream;
    stream = kunit_kzalloc(test, sizeof(*stream), GFP_KERNEL);
    KUNIT_ASSERT_NOT_NULL(test, stream);
    dm_helpers_dp_mst_update_mst_mgr_for_deallocation(core::ptr::null_mut(), stream);
    KUNIT_EXPECT_TRUE(test, true);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_is_dp_sink_present_null_priv(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_outbox_interrupt_control_null_dc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_enable_stream_features_aux_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_enable_stream_features_writes_downspread(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_idle_work {
    pub base: idle_workqueue,
    pub ran: bool,
}

#[no_mangle]
unsafe extern "C" fn dm_test_idle_work_func(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_enable_periodic_detection_no_workqueue(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_enable_periodic_detection_updates_enable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_enable_periodic_detection_schedules_work(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_mccs_caps_null_ctx(test: *mut kunit) {
    static void dm_test_read_mccs_caps_null_ctx(struct kunit *test)
    {
// NULL ctx → early return, no crash
    dm_helpers_read_mccs_caps(core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, true);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_mccs_caps_null_link(test: *mut kunit) {
...
// link is NULL → drm_dbg_driver + return
    dm_helpers_read_mccs_caps(ctx, core::ptr::null_mut(), sink);
    KUNIT_EXPECT_TRUE(test, true);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_mccs_caps_no_vcp_code(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_mccs_fixture {
    pub adev: *mut amdgpu_device,
    pub ctx: *mut dc_context,
    pub link: *mut dc_link,
    pub sink: *mut dc_sink,
    pub aconnector: *mut amdgpu_dm_connector,
    pub fake: *mut dm_test_mccs_i2c_adapter,
}

#[no_mangle]
unsafe extern "C" fn dm_test_alloc_mccs_fixture(test: *mut kunit) -> dm_test_mccs_fixture {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_mccs_caps_i2c_vcp_request(test: *mut kunit) {
    static void dm_test_read_mccs_caps_i2c_vcp_request(struct kunit *test)
    {
    static const u8 expected_prefix[] = { 0x51, 0x82, 0x01, 0xe3 };
    let mut fixture: dm_test_mccs_fixture = dm_test_alloc_mccs_fixture(test);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_mccs_caps_hdmi_vcp_request(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_mccs_caps_legacy_pcon_vcp_request(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_read_mccs_caps_i2c_failure(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mccs_vcp_set_null_ctx(test: *mut kunit) {
    static void dm_test_mccs_vcp_set_null_ctx(struct kunit *test)
    {
// NULL ctx → early return, no crash
    dm_helpers_mccs_vcp_set(core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, true);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mccs_vcp_set_not_supported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mccs_vcp_set_null_link(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_NULL(test, sink);
    ctx.driver_context = adev;
    dm_helpers_mccs_vcp_set(ctx, core::ptr::null_mut(), sink);
    KUNIT_EXPECT_TRUE(test, true);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mccs_vcp_set_i2c_packet(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mccs_vcp_set_i2c_failure(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_construct_old_payload_empty_list(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_construct_old_payload_intervening(test: *mut kunit) {
...
// aconnector acts as its own MST root for this fixture
    ...
    mutex_init(&mgr.lock);
    mgr.dev = &adev.ddev;
    mgr.mst_primary = core::ptr::null_mut();		/* topology walk fails gracefully */
...
// pre-existing HW allocation so the disable path finds a VCPI to clear
    ...
    stream.dm_stream_context = aconnector;
    stream.link = link;
    ret = dm_helpers_dp_mst_write_payload_allocation_table(core::ptr::null_mut(), stream,
    &table, enable);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_write_payload_alloc_table_enable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_write_payload_alloc_table_disable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_start_top_mgr_set_mst_fail(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_stop_top_mgr_active(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_poll_for_act_no_mst_state(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_poll_for_act_success(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_poll_for_act_status_failed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_send_payload_alloc_part2_fail(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mst_update_mgr_dealloc_success(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_write_dsc_enable_mst_no_aux(test: *mut kunit) {
    ...
    stream.dm_stream_context = aconnector;
    stream.signal = SIGNAL_TYPE_DISPLAY_PORT_MST;
    aconnector.dsc_aux = core::ptr::null_mut();
// MST signal with NULL dsc_aux → return false
    KUNIT_EXPECT_FALSE(test, dm_helpers_dp_write_dsc_enable(core::ptr::null_mut(), stream, true));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_write_dsc_enable_non_dp(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_dsc_aux_pair {
    pub main: *mut dm_test_synaptics_aux,
    pub passthrough: *mut dm_test_synaptics_aux,
}
    ...
    port = kunit_kzalloc(test, sizeof(*port), GFP_KERNEL);
    KUNIT_ASSERT_NOT_NULL(test, port);
    aux_pair.main = dm_test_alloc_synaptics_aux_with_dev(test, core::ptr::null_mut());
    aux_pair.passthrough = dm_test_alloc_synaptics_aux_with_dev(test, core::ptr::null_mut());
    stream.dm_stream_context = aconnector;
    aconnector.dsc_aux = &aux_pair.main.aux;
    aconnector.mst_output_port = port;
    if (passthrough)
    port.passthrough_aux = &aux_pair.passthrough.aux;
    ret = dm_helpers_dp_write_dsc_enable(core::ptr::null_mut(), stream, enable);
    KUNIT_EXPECT_TRUE(test, ret);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_write_dsc_enable_mst_enable_decode_only(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_write_dsc_enable_mst_enable_passthrough(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_write_dsc_enable_mst_disable_decode_only(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_write_dsc_enable_mst_disable_passthrough(test: *mut kunit) {
    ...
    fixture = dm_test_alloc_synaptics_aux_with_dev(test, core::ptr::null_mut());
    stream.dm_stream_context = aconnector;
    link.priv = aconnector;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_write_dsc_enable_sst_rx_enable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_write_dsc_enable_sst_rx_disable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_write_dsc_enable_pcon_enable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_write_dsc_enable_pcon_disable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dp_handle_test_pattern_no_pipe(test: *mut kunit) {
    static void dm_test_dp_handle_test_pattern_no_pipe(struct kunit *test)
    {
    let mut test_pattern: union link_test_pattern = {0};
    let mut test_params: union test_misc = {0};
    struct amdgpu_dm_connector *aconnector;
    struct amdgpu_device *adev;
    struct dc_context *ctx;
