...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_color_test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dm_test_fixpt_from_s3132_zero(test: *mut kunit) {
    static void dm_test_fixpt_from_s3132_zero(struct kunit *test)
    {
    let mut val: fixed31_32 = amdgpu_dm_fixpt_from_s3132(0ULL);
    KUNIT_EXPECT_EQ(test, val.value, 0LL);
    }
#[no_mangle]
unsafe extern "C" fn dm_test_fixpt_from_s3132_one(test: *mut kunit) {
    static void dm_test_fixpt_from_s3132_one(struct kunit *test)
    {
// 1.0 in S31.32 signed-magnitude = 1ULL << 32
    let mut val: fixed31_32 = amdgpu_dm_fixpt_from_s3132(1ULL << 32);
    KUNIT_EXPECT_EQ(test, val.value, (long long)(1ULL << 32));
    }
#[no_mangle]
unsafe extern "C" fn dm_test_fixpt_from_s3132_negative_one(test: *mut kunit) {
...
// -1.0 in S31.32 signed-magnitude: sign bit set | magnitude 1<<32
    let mut neg_one: __u64 = (1ULL << 63) | (1ULL << 32);
    let mut val: fixed31_32 = amdgpu_dm_fixpt_from_s3132(neg_one);
// 2's complement of 1.0 is -(1<<32)
    KUNIT_EXPECT_EQ(test, val.value, -(long long)(1ULL << 32));
    }
#[no_mangle]
unsafe extern "C" fn dm_test_fixpt_from_s3132_half(test: *mut kunit) {
    static void dm_test_fixpt_from_s3132_half(struct kunit *test)
    {
// 0.5 in S31.32 = 1ULL << 31
    let mut val: fixed31_32 = amdgpu_dm_fixpt_from_s3132(1ULL << 31);
    KUNIT_EXPECT_EQ(test, val.value, (long long)(1ULL << 31));
    }
#[no_mangle]
unsafe extern "C" fn dm_test_fixpt_from_s3132_neg_half(test: *mut kunit) {
    static void dm_test_fixpt_from_s3132_neg_half(struct kunit *test)
    {
    let mut neg_half: __u64 = (1ULL << 63) | (1ULL << 31);
    let mut val: fixed31_32 = amdgpu_dm_fixpt_from_s3132(neg_half);
    KUNIT_EXPECT_EQ(test, val.value, -(long long)(1ULL << 31));
    }
// ---- Tests for __is_lut_linear ----
#[no_mangle]
unsafe extern "C" fn dm_test_is_lut_linear_with_linear_lut(test: *mut kunit) {
    ...
    for (i = 0; i < size; i++) {
    let mut val: u16 = (uint16_t)(i * MAX_DRM_LUT_VALUE / (size - 1));
    lut[i].red = val;
    lut[i].green = val;
    lut[i].blue = val;
    }
...
#[no_mangle]
unsafe extern "C" fn dm_test_is_lut_linear_with_nonlinear_lut(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_is_lut_linear_rgb_mismatch(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_drm_ctm_to_dc_matrix_identity(test: *mut kunit) {
    static void dm_test_drm_ctm_to_dc_matrix_identity(struct kunit *test)
    {
    struct drm_color_ctm ctm;
    struct fixed31_32 matrix[12];
    int i;
    let mut one: c_longlong = 1LL << 32;
...
#[no_mangle]
unsafe extern "C" fn dm_test_drm_ctm_to_dc_matrix_negative(test: *mut kunit) {
    static void dm_test_drm_ctm_to_dc_matrix_negative(struct kunit *test)
    {
    struct drm_color_ctm ctm;
    struct fixed31_32 matrix[12];
    let mut neg_one: c_longlong = -(1LL << 32);
    memset(&ctm, 0, sizeof(ctm));
...
#[no_mangle]
unsafe extern "C" fn dm_test_drm_ctm_to_dc_matrix_4th_col_zero(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_drm_ctm_3x4_to_dc_matrix_identity(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_drm_ctm_3x4_to_dc_matrix_offset(test: *mut kunit) {
    static void dm_test_drm_ctm_3x4_to_dc_matrix_offset(struct kunit *test)
    {
    struct drm_color_ctm_3x4 ctm;
    struct fixed31_32 matrix[12];
    let mut half: c_longlong = 1LL << 31;
    memset(&ctm, 0, sizeof(ctm));
...
#[no_mangle]
unsafe extern "C" fn dm_test_tf_to_dc_tf_default(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_tf_to_dc_tf_identity(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_tf_to_dc_tf_srgb(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_tf_to_dc_tf_bt709(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_tf_to_dc_tf_pq(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_tf_to_dc_tf_gamma22(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_tf_to_dc_tf_gamma24(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_tf_to_dc_tf_gamma26(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_colorop_tf_to_dc_tf_srgb(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_colorop_tf_to_dc_tf_pq(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_colorop_tf_to_dc_tf_bt2020(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_colorop_tf_to_dc_tf_gamma22(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_colorop_tf_to_dc_tf_default(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_drm_lut_to_dc_gamma_legacy_zero(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_drm_lut_to_dc_gamma_legacy_max(test: *mut kunit) {
    static void dm_test_drm_lut_to_dc_gamma_legacy_max(struct kunit *test)
    {
    struct drm_color_lut *lut;
    struct dc_gamma *gamma;
    let mut expected: c_longlong = (long long)MAX_DRM_LUT_VALUE << 32;
    lut = kunit_kcalloc(test, MAX_COLOR_LEGACY_LUT_ENTRIES,
    sizeof(*lut), GFP_KERNEL);
    KUNIT_ASSERT_NOT_NULL(test, lut);
    gamma = kunit_kzalloc(test, sizeof(*gamma), GFP_KERNEL);
...
#[no_mangle]
unsafe extern "C" fn dm_test_drm_lut_to_dc_gamma_legacy_channels(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_drm_lut_to_dc_gamma_nonlegacy_zero(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_drm_lut_to_dc_gamma_nonlegacy_max(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_drm_lut32_to_dc_gamma_zero(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_drm_lut32_to_dc_gamma_max(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_drm_lut32_to_dc_gamma_channels(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_extract_blob_lut_null(test: *mut kunit) {
    static void dm_test_extract_blob_lut_null(struct kunit *test)
    {
    let mut size: u32 = 42;
    const struct drm_color_lut *lut;
    lut = __extract_blob_lut(core::ptr::null_mut(), &size);
    KUNIT_EXPECT_NULL(test, lut);
    KUNIT_EXPECT_EQ(test, size, 0);
    }
#[no_mangle]
unsafe extern "C" fn dm_test_extract_blob_lut_valid(test: *mut kunit) {
    static void dm_test_extract_blob_lut_valid(struct kunit *test)
    {
    let mut num_entries: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn dm_test_extract_blob_lut32_null(test: *mut kunit) {
    static void dm_test_extract_blob_lut32_null(struct kunit *test)
    {
    let mut size: u32 = 42;
    const struct drm_color_lut32 *lut;
    lut = __extract_blob_lut32(core::ptr::null_mut(), &size);
    KUNIT_EXPECT_NULL(test, lut);
    KUNIT_EXPECT_EQ(test, size, 0);
    }
#[no_mangle]
unsafe extern "C" fn dm_test_extract_blob_lut32_valid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_to_dc_lut3d_color_zero(test: *mut kunit) {
    static void dm_test_to_dc_lut3d_color_zero(struct kunit *test)
    {
    let mut rgb: dc_rgb = {0};
    let mut lut: drm_color_lut = {0};
...
#[no_mangle]
unsafe extern "C" fn dm_test_to_dc_lut3d_color_max(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_to_dc_lut3d_color_channels(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_3dlut_to_dc_3dlut_distribution(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_3dlut_to_dc_3dlut_tetrahedral_17(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_3dlut_to_dc_3dlut_green_blue(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_to_dc_lut3d_32_color_zero(test: *mut kunit) {
    static void dm_test_to_dc_lut3d_32_color_zero(struct kunit *test)
    {
    let mut rgb: dc_rgb = {0};
    let mut lut: drm_color_lut32 = {0};
...
#[no_mangle]
unsafe extern "C" fn dm_test_to_dc_lut3d_32_color_max(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_to_dc_lut3d_32_color_channels(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_3dlut32_to_dc_3dlut_distribution(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_3dlut32_to_dc_3dlut_tetrahedral_17(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_3dlut32_to_dc_3dlut_green_blue(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_verify_lut_sizes_null_luts(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_verify_lut_sizes_valid_degamma(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_verify_lut_sizes_invalid_degamma(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_verify_lut_sizes_valid_gamma_atomic(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_verify_lut_sizes_valid_gamma_legacy(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_verify_lut_sizes_invalid_gamma(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_verify_lut_sizes_both_valid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_verify_lut_sizes_invalid_degamma_valid_gamma(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_atomic_lut3d_zero_size(test: *mut kunit) {
...
// Pre-set initialized so we can confirm it is cleared
    ...
    amdgpu_dm_atomic_lut3d(core::ptr::null_mut(), 0, cm);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_atomic_lut3d_nonzero_state_bits(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_atomic_lut3d_data_forwarded(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_colorop_3dlut_zero_size(test: *mut kunit) {
    ...
    KUNIT_EXPECT_EQ(test, __set_colorop_3dlut(core::ptr::null_mut(), 0, lut), -EINVAL);
// Copy bit-field: typeof cannot be applied to a bit-field
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_colorop_3dlut_nonzero_state_bits(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_colorop_3dlut_data_forwarded(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_tf_bypass(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_tf_distributed_points_srgb(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_tf_distributed_points_pq(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_legacy_tf_identity(test: *mut kunit) {
    ...
    let mut value: u16 = i * MAX_DRM_LUT_VALUE / (MAX_COLOR_LEGACY_LUT_ENTRIES - 1);
    lut[i].red = value;
    lut[i].green = value;
    lut[i].blue = value;
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_output_tf_linear(test: *mut kunit) {
    ...
    KUNIT_EXPECT_EQ(test, __set_output_tf(tf, core::ptr::null_mut(), 0, false), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_output_tf_32_srgb_rom(test: *mut kunit) {
    ...
    tf.type = TF_TYPE_PREDEFINED;
    tf.tf = TRANSFER_FUNCTION_SRGB;
    KUNIT_EXPECT_EQ(test, __set_output_tf_32(tf, core::ptr::null_mut(), 0, true), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_input_tf_srgb(test: *mut kunit) {
    ...
    tf.type = TF_TYPE_PREDEFINED;
    tf.tf = TRANSFER_FUNCTION_SRGB;
    KUNIT_EXPECT_EQ(test, __set_input_tf(core::ptr::null_mut(), tf, core::ptr::null_mut(), 0), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_input_tf_32_srgb(test: *mut kunit) {
    ...
    tf.type = TF_TYPE_PREDEFINED;
    tf.tf = TRANSFER_FUNCTION_SRGB;
    KUNIT_EXPECT_EQ(test, __set_input_tf_32(core::ptr::null_mut(), tf, core::ptr::null_mut(), 0), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_transfer_funcs_with_luts(test: *mut kunit) {
    ...
    tf.tf = TRANSFER_FUNCTION_SRGB;
    KUNIT_EXPECT_EQ(test,
    __set_input_tf(core::ptr::null_mut(), tf, lut, MAX_COLOR_LUT_ENTRIES),
    0);
    memset(tf, 0, sizeof(*tf));
    tf.type = TF_TYPE_DISTRIBUTED_POINTS;
    tf.tf = TRANSFER_FUNCTION_SRGB;
    KUNIT_EXPECT_EQ(test,
    __set_input_tf_32(core::ptr::null_mut(), tf, lut32, MAX_COLOR_LUT_ENTRIES),
    0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_atomic_regamma_bypass(test: *mut kunit) {
...
// size=0 and tf=LINEAR: must take the bypass branch
    KUNIT_EXPECT_EQ(test,
    amdgpu_dm_set_atomic_regamma(out_tf, core::ptr::null_mut(), 0, false,
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_atomic_regamma_srgb(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_NULL(test, out_tf);
    KUNIT_EXPECT_EQ(test,
    amdgpu_dm_set_atomic_regamma(out_tf, core::ptr::null_mut(), 0, true, TRANSFER_FUNCTION_SRGB),
    0);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_atomic_shaper_lut_bypass(test: *mut kunit) {
...
// size=0 and tf=LINEAR: must take the bypass branch
    KUNIT_EXPECT_EQ(test,
    amdgpu_dm_atomic_shaper_lut(core::ptr::null_mut(), false,
    TRANSFER_FUNCTION_LINEAR,
    0, cm),
    0);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_atomic_blend_lut_bypass(test: *mut kunit) {
...
// size=0 and tf=LINEAR: must take the bypass branch
    KUNIT_EXPECT_EQ(test,
    amdgpu_dm_atomic_blend_lut(core::ptr::null_mut(), false,
    TRANSFER_FUNCTION_LINEAR,
    0, cm),
    0);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_atomic_shaper_blend_srgb(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_NULL(test, cm);
    KUNIT_EXPECT_EQ(test,
    amdgpu_dm_atomic_shaper_lut(core::ptr::null_mut(), true, TRANSFER_FUNCTION_SRGB, 0, cm),
    0);
    KUNIT_EXPECT_TRUE(test, cm.flags.bits.shaper_enable);
    KUNIT_EXPECT_EQ(test,
    amdgpu_dm_atomic_blend_lut(core::ptr::null_mut(), false, TRANSFER_FUNCTION_SRGB, 0, cm),
    0);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_colorop_in_tf_1d_curve_invalid_type(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_colorop_in_tf_1d_curve_unsupported_curve(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_colorop_in_tf_1d_curve_bypass(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_init_color_mod(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_verify_lut3d_no_luts(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_verify_lut3d_bad_shaper(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_verify_lut3d_bad_lut3d(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_verify_lut3d_valid(test: *mut kunit) {
...
//
    ...
    {
    let mut f: dm_test_colorop_fixture = {0};
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_colorop_multiplier_applied(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_colorop_multiplier_no_match(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_colorop_3x4_matrix_applied(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_colorop_3x4_matrix_bad_length(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_colorop_degamma_predefined(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_colorop_degamma_no_match(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_color_update_fixture {
    pub adev: *mut amdgpu_device,
    pub state: *mut drm_atomic_commit,
    pub crtc_state: *mut dm_crtc_state,
    pub stream: *mut dc_stream_state,
    pub dm_plane_state: *mut dm_plane_state,
...
//
    ...
    {
    let mut f: dm_test_color_update_fixture = {0};
    f.adev = dm_kunit_alloc_adev(test);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_check_crtc_color_mgmt_no_luts(test: *mut kunit) {
    static void dm_test_check_crtc_color_mgmt_no_luts(struct kunit *test)
    {
    let mut f: dm_test_color_update_fixture = dm_test_color_update_setup(test);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_check_crtc_color_mgmt_legacy_regamma(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_check_crtc_color_mgmt_degamma(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_crtc_color_mgmt_no_ctm(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_crtc_color_mgmt_ctm(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_bad_lut3d(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_fallback_defaults(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_maps_crtc_degamma(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_maps_crtc_degamma_lut(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_maps_bt709_degamma(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_plane_degamma_lut(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_rejects_dual_degamma(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_uses_color_caps(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_legacy_luts(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_plane_ctm(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_colorop_bypass_pipeline(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_colorop_missing_multiplier(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_colorop_missing_3x4(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_colorop_truncated(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_colorop_no_3dlut_hw(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_colorop_shaper(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_colorop_3dlut(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_colorop_3dlut_no_data(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_plane_color_mgmt_colorop_blend(test: *mut kunit) {
