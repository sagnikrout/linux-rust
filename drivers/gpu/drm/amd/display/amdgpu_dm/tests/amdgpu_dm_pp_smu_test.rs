...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_pp_smu_test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stub_dpm_context {
    pub ret_val: c_int,
    pub get_current_clocks_info: amd_pp_clock_info,
    pub get_clock_by_type_clocks: amd_pp_clocks,
    pub get_validation_clks: amd_pp_simple_clock_info,
    pub get_validation_clks_ret: c_int,
    pub get_clock_by_type_with_latency_clks: pp_clock_levels_with_latency,
    pub get_clock_by_type_with_voltage_clks: pp_clock_levels_with_voltage,
    pub set_watermarks_ret: c_int,
    pub display_clock_voltage_ret: c_int,
    pub display_disable_memory_clock_switch_ret: c_int,
    pub get_max_sustainable_ret: c_int,
    pub get_uclk_dpm_ret: c_int,
    pub get_dpm_clock_table_ret: c_int,
    pub set_active_display_count_ret: c_int,
    pub set_min_deep_sleep_dcefclk_ret: c_int,
}

    static struct stub_dpm_context *stub_dpm_ctx;
#[no_mangle]
unsafe extern "C" fn stub_get_current_clocks(handle: *mut c_void, clocks: *mut amd_pp_clock_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stub_display_configuration_change(handle: *mut c_void) {
    static void stub_display_configuration_change(void *handle)
    {
// No-op: satisfies display_configuration_changed callback
    }
#[no_mangle]
unsafe extern "C" fn stub_pm_compute_clocks(handle: *mut c_void) {
    static void stub_pm_compute_clocks(void *handle)
    {
// No-op: satisfies pm_compute_clocks callback
    }
#[no_mangle]
unsafe extern "C" fn stub_set_watermarks_for_clocks_ranges(handle: *mut c_void, clock_ranges: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stub_set_active_display_count(handle: *mut c_void, count: u32) -> c_int {
    static int stub_set_active_display_count(void *handle, uint32_t count)
    {
    return stub_dpm_ctx.set_active_display_count_ret;
    }
#[no_mangle]
unsafe extern "C" fn stub_set_min_deep_sleep_dcefclk(handle: *mut c_void, clock: u32) -> c_int {
    static int stub_set_min_deep_sleep_dcefclk(void *handle, uint32_t clock)
    {
    return stub_dpm_ctx.set_min_deep_sleep_dcefclk_ret;
    }
#[no_mangle]
unsafe extern "C" fn stub_set_hard_min_dcefclk_by_freq(handle: *mut c_void, clock: u32) -> c_int {
    static int stub_set_hard_min_dcefclk_by_freq(void *handle, uint32_t clock)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn stub_set_hard_min_fclk_by_freq(handle: *mut c_void, clock: u32) -> c_int {
    static int stub_set_hard_min_fclk_by_freq(void *handle, uint32_t clock)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn stub_notify_smu_enable_pwe(handle: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stub_get_dpm_clock_table(handle: *mut c_void, clock_table: *mut dpm_clocks) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn setup_stub_dpm(test: *mut kunit, adev: *mut amdgpu_device) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_default_clock_levels_display(test: *mut kunit) {
    static void dm_test_default_clock_levels_display(struct kunit *test)
    {
    let mut clks: dm_pp_clock_levels = { 0 };
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_default_clock_levels_engine(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_default_clock_levels_memory(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_default_clock_levels_unknown(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dc_to_pp_clock_type_display(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dc_to_pp_clock_type_engine(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dc_to_pp_clock_type_memory(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dc_to_pp_clock_type_dcefclk(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dc_to_pp_clock_type_dcfclk(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dc_to_pp_clock_type_pixelclk(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dc_to_pp_clock_type_fclk(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dc_to_pp_clock_type_phyclk(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dc_to_pp_clock_type_dppclk(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dc_to_pp_clock_type_invalid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_pp_to_dc_clock_levels_within_limit(test: *mut kunit) {
    static void dm_test_pp_to_dc_clock_levels_within_limit(struct kunit *test)
    {
    let mut pp_clks: amd_pp_clocks = {};
    let mut dc_clks: dm_pp_clock_levels = {};
    pp_clks.count = 3;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_pp_to_dc_clock_levels_caps_at_max(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_pp_to_dc_clock_levels_latency_within_limit(test: *mut kunit) {
    static void dm_test_pp_to_dc_clock_levels_latency_within_limit(struct kunit *test)
    {
    let mut pp_clks: pp_clock_levels_with_latency = {};
    let mut dc_clks: dm_pp_clock_levels_with_latency = {};
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_pp_to_dc_clock_levels_latency_caps_at_max(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_pp_to_dc_clock_levels_voltage_within_limit(test: *mut kunit) {
    static void dm_test_pp_to_dc_clock_levels_voltage_within_limit(struct kunit *test)
    {
    let mut pp_clks: pp_clock_levels_with_voltage = {};
    let mut dc_clks: dm_pp_clock_levels_with_voltage = {};
    pp_clks.num_levels = 2;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_pp_to_dc_clock_levels_voltage_caps_at_max(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_funcs_rv(test: *mut kunit) {
    ...
    KUNIT_EXPECT_TRUE(test, funcs.rv_funcs.set_wm_ranges != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, funcs.rv_funcs.set_pme_wa_enable != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, funcs.rv_funcs.set_display_count != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, funcs.rv_funcs.set_min_deep_sleep_dcfclk != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, funcs.rv_funcs.set_hard_min_dcfclk_by_freq != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, funcs.rv_funcs.set_hard_min_fclk_by_freq != core::ptr::null_mut());
    KUNIT_EXPECT_FALSE(test, funcs.rv_funcs.set_hard_min_socclk_by_freq != core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_funcs_rv_101(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_funcs_nv(test: *mut kunit) {
    ...
    KUNIT_EXPECT_TRUE(test, funcs.nv_funcs.set_display_count != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, funcs.nv_funcs.set_hard_min_dcfclk_by_freq != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, funcs.nv_funcs.set_min_deep_sleep_dcfclk != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, funcs.nv_funcs.set_voltage_by_freq != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, funcs.nv_funcs.set_wm_ranges != core::ptr::null_mut());
    KUNIT_EXPECT_FALSE(test, funcs.nv_funcs.set_pme_wa_enable != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, funcs.nv_funcs.set_hard_min_uclk_by_freq != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, funcs.nv_funcs.get_maximum_sustainable_clocks != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, funcs.nv_funcs.get_uclk_dpm_states != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, funcs.nv_funcs.set_pstate_handshake_support != core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_funcs_rn(test: *mut kunit) {
    ...
    KUNIT_EXPECT_TRUE(test, funcs.rn_funcs.set_wm_ranges != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, funcs.rn_funcs.get_dpm_clock_table != core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_funcs_unsupported(test: *mut kunit) {
    ...
    KUNIT_EXPECT_FALSE(test, funcs.rv_funcs.set_wm_ranges != core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_display_requirements_dpm_disabled(test: *mut kunit) {
    ...
    struct dc_context *ctx = kunit_kzalloc(test, sizeof(*ctx), GFP_KERNEL);
    let mut cfg: dm_pp_display_configuration = {};
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_clock_for_voltage_invalid_type(test: *mut kunit) {
    static void dm_test_apply_clock_for_voltage_invalid_type(struct kunit *test)
    {
    struct amdgpu_device *adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    struct dc_context *ctx = kunit_kzalloc(test, sizeof(*ctx), GFP_KERNEL);
    let mut req: dm_pp_clock_for_voltage_req = {};
    KUNIT_ASSERT_NOT_NULL(test, adev);
    KUNIT_ASSERT_NOT_NULL(test, ctx);
    ctx.driver_context = adev;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_build_pm_display_cfg_scalar_fields(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_build_pm_display_cfg_per_display(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_build_wm_clock_ranges_dmif(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_build_wm_clock_ranges_mcif(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cap_clock_levels_engine_caps(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cap_clock_levels_engine_first_exceeds(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cap_clock_levels_memory_caps(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cap_clock_levels_within_limit(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cap_clock_levels_other_type(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_clock_id_dispclk(test: *mut kunit) {
    static void dm_test_nv_clock_id_dispclk(struct kunit *test)
    {
    let mut clock_type: enum amd_pp_clock_type = amd_pp_mem_clock;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_clock_id_phyclk(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_clock_id_pixelclk(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_clock_id_invalid(test: *mut kunit) {
    static void dm_test_nv_clock_id_invalid(struct kunit *test)
    {
    let mut clock_type: enum amd_pp_clock_type = amd_pp_dcef_clock;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_display_requirements_dpm_enabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_clock_levels_by_type_dpm_error(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_clock_levels_by_type_success(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_clock_levels_by_type_validation_fallback(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_clock_levels_with_latency_success(test: *mut kunit) {
    static void dm_test_get_clock_levels_with_latency_success(struct kunit *test)
    {
    struct amdgpu_device *adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    struct dc_context *ctx = kunit_kzalloc(test, sizeof(*ctx), GFP_KERNEL);
    let mut info: dm_pp_clock_levels_with_latency = {};
    KUNIT_ASSERT_NOT_NULL(test, adev);
    KUNIT_ASSERT_NOT_NULL(test, ctx);
    setup_stub_dpm(test, adev);
    ctx.driver_context = adev;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_clock_levels_with_latency_failure(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_clock_levels_with_voltage_success(test: *mut kunit) {
    static void dm_test_get_clock_levels_with_voltage_success(struct kunit *test)
    {
    struct amdgpu_device *adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    struct dc_context *ctx = kunit_kzalloc(test, sizeof(*ctx), GFP_KERNEL);
    let mut info: dm_pp_clock_levels_with_voltage = {};
    KUNIT_ASSERT_NOT_NULL(test, adev);
    KUNIT_ASSERT_NOT_NULL(test, ctx);
    setup_stub_dpm(test, adev);
    ctx.driver_context = adev;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_clock_levels_with_voltage_failure(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_notify_wm_clock_changes_polaris(test: *mut kunit) {
    static void dm_test_notify_wm_clock_changes_polaris(struct kunit *test)
    {
    struct amdgpu_device *adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    struct dc_context *ctx = kunit_kzalloc(test, sizeof(*ctx), GFP_KERNEL);
    let mut wm: dm_pp_wm_sets_with_clock_ranges = {};
    KUNIT_ASSERT_NOT_NULL(test, adev);
    KUNIT_ASSERT_NOT_NULL(test, ctx);
    setup_stub_dpm(test, adev);
    ctx.driver_context = adev;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_notify_wm_clock_changes_non_polaris(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_clock_for_voltage_success(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_clock_for_voltage_eopnotsupp(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_clock_for_voltage_fail(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_display_count_ok(test: *mut kunit) {
    static void dm_test_nv_set_display_count_ok(struct kunit *test)
    {
    struct amdgpu_device *adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    struct dc_context *ctx = kunit_kzalloc(test, sizeof(*ctx), GFP_KERNEL);
    let mut pp_smu: pp_smu = {};
    KUNIT_ASSERT_NOT_NULL(test, adev);
    KUNIT_ASSERT_NOT_NULL(test, ctx);
    setup_stub_dpm(test, adev);
    ctx.driver_context = adev;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_display_count_unsupported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_display_count_fail(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_voltage_by_freq_ok(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_voltage_by_freq_invalid_id(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_pstate_handshake_ok(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_pstate_handshake_fail(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_rn_get_dpm_clock_table_ok(test: *mut kunit) {
    static void dm_test_rn_get_dpm_clock_table_ok(struct kunit *test)
    {
    struct amdgpu_device *adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    struct dc_context *ctx = kunit_kzalloc(test, sizeof(*ctx), GFP_KERNEL);
    let mut pp_smu: pp_smu = {};
    let mut clock_table: dpm_clocks = {};
    KUNIT_ASSERT_NOT_NULL(test, adev);
    KUNIT_ASSERT_NOT_NULL(test, ctx);
    setup_stub_dpm(test, adev);
    ctx.driver_context = adev;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_rn_get_dpm_clock_table_unsupported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_rn_get_dpm_clock_table_fail(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_rv_set_wm_ranges(test: *mut kunit) {
    static void dm_test_rv_set_wm_ranges(struct kunit *test)
    {
    struct amdgpu_device *adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    struct dc_context *ctx = kunit_kzalloc(test, sizeof(*ctx), GFP_KERNEL);
    let mut pp_smu: pp_smu = {};
    let mut ranges: pp_smu_wm_range_sets = {};
    KUNIT_ASSERT_NOT_NULL(test, adev);
    KUNIT_ASSERT_NOT_NULL(test, ctx);
    setup_stub_dpm(test, adev);
    ctx.driver_context = adev;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_rv_set_pme_wa_enable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_rv_set_active_display_count(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_rv_set_min_deep_sleep_dcfclk(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_rv_set_hard_min_dcefclk_by_freq(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_rv_set_hard_min_fclk_by_freq(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_wm_ranges(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_min_deep_sleep_dcfclk_ok(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_min_deep_sleep_dcfclk_unsupported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_min_deep_sleep_dcfclk_fail(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_hard_min_dcefclk_ok(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_hard_min_dcefclk_unsupported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_hard_min_dcefclk_fail(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_hard_min_uclk_ok(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_hard_min_uclk_unsupported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_set_hard_min_uclk_fail(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_get_max_sustainable_clocks_ok(test: *mut kunit) {
    static void dm_test_nv_get_max_sustainable_clocks_ok(struct kunit *test)
    {
    struct amdgpu_device *adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    struct dc_context *ctx = kunit_kzalloc(test, sizeof(*ctx), GFP_KERNEL);
    let mut pp_smu: pp_smu = {};
    let mut max_clocks: pp_smu_nv_clock_table = {};
    KUNIT_ASSERT_NOT_NULL(test, adev);
    KUNIT_ASSERT_NOT_NULL(test, ctx);
    setup_stub_dpm(test, adev);
    ctx.driver_context = adev;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_get_max_sustainable_clocks_unsupported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_get_max_sustainable_clocks_fail(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_get_uclk_dpm_states_ok(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_get_uclk_dpm_states_unsupported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_nv_get_uclk_dpm_states_fail(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_smu_write_watermarks_table_default(test: *mut kunit) {
