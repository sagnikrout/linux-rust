...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_irq_test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dm_test_irq_handler(arg: *mut c_void) {
    static void dm_test_irq_handler(void *arg)
    {
    }
#[no_mangle]
unsafe extern "C" fn dm_test_irq_handler_alt(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_dp_handle_automated_test(link: *mut dc_link) {
    static void dm_test_dp_handle_automated_test(struct dc_link *link)
    {
    dm_test_automated_test_count++;
    }
#[no_mangle]
unsafe extern "C" fn dm_test_dp_handle_link_loss(link: *mut dc_link) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_dp_should_allow_hpd_rx_irq_true(link: *const dc_link) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dm_test_sink_free(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_sink_release(sink: *mut dc_sink) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_allow_hpd_rx_irq_true(link: *const dc_link) -> bool {
    static bool dm_test_allow_hpd_rx_irq_true(const struct dc_link *link)
    {
    return true;
    }
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_get_outbox0_wptr(dmub: *mut dmub_srv) -> u32 {
    static uint32_t dm_test_dmub_get_outbox0_wptr(struct dmub_srv *dmub)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_get_outbox1_wptr(dmub: *mut dmub_srv) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn dm_test_free_irq_sources(data: *mut c_void) {
    ...
    adev.irq.client[i].sources = core::ptr::null_mut();
    }
    kfree(adev.crtc_irq.enabled_types);
    adev.crtc_irq.enabled_types = core::ptr::null_mut();
    kfree(adev.vline0_irq.enabled_types);
    adev.vline0_irq.enabled_types = core::ptr::null_mut();
    kfree(adev.vupdate_irq.enabled_types);
    adev.vupdate_irq.enabled_types = core::ptr::null_mut();
    kfree(adev.pageflip_irq.enabled_types);
    adev.pageflip_irq.enabled_types = core::ptr::null_mut();
    kfree(adev.dmub_outbox_irq.enabled_types);
    adev.dmub_outbox_irq.enabled_types = core::ptr::null_mut();
    kfree(adev.dmub_trace_irq.enabled_types);
    adev.dmub_trace_irq.enabled_types = core::ptr::null_mut();
    kfree(adev.hpd_irq.enabled_types);
    adev.hpd_irq.enabled_types = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_list_del(data: *mut c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_hpd_rx_wq_ctx {
    pub wq: *mut hpd_rx_irq_offload_work_queue,
    pub count: c_int,
}

#[no_mangle]
unsafe extern "C" fn dm_test_destroy_hpd_rx_wq(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_connector_cleanup(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_to_dal_irq_source_hpd1(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_to_dal_irq_source_hpd2(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_to_dal_irq_source_hpd3(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_to_dal_irq_source_hpd4(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_to_dal_irq_source_hpd5(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_to_dal_irq_source_hpd6(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_to_dal_irq_source_invalid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_to_dal_irq_source_out_of_range(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_are_sinks_equal_both_null(test: *mut kunit) {
    static void dm_test_are_sinks_equal_both_null(struct kunit *test)
    {
    KUNIT_EXPECT_FALSE(test, are_sinks_equal(core::ptr::null_mut(), core::ptr::null_mut()));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_are_sinks_equal_first_null(test: *mut kunit) {
    ...
    KUNIT_EXPECT_FALSE(test, are_sinks_equal(core::ptr::null_mut(), sink2));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_are_sinks_equal_second_null(test: *mut kunit) {
    ...
    KUNIT_EXPECT_FALSE(test, are_sinks_equal(sink1, core::ptr::null_mut()));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_are_sinks_equal_different_signal(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_are_sinks_equal_different_edid_length(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_are_sinks_equal_different_edid_data(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_are_sinks_equal_identical(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_are_sinks_equal_zero_length(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_are_sinks_equal_full_edid_identical(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_are_sinks_equal_full_edid_last_byte_differs(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_notification_str_no_data(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_notification_str_aux_reply(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_notification_str_hpd(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_notification_str_hpd_irq(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_notification_str_set_config(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_notification_str_dpia(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_notification_str_hpd_sense(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_notification_str_fused_io(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_notification_str_unknown(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_init_initializes_lists(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_register_rejects_null_params(test: *mut kunit) {
    static void dm_test_irq_register_rejects_null_params(struct kunit *test)
    {
    struct amdgpu_device *adev;
    let mut int_params: dc_interrupt_params = { 0 };
    adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, adev);
    int_params.int_context = INTERRUPT_LOW_IRQ_CONTEXT;
    int_params.irq_source = DC_IRQ_SOURCE_HPD1;
    KUNIT_EXPECT_NULL(test,
    amdgpu_dm_irq_register_interrupt(adev, core::ptr::null_mut(),
    dm_test_irq_handler, core::ptr::null_mut()));
    KUNIT_EXPECT_NULL(test,
    amdgpu_dm_irq_register_interrupt(adev, &int_params, core::ptr::null_mut(), core::ptr::null_mut()));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_register_rejects_invalid_context(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_register_rejects_invalid_source(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_register_adds_low_context_handler(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_register_adds_high_context_handler(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_register_multiple_handlers(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_register_separate_contexts(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_unregister_rejects_invalid_source(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_unregister_rejects_null_handler(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_unregister_handler_not_found(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_fini_removes_registered_handlers(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_fini_on_empty_tables(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_crtc_by_otg_inst_returns_match(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_crtc_by_otg_inst_returns_null(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_crtc_by_otg_inst_empty_list(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_irq_funcs(test: *mut kunit) {
    ...
    KUNIT_EXPECT_TRUE(test, adev.crtc_irq.funcs != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, adev.vline0_irq.funcs != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, adev.dmub_outbox_irq.funcs != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, adev.vupdate_irq.funcs != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, adev.dmub_trace_irq.funcs != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, adev.pageflip_irq.funcs != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, adev.hpd_irq.funcs != core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_suspend_empty(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_resume_early_empty(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_resume_late_empty(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_suspend_registered(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_suspend_disables_polling(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_resume_early_registered(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_resume_late_registered(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_resume_late_enables_polling(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_rx_irq_create_workqueue(test: *mut kunit) {
    ...
    KUNIT_EXPECT_TRUE(test, ctx.wq[i].wq != core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_rx_irq_work_suspend_null(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_rx_irq_work_suspend_flushes(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_crtc_irq_state_no_crtc(test: *mut kunit) {
...
// mode_info.crtcs[0] is NULL -> returns 0 without dereferencing DC.
    ...
    amdgpu_dm_set_crtc_irq_state(adev, core::ptr::null_mut(), 0, AMDGPU_IRQ_STATE_ENABLE), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_pflip_irq_state_no_crtc(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, adev);
    KUNIT_EXPECT_EQ(test,
    amdgpu_dm_set_pflip_irq_state(adev, core::ptr::null_mut(), 0, AMDGPU_IRQ_STATE_DISABLE), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_vline0_irq_state_no_crtc(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, adev);
    KUNIT_EXPECT_EQ(test,
    amdgpu_dm_set_vline0_irq_state(adev, core::ptr::null_mut(), 0, AMDGPU_IRQ_STATE_ENABLE), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_vupdate_irq_state_no_crtc(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, adev);
    KUNIT_EXPECT_EQ(test,
    amdgpu_dm_set_vupdate_irq_state(adev, core::ptr::null_mut(), 0, AMDGPU_IRQ_STATE_ENABLE), 0);
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_crtc_irq_state_otg_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_crtc_irq_state_enable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_pflip_irq_state_disable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_vline0_irq_state_enable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_vupdate_irq_state_enable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_crtc_irq_state_allows_idle(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_immediate_work_empty(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_immediate_work_invokes_handler(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_immediate_work_invokes_all(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_schedule_work_empty(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_schedule_work_queues_handler(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_schedule_work_requeue_fallback(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_hpd_irq_state_null_dc(test: *mut kunit) {
...
//
    KUNIT_EXPECT_EQ(test, amdgpu_dm_set_hpd_irq_state(adev, core::ptr::null_mut(), AMDGPU_HPD_1,
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_dmub_outbox_irq_state_null_dc(test: *mut kunit) {
    static void dm_test_set_dmub_outbox_irq_state_null_dc(struct kunit *test)
    {
    struct amdgpu_device *adev;
    adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, adev);
    KUNIT_EXPECT_EQ(test, amdgpu_dm_set_dmub_outbox_irq_state(adev, core::ptr::null_mut(), 0,
    AMDGPU_IRQ_STATE_ENABLE), 0);
    KUNIT_EXPECT_EQ(test, amdgpu_dm_set_dmub_outbox_irq_state(adev, core::ptr::null_mut(), 0,
    AMDGPU_IRQ_STATE_DISABLE), 0);
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_dmub_trace_irq_state_null_dc(test: *mut kunit) {
    static void dm_test_set_dmub_trace_irq_state_null_dc(struct kunit *test)
    {
    struct amdgpu_device *adev;
    adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, adev);
    KUNIT_EXPECT_EQ(test, amdgpu_dm_set_dmub_trace_irq_state(adev, core::ptr::null_mut(), 0,
    AMDGPU_IRQ_STATE_ENABLE), 0);
    KUNIT_EXPECT_EQ(test, amdgpu_dm_set_dmub_trace_irq_state(adev, core::ptr::null_mut(), 0,
    AMDGPU_IRQ_STATE_DISABLE), 0);
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_outbox_init_null_dc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_init_empty_connectors(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_fini_empty_connectors(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_init_fini_with_connectors(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_init_fini_analog_connector(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_init_fini_irq_ref(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_rx_offload_work_no_connector(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_rx_offload_work_no_connection(test: *mut kunit) {
    ...
    offload_wq = kunit_kzalloc(test, sizeof(*offload_wq), GFP_KERNEL);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, offload_wq);
    aconn = dm_kunit_alloc_connector(test, adev, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_rx_offload_work_automated_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hpd_rx_offload_work_link_loss(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdmi_hpd_debounce_detect_false(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdmi_hpd_debounce_reallow_idle(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_handle_hpd_irq_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_handle_hpd_irq_helper_debounce_schedule(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_handle_hpd_irq_helper_debounce_release_prev(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_handle_hpd_irq_helper_detect_false(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_handle_hpd_rx_irq_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_schedule_hpd_rx_offload_work(test: *mut kunit) {
    static void dm_test_schedule_hpd_rx_offload_work(struct kunit *test)
    {
    struct hpd_rx_irq_offload_work_queue *offload_wq;
    struct amdgpu_device *adev;
    let mut data: union hpd_irq_data = { 0 };
    adev = dm_kunit_alloc_adev(test);
    offload_wq = kunit_kzalloc(test, sizeof(*offload_wq), GFP_KERNEL);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, offload_wq);
...
#[no_mangle]
unsafe extern "C" fn dm_test_destroy_offload_wq(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_handle_hpd_rx_irq_no_left_work(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_handle_hpd_rx_irq_automated_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_handle_hpd_rx_irq_msg_rdy(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_handle_hpd_rx_irq_link_loss(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hpd_callback_null_inputs(test: *mut kunit) {
    static void dm_test_dmub_hpd_callback_null_inputs(struct kunit *test)
    {
    struct amdgpu_device *adev;
    adev = dm_kunit_alloc_adev(test);
    dmub_hpd_callback(core::ptr::null_mut(), core::ptr::null_mut());
    dmub_hpd_callback(adev, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hpd_callback_invalid_index(test: *mut kunit) {
    static void dm_test_dmub_hpd_callback_invalid_index(struct kunit *test)
    {
    let mut notify: dmub_notification = { 0 };
    struct amdgpu_device *adev;
    struct dc *dc;
    adev = dm_kunit_alloc_adev(test);
    dc = kunit_kzalloc(test, sizeof(*dc), GFP_KERNEL);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hpd_callback_empty_connectors(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hpd_callback_unknown_type_match(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hpd_callback_hpd_type(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hpd_callback_hpd_irq_type(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_register_hpd_handlers_empty(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_register_hpd_handlers_valid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_register_hpd_handlers_invalid_hpd(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_register_hpd_handlers_invalid_hpd_rx(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_register_hpd_handlers_dmub_outbox(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_pflip_high_irq_no_crtc(test: *mut kunit) {
    static void dm_test_pflip_high_irq_no_crtc(struct kunit *test)
    {
    let mut params: common_irq_params = { 0 };
    struct amdgpu_device *adev;
    adev = dm_kunit_alloc_adev(test);
    params.adev = adev;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_pflip_high_irq_not_submitted(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_vupdate_high_irq_no_crtc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_high_irq_no_crtc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_high_irq_vrr_pre_ai(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_high_irq_vrr_ai_no_stream(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_handle_hpd_work_out_of_range(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_outbox1_low_irq_empty(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_outbox1_low_irq_no_handler(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_outbox1_low_irq_direct_callback(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_outbox1_low_irq_offload(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dce110_register_irq_handlers_rejects_uninitialized_sources(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dce110_register_irq_handlers_one_crtc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dcn10_register_irq_handlers_zero_crtc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dcn10_register_irq_handlers_one_crtc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_register_outbox_irq_handlers_without_dmub(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_register_outbox_irq_handlers_with_dmub(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_irq_handler_dispatches_work(test: *mut kunit) {
    static void dm_test_irq_handler_dispatches_work(struct kunit *test)
    {
    let mut int_params: dc_interrupt_params = { 0 };
    let mut entry: amdgpu_iv_entry = { 0 };
    struct amdgpu_device *adev;
    let mut high_count: c_int = 0;
    let mut low_count: c_int = 0;
    void *handler;
    struct dc *dc;
    adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, adev);
...
// src_id maps to DC_IRQ_SOURCE_VBLANK1 via the dce110 stub.
    ...
    entry.src_data[0] = 0;
    KUNIT_EXPECT_EQ(test, amdgpu_dm_irq_handler(adev, core::ptr::null_mut(), &entry), 0);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_handle_vmin_vmax_update(test: *mut kunit) {
