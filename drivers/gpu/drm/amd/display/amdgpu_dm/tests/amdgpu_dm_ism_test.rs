...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_ism_test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_running_enter_idle(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_running_begin_cursor(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_running_invalid(test: *mut kunit) {
    static void dm_test_ism_next_state_running_invalid(struct kunit *test)
    {
    let mut next: enum amdgpu_dm_ism_state = DM_ISM_NUM_STATES;
    bool ok;
    ok = dm_ism_next_state(DM_ISM_STATE_FULL_POWER_RUNNING,
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_busy_enter_idle(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_busy_end_cursor(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_hyst_wait_exit_idle(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_hyst_wait_begin_cursor(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_hyst_wait_timer(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_hyst_wait_immediate(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_hyst_busy_exit_idle(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_hyst_busy_end_cursor(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_opt_idle_exit(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_opt_idle_begin_cursor(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_opt_idle_sso_timer(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_opt_idle_immediate(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_opt_idle_sso_exit(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_opt_idle_sso_cursor(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_aborted_immediate(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_next_state_aborted_invalid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_sso_delay_null_stream(test: *mut kunit) {
    ...
    KUNIT_EXPECT_EQ(test, dm_ism_get_sso_delay(ism, core::ptr::null_mut()), (uint64_t)0);
    }
#[no_mangle]
unsafe extern "C" fn dm_test_ism_sso_delay_zero_frames(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_sso_delay_1080p60_3frames(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_sso_delay_4k60_1frame(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_idle_delay_null_stream(test: *mut kunit) {
    ...
    KUNIT_EXPECT_EQ(test, dm_ism_get_idle_allow_delay(ism, core::ptr::null_mut()),
    (uint64_t)0);
    }
#[no_mangle]
unsafe extern "C" fn dm_test_ism_idle_delay_zero_filter_frames(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_idle_delay_zero_entry_count(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_idle_delay_zero_delay_frames(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_idle_delay_no_short_idles(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_idle_delay_enough_short_idles(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_idle_delay_wraps_around_buffer(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_idle_delay_old_history_cutoff(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_ism_idle_delay_mixed_durations(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ism_idle_delay_entry_count_exceeds_history_size(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ism_init_sets_initial_state(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ism_fini_after_init(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ism_set_last_idle_ts_updates_timestamp(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ism_insert_record_basic(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ism_insert_record_wraps_around(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ism_trigger_event_valid_transition(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ism_trigger_event_invalid_transition(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dispatch_next_event_hyst_wait_no_delay(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dispatch_next_event_hyst_wait_with_delay(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dispatch_next_event_opt_idle_no_sso_delay(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dispatch_next_event_opt_idle_with_sso_delay(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dispatch_next_event_timer_aborted(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dispatch_next_event_no_action_state(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ism_commit_event_cursor_transition(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ism_commit_event_invalid_event(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ism_force_full_power(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ism_disable_enable_cycle(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ism_dispatch_hysteresis_schedule_and_cancel(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ism_dispatch_optimized_idle_defers_sso(test: *mut kunit) {
