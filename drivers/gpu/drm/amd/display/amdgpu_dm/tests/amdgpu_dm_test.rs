...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_test.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_is_idle(test: *mut kunit) {
    static void dm_test_is_idle(struct kunit *test)
    {
    KUNIT_EXPECT_TRUE(test, dm_is_idle(core::ptr::null_mut()));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_wait_for_idle(test: *mut kunit) {
    static void dm_test_wait_for_idle(struct kunit *test)
    {
    KUNIT_EXPECT_EQ(test, dm_wait_for_idle(core::ptr::null_mut()), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_soft_reset(test: *mut kunit) {
    static void dm_test_soft_reset(struct kunit *test)
    {
    KUNIT_EXPECT_EQ(test, dm_soft_reset(core::ptr::null_mut()), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_clockgating_state(test: *mut kunit) {
    static void dm_test_set_clockgating_state(struct kunit *test)
    {
    KUNIT_EXPECT_EQ(test, dm_set_clockgating_state(core::ptr::null_mut(), AMD_CG_STATE_GATE), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_powergating_state(test: *mut kunit) {
    static void dm_test_set_powergating_state(struct kunit *test)
    {
    KUNIT_EXPECT_EQ(test, dm_set_powergating_state(core::ptr::null_mut(), AMD_PG_STATE_GATE), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_bandwidth_update(test: *mut kunit) {
    static void dm_test_bandwidth_update(struct kunit *test)
    {
    dm_bandwidth_update(core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_complete_writeback_no_connector(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_complete_writeback_not_pending(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_vblank_get_counter_out_of_range(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_vblank_get_counter_no_stream(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_get_scanoutpos_invalid_crtc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_get_scanoutpos_no_stream(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_atomic_get_new_state_empty(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_atomic_get_new_state_match(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_atomic_destroy_state_no_context(test: *mut kunit) {
...
// context == NULL: dc_state_release() is skipped and the state is freed.
    dm_atomic_destroy_state(core::ptr::null_mut(), &dm_state.base);
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_plane_layer_index_cmp_equal(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_plane_layer_index_cmp_descending(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_plane_layer_index_cmp_ascending(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_color_attr_rgb_format(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_color_attr_bt601_full(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_color_attr_bt601_limited(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_color_attr_bt709_full(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_color_attr_bt709_limited(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_color_attr_bt2020_full(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_color_attr_bt2020_limited(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_color_attr_invalid_encoding(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_modereset_required_when_inactive_and_modeset(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_modereset_not_required_when_active_and_modeset(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_modereset_not_required_when_inactive_without_modeset(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_scaling_state_same(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_scaling_state_scaling_changed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_scaling_state_underscan_enabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_scaling_state_underscan_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_scaling_state_underscan_border_changed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_multisync_trigger_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_multisync_trigger_rising(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_multisync_trigger_falling(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_master_stream_highest_refresh(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_master_stream_defaults_to_first(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_cp_ctx {
    pub aconnector: *mut amdgpu_dm_connector,
    pub /: *mut *mut *mut dm_connector_state new_dm; / also connector->state,
    pub old_dm: *mut dm_connector_state,
    pub new_crtc: *mut drm_crtc_state,
    pub old_crtc: *mut drm_crtc_state,
}
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cp_diff_hdcp_type_change(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cp_diff_reenable_mode_changed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cp_diff_reenable_no_change(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cp_diff_undesired(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cp_diff_desired_mode_changed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cp_diff_desired_no_change(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cp_diff_update_hdcp_hotplug(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cp_diff_stream_reenabled(test: *mut kunit) {
    ...
    ctx.new_dm.base.content_protection = DRM_MODE_CONTENT_PROTECTION_DESIRED;
    ctx.new_dm.update_hdcp = true;
    ctx.old_dm.base.crtc = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cp_diff_s3_undesired_to_enabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cp_diff_desired_to_enabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cp_diff_desired_to_undesired(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_per_frame_master_sync_single_stream(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_per_frame_master_sync_two_streams(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_per_frame_master_sync_skips_null_stream(test: *mut kunit) {
    ...
    context.streams[0] = stream;
    context.streams[1] = core::ptr::null_mut();
    context.stream_count = 2;
    dm_enable_per_frame_crtc_master_sync(context);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_delay_null_sink(test: *mut kunit) {
    static void dm_test_apply_delay_null_sink(struct kunit *test)
    {
// NULL sink: early return, no delay, no dereference
    amdgpu_dm_apply_delay_after_dpcd_poweroff(core::ptr::null_mut(), core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_delay_zero_wait(test: *mut kunit) {
...
// wait == 0: no msleep, adev is unused so NULL is safe
    ...
    amdgpu_dm_apply_delay_after_dpcd_poweroff(core::ptr::null_mut(), sink);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_apply_delay_nonzero_wait(test: *mut kunit) {
