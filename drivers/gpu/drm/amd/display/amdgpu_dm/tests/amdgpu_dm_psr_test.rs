...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_psr_test.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_link_supports_psrsu_no_dmcub(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_link_supports_psrsu_old_dcn(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_link_supports_psrsu_panel_unsupported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_link_supports_psrsu_missing_alpm(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_link_supports_psrsu_missing_y_coordinate(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_link_supports_psrsu_missing_granularity(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_link_supports_psrsu_debug_mask_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_link_supports_psrsu_temporarily_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_psr_caps_null_link(test: *mut kunit) {
    ...
    KUNIT_EXPECT_FALSE(test, amdgpu_dm_set_psr_caps(core::ptr::null_mut(), aconnector));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_psr_caps_null_connector(test: *mut kunit) {
    static void dm_test_set_psr_caps_null_connector(struct kunit *test)
    {
    struct dc_link *link = alloc_test_psr_caps_link(test);
    KUNIT_EXPECT_FALSE(test, amdgpu_dm_set_psr_caps(link, core::ptr::null_mut()));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_psr_caps_no_dmub_psr(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_psr_caps_non_edp(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_psr_caps_disconnected(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_psr_caps_no_dpcd_psr(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_psr_caps_edp1_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_psr_caps_success_psr1(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_psr_fill_caps_version_1(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_psr_fill_caps_version_su1(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_psr_fill_caps_version_unsupported(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_psr_fill_caps_setup_time_zero(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_psr_fill_caps_setup_time_mid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_psr_fill_caps_setup_time_max(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_psr_fill_caps_link_training_required(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_psr_fill_caps_link_training_not_required(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_psr_fill_caps_dpcd_fields(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_psr_fill_caps_dpcd_fields_unset(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_psr_fill_caps_rate_control_always_zero(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_psr_fill_caps_power_opts_z10_always_set(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_psr_fill_caps_power_opts_smu_opt_set(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_psr_set_event_null_stream(test: *mut kunit) {
    static void dm_test_psr_set_event_null_stream(struct kunit *test)
    {
// NULL stream → immediate false, dm is not accessed
    KUNIT_EXPECT_FALSE(test, amdgpu_dm_psr_set_event(core::ptr::null_mut(), core::ptr::null_mut(), true, psr_event_vsync, false));
    }
#[no_mangle]
unsafe extern "C" fn dm_test_psr_set_event_null_link(test: *mut kunit) {
...
// stream->link remains NULL from kzalloc
    KUNIT_EXPECT_FALSE(test, amdgpu_dm_psr_set_event(core::ptr::null_mut(), stream, true, psr_event_vsync, false));
    }
#[no_mangle]
unsafe extern "C" fn dm_test_psr_set_event_psr_not_enabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_psr_set_event_get_event_fails(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_psr_set_event_already_set(test: *mut kunit) {
    static void dm_test_psr_set_event_already_set(struct kunit *test)
    {
    struct amdgpu_display_manager *dm = dm_kunit_alloc_dm(test);
    struct dc_stream_state *stream = alloc_test_psr_stream(test);
    let mut caps: psr_caps = {0};
    struct core_power *core_power;
    caps.psr_version = 1;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_psr_set_event_updates_event(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_psr_is_active_allowed_no_streams(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_psr_is_active_allowed_null_link(test: *mut kunit) {
    static void dm_test_psr_is_active_allowed_null_link(struct kunit *test)
    {
    struct amdgpu_display_manager *dm = dm_kunit_alloc_dm(test);
    struct dc_state *state = dm.dc.current_state;
    dm_kunit_add_stream_to_state(test, state, 0, core::ptr::null_mut());
    KUNIT_EXPECT_FALSE(test, amdgpu_dm_psr_is_active_allowed(dm));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_psr_is_active_allowed_requires_enabled_and_allowed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_psr_is_active_allowed_any_stream(test: *mut kunit) {
