...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_dmub_test.c
#![no_std]
...
pub const DM_TEST_FW_SIZE: c_int = 512;
...
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_supported(dmub: *mut dmub_srv) -> bool {
    static bool dm_test_dmub_supported(struct dmub_srv *dmub)
    {
    return true;
    }
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_unsupported(dmub: *mut dmub_srv) -> bool {
    static bool dm_test_dmub_unsupported(struct dmub_srv *dmub)
    {
    return false;
    }
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_initialized(dmub: *mut dmub_srv) -> bool {
    static bool dm_test_dmub_hw_initialized(struct dmub_srv *dmub)
    {
    return true;
    }
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_fw_ready(dmub: *mut dmub_srv) -> union dmub_fw_boot_status {
    static union dmub_fw_boot_status dm_test_dmub_fw_ready(struct dmub_srv *dmub)
    {
    let mut status: union dmub_fw_boot_status = { 0 };
    status.bits.dal_fw = 1;
    status.bits.mailbox_rdy = 1;
    return status;
    }
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_fw_not_ready(dmub: *mut dmub_srv) -> union dmub_fw_boot_status {
...
#[no_mangle]
unsafe extern "C" fn dm_test_dmcu_init(dmcu: *mut dmcu) -> bool {
    static bool dm_test_dmcu_init(struct dmcu *dmcu)
    {
    return true;
    }
#[no_mangle]
unsafe extern "C" fn dm_test_dmcu_is_initialized(dmcu: *mut dmcu) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_register_dmub_notify_callback_null_callback(test: *mut kunit) {
    ...
    DMUB_NOTIFICATION_AUX_REPLY, core::ptr::null_mut(), false));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_register_dmub_notify_callback_type_out_of_range(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_register_dmub_notify_callback_valid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_register_dmub_notify_callback_offload_false(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_aux_setconfig_callback_copies_and_completes(test: *mut kunit) {
    static void dm_test_dmub_aux_setconfig_callback_copies_and_completes(struct kunit *test)
    {
    struct amdgpu_device *adev;
    struct dmub_notification *dm_notify;
    let mut notify: dmub_notification = {};
    adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, adev);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_aux_setconfig_callback_non_aux_no_complete(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_aux_setconfig_callback_aux_with_null_dm_notify(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, adev);
    init_completion(&adev.dm.dmub_aux_transfer_done);
    adev.dm.dmub_notify = core::ptr::null_mut();
    notify.type = DMUB_NOTIFICATION_AUX_REPLY;
    dm_dmub_aux_setconfig_callback(adev, &notify);
    KUNIT_EXPECT_TRUE(test, completion_done(&adev.dm.dmub_aux_transfer_done));
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_aux_setconfig_callback_set_config_reply(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_aux_fused_io_callback_copies_reply_and_completes(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_aux_fused_io_callback_max_ddc_line(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_aux_fused_io_callback_null_args(test: *mut kunit) {
...
// Must not crash; guard hits ASSERT (WARN_ON_ONCE) and returns.
    dm_dmub_aux_fused_io_callback(core::ptr::null_mut(), &notify);
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_default_ips_mode_dcn35(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_default_ips_mode_dcn351(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_default_ips_mode_dcn36(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_default_ips_mode_older_than_dcn35(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_default_ips_mode_newer_default(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_init_no_fb_info(test: *mut kunit) {
    ...
    adev.dm.dmub_fb_info = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_init_no_firmware(test: *mut kunit) {
    ...
    adev.dm.dmub_srv = dmub_srv;
    adev.dm.dmub_fb_info = fb_info;
    adev.dm.dmub_fw = core::ptr::null_mut();
    KUNIT_EXPECT_EQ(test, dm_dmub_hw_init(adev), -EINVAL);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_init_success_fake_dmub(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_init_no_hw_support(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_init_bss_data(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_init_hw_init_fails(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_init_auto_load_timeout(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_init_apu_dpia_dcn35(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_init_sanity_checks_dcn31(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_init_sanity_checks_dcn314(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_init_dmcu_abm(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_resume_no_dmub_srv(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_resume_initialized_dmub(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_resume_full_init(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_resume_init_check_failed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_hw_resume_auto_load_timeout(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_sw_init_unsupported_asic(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_init_microcode_unsupported_asic(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_dmub_get_vbios_bounding_box_default_null(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_execute_dmub_cmd_null_dmub_srv(test: *mut kunit) {
    ...
    ctx.driver_context = adev;
    ctx.dmub_srv = core::ptr::null_mut();
    KUNIT_EXPECT_FALSE(test,
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_process_dmub_aux_transfer_sync_engine_acquire(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_process_dmub_aux_transfer_sync_protocol_error(test: *mut kunit) {
    ...
    dc_ctx.dmub_srv = core::ptr::null_mut();
    ctx.dc = dc;
    ctx.driver_context = adev;
    spin_lock_init(&adev.dm.dmub_lock);
    adev.dm.dmub_notify = notify;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_process_dmub_aux_transfer_sync_copies_data(test: *mut kunit) {
    ...
    struct aux_payload *payload;
    struct dmub_notification *notify;
    let mut result: enum aux_return_code_type = AUX_RET_ERROR_UNKNOWN;
    u8 data[4] = { 0 };
    let mut reply: u8 = 0;
    int ret;
    adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_process_dmub_aux_transfer_sync_zero_length(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_process_dmub_set_config_sync_unknown_error(test: *mut kunit) {
    ...
    struct dmub_notification *notify;
    let mut result: enum set_config_status = SET_CONFIG_PENDING;
    int ret;
    adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, adev);
    ctx = kunit_kzalloc(test, sizeof(*ctx), GFP_KERNEL);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_abort_fused_io_no_dmub_srv(test: *mut kunit) {
