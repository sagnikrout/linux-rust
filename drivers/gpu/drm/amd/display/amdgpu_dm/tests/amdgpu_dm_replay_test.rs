...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_replay_test.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn set_all_replay_caps(ctx: *mut replay_test_ctx) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_replay_supports_all_caps(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_replay_no_freesync(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_replay_no_vsdb_replay_mode(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_replay_edp_rev_too_low(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_replay_no_alpm_aux_wake(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_replay_no_adaptive_sync_sdp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_replay_zero_pixel_deviation(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_replay_zero_max_deviation_line(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_replay_both_deviations_zero(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_set_caps_already_supported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_set_caps_non_embedded_signal(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_set_caps_disallowed_by_panel(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_set_caps_link_not_supported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_set_caps_missing_dmub_srv(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_set_caps_success(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_link_setup_null_stream(test: *mut kunit) {
    static void dm_test_replay_link_setup_null_stream(struct kunit *test)
    {
    let mut vrr_params: mod_vrr_params = { 0 };
    KUNIT_EXPECT_FALSE(test, amdgpu_dm_link_setup_replay(core::ptr::null_mut(), &vrr_params));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_link_setup_null_link(test: *mut kunit) {
    static void dm_test_replay_link_setup_null_link(struct kunit *test)
    {
    struct replay_test_ctx *ctx = alloc_replay_ctx(test);
    let mut vrr_params: mod_vrr_params = { 0 };
    ctx.stream.link = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_link_setup_null_vrr_params(test: *mut kunit) {
    static void dm_test_replay_link_setup_null_vrr_params(struct kunit *test)
    {
    struct replay_test_ctx *ctx = alloc_replay_ctx(test);
    KUNIT_EXPECT_FALSE(test, amdgpu_dm_link_setup_replay(ctx.stream, core::ptr::null_mut()));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_link_setup_not_supported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_link_setup_already_enabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_link_setup_success(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_set_event_null_stream(test: *mut kunit) {
    ...
    KUNIT_EXPECT_FALSE(test, amdgpu_dm_replay_set_event(dm, core::ptr::null_mut(), true,
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_set_event_null_link(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_set_event_feature_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_set_event_missing_power_module(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_set_event_already_set(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_replay_set_event_already_clear(test: *mut kunit) {
