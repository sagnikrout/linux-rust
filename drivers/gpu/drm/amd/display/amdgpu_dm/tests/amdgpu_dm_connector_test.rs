...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_connector_test.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_subconnector_type_none(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_subconnector_type_vga(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_subconnector_type_dvi_converter(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_subconnector_type_dvi_dongle(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_subconnector_type_hdmi_converter(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_subconnector_type_hdmi_dongle(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_subconnector_type_mismatched(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_subconnector_type_default_unknown(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_content_type_no_data(test: *mut kunit) {
    static void dm_test_content_type_no_data(struct kunit *test)
    {
    let mut state: drm_connector_state = {};
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_content_type_graphics(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_content_type_photo(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_content_type_cinema(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_content_type_game(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_content_type_unknown_defaults_no_data(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_adjust_colour_depth_fits_at_888(test: *mut kunit) {
    static void dm_test_adjust_colour_depth_fits_at_888(struct kunit *test)
    {
    let mut timing: dc_crtc_timing = {};
    let mut info: drm_display_info = {};
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_adjust_colour_depth_reduces_to_888(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_adjust_colour_depth_10bpc_passes(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_adjust_colour_depth_420_halves_clk(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_adjust_colour_depth_420_reduces(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_adjust_colour_depth_reduces_12bpc_to_10bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_adjust_colour_depth_16bpc_no_fallback(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_adjust_colour_depth_none_fits(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_adjust_colour_depth_invalid_depth(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_default_rgb_full(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_default_rgb_limited(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_default_ycbcr709(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_default_ycbcr601_limited(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_bt601_y_only(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_bt601(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_bt709(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_bt709_y_only(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_oprgb(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_bt2020_rgb(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_bt2020_ycc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_default_ycbcr709_y_only(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_default_ycbcr601(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_bt2020_ycc_rgb_encoding(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_output_color_space_bt2020_rgb_ycc_encoding(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_convert_color_depth_bpc_mappings(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_convert_color_depth_bpc_unknown(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_color_depth_from_info_bpc8(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_color_depth_from_info_bpc10(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_color_depth_from_info_zero_bpc_defaults_888(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_color_depth_from_info_requested_bpc_caps(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_color_depth_from_info_y420_default(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_color_depth_from_info_y420_10bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_color_depth_from_info_y420_12bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_color_depth_from_info_y420_16bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_color_depth_from_info_requested_odd_bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_color_depth_from_info_unsupported_bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_to_connector_type_hdmi(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_to_connector_type_edp(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_to_connector_type_lvds(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_to_connector_type_rgb(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_to_connector_type_dp(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_to_connector_type_dp_mst(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_to_connector_type_dvi_dvii(test: *mut kunit) {
    static void dm_test_to_connector_type_dvi_dvii(struct kunit *test)
    {
    let mut type: c_int = to_drm_connector_type(SIGNAL_TYPE_DVI_SINGLE_LINK, CONNECTOR_ID_SINGLE_LINK_DVII);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_to_connector_type_dual_link_dvii(test: *mut kunit) {
    static void dm_test_to_connector_type_dual_link_dvii(struct kunit *test)
    {
    let mut type: c_int = to_drm_connector_type(SIGNAL_TYPE_DVI_DUAL_LINK, CONNECTOR_ID_DUAL_LINK_DVII);
    KUNIT_EXPECT_EQ(test, type, DRM_MODE_CONNECTOR_DVII);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_to_connector_type_dvi_dvid(test: *mut kunit) {
    static void dm_test_to_connector_type_dvi_dvid(struct kunit *test)
    {
    let mut type: c_int = to_drm_connector_type(SIGNAL_TYPE_DVI_SINGLE_LINK, CONNECTOR_ID_SINGLE_LINK_DVID);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_to_connector_type_dual_link_dvid(test: *mut kunit) {
    static void dm_test_to_connector_type_dual_link_dvid(struct kunit *test)
    {
    let mut type: c_int = to_drm_connector_type(SIGNAL_TYPE_DVI_DUAL_LINK, CONNECTOR_ID_DUAL_LINK_DVID);
    KUNIT_EXPECT_EQ(test, type, DRM_MODE_CONNECTOR_DVID);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_to_connector_type_virtual(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_to_connector_type_unknown(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_is_duplicate_mode_empty_list(test: *mut kunit) {
    static void dm_test_is_duplicate_mode_empty_list(struct kunit *test)
    {
    struct amdgpu_dm_connector *aconnector;
    let mut mode: drm_display_mode = {};
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_is_duplicate_mode_match(test: *mut kunit) {
    static void dm_test_is_duplicate_mode_match(struct kunit *test)
    {
    struct amdgpu_dm_connector *aconnector;
    let mut existing: drm_display_mode = {};
    let mut candidate: drm_display_mode = {};
    aconnector = kunit_kzalloc(test, sizeof(*aconnector), GFP_KERNEL);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, aconnector);
    INIT_LIST_HEAD(&aconnector.base.probed_modes);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_is_duplicate_mode_no_match(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_is_duplicate_mode_same_size_different_clock(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_encoder_crtc_mask_1(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_encoder_crtc_mask_2(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_encoder_crtc_mask_3(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_encoder_crtc_mask_4(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_encoder_crtc_mask_5(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_encoder_crtc_mask_6(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_encoder_crtc_mask_default(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_aspect_ratio_no_data(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_aspect_ratio_4_3(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_aspect_ratio_16_9(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_aspect_ratio_64_27(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_aspect_ratio_256_135(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_copy_crtc_timing_copies_all_fields(test: *mut kunit) {
    static void dm_test_copy_crtc_timing_copies_all_fields(struct kunit *test)
    {
    let mut src: drm_display_mode = {};
    let mut dst: drm_display_mode = {};
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_copy_crtc_timing_leaves_non_crtc_fields(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_decide_crtc_timing_scale_enabled(test: *mut kunit) {
    static void dm_test_decide_crtc_timing_scale_enabled(struct kunit *test)
    {
    let mut drm_mode: drm_display_mode = {};
    let mut native_mode: drm_display_mode = {};
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_decide_crtc_timing_matching_mode(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_decide_crtc_timing_no_copy(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_decide_crtc_timing_no_crtc_clock(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_funcs_reset_sets_defaults(test: *mut kunit) {
    ...
    DRM_MODE_CONNECTOR_DisplayPort, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_funcs_reset_edp_abm_level(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_funcs_reset_edp_abm_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_atomic_dup_state_copies_fields(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_NULL(test, connector);
    drmm_connector_init(drm, connector, &dm_test_connector_funcs,
    DRM_MODE_CONNECTOR_HDMIA, core::ptr::null_mut());
    amdgpu_dm_connector_funcs_reset(connector);
    KUNIT_ASSERT_NOT_NULL(test, connector.state);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_hdr_null_metadata(test: *mut kunit) {
    static void dm_test_fill_hdr_null_metadata(struct kunit *test)
    {
    let mut state: drm_connector_state = {};
    let mut out: dc_info_packet = {};
// No hdr_output_metadata → early return 0, out stays zeroed
    state.hdr_output_metadata = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_hdr_zeroes_output(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_prop_ctx {
    pub adev: *mut amdgpu_device,
    pub connector: *mut drm_connector,
    pub old_state: *mut dm_connector_state,
    pub new_state: *mut dm_connector_state,
    pub scaling_prop: *mut drm_property,
    pub hborder_prop: *mut drm_property,
    pub vborder_prop: *mut drm_property,
    pub underscan_prop: *mut drm_property,
    pub abm_prop: *mut drm_property,
}
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_property_scaling_center(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_property_scaling_aspect(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_property_scaling_fullscreen(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_property_scaling_none(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_property_scaling_unchanged(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_property_underscan_hborder(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_property_underscan_vborder(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_property_underscan_enable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_property_abm_sysfs_control(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_property_abm_level_off(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_property_abm_level_value(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_property_unknown(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_property_scaling_center(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_property_scaling_aspect(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_property_scaling_full(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_property_scaling_off(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_property_underscan_borders(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_property_abm_sysfs_allowed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_property_abm_level(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_property_abm_disabled_zero(test: *mut kunit) {
    static void dm_test_get_property_abm_disabled_zero(struct kunit *test)
    {
    struct dm_test_prop_ctx *ctx = dm_test_prop_ctx_alloc(test);
    let mut val: u64 = 0xdead;
    ctx.new_state.abm_sysfs_forbidden = true;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_property_unknown(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_highest_refresh_writeback_null(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_highest_refresh_cached_base(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_highest_refresh_preferred_mode(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_is_freesync_video_mode_null_mode(test: *mut kunit) {
    ...
    aconnector.base.connector_type = DRM_MODE_CONNECTOR_HDMIA;
    aconnector.freesync_vid_base.clock = 148500;
    KUNIT_EXPECT_FALSE(test, amdgpu_dm_is_freesync_video_mode(core::ptr::null_mut(), aconnector));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_is_freesync_video_mode_match(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_is_freesync_video_mode_no_match(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cacp_caps_unsupported_ip(test: *mut kunit) {
    static void dm_test_cacp_caps_unsupported_ip(struct kunit *test)
    {
    let mut fixture: dm_cacp_fixture = {};
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cacp_caps_excluded_ip_316(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cacp_caps_edp_oled_supported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cacp_caps_lvds_oled_supported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cacp_caps_non_edp_signal(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cacp_caps_lcd_panel(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_panel_type_fixture {
    pub adev: *mut amdgpu_device,
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_panel_type_vsdb_oled(test: *mut kunit) {
    static void dm_test_set_panel_type_vsdb_oled(struct kunit *test)
    {
    let mut fixture: dm_panel_type_fixture = {};
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_panel_type_vsdb_miniled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_panel_type_dpcd_oled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_panel_type_dpcd_miniled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_panel_type_did_oled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_panel_type_did_lcd(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_panel_type_vendor_lum_heuristic(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_panel_type_defaults_to_lcd(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_subconnector_dp_with_sink(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_subconnector_dp_no_sink(test: *mut kunit) {
...
// Dongle type is set, but no sink means it must not be consulted
    link.dpcd_caps.dongle_type = DISPLAY_DONGLE_DP_HDMI_CONVERTER;
    aconnector.dc_link = link;
    aconnector.dc_sink = core::ptr::null_mut();
    update_subconnector_property(aconnector);
    KUNIT_EXPECT_EQ(test, drm_object_property_get_value(&aconnector.base.base,
    aconnector.base.dev.mode_config.dp_subconnector_property,
    &val), 0);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_subconnector_non_dp_noop(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fbc_init_non_edp(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fbc_init_already_allocated(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fbc_init_no_modes(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_detect_mst_no_connectors(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_detect_mst_skips_writeback(test: *mut kunit) {
...
// dc_link intentionally left NULL: it must not be touched
    aconnector.dc_link = core::ptr::null_mut();
    KUNIT_EXPECT_EQ(test,
    amdgpu_dm_detect_mst_link_for_all_connectors(drm), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_detect_mst_non_mst_link(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_detect_mst_branch_without_aux(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_find_first_crtc_match(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_find_first_crtc_no_match(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_find_first_crtc_empty_state(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_find_first_crtc_skips_null_ptr(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_find_first_crtc_returns_first(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_panel_ctx {
    pub adev: *mut amdgpu_device,
    pub drm: *mut drm_device,
    pub aconnector: *mut amdgpu_dm_connector,
    pub link: *mut dc_link,
    pub display_info: *mut drm_display_info,
}
...
// The function under test writes through this property.
    ...
    DRM_MODE_CONNECTOR_eDP, core::ptr::null_mut()), 0);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_panel_type_samsung_miniled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_panel_type_samsung_below_threshold(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_set_panel_type_default_lcd(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cacp_caps_edp_supported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cacp_caps_lvds_supported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cacp_caps_old_ip_unsupported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cacp_caps_ip_3_1_6_unsupported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cacp_caps_non_edp_lvds_unsupported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_cacp_caps_lcd_unsupported(test: *mut kunit) {
...
pub struct dm_test_fill_ctx {
    ...
    drmm_connector_init(ctx.drm, &ctx.aconnector.base,
    &dm_test_connector_funcs,
    DRM_MODE_CONNECTOR_DisplayPort, core::ptr::null_mut()), 0);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_stream_borders_zeroed(test: *mut kunit) {
...
// Pre-seed nonzero borders to prove they get reset.
    ...
    &ctx.aconnector.base, ctx.conn_state, core::ptr::null_mut(), 8,
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_stream_rgb_defaults(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_stream_sync_polarity_positive(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_stream_sync_polarity_negative(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_stream_inherits_old_stream(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_stream_timing_from_crtc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_stream_color_depth_requested_bpc(test: *mut kunit) {
    ...
    fill_stream_properties_from_drm_display_mode(ctx.stream, ctx.mode,
    &ctx.aconnector.base, ctx.conn_state, core::ptr::null_mut(), 10,
    PIXEL_ENCODING_RGB, false);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_stream_content_type(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_stream_aspect_ratio(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_stream_encoding_from_caller_ycbcr420(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_stream_encoding_from_caller_ycbcr422(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_stream_encoding_from_caller_ycbcr444(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_stream_hdmi_ep_clamps_depth(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_fill_stream_non_hdmi_ep_keeps_depth(test: *mut kunit) {
...
pub struct dm_test_stream_ctx {
    ...
    ctx.link.connector_signal = SIGNAL_TYPE_DISPLAY_PORT;
    ctx.aconnector.dc_link = ctx.link;
    ctx.aconnector.dc_sink = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_create_stream_fake_sink_success(test: *mut kunit) {
    ...
    ctx.dm_state, core::ptr::null_mut(), 8,
    PIXEL_ENCODING_RGB, false);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_create_stream_sets_dm_context(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_create_stream_virtual_signal(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_create_stream_scaling_src(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_create_stream_existing_sink(test: *mut kunit) {
    static void dm_test_create_stream_existing_sink(struct kunit *test)
    {
    struct dm_test_stream_ctx *ctx = dm_test_stream_ctx_alloc(test);
    let mut sink_init: dc_sink_init_data = { 0 };
    struct dc_stream_state *stream;
    struct dc_sink *sink;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_detect_force_on(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_detect_force_on_digital(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_detect_force_off(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_detect_sink_present(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_detect_no_sink(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_poll_dac_load_returns_cached(test: *mut kunit) {
    ...
    drmm_connector_init(drm, &aconnector.base,
    &dm_test_connector_funcs,
    DRM_MODE_CONNECTOR_VGA, core::ptr::null_mut()), 0);
    link = kunit_kzalloc(test, sizeof(*link), GFP_KERNEL);
    KUNIT_ASSERT_NOT_NULL(test, link);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_late_register_non_dp_succeeds(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_unregister_non_dp_noop(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_destroy_ctx {
    pub drm: *mut drm_device,
    pub dc_ctx: *mut dc_context,
    pub link: *mut dc_link,
}
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_destroy_minimal(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_destroy_releases_dc_sink(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_destroy_releases_dc_em_sink(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_encoder_disable_noop(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_test_atomic_check_ctx {
    pub drm: *mut drm_device,
    pub aenc: *mut amdgpu_encoder,
    pub aconnector: *mut amdgpu_dm_connector,
    pub dm_state: *mut dm_connector_state,
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_atomic_check_edp_native_keeps_scaling(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_atomic_check_lvds_non_native_enables_scaling(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_atomic_check_non_mst_returns_zero(test: *mut kunit) {
    ...
    ctx.aconnector.mst_output_port = core::ptr::null_mut();
    KUNIT_EXPECT_EQ(test,
    dm_encoder_helper_atomic_check(&ctx.aenc.base,
    ctx.crtc_state,
    &ctx.dm_state.base), 0);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdmi_cec_unset_edid_no_notifier(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_create_eml_sink_no_edid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_handle_edid_mgmt_dp_sets_link_caps(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_handle_edid_mgmt_non_dp_leaves_caps(test: *mut kunit) {
...
pub struct dm_test_modes_ctx {
    ...
    KUNIT_ASSERT_NOT_NULL(test, ctx.aenc);
    KUNIT_ASSERT_EQ(test,
    drmm_encoder_init(ctx.drm, &ctx.aenc.base, core::ptr::null_mut(),
    DRM_MODE_ENCODER_TMDS, core::ptr::null_mut()), 0);
    KUNIT_ASSERT_EQ(test,
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_funcs_force_no_edid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_validate_stream_null_stream(test: *mut kunit) {
    static void dm_test_validate_stream_null_stream(struct kunit *test)
    {
    KUNIT_EXPECT_EQ(test,
    (int)dm_validate_stream_and_context(core::ptr::null_mut(), core::ptr::null_mut()),
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_to_encoder_no_encoder(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_to_encoder_returns_attached(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_native_mode_no_encoder(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_native_mode_empty_probed_zeroes_clock(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_native_mode_copies_preferred(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_create_common_mode_overrides(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_add_common_modes_non_edp_noop(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_add_common_modes_edp_adds(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_ddc_get_modes_null_edid(test: *mut kunit) {
    ...
    amdgpu_dm_connector_ddc_get_modes(&aconnector.base, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_add_fs_modes_no_preferred_mode(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_add_freesync_modes_null_edid_noop(test: *mut kunit) {
    ...
    amdgpu_dm_connector_add_freesync_modes(&aconnector.base, core::ptr::null_mut());
    KUNIT_EXPECT_EQ(test, aconnector.num_modes, 7);
    }
// EDID extension block tag values (avoids pulling in private drm headers).
pub const DM_TEST_CEA_EXT: c_uint = 0x02;
pub const DM_TEST_DISPLAYID_EXT: c_uint = 0x70;
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_i2c_func_returns_flags(test: *mut kunit) {
    static void dm_test_i2c_func_returns_flags(struct kunit *test)
    {
    KUNIT_EXPECT_EQ(test, amdgpu_dm_i2c_func(core::ptr::null_mut()),
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_i2c_xfer_no_ddc_pin(test: *mut kunit) {
...
// ddc->ddc_pin is NULL -> transfer is rejected with -EIO.
    KUNIT_EXPECT_EQ(test, amdgpu_dm_i2c_xfer(&i2c.base, core::ptr::null_mut(), 0), -EIO);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_amd_vsdb_unsupported(test: *mut kunit) {
    static void dm_test_get_amd_vsdb_unsupported(struct kunit *test)
    {
    struct amdgpu_dm_connector *aconnector;
    let mut vsdb_info: amdgpu_hdmi_vsdb_info = {0};
    aconnector = kunit_kzalloc(test, sizeof(*aconnector), GFP_KERNEL);
    KUNIT_ASSERT_NOT_NULL(test, aconnector);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_get_amd_vsdb_supported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_parse_hdmi_amd_vsdb_null_edid(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_NULL(test, aconnector);
    KUNIT_EXPECT_EQ(test,
    parse_hdmi_amd_vsdb(aconnector, core::ptr::null_mut(), &vsdb_info),
    -ENODEV);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_parse_hdmi_amd_vsdb_no_extensions(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_parse_hdmi_amd_vsdb_no_cea_ext(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_parse_displayid_vrr_null_edid(test: *mut kunit) {
    static void dm_test_parse_displayid_vrr_null_edid(struct kunit *test)
    {
    struct drm_connector *connector;
    connector = kunit_kzalloc(test, sizeof(*connector), GFP_KERNEL);
    KUNIT_ASSERT_NOT_NULL(test, connector);
    parse_edid_displayid_vrr(connector, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_parse_displayid_vrr_no_displayid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_parse_displayid_vrr_sets_range(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mode_valid_interlace_rejected(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_mode_valid_dblscan_rejected(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_hdmi_cec_set_edid_no_notifier(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_s3_handle_hdmi_cec_suspend(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_s3_handle_hdmi_cec_resume(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_create_validate_stream_null_dm_state(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_after_detect_mst_noop(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_after_detect_sink_unchanged(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_scaling_null_mode(test: *mut kunit) {
    static void dm_test_update_scaling_null_mode(struct kunit *test)
    {
    struct amdgpu_device *adev = dm_kunit_alloc_adev(test);
    struct dc_stream_state *stream = dm_kunit_alloc_stream(test, core::ptr::null_mut());
    stream.timing.h_addressable = 1920;
    stream.timing.v_addressable = 1080;
    amdgpu_dm_update_stream_scaling_settings(&adev.ddev, core::ptr::null_mut(), core::ptr::null_mut(), stream);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_scaling_fullscreen_default(test: *mut kunit) {
    static void dm_test_update_scaling_fullscreen_default(struct kunit *test)
    {
    struct amdgpu_device *adev = dm_kunit_alloc_adev(test);
    struct dc_stream_state *stream = dm_kunit_alloc_stream(test, core::ptr::null_mut());
    let mut mode: drm_display_mode = { 0 };
    mode.hdisplay = 1920;
    mode.vdisplay = 1080;
    stream.timing.h_addressable = 2560;
    stream.timing.v_addressable = 1440;
    amdgpu_dm_update_stream_scaling_settings(&adev.ddev, &mode, core::ptr::null_mut(), stream);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_scaling_rmx_full(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_scaling_rmx_aspect_pillarbox(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_scaling_rmx_aspect_letterbox(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_scaling_rmx_center(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_update_scaling_underscan(test: *mut kunit) {
