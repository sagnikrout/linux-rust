...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_crtc_test.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_modeset_required_active_mode_changed(test: *mut kunit) {
    static void dm_test_crtc_modeset_required_active_mode_changed(struct kunit *test)
    {
    let mut state: drm_crtc_state = {};
    state.active = true;
    state.mode_changed = true;
    KUNIT_EXPECT_TRUE(test,
    amdgpu_dm_crtc_modeset_required(&state, core::ptr::null_mut(), core::ptr::null_mut()));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_modeset_required_active_active_changed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_modeset_required_active_connectors_changed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_modeset_required_inactive(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_modeset_required_no_changes(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_vrr_active_irq_variable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_vrr_active_irq_fixed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_vrr_active_irq_inactive(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_vrr_active_irq_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_vrr_active_irq_unsupported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_vrr_active_variable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_vrr_active_fixed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_vrr_active_inactive(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_vrr_active_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_vrr_active_unsupported(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_is_headless_null_adev(test: *mut kunit) {
    static void dm_test_crtc_is_headless_null_adev(struct kunit *test)
    {
    KUNIT_EXPECT_TRUE(test, amdgpu_dm_is_headless(core::ptr::null_mut()));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_is_headless_no_connectors(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_is_headless_writeback_only(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_is_headless_disconnected_display(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_is_headless_connected_display(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_is_headless_mixed_connectors(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_helper_mode_fixup_returns_true(test: *mut kunit) {
    static void dm_test_crtc_helper_mode_fixup_returns_true(struct kunit *test)
    {
    let mut mode: drm_display_mode = { 0 };
    let mut adjusted_mode: drm_display_mode = { 0 };
    KUNIT_EXPECT_TRUE(test,
    amdgpu_dm_crtc_helper_mode_fixup(core::ptr::null_mut(), &mode, &adjusted_mode));
    }
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_set_vupdate_irq_no_otg(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_set_vupdate_irq_dc_busy(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_set_vupdate_irq_enable(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_idle_create_workqueue(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_idle_worker_disabled_clears_running(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_idle_worker_enabled_breaks_when_idle_disallowed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_idle_worker_enabled_breaks_when_not_headless(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_idle_apply_flip(dc: *mut dc, enable: bool) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_idle_worker_enabled_runs_body(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_set_static_screen_optimze_no_sr_entry(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_set_static_screen_optimze_sr_entry_psr(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_set_static_screen_optimze_psr_su_skips(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_enable_vblank_rejects_unconfigured(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_enable_vblank_full_path(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_enable_vblank_vupdate_busy(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_enable_vblank_crtc_irq_error(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_enable_vblank_in_reset(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_enable_vblank_queues_work(test: *mut kunit) {
...
// Drain the queued worker before the fixture is torn down, then tidy up.
    ...
    adev.dm.vblank_control_workqueue = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_enable_vblank_ips_restore(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_enable_vblank_ips_restore_replay(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_update_active_planes_no_stream(test: *mut kunit) {
    static void dm_test_crtc_update_active_planes_no_stream(struct kunit *test)
    {
    struct dm_crtc_state *dm_state;
    dm_state = kunit_kzalloc(test, sizeof(*dm_state), GFP_KERNEL);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, dm_state);
    dm_state.stream = core::ptr::null_mut();
    dm_state.active_planes = 5;
    amdgpu_dm_crtc_update_crtc_active_planes(core::ptr::null_mut(), &dm_state.base);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_count_crtc_active_planes_none(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_count_crtc_active_planes_mixed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_duplicate_state_copies_fields(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_reset_state_allocates_state(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_destroy_state_no_stream(test: *mut kunit) {
...
// destroy_state kfree()s the state, so use a plain (unmanaged) alloc.
    ...
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, dm_state);
    amdgpu_dm_crtc_destroy_state(core::ptr::null_mut(), &dm_state.base);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_destroy_state_releases_stream(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_handle_vblank_no_event(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_handle_vblank_skips_when_flip_submitted(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_handle_vblank_completes_cursor_only(test: *mut kunit) {
...
//
    ...
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, acrtc);
    acrtc.base.dev = &adev.ddev;
    acrtc.base.state = core::ptr::null_mut();
    stream = dm_kunit_alloc_stream(test, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_vblank_control_worker_enable_increments(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_vblank_control_worker_disable_decrements(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_vblank_control_worker_disable_clamps_zero(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_disable_vblank_no_irq_installed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_disable_vblank_vrr(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_crtc_disable_vblank_queues_work(test: *mut kunit) {
