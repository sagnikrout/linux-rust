...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_wb_test.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_wb_atomic_check_no_job(test: *mut kunit) {
...
// No writeback_job — should return 0
    ...
    ret = amdgpu_dm_wb_encoder_atomic_check(core::ptr::null_mut(), crtc_state, conn_state);
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_wb_atomic_check_no_fb(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_wb_atomic_check_valid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_wb_atomic_check_size_mismatch(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_wb_atomic_check_width_mismatch(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_wb_atomic_check_height_mismatch(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_wb_atomic_check_invalid_format(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_wb_get_modes_returns_modes(test: *mut kunit) {
    ...
    DRM_MODE_CONNECTOR_VIRTUAL, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_wb_get_modes_bounded_by_max(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_wb_connector_init_success(test: *mut kunit) {
    ...
    KUNIT_EXPECT_TRUE(test, wbcon.base.base.funcs != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, wbcon.base.base.helper_private != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, wbcon.base.base.state != core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, wbcon.base.encoder.funcs != core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_wb_prepare_job_no_fb(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_NULL(test, job);
    job.fb = core::ptr::null_mut();
    ret = amdgpu_dm_wb_prepare_job(core::ptr::null_mut(), job);
    KUNIT_EXPECT_EQ(test, ret, 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_wb_cleanup_job_no_fb(test: *mut kunit) {
