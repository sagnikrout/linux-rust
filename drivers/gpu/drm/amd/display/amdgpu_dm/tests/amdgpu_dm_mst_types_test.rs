...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_mst_types_test.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_needs_dsc_aux_workaround_match(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_needs_dsc_aux_workaround_rev12(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_needs_dsc_aux_workaround_wrong_dev_id(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_needs_dsc_aux_workaround_wrong_rev(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_needs_dsc_aux_workaround_low_sink_count(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_needs_dsc_aux_workaround_zero_sink_count(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_pbn_divider_null_link(test: *mut kunit) {
    static void dm_mst_test_pbn_divider_null_link(struct kunit *test)
    {
    KUNIT_EXPECT_EQ(test, dm_mst_get_pbn_divider(core::ptr::null_mut()), 0U);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_pbn_divider_uses_link_bandwidth(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_reset_connector_setting(test: *mut kunit) {
    ...
    KUNIT_EXPECT_TRUE(test, aconnector.drm_edid == core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, aconnector.dsc_aux == core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, aconnector.mst_output_port.passthrough_aux == core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_retrieve_downstream_no_aux(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_retrieve_downstream_present(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_retrieve_downstream_aux_error(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_retrieve_branch_no_parent(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_retrieve_branch_reads_oui(test: *mut kunit) {
    ...
    port.parent = branch;
    port.mgr = mgr;
    port.aux.drm_dev = core::ptr::null_mut();
    aconnector.mst_output_port = port;
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_aux_result_success(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_aux_result_eio(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_aux_result_ebusy(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_aux_result_timeout(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_aux_transfer_native_read(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_aux_transfer_native_write(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_aux_transfer_partial_write(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_aux_transfer_error_result(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_aux_transfer_hpd_discon_quirk(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_aux_transfer_non_ack_reply(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_fill_payload_flags_native_write(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_fill_payload_flags_native_read(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_fill_payload_flags_i2c_read_mot(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_fill_payload_flags_write_status(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_msg_ready_mask(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_select_esi_dpcd_legacy(test: *mut kunit) {
    static void dm_mst_test_select_esi_dpcd_legacy(struct kunit *test)
    {
    let mut dpcd_addr: c_int = -1;
    let mut dpcd_bytes_to_read: u8 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_select_esi_dpcd_esi(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_sideband_msg_ready_no_ready_bits(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_sideband_msg_ready_read_error(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_sideband_msg_ready_without_mst_state(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_down_rep_msg_ready_wrapper(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_initialize_dp_connector_edp(test: *mut kunit) {
    ...
    KUNIT_EXPECT_PTR_EQ(test, aconnector.mst_mgr.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dm_mst_test_connector_destroy(connector: *mut drm_connector) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_initialize_dp_connector_mst(test: *mut kunit) {
    ...
    KUNIT_EXPECT_TRUE(test, aconnector.mst_mgr.cbs != core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_atomic_best_encoder(test: *mut kunit) {
    static void dm_mst_test_atomic_best_encoder(struct kunit *test)
    {
    let mut connector_state: drm_connector_state = { 0 };
    let mut state: drm_atomic_commit = { 0 };
    struct amdgpu_dm_connector *aconnector;
    struct amdgpu_device *adev;
    struct amdgpu_crtc *acrtc;
    let mut connector_index: c_uint = 3;
    adev = kunit_kzalloc(test, sizeof(*adev), GFP_KERNEL);
    aconnector = kunit_kzalloc(test, sizeof(*aconnector), GFP_KERNEL);
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_create_fake_mst_encoders(test: *mut kunit) {
    ...
    KUNIT_EXPECT_TRUE(test, encoder.helper_private != core::ptr::null_mut());
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_atomic_check_no_old_crtc(test: *mut kunit) {
    ...
    struct drm_dp_mst_port *port;
    let mut connector_index: c_uint = 2;
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_detect_unregistered(test: *mut kunit) {
    ...
    KUNIT_EXPECT_EQ(test,
    dm_dp_mst_detect(&aconnector.base, core::ptr::null_mut(), false),
...
//
#[no_mangle]
unsafe extern "C" fn dm_mst_test_fp_guarded_public_stubs(test: *mut kunit) {
    static void dm_mst_test_fp_guarded_public_stubs(struct kunit *test)
    {
    KUNIT_EXPECT_EQ(test, dm_dp_mst_is_port_support_mode(core::ptr::null_mut(), core::ptr::null_mut()),
