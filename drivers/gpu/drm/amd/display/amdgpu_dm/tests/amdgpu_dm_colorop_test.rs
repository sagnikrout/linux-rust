...
//! Source: drivers/gpu/drm/amd/display/amdgpu_dm/tests/amdgpu_dm_colorop_test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_degam_tfs_has_srgb_eotf(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_degam_tfs_has_pq125_eotf(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_degam_tfs_has_bt2020_inv_oetf(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_degam_tfs_has_gamma22(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_degam_tfs_no_extra_bits(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_shaper_tfs_has_srgb_inv_eotf(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_shaper_tfs_has_pq125_inv_eotf(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_shaper_tfs_has_bt2020_oetf(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_shaper_tfs_has_gamma22_inv(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_shaper_tfs_no_extra_bits(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_blnd_tfs_has_srgb_eotf(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_blnd_tfs_has_pq125_eotf(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_blnd_tfs_has_bt2020_inv_oetf(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_blnd_tfs_has_gamma22(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_supported_blnd_tfs_no_extra_bits(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dm_test_degam_and_blnd_tfs_match(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_colorop_pipeline_destroy(drm: *mut c_void) {
    ...
    int expected_count)
    {
    struct drm_colorop *op, *first = core::ptr::null_mut();
    let mut i: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_initialize_default_pipeline(test: *mut kunit) {
    ...
    let mut list: drm_prop_enum_list = {};
    int ret;
...
//
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), 0, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_initialize_default_pipeline_dpp_3d_lut(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_initialize_default_pipeline_mpc_preblend(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_test_initialize_default_pipeline_no_3d_lut(test: *mut kunit) {
