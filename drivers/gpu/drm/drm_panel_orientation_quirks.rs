...
//! Source: drivers/gpu/drm/drm_panel_orientation_quirks.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_dmi_panel_orientation_data {
    pub width: c_int,
    pub height: c_int,
    pub bios_dates: *const *const c_char,
    ...
    "07/05/2017", "08/07/2017", core::ptr::null_mut() },
    .orientation = DRM_MODE_PANEL_ORIENTATION_RIGHT_UP,
    };
    ...
    "02/21/2017", "03/20/2017", "05/25/2017", core::ptr::null_mut() },
    .orientation = DRM_MODE_PANEL_ORIENTATION_RIGHT_UP,
    };
    ...
    .height = 1280,
    .bios_dates = (const char * const []){
    "12/07/2017", "05/24/2018", "06/29/2018", core::ptr::null_mut() },
    .orientation = DRM_MODE_PANEL_ORIENTATION_RIGHT_UP,
    };
    static const struct drm_dmi_panel_orientation_data itworks_tw891 = {
    .width = 800,
    .height = 1280,
    .bios_dates = (const char * const []){ "10/16/2015", core::ptr::null_mut() },
    .orientation = DRM_MODE_PANEL_ORIENTATION_RIGHT_UP,
    };
    static const struct drm_dmi_panel_orientation_data onegx1_pro = {
    .width = 1200,
    .height = 1920,
    .bios_dates = (const char * const []){ "12/17/2020", core::ptr::null_mut() },
    .orientation = DRM_MODE_PANEL_ORIENTATION_RIGHT_UP,
    };
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_get_panel_orientation_quirk(width: c_int, height: c_int) -> c_int {
