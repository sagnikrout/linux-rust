...
//! Source: drivers/gpu/drm/arm/hdlcd_crtc.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn hdlcd_crtc_cleanup(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn hdlcd_crtc_enable_vblank(crtc: *mut drm_crtc) -> c_int {
    static int hdlcd_crtc_enable_vblank(struct drm_crtc *crtc)
    {
    struct hdlcd_drm_private *hdlcd = crtc_to_hdlcd_priv(crtc);
    let mut mask: c_uint = hdlcd_read(hdlcd, HDLCD_REG_INT_MASK);
    hdlcd_write(hdlcd, HDLCD_REG_INT_MASK, mask | HDLCD_INTERRUPT_VSYNC);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn hdlcd_crtc_disable_vblank(crtc: *mut drm_crtc) {
...
//
#[no_mangle]
unsafe extern "C" fn hdlcd_set_pxl_fmt(crtc: *mut drm_crtc) -> c_int {
    static int hdlcd_set_pxl_fmt(struct drm_crtc *crtc)
    {
    unsigned int btpp;
    struct hdlcd_drm_private *hdlcd = crtc_to_hdlcd_priv(crtc);
    const struct drm_framebuffer *fb = crtc.primary.state.fb;
    const struct pixel_format *format = core::ptr::null_mut();
    int i;
...
#[no_mangle]
unsafe extern "C" fn hdlcd_crtc_mode_set_nofb(crtc: *mut drm_crtc) {
...
#[no_mangle]
pub unsafe extern "C" fn hdlcd_setup_crtc(drm: *mut drm_device) -> c_int {
    ...
    ret = drm_crtc_init_with_planes(drm, &hdlcd.crtc, primary, core::ptr::null_mut(),
    &hdlcd_crtc_funcs, core::ptr::null_mut());
    if (ret)
    return ret;
