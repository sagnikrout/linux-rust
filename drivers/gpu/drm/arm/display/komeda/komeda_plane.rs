...
//! Source: drivers/gpu/drm/arm/display/komeda/komeda_plane.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn komeda_plane_destroy(plane: *mut drm_plane) {
...
#[no_mangle]
unsafe extern "C" fn komeda_plane_reset(plane: *mut drm_plane) {
    ...
    struct komeda_plane *kplane = to_kplane(plane);
    let mut layer_type: u32 = kplane.layer.layer_type;
...
// use Layer0 as primary
    ...
    {
    let mut is_primary: bool = (c.id == KOMEDA_COMPONENT_LAYER0);
...
#[no_mangle]
pub unsafe extern "C" fn komeda_kms_add_planes(kms: *mut komeda_kms_dev, mdev: *mut komeda_dev) -> c_int {
