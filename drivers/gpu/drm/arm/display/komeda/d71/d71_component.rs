...
//! Source: drivers/gpu/drm/arm/display/komeda/d71/d71_component.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_resources_id(hw_id: u32, pipe_id: *mut u32, comp_id: *mut u32) {
    static void get_resources_id(u32 hw_id, u32 *pipe_id, u32 *comp_id)
    {
    let mut id: u32 = BLOCK_INFO_BLK_ID(hw_id);
    let mut pipe: u32 = id;
...
#[no_mangle]
unsafe extern "C" fn get_valid_inputs(blk: *mut block_header) -> u32 {
    static u32 get_valid_inputs(struct block_header *blk)
    {
    let mut valid_inputs: u32 = 0, comp_id;
    int i;
    for (i = 0; i < PIPELINE_INFO_N_VALID_INPUTS(blk.pipeline_info); i++) {
    get_resources_id(blk.input_ids[i], core::ptr::null_mut(), &comp_id);
...
#[no_mangle]
unsafe extern "C" fn dump_block_header(sf: *mut seq_file, reg: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn get_blk_line_size(d71: *mut d71_dev, reg: *mut u32 __iomem) -> u32 {
    static u32 get_blk_line_size(struct d71_dev *d71, u32 __iomem *reg)
    {
    return __get_blk_line_size(d71, reg, d71.max_line_size);
    }
#[no_mangle]
unsafe extern "C" fn to_rot_ctrl(rot: u32) -> u32 {
    static u32 to_rot_ctrl(u32 rot)
    {
    let mut lr_ctrl: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn to_ad_ctrl(modifier: u64) -> u32 {
    static u32 to_ad_ctrl(u64 modifier)
    {
    let mut afbc_ctrl: u32 = AD_AEN;
    if (!modifier)
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn to_d71_input_id(st: *mut komeda_component_state, idx: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn d71_layer_disable(c: *mut komeda_component) {
    ...
    u32 __iomem *reg = c.reg;
    let mut ctrl_mask: u32 = L_EN | L_ROT(L_ROT_R270) | L_HFLIP | L_VFLIP | L_TBU_EN;
    let mut ctrl: u32 = L_EN | to_rot_ctrl(st.rot);
...
#[no_mangle]
unsafe extern "C" fn d71_layer_dump(c: *mut komeda_component, sf: *mut seq_file) {
...
// rich layer is 4K configuration
    ...
    let mut ctrl: u32 = L_EN | LW_OFM, mask = L_EN | LW_OFM | LW_TBU_EN;
    u32 __iomem *reg = c.reg;
    d71_layer_update_fb(c, kfb, st.addr);
    if (kfb.is_va)
    ctrl |= LW_TBU_EN;
...
#[no_mangle]
unsafe extern "C" fn d71_wb_layer_dump(c: *mut komeda_component, sf: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn d71_wb_layer_disable(c: *mut komeda_component) {
...
#[no_mangle]
unsafe extern "C" fn d71_component_disable(c: *mut komeda_component) {
...
//
    ...
    {
    let mut ctrl: u32 = CU_INPUT_CTRL_EN;
    let mut blend: u8 = cin.pixel_blend_mode;
    if (blend == DRM_MODE_BLEND_PIXEL_NONE)
    ctrl |= CU_INPUT_CTRL_PAD;
#[no_mangle]
pub unsafe extern "C" fn if(DRM_MODE_BLEND_PREMULTI: blend ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn d71_compiz_dump(c: *mut komeda_component, sf: *mut seq_file) {
    ...
    val  |= 0x62;
#[no_mangle]
pub unsafe extern "C" fn if(2): hsize_in <= (hsize_out + hsize_out /) -> else {
    else if (hsize_in <= (hsize_out + hsize_out / 2))
    val |= 0x63;
#[no_mangle]
pub unsafe extern "C" fn if(2: *mut *mut hsize_in <= hsize_out) -> else {
    else if (hsize_in <= hsize_out * 2)
    val |= 0x64;
#[no_mangle]
pub unsafe extern "C" fn if(4: *mut *mut *mut hsize_in <= hsize_out  2 + (hsize_out  3) /) -> else {
    ...
    val  |= SC_VTSEL(0x6A);
#[no_mangle]
pub unsafe extern "C" fn if(2): vsize_in <= (vsize_out + vsize_out /) -> else {
    else if (vsize_in <= (vsize_out + vsize_out / 2))
    val |= SC_VTSEL(0x6B);
#[no_mangle]
pub unsafe extern "C" fn if(2: *mut *mut vsize_in <= vsize_out) -> else {
    else if (vsize_in <= vsize_out * 2)
    val |= SC_VTSEL(0x6C);
#[no_mangle]
pub unsafe extern "C" fn if(4: *mut *mut *mut vsize_in <= vsize_out  2 + vsize_out  3 /) -> else {
...
//
    if (st.right_part) {
    let mut dst_a: u32 = st.total_hsize_out - st.hsize_out + st.left_crop;
...
#[no_mangle]
unsafe extern "C" fn d71_scaler_dump(c: *mut komeda_component, sf: *mut seq_file) {
    ...
    {
    let mut h_in: u32 = dflow.in_w;
    let mut v_in: u32 = dflow.in_h;
    let mut v_out: u32 = dflow.out_h;
...
#[no_mangle]
unsafe extern "C" fn d71_splitter_dump(c: *mut komeda_component, sf: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn d71_merger_dump(c: *mut komeda_component, sf: *mut seq_file) {
...
#[no_mangle]
pub unsafe extern "C" fn if(DRM_OUTPUT_COLOR_FORMAT_YCBCR422: st->color_format ==) -> else {
    else if (st.color_format == DRM_OUTPUT_COLOR_FORMAT_YCBCR422)
    ctrl |= IPS_CTRL_YUV | IPS_CTRL_CHD422;
#[no_mangle]
pub unsafe extern "C" fn if(DRM_OUTPUT_COLOR_FORMAT_YCBCR444: st->color_format ==) -> else {
    else if (st.color_format == DRM_OUTPUT_COLOR_FORMAT_YCBCR444)
    ctrl |= IPS_CTRL_YUV;
    malidp_write32_mask(reg, BLK_CONTROL, mask, ctrl);
    }
#[no_mangle]
unsafe extern "C" fn d71_improc_dump(c: *mut komeda_component, sf: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn d71_timing_ctrlr_disable(c: *mut komeda_component) {
...
// configure bs control register
    ...
    let mut blk_id: c_int = BLOCK_INFO_BLK_ID(blk.block_info);
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn d71_gcu_dump(d71: *mut d71_dev, sf: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn d71_lpu_dump(pipe: *mut d71_pipeline, sf: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn d71_dou_dump(pipe: *mut d71_pipeline, sf: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn d71_pipeline_dump(pipe: *mut komeda_pipeline, sf: *mut seq_file) {
...
#[no_mangle]
pub unsafe extern "C" fn d71_dump(mdev: *mut komeda_dev, sf: *mut seq_file) {
