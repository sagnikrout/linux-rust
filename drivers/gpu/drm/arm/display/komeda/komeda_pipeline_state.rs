...
//! Source: drivers/gpu/drm/arm/display/komeda/komeda_pipeline_state.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn is_switching_user(old: *mut c_void, new: *mut c_void) -> bool {
...
//
    ...
    return false;
#[no_mangle]
pub unsafe extern "C" fn if(max_downscaling: *mut *mut size_in > size_out) -> else {
...
// vsize = m->vdisplay;
    ...
    let mut idx: c_int = dflow.blending_zorder;
...
//
    ...
    let mut w: u32 = dflow.in_w;
    let mut h: u32 = dflow.in_h;
...
//
    ...
    struct komeda_data_flow_cfg *r_dflow)
    {
    let mut r90: bool = drm_rotation_90_or_270(dflow.rot);
    let mut flip_h: bool = has_flip_h(dflow.rot);
...
// unbound all disabling component
    ...
    drm_st, core::ptr::null_mut(), new.crtc);
...
// ignore the pipeline which is not affected
    ...
    st = komeda_pipeline_get_state_and_set_crtc(pipe, drm_st, core::ptr::null_mut());
