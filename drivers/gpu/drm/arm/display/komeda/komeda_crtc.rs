...
//! Source: drivers/gpu/drm/arm/display/komeda/komeda_crtc.c
#![no_std]
...
//
    ...
    let mut conn_color_formats: u32 = ~0u;
...
#[no_mangle]
unsafe extern "C" fn komeda_crtc_update_clock_ratio(kcrtc_st: *mut komeda_crtc_state) {
...
//
    ...
    let mut events: u32 = evts.pipes[kcrtc.master.id];
...
// will handle it together with the write back support
    ...
    kcrtc.disable_done = core::ptr::null_mut();
...
// step 1: update the pipeline/component state to HW
    ...
    conn_st = wb_conn ? wb_conn.base.base.state : core::ptr::null_mut();
...
// wait the flip take affect.
    ...
    let mut needs_phase2: bool = false;
...
//
    ...
    core::ptr::null_mut() : &crtc.state.commit.flip_done;
...
#[no_mangle]
pub unsafe extern "C" fn komeda_crtc_get_aclk(kcrtc_st: *mut komeda_crtc_state) -> c_ulong {
    unsigned long komeda_crtc_get_aclk(struct komeda_crtc_state *kcrtc_st)
    {
    struct drm_crtc *crtc = kcrtc_st.base.crtc;
    struct komeda_dev *mdev = crtc.dev.dev_private;
    let mut pxlclk: c_ulong = kcrtc_st.base.adjusted_mode.crtc_clock * 1000;
...
#[no_mangle]
unsafe extern "C" fn komeda_crtc_reset(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn komeda_crtc_vblank_enable(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn komeda_crtc_vblank_disable(crtc: *mut drm_crtc) {
...
// only master can be primary
    ...
    err = drm_bridge_attach(encoder, bridge, core::ptr::null_mut(), 0);
    if (err)
    ...
    get_crtc_primary(kms, kcrtc), core::ptr::null_mut(),
    &komeda_crtc_funcs, core::ptr::null_mut());
    if (err)
    return err;
...
#[no_mangle]
pub unsafe extern "C" fn komeda_kms_add_crtcs(kms: *mut komeda_kms_dev, mdev: *mut komeda_dev) -> c_int {
