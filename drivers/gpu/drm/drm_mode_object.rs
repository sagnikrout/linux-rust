...
//! Source: drivers/gpu/drm/drm_mode_object.c
#![no_std]
...
//
    ...
    ret = idr_alloc(&dev.mode_config.object_idr, register_obj ? obj : core::ptr::null_mut(),
    1, 0, GFP_KERNEL);
    if (ret >= 0) {
//
...
//
    ...
    {
    return __drm_mode_object_add(dev, obj, obj_type, true, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_object_lease_required(type: u32) -> bool {
    ...
    {
    struct drm_mode_object *obj = core::ptr::null_mut();
    mutex_lock(&dev.mode_config.idr_mutex);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_object_put(obj: *mut drm_mode_object) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_object_get(obj: *mut drm_mode_object) {
...
//
    ...
    uint64_t init_val)
    {
    let mut count: c_int = obj.properties.count;
