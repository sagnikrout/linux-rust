...
//! Source: drivers/gpu/drm/xlnx/zynqmp_dp_audio.c
#![no_std]
...
pub const ZYNQMP_DISP_AUD_SMPL_RATE_TO_CLK: c_int = 512;
pub const ZYNQMP_NUM_PCMS: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynqmp_dpsub_audio {
    pub base: *mut void __iomem,
    pub card: snd_soc_card,
    pub dai_name: *const c_char,
    pub link_names: [*const c_char; ZYNQMP_NUM_PCMS],
    pub pcm_names: [*const c_char; ZYNQMP_NUM_PCMS],
    pub dai_driver: snd_soc_dai_driver,
    pub pcm_configs: [snd_dmaengine_pcm_config; 2],
    pub links: [snd_soc_dai_link; ZYNQMP_NUM_PCMS],
    struct {
    pub cpu: snd_soc_dai_link_component,
    pub platform: snd_soc_dai_link_component,
    pub components: [}; ZYNQMP_NUM_PCMS],
//
// Protects:
// - enabled_streams
// - volumes
...
#[no_mangle]
unsafe extern "C" fn zynqmp_dp_startup(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zynqmp_audio_init(dpsub: *mut zynqmp_dpsub) -> c_int {
...
//
    ...
    dpsub.audio = core::ptr::null_mut();
    return 0;
    }
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn zynqmp_audio_uninit(dpsub: *mut zynqmp_dpsub) {
