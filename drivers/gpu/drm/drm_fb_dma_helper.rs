...
//! Source: drivers/gpu/drm/drm_fb_dma_helper.c
#![no_std]
...
//
    ...
    dma_addr_t dma_addr;
    let mut h_div: u8 = 1, v_div = 1;
    let mut block_w: u32 = drm_format_info_block_width(fb.format, plane);
    let mut block_h: u32 = drm_format_info_block_height(fb.format, plane);
    let mut block_size: u32 = fb.format.char_per_block[plane];
    u32 sample_x;
    u32 sample_y;
    u32 block_start_y;
    u32 num_hblocks;
