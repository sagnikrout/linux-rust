...
//! Source: drivers/gpu/drm/radeon/radeon_legacy_tv.c
#![no_std]
...
//
pub const H_POS_UNIT: c_int = 10;
//
// Indexes in h. code timing table for horizontal line position adjustment
//
pub const H_TABLE_POS1: c_int = 6;
pub const H_TABLE_POS2: c_int = 8;
//
// Limits of hor. size (hSize)
//

// tv standard constants
pub const NTSC_TV_CLOCK_T: c_int = 233;
pub const NTSC_TV_VFTOTAL: c_int = 1;
pub const NTSC_TV_LINES_PER_FRAME: c_int = 525;
pub const NTSC_TV_ZERO_H_SIZE: c_int = 479166;
pub const NTSC_TV_H_SIZE_UNIT: c_int = 9478;
pub const PAL_TV_CLOCK_T: c_int = 188;
pub const PAL_TV_VFTOTAL: c_int = 3;
pub const PAL_TV_LINES_PER_FRAME: c_int = 625;
pub const PAL_TV_ZERO_H_SIZE: c_int = 473200;
pub const PAL_TV_H_SIZE_UNIT: c_int = 9360;
// tv pll setting for 27 mhz ref clk
pub const NTSC_TV_PLL_M_27: c_int = 22;
pub const NTSC_TV_PLL_N_27: c_int = 175;
pub const NTSC_TV_PLL_P_27: c_int = 5;
pub const PAL_TV_PLL_M_27: c_int = 113;
pub const PAL_TV_PLL_N_27: c_int = 668;
pub const PAL_TV_PLL_P_27: c_int = 3;
// tv pll setting for 14 mhz ref clk
pub const NTSC_TV_PLL_M_14: c_int = 33;
pub const NTSC_TV_PLL_N_14: c_int = 693;
pub const NTSC_TV_PLL_P_14: c_int = 7;
pub const PAL_TV_PLL_M_14: c_int = 19;
pub const PAL_TV_PLL_N_14: c_int = 353;
pub const PAL_TV_PLL_P_14: c_int = 5;
pub const VERT_LEAD_IN_LINES: c_int = 2;
pub const FRAC_BITS: c_uint = 0xe;
pub const FRAC_MASK: c_uint = 0x3fff;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct radeon_tv_mode_constants {
    pub hor_resolution: u16,
    pub ver_resolution: u16,
    pub standard: enum radeon_tv_std,
    pub hor_total: u16,
    pub ver_total: u16,
    pub hor_start: u16,
    pub hor_syncstart: u16,
    pub ver_syncstart: u16,
    pub def_restart: unsigned,
    pub crtcPLL_N: u16,
    pub crtcPLL_M: u8,
    pub crtcPLL_post_div: u8,
    pub pix_to_tv: unsigned,
}
...
#[no_mangle]
unsafe extern "C" fn radeon_legacy_tv_read_fifo(radeon_encoder: *mut radeon_encoder, addr: u16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn radeon_get_htiming_tables_addr(tv_uv_adr: u32) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn radeon_get_vtiming_tables_addr(tv_uv_adr: u32) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn radeon_restore_tv_timing_tables(radeon_encoder: *mut radeon_encoder) {
...
#[no_mangle]
unsafe extern "C" fn radeon_legacy_write_tv_restarts(radeon_encoder: *mut radeon_encoder) {
...
#[no_mangle]
unsafe extern "C" fn radeon_legacy_tv_init_restarts(encoder: *mut drm_encoder) -> bool {
    ...
    bool h_changed;
    const struct radeon_tv_mode_constants *const_ptr;
    const_ptr = radeon_legacy_tv_get_std_mode(radeon_encoder, core::ptr::null_mut());
    if (!const_ptr)
    return false;
...
#[no_mangle]
unsafe extern "C" fn get_post_div(value: c_int) -> c_int {
