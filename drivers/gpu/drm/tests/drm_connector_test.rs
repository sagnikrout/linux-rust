...
//! Source: drivers/gpu/drm/tests/drm_connector_test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_connector_init_priv {
    pub drm: drm_device,
...
#[no_mangle]
unsafe extern "C" fn accept_infoframe_clear_infoframe(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_ddc_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn i2c_del_adapter_wrapper(ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_connector_init(test: *mut kunit) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drmm_connector_init(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drmm_connector_init_null_ddc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drmm_connector_init_type_valid(test: *mut kunit) {
    static void drm_test_drmm_connector_init_type_valid(struct kunit *test)
    {
    struct drm_connector_init_priv *priv = test.priv;
    let mut connector_type: c_uint = *(unsigned int *)test.param_value;
    int ret;
    ret = drmm_connector_init(&priv.drm, &priv.connector,
    &dummy_funcs,
    connector_type,
...
#[no_mangle]
unsafe extern "C" fn drm_connector_init_type_desc(type: *const c_uint, desc: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_init(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_connector_dynamic_init_cleanup(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_init_null_ddc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_init_not_added(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_init_properties(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_init_type_valid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_init_name(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_connector_dynamic_register_early_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_test_connector_dynamic_register_early_cleanup(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_register_early_on_list(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_register_early_defer(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_register_early_no_init(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_register_early_no_mode_object(test: *mut kunit) {
    ...
    KUNIT_ASSERT_EQ(test, ret, 0);
    tmp_connector = drm_connector_lookup(connector.dev, core::ptr::null_mut(), connector.base.id);
...
#[no_mangle]
unsafe extern "C" fn drm_test_connector_dynamic_register_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_test_connector_dynamic_register_cleanup(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_register_on_list(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_register_no_defer(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_register_no_init(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_register_mode_object(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_register_sysfs(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_register_sysfs_name(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_dynamic_register_debugfs(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_valid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_null_ddc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_null_vendor(test: *mut kunit) {
    static void drm_test_connector_hdmi_init_null_vendor(struct kunit *test)
    {
    struct drm_connector_init_priv *priv = test.priv;
    int ret;
    ret = drmm_connector_hdmi_init(&priv.drm, &priv.connector,
    core::ptr::null_mut(), "Product",
    &dummy_funcs,
    &dummy_hdmi_funcs,
    DRM_MODE_CONNECTOR_HDMIA,
    &priv.ddc,
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_null_product(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_product_valid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_product_length_exact(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_product_length_too_long(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_vendor_valid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_vendor_length_exact(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_vendor_length_too_long(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_bpc_invalid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_bpc_null(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_bpc_8(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_bpc_10(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_bpc_12(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_formats_empty(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_formats_no_rgb(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_connector_hdmi_init_formats_yuv420_allowed_test {
    pub supported_formats: c_ulong,
    pub yuv420_allowed: bool,
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_formats_yuv420_allowed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_type_valid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_connector_hdmi_init_type_desc(type: *const c_uint, desc: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_init_type_invalid(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_get_tv_mode_from_name_test {
    pub name: *const c_char,
    pub expected_mode: enum drm_connector_tv_mode,
}
...
#[no_mangle]
unsafe extern "C" fn drm_test_get_tv_mode_from_name_valid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_get_tv_mode_from_name_truncated(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_hdmi_connector_get_broadcast_rgb_name_test {
    pub kind: c_uint,
    pub expected_name: *const c_char,
}
...
#[no_mangle]
unsafe extern "C" fn drm_test_drm_hdmi_connector_get_broadcast_rgb_name(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_drm_hdmi_connector_get_broadcast_rgb_name_invalid(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_hdmi_connector_get_output_format_name_test {
    pub kind: c_uint,
    pub expected_name: *const c_char,
}
...
#[no_mangle]
unsafe extern "C" fn drm_test_drm_hdmi_connector_get_output_format_name(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_drm_hdmi_connector_get_output_format_name_invalid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_attach_broadcast_rgb_property(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_drm_connector_attach_broadcast_rgb_property_hdmi_connector(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_hdmi_compute_mode_clock_rgb(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_hdmi_compute_mode_clock_rgb_10bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_hdmi_compute_mode_clock_rgb_10bpc_vic_1(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_hdmi_compute_mode_clock_rgb_12bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_hdmi_compute_mode_clock_rgb_12bpc_vic_1(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_hdmi_compute_mode_clock_rgb_double(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_compute_mode_clock_yuv420_valid(test: *mut kunit) {
    ...
    struct drm_device *drm = &priv.drm;
    unsigned long long rate;
    let mut vic: c_uint = *(unsigned int *)test.param_value;
...
#[no_mangle]
unsafe extern "C" fn drm_hdmi_compute_mode_clock_yuv420_vic_desc(vic: *const c_uint, desc: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_compute_mode_clock_yuv420_10_bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_compute_mode_clock_yuv420_12_bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_compute_mode_clock_yuv422_8_bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_compute_mode_clock_yuv422_10_bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_connector_hdmi_compute_mode_clock_yuv422_12_bpc(test: *mut kunit) {
