...
//! Source: drivers/gpu/drm/tests/drm_gem_shmem_test.c
#![no_std]
...
pub const TEST_BYTE: c_uint = 0xae;
//
...
//
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_test_obj_create(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_test_obj_create_private(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_test_pin_pages(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_test_vmap(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_test_get_sg_table(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_test_get_pages_sgt(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_test_madvise(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_test_purge(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_gem_shmem_test_init(test: *mut kunit) -> c_int {
