...
//! Source: drivers/gpu/drm/tests/drm_bridge_test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_bridge_init_priv {
    pub drm: drm_device,
// @dev: device, only for tests not needing a whole drm_device
    ...
    pub test_bridge: *mut drm_bridge_priv,
...
#[no_mangle]
unsafe extern "C" fn drm_test_bridge_priv_destroy(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn dummy_clear_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fmt_in_list(fmt: u32, out_fmts: *const u32, num_fmts: usize) -> bool {
...
#[no_mangle]
unsafe extern "C" fn drm_test_bridge_clear_infoframe_stub(bridge: *mut drm_bridge) -> c_int {
    ...
    if (ret)
    return ERR_PTR(ret);
    ret = drm_bridge_attach(enc, bridge, core::ptr::null_mut(), 0);
    if (ret)
    return ERR_PTR(ret);
    ...
    priv.plane = drm_kunit_helper_create_primary_plane(test, drm, core::ptr::null_mut(), core::ptr::null_mut(),
    core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (IS_ERR(priv.plane))
    return ERR_CAST(priv.plane);
    priv.crtc = drm_kunit_helper_create_crtc(test, drm, priv.plane, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut());
    if (IS_ERR(priv.crtc))
    return ERR_CAST(priv.crtc);
    enc = &priv.encoder;
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_bridge_get_current_state_atomic(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_bridge_helper_reset_crtc_atomic(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_bridge_helper_reset_crtc_atomic_disabled(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_bridge_helper_hdmi_output_bus_fmts(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_bridge_alloc_init(test: *mut kunit) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_bridge_alloc_basic(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_drm_bridge_alloc_get_put(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_bridge_rgb_yuv_rgb(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_bridge_must_convert_to_yuv444(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_bridge_hdmi_auto_rgb(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_bridge_auto_first(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_bridge_rgb_yuv_no_path(test: *mut kunit) {
