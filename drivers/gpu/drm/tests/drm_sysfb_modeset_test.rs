...
//! Source: drivers/gpu/drm/tests/drm_sysfb_modeset_test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sysfb_build_fourcc_list_case {
    pub name: *const c_char,
    pub native_fourccs: [u32; TEST_BUF_SIZE],
    pub native_fourccs_size: usize,
    pub expected: [u32; TEST_BUF_SIZE],
    pub expected_fourccs_size: usize,
}
...
#[no_mangle]
unsafe extern "C" fn sysfb_build_fourcc_list_case_desc(t: *mut sysfb_build_fourcc_list_case, desc: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_sysfb_build_fourcc_list(test: *mut kunit) {
