...
//! Source: drivers/gpu/drm/tests/drm_hdmi_state_helper_test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_atomic_helper_connector_hdmi_priv {
    pub drm: drm_device,
    pub plane: *mut drm_plane,
    pub crtc: *mut drm_crtc,
    pub encoder: drm_encoder,
    pub connector: drm_connector,
    pub current_edid: *const c_void,
    pub current_edid_len: usize,
    pub hdmi_update_failures: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn dummy_connector_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_hdmi_connector_reset(connector: *mut drm_connector) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_broadcast_rgb_crtc_mode_changed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_broadcast_rgb_crtc_mode_not_changed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_broadcast_rgb_auto_cea_mode(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_broadcast_rgb_auto_cea_mode_vic_1(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_broadcast_rgb_full_cea_mode(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_broadcast_rgb_full_cea_mode_vic_1(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_broadcast_rgb_limited_cea_mode(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_broadcast_rgb_limited_cea_mode_vic_1(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_broadcast_rgb_cea_mode_yuv420(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_output_bpc_crtc_mode_changed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_output_bpc_crtc_mode_not_changed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_output_bpc_dvi(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_tmds_char_rate_rgb_8bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_tmds_char_rate_rgb_10bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_tmds_char_rate_rgb_12bpc(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_hdmi_funcs_reject_rate(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_max_tmds_rate_bpc_fallback_rgb(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_max_tmds_rate_bpc_fallback_yuv420(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_max_tmds_rate_bpc_fallback_ignore_yuv422(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_max_tmds_rate_bpc_fallback_ignore_yuv420(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_driver_unsupported_fallback_yuv420(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_output_bpc_format_vic_1(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_output_bpc_format_driver_rgb_only(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_output_bpc_format_display_rgb_only(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_output_bpc_format_driver_8bpc_only(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_output_bpc_format_display_8bpc_only(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_check_disable_connector(test: *mut kunit) {
    ...
    ret = drm_atomic_set_mode_for_crtc(crtc_state, core::ptr::null_mut());
    KUNIT_EXPECT_EQ(test, ret, 0);
    conn_state = drm_atomic_get_connector_state(state, conn);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, conn_state);
    ret = drm_atomic_set_crtc_for_connector(conn_state, core::ptr::null_mut());
    KUNIT_EXPECT_EQ(test, ret, 0);
    ret = drm_atomic_check_only(state);
    KUNIT_ASSERT_EQ(test, ret, 0);
    drm_modeset_drop_locks(&ctx);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct color_format_test_param {
    pub fmt: enum drm_connector_color_format,
    pub expected: enum drm_output_color_format,
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_hdmi_color_format(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_hdmi_color_format_420_only(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_broadcast_rgb_value(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_bpc_8_value(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_bpc_10_value(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_bpc_12_value(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_format_value(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_tmds_char_value(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_mode_valid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_mode_valid_reject_rate(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_mode_valid_reject(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_mode_valid_reject_max_clock(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_mode_valid_yuv420_only_max_clock(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_infoframes(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_reject_avi_infoframe(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_reject_hdr_infoframe_bpc_8(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_reject_hdr_infoframe_bpc_10(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_test_check_reject_audio_infoframe(test: *mut kunit) {
