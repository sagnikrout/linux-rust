...
//! Source: drivers/gpu/drm/tests/drm_damage_helper_test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_damage_mock {
    pub driver: drm_driver,
    pub device: drm_device,
    pub obj_props: drm_object_properties,
    pub plane: drm_plane,
    pub prop: drm_property,
    pub fb: drm_framebuffer,
    pub state: drm_plane_state,
    pub old_state: drm_plane_state,
}

#[no_mangle]
unsafe extern "C" fn drm_damage_helper_init(test: *mut kunit) -> c_int {
...
// just enough so that drm_plane_enable_fb_damage_clips() works
    ...
    let mut state: drm_plane_state = mock.state;
//
// Round down x1/y1 and round up x2/y2. This is because damage is not in
// 16.16 fixed point so to catch all pixels.
//
    let mut src_x1: c_int = state.src.x1 >> 16;
    let mut src_y1: c_int = state.src.y1 >> 16;
    let mut src_x2: c_int = (state.src.x2 >> 16) + !!(state.src.x2 & 0xFFFF);
    let mut src_y2: c_int = (state.src.y2 >> 16) + !!(state.src.y2 & 0xFFFF);
    if (x1 >= x2 || y1 >= y2)
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_no_damage(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_no_damage_fractional_src(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_no_damage_src_moved(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_no_damage_fractional_src_moved(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_no_damage_not_visible(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_no_damage_no_crtc(test: *mut kunit) {
    ...
    struct drm_rect clip;
    let mut num_hits: u32 = 0;
    mock.state.crtc = core::ptr::null_mut();
    set_plane_src(&mock.old_state, 0, 0, 1024 << 16, 768 << 16);
    set_plane_src(&mock.state, 0, 0, 1024 << 16, 768 << 16);
    drm_atomic_helper_damage_iter_init(&iter, &mock.old_state, &mock.state);
    drm_atomic_for_each_plane_damage(&iter, &clip)
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_no_damage_no_fb(test: *mut kunit) {
    ...
    struct drm_rect clip;
    let mut num_hits: u32 = 0;
    mock.state.fb = core::ptr::null_mut();
    set_plane_src(&mock.old_state, 0, 0, 1024 << 16, 768 << 16);
    set_plane_src(&mock.state, 0, 0, 1024 << 16, 768 << 16);
    drm_atomic_helper_damage_iter_init(&iter, &mock.old_state, &mock.state);
    drm_atomic_for_each_plane_damage(&iter, &clip)
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_simple_damage(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_single_damage(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_single_damage_intersect_src(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_single_damage_outside_src(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_single_damage_fractional_src(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_single_damage_intersect_fractional_src(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_single_damage_outside_fractional_src(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_single_damage_src_moved(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_single_damage_fractional_src_moved(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_damage(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_damage_one_intersect(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_damage_one_outside(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_damage_src_moved(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_damage_iter_damage_not_visible(test: *mut kunit) {
