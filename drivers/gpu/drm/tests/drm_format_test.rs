...
//! Source: drivers/gpu/drm/tests/drm_format_test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_block_width_invalid(test: *mut kunit) {
    static void drm_test_format_block_width_invalid(struct kunit *test)
    {
    const struct drm_format_info *info = core::ptr::null_mut();
    KUNIT_EXPECT_EQ(test, drm_format_info_block_width(info, 0), 0);
    KUNIT_EXPECT_EQ(test, drm_format_info_block_width(info, -1), 0);
    KUNIT_EXPECT_EQ(test, drm_format_info_block_width(info, 1), 0);
    }
#[no_mangle]
unsafe extern "C" fn drm_test_format_block_width_one_plane(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_block_width_two_plane(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_block_width_three_plane(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_block_width_tiled(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_block_height_invalid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_block_height_one_plane(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_block_height_two_plane(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_block_height_three_plane(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_block_height_tiled(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_min_pitch_invalid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_min_pitch_one_plane_8bpp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_min_pitch_one_plane_16bpp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_min_pitch_one_plane_24bpp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_min_pitch_one_plane_32bpp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_min_pitch_two_plane(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_min_pitch_three_plane_8bpp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_format_min_pitch_tiled(test: *mut kunit) {
