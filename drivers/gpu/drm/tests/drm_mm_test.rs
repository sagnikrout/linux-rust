...
//! Source: drivers/gpu/drm/tests/drm_mm_test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn assert_no_holes(test: *mut kunit, mm: *const drm_mm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn assert_one_hole(test: *mut kunit, mm: *const drm_mm, start: u64, end: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn misalignment(node: *mut drm_mm_node, alignment: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn drm_test_mm_init(test: *mut kunit) {
    static void drm_test_mm_init(struct kunit *test)
    {
    let mut size: c_uint = 4096;
    struct drm_mm mm;
...
#[no_mangle]
unsafe extern "C" fn drm_test_mm_debug(test: *mut kunit) {
    static void drm_test_mm_debug(struct kunit *test)
    {
    let mut p: drm_printer = drm_dbg_printer(core::ptr::null_mut(), DRM_UT_CORE, test.name);
    struct drm_mm mm;
...
#[no_mangle]
unsafe extern "C" fn drm_test_mm_align_pot(test: *mut kunit, max: c_int) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_mm_align32(test: *mut kunit) {
    static void drm_test_mm_align32(struct kunit *test)
    {
    drm_test_mm_align_pot(test, 32);
    }
#[no_mangle]
unsafe extern "C" fn drm_test_mm_align64(test: *mut kunit) {
    static void drm_test_mm_align64(struct kunit *test)
    {
    drm_test_mm_align_pot(test, 64);
    }
#[no_mangle]
unsafe extern "C" fn drm_test_mm_once(test: *mut kunit, mode: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_mm_lowest(test: *mut kunit) {
    static void drm_test_mm_lowest(struct kunit *test)
    {
    drm_test_mm_once(test, DRM_MM_INSERT_LOW);
    }
#[no_mangle]
unsafe extern "C" fn drm_test_mm_highest(test: *mut kunit) {
