...
//! Source: drivers/gpu/drm/tests/drm_kunit_helpers.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_kunit_helper_free_device(test: *mut kunit, dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn kunit_action_drm_atomic_commit_put(ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kunit_action_drm_mode_destroy(ptr: *mut c_void) {
    static void kunit_action_drm_mode_destroy(void *ptr)
    {
    struct drm_display_mode *mode = ptr;
    drm_mode_destroy(core::ptr::null_mut(), mode);
    }
//
