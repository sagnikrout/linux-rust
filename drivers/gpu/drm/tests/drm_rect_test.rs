...
//! Source: drivers/gpu/drm/tests/drm_rect_test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn drm_test_rect_clip_scaled_div_by_zero(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_rect_clip_scaled_not_clipped(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_rect_clip_scaled_clipped(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_rect_clip_scaled_signed_vs_unsigned(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_rect_intersect_case {
    pub description: *const c_char,
    pub r2: drm_rect r1,,
    pub should_be_visible: bool,
    pub expected_intersection: drm_rect,
}
...
#[no_mangle]
unsafe extern "C" fn drm_rect_intersect_case_desc(t: *const drm_rect_intersect_case, desc: *mut c_char) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_rect_scale_case {
    pub name: *const c_char,
    pub dst: drm_rect src,,
    pub max_range: int min_range,,
    pub expected_scaling_factor: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn drm_rect_scale_case_desc(t: *const drm_rect_scale_case, desc: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_rect_calc_hscale(test: *mut kunit) {
    static void drm_test_rect_calc_hscale(struct kunit *test)
    {
    const struct drm_rect_scale_case *params = test.param_value;
    let mut expected_warnings: c_int = params.expected_scaling_factor == -EINVAL;
    let mut scaling_factor: c_int = INT_MIN;
//
...
#[no_mangle]
unsafe extern "C" fn drm_test_rect_calc_vscale(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_rect_rotate_case {
    pub name: *const c_char,
    pub rotation: c_uint,
    pub rect: drm_rect,
    pub height: int width,,
    pub expected: drm_rect,
}
...
#[no_mangle]
unsafe extern "C" fn drm_rect_rotate_case_desc(t: *const drm_rect_rotate_case, desc: *mut c_char) {
