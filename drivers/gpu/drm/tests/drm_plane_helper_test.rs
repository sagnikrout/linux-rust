...
//! Source: drivers/gpu/drm/tests/drm_plane_helper_test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_check_plane_state_test {
    ...
    pub w: c_uint,
    pub h: c_uint,
    pub src_expected: } src,,
    struct {
    pub x: c_int,
    pub y: c_int,
    pub w: c_uint,
    pub h: c_uint,
    pub crtc_expected: } crtc,,
    pub rotation: c_uint,
    pub min_scale: c_int,
    pub max_scale: c_int,
...
#[no_mangle]
unsafe extern "C" fn drm_plane_helper_init(test: *mut kunit) -> c_int {
    ...
    {
    let mut expected: drm_rect = DRM_RECT_INIT(src_x, src_y, src_w, src_h);
    ...
    {
    let mut expected: drm_rect = DRM_RECT_INIT(crtc_x, crtc_y, crtc_w, crtc_h);
...
#[no_mangle]
unsafe extern "C" fn drm_test_check_plane_state(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_check_invalid_plane_state(test: *mut kunit) {
