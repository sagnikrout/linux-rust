...
//! Source: drivers/gpu/drm/tests/drm_format_helper_test.c
#![no_std]
...
pub const TEST_BUF_SIZE: c_int = 50;
pub const TEST_USE_DEFAULT_PITCH: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_to_gray8_result {
    pub dst_pitch: c_uint,
    pub expected: [u8; TEST_BUF_SIZE],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_to_rgb332_result {
    pub dst_pitch: c_uint,
    pub expected: [u8; TEST_BUF_SIZE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_to_rgb565_result {
    pub dst_pitch: c_uint,
    pub expected: [u16; TEST_BUF_SIZE],
    pub expected_swab: [u16; TEST_BUF_SIZE],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_to_xrgb1555_result {
    pub dst_pitch: c_uint,
    pub expected: [u16; TEST_BUF_SIZE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_to_argb1555_result {
    pub dst_pitch: c_uint,
    pub expected: [u16; TEST_BUF_SIZE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_to_rgba5551_result {
    pub dst_pitch: c_uint,
    pub expected: [u16; TEST_BUF_SIZE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_to_rgb888_result {
    pub dst_pitch: c_uint,
    pub expected: [u8; TEST_BUF_SIZE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_to_bgr888_result {
    pub dst_pitch: c_uint,
    pub expected: [u8; TEST_BUF_SIZE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_to_argb8888_result {
    pub dst_pitch: c_uint,
    pub expected: [u32; TEST_BUF_SIZE],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_to_xrgb2101010_result {
    pub dst_pitch: c_uint,
    pub expected: [u32; TEST_BUF_SIZE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_to_argb2101010_result {
    pub dst_pitch: c_uint,
    pub expected: [u32; TEST_BUF_SIZE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_to_mono_result {
    pub dst_pitch: c_uint,
    pub expected: [u8; TEST_BUF_SIZE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_to_xbgr8888_result {
    pub dst_pitch: c_uint,
    pub expected: [u32; TEST_BUF_SIZE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_to_abgr8888_result {
    pub dst_pitch: c_uint,
    pub expected: [u32; TEST_BUF_SIZE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_xrgb8888_case {
    pub name: *const c_char,
    pub pitch: c_uint,
    pub clip: drm_rect,
    pub xrgb8888: [u32; TEST_BUF_SIZE],
    pub gray8_result: convert_to_gray8_result,
    pub rgb332_result: convert_to_rgb332_result,
    pub rgb565_result: convert_to_rgb565_result,
    pub xrgb1555_result: convert_to_xrgb1555_result,
    pub argb1555_result: convert_to_argb1555_result,
    pub rgba5551_result: convert_to_rgba5551_result,
    pub rgb888_result: convert_to_rgb888_result,
    pub bgr888_result: convert_to_bgr888_result,
    pub argb8888_result: convert_to_argb8888_result,
    pub xrgb2101010_result: convert_to_xrgb2101010_result,
    pub argb2101010_result: convert_to_argb2101010_result,
    pub mono_result: convert_to_mono_result,
    pub swab_result: fb_swab_result,
    pub xbgr8888_result: convert_to_xbgr8888_result,
    pub abgr8888_result: convert_to_abgr8888_result,
}
...
//
    ...
    {
    u32 *dst = core::ptr::null_mut();
    int n;
    dst = kunit_kzalloc(test, sizeof(*dst) * buf_size, GFP_KERNEL);
    if (!dst)
    return core::ptr::null_mut();
    for (n = 0; n < buf_size; n++)
    dst[n] = le32_to_cpu(( __le32)buf[n]);
    return dst;
    }
    static __le32 *cpubuf_to_le32(struct kunit *test, const u32 *buf, size_t buf_size)
    {
    __le32 *dst = core::ptr::null_mut();
    int n;
    dst = kunit_kzalloc(test, sizeof(*dst) * buf_size, GFP_KERNEL);
    if (!dst)
    return core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_xrgb8888_to_gray8(test: *mut kunit) {
    ...
    __le32 *xrgb8888 = core::ptr::null_mut();
    ...
    core::ptr::null_mut() : &result.dst_pitch;
    drm_fb_xrgb8888_to_gray8(&dst, dst_pitch, &src, &fb, &params.clip, &fmtcnv_state);
    KUNIT_EXPECT_MEMEQ(test, buf, result.expected, dst_size);
    }
#[no_mangle]
unsafe extern "C" fn drm_test_fb_xrgb8888_to_rgb332(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_xrgb8888_to_rgb565(test: *mut kunit) {
    static void drm_test_fb_xrgb8888_to_rgb565(struct kunit *test)
    {
    const struct convert_xrgb8888_case *params = test.param_value;
    const struct convert_to_rgb565_result *result = &params.rgb565_result;
    size_t dst_size;
    u16 *buf = core::ptr::null_mut();
    __le32 *xrgb8888 = core::ptr::null_mut();
    struct iosys_map dst, src;
    struct drm_framebuffer fb = {
    .format = drm_format_info(DRM_FORMAT_XRGB8888),
    ...
    &fmtcnv_state);
    buf = le16buf_to_cpu(test, ( const __le16 *)buf, dst_size / sizeof(__le16));
    KUNIT_EXPECT_MEMEQ(test, buf, result.expected, dst_size);
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_xrgb8888_to_xrgb1555(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_xrgb8888_to_argb1555(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_xrgb8888_to_rgba5551(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_xrgb8888_to_rgb888(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_xrgb8888_to_bgr888(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_xrgb8888_to_argb8888(test: *mut kunit) {
    static void drm_test_fb_xrgb8888_to_argb8888(struct kunit *test)
    {
    const struct convert_xrgb8888_case *params = test.param_value;
    const struct convert_to_argb8888_result *result = &params.argb8888_result;
    size_t dst_size;
    u32 *buf = core::ptr::null_mut();
    __le32 *xrgb8888 = core::ptr::null_mut();
    struct iosys_map dst, src;
    struct drm_framebuffer fb = {
    .format = drm_format_info(DRM_FORMAT_XRGB8888),
    ...
    buf = le32buf_to_cpu(test, ( const __le32 *)buf, dst_size / sizeof(u32));
    KUNIT_EXPECT_MEMEQ(test, buf, result.expected, dst_size);
    buf = dst.vaddr; /* restore original value of buf */
    memset(buf, 0, dst_size);
    drm_fb_xrgb8888_to_argb8888(&dst, dst_pitch, &src, &fb, &params.clip, &fmtcnv_state);
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_xrgb8888_to_xrgb2101010(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_xrgb8888_to_argb2101010(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_xrgb8888_to_mono(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_swab(test: *mut kunit) {
    ...
    buf = dst.vaddr;
    memset(buf, 0, dst_size);
    let mut mock_format: drm_format_info = *fb.format;
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_xrgb8888_to_abgr8888(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_xrgb8888_to_xbgr8888(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clip_offset_case {
    pub name: *const c_char,
    pub pitch: c_uint,
    pub format: u32,
    pub clip: drm_rect,
    pub expected_offset: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn clip_offset_case_desc(t: *mut clip_offset_case, desc: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_clip_offset(test: *mut kunit) {
    ...
    unsigned int offset;
    let mut pitch: c_uint = params.pitch;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fb_memcpy_case {
    pub name: *const c_char,
    pub format: u32,
    pub clip: drm_rect,
    pub src_pitches: [c_uint; DRM_FORMAT_MAX_PLANES],
    pub src: [u32; DRM_FORMAT_MAX_PLANES][TEST_BUF_SIZE],
    pub dst_pitches: [c_uint; DRM_FORMAT_MAX_PLANES],
    pub expected: [u32; DRM_FORMAT_MAX_PLANES][TEST_BUF_SIZE],
}
...
#[no_mangle]
unsafe extern "C" fn fb_memcpy_case_desc(t: *mut fb_memcpy_case, desc: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn drm_test_fb_memcpy(test: *mut kunit) {
    ...
    const unsigned int *dst_pitches = params.dst_pitches[0] == TEST_USE_DEFAULT_PITCH ? core::ptr::null_mut() :
    params.dst_pitches;
