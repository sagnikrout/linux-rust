...
//! Source: drivers/gpu/drm/vboxvideo/hgsmi_base.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn hgsmi_report_flags_location(ctx: *mut gen_pool, location: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hgsmi_send_caps_info(ctx: *mut gen_pool, caps: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hgsmi_test_query_conf(ctx: *mut gen_pool) -> c_int {
    ...
    if (ret)
    return ret;
    let mut value: return = = U32_MAX ? 0 : -EIO;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn hgsmi_query_conf(ctx: *mut gen_pool, index: u32, value_ret: *mut u32) -> c_int {
