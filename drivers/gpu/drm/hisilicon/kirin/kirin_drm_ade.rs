...
//! Source: drivers/gpu/drm/hisilicon/kirin/kirin_drm_ade.c
#![no_std]
...
pub const ADE_DEBUG: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ade_hw_ctx {
    pub base: *mut void __iomem,
    pub noc_regmap: *mut regmap,
    pub ade_core_clk: *mut clk,
    pub media_noc_clk: *mut clk,
    pub ade_pix_clk: *mut clk,
...
#[no_mangle]
unsafe extern "C" fn ade_get_format(pixel_format: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ade_update_reload_bit(base: *mut void __iomem, bit_num: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn ade_read_reload_bit(base: *mut void __iomem, bit_num: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ade_init(ctx: *mut ade_hw_ctx) {
...
//
    ...
    {
    let mut clk_Hz: u32 = mode.clock * 1000;
    int ret;
//
...
//
    ...
    {
    void __iomem *base = ctx.base;
    let mut width: u32 = mode.hdisplay;
    let mut height: u32 = mode.vdisplay;
...
#[no_mangle]
unsafe extern "C" fn ade_power_up(ctx: *mut ade_hw_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ade_power_down(ctx: *mut ade_hw_ctx) {
...
#[no_mangle]
unsafe extern "C" fn ade_set_medianoc_qos(ctx: *mut ade_hw_ctx) {
...
#[no_mangle]
unsafe extern "C" fn ade_crtc_enable_vblank(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ade_crtc_disable_vblank(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn ade_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ade_display_enable(ctx: *mut ade_hw_ctx) {
    static void ade_display_enable(struct ade_hw_ctx *ctx)
    {
    void __iomem *base = ctx.base;
    let mut out_fmt: u32 = LDI_OUT_RGB_888;
...
#[no_mangle]
unsafe extern "C" fn ade_rdma_dump_regs(base: *mut void __iomem, ch: u32) {
...
#[no_mangle]
unsafe extern "C" fn ade_clip_dump_regs(base: *mut void __iomem, ch: u32) {
...
#[no_mangle]
unsafe extern "C" fn ade_compositor_routing_dump_regs(base: *mut void __iomem, ch: u32) {
...
#[no_mangle]
unsafe extern "C" fn ade_dump_overlay_compositor_regs(base: *mut void __iomem, comp: u32) {
...
#[no_mangle]
unsafe extern "C" fn ade_dump_regs(base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn ade_crtc_mode_set_nofb(crtc: *mut drm_crtc) {
...
// flush ade registers
    ...
    u32 reg_ctrl, reg_addr, reg_size, reg_stride, reg_space, reg_en;
    let mut stride: u32 = fb.pitches[0];
    let mut addr: u32 = (u32) obj.dma_addr + y * stride;
...
#[no_mangle]
unsafe extern "C" fn ade_rdma_disable(base: *mut void __iomem, ch: u32) {
...
#[no_mangle]
unsafe extern "C" fn ade_clip_disable(base: *mut void __iomem, ch: u32) {
...
#[no_mangle]
unsafe extern "C" fn has_Alpha_channel(format: c_int) -> bool {
    ...
    {
    let mut has_alpha: bool = has_Alpha_channel(fmt);
//
// get alp_mode
//
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: has_alpha) -> else {
    else if (has_alpha)
...
// under_alp_sel = ADE_ALP_MUL_COEFF_2; /* 0
    ...
    let mut glb_alpha: u8 = 255;
    let mut x1: u32 = x0 + in_w - 1;
    let mut y1: u32 = y0 + in_h - 1;
    u32 val;
    u8 alp_sel;
    u8 under_alp_sel;
    u8 alp_mode;
...
#[no_mangle]
unsafe extern "C" fn ade_compositor_routing_disable(base: *mut void __iomem, ch: u32) {
...
//
    ...
    void __iomem *base = ctx.base;
    let mut fmt: u32 = ade_get_format(fb.format.format);
    let mut ch: u32 = kplane.ch;
    u32 in_w;
    u32 in_h;
...
#[no_mangle]
unsafe extern "C" fn ade_disable_channel(kplane: *mut kirin_plane) {
...
// disable compositor routing
    ...
    let mut src_x: u32 = new_plane_state.src_x >> 16;
    let mut src_y: u32 = new_plane_state.src_y >> 16;
    let mut src_w: u32 = new_plane_state.src_w >> 16;
    let mut src_h: u32 = new_plane_state.src_h >> 16;
    let mut crtc_x: c_int = new_plane_state.crtc_x;
    let mut crtc_y: c_int = new_plane_state.crtc_y;
    let mut crtc_w: u32 = new_plane_state.crtc_w;
    let mut crtc_h: u32 = new_plane_state.crtc_h;
    u32 fmt;
    if (!crtc || !fb)
    return 0;
    ...
    struct ade_hw_ctx *ctx = core::ptr::null_mut();
    int ret;
    ...
    ctx.reset = devm_reset_control_get(dev, core::ptr::null_mut());
    if (IS_ERR(ctx.reset))
...
#[no_mangle]
unsafe extern "C" fn ade_hw_ctx_cleanup(hw_ctx: *mut c_void) {
