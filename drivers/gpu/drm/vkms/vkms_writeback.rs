...
//! Source: drivers/gpu/drm/vkms/vkms_writeback.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vkms_wb_connector_get_modes(connector: *mut drm_connector) -> c_int {
    ...
    let mut crtc_height: u16 = crtc_state.base.mode.vdisplay;
    let mut crtc_width: u16 = crtc_state.base.mode.hdisplay;
    struct vkms_writeback_job *active_wb;
    struct vkms_frame_info *wb_frame_info;
    let mut wb_format: u32 = fb.format.format;
    if (!conn_state)
    return;
    ...
    core::ptr::null_mut(), DRM_MODE_ENCODER_VIRTUAL, core::ptr::null_mut());
    if (ret)
    return ret;
