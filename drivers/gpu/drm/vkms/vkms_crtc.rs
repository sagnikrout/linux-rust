...
//! Source: drivers/gpu/drm/vkms/vkms_crtc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vkms_crtc_handle_vblank_timeout(crtc: *mut drm_crtc) -> bool {
    ...
    let mut frame: u64 = drm_crtc_accurate_vblank_count(crtc);
...
#[no_mangle]
unsafe extern "C" fn vkms_atomic_crtc_reset(crtc: *mut drm_crtc) {
...
//
    ...
    primary, cursor,
    &vkms_crtc_funcs, core::ptr::null_mut());
    if (IS_ERR(vkms_out)) {
