...
//! Source: drivers/gpu/drm/vkms/tests/vkms_config_test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vkms_config_get_num_planes(config: *mut vkms_config) -> usize {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_get_num_encoders(config: *mut vkms_config) -> usize {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_get_num_connectors(config: *mut vkms_config) -> usize {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct default_config_case {
    pub enable_cursor: bool,
    pub enable_writeback: bool,
    pub enable_overlay: bool,
    pub enable_plane_pipeline: bool,
}

#[no_mangle]
unsafe extern "C" fn vkms_config_test_empty_config(test: *mut kunit) {
...
// The dev_name string and the config have different lifetimes
    ...
    KUNIT_ARRAY_PARAM(default_config, default_config_cases, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn vkms_config_test_default_config(test: *mut kunit) {
    ...
    struct vkms_config_plane *plane_cfg;
    struct vkms_config_crtc *crtc_cfg;
    let mut n_primaries: c_int = 0;
    let mut n_cursors: c_int = 0;
    let mut n_overlays: c_int = 0;
...
// CRTCs
    ...
    let mut n_possible_crtcs: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_get_planes(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_get_crtcs(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_invalid_plane_number(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_valid_plane_type(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_valid_plane_possible_crtcs(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_invalid_crtc_number(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_invalid_encoder_number(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_valid_encoder_possible_crtcs(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_invalid_connector_number(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_valid_connector_possible_encoders(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_attach_different_configs(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_plane_attach_crtc(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_plane_get_possible_crtcs(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_encoder_get_possible_crtcs(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_connector_get_possible_encoders(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_config_test_connector_status(test: *mut kunit) {
