...
//! Source: drivers/gpu/drm/vkms/tests/vkms_color_test.c
#![no_std]
...
pub const TEST_LUT_SIZE: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vkms_color_test_lerp_params {
    pub t: i64,
    pub a: __u16,
    pub b: __u16,
    pub expected: __u16,
...
#[no_mangle]
unsafe extern "C" fn vkms_color_test_get_lut_index(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_color_test_lerp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_color_test_linear(test: *mut kunit) {
    static void vkms_color_test_linear(struct kunit *test)
    {
    for (int i = 0; i < LUT_SIZE; i++) {
    let mut linear: c_int = apply_lut_to_channel_value(&linear_eotf, i * 0x101, LUT_RED);
    KUNIT_EXPECT_EQ(test, DIV_ROUND_CLOSEST(linear, 0x101), i);
    }
    }
#[no_mangle]
unsafe extern "C" fn vkms_color_srgb_inv_srgb(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_color_ctm_3x4_50_desat(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vkms_color_ctm_3x4_bt709(test: *mut kunit) {
