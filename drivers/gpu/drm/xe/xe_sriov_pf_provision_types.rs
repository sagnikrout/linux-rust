...
//! Source: drivers/gpu/drm/xe/xe_sriov_pf_provision_types.h
#![no_std]
...
pub enum xe_sriov_provisioning_mode {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xe_sriov_pf_provision {
// @mode: selected provisioning mode.
    pub mode: xe_sriov_provisioning_mode,
}
