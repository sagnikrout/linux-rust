...
//! Source: drivers/gpu/drm/xe/tests/xe_guc_id_mgr_test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn guc_id_mgr_test_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bad_init(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn no_init(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn init_fini(test: *mut kunit) {
    ...
    __fini_idm(core::ptr::null_mut(), idm);
    KUNIT_EXPECT_NULL(test, idm.bitmap);
    KUNIT_EXPECT_EQ(test, idm.total, 0);
    }
#[no_mangle]
unsafe extern "C" fn check_used(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn check_quota(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn check_all(test: *mut kunit) {
