...
//! Source: drivers/gpu/drm/xe/tests/xe_mocs.c
#![no_std]
...
pub struct live_mocs {
    pub table: xe_mocs_info,
}

#[no_mangle]
unsafe extern "C" fn live_mocs_init(arg: *mut live_mocs, gt: *mut xe_gt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mocs_kernel_test_run_device(xe: *mut xe_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xe_live_mocs_kernel_kunit(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn mocs_reset_test_run_device(xe: *mut xe_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xe_live_mocs_reset_kunit(test: *mut kunit) {
