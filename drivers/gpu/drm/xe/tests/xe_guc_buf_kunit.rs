...
//! Source: drivers/gpu/drm/xe/tests/xe_guc_buf_kunit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn guc_buf_test_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_smallest(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_largest(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_granular(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_unique(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_overlap(test: *mut kunit) {
    static void test_overlap(struct kunit *test)
    {
    struct xe_guc_buf_cache *cache = test.priv;
    struct xe_guc_buf b1, b2;
    let mut dwords: u32 = xe_guc_buf_cache_dwords(cache) / 2;
    let mut bytes: u32 = dwords * sizeof(u32);
    void *p1, *p2;
    u64 a1, a2;
...
#[no_mangle]
unsafe extern "C" fn test_reusable(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_too_big(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_flush(test: *mut kunit) {
    static void test_flush(struct kunit *test)
    {
    struct xe_guc_buf_cache *cache = test.priv;
    struct xe_guc_buf buf;
    let mut dwords: u32 = xe_guc_buf_cache_dwords(cache);
    let mut bytes: u32 = dwords * sizeof(u32);
    u32 *s, *p, *d;
    int n;
...
#[no_mangle]
unsafe extern "C" fn test_lookup(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_data(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_class(test: *mut kunit) {
