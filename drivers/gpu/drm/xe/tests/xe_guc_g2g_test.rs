...
//! Source: drivers/gpu/drm/xe/tests/xe_guc_g2g_test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn slot_index_from_gts(tx_gt: *mut xe_gt, rx_gt: *mut xe_gt) -> c_int {
    static int slot_index_from_gts(struct xe_gt *tx_gt, struct xe_gt *rx_gt)
    {
    struct xe_device *xe = gt_to_xe(tx_gt);
    let mut idx: c_int = 0, found = 0, id, tx_idx, rx_idx;
    struct xe_gt *gt;
...
//
#[no_mangle]
pub unsafe extern "C" fn xe_guc_g2g_test_notification(guc: *mut xe_guc, msg: *mut u32, len: u32) -> c_int {
    int xe_guc_g2g_test_notification(struct xe_guc *guc, u32 *msg, u32 len)
    {
    struct xe_device *xe = guc_to_xe(guc);
    struct xe_gt *rx_gt = guc_to_gt(guc), *test_gt, *tx_gt = core::ptr::null_mut();
...
pub const G2G_WAIT_TIMEOUT_MS: c_int = 100;
pub const G2G_WAIT_POLL_MS: c_int = 1;
//
// Send the given seqno from all GuCs to all other GuCs in tile/GT order
//
#[no_mangle]
unsafe extern "C" fn g2g_test_in_order(test: *mut kunit, xe: *mut xe_device, seqno: u32) {
    ...
    let mut near_tile: u32 = gt_to_tile(near_gt).id;
    let mut near_dev: u32 = G2G_DEV(near_gt);
    for_each_gt(far_gt, xe, j) {
    let mut far_tile: u32 = gt_to_tile(far_gt).id;
    let mut far_dev: u32 = G2G_DEV(far_gt);
    struct g2g_test_payload payload;
...
pub const WAIT_TIME_MS: c_int = 100;

#[no_mangle]
unsafe extern "C" fn g2g_wait_for_complete(_xe: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn g2g_clean_array(_xe: *mut c_void) {
    static void g2g_clean_array(void *_xe)
    {
    struct xe_device *xe = (struct xe_device *)_xe;
    xe.g2g_test_array = core::ptr::null_mut();
    }
pub const NUM_LOOPS: c_int = 16;
#[no_mangle]
unsafe extern "C" fn g2g_run_test(test: *mut kunit, xe: *mut xe_device) {
...
// Check for the final seqno in each slot
    ...
    let mut idx: u32 = (j * xe.info.gt_count) + i;
    if (i == j)
...
#[no_mangle]
unsafe extern "C" fn g2g_ct_stop(guc: *mut xe_guc) {
...
#[no_mangle]
unsafe extern "C" fn g2g_ctb_size(test: *mut kunit, xe: *mut xe_device) -> u32 {
    static u32 g2g_ctb_size(struct kunit *test, struct xe_device *xe)
    {
    let mut count: c_uint = xe.info.gt_count;
    let mut num_channels: u32 = (count * (count - 1)) / 2;
...
//
#[no_mangle]
unsafe extern "C" fn g2g_alloc_default(test: *mut kunit, xe: *mut xe_device) {
...
#[no_mangle]
unsafe extern "C" fn g2g_distribute(test: *mut kunit, xe: *mut xe_device, bo: *mut xe_bo) {
...
//
#[no_mangle]
unsafe extern "C" fn g2g_alloc_host(test: *mut kunit, xe: *mut xe_device) {
...
//
#[no_mangle]
unsafe extern "C" fn g2g_alloc_tile(test: *mut kunit, xe: *mut xe_device, tile: *mut xe_tile) {
...
#[no_mangle]
unsafe extern "C" fn g2g_free(test: *mut kunit, xe: *mut xe_device) {
    ...
    gt.uc.guc.g2g.bo = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn g2g_stop(test: *mut kunit, xe: *mut xe_device) {
...
//
    ...
    {
    let mut near: u32 = near_tile, far = far_tile;
    let mut idx: u32 = 0, x, y, direction;
    int i;
    if (have_dev) {
...
#[no_mangle]
unsafe extern "C" fn g2g_register_flat(guc: *mut xe_guc, far_tile: u32, far_dev: u32, type: u32, have_dev: bool) -> c_int {
    static int g2g_register_flat(struct xe_guc *guc, u32 far_tile, u32 far_dev, u32 type, bool have_dev)
    {
    struct xe_gt *gt = guc_to_gt(guc);
    struct xe_device *xe = gt_to_xe(gt);
    let mut near_tile: u32 = gt_to_tile(gt).id;
    let mut near_dev: u32 = G2G_DEV(gt);
    let mut max: u32 = xe.info.gt_count;
    int idx;
    u32 base, desc, buf;
    if (!guc.g2g.bo)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn g2g_start(test: *mut kunit, guc: *mut xe_guc) {
...
#[no_mangle]
unsafe extern "C" fn g2g_reinit(test: *mut kunit, xe: *mut xe_device, ctb_type: c_int, tile: *mut xe_tile) {
...
#[no_mangle]
unsafe extern "C" fn g2g_recreate_ctb(_xe: *mut c_void) {
    ...
    g2g_reinit(test, xe, G2G_CTB_TYPE_DEFAULT, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn g2g_pm_runtime_put(_xe: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn g2g_pm_runtime_get(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn g2g_check_skip(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn xe_live_guc_g2g_kunit_default(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn xe_live_guc_g2g_kunit_allmem(test: *mut kunit) {
...
// Make sure to leave the system as we found it
    ...
    g2g_reinit(test, xe, G2G_CTB_TYPE_HOST, core::ptr::null_mut());
    g2g_run_test(test, xe);
    if (IS_DGFX(xe)) {
    struct xe_tile *tile;
    int id;
