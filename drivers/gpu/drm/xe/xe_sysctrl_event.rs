...
//! Source: drivers/gpu/drm/xe/xe_sysctrl_event.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_pending_event(sc: *mut xe_sysctrl, command: *mut xe_sysctrl_mailbox_command) {
    ...
    let mut count: u32 = XE_SYSCTRL_FLOOD_LIMIT;
    size_t len;
    int ret;
    do {
...
//
#[no_mangle]
pub unsafe extern "C" fn xe_sysctrl_event(sc: *mut xe_sysctrl) {
    void xe_sysctrl_event(struct xe_sysctrl *sc)
    {
    let mut command: xe_sysctrl_mailbox_command = {};
    let mut response: xe_sysctrl_event_response = {};
    let mut request: xe_sysctrl_event_request = {};
    let mut header: xe_sysctrl_app_msg_hdr = {};
