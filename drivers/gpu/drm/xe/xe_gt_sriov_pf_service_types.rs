...
//! Source: drivers/gpu/drm/xe/xe_gt_sriov_pf_service_types.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xe_gt_sriov_pf_service_version {
    pub major: u16,
    pub minor: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xe_gt_sriov_pf_service_runtime_regs {
    pub regs: *const xe_reg,
    pub values: *mut u32,
    pub size: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xe_gt_sriov_pf_service {
    pub base: xe_gt_sriov_pf_service_version,
    pub latest: xe_gt_sriov_pf_service_version,
    pub version: },
    pub runtime: xe_gt_sriov_pf_service_runtime_regs,
}
