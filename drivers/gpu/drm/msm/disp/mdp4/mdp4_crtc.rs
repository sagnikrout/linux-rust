...
//! Source: drivers/gpu/drm/msm/disp/mdp4/mdp4_crtc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mdp4_crtc {
    pub base: drm_crtc,
    pub name: [c_char; 8],
    pub ovlp: c_int,
    pub dma: enum mdp4_dma,
    pub enabled: bool,
...
// next cursor to scan-out:
    pub next_iova: u32,
    pub next_bo: *mut drm_gem_object,
...
#[no_mangle]
unsafe extern "C" fn crtc_flush(crtc: *mut drm_crtc) {
    ...
    let mut pipe_id: enum mdp4_pipe = mdp4_plane_pipe(plane);
...
unsafe extern "C" fn complete_flip(crtc: *mut drm_crtc, file: *mut drm_file) {
    ...
    if (event) {
    mdp4_crtc.event = core::ptr::null_mut();
...
unsafe extern "C" fn setup_mixer(mdp4_kms: *mut mdp4_kms) {
    ...
    drm_atomic_crtc_for_each_plane(plane, crtc) {
    let mut pipe_id: enum mdp4_pipe = mdp4_plane_pipe(plane);
    let mut idx: c_int = idxs[pipe_id];
...
#[no_mangle]
unsafe extern "C" fn mdp4_crtc_mode_set_nofb(crtc: *mut drm_crtc) {
    static void mdp4_crtc_mode_set_nofb(struct drm_crtc *crtc)
    {
    struct mdp4_crtc *mdp4_crtc = to_mdp4_crtc(crtc);
    struct mdp4_kms *mdp4_kms = get_kms(crtc);
    let mut dma: enum mdp4_dma = mdp4_crtc.dma;
    let mut ovlp: c_int = mdp4_crtc.ovlp;
...
//
#[no_mangle]
unsafe extern "C" fn update_cursor(crtc: *mut drm_crtc) {
    ...
    let mut iova: u64 = mdp4_crtc.cursor.next_iova;
    if (next_bo) {
...
#[no_mangle]
unsafe extern "C" fn mdp4_crtc_cursor_move(crtc: *mut drm_crtc, x: c_int, y: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdp4_crtc_vblank_irq(irq: *mut mdp_irq, irqstatus: u32) {
...
#[no_mangle]
unsafe extern "C" fn mdp4_crtc_err_irq(irq: *mut mdp_irq, irqstatus: u32) {
...
#[no_mangle]
unsafe extern "C" fn mdp4_crtc_wait_for_flush_done(crtc: *mut drm_crtc) {
...
#[no_mangle]
pub unsafe extern "C" fn mdp4_crtc_vblank(crtc: *mut drm_crtc) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn mdp4_crtc_set_config(crtc: *mut drm_crtc, config: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mdp4_crtc_set_intf(crtc: *mut drm_crtc, intf: enum mdp4_intf, mixer: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn mdp4_crtc_wait_for_commit_done(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn mdp4_crtc_flip_cleanup(dev: *mut drm_device, ptr: *mut c_void) {
...
// initialize crtc
    ...
    &mdp4_crtc_funcs, core::ptr::null_mut());
    if (IS_ERR(mdp4_crtc))
