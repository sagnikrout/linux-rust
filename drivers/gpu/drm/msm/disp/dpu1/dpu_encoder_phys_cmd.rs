...
//! Source: drivers/gpu/drm/msm/disp/dpu1/dpu_encoder_phys_cmd.c
#![no_std]
...
pub const PP_TIMEOUT_MAX_TRIALS: c_int = 10;
//
// Tearcheck sync start and continue thresholds are empirically found
// based on common panels In the future, may want to allow panels to override
// these default values
//
pub const DEFAULT_TEARCHECK_SYNC_THRESH_START: c_int = 4;
pub const DEFAULT_TEARCHECK_SYNC_THRESH_CONTINUE: c_int = 4;
    static void dpu_encoder_phys_cmd_enable_te(struct dpu_encoder_phys *phys_enc);
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_cmd_is_master(phys_enc: *mut dpu_encoder_phys) -> bool {
    ...
    let mut cmd_mode_cfg: dpu_hw_intf_cmd_mode_cfg = {};
    ctl = phys_enc.hw_ctl;
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_cmd_pp_tx_done_irq(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_cmd_te_rd_ptr_irq(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_cmd_ctl_start_irq(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_cmd_underrun_irq(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_cmd_irq_enable(phys_enc: *mut dpu_encoder_phys) {
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_cmd_irq_disable(phys_enc: *mut dpu_encoder_phys) {
    ...
    struct dpu_encoder_phys_cmd *cmd_enc =
    to_dpu_encoder_phys_cmd(phys_enc);
    let mut tc_cfg: dpu_hw_tear_check = { 0 };
    struct drm_display_mode *mode;
    let mut tc_enable: bool = true;
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_cmd_enable(phys_enc: *mut dpu_encoder_phys) {
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_cmd_disable(phys_enc: *mut dpu_encoder_phys) {
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_cmd_enable_te(phys_enc: *mut dpu_encoder_phys) {
    static void dpu_encoder_phys_cmd_enable_te(struct dpu_encoder_phys *phys_enc)
    {
    if (!phys_enc)
    return;
...
//
    ...
    struct dpu_encoder_phys_cmd *cmd_enc = core::ptr::null_mut();
    DPU_DEBUG("intf\n");
