...
//! Source: drivers/gpu/drm/msm/disp/dpu1/dpu_encoder_phys_wb.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_wb_is_master(phys_enc: *mut dpu_encoder_phys) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_wb_set_qos(phys_enc: *mut dpu_encoder_phys) {
...
//
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_wb_setup_ctl(phys_enc: *mut dpu_encoder_phys) {
...
//
#[no_mangle]
unsafe extern "C" fn _dpu_encoder_phys_wb_update_flush(phys_enc: *mut dpu_encoder_phys) {
...
//
    ...
    {
    struct dpu_hw_wb *hw_wb = phys_enc.hw_wb;
    let mut mode: drm_display_mode = phys_enc.cached_mode;
    struct dpu_encoder_phys_wb *wb_enc = to_dpu_encoder_phys_wb(phys_enc);
    const struct msm_format *format;
...
//
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_wb_done_irq(arg: *mut c_void) {
    ...
    let mut event: u32 = DPU_ENCODER_FRAME_EVENT_DONE;
    DPU_DEBUG("[wb:%d]\n", hw_wb.idx - WB_0);
...
//
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_wb_irq_enable(phys: *mut dpu_encoder_phys) {
...
//
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_wb_irq_disable(phys: *mut dpu_encoder_phys) {
    ...
    {
    struct dpu_encoder_phys_wb *wb_enc = to_dpu_encoder_phys_wb(phys_enc);
    let mut frame_event: u32 = DPU_ENCODER_FRAME_EVENT_ERROR;
...
//
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_wb_needs_single_flush(phys_enc: *mut dpu_encoder_phys) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_wb_enable(phys_enc: *mut dpu_encoder_phys) {
...
//
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_wb_disable(phys_enc: *mut dpu_encoder_phys) {
...
//
    ...
    wb_enc.wb_job = core::ptr::null_mut();
    wb_enc.wb_conn = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_wb_is_valid_for_commit(phys_enc: *mut dpu_encoder_phys) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_wb_init_ops(ops: *mut dpu_encoder_phys_ops) {
...
//
    ...
    struct dpu_encoder_phys_wb *wb_enc = core::ptr::null_mut();
    DPU_DEBUG("\n");
    if (!p || !p.parent) {
