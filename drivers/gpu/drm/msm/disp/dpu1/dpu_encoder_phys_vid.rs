...
//! Source: drivers/gpu/drm/msm/disp/dpu1/dpu_encoder_phys_vid.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_horizontal_total(timing: *const dpu_hw_intf_timing_params) -> u32 {
    static u32 get_horizontal_total(const struct dpu_hw_intf_timing_params *timing)
    {
    let mut active: u32 = timing.xres;
    u32 inactive =
    timing.h_back_porch + timing.h_front_porch +
...
#[no_mangle]
unsafe extern "C" fn get_vertical_total(timing: *const dpu_hw_intf_timing_params) -> u32 {
    static u32 get_vertical_total(const struct dpu_hw_intf_timing_params *timing)
    {
    let mut active: u32 = timing.yres;
    u32 inactive =
    timing.v_back_porch + timing.v_front_porch +
...
//
    ...
    let mut needed_vfp_lines: u32 = worst_case_needed_lines - start_of_frame_lines;
    let mut actual_vfp_lines: u32 = 0;
...
//
    ...
    const struct dpu_hw_intf_timing_params *timing)
    {
    let mut f: dpu_hw_intf_prog_fetch = { 0 };
    let mut vfp_fetch_lines: u32 = 0;
    let mut horiz_total: u32 = 0;
    let mut vert_total: u32 = 0;
    let mut vfp_fetch_start_vsync_counter: u32 = 0;
    ...
    let mut timing_params: dpu_hw_intf_timing_params = { 0 };
    const struct msm_format *fmt = core::ptr::null_mut();
    u32 fmt_fourcc;
    unsigned long lock_flags;
    let mut intf_cfg: dpu_hw_intf_cfg = { 0 };
    drm_mode_init(&mode, &phys_enc.cached_mode);
    if (!phys_enc.hw_ctl.ops.setup_intf_cfg) {
    DPU_ERROR("invalid encoder %d\n", phys_enc != core::ptr::null_mut());
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_vid_vblank_irq(arg: *mut c_void) {
    static void dpu_encoder_phys_vid_vblank_irq(void *arg)
    {
    struct dpu_encoder_phys *phys_enc = arg;
    struct dpu_hw_ctl *hw_ctl;
    unsigned long lock_flags;
    let mut flush_register: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_vid_underrun_irq(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_vid_enable(phys_enc: *mut dpu_encoder_phys) {
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_vid_disable(phys_enc: *mut dpu_encoder_phys) {
    static void dpu_encoder_phys_vid_disable(struct dpu_encoder_phys *phys_enc)
    {
    unsigned long lock_flags;
    int ret;
    let mut intf_status: dpu_hw_intf_status = {0};
    ...
    phys_enc.hw_intf != core::ptr::null_mut(), phys_enc.hw_ctl != core::ptr::null_mut());
    return;
    }
    if (WARN_ON(!phys_enc.hw_intf.ops.enable_timing))
    return;
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_vid_irq_enable(phys_enc: *mut dpu_encoder_phys) {
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_vid_irq_disable(phys_enc: *mut dpu_encoder_phys) {
    ...
    struct dpu_encoder_phys *phys_enc)
    {
    let mut s: dpu_hw_intf_status = {0};
    let mut fetch_start: u32 = 0;
    struct drm_display_mode mode;
    drm_mode_init(&mode, &phys_enc.cached_mode);
    if (!dpu_encoder_phys_vid_is_master(phys_enc))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn dpu_encoder_phys_vid_init_ops(ops: *mut dpu_encoder_phys_ops) {
...
//
    ...
    {
    struct dpu_encoder_phys *phys_enc = core::ptr::null_mut();
    if (!p) {
