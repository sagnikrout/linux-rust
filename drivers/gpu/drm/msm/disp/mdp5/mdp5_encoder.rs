...
//! Source: drivers/gpu/drm/msm/disp/mdp5/mdp5_encoder.c
#![no_std]
...
//
    ...
    let mut intf: c_int = mdp5_encoder.intf.num;
    uint32_t dtv_hsync_skew, vsync_period, vsync_len, ctrl_pol;
    uint32_t display_v_start, display_v_end;
    uint32_t hsync_start_x, hsync_end_x;
    let mut format: u32 = 0x2100;
    unsigned long flags;
    mode = adjusted_mode;
...
#[no_mangle]
unsafe extern "C" fn mdp5_vid_encoder_disable(encoder: *mut drm_encoder) {
    ...
    let mut intfn: c_int = mdp5_encoder.intf.num;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn mdp5_vid_encoder_enable(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn mdp5_encoder_disable(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn mdp5_encoder_enable(encoder: *mut drm_encoder) {
...
#[no_mangle]
pub unsafe extern "C" fn mdp5_encoder_get_linecount(encoder: *mut drm_encoder) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mdp5_encoder_get_framecount(encoder: *mut drm_encoder) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn mdp5_encoder_set_intf_mode(encoder: *mut drm_encoder, cmd_mode: bool) {
...
// initialize encoder
    ...
    core::ptr::null_mut(), enc_type, core::ptr::null_mut());
