...
//! Source: drivers/gpu/drm/msm/disp/mdp5/mdp5_crtc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mdp5_crtc {
    pub base: drm_crtc,
    pub id: c_int,
    pub enabled: bool,
    pub /: *mut *mut *mut spinlock_t lm_lock; / protect REG_MDP5_LM_ registers,
...
//
    pub flushed_mask: u32,
pub const PENDING_CURSOR: c_uint = 0x1;
pub const PENDING_FLIP: c_uint = 0x2;
    pub pending: core::sync::atomic::AtomicI32,
// for unref'ing cursor bo's after scanout completes:
    pub unref_cursor_work: drm_flip_work,
    pub vblank: mdp_irq,
    pub err: mdp_irq,
    pub pp_done: mdp_irq,
    pub pp_completion: completion,
    pub lm_cursor_enabled: bool,
    struct {
// protect REG_MDP5_LM_CURSOR* registers and cursor scanout_bo
    pub lock: spinlock_t,
// current cursor being scanned out:
    pub scanout_bo: *mut drm_gem_object,
    pub iova: u64,
    pub height: uint32_t width,,
    pub y: int x,,
    pub cursor: },
}
...
#[no_mangle]
unsafe extern "C" fn request_pending(crtc: *mut drm_crtc, pending: u32) {
...
#[no_mangle]
unsafe extern "C" fn request_pp_done_pending(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn crtc_flush(crtc: *mut drm_crtc, flush_mask: u32) -> u32 {
    static u32 crtc_flush(struct drm_crtc *crtc, u32 flush_mask)
    {
    struct mdp5_crtc_state *mdp5_cstate = to_mdp5_crtc_state(crtc.state);
    struct mdp5_ctl *ctl = mdp5_cstate.ctl;
    struct mdp5_pipeline *pipeline = &mdp5_cstate.pipeline;
    let mut start: bool = !mdp5_cstate.defer_start;
...
//
#[no_mangle]
unsafe extern "C" fn crtc_flush_all(crtc: *mut drm_crtc) -> u32 {
    static u32 crtc_flush_all(struct drm_crtc *crtc)
    {
    struct mdp5_crtc_state *mdp5_cstate = to_mdp5_crtc_state(crtc.state);
    struct mdp5_hw_mixer *mixer, *r_mixer;
    struct drm_plane *plane;
    let mut flush_mask: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn complete_flip(crtc: *mut drm_crtc, file: *mut drm_file) {
    ...
    if (event) {
    mdp5_crtc.event = core::ptr::null_mut();
...
// set STAGE_UNUSED for all layers
    mdp5_ctl_blend(ctl, pipeline, core::ptr::null_mut(), core::ptr::null_mut(), 0, 0);
// XXX: What to do here?
// mdp5_crtc->ctl = NULL;
    }
    }
#[no_mangle]
unsafe extern "C" fn unref_cursor_worker(work: *mut drm_flip_work, val: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mdp5_crtc_flip_cleanup(dev: *mut drm_device, ptr: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn mdp5_lm_use_fg_alpha_mask(stage: enum mdp_mixer_stage_id) -> u32 {
...
//
pub const PIPE_LEFT: c_int = 0;
pub const PIPE_RIGHT: c_int = 1;
//
...
//
#[no_mangle]
unsafe extern "C" fn blend_setup(crtc: *mut drm_crtc) {
    ...
    struct drm_plane *plane;
    struct mdp5_plane_state *pstate, *pstates[STAGE_MAX + 1] = {core::ptr::null_mut()};
    const struct msm_format *format;
    struct mdp5_hw_mixer *mixer = pipeline.mixer;
    let mut lm: u32 = mixer.lm;
    struct mdp5_hw_mixer *r_mixer = pipeline.r_mixer;
    let mut r_lm: u32 = r_mixer ? r_mixer.lm : 0;
    struct mdp5_ctl *ctl = mdp5_cstate.ctl;
    ...
    int i, plane_cnt = 0;
    let mut bg_alpha_enabled: bool = false;
    let mut mixer_op_mode: u32 = 0;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn mdp5_crtc_mode_set_nofb(crtc: *mut drm_crtc) {
...
// stime = ktime_get();
    ...
    line -= vactive_start;
#[no_mangle]
pub unsafe extern "C" fn if(vactive_end: line >) -> else {
...
#[no_mangle]
unsafe extern "C" fn mdp5_crtc_get_vblank_counter(crtc: *mut drm_crtc) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mdp5_crtc_vblank_on(crtc: *mut drm_crtc) {
...
// Restore vblank irq handling after power is enabled
    ...
    &pipeline.r_mixer : core::ptr::null_mut());
    if (ret)
    return ret;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct plane_state {
    pub plane: *mut drm_plane,
    pub state: *mut mdp5_plane_state,
}

#[no_mangle]
unsafe extern "C" fn pstate_cmp(a: *const c_void, b: *const c_void) -> c_int {
...
//
    ...
    let mut cursor_plane: bool = false;
    let mut need_right_mixer: bool = false;
    let mut cnt: c_int = 0, i;
    int ret;
...
// assign a stage based on sorted zpos property
    sort(pstates, cnt, sizeof(pstates[0]), pstate_cmp, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn get_roi(crtc: *mut drm_crtc, roi_w: *mut u32, roi_h: *mut u32) {
    static void get_roi(struct drm_crtc *crtc, uint32_t *roi_w, uint32_t *roi_h)
    {
    struct mdp5_crtc *mdp5_crtc = to_mdp5_crtc(crtc);
    let mut xres: u32 = crtc.mode.hdisplay;
    let mut yres: u32 = crtc.mode.vdisplay;
//
...
#[no_mangle]
unsafe extern "C" fn mdp5_crtc_restore_cursor(crtc: *mut drm_crtc) {
    static void mdp5_crtc_restore_cursor(struct drm_crtc *crtc)
    {
    ...
    struct mdp5_crtc *mdp5_crtc = to_mdp5_crtc(crtc);
    struct mdp5_kms *mdp5_kms = get_kms(crtc);
    let mut cur_alpha: enum mdp5_cursor_alpha = CURSOR_ALPHA_PER_PIXEL;
...
//
    ...
    struct msm_kms *kms = &mdp5_kms.base.base;
    struct drm_gem_object *cursor_bo, *old_bo = core::ptr::null_mut();
    struct mdp5_ctl *ctl;
    int ret;
    let mut flush_mask: u32 = mdp_ctl_flush_mask_cursor(0);
    let mut cursor_enable: bool = true;
    unsigned long flags;
    if (!mdp5_crtc.lm_cursor_enabled) {
    dev_warn(dev.dev,
...
#[no_mangle]
unsafe extern "C" fn mdp5_crtc_cursor_move(crtc: *mut drm_crtc, x: c_int, y: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdp5_crtc_destroy_state(crtc: *mut drm_crtc, state: *mut drm_crtc_state) {
...
#[no_mangle]
unsafe extern "C" fn mdp5_crtc_reset(crtc: *mut drm_crtc) {
    ...
    __drm_atomic_helper_crtc_reset(crtc, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn mdp5_crtc_vblank_irq(irq: *mut mdp_irq, irqstatus: u32) {
    ...
    complete_flip(crtc, core::ptr::null_mut());
    }
    if (pending & PENDING_CURSOR)
    drm_flip_work_commit(&mdp5_crtc.unref_cursor_work, priv.kms.wq);
    }
#[no_mangle]
unsafe extern "C" fn mdp5_crtc_err_irq(irq: *mut mdp_irq, irqstatus: u32) {
...
#[no_mangle]
unsafe extern "C" fn mdp5_crtc_pp_done_irq(irq: *mut mdp_irq, irqstatus: u32) {
...
#[no_mangle]
unsafe extern "C" fn mdp5_crtc_wait_for_pp_done(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn mdp5_crtc_wait_for_flush_done(crtc: *mut drm_crtc) {
...
#[no_mangle]
pub unsafe extern "C" fn mdp5_crtc_vblank(crtc: *mut drm_crtc) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn mdp5_crtc_set_pipeline(crtc: *mut drm_crtc) {
...
#[no_mangle]
pub unsafe extern "C" fn mdp5_crtc_wait_for_commit_done(crtc: *mut drm_crtc) {
...
// initialize crtc
    ...
    {
    struct drm_crtc *crtc = core::ptr::null_mut();
    struct mdp5_crtc *mdp5_crtc;
    int ret;
