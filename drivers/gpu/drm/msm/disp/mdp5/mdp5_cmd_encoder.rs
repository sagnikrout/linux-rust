...
//! Source: drivers/gpu/drm/msm/disp/mdp5/mdp5_cmd_encoder.c
#![no_std]
...
pub const VSYNC_CLK_RATE: c_int = 19200000;
...
#[no_mangle]
unsafe extern "C" fn pingpong_tearcheck_enable(encoder: *mut drm_encoder) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pingpong_tearcheck_disable(encoder: *mut drm_encoder) {
...
#[no_mangle]
pub unsafe extern "C" fn mdp5_cmd_encoder_disable(encoder: *mut drm_encoder) {
...
#[no_mangle]
pub unsafe extern "C" fn mdp5_cmd_encoder_enable(encoder: *mut drm_encoder) {
