...
//! Source: drivers/gpu/drm/msm/disp/msm_disp_snapshot_util.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn msm_disp_state_dump_regs(reg: *mut u32, len: u32, base_addr: *mut void __iomem) {
    ...
    u32 x0, x4, x8, xc;
    void __iomem *addr;
    u32 *dump_addr = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn msm_disp_state_print(state: *mut msm_disp_state, p: *mut drm_printer) {
...
#[no_mangle]
unsafe extern "C" fn msm_disp_capture_atomic_state(disp_state: *mut msm_disp_state) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_disp_snapshot_capture_state(disp_state: *mut msm_disp_state) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_disp_state_free(data: *mut c_void) {
    ...
    disp_state.atomic_state = core::ptr::null_mut();
    }
