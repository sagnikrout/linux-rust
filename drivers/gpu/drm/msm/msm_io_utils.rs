...
//! Source: drivers/gpu/drm/msm/msm_io_utils.c
#![no_std]
...
// psize = size;
    ...
    {
    return _msm_ioremap(pdev, name, false, core::ptr::null_mut());
    }
    void __iomem *msm_ioremap_quiet(struct platform_device *pdev, const char *name)
    {
    return _msm_ioremap(pdev, name, true, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn msm_hrtimer_worktimer(t: *mut hrtimer) -> enum hrtimer_restart {
