...
//! Source: drivers/gpu/drm/msm/msm_atomic.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn vblank_get(kms: *mut msm_kms, crtc_mask: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn vblank_put(kms: *mut msm_kms, crtc_mask: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn lock_crtcs(kms: *mut msm_kms, crtc_mask: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn unlock_crtcs(kms: *mut msm_kms, crtc_mask: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn msm_atomic_async_commit(kms: *mut msm_kms, crtc_idx: c_int) {
    static void msm_atomic_async_commit(struct msm_kms *kms, int crtc_idx)
    {
    let mut crtc_mask: unsigned = BIT(crtc_idx);
...
#[no_mangle]
unsafe extern "C" fn msm_atomic_pending_work(work: *mut kthread_work) {
    ...
    let mut ret: c_int = PTR_ERR(timer.worker);
    timer.worker = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn msm_atomic_destroy_pending_timer(timer: *mut msm_pending_timer) {
...
//
#[no_mangle]
unsafe extern "C" fn get_crtc_mask(state: *mut drm_atomic_commit) -> unsigned {
...
#[no_mangle]
pub unsafe extern "C" fn msm_atomic_check(dev: *mut drm_device, state: *mut drm_atomic_commit) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn msm_atomic_commit_tail(state: *mut drm_atomic_commit) {
    void msm_atomic_commit_tail(struct drm_atomic_commit *state)
    {
    struct drm_device *dev = state.dev;
    struct msm_drm_private *priv = dev.dev_private;
    struct msm_kms *kms = priv.kms;
    struct drm_crtc *async_crtc = core::ptr::null_mut();
    let mut crtc_mask: unsigned = get_crtc_mask(state);
    let mut async: bool = can_do_async(state, &async_crtc);
