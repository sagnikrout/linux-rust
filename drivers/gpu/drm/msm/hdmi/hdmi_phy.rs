...
//! Source: drivers/gpu/drm/msm/hdmi/hdmi_phy.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_phy_resource_init(phy: *mut hdmi_phy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn msm_hdmi_phy_resource_enable(phy: *mut hdmi_phy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn msm_hdmi_phy_resource_disable(phy: *mut hdmi_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_hdmi_phy_powerup(phy: *mut hdmi_phy, pixclock: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_hdmi_phy_powerdown(phy: *mut hdmi_phy) {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_phy_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_phy_remove(pdev: *mut platform_device) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_hdmi_phy_driver_register() -> void __init {
    void __init msm_hdmi_phy_driver_register(void)
    {
    platform_driver_register(&msm_hdmi_phy_platform_driver);
    }
#[no_mangle]
pub unsafe extern "C" fn msm_hdmi_phy_driver_unregister() -> void __exit {
