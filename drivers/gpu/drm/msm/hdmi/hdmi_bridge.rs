...
//! Source: drivers/gpu/drm/msm/hdmi/hdmi_bridge.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_power_on(bridge: *mut drm_bridge) {
...
#[no_mangle]
unsafe extern "C" fn power_off(bridge: *mut drm_bridge) {
...
pub const AVI_IFRAME_LINE_NUMBER: c_int = 1;
pub const SPD_IFRAME_LINE_NUMBER: c_int = 1;
pub const VENSPEC_IFRAME_LINE_NUMBER: c_int = 3;
#[no_mangle]
unsafe extern "C" fn msm_hdmi_bridge_clear_avi_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_bridge_clear_audio_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_bridge_clear_spd_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_bridge_clear_hdmi_infoframe(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: hdmi->extp_clk) -> else {
...
// initialize bridge
#[no_mangle]
pub unsafe extern "C" fn msm_hdmi_bridge_init(hdmi: *mut hdmi) -> c_int {
    int msm_hdmi_bridge_init(struct hdmi *hdmi)
    {
    struct drm_bridge *bridge = core::ptr::null_mut();
    struct hdmi_bridge *hdmi_bridge;
    int ret;
    ...
    if (ret)
    return ret;
    ret = drm_bridge_attach(hdmi.encoder, bridge, core::ptr::null_mut(), DRM_BRIDGE_ATTACH_NO_CONNECTOR);
    if (ret)
    return ret;
    hdmi.bridge = bridge;
    return 0;
