...
//! Source: drivers/gpu/drm/msm/hdmi/hdmi_hdcp.c
#![no_std]
...
pub const HDCP_REG_ENABLE: c_uint = 0x01;
pub const HDCP_REG_DISABLE: c_uint = 0x00;
pub const HDCP_PORT_ADDR: c_uint = 0x74;
...
pub const AUTH_WORK_RETRIES_TIME: c_int = 100;
pub const AUTH_RETRIES_TIME: c_int = 30;
// QFPROM Registers for HDMI/HDCP
pub const QFPROM_RAW_FEAT_CONFIG_ROW0_LSB: c_uint = 0x000000F8;
pub const QFPROM_RAW_FEAT_CONFIG_ROW0_MSB: c_uint = 0x000000FC;
pub const HDCP_KSV_LSB: c_uint = 0x000060D8;
pub const HDCP_KSV_MSB: c_uint = 0x000060DC;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdmi_hdcp_ctrl {
    pub hdmi: *mut hdmi,
    pub auth_retries: u32,
    pub tz_hdcp: bool,
    pub hdcp_state: enum hdmi_hdcp_state,
    pub hdcp_auth_work: work_struct,
    pub hdcp_reauth_work: work_struct,
pub const AUTH_ABORT_EV: c_int = 1;
pub const AUTH_RESULT_RDY_EV: c_int = 2;
    pub auth_event: c_ulong,
    pub auth_event_queue: wait_queue_head_t,
    pub ksv_fifo_w_index: u32,
//
...
//
    ...
    pub dev_count: u8,
    pub depth: u8,
    pub 127]: *mut *mut u8 ksv_list[5,
    pub max_cascade_exceeded: bool,
    pub max_dev_exceeded: bool,
}
    ...
    rc = 0;
#[no_mangle]
pub unsafe extern "C" fn if(0: retry >) -> else {
    else if (retry > 0)
    goto retry;
    else
    rc = -EIO;
...
pub const HDCP_DDC_WRITE_MAX_BYTE_NUM: c_int = 32;
...
#[no_mangle]
pub unsafe extern "C" fn msm_hdmi_hdcp_irq(hdcp_ctrl: *mut hdmi_hdcp_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_msleep(hdcp_ctrl: *mut hdmi_hdcp_ctrl, ms: u32, ev: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_read_validate_aksv(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_reset_hdcp_ddc_failures(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_hw_ddc_clean(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_reauth_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_auth_prepare(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_auth_fail(hdcp_ctrl: *mut hdmi_hdcp_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_auth_done(hdcp_ctrl: *mut hdmi_hdcp_ctrl) {
...
//
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_wait_key_an_ready(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_send_aksv_an(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_recv_bksv(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_recv_bcaps(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_auth_part1_key_exchange(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_auth_part1_recv_r0(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_auth_part1_verify_r0(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
...
// Enable HDCP Encryption
    ...
    int rc;
    struct hdmi *hdmi = hdcp_ctrl.hdmi;
    let mut max_devs_exceeded: bool = false, max_cascade_exceeded = false;
    let mut repeater_cascade_depth: u32 = 0, down_stream_devices = 0;
    u16 bstatus;
    u8 buf[2];
...
//
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_transfer_v_h(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
    ...
    let mut size: u32 = ARRAY_SIZE(reg_data);
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_recv_ksv_fifo(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_reset_sha_engine(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_write_ksv_fifo(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
    static int msm_hdmi_hdcp_write_ksv_fifo(struct hdmi_hdcp_ctrl *hdcp_ctrl)
    {
    int i;
    struct hdmi *hdmi = hdcp_ctrl.hdmi;
    u32 ksv_bytes, last_byte = 0;
    u8 *ksv_fifo = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_auth_part2_check_v_match(hdcp_ctrl: *mut hdmi_hdcp_ctrl) -> c_int {
    static int msm_hdmi_hdcp_auth_part2_check_v_match(struct hdmi_hdcp_ctrl *hdcp_ctrl)
    {
    let mut rc: c_int = 0;
    struct hdmi *hdmi = hdcp_ctrl.hdmi;
    u32 link0_status;
    let mut timeout_count: u32 = 100;
    do {
    link0_status = hdmi_read(hdmi, REG_HDMI_HDCP_LINK0_STATUS);
...
#[no_mangle]
unsafe extern "C" fn msm_hdmi_hdcp_auth_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_hdmi_hdcp_on(hdcp_ctrl: *mut hdmi_hdcp_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_hdmi_hdcp_off(hdcp_ctrl: *mut hdmi_hdcp_ctrl) {
...
// Enable HPD circuitry
    ...
    {
    struct hdmi_hdcp_ctrl *hdcp_ctrl = core::ptr::null_mut();
    if (!hdmi.qfprom_mmio) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_hdmi_hdcp_destroy(hdmi: *mut hdmi) {
    void msm_hdmi_hdcp_destroy(struct hdmi *hdmi)
    {
    if (hdmi) {
    kfree(hdmi.hdcp_ctrl);
    hdmi.hdcp_ctrl = core::ptr::null_mut();
    }
    }
