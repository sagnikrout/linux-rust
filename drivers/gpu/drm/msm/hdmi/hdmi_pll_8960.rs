...
//! Source: drivers/gpu/drm/msm/hdmi/hdmi_pll_8960.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn pll_write(pll: *mut hdmi_pll_8960, reg: u32, data: u32) {
    static inline void pll_write(struct hdmi_pll_8960 *pll, u32 reg, u32 data)
    {
    writel(data, pll.mmio + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn pll_read(pll: *mut hdmi_pll_8960, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hdmi_pll_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_pll_disable(hw: *mut clk_hw) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_hdmi_pll_8960_init(pdev: *mut platform_device) -> c_int {
