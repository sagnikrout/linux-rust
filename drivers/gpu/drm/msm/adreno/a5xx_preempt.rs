...
//! Source: drivers/gpu/drm/msm/adreno/a5xx_preempt.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn update_wptr(gpu: *mut msm_gpu, ring: *mut msm_ringbuffer) {
...
#[no_mangle]
unsafe extern "C" fn a5xx_preempt_timer(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn a5xx_preempt_trigger(gpu: *mut msm_gpu) {
...
#[no_mangle]
pub unsafe extern "C" fn a5xx_preempt_irq(gpu: *mut msm_gpu) {
...
//
    ...
    a5xx_gpu.next_ring = core::ptr::null_mut();
    update_wptr(gpu, a5xx_gpu.cur_ring);
    set_preempt_state(a5xx_gpu, PREEMPT_NONE);
//
...
#[no_mangle]
pub unsafe extern "C" fn a5xx_preempt_hw_init(gpu: *mut msm_gpu) {
...
// Reset the preemption state
    ...
    void *counters;
    struct drm_gem_object *bo = core::ptr::null_mut(), *counters_bo = core::ptr::null_mut();
    let mut iova: u64 = 0, counters_iova = 0;
...
#[no_mangle]
pub unsafe extern "C" fn a5xx_preempt_fini(gpu: *mut msm_gpu) {
...
#[no_mangle]
pub unsafe extern "C" fn a5xx_preempt_init(gpu: *mut msm_gpu) {
