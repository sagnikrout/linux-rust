...
//! Source: drivers/gpu/drm/msm/adreno/a8xx_gpu.c
#![no_std]
...
pub const GPU_PAS_ID: c_int = 13;
#[no_mangle]
unsafe extern "C" fn a8xx_aperture_slice_set(gpu: *mut msm_gpu, pipe: enum adreno_pipe, slice: u32) {
...
#[no_mangle]
unsafe extern "C" fn a8xx_aperture_acquire(gpu: *mut msm_gpu, pipe: enum adreno_pipe, flags: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn a8xx_aperture_release(gpu: *mut msm_gpu, flags: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn a8xx_aperture_clear(gpu: *mut msm_gpu) {
...
#[no_mangle]
unsafe extern "C" fn a8xx_write_pipe(gpu: *mut msm_gpu, pipe: enum adreno_pipe, offset: u32, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn a8xx_read_pipe_slice(gpu: *mut msm_gpu, pipe: enum adreno_pipe, slice: u32, offset: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn a8xx_gpu_get_slice_info(gpu: *mut msm_gpu) {
...
#[no_mangle]
unsafe extern "C" fn a8xx_get_first_slice(a6xx_gpu: *mut a6xx_gpu) -> u32 {
    static u32 a8xx_get_first_slice(struct a6xx_gpu *a6xx_gpu)
    {
    return ffs(a6xx_gpu.slice_mask) - 1;
    }
#[no_mangle]
pub unsafe extern "C" fn _a8xx_check_idle(gpu: *mut msm_gpu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn a8xx_idle(gpu: *mut msm_gpu, ring: *mut msm_ringbuffer) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn a8xx_flush(gpu: *mut msm_gpu, ring: *mut msm_ringbuffer) {
...
#[no_mangle]
unsafe extern "C" fn a8xx_set_hwcg(gpu: *mut msm_gpu, state: bool) {
...
#[no_mangle]
unsafe extern "C" fn a8xx_set_cp_protect(gpu: *mut msm_gpu) {
...
#[no_mangle]
unsafe extern "C" fn a8xx_set_ubwc_config(gpu: *mut msm_gpu) {
    static void a8xx_set_ubwc_config(struct msm_gpu *gpu)
    {
    struct adreno_gpu *adreno_gpu = to_adreno_gpu(gpu);
    const struct qcom_ubwc_cfg_data *cfg = adreno_gpu.ubwc_config;
    let mut level2_swizzling_dis: u32 = !(qcom_ubwc_swizzle(cfg) & UBWC_SWIZZLE_ENABLE_LVL2);
    let mut level3_swizzling_dis: u32 = !(qcom_ubwc_swizzle(cfg) & UBWC_SWIZZLE_ENABLE_LVL3);
    let mut rgba8888_lossless: bool = false, fp16compoptdis = false;
    let mut yuvnotcomptofc: bool = false, min_acc_len_64b = false;
    let mut rgb565_predicator: bool = false;
    let mut amsbc: bool = qcom_ubwc_enable_amsbc(cfg);
    let mut ubwc_mode: bool = qcom_ubwc_get_ubwc_mode(cfg);
    let mut ubwc_version: u32 = cfg.ubwc_enc_version;
    u32 hbb, hbb_hi, hbb_lo, mode;
    let mut uavflagprd_inv: u8 = 2;
...
#[no_mangle]
unsafe extern "C" fn a8xx_nonctxt_config(gpu: *mut msm_gpu, gmem_protect: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn a8xx_patch_pwrup_reglist(gpu: *mut msm_gpu) {
    ...
    let mut dyn_pwrup_reglist_count: u32 = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn a8xx_preempt_start(gpu: *mut msm_gpu) -> c_int {
...
// Turn CP protection off
    ...
    OUT_RING(ring, 0);
    a6xx_emit_set_pseudo_reg(ring, a6xx_gpu, core::ptr::null_mut());
    a6xx_flush_yield(gpu, ring);
    return a8xx_idle(gpu, ring) ? 0 : -EINVAL;
    }
#[no_mangle]
unsafe extern "C" fn a8xx_cp_init(gpu: *mut msm_gpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hw_init(gpu: *mut msm_gpu) -> c_int {
...
// Enable the GMEM save/restore feature for preemption
    ...
    let mut apriv_mask: u32 = A8XX_APRIV_MASK;
    unsigned long flags;
    if (pipe_id == PIPE_LPAC)
    continue;
    if (pipe_id == PIPE_BR)
...
#[no_mangle]
pub unsafe extern "C" fn a8xx_hw_init(gpu: *mut msm_gpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn a8xx_dump(gpu: *mut msm_gpu) {
...
#[no_mangle]
pub unsafe extern "C" fn a8xx_recover(gpu: *mut msm_gpu) {
...
#[no_mangle]
pub unsafe extern "C" fn a8xx_fault_handler(arg: *mut c_void, iova: c_ulong, flags: c_int, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn a8xx_cp_hw_err_irq(gpu: *mut msm_gpu) {
    static void a8xx_cp_hw_err_irq(struct msm_gpu *gpu)
    {
    let mut status: u32 = gpu_read(gpu, REG_A8XX_CP_INTERRUPT_STATUS_GLOBAL);
    struct adreno_gpu *adreno_gpu = to_adreno_gpu(gpu);
    struct a6xx_gpu *a6xx_gpu = to_a6xx_gpu(adreno_gpu);
    let mut slice: u32 = a8xx_get_first_slice(a6xx_gpu);
    let mut hw_fault_mask: u32 = GENMASK(6, 0);
    let mut sw_fault_mask: u32 = GENMASK(22, 16);
    let mut pipe: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn gpu_periph_read(gpu: *mut msm_gpu, dbg_offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gpu_periph_read64(gpu: *mut msm_gpu, dbg_offset: u32) -> u64 {
...
pub const CP_PERIPH_IB1_BASE_LO: c_uint = 0x7005;
pub const CP_PERIPH_IB1_BASE_HI: c_uint = 0x7006;
pub const CP_PERIPH_IB1_SIZE: c_uint = 0x7007;
pub const CP_PERIPH_IB1_OFFSET: c_uint = 0x7008;
pub const CP_PERIPH_IB2_BASE_LO: c_uint = 0x7009;
pub const CP_PERIPH_IB2_BASE_HI: c_uint = 0x700a;
pub const CP_PERIPH_IB2_SIZE: c_uint = 0x700b;
pub const CP_PERIPH_IB2_OFFSET: c_uint = 0x700c;
pub const CP_PERIPH_IB3_BASE_LO: c_uint = 0x700d;
pub const CP_PERIPH_IB3_BASE_HI: c_uint = 0x700e;
pub const CP_PERIPH_IB3_SIZE: c_uint = 0x700f;
pub const CP_PERIPH_IB3_OFFSET: c_uint = 0x7010;
#[no_mangle]
unsafe extern "C" fn a8xx_fault_detect_irq(gpu: *mut msm_gpu) {
...
#[no_mangle]
unsafe extern "C" fn a8xx_sw_fuse_violation_irq(gpu: *mut msm_gpu) {
...
#[no_mangle]
pub unsafe extern "C" fn a8xx_irq(gpu: *mut msm_gpu) -> irqreturn_t {
    irqreturn_t a8xx_irq(struct msm_gpu *gpu)
    {
    struct msm_drm_private *priv = gpu.dev.dev_private;
    let mut status: u32 = gpu_read(gpu, REG_A8XX_RBBM_INT_0_STATUS);
...
#[no_mangle]
pub unsafe extern "C" fn a8xx_llc_activate(a6xx_gpu: *mut a6xx_gpu) {
    void a8xx_llc_activate(struct a6xx_gpu *a6xx_gpu)
    {
    struct adreno_gpu *adreno_gpu = &a6xx_gpu.base;
    struct msm_gpu *gpu = &adreno_gpu.base;
    if (!llcc_slice_activate(a6xx_gpu.llc_slice)) {
    let mut gpu_scid: u32 = llcc_get_slice_id(a6xx_gpu.llc_slice);
...
pub const VBIF_RESET_ACK_MASK: c_uint = 0xF0;
pub const GPR0_GBIF_HALT_REQUEST: c_uint = 0x1E0;
#[no_mangle]
pub unsafe extern "C" fn a8xx_bus_clear_pending_transactions(adreno_gpu: *mut adreno_gpu, gx_off: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn a8xx_gmu_get_timestamp(gpu: *mut msm_gpu) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn a8xx_gpu_busy(gpu: *mut msm_gpu, out_sample_rate: *mut c_ulong) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn a8xx_progress(gpu: *mut msm_gpu, ring: *mut msm_ringbuffer) -> bool {
    bool a8xx_progress(struct msm_gpu *gpu, struct msm_ringbuffer *ring)
    {
    return true;
    }
#[no_mangle]
pub unsafe extern "C" fn a8xx_perfcntr_flush(gpu: *mut msm_gpu) {
