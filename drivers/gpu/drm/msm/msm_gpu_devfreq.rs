...
//! Source: drivers/gpu/drm/msm/msm_gpu_devfreq.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_freq(gpu: *mut msm_gpu) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn msm_devfreq_get_cur_freq(dev: *mut device, freq: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn has_devfreq(gpu: *mut msm_gpu) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn msm_devfreq_init(gpu: *mut msm_gpu) {
...
//
    msm_devfreq_profile.freq_table = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cancel_idle_work(df: *mut msm_gpu_devfreq) {
...
#[no_mangle]
unsafe extern "C" fn cancel_boost_work(df: *mut msm_gpu_devfreq) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_devfreq_cleanup(gpu: *mut msm_gpu) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_devfreq_resume(gpu: *mut msm_gpu) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_devfreq_suspend(gpu: *mut msm_gpu) {
...
#[no_mangle]
unsafe extern "C" fn msm_devfreq_boost_work(work: *mut kthread_work) {
    static void msm_devfreq_boost_work(struct kthread_work *work)
    {
...
#[no_mangle]
pub unsafe extern "C" fn msm_devfreq_boost(gpu: *mut msm_gpu, factor: unsigned) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_devfreq_active(gpu: *mut msm_gpu) {
...
#[no_mangle]
unsafe extern "C" fn msm_devfreq_idle_work(work: *mut kthread_work) {
    static void msm_devfreq_idle_work(struct kthread_work *work)
    {
    struct msm_gpu_devfreq *df = container_of(work,
...
#[no_mangle]
pub unsafe extern "C" fn msm_devfreq_idle(gpu: *mut msm_gpu) {
