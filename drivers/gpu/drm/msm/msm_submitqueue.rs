...
//! Source: drivers/gpu/drm/msm/msm_submitqueue.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn msm_context_set_sysprof(ctx: *mut msm_context, gpu: *mut msm_gpu, sysprof: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __msm_context_destroy(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_submitqueue_destroy(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_submitqueue_close(ctx: *mut msm_context) {
...
//
    ...
    let mut idx: unsigned = (ring_nr * NR_SCHED_PRIORITIES) + sched_prio;
...
//
    ...
    ret = drm_sched_entity_init(entity, sched_prio, &sched, 1, core::ptr::null_mut());
    if (ret) {
    ...
    struct drm_gpuvm *vm = core::ptr::null_mut();
    unsigned ring_nr;
    int ret;
    if (!ctx)
    return -ENODEV;
...
//
#[no_mangle]
pub unsafe extern "C" fn msm_submitqueue_init(drm: *mut drm_device, ctx: *mut msm_context) -> c_int {
...
//
    ...
    return msm_submitqueue_create(drm, ctx, default_prio, 0, core::ptr::null_mut());
    }
    static int msm_submitqueue_query_faults(struct msm_gpu_submitqueue *queue,
    struct drm_msm_submitqueue_query *args)
    {
    let mut size: usize = min_t(size_t, args.len, sizeof(queue.faults));
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn msm_submitqueue_remove(ctx: *mut msm_context, id: u32) -> c_int {
