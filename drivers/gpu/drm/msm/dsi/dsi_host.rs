...
//! Source: drivers/gpu/drm/msm/dsi/dsi_host.c
#![no_std]
...
pub const DSI_RESET_TOGGLE_DELAY_MS: c_int = 20;
    static int dsi_populate_dsc_params(struct msm_dsi_host *msm_host, struct drm_dsc_config *dsc);
#[no_mangle]
unsafe extern "C" fn dsi_get_version(base: *const void __iomem, major: *mut u32, minor: *mut u32) -> c_int {
...
pub const DSI_ERR_STATE_ACK: c_uint = 0x0000;
pub const DSI_ERR_STATE_TIMEOUT: c_uint = 0x0001;
pub const DSI_ERR_STATE_DLN0_PHY: c_uint = 0x0002;
pub const DSI_ERR_STATE_FIFO: c_uint = 0x0004;
pub const DSI_ERR_STATE_MDP_FIFO_UNDERFLOW: c_uint = 0x0008;
pub const DSI_ERR_STATE_INTERLEAVE_OP_CONTENTION: c_uint = 0x0010;
pub const DSI_ERR_STATE_PLL_UNLOCKED: c_uint = 0x0020;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct msm_dsi_host {
    pub base: mipi_dsi_host,
    pub pdev: *mut platform_device,
    pub dev: *mut drm_device,
    pub id: c_int,
    pub ctrl_base: *mut void __iomem,
    pub ctrl_size: phys_addr_t,
    pub supplies: *mut regulator_bulk_data,
    pub num_bus_clks: c_int,
    pub bus_clks: [clk_bulk_data; DSI_BUS_CLK_MAX],
    pub byte_clk: *mut clk,
    pub esc_clk: *mut clk,
    pub pixel_clk: *mut clk,
    pub byte_intf_clk: *mut clk,
//
// Clocks which needs to be properly parented between DISPCC and DSI PHY
// PLL:
//
    pub byte_src_clk: *mut clk,
    pub pixel_src_clk: *mut clk,
    pub dsi_pll_byte_clk: *mut clk,
    pub dsi_pll_pixel_clk: *mut clk,
    pub byte_clk_rate: c_ulong,
    pub byte_intf_clk_rate: c_ulong,
    pub pixel_clk_rate: c_ulong,
    pub esc_clk_rate: c_ulong,
// DSI v2 specific clocks
    pub src_clk: *mut clk,
    pub src_clk_rate: c_ulong,
    pub cfg_hnd: *const msm_dsi_cfg_handler,
    pub dma_comp: completion,
    pub video_comp: completion,
    pub dev_mutex: mutex,
    pub cmd_mutex: mutex,
    pub /: *mut *mut spinlock_t intr_lock; / Protect interrupt ctrl register,
    pub err_work_state: u32,
    pub err_work: work_struct,
    pub workqueue: *mut workqueue_struct,
// DSI 6G TX buffer
    pub tx_gem_obj: *mut drm_gem_object,
    pub vm: *mut drm_gpuvm,
// DSI v2 TX buffer
    pub tx_buf: *mut c_void,
    pub tx_buf_paddr: dma_addr_t,
    pub tx_size: c_int,
    pub rx_buf: *mut u8,
    pub sfpb: *mut regmap,
    pub mode: *mut drm_display_mode,
    pub dsc: *mut drm_dsc_config,
    pub dsc_slice_per_pkt: c_uint,
...
// lane data parsed via DT
    pub dlane_swap: c_int,
    pub num_data_lanes: c_int,
// from phy DT
    pub cphy_mode: bool,
    pub dma_cmd_ctrl_restore: u32,
    pub registered: bool,
    pub power_on: bool,
    pub enabled: bool,
    pub irq: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn dsi_read(msm_host: *mut msm_dsi_host, reg: u32) -> u32 {
    static inline u32 dsi_read(struct msm_dsi_host *msm_host, u32 reg)
    {
    return readl(msm_host.ctrl_base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn dsi_write(msm_host: *mut msm_dsi_host, reg: u32, data: u32) {
    ...
    {
    const struct msm_dsi_cfg_handler *cfg_hnd = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn dsi_clk_init_v2(msm_host: *mut msm_dsi_host) -> c_int {
    ...
    __func__, ret);
    msm_host.src_clk = core::ptr::null_mut();
    return ret;
    }
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn dsi_clk_init_6g_v2(msm_host: *mut msm_dsi_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_clk_init_6g_v2_9(msm_host: *mut msm_dsi_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_clk_init(msm_host: *mut msm_dsi_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_link_clk_set_rate_6g(msm_host: *mut msm_dsi_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_link_clk_set_rate_6g_v2_9(msm_host: *mut msm_dsi_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_link_clk_enable_6g(msm_host: *mut msm_dsi_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_link_clk_set_rate_v2(msm_host: *mut msm_dsi_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_link_clk_enable_v2(msm_host: *mut msm_dsi_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_link_clk_disable_6g(msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_link_clk_disable_v2(msm_host: *mut msm_dsi_host) {
...
//
    ...
    {
    struct msm_dsi_host *msm_host = to_msm_dsi_host(host);
    let mut lanes: u8 = msm_host.lanes;
    let mut bpp: u32 = mipi_dsi_pixel_format_to_bpp(msm_host.format);
    let mut pclk_rate: c_ulong = dsi_get_pclk_rate(mode, msm_host.dsc, is_bonded_dsi);
...
#[no_mangle]
unsafe extern "C" fn dsi_calc_pclk(msm_host: *mut msm_dsi_host, is_bonded_dsi: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_calc_clk_rate_6g(msm_host: *mut msm_dsi_host, is_bonded_dsi: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_calc_clk_rate_v2(msm_host: *mut msm_dsi_host, is_bonded_dsi: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_intr_ctrl(msm_host: *mut msm_dsi_host, mask: u32, enable: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_get_traffic_mode(mode_flags: u32) -> enum dsi_traffic_mode {
    static inline enum dsi_traffic_mode dsi_get_traffic_mode(const u32 mode_flags)
    {
    if (mode_flags & MIPI_DSI_MODE_VIDEO_BURST)
    return BURST_MODE;
#[no_mangle]
pub unsafe extern "C" fn if(MIPI_DSI_MODE_VIDEO_SYNC_PULSE: mode_flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn dsi_ctrl_disable(msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_host_is_wide_bus_enabled(host: *mut mipi_dsi_host) -> bool {
    ...
    {
    let mut flags: u32 = msm_host.mode_flags;
    let mut mipi_fmt: enum mipi_dsi_pixel_format = msm_host.format;
    const struct msm_dsi_cfg_handler *cfg_hnd = msm_host.cfg_hnd;
    let mut data: u32 = 0, lane_ctrl = 0;
...
#[no_mangle]
unsafe extern "C" fn dsi_update_dsc_timing(msm_host: *mut msm_dsi_host, is_cmd_mode: bool) {
...
#[no_mangle]
unsafe extern "C" fn dsi_timing_setup(msm_host: *mut msm_dsi_host, is_bonded_dsi: bool) {
    static void dsi_timing_setup(struct msm_dsi_host *msm_host, bool is_bonded_dsi)
    {
    struct drm_display_mode *mode = msm_host.mode;
    u32 hs_start = 0, vs_start = 0; /* take sync start as 0 */
    let mut h_total: u32 = mode.htotal;
    let mut v_total: u32 = mode.vtotal;
    let mut hs_end: u32 = mode.hsync_end - mode.hsync_start;
    let mut vs_end: u32 = mode.vsync_end - mode.vsync_start;
    let mut ha_start: u32 = h_total - mode.hsync_start;
    let mut ha_end: u32 = ha_start + mode.hdisplay;
    let mut va_start: u32 = v_total - mode.vsync_start;
    let mut va_end: u32 = va_start + mode.vdisplay;
    let mut hdisplay: u32 = mode.hdisplay;
    u32 wc;
    int ret;
    let mut wide_bus_enabled: bool = msm_dsi_host_is_wide_bus_enabled(&msm_host.base);
    DBG("");
//
...
#[no_mangle]
unsafe extern "C" fn dsi_sw_reset(msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
unsafe extern "C" fn dsi_set_tx_power_mode(mode: c_int, msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
unsafe extern "C" fn dsi_wait4video_done(msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
unsafe extern "C" fn dsi_wait4video_eng_busy(msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_tx_buf_alloc_6g(msm_host: *mut msm_dsi_host, size: c_int) -> c_int {
    ...
    if (IS_ERR(data)) {
    msm_host.tx_gem_obj = core::ptr::null_mut();
    return PTR_ERR(data);
    }
...
#[no_mangle]
pub unsafe extern "C" fn dsi_tx_buf_alloc_v2(msm_host: *mut msm_dsi_host, size: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_tx_buf_free(host: *mut mipi_dsi_host) {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_tx_buf_put_6g(msm_host: *mut msm_dsi_host) {
...
//
#[no_mangle]
unsafe extern "C" fn dsi_short_read1_resp(buf: *mut u8, msg: *const mipi_dsi_msg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dsi_short_read2_resp(buf: *mut u8, msg: *const mipi_dsi_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_long_read_resp(buf: *mut u8, msg: *const mipi_dsi_msg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_dma_base_get_6g(msm_host: *mut msm_dsi_host, dma_base: *mut u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dsi_dma_base_get_v2(msm_host: *mut msm_dsi_host, dma_base: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_cmd_dma_tx(msm_host: *mut msm_dsi_host, len: c_int) -> c_int {
    ...
    u32 read_cnt;
    u8 reg[16];
    let mut repeated_bytes: c_int = 0;
    let mut buf_offset: c_int = buf - msm_host.rx_buf;
    temp = (u32 *)reg;
    cnt = (rx_byte + 3) >> 2;
    if (cnt > 4)
...
#[no_mangle]
unsafe extern "C" fn dsi_err_worker(work: *mut work_struct) {
    static void dsi_err_worker(struct work_struct *work)
    {
    struct msm_dsi_host *msm_host =
    container_of(work, struct msm_dsi_host, err_work);
    let mut status: u32 = msm_host.err_work_state;
...
#[no_mangle]
unsafe extern "C" fn dsi_ack_err_status(msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
unsafe extern "C" fn dsi_timeout_status(msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
unsafe extern "C" fn dsi_dln0_phy_err(msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
unsafe extern "C" fn dsi_fifo_status(msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
unsafe extern "C" fn dsi_status(msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
unsafe extern "C" fn dsi_clk_status(msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
unsafe extern "C" fn dsi_error(msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
unsafe extern "C" fn dsi_host_irq(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dsi_populate_dsc_params(msm_host: *mut msm_dsi_host, dsc: *mut drm_dsc_config) -> c_int {
    static int dsi_populate_dsc_params(struct msm_dsi_host *msm_host, struct drm_dsc_config *dsc)
    {
    int ret;
...
#[no_mangle]
unsafe extern "C" fn dsi_host_parse_dt(msm_host: *mut msm_dsi_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_host_get_id(msm_host: *mut msm_dsi_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_host_init(msm_dsi: *mut msm_dsi) -> c_int {
    int msm_dsi_host_init(struct msm_dsi *msm_dsi)
    {
    struct msm_dsi_host *msm_host = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_host_destroy(host: *mut mipi_dsi_host) {
    ...
    msm_host.workqueue = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_host_register(host: *mut mipi_dsi_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_host_unregister(host: *mut mipi_dsi_host) {
    void msm_dsi_host_unregister(struct mipi_dsi_host *host)
    {
    struct msm_dsi_host *msm_host = to_msm_dsi_host(host);
    if (msm_host.registered) {
    mipi_dsi_host_unregister(host);
    host.dev = core::ptr::null_mut();
    host.ops = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_host_reset_phy(host: *mut mipi_dsi_host) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_host_enable_irq(host: *mut mipi_dsi_host) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_host_disable_irq(host: *mut mipi_dsi_host) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_host_enable(host: *mut mipi_dsi_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_host_disable(host: *mut mipi_dsi_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_dsi_sfpb_config(msm_host: *mut msm_dsi_host, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_host_power_off(host: *mut mipi_dsi_host) -> c_int {
    ...
    msm_host.mode = core::ptr::null_mut();
    }
    ...
    struct msm_dsi_host *msm_host = to_msm_dsi_host(host);
    struct drm_dsc_config *dsc = msm_host.dsc;
    let mut pic_width: c_int = mode.hdisplay;
    let mut pic_height: c_int = mode.vdisplay;
    if (!msm_host.dsc)
    return MODE_OK;
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_host_get_mode_flags(host: *mut mipi_dsi_host) -> c_ulong {
    unsigned long msm_dsi_host_get_mode_flags(struct mipi_dsi_host *host)
    {
    return to_msm_dsi_host(host).mode_flags;
    }
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_host_snapshot(disp_state: *mut msm_disp_state, host: *mut mipi_dsi_host) {
...
#[no_mangle]
unsafe extern "C" fn msm_dsi_host_video_test_pattern_setup(msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
unsafe extern "C" fn msm_dsi_host_cmd_test_pattern_setup(msm_host: *mut msm_dsi_host) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_host_test_pattern_en(host: *mut mipi_dsi_host) {
    void msm_dsi_host_test_pattern_en(struct mipi_dsi_host *host)
    {
    struct msm_dsi_host *msm_host = to_msm_dsi_host(host);
    let mut is_video_mode: bool = !!(msm_host.mode_flags & MIPI_DSI_MODE_VIDEO);
    u32 reg;
    if (is_video_mode)
