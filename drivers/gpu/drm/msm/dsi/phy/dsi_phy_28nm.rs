...
//! Source: drivers/gpu/drm/msm/dsi/phy/dsi_phy_28nm.c
#![no_std]
...
// +------+
//
pub const POLL_MAX_READS: c_int = 10;
pub const POLL_TIMEOUT_US: c_int = 50;
pub const VCO_REF_CLK_RATE: c_int = 19200000;
pub const VCO_MIN_RATE: c_int = 350000000;
pub const VCO_MAX_RATE: c_int = 750000000;
// v2.0.0 28nm LP implementation

pub const LPFR_LUT_SIZE: c_int = 10;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpfr_cfg {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pll_28nm_cached_state {
    pub vco_rate: c_ulong,
    pub postdiv3: u8,
    pub postdiv1: u8,
    pub byte_mux: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dsi_pll_28nm {
    pub clk_hw: clk_hw,
    pub phy: *mut msm_dsi_phy,
    pub cached_state: pll_28nm_cached_state,
}
...
#[no_mangle]
unsafe extern "C" fn pll_28nm_software_reset(pll_28nm: *mut dsi_pll_28nm) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_28nm_clk_is_enabled(hw: *mut clk_hw) -> c_int {
    ...
    let mut ref_clk: u32 = VCO_REF_CLK_RATE;
...
#[no_mangle]
unsafe extern "C" fn _dsi_pll_28nm_vco_prepare_hpm(pll_28nm: *mut dsi_pll_28nm) -> c_int {
    static int _dsi_pll_28nm_vco_prepare_hpm(struct dsi_pll_28nm *pll_28nm)
    {
    struct device *dev = &pll_28nm.phy.pdev.dev;
    void __iomem *base = pll_28nm.phy.pll_base;
    let mut max_reads: u32 = 5, timeout_us = 100;
    bool locked;
    u32 val;
    int i;
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_28nm_vco_prepare_hpm(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_28nm_vco_prepare_8226(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_28nm_vco_prepare_lp(hw: *mut clk_hw) -> c_int {
    ...
    void __iomem *base = pll_28nm.phy.pll_base;
    bool locked;
    let mut max_reads: u32 = 10, timeout_us = 50;
    u32 val;
    DBG("id=%d", pll_28nm.phy.id);
    if (unlikely(pll_28nm.phy.pll_on))
    return 0;
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_28nm_vco_unprepare(hw: *mut clk_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn dsi_28nm_pll_save_state(phy: *mut msm_dsi_phy) {
...
#[no_mangle]
unsafe extern "C" fn dsi_28nm_pll_restore_state(phy: *mut msm_dsi_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pll_28nm_register(pll_28nm: *mut dsi_pll_28nm, provided_clocks: *mut clk_hw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(DSI_PHY_28NM_QUIRK_PHY_8226: pll_28nm->phy->cfg->quirks &) -> else {
    ...
    REG_DSI_28nm_PHY_PLL_VREG_CFG, 1, 1, 0, core::ptr::null_mut());
    if (IS_ERR(byte_mux))
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_28nm_init(phy: *mut msm_dsi_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_28nm_phy_regulator_enable_dcdc(phy: *mut msm_dsi_phy) {
...
#[no_mangle]
unsafe extern "C" fn dsi_28nm_phy_regulator_enable_ldo(phy: *mut msm_dsi_phy) {
...
#[no_mangle]
unsafe extern "C" fn dsi_28nm_phy_regulator_ctrl(phy: *mut msm_dsi_phy, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn dsi_28nm_phy_disable(phy: *mut msm_dsi_phy) {
