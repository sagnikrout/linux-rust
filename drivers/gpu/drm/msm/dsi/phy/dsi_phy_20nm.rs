...
//! Source: drivers/gpu/drm/msm/dsi/phy/dsi_phy_20nm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dsi_20nm_phy_regulator_ctrl(phy: *mut msm_dsi_phy, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn dsi_20nm_phy_disable(phy: *mut msm_dsi_phy) {
