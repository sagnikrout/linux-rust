...
//! Source: drivers/gpu/drm/msm/dsi/phy/dsi_phy_7nm.c
#![no_std]
...
pub struct dsi_pll_config {
    ...
    pub ssc_adj_per: u32,
// out
    pub decimal_div_start: u32,
    pub frac_div_start: u32,
    pub pll_clock_inverters: u32,
    pub ssc_stepsize: u32,
    pub ssc_div_per: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pll_7nm_cached_state {
...
// protects REG_DSI_7nm_PHY_CMN_CLK_CFG1 register
    pub pclk_mux_lock: spinlock_t,
//
// protects REG_DSI_7nm_PHY_CMN_CTRL_0 register and pll_enable_cnt
// member
//
    pub pll_enable_lock: spinlock_t,
    pub pll_enable_cnt: c_int,
    pub cached_state: pll_7nm_cached_state,
    pub slave: *mut dsi_pll_7nm,
}
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_setup_config(config: *mut dsi_pll_config) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_calc_dec_frac(pll: *mut dsi_pll_7nm, config: *mut dsi_pll_config) {
...
#[no_mangle]
pub unsafe extern "C" fn if(175000000ULL: pll_freq <) -> else {
    else if (pll_freq < 175000000ULL)
    config.pll_clock_inverters = 0x20;
#[no_mangle]
pub unsafe extern "C" fn if(325000000ULL: pll_freq <) -> else {
    else if (pll_freq < 325000000ULL)
    config.pll_clock_inverters = 0xa0;
#[no_mangle]
pub unsafe extern "C" fn if(350000000ULL: pll_freq <) -> else {
    else if (pll_freq < 350000000ULL)
    config.pll_clock_inverters = 0x20;
#[no_mangle]
pub unsafe extern "C" fn if(650000000ULL: pll_freq <) -> else {
    else if (pll_freq < 650000000ULL)
    config.pll_clock_inverters = 0xa0;
#[no_mangle]
pub unsafe extern "C" fn if(700000000ULL: pll_freq <) -> else {
    else if (pll_freq < 700000000ULL)
    config.pll_clock_inverters = 0x20;
#[no_mangle]
pub unsafe extern "C" fn if(1300000000ULL: pll_freq <) -> else {
    else if (pll_freq < 1300000000ULL)
    config.pll_clock_inverters = 0xa0;
#[no_mangle]
pub unsafe extern "C" fn if(2500000000ULL: pll_freq <) -> else {
    else if (pll_freq < 2500000000ULL)
    config.pll_clock_inverters = 0x20;
#[no_mangle]
pub unsafe extern "C" fn if(4000000000ULL: pll_freq <) -> else {
...
pub unsafe extern "C" fn if(2500000000ULL: pll_freq <=) -> else {
    ...
    config.pll_clock_inverters = 0x20;
#[no_mangle]
pub unsafe extern "C" fn if(3020000000ULL: pll_freq <=) -> else {
...
pub unsafe extern "C" fn if(2500000000ULL: pll_freq <=) -> else {
    ...
    config.pll_clock_inverters = 0x20;
#[no_mangle]
pub unsafe extern "C" fn if(3500000000ULL: pll_freq <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_calc_ssc(pll: *mut dsi_pll_7nm, config: *mut dsi_pll_config) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_ssc_commit(pll: *mut dsi_pll_7nm, config: *mut dsi_pll_config) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_config_hzindep_reg(pll: *mut dsi_pll_7nm) {
    static void dsi_pll_config_hzindep_reg(struct dsi_pll_7nm *pll)
    {
    void __iomem *base = pll.phy.pll_base;
    let mut analog_controls_five_1: u8 = 0x01, vco_config_1 = 0x00;
    if (!(pll.phy.cfg.quirks & DSI_PHY_7NM_QUIRK_V4_0))
    ...
    vco_config_1 = 0x08;
#[no_mangle]
pub unsafe extern "C" fn if(2990000000ULL: pll->vco_current_rate <) -> else {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_commit(pll: *mut dsi_pll_7nm, config: *mut dsi_pll_config) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_7nm_lock_status(pll: *mut dsi_pll_7nm) -> c_int {
    static int dsi_pll_7nm_lock_status(struct dsi_pll_7nm *pll)
    {
    int rc;
    let mut status: u32 = 0;
    let mut delay_us: u32 const = 100;
    let mut timeout_us: u32 const = 5000;
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_disable_pll_bias(pll: *mut dsi_pll_7nm) {
    static void dsi_pll_disable_pll_bias(struct dsi_pll_7nm *pll)
    {
    unsigned long flags;
    u32 data;
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_enable_pll_bias(pll: *mut dsi_pll_7nm) {
    static void dsi_pll_enable_pll_bias(struct dsi_pll_7nm *pll)
    {
    unsigned long flags;
    u32 data;
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_cmn_clk_cfg0_write(pll: *mut dsi_pll_7nm, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_disable_global_clk(pll: *mut dsi_pll_7nm) {
    static void dsi_pll_disable_global_clk(struct dsi_pll_7nm *pll)
    {
    dsi_pll_cmn_clk_cfg1_update(pll, DSI_7nm_PHY_CMN_CLK_CFG1_CLK_EN, 0);
    }
#[no_mangle]
unsafe extern "C" fn dsi_pll_enable_global_clk(pll: *mut dsi_pll_7nm) {
    static void dsi_pll_enable_global_clk(struct dsi_pll_7nm *pll)
    {
    let mut cfg_1: u32 = DSI_7nm_PHY_CMN_CLK_CFG1_CLK_EN | DSI_7nm_PHY_CMN_CLK_CFG1_CLK_EN_SEL;
    writel(0x04, pll.phy.base + REG_DSI_7nm_PHY_CMN_CTRL_3);
    dsi_pll_cmn_clk_cfg1_update(pll, cfg_1, cfg_1);
    }
#[no_mangle]
unsafe extern "C" fn dsi_pll_phy_dig_reset(pll: *mut dsi_pll_7nm) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_7nm_vco_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_disable_sub(pll: *mut dsi_pll_7nm) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_7nm_vco_unprepare(hw: *mut clk_hw) {
...
// flush, ensure all register writes are done
    ...
    let mut ref_clk: u64 = VCO_REF_CLK_RATE;
    let mut vco_rate: u64 = 0x0;
    u64 multiplier;
    u32 frac;
    u32 dec;
    u64 pll_freq, tmp64;
...
//
#[no_mangle]
unsafe extern "C" fn dsi_7nm_pll_save_state(phy: *mut msm_dsi_phy) {
...
#[no_mangle]
unsafe extern "C" fn dsi_7nm_pll_restore_state(phy: *mut msm_dsi_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_7nm_set_usecase(phy: *mut msm_dsi_phy) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pll_7nm_register(pll_7nm: *mut dsi_pll_7nm, provided_clocks: *mut clk_hw) -> c_int {
    ...
    REG_DSI_7nm_PHY_PLL_PLL_OUTDIV_RATE,
    0, 2, CLK_DIVIDER_POWER_OF_TWO, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_7nm_init(phy: *mut msm_dsi_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_phy_hw_v4_0_is_pll_on(phy: *mut msm_dsi_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_phy_hw_v4_0_config_lpcdrx(phy: *mut msm_dsi_phy, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn dsi_phy_hw_v4_0_lane_settings(phy: *mut msm_dsi_phy) {
...
// other settings
    ...
    int ret;
    u32 status;
    let mut delay_us: u32 const = 5;
    let mut timeout_us: u32 const = 1000;
...
#[no_mangle]
unsafe extern "C" fn dsi_7nm_set_continuous_clock(phy: *mut msm_dsi_phy, enable: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dsi_7nm_phy_disable(phy: *mut msm_dsi_phy) {
