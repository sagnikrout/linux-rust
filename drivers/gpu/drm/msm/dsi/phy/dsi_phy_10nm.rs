...
//! Source: drivers/gpu/drm/msm/dsi/phy/dsi_phy_10nm.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pll_10nm_cached_state {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dsi_pll_10nm {
    pub clk_hw: clk_hw,
    pub phy: *mut msm_dsi_phy,
    pub vco_current_rate: u64,
// protects REG_DSI_10nm_PHY_CMN_CLK_CFG0 register
    pub postdiv_lock: spinlock_t,
    pub cached_state: pll_10nm_cached_state,
    pub slave: *mut dsi_pll_10nm,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dsi_phy_10nm_tuning_cfg {
    pub rescode_offset_top: [u8; DSI_LANE_MAX],
    pub rescode_offset_bot: [u8; DSI_LANE_MAX],
    pub vreg_ctrl: u8,
}
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_calc_dec_frac(pll: *mut dsi_pll_10nm, config: *mut dsi_pll_config) {
...
#[no_mangle]
pub unsafe extern "C" fn if(3000000000UL: pll_freq <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_calc_ssc(pll: *mut dsi_pll_10nm, config: *mut dsi_pll_config) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_ssc_commit(pll: *mut dsi_pll_10nm, config: *mut dsi_pll_config) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_config_hzindep_reg(pll: *mut dsi_pll_10nm) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_commit(pll: *mut dsi_pll_10nm, config: *mut dsi_pll_config) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_10nm_lock_status(pll: *mut dsi_pll_10nm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_disable_pll_bias(pll: *mut dsi_pll_10nm) {
    static void dsi_pll_disable_pll_bias(struct dsi_pll_10nm *pll)
    {
    let mut data: u32 = readl(pll.phy.base + REG_DSI_10nm_PHY_CMN_CTRL_0);
    writel(0, pll.phy.pll_base + REG_DSI_10nm_PHY_PLL_SYSTEM_MUXES);
    writel(data & ~BIT(5), pll.phy.base + REG_DSI_10nm_PHY_CMN_CTRL_0);
    ndelay(250);
    }
#[no_mangle]
unsafe extern "C" fn dsi_pll_enable_pll_bias(pll: *mut dsi_pll_10nm) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_disable_global_clk(pll: *mut dsi_pll_10nm) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_enable_global_clk(pll: *mut dsi_pll_10nm) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_10nm_vco_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_disable_sub(pll: *mut dsi_pll_10nm) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_10nm_vco_unprepare(hw: *mut clk_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn dsi_10nm_pll_save_state(phy: *mut msm_dsi_phy) {
...
#[no_mangle]
unsafe extern "C" fn dsi_10nm_pll_restore_state(phy: *mut msm_dsi_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_10nm_set_usecase(phy: *mut msm_dsi_phy) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pll_10nm_register(pll_10nm: *mut dsi_pll_10nm, provided_clocks: *mut clk_hw) -> c_int {
...
// DSI Byte clock = VCO_CLK / OUT_DIV / BIT_DIV / 8
    ...
    REG_DSI_10nm_PHY_CMN_CLK_CFG1, 0, 2, 0, core::ptr::null_mut());
    if (IS_ERR(pclk_mux)) {
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_10nm_init(phy: *mut msm_dsi_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_phy_hw_v3_0_is_pll_on(phy: *mut msm_dsi_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_phy_hw_v3_0_config_lpcdrx(phy: *mut msm_dsi_phy, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn dsi_phy_hw_v3_0_lane_settings(phy: *mut msm_dsi_phy) {
...
#[no_mangle]
unsafe extern "C" fn dsi_10nm_phy_disable(phy: *mut msm_dsi_phy) {
...
#[no_mangle]
unsafe extern "C" fn dsi_10nm_phy_parse_dt(phy: *mut msm_dsi_phy) -> c_int {
