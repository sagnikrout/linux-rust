...
//! Source: drivers/gpu/drm/msm/dsi/phy/dsi_phy_28nm_8960.c
#![no_std]
...
// (doesn't set parent rate)
//
pub const POLL_MAX_READS: c_int = 8000;
pub const POLL_TIMEOUT_US: c_int = 1;
pub const VCO_REF_CLK_RATE: c_int = 27000000;
pub const VCO_MIN_RATE: c_int = 600000000;
pub const VCO_MAX_RATE: c_int = 1200000000;
pub const VCO_PREF_DIV_RATIO: c_int = 27;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_28nm_vco_prepare(hw: *mut clk_hw) -> c_int {
    ...
    let mut max_reads: c_int = 1000, timeout_us = 100;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn get_vco_mul_factor(byte_clk_rate: c_ulong) -> c_uint {
...
// convert to bit clock in Mhz
    ...
    return 64;
#[no_mangle]
pub unsafe extern "C" fn if(250: bit_mhz <) -> else {
    else if (bit_mhz < 250)
    return 32;
#[no_mangle]
pub unsafe extern "C" fn if(600: bit_mhz <) -> else {
    else if (bit_mhz < 600)
    return 16;
    else
    return 8;
...
unsafe extern "C" fn pll_28nm_register(pll_28nm: *mut dsi_pll_28nm, provided_clocks: *mut clk_hw) -> c_int {
    ...
    let mut bytediv_init: clk_init_data = { };
    int ret;
...
#[no_mangle]
unsafe extern "C" fn dsi_pll_28nm_8960_init(phy: *mut msm_dsi_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_28nm_phy_regulator_init(phy: *mut msm_dsi_phy) {
...
#[no_mangle]
unsafe extern "C" fn dsi_28nm_phy_regulator_ctrl(phy: *mut msm_dsi_phy) {
...
#[no_mangle]
unsafe extern "C" fn dsi_28nm_phy_calibration(phy: *mut msm_dsi_phy) {
    static void dsi_28nm_phy_calibration(struct msm_dsi_phy *phy)
    {
    void __iomem *base = phy.reg_base;
    u32 status;
    let mut i: c_int = 5000;
...
#[no_mangle]
unsafe extern "C" fn dsi_28nm_phy_lane_config(phy: *mut msm_dsi_phy) {
