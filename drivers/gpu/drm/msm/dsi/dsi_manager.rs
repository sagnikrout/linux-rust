...
//! Source: drivers/gpu/drm/msm/dsi/dsi_manager.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct msm_dsi_manager {
    pub dsi: [*mut msm_dsi; DSI_MAX],
    pub is_bonded_dsi: bool,
    pub is_sync_needed: bool,
    pub master_dsi_link_id: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn dsi_mgr_parse_of(np: *mut device_node, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_mgr_setup_components(id: c_int) -> c_int {
...
//
    ...
    let mut is_bonded_dsi: bool = IS_BONDED_DSI();
...
#[no_mangle]
unsafe extern "C" fn dsi_mgr_phy_disable(id: c_int) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dsi_bridge {
    pub base: drm_bridge,
    pub id: c_int,
}

#[no_mangle]
unsafe extern "C" fn dsi_mgr_bridge_get_id(bridge: *mut drm_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsi_mgr_bridge_power_on(bridge: *mut drm_bridge) -> c_int {
    static int dsi_mgr_bridge_power_on(struct drm_bridge *bridge)
    {
    let mut id: c_int = dsi_mgr_bridge_get_id(bridge);
    struct msm_dsi *msm_dsi = dsi_mgr_get_dsi(id);
...
#[no_mangle]
unsafe extern "C" fn dsi_mgr_bridge_power_off(bridge: *mut drm_bridge) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_manager_tpg_enable() {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_manager_cmd_xfer(id: c_int, msg: *const mipi_dsi_msg) -> c_int {
    int msm_dsi_manager_cmd_xfer(int id, const struct mipi_dsi_msg *msg)
    {
    struct msm_dsi *msm_dsi = dsi_mgr_get_dsi(id);
    struct msm_dsi *msm_dsi0 = dsi_mgr_get_dsi(DSI_0);
    struct mipi_dsi_host *host = msm_dsi.host;
    let mut is_read: bool = (msg.rx_buf && msg.rx_len);
    let mut need_sync: bool = (IS_SYNC_NEEDED() && !is_read);
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_manager_cmd_xfer_trigger(id: c_int, dma_base: u32, len: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_manager_register(msm_dsi: *mut msm_dsi) -> c_int {
    int msm_dsi_manager_register(struct msm_dsi *msm_dsi)
    {
    struct msm_dsi_manager *msm_dsim = &msm_dsim_glb;
    let mut id: c_int = msm_dsi.id;
    int ret;
    if (id >= DSI_MAX) {
    ...
    return 0;
    fail:
    msm_dsim.dsi[id] = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_manager_unregister(msm_dsi: *mut msm_dsi) {
    ...
    if (msm_dsi.id >= 0)
    msm_dsim.dsi[msm_dsi.id] = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_is_bonded_dsi(msm_dsi: *mut msm_dsi) -> bool {
    bool msm_dsi_is_bonded_dsi(struct msm_dsi *msm_dsi)
    {
    return IS_BONDED_DSI();
    }
#[no_mangle]
pub unsafe extern "C" fn msm_dsi_is_master_dsi(msm_dsi: *mut msm_dsi) -> bool {
