...
//! Source: drivers/gpu/drm/virtio/virtgpu_vram.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn virtio_gpu_vram_free(obj: *mut drm_gem_object) {
    ...
    struct virtio_gpu_object *bo = gem_to_virtio_gpu_obj(obj);
    struct virtio_gpu_object_vram *vram = to_virtio_gpu_vram(bo);
    let mut vm_size: c_ulong = vma.vm_end - vma.vm_start;
...
#[no_mangle]
pub unsafe extern "C" fn if(VIRTIO_GPU_MAP_CACHE_UNCACHED: vram->map_info ==) -> else {
...
// sg_table so the dma-buf API still works.
    ...
    if (ret)
    goto out;
    sg_set_page(sgt.sgl, core::ptr::null_mut(), vram.vram_node.size, 0);
...
#[no_mangle]
pub unsafe extern "C" fn virtio_gpu_is_vram(bo: *mut virtio_gpu_object) -> bool {
    bool virtio_gpu_is_vram(struct virtio_gpu_object *bo)
    {
    return bo.base.base.funcs == &virtio_gpu_vram_funcs;
    }
#[no_mangle]
unsafe extern "C" fn virtio_gpu_vram_map(bo: *mut virtio_gpu_object) -> c_int {
...
// Create fake offset
    ...
    virtio_gpu_cmd_resource_create_blob(vgdev, &vram.base, params, core::ptr::null_mut(),
    0);
...
#[no_mangle]
pub unsafe extern "C" fn virtio_gpu_vram_map_deferred(vram: *mut virtio_gpu_object_vram) {
