...
//! Source: drivers/gpu/drm/drm_managed.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drmres_node {
    pub entry: list_head,
    pub release: drmres_release_t,
...
#[no_mangle]
unsafe extern "C" fn free_dr(dr: *mut drmres) {
...
#[no_mangle]
pub unsafe extern "C" fn drm_managed_release(dev: *mut drm_device) {
    ...
    if (dr.node.release)
    dr.node.release(dev, dr.node.size ? *(void **)&dr.data : core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn del_dr(dev: *mut drm_device, dr: *mut drmres) {
...
#[no_mangle]
unsafe extern "C" fn add_dr(dev: *mut drm_device, dr: *mut drmres) {
...
#[no_mangle]
pub unsafe extern "C" fn drmm_add_final_kfree(dev: *mut drm_device, container: *mut c_void) {
...
//
    ...
    void *data)
    {
    struct drmres *dr_match = core::ptr::null_mut(), *dr;
    unsigned long flags;
    spin_lock_irqsave(&dev.managed.lock, flags);
...
//
    ...
    {
    struct drmres *dr;
    dr = alloc_dr(core::ptr::null_mut(), size, gfp, dev_to_node(dev.dev));
    if (!dr) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drmm_kfree(dev: *mut drm_device, data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn __drmm_mutex_release(dev: *mut drm_device, res: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn __drmm_workqueue_release(device: *mut drm_device, res: *mut c_void) {
