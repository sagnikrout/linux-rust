...
//! Source: drivers/gpu/drm/drm_fourcc.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_legacy_fb_format(bpp: u32, depth: u32) -> u32 {
    uint32_t drm_mode_legacy_fb_format(uint32_t bpp, uint32_t depth)
    {
    let mut fmt: u32 = DRM_FORMAT_INVALID;
    switch (bpp) {
    case 1:
    if (depth == 1)
    fmt = DRM_FORMAT_C1;
...
//
    ...
    {
    let mut fmt: u32 = drm_mode_legacy_fb_format(bpp, depth);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_driver_color_mode_format(dev: *mut drm_device, color_mode: c_uint) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_format_info_bpp(info: *const drm_format_info, plane: c_int) -> c_uint {
