...
//! Source: drivers/gpu/drm/sysfb/corebootdrm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn corebootdrm_get_width_fb(dev: *mut drm_device, fb: *const lb_framebuffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn corebootdrm_get_height_fb(dev: *mut drm_device, fb: *const lb_framebuffer) -> c_int {
    ...
    {
    let mut bytes_per_line: u64 = fb.bytes_per_line;
    if (!bytes_per_line)
...
//
    ...
    let mut width: c_uint = sysfb.fb_mode.hdisplay;
    let mut height: c_uint = sysfb.fb_mode.vdisplay;
...
// CRTC
    ...
    &corebootdrm_crtc_funcs, core::ptr::null_mut());
    if (ret)
    return ret;
...
//
#[no_mangle]
unsafe extern "C" fn corebootdrm_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn corebootdrm_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn corebootdrm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn corebootdrm_remove(pdev: *mut platform_device) {
