...
//! Source: drivers/gpu/drm/sysfb/efidrm.c
#![no_std]
...
pub const DRIVER_MINOR: c_int = 0;
    ...
    let mut mem_flags: u64 = EFI_MEMORY_WC | EFI_MEMORY_UC;
    let mut end: resource_size_t = start + len;
...
// CRTC
    ...
    &efidrm_crtc_funcs, core::ptr::null_mut());
    if (ret)
    return ERR_PTR(ret);
...
//
#[no_mangle]
unsafe extern "C" fn efidrm_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efidrm_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efidrm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efidrm_remove(pdev: *mut platform_device) {
