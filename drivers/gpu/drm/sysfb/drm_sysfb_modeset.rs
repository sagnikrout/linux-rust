...
//! Source: drivers/gpu/drm/sysfb/drm_sysfb_modeset.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn to_nonalpha_fourcc(fourcc: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn is_listed_fourcc(fourccs: *const u32, nfourccs: usize, fourcc: u32) -> bool {
...
//
    ...
    let mut extra_nfourccs: static size_t = ARRAY_SIZE(extra_fourccs);
...
//
    let mut fourcc: u32 = to_nonalpha_fourcc(native_fourccs[i]);
...
//
    ...
    let mut fourcc: u32 = extra_fourccs[i];
    if (is_listed_fourcc(fourccs_out, fourccs - fourccs_out, fourcc)) {
...
#[no_mangle]
unsafe extern "C" fn drm_sysfb_plane_state_destroy(sysfb_plane_state: *mut drm_sysfb_plane_state) {
...
#[no_mangle]
unsafe extern "C" fn drm_sysfb_get_blit_func(dst_format: u32, src_format: u32) -> drm_sysfb_blit_func {
...
#[no_mangle]
pub unsafe extern "C" fn drm_sysfb_plane_helper_atomic_update(plane: *mut drm_plane, state: *mut drm_atomic_commit) {
    ...
    struct drm_framebuffer *fb = plane_state.fb;
    let mut dst_pitch: c_uint = sysfb.fb_pitch;
    struct drm_crtc_state *crtc_state = drm_atomic_get_new_crtc_state(state, plane_state.crtc);
    struct drm_sysfb_crtc_state *sysfb_crtc_state = to_drm_sysfb_crtc_state(crtc_state);
    const struct drm_format_info *dst_format = sysfb_crtc_state.format;
    let mut blit_to_crtc: drm_sysfb_blit_func = sysfb_plane_state.blit_to_crtc;
    ...
    let mut dst: iosys_map = sysfb.fb_addr;
    let mut dst_clip: drm_rect = plane_state.dst;
...
#[no_mangle]
pub unsafe extern "C" fn drm_sysfb_plane_reset(plane: *mut drm_plane) {
    ...
    __drm_gem_reset_shadow_plane(plane, core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn drm_sysfb_crtc_state_destroy(sysfb_crtc_state: *mut drm_sysfb_crtc_state) {
...
#[no_mangle]
pub unsafe extern "C" fn drm_sysfb_crtc_helper_atomic_check(crtc: *mut drm_crtc, new_state: *mut drm_atomic_commit) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drm_sysfb_crtc_reset(crtc: *mut drm_crtc) {
...
#[no_mangle]
pub unsafe extern "C" fn drm_sysfb_crtc_atomic_destroy_state(crtc: *mut drm_crtc, crtc_state: *mut drm_crtc_state) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_sysfb_get_edid_block(data: *mut c_void, buf: *mut u8, block: c_uint, len: usize) -> c_int {
    ...
    let mut off: usize = block * EDID_LENGTH;
    let mut end: usize = off + len;
    if (!edid)
    return -EINVAL;
    if (end > EDID_LENGTH)
    return -EINVAL;
...
#[no_mangle]
pub unsafe extern "C" fn drm_sysfb_connector_helper_get_modes(connector: *mut drm_connector) -> c_int {
