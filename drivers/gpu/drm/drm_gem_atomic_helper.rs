...
//! Source: drivers/gpu/drm/drm_gem_atomic_helper.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn __drm_gem_destroy_shadow_plane_state(shadow_plane_state: *mut drm_shadow_plane_state) {
...
//
    ...
    __drm_atomic_helper_plane_reset(plane, core::ptr::null_mut());
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_reset_shadow_plane(plane: *mut drm_plane) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_begin_shadow_fb_access(plane: *mut drm_plane, plane_state: *mut drm_plane_state) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_end_shadow_fb_access(plane: *mut drm_plane, plane_state: *mut drm_plane_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_gem_simple_kms_reset_shadow_plane(pipe: *mut drm_simple_display_pipe) {
