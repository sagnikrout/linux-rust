...
//! Source: drivers/gpu/drm/drm_privacy_screen.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_privacy_screen_lookup_add(lookup: *mut drm_privacy_screen_lookup) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_privacy_screen_lookup_remove(lookup: *mut drm_privacy_screen_lookup) {
...
// drm_privacy_screen_consumer.h functions
    ...
    return dev ? to_drm_privacy_screen(dev) : core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_privacy_screen_put(priv: *mut drm_privacy_screen) {
...
// drm_privacy_screen_driver.h functions
    ...
    ret = -ENODEV;
#[no_mangle]
pub unsafe extern "C" fn if(ARRAY_SIZE(sw_state_names)): WARN_ON(priv->sw_state >=) -> else {
...
//
    ...
    ret = -ENODEV;
#[no_mangle]
pub unsafe extern "C" fn if(ARRAY_SIZE(hw_state_names)): WARN_ON(priv->hw_state >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn drm_privacy_screen_device_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_privacy_screen_unregister(priv: *mut drm_privacy_screen) {
    ...
    mutex_unlock(&drm_privacy_screen_devs_lock);
    mutex_lock(&priv.lock);
    priv.drvdata = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_privacy_screen_call_notifier_chain(priv: *mut drm_privacy_screen) {
