...
//! Source: drivers/gpu/drm/gma500/psb_intel_lvds.c
#![no_std]
...
//
pub const BRIGHTNESS_MAX_LEVEL: c_int = 100;
pub const BRIGHTNESS_MASK: c_uint = 0xFF;
pub const BLC_I2C_TYPE: c_uint = 0x01;
pub const BLC_PWM_TYPT: c_uint = 0x02;
pub const BLC_POLARITY_NORMAL: c_int = 0;
pub const BLC_POLARITY_INVERSE: c_int = 1;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct psb_intel_lvds_priv {
//
...
//
#[no_mangle]
unsafe extern "C" fn psb_intel_lvds_get_max_backlight(dev: *mut drm_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn psb_lvds_pwm_set_brightness(dev: *mut drm_device, level: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn psb_intel_lvds_set_brightness(dev: *mut drm_device, level: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn psb_intel_lvds_set_backlight(dev: *mut drm_device, level: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn psb_intel_lvds_set_power(dev: *mut drm_device, on: bool) {
...
#[no_mangle]
unsafe extern "C" fn psb_intel_lvds_encoder_dpms(encoder: *mut drm_encoder, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn psb_intel_lvds_save(connector: *mut drm_connector) {
...
#[no_mangle]
unsafe extern "C" fn psb_intel_lvds_restore(connector: *mut drm_connector) {
...
//
    if (panel_fixed_mode != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn psb_intel_lvds_prepare(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn psb_intel_lvds_commit(encoder: *mut drm_encoder) {
...
//
#[no_mangle]
unsafe extern "C" fn psb_intel_lvds_get_modes(connector: *mut drm_connector) -> c_int {
    ...
    if (ret)
    return ret;
    if (mode_dev.panel_fixed_mode != core::ptr::null_mut()) {
    struct drm_display_mode *mode =
...
#[no_mangle]
pub unsafe extern "C" fn psb_intel_lvds_destroy(connector: *mut drm_connector) {
