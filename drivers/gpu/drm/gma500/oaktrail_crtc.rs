...
//! Source: drivers/gpu/drm/gma500/oaktrail_crtc.c
#![no_std]
...
pub const MRST_LIMIT_LVDS_100L: c_int = 0;
pub const MRST_LIMIT_LVDS_83: c_int = 1;
pub const MRST_LIMIT_LVDS_100: c_int = 2;
pub const MRST_LIMIT_SDVO: c_int = 3;
pub const MRST_DOT_MIN: c_int = 19750;
pub const MRST_DOT_MAX: c_int = 120000;
pub const MRST_M_MIN_100L: c_int = 20;
pub const MRST_M_MIN_100: c_int = 10;
pub const MRST_M_MIN_83: c_int = 12;
pub const MRST_M_MAX_100L: c_int = 34;
pub const MRST_M_MAX_100: c_int = 17;
pub const MRST_M_MAX_83: c_int = 20;
pub const MRST_P1_MIN: c_int = 2;
pub const MRST_P1_MAX_0: c_int = 7;
pub const MRST_P1_MAX_1: c_int = 8;
...
pub const MRST_M_MIN: c_int = 10;
    ...
    int refclk)
    {
    const struct gma_limit_t *limit = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mrst_lvds_clock(refclk: c_int, clock: *mut gma_clock_t) {
    static void mrst_lvds_clock(int refclk, struct gma_clock_t *clock)
    {
    clock.dot = (refclk * clock.m) / (14 * clock.p1);
    }
#[no_mangle]
unsafe extern "C" fn mrst_print_pll(clock: *mut gma_clock_t) {
...
//
#[no_mangle]
unsafe extern "C" fn oaktrail_crtc_dpms(crtc: *mut drm_crtc, mode: c_int) {
    ...
    u32 temp;
    int i;
    let mut need_aux: c_int = gma_pipe_has_type(crtc, INTEL_OUTPUT_SDVO) ? 1 : 0;
...
//
#[no_mangle]
unsafe extern "C" fn oaktrail_panel_fitter_pipe(dev: *mut drm_device) -> c_int {
...
// See if the panel fitter is in use
    ...
    let mut pipe: c_int = gma_crtc.pipe;
    const struct psb_offset *map = &dev_priv.regmap[pipe];
    let mut refclk: c_int = 0;
    struct gma_clock_t clock;
    const struct gma_limit_t *limit;
    let mut dpll: u32 = 0, fp = 0, dspcntr, pipeconf;
    bool ok, is_sdvo = false;
    let mut is_lvds: bool = false;
    let mut is_mipi: bool = false;
    struct gma_encoder *gma_encoder = core::ptr::null_mut();
    let mut scalingType: u64 = DRM_MODE_SCALE_FULLSCREEN;
...
// ends to get centering
    let mut offsetX: c_int = 0, offsetY = 0;
