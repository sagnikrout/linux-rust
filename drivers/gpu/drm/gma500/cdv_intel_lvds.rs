...
//! Source: drivers/gpu/drm/gma500/cdv_intel_lvds.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdv_intel_lvds_priv {
//
...
//
#[no_mangle]
unsafe extern "C" fn cdv_intel_lvds_get_max_backlight(dev: *mut drm_device) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn cdv_intel_lvds_set_backlight(dev: *mut drm_device, level: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cdv_intel_lvds_encoder_dpms(encoder: *mut drm_encoder, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cdv_intel_lvds_save(connector: *mut drm_connector) {
    static void cdv_intel_lvds_save(struct drm_connector *connector)
    {
    }
#[no_mangle]
unsafe extern "C" fn cdv_intel_lvds_restore(connector: *mut drm_connector) {
...
#[no_mangle]
unsafe extern "C" fn cdv_intel_lvds_prepare(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn cdv_intel_lvds_commit(encoder: *mut drm_encoder) {
...
//
#[no_mangle]
unsafe extern "C" fn cdv_intel_lvds_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdv_intel_lvds_destroy(connector: *mut drm_connector) {
