...
//! Source: drivers/gpu/drm/gma500/psb_intel_display.c
#![no_std]
...
pub const INTEL_LIMIT_I9XX_SDVO_DAC: c_int = 0;
pub const INTEL_LIMIT_I9XX_LVDS: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn psb_intel_clock(refclk: c_int, clock: *mut gma_clock_t) {
...
//
#[no_mangle]
unsafe extern "C" fn psb_intel_panel_fitter_pipe(dev: *mut drm_device) -> c_int {
...
// Must be on PIPE 1 for PSB
    ...
    let mut is_lvds: bool = false, is_tv = false;
    struct drm_connector_list_iter conn_iter;
    struct drm_connector *connector;
    const struct gma_limit_t *limit;
// No scan out no play
    if (crtc.primary.fb == core::ptr::null_mut()) {
...
//
    ...
    gma_crtc.cursor_pobj = core::ptr::null_mut();
    goto out;
    }
...
// Setup the array of drm_connector pointer array
    ...
    dev_priv.plane_to_crtc_mapping[gma_crtc.plane] != core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn gma_connector_clones(dev: *mut drm_device, type_mask: c_int) -> c_int {
    int gma_connector_clones(struct drm_device *dev, int type_mask)
    {
    struct drm_connector_list_iter conn_iter;
    struct drm_connector *connector;
    let mut index_mask: c_int = 0;
