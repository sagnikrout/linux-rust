...
//! Source: drivers/gpu/drm/gma500/oaktrail_lvds.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn oaktrail_lvds_dpms(encoder: *mut drm_encoder, mode: c_int) {
...
// XXX: We never power down the LVDS pairs.
    ...
    u32 lvds_port;
    let mut v: u64 = DRM_MODE_SCALE_FULLSCREEN;
    if (!gma_power_begin(dev, true))
    return;
//
...
#[no_mangle]
pub unsafe extern "C" fn if(DRM_MODE_SCALE_ASPECT: v ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn oaktrail_lvds_prepare(encoder: *mut drm_encoder) {
...
#[no_mangle]
unsafe extern "C" fn oaktrail_lvds_get_max_backlight(dev: *mut drm_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn oaktrail_lvds_commit(encoder: *mut drm_encoder) {
...
// Returns the panel fixed mode from configuration.
    ...
    mode_dev.panel_fixed_mode = core::ptr::null_mut();
...
// Use the BIOS VBT mode if available
    if (mode_dev.panel_fixed_mode == core::ptr::null_mut() && mode_dev.vbt_mode)
...
//
    ...
    struct gma_i2c_chan *ddc_bus = core::ptr::null_mut();
...
//
    ...
    if (edid == core::ptr::null_mut() && dev_priv.lpc_gpio_base) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: i2c_adap) -> else {
    else if (i2c_adap)
    i2c_put_adapter(i2c_adap);
