...
//! Source: drivers/gpu/drm/gma500/oaktrail_device.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn oaktrail_output_init(dev: *mut drm_device) -> c_int {
...
//
pub const MRST_BLC_MAX_PWM_REG_FREQ: c_uint = 0xFFFF;

pub const BLC_PWM_FREQ_CALC_CONSTANT: c_int = 32;
pub const MHz: c_int = 1000000;
pub const BLC_ADJUSTMENT_MAX: c_int = 100;
#[no_mangle]
unsafe extern "C" fn oaktrail_set_brightness(dev: *mut drm_device, level: c_int) {
...
#[no_mangle]
unsafe extern "C" fn oaktrail_backlight_init(dev: *mut drm_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn oaktrail_save_display_registers(dev: *mut drm_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn oaktrail_restore_display_registers(dev: *mut drm_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn oaktrail_power_down(dev: *mut drm_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn oaktrail_power_up(dev: *mut drm_device) -> c_int {
    static int oaktrail_power_up(struct drm_device *dev)
    {
    struct drm_psb_private *dev_priv = to_drm_psb_private(dev);
    let mut pwr_mask: u32 = PSB_PWRGT_DISPLAY_MASK;
    u32 pwr_sts, pwr_cnt;
...
#[no_mangle]
unsafe extern "C" fn oaktrail_chip_setup(dev: *mut drm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oaktrail_teardown(dev: *mut drm_device) {
