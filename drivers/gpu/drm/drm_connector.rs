...
//! Source: drivers/gpu/drm/drm_connector.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_conn_prop_enum_list {
    pub type: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn drm_connector_ida_init() {
...
#[no_mangle]
pub unsafe extern "C" fn drm_connector_ida_destroy() {
...
//
#[no_mangle]
unsafe extern "C" fn drm_connector_get_cmdline_mode(connector: *mut drm_connector) {
...
#[no_mangle]
unsafe extern "C" fn drm_connector_free(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn drm_connector_free_work_fn(work: *mut work_struct) {
...
// provide ddc symlink in sysfs
    ...
    connector.edid_blob_ptr = core::ptr::null_mut();
    connector.epoch_counter = 0;
    connector.tile_blob_ptr = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn drm_connector_add(connector: *mut drm_connector) {
...
#[no_mangle]
unsafe extern "C" fn drm_connector_remove(connector: *mut drm_connector) {
...
//
    ...
    return -EINVAL;
    return drm_connector_init_and_add(dev, connector, funcs, connector_type, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_attach_edid_property(connector: *mut drm_connector) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_cec_phys_addr_invalidate(connector: *mut drm_connector) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_cec_phys_addr_set(connector: *mut drm_connector) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_cleanup(connector: *mut drm_connector) {
...
//
    ...
    connector.privacy_screen = core::ptr::null_mut();
    }
    if (connector.tile_group) {
    drm_mode_put_tile_group(dev, connector.tile_group);
    connector.tile_group = core::ptr::null_mut();
    }
    ...
    connector.name = core::ptr::null_mut();
    fwnode_handle_put(connector.fwnode);
    connector.fwnode = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_register(connector: *mut drm_connector) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_dynamic_register(connector: *mut drm_connector) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_unregister(connector: *mut drm_connector) {
...
#[no_mangle]
pub unsafe extern "C" fn drm_connector_unregister_all(dev: *mut drm_device) {
...
#[no_mangle]
pub unsafe extern "C" fn drm_connector_register_all(dev: *mut drm_device) -> c_int {
...
//
    ...
    return "connected";
#[no_mangle]
pub unsafe extern "C" fn if(connector_status_disconnected: status ==) -> else {
...
//
    ...
    {
    iter.dev = dev;
    iter.conn = core::ptr::null_mut();
    lock_acquire_shared_recursive(&connector_list_iter_dep_map, 0, 1, core::ptr::null_mut(), _RET_IP_);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_list_iter_end(iter: *mut drm_connector_list_iter) {
    void drm_connector_list_iter_end(struct drm_connector_list_iter *iter)
    {
    struct drm_mode_config *config = &iter.dev.mode_config;
    unsigned long flags;
    iter.dev = core::ptr::null_mut();
    if (iter.conn) {
    spin_lock_irqsave(&config.connector_list_lock, flags);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_get_tv_mode_from_name(name: *const c_char, len: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_create_standard_properties(dev: *mut drm_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_create_dvi_i_properties(dev: *mut drm_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_attach_dp_subconnector_property(connector: *mut drm_connector) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_attach_content_type_property(connector: *mut drm_connector) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_attach_tv_margin_properties(connector: *mut drm_connector) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_create_tv_margin_properties(dev: *mut drm_device) -> c_int {
...
//
    ...
    return drm_mode_create_tv_properties_legacy(dev, 0, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_create_scaling_mode_property(dev: *mut drm_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_create_aspect_ratio_property(dev: *mut drm_device) -> c_int {
    ...
    if (dev.mode_config.aspect_ratio_property == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
...
//
    ...
    {
    struct drm_device *dev = connector.dev;
    let mut colorspaces: u32 = supported_colorspaces | BIT(DRM_MODE_COLORIMETRY_DEFAULT);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_create_content_type_property(dev: *mut drm_device) -> c_int {
    ...
    if (dev.mode_config.content_type_property == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_create_suggested_offset_properties(dev: *mut drm_device) -> c_int {
    ...
    if (dev.mode_config.suggested_x_property == core::ptr::null_mut() ||
    dev.mode_config.suggested_y_property == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_set_tile_property(connector: *mut drm_connector) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_attach_hdr_output_metadata_property(connector: *mut drm_connector) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_attach_broadcast_rgb_property(connector: *mut drm_connector) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_attach_colorspace_property(connector: *mut drm_connector) -> c_int {
...
//
    ...
    let mut old_blob: return = = new_blob;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_update_privacy_screen(connector_state: *const drm_connector_state) {
...
//
    ...
    struct drm_encoder *encoder;
    struct drm_display_mode *mode;
    let mut mode_count: c_int = 0;
    let mut encoders_count: c_int = 0;
    let mut ret: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn drm_tile_group_free(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_connector_attach_panel_type_property(connector: *mut drm_connector) {
