...
//! Source: drivers/gpu/drm/drm_pagemap.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_pagemap_zdd {
    pub refcount: kref,
    pub devmem_allocation: *mut drm_pagemap_devmem,
...
//
    ...
    zdd.devmem_allocation = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn drm_pagemap_zdd_destroy(ref: *mut kref) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_pagemap_zdd_put(zdd: *mut drm_pagemap_zdd) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_pagemap_migration_unlock_put_folio(folio: *mut folio) {
...
//
    ...
    {
    let mut num_peer_pages: c_ulong = 0, num_local_pages = 0, i;
    for (i = 0; i < npages;) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_pagemap_iova_state {
...
//
    ...
    npages, DMA_FROM_DEVICE, core::ptr::null_mut());
    return err;
    }
    static int
...
pub struct migrate_range_loc {
    ...
    const struct drm_pagemap_migrate_details *mdetails)
    {
    let mut state: drm_pagemap_iova_state = {};
    let mut ret: c_int = 0;
    if (cur.start == 0)
    goto out;
...
//
#[no_mangle]
unsafe extern "C" fn drm_pagemap_cpages(migrate_pfn: *mut c_ulong, npages: c_ulong) -> c_int {
...
//
    ...
    let mut own_pages: c_ulong = 0, migrated_pages = 0;
    struct migrate_range_loc cur, last = {.device = dpagemap.drm.dev, .ops = ops};
    struct vm_area_struct *vas;
    struct drm_pagemap_zdd *zdd = core::ptr::null_mut();
    struct page **pages;
    struct drm_pagemap_addr *pagemap_addr;
    void *buf;
    int err;
...
// Count device-private pages to migrate
    ...
    let mut nr_pages: c_ulong = src_page ? NR_PAGES(folio_order(page_folio(src_page))) : 1;
    ...
    if (!pages[i]) {
    cur.dpagemap = core::ptr::null_mut();
    cur.ops = ops;
...
// If we switched the migrating drm_pagemap, migrate previous pages now
    ...
    cur.start = npages;
    cur.ops = core::ptr::null_mut(); /* Force migration */
    err = drm_pagemap_migrate_range(devmem_allocation, migrate.src, migrate.dst,
    ...
    devmem_allocation.pre_migrate_fence = core::ptr::null_mut();
// Upon success bind devmem allocation to range and zdd
    ...
    let mut nr_pages: c_ulong = page ? NR_PAGES(folio_order(page_folio(page))) : 1;
...
//
    ...
    unsigned long i;
    for (i = 0; i < npages;) {
    struct page *page = core::ptr::null_mut(), *src_page;
    struct folio *folio;
    let mut order: c_uint = 0;
    let mut gfp: gfp_t = GFP_HIGHUSER;
...
// that range.
//
    let mut nr: c_ulong = NR_PAGES(order);
    unsigned long j;
    gfp &= ~__GFP_NOWARN;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_pagemap_dev_hold {
    pub link: llist_node,
    pub drm: *mut drm_device,
}

#[no_mangle]
unsafe extern "C" fn drm_pagemap_release(ref: *mut kref) {
...
//
    dpagemap.dev_hold = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn drm_pagemap_dev_unhold_work(work: *mut work_struct) {
    static void drm_pagemap_dev_unhold_work(struct work_struct *work)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_pagemap_reinit(dpagemap: *mut drm_pagemap) -> c_int {
...
//
    ...
    dpagemap.drm = drm;
    dpagemap.cache = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_pagemap_put(dpagemap: *mut drm_pagemap) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_pagemap_page_get_flags(page: *mut page) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_pagemap_evict_to_ram(devmem_allocation: *mut drm_pagemap_devmem) -> c_int {
    ...
    err = drm_pagemap_migrate_populate_ram_pfn(core::ptr::null_mut(), core::ptr::null_mut(), npages, &mpages,
    src, dst, 0);
    if (err || !mpages)
    goto err_finalize;
    ...
    err = ops.copy_to_ram(pages, pagemap_addr, npages, core::ptr::null_mut());
    if (err)
    goto err_finalize;
    err_finalize:
...
//
#[no_mangle]
unsafe extern "C" fn drm_pagemap_folio_free(folio: *mut folio) {
...
//
#[no_mangle]
unsafe extern "C" fn drm_pagemap_migrate_to_ram(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn drm_pagemap_folio_split(orig_folio: *mut folio, new_folio: *mut folio) {
...
#[no_mangle]
pub unsafe extern "C" fn drm_pagemap_destroy(dpagemap: *mut drm_pagemap, is_atomic_or_reclaim: bool) {
...
#[no_mangle]
unsafe extern "C" fn drm_pagemap_exit() {
