...
//! Source: drivers/gpu/drm/drm_color_mgmt.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_color_ctm_s31_32_to_qm_n(user_input: u64, m: u32, n: u32) -> u64 {
    u64 drm_color_ctm_s31_32_to_qm_n(u64 user_input, u32 m, u32 n)
    {
    let mut mag: u64 = (user_input & ~BIT_ULL(63)) >> (32 - n);
    let mut negative: bool = !!(user_input & BIT_ULL(63));
    s64 val;
    WARN_ON(m > 32 || n > 32);
...
//
#[no_mangle]
unsafe extern "C" fn drm_crtc_supports_legacy_gamma(crtc: *mut drm_crtc) -> bool {
    static bool drm_crtc_supports_legacy_gamma(struct drm_crtc *crtc)
    {
    let mut gamma_id: u32 = crtc.dev.mode_config.gamma_lut_property.base.id;
    let mut degamma_id: u32 = crtc.dev.mode_config.degamma_lut_property.base.id;
    if (!crtc.gamma_size)
    return false;
...
//
    ...
    let mut gamma_id: u32 = dev.mode_config.gamma_lut_property.base.id;
    let mut degamma_id: u32 = dev.mode_config.degamma_lut_property.base.id;
    bool use_gamma_lut;
    int i, ret = 0;
    bool replaced;
    if (crtc.funcs.gamma_set)
    ...
    use_gamma_lut = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: drm_mode_obj_find_prop_id(&crtc->base, _arg: degamma_id)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_color_lut_check(lut: *const drm_property_blob, tests: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_crtc_fill_gamma_888(crtc: *mut drm_crtc, set_gamma: drm_crtc_set_lut_func) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_crtc_fill_gamma_565(crtc: *mut drm_crtc, set_gamma: drm_crtc_set_lut_func) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_crtc_fill_gamma_555(crtc: *mut drm_crtc, set_gamma: drm_crtc_set_lut_func) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_crtc_fill_palette_332(crtc: *mut drm_crtc, set_palette: drm_crtc_set_lut_func) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_crtc_fill_palette_8(crtc: *mut drm_crtc, set_palette: drm_crtc_set_lut_func) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_color_lut32_check(lut: *const drm_property_blob, tests: u32) -> c_int {
