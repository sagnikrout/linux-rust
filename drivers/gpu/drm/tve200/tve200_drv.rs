...
//! Source: drivers/gpu/drm/tve200/tve200_drv.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tve200_modeset_init(dev: *mut drm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tve200_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tve200_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tve200_shutdown(pdev: *mut platform_device) {
