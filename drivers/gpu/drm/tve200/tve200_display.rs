...
//! Source: drivers/gpu/drm/tve200/tve200_display.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn tve200_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tve200_display_disable(pipe: *mut drm_simple_display_pipe) {
...
#[no_mangle]
unsafe extern "C" fn tve200_display_enable_vblank(pipe: *mut drm_simple_display_pipe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tve200_display_disable_vblank(pipe: *mut drm_simple_display_pipe) {
...
#[no_mangle]
pub unsafe extern "C" fn tve200_display_init(drm: *mut drm_device) -> c_int {
