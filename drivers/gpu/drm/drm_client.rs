...
//! Source: drivers/gpu/drm/drm_client.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn drm_client_open(client: *mut drm_client_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_client_close(client: *mut drm_client_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_client_register(client: *mut drm_client_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_client_release(client: *mut drm_client_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_client_buffer_delete(buffer: *mut drm_client_buffer) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_client_buffer_vunmap_local(buffer: *mut drm_client_buffer) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_client_buffer_vunmap(buffer: *mut drm_client_buffer) {
...
//
    ...
    struct drm_device *dev = client.dev;
    let mut dumb_args: drm_mode_create_dumb = { };
    struct drm_client_buffer *buffer;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_client_buffer_flush(buffer: *mut drm_client_buffer, rect: *mut drm_rect) -> c_int {
