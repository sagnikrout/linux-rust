...
//! Source: drivers/gpu/drm/drm_modeset_helper.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_helper_move_panel_connectors_to_head(dev: *mut drm_device) {
...
//
    ...
    ret = drm_crtc_init_with_planes(dev, crtc, primary, core::ptr::null_mut(), funcs, core::ptr::null_mut());
    if (ret)
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_config_helper_suspend(dev: *mut drm_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_mode_config_helper_resume(dev: *mut drm_device) -> c_int {
    ...
    dev.mode_config.suspend_state = core::ptr::null_mut();
    drm_client_dev_resume(dev);
//
