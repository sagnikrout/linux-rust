...
//! Source: drivers/gpu/drm/gud/gud_connector.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gud_conn_err(connector: *mut drm_connector, msg: *const c_char, ret: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn gud_connector_backlight_update_status_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn gud_connector_backlight_update_status(bd: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gud_connector_backlight_register(gconn: *mut gud_connector) -> c_int {
    ...
    connector.index, core::ptr::null_mut(), 0);
    if (ret) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gud_connector_get_edid_ctx {
    pub buf: *mut c_void,
    pub len: usize,
    pub edid_override: bool,
}

#[no_mangle]
unsafe extern "C" fn gud_connector_get_edid_block(data: *mut c_void, buf: *mut u8, block: c_uint, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gud_connector_get_modes(connector: *mut drm_connector) -> c_int {
    static int gud_connector_get_modes(struct drm_connector *connector)
    {
    struct gud_device *gdrm = to_gud_device(connector.dev);
    struct gud_display_mode_req *reqmodes = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn gud_connector_late_register(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gud_connector_early_unregister(connector: *mut drm_connector) {
...
#[no_mangle]
unsafe extern "C" fn gud_connector_destroy(connector: *mut drm_connector) {
...
#[no_mangle]
unsafe extern "C" fn gud_connector_reset(connector: *mut drm_connector) {
...
//
#[no_mangle]
unsafe extern "C" fn gud_connector_add_tv_mode(gdrm: *mut gud_device, connector: *mut drm_connector) -> c_int {
    static int gud_connector_add_tv_mode(struct gud_device *gdrm, struct drm_connector *connector)
    {
    let mut buf_len: usize = GUD_CONNECTOR_TV_MODE_MAX_NUM * GUD_CONNECTOR_TV_MODE_NAME_LEN;
...
#[no_mangle]
unsafe extern "C" fn gud_connector_add_properties(gdrm: *mut gud_device, gconn: *mut gud_connector) -> c_int {
...
// This is a no-op if already added.
    ret = drm_mode_create_tv_properties_legacy(drm, 0, core::ptr::null_mut());
    if (ret)
    goto out;
    break;
...
// state_val = val;
    ...
    let mut prop: u16 = gconn.properties[i];
    u64 val;
    if (prop == GUD_PROPERTY_BACKLIGHT_BRIGHTNESS) {
...
#[no_mangle]
pub unsafe extern "C" fn gud_get_connectors(gdrm: *mut gud_device) -> c_int {
