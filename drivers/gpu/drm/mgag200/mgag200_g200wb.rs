...
//! Source: drivers/gpu/drm/mgag200/mgag200_g200wb.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mgag200_g200wb_init_registers(mdev: *mut mga_device) {
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200wb_pipeline_init(mdev: *mut mga_device) -> c_int {
    ...
    &mgag200_g200wb_crtc_funcs, core::ptr::null_mut());
    if (ret) {
