...
//! Source: drivers/gpu/drm/mgag200/mgag200_mode.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mga_wait_vsync(mdev: *mut mga_device) {
...
#[no_mangle]
pub unsafe extern "C" fn mga_wait_busy(mdev: *mut mga_device) {
...
//
#[no_mangle]
unsafe extern "C" fn mgag200_set_datasiz(mdev: *mut mga_device, format: u32) {
    static void mgag200_set_datasiz(struct mga_device *mdev, u32 format)
    {

    let mut opmode: u32 = RREG32(MGAREG_OPMODE);
...
#[no_mangle]
pub unsafe extern "C" fn mgag200_init_registers(mdev: *mut mga_device) {
...
// Work around hardware quirk
    ...
    {
    u8 crtc13, crtcext0;
    let mut offset: u32 = fb.pitches[0] / 16;
...
#[no_mangle]
pub unsafe extern "C" fn mgag200_set_format_regs(mdev: *mut mga_device, format: *const drm_format_info) {
    void mgag200_set_format_regs(struct mga_device *mdev, const struct drm_format_info *format)
    {
    let mut xmulctrl: u8 = 0;
    u8 crtcext3;
...
#[no_mangle]
pub unsafe extern "C" fn mgag200_enable_display(mdev: *mut mga_device) {
...
#[no_mangle]
unsafe extern "C" fn mgag200_disable_display(mdev: *mut mga_device) {
...
//
    ...
    {
    let mut dst: iosys_map = IOSYS_MAP_INIT_VADDR_IOMEM(mdev.vram);
...
//
    ...
    let mut mgag200_primary_plane_formats_size: usize = ARRAY_SIZE(mgag200_primary_plane_formats);
    ...
    struct drm_framebuffer *fb = core::ptr::null_mut();
...
// Always scanout image at VRAM offset 0
    ...
    let mut map: iosys_map = IOSYS_MAP_INIT_VADDR_IOMEM(mdev.vram);
...
#[no_mangle]
pub unsafe extern "C" fn mgag200_crtc_helper_atomic_check(crtc: *mut drm_crtc, new_state: *mut drm_atomic_commit) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mgag200_crtc_helper_atomic_flush(crtc: *mut drm_crtc, old_state: *mut drm_atomic_commit) {
...
#[no_mangle]
pub unsafe extern "C" fn mgag200_crtc_helper_atomic_enable(crtc: *mut drm_crtc, old_state: *mut drm_atomic_commit) {
...
#[no_mangle]
pub unsafe extern "C" fn mgag200_crtc_helper_atomic_disable(crtc: *mut drm_crtc, old_state: *mut drm_atomic_commit) {
...
#[no_mangle]
pub unsafe extern "C" fn mgag200_crtc_reset(crtc: *mut drm_crtc) {
...
#[no_mangle]
pub unsafe extern "C" fn mgag200_crtc_atomic_destroy_state(crtc: *mut drm_crtc, crtc_state: *mut drm_crtc_state) {
...
//
#[no_mangle]
unsafe extern "C" fn mgag200_mode_config_helper_atomic_commit_tail(state: *mut drm_atomic_commit) {
...
// Calculates a mode's required memory bandwidth (in KiB/sec).
    ...
    let mut bytes_per_pixel: u64 = (bits_per_pixel + 7) / 8;
    divisor = 1024;
...
//
    ...
    let mut mode_bandwidth: u32 = mgag200_calculate_mode_bandwidth(mode, max_bpp * 8);
...
#[no_mangle]
pub unsafe extern "C" fn mgag200_mode_config_init(mdev: *mut mga_device, vram_available: resource_size_t) -> c_int {
