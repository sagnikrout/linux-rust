...
//! Source: drivers/gpu/drm/mgag200/mgag200_g200.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200_init_pci_options(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200_init_registers(g200: *mut mgag200_g200_device) {
...
//
#[no_mangle]
unsafe extern "C" fn mgag200_g200_pixpllc_atomic_check(crtc: *mut drm_crtc, new_state: *mut drm_atomic_commit) -> c_int {
    static int mgag200_g200_pixpllc_atomic_check(struct drm_crtc *crtc, struct drm_atomic_commit *new_state)
    {
    let mut post_div_max: static int = 7;
    let mut in_div_min: static int = 1;
    let mut in_div_max: static int = 6;
    let mut feed_div_min: static int = 7;
    let mut feed_div_max: static int = 127;
    ...
    let mut n: u8 = 0, m = 0, p, s;
    long f_vco;
    long computed;
    long delta, tmp_delta;
    let mut ref_clk: c_long = g200.ref_clk;
    let mut p_clk_min: c_long = g200.pclk_min;
    let mut p_clk_max: c_long = g200.pclk_max;
    if (clock > p_clk_max) {
    ...
    s = 0;
#[no_mangle]
pub unsafe extern "C" fn if(140000: f_vco <) -> else {
    else if (f_vco < 140000)
    s = 1;
#[no_mangle]
pub unsafe extern "C" fn if(180000: f_vco <) -> else {
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200_pipeline_init(mdev: *mut mga_device) -> c_int {
    ...
    &mgag200_g200_crtc_funcs, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200_init_refclk(g200: *mut mgag200_g200_device) {
