...
//! Source: drivers/gpu/drm/mgag200/mgag200_g200eh.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mgag200_g200eh_init_registers(mdev: *mut mga_device) {
...
//
    ...
    let mut pllreffreq: static unsigned int = 33333;
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200eh_pipeline_init(mdev: *mut mga_device) -> c_int {
    ...
    &mgag200_g200eh_crtc_funcs, core::ptr::null_mut());
    if (ret) {
