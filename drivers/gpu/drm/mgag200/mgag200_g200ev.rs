...
//! Source: drivers/gpu/drm/mgag200/mgag200_g200ev.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200ev_init_registers(mdev: *mut mga_device) {
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200ev_set_hiprilvl(mdev: *mut mga_device) {
...
//
    ...
    {
    let mut vcomax: static unsigned int = 550000;
    let mut vcomin: static unsigned int = 150000;
    let mut pllreffreq: static unsigned int = 50000;
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200ev_pipeline_init(mdev: *mut mga_device) -> c_int {
    ...
    &mgag200_g200ev_crtc_funcs, core::ptr::null_mut());
    if (ret) {
