...
//! Source: drivers/gpu/drm/mgag200/mgag200_g200se.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200se_init_pci_options(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200se_init_registers(g200se: *mut mgag200_g200se_device) {
    ...
    hiprilvl = 0;
#[no_mangle]
pub unsafe extern "C" fn if(2600: mb >) -> else {
    else if (mb > 2600)
    hiprilvl = 1;
#[no_mangle]
pub unsafe extern "C" fn if(1900: mb >) -> else {
    else if (mb > 1900)
    hiprilvl = 2;
#[no_mangle]
pub unsafe extern "C" fn if(1160: mb >) -> else {
    else if (mb > 1160)
    hiprilvl = 3;
#[no_mangle]
pub unsafe extern "C" fn if(440: mb >) -> else {
    else if (mb > 440)
    hiprilvl = 4;
    else
    hiprilvl = 5;
...
//
    ...
    {
    let mut vcomax: static unsigned int = 320000;
    let mut vcomin: static unsigned int = 160000;
    ...
    struct drm_atomic_commit *new_state)
    {
    let mut vcomax: static unsigned int = 1600000;
    let mut vcomin: static unsigned int = 800000;
    let mut pllreffreq: static unsigned int = 25000;
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200se_pipeline_init(mdev: *mut mga_device) -> c_int {
    ...
    &mgag200_g200se_crtc_funcs, core::ptr::null_mut());
    if (ret) {
...
//
    ...
    MGAG200_DEVICE_INFO_INIT(2048, 2048, 55000, false, 0, 1, false);
#[no_mangle]
unsafe extern "C" fn mgag200_g200se_init_unique_rev_id(g200se: *mut mgag200_g200se_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x02: g200se->unique_rev_id >=) -> else {
    else if (g200se.unique_rev_id >= 0x02)
