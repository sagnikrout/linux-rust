...
//! Source: drivers/gpu/drm/mgag200/mgag200_g200eh5.c
#![no_std]
...
//
    ...
    let mut fdelta: c_ulonglong = ULLONG_MAX;
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200eh5_pipeline_init(mdev: *mut mga_device) -> c_int {
    ...
    &mgag200_g200eh5_crtc_funcs, core::ptr::null_mut());
    if (ret) {
