...
//! Source: drivers/gpu/drm/mgag200/mgag200_g200er.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200er_init_registers(mdev: *mut mga_device) {
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200er_reset_tagfifo(mdev: *mut mga_device) {
...
//
    ...
    {
    let mut vcomax: static unsigned int = 1488000;
    let mut vcomin: static unsigned int = 1056000;
    let mut pllreffreq: static unsigned int = 48000;
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200er_pipeline_init(mdev: *mut mga_device) -> c_int {
    ...
    &mgag200_g200er_crtc_funcs, core::ptr::null_mut());
    if (ret) {
