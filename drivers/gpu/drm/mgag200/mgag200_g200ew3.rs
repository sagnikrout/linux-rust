...
//! Source: drivers/gpu/drm/mgag200/mgag200_g200ew3.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200ew3_init_registers(mdev: *mut mga_device) {
...
//
    ...
    {
    let mut vcomax: static unsigned int = 800000;
    let mut vcomin: static unsigned int = 400000;
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200ew3_pipeline_init(mdev: *mut mga_device) -> c_int {
    ...
    &mgag200_g200ew3_crtc_funcs, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn mgag200_g200ew3_device_probe_vram(mdev: *mut mga_device) -> resource_size_t {
    static resource_size_t mgag200_g200ew3_device_probe_vram(struct mga_device *mdev)
    {
    let mut vram_size: resource_size_t = resource_size(mdev.vram_res);
