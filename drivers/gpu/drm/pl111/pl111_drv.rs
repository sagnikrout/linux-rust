...
//! Source: drivers/gpu/drm/pl111/pl111_drv.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pl111_modeset_init(dev: *mut drm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl111_amba_remove(amba_dev: *mut amba_device) {
...
#[no_mangle]
unsafe extern "C" fn pl111_amba_shutdown(amba_dev: *mut amba_device) {
