...
//! Source: drivers/gpu/drm/sun4i/sun8i_hdmi_phy.c
#![no_std]
...
//
pub const I2C_ADDR: c_uint = 0x69;
...
// pixelclk   symbol   term   vlev
    ...
    const struct drm_display_mode *mode)
    {
    let mut clk_rate: c_uint = mode.crtc_clock * 1000;
...
#[no_mangle]
unsafe extern "C" fn sun8i_a83t_hdmi_phy_disable(hdmi: *mut dw_hdmi, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sun8i_h3_hdmi_phy_disable(hdmi: *mut dw_hdmi, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sun8i_hdmi_phy_unlock(phy: *mut sun8i_hdmi_phy) {
...
#[no_mangle]
unsafe extern "C" fn sun50i_hdmi_phy_init_h6(phy: *mut sun8i_hdmi_phy) {
...
#[no_mangle]
unsafe extern "C" fn sun8i_hdmi_phy_init_a83t(phy: *mut sun8i_hdmi_phy) {
...
#[no_mangle]
unsafe extern "C" fn sun8i_hdmi_phy_init_h3(phy: *mut sun8i_hdmi_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_hdmi_phy_init(phy: *mut sun8i_hdmi_phy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_hdmi_phy_deinit(phy: *mut sun8i_hdmi_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_hdmi_phy_get(hdmi: *mut sun8i_dw_hdmi, node: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_hdmi_phy_probe(pdev: *mut platform_device) -> c_int {
