...
//! Source: drivers/gpu/drm/sun4i/sun4i_hdmi_enc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sun4i_hdmi_clear_avi_infoframe(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_hdmi_clear_hdmi_infoframe(connector: *mut drm_connector) -> c_int {
    ...
    let mut tmds_rate: c_ulonglong = conn_state.hdmi.tmds_char_rate;
    unsigned int x, y;
    let mut val: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn sun4i_hdmi_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_hdmi_connector_reset(connector: *mut drm_connector) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_hdmi_cec_pin_read(adap: *mut cec_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_hdmi_cec_pin_low(adap: *mut cec_adapter) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_hdmi_cec_pin_high(adap: *mut cec_adapter) {
...
// Only difference from sun5i is AMP is 4 instead of 6
    ...
    hdmi.reset = devm_reset_control_get(dev, core::ptr::null_mut());
    ...
    if (ret == -ENODEV)
    hdmi.ddc_i2c = core::ptr::null_mut();
    else
...
#[no_mangle]
unsafe extern "C" fn sun4i_hdmi_probe(pdev: *mut platform_device) -> c_int {
    static int sun4i_hdmi_probe(struct platform_device *pdev)
    {
    return component_add(&pdev.dev, &sun4i_hdmi_ops);
    }
#[no_mangle]
unsafe extern "C" fn sun4i_hdmi_remove(pdev: *mut platform_device) {
