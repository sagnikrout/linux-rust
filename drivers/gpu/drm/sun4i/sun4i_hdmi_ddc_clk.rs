...
//! Source: drivers/gpu/drm/sun4i/sun4i_hdmi_ddc_clk.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun4i_ddc {
    pub hw: clk_hw,
    pub hdmi: *mut sun4i_hdmi,
    pub reg: *mut regmap_field,
    pub pre_div: u8,
    pub m_offset: u8,
}
    ...
    let mut best_m: u8 = 0, best_n = 0, _m, _n;
    for (_m = 0; _m < 16; _m++) {
    for (_n = 0; _n < 8; _n++) {
...
// n = best_n;
    ...
    ddc.pre_div, ddc.m_offset, core::ptr::null_mut(), core::ptr::null_mut());
    return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_ddc_create(hdmi: *mut sun4i_hdmi, parent: *mut clk) -> c_int {
