...
//! Source: drivers/gpu/drm/sun4i/sun4i_tv.c
#![no_std]
...
pub const SUN4I_TVE_EN_REG: c_uint = 0x000;

pub const SUN4I_TVE_CFG0_REG: c_uint = 0x004;

pub const SUN4I_TVE_DAC0_REG: c_uint = 0x008;

pub const SUN4I_TVE_NOTCH_REG: c_uint = 0x00c;

pub const SUN4I_TVE_CHROMA_FREQ_REG: c_uint = 0x010;
pub const SUN4I_TVE_PORCH_REG: c_uint = 0x014;

pub const SUN4I_TVE_LINE_REG: c_uint = 0x01c;

pub const SUN4I_TVE_LEVEL_REG: c_uint = 0x020;

pub const SUN4I_TVE_DAC1_REG: c_uint = 0x024;

pub const SUN4I_TVE_DETECT_STA_REG: c_uint = 0x038;

pub const SUN4I_TVE_DETECT_STA_UNCONNECTED: c_int = 0;
pub const SUN4I_TVE_DETECT_STA_CONNECTED: c_int = 1;
pub const SUN4I_TVE_DETECT_STA_GROUND: c_int = 2;
pub const SUN4I_TVE_CB_CR_LVL_REG: c_uint = 0x10c;

pub const SUN4I_TVE_TINT_BURST_PHASE_REG: c_uint = 0x110;

pub const SUN4I_TVE_BURST_WIDTH_REG: c_uint = 0x114;

pub const SUN4I_TVE_CB_CR_GAIN_REG: c_uint = 0x118;

pub const SUN4I_TVE_SYNC_VBI_REG: c_uint = 0x11c;

pub const SUN4I_TVE_ACTIVE_LINE_REG: c_uint = 0x124;

pub const SUN4I_TVE_CHROMA_REG: c_uint = 0x128;

pub const SUN4I_TVE_12C_REG: c_uint = 0x12c;

pub const SUN4I_TVE_RESYNC_REG: c_uint = 0x130;

pub const SUN4I_TVE_SLAVE_REG: c_uint = 0x134;
pub const SUN4I_TVE_WSS_DATA2_REG: c_uint = 0x244;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct color_gains {
    pub cb: u16,
    pub cr: u16,
}
...
pub struct tv_mode {
    ...
    pub back_porch: u16,
    pub front_porch: u16,
    pub vblank_level: u16,
    pub yc_en: bool,
    pub dac3_en: bool,
    pub dac_bit25_en: bool,
    pub color_gains: *const color_gains,
    pub burst_levels: *const burst_levels,
    pub video_levels: *const video_levels,
    pub resync_params: *const resync_parameters,
}
...
#[no_mangle]
unsafe extern "C" fn sun4i_tv_connector_reset(connector: *mut drm_connector) {
    ...
    tv.reset = devm_reset_control_get(dev, core::ptr::null_mut());
    if (IS_ERR(tv.reset)) {
    ...
    tv.clk = devm_clk_get(dev, core::ptr::null_mut());
    if (IS_ERR(tv.clk)) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_tv_probe(pdev: *mut platform_device) -> c_int {
    static int sun4i_tv_probe(struct platform_device *pdev)
    {
    return component_add(&pdev.dev, &sun4i_tv_ops);
    }
#[no_mangle]
unsafe extern "C" fn sun4i_tv_remove(pdev: *mut platform_device) {
