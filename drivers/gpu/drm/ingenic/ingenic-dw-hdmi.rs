...
//! Source: drivers/gpu/drm/ingenic/ingenic-dw-hdmi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ingenic_dw_hdmi_cleanup(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_dw_hdmi_probe(pdev: *mut platform_device) -> c_int {
