...
//! Source: drivers/gpu/drm/ingenic/ingenic-drm-drv.c
#![no_std]
...
pub const HWDESC_PALETTE: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingenic_dma_hwdesc {
    pub next: u32,
    pub addr: u32,
    pub id: u32,
    pub cmd: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingenic_dma_hwdescs {
    pub hwdesc: [ingenic_dma_hwdesc; 3],
    pub __aligned(16): u16 palette[256],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct jz_soc_info {
    pub needs_dev_clk: bool,
    pub has_osd: bool,
    pub has_alpha: bool,
    pub map_noncoherent: bool,
    pub use_extended_hwdesc: bool,
    pub plane_f0_not_working: bool,
    pub max_burst: u32,
    pub max_height: unsigned int max_width,,
    pub formats_f1: *const *const u32 formats_f0,,
    pub num_formats_f1: unsigned int num_formats_f0,,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingenic_drm_private_state {
...
//
    pub ipu_plane: *mut drm_plane f0, f1,,
    pub crtc: drm_crtc,
    pub dev: *mut device,
    pub map: *mut regmap,
    pub pix_clk: *mut *mut clk lcd_clk,,
    pub soc_info: *const jz_soc_info,
    pub dma_hwdescs: *mut ingenic_dma_hwdescs,
    pub dma_hwdescs_phys: dma_addr_t,
    pub panel_is_sharp: bool,
    pub no_vblank: bool,
//
...
//
    pub clk_mutex: mutex,
    pub update_clk_rate: bool,
    pub clock_nb: notifier_block,
    pub private_obj: drm_private_obj,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingenic_drm_bridge {
    pub encoder: drm_encoder,
    pub next_bridge: *mut drm_bridge bridge,,
    pub bus_cfg: drm_bus_cfg,
}
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
    ...
    unsigned int idx)
    {
    let mut offset: u32 = offsetof(struct ingenic_dma_hwdescs, hwdesc[idx]);
...
//
    ...
    crtc);
    struct ingenic_drm *priv = drm_crtc_get_priv(crtc);
    struct drm_plane_state *f1_state, *f0_state, *ipu_state = core::ptr::null_mut();
    struct ingenic_drm_private_state *priv_state;
...
#[no_mangle]
pub unsafe extern "C" fn ingenic_drm_plane_disable(dev: *mut device, plane: *mut drm_plane) {
...
#[no_mangle]
pub unsafe extern "C" fn ingenic_drm_map_noncoherent(dev: *const device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_irq_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_enable_vblank(crtc: *mut drm_crtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_disable_vblank(crtc: *mut drm_crtc) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_unbind_all(d: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_release_rmem(d: *mut c_void) -> void __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_configure_hwdesc_palette(priv: *mut ingenic_drm) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_atomic_private_obj_fini(drm: *mut drm_device, private_obj: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_bind(dev: *mut device, has_components: bool) -> c_int {
...
// Configure DMA hwdesc for palette
    ...
    core::ptr::null_mut(), &ingenic_drm_crtc_funcs, core::ptr::null_mut());
    if (ret) {
    ...
    core::ptr::null_mut(), DRM_PLANE_TYPE_OVERLAY,
    core::ptr::null_mut());
    if (ret) {
    ...
    core::ptr::null_mut(), DRM_MODE_ENCODER_DPI, core::ptr::null_mut());
    if (IS_ERR(ib)) {
    ret = PTR_ERR(ib);
    ...
    ret = drm_bridge_attach(encoder, &ib.bridge, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_bind_with_components(dev: *mut device) -> c_int {
    static int ingenic_drm_bind_with_components(struct device *dev)
    {
    return ingenic_drm_bind(dev, true);
    }
#[no_mangle]
unsafe extern "C" fn ingenic_drm_unbind(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ingenic_drm_exit() {
