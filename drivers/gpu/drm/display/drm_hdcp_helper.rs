...
//! Source: drivers/gpu/drm/display/drm_hdcp_helper.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn drm_hdcp_print_ksv(ksv: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn drm_hdcp_get_revoked_ksv_count(buf: *const u8, vrls_length: u32) -> u32 {
    static u32 drm_hdcp_get_revoked_ksv_count(const u8 *buf, u32 vrls_length)
    {
    let mut parsed_bytes: u32 = 0, ksv_count = 0, vrl_ksv_cnt, vrl_sz;
...
//
    ...
    let mut parsed_bytes: u32 = 0, ksv_count = 0;
    do {
    vrl_ksv_cnt = *buf;
...
#[no_mangle]
pub unsafe extern "C" fn get_vrl_length(buf: *const u8) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn is_srm_version_hdcp1(buf: *const u8) -> bool {
    static inline bool is_srm_version_hdcp1(const u8 *buf)
    {
    return *buf == (u8)(DRM_HDCP_1_4_SRM_ID << 4);
    }
#[no_mangle]
pub unsafe extern "C" fn is_srm_version_hdcp2(buf: *const u8) -> bool {
    ...
    revoked_ksv_cnt);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_srm_version_hdcp2(buf)) -> else {
...
//
    ...
    u32 ksv_count)
    {
    let mut revoked_ksv_cnt: u32 = 0, i, j;
    u8 *revoked_ksv_list = core::ptr::null_mut();
    let mut ret: c_int = 0;
