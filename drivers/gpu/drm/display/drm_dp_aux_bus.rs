...
//! Source: drivers/gpu/drm/display/drm_dp_aux_bus.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dp_aux_ep_device_with_data {
    pub aux_ep: dp_aux_ep_device,
    pub aux): *mut *mut int (done_probing)(struct drm_dp_aux,
}
...
//
#[no_mangle]
unsafe extern "C" fn dp_aux_ep_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dp_aux_ep_probe(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dp_aux_ep_remove(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn dp_aux_ep_shutdown(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn dp_aux_ep_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn dp_aux_ep_dev_modalias(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn of_dp_aux_ep_destroy(dev: *mut device, data: *mut c_void) -> c_int {
...
pub unsafe extern "C" fn of_dp_aux_depopulate_bus(aux: *mut drm_dp_aux) {
    ...
    {
    device_for_each_child_reverse(aux.dev, core::ptr::null_mut(), of_dp_aux_ep_destroy);
    }
...
//
    ...
    {
    struct device_node *bus = core::ptr::null_mut(), *np = core::ptr::null_mut();
...
// drm_dp_aux_init() should have been called already; warn if not
    ...
    if (!bus)
    return -ENODEV;
    np = of_get_next_available_child(bus, core::ptr::null_mut());
    of_node_put(bus);
    if (!np)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn of_dp_aux_depopulate_bus_void(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn __dp_aux_dp_driver_register(drv: *mut dp_aux_ep_driver, owner: *mut module) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dp_aux_dp_driver_unregister(drv: *mut dp_aux_ep_driver) {
...
#[no_mangle]
unsafe extern "C" fn dp_aux_bus_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dp_aux_bus_exit() -> void __exit {
