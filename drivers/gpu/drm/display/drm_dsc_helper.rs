...
//! Source: drivers/gpu/drm/display/drm_dsc_helper.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dsc_dp_pps_header_init(pps_header: *mut dp_sdp_header) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dsc_dp_rc_buffer_size(rc_buffer_block_size: u8, rc_buffer_size: u8) -> c_int {
    int drm_dsc_dp_rc_buffer_size(u8 rc_buffer_block_size, u8 rc_buffer_size)
    {
    let mut size: c_int = 1024 * (rc_buffer_size + 1);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dsc_set_const_params(vdsc_cfg: *mut drm_dsc_config) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dsc_set_rc_buf_thresh(vdsc_cfg: *mut drm_dsc_config) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rc_parameters_data {
    pub bpp: u8,
    pub bpc: u8,
    pub params: rc_parameters,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dsc_setup_rc_params(vdsc_cfg: *mut drm_dsc_config, type: enum drm_dsc_params_type) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dsc_compute_rc_parameters(vdsc_cfg: *mut drm_dsc_config) -> c_int {
    int drm_dsc_compute_rc_parameters(struct drm_dsc_config *vdsc_cfg)
    {
    let mut groups_per_line: c_ulong = 0;
    let mut groups_total: c_ulong = 0;
    let mut num_extra_mux_bits: c_ulong = 0;
    let mut slice_bits: c_ulong = 0;
    let mut hrd_delay: c_ulong = 0;
    let mut final_scale: c_ulong = 0;
    let mut rbs_min: c_ulong = 0;
...
// chunksize in Bytes
    ...
    - 2);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: vdsc_cfg->native_422) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dsc_get_bpp_int(vdsc_cfg: *const drm_dsc_config) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dsc_initial_scale_value(dsc: *const drm_dsc_config) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dsc_flatness_det_thresh(dsc: *const drm_dsc_config) -> u32 {
