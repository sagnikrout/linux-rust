...
//! Source: drivers/gpu/drm/display/drm_dp_cec.c
#![no_std]
...
//
pub const NEVER_UNREG_DELAY: c_int = 1000;
    let mut drm_dp_cec_unregister_delay: static unsigned int = 1;
...
#[no_mangle]
unsafe extern "C" fn drm_dp_cec_adap_enable(adap: *mut cec_adapter, enable: bool) -> c_int {
    static int drm_dp_cec_adap_enable(struct cec_adapter *adap, bool enable)
    {
    struct drm_dp_aux *aux = cec_get_drvdata(adap);
    let mut val: u32 = enable ? DP_CEC_TUNNELING_ENABLE : 0;
    let mut err: isize = 0;
    err = drm_dp_dpcd_write_byte(aux, DP_CEC_TUNNELING_CONTROL, val);
    return (enable && err < 0) ? err : 0;
    }
#[no_mangle]
unsafe extern "C" fn drm_dp_cec_adap_log_addr(adap: *mut cec_adapter, addr: u8) -> c_int {
    static int drm_dp_cec_adap_log_addr(struct cec_adapter *adap, u8 addr)
    {
    struct drm_dp_aux *aux = cec_get_drvdata(adap);
// Bit 15 (logical address 15) should always be set
    let mut la_mask: u16 = 1 << CEC_LOG_ADDR_BROADCAST;
    u8 mask[2];
    ssize_t err;
    ...
    {
    struct drm_dp_aux *aux = cec_get_drvdata(adap);
    let mut retries: c_uint = min(5, attempts - 1);
    ssize_t err;
...
#[no_mangle]
unsafe extern "C" fn drm_dp_cec_received(aux: *mut drm_dp_aux) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_dp_cec_handle_irq(aux: *mut drm_dp_aux) {
...
#[no_mangle]
pub unsafe extern "C" fn if(DP_CEC_TX_LINE_ERROR: flags &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_cec_irq(aux: *mut drm_dp_aux) {
...
#[no_mangle]
unsafe extern "C" fn drm_dp_cec_cap(aux: *mut drm_dp_aux, cec_cap: *mut u8) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn drm_dp_cec_unregister_work(work: *mut work_struct) {
    ...
    aux.cec.adap = core::ptr::null_mut();
    mutex_unlock(&aux.cec.lock);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_cec_attach(aux: *mut drm_dp_aux, source_physical_address: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_cec_set_edid(aux: *mut drm_dp_aux, edid: *const edid) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_cec_unset_edid(aux: *mut drm_dp_aux) {
...
//
    ...
    !drm_dp_cec_cap(aux, core::ptr::null_mut())) {
//
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_cec_unregister_connector(aux: *mut drm_dp_aux) {
