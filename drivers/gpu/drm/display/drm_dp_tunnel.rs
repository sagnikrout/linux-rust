...
//! Source: drivers/gpu/drm/display/drm_dp_tunnel.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_dp_tunnel_regs {
    pub buf: [u8; HWEIGHT64(DPTUN_INFO_REG_MASK)],
}
...
pub struct drm_dp_tunnel {
    pub group: *mut drm_dp_tunnel_group,
    pub node: list_head,
    pub kref: kref,
    pub tracker: *mut ref_tracker,
    pub aux: *mut drm_dp_aux,
    pub name: [c_char; 8],
    pub bw_granularity: c_int,
    pub estimated_bw: c_int,
    pub allocated_bw: c_int,
    pub dprx_128b132b_rates: u8,
    pub max_dprx_rate: c_int,
    pub max_dprx_lane_count: u8,
    pub adapter_id: u8,
    pub dprx_128b132b_support:1: bool,
    pub dprx_128b132b_lane0_mapping_support:1: bool,
    pub bw_alloc_supported:1: bool,
    pub bw_alloc_enabled:1: bool,
    pub has_io_error:1: bool,
    pub destroyed:1: bool,
    pub pr_optimization_support:1: bool,
}
...
pub struct drm_dp_tunnel_state {
    pub group_state: *mut drm_dp_tunnel_group_state,
    pub tunnel_ref: drm_dp_tunnel_ref,
    pub node: list_head,
    pub stream_mask: u32,
    pub stream_bw: *mut c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_dp_tunnel_group_state {
    pub base: drm_private_state,
    pub tunnel_states: list_head,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_dp_tunnel_group {
    pub base: drm_private_obj,
    pub mgr: *mut drm_dp_tunnel_mgr,
    pub tunnels: list_head,
// available BW including the allocated_bw of all tunnels in the group
    pub available_bw: c_int,
    pub drv_group_id: u8,
    pub name: [c_char; 8],
    pub active:1: bool,
}
...
pub struct drm_dp_tunnel_mgr {
    ...
    pub groups: *mut drm_dp_tunnel_group,
    pub bw_req_queue: wait_queue_head_t,

    pub ref_tracker: ref_tracker_dir,
...
//
#[no_mangle]
unsafe extern "C" fn next_reg_area(offset: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_tunnel_regs(aux: *mut drm_dp_aux, regs: *mut drm_dp_tunnel_regs) -> c_int {
    static int read_tunnel_regs(struct drm_dp_aux *aux, struct drm_dp_tunnel_regs *regs)
    {
    let mut offset: c_int = 0;
    int len;
    while ((len = next_reg_area(&offset))) {
    let mut address: c_int = DP_TUNNELING_BASE + offset;
...
#[no_mangle]
unsafe extern "C" fn tunnel_reg(regs: *const drm_dp_tunnel_regs, address: c_int) -> u8 {
    static u8 tunnel_reg(const struct drm_dp_tunnel_regs *regs, int address)
    {
    return *tunnel_reg_ptr(regs, address);
    }
#[no_mangle]
unsafe extern "C" fn tunnel_reg_drv_group_id(regs: *const drm_dp_tunnel_regs) -> u8 {
    static u8 tunnel_reg_drv_group_id(const struct drm_dp_tunnel_regs *regs)
    {
    let mut drv_id: u8 = tunnel_reg(regs, DP_USB4_DRIVER_ID) & DP_USB4_DRIVER_ID_MASK;
    let mut group_id: u8 = tunnel_reg(regs, DP_IN_ADAPTER_TUNNEL_INFORMATION) & DP_GROUP_ID_MASK;
    if (!group_id)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn tunnel_reg_bw_granularity(regs: *const drm_dp_tunnel_regs) -> c_int {
    static int tunnel_reg_bw_granularity(const struct drm_dp_tunnel_regs *regs)
    {
    let mut gr: c_int = tunnel_reg(regs, DP_BW_GRANULARITY) & DP_BW_GRANULARITY_MASK;
    if (gr > 2)
    return -1;
    return (250000 << gr) / 8;
    }
#[no_mangle]
unsafe extern "C" fn tunnel_reg_dprx_128b132b_support(regs: *const drm_dp_tunnel_regs) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tunnel_reg_dprx_128b132b_lane0_mapping_support(regs: *const drm_dp_tunnel_regs) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tunnel_reg_dprx_128b132b_rates(regs: *const drm_dp_tunnel_regs) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn max_128b132b_rate(rates: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn if(DP_TUNNELING_13_5GBPS_PER_LANE_SUPPORT: rates &) -> else {
    else if (rates & DP_TUNNELING_13_5GBPS_PER_LANE_SUPPORT)
    return DP_TUNNELING_13_5GBPS_PER_LANE_SUPPORT;
#[no_mangle]
pub unsafe extern "C" fn if(DP_TUNNELING_10GBPS_PER_LANE_SUPPORT: rates &) -> else {
...
#[no_mangle]
unsafe extern "C" fn tunnel_reg_max_dprx_rate(regs: *const drm_dp_tunnel_regs) -> c_int {
    static int tunnel_reg_max_dprx_rate(const struct drm_dp_tunnel_regs *regs)
    {
    let mut bw_code: u8 = max_128b132b_rate(tunnel_reg_dprx_128b132b_rates(regs));
    if (!bw_code)
    bw_code = tunnel_reg(regs, DP_TUNNELING_MAX_LINK_RATE);
    return drm_dp_bw_code_to_link_rate(bw_code);
    }
#[no_mangle]
unsafe extern "C" fn tunnel_reg_max_dprx_lane_count(regs: *const drm_dp_tunnel_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tunnel_reg_bw_alloc_supported(regs: *const drm_dp_tunnel_regs) -> bool {
    static bool tunnel_reg_bw_alloc_supported(const struct drm_dp_tunnel_regs *regs)
    {
    let mut cap_mask: u8 = DP_TUNNELING_SUPPORT | DP_IN_BW_ALLOCATION_MODE_SUPPORT;
...
#[no_mangle]
unsafe extern "C" fn tunnel_reg_bw_alloc_enabled(regs: *const drm_dp_tunnel_regs) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tunnel_group_drv_id(drv_group_id: u8) -> u8 {
    static u8 tunnel_group_drv_id(u8 drv_group_id)
    {
    return drv_group_id >> DP_GROUP_ID_BITS;
    }
#[no_mangle]
unsafe extern "C" fn tunnel_group_id(drv_group_id: u8) -> u8 {
    ...
    {
    struct drm_dp_tunnel_group *group = core::ptr::null_mut();
    int i;
...
#[no_mangle]
unsafe extern "C" fn free_group(group: *mut drm_dp_tunnel_group) {
...
#[no_mangle]
unsafe extern "C" fn free_tunnel(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn tunnel_put(tunnel: *mut drm_dp_tunnel) {
...
//
    ...
    {
    let mut drv_group_id: u8 = tunnel_reg_drv_group_id(regs);
    struct drm_dp_tunnel *tunnel;
...
#[no_mangle]
unsafe extern "C" fn destroy_tunnel(tunnel: *mut drm_dp_tunnel) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_set_io_error(tunnel: *mut drm_dp_tunnel) {
    ...
    {
    let mut drv_group_id: u8 = tunnel_reg_drv_group_id(regs);
    let mut check_dprx: bool = !(flags & SKIP_DPRX_CAPS_CHECK);
...
#[no_mangle]
unsafe extern "C" fn tunnel_allocated_bw(tunnel: *const drm_dp_tunnel) -> c_int {
    ...
    unsigned int flags)
    {
    let mut new_drv_group_id: u8 = tunnel_reg_drv_group_id(regs);
    let mut ret: bool = true;
...
#[no_mangle]
unsafe extern "C" fn update_dprx_caps(tunnel: *mut drm_dp_tunnel, regs: *const drm_dp_tunnel_regs) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dev_id_len(dev_id: *const u8, max_len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_max_dprx_bw(tunnel: *const drm_dp_tunnel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_max_tunnel_bw(tunnel: *const drm_dp_tunnel) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_destroy(tunnel: *mut drm_dp_tunnel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_tunnel(tunnel: *const drm_dp_tunnel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn group_allocated_bw(group: *mut drm_dp_tunnel_group) -> c_int {
    static int group_allocated_bw(struct drm_dp_tunnel_group *group)
    {
    struct drm_dp_tunnel *tunnel;
    let mut group_allocated_bw: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn group_free_bw(tunnel: *const drm_dp_tunnel) -> c_int {
    static int group_free_bw(const struct drm_dp_tunnel *tunnel)
    {
    return tunnel.estimated_bw - tunnel_allocated_bw(tunnel);
    }
#[no_mangle]
unsafe extern "C" fn calc_group_available_bw(tunnel: *const drm_dp_tunnel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_bw_alloc_mode(tunnel: *mut drm_dp_tunnel, enable: bool) -> c_int {
    static int set_bw_alloc_mode(struct drm_dp_tunnel *tunnel, bool enable)
    {
    let mut mask: u8 = DP_DISPLAY_DRIVER_BW_ALLOCATION_MODE_ENABLE | DP_UNMASK_BW_ALLOCATION_IRQ;
    u8 val;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_enable_bw_alloc(tunnel: *mut drm_dp_tunnel) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_disable_bw_alloc(tunnel: *mut drm_dp_tunnel) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_bw_alloc_is_enabled(tunnel: *const drm_dp_tunnel) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_pr_optimization_supported(tunnel: *const drm_dp_tunnel) -> bool {
...
#[no_mangle]
unsafe extern "C" fn clear_bw_req_state(aux: *mut drm_dp_aux) -> c_int {
    static int clear_bw_req_state(struct drm_dp_aux *aux)
    {
    let mut bw_req_mask: u8 = DP_BW_REQUEST_SUCCEEDED | DP_BW_REQUEST_FAILED;
    if (drm_dp_dpcd_write_byte(aux, DP_TUNNELING_STATUS, bw_req_mask) < 0)
    return -EIO;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn bw_req_complete(aux: *mut drm_dp_aux, status_changed: *mut bool) -> c_int {
    static int bw_req_complete(struct drm_dp_aux *aux, bool *status_changed)
    {
    let mut bw_req_mask: u8 = DP_BW_REQUEST_SUCCEEDED | DP_BW_REQUEST_FAILED;
    let mut status_change_mask: u8 = DP_BW_ALLOCATION_CAPABILITY_CHANGED | DP_ESTIMATED_BW_CHANGED;
    u8 val;
    int err;
...
// status_changed = val & status_change_mask;
    ...
    if (err < 0)
    return err;
    let mut val: return = = DP_BW_REQUEST_SUCCEEDED ? 0 : -ENOSPC;
    }
#[no_mangle]
unsafe extern "C" fn allocate_tunnel_bw(tunnel: *mut drm_dp_tunnel, bw: c_int) -> c_int {
    static int allocate_tunnel_bw(struct drm_dp_tunnel *tunnel, int bw)
    {
    struct drm_dp_tunnel_mgr *mgr = tunnel.group.mgr;
    let mut request_bw: c_int = DIV_ROUND_UP(bw, tunnel.bw_granularity);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_alloc_bw(tunnel: *mut drm_dp_tunnel, bw: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_get_allocated_bw(tunnel: *mut drm_dp_tunnel) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn check_and_clear_status_change(tunnel: *mut drm_dp_tunnel) -> c_int {
    static int check_and_clear_status_change(struct drm_dp_tunnel *tunnel)
    {
    let mut mask: u8 = DP_BW_ALLOCATION_CAPABILITY_CHANGED | DP_ESTIMATED_BW_CHANGED;
    u8 val;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_update_state(tunnel: *mut drm_dp_tunnel) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_handle_irq(mgr: *mut drm_dp_tunnel_mgr, aux: *mut drm_dp_aux) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_128b132b_supported(tunnel: *const drm_dp_tunnel) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_128b132b_lane0_mapping_supported(tunnel: *const drm_dp_tunnel) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_128b132b_dprx_rates(tunnel: *const drm_dp_tunnel) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_max_dprx_rate(tunnel: *const drm_dp_tunnel) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_max_dprx_lane_count(tunnel: *const drm_dp_tunnel) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_available_bw(tunnel: *const drm_dp_tunnel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_tunnel_state(tunnel_state: *mut drm_dp_tunnel_state) {
...
#[no_mangle]
unsafe extern "C" fn free_group_state(group_state: *mut drm_dp_tunnel_group_state) {
...
#[no_mangle]
unsafe extern "C" fn tunnel_group_destroy_state(obj: *mut drm_private_obj, state: *mut drm_private_state) {
...
#[no_mangle]
unsafe extern "C" fn init_group(mgr: *mut drm_dp_tunnel_mgr, group: *mut drm_dp_tunnel_group) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cleanup_group(group: *mut drm_dp_tunnel_group) {
...
#[no_mangle]
unsafe extern "C" fn check_unique_stream_ids(group_state: *const drm_dp_tunnel_group_state) {
    static void check_unique_stream_ids(const struct drm_dp_tunnel_group_state *group_state)
    {
    const struct drm_dp_tunnel_state *tunnel_state;
    let mut stream_mask: u32 = 0;
    for_each_tunnel_state(group_state, tunnel_state) {
...
#[no_mangle]
unsafe extern "C" fn stream_id_to_idx(stream_mask: u32, stream_id: u8) -> c_int {
    ...
    {
    let mut move_mask: c_ulong = old_mask & new_mask;
    int *new_bws = core::ptr::null_mut();
    int id;
    WARN_ON(!new_mask);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_atomic_get_required_bw(tunnel_state: *const drm_dp_tunnel_state) -> c_int {
    int drm_dp_tunnel_atomic_get_required_bw(const struct drm_dp_tunnel_state *tunnel_state)
    {
    let mut tunnel_bw: c_int = 0;
    int i;
...
// stream_mask |= tunnel_state->stream_mask;
    ...
    struct drm_dp_tunnel_state *new_tunnel_state;
    let mut group_stream_mask: u32 = 0;
    let mut group_bw: c_int = 0;
    for_each_tunnel_state(new_group_state, new_tunnel_state) {
    struct drm_dp_tunnel *tunnel = new_tunnel_state.tunnel_ref.tunnel;
    let mut max_dprx_bw: c_int = get_max_dprx_bw(tunnel);
    let mut tunnel_bw: c_int = drm_dp_tunnel_atomic_get_required_bw(new_tunnel_state);
    tun_dbg(tunnel,
...
#[no_mangle]
unsafe extern "C" fn destroy_mgr(mgr: *mut drm_dp_tunnel_mgr) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_tunnel_mgr_destroy(mgr: *mut drm_dp_tunnel_mgr) {
