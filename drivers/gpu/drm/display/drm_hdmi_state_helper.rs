...
//! Source: drivers/gpu/drm/display/drm_hdmi_state_helper.c
#![no_std]
...
//
    ...
    {
    let mut max_bpc: c_uint = connector.max_bpc;
...
//
    ...
    &infoframe.data.avi;
    let mut is_limited_range: bool = conn_state.hdmi.is_limited_range;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_atomic_helper_connector_hdmi_force(connector: *mut drm_connector) {
