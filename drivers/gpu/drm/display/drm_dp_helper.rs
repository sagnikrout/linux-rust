...
//! Source: drivers/gpu/drm/display/drm_dp_helper.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dp_aux_backlight {
    pub base: *mut backlight_device,
...
#[no_mangle]
unsafe extern "C" fn dp_link_status(link_status[DP_LINK_STATUS_SIZE]: u8, r: c_int) -> u8 {
    ...
    int lane)
    {
    let mut i: c_int = DP_LANE0_1_STATUS + (lane >> 1);
    let mut s: c_int = (lane & 1) * 4;
    let mut l: u8 = dp_link_status(link_status, i);
    return (l >> s) & 0xf;
    }
...
#[no_mangle]
pub unsafe extern "C" fn drm_dp_post_lt_adj_req_in_progress(link_status[DP_LINK_STATUS_SIZE]: u8) -> bool {
    bool drm_dp_post_lt_adj_req_in_progress(const u8 link_status[DP_LINK_STATUS_SIZE])
    {
    let mut lane_align: u8 = dp_link_status(link_status, DP_LANE_ALIGN_STATUS_UPDATED);
    ...
    int lane)
    {
    let mut i: c_int = DP_ADJUST_REQUEST_LANE0_1 + (lane >> 1);
    int s = ((lane & 1) ?
...
// DP 2.0 errata for 128b/132b
#[no_mangle]
pub unsafe extern "C" fn drm_dp_128b132b_eq_interlane_align_done(link_status[DP_LINK_STATUS_SIZE]: u8) -> bool {
    bool drm_dp_128b132b_eq_interlane_align_done(const u8 link_status[DP_LINK_STATUS_SIZE])
    {
    let mut status: u8 = dp_link_status(link_status, DP_LANE_ALIGN_STATUS_UPDATED);
    return status & DP_128B132B_DPRX_EQ_INTERLANE_ALIGN_DONE;
    }
    EXPORT_SYMBOL(drm_dp_128b132b_eq_interlane_align_done);
// DP 2.0 errata for 128b/132b
#[no_mangle]
pub unsafe extern "C" fn drm_dp_128b132b_cds_interlane_align_done(link_status[DP_LINK_STATUS_SIZE]: u8) -> bool {
...
// DP 2.0 errata for 128b/132b
#[no_mangle]
pub unsafe extern "C" fn drm_dp_128b132b_link_training_failed(link_status[DP_LINK_STATUS_SIZE]: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __8b10b_clock_recovery_delay_us(aux: *const drm_dp_aux, rd_interval: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __8b10b_channel_eq_delay_us(aux: *const drm_dp_aux, rd_interval: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __128b132b_channel_eq_delay_us(aux: *const drm_dp_aux, rd_interval: u8) -> c_int {
...
// Per DP 2.0 Errata
#[no_mangle]
pub unsafe extern "C" fn drm_dp_128b132b_read_aux_rd_interval(aux: *mut drm_dp_aux) -> c_int {
...
// default to max
    ...
    u8 rd_interval)
    {
    let mut delay_us: c_int = __8b10b_channel_eq_delay_us(aux, rd_interval);
    usleep_range(delay_us, delay_us * 2);
    }
...
#[no_mangle]
pub unsafe extern "C" fn drm_dp_lttpr_link_train_clock_recovery_delay() {
...
#[no_mangle]
unsafe extern "C" fn dp_lttpr_phy_cap(phy_cap[DP_LTTPR_PHY_CAP_SIZE]: u8, r: c_int) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_lttpr_wake_timeout_setup(aux: *mut drm_dp_aux, transparent_mode: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn drm_dp_link_rate_to_bw_code(link_rate: c_int) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn drm_dp_bw_code_to_link_rate(link_bw: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_dpcd_probe(aux: *mut drm_dp_aux, offset: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_dpcd_set_powered(aux: *mut drm_dp_aux, powered: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_dpcd_set_probe(aux: *mut drm_dp_aux, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn dpcd_access_needs_probe(aux: *mut drm_dp_aux) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_link_power_up(aux: *mut drm_dp_aux, revision: c_uchar) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_link_power_down(aux: *mut drm_dp_aux, revision: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_payload_update_status(aux: *mut drm_dp_aux) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_dpcd_clear_payload(aux: *mut drm_dp_aux) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_dpcd_poll_act_handled(aux: *mut drm_dp_aux, timeout_ms: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_edid_digital_input_dp(drm_edid: *const drm_edid) -> bool {
...
//
    ...
    {
    let mut link_edid_read: u8 = 0, auto_test_req = 0, test_resp = 0;
...
#[no_mangle]
unsafe extern "C" fn drm_dp_downstream_port_count(dpcd[DP_RECEIVER_CAP_SIZE]: u8) -> u8 {
    static u8 drm_dp_downstream_port_count(const u8 dpcd[DP_RECEIVER_CAP_SIZE])
    {
    let mut port_count: u8 = dpcd[DP_DOWN_STREAM_PORT_COUNT] & DP_PORT_COUNT_MASK;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_downstream_id(aux: *mut drm_dp_aux, id[6]: c_char) -> c_int {
...
//
    ...
    int len;
    uint8_t rev[2];
    let mut type: c_int = port_cap[0] & DP_DS_PORT_TYPE_MASK;
    let mut branch_device: bool = drm_dp_is_branch(dpcd);
...
//
    ...
    const u8 port_cap[4])
    {
    let mut subconnector: enum drm_mode_subconnector = DRM_MODE_SUBCONNECTOR_Unknown;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_read_sink_count(aux: *mut drm_dp_aux) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn drm_dp_i2c_functionality(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn drm_dp_i2c_msg_write_status_update(msg: *mut drm_dp_aux_msg) {
...
pub const AUX_STOP_LEN: c_int = 4;
pub const AUX_CMD_LEN: c_int = 4;
pub const AUX_ADDRESS_LEN: c_int = 20;
pub const AUX_REPLY_PAD_LEN: c_int = 4;
pub const AUX_LENGTH_LEN: c_int = 8;
//
// Calculate the duration of the AUX request/reply in usec. Gives the
// "best" case estimate, ie. successful while as short as possible.
//
#[no_mangle]
unsafe extern "C" fn drm_dp_aux_req_duration(msg: *const drm_dp_aux_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_dp_aux_reply_duration(msg: *const drm_dp_aux_msg) -> c_int {
...
pub const I2C_START_LEN: c_int = 1;
pub const I2C_STOP_LEN: c_int = 1;
...
//
    ...
    let mut i2c_time_us: c_int = drm_dp_i2c_msg_duration(msg, i2c_speed_khz);
...
//
    let mut __read_mostly: static int dp_aux_i2c_speed_khz = 10;
...
//
#[no_mangle]
unsafe extern "C" fn drm_dp_i2c_do_msg(aux: *mut drm_dp_aux, msg: *mut drm_dp_aux_msg) -> c_int {
...
//
    let mut max_retries: c_int = max(7, drm_dp_i2c_retry_count(msg, dp_aux_i2c_speed_khz));
...
//
#[no_mangle]
unsafe extern "C" fn drm_dp_i2c_drain_msg(aux: *mut drm_dp_aux, orig_msg: *mut drm_dp_aux_msg) -> c_int {
    static int drm_dp_i2c_drain_msg(struct drm_dp_aux *aux, struct drm_dp_aux_msg *orig_msg)
    {
    int err, ret = orig_msg.size;
    let mut msg: drm_dp_aux_msg = *orig_msg;
    while (msg.size > 0) {
    err = drm_dp_i2c_do_msg(aux, &msg);
    if (err <= 0)
    let mut err: return = = 0 ? -EPROTO : err;
...
//
    let mut __read_mostly: static int dp_aux_i2c_transfer_size = DP_AUX_MAX_PAYLOAD_BYTES;
...
#[no_mangle]
unsafe extern "C" fn lock_bus(i2c: *mut i2c_adapter, flags: c_uint) {
    static void lock_bus(struct i2c_adapter *i2c, unsigned int flags)
    {
    mutex_lock(&i2c_to_aux(i2c).hw_mutex);
    }
#[no_mangle]
unsafe extern "C" fn trylock_bus(i2c: *mut i2c_adapter, flags: c_uint) -> c_int {
    static int trylock_bus(struct i2c_adapter *i2c, unsigned int flags)
    {
    return mutex_trylock(&i2c_to_aux(i2c).hw_mutex);
    }
#[no_mangle]
unsafe extern "C" fn unlock_bus(i2c: *mut i2c_adapter, flags: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn drm_dp_aux_get_crc(aux: *mut drm_dp_aux, crc: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_dp_aux_crc_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_remote_aux_init(aux: *mut drm_dp_aux) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_aux_init(aux: *mut drm_dp_aux) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_aux_register(aux: *mut drm_dp_aux) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_aux_unregister(aux: *mut drm_dp_aux) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_psr_setup_time(psr_cap[EDP_PSR_RECEIVER_CAP_SIZE]: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_start_crc(aux: *mut drm_dp_aux, crtc: *mut drm_crtc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_stop_crc(aux: *mut drm_dp_aux) -> c_int {
    ...
    aux.crtc = core::ptr::null_mut();
    return 0;
    }
    EXPORT_SYMBOL(drm_dp_stop_crc);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dpcd_quirk {
    pub oui: [u8; 3],
    pub device_id: [u8; 6],
    pub is_branch: bool,
    pub quirks: u32,
...
//
    ...
    let mut offset: c_uint = is_branch ? DP_BRANCH_OUI : DP_SINK_OUI;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_dump_lttpr_desc(aux: *mut drm_dp_aux, dp_phy: enum drm_dp_phy) -> c_int {
    int drm_dp_dump_lttpr_desc(struct drm_dp_aux *aux, enum drm_dp_phy dp_phy)
    {
    let mut desc: drm_dp_desc = {};
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_dsc_sink_bpp_incr(dsc_dpcd[DP_DSC_RECEIVER_CAP_SIZE]: u8) -> u8 {
    u8 drm_dp_dsc_sink_bpp_incr(const u8 dsc_dpcd[DP_DSC_RECEIVER_CAP_SIZE])
    {
    let mut bpp_increment_dpcd: u8 = dsc_dpcd[DP_DSC_BITS_PER_PIXEL_INC - DP_DSC_SUPPORT];
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_dsc_slice_count_to_mask(slice_count: c_int) -> u32 {
...
//
    ...
    bool is_edp)
    {
    let mut slice_cap1: u8 = dsc_dpcd[DP_DSC_SLICE_CAP_1 - DP_DSC_SUPPORT];
    let mut mask: u32 = 0;
    if (!is_edp) {
// For DP, use values from DSC_SLICE_CAP_1 and DSC_SLICE_CAP2
    let mut slice_cap2: u8 = dsc_dpcd[DP_DSC_SLICE_CAP_2 - DP_DSC_SUPPORT];
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_dsc_sink_line_buf_depth(dsc_dpcd[DP_DSC_RECEIVER_CAP_SIZE]: u8) -> u8 {
    u8 drm_dp_dsc_sink_line_buf_depth(const u8 dsc_dpcd[DP_DSC_RECEIVER_CAP_SIZE])
    {
    let mut line_buf_depth: u8 = dsc_dpcd[DP_DSC_LINE_BUF_BIT_DEPTH - DP_DSC_SUPPORT];
...
//
    ...
    u8 dsc_bpc[3])
    {
    let mut num_bpc: c_int = 0;
    let mut color_depth: u8 = dsc_dpcd[DP_DSC_DEC_COLOR_DEPTH_CAP - DP_DSC_SUPPORT];
...
//
#[no_mangle]
unsafe extern "C" fn dsc_sink_min_slice_throughput(peak_pixel_rate: c_int) -> c_int {
    static int dsc_sink_min_slice_throughput(int peak_pixel_rate)
    {
    if (peak_pixel_rate >= 4800000)
    return 600000;
#[no_mangle]
pub unsafe extern "C" fn if(2700000: peak_pixel_rate >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn dsc_branch_dpcd_cap(dpcd[DP_DSC_BRANCH_CAP_SIZE]: u8, reg: c_int) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_dsc_branch_max_line_width(dsc_branch_dpcd[DP_DSC_BRANCH_CAP_SIZE]: u8) -> c_int {
    int drm_dp_dsc_branch_max_line_width(const u8 dsc_branch_dpcd[DP_DSC_BRANCH_CAP_SIZE])
    {
    let mut line_width: c_int = dsc_branch_dpcd_cap(dsc_branch_dpcd, DP_DSC_BRANCH_MAX_LINE_WIDTH);
    switch (line_width) {
    case 0:
    return 0;
    case 1 ... 15:
...
// size bigger than 1.
//
    let mut block_size: c_int = dpcd[DP_DPCD_REV] < 0x14 ? 1 : buf_size;
    int offset;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn dp_lttpr_common_cap(caps[DP_LTTPR_COMMON_CAP_SIZE]: u8, r: c_int) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_lttpr_count(caps[DP_LTTPR_COMMON_CAP_SIZE]: u8) -> c_int {
    int drm_dp_lttpr_count(const u8 caps[DP_LTTPR_COMMON_CAP_SIZE])
    {
    let mut count: u8 = dp_lttpr_common_cap(caps, DP_PHY_REPEATER_CNT);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_lttpr_max_link_rate(caps[DP_LTTPR_COMMON_CAP_SIZE]: u8) -> c_int {
    int drm_dp_lttpr_max_link_rate(const u8 caps[DP_LTTPR_COMMON_CAP_SIZE])
    {
    let mut rate: u8 = dp_lttpr_common_cap(caps, DP_MAX_LINK_RATE_PHY_REPEATER);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_lttpr_set_transparent_mode(aux: *mut drm_dp_aux, enable: bool) -> c_int {
    int drm_dp_lttpr_set_transparent_mode(struct drm_dp_aux *aux, bool enable)
    {
    u8 val = enable ? DP_PHY_REPEATER_MODE_TRANSPARENT :
    DP_PHY_REPEATER_MODE_NON_TRANSPARENT;
    let mut ret: c_int = drm_dp_dpcd_writeb(aux, DP_PHY_REPEATER_MODE, val);
    if (ret < 0)
    return ret;
    return (ret == 1) ? 0 : -EIO;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_lttpr_init(aux: *mut drm_dp_aux, lttpr_count: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_lttpr_max_lane_count(caps[DP_LTTPR_COMMON_CAP_SIZE]: u8) -> c_int {
    int drm_dp_lttpr_max_lane_count(const u8 caps[DP_LTTPR_COMMON_CAP_SIZE])
    {
    let mut max_lanes: u8 = dp_lttpr_common_cap(caps, DP_MAX_LANE_COUNT_PHY_REPEATER);
...
//
    ...
    {
    let mut txcap: u8 = dp_lttpr_phy_cap(caps, DP_TRANSMITTER_CAPABILITY_PHY_REPEATER1);
...
#[no_mangle]
pub unsafe extern "C" fn drm_dp_vsc_sdp_log(p: *mut drm_printer, vsc: *const drm_dp_vsc_sdp) {
...
#[no_mangle]
pub unsafe extern "C" fn drm_dp_as_sdp_log(p: *mut drm_printer, as_sdp: *const drm_dp_as_sdp) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_as_sdp_supported(aux: *mut drm_dp_aux, dpcd[DP_RECEIVER_CAP_SIZE]: u8) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_vsc_sdp_supported(aux: *mut drm_dp_aux, dpcd[DP_RECEIVER_CAP_SIZE]: u8) -> bool {
...
//
    ...
    struct dp_sdp *sdp)
    {
    let mut length: usize = sizeof(struct dp_sdp);
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_frl_prepare(aux: *mut drm_dp_aux, enable_frl_ready_hpd: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_is_frl_ready(aux: *mut drm_dp_aux) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_reset_frl_config(aux: *mut drm_dp_aux) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_frl_enable(aux: *mut drm_dp_aux) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_hdmi_link_active(aux: *mut drm_dp_aux) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_hdmi_link_mode(aux: *mut drm_dp_aux, frl_trained_mask: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_enc_is_dsc_1_2(pcon_dsc_dpcd[DP_PCON_DSC_ENCODER_CAP_SIZE]: u8) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_dsc_max_slices(pcon_dsc_dpcd[DP_PCON_DSC_ENCODER_CAP_SIZE]: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_dsc_max_slice_width(pcon_dsc_dpcd[DP_PCON_DSC_ENCODER_CAP_SIZE]: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_dsc_bpp_incr(pcon_dsc_dpcd[DP_PCON_DSC_ENCODER_CAP_SIZE]: u8) -> c_int {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_configure_dsc_enc(aux: *mut drm_dp_aux, pps_buf_config: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_pps_default(aux: *mut drm_dp_aux) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_pps_override_buf(aux: *mut drm_dp_aux, pps_buf[128]: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_pps_override_param(aux: *mut drm_dp_aux, pps_param[6]: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_pcon_convert_rgb_to_ycbcr(aux: *mut drm_dp_aux, color_spc: u8) -> c_int {
...
//
    ...
    {
    int ret;
    let mut offset: c_uint = DP_EDP_BACKLIGHT_BRIGHTNESS_MSB;
    u8 buf[3] = { 0 };
    let mut len: usize = 2;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_edp_backlight_disable(aux: *mut drm_dp_aux, bl: *const drm_edp_backlight_info) -> c_int {
...
// current_mode = (mode_reg & DP_EDP_BACKLIGHT_CONTROL_MODE_MASK);
    ...
    let mut size: c_int = 1 + bl.lsb_reg_used;
    if (bl.luminance_set) {
...
#[no_mangle]
unsafe extern "C" fn dp_aux_backlight_update_status(bd: *mut backlight_device) -> c_int {
    static int dp_aux_backlight_update_status(struct backlight_device *bd)
    {
    struct dp_aux_backlight *bl = bl_get_data(bd);
    let mut brightness: u16 = backlight_get_brightness(bd);
    let mut ret: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_panel_dp_aux_backlight(panel: *mut drm_panel, aux: *mut drm_dp_aux) -> c_int {
...
// See DP Standard v2.1 2.6.4.4.1.1, 2.8.4.4, 2.8.7
    ...
    bool is_mst)
    {
    let mut cycles: c_int = DIV_ROUND_UP(pixels * bpp_x16, 16 * symbol_size * lane_count);
    let mut align: c_int = is_mst ? 4 / lane_count : 1;
...
//
    ...
    {
    let mut slice_count: c_int = dsc_slice_count ? : 1;
    let mut slice_pixels: c_int = DIV_ROUND_UP(pixels, slice_count);
    int slice_data_cycles = drm_dp_link_data_symbol_cycles(lane_count,
    slice_pixels,
    bpp_x16,
    symbol_size,
    is_mst);
    let mut slice_eoc_cycles: c_int = 0;
    if (dsc_slice_count)
...
//
    ...
    {
    let mut symbol_size: c_int = flags & DRM_DP_BW_OVERHEAD_UHBR ? 32 : 8;
    let mut is_mst: bool = flags & DRM_DP_BW_OVERHEAD_MST;
    let mut overhead: u32 = 1000000;
    int symbol_cycles;
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_bw_channel_coding_efficiency(is_uhbr: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_dp_max_dprx_data_rate(max_link_rate: c_int, max_lanes: c_int) -> c_int {
