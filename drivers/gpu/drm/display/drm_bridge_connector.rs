...
//! Source: drivers/gpu/drm/display/drm_bridge_connector.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drm_bridge_connector {
//
...
//
    pub bridge_edid: *mut drm_bridge,
//
// @bridge_hpd:
//
// The last bridge in the chain (closest to the connector) that provides
...
//
    pub bridge_detect: *mut drm_bridge,
//
// @bridge_modes:
//
// The last bridge in the chain (closest to the connector) that provides
...
//
    pub bridge_modes: *mut drm_bridge,
//
// @bridge_hdmi:
//
...
//
    pub bridge_hdmi: *mut drm_bridge,
//
// @bridge_hdmi_audio:
//
// The bridge in the chain that implements necessary support for the
...
//
    pub bridge_hdmi_audio: *mut drm_bridge,
//
// @bridge_dp_audio:
//
// The bridge in the chain that implements necessary support for the
...
//
    pub bridge_dp_audio: *mut drm_bridge,
//
// @bridge_hdmi_cec:
//
...
//
    pub bridge_hdmi_cec: *mut drm_bridge,
//
// @hdmi_funcs:
//
...
// bridge connector.
//
    pub hdmi_funcs: drm_connector_hdmi_funcs,
}
...
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_enable_hpd(connector: *mut drm_connector) {
...
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_disable_hpd(connector: *mut drm_connector) {
...
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_force(connector: *mut drm_connector) {
...
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_get_modes(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_clear_avi_infoframe(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_clear_hdmi_infoframe(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_clear_audio_infoframe(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_clear_hdr_drm_infoframe(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_clear_spd_infoframe(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_audio_startup(connector: *mut drm_connector) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_audio_shutdown(connector: *mut drm_connector) {
...
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_hdmi_cec_enable(connector: *mut drm_connector, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_hdmi_cec_log_addr(connector: *mut drm_connector, logical_addr: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_hdmi_cec_init(connector: *mut drm_connector) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn drm_bridge_connector_put_bridges(dev: *mut drm_device, data: *mut c_void) {
...
//
    ...
    struct drm_bridge *panel_bridge __free(drm_bridge_put) = core::ptr::null_mut();
    let mut supported_formats: c_uint = BIT(DRM_OUTPUT_COLOR_FORMAT_RGB444);
    let mut max_bpc: c_uint = 8;
    let mut support_hdcp: bool = false;
    int connector_type;
    int ret;
...
//
    ...
    drm_bridge_put(bridge_connector.bridge_edid);
    bridge_connector.bridge_edid = core::ptr::null_mut();
    drm_bridge_put(bridge_connector.bridge_modes);
    bridge_connector.bridge_modes = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: bridge_connector->bridge_detect) -> else {
