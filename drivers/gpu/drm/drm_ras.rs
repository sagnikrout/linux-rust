...
//! Source: drivers/gpu/drm/drm_ras.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_ras_node_register(node: *mut drm_ras_node) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drm_ras_node_unregister(node: *mut drm_ras_node) {
