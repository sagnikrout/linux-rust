...
//! Source: drivers/gpu/drm/ttm/tests/ttm_resource_test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ttm_resource_test_case {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ttm_resource_test_priv {
    pub devs: *mut ttm_test_devices,
    pub bo: *mut ttm_buffer_object,
    pub place: *mut ttm_place,
}

    let mut ttm_resource_manager_mock_funcs: static struct ttm_resource_manager_func = { };
#[no_mangle]
unsafe extern "C" fn ttm_resource_test_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ttm_resource_test_fini(test: *mut kunit) {
    ...
    {
    let mut size: usize = RES_SIZE;
// Make sure we have what we need for a good BO mock
    KUNIT_ASSERT_NOT_NULL(test, priv.devs.ttm_dev);
    priv.bo = ttm_bo_kunit_init(test, priv.devs, size, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ttm_resource_case_desc(t: *const ttm_resource_test_case, desc: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn ttm_resource_init_basic(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ttm_resource_init_pinned(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ttm_resource_fini_basic(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ttm_resource_manager_init_basic(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ttm_resource_manager_usage_basic(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ttm_resource_manager_set_used_basic(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ttm_sys_man_alloc_basic(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ttm_sys_man_free_basic(test: *mut kunit) {
    ...
    res = kunit_kzalloc(test, sizeof(*res), GFP_KERNEL);
    KUNIT_ASSERT_NOT_NULL(test, res);
    ttm_resource_alloc(bo, place, &res, core::ptr::null_mut());
    man = ttm_manager_type(priv.devs.ttm_dev, mem_type);
