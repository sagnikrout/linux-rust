...
//! Source: drivers/gpu/drm/ttm/tests/ttm_bo_validate_test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ttm_bo_validate_test_case {
    pub description: *const c_char,
    pub bo_type: enum ttm_bo_type,
    pub mem_type: u32,
    pub with_ttm: bool,
    pub no_gpu_wait: bool,
}
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_init_reserved_sys_man(test: *mut kunit) {
    static void ttm_bo_init_reserved_sys_man(struct kunit *test)
    {
    const struct ttm_bo_validate_test_case *params = test.param_value;
    struct ttm_test_devices *priv = test.priv;
    let mut bo_type: enum ttm_bo_type = params.bo_type;
    let mut size: u32 = ALIGN(BO_SIZE, PAGE_SIZE);
    ...
    PAGE_SIZE, &ctx, core::ptr::null_mut(), core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_init_reserved_mock_man(test: *mut kunit) {
    ...
    let mut ctx: ttm_operation_ctx = { };
    struct ttm_placement *placement;
    let mut mem_type: u32 = TTM_PL_VRAM;
    struct ttm_buffer_object *bo;
    struct ttm_place *place;
    int err;
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_init_reserved_resv(test: *mut kunit) {
    ...
    dma_resv_lock(&resv, core::ptr::null_mut());
    err = ttm_bo_init_reserved(priv.ttm_dev, bo, bo_type, placement,
    PAGE_SIZE, &ctx, core::ptr::null_mut(), &resv,
    &dummy_ttm_bo_destroy);
    dma_resv_unlock(bo.base.resv);
    KUNIT_EXPECT_EQ(test, err, 0);
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_basic(test: *mut kunit) {
    static void ttm_bo_validate_basic(struct kunit *test)
    {
    const struct ttm_bo_validate_test_case *params = test.param_value;
    let mut fst_mem: u32 = TTM_PL_SYSTEM, snd_mem = TTM_PL_VRAM;
    let mut ctx_init: ttm_operation_ctx = { }, ctx_val = { };
    struct ttm_placement *fst_placement, *snd_placement;
    struct ttm_test_devices *priv = test.priv;
    struct ttm_place *fst_place, *snd_place;
    let mut size: u32 = ALIGN(SZ_8K, PAGE_SIZE);
    struct ttm_buffer_object *bo;
    int err;
    ...
    fst_placement, PAGE_SIZE, &ctx_init, core::ptr::null_mut(),
    core::ptr::null_mut(), &dummy_ttm_bo_destroy);
    KUNIT_EXPECT_EQ(test, err, 0);
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_invalid_placement(test: *mut kunit) {
    static void ttm_bo_validate_invalid_placement(struct kunit *test)
    {
    let mut bo_type: enum ttm_bo_type = ttm_bo_type_device;
    let mut unknown_mem_type: u32 = TTM_PL_PRIV + 1;
    let mut size: u32 = ALIGN(BO_SIZE, PAGE_SIZE);
    let mut ctx: ttm_operation_ctx = { };
    struct ttm_placement *placement;
    struct ttm_buffer_object *bo;
    ...
    bo.type = bo_type;
    ttm_bo_reserve(bo, false, false, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_failed_alloc(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_pinned(test: *mut kunit) {
    ...
    ttm_bo_validate_case_desc);
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_same_placement(test: *mut kunit) {
    ...
    drm_gem_private_object_init(priv.drm, &bo.base, size);
    err = ttm_bo_init_reserved(priv.ttm_dev, bo, params.bo_type,
    placement, PAGE_SIZE, &ctx_init, core::ptr::null_mut(),
    core::ptr::null_mut(), &dummy_ttm_bo_destroy);
    KUNIT_EXPECT_EQ(test, err, 0);
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_busy_placement(test: *mut kunit) {
    static void ttm_bo_validate_busy_placement(struct kunit *test)
    {
    let mut fst_mem: u32 = TTM_PL_VRAM, snd_mem = TTM_PL_VRAM + 1;
    let mut ctx_init: ttm_operation_ctx = { }, ctx_val = { };
    ...
    PAGE_SIZE, &ctx_init, core::ptr::null_mut(), core::ptr::null_mut(),
    &dummy_ttm_bo_destroy);
    KUNIT_EXPECT_EQ(test, err, 0);
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_multihop(test: *mut kunit) {
    static void ttm_bo_validate_multihop(struct kunit *test)
    {
    const struct ttm_bo_validate_test_case *params = test.param_value;
    let mut ctx_init: ttm_operation_ctx = { }, ctx_val = { };
    struct ttm_placement *placement_init, *placement_val;
    let mut fst_mem: u32 = TTM_PL_VRAM, tmp_mem = TTM_PL_TT, final_mem = TTM_PL_SYSTEM;
    struct ttm_test_devices *priv = test.priv;
    ...
    drm_gem_private_object_init(priv.drm, &bo.base, size);
    err = ttm_bo_init_reserved(priv.ttm_dev, bo, params.bo_type,
    placement_init, PAGE_SIZE, &ctx_init, core::ptr::null_mut(),
    core::ptr::null_mut(), &dummy_ttm_bo_destroy);
    KUNIT_EXPECT_EQ(test, err, 0);
    ...
    ttm_bo_validate_case_desc);
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_no_placement_signaled(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_NULL(test, placement);
    ttm_bo_reserve(bo, false, false, core::ptr::null_mut());
    err = ttm_resource_alloc(bo, place, &bo.resource, core::ptr::null_mut());
    KUNIT_EXPECT_EQ(test, err, 0);
...
#[no_mangle]
unsafe extern "C" fn threaded_dma_resv_signal(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_no_placement_not_signaled(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_move_fence_signaled(test: *mut kunit) {
    ...
    ttm_bo_validate_case_desc);
#[no_mangle]
unsafe extern "C" fn threaded_fence_signal(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_move_fence_not_signaled(test: *mut kunit) {
    ...
    man.eviction_fences[0] = core::ptr::null_mut();
    KUNIT_EXPECT_EQ(test, err, 0);
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_swapout(test: *mut kunit) {
    static void ttm_bo_validate_swapout(struct kunit *test)
    {
    let mut mem_type: u32 = TTM_PL_TT;
    struct ttm_test_devices *priv = test.priv;
    let mut ctx_init: ttm_operation_ctx = { };
    let mut bo_type: enum ttm_bo_type = ttm_bo_type_device;
    struct ttm_resource_manager *man;
    struct ttm_placement *placement;
    struct ttm_buffer_object *bo;
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_happy_evict(test: *mut kunit) {
    ...
    bo_val = ttm_bo_kunit_init(test, test.priv, BO_SIZE, core::ptr::null_mut());
    bo_val.type = bo_type;
    ttm_bo_reserve(bo_val, false, false, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_all_pinned_evict(test: *mut kunit) {
    ...
    struct ttm_test_devices *priv = test.priv;
    struct ttm_placement *placement;
    let mut mem_type: u32 = TTM_PL_VRAM, mem_multihop = TTM_PL_TT;
    struct ttm_place *place;
    int err;
    ttm_mock_manager_init(priv.ttm_dev, mem_type, MANAGER_SIZE);
    ttm_mock_manager_init(priv.ttm_dev, mem_multihop, MANAGER_SIZE);
    ...
    bo_small = ttm_bo_kunit_init(test, test.priv, BO_SIZE, core::ptr::null_mut());
    bo_small.type = bo_type;
    ttm_bo_reserve(bo_small, false, false, core::ptr::null_mut());
    err = ttm_bo_validate(bo_small, placement, &ctx_val);
    ttm_bo_unreserve(bo_small);
    KUNIT_EXPECT_EQ(test, err, -ENOMEM);
    ttm_bo_fini(bo_small);
    ttm_bo_reserve(bo_big, false, false, core::ptr::null_mut());
    ttm_bo_unpin(bo_big);
    dma_resv_unlock(bo_big.base.resv);
    ttm_bo_fini(bo_big);
    ttm_mock_manager_fini(priv.ttm_dev, mem_type);
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_allowed_only_evict(test: *mut kunit) {
    ...
    ttm_bo_reserve(bo_pinned, false, false, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_deleted_evict(test: *mut kunit) {
    static void ttm_bo_validate_deleted_evict(struct kunit *test)
    {
    let mut ctx_init: ttm_operation_ctx = { }, ctx_val  = { };
    let mut small: u32 = SZ_8K, big = MANAGER_SIZE - BO_SIZE;
    let mut bo_type: enum ttm_bo_type = ttm_bo_type_device;
    struct ttm_buffer_object *bo_big, *bo_small;
    struct ttm_test_devices *priv = test.priv;
    struct ttm_resource_manager *man;
    ...
    dma_resv_unlock(bo_big.base.resv);
    bo_big.deleted = true;
    bo_small = ttm_bo_kunit_init(test, test.priv, small, core::ptr::null_mut());
    bo_small.type = bo_type;
    ttm_bo_reserve(bo_small, false, false, core::ptr::null_mut());
    err = ttm_bo_validate(bo_small, placement, &ctx_val);
    ttm_bo_unreserve(bo_small);
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_busy_domain_evict(test: *mut kunit) {
    static void ttm_bo_validate_busy_domain_evict(struct kunit *test)
    {
    let mut mem_type: u32 = TTM_PL_VRAM, mem_type_evict = TTM_PL_MOCK1;
    let mut ctx_init: ttm_operation_ctx = { }, ctx_val  = { };
    let mut bo_type: enum ttm_bo_type = ttm_bo_type_device;
    struct ttm_test_devices *priv = test.priv;
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_evict_gutting(test: *mut kunit) {
    ...
    let mut mem_type: u32 = TTM_PL_MOCK1;
    struct ttm_placement *placement;
    struct ttm_place *place;
    int err;
    ttm_mock_manager_init(priv.ttm_dev, mem_type, MANAGER_SIZE);
...
#[no_mangle]
unsafe extern "C" fn ttm_bo_validate_recrusive_evict(test: *mut kunit) {
    static void ttm_bo_validate_recrusive_evict(struct kunit *test)
    {
    let mut mem_type: u32 = TTM_PL_TT, mem_type_evict = TTM_PL_MOCK2;
    let mut ctx_init: ttm_operation_ctx = { }, ctx_val  = { };
