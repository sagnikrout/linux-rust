...
pub struct ntb_msi {
    pub base_addr: u64,
    pub end_addr: u64,
    pub ctx): *mut *mut void (desc_changed)(void,
    pub peer_mws: [*mut u32 __iomem; ],
}
...
//
#[no_mangle]
pub unsafe extern "C" fn ntb_msi_setup_mws(ntb: *mut ntb_dev) -> c_int {
    ...
    let mut mw_size: resource_size_t = SZ_32K;
    let mut mw_min_size: resource_size_t = mw_size;
    int i;
    int ret;
    if (!ntb.msi)
    return -EINVAL;
    ...
    ret = ntb_mw_get_align(ntb, peer, peer_widx, core::ptr::null_mut(),
    &size_align, &size_max);
    if (ret)
    goto error_out;
...
//
#[no_mangle]
pub unsafe extern "C" fn ntb_msi_clear_mws(ntb: *mut ntb_dev) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ntb_msi_devres {
    pub ntb: *mut ntb_dev,
    pub entry: *mut msi_desc,
...
#[no_mangle]
unsafe extern "C" fn ntb_msi_write_msg(entry: *mut msi_desc, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ntbm_msi_callback_release(dev: *mut device, res: *mut c_void) {
    static void ntbm_msi_callback_release(struct device *dev, void *res)
    {
    struct ntb_msi_devres *dr = res;
    dr.entry.write_msi_msg = core::ptr::null_mut();
    dr.entry.write_msi_msg_data = core::ptr::null_mut();
    }
