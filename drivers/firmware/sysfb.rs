...
//! Source: drivers/firmware/sysfb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sysfb_unregister() -> bool {
...
#[no_mangle]
unsafe extern "C" fn sysfb_pci_dev_is_enabled(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sysfb_init() -> __init int {
