...
//! Source: drivers/firmware/tegra/bpmp-tegra186.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra186_bpmp {
    pub parent: *mut tegra_bpmp,
    struct {
...
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_is_message_ready(channel: *mut tegra_bpmp_channel) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_is_channel_free(channel: *mut tegra_bpmp_channel) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_ack_message(channel: *mut tegra_bpmp_channel) -> c_int {
    static int tegra186_bpmp_ack_message(struct tegra_bpmp_channel *channel)
    {
    return tegra_ivc_read_advance(channel.ivc);
    }
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_post_message(channel: *mut tegra_bpmp_channel) -> c_int {
    static int tegra186_bpmp_post_message(struct tegra_bpmp_channel *channel)
    {
    return tegra_ivc_write_advance(channel.ivc);
    }
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_ring_doorbell(bpmp: *mut tegra_bpmp) -> c_int {
    static int tegra186_bpmp_ring_doorbell(struct tegra_bpmp *bpmp)
    {
    struct tegra186_bpmp *priv = bpmp.priv;
    int err;
    err = mbox_send_message(priv.mbox.channel, core::ptr::null_mut());
    if (err < 0)
    return err;
...
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_ivc_notify(ivc: *mut tegra_ivc, data: *mut c_void) {
    static void tegra186_bpmp_ivc_notify(struct tegra_ivc *ivc, void *data)
    {
    struct tegra_bpmp *bpmp = data;
    struct tegra186_bpmp *priv = bpmp.priv;
    if (WARN_ON(priv.mbox.channel == core::ptr::null_mut()))
    return;
    ...
    err = tegra_ivc_init(channel.ivc, core::ptr::null_mut(), &rx, priv.rx.phys + offset, &tx,
...
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_channel_reset(channel: *mut tegra_bpmp_channel) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_channel_cleanup(channel: *mut tegra_bpmp_channel) {
    static void tegra186_bpmp_channel_cleanup(struct tegra_bpmp_channel *channel)
    {
    tegra_ivc_cleanup(channel.ivc);
    }
#[no_mangle]
unsafe extern "C" fn mbox_handle_rx(client: *mut mbox_client, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_teardown_channels(bpmp: *mut tegra_bpmp) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_dram_init(bpmp: *mut tegra_bpmp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_sram_init(bpmp: *mut tegra_bpmp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_setup_channels(bpmp: *mut tegra_bpmp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_reset_channels(bpmp: *mut tegra_bpmp) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_init(bpmp: *mut tegra_bpmp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_deinit(bpmp: *mut tegra_bpmp) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_bpmp_resume(bpmp: *mut tegra_bpmp) -> c_int {
