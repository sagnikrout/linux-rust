...
//! Source: drivers/firmware/tegra/bpmp.c
#![no_std]
...
pub const TAG_SZ: c_int = 32;
    ...
    int err;
    err = __of_parse_phandle_with_args(dev.of_node, "nvidia,bpmp", core::ptr::null_mut(),
    1, 0, &args);
    if (err < 0)
    return ERR_PTR(err);
...
#[no_mangle]
pub unsafe extern "C" fn tegra_bpmp_put(bpmp: *mut tegra_bpmp) {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_message_valid(msg: *const tegra_bpmp_message) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_is_response_ready(channel: *mut tegra_bpmp_channel) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_is_request_ready(channel: *mut tegra_bpmp_channel) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_wait_response(channel: *mut tegra_bpmp_channel) -> c_int {
    static int tegra_bpmp_wait_response(struct tegra_bpmp_channel *channel)
    {
    let mut timeout: c_ulong = channel.bpmp.soc.channels.cpu_tx.timeout;
    ktime_t end;
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_ack_response(channel: *mut tegra_bpmp_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_ack_request(channel: *mut tegra_bpmp_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_post_request(channel: *mut tegra_bpmp_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_post_response(channel: *mut tegra_bpmp_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_ring_doorbell(bpmp: *mut tegra_bpmp) -> c_int {
...
// ret = tegra_bpmp_mb_read_field(&channel->ib, code);
    ...
    const void *data, size_t size)
    {
    let mut timeout: c_ulong = bpmp.soc.channels.thread.timeout;
    let mut count: c_uint = bpmp.soc.channels.thread.count;
...
// Reset BPMP IPC channels during resume based on flags passed
    ...
    const void *data, size_t size)
    {
    let mut flags: c_ulong = tegra_bpmp_mb_read_field(&channel.ib, flags);
    struct tegra_bpmp *bpmp = channel.bpmp;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn tegra_bpmp_free_mrq(bpmp: *mut tegra_bpmp, mrq: c_uint, data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_bpmp_mrq_is_supported(bpmp: *mut tegra_bpmp, mrq: c_uint) -> bool {
    bool tegra_bpmp_mrq_is_supported(struct tegra_bpmp *bpmp, unsigned int mrq)
    {
    let mut req: mrq_query_abi_request = { .mrq = mrq };
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_ping(bpmp: *mut tegra_bpmp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_channel_signal(channel: *mut tegra_bpmp_channel) {
    static void tegra_bpmp_channel_signal(struct tegra_bpmp_channel *channel)
    {
    let mut flags: c_ulong = tegra_bpmp_mb_read_field(&channel.ob, flags);
    if ((flags & MSG_RING) == 0)
    return;
    complete(&channel.completion);
    }
#[no_mangle]
pub unsafe extern "C" fn tegra_bpmp_handle_rx(bpmp: *mut tegra_bpmp) {
    ...
    let mut mrq: c_uint = tegra_bpmp_mb_read_field(&channel.ib, code);
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_probe(pdev: *mut platform_device) -> c_int {
    ...
    err = of_platform_default_populate(pdev.dev.of_node, core::ptr::null_mut(), &pdev.dev);
    if (err < 0)
    goto free_mrq;
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_resume(dev: *mut device) -> int __maybe_unused {
    static int __maybe_unused tegra_bpmp_resume(struct device *dev)
    {
    struct tegra_bpmp *bpmp = dev_get_drvdata(dev);
