...
//! Source: drivers/firmware/tegra/ivc.c
#![no_std]
...
pub const TEGRA_IVC_ALIGN: c_int = 64;
//
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_invalidate(ivc: *mut tegra_ivc, phys: dma_addr_t) {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_flush(ivc: *mut tegra_ivc, phys: dma_addr_t) {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_empty(ivc: *mut tegra_ivc, map: *mut iosys_map) -> bool {
...
//
    let mut tx: u32 = tegra_ivc_header_read_field(map, tx.count);
    let mut rx: u32 = tegra_ivc_header_read_field(map, rx.count);
//
...
//
    ...
    return true;
    let mut tx: return = = rx;
    }
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_full(ivc: *mut tegra_ivc, map: *mut iosys_map) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_available(ivc: *mut tegra_ivc, map: *mut iosys_map) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_advance_tx(ivc: *mut tegra_ivc) {
    static inline void tegra_ivc_advance_tx(struct tegra_ivc *ivc)
    {
    let mut count: c_uint = tegra_ivc_header_read_field(&ivc.tx.map, tx.count);
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_advance_rx(ivc: *mut tegra_ivc) {
    static inline void tegra_ivc_advance_rx(struct tegra_ivc *ivc)
    {
    let mut count: c_uint = tegra_ivc_header_read_field(&ivc.rx.map, rx.count);
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_check_read(ivc: *mut tegra_ivc) -> c_int {
    static inline int tegra_ivc_check_read(struct tegra_ivc *ivc)
    {
    let mut offset: c_uint = offsetof(struct tegra_ivc_header, tx.count);
    unsigned int state;
//
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_check_write(ivc: *mut tegra_ivc) -> c_int {
    static inline int tegra_ivc_check_write(struct tegra_ivc *ivc)
    {
    let mut offset: c_uint = offsetof(struct tegra_ivc_header, rx.count);
    unsigned int state;
    state = tegra_ivc_header_read_field(&ivc.tx.map, tx.state);
    if (state != TEGRA_IVC_STATE_ESTABLISHED)
    return -ECONNRESET;
    ...
    {
    let mut offset: usize = sizeof(struct tegra_ivc_header) + ivc.frame_size * frame;
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_read_get_next_frame(ivc: *mut tegra_ivc, map: *mut iosys_map) -> c_int {
    int tegra_ivc_read_get_next_frame(struct tegra_ivc *ivc, struct iosys_map *map)
    {
    int err;
    if (WARN_ON(ivc == core::ptr::null_mut()))
    return -EINVAL;
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_read_advance(ivc: *mut tegra_ivc) -> c_int {
    int tegra_ivc_read_advance(struct tegra_ivc *ivc)
    {
    let mut rx: c_uint = offsetof(struct tegra_ivc_header, rx.count);
    let mut tx: c_uint = offsetof(struct tegra_ivc_header, tx.count);
    int err;
//
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_write_get_next_frame(ivc: *mut tegra_ivc, map: *mut iosys_map) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_write_advance(ivc: *mut tegra_ivc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_reset(ivc: *mut tegra_ivc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_notified(ivc: *mut tegra_ivc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_align(size: usize) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_total_queue_size(queue_size: unsigned) -> unsigned {
...
#[no_mangle]
pub unsafe extern "C" fn iosys_map_copy(dst: *mut iosys_map, src: *const iosys_map) {
    static inline void iosys_map_copy(struct iosys_map *dst, const struct iosys_map *src)
    {
// dst = *src;
    }
#[no_mangle]
pub unsafe extern "C" fn iosys_map_get_address(map: *const iosys_map) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ivc_cleanup(ivc: *mut tegra_ivc) {
