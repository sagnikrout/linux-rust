...
//! Source: drivers/firmware/qcom/qcom_pas_tee.c
#![no_std]
...
//
pub const TA_QCOM_PAS_IS_SUPPORTED: c_int = 1;
//
// PAS capabilities.
//
// [in]  params[0].value.a:	Unique 32bit remote processor identifier
...
//
pub const TA_QCOM_PAS_CAPABILITIES: c_int = 2;
//
...
//
pub const TA_QCOM_PAS_INIT_IMAGE: c_int = 3;
//
// PAS memory setup.
//
// [in]  params[0].value.a:	Unique 32bit remote processor identifier
...
//
pub const TA_QCOM_PAS_MEM_SETUP: c_int = 4;
//
...
//
pub const TA_QCOM_PAS_GET_RESOURCE_TABLE: c_int = 5;
//
...
//
pub const TA_QCOM_PAS_AUTH_AND_RESET: c_int = 6;
//
...
//
pub const TA_QCOM_PAS_SET_REMOTE_STATE: c_int = 7;
//
// PAS co-processor shutdown.
//
// [in]  params[0].value.a:	Unique 32bit remote processor identifier
//
pub const TA_QCOM_PAS_SHUTDOWN: c_int = 8;
pub const TEE_NUM_PARAMS: c_int = 4;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_pas_tee_private {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn qcom_pas_tee_supported(dev: *mut device, pas_id: u32) -> bool {
    ...
    u8 *mdata_buf = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn qcom_pas_tee_auth_and_reset(dev: *mut device, pas_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_pas_tee_shutdown(dev: *mut device, pas_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_pas_tee_probe(pas_dev: *mut tee_client_device) -> c_int {
    ...
    if (!data)
    return -ENOMEM;
    data.ctx = tee_client_open_context(core::ptr::null_mut(), optee_ctx_match, core::ptr::null_mut(), core::ptr::null_mut());
    if (IS_ERR(data.ctx))
    return -ENODEV;
    export_uuid(sess_arg.uuid, &pas_dev.id.uuid);
    ret = tee_client_open_session(data.ctx, &sess_arg, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn qcom_pas_tee_remove(pas_dev: *mut tee_client_device) {
