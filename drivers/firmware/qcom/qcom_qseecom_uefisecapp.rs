...
//! Source: drivers/firmware/qcom/qcom_qseecom_uefisecapp.c
#![no_std]
...
pub const QSEE_MAX_NAME_LEN: c_int = 1024;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qsee_req_uefi_get_variable {
    pub command_id: u32,
    pub length: u32,
    pub name_offset: u32,
    pub name_size: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qsee_rsp_uefi_get_variable {
    pub command_id: u32,
    pub length: u32,
    pub status: u32,
    pub attributes: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qsee_req_uefi_set_variable {
    pub command_id: u32,
    pub length: u32,
    pub name_offset: u32,
    pub name_size: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qsee_rsp_uefi_set_variable {
    pub command_id: u32,
    pub length: u32,
    pub status: u32,
    pub _unknown1: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qsee_req_uefi_get_next_variable {
    pub command_id: u32,
    pub length: u32,
    pub guid_offset: u32,
    pub guid_size: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qsee_rsp_uefi_get_next_variable {
    pub command_id: u32,
    pub length: u32,
    pub status: u32,
    pub guid_offset: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qsee_req_uefi_query_variable_info {
    pub command_id: u32,
    pub length: u32,
    pub attributes: u32,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qsee_rsp_uefi_query_variable_info {
    pub command_id: u32,
    pub length: u32,
    pub status: u32,
    pub _pad: u32,
...
//
    ...
    ({									\
    pub \: *mut *mut size_t __offset = (offset);,
    pub \: size_t __aligned;,
    \
    pub \: __aligned = ALIGN(__len, align);,
    pub \: __len = __aligned + (size);,
    \
    if (__offset)							\
// __offset = __aligned;					\
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcuefi_client {
    pub client: *mut qseecom_client,
    pub efivars: efivars,
    pub mempool: *mut qcom_tzmem_pool,
}
...
#[no_mangle]
unsafe extern "C" fn qsee_uefi_status_to_efi(status: u32) -> efi_status_t {
    static efi_status_t qsee_uefi_status_to_efi(u32 status)
    {
    let mut category: u64 = status & 0xf0000000;
    let mut code: u64 = status & 0x0fffffff;
    ...
    void *cmd_buf __free(qcom_tzmem) = core::ptr::null_mut();
    let mut buffer_size: c_ulong = *data_size;
...
#[no_mangle]
unsafe extern "C" fn qcuefi_set_reference(qcuefi: *mut qcuefi_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcuefi_release() {
...
// -- Driver setup. ---------------------------------------------------------
    ...
    if (status)
    qcuefi_set_reference(core::ptr::null_mut());
    return status;
    }
#[no_mangle]
unsafe extern "C" fn qcom_uefisecapp_remove(aux_dev: *mut auxiliary_device) {
