...
//! Source: drivers/firmware/dmi-sysfs.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmi_sysfs_entry {
    pub dh: dmi_header,
    pub kobj: kobject,
    pub instance: c_int,
    pub position: c_int,
    pub list: list_head,
    pub child: *mut kobject,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmi_sysfs_attribute {
    pub attr: attribute,
    pub buf): *mut *mut *mut ssize_t (show)(struct dmi_sysfs_entry entry, char,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmi_sysfs_mapped_attribute {
    pub attr: attribute,
...
//
#[no_mangle]
unsafe extern "C" fn dmi_entry_free(kobj: *mut kobject) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct find_dmi_data {
    pub entry: *mut dmi_sysfs_entry,
    pub callback: dmi_callback,
    pub private: *mut c_void,
    pub instance_countdown: c_int,
    pub ret: isize,
}
...
//
#[no_mangle]
unsafe extern "C" fn dmi_entry_length(dh: *const dmi_header) -> usize {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmi_entry_attr_show_data {
    pub attr: *mut attribute,
    pub buf: *mut c_char,
}
...
pub const DMI_SEL_ACCESS_METHOD_IO8: c_uint = 0x00;
pub const DMI_SEL_ACCESS_METHOD_IO2x8: c_uint = 0x01;
pub const DMI_SEL_ACCESS_METHOD_IO16: c_uint = 0x02;
pub const DMI_SEL_ACCESS_METHOD_PHYS32: c_uint = 0x03;
pub const DMI_SEL_ACCESS_METHOD_GPNV: c_uint = 0x04;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmi_system_event_log {
    pub header: dmi_header,
    pub area_length: u16,
    pub header_start_offset: u16,
...
#[no_mangle]
pub unsafe extern "C" fn DMI_SYSFS_MAPPED_ATTR(_arg: sel, _arg: _field) -> static {
    ...
    {
    let mut wrote: isize = 0;
    let mut io_reader: sel_io_reader = sel_io_readers[sel.access_method];
...
#[no_mangle]
unsafe extern "C" fn dmi_system_event_log(entry: *mut dmi_sysfs_entry) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dmi_sysfs_entry_length(entry: *mut dmi_sysfs_entry, buf: *mut c_char) -> isize {
    static ssize_t dmi_sysfs_entry_length(struct dmi_sysfs_entry *entry, char *buf)
    {
    return sprintf(buf, "%d\n", entry.dh.length);
    }
#[no_mangle]
unsafe extern "C" fn dmi_sysfs_entry_handle(entry: *mut dmi_sysfs_entry, buf: *mut c_char) -> isize {
    static ssize_t dmi_sysfs_entry_handle(struct dmi_sysfs_entry *entry, char *buf)
    {
    return sprintf(buf, "%d\n", entry.dh.handle);
    }
#[no_mangle]
unsafe extern "C" fn dmi_sysfs_entry_type(entry: *mut dmi_sysfs_entry, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn dmi_sysfs_entry_release(kobj: *mut kobject) {
...
#[no_mangle]
unsafe extern "C" fn dmi_sysfs_init() -> int __init {
    ...
    dmi_kset = kset_create_and_add("entries", core::ptr::null_mut(), dmi_kobj);
    if (!dmi_kset) {
    error = -ENOMEM;
    goto err;
    }
...
// clean up everything.
#[no_mangle]
unsafe extern "C" fn dmi_sysfs_exit() -> void __exit {
