...
//! Source: drivers/firmware/qemu_fw_cfg.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_sel_endianness(key: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn fw_cfg_dma_enabled() -> bool {
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_wait_for_control(d: *mut fw_cfg_dma_access) {
    static void fw_cfg_wait_for_control(struct fw_cfg_dma_access *d)
    {
    for (;;) {
    let mut ctrl: u32 = be32_to_cpu(READ_ONCE(d.control));
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_dma_transfer(address: *mut c_void, length: u32, control: u32) -> isize {
    static ssize_t fw_cfg_dma_transfer(void *address, u32 length, u32 control)
    {
    phys_addr_t dma;
    struct fw_cfg_dma_access *d = core::ptr::null_mut();
    let mut ret: isize = length;
    d = kmalloc_obj(*d);
    if (!d) {
    ret = -ENOMEM;
    goto end;
...
// Should never get here
    ...
    fw_cfg_sel_endianness(key);
    ret = fw_cfg_dma_transfer(core::ptr::null_mut(), pos, FW_CFG_DMA_CTL_SKIP);
    if (ret < 0)
    goto end;
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_io_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_do_platform_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_write_vmcoreinfo(f: *const fw_cfg_file) -> isize {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fw_cfg_sysfs_attribute {
    pub attr: attribute,
    pub buf): *mut *mut *mut ssize_t (show)(struct fw_cfg_sysfs_entry entry, char,
}
...
#[no_mangle]
pub unsafe extern "C" fn fw_cfg_sysfs_cache_enlist(entry: *mut fw_cfg_sysfs_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn fw_cfg_sysfs_cache_delist(entry: *mut fw_cfg_sysfs_entry) {
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_sysfs_cache_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_sysfs_show_size(e: *mut fw_cfg_sysfs_entry, buf: *mut c_char) -> isize {
    static ssize_t fw_cfg_sysfs_show_size(struct fw_cfg_sysfs_entry *e, char *buf)
    {
    return sprintf(buf, "%u\n", e.size);
    }
#[no_mangle]
unsafe extern "C" fn fw_cfg_sysfs_show_key(e: *mut fw_cfg_sysfs_entry, buf: *mut c_char) -> isize {
    static ssize_t fw_cfg_sysfs_show_key(struct fw_cfg_sysfs_entry *e, char *buf)
    {
    return sprintf(buf, "%u\n", e.select);
    }
#[no_mangle]
unsafe extern "C" fn fw_cfg_sysfs_show_name(e: *mut fw_cfg_sysfs_entry, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_sysfs_release_entry(kobj: *mut kobject) {
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_kset_unregister_recursive(kset: *mut kset) {
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_register_file(f: *const fw_cfg_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_register_dir_entries() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fw_cfg_kobj_cleanup(kobj: *mut kobject) {
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_sysfs_probe(pdev: *mut platform_device) -> c_int {
...
// create by_key and by_name subdirs of /sys/firmware/qemu_fw_cfg/
    ...
    if (!fw_cfg_sel_ko)
    goto err_sel;
    fw_cfg_fname_kset = kset_create_and_add("by_name", core::ptr::null_mut(), fw_cfg_top_ko);
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_sysfs_remove(pdev: *mut platform_device) {
...
// use special scanf/printf modifier for phys_addr_t, resource_size_t
    ...
    ":%" __PHYS_ADDR_PREFIX "u"
#[no_mangle]
unsafe extern "C" fn fw_cfg_cmdline_set(arg: *const c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_cmdline_get(buf: *mut c_char, kp: *const kernel_param) -> c_int {
...
// Should never get here
    ...
    device_param_cb(ioport, &fw_cfg_cmdline_param_ops, core::ptr::null_mut(), S_IRUSR);
    device_param_cb(mmio, &fw_cfg_cmdline_param_ops, core::ptr::null_mut(), S_IRUSR);

#[no_mangle]
unsafe extern "C" fn fw_cfg_sysfs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fw_cfg_sysfs_exit() -> void __exit {
