...
//! Source: drivers/firmware/thead,th1520-aon.c
#![no_std]
...
pub const MAX_TX_TIMEOUT: c_int = 500;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
pub unsafe extern "C" fn th1520_aon_to_linux_errno(errno: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn th1520_aon_rx_callback(c: *mut mbox_client, rx_msg: *mut c_void) {
    ...
    let mut recv_size: u8 = sizeof(struct th1520_aon_rpc_msg_hdr) + hdr.size;
...
//
#[no_mangle]
pub unsafe extern "C" fn th1520_aon_call_rpc(aon_chan: *mut th1520_aon_chan, msg: *mut c_void) -> c_int {
...
//
    ...
    bool power_on)
    {
    let mut msg: th1520_aon_msg_req_set_resource_power_mode = {};
...
//
#[no_mangle]
pub unsafe extern "C" fn th1520_aon_deinit(aon_chan: *mut th1520_aon_chan) {
