...
//! Source: drivers/firmware/meson/meson_sm.c
#![no_std]
...
pub struct meson_sm_firmware {
    ...
    pub sm_shmem_in_base: *mut void __iomem,
    pub sm_shmem_out_base: *mut void __iomem,
}
...
pub const SM_CHIP_ID_LENGTH: c_int = 119;
pub const SM_CHIP_ID_OFFSET: c_int = 4;
pub const SM_CHIP_ID_SIZE: c_int = 12;
...
#[no_mangle]
unsafe extern "C" fn meson_sm_probe(pdev: *mut platform_device) -> int __init {
