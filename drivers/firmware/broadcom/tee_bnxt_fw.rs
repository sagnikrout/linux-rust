...
//! Source: drivers/firmware/broadcom/tee_bnxt_fw.c
#![no_std]
...
pub const MAX_TEE_PARAM_ARRY_MEMB: c_int = 4;
    enum ta_cmd {
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tee_bnxt_fw_private {
    pub dev: *mut device,
...
//
#[no_mangle]
pub unsafe extern "C" fn tee_bnxt_fw_load() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tee_bnxt_copy_coredump(buf: *mut c_void, offset: u32, size: u32) -> c_int {
    int tee_bnxt_copy_coredump(void *buf, u32 offset, u32 size)
    {
    struct tee_ioctl_invoke_arg arg;
    struct tee_param param[MAX_TEE_PARAM_ARRY_MEMB];
    void *core_data;
    let mut rbytes: u32 = size;
...
#[no_mangle]
unsafe extern "C" fn tee_bnxt_fw_probe(bnxt_device: *mut tee_client_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tee_bnxt_fw_remove(bnxt_device: *mut tee_client_device) {
...
#[no_mangle]
unsafe extern "C" fn tee_bnxt_fw_shutdown(bnxt_device: *mut tee_client_device) {
