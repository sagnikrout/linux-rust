...
//! Source: drivers/firmware/cirrus/test/cs_dsp_test_control_rw.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs_dsp_ctl_rw_test_param {
    pub mem_type: c_int,
    pub alg_id: c_int,
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_write_running(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_read_volatile_running(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_read_volatile_not_started(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_read_volatile_stopped(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_read_volatile_stopped_powered_down(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_read_volatile_not_current_loaded_fw(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_read_volatile_not_current_running_fw(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_write_volatile_not_started(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_write_volatile_stopped(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_write_volatile_stopped_powered_down(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_write_volatile_not_current_loaded_fw(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_write_volatile_not_current_running_fw(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_read_with_seek(test: *mut kunit) {
...
// Start the firmware and add an action to stop it during cleanup
    ...
    let mut len_bytes: c_uint = def.length_bytes - (seek_words * sizeof(u32));
    KUNIT_EXPECT_EQ(test,
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_read_cache_with_seek(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_read_truncated(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_read_cache_truncated(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_write_with_seek(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_write_cache_with_seek(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_write_truncated(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_write_cache_truncated(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_read_with_seek_oob(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_read_with_length_overflow(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_read_with_seek_and_length_oob(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_write_with_seek_oob(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_write_with_length_overflow(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_write_with_seek_and_length_oob(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_read_from_writeonly(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_write_to_readonly(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_rw_test_halo_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_rw_test_adsp2_32bit_init(test: *mut kunit, wmfw_ver: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_rw_test_adsp2_32bit_wmfw1_init(test: *mut kunit) -> c_int {
    static int cs_dsp_ctl_rw_test_adsp2_32bit_wmfw1_init(struct kunit *test)
    {
    return cs_dsp_ctl_rw_test_adsp2_32bit_init(test, 1);
    }
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_rw_test_adsp2_32bit_wmfw2_init(test: *mut kunit) -> c_int {
    static int cs_dsp_ctl_rw_test_adsp2_32bit_wmfw2_init(struct kunit *test)
    {
    return cs_dsp_ctl_rw_test_adsp2_32bit_init(test, 2);
    }
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_rw_test_adsp2_16bit_init(test: *mut kunit, wmfw_ver: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_rw_test_adsp2_16bit_wmfw1_init(test: *mut kunit) -> c_int {
    static int cs_dsp_ctl_rw_test_adsp2_16bit_wmfw1_init(struct kunit *test)
    {
    return cs_dsp_ctl_rw_test_adsp2_16bit_init(test, 1);
    }
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_rw_test_adsp2_16bit_wmfw2_init(test: *mut kunit) -> c_int {
