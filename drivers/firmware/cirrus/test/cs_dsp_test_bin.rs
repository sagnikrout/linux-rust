...
//! Source: drivers/firmware/cirrus/test/cs_dsp_test_bin.c
#![no_std]
...
pub struct bin_test_param {
    ...
    pub payload_len_bytes): *const *const void payload_data, size_t,
}
...
//
#[no_mangle]
unsafe extern "C" fn _num_words_to_num_packed_regs(num_dsp_words: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn bin_patch_one_word(test: *mut kunit) {
    static void bin_patch_one_word(struct kunit *test)
    {
    struct cs_dsp_test *priv = test.priv;
    const struct bin_test_param *param = test.param_value;
    let mut reg_inc_per_word: c_uint = cs_dsp_mock_reg_addr_inc_per_unpacked_word(priv);
...
#[no_mangle]
unsafe extern "C" fn bin_patch_one_multiword(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn bin_patch_multi_oneword(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_multi_oneword_unordered(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_multi_oneword_sparse_unordered(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_one_word_multiple_mems(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_one_word_multiple_algs(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_one_word_multiple_algs_unordered(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn bin_patch_1_packed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_1_packed_1_single_trailing(test: *mut kunit) {
    static void bin_patch_1_packed_1_single_trailing(struct kunit *test)
    {
    struct cs_dsp_test *priv = test.priv;
    const struct bin_test_param *param = test.param_value;
    let mut unpacked_mem_type: c_uint = cs_dsp_mock_packed_to_unpacked_mem_type(param.mem_type);
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_1_packed_2_single_trailing(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_1_packed_3_single_trailing(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_1_packed_2_trailing(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_1_packed_3_trailing(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_1_single_leading_1_packed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_2_single_leading_1_packed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_2_leading_1_packed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_3_single_leading_1_packed(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_3_leading_1_packed(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn bin_patch_multi_onepacked(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_multi_onepacked_unordered(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_multi_onepacked_sparse_unordered(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_1_packed_multiple_mems(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_1_packed_multiple_algs(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_1_packed_multiple_algs_unordered(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn bin_patch_mixed_packed_unpacked_random(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn bin_patch_name_and_info(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_bin_test_can_emit_message_hook() -> bool {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_bin_test_halo_init_common(test: *mut kunit, wmdr_ver: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_bin_test_halo_init(test: *mut kunit) -> c_int {
    static int cs_dsp_bin_test_halo_init(struct kunit *test)
    {
    return cs_dsp_bin_test_halo_init_common(test, 1);
    }
#[no_mangle]
unsafe extern "C" fn cs_dsp_bin_test_halo_wmdr3_init(test: *mut kunit) -> c_int {
    static int cs_dsp_bin_test_halo_wmdr3_init(struct kunit *test)
    {
    return cs_dsp_bin_test_halo_init_common(test, 3);
    }
#[no_mangle]
unsafe extern "C" fn cs_dsp_bin_test_adsp2_32bit_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_bin_test_adsp2_16bit_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn offset_param_desc(param: *const bin_test_param, desc: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn alg_param_desc(param: *const bin_test_param, desc: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn x_or_y_or_z_and_alg_param_desc(param: *const bin_test_param, desc: *mut c_char) {
