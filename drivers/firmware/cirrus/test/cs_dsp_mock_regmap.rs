...
//! Source: drivers/firmware/cirrus/test/cs_dsp_mock_regmap.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_mock_regmap_write(context: *mut c_void, val_buf: *const c_void, val_size: usize) -> c_int {
...
// Should never get here because the regmap is cache-only
    ...
    let mut cs_dsp_mock_adsp2_32bit_sysbase: c_uint = 0xffe00;
    ...
    let mut cs_dsp_mock_adsp2_16bit_sysbase: c_uint = 0x001100;
...
// SYSINFO
    ...
    let mut cs_dsp_mock_halo_core_base: c_uint = 0x2b80000;
    EXPORT_SYMBOL_NS_GPL(cs_dsp_mock_halo_core_base, "FW_CS_DSP_KUNIT_TEST_UTILS");
    let mut cs_dsp_mock_halo_sysinfo_base: c_uint = 0x25e0000;
...
//
    ...
    {
    let mut stride: c_int = regmap_get_reg_stride(priv.dsp.regmap);
    let mut last: c_uint = first_reg + (stride * (num_regs - 1));
...
//
    ...
    {
    let mut num_regs: usize = num_bytes / regmap_get_val_bytes(priv.dsp.regmap);
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_regmap_drop_system_regs(priv: *mut cs_dsp_test) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_regmap_is_dirty(priv: *mut cs_dsp_test, drop_system_regs: bool) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_regmap_init(priv: *mut cs_dsp_test) -> c_int {
