...
//! Source: drivers/firmware/cirrus/test/cs_dsp_test_control_cache.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs_dsp_ctl_cache_test_param {
    pub mem_type: c_int,
    pub alg_id: c_int,
    pub offs_words: c_uint,
    pub len_bytes: c_uint,
    pub ctl_type: u16,
    pub flags: u16,
}
...
#[no_mangle]
unsafe extern "C" fn _find_alg_entry(test: *mut kunit, alg_id: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _get_alg_mem_base_words(test: *mut kunit, alg_index: c_int, mem_type: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_v2_cache_alloc(test: *mut kunit) {
...
// Create controls of different sizes
    ...
    KUNIT_ASSERT_EQ(test, cs_dsp_power_up(dsp, wmfw, "mock_fw", core::ptr::null_mut(), core::ptr::null_mut(), "misc"), 0);
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_init(test: *mut kunit) {
    ...
    struct cs_dsp *dsp = priv.dsp;
    let mut def: cs_dsp_mock_coeff_def = mock_coeff_template;
    let mut alg_idx: c_int = _find_alg_entry(test, param.alg_id);
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_init_write_only(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_init_multiple_fw_same_controls(test: *mut kunit) {
...
//
    ...
    ctl[i] = core::ptr::null_mut();
    list_for_each_entry(walkctl, &dsp.ctl_list, list) {
    if (strcmp(walkctl.fw_name, cs_dsp_ctl_cache_test_fw_names[0]) == 0)
    ctl[0] = walkctl;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(walkctl->fw_name, 0: cs_dsp_ctl_cache_test_fw_names[1]) ==) -> else {
    else if (strcmp(walkctl.fw_name, cs_dsp_ctl_cache_test_fw_names[1]) == 0)
    ctl[1] = walkctl;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(walkctl->fw_name, 0: cs_dsp_ctl_cache_test_fw_names[2]) ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_init_multiple_fwalgid_same_controls(test: *mut kunit) {
...
//
    ...
    ctl[0] = walkctl;
#[no_mangle]
pub unsafe extern "C" fn if(walkctl->alg_region.alg: cs_dsp_ctl_cache_test_algs[1].id ==) -> else {
    else if (cs_dsp_ctl_cache_test_algs[1].id == walkctl.alg_region.alg)
    ctl[1] = walkctl;
#[no_mangle]
pub unsafe extern "C" fn if(walkctl->alg_region.alg: cs_dsp_ctl_cache_test_algs[2].id ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_init_multiple_mems(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_init_multiple_algs(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_init_multiple_offsets(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_read_not_started(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_read_stopped(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_read_powered_down(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_read_stopped_powered_down(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_read_not_current_loaded_fw(test: *mut kunit) {
...
// Power-down DSP then power-up with a different firmware
    ...
    KUNIT_ASSERT_EQ(test, cs_dsp_power_up(dsp, wmfw, "mock_fw2", core::ptr::null_mut(), core::ptr::null_mut(), "mbc.vss"), 0);
// Drop expected writes and the regmap cache should be clean
    cs_dsp_mock_xm_header_drop_from_regmap_cache(priv);
    cs_dsp_mock_regmap_drop_bytes(priv, reg, param.len_bytes);
    KUNIT_EXPECT_FALSE(test, cs_dsp_mock_regmap_is_dirty(priv, true));
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_read_not_current_running_fw(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_read_running(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_read_running_zero_flags(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_writethrough(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_writethrough_unchanged(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_write_unchanged_not_started(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_write_not_started(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_write_stopped(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_write_powered_down(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_write_stopped_powered_down(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_write_not_current_loaded_fw(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_write_not_current_running_fw(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_sync_write_before_run(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_sync_write_while_running(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_sync_write_after_stop(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_sync_write_not_current_fw(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_sync_reapply_every_run(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_sync_reapply_after_fw_reload(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_sync_reapply_after_fw_swap(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_test_halo_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_test_adsp2_32bit_init(test: *mut kunit, wmfw_ver: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_test_adsp2_32bit_wmfw1_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_test_adsp2_32bit_wmfw2_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_test_adsp2_16bit_init(test: *mut kunit, wmfw_ver: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_test_adsp2_16bit_wmfw1_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_cache_test_adsp2_16bit_wmfw2_init(test: *mut kunit) -> c_int {
