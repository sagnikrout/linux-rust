...
//! Source: drivers/firmware/cirrus/test/cs_dsp_mock_bin.c
#![no_std]
...
pub const CS_DSP_MOCK_BIN_BUF_SIZE: c_int = 32768;
...
//
    ...
    let mut bytes_needed: usize = struct_size_t(struct wmfw_coeff_item, data, payload_len_bytes);
    ...
    {
    let mut info_len: usize = strlen(info);
    char *tmp = core::ptr::null_mut();
    if (info_len % 4) {
// Create a padded string with length a multiple of 4
    let mut copy_len: usize = info_len;
