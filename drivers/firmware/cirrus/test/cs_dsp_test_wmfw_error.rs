...
//! Source: drivers/firmware/cirrus/test/cs_dsp_test_wmfw_error.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wmfw_load_with_unknown_blocks(test: *mut kunit) {
...
// Add some unknown blocks at the start of the wmfw
    ...
    sizeof(random_data));
    cs_dsp_mock_wmfw_add_raw_block(local.wmfw_builder, 0x33, 0, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn wmfw_err_wrong_magic(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_err_too_short_for_header(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_err_bad_header_length(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_err_bad_core_type(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_too_short_for_block_header(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_too_short_for_block_payload(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_block_payload_len_garbage(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_too_short_for_alg_header(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_v1_alg_name_unterminated(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_v2_alg_name_exceeds_block(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_v2_alg_description_exceeds_block(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_v1_coeff_count_exceeds_block(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_v2_coeff_count_exceeds_block(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_v2_coeff_block_size_exceeds_block(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_v1_coeff_name_unterminated(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_v2_coeff_shortname_exceeds_block(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_v2_coeff_fullname_exceeds_block(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_v2_coeff_description_exceeds_block(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_wmfw_err_test_can_emit_message_hook() -> bool {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_wmfw_err_test_halo_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_wmfw_err_test_adsp2_32bit_init(test: *mut kunit, wmfw_ver: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_wmfw_err_test_adsp2_32bit_wmfw0_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_wmfw_err_test_adsp2_32bit_wmfw1_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_wmfw_err_test_adsp2_32bit_wmfw2_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_wmfw_err_test_adsp2_16bit_init(test: *mut kunit, wmfw_ver: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_wmfw_err_test_adsp2_16bit_wmfw0_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_wmfw_err_test_adsp2_16bit_wmfw1_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_wmfw_err_test_adsp2_16bit_wmfw2_init(test: *mut kunit) -> c_int {
