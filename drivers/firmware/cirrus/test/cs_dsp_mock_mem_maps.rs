...
//! Source: drivers/firmware/cirrus/test/cs_dsp_mock_mem_maps.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_count_regions(region_sizes: *const c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_size_of_region(dsp: *const cs_dsp, mem_type: c_int) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn if(cs_dsp_mock_adsp2_32bit_dsp1_regions: dsp->mem ==) -> else {
    else if (dsp.mem == cs_dsp_mock_adsp2_32bit_dsp1_regions)
    sizes = cs_dsp_mock_adsp2_32bit_dsp1_region_sizes;
#[no_mangle]
pub unsafe extern "C" fn if(cs_dsp_mock_adsp2_16bit_dsp1_regions: dsp->mem ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_base_addr_for_mem(priv: *mut cs_dsp_test, mem_type: c_int) -> c_uint {
    unsigned int cs_dsp_mock_base_addr_for_mem(struct cs_dsp_test *priv, int mem_type)
    {
    let mut num_mems: c_int = priv.dsp.num_mems;
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_reg_addr_inc_per_unpacked_word(priv: *mut cs_dsp_test) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_reg_block_length_bytes(priv: *mut cs_dsp_test, mem_type: c_int) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_reg_block_length_registers(priv: *mut cs_dsp_test, mem_type: c_int) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_reg_block_length_dsp_words(priv: *mut cs_dsp_test, mem_type: c_int) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_has_zm(priv: *mut cs_dsp_test) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_packed_to_unpacked_mem_type(packed_mem_type: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_num_dsp_words_to_num_packed_regs(num_dsp_words: c_uint) -> c_uint {
...
//
    ...
    int mem_type)
    {
    let mut xm: c_uint = cs_dsp_mock_base_addr_for_mem(priv, WMFW_ADSP2_XM);
    union {
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_xm_header_get_fw_version(header: *mut cs_dsp_mock_xm_header) -> c_uint {
    ...
    default:
    KUNIT_FAIL(header.test_priv.test, core::ptr::null_mut());
    return 0;
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_xm_header_drop_from_regmap_cache(priv: *mut cs_dsp_test) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_dsp_mock_xm_header_write_to_regmap(header: *mut cs_dsp_mock_xm_header) -> c_int {
    int cs_dsp_mock_xm_header_write_to_regmap(struct cs_dsp_mock_xm_header *header)
    {
    struct cs_dsp_test *priv = header.test_priv;
    let mut reg_addr: c_uint = cs_dsp_mock_base_addr_for_mem(priv, WMFW_ADSP2_XM);
//
