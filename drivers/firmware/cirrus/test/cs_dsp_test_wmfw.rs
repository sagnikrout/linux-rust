...
//! Source: drivers/firmware/cirrus/test/cs_dsp_test_wmfw.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs_dsp_wmfw_test_param {
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_xm_header_unpacked(test: *mut kunit) {
...
// XM header payload was added to wmfw by test case init function
    ...
    cs_dsp_power_up(priv.dsp, wmfw, "mock_wmfw", core::ptr::null_mut(), core::ptr::null_mut(), "misc"),
    0);
...
#[no_mangle]
unsafe extern "C" fn wmfw_write_one_payload(test: *mut kunit) {
    ...
    let mut mem_offset_dsp_words: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn wmfw_write_multiple_oneblock_payloads(test: *mut kunit) {
    ...
    let mut num_payloads: c_uint = param.num_blocks;
    int i;
// payloads must be a multiple of 4 bytes and a whole number of DSP registers
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_multiple_oneblock_payloads_reverse(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_multiple_payloads_sparse_unordered(test: *mut kunit) {
    ...
    let mut mem_offset_dsp_words: c_uint = 0;
    unsigned int payload_size_bytes, payload_size_dsp_words;
    let mut num_payloads: c_int = ARRAY_SIZE(random_offsets);
    int i;
    payload_size_bytes = param.num_blocks *
    cs_dsp_mock_reg_block_length_bytes(priv, param.mem_type);
...
// Add multiple payloads of one block each at "random" locations
    for (i = 0; i < num_payloads; ++i) {
    let mut offset: c_uint = random_offsets[i] * payload_size_dsp_words;
    cs_dsp_mock_wmfw_add_data_block(local.wmfw_builder,
    param.mem_type,
...
#[no_mangle]
unsafe extern "C" fn wmfw_write_all_unpacked_pm(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_write_all_packed_pm(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_multiple_unpacked_mem(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_multiple_packed_unpacked_mem(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_packed_1_unpacked_trailing(test: *mut kunit) {
    static void wmfw_write_packed_1_unpacked_trailing(struct kunit *test)
    {
    const struct cs_dsp_wmfw_test_param *param = test.param_value;
    struct cs_dsp_test *priv = test.priv;
    struct cs_dsp_test_local *local = priv.local;
    let mut packed_mem_type: c_int = param.mem_type;
    let mut unpacked_mem_type: c_int = cs_dsp_mock_packed_to_unpacked_mem_type(param.mem_type);
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_packed_2_unpacked_trailing(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_packed_3_unpacked_trailing(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_packed_2_single_unpacked_trailing(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_packed_3_single_unpacked_trailing(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_packed_1_unpacked_leading(test: *mut kunit) {
    ...
    unsigned int dsp_words_per_unpacked_block =
    cs_dsp_mock_reg_block_length_dsp_words(priv, unpacked_mem_type);
    let mut packed_payload_offset_dsp_words: c_uint = 0;
    struct firmware *wmfw;
    unsigned int reg_addr;
    void *packed_payload_data, *readback;
    u32 unpacked_payload_data[1];
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_packed_2_unpacked_leading(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_packed_3_unpacked_leading(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_packed_2_single_unpacked_leading(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn wmfw_write_packed_3_single_unpacked_leading(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmfw_load_with_info(test: *mut kunit) {
    ...
    u8 *payload_data, *readback;
    char *infobuf;
    let mut payload_size_bytes: c_uint = 48;
    int ret;
    payload_data = kunit_kmalloc(test, payload_size_bytes, GFP_KERNEL);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, payload_data);
    get_random_bytes(payload_data, payload_size_bytes);
...
// Add another payload
    ...
    payload_data, payload_size_bytes);
    wmfw = cs_dsp_mock_wmfw_get_firmware(priv.local.wmfw_builder);
    ret = cs_dsp_power_up(priv.dsp, wmfw, "mock_wmfw", core::ptr::null_mut(), core::ptr::null_mut(), "misc");
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_wmfw_test_can_emit_message_hook() -> bool {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_wmfw_test_halo_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_wmfw_test_adsp2_32bit_init(test: *mut kunit, wmfw_ver: c_int) -> c_int {
