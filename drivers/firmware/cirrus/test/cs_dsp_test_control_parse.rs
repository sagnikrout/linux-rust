...
//! Source: drivers/firmware/cirrus/test/cs_dsp_test_control_parse.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_no_coeffs(test: *mut kunit) {
    ...
    KUNIT_ASSERT_EQ(test, cs_dsp_power_up(priv.dsp, wmfw, "mock_fw", core::ptr::null_mut(), core::ptr::null_mut(), "misc"), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_v1_name(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_empty_v1_name(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_max_v1_name(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_short_name(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_min_short_name(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_max_short_name(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_with_min_fullname(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_with_max_fullname(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_with_min_description(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_with_max_description(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_with_max_fullname_and_description(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_shortname_alignment(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_fullname_alignment(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_description_alignment(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_get_ctl_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_get_ctl_test_multiple_wmfw(test: *mut kunit) {
...
// Load a 'mbc/vss' firmware with a control of the same name
    ...
    cs_dsp_power_up(priv.dsp, wmfw, "mock_fw2", core::ptr::null_mut(), core::ptr::null_mut(), "mbc/vss"), 0);
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_memory_type(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_alg_id(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_alg_mem(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_offset(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_length(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_ctl_type(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_flags(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_illegal_type_flags(test: *mut kunit) {
...
//
    ...
    cs_dsp_mock_wmfw_end_alg_info_block(local.wmfw_builder);
    wmfw = cs_dsp_mock_wmfw_get_firmware(priv.local.wmfw_builder);
    KUNIT_ASSERT_LT(test, cs_dsp_power_up(priv.dsp, wmfw, "mock_fw", core::ptr::null_mut(), core::ptr::null_mut(), "misc"), 0);
    }
// Test that the correct firmware name is entered in the cs_dsp_coeff_ctl.
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_fw_name(test: *mut kunit) {
...
// Both controls should be in the list (order not guaranteed)
    ...
    ctl1 = core::ptr::null_mut();
    ctl2 = core::ptr::null_mut();
    list_for_each_entry(walkctl, &priv.dsp.ctl_list, list) {
    if (strcmp(walkctl.fw_name, "misc") == 0)
    ctl1 = walkctl;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(walkctl->fw_name, 0: "mbc/vss") ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_alg_id_uniqueness(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_mem_uniqueness(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_fw_uniqueness(test: *mut kunit) {
...
// Load a 'mbc/vss' firmware with the same control
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), "mbc/vss"), 0);
    cs_dsp_power_down(priv.dsp);
// Both controls should be in the list
    KUNIT_EXPECT_EQ(test, list_count_nodes(&priv.dsp.ctl_list), 2);
    ctl1 = list_first_entry_or_null(&priv.dsp.ctl_list, struct cs_dsp_coeff_ctl, list);
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_squash_reloaded_controls(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_v2_squash_reloaded_controls(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_v2_compare_len(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_test_halo_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_test_adsp2_32bit_init(test: *mut kunit, wmfw_ver: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_test_adsp2_32bit_wmfw1_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_test_adsp2_32bit_wmfw2_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_test_adsp2_16bit_init(test: *mut kunit, wmfw_ver: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_test_adsp2_16bit_wmfw1_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_dsp_ctl_parse_test_adsp2_16bit_wmfw2_init(test: *mut kunit) -> c_int {
