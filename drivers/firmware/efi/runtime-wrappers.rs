...
//! Source: drivers/firmware/efi/runtime-wrappers.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn efi_call_virt_save_flags() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn efi_call_virt_check_flags(flags: c_ulong, caller: *const c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn efi_rts_park_worker() -> void __noreturn {
...
//
#[no_mangle]
unsafe extern "C" fn efi_call_rts(work: *mut work_struct) -> void __nocfi {
...
#[no_mangle]
unsafe extern "C" fn virt_efi_get_time(tm: *mut efi_time_t, tc: *mut efi_time_cap_t) -> efi_status_t {
...
#[no_mangle]
unsafe extern "C" fn virt_efi_set_time(tm: *mut efi_time_t) -> efi_status_t {
...
#[no_mangle]
unsafe extern "C" fn virt_efi_set_wakeup_time(enabled: efi_bool_t, tm: *mut efi_time_t) -> efi_status_t {
...
#[no_mangle]
unsafe extern "C" fn virt_efi_get_next_high_mono_count(count: *mut u32) -> efi_status_t {
...
#[no_mangle]
pub unsafe extern "C" fn efi_native_runtime_setup() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn efi_runtime_assert_lock_held() {
