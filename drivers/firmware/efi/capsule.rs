...
//! Source: drivers/firmware/efi/capsule.c
#![no_std]
...
//
    ...
    let mut efi_reset_type: static int = -1;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn efi_capsule_pending(reset_type: *mut c_int) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn efi_capsule_supported(guid: efi_guid_t, flags: u32, size: usize, reset: *mut c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sg_pages_num(count: c_uint) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn efi_capsule_update(capsule: *mut efi_capsule_header_t, pages: *mut phys_addr_t) -> c_int {
    int efi_capsule_update(efi_capsule_header_t *capsule, phys_addr_t *pages)
    {
    let mut imagesize: u32 = capsule.imagesize;
    let mut guid: efi_guid_t = capsule.guid;
    unsigned int count, sg_count;
    let mut flags: u32 = capsule.flags;
...
#[no_mangle]
unsafe extern "C" fn capsule_reboot_notify(nb: *mut notifier_block, event: c_ulong, cmd: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn capsule_reboot_register() -> int __init {
