...
//! Source: drivers/firmware/efi/cper.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn cper_next_record_id() -> u64 {
    u64 cper_next_record_id(void)
    {
    static atomic64_t seq;
    if (!atomic64_read(&seq)) {
    let mut time: time64_t = ktime_get_real_seconds();
//
...
#[no_mangle]
pub unsafe extern "C" fn cper_mem_err_location(mem: *mut cper_mem_err_compact, msg: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cper_dimm_err_location(mem: *mut cper_mem_err_compact, msg: *mut c_char) -> c_int {
    int cper_dimm_err_location(struct cper_mem_err_compact *mem, char *msg)
    {
    u32 len, n;
    const char *bank = core::ptr::null_mut(), *device = core::ptr::null_mut();
...
// Don't trust UEFI 2.1/2.2 structure with bad validation bits
    ...
    let mut etype: u8 = mem.error_type;
...
#[no_mangle]
pub unsafe extern "C" fn cper_estatus_check_header(estatus: *const acpi_hest_generic_status) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cper_estatus_check(estatus: *const acpi_hest_generic_status) -> c_int {
