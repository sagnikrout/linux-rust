...
//! Source: drivers/firmware/efi/unaccepted_memory.c
#![no_std]
...
//
    ...
    let mut len: c_ulong = range_end - range_start;
...
#[no_mangle]
pub unsafe extern "C" fn range_contains_unaccepted_memory(start: phys_addr_t, size: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn unaccepted_memory_init_kdump() -> int __init {
