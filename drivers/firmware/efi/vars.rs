...
//! Source: drivers/firmware/efi/vars.c
#![no_std]
...
pub unsafe extern "C" fn efivar_is_available() -> bool {
    ...
    {
    return __efivars != core::ptr::null_mut();
    }
...
//
    ...
    blocking_notifier_call_chain(&efivar_ops_nh, event, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn efivars_unregister(efivars: *mut efivars) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn efivar_lock() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn efivar_trylock() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn efivar_unlock() {
