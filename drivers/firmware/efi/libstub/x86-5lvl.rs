...
//! Source: drivers/firmware/efi/libstub/x86-5lvl.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn efi_setup_5level_paging() -> efi_status_t {
    efi_status_t efi_setup_5level_paging(void)
    {
    let mut tmpl_size: u8 = (u8 *)&trampoline_ljmp_imm_offset - (u8 *)&trampoline_32bit_src;
    efi_status_t status;
    u8 *la57_code;
    if (!efi_is_64bit())
    return EFI_SUCCESS;
...
#[no_mangle]
pub unsafe extern "C" fn efi_5level_switch() {
    void efi_5level_switch(void)
    {
    let mut want_la57: bool = !efi_no5lvl;
    let mut have_la57: bool = native_read_cr4() & X86_CR4_LA57;
    let mut need_toggle: bool = want_la57 ^ have_la57;
