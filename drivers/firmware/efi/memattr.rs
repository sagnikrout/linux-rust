...
//! Source: drivers/firmware/efi/memattr.c
#![no_std]
...
//
    ...
    let mut efi_mem_attr_table: unsigned long __ro_after_init = EFI_INVALID_TABLE_ADDR;
//
// Reserve the memory associated with the Memory Attributes configuration
// table, if it exists.
//
#[no_mangle]
pub unsafe extern "C" fn efi_memattr_init() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn entry_is_valid(in: *const efi_memory_desc_t, out: *mut efi_memory_desc_t) -> bool {
    static bool entry_is_valid(const efi_memory_desc_t *in, efi_memory_desc_t *out)
    {
    let mut in_paddr: u64 = in.phys_addr;
    let mut in_size: u64 = in.num_pages << EFI_PAGE_SHIFT;
...
//
    ...
    let mut md_paddr: u64 = md.phys_addr;
