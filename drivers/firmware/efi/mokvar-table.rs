...
//! Source: drivers/firmware/efi/mokvar-table.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct efi_mokvar_sysfs_attr {
...
//
#[no_mangle]
pub unsafe extern "C" fn efi_mokvar_table_init() -> void __init {
    ...
    let mut map_size_needed: c_ulong = 0;
    unsigned long size;
    int err;
...
// mokvar_entry = NULL;
    if (efi_mokvar_table_va == core::ptr::null_mut())
    return core::ptr::null_mut();
    if (mokvar_cur == core::ptr::null_mut()) {
...
//
    ...
    {
    struct efi_mokvar_table_entry *mokvar_entry = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn efi_mokvar_sysfs_init() -> int __init {
    static int __init efi_mokvar_sysfs_init(void)
    {
    void *config_va;
    struct efi_mokvar_table_entry *mokvar_entry = core::ptr::null_mut();
    struct efi_mokvar_sysfs_attr *mokvar_sysfs = core::ptr::null_mut();
    let mut err: c_int = 0;
