...
//! Source: drivers/firmware/xilinx/zynqmp.c
#![no_std]
...
pub const PM_API_FEATURE_CHECK_MAX_ORDER: c_int = 7;
// CRL registers and bitfields
pub const CRL_APB_BASE: c_uint = 0xFF5E0000U;
// BOOT_PIN_CTRL- Used to control the mode pins after boot

// BOOT_PIN_CTRL_MASK- out_val[11:8], out_en[3:0]
pub const CRL_APB_BOOTPIN_CTRL_MASK: c_uint = 0xF0FU;
// IOCTL/QUERY feature payload size
pub const FEATURE_PAYLOAD_SIZE: c_int = 2;
...
pub struct pm_api_feature_data {
    pub pm_api_id: u32,
    pub feature_status: c_int,
    pub hentry: hlist_node,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct platform_fw_data {
//
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_pm_ret_code(ret_status: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_fw_call_fail(ret_payload: *mut u32, num_args: u32, ...) -> noinline int {
...
//
#[no_mangle]
unsafe extern "C" fn do_fw_call_smc(ret_payload: *mut u32, num_args: u32, ...) -> noinline int {
...
//
#[no_mangle]
unsafe extern "C" fn do_fw_call_hvc(ret_payload: *mut u32, num_args: u32, ...) -> noinline int {
...
#[no_mangle]
unsafe extern "C" fn __do_feature_check_call(api_id: u32, ret_payload: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_feature_check_call(api_id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(PM_QUERY_DATA: api_id ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_feature(api_id: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_is_function_supported(api_id: u32, id: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_invoke_fw_fn(pm_api_id: u32, ret_payload: *mut u32, num_args: u32, ...) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_invoke_fn(pm_api_id: u32, ret_payload: *mut u32, num_args: u32, ...) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_register_sgi(sgi_num: u32, reset: u32) -> c_int {
    int zynqmp_pm_register_sgi(u32 sgi_num, u32 reset)
    {
    int ret;
    ret = zynqmp_pm_invoke_fn(TF_A_PM_REGISTER_SGI, core::ptr::null_mut(), 2, sgi_num, reset);
    if (ret != -EOPNOTSUPP && !ret)
    return ret;
// try old implementation as fallback strategy if above fails
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 3, IOCTL_REGISTER_SGI, sgi_num, reset);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_get_api_version(version: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_get_chipid(idcode: *mut u32, version: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_get_family_info(family: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_pm_get_sip_svc_version(version: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_pm_get_trustzone_version(version: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_set_conduit_method(np: *mut device_node) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_query_data(qdata: zynqmp_pm_query_data, out: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_clock_enable(clock_id: u32) -> c_int {
    int zynqmp_pm_clock_enable(u32 clock_id)
    {
    return zynqmp_pm_invoke_fn(PM_CLOCK_ENABLE, core::ptr::null_mut(), 1, clock_id);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_clock_disable(clock_id: u32) -> c_int {
    int zynqmp_pm_clock_disable(u32 clock_id)
    {
    return zynqmp_pm_invoke_fn(PM_CLOCK_DISABLE, core::ptr::null_mut(), 1, clock_id);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_clock_getstate(clock_id: u32, state: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_clock_setdivider(clock_id: u32, divider: u32) -> c_int {
    int zynqmp_pm_clock_setdivider(u32 clock_id, u32 divider)
    {
    return zynqmp_pm_invoke_fn(PM_CLOCK_SETDIVIDER, core::ptr::null_mut(), 2, clock_id, divider);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_clock_getdivider(clock_id: u32, divider: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_clock_setparent(clock_id: u32, parent_id: u32) -> c_int {
    int zynqmp_pm_clock_setparent(u32 clock_id, u32 parent_id)
    {
    return zynqmp_pm_invoke_fn(PM_CLOCK_SETPARENT, core::ptr::null_mut(), 2, clock_id, parent_id);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_clock_getparent(clock_id: u32, parent_id: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_set_pll_frac_mode(clk_id: u32, mode: u32) -> c_int {
    int zynqmp_pm_set_pll_frac_mode(u32 clk_id, u32 mode)
    {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 4, 0, IOCTL_SET_PLL_FRAC_MODE, clk_id, mode);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_get_pll_frac_mode(clk_id: u32, mode: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_set_pll_frac_data(clk_id: u32, data: u32) -> c_int {
    int zynqmp_pm_set_pll_frac_data(u32 clk_id, u32 data)
    {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 4, 0, IOCTL_SET_PLL_FRAC_DATA, clk_id, data);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_get_pll_frac_data(clk_id: u32, data: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_set_sd_tapdelay(node_id: u32, type: u32, value: u32) -> c_int {
    int zynqmp_pm_set_sd_tapdelay(u32 node_id, u32 type, u32 value)
    {
    let mut reg: u32 = (type == PM_TAPDELAY_INPUT) ? SD_ITAPDLY : SD_OTAPDLYSEL;
    let mut mask: u32 = (node_id == NODE_SD_0) ? GENMASK(15, 0) : GENMASK(31, 16);
    if (value) {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 4, node_id, IOCTL_SET_SD_TAPDELAY, type,
    value);
    }
//
...
//
    return zynqmp_pm_invoke_fn(PM_MMIO_WRITE, core::ptr::null_mut(), 2, reg, mask);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_sd_dll_reset(node_id: u32, type: u32) -> c_int {
    int zynqmp_pm_sd_dll_reset(u32 node_id, u32 type)
    {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 3, node_id, IOCTL_SD_DLL_RESET, type);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_ospi_mux_select(dev_id: u32, select: u32) -> c_int {
    int zynqmp_pm_ospi_mux_select(u32 dev_id, u32 select)
    {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 3, dev_id, IOCTL_OSPI_MUX_SELECT, select);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_write_ggs(index: u32, value: u32) -> c_int {
    int zynqmp_pm_write_ggs(u32 index, u32 value)
    {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 4, 0, IOCTL_WRITE_GGS, index, value);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_read_ggs(index: u32, value: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_write_pggs(index: u32, value: u32) -> c_int {
    int zynqmp_pm_write_pggs(u32 index, u32 value)
    {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 4, 0, IOCTL_WRITE_PGGS, index, value);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_read_pggs(index: u32, value: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_set_tapdelay_bypass(index: u32, value: u32) -> c_int {
    int zynqmp_pm_set_tapdelay_bypass(u32 index, u32 value)
    {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 4, 0, IOCTL_SET_TAPDELAY_BYPASS, index, value);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_set_boot_health_status(value: u32) -> c_int {
    int zynqmp_pm_set_boot_health_status(u32 value)
    {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 3, 0, IOCTL_SET_BOOT_HEALTH_STATUS, value);
    }
//
...
//
    ...
    {
    return zynqmp_pm_invoke_fn(PM_RESET_ASSERT, core::ptr::null_mut(), 2, reset, assert_flag);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_reset_get_status(reset: u32, status: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_fpga_load(address: u64, size: u32, flags: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_fpga_get_status(value: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_fpga_get_config_status(value: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_pinctrl_request(pin: u32) -> c_int {
    int zynqmp_pm_pinctrl_request(const u32 pin)
    {
    return zynqmp_pm_invoke_fn(PM_PINCTRL_REQUEST, core::ptr::null_mut(), 1, pin);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_pinctrl_release(pin: u32) -> c_int {
    int zynqmp_pm_pinctrl_release(const u32 pin)
    {
    return zynqmp_pm_invoke_fn(PM_PINCTRL_RELEASE, core::ptr::null_mut(), 1, pin);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_pinctrl_set_function(pin: u32, id: u32) -> c_int {
    int zynqmp_pm_pinctrl_set_function(const u32 pin, const u32 id)
    {
    return zynqmp_pm_invoke_fn(PM_PINCTRL_SET_FUNCTION, core::ptr::null_mut(), 2, pin, id);
    }
...
//
    ...
    return zynqmp_pm_invoke_fn(PM_PINCTRL_CONFIG_PARAM_SET, core::ptr::null_mut(), 3, pin, param, value);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_bootmode_read(ps_mode: *mut u32) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_bootmode_write(ps_mode: u32) -> c_int {
    int zynqmp_pm_bootmode_write(u32 ps_mode)
    {
    return zynqmp_pm_invoke_fn(PM_MMIO_WRITE, core::ptr::null_mut(), 3, CRL_APB_BOOT_PIN_CTRL,
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_pm_init_finalize() -> c_int {
    static int zynqmp_pm_init_finalize(void)
    {
    return zynqmp_pm_invoke_fn(PM_PM_INIT_FINALIZE, core::ptr::null_mut(), 0);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_set_suspend_mode(mode: u32) -> c_int {
    int zynqmp_pm_set_suspend_mode(u32 mode)
    {
    return zynqmp_pm_invoke_fn(PM_SET_SUSPEND_MODE, core::ptr::null_mut(), 1, mode);
    }
...
//
    ...
    {
    return zynqmp_pm_invoke_fn(PM_REQUEST_NODE, core::ptr::null_mut(), 4, node, capabilities, qos, ack);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_release_node(node: u32) -> c_int {
    int zynqmp_pm_release_node(const u32 node)
    {
    return zynqmp_pm_invoke_fn(PM_RELEASE_NODE, core::ptr::null_mut(), 1, node);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_get_rpu_mode(node_id: u32, rpu_mode: *mut enum rpu_oper_mode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_set_rpu_mode(node_id: u32, rpu_mode: enum rpu_oper_mode) -> c_int {
    int zynqmp_pm_set_rpu_mode(u32 node_id, enum rpu_oper_mode rpu_mode)
    {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 3, node_id, IOCTL_SET_RPU_OPER_MODE,
    (u32)rpu_mode);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_set_tcm_config(node_id: u32, tcm_mode: enum rpu_tcm_comb) -> c_int {
    int zynqmp_pm_set_tcm_config(u32 node_id, enum rpu_tcm_comb tcm_mode)
    {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 3, node_id, IOCTL_TCM_COMB_CONFIG,
    (u32)tcm_mode);
    }
...
//
    ...
    {
    return zynqmp_pm_invoke_fn(PM_FORCE_POWERDOWN, core::ptr::null_mut(), 2, node, ack);
    }
...
// set_addr flag is encoded into 1st bit of address
    return zynqmp_pm_invoke_fn(PM_REQUEST_WAKEUP, core::ptr::null_mut(), 4, node, address | set_addr,
    address >> 32, ack);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_start_rpu(node: u32, bootaddr: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_stop_rpu(node: u32) -> c_int {
...
//
    ...
    const enum zynqmp_pm_request_ack ack)
    {
    return zynqmp_pm_invoke_fn(PM_SET_REQUIREMENT, core::ptr::null_mut(), 4, node, capabilities, qos, ack);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_load_pdi(src: u32, address: u64) -> c_int {
    int zynqmp_pm_load_pdi(const u32 src, const u64 address)
    {
    return zynqmp_pm_invoke_fn(PM_LOAD_PDI, core::ptr::null_mut(), 3, src, lower_32_bits(address),
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_efuse_access(address: u64, out: *mut u32) -> c_int {
...
//
    ...
    {
    return zynqmp_pm_invoke_fn(PM_REGISTER_NOTIFIER, core::ptr::null_mut(), 4, node, event, wake, enable);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_system_shutdown(type: u32, subtype: u32) -> c_int {
    int zynqmp_pm_system_shutdown(const u32 type, const u32 subtype)
    {
    return zynqmp_pm_invoke_fn(PM_SYSTEM_SHUTDOWN, core::ptr::null_mut(), 2, type, subtype);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_set_feature_config(id: enum pm_feature_config_id, value: u32) -> c_int {
    int zynqmp_pm_set_feature_config(enum pm_feature_config_id id, u32 value)
    {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 4, 0, IOCTL_SET_FEATURE_CONFIG, id, value);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_sec_read_reg(node_id: u32, offset: u32, ret_value: *mut u32) -> c_int {
...
//
    ...
    u32 value)
    {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 5, node_id, IOCTL_MASK_WRITE_REG,
    offset, mask, value);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pm_set_sd_config(node: u32, config: enum pm_sd_config_type, value: u32) -> c_int {
    int zynqmp_pm_set_sd_config(u32 node, enum pm_sd_config_type config, u32 value)
    {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 4, node, IOCTL_SET_SD_CONFIG, config, value);
    }
...
//
    ...
    u32 value)
    {
    return zynqmp_pm_invoke_fn(PM_IOCTL, core::ptr::null_mut(), 4, node, IOCTL_SET_GEM_CONFIG, config, value);
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynqmp_pm_shutdown_scope {
    pub subtype: enum zynqmp_pm_shutdown_subtype,
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_clear_pm_state(dev: *mut device) -> c_int {
...
// Clear PM specific data in EL3 firmware
    ret = zynqmp_pm_invoke_fn(TF_A_CLEAR_PM_STATE, core::ptr::null_mut(), 0);
    if (ret)
    dev_err(dev,
...
#[no_mangle]
unsafe extern "C" fn zynqmp_firmware_probe(pdev: *mut platform_device) -> c_int {
...
// Check trustzone version number
    ...
    ARRAY_SIZE(firmware_devs), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_firmware_shutdown(pdev: *mut platform_device) {
    static void zynqmp_firmware_shutdown(struct platform_device *pdev)
    {
    zynqmp_clear_pm_state(&pdev.dev);
    }
#[no_mangle]
unsafe extern "C" fn zynqmp_firmware_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_firmware_sync_state(dev: *mut device) {
