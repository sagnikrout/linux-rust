...
//! Source: drivers/firmware/imx/sm-misc.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn scmi_imx_misc_ctrl_set(id: u32, val: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn scmi_imx_misc_ctrl_get(id: u32, num: *mut u32, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn syslog_show(file: *mut seq_file, priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_imx_misc_put(p: *mut c_void) {
    static void scmi_imx_misc_put(void *p)
    {
    debugfs_remove((struct dentry *)p);
    }
#[no_mangle]
unsafe extern "C" fn scmi_imx_misc_get_reason(sdev: *mut scmi_device) -> c_int {
    ...
    ret = imx_misc_ctrl_ops.misc_reset_reason(ph, system, &boot, &shutdown, core::ptr::null_mut());
    if (!ret) {
    if (boot.valid)
...
#[no_mangle]
unsafe extern "C" fn scmi_imx_misc_ctrl_probe(sdev: *mut scmi_device) -> c_int {
