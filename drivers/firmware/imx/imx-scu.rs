...
//! Source: drivers/firmware/imx/imx-scu.c
#![no_std]
...
pub const SCU_MU_CHAN_NUM: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn imx_scu_free_mbox_chan(data: *mut c_void) {
    static void imx_scu_free_mbox_chan(void *data)
    {
    mbox_free_channel(data);
    }
#[no_mangle]
unsafe extern "C" fn imx_scu_clear_handle(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn imx_sc_to_linux_errno(errno: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn imx_scu_get_handle(ipc: *mut imx_sc_ipc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_scu_tx_done(cl: *mut mbox_client, mssg: *mut c_void, r: c_int) {
...
#[no_mangle]
unsafe extern "C" fn imx_scu_rx_callback(c: *mut mbox_client, msg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn imx_scu_ipc_write(sc_ipc: *mut imx_sc_ipc, msg: *mut c_void) -> c_int {
    static int imx_scu_ipc_write(struct imx_sc_ipc *sc_ipc, void *msg)
    {
    let mut hdr: imx_sc_rpc_msg = *(struct imx_sc_rpc_msg *)msg;
...
//
#[no_mangle]
pub unsafe extern "C" fn imx_scu_call_rpc(sc_ipc: *mut imx_sc_ipc, msg: *mut c_void, have_resp: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_scu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_scu_driver_init() -> int __init {
