...
//! Source: drivers/firmware/stratix10-svc.c
#![no_std]
...
//
pub const SVC_NUM_DATA_IN_FIFO: c_int = 8;
pub const SVC_NUM_CHANNEL: c_int = 4;
pub const FPGA_CONFIG_DATA_CLAIM_TIMEOUT_MS: c_int = 2000;
pub const FPGA_CONFIG_STATUS_TIMEOUT_SEC: c_int = 30;
pub const BYTE_TO_WORD_SIZE: c_int = 4;
// stratix10 service layer clients

// Maximum number of SDM client IDs.
pub const MAX_SDM_CLIENT_IDS: c_int = 16;
// Client ID for SIP Service Version 1.
pub const SIP_SVC_V1_CLIENT_ID: c_uint = 0x1;
// Maximum number of SDM job IDs.
pub const MAX_SDM_JOB_IDS: c_int = 16;
// Number of bits used for asynchronous transaction hashing.
pub const ASYNC_TRX_HASH_BITS: c_int = 3;
//
...
pub const ASYNC_ATF_MINIMUM_MAJOR_VERSION: c_uint = 0x3;
// Minimum minor version of the ATF for Asynchronous transactions.
pub const ASYNC_ATF_MINIMUM_MINOR_VERSION: c_uint = 0x0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stratix10_svc {
    pub stratix10_svc_rsu: *mut platform_device,
    pub stratix10_svc_hwmon: *mut platform_device,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stratix10_svc_sh_memory {
    pub sync_complete: completion,
    pub addr: c_ulong,
    pub size: c_ulong,
    pub invoke_fn: *mut svc_invoke_fn,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stratix10_svc_data_mem {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stratix10_svc_data {
    pub chan: *mut stratix10_svc_chan,
    pub paddr: phys_addr_t,
    pub size: usize,
    pub paddr_output: phys_addr_t,
    pub size_output: usize,
    pub command: u32,
    pub flag: u32,
    pub arg: [u64; 3],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stratix10_svc_async_handler {
    pub transaction_id: u8,
    pub achan: *mut stratix10_async_chan,
    pub cb_arg: *mut c_void,
    pub cb: async_callback_t,
    pub msg: *mut stratix10_svc_client_msg,
    pub next: hlist_node,
    pub res: arm_smccc_1_2_regs,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stratix10_async_chan {
    pub async_client_id: c_ulong,
    pub job_id_pool: ida,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stratix10_async_ctrl {
    pub supported: bool,
    pub initialized: bool,
    void (*invoke_fn)(struct stratix10_async_ctrl *actrl,
    const struct arm_smccc_1_2_regs *args,
    pub res): *mut arm_smccc_1_2_regs,
    pub async_id_pool: ida,
    pub common_achan_refcount: core::sync::atomic::AtomicI32,
    pub common_async_chan: *mut stratix10_async_chan,
// spinlock to protect trx_list hash table
    pub trx_list_lock: spinlock_t,
    pub ASYNC_TRX_HASH_BITS): DECLARE_HASHTABLE(trx_list,,
}
...
pub struct stratix10_svc_chan {
    pub ctrl: *mut stratix10_svc_controller,
    pub scl: *mut stratix10_svc_client,
    pub name: *mut c_char,
    pub task: *mut task_struct,
    pub svc_fifo: kfifo,
    pub svc_fifo_lock: spinlock_t,
    pub lock: spinlock_t,
    pub async_chan: *mut stratix10_async_chan,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stratix10_svc_controller {
    pub dev: *mut device,
    pub num_chans: c_int,
    pub num_active_client: c_int,
    pub node: list_head,
    pub genpool: *mut gen_pool,
    pub complete_status: completion,
    pub invoke_fn: *mut svc_invoke_fn,
    pub svc: *mut stratix10_svc,
    pub sdm_lock: mutex,
    pub actrl: stratix10_async_ctrl,
    pub __counted_by(num_chans): stratix10_svc_chan chans[],
}
...
//
    ...
    svc_pa_to_va(res.a2) : core::ptr::null_mut();
    cb_data.kaddr3 = (res.a3) ?
    svc_pa_to_va(res.a3) : core::ptr::null_mut();
...
//
    ...
    cb_data.kaddr1 = core::ptr::null_mut();
    cb_data.kaddr2 = core::ptr::null_mut();
    cb_data.kaddr3 = core::ptr::null_mut();
...
//
    ...
    cb_data.kaddr2 = (res.a2) ?
    svc_pa_to_va(res.a2) : core::ptr::null_mut();
    cb_data.kaddr3 = (res.a3) ? &res.a3 : core::ptr::null_mut();
    } else {
...
//
#[no_mangle]
unsafe extern "C" fn svc_normal_to_secure_thread(data: *mut c_void) -> c_int {
    static int svc_normal_to_secure_thread(void *data)
    {
    struct stratix10_svc_chan *chan = (struct stratix10_svc_chan *)data;
    struct stratix10_svc_controller *ctrl = chan.ctrl;
    struct stratix10_svc_data *pdata = core::ptr::null_mut();
    struct stratix10_svc_cb_data *cbdata = core::ptr::null_mut();
    struct arm_smccc_res res;
    let mut res12: arm_smccc_1_2_regs = { 0 };
    unsigned long a0, a1, a2, a3, a4, a5, a6, a7;
    let mut ret_fifo: c_int = 0;
...
// item already dequeued; notify client to unblock it
    ...
    cbdata.kaddr1 = core::ptr::null_mut();
    cbdata.kaddr2 = core::ptr::null_mut();
    cbdata.kaddr3 = core::ptr::null_mut();
    if (pdata.chan.scl)
...
// for polling
    ...
    let mut args12: arm_smccc_1_2_regs = { 0 };
...
// for FCS
    ...
    svc_pa_to_va(res.a2) : core::ptr::null_mut();
    cbdata.kaddr3 = (res.a3) ? &res.a3 : core::ptr::null_mut();
    }
    pdata.chan.scl.receive_cb(pdata.chan.scl, cbdata);
    break;
    default:
...
//
#[no_mangle]
unsafe extern "C" fn svc_normal_to_secure_shm_thread(data: *mut c_void) -> c_int {
...
//
    ...
    let mut min_alloc_order: c_int = 3;
    int ret;
    ...
    gen_pool_set_algo(genpool, gen_pool_best_fit, core::ptr::null_mut());
...
//
    ...
    struct stratix10_svc_chan *chan = core::ptr::null_mut();
    unsigned long flag;
    int i;
...
//
#[no_mangle]
pub unsafe extern "C" fn stratix10_svc_remove_async_client(chan: *mut stratix10_svc_chan) -> c_int {
    ...
    kfree(achan);
    actrl.common_async_chan = core::ptr::null_mut();
    }
    } else {
    ida_destroy(&achan.job_id_pool);
    ...
    chan.async_chan = core::ptr::null_mut();
    return 0;
    }
...
//
    ...
    {
    let mut args: arm_smccc_1_2_regs = { 0 }, res = { 0 };
    struct stratix10_svc_async_handler *handle = core::ptr::null_mut();
...
//
    ...
    {
    struct stratix10_svc_async_handler *handle;
    let mut args: arm_smccc_1_2_regs = { 0 };
    struct stratix10_svc_controller *ctrl;
    struct stratix10_async_ctrl *actrl;
    struct stratix10_async_chan *achan;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn stratix10_svc_async_done(chan: *mut stratix10_svc_chan, tx_handle: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stratix10_svc_async_init(controller: *mut stratix10_svc_controller) -> c_int {
...
//
    ...
    actrl.invoke_fn = core::ptr::null_mut();
    return -EADDRINUSE;
    }
...
//
#[no_mangle]
unsafe extern "C" fn stratix10_svc_async_exit(ctrl: *mut stratix10_svc_controller) -> c_int {
    ...
    ctrl.chans[i].async_chan = core::ptr::null_mut();
    }
    }
    ida_destroy(&actrl.async_id_pool);
    actrl.invoke_fn = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn stratix10_svc_free_channel(chan: *mut stratix10_svc_chan) {
    void stratix10_svc_free_channel(struct stratix10_svc_chan *chan)
    {
    unsigned long flag;
    spin_lock_irqsave(&chan.lock, flag);
    chan.scl = core::ptr::null_mut();
    chan.ctrl.num_active_client--;
...
//
#[no_mangle]
pub unsafe extern "C" fn stratix10_svc_send(chan: *mut stratix10_svc_chan, msg: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn stratix10_svc_done(chan: *mut stratix10_svc_chan) {
...
//
    ...
    let mut s: usize = roundup(size, 1 << genpool.min_alloc_order);
...
//
#[no_mangle]
pub unsafe extern "C" fn stratix10_svc_free_memory(chan: *mut stratix10_svc_chan, kaddr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn stratix10_svc_drv_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct gen_pool *genpool;
    struct stratix10_svc_sh_memory *sh_memory;
    struct stratix10_svc *svc = core::ptr::null_mut();
...
// allocate service controller and supporting channel
    ...
    for (i = 0; i < SVC_NUM_CHANNEL; i++) {
    controller.chans[i].scl = core::ptr::null_mut();
...
// add svc client device(s)
    ...
    svc.stratix10_svc_hwmon = core::ptr::null_mut();
    }
    }
    }
...
#[no_mangle]
unsafe extern "C" fn stratix10_svc_drv_remove(pdev: *mut platform_device) {
    ...
    ctrl.chans[i].task = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn stratix10_svc_init() -> int __init {
    static int __init stratix10_svc_init(void)
    {
    struct device_node *fw_np;
    struct device_node *np;
    int ret;
    fw_np = of_find_node_by_name(core::ptr::null_mut(), "firmware");
    if (!fw_np)
    return -ENODEV;
    ...
    return -ENODEV;
    of_node_put(np);
    ret = of_platform_populate(fw_np, stratix10_svc_drv_match, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret)
    return ret;
    return platform_driver_register(&stratix10_svc_driver);
    }
#[no_mangle]
unsafe extern "C" fn stratix10_svc_exit() -> void __exit {
