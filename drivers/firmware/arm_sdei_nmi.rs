...
//! Source: drivers/firmware/arm_sdei_nmi.c
#![no_std]
...
pub const SDEI_NMI_EVENT: c_int = 0;
//
...
#[no_mangle]
unsafe extern "C" fn sdei_nmi_handler(event: u32, regs: *mut pt_regs, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdei_nmi_fire(target_cpu: c_uint) {
    static void sdei_nmi_fire(unsigned int target_cpu)
    {
    let mut err: c_int = sdei_event_signal(SDEI_NMI_EVENT, cpu_logical_map(target_cpu));
    if (err)
...
//
#[no_mangle]
unsafe extern "C" fn sdei_nmi_raise_backtrace(mask: *mut cpumask_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sdei_nmi_trigger_cpumask_backtrace(mask: *const cpumask_t, exclude_cpu: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn sdei_nmi_active() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn sdei_nmi_stop_cpus(mask: *const cpumask_t) {
...
//
#[no_mangle]
unsafe extern "C" fn sdei_nmi_init() -> int __init {
