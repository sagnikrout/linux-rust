...
//! Source: drivers/firmware/raspberrypi.c
#![no_std]
...
pub const MBOX_CHAN_PROPERTY: c_int = 8;
...
pub struct rpi_firmware {
    pub cl: mbox_client,
    pub /: *mut *mut *mut mbox_chan chan; / The property channel.,
    pub c: completion,
    pub enabled: u32,
    pub consumers: kref,
}
...
#[no_mangle]
unsafe extern "C" fn response_callback(cl: *mut mbox_client, msg: *mut c_void) {
...
//
    ...
    {
    let mut message: u32 = MBOX_MSG(chan, data);
    int ret;
    WARN_ON(data & 0xf);
...
//
    ...
    {
    let mut size: usize = tag_size + 12;
    u32 *buf;
    dma_addr_t bus_addr;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rpi_register_clk_driver(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn rpi_firmware_clk_get_max_rate(fw: *mut rpi_firmware, id: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn rpi_firmware_put(fw: *mut rpi_firmware) {
...
#[no_mangle]
unsafe extern "C" fn devm_rpi_firmware_put(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rpi_firmware_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    if (IS_ERR(fw.chan)) {
    let mut ret: c_int = PTR_ERR(fw.chan);
    kfree(fw);
...
unsafe extern "C" fn rpi_firmware_shutdown(pdev: *mut platform_device) {
    ...
    if (!fw)
    return;
    rpi_firmware_property(fw, RPI_FIRMWARE_NOTIFY_REBOOT, core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn rpi_firmware_remove(pdev: *mut platform_device) {
    ...
    rpi_hwmon = core::ptr::null_mut();
    platform_device_unregister(rpi_clk);
    rpi_clk = core::ptr::null_mut();
    rpi_firmware_put(fw);
    }
    ...
    {
    return of_find_matching_node(core::ptr::null_mut(), rpi_firmware_of_match);
    }
