...
//! Source: drivers/firmware/arm_scmi/sensors.c
#![no_std]
...
pub const SCMI_MAX_NUM_SENSOR_AXIS: c_int = 63;
pub const SCMIv2_SENSOR_PROTOCOL: c_uint = 0x10000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_resp_sensor_attributes {
    pub num_sensors: __le16,
    pub max_requests: u8,
    pub reserved: u8,
    pub reg_addr_low: __le32,
    pub reg_addr_high: __le32,
    pub reg_size: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_resp_attrs {
    pub min_range_low: __le32,
    pub min_range_high: __le32,
    pub max_range_low: __le32,
    pub max_range_high: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_sensor_description {
    pub desc_index: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_resp_sensor_description {
    pub num_returned: __le16,
    pub num_remaining: __le16,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_sensor_descriptor {
    pub id: __le32,
...
// only for version > 2.0
    pub power: __le32,
    pub resolution: __le32,
    pub scalar_attrs: scmi_msg_resp_attrs,
    pub desc: [}; ],
}

// Base scmi_sensor_descriptor size excluding extended attrs after name
pub const SCMI_MSG_RESP_SENS_DESCR_BASE_SZ: c_int = 28;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_sensor_axis_description_get {
    pub id: __le32,
    pub axis_desc_index: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_resp_sensor_axis_description {
    pub num_axis_flags: __le32,

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_axis_descriptor {
    pub id: __le32,
    pub attributes_low: __le32,
    ...
    pub name: [u8; SCMI_SHORT_NAME_MAX_SIZE],
    pub resolution: __le32,
    pub attrs: scmi_msg_resp_attrs,
    pub desc: [}; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_resp_sensor_axis_names_description {
    pub num_axis_flags: __le32,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_sensor_axis_name_descriptor {
    pub axis_id: __le32,
...
pub const SCMI_MSG_RESP_AXIS_DESCR_BASE_SZ: c_int = 28;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_sensor_list_update_intervals {
    pub id: __le32,
    pub index: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_resp_sensor_list_update_intervals {
    pub num_intervals_flags: __le32,
    pub intervals: [__le32; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_sensor_request_notify {
    pub id: __le32,
    pub event_control: __le32,

}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_set_sensor_trip_point {
    pub id: __le32,
    pub event_control: __le32,

pub const SENSOR_TP_DISABLED: c_uint = 0x0;
pub const SENSOR_TP_POSITIVE: c_uint = 0x1;
pub const SENSOR_TP_NEGATIVE: c_uint = 0x2;
pub const SENSOR_TP_BOTH: c_uint = 0x3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_sensor_config_set {
    pub id: __le32,
    pub sensor_config: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_sensor_reading_get {
    pub id: __le32,
    pub flags: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_resp_sensor_reading_complete {
    pub id: __le32,
    pub readings_low: __le32,
    pub readings_high: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_sensor_reading_resp {
    pub sensor_value_low: __le32,
    pub sensor_value_high: __le32,
    pub timestamp_low: __le32,
    pub timestamp_high: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_resp_sensor_reading_complete_v3 {
    pub id: __le32,
    pub readings: [scmi_sensor_reading_resp; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_sensor_trip_notify_payld {
    pub agent_id: __le32,
    pub sensor_id: __le32,
    pub trip_point_desc: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_sensor_update_notify_payld {
    pub agent_id: __le32,
    pub sensor_id: __le32,
    pub readings: [scmi_sensor_reading_resp; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sensors_info {
    pub notify_trip_point_cmd: bool,
    pub notify_continuos_update_cmd: bool,
    pub num_sensors: c_int,
    pub max_requests: c_int,
    pub reg_addr: u64,
    pub reg_size: u32,
    pub sensors: *mut scmi_sensor_info,
}
    ...
    SENSOR_TRIP_POINT_NOTIFY, core::ptr::null_mut()))
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_apriv {
    pub any_axes_support_extended_names: bool,
    pub s: *mut scmi_sensor_info,
}
...
// Set the number of sensors to be skipped/already read
    ...
    let mut dsize: usize = SCMI_MSG_RESP_AXIS_DESCR_BASE_SZ;
    ...
    if (a.extended_attrs) {
    let mut ares: c_uint = le32_to_cpu(adesc.resolution);
    ...
    let mut axis_id: u32 = le32_to_cpu(adesc.axis_id);
...
//
    ...
    let mut ret: c_int = 0;
    u32 attrh, attrl;
    let mut dsize: usize = SCMI_MSG_RESP_SENS_DESCR_BASE_SZ;
    struct scmi_sensor_info *s;
...
//
    ...
    core::ptr::null_mut(), s.name, SCMI_MAX_STR_SIZE);
    if (s.extended_scalar_attrs) {
    s.sensor_power = le32_to_cpu(sdesc.power);
    dsize += sizeof(sdesc.power);
// Only for sensors reporting scalar values
    if (s.num_axis == 0) {
    let mut sres: c_uint = le32_to_cpu(sdesc.resolution);
    ...
    {
    int ret;
    let mut evt_cntl: u32 = enable ? SENSOR_NOTIFY_ALL : 0;
    struct scmi_xfer *t;
    ...
    {
    int ret;
    let mut evt_cntl: u32 = SENSOR_TP_BOTH;
    struct scmi_xfer *t;
...
#[no_mangle]
unsafe extern "C" fn scmi_sensor_count_get(ph: *const scmi_protocol_handle) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(SCMI_EVENT_SENSOR_UPDATE: evt_id ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn scmi_sensor_get_num_sources(ph: *const scmi_protocol_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_sensors_protocol_init(ph: *const scmi_protocol_handle) -> c_int {
