...
//! Source: drivers/firmware/arm_scmi/base.c
#![no_std]
...
pub const SCMI_BASE_NUM_SOURCES: c_int = 1;
pub const SCMI_BASE_MAX_CMD_ERR_COUNT: c_int = 1024;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_resp_base_attributes {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_resp_base_discover_agent {
    pub agent_id: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_base_error_notify {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_base_error_notify_payld {
    pub agent_id: __le32,
    pub error_status: __le32,
    pub msg_reports: [__le64; SCMI_BASE_MAX_CMD_ERR_COUNT],
}
...
//
#[no_mangle]
unsafe extern "C" fn scmi_base_attributes_get(ph: *const scmi_protocol_handle) -> c_int {
...
//
    ...
    let mut tot_num_ret: u32 = 0, loop_num_ret;
...
//
    ...
    {
    int ret;
    let mut evt_cntl: u32 = enable ? BASE_TP_NOTIFY_ALL : 0;
    struct scmi_xfer *t;
...
#[no_mangle]
unsafe extern "C" fn scmi_base_protocol_init(ph: *const scmi_protocol_handle) -> c_int {
