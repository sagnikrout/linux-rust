...
//! Source: drivers/firmware/arm_scmi/powercap.c
#![no_std]
...
pub const SCMI_PROTOCOL_SUPPORTED_VERSION: c_uint = 0x20000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_resp_powercap_domain_attributes {
    ...
    pub max_pai: __le32,
    pub pai_step: __le32,
    pub min_power_cap: __le32,
    pub max_power_cap: __le32,
    pub power_cap_step: __le32,
    pub sustainable_power: __le32,
    pub accuracy: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_powercap_set_cap_or_pai {
    pub domain: __le32,
    pub flags: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_resp_powercap_cap_set_complete {
    pub domain: __le32,
    pub power_cap: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_resp_powercap_meas_get {
    pub power: __le32,
    pub pai: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_powercap_notify_cap {
    pub domain: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_powercap_notify_thresh {
    pub domain: __le32,
    pub notify_enable: __le32,
    pub power_thresh_low: __le32,
    pub power_thresh_high: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_powercap_cap_changed_notify_payld {
    pub agent_id: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_powercap_meas_changed_notify_payld {
    pub agent_id: __le32,
    pub domain_id: __le32,
    pub power: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_powercap_state {
    pub enabled: bool,
    pub last_pcap: u32,
    pub meas_notif_enabled: bool,
    pub thresholds: u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct powercap_info {
    pub num_domains: c_int,
    pub notify_cap_cmd: bool,
    pub notify_measurements_cmd: bool,
    pub states: *mut scmi_powercap_state,
    pub powercaps: *mut scmi_powercap_info,
}
    ...
    POWERCAP_CAP_NOTIFY, core::ptr::null_mut()))
...
#[no_mangle]
unsafe extern "C" fn scmi_powercap_num_domains_get(ph: *const scmi_protocol_handle) -> c_int {
...
// Update internal state with current real platform state
    ...
    &fc[POWERCAP_FC_CAP].get_addr, core::ptr::null_mut(),
    &fc[POWERCAP_FC_CAP].rate_limit);
    ph.hops.fastchannel_init(ph, POWERCAP_DESCRIBE_FASTCHANNEL,
    ...
    &fc[POWERCAP_FC_PAI].get_addr, core::ptr::null_mut(),
    &fc[POWERCAP_FC_PAI].rate_limit);
// p_fc = fc;
    }
    static int scmi_powercap_notify(const struct scmi_protocol_handle *ph,
...
#[no_mangle]
pub unsafe extern "C" fn if(SCMI_EVENT_POWERCAP_MEASUREMENTS_CHANGED: evt_id ==) -> else {
    ...
    evt_id, src_id, ret);
#[no_mangle]
pub unsafe extern "C" fn if(POWERCAP_MEASUREMENTS_NOTIFY: cmd_id ==) -> else {
