...
//! Source: drivers/firmware/arm_scmi/vendors/imx/imx-sm-bbm.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_imx_bbm_protocol_attributes {
    pub attributes: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_bbm_set_time {
    pub id: __le32,
    pub flags: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_bbm_get_time {
    pub id: __le32,
    pub flags: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_bbm_alarm_time {
    pub id: __le32,
    pub flags: __le32,
    pub value_low: __le32,
    pub value_high: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_imx_bbm_rtc_notify {
    pub rtc_id: __le32,
    pub flags: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_imx_bbm_button_notify {
    pub flags: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_bbm_notify_payld {
    pub flags: __le32,
}
...
#[no_mangle]
unsafe extern "C" fn scmi_imx_bbm_button_get(ph: *const scmi_protocol_handle, state: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_imx_bbm_protocol_init(ph: *const scmi_protocol_handle) -> c_int {
