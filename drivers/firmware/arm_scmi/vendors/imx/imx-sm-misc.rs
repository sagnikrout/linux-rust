...
//! Source: drivers/firmware/arm_scmi/vendors/imx/imx-sm-misc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_imx_misc_protocol_attributes {
    pub attributes: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_misc_ctrl_set_in {
    pub id: __le32,
    pub num: __le32,
    pub value: [__le32; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_misc_ctrl_notify_in {
    pub ctrl_id: __le32,
    pub flags: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_misc_ctrl_notify_payld {
    pub ctrl_id: __le32,
    pub flags: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_misc_ctrl_get_out {
    pub num: __le32,
    pub val: [__le32; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_misc_buildinfo_out {
    pub buildnum: __le32,
    pub buildcommit: __le32,
pub const MISC_MAX_BUILDDATE: c_int = 16;
    pub builddate: [u8; MISC_MAX_BUILDDATE],
pub const MISC_MAX_BUILDTIME: c_int = 16;
    pub buildtime: [u8; MISC_MAX_BUILDTIME],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_misc_board_info_out {
    pub attributes: __le32,
pub const MISC_MAX_BRDNAME: c_int = 16;
    pub brdname: [u8; MISC_MAX_BRDNAME],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_misc_cfg_info_out {
    pub msel: __le32,
pub const MISC_MAX_CFGNAME: c_int = 16;
    pub cfgname: [u8; MISC_MAX_CFGNAME],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_misc_reset_reason_in {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_misc_reset_reason_out {
// Boot reason flags

pub const MISC_BOOT_FLAG_O_SHIFT: c_int = 24;

pub const MISC_BOOT_FLAG_E_SHIFT: c_int = 8;

    pub b_flags: __le32,
// Shutdown reason flags

pub const MISC_SHUTDOWN_FLAG_O_SHIFT: c_int = 24;

pub const MISC_SHUTDOWN_FLAG_E_SHIFT: c_int = 8;

    pub s_flags: __le32,
// Array of extended info words
    pub extinfo: [__le32; MISC_EXT_INFO_LEN_MAX],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_misc_syslog_in {
    pub flags: __le32,
    pub index: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_misc_syslog_out {
    pub numlogflags: __le32,
    pub syslog: [__le32; ],
}
...
// src_id = r->ctrl_id;
    ...
    let mut max_num: c_int = (max_msg_size - sizeof(*out)) / sizeof(__le32);
    ret = scmi_imx_misc_ctrl_validate_id(ph, ctrl_id);
    if (ret)
    return ret;
...
// num * sizeof(__le32) > t->rx.len - sizeof(__le32)) {
    ...
    int ret, i;
    let mut max_msg_size: c_int = ph.hops.get_max_msg_size(ph);
    let mut max_num: c_int = (max_msg_size - sizeof(*in)) / sizeof(__le32);
    ret = scmi_imx_misc_ctrl_validate_id(ph, ctrl_id);
    if (ret)
    return ret;
    if (num > max_num)
...
#[no_mangle]
unsafe extern "C" fn scmi_imx_misc_build_info_discover(ph: *const scmi_protocol_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_imx_misc_board_info(ph: *const scmi_protocol_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_imx_misc_cfg_info_get(ph: *const scmi_protocol_handle) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_imx_misc_syslog_ipriv {
    pub array: *mut u32,
    pub size: *mut u16,
}
...
#[no_mangle]
unsafe extern "C" fn scmi_imx_misc_protocol_init(ph: *const scmi_protocol_handle) -> c_int {
