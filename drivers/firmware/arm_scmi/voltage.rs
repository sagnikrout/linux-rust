...
//! Source: drivers/firmware/arm_scmi/voltage.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_resp_domain_attributes {
    pub attr: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_cmd_describe_levels {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_resp_describe_levels {
    pub flags: __le32,
    pub voltage: [__le32; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_cmd_config_set {
    pub domain_id: __le32,
    pub config: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_cmd_level_set {
    pub domain_id: __le32,
    pub flags: __le32,
    pub voltage_level: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_resp_voltage_level_set_complete {
    pub domain_id: __le32,
    pub voltage_level: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct voltage_info {
    pub num_domains: c_uint,
    pub domains: *mut scmi_voltage_info,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_volt_ipriv {
    pub dev: *mut device,
    pub v: *mut scmi_voltage_info,
}
...
#[no_mangle]
unsafe extern "C" fn scmi_voltage_domains_num_get(ph: *const scmi_protocol_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_voltage_protocol_init(ph: *const scmi_protocol_handle) -> c_int {
