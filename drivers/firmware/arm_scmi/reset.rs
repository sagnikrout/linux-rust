...
//! Source: drivers/firmware/arm_scmi/reset.c
#![no_std]
...
pub const NUM_RESET_DOMAIN_MASK: c_uint = 0xffff;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_resp_reset_domain_attributes {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_reset_domain_reset {
    pub domain_id: __le32,
    pub flags: __le32,

    pub reset_state: __le32,
pub const ARCH_COLD_RESET: c_int = 0;
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_msg_reset_notify {
    pub id: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_reset_issued_notify_payld {
    pub agent_id: __le32,
    pub domain_id: __le32,
    pub reset_state: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_reset_info {
    pub num_domains: c_int,
    pub notify_reset_cmd: bool,
    pub dom_info: *mut reset_dom_info,
}
    ...
    if (!ret)
    if (!ph.hops.protocol_msg_check(ph, RESET_NOTIFY, core::ptr::null_mut()))
...
//
    ...
    core::ptr::null_mut(), dom_info.name,
    SCMI_MAX_STR_SIZE);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn scmi_reset_num_domains_get(ph: *const scmi_protocol_handle) -> c_int {
    ...
    {
    int ret;
    let mut evt_cntl: u32 = enable ? RESET_TP_NOTIFY_ALL : 0;
    struct scmi_xfer *t;
...
#[no_mangle]
unsafe extern "C" fn scmi_reset_get_num_sources(ph: *const scmi_protocol_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_reset_protocol_init(ph: *const scmi_protocol_handle) -> c_int {
