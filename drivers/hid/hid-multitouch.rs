...
//! Source: drivers/hid/hid-multitouch.c
#![no_std]
...
pub const MT_INPUTMODE_TOUCHSCREEN: c_uint = 0x02;
pub const MT_INPUTMODE_TOUCHPAD: c_uint = 0x03;
pub const MT_BUTTONTYPE_CLICKPAD: c_int = 0;
pub const MT_BUTTONTYPE_PRESSUREPAD: c_int = 1;
    enum latency_mode {
...
pub const MT_IO_FLAGS_RUNNING: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt_usages {
    pub list: list_head,
    pub a: *mut *mut *mut *mut *mut *mut *mut *mut __s32 x, y, cx, cy, p, w, h,,
    pub /: *mut *mut *mut __s32 contactid; / the device ContactID assigned to this slot,
    pub /: *mut *mut *mut bool tip_state; / is the touch valid?,
    pub /: *mut *mut *mut bool inrange_state; / is the finger in proximity of the sensor?,
    pub /: *mut *mut *mut bool confidence_state; / is the touch made by a finger?,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt_application {
    pub list: list_head,
    pub application: c_uint,
    pub report_id: c_uint,
    pub /: *mut *mut list_head mt_usages; / mt usages list,
    pub quirks: __s32,
    pub /: *mut *mut *mut __s32 scantime; / scantime reported,
    pub /: *mut *mut __s32 scantime_logical_max; / max value for raw scantime,
    pub /: *mut *mut *mut __s32 raw_cc; / contact count in the report,
    pub /: *mut *mut int left_button_state; / left button state,
    pub /: *mut *mut unsigned int mt_flags; / flags to pass to input-mt,
    pub palm: *mut *mut *mut unsigned long pending_palm_slots; / slots where we reported,
// and need to release
    pub /: *mut *mut __u8 num_received; / how many contacts we received,
    pub /: *mut *mut __u8 num_expected; / expected last contact index,
    pub /: *mut *mut __u8 buttons_count; / number of physical buttons per touchpad,
    pub report:: *mut *mut __u8 touches_by_report; / how many touches are present in one,
// 1 means we should use a serial protocol
// > 1 means hybrid (multitouch) protocol
//
    pub /: *mut *mut unsigned long jiffies; / the frame's jiffies,
    pub /: *mut *mut int timestamp; / the timestamp to be sent,
    pub /: *mut *mut int prev_scantime; / scantime reported previously,
    pub have_contact_count: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt_class {
    pub /: *mut *mut __s32 name; / MT_CLS,
    pub quirks: __s32,
    pub /: *mut *mut __s32 sn_move; / Signal/noise ratio for move events,
    pub /: *mut *mut __s32 sn_width; / Signal/noise ratio for width events,
    pub /: *mut *mut __s32 sn_height; / Signal/noise ratio for height events,
    pub /: *mut *mut __s32 sn_pressure; / Signal/noise ratio for pressure events,
    pub maxcontacts: __u8,
    pub /: *mut *mut bool is_indirect; / true for touchpads,
    pub /: *mut *mut bool export_all_inputs; / do not ignore mouse, keyboards, etc...,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt_report_data {
    pub list: list_head,
    pub report: *mut hid_report,
    pub application: *mut mt_application,
    pub is_mt_collection: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt_device {
    pub /: *mut *mut mt_class mtclass; / our mt device class,
    pub /: *mut *mut timer_list release_timer; / to release sticky fingers,
    pub /: *mut *mut *mut hid_haptic_device haptic; / haptic related configuration,
    pub /: *mut *mut *mut hid_device hdev; / hid_device we're attached to,
    pub /: *mut *mut unsigned long mt_io_flags; / mt flags (MT_IO_FLAGS_RUNNING),
    pub active: *mut *mut *mut unsigned long active_slots; / bitmap of slots with an,
// contact, sized for maxcontacts
//
    pub /: *mut *mut __u8 inputmode_value; / InputMode HID feature value,
    pub maxcontacts: __u8,
    pub /: *mut *mut bool is_buttonpad; / is this device a button pad?,
    pub /: *mut *mut bool is_pressurepad; / is this device a pressurepad?,
    pub /: *mut *mut bool is_haptic_touchpad; / is this device a haptic touchpad?,
    pub /: *mut *mut bool serial_maybe; / need to check for serial protocol,
    pub applications: list_head,
    pub reports: list_head,
}
...
pub const MT_CLS_DEFAULT: c_uint = 0x0001;
pub const MT_CLS_SERIAL: c_uint = 0x0002;
pub const MT_CLS_CONFIDENCE: c_uint = 0x0003;
pub const MT_CLS_CONFIDENCE_CONTACT_ID: c_uint = 0x0004;
pub const MT_CLS_CONFIDENCE_MINUS_ONE: c_uint = 0x0005;
pub const MT_CLS_DUAL_INRANGE_CONTACTID: c_uint = 0x0006;
pub const MT_CLS_DUAL_INRANGE_CONTACTNUMBER: c_uint = 0x0007;
// reserved					0x0008
pub const MT_CLS_INRANGE_CONTACTNUMBER: c_uint = 0x0009;
pub const MT_CLS_NSMU: c_uint = 0x000a;
// reserved					0x0010
// reserved					0x0011
pub const MT_CLS_WIN_8: c_uint = 0x0012;
pub const MT_CLS_EXPORT_ALL_INPUTS: c_uint = 0x0013;
// reserved					0x0014
pub const MT_CLS_WIN_8_FORCE_MULTI_INPUT: c_uint = 0x0015;
pub const MT_CLS_WIN_8_DISABLE_WAKEUP: c_uint = 0x0016;
pub const MT_CLS_WIN_8_NO_STICKY_FINGERS: c_uint = 0x0017;
pub const MT_CLS_WIN_8_FORCE_MULTI_INPUT_NSMU: c_uint = 0x0018;
pub const MT_CLS_WIN_8_KEEP_LATENCY_ON_CLOSE: c_uint = 0x0019;
// vendor specific classes
pub const MT_CLS_3M: c_uint = 0x0101;
// reserved					0x0102
pub const MT_CLS_EGALAX: c_uint = 0x0103;
pub const MT_CLS_EGALAX_SERIAL: c_uint = 0x0104;
pub const MT_CLS_TOPSEED: c_uint = 0x0105;
pub const MT_CLS_PANASONIC: c_uint = 0x0106;
pub const MT_CLS_FLATFROG: c_uint = 0x0107;
pub const MT_CLS_GENERALTOUCH_TWOFINGERS: c_uint = 0x0108;
pub const MT_CLS_GENERALTOUCH_PWT_TENFINGERS: c_uint = 0x0109;
pub const MT_CLS_LG: c_uint = 0x010a;
pub const MT_CLS_ASUS: c_uint = 0x010b;
pub const MT_CLS_VTL: c_uint = 0x0110;
pub const MT_CLS_GOOGLE: c_uint = 0x0111;
pub const MT_CLS_RAZER_BLADE_STEALTH: c_uint = 0x0112;
pub const MT_CLS_SMART_TECH: c_uint = 0x0113;
pub const MT_CLS_APPLE_TOUCHBAR: c_uint = 0x0114;
pub const MT_CLS_YOGABOOK9I: c_uint = 0x0115;
pub const MT_CLS_EGALAX_P80H84: c_uint = 0x0116;
pub const MT_CLS_SIS: c_uint = 0x0457;
pub const MT_DEFAULT_MAXCONTACT: c_int = 10;
pub const MT_MAX_MAXCONTACT: c_int = 250;
//
// Resync device and local timestamps after that many microseconds without
// receiving data.
//
pub const MAX_TIMESTAMP_INTERVAL: c_int = 1000000;
...
#[no_mangle]
unsafe extern "C" fn mt_get_feature(hdev: *mut hid_device, report: *mut hid_report) {
    static void mt_get_feature(struct hid_device *hdev, struct hid_report *report)
    {
    int ret;
    let mut size: u32 = hid_report_len(report);
    u8 *buf;
//
...
// Retrieve the Win8 blob once to enable some devices
    ...
    {
    let mut fmin: c_int = field.logical_minimum;
    let mut fmax: c_int = field.logical_maximum;
    let mut fuzz: c_int = snratio ? (fmax - fmin) / snratio : 0;
...
// set some defaults so we do not need to check for null pointers
    ...
    {
    let mut application: c_uint = report.application;
...
//
    ...
    {
    let mut application: c_uint = report.application;
    struct mt_application *tmp, *mt_application = core::ptr::null_mut();
    ...
    let mut hid: c_uint = field.usage[n].hid;
    ...
    struct hid_report *report)
    {
    struct mt_report_data *tmp, *rdata = core::ptr::null_mut();
...
// target = value;
    ...
    struct mt_class *cls = &td.mtclass;
    int code;
    struct hid_usage *prev_usage = core::ptr::null_mut();
//
// Model touchscreens providing buttons as touchpads.
//
...
// we do not want to map these: no input-oriented meaning
    ...
    {
    let mut quirks: __s32 = app.quirks;
...
#[no_mangle]
unsafe extern "C" fn mt_compute_timestamp(app: *mut mt_application, value: __s32) -> c_int {
    static int mt_compute_timestamp(struct mt_application *app, __s32 value)
    {
    let mut delta: c_long = value - app.prev_scantime;
    let mut jdelta: c_ulong = jiffies_to_usecs(jiffies - app.jiffies);
    app.jiffies = jiffies;
    if (delta < 0)
...
// we will handle the hidinput part later, now remains hiddev
    ...
    let mut confidence_state: bool = true;
    let mut inrange_state: bool = false;
    int active;
    int slotnum;
    let mut tool: c_int = MT_TOOL_FINGER;
    if (!slot)
    return -EINVAL;
    ...
    tool = MT_TOOL_DIAL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: unlikely(!confidence_state)) -> else {
    tool = MT_TOOL_PALM;
    if (!active && mt &&
...
// this finger is in proximity of the sensor
    let mut wide: c_int = (*slot.w > *slot.h);
    let mut major: c_int = max(*slot.w, *slot.h);
    let mut minor: c_int = min(*slot.w, *slot.h);
    let mut orientation: c_int = wide;
    int max_azimuth;
    int azimuth;
    int x;
    int y;
...
//
    ...
    unsigned count;
    int r, n;
    let mut scantime: c_int = 0;
    let mut contact_count: c_int = -1;
...
#[no_mangle]
pub unsafe extern "C" fn if(scantime: app->num_received == 0 && app->prev_scantime !=) -> else {
//
...
//
    ...
    __u8 *start = rdesc + i;
    __u8 *coll_end = core::ptr::null_mut();
    __u8 *p = start;
    unsigned int drop;
    let mut depth: c_int = 0;
    while (p < rdesc + *size) {
    let mut b: __u8 = *p;
    let mut ds: c_int = b & 3;
    int item_len;
    if (b == 0xfe) { /* long item */
    if (p + 2 >= rdesc + *size)
    break;
    ...
    depth++; /* Collection */
#[no_mangle]
pub unsafe extern "C" fn if(0xc0: b ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mt_report(hid: *mut hid_device, report: *mut hid_report) {
...
// Lenovo Yoga Book 9i requires consuming and dropping certain bogus reports
    ...
    let mut index: c_uint = usage.usage_index;
    char *buf;
    u32 report_len;
    int max;
    switch (usage.hid) {
...
// inputmode_found = true;
    ...
    int i, j;
    bool update_report;
    let mut inputmode_found: bool = false;
...
#[no_mangle]
unsafe extern "C" fn mt_post_parse(td: *mut mt_device, app: *mut mt_application) {
    static void mt_post_parse(struct mt_device *td, struct mt_application *app)
    {
...
#[no_mangle]
unsafe extern "C" fn mt_input_configured(hdev: *mut hid_device, hi: *mut hid_input) -> c_int {
    static int mt_input_configured(struct hid_device *hdev, struct hid_input *hi)
    {
    struct mt_device *td = hid_get_drvdata(hdev);
    const char *suffix = core::ptr::null_mut();
    struct mt_report_data *rdata;
    struct mt_application *mt_application = core::ptr::null_mut();
    struct hid_report *report;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mt_fix_const_field(field: *mut hid_field, usage: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mt_fix_const_fields(hdev: *mut hid_device, usage: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mt_release_contacts(hid: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn mt_expired_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn mt_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt_suspend(hdev: *mut hid_device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt_reset_resume(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt_resume(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt_remove(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn mt_on_hid_hw_open(hdev: *mut hid_device) {
    static void mt_on_hid_hw_open(struct hid_device *hdev)
    {
    mt_set_modes(hdev, HID_LATENCY_NORMAL, TOUCHPAD_REPORT_ALL);
    }
#[no_mangle]
unsafe extern "C" fn mt_on_hid_hw_close(hdev: *mut hid_device) {
