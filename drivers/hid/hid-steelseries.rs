...
//! Source: drivers/hid/hid-steelseries.c
#![no_std]
...
pub const STEELSERIES_MSI_RGB_WVALUE: c_uint = 0x0300 /* Feature report, ID 0 */;
pub const STEELSERIES_MSI_RGB_REPORT_LEN: c_int = 524;
pub const STEELSERIES_MSI_RGB_OPCODE: c_uint = 0x0c;
pub const STEELSERIES_MSI_RGB_KLC_MODE: c_uint = 0x66;
pub const STEELSERIES_MSI_RGB_ALC_MODE: c_uint = 0x06;
...
pub struct steelseries_device {
    ...
    pub subled_info: [mc_subled; 3],
    pub /: *mut *mut mutex rgb_lock; / protects rgb_buf,
    pub rgb_buf: *mut u8,

}

    (IS_MODULE(CONFIG_LEDS_CLASS) && IS_MODULE(CONFIG_HID_STEELSERIES))
pub const SRWS1_NUMBER_LEDS: c_int = 15;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct steelseries_srws1_data {
    pub led_state: __u16,
// the last element is used for setting all leds simultaneously
    pub 1]: *mut *mut led_classdev led[SRWS1_NUMBER_LEDS +,
}
...
// ---- Dial patch ends here ----
    ...
    (IS_MODULE(CONFIG_LEDS_CLASS) && IS_MODULE(CONFIG_HID_STEELSERIES))
#[no_mangle]
unsafe extern "C" fn steelseries_srws1_set_leds(hdev: *mut hid_device, leds: __u16) {
...
#[no_mangle]
unsafe extern "C" fn steelseries_srws1_led_all_get_brightness(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn steelseries_srws1_led_get_brightness(led_cdev: *mut led_classdev) -> enum led_brightness {
...
// register led subsystem
    ...
    drv_data.led[i] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn steelseries_msi_rgb_is_interface0(hdev: *mut hid_device) -> bool {
    ...
    let mut intf: return = = usb_ifnum_to_if(udev, 0);
    }
...
#[no_mangle]
unsafe extern "C" fn steelseries_msi_rgb_free_buf(data: *mut c_void) {
    static void steelseries_msi_rgb_free_buf(void *data)
    {
    kfree(data);
    }
#[no_mangle]
unsafe extern "C" fn steelseries_msi_rgb_register(sd: *mut steelseries_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn steelseries_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn steelseries_remove(hdev: *mut hid_device) {
