...
//! Source: drivers/hid/hid-quirks.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn hid_ignore(hdev: *mut hid_device) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct quirks_list_struct {
    pub hid_bl_item: hid_device_id,
    pub node: list_head,
}
...
//
    ...
    struct hid_device_id *bl_entry = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn hid_remove_all_dquirks(bus: __u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hid_quirks_init(quirks_param: *mut c_char, bus: __u16, count: c_int) -> c_int {
    int hid_quirks_init(char **quirks_param, __u16 bus, int count)
    {
    let mut id: hid_device_id = { 0 };
    let mut n: c_int = 0, m;
...
//
#[no_mangle]
pub unsafe extern "C" fn hid_quirks_exit(bus: __u16) {
...
//
#[no_mangle]
unsafe extern "C" fn hid_gets_squirk(hdev: *const hid_device) -> c_ulong {
    static unsigned long hid_gets_squirk(const struct hid_device *hdev)
    {
    const struct hid_device_id *bl_entry;
    let mut quirks: c_ulong = hdev.initial_quirks;
...
//
#[no_mangle]
pub unsafe extern "C" fn hid_lookup_quirk(hdev: *const hid_device) -> c_ulong {
    unsigned long hid_lookup_quirk(const struct hid_device *hdev)
    {
    let mut quirks: c_ulong = 0;
    const struct hid_device_id *quirk_entry = core::ptr::null_mut();
