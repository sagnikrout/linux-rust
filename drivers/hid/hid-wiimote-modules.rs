...
//! Source: drivers/hid/hid-wiimote-modules.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wiimod_keys_in_keys(wdata: *mut wiimote_data, keys: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn wiimod_rumble_worker(work: *mut work_struct) {
...
// schedule_work acts as barrier. Merging multiple changes is fine.
    ...
    if (input_ff_create_memless(wdata.input, core::ptr::null_mut(), wiimod_rumble_play))
    return -ENOMEM;
    return 0;
    }
...
//
    ...
    struct wiimote_data *wdata)
    {
    let mut psy_cfg: power_supply_config = { .drv_data = wdata, };
    int ret;
    ...
    wdata.battery_desc.name = core::ptr::null_mut();
    return ret;
    }
...
//
#[no_mangle]
unsafe extern "C" fn wiimod_led_get(led_dev: *mut led_classdev) -> enum led_brightness {
    ...
    let mut namesz: usize = strlen(dev_name(dev)) + 9;
...
// enable LED1 to stop initial LED-blinking
    ...
    return 0;
    err_free:
    wdata.leds[ops.arg] = core::ptr::null_mut();
    kfree(led);
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn wiimod_accel_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiimod_accel_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn wiimod_ir_change(wdata: *mut wiimote_data, mode: __u16) -> c_int {
    static int wiimod_ir_change(struct wiimote_data *wdata, __u16 mode)
    {
    int ret;
    unsigned long flags;
    let mut format: __u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn wiimod_ir_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiimod_ir_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn wiimod_nunchuk_in_ext(wdata: *mut wiimote_data, ext: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn wiimod_nunchuk_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiimod_nunchuk_close(dev: *mut input_dev) {
    ...
    wdata.extension.input = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn wiimod_classic_in_ext(wdata: *mut wiimote_data, ext: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn wiimod_classic_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiimod_classic_close(dev: *mut input_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn wiimod_bboard_in_keys(wdata: *mut wiimote_data, keys: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn wiimod_bboard_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiimod_bboard_close(dev: *mut input_dev) {
    ...
    static DEVICE_ATTR(bboard_calib, S_IRUGO, wiimod_bboard_calib_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn wiimod_pro_in_ext(wdata: *mut wiimote_data, ext: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn wiimod_pro_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiimod_pro_close(dev: *mut input_dev) {
...
// schedule_work acts as barrier. Merging multiple changes is fine.
    ...
    input_set_drvdata(wdata.extension.input, wdata);
    if (input_ff_create_memless(wdata.extension.input, core::ptr::null_mut(),
    wiimod_pro_play)) {
    ret = -ENOMEM;
    goto err_free;
    }
...
//
    ...
    __u8 which_code)
    {
    let mut default_pressure: static __u8 = 3;
...
#[no_mangle]
unsafe extern "C" fn wiimod_drums_in_ext(wdata: *mut wiimote_data, ext: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn wiimod_drums_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiimod_drums_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn wiimod_guitar_in_ext(wdata: *mut wiimote_data, ext: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn wiimod_guitar_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiimod_guitar_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn wiimod_turntable_in_ext(wdata: *mut wiimote_data, ext: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn wiimod_turntable_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiimod_turntable_close(dev: *mut input_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn wiimod_mp_in_mp(wdata: *mut wiimote_data, ext: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn wiimod_mp_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiimod_mp_close(dev: *mut input_dev) {
