...
//! Source: drivers/hid/hid-corsair-void.c
#![no_std]
...
pub const CORSAIR_VOID_STATUS_REQUEST_ID: c_uint = 0xC9;
pub const CORSAIR_VOID_NOTIF_REQUEST_ID: c_uint = 0xCA;
pub const CORSAIR_VOID_SIDETONE_REQUEST_ID: c_uint = 0xFF;
pub const CORSAIR_VOID_STATUS_REPORT_ID: c_uint = 0x64;
pub const CORSAIR_VOID_FIRMWARE_REPORT_ID: c_uint = 0x66;
pub const CORSAIR_VOID_STATUS_REPORT_SIZE: c_int = 5;
pub const CORSAIR_VOID_FIRMWARE_REPORT_SIZE: c_int = 5;
pub const CORSAIR_VOID_USB_SIDETONE_REQUEST: c_uint = 0x1;
pub const CORSAIR_VOID_USB_SIDETONE_REQUEST_TYPE: c_uint = 0x21;
pub const CORSAIR_VOID_USB_SIDETONE_VALUE: c_uint = 0x200;
pub const CORSAIR_VOID_USB_SIDETONE_INDEX: c_uint = 0xB00;

pub const CORSAIR_VOID_WIRELESS_CONNECTED: c_int = 177;
pub const CORSAIR_VOID_SIDETONE_MAX_WIRELESS: c_int = 55;
pub const CORSAIR_VOID_SIDETONE_MAX_WIRED: c_int = 4096;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct corsair_void_battery_data {
    pub status: c_int,
    pub present: bool,
    pub capacity: c_int,
    pub capacity_level: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct corsair_void_drvdata {
    pub hid_dev: *mut hid_device,
    pub dev: *mut device,
    pub name: *mut c_char,
    pub is_wired: bool,
    pub sidetone_max: c_uint,
    pub battery_data: corsair_void_battery_data,
    pub mic_up: bool,
    pub connected: bool,
    pub fw_receiver_major: c_int,
    pub fw_receiver_minor: c_int,
    pub fw_headset_major: c_int,
    pub fw_headset_minor: c_int,
    pub battery: *mut power_supply,
    pub battery_desc: power_supply_desc,
    pub delayed_status_work: delayed_work,
    pub delayed_firmware_work: delayed_work,
    pub battery_work_flags: c_ulong,
...
//
#[no_mangle]
unsafe extern "C" fn corsair_void_set_wireless_status(drvdata: *mut corsair_void_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn corsair_void_set_unknown_batt(drvdata: *mut corsair_void_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn corsair_void_set_unknown_wireless_data(drvdata: *mut corsair_void_drvdata) {
...
#[no_mangle]
pub unsafe extern "C" fn if(CORSAIR_VOID_BATTERY_CRITICAL: raw_battery_status ==) -> else {
...
//
    ...
    unsigned char *send_buf __free(kfree) = core::ptr::null_mut();
    int ret;
...
// Packet format to set sidetone for wired headsets
    let mut sidetone_le: __le16 = cpu_to_le16(sidetone);
...
#[no_mangle]
unsafe extern "C" fn corsair_void_request_status(hid_dev: *mut hid_device, id: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn corsair_void_status_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn corsair_void_firmware_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn corsair_void_add_battery(drvdata: *mut corsair_void_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn corsair_void_battery_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn corsair_void_headset_connected(drvdata: *mut corsair_void_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn corsair_void_headset_disconnected(drvdata: *mut corsair_void_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn corsair_void_remove(hid_dev: *mut hid_device) {
    ...
    {
    struct corsair_void_drvdata *drvdata = hid_get_drvdata(hid_dev);
    let mut was_connected: bool = drvdata.connected;
