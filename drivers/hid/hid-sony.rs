...
pub const NSG_MRXU_MAX_X: c_int = 1667;
pub const NSG_MRXU_MAX_Y: c_int = 1868;
...
pub const GUITAR_TILT_USAGE: c_int = 44;
pub const TURNTABLE_EFFECTS_KNOB_USAGE: c_int = 44;
pub const TURNTABLE_PLATTER_BUTTONS_USAGE: c_int = 45;
pub const TURNTABLE_CROSS_FADER_USAGE: c_int = 46;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sixaxis_led {
    pub /: *mut *mut u8 time_enabled; / the total time the led is active (0xff means forever),
    pub /: *mut *mut u8 duty_length; / how long a cycle is in deciseconds (0 means "really fast"),
    pub enabled: u8,
    pub /: *mut *mut u8 duty_off; / % of duty_length the led is off (0xff means 100%),
    pub /: *mut *mut u8 duty_on; / % of duty_length the led is on (0xff mean 100%),
    pub __packed: },
    pub 5): static_assert(sizeof(struct sixaxis_led) ==,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sixaxis_rumble {
    pub padding: u8,
    pub /: *mut *mut u8 right_duration; / Right motor duration (0xff means forever),
    pub /: *mut *mut u8 right_motor_on; / Right (small) motor on/off, only supports values of 0 or 1 (off/on),
    pub /: *mut *mut u8 left_duration; / Left motor duration (0xff means forever),
    pub /: *mut *mut u8 left_motor_force; / left (large) motor, supports force values from 0 to 255,
    pub __packed: },
    pub 5): static_assert(sizeof(struct sixaxis_rumble) ==,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sixaxis_output_report {
    pub report_id: u8,
    pub rumble: sixaxis_rumble,
    pub padding: [u8; 4],
    pub /: *mut *mut u8 leds_bitmap; / bitmap of enabled LEDs: LED_1 = 0x02, LED_2 = 0x04, ...,
    pub /: *mut *mut sixaxis_led led[4]; / LEDx at (4 - x),
    pub /: *mut *mut sixaxis_led _reserved; / LED5, not actually soldered,
    pub __packed: },
    pub 36): static_assert(sizeof(struct sixaxis_output_report) ==,
    union sixaxis_output_report_01 {
    pub data: sixaxis_output_report,
    pub buf: [u8; 36],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct motion_output_report_02 {
    pub zero: u8 type,,
    pub b: u8 r, g,,
    pub zero2: u8,
    pub rumble: u8,
    pub __packed: },
    pub 7): static_assert(sizeof(struct motion_output_report_02) ==,
pub const SIXAXIS_REPORT_0xF2_SIZE: c_int = 17;
pub const SIXAXIS_REPORT_0xF5_SIZE: c_int = 8;
pub const MOTION_REPORT_0x02_SIZE: c_int = 49;
pub const PRO_INSTRUMENT_0x00_SIZE: c_int = 8;

pub const SIXAXIS_INPUT_REPORT_ACC_X_OFFSET: c_int = 41;
pub const SIXAXIS_ACC_RES_PER_G: c_int = 113;
    pub DEFINE_SPINLOCK(sony_dev_list_lock): static,
    pub LIST_HEAD(sony_device_list): static,
    pub DEFINE_IDA(sony_device_id_allocator): static,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sony_sc {
    pub lock: spinlock_t,
    ...
    pub sensor_dev: *mut input_dev,
    pub leds: [*mut led_classdev; MAX_LEDS],
    pub quirks: c_ulong,
    pub size): *mut *mut *mut *mut int (raw_event)(struct sony_sc sc, u8 rd, int,
    pub state_worker: work_struct,
    pub sc): *mut *mut void (send_output_report)(struct sony_sc,
    pub battery: *mut power_supply,
    pub battery_desc: power_supply_desc,
    pub device_id: c_int,
    pub output_report_dmabuf: *mut u8,

    pub left: u8,
    pub right: u8,
    pub mac_address: [u8; 6],
    pub state_worker_initialized: u8,
    pub defer_initialization: u8,
    pub battery_capacity: u8,
    pub battery_status: c_int,
    pub led_state: [u8; MAX_LEDS],
    pub led_delay_on: [u8; MAX_LEDS],
    pub led_delay_off: [u8; MAX_LEDS],
    pub led_count: u8,
// GH Live
    pub ghl_urb: *mut urb,
    pub ghl_poke_timer: timer_list,
// Rock Band 3 Pro Instruments
    pub rb3_pro_poke_jiffies: c_ulong,
}

    static void sony_set_leds(struct sony_sc *sc);
#[no_mangle]
pub unsafe extern "C" fn sony_schedule_work(sc: *mut sony_sc) {
...
#[no_mangle]
unsafe extern "C" fn ghl_magic_poke_cb(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn ghl_magic_poke(t: *mut timer_list) {
    ...
    u8 *databuf;
    unsigned int pipe;
    let mut ghl_magic_value: u16 = (((HID_OUTPUT_REPORT + 1) << 8) | ghl_magic_data[0]);
...
//
#[no_mangle]
unsafe extern "C" fn rb3_pro_instrument_enable_full_report(sc: *mut sony_sc) -> c_int {
    ...
    let mut abs: c_uint = usage.hid & HID_USAGE;
    ...
    let mut key: c_uint = usage.hid & HID_USAGE;
...
#[no_mangle]
unsafe extern "C" fn sixaxis_raw_event(sc: *mut sony_sc, rd: *mut u8, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsg_mrxu_raw_event(sc: *mut sony_sc, rd: *mut u8, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rb3_pro_instrument_raw_event(sc: *mut sony_sc, rd: *mut u8, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rb4_ps4_guitar_raw_event(sc: *mut sony_sc, rd: *mut u8, size: c_int) -> c_int {
    static int rb4_ps4_guitar_raw_event(struct sony_sc *sc, u8 *rd, int size)
    {
    let mut expected_size: c_int = (sc.quirks & RB4_GUITAR_PS4_BT) ? 78 : 64;
...
#[no_mangle]
unsafe extern "C" fn rb4_ps5_guitar_raw_event(sc: *mut sony_sc, rd: *mut u8, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sony_register_sensors(sc: *mut sony_sc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sixaxis_set_operational_usb(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sixaxis_set_operational_bt(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sixaxis_set_leds_from_id(sc: *mut sony_sc) {
...
#[no_mangle]
unsafe extern "C" fn buzz_set_leds(sc: *mut sony_sc) {
...
#[no_mangle]
unsafe extern "C" fn sony_set_leds(sc: *mut sony_sc) {
    static void sony_set_leds(struct sony_sc *sc)
    {
    if (!(sc.quirks & BUZZ_CONTROLLER))
    sony_schedule_work(sc);
...
#[no_mangle]
unsafe extern "C" fn sony_led_get_brightness(led: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn sony_leds_init(sc: *mut sony_sc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sixaxis_send_output_report(sc: *mut sony_sc) {
...
#[no_mangle]
unsafe extern "C" fn motion_send_output_report(sc: *mut sony_sc) {
...
#[no_mangle]
pub unsafe extern "C" fn sony_send_output_report(sc: *mut sony_sc) {
...
#[no_mangle]
unsafe extern "C" fn sony_state_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sony_allocate_output_report(sc: *mut sony_sc) -> c_int {
    ...
    GFP_KERNEL);
#[no_mangle]
pub unsafe extern "C" fn if(MOTION_CONTROLLER: sc->quirks &) -> else {
    else if (sc.quirks & MOTION_CONTROLLER)
...
#[no_mangle]
unsafe extern "C" fn sony_init_ff(sc: *mut sony_sc) -> c_int {
    static int sony_init_ff(struct sony_sc *sc)
    {
    input_set_capability(sc.input_dev, EV_FF, FF_RUMBLE);
    return input_ff_create_memless(sc.input_dev, core::ptr::null_mut(), sony_play_effect);
    }
...
#[no_mangle]
unsafe extern "C" fn sony_battery_probe(sc: *mut sony_sc, append_dev_id: c_int) -> c_int {
    ...
    let mut psy_cfg: power_supply_config = { .drv_data = sc, };
    struct hid_device *hdev = sc.hdev;
    int ret;
//
...
//
    ...
    struct sony_sc *sc1)
    {
    let mut sc0_not_bt: c_int = !(sc0.quirks & SONY_BT_DEVICE);
    let mut sc1_not_bt: c_int = !(sc1.quirks & SONY_BT_DEVICE);
    let mut sc0_not_bt: return = = sc1_not_bt;
    }
#[no_mangle]
unsafe extern "C" fn sony_check_add_dev_list(sc: *mut sony_sc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sony_remove_dev_list(sc: *mut sony_sc) {
...
#[no_mangle]
unsafe extern "C" fn sony_get_bt_devaddr(sc: *mut sony_sc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sony_check_add(sc: *mut sony_sc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sony_set_device_id(sc: *mut sony_sc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sony_release_device_id(sc: *mut sony_sc) {
...
#[no_mangle]
pub unsafe extern "C" fn sony_cancel_work_sync(sc: *mut sony_sc) {
...
#[no_mangle]
unsafe extern "C" fn sony_cleanup(sc: *mut sony_sc) {
...
#[no_mangle]
unsafe extern "C" fn sony_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(SIXAXIS_CONTROLLER: sc->quirks &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(GHL_GUITAR_PS4: sc->quirks &) -> else {
...
#[no_mangle]
unsafe extern "C" fn sony_remove(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn sony_suspend(hdev: *mut hid_device, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sony_resume(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sony_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sony_exit() -> void __exit {
