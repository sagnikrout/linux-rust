...
//! Source: drivers/hid/hid-sensor-custom.c
#![no_std]
...
pub const HID_CUSTOM_NAME_LENGTH: c_int = 64;
pub const HID_CUSTOM_MAX_CORE_ATTRS: c_int = 10;

pub const HID_CUSTOM_FIFO_SIZE: c_int = 4096;
pub const HID_CUSTOM_MAX_FEATURE_BYTES: c_int = 64;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hid_sensor_custom_field {
    pub report_id: c_int,
    pub group_name: [c_char; HID_CUSTOM_NAME_LENGTH],
    pub attribute: hid_sensor_hub_attribute_info,
    pub sd_attrs: [device_attribute; HID_CUSTOM_MAX_CORE_ATTRS],
    pub attr_name: [c_char; HID_CUSTOM_TOTAL_ATTRS][HID_CUSTOM_NAME_LENGTH],
    pub attrs: [*mut attribute; HID_CUSTOM_TOTAL_ATTRS],
    pub hid_custom_attribute_group: attribute_group,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hid_sensor_custom {
    pub mutex: mutex,
    pub pdev: *mut platform_device,
    pub hsdev: *mut hid_sensor_hub_device,
    pub callbacks: hid_sensor_hub_callbacks,
    pub sensor_field_count: c_int,
    pub fields: *mut hid_sensor_custom_field,
    pub input_field_count: c_int,
    pub input_report_size: c_int,
    pub input_report_recd_size: c_int,
    pub input_skip_sample: bool,
    pub enable: bool,
    pub power_state: *mut hid_sensor_custom_field,
    pub report_state: *mut hid_sensor_custom_field,
    pub custom_dev: miscdevice,
    pub data_fifo: kfifo,
    pub misc_opened: c_ulong,
    pub wait: wait_queue_head_t,
    pub custom_pdev: *mut platform_device,
}

// Header for each sample to user space via dev interface
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hid_sensor_sample {
    pub usage_id: u32,
    pub timestamp: u64,
    pub raw_len: u32,
    pub __packed: },
...
#[no_mangle]
unsafe extern "C" fn usage_id_cmp(p1: *const c_void, p2: *const c_void) -> c_int {
    ...
    bool state)
    {
    let mut power_val: c_int = -1;
    let mut report_val: c_int = -1;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(name, _arg: "unit-expo", _arg: strlen("unit-expo"))) -> else {
    else if (!strncmp(name, "unit-expo", strlen("unit-expo")))
    value = sensor_inst.fields[field_index].attribute.unit_expo;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(name, _arg: "size", _arg: strlen("size"))) -> else {
    else if (!strncmp(name, "size", strlen("size")))
    value = sensor_inst.fields[field_index].attribute.size;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(name, _arg: "minimum", _arg: strlen("minimum"))) -> else {
    else if (!strncmp(name, "minimum", strlen("minimum")))
    value = sensor_inst.fields[field_index].attribute.
    logical_minimum;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(name, _arg: "maximum", _arg: strlen("maximum"))) -> else {
    else if (!strncmp(name, "maximum", strlen("maximum")))
    value = sensor_inst.fields[field_index].attribute.
    logical_maximum;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(name, _arg: "name", _arg: strlen("name"))) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(HID_INPUT_REPORT: report_type ==) -> else {
    snprintf(sensor_field.group_name,
...
// Create sysfs attributes
    ...
    sensor_inst.fields[i].attrs[j] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn hid_sensor_custom_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_sensor_custom_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_sensor_custom_dev_if_add(sensor_inst: *mut hid_sensor_custom) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hid_sensor_custom_match {
    pub tag: *const c_char,
    pub luid: *const c_char,
    pub model: *const c_char,
    pub manufacturer: *const c_char,
    pub check_dmi: bool,
    pub dmi: dmi_system_id,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hid_sensor_custom_properties {
    pub serial_num: [u16; HID_CUSTOM_MAX_FEATURE_BYTES],
    pub model: [u16; HID_CUSTOM_MAX_FEATURE_BYTES],
    pub manufacturer: [u16; HID_CUSTOM_MAX_FEATURE_BYTES],
}
...
//
    ...
    u16 *prop)
    {
    let mut prop_attr: hid_sensor_hub_attribute_info = { 0 };
    int ret;
...
#[no_mangle]
unsafe extern "C" fn hid_sensor_custom_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_sensor_custom_remove(pdev: *mut platform_device) {
