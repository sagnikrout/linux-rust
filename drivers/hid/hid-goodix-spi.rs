...
//! Source: drivers/hid/hid-goodix-spi.c
#![no_std]
...
pub const GOODIX_DEV_CONFIRM_ADDR: c_uint = 0x10000;
pub const GOODIX_HID_DESC_ADDR: c_uint = 0x1058C;
pub const GOODIX_HID_REPORT_DESC_ADDR: c_uint = 0x105AA;
pub const GOODIX_HID_SIGN_ADDR: c_uint = 0x10D32;
pub const GOODIX_HID_CMD_ADDR: c_uint = 0x10364;
pub const GOODIX_HID_REPORT_ADDR: c_uint = 0x22C8C;
pub const GOODIX_HID_GET_REPORT_CMD: c_uint = 0x02;
pub const GOODIX_HID_SET_REPORT_CMD: c_uint = 0x03;
pub const GOODIX_HID_MAX_INBUF_SIZE: c_int = 128;
pub const GOODIX_HID_ACK_READY_FLAG: c_uint = 0x01;
pub const GOODIX_HID_REPORT_READY_FLAG: c_uint = 0x80;
pub const GOODIX_DEV_CONFIRM_VAL: c_uint = 0xAA;
pub const GOODIX_SPI_WRITE_FLAG: c_uint = 0xF0;
pub const GOODIX_SPI_READ_FLAG: c_uint = 0xF1;
pub const GOODIX_SPI_TRANS_PREFIX_LEN: c_int = 1;
pub const GOODIX_REGISTER_WIDTH: c_int = 4;
pub const GOODIX_SPI_READ_DUMMY_LEN: c_int = 3;
...
pub const GOODIX_NORMAL_RESET_DELAY_MS: c_int = 150;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct goodix_hid_report_header {
    pub flag: u8,
    pub size: __le16,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct goodix_hid_report_package {
    pub size: __le16,
    pub data: [u8; ],
}

pub const GOODIX_HID_COOR_DATA_LEN: c_int = 82;

    GOODIX_HID_COOR_DATA_LEN)
// power state
pub const GOODIX_SPI_POWER_ON: c_uint = 0x00;
pub const GOODIX_SPI_POWER_SLEEP: c_uint = 0x01;
// flags used to record the current device operating state
pub const GOODIX_HID_STARTED: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct goodix_hid_report_event {
    pub hdr: goodix_hid_report_header,
    pub data: [u8; GOODIX_HID_COOR_PKG_LEN],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct goodix_hid_desc {
    pub desc_length: __le16,
    pub bcd_version: __le16,
    pub report_desc_length: __le16,
    pub report_desc_register: __le16,
    pub input_register: __le16,
    pub max_input_length: __le16,
    pub output_register: __le16,
    pub max_output_length: __le16,
    pub cmd_register: __le16,
...
pub struct goodix_ts_data {
    ...
    pub hid_desc: goodix_hid_desc,
    pub reset_gpio: *mut gpio_desc,
    pub hid_report_addr: u32,
    pub flags: c_ulong,
// lock for hid raw request operation
    pub hid_request_lock: mutex,
// buffer used to store hid report event
    pub event_buf: *mut u8,
    pub hid_max_event_sz: u32,
// buffer used to do spi data transfer
    pub ____cacheline_aligned: u8 xfer_buf[SZ_2K],
}
...
#[no_mangle]
unsafe extern "C" fn goodix_dev_confirm(ts: *mut goodix_ts_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn goodix_hid_parse(hid: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goodix_hid_get_report_length(report: *mut hid_report) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goodix_hid_start(hid: *mut hid_device) -> c_int {
    static int goodix_hid_start(struct hid_device *hid)
    {
    struct goodix_ts_data *ts = hid.driver_data;
    let mut bufsize: c_uint = GOODIX_HID_COOR_PKG_LEN;
    u32 report_size;
...
#[no_mangle]
unsafe extern "C" fn goodix_hid_stop(hid: *mut hid_device) {
    static void goodix_hid_stop(struct hid_device *hid)
    {
    hid.claimed = 0;
    }
#[no_mangle]
unsafe extern "C" fn goodix_hid_open(hid: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goodix_hid_close(hid: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn goodix_hid_check_ack_status(ts: *mut goodix_ts_data, resp_len: *mut u32) -> c_int {
...
//
    ...
    {
    struct goodix_ts_data *ts = hid.driver_data;
    let mut data_register: u16 = le16_to_cpu(ts.hid_desc.data_register);
    let mut cmd_register: u16 = le16_to_cpu(ts.hid_desc.cmd_register);
    u8 tmp_buf[GOODIX_HID_MAX_INBUF_SIZE];
    let mut tx_len: c_int = 0, args_len = 0;
...
#[no_mangle]
unsafe extern "C" fn goodix_hid_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn goodix_hid_init(ts: *mut goodix_ts_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goodix_spi_probe(spi: *mut spi_device) -> c_int {
...
// Waits 150ms for firmware to fully boot
    ...
    core::ptr::null_mut(), goodix_hid_irq, IRQF_ONESHOT,
    "goodix_spi_hid", ts);
    if (error)
...
#[no_mangle]
unsafe extern "C" fn goodix_spi_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn goodix_spi_set_power(ts: *mut goodix_ts_data, power_state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goodix_spi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goodix_spi_resume(dev: *mut device) -> c_int {
