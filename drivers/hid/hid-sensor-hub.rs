...
//! Source: drivers/hid/hid-sensor-hub.c
#![no_std]
...
pub const HID_SENSOR_HUB_ENUM_QUIRK: c_uint = 0x01;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sensor_hub_data {
    pub mutex: mutex,
    pub lock: spinlock_t,
    pub dyn_callback_list: list_head,
    pub dyn_callback_lock: spinlock_t,
    pub hid_sensor_hub_client_devs: *mut mfd_cell,
    pub hid_sensor_client_cnt: c_int,
    pub ref_cnt: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hid_sensor_hub_callbacks_list {
    pub list: list_head,
    pub usage_id: u32,
    pub hsdev: *mut hid_sensor_hub_device,
    pub usage_callback: *mut hid_sensor_hub_callbacks,
    pub priv: *mut c_void,
}
...
#[no_mangle]
unsafe extern "C" fn sensor_hub_get_physical_device_count(hdev: *mut hid_device) -> c_int {
...
// hsdev = callback->hsdev;
    ...
    callback.priv = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn sensor_hub_suspend(hdev: *mut hid_device, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sensor_hub_resume(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sensor_hub_reset_resume(hdev: *mut hid_device) -> c_int {
...
//
    ...
    struct sensor_hub_data *pdata = hid_get_drvdata(hdev);
    unsigned long flags;
    struct hid_sensor_hub_callbacks *callback = core::ptr::null_mut();
    struct hid_collection *collection = core::ptr::null_mut();
    void *priv = core::ptr::null_mut();
    struct hid_sensor_hub_device *hsdev = core::ptr::null_mut();
    u32 copy_size;
    u32 avail;
...
#[no_mangle]
pub unsafe extern "C" fn sensor_hub_device_open(hsdev: *mut hid_sensor_hub_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sensor_hub_device_close(hsdev: *mut hid_sensor_hub_device) {
...
// Sets negative logical minimum for mag x, y and z
    ...
    int dev_cnt;
    struct hid_sensor_hub_device *hsdev;
    struct hid_sensor_hub_device *last_hsdev = core::ptr::null_mut();
    struct hid_sensor_hub_device *collection_hsdev = core::ptr::null_mut();
    ...
    GFP_KERNEL);
    if (sd.hid_sensor_hub_client_devs == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn sensor_hub_finalize_pending_fn(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sensor_hub_remove(hdev: *mut hid_device) {
    ...
    hid_hw_stop(hdev);
    spin_lock_irqsave(&data.lock, flags);
    device_for_each_child(&hdev.dev, core::ptr::null_mut(),
