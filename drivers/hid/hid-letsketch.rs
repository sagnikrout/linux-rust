...
//! Source: drivers/hid/hid-letsketch.c
#![no_std]
...
pub const LETSKETCH_RAW_IF: c_int = 0;
pub const LETSKETCH_RAW_DATA_LEN: c_int = 12;
pub const LETSKETCH_RAW_REPORT_ID: c_int = 8;
pub const LETSKETCH_PAD_BUTTONS: c_int = 5;
pub const LETSKETCH_INFO_STR_IDX_BEGIN: c_uint = 0xc8;
pub const LETSKETCH_INFO_STR_IDX_END: c_uint = 0xca;
pub const LETSKETCH_GET_STRING_RETRIES: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct letsketch_data {
    pub hdev: *mut hid_device,
    pub input_tablet: *mut input_dev,
    pub input_tablet_pad: *mut input_dev,
    pub inrange_timer: timer_list,
}

#[no_mangle]
unsafe extern "C" fn letsketch_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn letsketch_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn letsketch_setup_input_tablet(data: *mut letsketch_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn letsketch_setup_input_tablet_pad(data: *mut letsketch_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn letsketch_inrange_timeout(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn letsketch_get_string(udev: *mut usb_device, index: c_int, buf: *mut c_char, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn letsketch_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn letsketch_remove(hdev: *mut hid_device) {
