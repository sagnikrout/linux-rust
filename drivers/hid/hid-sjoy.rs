...
#[no_mangle]
unsafe extern "C" fn sjoy_input_configured(hid: *mut hid_device, hidinput: *mut hid_input) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sjoy_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
