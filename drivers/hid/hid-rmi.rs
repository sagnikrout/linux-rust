...
pub const RMI_MOUSE_REPORT_ID: c_uint = 0x01 /* Mouse emulation Report */;
pub const RMI_WRITE_REPORT_ID: c_uint = 0x09 /* Output Report */;
pub const RMI_READ_ADDR_REPORT_ID: c_uint = 0x0a /* Output Report */;
pub const RMI_READ_DATA_REPORT_ID: c_uint = 0x0b /* Input Report */;
pub const RMI_ATTN_REPORT_ID: c_uint = 0x0c /* Input Report */;
pub const RMI_SET_RMI_MODE_REPORT_ID: c_uint = 0x0f /* Feature Report */;
// flags
pub const RMI_READ_REQUEST_PENDING: c_int = 0;
pub const RMI_READ_DATA_PENDING: c_int = 1;
pub const RMI_STARTED: c_int = 2;
// device flags
...
pub struct rmi_data {
    ...
    pub writeReport: *mut u8,
    pub readReport: *mut u8,
    pub input_report_size: u32,
    pub output_report_size: u32,
    pub flags: c_ulong,
...
//
#[no_mangle]
unsafe extern "C" fn rmi_set_page(hdev: *mut hid_device, page: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_set_mode(hdev: *mut hid_device, mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_write_report(hdev: *mut hid_device, report: *mut u8, len: c_int) -> c_int {
    static int rmi_write_report(struct hid_device *hdev, u8 *report, int len)
    {
    struct rmi_data *data = hid_get_drvdata(hdev);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rmi_reset_attn_mode(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_reset_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rmi_input_event(hdev: *mut hid_device, data: *mut u8, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_read_data_event(hdev: *mut hid_device, data: *mut u8, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_check_sanity(hdev: *mut hid_device, data: *mut u8, size: c_int) -> c_int {
    static int rmi_check_sanity(struct hid_device *hdev, u8 *data, int size)
    {
    let mut valid_size: c_int = size;
//
...
#[no_mangle]
unsafe extern "C" fn rmi_report(hid: *mut hid_device, report: *mut hid_report) {
...
#[no_mangle]
unsafe extern "C" fn rmi_suspend(hdev: *mut hid_device, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_post_resume(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_hid_reset(xport: *mut rmi_transport_dev, reset_addr: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_input_configured(hdev: *mut hid_device, hi: *mut hid_input) -> c_int {
...
// report = hdev->report_enum[type].report_id_hash[id];
    ...
    let mut app: unsigned = (*report).field[i].application;
...
#[no_mangle]
unsafe extern "C" fn rmi_irq_teardown(data: *mut c_void) {
    ...
    hdata.domain = core::ptr::null_mut();
    hdata.rmi_irq = 0;
    }
...
#[no_mangle]
unsafe extern "C" fn rmi_setup_irq_domain(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
    static int rmi_probe(struct hid_device *hdev, const struct hid_device_id *id)
    {
    struct rmi_data *data = core::ptr::null_mut();
    int ret;
    size_t alloc_size;
...
#[no_mangle]
unsafe extern "C" fn rmi_remove(hdev: *mut hid_device) {
