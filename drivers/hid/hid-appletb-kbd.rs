...
//! Source: drivers/hid/hid-appletb-kbd.c
#![no_std]
...
pub const APPLETB_KBD_MODE_ESC: c_int = 0;
pub const APPLETB_KBD_MODE_FN: c_int = 1;
pub const APPLETB_KBD_MODE_SPCL: c_int = 2;
pub const APPLETB_KBD_MODE_OFF: c_int = 3;

pub const APPLETB_DEVID_KEYBOARD: c_int = 1;
pub const APPLETB_DEVID_TRACKPAD: c_int = 2;
pub const HID_USAGE_MODE: c_uint = 0x00ff0004;
    let mut appletb_tb_def_mode: static int = APPLETB_KBD_MODE_SPCL;
    module_param_named(mode, appletb_tb_def_mode, int, 0444);
    MODULE_PARM_DESC(mode, "Default touchbar mode:\n"
    "    0 - escape key only\n"
    "    1 - function-keys\n"
    "    [2] - special keys");
    let mut appletb_tb_fn_toggle: static bool = true;
    ...
    let mut appletb_tb_autodim: static bool = true;
    ...
    let mut appletb_tb_dim_timeout: static int = 60;
    module_param_named(dim_timeout, appletb_tb_dim_timeout, int, 0644);
    MODULE_PARM_DESC(dim_timeout, "Dim timeout in sec");
    let mut appletb_tb_idle_timeout: static int = 15;
    module_param_named(idle_timeout, appletb_tb_idle_timeout, int, 0644);
    MODULE_PARM_DESC(idle_timeout, "Idle timeout in sec");
#[repr(C)]
#[derive(Copy, Clone)]
pub struct appletb_kbd {
    pub mode_field: *mut hid_field,
    pub inp_handler: input_handler,
    pub kbd_handle: input_handle,
    pub tpd_handle: input_handle,
    pub backlight_dev: *mut backlight_device,
    pub inactivity_work: delayed_work,
    pub restore_brightness_work: work_struct,
    pub has_dimmed: bool,
    pub has_turned_off: bool,
    pub saved_mode: u8,
    pub current_mode: u8,
}
...
#[no_mangle]
unsafe extern "C" fn appletb_kbd_set_mode(kbd: *mut appletb_kbd, mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn appletb_tb_key_to_slot(code: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn appletb_inactivity_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn appletb_restore_brightness_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn reset_inactivity_timer(kbd: *mut appletb_kbd) {
...
//
    ...
    handle.dev = core::ptr::null_mut();
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn appletb_kbd_inp_disconnect(handle: *mut input_handle) {
...
#[no_mangle]
unsafe extern "C" fn appletb_kbd_input_configured(hdev: *mut hid_device, hidinput: *mut hid_input) -> c_int {
...
//
    ...
    sparse_keymap_setup(input, appletb_kbd_keymap, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn appletb_kbd_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn appletb_kbd_remove(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn appletb_kbd_suspend(hdev: *mut hid_device, msg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn appletb_kbd_resume(hdev: *mut hid_device) -> c_int {
