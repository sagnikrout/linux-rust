...
//! Source: drivers/hid/intel-thc-hid/intel-quickspi/pci-quickspi.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn quickspi_get_acpi_resources(qsdev: *mut quickspi_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn quickspi_irq_quick_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn quickspi_irq_thread_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t quickspi_irq_thread_handler(int irq, void *dev_id)
    {
    struct quickspi_device *qsdev = dev_id;
    size_t input_len;
    let mut read_finished: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn quickspi_dev_deinit(qsdev: *mut quickspi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn quickspi_dma_init(qsdev: *mut quickspi_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn quickspi_dma_deinit(qsdev: *mut quickspi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn quickspi_alloc_report_buf(qsdev: *mut quickspi_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn quickspi_remove(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quickspi_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quickspi_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quickspi_resume(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quickspi_freeze(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quickspi_thaw(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quickspi_poweroff(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quickspi_restore(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quickspi_runtime_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quickspi_runtime_resume(device: *mut device) -> c_int {
