...
//! Source: drivers/hid/intel-thc-hid/intel-quicki2c/pci-quicki2c.c
#![no_std]
...
// QuickI2C Wake-on-Touch GPIO resource
    let mut wake_gpio: static struct acpi_gpio_params = { 0, 0, true };
...
//
    ...
    {
    let mut handle: acpi_handle = acpi_device_handle(adev);
    union acpi_object *obj;
    obj = acpi_evaluate_dsm_typed(handle, guid, rev, func, core::ptr::null_mut(), type);
    if (!obj) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_TYPE_BUFFER: type ==) -> else {
...
//
    ...
    acpi_status status;
    status = acpi_evaluate_object(handle, dsd_method_name, core::ptr::null_mut(), &buffer);
...
//
#[no_mangle]
unsafe extern "C" fn quicki2c_get_acpi_resources(qcdev: *mut quicki2c_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn quicki2c_irq_quick_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn try_recover(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn handle_input_report(qcdev: *mut quicki2c_device) -> c_int {
    ...
    let mut rx_dma_finished: c_int = 0;
    size_t report_len;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn quicki2c_irq_thread_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t quicki2c_irq_thread_handler(int irq, void *dev_id)
    {
    struct quicki2c_device *qcdev = dev_id;
    let mut err_recover: c_int = 0;
    int int_mask;
    int ret;
    if (qcdev.state == QUICKI2C_DISABLED)
    return IRQ_HANDLED;
...
//
#[no_mangle]
unsafe extern "C" fn quicki2c_dev_deinit(qcdev: *mut quicki2c_device) {
...
//
#[no_mangle]
unsafe extern "C" fn quicki2c_dma_adv_enable(qcdev: *mut quicki2c_device) {
...
//
#[no_mangle]
unsafe extern "C" fn quicki2c_dma_adv_disable(qcdev: *mut quicki2c_device) {
...
//
#[no_mangle]
unsafe extern "C" fn quicki2c_dma_init(qcdev: *mut quicki2c_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn quicki2c_dma_deinit(qcdev: *mut quicki2c_device) {
...
//
#[no_mangle]
unsafe extern "C" fn quicki2c_alloc_report_buf(qcdev: *mut quicki2c_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn quicki2c_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn quicki2c_remove(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quicki2c_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quicki2c_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quicki2c_resume(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quicki2c_freeze(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quicki2c_thaw(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quicki2c_poweroff(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quicki2c_restore(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quicki2c_runtime_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quicki2c_runtime_resume(device: *mut device) -> c_int {
    ...
    .runtime_idle = core::ptr::null_mut(),
    };
    static const struct pci_device_id quicki2c_pci_tbl[] = {
    { PCI_DEVICE_DATA(INTEL, THC_LNL_DEVICE_ID_I2C_PORT1, core::ptr::null_mut()) },
    { PCI_DEVICE_DATA(INTEL, THC_LNL_DEVICE_ID_I2C_PORT2, core::ptr::null_mut()) },
