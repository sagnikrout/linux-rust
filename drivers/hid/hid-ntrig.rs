...
//! Source: drivers/hid/hid-ntrig.c
#![no_std]
...
pub const NTRIG_DUPLICATE_USAGES: c_uint = 0x001;
    ...
    let mut activate_slack: static unsigned int = 1;
...
//
#[no_mangle]
unsafe extern "C" fn ntrig_version_string(raw: *mut c_uchar, buf: *mut c_char) -> c_int {
    static int ntrig_version_string(unsigned char *raw, char *buf)
    {
    let mut a: __u8 = (raw[1] & 0x0e) >> 1;
    let mut b: __u8 = (raw[0] & 0x3c) >> 2;
    let mut c: __u8 = ((raw[0] & 0x03) << 3) | ((raw[3] & 0xe0) >> 5);
    let mut d: __u8 = ((raw[3] & 0x07) << 3) | ((raw[2] & 0xe0) >> 5);
    let mut e: __u8 = raw[2] & 0x07;
//
...
#[no_mangle]
pub unsafe extern "C" fn ntrig_get_mode(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ntrig_set_mode(hdev: *mut hid_device, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ntrig_report_version(hdev: *mut hid_device) {
    ...
    static DEVICE_ATTR(sensor_physical_width, S_IRUGO, show_phys_width, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(sensor_physical_height, S_IRUGO, show_phys_height, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(sensor_logical_width, S_IRUGO, show_log_width, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(sensor_logical_height, S_IRUGO, show_log_height, core::ptr::null_mut());
...
//
    nd.act_state = 0;
#[no_mangle]
pub unsafe extern "C" fn if(nd->deactivate_slack: nd->act_state <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn ntrig_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntrig_remove(hdev: *mut hid_device) {
