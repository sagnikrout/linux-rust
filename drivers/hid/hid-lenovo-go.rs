...
//! Source: drivers/hid/hid-lenovo-go.c
#![no_std]
...
pub const GO_GP_INTF_IN: c_uint = 0x83;
pub const GO_OUTPUT_REPORT_ID: c_uint = 0x05;
pub const GO_GP_RESET_SUCCESS: c_uint = 0x01;
pub const GO_PACKET_SIZE: c_int = 64;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct go_cfg_attr {
    pub index: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct command_report {
    pub report_id: u8,
    pub id: u8,
    pub cmd: u8,
    pub sub_cmd: u8,
...
pub const FEATURE_OS_MODE: c_uint = 0x69;
...
pub const FPS_MODE_DPI: c_uint = 0x02;
pub const TRIGGER_CALIBRATE: c_uint = 0x04;
pub const JOYSTICK_CALIBRATE: c_uint = 0x04;
pub const GYRO_CALIBRATE: c_uint = 0x06;
...
#[no_mangle]
unsafe extern "C" fn hid_go_version_event(cmd_rep: *mut command_report) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_go_feature_status_event(cmd_rep: *mut command_report) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_go_motor_event(cmd_rep: *mut command_report) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_go_fps_dpi_event(cmd_rep: *mut command_report) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_go_light_event(cmd_rep: *mut command_report) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_go_device_status_event(cmd_rep: *mut command_report) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_go_os_mode_cfg_event(cmd_rep: *mut command_report) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_go_set_event_return(cmd_rep: *mut command_report) -> c_int {
...
// We can't use a devm_alloc reusable buffer without side effects during suspend
    ...
    index, device_type, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
    switch (index) {
    case PRODUCT_VERSION:
    ...
    u8 i;
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA,
    GET_FEATURE_STATUS, index, device_type, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
    switch (index) {
    case FEATURE_IMU_ENABLE:
    ...
    FPS_MODE_DPI, UNSPECIFIED, core::ptr::null_mut(), 0);
    if (ret < 0)
    return ret;
    ...
    u8 i;
    ret = mcu_property_out(drvdata.hdev, OS_MODE_DATA, FEATURE_OS_MODE,
    GET_OS_MODE, USB_MCU, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
    i = drvdata.os_mode;
...
#[no_mangle]
unsafe extern "C" fn rgb_attr_show() -> c_int {
    static int rgb_attr_show(void)
    {
    enum rgb_config_index index;
    index = drvdata.rgb_profile + 3;
    return rgb_cfg_call(drvdata.hdev, GET_RGB_CFG, index, core::ptr::null_mut(), 0);
    }
...
// This is a delay setting, invert logic for consistency with other drivers
    ...
    {
    int ret;
    ret = rgb_cfg_call(drvdata.hdev, GET_RGB_CFG, LIGHT_MODE_SEL, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
    ...
    {
    int ret;
    ret = rgb_cfg_call(drvdata.hdev, GET_RGB_CFG, LIGHT_PROFILE_SEL, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR_RW_NAMED(_arg: _name, _arg: _attrname) -> static {
...
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR_WO_NAMED(_arg: _name, _arg: _attrname) -> static {
...
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR_RO_NAMED(_arg: _name, _arg: _attrname) -> static {
...
pub unsafe extern "C" fn DEVICE_ATTR_RO_NAMED(_arg: _name, _arg: _attrname) -> static {
    static DEVICE_ATTR_RO_NAMED(_name, _attrname)
// Gamepad - MCU
    let mut version_product_mcu: static struct go_cfg_attr = { PRODUCT_VERSION };
    LEGO_DEVICE_ATTR_RO(version_product_mcu, "product_version", USB_MCU, version);
    let mut version_protocol_mcu: static struct go_cfg_attr = { PROTOCOL_VERSION };
    LEGO_DEVICE_ATTR_RO(version_protocol_mcu, "protocol_version", USB_MCU, version);
    let mut version_firmware_mcu: static struct go_cfg_attr = { FIRMWARE_VERSION };
    LEGO_DEVICE_ATTR_RO(version_firmware_mcu, "firmware_version", USB_MCU, version);
    let mut version_hardware_mcu: static struct go_cfg_attr = { HARDWARE_VERSION };
    LEGO_DEVICE_ATTR_RO(version_hardware_mcu, "hardware_version", USB_MCU, version);
    let mut version_gen_mcu: static struct go_cfg_attr = { HARDWARE_GENERATION };
    LEGO_DEVICE_ATTR_RO(version_gen_mcu, "hardware_generation", USB_MCU, version);
    let mut fps_switch_status: static struct go_cfg_attr = { FEATURE_FPS_SWITCH_STATUS };
    LEGO_DEVICE_ATTR_RO(fps_switch_status, "fps_switch_status", UNSPECIFIED,
    feature_status);
    let mut gamepad_mode: static struct go_cfg_attr = { FEATURE_GAMEPAD_MODE };
    ...
    let mut reset_mcu: static struct go_cfg_attr = { FEATURE_RESET_GAMEPAD };
    LEGO_DEVICE_ATTR_WO(reset_mcu, "reset_mcu", USB_MCU, feature_status);
    let mut gamepad_rumble_intensity: static struct go_cfg_attr = { MOTOR_INTENSITY };
...
// Gamepad - TX Dongle
    let mut version_product_tx_dongle: static struct go_cfg_attr = { PRODUCT_VERSION };
    LEGO_DEVICE_ATTR_RO(version_product_tx_dongle, "product_version", TX_DONGLE, version);
    let mut version_protocol_tx_dongle: static struct go_cfg_attr = { PROTOCOL_VERSION };
    LEGO_DEVICE_ATTR_RO(version_protocol_tx_dongle, "protocol_version", TX_DONGLE, version);
    let mut version_firmware_tx_dongle: static struct go_cfg_attr = { FIRMWARE_VERSION };
    LEGO_DEVICE_ATTR_RO(version_firmware_tx_dongle, "firmware_version", TX_DONGLE, version);
    let mut version_hardware_tx_dongle: static struct go_cfg_attr = { HARDWARE_VERSION };
    LEGO_DEVICE_ATTR_RO(version_hardware_tx_dongle, "hardware_version", TX_DONGLE, version);
    let mut version_gen_tx_dongle: static struct go_cfg_attr = { HARDWARE_GENERATION };
    LEGO_DEVICE_ATTR_RO(version_gen_tx_dongle, "hardware_generation", TX_DONGLE, version);
    let mut reset_tx_dongle: static struct go_cfg_attr = { FEATURE_RESET_GAMEPAD };
...
// Gamepad - Left
    let mut version_product_left: static struct go_cfg_attr = { PRODUCT_VERSION };
    LEGO_DEVICE_ATTR_RO(version_product_left, "product_version", LEFT_CONTROLLER, version);
    let mut version_protocol_left: static struct go_cfg_attr = { PROTOCOL_VERSION };
    LEGO_DEVICE_ATTR_RO(version_protocol_left, "protocol_version", LEFT_CONTROLLER, version);
    let mut version_firmware_left: static struct go_cfg_attr = { FIRMWARE_VERSION };
    LEGO_DEVICE_ATTR_RO(version_firmware_left, "firmware_version", LEFT_CONTROLLER, version);
    let mut version_hardware_left: static struct go_cfg_attr = { HARDWARE_VERSION };
    LEGO_DEVICE_ATTR_RO(version_hardware_left, "hardware_version", LEFT_CONTROLLER, version);
    let mut version_gen_left: static struct go_cfg_attr = { HARDWARE_GENERATION };
    LEGO_DEVICE_ATTR_RO(version_gen_left, "hardware_generation", LEFT_CONTROLLER, version);
    let mut auto_sleep_time_left: static struct go_cfg_attr = { FEATURE_AUTO_SLEEP_TIME };
    ...
    let mut imu_bypass_left: static struct go_cfg_attr = { FEATURE_IMU_BYPASS };
    ...
    let mut imu_enabled_left: static struct go_cfg_attr = { FEATURE_IMU_ENABLE };
    ...
    let mut reset_left: static struct go_cfg_attr = { FEATURE_RESET_GAMEPAD };
    LEGO_DEVICE_ATTR_WO(reset_left, "reset", LEFT_CONTROLLER, feature_status);
    let mut rumble_mode_left: static struct go_cfg_attr = { RUMBLE_MODE };
    ...
    let mut rumble_notification_left: static struct go_cfg_attr = { VIBRATION_NOTIFY_ENABLE };
    ...
    let mut cal_trigg_left: static struct go_cfg_attr = { TRIGGER_CALIBRATE };
    ...
    let mut cal_joy_left: static struct go_cfg_attr = { JOYSTICK_CALIBRATE };
    ...
    let mut cal_gyro_left: static struct go_cfg_attr = { GYRO_CALIBRATE };
    ...
    let mut cal_trigg_left_status: static struct go_cfg_attr = { GET_CAL_STATUS };
    LEGO_DEVICE_STATUS_ATTR(cal_trigg_left_status, "calibrate_trigger_status",
    LEFT_CONTROLLER, CALDEV_TRIGGER);
    let mut cal_joy_left_status: static struct go_cfg_attr = { GET_CAL_STATUS };
    LEGO_DEVICE_STATUS_ATTR(cal_joy_left_status, "calibrate_joystick_status",
    LEFT_CONTROLLER, CALDEV_JOYSTICK);
    let mut cal_gyro_left_status: static struct go_cfg_attr = { GET_CAL_STATUS };
...
// Gamepad - Right
    let mut version_product_right: static struct go_cfg_attr = { PRODUCT_VERSION };
    LEGO_DEVICE_ATTR_RO(version_product_right, "product_version", RIGHT_CONTROLLER, version);
    let mut version_protocol_right: static struct go_cfg_attr = { PROTOCOL_VERSION };
    LEGO_DEVICE_ATTR_RO(version_protocol_right, "protocol_version", RIGHT_CONTROLLER, version);
    let mut version_firmware_right: static struct go_cfg_attr = { FIRMWARE_VERSION };
    LEGO_DEVICE_ATTR_RO(version_firmware_right, "firmware_version", RIGHT_CONTROLLER, version);
    let mut version_hardware_right: static struct go_cfg_attr = { HARDWARE_VERSION };
    LEGO_DEVICE_ATTR_RO(version_hardware_right, "hardware_version", RIGHT_CONTROLLER, version);
    let mut version_gen_right: static struct go_cfg_attr = { HARDWARE_GENERATION };
    LEGO_DEVICE_ATTR_RO(version_gen_right, "hardware_generation", RIGHT_CONTROLLER, version);
    let mut auto_sleep_time_right: static struct go_cfg_attr = { FEATURE_AUTO_SLEEP_TIME };
    ...
    "auto_sleep_time_range");
    let mut imu_bypass_right: static struct go_cfg_attr = { FEATURE_IMU_BYPASS };
    ...
    let mut imu_enabled_right: static struct go_cfg_attr = { FEATURE_IMU_BYPASS };
    ...
    let mut reset_right: static struct go_cfg_attr = { FEATURE_RESET_GAMEPAD };
    LEGO_DEVICE_ATTR_WO(reset_right, "reset", LEFT_CONTROLLER, feature_status);
    let mut rumble_mode_right: static struct go_cfg_attr = { RUMBLE_MODE };
    ...
    let mut rumble_notification_right: static struct go_cfg_attr = { VIBRATION_NOTIFY_ENABLE };
    ...
    "rumble_notification_index");
    let mut cal_trigg_right: static struct go_cfg_attr = { TRIGGER_CALIBRATE };
    ...
    let mut cal_joy_right: static struct go_cfg_attr = { JOYSTICK_CALIBRATE };
    ...
    let mut cal_gyro_right: static struct go_cfg_attr = { GYRO_CALIBRATE };
    ...
    let mut cal_trigg_right_status: static struct go_cfg_attr = { GET_CAL_STATUS };
    LEGO_DEVICE_STATUS_ATTR(cal_trigg_right_status, "calibrate_trigger_status",
    RIGHT_CONTROLLER, CALDEV_TRIGGER);
    let mut cal_joy_right_status: static struct go_cfg_attr = { GET_CAL_STATUS };
    LEGO_DEVICE_STATUS_ATTR(cal_joy_right_status, "calibrate_joystick_status",
    RIGHT_CONTROLLER, CALDEV_JOYSTICK);
    let mut cal_gyro_right_status: static struct go_cfg_attr = { GET_CAL_STATUS };
...
// Touchpad
    let mut touchpad_enabled: static struct go_cfg_attr = { FEATURE_TOUCHPAD_ENABLE };
    ...
    let mut touchpad_vibration_enabled: static struct go_cfg_attr = { TP_VIBRATION_ENABLE };
    ...
    let mut touchpad_vibration_intensity: static struct go_cfg_attr = { TP_VIBRATION_INTENSITY };
    ...
    &touchpad_attr_group,	  core::ptr::null_mut(),
    };
// RGB
    let mut rgb_enabled: static struct go_cfg_attr = { FEATURE_LIGHT_ENABLE };
...
#[no_mangle]
unsafe extern "C" fn cfg_setup(work: *mut work_struct) {
    static void cfg_setup(struct work_struct *work)
    {
    int ret;
// MCU Version Attrs
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    PRODUCT_VERSION, USB_MCU, core::ptr::null_mut(), 0);
    if (ret < 0) {
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    PROTOCOL_VERSION, USB_MCU, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    FIRMWARE_VERSION, USB_MCU, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    HARDWARE_VERSION, USB_MCU, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    HARDWARE_GENERATION, USB_MCU, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
...
// TX Dongle Version Attrs
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    PRODUCT_VERSION, TX_DONGLE, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    PROTOCOL_VERSION, TX_DONGLE, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    FIRMWARE_VERSION, TX_DONGLE, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    HARDWARE_VERSION, TX_DONGLE, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    HARDWARE_GENERATION, TX_DONGLE, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
...
// Left Handle Version Attrs
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    PRODUCT_VERSION, LEFT_CONTROLLER, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    PROTOCOL_VERSION, LEFT_CONTROLLER, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    FIRMWARE_VERSION, LEFT_CONTROLLER, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    HARDWARE_VERSION, LEFT_CONTROLLER, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    HARDWARE_GENERATION, LEFT_CONTROLLER, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
...
// Right Handle Version Attrs
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    PRODUCT_VERSION, RIGHT_CONTROLLER, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    PROTOCOL_VERSION, RIGHT_CONTROLLER, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    FIRMWARE_VERSION, RIGHT_CONTROLLER, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    HARDWARE_VERSION, RIGHT_CONTROLLER, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
    ...
    ret = mcu_property_out(drvdata.hdev, MCU_CONFIG_DATA, GET_VERSION_DATA,
    HARDWARE_GENERATION, RIGHT_CONTROLLER, core::ptr::null_mut(), 0);
    if (ret < 0) {
    dev_err(&drvdata.hdev.dev,
...
#[no_mangle]
unsafe extern "C" fn hid_go_cfg_remove(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn hid_go_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_go_remove(hdev: *mut hid_device) {
    static void hid_go_remove(struct hid_device *hdev)
    {
    let mut ep: c_int = get_endpoint_address(hdev);
    if (ep <= 0)
    return;
    switch (ep) {
    case GO_GP_INTF_IN:
