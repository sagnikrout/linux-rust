...
//! Source: drivers/hid/hid-nintendo.c
#![no_std]
...
//
// Output Reports
pub const JC_OUTPUT_RUMBLE_AND_SUBCMD: c_uint = 0x01;
pub const JC_OUTPUT_FW_UPDATE_PKT: c_uint = 0x03;
pub const JC_OUTPUT_RUMBLE_ONLY: c_uint = 0x10;
pub const JC_OUTPUT_MCU_DATA: c_uint = 0x11;
pub const JC_OUTPUT_USB_CMD: c_uint = 0x80;
// Subcommand IDs
pub const JC_SUBCMD_STATE: c_uint = 0x00;
pub const JC_SUBCMD_MANUAL_BT_PAIRING: c_uint = 0x01;
pub const JC_SUBCMD_REQ_DEV_INFO: c_uint = 0x02;
pub const JC_SUBCMD_SET_REPORT_MODE: c_uint = 0x03;
pub const JC_SUBCMD_TRIGGERS_ELAPSED: c_uint = 0x04;
pub const JC_SUBCMD_GET_PAGE_LIST_STATE: c_uint = 0x05;
pub const JC_SUBCMD_SET_HCI_STATE: c_uint = 0x06;
pub const JC_SUBCMD_RESET_PAIRING_INFO: c_uint = 0x07;
pub const JC_SUBCMD_LOW_POWER_MODE: c_uint = 0x08;
pub const JC_SUBCMD_SPI_FLASH_READ: c_uint = 0x10;
pub const JC_SUBCMD_SPI_FLASH_WRITE: c_uint = 0x11;
pub const JC_SUBCMD_RESET_MCU: c_uint = 0x20;
pub const JC_SUBCMD_SET_MCU_CONFIG: c_uint = 0x21;
pub const JC_SUBCMD_SET_MCU_STATE: c_uint = 0x22;
pub const JC_SUBCMD_SET_PLAYER_LIGHTS: c_uint = 0x30;
pub const JC_SUBCMD_GET_PLAYER_LIGHTS: c_uint = 0x31;
pub const JC_SUBCMD_SET_HOME_LIGHT: c_uint = 0x38;
pub const JC_SUBCMD_ENABLE_IMU: c_uint = 0x40;
pub const JC_SUBCMD_SET_IMU_SENSITIVITY: c_uint = 0x41;
pub const JC_SUBCMD_WRITE_IMU_REG: c_uint = 0x42;
pub const JC_SUBCMD_READ_IMU_REG: c_uint = 0x43;
pub const JC_SUBCMD_ENABLE_VIBRATION: c_uint = 0x48;
pub const JC_SUBCMD_GET_REGULATED_VOLTAGE: c_uint = 0x50;
// Input Reports
pub const JC_INPUT_BUTTON_EVENT: c_uint = 0x3F;
pub const JC_INPUT_SUBCMD_REPLY: c_uint = 0x21;
pub const JC_INPUT_IMU_DATA: c_uint = 0x30;
pub const JC_INPUT_MCU_DATA: c_uint = 0x31;
pub const JC_INPUT_USB_RESPONSE: c_uint = 0x81;
// Feature Reports
pub const JC_FEATURE_LAST_SUBCMD: c_uint = 0x02;
pub const JC_FEATURE_OTA_FW_UPGRADE: c_uint = 0x70;
pub const JC_FEATURE_SETUP_MEM_READ: c_uint = 0x71;
pub const JC_FEATURE_MEM_READ: c_uint = 0x72;
pub const JC_FEATURE_ERASE_MEM_SECTOR: c_uint = 0x73;
pub const JC_FEATURE_MEM_WRITE: c_uint = 0x74;
pub const JC_FEATURE_LAUNCH: c_uint = 0x75;
// USB Commands
pub const JC_USB_CMD_CONN_STATUS: c_uint = 0x01;
pub const JC_USB_CMD_HANDSHAKE: c_uint = 0x02;
pub const JC_USB_CMD_BAUDRATE_3M: c_uint = 0x03;
pub const JC_USB_CMD_NO_TIMEOUT: c_uint = 0x04;
pub const JC_USB_CMD_EN_TIMEOUT: c_uint = 0x05;
pub const JC_USB_RESET: c_uint = 0x06;
pub const JC_USB_PRE_HANDSHAKE: c_uint = 0x91;
pub const JC_USB_SEND_UART: c_uint = 0x92;
// Magic value denoting presence of user calibration
pub const JC_CAL_USR_MAGIC_0: c_uint = 0xB2;
pub const JC_CAL_USR_MAGIC_1: c_uint = 0xA1;
pub const JC_CAL_USR_MAGIC_SIZE: c_int = 2;
// SPI storage addresses of user calibration data
pub const JC_CAL_USR_LEFT_MAGIC_ADDR: c_uint = 0x8010;
pub const JC_CAL_USR_LEFT_DATA_ADDR: c_uint = 0x8012;
pub const JC_CAL_USR_LEFT_DATA_END: c_uint = 0x801A;
pub const JC_CAL_USR_RIGHT_MAGIC_ADDR: c_uint = 0x801B;
pub const JC_CAL_USR_RIGHT_DATA_ADDR: c_uint = 0x801D;

    (JC_CAL_USR_LEFT_DATA_END - JC_CAL_USR_LEFT_DATA_ADDR + 1)
// SPI storage addresses of factory calibration data
pub const JC_CAL_FCT_DATA_LEFT_ADDR: c_uint = 0x603d;
pub const JC_CAL_FCT_DATA_RIGHT_ADDR: c_uint = 0x6046;
// SPI storage addresses of IMU factory calibration data
pub const JC_IMU_CAL_FCT_DATA_ADDR: c_uint = 0x6020;
pub const JC_IMU_CAL_FCT_DATA_END: c_uint = 0x6037;

    (JC_IMU_CAL_FCT_DATA_END - JC_IMU_CAL_FCT_DATA_ADDR + 1)
// SPI storage addresses of IMU user calibration data
pub const JC_IMU_CAL_USR_MAGIC_ADDR: c_uint = 0x8026;
pub const JC_IMU_CAL_USR_DATA_ADDR: c_uint = 0x8028;
// The raw analog joystick values will be mapped in terms of this magnitude
pub const JC_MAX_STICK_MAG: c_int = 32767;
pub const JC_STICK_FUZZ: c_int = 250;
pub const JC_STICK_FLAT: c_int = 500;
// Hat values for pro controller's d-pad
pub const JC_MAX_DPAD_MAG: c_int = 1;
pub const JC_DPAD_FUZZ: c_int = 0;
pub const JC_DPAD_FLAT: c_int = 0;
// Under most circumstances IMU reports are pushed every 15ms; use as default
pub const JC_IMU_DFLT_AVG_DELTA_MS: c_int = 15;
// How many samples to sum before calculating average IMU report delta
pub const JC_IMU_SAMPLES_PER_DELTA_AVG: c_int = 300;
// Controls how many dropped IMU packets at once trigger a warning message
pub const JC_IMU_DROPPED_PKT_WARNING: c_int = 3;
//
...
//
pub const JC_IMU_MAX_ACCEL_MAG: c_int = 32767;
pub const JC_IMU_ACCEL_RES_PER_G: c_int = 4096;
pub const JC_IMU_ACCEL_FUZZ: c_int = 10;
pub const JC_IMU_ACCEL_FLAT: c_int = 0;
//
...
//
pub const JC_IMU_PREC_RANGE_SCALE: c_int = 1000;
// Note: change mag and res_per_dps if prec_range_scale is ever altered

pub const JC_IMU_GYRO_FUZZ: c_int = 10;
pub const JC_IMU_GYRO_FLAT: c_int = 0;
// frequency/amplitude tables for rumble
#[repr(C)]
#[derive(Copy, Clone)]
pub struct joycon_rumble_freq_data {
    pub high: u16,
    pub low: u8,
    pub Hz*/: *mut *mut u16 freq; /,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct joycon_rumble_amp_data {
    pub high: u8,
    pub low: u16,
    pub amp: u16,
}
...
// high, low, amp
    ...
    let mut JC_RUMBLE_DFLT_LOW_FREQ: static u16 = 160;
    let mut JC_RUMBLE_DFLT_HIGH_FREQ: static u16 = 320;
    let mut JC_RUMBLE_ZERO_AMP_PKT_CNT: static unsigned short = 5;

    let mut JC_RUMBLE_PERIOD_MS: static u16 = 50;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct joycon_ctlr_button_mapping {
    pub code: u32,
    pub bit: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct joycon_rumble_output {
    pub output_id: u8,
    pub packet_num: u8,
    pub rumble_data: [u8; 8],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct joycon_subcmd_request {
    pub /: *mut *mut u8 output_id; / must be 0x01 for subcommand, 0x10 for rumble only,
    pub /: *mut *mut u8 packet_num; / incremented every send,
    pub rumble_data: [u8; 8],
    pub subcmd_id: u8,
    pub /: *mut *mut u8 data[]; / length depends on the subcommand,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct joycon_subcmd_reply {
    pub /: *mut *mut u8 ack; / MSB 1 for ACK, 0 for NACK,
    pub /: *mut *mut u8 id; / id of requested subcmd,
    pub /: *mut *mut u8 data[]; / will be at most 35 bytes,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct joycon_imu_data {
    pub accel_x: i16,
    pub accel_y: i16,
    pub accel_z: i16,
    pub gyro_x: i16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct joycon_input_report {
    pub id: u8,
    pub timer: u8,
    pub /: *mut *mut u8 bat_con; / battery and connection info,
    pub button_status: [u8; 3],
    pub left_stick: [u8; 3],
    pub right_stick: [u8; 3],
    pub vibrator_report: u8,
    union {
    pub subcmd_reply: joycon_subcmd_reply,
// IMU input reports contain 3 samples
    pub 3]: *mut *mut u8 imu_raw_bytes[sizeof(struct joycon_imu_data),
}

    } __packed;

pub const JC_RUMBLE_DATA_SIZE: c_int = 8;
pub const JC_RUMBLE_QUEUE_SIZE: c_int = 8;
...
pub const JC_NUM_LED_PATTERNS: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct joycon_ctlr {
    pub hdev: *mut hid_device,
    pub input: *mut input_dev,
    pub player_id: u32,
    pub /: *mut *mut led_classdev leds[JC_NUM_LEDS]; / player leds,
    pub home_led: led_classdev,
    pub ctlr_state: enum joycon_ctlr_state,
    pub lock: spinlock_t,
    pub mac_addr: [u8; 6],
    pub mac_addr_str: *mut c_char,
    pub ctlr_type: enum joycon_ctlr_type,
// The following members are used for synchronous sends/receives
    pub msg_type: enum joycon_msg_type,
    pub subcmd_num: u8,
    pub output_mutex: mutex,
    pub input_buf: [u8; JC_MAX_RESP_SIZE],
    pub wait: wait_queue_head_t,
    pub received_resp: bool,
    pub usb_ack_match: u8,
    pub subcmd_ack_match: u8,
    pub received_input_report: bool,
    pub last_input_report_msecs: c_uint,
    pub last_subcmd_sent_msecs: c_uint,
    pub consecutive_valid_report_deltas: c_uint,
    pub subcmd_rate_exhaustions: c_uint,
    pub subcmd_rate_relaxed: bool,
// factory calibration data
    pub left_stick_cal_x: joycon_stick_cal,
    pub left_stick_cal_y: joycon_stick_cal,
    pub right_stick_cal_x: joycon_stick_cal,
    pub right_stick_cal_y: joycon_stick_cal,
    pub accel_cal: joycon_imu_cal,
    pub gyro_cal: joycon_imu_cal,
// prevents needlessly recalculating these divisors every sample
    pub imu_cal_accel_divisor: [i32; 3],
    pub imu_cal_gyro_divisor: [i32; 3],
// power supply data
    pub battery: *mut power_supply,
    pub battery_desc: power_supply_desc,
    pub battery_capacity: u8,
    pub battery_charging: bool,
    pub host_powered: bool,
// rumble
    pub rumble_data: [u8; JC_RUMBLE_QUEUE_SIZE][JC_RUMBLE_DATA_SIZE],
    pub rumble_queue_head: c_int,
    pub rumble_queue_tail: c_int,
    pub rumble_queue: *mut workqueue_struct,
    pub rumble_worker: work_struct,
    pub rumble_msecs: c_uint,
    pub rumble_ll_freq: u16,
    pub rumble_lh_freq: u16,
    pub rumble_rl_freq: u16,
    pub rumble_rh_freq: u16,
    pub rumble_zero_countdown: c_ushort,
// imu
    pub imu_input: *mut input_dev,
    pub /: *mut *mut bool imu_first_packet_received; / helps in initiating timestamp,
    pub /: *mut *mut unsigned int imu_timestamp_us; / timestamp we report to userspace,
    pub /: *mut *mut unsigned int imu_last_pkt_ms; / used to calc imu report delta,
// the following are used to track the average imu report time delta
    pub imu_delta_samples_count: c_uint,
    pub imu_delta_samples_sum: c_uint,
    pub imu_avg_delta_ms: c_uint,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn joycon_device_is_chrggrip(ctlr: *mut joycon_ctlr) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn joycon_type_is_any_nescon(ctlr: *mut joycon_ctlr) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn joycon_has_imu(ctlr: *mut joycon_ctlr) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn joycon_has_joysticks(ctlr: *mut joycon_ctlr) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn joycon_has_rumble(ctlr: *mut joycon_ctlr) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn joycon_using_usb(ctlr: *mut joycon_ctlr) -> bool {
    static inline bool joycon_using_usb(struct joycon_ctlr *ctlr)
    {
    return ctlr.hdev.bus == BUS_USB;
    }
#[no_mangle]
unsafe extern "C" fn __joycon_hid_send(hdev: *mut hid_device, data: *mut u8, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn joycon_wait_for_input_report(ctlr: *mut joycon_ctlr) {
...
//
pub const JC_INPUT_REPORT_MIN_DELTA: c_int = 8;
pub const JC_INPUT_REPORT_MAX_DELTA: c_int = 17;
pub const JC_SUBCMD_TX_OFFSET_MS: c_int = 4;
pub const JC_SUBCMD_VALID_DELTA_REQ: c_int = 3;
pub const JC_SUBCMD_RATE_MAX_ATTEMPTS: c_int = 25;
pub const JC_SUBCMD_RATE_MAX_FAILURES: c_int = 4;
pub const JC_SUBCMD_RATE_LIMITER_USB_MS: c_int = 20;
pub const JC_SUBCMD_RATE_LIMITER_BT_MS: c_int = 60;

#[no_mangle]
unsafe extern "C" fn joycon_enforce_subcmd_rate_strict(ctlr: *mut joycon_ctlr) {
    static void joycon_enforce_subcmd_rate_strict(struct joycon_ctlr *ctlr)
    {
    unsigned int current_ms;
    unsigned long subcmd_delta;
    let mut consecutive_valid_deltas: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn joycon_enforce_subcmd_rate_legacy(ctlr: *mut joycon_ctlr) {
    static void joycon_enforce_subcmd_rate_legacy(struct joycon_ctlr *ctlr)
    {
    let mut max_subcmd_rate_ms: static unsigned int = 25;
    let mut current_ms: c_uint = jiffies_to_msecs(jiffies);
    let mut delta_ms: c_uint = current_ms - ctlr.last_subcmd_sent_msecs;
...
#[no_mangle]
unsafe extern "C" fn joycon_enforce_subcmd_rate(ctlr: *mut joycon_ctlr) {
...
#[no_mangle]
unsafe extern "C" fn joycon_send_usb(ctlr: *mut joycon_ctlr, cmd: u8, timeout: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn joycon_set_player_leds(ctlr: *mut joycon_ctlr, flash: u8, on: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn joycon_set_home_led(ctlr: *mut joycon_ctlr, brightness: enum led_brightness) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn joycon_check_for_cal_magic(ctlr: *mut joycon_ctlr, flash_addr: u32) -> c_int {
...
// check if calibration values are plausible
    ...
    let mut DFLT_STICK_CAL_CEN: static u16 = 2000;
    let mut DFLT_STICK_CAL_MAX: static u16 = 3500;
    let mut DFLT_STICK_CAL_MIN: static u16 = 500;
...
#[no_mangle]
unsafe extern "C" fn joycon_request_calibration(ctlr: *mut joycon_ctlr) -> c_int {
    static int joycon_request_calibration(struct joycon_ctlr *ctlr)
    {
    let mut left_stick_addr: u16 = JC_CAL_FCT_DATA_LEFT_ADDR;
    let mut right_stick_addr: u16 = JC_CAL_FCT_DATA_RIGHT_ADDR;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn joycon_calc_imu_cal_divisors(ctlr: *mut joycon_ctlr) {
    ...
    let mut DFLT_ACCEL_SCALE: static s16 = 16384;
    static const s16 DFLT_GYRO_OFFSET /*= 0*/;
    let mut DFLT_GYRO_SCALE: static s16 = 13371;
#[no_mangle]
unsafe extern "C" fn joycon_request_imu_calibration(ctlr: *mut joycon_ctlr) -> c_int {
    static int joycon_request_imu_calibration(struct joycon_ctlr *ctlr)
    {
    let mut imu_cal_addr: u16 = JC_IMU_CAL_FCT_DATA_ADDR;
    u8 *raw_cal;
    int ret;
    int i;
...
#[no_mangle]
unsafe extern "C" fn joycon_set_report_mode(ctlr: *mut joycon_ctlr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn joycon_enable_rumble(ctlr: *mut joycon_ctlr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn joycon_enable_imu(ctlr: *mut joycon_ctlr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn joycon_map_stick_val(cal: *mut joycon_stick_cal, val: i32) -> i32 {
    static s32 joycon_map_stick_val(struct joycon_stick_cal *cal, s32 val)
    {
    let mut center: i32 = cal.center;
    let mut min: i32 = cal.min;
    let mut max: i32 = cal.max;
    s32 new_val;
    if (val > center) {
...
// point to next imu sample
    ...
    let mut msecs: c_uint = jiffies_to_msecs(jiffies);
    let mut last_msecs: c_uint = ctlr.imu_last_pkt_ms;
    int i;
    int value[6];
...
//
    ...
    let mut delta: c_uint = msecs - last_msecs;
...
#[no_mangle]
unsafe extern "C" fn joycon_handle_rumble_report(ctlr: *mut joycon_ctlr, rep: *mut joycon_input_report) {
    static void joycon_handle_rumble_report(struct joycon_ctlr *ctlr, struct joycon_input_report *rep)
    {
    unsigned long flags;
    let mut msecs: c_ulong = jiffies_to_msecs(jiffies);
    spin_lock_irqsave(&ctlr.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn joycon_parse_battery_status(ctlr: *mut joycon_ctlr, rep: *mut joycon_input_report) {
    ...
    struct joycon_input_report *rep)
    {
    let mut hatx: c_int = 0;
    let mut haty: c_int = 0;
    let mut btns: u32 = hid_field_extract(ctlr.hdev, rep.button_status, 0, 24);
    if (btns & JC_BTN_LEFT)
    hatx = -1;
#[no_mangle]
pub unsafe extern "C" fn if(JC_BTN_RIGHT: btns &) -> else {
    else if (btns & JC_BTN_RIGHT)
    hatx = 1;
    if (btns & JC_BTN_UP)
    haty = -1;
#[no_mangle]
pub unsafe extern "C" fn if(JC_BTN_DOWN: btns &) -> else {
    ...
    let mut status: u32 = hid_field_extract(ctlr.hdev, rep.button_status, 0, 24);
    ...
    unsigned long flags;
    let mut msecs: c_ulong = jiffies_to_msecs(jiffies);
    let mut report_delta_ms: c_ulong = msecs - ctlr.last_input_report_msecs;
...
#[no_mangle]
unsafe extern "C" fn joycon_send_rumble_data(ctlr: *mut joycon_ctlr) -> c_int {
    static int joycon_send_rumble_data(struct joycon_ctlr *ctlr)
    {
    int ret;
    unsigned long flags;
    let mut rumble_output: joycon_rumble_output = { 0 };
    spin_lock_irqsave(&ctlr.lock, flags);
//
// If the controller has been removed, just return ENODEV so the LED
// subsystem doesn't print invalid errors on removal.
...
#[no_mangle]
unsafe extern "C" fn joycon_rumble_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn joycon_find_rumble_freq(freq: u16) -> joycon_rumble_freq_data {
    static struct joycon_rumble_freq_data joycon_find_rumble_freq(u16 freq)
    {
    let mut length: usize = ARRAY_SIZE(joycon_rumble_frequencies);
...
#[no_mangle]
unsafe extern "C" fn joycon_find_rumble_amp(amp: u16) -> joycon_rumble_amp_data {
    static struct joycon_rumble_amp_data joycon_find_rumble_amp(u16 amp)
    {
    let mut length: usize = ARRAY_SIZE(joycon_rumble_amplitudes);
...
#[no_mangle]
unsafe extern "C" fn joycon_encode_rumble(data: *mut u8, freq_low: u16, freq_high: u16, amp: u16) {
    ...
    let mut JOYCON_MAX_RUMBLE_HIGH_FREQ: static u16 = 1253;
    let mut JOYCON_MIN_RUMBLE_HIGH_FREQ: static u16 = 82;
    let mut JOYCON_MAX_RUMBLE_LOW_FREQ: static u16 = 626;
    let mut JOYCON_MIN_RUMBLE_LOW_FREQ: static u16 = 41;
#[no_mangle]
unsafe extern "C" fn joycon_clamp_rumble_freqs(ctlr: *mut joycon_ctlr) {
...
#[no_mangle]
unsafe extern "C" fn joycon_config_left_stick(idev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn joycon_config_right_stick(idev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn joycon_config_dpad(idev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn joycon_config_rumble(ctlr: *mut joycon_ctlr) {
    static void joycon_config_rumble(struct joycon_ctlr *ctlr)
    {

// set up rumble
    input_set_capability(ctlr.input, EV_FF, FF_RUMBLE);
    input_ff_create_memless(ctlr.input, core::ptr::null_mut(), joycon_play_effect);
...
#[no_mangle]
unsafe extern "C" fn joycon_imu_input_create(ctlr: *mut joycon_ctlr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn joycon_input_create(ctlr: *mut joycon_ctlr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn joycon_leds_create(ctlr: *mut joycon_ctlr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn joycon_power_supply_create(ctlr: *mut joycon_ctlr) -> c_int {
    static int joycon_power_supply_create(struct joycon_ctlr *ctlr)
    {
    struct hid_device *hdev = ctlr.hdev;
    let mut supply_config: power_supply_config = { .drv_data = ctlr, };
    let mut name_fmt: *const char  const = "nintendo_switch_controller_battery_%s";
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn joycon_read_info(ctlr: *mut joycon_ctlr) -> c_int {
    static int joycon_read_info(struct joycon_ctlr *ctlr)
    {
    int ret;
    int i;
    int j;
    let mut req: joycon_subcmd_request = { 0 };
    struct joycon_input_report *report;
...
#[no_mangle]
unsafe extern "C" fn joycon_init(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nintendo_hid_remove(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn nintendo_hid_resume(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nintendo_hid_suspend(hdev: *mut hid_device, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nintendo_init() -> int __init {
    static int __init nintendo_init(void)
    {
    return hid_register_driver(&nintendo_hid_driver);
    }
#[no_mangle]
unsafe extern "C" fn nintendo_exit() -> void __exit {
