...
#[no_mangle]
unsafe extern "C" fn dr_input_configured(hid: *mut hid_device, hidinput: *mut hid_input) -> c_int {
...
pub const PID0011_RDESC_ORIG_SIZE: c_int = 101;
