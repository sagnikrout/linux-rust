...
#[no_mangle]
pub unsafe extern "C" fn hidraw_is_revoked(list: *mut hidraw_list) -> bool {
    static inline bool hidraw_is_revoked(struct hidraw_list *list)
    {
    return list.revoked;
    }
#[no_mangle]
unsafe extern "C" fn hidraw_read(file: *mut file, buffer: *mut char __user, count: usize, ppos: *mut loff_t) -> isize {
...
// allow O_NONBLOCK to work well from other threads
    ...
    list.buffer[list.tail].value = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn hidraw_send_report(file: *mut file, buffer: *const char __user, count: usize, report_type: c_uchar) -> isize {
...
#[no_mangle]
unsafe extern "C" fn hidraw_write(file: *mut file, buffer: *const char __user, count: usize, ppos: *mut loff_t) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn hidraw_get_report(file: *mut file, buffer: *mut char __user, count: usize, report_type: c_uchar) -> isize {
...
#[no_mangle]
unsafe extern "C" fn hidraw_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn hidraw_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidraw_fasync(fd: c_int, file: *mut file, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drop_ref(hidraw: *mut hidraw, exists_bit: c_int) {
    ...
    if (!hidraw.open) {
    if (!hidraw.exist) {
    hidraw_table[hidraw.minor] = core::ptr::null_mut();
    kfree(hidraw);
    } else {
...
#[no_mangle]
unsafe extern "C" fn hidraw_release(inode: *mut *mut inode, file: *mut *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidraw_revoke(list: *mut hidraw_list) -> c_int {
...
//
    ...
    {
    let mut len: c_int = _IOC_SIZE(cmd);
...
#[no_mangle]
unsafe extern "C" fn hidraw_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn hidraw_report_event(hid: *mut hid_device, data: *mut u8, len: c_int) -> c_int {
    ...
    let mut new_head: c_int = (list.head + 1) & (HIDRAW_BUFFER_SIZE - 1);
...
#[no_mangle]
pub unsafe extern "C" fn hidraw_connect(hid: *mut hid_device) -> c_int {
...
// we accept any HID device, all applications
    ...
    core::ptr::null_mut(), "%s%d", "hidraw", minor);
    if (IS_ERR(dev.dev)) {
    hidraw_table[minor] = core::ptr::null_mut();
    up_write(&minors_rwsem);
...
#[no_mangle]
pub unsafe extern "C" fn hidraw_disconnect(hid: *mut hid_device) {
...
#[no_mangle]
pub unsafe extern "C" fn hidraw_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn hidraw_exit() {
    void hidraw_exit(void)
    {
    let mut dev_id: dev_t = MKDEV(hidraw_major, 0);
