...
//! Source: drivers/hid/hid-waltop.c
#![no_std]
...
pub const SLIM_TABLET_5_8_INCH_RDESC_ORIG_SIZE: c_int = 222;
...
pub const SLIM_TABLET_12_1_INCH_RDESC_ORIG_SIZE: c_int = 269;
...
pub const Q_PAD_RDESC_ORIG_SIZE: c_int = 241;
...
pub const PID_0038_RDESC_ORIG_SIZE: c_int = 241;
//
...
pub const MEDIA_TABLET_10_6_INCH_RDESC_ORIG_SIZE: c_int = 300;
...
pub const MEDIA_TABLET_14_1_INCH_RDESC_ORIG_SIZE: c_int = 309;
...
pub const SIRIUS_BATTERY_FREE_TABLET_RDESC_ORIG_SIZE: c_int = 335;
...
//
    ...
    let mut tilt_x: i8 = (s8)data[8];
    let mut tilt_y: i8 = (s8)data[9];
    let mut sign_x: i8 = tilt_x >= 0 ? 1 : -1;
    let mut sign_y: i8 = tilt_y >= 0 ? 1 : -1;
    tilt_x *= sign_x;
    tilt_y *= sign_y;
//
