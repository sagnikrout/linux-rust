...
//! Source: drivers/hid/hid-cp2112.c
#![no_std]
...
pub const CP2112_REPORT_MAX_LENGTH: c_int = 64;
pub const CP2112_GPIO_CONFIG_LENGTH: c_int = 5;
pub const CP2112_GPIO_GET_LENGTH: c_int = 2;
pub const CP2112_GPIO_SET_LENGTH: c_int = 3;
pub const CP2112_GPIO_MAX_GPIO: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp2112_smbus_config_report {
    pub /: *mut *mut u8 report; / CP2112_SMBUS_CONFIG,
    pub /: *mut *mut __be32 clock_speed; / Hz,
    pub /: *mut *mut u8 device_address; / Stored in the upper 7 bits,
    pub /: *mut *mut u8 auto_send_read; / 1 = enabled, 0 = disabled,
    pub /: *mut *mut __be16 write_timeout; / ms, 0 = no timeout,
    pub /: *mut *mut __be16 read_timeout; / ms, 0 = no timeout,
    pub /: *mut *mut u8 scl_low_timeout; / 1 = enabled, 0 = disabled,
    pub /: *mut *mut __be16 retry_time; / # of retries, 0 = no limit,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp2112_usb_config_report {
    pub /: *mut *mut u8 report; / CP2112_USB_CONFIG,
    pub /: *mut *mut __le16 vid; / Vendor ID,
    pub /: *mut *mut __le16 pid; / Product ID,
    pub /: *mut *mut u8 max_power; / Power requested in 2mA units,
    pub powered: *mut *mut u8 power_mode; / 0x00 = bus,
    0x01 = self powered & regulator off
    0x02 = self powered & regulator on */
    pub release_major: u8,
    pub release_minor: u8,
    pub /: *mut *mut u8 mask; / What fields to program,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp2112_read_req_report {
    pub /: *mut *mut u8 report; / CP2112_DATA_READ_REQUEST,
    pub slave_address: u8,
    pub length: __be16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp2112_write_read_req_report {
    pub /: *mut *mut u8 report; / CP2112_DATA_WRITE_READ_REQUEST,
    pub slave_address: u8,
    pub length: __be16,
    pub target_address_length: u8,
    pub target_address: [u8; 16],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp2112_write_req_report {
    pub /: *mut *mut u8 report; / CP2112_DATA_WRITE_REQUEST,
    pub slave_address: u8,
    pub length: u8,
    pub data: [u8; 61],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp2112_force_read_report {
    pub /: *mut *mut u8 report; / CP2112_DATA_READ_FORCE_SEND,
    pub length: __be16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp2112_xfer_status_report {
    pub /: *mut *mut u8 report; / CP2112_TRANSFER_STATUS_RESPONSE,
    pub /: *mut *mut *mut u8 status0; / STATUS0_,
    pub /: *mut *mut *mut u8 status1; / STATUS1_,
    pub retries: __be16,
    pub length: __be16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp2112_string_report {
    pub /: *mut *mut u8 dummy; / force .string to be aligned,
    struct_group_attr(contents, __packed,
    pub /: *mut *mut *mut u8 report; / CP2112__STRING,
    pub /: *mut *mut u8 length; / length in bytes of everything after .report,
    pub /: *mut *mut u8 type; / USB_DT_STRING,
    pub /: *mut *mut wchar_t string[30]; / UTF16_LITTLE_ENDIAN string,
    pub __packed: },
// Number of times to request transfer status before giving up waiting for a
    ...
    pub 10: static int XFER_STATUS_RETRIES =,
// Time in ms to wait for a CP2112_DATA_READ_RESPONSE or
    CP2112_TRANSFER_STATUS_RESPONSE. */
    pub 50: static int RESPONSE_TIMEOUT =,
...
pub struct cp2112_device {
    ...
    pub read_length: u8,
    pub hwversion: u8,
    pub xfer_status: c_int,
    pub read_avail: core::sync::atomic::AtomicI32,
    pub xfer_avail: core::sync::atomic::AtomicI32,
    pub gc: gpio_chip,
    pub in_out_buffer: *mut u8,
    pub lock: mutex,
    pub gpio_poll: bool,
    pub gpio_poll_worker: delayed_work,
    pub irq_mask: c_ulong,
    pub gpio_prev_state: u8,
}

    let mut gpio_push_pull: static int = CP2112_GPIO_ALL_GPIO_MASK;
    module_param(gpio_push_pull, int, 0644);
    MODULE_PARM_DESC(gpio_push_pull, "GPIO push-pull configuration bitmask");
#[no_mangle]
unsafe extern "C" fn cp2112_gpio_direction_input(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp2112_gpio_get_all(chip: *mut gpio_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp2112_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp2112_wait(dev: *mut cp2112_device, avail: *mut core::sync::atomic::AtomicI32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp2112_xfer_status(dev: *mut cp2112_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp2112_read(dev: *mut cp2112_device, data: *mut u8, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp2112_read_req(buf: *mut c_void, slave_address: u8, length: u16) -> c_int {
    ...
    u8 buf[64];
    ssize_t count;
    let mut read_length: isize = 0;
    u8 *read_buf = core::ptr::null_mut();
...
// return the number of transferred messages
    ...
    count = cp2112_write_req(buf, addr, command, core::ptr::null_mut(),
    0);
    break;
...
#[no_mangle]
unsafe extern "C" fn cp2112_functionality(adap: *mut i2c_adapter) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn chmod_sysfs_attrs(hdev: *mut hid_device) {
    static void chmod_sysfs_attrs(struct hid_device *hdev)
    {
    ...
    let mut mode: umode_t = (buf[1] & 1) ? 0644 : 0444;
...
#[no_mangle]
unsafe extern "C" fn cp2112_gpio_irq_ack(d: *mut irq_data) {
    static void cp2112_gpio_irq_ack(struct irq_data *d)
    {
    }
#[no_mangle]
unsafe extern "C" fn cp2112_gpio_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn cp2112_gpio_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn cp2112_gpio_poll_callback(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn cp2112_gpio_irq_startup(d: *mut irq_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn cp2112_gpio_irq_shutdown(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn cp2112_gpio_irq_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp2112_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp2112_remove(hdev: *mut hid_device) {
