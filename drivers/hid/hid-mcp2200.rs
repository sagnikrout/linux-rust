...
//! Source: drivers/hid/hid-mcp2200.c
#![no_std]
...
pub const SET_CLEAR_OUTPUTS: c_uint = 0x08;
pub const CONFIGURE: c_uint = 0x10;
pub const READ_EE: c_uint = 0x20;
pub const WRITE_EE: c_uint = 0x40;
pub const READ_ALL: c_uint = 0x80;
...
pub const TXLED: c_int = 2;
pub const RXLED: c_int = 3;
pub const USBCFG: c_int = 6;
pub const SSPND: c_int = 7;
pub const MCP_NGPIO: c_int = 8;
// CMD to set or clear a GPIO output
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp_set_clear_outputs {
    pub cmd: u8,
    pub dummys1: [u8; 10],
    pub set_bmap: u8,
    pub clear_bmap: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp_configure {
    pub cmd: u8,
    pub dummys1: [u8; 3],
    pub io_bmap: u8,
    pub config_alt_pins: u8,
    pub io_default_val_bmap: u8,
    pub config_alt_options: u8,
    pub baud_h: u8,
    pub baud_l: u8,
    pub dummys2: [u8; 6],
    pub __packed: },
...
#[no_mangle]
unsafe extern "C" fn mcp_cmd_read_all(mcp: *mut mcp2200) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp_set(gc: *mut gpio_chip, gpio_nr: c_uint, value: c_int) -> c_int {
    static int mcp_set(struct gpio_chip *gc, unsigned int gpio_nr, int value)
    {
    let mut mask: c_ulong = 1 << gpio_nr;
    let mut bmap_value: c_ulong = value << gpio_nr;
...
#[no_mangle]
unsafe extern "C" fn mcp_get(gc: *mut gpio_chip, gpio_nr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp_get_direction(gc: *mut gpio_chip, gpio_nr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp_direction_input(gc: *mut gpio_chip, gpio_nr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp2200_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp2200_remove(hdev: *mut hid_device) {
