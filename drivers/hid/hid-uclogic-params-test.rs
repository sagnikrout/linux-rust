...
//! Source: drivers/hid/hid-uclogic-params-test.c
#![no_std]
...
pub const MAX_STR_DESC_SIZE: c_int = 14;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uclogic_parse_ugee_v2_desc_case {
    pub name: *const c_char,
    pub res: c_int,
    pub str_desc: [__u8; MAX_STR_DESC_SIZE],
    pub str_desc_size: usize,
    pub desc_params: [i32; UCLOGIC_RDESC_PH_ID_NUM],
    pub frame_type: enum uclogic_params_frame_type,
}
...
#[no_mangle]
unsafe extern "C" fn hid_test_uclogic_parse_ugee_v2_desc(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fake_device {
    pub quirks: c_ulong,
}

#[no_mangle]
unsafe extern "C" fn hid_test_uclogic_params_cleanup_event_hooks(test: *mut kunit) {
...
// Check that the function can be called repeatedly
    ...
    KUNIT_EXPECT_PTR_EQ(test, p.event_hooks, core::ptr::null_mut());
    }
    }
