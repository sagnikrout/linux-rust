...
//
    ...
    let mut hid_ignore_special_drivers: static int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn snto32(value: __u32, n: c_uint) -> i32 {
...
//
#[no_mangle]
unsafe extern "C" fn s32ton(value: __s32, n: c_uint) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn open_collection(parser: *mut hid_parser, type: unsigned) -> c_int {
    ...
    2),
    GFP_KERNEL);
    if (collection == core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn close_collection(parser: *mut hid_parser) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hid_lookup_collection(parser: *mut hid_parser, type: unsigned) -> unsigned {
    static unsigned hid_lookup_collection(struct hid_parser *parser, unsigned type)
    {
    struct hid_collection *collection = parser.device.collection;
    int n;
    for (n = parser.collection_stack_ptr - 1; n >= 0; n--) {
    let mut index: unsigned = parser.collection_stack[n];
...
//
#[no_mangle]
unsafe extern "C" fn complete_usage(parser: *mut hid_parser, index: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn hid_add_usage(parser: *mut hid_parser, usage: unsigned, size: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hid_add_field(parser: *mut hid_parser, report_type: unsigned, flags: unsigned) -> c_int {
    static int hid_add_field(struct hid_parser *parser, unsigned report_type, unsigned flags)
    {
    struct hid_report *report;
    struct hid_field *field;
    let mut max_buffer_size: c_uint = HID_MAX_BUFFER_SIZE;
    unsigned int usages;
    unsigned int offset;
    unsigned int i;
    unsigned int application;
...
//
#[no_mangle]
unsafe extern "C" fn item_udata(item: *mut hid_item) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn item_sdata(item: *mut hid_item) -> i32 {
...
//
#[no_mangle]
unsafe extern "C" fn hid_parser_global(parser: *mut hid_parser, item: *mut hid_item) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hid_parser_local(parser: *mut hid_parser, item: *mut hid_item) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hid_concatenate_last_usage_page(parser: *mut hid_parser) {
...
//
#[no_mangle]
unsafe extern "C" fn hid_parser_main(parser: *mut hid_parser, item: *mut hid_item) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hid_parser_reserved(parser: *mut hid_parser, item: *mut hid_item) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hid_free_report(report: *mut hid_report) {
...
//
#[no_mangle]
unsafe extern "C" fn hid_close_report(device: *mut hid_device) {
...
//
    ...
    kfree(device.rdesc);
    device.rdesc = core::ptr::null_mut();
    device.rsize = 0;
    kfree(device.collection);
    device.collection = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn hid_free_bpf_rdesc(hdev: *mut hid_device) {
...
// bpf_rdesc is either equal to dev_rdesc or allocated by call_hid_bpf_rdesc_fixup()
    ...
    hdev.bpf_rdesc = core::ptr::null_mut();
    }
//
// Free a device structure, all reports, and all fields.
//
#[no_mangle]
pub unsafe extern "C" fn hiddev_free(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn hid_device_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn hid_scan_input_usage(parser: *mut hid_parser, usage: u32) {
...
#[no_mangle]
unsafe extern "C" fn hid_scan_feature_usage(parser: *mut hid_parser, usage: u32) {
...
#[no_mangle]
unsafe extern "C" fn hid_scan_collection(parser: *mut hid_parser, type: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn hid_scan_main(parser: *mut hid_parser, item: *mut hid_item) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hid_scan_report(hid: *mut hid_device) -> c_int {
...
//
    while ((start = fetch_item(start, end, &item)) != core::ptr::null_mut())
...
//
#[no_mangle]
pub unsafe extern "C" fn hid_parse_report(hid: *mut hid_device, start: *const __u8, size: unsigned) -> c_int {
...
//
    ...
    {
    int m;
    let mut v: __s32 = *multiplier.value;
    let mut lmin: __s32 = multiplier.logical_minimum;
    let mut lmax: __s32 = multiplier.logical_maximum;
    let mut pmin: __s32 = multiplier.physical_minimum;
    let mut pmax: __s32 = multiplier.physical_maximum;
//
...
//
    ...
    multiplier_collection == core::ptr::null_mut())
...
//
#[no_mangle]
pub unsafe extern "C" fn hid_setup_resolution_multiplier(hid: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn hid_parse_collections(device: *mut hid_device) -> c_int {
    ...
    while ((next = fetch_item(start, end, &item)) != core::ptr::null_mut()) {
    start = next;
    if (item.format != HID_ITEM_FORMAT_SHORT) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hid_open_report(device: *mut hid_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __extract(report: *mut u8, offset: unsigned, n: c_int) -> u32 {
    static u32 __extract(u8 *report, unsigned offset, int n)
    {
    let mut idx: c_uint = offset / 8;
    let mut bit_nr: c_uint = 0;
    let mut bit_shift: c_uint = offset % 8;
    let mut bits_to_copy: c_int = 8 - bit_shift;
    let mut value: u32 = 0;
    let mut mask: u32 = n < 32 ? (1U << n) - 1 : ~0U;
    while (n > 0) {
...
//
#[no_mangle]
unsafe extern "C" fn __implement(report: *mut u8, offset: unsigned, n: c_int, value: u32) {
    static void __implement(u8 *report, unsigned offset, int n, u32 value)
    {
    let mut idx: c_uint = offset / 8;
    let mut bit_shift: c_uint = offset % 8;
    let mut bits_to_set: c_int = 8 - bit_shift;
...
//
#[no_mangle]
unsafe extern "C" fn search(array: *mut __s32, value: __s32, n: unsigned) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hid_match_report(hid: *mut hid_device, report: *mut hid_report) -> c_int {
    static int hid_match_report(struct hid_device *hid, struct hid_report *report)
    {
    const struct hid_report_id *id = hid.driver.report_table;
    if (!id) /* core::ptr::null_mut() means all */
    return 1;
...
//
#[no_mangle]
unsafe extern "C" fn hid_match_usage(hid: *mut hid_device, usage: *mut hid_usage) -> c_int {
...
//
    ...
    __s32 value)
    {
    let mut min: __s32 = field.logical_minimum;
//
...
//
    ...
    {
    unsigned n;
    let mut count: unsigned = field.report_count;
    let mut offset: unsigned = field.report_offset;
    let mut size: unsigned = field.report_size;
    let mut min: __s32 = field.logical_minimum;
    __s32 *value;
...
//
    ...
    int interrupt)
    {
    let mut count: c_uint = field.report_count;
...
#[no_mangle]
unsafe extern "C" fn hid_process_ordering(hid: *mut hid_device) {
...
//
#[no_mangle]
unsafe extern "C" fn hid_compute_report_size(report: *mut hid_report) -> usize {
...
//
#[no_mangle]
pub unsafe extern "C" fn hid_output_report(report: *mut hid_report, data: *mut __u8) {
...
//
    let mut len: u32 = hid_report_len(report) + 7 + (report.id == 0);
...
//
#[no_mangle]
pub unsafe extern "C" fn hid_set_field(field: *mut hid_field, offset: unsigned, value: __s32) -> c_int {
...
// reserve the first byte for the report ID
    ...
    let mut max_buffer_size: c_int = HID_MAX_BUFFER_SIZE;
    u32 rsize, csize = size;
    let mut bsize: usize = bufsize;
    u8 *cdata = data;
    let mut ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(max_buffer_size: rsize >) -> else {
...
#[no_mangle]
unsafe extern "C" fn hid_hiddev(hdev: *mut hid_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn hid_connect(hdev: *mut hid_device, connect_mask: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hid_disconnect(hdev: *mut hid_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hid_hw_start(hdev: *mut hid_device, connect_mask: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hid_hw_stop(hdev: *mut hid_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hid_hw_open(hdev: *mut hid_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hid_hw_close(hdev: *mut hid_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hid_hw_output_report(hdev: *mut hid_device, buf: *mut __u8, len: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hid_driver_suspend(hdev: *mut hid_device, state: pm_message_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hid_driver_reset_resume(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hid_driver_resume(hdev: *mut hid_device) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hid_dynid {
    pub list: list_head,
    pub id: hid_device_id,
}
...
#[no_mangle]
unsafe extern "C" fn hid_free_dynids(hdrv: *mut hid_driver) {
...
#[no_mangle]
unsafe extern "C" fn hid_bus_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
//
    ...
    {
    let mut n1: c_int = strrchr(hdev_a.phys, separator) - hdev_a.phys;
    let mut n2: c_int = strrchr(hdev_b.phys, separator) - hdev_b.phys;
    if (n1 != n2 || n1 <= 0 || n2 <= 0)
    return false;
...
#[no_mangle]
unsafe extern "C" fn hid_set_group(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn __hid_device_probe(hdev: *mut hid_device, hdrv: *mut hid_driver) -> c_int {
...
// the report descriptor changed, we need to re-scan it
    ...
    return -ENODEV;
    hdev.devres_group_id = devres_open_group(&hdev.dev, core::ptr::null_mut(), GFP_KERNEL);
...
//
    ...
    hdev.driver = core::ptr::null_mut();
    }
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn hid_device_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_device_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn hid_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hid_add_device(hdev: *mut hid_device) -> c_int {
    int hid_add_device(struct hid_device *hdev)
    {
    let mut id: static atomic_t = ATOMIC_INIT(0);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn hid_remove_device(hdev: *mut hid_device) {
    ...
    hdev.dev_rdesc = core::ptr::null_mut();
    hdev.dev_rsize = 0;
    hdev.bpf_rsize = 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn hid_destroy_device(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn __hid_bus_reprobe_drivers(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __hid_bus_driver_added(drv: *mut device_driver, data: *mut c_void) -> c_int {
    static int __hid_bus_driver_added(struct device_driver *drv, void *data)
    {
    struct hid_driver *hdrv = to_hid_driver(drv);
    if (hdrv.match) {
    bus_for_each_dev(&hid_bus_type, core::ptr::null_mut(), hdrv,
    __hid_bus_reprobe_drivers);
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn __bus_removed_driver(drv: *mut device_driver, data: *mut c_void) -> c_int {
    ...
    if (ret == 0)
    bus_for_each_drv(&hid_bus_type, core::ptr::null_mut(), core::ptr::null_mut(),
    __hid_bus_driver_added);
    return ret;
    }
    EXPORT_SYMBOL_GPL(__hid_register_driver);
#[no_mangle]
pub unsafe extern "C" fn hid_unregister_driver(hdrv: *mut hid_driver) {
    void hid_unregister_driver(struct hid_driver *hdrv)
    {
    driver_unregister(&hdrv.driver);
    hid_free_dynids(hdrv);
    bus_for_each_drv(&hid_bus_type, core::ptr::null_mut(), hdrv, __bus_removed_driver);
    }
    EXPORT_SYMBOL_GPL(hid_unregister_driver);
#[no_mangle]
pub unsafe extern "C" fn hid_check_keys_pressed(hid: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hid_exit() -> void __exit {
    static void __exit hid_exit(void)
    {

    hid_ops = core::ptr::null_mut();
