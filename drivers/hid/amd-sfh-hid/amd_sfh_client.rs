...
//! Source: drivers/hid/amd-sfh-hid/amd_sfh_client.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn amd_sfh_get_report(hid: *mut hid_device, report_id: c_int, report_type: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_sfh_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_sfh_work_buffer(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn amd_sfh_wait_for_response(mp2: *mut amd_mp2_dev, sid: u8, sensor_sts: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn amd_sfh_resume(mp2: *mut amd_mp2_dev) {
...
#[no_mangle]
unsafe extern "C" fn amd_sfh_suspend(mp2: *mut amd_mp2_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_sfh_hid_client_init(privdata: *mut amd_mp2_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_sfh_hid_client_deinit(privdata: *mut amd_mp2_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_sfh_op_idx_enabled(mp2: *mut amd_mp2_dev) -> bool {
