...
pub const ELAN_MT_I2C: c_uint = 0x5d;
pub const ELAN_SINGLE_FINGER: c_uint = 0x81;
pub const ELAN_MT_FIRST_FINGER: c_uint = 0x82;
pub const ELAN_MT_SECOND_FINGER: c_uint = 0x83;
pub const ELAN_INPUT_REPORT_SIZE: c_int = 8;
pub const ELAN_I2C_REPORT_SIZE: c_int = 32;
pub const ELAN_FINGER_DATA_LEN: c_int = 5;
pub const ELAN_MAX_FINGERS: c_int = 5;
pub const ELAN_MAX_PRESSURE: c_int = 255;
pub const ELAN_TP_USB_INTF: c_int = 1;
pub const ELAN_FEATURE_REPORT: c_uint = 0x0d;
pub const ELAN_FEATURE_SIZE: c_int = 5;
pub const ELAN_PARAM_MAX_X: c_int = 6;
pub const ELAN_PARAM_MAX_Y: c_int = 7;
pub const ELAN_PARAM_RES: c_int = 8;
pub const ELAN_MUTE_LED_REPORT: c_uint = 0xBC;
pub const ELAN_LED_REPORT_SIZE: c_int = 8;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct elan_drvdata {
    pub input: *mut input_dev,
    pub prev_report: [u8; ELAN_INPUT_REPORT_SIZE],
    pub mute_led: led_classdev,
    pub mute_led_state: u8,
    pub max_x: u16,
    pub max_y: u16,
    pub res_x: u16,
    pub res_y: u16,
...
#[no_mangle]
unsafe extern "C" fn is_not_elan_touchpad(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elan_convert_res(val: c_char) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn elan_get_device_params(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elan_input_configured(hdev: *mut hid_device, hi: *mut hid_input) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elan_usb_report_input(drvdata: *mut elan_drvdata, data: *mut u8) {
...
//
    ...
    elan_report_mt_slot(drvdata, core::ptr::null_mut(), i);
    }
...
#[no_mangle]
unsafe extern "C" fn elan_i2c_report_input(drvdata: *mut elan_drvdata, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn elan_start_multitouch(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elan_init_mute_led(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elan_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
