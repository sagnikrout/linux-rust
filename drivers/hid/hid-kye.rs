...
#[no_mangle]
unsafe extern "C" fn kye_tablet_enable(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kye_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
