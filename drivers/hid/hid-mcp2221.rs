...
//! Source: drivers/hid/hid-mcp2221.c
#![no_std]
...
pub const MCP2221_SRAM_GP_DESIGN_MASK: c_uint = 0x07;
pub const MCP2221_SRAM_GP_DIRECTION_MASK: c_uint = 0x08;
pub const MCP2221_SRAM_GP_VALUE_MASK: c_uint = 0x10;
// MCP GPIO direction encoding
    enum {
    MCP2221_DIR_OUT = 0x00,
    MCP2221_DIR_IN = 0x01,
    };
pub const MCP_NGPIO: c_int = 4;
// MCP GPIO set command layout
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp_set_gpio {
    pub cmd: u8,
    pub dummy: u8,
    struct {
    pub change_value: u8,
...
pub struct mcp2221 {
    ...
    pub lock: mutex,
    pub wait_in_report: completion,
    pub init_work: delayed_work,
    pub rxbuf: *mut u8,
    pub txbuf: [u8; 64],
    pub rxbuf_idx: c_int,
    pub rxbuf_size: c_int,
    pub status: c_int,
    pub cur_i2c_clk_div: u8,
    pub gc: *mut gpio_chip,
    pub gp_idx: u8,
    pub gpio_dir: u8,
    pub mode: [u8; 4],    pub iio_channels: [iio_chan_spec; 3],
...
//
    let mut i2c_clk_freq: static uint = 400;
...
#[no_mangle]
unsafe extern "C" fn mcp_chk_last_cmd_status(mcp: *mut mcp2221) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp_cancel_last_cmd(mcp: *mut mcp2221) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mcp_chk_last_cmd_status_free_bus(mcp: *mut mcp2221) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp_set_i2c_speed(mcp: *mut mcp2221) -> c_int {
...
// Ex transaction; send reg address and read its contents
    ...
    ret = mcp_i2c_smbus_read(mcp, core::ptr::null_mut(), MCP2221_I2C_RD_DATA,
    addr, 0, &data.byte);
    else
    ret = mcp_smbus_write(mcp, addr, command, core::ptr::null_mut(),
    ...
    if (ret)
    goto exit;
    ret = mcp_i2c_smbus_read(mcp, core::ptr::null_mut(),
    MCP2221_I2C_RD_RPT_START,
    addr, 1, &data.byte);
    } else {
...
#[no_mangle]
unsafe extern "C" fn mcp_i2c_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mcp_gpio_read_sram(mcp: *mut mcp2221) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mcp2221_check_gpio_pinfunc(mcp: *mut mcp2221) -> c_int {
    static int mcp2221_check_gpio_pinfunc(struct mcp2221 *mcp)
    {
    int i;
    let mut needgpiofix: c_int = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mcp_gpio_set(gc: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp2221_hid_unregister(ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mcp2221_remove(hdev: *mut hid_device) {
...
// Read ADC values
    ret = mcp_chk_last_cmd_status(mcp);
    if (!ret) {
// val = le16_to_cpu(( __le16) mcp->adc_values[channel->address]);
    if (*val >= BIT(10))
    ret =  -EINVAL;
    else
    ret = IIO_VAL_INT;
...
#[no_mangle]
unsafe extern "C" fn mcp_iio_channels(mcp: *mut mcp2221) -> c_int {
    static int mcp_iio_channels(struct mcp2221 *mcp)
    {
    int idx, cnt = 0;
    let mut dac_created: bool = false;
...
#[no_mangle]
unsafe extern "C" fn mcp_init_work(work: *mut work_struct) {
