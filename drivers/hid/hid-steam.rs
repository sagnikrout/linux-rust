...
//! Source: drivers/hid/hid-steam.c
#![no_std]
...
//
    ...
    let mut lizard_mode: static bool = true;
    static DEFINE_MUTEX(steam_devices_lock);
    static LIST_HEAD(steam_devices);

// Touch pads are 40 mm in diameter and 65535 units
pub const STEAM_PAD_RESOLUTION: c_int = 1638;
// Trigger runs are about 5 mm and 256 units
pub const STEAM_TRIGGER_RESOLUTION: c_int = 51;
// Joystick runs are about 5 mm and 256 units
pub const STEAM_JOYSTICK_RESOLUTION: c_int = 51;
// Trigger runs are about 6 mm and 32768 units
pub const STEAM_DECK_TRIGGER_RESOLUTION: c_int = 5461;
// Joystick runs are about 5 mm and 32768 units
pub const STEAM_DECK_JOYSTICK_RESOLUTION: c_int = 6553;
// Accelerometer has 16 bit resolution and a range of +/- 2g
pub const STEAM_ACCEL_RES_PER_G: c_int = 16384;
pub const STEAM_ACCEL_RANGE: c_int = 32768;
pub const STEAM_ACCEL_FUZZ: c_int = 128;
pub const STEAM_DECK_ACCEL_FUZZ: c_int = 32;
// Gyroscope has 16 bit resolution and a range of +/- 2000 dps
pub const STEAM_GYRO_RES_PER_DPS: c_int = 16;
pub const STEAM_GYRO_RANGE: c_int = 32768;
pub const STEAM_GYRO_FUZZ: c_int = 0;
pub const STEAM_PAD_FUZZ: c_int = 256;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct steam_controller_attribute {
    pub tag: c_uchar,
    pub value: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct steam_ibex_battery_status {
    pub charge_state: u8,
    pub battery_level: u8,
    pub battery_voltage: __le16,
    pub system_voltage: __le16,
    pub input_voltage: __le16,
    pub battery_current: __le16,
    pub input_current: __le16,
    pub temperature: __le16,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct steam_ibex_haptic_rumble {
    pub type: u8,
    pub intensity: __le16,
    struct {
    pub speed: __le16,
    pub gain: u8,
    pub right: } __packed left,,
    pub __packed: },
    pub 9): static_assert(sizeof(struct steam_ibex_haptic_rumble) ==,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct steam_ibex_haptic_pulse {
    pub side: u8,
    pub on_us: __le16,
    pub off_us: __le16,
    pub repeat_count: __le16,
    pub __packed: },
    pub 7): static_assert(sizeof(struct steam_ibex_haptic_pulse) ==,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct steam_ibex_output_report {
    pub id: u8,
    union {
    pub rumble: steam_ibex_haptic_rumble,
    pub pulse: steam_ibex_haptic_pulse,
}

    } __packed;
// Pad identifiers for the deck
pub const STEAM_PAD_LEFT: c_int = 0;
pub const STEAM_PAD_RIGHT: c_int = 1;
pub const STEAM_PAD_BOTH: c_int = 2;
// Other random constants
pub const STEAM_SERIAL_LEN: c_uint = 0x15;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct steam_device {
    pub list: list_head,
    pub lock: spinlock_t,
    pub client_hdev: *mut *mut hid_device hdev,,
    pub report_mutex: mutex,
    pub registration_mutex: mutex,
    pub client_opened: c_ulong,
    pub input: *mut input_dev __rcu,
    pub sensors: *mut input_dev __rcu,
    pub quirks: c_ulong,
    pub work_connect: work_struct,
    pub connected: bool,
    pub registered: bool,
    pub 1]: char serial_no[STEAM_SERIAL_LEN +,
    pub battery_desc: power_supply_desc,
    pub battery: *mut power_supply __rcu,
    pub battery_charge: u8,
    pub battery_status: u8,
    pub battery_temp: u16,
    pub battery_voltage: u16,
    pub battery_current: u16,
    pub mode_switch: delayed_work,
    pub did_mode_switch: bool,
    pub gamepad_mode: bool,
    pub rumble_work: work_struct,
    pub coalesce_rumble_work: delayed_work,
    pub rumble_left: u16,
    pub rumble_right: u16,
    pub sensor_timestamp_us: c_uint,
    pub sensor_update_rate_us: c_uint,
}
...
#[no_mangle]
pub unsafe extern "C" fn steam_send_report_byte(steam: *mut steam_device, cmd: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn steam_get_serial(steam: *mut steam_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn steam_get_attributes(steam: *mut steam_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn steam_get_conn_status(steam: *mut steam_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn steam_haptic_rumble_cb(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn steam_coalesce_rumble_cb(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn steam_set_lizard_mode(steam: *mut steam_device, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn steam_input_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn steam_input_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn steam_sensor_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn steam_sensor_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn steam_battery_register(steam: *mut steam_device) -> c_int {
    static int steam_battery_register(struct steam_device *steam)
    {
    struct power_supply *battery;
    let mut battery_cfg: power_supply_config = { .drv_data = steam, };
    unsigned long flags;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn steam_input_register(steam: *mut steam_device) -> c_int {
    ...
    ret = input_ff_create_memless(input, core::ptr::null_mut(), steam_play_effect);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn steam_sensors_register(steam: *mut steam_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(STEAM_QUIRK_BLE): steam->quirks & (STEAM_QUIRK_WIRELESS |) -> else {
    else if (steam.quirks & (STEAM_QUIRK_WIRELESS | STEAM_QUIRK_BLE))
// Both wireless Steam Controller setups
    needs_open_close = true;
#[no_mangle]
pub unsafe extern "C" fn if(STEAM_QUIRK_IBEX: steam->quirks &) -> else {
...
#[no_mangle]
unsafe extern "C" fn steam_input_unregister(steam: *mut steam_device) {
    ...
    if (!input)
    return;
    RCU_INIT_POINTER(steam.input, core::ptr::null_mut());
    synchronize_rcu();
    input_unregister_device(input);
    }
#[no_mangle]
unsafe extern "C" fn steam_sensors_unregister(steam: *mut steam_device) {
    ...
    if (!sensors)
    return;
    RCU_INIT_POINTER(steam.sensors, core::ptr::null_mut());
    synchronize_rcu();
    input_unregister_device(sensors);
    }
#[no_mangle]
unsafe extern "C" fn steam_battery_unregister(steam: *mut steam_device) {
    ...
    if (!battery)
    return;
    RCU_INIT_POINTER(steam.battery, core::ptr::null_mut());
    synchronize_rcu();
    power_supply_unregister(battery);
    devm_kfree(&steam.hdev.dev, steam.battery_desc.name);
    }
#[no_mangle]
unsafe extern "C" fn steam_register(steam: *mut steam_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn steam_unregister(steam: *mut steam_device) {
...
#[no_mangle]
unsafe extern "C" fn steam_work_connect_cb(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn steam_mode_switch_cb(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn steam_is_valve_interface(hdev: *mut hid_device, quirks: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn steam_client_ll_parse(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn steam_client_ll_start(hdev: *mut hid_device) -> c_int {
    static int steam_client_ll_start(struct hid_device *hdev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn steam_client_ll_stop(hdev: *mut hid_device) {
    static void steam_client_ll_stop(struct hid_device *hdev)
    {
    }
#[no_mangle]
unsafe extern "C" fn steam_client_ll_open(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn steam_client_ll_close(hdev: *mut hid_device) {
...
// If using a wireless adaptor ask for connection status
    ...
    __func__, ret);
#[no_mangle]
pub unsafe extern "C" fn if(WIRELESS_EVENT_CONNECT: ret ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn steam_remove(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn steam_do_connect_event(steam: *mut steam_device, connected: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn steam_le16(data: *const u8) -> i16 {
    static inline s16 steam_le16(const u8 *data)
    {
    let mut x: i16 = (s16) get_unaligned_le16((const __le16 *)data);
    let mut x: return = = -32768 ? -32767 : x;
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct steam_button_mapping {
    pub code: c_int,
    pub byte: u8,
    pub bit: u8,
}
...
//
    ...
    {
    let mut volts: i16 = steam_le16(data + 12);
    let mut batt: u8 = data[14];
