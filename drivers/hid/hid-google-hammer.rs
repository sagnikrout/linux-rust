...
//! Source: drivers/hid/hid-google-hammer.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct cbas_ec {
    pub /: *mut *mut *mut device dev; / The platform device (EC),
...
#[no_mangle]
unsafe extern "C" fn cbas_parse_base_state(data: *const c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cbas_ec_resume(dev: *mut device) -> __maybe_unused int {
...
//
    ...
    static SIMPLE_DEV_PM_OPS(cbas_ec_pm_ops, core::ptr::null_mut(), cbas_ec_resume);
#[no_mangle]
unsafe extern "C" fn cbas_ec_set_input(input: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn __cbas_ec_probe(pdev: *mut platform_device) -> c_int {
...
// Seed the state
    ...
    cbas_ec_set_input(core::ptr::null_mut());
    return error;
    }
...
#[no_mangle]
unsafe extern "C" fn cbas_ec_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cbas_ec_remove(pdev: *mut platform_device) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hammer_kbd_leds {
    pub cdev: led_classdev,
    pub hdev: *mut hid_device,
    pub ____cacheline_aligned: u8 buf[2],
}
...
#[no_mangle]
unsafe extern "C" fn hammer_register_leds(hdev: *mut hid_device) -> c_int {
...
pub const HID_VD_KBD_FOLDED: c_uint = 0x00000019;

// HID usage for keyboard backlight (Alphanumeric display brightness)
pub const HID_AD_BRIGHTNESS: c_uint = 0x00140046;
...
#[no_mangle]
unsafe extern "C" fn hammer_folded_event(hdev: *mut hid_device, folded: bool) {
...
#[no_mangle]
unsafe extern "C" fn hammer_has_folded_event(hdev: *mut hid_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hammer_has_backlight_control(hdev: *mut hid_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hammer_get_folded_state(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn hammer_stop(hdev: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hammer_remove(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn hammer_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hammer_exit() -> void __exit {
