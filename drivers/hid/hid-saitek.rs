...
//! Source: drivers/hid/hid-saitek.c
#![no_std]
...
pub const SAITEK_FIX_PS1000: c_uint = 0x0001;
pub const SAITEK_RELEASE_MODE_RAT7: c_uint = 0x0002;
pub const SAITEK_RELEASE_MODE_MMO7: c_uint = 0x0004;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct saitek_sc {
    pub quirks: c_ulong,
    pub mode: c_int,
}
...
// R.A.T.7 uses bits 13, 14, 15 for the mode
    ...
    mode = 0;
#[no_mangle]
pub unsafe extern "C" fn if(0x02: raw_data[1] &) -> else {
    else if (raw_data[1] & 0x02)
    mode = 1;
#[no_mangle]
pub unsafe extern "C" fn if(0x04: raw_data[1] &) -> else {
...
// M.M.O.7 uses bits 8, 22, 23 for the mode
    ...
    mode = 0;
#[no_mangle]
pub unsafe extern "C" fn if(0x01: raw_data[2] &) -> else {
    else if (raw_data[2] & 0x01)
    mode = 1;
#[no_mangle]
pub unsafe extern "C" fn if(0x02: raw_data[2] &) -> else {
