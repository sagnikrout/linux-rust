...
//! Source: drivers/hid/hid-corsair.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k90_drvdata {
    pub record_led: k90_led,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct corsair_drvdata {
    pub quirks: c_ulong,
    pub k90: *mut k90_drvdata,
    pub backlight: *mut k90_led,
}

pub const K90_GKEY_COUNT: c_int = 18;
#[no_mangle]
unsafe extern "C" fn corsair_usage_to_gkey(usage: c_uint) -> c_int {
...
// G17 (0xe8) to G18 (0xe9)
    ...
    module_param_array_named(gkey_codes, corsair_gkey_map, ushort, core::ptr::null_mut(), S_IRUGO);
...
pub const CORSAIR_USAGE_SPECIAL_MIN: c_uint = 0xf0;
pub const CORSAIR_USAGE_SPECIAL_MAX: c_uint = 0xff;
pub const CORSAIR_USAGE_MACRO_RECORD_START: c_uint = 0xf6;
pub const CORSAIR_USAGE_MACRO_RECORD_STOP: c_uint = 0xf7;
pub const CORSAIR_USAGE_PROFILE: c_uint = 0xf1;
pub const CORSAIR_USAGE_M1: c_uint = 0xf1;
pub const CORSAIR_USAGE_M2: c_uint = 0xf2;
pub const CORSAIR_USAGE_M3: c_uint = 0xf3;
pub const CORSAIR_USAGE_PROFILE_MAX: c_uint = 0xf3;
pub const CORSAIR_USAGE_META_OFF: c_uint = 0xf4;
pub const CORSAIR_USAGE_META_ON: c_uint = 0xf5;
pub const CORSAIR_USAGE_LIGHT: c_uint = 0xfa;
pub const CORSAIR_USAGE_LIGHT_OFF: c_uint = 0xfa;
pub const CORSAIR_USAGE_LIGHT_DIM: c_uint = 0xfb;
pub const CORSAIR_USAGE_LIGHT_MEDIUM: c_uint = 0xfc;
pub const CORSAIR_USAGE_LIGHT_BRIGHT: c_uint = 0xfd;
pub const CORSAIR_USAGE_LIGHT_MAX: c_uint = 0xfd;
// USB control protocol
pub const K90_REQUEST_BRIGHTNESS: c_int = 49;
pub const K90_REQUEST_MACRO_MODE: c_int = 2;
pub const K90_REQUEST_STATUS: c_int = 4;
pub const K90_REQUEST_GET_MODE: c_int = 5;
pub const K90_REQUEST_PROFILE: c_int = 20;
pub const K90_MACRO_MODE_SW: c_uint = 0x0030;
pub const K90_MACRO_MODE_HW: c_uint = 0x0001;
pub const K90_MACRO_LED_ON: c_uint = 0x0020;
pub const K90_MACRO_LED_OFF: c_uint = 0x0040;
//
// LED class devices
//

#[no_mangle]
unsafe extern "C" fn k90_backlight_get(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn k90_record_led_get(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn k90_backlight_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn k90_record_led_work(work: *mut work_struct) {
    ...
    USB_DIR_OUT | USB_TYPE_VENDOR |
    USB_RECIP_DEVICE, value, 0, core::ptr::null_mut(), 0,
    USB_CTRL_SET_TIMEOUT);
    if (ret != 0)
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(buf, _arg: "HW", 0: 2) ==) -> else {
    ...
    K90_REQUEST_PROFILE,
    USB_DIR_OUT | USB_TYPE_VENDOR |
    USB_RECIP_DEVICE, profile, 0, core::ptr::null_mut(), 0,
    USB_CTRL_SET_TIMEOUT);
    if (ret != 0) {
...
//
#[no_mangle]
unsafe extern "C" fn k90_init_backlight(dev: *mut hid_device) -> c_int {
    ...
    drvdata.backlight = core::ptr::null_mut();
    fail_backlight_alloc:
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn k90_init_macro_functions(dev: *mut hid_device) -> c_int {
...
// Init attributes
    ...
    kfree(k90);
    fail_drvdata:
    drvdata.k90 = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn k90_cleanup_backlight(dev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn k90_cleanup_macro_functions(dev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn corsair_probe(dev: *mut hid_device, id: *const hid_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn corsair_remove(dev: *mut hid_device) {
