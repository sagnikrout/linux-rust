...
//! Source: drivers/hid/bpf/progs/Huion__Kamvas13Gen3.bpf.c
#![no_std]
...
pub const PID_KAMVAS13_GEN3: c_uint = 0x2008;
pub const VENDOR_DESCRIPTOR_LENGTH: c_int = 36;
pub const TABLET_DESCRIPTOR_LENGTH: c_int = 368;
pub const WHEEL_DESCRIPTOR_LENGTH: c_int = 108;
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_fix_rdesc_huion_kamvas13_gen3, hid_ctx: *mut hid_bpf_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_fix_event_huion_kamvas13_gen3, hid_ctx: *mut hid_bpf_ctx) -> c_int {
