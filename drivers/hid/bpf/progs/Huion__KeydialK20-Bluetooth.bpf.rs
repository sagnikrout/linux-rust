...
//! Source: drivers/hid/bpf/progs/Huion__KeydialK20-Bluetooth.bpf.c
#![no_std]
...
pub const PID_KEYDIAL_K20_BLUETOOTH: c_uint = 0x8251;
    HID_BPF_CONFIG(
...
//
pub const BT_PAD_REPORT_DESCRIPTOR_LENGTH: c_int = 160;

pub const BT_PAD_KBD_REPORT_ID: c_int = 1;
pub const BT_PAD_CC_REPORT_ID: c_int = 2;
pub const BT_PAD_MOUSE_REPORT_ID: c_int = 5;
pub const BT_PAD_KBD_REPORT_LENGTH: c_int = 9;
pub const BT_PAD_CC_REPORT_LENGTH: c_int = 3;
pub const BT_PAD_MOUSE_REPORT_LENGTH: c_int = 7;

    let mut last_button_state: __u32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: k20_bt_fix_rdesc, hctx: *mut hid_bpf_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: k20_bt_fix_events, hctx: *mut hid_bpf_ctx) -> c_int {
...
pub struct pad_report {
    ...
    pub buttons: __u32,
    pub wheel: __u8,
    pub )data: *mut *mut } __packed  pad_report = (struct pad_report,
    if (!data)
    pub /: *mut *mut return 0; / EPERM check,
// Report ID 1 - Keyboard events (button presses)
    ...
    let mut modifiers: __u8 = data[1];
    let mut buttons: __u32 = 0;
...
// Report ID 5 - Mouse events (wheel rotation)
    ...
    let mut wheel_delta: __u8 = data[6];
    pad_report.report_id = OUR_REPORT_ID;
    pad_report.btn_stylus = 0;
    pad_report.x = 0;
    pad_report.y = 0;
