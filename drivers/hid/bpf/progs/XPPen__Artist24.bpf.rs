...
//! Source: drivers/hid/bpf/progs/XPPen__Artist24.bpf.c
#![no_std]
...
pub const PID_ARTIST_24: c_uint = 0x093A;
pub const PID_ARTIST_24_PRO: c_uint = 0x092D;
    HID_BPF_CONFIG(
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_fix_rdesc_xppen_artist24, hctx: *mut hid_bpf_ctx) -> c_int {
    ...
    let mut prev_state: static __u8 = 0;
//
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: xppen_24_fix_eraser, hctx: *mut hid_bpf_ctx) -> c_int {
