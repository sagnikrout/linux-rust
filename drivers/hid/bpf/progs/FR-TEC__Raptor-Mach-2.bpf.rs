...
//! Source: drivers/hid/bpf/progs/FR-TEC__Raptor-Mach-2.bpf.c
#![no_std]
...
pub const VID_BETOP_2185PC: c_uint = 0x11C0;
pub const PID_RAPTOR_MACH_2: c_uint = 0x5606;
    HID_BPF_CONFIG(
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_fix_rdesc_raptor_mach_2, hctx: *mut hid_bpf_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: raptor_mach_2_fix_hat_switch, hctx: *mut hid_bpf_ctx) -> c_int {
