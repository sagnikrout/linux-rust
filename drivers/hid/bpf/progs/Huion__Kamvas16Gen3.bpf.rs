...
//! Source: drivers/hid/bpf/progs/Huion__Kamvas16Gen3.bpf.c
#![no_std]
...
pub const PID_KAMVAS16_GEN3: c_uint = 0x2009;
pub const VENDOR_DESCRIPTOR_LENGTH: c_int = 36;
pub const TABLET_DESCRIPTOR_LENGTH: c_int = 328;
pub const WHEEL_DESCRIPTOR_LENGTH: c_int = 200;
pub const VENDOR_REPORT_ID: c_int = 8;
pub const VENDOR_REPORT_LENGTH: c_int = 14;
pub const VENDOR_REPORT_SUBTYPE_PEN: c_uint = 0x08;
pub const VENDOR_REPORT_SUBTYPE_PEN_OUT: c_uint = 0x00;
pub const VENDOR_REPORT_SUBTYPE_BUTTONS: c_uint = 0x0e;
pub const VENDOR_REPORT_SUBTYPE_WHEELS: c_uint = 0x0f;
// For the reports that we create ourselves
pub const CUSTOM_PAD_REPORT_ID: c_int = 9;
    HID_BPF_CONFIG(
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_fix_rdesc_huion_kamvas16_gen3, hid_ctx: *mut hid_bpf_ctx) -> c_int {
    ...
    let mut rdesc_size: __s32 = hid_ctx.size;
    __u8 have_fw_id;
    if (!data)
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_fix_event_huion_kamvas16_gen3, hid_ctx: *mut hid_bpf_ctx) -> c_int {
...
// Handle vendor reports only
    ...
    return 0;
    let mut report_subtype: __u8 = (data[1] >> 4) & 0x0f;
...
pub struct pad_report {
    ...
    pub buttons: __u8,
    pub top_wheel: __s8,
    pub bottom_wheel: __s8,
// C attribute field omitted
    pub 0: __s8 top_wheel =,
    pub 0: __s8 bottom_wheel =,
...
//
    switch (data[3]) {
    case 1:
    pub -1: top_wheel = (data[5] == 1) ? 1 :,
    case 2:
    pub -1: bottom_wheel = (data[5] == 1) ? 1 :,
    }
...
//
    ...
    pub data: [last_button_state =; 4],
    }
    pub )data: *mut pad_report = (struct pad_report,
    pub CUSTOM_PAD_REPORT_ID: pad_report->report_id =,
    pub 0: pad_report->btn_stylus =,
    pub 0: pad_report->x =,
    pub 0: pad_report->y =,
    pub last_button_state: pad_report->buttons =,
    pub top_wheel: pad_report->top_wheel =,
    pub bottom_wheel: pad_report->bottom_wheel =,
