...
//! Source: drivers/hid/bpf/progs/Rapoo__M50-Plus-Silent.bpf.c
#![no_std]
...
pub const VID_RAPOO: c_uint = 0x24AE;
pub const PID_M50: c_uint = 0x2015;
pub const RDESC_SIZE: c_int = 186;
    HID_BPF_CONFIG(
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_rdesc_fixup_rapoo_m50, hctx: *mut hid_bpf_ctx) -> c_int {
