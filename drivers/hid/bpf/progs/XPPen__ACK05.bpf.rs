...
//! Source: drivers/hid/bpf/progs/XPPen__ACK05.bpf.c
#![no_std]
...
//
pub const PAD_WIRED_DESCRIPTOR_LENGTH: c_int = 102;
pub const PAD_DONGLE_DESCRIPTOR_LENGTH: c_int = 177;
pub const STYLUS_DESCRIPTOR_LENGTH: c_int = 109;
pub const VENDOR_DESCRIPTOR_LENGTH: c_int = 36;
pub const PAD_REPORT_ID: c_int = 6;
pub const RAW_PAD_REPORT_ID: c_uint = 0xf0;
pub const RAW_BATTERY_REPORT_ID: c_uint = 0xf2;
pub const VENDOR_REPORT_ID: c_int = 2;
pub const PAD_REPORT_LENGTH: c_int = 8;
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: ack05_fix_rdesc, hctx: *mut hid_bpf_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn HID_BPF_ASYNC_FUN(hid: *mut switch_to_raw_mode)(struct hid_bpf_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: ack05_fix_events, hctx: *mut hid_bpf_ctx) -> c_int {
