...
//! Source: drivers/hid/bpf/progs/Thrustmaster__TCA-Yoke-Boeing.bpf.c
#![no_std]
...
pub const VID_THRUSTMASTER: c_uint = 0x044F;
pub const PID_TCA_YOKE_BOEING: c_uint = 0x0409;
    HID_BPF_CONFIG(
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: hid_fix_rdesc_tca_yoke, hctx: *mut hid_bpf_ctx) -> c_int {
    int BPF_PROG(hid_fix_rdesc_tca_yoke, struct hid_bpf_ctx *hctx)
    {
    let mut expected_length: c_int = 148;
