...
//! Source: drivers/hid/bpf/progs/XPPen__Deco01V3.bpf.c
#![no_std]
...
pub const PID_DECO_01_V3: c_uint = 0x0947;
    HID_BPF_CONFIG(
...
//
pub const PEN_REPORT_DESCRIPTOR_LENGTH: c_int = 109;
pub const PAD_REPORT_DESCRIPTOR_LENGTH: c_int = 102;
pub const PAD_REPORT_LENGTH: c_int = 8;
pub const PAD_REPORT_ID: c_int = 6;
pub const PAD_NUM_BUTTONS: c_int = 8;
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: xppen_deco01v3_rdesc_fixup, hctx: *mut hid_bpf_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: xppen_deco01v3_device_event, hctx: *mut hid_bpf_ctx) -> c_int {
