...
//! Source: drivers/hid/bpf/progs/XPPen__Deco02.bpf.c
#![no_std]
...
pub const PID_DECO_02: c_uint = 0x0803;
    HID_BPF_CONFIG(
...
//
pub const RDESC_SIZE_PAD: c_int = 188;
pub const REPORT_SIZE_PAD: c_int = 8;
pub const REPORT_ID_BUTTONS: c_int = 3;
pub const PAD_BUTTON_COUNT: c_int = 6;
pub const RDESC_KEYBOARD_OFFSET: c_int = 148;
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: xppen_deco02_rdesc_fixup, hctx: *mut hid_bpf_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: xppen_deco02_device_event, hctx: *mut hid_bpf_ctx) -> c_int {
