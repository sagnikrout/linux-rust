...
//! Source: drivers/hid/bpf/progs/Wacom__ArtPen.bpf.c
#![no_std]
...
pub const VID_WACOM: c_uint = 0x056a;
pub const ART_PEN_ID: c_uint = 0x0804;
pub const PID_INTUOS_PRO_2_M: c_uint = 0x0357;
    HID_BPF_CONFIG(
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: artpen_pressure_interpolate, hctx: *mut hid_bpf_ctx) -> c_int {
