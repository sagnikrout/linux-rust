...
//! Source: drivers/hid/bpf/progs/Huion__Dial-2.bpf.c
#![no_std]
...
pub const PID_DIAL_2: c_uint = 0x0060;
    HID_BPF_CONFIG(
...
//
pub const PAD_REPORT_DESCRIPTOR_LENGTH: c_int = 148;
...
pub const DIAL_REPORT_ID: c_int = 17;
pub const PEN_REPORT_ID: c_int = 10;
pub const VENDOR_REPORT_ID: c_int = 8;
pub const PAD_REPORT_LENGTH: c_int = 9;
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: dial_2_fix_rdesc, hctx: *mut hid_bpf_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: dial_2_fix_events, hctx: *mut hid_bpf_ctx) -> c_int {
...
//
    let mut dial: __u16 = data[3] << 8 | data[2];
    button &= 0x3f;
    button |= !!data[1] << 6;
...
// data[4] are the buttons, mapped correctly
    ...
    pub dial_1: pad_report->dial_1 =,
    pub dial_2: pad_report->dial_2 =,
