...
//! Source: drivers/hid/bpf/progs/Huion__Inspiroy-2-S.bpf.c
#![no_std]
...
pub const PID_INSPIROY_2_S: c_uint = 0x0066;
    HID_BPF_CONFIG(
...
//
pub const PAD_REPORT_DESCRIPTOR_LENGTH: c_int = 65;
pub const PEN_REPORT_DESCRIPTOR_LENGTH: c_int = 93;
pub const VENDOR_REPORT_DESCRIPTOR_LENGTH: c_int = 18;
pub const PAD_REPORT_ID: c_int = 3;
pub const PEN_REPORT_ID: c_int = 10;
pub const VENDOR_REPORT_ID: c_int = 8;
pub const PAD_REPORT_LENGTH: c_int = 8;
pub const PEN_REPORT_LENGTH: c_int = 10;
...
#[no_mangle]
pub unsafe extern "C" fn BPF_PROG(_arg: inspiroy_2_fix_events, hctx: *mut hid_bpf_ctx) -> c_int {
...
//
    let mut button: __u8 = 0;
    let mut wheel: __u8 = 0;
...
// data[4] are the buttons, mapped correctly
    ...
    pub PAD_REPORT_ID: pad_report->report_id =,
    ...
    pub 0x1: __u8 tip_state = data[1] &,
    pub 0x4: __u8 sec_barrel_state = data[1] &,
    if (force_tip_down_count > 0) {
    pub 0x1: data[1] |=,
    if (tip_state)
    pub 0: force_tip_down_count =,
    }
...
//
    ...
    pub 4: force_tip_down_count =,
    pub 0x1: data[1] |=,
    }
    pub tip_state: last_tip_state =,
    pub sec_barrel_state: last_sec_barrel_state =,
    }
    }
    pub 0: return,
    }
