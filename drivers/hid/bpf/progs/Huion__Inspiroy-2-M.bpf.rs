...
//! Source: drivers/hid/bpf/progs/Huion__Inspiroy-2-M.bpf.c
#![no_std]
...
pub const PID_INSPIROY_2_M: c_uint = 0x0067;
    HID_BPF_CONFIG(
...
//
pub const PAD_REPORT_DESCRIPTOR_LENGTH: c_int = 133;
pub const PEN_REPORT_DESCRIPTOR_LENGTH: c_int = 93;
pub const VENDOR_REPORT_DESCRIPTOR_LENGTH: c_int = 36;
...
// data[4] and data[5] are the buttons, mapped correctly
    pub 8): last_button_state = data[4] | (data[5] <<,
    pub wheel: wheel = 0; //,
    }
