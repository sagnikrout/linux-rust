...
//! Source: drivers/hid/intel-ish-hid/ipc/ipc.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn _ish_read_fw_sts_reg(dev: *mut ishtp_device) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn check_generated_interrupt(dev: *mut ishtp_device) -> bool {
    static bool check_generated_interrupt(struct ishtp_device *dev)
    {
    let mut interrupt_generated: bool = true;
    let mut pisr_val: u32 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn ish_is_input_ready(dev: *mut ishtp_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn set_host_ready(dev: *mut ishtp_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ishtp_fw_is_ready(dev: *mut ishtp_device) -> bool {
    static bool ishtp_fw_is_ready(struct ishtp_device *dev)
    {
    let mut ish_status: u32 = _ish_read_fw_sts_reg(dev);
...
//
#[no_mangle]
unsafe extern "C" fn ish_set_host_rdy(dev: *mut ishtp_device) {
    static void ish_set_host_rdy(struct ishtp_device *dev)
    {
    let mut host_status: u32 = ish_reg_read(dev, IPC_REG_HOST_COMM);
...
//
#[no_mangle]
unsafe extern "C" fn ish_clr_host_rdy(dev: *mut ishtp_device) {
...
#[no_mangle]
unsafe extern "C" fn ish_chk_host_rdy(dev: *mut ishtp_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ish_set_host_ready(dev: *mut ishtp_device) {
...
//
#[no_mangle]
unsafe extern "C" fn _ishtp_read_hdr(dev: *const ishtp_device) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn write_ipc_from_queue(dev: *mut ishtp_device) -> c_int {
...
//
    ...
    let mut drbl_val: u32 = IPC_BUILD_MNG_MSG(msg_code, size);
    memcpy(ipc_msg, &drbl_val, sizeof(uint32_t));
    memcpy(ipc_msg + sizeof(uint32_t), msg, size);
    return	write_ipc_to_queue(dev, core::ptr::null_mut(), core::ptr::null_mut(), ipc_msg,
    sizeof(uint32_t) + size);
    }
pub const WAIT_FOR_FW_RDY: c_uint = 0x1;
pub const WAIT_FOR_INPUT_RDY: c_uint = 0x2;
//
...
#[no_mangle]
unsafe extern "C" fn ish_send_reset_notify_ack(dev: *mut ishtp_device) {
    static void ish_send_reset_notify_ack(struct ishtp_device *dev)
    {
// Read reset ID
    let mut reset_id: u32 = ish_reg_read(dev, IPC_REG_ISH2HOST_MSG) & 0xFFFF;
//
...
pub const TIME_SLICE_FOR_FW_RDY_MS: c_int = 100;
pub const TIME_SLICE_FOR_INPUT_RDY_MS: c_int = 100;
pub const TIMEOUT_FOR_FW_RDY_MS: c_int = 2000;
pub const TIMEOUT_FOR_INPUT_RDY_MS: c_int = 2000;
//
...
//
#[no_mangle]
unsafe extern "C" fn ish_fw_reset_handler(dev: *mut ishtp_device) -> c_int {
...
pub const TIMEOUT_FOR_HW_RDY_MS: c_int = 300;
//
...
//
#[no_mangle]
unsafe extern "C" fn fw_reset_work_fn(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn _ish_sync_fw_clock(dev: *mut ishtp_device) {
    static void _ish_sync_fw_clock(struct ishtp_device *dev)
    {
    let mut time: ipc_time_update_msg = {};
...
//
#[no_mangle]
unsafe extern "C" fn recv_ipc(dev: *mut ishtp_device, doorbell_val: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ish_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn ish_disable_dma(dev: *mut ishtp_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ish_wakeup(dev: *mut ishtp_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _ish_hw_reset(dev: *mut ishtp_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _ish_ipc_reset(dev: *mut ishtp_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ish_hw_start(dev: *mut ishtp_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _dma_no_cache_snooping(dev: *mut ishtp_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ishtp_free_workqueue(wq: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ish_device_disable(dev: *mut ishtp_device) {
