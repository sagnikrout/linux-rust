...
//! Source: drivers/hid/intel-ish-hid/ishtp-fw-loader.c
#![no_std]
...
pub const MAX_LOAD_ATTEMPTS: c_int = 3;
// ISH TX/RX ring buffer pool size
pub const LOADER_CL_RX_RING_SIZE: c_int = 1;
pub const LOADER_CL_TX_RING_SIZE: c_int = 1;
//
...
//
pub const LOADER_SHIM_IPC_BUF_SIZE: c_int = 3968;
//
...
pub const FILENAME_SIZE: c_int = 256;
//
...
//
    let mut dma_buf_size_limit: static int = 4 * PAGE_SIZE;
//
...
pub struct loader_xfer_query {
    pub hdr: loader_msg_hdr,
    pub image_size: u32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ish_fw_version {
    pub major: u16,
    pub minor: u16,
    pub hotfix: u16,
    pub build: u16,
...
pub struct loader_capability {
    pub max_fw_image_size: u32,
    pub xfer_mode: u32,
    pub /: *mut *mut u32 max_dma_buf_size; / only for dma mode, multiples of cacheline,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct shim_fw_info {
    pub ish_fw_version: ish_fw_version,
    pub protocol_version: u32,
    pub ldr_version: union loader_version,
    pub ldr_capability: loader_capability,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct loader_xfer_query_response {
    pub hdr: loader_msg_hdr,
    pub fw_info: shim_fw_info,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct loader_xfer_ipc_fragment {
    pub fragment: loader_xfer_fragment,
    pub /: *mut *mut u8 data[] ____cacheline_aligned; / variable length payload here,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct loader_xfer_dma_fragment {
    pub fragment: loader_xfer_fragment,
    pub ddr_phys_addr: u64,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct ishtp_cl_data {
    pub loader_ishtp_cl: *mut ishtp_cl,
    pub cl_device: *mut ishtp_cl_device,
//
// Used for passing firmware response information between
// loader_cl_send() and process_recv() callback.
//
    pub response: response_info,
    pub work_ishtp_reset: work_struct,
    pub work_fw_load: work_struct,
//
...
//
    ...
    let mut data_len: usize = rb_in_proc.buf_idx;
...
//
#[no_mangle]
unsafe extern "C" fn loader_cl_event_cb(cl_device: *mut ishtp_cl_device) {
    static void loader_cl_event_cb(struct ishtp_cl_device *cl_device)
    {
    struct ishtp_cl_rb *rb_in_proc;
    struct ishtp_cl	*loader_ishtp_cl = ishtp_get_drvdata(cl_device);
    while ((rb_in_proc = ishtp_cl_rx_get_rb(loader_ishtp_cl)) != core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn ish_fw_start(client_data: *mut ishtp_cl_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn load_fw_from_host(client_data: *mut ishtp_cl_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn load_fw_from_host_handler(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn loader_init(loader_ishtp_cl: *mut ishtp_cl, reset: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loader_deinit(loader_ishtp_cl: *mut ishtp_cl) {
...
#[no_mangle]
unsafe extern "C" fn reset_handler(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn loader_ishtp_cl_probe(cl_device: *mut ishtp_cl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn loader_ishtp_cl_remove(cl_device: *mut ishtp_cl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn loader_ishtp_cl_reset(cl_device: *mut ishtp_cl_device) -> c_int {
