...
//! Source: drivers/hid/intel-ish-hid/ishtp/dma-if.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn ishtp_cl_alloc_dma_buf(dev: *mut ishtp_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ishtp_cl_free_dma_buf(dev: *mut ishtp_device) {
    ...
    dev.ishtp_host_dma_tx_buf = core::ptr::null_mut();
    dev.ishtp_host_dma_rx_buf = core::ptr::null_mut();
    dev.ishtp_dma_tx_map = core::ptr::null_mut();
    }
//
