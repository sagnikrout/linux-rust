...
//! Source: drivers/hid/intel-ish-hid/ishtp-hid-client.c
#![no_std]
...
pub const HID_CL_RX_RING_SIZE: c_int = 32;
pub const HID_CL_TX_RING_SIZE: c_int = 16;
...
//
    ...
    size_t report_len;
    struct ishtp_cl_data *client_data = ishtp_get_client_data(hid_ishtp_cl);
    let mut curr_hid_dev: c_int = client_data.cur_hid_dev;
    struct ishtp_hid_data *hid_data = core::ptr::null_mut();
    struct hid_device *hid = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ish_cl_event_cb(device: *mut ishtp_cl_device) {
    ...
    if (!hid_ishtp_cl)
    return;
    while ((rb_in_proc = ishtp_cl_rx_get_rb(hid_ishtp_cl)) != core::ptr::null_mut()) {
...
//
    ...
    struct ishtp_hid_data *hid_data =  hid.driver_data;
    struct ishtp_cl_data *client_data = hid_data.client_data;
    let mut msg: hostif_msg_to_sensor = {};
    int	rv;
    int	i;
    hid_ishtp_trace(client_data,  "%s hid %p\n", __func__, hid);
    rv = ishtp_hid_link_ready_wait(client_data);
...
//
#[no_mangle]
pub unsafe extern "C" fn ishtp_hid_link_ready_wait(client_data: *mut ishtp_cl_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ishtp_enum_enum_devices(hid_ishtp_cl: *mut ishtp_cl) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ishtp_get_hid_descriptor(hid_ishtp_cl: *mut ishtp_cl, index: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hid_ishtp_cl_init(hid_ishtp_cl: *mut ishtp_cl, reset: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hid_ishtp_cl_deinit(hid_ishtp_cl: *mut ishtp_cl) {
...
#[no_mangle]
unsafe extern "C" fn hid_ishtp_cl_reset_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn hid_ishtp_cl_resume_handler(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn hid_ishtp_cl_probe(cl_device: *mut ishtp_cl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hid_ishtp_cl_remove(cl_device: *mut ishtp_cl_device) {
    ...
    hid_ishtp_cl = core::ptr::null_mut();
    client_data.num_hid_devices = 0;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn hid_ishtp_cl_reset(cl_device: *mut ishtp_cl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hid_ishtp_cl_suspend(device: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hid_ishtp_cl_resume(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ish_hid_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ish_hid_exit() -> void __exit {
