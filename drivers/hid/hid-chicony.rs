...
//! Source: drivers/hid/hid-chicony.c
#![no_std]
...
pub const CH_WIRELESS_CTL_REPORT_ID: c_uint = 0x11;
#[no_mangle]
unsafe extern "C" fn ch_report_wireless(report: *mut hid_report, data: *mut u8, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ch_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
