...
//! Source: drivers/hid/hid-wiimote-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wiimote_queue_worker(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn wiiproto_keep_rumble(wdata: *mut wiimote_data, cmd1: *mut __u8) {
...
#[no_mangle]
pub unsafe extern "C" fn wiiproto_req_rumble(wdata: *mut wiimote_data, rumble: __u8) {
...
#[no_mangle]
pub unsafe extern "C" fn wiiproto_req_leds(wdata: *mut wiimote_data, leds: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn select_drm(wdata: *mut wiimote_data) -> __u8 {
    static __u8 select_drm(struct wiimote_data *wdata)
    {
    let mut ir: __u8 = wdata.state.flags & WIIPROTO_FLAGS_IR;
    bool ext;
...
#[no_mangle]
pub unsafe extern "C" fn wiiproto_req_drm(wdata: *mut wiimote_data, drm: __u8) {
    ...
    drm = wdata.state.drm;
#[no_mangle]
pub unsafe extern "C" fn if(WIIPROTO_REQ_NULL: drm ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn wiiproto_req_status(wdata: *mut wiimote_data) {
...
#[no_mangle]
pub unsafe extern "C" fn wiiproto_req_accel(wdata: *mut wiimote_data, accel: __u8) {
...
#[no_mangle]
pub unsafe extern "C" fn wiiproto_req_ir1(wdata: *mut wiimote_data, flags: __u8) {
...
#[no_mangle]
pub unsafe extern "C" fn wiiproto_req_ir2(wdata: *mut wiimote_data, flags: __u8) {
...
#[no_mangle]
unsafe extern "C" fn wiimote_cmd_init_ext(wdata: *mut wiimote_data) -> c_int {
...
// requires the cmd-mutex to be held
#[no_mangle]
unsafe extern "C" fn wiimote_cmd_read_ext(wdata: *mut wiimote_data, rmem: *mut __u8) -> __u8 {
...
// requires the cmd-mutex to be held
#[no_mangle]
unsafe extern "C" fn wiimote_cmd_init_mp(wdata: *mut wiimote_data) -> c_int {
...
// requires the cmd-mutex to be held
#[no_mangle]
unsafe extern "C" fn wiimote_cmd_map_mp(wdata: *mut wiimote_data, exttype: __u8) -> bool {
...
// requires the cmd-mutex to be held
#[no_mangle]
unsafe extern "C" fn wiimote_cmd_read_mp(wdata: *mut wiimote_data, rmem: *mut __u8) -> bool {
...
// requires the cmd-mutex to be held
#[no_mangle]
unsafe extern "C" fn wiimote_cmd_read_mp_mapped(wdata: *mut wiimote_data) -> __u8 {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x05: rmem[4] == 0x05 && rmem[5] ==) -> else {
    else if (rmem[4] == 0x05 && rmem[5] == 0x05)
    return WIIMOTE_MP_PASSTHROUGH_NUNCHUK;
#[no_mangle]
pub unsafe extern "C" fn if(0x05: rmem[4] == 0x07 && rmem[5] ==) -> else {
...
// device module handling
    ...
    wdata.input = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn wiimote_modules_unload(wdata: *mut wiimote_data) {
...
#[no_mangle]
unsafe extern "C" fn wiimote_ext_load(wdata: *mut wiimote_data, ext: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn wiimote_ext_unload(wdata: *mut wiimote_data) {
...
#[no_mangle]
unsafe extern "C" fn wiimote_mp_load(wdata: *mut wiimote_data) {
...
#[no_mangle]
unsafe extern "C" fn wiimote_mp_unload(wdata: *mut wiimote_data) {
...
// WIIMOTE_DEV_GENERIC so all modules will get probed on the device.
    ...
    __u8 exttype)
    {
    let mut devtype: __u8 = WIIMOTE_DEV_GENERIC;
...
#[no_mangle]
unsafe extern "C" fn wiimote_init_detect(wdata: *mut wiimote_data) {
    static void wiimote_init_detect(struct wiimote_data *wdata)
    {
    let mut exttype: __u8 = WIIMOTE_EXT_NONE, extdata[6];
    bool ext;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn wiimote_init_poll_mp(wdata: *mut wiimote_data) {
...
//
#[no_mangle]
unsafe extern "C" fn wiimote_init_check(wdata: *mut wiimote_data) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn wiimote_init_hotplug(wdata: *mut wiimote_data) {
...
#[no_mangle]
unsafe extern "C" fn wiimote_init_worker(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn __wiimote_schedule(wdata: *mut wiimote_data) {
...
#[no_mangle]
unsafe extern "C" fn wiimote_schedule(wdata: *mut wiimote_data) {
...
#[no_mangle]
unsafe extern "C" fn wiimote_init_timeout(t: *mut timer_list) {
...
// protocol handlers
#[no_mangle]
unsafe extern "C" fn handler_keys(wdata: *mut wiimote_data, payload: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn handler_accel(wdata: *mut wiimote_data, payload: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn valid_ext_handler(ops: *const wiimod_ops, len: usize) -> bool {
...
#[no_mangle]
unsafe extern "C" fn handler_status(wdata: *mut wiimote_data, payload: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn handler_generic_K(wdata: *mut wiimote_data, payload: *const __u8) {
    static void handler_generic_K(struct wiimote_data *wdata, const __u8 *payload)
    {
    handler_keys(wdata, payload);
    }
#[no_mangle]
unsafe extern "C" fn handler_data(wdata: *mut wiimote_data, payload: *const __u8) {
    static void handler_data(struct wiimote_data *wdata, const __u8 *payload)
    {
    let mut offset: __u16 = payload[3] << 8 | payload[4];
    let mut size: __u8 = (payload[2] >> 4) + 1;
    let mut err: __u8 = payload[2] & 0x0f;
    handler_keys(wdata, payload);
    if (wiimote_cmd_pending(wdata, WIIPROTO_REQ_RMEM, offset)) {
    if (err)
    size = 0;
#[no_mangle]
pub unsafe extern "C" fn if(wdata->state.cmd_read_size: size >) -> else {
...
#[no_mangle]
unsafe extern "C" fn handler_return(wdata: *mut wiimote_data, payload: *const __u8) {
    static void handler_return(struct wiimote_data *wdata, const __u8 *payload)
    {
    let mut err: __u8 = payload[3];
    let mut cmd: __u8 = payload[2];
    handler_keys(wdata, payload);
...
#[no_mangle]
unsafe extern "C" fn handler_drm_KA(wdata: *mut wiimote_data, payload: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn handler_drm_KE(wdata: *mut wiimote_data, payload: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn handler_drm_KAI(wdata: *mut wiimote_data, payload: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn handler_drm_KEE(wdata: *mut wiimote_data, payload: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn handler_drm_KIE(wdata: *mut wiimote_data, payload: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn handler_drm_KAE(wdata: *mut wiimote_data, payload: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn handler_drm_KAIE(wdata: *mut wiimote_data, payload: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn handler_drm_E(wdata: *mut wiimote_data, payload: *const __u8) {
    static void handler_drm_E(struct wiimote_data *wdata, const __u8 *payload)
    {
    handler_ext(wdata, payload, 21);
    }
#[no_mangle]
unsafe extern "C" fn handler_drm_SKAI1(wdata: *mut wiimote_data, payload: *const __u8) {
...
#[no_mangle]
unsafe extern "C" fn handler_drm_SKAI2(wdata: *mut wiimote_data, payload: *const __u8) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wiiproto_handler {
    pub id: __u8,
    pub size: usize,
    pub payload): *const *const *const void (func)(struct wiimote_data wdata, __u8,
}
    ...
    static DEVICE_ATTR(devtype, S_IRUGO, wiimote_dev_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn wiimote_destroy(wdata: *mut wiimote_data) {
...
#[no_mangle]
unsafe extern "C" fn wiimote_hid_remove(hdev: *mut hid_device) {
    ...
    let mut wiimote_dpad_as_analog: bool = false;
