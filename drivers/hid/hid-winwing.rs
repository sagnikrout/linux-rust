...
//! Source: drivers/hid/hid-winwing.c
#![no_std]
...
pub const MAX_REPORT: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct winwing_led {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct winwing_led_info {
    pub number: c_int,
    pub max_brightness: c_int,
    pub led_name: *const c_char,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct winwing_drv_data {
    pub hdev: *mut hid_device,
    pub lights_lock: mutex,
    pub report_lights: *mut __u8,
    pub report_rumble: *mut __u8,
    pub rumble_work: work_struct,
    pub rumble: ff_rumble_effect,
    pub rumble_left: c_int,
    pub rumble_right: c_int,
    pub has_grip15: c_int,
    pub leds: [winwing_led; ],
}
...
#[no_mangle]
unsafe extern "C" fn winwing_map_button(button: c_int, has_grip15: c_int) -> c_int {
...
//
    ...
    {
    struct winwing_drv_data *data;
    let mut code: c_int = KEY_RESERVED;
...
//
#[no_mangle]
pub unsafe extern "C" fn convert_magnitude(x: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn winwing_haptic_rumble(data: *mut winwing_drv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn winwing_haptic_rumble_cb(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn winwing_init_ff(hdev: *mut hid_device, hidinput: *mut hid_input) -> c_int {
    ...
    {
    struct winwing_drv_data *data;
    let mut data_size: usize = struct_size(data, leds, 3);
    int ret;
    ret = hid_parse(hdev);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn winwing_remove(hdev: *mut hid_device) {
