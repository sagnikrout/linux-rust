...
pub const GFRM100_SEARCH_KEY_REPORT_ID: c_uint = 0xF7;
pub const GFRM100_SEARCH_KEY_DOWN: c_uint = 0x0;
pub const GFRM100_SEARCH_KEY_AUDIO_DATA: c_uint = 0x1;
pub const GFRM100_SEARCH_KEY_UP: c_uint = 0x2;
    ...
    let mut hdev_type: c_ulong = id.driver_data;
...
#[no_mangle]
unsafe extern "C" fn gfrm_input_configured(hid: *mut hid_device, hidinput: *mut hid_input) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gfrm_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
