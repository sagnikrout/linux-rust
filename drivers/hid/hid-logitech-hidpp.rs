...
//! Source: drivers/hid/hid-logitech-hidpp.c
#![no_std]
...
pub const LINUX_KERNEL_SW_ID: c_uint = 0x01;
pub const REPORT_ID_HIDPP_SHORT: c_uint = 0x10;
pub const REPORT_ID_HIDPP_LONG: c_uint = 0x11;
pub const REPORT_ID_HIDPP_VERY_LONG: c_uint = 0x12;
pub const HIDPP_REPORT_SHORT_LENGTH: c_int = 7;
pub const HIDPP_REPORT_LONG_LENGTH: c_int = 20;
pub const HIDPP_REPORT_VERY_LONG_MAX_LENGTH: c_int = 64;

pub const HIDPP_SUB_ID_CONSUMER_VENDOR_KEYS: c_uint = 0x03;
pub const HIDPP_SUB_ID_ROLLER: c_uint = 0x05;
pub const HIDPP_SUB_ID_MOUSE_EXTRA_BTNS: c_uint = 0x06;
pub const HIDPP_SUB_ID_USER_IFACE_EVENT: c_uint = 0x08;
...
pub struct fap {
    ...
    pub 4U]: u8 params[HIDPP_REPORT_VERY_LONG_MAX_LENGTH -,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidpp_report {
    pub report_id: u8,
    pub device_index: u8,
    union {
    pub fap: fap,
    pub rap: rap,
    pub fap)]: u8 rawbytes[sizeof(struct,
}

    } __packed;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidpp_battery {
    pub feature_index: u8,
    pub solar_feature_index: u8,
    pub voltage_feature_index: u8,
    pub adc_measurement_feature_index: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidpp_scroll_counter {
    pub wheel_multiplier: c_int,
    pub remainder: c_int,
    pub direction: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidpp_device {
    pub hid_dev: *mut hid_device,
    pub input: *mut input_dev,
    pub send_mutex: mutex,
    pub send_receive_buf: *mut c_void,
    pub /: *mut *mut *mut char name; / will never be NULL and should not be freed,
    pub wait: wait_queue_head_t,
    pub very_long_report_length: c_int,
    pub answer_available: bool,
    pub protocol_major: u8,
    pub protocol_minor: u8,
    pub private_data: *mut c_void,
    pub work: work_struct,
    pub reset_hi_res_work: work_struct,
    pub delayed_work_fifo: kfifo,
    pub delayed_input: *mut input_dev,
    pub quirks: c_ulong,
    pub capabilities: c_ulong,
    pub supported_reports: u8,
    pub battery: hidpp_battery,
    pub vertical_wheel_counter: hidpp_scroll_counter,
    pub wireless_feature_index: u8,
    pub reprog_controls_feature_index: u8,
    pub reprog_controls: *const hidpp_reprog_control_mapping,
    pub hires_wheel_multiplier: c_int,
    pub hires_wheel_feature_index: u8,
    pub connected_once: bool,
}

// HID++ 1.0 error codes
pub const HIDPP_ERROR: c_uint = 0x8f;
pub const HIDPP_ERROR_SUCCESS: c_uint = 0x00;
pub const HIDPP_ERROR_INVALID_SUBID: c_uint = 0x01;
pub const HIDPP_ERROR_INVALID_ADRESS: c_uint = 0x02;
pub const HIDPP_ERROR_INVALID_VALUE: c_uint = 0x03;
pub const HIDPP_ERROR_CONNECT_FAIL: c_uint = 0x04;
pub const HIDPP_ERROR_TOO_MANY_DEVICES: c_uint = 0x05;
pub const HIDPP_ERROR_ALREADY_EXISTS: c_uint = 0x06;
pub const HIDPP_ERROR_BUSY: c_uint = 0x07;
pub const HIDPP_ERROR_UNKNOWN_DEVICE: c_uint = 0x08;
pub const HIDPP_ERROR_RESOURCE_ERROR: c_uint = 0x09;
pub const HIDPP_ERROR_REQUEST_UNAVAILABLE: c_uint = 0x0a;
pub const HIDPP_ERROR_INVALID_PARAM_VALUE: c_uint = 0x0b;
pub const HIDPP_ERROR_WRONG_PIN_CODE: c_uint = 0x0c;
// HID++ 2.0 error codes
pub const HIDPP20_ERROR_NO_ERROR: c_uint = 0x00;
pub const HIDPP20_ERROR_UNKNOWN: c_uint = 0x01;
pub const HIDPP20_ERROR_INVALID_ARGS: c_uint = 0x02;
pub const HIDPP20_ERROR_OUT_OF_RANGE: c_uint = 0x03;
pub const HIDPP20_ERROR_HW_ERROR: c_uint = 0x04;
pub const HIDPP20_ERROR_NOT_ALLOWED: c_uint = 0x05;
pub const HIDPP20_ERROR_INVALID_FEATURE_INDEX: c_uint = 0x06;
pub const HIDPP20_ERROR_INVALID_FUNCTION_ID: c_uint = 0x07;
pub const HIDPP20_ERROR_BUSY: c_uint = 0x08;
pub const HIDPP20_ERROR_UNSUPPORTED: c_uint = 0x09;
pub const HIDPP20_ERROR: c_uint = 0xff;
...
//
    ...
    let mut ret: return = = fields_count ? 0 : -1;
    }
//
...
// response = *message;
    ...
    ret = 0;
    out:
    hidpp.send_receive_buf = core::ptr::null_mut();
    return ret;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn hidpp_prefix_name(name: *mut c_char, name_length: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn hidpp_update_usb_wireless_status(hidpp: *mut hidpp_device) {
...
// HIDP++ 1.0 commands
// --------------------------------------------------------------------------
pub const HIDPP_SET_REGISTER: c_uint = 0x80;
pub const HIDPP_GET_REGISTER: c_uint = 0x81;
pub const HIDPP_SET_LONG_REGISTER: c_uint = 0x82;
pub const HIDPP_GET_LONG_REGISTER: c_uint = 0x83;
//
...
pub const HIDPP_REG_ENABLE_REPORTS: c_uint = 0x00;

#[no_mangle]
unsafe extern "C" fn hidpp10_enable_battery_reporting(hidpp_dev: *mut hidpp_device) -> c_int {
    static int hidpp10_enable_battery_reporting(struct hidpp_device *hidpp_dev)
    {
    return hidpp10_set_register(hidpp_dev, HIDPP_REG_ENABLE_REPORTS, 0,
    HIDPP_ENABLE_BAT_REPORT, HIDPP_ENABLE_BAT_REPORT);
    }
pub const HIDPP_REG_FEATURES: c_uint = 0x01;

// On HID++ 1.0 devices, high-res scroll was called "scrolling acceleration".
#[no_mangle]
unsafe extern "C" fn hidpp10_enable_scrolling_acceleration(hidpp_dev: *mut hidpp_device) -> c_int {
...
pub const HIDPP_REG_BATTERY_STATUS: c_uint = 0x07;
#[no_mangle]
unsafe extern "C" fn hidpp10_battery_status_map_level(param: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp10_battery_status_map_status(param: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp10_query_battery_status(hidpp: *mut hidpp_device) -> c_int {
...
pub const HIDPP_REG_BATTERY_MILEAGE: c_uint = 0x0D;
#[no_mangle]
unsafe extern "C" fn hidpp10_battery_mileage_map_status(param: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp10_query_battery_mileage(hidpp: *mut hidpp_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp10_battery_event(hidpp: *mut hidpp_device, data: *mut u8, size: c_int) -> c_int {
...
pub const HIDPP_REG_PAIRING_INFORMATION: c_uint = 0xB5;
pub const HIDPP_EXTENDED_PAIRING: c_uint = 0x30;
pub const HIDPP_DEVICE_NAME: c_uint = 0x40;
...
#[no_mangle]
unsafe extern "C" fn hidpp_unifying_get_serial(hidpp: *mut hidpp_device, serial: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp_unifying_init(hidpp: *mut hidpp_device) -> c_int {
...
// 0x0000: Root
// --------------------------------------------------------------------------
pub const HIDPP_PAGE_ROOT: c_uint = 0x0000;
pub const HIDPP_PAGE_ROOT_IDX: c_uint = 0x00;
pub const CMD_ROOT_GET_FEATURE: c_uint = 0x00;
pub const CMD_ROOT_GET_PROTOCOL_VERSION: c_uint = 0x10;
...
#[no_mangle]
unsafe extern "C" fn hidpp_root_get_protocol_version(hidpp: *mut hidpp_device) -> c_int {
    static int hidpp_root_get_protocol_version(struct hidpp_device *hidpp)
    {
    let mut ping_byte: u8 = 0x5a;
...
// --------------------------------------------------------------------------
pub const HIDPP_PAGE_DEVICE_INFORMATION: c_uint = 0x0003;
pub const CMD_GET_DEVICE_INFO: c_uint = 0x00;
#[no_mangle]
unsafe extern "C" fn hidpp_get_serial(hidpp: *mut hidpp_device, serial: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp_serial_init(hidpp: *mut hidpp_device) -> c_int {
...
// --------------------------------------------------------------------------
pub const HIDPP_PAGE_GET_DEVICE_NAME_TYPE: c_uint = 0x0005;
pub const CMD_GET_DEVICE_NAME_TYPE_GET_COUNT: c_uint = 0x00;
pub const CMD_GET_DEVICE_NAME_TYPE_GET_DEVICE_NAME: c_uint = 0x10;
pub const CMD_GET_DEVICE_NAME_TYPE_GET_TYPE: c_uint = 0x20;
    ...
    int ret;
    ret = hidpp_send_fap_command_sync(hidpp, feature_index,
    CMD_GET_DEVICE_NAME_TYPE_GET_COUNT, core::ptr::null_mut(), 0, &response);
    if (ret > 0) {
    hid_err(hidpp.hid_dev, "%s: received protocol error 0x%02x\n",
    __func__, ret);
    return -EPROTO;
...
// --------------------------------------------------------------------------
pub const HIDPP_PAGE_BATTERY_LEVEL_STATUS: c_uint = 0x1000;
pub const CMD_BATTERY_LEVEL_STATUS_GET_BATTERY_LEVEL_STATUS: c_uint = 0x00;
pub const CMD_BATTERY_LEVEL_STATUS_GET_BATTERY_CAPABILITY: c_uint = 0x10;
pub const EVENT_BATTERY_LEVEL_STATUS_BROADCAST: c_uint = 0x00;

#[no_mangle]
unsafe extern "C" fn hidpp_map_battery_level(capacity: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(30: capacity <) -> else {
    else if (capacity < 30)
    return POWER_SUPPLY_CAPACITY_LEVEL_LOW;
#[no_mangle]
pub unsafe extern "C" fn if(81: capacity <) -> else {
    else if (capacity < 81)
...
#[no_mangle]
unsafe extern "C" fn hidpp20_query_battery_info_1000(hidpp: *mut hidpp_device) -> c_int {
...
// --------------------------------------------------------------------------
pub const HIDPP_PAGE_BATTERY_VOLTAGE: c_uint = 0x1001;
pub const CMD_BATTERY_VOLTAGE_GET_BATTERY_VOLTAGE: c_uint = 0x00;
pub const EVENT_BATTERY_VOLTAGE_STATUS_BROADCAST: c_uint = 0x00;
    static int hidpp20_battery_map_status_voltage(u8 data[3], int *voltage,
    int *level, int *charge_type)
    {
    int status;
    let mut flags: c_long = (long) data[2];
// level = POWER_SUPPLY_CAPACITY_LEVEL_UNKNOWN;
    if (flags & 0x80)
    switch (flags & 0x07) {
    case 0:
...
#[no_mangle]
unsafe extern "C" fn hidpp20_map_battery_capacity(hid_dev: *mut hid_device, voltage: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp20_query_battery_voltage_info(hidpp: *mut hidpp_device) -> c_int {
...
// --------------------------------------------------------------------------
pub const HIDPP_PAGE_UNIFIED_BATTERY: c_uint = 0x1004;
pub const CMD_UNIFIED_BATTERY_GET_CAPABILITIES: c_uint = 0x00;
pub const CMD_UNIFIED_BATTERY_GET_STATUS: c_uint = 0x10;
pub const EVENT_UNIFIED_BATTERY_STATUS_EVENT: c_uint = 0x00;
...
// cler unsupported level bits
    ...
    return POWER_SUPPLY_CAPACITY_LEVEL_FULL;
#[no_mangle]
pub unsafe extern "C" fn if(FLAG_UNIFIED_BATTERY_LEVEL_GOOD: battery_level &) -> else {
    else if (battery_level & FLAG_UNIFIED_BATTERY_LEVEL_GOOD)
    return POWER_SUPPLY_CAPACITY_LEVEL_NORMAL;
#[no_mangle]
pub unsafe extern "C" fn if(FLAG_UNIFIED_BATTERY_LEVEL_LOW: battery_level &) -> else {
    else if (battery_level & FLAG_UNIFIED_BATTERY_LEVEL_LOW)
    return POWER_SUPPLY_CAPACITY_LEVEL_LOW;
#[no_mangle]
pub unsafe extern "C" fn if(FLAG_UNIFIED_BATTERY_LEVEL_CRITICAL: battery_level &) -> else {
...
#[no_mangle]
unsafe extern "C" fn hidpp20_query_battery_info_1004(hidpp: *mut hidpp_device) -> c_int {
...
// --------------------------------------------------------------------------
pub const HIDPP_PAGE_WIRELESS_DEVICE_STATUS: c_uint = 0x1d4b;
#[no_mangle]
unsafe extern "C" fn hidpp_get_wireless_feature_index(hidpp: *mut hidpp_device, feature_index: *mut u8) -> c_int {
...
// --------------------------------------------------------------------------
pub const HIDPP_PAGE_ADC_MEASUREMENT: c_uint = 0x1f20;
pub const CMD_ADC_MEASUREMENT_GET_ADC_MEASUREMENT: c_uint = 0x00;
pub const EVENT_ADC_MEASUREMENT_STATUS_BROADCAST: c_uint = 0x00;
#[no_mangle]
unsafe extern "C" fn hidpp20_map_adc_measurement_1f20_capacity(hid_dev: *mut hid_device, voltage: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp20_map_adc_measurement_1f20(data[3]: u8, voltage: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp20_query_adc_measurement_info_1f20(hidpp: *mut hidpp_device) -> c_int {
...
// --------------------------------------------------------------------------
pub const HIDPP_PAGE_HI_RESOLUTION_SCROLLING: c_uint = 0x2120;
pub const CMD_HI_RESOLUTION_SCROLLING_SET_HIGHRES_SCROLLING_MODE: c_uint = 0x10;
...
// 0x2121: HiRes Wheel
// --------------------------------------------------------------------------
pub const HIDPP_PAGE_HIRES_WHEEL: c_uint = 0x2121;
pub const CMD_HIRES_WHEEL_GET_WHEEL_CAPABILITY: c_uint = 0x00;
pub const CMD_HIRES_WHEEL_SET_WHEEL_MODE: c_uint = 0x20;
...
// --------------------------------------------------------------------------
pub const HIDPP_PAGE_SOLAR_KEYBOARD: c_uint = 0x4301;
pub const CMD_SOLAR_SET_LIGHT_MEASURE: c_uint = 0x00;
pub const EVENT_SOLAR_BATTERY_BROADCAST: c_uint = 0x00;
pub const EVENT_SOLAR_BATTERY_LIGHT_MEASURE: c_uint = 0x10;
pub const EVENT_SOLAR_CHECK_LIGHT_BUTTON: c_uint = 0x20;
#[no_mangle]
unsafe extern "C" fn hidpp_solar_request_battery_event(hidpp: *mut hidpp_device) -> c_int {
...
// --------------------------------------------------------------------------
pub const HIDPP_PAGE_TOUCHPAD_FW_ITEMS: c_uint = 0x6010;
pub const CMD_TOUCHPAD_FW_ITEMS_SET: c_uint = 0x10;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidpp_touchpad_fw_items {
    pub presence: u8,
...
// --------------------------------------------------------------------------
pub const HIDPP_PAGE_TOUCHPAD_RAW_XY: c_uint = 0x6100;
pub const CMD_TOUCHPAD_GET_RAW_INFO: c_uint = 0x00;
pub const CMD_TOUCHPAD_SET_RAW_REPORT_STATE: c_uint = 0x20;
pub const EVENT_TOUCHPAD_RAW_XY: c_uint = 0x00;
pub const TOUCHPAD_RAW_XY_ORIGIN_LOWER_LEFT: c_uint = 0x01;
pub const TOUCHPAD_RAW_XY_ORIGIN_UPPER_LEFT: c_uint = 0x03;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidpp_touchpad_raw_info {
    pub x_size: u16,
    pub y_size: u16,
    pub z_range: u8,
    pub area_range: u8,
    pub timestamp_unit: u8,
    pub maxcontacts: u8,
    pub origin: u8,
    pub res: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidpp_touchpad_raw_xy_finger {
    pub contact_type: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidpp_touchpad_raw_xy {
    pub timestamp: u16,
    pub fingers: [hidpp_touchpad_raw_xy_finger; 2],
    pub spurious_flag: u8,
    pub end_of_frame: u8,
    pub finger_count: u8,
    pub button: u8,
}
    ...
    u8 *params = (u8 *)response.fap.params;
    ret = hidpp_send_fap_command_sync(hidpp, feature_index,
    CMD_TOUCHPAD_GET_RAW_INFO, core::ptr::null_mut(), 0, &response);
    if (ret > 0) {
    hid_err(hidpp.hid_dev, "%s: received protocol error 0x%02x\n",
    __func__, ret);
    return -EPROTO;
...
//
    let mut params: u8 = send_raw_reports | (sensor_enhanced_settings << 2);
    ...
    {
    let mut x_m: u8 = data[0] << 2;
    let mut y_m: u8 = data[2] << 2;
...
// --------------------------------------------------------------------------
pub const HIDPP_FF_GET_INFO: c_uint = 0x01;
pub const HIDPP_FF_RESET_ALL: c_uint = 0x11;
pub const HIDPP_FF_DOWNLOAD_EFFECT: c_uint = 0x21;
pub const HIDPP_FF_SET_EFFECT_STATE: c_uint = 0x31;
pub const HIDPP_FF_DESTROY_EFFECT: c_uint = 0x41;
pub const HIDPP_FF_GET_APERTURE: c_uint = 0x51;
pub const HIDPP_FF_SET_APERTURE: c_uint = 0x61;
pub const HIDPP_FF_GET_GLOBAL_GAINS: c_uint = 0x71;
pub const HIDPP_FF_SET_GLOBAL_GAINS: c_uint = 0x81;
pub const HIDPP_FF_EFFECT_STATE_GET: c_uint = 0x00;
pub const HIDPP_FF_EFFECT_STATE_STOP: c_uint = 0x01;
pub const HIDPP_FF_EFFECT_STATE_PLAY: c_uint = 0x02;
pub const HIDPP_FF_EFFECT_STATE_PAUSE: c_uint = 0x03;
pub const HIDPP_FF_EFFECT_CONSTANT: c_uint = 0x00;
pub const HIDPP_FF_EFFECT_PERIODIC_SINE: c_uint = 0x01;
pub const HIDPP_FF_EFFECT_PERIODIC_SQUARE: c_uint = 0x02;
pub const HIDPP_FF_EFFECT_PERIODIC_TRIANGLE: c_uint = 0x03;
pub const HIDPP_FF_EFFECT_PERIODIC_SAWTOOTHUP: c_uint = 0x04;
pub const HIDPP_FF_EFFECT_PERIODIC_SAWTOOTHDOWN: c_uint = 0x05;
pub const HIDPP_FF_EFFECT_SPRING: c_uint = 0x06;
pub const HIDPP_FF_EFFECT_DAMPER: c_uint = 0x07;
pub const HIDPP_FF_EFFECT_FRICTION: c_uint = 0x08;
pub const HIDPP_FF_EFFECT_INERTIA: c_uint = 0x09;
pub const HIDPP_FF_EFFECT_RAMP: c_uint = 0x0A;
pub const HIDPP_FF_EFFECT_AUTOSTART: c_uint = 0x80;

pub const HIDPP_AUTOCENTER_PARAMS_LENGTH: c_int = 18;
pub const HIDPP_FF_MAX_PARAMS: c_int = 20;
pub const HIDPP_FF_RESERVED_SLOTS: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidpp_ff_private_data {
    pub hidpp: *mut hidpp_device,
    pub feature_index: u8,
    pub version: u8,
    pub gain: u16,
    pub range: i16,
    pub slot_autocenter: u8,
    pub num_effects: u8,
    pub effect_ids: *mut c_int,
    pub wq: *mut workqueue_struct,
    pub workqueue_size: core::sync::atomic::AtomicI32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidpp_ff_work_data {
    pub work: work_struct,
    pub data: *mut hidpp_ff_private_data,
    pub effect_id: c_int,
    pub command: u8,
    pub params: [u8; HIDPP_FF_MAX_PARAMS],
    pub size: u8,
}
...
#[no_mangle]
unsafe extern "C" fn hidpp_ff_find_effect(data: *mut hidpp_ff_private_data, effect_id: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn hidpp_ff_work_handler(w: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(HIDPP_FF_EFFECTID_AUTOCENTER: wd->effect_id >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn hidpp_ff_queue_work(data: *mut hidpp_ff_private_data, effect_id: c_int, command: u8, params: *mut u8, size: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp_ff_upload_effect(dev: *mut input_dev, effect: *mut ff_effect, old: *mut ff_effect) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp_ff_playback(dev: *mut input_dev, effect_id: c_int, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp_ff_erase_effect(dev: *mut input_dev, effect_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp_ff_set_autocenter(dev: *mut input_dev, magnitude: u16) {
...
#[no_mangle]
unsafe extern "C" fn hidpp_ff_set_gain(dev: *mut input_dev, gain: u16) {
...
#[no_mangle]
unsafe extern "C" fn hidpp_ff_range_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn hidpp_ff_range_store(dev: *mut device, attr: *mut device_attribute, buf: *const c_char, count: usize) -> isize {
    ...
    struct hidpp_ff_private_data *data = idev.ff.private;
    u8 params[2];
    let mut range: c_int = simple_strtoul(buf, core::ptr::null_mut(), 10);
...
#[no_mangle]
unsafe extern "C" fn hidpp_ff_destroy(ff: *mut ff_device) {
...
// --------------------------------------------------------------------------
pub const WTP_MANUAL_RESOLUTION: c_int = 39;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wtp_data {
    pub y_size: u16 x_size,,
    pub finger_count: u8,
    pub mt_feature_index: u8,
    pub button_feature_index: u8,
    pub maxcontacts: u8,
    pub flip_y: bool,
...
#[no_mangle]
unsafe extern "C" fn wtp_mouse_raw_xy_event(hidpp: *mut hidpp_device, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wtp_raw_event(hdev: *mut hid_device, data: *mut u8, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wtp_get_config(hidpp: *mut hidpp_device) -> c_int {
    static int wtp_get_config(struct hidpp_device *hidpp)
    {
    struct wtp_data *wd = hidpp.private_data;
    let mut raw_info: hidpp_touchpad_raw_info = {0};
    int ret;
...
#[no_mangle]
unsafe extern "C" fn wtp_allocate(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wtp_connect(hdev: *mut hid_device) -> c_int {
...
pub const M560_MOUSE_BTN_LEFT: c_uint = 0x01;
pub const M560_MOUSE_BTN_RIGHT: c_uint = 0x02;
pub const M560_MOUSE_BTN_WHEEL_LEFT: c_uint = 0x08;
pub const M560_MOUSE_BTN_WHEEL_RIGHT: c_uint = 0x10;
pub const M560_SUB_ID: c_uint = 0x0a;
pub const M560_BUTTON_MODE_REGISTER: c_uint = 0x35;
#[no_mangle]
unsafe extern "C" fn m560_send_config_command(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m560_raw_event(hdev: *mut hid_device, data: *mut u8, size: c_int) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k400_private_data {
    pub feature_index: u8,
}

#[no_mangle]
unsafe extern "C" fn k400_disable_tap_to_click(hidpp: *mut hidpp_device) -> c_int {
    static int k400_disable_tap_to_click(struct hidpp_device *hidpp)
    {
    struct k400_private_data *k400 = hidpp.private_data;
    let mut items: hidpp_touchpad_fw_items = {};
    int ret;
...
#[no_mangle]
unsafe extern "C" fn k400_allocate(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k400_connect(hdev: *mut hid_device) -> c_int {
...
// -------------------------------------------------------------------------
pub const HIDPP_PAGE_G920_FORCE_FEEDBACK: c_uint = 0x8123;
...
// --------------------------------------------------------------------------
pub const DINOVO_MINI_PRODUCT_ID: c_uint = 0xb30c;
...
// --------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn hidpp10_wheel_connect(hidpp: *mut hidpp_device) -> c_int {
...
// --------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn hidpp10_extra_mouse_buttons_connect(hidpp: *mut hidpp_device) -> c_int {
...
// --------------------------------------------------------------------------
pub const HIDPP_PAGE_REPROG_CONTROLS_V4: c_uint = 0x1b04;
pub const HIDPP_REPROG_CONTROLS_GET_COUNT: c_uint = 0x00;
pub const HIDPP_REPROG_CONTROLS_GET_CID_INFO: c_uint = 0x10;
pub const HIDPP_REPROG_CONTROLS_SET_CONTROL_REPORTING: c_uint = 0x30;

pub const HIDPP_REPROG_CONTROLS_EVENT_DIVERTED: c_uint = 0x00;
pub const HIDPP_REPROG_CONTROL_BACK: c_uint = 0x0053;
pub const HIDPP_REPROG_CONTROL_FORWARD: c_uint = 0x0056;
pub const HIDPP_PRODUCT_SIGNATURE_M650: c_uint = 0xb02a;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidpp_reprog_control_mapping {
    pub control: u16,
    pub code: u16,
}
...
#[no_mangle]
unsafe extern "C" fn hidpp20_reprog_controls_get_count(hidpp: *mut hidpp_device) -> c_int {
    static int hidpp20_reprog_controls_get_count(struct hidpp_device *hidpp)
    {
    struct hidpp_report response;
    let mut feature_index: u8 = hidpp.reprog_controls_feature_index;
    let mut cmd: u8 = HIDPP_REPROG_CONTROLS_GET_COUNT;
    int ret;
    ret = hidpp_send_fap_command_sync(hidpp, feature_index, cmd, core::ptr::null_mut(), 0,
    &response);
    if (ret > 0)
    return -EPROTO;
    if (ret)
    ...
    struct hidpp_report response;
    let mut feature_index: u8 = hidpp.reprog_controls_feature_index;
    let mut cmd: u8 = HIDPP_REPROG_CONTROLS_GET_CID_INFO;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn hidpp20_reprog_controls_connect(hidpp: *mut hidpp_device) {
...
#[no_mangle]
unsafe extern "C" fn hidpp10_consumer_keys_connect(hidpp: *mut hidpp_device) -> c_int {
...
// --------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn hi_res_scroll_enable(hidpp: *mut hidpp_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp_initialize_hires_scroll(hidpp: *mut hidpp_device) -> c_int {
...
// We cannot detect fast scrolling support on HID++ 1.0 devices
    ...
    let mut mode: u8 = data[4];
    let mut hires: bool = (mode & 0x02) != 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(HIDPP_QUIRK_CLASS_M560: hidpp->quirks &) -> else {
    else if (hidpp.quirks & HIDPP_QUIRK_CLASS_M560)
...
#[no_mangle]
unsafe extern "C" fn hidpp_input_configured(hdev: *mut hid_device, hidinput: *mut hid_input) -> c_int {
...
//
    ...
    || value == 0 || hidpp.input == core::ptr::null_mut()
...
#[no_mangle]
unsafe extern "C" fn hidpp_initialize_battery(hidpp: *mut hidpp_device) -> c_int {
    static int hidpp_initialize_battery(struct hidpp_device *hidpp)
    {
    let mut battery_no: static atomic_t = ATOMIC_INIT(0);
    let mut cfg: power_supply_config = { .drv_data = hidpp };
...
#[no_mangle]
unsafe extern "C" fn hidpp_is_bolt_child(hdev: *mut hid_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hidpp_bolt_init(hidpp: *mut hidpp_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp_receiver_init(hidpp: *mut hidpp_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp_non_receiver_init(hidpp: *mut hidpp_device) {
...
#[no_mangle]
unsafe extern "C" fn hidpp_input_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp_input_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn hidpp_connect_event(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(HIDPP_CAPABILITY_UNIFIED_BATTERY: hidpp->capabilities &) -> else {
    else if (hidpp.capabilities & HIDPP_CAPABILITY_UNIFIED_BATTERY)
    hidpp20_query_battery_info_1004(hidpp);
#[no_mangle]
pub unsafe extern "C" fn if(HIDPP_CAPABILITY_ADC_MEASUREMENT: hidpp->capabilities &) -> else {
...
#[no_mangle]
unsafe extern "C" fn hidpp_reset_hi_res_handler(work: *mut work_struct) {
    ...
    static DEVICE_ATTR(builtin_power_supply, 0000, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn hidpp_get_report_length(hdev: *mut hid_device, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hidpp_validate_device(hdev: *mut hid_device) -> u8 {
    static u8 hidpp_validate_device(struct hid_device *hdev)
    {
    struct hidpp_device *hidpp = hid_get_drvdata(hdev);
    int id, report_length;
    let mut supported_reports: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn hidpp_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
    static int hidpp_probe(struct hid_device *hdev, const struct hid_device_id *id)
    {
    struct hidpp_device *hidpp;
    int ret;
    let mut connect_mask: c_uint = HID_CONNECT_DEFAULT;
...
#[no_mangle]
unsafe extern "C" fn hidpp_remove(hdev: *mut hid_device) {
