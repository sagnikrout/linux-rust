...
//! Source: drivers/hid/hid-creative-sb0540.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct creative_sb0540 {
    pub input_dev: *mut input_dev,
    pub hid: *mut hid_device,
    pub keymap: [c_ushort; ARRAY_SIZE(creative_sb0540_key_table)],
}

#[no_mangle]
pub unsafe extern "C" fn reverse(data: u64, bits: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn get_key(creative_sb0540: *mut creative_sb0540, keycode: u64) -> c_int {
