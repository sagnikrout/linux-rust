...
//! Source: drivers/hid/hid-lg-g15.c
#![no_std]
...
pub const LG_G15_TRANSFER_BUF_SIZE: c_int = 20;
pub const LG_G15_FEATURE_REPORT: c_uint = 0x02;
pub const LG_G510_FEATURE_M_KEYS_LEDS: c_uint = 0x04;
pub const LG_G510_FEATURE_BACKLIGHT_RGB: c_uint = 0x05;
pub const LG_G510_FEATURE_POWER_ON_RGB: c_uint = 0x06;
pub const LG_G510_INPUT_MACRO_KEYS: c_uint = 0x03;
pub const LG_G510_INPUT_KBD_BACKLIGHT: c_uint = 0x04;
pub const LG_G13_INPUT_REPORT: c_uint = 0x01;
pub const LG_G13_FEATURE_M_KEYS_LEDS: c_uint = 0x05;
pub const LG_G13_FEATURE_BACKLIGHT_RGB: c_uint = 0x07;
pub const LG_G13_BACKLIGHT_HW_ON_BIT: c_int = 23;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct g13_input_report {
    pub /: *mut *mut u8 report_id; / Report ID is always set to 1.,
    pub joy_y: u8 joy_x,,
    pub keybits: [u8; 5],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lg_g15_data {
// Must be first for proper dma alignment
    pub transfer_buf: [u8; LG_G15_TRANSFER_BUF_SIZE],
// Protects the transfer_buf and led brightness
    pub mutex: mutex,
    pub work: work_struct,
    pub input: *mut input_dev,
    pub /: *mut *mut *mut input_dev input_js; / Separate joystick device for G13.,
    pub hdev: *mut hid_device,
    pub model: enum lg_g15_model,
    pub leds: [lg_g15_led; LG_G15_LED_MAX],
    pub game_mode_enabled: bool,
    pub /: *mut *mut *mut *mut bool backlight_disabled; / true == HW backlight toggled OFF,
}
...
//
#[no_mangle]
unsafe extern "C" fn lg_g13_get_leds_state(g15: *mut lg_g15_data) -> c_int {
    static int lg_g13_get_leds_state(struct lg_g15_data *g15)
    {
    let mut tbuf: *mut u8  const = g15.transfer_buf;
    int ret, high;
// RGB backlight.
...
//
    ...
    enum led_brightness brightness)
    {
    let mut subleds: *const mc_subled  const = g15_led.mcdev.subled_info;
    let mut tbuf: *mut u8  const = g15.transfer_buf;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn lg_g13_kbd_led_set(led_cdev: *mut led_classdev, brightness: enum led_brightness) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg_g13_kbd_led_get(led_cdev: *mut led_classdev) -> enum led_brightness {
    static enum led_brightness lg_g13_kbd_led_get(struct led_classdev *led_cdev)
    {
    let mut mc: *const led_classdev_mc  const = lcdev_to_mccdev(led_cdev);
    struct lg_g15_led const *g15_led =
    container_of(mc, struct lg_g15_led, mcdev);
    return g15_led.brightness;
    }
#[no_mangle]
unsafe extern "C" fn lg_g13_mkey_led_set(led_cdev: *mut led_classdev, brightness: enum led_brightness) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg_g13_mkey_led_get(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn lg_g15_update_led_brightness(g15: *mut lg_g15_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg_g15_led_get(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn lg_g15_leds_changed_work(work: *mut work_struct) {
...
// G510 LED functions
#[no_mangle]
unsafe extern "C" fn lg_g510_get_initial_led_brightness(g15: *mut lg_g15_data, i: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg_g510_kbd_led_get(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn lg_g510_leds_sync_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn lg_g510_update_mkey_led_brightness(g15: *mut lg_g15_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg_g510_mkey_led_get(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn lg_g15_get_initial_led_brightness(g15: *mut lg_g15_data) -> c_int {
...
pub const G13_JS_KEYBITS_OFFSET: c_int = 33;
...
#[no_mangle]
unsafe extern "C" fn lg_g13_event(g15: *mut lg_g15_data, data: *const u8) -> c_int {
    static int lg_g13_event(struct lg_g15_data *g15, u8 const *data)
    {
    let mut rep: *const g13_input_report  const = (struct g13_input_report *) data;
    int i, val;
...
#[no_mangle]
unsafe extern "C" fn lg_g15_handle_lcd_menu_keys(g15: *mut lg_g15_data, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn lg_g15_event(g15: *mut lg_g15_data, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg_g15_v2_event(g15: *mut lg_g15_data, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg_g510_event(g15: *mut lg_g15_data, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg_g510_leds_event(g15: *mut lg_g15_data, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg_g15_input_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg_g15_input_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn lg_g15_setup_led_rgb(g15: *mut lg_g15_data, index: c_int) {
    static void lg_g15_setup_led_rgb(struct lg_g15_data *g15, int index)
    {
    int i;
    struct mc_subled *subled_info;
    let mut gled: *mut lg_g15_led  const = &g15.leds[index];
    if (g15.model == LG_G13) {
...
#[no_mangle]
unsafe extern "C" fn lg_g15_register_led(g15: *mut lg_g15_data, i: c_int, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lg_g15_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
    ...
    let mut gkeys_settings_output_report: u8 = 0;
    let mut gkeys_settings_feature_report: u8 = 0;
    struct hid_report_enum *rep_enum;
    let mut connect_mask: c_uint = 0;
    let mut has_ff000000: bool = false;
...
// Backlight is shared between LCD and keys.
    ...
    core::ptr::null_mut(),	/* Keep in sync with led_type enum */
...
#[no_mangle]
unsafe extern "C" fn lg_g15_remove(hdev: *mut hid_device) {
