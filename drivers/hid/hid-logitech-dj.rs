...
//! Source: drivers/hid/hid-logitech-dj.c
#![no_std]
...
pub const DJ_MAX_PAIRED_DEVICES: c_int = 7;
pub const DJ_MAX_NUMBER_NOTIFS: c_int = 8;
pub const DJ_RECEIVER_INDEX: c_int = 0;
pub const DJ_DEVICE_INDEX_MIN: c_int = 1;
pub const DJ_DEVICE_INDEX_MAX: c_int = 7;
pub const DJREPORT_SHORT_LENGTH: c_int = 15;
pub const DJREPORT_LONG_LENGTH: c_int = 32;
pub const REPORT_ID_DJ_SHORT: c_uint = 0x20;
pub const REPORT_ID_DJ_LONG: c_uint = 0x21;
...
pub const HIDPP_RECEIVER_INDEX: c_uint = 0xff;
pub const REPORT_TYPE_RFREPORT_FIRST: c_uint = 0x01;
pub const REPORT_TYPE_RFREPORT_LAST: c_uint = 0x1F;
// Command Switch to DJ mode
pub const REPORT_TYPE_CMD_SWITCH: c_uint = 0x80;
pub const CMD_SWITCH_PARAM_DEVBITFIELD: c_uint = 0x00;
pub const CMD_SWITCH_PARAM_TIMEOUT_SECONDS: c_uint = 0x01;
pub const TIMEOUT_NO_KEEPALIVE: c_uint = 0x00;
// Command to Get the list of Paired devices
pub const REPORT_TYPE_CMD_GET_PAIRED_DEVICES: c_uint = 0x81;
// Device Paired Notification
pub const REPORT_TYPE_NOTIF_DEVICE_PAIRED: c_uint = 0x41;
pub const SPFUNCTION_MORE_NOTIF_EXPECTED: c_uint = 0x01;
pub const SPFUNCTION_DEVICE_LIST_EMPTY: c_uint = 0x02;
pub const DEVICE_PAIRED_PARAM_SPFUNCTION: c_uint = 0x00;
pub const DEVICE_PAIRED_PARAM_EQUAD_ID_LSB: c_uint = 0x01;
pub const DEVICE_PAIRED_PARAM_EQUAD_ID_MSB: c_uint = 0x02;
pub const DEVICE_PAIRED_RF_REPORT_TYPE: c_uint = 0x03;
// Device Un-Paired Notification
pub const REPORT_TYPE_NOTIF_DEVICE_UNPAIRED: c_uint = 0x40;
// Connection Status Notification
pub const REPORT_TYPE_NOTIF_CONNECTION_STATUS: c_uint = 0x42;
pub const CONNECTION_STATUS_PARAM_STATUS: c_uint = 0x00;
pub const STATUS_LINKLOSS: c_uint = 0x01;
// Error Notification
pub const REPORT_TYPE_NOTIF_ERROR: c_uint = 0x7F;
pub const NOTIF_ERROR_PARAM_ETYPE: c_uint = 0x00;
pub const ETYPE_KEEPALIVE_TIMEOUT: c_uint = 0x01;
// supported DJ HID && RF report types
pub const REPORT_TYPE_KEYBOARD: c_uint = 0x01;
pub const REPORT_TYPE_MOUSE: c_uint = 0x02;
pub const REPORT_TYPE_CONSUMER_CONTROL: c_uint = 0x03;
pub const REPORT_TYPE_SYSTEM_CONTROL: c_uint = 0x04;
pub const REPORT_TYPE_MEDIA_CENTER: c_uint = 0x08;
pub const REPORT_TYPE_LEDS: c_uint = 0x0E;
// RF Report types bitfield

// Fake (bitnr > NUMBER_OF_HID_REPORTS) bit to track HID++ capability

// HID++ Device Connected Notification
pub const REPORT_TYPE_NOTIF_DEVICE_CONNECTED: c_uint = 0x41;
pub const HIDPP_PARAM_PROTO_TYPE: c_uint = 0x00;
pub const HIDPP_PARAM_DEVICE_INFO: c_uint = 0x01;
pub const HIDPP_PARAM_EQUAD_LSB: c_uint = 0x02;
pub const HIDPP_PARAM_EQUAD_MSB: c_uint = 0x03;
pub const HIDPP_PARAM_27MHZ_DEVID: c_uint = 0x03;

pub const HIDPP_DEVICE_TYPE_KEYBOARD: c_int = 1;
pub const HIDPP_DEVICE_TYPE_MOUSE: c_int = 2;
pub const HIDPP_SET_REGISTER: c_uint = 0x80;
pub const HIDPP_GET_LONG_REGISTER: c_uint = 0x83;
pub const HIDPP_REG_CONNECTION_STATE: c_uint = 0x02;
pub const HIDPP_REG_PAIRING_INFORMATION: c_uint = 0xB5;
pub const HIDPP_PAIRING_INFORMATION: c_uint = 0x20;
pub const HIDPP_FAKE_DEVICE_ARRIVAL: c_uint = 0x02;
    enum recvr_type {
    recvr_type_dj,
    recvr_type_hidpp,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dj_report {
    pub report_id: u8,
    pub device_index: u8,
    pub report_type: u8,
    pub 3]: u8 report_params[DJREPORT_SHORT_LENGTH -,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hidpp_event {
    pub report_id: u8,
    pub device_index: u8,
    pub sub_id: u8,
    pub 3U]: u8 params[HIDPP_REPORT_LONG_LENGTH -,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dj_receiver_dev {
    pub mouse: *mut hid_device,
    pub keyboard: *mut hid_device,
    pub hidpp: *mut hid_device,
    struct dj_device *paired_dj_devices[DJ_MAX_PAIRED_DEVICES +
    pub list: list_head,
    pub kref: kref,
    pub work: work_struct,
    pub notif_fifo: kfifo,
    pub /: *mut *mut unsigned long last_query; / in jiffies,
    pub ready: bool,
    pub dj_mode: bool,
    pub type: enum recvr_type,
    pub unnumbered_application: c_uint,
    pub lock: spinlock_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dj_device {
    pub hdev: *mut hid_device,
    pub dj_receiver_dev: *mut dj_receiver_dev,
    pub reports_supported: u64,
    pub device_index: u8,
}

pub const WORKITEM_TYPE_EMPTY: c_int = 0;
pub const WORKITEM_TYPE_PAIRED: c_int = 1;
pub const WORKITEM_TYPE_UNPAIRED: c_int = 2;
pub const WORKITEM_TYPE_UNKNOWN: c_int = 255;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dj_workitem {
    pub /: *mut *mut *mut u8 type; / WORKITEM_TYPE_,
    pub device_index: u8,
    pub device_type: u8,
    pub quad_id_msb: u8,
    pub quad_id_lsb: u8,
...
pub const MAX_REPORT_SIZE: c_int = 8;
...
//
pub const NUMBER_OF_HID_REPORTS: c_int = 32;
...
pub const LOGITECH_DJ_INTERFACE_NUMBER: c_uint = 0x02;
...
#[no_mangle]
unsafe extern "C" fn recvr_type_is_bluetooth(type: enum recvr_type) -> bool {
    static bool recvr_type_is_bluetooth(enum recvr_type type)
    {
    let mut type: return = = recvr_type_bluetooth || type == recvr_type_dinovo;
    }
//
...
#[no_mangle]
unsafe extern "C" fn dj_release_receiver_dev(kref: *mut kref) {
...
// Called in delayed work context
    ...
    djrcv_dev.paired_dj_devices[workitem.device_index] = core::ptr::null_mut();
    spin_unlock_irqrestore(&djrcv_dev.lock, flags);
    if (dj_dev != core::ptr::null_mut()) {
    hid_destroy_device(dj_dev.hdev);
    kfree(dj_dev);
    } else {
    hid_err(djrcv_dev.hidpp, "%s: can't destroy a core::ptr::null_mut() device\n",
    __func__);
    }
    }
...
// Called in delayed work context
    ...
    struct dj_device *dj_dev;
    let mut device_index: u8 = workitem.device_index;
    unsigned long flags;
...
// The device is already known. No need to reallocate it.
    ...
    hid_add_device_fail:
    spin_lock_irqsave(&djrcv_dev.lock, flags);
    djrcv_dev.paired_dj_devices[device_index] = core::ptr::null_mut();
    spin_unlock_irqrestore(&djrcv_dev.lock, flags);
    kfree(dj_dev);
...
#[no_mangle]
unsafe extern "C" fn delayedwork_callback(work: *mut work_struct) {
    static void delayedwork_callback(struct work_struct *work)
    {
    struct dj_receiver_dev *djrcv_dev =
...
//
#[no_mangle]
unsafe extern "C" fn logi_dj_recv_queue_unknown_work(djrcv_dev: *mut dj_receiver_dev) {
    static void logi_dj_recv_queue_unknown_work(struct dj_receiver_dev *djrcv_dev)
    {
    let mut workitem: dj_workitem = { .type = WORKITEM_TYPE_UNKNOWN };
...
#[no_mangle]
unsafe extern "C" fn logi_dj_recv_query_hidpp_devices(djrcv_dev: *mut dj_receiver_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn logi_dj_recv_query_paired_devices(djrcv_dev: *mut dj_receiver_dev) -> c_int {
    static int logi_dj_recv_query_paired_devices(struct dj_receiver_dev *djrcv_dev)
    {
    struct dj_report *dj_report;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn logi_dj_ll_open(hid: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn logi_dj_ll_close(hid: *mut hid_device) {
...
// the device_index
    ...
    let mut led_report_id: c_uchar = 0;
    if (!djrcv_dev.keyboard) {
...
#[no_mangle]
unsafe extern "C" fn rdcat(rdesc: *mut c_char, rsize: *mut c_uint, data: *const c_char, size: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn logi_dj_ll_parse(hid: *mut hid_device) -> c_int {
    static int logi_dj_ll_parse(struct hid_device *hid)
    {
    struct dj_device *djdev = hid.driver_data;
    let mut rsize: c_uint = 0;
    char *rdesc;
    int retval;
    dbg_hid("%s\n", __func__);
...
#[no_mangle]
pub unsafe extern "C" fn if(recvr_type_gaming_hidpp_ls_1_3: djdev->dj_receiver_dev->type ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(recvr_type_27mhz: djdev->dj_receiver_dev->type ==) -> else {
    else if (djdev.dj_receiver_dev.type == recvr_type_27mhz)
    rdcat(rdesc, &rsize, mse_27mhz_descriptor,
    sizeof(mse_27mhz_descriptor));
#[no_mangle]
pub unsafe extern "C" fn if(_arg: recvr_type_is_bluetooth(djdev->dj_receiver_dev->type)) -> else {
...
#[no_mangle]
unsafe extern "C" fn logi_dj_ll_start(hid: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn logi_dj_ll_stop(hid: *mut hid_device) {
    static void logi_dj_ll_stop(struct hid_device *hid)
    {
    dbg_hid("%s\n", __func__);
    }
#[no_mangle]
unsafe extern "C" fn logi_dj_ll_may_wakeup(hid: *mut hid_device) -> bool {
...
// pairing notifications are handled above the switch
    ...
    struct dj_device *dj_dev;
    unsigned long flags;
    let mut device_index: u8 = hidpp_report.device_index;
...
// Prepend report id
    ...
    let mut no_dj_interfaces: c_uint = 0;
    let mut has_hidpp: bool = false;
    unsigned long flags;
    int retval;
//
...
#[no_mangle]
unsafe extern "C" fn logi_dj_reset_resume(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn logi_dj_remove(hdev: *mut hid_device) {
...
//
    ...
    spin_lock_irqsave(&djrcv_dev.lock, flags);
    dj_dev = djrcv_dev.paired_dj_devices[i];
    djrcv_dev.paired_dj_devices[i] = core::ptr::null_mut();
    spin_unlock_irqrestore(&djrcv_dev.lock, flags);
    if (dj_dev != core::ptr::null_mut()) {
    hid_destroy_device(dj_dev.hdev);
    kfree(dj_dev);
