...
//! Source: drivers/hid/i2c-hid/i2c-hid-acpi-prp0001.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_acpi_prp0001_power_up(ops: *mut i2chid_ops) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_acpi_prp0001_probe(client: *mut i2c_client) -> c_int {
