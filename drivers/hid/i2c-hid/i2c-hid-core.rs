...
//! Source: drivers/hid/i2c-hid/i2c-hid-core.c
#![no_std]
...
// Command opcodes
pub const I2C_HID_OPCODE_RESET: c_uint = 0x01;
pub const I2C_HID_OPCODE_GET_REPORT: c_uint = 0x02;
pub const I2C_HID_OPCODE_SET_REPORT: c_uint = 0x03;
pub const I2C_HID_OPCODE_GET_IDLE: c_uint = 0x04;
pub const I2C_HID_OPCODE_SET_IDLE: c_uint = 0x05;
pub const I2C_HID_OPCODE_GET_PROTOCOL: c_uint = 0x06;
pub const I2C_HID_OPCODE_SET_PROTOCOL: c_uint = 0x07;
pub const I2C_HID_OPCODE_SET_POWER: c_uint = 0x08;
// flags
pub const I2C_HID_STARTED: c_int = 0;
pub const I2C_HID_RESET_PENDING: c_int = 1;
pub const I2C_HID_PWR_ON: c_uint = 0x00;
pub const I2C_HID_PWR_SLEEP: c_uint = 0x01;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_hid_desc {
    pub wHIDDescLength: __le16,
    pub bcdVersion: __le16,
    pub wReportDescLength: __le16,
    pub wReportDescRegister: __le16,
    pub wInputRegister: __le16,
    pub wMaxInputLength: __le16,
    pub wOutputRegister: __le16,
    pub wMaxOutputLength: __le16,
    pub wCommandRegister: __le16,
    pub wDataRegister: __le16,
    pub wVendorID: __le16,
    pub wProductID: __le16,
    pub wVersionID: __le16,
    pub reserved: __le32,
    pub __packed: },
...
#[derive(Copy, Clone)]
pub struct i2c_hid {
    pub /: *mut *mut *mut i2c_client client; / i2c client,
    pub /: *mut *mut *mut hid_device hid; / pointer to corresponding HID dev,
    pub /: *mut *mut i2c_hid_desc hdesc; / the HID Descriptor,
    pub i2c: *mut *mut __le16 wHIDDescRegister; / location of the,
// register of the HID
// descriptor.
    pub /: *mut *mut unsigned int bufsize; / i2c buffer size,
    pub /: *mut *mut *mut u8 inbuf; / Input buffer,
    pub /: *mut *mut *mut u8 rawbuf; / Raw Input buffer,
    pub /: *mut *mut *mut u8 cmdbuf; / Command buffer,
    pub /: *mut *mut unsigned long flags; / device flags,
    pub /: *mut *mut unsigned long quirks; / Various quirks,
    pub /: *mut *mut wait_queue_head_t wait; / For waiting the interrupt,
    pub /: *mut *mut mutex cmd_lock; / protects cmdbuf and rawbuf,
    pub reset_lock: mutex,
    pub ops: *mut i2chid_ops,
    pub panel_follower: drm_panel_follower,
    pub panel_follower_work: work_struct,
    pub is_panel_follower: bool,
    pub panel_follower_work_finished: bool,
}
...
//
#[no_mangle]
unsafe extern "C" fn i2c_hid_lookup_quirk(idVendor: u16, idProduct: u16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_probe_address(ihid: *mut i2c_hid) -> c_int {
...
// (__le16 *)ihid->cmdbuf = ihid->hdesc.wOutputRegister;
    ...
    error = i2c_hid_xfer(ihid, ihid.cmdbuf, length, core::ptr::null_mut(), 0);
    if (error) {
    dev_err(&ihid.client.dev,
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_set_power_command(ihid: *mut i2c_hid, power_state: c_int) -> c_int {
...
// Now the command itself
    ...
    0, power_state);
    return i2c_hid_xfer(ihid, ihid.cmdbuf, length, core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn i2c_hid_set_power(ihid: *mut i2c_hid, power_state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_start_hwreset(ihid: *mut i2c_hid) -> c_int {
...
// Next is RESET command itself
    ...
    ret = i2c_hid_xfer(ihid, ihid.cmdbuf, length, core::ptr::null_mut(), 0);
    if (ret) {
    dev_err(&ihid.client.dev,
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_finish_hwreset(ihid: *mut i2c_hid) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_get_input(ihid: *mut i2c_hid) {
    static void i2c_hid_get_input(struct i2c_hid *ihid)
    {
    let mut size: u16 = le16_to_cpu(ihid.hdesc.wMaxInputLength);
    u16 ret_size;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_get_report_length(report: *mut hid_report) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_free_buffers(ihid: *mut i2c_hid) {
    static void i2c_hid_free_buffers(struct i2c_hid *ihid)
    {
    kfree(ihid.inbuf);
    kfree(ihid.rawbuf);
    kfree(ihid.cmdbuf);
    ihid.inbuf = core::ptr::null_mut();
    ihid.rawbuf = core::ptr::null_mut();
    ihid.cmdbuf = core::ptr::null_mut();
    ihid.bufsize = 0;
    }
#[no_mangle]
unsafe extern "C" fn i2c_hid_alloc_buffers(ihid: *mut i2c_hid, report_size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_output_report(hid: *mut hid_device, buf: *mut u8, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_parse(hid: *mut hid_device) -> c_int {
    static int i2c_hid_parse(struct hid_device *hid)
    {
    struct i2c_client *client = hid.driver_data;
    struct i2c_hid *ihid = i2c_get_clientdata(client);
    struct i2c_hid_desc *hdesc = &ihid.hdesc;
    char *rdesc = core::ptr::null_mut(), *use_override = core::ptr::null_mut();
    unsigned int rsize;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_start(hid: *mut hid_device) -> c_int {
    static int i2c_hid_start(struct hid_device *hid)
    {
    struct i2c_client *client = hid.driver_data;
    struct i2c_hid *ihid = i2c_get_clientdata(client);
    int ret;
    let mut bufsize: c_uint = HID_MIN_BUFFER_SIZE;
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_stop(hid: *mut hid_device) {
    static void i2c_hid_stop(struct hid_device *hid)
    {
    hid.claimed = 0;
    }
#[no_mangle]
unsafe extern "C" fn i2c_hid_open(hid: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_close(hid: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_init_irq(client: *mut i2c_client) -> c_int {
    ...
    ret = request_threaded_irq(client.irq, core::ptr::null_mut(), i2c_hid_irq,
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_fetch_hid_descriptor(ihid: *mut i2c_hid) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_core_power_up(ihid: *mut i2c_hid) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_core_power_down(ihid: *mut i2c_hid) {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_core_shutdown_tail(ihid: *mut i2c_hid) {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_core_restore_sequence(ihid: *mut i2c_hid) {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_core_suspend(ihid: *mut i2c_hid, force_poweroff: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_core_resume(ihid: *mut i2c_hid) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __i2c_hid_core_probe(ihid: *mut i2c_hid) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_core_register_hid(ihid: *mut i2c_hid) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_core_probe_panel_follower(ihid: *mut i2c_hid) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ihid_core_panel_follower_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_core_panel_follower_resume(follower: *mut drm_panel_follower) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_core_panel_follower_suspend(follower: *mut drm_panel_follower) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_core_register_panel_follower(ihid: *mut i2c_hid) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_hid_core_remove(client: *mut i2c_client) {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_hid_core_shutdown(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_core_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_core_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_hid_core_pm_restore(dev: *mut device) -> c_int {
