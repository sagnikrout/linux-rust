...
pub const THRUSTMASTER_DEVICE_ID_2_IN_1_DT: c_uint = 0xb320;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tmff_device {
    pub report: *mut hid_report,
    pub ff_field: *mut hid_field,
}

// Changes values from 0 to 0xffff into values from minimum to maximum
#[no_mangle]
pub unsafe extern "C" fn tmff_scale_u16(in: c_uint, minimum: c_int, maximum: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tmff_scale_s8(in: c_int, minimum: c_int, maximum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tm_input_configured(hid: *mut hid_device, hidinput: *mut hid_input) -> c_int {
