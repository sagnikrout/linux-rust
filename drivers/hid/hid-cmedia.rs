...
//! Source: drivers/hid/hid-cmedia.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
pub const CM6533_JD_TYPE_COUNT: c_int = 1;
pub const CM6533_JD_RAWEV_LEN: c_int = 16;
pub const CM6533_JD_SFX_OFFSET: c_int = 8;
pub const HS100B_RDESC_ORIG_SIZE: c_int = 60;
...
pub struct cmhid {
    ...
    pub switch_map: [c_ushort; CM6533_JD_TYPE_COUNT],
}

#[no_mangle]
unsafe extern "C" fn hp_ev(hid: *mut hid_device, cm: *mut cmhid, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cmhid_probe(hid: *mut hid_device, id: *const hid_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmhid_remove(hid: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn cmedia_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmedia_exit() {
