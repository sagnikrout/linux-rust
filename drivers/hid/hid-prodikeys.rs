...
//! Source: drivers/hid/hid-prodikeys.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcmidi_sustain {
    pub in_use: c_ulong,
    pub pm: *mut pcmidi_snd,
...
pub const PCMIDI_SUSTAINED_MAX: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcmidi_snd {
    pub hdev: *mut hid_device,
    pub ifnum: c_ushort,
    pub pcmidi_report6: *mut hid_report,
    pub input_ep82: *mut input_dev,
    pub midi_mode: c_ushort,
    pub midi_sustain_mode: c_ushort,
    pub midi_sustain: c_ushort,
    pub midi_channel: c_ushort,
    pub midi_octave: c_short,
    pub sustained_notes: [pcmidi_sustain; PCMIDI_SUSTAINED_MAX],
    pub fn_state: c_ushort,
    pub last_key: [c_ushort; 24],
    pub rawmidi_in_lock: spinlock_t,
    pub card: *mut snd_card,
    pub rwmidi: *mut snd_rawmidi,
    pub in_substream: *mut snd_rawmidi_substream,
    pub in_triggered: c_ulong,
}

pub const PK_QUIRK_NOGET: c_uint = 0x00010000;
pub const PCMIDI_MIDDLE_C: c_int = 60;
pub const PCMIDI_CHANNEL_MIN: c_int = 0;
pub const PCMIDI_CHANNEL_MAX: c_int = 15;

pub const PCMIDI_OCTAVE_MAX: c_int = 2;
pub const PCMIDI_SUSTAIN_MIN: c_int = 0;
pub const PCMIDI_SUSTAIN_MAX: c_int = 5000;
...
#[no_mangle]
unsafe extern "C" fn pcmidi_sustained_note_release(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn init_sustain_timers(pm: *mut pcmidi_snd) {
...
#[no_mangle]
unsafe extern "C" fn stop_sustain_timers(pm: *mut pcmidi_snd) {
...
#[no_mangle]
unsafe extern "C" fn pcmidi_get_output_report(pm: *mut pcmidi_snd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcmidi_submit_output_report(pm: *mut pcmidi_snd, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pcmidi_handle_report1(pm: *mut pcmidi_snd, data: *mut u8) -> c_int {
...
// KEY_WWW or sustain
#[no_mangle]
pub unsafe extern "C" fn if(0x000004: pm->midi_mode && bit_mask ==) -> else {
// sustain on/off
...
#[no_mangle]
unsafe extern "C" fn pcmidi_handle_report3(pm: *mut pcmidi_snd, data: *mut u8, size: c_int) -> c_int {
    static int pcmidi_handle_report3(struct pcmidi_snd *pm, u8 *data, int size)
    {
    struct pcmidi_sustain *pms;
    unsigned i, j;
    unsigned char status, note, velocity;
    let mut num_notes: unsigned = (size-1)/2;
...
#[no_mangle]
unsafe extern "C" fn pcmidi_handle_report4(pm: *mut pcmidi_snd, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcmidi_set_operational(pm: *mut pcmidi_snd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcmidi_snd_free(dev: *mut snd_device) -> c_int {
    static int pcmidi_snd_free(struct snd_device *dev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn pcmidi_in_open(substream: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcmidi_in_close(substream: *mut snd_rawmidi_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcmidi_in_trigger(substream: *mut snd_rawmidi_substream, up: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pcmidi_snd_initialise(pm: *mut pcmidi_snd) -> c_int {
...
// register it
    ...
    pm.card = core::ptr::null_mut();
    }
    return err;
    }
#[no_mangle]
unsafe extern "C" fn pcmidi_snd_terminate(pm: *mut pcmidi_snd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pk_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pk_remove(hdev: *mut hid_device) {
