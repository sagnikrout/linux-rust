...
//! Source: drivers/hid/hid-cougar.c
#![no_std]
...
//
    ...
    let mut g6_is_space: static bool = true;
    MODULE_PARM_DESC(g6_is_space,
    "If true, G6 programmable key sends SPACE instead of F18 (default=true)");
pub const COUGAR_VENDOR_USAGE: c_uint = 0xff00ff00;
pub const COUGAR_FIELD_CODE: c_int = 1;
pub const COUGAR_FIELD_ACTION: c_int = 2;
pub const COUGAR_KEY_G1: c_uint = 0x83;
pub const COUGAR_KEY_G2: c_uint = 0x84;
pub const COUGAR_KEY_G3: c_uint = 0x85;
pub const COUGAR_KEY_G4: c_uint = 0x86;
pub const COUGAR_KEY_G5: c_uint = 0x87;
pub const COUGAR_KEY_G6: c_uint = 0x78;
pub const COUGAR_KEY_FN: c_uint = 0x0d;
pub const COUGAR_KEY_MR: c_uint = 0x6f;
pub const COUGAR_KEY_M1: c_uint = 0x80;
pub const COUGAR_KEY_M2: c_uint = 0x81;
pub const COUGAR_KEY_M3: c_uint = 0x82;
pub const COUGAR_KEY_LEDS: c_uint = 0x67;
pub const COUGAR_KEY_LOCK: c_uint = 0x6e;
...
#[derive(Copy, Clone)]
pub struct cougar {
    pub special_intf: bool,
    pub shared: *mut cougar_shared,
}
...
//
#[no_mangle]
unsafe extern "C" fn cougar_fix_g6_mapping() {
...
#[no_mangle]
unsafe extern "C" fn cougar_release_shared_data(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn cougar_remove_shared_data(resource: *mut c_void) {
    ...
    cougar.shared = core::ptr::null_mut();
    }
    }
//
...
//
    ...
    if (hidinput.registered && hidinput.input != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn cougar_remove(hdev: *mut hid_device) {
