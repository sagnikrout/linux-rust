...
//! Source: drivers/hid/hid-udraw-ps3.c
#![no_std]
...
pub const RES_X: c_int = 1920;
pub const RES_Y: c_int = 1080;
// size in mm
pub const WIDTH: c_int = 160;
pub const HEIGHT: c_int = 90;
pub const PRESSURE_OFFSET: c_int = 113;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct udraw {
    pub joy_input_dev: *mut input_dev,
    pub touch_input_dev: *mut input_dev,
    pub pen_input_dev: *mut input_dev,
    pub accel_input_dev: *mut input_dev,
...
//
    pub last_one_finger_x: c_int,
    pub last_one_finger_y: c_int,
    pub last_two_finger_x: c_int,
    pub last_two_finger_y: c_int,
}

#[no_mangle]
unsafe extern "C" fn clamp_accel(axis: c_int, offset: c_int) -> c_int {
    ...
    touch = TOUCH_NONE;
#[no_mangle]
pub unsafe extern "C" fn if(0x40: data[11] ==) -> else {
    else if (data[11] == 0x40)
    touch = TOUCH_PEN;
#[no_mangle]
pub unsafe extern "C" fn if(0x80: data[11] ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn udraw_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udraw_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn udraw_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
