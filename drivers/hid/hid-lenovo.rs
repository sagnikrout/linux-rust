...
//! Source: drivers/hid/hid-lenovo.c
#![no_std]
...
pub const TP_X12_RAW_HOTKEY_FN_F4: c_uint = 0x00020003;
pub const TP_X12_RAW_HOTKEY_FN_F8: c_uint = 0x38001003;
pub const TP_X12_RAW_HOTKEY_FN_F10: c_uint = 0x00000803;
pub const TP_X12_RAW_HOTKEY_FN_F12: c_uint = 0x00000403;
pub const TP_X12_RAW_HOTKEY_FN_SPACE: c_uint = 0x18001003;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lenovo_drvdata {
    pub /: *mut *mut u8 led_report[3]; / Must be first for proper alignment,
    pub led_state: c_int,
    pub led_report_mutex: mutex,
    pub led_mute: led_classdev,
    pub led_micmute: led_classdev,
    pub fn_lock_sync_work: work_struct,
    pub hdev: *mut hid_device,
    pub press_to_select: c_int,
    pub dragging: c_int,
    pub release_to_select: c_int,
    pub select_right: c_int,
    pub sensitivity: c_int,
    pub press_speed: c_int,
// 0: Up
// 1: Down (undecided)
// 2: Scrolling
//
    pub middlebutton_state: u8,
    pub fn_lock: bool,
    pub middleclick_workaround_cptkbd: bool,
}

pub const TP10UBKBD_LED_OUTPUT_REPORT: c_int = 9;
pub const TP10UBKBD_FN_LOCK_LED: c_uint = 0x54;
pub const TP10UBKBD_MUTE_LED: c_uint = 0x64;
pub const TP10UBKBD_MICMUTE_LED: c_uint = 0x74;
pub const TP10UBKBD_LED_OFF: c_int = 1;
pub const TP10UBKBD_LED_ON: c_int = 2;
// Function to report raw_events as key events
#[no_mangle]
pub unsafe extern "C" fn report_key_event(input: *mut input_dev, keycode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lenovo_tp10ubkbd_sync_fn_lock(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn lenovo_features_set_cptkbd(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn lenovo_raw_event_TP_X12_tab(hdev: *mut hid_device, raw_data: u32) -> c_int {
    static int lenovo_raw_event_TP_X12_tab(struct hid_device *hdev, u32 raw_data)
    {
    struct hid_input *hidinput;
    struct input_dev *input = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn lenovo_features_set_tpkbd(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lenovo_led_set_tpkbd(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn lenovo_register_leds(hdev: *mut hid_device) -> c_int {
    static int lenovo_register_leds(struct hid_device *hdev)
    {
    struct lenovo_drvdata *data = hid_get_drvdata(hdev);
    let mut name_sz: usize = strlen(dev_name(&hdev.dev)) + 16;
    char *name_mute, *name_micm;
    int ret;
    name_mute = devm_kzalloc(&hdev.dev, name_sz, GFP_KERNEL);
    name_micm = devm_kzalloc(&hdev.dev, name_sz, GFP_KERNEL);
    if (name_mute == core::ptr::null_mut() || name_micm == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn lenovo_probe_tpkbd(hdev: *mut hid_device) -> c_int {
...
// Validate required reports.
    ...
    GFP_KERNEL);
    if (data_pointer == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn lenovo_probe_cptkbd(hdev: *mut hid_device) -> c_int {
...
// All the custom action happens on the USBMOUSE device for USB
    ...
    sizeof(*cptkbd_data),
    GFP_KERNEL);
    if (cptkbd_data == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn lenovo_probe_tp10ubkbd(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lenovo_reset_resume(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lenovo_remove_tpkbd(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn lenovo_remove_cptkbd(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn lenovo_remove_tp10ubkbd(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn lenovo_remove(hdev: *mut hid_device) {
