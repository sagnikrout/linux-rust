...
//! Source: drivers/hid/hid-bigbenff.c
#![no_std]
...
// 0xC0,              // End Collection
//
pub const PID0902_RDESC_ORIG_SIZE: c_int = 137;
//
...
pub const NUM_LEDS: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bigben_device {
    pub hid: *mut hid_device,
    pub report: *mut hid_report,
    pub lock: spinlock_t,
    pub removed: bool,
    pub /: *mut *mut u8 led_state; / LED1 = 1 .. LED4 = 8,
    pub /: *mut *mut u8 right_motor_on; / right motor off/on 0/1,
    pub /: *mut *mut u8 left_motor_force; / left motor force 0-255,
    pub leds: [*mut led_classdev; NUM_LEDS],
    pub work_led: bool,
    pub work_ff: bool,
...
#[no_mangle]
pub unsafe extern "C" fn bigben_schedule_work(bigben: *mut bigben_device) {
...
#[no_mangle]
unsafe extern "C" fn bigben_worker(work: *mut work_struct) {
    static void bigben_worker(struct work_struct *work)
    {
    struct bigben_device *bigben = container_of(work,
    struct bigben_device, worker);
    struct hid_field *report_field = bigben.report.field[0];
    let mut do_work_led: bool = false;
    let mut do_work_ff: bool = false;
    u8 *buf;
    u32 len;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn bigben_get_led(led: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn bigben_remove(hid: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn bigben_input_configured(hid: *mut hid_device, hidinput: *mut hid_input) -> c_int {
    ...
    error = input_ff_create_memless(input_dev, core::ptr::null_mut(), hid_bigben_play_effect);
    if (error)
    return error;
...
#[no_mangle]
unsafe extern "C" fn bigben_probe(hid: *mut hid_device, id: *const hid_device_id) -> c_int {
