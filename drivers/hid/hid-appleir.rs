...
//! Source: drivers/hid/hid-appleir.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
pub const KEY_MASK: c_uint = 0x0F;
pub const TWO_PACKETS_MASK: c_uint = 0x40;
//
...
pub struct appleir {
    ...
    pub keymap: [c_ushort; ARRAY_SIZE(appleir_key_table)],
    pub /: *mut *mut timer_list key_up_timer; / timer for key up,
    pub /: *mut *mut spinlock_t lock; / protects .current_key, .removing,
    pub /: *mut *mut int current_key; / the currently pressed key,
    pub /: *mut *mut int prev_key_idx; / key index in a 2 packets message,
    pub /: *mut *mut bool removing; / set during teardown; gates input_dev access,
}

#[no_mangle]
unsafe extern "C" fn get_key(data: c_int) -> c_int {
...
//
    let mut key: c_int = (data >> 1) & KEY_MASK;
...
#[no_mangle]
unsafe extern "C" fn key_up(hid: *mut hid_device, appleir: *mut appleir, key: c_int) {
...
#[no_mangle]
unsafe extern "C" fn key_down(hid: *mut hid_device, appleir: *mut appleir, key: c_int) {
...
#[no_mangle]
unsafe extern "C" fn battery_flat(appleir: *mut appleir) {
    static void battery_flat(struct appleir *appleir)
    {
    dev_err(&appleir.input_dev.dev, "possible flat battery?\n");
    }
#[no_mangle]
unsafe extern "C" fn key_up_tick(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn appleir_probe(hid: *mut hid_device, id: *const hid_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn appleir_remove(hid: *mut hid_device) {
