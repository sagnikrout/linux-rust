...
//! Source: drivers/hid/hid-cypress.c
#![no_std]
...
pub const CP_RDESC_SWAPPED_MIN_MAX: c_uint = 0x01;
pub const CP_2WHEEL_MOUSE_HACK: c_uint = 0x02;
pub const CP_2WHEEL_MOUSE_HACK_ON: c_uint = 0x04;
pub const VA_INVAL_LOGICAL_BOUNDARY: c_uint = 0x08;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp_device {
    pub quirks: c_ulong,
}
...
//
    ...
    let mut quirks: c_ulong = cp_device.quirks;
...
#[no_mangle]
unsafe extern "C" fn cp_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
