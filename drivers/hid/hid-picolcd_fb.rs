...
//! Source: drivers/hid/hid-picolcd_fb.c
#![no_std]
...
pub const PICOLCDFB_UPDATE_RATE_LIMIT: c_int = 10;
pub const PICOLCDFB_UPDATE_RATE_DEFAULT: c_int = 2;
...
#[no_mangle]
pub unsafe extern "C" fn picolcd_fb_refresh(data: *mut picolcd_data) {
...
#[no_mangle]
pub unsafe extern "C" fn picolcd_fb_reset(data: *mut picolcd_data, clear: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(sizeof(mapcmd): j <) -> else {
...
#[no_mangle]
unsafe extern "C" fn picolcd_fb_update(info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn picolcd_fb_blank(blank: c_int, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn picolcd_fb_destroy(info: *mut fb_info) {
...
// No thirdparty should ever unregister our framebuffer!
    WARN_ON(fbdata.picolcd != core::ptr::null_mut());
    vfree((u8 *)info.fix.smem_start);
    framebuffer_release(info);
    }
#[no_mangle]
unsafe extern "C" fn picolcd_fb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
    static int picolcd_fb_check_var(struct fb_var_screeninfo *var, struct fb_info *info)
    {
    let mut bpp: __u32 = var.bits_per_pixel;
    let mut activate: __u32 = var.activate;
...
#[no_mangle]
unsafe extern "C" fn picolcd_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn picolcdfb_ops_damage_range(info: *mut fb_info, off: off_t, len: usize) {
...
#[no_mangle]
unsafe extern "C" fn picolcdfb_ops_damage_area(info: *mut fb_info, x: u32, y: u32, width: u32, height: u32) {
...
#[no_mangle]
unsafe extern "C" fn picolcd_fb_deferred_io(info: *mut fb_info, pagereflist: *mut list_head) {
...
//
    ...
    return -ERANGE;
#[no_mangle]
pub unsafe extern "C" fn if(0: u ==) -> else {
    else if (u == 0)
...
#[no_mangle]
pub unsafe extern "C" fn picolcd_init_framebuffer(data: *mut picolcd_data) -> c_int {
    int picolcd_init_framebuffer(struct picolcd_data *data)
    {
    struct device *dev = &data.hdev.dev;
    struct fb_info *info = core::ptr::null_mut();
    struct picolcd_fb_data *fbdata = core::ptr::null_mut();
    int i, error = -ENOMEM;
    u32 *palette;
// The extra memory is:
...
// info->fbdefio = picolcd_fb_defio;
    ...
    if (fbdata.bitmap == core::ptr::null_mut()) {
    ...
    fb_deferred_io_cleanup(info);
    err_cleanup:
    data.fb_info    = core::ptr::null_mut();
    err_nomem:
    if (fbdata)
    vfree(fbdata.bitmap);
    framebuffer_release(info);
...
#[no_mangle]
pub unsafe extern "C" fn picolcd_exit_framebuffer(data: *mut picolcd_data) {
...
// disconnect framebuffer from HID dev
    spin_lock_irqsave(&fbdata.lock, flags);
    fbdata.picolcd = core::ptr::null_mut();
    spin_unlock_irqrestore(&fbdata.lock, flags);
