...
//! Source: drivers/firewire/node-tree-test.c
#![no_std]
...
pub struct private_data {
    ...
    pub release_count: c_uint,
}

#[no_mangle]
unsafe extern "C" fn node_tree_test_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn node_tree_test_exit(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn release_fw_node(card: *mut fw_card, node: *mut fw_node, parent: *mut fw_node) {
...
#[no_mangle]
unsafe extern "C" fn node_tree_test_two_nodes(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn node_tree_test_two_nodes_1394a(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn node_tree_test_three_nodes_case0(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn node_tree_test_three_nodes_case1(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn node_tree_test_four_nodes_case0(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn node_tree_test_four_nodes_case1(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn node_tree_test_four_nodes_case2(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn node_tree_test_four_nodes_case3(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn node_tree_test_invalid_extended_self_id_sequence(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn node_tree_test_invalid_phy_id(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn node_tree_test_invalid_child_port_count(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn node_tree_test_invalid_parent_port_count(test: *mut kunit) {
