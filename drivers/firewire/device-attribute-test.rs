...
//! Source: drivers/firewire/device-attribute-test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn device_attr_simple_avc(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn device_attr_legacy_avc(test: *mut kunit) {
