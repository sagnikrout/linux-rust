...
//! Source: drivers/firewire/core-iso.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn fw_iso_buffer_alloc(buffer: *mut fw_iso_buffer, page_count: c_int) -> c_int {
...
// The dma_map_phys() with a physical address per page is available here, instead.
    ...
    let mut dma_addr: dma_addr_t = buffer.dma_addrs[i];
...
#[no_mangle]
pub unsafe extern "C" fn fw_iso_buffer_lookup(buffer: *mut fw_iso_buffer, completed: dma_addr_t) -> usize {
    size_t fw_iso_buffer_lookup(struct fw_iso_buffer *buffer, dma_addr_t completed)
    {
    for (int i = 0; i < buffer.page_count; i++) {
    let mut dma_addr: dma_addr_t = buffer.dma_addrs[i];
    let mut offset: isize = (ssize_t)completed - (ssize_t)dma_addr;
...
#[no_mangle]
pub unsafe extern "C" fn fw_iso_context_destroy(ctx: *mut fw_iso_context) {
...
#[no_mangle]
pub unsafe extern "C" fn fw_iso_context_set_channels(ctx: *mut fw_iso_context, channels: *mut u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fw_iso_context_queue_flush(ctx: *mut fw_iso_context) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fw_iso_context_flush_completions(ctx: *mut fw_iso_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fw_iso_context_stop(ctx: *mut fw_iso_context) -> c_int {
