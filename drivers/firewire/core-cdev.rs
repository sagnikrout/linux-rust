...
//! Source: drivers/firewire/core-cdev.c
#![no_std]
...
//
pub const FW_CDEV_KERNEL_VERSION: c_int = 6;
pub const FW_CDEV_VERSION_EVENT_REQUEST2: c_int = 4;
pub const FW_CDEV_VERSION_ALLOCATE_REGION_END: c_int = 4;
pub const FW_CDEV_VERSION_AUTO_FLUSH_ISO_OVERFLOW: c_int = 5;
pub const FW_CDEV_VERSION_EVENT_ASYNC_TSTAMP: c_int = 6;
...
#[no_mangle]
pub unsafe extern "C" fn client_get(client: *mut client) {
    static inline void client_get(struct client *client)
    {
    kref_get(&client.kref);
    }
#[no_mangle]
unsafe extern "C" fn client_release(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn client_put(client: *mut client) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct client_resource {
    pub release: client_resource_release_fn_t,
    pub handle: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct address_handler_resource {
    pub resource: client_resource,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct outbound_transaction_resource {
    pub resource: client_resource,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct inbound_transaction_resource {
    pub resource: client_resource,
    pub card: *mut fw_card,
    pub request: *mut fw_request,
    pub is_fcp: bool,
    pub data: *mut c_void,
    pub length: usize,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct descriptor_resource {
    pub resource: client_resource,
    pub descriptor: fw_descriptor,
    pub data: [u32; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct iso_resource_params {
...
// Schedule work and access todo only with client->lock held.
    ...
    pub params: iso_resource_params,
    pub e_dealloc: *mut *mut iso_resource_event e_alloc,,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct iso_resource_once {
    pub client: *mut client,
    ...
    pub todo: },
    pub params: iso_resource_params,
    pub event: *mut iso_resource_event,
}
...
#[no_mangle]
unsafe extern "C" fn is_iso_resource_auto(resource: *const client_resource) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_outbound_transaction_resource(resource: *const client_resource) -> c_int {
    static int is_outbound_transaction_resource(const struct client_resource *resource)
    {
    return resource.release == release_transaction;
    }
#[no_mangle]
unsafe extern "C" fn schedule_iso_resource_auto(r: *mut iso_resource_auto, delay: c_ulong) {
...
#[derive(Copy, Clone)]
pub struct event {
    pub v: [*mut *mut { void data; size_t size; }; 2],
    pub link: list_head,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bus_reset_event {
    pub event: event,
    pub reset: fw_cdev_event_bus_reset,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct outbound_transaction_event {
    pub event: event,
    pub client: *mut client,
    pub r: outbound_transaction_resource,
    union {
    pub without_tstamp: fw_cdev_event_response,
    pub with_tstamp: fw_cdev_event_response2,
    pub rsp: },
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct inbound_transaction_event {
    pub event: event,
    union {
    pub request: fw_cdev_event_request,
    pub request2: fw_cdev_event_request2,
    pub with_tstamp: fw_cdev_event_request3,
    pub req: },
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct iso_interrupt_event {
    pub event: event,
    pub interrupt: fw_cdev_event_iso_interrupt,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct iso_interrupt_mc_event {
    pub event: event,
    pub interrupt: fw_cdev_event_iso_interrupt_mc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct iso_resource_event {
    pub event: event,
    pub iso_resource: fw_cdev_event_iso_resource,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct outbound_phy_packet_event {
    pub event: event,
    pub client: *mut client,
    pub p: fw_packet,
    union {
    pub without_tstamp: fw_cdev_event_phy_packet,
    pub with_tstamp: fw_cdev_event_phy_packet2,
    pub phy_packet: },
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct inbound_phy_packet_event {
    pub event: event,
    union {
    pub without_tstamp: fw_cdev_event_phy_packet,
    pub with_tstamp: fw_cdev_event_phy_packet2,
...
#[no_mangle]
unsafe extern "C" fn uptr_to_u64(ptr: *mut void __user) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn uptr_to_u64(ptr: *mut void __user) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn fw_device_op_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn queue_bus_reset_event(client: *mut client) {
    ...
    &e.reset, sizeof(e.reset), core::ptr::null_mut(), 0);
...
#[no_mangle]
pub unsafe extern "C" fn fw_device_cdev_update(device: *mut fw_device) {
    void fw_device_cdev_update(struct fw_device *device)
    {
    for_each_client(device, queue_bus_reset_event);
    }
#[no_mangle]
unsafe extern "C" fn wake_up_client(client: *mut client) {
    static void wake_up_client(struct client *client)
    {
    wake_up_interruptible(&client.wait);
    }
#[no_mangle]
pub unsafe extern "C" fn fw_device_cdev_remove(device: *mut fw_device) {
...
#[no_mangle]
unsafe extern "C" fn ioctl_get_info(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
    ...
    if (a.rom != 0) {
    let mut want: usize = a.rom_length;
    let mut have: usize = client.device.config_rom_length * 4;
...
// return_resource = resource;
    ...
    let mut index: c_ulong = e.r.resource.handle;
    scoped_guard(spinlock_irqsave, &client.lock) {
...
// and prudent for compatibility.
    ...
    queue_event(client, &e.event, rsp, sizeof(*rsp) + rsp.length, core::ptr::null_mut(), 0);
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn ioctl_send_request(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
    ...
    let mut is_fcp: bool = is_in_fcp_region(offset, length);
...
// the process context for the client.
    ...
    if (r == core::ptr::null_mut() || e == core::ptr::null_mut())
    goto failed;
    r.card    = card;
    r.request = request;
    r.is_fcp  = is_fcp;
...
#[no_mangle]
unsafe extern "C" fn ioctl_allocate(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioctl_deallocate(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
    static int ioctl_deallocate(struct client *client, union ioctl_arg *arg)
    {
    return release_client_resource(client, arg.deallocate.handle,
    release_address_handler, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ioctl_send_response(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioctl_initiate_bus_reset(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioctl_add_descriptor(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioctl_remove_descriptor(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
    static int ioctl_remove_descriptor(struct client *client, union ioctl_arg *arg)
    {
    return release_client_resource(client, arg.remove_descriptor.handle,
    release_descriptor, core::ptr::null_mut());
    }
    ...
    sizeof(e.interrupt) + header_length, core::ptr::null_mut(), 0);
    }
    ...
    completed);
    queue_event(client, &e.event, &e.interrupt,
    sizeof(e.interrupt), core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn iso_dma_direction(context: *mut fw_iso_context) -> enum dma_data_direction {
...
#[no_mangle]
unsafe extern "C" fn ioctl_create_iso_context(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
...
// We only support one context at this time.
    ...
    if (client.iso_context != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn ioctl_set_iso_channels(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
    static int ioctl_set_iso_channels(struct client *client, union ioctl_arg *arg)
    {
    struct fw_cdev_set_iso_channels *a = &arg.set_iso_channels;
    struct fw_iso_context *ctx = client.iso_context;
    if (ctx == core::ptr::null_mut() || a.handle != 0)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn ioctl_queue_iso(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
...
//
    ...
    if (a.data == 0 || client.buffer.pages == core::ptr::null_mut() ||
    payload >= buffer_end) {
    payload = 0;
    buffer_end = 0;
    }
...
#[no_mangle]
unsafe extern "C" fn ioctl_start_iso(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
    ...
    if (client.iso_context == core::ptr::null_mut() || a.handle != 0)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn ioctl_stop_iso(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioctl_flush_iso(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioctl_get_cycle_timer2(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioctl_get_cycle_timer(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iso_resource_auto_work(work: *mut work_struct) {
    ...
    let mut index: c_ulong = r.resource.handle;
...
// xarray, it will be scheduled again for a newer generation or at shutdown.
    if (channel == -EAGAIN)
    goto out;
    let mut success: bool = channel >= 0 || bandwidth > 0;
    if (!success) {
...
// deallocation in the meantime.
    ...
    queue_event(client, &e.event,
    &e.iso_resource, sizeof(e.iso_resource), core::ptr::null_mut(), 0);
    if (free) {
...
#[no_mangle]
unsafe extern "C" fn release_iso_resource_auto(client: *mut client, resource: *mut client_resource) {
...
#[no_mangle]
unsafe extern "C" fn ioctl_allocate_iso_resource(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
    ...
    arg.deallocate.handle, release_iso_resource_auto, core::ptr::null_mut());
    }

#[no_mangle]
unsafe extern "C" fn iso_resource_once_work(work: *mut work_struct) {
    ...
    e.iso_resource.channel = channel;
    e.iso_resource.bandwidth = bandwidth;
    queue_event(client, &e.event, &e.iso_resource, sizeof(e.iso_resource), core::ptr::null_mut(), 0);
    cancel_work(&r.work);
    kfree(r);
    client_put(client);
    }
...
//
#[no_mangle]
unsafe extern "C" fn ioctl_get_speed(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioctl_send_stream_packet(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioctl_send_phy_packet(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioctl_receive_phy_packets(client: *mut client, arg: *mut union ioctl_arg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fw_cdev_handle_phy_packet(card: *mut fw_card, p: *mut fw_packet) {
...
// destination never runs in any type of IRQ context.
    ...
    queue_event(client, &e.event, &e.phy_packet, sizeof(*pp) + 8, core::ptr::null_mut(), 0);
    } else {
    struct fw_cdev_event_phy_packet2 *pp = &e.phy_packet.with_tstamp;
...
#[no_mangle]
unsafe extern "C" fn fw_device_op_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
// FIXME: We could support multiple buffers, but we don't.
    if (client.buffer.pages != core::ptr::null_mut())
    return -EBUSY;
...
#[no_mangle]
unsafe extern "C" fn has_outbound_transactions(client: *mut client) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fw_device_op_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fw_device_op_poll(file: *mut file, pt: *mut *mut poll_table) -> __poll_t {
