...
pub const IEEE1394_BROADCAST_CHANNEL: c_int = 31;

pub const IEEE1394_MAX_PAYLOAD_S100: c_int = 512;

pub const IANA_SPECIFIER_ID: c_uint = 0x00005eU;
pub const RFC2734_SW_VERSION: c_uint = 0x000001U;
pub const RFC3146_SW_VERSION: c_uint = 0x000002U;
pub const IEEE1394_GASP_HDR_SIZE: c_int = 8;
pub const RFC2374_UNFRAG_HDR_SIZE: c_int = 4;
pub const RFC2374_FRAG_HDR_SIZE: c_int = 8;
pub const RFC2374_FRAG_OVERHEAD: c_int = 4;

#[no_mangle]
unsafe extern "C" fn fwnet_hwaddr_is_multicast(ha: *mut u8) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fwnet_fragment_info {
    pub fi_link: list_head,
    pub offset: u16,
    pub len: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fwnet_partial_datagram {
    pub pd_link: list_head,
    pub fi_list: list_head,
    pub skb: *mut sk_buff,
// FIXME Why not use skb->data?
    pub pbuf: *mut c_char,
    pub datagram_label: u16,
    pub ether_type: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fwnet_device {
    pub dev_link: list_head,
    pub lock: spinlock_t,
    enum {
    ...
    pub broadcast_state: },
    pub broadcast_rcv_context: *mut fw_iso_context,
    pub broadcast_rcv_buffer: fw_iso_buffer,
    pub broadcast_rcv_buffer_ptrs: *mut c_void,
    pub broadcast_rcv_next_ptr: unsigned,
    pub num_broadcast_rcv_ptrs: unsigned,
    pub rcv_buffer_size: unsigned,
//
// This value is the maximum unfragmented datagram size that can be
// sent by the hardware.  It already has the GASP overhead and the
// unfragmented datagram header overhead calculated into it.
//
    pub broadcast_xmt_max_payload: unsigned,
    pub broadcast_xmt_datagramlabel: u16,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fwnet_peer {
    pub peer_link: list_head,
    pub dev: *mut fwnet_device,
    pub guid: u64,
// guarded by dev->lock
    pub /: *mut *mut list_head pd_list; / received partial datagrams,
    pub /: *mut *mut unsigned pdg_size; / pd_list size,
    pub /: *mut *mut u16 datagram_label; / outgoing datagram label,
    pub /: *mut *mut u16 max_payload; / includes RFC2374_FRAG_HDR_SIZE overhead,
    pub node_id: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fwnet_packet_task {
    pub transaction: fw_transaction,
    pub hdr: rfc2734_header,
    pub skb: *mut sk_buff,
    pub dev: *mut fwnet_device,
    pub outstanding_pkts: c_int,
    pub fifo_addr: u64,
    pub dest_node: u16,
    pub max_payload: u16,
    pub generation: u8,
...
// FIXME: is this correct for all cases?
    ...
    let mut end: unsigned = offset + len;
...
#[no_mangle]
unsafe extern "C" fn fwnet_pd_delete(old: *mut fwnet_partial_datagram) {
    ...
    {
    if (fwnet_frag_new(pd, frag_off, frag_len) == core::ptr::null_mut())
    return false;
...
#[no_mangle]
unsafe extern "C" fn fwnet_pd_is_complete(pd: *mut fwnet_partial_datagram) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fwnet_max_payload(max_rec: unsigned, speed: unsigned) -> unsigned {
...
#[no_mangle]
unsafe extern "C" fn gasp_source_id(p: *mut __be32) -> c_int {
    static int gasp_source_id(__be32 *p)
    {
    return be32_to_cpu(p[0]) >> 16;
    }
#[no_mangle]
unsafe extern "C" fn gasp_specifier_id(p: *mut __be32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gasp_version(p: *mut __be32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fwnet_free_ptask(ptask: *mut fwnet_packet_task) {
...
// Caller must hold dev->lock.
#[no_mangle]
unsafe extern "C" fn dec_queued_datagrams(dev: *mut fwnet_device) {
...
#[no_mangle]
unsafe extern "C" fn fwnet_transmit_packet_done(ptask: *mut fwnet_packet_task) {
...
#[no_mangle]
unsafe extern "C" fn fwnet_transmit_packet_failed(ptask: *mut fwnet_packet_task) {
...
#[no_mangle]
unsafe extern "C" fn fwnet_send_packet(ptask: *mut fwnet_packet_task) -> c_int {
    static int fwnet_send_packet(struct fwnet_packet_task *ptask)
    {
    struct fwnet_device *dev;
    unsigned tx_len;
...
#[no_mangle]
unsafe extern "C" fn fwnet_fifo_stop(dev: *mut fwnet_device) {
...
#[no_mangle]
unsafe extern "C" fn fwnet_fifo_start(dev: *mut fwnet_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __fwnet_broadcast_stop(dev: *mut fwnet_device) {
    ...
    dev.broadcast_rcv_context = core::ptr::null_mut();
    }
    kfree(dev.broadcast_rcv_buffer_ptrs);
    dev.broadcast_rcv_buffer_ptrs = core::ptr::null_mut();
    dev.broadcast_state = FWNET_BROADCAST_ERROR;
    }
#[no_mangle]
unsafe extern "C" fn fwnet_broadcast_stop(dev: *mut fwnet_device) {
...
#[no_mangle]
unsafe extern "C" fn fwnet_broadcast_start(dev: *mut fwnet_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_carrier_state(dev: *mut fwnet_device) {
...
// ifup
#[no_mangle]
unsafe extern "C" fn fwnet_open(net: *mut net_device) -> c_int {
...
// ifdown
#[no_mangle]
unsafe extern "C" fn fwnet_stop(net: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fwnet_tx(skb: *mut sk_buff, net: *mut net_device) -> netdev_tx_t {
...
//
    ...
    let mut guid: __be64 = get_unaligned(&ha.uc.uniq_id);
    u8 generation;
...
#[no_mangle]
unsafe extern "C" fn fwnet_init_dev(net: *mut net_device) {
...
// caller must hold fwnet_device_mutex
    ...
    struct net_device *net;
    let mut allocated_netdev: bool = false;
    struct fwnet_device *dev;
...
//
#[no_mangle]
unsafe extern "C" fn fwnet_update(unit: *mut fw_unit) {
...
#[no_mangle]
unsafe extern "C" fn fwnet_remove_peer(peer: *mut fwnet_peer, dev: *mut fwnet_device) {
...
#[no_mangle]
unsafe extern "C" fn fwnet_remove(unit: *mut fw_unit) {
...
#[no_mangle]
unsafe extern "C" fn fwnet_init() -> int __init {
    ...
    sizeof(struct fwnet_packet_task), 0, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn fwnet_cleanup() -> void __exit {
