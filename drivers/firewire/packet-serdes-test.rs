...
//! Source: drivers/firewire/packet-serdes-test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_async_header_write_quadlet_request(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_async_header_write_block_request(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_async_header_write_response(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_async_header_read_quadlet_request(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_async_header_read_quadlet_response(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_async_header_read_block_request(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_async_header_read_block_response(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_async_header_lock_request(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_async_header_lock_response(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_isoc_header(test: *mut kunit) {
    static void test_isoc_header(struct kunit *test)
    {
    let mut expected: u32 = 0x00d08dec;
...
#[no_mangle]
unsafe extern "C" fn test_phy_packet_self_id_zero_case0(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_phy_packet_self_id_zero_case1(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_phy_packet_self_id_zero_and_one(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_phy_packet_phy_config_force_root_node(test: *mut kunit) {
    static void test_phy_packet_phy_config_force_root_node(struct kunit *test)
    {
    let mut expected: u32 = 0x02800000;
    let mut quadlet: u32 = 0;
    unsigned int packet_identifier;
...
#[no_mangle]
unsafe extern "C" fn test_phy_packet_phy_config_gap_count_optimization(test: *mut kunit) {
    static void test_phy_packet_phy_config_gap_count_optimization(struct kunit *test)
    {
    let mut expected: u32 = 0x034f0000;
    let mut quadlet: u32 = 0;
    unsigned int packet_identifier;
    unsigned int root_id;
    bool has_force_root_node;
