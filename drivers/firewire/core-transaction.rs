...
//! Source: drivers/firewire/core-transaction.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn try_cancel_split_timeout(t: *mut fw_transaction) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_transaction_entry(card: *mut fw_card, entry: *mut fw_transaction) {
...
#[no_mangle]
pub unsafe extern "C" fn fw_cancel_pending_transactions(card: *mut fw_card) {
...
// local destination never runs in any type of IRQ context.
    ...
    list_del(&t.link);
    if (!t.with_tstamp) {
    t.callback.without_tstamp(card, RCODE_CANCELLED, core::ptr::null_mut(), 0,
    t.callback_data);
    } else {
    t.callback.with_tstamp(card, RCODE_CANCELLED, t.packet.timestamp, 0,
    core::ptr::null_mut(), 0, t.callback_data);
    }
    }
    }
// card->transactions.lock must be acquired in advance.
    ...
    ({									\
    struct fw_transaction *iter, *t = core::ptr::null_mut();				\
...
// local destination never runs in any type of IRQ context.
    ...
    if (!t.with_tstamp) {
    t.callback.without_tstamp(card, rcode, core::ptr::null_mut(), 0, t.callback_data);
    } else {
    t.callback.with_tstamp(card, rcode, t.packet.timestamp, response_tstamp, core::ptr::null_mut(), 0,
    t.callback_data);
    }
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn split_transaction_timeout_callback(timer: *mut timer_list) {
    ...
    if (!t.with_tstamp) {
    t.callback.without_tstamp(card, RCODE_CANCELLED, core::ptr::null_mut(), 0, t.callback_data);
    } else {
    t.callback.with_tstamp(card, RCODE_CANCELLED, t.packet.timestamp,
    t.split_timeout_cycle, core::ptr::null_mut(), 0, t.callback_data);
    }
    }
// card->transactions.lock should be acquired in advance for the linked list.
#[no_mangle]
unsafe extern "C" fn start_split_transaction_timeout(t: *mut fw_transaction, delta: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn allocate_tlabel(card: *mut fw_card) -> c_int {
...
// local destination never runs in any type of IRQ context.
    ...
    if (tlabel < 0) {
    if (!with_tstamp) {
    callback.without_tstamp(card, RCODE_SEND_ERROR, core::ptr::null_mut(), 0, callback_data);
    } else {
// Timestamping on behalf of hardware.
    ...
    (void)fw_card_read_cycle_time(card, &curr_cycle_time);
    tstamp = cycle_time_to_ohci_tstamp(curr_cycle_time);
    callback.with_tstamp(card, RCODE_SEND_ERROR, tstamp, tstamp, core::ptr::null_mut(), 0,
    callback_data);
    }
    return;
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct transaction_callback_data {
    pub done: completion,
...
//
    ...
    struct fw_transaction t;
    timer_setup_on_stack(&t.split_timeout_timer, core::ptr::null_mut(), 0);
    ...
    {
    let mut timeout: c_long = msecs_to_jiffies(100);
    let mut data: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn complete_address_handler(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn get_address_handler(handler: *mut fw_address_handler) {
    static void get_address_handler(struct fw_address_handler *handler)
    {
    kref_get(&handler.kref);
    }
#[no_mangle]
unsafe extern "C" fn put_address_handler(handler: *mut fw_address_handler) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fw_core_remove_address_handler(handler: *mut fw_address_handler) {
...
pub struct fw_request {
    pub kref: kref,
    pub response: fw_packet,
    pub request_header: [u32; ASYNC_HEADER_QUADLET_COUNT],
    pub ack: c_int,
    pub timestamp: u32,
    pub length: u32,
    pub data: [u32; ],
...
#[no_mangle]
pub unsafe extern "C" fn fw_request_get(request: *mut fw_request) {
    void fw_request_get(struct fw_request *request)
    {
    kref_get(&request.kref);
    }
#[no_mangle]
unsafe extern "C" fn release_request(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn fw_request_put(request: *mut fw_request) {
...
#[no_mangle]
pub unsafe extern "C" fn fw_get_response_length(r: *mut fw_request) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fw_get_request_speed(request: *mut fw_request) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fw_request_get_timestamp(request: *const fw_request) -> u32 {
...
pub const BUFFER_ON_KERNEL_STACK_SIZE: c_int = 4;
...
#[no_mangle]
pub unsafe extern "C" fn fw_core_handle_request(card: *mut fw_card, p: *mut fw_packet) {
...
#[no_mangle]
pub unsafe extern "C" fn fw_core_handle_response(card: *mut fw_card, p: *mut fw_packet) {
    void fw_core_handle_response(struct fw_card *card, struct fw_packet *p)
    {
    struct fw_transaction *t = core::ptr::null_mut();
    u32 *data;
    size_t data_length;
...
#[no_mangle]
unsafe extern "C" fn update_split_timeout(card: *mut fw_card) {
...
// minimum per IEEE 1394, maximum which doesn't overflow OHCI
    ...
    void *callback_data)
    {
    let mut reg: c_int = offset & ~CSR_REGISTER_BASE;
    __be32 *data = payload;
    let mut rcode: c_int = RCODE_COMPLETE;
    switch (reg) {
...
#[no_mangle]
pub unsafe extern "C" fn if(TCODE_WRITE_QUADLET_REQUEST: tcode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn fw_core_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fw_core_cleanup() -> void __exit {
