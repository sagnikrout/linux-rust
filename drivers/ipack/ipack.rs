...
#[no_mangle]
unsafe extern "C" fn ipack_device_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ipack_bus_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipack_bus_probe(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipack_bus_remove(device: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ipack_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
    ...
    buf[c++] = '\n';
#[no_mangle]
pub unsafe extern "C" fn if(0: (i & s) ==) -> else {
    else if ((i & s) == 0)
    buf[c++] = ' ';
    }
...
#[no_mangle]
unsafe extern "C" fn ipack_unregister_bus_member(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipack_bus_unregister(bus: *mut ipack_bus_device) -> c_int {
    int ipack_bus_unregister(struct ipack_bus_device *bus)
    {
    bus_for_each_dev(&ipack_bus_type, core::ptr::null_mut(), bus,
...
#[no_mangle]
pub unsafe extern "C" fn ipack_driver_unregister(edrv: *mut ipack_driver) {
...
#[no_mangle]
unsafe extern "C" fn ipack_crc_byte(crc: u16, c: u8) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn ipack_calc_crc1(dev: *mut ipack_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ipack_calc_crc2(dev: *mut ipack_device) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn ipack_parse_id1(dev: *mut ipack_device) {
...
#[no_mangle]
unsafe extern "C" fn ipack_parse_id2(dev: *mut ipack_device) {
...
#[no_mangle]
unsafe extern "C" fn ipack_device_read_id(dev: *mut ipack_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipack_device_init(dev: *mut ipack_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipack_device_add(dev: *mut ipack_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipack_device_del(dev: *mut ipack_device) {
...
#[no_mangle]
pub unsafe extern "C" fn ipack_get_device(dev: *mut ipack_device) {
...
#[no_mangle]
pub unsafe extern "C" fn ipack_put_device(dev: *mut ipack_device) {
...
#[no_mangle]
unsafe extern "C" fn ipack_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ipack_exit() -> void __exit {
