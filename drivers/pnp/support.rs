...
//
#[no_mangle]
pub unsafe extern "C" fn pnp_is_active(dev: *mut pnp_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pnp_eisa_id_to_string(id: u32, str: *mut c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn dbg_pnp_show_resources(dev: *mut pnp_dev, desc: *mut c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn dbg_pnp_show_option(dev: *mut pnp_dev, option: *mut pnp_option) {
