...
#[no_mangle]
pub unsafe extern "C" fn pnp_free_options(dev: *mut pnp_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pnp_check_port(dev: *mut pnp_dev, res: *mut resource) -> c_int {
...
// check if the resource is reserved
    for (i = 0; i < 8; i++) {
    let mut rport: c_int = pnp_reserve_io[i << 1];
    let mut rend: c_int = pnp_reserve_io[(i << 1) + 1] + rport - 1;
...
#[no_mangle]
pub unsafe extern "C" fn pnp_check_mem(dev: *mut pnp_dev, res: *mut resource) -> c_int {
...
// check if the resource is reserved
    for (i = 0; i < 8; i++) {
    let mut raddr: c_int = pnp_reserve_mem[i << 1];
    let mut rend: c_int = pnp_reserve_mem[(i << 1) + 1] + raddr - 1;
...
#[no_mangle]
unsafe extern "C" fn pnp_test_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pci_uses_irq(pnp: *mut pnp_dev, irq: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pnp_check_irq(dev: *mut pnp_dev, res: *mut resource) -> c_int {
...
// device is active because it itself may be in use
    ...
    IRQF_PROBE_SHARED, "pnp", core::ptr::null_mut()))
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn pnp_check_dma(dev: *mut pnp_dev, res: *mut resource) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pnp_resource_type(res: *mut resource) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn pnp_range_reserved(start: resource_size_t, end: resource_size_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnp_setup_reserve_irq(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pnp_setup_reserve_dma(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pnp_setup_reserve_io(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pnp_setup_reserve_mem(str: *mut c_char) -> int __init {
