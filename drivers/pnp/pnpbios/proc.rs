...
//! Source: drivers/pnp/pnpbios/proc.c
#![no_std]
...
//
    ...
    static struct proc_dir_entry *proc_pnp = core::ptr::null_mut();
    static struct proc_dir_entry *proc_pnp_boot = core::ptr::null_mut();
#[no_mangle]
unsafe extern "C" fn pnpconfig_proc_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn escd_info_proc_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn escd_proc_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnp_legacyres_proc_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnp_devices_proc_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnpbios_proc_show(m: *mut seq_file, v: *mut c_void) -> c_int {
    static int pnpbios_proc_show(struct seq_file *m, void *v)
    {
    void *data = m.private;
    struct pnp_bios_node *node;
    let mut boot: c_int = (long)data >> 8;
    let mut nodenum: u8 = (long)data;
    int len;
    node = kzalloc(node_info.max_node_size, GFP_KERNEL);
    if (!node)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn pnpbios_proc_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pnpbios_interface_attach_device(node: *mut pnp_bios_node) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pnpbios_proc_init() -> int __init {
    int __init pnpbios_proc_init(void)
    {
    proc_pnp = proc_mkdir("bus/pnp", core::ptr::null_mut());
    if (!proc_pnp)
    return -EIO;
...
#[no_mangle]
pub unsafe extern "C" fn pnpbios_proc_exit() -> void __exit {
    ...
    remove_proc_entry("bus/pnp", core::ptr::null_mut());
    }
