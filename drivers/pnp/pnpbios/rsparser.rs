...
//! Source: drivers/pnp/pnpbios/rsparser.c
#![no_std]
...
pub const SMALL_TAG_PNPVERNO: c_uint = 0x01;
pub const SMALL_TAG_LOGDEVID: c_uint = 0x02;
pub const SMALL_TAG_COMPATDEVID: c_uint = 0x03;
pub const SMALL_TAG_IRQ: c_uint = 0x04;
pub const SMALL_TAG_DMA: c_uint = 0x05;
pub const SMALL_TAG_STARTDEP: c_uint = 0x06;
pub const SMALL_TAG_ENDDEP: c_uint = 0x07;
pub const SMALL_TAG_PORT: c_uint = 0x08;
pub const SMALL_TAG_FIXEDPORT: c_uint = 0x09;
pub const SMALL_TAG_VENDOR: c_uint = 0x0e;
pub const SMALL_TAG_END: c_uint = 0x0f;
pub const LARGE_TAG: c_uint = 0x80;
pub const LARGE_TAG_MEM: c_uint = 0x81;
pub const LARGE_TAG_ANSISTR: c_uint = 0x82;
pub const LARGE_TAG_UNICODESTR: c_uint = 0x83;
pub const LARGE_TAG_VENDOR: c_uint = 0x84;
pub const LARGE_TAG_MEM32: c_uint = 0x85;
pub const LARGE_TAG_FIXEDMEM32: c_uint = 0x86;
//
...
//
    ...
    struct resource *res)
    {
    let mut base: c_ulong = res.start;
    let mut len: c_ulong = resource_size(res);
    if (pnp_resource_enabled(res)) {
    base = res.start;
    len = resource_size(res);
    } else {
...
// dev,
    ...
    {
    unsigned int len, tag;
    let mut port: c_int = 0, irq = 0, dma = 0, mem = 0;
    if (!p)
    return core::ptr::null_mut();
    while ((char *)p < (char *)end) {
// determine the type of tag
