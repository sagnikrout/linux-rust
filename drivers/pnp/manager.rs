...
#[no_mangle]
unsafe extern "C" fn pnp_assign_port(dev: *mut pnp_dev, rule: *mut pnp_port, idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnp_assign_mem(dev: *mut pnp_dev, rule: *mut pnp_mem, idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnp_assign_irq(dev: *mut pnp_dev, rule: *mut pnp_irq, idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnp_assign_dma(dev: *mut pnp_dev, rule: *mut pnp_dma, idx: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pnp_init_resources(dev: *mut pnp_dev) {
    void pnp_init_resources(struct pnp_dev *dev)
    {
    pnp_free_resources(dev);
    }
#[no_mangle]
unsafe extern "C" fn pnp_clean_resource_table(dev: *mut pnp_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pnp_assign_resources(dev: *mut pnp_dev, set: c_int) -> c_int {
    static int pnp_assign_resources(struct pnp_dev *dev, int set)
    {
    struct pnp_option *option;
    let mut nport: c_int = 0, nmem = 0, nirq = 0;
    let mut __maybe_unused: int ndma = 0;
    let mut ret: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn pnp_auto_config_dev(dev: *mut pnp_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pnp_start_dev(dev: *mut pnp_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pnp_stop_dev(dev: *mut pnp_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pnp_activate_dev(dev: *mut pnp_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pnp_disable_dev(dev: *mut pnp_dev) -> c_int {
