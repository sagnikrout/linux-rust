...
#[no_mangle]
unsafe extern "C" fn quirk_awe32_resources(dev: *mut pnp_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_cmi8330_resources(dev: *mut pnp_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_sb16audio_resources(dev: *mut pnp_dev) {
    static void quirk_sb16audio_resources(struct pnp_dev *dev)
    {
    struct pnp_option *option;
    let mut prev_option_flags: c_uint = ~0, n = 0;
...
//
    ...
    unsigned int set)
    {
    struct pnp_option *tail = core::ptr::null_mut(), *first_new_option = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn quirk_add_irq_optional_dependent_sets(dev: *mut pnp_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_ad1815_mpu_resources(dev: *mut pnp_dev) {
    static void quirk_ad1815_mpu_resources(struct pnp_dev *dev)
    {
    struct pnp_option *option;
    struct pnp_irq *irq = core::ptr::null_mut();
    let mut independent_irqs: c_uint = 0;
    list_for_each_entry(option, &dev.options, list) {
    if (option.type == IORESOURCE_IRQ &&
...
#[no_mangle]
unsafe extern "C" fn quirk_system_pci_resources(dev: *mut pnp_dev) {
...
//
    ...
    let mut type: c_ulong = resource_type(r);
...
#[no_mangle]
unsafe extern "C" fn quirk_amd_mmconfig_area(dev: *mut pnp_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_intel_mch(dev: *mut pnp_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pnp_fixup_device(dev: *mut pnp_dev) {
