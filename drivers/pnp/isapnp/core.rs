...
//! Source: drivers/pnp/isapnp/core.c
#![no_std]
...
// Macro flag: #define ISAPNP_REGION_OK
...
pub const _PIDXR: c_uint = 0x279;
pub const _PNPWRP: c_uint = 0xa79;
// short tags
pub const _STAG_PNPVERNO: c_uint = 0x01;
pub const _STAG_LOGDEVID: c_uint = 0x02;
pub const _STAG_COMPATDEVID: c_uint = 0x03;
pub const _STAG_IRQ: c_uint = 0x04;
pub const _STAG_DMA: c_uint = 0x05;
pub const _STAG_STARTDEP: c_uint = 0x06;
pub const _STAG_ENDDEP: c_uint = 0x07;
pub const _STAG_IOPORT: c_uint = 0x08;
pub const _STAG_FIXEDIO: c_uint = 0x09;
pub const _STAG_VENDOR: c_uint = 0x0e;
pub const _STAG_END: c_uint = 0x0f;
// long tags
pub const _LTAG_MEMRANGE: c_uint = 0x81;
pub const _LTAG_ANSISTR: c_uint = 0x82;
pub const _LTAG_UNICODESTR: c_uint = 0x83;
pub const _LTAG_VENDOR: c_uint = 0x84;
pub const _LTAG_MEM32RANGE: c_uint = 0x85;
pub const _LTAG_FIXEDMEM32RANGE: c_uint = 0x86;
// Logical device control and configuration registers
pub const ISAPNP_CFG_ACTIVATE: c_uint = 0x30	/* byte */;
pub const ISAPNP_CFG_MEM: c_uint = 0x40	/* 4 * dword */;
pub const ISAPNP_CFG_PORT: c_uint = 0x60	/* 8 * word */;
pub const ISAPNP_CFG_IRQ: c_uint = 0x70	/* 2 * word */;
pub const ISAPNP_CFG_DMA: c_uint = 0x74	/* 2 * byte */;
//
// Sizes of ISAPNP logical device configuration register sets.
// See PNP-ISA-v1.0a.pdf, Appendix A.
//
pub const ISAPNP_MAX_MEM: c_int = 4;
pub const ISAPNP_MAX_PORT: c_int = 8;
pub const ISAPNP_MAX_IRQ: c_int = 2;
pub const ISAPNP_MAX_DMA: c_int = 2;
    static unsigned char isapnp_checksum_value;
    static DEFINE_MUTEX(isapnp_cfg_mutex);
    static int isapnp_csn_count;
// some prototypes
#[no_mangle]
pub unsafe extern "C" fn write_data(x: c_uchar) {
    static inline void write_data(unsigned char x)
    {
    outb(x, _PNPWRP);
    }
#[no_mangle]
pub unsafe extern "C" fn write_address(x: c_uchar) {
...
#[no_mangle]
pub unsafe extern "C" fn read_data() -> c_uchar {
    static inline unsigned char read_data(void)
    {
    let mut val: c_uchar = inb(isapnp_rdp);
    return val;
    }
#[no_mangle]
pub unsafe extern "C" fn isapnp_read_byte(idx: c_uchar) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn isapnp_read_word(idx: c_uchar) -> c_ushort {
...
#[no_mangle]
pub unsafe extern "C" fn isapnp_write_byte(idx: c_uchar, val: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn isapnp_write_word(idx: c_uchar, val: c_ushort) {
...
#[no_mangle]
unsafe extern "C" fn isapnp_key() {
    static void isapnp_key(void)
    {
    let mut code: c_uchar = 0x6a, msb;
    int i;
    mdelay(1);
    write_address(0x00);
    write_address(0x00);
...
#[no_mangle]
unsafe extern "C" fn isapnp_deactivate(logdev: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn isapnp_peek(data: *mut c_uchar, bytes: c_int) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn isapnp_next_rdp() -> c_int {
    static int isapnp_next_rdp(void)
    {
    let mut rdp: c_int = isapnp_rdp;
    let mut old_rdp: static int = 0;
    if (old_rdp) {
...
#[no_mangle]
pub unsafe extern "C" fn isapnp_set_rdp() {
...
//
#[no_mangle]
unsafe extern "C" fn isapnp_isolate_rdp_select() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn isapnp_isolate() -> int __init {
    static int __init isapnp_isolate(void)
    {
    let mut checksum: c_uchar = 0x6a;
    let mut chksum: c_uchar = 0x00;
    let mut bit: c_uchar = 0x00;
    int data;
    let mut csn: c_int = 0;
    int i;
    let mut iteration: c_int = 1;
    isapnp_rdp = 0x213;
...
//
#[no_mangle]
unsafe extern "C" fn isapnp_read_tag(type: *mut c_uchar, size: *mut c_ushort) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn isapnp_skip_bytes(count: c_int) -> void __init {
    static void __init isapnp_skip_bytes(int count)
    {
    isapnp_peek(core::ptr::null_mut(), count);
    }
//
...
//
    ...
    unsigned long bits;
    pnp_irq_mask_t map;
    let mut flags: c_uchar = IORESOURCE_IRQ_HIGHEDGE;
    isapnp_peek(tmp, size);
    bits = (tmp[1] << 8) | tmp[0];
...
//
    ...
    unsigned short size)
    {
    let mut number: c_int = 0, skip = 0, priority, compat = 0;
    unsigned char type, tmp[17];
    unsigned int option_flags;
    struct pnp_dev *dev;
    u32 eisa_id;
    char id[8];
    if ((dev = isapnp_parse_device(card, size, number++)) == core::ptr::null_mut())
    return 1;
    option_flags = 0;
...
//
#[no_mangle]
unsafe extern "C" fn isapnp_parse_resource_map(card: *mut pnp_card) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn isapnp_build_device_list() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn isapnp_present() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isapnp_cfg_begin(csn: c_int, logdev: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isapnp_cfg_end() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isapnp_get_resources(dev: *mut pnp_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isapnp_set_resources(dev: *mut pnp_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isapnp_disable_resources(dev: *mut pnp_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isapnp_init() -> int __init {
...
// format is: noisapnp
#[no_mangle]
unsafe extern "C" fn isapnp_setup_disable(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn isapnp_setup_isapnp(str: *mut c_char) -> int __init {
