...
#[no_mangle]
unsafe extern "C" fn adg792a_write_cmd(i2c: *mut i2c_client, cmd: u8, reset: c_int) -> c_int {
    static int adg792a_write_cmd(struct i2c_client *i2c, u8 cmd, int reset)
    {
    let mut data: u8 = ADG792A_RESETB | ADG792A_LDSW;
...
#[no_mangle]
unsafe extern "C" fn adg792a_set(mux: *mut mux_control, state: c_int) -> c_int {
...
// parallel mux controller operation
    ...
    let mut controller: c_uint = mux_control_get_index(mux);
    if (state == MUX_IDLE_DISCONNECT)
...
#[no_mangle]
unsafe extern "C" fn adg792a_probe(i2c: *mut i2c_client) -> c_int {
