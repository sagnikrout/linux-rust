...
pub const CD_NOTHING: c_uint = 0x0;
pub const CD_WARNING: c_uint = 0x1;
pub const CD_REG_UNREG: c_uint = 0x2;
pub const CD_DO_IOCTL: c_uint = 0x4;
pub const CD_OPEN: c_uint = 0x8;
pub const CD_CLOSE: c_uint = 0x10;
pub const CD_COUNT_TRACKS: c_uint = 0x20;
pub const CD_CHANGER: c_uint = 0x40;
pub const CD_DVD: c_uint = 0x80;
...
// default compatibility mode
    let mut autoclose: static bool = 1;
    static bool autoeject;
    let mut lockdoor: static bool = 1;
// will we ever get to use this... sigh.
    static bool check_media_type;
// automatically restart mrw format
    let mut mrw_format_restart: static bool = 1;
...
#[no_mangle]
unsafe extern "C" fn signal_media_change(cdi: *mut cdrom_device_info) {
...
#[no_mangle]
unsafe extern "C" fn cdrom_flush_cache(cdi: *mut cdrom_device_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cdrom_mrw_probe_pc(cdi: *mut cdrom_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdrom_is_mrw(cdi: *mut cdrom_device_info, write: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdrom_mrw_bgformat(cdi: *mut cdrom_device_info, cont: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdrom_mrw_bgformat_susp(cdi: *mut cdrom_device_info, immed: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdrom_mrw_exit(cdi: *mut cdrom_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdrom_mrw_set_lba_space(cdi: *mut cdrom_device_info, space: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn register_cdrom(disk: *mut gendisk, cdi: *mut cdrom_device_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn unregister_cdrom(cdi: *mut cdrom_device_info) {
...
#[no_mangle]
unsafe extern "C" fn cdrom_has_defect_mgt(cdi: *mut cdrom_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdrom_is_random_writable(cdi: *mut cdrom_device_info, write: *mut c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cdrom_probe_write_features(cdi: *mut cdrom_device_info) {
...
#[no_mangle]
unsafe extern "C" fn cdrom_media_erasable(cdi: *mut cdrom_device_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cdrom_dvdram_open_write(cdi: *mut cdrom_device_info) -> c_int {
    static int cdrom_dvdram_open_write(struct cdrom_device_info *cdi)
    {
    let mut ret: c_int = cdrom_media_erasable(cdi);
//
...
#[no_mangle]
unsafe extern "C" fn cdrom_mrw_open_write(cdi: *mut cdrom_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mo_open_write(cdi: *mut cdrom_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdrom_ram_open_write(cdi: *mut cdrom_device_info) -> c_int {
    ...
    return ret;
#[no_mangle]
pub unsafe extern "C" fn if(be16_to_cpu(rfd.feature_code): CDF_RWRT ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn cdrom_mmc3_profile(cdi: *mut cdrom_device_info) {
...
#[no_mangle]
unsafe extern "C" fn cdrom_is_dvd_rw(cdi: *mut cdrom_device_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cdrom_open_write(cdi: *mut cdrom_device_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CDROM_CAN(CDC_DVD_RAM)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CDROM_CAN(CDC_MO_DRIVE)) -> else {
    else if (CDROM_CAN(CDC_MO_DRIVE))
    ret = mo_open_write(cdi);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !cdrom_is_dvd_rw(cdi)) -> else {
    else if (!cdrom_is_dvd_rw(cdi))
    ret = 0;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn cdrom_dvd_rw_close_write(cdi: *mut cdrom_device_info) {
...
#[no_mangle]
unsafe extern "C" fn cdrom_count_tracks(cdi: *mut cdrom_device_info, tracks: *mut tracktype) {
...
// check what type of tracks are on this disc
    ...
    tracks.cdi++;
#[no_mangle]
pub unsafe extern "C" fn if(0x20: entry.cdte_format ==) -> else {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn open_for_data(cdi: *mut cdrom_device_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cdrom_open(cdi: *mut cdrom_device_info, mode: blk_mode_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cdrom_release(cdi: *mut cdrom_device_info) {
...
#[no_mangle]
unsafe extern "C" fn cdrom_slot_status(cdi: *mut cdrom_device_info, slot: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cdrom_number_of_slots(cdi: *mut cdrom_device_info) -> c_int {
    int cdrom_number_of_slots(struct cdrom_device_info *cdi)
    {
    let mut nslots: c_int = 1;
    struct cdrom_changer_info *info;
...
#[no_mangle]
unsafe extern "C" fn cdrom_load_unload(cdi: *mut cdrom_device_info, slot: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdrom_select_disc(cdi: *mut cdrom_device_info, slot: c_int) -> c_int {
...
//
    static
#[no_mangle]
pub unsafe extern "C" fn media_changed(cdi: *mut cdrom_device_info, queue: c_int) -> c_int {
    int media_changed(struct cdrom_device_info *cdi, int queue)
    {
    let mut mask: c_uint = (1 << (queue & 1));
    let mut ret: c_int = !!(cdi.mc_flags & mask);
    bool changed;
...
#[no_mangle]
unsafe extern "C" fn setup_report_key(cgc: *mut packet_command, agid: unsigned, type: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn setup_send_key(cgc: *mut packet_command, agid: unsigned, type: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn dvd_do_auth(cdi: *mut cdrom_device_info, ai: *mut dvd_authinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdrom_ioctl_eject(cdi: *mut cdrom_device_info) -> c_int {
    ...
    let mut ret: c_int = cdi.ops.lock_door(cdi, 0);
    if (ret)
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn cdrom_ioctl_closetray(cdi: *mut cdrom_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdrom_ioctl_get_capability(cdi: *mut cdrom_device_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cdrom_ioctl_disc_status(cdi: *mut cdrom_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdrom_ioctl_changer_nslots(cdi: *mut cdrom_device_info) -> c_int {
...
// cd_dbg(CD_DO_IOCTL, "CDROMREADTOCHDR successful\n");
    ...
    struct cdrom_tocentry *entry)
    {
    let mut requested_format: u8 = entry.cdte_format;
    int ret;
    if (requested_format != CDROM_MSF && requested_format != CDROM_LBA)
    return -EINVAL;
...
//
#[no_mangle]
unsafe extern "C" fn cdrom_switch_blocksize(cdi: *mut cdrom_device_info, size: c_int) -> c_int {
...
// return the last written block on the CD-R media. this is for the udf
    file system. */
#[no_mangle]
pub unsafe extern "C" fn cdrom_get_last_written(cdi: *mut cdrom_device_info, last_written: *mut c_long) -> c_int {
...
// next_writable += 7;
    ...
    struct cdrom_msf msf;
    let mut blocksize: c_int = 0, format = 0, lba;
    int ret;
    switch (cmd) {
    case CDROMREADRAW:
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct compat_cdrom_read_audio {
    pub addr: union cdrom_addr,
    pub addr_format: u8,
    pub nframes: compat_int_t,
    pub buf: compat_caddr_t,
    pub ra32: },
    ...
    ra.addr.msf.frame);
#[no_mangle]
pub unsafe extern "C" fn if(CDROM_LBA: ra.addr_format ==) -> else {
...
// set volume
    ...
    int ret;
    dvd_struct *s;
    let mut size: c_int = sizeof(dvd_struct);
...
pub const CDROM_STR_SIZE: c_int = 1000;
    ...
    {
    let mut max_size: c_int = sizeof(cdrom_sysctl_settings.info);
...
#[no_mangle]
unsafe extern "C" fn cdrom_update_settings() {
    ...
    cdi.options |= CDO_AUTO_CLOSE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !autoclose) -> else {
    else if (!autoclose)
    cdi.options &= ~CDO_AUTO_CLOSE;
    if (autoeject && CDROM_CAN(CDC_OPEN_TRAY))
    cdi.options |= CDO_AUTO_EJECT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !autoeject) -> else {
    else if (!autoeject)
    cdi.options &= ~CDO_AUTO_EJECT;
    if (lockdoor && CDROM_CAN(CDC_LOCK))
    cdi.options |= CDO_LOCK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !lockdoor) -> else {
    else if (!lockdoor)
    cdi.options &= ~CDO_LOCK;
    if (check_media_type)
...
#[no_mangle]
unsafe extern "C" fn cdrom_sysctl_register() {
    static void cdrom_sysctl_register(void)
    {
    let mut initialized: static atomic_t = ATOMIC_INIT(0);
...
#[no_mangle]
unsafe extern "C" fn cdrom_sysctl_unregister() {
...
#[no_mangle]
unsafe extern "C" fn cdrom_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cdrom_exit() -> void __exit {
