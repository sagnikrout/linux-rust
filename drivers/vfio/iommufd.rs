...
#[no_mangle]
pub unsafe extern "C" fn vfio_df_iommufd_bind(df: *mut vfio_device_file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_df_iommufd_unbind(df: *mut vfio_device_file) {
...
#[no_mangle]
unsafe extern "C" fn vfio_iommufd_device_id(vdev: *mut vfio_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfio_iommufd_get_dev_id(vdev: *mut vfio_device, ictx: *mut iommufd_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_iommufd_physical_unbind(vdev: *mut vfio_device) {
    ...
    vdev.iommufd_device = core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(vfio_iommufd_physical_unbind);
#[no_mangle]
pub unsafe extern "C" fn vfio_iommufd_physical_attach_ioas(vdev: *mut vfio_device, pt_id: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_iommufd_physical_detach_ioas(vdev: *mut vfio_device) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_iommufd_emulated_unbind(vdev: *mut vfio_device) {
    ...
    vdev.iommufd_attached = false;
    vdev.iommufd_access = core::ptr::null_mut();
    }
    }
    EXPORT_SYMBOL_GPL(vfio_iommufd_emulated_unbind);
#[no_mangle]
pub unsafe extern "C" fn vfio_iommufd_emulated_attach_ioas(vdev: *mut vfio_device, pt_id: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_iommufd_emulated_detach_ioas(vdev: *mut vfio_device) {
