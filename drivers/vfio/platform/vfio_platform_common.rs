...
//! Source: drivers/vfio/platform/vfio_platform_common.c
#![no_std]
...
//
    ...
    let mut reset_fn: vfio_platform_reset_fn_t = core::ptr::null_mut();
...
// module = iter->owner;
    ...
    acpi_ret = acpi_evaluate_object(handle, "_RST", core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn vfio_platform_acpi_has_reset(vdev: *mut vfio_platform_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vfio_platform_has_reset(vdev: *mut vfio_platform_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vfio_platform_get_reset(vdev: *mut vfio_platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_platform_put_reset(vdev: *mut vfio_platform_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_platform_regions_init(vdev: *mut vfio_platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_platform_regions_cleanup(vdev: *mut vfio_platform_device) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_platform_close_device(core_vdev: *mut vfio_device) {
    void vfio_platform_close_device(struct vfio_device *core_vdev)
    {
    struct vfio_platform_device *vdev =
    container_of(core_vdev, struct vfio_platform_device, vdev);
    const char *extra_dbg = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn vfio_platform_open_device(core_vdev: *mut vfio_device) -> c_int {
...
// map offset to the physical address
    ...
    return vfio_platform_call_reset(vdev, core::ptr::null_mut());
    }
    return -ENOTTY;
    }
    ...
    struct vfio_platform_device *vdev =
    container_of(core_vdev, struct vfio_platform_device, vdev);
    let mut index: c_uint = VFIO_PLATFORM_OFFSET_TO_INDEX(*ppos);
    let mut off: loff_t = *ppos & VFIO_PLATFORM_OFFSET_MASK;
    ...
    buf, count, off);
#[no_mangle]
pub unsafe extern "C" fn if(VFIO_PLATFORM_REGION_TYPE_PIO: vdev->regions[index].type &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_platform_mmap(core_vdev: *mut vfio_device, vma: *mut vm_area_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfio_platform_init_common(vdev: *mut vfio_platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_platform_release_common(vdev: *mut vfio_platform_device) {
...
#[no_mangle]
pub unsafe extern "C" fn __vfio_platform_register_reset(node: *mut vfio_platform_reset_node) {
