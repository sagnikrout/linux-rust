...
//! Source: drivers/vfio/fsl-mc/vfio_fsl_mc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vfio_fsl_mc_open_device(core_vdev: *mut vfio_device) -> c_int {
    static int vfio_fsl_mc_open_device(struct vfio_device *core_vdev)
    {
    struct vfio_fsl_mc_device *vdev =
    container_of(core_vdev, struct vfio_fsl_mc_device, vdev);
    struct fsl_mc_device *mc_dev = vdev.mc_dev;
    let mut count: c_int = mc_dev.obj_desc.region_count;
    int i;
    ...
    let mut no_mmap: c_int = is_fsl_mc_bus_dprc(mc_dev);
...
#[no_mangle]
unsafe extern "C" fn vfio_fsl_mc_regions_cleanup(vdev: *mut vfio_fsl_mc_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_fsl_mc_reset_device(vdev: *mut vfio_fsl_mc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_fsl_mc_close_device(core_vdev: *mut vfio_device) {
...
// map offset to the physical address
    ...
    struct vfio_fsl_mc_device *vdev =
    container_of(core_vdev, struct vfio_fsl_mc_device, vdev);
    let mut index: c_uint = VFIO_FSL_MC_OFFSET_TO_INDEX(*ppos);
    let mut off: loff_t = *ppos & VFIO_FSL_MC_OFFSET_MASK;
    struct fsl_mc_device *mc_dev = vdev.mc_dev;
...
pub const MC_CMD_COMPLETION_TIMEOUT_MS: c_int = 5000;
pub const MC_CMD_COMPLETION_POLLING_MAX_SLEEP_USECS: c_int = 500;
#[no_mangle]
unsafe extern "C" fn vfio_fsl_mc_send_command(ioaddr: *mut void __iomem, cmd_data: *mut u64) -> c_int {
    static int vfio_fsl_mc_send_command(void __iomem *ioaddr, uint64_t *cmd_data)
    {
    int i;
    enum mc_cmd_status status;
    let mut timeout_usecs: c_ulong = MC_CMD_COMPLETION_TIMEOUT_MS * 1000;
...
//
    ...
    {
    let mut size: u64 = vma.vm_end - vma.vm_start;
    u64 pgoff, base;
    u8 region_cacheable;
    pgoff = vma.vm_pgoff &
...
#[no_mangle]
unsafe extern "C" fn vfio_fsl_mc_init_device(vdev: *mut vfio_fsl_mc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_fsl_mc_scan_container(mc_dev: *mut fsl_mc_device) -> c_int {
...
// non dprc devices do not scan for other devices
    ...
    dprc_remove_devices(mc_dev, core::ptr::null_mut(), 0);
    return ret;
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn vfio_fsl_uninit_device(vdev: *mut vfio_fsl_mc_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_fsl_mc_init_dev(core_vdev: *mut vfio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_fsl_mc_probe(mc_dev: *mut fsl_mc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_fsl_mc_release_dev(core_vdev: *mut vfio_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_fsl_mc_remove(mc_dev: *mut fsl_mc_device) {
