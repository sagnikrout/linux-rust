...
//! Source: drivers/vfio/cdx/main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vfio_cdx_init_dev(core_vdev: *mut vfio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_cdx_release_dev(core_vdev: *mut vfio_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_cdx_open_device(core_vdev: *mut vfio_device) -> c_int {
    static int vfio_cdx_open_device(struct vfio_device *core_vdev)
    {
    struct vfio_cdx_device *vdev =
    container_of(core_vdev, struct vfio_cdx_device, vdev);
    struct cdx_device *cdx_dev = to_cdx_device(core_vdev.dev);
    let mut count: c_int = cdx_dev.res_count;
    int i, ret;
...
//
    ...
    if (ret) {
    kfree(vdev.regions);
    vdev.regions = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn vfio_cdx_close_device(core_vdev: *mut vfio_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_cdx_probe(cdx_dev: *mut cdx_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_cdx_remove(cdx_dev: *mut cdx_device) -> c_int {
