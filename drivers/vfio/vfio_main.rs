...
//! Source: drivers/vfio/vfio_main.c
#![no_std]
...
pub const VFIO_MAGIC: c_uint = 0x5646494f /* "VFIO" */;
    static struct vfio {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_assign_device_set(device: *mut vfio_device, set_id: *mut c_void) -> c_int {
    int vfio_assign_device_set(struct vfio_device *device, void *set_id)
    {
    let mut idx: c_ulong = (unsigned long)set_id;
...
//
    ...
    xa_lock(&vfio_device_set_xa);
    dev_set = __xa_cmpxchg(&vfio_device_set_xa, idx, core::ptr::null_mut(), new_dev_set,
    GFP_KERNEL);
    if (!dev_set) {
    dev_set = new_dev_set;
    goto found_get_ref;
...
#[no_mangle]
unsafe extern "C" fn vfio_release_device_set(device: *mut vfio_device) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_device_set_open_count(dev_set: *mut vfio_device_set) -> c_uint {
    unsigned int vfio_device_set_open_count(struct vfio_device_set *dev_set)
    {
    struct vfio_device *cur;
    let mut open_count: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn vfio_device_put_registration(device: *mut vfio_device) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_device_try_get_registration(device: *mut vfio_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vfio_device_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_fs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_device_set_noiommu_and_name(device: *mut vfio_device, type: enum vfio_group_type) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_register_group_dev(device: *mut vfio_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfio_register_emulated_iommu_dev(device: *mut vfio_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_unregister_group_dev(device: *mut vfio_device) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_device_get_kvm_safe(device: *mut vfio_device, kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_device_put_kvm(device: *mut vfio_device) {
    ...
    device.put_kvm = core::ptr::null_mut();
    symbol_put(kvm_put_kvm);
    clear:
    device.kvm = core::ptr::null_mut();
    }

// true if the vfio_device has open_device() called but not close_device()
#[no_mangle]
unsafe extern "C" fn vfio_assert_device_open(device: *mut vfio_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vfio_df_device_first_open(df: *mut vfio_device_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_df_device_last_close(df: *mut vfio_device_file) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_df_open(df: *mut vfio_device_file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_df_close(df: *mut vfio_device_file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfio_device_pm_runtime_get(device: *mut vfio_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfio_device_pm_runtime_put(device: *mut vfio_device) {
...
//
#[no_mangle]
unsafe extern "C" fn vfio_device_fops_release(inode: *mut inode, filep: *mut file) -> c_int {
...
//
    ...
    struct vfio_device_feature_mig_state mig;
    struct file *filp = core::ptr::null_mut();
    int ret;
    if (!device.mig_ops)
    return -ENOTTY;
...
// Handle the VFIO_DEVICE_FEATURE_SET
    ...
    size_t argsz)
    {
    let mut data_size: vfio_device_feature_mig_data_size = {};
...
// Ranges should fit into a single kernel page
    ...
    let mut root: rb_root_cached = RB_ROOT_CACHED;
...
// Range overlapping
    ...
    {
    let mut minsz: usize = offsetofend(struct vfio_device_feature, flags);
...
// GET & SET are mutually exclusive except with PROBE
    ...
    {
    let mut minsz: c_ulong = offsetofend(struct vfio_region_info, offset);
    let mut info: vfio_region_info = {};
    let mut caps: vfio_info_cap = {};
    int ret;
...
#[no_mangle]
unsafe extern "C" fn vfio_device_fops_mmap(filep: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_device_show_fdinfo(m: *mut seq_file, filep: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfio_file_is_valid(file: *mut file) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfio_file_enforced_coherent(file: *mut file) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vfio_device_file_set_kvm(file: *mut file, kvm: *mut kvm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfio_file_set_kvm(file: *mut file, kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_info_cap_shift(caps: *mut vfio_info_cap, offset: usize) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfio_unpin_pages(device: *mut vfio_device, iova: dma_addr_t, npage: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn vfio_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vfio_cleanup() -> void __exit {
