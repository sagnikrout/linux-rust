...
//! Source: drivers/vfio/pci/ism/main.c
#![no_std]
...
pub const ISM_VFIO_PCI_OFFSET_SHIFT: c_int = 48;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ism_vfio_pci_core_device {
    pub core_device: vfio_pci_core_device,
    pub store_block_cache: *mut kmem_cache,
}

#[no_mangle]
unsafe extern "C" fn ism_vfio_pci_open_device(core_vdev: *mut vfio_device) -> c_int {
...
//
    ...
    bool iswrite)
    {
    let mut bar: c_int = ISM_VFIO_PCI_OFFSET_TO_INDEX(*ppos);
    let mut pos: loff_t = *ppos & ISM_VFIO_PCI_OFFSET_MASK;
    resource_size_t end;
    let mut done: isize = 0;
...
// ppos += done;
    ...
    {
    let mut index: c_uint = ISM_VFIO_PCI_OFFSET_TO_INDEX(*ppos);
    struct vfio_pci_core_device *vdev;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ism_vfio_pci_init_dev(core_vdev: *mut vfio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ism_vfio_pci_release_dev(core_vdev: *mut vfio_device) {
...
#[no_mangle]
unsafe extern "C" fn ism_vfio_pci_remove(pdev: *mut pci_dev) {
