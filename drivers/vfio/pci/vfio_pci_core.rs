...
//! Source: drivers/vfio/pci/vfio_pci_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_eventfd_rcu_free(rcu: *mut rcu_head) {
    ...
    {
    struct vfio_pci_eventfd *new = core::ptr::null_mut();
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vfio_pci_dummy_resource {
    pub resource: resource,
    pub index: c_int,
    pub res_next: list_head,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vfio_pci_vf_token {
    pub lock: mutex,
    pub uuid: uuid_t,
    pub users: c_int,
}
...
#[no_mangle]
pub unsafe extern "C" fn vfio_vga_disabled(vdev: *mut vfio_pci_core_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_core_debugfs_nointxmask(seq: *mut seq_file, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vfio_pci_core_debugfs_init(vdev: *mut vfio_pci_core_device) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_core_debugfs_init(vdev: *mut vfio_pci_core_device) {
...
//
#[no_mangle]
unsafe extern "C" fn vfio_pci_set_decode(pdev: *mut pci_dev, single_vga: bool) -> c_uint {
    ...
    while ((tmp = pci_get_class(PCI_CLASS_DISPLAY_VGA << 8, tmp)) != core::ptr::null_mut()) {
    if (tmp == pdev ||
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_probe_mmaps(vdev: *mut vfio_pci_core_device) {
    ...
    let mut bar: c_int = i + PCI_STD_RESOURCES;
...
//
    ...
    if (dummy_res == core::ptr::null_mut())
    goto no_mmap;
...
//
#[no_mangle]
unsafe extern "C" fn vfio_pci_nointx(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_probe_power_state(vdev: *mut vfio_pci_core_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_set_power_state(vdev: *mut vfio_pci_core_device, state: pci_power_t) -> c_int {
    int vfio_pci_set_power_state(struct vfio_pci_core_device *vdev, pci_power_t state)
    {
    struct pci_dev *pdev = vdev.pdev;
    let mut needs_restore: bool = false, needs_save = false;
    int ret;
...
//
    return vfio_pci_runtime_pm_entry(vdev, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn __vfio_pci_runtime_pm_exit(vdev: *mut vfio_pci_core_device) {
    ...
    vdev.pm_wake_eventfd_ctx = core::ptr::null_mut();
    }
    }
    }
#[no_mangle]
unsafe extern "C" fn vfio_pci_runtime_pm_exit(vdev: *mut vfio_pci_core_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_core_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_core_runtime_resume(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vfio_pci_core_map_bars(vdev: *mut vfio_pci_core_device) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_core_enable(vdev: *mut vfio_pci_core_device) -> c_int {
...
// If reset fails because of the device lock, fail this path entirely
    ...
    vdev.pci_saved_state = core::ptr::null_mut();
    out_disable_device:
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_core_disable(vdev: *mut vfio_pci_core_device) {
...
// Stop the device from further DMA
    ...
    vdev.irq_type, 0, 0, core::ptr::null_mut());
// Device closed, don't need mutex here
    ...
    vdev.num_regions = 0;
    kfree(vdev.region);
    vdev.region = core::ptr::null_mut(); /* don't krealloc a freed pointer */
    ...
    pci_release_selected_regions(pdev, 1 << bar);
    vdev.barmap[bar] = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_core_close_device(core_vdev: *mut vfio_device) {
    ...
    vfio_pci_eventfd_replace_locked(vdev, &vdev.err_trigger, core::ptr::null_mut());
    vfio_pci_eventfd_replace_locked(vdev, &vdev.req_trigger, core::ptr::null_mut());
    mutex_unlock(&vdev.igate);
    }
    EXPORT_SYMBOL_GPL(vfio_pci_core_close_device);
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_core_finish_enable(vdev: *mut vfio_pci_core_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_get_irq_count(vdev: *mut vfio_pci_core_device, irq_type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_count_devs(pdev: *mut pci_dev, data: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vfio_pci_fill_info {
    pub vdev: *mut vfio_device,
    pub devices: *mut vfio_pci_dependent_device,
    pub nr_devices: c_int,
    pub count: u32,
    pub flags: u32,
}

#[no_mangle]
unsafe extern "C" fn vfio_pci_fill_devs(pdev: *mut pci_dev, data: *mut c_void) -> c_int {
...
//
    ...
    let mut id: c_int = vfio_iommufd_get_dev_id(vdev, iommufd);
    if (id > 0)
    info.devid = id;
#[no_mangle]
pub unsafe extern "C" fn if(-ENOENT: id ==) -> else {
    else if (id == -ENOENT)
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vfio_pci_group_info {
    pub count: c_int,
    pub files: *mut file,
}

#[no_mangle]
unsafe extern "C" fn vfio_pci_dev_below_slot(pdev: *mut pci_dev, slot: *mut pci_slot) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vfio_pci_walk_info {
    pub data): *mut *mut *mut int (fn)(struct pci_dev pdev, void,
    pub data: *mut c_void,
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_walk_wrapper(pdev: *mut pci_dev, data: *mut c_void) -> c_int {
    ...
    {
    let mut minsz: c_ulong = offsetofend(struct vfio_device_info, num_irqs);
    let mut info: vfio_device_info = {};
    let mut caps: vfio_info_cap = { .buf = core::ptr::null_mut(), .size = 0 };
    int ret;
...
// Report BAR size as power of two.
    ...
    {
    let mut minsz: c_ulong = offsetofend(struct vfio_irq_info, count);
...
#[no_mangle]
pub unsafe extern "C" fn if(!vdev->has_dyn_msix: info.index != VFIO_PCI_MSIX_IRQ_INDEX ||) -> else {
    ...
    {
    let mut minsz: c_ulong = offsetofend(struct vfio_irq_set, count);
...
//
    ...
    struct vfio_pci_dependent_device *devices = core::ptr::null_mut();
    struct vfio_pci_hot_reset_info hdr;
    let mut fill: vfio_pci_fill_info = {};
...
// Can we do a slot or bus reset or neither?
    ...
    slot = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pci_probe_reset_bus(vdev->pdev->bus)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn sizeof(_arg: *mut group_fds))) -> *mut array_count {
    kfree(group_fds);
    kfree(files);
    return -EFAULT;
    }
...
// release reference to groups on error
    ...
    info.files = files;
    ret = vfio_pci_dev_set_hot_reset(vdev.vdev.dev_set, &info, core::ptr::null_mut());
    hot_reset_release:
    ...
    struct vfio_pci_hot_reset __user *arg)
    {
    let mut minsz: c_ulong = offsetofend(struct vfio_pci_hot_reset, count);
...
pub unsafe extern "C" fn if(_arg: pci_probe_reset_bus(vdev->pdev->bus)) -> else {
    ...
    return vfio_pci_dev_set_hot_reset(vdev.vdev.dev_set, core::ptr::null_mut(),
    vfio_iommufd_device_ictx(&vdev.vdev));
    }
    static int vfio_pci_ioctl_ioeventfd(struct vfio_pci_core_device *vdev,
    struct vfio_device_ioeventfd __user *arg)
    {
    let mut minsz: c_ulong = offsetofend(struct vfio_device_ioeventfd, fd);
...
//
    ...
    {
    let mut index: c_uint = VFIO_PCI_OFFSET_TO_INDEX(*ppos);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_zap_bars(vdev: *mut vfio_pci_core_device) {
    static void vfio_pci_zap_bars(struct vfio_pci_core_device *vdev)
    {
    struct vfio_device *core_vdev = &vdev.vdev;
    let mut start: loff_t = VFIO_PCI_INDEX_TO_OFFSET(VFIO_PCI_BAR0_REGION_INDEX);
    let mut end: loff_t = VFIO_PCI_INDEX_TO_OFFSET(VFIO_PCI_ROM_REGION_INDEX);
    let mut len: loff_t = end - start;
    unmap_mapping_range(core_vdev.inode.i_mapping, start, len, true);
    }
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_zap_and_down_write_memory_lock(vdev: *mut vfio_pci_core_device) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_memory_lock_and_enable(vdev: *mut vfio_pci_core_device) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_memory_unlock_and_restore(vdev: *mut vfio_pci_core_device, cmd: u16) {
...
#[no_mangle]
unsafe extern "C" fn vma_to_pfn(vma: *mut vm_area_struct) -> c_ulong {
    static unsigned long vma_to_pfn(struct vm_area_struct *vma)
    {
    struct vfio_pci_core_device *vdev = vma.vm_private_data;
    let mut index: c_int = vma.vm_pgoff >> (VFIO_PCI_OFFSET_SHIFT - PAGE_SHIFT);
    u64 pgoff;
    pgoff = vma.vm_pgoff &
    ...
    struct vfio_pci_core_device *vdev = vma.vm_private_data;
    let mut addr: c_ulong = vmf.address & ~((PAGE_SIZE << order) - 1);
    let mut pgoff: c_ulong = linear_page_delta(vma, addr);
    let mut pfn: c_ulong = vma_to_pfn(vma) + pgoff;
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_mmap_page_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_core_mmap(core_vdev: *mut vfio_device, vma: *mut vm_area_struct) -> c_int {
    ...
    let mut regnum: c_int = index - VFIO_PCI_NUM_REGIONS;
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_core_request(core_vdev: *mut vfio_device, count: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_core_match(core_vdev: *mut vfio_device, buf: *mut c_char) -> c_int {
    int vfio_pci_core_match(struct vfio_device *core_vdev, char *buf)
    {
    struct vfio_pci_core_device *vdev =
    container_of(core_vdev, struct vfio_pci_core_device, vdev);
    let mut vf_token: bool = false;
    uuid_t uuid;
    int ret;
...
// Unknown/duplicate option
    ...
    vf_token ? &uuid : core::ptr::null_mut());
    if (ret)
    return ret;
    return 1; /* Match */
    }
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_vf_init(vdev: *mut vfio_pci_core_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_vf_uninit(vdev: *mut vfio_pci_core_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_vga_init(vdev: *mut vfio_pci_core_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_vga_uninit(vdev: *mut vfio_pci_core_device) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_core_init_dev(core_vdev: *mut vfio_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_core_release_dev(core_vdev: *mut vfio_device) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_core_register_device(vdev: *mut vfio_pci_core_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_core_unregister_device(vdev: *mut vfio_pci_core_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_is_device_in_set(pdev: *mut pci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_dev_set_pm_runtime_get(dev_set: *mut vfio_device_set) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_dev_set_needs_reset(dev_set: *mut vfio_device_set) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn vfio_pci_dev_set_try_reset(dev_set: *mut vfio_device_set) {
    static void vfio_pci_dev_set_try_reset(struct vfio_device_set *dev_set)
    {
    struct vfio_pci_core_device *cur;
    struct pci_dev *pdev;
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_core_cleanup() {
    static void vfio_pci_core_cleanup(void)
    {
    vfio_pci_uninit_perm_bits();
    }
#[no_mangle]
unsafe extern "C" fn vfio_pci_core_init() -> int __init {
