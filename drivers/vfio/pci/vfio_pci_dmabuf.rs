...
//! Source: drivers/vfio/pci/vfio_pci_dmabuf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_dma_buf_done(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn vfio_pci_dma_buf_release(dmabuf: *mut dma_buf) {
...
// provider = pcim_p2pdma_provider(pdev, region_index);
    ...
    let mut offset: u64 = dma_ranges[i].offset;
    let mut len: u64 = dma_ranges[i].length;
...
// lengthp = length;
    ...
    size_t argsz)
    {
    let mut get_dma_buf: vfio_device_feature_dma_buf = {};
    struct vfio_region_dma_range *dma_ranges;
...
// dma_buf_put() now frees priv
    ...
    dma_resv_lock(priv.dmabuf.resv, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_dma_buf_move(vdev: *mut vfio_pci_core_device, revoked: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_dma_buf_cleanup(vdev: *mut vfio_pci_core_device) {
