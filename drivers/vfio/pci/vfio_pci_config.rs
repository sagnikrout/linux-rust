...
//! Source: drivers/vfio/pci/vfio_pci_config.c
#![no_std]
...
pub const PCI_CAP_ID_BASIC: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct perm_bits {
    pub /: *mut *mut *mut u8 virt; / read/write virtual data, not hw,
    pub /: *mut *mut *mut u8 write; / writeable bits,
    int	(*readfn)(struct vfio_pci_core_device *vdev, int pos, int count,
    pub val): *mut *mut perm_bits perm, int offset, __le32,
    int	(*writefn)(struct vfio_pci_core_device *vdev, int pos, int count,
    pub val): *mut *mut perm_bits perm, int offset, __le32,
}

pub const NO_VIRT: c_int = 0;
pub const ALL_VIRT: c_uint = 0xFFFFFFFFU;
pub const NO_WRITE: c_int = 0;
pub const ALL_WRITE: c_uint = 0xFFFFFFFFU;
...
// val = cpu_to_le32(tmp_val);
    ...
    {
    let mut ret: c_int = -EINVAL;
    let mut tmp_val: u32 = le32_to_cpu(val);
    switch (count) {
    case 1:
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_CAP_LIST_NEXT: offset ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn free_perm_bits(perm: *mut perm_bits) {
    static void free_perm_bits(struct perm_bits *perm)
    {
    kfree(perm.virt);
    kfree(perm.write);
    perm.virt = core::ptr::null_mut();
    perm.write = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn alloc_perm_bits(perm: *mut perm_bits, size: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn p_setb(p: *mut perm_bits, off: c_int, virt: u8, write: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn p_setw(p: *mut perm_bits, off: c_int, virt: u16, write: u16) {
...
// Handle endian-ness - pci and tables are little-endian
#[no_mangle]
pub unsafe extern "C" fn p_setd(p: *mut perm_bits, off: c_int, virt: u32, write: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn __vfio_pci_memory_enabled(vdev: *mut vfio_pci_core_device) -> bool {
    bool __vfio_pci_memory_enabled(struct vfio_pci_core_device *vdev)
    {
    struct pci_dev *pdev = vdev.pdev;
    let mut cmd: u16 = le16_to_cpu(*(__le16 *)&vdev.vconfig[PCI_COMMAND]);
//
...
//
#[no_mangle]
unsafe extern "C" fn vfio_bar_restore(vdev: *mut vfio_pci_core_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_generate_bar_flags(pdev: *mut pci_dev, bar: c_int) -> __le32 {
    static __le32 vfio_generate_bar_flags(struct pci_dev *pdev, int bar)
    {
    let mut flags: c_ulong = pci_resource_flags(pdev, bar);
    u32 val;
...
//
#[no_mangle]
unsafe extern "C" fn vfio_bar_fixup(vdev: *mut vfio_pci_core_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_need_bar_restore(vdev: *mut vfio_pci_core_device) -> bool {
    static bool vfio_need_bar_restore(struct vfio_pci_core_device *vdev)
    {
    let mut i: c_int = 0, pos = PCI_BASE_ADDRESS_0, ret;
    u32 bar;
...
//
    if (offset == PCI_COMMAND) {
    let mut mask: u16 = PCI_COMMAND_MEMORY | PCI_COMMAND_IO;
...
#[no_mangle]
unsafe extern "C" fn init_pci_cap_basic_perm(perm: *mut perm_bits) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_pci_cap_pm_perm(perm: *mut perm_bits) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_pci_cap_vpd_perm(perm: *mut perm_bits) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_pci_cap_pcix_perm(perm: *mut perm_bits) -> int __init {
...
// Alloc 24, but only 8 are used in v0
    ...
    let mut readrq: c_int = le16_to_cpu(*ctrl) & PCI_EXP_DEVCTL_READRQ;
    count = vfio_default_config_write(vdev, pos, count, perm, offset, val);
    if (count < 0)
    return count;
//
...
#[no_mangle]
unsafe extern "C" fn init_pci_cap_exp_perm(perm: *mut perm_bits) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_pci_cap_af_perm(perm: *mut perm_bits) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_pci_ext_cap_err_perm(perm: *mut perm_bits) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_pci_ext_cap_pwr_perm(perm: *mut perm_bits) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_uninit_perm_bits() {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_pci_init_perm_bits() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vfio_find_cap_start(vdev: *mut vfio_pci_core_device, pos: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn init_pci_cap_msi_perm(perm: *mut perm_bits, len: c_int, flags: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_msi_cap_len(vdev: *mut vfio_pci_core_device, pos: u8) -> c_int {
    ...
    if (ret) {
    kfree(vdev.msi_perm);
    vdev.msi_perm = core::ptr::null_mut();
    return ret;
    }
    return len;
    }
...
#[no_mangle]
unsafe extern "C" fn vfio_vc_cap_len(vdev: *mut vfio_pci_core_device, pos: u16) -> c_int {
    static int vfio_vc_cap_len(struct vfio_pci_core_device *vdev, u16 pos)
    {
    struct pci_dev *pdev = vdev.pdev;
    u32 tmp;
    int ret, evcc, phases, vc_arb;
    let mut len: c_int = PCI_CAP_VC_BASE_SIZEOF;
    ...
    phases = 128;
#[no_mangle]
pub unsafe extern "C" fn if(PCI_VC_CAP2_64_PHASE: tmp &) -> else {
    else if (tmp & PCI_VC_CAP2_64_PHASE)
    phases = 64;
#[no_mangle]
pub unsafe extern "C" fn if(PCI_VC_CAP2_32_PHASE: tmp &) -> else {
...
#[no_mangle]
unsafe extern "C" fn vfio_cap_len(vdev: *mut vfio_pci_core_device, cap: u8, pos: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_ext_cap_len(vdev: *mut vfio_pci_core_device, ecap: u16, epos: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_cap_init(vdev: *mut vfio_pci_core_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_ecap_init(vdev: *mut vfio_pci_core_device) -> c_int {
    static int vfio_ecap_init(struct vfio_pci_core_device *vdev)
    {
    struct pci_dev *pdev = vdev.pdev;
    u8 *map = vdev.pci_config_map;
    u16 epos;
    __le32 *prev = core::ptr::null_mut();
...
// If not the first in the chain, we can skip over it
    if (prev) {
    let mut val: u32 = epos = PCI_EXT_CAP_NEXT(header);
...
//
#[no_mangle]
pub unsafe extern "C" fn vfio_config_init(vdev: *mut vfio_pci_core_device) -> c_int {
...
// (__le16 *)&vconfig[PCI_COMMAND] |=
    ...
    out:
    kfree(map);
    vdev.pci_config_map = core::ptr::null_mut();
    kfree(vconfig);
    vdev.vconfig = core::ptr::null_mut();
    return pcibios_err_to_errno(ret);
    }
#[no_mangle]
pub unsafe extern "C" fn vfio_config_free(vdev: *mut vfio_pci_core_device) {
...
//
    ...
    loff_t pos)
    {
    let mut cap: u8 = vdev.pci_config_map[pos];
    size_t i;
...
// nop */;
    ...
    let mut cap_start: c_int = 0, offset;
    u8 cap_id;
    ssize_t ret;
...
//
    ...
    count = 4;
#[no_mangle]
pub unsafe extern "C" fn if(2): *mut *mut count >= 2 && !(ppos %) -> else {
