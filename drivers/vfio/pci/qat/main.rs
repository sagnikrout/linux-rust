...
//! Source: drivers/vfio/pci/qat/main.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qat_vf_migration_file {
    pub filp: *mut file,
// protects migration region context
    pub lock: mutex,
    pub disabled: bool,
    pub qat_vdev: *mut qat_vf_core_device,
    pub filled_size: isize,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qat_vf_core_device {
    pub core_device: vfio_pci_core_device,
    pub mdev: *mut qat_mig_dev,
// protects migration state
    pub state_mutex: mutex,
    pub mig_state: enum vfio_device_mig_state,
    pub resuming_migf: *mut qat_vf_migration_file,
    pub saving_migf: *mut qat_vf_migration_file,
}

#[no_mangle]
unsafe extern "C" fn qat_vf_pci_open_device(core_vdev: *mut vfio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qat_vf_disable_fd(migf: *mut qat_vf_migration_file) {
...
#[no_mangle]
unsafe extern "C" fn qat_vf_disable_fds(qat_vdev: *mut qat_vf_core_device) {
    ...
    qat_vdev.resuming_migf = core::ptr::null_mut();
    }
    if (qat_vdev.saving_migf) {
    qat_vf_disable_fd(qat_vdev.saving_migf);
    fput(qat_vdev.saving_migf.filp);
    qat_vdev.saving_migf = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn qat_vf_pci_close_device(core_vdev: *mut vfio_device) {
...
#[no_mangle]
unsafe extern "C" fn qat_vf_release_file(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qat_vf_load_device_data(qat_vdev: *mut qat_vf_core_device) -> c_int {
    ...
    {
    let mut cur: u32 = qat_vdev.mig_state;
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn qat_vf_reset_done(qat_vdev: *mut qat_vf_core_device) {
...
#[no_mangle]
unsafe extern "C" fn qat_vf_pci_release_dev(core_vdev: *mut vfio_device) {
...
#[no_mangle]
unsafe extern "C" fn qat_vf_pci_init_dev(core_vdev: *mut vfio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qat_vf_pci_aer_reset_done(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn qat_vf_vfio_pci_remove(pdev: *mut pci_dev) {
