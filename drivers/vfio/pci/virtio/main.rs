...
//! Source: drivers/vfio/pci/virtio/main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn virtiovf_pci_open_device(core_vdev: *mut vfio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtiovf_pci_close_device(core_vdev: *mut vfio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtiovf_pci_init_device(core_vdev: *mut vfio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtiovf_pci_core_release_dev(core_vdev: *mut vfio_device) {
    ...
    let mut sup_legacy_io: bool = false;
    let mut sup_lm: bool = false;
    int ret;
    if (pdev.is_virtfn) {
...
#[no_mangle]
unsafe extern "C" fn virtiovf_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn virtiovf_pci_aer_reset_done(pdev: *mut pci_dev) {
