...
//! Source: drivers/vfio/pci/virtio/migrate.c
#![no_std]
...
// All accesses are sequential
    ...
    unsigned int npages)
    {
    let mut to_alloc: c_uint = npages;
...
#[no_mangle]
unsafe extern "C" fn virtiovf_free_data_buffer(buf: *mut virtiovf_data_buffer) {
...
#[no_mangle]
unsafe extern "C" fn virtiovf_put_data_buffer(buf: *mut virtiovf_data_buffer) {
...
#[no_mangle]
unsafe extern "C" fn virtiovf_clean_migf_resources(migf: *mut virtiovf_migration_file) {
    ...
    migf.buf = core::ptr::null_mut();
    }
    if (migf.buf_header) {
    virtiovf_free_data_buffer(migf.buf_header);
    migf.buf_header = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn virtiovf_disable_fd(migf: *mut virtiovf_migration_file) {
...
#[no_mangle]
unsafe extern "C" fn virtiovf_disable_fds(virtvdev: *mut virtiovf_pci_core_device) {
    ...
    virtvdev.resuming_migf = core::ptr::null_mut();
    }
    ...
    virtvdev.saving_migf = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn virtiovf_state_mutex_unlock(virtvdev: *mut virtiovf_pci_core_device) {
...
#[no_mangle]
pub unsafe extern "C" fn virtiovf_migration_reset_done(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn virtiovf_release_file(inode: *mut inode, filp: *mut file) -> c_int {
...
// Temporary end of file as part of PRE_COPY
    ...
    let mut end_of_data: bool = false;
    let mut ctx_size: u32 = 0;
    int ret;
...
//
    ...
    let mut header: virtiovf_migration_header = {};
    struct page *page;
    u8 *to_buff;
...
//
#[no_mangle]
unsafe extern "C" fn virtiovf_set_obj_cmd_header(vhca_buf: *mut virtiovf_data_buffer) -> c_int {
    static int virtiovf_set_obj_cmd_header(struct virtiovf_data_buffer *vhca_buf)
    {
    let mut obj_hdr: virtio_admin_cmd_resource_obj_cmd_hdr = {};
    struct page *page;
    u8 *to_buff;
...
// Mark as having a valid obj id which can be even 0
    ...
    u32 new)
    {
    let mut cur: u32 = virtvdev.mig_state;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn virtiovf_set_migratable(virtvdev: *mut virtiovf_pci_core_device) {
...
#[no_mangle]
pub unsafe extern "C" fn virtiovf_open_migration(virtvdev: *mut virtiovf_pci_core_device) {
...
#[no_mangle]
pub unsafe extern "C" fn virtiovf_close_migration(virtvdev: *mut virtiovf_pci_core_device) {
