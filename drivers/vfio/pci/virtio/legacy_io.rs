...
//! Source: drivers/vfio/pci/virtio/legacy_io.c
#![no_std]
...
// Transional needs to have revision 0
    ...
    &copy_count, &register_offset)) {
    let mut bar_mask: u32 = ~(virtvdev.bar0_virtual_buf_size - 1);
    let mut pci_base_addr_0: u32 = le32_to_cpu(virtvdev.pci_base_addr_0);
...
#[no_mangle]
unsafe extern "C" fn virtiovf_set_notify_addr(virtvdev: *mut virtiovf_pci_core_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn virtiovf_open_legacy_io(virtvdev: *mut virtiovf_pci_core_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtiovf_get_device_config_size(device: c_ushort) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtiovf_read_notify_info(virtvdev: *mut virtiovf_pci_core_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtiovf_bar0_exists(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn virtiovf_support_legacy_io(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn virtiovf_init_legacy_io(virtvdev: *mut virtiovf_pci_core_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn virtiovf_release_legacy_io(virtvdev: *mut virtiovf_pci_core_device) {
    void virtiovf_release_legacy_io(struct virtiovf_pci_core_device *virtvdev)
    {
    kfree(virtvdev.bar0_virtual_buf);
    }
#[no_mangle]
pub unsafe extern "C" fn virtiovf_legacy_io_reset_done(pdev: *mut pci_dev) {
