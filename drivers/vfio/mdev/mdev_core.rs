...
//! Source: drivers/vfio/mdev/mdev_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mdev_device_remove_common(mdev: *mut mdev_device) {
...
#[no_mangle]
unsafe extern "C" fn mdev_device_remove_cb(dev: *mut device, data: *mut c_void) -> c_int {
...
//
    ...
    char *envp[] = { env_string, core::ptr::null_mut() };
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn mdev_unregister_parent(parent: *mut mdev_parent) {
    ...
    device_for_each_child(parent.dev, core::ptr::null_mut(), mdev_device_remove_cb);
...
#[no_mangle]
unsafe extern "C" fn mdev_device_release(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn mdev_device_create(type: *mut mdev_type, uuid: *const guid_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mdev_device_remove(mdev: *mut mdev_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdev_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mdev_exit() -> void __exit {
