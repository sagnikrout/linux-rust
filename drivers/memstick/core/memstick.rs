...
//! Source: drivers/memstick/core/memstick.c
#![no_std]
...
//
    ...
    let mut cmd_retries: static unsigned int = 3;
...
#[no_mangle]
unsafe extern "C" fn memstick_bus_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn memstick_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn memstick_device_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn memstick_device_remove(dev: *mut device) {
    ...
    drv.remove(card);
    card.dev.driver = core::ptr::null_mut();
    }
    put_device(dev);
    }

#[no_mangle]
unsafe extern "C" fn memstick_device_suspend(dev: *mut device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn memstick_device_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn memstick_free(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn memstick_free_card(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn memstick_dummy_check(card: *mut memstick_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn memstick_detect_change(host: *mut memstick_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn memstick_next_req(host: *mut memstick_host, mrq: *mut memstick_request) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn memstick_new_req(host: *mut memstick_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn memstick_set_rw_addr(card: *mut memstick_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn memstick_power_on(host: *mut memstick_host) -> c_int {
    static int memstick_power_on(struct memstick_host *host)
    {
    let mut rc: c_int = host.set_param(host, MEMSTICK_POWER, MEMSTICK_POWER_ON);
    if (!rc)
    rc = host.set_param(host, MEMSTICK_INTERFACE, MEMSTICK_SERIAL);
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn memstick_check(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn memstick_add_host(host: *mut memstick_host) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn memstick_remove_host(host: *mut memstick_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn memstick_free_host(host: *mut memstick_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn memstick_suspend_host(host: *mut memstick_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn memstick_resume_host(host: *mut memstick_host) {
...
#[no_mangle]
pub unsafe extern "C" fn memstick_register_driver(drv: *mut memstick_driver) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn memstick_unregister_driver(drv: *mut memstick_driver) {
...
#[no_mangle]
unsafe extern "C" fn memstick_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn memstick_exit() -> void __exit {
