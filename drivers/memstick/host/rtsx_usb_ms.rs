...
//! Source: drivers/memstick/host/rtsx_usb_ms.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ms_clear_error(host: *mut rtsx_usb_ms) {
...
#[no_mangle]
unsafe extern "C" fn ms_print_debug_regs(host: *mut rtsx_usb_ms) {
...
#[no_mangle]
unsafe extern "C" fn ms_pull_ctl_disable_lqfp48(ucr: *mut rtsx_ucr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ms_pull_ctl_disable_qfn24(ucr: *mut rtsx_ucr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ms_pull_ctl_enable_lqfp48(ucr: *mut rtsx_ucr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ms_pull_ctl_enable_qfn24(ucr: *mut rtsx_ucr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ms_power_on(host: *mut rtsx_usb_ms) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ms_power_off(host: *mut rtsx_usb_ms) -> c_int {
    ...
    struct rtsx_ucr *ucr = host.ucr;
    int err;
    let mut length: c_uint = sg.length;
    let mut sec_cnt: u16 = (u16)(length / 512);
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_ms_issue_cmd(host: *mut rtsx_usb_ms) -> c_int {
    static int rtsx_usb_ms_issue_cmd(struct rtsx_usb_ms *host)
    {
    struct memstick_request *req = host.req;
    let mut err: c_int = 0;
    let mut cfg: u8 = 0, int_reg;
    dev_dbg(ms_dev(host), "%s\n", __func__);
    ...
    NO_WAIT_INT, 1, &req.int_reg, core::ptr::null_mut());
    if (err < 0)
    return err;
    } else {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_ms_handle_req(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_ms_request(msh: *mut memstick_host) {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_ms_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_ms_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_ms_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_ms_runtime_resume(dev: *mut device) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(rtsx_usb_ms_runtime_suspend, rtsx_usb_ms_runtime_resume, core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn rtsx_usb_ms_poll_card(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_ms_drv_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_ms_drv_remove(pdev: *mut platform_device) {
