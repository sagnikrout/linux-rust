...
//! Source: drivers/thermal/renesas/rzg3e_thermal.c
#![no_std]
...
pub const TSU_SSUSR: c_uint = 0x00;

pub const TSU_STRGR: c_uint = 0x04;

pub const TSU_SOSR1: c_uint = 0x08;
pub const TSU_SOSR1_ADCT_8: c_uint = 0x03;

pub const TSU_SCRR: c_uint = 0x10;

pub const TSU_SSR: c_uint = 0x14;

pub const TSU_CMSR: c_uint = 0x18;

pub const TSU_LLSR: c_uint = 0x1C;
pub const TSU_ULSR: c_uint = 0x20;
pub const TSU_SISR: c_uint = 0x30;

pub const TSU_SIER: c_uint = 0x34;

pub const TSU_SICR: c_uint = 0x38;

// Temperature calculation constants from datasheet
pub const TSU_CODE_MAX: c_uint = 0xFFF;
// Timing specifications from datasheet

pub const RZ_SIP_SVC_GET_SYSTSU: c_uint = 0x82000022;
pub const OTP_TSU_REG_ADR_TEMPHI: c_uint = 0x01DC;
pub const OTP_TSU_REG_ADR_TEMPLO: c_uint = 0x01DD;
    struct rzg3e_thermal_priv;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg3e_thermal_info {
    pub priv): *mut *mut int (get_trim)(struct rzg3e_thermal_priv,
    pub temp_d_mc: c_int,
    pub temp_e_mc: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn rzg3e_thermal_power_on(priv: *mut rzg3e_thermal_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3e_thermal_power_off(priv: *mut rzg3e_thermal_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn rzg3e_thermal_code_to_temp(priv: *mut rzg3e_thermal_priv, code: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rzg3e_thermal_temp_to_code(priv: *mut rzg3e_thermal_priv, temp_mc: c_int) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn rzg3e_thermal_get_temp(tz: *mut thermal_zone_device, temp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3e_thermal_irq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rzg3e_thermal_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rzg3e_thermal_get_syscon_trim(priv: *mut rzg3e_thermal_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3e_thermal_get_smc_trim(priv: *mut rzg3e_thermal_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3e_thermal_probe(pdev: *mut platform_device) -> c_int {
...
// Get clock to verify frequency - clock is managed by power domain
    ...
    priv.rstc = devm_reset_control_get_optional_exclusive_deasserted(dev, core::ptr::null_mut());
    if (IS_ERR(priv.rstc))
...
#[no_mangle]
unsafe extern "C" fn rzg3e_thermal_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3e_thermal_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3e_thermal_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3e_thermal_resume(dev: *mut device) -> c_int {
...
// If device was active before suspend, power it back on
    ...
    rzg3e_thermal_runtime_resume, core::ptr::null_mut())
