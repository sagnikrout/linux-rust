...
//! Source: drivers/thermal/gov_power_allocator.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn mul_frac(x: i64, y: i64) -> i64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn div_frac(x: i64, y: i64) -> i64 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct power_actor {
    pub req_power: u32,
    pub max_power: u32,
    pub granted_power: u32,
    pub extra_actor_power: u32,
    pub weighted_req_power: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct power_allocator_params {
    pub allocated_tzp: bool,
    pub update_cdevs: bool,
    pub err_integral: i64,
    pub prev_err: i32,
    pub sustainable_power: u32,
    pub trip_switch_on: *const thermal_trip,
    pub trip_max: *const thermal_trip,
    pub total_weight: c_int,
    pub num_actors: c_uint,
    pub buffer_size: c_uint,
    pub power: *mut power_actor,
}

#[no_mangle]
unsafe extern "C" fn power_actor_is_valid(instance: *mut thermal_instance) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn estimate_sustainable_power(tz: *mut thermal_zone_device) -> u32 {
    ...
    let mut sustainable_power: u32 = 0;
    u32 min_power;
...
//
    ...
    int control_temp)
    {
    let mut temperature_threshold: u32 = control_temp;
    s32 k_i;
    if (trip_switch_on)
...
//
    ...
    let mut i_next: i64 = i + mul_frac(tz.tzp.k_i, err);
...
//
    ...
    {
    let mut capped_extra_power: u32 = 0;
    let mut extra_power: u32 = 0;
    int i;
    if (!total_req_power) {
//
...
//
    ...
    for (i = 0; i < num_actors; i++) {
    struct power_actor *pa = &power[i];
    let mut req_range: u64 = (u64)pa.weighted_req_power * power_range;
...
//
    ...
    for (i = 0; i < num_actors; i++) {
    struct power_actor *pa = &power[i];
    let mut extra_range: u64 = pa.extra_actor_power;
...
#[no_mangle]
unsafe extern "C" fn allocate_power(tz: *mut thermal_zone_device, control_temp: c_int) {
    static void allocate_power(struct thermal_zone_device *tz, int control_temp)
    {
    struct power_allocator_params *params = tz.governor_data;
    const struct thermal_trip_desc *td = trip_to_trip_desc(params.trip_max);
    let mut num_actors: c_uint = params.num_actors;
    struct power_actor *power = params.power;
    struct thermal_cooling_device *cdev;
    struct thermal_instance *instance;
    let mut total_weighted_req_power: u32 = 0;
    let mut max_allocatable_power: u32 = 0;
    let mut total_granted_power: u32 = 0;
    let mut total_req_power: u32 = 0;
...
//
    ...
    struct power_allocator_params *params)
    {
    const struct thermal_trip *first_passive = core::ptr::null_mut();
    const struct thermal_trip *last_passive = core::ptr::null_mut();
    const struct thermal_trip *last_active = core::ptr::null_mut();
    ...
    params.trip_switch_on = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn reset_pid_controller(params: *mut power_allocator_params) {
...
#[no_mangle]
unsafe extern "C" fn allow_maximum_power(tz: *mut thermal_zone_device) {
...
// There might be no cooling devices yet.
    ...
    params.power = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn power_allocator_update_weight(params: *mut power_allocator_params) {
...
//
#[no_mangle]
unsafe extern "C" fn power_allocator_bind(tz: *mut thermal_zone_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power_allocator_unbind(tz: *mut thermal_zone_device) {
...
#[no_mangle]
unsafe extern "C" fn power_allocator_manage(tz: *mut thermal_zone_device) {
