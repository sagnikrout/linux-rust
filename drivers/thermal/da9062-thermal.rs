...
//! Source: drivers/thermal/da9062-thermal.c
#![no_std]
...
// application.
//
pub const DA9062_DEFAULT_POLLING_MS_PERIOD: c_int = 3000;
pub const DA9062_MAX_POLLING_MS_PERIOD: c_int = 10000;
pub const DA9062_MIN_POLLING_MS_PERIOD: c_int = 1000;

    let mut pp_tmp: static unsigned int = DA9062_DEFAULT_POLLING_MS_PERIOD;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9062_thermal_config {
    pub name: *const c_char,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9062_thermal {
    pub hw: *mut da9062,
    pub work: delayed_work,
    pub zone: *mut thermal_zone_device,
    pub /: *mut *mut mutex lock; / protection for da9062_thermal temperature,
    pub temperature: c_int,
    pub irq: c_int,
    pub config: *const da9062_thermal_config,
    pub dev: *mut device,
}

#[no_mangle]
unsafe extern "C" fn da9062_thermal_poll_on(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn da9062_thermal_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn da9062_thermal_probe(pdev: *mut platform_device) -> c_int {
    ...
    &da9062_thermal_ops, core::ptr::null_mut(), pp_tmp,
    0);
    ...
    goto err_zone;
    thermal.irq = ret;
    ret = request_threaded_irq(thermal.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn da9062_thermal_remove(pdev: *mut platform_device) {
