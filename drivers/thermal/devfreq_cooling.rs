...
//! Source: drivers/thermal/devfreq_cooling.c
#![no_std]
...
pub const SCALE_ERROR_MITIGATION: c_int = 100;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct devfreq_cooling_device {
    pub cdev: *mut thermal_cooling_device,
    pub cooling_ops: thermal_cooling_device_ops,
    pub devfreq: *mut devfreq,
    pub cooling_state: c_ulong,
    pub freq_table: *mut u32,
    pub max_state: usize,
    pub power_ops: *mut devfreq_cooling_power,
    pub res_util: u32,
    pub capped_state: c_int,
    pub req_max_freq: dev_pm_qos_request,
...
//
#[no_mangle]
unsafe extern "C" fn get_perf_idx(em_pd: *mut em_perf_domain, freq: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_voltage(df: *mut devfreq, freq: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn _normalize_load(status: *mut devfreq_dev_status) {
...
//
    ...
    {
    return of_devfreq_cooling_register_power(np, df, core::ptr::null_mut());
    }
...
//
    ...
    {
    return of_devfreq_cooling_register(core::ptr::null_mut(), df);
    }
...
//
    ...
    dev = df.dev.parent;
    ret = dev_pm_opp_of_register_em(dev, core::ptr::null_mut());
    if (ret)
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_cooling_unregister(cdev: *mut thermal_cooling_device) {
