...
pub const LVTS_PERIOD_UNIT: c_int = 0;
pub const LVTS_GROUP_INTERVAL: c_int = 0;
pub const LVTS_FILTER_INTERVAL: c_int = 0;
pub const LVTS_SENSOR_INTERVAL: c_int = 0;
pub const LVTS_HW_FILTER: c_uint = 0x0;
pub const LVTS_TSSEL_CONF: c_uint = 0x13121110;
pub const LVTS_CALSCALE_CONF: c_uint = 0x300;

pub const LVTS_INT_SENSOR0: c_uint = 0x0009001F;
pub const LVTS_INT_SENSOR1: c_uint = 0x001203E0;
pub const LVTS_INT_SENSOR2: c_uint = 0x00247C00;
pub const LVTS_INT_SENSOR3: c_uint = 0x1FC00000;
pub const LVTS_SENSOR_MAX: c_int = 4;
pub const LVTS_GOLDEN_TEMP_MAX: c_int = 62;
pub const LVTS_GOLDEN_TEMP_DEFAULT: c_int = 50;

pub const LVTS_COEFF_B_MT8195: c_int = 250460;

pub const LVTS_COEFF_B_MT7987: c_int = 204650;

pub const LVTS_COEFF_B_MT7988: c_int = 204650;
pub const LVTS_COEFF_A_MT8196: c_int = 391460;

pub const LVTS_MSR_READ_TIMEOUT_US: c_int = 400;

pub const LVTS_MINIMUM_THRESHOLD: c_int = 20000;
pub const LVTS_MAX_CAL_OFFSETS: c_int = 3;
pub const LVTS_NUM_CAL_OFFSETS_MT7988: c_int = 3;
pub const LVTS_NUM_CAL_OFFSETS_MT8196: c_int = 2;
    let mut golden_temp: static int = LVTS_GOLDEN_TEMP_DEFAULT;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lvts_sensor_data {
    pub dt_id: c_int,
    pub cal_offsets: [u8; LVTS_MAX_CAL_OFFSETS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lvts_ctrl_data {
    pub lvts_sensor: [lvts_sensor_data; LVTS_SENSOR_MAX],
    pub valid_sensor_mask: u8,
    pub offset: c_int,
    pub mode: enum lvts_msr_mode,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lvts_platform_ops {
    pub temp_factor): *mut *mut int (lvts_raw_to_temp)(u32 raw_temp, int,
    pub temp_factor): *mut *mut u32 (lvts_temp_to_raw)(int temperature, int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lvts_data {
    pub lvts_ctrl: *const lvts_ctrl_data,
    pub ops: *const lvts_platform_ops,
    pub conn_cmd: *const u32,
    pub init_cmd: *const u32,
    pub num_cal_offsets: c_int,
    pub num_lvts_ctrl: c_int,
    pub num_conn_cmd: c_int,
    pub num_init_cmd: c_int,
    pub temp_factor: c_int,
    pub temp_offset: c_int,
    pub gt_calib_bit_offset: c_int,
    pub def_calibration: c_uint,
    pub msr_offset: u16,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lvts_sensor {
    pub tz: *mut thermal_zone_device,
    pub msr: *mut void __iomem,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lvts_ctrl {
    pub sensors: [lvts_sensor; LVTS_SENSOR_MAX],
    pub lvts_data: *const lvts_data,
    pub calibration: [u32; LVTS_SENSOR_MAX],
    pub valid_sensor_mask: u8,
    pub mode: c_int,
    pub base: *mut void __iomem,
    pub low_thresh: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lvts_domain {
    pub lvts_ctrl: *mut lvts_ctrl,
...
#[no_mangle]
unsafe extern "C" fn lvts_debugfs_exit(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn lvts_debugfs_init(dev: *mut device, lvts_td: *mut lvts_domain) -> c_int {
    ...
    char name[64];
    int i;
    lvts_td.dom_dentry = debugfs_create_dir(dev_name(dev), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn lvts_raw_to_temp(raw_temp: u32, lvts_data: *const lvts_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lvts_temp_to_raw(temperature: c_int, lvts_data: *const lvts_data) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lvts_raw_to_temp_mt7988(raw_temp: u32, temp_factor: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lvts_temp_to_raw_mt7988(temperature: c_int, temp_factor: c_int) -> u32 {
    static u32 lvts_temp_to_raw_mt7988(int temperature, int temp_factor)
    {
    let mut raw_temp: u32 = ((s64)(golden_temp_offset - temperature)) << 14;
    raw_temp = div_s64(raw_temp, -temp_factor);
    return raw_temp;
    }
#[no_mangle]
unsafe extern "C" fn lvts_temp_to_raw_mt8196(temperature: c_int, temp_factor: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lvts_get_temp(tz: *mut thermal_zone_device, temp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lvts_update_irq_mask(lvts_ctrl: *mut lvts_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn lvts_should_update_thresh(lvts_ctrl: *mut lvts_ctrl, high: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lvts_set_trips(tz: *mut thermal_zone_device, low: c_int, high: c_int) -> c_int {
    ...
    lvts_data);
    let mut raw_high: u32 = lvts_temp_to_raw(high, lvts_data);
...
#[no_mangle]
unsafe extern "C" fn lvts_ctrl_irq_handler(lvts_ctrl: *mut lvts_ctrl) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn lvts_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    let mut dt_id: c_int = lvts_ctrl_data.lvts_sensor[i].dt_id;
//
...
//
    ...
    {
    int i;
    let mut calib_val: u32 = 0;
    for (i = 0; i < num_offsets; i++) {
    let mut offset: u8 = sensor.cal_offsets[i];
    if (offset >= calib_len)
    return -EINVAL;
...
// A zero value for gt means that device has invalid efuse data
    ...
    const struct lvts_data *lvts_data)
    {
    let mut size: usize = sizeof(*lvts_td.lvts_ctrl) * lvts_data.num_lvts_ctrl;
    struct lvts_ctrl *lvts_ctrl;
    int i, ret;
//
...
#[no_mangle]
unsafe extern "C" fn lvts_ctrl_monitor_enable(dev: *mut device, lvts_ctrl: *mut lvts_ctrl, enable: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn lvts_write_config(lvts_ctrl: *mut lvts_ctrl, cmds: *const u32, nr_cmds: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lvts_irq_init(lvts_ctrl: *mut lvts_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lvts_domain_reset(dev: *mut device, reset: *mut reset_control) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lvts_ctrl_set_enable(lvts_ctrl: *mut lvts_ctrl, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lvts_ctrl_connect(dev: *mut device, lvts_ctrl: *mut lvts_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lvts_ctrl_initialize(dev: *mut device, lvts_ctrl: *mut lvts_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lvts_ctrl_calibrate(dev: *mut device, lvts_ctrl: *mut lvts_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lvts_ctrl_configure(dev: *mut device, lvts_ctrl: *mut lvts_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lvts_ctrl_start(dev: *mut device, lvts_ctrl: *mut lvts_ctrl) -> c_int {
...
//
    ...
    lvts_for_each_valid_sensor(i, lvts_ctrl) {
    let mut dt_id: c_int = lvts_sensors[i].dt_id;
...
#[no_mangle]
unsafe extern "C" fn lvts_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (!lvts_data)
    return -ENODEV;
    lvts_td.clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
...
//
    lvts_td.reset = devm_reset_control_get_optional_exclusive(dev, core::ptr::null_mut());
...
//
    ret = devm_request_threaded_irq(dev, irq, core::ptr::null_mut(), lvts_irq_handler,
...
#[no_mangle]
unsafe extern "C" fn lvts_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn lvts_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lvts_resume(dev: *mut device) -> c_int {
