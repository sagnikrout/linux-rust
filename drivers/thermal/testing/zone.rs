...
//! Source: drivers/thermal/testing/zone.c
#![no_std]
...
pub const TT_MAX_FILE_NAME_LENGTH: c_int = 16;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tt_thermal_zone {
    pub list_node: list_head,
    pub trips: list_head,
    pub d_tt_zone: *mut dentry,
...
pub struct tt_work {
    ...
    pub tt_zone: *mut tt_thermal_zone,
    pub tt_trip: *mut tt_trip,
}
...
#[no_mangle]
unsafe extern "C" fn tt_int_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tt_int_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tt_zone_tz_temp_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tt_zone_tz_temp_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tt_zone_free_trips(tt_zone: *mut tt_thermal_zone) {
...
#[no_mangle]
unsafe extern "C" fn tt_zone_free(tt_zone: *mut tt_thermal_zone) {
...
#[no_mangle]
unsafe extern "C" fn tt_add_tz_work_fn(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn tt_add_tz() -> c_int {
    int tt_add_tz(void)
    {
    int ret;
...
#[no_mangle]
unsafe extern "C" fn tt_del_tz_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tt_zone_unregister_tz(tt_zone: *mut tt_thermal_zone) {
    static void tt_zone_unregister_tz(struct tt_thermal_zone *tt_zone)
    {
    guard(tt_zone)(tt_zone);
    if (tt_zone.tz) {
    thermal_zone_device_unregister(tt_zone.tz);
    tt_zone.tz = core::ptr::null_mut();
    }
    }
#[no_mangle]
pub unsafe extern "C" fn tt_del_tz(arg: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tt_put_tt_zone(tt_zone: *mut tt_thermal_zone) {
...
#[no_mangle]
unsafe extern "C" fn tt_zone_add_trip_work_fn(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn tt_zone_add_trip(arg: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tt_zone_get_temp(tz: *mut thermal_zone_device, temp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tt_zone_register_tz(tt_zone: *mut tt_thermal_zone) -> c_int {
    ...
    &tt_zone_ops, core::ptr::null_mut(), 0, 0);
    if (IS_ERR(tz))
    return PTR_ERR(tz);
    tt_zone.tz = tz;
...
#[no_mangle]
pub unsafe extern "C" fn tt_zone_reg(arg: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tt_zone_unreg(arg: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tt_zone_cleanup() {
