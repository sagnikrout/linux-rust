...
//! Source: drivers/thermal/testing/command.c
#![no_std]
...
pub const TT_COMMAND_SIZE: c_int = 16;
    enum tt_commands {
    TT_CMD_ADDTZ,
    TT_CMD_DELTZ,
    TT_CMD_TZADDTRIP,
...
#[no_mangle]
unsafe extern "C" fn tt_command_exec(index: c_int, arg: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tt_command_process(s: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn thermal_testing_init() -> int __init {
    ...
    if (!tt_wq)
    return -ENOMEM;
    d_testing = debugfs_create_dir("thermal-testing", core::ptr::null_mut());
    if (IS_ERR(d_testing)) {
    error = PTR_ERR(d_testing);
    goto destroy_wq;
    }
    d_command = debugfs_create_file("command", 0200, d_testing, core::ptr::null_mut(), &tt_command_fops);
    if (IS_ERR(d_command)) {
...
#[no_mangle]
unsafe extern "C" fn thermal_testing_exit() -> void __exit {
