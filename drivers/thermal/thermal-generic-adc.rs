...
//! Source: drivers/thermal/thermal-generic-adc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gadc_thermal_info {
    pub dev: *mut device,
    pub tz_dev: *mut thermal_zone_device,
    pub channel: *mut iio_channel,
    pub lookup_table: *mut i32,
    pub nlookup_table: c_int,
}

#[no_mangle]
unsafe extern "C" fn gadc_thermal_adc_to_temp(gti: *mut gadc_thermal_info, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gadc_thermal_get_temp(tz: *mut thermal_zone_device, temp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gadc_iio_register(dev: *mut device, gti: *mut gadc_thermal_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gadc_thermal_probe(pdev: *mut platform_device) -> c_int {
