...
//! Source: drivers/thermal/cpuidle_cooling.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpuidle_cooling_device {
    pub ii_dev: *mut idle_inject_device,
    pub state: c_ulong,
}
...
//
    ...
    let mut current_state: c_ulong = idle_cdev.state;
...
//
    ...
    struct device *dev;
    let mut idle_duration_us: c_uint = TICK_USEC;
    let mut latency_us: c_uint = UINT_MAX;
    char *name;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn cpuidle_cooling_register(drv: *mut cpuidle_driver) {
