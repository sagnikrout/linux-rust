...
//! Source: drivers/thermal/cpufreq_cooling.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpufreq_cooling_device {
    pub last_load: u32,
    pub cpufreq_state: c_uint,
    pub max_level: c_uint,
    pub em: *mut em_perf_domain,
    pub policy: *mut cpufreq_policy,
    pub cooling_ops: thermal_cooling_device_ops,

    pub idle_time: *mut time_in_idle,
...
//
    ...
    int cpu_idx)
    {
    let mut util: c_ulong = sched_cpu_util(cpu);
...
#[no_mangle]
pub unsafe extern "C" fn allocate_idle_time(cpufreq_cdev: *mut cpufreq_cooling_device) -> c_int {
    static inline int allocate_idle_time(struct cpufreq_cooling_device *cpufreq_cdev)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn free_idle_time(cpufreq_cdev: *mut cpufreq_cooling_device) {
    static inline void free_idle_time(struct cpufreq_cooling_device *cpufreq_cdev)
    {
    }

#[no_mangle]
unsafe extern "C" fn allocate_idle_time(cpufreq_cdev: *mut cpufreq_cooling_device) -> c_int {
    static int allocate_idle_time(struct cpufreq_cooling_device *cpufreq_cdev)
    {
    let mut num_cpus: c_uint = cpumask_weight(cpufreq_cdev.policy.related_cpus);
...
#[no_mangle]
unsafe extern "C" fn free_idle_time(cpufreq_cdev: *mut cpufreq_cooling_device) {
    static void free_idle_time(struct cpufreq_cooling_device *cpufreq_cdev)
    {
    kfree(cpufreq_cdev.idle_time);
    cpufreq_cdev.idle_time = core::ptr::null_mut();
    }
...
//
    ...
    {
    return __cpufreq_cooling_register(core::ptr::null_mut(), policy, core::ptr::null_mut());
    }
...
//
    ...
    {
    struct device_node *np = of_get_cpu_node(policy.cpu, core::ptr::null_mut());
    struct thermal_cooling_device *cdev = core::ptr::null_mut();
    if (!np) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_cooling_unregister(cdev: *mut thermal_cooling_device) {
