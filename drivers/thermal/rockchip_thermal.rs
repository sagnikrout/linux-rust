...
//! Source: drivers/thermal/rockchip_thermal.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct chip_tsadc_table {
    pub id: *const tsadc_table,
    pub length: c_uint,
    pub data_mask: u32,
    pub mode: enum adc_sort_mode,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_tsadc_chip {
// The sensor id of chip correspond to the ADC channel
    pub chn_offset: c_int,
    pub chn_num: c_int,
// Used to convert trim code to trim temp
    pub trim_slope: c_int,
// The hardware-controlled tshut property
    pub tshut_temp: c_int,
    pub tshut_mode: enum tshut_mode,
    pub tshut_polarity: enum tshut_polarity,
// GRF availability
    pub grf_required: bool,
// Chip-wide methods
    void (*initialize)(struct regmap *grf,
    pub p): *mut *mut void __iomem reg, enum tshut_polarity,
    pub reg): *mut *mut void (irq_ack)(void __iomem,
    pub on): *mut *mut *mut void (control)(void __iomem reg, bool,
// Per-sensor methods
    int (*get_temp)(const struct chip_tsadc_table *table,
    pub temp): *mut *mut int chn, void __iomem reg, int,
    int (*set_alarm_temp)(const struct chip_tsadc_table *table,
    pub temp): *mut *mut int chn, void __iomem reg, int,
    int (*set_tshut_temp)(const struct chip_tsadc_table *table,
    pub temp): *mut *mut int chn, void __iomem reg, int,
    pub m): *mut *mut *mut void (set_tshut_mode)(int chn, void __iomem reg, enum tshut_mode,
    int (*get_trim_code)(const struct chip_tsadc_table *table,
    pub trim_base_frac): int code, int trim_base, int,
// Per-table methods
    pub table: chip_tsadc_table,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_thermal_sensor {
    pub thermal: *mut rockchip_thermal_data,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_thermal_data {
    pub chip: *const rockchip_tsadc_chip,
    pub pdev: *mut platform_device,
    pub reset: *mut reset_control,
    pub sensors: *mut rockchip_thermal_sensor,
    pub clk: *mut clk,
    pub pclk: *mut clk,
    pub grf: *mut regmap,
    pub regs: *mut void __iomem,
    pub trim_base: c_int,
    pub trim_base_frac: c_int,
    pub trim: c_int,
    pub tshut_temp: c_int,
    pub trim_temp: c_int,
    pub tshut_mode: enum tshut_mode,
...
//
pub const TSADCV2_USER_CON: c_uint = 0x00;
pub const TSADCV2_AUTO_CON: c_uint = 0x04;
pub const TSADCV2_INT_EN: c_uint = 0x08;
pub const TSADCV2_INT_PD: c_uint = 0x0c;
pub const TSADCV3_AUTO_SRC_CON: c_uint = 0x0c;
pub const TSADCV3_HT_INT_EN: c_uint = 0x14;
pub const TSADCV3_HSHUT_GPIO_INT_EN: c_uint = 0x18;
pub const TSADCV3_HSHUT_CRU_INT_EN: c_uint = 0x1c;
pub const TSADCV3_INT_PD: c_uint = 0x24;
pub const TSADCV3_HSHUT_PD: c_uint = 0x28;

pub const TSADCV2_HIGHT_INT_DEBOUNCE: c_uint = 0x60;
pub const TSADCV2_HIGHT_TSHUT_DEBOUNCE: c_uint = 0x64;
pub const TSADCV3_HIGHT_INT_DEBOUNCE: c_uint = 0x14c;
pub const TSADCV3_HIGHT_TSHUT_DEBOUNCE: c_uint = 0x150;
pub const TSADCV2_AUTO_PERIOD: c_uint = 0x68;
pub const TSADCV2_AUTO_PERIOD_HT: c_uint = 0x6c;
pub const TSADCV3_AUTO_PERIOD: c_uint = 0x154;
pub const TSADCV3_AUTO_PERIOD_HT: c_uint = 0x158;

pub const TSADCV4_INT_PD_CLEAR_MASK: c_uint = 0xffffffff;
pub const TSADCV2_DATA_MASK: c_uint = 0xfff;
pub const TSADCV3_DATA_MASK: c_uint = 0x3ff;
pub const TSADCV4_DATA_MASK: c_uint = 0x1ff;
pub const TSADCV2_HIGHT_INT_DEBOUNCE_COUNT: c_int = 4;
pub const TSADCV2_HIGHT_TSHUT_DEBOUNCE_COUNT: c_int = 4;

pub const TSADCV2_USER_INTER_PD_SOC: c_uint = 0x340 /* 13 clocks */;
pub const TSADCV5_USER_INTER_PD_SOC: c_uint = 0xfc0 /* 97us, at least 90us */;
pub const GRF_SARADC_TESTBIT: c_uint = 0x0e644;
pub const GRF_TSADC_TESTBIT_L: c_uint = 0x0e648;
pub const GRF_TSADC_TESTBIT_H: c_uint = 0x0e64c;
pub const PX30_GRF_SOC_CON2: c_uint = 0x0408;
pub const RK3568_GRF_TSADC_CON: c_uint = 0x0600;

pub const RK3588_GRF0_TSADC_CON: c_uint = 0x0100;
...
pub struct tsadc_table {
    ...
    unsigned long num;
    unsigned int denom;
    let mut error: u32 = table.data_mask;
    low = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(table->id[mid].temp: temp <) -> else {
...
//
    ...
    u32 code, int *temp)
    {
    let mut low: c_uint = 1;
    let mut high: c_uint = table.length - 1;
    let mut mid: c_uint = (low + high) / 2;
    unsigned int num;
    unsigned long denom;
    ...
    break;
#[no_mangle]
pub unsafe extern "C" fn if(table->id[mid].code: code <) -> else {
...
#[no_mangle]
unsafe extern "C" fn rk_tsadcv2_irq_ack(regs: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn rk_tsadcv3_irq_ack(regs: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn rk_tsadcv4_irq_ack(regs: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn rk_tsadcv2_control(regs: *mut void __iomem, enable: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn rk_tsadcv3_control(regs: *mut void __iomem, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn rk_tsadcv4_control(regs: *mut void __iomem, enable: bool) {
...
// TSHUT will be valid
    ...
    {
    let mut temp: c_int = trim_base * 1000 + trim_base_frac * 100;
    let mut base_code: u32 = rk_tsadcv2_temp_to_code(table, temp);
...
#[no_mangle]
unsafe extern "C" fn rockchip_thermal_alarm_irq_thread(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rockchip_thermal_set_trips(tz: *mut thermal_zone_device, low: c_int, high: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_thermal_get_temp(tz: *mut thermal_zone_device, out_temp: *mut c_int) -> c_int {
...
// value |= (int) buf[i] << (8 * i);
    ...
    {
    const struct rockchip_tsadc_chip *tsadc = thermal.chip;
    let mut trim_base: c_int = 0, trim_base_frac = 0, trim = 0;
    int trim_code;
    int ret;
    thermal.trim_base = 0;
...
//
    ...
    let mut trim: c_int = thermal.trim;
    int trim_code, tshut_temp;
    let mut trim_temp: c_int = 0;
    int error;
...
//
#[no_mangle]
unsafe extern "C" fn rockchip_thermal_reset_controller(reset: *mut reset_control) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_thermal_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (!thermal.sensors)
    return -ENOMEM;
    thermal.regs = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
    ...
    error = devm_request_threaded_irq(&pdev.dev, irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn rockchip_thermal_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_thermal_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn rockchip_thermal_resume(dev: *mut device) -> int __maybe_unused {
