...
//! Source: drivers/thermal/thermal_sysfs.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(buf, _arg: "disabled", 1): sizeof("disabled") -) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn create_trip_attrs(tz: *mut thermal_zone_device) -> c_int {
...
// create trip temp attribute
    ...
    attrs[tz.num_trips * 3] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn destroy_trip_attrs(tz: *mut thermal_zone_device) {
...
#[no_mangle]
pub unsafe extern "C" fn thermal_zone_create_device_groups(tz: *mut thermal_zone_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn thermal_zone_destroy_device_groups(tz: *mut thermal_zone_device) {
...
// Requested state should be less than max_state + 1
    ...
    dev_attr_cdev_type = __ATTR(type, 0444, cdev_type_show, core::ptr::null_mut());
    ...
    core::ptr::null_mut(), /* Space allocated for cooling_device_stats_attr_group */
    core::ptr::null_mut(),
    };

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cooling_dev_stats {
    pub lock: spinlock_t,
    pub total_trans: c_uint,
    pub state: c_ulong,
    pub last_time: ktime_t,
    pub time_in_state: *mut ktime_t,
    pub trans_table: *mut c_uint,
}

#[no_mangle]
unsafe extern "C" fn update_time_in_state(stats: *mut cooling_dev_stats) {
    static void update_time_in_state(struct cooling_dev_stats *stats)
    {
    let mut now: ktime_t = ktime_get(), delta;
...
#[no_mangle]
unsafe extern "C" fn cooling_device_stats_setup(cdev: *mut thermal_cooling_device) {
    static void cooling_device_stats_setup(struct thermal_cooling_device *cdev)
    {
    const struct attribute_group *stats_attr_group = core::ptr::null_mut();
    struct cooling_dev_stats *stats;
// Total number of states is highest state + 1
    let mut states: c_ulong = cdev.max_state + 1;
    int var;
    var = sizeof(*stats);
...
#[no_mangle]
unsafe extern "C" fn cooling_device_stats_destroy(cdev: *mut thermal_cooling_device) {
    static void cooling_device_stats_destroy(struct thermal_cooling_device *cdev)
    {
    kfree(cdev.stats);
    cdev.stats = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn thermal_cooling_device_setup_sysfs(cdev: *mut thermal_cooling_device) {
...
#[no_mangle]
pub unsafe extern "C" fn thermal_cooling_device_destroy_sysfs(cdev: *mut thermal_cooling_device) {
    void thermal_cooling_device_destroy_sysfs(struct thermal_cooling_device *cdev)
    {
    cooling_device_stats_destroy(cdev);
    }
#[no_mangle]
pub unsafe extern "C" fn thermal_cooling_device_stats_reinit(cdev: *mut thermal_cooling_device) {
