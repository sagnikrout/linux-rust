...
//! Source: drivers/thermal/intel/int340x_thermal/int3403_thermal.c
#![no_std]
...
pub const INT3403_TYPE_SENSOR: c_uint = 0x03;
pub const INT3403_TYPE_CHARGER: c_uint = 0x0B;
pub const INT3403_TYPE_BATTERY: c_uint = 0x0C;
pub const INT3403_PERF_CHANGED_EVENT: c_uint = 0x80;
pub const INT3403_PERF_TRIP_POINT_CHANGED: c_uint = 0x81;
pub const INT3403_THERMAL_EVENT: c_uint = 0x90;
// Preserved structure for future expandbility
#[repr(C)]
#[derive(Copy, Clone)]
pub struct int3403_sensor {
    pub int340x_zone: *mut int34x_thermal_zone,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct int3403_cdev {
...
#[no_mangle]
unsafe extern "C" fn int3403_sensor_add(priv: *mut int3403_priv) -> c_int {
    ...
    return -ENOMEM;
    priv.priv = obj;
    obj.int340x_zone = int340x_thermal_zone_add(priv.adev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn int3403_sensor_remove(priv: *mut int3403_priv) -> c_int {
...
// state = obj->max_state;
    ...
    acpi_status status;
    status = acpi_evaluate_integer(priv.adev.handle, "PPPC", core::ptr::null_mut(), &level);
...
#[no_mangle]
unsafe extern "C" fn int3403_cdev_add(priv: *mut int3403_priv) -> c_int {
    ...
    if (!obj)
    return -ENOMEM;
    status = acpi_evaluate_object(priv.adev.handle, "PPSS", core::ptr::null_mut(), &buf);
...
#[no_mangle]
unsafe extern "C" fn int3403_cdev_remove(priv: *mut int3403_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn int3403_add(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn int3403_remove(pdev: *mut platform_device) {
