...
//! Source: drivers/thermal/intel/int340x_thermal/processor_thermal_device_pci.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct proc_thermal_pci {
    pub pdev: *mut pci_dev,
    pub proc_priv: *mut proc_thermal_device,
    pub tzone: *mut thermal_zone_device,
    pub work: delayed_work,
    pub stored_thres: c_int,
    pub no_legacy: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct proc_thermal_mmio_info {
    pub mmio_type: enum proc_thermal_mmio_type,
    pub mmio_addr: u64,
    pub shift: u64,
    pub mask: u64,
}
...
pub const B0D4_THERMAL_NOTIFY_DELAY: c_int = 1000;
    let mut notify_delay_ms: static int = B0D4_THERMAL_NOTIFY_DELAY;
...
//
#[no_mangle]
unsafe extern "C" fn proc_thermal_threshold_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pkg_thermal_schedule_work(work: *mut delayed_work) {
...
#[no_mangle]
unsafe extern "C" fn proc_thermal_clear_soc_int_status(proc_priv: *mut proc_thermal_device) {
...
#[no_mangle]
unsafe extern "C" fn proc_thermal_irq_thread_handler(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn proc_thermal_match_msi_irq(irq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn proc_thermal_irq_handler(irq: c_int, devid: *mut c_void) -> irqreturn_t {
    static irqreturn_t proc_thermal_irq_handler(int irq, void *devid)
    {
    struct proc_thermal_pci *pci_info = devid;
    struct proc_thermal_device *proc_priv;
    let mut ret: c_int = IRQ_NONE, msi_id;
    u32 status;
...
#[no_mangle]
unsafe extern "C" fn get_trip_temp(pci_info: *mut proc_thermal_pci) -> c_int {
    ...
    static bool msi_irq;
#[no_mangle]
unsafe extern "C" fn proc_thermal_free_msi(pdev: *mut pci_dev, pci_info: *mut proc_thermal_pci) {
...
#[no_mangle]
unsafe extern "C" fn proc_thermal_setup_msi(pdev: *mut pci_dev, pci_info: *mut proc_thermal_pci) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn proc_thermal_pci_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    ...
    let mut irq_flag: c_int = 0, irq, ret;
