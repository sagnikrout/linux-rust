...
//! Source: drivers/thermal/intel/int340x_thermal/processor_thermal_wt_hint.c
#![no_std]
...
pub const SOC_WT_SLOW_PREDICTION_INT_ENABLE_BIT: c_int = 22;
pub const SOC_WT_PREDICTION_INT_ENABLE_BIT: c_int = 23;

//
// Closest possible to 1 Second is 1024 ms with programmed time delay
// of 0x0A.
//
    let mut notify_delay: static u8 = 0x0A;
    let mut notify_delay_ms: static u16 = 1024;
...
#[no_mangle]
unsafe extern "C" fn workload_hint_attr_visible(kobj: *mut kobject, attr: *mut attribute, unused: c_int) -> umode_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn proc_thermal_check_wt_intr(proc_priv: *mut proc_thermal_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn proc_thermal_wt_intr_callback(pdev: *mut pci_dev, proc_priv: *mut proc_thermal_device) {
...
#[no_mangle]
pub unsafe extern "C" fn proc_thermal_wt_hint_add(pdev: *mut pci_dev, proc_priv: *mut proc_thermal_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn proc_thermal_wt_hint_remove(pdev: *mut pci_dev) {
