...
//! Source: drivers/thermal/intel/int340x_thermal/processor_thermal_rapl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rapl_mmio_read_raw(cpu: c_int, ra: *mut reg_action, atomic: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rapl_mmio_write_raw(cpu: c_int, ra: *mut reg_action) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn proc_thermal_rapl_add(pdev: *mut pci_dev, proc_priv: *mut proc_thermal_device) -> c_int {
    ...
    rapl_mmio_priv.control_type = powercap_register_control_type(core::ptr::null_mut(), "intel-rapl-mmio", core::ptr::null_mut());
...
// Register a RAPL package device for package 0 which is always online
    ...
    rapl_mmio_priv.control_type = core::ptr::null_mut();
    return ret;
    }
    EXPORT_SYMBOL_GPL(proc_thermal_rapl_add);
#[no_mangle]
pub unsafe extern "C" fn proc_thermal_rapl_remove() {
