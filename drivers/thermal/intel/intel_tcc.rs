...
//! Source: drivers/thermal/intel/intel_tcc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct temp_masks {
    pub tcc_offset: u32,
    pub digital_readout: u32,
    pub pkg_digital_readout: u32,
}
...
#[no_mangle]
unsafe extern "C" fn intel_tcc_init() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_tcc_get_offset_mask() -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn get_temp_mask(pkg: bool) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_tcc_get_tjmax(cpu: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_tcc_get_offset(cpu: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_tcc_set_offset(cpu: c_int, offset: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_tcc_get_temp(cpu: c_int, temp: *mut c_int, pkg: bool) -> c_int {
    int intel_tcc_get_temp(int cpu, int *temp, bool pkg)
    {
    let mut msr: u32 = pkg ? MSR_IA32_PACKAGE_THERM_STATUS : MSR_IA32_THERM_STATUS;
    u32 mask;
    struct msr val;
    int tjmax, err;
