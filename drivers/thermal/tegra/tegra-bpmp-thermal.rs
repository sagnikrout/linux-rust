...
//! Source: drivers/thermal/tegra/tegra-bpmp-thermal.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_bpmp_thermal_zone {
    pub tegra: *mut tegra_bpmp_thermal,
    pub tzd: *mut thermal_zone_device,
    pub tz_device_update_work: work_struct,
    pub idx: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_bpmp_thermal {
    pub dev: *mut device,
    pub bpmp: *mut tegra_bpmp,
    pub num_zones: c_uint,
    pub zones: *mut tegra_bpmp_thermal_zone,
}
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_thermal_get_temp(tz: *mut thermal_zone_device, out_temp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_thermal_set_trips(tz: *mut thermal_zone_device, low: c_int, high: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tz_device_update_work_fn(work: *mut work_struct) {
    ...
    tegra_bpmp_mrq_return(ch, -EINVAL, core::ptr::null_mut(), 0);
    return;
    }
    ...
    tegra_bpmp_mrq_return(ch, 0, core::ptr::null_mut(), 0);
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_thermal_trips_supported(bpmp: *mut tegra_bpmp, supported: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_thermal_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_thermal_remove(pdev: *mut platform_device) {
