...
//! Source: drivers/thermal/tegra/soctherm-fuse.c
#![no_std]
...
pub const NOMINAL_CALIB_CP: c_int = 25;
pub const FUSE_TSENSOR_CALIB_CP_TS_BASE_MASK: c_uint = 0x1fff;

pub const FUSE_TSENSOR_CALIB_FT_TS_BASE_SHIFT: c_int = 13;
//
...
//
#[no_mangle]
unsafe extern "C" fn div64_s64_precise(a: i64, b: i32) -> i64 {
