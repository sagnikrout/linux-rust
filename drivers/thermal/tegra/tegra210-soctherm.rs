...
//! Source: drivers/thermal/tegra/tegra210-soctherm.c
#![no_std]
...
pub const TEGRA210_THERMTRIP_TSENSE_THRESH_MASK: c_uint = 0x1ff;

pub const TEGRA210_THRESH_GRAIN: c_int = 500;
pub const TEGRA210_BPTT: c_int = 9;
