...
//! Source: drivers/thermal/tegra/tegra124-soctherm.c
#![no_std]
...
pub const TEGRA124_THERMTRIP_TSENSE_THRESH_MASK: c_uint = 0xff;

pub const TEGRA124_THRESH_GRAIN: c_int = 1000;
pub const TEGRA124_BPTT: c_int = 8;
