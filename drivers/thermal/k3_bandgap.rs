...
//! Source: drivers/thermal/k3_bandgap.c
#![no_std]
...
pub const K3_VTM_TMPSENS0_CTRL_OFFSET: c_uint = 0x80;
pub const K3_VTM_REGS_PER_TS: c_uint = 0x10;
pub const K3_VTM_TS_STAT_DTEMP_MASK: c_uint = 0x3ff;

pub const K3_VTM_ADC_BEGIN_VAL: c_int = 540;
pub const K3_VTM_ADC_END_VAL: c_int = 944;
...
#[no_mangle]
unsafe extern "C" fn k3_bandgap_probe(pdev: *mut platform_device) -> c_int {
    static int k3_bandgap_probe(struct platform_device *pdev)
    {
    let mut ret: c_int = 0, cnt, val, id;
    struct resource *res;
...
// Register the thermal sensors
    ...
    dev_err(dev, "thermal zone device is core::ptr::null_mut()\n");
...
#[no_mangle]
unsafe extern "C" fn k3_bandgap_remove(pdev: *mut platform_device) {
