...
//! Source: drivers/thermal/armada_thermal.c
#![no_std]
...
pub const CONTROL0_TSEN_TC_TRIM_VAL: c_uint = 0x3;

pub const CONTROL0_TSEN_MODE_EXTERNAL: c_uint = 0x2;

pub const STATUS_POLL_PERIOD_US: c_int = 1000;
pub const STATUS_POLL_TIMEOUT_US: c_int = 100000;
pub const OVERHEAT_INT_POLL_DELAY_MS: c_int = 1000;
    struct armada_thermal_data;
// Marvell EBU Thermal Sensor Dev Structure
#[repr(C)]
#[derive(Copy, Clone)]
pub struct armada_thermal_priv {
    pub dev: *mut device,
    pub syscon: *mut regmap,
    pub zone_name: [c_char; THERMAL_NAME_LENGTH],
// serialize temperature reads/updates
    pub update_lock: mutex,
    pub data: *mut armada_thermal_data,
    pub overheat_sensor: *mut thermal_zone_device,
    pub interrupt_source: c_int,
    pub current_channel: c_int,
    pub current_threshold: c_long,
    pub current_hysteresis: c_long,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct armada_thermal_data {
// Initialize the thermal IC
    void (*init)(struct platform_device *pdev,
    pub priv): *mut armada_thermal_priv,
// Formula coeficients: temp = (b - m * reg) / div
    pub coef_b: i64,
    pub coef_m: i64,
    pub coef_div: u32,
    pub inverted: bool,
    pub signed_sample: bool,
// Register shift and mask to access the sensor temperature
    pub temp_shift: c_uint,
    pub temp_mask: c_uint,
    pub thresh_shift: c_uint,
    pub hyst_shift: c_uint,
    pub hyst_mask: c_uint,
    pub is_valid_bit: u32,
// Syscon access
    pub syscon_control0_off: c_uint,
    pub syscon_control1_off: c_uint,
    pub syscon_status_off: c_uint,
    pub dfx_irq_cause_off: c_uint,
    pub dfx_irq_mask_off: c_uint,
    pub dfx_overheat_irq: c_uint,
    pub dfx_server_irq_mask_off: c_uint,
    pub dfx_server_irq_en: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct armada_thermal_sensor {
    pub priv: *mut armada_thermal_priv,
    pub id: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn armada_wait_sensor_validity(priv: *mut armada_thermal_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada_is_valid(priv: *mut armada_thermal_priv) -> bool {
...
#[no_mangle]
unsafe extern "C" fn armada_enable_overheat_interrupt(priv: *mut armada_thermal_priv) {
...
#[no_mangle]
unsafe extern "C" fn armada_select_channel(priv: *mut armada_thermal_priv, channel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada_read_sensor(priv: *mut armada_thermal_priv, temp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada_get_temp(tz: *mut thermal_zone_device, temp: *mut c_int) -> c_int {
...
//
    ...
    {
    let mut b: i64 = data.coef_b;
    let mut m: i64 = data.coef_m;
    let mut div: i64 = data.coef_div;
    unsigned int sample;
    if (data.inverted)
...
//
    ...
    {
    struct armada_thermal_data *data = priv.data;
    let mut threshold: c_uint = armada_mc_to_reg_temp(data, thresh_mc);
    let mut hysteresis: c_uint = armada_mc_to_reg_hyst(data, hyst_mc);
    u32 ctrl1;
...
#[no_mangle]
unsafe extern "C" fn armada_overheat_isr(irq: c_int, blob: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn armada_overheat_isr_thread(irq: c_int, blob: *mut c_void) -> irqreturn_t {
    static irqreturn_t armada_overheat_isr_thread(int irq, void *blob)
    {
    struct armada_thermal_priv *priv = blob;
    let mut low_threshold: c_int = priv.current_threshold - priv.current_hysteresis;
    int temperature;
    u32 dummy;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn armada_thermal_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada_thermal_exit(pdev: *mut platform_device) {
