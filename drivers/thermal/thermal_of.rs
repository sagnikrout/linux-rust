...
//! Source: drivers/thermal/thermal_of.c
#![no_std]
...
// ntrips = count;
    ...
    struct device_node *np __free(device_node) = of_find_node_by_name(core::ptr::null_mut(), "thermal-zones");
    if (!np) {
...
#[no_mangle]
unsafe extern "C" fn thermal_of_monitor_init(np: *mut device_node, delay: *mut c_int, pdelay: *mut c_int) -> c_int {
...
// delay = 0;
    ...
    {
    int coef[2];
    let mut ncoef: c_int = ARRAY_SIZE(coef);
    int prop, ret;
    tzp.no_hwmon = true;
...
//
    ...
    np = of_find_node_by_name(core::ptr::null_mut(), "thermal-zones");
    if (!np)
    return ERR_PTR(-ENODEV);
...
//
#[no_mangle]
unsafe extern "C" fn thermal_of_zone_unregister(tz: *mut thermal_zone_device) {
...
//
    ...
    {
    let mut of_ops: thermal_zone_device_ops = *ops;
    struct thermal_zone_device *tz;
    struct thermal_trip *trips;
    let mut tzp: thermal_zone_params = {};
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(action, _arg: "shutdown")) -> else {
...
#[no_mangle]
unsafe extern "C" fn devm_thermal_of_zone_release(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_thermal_of_zone_unregister(dev: *mut device, tz: *mut thermal_zone_device) {
...
#[no_mangle]
unsafe extern "C" fn thermal_of_cooling_device_release(data: *mut c_void) {
