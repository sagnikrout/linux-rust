...
//! Source: drivers/thermal/qcom/tsens-v1.c
#![no_std]
...
pub const TM_Sn_STATUS_OFF: c_uint = 0x0044;
pub const TM_TRDY_OFF: c_uint = 0x0084;
pub const TM_HIGH_LOW_INT_STATUS_OFF: c_uint = 0x0088;
pub const TM_HIGH_LOW_Sn_INT_THRESHOLD_OFF: c_uint = 0x0090;
...
#[no_mangle]
unsafe extern "C" fn calibrate_v1(priv: *mut tsens_priv) -> c_int {
    ...
    p1, p2,
    qfprom_cdata, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn init_8956(priv: *mut tsens_priv) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_tsens_v1_no_rpm(priv: *mut tsens_priv) -> int __init {
