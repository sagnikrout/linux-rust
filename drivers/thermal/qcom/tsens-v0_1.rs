...
//! Source: drivers/thermal/qcom/tsens-v0_1.c
#![no_std]
...
// ----- SROT ------
pub const SROT_CTRL_OFF: c_uint = 0x0000;
// ----- TM ------
pub const TM_INT_EN_OFF: c_uint = 0x0000;
pub const TM_Sn_UPPER_LOWER_STATUS_CTRL_OFF: c_uint = 0x0004;
pub const TM_Sn_STATUS_OFF: c_uint = 0x0030;
pub const TM_TRDY_OFF: c_uint = 0x005c;
// extra data for 8974
pub const BKP_SEL: c_uint = 0x3;
pub const BKP_REDUN_SEL: c_uint = 0xe0000000;
pub const BIT_APPEND: c_uint = 0x3;
...
#[no_mangle]
unsafe extern "C" fn calibrate_8916(priv: *mut tsens_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fixup_8974_points(mode: c_int, p1: *mut u32, p2: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn calibrate_8974_nvmem(priv: *mut tsens_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn calibrate_8974(priv: *mut tsens_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_8226(priv: *mut tsens_priv) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_8909(priv: *mut tsens_priv) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_8939(priv: *mut tsens_priv) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_9607(priv: *mut tsens_priv) -> int __init {
