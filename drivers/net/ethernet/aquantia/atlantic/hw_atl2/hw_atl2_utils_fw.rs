...
//! Source: drivers/net/ethernet/aquantia/atlantic/hw_atl2/hw_atl2_utils_fw.c
#![no_std]
...
pub const AQ_A2_FW_READ_TRY_MAX: c_int = 1000;
...
#[no_mangle]
pub unsafe extern "C" fn hw_atl2_shared_buffer_finish_ack(self: *mut aq_hw_s) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_init(self: *mut aq_hw_s) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_deinit(self: *mut aq_hw_s) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn a2_fw_dev_to_eee_mask(device_link_caps: *mut device_link_caps_s) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn a2_fw_lkp_to_mask(lkp_link_caps: *mut lkp_link_caps_s) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_set_link_speed(self: *mut aq_hw_s, speed: u32) -> c_int {
    ...
    struct link_options_s *link_options)
    {
    let mut flow_control: u32 = self.aq_nic_cfg.fc.req;
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_update_link_status(self: *mut aq_hw_s) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_get_mac_permanent(self: *mut aq_hw_s, mac: *mut u8) -> c_int {
    ...
    let mut curr_stats: aq_stats_s = *cs;
    let mut corrupted_stats: bool = false;
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_update_stats(self: *mut aq_hw_s) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_get_phy_temp(self: *mut aq_hw_s, temp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_get_mac_temp(self: *mut aq_hw_s, temp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_set_wol_params(self: *mut aq_hw_s, mac: *const u8, wol: u32) -> c_int {
    ...
    const u8 *mac)
    {
    let mut wol: u32 = self.aq_nic_cfg.wol;
    let mut err: c_int = 0;
    if (wol)
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_set_eee_rate(self: *mut aq_hw_s, speed: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_renegotiate(self: *mut aq_hw_s) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_set_flow_control(self: *mut aq_hw_s) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_get_flow_control(self: *mut aq_hw_s, fcmode: *mut u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_set_phyloopback(self: *mut aq_hw_s, mode: u32, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hw_atl2_utils_get_fw_version(self: *mut aq_hw_s) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn hw_atl2_utils_get_filter_caps(self: *mut aq_hw_s) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aq_a2_fw_set_downshift(self: *mut aq_hw_s, counter: u32) -> c_int {
