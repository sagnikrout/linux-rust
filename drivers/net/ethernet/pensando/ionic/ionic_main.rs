...
//! Source: drivers/net/ethernet/pensando/ionic/ionic_main.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ionic_error_to_errno(code: enum ionic_status_code) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_adminq_flush(lif: *mut ionic_lif) {
    ...
    desc_info.ctx = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ionic_notifyq_service(cq: *mut ionic_cq) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_adminq_service(cq: *mut ionic_cq) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_adminq_poke_doorbell(q: *mut ionic_queue) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_adminq_post(lif: *mut ionic_lif, ctx: *mut ionic_admin_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_adminq_post_wait(lif: *mut ionic_lif, ctx: *mut ionic_admin_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_adminq_post_wait_nomsg(lif: *mut ionic_lif, ctx: *mut ionic_admin_ctx) -> c_int {
    int ionic_adminq_post_wait_nomsg(struct ionic_lif *lif, struct ionic_admin_ctx *ctx)
    {
    return __ionic_adminq_post_wait(lif, ctx, false);
    }
#[no_mangle]
unsafe extern "C" fn ionic_dev_cmd_clean(ionic: *mut ionic) {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_dev_cmd_wait(ionic: *mut ionic, max_seconds: c_ulong) -> c_int {
    int ionic_dev_cmd_wait(struct ionic *ionic, unsigned long max_seconds)
    {
    return __ionic_dev_cmd_wait(ionic, max_seconds, true);
    }
#[no_mangle]
pub unsafe extern "C" fn ionic_dev_cmd_wait_nomsg(ionic: *mut ionic, max_seconds: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_setup(ionic: *mut ionic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_identify(ionic: *mut ionic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_init(ionic: *mut ionic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_reset(ionic: *mut ionic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_port_identify(ionic: *mut ionic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_port_init(ionic: *mut ionic) -> c_int {
...
//
    ...
    idev.port_info = core::ptr::null_mut();
    idev.port_info_pa = 0;
    }
    return err;
    }
#[no_mangle]
pub unsafe extern "C" fn ionic_port_reset(ionic: *mut ionic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ionic_cleanup_module() -> void __exit {
