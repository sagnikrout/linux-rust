...
//! Source: drivers/net/ethernet/pensando/ionic/ionic_phc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ionic_hwstamp_tx_mode(config_tx_type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_hwstamp_rx_filt(config_rx_filter: c_int) -> u64 {
    ...
    let mut ts: kernel_hwtstamp_config = {};
    struct ionic *ionic = lif.ionic;
    let mut tx_mode: c_int = 0;
    let mut rx_filt: u64 = 0;
    int err, err2;
    bool rx_all;
    __le64 mask;
...
#[no_mangle]
pub unsafe extern "C" fn ionic_lif_hwstamp_replay(lif: *mut ionic_lif) {
    ...
    return;
    mutex_lock(&lif.queue_lock);
    err = ionic_lif_hwstamp_set_ts_config(lif, core::ptr::null_mut(), core::ptr::null_mut());
    mutex_unlock(&lif.queue_lock);
    if (err)
    netdev_info(lif.netdev, "hwstamp replay failed: %d\n", err);
    }
#[no_mangle]
pub unsafe extern "C" fn ionic_lif_hwstamp_recreate_queues(lif: *mut ionic_lif) {
...
#[no_mangle]
unsafe extern "C" fn ionic_cc_read(cc: *mut cyclecounter) -> u64 {
    ...
    return ionic_hwstamp_read(ionic, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ionic_setphc_cmd(phc: *mut ionic_phc, ctx: *mut ionic_admin_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_phc_state_page_update(phc: *mut ionic_phc) {
...
#[no_mangle]
unsafe extern "C" fn ionic_phc_adjfine(info: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_phc_adjtime(info: *mut ptp_clock_info, delta: i64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_phc_aux_work(info: *mut ptp_clock_info) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_lif_phc_ktime(lif: *mut ionic_lif, tick: u64) -> ktime_t {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_lif_register_phc(lif: *mut ionic_lif) {
    ...
    PTR_ERR(lif.phc.ptp));
    lif.phc.ptp = core::ptr::null_mut();
    }
    if (lif.phc.ptp)
    ptp_schedule_worker(lif.phc.ptp, lif.phc.aux_work_delay);
    }
#[no_mangle]
pub unsafe extern "C" fn ionic_lif_unregister_phc(lif: *mut ionic_lif) {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_lif_alloc_phc(lif: *mut ionic_lif) {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_lif_free_phc(lif: *mut ionic_lif) {
