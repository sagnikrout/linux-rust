...
//! Source: drivers/net/ethernet/mscc/ocelot_ptp.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ocelot_ptp_gettime64(ptp: *mut ptp_clock_info, ts: *mut timespec64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocelot_ptp_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocelot_ptp_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
    int ocelot_ptp_adjfine(struct ptp_clock_info *ptp, long scaled_ppm)
    {
    struct ocelot *ocelot = container_of(ptp, struct ocelot, ptp_info);
    let mut unit: u32 = 0, direction = 0;
    unsigned long flags;
    let mut adj: u64 = 0;
    spin_lock_irqsave(&ocelot.ptp_clock_lock, flags);
    if (!scaled_ppm)
...
// Still too big
    ...
    ptp_pin = PTP_PIN_0;
#[no_mangle]
pub unsafe extern "C" fn if(1: pin ==) -> else {
    else if (pin == 1)
    ptp_pin = PTP_PIN_1;
#[no_mangle]
pub unsafe extern "C" fn if(2: pin ==) -> else {
    else if (pin == 2)
    ptp_pin = PTP_PIN_2;
#[no_mangle]
pub unsafe extern "C" fn if(3: pin ==) -> else {
    else if (pin == 3)
    ptp_pin = PTP_PIN_3;
    else
    return -EBUSY;
...
#[no_mangle]
unsafe extern "C" fn ocelot_populate_l2_ptp_trap_key(trap: *mut ocelot_vcap_filter) {
...
#[no_mangle]
unsafe extern "C" fn ocelot_l2_ptp_trap_add(ocelot: *mut ocelot, port: c_int) -> c_int {
    static int ocelot_l2_ptp_trap_add(struct ocelot *ocelot, int port)
    {
    let mut l2_cookie: c_ulong = OCELOT_VCAP_IS2_L2_PTP_TRAP(ocelot);
    return ocelot_trap_add(ocelot, port, l2_cookie, true,
    ocelot_populate_l2_ptp_trap_key);
    }
#[no_mangle]
unsafe extern "C" fn ocelot_l2_ptp_trap_del(ocelot: *mut ocelot, port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocelot_ipv4_ptp_trap_add(ocelot: *mut ocelot, port: c_int) -> c_int {
    static int ocelot_ipv4_ptp_trap_add(struct ocelot *ocelot, int port)
    {
    let mut ipv4_gen_cookie: c_ulong = OCELOT_VCAP_IS2_IPV4_GEN_PTP_TRAP(ocelot);
    let mut ipv4_ev_cookie: c_ulong = OCELOT_VCAP_IS2_IPV4_EV_PTP_TRAP(ocelot);
    int err;
...
#[no_mangle]
unsafe extern "C" fn ocelot_ipv4_ptp_trap_del(ocelot: *mut ocelot, port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocelot_ipv6_ptp_trap_add(ocelot: *mut ocelot, port: c_int) -> c_int {
    static int ocelot_ipv6_ptp_trap_add(struct ocelot *ocelot, int port)
    {
    let mut ipv6_gen_cookie: c_ulong = OCELOT_VCAP_IS2_IPV6_GEN_PTP_TRAP(ocelot);
    let mut ipv6_ev_cookie: c_ulong = OCELOT_VCAP_IS2_IPV6_EV_PTP_TRAP(ocelot);
    int err;
...
#[no_mangle]
unsafe extern "C" fn ocelot_ipv6_ptp_trap_del(ocelot: *mut ocelot, port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocelot_traps_to_ptp_rx_filter(proto: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(OCELOT_PROTO_PTP_L2: proto &) -> else {
    else if (proto & OCELOT_PROTO_PTP_L2)
    return HWTSTAMP_FILTER_PTP_V2_L2_EVENT;
#[no_mangle]
pub unsafe extern "C" fn if(OCELOT_PROTO_PTP_L4: proto &) -> else {
    else if (proto & OCELOT_PROTO_PTP_L4)
    return HWTSTAMP_FILTER_PTP_V2_L4_EVENT;
    return HWTSTAMP_FILTER_NONE;
    }
#[no_mangle]
unsafe extern "C" fn ocelot_ptp_tx_type_to_cmd(tx_type: c_int, ptp_cmd: *mut c_int) -> c_int {
...
// ptp_cmd = 0;
    ...
    {
    struct ocelot_port *ocelot_port = ocelot.ports[port];
    let mut l2: bool = false, l4 = false;
    int ptp_cmd;
    int err;
// Tx type sanity check
    ...
    {
    struct ocelot_port *ocelot_port = ocelot.ports[port];
    struct sk_buff *skb, *skb_tmp, *skb_match = core::ptr::null_mut();
...
// Found an available timestamp ID, use it
    ...
    {
    struct ocelot_port *ocelot_port = ocelot.ports[port];
    let mut ptp_cmd: u8 = ocelot_port.ptp_cmd;
    unsigned int ptp_class;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn ocelot_get_txtstamp(ocelot: *mut ocelot) {
    void ocelot_get_txtstamp(struct ocelot *ocelot)
    {
    let mut budget: c_int = OCELOT_PTP_QUEUE_SZ;
    while (budget--) {
...
#[no_mangle]
pub unsafe extern "C" fn ocelot_deinit_timestamp(ocelot: *mut ocelot) -> c_int {
