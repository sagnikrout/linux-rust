...
//! Source: drivers/net/ethernet/mscc/ocelot_devlink.c
#![no_std]
...
//
pub const OCELOT_RESOURCE_SZ: c_int = 256;
pub const OCELOT_NUM_RESOURCES: c_int = 4;
...
//
pub const xxx_Q_RSRV_x: c_int = 0;
pub const xxx_PRIO_SHR_x: c_int = 216;
pub const xxx_P_RSRV_x: c_int = 224;
pub const xxx_COL_SHR_x: c_int = 254;
...
#[no_mangle]
unsafe extern "C" fn ocelot_wm_read(ocelot: *mut ocelot, index: c_int) -> u32 {
    static u32 ocelot_wm_read(struct ocelot *ocelot, int index)
    {
    let mut wm: c_int = ocelot_read_gix(ocelot, QSYS_RES_CFG, index);
    return ocelot.ops.wm_dec(wm);
    }
#[no_mangle]
unsafe extern "C" fn ocelot_wm_write(ocelot: *mut ocelot, index: c_int, val: u32) {
    static void ocelot_wm_write(struct ocelot *ocelot, int index, u32 val)
    {
    let mut wm: u32 = ocelot.ops.wm_enc(val);
    ocelot_write_gix(ocelot, wm, QSYS_RES_CFG, index);
    }
    static void ocelot_wm_status(struct ocelot *ocelot, int index, u32 *inuse,
    u32 *maxuse)
    {
    let mut res_stat: c_int = ocelot_read_gix(ocelot, QSYS_RES_STAT, index);
...
//
#[no_mangle]
unsafe extern "C" fn ocelot_disable_tc_sharing_watermarks(ocelot: *mut ocelot) {
...
//
#[no_mangle]
unsafe extern "C" fn ocelot_setup_sharing_watermarks(ocelot: *mut ocelot) {
...
//
#[no_mangle]
unsafe extern "C" fn ocelot_watermark_init(ocelot: *mut ocelot) {
    static void ocelot_watermark_init(struct ocelot *ocelot)
    {
    let mut all_tcs: c_int = GENMASK(OCELOT_NUM_TC - 1, 0);
    int port;
...
//
#[no_mangle]
pub unsafe extern "C" fn ocelot_wm_enc(value: u16) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn ocelot_wm_dec(wm: u16) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn ocelot_wm_stat(val: u32, inuse: *mut u32, maxuse: *mut u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ocelot_sb_occ_snapshot(ocelot: *mut ocelot, sb_index: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ocelot_sb_occ_max_clear(ocelot: *mut ocelot, sb_index: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocelot_devlink_sb_register(ocelot: *mut ocelot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocelot_devlink_sb_unregister(ocelot: *mut ocelot) {
