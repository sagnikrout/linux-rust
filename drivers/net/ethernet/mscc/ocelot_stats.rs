...
//! Source: drivers/net/ethernet/mscc/ocelot_stats.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocelot_stat_layout {
    pub reg: enum ocelot_reg,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocelot_stats_region {
    pub node: list_head,
    pub base: enum ocelot_reg,
    pub first_stat: enum ocelot_stat,
    pub count: c_int,
    pub buf: *mut u32,
}
...
//
#[no_mangle]
unsafe extern "C" fn ocelot_port_update_stats(ocelot: *mut ocelot, port: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ocelot_port_transfer_stats(ocelot: *mut ocelot, port: c_int) {
    static void ocelot_port_transfer_stats(struct ocelot *ocelot, int port)
    {
    struct ocelot_stats_region *region;
    int j;
    list_for_each_entry(region, &ocelot.stats_regions, node) {
    let mut idx: c_uint = port * OCELOT_NUM_STATS + region.first_stat;
    for (j = 0; j < region.count; j++) {
    u64 *stat = &ocelot.stats[idx + j];
    let mut val: u64 = region.buf[j];
    if (val < (*stat & U32_MAX))
// stat += (u64)1 << 32;
...
#[no_mangle]
unsafe extern "C" fn ocelot_check_stats_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn ocelot_get_strings(ocelot: *mut ocelot, port: c_int, sset: u32, data: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn ocelot_get_sset_count(ocelot: *mut ocelot, port: c_int, sset: c_int) -> c_int {
    int ocelot_get_sset_count(struct ocelot *ocelot, int port, int sset)
    {
    const struct ocelot_stat_layout *layout;
    enum ocelot_stat i;
    let mut num_stats: c_int = 0;
    if (sset != ETH_SS_STATS)
    return -EOPNOTSUPP;
    layout = ocelot_get_stats_layout(ocelot);
    for (i = 0; i < OCELOT_NUM_STATS; i++)
...
// Copy all supported counters
    for (i = 0; i < OCELOT_NUM_STATS; i++) {
    let mut index: c_int = port * OCELOT_NUM_STATS + i;
    if (layout[i].name[0] == '\0')
    continue;
...
#[no_mangle]
pub unsafe extern "C" fn ocelot_get_ethtool_stats(ocelot: *mut ocelot, port: c_int, data: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn ocelot_port_pause_stats_cb(ocelot: *mut ocelot, port: c_int, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ocelot_port_rmon_stats_cb(ocelot: *mut ocelot, port: c_int, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ocelot_port_ctrl_stats_cb(ocelot: *mut ocelot, port: c_int, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ocelot_port_mac_stats_cb(ocelot: *mut ocelot, port: c_int, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ocelot_port_phy_stats_cb(ocelot: *mut ocelot, port: c_int, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ocelot_prepare_stats_regions(ocelot: *mut ocelot) -> c_int {
    static int ocelot_prepare_stats_regions(struct ocelot *ocelot)
    {
    struct ocelot_stats_region *region = core::ptr::null_mut();
    const struct ocelot_stat_layout *layout;
    let mut last: enum ocelot_reg = 0;
    enum ocelot_stat i;
...
#[no_mangle]
pub unsafe extern "C" fn ocelot_stats_init(ocelot: *mut ocelot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocelot_stats_deinit(ocelot: *mut ocelot) {
