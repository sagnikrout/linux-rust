...
//! Source: drivers/net/ethernet/apm/xgene/xgene_enet_ethtool.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgene_gstrings_stats {
...
pub const RFCS_IDX: c_int = 7;
pub const RALN_IDX: c_int = 13;
pub const RFLR_IDX: c_int = 14;
pub const FALSE_RFLR_IDX: c_int = 15;
pub const RUND_IDX: c_int = 18;
pub const FALSE_RJBR_IDX: c_int = 22;
pub const RX_OVERRUN_IDX: c_int = 24;
pub const TFCS_IDX: c_int = 38;
pub const TFRG_IDX: c_int = 42;
pub const TX_UNDERRUN_IDX: c_int = 43;
...
#[no_mangle]
unsafe extern "C" fn xgene_get_strings(ndev: *mut net_device, stringset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn xgene_get_sset_count(ndev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_get_extd_stats(pdata: *mut xgene_enet_pdata) {
...
#[no_mangle]
pub unsafe extern "C" fn xgene_extd_stats_init(pdata: *mut xgene_enet_pdata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xgene_enet_set_ethtool_ops(ndev: *mut net_device) {
