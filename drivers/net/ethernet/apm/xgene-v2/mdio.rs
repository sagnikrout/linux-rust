...
//! Source: drivers/net/ethernet/apm/xgene-v2/mdio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn xge_mdio_write(bus: *mut mii_bus, phy_id: c_int, reg: c_int, data: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xge_mdio_read(bus: *mut mii_bus, phy_id: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xge_adjust_link(ndev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn xge_mdio_remove(ndev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn xge_mdio_config(ndev: *mut net_device) -> c_int {
