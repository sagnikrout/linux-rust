...
//! Source: drivers/net/ethernet/adi/adin1140.c
#![no_std]
...
pub const ADIN1140_MAC_P1_LOOP_ADDR_REG: c_uint = 0xC4;
pub const ADIN1140_MAC_ADDR_FILT_UPR_REG: c_uint = 0x50;

pub const ADIN1140_MAC_ADDR_FILT_LWR_REG: c_uint = 0x51;
pub const ADIN1140_MAC_ADDR_MASK_UPR_REG: c_uint = 0x70;
pub const ADIN1140_MAC_ADDR_MASK_LWR_REG: c_uint = 0x71;

pub const ADIN1140_MAC_RX_FRAME_CNT: c_uint = 0xA1;
pub const ADIN1140_MAC_RX_BC_FRAME_CNT: c_uint = 0xA2;
pub const ADIN1140_MAC_RX_MC_FRAME_CNT: c_uint = 0xA3;
pub const ADIN1140_MAC_RX_CRC_ERR_CNT: c_uint = 0xA5;
pub const ADIN1140_MAC_RX_ALIGN_ERR_CNT: c_uint = 0xA6;
pub const ADIN1140_MAC_RX_PREAMBLE_ERR_CNT: c_uint = 0xA7;
pub const ADIN1140_MAC_RX_SHORT_ERR_CNT: c_uint = 0xA8;
pub const ADIN1140_MAC_RX_LONG_ERR_CNT: c_uint = 0xA9;
pub const ADIN1140_MAC_RX_PHY_ERR_CNT: c_uint = 0xAA;
pub const ADIN1140_MAC_RX_DRP_FULL_CNT: c_uint = 0xAB;
pub const ADIN1140_MAC_RX_DRP_FILTER_CNT: c_uint = 0xAD;
pub const ADIN1140_MAC_RX_IFG_ERR_CNT: c_uint = 0xAE;
pub const ADIN1140_MAC_TX_FRAME_CNT: c_uint = 0xB1;
pub const ADIN1140_MAC_TX_BC_FRAME_CNT: c_uint = 0xB2;
pub const ADIN1140_MAC_TX_MC_FRAME_CNT: c_uint = 0xB3;
pub const ADIN1140_MAC_TX_SINGLE_COL_CNT: c_uint = 0xB5;
pub const ADIN1140_MAC_TX_MULTI_COL_CNT: c_uint = 0xB6;
pub const ADIN1140_MAC_TX_DEFERRED_CNT: c_uint = 0xB7;
pub const ADIN1140_MAC_TX_LATE_COL_CNT: c_uint = 0xB8;
pub const ADIN1140_MAC_TX_EXCESS_COL_CNT: c_uint = 0xB9;
pub const ADIN1140_MAC_TX_UNDERRUN_CNT: c_uint = 0xBA;
// ADIN1140_MAC_FILT_MAX_SLOT - 3 (multicast, broadcast and unicast
// reserved slots)
//

pub const ADIN1140_PHY_CTRL_DEFAULT: c_uint = 0x1000;
pub const ADIN1140_PHY_STATUS_DEFAULT: c_uint = 0x082D;
pub const ADIN1140_PHY_ID1: c_uint = 0x0283;
pub const ADIN1140_PHY_ID2: c_uint = 0xBE00;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adin1140_statistics_reg {
    pub name: *const c_char,
    pub idx: enum adin1140_statistics_entry,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct adin1140_priv {
...
//
    ...
    pub stats: [u64; ADIN1140_STATS_CNT],
}
...
#[no_mangle]
unsafe extern "C" fn adin1140_mac_filter_clear(priv: *mut adin1140_priv, slot: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin1140_filter_unicast(priv: *mut adin1140_priv) -> c_int {
...
//
    return adin1140_mac_filter_set(priv, priv.netdev.dev_addr, core::ptr::null_mut(),
    ADIN1140_MAC_FILT_UC_SLOT);
    }
#[no_mangle]
unsafe extern "C" fn adin1140_filter_all_multicast(priv: *mut adin1140_priv, en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin1140_filter_broadcast(priv: *mut adin1140_priv, enabled: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin1140_default_filter_config(priv: *mut adin1140_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin1140_promiscuous_mode(priv: *mut adin1140_priv, enabled: bool) -> c_int {
...
//
    ...
    promisc = true;
#[no_mangle]
pub unsafe extern "C" fn if(IFF_ALLMULTI: priv->netdev->flags &) -> else {
...
// The filter table is full. Enable promisc mode.
    ...
    ret = adin1140_mac_filter_set(priv, ha.addr, core::ptr::null_mut(),
    slot);
    if (ret)
    return ret;
    slot++;
...
#[no_mangle]
unsafe extern "C" fn adin1140_stats_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn adin1140_configure(priv: *mut adin1140_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin1140_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin1140_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin1140_set_mac_address(netdev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin1140_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin1140_mdiobus_read(bus: *mut mii_bus, addr: c_int, regnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin1140_handle_link_change(netdev: *mut net_device) {
    static void adin1140_handle_link_change(struct net_device *netdev)
    {
    phy_print_status(netdev.phydev);
    }
#[no_mangle]
unsafe extern "C" fn adin1140_phy_remove(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn adin1140_oa_tc6_remove(data: *mut c_void) {
    static void adin1140_oa_tc6_remove(void *data)
    {
    oa_tc6_exit(data);
    }
#[no_mangle]
unsafe extern "C" fn adin1140_probe(spi: *mut spi_device) -> c_int {
    static int adin1140_probe(struct spi_device *spi)
    {
    let mut tc6_quirks: oa_tc6_quirks = {};
    struct net_device *netdev;
    struct adin1140_priv *priv;
    int ret;
