...
//! Source: drivers/net/ethernet/fealnx.c
#![no_std]
...
pub const TX_RING_SIZE: c_int = 6;
pub const RX_RING_SIZE: c_int = 12;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fealnx_desc {
    pub status: i32,
    pub control: i32,
    pub buffer: u32,
    pub next_desc: u32,
    pub next_desc_logical: *mut fealnx_desc,
...
pub const MASK_MIIR_MII_READ: c_uint = 0x00000000;
pub const MASK_MIIR_MII_WRITE: c_uint = 0x00000008;
pub const MASK_MIIR_MII_MDO: c_uint = 0x00000004;
pub const MASK_MIIR_MII_MDI: c_uint = 0x00000002;
pub const MASK_MIIR_MII_MDC: c_uint = 0x00000001;
// ST+OP+PHYAD+REGAD+TA
pub const OP_READ: c_uint = 0x6000	/* ST:01+OP:10+PHYAD+REGAD+TA:Z0 */;
pub const OP_WRITE: c_uint = 0x5002	/* ST:01+OP:01+PHYAD+REGAD+TA:10 */;
// -------------------------------------------------------------------------
// Constants for Myson PHY
// -------------------------------------------------------------------------
pub const MysonPHYID: c_uint = 0xd0000302;
// 89-7-27 add, (begin)
pub const MysonPHYID0: c_uint = 0x0302;
pub const StatusRegister: c_int = 18;
pub const SPEED100: c_uint = 0x0400	// bit10;
pub const FULLMODE: c_uint = 0x0800	// bit11;
// 89-7-27 add, (end)
// -------------------------------------------------------------------------
// Constants for Seeq 80225 PHY
// -------------------------------------------------------------------------
pub const SeeqPHYID0: c_uint = 0x0016;
pub const MIIRegister18: c_int = 18;
pub const SPD_DET_100: c_uint = 0x80;
pub const DPLX_DET_FULL: c_uint = 0x40;
// -------------------------------------------------------------------------
// Constants for Ahdoc 101 PHY
// -------------------------------------------------------------------------
pub const AhdocPHYID0: c_uint = 0x0022;
pub const DiagnosticReg: c_int = 18;
pub const DPLX_FULL: c_uint = 0x0800;
pub const Speed_100: c_uint = 0x0400;
// 89/6/13 add,
// --------------------------------------------------------------------------
// Constants
// --------------------------------------------------------------------------
pub const MarvellPHYID0: c_uint = 0x0141;
pub const LevelOnePHYID0: c_uint = 0x0013;
pub const MII1000BaseTControlReg: c_int = 9;
pub const MII1000BaseTStatusReg: c_int = 10;
pub const SpecificReg: c_int = 17;
// for 1000BaseT Control Register
pub const PHYAbletoPerform1000FullDuplex: c_uint = 0x0200;
pub const PHYAbletoPerform1000HalfDuplex: c_uint = 0x0100;
pub const PHY1000AbilityMask: c_uint = 0x300;
// for phy specific status register, marvell phy.
pub const SpeedMask: c_uint = 0x0c000;
pub const Speed_1000M: c_uint = 0x08000;
pub const Speed_100M: c_uint = 0x4000;
pub const Speed_10M: c_int = 0;
pub const Full_Duplex: c_uint = 0x2000;
// 89/12/29 add, for phy specific status register, levelone phy, (begin)
pub const LXT1000_100M: c_uint = 0x08000;
pub const LXT1000_1000M: c_uint = 0x0c000;
pub const LXT1000_Full: c_uint = 0x200;
// 89/12/29 add, for phy specific status register, levelone phy, (end)
// for 3-in-1 case, BMCRSR register
pub const LinkIsUp2: c_uint = 0x00040000;
// for PHY
pub const LinkIsUp: c_uint = 0x0004;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct netdev_private {
// Descriptor rings first for alignment.
    pub rx_ring: *mut fealnx_desc,
    pub tx_ring: *mut fealnx_desc,
...
// Reset timer
    ...
    pub reset_timer_armed: c_int,
    pub crvalue_sv: c_ulong,
    pub imrvalue_sv: c_ulong,
// Frequently used values: keep some adjacent for cache effect.
    pub flags: c_int,
    pub pci_dev: *mut pci_dev,
    pub crvalue: c_ulong,
    pub bcrvalue: c_ulong,
    pub imrvalue: c_ulong,
    pub cur_rx: *mut fealnx_desc,
    pub lack_rxbuf: *mut fealnx_desc,
    pub really_rx_count: c_int,
    pub cur_tx: *mut fealnx_desc,
    pub cur_tx_copy: *mut fealnx_desc,
    pub really_tx_count: c_int,
    pub free_tx_count: c_int,
    pub /: *mut *mut unsigned int rx_buf_sz; / Based on MTU+slack.,
// These values are keep track of the transceiver/media in use.
    pub linkok: c_uint,
    pub line_speed: c_uint,
    pub duplexmode: c_uint,
...
#[no_mangle]
unsafe extern "C" fn stop_nic_rx(ioaddr: *mut void __iomem, crvalue: c_long) {
    static void stop_nic_rx(void __iomem *ioaddr, long crvalue)
    {
    let mut delay: c_int = 0x1000;
...
#[no_mangle]
unsafe extern "C" fn stop_nic_rxtx(ioaddr: *mut void __iomem, crvalue: c_long) {
    ...
    void __iomem *ioaddr;
    unsigned long len;
    let mut chip_id: c_uint = ent.driver_data;
...
// get phy type
    ...
    np.PHYType = SeeqPHY;
#[no_mangle]
pub unsafe extern "C" fn if(AhdocPHYID0: data ==) -> else {
    else if (data == AhdocPHYID0)
    np.PHYType = AhdocPHY;
#[no_mangle]
pub unsafe extern "C" fn if(MarvellPHYID0: data ==) -> else {
    else if (data == MarvellPHYID0)
    np.PHYType = MarvellPHY;
#[no_mangle]
pub unsafe extern "C" fn if(MysonPHYID0: data ==) -> else {
    else if (data == MysonPHYID0)
    np.PHYType = Myson981;
#[no_mangle]
pub unsafe extern "C" fn if(LevelOnePHYID0: data ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn fealnx_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn m80x_send_cmd_to_phy(miiport: *mut void __iomem, opcode: c_int, phyad: c_int, regad: c_int) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn mdio_read(dev: *mut net_device, phyad: c_int, regad: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdio_write(dev: *mut net_device, phyad: c_int, regad: c_int, data: c_int) {
...
#[no_mangle]
unsafe extern "C" fn getlinkstatus(dev: *mut net_device) {
    static void getlinkstatus(struct net_device *dev)
...
#[no_mangle]
unsafe extern "C" fn getlinktype(dev: *mut net_device) {
    static void getlinktype(struct net_device *dev)
    {
    struct netdev_private *np = netdev_priv(dev);
...
// 89/6/13 add, (begin)
#[no_mangle]
pub unsafe extern "C" fn if(MarvellPHY: np->PHYType ==) -> else {
    unsigned int data;
...
#[no_mangle]
pub unsafe extern "C" fn if(Speed_100M: data ==) -> else {
...
// 89/7/27 add, (begin)
#[no_mangle]
pub unsafe extern "C" fn if(Myson981: np->PHYType ==) -> else {
    unsigned int data;
...
// 89/12/29 add
#[no_mangle]
pub unsafe extern "C" fn if(LevelOnePHY: np->PHYType ==) -> else {
    unsigned int data;
    data = mdio_read(dev, np.phys[0], SpecificReg);
    ...
    np.line_speed = 3;	/* 1000M */
#[no_mangle]
pub unsafe extern "C" fn if(LXT1000_100M: data ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(3: np->line_speed ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn allocate_rx_buffers(dev: *mut net_device) {
...
unsafe extern "C" fn netdev_timer(t: *mut timer_list) {
    ...
    void __iomem *ioaddr = np.mem;
    let mut old_crvalue: c_int = np.crvalue;
    let mut old_linkok: c_uint = np.linkok;
    unsigned long flags;
    if (debug)
...
#[no_mangle]
unsafe extern "C" fn reset_and_disable_rxtx(dev: *mut net_device) {
    static void reset_and_disable_rxtx(struct net_device *dev)
    {
    struct netdev_private *np = netdev_priv(dev);
    void __iomem *ioaddr = np.mem;
    let mut delay: c_int = 51;
...
#[no_mangle]
unsafe extern "C" fn enable_rxtx(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn reset_timer(t: *mut timer_list) {
    static void reset_timer(struct timer_list *t)
    {
...
#[no_mangle]
unsafe extern "C" fn fealnx_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
    static void fealnx_tx_timeout(struct net_device *dev, unsigned int txqueue)
    {
    struct netdev_private *np = netdev_priv(dev);
    void __iomem *ioaddr = np.mem;
...
// initial rx descriptors.
    ...
    np.rx_ring[i].skbuff = core::ptr::null_mut();
    }
...
// do we need np->tx_ring[i].control = XXX; ??
    ...
    np.tx_ring[i].skbuff = core::ptr::null_mut();
    }
...
// Macro flag: #define one_buffer
pub const BPT: c_int = 1022;
...
#[no_mangle]
unsafe extern "C" fn reset_tx_descriptors(dev: *mut net_device) {
    static void reset_tx_descriptors(struct net_device *dev)
    {
    struct netdev_private *np = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn reset_rx_descriptors(dev: *mut net_device) {
    static void reset_rx_descriptors(struct net_device *dev)
    {
    struct netdev_private *np = netdev_priv(dev);
...
unsafe extern "C" fn intr_handler(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
    ...
    struct netdev_private *np = netdev_priv(dev);
    void __iomem *ioaddr = np.mem;
    let mut boguscnt: c_long = max_interrupt_work;
    let mut num_tx: c_uint = 0;
    let mut handled: c_int = 0;
    spin_lock(&np.lock);
    iowrite32(0, ioaddr + IMR);
    do {
    let mut intr_status: u32 = ioread32(ioaddr + ISR);
...
// crc error
    ...
    let mut tx_status: c_long = np.cur_tx.status;
    let mut tx_control: c_long = np.cur_tx.control;
...
// Free the original skb.
    ...
    np.cur_tx.skbuff = core::ptr::null_mut();
    --np.really_tx_count;
...
// If EOP is set on the next entry, it's a new packet. Send it up.
    ...
    let mut rx_status: i32 = np.cur_rx.status;
    ...
    let mut need_to_reset: c_int = 0;
    let mut desno: c_int = 0;
...
// Omit the four octet CRC from the length.
    let mut pkt_len: c_short = ((rx_status & FLNGMASK) >> FLNGShift) - 4;
...
// Call copy + cksum if available.
    ...
    np.cur_rx.skbuff = core::ptr::null_mut();
    --np.really_rx_count;
    }
...
#[no_mangle]
unsafe extern "C" fn mii_ioctl(dev: *mut net_device, rq: *mut ifreq, cmd: c_int) -> c_int {
    static int mii_ioctl(struct net_device *dev, struct ifreq *rq, int cmd)
    {
    struct netdev_private *np = netdev_priv(dev);
    int rc;
    ...
    return -EINVAL;
    spin_lock_irq(&np.lock);
    rc = generic_mii_ioctl(&np.mii, if_mii(rq), cmd, core::ptr::null_mut());
    spin_unlock_irq(&np.lock);
    return rc;
    }
#[no_mangle]
