...
//! Source: drivers/net/ethernet/alacritech/slicoss.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn slic_next_queue_idx(idx: c_uint, qlen: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slic_next_compl_idx(sdev: *mut slic_device) -> c_uint {
    static unsigned int slic_next_compl_idx(struct slic_device *sdev)
    {
    struct slic_stat_queue *stq = &sdev.stq;
    let mut active: c_uint = stq.active_array;
...
// check for wraparound
    if (!stq.done_idx) {
    let mut paddr: dma_addr_t = stq.paddr[active];
...
#[no_mangle]
unsafe extern "C" fn slic_get_free_tx_descs(txq: *mut slic_tx_queue) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn slic_get_free_rx_descs(rxq: *mut slic_rx_queue) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn slic_clear_upr_list(upr_list: *mut slic_upr_list) {
...
#[no_mangle]
unsafe extern "C" fn slic_start_upr(sdev: *mut slic_device, upr: *mut slic_upr) {
...
#[no_mangle]
unsafe extern "C" fn slic_queue_upr(sdev: *mut slic_device, upr: *mut slic_upr) {
    ...
    {
    struct slic_upr_list *upr_list = &sdev.upr_list;
    struct slic_upr *next_upr = core::ptr::null_mut();
    struct slic_upr *upr = core::ptr::null_mut();
    spin_lock_bh(&upr_list.lock);
...
#[no_mangle]
unsafe extern "C" fn slic_set_mcast_bit(mcmask: *mut u64, addr: *const c_uchar) {
    static void slic_set_mcast_bit(u64 *mcmask, unsigned char const *addr)
    {
    let mut mask: u64 = *mcmask;
    u8 crc;
...
#[no_mangle]
unsafe extern "C" fn slic_configure_rcv(sdev: *mut slic_device) {
...
// must be called with link_lock held
#[no_mangle]
unsafe extern "C" fn slic_configure_xmt(sdev: *mut slic_device) {
...
// must be called with link_lock held
#[no_mangle]
unsafe extern "C" fn slic_configure_mac(sdev: *mut slic_device) {
...
#[no_mangle]
unsafe extern "C" fn slic_set_rx_mode(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn slic_xmit_complete(sdev: *mut slic_device) {
    static void slic_xmit_complete(struct slic_device *sdev)
    {
    struct slic_tx_queue *txq = &sdev.txq;
    struct net_device *dev = sdev.netdev;
    struct slic_tx_buffer *buff;
    let mut frames: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn slic_refill_rx_queue(sdev: *mut slic_device, gfp: gfp_t) {
    static void slic_refill_rx_queue(struct slic_device *sdev, gfp_t gfp)
    {
    let mut ALIGN_MASK: c_uint = SLIC_RX_BUFF_ALIGN - 1;
    let mut maplen: c_uint = SLIC_RX_BUFF_SIZE;
...
// transport layer
    ...
    let mut xerr: u32 = status >> SLIC_VGBSTAT_XERRSHFT;
...
// link layer
    ...
    let mut lerr: u32 = status & SLIC_VGBSTAT_LERRMSK;
...
#[no_mangle]
unsafe extern "C" fn slic_handle_link_irq(sdev: *mut slic_device) {
    ...
    speed = SPEED_1000;
#[no_mangle]
pub unsafe extern "C" fn if(SLIC_GIG_SPEED_100: link &) -> else {
...
#[no_mangle]
unsafe extern "C" fn slic_handle_upr_irq(sdev: *mut slic_device, irqs: u32) {
...
#[no_mangle]
unsafe extern "C" fn slic_handle_link_change(sdev: *mut slic_device) -> c_int {
    static int slic_handle_link_change(struct slic_device *sdev)
    {
    return slic_new_upr(sdev, SLIC_UPR_LSTAT, sdev.shmem.link_paddr);
    }
#[no_mangle]
unsafe extern "C" fn slic_handle_err_irq(sdev: *mut slic_device, isr: u32) {
...
#[no_mangle]
unsafe extern "C" fn slic_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn slic_card_reset(sdev: *mut slic_device) {
...
#[no_mangle]
unsafe extern "C" fn slic_init_stat_queue(sdev: *mut slic_device) -> c_int {
    static int slic_init_stat_queue(struct slic_device *sdev)
    {
    let mut DESC_ALIGN_MASK: c_uint = SLIC_STATS_DESC_ALIGN - 1;
    struct slic_stat_queue *stq = &sdev.stq;
    struct slic_stat_desc *descs;
    unsigned int misalign;
    unsigned int offset;
...
#[no_mangle]
unsafe extern "C" fn slic_free_stat_queue(sdev: *mut slic_device) {
...
#[no_mangle]
unsafe extern "C" fn slic_init_tx_queue(sdev: *mut slic_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slic_free_tx_queue(sdev: *mut slic_device) {
...
#[no_mangle]
unsafe extern "C" fn slic_init_rx_queue(sdev: *mut slic_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slic_free_rx_queue(sdev: *mut slic_device) {
...
#[no_mangle]
unsafe extern "C" fn slic_set_link_autoneg(sdev: *mut slic_device) {
    static void slic_set_link_autoneg(struct slic_device *sdev)
    {
    let mut subid: c_uint = sdev.pdev.subsystem_device;
    u32 val;
    if (sdev.is_fiber) {
...
#[no_mangle]
unsafe extern "C" fn slic_set_mac_address(sdev: *mut slic_device) {
...
#[no_mangle]
unsafe extern "C" fn slic_read_dword_from_firmware(fw: *const firmware, offset: *mut c_int) -> u32 {
    static u32 slic_read_dword_from_firmware(const struct firmware *fw, int *offset)
    {
    let mut idx: c_int = *offset;
    __le32 val;
...
#[no_mangle]
unsafe extern "C" fn slic_load_rcvseq_firmware(sdev: *mut slic_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slic_load_firmware(sdev: *mut slic_device) -> c_int {
...
// get sections
    ...
    let mut ssize: c_uint = sectsize[sect] >> 3;
    base = sectstart[sect];
...
#[no_mangle]
unsafe extern "C" fn slic_init_shmem(sdev: *mut slic_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slic_free_shmem(sdev: *mut slic_device) {
...
#[no_mangle]
unsafe extern "C" fn slic_init_iface(sdev: *mut slic_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slic_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slic_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slic_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn slic_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slic_get_strings(dev: *mut net_device, stringset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn slic_eeprom_csum(eeprom: *mut c_uchar, len: c_uint) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn slic_eeprom_valid(eeprom: *mut c_uchar, size: c_uint) -> bool {
    static bool slic_eeprom_valid(unsigned char *eeprom, unsigned int size)
    {
    let mut MAX_SIZE: c_uint = 128;
    let mut MIN_SIZE: c_uint = 98;
    __le16 magic;
    __le16 csum;
...
#[no_mangle]
unsafe extern "C" fn slic_read_eeprom(sdev: *mut slic_device) -> c_int {
    static int slic_read_eeprom(struct slic_device *sdev)
    {
    let mut devfn: c_uint = PCI_FUNC(sdev.pdev.devfn);
    struct slic_shmem *sm = &sdev.shmem;
    struct slic_shmem_data *sm_data = sm.shmem_data;
    let mut MAX_LOOPS: c_uint = 5000;
...
#[no_mangle]
unsafe extern "C" fn slic_init(sdev: *mut slic_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slic_is_fiber(subdev: c_ushort) -> bool {
...
#[no_mangle]
unsafe extern "C" fn slic_configure_pci(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn slic_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn slic_remove(pdev: *mut pci_dev) {
