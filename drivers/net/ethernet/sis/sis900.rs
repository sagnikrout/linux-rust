...
//! Source: drivers/net/ethernet/sis/sis900.h
#![no_std]
...
pub const SIS900_TOTAL_SIZE: c_uint = 0x100;
// Symbolic offsets to registers.
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_registers {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_command_register_bits {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_configuration_register_bits {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_eeprom_access_register_bits {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_interrupt_register_bits {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_interrupt_enable_register_bits {
    IE = 0x00000001
}

// maximum dma burst for transmission and receive

pub const TxMXDMA_shift: c_int = 20;
pub const RxMXDMA_shift: c_int = 20;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_tx_rx_dma {
    DMA_BURST_512 = 0,	DMA_BURST_64 = 5
}

// transmit FIFO thresholds

pub const TxFILLT_shift: c_int = 8;
pub const TxDRNT_shift: c_int = 0;

#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_transmit_config_register_bits {
...
pub const RxDRNT_shift: c_int = 1;

#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_reveive_config_register_bits {
    RxAEP  = 0x80000000, RxARP = 0x40000000, RxATX = 0x10000000,
    RxAJAB = 0x08000000, RxDRNT = 0x0000007F
}

pub const RFAA_shift: c_int = 28;
pub const RFADDR_shift: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_receive_filter_control_register_bits {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_reveive_filter_data_mask {
    RFDAT =  0x0000FFFF
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_eeprom_address {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_eeprom_command {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis96x_eeprom_command {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_cfgpmc_register_bits {
    PMVER	= 0x00070000,
    DSI	= 0x00100000,
    PMESP	= 0xf8000000
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_cfgpmcsr_register_bits {
    PMESTS = 0x00004000,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_power_management_control_register_bits {
    LINKLOSS  = 0x00000001,
    LINKON    = 0x00000002,
    MAGICPKT  = 0x00000400,
...
pub const MIIread: c_uint = 0x6000;
pub const MIIwrite: c_uint = 0x5002;
pub const MIIpmdShift: c_int = 7;
pub const MIIregShift: c_int = 2;
pub const MIIcmdLen: c_int = 16;
pub const MIIcmdShift: c_int = 16;
// Buffer Descriptor Status
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_buffer_status {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_tx_buffer_status {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis900_rx_buffer_status {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mii_control_register_bits {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mii_status_register_bits {
...
pub const MII_ID1_OUI_LO: c_uint = 0xFC00	/* low bits of OUI mask */;
pub const MII_ID1_MODEL: c_uint = 0x03F0	/* model number */;
pub const MII_ID1_REV: c_uint = 0x000F	/* model number */;
// MII NWAY Register Bits ...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mii_nway_register_bits {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mii_stsout_register_bits {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mii_stsics_register_bits {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mii_stssum_register_bits {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sis630_revision_id {
    SIS630A0    = 0x00, SIS630A1      = 0x01,
    SIS630B0    = 0x10, SIS630B1      = 0x11
}

pub const FDX_CAPABLE_DUPLEX_UNKNOWN: c_int = 0;
pub const FDX_CAPABLE_HALF_SELECTED: c_int = 1;
pub const FDX_CAPABLE_FULL_SELECTED: c_int = 2;
pub const HW_SPEED_UNCONFIG: c_int = 0;
pub const HW_SPEED_HOME: c_int = 1;
pub const HW_SPEED_10_MBPS: c_int = 10;
pub const HW_SPEED_100_MBPS: c_int = 100;

pub const CRC_SIZE: c_int = 4;
pub const MAC_HEADER_SIZE: c_int = 14;

pub const MAX_FRAME_SIZE: c_int = 1518;

// PCI stuff, should be move to pci.h
pub const SIS630_VENDOR_ID: c_uint = 0x1039;
pub const SIS630_DEVICE_ID: c_uint = 0x0630;
