...
//! Source: drivers/net/ethernet/google/gve/gve_flow_rule.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn gve_get_flow_rule_entry(priv: *mut gve_priv, cmd: *mut ethtool_rxnfc) -> c_int {
    ...
    struct gve_adminq_queried_flow_rule *rule = core::ptr::null_mut();
    let mut err: c_int = 0;
    u32 i;
...
#[no_mangle]
pub unsafe extern "C" fn gve_get_flow_rule_ids(priv: *mut gve_priv, cmd: *mut ethtool_rxnfc, rule_locs: *mut u32) -> c_int {
    ...
    let mut starting_rule_id: u32 = 0;
    let mut i: u32 = 0, j = 0;
    let mut err: c_int = 0;
    if (!priv.max_flow_rules)
    return -EOPNOTSUPP;
...
#[no_mangle]
pub unsafe extern "C" fn gve_add_flow_rule(priv: *mut gve_priv, cmd: *mut ethtool_rxnfc) -> c_int {
    int gve_add_flow_rule(struct gve_priv *priv, struct ethtool_rxnfc *cmd)
    {
    struct ethtool_rx_flow_spec *fsp = &cmd.fs;
    struct gve_adminq_flow_rule *rule = core::ptr::null_mut();
    int err;
    if (!priv.max_flow_rules)
    return -EOPNOTSUPP;
...
#[no_mangle]
pub unsafe extern "C" fn gve_del_flow_rule(priv: *mut gve_priv, cmd: *mut ethtool_rxnfc) -> c_int {
