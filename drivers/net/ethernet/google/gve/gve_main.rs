...
//! Source: drivers/net/ethernet/google/gve/gve_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gve_verify_driver_compatibility(priv: *mut gve_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_start_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn gve_get_stats(dev: *mut net_device, s: *mut rtnl_link_stats64) {
...
#[no_mangle]
unsafe extern "C" fn gve_alloc_flow_rule_caches(priv: *mut gve_priv) -> c_int {
    ...
    flow_rules_cache.rules_cache = core::ptr::null_mut();
    return err;
    }
#[no_mangle]
unsafe extern "C" fn gve_free_flow_rule_caches(priv: *mut gve_priv) {
    static void gve_free_flow_rule_caches(struct gve_priv *priv)
    {
    struct gve_flow_rules_cache *flow_rules_cache = &priv.flow_rules_cache;
    kvfree(flow_rules_cache.rule_ids_cache);
    flow_rules_cache.rule_ids_cache = core::ptr::null_mut();
    kvfree(flow_rules_cache.rules_cache);
    flow_rules_cache.rules_cache = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn gve_alloc_rss_config_cache(priv: *mut gve_priv) -> c_int {
    ...
    rss_config.hash_key = core::ptr::null_mut();
    return -ENOMEM;
    }
#[no_mangle]
unsafe extern "C" fn gve_free_rss_config_cache(priv: *mut gve_priv) {
...
#[no_mangle]
unsafe extern "C" fn gve_alloc_counter_array(priv: *mut gve_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_free_counter_array(priv: *mut gve_priv) {
    ...
    priv.counter_array = core::ptr::null_mut();
    }
// NIC requests to report stats
#[no_mangle]
unsafe extern "C" fn gve_stats_report_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn gve_stats_report_schedule(priv: *mut gve_priv) {
...
#[no_mangle]
unsafe extern "C" fn gve_stats_report_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn gve_alloc_stats_report(priv: *mut gve_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_free_stats_report(priv: *mut gve_priv) {
    ...
    priv.stats_report = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn gve_mgmnt_intr(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gve_intr(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gve_intr_dqo(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gve_is_napi_on_home_cpu(priv: *mut gve_priv, irq: u32) -> c_int {
    static int gve_is_napi_on_home_cpu(struct gve_priv *priv, u32 irq)
    {
    let mut cpu_curr: c_int = smp_processor_id();
...
#[no_mangle]
pub unsafe extern "C" fn gve_napi_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: budget) -> else {
    else if (budget)
...
#[no_mangle]
pub unsafe extern "C" fn gve_napi_poll_dqo(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_alloc_notify_blocks(priv: *mut gve_priv) -> c_int {
    static int gve_alloc_notify_blocks(struct gve_priv *priv)
    {
    let mut num_vecs_requested: c_int = priv.num_ntfy_blks + 1;
    ...
    let mut new_num_ntfy_blks: c_int = (vecs_enabled - 1) & ~0x1;
    let mut vecs_per_type: c_int = new_num_ntfy_blks / 2;
    let mut vecs_left: c_int = new_num_ntfy_blks % 2;
...
//
    ...
    priv.ntfy_blocks = core::ptr::null_mut();
    abort_with_irq_db_indices:
    dma_free_coherent(&priv.pdev.dev, priv.num_ntfy_blks *
    sizeof(*priv.irq_db_indices),
    priv.irq_db_indices, priv.irq_db_indices_bus);
    priv.irq_db_indices = core::ptr::null_mut();
    ...
    priv.msix_vectors = core::ptr::null_mut();
    return err;
    }
#[no_mangle]
unsafe extern "C" fn gve_free_notify_blocks(priv: *mut gve_priv) {
...
#[no_mangle]
unsafe extern "C" fn gve_setup_device_resources(priv: *mut gve_priv) -> c_int {
    ...
    priv.ptype_lut_dqo = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn gve_teardown_device_resources(priv: *mut gve_priv) {
...
#[no_mangle]
unsafe extern "C" fn gve_register_qpls(priv: *mut gve_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_unregister_qpls(priv: *mut gve_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_create_rings(priv: *mut gve_priv) -> c_int {
    static int gve_create_rings(struct gve_priv *priv)
    {
    let mut num_tx_queues: c_int = gve_num_tx_queues(priv);
    int err;
    int i;
...
#[no_mangle]
unsafe extern "C" fn init_xdp_sync_stats(priv: *mut gve_priv) {
    static void init_xdp_sync_stats(struct gve_priv *priv)
    {
    let mut start_id: c_int = gve_xdp_tx_start_queue_id(priv);
    int i;
// Init stats
    for (i = start_id; i < start_id + priv.tx_cfg.num_xdp_queues; i++) {
    let mut ntfy_idx: c_int = gve_tx_idx_to_ntfy(priv, i);
    u64_stats_init(&priv.tx[i].statss);
    priv.tx[i].ntfy_id = ntfy_idx;
    }
    }
#[no_mangle]
unsafe extern "C" fn gve_init_sync_stats(priv: *mut gve_priv) {
...
#[no_mangle]
unsafe extern "C" fn gve_tx_stop_rings(priv: *mut gve_priv, num_rings: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gve_tx_start_rings(priv: *mut gve_priv, num_rings: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gve_destroy_rings(priv: *mut gve_priv) -> c_int {
...
// dma = dma_map_page(dev, *page, 0, PAGE_SIZE, dir);
    ...
    qpl.page_buses = core::ptr::null_mut();
    free_pages:
    kvfree(qpl.pages);
    qpl.pages = core::ptr::null_mut();
    free_qpl:
    kvfree(qpl);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn gve_schedule_reset(priv: *mut gve_priv) {
...
#[no_mangle]
unsafe extern "C" fn gve_unreg_xsk_pool(priv: *mut gve_priv, qid: u16) {
    ...
    return;
    rx = &priv.rx[qid];
    rx.xsk_pool = core::ptr::null_mut();
    if (xdp_rxq_info_is_reg(&rx.xdp_rxq))
    xdp_rxq_info_unreg_mem_model(&rx.xdp_rxq);
    if (!priv.tx)
    return;
    priv.tx[gve_xdp_tx_queue_id(priv, qid)].xsk_pool = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn gve_unreg_xdp_info(priv: *mut gve_priv) {
...
#[no_mangle]
unsafe extern "C" fn gve_reg_xdp_info(priv: *mut gve_priv, dev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: gve_is_qpl(priv)) -> else {
...
#[no_mangle]
unsafe extern "C" fn gve_drain_page_cache(priv: *mut gve_priv) {
...
#[no_mangle]
unsafe extern "C" fn gve_rx_start_ring(priv: *mut gve_priv, i: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gve_rx_start_rings(priv: *mut gve_priv, num_rings: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gve_rx_stop_ring(priv: *mut gve_priv, i: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gve_rx_stop_rings(priv: *mut gve_priv, num_rings: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gve_queues_mem_remove(priv: *mut gve_priv) {
    static void gve_queues_mem_remove(struct gve_priv *priv)
    {
    let mut tx_alloc_cfg: gve_tx_alloc_rings_cfg = {0};
    let mut rx_alloc_cfg: gve_rx_alloc_rings_cfg = {0};
    gve_get_curr_alloc_cfgs(priv, &tx_alloc_cfg, &rx_alloc_cfg);
    gve_queues_mem_free(priv, &tx_alloc_cfg, &rx_alloc_cfg);
    priv.tx = core::ptr::null_mut();
    priv.rx = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn gve_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_queues_stop(priv: *mut gve_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_handle_link_status(priv: *mut gve_priv, link_status: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(!prog: old_prog &&) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(GVE_DQO_RDA_FORMAT: priv->queue_format ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn gve_xsk_wakeup(dev: *mut net_device, queue_id: u32, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_xdp(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gve_init_rss_config(priv: *mut gve_priv, num_queues: u16) -> c_int {
    int gve_init_rss_config(struct gve_priv *priv, u16 num_queues)
    {
    struct gve_rss_config *rss_config = &priv.rss_config;
    let mut rxfh: ethtool_rxfh_param = {0};
    u16 i;
    if (!priv.cache_rss_config)
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn gve_flow_rules_reset(priv: *mut gve_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_turndown(priv: *mut gve_priv) {
    static void gve_turndown(struct gve_priv *priv)
    {
    int idx;
...
// Disable napi to prevent more work from coming in
    ...
    let mut ntfy_idx: c_int = gve_tx_idx_to_ntfy(priv, idx);
    struct gve_notify_block *block = &priv.ntfy_blocks[ntfy_idx];
    if (!gve_tx_was_added_to_block(priv, idx))
    continue;
    if (idx < priv.tx_cfg.num_queues)
    netif_queue_set_napi(priv.dev, idx,
    NETDEV_QUEUE_TYPE_TX, core::ptr::null_mut());
    napi_disable_locked(&block.napi);
    }
    for (idx = 0; idx < priv.rx_cfg.num_queues; idx++) {
    let mut ntfy_idx: c_int = gve_rx_idx_to_ntfy(priv, idx);
    struct gve_notify_block *block = &priv.ntfy_blocks[ntfy_idx];
...
#[no_mangle]
unsafe extern "C" fn gve_turnup(priv: *mut gve_priv) {
    static void gve_turnup(struct gve_priv *priv)
    {
    int idx;
// Start the tx queues
...
#[no_mangle]
unsafe extern "C" fn gve_turnup_and_check_status(priv: *mut gve_priv) {
...
#[no_mangle]
unsafe extern "C" fn gve_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gve_header_split_supported(priv: *const gve_priv) -> bool {
    ...
    struct gve_rx_alloc_rings_cfg *rx_alloc_cfg)
    {
    let mut old_rx_buf_len: u32 = rx_alloc_cfg.packet_buffer_size;
...
// device options may not always contain support for 4K buffers
    ...
    netdev_features_t features)
    {
    let mut orig_features: netdev_features_t = netdev.features;
    let mut tx_alloc_cfg: gve_tx_alloc_rings_cfg = {0};
    let mut rx_alloc_cfg: gve_rx_alloc_rings_cfg = {0};
...
#[no_mangle]
unsafe extern "C" fn gve_handle_status(priv: *mut gve_priv, status: u32) {
...
#[no_mangle]
unsafe extern "C" fn gve_handle_reset(priv: *mut gve_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn gve_handle_report_stats(priv: *mut gve_priv) {
...
#[no_mangle]
unsafe extern "C" fn gve_service_task(work: *mut work_struct) {
    static void gve_service_task(struct work_struct *work)
    {
    struct gve_priv *priv = container_of(work, struct gve_priv,
    service_task);
    let mut status: u32 = ioread32be(&priv.reg_bar0.device_status);
    gve_handle_status(priv, status);
    gve_handle_reset(priv);
    gve_handle_link_status(priv, GVE_DEVICE_STATUS_LINK_STATUS_MASK & status);
    }
#[no_mangle]
unsafe extern "C" fn gve_set_netdev_xdp_features(priv: *mut gve_priv) {
...
#[no_mangle]
unsafe extern "C" fn gve_init_priv(priv: *mut gve_priv, skip_describe_device: bool) -> c_int {
...
// DQO supports HW-GRO and UDP_GSO
    let mut additional_features: u64 = NETIF_F_GRO_HW | NETIF_F_GSO_UDP_L4;
...
// Big TCP is only supported on DQO
    ...
    priv.xsk_pools = core::ptr::null_mut();
    err:
    gve_adminq_free(priv);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn gve_teardown_priv_resources(priv: *mut gve_priv) {
...
#[no_mangle]
unsafe extern "C" fn gve_trigger_reset(priv: *mut gve_priv) {
    static void gve_trigger_reset(struct gve_priv *priv)
    {
...
#[no_mangle]
unsafe extern "C" fn gve_reset_and_teardown(priv: *mut gve_priv, was_up: bool) {
    static void gve_reset_and_teardown(struct gve_priv *priv, bool was_up)
    {
    gve_trigger_reset(priv);
...
#[no_mangle]
unsafe extern "C" fn gve_reset_recovery(priv: *mut gve_priv, was_up: bool) -> c_int {
    static int gve_reset_recovery(struct gve_priv *priv, bool was_up)
    {
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn gve_reset(priv: *mut gve_priv, attempt_teardown: bool) -> c_int {
    int gve_reset(struct gve_priv *priv, bool attempt_teardown)
    {
    let mut was_up: bool = netif_running(priv.dev);
    int err;
...
#[no_mangle]
unsafe extern "C" fn gve_write_version(driver_version_register: *mut u8 __iomem) {
...
#[no_mangle]
unsafe extern "C" fn gve_rx_queue_stop(dev: *mut net_device, per_q_mem: *mut c_void, idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_rx_queue_mem_free(dev: *mut net_device, per_q_mem: *mut c_void) {
    static void gve_rx_queue_mem_free(struct net_device *dev, void *per_q_mem)
    {
    struct gve_priv *priv = netdev_priv(dev);
    let mut cfg: gve_rx_alloc_rings_cfg = {0};
    struct gve_rx_ring *gve_per_q_mem;
    gve_per_q_mem = (struct gve_rx_ring *)per_q_mem;
...
#[no_mangle]
unsafe extern "C" fn gve_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn gve_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn gve_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_resume(dev: *mut device) -> c_int {
