...
//! Source: drivers/net/ethernet/google/gve/gve_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gve_set_msglevel(netdev: *mut net_device, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn gve_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gve_get_strings(netdev: *mut net_device, stringset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn gve_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
    ...
    let mut num_stopped_rxqs: c_int = 0;
    let mut num_stopped_txqs: c_int = 0;
...
// Preprocess the stats report for rx, map queue id to start index
    ...
    let mut stat_name: u32 = be32_to_cpu(report_stats[stats_idx].stat_name);
    let mut queue_id: u32 = be32_to_cpu(report_stats[stats_idx].queue_id);
    if (stat_name == 0) {
...
// AQ Stats
    ...
    {
    struct gve_priv *priv = netdev_priv(netdev);
    let mut new_tx_cfg: gve_tx_queue_config = priv.tx_cfg;
    let mut new_rx_cfg: gve_rx_queue_config = priv.rx_cfg;
    struct ethtool_channels old_settings;
    let mut new_tx: c_int = cmd.tx_count;
    let mut new_rx: c_int = cmd.rx_count;
    let mut reset_rss: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: priv->header_split_enabled) -> else {
...
#[no_mangle]
unsafe extern "C" fn gve_user_reset(netdev: *mut net_device, flags: *mut u32) -> c_int {
...
// (u32 *)value = priv->rx_copybreak;
    ...
    case ETHTOOL_RX_COPYBREAK:
    {
    let mut max_copybreak: u32 = priv.rx_cfg.packet_buffer_size;
    len = *(u32 *)value;
...
#[no_mangle]
unsafe extern "C" fn gve_get_priv_flags(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gve_set_priv_flags(netdev: *mut net_device, flags: u32) -> c_int {
...
// delete report stats timer.
    ...
    {
    struct gve_priv *priv = netdev_priv(netdev);
    let mut tx_usecs_orig: u32 = priv.tx_coalesce_usecs;
    let mut rx_usecs_orig: u32 = priv.rx_coalesce_usecs;
    int idx;
    if (gve_is_gqi(priv))
    return -EOPNOTSUPP;
...
#[no_mangle]
unsafe extern "C" fn gve_set_rxnfc(netdev: *mut net_device, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_get_rx_ring_count(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gve_get_rxnfc(netdev: *mut net_device, cmd: *mut ethtool_rxnfc, rule_locs: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gve_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gve_get_rxfh_indir_size(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gve_get_rxfh(netdev: *mut net_device, rxfh: *mut ethtool_rxfh_param) -> c_int {
