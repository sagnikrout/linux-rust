...
//! Source: drivers/net/ethernet/oki-semi/pch_gbe/pch_gbe_ethtool.c
#![no_std]
...
pub const PCH_GBE_QUEUE_STATS_LEN: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_get_regs_len(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_nway_reset(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pch_gbe_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pch_gbe_set_ethtool_ops(netdev: *mut net_device) {
