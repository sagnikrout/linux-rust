...
//! Source: drivers/net/ethernet/oki-semi/pch_gbe/pch_gbe_main.c
#![no_std]
...
pub const PCH_GBE_MAR_ENTRIES: c_int = 16;
pub const PCH_GBE_SHORT_PKT: c_int = 64;
pub const DSC_INIT16: c_uint = 0xC000;
pub const PCH_GBE_DMA_ALIGN: c_int = 0;
pub const PCH_GBE_DMA_PADDING: c_int = 2;

pub const PCH_GBE_PCI_BAR: c_int = 1;
pub const PCH_GBE_RESERVE_MEMORY: c_uint = 0x200000	/* 2MB */;
pub const PCI_DEVICE_ID_INTEL_IOH1_GBE: c_uint = 0x8802;
pub const PCI_DEVICE_ID_ROHM_ML7223_GBE: c_uint = 0x8013;
pub const PCI_DEVICE_ID_ROHM_ML7831_GBE: c_uint = 0x8802;
pub const PCH_GBE_RX_BUFFER_WRITE: c_int = 16;
...
pub const PCH_GBE_MAX_RX_BUFFER_SIZE: c_uint = 0x2880;
pub const PCH_GBE_MAX_JUMBO_FRAME_SIZE: c_int = 10318;
pub const PCH_GBE_FRAME_SIZE_2048: c_int = 2048;
pub const PCH_GBE_FRAME_SIZE_4096: c_int = 4096;
pub const PCH_GBE_FRAME_SIZE_8192: c_int = 8192;

    ((((R).next_to_clean > (R).next_to_use) ? 0 : (R).count) + \
    (R).next_to_clean - (R).next_to_use - 1)
// Pause packet value
pub const PCH_GBE_PAUSE_PKT1_VALUE: c_uint = 0x00C28001;
pub const PCH_GBE_PAUSE_PKT2_VALUE: c_uint = 0x00000100;
pub const PCH_GBE_PAUSE_PKT4_VALUE: c_uint = 0x01000888;
pub const PCH_GBE_PAUSE_PKT5_VALUE: c_uint = 0x0000FFFF;
...
pub const PCH_GBE_INT_DISABLE_ALL: c_int = 0;
// Macros for ieee1588
...
#[no_mangle]
unsafe extern "C" fn pch_ptp_match(skb: *mut sk_buff, uid_hi: u16, uid_lo: u32, seqid: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pch_gbe_mac_load_mac_addr(hw: *mut pch_gbe_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_mac_read_mac_addr(hw: *mut pch_gbe_hw) -> i32 {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_wait_clr_bit(reg: *mut void __iomem, bit: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_mac_mar_set(hw: *mut pch_gbe_hw, addr: *mut *mut u8, index: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_mac_reset_hw(hw: *mut pch_gbe_hw) {
...
#[no_mangle]
unsafe extern "C" fn pch_gbe_disable_mac_rx(hw: *mut pch_gbe_hw) {
...
#[no_mangle]
unsafe extern "C" fn pch_gbe_enable_mac_rx(hw: *mut pch_gbe_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_mac_init_rx_addrs(hw: *mut pch_gbe_hw, mar_count: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_gbe_mac_force_mac_fc(hw: *mut pch_gbe_hw) -> i32 {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_mac_set_wol_event(hw: *mut pch_gbe_hw, wu_evt: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_mac_set_pause_packet(hw: *mut pch_gbe_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_alloc_queues(adapter: *mut pch_gbe_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_init_stats(adapter: *mut pch_gbe_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_init_phy(adapter: *mut pch_gbe_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_mdio_read(netdev: *mut net_device, addr: c_int, reg: c_int) -> c_int {
    static int pch_gbe_mdio_read(struct net_device *netdev, int addr, int reg)
    {
    struct pch_gbe_adapter *adapter = netdev_priv(netdev);
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_reset_task(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_gbe_reinit_locked(adapter: *mut pch_gbe_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_gbe_reset(adapter: *mut pch_gbe_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_free_irq(adapter: *mut pch_gbe_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_irq_disable(adapter: *mut pch_gbe_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_irq_enable(adapter: *mut pch_gbe_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_setup_tctl(adapter: *mut pch_gbe_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_configure_tx(adapter: *mut pch_gbe_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_setup_rctl(adapter: *mut pch_gbe_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_configure_rx(adapter: *mut pch_gbe_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_watchdog(t: *mut timer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_gbe_update_stats(adapter: *mut pch_gbe_adapter) {
...
#[no_mangle]
unsafe extern "C" fn pch_gbe_disable_dma_rx(hw: *mut pch_gbe_hw) {
...
#[no_mangle]
unsafe extern "C" fn pch_gbe_enable_dma_rx(hw: *mut pch_gbe_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// align
    ...
    rx_ring.rx_buff_pool = core::ptr::null_mut();
    }
//
...
//
    ...
    struct sk_buff *skb;
    unsigned int i;
    let mut cleaned_count: c_uint = 0;
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_request_irq(adapter: *mut pch_gbe_adapter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_gbe_up(adapter: *mut pch_gbe_adapter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pch_gbe_down(adapter: *mut pch_gbe_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_sw_init(adapter: *mut pch_gbe_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_open(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_stop(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_xmit_frame(skb: *mut sk_buff, netdev: *mut net_device) -> netdev_tx_t {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_set_multi(netdev: *mut net_device) {
    static void pch_gbe_set_multi(struct net_device *netdev)
    {
    struct pch_gbe_adapter *adapter = netdev_priv(netdev);
    struct pch_gbe_hw *hw = &adapter.hw;
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_set_mac(netdev: *mut net_device, addr: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
    static int pch_gbe_change_mtu(struct net_device *netdev, int new_mtu)
    {
    struct pch_gbe_adapter *adapter = netdev_priv(netdev);
    let mut max_frame: c_int = new_mtu + ETH_HLEN + ETH_FCS_LEN;
    let mut old_rx_buffer_len: c_ulong = adapter.rx_buffer_len;
    int err;
    if (max_frame <= PCH_GBE_FRAME_SIZE_2048)
    adapter.rx_buffer_len = PCH_GBE_FRAME_SIZE_2048;
#[no_mangle]
pub unsafe extern "C" fn if(PCH_GBE_FRAME_SIZE_4096: max_frame <=) -> else {
    else if (max_frame <= PCH_GBE_FRAME_SIZE_4096)
    adapter.rx_buffer_len = PCH_GBE_FRAME_SIZE_4096;
#[no_mangle]
pub unsafe extern "C" fn if(PCH_GBE_FRAME_SIZE_8192: max_frame <=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_ioctl(netdev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
    static int pch_gbe_ioctl(struct net_device *netdev, struct ifreq *ifr, int cmd)
    {
    struct pch_gbe_adapter *adapter = netdev_priv(netdev);
    netdev_dbg(netdev, "cmd : 0x%04x\n", cmd);
    return generic_mii_ioctl(&adapter.mii, if_mii(ifr), cmd, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_napi_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int pch_gbe_napi_poll(struct napi_struct *napi, int budget)
    {
    struct pch_gbe_adapter *adapter =
    container_of(napi, struct pch_gbe_adapter, napi);
    let mut work_done: c_int = 0;
    let mut poll_end_flag: bool = false;
    let mut cleaned: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_netpoll(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn pch_gbe_io_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn pch_gbe_io_resume(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn __pch_gbe_suspend(pdev: *mut pci_dev) -> c_int {
    static int __pch_gbe_suspend(struct pci_dev *pdev)
    {
    struct net_device *netdev = pci_get_drvdata(pdev);
    struct pch_gbe_adapter *adapter = netdev_priv(netdev);
    struct pch_gbe_hw *hw = &adapter.hw;
    let mut wufc: u32 = adapter.wake_up_evt;
    netif_device_detach(netdev);
    if (netif_running(netdev))
    pch_gbe_down(adapter);
    if (wufc) {
...
#[no_mangle]
unsafe extern "C" fn pch_gbe_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pch_gbe_resume(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pch_gbe_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pch_gbe_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pch_gbe_gpio_remove_table(table: *mut c_void) {
    static void pch_gbe_gpio_remove_table(void *table)
    {
    gpiod_remove_lookup_table(table);
    }
#[no_mangle]
unsafe extern "C" fn pch_gbe_gpio_add_table(dev: *mut device, table: *mut c_void) -> c_int {
    ...
    .dev_id		= "0000:02:00.1",
    .table		= {
    GPIO_LOOKUP("sch_gpio.33158", 13, core::ptr::null_mut(), GPIO_ACTIVE_LOW),
    {}
    },
    };
...
//
#[no_mangle]
unsafe extern "C" fn pch_gbe_minnow_platform_init(pdev: *mut pci_dev) -> c_int {
    ...
    if (ret)
    return ret;
    gpiod = devm_gpiod_get(&pdev.dev, core::ptr::null_mut(), GPIOD_OUT_HIGH);
    if (IS_ERR(gpiod))
