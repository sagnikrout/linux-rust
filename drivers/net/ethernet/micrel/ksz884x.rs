...
//! Source: drivers/net/ethernet/micrel/ksz884x.c
#![no_std]
...
// DMA Registers
pub const KS_DMA_TX_CTRL: c_uint = 0x0000;
pub const DMA_TX_ENABLE: c_uint = 0x00000001;
pub const DMA_TX_CRC_ENABLE: c_uint = 0x00000002;
pub const DMA_TX_PAD_ENABLE: c_uint = 0x00000004;
pub const DMA_TX_LOOPBACK: c_uint = 0x00000100;
pub const DMA_TX_FLOW_ENABLE: c_uint = 0x00000200;
pub const DMA_TX_CSUM_IP: c_uint = 0x00010000;
pub const DMA_TX_CSUM_TCP: c_uint = 0x00020000;
pub const DMA_TX_CSUM_UDP: c_uint = 0x00040000;
pub const DMA_TX_BURST_SIZE: c_uint = 0x3F000000;
pub const KS_DMA_RX_CTRL: c_uint = 0x0004;
pub const DMA_RX_ENABLE: c_uint = 0x00000001;
pub const KS884X_DMA_RX_MULTICAST: c_uint = 0x00000002;
pub const DMA_RX_PROMISCUOUS: c_uint = 0x00000004;
pub const DMA_RX_ERROR: c_uint = 0x00000008;
pub const DMA_RX_UNICAST: c_uint = 0x00000010;
pub const DMA_RX_ALL_MULTICAST: c_uint = 0x00000020;
pub const DMA_RX_BROADCAST: c_uint = 0x00000040;
pub const DMA_RX_FLOW_ENABLE: c_uint = 0x00000200;
pub const DMA_RX_CSUM_IP: c_uint = 0x00010000;
pub const DMA_RX_CSUM_TCP: c_uint = 0x00020000;
pub const DMA_RX_CSUM_UDP: c_uint = 0x00040000;
pub const DMA_RX_BURST_SIZE: c_uint = 0x3F000000;
pub const DMA_BURST_SHIFT: c_int = 24;
pub const DMA_BURST_DEFAULT: c_int = 8;
pub const KS_DMA_TX_START: c_uint = 0x0008;
pub const KS_DMA_RX_START: c_uint = 0x000C;
pub const DMA_START: c_uint = 0x00000001;
pub const KS_DMA_TX_ADDR: c_uint = 0x0010;
pub const KS_DMA_RX_ADDR: c_uint = 0x0014;
pub const DMA_ADDR_LIST_MASK: c_uint = 0xFFFFFFFC;
pub const DMA_ADDR_LIST_SHIFT: c_int = 2;
// MTR0
pub const KS884X_MULTICAST_0_OFFSET: c_uint = 0x0020;
pub const KS884X_MULTICAST_1_OFFSET: c_uint = 0x0021;
pub const KS884X_MULTICAST_2_OFFSET: c_uint = 0x0022;
pub const KS884x_MULTICAST_3_OFFSET: c_uint = 0x0023;
// MTR1
pub const KS884X_MULTICAST_4_OFFSET: c_uint = 0x0024;
pub const KS884X_MULTICAST_5_OFFSET: c_uint = 0x0025;
pub const KS884X_MULTICAST_6_OFFSET: c_uint = 0x0026;
pub const KS884X_MULTICAST_7_OFFSET: c_uint = 0x0027;
// Interrupt Registers
// INTEN
pub const KS884X_INTERRUPTS_ENABLE: c_uint = 0x0028;
// INTST
pub const KS884X_INTERRUPTS_STATUS: c_uint = 0x002C;
pub const KS884X_INT_RX_STOPPED: c_uint = 0x02000000;
pub const KS884X_INT_TX_STOPPED: c_uint = 0x04000000;
pub const KS884X_INT_RX_OVERRUN: c_uint = 0x08000000;
pub const KS884X_INT_TX_EMPTY: c_uint = 0x10000000;
pub const KS884X_INT_RX: c_uint = 0x20000000;
pub const KS884X_INT_TX: c_uint = 0x40000000;
pub const KS884X_INT_PHY: c_uint = 0x80000000;
...
// MAAL0
pub const KS_ADD_ADDR_0_LO: c_uint = 0x0080;
// MAAH0
pub const KS_ADD_ADDR_0_HI: c_uint = 0x0084;
// MAAL1
pub const KS_ADD_ADDR_1_LO: c_uint = 0x0088;
// MAAH1
pub const KS_ADD_ADDR_1_HI: c_uint = 0x008C;
// MAAL2
pub const KS_ADD_ADDR_2_LO: c_uint = 0x0090;
// MAAH2
pub const KS_ADD_ADDR_2_HI: c_uint = 0x0094;
// MAAL3
pub const KS_ADD_ADDR_3_LO: c_uint = 0x0098;
// MAAH3
pub const KS_ADD_ADDR_3_HI: c_uint = 0x009C;
// MAAL4
pub const KS_ADD_ADDR_4_LO: c_uint = 0x00A0;
// MAAH4
pub const KS_ADD_ADDR_4_HI: c_uint = 0x00A4;
// MAAL5
pub const KS_ADD_ADDR_5_LO: c_uint = 0x00A8;
// MAAH5
pub const KS_ADD_ADDR_5_HI: c_uint = 0x00AC;
// MAAL6
pub const KS_ADD_ADDR_6_LO: c_uint = 0x00B0;
// MAAH6
pub const KS_ADD_ADDR_6_HI: c_uint = 0x00B4;
// MAAL7
pub const KS_ADD_ADDR_7_LO: c_uint = 0x00B8;
// MAAH7
pub const KS_ADD_ADDR_7_HI: c_uint = 0x00BC;
// MAAL8
pub const KS_ADD_ADDR_8_LO: c_uint = 0x00C0;
// MAAH8
pub const KS_ADD_ADDR_8_HI: c_uint = 0x00C4;
// MAAL9
pub const KS_ADD_ADDR_9_LO: c_uint = 0x00C8;
// MAAH9
pub const KS_ADD_ADDR_9_HI: c_uint = 0x00CC;
// MAAL10
pub const KS_ADD_ADDR_A_LO: c_uint = 0x00D0;
// MAAH10
pub const KS_ADD_ADDR_A_HI: c_uint = 0x00D4;
// MAAL11
pub const KS_ADD_ADDR_B_LO: c_uint = 0x00D8;
// MAAH11
pub const KS_ADD_ADDR_B_HI: c_uint = 0x00DC;
// MAAL12
pub const KS_ADD_ADDR_C_LO: c_uint = 0x00E0;
// MAAH12
pub const KS_ADD_ADDR_C_HI: c_uint = 0x00E4;
// MAAL13
pub const KS_ADD_ADDR_D_LO: c_uint = 0x00E8;
// MAAH13
pub const KS_ADD_ADDR_D_HI: c_uint = 0x00EC;
// MAAL14
pub const KS_ADD_ADDR_E_LO: c_uint = 0x00F0;
// MAAH14
pub const KS_ADD_ADDR_E_HI: c_uint = 0x00F4;
// MAAL15
pub const KS_ADD_ADDR_F_LO: c_uint = 0x00F8;
// MAAH15
pub const KS_ADD_ADDR_F_HI: c_uint = 0x00FC;
pub const ADD_ADDR_HI_MASK: c_uint = 0x0000FFFF;
pub const ADD_ADDR_ENABLE: c_uint = 0x80000000;
pub const ADD_ADDR_INCR: c_int = 8;
// Miscellaneous Registers
// MARL
pub const KS884X_ADDR_0_OFFSET: c_uint = 0x0200;
pub const KS884X_ADDR_1_OFFSET: c_uint = 0x0201;
// MARM
pub const KS884X_ADDR_2_OFFSET: c_uint = 0x0202;
pub const KS884X_ADDR_3_OFFSET: c_uint = 0x0203;
// MARH
pub const KS884X_ADDR_4_OFFSET: c_uint = 0x0204;
pub const KS884X_ADDR_5_OFFSET: c_uint = 0x0205;
// OBCR
pub const KS884X_BUS_CTRL_OFFSET: c_uint = 0x0210;
pub const BUS_SPEED_125_MHZ: c_uint = 0x0000;
pub const BUS_SPEED_62_5_MHZ: c_uint = 0x0001;
pub const BUS_SPEED_41_66_MHZ: c_uint = 0x0002;
pub const BUS_SPEED_25_MHZ: c_uint = 0x0003;
// EEPCR
pub const KS884X_EEPROM_CTRL_OFFSET: c_uint = 0x0212;
pub const EEPROM_CHIP_SELECT: c_uint = 0x0001;
pub const EEPROM_SERIAL_CLOCK: c_uint = 0x0002;
pub const EEPROM_DATA_OUT: c_uint = 0x0004;
pub const EEPROM_DATA_IN: c_uint = 0x0008;
pub const EEPROM_ACCESS_ENABLE: c_uint = 0x0010;
// MBIR
pub const KS884X_MEM_INFO_OFFSET: c_uint = 0x0214;
pub const RX_MEM_TEST_FAILED: c_uint = 0x0008;
pub const RX_MEM_TEST_FINISHED: c_uint = 0x0010;
pub const TX_MEM_TEST_FAILED: c_uint = 0x0800;
pub const TX_MEM_TEST_FINISHED: c_uint = 0x1000;
// GCR
pub const KS884X_GLOBAL_CTRL_OFFSET: c_uint = 0x0216;
pub const GLOBAL_SOFTWARE_RESET: c_uint = 0x0001;
pub const KS8841_POWER_MANAGE_OFFSET: c_uint = 0x0218;
// WFCR
pub const KS8841_WOL_CTRL_OFFSET: c_uint = 0x021A;
pub const KS8841_WOL_MAGIC_ENABLE: c_uint = 0x0080;
pub const KS8841_WOL_FRAME3_ENABLE: c_uint = 0x0008;
pub const KS8841_WOL_FRAME2_ENABLE: c_uint = 0x0004;
pub const KS8841_WOL_FRAME1_ENABLE: c_uint = 0x0002;
pub const KS8841_WOL_FRAME0_ENABLE: c_uint = 0x0001;
// WF0
pub const KS8841_WOL_FRAME_CRC_OFFSET: c_uint = 0x0220;
pub const KS8841_WOL_FRAME_BYTE0_OFFSET: c_uint = 0x0224;
pub const KS8841_WOL_FRAME_BYTE2_OFFSET: c_uint = 0x0228;
// IACR
pub const KS884X_IACR_P: c_uint = 0x04A0;

// IADR1
pub const KS884X_IADR1_P: c_uint = 0x04A2;
pub const KS884X_IADR2_P: c_uint = 0x04A4;
pub const KS884X_IADR3_P: c_uint = 0x04A6;
pub const KS884X_IADR4_P: c_uint = 0x04A8;
pub const KS884X_IADR5_P: c_uint = 0x04AA;

// P1MBCR
pub const KS884X_P1MBCR_P: c_uint = 0x04D0;
pub const KS884X_P1MBSR_P: c_uint = 0x04D2;
pub const KS884X_PHY1ILR_P: c_uint = 0x04D4;
pub const KS884X_PHY1IHR_P: c_uint = 0x04D6;
pub const KS884X_P1ANAR_P: c_uint = 0x04D8;
pub const KS884X_P1ANLPR_P: c_uint = 0x04DA;
// P2MBCR
pub const KS884X_P2MBCR_P: c_uint = 0x04E0;
pub const KS884X_P2MBSR_P: c_uint = 0x04E2;
pub const KS884X_PHY2ILR_P: c_uint = 0x04E4;
pub const KS884X_PHY2IHR_P: c_uint = 0x04E6;
pub const KS884X_P2ANAR_P: c_uint = 0x04E8;
pub const KS884X_P2ANLPR_P: c_uint = 0x04EA;

pub const KS884X_PHY_CTRL_OFFSET: c_uint = 0x00;
pub const KS884X_PHY_STATUS_OFFSET: c_uint = 0x02;
pub const KS884X_PHY_ID_1_OFFSET: c_uint = 0x04;
pub const KS884X_PHY_ID_2_OFFSET: c_uint = 0x06;
pub const KS884X_PHY_AUTO_NEG_OFFSET: c_uint = 0x08;
pub const KS884X_PHY_REMOTE_CAP_OFFSET: c_uint = 0x0A;
// P1VCT
pub const KS884X_P1VCT_P: c_uint = 0x04F0;
pub const KS884X_P1PHYCTRL_P: c_uint = 0x04F2;
// P2VCT
pub const KS884X_P2VCT_P: c_uint = 0x04F4;
pub const KS884X_P2PHYCTRL_P: c_uint = 0x04F6;

pub const KS884X_PHY_LINK_MD_OFFSET: c_uint = 0x00;
pub const PHY_START_CABLE_DIAG: c_uint = 0x8000;
...
pub const PHY_CABLE_10M_SHORT: c_uint = 0x1000;
pub const PHY_CABLE_FAULT_COUNTER: c_uint = 0x01FF;
pub const KS884X_PHY_PHY_CTRL_OFFSET: c_uint = 0x02;
pub const PHY_STAT_REVERSED_POLARITY: c_uint = 0x0020;
pub const PHY_STAT_MDIX: c_uint = 0x0010;
pub const PHY_FORCE_LINK: c_uint = 0x0008;
pub const PHY_POWER_SAVING_DISABLE: c_uint = 0x0004;
pub const PHY_REMOTE_LOOPBACK: c_uint = 0x0002;
// SIDER
pub const KS884X_SIDER_P: c_uint = 0x0400;

pub const REG_FAMILY_ID: c_uint = 0x88;
pub const REG_CHIP_ID_41: c_uint = 0x8810;
pub const REG_CHIP_ID_42: c_uint = 0x8800;
pub const KS884X_CHIP_ID_MASK_41: c_uint = 0xFF10;
pub const KS884X_CHIP_ID_MASK: c_uint = 0xFFF0;
pub const KS884X_CHIP_ID_SHIFT: c_int = 4;
pub const KS884X_REVISION_MASK: c_uint = 0x000E;
pub const KS884X_REVISION_SHIFT: c_int = 1;
pub const KS8842_START: c_uint = 0x0001;
pub const CHIP_IP_41_M: c_uint = 0x8810;
pub const CHIP_IP_42_M: c_uint = 0x8800;
pub const CHIP_IP_61_M: c_uint = 0x8890;
pub const CHIP_IP_62_M: c_uint = 0x8880;
pub const CHIP_IP_41_P: c_uint = 0x8850;
pub const CHIP_IP_42_P: c_uint = 0x8840;
pub const CHIP_IP_61_P: c_uint = 0x88D0;
pub const CHIP_IP_62_P: c_uint = 0x88C0;
// SGCR1
pub const KS8842_SGCR1_P: c_uint = 0x0402;

pub const SWITCH_PASS_ALL: c_uint = 0x8000;
pub const SWITCH_TX_FLOW_CTRL: c_uint = 0x2000;
pub const SWITCH_RX_FLOW_CTRL: c_uint = 0x1000;
pub const SWITCH_CHECK_LENGTH: c_uint = 0x0800;
pub const SWITCH_AGING_ENABLE: c_uint = 0x0400;
pub const SWITCH_FAST_AGING: c_uint = 0x0200;
pub const SWITCH_AGGR_BACKOFF: c_uint = 0x0100;
pub const SWITCH_PASS_PAUSE: c_uint = 0x0008;
pub const SWITCH_LINK_AUTO_AGING: c_uint = 0x0001;
// SGCR2
pub const KS8842_SGCR2_P: c_uint = 0x0404;

pub const SWITCH_VLAN_ENABLE: c_uint = 0x8000;
pub const SWITCH_IGMP_SNOOP: c_uint = 0x4000;
pub const IPV6_MLD_SNOOP_ENABLE: c_uint = 0x2000;
pub const IPV6_MLD_SNOOP_OPTION: c_uint = 0x1000;
pub const PRIORITY_SCHEME_SELECT: c_uint = 0x0800;
pub const SWITCH_MIRROR_RX_TX: c_uint = 0x0100;
pub const UNICAST_VLAN_BOUNDARY: c_uint = 0x0080;
pub const MULTICAST_STORM_DISABLE: c_uint = 0x0040;
pub const SWITCH_BACK_PRESSURE: c_uint = 0x0020;
pub const FAIR_FLOW_CTRL: c_uint = 0x0010;
pub const NO_EXC_COLLISION_DROP: c_uint = 0x0008;
pub const SWITCH_HUGE_PACKET: c_uint = 0x0004;
pub const SWITCH_LEGAL_PACKET: c_uint = 0x0002;
pub const SWITCH_BUF_RESERVE: c_uint = 0x0001;
// SGCR3
pub const KS8842_SGCR3_P: c_uint = 0x0406;

pub const BROADCAST_STORM_RATE_LO: c_uint = 0xFF00;
pub const SWITCH_REPEATER: c_uint = 0x0080;
pub const SWITCH_HALF_DUPLEX: c_uint = 0x0040;
pub const SWITCH_FLOW_CTRL: c_uint = 0x0020;
pub const SWITCH_10_MBIT: c_uint = 0x0010;
pub const SWITCH_REPLACE_NULL_VID: c_uint = 0x0008;
pub const BROADCAST_STORM_RATE_HI: c_uint = 0x0007;
pub const BROADCAST_STORM_RATE: c_uint = 0x07FF;
// SGCR4
pub const KS8842_SGCR4_P: c_uint = 0x0408;
// SGCR5
pub const KS8842_SGCR5_P: c_uint = 0x040A;

pub const LED_MODE: c_uint = 0x8200;
pub const LED_SPEED_DUPLEX_ACT: c_uint = 0x0000;
pub const LED_SPEED_DUPLEX_LINK_ACT: c_uint = 0x8000;
pub const LED_DUPLEX_10_100: c_uint = 0x0200;
// SGCR6
pub const KS8842_SGCR6_P: c_uint = 0x0410;

pub const KS8842_PRIORITY_MASK: c_int = 3;
pub const KS8842_PRIORITY_SHIFT: c_int = 2;
// SGCR7
pub const KS8842_SGCR7_P: c_uint = 0x0412;

pub const SWITCH_UNK_DEF_PORT_ENABLE: c_uint = 0x0008;
pub const SWITCH_UNK_DEF_PORT_3: c_uint = 0x0004;
pub const SWITCH_UNK_DEF_PORT_2: c_uint = 0x0002;
pub const SWITCH_UNK_DEF_PORT_1: c_uint = 0x0001;
// MACAR1
pub const KS8842_MACAR1_P: c_uint = 0x0470;
pub const KS8842_MACAR2_P: c_uint = 0x0472;
pub const KS8842_MACAR3_P: c_uint = 0x0474;

// TOSR1
pub const KS8842_TOSR1_P: c_uint = 0x0480;
pub const KS8842_TOSR2_P: c_uint = 0x0482;
pub const KS8842_TOSR3_P: c_uint = 0x0484;
pub const KS8842_TOSR4_P: c_uint = 0x0486;
pub const KS8842_TOSR5_P: c_uint = 0x0488;
pub const KS8842_TOSR6_P: c_uint = 0x048A;
pub const KS8842_TOSR7_P: c_uint = 0x0490;
pub const KS8842_TOSR8_P: c_uint = 0x0492;

// P1CR1
pub const KS8842_P1CR1_P: c_uint = 0x0500;
pub const KS8842_P1CR2_P: c_uint = 0x0502;
pub const KS8842_P1VIDR_P: c_uint = 0x0504;
pub const KS8842_P1CR3_P: c_uint = 0x0506;
pub const KS8842_P1IRCR_P: c_uint = 0x0508;
pub const KS8842_P1ERCR_P: c_uint = 0x050A;
pub const KS884X_P1SCSLMD_P: c_uint = 0x0510;
pub const KS884X_P1CR4_P: c_uint = 0x0512;
pub const KS884X_P1SR_P: c_uint = 0x0514;
// P2CR1
pub const KS8842_P2CR1_P: c_uint = 0x0520;
pub const KS8842_P2CR2_P: c_uint = 0x0522;
pub const KS8842_P2VIDR_P: c_uint = 0x0524;
pub const KS8842_P2CR3_P: c_uint = 0x0526;
pub const KS8842_P2IRCR_P: c_uint = 0x0528;
pub const KS8842_P2ERCR_P: c_uint = 0x052A;
pub const KS884X_P2SCSLMD_P: c_uint = 0x0530;
pub const KS884X_P2CR4_P: c_uint = 0x0532;
pub const KS884X_P2SR_P: c_uint = 0x0534;
// P3CR1
pub const KS8842_P3CR1_P: c_uint = 0x0540;
pub const KS8842_P3CR2_P: c_uint = 0x0542;
pub const KS8842_P3VIDR_P: c_uint = 0x0544;
pub const KS8842_P3CR3_P: c_uint = 0x0546;
pub const KS8842_P3IRCR_P: c_uint = 0x0548;
pub const KS8842_P3ERCR_P: c_uint = 0x054A;

    (addr = KS8842_PORT_1_CTRL_1 + (port) *	\
    (KS8842_PORT_2_CTRL_1 - KS8842_PORT_1_CTRL_1))
pub const KS8842_PORT_CTRL_1_OFFSET: c_uint = 0x00;
pub const PORT_BROADCAST_STORM: c_uint = 0x0080;
pub const PORT_DIFFSERV_ENABLE: c_uint = 0x0040;
pub const PORT_802_1P_ENABLE: c_uint = 0x0020;
pub const PORT_BASED_PRIORITY_MASK: c_uint = 0x0018;
pub const PORT_BASED_PRIORITY_BASE: c_uint = 0x0003;
pub const PORT_BASED_PRIORITY_SHIFT: c_int = 3;
pub const PORT_BASED_PRIORITY_0: c_uint = 0x0000;
pub const PORT_BASED_PRIORITY_1: c_uint = 0x0008;
pub const PORT_BASED_PRIORITY_2: c_uint = 0x0010;
pub const PORT_BASED_PRIORITY_3: c_uint = 0x0018;
pub const PORT_INSERT_TAG: c_uint = 0x0004;
pub const PORT_REMOVE_TAG: c_uint = 0x0002;
pub const PORT_PRIO_QUEUE_ENABLE: c_uint = 0x0001;
pub const KS8842_PORT_CTRL_2_OFFSET: c_uint = 0x02;
pub const PORT_INGRESS_VLAN_FILTER: c_uint = 0x4000;
pub const PORT_DISCARD_NON_VID: c_uint = 0x2000;
pub const PORT_FORCE_FLOW_CTRL: c_uint = 0x1000;
pub const PORT_BACK_PRESSURE: c_uint = 0x0800;
pub const PORT_TX_ENABLE: c_uint = 0x0400;
pub const PORT_RX_ENABLE: c_uint = 0x0200;
pub const PORT_LEARN_DISABLE: c_uint = 0x0100;
pub const PORT_MIRROR_SNIFFER: c_uint = 0x0080;
pub const PORT_MIRROR_RX: c_uint = 0x0040;
pub const PORT_MIRROR_TX: c_uint = 0x0020;
pub const PORT_USER_PRIORITY_CEILING: c_uint = 0x0008;
pub const PORT_VLAN_MEMBERSHIP: c_uint = 0x0007;
pub const KS8842_PORT_CTRL_VID_OFFSET: c_uint = 0x04;
pub const PORT_DEFAULT_VID: c_uint = 0x0001;
pub const KS8842_PORT_CTRL_3_OFFSET: c_uint = 0x06;
pub const PORT_INGRESS_LIMIT_MODE: c_uint = 0x000C;
pub const PORT_INGRESS_ALL: c_uint = 0x0000;
pub const PORT_INGRESS_UNICAST: c_uint = 0x0004;
pub const PORT_INGRESS_MULTICAST: c_uint = 0x0008;
pub const PORT_INGRESS_BROADCAST: c_uint = 0x000C;
pub const PORT_COUNT_IFG: c_uint = 0x0002;
pub const PORT_COUNT_PREAMBLE: c_uint = 0x0001;
pub const KS8842_PORT_IN_RATE_OFFSET: c_uint = 0x08;
pub const KS8842_PORT_OUT_RATE_OFFSET: c_uint = 0x0A;
pub const PORT_PRIORITY_RATE: c_uint = 0x0F;
pub const PORT_PRIORITY_RATE_SHIFT: c_int = 4;
pub const KS884X_PORT_LINK_MD: c_uint = 0x10;
pub const PORT_CABLE_10M_SHORT: c_uint = 0x8000;
pub const PORT_CABLE_DIAG_RESULT: c_uint = 0x6000;
pub const PORT_CABLE_STAT_NORMAL: c_uint = 0x0000;
pub const PORT_CABLE_STAT_OPEN: c_uint = 0x2000;
pub const PORT_CABLE_STAT_SHORT: c_uint = 0x4000;
pub const PORT_CABLE_STAT_FAILED: c_uint = 0x6000;
pub const PORT_START_CABLE_DIAG: c_uint = 0x1000;
pub const PORT_FORCE_LINK: c_uint = 0x0800;
pub const PORT_POWER_SAVING_DISABLE: c_uint = 0x0400;
pub const PORT_PHY_REMOTE_LOOPBACK: c_uint = 0x0200;
pub const PORT_CABLE_FAULT_COUNTER: c_uint = 0x01FF;
pub const KS884X_PORT_CTRL_4_OFFSET: c_uint = 0x12;
pub const PORT_LED_OFF: c_uint = 0x8000;
pub const PORT_TX_DISABLE: c_uint = 0x4000;
pub const PORT_AUTO_NEG_RESTART: c_uint = 0x2000;
pub const PORT_REMOTE_FAULT_DISABLE: c_uint = 0x1000;
pub const PORT_POWER_DOWN: c_uint = 0x0800;
pub const PORT_AUTO_MDIX_DISABLE: c_uint = 0x0400;
pub const PORT_FORCE_MDIX: c_uint = 0x0200;
pub const PORT_LOOPBACK: c_uint = 0x0100;
pub const PORT_AUTO_NEG_ENABLE: c_uint = 0x0080;
pub const PORT_FORCE_100_MBIT: c_uint = 0x0040;
pub const PORT_FORCE_FULL_DUPLEX: c_uint = 0x0020;
pub const PORT_AUTO_NEG_SYM_PAUSE: c_uint = 0x0010;
pub const PORT_AUTO_NEG_100BTX_FD: c_uint = 0x0008;
pub const PORT_AUTO_NEG_100BTX: c_uint = 0x0004;
pub const PORT_AUTO_NEG_10BT_FD: c_uint = 0x0002;
pub const PORT_AUTO_NEG_10BT: c_uint = 0x0001;
pub const KS884X_PORT_STATUS_OFFSET: c_uint = 0x14;
pub const PORT_HP_MDIX: c_uint = 0x8000;
pub const PORT_REVERSED_POLARITY: c_uint = 0x2000;
pub const PORT_RX_FLOW_CTRL: c_uint = 0x0800;
pub const PORT_TX_FLOW_CTRL: c_uint = 0x1000;
pub const PORT_STATUS_SPEED_100MBIT: c_uint = 0x0400;
pub const PORT_STATUS_FULL_DUPLEX: c_uint = 0x0200;
pub const PORT_REMOTE_FAULT: c_uint = 0x0100;
pub const PORT_MDIX_STATUS: c_uint = 0x0080;
pub const PORT_AUTO_NEG_COMPLETE: c_uint = 0x0040;
pub const PORT_STATUS_LINK_GOOD: c_uint = 0x0020;
pub const PORT_REMOTE_SYM_PAUSE: c_uint = 0x0010;
pub const PORT_REMOTE_100BTX_FD: c_uint = 0x0008;
pub const PORT_REMOTE_100BTX: c_uint = 0x0004;
pub const PORT_REMOTE_10BT_FD: c_uint = 0x0002;
pub const PORT_REMOTE_10BT: c_uint = 0x0001;
//

//
pub const STATIC_MAC_TABLE_ADDR: c_uint = 0x0000FFFF;
pub const STATIC_MAC_TABLE_FWD_PORTS: c_uint = 0x00070000;
pub const STATIC_MAC_TABLE_VALID: c_uint = 0x00080000;
pub const STATIC_MAC_TABLE_OVERRIDE: c_uint = 0x00100000;
pub const STATIC_MAC_TABLE_USE_FID: c_uint = 0x00200000;
pub const STATIC_MAC_TABLE_FID: c_uint = 0x03C00000;
pub const STATIC_MAC_FWD_PORTS_SHIFT: c_int = 16;
pub const STATIC_MAC_FID_SHIFT: c_int = 22;
//

//
pub const VLAN_TABLE_VID: c_uint = 0x00000FFF;
pub const VLAN_TABLE_FID: c_uint = 0x0000F000;
pub const VLAN_TABLE_MEMBERSHIP: c_uint = 0x00070000;
pub const VLAN_TABLE_VALID: c_uint = 0x00080000;
pub const VLAN_TABLE_FID_SHIFT: c_int = 12;
pub const VLAN_TABLE_MEMBERSHIP_SHIFT: c_int = 16;
//

//
pub const DYNAMIC_MAC_TABLE_ADDR: c_uint = 0x0000FFFF;
pub const DYNAMIC_MAC_TABLE_FID: c_uint = 0x000F0000;
pub const DYNAMIC_MAC_TABLE_SRC_PORT: c_uint = 0x00300000;
pub const DYNAMIC_MAC_TABLE_TIMESTAMP: c_uint = 0x00C00000;
pub const DYNAMIC_MAC_TABLE_ENTRIES: c_uint = 0xFF000000;
pub const DYNAMIC_MAC_TABLE_ENTRIES_H: c_uint = 0x03;
pub const DYNAMIC_MAC_TABLE_MAC_EMPTY: c_uint = 0x04;
pub const DYNAMIC_MAC_TABLE_RESERVED: c_uint = 0x78;
pub const DYNAMIC_MAC_TABLE_NOT_READY: c_uint = 0x80;
pub const DYNAMIC_MAC_FID_SHIFT: c_int = 16;
pub const DYNAMIC_MAC_SRC_PORT_SHIFT: c_int = 20;
pub const DYNAMIC_MAC_TIMESTAMP_SHIFT: c_int = 22;
pub const DYNAMIC_MAC_ENTRIES_SHIFT: c_int = 24;
pub const DYNAMIC_MAC_ENTRIES_H_SHIFT: c_int = 8;
//

//
pub const MIB_COUNTER_VALUE: c_uint = 0x3FFFFFFF;
pub const MIB_COUNTER_VALID: c_uint = 0x40000000;
pub const MIB_COUNTER_OVERFLOW: c_uint = 0x80000000;
pub const MIB_PACKET_DROPPED: c_uint = 0x0000FFFF;
pub const KS_MIB_PACKET_DROPPED_TX_0: c_uint = 0x100;
pub const KS_MIB_PACKET_DROPPED_TX_1: c_uint = 0x101;
pub const KS_MIB_PACKET_DROPPED_TX: c_uint = 0x102;
pub const KS_MIB_PACKET_DROPPED_RX_0: c_uint = 0x103;
pub const KS_MIB_PACKET_DROPPED_RX_1: c_uint = 0x104;
pub const KS_MIB_PACKET_DROPPED_RX: c_uint = 0x105;
// Change default LED mode.

pub const MAX_ETHERNET_BODY_SIZE: c_int = 1500;

    (MAX_ETHERNET_BODY_SIZE + ETHERNET_HEADER_SIZE)

pub const ADDITIONAL_ENTRIES: c_int = 16;
pub const MAX_MULTICAST_LIST: c_int = 32;
pub const HW_MULTICAST_SIZE: c_int = 8;
...
//
pub const DESC_ALIGNMENT: c_int = 16;
pub const BUFFER_ALIGNMENT: c_int = 8;
pub const NUM_OF_RX_DESC: c_int = 64;
pub const NUM_OF_TX_DESC: c_int = 64;
pub const KS_DESC_RX_FRAME_LEN: c_uint = 0x000007FF;
pub const KS_DESC_RX_FRAME_TYPE: c_uint = 0x00008000;
pub const KS_DESC_RX_ERROR_CRC: c_uint = 0x00010000;
pub const KS_DESC_RX_ERROR_RUNT: c_uint = 0x00020000;
pub const KS_DESC_RX_ERROR_TOO_LONG: c_uint = 0x00040000;
pub const KS_DESC_RX_ERROR_PHY: c_uint = 0x00080000;
pub const KS884X_DESC_RX_PORT_MASK: c_uint = 0x00300000;
pub const KS_DESC_RX_MULTICAST: c_uint = 0x01000000;
pub const KS_DESC_RX_ERROR: c_uint = 0x02000000;
pub const KS_DESC_RX_ERROR_CSUM_UDP: c_uint = 0x04000000;
pub const KS_DESC_RX_ERROR_CSUM_TCP: c_uint = 0x08000000;
pub const KS_DESC_RX_ERROR_CSUM_IP: c_uint = 0x10000000;
pub const KS_DESC_RX_LAST: c_uint = 0x20000000;
pub const KS_DESC_RX_FIRST: c_uint = 0x40000000;

    (KS_DESC_RX_ERROR_CRC |		\
    KS_DESC_RX_ERROR_RUNT |		\
    KS_DESC_RX_ERROR_PHY |		\
    KS_DESC_RX_ERROR_TOO_LONG)
pub const KS_DESC_HW_OWNED: c_uint = 0x80000000;
pub const KS_DESC_BUF_SIZE: c_uint = 0x000007FF;
pub const KS884X_DESC_TX_PORT_MASK: c_uint = 0x00300000;
pub const KS_DESC_END_OF_RING: c_uint = 0x02000000;
pub const KS_DESC_TX_CSUM_GEN_UDP: c_uint = 0x04000000;
pub const KS_DESC_TX_CSUM_GEN_TCP: c_uint = 0x08000000;
pub const KS_DESC_TX_CSUM_GEN_IP: c_uint = 0x10000000;
pub const KS_DESC_TX_LAST: c_uint = 0x20000000;
pub const KS_DESC_TX_FIRST: c_uint = 0x40000000;
pub const KS_DESC_TX_INTERRUPT: c_uint = 0x80000000;
pub const KS_DESC_PORT_SHIFT: c_int = 20;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ksz_desc_rx_stat {

    pub hw_owned:1: u32,
    pub first_desc:1: u32,
    pub last_desc:1: u32,
    pub csum_err_ip:1: u32,
    pub csum_err_tcp:1: u32,
    pub csum_err_udp:1: u32,
    pub error:1: u32,
    pub multicast:1: u32,
    pub src_port:4: u32,
    pub err_phy:1: u32,
    pub err_too_long:1: u32,
    pub err_runt:1: u32,
    pub err_crc:1: u32,
    pub frame_type:1: u32,
    pub reserved1:4: u32,
    pub frame_len:11: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ksz_desc_tx_stat {

    pub hw_owned:1: u32,
    pub reserved1:31: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ksz_desc_rx_buf {

    pub reserved4:6: u32,
    pub end_of_ring:1: u32,
    pub reserved3:14: u32,
    pub buf_size:11: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ksz_desc_tx_buf {

    pub intr:1: u32,
    pub first_seg:1: u32,
    pub last_seg:1: u32,
    pub csum_gen_ip:1: u32,
    pub csum_gen_tcp:1: u32,
    pub csum_gen_udp:1: u32,
    pub end_of_ring:1: u32,
    pub reserved4:1: u32,
    pub dest_port:4: u32,
    pub reserved3:9: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ksz_hw_desc {
    pub ctrl: union desc_stat,
    pub buf: union desc_buf,
    pub addr: u32,
    pub next: u32,
}
...
#[derive(Copy, Clone)]
pub struct ksz_desc {
    pub phw: *mut ksz_hw_desc,
    pub sw: ksz_sw_desc,
    pub dma_buf: ksz_dma_buf,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ksz_desc_info {
    pub ring: *mut ksz_desc,
    pub cur: *mut ksz_desc,
    pub ring_virt: *mut ksz_hw_desc,
    pub ring_phys: u32,
    pub size: c_int,
    pub alloc: c_int,
    pub avail: c_int,
...
pub const LEARNED_MAC_TABLE_ENTRIES: c_int = 1024;
pub const STATIC_MAC_TABLE_ENTRIES: c_int = 8;
//
...
pub const VLAN_TABLE_ENTRIES: c_int = 16;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ksz_vlan_table {
    pub vid: u16,
    pub fid: u8,
    pub member: u8,
}

pub const DIFFSERV_ENTRIES: c_int = 64;
pub const PRIO_802_1P_ENTRIES: c_int = 8;
pub const PRIO_QUEUES: c_int = 4;
pub const SWITCH_PORT_NUM: c_int = 2;

pub const PORT_MASK: c_int = 7;
pub const MAIN_PORT: c_int = 0;
pub const OTHER_PORT: c_int = 1;

pub const PORT_COUNTER_NUM: c_uint = 0x20;

pub const MIB_COUNTER_RX_LO_PRIORITY: c_uint = 0x00;
pub const MIB_COUNTER_RX_HI_PRIORITY: c_uint = 0x01;
pub const MIB_COUNTER_RX_UNDERSIZE: c_uint = 0x02;
pub const MIB_COUNTER_RX_FRAGMENT: c_uint = 0x03;
pub const MIB_COUNTER_RX_OVERSIZE: c_uint = 0x04;
pub const MIB_COUNTER_RX_JABBER: c_uint = 0x05;
pub const MIB_COUNTER_RX_SYMBOL_ERR: c_uint = 0x06;
pub const MIB_COUNTER_RX_CRC_ERR: c_uint = 0x07;
pub const MIB_COUNTER_RX_ALIGNMENT_ERR: c_uint = 0x08;
pub const MIB_COUNTER_RX_CTRL_8808: c_uint = 0x09;
pub const MIB_COUNTER_RX_PAUSE: c_uint = 0x0A;
pub const MIB_COUNTER_RX_BROADCAST: c_uint = 0x0B;
pub const MIB_COUNTER_RX_MULTICAST: c_uint = 0x0C;
pub const MIB_COUNTER_RX_UNICAST: c_uint = 0x0D;
pub const MIB_COUNTER_RX_OCTET_64: c_uint = 0x0E;
pub const MIB_COUNTER_RX_OCTET_65_127: c_uint = 0x0F;
pub const MIB_COUNTER_RX_OCTET_128_255: c_uint = 0x10;
pub const MIB_COUNTER_RX_OCTET_256_511: c_uint = 0x11;
pub const MIB_COUNTER_RX_OCTET_512_1023: c_uint = 0x12;
pub const MIB_COUNTER_RX_OCTET_1024_1522: c_uint = 0x13;
pub const MIB_COUNTER_TX_LO_PRIORITY: c_uint = 0x14;
pub const MIB_COUNTER_TX_HI_PRIORITY: c_uint = 0x15;
pub const MIB_COUNTER_TX_LATE_COLLISION: c_uint = 0x16;
pub const MIB_COUNTER_TX_PAUSE: c_uint = 0x17;
pub const MIB_COUNTER_TX_BROADCAST: c_uint = 0x18;
pub const MIB_COUNTER_TX_MULTICAST: c_uint = 0x19;
pub const MIB_COUNTER_TX_UNICAST: c_uint = 0x1A;
pub const MIB_COUNTER_TX_DEFERRED: c_uint = 0x1B;
pub const MIB_COUNTER_TX_TOTAL_COLLISION: c_uint = 0x1C;
pub const MIB_COUNTER_TX_EXCESS_COLLISION: c_uint = 0x1D;
pub const MIB_COUNTER_TX_SINGLE_COLLISION: c_uint = 0x1E;
pub const MIB_COUNTER_TX_MULTI_COLLISION: c_uint = 0x1F;
pub const MIB_COUNTER_RX_DROPPED_PACKET: c_uint = 0x20;
pub const MIB_COUNTER_TX_DROPPED_PACKET: c_uint = 0x21;
//
...
pub struct ksz_port_mib {
    ...
    pub state: u8,
    pub mib_start: u8,
    pub counter: [u64; TOTAL_PORT_COUNTER_NUM],
    pub dropped: [u32; 2],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ksz_port_cfg {
    pub vid: u16,
    pub member: u8,
    pub port_prio: u8,
    pub rx_rate: [u32; PRIO_QUEUES],
    pub tx_rate: [u32; PRIO_QUEUES],
    pub stp_state: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ksz_switch {
    pub mac_table: [ksz_mac_table; STATIC_MAC_TABLE_ENTRIES],
    pub vlan_table: [ksz_vlan_table; VLAN_TABLE_ENTRIES],
    pub port_cfg: [ksz_port_cfg; TOTAL_PORT_NUM],
    pub diffserv: [u8; DIFFSERV_ENTRIES],
    pub p_802_1p: [u8; PRIO_802_1P_ENTRIES],
    pub br_addr: [u8; ETH_ALEN],
    pub other_addr: [u8; ETH_ALEN],
    pub broad_per: u8,
    pub member: u8,
}

pub const TX_RATE_UNIT: c_int = 10000;
//
...
pub const MAX_TX_HELD_SIZE: c_int = 52000;
...
pub struct ksz_hw {
    ...
    pub ksz_switch: *mut ksz_switch,
    pub port_info: [ksz_port_info; SWITCH_PORT_NUM],
    pub port_mib: [ksz_port_mib; TOTAL_PORT_NUM],
    pub dev_count: c_int,
    pub dst_ports: c_int,
    pub id: c_int,
    pub mib_cnt: c_int,
    pub mib_port_cnt: c_int,
    pub tx_cfg: u32,
    pub rx_cfg: u32,
    pub intr_mask: u32,
    pub intr_set: u32,
    pub intr_blocked: c_uint,
    pub rx_desc_info: ksz_desc_info,
    pub tx_desc_info: ksz_desc_info,
    pub tx_int_cnt: c_int,
    pub tx_int_mask: c_int,
    pub tx_size: c_int,
    pub perm_addr: [u8; ETH_ALEN],
    pub override_addr: [u8; ETH_ALEN],
    pub address: [u8; ADDITIONAL_ENTRIES][ETH_ALEN],
    pub addr_list_size: u8,
    pub mac_override: u8,
    pub promiscuous: u8,
    pub all_multi: u8,
    pub multi_list: [u8; MAX_MULTICAST_LIST][ETH_ALEN],
    pub multi_bits: [u8; HW_MULTICAST_SIZE],
    pub multi_list_size: u8,
    pub enabled: u8,
    pub rx_stop: u8,
    pub reserved2: [u8; 1],
    pub features: c_uint,
    pub overrides: c_uint,
...
pub struct ksz_port {
    ...
    pub force_link: u8,
    pub flow_ctrl: u8,
    pub first_port: c_int,
    pub mib_port_cnt: c_int,
    pub port_cnt: c_int,
    pub counter: [u64; OID_COUNTER_LAST],
    pub hw: *mut ksz_hw,
    pub linked: *mut ksz_port_info,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ksz_shared_mem {
    pub dma_addr: dma_addr_t,
    pub alloc_size: c_uint,
    pub phys: c_uint,
    pub alloc_virt: *mut u8,
    pub virt: *mut u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ksz_counter_info {
    pub counter: wait_queue_head_t,
    pub time: c_ulong,
    pub read: c_int,
}
...
pub struct dev_info {
    ...
    pub hw: ksz_hw,
    pub desc_pool: ksz_shared_mem,
    pub hwlock: spinlock_t,
    pub lock: mutex,
    pub ): *mut *mut int (dev_rcv)(struct dev_info,
    pub last_skb: *mut sk_buff,
    pub skb_index: c_int,
    pub skb_len: c_int,
    pub mib_read: work_struct,
    pub mib_timer_info: ksz_timer_info,
    pub counter: [ksz_counter_info; TOTAL_PORT_NUM],
    pub mtu: c_int,
    pub opened: c_int,
    pub rx_tasklet: tasklet_struct,
    pub tx_tasklet: tasklet_struct,
    pub wol_enable: c_int,
    pub wol_support: c_int,
    pub pme_wait: c_ulong,
}
...
#[derive(Copy, Clone)]
pub struct dev_priv {
    pub adapter: *mut dev_info,
    pub port: ksz_port,
    pub monitor_timer_info: ksz_timer_info,
    pub proc_sem: semaphore,
    pub id: c_int,
    pub mii_if: mii_if_info,
    pub advertising: u32,
    pub msg_enable: u32,
    pub media_state: c_int,
    pub multicast: c_int,
    pub promiscuous: c_int,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn hw_ack_intr(hw: *mut ksz_hw, interrupt: c_uint) {
    static inline void hw_ack_intr(struct ksz_hw *hw, uint interrupt)
    {
    writel(interrupt, hw.io + KS884X_INTERRUPTS_STATUS);
    }
#[no_mangle]
pub unsafe extern "C" fn hw_dis_intr(hw: *mut ksz_hw) {
...
#[no_mangle]
pub unsafe extern "C" fn hw_set_intr(hw: *mut ksz_hw, interrupt: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn hw_ena_intr(hw: *mut ksz_hw) {
...
#[no_mangle]
pub unsafe extern "C" fn hw_dis_intr_bit(hw: *mut ksz_hw, bit: c_uint) {
    static inline void hw_dis_intr_bit(struct ksz_hw *hw, uint bit)
    {
    hw.intr_mask &= ~(bit);
    }
#[no_mangle]
pub unsafe extern "C" fn hw_turn_off_intr(hw: *mut ksz_hw, interrupt: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_turn_on_intr(hw: *mut ksz_hw, bit: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn hw_read_intr(hw: *mut ksz_hw, status: *mut c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn hw_restore_intr(hw: *mut ksz_hw, interrupt: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_block_intr(hw: *mut ksz_hw) -> c_uint {
    static uint hw_block_intr(struct ksz_hw *hw)
    {
    let mut interrupt: c_uint = 0;
    if (!hw.intr_blocked) {
    hw_dis_intr(hw);
...
//
#[no_mangle]
pub unsafe extern "C" fn reset_desc(desc: *mut ksz_desc, status: union desc_stat) {
...
#[no_mangle]
pub unsafe extern "C" fn release_desc(desc: *mut ksz_desc) {
...
#[no_mangle]
unsafe extern "C" fn get_rx_pkt(info: *mut ksz_desc_info, desc: *mut ksz_desc) {
...
#[no_mangle]
pub unsafe extern "C" fn set_rx_buf(desc: *mut ksz_desc, addr: u32) {
    static inline void set_rx_buf(struct ksz_desc *desc, u32 addr)
    {
    desc.phw.addr = cpu_to_le32(addr);
    }
#[no_mangle]
pub unsafe extern "C" fn set_rx_len(desc: *mut ksz_desc, len: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn set_tx_buf(desc: *mut ksz_desc, addr: u32) {
    static inline void set_tx_buf(struct ksz_desc *desc, u32 addr)
    {
    desc.phw.addr = cpu_to_le32(addr);
    }
#[no_mangle]
pub unsafe extern "C" fn set_tx_len(desc: *mut ksz_desc, len: u32) {
    static inline void set_tx_len(struct ksz_desc *desc, u32 len)
    {
    desc.sw.buf.tx.buf_size = len;
    }
// Switch functions
pub const TABLE_READ: c_uint = 0x10;
pub const TABLE_SEL_SHIFT: c_int = 2;
...
//
#[no_mangle]
unsafe extern "C" fn sw_r_table(hw: *mut ksz_hw, table: c_int, addr: u16, data: *mut u32) {
...
//
#[no_mangle]
unsafe extern "C" fn port_r_mib_cnt(hw: *mut ksz_hw, port: c_int, addr: u16, cnt: *mut u64) {
...
//
#[no_mangle]
unsafe extern "C" fn port_r_mib_pkt(hw: *mut ksz_hw, port: c_int, last: *mut u32, cnt: *mut u64) {
...
//
#[no_mangle]
unsafe extern "C" fn port_r_cnt(hw: *mut ksz_hw, port: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn port_init_cnt(hw: *mut ksz_hw, port: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn port_r8(hw: *mut ksz_hw, port: c_int, offset: c_int, data: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn port_r16(hw: *mut ksz_hw, port: c_int, offset: c_int, data: *mut u16) {
...
//
#[no_mangle]
unsafe extern "C" fn port_w16(hw: *mut ksz_hw, port: c_int, offset: c_int, data: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_chk(hw: *mut ksz_hw, addr: u32, bits: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sw_cfg(hw: *mut ksz_hw, addr: u32, bits: u16, set: c_int) {
...
// Bandwidth
#[no_mangle]
pub unsafe extern "C" fn port_cfg_broad_storm(hw: *mut ksz_hw, p: c_int, set: c_int) {
...
pub const BROADCAST_STORM_PROTECTION_RATE: c_int = 10;
...
//
#[no_mangle]
unsafe extern "C" fn sw_cfg_broad_storm(hw: *mut ksz_hw, percent: u8) {
    static void sw_cfg_broad_storm(struct ksz_hw *hw, u8 percent)
    {
    u16 data;
    let mut value: u32 = ((u32) BROADCAST_STORM_VALUE * (u32) percent / 100);
...
//
#[no_mangle]
unsafe extern "C" fn sw_get_broad_storm(hw: *mut ksz_hw, percent: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_dis_broad_storm(hw: *mut ksz_hw, port: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_ena_broad_storm(hw: *mut ksz_hw, port: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_init_broad_storm(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_cfg_broad_storm(hw: *mut ksz_hw, percent: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_dis_prio_rate(hw: *mut ksz_hw, port: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_init_prio_rate(hw: *mut ksz_hw) {
...
// Communication
#[no_mangle]
pub unsafe extern "C" fn port_cfg_back_pressure(hw: *mut ksz_hw, p: c_int, set: c_int) {
...
// Mirroring
#[no_mangle]
pub unsafe extern "C" fn port_cfg_mirror_sniffer(hw: *mut ksz_hw, p: c_int, set: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn port_cfg_mirror_rx(hw: *mut ksz_hw, p: c_int, set: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn port_cfg_mirror_tx(hw: *mut ksz_hw, p: c_int, set: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn sw_cfg_mirror_rx_tx(hw: *mut ksz_hw, set: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sw_init_mirror(hw: *mut ksz_hw) {
...
// Priority
#[no_mangle]
pub unsafe extern "C" fn port_cfg_diffserv(hw: *mut ksz_hw, p: c_int, set: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn port_cfg_802_1p(hw: *mut ksz_hw, p: c_int, set: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn port_cfg_replace_vid(hw: *mut ksz_hw, p: c_int, set: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn port_cfg_prio(hw: *mut ksz_hw, p: c_int, set: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_dis_diffserv(hw: *mut ksz_hw, port: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_dis_802_1p(hw: *mut ksz_hw, port: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_cfg_replace_null_vid(hw: *mut ksz_hw, set: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_cfg_replace_vid(hw: *mut ksz_hw, port: c_int, set: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_cfg_port_based(hw: *mut ksz_hw, port: c_int, prio: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_dis_multi_queue(hw: *mut ksz_hw, port: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_init_prio(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn port_get_def_vid(hw: *mut ksz_hw, port: c_int, vid: *mut u16) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_init_vlan(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_cfg_port_base_vlan(hw: *mut ksz_hw, port: c_int, member: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_set_addr(hw: *mut ksz_hw, mac_addr: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_set_global_ctrl(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn port_set_stp_state(hw: *mut ksz_hw, port: c_int, state: c_int) {
...
pub const STP_ENTRY: c_int = 0;
pub const BROADCAST_ENTRY: c_int = 1;
pub const BRIDGE_ADDR_ENTRY: c_int = 2;
pub const IPV6_ADDR_ENTRY: c_int = 3;
//
...
//
#[no_mangle]
unsafe extern "C" fn sw_clr_sta_mac_table(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_init_stp(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_block_addr(hw: *mut ksz_hw) {
...
#[no_mangle]
pub unsafe extern "C" fn hw_r_phy_ctrl(hw: *mut ksz_hw, phy: c_int, data: *mut u16) {
    static inline void hw_r_phy_ctrl(struct ksz_hw *hw, int phy, u16 *data)
    {
// data = readw(hw->io + phy + KS884X_PHY_CTRL_OFFSET);
    }
#[no_mangle]
pub unsafe extern "C" fn hw_w_phy_ctrl(hw: *mut ksz_hw, phy: c_int, data: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_r_phy(hw: *mut ksz_hw, port: c_int, reg: u16, val: *mut u16) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_w_phy(hw: *mut ksz_hw, port: c_int, reg: u16, val: u16) {
...
//
pub const AT93C_CODE: c_int = 0;
pub const AT93C_WR_OFF: c_uint = 0x00;
pub const AT93C_WR_ALL: c_uint = 0x10;
pub const AT93C_ER_ALL: c_uint = 0x20;
pub const AT93C_WR_ON: c_uint = 0x30;
pub const AT93C_WRITE: c_int = 1;
pub const AT93C_READ: c_int = 2;
pub const AT93C_ERASE: c_int = 3;
pub const EEPROM_DELAY: c_int = 4;
#[no_mangle]
pub unsafe extern "C" fn drop_gpio(hw: *mut ksz_hw, gpio: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn raise_gpio(hw: *mut ksz_hw, gpio: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn state_gpio(hw: *mut ksz_hw, gpio: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn eeprom_clk(hw: *mut ksz_hw) {
...
#[no_mangle]
unsafe extern "C" fn spi_r(hw: *mut ksz_hw) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn spi_w(hw: *mut ksz_hw, data: u16) {
...
#[no_mangle]
unsafe extern "C" fn spi_reg(hw: *mut ksz_hw, data: u8, reg: u8) {
...
pub const EEPROM_DATA_RESERVED: c_int = 0;
pub const EEPROM_DATA_MAC_ADDR_0: c_int = 1;
pub const EEPROM_DATA_MAC_ADDR_1: c_int = 2;
pub const EEPROM_DATA_MAC_ADDR_2: c_int = 3;
pub const EEPROM_DATA_SUBSYS_ID: c_int = 4;
pub const EEPROM_DATA_SUBSYS_VEN_ID: c_int = 5;
pub const EEPROM_DATA_PM_CAP: c_int = 6;
// User defined EEPROM data
pub const EEPROM_DATA_OTHER_MAC_ADDR: c_int = 9;
//
...
//
#[no_mangle]
unsafe extern "C" fn eeprom_read(hw: *mut ksz_hw, reg: u8) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn eeprom_write(hw: *mut ksz_hw, reg: u8, data: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn advertised_flow_ctrl(port: *mut ksz_port, ctrl: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn set_flow_ctrl(hw: *mut ksz_hw, rx: c_int, tx: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn port_get_link_speed(port: *mut ksz_port) {
    static void port_get_link_speed(struct ksz_port *port)
    {
    uint interrupt;
    struct ksz_port_info *info;
    struct ksz_port_info *linked = core::ptr::null_mut();
...
pub const PHY_RESET_TIMEOUT: c_int = 10;
//
...
//
#[no_mangle]
unsafe extern "C" fn port_set_link_speed(port: *mut ksz_port) {
...
#[no_mangle]
pub unsafe extern "C" fn if(port->speed: 100 ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(port->duplex: 2 ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn port_force_link_speed(port: *mut ksz_port) {
...
#[no_mangle]
unsafe extern "C" fn port_set_power_saving(port: *mut ksz_port, enable: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_chk_wol_pme_status(hw: *mut ksz_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hw_clr_wol_pme_status(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_cfg_wol_pme(hw: *mut ksz_hw, set: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_cfg_wol(hw: *mut ksz_hw, frame: u16, set: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_add_wol_arp(hw: *mut ksz_hw, ip_addr: *const u8) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_add_wol_bcast(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_add_wol_mcast(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_add_wol_ucast(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_enable_wol(hw: *mut ksz_hw, wol_enable: u32, net_addr: *const u8) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_init(hw: *mut ksz_hw) -> c_int {
...
// Check KSZ884x chip ID.
    ...
    rc = 1;
#[no_mangle]
pub unsafe extern "C" fn if(data: REG_CHIP_ID_42 ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn hw_reset(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_setup(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_setup_intr(hw: *mut ksz_hw) {
    static void hw_setup_intr(struct ksz_hw *hw)
    {
    hw.intr_mask = KS884X_INT_MASK | KS884X_INT_RX_OVERRUN;
    }
#[no_mangle]
unsafe extern "C" fn ksz_check_desc_num(info: *mut ksz_desc_info) {
    static void ksz_check_desc_num(struct ksz_desc_info *info)
    {
pub const MIN_DESC_SHIFT: c_int = 2;
    let mut alloc: c_int = info.alloc;
    int shift;
    shift = 0;
    while (!(alloc & 1)) {
    shift++;
...
#[no_mangle]
unsafe extern "C" fn hw_init_desc(desc_info: *mut ksz_desc_info, transmit: c_int) {
    static void hw_init_desc(struct ksz_desc_info *desc_info, int transmit)
    {
    int i;
    let mut phys: u32 = desc_info.ring_phys;
    struct ksz_hw_desc *desc = desc_info.ring_virt;
    struct ksz_desc *cur = desc_info.ring;
    struct ksz_desc *previous = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn hw_set_desc_base(hw: *mut ksz_hw, tx_addr: u32, rx_addr: u32) {
...
#[no_mangle]
unsafe extern "C" fn hw_reset_pkts(info: *mut ksz_desc_info) {
...
#[no_mangle]
pub unsafe extern "C" fn hw_resume_rx(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_start_rx(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_stop_rx(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_start_tx(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_stop_tx(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_disable(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_enable(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_alloc_pkt(hw: *mut ksz_hw, length: c_int, physical: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hw_send_pkt(hw: *mut ksz_hw) {
...
#[no_mangle]
unsafe extern "C" fn empty_addr(addr: *mut u8) -> c_int {
    static int empty_addr(u8 *addr)
    {
    u32 *addr1 = (u32 *) addr;
    u16 *addr2 = (u16 *) &addr[4];
    let mut 0: return = = *addr1 && 0 == *addr2;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn hw_set_addr(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_read_addr(hw: *mut ksz_hw) {
...
#[no_mangle]
unsafe extern "C" fn hw_ena_add_addr(hw: *mut ksz_hw, index: c_int, mac_addr: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn hw_set_add_addr(hw: *mut ksz_hw) {
...
#[no_mangle]
unsafe extern "C" fn hw_add_addr(hw: *mut ksz_hw, mac_addr: *const u8) -> c_int {
    static int hw_add_addr(struct ksz_hw *hw, const u8 *mac_addr)
    {
    int i;
    let mut j: c_int = ADDITIONAL_ENTRIES;
...
#[no_mangle]
unsafe extern "C" fn hw_del_addr(hw: *mut ksz_hw, mac_addr: *const u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hw_clr_multicast(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_set_grp_addr(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_set_multicast(hw: *mut ksz_hw, multicast: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_set_promiscuous(hw: *mut ksz_hw, prom: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_enable(hw: *mut ksz_hw, enable: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sw_setup(hw: *mut ksz_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn ksz_start_timer(info: *mut ksz_timer_info, time: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn ksz_stop_timer(info: *mut ksz_timer_info) {
...
#[no_mangle]
unsafe extern "C" fn ksz_update_timer(info: *mut ksz_timer_info) {
...
//
#[no_mangle]
unsafe extern "C" fn ksz_alloc_soft_desc(desc_info: *mut ksz_desc_info, transmit: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ksz_alloc_desc(adapter: *mut dev_info) -> c_int {
...
// Allocate memory for RX & TX descriptors.
    ...
    if (adapter.desc_pool.alloc_virt == core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn ksz_init_rx_buffers(adapter: *mut dev_info) {
...
//
#[no_mangle]
unsafe extern "C" fn ksz_alloc_mem(adapter: *mut dev_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ksz_free_desc(adapter: *mut dev_info) {
    static void ksz_free_desc(struct dev_info *adapter)
    {
    struct ksz_hw *hw = &adapter.hw;
// Reset descriptor.
    hw.rx_desc_info.ring_virt = core::ptr::null_mut();
    hw.tx_desc_info.ring_virt = core::ptr::null_mut();
...
// Reset resource pool.
    adapter.desc_pool.alloc_size = 0;
    adapter.desc_pool.alloc_virt = core::ptr::null_mut();
    kfree(hw.rx_desc_info.ring);
    hw.rx_desc_info.ring = core::ptr::null_mut();
    kfree(hw.tx_desc_info.ring);
    hw.tx_desc_info.ring = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ksz_free_mem(adapter: *mut dev_info) {
...
//
#[no_mangle]
unsafe extern "C" fn send_packet(skb: *mut sk_buff, dev: *mut net_device) {
    ...
    struct ksz_dma_buf *dma_buf;
    int len;
    let mut last_frag: c_int = skb_shinfo(skb).nr_frags;
//
...
//
#[no_mangle]
unsafe extern "C" fn transmit_cleanup(hw_priv: *mut dev_info, normal: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn tx_done(hw_priv: *mut dev_info) {
...
#[no_mangle]
pub unsafe extern "C" fn copy_old_skb(old: *mut sk_buff, skb: *mut sk_buff) {
...
//
#[no_mangle]
unsafe extern "C" fn netdev_tx(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
//
#[no_mangle]
unsafe extern "C" fn netdev_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: hw->multi_list_size) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn csum_verified(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn dev_rcv_packets(hw_priv: *mut dev_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_rcv_packets(hw_priv: *mut dev_info) -> c_int {
...
// Get received port number.
    let mut p: c_int = HW_TO_DEV_PORT(status.rx.src_port);
...
#[no_mangle]
unsafe extern "C" fn dev_rcv_special(hw_priv: *mut dev_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rx_proc_task(t: *mut tasklet_struct) {
...
#[no_mangle]
unsafe extern "C" fn tx_proc_task(t: *mut tasklet_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn handle_rx_stop(hw: *mut ksz_hw) {
...
// Receive just has been stopped.
    ...
    hw.intr_mask &= ~KS884X_INT_RX_STOPPED;
#[no_mangle]
pub unsafe extern "C" fn if(1: hw->rx_stop >) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn netdev_intr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn netdev_netpoll(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn bridge_change(hw: *mut ksz_hw) {
...
#[no_mangle]
unsafe extern "C" fn hw_cfg_huge_frame(hw_priv: *mut dev_info, hw: *mut ksz_hw) {
...
#[no_mangle]
unsafe extern "C" fn prepare_hardware(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_media_state(dev: *mut net_device, media_state: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn netdev_set_mac_address(dev: *mut net_device, addr: *mut c_void) -> c_int {
    ...
    let mut prev_state: u8 = hw.promiscuous;
    if (promiscuous)
    ++hw.promiscuous;
    else
    --hw.promiscuous;
...
//
    ...
    struct ksz_switch *sw = hw.ksz_switch;
    let mut port: c_int = priv.port.first_port;
    port_set_stp_state(hw, port, STP_STATE_DISABLED);
    port = 1 << port;
    if (sw.member & port) {
    sw.member &= ~port;
    ...
    let mut all_multi: u8 = hw.all_multi;
    if (multicast)
    ++hw.all_multi;
    else
    --hw.all_multi;
...
//
#[no_mangle]
unsafe extern "C" fn netdev_set_rx_mode(dev: *mut net_device) {
    ...
    let mut multicast: c_int = (dev.flags & IFF_ALLMULTI);
...
#[no_mangle]
unsafe extern "C" fn netdev_change_mtu(dev: *mut net_device, new_mtu: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn netdev_ioctl(dev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
...
// Write MII PHY register.
    ...
    result = -EPERM;
#[no_mangle]
pub unsafe extern "C" fn if(6: data->phy_id != priv->id || data->reg_num >=) -> else {
...
// ethtool support
//
pub const EEPROM_SIZE: c_uint = 0x40;
...
//
    ...
    ADVERTISED_100baseT_Half);
#[no_mangle]
pub unsafe extern "C" fn if(speed: 100 ==) -> else {
    else if (100 == speed)
    advertising &=
    ~(ADVERTISED_10baseT_Full |
    ADVERTISED_10baseT_Half);
    ...
    ADVERTISED_10baseT_Full);
#[no_mangle]
pub unsafe extern "C" fn if(cmd->base.duplex: 1 ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn netdev_get_regs_len(dev: *mut net_device) -> c_int {
    static int netdev_get_regs_len(struct net_device *dev)
    {
    struct hw_regs *range = hw_regs_range;
    let mut regs_len: c_int = 0x10 * sizeof(u32);
...
//
#[no_mangle]
unsafe extern "C" fn netdev_get_eeprom_len(dev: *mut net_device) -> c_int {
    static int netdev_get_eeprom_len(struct net_device *dev)
    {
    return EEPROM_SIZE * 2;
    }
pub const EEPROM_MAGIC: c_uint = 0x10A18842;
//
...
//
#[no_mangle]
unsafe extern "C" fn netdev_get_strings(dev: *mut net_device, stringset: u32, buf: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn netdev_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
//
    ...
    struct ksz_hw *hw = &hw_priv.hw;
    struct ksz_port *port = &priv.port;
    let mut n_stats: c_int = stats.n_stats;
    int i;
    int n;
    int p;
...
#[no_mangle]
unsafe extern "C" fn mib_read_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mib_monitor(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn dev_monitor(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn netdev_init(dev: *mut net_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn netdev_free(dev: *mut net_device) {
...
pub struct platform_info {
    pub dev_info: dev_info,
    pub netdev: [*mut net_device; SWITCH_PORT_NUM],
}

    static int net_device_present;
#[no_mangle]
unsafe extern "C" fn get_mac_addr(hw_priv: *mut dev_info, macaddr: *mut u8, port: c_int) {
    ...
    num = num * 16 + digit;
#[no_mangle]
pub unsafe extern "C" fn if(macaddr[i]: ':' ==) -> else {
    else if (':' == macaddr[i])
    got_num = 2;
    else
    break;
...
#[no_mangle]
unsafe extern "C" fn read_other_addr(hw: *mut ksz_hw) {
...
pub const PCI_VENDOR_ID_MICREL_KS: c_uint = 0x16c6;

#[no_mangle]
unsafe extern "C" fn pcidev_init(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    ...
    struct ksz_switch *sw = core::ptr::null_mut();
...
// MTU range: 60 - 1894
    ...
    info.netdev[i] = core::ptr::null_mut();
    }
    }
    pcidev_init_mem_err:
...
#[no_mangle]
unsafe extern "C" fn pcidev_exit(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pcidev_resume(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn pcidev_suspend(dev_d: *mut device) -> int __maybe_unused {
