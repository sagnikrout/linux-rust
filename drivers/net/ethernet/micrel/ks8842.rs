...
//! Source: drivers/net/ethernet/micrel/ks8842.c
#![no_std]
...
pub const REG_TIMB_RST: c_uint = 0x1c;
pub const REG_TIMB_FIFO: c_uint = 0x20;
pub const REG_TIMB_ISR: c_uint = 0x24;
pub const REG_TIMB_IER: c_uint = 0x28;
pub const REG_TIMB_IAR: c_uint = 0x2C;
pub const REQ_TIMB_DMA_RESUME: c_uint = 0x30;
// KS8842 registers
pub const REG_SELECT_BANK: c_uint = 0x0e;
// bank 0 registers
pub const REG_QRFCR: c_uint = 0x04;
// bank 2 registers
pub const REG_MARL: c_uint = 0x00;
pub const REG_MARM: c_uint = 0x02;
pub const REG_MARH: c_uint = 0x04;
// bank 3 registers
pub const REG_GRR: c_uint = 0x06;
// bank 16 registers
pub const REG_TXCR: c_uint = 0x00;
pub const REG_TXSR: c_uint = 0x02;
pub const REG_RXCR: c_uint = 0x04;
pub const REG_TXMIR: c_uint = 0x08;
pub const REG_RXMIR: c_uint = 0x0A;
// bank 17 registers
pub const REG_TXQCR: c_uint = 0x00;
pub const REG_RXQCR: c_uint = 0x02;
pub const REG_TXFDPR: c_uint = 0x04;
pub const REG_RXFDPR: c_uint = 0x06;
pub const REG_QMU_DATA_LO: c_uint = 0x08;
pub const REG_QMU_DATA_HI: c_uint = 0x0A;
// bank 18 registers
pub const REG_IER: c_uint = 0x00;
pub const IRQ_LINK_CHANGE: c_uint = 0x8000;
pub const IRQ_TX: c_uint = 0x4000;
pub const IRQ_RX: c_uint = 0x2000;
pub const IRQ_RX_OVERRUN: c_uint = 0x0800;
pub const IRQ_TX_STOPPED: c_uint = 0x0200;
pub const IRQ_RX_STOPPED: c_uint = 0x0100;
pub const IRQ_RX_ERROR: c_uint = 0x0080;
...
pub const REG_ISR: c_uint = 0x02;
pub const REG_RXSR: c_uint = 0x04;
pub const RXSR_VALID: c_uint = 0x8000;
pub const RXSR_BROADCAST: c_uint = 0x80;
pub const RXSR_MULTICAST: c_uint = 0x40;
pub const RXSR_UNICAST: c_uint = 0x20;
pub const RXSR_FRAMETYPE: c_uint = 0x08;
pub const RXSR_TOO_LONG: c_uint = 0x04;
pub const RXSR_RUNT: c_uint = 0x02;
pub const RXSR_CRC_ERROR: c_uint = 0x01;

// bank 32 registers
pub const REG_SW_ID_AND_ENABLE: c_uint = 0x00;
pub const REG_SGCR1: c_uint = 0x02;
pub const REG_SGCR2: c_uint = 0x04;
pub const REG_SGCR3: c_uint = 0x06;
// bank 39 registers
pub const REG_MACAR1: c_uint = 0x00;
pub const REG_MACAR2: c_uint = 0x02;
pub const REG_MACAR3: c_uint = 0x04;
// bank 45 registers
pub const REG_P1MBCR: c_uint = 0x00;
pub const REG_P1MBSR: c_uint = 0x02;
// bank 46 registers
pub const REG_P2MBCR: c_uint = 0x00;
pub const REG_P2MBSR: c_uint = 0x02;
// bank 48 registers
pub const REG_P1CR2: c_uint = 0x02;
// bank 49 registers
pub const REG_P1CR4: c_uint = 0x02;
pub const REG_P1SR: c_uint = 0x04;
// flags passed by platform_device for configuration
pub const MICREL_KS884X: c_uint = 0x01	/* 0=Timeberdale(FPGA), 1=Micrel */;
pub const KS884X_16BIT: c_uint = 0x02	/*  1=16bit, 0=32bit */;
pub const DMA_BUFFER_SIZE: c_int = 2048;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ks8842_tx_dma_ctl {
    pub chan: *mut dma_chan,
    pub adesc: *mut dma_async_tx_descriptor,
    pub buf: *mut c_void,
    pub sg: scatterlist,
    pub channel: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ks8842_adapter {
    pub hw_addr: *mut void __iomem,
    pub irq: c_int,
    pub /: *mut *mut unsigned long conf_flags; / copy of platform_device config,
    pub tasklet: tasklet_struct,
    pub /: *mut *mut spinlock_t lock; / spinlock to be interrupt safe,
    pub timeout_work: work_struct,
    pub netdev: *mut net_device,
    pub dev: *mut device,
    pub dma_tx: ks8842_tx_dma_ctl,
    pub dma_rx: ks8842_rx_dma_ctl,
}

    static void ks8842_dma_rx_cb(void *data);
    static void ks8842_dma_tx_cb(void *data);
#[no_mangle]
pub unsafe extern "C" fn ks8842_resume_dma(adapter: *mut ks8842_adapter) {
    static inline void ks8842_resume_dma(struct ks8842_adapter *adapter)
    {
    iowrite32(1, adapter.hw_addr + REQ_TIMB_DMA_RESUME);
    }
#[no_mangle]
pub unsafe extern "C" fn ks8842_select_bank(adapter: *mut ks8842_adapter, bank: u16) {
...
#[no_mangle]
unsafe extern "C" fn ks8842_reset(adapter: *mut ks8842_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ks8842_init_mac_addr(adapter: *mut ks8842_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ks8842_write_mac_addr(adapter: *mut ks8842_adapter, mac: *const u8) {
...
#[no_mangle]
pub unsafe extern "C" fn ks8842_tx_fifo_space(adapter: *mut ks8842_adapter) -> u16 {
    static inline u16 ks8842_tx_fifo_space(struct ks8842_adapter *adapter)
    {
    return ks8842_read16(adapter, 16, REG_TXMIR) & 0x1fff;
    }
#[no_mangle]
unsafe extern "C" fn ks8842_tx_frame_dma(skb: *mut sk_buff, netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks8842_tx_frame(skb: *mut sk_buff, netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks8842_update_rx_err_counters(netdev: *mut net_device, status: u32) {
...
#[no_mangle]
unsafe extern "C" fn __ks8842_start_new_rx_dma(netdev: *mut net_device) -> c_int {
    ...
    ctl.skb = core::ptr::null_mut();
    printk(KERN_ERR DRV_NAME": Failed to start RX DMA: %d\n", err);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn ks8842_rx_frame_dma_tasklet(t: *mut tasklet_struct) {
    ...
    let mut addr: dma_addr_t = sg_dma_address(&ctl.sg);
    u32 status;
    ctl.adesc = core::ptr::null_mut();
...
// check the status
    ...
    let mut len: c_int = (status >> 16) & 0x7ff;
...
// set high watermark to 2K
    ...
    struct ks8842_adapter *adapter)
    {
    let mut rx_data: u16 = ks8842_read16(adapter, 16, REG_RXMIR) & 0x1fff;
    ...
    struct ks8842_adapter *adapter)
    {
    let mut sr: u16 = ks8842_read16(adapter, 16, REG_TXSR);
...
#[no_mangle]
unsafe extern "C" fn ks8842_tasklet(t: *mut tasklet_struct) {
...
#[no_mangle]
unsafe extern "C" fn ks8842_irq(irq: c_int, devid: *mut c_void) -> irqreturn_t {
    static irqreturn_t ks8842_irq(int irq, void *devid)
    {
    struct net_device *netdev = devid;
    struct ks8842_adapter *adapter = netdev_priv(netdev);
    u16 isr;
    let mut entry_bank: u16 = ioread16(adapter.hw_addr + REG_SELECT_BANK);
...
#[no_mangle]
unsafe extern "C" fn ks8842_dma_rx_cb(data: *mut c_void) {
    static void ks8842_dma_rx_cb(void *data)
    {
...
#[no_mangle]
unsafe extern "C" fn ks8842_dma_tx_cb(data: *mut c_void) {
    static void ks8842_dma_tx_cb(void *data)
    {
    struct net_device		*netdev = data;
    struct ks8842_adapter		*adapter = netdev_priv(netdev);
...
#[no_mangle]
unsafe extern "C" fn ks8842_stop_dma(adapter: *mut ks8842_adapter) {
    ...
    tx_ctl.adesc = core::ptr::null_mut();
    if (tx_ctl.chan)
    dmaengine_terminate_all(tx_ctl.chan);
    rx_ctl.adesc = core::ptr::null_mut();
    if (rx_ctl.chan)
    ...
    rx_ctl.skb = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ks8842_dealloc_dma_bufs(adapter: *mut ks8842_adapter) {
    ...
    tx_ctl.chan = core::ptr::null_mut();
    if (rx_ctl.chan)
    dma_release_channel(rx_ctl.chan);
    rx_ctl.chan = core::ptr::null_mut();
    ...
    kfree(tx_ctl.buf);
    tx_ctl.buf = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ks8842_dma_filter_fn(chan: *mut dma_chan, filter_param: *mut c_void) -> bool {
    static bool ks8842_dma_filter_fn(struct dma_chan *chan, void *filter_param)
    {
    return chan.chan_id == (long)filter_param;
    }
#[no_mangle]
unsafe extern "C" fn ks8842_alloc_dma_bufs(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks8842_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks8842_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks8842_set_mac(netdev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks8842_tx_timeout_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ks8842_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ks8842_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks8842_remove(pdev: *mut platform_device) {
