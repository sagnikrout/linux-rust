...
//! Source: drivers/net/ethernet/micrel/ks8851_common.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_lock(ks: *mut ks8851_net) {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_unlock(ks: *mut ks8851_net) {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_soft_reset(ks: *mut ks8851_net, op: unsigned) {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_set_powermode(ks: *mut ks8851_net, pwrmode: unsigned) {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_write_mac_addr(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_read_mac_addr(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_init_mac(ks: *mut ks8851_net, np: *mut device_node) {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_rx_pkts(ks: *mut ks8851_net, rxq: *mut sk_buff_head) {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_irq(irq: c_int, _ks: *mut c_void) -> irqreturn_t {
    ...
    "%s: status 0x%04x\n", __func__, status);
    if (status & IRQ_LDI) {
    let mut pmecr: u16 = ks8851_rdreg16(ks, KS_PMECR);
    pmecr &= ~PMECR_WKEVT_MASK;
    ks8851_wrreg16(ks, KS_PMECR, pmecr | PMECR_WKEVT_LINK);
    }
    if (status & IRQ_TXI) {
    let mut tx_space: c_ushort = ks8851_rdreg16(ks, KS_TXMIR);
    netif_dbg(ks, intr, ks.netdev,
    "%s: txspace %d\n", __func__, tx_space);
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_flush_tx_work(ks: *mut ks8851_net) {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_net_open(dev: *mut net_device) -> c_int {
    static int ks8851_net_open(struct net_device *dev)
    {
    struct ks8851_net *ks = netdev_priv(dev);
    int ret;
    ret = request_threaded_irq(dev.irq, core::ptr::null_mut(), ks8851_irq,
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_net_stop(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_rxctrl_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ks8851_set_rx_mode(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ks8851_set_mac_address(dev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks8851_net_ioctl(dev: *mut net_device, req: *mut ifreq, cmd: c_int) -> c_int {
    static int ks8851_net_ioctl(struct net_device *dev, struct ifreq *req, int cmd)
    {
    struct ks8851_net *ks = netdev_priv(dev);
    if (!netif_running(dev))
    return -EINVAL;
    return generic_mii_ioctl(&ks.mii, if_mii(req), cmd, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn ks8851_get_msglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ks8851_set_msglevel(dev: *mut net_device, to: u32) {
...
#[no_mangle]
unsafe extern "C" fn ks8851_get_link(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ks8851_nway_reset(dev: *mut net_device) -> c_int {
...
// EEPROM support
#[no_mangle]
unsafe extern "C" fn ks8851_eeprom_regread(ee: *mut eeprom_93cx6) {
...
#[no_mangle]
unsafe extern "C" fn ks8851_eeprom_regwrite(ee: *mut eeprom_93cx6) {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_eeprom_claim(ks: *mut ks8851_net) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_eeprom_release(ks: *mut ks8851_net) {
    static void ks8851_eeprom_release(struct ks8851_net *ks)
    {
    let mut val: unsigned = ks8851_rdreg16(ks, KS_EEPCR);
...
#[no_mangle]
unsafe extern "C" fn ks8851_get_eeprom_len(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_phy_reg(reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks8851_phy_read_common(dev: *mut net_device, phy_addr: c_int, reg: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_phy_read(dev: *mut net_device, phy_addr: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks8851_mdio_read(bus: *mut mii_bus, phy_id: c_int, reg: c_int) -> c_int {
...
// KS8851 PHY ID registers are swapped in HW, swap them back.
    ...
    reg = MII_PHYSID2;
#[no_mangle]
pub unsafe extern "C" fn if(MII_PHYSID2: reg ==) -> else {
    else if (reg == MII_PHYSID2)
    reg = MII_PHYSID1;
    return ks8851_phy_read_common(ks.netdev, phy_id, reg);
    }
#[no_mangle]
unsafe extern "C" fn ks8851_mdio_write(bus: *mut mii_bus, phy_id: c_int, reg: c_int, val: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ks8851_read_selftest(ks: *mut ks8851_net) {
    static void ks8851_read_selftest(struct ks8851_net *ks)
    {
    let mut both_done: unsigned = MBIR_TXMBF | MBIR_RXMBF;
    unsigned rd;
...
#[no_mangle]
pub unsafe extern "C" fn ks8851_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ks8851_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks8851_register_mdiobus(ks: *mut ks8851_net, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks8851_unregister_mdiobus(ks: *mut ks8851_net) {
...
#[no_mangle]
pub unsafe extern "C" fn ks8851_remove_common(dev: *mut device) {
