...
//! Source: drivers/net/ethernet/lantiq_xrx200.c
#![no_std]
...
pub const XRX200_DMA_RX: c_int = 0;
pub const XRX200_DMA_TX: c_int = 1;
pub const XRX200_DMA_BURST_LEN: c_int = 8;
pub const XRX200_DMA_PACKET_COMPLETE: c_int = 0;
pub const XRX200_DMA_PACKET_IN_PROGRESS: c_int = 1;
// cpu port mac
pub const PMAC_RX_IPG: c_uint = 0x0024;
pub const PMAC_RX_IPG_MASK: c_uint = 0xf;
pub const PMAC_HD_CTL: c_uint = 0x0000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xrx200_priv {
    pub clk: *mut clk,
    pub chan_tx: xrx200_chan,
    pub chan_rx: xrx200_chan,
    pub rx_buf_size: u16,
    pub rx_skb_size: u16,
    pub net_dev: *mut net_device,
    pub dev: *mut device,
    pub pmac_reg: *mut __iomem void,
}

#[no_mangle]
unsafe extern "C" fn xrx200_pmac_r32(priv: *mut xrx200_priv, offset: u32) -> u32 {
    static u32 xrx200_pmac_r32(struct xrx200_priv *priv, u32 offset)
    {
    return __raw_readl(priv.pmac_reg + offset);
    }
#[no_mangle]
unsafe extern "C" fn xrx200_pmac_w32(priv: *mut xrx200_priv, val: u32, offset: u32) {
    ...
    u32 offset)
    {
    let mut val: u32 = xrx200_pmac_r32(priv, offset);
    val &= ~(clear);
    val |= set;
    xrx200_pmac_w32(priv, val, offset);
    }
#[no_mangle]
unsafe extern "C" fn xrx200_max_frame_len(mtu: c_int) -> c_int {
    static int xrx200_max_frame_len(int mtu)
    {
    return VLAN_ETH_HLEN + mtu;
    }
#[no_mangle]
unsafe extern "C" fn xrx200_buffer_size(mtu: c_int) -> c_int {
    static int xrx200_buffer_size(int mtu)
    {
    return round_up(xrx200_max_frame_len(mtu), 4 * XRX200_DMA_BURST_LEN);
    }
#[no_mangle]
unsafe extern "C" fn xrx200_skb_size(buf_size: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xrx200_flush_dma(ch: *mut xrx200_chan) {
...
#[no_mangle]
unsafe extern "C" fn xrx200_open(net_dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xrx200_close(net_dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xrx200_alloc_buf(ch: *mut xrx200_chan, size): *mut *mut *mut void (alloc)(unsigned int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xrx200_hw_receive(ch: *mut xrx200_chan) -> c_int {
    static int xrx200_hw_receive(struct xrx200_chan *ch)
    {
    struct xrx200_priv *priv = ch.priv;
    struct ltq_dma_desc *desc = &ch.dma.desc_base[ch.dma.desc];
    void *buf = ch.rx_buff[ch.dma.desc];
    let mut ctl: u32 = desc.ctl;
    let mut len: c_int = (ctl & LTQ_DMA_SIZE_MASK);
...
// add buffers to skb via skb->frag_list
    ...
    ch.skb_head = core::ptr::null_mut();
    ch.skb_tail = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn xrx200_poll_rx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xrx200_tx_housekeeping(napi: *mut napi_struct, budget: c_int) -> c_int {
...
// Make sure the address is written before we give it to HW
    ...
    let mut old_mtu: c_int = net_dev.mtu;
...
#[no_mangle]
unsafe extern "C" fn xrx200_dma_irq(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xrx200_dma_init(priv: *mut xrx200_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xrx200_hw_cleanup(priv: *mut xrx200_priv) {
...
#[no_mangle]
unsafe extern "C" fn xrx200_probe(pdev: *mut platform_device) -> c_int {
...
// load the memory ranges
    priv.pmac_reg = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn xrx200_remove(pdev: *mut platform_device) {
