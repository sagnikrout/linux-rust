...
//! Source: drivers/net/ethernet/amazon/ena/ena_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ena_metrics_stats(adapter: *mut ena_adapter, data: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn ena_queue_stats(adapter: *mut ena_adapter, data: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn ena_dev_admin_queue_stats(adapter: *mut ena_adapter, data: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn ena_get_sw_stats_count(adapter: *mut ena_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ena_get_hw_stats_count(adapter: *mut ena_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ena_com_get_cap(dev, _arg: ENA_ADMIN_ENI_STATS)) -> else {
    else if (ena_com_get_cap(dev, ENA_ADMIN_ENI_STATS))
    count += ENA_STATS_ARRAY_ENI;
    return count;
    }
#[no_mangle]
pub unsafe extern "C" fn ena_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ena_metrics_stats_strings(adapter: *mut ena_adapter, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn ena_queue_strings(adapter: *mut ena_adapter, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn ena_com_dev_strings(data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn ena_update_tx_rings_nonadaptive_intr_moderation(adapter: *mut ena_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ena_update_rx_rings_nonadaptive_intr_moderation(adapter: *mut ena_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ena_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ena_set_msglevel(netdev: *mut net_device, value: u32) {
    ...
    let mut large_llq_supported: bool = adapter.large_llq_header_supported;
...
// Validate that the push buffer is supported on the underlying device
    ...
    let mut large_llq_sup: bool = adapter.large_llq_header_supported;
...
#[no_mangle]
unsafe extern "C" fn ena_flow_hash_to_flow_type(hash_fields: u16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ena_flow_data_to_flow_hash(hash_fields: u32) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn ena_get_rx_ring_count(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ena_get_rxfh_indir_size(netdev: *mut net_device) -> u32 {
    static u32 ena_get_rxfh_indir_size(struct net_device *netdev)
    {
    return ENA_RX_RSS_TABLE_SIZE;
    }
#[no_mangle]
unsafe extern "C" fn ena_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
    ...
    let mut rc: return = = -EPERM ? -EOPNOTSUPP : rc;
    }
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn ena_indirection_table_get(adapter: *mut ena_adapter, indir: *mut u32) -> c_int {
...
//
    ...
    struct ena_adapter *adapter = netdev_priv(netdev);
    struct ena_com_dev *ena_dev = adapter.ena_dev;
    let mut func: enum ena_admin_hash_functions = 0;
    int rc;
    if (rxfh.indir) {
    ...
    {
    struct ena_adapter *adapter = netdev_priv(netdev);
    let mut count: u32 = channels.combined_count;
...
#[no_mangle]
pub unsafe extern "C" fn ena_set_ethtool_ops(netdev: *mut net_device) {
    void ena_set_ethtool_ops(struct net_device *netdev)
    {
    netdev.ethtool_ops = &ena_ethtool_ops;
    }
#[no_mangle]
unsafe extern "C" fn ena_dump_stats_ex(adapter: *mut ena_adapter, buf: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn ena_dump_stats_to_buf(adapter: *mut ena_adapter, buf: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn ena_dump_stats_to_dmesg(adapter: *mut ena_adapter) {
    void ena_dump_stats_to_dmesg(struct ena_adapter *adapter)
    {
    ena_dump_stats_ex(adapter, core::ptr::null_mut());
    }
