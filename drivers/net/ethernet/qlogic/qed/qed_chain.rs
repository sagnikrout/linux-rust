...
//! Source: drivers/net/ethernet/qlogic/qed/qed_chain.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qed_chain_free_pbl(cdev: *mut qed_dev, chain: *mut qed_chain) {
    ...
    chain.pbl.pp_addr_tbl = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn qed_chain_free(cdev: *mut qed_dev, chain: *mut qed_chain) {
    ...
    qed_chain_init_mem(chain, core::ptr::null_mut(), 0);
    }
    static int
...
//
    ...
    {
    struct device *dev = &cdev.pdev.dev;
    void *virt, *virt_prev = core::ptr::null_mut();
    dma_addr_t phys;
    u32 i;
    for (i = 0; i < chain.page_cnt; i++) {
...
#[no_mangle]
unsafe extern "C" fn qed_chain_alloc_pbl(cdev: *mut qed_dev, chain: *mut qed_chain) -> c_int {
