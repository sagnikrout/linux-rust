...
//! Source: drivers/net/ethernet/qlogic/qed/qed_init_fw_funcs.c
#![no_std]
...
// General constants
    ...
    0x100) - 1 : 0)
pub const QM_INVALID_PQ_ID: c_uint = 0xffff;
// Max link speed (in Mbps)
pub const QM_MAX_LINK_SPEED: c_int = 100000;
// Feature enable
pub const QM_BYPASS_EN: c_int = 1;
pub const QM_BYTE_CRD_EN: c_int = 1;
// Initial VOQ byte credit
pub const QM_INITIAL_VOQ_BYTE_CRD: c_int = 98304;
// Other PQ constants
pub const QM_OTHER_PQS_PER_PF: c_int = 4;
// VOQ constants
...
pub const QM_PF_WFQ_UPPER_BOUND: c_int = 62500000;
// PF WFQ max increment value, 0.7 * upper bound

// Number of VOQs in E5 PF WFQ credit register (QmWfqCrd)
pub const QM_PF_WFQ_CRD_E5_NUM_VOQS: c_int = 16;
// VP WFQ increment value

// VP WFQ min increment value
pub const QM_VP_WFQ_MIN_INC_VAL: c_int = 10800;
// VP WFQ max increment value, 2^30
pub const QM_VP_WFQ_MAX_INC_VAL: c_uint = 0x40000000;
// VP WFQ bypass threshold

// VP RL credit task cost
pub const QM_VP_RL_CRD_TASK_COST: c_int = 9700;
// Bit of VOQ in VP WFQ PQ map
pub const QM_VP_WFQ_PQ_VOQ_SHIFT: c_int = 0;
// Bit of PF in VP WFQ PQ map
pub const QM_VP_WFQ_PQ_PF_SHIFT: c_int = 5;
// RL constants
// Period in us
pub const QM_RL_PERIOD: c_int = 5;
...
pub const QM_PF_RL_UPPER_BOUND: c_int = 62500000;
...
pub const QM_OPPOR_LINE_VOQ_DEF: c_int = 1;
pub const QM_OPPOR_FW_STOP_DEF: c_int = 0;
pub const QM_OPPOR_PQ_EMPTY_DEF: c_int = 1;
// Command Queue constants
// Pure LB CmdQ lines (+spare)
pub const PBF_CMDQ_PURE_LB_LINES: c_int = 150;
...
pub const BTB_JUMBO_PKT_BLOCKS: c_int = 38;
// Headroom per-port

pub const BTB_PURE_LB_FACTOR: c_int = 10;
// Factored (hence really 0.7)
pub const BTB_PURE_LB_RATIO: c_int = 7;
// QM stop command constants
pub const QM_STOP_PQ_MASK_WIDTH: c_int = 32;
pub const QM_STOP_CMD_ADDR: c_int = 2;
pub const QM_STOP_CMD_STRUCT_SIZE: c_int = 2;
pub const QM_STOP_CMD_PAUSE_MASK_OFFSET: c_int = 0;
pub const QM_STOP_CMD_PAUSE_MASK_SHIFT: c_int = 0;

pub const QM_STOP_CMD_GROUP_ID_OFFSET: c_int = 1;
pub const QM_STOP_CMD_GROUP_ID_SHIFT: c_int = 16;
pub const QM_STOP_CMD_GROUP_ID_MASK: c_int = 15;
pub const QM_STOP_CMD_PQ_TYPE_OFFSET: c_int = 1;
pub const QM_STOP_CMD_PQ_TYPE_SHIFT: c_int = 24;
pub const QM_STOP_CMD_PQ_TYPE_MASK: c_int = 1;
pub const QM_STOP_CMD_MAX_POLL_COUNT: c_int = 100;
pub const QM_STOP_CMD_POLL_PERIOD_US: c_int = 500;
// QM command macros
...
pub const WRITE_PQ_INFO_TO_RAM: c_int = 1;
    ...
    { core::ptr::null_mut() }, /*TOE*/
    { core::ptr::null_mut() }, /*PREROCE*/
...
#[no_mangle]
unsafe extern "C" fn qed_enable_pf_rl(p_hwfn: *mut qed_hwfn, pf_rl_en: bool) {
    static void qed_enable_pf_rl(struct qed_hwfn *p_hwfn, bool pf_rl_en)
    {
    STORE_RT_REG(p_hwfn, QM_REG_RLPFENABLE_RT_OFFSET, pf_rl_en ? 1 : 0);
    if (pf_rl_en) {
    let mut num_ext_voqs: u8 = MAX_NUM_VOQS;
    let mut voq_bit_mask: u64 = ((u64)1 << num_ext_voqs) - 1;
...
#[no_mangle]
unsafe extern "C" fn qed_enable_pf_wfq(p_hwfn: *mut qed_hwfn, pf_wfq_en: bool) {
...
#[no_mangle]
unsafe extern "C" fn qed_enable_global_rl(p_hwfn: *mut qed_hwfn, global_rl_en: bool) {
...
#[no_mangle]
unsafe extern "C" fn qed_enable_vport_wfq(p_hwfn: *mut qed_hwfn, vport_wfq_en: bool) {
...
//
    ...
    {
    let mut qm_line_crd: u32 = QM_VOQ_LINE_CRD(cmdq_lines);
...
//
#[no_mangle]
unsafe extern "C" fn qed_global_rl_rt_init(p_hwfn: *mut qed_hwfn) -> c_int {
...
// Prepare Tx PQ mapping runtime init values for the specified PF
    ...
    let mut num_tx_pq_vf_masks: u32 = MAX_QM_TX_QUEUES / QM_PF_QUEUE_GROUP_SIZE;
...
// Go over all Tx PQs
    ...
    let mut tc_id: u8 = pq_params[i].tc_id;
    bool is_vf_pq;
    u8 ext_voq;
    ext_voq = qed_get_ext_voq(p_hwfn,
    pq_params[i].port_id,
...
//
    ...
    struct qed_qm_pf_rt_init_params *p_params)
    {
    let mut num_tx_pqs: u16 = p_params.num_pf_pqs + p_params.num_vf_pqs;
    struct init_qm_pq_params *pq_params = p_params.pq_params;
...
//
#[no_mangle]
unsafe extern "C" fn qed_pf_rl_rt_init(p_hwfn: *mut qed_hwfn, pf_id: u8, pf_rl: u32) -> c_int {
    static int qed_pf_rl_rt_init(struct qed_hwfn *p_hwfn, u8 pf_id, u32 pf_rl)
    {
    let mut inc_val: u32 = QM_RL_INC_VAL(pf_rl);
...
// Set VPORT RL
    ...
    {
    let mut inc_val: u32 = QM_PF_WFQ_INC_VAL(pf_wfq);
    if (!inc_val || inc_val > QM_PF_WFQ_MAX_INC_VAL) {
    DP_NOTICE(p_hwfn, "Invalid PF WFQ weight configuration\n");
    return -1;
    }
    ...
    let mut pq_mask: u32 = 0, last_pq, pq_id;
...
pub const PRS_ETH_TUNN_OUTPUT_FORMAT: c_uint = 0xF4DAB910;
pub const PRS_ETH_OUTPUT_FORMAT: c_uint = 0xFFFF4910;
...
pub const PRS_ETH_VXLAN_NO_L2_ENABLE_OFFSET: c_int = 3;
pub const PRS_ETH_VXLAN_NO_L2_OUTPUT_FORMAT: c_uint = 0xC8DAB910;
...
pub const T_ETH_PACKET_ACTION_GFT_EVENTID: c_int = 23;
pub const PARSER_ETH_CONN_GFT_ACTION_CM_HDR: c_int = 272;
pub const T_ETH_PACKET_MATCH_RFS_EVENTID: c_int = 25;
pub const PARSER_ETH_CONN_CM_HDR: c_int = 0;

#[no_mangle]
pub unsafe extern "C" fn qed_gft_disable(p_hwfn: *mut qed_hwfn, p_ptt: *mut qed_ptt, pf_id: u16) {
    void qed_gft_disable(struct qed_hwfn *p_hwfn, struct qed_ptt *p_ptt, u16 pf_id)
    {
    let mut ram_line: regpair = { 0 };
...
#[no_mangle]
unsafe extern "C" fn qed_get_rdma_assert_ram_addr(p_hwfn: *mut qed_hwfn, storm_id: u8) -> u32 {
    ...
    let mut ram_addr: u32 = qed_get_rdma_assert_ram_addr(p_hwfn, storm_id);
    qed_wr(p_hwfn, p_ptt, ram_addr, assert_level[storm_id]);
    }
    }

#[no_mangle]
unsafe extern "C" fn qed_get_overlay_addr_ram_addr(p_hwfn: *mut qed_hwfn, storm_id: u8) -> u32 {
    ...
    {
    let mut buf_size: u32 = buf_size_in_bytes / sizeof(u32), buf_offset = 0;
