...
//! Source: drivers/net/ethernet/qlogic/qed/qed_main.c
#![no_std]
...
pub const QED_NVM_CFG_GET_FLAGS: c_uint = 0xA;
pub const QED_NVM_CFG_GET_PF_FLAGS: c_uint = 0x1A;
pub const QED_NVM_CFG_MAX_ATTRS: c_int = 50;
    static char version[] =
...
#[no_mangle]
unsafe extern "C" fn qed_mfw_speed_map_populate(map: *mut qed_mfw_speed_map) -> void __init {
    static void __init qed_mfw_speed_map_populate(struct qed_mfw_speed_map *map)
    {
    linkmode_set_bit_array(map.cap_arr, map.arr_size, map.caps);
    map.cap_arr = core::ptr::null_mut();
    map.arr_size = 0;
    }
#[no_mangle]
unsafe extern "C" fn qed_mfw_speed_maps_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn qed_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn qed_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn qed_free_pci(cdev: *mut qed_dev) {
...
pub const PCI_REVISION_ID_ERROR_VAL: c_uint = 0xff;
// Performs PCI initializations as well as initializing PCI-related parameters
// in the device structrue. Returns 0 in case of success.
//
#[no_mangle]
unsafe extern "C" fn qed_init_pci(cdev: *mut qed_dev, pdev: *mut pci_dev) -> c_int {
    ...
    &dev_info.mfw_rev, core::ptr::null_mut());
    ...
    qed_mcp_get_mfw_ver(QED_LEADING_HWFN(cdev), core::ptr::null_mut(),
    &dev_info.mfw_rev, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn qed_free_cdev(cdev: *mut qed_dev) {
...
#[no_mangle]
unsafe extern "C" fn qed_set_power_state(cdev: *mut qed_dev, state: pci_power_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_remove(cdev: *mut qed_dev) {
...
#[no_mangle]
unsafe extern "C" fn qed_disable_msix(cdev: *mut qed_dev) {
...
// Enable MSIX
    ...
    let mut relative_idx: c_int = index / cdev.num_hwfns;
    hwfn.simd_proto_handler[relative_idx].func = handler;
    hwfn.simd_proto_handler[relative_idx].token = token;
    }
#[no_mangle]
unsafe extern "C" fn qed_simd_handler_clean(cdev: *mut qed_dev, index: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qed_msix_sp_int(irq: c_int, tasklet: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qed_single_int(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
// Fastpath interrupts
    ...
    DP_NOTICE(hwfn,
    "Not calling fastpath handler as it is core::ptr::null_mut() [handler #%d, status 0x%llx]\n",
    j, status);
    status &= ~(0x2ULL << j);
    rc = IRQ_HANDLED;
    }
...
#[no_mangle]
pub unsafe extern "C" fn qed_slowpath_irq_req(hwfn: *mut qed_hwfn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_slowpath_tasklet_flush(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
pub unsafe extern "C" fn qed_slowpath_irq_sync(p_hwfn: *mut qed_hwfn) {
    void qed_slowpath_irq_sync(struct qed_hwfn *p_hwfn)
    {
    struct qed_dev *cdev = p_hwfn.cdev;
    let mut id: u8 = p_hwfn.my_id;
    u32 int_mode;
    int_mode = cdev.int_params.out.int_mode;
    if (int_mode == QED_INT_MODE_MSIX)
...
#[no_mangle]
unsafe extern "C" fn qed_slowpath_irq_free(cdev: *mut qed_dev) {
...
#[no_mangle]
unsafe extern "C" fn qed_nic_stop(cdev: *mut qed_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_nic_setup(cdev: *mut qed_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_set_int_fp(cdev: *mut qed_dev, cnt: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cdev->int_params.fp_msix_cnt) -> else {
...
#[no_mangle]
unsafe extern "C" fn qed_get_int_fp(cdev: *mut qed_dev, info: *mut qed_int_info) -> c_int {
...
//
    if (cdev.int_params.out.int_mode == QED_INT_MODE_MSIX) {
    let mut msix_base: c_int = cdev.int_params.fp_msix_base;
...
#[no_mangle]
unsafe extern "C" fn qed_slowpath_vf_setup_int(cdev: *mut qed_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_alloc_stream_mem(cdev: *mut qed_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_free_stream_mem(cdev: *mut qed_dev) {
...
pub const QED_PERIODIC_DB_REC_COUNT: c_int = 10;
pub const QED_PERIODIC_DB_REC_INTERVAL_MS: c_int = 100;
...
#[no_mangle]
pub unsafe extern "C" fn qed_periodic_db_rec_start(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_slowpath_wq_stop(cdev: *mut qed_dev) {
...
#[no_mangle]
unsafe extern "C" fn qed_slowpath_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qed_slowpath_wq_start(cdev: *mut qed_dev) -> c_int {
    ...
    const u8 *data = core::ptr::null_mut();
    struct qed_hwfn *hwfn;
...
#[no_mangle]
unsafe extern "C" fn qed_slowpath_stop(cdev: *mut qed_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_set_name(cdev: *mut qed_dev, name[NAME_SIZE]: c_char) {
...
// RoCE/Storage use a single engine in CMT mode while L2 uses both
    ...
    rc = qed_int_sb_init(p_hwfn, core::ptr::null_mut(), sb_info, sb_virt_addr,
    sb_phy_addr, rel_sb_id);
    }
    return rc;
    }
...
#[no_mangle]
unsafe extern "C" fn qed_can_link_change(cdev: *mut qed_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qed_set_link(cdev: *mut qed_dev, params: *mut qed_link_params) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_get_port_type(media_type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_lp_caps_to_speed_mask(caps: u32, speed_mask: *mut u32) {
...
// MFW clears adv_caps on eee disable; use configured value
    ...
    qed_fill_link(hwfn, core::ptr::null_mut(), if_link);
    }
    for_each_hwfn(cdev, i)
    qed_inform_vf_link_state(&cdev.hwfns[i]);
    }
#[no_mangle]
pub unsafe extern "C" fn qed_link_update(hwfn: *mut qed_hwfn, ptt: *mut qed_ptt) {
...
#[no_mangle]
pub unsafe extern "C" fn qed_bw_update(hwfn: *mut qed_hwfn, ptt: *mut qed_ptt) {
...
#[no_mangle]
unsafe extern "C" fn qed_drain(cdev: *mut qed_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qed_nvm_flash_cfg_write(cdev: *mut qed_dev, data: *const u8) -> c_int {
    static int qed_nvm_flash_cfg_write(struct qed_dev *cdev, const u8 **data)
    {
    struct qed_hwfn *hwfn = QED_LEADING_HWFN(cdev);
    u8 entity_id, len, buf[32];
    let mut need_nvm_init: bool = true;
    struct qed_ptt *ptt;
    u16 cfg_id, count;
    let mut rc: c_int = 0, i;
    u32 flags;
...
pub const QED_MAX_NVM_BUF_LEN: c_int = 32;
#[no_mangle]
unsafe extern "C" fn qed_nvm_flash_cfg_len(cdev: *mut qed_dev, cmd: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_nvm_flash(cdev: *mut qed_dev, name: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_schedule_recovery_handler(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_set_led(cdev: *mut qed_dev, mode: enum qed_led_mode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_recovery_process(cdev: *mut qed_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_update_wol(cdev: *mut qed_dev, enabled: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_update_drv_state(cdev: *mut qed_dev, active: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_update_mac(cdev: *mut qed_dev, mac: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_update_mtu(cdev: *mut qed_dev, mtu: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_set_grc_config(cdev: *mut qed_dev, cfg_id: u32, val: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __printf(_arg: 2, cdev: *mut 3) void qed_mfw_report(struct qed_dev, fmt: *mut c_char, ...) -> static {
...
#[no_mangle]
unsafe extern "C" fn qed_get_affin_hwfn_idx(cdev: *mut qed_dev) -> u8 {
    static u8 qed_get_affin_hwfn_idx(struct qed_dev *cdev)
    {
    return QED_AFFIN_HWFN_IDX(cdev);
    }
#[no_mangle]
unsafe extern "C" fn qed_get_esl_status(cdev: *mut qed_dev, esl_active: *mut bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_mfw_tlv_req(hwfn: *mut qed_hwfn) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_get_epoch_time() -> c_ulong {
