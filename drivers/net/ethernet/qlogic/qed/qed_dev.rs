...
//! Source: drivers/net/ethernet/qlogic/qed/qed_dev.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qed_db_recovery_entry {
    pub list_entry: list_head,
    pub db_addr: *mut void __iomem,
    pub db_data: *mut c_void,
    pub db_width: enum qed_db_rec_width,
    pub db_space: enum qed_db_rec_space,
    pub hwfn_idx: u8,
}
...
// Doorbell address sanity (address within doorbell bar range)
    ...
    void *db_data)
    {
    let mut width: u32 = (db_width == DB_REC_WIDTH_32B) ? 32 : 64;
...
// Remove an entry from the doorbell recovery mechanism
    ...
    {
    struct qed_db_recovery_entry *db_entry = core::ptr::null_mut();
    struct qed_hwfn *p_hwfn;
...
#[no_mangle]
unsafe extern "C" fn qed_db_recovery_setup(p_hwfn: *mut qed_hwfn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_db_recovery_teardown(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
pub unsafe extern "C" fn qed_db_recovery_execute(p_hwfn: *mut qed_hwfn) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qed_llh_mac_filter {
    pub addr: [u8; ETH_ALEN],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qed_llh_protocol_filter {
    pub type: enum qed_llh_prot_filter_type_t,
    pub source_port_or_eth_type: u16,
    pub dest_port: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qed_llh_filter_info {
    pub b_enabled: bool,
    pub ref_cnt: u32,
    pub type: enum qed_llh_filter_type,
    pub filter: union qed_llh_filter,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qed_llh_info {
// Number of LLH filters banks
    pub num_ppfid: u8,
pub const MAX_NUM_PPFID: c_int = 8;
    pub ppfid_array: [u8; MAX_NUM_PPFID],
...
//
    pub pp_filters: *mut qed_llh_filter_info,
}

#[no_mangle]
unsafe extern "C" fn qed_llh_free(cdev: *mut qed_dev) {
    ...
    kfree(p_llh_info);
    cdev.p_llh_info = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn qed_llh_alloc(cdev: *mut qed_dev) -> c_int {
...
pub const QED_LLH_INVALID_FILTER_IDX: c_uint = 0xff;
    static int
...
#[no_mangle]
unsafe extern "C" fn qed_llh_abs_ppfid(cdev: *mut qed_dev, ppfid: u8, p_abs_ppfid: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_llh_get_num_ppfid(cdev: *mut qed_dev) -> u8 {
    u8 qed_llh_get_num_ppfid(struct qed_dev *cdev)
    {
    return cdev.p_llh_info.num_ppfid;
    }
pub const NIG_REG_PPF_TO_ENGINE_SEL_ROCE_MASK: c_uint = 0x3;
pub const NIG_REG_PPF_TO_ENGINE_SEL_ROCE_SHIFT: c_int = 0;
pub const NIG_REG_PPF_TO_ENGINE_SEL_NON_ROCE_MASK: c_uint = 0x3;
pub const NIG_REG_PPF_TO_ENGINE_SEL_NON_ROCE_SHIFT: c_int = 2;
#[no_mangle]
pub unsafe extern "C" fn qed_llh_set_ppfid_affinity(cdev: *mut qed_dev, ppfid: u8, eng: enum qed_eng) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_llh_set_roce_affinity(cdev: *mut qed_dev, eng: enum qed_eng) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qed_llh_filter_details {
    pub value: u64,
    pub mode: u32,
    ...
    {
    let mut params: qed_dmae_params = {0};
    u32 addr;
    u8 pfid;
    int rc;
...
// Mode: 0: MAC-address classification 1: protocol classification
    ...
    {
    let mut filter_details: qed_llh_filter_details = {0};
    return qed_llh_access_filter(p_hwfn, p_ptt, abs_ppfid, filter_idx,
    &filter_details);
    }
    ...
    struct qed_hwfn *p_hwfn = QED_LEADING_HWFN(cdev);
    struct qed_ptt *p_ptt = qed_ptt_acquire(p_hwfn);
    let mut filter: union qed_llh_filter = {};
...
#[no_mangle]
pub unsafe extern "C" fn qed_init_dp(cdev: *mut qed_dev, dp_module: u32, dp_level: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn qed_init_struct(cdev: *mut qed_dev) {
...
#[no_mangle]
unsafe extern "C" fn qed_qm_info_free(p_hwfn: *mut qed_hwfn) {
    static void qed_qm_info_free(struct qed_hwfn *p_hwfn)
    {
    struct qed_qm_info *qm_info = &p_hwfn.qm_info;
    kfree(qm_info.qm_pq_params);
    qm_info.qm_pq_params = core::ptr::null_mut();
    kfree(qm_info.qm_vport_params);
    qm_info.qm_vport_params = core::ptr::null_mut();
    kfree(qm_info.qm_port_params);
    qm_info.qm_port_params = core::ptr::null_mut();
    kfree(qm_info.wfq_data);
    qm_info.wfq_data = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn qed_dbg_user_data_free(p_hwfn: *mut qed_hwfn) {
    static void qed_dbg_user_data_free(struct qed_hwfn *p_hwfn)
    {
    kfree(p_hwfn.dbg_user_info);
    p_hwfn.dbg_user_info = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn qed_resc_free(cdev: *mut qed_dev) {
    ...
    kfree(cdev.fw_data);
    cdev.fw_data = core::ptr::null_mut();
    kfree(cdev.reset_stats);
    cdev.reset_stats = core::ptr::null_mut();
    qed_llh_free(cdev);
    for_each_hwfn(cdev, i) {
    p_hwfn = cdev.hwfns + i;
...
// QM initialization
pub const ACTIVE_TCS_BMAP: c_uint = 0x9f;
pub const ACTIVE_TCS_BMAP_4PORT_K2: c_uint = 0xf;
// determines the physical queue flags for a given PF.
#[no_mangle]
unsafe extern "C" fn qed_get_pq_flags(p_hwfn: *mut qed_hwfn) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_get_num_tcs(p_hwfn: *mut qed_hwfn) -> u8 {
    static u8 qed_init_qm_get_num_tcs(struct qed_hwfn *p_hwfn)
    {
    return p_hwfn.hw_info.num_hw_tc;
    }
#[no_mangle]
unsafe extern "C" fn qed_init_qm_get_num_vfs(p_hwfn: *mut qed_hwfn) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_get_num_mtc_tcs(p_hwfn: *mut qed_hwfn) -> u8 {
    static u8 qed_init_qm_get_num_mtc_tcs(struct qed_hwfn *p_hwfn)
    {
    let mut pq_flags: u32 = qed_get_pq_flags(p_hwfn);
    if (!(PQ_FLAGS_MTC & pq_flags))
    return 1;
    return qed_init_qm_get_num_tcs(p_hwfn);
    }
pub const NUM_DEFAULT_RLS: c_int = 1;
#[no_mangle]
unsafe extern "C" fn qed_init_qm_get_num_pf_rls(p_hwfn: *mut qed_hwfn) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_get_num_vports(p_hwfn: *mut qed_hwfn) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_get_num_pqs(p_hwfn: *mut qed_hwfn) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_params(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_vport_params(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_port_params(p_hwfn: *mut qed_hwfn) {
...
//
#[no_mangle]
unsafe extern "C" fn qed_init_qm_reset_params(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_advance_vport(p_hwfn: *mut qed_hwfn) {
...
// defines for pq init
pub const PQ_INIT_DEFAULT_WRR_GROUP: c_int = 1;
pub const PQ_INIT_DEFAULT_TC: c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn qed_hw_info_set_offload_tc(p_info: *mut qed_hw_info, tc: u8) {
...
#[no_mangle]
unsafe extern "C" fn qed_is_offload_tc_set(p_hwfn: *mut qed_hwfn) -> bool {
    static bool qed_is_offload_tc_set(struct qed_hwfn *p_hwfn)
    {
    return p_hwfn.hw_info.offload_tc_set;
    }
#[no_mangle]
unsafe extern "C" fn qed_get_offload_tc(p_hwfn: *mut qed_hwfn) -> u32 {
    ...
    {
    let mut pq_idx: u16 = qm_info.num_pqs, max_pq = qed_init_qm_get_num_pqs(p_hwfn);
    if (pq_idx > max_pq)
    DP_ERR(p_hwfn,
...
#[no_mangle]
pub unsafe extern "C" fn qed_get_cm_pq_idx(p_hwfn: *mut qed_hwfn, pq_flags: u32) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn qed_get_cm_pq_idx_mcos(p_hwfn: *mut qed_hwfn, tc: u8) -> u16 {
    u16 qed_get_cm_pq_idx_mcos(struct qed_hwfn *p_hwfn, u8 tc)
    {
    let mut max_tc: u8 = qed_init_qm_get_num_tcs(p_hwfn);
    if (max_tc == 0) {
...
#[no_mangle]
pub unsafe extern "C" fn qed_get_cm_pq_idx_vf(p_hwfn: *mut qed_hwfn, vf: u16) -> u16 {
    u16 qed_get_cm_pq_idx_vf(struct qed_hwfn *p_hwfn, u16 vf)
    {
    let mut max_vf: u16 = qed_init_qm_get_num_vfs(p_hwfn);
    if (max_vf == 0) {
    DP_ERR(p_hwfn, "pq with flag 0x%lx do not exist\n",
    PQ_FLAGS_VFS);
    return p_hwfn.qm_info.start_pq;
...
#[no_mangle]
pub unsafe extern "C" fn qed_get_cm_pq_idx_ofld_mtc(p_hwfn: *mut qed_hwfn, tc: u8) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn qed_get_cm_pq_idx_llt_mtc(p_hwfn: *mut qed_hwfn, tc: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_lb_pq(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_ooo_pq(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_pure_ack_pq(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_mtc_pqs(p_hwfn: *mut qed_hwfn) {
    static void qed_init_qm_mtc_pqs(struct qed_hwfn *p_hwfn)
    {
    let mut num_tcs: u8 = qed_init_qm_get_num_mtc_tcs(p_hwfn);
    struct qed_qm_info *qm_info = &p_hwfn.qm_info;
    u8 tc;
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_offload_pq(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_low_latency_pq(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_mcos_pqs(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_vf_pqs(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_rl_pqs(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_pq_params(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_sanity(p_hwfn: *mut qed_hwfn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_dp_init_qm_params(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_init_qm_info(p_hwfn: *mut qed_hwfn) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qed_qm_reconf(p_hwfn: *mut qed_hwfn, p_ptt: *mut qed_ptt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_alloc_qm_data(p_hwfn: *mut qed_hwfn) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_resc_alloc(cdev: *mut qed_dev) -> c_int {
...
// EQ
    ...
    let mut n_srq: u32 = qed_cxt_get_total_srq_count(p_hwfn);
...
#[no_mangle]
pub unsafe extern "C" fn qed_resc_setup(cdev: *mut qed_dev) {
...
// Read shadow of current MFW mailbox
    ...
    {
    let mut command: u32 = 0, addr, count = FINAL_CLEANUP_POLL_CNT;
...
#[no_mangle]
unsafe extern "C" fn qed_calc_hw_mode(p_hwfn: *mut qed_hwfn) -> c_int {
    static int qed_calc_hw_mode(struct qed_hwfn *p_hwfn)
    {
    let mut hw_mode: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn qed_init_cau_rt_data(cdev: *mut qed_dev) {
    static void qed_init_cau_rt_data(struct qed_dev *cdev)
    {
    let mut offset: u32 = CAU_REG_SB_VAR_MEMORY_RT_OFFSET;
    int i, igu_sb_id;
    for_each_hwfn(cdev, i) {
    struct qed_hwfn *p_hwfn = &cdev.hwfns[i];
...
#[no_mangle]
pub unsafe extern "C" fn qed_edpm_enabled(p_hwfn: *mut qed_hwfn) -> bool {
...
// In CMT the gate should be cleared by the 2nd hwfn
    ...
    {
    let mut rel_pf_id: u8 = p_hwfn.rel_pf_id;
    let mut rc: c_int = 0;
    if (p_hwfn.mcp_info) {
...
// send function start command
    ...
    {
    let mut delay_idx: u32 = 0, val, set_val = b_enable ? 1 : 0;
...
#[no_mangle]
unsafe extern "C" fn qed_pglueb_clear_err(p_hwfn: *mut qed_hwfn, p_ptt: *mut qed_ptt) {
...
#[no_mangle]
pub unsafe extern "C" fn qed_hw_init(cdev: *mut qed_dev, p_params: *mut qed_hw_init_params) -> c_int {
    int qed_hw_init(struct qed_dev *cdev, struct qed_hw_init_params *p_params)
    {
    struct qed_load_req_params load_req_params;
    u32 load_code, resp, param, drv_mb_param;
    let mut b_default_mtu: bool = true;
    struct qed_hwfn *p_hwfn;
...
#[no_mangle]
pub unsafe extern "C" fn qed_hw_timers_stop_all(cdev: *mut qed_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn qed_hw_stop(cdev: *mut qed_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_hw_stop_fastpath(cdev: *mut qed_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_hw_start_fastpath(p_hwfn: *mut qed_hwfn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_hw_hwfn_free(p_hwfn: *mut qed_hwfn) {
    static void qed_hw_hwfn_free(struct qed_hwfn *p_hwfn)
    {
    qed_ptt_pool_free(p_hwfn);
    kfree(p_hwfn.hw_info.p_igu_info);
    p_hwfn.hw_info.p_igu_info = core::ptr::null_mut();
    }
// Setup bar access
#[no_mangle]
unsafe extern "C" fn qed_hw_hwfn_prepare(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn get_function_id(p_hwfn: *mut qed_hwfn) {
...
#[no_mangle]
unsafe extern "C" fn qed_hw_set_feat(p_hwfn: *mut qed_hwfn) {
    static void qed_hw_set_feat(struct qed_hwfn *p_hwfn)
    {
    u32 *feat_num = p_hwfn.hw_info.feat_num;
    struct qed_sb_cnt_info sb_cnt;
    let mut non_l2_sbs: u32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn qed_get_hsi_def_val(cdev: *mut qed_dev, type: enum qed_hsi_def_type) -> u32 {
    u32 qed_get_hsi_def_val(struct qed_dev *cdev, enum qed_hsi_def_type type)
    {
    let mut chip_id: enum chip_ids = QED_IS_BB(cdev) ? CHIP_BB : CHIP_K2;
...
//
    ...
    {
    let mut num_funcs: u8 = p_hwfn.num_funcs_on_engine;
    struct qed_dev *cdev = p_hwfn.cdev;
    switch (res_id) {
    case QED_L2_QUEUE:
...
// p_resc_start = 0;
#[no_mangle]
pub unsafe extern "C" fn if(4: p_hwfn->cdev->num_ports_in_engine ==) -> else {
...
// p_resc_start = p_hwfn->port_id;
#[no_mangle]
pub unsafe extern "C" fn if(QED_PCI_FCOE: p_hwfn->hw_info.personality ==) -> else {
...
// p_resc_start = *p_resc_num * p_hwfn->enabled_func_idx;
    ...
    enum qed_resources res_id)
    {
    let mut dflt_resc_num: u32 = 0, dflt_resc_start = 0;
...
#[no_mangle]
unsafe extern "C" fn qed_hw_set_resc_info(p_hwfn: *mut qed_hwfn) -> c_int {
...
// Calculation of BB/AH is different for native_ppfid_idx
    ...
    return rc;
#[no_mangle]
pub unsafe extern "C" fn if(-EOPNOTSUPP: rc ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn qed_hw_get_resc(p_hwfn: *mut qed_hwfn, p_ptt: *mut qed_ptt) -> c_int {
    static int qed_hw_get_resc(struct qed_hwfn *p_hwfn, struct qed_ptt *p_ptt)
    {
    struct qed_resc_unlock_params resc_unlock_params;
    struct qed_resc_lock_params resc_lock_params;
    let mut b_ah: bool = QED_IS_AH(p_hwfn.cdev);
    u8 res_id;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn qed_hw_get_nvm_info(p_hwfn: *mut qed_hwfn, p_ptt: *mut qed_ptt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_get_num_funcs(p_hwfn: *mut qed_hwfn, p_ptt: *mut qed_ptt) {
...
#[no_mangle]
unsafe extern "C" fn qed_hw_info_port_num(p_hwfn: *mut qed_hwfn, p_ptt: *mut qed_ptt) {
...
#[no_mangle]
unsafe extern "C" fn qed_get_eee_caps(p_hwfn: *mut qed_hwfn, p_ptt: *mut qed_ptt) {
...
#[no_mangle]
unsafe extern "C" fn qed_get_dev_info(p_hwfn: *mut qed_hwfn, p_ptt: *mut qed_ptt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_hw_remove(cdev: *mut qed_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn qed_fw_l2_queue(p_hwfn: *mut qed_hwfn, src_id: u16, dst_id: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_fw_vport(p_hwfn: *mut qed_hwfn, src_id: u8, dst_id: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_fw_rss_eng(p_hwfn: *mut qed_hwfn, src_id: u8, dst_id: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_set_queue_coalesce(rx_coal: u16, tx_coal: u16, p_handle: *mut c_void) -> c_int {
...
//
    ...
    let mut wfq_speed: u32 = p_hwfn.qm_info.wfq_data[i].min_speed;
...
//
    ...
    {
    let mut total_req_min_rate: u32 = 0, total_left_rate = 0, left_rate_per_vp = 0;
    let mut non_requested_count: c_int = 0, req_count = 0, i, num_vports;
...
//
#[no_mangle]
pub unsafe extern "C" fn qed_configure_vport_wfq(cdev: *mut qed_dev, vp_id: u16, rate: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_configure_pf_max_bandwidth(cdev: *mut qed_dev, max_bw: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_configure_pf_min_bandwidth(cdev: *mut qed_dev, min_bw: u8) -> c_int {
    ...
    if (p_link.min_pf_rate) {
    let mut min_rate: u32 = p_link.min_pf_rate;
...
#[no_mangle]
pub unsafe extern "C" fn qed_clean_wfq_db(p_hwfn: *mut qed_hwfn, p_ptt: *mut qed_ptt) {
...
#[no_mangle]
pub unsafe extern "C" fn qed_device_num_ports(cdev: *mut qed_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_llh_shadow_remove_all_filters(cdev: *mut qed_dev, ppfid: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qed_llh_clear_ppfid_filters(cdev: *mut qed_dev, ppfid: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn qed_llh_add_src_tcp_port_filter(cdev: *mut qed_dev, src_port: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_llh_remove_src_tcp_port_filter(cdev: *mut qed_dev, src_port: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn qed_llh_add_dst_tcp_port_filter(cdev: *mut qed_dev, dest_port: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_llh_remove_dst_tcp_port_filter(cdev: *mut qed_dev, dest_port: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn qed_llh_clear_all_filters(cdev: *mut qed_dev) {
