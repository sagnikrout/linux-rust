...
//! Source: drivers/net/ethernet/qlogic/qed/qed_spq.c
#![no_std]
...
// QM physical queue
    ...
    let mut echo: u16 = qed_chain_get_prod_idx(p_chain);
...
//
    ...
    if (!p_hwfn.p_spq || (protocol_id >= MAX_PROTOCOL_TYPE))
    return;
    p_hwfn.p_spq.async_comp_cb[protocol_id] = core::ptr::null_mut();
    }
//
// EQ API
//
#[no_mangle]
pub unsafe extern "C" fn qed_eq_prod_update(p_hwfn: *mut qed_hwfn, prod: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn qed_eq_completion(p_hwfn: *mut qed_hwfn, cookie: *mut c_void) -> c_int {
...
// take a snapshot of the FW consumer
    let mut fw_cons_idx: u16 = le16_to_cpu(*p_eq.p_fw_cons);
...
#[no_mangle]
pub unsafe extern "C" fn qed_eq_alloc(p_hwfn: *mut qed_hwfn, num_elem: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_eq_setup(p_hwfn: *mut qed_hwfn) {
    void qed_eq_setup(struct qed_hwfn *p_hwfn)
    {
    qed_chain_reset(&p_hwfn.p_eq.chain);
    }
#[no_mangle]
pub unsafe extern "C" fn qed_eq_free(p_hwfn: *mut qed_hwfn) {
...
//
    return qed_spq_completion(p_hwfn, cqe.echo, 0, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn qed_spq_setup(p_hwfn: *mut qed_hwfn) {
    void qed_spq_setup(struct qed_hwfn *p_hwfn)
    {
    struct qed_spq *p_spq = p_hwfn.p_spq;
    struct qed_spq_entry *p_virt = core::ptr::null_mut();
    struct core_db_data *p_db_data;
    void __iomem *db_addr;
    let mut p_phys: dma_addr_t = 0;
    u32 i, capacity;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn qed_spq_alloc(p_hwfn: *mut qed_hwfn) -> c_int {
    ...
    struct qed_spq_entry *p_virt = core::ptr::null_mut();
    struct qed_spq *p_spq = core::ptr::null_mut();
    let mut p_phys: dma_addr_t = 0;
    u32 capacity;
    int ret;
// SPQ struct
...
#[no_mangle]
pub unsafe extern "C" fn qed_spq_free(p_hwfn: *mut qed_hwfn) {
...
// Delete the SPQ doorbell from the doorbell recovery mechanism
    ...
    kfree(p_spq);
    p_hwfn.p_spq = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn qed_spq_get_entry(p_hwfn: *mut qed_hwfn, pp_ent: *mut qed_spq_entry) -> c_int {
    int qed_spq_get_entry(struct qed_hwfn *p_hwfn, struct qed_spq_entry **pp_ent)
    {
    struct qed_spq *p_spq = p_hwfn.p_spq;
    struct qed_spq_entry *p_ent = core::ptr::null_mut();
    let mut rc: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn qed_spq_return_entry(p_hwfn: *mut qed_hwfn, p_ent: *mut qed_spq_entry) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qed_spq_get_cid(p_hwfn: *mut qed_hwfn) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn qed_spq_pend_post(p_hwfn: *mut qed_hwfn) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qed_spq_comp_bmap_update(p_hwfn: *mut qed_hwfn, echo: __le16) {
    static void qed_spq_comp_bmap_update(struct qed_hwfn *p_hwfn, __le16 echo)
    {
    let mut pos: u16 = le16_to_cpu(echo) % SPQ_RING_SIZE;
    struct qed_spq *p_spq = p_hwfn.p_spq;
    ...
    {
    let mut rc: c_int = 0;
    struct qed_spq *p_spq = p_hwfn ? p_hwfn.p_spq : core::ptr::null_mut();
    let mut b_ret_ent: bool = true;
    bool eblock;
    if (!p_hwfn)
    return -EINVAL;
    if (!p_ent) {
    DP_NOTICE(p_hwfn, "Got a core::ptr::null_mut() pointer\n");
    return -EINVAL;
    }
...
// return to the free pool
    ...
    struct qed_spq_entry	*found = core::ptr::null_mut();
    if (!p_hwfn)
    return -EINVAL;
    p_spq = p_hwfn.p_spq;
    if (!p_spq)
...
pub const QED_SPQ_CONSQ_ELEM_SIZE: c_uint = 0x80;
#[no_mangle]
pub unsafe extern "C" fn qed_consq_alloc(p_hwfn: *mut qed_hwfn) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_consq_setup(p_hwfn: *mut qed_hwfn) {
    void qed_consq_setup(struct qed_hwfn *p_hwfn)
    {
    qed_chain_reset(&p_hwfn.p_consq.chain);
    }
#[no_mangle]
pub unsafe extern "C" fn qed_consq_free(p_hwfn: *mut qed_hwfn) {
    ...
    p_hwfn.p_consq = core::ptr::null_mut();
    }
