...
//! Source: drivers/net/ethernet/qlogic/qed/qed_sp_commands.c
#![no_std]
...
//
    ...
    {
    let mut opaque_cid: u32 = p_data.opaque_fid << 16 | p_data.cid;
    ...
    if (!p_data.p_comp_data)
    p_ent.comp_cb.function = core::ptr::null_mut();
    else
...
#[no_mangle]
unsafe extern "C" fn qed_tunn_clss_to_fw_clss(type: u8) -> enum tunnel_clss {
...
// p_port = cpu_to_le16(p_udp_port->port);
    ...
    struct pf_start_ramrod_data *p_ramrod = core::ptr::null_mut();
    let mut sb: u16 = qed_int_get_sp_sb_id(p_hwfn);
    let mut sb_index: u8 = p_hwfn.p_eq.eq_sb_index;
    struct qed_spq_entry *p_ent = core::ptr::null_mut();
...
// Place consolidation queue address in ramrod
    ...
    rc = qed_spq_post(p_hwfn, p_ent, core::ptr::null_mut());
    if (p_tunn)
...
#[no_mangle]
pub unsafe extern "C" fn qed_sp_pf_update(p_hwfn: *mut qed_hwfn) -> c_int {
...
// Get SPQ entry
    ...
    return qed_spq_post(p_hwfn, p_ent, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn qed_sp_pf_update_ufp(p_hwfn: *mut qed_hwfn) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_sp_pf_stop(p_hwfn: *mut qed_hwfn) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_sp_heartbeat_ramrod(p_hwfn: *mut qed_hwfn) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qed_sp_pf_update_stag(p_hwfn: *mut qed_hwfn) -> c_int {
