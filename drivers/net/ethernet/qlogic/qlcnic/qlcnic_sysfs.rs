...
//! Source: drivers/net/ethernet/qlogic/qlcnic/qlcnic_sysfs.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn qlcnicvf_config_bridged_mode(adapter: *mut qlcnic_adapter, enable: u32) -> c_int {
    int qlcnicvf_config_bridged_mode(struct qlcnic_adapter *adapter, u32 enable)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
pub unsafe extern "C" fn qlcnicvf_config_led(adapter: *mut qlcnic_adapter, state: u32, rate: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_is_valid_nic_func(adapter: *mut qlcnic_adapter, pci_func: u8) -> c_int {
    ...
    {
    struct qlcnic_adapter *adapter = dev_get_drvdata(dev);
    let mut temperature: c_uint = 0, value = 0;
    if (qlcnic_83xx_check(adapter))
    value = QLCRDX(adapter.ahw, QLC_83XX_ASIC_TEMP);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: qlcnic_82xx_check(adapter)) -> else {
...
// hwmon-sysfs attributes
    ...
    qlcnic_hwmon_show_temp, core::ptr::null_mut(), 1);
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_register_hwmon_dev(adapter: *mut qlcnic_adapter) {
...
// Skip hwmon registration for a VF device
    ...
    adapter.ahw.hwmon_dev = core::ptr::null_mut();
    return;
    }
    ...
    PTR_ERR(hwmon_dev));
    hwmon_dev = core::ptr::null_mut();
    }
    adapter.ahw.hwmon_dev = hwmon_dev;
    }
#[no_mangle]
pub unsafe extern "C" fn qlcnic_unregister_hwmon_dev(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_create_sysfs_entries(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_remove_sysfs_entries(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_create_diag_entries(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_remove_diag_entries(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_82xx_add_sysfs(adapter: *mut qlcnic_adapter) {
    void qlcnic_82xx_add_sysfs(struct qlcnic_adapter *adapter)
    {
    qlcnic_create_diag_entries(adapter);
    }
#[no_mangle]
pub unsafe extern "C" fn qlcnic_82xx_remove_sysfs(adapter: *mut qlcnic_adapter) {
    void qlcnic_82xx_remove_sysfs(struct qlcnic_adapter *adapter)
    {
    qlcnic_remove_diag_entries(adapter);
    }
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_add_sysfs(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_remove_sysfs(adapter: *mut qlcnic_adapter) {
