...
//! Source: drivers/net/ethernet/qlogic/qlcnic/qlcnic_sriov_common.c
#![no_std]
...
pub const QLC_BC_COMMAND: c_int = 0;
pub const QLC_BC_RESPONSE: c_int = 1;

pub const QLC_BC_MSG: c_int = 0;
pub const QLC_BC_CFREE: c_int = 1;
pub const QLC_BC_FLR: c_int = 2;
pub const QLC_BC_HDR_SZ: c_int = 16;

pub const QLC_DEFAULT_RCV_DESCRIPTORS_SRIOV_VF: c_int = 2048;
pub const QLC_DEFAULT_JUMBO_RCV_DESCRIPTORS_SRIOV_VF: c_int = 512;
pub const QLC_83XX_VF_RESET_FAIL_THRESH: c_int = 8;
pub const QLC_BC_CMD_MAX_RETRY_CNT: c_int = 5;
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_bc_msg_check(val: u32) -> bool {
    static inline bool qlcnic_sriov_bc_msg_check(u32 val)
    {
    return (val & (1 << QLC_BC_MSG)) ? true : false;
    }
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_channel_free_check(val: u32) -> bool {
    static inline bool qlcnic_sriov_channel_free_check(u32 val)
    {
    return (val & (1 << QLC_BC_CFREE)) ? true : false;
    }
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_flr_check(val: u32) -> bool {
    static inline bool qlcnic_sriov_flr_check(u32 val)
    {
    return (val & (1 << QLC_BC_FLR)) ? true : false;
    }
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_target_func_id(val: u32) -> u8 {
    static inline u8 qlcnic_sriov_target_func_id(u32 val)
    {
    return (val >> 4) & 0xff;
    }
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_virtid_fn(adapter: *mut qlcnic_adapter, vf_id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_init(adapter: *mut qlcnic_adapter, num_vfs: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_cleanup_list(t_list: *mut qlcnic_trans_list) {
...
#[no_mangle]
pub unsafe extern "C" fn __qlcnic_sriov_cleanup(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_cleanup(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_cleanup(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_cfg_buff_desc(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_get_vf_acl(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_init_driver(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_setup_vf(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_check_dev_ready(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_vf_init(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_vf_set_ops(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_vf_register_map(ahw: *mut qlcnic_hardware_context) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_get_bc_paysize(real_pay_size: u32, curr_frag: u8) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_func_to_index(adapter: *mut qlcnic_adapter, pci_func: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_alloc_bc_trans(trans: *mut qlcnic_bc_trans) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_alloc_bc_mbx_args(mbx: *mut qlcnic_cmd_args, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_cleanup_transaction(trans: *mut qlcnic_bc_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_wait_for_resp(trans: *mut qlcnic_bc_trans) {
...
#[no_mangle]
unsafe extern "C" fn __qlcnic_sriov_issue_bc_post(vf: *mut qlcnic_vf_info) -> c_int {
    static int __qlcnic_sriov_issue_bc_post(struct qlcnic_vf_info *vf)
    {
    let mut ret: c_int = -EBUSY;
    let mut timeout: u32 = 10000;
    do {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_issue_bc_post(trans: *mut qlcnic_bc_trans, type: u8) -> c_int {
    ...
    u32 *hdr, *pay;
    int ret;
    let mut pci_func: u8 = trans.func_id;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_process_bc_cmd(work: *mut work_struct) {
    ...
    trans_work);
    struct qlcnic_bc_trans *trans = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_handle_bc_event(adapter: *mut qlcnic_adapter, event: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_cfg_bc_intr(adapter: *mut qlcnic_adapter, enable: u8) -> c_int {
    ...
    struct qlcnic_bc_trans *trans)
    {
    let mut max: u8 = QLC_BC_CMD_MAX_RETRY_CNT;
    u32 state;
    state = QLCRDX(adapter.ahw, QLC_83XX_IDC_DEV_STATE);
    ...
    let mut seq: u16 = ++adapter.ahw.sriov.bc.trans_counter;
    let mut func: u8 = ahw.pci_func;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_channel_cfg_cmd(adapter: *mut qlcnic_adapter, cmd_op: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_cleanup_async_list(bc: *mut qlcnic_back_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_vf_set_multi(netdev: *mut net_device) {
    ...
    let mut mode: u32 = VPORT_MISS_MODE_DROP;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_handle_async_issue_cmd(work: *mut work_struct) {
    static void qlcnic_sriov_handle_async_issue_cmd(struct work_struct *work)
    {
    ...
    struct qlcnic_cmd_args *cmd)
    {
    struct qlcnic_async_cmd *entry = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_reinit_driver(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_attach(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_detach(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_handle_dev_ready(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_handle_context_reset(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_idc_ready_state(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ahw->reset_context) -> else {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_idc_failed_state(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_idc_init_reset_state(adapter: *mut qlcnic_adapter) -> c_int {
    static int qlcnic_sriov_vf_idc_init_reset_state(struct qlcnic_adapter *adapter)
    {
    struct qlcnic_mailbox *mbx = adapter.ahw.mailbox;
    struct qlc_83xx_idc *idc = &adapter.ahw.idc;
    let mut func: u8 = adapter.ahw.pci_func;
    if (idc.prev_state == QLC_83XX_IDC_DEV_READY) {
    dev_err(&adapter.pdev.dev,
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_idc_unknown_state(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_periodic_tasks(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_poll_dev_state(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_cancel_fw_work(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_free_mac_list(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_shutdown(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_vf_resume(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_alloc_vlans(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_free_vlans(adapter: *mut qlcnic_adapter) {
    ...
    vf.sriov_vlans = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_check_any_vlan(vf: *mut qlcnic_vf_info) -> bool {
