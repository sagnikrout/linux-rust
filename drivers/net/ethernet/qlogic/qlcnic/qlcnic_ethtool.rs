...
//! Source: drivers/net/ethernet/qlogic/qlcnic/qlcnic_ethtool.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_82xx_statistics(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_statistics(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_dev_statistics_len(adapter: *mut qlcnic_adapter) -> c_int {
...
pub const QLCNIC_MAX_EEPROM_LEN: c_int = 1024;
...
pub const QLCNIC_MGMT_API_VERSION: c_int = 3;
pub const QLCNIC_ETHTOOL_REGS_VER: c_int = 4;
#[no_mangle]
pub unsafe extern "C" fn qlcnic_get_ring_regs_len(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_get_regs_len(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_get_eeprom_len(dev: *mut net_device) -> c_int {
    ...
    u32 speed, reg;
    let mut check_sfp_module: c_int = 0, err = 0;
    let mut pcifn: u16 = ahw.pci_func;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_test_link(dev: *mut net_device) -> u32 {
    ...
    let mut port: c_int = adapter.ahw.physical_port;
    let mut err: c_int = 0;
    __u32 val;
    if (qlcnic_83xx_check(adapter)) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_reg_test(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_eeprom_test(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_irq_test(netdev: *mut net_device) -> c_int {
...
pub const QLCNIC_ILB_PKT_SIZE: c_int = 64;
pub const QLCNIC_NUM_ILB_PKT: c_int = 16;
pub const QLCNIC_ILB_MAX_RCV_LOOP: c_int = 10;
pub const QLCNIC_LB_PKT_POLL_DELAY_MSEC: c_int = 1;
pub const QLCNIC_LB_PKT_POLL_COUNT: c_int = 20;
#[no_mangle]
unsafe extern "C" fn qlcnic_create_loopback_buff(data: *mut c_uchar, mac[]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_check_loopback_buff(data: *mut c_uchar, mac[]: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_do_lb_test(adapter: *mut qlcnic_adapter, mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_loopback_test(netdev: *mut net_device, mode: u8) -> c_int {
    static int qlcnic_loopback_test(struct net_device *netdev, u8 mode)
    {
    struct qlcnic_adapter *adapter = netdev_priv(netdev);
    let mut drv_tx_rings: c_int = adapter.drv_tx_rings;
    let mut drv_sds_rings: c_int = adapter.drv_sds_rings;
    struct qlcnic_host_sds_ring *sds_ring;
    struct qlcnic_hardware_context *ahw = adapter.ahw;
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_update_stats(adapter: *mut qlcnic_adapter) {
...
// Retrieve MAC statistics from firmware
    ...
    struct qlcnic_adapter *adapter = netdev_priv(dev);
    let mut drv_sds_rings: c_int = adapter.drv_sds_rings;
    let mut err: c_int = -EIO, active = 1;
    if (qlcnic_83xx_check(adapter))
...
#[no_mangle]
unsafe extern "C" fn qlcnic_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_set_msglevel(netdev: *mut net_device, msglvl: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_enable_fw_dump_state(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_disable_fw_dump_state(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_check_fw_dump_state(adapter: *mut qlcnic_adapter) -> bool {
...
// Free dump area once data has been captured
    vfree(fw_dump.data);
    fw_dump.data = core::ptr::null_mut();
    fw_dump.clr = 0;
    netdev_info(netdev, "extracted the FW dump Successfully\n");
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn qlcnic_set_dump_mask(adapter: *mut qlcnic_adapter, mask: u32) -> c_int {
