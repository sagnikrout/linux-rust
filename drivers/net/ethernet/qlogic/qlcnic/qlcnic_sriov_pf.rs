...
//! Source: drivers/net/ethernet/qlogic/qlcnic/qlcnic_sriov_pf.c
#![no_std]
...
pub const QLCNIC_SRIOV_VF_MAX_MAC: c_int = 7;
pub const QLC_VF_MIN_TX_RATE: c_int = 100;
pub const QLC_VF_MAX_TX_RATE: c_int = 9999;
pub const QLC_MAC_OPCODE_MASK: c_uint = 0x7;

pub const QLC_FLOOD_MODE: c_uint = 0x5;

pub const QLC_INTR_COAL_TYPE_MASK: c_uint = 0x7;
    static int qlcnic_sriov_pf_get_vport_handle(struct qlcnic_adapter *, u8);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qlcnic_sriov_cmd_handler {
    pub ): *mut *mut *mut int (fn) (struct qlcnic_bc_trans , struct qlcnic_cmd_args,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qlcnic_sriov_fw_cmd_handler {
    pub cmd: u32,
    pub ): *mut *mut *mut int (fn) (struct qlcnic_bc_trans , struct qlcnic_cmd_args,
}
    ...
    let mut num_macs: u16 = sriov.num_allowed_vlans + 1;
    let mut ret: c_int = -EIO, vpid, id;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_pf_cfg_flood(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_pf_del_flr_queue(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_pf_create_flr_queue(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_pf_cleanup(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_pf_disable(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_pci_sriov_disable(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_pf_init(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_pf_enable(adapter: *mut qlcnic_adapter, num_vfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_pci_sriov_enable(adapter: *mut qlcnic_adapter, num_vfs: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_pci_sriov_configure(dev: *mut pci_dev, num_vfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_set_vf_acl(adapter: *mut qlcnic_adapter, func: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_validate_create_rx_ctx(cmd: *mut qlcnic_cmd_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_validate_create_tx_ctx(cmd: *mut qlcnic_cmd_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __qlcnic_sriov_process_flr(vf: *mut qlcnic_vf_info) {
    ...
    vf.flr_trans = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn qlcnic_sriov_pf_process_flr(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_pf_reset(adapter: *mut qlcnic_adapter) {
    void qlcnic_sriov_pf_reset(struct qlcnic_adapter *adapter)
    {
    struct qlcnic_hardware_context *ahw = adapter.ahw;
    struct qlcnic_sriov *sriov = ahw.sriov;
    struct qlcnic_vf_info *vf;
    let mut num_vfs: u16 = sriov.num_vfs;
    int i;
    for (i = 0; i < num_vfs; i++) {
    vf = &sriov.vf_info[i];
    vf.rx_ctx_id = 0;
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_pf_reinit(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_set_vf_mac(netdev: *mut net_device, vf: c_int, mac: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_sriov_set_vf_spoofchk(netdev: *mut net_device, vf: c_int, chk: bool) -> c_int {
