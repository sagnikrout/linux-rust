...
//! Source: drivers/net/ethernet/qlogic/qlcnic/qlcnic_83xx_init.c
#![no_std]
...
pub const QLC_83XX_RESTART_TEMPLATE_SIZE: c_uint = 0x2000;
pub const QLC_83XX_RESET_TEMPLATE_ADDR: c_uint = 0x4F0000;
pub const QLC_83XX_RESET_SEQ_VERSION: c_uint = 0x0101;
pub const QLC_83XX_OPCODE_NOP: c_uint = 0x0000;
pub const QLC_83XX_OPCODE_WRITE_LIST: c_uint = 0x0001;
pub const QLC_83XX_OPCODE_READ_WRITE_LIST: c_uint = 0x0002;
pub const QLC_83XX_OPCODE_POLL_LIST: c_uint = 0x0004;
pub const QLC_83XX_OPCODE_POLL_WRITE_LIST: c_uint = 0x0008;
pub const QLC_83XX_OPCODE_READ_MODIFY_WRITE: c_uint = 0x0010;
pub const QLC_83XX_OPCODE_SEQ_PAUSE: c_uint = 0x0020;
pub const QLC_83XX_OPCODE_SEQ_END: c_uint = 0x0040;
pub const QLC_83XX_OPCODE_TMPL_END: c_uint = 0x0080;
pub const QLC_83XX_OPCODE_POLL_READ_LIST: c_uint = 0x0100;
// EPORT control registers
pub const QLC_83XX_RESET_CONTROL: c_uint = 0x28084E50;
pub const QLC_83XX_RESET_REG: c_uint = 0x28084E60;
pub const QLC_83XX_RESET_PORT0: c_uint = 0x28084E70;
pub const QLC_83XX_RESET_PORT1: c_uint = 0x28084E80;
pub const QLC_83XX_RESET_PORT2: c_uint = 0x28084E90;
pub const QLC_83XX_RESET_PORT3: c_uint = 0x28084EA0;
pub const QLC_83XX_RESET_SRESHIM: c_uint = 0x28084EB0;
pub const QLC_83XX_RESET_EPGSHIM: c_uint = 0x28084EC0;
pub const QLC_83XX_RESET_ETHERPCS: c_uint = 0x28084ED0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qlc_83xx_quad_entry {
    pub dr_addr: u32,
    pub dr_value: u32,
    pub ar_addr: u32,
    pub ar_value: u32,
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_log_state_history(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_update_minor_version(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_check_major_version(adapter: *mut qlcnic_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_check_reset_ack_reg(adapter: *mut qlcnic_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_tx_soft_reset(adapter: *mut qlcnic_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_detach_driver(adapter: *mut qlcnic_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_attach_driver(adapter: *mut qlcnic_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_find_reset_owner_id(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(QLCNIC_TYPE_ISCSI: owner ==) -> else {
    else if (owner == QLCNIC_TYPE_ISCSI)
    owner = QLCNIC_TYPE_FCOE;
#[no_mangle]
pub unsafe extern "C" fn if(QLCNIC_TYPE_FCOE: owner ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_restart_hw(adapter: *mut qlcnic_adapter, lock: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_check_fan_failure(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_idc_reattach_driver(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_update_idc_params(adapter: *mut qlcnic_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_idc_ready_state_entry(adapter: *mut qlcnic_adapter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_idc_vnic_pf_entry(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_unknown_state(adapter: *mut qlcnic_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_cold_state_handler(adapter: *mut qlcnic_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_init_state(adapter: *mut qlcnic_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_ready_state(adapter: *mut qlcnic_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_need_reset_state(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_need_quiesce_state(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_failed_state(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_idc_quiesce_state(adapter: *mut qlcnic_adapter) -> c_int {
...
pub const QLCNIC_ENABLE_INGRESS_ENCAP_PARSING: c_int = 1;
pub const QLCNIC_DISABLE_INGRESS_ENCAP_PARSING: c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn qlcnic_set_vxlan_port(adapter: *mut qlcnic_adapter, port: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_set_vxlan_parsing(adapter: *mut qlcnic_adapter, port: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_periodic_tasks(adapter: *mut qlcnic_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_idc_poll_dev_state(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_setup_idc_parameters(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_idc_init(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_idc_exit(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_idc_request_reset(adapter: *mut qlcnic_adapter, key: u32) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_copy_bootloader(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_copy_fw_file(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_dump_pause_control_regs(adapter: *mut qlcnic_adapter) {
    static void qlcnic_83xx_dump_pause_control_regs(struct qlcnic_adapter *adapter)
    {
    int i, j;
    let mut val: u32 = 0, val1 = 0, reg = 0;
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_disable_pause_frames(adapter: *mut qlcnic_adapter) {
    static void qlcnic_83xx_disable_pause_frames(struct qlcnic_adapter *adapter)
    {
    let mut reg: u32 = 0, i, j;
    if (qlcnic_83xx_lock_driver(adapter)) {
    dev_err(&adapter.pdev.dev,
    ...
    reg = QLC_83XX_PORT0_THRESHOLD;
#[no_mangle]
pub unsafe extern "C" fn if(1: j ==) -> else {
    else if (j == 1)
    reg = QLC_83XX_PORT1_THRESHOLD;
    for (i = 0; i < 8; i++)
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_take_eport_out_of_reset(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_check_heartbeat(p_dev: *mut qlcnic_adapter) -> c_int {
    static int qlcnic_83xx_check_heartbeat(struct qlcnic_adapter *p_dev)
    {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_check_cmd_peg_status(p_dev: *mut qlcnic_adapter) -> c_int {
    static int qlcnic_83xx_check_cmd_peg_status(struct qlcnic_adapter *p_dev)
    {
    let mut retries: c_int = QLCNIC_CMDPEG_CHECK_RETRY_COUNT;
    u32 val;
    do {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_check_hw_status(p_dev: *mut qlcnic_adapter) -> c_int {
    static int qlcnic_83xx_check_hw_status(struct qlcnic_adapter *p_dev)
    {
    int err;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_reset_template_checksum(p_dev: *mut qlcnic_adapter) -> c_int {
    static int qlcnic_83xx_reset_template_checksum(struct qlcnic_adapter *p_dev)
    {
    let mut sum: u32 = 0;
    u16 *buff = (u16 *)p_dev.ahw.reset.buff;
    let mut count: c_int = p_dev.ahw.reset.hdr.size / sizeof(u16);
    while (count-- > 0)
    sum += *buff++;
    while (sum >> 16)
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_get_reset_instruction_template(p_dev: *mut qlcnic_adapter) -> c_int {
    ...
    u8 *p_buff;
    if (ahw.reset.buff != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_pause(p_hdr: *mut qlc_83xx_entry_hdr) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_seq_end(p_dev: *mut qlcnic_adapter) {
    static inline void qlcnic_83xx_seq_end(struct qlcnic_adapter *p_dev)
    {
    p_dev.ahw.reset.seq_end = 1;
    }
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_template_end(p_dev: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_stop_hw(p_dev: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_start_hw(p_dev: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_init_hw(p_dev: *mut qlcnic_adapter) {
...
pub const QLC_83XX_POST_SIGNATURE_REG: c_uint = 0x41602014;
pub const QLC_83XX_POST_MODE_REG: c_uint = 0x41602018;
pub const QLC_83XX_POST_FAST_MODE: c_int = 0;
pub const QLC_83XX_POST_MEDIUM_MODE: c_int = 1;
pub const QLC_83XX_POST_SLOW_MODE: c_int = 2;
// POST Timeout values in milliseconds
pub const QLC_83XX_POST_FAST_MODE_TIMEOUT: c_int = 690;
pub const QLC_83XX_POST_MED_MODE_TIMEOUT: c_int = 2930;
pub const QLC_83XX_POST_SLOW_MODE_TIMEOUT: c_int = 7500;
// POST result values
pub const QLC_83XX_POST_PASS: c_uint = 0xfffffff0;
pub const QLC_83XX_POST_ASIC_STRESS_TEST_FAIL: c_uint = 0xffffffff;
pub const QLC_83XX_POST_DDR_TEST_FAIL: c_uint = 0xfffffffe;
pub const QLC_83XX_POST_ASIC_MEMORY_TEST_FAIL: c_uint = 0xfffffffc;
pub const QLC_83XX_POST_FLASH_TEST_FAIL: c_uint = 0xfffffff8;
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_run_post(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_load_fw_image_from_host(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_restart_hw(adapter: *mut qlcnic_adapter) -> c_int {
    static int qlcnic_83xx_restart_hw(struct qlcnic_adapter *adapter)
    {
    u32 val;
    let mut err: c_int = -EIO;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_get_nic_configuration(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_configure_opmode(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_config_buff_descriptors(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_init_default_driver(adapter: *mut qlcnic_adapter) -> c_int {
    static int qlcnic_83xx_init_default_driver(struct qlcnic_adapter *adapter)
    {
    let mut err: c_int = -EIO;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_clear_function_resources(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_get_fw_info(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_init_rings(adapter: *mut qlcnic_adapter) {
    static void qlcnic_83xx_init_rings(struct qlcnic_adapter *adapter)
    {
    let mut rx_cnt: u8 = QLCNIC_DEF_SDS_RINGS;
    let mut tx_cnt: u8 = QLCNIC_DEF_TX_RINGS;
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_init(adapter: *mut qlcnic_adapter) -> c_int {
...
// Periodically monitor device status
    ...
    ahw.mailbox = core::ptr::null_mut();
    exit:
    return err;
    }
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_aer_stop_poll_work(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_aer_reset(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_aer_start_poll_work(adapter: *mut qlcnic_adapter) {
