...
//! Source: drivers/net/ethernet/qlogic/qlcnic/qlcnic_main.c
#![no_std]
...
//
    ...
    let mut qlcnic_use_msi: c_int = 1;
    MODULE_PARM_DESC(use_msi, "MSI interrupt (0=disabled, 1=enabled)");
    module_param_named(use_msi, qlcnic_use_msi, int, 0444);
    let mut qlcnic_use_msi_x: c_int = 1;
    MODULE_PARM_DESC(use_msi_x, "MSI-X interrupt (0=disabled, 1=enabled)");
    module_param_named(use_msi_x, qlcnic_use_msi_x, int, 0444);
    let mut qlcnic_auto_fw_reset: c_int = 1;
    ...
    pci_channel_state_t);
#[no_mangle]
unsafe extern "C" fn qlcnic_vlan_tx_check(adapter: *mut qlcnic_adapter) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_update_cmd_producer(tx_ring: *mut qlcnic_host_tx_ring) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_alloc_sds_rings(recv_ctx: *mut qlcnic_recv_context, count: c_int) -> c_int {
    int qlcnic_alloc_sds_rings(struct qlcnic_recv_context *recv_ctx, int count)
    {
    let mut size: c_int = sizeof(struct qlcnic_host_sds_ring) * count;
    recv_ctx.sds_rings = kzalloc(size, GFP_KERNEL);
    return recv_ctx.sds_rings == core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn qlcnic_free_sds_rings(recv_ctx: *mut qlcnic_recv_context) {
    void qlcnic_free_sds_rings(struct qlcnic_recv_context *recv_ctx)
    {
    kfree(recv_ctx.sds_rings);
    recv_ctx.sds_rings = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn qlcnic_read_mac_addr(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_delete_adapter_mac(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_set_mac(netdev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_82xx_cancel_idc_work(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_udp_tunnel_sync(dev: *mut net_device, table: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_check_multi_tx_capability(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(QLCNIC_TX_QUEUE: queue_type ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_set_tx_ring_count(adapter: *mut qlcnic_adapter, tx_cnt: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_set_sds_ring_count(adapter: *mut qlcnic_adapter, rx_cnt: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_setup_tss_rss_intr(adapter: *mut qlcnic_adapter) -> c_int {
    int qlcnic_setup_tss_rss_intr(struct qlcnic_adapter *adapter)
    {
    struct pci_dev *pdev = adapter.pdev;
    let mut num_msix: c_int = 0, err = 0, vector;
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_enable_msix(adapter: *mut qlcnic_adapter, num_msix: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_82xx_calculate_msix_vector(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_enable_msi_legacy(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_82xx_setup_intr(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_82xx_mq_intrpt(adapter: *mut qlcnic_adapter, op_type: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_teardown_intr(adapter: *mut qlcnic_adapter) {
    ...
    adapter.ahw.intr_tbl = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn qlcnic_cleanup_pci_map(ahw: *mut qlcnic_hardware_context) {
    static void qlcnic_cleanup_pci_map(struct qlcnic_hardware_context *ahw)
    {
    if (ahw.pci_base0 != core::ptr::null_mut())
    iounmap(ahw.pci_base0);
    }
#[no_mangle]
unsafe extern "C" fn qlcnic_get_act_pci_func(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_port_eswitch_cfg_capability(adapter: *mut qlcnic_adapter) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_init_pci_info(adapter: *mut qlcnic_adapter) -> c_int {
...
//
    ...
    adapter.eswitch = core::ptr::null_mut();
    err_npars:
    kfree(adapter.npars);
    adapter.npars = core::ptr::null_mut();
    err_pci_info:
    kfree(pci_info);
    return ret;
    }
    ...
    u8 id;
    int ret;
    let mut data: u32 = QLCNIC_MGMT_FUNC;
    struct qlcnic_hardware_context *ahw = adapter.ahw;
...
pub const QLCNIC_82XX_BAR0_LENGTH: c_uint = 0x00200000UL;
pub const QLCNIC_83XX_BAR0_LENGTH: c_uint = 0x4000;
#[no_mangle]
unsafe extern "C" fn qlcnic_get_bar_length(dev_id: u32, bar: *mut c_ulong) {
...
// bar = 0;
    ...
    {
    u32 offset;
    void __iomem *mem_ptr0 = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qlcnic_get_board_name(adapter: *mut qlcnic_adapter, name: *mut c_char) {
    ...
    if (fw_dump.tmpl_hdr == core::ptr::null_mut() ||
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_set_eswitch_port_config(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_set_default_offload_settings(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_reset_npar_config(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_check_npar_opertional(adapter: *mut qlcnic_adapter) -> c_int {
    static int qlcnic_check_npar_opertional(struct qlcnic_adapter *adapter)
    {
    let mut npar_opt_timeo: u8 = QLCNIC_DEV_NPAR_OPER_TIMEO;
    u32 npar_state;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_82xx_start_firmware(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(QLCNIC_MSI_ENABLED: adapter->flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_get_lro_mss_capability(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_config_def_intr_coalesce(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __qlcnic_up(adapter: *mut qlcnic_adapter, netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_up(adapter: *mut qlcnic_adapter, netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __qlcnic_down(adapter: *mut qlcnic_adapter, netdev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_down(adapter: *mut qlcnic_adapter, netdev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_detach(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_diag_free_res(netdev: *mut net_device, drv_sds_rings: c_int) {
    void qlcnic_diag_free_res(struct net_device *netdev, int drv_sds_rings)
    {
    struct qlcnic_adapter *adapter = netdev_priv(netdev);
    struct qlcnic_host_sds_ring *sds_ring;
    let mut drv_tx_rings: c_int = adapter.drv_tx_rings;
    int ring;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_alloc_adapter_resources(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_free_adapter_resources(adapter: *mut qlcnic_adapter) {
    static void qlcnic_free_adapter_resources(struct qlcnic_adapter *adapter)
    {
    struct qlcnic_fw_dump *fw_dump = &adapter.ahw.fw_dump;
    kfree(adapter.recv_ctx);
    adapter.recv_ctx = core::ptr::null_mut();
    if (fw_dump.tmpl_hdr) {
    vfree(fw_dump.tmpl_hdr);
    fw_dump.tmpl_hdr = core::ptr::null_mut();
    }
    if (fw_dump.dma_buffer) {
    dma_free_coherent(&adapter.pdev.dev, QLC_PEX_DMA_READ_SIZE,
    fw_dump.dma_buffer, fw_dump.phys_addr);
    fw_dump.dma_buffer = core::ptr::null_mut();
    }
    kfree(adapter.ahw.reset.buff);
    adapter.ahw.fw_dump.tmpl_hdr = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn qlcnic_diag_alloc_res(netdev: *mut net_device, test: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_82xx_set_mac_filter_count(adapter: *mut qlcnic_adapter) {
    static void qlcnic_82xx_set_mac_filter_count(struct qlcnic_adapter *adapter)
    {
    struct qlcnic_hardware_context *ahw = adapter.ahw;
    let mut act_pci_fn: u16 = ahw.total_nic_func;
    u16 count;
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_free_tx_rings(adapter: *mut qlcnic_adapter) {
    ...
    tx_ring.cmd_buf_arr = core::ptr::null_mut();
    }
    }
    ...
    if (cmd_buf_arr == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_set_drv_version(adapter: *mut qlcnic_adapter) {
    void qlcnic_set_drv_version(struct qlcnic_adapter *adapter)
    {
    struct qlcnic_hardware_context *ahw = adapter.ahw;
    let mut fw_cmd: u32 = 0;
    if (qlcnic_82xx_check(adapter))
    fw_cmd = QLCNIC_CMD_82XX_SET_DRV_VER;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: qlcnic_83xx_check(adapter)) -> else {
    else if (qlcnic_83xx_check(adapter))
...
#[no_mangle]
unsafe extern "C" fn qlcnic_reset_api_lock(adapter: *mut qlcnic_adapter) {
    ...
    struct qlcnic_adapter *adapter = core::ptr::null_mut();
    struct qlcnic_hardware_context *ahw;
    ...
    if (adapter.qlcnic_wq == core::ptr::null_mut()) {
    err = -ENOMEM;
...
#[no_mangle]
pub unsafe extern "C" fn if(DRV_MAC_LEARN: qlcnic_mac_learn ==) -> else {
...
// compute and set default and max tx/sds rings
    ...
    if (qlcnic_83xx_check(adapter))
    adapter.tgt_status_reg = core::ptr::null_mut();
    else
...
#[no_mangle]
unsafe extern "C" fn qlcnic_remove(pdev: *mut pci_dev) {
    static void qlcnic_remove(struct pci_dev *pdev)
    {
    ...
    destroy_workqueue(adapter.qlcnic_wq);
    adapter.qlcnic_wq = core::ptr::null_mut();
    }
    qlcnic_free_adapter_resources(adapter);
    kfree(ahw);
    free_netdev(netdev);
...
#[no_mangle]
unsafe extern "C" fn qlcnic_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_suspend(dev_d: *mut device) -> int __maybe_unused {
    static int __maybe_unused qlcnic_suspend(struct device *dev_d)
    {
    return __qlcnic_shutdown(to_pci_dev(dev_d));
    }
#[no_mangle]
unsafe extern "C" fn qlcnic_resume(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_open(netdev: *mut net_device) -> c_int {
    static int qlcnic_open(struct net_device *netdev)
    {
    struct qlcnic_adapter *adapter = netdev_priv(netdev);
    int err;
...
//
#[no_mangle]
unsafe extern "C" fn qlcnic_close(netdev: *mut net_device) -> c_int {
    static int qlcnic_close(struct net_device *netdev)
    {
    struct qlcnic_adapter *adapter = netdev_priv(netdev);
    __qlcnic_down(adapter, netdev);
...
pub const QLCNIC_VF_LB_BUCKET_SIZE: c_int = 1;
#[no_mangle]
pub unsafe extern "C" fn qlcnic_alloc_lb_filters_mem(adapter: *mut qlcnic_adapter) {
    void qlcnic_alloc_lb_filters_mem(struct qlcnic_adapter *adapter)
    {
    void *head;
    int i;
    struct net_device *netdev = adapter.netdev;
    let mut filter_size: u32 = 0;
    let mut act_pci_func: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_free_lb_filters_mem(adapter: *mut qlcnic_adapter) {
    static void qlcnic_free_lb_filters_mem(struct qlcnic_adapter *adapter)
    {
    if (adapter.fhash.fmax)
    kfree(adapter.fhash.fhead);
    adapter.fhash.fhead = core::ptr::null_mut();
    adapter.fhash.fmax = 0;
    if (adapter.rx_fhash.fmax)
    kfree(adapter.rx_fhash.fhead);
    adapter.rx_fhash.fmax = 0;
    adapter.rx_fhash.fhead = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn qlcnic_check_temp(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dump_tx_ring_desc(tx_ring: *mut qlcnic_host_tx_ring) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_dump_rings(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
    static void qlcnic_tx_timeout(struct net_device *netdev, unsigned int txqueue)
    {
    struct qlcnic_adapter *adapter = netdev_priv(netdev);
...
#[no_mangle]
unsafe extern "C" fn qlcnic_82xx_clear_legacy_intr(adapter: *mut qlcnic_adapter) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_tmp_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t qlcnic_tmp_intr(int irq, void *data)
    {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t qlcnic_intr(int irq, void *data)
    {
    struct qlcnic_host_sds_ring *sds_ring = data;
    struct qlcnic_adapter *adapter = sds_ring.adapter;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_msi_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t qlcnic_msi_intr(int irq, void *data)
    {
    struct qlcnic_host_sds_ring *sds_ring = data;
    struct qlcnic_adapter *adapter = sds_ring.adapter;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_msix_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t qlcnic_msix_intr(int irq, void *data)
    {
    struct qlcnic_host_sds_ring *sds_ring = data;
    napi_schedule(&sds_ring.napi);
...
#[no_mangle]
unsafe extern "C" fn qlcnic_msix_tx_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t qlcnic_msix_tx_intr(int irq, void *data)
    {
...
#[no_mangle]
pub unsafe extern "C" fn if(QLCNIC_DEV_NEED_QUISCENT: state ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_clr_all_drv_state(adapter: *mut qlcnic_adapter, failed: u8) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_check_idc_ver(adapter: *mut qlcnic_adapter) -> c_int {
    static int qlcnic_check_idc_ver(struct qlcnic_adapter *adapter)
    {
    let mut val: u32 = QLC_SHARED_REG_RD32(adapter, QLCNIC_CRB_DRV_IDC_VER);
    ...
    {
    u32 val, prev_state;
    let mut dev_init_timeo: u8 = adapter.dev_init_timeo;
    let mut portnum: u8 = adapter.portnum;
    u8 ret;
...
// Transit to NPAR READY state from NPAR NOT READY state
    ...
    qlcnic_clr_all_drv_state(adapter, 0);
#[no_mangle]
pub unsafe extern "C" fn if(QLCNIC_DEV_NPAR_OPER: npar_state !=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_fw_poll_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_is_first_func(pdev: *mut pci_dev) -> c_int {
    static int qlcnic_is_first_func(struct pci_dev *pdev)
    {
    struct pci_dev *oth_pdev;
    let mut val: c_int = pdev.devfn;
    while (val-- > 0) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_attach_func(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_82xx_io_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_82xx_io_resume(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_io_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_io_resume(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_setup_rings(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_restore_indev_addr(netdev: *mut net_device, event: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_restore_indev_addr(dev: *mut net_device, event: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_exit_module() -> void __exit {
