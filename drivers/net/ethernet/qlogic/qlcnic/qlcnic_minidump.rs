...
//! Source: drivers/net/ethernet/qlogic/qlcnic/qlcnic_minidump.c
#![no_std]
...
pub const QLC_83XX_MINIDUMP_FLASH: c_uint = 0x520000;
pub const QLC_83XX_OCM_INDEX: c_int = 3;
pub const QLC_83XX_PCI_INDEX: c_int = 0;
pub const QLC_83XX_DMA_ENGINE_INDEX: c_int = 8;
    static const u32 qlcnic_ms_read_data[] = {
    0x410000A8, 0x410000AC, 0x410000B8, 0x410000BC
    };

pub const QLCNIC_DUMP_MASK_MAX: c_uint = 0xff;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qlcnic_pex_dma_descriptor {
    pub read_data_size: u32,
    pub dma_desc_cmd: u32,
    pub src_addr_low: u32,
    pub src_addr_high: u32,
    pub dma_bus_addr_low: u32,
    pub dma_bus_addr_high: u32,
    pub rsvd: [u32; 6],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qlcnic_common_entry_hdr {
    pub type: u32,
    pub offset: u32,
    pub cap_size: u32,
...
pub struct __cache {
    ...
    pub read_addr_num: u8,
    pub rsvd1: [u8; 2],    pub rsvd1: [u8; 2],
    pub read_addr_num: u8,
    pub read_addr_stride: u8,
...
pub struct __mux2 {
    ...
    pub sel_val2: u32,
    pub no_ops: u32,
    pub sel_val_mask: u32,
    pub read_addr: u32,

    pub sel_val_stride: u8,
    pub data_size: u8,
    pub rsvd: [u8; 2],    pub rsvd: [u8; 2],
    pub data_size: u8,
    pub sel_val_stride: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qlcnic_dump_entry {
    pub hdr: qlcnic_common_entry_hdr,
    union {
    pub crb: __crb,
    pub cache: __cache,
    pub ocm: __ocm,
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_82xx_get_saved_state(t_hdr: *mut c_void, index: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_82xx_cache_tmpl_hdr_values(fw_dump: *mut qlcnic_fw_dump) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_82xx_get_cap_size(t_hdr: *mut c_void, index: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_82xx_set_sys_info(t_hdr: *mut c_void, idx: c_int, value: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_82xx_store_cap_mask(tmpl_hdr: *mut c_void, mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_get_saved_state(t_hdr: *mut c_void, index: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_cache_tmpl_hdr_values(fw_dump: *mut qlcnic_fw_dump) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_get_cap_size(t_hdr: *mut c_void, index: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_set_sys_info(t_hdr: *mut c_void, idx: c_int, value: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_store_cap_mask(tmpl_hdr: *mut c_void, mask: u32) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qlcnic_dump_operations {
    pub opcode: enum qlcnic_minidump_opcode,
...
pub const QLC_DMA_CMD_BUFF_ADDR_LOW: c_int = 0;
pub const QLC_DMA_CMD_BUFF_ADDR_HI: c_int = 4;
pub const QLC_DMA_CMD_STATUS_CTRL: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_temp_checksum(temp_buffer: *mut u32, temp_size: u32) -> u32 {
    static uint32_t qlcnic_temp_checksum(uint32_t *temp_buffer, u32 temp_size)
    {
    let mut sum: u64 = 0;
    let mut count: c_int = temp_size / sizeof(uint32_t);
    while (count-- > 0)
    sum += *temp_buffer++;
    while (sum >> 32)
    ...
    let mut size: u32 = sizeof(tmp_hdr) / sizeof(u32);
    let mut ret: c_int = 0;
    if (qlcnic_82xx_check(adapter))
    return -EIO;
    if (qlcnic_83xx_lock_flash(adapter))
...
// version = cmd.rsp.arg[3];
    ...
    __le32 *tmp_buf;
    struct qlcnic_cmd_args cmd;
    let mut tmp_addr_t: dma_addr_t = 0;
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_fw_cmd_get_minidump_temp(adapter: *mut qlcnic_adapter) -> c_int {
    int qlcnic_fw_cmd_get_minidump_temp(struct qlcnic_adapter *adapter)
    {
    struct qlcnic_hardware_context *ahw;
    struct qlcnic_fw_dump *fw_dump;
    u32 version, csum, *tmp_buf;
    let mut use_flash_temp: u8 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_dump_fw(adapter: *mut qlcnic_adapter) -> c_int {
    ...
    __le32 *buffer;
    char mesg[64];
    char *msg[] = {mesg, core::ptr::null_mut()};
    ahw = adapter.ahw;
    tmpl_hdr = fw_dump.tmpl_hdr;
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_get_minidump_template(adapter: *mut qlcnic_adapter) {
    ...
    if (fw_dump.tmpl_hdr == core::ptr::null_mut() || current_version > prev_version) {
    vfree(fw_dump.tmpl_hdr);
    fw_dump.tmpl_hdr = core::ptr::null_mut();
