...
//! Source: drivers/net/ethernet/qlogic/qlcnic/qlcnic_83xx_vnic.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_enable_vnic_mode(adapter: *mut qlcnic_adapter, lock: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_disable_vnic_mode(adapter: *mut qlcnic_adapter, lock: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_set_vnic_opmode(adapter: *mut qlcnic_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_init_mgmt_vnic(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_init_privileged_vnic(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_init_non_privileged_vnic(adapter: *mut qlcnic_adapter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_config_vnic_opmode(adapter: *mut qlcnic_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_check_vnic_state(adapter: *mut qlcnic_adapter) -> c_int {
