...
//! Source: drivers/net/ethernet/qlogic/qlcnic/qlcnic_io.c
#![no_std]
...
pub const QLCNIC_TX_ETHER_PKT: c_uint = 0x01;
pub const QLCNIC_TX_TCP_PKT: c_uint = 0x02;
pub const QLCNIC_TX_UDP_PKT: c_uint = 0x03;
pub const QLCNIC_TX_IP_PKT: c_uint = 0x04;
pub const QLCNIC_TX_TCP_LSO: c_uint = 0x05;
pub const QLCNIC_TX_TCP_LSO6: c_uint = 0x06;
pub const QLCNIC_TX_ENCAP_PKT: c_uint = 0x07;
pub const QLCNIC_TX_ENCAP_LSO: c_uint = 0x08;
pub const QLCNIC_TX_TCPV6_PKT: c_uint = 0x0b;
pub const QLCNIC_TX_UDPV6_PKT: c_uint = 0x0c;
pub const QLCNIC_FLAGS_VLAN_TAGGED: c_uint = 0x10;
pub const QLCNIC_FLAGS_VLAN_OOB: c_uint = 0x40;
...
pub const QLCNIC_SYN_OFFLOAD: c_uint = 0x03;
pub const QLCNIC_RXPKT_DESC: c_uint = 0x04;
pub const QLCNIC_OLD_RXPKT_DESC: c_uint = 0x3f;
pub const QLCNIC_RESPONSE_DESC: c_uint = 0x05;
pub const QLCNIC_LRO_DESC: c_uint = 0x12;
pub const QLCNIC_TCP_HDR_SIZE: c_int = 20;
pub const QLCNIC_TCP_TS_OPTION_SIZE: c_int = 12;

// for status field in status_desc
pub const STATUS_CKSUM_LOOP: c_int = 0;
pub const STATUS_CKSUM_OK: c_int = 2;
    ...
    u16, u16);
#[no_mangle]
pub unsafe extern "C" fn qlcnic_mac_hash(mac: u64, vlan: u16) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_82xx_is_lb_pkt(sts_data: u64) -> c_int {
    ...
    void *addr, u16 vlan_id)
    {
    struct qlcnic_filter *tmp_fil = core::ptr::null_mut();
    struct hlist_node *n;
    ...
    struct ethhdr *phdr = (struct ethhdr *)(skb.data);
    let mut protocol: u16 = ntohs(skb.protocol);
    struct qlcnic_filter *fil, *tmp_fil;
    struct hlist_head *head;
    struct hlist_node *n;
    let mut src_addr: u64 = 0;
    ...
    struct qlcnic_host_tx_ring *tx_ring)
    {
    let mut opcode: u8 = 0, inner_hdr_len = 0, outer_hdr_len = 0, total_hdr_len = 0;
    int copied, copy_len, descr_size;
    let mut producer: u32 = tx_ring.producer;
    struct cmd_desc_type0 *hwdesc;
    let mut flags: u16 = 0, encap_descr = 0;
...
// outer IP header offset
    ...
    let mut flags: u16 = 0, vlan_tci = 0;
...
pub unsafe extern "C" fn if(IPPROTO_UDP: l4proto ==) -> else {
    ...
    nf = &pbuf.frag_array[0];
    dma_unmap_single(&pdev.dev, nf.dma, skb_headlen(skb), DMA_TO_DEVICE);
    pbuf.skb = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn qlcnic_clear_cmddesc(desc: *mut u64) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_xmit_frame(skb: *mut sk_buff, netdev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(ETH_P_IPV6: protocol ==) -> else {
    else if (protocol == ETH_P_IPV6)
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_advert_link_change(adapter: *mut qlcnic_adapter, linkup: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_tx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_rx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
    ...
    cable_OUI, cable_len);
#[no_mangle]
pub unsafe extern "C" fn if(LINKEVENT_MODULE_TWINAX_UNSUPPORTED_CABLELEN: module ==) -> else {
    ...
    if (unlikely(buffer.skb == core::ptr::null_mut())) {
    WARN_ON(1);
    return core::ptr::null_mut();
    }
...
pub const QLC_TCP_HDR_SIZE: c_int = 20;
pub const QLC_TCP_TS_OPTION_SIZE: c_int = 12;
...
#[no_mangle]
unsafe extern "C" fn qlcnic_process_rcv_ring(sds_ring: *mut qlcnic_host_sds_ring, max: c_int) -> c_int {
    ...
    u8 ring;
    let mut consumer: u32 = sds_ring.consumer;
    while (count < max) {
...
#[no_mangle]
unsafe extern "C" fn dump_skb(skb: *mut sk_buff, adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_82xx_process_rcv_ring_diag(sds_ring: *mut qlcnic_host_sds_ring) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_82xx_napi_del(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_82xx_napi_enable(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_82xx_napi_disable(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_is_lb_pkt(sts_data: u64, lro_pkt: c_int) -> c_int {
...
pub const QLCNIC_ENCAP_LENGTH_MASK: c_uint = 0x7f;
#[no_mangle]
pub unsafe extern "C" fn qlcnic_encap_length(sts_data: u64) -> u8 {
    ...
    struct list_head *cur;
    struct status_desc *desc;
    struct qlcnic_rx_buffer *rxbuf = core::ptr::null_mut();
    u8 ring;
    u64 sts_data[2];
    let mut count: c_int = 0, opcode;
    let mut consumer: u32 = sds_ring.consumer;
    while (count < max) {
    desc = &sds_ring.desc_head[consumer];
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_msix_sriov_vf_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_msix_tx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlcnic_83xx_rx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_napi_enable(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_napi_disable(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_napi_del(adapter: *mut qlcnic_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn qlcnic_83xx_process_rcv_ring_diag(sds_ring: *mut qlcnic_host_sds_ring) {
