...
//! Source: drivers/net/ethernet/qlogic/netxen/netxen_nic_ethtool.c
#![no_std]
...
pub const NETXEN_NIC_PORT_WINDOW: c_uint = 0x10000;
pub const NETXEN_NIC_INVALID_DATA: c_uint = 0xDEADBEEF;
...
pub const NETXEN_NIC_REGS_COUNT: c_int = 30;

pub const NETXEN_MAX_EEPROM_LEN: c_int = 1024;
#[no_mangle]
unsafe extern "C" fn netxen_nic_get_eeprom_len(dev: *mut net_device) -> c_int {
    ...
    let mut fw_major: u32 = 0;
    let mut fw_minor: u32 = 0;
    let mut fw_build: u32 = 0;
    ...
    {
    struct netxen_adapter *adapter = netdev_priv(dev);
    let mut check_sfp_module: c_int = 0;
...
// read which mode
    ...
    let mut pcifn: u16 = adapter.ahw.pci_func;
...
#[no_mangle]
unsafe extern "C" fn netxen_nic_get_regs_len(dev: *mut net_device) -> c_int {
    ...
    u32 *regs_buff = p;
    int ring, i = 0;
    let mut port: c_int = adapter.physical_port;
...
#[no_mangle]
unsafe extern "C" fn netxen_nic_test_link(dev: *mut net_device) -> u32 {
    ...
    {
    struct netxen_adapter *adapter = netdev_priv(dev);
    let mut max_rcv_desc: u16 = MAX_RCV_DESCRIPTORS_10G;
    let mut max_jumbo_desc: u16 = MAX_JUMBO_RCV_DESCRIPTORS_10G;
...
#[no_mangle]
unsafe extern "C" fn netxen_nic_reg_test(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netxen_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
// Free dump area once data has been captured
    ...
    mdump.md_capture_buff = core::ptr::null_mut();
