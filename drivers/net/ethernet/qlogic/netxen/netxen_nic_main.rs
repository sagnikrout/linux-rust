...
//! Source: drivers/net/ethernet/qlogic/netxen/netxen_nic_main.c
#![no_std]
...
//
    ...
    let mut port_mode: static int = NETXEN_PORT_MODE_AUTO_NEG;
// Default to restricted 1G auto-neg mode
    let mut wol_port_mode: static int = 5;
    let mut use_msi: static int = 1;
    let mut use_msi_x: static int = 1;
    let mut auto_fw_reset: static int = AUTO_FW_RESET_ENABLED;
...
#[no_mangle]
pub unsafe extern "C" fn netxen_nic_disable_int(sds_ring: *mut nx_host_sds_ring) {
...
#[no_mangle]
pub unsafe extern "C" fn netxen_nic_enable_int(sds_ring: *mut nx_host_sds_ring) {
    ...
    {
    let mut size: c_int = sizeof(struct nx_host_sds_ring) * count;
...
#[no_mangle]
unsafe extern "C" fn nx_set_dma_mask(adapter: *mut netxen_adapter) -> c_int {
...
// Update addressable range if firmware supports it
    ...
    change = 1;
#[no_mangle]
pub unsafe extern "C" fn if(4): (adapter->ahw.revision_id == NX_P2_C1) && (shift <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn netxen_set_port_mode(adapter: *mut netxen_adapter) {
...
pub const PCI_CAP_ID_GEN: c_uint = 0x10;
#[no_mangle]
unsafe extern "C" fn netxen_pcie_strap_init(adapter: *mut netxen_adapter) {
    static void netxen_pcie_strap_init(struct netxen_adapter *adapter)
    {
    u32 pdevfuncsave;
    let mut c8c9value: u32 = 0;
    let mut chicken: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn netxen_set_msix_bit(pdev: *mut pci_dev, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn netxen_init_msix_entries(adapter: *mut netxen_adapter, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn netxen_nic_set_mac(netdev: *mut net_device, p: *mut c_void) -> c_int {
    static int netxen_nic_set_mac(struct net_device *netdev, void *p)
    {
...
#[no_mangle]
unsafe extern "C" fn netxen_set_multicast_list(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn netxen_get_interrupt_mode(adapter: *mut netxen_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn netxen_setup_intr(adapter: *mut netxen_adapter) -> c_int {
    ...
    {
    if (adapter.ahw.db_base != core::ptr::null_mut())
    iounmap(adapter.ahw.db_base);
    if (adapter.ahw.pci_base0 != core::ptr::null_mut())
    iounmap(adapter.ahw.pci_base0);
    if (adapter.ahw.pci_base1 != core::ptr::null_mut())
    iounmap(adapter.ahw.pci_base1);
    if (adapter.ahw.pci_base2 != core::ptr::null_mut())
    iounmap(adapter.ahw.pci_base2);
    }
    static int
    netxen_setup_pci_map(struct netxen_adapter *adapter)
    {
    void __iomem *db_ptr = core::ptr::null_mut();
    resource_size_t mem_base, db_base;
    unsigned long mem_len, db_len = 0;
    struct pci_dev *pdev = adapter.pdev;
    let mut pci_func: c_int = adapter.ahw.pci_func;
...
// 128 Meg of memory
    ...
    if (ahw.pci_base0 == core::ptr::null_mut() || ahw.pci_base1 == core::ptr::null_mut() ||
    ahw.pci_base2 == core::ptr::null_mut()) {
    ...
    if (ahw.pci_base1 == core::ptr::null_mut() || ahw.pci_base2 == core::ptr::null_mut()) {
    dev_err(&pdev.dev, "failed to map PCI bar 0\n");
    err = -EIO;
    goto err_out;
    }
...
// Get FW Mini Coredump template and store it
    if (NX_IS_REVISION_P3(adapter.ahw.revision_id)) {
    if (adapter.mdump.md_template == core::ptr::null_mut() ||
    adapter.fw_version > prev_fw_version) {
    kfree(adapter.mdump.md_template);
    adapter.mdump.md_template = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(NETXEN_NIC_MSI_ENABLED: adapter->flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn netxen_read_ula_info(adapter: *mut netxen_adapter) {
...
#[no_mangle]
unsafe extern "C" fn netxen_mask_aer_correctable(adapter: *mut netxen_adapter) {
...
// root bus?
    ...
    struct netxen_adapter *adapter = core::ptr::null_mut();
    let mut i: c_int = 0, err;
    let mut pci_func_id: c_int = PCI_FUNC(pdev.devfn);
    uint8_t revision_id;
    u32 val;
...
// MTU range: 0 - 8000 (P2) or 9600 (P3)
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn netxen_cleanup_minidump(adapter: *mut netxen_adapter) {
    ...
    adapter.mdump.md_capture_buff = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn netxen_nic_remove(pdev: *mut pci_dev) {
    static void netxen_nic_remove(struct pci_dev *pdev)
    {
...
#[no_mangle]
unsafe extern "C" fn netxen_nic_detach_func(adapter: *mut netxen_adapter) {
...
#[no_mangle]
unsafe extern "C" fn netxen_nic_attach_late_func(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netxen_nic_attach_func(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netxen_io_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn netxen_nic_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn netxen_nic_open(netdev: *mut net_device) -> c_int {
    static int netxen_nic_open(struct net_device *netdev)
    {
    struct netxen_adapter *adapter = netdev_priv(netdev);
    let mut err: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn netxen_nic_close(netdev: *mut net_device) -> c_int {
    static int netxen_nic_close(struct net_device *netdev)
    {
    struct netxen_adapter *adapter = netdev_priv(netdev);
    __netxen_nic_down(adapter, netdev);
    ...
    struct sk_buff *skb)
    {
    let mut opcode: u8 = TX_ETHER_PKT;
    let mut protocol: __be16 = skb.protocol;
    let mut flags: u16 = 0, vid = 0;
    u32 producer;
...
// Only in case of TSO on vlan device
    ...
    opcode = TX_TCP_PKT;
#[no_mangle]
pub unsafe extern "C" fn if(IPPROTO_UDP: l4proto ==) -> else {
...
// Create a TSO vlan header template for firmware
    ...
    tx_ring.cmd_buf_arr[producer].skb = core::ptr::null_mut();
    ...
    u32 producer;
    int frag_count;
    let mut num_txd: u32 = tx_ring.num_desc;
...
#[no_mangle]
unsafe extern "C" fn netxen_nic_check_temp(adapter: *mut netxen_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn netxen_advert_link_change(adapter: *mut netxen_adapter, linkup: c_int) {
...
#[no_mangle]
unsafe extern "C" fn netxen_nic_handle_phy_intr(adapter: *mut netxen_adapter) {
...
#[no_mangle]
unsafe extern "C" fn netxen_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
    static void netxen_tx_timeout(struct net_device *netdev, unsigned int txqueue)
    {
    struct netxen_adapter *adapter = netdev_priv(netdev);
...
#[no_mangle]
unsafe extern "C" fn netxen_tx_timeout_task(work: *mut work_struct) {
    static void netxen_tx_timeout_task(struct work_struct *work)
    {
    struct netxen_adapter *adapter =
...
#[no_mangle]
unsafe extern "C" fn netxen_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t netxen_intr(int irq, void *data)
    {
...
#[no_mangle]
unsafe extern "C" fn netxen_msi_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t netxen_msi_intr(int irq, void *data)
    {
    struct nx_host_sds_ring *sds_ring = data;
    struct netxen_adapter *adapter = sds_ring.adapter;
...
#[no_mangle]
unsafe extern "C" fn netxen_msix_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t netxen_msix_intr(int irq, void *data)
    {
    struct nx_host_sds_ring *sds_ring = data;
    napi_schedule(&sds_ring.napi);
...
#[no_mangle]
unsafe extern "C" fn netxen_nic_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int netxen_nic_poll(struct napi_struct *napi, int budget)
    {
    struct nx_host_sds_ring *sds_ring =
    ...
    ret = 0;
#[no_mangle]
pub unsafe extern "C" fn if(NX_DEV_READY: state ==) -> else {
    ...
    ret = 0;
#[no_mangle]
pub unsafe extern "C" fn if(NX_DEV_NEED_AER: state != NX_DEV_INITALIZING && state !=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn netxen_config_master(dev: *mut net_device, event: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn netxen_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn netxen_exit_module() -> void __exit {
