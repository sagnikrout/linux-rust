...
//! Source: drivers/net/ethernet/qlogic/qede/qede_filter.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qede_arfs_fltr_node {
pub const QEDE_FLTR_VALID: c_int = 0;
    pub state: c_ulong,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qede_arfs {

pub const QEDE_ARFS_POLL_COUNT: c_int = 100;

    pub QEDE_RFS_FLW_BITSHIFT]: hlist_head arfs_hl_head[1 <<,
// lock for filter list access
    pub arfs_list_lock: spinlock_t,
    pub arfs_fltr_bmap: *mut c_ulong,
    pub filter_count: c_int,
// Currently configured filtering mode
    pub mode: enum qed_filter_config_mode,
}
...
#[no_mangle]
pub unsafe extern "C" fn qede_arfs_filter_op(dev: *mut c_void, filter: *mut c_void, fw_rc: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn qede_process_arfs_filters(edev: *mut qede_dev, free_fltr: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qede_poll_for_freeing_arfs_filters(edev: *mut qede_dev) {
    void qede_poll_for_freeing_arfs_filters(struct qede_dev *edev)
    {
    let mut count: c_int = QEDE_ARFS_POLL_COUNT;
    while (count) {
...
#[no_mangle]
pub unsafe extern "C" fn qede_alloc_arfs(edev: *mut qede_dev) -> c_int {
    ...
    edev.arfs.arfs_fltr_bmap = core::ptr::null_mut();
    vfree(edev.arfs);
    edev.arfs = core::ptr::null_mut();
    return -ENOMEM;
    }
...
#[no_mangle]
pub unsafe extern "C" fn qede_free_arfs(edev: *mut qede_dev) {
    ...
    let mut size: u8 = sizeof(struct in6_addr);
...
#[no_mangle]
pub unsafe extern "C" fn qede_udp_ports_update(dev: *mut c_void, vxlan_port: u16, geneve_port: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn qede_force_mac(dev: *mut c_void, mac: *mut u8, forced: bool) {
...
// Now that we have the queue-indirection, prepare the handles
    for (i = 0; i < QED_RSS_IND_TABLE_SIZE; i++) {
    let mut idx: u16 = QEDE_RX_QUEUE_IDX(edev, edev.rss_ind_table[i]);
...
#[no_mangle]
unsafe extern "C" fn qede_config_accept_any_vlan(edev: *mut qede_dev, action: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qede_vlan_rx_add_vid(dev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qede_configure_vlan_filters(edev: *mut qede_dev) -> c_int {
    int qede_configure_vlan_filters(struct qede_dev *edev)
    {
    let mut rc: c_int = 0, real_rc = 0, accept_any_vlan = 0;
    struct qed_dev_eth_info *dev_info;
    struct qede_vlan *vlan = core::ptr::null_mut();
...
//
    ...
    rc = qede_config_accept_any_vlan(edev, true);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !edev->non_configured_vlans) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn qede_vlan_rx_kill_vid(dev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qede_vlan_mark_nonconfigured(edev: *mut qede_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn qede_set_features(dev: *mut net_device, features: netdev_features_t) -> c_int {
    int qede_set_features(struct net_device *dev, netdev_features_t features)
    {
    struct qede_dev *edev = netdev_priv(dev);
    let mut changes: netdev_features_t = features ^ dev.features;
    let mut need_reload: bool = false;
...
#[no_mangle]
unsafe extern "C" fn qede_udp_tunnel_sync(dev: *mut net_device, table: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qede_set_udp_tunnels(edev: *mut qede_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: edev->dev_info.common.vxlan_enable) -> else {
    else if (edev.dev_info.common.vxlan_enable)
    edev.ndev.udp_tunnel_nic_info = &qede_udp_tunnels_vxlan;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: edev->dev_info.common.geneve_enable) -> else {
...
#[no_mangle]
unsafe extern "C" fn qede_xdp_set(edev: *mut qede_dev, prog: *mut bpf_prog) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qede_xdp(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qede_set_mac_addr(ndev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qede_set_rx_mode(ndev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn qede_config_rx_mode(ndev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn qede_get_cls_rule_entry(edev: *mut qede_dev, cmd: *mut ethtool_rxnfc) -> c_int {
    int qede_get_cls_rule_entry(struct qede_dev *edev, struct ethtool_rxnfc *cmd)
    {
    struct ethtool_rx_flow_spec *fsp = &cmd.fs;
    struct qede_arfs_fltr_node *fltr = core::ptr::null_mut();
    let mut rc: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn qede_flow_get_min_header_size(t: *mut qede_arfs_tuple) -> c_int {
    static int qede_flow_get_min_header_size(struct qede_arfs_tuple *t)
    {
    let mut size: c_int = ETH_HLEN;
...
#[no_mangle]
pub unsafe extern "C" fn qede_delete_flow_filter(edev: *mut qede_dev, cookie: u64) -> c_int {
    int qede_delete_flow_filter(struct qede_dev *edev, u64 cookie)
    {
    struct qede_arfs_fltr_node *fltr = core::ptr::null_mut();
    let mut rc: c_int = -EPERM;
    __qede_lock(edev);
    if (!edev.arfs)
    goto unlock;
    fltr = qede_get_arfs_fltr_by_loc(QEDE_ARFS_BUCKET_HEAD(edev, 0),
...
#[no_mangle]
pub unsafe extern "C" fn qede_get_arfs_filter_count(edev: *mut qede_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(htons(ETH_P_IPV6): ip_proto == IPPROTO_TCP && proto ==) -> else {
    else if (ip_proto == IPPROTO_TCP && proto == htons(ETH_P_IPV6))
    rc = qede_flow_parse_tcp_v6(rule, tuple, extack);
#[no_mangle]
pub unsafe extern "C" fn if(htons(ETH_P_IP): ip_proto == IPPROTO_UDP && proto ==) -> else {
    else if (ip_proto == IPPROTO_UDP && proto == htons(ETH_P_IP))
    rc = qede_flow_parse_udp_v4(rule, tuple, extack);
#[no_mangle]
pub unsafe extern "C" fn if(htons(ETH_P_IPV6): ip_proto == IPPROTO_UDP && proto ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn qede_add_cls_rule(edev: *mut qede_dev, info: *mut ethtool_rxnfc) -> c_int {
