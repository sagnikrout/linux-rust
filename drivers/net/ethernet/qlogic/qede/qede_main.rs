...
//! Source: drivers/net/ethernet/qlogic/qede/qede_main.c
#![no_std]
...
pub const CHIP_NUM_57980S_40: c_uint = 0x1634;
pub const CHIP_NUM_57980S_10: c_uint = 0x1666;
pub const CHIP_NUM_57980S_MF: c_uint = 0x1636;
pub const CHIP_NUM_57980S_100: c_uint = 0x1644;
pub const CHIP_NUM_57980S_50: c_uint = 0x1654;
pub const CHIP_NUM_57980S_25: c_uint = 0x1656;
pub const CHIP_NUM_57980S_IOV: c_uint = 0x1664;
pub const CHIP_NUM_AH: c_uint = 0x8070;
pub const CHIP_NUM_AH_IOV: c_uint = 0x8090;
...
#[no_mangle]
unsafe extern "C" fn qede_set_vf_mac(ndev: *mut net_device, vfidx: c_int, mac: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_sriov_configure(pdev: *mut pci_dev, num_vfs_param: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_suspend(dev: *mut device) -> int __maybe_unused {
    static int __maybe_unused qede_suspend(struct device *dev)
    {
    dev_info(dev, "Device does not support suspend operation\n");
    return -EOPNOTSUPP;
    }
    static DEFINE_SIMPLE_DEV_PM_OPS(qede_pm_ops, qede_suspend, core::ptr::null_mut());
...
// Notify qed of the name change
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn qede_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn qede_cleanup() -> void __exit {
...
#[no_mangle]
pub unsafe extern "C" fn qede_fill_by_demand_stats(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_set_vf_spoofchk(dev: *mut net_device, vfidx: c_int, val: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_set_vf_trust(dev: *mut net_device, vfidx: c_int, setting: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_fp_sb_dump(edev: *mut qede_dev, fp: *mut qede_fastpath) {
...
#[no_mangle]
unsafe extern "C" fn qede_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn qede_setup_tc(ndev: *mut net_device, num_tc: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_init_ndev(edev: *mut qede_dev) {
    static void qede_init_ndev(struct qede_dev *edev)
    {
    struct net_device *ndev = edev.ndev;
    struct pci_dev *pdev = edev.pdev;
    let mut udp_tunnel_enable: bool = false;
...
//
#[no_mangle]
pub unsafe extern "C" fn qede_config_debug(debug: c_uint, p_dp_module: *mut u32, p_dp_level: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn qede_free_fp_array(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_alloc_fp_array(edev: *mut qede_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __qede_lock(edev: *mut qede_dev) {
    void __qede_lock(struct qede_dev *edev)
    {
    mutex_lock(&edev.qede_lock);
    }
#[no_mangle]
pub unsafe extern "C" fn __qede_unlock(edev: *mut qede_dev) {
    void __qede_unlock(struct qede_dev *edev)
    {
    mutex_unlock(&edev.qede_lock);
    }
#[no_mangle]
unsafe extern "C" fn qede_periodic_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qede_init_periodic_task(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_sp_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qede_update_pf_params(cdev: *mut qed_dev) {
...
pub const QEDE_FW_VER_STR_SIZE: c_int = 80;
#[no_mangle]
unsafe extern "C" fn qede_log_probe(edev: *mut qede_dev) {
...
// Learn information crucial for qede to progress
    ...
    edev.devlink = core::ptr::null_mut();
    goto err3;
    }
    } else {
...
#[no_mangle]
unsafe extern "C" fn qede_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    static int qede_probe(struct pci_dev *pdev, const struct pci_device_id *id)
    {
    let mut is_vf: bool = false;
    let mut dp_module: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn __qede_remove(pdev: *mut pci_dev, mode: enum qede_remove_mode) {
...
#[no_mangle]
unsafe extern "C" fn qede_remove(pdev: *mut pci_dev) {
    static void qede_remove(struct pci_dev *pdev)
    {
    __qede_remove(pdev, QEDE_REMOVE_NORMAL);
    }
#[no_mangle]
unsafe extern "C" fn qede_shutdown(pdev: *mut pci_dev) {
    static void qede_shutdown(struct pci_dev *pdev)
    {
    __qede_remove(pdev, QEDE_REMOVE_NORMAL);
    }
...
//
#[no_mangle]
unsafe extern "C" fn qede_set_num_queues(edev: *mut qede_dev) -> c_int {
...
// This function allocates fast-path status block memory
    ...
    rx_buf.data = core::ptr::null_mut();
    __free_page(data);
    }
    }
#[no_mangle]
unsafe extern "C" fn qede_free_mem_rxq(edev: *mut qede_dev, rxq: *mut qede_rx_queue) {
...
#[no_mangle]
unsafe extern "C" fn qede_set_tpa_param(rxq: *mut qede_rx_queue) {
...
#[no_mangle]
unsafe extern "C" fn qede_alloc_mem_rxq(edev: *mut qede_dev, rxq: *mut qede_rx_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_free_mem_txq(edev: *mut qede_dev, txq: *mut qede_tx_queue) {
...
#[no_mangle]
unsafe extern "C" fn qede_alloc_mem_txq(edev: *mut qede_dev, txq: *mut qede_tx_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_free_mem_fp(edev: *mut qede_dev, fp: *mut qede_fastpath) {
...
//
#[no_mangle]
unsafe extern "C" fn qede_alloc_mem_fp(edev: *mut qede_dev, fp: *mut qede_fastpath) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_free_mem_load(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_alloc_mem_load(edev: *mut qede_dev) -> c_int {
    static int qede_alloc_mem_load(struct qede_dev *edev)
    {
    let mut rc: c_int = 0, queue_id;
...
#[no_mangle]
unsafe extern "C" fn qede_empty_tx_queues(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_init_fp(edev: *mut qede_dev) {
    static void qede_init_fp(struct qede_dev *edev)
    {
    int queue_id, rxq_index = 0, txq_index = 0;
    struct qede_fastpath *fp;
    let mut init_xdp: bool = false;
...
#[no_mangle]
unsafe extern "C" fn qede_set_real_num_queues(edev: *mut qede_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_napi_disable_remove(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_napi_add_enable(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_sync_free_irqs(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_req_msix_irqs(edev: *mut qede_dev) -> c_int {
...
// Sanitize number of interrupts == number of prepared RSS queues
    ...
    edev.ndev.rx_cpu_rmap = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qede_simd_fp_handler(cookie: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qede_setup_irqs(edev: *mut qede_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_stop_queues(edev: *mut qede_dev) -> c_int {
...
// Stop the vport
    ...
    {
    let mut phys_table: dma_addr_t = qed_chain_get_pbl_phys(&txq.tx_pbl);
    let mut page_cnt: u32 = qed_chain_get_page_cnt(&txq.tx_pbl);
...
#[no_mangle]
unsafe extern "C" fn qede_start_queues(edev: *mut qede_dev, clear_stats: bool) -> c_int {
    static int qede_start_queues(struct qede_dev *edev, bool clear_stats)
    {
    let mut vlan_removal_en: c_int = 1;
    struct qed_dev *cdev = edev.cdev;
    struct qed_dev_info *qed_info = &edev.dev_info.common;
    struct qed_update_vport_params *vport_update_params;
    struct qed_queue_start_common_params q_params;
    let mut start: qed_start_vport_params = {0};
    int rc, i;
    if (!edev.num_queues) {
    DP_ERR(edev,
...
#[no_mangle]
unsafe extern "C" fn qede_open(ndev: *mut net_device) -> c_int {
    static int qede_open(struct net_device *ndev)
    {
    struct qede_dev *edev = netdev_priv(ndev);
    int rc;
...
#[no_mangle]
unsafe extern "C" fn qede_close(ndev: *mut net_device) -> c_int {
    static int qede_close(struct net_device *ndev)
    {
    struct qede_dev *edev = netdev_priv(ndev);
...
#[no_mangle]
unsafe extern "C" fn qede_link_update(dev: *mut c_void, link: *mut qed_link_output) {
    static void qede_link_update(void *dev, struct qed_link_output *link)
    {
...
#[no_mangle]
unsafe extern "C" fn qede_schedule_recovery_handler(dev: *mut c_void) {
    static void qede_schedule_recovery_handler(void *dev)
    {
    struct qede_dev *edev = dev;
...
#[no_mangle]
unsafe extern "C" fn qede_recovery_failed(edev: *mut qede_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn qede_recovery_handler(edev: *mut qede_dev) -> bool {
    static bool qede_recovery_handler(struct qede_dev *edev)
    {
    let mut curr_state: u32 = edev.state;
    let mut reloaded: bool = false;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn qede_atomic_hw_err_handler(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_generic_hw_err_handler(edev: *mut qede_dev) {
    static void qede_generic_hw_err_handler(struct qede_dev *edev)
    {
    DP_NOTICE(edev,
...
#[no_mangle]
unsafe extern "C" fn qede_is_txq_full(edev: *mut qede_dev, txq: *mut qede_tx_queue) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qede_get_generic_tlv_data(dev: *mut c_void, data: *mut qed_generic_tlvs) {
...
#[no_mangle]
unsafe extern "C" fn qede_get_eth_tlv_data(dev: *mut c_void, data: *mut c_void) {
