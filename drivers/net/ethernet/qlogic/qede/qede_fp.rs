...
//! Source: drivers/net/ethernet/qlogic/qede/qede_fp.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn qede_alloc_rx_buffer(rxq: *mut qede_rx_queue, allow_lazy: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qede_free_tx_pkt(edev: *mut qede_dev, txq: *mut qede_tx_queue, len: *mut c_int) -> c_int {
    int qede_free_tx_pkt(struct qede_dev *edev, struct qede_tx_queue *txq, int *len)
    {
    let mut idx: u16 = txq.sw_tx_cons;
    struct sk_buff *skb = txq.sw_tx_ring.skbs[idx].skb;
    struct eth_tx_1st_bd *first_bd;
    struct eth_tx_bd *tx_data_bd;
    let mut bds_consumed: c_int = 0;
    int nbds;
    let mut data_split: bool = txq.sw_tx_ring.skbs[idx].flags & QEDE_TSO_SPLIT_BD;
...
// Free skb
    ...
    txq.sw_tx_ring.skbs[idx].skb = core::ptr::null_mut();
...
// Unmap the data and free skb when mapping failed during start_xmit
    ...
    {
    let mut idx: u16 = txq.sw_tx_prod;
    struct sk_buff *skb = txq.sw_tx_ring.skbs[idx].skb;
    struct eth_tx_bd *tx_data_bd;
    int i, split_bd_len = 0;
...
#[no_mangle]
unsafe extern "C" fn qede_xmit_type(skb: *mut sk_buff, ipv6_ext: *mut c_int) -> u32 {
    static u32 qede_xmit_type(struct sk_buff *skb, int *ipv6_ext)
    {
    let mut rc: u32 = XMIT_L4_CSUM;
    __be16 l3_proto;
...
// ipv6_ext = 1;
    ...
    rc |= XMIT_ENC;
    if (skb_is_gso(skb)) {
    let mut gso_type: c_ushort = skb_shinfo(skb).gso_type;
    ...
    {
    u8 l4_proto;
    let mut bd2_bits1: u16 = 0, bd2_bits2 = 0;
...
#[no_mangle]
unsafe extern "C" fn qede_get_skb_hlen(skb: *mut sk_buff, is_encap_pkt: bool) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn qede_pkt_req_lin(skb: *mut sk_buff, xmit_type: u8) -> bool {
    static bool qede_pkt_req_lin(struct sk_buff *skb, u8 xmit_type)
    {
    let mut allowed_frags: c_int = ETH_TX_MAX_BDS_PER_NON_LSO_PACKET - 1;
...
#[no_mangle]
pub unsafe extern "C" fn qede_update_tx_producer(txq: *mut qede_tx_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn qede_txq_has_work(txq: *mut qede_tx_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_xdp_tx_int(edev: *mut qede_dev, txq: *mut qede_tx_queue) {
    ...
    xdp_info.xdpf = core::ptr::null_mut();
    } else {
...
#[no_mangle]
unsafe extern "C" fn qede_tx_int(edev: *mut qede_dev, txq: *mut qede_tx_queue) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qede_has_rx_work(rxq: *mut qede_rx_queue) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn qede_rx_bd_ring_consume(rxq: *mut qede_rx_queue) {
...
// curr_prod = *curr_cons;
    ...
    rxq.rx_headroom);
    rxq.sw_rx_prod++;
    curr_cons.data = core::ptr::null_mut();
    }
// In case of allocation failures reuse buffers
// from consumer index to produce buffers for firmware
//
#[no_mangle]
pub unsafe extern "C" fn qede_recycle_rx_bd_ring(rxq: *mut qede_rx_queue, count: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn qede_update_rx_prod(edev: *mut qede_dev, rxq: *mut qede_rx_queue) {
    void qede_update_rx_prod(struct qede_dev *edev, struct qede_rx_queue *rxq)
    {
    let mut bd_prod: u16 = qed_chain_get_prod_idx(&rxq.rx_bd_ring);
    let mut cqe_prod: u16 = qed_chain_get_prod_idx(&rxq.rx_comp_ring);
    let mut rx_prods: eth_rx_prod_data = {0};
// Update producers
...
#[no_mangle]
unsafe extern "C" fn qede_get_rxhash(skb: *mut sk_buff, bitfields: u8, rss_hash: __le32) {
    static void qede_get_rxhash(struct sk_buff *skb, u8 bitfields, __le32 rss_hash)
    {
    let mut hash_type: enum pkt_hash_types = PKT_HASH_TYPE_NONE;
...
#[no_mangle]
unsafe extern "C" fn qede_set_skb_csum(skb: *mut sk_buff, csum_flag: u8) {
    ...
    {
    let mut parsing_flags: u16 = le16_to_cpu(cqe.pars_flags.flags);
...
#[no_mangle]
unsafe extern "C" fn qede_tunn_exist(flag: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qede_check_tunn_csum(flag: u16) -> u8 {
    static u8 qede_check_tunn_csum(u16 flag)
    {
    let mut csum_flag: u16 = 0;
    let mut tcsum: u8 = 0;
...
//
    ...
    let mut offset: c_uint = bd.page_offset + pad;
...
#[no_mangle]
unsafe extern "C" fn qede_gro_ip_csum(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn qede_gro_ipv6_csum(skb: *mut sk_buff) {
...
//
    ...
    tpa_info.skb = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn qede_check_notunn_csum(flag: u16) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn qede_check_csum(flag: u16) -> u8 {
    ...
    u16 flag)
    {
    let mut tun_pars_flg: u8 = cqe.tunnel_pars_flags.flags;
...
// We need the replacement buffer before transmit.
    ...
    u16 first_bd_len)
    {
    let mut pkt_len: u16 = le16_to_cpu(cqe.pkt_len);
    struct sw_rx_data *bd;
    u16 bd_cons_idx;
    u8 num_frags;
...
#[no_mangle]
unsafe extern "C" fn qede_rx_int(fp: *mut qede_fastpath, budget: c_int) -> c_int {
    static int qede_rx_int(struct qede_fastpath *fp, int budget)
    {
    struct qede_rx_queue *rxq = fp.rxq;
    struct qede_dev *edev = fp.edev;
    let mut work_done: c_int = 0, rcv_pkts = 0;
    u16 hw_comp_cons, sw_comp_cons;
    hw_comp_cons = le16_to_cpu(*rxq.hw_cons_ptr);
    sw_comp_cons = qed_chain_get_cons_idx(&rxq.rx_comp_ring);
...
#[no_mangle]
unsafe extern "C" fn qede_poll_is_more_work(fp: *mut qede_fastpath) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn qede_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qede_msix_fp_int(irq: c_int, fp_cookie: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn qede_start_xmit(skb: *mut sk_buff, ndev: *mut net_device) -> netdev_tx_t {
    ...
    struct eth_tx_1st_bd *first_bd;
    struct eth_tx_2nd_bd *second_bd = core::ptr::null_mut();
    struct eth_tx_3rd_bd *third_bd = core::ptr::null_mut();
    struct eth_tx_bd *tx_data_bd = core::ptr::null_mut();
    u16 txq_index, val = 0;
    let mut nbd: u8 = 0;
    dma_addr_t mapping;
...
//
    ...
    let mut tmp: u8 = ETH_TX_1ST_BD_FLAGS_TUNN_L4_CSUM_SHIFT;
...
//
    ...
    netdev_pick_tx(dev, skb, core::ptr::null_mut()) % total_txq :  0;
    }
// 8B udp header + 8B base tunnel header + 32B option length
pub const QEDE_MAX_TUN_HDR_LEN: c_int = 48;
