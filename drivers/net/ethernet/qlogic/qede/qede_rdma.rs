...
//! Source: drivers/net/ethernet/qlogic/qede/qede_rdma.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn qede_rdma_supported(dev: *mut qede_dev) -> bool {
    bool qede_rdma_supported(struct qede_dev *dev)
    {
    return dev.dev_info.common.rdma_supported;
    }
#[no_mangle]
unsafe extern "C" fn _qede_rdma_dev_add(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_rdma_create_wq(edev: *mut qede_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_rdma_cleanup_event(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_rdma_complete_event(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn qede_rdma_destroy_wq(edev: *mut qede_dev) {
...
//
    ...
    edev.rdma_info.rdma_wq = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn qede_rdma_dev_add(edev: *mut qede_dev, recovery: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _qede_rdma_dev_remove(edev: *mut qede_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn qede_rdma_dev_remove(edev: *mut qede_dev, recovery: bool) {
...
// Cannot remove qedr while recovering since it wasn't fully stopped
    ...
    edev.rdma_info.qedr_dev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn _qede_rdma_dev_open(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_rdma_dev_open(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn _qede_rdma_dev_close(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_rdma_dev_close(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_rdma_dev_shutdown(edev: *mut qede_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn qede_rdma_register_driver(drv: *mut qedr_driver) -> c_int {
    int qede_rdma_register_driver(struct qedr_driver *drv)
    {
    struct qede_dev *edev;
    let mut qedr_counter: u8 = 0;
    mutex_lock(&qedr_dev_list_lock);
    if (qedr_drv) {
    mutex_unlock(&qedr_dev_list_lock);
    return -EINVAL;
...
#[no_mangle]
pub unsafe extern "C" fn qede_rdma_unregister_driver(drv: *mut qedr_driver) {
...
// If device has experienced recovery it was already removed
    ...
    qedr_drv = core::ptr::null_mut();
    mutex_unlock(&qedr_dev_list_lock);
    }
    EXPORT_SYMBOL(qede_rdma_unregister_driver);
#[no_mangle]
unsafe extern "C" fn qede_rdma_changeaddr(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_rdma_change_mtu(edev: *mut qede_dev) {
    ...
    {
    struct qede_rdma_event_work *event_node = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qede_rdma_handle_event(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn qede_rdma_dev_event_open(edev: *mut qede_dev) {
    void qede_rdma_dev_event_open(struct qede_dev *edev)
    {
    qede_rdma_add_event(edev, QEDE_UP);
    }
#[no_mangle]
pub unsafe extern "C" fn qede_rdma_dev_event_close(edev: *mut qede_dev) {
    void qede_rdma_dev_event_close(struct qede_dev *edev)
    {
    qede_rdma_add_event(edev, QEDE_DOWN);
    }
#[no_mangle]
pub unsafe extern "C" fn qede_rdma_event_changeaddr(edev: *mut qede_dev) {
    void qede_rdma_event_changeaddr(struct qede_dev *edev)
    {
    qede_rdma_add_event(edev, QEDE_CHANGE_ADDR);
    }
#[no_mangle]
pub unsafe extern "C" fn qede_rdma_event_change_mtu(edev: *mut qede_dev) {
