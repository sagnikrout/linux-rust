...
//! Source: drivers/net/ethernet/qlogic/qede/qede_dcbnl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qede_dcbnl_getstate(netdev: *mut net_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn qede_dcbnl_setstate(netdev: *mut net_device, state: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn qede_dcbnl_getcap(netdev: *mut net_device, capid: c_int, cap: *mut u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn qede_dcbnl_getnumtcs(netdev: *mut net_device, tcid: c_int, num: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_dcbnl_getpfcstate(netdev: *mut net_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn qede_dcbnl_getapp(netdev: *mut net_device, idtype: u8, id: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_dcbnl_getdcbx(netdev: *mut net_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn qede_dcbnl_setall(netdev: *mut net_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn qede_dcbnl_setnumtcs(netdev: *mut net_device, tcid: c_int, num: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_dcbnl_setpfcstate(netdev: *mut net_device, state: u8) {
...
#[no_mangle]
unsafe extern "C" fn qede_dcbnl_setdcbx(netdev: *mut net_device, state: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn qede_dcbnl_setfeatcfg(netdev: *mut net_device, featid: c_int, flags: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn qede_set_dcbnl_ops(dev: *mut net_device) {
