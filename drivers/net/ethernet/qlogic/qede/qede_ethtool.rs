...
//! Source: drivers/net/ethernet/qlogic/qede/qede_ethtool.c
#![no_std]
...
pub const QEDE_SELFTEST_POLL_COUNT: c_int = 100;
pub const QEDE_DUMP_VERSION: c_uint = 0x1;
pub const QEDE_DUMP_NVM_ARG_COUNT: c_int = 2;
    static const struct {
    u64 offset;
    ...
    char string[ETH_GSTRING_LEN];
    unsigned long attr;
pub const QEDE_STAT_PF_ONLY: c_int = 0;
pub const QEDE_STAT_BB_ONLY: c_int = 1;
pub const QEDE_STAT_AH_ONLY: c_int = 2;
    } qede_stats_arr[] = {
...
#[no_mangle]
pub unsafe extern "C" fn qede_forced_speed_maps_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn qede_is_irrelevant_stat(edev: *mut qede_dev, stat_index: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qede_get_strings_stats(edev: *mut qede_dev, buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn qede_get_strings(dev: *mut net_device, stringset: u32, buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn qede_get_ethtool_stats_txq(txq: *mut qede_tx_queue, buf: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn qede_get_ethtool_stats_rxq(rxq: *mut qede_rx_queue, buf: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn qede_get_sset_count(dev: *mut net_device, stringset: c_int) -> c_int {
    static int qede_get_sset_count(struct net_device *dev, int stringset)
    {
    struct qede_dev *edev = netdev_priv(dev);
    let mut num_stats: c_int = QEDE_NUM_STATS, i;
    switch (stringset) {
    case ETH_SS_STATS:
    for (i = 0; i < QEDE_NUM_STATS; i++)
    if (qede_is_irrelevant_stat(edev, i))
...
#[no_mangle]
unsafe extern "C" fn qede_get_priv_flags(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn qede_set_priv_flags(dev: *mut net_device, flags: u32) -> c_int {
    static int qede_set_priv_flags(struct net_device *dev, u32 flags)
    {
    struct qede_dev *edev = netdev_priv(dev);
    let mut cflags: u32 = qede_get_priv_flags(dev);
    let mut dflags: u32 = flags ^ cflags;
...
#[no_mangle]
unsafe extern "C" fn qede_get_wol(ndev: *mut net_device, wol: *mut ethtool_wolinfo) {
...
#[no_mangle]
unsafe extern "C" fn qede_set_wol(ndev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_get_msglevel(ndev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn qede_set_msglevel(ndev: *mut net_device, level: u32) {
...
#[no_mangle]
unsafe extern "C" fn qede_nway_reset(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_get_link(dev: *mut net_device) -> u32 {
    ...
    {
    void *rx_handle = core::ptr::null_mut(), *tx_handle = core::ptr::null_mut();
    struct qede_dev *edev = netdev_priv(dev);
...
// Change ring size and re-load
    ...
    qede_reload(edev, core::ptr::null_mut(), false);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn qede_get_regs_len(ndev: *mut net_device) -> c_int {
...
// Netdevice NDOs
#[no_mangle]
pub unsafe extern "C" fn qede_change_mtu(ndev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_get_rx_ring_count(dev: *mut net_device) -> u32 {
    ...
    struct qede_dev *edev = netdev_priv(dev);
    let mut set_caps: u8 = 0, clr_caps = 0;
    let mut rc: c_int = 0;
    DP_VERBOSE(edev, QED_MSG_DEBUG,
...
#[no_mangle]
unsafe extern "C" fn qede_set_rxnfc(dev: *mut net_device, info: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_get_rxfh_indir_size(dev: *mut net_device) -> u32 {
    static u32 qede_get_rxfh_indir_size(struct net_device *dev)
    {
    return QED_RSS_IND_TABLE_SIZE;
    }
#[no_mangle]
unsafe extern "C" fn qede_get_rxfh_key_size(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn qede_netif_start(edev: *mut qede_dev) {
...
#[no_mangle]
unsafe extern "C" fn qede_netif_stop(edev: *mut qede_dev) {
...
// Disable interrupts
    ...
    struct sk_buff *skb)
    {
    struct qede_tx_queue *txq = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qede_selftest_receive_traffic(edev: *mut qede_dev) -> c_int {
    static int qede_selftest_receive_traffic(struct qede_dev *edev)
    {
    u16 sw_rx_index, len;
    struct eth_fast_path_rx_reg_cqe *fp_cqe;
    struct qede_rx_queue *rxq = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qede_selftest_run_loopback(edev: *mut qede_dev, loopback_mode: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_get_eee(dev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_set_eee(dev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qede_link_to_ethtool_fec(link_fec: u32) -> u32 {
    static u32 qede_link_to_ethtool_fec(u32 link_fec)
    {
    let mut eth_fec: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn qede_ethtool_to_link_fec(eth_fec: u32) -> u32 {
    static u32 qede_ethtool_to_link_fec(u32 eth_fec)
    {
    let mut link_fec: u32 = 0;
...
// Read first 4 bytes to find the sfp type
    ...
    {
    struct qede_dev *edev = netdev_priv(dev);
    let mut start_addr: u32 = ee.offset, size = 0;
    u8 *buf = data;
    let mut rc: c_int = 0;
// Read A0 section
...
#[no_mangle]
unsafe extern "C" fn qede_set_dump(dev: *mut net_device, val: *mut ethtool_dump) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qede_set_ethtool_ops(dev: *mut net_device) {
