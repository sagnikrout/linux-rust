...
//! Source: drivers/net/ethernet/synopsys/dwc-xlgmac-common.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn xlgmac_read_mac_addr(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_default_config(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_init_all_ops(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_init(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xlgmac_drv_probe(dev: *mut device, res: *mut xlgmac_resources) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xlgmac_drv_remove(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xlgmac_get_all_hw_features(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
pub unsafe extern "C" fn xlgmac_print_all_hw_features(pdata: *mut xlgmac_pdata) {
    void xlgmac_print_all_hw_features(struct xlgmac_pdata *pdata)
    {
    char __maybe_unused *str = core::ptr::null_mut();
    XLGMAC_PR("\n");
    XLGMAC_PR("=====================================================\n");
    XLGMAC_PR("\n");
