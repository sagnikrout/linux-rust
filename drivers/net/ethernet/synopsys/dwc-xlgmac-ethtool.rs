...
//! Source: drivers/net/ethernet/synopsys/dwc-xlgmac-ethtool.c
#![no_std]
...
// Extra counters
    ...
    let mut ver: u32 = pdata.hw_feat.version;
...
#[no_mangle]
unsafe extern "C" fn xlgmac_ethtool_get_msglevel(netdev: *mut net_device) -> u32 {
