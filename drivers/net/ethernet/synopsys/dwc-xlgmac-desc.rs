...
//! Source: drivers/net/ethernet/synopsys/dwc-xlgmac-desc.c
#![no_std]
...
//
    ...
    desc_data.skb = core::ptr::null_mut();
    }
    ...
    desc_data.state.skb = core::ptr::null_mut();
    ...
    ring.desc_data_head = core::ptr::null_mut();
    }
    if (ring.rx_hdr_pa.pages) {
    dma_unmap_page(pdata.dev, ring.rx_hdr_pa.pages_dma,
    ring.rx_hdr_pa.pages_len, DMA_FROM_DEVICE);
    put_page(ring.rx_hdr_pa.pages);
    ring.rx_hdr_pa.pages = core::ptr::null_mut();
    ...
    ring.rx_buf_pa.pages = core::ptr::null_mut();
    ...
    ring.dma_desc_head = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn xlgmac_free_rings(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_alloc_rings(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_free_channels(pdata: *mut xlgmac_pdata) {
    static void xlgmac_free_channels(struct xlgmac_pdata *pdata)
    {
    if (!pdata.channel_head)
    return;
    kfree(pdata.channel_head.tx_ring);
    pdata.channel_head.tx_ring = core::ptr::null_mut();
    kfree(pdata.channel_head.rx_ring);
    pdata.channel_head.rx_ring = core::ptr::null_mut();
    kfree(pdata.channel_head);
    pdata.channel_head = core::ptr::null_mut();
    pdata.channel_count = 0;
    }
#[no_mangle]
unsafe extern "C" fn xlgmac_alloc_channels(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_free_channels_and_rings(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_alloc_channels_and_rings(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_tx_desc_init(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_rx_desc_init(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
pub unsafe extern "C" fn xlgmac_init_desc_ops(desc_ops: *mut xlgmac_desc_ops) {
