...
//! Source: drivers/net/ethernet/synopsys/dwc-xlgmac-hw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn xlgmac_tx_complete(dma_desc: *mut xlgmac_dma_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_disable_rx_csum(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_enable_rx_csum(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_set_mac_address(pdata: *mut xlgmac_pdata, addr: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_enable_rx_vlan_stripping(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_disable_rx_vlan_stripping(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_enable_rx_vlan_filtering(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_disable_rx_vlan_filtering(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_vid_crc32_le(vid_le: __le16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_update_vlan_hash_table(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_set_mac_addn_addrs(pdata: *mut xlgmac_pdata) {
...
// Clear remaining additional MAC address entries
    while (addn_macs--)
    xlgmac_set_mac_reg(pdata, core::ptr::null_mut(), &mac_reg);
    }
#[no_mangle]
unsafe extern "C" fn xlgmac_set_mac_hash_table(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_add_mac_addresses(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_mac_address(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_jumbo_enable(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_checksum_offload(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_vlan_support(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_rx_mode(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_enable_tx(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_disable_tx(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_enable_rx(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_disable_rx(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_dev_xmit(channel: *mut xlgmac_channel) {
...
//
    ...
    tx_set_ic = 0;
#[no_mangle]
pub unsafe extern "C" fn if(pdata->tx_frames: pkt_info->tx_packets >) -> else {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_tx_desc_reset(desc_data: *mut xlgmac_desc_data) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_tx_desc_init(channel: *mut xlgmac_channel) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_rx_desc_init(channel: *mut xlgmac_channel) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_is_context_desc(dma_desc: *mut xlgmac_dma_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_is_last_desc(dma_desc: *mut xlgmac_dma_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_disable_tx_flow_control(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_enable_tx_flow_control(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_disable_rx_flow_control(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_enable_rx_flow_control(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_tx_flow_control(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_rx_flow_control(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_rx_coalesce(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_flow_control(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_rx_fep_enable(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_rx_fup_enable(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_tx_coalesce(pdata: *mut xlgmac_pdata) -> c_int {
    static int xlgmac_config_tx_coalesce(struct xlgmac_pdata *pdata)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn xlgmac_config_rx_buffer_size(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_tso_mode(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_sph_mode(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_mtl_mode(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_queue_mapping(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_tx_fifo_size(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_rx_fifo_size(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_flow_control_threshold(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_osp_mode(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_pblx8(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_get_tx_pbl_val(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_tx_pbl_val(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_get_rx_pbl_val(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_rx_pbl_val(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_mmc_read(pdata: *mut xlgmac_pdata, reg_lo: c_uint) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_tx_mmc_int(pdata: *mut xlgmac_pdata) {
    static void xlgmac_tx_mmc_int(struct xlgmac_pdata *pdata)
    {
    let mut mmc_isr: c_uint = readl(pdata.mac_regs + MMC_TISR);
...
#[no_mangle]
unsafe extern "C" fn xlgmac_rx_mmc_int(pdata: *mut xlgmac_pdata) {
    static void xlgmac_rx_mmc_int(struct xlgmac_pdata *pdata)
    {
    let mut mmc_isr: c_uint = readl(pdata.mac_regs + MMC_RISR);
    struct xlgmac_stats *stats = &pdata.stats;
    if (XLGMAC_GET_REG_BITS(mmc_isr,
...
#[no_mangle]
unsafe extern "C" fn xlgmac_read_mmc_stats(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_mmc(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_write_rss_hash_key(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_write_rss_lookup_table(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_set_rss_hash_key(pdata: *mut xlgmac_pdata, key: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_enable_rss(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_disable_rss(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_rss(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_enable_dma_interrupts(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_enable_mtl_interrupts(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_enable_mac_interrupts(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_set_xlgmii_25000_speed(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_set_xlgmii_40000_speed(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_set_xlgmii_50000_speed(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_set_xlgmii_100000_speed(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_mac_speed(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_dev_read(channel: *mut xlgmac_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_flush_tx_queues(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_config_dma_bus(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_hw_init(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_hw_exit(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xlgmac_init_hw_ops(hw_ops: *mut xlgmac_hw_ops) {
