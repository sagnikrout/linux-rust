...
//! Source: drivers/net/ethernet/synopsys/dwc-xlgmac-net.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn xlgmac_tx_avail_desc(ring: *mut xlgmac_ring) -> c_uint {
    static inline unsigned int xlgmac_tx_avail_desc(struct xlgmac_ring *ring)
    {
    return (ring.dma_desc_count - (ring.cur - ring.dirty));
    }
#[no_mangle]
pub unsafe extern "C" fn xlgmac_rx_dirty_desc(ring: *mut xlgmac_ring) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_is_tso(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_calc_rx_buf_size(netdev: *mut net_device, mtu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_enable_rx_tx_ints(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_disable_rx_tx_ints(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_dma_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_tx_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_init_timers(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_stop_timers(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_napi_enable(pdata: *mut xlgmac_pdata, add: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_napi_disable(pdata: *mut xlgmac_pdata, del: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_request_irqs(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_free_irqs(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_free_tx_data(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_free_rx_data(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_start(pdata: *mut xlgmac_pdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_stop(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_restart_dev(pdata: *mut xlgmac_pdata) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_restart(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_xmit(skb: *mut sk_buff, netdev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_set_mac_address(netdev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_change_mtu(netdev: *mut net_device, mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_poll_controller(netdev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(rxcsum: !(features & NETIF_F_RXCSUM) &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_set_rx_mode(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_rx_refresh(channel: *mut xlgmac_channel) {
...
// Add the remaining data as a frag
    ...
    desc_data.rx.buf.pa.pages = core::ptr::null_mut();
    }
    return skb;
    }
#[no_mangle]
unsafe extern "C" fn xlgmac_tx_poll(channel: *mut xlgmac_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_rx_poll(channel: *mut xlgmac_channel, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_one_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlgmac_all_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
