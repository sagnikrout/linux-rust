...
//! Source: drivers/net/ethernet/atheros/ag71xx.c
#![no_std]
...
//
pub const AG71XX_NAPI_WEIGHT: c_int = 32;

pub const AG71XX_TX_MTU_LEN: c_int = 1540;
pub const AG71XX_TX_RING_SPLIT: c_int = 512;

    AG71XX_TX_RING_SPLIT)
pub const AG71XX_TX_RING_SIZE_DEFAULT: c_int = 128;
pub const AG71XX_RX_RING_SIZE_DEFAULT: c_int = 256;
pub const AG71XX_MDIO_RETRY: c_int = 1000;
pub const AG71XX_MDIO_DELAY: c_int = 5;
pub const AG71XX_MDIO_MAX_CLK: c_int = 5000000;
// Register offsets
pub const AG71XX_REG_MAC_CFG1: c_uint = 0x0000;

    MAC_CFG1_SRX | MAC_CFG1_STX)
pub const AG71XX_REG_MAC_CFG2: c_uint = 0x0004;

pub const AG71XX_REG_MAC_MFL: c_uint = 0x0010;
pub const AG71XX_REG_MII_CFG: c_uint = 0x0020;
pub const MII_CFG_CLK_DIV_4: c_int = 0;
pub const MII_CFG_CLK_DIV_6: c_int = 2;
pub const MII_CFG_CLK_DIV_8: c_int = 3;
pub const MII_CFG_CLK_DIV_10: c_int = 4;
pub const MII_CFG_CLK_DIV_14: c_int = 5;
pub const MII_CFG_CLK_DIV_20: c_int = 6;
pub const MII_CFG_CLK_DIV_28: c_int = 7;
pub const MII_CFG_CLK_DIV_34: c_int = 8;
pub const MII_CFG_CLK_DIV_42: c_int = 9;
pub const MII_CFG_CLK_DIV_50: c_int = 10;
pub const MII_CFG_CLK_DIV_58: c_int = 11;
pub const MII_CFG_CLK_DIV_66: c_int = 12;
pub const MII_CFG_CLK_DIV_74: c_int = 13;
pub const MII_CFG_CLK_DIV_82: c_int = 14;
pub const MII_CFG_CLK_DIV_98: c_int = 15;

pub const AG71XX_REG_MII_CMD: c_uint = 0x0024;

pub const AG71XX_REG_MII_ADDR: c_uint = 0x0028;
pub const MII_ADDR_SHIFT: c_int = 8;
pub const AG71XX_REG_MII_CTRL: c_uint = 0x002c;
pub const AG71XX_REG_MII_STATUS: c_uint = 0x0030;
pub const AG71XX_REG_MII_IND: c_uint = 0x0034;

pub const AG71XX_REG_MAC_IFCTL: c_uint = 0x0038;

pub const AG71XX_REG_MAC_ADDR1: c_uint = 0x0040;
pub const AG71XX_REG_MAC_ADDR2: c_uint = 0x0044;
pub const AG71XX_REG_FIFO_CFG0: c_uint = 0x0048;

    | FIFO_CFG0_TXS | FIFO_CFG0_TXF)

pub const FIFO_CFG0_ENABLE_SHIFT: c_int = 8;
pub const AG71XX_REG_FIFO_CFG1: c_uint = 0x004c;
pub const AG71XX_REG_FIFO_CFG2: c_uint = 0x0050;
pub const AG71XX_REG_FIFO_CFG3: c_uint = 0x0054;
pub const AG71XX_REG_FIFO_CFG4: c_uint = 0x0058;
    ...
    FIFO_CFG4_VT)
pub const AG71XX_REG_FIFO_CFG5: c_uint = 0x005c;
...
pub const AG71XX_REG_TX_CTRL: c_uint = 0x0180;

pub const AG71XX_REG_TX_DESC: c_uint = 0x0184;
pub const AG71XX_REG_TX_STATUS: c_uint = 0x0188;

pub const AG71XX_REG_RX_CTRL: c_uint = 0x018c;

pub const AG71XX_DMA_RETRY: c_int = 10;
pub const AG71XX_DMA_DELAY: c_int = 1;
pub const AG71XX_REG_RX_DESC: c_uint = 0x0190;
pub const AG71XX_REG_RX_STATUS: c_uint = 0x0194;

pub const AG71XX_REG_INT_ENABLE: c_uint = 0x0198;
pub const AG71XX_REG_INT_STATUS: c_uint = 0x019c;

pub const AG71XX_REG_FIFO_DEPTH: c_uint = 0x01a8;
pub const AG71XX_REG_RX_SM: c_uint = 0x01b0;
pub const AG71XX_REG_TX_SM: c_uint = 0x01b4;
...
pub const DESC_PKTLEN_M: c_uint = 0xfff;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ag71xx_desc {
    pub data: u32,
    pub ctrl: u32,
    pub next: u32,
    pub pad: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ag71xx_ring {
// "Hot" fields in the data path.
    pub curr: c_uint,
    pub dirty: c_uint,
// "Cold" fields - not used in the data path.
    pub buf: *mut ag71xx_buf,
    pub order: u16,
    pub desc_split: u16,
    pub descs_dma: dma_addr_t,
    pub descs_cpu: *mut u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ag71xx_dcfg {
    pub max_frame_len: u32,
    pub fifodata: *const u32,
    pub desc_pktlen_mask: u16,
    pub tx_hang_workaround: bool,
    pub type: enum ag71xx_type,
}
...
//
    pub ____cacheline_aligned: ag71xx_ring rx_ring,
    pub ____cacheline_aligned: ag71xx_ring tx_ring,
    pub rx_buf_size: u16,
    pub rx_buf_offset: u8,
    pub ndev: *mut net_device,
    pub pdev: *mut platform_device,
    pub napi: napi_struct,
    pub msg_enable: u32,
    pub dcfg: *const ag71xx_dcfg,
// From this point onwards we're not looking at per-packet fields.
    pub mac_base: *mut void __iomem,
    pub stop_desc: *mut ag71xx_desc,
    pub stop_desc_dma: dma_addr_t,
    pub phy_if_mode: phy_interface_t,
    pub phylink: *mut phylink,
    pub phylink_config: phylink_config,
    pub restart_work: delayed_work,
    pub oom_timer: timer_list,
    pub mac_reset: *mut reset_control,
    pub fifodata: [u32; 3],
    pub mac_idx: c_int,
    pub clk_mdio: *mut clk,
}

#[no_mangle]
unsafe extern "C" fn ag71xx_desc_empty(desc: *mut ag71xx_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_ring_size_order(size: c_int) -> c_int {
    static int ag71xx_ring_size_order(int size)
    {
    return fls(size - 1);
    }
#[no_mangle]
unsafe extern "C" fn ag71xx_is(ag: *mut ag71xx, type: enum ag71xx_type) -> bool {
    static bool ag71xx_is(struct ag71xx *ag, enum ag71xx_type type)
    {
    return ag.dcfg.type == type;
    }
#[no_mangle]
unsafe extern "C" fn ag71xx_wr(ag: *mut ag71xx, reg: c_uint, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_rr(ag: *mut ag71xx, reg: c_uint) -> u32 {
    static u32 ag71xx_rr(struct ag71xx *ag, unsigned int reg)
    {
    return ioread32(ag.mac_base + reg);
    }
#[no_mangle]
unsafe extern "C" fn ag71xx_sb(ag: *mut ag71xx, reg: c_uint, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_cb(ag: *mut ag71xx, reg: c_uint, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_int_enable(ag: *mut ag71xx, ints: u32) {
    static void ag71xx_int_enable(struct ag71xx *ag, u32 ints)
    {
    ag71xx_sb(ag, AG71XX_REG_INT_ENABLE, ints);
    }
#[no_mangle]
unsafe extern "C" fn ag71xx_int_disable(ag: *mut ag71xx, ints: u32) {
    static void ag71xx_int_disable(struct ag71xx *ag, u32 ints)
    {
    ag71xx_cb(ag, AG71XX_REG_INT_ENABLE, ints);
    }
#[no_mangle]
unsafe extern "C" fn ag71xx_do_ioctl(ndev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_ethtool_nway_reset(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_ethtool_get_sset_count(ndev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_mdio_wait_busy(ag: *mut ag71xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_mdio_mii_read(bus: *mut mii_bus, addr: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_mdio_get_divider(ag: *mut ag71xx, div: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_mdio_reset(bus: *mut mii_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_mdio_probe(ag: *mut ag71xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_hw_stop(ag: *mut ag71xx) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_check_dma_stuck(ag: *mut ag71xx) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_tx_packets(ag: *mut ag71xx, flush: bool, budget: c_int) -> c_int {
    static int ag71xx_tx_packets(struct ag71xx *ag, bool flush, int budget)
    {
    struct ag71xx_ring *ring = &ag.tx_ring;
    let mut sent: c_int = 0, bytes_compl = 0, n = 0;
    struct net_device *ndev = ag.ndev;
    int ring_mask, ring_size;
    let mut dma_stuck: bool = false;
    ...
    ring.buf[i].tx.skb = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ag71xx_dma_wait_stop(ag: *mut ag71xx) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_dma_reset(ag: *mut ag71xx) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_hw_setup(ag: *mut ag71xx) {
    static void ag71xx_hw_setup(struct ag71xx *ag)
    {
    let mut init: u32 = MAC_CFG1_INIT;
...
#[no_mangle]
unsafe extern "C" fn ag71xx_max_frame_len(mtu: c_uint) -> c_uint {
    static unsigned int ag71xx_max_frame_len(unsigned int mtu)
    {
    return ETH_HLEN + VLAN_HLEN + mtu + ETH_FCS_LEN;
    }
#[no_mangle]
unsafe extern "C" fn ag71xx_hw_set_macaddr(ag: *mut ag71xx, mac: *const c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_fast_reset(ag: *mut ag71xx) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_hw_start(ag: *mut ag71xx) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_phylink_setup(ag: *mut ag71xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_ring_tx_clean(ag: *mut ag71xx) {
    static void ag71xx_ring_tx_clean(struct ag71xx *ag)
    {
    struct ag71xx_ring *ring = &ag.tx_ring;
    let mut ring_mask: c_int = BIT(ring.order) - 1;
    let mut bytes_compl: u32 = 0, pkts_compl = 0;
    struct net_device *ndev = ag.ndev;
    while (ring.curr != ring.dirty) {
    struct ag71xx_desc *desc;
    let mut i: u32 = ring.dirty & ring_mask;
    desc = ag71xx_ring_desc(ring, i);
...
#[no_mangle]
unsafe extern "C" fn ag71xx_ring_tx_init(ag: *mut ag71xx) {
    static void ag71xx_ring_tx_init(struct ag71xx *ag)
    {
    struct ag71xx_ring *ring = &ag.tx_ring;
    let mut ring_size: c_int = BIT(ring.order);
    let mut ring_mask: c_int = ring_size - 1;
    int i;
...
#[no_mangle]
unsafe extern "C" fn ag71xx_ring_rx_clean(ag: *mut ag71xx) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_buffer_size(ag: *mut ag71xx) -> c_int {
    ...
    skb_free_frag(data);
    buf.rx.rx_buf = core::ptr::null_mut();
    return false;
    }
...
#[no_mangle]
unsafe extern "C" fn ag71xx_ring_rx_init(ag: *mut ag71xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_ring_rx_refill(ag: *mut ag71xx) -> c_int {
    static int ag71xx_ring_rx_refill(struct ag71xx *ag)
    {
    struct ag71xx_ring *ring = &ag.rx_ring;
    let mut ring_mask: c_int = BIT(ring.order) - 1;
    let mut offset: c_int = ag.rx_buf_offset;
    unsigned int count;
    count = 0;
...
#[no_mangle]
unsafe extern "C" fn ag71xx_rings_init(ag: *mut ag71xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_rings_free(ag: *mut ag71xx) {
    ...
    kfree(tx.buf);
    tx.descs_cpu = core::ptr::null_mut();
    rx.descs_cpu = core::ptr::null_mut();
    tx.buf = core::ptr::null_mut();
    rx.buf = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ag71xx_rings_cleanup(ag: *mut ag71xx) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_hw_init(ag: *mut ag71xx) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_hw_enable(ag: *mut ag71xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_hw_disable(ag: *mut ag71xx) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_stop(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_fill_dma_desc(ring: *mut ag71xx_ring, addr: u32, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_oom_timer_handler(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_tx_timeout(ndev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_restart_work_func(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_rx_packets(ag: *mut ag71xx, limit: c_int) -> c_int {
    ...
    while (done < limit) {
    let mut i: c_uint = ring.curr & ring_mask;
    struct ag71xx_desc *desc = ag71xx_ring_desc(ring, i);
    int pktlen;
    if (ag71xx_desc_empty(desc))
    break;
    ...
    next:
    ring.buf[i].rx.rx_buf = core::ptr::null_mut();
    done++;
    ring.curr++;
    }
...
#[no_mangle]
unsafe extern "C" fn ag71xx_poll(napi: *mut napi_struct, limit: c_int) -> c_int {
    static int ag71xx_poll(struct napi_struct *napi, int limit)
    {
    struct ag71xx *ag = container_of(napi, struct ag71xx, napi);
    struct ag71xx_ring *rx_ring = &ag.rx_ring;
    let mut rx_ring_size: c_int = BIT(rx_ring.order);
    struct net_device *ndev = ag.ndev;
    int tx_done, rx_done;
    u32 status;
...
#[no_mangle]
unsafe extern "C" fn ag71xx_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_change_mtu(ndev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ag71xx_probe(pdev: *mut platform_device) -> c_int {
