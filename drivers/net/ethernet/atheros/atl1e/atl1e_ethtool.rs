...
//! Source: drivers/net/ethernet/atheros/atl1e/atl1e_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn atl1e_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn atl1e_get_regs_len(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atl1e_get_eeprom_len(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atl1e_set_wol(netdev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atl1e_nway_reset(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn atl1e_set_ethtool_ops(netdev: *mut net_device) {
