...
//! Source: drivers/net/ethernet/atheros/atl1e/atl1e_main.c
#![no_std]
...
pub const PCI_DEVICE_ID_ATTANSIC_L1E: c_uint = 0x1026;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn atl1e_irq_enable(adapter: *mut atl1e_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn atl1e_irq_disable(adapter: *mut atl1e_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn atl1e_irq_reset(adapter: *mut atl1e_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_phy_config(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn atl1e_reinit_locked(adapter: *mut atl1e_adapter) {
...
#[no_mangle]
unsafe extern "C" fn atl1e_reset_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn atl1e_check_link(adapter: *mut atl1e_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_link_chg_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn atl1e_link_chg_event(adapter: *mut atl1e_adapter) {
    static void atl1e_link_chg_event(struct atl1e_adapter *adapter)
    {
    struct net_device *netdev = adapter.netdev;
    let mut phy_data: u16 = 0;
    let mut link_up: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn atl1e_del_timer(adapter: *mut atl1e_adapter) {
    static void atl1e_del_timer(struct atl1e_adapter *adapter)
    {
    timer_delete_sync(&adapter.phy_config_timer);
    }
#[no_mangle]
unsafe extern "C" fn atl1e_cancel_work(adapter: *mut atl1e_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_set_multi(netdev: *mut net_device) {
    static void atl1e_set_multi(struct net_device *netdev)
    {
    struct atl1e_adapter *adapter = netdev_priv(netdev);
    struct atl1e_hw *hw = &adapter.hw;
    struct netdev_hw_addr *ha;
    let mut mac_ctrl_data: u32 = 0;
    u32 hash_value;
...
#[no_mangle]
unsafe extern "C" fn __atl1e_rx_mode(features: netdev_features_t, mac_ctrl_data: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn __atl1e_vlan_mode(features: netdev_features_t, mac_ctrl_data: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn atl1e_restore_vlan(adapter: *mut atl1e_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_set_mac_addr(netdev: *mut net_device, p: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_mdio_read(netdev: *mut net_device, phy_id: c_int, reg_num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atl1e_ioctl(netdev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atl1e_setup_pcicmd(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_alloc_queues(adapter: *mut atl1e_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_sw_init(adapter: *mut atl1e_adapter) -> c_int {
    static int atl1e_sw_init(struct atl1e_adapter *adapter)
    {
    struct atl1e_hw *hw   = &adapter.hw;
    struct pci_dev	*pdev = adapter.pdev;
    let mut phy_status_data: u32 = 0;
    adapter.wol = 0;
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_clean_tx_ring(adapter: *mut atl1e_adapter) {
    static void atl1e_clean_tx_ring(struct atl1e_adapter *adapter)
    {
    struct atl1e_tx_ring *tx_ring = &adapter.tx_ring;
    struct atl1e_tx_buffer *tx_buffer = core::ptr::null_mut();
    struct pci_dev *pdev = adapter.pdev;
    u16 index, ring_count;
    if (tx_ring.desc == core::ptr::null_mut() || tx_ring.tx_buffer == core::ptr::null_mut())
    return;
...
// first unmmap dma
    ...
    DMA_TO_DEVICE);
#[no_mangle]
pub unsafe extern "C" fn if(ATL1E_TX_PCIMAP_PAGE: tx_buffer->flags &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_clean_rx_ring(adapter: *mut atl1e_adapter) {
    ...
    u16 i, j;
    if (adapter.ring_vir_addr == core::ptr::null_mut())
    return;
// Zero out the descriptor ring
    for (i = 0; i < adapter.num_rx_queues; i++) {
    for (j = 0; j < AT_PAGE_NUM_PER_QUEUE; j++) {
    if (rx_page_desc[i].rx_page[j].addr != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn atl1e_cal_ring_size(adapter: *mut atl1e_adapter, ring_size: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn atl1e_init_ring_resources(adapter: *mut atl1e_adapter) {
    static void atl1e_init_ring_resources(struct atl1e_adapter *adapter)
    {
    struct atl1e_rx_ring *rx_ring = core::ptr::null_mut();
    ...
    adapter.ring_vir_addr = core::ptr::null_mut();
    adapter.rx_ring.desc = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_init_ring_ptrs(adapter: *mut atl1e_adapter) {
    static void atl1e_init_ring_ptrs(struct atl1e_adapter *adapter)
    {
    struct atl1e_tx_ring *tx_ring = core::ptr::null_mut();
    struct atl1e_rx_ring *rx_ring = core::ptr::null_mut();
    struct atl1e_rx_page_desc *rx_page_desc = core::ptr::null_mut();
    int i, j;
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_free_ring_resources(adapter: *mut atl1e_adapter) {
    ...
    adapter.tx_ring.tx_buffer = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_setup_ring_resources(adapter: *mut atl1e_adapter) -> c_int {
...
// Init TPD Ring
    ...
    if (tx_ring.tx_buffer == core::ptr::null_mut()) {
    err = -ENOMEM;
    goto failed;
    }
// Init RXF-Pages
...
// Init CMB dma address
    ...
    tx_ring.tx_buffer = core::ptr::null_mut();
    failed:
    if (adapter.ring_vir_addr != core::ptr::null_mut()) {
    dma_free_coherent(&pdev.dev, adapter.ring_size,
    adapter.ring_vir_addr, adapter.ring_dma);
...
#[no_mangle]
pub unsafe extern "C" fn atl1e_configure_des_ring(adapter: *mut atl1e_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn atl1e_configure_tx(adapter: *mut atl1e_adapter) {
    static inline void atl1e_configure_tx(struct atl1e_adapter *adapter)
    {
    struct atl1e_hw *hw = &adapter.hw;
    let mut dev_ctrl_data: u32 = 0;
    let mut max_pay_load: u32 = 0;
    let mut jumbo_thresh: u32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn atl1e_configure_rx(adapter: *mut atl1e_adapter) {
    static inline void atl1e_configure_rx(struct atl1e_adapter *adapter)
    {
    struct atl1e_hw *hw = &adapter.hw;
    let mut rxf_len: u32 = 0;
    let mut rxf_low: u32 = 0;
    let mut rxf_high: u32 = 0;
    let mut rxf_thresh_data: u32 = 0;
    let mut rxq_ctrl_data: u32 = 0;
    if (hw.nic_type != athr_l2e_revB) {
...
#[no_mangle]
pub unsafe extern "C" fn atl1e_configure_dma(adapter: *mut atl1e_adapter) {
    static inline void atl1e_configure_dma(struct atl1e_adapter *adapter)
    {
    struct atl1e_hw *hw = &adapter.hw;
    let mut dma_ctrl_data: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn atl1e_setup_mac_ctrl(adapter: *mut atl1e_adapter) {
    static void atl1e_setup_mac_ctrl(struct atl1e_adapter *adapter)
    {
    u32 value;
    struct atl1e_hw *hw = &adapter.hw;
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_configure(adapter: *mut atl1e_adapter) -> c_int {
    static int atl1e_configure(struct atl1e_adapter *adapter)
    {
    struct atl1e_hw *hw = &adapter.hw;
    let mut intr_status_data: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn atl1e_update_hw_stats(adapter: *mut atl1e_adapter) {
    static void atl1e_update_hw_stats(struct atl1e_adapter *adapter)
    {
    let mut hw_reg_addr: u16 = 0;
    unsigned long *stats_item = core::ptr::null_mut();
// update rx status
...
#[no_mangle]
pub unsafe extern "C" fn atl1e_clear_phy_int(adapter: *mut atl1e_adapter) {
...
#[no_mangle]
unsafe extern "C" fn atl1e_clean_tx_irq(adapter: *mut atl1e_adapter) -> bool {
    static bool atl1e_clean_tx_irq(struct atl1e_adapter *adapter)
    {
    struct atl1e_tx_ring *tx_ring = &adapter.tx_ring;
    struct atl1e_tx_buffer *tx_buffer = core::ptr::null_mut();
    let mut hw_next_to_clean: u16 = AT_READ_REGW(&adapter.hw, REG_TPD_CONS_IDX);
    let mut next_to_clean: u16 = atomic_read(&tx_ring.next_to_clean);
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t atl1e_intr(int irq, void *data)
    {
    struct net_device *netdev  = data;
    struct atl1e_adapter *adapter = netdev_priv(netdev);
    struct atl1e_hw *hw = &adapter.hw;
    let mut max_ints: c_int = AT_MAX_INT_WORK;
...
// re-enable Interrupt
    ...
    let mut rx_using: u8 = rx_page_desc[que].rx_using;
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_clean(napi: *mut napi_struct, budget: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_netpoll(netdev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn atl1e_tpd_avail(adapter: *mut atl1e_adapter) -> u16 {
    static inline u16 atl1e_tpd_avail(struct atl1e_adapter *adapter)
    {
    struct atl1e_tx_ring *tx_ring = &adapter.tx_ring;
    let mut next_to_use: u16 = 0;
    let mut next_to_clean: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn atl1e_cal_tdp_req(skb: *const sk_buff) -> u16 {
    static u16 atl1e_cal_tdp_req(const struct sk_buff *skb)
    {
    let mut i: c_int = 0;
    let mut tpd_req: u16 = 1;
    let mut fg_size: u16 = 0;
    let mut proto_hdr_len: u16 = 0;
...
// only xsum need
    ...
    struct sk_buff *skb, struct atl1e_tpd_desc *tpd)
    {
    struct atl1e_tpd_desc *use_tpd = core::ptr::null_mut();
    struct atl1e_tx_buffer *tx_buffer = core::ptr::null_mut();
    let mut buf_len: u16 = skb_headlen(skb);
    let mut map_len: u16 = 0;
    let mut mapped_len: u16 = 0;
    let mut hdr_len: u16 = 0;
    u16 nr_frags;
    u16 f;
    int segment;
    let mut ring_start: c_int = adapter.tx_ring.next_to_use;
    int ring_end;
...
// no enough descriptor, just stop queue
    ...
    let mut vlan_tag: u16 = skb_vlan_tag_get(skb);
    u16 atl1e_vlan_tag;
...
#[no_mangle]
unsafe extern "C" fn atl1e_free_irq(adapter: *mut atl1e_adapter) {
...
#[no_mangle]
unsafe extern "C" fn atl1e_request_irq(adapter: *mut atl1e_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn atl1e_up(adapter: *mut atl1e_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn atl1e_down(adapter: *mut atl1e_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_open(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atl1e_suspend(pdev: *mut pci_dev, state: pm_message_t) -> c_int {
    ...
    let mut ctrl: u32 = 0;
    let mut mac_ctrl_data: u32 = 0;
    let mut wol_ctrl_data: u32 = 0;
    let mut mii_advertise_data: u16 = 0;
    let mut mii_bmsr_data: u16 = 0;
    let mut mii_intr_status_data: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn atl1e_resume(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atl1e_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn atl1e_init_netdev(netdev: *mut net_device, pdev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
    static int atl1e_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
    {
    struct net_device *netdev;
    struct atl1e_adapter *adapter = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_remove(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_io_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
//
#[no_mangle]
unsafe extern "C" fn atl1e_io_resume(pdev: *mut pci_dev) {
