...
//! Source: drivers/net/ethernet/atheros/atl1c/atl1c_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn atl1c_pcie_patch(hw: *mut atl1c_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_reset_pcie(hw: *mut atl1c_hw, flag: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn atl1c_irq_enable(adapter: *mut atl1c_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn atl1c_irq_disable(adapter: *mut atl1c_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_wait_until_idle(hw: *mut atl1c_hw, modu_ctrl: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_phy_config(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn atl1c_reinit_locked(adapter: *mut atl1c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn atl1c_check_link_status(adapter: *mut atl1c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn atl1c_link_chg_event(adapter: *mut atl1c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn atl1c_common_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn atl1c_del_timer(adapter: *mut atl1c_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_set_multi(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn __atl1c_vlan_mode(features: netdev_features_t, mac_ctrl_data: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn atl1c_restore_vlan(adapter: *mut atl1c_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_set_mac_addr(netdev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atl1c_set_max_mtu(netdev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_mdio_read(netdev: *mut net_device, phy_id: c_int, reg_num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atl1c_ioctl(netdev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_alloc_queues(adapter: *mut atl1c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atl1c_setup_mac_funcs(hw: *mut atl1c_hw) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atl1c_platform_patch {
    pub pci_did: u16,
    pub pci_revid: u8,
    pub subsystem_vid: u16,
    pub subsystem_did: u16,
    pub patch_flag: u32,
pub const ATL1C_LINK_PATCH: c_uint = 0x1;
}
...
#[no_mangle]
unsafe extern "C" fn atl1c_patch_assign(hw: *mut atl1c_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_sw_init(adapter: *mut atl1c_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(ATL1C_PCIMAP_PAGE: buffer_info->flags &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_clean_rx_ring(adapter: *mut atl1c_adapter, queue: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_init_ring_ptrs(adapter: *mut atl1c_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_free_ring_resources(adapter: *mut atl1c_adapter) {
    static void atl1c_free_ring_resources(struct atl1c_adapter *adapter)
    {
    struct pci_dev *pdev = adapter.pdev;
    dma_free_coherent(&pdev.dev, adapter.ring_header.size,
    adapter.ring_header.desc, adapter.ring_header.dma);
    adapter.ring_header.desc = core::ptr::null_mut();
// Note: just free tdp_ring.buffer_info,
// it contain rfd_ring.buffer_info, do not double free
//
    if (adapter.tpd_ring[0].buffer_info) {
    kfree(adapter.tpd_ring[0].buffer_info);
    adapter.tpd_ring[0].buffer_info = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_setup_ring_resources(adapter: *mut atl1c_adapter) -> c_int {
    ...
    let mut tqc: c_int = adapter.tx_queue_count;
    let mut rqc: c_int = adapter.rx_queue_count;
    int size;
    int i;
...
#[no_mangle]
unsafe extern "C" fn atl1c_configure_des_ring(adapter: *mut atl1c_adapter) {
    ...
    struct atl1c_tpd_ring *tpd_ring = adapter.tpd_ring;
    int i;
    let mut tx_queue_count: c_int = adapter.tx_queue_count;
    if (tx_queue_count == 1)
    tx_queue_count = 2;
// TPD
...
#[no_mangle]
unsafe extern "C" fn atl1c_configure_tx(adapter: *mut atl1c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn atl1c_configure_rx(adapter: *mut atl1c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn atl1c_configure_dma(adapter: *mut atl1c_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_stop_mac(hw: *mut atl1c_hw) -> c_int {
    static int atl1c_stop_mac(struct atl1c_hw *hw)
    {
    u32 data;
...
#[no_mangle]
unsafe extern "C" fn atl1c_start_mac(adapter: *mut atl1c_adapter) {
    static void atl1c_start_mac(struct atl1c_adapter *adapter)
    {
    struct atl1c_hw *hw = &adapter.hw;
    u32 mac, txq, rxq;
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_reset_mac(hw: *mut atl1c_hw) -> c_int {
    static int atl1c_reset_mac(struct atl1c_hw *hw)
    {
...
#[no_mangle]
unsafe extern "C" fn atl1c_disable_l0s_l1(hw: *mut atl1c_hw) {
    static void atl1c_disable_l0s_l1(struct atl1c_hw *hw)
    {
    let mut ctrl_flags: u16 = hw.ctrl_flags;
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_set_aspm(hw: *mut atl1c_hw, link_speed: u16) {
    static void atl1c_set_aspm(struct atl1c_hw *hw, u16 link_speed)
    {
    u32 pm_ctrl_data;
    u32 link_l1_timer;
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_configure_mac(adapter: *mut atl1c_adapter) -> c_int {
    static int atl1c_configure_mac(struct atl1c_adapter *adapter)
    {
    struct atl1c_hw *hw = &adapter.hw;
    let mut master_ctrl_data: u32 = 0;
    u32 intr_modrt_data;
    u32 data;
...
#[no_mangle]
unsafe extern "C" fn atl1c_configure(adapter: *mut atl1c_adapter) -> c_int {
    static int atl1c_configure(struct atl1c_adapter *adapter)
    {
    struct net_device *netdev = adapter.netdev;
    int num;
...
#[no_mangle]
unsafe extern "C" fn atl1c_update_hw_stats(adapter: *mut atl1c_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn atl1c_clear_phy_int(adapter: *mut atl1c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn atl1c_clean_tx(napi: *mut napi_struct, budget: c_int) -> c_int {
    ...
    struct atl1c_buffer *buffer_info;
    struct pci_dev *pdev = adapter.pdev;
    let mut next_to_clean: u16 = atomic_read(&tpd_ring.next_to_clean);
...
#[no_mangle]
unsafe extern "C" fn atl1c_intr_rx_tx(adapter: *mut atl1c_adapter, status: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
    ...
    struct sk_buff *skb;
    void *vir_addr = core::ptr::null_mut();
    let mut num_alloc: u16 = 0;
...
// the relationship between rrd and rfd is one map one
    ...
    for (i = 0; i < num; i++) {
    buffer_info[rfd_index].skb = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_clean_rx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_netpoll(netdev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn atl1c_tpd_avail(adapter: *mut atl1c_adapter, queue: u32) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn atl1c_cal_tpd_req(skb: *const sk_buff) -> u16 {
...
// only xsum need
    ...
    u32 queue)
    {
    struct atl1c_tpd_desc *use_tpd = core::ptr::null_mut();
    struct atl1c_buffer *buffer_info = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn atl1c_tx_queue(adapter: *mut atl1c_adapter, queue: u32) {
...
// do TSO and check sum
    ...
    let mut vlan: u16 = skb_vlan_tag_get(skb);
    __le16 tag;
...
#[no_mangle]
unsafe extern "C" fn atl1c_free_irq(adapter: *mut atl1c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn atl1c_request_irq(adapter: *mut atl1c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atl1c_reset_dma_ring(adapter: *mut atl1c_adapter) {
    static void atl1c_reset_dma_ring(struct atl1c_adapter *adapter)
    {
    int i;
...
#[no_mangle]
unsafe extern "C" fn atl1c_up(adapter: *mut atl1c_adapter) -> c_int {
    static int atl1c_up(struct atl1c_adapter *adapter)
    {
    struct net_device *netdev = adapter.netdev;
    int err;
...
#[no_mangle]
unsafe extern "C" fn atl1c_down(adapter: *mut atl1c_adapter) {
    static void atl1c_down(struct atl1c_adapter *adapter)
    {
    struct net_device *netdev = adapter.netdev;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_open(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atl1c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atl1c_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atl1c_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn atl1c_init_netdev(netdev: *mut net_device, pdev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_remove(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_io_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
//
#[no_mangle]
unsafe extern "C" fn atl1c_io_resume(pdev: *mut pci_dev) {
