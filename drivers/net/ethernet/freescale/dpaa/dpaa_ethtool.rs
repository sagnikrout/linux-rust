...
//! Source: drivers/net/ethernet/freescale/dpaa/dpaa_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dpaa_get_msglevel(net_dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn dpaa_nway_reset(net_dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpaa_get_sset_count(net_dev: *mut net_device, type: c_int) -> c_int {
    ...
    {
    let mut num_values: c_int = num_cpus + 1;
    let mut crr: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn dpaa_set_hash(net_dev: *mut net_device, enable: bool) {
...
// we support hashing on IPv4/v6 src/dest IP and L4 src/dest port
    ...
    struct device_node *fman_node = core::ptr::null_mut(), *ptp_node = core::ptr::null_mut();
    struct platform_device *ptp_dev = core::ptr::null_mut();
