...
//! Source: drivers/net/ethernet/freescale/fs_enet/fs_enet-main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fs_set_multicast_list(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn fs_eth_ioctl(dev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn skb_align(skb: *mut sk_buff, align: c_int) {
    static void skb_align(struct sk_buff *skb, int align)
    {
    let mut off: c_int = ((unsigned long)skb.data) & (align - 1);
    if (off)
    skb_reserve(skb, align - off);
    }
// NAPI function
#[no_mangle]
unsafe extern "C" fn fs_enet_napi(napi: *mut napi_struct, budget: c_int) -> c_int {
    ...
    let mut do_wake: c_int = 0, do_restart = 0;
    let mut tx_left: c_int = TX_RING_SIZE;
...
// Free the sk buffer associated with this last transmit.
    if (skb) {
    dev_kfree_skb(skb);
    fep.tx_skbuff[dirtyidx] = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn fs_init_bds(dev: *mut net_device) {
...
// if we failed, fillup remainder
    ...
    fep.rx_skbuff[i] = core::ptr::null_mut();
    CBDW_SC(bdp, (i < fep.rx_ring - 1) ? 0 : BD_SC_WRAP);
    }
// ...and the same for transmit.
    for (i = 0, bdp = fep.tx_bd_base; i < fep.tx_ring; i++, bdp++) {
    fep.tx_skbuff[i] = core::ptr::null_mut();
    CBDW_BUFADDR(bdp, 0);
    CBDW_DATLEN(bdp, 0);
...
#[no_mangle]
pub unsafe extern "C" fn fs_cleanup_bds(dev: *mut net_device) {
...
//
    ...
    DMA_TO_DEVICE));
    CBDW_DATLEN(bdp, len);
    fep.tx_skbuff[curidx] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fs_timeout_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn fs_timeout(dev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn fs_enet_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fs_enet_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fs_get_regs_len(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fs_get_msglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fs_set_msglevel(dev: *mut net_device, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn fs_enet_probe(ofdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fs_enet_remove(ofdev: *mut platform_device) {
    ...
    fep.ops.free_bd(ndev);
    fep.ops.cleanup_data(ndev);
    dev_set_drvdata(fep.dev, core::ptr::null_mut());
    phylink_destroy(fep.phylink);
    free_netdev(ndev);
    }
...
#[no_mangle]
unsafe extern "C" fn fs_enet_netpoll(dev: *mut net_device) {
    static void fs_enet_netpoll(struct net_device *dev)
    {
    disable_irq(dev.irq);
