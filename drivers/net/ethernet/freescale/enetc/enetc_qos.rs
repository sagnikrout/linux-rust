...
//! Source: drivers/net/ethernet/freescale/enetc/enetc_qos.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn enetc_get_max_gcl_len(hw: *mut enetc_hw) -> u16 {
    static u16 enetc_get_max_gcl_len(struct enetc_hw *hw)
    {
    return enetc_rd(hw, ENETC_PTGCAPR) & ENETC_PTGCAPR_MAX_GCL_LEN_MASK;
    }
#[no_mangle]
pub unsafe extern "C" fn enetc_sched_speed_set(priv: *mut enetc_ndev_priv, speed: c_int) {
...
#[no_mangle]
unsafe extern "C" fn enetc_reset_taprio_stats(priv: *mut enetc_ndev_priv) {
...
#[no_mangle]
unsafe extern "C" fn enetc_reset_taprio(priv: *mut enetc_ndev_priv) {
...
#[no_mangle]
unsafe extern "C" fn enetc_taprio_destroy(ndev: *mut net_device) {
    ...
    struct enetc_ndev_priv *priv = netdev_priv(ndev);
    let mut queue: c_int = queue_stats.queue;
...
#[no_mangle]
pub unsafe extern "C" fn enetc_setup_tc_taprio(ndev: *mut net_device, type_data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enetc_get_cbs_enable(hw: *mut enetc_hw, tc: u8) -> u32 {
    static u32 enetc_get_cbs_enable(struct enetc_hw *hw, u8 tc)
    {
    return enetc_port_rd(hw, ENETC_PTCCBSR0(tc)) & ENETC_CBSE;
    }
#[no_mangle]
unsafe extern "C" fn enetc_get_cbs_bw(hw: *mut enetc_hw, tc: u8) -> u8 {
    static u8 enetc_get_cbs_bw(struct enetc_hw *hw, u8 tc)
    {
    return enetc_port_rd(hw, ENETC_PTCCBSR0(tc)) & ENETC_CBS_BW_MASK;
    }
#[no_mangle]
pub unsafe extern "C" fn enetc_setup_tc_cbs(ndev: *mut net_device, type_data: *mut c_void) -> c_int {
    int enetc_setup_tc_cbs(struct net_device *ndev, void *type_data)
    {
    struct enetc_ndev_priv *priv = netdev_priv(ndev);
    struct tc_cbs_qopt_offload *cbs = type_data;
    let mut port_transmit_rate: u32 = priv.speed;
    let mut tc_nums: u8 = netdev_get_num_tc(ndev);
    struct enetc_hw *hw = &priv.si.hw;
    u32 hi_credit_bit, hi_credit_reg;
    u32 max_interference_size;
    u32 port_frame_max_size;
    let mut tc: u8 = cbs.queue;
    u8 prio_top, prio_next;
    let mut bw_sum: c_int = 0;
    u8 bw;
    prio_top = tc_nums - 1;
    prio_next = tc_nums - 2;
...
#[no_mangle]
pub unsafe extern "C" fn enetc_setup_tc_txtime(ndev: *mut net_device, type_data: *mut c_void) -> c_int {
...
pub const HANDLE_OFFSET: c_int = 100;
    enum forward_type {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct actions_fwd {
    pub actions: u64,
    pub /: *mut *mut u64 keys; / include the must needed keys,
    pub output: enum forward_type,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct psfp_streamfilter_counters {
    pub matching_frames_count: u64,
    pub passing_frames_count: u64,
    pub not_passing_frames_count: u64,
    pub passing_sdu_count: u64,
    pub not_passing_sdu_count: u64,
    pub red_frames_count: u64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct enetc_streamid {
    pub index: u32,
    union {
    pub src_mac: [u8; 6],
    pub dst_mac: [u8; 6],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct enetc_stream_filter {
    pub sid: enetc_streamid,
    pub sfi_index: u32,
    pub sgi_index: u32,
    pub flags: u32,
    pub fmi_index: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct enetc_psfp {
    pub dev_bitmap: c_ulong,
    pub psfp_sfi_bitmap: *mut c_ulong,
    pub stream_list: hlist_head,
    pub psfp_filter_list: hlist_head,
    pub psfp_gate_list: hlist_head,
    pub psfp_meter_list: hlist_head,
    pub /: *mut *mut spinlock_t psfp_lock; / spinlock for the struct enetc_psfp r/w,
}
...
// example for ACL actions
    ...
    .dev_bitmap = 0,
    .psfp_sfi_bitmap = core::ptr::null_mut(),
    };
...
#[no_mangle]
unsafe extern "C" fn get_ptp_now(hw: *mut enetc_hw) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn get_start_ns(now: u64, cycle: u64, start: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enetc_get_free_index(priv: *mut enetc_ndev_priv) -> c_int {
    static int enetc_get_free_index(struct enetc_ndev_priv *priv)
    {
    let mut max_size: u32 = priv.psfp_cap.max_psfp_filter;
    unsigned long index;
...
#[no_mangle]
unsafe extern "C" fn stream_filter_unref(priv: *mut enetc_ndev_priv, index: u32) {
...
#[no_mangle]
unsafe extern "C" fn stream_gate_unref(priv: *mut enetc_ndev_priv, index: u32) {
...
#[no_mangle]
unsafe extern "C" fn flow_meter_unref(priv: *mut enetc_ndev_priv, index: u32) {
    ...
    {
    struct flow_action_entry *entryg = core::ptr::null_mut(), *entryp = core::ptr::null_mut();
    struct flow_rule *rule = flow_cls_offload_flow_rule(f);
    struct netlink_ext_ack *extack = f.common.extack;
    struct enetc_stream_filter *filter, *old_filter;
    struct enetc_psfp_meter *fmi = core::ptr::null_mut(), *old_fmi;
    struct enetc_psfp_filter *sfi, *old_sfi;
    struct enetc_psfp_gate *sgi, *old_sgi;
    struct flow_action_entry *entry;
    struct action_gate_entry *e;
    let mut sfi_overwrite: u8 = 0;
    int i, err;
    ...
    entryg = entry;
#[no_mangle]
pub unsafe extern "C" fn if(FLOW_ACTION_POLICE: entry->id ==) -> else {
...
// Update the stream filter handle also
    ...
    sfi_overwrite ? core::ptr::null_mut() : sfi, sgi, fmi);
    if (err)
    goto free_fmi;
...
// Remove the old node if exist and update with a new node
    ...
    struct flow_cls_offload *f)
    {
    let mut counters: psfp_streamfilter_counters = {};
    struct enetc_stream_filter *filter;
    let mut stats: flow_stats = {};
    int err;
    filter = enetc_get_stream_by_index(f.common.chain_index);
    if (!filter)
    return -EINVAL;
...
#[no_mangle]
pub unsafe extern "C" fn clean_psfp_sfi_bitmap() {
    static inline void clean_psfp_sfi_bitmap(void)
    {
    bitmap_free(epsfp.psfp_sfi_bitmap);
    epsfp.psfp_sfi_bitmap = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn clean_stream_list() {
...
#[no_mangle]
unsafe extern "C" fn clean_sfi_list() {
...
#[no_mangle]
unsafe extern "C" fn clean_sgi_list() {
...
#[no_mangle]
unsafe extern "C" fn clean_psfp_all() {
...
#[no_mangle]
pub unsafe extern "C" fn enetc_set_psfp(ndev: *mut net_device, en: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn enetc_psfp_init(priv: *mut enetc_ndev_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn enetc_psfp_clean(priv: *mut enetc_ndev_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn enetc_setup_tc_psfp(ndev: *mut net_device, type_data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn enetc_qos_query_caps(ndev: *mut net_device, type_data: *mut c_void) -> c_int {
