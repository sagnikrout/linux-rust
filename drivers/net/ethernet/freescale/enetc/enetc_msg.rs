...
//! Source: drivers/net/ethernet/freescale/enetc/enetc_msg.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn enetc_msg_disable_mr_int(pf: *mut enetc_pf) {
...
#[no_mangle]
unsafe extern "C" fn enetc_msg_enable_mr_int(pf: *mut enetc_pf) {
...
#[no_mangle]
unsafe extern "C" fn enetc_msg_psi_msix(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// Messaging
#[no_mangle]
unsafe extern "C" fn enetc_msg_check_crc16(msg_addr: *mut c_void, msg_size: u32) -> bool {
    static bool enetc_msg_check_crc16(void *msg_addr, u32 msg_size)
    {
    let mut data_size: u32 = msg_size - 2;
...
#[no_mangle]
unsafe extern "C" fn enetc_msg_handle_ip_revision(pf: *mut enetc_pf, vf_msg: *mut c_void) -> u16 {
    ...
    let mut msg_size: u32 = ENETC_MSG_SIZE(msg_hdr.len);
    struct device *dev = &pf.si.pdev.dev;
    u8 *msg;
...
#[no_mangle]
unsafe extern "C" fn enetc_msg_task(work: *mut work_struct) {
    static void enetc_msg_task(struct work_struct *work)
    {
    struct enetc_pf *pf = container_of(work, struct enetc_pf, msg_task);
    let mut mr_mask: u32 = ENETC_PSIMR_MASK(pf.num_vfs);
    struct enetc_hw *hw = &pf.si.hw;
    u32 mr_status;
    int i;
...
// Init
#[no_mangle]
unsafe extern "C" fn enetc_msg_alloc_mbx(si: *mut enetc_si, idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enetc_msg_free_mbx(si: *mut enetc_si, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn enetc_msg_psi_init(pf: *mut enetc_pf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enetc_msg_psi_free(pf: *mut enetc_pf) {
...
#[no_mangle]
pub unsafe extern "C" fn enetc_sriov_configure(pdev: *mut pci_dev, num_vfs: c_int) -> c_int {
