...
//! Source: drivers/net/ethernet/freescale/enetc/enetc_cbdr.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn enetc_setup_cbdr(si: *mut enetc_si) -> c_int {
    int enetc_setup_cbdr(struct enetc_si *si)
    {
    let mut size: c_int = ENETC_CBDR_DEFAULT_SIZE * sizeof(struct enetc_cbd);
...
#[no_mangle]
pub unsafe extern "C" fn enetc_teardown_cbdr(si: *mut enetc_si) {
...
// disable ring
    ...
    cbdr.bd_dma_base);
    cbdr.bd_base = core::ptr::null_mut();
    cbdr.dma_dev = core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(enetc_teardown_cbdr);
#[no_mangle]
pub unsafe extern "C" fn enetc4_setup_cbdr(si: *mut enetc_si) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn enetc4_teardown_cbdr(si: *mut enetc_si) {
    void enetc4_teardown_cbdr(struct enetc_si *si)
    {
    struct ntmp_user *user = &si.ntmp_user;
    ntmp_free_cbdr(user.ring);
    user.dev = core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(enetc4_teardown_cbdr);
#[no_mangle]
unsafe extern "C" fn enetc_clean_cbdr(ring: *mut enetc_cbdr) {
...
#[no_mangle]
unsafe extern "C" fn enetc_cbd_unused(r: *mut enetc_cbdr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn enetc_send_cmd(si: *mut enetc_si, cbd: *mut enetc_cbd) -> c_int {
    int enetc_send_cmd(struct enetc_si *si, struct enetc_cbd *cbd)
    {
    struct enetc_cbdr *ring = &si.cbd_ring;
    let mut timeout: c_int = ENETC_CBDR_TIMEOUT;
    struct enetc_cbd *dest_cbd;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn enetc_clear_mac_flt_entry(si: *mut enetc_si, index: c_int) -> c_int {
...
// Get RSS table
#[no_mangle]
pub unsafe extern "C" fn enetc_get_rss_table(si: *mut enetc_si, table: *mut u32, count: c_int) -> c_int {
...
// Set RSS table
#[no_mangle]
pub unsafe extern "C" fn enetc_set_rss_table(si: *mut enetc_si, table: *const u32, count: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn enetc4_get_rss_table(si: *mut enetc_si, table: *mut u32, count: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn enetc4_set_rss_table(si: *mut enetc_si, table: *const u32, count: c_int) -> c_int {
