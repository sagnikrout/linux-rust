...
//! Source: drivers/net/ethernet/freescale/enetc/enetc_vf.c
#![no_std]
...
//
    ...
    let mut data_size: u32 = msg_swbd.size - 2;
    u16 crc16;
...
#[no_mangle]
unsafe extern "C" fn enetc_msg_dma_free(dev: *mut device, msg: *mut enetc_msg_swbd) {
    ...
    msg.vaddr = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn enetc_msg_vsi_send(si: *mut enetc_si, msg: *mut enetc_msg_swbd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enetc_vf_get_ip_minor_revision(si: *mut enetc_si) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enetc_vf_set_mac_addr(ndev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enetc_vf_get_revision(si: *mut enetc_si) {
...
#[no_mangle]
unsafe extern "C" fn enetc_vf_remove(pdev: *mut pci_dev) {
