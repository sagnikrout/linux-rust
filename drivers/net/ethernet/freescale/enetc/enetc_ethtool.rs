...
//! Source: drivers/net/ethernet/freescale/enetc/enetc_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn enetc_get_reglen(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enetc_get_sset_count(ndev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enetc_get_pf_strings(si: *mut enetc_si, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn enetc4_get_pf_strings(si: *mut enetc_si, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn enetc_get_strings(ndev: *mut net_device, stringset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn enetc_pf_get_ethtool_stats(si: *mut enetc_si, o: *mut c_int, data: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn enetc4_pf_get_ethtool_stats(si: *mut enetc_si, o: *mut c_int, data: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn ether_addr_copy_swap(dst: *mut u8, src: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn enetc_get_rx_ring_count(ndev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn enetc_set_rxnfc(ndev: *mut net_device, rxnfc: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enetc_get_rxfh_key_size(ndev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn enetc_get_rxfh_indir_size(ndev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn enetc_get_rss_key_base(si: *mut enetc_si) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enetc_get_rss_key(si: *mut enetc_si, key: *const u8) {
    static void enetc_get_rss_key(struct enetc_si *si, const u8 *key)
    {
    let mut base: c_int = enetc_get_rss_key_base(si);
    struct enetc_hw *hw = &si.hw;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn enetc_set_rss_key(si: *mut enetc_si, bytes: *const u8) {
...
// do some h/w sanity checks for BDR length
    ...
    struct enetc_hw *hw = &priv.si.hw;
    let mut val: u32 = enetc_rxbdr_rd(hw, 0, ENETC_RBLENR);
    ...
    let mut clk_freq: u64 = priv.sysclk_freq;
...
#[no_mangle]
unsafe extern "C" fn enetc_get_phc_index_by_pdev(si: *mut enetc_si) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enetc_get_phc_index(si: *mut enetc_si) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enetc_get_mm(ndev: *mut net_device, state: *mut ethtool_mm_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enetc_mm_wait_tx_active(hw: *mut enetc_hw, verify_time: c_int) -> c_int {
    static int enetc_mm_wait_tx_active(struct enetc_hw *hw, int verify_time)
    {
    let mut timeout: c_int = verify_time * USEC_PER_MSEC * ENETC_MM_VERIFY_RETRIES;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn enetc_set_ptcfpr(hw: *mut enetc_hw, preemptible_tcs: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn enetc_mm_commit_preemptible_tcs(priv: *mut enetc_ndev_priv) {
    void enetc_mm_commit_preemptible_tcs(struct enetc_ndev_priv *priv)
    {
    struct enetc_hw *hw = &priv.si.hw;
    let mut preemptible_tcs: u8 = 0;
    u32 val;
    int err;
    val = enetc_port_rd(hw, ENETC_MMCSR);
...
//
#[no_mangle]
unsafe extern "C" fn enetc_restart_emac_rx(si: *mut enetc_si) {
    static void enetc_restart_emac_rx(struct enetc_si *si)
    {
    let mut val: u32 = enetc_port_rd(&si.hw, ENETC_PM0_CMD_CFG);
...
//
#[no_mangle]
pub unsafe extern "C" fn enetc_mm_link_state_update(priv: *mut enetc_ndev_priv, link: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn enetc_set_ethtool_ops(ndev: *mut net_device) {
