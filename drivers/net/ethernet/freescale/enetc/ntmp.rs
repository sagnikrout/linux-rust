...
//! Source: drivers/net/ethernet/freescale/enetc/ntmp.c
#![no_std]
...
pub const NETC_CBDR_DELAY_US: c_int = 10;

pub const NTMP_BASE_ADDR_ALIGN: c_int = 128;
pub const NTMP_DATA_ADDR_ALIGN: c_int = 32;
// Define NTMP Table ID
pub const NTMP_MAFT_ID: c_int = 1;
pub const NTMP_RSST_ID: c_int = 3;
pub const NTMP_IPFT_ID: c_int = 13;
pub const NTMP_FDBT_ID: c_int = 15;
pub const NTMP_VFT_ID: c_int = 18;
pub const NTMP_ETT_ID: c_int = 33;
pub const NTMP_ECT_ID: c_int = 39;
pub const NTMP_BPT_ID: c_int = 41;
...
// ID are not returned.
//
pub const NTMP_QA_ENTRY_ID: c_int = 1;
pub const NTMP_ENTRY_ID_SIZE: c_int = 4;
pub const RSST_ENTRY_NUM: c_int = 64;

#[no_mangle]
pub unsafe extern "C" fn ntmp_lookup_free_eid(bitmap: *mut c_ulong, size: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ntmp_clear_eid_bitmap(bitmap: *mut c_ulong, entry_id: u32) {
    ...
    {
    let mut cbd_num: c_int = NETC_CBDR_BD_NUM;
    size_t size;
...
#[no_mangle]
unsafe extern "C" fn ntmp_free_data_mem(dev: *mut device, swcbd: *mut netc_swcbd) {
...
#[no_mangle]
pub unsafe extern "C" fn ntmp_free_cbdr(cbdr: *mut netc_cbdr) {
...
#[no_mangle]
unsafe extern "C" fn ntmp_get_free_cbd_num(cbdr: *mut netc_cbdr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ntmp_clean_cbdr(cbdr: *mut netc_cbdr) {
    static void ntmp_clean_cbdr(struct netc_cbdr *cbdr)
    {
    let mut i: c_int = cbdr.next_to_clean;
...
#[no_mangle]
unsafe extern "C" fn ntmp_unlock_cbdr(cbdr: *mut netc_cbdr) {
...
// For NTMP version 2.0 or later version
    ...
    bool compare_eid)
    {
    let mut len: u32 = NTMP_LEN(sizeof(*req), swcbd.size);
    struct ntmp_cmn_resp_query *resp;
    let mut cmd: c_int = NTMP_CMD_QUERY;
    union netc_cbd cbd;
    u32 entry_id;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn ntmp_maft_delete_entry(user: *mut ntmp_user, entry_id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ntmp_rsst_query_entry(user: *mut ntmp_user, table: *mut u32, count: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ntmp_ipft_delete_entry(user: *mut ntmp_user, entry_id: u32) -> c_int {
    int ntmp_ipft_delete_entry(struct ntmp_user *user, u32 entry_id)
    {
    let mut req_len: u32 = sizeof(struct ipft_req_qd);
...
//
#[no_mangle]
pub unsafe extern "C" fn ntmp_fdbt_delete_entry(user: *mut ntmp_user, entry_id: u32) -> c_int {
    int ntmp_fdbt_delete_entry(struct ntmp_user *user, u32 entry_id)
    {
    let mut req_len: u32 = sizeof(struct fdbt_req_qd);
...
//
#[no_mangle]
pub unsafe extern "C" fn ntmp_fdbt_update_activity_element(user: *mut ntmp_user) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ntmp_fdbt_delete_ageing_entries(user: *mut ntmp_user, act_cnt: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ntmp_fdbt_delete_port_dynamic_entries(user: *mut ntmp_user, port: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ntmp_vft_delete_entry(user: *mut ntmp_user, vid: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ntmp_ett_delete_entry(user: *mut ntmp_user, entry_id: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ntmp_ect_update_entry(user: *mut ntmp_user, entry_id: u32) -> c_int {
