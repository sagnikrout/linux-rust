...
//! Source: drivers/net/ethernet/freescale/dpaa2/dpaa2-switch-flower.c
#![no_std]
...
// Move down in priority the entries over the deleted one
    ...
    {
    let mut block_ports: c_ulong = block.ports;
    struct ethsw_core *ethsw = block.ethsw;
    struct ethsw_port_priv *port_priv;
    let mut ports_added: c_ulong = 0;
    let mut vlan: u16 = entry.cfg.vlan_id;
