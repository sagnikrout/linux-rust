...
//! Source: drivers/net/ethernet/freescale/dpaa2/dpaa2-eth-devlink.c
#![no_std]
...
//
    ...
    let mut err_cfg: dpni_error_cfg = {0};
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn dpaa2_eth_dl_alloc(priv: *mut dpaa2_eth_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dpaa2_eth_dl_free(priv: *mut dpaa2_eth_priv) {
    void dpaa2_eth_dl_free(struct dpaa2_eth_priv *priv)
    {
    devlink_free(priv.devlink);
    }
#[no_mangle]
pub unsafe extern "C" fn dpaa2_eth_dl_register(priv: *mut dpaa2_eth_priv) {
    void dpaa2_eth_dl_register(struct dpaa2_eth_priv *priv)
    {
    devlink_register(priv.devlink);
    }
#[no_mangle]
pub unsafe extern "C" fn dpaa2_eth_dl_unregister(priv: *mut dpaa2_eth_priv) {
    void dpaa2_eth_dl_unregister(struct dpaa2_eth_priv *priv)
    {
    devlink_unregister(priv.devlink);
    }
#[no_mangle]
pub unsafe extern "C" fn dpaa2_eth_dl_port_add(priv: *mut dpaa2_eth_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dpaa2_eth_dl_port_del(priv: *mut dpaa2_eth_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn dpaa2_eth_dl_traps_register(priv: *mut dpaa2_eth_priv) -> c_int {
    ...
    priv.trap_data = core::ptr::null_mut();
    return err;
    }
#[no_mangle]
pub unsafe extern "C" fn dpaa2_eth_dl_traps_unregister(priv: *mut dpaa2_eth_priv) {
