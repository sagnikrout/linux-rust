...
//! Source: drivers/net/ethernet/freescale/dpaa2/dpmac.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dpmac_attr {
    pub id: u16,
    pub max_rate: u32,
    pub eth_if: dpmac_eth_if,
    pub link_type: dpmac_link_type,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dpmac_link_state {
    pub rate: u32,
    pub options: u64,
    pub up: c_int,
    pub state_valid: c_int,
    pub supported: u64,
    pub advertising: u64,
}
