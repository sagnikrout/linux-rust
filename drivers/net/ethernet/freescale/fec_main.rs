...
//! Source: drivers/net/ethernet/freescale/fec_main.c
#![no_std]
...
pub const FEC_ENET_RSEM_V: c_uint = 0x84;
pub const FEC_ENET_RSFL_V: c_int = 16;
pub const FEC_ENET_RAEM_V: c_uint = 0x8;
pub const FEC_ENET_RAFL_V: c_uint = 0x8;
pub const FEC_ENET_OPD_V: c_uint = 0xFFF0;

pub const FEC_ENET_XDP_PASS: c_int = 0;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fec_devinfo {
    pub quirks: u32,
}
...
// sentinel
    ...
    module_param_array(macaddr, byte, core::ptr::null_mut(), 0);
...
pub const FEC_FLASHMAC: c_uint = 0xf0006006;

pub const FEC_FLASHMAC: c_uint = 0xf0006000;

pub const FEC_FLASHMAC: c_uint = 0xf0020000;

pub const FEC_FLASHMAC: c_uint = 0xffc0406b;

pub const FEC_FLASHMAC: c_int = 0;
...
pub const PKT_MINBUF_SIZE: c_int = 64;
...
pub const OPT_ARCH_HAS_MAX_FL: c_int = 1;

pub const OPT_ARCH_HAS_MAX_FL: c_int = 0;
...
pub const FEC_PAUSE_FLAG_AUTONEG: c_uint = 0x1;
pub const FEC_PAUSE_FLAG_ENABLE: c_uint = 0x2;

// Max number of allowed TCP segments for software TSO
pub const FEC_MAX_TSO_SEGS: c_int = 100;
...
#[no_mangle]
unsafe extern "C" fn fec_enet_get_free_txdesc_num(txq: *mut fec_enet_priv_tx_q) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn swap_buffer(bufaddr: *mut c_void, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fec_dump(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn fec_dmam_release(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn is_ipv4_pkt(skb: *mut sk_buff) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn fec_enet_bd_init(dev: *mut net_device) {
...
// Initialize the BD for every fragment in the page.
    ...
    txq.tx_buf[i].buf_p = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fec_enet_active_rxring(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_enable_ring(ndev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn fec_ctrl_reset(fep: *mut fec_enet_private, allow_wol: bool) {
...
#[no_mangle]
unsafe extern "C" fn fec_set_hw_mac_addr(ndev: *mut net_device) {
...
//
    ...
    {
    struct fec_enet_private *fep = netdev_priv(ndev);
    let mut ecntl: u32 = FEC_ECR_ETHEREN;
    let mut rcntl: u32 = FEC_RCR_MII;
...
// Set MII speed
    ...
    let mut val: u32 = readl(fep.hwp + FEC_RACC);
// align IP header
...
// RGMII, RMII or MII
    ...
    rcntl |= FEC_RCR_RGMII;
#[no_mangle]
pub unsafe extern "C" fn if(PHY_INTERFACE_MODE_RMII: fep->phy_interface ==) -> else {
...
// 1G, 100M or 10M
    ...
    ecntl |= FEC_ECR_SPEED;
#[no_mangle]
pub unsafe extern "C" fn if(SPEED_100: ndev->phydev->speed ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_ipc_handle_init(fep: *mut fec_enet_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_ipg_stop_set(fep: *mut fec_enet_private, enabled: bool) {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_stop_mode(fep: *mut fec_enet_private, enabled: bool) {
...
#[no_mangle]
unsafe extern "C" fn fec_irqs_disable(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn fec_irqs_disable_except_wakeup(ndev: *mut net_device) {
    ...
    {
    struct fec_enet_private *fep = netdev_priv(ndev);
    let mut rmii_mode: u32 = readl(fep.hwp + FEC_R_CNTRL) & FEC_RCR_RMII;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn fec_enet_timeout_work(work: *mut work_struct) {
    ...
    txq.tx_buf[j].buf_p = core::ptr::null_mut();
    status = fec16_to_cpu(bdp.cbd_sc);
    status &= ~BD_ENET_TX_STATS;
    status |= BD_ENET_TX_INTR | BD_ENET_TX_LAST;
...
//
    ...
    tx_buf.buf_p = core::ptr::null_mut();
// restore default tx buffer type: FEC_TXBUF_T_SKB
...
#[no_mangle]
unsafe extern "C" fn fec_enet_tx(ndev: *mut net_device, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_rx_vlan(ndev: *const net_device, skb: *mut sk_buff) {
    ...
    let mut vlan_tag: u16 = ntohs(vlan_header.h_vlan_TCI);
...
#[no_mangle]
unsafe extern "C" fn fec_rx_error_check(ndev: *mut net_device, status: u16) -> c_int {
...
//
    ...
    let mut need_swap: bool = fep.quirks & FEC_QUIRK_SWAP_FRAME;
    struct net_device *ndev = fep.netdev;
    struct bufdesc *bdp = rxq.bd.cur;
    let mut sub_len: u32 = 4 + fep.rx_shift;
    let mut pkt_received: c_int = 0;
    u16 status, pkt_len;
    struct sk_buff *skb;
    struct page *page;
    dma_addr_t dma;
...
//
    ...
    {
    let mut data_start: u32 = FEC_ENET_XDP_HEADROOM + fep.rx_shift;
    struct fec_enet_priv_rx_q *rxq = fep.rx_queue[queue];
    struct net_device *ndev = fep.netdev;
    struct bufdesc *bdp = rxq.bd.cur;
    let mut sub_len: u32 = 4 + fep.rx_shift;
    ...
    u16 status, pkt_len;
    struct xdp_buff xdp;
    let mut tx_qid: c_int = queue;
    struct page *page;
    let mut xdp_res: u32 = 0;
    dma_addr_t dma;
    int index, err;
    u32 act, sync;
...
// Trigger transmission start
    ...
    {
    let mut len: usize = xdp_get_buff_len(xsk);
    struct sk_buff *skb;
    ...
    struct netdev_queue *nq = netdev_get_tx_queue(fep.netdev, queue);
    struct fec_enet_priv_tx_q *txq = fep.tx_queue[queue];
    let mut offset: u32 = xsk.data - xsk.data_hard_start;
    let mut headroom: u32 = txq.xsk_pool.headroom;
    let mut len: u32 = xsk.data_end - xsk.data;
...
#[no_mangle]
unsafe extern "C" fn fec_enet_rx(ndev: *mut net_device, budget: c_int) -> c_int {
...
// Make sure that AVB queues are processed first.
    ...
    let mut batch: c_int = budget - done;
    if (rxq.xsk_pool)
    done += fec_enet_rx_queue_xsk(fep, i, batch, prog);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: prog) -> else {
    else if (prog)
...
#[no_mangle]
unsafe extern "C" fn fec_enet_collect_events(fep: *mut fec_enet_private) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_rx_napi(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int fec_enet_rx_napi(struct napi_struct *napi, int budget)
    {
    struct net_device *ndev = napi.dev;
    struct fec_enet_private *fep = netdev_priv(ndev);
    let mut rx_done: c_int = 0, tx_done = 0;
    int max_done;
    do {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn fec_get_mac(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fec_enet_us_to_tx_cycle(ndev: *mut net_device, us: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_adjust_link(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_mdio_wait(fep: *mut fec_enet_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_mdio_read_c22(bus: *mut mii_bus, mii_id: c_int, regnum: c_int) -> c_int {
    static int fec_enet_mdio_read_c22(struct mii_bus *bus, int mii_id, int regnum)
    {
    struct fec_enet_private *fep = bus.priv;
    struct device *dev = &fep.pdev.dev;
    let mut ret: c_int = 0, frame_start, frame_addr, frame_op;
...
// wait for end of transfer
    ...
    struct fec_enet_private *fep = bus.priv;
    struct device *dev = &fep.pdev.dev;
    let mut ret: c_int = 0, frame_start, frame_op;
    ret = pm_runtime_resume_and_get(dev);
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn fec_enet_phy_reset_after_clk_enable(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_clk_enable(ndev: *mut net_device, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_mii_probe(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_mii_init(pdev: *mut platform_device) -> c_int {
    static int fec_enet_mii_init(struct platform_device *pdev)
    {
    static struct mii_bus *fec0_mii_bus;
    struct net_device *ndev = platform_get_drvdata(pdev);
    struct fec_enet_private *fep = netdev_priv(ndev);
    let mut suppress_preamble: bool = false;
...
// Clear any pending transaction complete indication
    ...
    if (fep.mii_bus == core::ptr::null_mut()) {
    err = -ENOMEM;
    goto err_out;
    }
...
#[no_mangle]
unsafe extern "C" fn fec_enet_mii_remove(fep: *mut fec_enet_private) {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_get_regs_len(ndev: *mut net_device) -> c_int {
...
// List of registers that can be safety be read to dump them with ethtool
    ...
    let mut fec_enet_register_version: static __u32 = 2;
...
// for i.MX6ul
    ...
    let mut fec_enet_register_version: static __u32 = 1;
    static u32 fec_enet_register_offset[] = {
    ...
    {
    let mut reg_cnt: u32 = ARRAY_SIZE(fec_enet_register_offset);
    struct fec_enet_private *fep = netdev_priv(ndev);
...
#[no_mangle]
unsafe extern "C" fn fec_enet_update_ethtool_stats(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_get_xdp_stats(fep: *mut fec_enet_private, data: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_page_pool_stats(fep: *mut fec_enet_private, data: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_clear_ethtool_stats(dev: *mut net_device) {
...
pub const FEC_STATS_SIZE: c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn fec_enet_update_ethtool_stats(dev: *mut net_device) {
    static inline void fec_enet_update_ethtool_stats(struct net_device *dev)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn fec_enet_clear_ethtool_stats(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn fec_enet_us_to_itr_clock(ndev: *mut net_device, us: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_itr_coal_set(ndev: *mut net_device) {
    static void fec_enet_itr_coal_set(struct net_device *ndev)
    {
    struct fec_enet_private *fep = netdev_priv(ndev);
    let mut rx_itr: u32 = 0, tx_itr = 0;
    int rx_ictt, tx_ictt;
...
// Enable with enet system clock as Interrupt Coalescing timer Clock Source
    ...
    allocator = rxq.xsk_pool ? core::ptr::null_mut() : rxq.page_pool;
...
#[no_mangle]
unsafe extern "C" fn fec_xdp_rxq_info_unreg(rxq: *mut fec_enet_priv_rx_q) {
...
#[no_mangle]
unsafe extern "C" fn fec_free_rxq_buffers(rxq: *mut fec_enet_priv_rx_q) {
    static void fec_free_rxq_buffers(struct fec_enet_priv_rx_q *rxq)
    {
    let mut xsk: bool = !!rxq.xsk_pool;
    int i;
    for (i = 0; i < rxq.bd.ring_size; i++) {
    ...
    buf.page, false);
    rxq.rx_buf[i].buf_p = core::ptr::null_mut();
    }
    if (!xsk) {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_free_buffers(ndev: *mut net_device) {
    ...
    txq.tx_bounce[i] = core::ptr::null_mut();
    switch (txq.tx_buf[i].type) {
    case FEC_TXBUF_T_SKB:
...
#[no_mangle]
unsafe extern "C" fn fec_enet_free_queue(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_alloc_queue(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fec_enet_alloc_buffers(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_multicast_list(ndev: *mut net_device) {
    static void set_multicast_list(struct net_device *ndev)
    {
    struct fec_enet_private *fep = netdev_priv(ndev);
    ...
    unsigned char hash;
    let mut hash_high: c_uint = 0, hash_low = 0;
...
// Receive checksum has been changed
    ...
    if (!(fep.quirks & FEC_QUIRK_HAS_AVB))
    return netdev_pick_tx(ndev, skb, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn fec_free_rxq(rxq: *mut fec_enet_priv_rx_q) {
...
#[no_mangle]
unsafe extern "C" fn fec_init_rxq_bd_buffers(rxq: *mut fec_enet_priv_rx_q, xsk: bool) {
...
// Replace the old rxq with the new rxq
    ...
    rxq.xsk_pool = core::ptr::null_mut();
    txq.xsk_pool = core::ptr::null_mut();
    return 0;
    }
    err = fec_xsk_restart_napi(fep, core::ptr::null_mut(), queue);
    if (err)
    return err;
    xsk_pool_dma_unmap(old_pool, 0);
    return 0;
...
#[no_mangle]
unsafe extern "C" fn fec_enet_bpf(dev: *mut net_device, bpf: *mut netdev_bpf) -> c_int {
    static int fec_enet_bpf(struct net_device *dev, struct netdev_bpf *bpf)
    {
    struct fec_enet_private *fep = netdev_priv(dev);
    let mut is_run: bool = netif_running(dev);
...
#[no_mangle]
unsafe extern "C" fn fec_enet_xsk_wakeup(ndev: *mut net_device, queue: u32, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fec_change_mtu(ndev: *mut net_device, new_mtu: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fec_enet_init(ndev: *mut net_device) -> c_int {
    ...
    let mut dsize_log2: unsigned = __fls(dsize);
    int ret;
...
// Set receive and transmit descriptor base.
    for (i = 0; i < fep.num_rx_queues; i++) {
    struct fec_enet_priv_rx_q *rxq = fep.rx_queue[i];
    let mut size: unsigned = dsize * rxq.bd.ring_size;
    rxq.bd.qid = i;
    ...
    let mut size: unsigned = dsize * txq.bd.ring_size;
    txq.bd.qid = i;
...
#[no_mangle]
unsafe extern "C" fn fec_enet_deinit(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn fec_reset_phy(pdev: *mut platform_device) -> c_int {
    static int fec_reset_phy(struct platform_device *pdev)
    {
    struct gpio_desc *phy_reset;
    let mut msec: c_int = 1, phy_post_delay = 0;
...
#[no_mangle]
unsafe extern "C" fn fec_enet_get_irq_cnt(pdev: *mut platform_device) -> c_int {
    static int fec_enet_get_irq_cnt(struct platform_device *pdev)
    {
    let mut irq_cnt: c_int = platform_irq_count(pdev);
    if (irq_cnt > FEC_IRQ_NUM)
    irq_cnt = FEC_IRQ_NUM;	/* last for pps */
#[no_mangle]
pub unsafe extern "C" fn if(2: irq_cnt ==) -> else {
    else if (irq_cnt == 2)
    irq_cnt = 1;	/* last for pps */
#[no_mangle]
pub unsafe extern "C" fn if(0: irq_cnt <=) -> else {
    else if (irq_cnt <= 0)
    irq_cnt = 1;	/* At least 1 irq is needed */
    return irq_cnt;
    }
#[no_mangle]
unsafe extern "C" fn fec_enet_get_wakeup_irq(pdev: *mut platform_device) {
    ...
    fep.stop_gpr.gpr = core::ptr::null_mut();
    goto out;
    }
...
// clk_2x_txclk is optional, depends on board
    ...
    fep.clk_2x_txclk = core::ptr::null_mut();
    }
    fep.bufdesc_ex = fep.quirks & FEC_QUIRK_HAS_BUFDESC_EX;
    fep.clk_ptp = devm_clk_get(&pdev.dev, "ptp");
    if (IS_ERR(fep.clk_ptp)) {
    fep.clk_ptp = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fec_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fec_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fec_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fec_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(fec_runtime_suspend, fec_runtime_resume, core::ptr::null_mut())
    };
