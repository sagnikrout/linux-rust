...
//! Source: drivers/net/ethernet/sfc/siena/ethtool.c
#![no_std]
...
pub const EFX_ETHTOOL_EEPROM_MAGIC: c_uint = 0xEFAB;
//
// Ethtool operations
//
// Identify device by flashing LEDs
    ...
    let mut mode: enum efx_led_mode = EFX_LED_DEFAULT;
    switch (state) {
    case ETHTOOL_ID_ON:
    mode = EFX_LED_ON;
    break;
...
#[no_mangle]
unsafe extern "C" fn efx_ethtool_get_regs_len(net_dev: *mut net_device) -> c_int {
