...
//! Source: drivers/net/ethernet/sfc/siena/farch.c
#![no_std]
...
// goes idle.
//
pub const TX_DC_ENTRIES: c_int = 16;
pub const TX_DC_ENTRIES_ORDER: c_int = 1;
pub const RX_DC_ENTRIES: c_int = 64;
pub const RX_DC_ENTRIES_ORDER: c_int = 3;
// If EFX_MAX_INT_ERRORS internal errors occur within
// EFX_INT_ERROR_EXPIRE seconds, we consider the NIC broken and
// disable it.
//
pub const EFX_INT_ERROR_EXPIRE: c_int = 3600;
pub const EFX_MAX_INT_ERRORS: c_int = 5;
// Depth of RX flush request fifo
pub const EFX_RX_FLUSH_COUNT: c_int = 4;
// Driver generated events
pub const _EFX_CHANNEL_MAGIC_TEST: c_uint = 0x000101;
pub const _EFX_CHANNEL_MAGIC_FILL: c_uint = 0x000102;
pub const _EFX_CHANNEL_MAGIC_RX_DRAIN: c_uint = 0x000103;
pub const _EFX_CHANNEL_MAGIC_TX_DRAIN: c_uint = 0x000104;
...
// Unmaps a buffer and clears the buffer table entries
    ...
    let mut start: c_uint = buffer.index;
    let mut end: c_uint = (buffer.index + buffer.entries - 1);
    if (!buffer.entries)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_notify_tx_desc(tx_queue: *mut efx_tx_queue) {
...
//
#[no_mangle]
pub unsafe extern "C" fn efx_farch_tx_write(tx_queue: *mut efx_tx_queue) {
    void efx_farch_tx_write(struct efx_tx_queue *tx_queue)
    {
    struct efx_tx_buffer *buffer;
    efx_qword_t *txd;
    unsigned write_ptr;
    let mut old_write_count: unsigned = tx_queue.write_count;
...
// Don't cross 4K boundaries with descriptors.
    let mut limit: c_uint = (~dma_addr & (EFX_PAGE_SIZE - 1)) + 1;
    len = min(limit, len);
    return len;
    }
// Allocate hardware resources for a TX queue
#[no_mangle]
pub unsafe extern "C" fn efx_farch_tx_probe(tx_queue: *mut efx_tx_queue) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_tx_init(tx_queue: *mut efx_tx_queue) {
    void efx_farch_tx_init(struct efx_tx_queue *tx_queue)
    {
    let mut csum: c_int = tx_queue.type & EFX_TXQ_TYPE_OUTER_CSUM;
    struct efx_nic *efx = tx_queue.efx;
    efx_oword_t reg;
...
#[no_mangle]
unsafe extern "C" fn efx_farch_flush_tx_queue(tx_queue: *mut efx_tx_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_tx_fini(tx_queue: *mut efx_tx_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_tx_remove(tx_queue: *mut efx_tx_queue) {
...
//
#[no_mangle]
pub unsafe extern "C" fn efx_farch_rx_write(rx_queue: *mut efx_rx_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_rx_probe(rx_queue: *mut efx_rx_queue) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_rx_init(rx_queue: *mut efx_rx_queue) {
...
#[no_mangle]
unsafe extern "C" fn efx_farch_flush_rx_queue(rx_queue: *mut efx_rx_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_rx_fini(rx_queue: *mut efx_rx_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_rx_remove(rx_queue: *mut efx_rx_queue) {
...
//
#[no_mangle]
unsafe extern "C" fn efx_farch_flush_wake(efx: *mut efx_nic) -> bool {
...
#[no_mangle]
unsafe extern "C" fn efx_check_tx_flush_complete(efx: *mut efx_nic) -> bool {
...
#[no_mangle]
unsafe extern "C" fn efx_farch_do_flush(efx: *mut efx_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_fini_dmaq(efx: *mut efx_nic) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn efx_farch_finish_flr(efx: *mut efx_nic) {
...
//
#[no_mangle]
pub unsafe extern "C" fn efx_farch_ev_read_ack(channel: *mut efx_channel) {
...
#[no_mangle]
unsafe extern "C" fn efx_farch_magic_event(channel: *mut efx_channel, magic: u32) {
    static void efx_farch_magic_event(struct efx_channel *channel, u32 magic)
    {
    efx_qword_t event;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rx_ev_tobe_disc) -> else {
    else if (rx_ev_tobe_disc)
    ++channel.n_rx_tobe_disc;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !efx->loopback_selftest) -> else {
    if (rx_ev_ip_hdr_chksum_err)
    ++channel.n_rx_ip_hdr_chksum_err;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rx_ev_tcp_udp_chksum_err) -> else {
...
//
    ...
    efx_channel_get_rx_queue(channel) : core::ptr::null_mut();
    unsigned magic, code;
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_ev_process(channel: *mut efx_channel, budget: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_ev_probe(channel: *mut efx_channel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_ev_init(channel: *mut efx_channel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_ev_fini(channel: *mut efx_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_ev_remove(channel: *mut efx_channel) {
    void efx_farch_ev_remove(struct efx_channel *channel)
    {
    efx_free_special_buffer(channel.efx, &channel.eventq);
    }
#[no_mangle]
pub unsafe extern "C" fn efx_farch_ev_test_generate(channel: *mut efx_channel) {
    void efx_farch_ev_test_generate(struct efx_channel *channel)
    {
    efx_farch_magic_event(channel, EFX_CHANNEL_MAGIC_TEST(channel));
    }
#[no_mangle]
pub unsafe extern "C" fn efx_farch_rx_defer_refill(rx_queue: *mut efx_rx_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_irq_enable_master(efx: *mut efx_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_irq_disable_master(efx: *mut efx_nic) {
...
//
#[no_mangle]
pub unsafe extern "C" fn efx_farch_irq_test_generate(efx: *mut efx_nic) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn efx_farch_fatal_interrupt(efx: *mut efx_nic) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn efx_farch_legacy_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn efx_farch_msi_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn efx_farch_rx_push_indir_table(efx: *mut efx_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_rx_pull_indir_table(efx: *mut efx_nic) {
...
//
#[no_mangle]
pub unsafe extern "C" fn efx_farch_dimension_resources(efx: *mut efx_nic, sram_lim_qw: unsigned) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_fpga_ver(efx: *mut efx_nic) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_init_common(efx: *mut efx_nic) {
...
//
pub const EFX_FARCH_FILTER_CTL_SRCH_FUDGE_WILD: c_int = 3;
pub const EFX_FARCH_FILTER_CTL_SRCH_FUDGE_FULL: c_int = 1;
...
// table is full.
//
pub const EFX_FARCH_FILTER_CTL_SRCH_MAX: c_int = 200;
// Don't try very hard to find space for performance hints, as this is
// counter-productive.
pub const EFX_FARCH_FILTER_CTL_SRCH_HINT_MAX: c_int = 5;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct efx_farch_filter_spec {
    pub type:4: u8,
    pub priority:4: u8,
    pub flags: u8,
    pub dmaq_id: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct efx_farch_filter_table {
    pub id: enum efx_farch_filter_table_id,
    pub /: *mut *mut u32 offset; / address of table relative to BAR,
    pub /: *mut *mut unsigned size; / number of entries,
    pub /: *mut *mut unsigned step; / step between entries,
    pub /: *mut *mut unsigned used; / number currently used,
    pub used_bitmap: *mut c_ulong,
    pub spec: *mut efx_farch_filter_spec,
    pub search_limit: [unsigned; EFX_FARCH_FILTER_TYPE_COUNT],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct efx_farch_filter_state {
    pub /: *mut *mut rw_semaphore lock; / Protects table contents,
    pub table: [efx_farch_filter_table; EFX_FARCH_FILTER_TABLE_COUNT],
}
...
#[no_mangle]
unsafe extern "C" fn efx_farch_filter_hash(key: u32) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn efx_farch_filter_increment(key: u32) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn efx_farch_filter_push_rx_config(efx: *mut efx_nic) {
...
#[no_mangle]
unsafe extern "C" fn efx_farch_filter_push_tx_limits(efx: *mut efx_nic) {
...
// filter,
    ...
    let mut is_wild: bool = spec.type == EFX_FARCH_FILTER_MAC_WILD;
    EFX_POPULATE_OWORD_7(
// filter,
    FRF_CZ_RMFT_RSS_EN,
    !!(spec.flags & EFX_FILTER_FLAG_RX_RSS),
...
//
pub const EFX_FARCH_FILTER_MATCH_PRI_COUNT: c_int = 5;
...
pub const EFX_FARCH_FILTER_INDEX_WIDTH: c_int = 13;
    ...
    {
    let mut range: c_uint = id >> EFX_FARCH_FILTER_INDEX_WIDTH;
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_filter_id_index(id: u32) -> c_uint {
    static inline unsigned int efx_farch_filter_id_index(u32 id)
    {
    return id & EFX_FARCH_FILTER_INDEX_MASK;
    }
#[no_mangle]
pub unsafe extern "C" fn efx_farch_filter_get_rx_id_limit(efx: *mut efx_nic) -> u32 {
    u32 efx_farch_filter_get_rx_id_limit(struct efx_nic *efx)
    {
    struct efx_farch_filter_state *state = efx.filter_state;
    let mut range: c_uint = EFX_FARCH_FILTER_MATCH_PRI_COUNT - 1;
...
//
    let mut key: u32 = efx_farch_filter_build(&filter, &spec);
    let mut hash: c_uint = efx_farch_filter_hash(key);
    let mut incr: c_uint = efx_farch_filter_increment(key);
    let mut max_rep_depth: c_uint = table.search_limit[spec.type];
    unsigned int max_ins_depth =
    spec.priority <= EFX_FILTER_PRI_HINT ?
    EFX_FARCH_FILTER_CTL_SRCH_HINT_MAX :
    EFX_FARCH_FILTER_CTL_SRCH_MAX;
    let mut i: c_uint = hash & (table.size - 1);
    ins_index = -1;
    depth = 1;
    for (;;) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_filter_table_restore(efx: *mut efx_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_filter_table_remove(efx: *mut efx_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_filter_table_probe(efx: *mut efx_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_filter_update_rx_scatter(efx: *mut efx_nic) {
...
// Pushed by efx_farch_filter_push_rx_config()
    ...
    struct efx_farch_filter_state *state = efx.filter_state;
    struct efx_farch_filter_table *table;
    let mut ret: bool = false, force = false;
    u16 arfs_id;
    down_write(&state.lock);
    ...
    struct efx_arfs_rule *rule = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn efx_farch_filter_sync_rx_mode(efx: *mut efx_nic) {
