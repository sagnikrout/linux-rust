...
//! Source: drivers/net/ethernet/sfc/siena/rx.c
#![no_std]
...
pub const EFX_MAX_RX_PREFIX_SIZE: c_int = 16;
...
//
    ...
    {
    struct sk_buff *skb;
    let mut hdr_len: u16 = min_t(u16, rx_buf.len, EFX_SKB_HEADERS);
...
// Set the SKB flags
    ...
    return;
// Pass the packet up
    if (channel.rx_list != core::ptr::null_mut())
...
// Buffer ownership passes to tx on success.
    ...
    let mut xdp_act: return = = XDP_PASS;
    }
// Handle a received packet.  Second half: Touches packet payload.
#[no_mangle]
pub unsafe extern "C" fn __efx_siena_rx_packet(channel: *mut efx_channel) {
