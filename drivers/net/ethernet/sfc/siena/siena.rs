...
//! Source: drivers/net/ethernet/sfc/siena/siena.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn siena_push_irq_moderation(channel: *mut efx_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_siena_prepare_flush(efx: *mut efx_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn siena_finish_flush(efx: *mut efx_nic) {
...
#[no_mangle]
unsafe extern "C" fn siena_test_chip(efx: *mut efx_nic, tests: *mut efx_self_tests) -> c_int {
    static int siena_test_chip(struct efx_nic *efx, struct efx_self_tests *tests)
    {
    let mut reset_method: enum reset_type = RESET_TYPE_ALL;
    int rc, rc2;
...
//
#[no_mangle]
unsafe extern "C" fn siena_ptp_write_host_time(efx: *mut efx_nic, host_time: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn siena_map_reset_flags(flags: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn siena_monitor(efx: *mut efx_nic) {
...
#[no_mangle]
unsafe extern "C" fn siena_probe_nvconfig(efx: *mut efx_nic) -> c_int {
    static int siena_probe_nvconfig(struct efx_nic *efx)
    {
    let mut caps: u32 = 0;
    int rc;
    rc = efx_siena_mcdi_get_board_cfg(efx, efx.net_dev.perm_addr, core::ptr::null_mut(),
    &caps);
...
#[no_mangle]
unsafe extern "C" fn siena_dimension_resources(efx: *mut efx_nic) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn siena_mem_bar(efx: *mut efx_nic) -> c_uint {
    static unsigned int siena_mem_bar(struct efx_nic *efx)
    {
    return 2;
    }
#[no_mangle]
unsafe extern "C" fn siena_mem_map_size(efx: *mut efx_nic) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn siena_probe_nic(efx: *mut efx_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn siena_rx_pull_rss_config(efx: *mut efx_nic) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn siena_init_nic(efx: *mut efx_nic) -> c_int {
...
// TCP/IPv4 and IPv4 hashes.
    ...
    siena_rx_push_rss_config(efx, false, efx.rss_context.rx_indir_table, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn siena_remove_nic(efx: *mut efx_nic) {
...
#[no_mangle]
unsafe extern "C" fn siena_describe_nic_stats(efx: *mut efx_nic, names: *mut u8) -> usize {
...
#[no_mangle]
unsafe extern "C" fn siena_try_update_nic_stats(efx: *mut efx_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn siena_mac_reconfigure(efx: *mut efx_nic, __always_unused: bool mtu_only) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn siena_get_wol(efx: *mut efx_nic, wol: *mut ethtool_wolinfo) {
...
#[no_mangle]
unsafe extern "C" fn siena_set_wol(efx: *mut efx_nic, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn siena_init_wol(efx: *mut efx_nic) {
    static void siena_init_wol(struct efx_nic *efx)
    {
    struct siena_nic_data *nic_data = efx.nic_data;
    int rc;
...
//
    ...
    {
    let mut pdu: unsigned = FR_CZ_MC_TREG_SMEM + MCDI_PDU(efx);
    let mut doorbell: unsigned = FR_CZ_MC_TREG_SMEM + MCDI_DOORBELL(efx);
    unsigned int i;
    let mut inlen_dw: c_uint = DIV_ROUND_UP(sdu_len, 4);
...
// ring the doorbell with a distinctive value
    _efx_writed(efx, ( __le32) 0x45789abc, doorbell);
    }
#[no_mangle]
unsafe extern "C" fn siena_mcdi_poll_response(efx: *mut efx_nic) -> bool {
    static bool siena_mcdi_poll_response(struct efx_nic *efx)
    {
    let mut pdu: c_uint = FR_CZ_MC_TREG_SMEM + MCDI_PDU(efx);
    efx_dword_t hdr;
...
//
    ...
    {
    let mut pdu: c_uint = FR_CZ_MC_TREG_SMEM + MCDI_PDU(efx);
    let mut outlen_dw: c_uint = DIV_ROUND_UP(outlen, 4);
    int i;
    for (i = 0; i < outlen_dw; i++)
    efx_readd(efx, &outbuf[i], pdu + offset + 4 * i);
    }
#[no_mangle]
unsafe extern "C" fn siena_mcdi_poll_reboot(efx: *mut efx_nic) -> c_int {
    static int siena_mcdi_poll_reboot(struct efx_nic *efx)
    {
    struct siena_nic_data *nic_data = efx.nic_data;
    let mut addr: c_uint = FR_CZ_MC_TREG_SMEM + MCDI_STATUS(efx);
    efx_dword_t reg;
    u32 value;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct siena_nvram_type_info {
    pub port: c_int,
    ...
    siena_nvram_types[type].name == core::ptr::null_mut())
    return -ENODEV;
    ...
    size_t i;
    int rc;
    rc = efx_siena_mcdi_get_board_cfg(efx, core::ptr::null_mut(), fw_subtype_list, core::ptr::null_mut());
    if (rc)
    return rc;
    for (i = 0; i < n_parts; i++)
...
#[no_mangle]
unsafe extern "C" fn siena_mtd_probe(efx: *mut efx_nic) -> c_int {
    ...
    n_parts++;
#[no_mangle]
pub unsafe extern "C" fn if(-ENODEV: rc !=) -> else {
    else if (rc != -ENODEV)
    goto fail;
    }
    type++;
...
#[no_mangle]
unsafe extern "C" fn efx_siena_recycle_ring_size(efx: *const efx_nic) -> c_uint {
