...
//! Source: drivers/net/ethernet/sfc/falcon/mtd.c
#![no_std]
...
// MTD interface
#[no_mangle]
unsafe extern "C" fn ef4_mtd_erase(mtd: *mut mtd_info, erase: *mut erase_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ef4_mtd_sync(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn ef4_mtd_remove_partition(part: *mut ef4_mtd_partition) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_mtd_remove(efx: *mut ef4_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_mtd_rename(efx: *mut ef4_nic) {
