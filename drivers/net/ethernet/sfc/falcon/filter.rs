...
//! Source: drivers/net/ethernet/sfc/falcon/filter.h
#![no_std]
...
pub enum ef4_filter_match_flags {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ef4_filter_spec {
    pub match_flags:12: u32,
    pub priority:2: u32,
    pub flags:6: u32,
    pub dmaq_id:12: u32,
    pub rss_context: u32,
    pub /: *mut *mut __be16 outer_vid __aligned(4); / allow jhash2() of match values,
