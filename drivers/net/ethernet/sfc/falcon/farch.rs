...
//! Source: drivers/net/ethernet/sfc/falcon/farch.c
#![no_std]
...
// disable it.
//
pub const EF4_INT_ERROR_EXPIRE: c_int = 3600;
pub const EF4_MAX_INT_ERRORS: c_int = 5;
// Depth of RX flush request fifo
pub const EF4_RX_FLUSH_COUNT: c_int = 4;
// Driver generated events
pub const _EF4_CHANNEL_MAGIC_TEST: c_uint = 0x000101;
pub const _EF4_CHANNEL_MAGIC_FILL: c_uint = 0x000102;
pub const _EF4_CHANNEL_MAGIC_RX_DRAIN: c_uint = 0x000103;
pub const _EF4_CHANNEL_MAGIC_TX_DRAIN: c_uint = 0x000104;
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_notify_tx_desc(tx_queue: *mut ef4_tx_queue) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_tx_write(tx_queue: *mut ef4_tx_queue) {
...
// Don't cross 4K boundaries with descriptors.
    let mut limit: c_uint = (~dma_addr & (EF4_PAGE_SIZE - 1)) + 1;
    len = min(limit, len);
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_tx_probe(tx_queue: *mut ef4_tx_queue) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_tx_init(tx_queue: *mut ef4_tx_queue) {
...
// Push TX descriptor ring to card
    ...
    let mut csum: c_int = tx_queue.queue & EF4_TXQ_TYPE_OFFLOAD;
...
#[no_mangle]
unsafe extern "C" fn ef4_farch_flush_tx_queue(tx_queue: *mut ef4_tx_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_tx_fini(tx_queue: *mut ef4_tx_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_tx_remove(tx_queue: *mut ef4_tx_queue) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_rx_write(rx_queue: *mut ef4_rx_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_rx_probe(rx_queue: *mut ef4_rx_queue) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_rx_init(rx_queue: *mut ef4_rx_queue) {
    void ef4_farch_rx_init(struct ef4_rx_queue *rx_queue)
    {
    ef4_oword_t rx_desc_ptr;
    struct ef4_nic *efx = rx_queue.efx;
    let mut is_b0: bool = ef4_nic_rev(efx) >= EF4_REV_FALCON_B0;
    let mut iscsi_digest_en: bool = is_b0;
    bool jumbo_en;
...
#[no_mangle]
unsafe extern "C" fn ef4_farch_flush_rx_queue(rx_queue: *mut ef4_rx_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_rx_fini(rx_queue: *mut ef4_rx_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_rx_remove(rx_queue: *mut ef4_rx_queue) {
...
//
#[no_mangle]
unsafe extern "C" fn ef4_farch_flush_wake(efx: *mut ef4_nic) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ef4_check_tx_flush_complete(efx: *mut ef4_nic) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ef4_farch_do_flush(efx: *mut ef4_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_fini_dmaq(efx: *mut ef4_nic) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_finish_flr(efx: *mut ef4_nic) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_ev_read_ack(channel: *mut ef4_channel) {
...
#[no_mangle]
unsafe extern "C" fn ef4_farch_magic_event(channel: *mut ef4_channel, magic: u32) {
    static void ef4_farch_magic_event(struct ef4_channel *channel, u32 magic)
    {
    ef4_qword_t event;
...
//
    ...
    ef4_channel_get_rx_queue(channel) : core::ptr::null_mut();
    unsigned magic, code;
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_ev_process(channel: *mut ef4_channel, budget: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_ev_probe(channel: *mut ef4_channel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_ev_init(channel: *mut ef4_channel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_ev_fini(channel: *mut ef4_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_irq_enable_master(efx: *mut ef4_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_irq_disable_master(efx: *mut ef4_nic) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_irq_test_generate(efx: *mut ef4_nic) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_fatal_interrupt(efx: *mut ef4_nic) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_legacy_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_msi_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_rx_push_indir_table(efx: *mut ef4_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_fpga_ver(efx: *mut ef4_nic) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_init_common(efx: *mut ef4_nic) {
...
//
pub const EF4_FARCH_FILTER_CTL_SRCH_FUDGE_WILD: c_int = 3;
pub const EF4_FARCH_FILTER_CTL_SRCH_FUDGE_FULL: c_int = 1;
...
// table is full.
//
pub const EF4_FARCH_FILTER_CTL_SRCH_MAX: c_int = 200;
// Don't try very hard to find space for performance hints, as this is
// counter-productive.
pub const EF4_FARCH_FILTER_CTL_SRCH_HINT_MAX: c_int = 5;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ef4_farch_filter_spec {
    pub type:4: u8,
    pub priority:4: u8,
    pub flags: u8,
    pub dmaq_id: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ef4_farch_filter_table {
    pub id: enum ef4_farch_filter_table_id,
    ...
    pub spec: *mut ef4_farch_filter_spec,
    pub search_limit: [unsigned; EF4_FARCH_FILTER_TYPE_COUNT],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ef4_farch_filter_state {
    pub table: [ef4_farch_filter_table; EF4_FARCH_FILTER_TABLE_COUNT],
}
...
#[no_mangle]
unsafe extern "C" fn ef4_farch_filter_hash(key: u32) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn ef4_farch_filter_increment(key: u32) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn ef4_farch_filter_push_rx_config(efx: *mut ef4_nic) {
...
#[no_mangle]
unsafe extern "C" fn ef4_farch_filter_push_tx_limits(efx: *mut ef4_nic) {
...
// filter,
    ...
    let mut is_wild: bool = spec.type == EF4_FARCH_FILTER_MAC_WILD;
    EF4_POPULATE_OWORD_7(
// filter,
    FRF_CZ_RMFT_RSS_EN,
    !!(spec.flags & EF4_FILTER_FLAG_RX_RSS),
...
//
pub const EF4_FARCH_FILTER_MATCH_PRI_COUNT: c_int = 5;
...
pub const EF4_FARCH_FILTER_INDEX_WIDTH: c_int = 13;
    ...
    {
    let mut range: c_uint = id >> EF4_FARCH_FILTER_INDEX_WIDTH;
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_filter_id_index(id: u32) -> c_uint {
    static inline unsigned int ef4_farch_filter_id_index(u32 id)
    {
    return id & EF4_FARCH_FILTER_INDEX_MASK;
    }
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_filter_get_rx_id_limit(efx: *mut ef4_nic) -> u32 {
    u32 ef4_farch_filter_get_rx_id_limit(struct ef4_nic *efx)
    {
    struct ef4_farch_filter_state *state = efx.filter_state;
    let mut range: c_uint = EF4_FARCH_FILTER_MATCH_PRI_COUNT - 1;
...
//
    let mut key: u32 = ef4_farch_filter_build(&filter, &spec);
    let mut hash: c_uint = ef4_farch_filter_hash(key);
    let mut incr: c_uint = ef4_farch_filter_increment(key);
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_filter_table_restore(efx: *mut ef4_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_filter_table_remove(efx: *mut ef4_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_filter_table_probe(efx: *mut ef4_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_filter_update_rx_scatter(efx: *mut ef4_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_farch_filter_sync_rx_mode(efx: *mut ef4_nic) {
