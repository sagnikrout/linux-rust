...
//! Source: drivers/net/ethernet/sfc/falcon/falcon.c
#![no_std]
...
// NIC stats
//
pub const FALCON_MAC_STATS_SIZE: c_uint = 0x100;
pub const XgRxOctets_offset: c_uint = 0x0;
pub const XgRxOctets_WIDTH: c_int = 48;
pub const XgRxOctetsOK_offset: c_uint = 0x8;
pub const XgRxOctetsOK_WIDTH: c_int = 48;
pub const XgRxPkts_offset: c_uint = 0x10;
pub const XgRxPkts_WIDTH: c_int = 32;
pub const XgRxPktsOK_offset: c_uint = 0x14;
pub const XgRxPktsOK_WIDTH: c_int = 32;
pub const XgRxBroadcastPkts_offset: c_uint = 0x18;
pub const XgRxBroadcastPkts_WIDTH: c_int = 32;
pub const XgRxMulticastPkts_offset: c_uint = 0x1C;
pub const XgRxMulticastPkts_WIDTH: c_int = 32;
pub const XgRxUnicastPkts_offset: c_uint = 0x20;
pub const XgRxUnicastPkts_WIDTH: c_int = 32;
pub const XgRxUndersizePkts_offset: c_uint = 0x24;
pub const XgRxUndersizePkts_WIDTH: c_int = 32;
pub const XgRxOversizePkts_offset: c_uint = 0x28;
pub const XgRxOversizePkts_WIDTH: c_int = 32;
pub const XgRxJabberPkts_offset: c_uint = 0x2C;
pub const XgRxJabberPkts_WIDTH: c_int = 32;
pub const XgRxUndersizeFCSerrorPkts_offset: c_uint = 0x30;
pub const XgRxUndersizeFCSerrorPkts_WIDTH: c_int = 32;
pub const XgRxDropEvents_offset: c_uint = 0x34;
pub const XgRxDropEvents_WIDTH: c_int = 32;
pub const XgRxFCSerrorPkts_offset: c_uint = 0x38;
pub const XgRxFCSerrorPkts_WIDTH: c_int = 32;
pub const XgRxAlignError_offset: c_uint = 0x3C;
pub const XgRxAlignError_WIDTH: c_int = 32;
pub const XgRxSymbolError_offset: c_uint = 0x40;
pub const XgRxSymbolError_WIDTH: c_int = 32;
pub const XgRxInternalMACError_offset: c_uint = 0x44;
pub const XgRxInternalMACError_WIDTH: c_int = 32;
pub const XgRxControlPkts_offset: c_uint = 0x48;
pub const XgRxControlPkts_WIDTH: c_int = 32;
pub const XgRxPausePkts_offset: c_uint = 0x4C;
pub const XgRxPausePkts_WIDTH: c_int = 32;
pub const XgRxPkts64Octets_offset: c_uint = 0x50;
pub const XgRxPkts64Octets_WIDTH: c_int = 32;
pub const XgRxPkts65to127Octets_offset: c_uint = 0x54;
pub const XgRxPkts65to127Octets_WIDTH: c_int = 32;
pub const XgRxPkts128to255Octets_offset: c_uint = 0x58;
pub const XgRxPkts128to255Octets_WIDTH: c_int = 32;
pub const XgRxPkts256to511Octets_offset: c_uint = 0x5C;
pub const XgRxPkts256to511Octets_WIDTH: c_int = 32;
pub const XgRxPkts512to1023Octets_offset: c_uint = 0x60;
pub const XgRxPkts512to1023Octets_WIDTH: c_int = 32;
pub const XgRxPkts1024to15xxOctets_offset: c_uint = 0x64;
pub const XgRxPkts1024to15xxOctets_WIDTH: c_int = 32;
pub const XgRxPkts15xxtoMaxOctets_offset: c_uint = 0x68;
pub const XgRxPkts15xxtoMaxOctets_WIDTH: c_int = 32;
pub const XgRxLengthError_offset: c_uint = 0x6C;
pub const XgRxLengthError_WIDTH: c_int = 32;
pub const XgTxPkts_offset: c_uint = 0x80;
pub const XgTxPkts_WIDTH: c_int = 32;
pub const XgTxOctets_offset: c_uint = 0x88;
pub const XgTxOctets_WIDTH: c_int = 48;
pub const XgTxMulticastPkts_offset: c_uint = 0x90;
pub const XgTxMulticastPkts_WIDTH: c_int = 32;
pub const XgTxBroadcastPkts_offset: c_uint = 0x94;
pub const XgTxBroadcastPkts_WIDTH: c_int = 32;
pub const XgTxUnicastPkts_offset: c_uint = 0x98;
pub const XgTxUnicastPkts_WIDTH: c_int = 32;
pub const XgTxControlPkts_offset: c_uint = 0x9C;
pub const XgTxControlPkts_WIDTH: c_int = 32;
pub const XgTxPausePkts_offset: c_uint = 0xA0;
pub const XgTxPausePkts_WIDTH: c_int = 32;
pub const XgTxPkts64Octets_offset: c_uint = 0xA4;
pub const XgTxPkts64Octets_WIDTH: c_int = 32;
pub const XgTxPkts65to127Octets_offset: c_uint = 0xA8;
pub const XgTxPkts65to127Octets_WIDTH: c_int = 32;
pub const XgTxPkts128to255Octets_offset: c_uint = 0xAC;
pub const XgTxPkts128to255Octets_WIDTH: c_int = 32;
pub const XgTxPkts256to511Octets_offset: c_uint = 0xB0;
pub const XgTxPkts256to511Octets_WIDTH: c_int = 32;
pub const XgTxPkts512to1023Octets_offset: c_uint = 0xB4;
pub const XgTxPkts512to1023Octets_WIDTH: c_int = 32;
pub const XgTxPkts1024to15xxOctets_offset: c_uint = 0xB8;
pub const XgTxPkts1024to15xxOctets_WIDTH: c_int = 32;
pub const XgTxPkts1519toMaxOctets_offset: c_uint = 0xBC;
pub const XgTxPkts1519toMaxOctets_WIDTH: c_int = 32;
pub const XgTxUndersizePkts_offset: c_uint = 0xC0;
pub const XgTxUndersizePkts_WIDTH: c_int = 32;
pub const XgTxOversizePkts_offset: c_uint = 0xC4;
pub const XgTxOversizePkts_WIDTH: c_int = 32;
pub const XgTxNonTcpUdpPkt_offset: c_uint = 0xC8;
pub const XgTxNonTcpUdpPkt_WIDTH: c_int = 16;
pub const XgTxMacSrcErrPkt_offset: c_uint = 0xCC;
pub const XgTxMacSrcErrPkt_WIDTH: c_int = 16;
pub const XgTxIpSrcErrPkt_offset: c_uint = 0xD0;
pub const XgTxIpSrcErrPkt_WIDTH: c_int = 16;
pub const XgDmaDone_offset: c_uint = 0xD4;
pub const XgDmaDone_WIDTH: c_int = 32;
...
//
pub const SPI_WRSR: c_uint = 0x01		/* Write status register */;
pub const SPI_WRITE: c_uint = 0x02		/* Write data to memory array */;
pub const SPI_READ: c_uint = 0x03		/* Read data from memory array */;
pub const SPI_WRDI: c_uint = 0x04		/* Reset write enable latch */;
pub const SPI_RDSR: c_uint = 0x05		/* Read status register */;
pub const SPI_WREN: c_uint = 0x06		/* Set write enable latch */;
pub const SPI_SST_EWSR: c_uint = 0x50	/* SST: Enable write to status register */;
pub const SPI_STATUS_WPEN: c_uint = 0x80	/* Write-protect pin enabled */;
pub const SPI_STATUS_BP2: c_uint = 0x10	/* Block protection bit 2 */;
pub const SPI_STATUS_BP1: c_uint = 0x08	/* Block protection bit 1 */;
pub const SPI_STATUS_BP0: c_uint = 0x04	/* Block protection bit 0 */;
pub const SPI_STATUS_WEN: c_uint = 0x02	/* State of the write enable latch */;
pub const SPI_STATUS_NRDY: c_uint = 0x01	/* Device busy flag */;
//
...
//
pub const FALCON_NVCONFIG_END: c_uint = 0x400U;
pub const FALCON_FLASH_BOOTCODE_START: c_uint = 0x8000U;
pub const FALCON_EEPROM_BOOTCONFIG_START: c_uint = 0x800U;
pub const FALCON_EEPROM_BOOTCONFIG_END: c_uint = 0x1800U;
// Board configuration v2 (v1 is obsolete; later versions are compatible)
#[repr(C)]
#[derive(Copy, Clone)]
pub struct falcon_nvconfig_board_v2 {
    pub nports: __le16,
    pub port0_phy_addr: u8,
    pub port0_phy_type: u8,
    pub port1_phy_addr: u8,
    pub port1_phy_type: u8,
    pub asic_sub_revision: __le16,
    pub board_revision: __le16,
    pub __packed: },
// Board configuration v3 extra information
#[repr(C)]
#[derive(Copy, Clone)]
pub struct falcon_nvconfig_board_v3 {
    pub spi_device_type: [__le32; 2],
    pub __packed: },
// Bit numbers for spi_device_type
pub const SPI_DEV_TYPE_SIZE_LBN: c_int = 0;
pub const SPI_DEV_TYPE_SIZE_WIDTH: c_int = 5;
pub const SPI_DEV_TYPE_ADDR_LEN_LBN: c_int = 6;
pub const SPI_DEV_TYPE_ADDR_LEN_WIDTH: c_int = 2;
pub const SPI_DEV_TYPE_ERASE_CMD_LBN: c_int = 8;
pub const SPI_DEV_TYPE_ERASE_CMD_WIDTH: c_int = 8;
pub const SPI_DEV_TYPE_ERASE_SIZE_LBN: c_int = 16;
pub const SPI_DEV_TYPE_ERASE_SIZE_WIDTH: c_int = 5;
pub const SPI_DEV_TYPE_BLOCK_SIZE_LBN: c_int = 24;
pub const SPI_DEV_TYPE_BLOCK_SIZE_WIDTH: c_int = 5;

    (((type) >> EF4_LOW_BIT(field)) & EF4_MASK32(EF4_WIDTH(field)))
pub const FALCON_NVCONFIG_OFFSET: c_uint = 0x300;
pub const FALCON_NVCONFIG_BOARD_MAGIC_NUM: c_uint = 0xFA1C;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct falcon_nvconfig {
    pub /: *mut *mut ef4_oword_t ee_vpd_cfg_reg; / 0x300,
    pub /: *mut *mut u8 mac_address[2][8]; / 0x310,
    pub /: *mut *mut ef4_oword_t pcie_sd_ctl0123_reg; / 0x320,
    pub /: *mut *mut ef4_oword_t pcie_sd_ctl45_reg; / 0x330,
    pub /: *mut *mut ef4_oword_t pcie_pcs_ctl_stat_reg; / 0x340,
    pub /: *mut *mut ef4_oword_t hw_init_reg; / 0x350,
    pub /: *mut *mut ef4_oword_t nic_stat_reg; / 0x360,
    pub /: *mut *mut ef4_oword_t glb_ctl_reg; / 0x370,
    pub /: *mut *mut ef4_oword_t srm_cfg_reg; / 0x380,
    pub /: *mut *mut ef4_oword_t spare_reg; / 0x390,
    pub /: *mut *mut __le16 board_magic_num; / 0x3A0,
    pub board_struct_ver: __le16,
    pub board_checksum: __le16,
    pub board_v2: falcon_nvconfig_board_v2,
    pub /: *mut *mut ef4_oword_t ee_base_page_reg; / 0x3B0,
    pub /: *mut *mut falcon_nvconfig_board_v3 board_v3; / 0x3C0,
    pub __packed: },
//
    pub method): *mut *mut static int falcon_reset_hw(struct ef4_nic efx, enum reset_type,
    pub efx): *mut static void falcon_reconfigure_mac_wrapper(struct ef4_nic,
...
// 128 KB, 24-bit address, 32 KB erase block, 256 B write block
    ...
    pub SPI_DEV_TYPE_BLOCK_SIZE_LBN)): | (8 <<,
//
...
//
#[no_mangle]
unsafe extern "C" fn falcon_setsda(data: *mut c_void, state: c_int) {
    static void falcon_setsda(void *data, int state)
    {
    pub )data: *mut *mut ef4_nic efx = (ef4_nic,
    pub reg: ef4_oword_t,
    pub FR_AB_GPIO_CTL): ef4_reado(efx, &reg,,
    pub !state): EF4_SET_OWORD_FIELD(reg, FRF_AB_GPIO3_OEN,,
    pub FR_AB_GPIO_CTL): ef4_writeo(efx, &reg,,
    }
#[no_mangle]
unsafe extern "C" fn falcon_setscl(data: *mut c_void, state: c_int) {
    static void falcon_setscl(void *data, int state)
    {
    pub )data: *mut *mut ef4_nic efx = (ef4_nic,
    pub reg: ef4_oword_t,
    pub FR_AB_GPIO_CTL): ef4_reado(efx, &reg,,
    pub !state): EF4_SET_OWORD_FIELD(reg, FRF_AB_GPIO0_OEN,,
    pub FR_AB_GPIO_CTL): ef4_writeo(efx, &reg,,
    }
#[no_mangle]
unsafe extern "C" fn falcon_getsda(data: *mut c_void) -> c_int {
    static int falcon_getsda(void *data)
    {
    pub )data: *mut *mut ef4_nic efx = (ef4_nic,
    pub reg: ef4_oword_t,
    pub FR_AB_GPIO_CTL): ef4_reado(efx, &reg,,
    pub FRF_AB_GPIO3_IN): return EF4_OWORD_FIELD(reg,,
    }
#[no_mangle]
unsafe extern "C" fn falcon_getscl(data: *mut c_void) -> c_int {
    static int falcon_getscl(void *data)
    {
    pub )data: *mut *mut ef4_nic efx = (ef4_nic,
    pub reg: ef4_oword_t,
    pub FR_AB_GPIO_CTL): ef4_reado(efx, &reg,,
    pub FRF_AB_GPIO0_IN): return EF4_OWORD_FIELD(reg,,
    }
...
#[no_mangle]
unsafe extern "C" fn falcon_push_irq_moderation(channel: *mut ef4_channel) {
...
#[no_mangle]
unsafe extern "C" fn falcon_prepare_flush(efx: *mut ef4_nic) {
...
//
#[no_mangle]
pub unsafe extern "C" fn falcon_irq_ack_a1(efx: *mut ef4_nic) {
...
#[no_mangle]
unsafe extern "C" fn falcon_legacy_interrupt_a1(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn falcon_spi_poll(efx: *mut ef4_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn falcon_spi_wait(efx: *mut ef4_nic) -> c_int {
...
// control, so we allow up to 100 ms.
    let mut timeout: c_ulong = jiffies + 1 + DIV_ROUND_UP(HZ, 10);
    int i;
    for (i = 0; i < 10; i++) {
    ...
    {
    let mut addressed: bool = (address >= 0);
    let mut reading: bool = (out != core::ptr::null_mut());
    ef4_oword_t reg;
    int rc;
// Input validation
...
// Read data
    ...
    rc = falcon_spi_cmd(efx, spi, command, start + pos, core::ptr::null_mut(),
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct falcon_mtd_partition {
    pub common: ef4_mtd_partition,
    pub spi: *const falcon_spi_device,
    pub offset: usize,
}
...
// Wait up to 10 ms for buffered write completion
    ...
    {
    let mut timeout: c_ulong = jiffies + 1 + DIV_ROUND_UP(HZ, 100);
    u8 status;
    int rc;
    for (;;) {
    rc = falcon_spi_cmd(efx, spi, SPI_RDSR, -1, core::ptr::null_mut(),
    ...
    let mut rc: c_int = 0;
    while (pos < len) {
    rc = falcon_spi_cmd(efx, spi, SPI_WREN, -1, core::ptr::null_mut(), core::ptr::null_mut(), 0);
    if (rc)
    break;
    ...
    buffer + pos, core::ptr::null_mut(), block_len);
    if (rc)
    break;
    ...
    command = falcon_spi_munge_command(spi, SPI_READ, start + pos);
    rc = falcon_spi_cmd(efx, spi, command, start + pos,
    core::ptr::null_mut(), verify_buffer, block_len);
...
// Wait up to 4s for flash/EEPROM to finish a slow operation.
    ...
    if (rc)
    return rc;
    rc = falcon_spi_cmd(efx, spi, SPI_SST_EWSR, -1, core::ptr::null_mut(), core::ptr::null_mut(), 0);
    if (rc)
    return rc;
    status &= ~unlock_mask;
    rc = falcon_spi_cmd(efx, spi, SPI_WRSR, -1, &status,
    core::ptr::null_mut(), sizeof(status));
    if (rc)
    return rc;
    rc = falcon_spi_wait_write(efx, spi);
    if (rc)
...
pub const FALCON_SPI_VERIFY_BUF_LEN: c_int = 16;
    static int
    ...
    if (rc)
    return rc;
    rc = falcon_spi_cmd(efx, spi, spi.erase_command, start, core::ptr::null_mut(),
    core::ptr::null_mut(), 0);
    if (rc)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn falcon_mtd_rename(part: *mut ef4_mtd_partition) {
...
#[no_mangle]
unsafe extern "C" fn falcon_mtd_erase(mtd: *mut mtd_info, start: loff_t, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn falcon_mtd_sync(mtd: *mut mtd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn falcon_mtd_probe(efx: *mut ef4_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn falcon_setup_xaui(efx: *mut ef4_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn falcon_reset_xaui(efx: *mut ef4_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn falcon_ack_status_intr(efx: *mut ef4_nic) {
...
#[no_mangle]
unsafe extern "C" fn falcon_xgxs_link_ok(efx: *mut ef4_nic) -> bool {
...
#[no_mangle]
unsafe extern "C" fn falcon_xmac_link_ok(efx: *mut ef4_nic) -> bool {
...
#[no_mangle]
unsafe extern "C" fn falcon_reconfigure_xmac_core(efx: *mut ef4_nic) {
    static void falcon_reconfigure_xmac_core(struct ef4_nic *efx)
    {
    unsigned int max_frame_len;
    ef4_oword_t reg;
    let mut rx_fc: bool = !!(efx.link_state.fc & EF4_FC_RX);
    let mut tx_fc: bool = !!(efx.link_state.fc & EF4_FC_TX);
...
#[no_mangle]
unsafe extern "C" fn falcon_reconfigure_xgxs_core(efx: *mut ef4_nic) {
    static void falcon_reconfigure_xgxs_core(struct ef4_nic *efx)
    {
    ef4_oword_t reg;
    let mut xgxs_loopback: bool = (efx.loopback_mode == LOOPBACK_XGXS);
    let mut xaui_loopback: bool = (efx.loopback_mode == LOOPBACK_XAUI);
    let mut xgmii_loopback: bool = (efx.loopback_mode == LOOPBACK_XGMII);
...
#[no_mangle]
unsafe extern "C" fn falcon_xmac_link_ok_retry(efx: *mut ef4_nic, tries: c_int) -> bool {
    static bool falcon_xmac_link_ok_retry(struct ef4_nic *efx, int tries)
    {
    let mut mac_up: bool = falcon_xmac_link_ok(efx);
...
#[no_mangle]
unsafe extern "C" fn falcon_xmac_check_fault(efx: *mut ef4_nic) -> bool {
    static bool falcon_xmac_check_fault(struct ef4_nic *efx)
    {
    return !falcon_xmac_link_ok_retry(efx, 5);
    }
#[no_mangle]
unsafe extern "C" fn falcon_reconfigure_xmac(efx: *mut ef4_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn falcon_poll_xmac(efx: *mut ef4_nic) {
...
//
#[no_mangle]
unsafe extern "C" fn falcon_push_multicast_hash(efx: *mut ef4_nic) {
...
#[no_mangle]
unsafe extern "C" fn falcon_reset_macs(efx: *mut ef4_nic) {
...
#[no_mangle]
unsafe extern "C" fn falcon_drain_tx_fifo(efx: *mut ef4_nic) {
...
#[no_mangle]
unsafe extern "C" fn falcon_deconfigure_mac_wrapper(efx: *mut ef4_nic) {
    static void falcon_deconfigure_mac_wrapper(struct ef4_nic *efx)
    {
    ef4_oword_t reg;
    if (ef4_nic_rev(efx) < EF4_REV_FALCON_B0)
...
#[no_mangle]
unsafe extern "C" fn falcon_reconfigure_mac_wrapper(efx: *mut ef4_nic) {
...
#[no_mangle]
unsafe extern "C" fn falcon_stats_request(efx: *mut ef4_nic) {
...
#[no_mangle]
unsafe extern "C" fn falcon_stats_complete(efx: *mut ef4_nic) {
...
#[no_mangle]
unsafe extern "C" fn falcon_stats_timer_func(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn falcon_loopback_link_poll(efx: *mut ef4_nic) -> bool {
...
#[no_mangle]
unsafe extern "C" fn falcon_reconfigure_port(efx: *mut ef4_nic) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn falcon_a1_prepare_enable_fc_tx(efx: *mut ef4_nic) {
...
#[no_mangle]
unsafe extern "C" fn falcon_b0_prepare_enable_fc_tx(efx: *mut ef4_nic) {
...
#[no_mangle]
unsafe extern "C" fn falcon_gmii_wait(efx: *mut ef4_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn falcon_probe_port(efx: *mut ef4_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn falcon_remove_port(efx: *mut ef4_nic) {
...
//
    ...
    spi = &nic_data.spi_flash;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: falcon_spi_present(&nic_data->spi_eeprom)) -> else {
    ...
    mutex_lock(&nic_data.spi_lock);
    rc = falcon_spi_read(efx, spi, 0, FALCON_NVCONFIG_END, core::ptr::null_mut(), region);
    mutex_unlock(&nic_data.spi_lock);
    if (rc) {
...
#[no_mangle]
unsafe extern "C" fn falcon_test_nvram(efx: *mut ef4_nic) -> c_int {
    static int falcon_test_nvram(struct ef4_nic *efx)
    {
    return falcon_read_nvram(efx, core::ptr::null_mut());
    }
    ...
    {
    let mut reset_method: enum reset_type = RESET_TYPE_INVISIBLE;
    int rc, rc2;
...
//
#[no_mangle]
unsafe extern "C" fn falcon_map_reset_reason(reason: enum reset_type) -> enum reset_type {
...
#[no_mangle]
unsafe extern "C" fn falcon_map_reset_flags(flags: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __falcon_reset_hw(efx: *mut ef4_nic, method: enum reset_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn falcon_reset_hw(efx: *mut ef4_nic, method: enum reset_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn falcon_monitor(efx: *mut ef4_nic) {
...
//
#[no_mangle]
unsafe extern "C" fn falcon_reset_sram(efx: *mut ef4_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn falcon_probe_nvconfig(efx: *mut ef4_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn falcon_dimension_resources(efx: *mut ef4_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn falcon_probe_spi_devices(efx: *mut ef4_nic) {
...
#[no_mangle]
unsafe extern "C" fn falcon_a1_mem_map_size(efx: *mut ef4_nic) -> c_uint {
    static unsigned int falcon_a1_mem_map_size(struct ef4_nic *efx)
    {
    return 0x20000;
    }
#[no_mangle]
unsafe extern "C" fn falcon_b0_mem_map_size(efx: *mut ef4_nic) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn falcon_probe_nic(efx: *mut ef4_nic) -> c_int {
...
// Allocate storage for hardware specific data
    ...
    struct pci_dev *dev;
    let mut pci_rev: u8 = efx.pci_dev.revision;
...
// Initialise I2C adapter
    ...
    nic_data.pci_dev2 = core::ptr::null_mut();
    }
    fail2:
    fail1:
    kfree(efx.nic_data);
...
#[no_mangle]
unsafe extern "C" fn falcon_init_rx_cfg(efx: *mut ef4_nic) {
    static void falcon_init_rx_cfg(struct ef4_nic *efx)
    {
// RX control FIFO thresholds (32 entries)
    let mut ctrl_xon_thr: unsigned = 20;
    let mut ctrl_xoff_thr: unsigned = 25;
    ef4_oword_t reg;
    ef4_reado(efx, &reg, FR_AZ_RX_CFG);
    if (ef4_nic_rev(efx) <= EF4_REV_FALCON_A1) {
...
//
#[no_mangle]
unsafe extern "C" fn falcon_init_nic(efx: *mut ef4_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn falcon_remove_nic(efx: *mut ef4_nic) {
...
// Tear down the private nic state
    kfree(efx.nic_data);
    efx.nic_data = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn falcon_describe_nic_stats(efx: *mut ef4_nic, names: *mut u8) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn falcon_start_nic_stats(efx: *mut ef4_nic) {
...
//
#[no_mangle]
unsafe extern "C" fn falcon_pull_nic_stats(efx: *mut ef4_nic) {
    static void falcon_pull_nic_stats(struct ef4_nic *efx)
    {
    msleep(10);
    }
#[no_mangle]
pub unsafe extern "C" fn falcon_stop_nic_stats(efx: *mut ef4_nic) {
...
#[no_mangle]
unsafe extern "C" fn falcon_set_id_led(efx: *mut ef4_nic, mode: enum ef4_led_mode) {
...
//
#[no_mangle]
unsafe extern "C" fn falcon_get_wol(efx: *mut ef4_nic, wol: *mut ethtool_wolinfo) {
...
#[no_mangle]
unsafe extern "C" fn falcon_set_wol(efx: *mut ef4_nic, type: u32) -> c_int {
