...
//! Source: drivers/net/ethernet/sfc/falcon/ethtool.c
#![no_std]
...
pub struct ef4_sw_stat_desc {
    ...
    pub source: },
    pub offset: unsigned,
    pub /: *mut *mut *mut *mut u64(get_stat) (void field); / Reader function,
}
...
#[no_mangle]
unsafe extern "C" fn ef4_get_uint_stat(field: *mut c_void) -> u64 {
    static u64 ef4_get_uint_stat(void *field)
    {
    return *(unsigned int *)field;
    }
#[no_mangle]
unsafe extern "C" fn ef4_get_atomic_stat(field: *mut c_void) -> u64 {
...
pub const EF4_ETHTOOL_EEPROM_MAGIC: c_uint = 0xEFAB;
//
// Ethtool operations
//
// Identify device by flashing LEDs
    ...
    let mut mode: enum ef4_led_mode = EF4_LED_DEFAULT;
    switch (state) {
    case ETHTOOL_ID_ON:
    mode = EF4_LED_ON;
    break;
...
#[no_mangle]
unsafe extern "C" fn ef4_ethtool_get_regs_len(net_dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ef4_ethtool_get_msglevel(net_dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ef4_ethtool_set_msglevel(net_dev: *mut net_device, msg_enable: u32) {
...
//
    ...
    {
    struct ef4_channel *channel;
    let mut n: c_uint = 0, i;
    enum ef4_loopback_mode mode;
    ef4_fill_test(n++, strings, data, &tests.phy_alive,
    "phy", 0, "alive", core::ptr::null_mut());
    ef4_fill_test(n++, strings, data, &tests.nvram,
    "core", 0, "nvram", core::ptr::null_mut());
    ef4_fill_test(n++, strings, data, &tests.interrupt,
    "core", 0, "interrupt", core::ptr::null_mut());
// Event queues
    ef4_for_each_channel(channel, efx) {
    ef4_fill_test(n++, strings, data,
    &tests.eventq_dma[channel.channel],
    EF4_CHANNEL_NAME(channel),
    "eventq.dma", core::ptr::null_mut());
    ef4_fill_test(n++, strings, data,
    &tests.eventq_int[channel.channel],
    EF4_CHANNEL_NAME(channel),
    "eventq.int", core::ptr::null_mut());
    }
    ef4_fill_test(n++, strings, data, &tests.memory,
    "core", 0, "memory", core::ptr::null_mut());
    ef4_fill_test(n++, strings, data, &tests.registers,
    "core", 0, "registers", core::ptr::null_mut());
    if (efx.phy_op.run_tests != core::ptr::null_mut()) {
    EF4_BUG_ON_PARANOID(efx.phy_op.test_name == core::ptr::null_mut());
    for (i = 0; true; ++i) {
    const char *name;
...
#[no_mangle]
unsafe extern "C" fn ef4_describe_per_queue_stats(efx: *mut ef4_nic, strings: *mut u8) -> usize {
    static size_t ef4_describe_per_queue_stats(struct ef4_nic *efx, u8 **strings)
    {
    let mut n_stats: usize = 0;
    struct ef4_channel *channel;
    ef4_for_each_channel(channel, efx) {
    ...
    switch (string_set) {
    case ETH_SS_STATS:
    return efx.type.describe_stats(efx, core::ptr::null_mut()) +
    EF4_ETHTOOL_SW_STAT_COUNT +
    ef4_describe_per_queue_stats(efx, core::ptr::null_mut());
    case ETH_SS_TEST:
    return ef4_ethtool_fill_self_tests(efx, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    default:
    return -EINVAL;
    }
    }
    ...
    break;
    case ETH_SS_TEST:
    ef4_ethtool_fill_self_tests(efx, core::ptr::null_mut(), strings, core::ptr::null_mut());
    break;
    default:
...
// Get NIC statistics
    data += efx.type.update_stats(efx, data, core::ptr::null_mut());
...
// We need rx buffers and interrupts.
    ...
    if (!already_up) {
    rc = dev_open(efx.net_dev, core::ptr::null_mut());
    if (rc) {
    ...
    (test.flags & ETH_TEST_FL_OFFLINE) ? "off" : "on");
    out:
    ef4_ethtool_fill_self_tests(efx, ef4_tests, core::ptr::null_mut(), data);
    kfree(ef4_tests);
    fail:
    if (rc)
...
#[no_mangle]
unsafe extern "C" fn ef4_ethtool_nway_reset(net_dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ef4_ethtool_reset(net_dev: *mut net_device, flags: *mut u32) -> c_int {
...
pub const IP_PROTO_FULL_MASK: c_uint = 0xFF;

#[no_mangle]
pub unsafe extern "C" fn ip6_fill_mask(mask: *mut __be32) {
...
#[no_mangle]
unsafe extern "C" fn ef4_ethtool_get_rx_ring_count(net_dev: *mut net_device) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ip6_mask_is_full(mask[4]: __be32) -> bool {
    static inline bool ip6_mask_is_full(__be32 mask[4])
    {
    return !~(mask[0] & mask[1] & mask[2] & mask[3]);
    }
#[no_mangle]
pub unsafe extern "C" fn ip6_mask_is_empty(mask[4]: __be32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_broadcast_ether_addr(mac_mask->h_dest)) -> else {
...
#[no_mangle]
unsafe extern "C" fn ef4_ethtool_get_rxfh_indir_size(net_dev: *mut net_device) -> u32 {
