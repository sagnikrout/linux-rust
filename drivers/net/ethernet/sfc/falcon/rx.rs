...
//! Source: drivers/net/ethernet/sfc/falcon/rx.c
#![no_std]
...
//
pub const EF4_RECYCLE_RING_SIZE_IOMMU: c_int = 4096;
...
#[no_mangle]
pub unsafe extern "C" fn ef4_rx_buf_hash(efx: *mut ef4_nic, eh: *const u8) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_rx_config_page_split(efx: *mut ef4_nic) {
...
// Check the RX page recycle ring for a page that can be reused.
    ...
    return core::ptr::null_mut();
    rx_queue.page_ring[index] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ef4_init_rx_buffers(rx_queue: *mut ef4_rx_queue, atomic: bool) -> c_int {
...
// Only recycle the page after processing the final buffer.
    ...
    if (rx_queue.page_ring[index] == core::ptr::null_mut()) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ef4_fast_push_rx_descriptors(rx_queue: *mut ef4_rx_queue, atomic: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_rx_slow_fill(t: *mut timer_list) {
...
// Post an event to cause NAPI to run and refill the queue
    ...
    {
    struct ef4_nic *efx = rx_queue.efx;
    let mut max_len: unsigned = rx_buf.len - efx.type.rx_buffer_padding;
...
//
    let mut tail_frags: c_uint = n_frags - 1;
    for (;;) {
    rx_buf = ef4_rx_buf_next(rx_queue, rx_buf);
    if (--tail_frags == 0)
    break;
...
//
    ...
    {
    struct sk_buff *skb;
    let mut hdr_len: u16 = min_t(u16, rx_buf.len, EF4_SKB_HEADERS);
...
#[no_mangle]
pub unsafe extern "C" fn __ef4_rx_packet(channel: *mut ef4_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_probe_rx_queue(rx_queue: *mut ef4_rx_queue) -> c_int {
...
// Allocate RX buffers
    ...
    rx_queue.buffer = core::ptr::null_mut();
    }
    return rc;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ef4_init_rx_queue(rx_queue: *mut ef4_rx_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn ef4_fini_rx_queue(rx_queue: *mut ef4_rx_queue) {
...
// Release RX buffers from the current read ptr to the write ptr
    ...
    i++) {
    let mut index: unsigned = i & rx_queue.ptr_mask;
    rx_buf = ef4_rx_buffer(rx_queue, index);
...
// Unmap and release the pages in the recycle ring. Remove the ring.
    ...
    rx_queue.page_ring = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn ef4_remove_rx_queue(rx_queue: *mut ef4_rx_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn __ef4_filter_rfs_expire(efx: *mut ef4_nic, quota: c_uint) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ef4_filter_is_mc_recipient(spec: *const ef4_filter_spec) -> bool {
