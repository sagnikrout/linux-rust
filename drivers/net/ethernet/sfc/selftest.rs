...
//! Source: drivers/net/ethernet/sfc/selftest.h
#![no_std]
...
extern "C" {
    pub fn efx_selftest_async_init(efx: *mut efx_nic);
}
extern "C" {
    pub fn efx_selftest_async_start(efx: *mut efx_nic);
}
extern "C" {
    pub fn efx_selftest_async_cancel(efx: *mut efx_nic);
}
