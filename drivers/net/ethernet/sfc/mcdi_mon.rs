...
//! Source: drivers/net/ethernet/sfc/mcdi_mon.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn efx_mcdi_sensor_event(efx: *mut efx_nic, ev: *mut efx_qword_t) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_mcdi_mon_probe(efx: *mut efx_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efx_mcdi_mon_remove(efx: *mut efx_nic) {
