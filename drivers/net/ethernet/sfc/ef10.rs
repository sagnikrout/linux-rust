...
//! Source: drivers/net/ethernet/sfc/ef10.c
#![no_std]
...
pub const EFX_EF10_DRVGEN_EV: c_int = 7;
    enum {
    EFX_EF10_TEST = 1,
    EFX_EF10_REFILL,
    };
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_get_warm_boot_count(efx: *mut efx_nic) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn efx_ef10_pf_mem_bar(efx: *mut efx_nic) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_vf_mem_bar(efx: *mut efx_nic) -> c_uint {
    static unsigned int efx_ef10_vf_mem_bar(struct efx_nic *efx)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn efx_ef10_mem_map_size(efx: *mut efx_nic) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_is_vf(efx: *mut efx_nic) -> bool {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_get_vf_index(efx: *mut efx_nic) -> c_int {
    ...
    size_t outlen;
    int rc;
    rc = efx_mcdi_rpc(efx, MC_CMD_GET_FUNCTION_INFO, core::ptr::null_mut(), 0, outbuf,
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_init_datapath_caps(efx: *mut efx_nic) -> c_int {
    ...
    rc = efx_mcdi_rpc(efx, MC_CMD_GET_CAPABILITIES, core::ptr::null_mut(), 0,
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_read_licensed_features(efx: *mut efx_nic) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_get_sysclk_freq(efx: *mut efx_nic) -> c_int {
    static int efx_ef10_get_sysclk_freq(struct efx_nic *efx)
    {
    MCDI_DECLARE_BUF(outbuf, MC_CMD_GET_CLOCK_OUT_LEN);
    int rc;
    rc = efx_mcdi_rpc(efx, MC_CMD_GET_CLOCK, core::ptr::null_mut(), 0,
    outbuf, sizeof(outbuf), core::ptr::null_mut());
    if (rc)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_get_timer_workarounds(efx: *mut efx_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_get_timer_config(efx: *mut efx_nic) -> c_int {
    ...
    if (rc)
    return rc;
    rc = efx_mcdi_rpc_quiet(efx, MC_CMD_GET_EVQ_TMR_PROPERTIES, core::ptr::null_mut(), 0,
    outbuf, sizeof(outbuf), core::ptr::null_mut());
    if (rc == 0) {
...
// Not available - fall back to Huntington defaults.
    ...
    core::ptr::null_mut(), 0, rc);
    }
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn efx_ef10_get_mac_address_pf(efx: *mut efx_nic, mac_address: *mut u8) -> c_int {
    ...
    rc = efx_mcdi_rpc(efx, MC_CMD_GET_MAC_ADDRESSES, core::ptr::null_mut(), 0,
    outbuf, sizeof(outbuf), &outlen);
    if (rc)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_get_mac_address_vf(efx: *mut efx_nic, mac_address: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_add_vlan(efx: *mut efx_nic, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_del_vlan(efx: *mut efx_nic, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_cleanup_vlans(efx: *mut efx_nic) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_probe(efx: *mut efx_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_free_piobufs(efx: *mut efx_nic) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_alloc_piobufs(efx: *mut efx_nic, n: c_uint) -> c_int {
    ...
    for (i = 0; i < n; i++) {
    rc = efx_mcdi_rpc_quiet(efx, MC_CMD_ALLOC_PIOBUF, core::ptr::null_mut(), 0,
    outbuf, sizeof(outbuf), &outlen);
    if (rc) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_link_piobufs(efx: *mut efx_nic) -> c_int {
...
//
    ...
    tx_queue.piobuf = core::ptr::null_mut();
    } else {
    tx_queue.piobuf =
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_forget_old_piobufs(efx: *mut efx_nic) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_remove(efx: *mut efx_nic) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_probe_pf(efx: *mut efx_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efx_ef10_vadaptor_alloc(efx: *mut efx_nic, port_id: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efx_ef10_vadaptor_free(efx: *mut efx_nic, port_id: c_uint) -> c_int {
    ...
    sizeof(inbuf), core::ptr::null_mut(), 0, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_probe_vf(efx: *mut efx_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_probe_vf(((unused)): *mut *mut efx_nic efx __attribute__) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn efx_ef10_dimension_resources(efx: *mut efx_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(-EPERM: rc ==) -> else {
    else if (rc == -EPERM)
    netif_dbg(efx, probe, efx.net_dev,
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_fini_nic(efx: *mut efx_nic) {
    static void efx_ef10_fini_nic(struct efx_nic *efx)
    {
    struct efx_ef10_nic_data *nic_data = efx.nic_data;
    spin_lock_bh(&efx.stats_lock);
    kfree(nic_data.mc_stats);
    nic_data.mc_stats = core::ptr::null_mut();
    spin_unlock_bh(&efx.stats_lock);
    }
#[no_mangle]
unsafe extern "C" fn efx_ef10_init_nic(efx: *mut efx_nic) -> c_int {
...
// don't fail init if RSS setup doesn't work
    ...
    efx.rss_context.rx_indir_table, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn efx_ef10_table_reset_mc_allocations(efx: *mut efx_nic) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_map_reset_reason(reason: enum reset_type) -> enum reset_type {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_map_reset_flags(flags: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_reset(efx: *mut efx_nic, reset_type: enum reset_type) -> c_int {
    static int efx_ef10_reset(struct efx_nic *efx, enum reset_type reset_type)
    {
    let mut rc: c_int = efx_mcdi_reset(efx, reset_type);
...
//
    ...
    [EF10_STAT_ ## int_name] =				\
    { core::ptr::null_mut(), 64, 8 * MC_CMD_MAC_ ## mcdi_name }
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_raw_stat_mask(efx: *mut efx_nic) -> u64 {
    static u64 efx_ef10_raw_stat_mask(struct efx_nic *efx)
    {
    let mut raw_mask: u64 = HUNT_COMMON_STAT_MASK;
    let mut port_caps: u32 = efx_mcdi_phy_get_caps(efx);
    struct efx_ef10_nic_data *nic_data = efx.nic_data;
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_get_stat_mask(efx: *mut efx_nic, mask: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_describe_stats(efx: *mut efx_nic, names: *mut u8) -> usize {
    ...
    struct efx_ef10_nic_data *nic_data = efx.nic_data;
    u64 *stats = nic_data.stats;
    let mut stats_count: usize = 0, index;
    efx_ef10_get_stat_mask(efx, mask);
    if (full_stats) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_try_update_nic_stats_vf(efx: *mut efx_nic) -> c_int {
    ...
    u64 *stats = nic_data.stats;
    let mut dma_len: u32 = efx.num_mac_stats * sizeof(u64);
...
// Expect ENOENT if DMA queues have not been set up
    ...
    sizeof(inbuf), core::ptr::null_mut(), 0, rc);
    goto out;
    }
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_push_irq_moderation(channel: *mut efx_channel) {
    ...
    inbuf, sizeof(inbuf), 0, core::ptr::null_mut(), 0);
    } else if (EFX_EF10_WORKAROUND_35388(efx)) {
    let mut ticks: c_uint = efx_usecs_to_ticks(efx, usecs);
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_set_wol_vf(efx: *mut efx_nic, type: u32) -> c_int {
    static int efx_ef10_set_wol_vf(struct efx_nic *efx, u32 type)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn efx_ef10_get_wol(efx: *mut efx_nic, wol: *mut ethtool_wolinfo) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_set_wol(efx: *mut efx_nic, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_mcdi_poll_response(efx: *mut efx_nic) -> bool {
    static bool efx_ef10_mcdi_poll_response(struct efx_nic *efx)
    {
    struct efx_ef10_nic_data *nic_data = efx.nic_data;
    let mut hdr: efx_dword_t = *(const efx_dword_t *)nic_data.mcdi_buf.addr;
    rmb();
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_mcdi_reboot_detected(efx: *mut efx_nic) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_mcdi_poll_reboot(efx: *mut efx_nic) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn efx_ef10_msi_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_legacy_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t efx_ef10_legacy_interrupt(int irq, void *dev_id)
    {
    struct efx_nic *efx = dev_id;
    let mut soft_enabled: bool = READ_ONCE(efx.irq_soft_enabled);
    struct efx_channel *channel;
    efx_dword_t reg;
    u32 queues;
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_irq_test_generate(efx: *mut efx_nic) -> c_int {
    ...
    inbuf, sizeof(inbuf), core::ptr::null_mut(), 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn efx_ef10_tx_probe(tx_queue: *mut efx_tx_queue) -> c_int {
...
//
    ...
    let mut inner_ipv4_id: u16 = 0;
    let mut outer_ipv4_id: u16 = 0;
    struct tcphdr *tcp;
    struct iphdr *ip;
    u16 ip_tot_len;
    u32 seqnum;
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_tso_versions(efx: *mut efx_nic) -> u32 {
    static u32 efx_ef10_tso_versions(struct efx_nic *efx)
    {
    struct efx_ef10_nic_data *nic_data = efx.nic_data;
    let mut tso_versions: u32 = 0;
    if (nic_data.datapath_caps &
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_tx_init(tx_queue: *mut efx_tx_queue) {
    static void efx_ef10_tx_init(struct efx_tx_queue *tx_queue)
    {
    let mut csum_offload: bool = tx_queue.type & EFX_TXQ_TYPE_OUTER_CSUM;
    let mut inner_csum: bool = tx_queue.type & EFX_TXQ_TYPE_INNER_CSUM;
...
#[no_mangle]
pub unsafe extern "C" fn efx_ef10_notify_tx_desc(tx_queue: *mut efx_tx_queue) {
...
pub const EFX_EF10_MAX_TX_DESCRIPTOR_LEN: c_uint = 0x3fff;
...
//
    let mut end: dma_addr_t = dma_addr + EFX_EF10_MAX_TX_DESCRIPTOR_LEN;
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_tx_write(tx_queue: *mut efx_tx_queue) {
    static void efx_ef10_tx_write(struct efx_tx_queue *tx_queue)
    {
    let mut old_write_count: c_uint = tx_queue.write_count;
    struct efx_tx_buffer *buffer;
    unsigned int write_ptr;
    efx_qword_t *txd;
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_probe_multicast_chaining(efx: *mut efx_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_filter_table_probe(efx: *mut efx_nic) -> c_int {
    static int efx_ef10_filter_table_probe(struct efx_nic *efx)
    {
    struct efx_ef10_nic_data *nic_data = efx.nic_data;
    let mut rc: c_int = efx_ef10_probe_multicast_chaining(efx);
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_filter_table_remove(efx: *mut efx_nic) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_rx_write(rx_queue: *mut efx_rx_queue) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_rx_defer_refill(rx_queue: *mut efx_rx_queue) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_ev_init(channel: *mut efx_channel) -> c_int {
    ...
    {
    let mut dropped: c_uint = (actual - expected) & rx_queue.ptr_mask;
    struct efx_nic *efx = rx_queue.efx;
    netif_info(efx, hw, efx.net_dev,
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_handle_rx_abort(rx_queue: *mut efx_rx_queue) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_extract_event_ts(event: *mut efx_qword_t) -> u32 {
...
pub const EFX_NAPI_MAX_TX: c_int = 512;
#[no_mangle]
unsafe extern "C" fn efx_ef10_ev_process(channel: *mut efx_channel, quota: c_int) -> c_int {
    static int efx_ef10_ev_process(struct efx_channel *channel, int quota)
    {
    struct efx_nic *efx = channel.efx;
    efx_qword_t event, *p_event;
    unsigned int read_ptr;
    let mut spent_tx: c_int = 0;
    let mut spent: c_int = 0;
    int ev_code;
    if (quota <= 0)
    return spent;
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_ev_read_ack(channel: *mut efx_channel) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_ev_test_generate(channel: *mut efx_channel) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_prepare_flr(efx: *mut efx_nic) {
    static void efx_ef10_prepare_flr(struct efx_nic *efx)
    {
    atomic_set(&efx.active_queues, 0);
    }
#[no_mangle]
unsafe extern "C" fn efx_ef10_vport_set_mac_address(efx: *mut efx_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_set_mac_address(efx: *mut efx_nic) -> c_int {
    static int efx_ef10_set_mac_address(struct efx_nic *efx)
    {
    MCDI_DECLARE_BUF(inbuf, MC_CMD_VADAPTOR_SET_MAC_IN_LEN);
    let mut was_enabled: bool = efx.port_enabled;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_mac_reconfigure(efx: *mut efx_nic, mtu_only: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_start_bist(efx: *mut efx_nic, bist_type: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn efx_ef10_poll_bist(efx: *mut efx_nic) -> c_int {
    ...
    size_t outlen;
    u32 result;
    rc = efx_mcdi_rpc(efx, MC_CMD_POLL_BIST, core::ptr::null_mut(), 0,
    outbuf, sizeof(outbuf), &outlen);
    if (rc != 0)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_run_bist(efx: *mut efx_nic, bist_type: u32) -> c_int {
    ...
    core::ptr::null_mut(), 0, core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (rc != 0)
    goto out;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct efx_ef10_nvram_type_info {
    pub type_mask: u16 type,,
    pub port: u8,
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_mtd_probe(efx: *mut efx_nic) -> c_int {
    ...
    rc = efx_mcdi_rpc(efx, MC_CMD_NVRAM_PARTITIONS, core::ptr::null_mut(), 0,
    outbuf, sizeof(outbuf), &outlen);
    if (rc)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_ptp_write_host_time(efx: *mut efx_nic, host_time: u32) {
    ...
    if (channel) {
    let mut rc: c_int = set(channel, temp);
    if (en && rc != 0) {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_vlan_rx_add_vid(efx: *mut efx_nic, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_vlan_rx_kill_vid(efx: *mut efx_nic, proto: __be16, vid: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn efx_ef10_set_udp_tnl_ports(efx: *mut efx_nic, unloading: bool) -> c_int {
    static int efx_ef10_set_udp_tnl_ports(struct efx_nic *efx, bool unloading)
    {
    struct efx_ef10_nic_data *nic_data = efx.nic_data;
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_udp_tnl_push_ports(efx: *mut efx_nic) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn efx_ef10_udp_tnl_has_port(efx: *mut efx_nic, port: __be16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn efx_ef10_recycle_ring_size(efx: *const efx_nic) -> c_uint {
    static unsigned int efx_ef10_recycle_ring_size(const struct efx_nic *efx)
    {
    let mut ret: c_uint = EFX_RECYCLE_RING_SIZE_10G;
