...
//! Source: drivers/net/ethernet/sfc/mtd.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn efx_mtd_remove_partition(part: *mut efx_mtd_partition) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_mtd_remove(efx: *mut efx_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn efx_mtd_rename(efx: *mut efx_nic) {
