...
//! Source: drivers/net/ethernet/sfc/net_driver.h
#![no_std]
...
pub const EFX_EXTRA_CHANNEL_TC: c_int = 2;
...
pub const EFX_TXQ_TYPES: c_int = 4;
...
pub const EFX_TX_BUF_EFV: c_uint = 0x100	/* buffer was sent from representor */;
//
...
// Members which don't change on the fast path
    ...
    pub xdp_tx: bool,
    pub old_complete_packets: c_ulong,
    pub old_complete_bytes: c_ulong,
    pub old_tso_bursts: c_uint,
    pub old_tso_packets: c_uint,
// Members used mainly on the completion path
    ...
    pub complete_packets: c_ulong,
    pub complete_bytes: c_ulong,
    pub complete_xdp_packets: c_ulong,
    pub complete_xdp_bytes: c_ulong,
...
pub struct efx_rx_queue {
    ...
    pub grant_work: work_struct,
// Statistics to supplement MAC stats
    pub rx_packets: c_ulong,
    pub rx_bytes: c_ulong,
    pub old_rx_packets: c_ulong,
    pub old_rx_bytes: c_ulong,
...
pub const RPS_FLOW_ID_INVALID: c_uint = 0xFFFFFFFF;
    ...
    pub n_rx_mport_bad: c_uint,
    pub old_n_rx_hw_drops: c_uint,
    pub old_n_rx_hw_drop_overruns: c_uint,
...
pub struct efx_channel_type {
    ...
    pub ): *mut *mut int (start)(struct efx_channel,
    pub ): *mut *mut void (stop)(struct efx_channel,
    ...
    pub u32): *mut *mut *mut bool (receive_raw)(struct efx_rx_queue ,,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct efx_rss_context_priv {
    pub context_id: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct efx_probe_data {
    pub pci_dev: *mut pci_dev,
    pub efx: efx_nic,

    pub cxl: *mut efx_cxl,
    pub cxl_pio_initialised: bool,
...
pub struct efx_nic_type {
    ...
    pub delete): *const *const u8 key, bool,
    pub ctx): *mut efx_rss_context,
    pub efx): *mut *mut void (rx_restore_rss_contexts)(struct efx_nic,
