...
//! Source: drivers/net/ethernet/cavium/thunder/nicvf_ethtool.c
#![no_std]
...
pub struct nicvf_stat {
    ...
    let mut nicvf_n_hw_stats: static unsigned int = ARRAY_SIZE(nicvf_hw_stats);
    let mut nicvf_n_drv_stats: static unsigned int = ARRAY_SIZE(nicvf_drv_stats);
    let mut nicvf_n_queue_stats: static unsigned int = ARRAY_SIZE(nicvf_queue_stats);
...
#[no_mangle]
unsafe extern "C" fn nicvf_get_link(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nicvf_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nicvf_set_msglevel(netdev: *mut net_device, lvl: u32) {
...
#[no_mangle]
unsafe extern "C" fn nicvf_get_qset_strings(nic: *mut nicvf, data: *mut u8, qset: c_int) {
    static void nicvf_get_qset_strings(struct nicvf *nic, u8 **data, int qset)
    {
    int stats, qidx;
    let mut start_qidx: c_int = qset * MAX_RCV_QUEUES_PER_QS;
...
#[no_mangle]
unsafe extern "C" fn nicvf_get_strings(netdev: *mut net_device, sset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn nicvf_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nicvf_get_regs_len(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nicvf_get_rx_ring_count(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nicvf_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
    static u32 nicvf_get_rxfh_key_size(struct net_device *netdev)
    {
    return RSS_HASH_KEY_SIZE * sizeof(u64);
    }
#[no_mangle]
unsafe extern "C" fn nicvf_get_rxfh_indir_size(dev: *mut net_device) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn nicvf_set_ethtool_ops(netdev: *mut net_device) {
