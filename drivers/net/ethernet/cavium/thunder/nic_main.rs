...
//! Source: drivers/net/ethernet/cavium/thunder/nic_main.c
#![no_std]
...
pub const NIC_VF_PER_MBX_REG: c_int = 64;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hw_info {
    pub bgx_cnt: u8,
    pub chans_per_lmac: u8,
    pub /: *mut *mut u8 chans_per_bgx; / Rx/Tx chans,
    pub chans_per_rgx: u8,
    pub chans_per_lbk: u8,
    pub cpi_cnt: u16,
    pub rssi_cnt: u16,
    ...
    pub tl2_cnt: u8,
    pub tl1_cnt: u8,
    pub /: *mut *mut bool tl1_per_bgx; / TL1 per BGX or per LMAC,
}
...
pub struct nicpf {
    ...
    pub node: u8,
    pub flags: c_uint,
    pub /: *mut *mut u8 num_vf_en; / No of VF enabled,
    pub vf_enabled: [bool; MAX_NUM_VFS_SUPPORTED],
    pub /: *mut *mut *mut void __iomem reg_base; / Register start address,
    pub /: *mut *mut u8 num_sqs_en; / Secondary qsets enabled,
    pub nicvf: [u64; MAX_NUM_VFS_SUPPORTED],
    pub vf_sqs: [u8; MAX_NUM_VFS_SUPPORTED][MAX_SQS_PER_VF],
    pub pqs_vf: [u8; MAX_NUM_VFS_SUPPORTED],
    pub sqs_used: [bool; MAX_NUM_VFS_SUPPORTED],
    pub pkind: pkind_cfg,

    pub vf_lmac_map: *mut u8,
    pub cpi_base: [u16; MAX_NUM_VFS_SUPPORTED],
    pub rssi_base: [u16; MAX_NUM_VFS_SUPPORTED],
// MSI-X
    pub num_vec: u8,
    pub irq_allocated: [c_uint; NIC_PF_MSIX_VECTORS],
    pub irq_name: [c_char; NIC_PF_MSIX_VECTORS][20],
}
...
#[no_mangle]
unsafe extern "C" fn nic_reg_write(nic: *mut nicpf, offset: u64, val: u64) {
    static void nic_reg_write(struct nicpf *nic, u64 offset, u64 val)
    {
    writeq_relaxed(val, nic.reg_base + offset);
    }
#[no_mangle]
unsafe extern "C" fn nic_reg_read(nic: *mut nicpf, offset: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn nic_enable_mbx_intr(nic: *mut nicpf) {
    static void nic_enable_mbx_intr(struct nicpf *nic)
    {
    let mut vf_cnt: c_int = pci_sriov_get_totalvfs(nic.pdev);
...
#[no_mangle]
unsafe extern "C" fn nic_clear_mbx_intr(nic: *mut nicpf, vf: c_int, mbx_reg: c_int) {
    static void nic_clear_mbx_intr(struct nicpf *nic, int vf, int mbx_reg)
    {
    nic_reg_write(nic, NIC_PF_MAILBOX_INT + (mbx_reg << 3), BIT_ULL(vf));
    }
#[no_mangle]
unsafe extern "C" fn nic_get_mbx_addr(vf: c_int) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn nic_send_msg_to_vf(nic: *mut nicpf, vf: c_int, mbx: *mut union nic_mbx) {
...
//
#[no_mangle]
unsafe extern "C" fn nic_mbx_send_ready(nic: *mut nicpf, vf: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn nic_mbx_send_ack(nic: *mut nicpf, vf: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn nic_mbx_send_nack(nic: *mut nicpf, vf: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn nic_rcv_queue_sw_sync(nic: *mut nicpf) -> c_int {
    static int nic_rcv_queue_sw_sync(struct nicpf *nic)
    {
    let mut timeout: u16 = ~0x00;
...
#[no_mangle]
unsafe extern "C" fn nic_get_bgx_stats(nic: *mut nicpf, bgx: *mut bgx_stats_msg) {
...
#[no_mangle]
unsafe extern "C" fn nic_update_hw_frs(nic: *mut nicpf, new_frs: c_int, vf: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nic_set_tx_pkt_pad(nic: *mut nicpf, size: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn nic_set_lmac_vf_mapping(nic: *mut nicpf) {
    static void nic_set_lmac_vf_mapping(struct nicpf *nic)
    {
    let mut bgx_map: unsigned = bgx_get_map(nic.node);
...
#[no_mangle]
unsafe extern "C" fn nic_get_hw_info(nic: *mut nicpf) {
...
pub const BGX0_BLOCK: c_int = 8;
pub const BGX1_BLOCK: c_int = 9;
#[no_mangle]
unsafe extern "C" fn nic_init_hw(nic: *mut nicpf) {
...
#[no_mangle]
unsafe extern "C" fn nic_config_cpi(nic: *mut nicpf, cfg: *mut cpi_cfg_msg) {
...
// MPI index is same as CPI if MPI_ALG is not enabled
    ...
    rssi++;
#[no_mangle]
pub unsafe extern "C" fn if(CPI_ALG_VLAN16: cfg->cpi_alg ==) -> else {
    else if (cfg.cpi_alg == CPI_ALG_VLAN16)
    rssi = ((cpi - cpi_base) & 0xe) >> 1;
#[no_mangle]
pub unsafe extern "C" fn if(CPI_ALG_DIFF: cfg->cpi_alg ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn nic_send_rss_size(nic: *mut nicpf, vf: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn nic_config_rss(nic: *mut nicpf, cfg: *mut rss_cfg_msg) {
    ...
    let mut svf: u8 = cfg.ind_tbl[idx] >> 3;
    if (svf)
...
#[no_mangle]
unsafe extern "C" fn nic_send_pnicvf(nic: *mut nicpf, sqs: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nic_send_snicvf(nic: *mut nicpf, nicvf: *mut nicvf_ptr) {
    static void nic_send_snicvf(struct nicpf *nic, struct nicvf_ptr *nicvf)
    {
    let mut mbx: union nic_mbx = {};
    let mut sqs_id: c_int = nic.vf_sqs[nicvf.vf_id][nicvf.sqs_id];
...
//
#[no_mangle]
unsafe extern "C" fn nic_nxt_avail_sqs(nic: *mut nicpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nic_alloc_sqs(nic: *mut nicpf, sqs: *mut sqs_alloc) {
...
#[no_mangle]
unsafe extern "C" fn nic_config_loopback(nic: *mut nicpf, lbk: *mut set_loopback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nic_enable_tunnel_parsing(nic: *mut nicpf, vf: c_int) {
    static void nic_enable_tunnel_parsing(struct nicpf *nic, int vf)
    {
    let mut prot_def: u64 = (IPV6_PROT << 32) | (IPV4_PROT << 16) | ET_PROT;
...
#[no_mangle]
unsafe extern "C" fn nic_enable_vf(nic: *mut nicpf, vf: c_int, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn nic_pause_frame(nic: *mut nicpf, vf: c_int, cfg: *mut pfc) {
...
#[no_mangle]
unsafe extern "C" fn nic_config_timestamp(nic: *mut nicpf, vf: c_int, ptp: *mut set_ptp) {
...
//
#[no_mangle]
unsafe extern "C" fn nic_link_status_get(nic: *mut nicpf, vf: u8) {
...
#[no_mangle]
unsafe extern "C" fn nic_handle_mbx_intr(nic: *mut nicpf, vf: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nic_mbx_intr_handler(irq: c_int, nic_irq: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nic_free_all_interrupts(nic: *mut nicpf) {
...
#[no_mangle]
unsafe extern "C" fn nic_register_interrupts(nic: *mut nicpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nic_unregister_interrupts(nic: *mut nicpf) {
...
#[no_mangle]
unsafe extern "C" fn nic_num_sqs_en(nic: *mut nicpf, vf_en: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nic_sriov_init(pdev: *mut pci_dev, nic: *mut nicpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nic_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nic_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn nic_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nic_cleanup_module() -> void __exit {
