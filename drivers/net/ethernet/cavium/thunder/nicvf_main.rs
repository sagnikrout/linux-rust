...
//! Source: drivers/net/ethernet/cavium/thunder/nicvf_main.c
#![no_std]
...
// Supported devices
    ...
    let mut debug: static int = 0x00;
    module_param(debug, int, 0644);
    MODULE_PARM_DESC(debug, "Debug message level bitmap");
    let mut cpi_alg: static int = CPI_ALG_NONE;
    module_param(cpi_alg, int, 0444);
    MODULE_PARM_DESC(cpi_alg,
    "PFC algorithm (0=none, 1=VLAN, 2=VLAN16, 3=IP Diffserv)");
#[no_mangle]
pub unsafe extern "C" fn nicvf_netdev_qidx(nic: *mut nicvf, qidx: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn nicvf_reg_write(nic: *mut nicvf, offset: u64, val: u64) {
    void nicvf_reg_write(struct nicvf *nic, u64 offset, u64 val)
    {
    writeq_relaxed(val, nic.reg_base + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn nicvf_reg_read(nic: *mut nicvf, offset: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn nicvf_queue_reg_read(nic: *mut nicvf, offset: u64, qidx: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn nicvf_write_to_mbx(nic: *mut nicvf, mbx: *mut union nic_mbx) {
...
#[no_mangle]
pub unsafe extern "C" fn nicvf_send_msg_to_pf(nic: *mut nicvf, mbx: *mut union nic_mbx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nicvf_check_pf_ready(nic: *mut nicvf) -> c_int {
    static int nicvf_check_pf_ready(struct nicvf *nic)
    {
    let mut mbx: union nic_mbx = {};
...
#[no_mangle]
unsafe extern "C" fn nicvf_send_cfg_done(nic: *mut nicvf) {
...
#[no_mangle]
unsafe extern "C" fn nicvf_read_bgx_stats(nic: *mut nicvf, bgx: *mut bgx_stats_msg) {
...
#[no_mangle]
unsafe extern "C" fn nicvf_handle_mbx_intr(nic: *mut nicvf) {
...
#[no_mangle]
unsafe extern "C" fn nicvf_hw_set_mac_addr(nic: *mut nicvf, netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nicvf_config_cpi(nic: *mut nicvf) {
...
#[no_mangle]
unsafe extern "C" fn nicvf_get_rss_size(nic: *mut nicvf) {
...
#[no_mangle]
pub unsafe extern "C" fn nicvf_config_rss(nic: *mut nicvf) {
    void nicvf_config_rss(struct nicvf *nic)
    {
    let mut mbx: union nic_mbx = {};
    struct nicvf_rss_info *rss = &nic.rss_info;
    let mut ind_tbl_len: c_int = rss.rss_size;
    int i, nextq = 0;
...
#[no_mangle]
pub unsafe extern "C" fn nicvf_set_rss_key(nic: *mut nicvf) {
    void nicvf_set_rss_key(struct nicvf *nic)
    {
    struct nicvf_rss_info *rss = &nic.rss_info;
    let mut key_addr: u64 = NIC_VNIC_RSS_KEY_0_4;
    int idx;
...
#[no_mangle]
unsafe extern "C" fn nicvf_rss_init(nic: *mut nicvf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nicvf_request_sqs(nic: *mut nicvf) {
    static void nicvf_request_sqs(struct nicvf *nic)
    {
    let mut mbx: union nic_mbx = {};
    int sqs;
    let mut sqs_count: c_int = nic.sqs_count;
    let mut rx_queues: c_int = 0, tx_queues = 0;
...
//
#[no_mangle]
unsafe extern "C" fn nicvf_send_vf_struct(nic: *mut nicvf) {
...
#[no_mangle]
unsafe extern "C" fn nicvf_get_primary_vf_struct(nic: *mut nicvf) {
...
#[no_mangle]
unsafe extern "C" fn nicvf_init_resources(nic: *mut nicvf) -> c_int {
...
// Release page reference for recycling
    if (page)
    put_page(page);
    sq.xdp_page[cqe_tx.sqe_ptr] = (u64)core::ptr::null_mut();
...
// If timestamp is requested for this skb, don't free it
    ...
    sq.skbuff[cqe_tx.sqe_ptr] = (u64)core::ptr::null_mut();
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn nicvf_set_rxtstamp(nic: *mut nicvf, skb: *mut sk_buff) {
...
// Check for stripped VLAN
    ...
    let mut tx_pkts: c_uint = 0, tx_bytes = 0, txq_idx;
...
#[no_mangle]
unsafe extern "C" fn nicvf_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nicvf_handle_qs_err(t: *mut tasklet_struct) {
...
// Process already queued CQEs and reconfig CQ
    ...
    nicvf_cq_intr_handler(nic.netdev, qidx, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn nicvf_dump_intr_status(nic: *mut nicvf) {
...
#[no_mangle]
unsafe extern "C" fn nicvf_misc_intr_handler(irq: c_int, nicvf_irq: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nicvf_intr_handler(irq: c_int, cq_irq: *mut c_void) -> irqreturn_t {
    ...
    let mut qidx: c_int = cq_poll.cq_idx;
    nicvf_dump_intr_status(nic);
// Disable interrupts
    nicvf_disable_intr(nic, NICVF_INTR_CQ, qidx);
// Schedule NAPI
...
#[no_mangle]
unsafe extern "C" fn nicvf_rbdr_intr_handler(irq: c_int, nicvf_irq: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nicvf_qs_err_intr_handler(irq: c_int, nicvf_irq: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nicvf_set_irq_affinity(nic: *mut nicvf) {
...
#[no_mangle]
unsafe extern "C" fn nicvf_register_interrupts(nic: *mut nicvf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nicvf_unregister_interrupts(nic: *mut nicvf) {
...
// Free registered interrupts
    ...
    continue;
    irq_set_affinity_hint(pci_irq_vector(pdev, irq), core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn nicvf_register_misc_interrupt(nic: *mut nicvf) -> c_int {
    static int nicvf_register_misc_interrupt(struct nicvf *nic)
    {
    let mut ret: c_int = 0;
    let mut irq: c_int = NICVF_INTR_ID_MISC;
...
#[no_mangle]
unsafe extern "C" fn nicvf_xmit(skb: *mut sk_buff, netdev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t nicvf_xmit(struct sk_buff *skb, struct net_device *netdev)
    {
    struct nicvf *nic = netdev_priv(netdev);
    let mut qid: c_int = skb_get_queue_mapping(skb);
...
#[no_mangle]
pub unsafe extern "C" fn nicvf_free_cq_poll(nic: *mut nicvf) {
    ...
    if (!cq_poll)
    continue;
    nic.napi[qidx] = core::ptr::null_mut();
    kfree(cq_poll);
    }
    }
#[no_mangle]
pub unsafe extern "C" fn nicvf_stop(netdev: *mut net_device) -> c_int {
    int nicvf_stop(struct net_device *netdev)
    {
    int irq, qidx;
    struct nicvf *nic = netdev_priv(netdev);
    struct queue_set *qs = nic.qs;
    struct nicvf_cq_poll *cq_poll = core::ptr::null_mut();
    let mut mbx: union nic_mbx = {};
...
// Teardown secondary qsets first
    ...
    nic.snicvf[qidx] = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn nicvf_config_hw_rx_tstamp(nic: *mut nicvf, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nicvf_update_hw_max_frs(nic: *mut nicvf, mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nicvf_link_status_check_task(work_arg: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn nicvf_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nicvf_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nicvf_set_mac_address(netdev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nicvf_update_lmac_stats(nic: *mut nicvf) {
...
#[no_mangle]
pub unsafe extern "C" fn nicvf_update_stats(nic: *mut nicvf) {
    void nicvf_update_stats(struct nicvf *nic)
    {
    int qidx, cpu;
    let mut tmp_stats: u64 = 0;
...
#[no_mangle]
unsafe extern "C" fn nicvf_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn nicvf_reset_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nicvf_set_xdp_queues(nic: *mut nicvf, bpf_attached: bool) {
...
#[no_mangle]
unsafe extern "C" fn nicvf_xdp_setup(nic: *mut nicvf, prog: *mut bpf_prog) -> c_int {
    static int nicvf_xdp_setup(struct nicvf *nic, struct bpf_prog *prog)
    {
    struct net_device *dev = nic.netdev;
    let mut if_up: bool = netif_running(nic.netdev);
    struct bpf_prog *old_prog;
    let mut bpf_attached: bool = false;
    let mut ret: c_int = 0;
// For now just support only the usual MTU sized frames,
// plus some headroom for VLAN, QinQ.
//
...
#[no_mangle]
unsafe extern "C" fn nicvf_xdp(netdev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nicvf_set_rx_mode_task(work_arg: *mut work_struct) {
...
//
    ...
    mode = vf_work.mode;
    mc = vf_work.mc;
    vf_work.mc = core::ptr::null_mut();
    spin_unlock_bh(&nic.rx_mode_wq_lock);
    __nicvf_set_rx_mode_task(mode, mc, nic);
    }
#[no_mangle]
unsafe extern "C" fn nicvf_set_rx_mode(netdev: *mut net_device) {
    static void nicvf_set_rx_mode(struct net_device *netdev)
    {
    struct nicvf *nic = netdev_priv(netdev);
    struct netdev_hw_addr *ha;
    struct xcast_addr_list *mc_list = core::ptr::null_mut();
    let mut mode: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn nicvf_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nicvf_remove(pdev: *mut pci_dev) {
...
//
    ...
    if (nic.nicvf_rx_mode_wq) {
    destroy_workqueue(nic.nicvf_rx_mode_wq);
    nic.nicvf_rx_mode_wq = core::ptr::null_mut();
    }
    nicvf_unregister_interrupts(nic);
    pci_set_drvdata(pdev, core::ptr::null_mut());
    if (nic.drv_stats)
...
#[no_mangle]
unsafe extern "C" fn nicvf_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn nicvf_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nicvf_cleanup_module() -> void __exit {
