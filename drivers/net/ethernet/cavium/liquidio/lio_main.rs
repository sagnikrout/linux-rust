...
//! Source: drivers/net/ethernet/cavium/liquidio/lio_main.c
#![no_std]
...
//
    ...
    "_" LIO_FW_NAME_TYPE_NIC LIO_FW_NAME_SUFFIX);
    let mut ddr_timeout: static int = 10000;
...
//
#[no_mangle]
unsafe extern "C" fn octeon_console_debug_enabled(console: u32) -> c_int {
    static int octeon_console_debug_enabled(u32 console)
    {
    return (console_bitmask >> (console)) & 0x1;
    }
// Polling interval for determining when NIC application is alive
pub const LIQUIDIO_STARTER_POLL_INTERVAL_MS: c_int = 100;
// runtime link query interval
pub const LIQUIDIO_LINK_QUERY_INTERVAL_MS: c_int = 1000;
...
//
pub const LIO_SYNC_OCTEON_TIME_INTERVAL_MS: c_int = 60000;
// time to wait for possible in-flight requests in milliseconds

#[repr(C)]
#[derive(Copy, Clone)]
pub struct oct_timestamp_resp {
    pub rh: u64,
    pub timestamp: u64,
    pub status: u64,
}
...
//
pub const OCTNIC_GSO_MAX_HEADER_SIZE: c_int = 128;
...
#[no_mangle]
unsafe extern "C" fn octeon_droq_bh(t: *mut tasklet_struct) {
    static void octeon_droq_bh(struct tasklet_struct *t)
    {
    int q_no;
    let mut reschedule: c_int = 0;
    ...
    MAX_PACKET_BUDGET);
    lio_enable_irq(oct.droq[q_no], core::ptr::null_mut());
    if (OCTEON_CN23XX_PF(oct) && oct.msix_on) {
// set time and cnt interrupt thresholds for this DROQ
// for NAPI
//
    let mut adjusted_q_no: c_int = q_no + oct.sriov_info.pf_srn;
    octeon_write_csr64(
...
#[no_mangle]
unsafe extern "C" fn lio_wait_for_oq_pkts(oct: *mut octeon_device) -> c_int {
    static int lio_wait_for_oq_pkts(struct octeon_device *oct)
    {
    struct octeon_device_priv *oct_priv = oct.priv;
    let mut retry: c_int = 100, pkt_cnt = 0, pending_pkts = 0;
    int i;
    do {
    pending_pkts = 0;
...
//
#[no_mangle]
unsafe extern "C" fn force_io_queues_off(oct: *mut octeon_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcierror_quiesce_device(oct: *mut octeon_device) {
...
//
#[no_mangle]
unsafe extern "C" fn cleanup_aer_uncorrect_error_status(dev: *mut pci_dev) {
    static void cleanup_aer_uncorrect_error_status(struct pci_dev *dev)
    {
    let mut pos: c_int = 0x100;
    u32 status, mask;
    pr_info("%s :\n", __func__);
...
//
#[no_mangle]
unsafe extern "C" fn stop_pci_io(oct: *mut octeon_device) {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_pcie_mmio_enabled(pdev: *mut pci_dev __maybe_unused) -> pci_ers_result_t {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_pcie_slot_reset(pdev: *mut pci_dev __maybe_unused) -> pci_ers_result_t {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_pcie_resume(pdev: *mut pci_dev __maybe_unused) {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_init_pci() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_deinit_pci() {
...
//
#[no_mangle]
pub unsafe extern "C" fn check_txq_status(lio: *mut lio) -> c_int {
    static inline int check_txq_status(struct lio *lio)
    {
    let mut numqs: c_int = lio.netdev.real_num_tx_queues;
...
//
#[no_mangle]
unsafe extern "C" fn print_link_info(netdev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn octnet_link_status_change(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn setup_link_status_change_wq(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cleanup_link_status_change_wq(netdev: *mut net_device) {
...
//
    ...
    {
    struct lio *lio = GET_LIO(netdev);
    let mut changed: c_int = (lio.linfo.link.u64 != ls.u64);
    let mut current_max_mtu: c_int = lio.linfo.link.s.mtu;
    struct octeon_device *oct = lio.oct_dev;
...
//
#[no_mangle]
unsafe extern "C" fn lio_sync_octeon_time(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn setup_sync_octeon_time_wq(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cleanup_sync_octeon_time_wq(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn disable_all_vf_links(oct: *mut octeon_device) {
...
#[no_mangle]
unsafe extern "C" fn liquidio_watchdog(param: *mut c_void) -> c_int {
    static int liquidio_watchdog(void *param)
    {
    bool err_msg_was_printed[LIO_MAX_CORES];
    let mut mask_of_crashed_or_stuck_cores: u16 = 0;
    let mut all_vf_links_are_disabled: bool = false;
...
//
    ...
    {
    struct octeon_device *oct_dev = core::ptr::null_mut();
    struct handshake *hs;
...
//
    ...
    oct_dev.watchdog_task = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fw_type_is_auto() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_pci_flr(oct: *mut octeon_device) {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_destroy_resources(oct: *mut octeon_device) {
...
// non-iov vector's argument is oct struct
    ...
    oct.msix_entries = core::ptr::null_mut();
    } else {
// Release the interrupt line
    free_irq(oct.pci_dev.irq, oct);
    if (oct.flags & LIO_FLAG_MSI_ENABLED)
    ...
    oct.irq_name_storage = core::ptr::null_mut();
    fallthrough;
...
//
    ...
    octeon_pci_flr(oct);
#[no_mangle]
pub unsafe extern "C" fn if(!refcount: OCTEON_CN6XXX(oct) ||) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn send_rx_ctrl_cmd(lio: *mut lio, start_stop: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_destroy_nic_device(oct: *mut octeon_device, ifidx: c_int) {
...
// Delete NAPI
    ...
    oct.props[ifidx].netdev = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_stop_nic_module(oct: *mut octeon_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_remove(pdev: *mut pci_dev) {
    static void liquidio_remove(struct pci_dev *pdev)
    {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_chip_specific_setup(oct: *mut octeon_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_pci_os_setup(oct: *mut octeon_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn free_netbuf(buf: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn free_netsgbuf(buf: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn free_netsgbuf_with_resp(buf: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_ptp_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_ptp_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn oct_ptp_open(netdev: *mut net_device) {
    ...
    lio.ptp_clock = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_ptp_init(oct: *mut octeon_device) {
...
//
#[no_mangle]
unsafe extern "C" fn load_firmware(oct: *mut octeon_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn octnet_poll_check_txq_status(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn setup_tx_poll_fn(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cleanup_tx_poll_fn(netdev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_open(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_stop(netdev: *mut net_device) -> c_int {
    static int liquidio_stop(struct net_device *netdev)
    {
    struct lio *lio = GET_LIO(netdev);
    struct octeon_device *oct = lio.oct_dev;
...
//
#[no_mangle]
pub unsafe extern "C" fn get_new_flags(netdev: *mut net_device) -> enum octnet_ifflags {
    static inline enum octnet_ifflags get_new_flags(struct net_device *netdev)
    {
    let mut f: enum octnet_ifflags = OCTNET_IFFLAG_UNICAST;
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_set_mcast_list(netdev: *mut net_device) {
    ...
    u64 *mc;
    int ret;
    let mut mc_count: c_int = min(netdev_mc_count(netdev), MAX_OCTEON_MULTICAST_ADDR);
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_set_mac(netdev: *mut net_device, p: *mut c_void) -> c_int {
...
// The MAC Address is presented in network byte order.
    ...
    let mut pkts: u64 = 0, drop = 0, bytes = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(REQTYPE_NORESP_NET_SG: ndata->reqtype ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_xmit(skb: *mut sk_buff, netdev: *mut net_device) -> netdev_tx_t {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn liquidio_set_vf_mac(netdev: *mut net_device, vfidx: c_int, mac: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn liquidio_send_vf_trust_cmd(lio: *mut lio, vfidx: c_int, trusted: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn lio_nic_info(recv_info: *mut octeon_recv_info, buf: *mut c_void) -> c_int {
    static int lio_nic_info(struct octeon_recv_info *recv_info, void *buf)
    {
    struct octeon_device *oct = (struct octeon_device *)buf;
    struct octeon_recv_pkt *recv_pkt = recv_info.recv_pkt;
    let mut gmxport: c_int = 0;
    union oct_link_status *ls;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn setup_nic_devices(octeon_dev: *mut octeon_device) -> c_int {
    static int setup_nic_devices(struct octeon_device *octeon_dev)
    {
    struct lio *lio = core::ptr::null_mut();
    struct net_device *netdev;
    ...
    let mut max_num_queues: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn octeon_enable_sriov(oct: *mut octeon_device) -> c_int {
    static int octeon_enable_sriov(struct octeon_device *oct)
    {
    let mut num_vfs_alloced: c_uint = oct.sriov_info.num_vfs_alloced;
    int err;
...
#[no_mangle]
unsafe extern "C" fn lio_pci_sriov_disable(oct: *mut octeon_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn liquidio_enable_sriov(dev: *mut pci_dev, num_vfs: c_int) -> c_int {
    static int liquidio_enable_sriov(struct pci_dev *dev, int num_vfs)
    {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_init_nic_module(oct: *mut octeon_device) -> c_int {
    static int liquidio_init_nic_module(struct octeon_device *oct)
    {
    int i, retval = 0;
    let mut num_nic_ports: c_int = CFG_GET_NUM_NIC_PORTS(octeon_get_conf(oct));
...
//
#[no_mangle]
unsafe extern "C" fn nic_starter(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_device_init(octeon_dev: *mut octeon_device) -> c_int {
    static int octeon_device_init(struct octeon_device *octeon_dev)
    {
    int j, ret;
    char bootcmd[] = "\n";
    char *dbg_enb = core::ptr::null_mut();
...
//
    dbg_enb = octeon_console_debug_enabled(0) ? "" : core::ptr::null_mut();
...
//
    ...
    suffix);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: prefix) -> else {
    else if (prefix)
    dev_info(&oct.pci_dev.dev, "%u: %s\n", console_num, prefix);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: suffix) -> else {
    else if (suffix)
    dev_info(&oct.pci_dev.dev, "%u: %s\n", console_num, suffix);
    return 0;
    }
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_exit() -> void __exit {
