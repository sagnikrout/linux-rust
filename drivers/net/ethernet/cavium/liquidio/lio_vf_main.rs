...
//! Source: drivers/net/ethernet/cavium/liquidio/lio_vf_main.c
#![no_std]
...
unsafe extern "C" fn lio_wait_for_oq_pkts(oct: *mut octeon_device) -> c_int {
    ...
    let mut retry: c_int = MAX_IO_PENDING_PKT_COUNT;
    let mut pkt_cnt: c_int = 0, pending_pkts;
    int i;
    do {
    pending_pkts = 0;
...
//
#[no_mangle]
unsafe extern "C" fn pcierror_quiesce_device(oct: *mut octeon_device) {
...
//
#[no_mangle]
unsafe extern "C" fn setup_link_status_change_wq(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cleanup_link_status_change_wq(netdev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_vf_remove(pdev: *mut pci_dev) {
    static void liquidio_vf_remove(struct pci_dev *pdev)
    {
...
//
#[no_mangle]
unsafe extern "C" fn get_new_flags(netdev: *mut net_device) -> enum octnet_ifflags {
...
#[no_mangle]
unsafe extern "C" fn liquidio_set_uc_list(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn handle_timestamp(oct: *mut octeon_device, status: u32, buf: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn __attribute__(_arg: (unused)), vid: u16) -> __be16 proto {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_device_init(oct: *mut octeon_device) -> c_int {
    static int octeon_device_init(struct octeon_device *oct)
    {
    u32 rev_id;
    int j;
...
#[no_mangle]
unsafe extern "C" fn liquidio_vf_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn liquidio_vf_exit() -> void __exit {
