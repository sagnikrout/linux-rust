...
//! Source: drivers/net/ethernet/cavium/liquidio/lio_ethtool.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct oct_intrmod_resp {
    pub rh: u64,
    pub intrmod: oct_intrmod_cfg,
    pub status: u64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct oct_mdio_cmd_resp {
    pub rh: u64,
    pub resp: oct_mdio_cmd,
    pub status: u64,
}
...
pub const OCT_ETHTOOL_REGDUMP_LEN: c_int = 4096;

pub const OCT_ETHTOOL_REGSVER: c_int = 1;
// statistics of PF
...
pub const OCTNIC_NCMD_AUTONEG_ON: c_uint = 0x1;
pub const OCTNIC_NCMD_PHY_ON: c_uint = 0x2;
...
// ETHTOOL_FEC_OFF
    ...
    {
    let mut speed: c_int = ecmd.base.speed;
    struct lio *lio = GET_LIO(netdev);
    struct oct_link_info *linfo;
    ...
    struct octeon_device *oct = lio.oct_dev;
    let mut max_rx: u32 = 0, max_tx = 0, tx_count = 0, rx_count = 0;
    let mut combined_count: u32 = 0, max_combined = 0;
    ...
    let mut ctrl: u64 = CN23XX_VF_SLI_IQ_PKT_CONTROL64(0);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: OCTEON_CN23XX_VF(oct)) -> else {
    else if (OCTEON_CN23XX_VF(oct))
...
#[no_mangle]
unsafe extern "C" fn lio_get_eeprom_len(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octnet_gpio_access(netdev: *mut net_device, addr: c_int, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octnet_id_active(netdev: *mut net_device, val: c_int) -> c_int {
...
// Configure Beacon values
    ...
    octnet_id_active(netdev, LED_IDENTIFICATION_ON);
#[no_mangle]
pub unsafe extern "C" fn if(OCTEON_CN66XX: oct->chip_id ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn lio_23xx_reconfigure_queue_count(lio: *mut lio) -> c_int {
    ...
    vdata.major = ( u16)cpu_to_be16(LIQUIDIO_BASE_MAJOR_VERSION);
    vdata.minor = ( u16)cpu_to_be16(LIQUIDIO_BASE_MINOR_VERSION);
    vdata.micro = ( u16)cpu_to_be16(LIQUIDIO_BASE_MICRO_VERSION);
...
#[no_mangle]
unsafe extern "C" fn lio_reset_queues(netdev: *mut net_device, num_qs: u32) -> c_int {
    static int lio_reset_queues(struct net_device *netdev, uint32_t num_qs)
    {
    struct lio *lio = GET_LIO(netdev);
    struct octeon_device *oct = lio.oct_dev;
...
#[no_mangle]
unsafe extern "C" fn lio_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lio_set_msglevel(netdev: *mut net_device, msglvl: u32) {
...
#[no_mangle]
unsafe extern "C" fn lio_vf_set_msglevel(netdev: *mut net_device, msglvl: u32) {
...
#[no_mangle]
unsafe extern "C" fn lio_get_priv_flags_strings(lio: *mut lio, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn lio_get_strings(netdev: *mut net_device, stringset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn lio_get_priv_flags_ss_count(lio: *mut lio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lio_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lio_vf_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
// consider setting resend bit
    ...
    int ret;
    struct octeon_device *oct = lio.oct_dev;
    let mut intrmod: oct_intrmod_cfg = {0};
    u32 j, q_no;
    int db_max, db_min;
    switch (oct.chip_id) {
    case OCTEON_CN68XX:
...
#[no_mangle]
unsafe extern "C" fn lio_get_regs_len(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn23xx_read_csr_reg(s: *mut c_char, oct: *mut octeon_device) -> c_int {
    static int cn23xx_read_csr_reg(char *s, struct octeon_device *oct)
    {
    u32 reg;
    let mut pf_num: u8 = oct.pf_num;
    let mut len: c_int = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn cn23xx_vf_read_csr_reg(s: *mut c_char, oct: *mut octeon_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn6xxx_read_csr_reg(s: *mut c_char, oct: *mut octeon_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn6xxx_read_config_reg(s: *mut c_char, oct: *mut octeon_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lio_get_priv_flags(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lio_set_priv_flags(netdev: *mut net_device, flags: u32) -> c_int {
    static int lio_set_priv_flags(struct net_device *netdev, u32 flags)
    {
    struct lio *lio = GET_LIO(netdev);
    let mut intr_by_tx_bytes: bool = !!(flags & (0x1 << OCT_PRIV_FLAG_TX_BYTES));
...
#[no_mangle]
pub unsafe extern "C" fn if(ETHTOOL_FEC_RS: fec->fec &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn liquidio_set_ethtool_ops(netdev: *mut net_device) {
