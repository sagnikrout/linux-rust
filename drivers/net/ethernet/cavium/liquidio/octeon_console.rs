...
//! Source: drivers/net/ethernet/cavium/liquidio/octeon_console.c
#![no_std]
...
pub const BOOTLOADER_PCI_READ_BUFFER_DATA_ADDR: c_uint = 0x0006c008;
pub const BOOTLOADER_PCI_READ_BUFFER_LEN_ADDR: c_uint = 0x0006c004;
pub const BOOTLOADER_PCI_READ_BUFFER_OWNER_ADDR: c_uint = 0x0006c000;
pub const BOOTLOADER_PCI_READ_DESC_ADDR: c_uint = 0x0006c100;
pub const BOOTLOADER_PCI_WRITE_BUFFER_STR_LEN: c_int = 248;
pub const OCTEON_PCI_IO_BUF_OWNER_OCTEON: c_uint = 0x00000001;
pub const OCTEON_PCI_IO_BUF_OWNER_HOST: c_uint = 0x00000002;
// Can change without breaking ABI
pub const CVMX_BOOTMEM_NUM_NAMED_BLOCKS: c_int = 64;
// minimum alignment of bootmem alloced blocks

// CVMX bootmem descriptor major version
pub const CVMX_BOOTMEM_DESC_MAJ_VER: c_int = 3;
// CVMX bootmem descriptor minor version
pub const CVMX_BOOTMEM_DESC_MIN_VER: c_int = 0;
// Current versions
pub const OCTEON_PCI_CONSOLE_MAJOR_VERSION: c_int = 1;
pub const OCTEON_PCI_CONSOLE_MINOR_VERSION: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octeon_pci_console_desc {
    pub major_version: u32,
    pub minor_version: u32,
    pub lock: u32,
    pub flags: u32,
...
// __cvmx_bootmem_find_named_block_flags(struct octeon_device *oct,
    ...
    let mut named_addr: u64 = cvmx_bootmem_phy_named_block_find(oct, name, flags);
    if (named_addr) {
    ...
    sizeof_field(struct cvmx_bootmem_desc,
    named_block_name_len));
    let mut named_addr: u64 = named_block_array_addr;
...
#[no_mangle]
unsafe extern "C" fn octeon_remote_lock() {
    static void octeon_remote_lock(void)
    {
// fill this in if any sharing is needed
    }
#[no_mangle]
unsafe extern "C" fn octeon_remote_unlock() {
    static void octeon_remote_unlock(void)
    {
// fill this in if any sharing is needed
    }
    ...
    u32 wait_hundredths)
    {
    let mut len: u32 = (u32)strlen(cmd_str);
...
#[no_mangle]
unsafe extern "C" fn check_console(work: *mut work_struct) {
    ...
    let mut console_num: u32 = (u32)wk.ctxul;
    u32 delay;
    console = &oct.console[console_num];
    tries = 0;
    total_read = 0;
...
#[no_mangle]
pub unsafe extern "C" fn octeon_init_consoles(oct: *mut octeon_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octeon_get_uboot_version(oct: *mut octeon_device) {
    static void octeon_get_uboot_version(struct octeon_device *oct)
    {
    s32 bytes_read, tries, total_read;
    struct octeon_console *console;
    let mut console_num: u32 = 0;
    char *uboot_ver;
    char *buf;
    char *p;
pub const OCTEON_UBOOT_VER_BUF_SIZE: c_int = 512;
...
//
#[no_mangle]
pub unsafe extern "C" fn octeon_remove_consoles(oct: *mut octeon_device) {
...
pub const MAX_BOOTTIME_SIZE: c_int = 80;
