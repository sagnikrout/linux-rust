...
//! Source: drivers/net/ethernet/cavium/liquidio/lio_core.c
#![no_std]
...
pub const LIO_OOM_POLL_INTERVAL_MS: c_int = 250;
...
//
#[no_mangle]
pub unsafe extern "C" fn lio_delete_glists(lio: *mut lio) {
    void lio_delete_glists(struct lio *lio)
    {
    struct octnic_gather *g;
    int i;
    kfree(lio.glist_lock);
    lio.glist_lock = core::ptr::null_mut();
    if (!lio.glist)
    return;
    ...
    lio.glists_virt_base = core::ptr::null_mut();
    kfree(lio.glists_dma_base);
    lio.glists_dma_base = core::ptr::null_mut();
    kfree(lio.glist);
    lio.glist = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn lio_setup_glists(oct: *mut octeon_device, lio: *mut lio, num_iqs: c_int) -> c_int {
...
//
    ...
    for (i = 0; i < num_iqs; i++) {
    let mut numa_node: c_int = dev_to_node(&oct.pci_dev.dev);
...
#[no_mangle]
pub unsafe extern "C" fn liquidio_set_feature(netdev: *mut net_device, cmd: c_int, param1: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn octeon_report_sent_bytes_to_bql(buf: *mut c_void, reqtype: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn liquidio_link_ctrl_cmd_completion(nctrl_ptr: *mut c_void) {
...
// vfidx is 0 based, but vf_num (param1) is 1 based
    let mut vfidx: c_int = nctrl.ncmd.s.param1 - 1;
    let mut mac_is_admin_assigned: bool = nctrl.ncmd.s.param2;
...
#[no_mangle]
pub unsafe extern "C" fn octeon_pf_changed_vf_macaddr(oct: *mut octeon_device, mac: *mut u8) {
    void octeon_pf_changed_vf_macaddr(struct octeon_device *oct, u8 *mac)
    {
    let mut macaddr_changed: bool = false;
...
#[no_mangle]
unsafe extern "C" fn octnet_poll_check_rxq_oom_status(work: *mut work_struct) {
    static void octnet_poll_check_rxq_oom_status(struct work_struct *work)
    {
    struct cavium_wk *wk = (struct cavium_wk *)work;
    struct lio *lio = (struct lio *)wk.ctxptr;
    struct octeon_device *oct = lio.oct_dev;
    let mut q_no: c_int = wk.ctxul;
...
#[no_mangle]
pub unsafe extern "C" fn setup_rx_oom_poll_fn(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cleanup_rx_oom_poll_fn(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn lio_update_txq_status(oct: *mut octeon_device, iq_num: c_int) {
...
//
    ...
    let mut hash: u32 = be32_to_cpu(*hash_be);
...
// inbound VLAN tag
    ...
    rh.r_dh.vlan) {
    let mut priority: u16 = rh.r_dh.priority;
    let mut vid: u16 = rh.r_dh.vlan;
...
//
#[no_mangle]
unsafe extern "C" fn napi_schedule_wrapper(param: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_napi_drv_callback(arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_napi_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int liquidio_napi_poll(struct napi_struct *napi, int budget)
    {
    struct octeon_instr_queue *iq;
    struct octeon_device *oct;
    struct octeon_droq *droq;
    let mut tx_done: c_int = 0, iq_no;
    int work_done;
...
// XPS
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn liquidio_schedule_msix_droq_pkt_handler(droq: *mut octeon_droq, ret: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn liquidio_schedule_droq_pkt_handlers(oct: *mut octeon_device) {
...
//
    static
#[no_mangle]
pub unsafe extern "C" fn liquidio_legacy_intr_handler(irq: int __maybe_unused, dev: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn octeon_setup_interrupt(oct: *mut octeon_device, num_ioqs: u32) -> c_int {
    int octeon_setup_interrupt(struct octeon_device *oct, u32 num_ioqs)
    {
    struct msix_entry *msix_entries;
    char *queue_irq_names = core::ptr::null_mut();
    int i, num_interrupts = 0;
    int num_alloc_ioq_vectors;
    char *aux_irq_name = core::ptr::null_mut();
    int num_ioq_vectors;
    int irqret, err;
    if (oct.msix_on) {
...
//
#[no_mangle]
pub unsafe extern "C" fn liquidio_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lio_wait_for_clean_oq(oct: *mut octeon_device) -> c_int {
    int lio_wait_for_clean_oq(struct octeon_device *oct)
    {
    let mut retry: c_int = 100, pending_pkts = 0;
    int idx;
    do {
    pending_pkts = 0;
...
#[no_mangle]
unsafe extern "C" fn lio_fetch_vf_stats(lio: *mut lio) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lio_fetch_stats(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn liquidio_set_speed(lio: *mut lio, speed: c_int) -> c_int {
...
// Wait for response or timeout
    ...
    var = be32_to_cpu(( __be32)resp.speed);
    if (var != speed) {
    dev_err(&oct.pci_dev.dev,
...
#[no_mangle]
pub unsafe extern "C" fn liquidio_get_speed(lio: *mut lio) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn liquidio_set_fec(lio: *mut lio, on_off: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn liquidio_get_fec(lio: *mut lio) -> c_int {
