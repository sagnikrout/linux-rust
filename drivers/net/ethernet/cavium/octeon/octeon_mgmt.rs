...
//! Source: drivers/net/ethernet/cavium/octeon/octeon_mgmt.c
#![no_std]
...
pub const OCTEON_MGMT_NAPI_WEIGHT: c_int = 16;
// Ring sizes that are powers of two allow for more efficient modulo
// opertions.
//
pub const OCTEON_MGMT_RX_RING_SIZE: c_int = 512;
pub const OCTEON_MGMT_TX_RING_SIZE: c_int = 128;
// Allow 8 bytes for vlan and FCS.

    union mgmt_port_ring_entry {
    u64 d64;
    struct {
pub const RING_ENTRY_CODE_DONE: c_uint = 0xf;
pub const RING_ENTRY_CODE_MORE: c_uint = 0x10;
...
pub const MIX_ORING1: c_uint = 0x0;
pub const MIX_ORING2: c_uint = 0x8;
pub const MIX_IRING1: c_uint = 0x10;
pub const MIX_IRING2: c_uint = 0x18;
pub const MIX_CTL: c_uint = 0x20;
pub const MIX_IRHWM: c_uint = 0x28;
pub const MIX_IRCNT: c_uint = 0x30;
pub const MIX_ORHWM: c_uint = 0x38;
pub const MIX_ORCNT: c_uint = 0x40;
pub const MIX_ISR: c_uint = 0x48;
pub const MIX_INTENA: c_uint = 0x50;
pub const MIX_REMCNT: c_uint = 0x58;
pub const MIX_BIST: c_uint = 0x78;
pub const AGL_GMX_PRT_CFG: c_uint = 0x10;
pub const AGL_GMX_RX_FRM_CTL: c_uint = 0x18;
pub const AGL_GMX_RX_FRM_MAX: c_uint = 0x30;
pub const AGL_GMX_RX_JABBER: c_uint = 0x38;
pub const AGL_GMX_RX_STATS_CTL: c_uint = 0x50;
pub const AGL_GMX_RX_STATS_PKTS_DRP: c_uint = 0xb0;
pub const AGL_GMX_RX_STATS_OCTS_DRP: c_uint = 0xb8;
pub const AGL_GMX_RX_STATS_PKTS_BAD: c_uint = 0xc0;
pub const AGL_GMX_RX_ADR_CTL: c_uint = 0x100;
pub const AGL_GMX_RX_ADR_CAM_EN: c_uint = 0x108;
pub const AGL_GMX_RX_ADR_CAM0: c_uint = 0x180;
pub const AGL_GMX_RX_ADR_CAM1: c_uint = 0x188;
pub const AGL_GMX_RX_ADR_CAM2: c_uint = 0x190;
pub const AGL_GMX_RX_ADR_CAM3: c_uint = 0x198;
pub const AGL_GMX_RX_ADR_CAM4: c_uint = 0x1a0;
pub const AGL_GMX_RX_ADR_CAM5: c_uint = 0x1a8;
pub const AGL_GMX_TX_CLK: c_uint = 0x208;
pub const AGL_GMX_TX_STATS_CTL: c_uint = 0x268;
pub const AGL_GMX_TX_CTL: c_uint = 0x270;
pub const AGL_GMX_TX_STAT0: c_uint = 0x280;
pub const AGL_GMX_TX_STAT1: c_uint = 0x288;
pub const AGL_GMX_TX_STAT2: c_uint = 0x290;
pub const AGL_GMX_TX_STAT3: c_uint = 0x298;
pub const AGL_GMX_TX_STAT4: c_uint = 0x2a0;
pub const AGL_GMX_TX_STAT5: c_uint = 0x2a8;
pub const AGL_GMX_TX_STAT6: c_uint = 0x2b0;
pub const AGL_GMX_TX_STAT7: c_uint = 0x2b8;
pub const AGL_GMX_TX_STAT8: c_uint = 0x2c0;
pub const AGL_GMX_TX_STAT9: c_uint = 0x2c8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octeon_mgmt {
    ...
    pub port: c_int,
    pub irq: c_int,
    pub has_rx_tstamp: bool,
    pub tx_ring: *mut u64,
    pub tx_ring_handle: dma_addr_t,
    pub tx_next: c_uint,
    pub tx_next_clean: c_uint,
    pub tx_current_fill: c_uint,
// The tx_list lock also protects the ring related variables
    pub tx_list: sk_buff_head,
// RX variables only touched in napi_poll.  No locking necessary.
    pub rx_ring: *mut u64,
    pub rx_ring_handle: dma_addr_t,
    pub rx_next: c_uint,
    pub rx_next_fill: c_uint,
    pub rx_current_fill: c_uint,
    pub rx_list: sk_buff_head,
    pub lock: spinlock_t,
    pub last_duplex: c_uint,
    pub last_link: c_uint,
    pub last_speed: c_uint,
    pub dev: *mut device,
    pub napi: napi_struct,
    pub tx_clean_tasklet: tasklet_struct,
    pub phy_np: *mut device_node,
    pub mix_phys: resource_size_t,
    pub mix_size: resource_size_t,
    pub agl_phys: resource_size_t,
    pub agl_size: resource_size_t,
    pub agl_prt_ctl_phys: resource_size_t,
    pub agl_prt_ctl_size: resource_size_t,
}

#[no_mangle]
unsafe extern "C" fn octeon_mgmt_set_rx_irq(p: *mut octeon_mgmt, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_set_tx_irq(p: *mut octeon_mgmt, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_enable_rx_irq(p: *mut octeon_mgmt) {
    static void octeon_mgmt_enable_rx_irq(struct octeon_mgmt *p)
    {
    octeon_mgmt_set_rx_irq(p, 1);
    }
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_disable_rx_irq(p: *mut octeon_mgmt) {
    static void octeon_mgmt_disable_rx_irq(struct octeon_mgmt *p)
    {
    octeon_mgmt_set_rx_irq(p, 0);
    }
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_enable_tx_irq(p: *mut octeon_mgmt) {
    static void octeon_mgmt_enable_tx_irq(struct octeon_mgmt *p)
    {
    octeon_mgmt_set_tx_irq(p, 1);
    }
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_disable_tx_irq(p: *mut octeon_mgmt) {
    static void octeon_mgmt_disable_tx_irq(struct octeon_mgmt *p)
    {
    octeon_mgmt_set_tx_irq(p, 0);
    }
#[no_mangle]
unsafe extern "C" fn ring_max_fill(ring_size: c_uint) -> c_uint {
    static unsigned int ring_max_fill(unsigned int ring_size)
    {
    return ring_size - 8;
    }
#[no_mangle]
unsafe extern "C" fn ring_size_to_bytes(ring_size: c_uint) -> c_uint {
    static unsigned int ring_size_to_bytes(unsigned int ring_size)
    {
    return ring_size * sizeof(union mgmt_port_ring_entry);
    }
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_rx_fill_ring(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_clean_tx_buffers(p: *mut octeon_mgmt) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_clean_tx_tasklet(t: *mut tasklet_struct) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_update_rx_stats(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_update_tx_stats(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_receive_one(p: *mut octeon_mgmt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_receive_packets(p: *mut octeon_mgmt, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_napi_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_reset_hw(p: *mut octeon_mgmt) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octeon_mgmt_cam_state {
    pub cam: [u64; 6],
    pub cam_mask: u64,
    pub cam_index: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_set_rx_filtering(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_set_mac_address(netdev: *mut net_device, addr: *mut c_void) -> c_int {
    static int octeon_mgmt_set_mac_address(struct net_device *netdev, void *addr)
    {
    let mut r: c_int = eth_mac_addr(netdev, addr);
    if (r)
    return r;
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
    static int octeon_mgmt_change_mtu(struct net_device *netdev, int new_mtu)
    {
    struct octeon_mgmt *p = netdev_priv(netdev);
    let mut max_packet: c_int = new_mtu + ETH_HLEN + ETH_FCS_LEN;
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_interrupt(cpl: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// Clear any pending interrupts
    ...
    let mut have_hw_timestamps: bool = false;
...
// reference.
//
    let mut clock_comp: u64 = (NSEC_PER_SEC << 32) /	octeon_get_io_clock_rate();
    if (!ptp.s.ptp_en)
...
// The clock is already programmed to use a GPIO
    let mut clock_comp: u64 = cvmx_read_csr(CVMX_MIO_PTP_CLOCK_COMP);
    netdev_info(netdev,
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_disable_link(p: *mut octeon_mgmt) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_enable_link(p: *mut octeon_mgmt) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_update_link(p: *mut octeon_mgmt) {
...
#[no_mangle]
pub unsafe extern "C" fn if(100: phydev->speed ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_adjust_link(netdev: *mut net_device) {
    static void octeon_mgmt_adjust_link(struct net_device *netdev)
    {
    struct octeon_mgmt *p = netdev_priv(netdev);
    struct phy_device *phydev = netdev.phydev;
    unsigned long flags;
    let mut link_changed: c_int = 0;
    if (!phydev)
    return;
    spin_lock_irqsave(&p.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_init_phy(netdev: *mut net_device) -> c_int {
    static int octeon_mgmt_init_phy(struct net_device *netdev)
    {
    struct octeon_mgmt *p = netdev_priv(netdev);
    struct phy_device *phydev = core::ptr::null_mut();
    if (octeon_is_simulation() || p.phy_np == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_open(netdev: *mut net_device) -> c_int {
...
//
pub const NS_PER_PHY_CLK: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_stop(netdev: *mut net_device) -> c_int {
...
// dma_unmap is a nop on Octeon, so just free everything.
    ...
    union mgmt_port_ring_entry re;
    unsigned long flags;
    let mut rv: netdev_tx_t = NETDEV_TX_BUSY;
    re.d64 = 0;
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_poll_controller(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_nway_reset(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (res_mix == core::ptr::null_mut()) {
    dev_err(&pdev.dev, "no 'reg' resource\n");
    result = -ENXIO;
    goto err;
    }
    res_agl = platform_get_resource(pdev, IORESOURCE_MEM, 1);
    if (res_agl == core::ptr::null_mut()) {
    dev_err(&pdev.dev, "no 'reg' resource\n");
    result = -ENXIO;
    goto err;
    }
    res_agl_prt_ctl = platform_get_resource(pdev, IORESOURCE_MEM, 3);
    if (res_agl_prt_ctl == core::ptr::null_mut()) {
    dev_err(&pdev.dev, "no 'reg' resource\n");
    result = -ENXIO;
    goto err;
    }
...
#[no_mangle]
unsafe extern "C" fn octeon_mgmt_remove(pdev: *mut platform_device) {
