...
//! Source: drivers/net/ethernet/mediatek/mtk_wed_debugfs.c
#![no_std]
...
// val = regval;
    ...
    "0x%08llx\n");
#[no_mangle]
pub unsafe extern "C" fn mtk_wed_hw_add_debugfs(hw: *mut mtk_wed_hw) {
    void mtk_wed_hw_add_debugfs(struct mtk_wed_hw *hw)
    {
    struct dentry *dir;
    snprintf(hw.dirname, sizeof(hw.dirname), "wed%d", hw.index);
    dir = debugfs_create_dir(hw.dirname, core::ptr::null_mut());
    hw.debugfs_dir = dir;
