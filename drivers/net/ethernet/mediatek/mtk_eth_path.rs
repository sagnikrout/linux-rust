...
//! Source: drivers/net/ethernet/mediatek/mtk_eth_path.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_eth_muxc {
    pub name: *const c_char,
    pub cap_bit: u64,
    pub path): *mut *mut *mut int (set_path)(struct mtk_eth eth, u64,
}
...
#[no_mangle]
unsafe extern "C" fn set_mux_gdm1_to_gmac1_esw(eth: *mut mtk_eth, path: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_mux_gmac2_gmac0_to_gephy(eth: *mut mtk_eth, path: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_mux_u3_gmac2_to_qphy(eth: *mut mtk_eth, path: u64) -> c_int {
    static int set_mux_u3_gmac2_to_qphy(struct mtk_eth *eth, u64 path)
    {
    let mut val: c_uint = 0, mask = 0, reg = 0;
    let mut updated: bool = true;
    switch (path) {
    case MTK_ETH_PATH_GMAC2_SGMII:
...
#[no_mangle]
unsafe extern "C" fn set_mux_gmac2_to_2p5gphy(eth: *mut mtk_eth, path: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_mux_gmac1_gmac2_to_sgmii_rgmii(eth: *mut mtk_eth, path: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_mux_gmac12_to_gephy_sgmii(eth: *mut mtk_eth, path: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_eth_mux_setup(eth: *mut mtk_eth, path: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_gmac_sgmii_path_setup(eth: *mut mtk_eth, mac_id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_gmac_2p5gphy_path_setup(eth: *mut mtk_eth, mac_id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_gmac_gephy_path_setup(eth: *mut mtk_eth, mac_id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_gmac_rgmii_path_setup(eth: *mut mtk_eth, mac_id: c_int) -> c_int {
