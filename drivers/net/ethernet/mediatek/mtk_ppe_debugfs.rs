...
//! Source: drivers/net/ethernet/mediatek/mtk_ppe_debugfs.c
#![no_std]
...
// Copyright (C) 2020 Felix Fietkau <nbd@nbd.name>
    ...
    continue;
    acct = mtk_foe_entry_get_mib(ppe, i, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn mtk_ppe_debugfs_init(ppe: *mut mtk_ppe, index: c_int) -> c_int {
    int mtk_ppe_debugfs_init(struct mtk_ppe *ppe, int index)
    {
    struct dentry *root;
    snprintf(ppe.dirname, sizeof(ppe.dirname), "ppe%d", index);
    root = debugfs_create_dir(ppe.dirname, core::ptr::null_mut());
