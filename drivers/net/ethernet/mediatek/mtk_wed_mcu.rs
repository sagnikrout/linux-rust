...
//! Source: drivers/net/ethernet/mediatek/mtk_wed_mcu.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wo_r32(reg: u32) -> u32 {
    static u32 wo_r32(u32 reg)
    {
    return readl(mem_region[MTK_WED_WO_REGION_BOOT].addr + reg);
    }
#[no_mangle]
unsafe extern "C" fn wo_w32(reg: u32, val: u32) {
    ...
    {
    let mut length: c_int = sizeof(struct mtk_wed_mcu_hdr) + data_len;
    struct sk_buff *skb;
...
#[no_mangle]
pub unsafe extern "C" fn mtk_wed_mcu_rx_event(wo: *mut mtk_wed_wo, skb: *mut sk_buff) {
    ...
    {
    let mut count: u32 = get_unaligned_le32(skb.data);
    ...
    let mut count: u32 = skb.len / sizeof(*info);
    int i;
    for (i = 0 ; i < count ; i++)
...
#[no_mangle]
pub unsafe extern "C" fn mtk_wed_mcu_init(wo: *mut mtk_wed_wo) -> c_int {
