...
//! Source: drivers/net/ethernet/ti/netcp_xgbepcsr.c
#![no_std]
...
// XGBE registers
pub const XGBE_CTRL_OFFSET: c_uint = 0x0c;
pub const XGBE_SGMII_1_OFFSET: c_uint = 0x0114;
pub const XGBE_SGMII_2_OFFSET: c_uint = 0x0214;
// PCS-R registers
pub const PCSR_CPU_CTRL_OFFSET: c_uint = 0x1fd0;
...
pub const PHY_A(serdes): c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct serdes_cfg {
    pub ofs: u32,
    pub val: u32,
    pub mask: u32,
}
...
#[no_mangle]
unsafe extern "C" fn netcp_xgbe_serdes_cmu_init(serdes_regs: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn netcp_xgbe_serdes_com_enable(serdes_regs: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn netcp_xgbe_serdes_phyb_rst_clr(serdes_regs: *mut void __iomem) {
    static void netcp_xgbe_serdes_phyb_rst_clr(void __iomem *serdes_regs)
    {
    reg_rmw(serdes_regs + 0x0a00, 0x0000001f, 0x000000ff);
    }
#[no_mangle]
unsafe extern "C" fn netcp_xgbe_serdes_pll_disable(serdes_regs: *mut void __iomem) {
    static void netcp_xgbe_serdes_pll_disable(void __iomem *serdes_regs)
    {
    writel(0x88000000, serdes_regs + 0x1ff4);
    }
#[no_mangle]
unsafe extern "C" fn netcp_xgbe_serdes_pll_enable(serdes_regs: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn netcp_xgbe_wait_pll_locked(sw_regs: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netcp_xgbe_serdes_enable_xgmii_port(sw_regs: *mut void __iomem) {
    static void netcp_xgbe_serdes_enable_xgmii_port(void __iomem *sw_regs)
    {
    writel(0x03, sw_regs + XGBE_CTRL_OFFSET);
    }
#[no_mangle]
unsafe extern "C" fn netcp_xgbe_serdes_read_tbus_val(serdes_regs: *mut void __iomem) -> u32 {
...
// Reset the Error counts!
    ...
    let mut retries: c_int = 0, link_up;
    u32 lane_down[2];
    do {
    lane_down[0] = 0;
    lane_down[1] = 0;
...
#[no_mangle]
unsafe extern "C" fn netcp_xgbe_reset_serdes(serdes_regs: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn netcp_xgbe_serdes_init(serdes_regs: *mut void __iomem, xgbe_regs: *mut void __iomem) -> c_int {
