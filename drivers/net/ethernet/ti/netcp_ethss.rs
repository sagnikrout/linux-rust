...
//! Source: drivers/net/ethernet/ti/netcp_ethss.c
#![no_std]
...
pub const GBE_SS_VERSION_14: c_uint = 0x4ed2;
pub const GBE_SS_REG_INDEX: c_int = 0;
pub const GBE_SGMII34_REG_INDEX: c_int = 1;
pub const GBE_SM_REG_INDEX: c_int = 2;
// offset relative to base of GBE_SS_REG_INDEX
pub const GBE13_SGMII_MODULE_OFFSET: c_uint = 0x100;
// offset relative to base of GBE_SM_REG_INDEX
pub const GBE13_HOST_PORT_OFFSET: c_uint = 0x34;
pub const GBE13_SLAVE_PORT_OFFSET: c_uint = 0x60;
pub const GBE13_EMAC_OFFSET: c_uint = 0x100;
pub const GBE13_SLAVE_PORT2_OFFSET: c_uint = 0x200;
pub const GBE13_HW_STATS_OFFSET: c_uint = 0x300;
pub const GBE13_CPTS_OFFSET: c_uint = 0x500;
pub const GBE13_ALE_OFFSET: c_uint = 0x600;
pub const GBE13_HOST_PORT_NUM: c_int = 0;
// 1G Ethernet NU SS defines

pub const GBE_SS_ID_NU: c_uint = 0x4ee6;
pub const GBE_SS_ID_2U: c_uint = 0x4ee8;
    ...
    (GBE_IDENT((d).ss_version) == GBE_SS_ID_2U)
pub const GBENU_SS_REG_INDEX: c_int = 0;
pub const GBENU_SM_REG_INDEX: c_int = 1;
pub const GBENU_SGMII_MODULE_OFFSET: c_uint = 0x100;
pub const GBENU_HOST_PORT_OFFSET: c_uint = 0x1000;
pub const GBENU_SLAVE_PORT_OFFSET: c_uint = 0x2000;
pub const GBENU_EMAC_OFFSET: c_uint = 0x2330;
pub const GBENU_HW_STATS_OFFSET: c_uint = 0x1a000;
pub const GBENU_CPTS_OFFSET: c_uint = 0x1d000;
pub const GBENU_ALE_OFFSET: c_uint = 0x1e000;
pub const GBENU_HOST_PORT_NUM: c_int = 0;
pub const GBENU_SGMII_MODULE_SIZE: c_uint = 0x100;
// 10G Ethernet SS defines

pub const XGBE_SS_VERSION_10: c_uint = 0x4ee4;
pub const XGBE_SS_REG_INDEX: c_int = 0;
pub const XGBE_SM_REG_INDEX: c_int = 1;
pub const XGBE_SERDES_REG_INDEX: c_int = 2;
// offset relative to base of XGBE_SS_REG_INDEX
pub const XGBE10_SGMII_MODULE_OFFSET: c_uint = 0x100;

// offset relative to base of XGBE_SM_REG_INDEX
pub const XGBE10_HOST_PORT_OFFSET: c_uint = 0x34;
pub const XGBE10_SLAVE_PORT_OFFSET: c_uint = 0x64;
pub const XGBE10_EMAC_OFFSET: c_uint = 0x400;
pub const XGBE10_CPTS_OFFSET: c_uint = 0x600;
pub const XGBE10_ALE_OFFSET: c_uint = 0x700;
pub const XGBE10_HW_STATS_OFFSET: c_uint = 0x800;
pub const XGBE10_HOST_PORT_NUM: c_int = 0;

// Soft reset register values

pub const DEVICE_EMACSL_RESET_POLL_COUNT: c_int = 100;

pub const GBE13_REG_VAL_STAT_ENABLE_ALL: c_uint = 0xff;
pub const XGBE_REG_VAL_STAT_ENABLE_ALL: c_uint = 0xf;

pub const GBE_MASK_NO_PORTS: c_int = 0;
    ...
    MACSL_ENABLE_EXT_CTL |	MACSL_RX_ENABLE_CSF)
pub const GBE_STATSA_MODULE: c_int = 0;
pub const GBE_STATSB_MODULE: c_int = 1;
pub const GBE_STATSC_MODULE: c_int = 2;
pub const GBE_STATSD_MODULE: c_int = 3;
pub const GBENU_STATS0_MODULE: c_int = 0;
pub const GBENU_STATS1_MODULE: c_int = 1;
pub const GBENU_STATS2_MODULE: c_int = 2;
pub const GBENU_STATS3_MODULE: c_int = 3;
pub const GBENU_STATS4_MODULE: c_int = 4;
pub const GBENU_STATS5_MODULE: c_int = 5;
pub const GBENU_STATS6_MODULE: c_int = 6;
pub const GBENU_STATS7_MODULE: c_int = 7;
pub const GBENU_STATS8_MODULE: c_int = 8;
pub const XGBE_STATS0_MODULE: c_int = 0;
pub const XGBE_STATS1_MODULE: c_int = 1;
pub const XGBE_STATS2_MODULE: c_int = 2;
// s: 0-based slave_port

    (((s) < 2) ? (d).sgmii_port_regs : (d).sgmii_port34_regs)
pub const GBE_TX_QUEUE: c_int = 648;
pub const GBE_TXHOOK_ORDER: c_int = 0;
pub const GBE_RXHOOK_ORDER: c_int = 0;
pub const GBE_DEFAULT_ALE_AGEOUT: c_int = 30;
...
pub const HOST_TX_PRI_MAP_DEFAULT: c_uint = 0x00000000;

// Px_TS_CTL register fields

pub const TS_MSG_TYPE_EN_SHIFT: c_int = 16;
pub const TS_MSG_TYPE_EN_MASK: c_uint = 0xffff;
// Px_TS_SEQ_LTYPE register fields
pub const TS_SEQ_ID_OFS_SHIFT: c_int = 16;
pub const TS_SEQ_ID_OFS_MASK: c_uint = 0x3f;
// Px_TS_CTL_LTYPE2 register fields

pub const TS_UNI_EN_SHIFT: c_int = 24;

    (TS_TX_ANX_D_EN	| TS_TX_ANX_E_EN | TS_TX_ANX_F_EN)

    (TS_RX_ANX_D_EN	| TS_RX_ANX_E_EN | TS_RX_ANX_F_EN)

pub const TS_CTL_DST_PORT_SHIFT: c_int = 21;

    (TS_107 | TS_129 | TS_130 | TS_131 | TS_132)
pub const TS_CTL_MADDR_SHIFT: c_int = 16;
// The PTP event messages - Sync, Delay_Req, Pdelay_Req, and Pdelay_Resp.

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgbe_ss_regs {
    pub id_ver: u32,
    pub synce_count: u32,
    pub synce_mux: u32,
    pub control: u32,
...
pub struct xgbe_port_regs {
    ...
    pub sa_hi: u32,
    pub ts_ctl: u32,
    pub ts_seq_ltype: u32,
    pub ts_vlan: u32,
    pub ts_ctl_ltype2: u32,
    pub ts_ctl2: u32,
    pub control: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgbe_host_port_regs {
    pub blk_cnt: u32,
    pub port_vlan: u32,
    pub tx_pri_map: u32,
    pub src_id: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgbe_host_hw_stats {
    pub rx_good_frames: u32,
    pub rx_broadcast_frames: u32,
    pub rx_multicast_frames: u32,
    pub __rsvd_0: [u32; 3],
    pub rx_oversized_frames: u32,
    pub __rsvd_1: u32,
    pub rx_undersized_frames: u32,
    pub __rsvd_2: u32,
    pub overrun_type4: u32,
    pub overrun_type5: u32,
    pub rx_bytes: u32,
    ...
    pub __rsvd_3: [u32; 9],
    pub tx_bytes: u32,
    pub tx_64byte_frames: u32,
    pub tx_65_to_127byte_frames: u32,
    pub tx_128_to_255byte_frames: u32,
    pub tx_256_to_511byte_frames: u32,
    pub tx_512_to_1023byte_frames: u32,
    pub tx_1024byte_frames: u32,
    pub net_bytes: u32,
    pub rx_sof_overruns: u32,
    pub rx_mof_overruns: u32,
    pub rx_dma_overruns: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgbe_hw_stats {
    pub rx_good_frames: u32,
    pub rx_broadcast_frames: u32,
    pub rx_multicast_frames: u32,
    pub rx_pause_frames: u32,
    pub rx_crc_errors: u32,
    pub rx_align_code_errors: u32,
    pub rx_oversized_frames: u32,
    pub rx_jabber_frames: u32,
    pub rx_undersized_frames: u32,
    ...
    pub tx_deferred_frames: u32,
    pub tx_collision_frames: u32,
    pub tx_single_coll_frames: u32,
    pub tx_mult_coll_frames: u32,
    pub tx_excessive_collisions: u32,
    pub tx_late_collisions: u32,
    pub tx_underrun: u32,
    pub tx_carrier_sense_errors: u32,
    pub tx_bytes: u32,
    pub tx_64byte_frames: u32,
    pub tx_65_to_127byte_frames: u32,
    pub tx_128_to_255byte_frames: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbenu_ss_regs {
    pub id_ver: u32,
    pub /: *mut *mut u32 synce_count; / NU,
    pub /: *mut *mut u32 synce_mux; / NU,
    pub /: *mut *mut u32 control; / 2U,
    pub /: *mut *mut u32 __rsvd_0[2]; / 2U,
    pub /: *mut *mut u32 rgmii_status; / 2U,
    pub /: *mut *mut u32 ss_status; / 2U,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbenu_switch_regs {
    pub id_ver: u32,
    pub control: u32,
    pub __rsvd_0: [u32; 2],
    pub emcontrol: u32,
    pub stat_port_en: u32,
    pub /: *mut *mut u32 ptype; / NU,
    pub soft_idle: u32,
    pub /: *mut *mut u32 thru_rate; / NU,
    pub /: *mut *mut u32 gap_thresh; / NU,
    pub /: *mut *mut u32 tx_start_wds; / NU,
    pub /: *mut *mut u32 eee_prescale; / 2U,
    pub /: *mut *mut u32 tx_g_oflow_thresh_set; / NU,
    pub /: *mut *mut u32 tx_g_oflow_thresh_clr; / NU,
    pub /: *mut *mut u32 tx_g_buf_thresh_set_l; / NU,
    pub /: *mut *mut u32 tx_g_buf_thresh_set_h; / NU,
    pub /: *mut *mut u32 tx_g_buf_thresh_clr_l; / NU,
    pub /: *mut *mut u32 tx_g_buf_thresh_clr_h; / NU,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbenu_port_regs {
    pub __rsvd_0: u32,
    pub control: u32,
    pub /: *mut *mut u32 max_blks; / 2U,
    pub mem_align1: u32,
    pub blk_cnt: u32,
    pub port_vlan: u32,
    pub /: *mut *mut u32 tx_pri_map; / NU,
    pub /: *mut *mut u32 pri_ctl; / 2U,
    pub rx_pri_map: u32,
    pub rx_maxlen: u32,
    pub /: *mut *mut u32 tx_blks_pri; / NU,
    pub __rsvd_1: u32,
    pub /: *mut *mut u32 idle2lpi; / 2U,
    pub /: *mut *mut u32 lpi2idle; / 2U,
    pub /: *mut *mut u32 eee_status; / 2U,
    pub __rsvd_2: u32,
    pub /: *mut *mut u32 __rsvd_3[176]; / NU: more to add,
    pub __rsvd_4: [u32; 2],
    pub sa_lo: u32,
    pub sa_hi: u32,
    pub ts_ctl: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbenu_host_port_regs {
    pub __rsvd_0: u32,
    pub control: u32,
    pub /: *mut *mut u32 flow_id_offset; / 2U,
    pub __rsvd_1: u32,
    pub blk_cnt: u32,
    pub port_vlan: u32,
    pub /: *mut *mut u32 tx_pri_map; / NU,
    ...
    pub __rsvd_2: u32,
    pub /: *mut *mut u32 idle2lpi; / 2U,
    pub /: *mut *mut u32 lpi2wake; / 2U,
    pub /: *mut *mut u32 eee_status; / 2U,
    pub __rsvd_3: u32,
    pub /: *mut *mut u32 __rsvd_4[184]; / NU,
    pub /: *mut *mut u32 host_blks_pri; / NU,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbenu_emac_regs {
    pub mac_control: u32,
    pub mac_status: u32,
    pub soft_reset: u32,
    pub boff_test: u32,
    pub rx_pause: u32,
    pub /: *mut *mut u32 __rsvd_0[11]; / NU,
    pub tx_pause: u32,
    pub /: *mut *mut u32 __rsvd_1[11]; / NU,
    pub em_control: u32,
    pub tx_gap: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbenu_hw_stats {
    pub rx_good_frames: u32,
    pub rx_broadcast_frames: u32,
    pub rx_multicast_frames: u32,
    pub /: *mut *mut u32 rx_pause_frames; / slave,
    pub rx_crc_errors: u32,
    pub /: *mut *mut u32 rx_align_code_errors; / slave,
    pub rx_oversized_frames: u32,
    pub /: *mut *mut u32 rx_jabber_frames; / slave,
    pub rx_undersized_frames: u32,
    pub /: *mut *mut u32 rx_fragments; / slave,
    pub ale_drop: u32,
    pub ale_overrun_drop: u32,
    pub rx_bytes: u32,
    pub tx_good_frames: u32,
    pub tx_broadcast_frames: u32,
    pub tx_multicast_frames: u32,
    pub /: *mut *mut u32 tx_pause_frames; / slave,
    pub /: *mut *mut u32 tx_deferred_frames; / slave,
    pub /: *mut *mut u32 tx_collision_frames; / slave,
    pub /: *mut *mut u32 tx_single_coll_frames; / slave,
    pub /: *mut *mut u32 tx_mult_coll_frames; / slave,
    pub /: *mut *mut u32 tx_excessive_collisions; / slave,
    pub /: *mut *mut u32 tx_late_collisions; / slave,
    pub /: *mut *mut u32 rx_ipg_error; / slave 10G only,
    pub /: *mut *mut u32 tx_carrier_sense_errors; / slave,
    pub tx_bytes: u32,
    pub tx_64B_frames: u32,
    pub tx_65_to_127B_frames: u32,
    pub tx_128_to_255B_frames: u32,
    pub tx_256_to_511B_frames: u32,
    pub tx_512_to_1023B_frames: u32,
    pub tx_1024B_frames: u32,
    pub net_bytes: u32,
    pub rx_bottom_fifo_drop: u32,
    pub rx_port_mask_drop: u32,
    pub rx_top_fifo_drop: u32,
    pub ale_rate_limit_drop: u32,
    pub ale_vid_ingress_drop: u32,
    pub ale_da_eq_sa_drop: u32,
    pub __rsvd_0: [u32; 3],
    pub ale_unknown_ucast: u32,
    pub ale_unknown_ucast_bytes: u32,
    pub ale_unknown_mcast: u32,
    pub ale_unknown_mcast_bytes: u32,
    pub ale_unknown_bcast: u32,
    pub ale_unknown_bcast_bytes: u32,
    pub ale_pol_match: u32,
    pub /: *mut *mut u32 ale_pol_match_red; / NU,
    pub /: *mut *mut u32 ale_pol_match_yellow; / NU,
    pub __rsvd_1: [u32; 44],
    pub tx_mem_protect_err: u32,
// following NU only
    pub tx_pri0: u32,
    pub tx_pri1: u32,
    pub tx_pri2: u32,
    ...
    pub tx_pri6: u32,
    pub tx_pri7: u32,
    pub tx_pri0_bcnt: u32,
    pub tx_pri1_bcnt: u32,
    pub tx_pri2_bcnt: u32,
    pub tx_pri3_bcnt: u32,
    pub tx_pri4_bcnt: u32,
    pub tx_pri5_bcnt: u32,
    pub tx_pri6_bcnt: u32,
    pub tx_pri7_bcnt: u32,
    pub tx_pri0_drop: u32,
    pub tx_pri1_drop: u32,
    pub tx_pri2_drop: u32,
    pub tx_pri3_drop: u32,
    pub tx_pri4_drop: u32,
    pub tx_pri5_drop: u32,
    pub tx_pri6_drop: u32,
    pub tx_pri7_drop: u32,
    pub tx_pri0_drop_bcnt: u32,
    pub tx_pri1_drop_bcnt: u32,
    pub tx_pri2_drop_bcnt: u32,
    pub tx_pri3_drop_bcnt: u32,
    pub tx_pri4_drop_bcnt: u32,
    pub tx_pri5_drop_bcnt: u32,
    pub tx_pri6_drop_bcnt: u32,
    pub tx_pri7_drop_bcnt: u32,
}

pub const GBENU_HW_STATS_REG_MAP_SZ: c_uint = 0x200;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbe_ss_regs {
    pub id_ver: u32,
    pub synce_count: u32,
    pub synce_mux: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbe_ss_regs_ofs {
    pub id_ver: u16,
    pub control: u16,
    pub /: *mut *mut u16 rgmii_status; / 2U,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbe_switch_regs {
    pub id_ver: u32,
    pub control: u32,
    pub soft_reset: u32,
    pub stat_port_en: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbe_switch_regs_ofs {
    pub id_ver: u16,
    pub control: u16,
    pub soft_reset: u16,
    pub emcontrol: u16,
    pub stat_port_en: u16,
    pub ptype: u16,
...
pub struct gbe_port_regs_ofs {
    ...
    pub sa_hi: u16,
    pub ts_ctl: u16,
    pub ts_seq_ltype: u16,
    pub ts_vlan: u16,
    pub ts_ctl_ltype2: u16,
    pub ts_ctl2: u16,
    pub /: *mut *mut u16 rx_maxlen; / 2U, NU,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbe_host_port_regs {
    pub src_id: u32,
    pub port_vlan: u32,
    pub rx_pri_map: u32,
    pub rx_maxlen: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbe_host_port_regs_ofs {
    pub port_vlan: u16,
    pub tx_pri_map: u16,
    pub rx_maxlen: u16,
}
...
pub const GBE_MAX_HW_STAT_MODS: c_int = 9;
pub const GBE_HW_STATS_REG_MAP_SZ: c_uint = 0x100;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ts_ctl {
    pub uni: c_int,
    pub dst_port_map: u8,
    pub maddr_map: u8,
    pub ts_mcast_type: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbe_slave {
    pub port_regs: *mut void __iomem,
    pub emac_regs: *mut void __iomem,
    pub port_regs_ofs: gbe_port_regs_ofs,
    pub emac_regs_ofs: gbe_emac_regs_ofs,
    pub /: *mut *mut int slave_num; / 0 based logical number,
    pub /: *mut *mut int port_num; / actual port number,
    pub link_state: core::sync::atomic::AtomicI32,
    pub open: bool,
    pub phy: *mut phy_device,
    pub link_interface: u32,
    pub mac_control: u32,
    pub phy_port_t: u8,
    pub node: *mut device_node,
    pub phy_node: *mut device_node,
    pub ts_ctl: ts_ctl,
    pub slave_list: list_head,
}
...
pub struct gbe_priv {
    ...
    pub ale_ports: u32,
    pub enable_ale: bool,
    pub max_num_slaves: u8,
    pub /: *mut *mut u8 max_num_ports; / max_num_slaves + 1,
    pub num_stats_mods: u8,
    pub tx_pipe: netcp_tx_pipe,
    pub host_port: c_int,
    pub rx_packet_max: u32,
    pub ss_version: u32,
    pub stats_en_mask: u32,
    pub ss_regs: *mut void __iomem,
    pub switch_regs: *mut void __iomem,
    pub host_port_regs: *mut void __iomem,
    pub ale_reg: *mut void __iomem,
    pub cpts_reg: *mut void __iomem,
    pub sgmii_port_regs: *mut void __iomem,
    pub sgmii_port34_regs: *mut void __iomem,
    pub xgbe_serdes_regs: *mut void __iomem,
    pub hw_stats_regs: [*mut void __iomem; GBE_MAX_HW_STAT_MODS],
    pub ss_regs_ofs: gbe_ss_regs_ofs,
    pub switch_regs_ofs: gbe_switch_regs_ofs,
    pub host_port_regs_ofs: gbe_host_port_regs_ofs,
    pub ale: *mut cpsw_ale,
    pub tx_queue_id: c_uint,
    pub dma_chan_name: *const c_char,
    pub gbe_intf_head: list_head,
    pub secondary_slaves: list_head,
    pub dummy_ndev: *mut net_device,
    pub hw_stats: *mut u64,
    pub hw_stats_prev: *mut u32,
    pub et_stats: *const netcp_ethtool_stat,
    pub num_et_stats: c_int,
// Lock for updating the hwstats
    pub hw_stats_lock: spinlock_t,
    pub cpts_registered: c_int,
    pub cpts: *mut cpts,
...
pub struct gbe_intf {
    ...
    pub dev: *mut device,
    pub gbe_dev: *mut gbe_priv,
    pub tx_pipe: netcp_tx_pipe,
    pub slave: *mut gbe_slave,
    pub gbe_intf_list: list_head,
...
pub const GBENU_ET_STATS_HOST_SIZE: c_int = 52;
...
pub const GBENU_ET_STATS_PORT_SIZE: c_int = 65;
...
#[no_mangle]
unsafe extern "C" fn keystone_get_msglevel(ndev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn keystone_set_msglevel(ndev: *mut net_device, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn keystone_get_sset_count(ndev: *mut net_device, stringset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gbe_reset_mod_stats(gbe_dev: *mut gbe_priv, stats_mod: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gbe_update_stats(gbe_dev: *mut gbe_priv, data: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn gbe_reset_mod_stats_ver14(gbe_dev: *mut gbe_priv, stats_mod: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gbe_update_stats_ver14(gbe_dev: *mut gbe_priv, data: *mut u64) {
    static void gbe_update_stats_ver14(struct gbe_priv *gbe_dev, uint64_t *data)
    {
    let mut half_num_et_stats: u32 = (gbe_dev.num_et_stats / 2);
    int et_entry, j, pair;
...
#[no_mangle]
unsafe extern "C" fn gbe_get_slave_port(priv: *mut gbe_priv, slave_num: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gbe_phy_link_status(slave: *mut gbe_slave) -> bool {
...
#[no_mangle]
unsafe extern "C" fn netcp_2u_rgmii_get_port_link(gbe_dev: *mut gbe_priv, status: *mut bool) {
...
// status = !!(val & RGMII_REG_STATUS_LINK);
    ...
    struct net_device *ndev)
    {
    let mut sw_link_state: bool = true, phy_link_state;
    let mut sp: c_int = slave.slave_num, link_state;
    if (!slave.open)
    return;
...
#[no_mangle]
unsafe extern "C" fn xgbe_adjust_link(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn gbe_adjust_link(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn gbe_adjust_link_sec_slaves(ndev: *mut net_device) {
    static void gbe_adjust_link_sec_slaves(struct net_device *ndev)
    {
    struct gbe_priv *gbe_dev = netdev_priv(ndev);
    struct gbe_slave *slave;
    for_each_sec_slave(slave, gbe_dev)
    netcp_ethss_update_link_state(gbe_dev, slave, core::ptr::null_mut());
    }
// Reset EMAC
// Soft reset is set and polled until clear, or until a timeout occurs
//
#[no_mangle]
unsafe extern "C" fn gbe_port_reset(slave: *mut gbe_slave) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gbe_slave_stop(intf: *mut gbe_intf) {
...
// Disable forwarding
    ...
    slave.phy = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn gbe_sgmii_config(priv: *mut gbe_priv, slave: *mut gbe_slave) {
...
#[no_mangle]
unsafe extern "C" fn gbe_init_host_port(priv: *mut gbe_priv) {
    static void gbe_init_host_port(struct gbe_priv *priv)
    {
    let mut bypass_en: c_int = 1;
// Host Tx Pri
...
#[no_mangle]
unsafe extern "C" fn gbe_add_mcast_addr(gbe_intf: *mut gbe_intf, addr: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn gbe_add_ucast_addr(gbe_intf: *mut gbe_intf, addr: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn gbe_del_mcast_addr(gbe_intf: *mut gbe_intf, addr: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn gbe_del_ucast_addr(gbe_intf: *mut gbe_intf, addr: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn gbe_add_addr(intf_priv: *mut c_void, naddr: *mut netcp_addr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gbe_del_addr(intf_priv: *mut c_void, naddr: *mut netcp_addr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gbe_add_vid(intf_priv: *mut c_void, vid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gbe_del_vid(intf_priv: *mut c_void, vid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gbe_txtstamp(context: *mut c_void, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn gbe_rxtstamp(gbe_intf: *mut gbe_intf, p_info: *mut netcp_packet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gbe_hwtstamp_get(intf_priv: *mut c_void, cfg: *mut kernel_hwtstamp_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gbe_hwtstamp(gbe_intf: *mut gbe_intf) {
...
#[no_mangle]
unsafe extern "C" fn gbe_register_cpts(gbe_dev: *mut gbe_priv) {
...
#[no_mangle]
unsafe extern "C" fn gbe_unregister_cpts(gbe_dev: *mut gbe_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn gbe_register_cpts(gbe_dev: *mut gbe_priv) {
    static inline void gbe_register_cpts(struct gbe_priv *gbe_dev)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn gbe_unregister_cpts(gbe_dev: *mut gbe_priv) {
...
#[no_mangle]
unsafe extern "C" fn gbe_set_rx_mode(intf_priv: *mut c_void, promisc: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gbe_ioctl(intf_priv: *mut c_void, req: *mut ifreq, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netcp_ethss_timer(t: *mut timer_list) {
...
// A timer runs as a BH, no need to block them
    ...
    if (IS_SS_ID_VER_14(gbe_dev))
    gbe_update_stats_ver14(gbe_dev, core::ptr::null_mut());
    else
    gbe_update_stats(gbe_dev, core::ptr::null_mut());
    spin_unlock(&gbe_dev.hw_stats_lock);
    gbe_dev.timer.expires	= jiffies + GBE_TIMER_INTERVAL;
    add_timer(&gbe_dev.timer);
    }
#[no_mangle]
unsafe extern "C" fn gbe_txhook(order: c_int, data: *mut c_void, p_info: *mut netcp_packet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gbe_rxhook(order: c_int, data: *mut c_void, p_info: *mut netcp_packet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gbe_open(intf_priv: *mut c_void, ndev: *mut net_device) -> c_int {
    ...
    struct netcp_intf *netcp = netdev_priv(ndev);
    struct gbe_slave *slave = gbe_intf.slave;
    let mut port_num: c_int = slave.port_num;
    u32 reg, val;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn gbe_close(intf_priv: *mut c_void, ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_slave_ts_ctl(slave: *mut gbe_slave) {
...
// Initialize EMAC register offsets
    ...
    struct gbe_slave *slave;
    let mut mac_phy_link: bool = false;
...
#[no_mangle]
unsafe extern "C" fn free_secondary_ports(gbe_dev: *mut gbe_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_SS_ID_MU(gbe_dev)) -> else {
    else if (IS_SS_ID_MU(gbe_dev))
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_SS_ID_2U(gbe_dev)) -> else {
    else if (IS_SS_ID_2U(gbe_dev))
    ale_params.dev_id = "66ak2g";
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_SS_ID_XGBE(gbe_dev)) -> else {
    else if (IS_SS_ID_XGBE(gbe_dev))
...
#[no_mangle]
unsafe extern "C" fn gbe_release(intf_priv: *mut c_void) -> c_int {
    static int gbe_release(void *intf_priv)
    {
    struct gbe_intf *gbe_intf = intf_priv;
    gbe_intf.ndev.ethtool_ops = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn gbe_remove(netcp_device: *mut netcp_device, inst_priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keystone_gbe_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn keystone_gbe_exit() -> void __exit {
