...
//! Source: drivers/net/ethernet/ti/icssg/icssg_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn emac_get_msglevel(ndev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn emac_set_msglevel(ndev: *mut net_device, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn emac_get_eee(ndev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emac_set_eee(ndev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emac_nway_reset(ndev: *mut net_device) -> c_int {
    static int emac_nway_reset(struct net_device *ndev)
    {
    return phy_ethtool_nway_reset(ndev);
    }
#[no_mangle]
unsafe extern "C" fn emac_get_sset_count(ndev: *mut net_device, stringset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emac_get_strings(ndev: *mut net_device, stringset: u32, data: *mut u8) {
