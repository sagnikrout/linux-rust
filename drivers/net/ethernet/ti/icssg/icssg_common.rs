...
//! Source: drivers/net/ethernet/ti/icssg/icssg_common.c
#![no_std]
...
// Netif debug messages possible
    ...
    rx_chn.pg_pool = core::ptr::null_mut();
    }
    if (rx_chn.desc_pool)
...
#[no_mangle]
pub unsafe extern "C" fn prueth_cleanup_tx_chns(emac: *mut prueth_emac) {
...
#[no_mangle]
pub unsafe extern "C" fn prueth_ndev_del_tx_napi(emac: *mut prueth_emac, num: c_int) {
    ...
    let mut num_tx: c_int = 0, pkt_len;
    int descs_avail, ret;
    u32 dst_tag_id;
    u32 *epib;
    int i;
...
//
    ...
    let mut total_bytes: c_uint = 0;
    let mut xsk_frames_done: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn emac_tx_timer_callback(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn emac_napi_tx_poll(napi_tx: *mut napi_struct, budget: c_int) -> c_int {
    static int emac_napi_tx_poll(struct napi_struct *napi_tx, int budget)
    {
    struct prueth_tx_chn *tx_chn = prueth_napi_to_tx_chn(napi_tx);
    struct prueth_emac *emac = tx_chn.emac;
    let mut tdown: bool = false;
    int num_tx_packets;
...
#[no_mangle]
unsafe extern "C" fn prueth_tx_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn prueth_ndev_add_tx_napi(emac: *mut prueth_emac) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn prueth_init_tx_chns(emac: *mut prueth_emac) -> c_int {
...
// To differentiate channels for SLICE0 vs SLICE1
    ...
    tx_chn.tx_chn = core::ptr::null_mut();
    netdev_err(ndev,
    ...
    tx_chn.desc_pool = core::ptr::null_mut();
...
// init all flows
    ...
    rx_chn.rx_chn = core::ptr::null_mut();
    ...
    rx_chn.desc_pool = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn icssg_ts_to_ns(hi_sw: u32, hi: u32, lo: u32, cycle_time_ns: u32) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn emac_run_xdp(emac: *mut prueth_emac, xdp: *mut xdp_buff, len: *mut u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn prueth_rx_alloc_zc(emac: *mut prueth_emac, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emac_dispatch_skb_zc(emac: *mut prueth_emac, xdp: *mut xdp_buff, psdata: *mut u32) {
    static void emac_dispatch_skb_zc(struct prueth_emac *emac, struct xdp_buff *xdp, u32 *psdata)
    {
    let mut headroom: c_uint = xdp.data - xdp.data_hard_start;
    let mut pkt_len: c_uint = xdp.data_end - xdp.data;
    struct net_device *ndev = emac.ndev;
    struct sk_buff *skb;
...
// firmware adds 4 CRC bytes, strip them
    pkt_len -= 4;
    cppi5_desc_get_tags_ids(&desc_rx.hdr, &port_id, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn emac_rx_packet(emac: *mut prueth_emac, flow_id: u32, xdp_state: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn prueth_rx_cleanup(data: *mut c_void, desc_dma: dma_addr_t) {
...
#[no_mangle]
unsafe extern "C" fn prueth_tx_ts_cookie_get(emac: *mut prueth_emac) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn icssg_ndo_start_xmit(skb: *mut sk_buff, ndev: *mut net_device) -> enum netdev_tx {
...
// Barrier, so that stop_queue visible to other cpus
    ...
    emac.tx_ts_skb[tx_ts_cookie] = core::ptr::null_mut();
    }
    drop_free_descs:
    prueth_xmit_free(tx_chn, first_desc);
    drop_free_skb:
...
#[no_mangle]
pub unsafe extern "C" fn prueth_tx_cleanup(data: *mut c_void, desc_dma: dma_addr_t) {
...
#[no_mangle]
pub unsafe extern "C" fn prueth_rx_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn prueth_cleanup_tx_ts(emac: *mut prueth_emac) {
    ...
    emac.tx_ts_skb[i] = core::ptr::null_mut();
    }
    }
    }
    EXPORT_SYMBOL_GPL(prueth_cleanup_tx_ts);
#[no_mangle]
pub unsafe extern "C" fn icssg_napi_rx_poll(napi_rx: *mut napi_struct, budget: c_int) -> c_int {
    ...
    struct prueth_rx_chn *rx_chn = &emac.rx_chns;
    let mut xdp_state_or: c_int = 0;
    let mut num_rx: c_int = 0;
    int cur_budget;
    u32 xdp_state;
    int ret;
    while (flow--) {
...
#[no_mangle]
pub unsafe extern "C" fn icssg_ndo_tx_timeout(ndev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn prueth_node_port(eth_node: *mut device_node) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: port_id ==) -> else {
    else if (port_id == 1)
...
#[no_mangle]
pub unsafe extern "C" fn prueth_node_mac(eth_node: *mut device_node) -> c_int {
...
pub unsafe extern "C" fn if(1: port_id ==) -> else {
    ...
    prueth.emac[mac] = core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(prueth_netdev_exit);
#[no_mangle]
pub unsafe extern "C" fn prueth_get_cores(prueth: *mut prueth, slice: c_int, is_sr1: bool) -> c_int {
    int prueth_get_cores(struct prueth *prueth, int slice, bool is_sr1)
    {
    struct device *dev = prueth.dev;
    enum pruss_pru_id pruss_id;
    struct device_node *np;
    let mut idx: c_int = -1, ret;
    np = dev.of_node;
    switch (slice) {
    case ICSS_SLICE0:
    idx = 0;
...
#[no_mangle]
pub unsafe extern "C" fn prueth_put_cores(prueth: *mut prueth, slice: c_int) {
...
#[no_mangle]
unsafe extern "C" fn prueth_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prueth_resume(dev: *mut device) -> c_int {
