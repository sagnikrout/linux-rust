...
//! Source: drivers/net/ethernet/ti/icssg/icssg_mii_cfg.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn icssg_mii_update_ipg(mii_rt: *mut regmap, mii: c_int, ipg: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn icssg_mii_update_mtu(mii_rt: *mut regmap, mii: c_int, mtu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn icssg_update_rgmii_cfg(miig_rt: *mut regmap, emac: *mut prueth_emac) {
...
#[no_mangle]
pub unsafe extern "C" fn icssg_miig_set_interface_mode(miig_rt: *mut regmap, mii: c_int, phy_if: phy_interface_t) {
...
#[no_mangle]
pub unsafe extern "C" fn icssg_rgmii_cfg_get_bitfield(miig_rt: *mut regmap, mask: u32, shift: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn icssg_rgmii_get_speed(miig_rt: *mut regmap, mii: c_int) -> u32 {
    u32 icssg_rgmii_get_speed(struct regmap *miig_rt, int mii)
    {
    let mut shift: u32 = RGMII_CFG_SPEED_MII0_SHIFT, mask = RGMII_CFG_SPEED_MII0;
    if (mii == ICSS_MII1) {
...
#[no_mangle]
pub unsafe extern "C" fn icssg_rgmii_get_fullduplex(miig_rt: *mut regmap, mii: c_int) -> u32 {
    u32 icssg_rgmii_get_fullduplex(struct regmap *miig_rt, int mii)
    {
    let mut shift: u32 = RGMII_CFG_FULLDUPLEX_MII0_SHIFT;
    let mut mask: u32 = RGMII_CFG_FULLDUPLEX_MII0;
    if (mii == ICSS_MII1) {
