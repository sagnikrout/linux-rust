...
//! Source: drivers/net/ethernet/ti/davinci_mdio.c
#![no_std]
...
pub const PHY_ID_MASK: c_uint = 0x1f;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct davinci_mdio_of_param {
    pub autosuspend_delay_ms: c_int,
    pub manual_mode: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct davinci_mdio_regs {
    pub version: u32,
    pub control: u32,

pub const MDIO_PIN: c_int = 0;
    pub alive: u32,
    pub link: u32,
    pub linkintraw: u32,
    pub linkintmasked: u32,
    pub __reserved_0: [u32; 2],
    pub userintraw: u32,
    pub userintmasked: u32,
    pub userintmaskset: u32,
    pub userintmaskclr: u32,
    pub manualif: u32,
    pub poll: u32,
    pub __reserved_1: [u32; 18],
    struct {
    pub access: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct davinci_mdio_data {
    pub pdata: mdio_platform_data,
    pub bb_ctrl: mdiobb_ctrl,
    pub regs: *mut davinci_mdio_regs __iomem,
    pub clk: *mut clk,
    pub dev: *mut device,
    pub bus: *mut mii_bus,
    pub active_in_suspend: bool,
    pub /: *mut *mut unsigned long access_time; / jiffies,
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_init_clk(data: *mut davinci_mdio_data) {
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_enable(data: *mut davinci_mdio_data) {
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_disable(data: *mut davinci_mdio_data) {
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_enable_manual_mode(data: *mut davinci_mdio_data) {
...
#[no_mangle]
unsafe extern "C" fn davinci_set_mdc(ctrl: *mut mdiobb_ctrl, level: c_int) {
...
#[no_mangle]
unsafe extern "C" fn davinci_set_mdio_dir(ctrl: *mut mdiobb_ctrl, output: c_int) {
...
#[no_mangle]
unsafe extern "C" fn davinci_set_mdio_data(ctrl: *mut mdiobb_ctrl, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn davinci_get_mdio_data(ctrl: *mut mdiobb_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_mdiobb_read_c22(bus: *mut mii_bus, phy: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_common_reset(data: *mut davinci_mdio_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_reset(bus: *mut mii_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_mdiobb_reset(bus: *mut mii_bus) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wait_for_user_access(data: *mut davinci_mdio_data) -> c_int {
    static inline int wait_for_user_access(struct davinci_mdio_data *data)
    {
    struct davinci_mdio_regs __iomem *regs = data.regs;
    let mut timeout: c_ulong = jiffies + msecs_to_jiffies(MDIO_TIMEOUT);
    u32 reg;
...
#[no_mangle]
pub unsafe extern "C" fn wait_for_idle(data: *mut davinci_mdio_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_read(bus: *mut mii_bus, phy_id: c_int, phy_reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut autosuspend_delay_ms: c_int = -1;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_resume(dev: *mut device) -> c_int {
...
// Select default pin state
    ...
    davinci_mdio_runtime_resume, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn davinci_mdio_exit() -> void __exit {
