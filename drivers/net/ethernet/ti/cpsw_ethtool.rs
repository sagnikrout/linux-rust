...
//! Source: drivers/net/ethernet/ti/cpsw_ethtool.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpsw_hw_stats {
    pub rxgoodframes: u32,
    pub rxbroadcastframes: u32,
    pub rxmulticastframes: u32,
    pub rxpauseframes: u32,
    pub rxcrcerrors: u32,
    pub rxaligncodeerrors: u32,
    pub rxoversizedframes: u32,
    pub rxjabberframes: u32,
    pub rxundersizedframes: u32,
    pub rxfragments: u32,
    pub __pad_0: [u32; 2],
    pub rxoctets: u32,
    pub txgoodframes: u32,
    pub txbroadcastframes: u32,
    pub txmulticastframes: u32,
    pub txpauseframes: u32,
    pub txdeferredframes: u32,
    pub txcollisionframes: u32,
    pub txsinglecollframes: u32,
    pub txmultcollframes: u32,
    pub txexcessivecollisions: u32,
    pub txlatecollisions: u32,
    pub txunderrun: u32,
    pub txcarriersenseerrors: u32,
    pub txoctets: u32,
    pub octetframes64: u32,
    pub octetframes65t127: u32,
    pub octetframes128t255: u32,
    pub octetframes256t511: u32,
    pub octetframes512t1023: u32,
    pub octetframes1024tup: u32,
    pub netoctets: u32,
    pub rxsofoverruns: u32,
    pub rxmofoverruns: u32,
    pub rxdmaoverruns: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpsw_stats {
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_get_msglevel(ndev: *mut net_device) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_set_msglevel(ndev: *mut net_device, value: u32) {
    ...
    struct cpsw_priv *priv = netdev_priv(ndev);
    u32 int_ctrl;
    let mut num_interrupts: u32 = 0;
    let mut prescale: u32 = 0;
    let mut addnl_dvdr: u32 = 1;
    let mut coal_intvl: u32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_get_sset_count(ndev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpsw_add_ch_strings(p: *mut u8, ch_num: c_int, rx_dir: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_get_strings(ndev: *mut net_device, stringset: u32, data: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_get_wol(ndev: *mut net_device, wol: *mut ethtool_wolinfo) {
    void cpsw_get_wol(struct net_device *ndev, struct ethtool_wolinfo *wol)
    {
    struct cpsw_priv *priv = netdev_priv(ndev);
    struct cpsw_common *cpsw = priv.cpsw;
    let mut slave_no: c_int = cpsw_slave_index(cpsw, priv);
    wol.supported = 0;
    wol.wolopts = 0;
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_set_wol(ndev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_get_regs_len(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_get_regs(ndev: *mut net_device, regs: *mut ethtool_regs, p: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_ethtool_op_begin(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_ethtool_op_complete(ndev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_get_channels(ndev: *mut net_device, ch: *mut ethtool_channels) {
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_get_eee(ndev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_nway_reset(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpsw_suspend_data_pass(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn cpsw_resume_data_pass(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpsw_fail(cpsw: *mut cpsw_common) {
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_get_ts_info(ndev: *mut net_device, info: *mut kernel_ethtool_ts_info) -> c_int {
