...
//! Source: drivers/net/ethernet/ti/netcp_core.c
#![no_std]
...
pub const NETCP_MAX_MCAST_ADDR: c_int = 16;
pub const NETCP_EFUSE_REG_INDEX: c_int = 0;
pub const NETCP_MOD_PROBE_SKIPPED: c_int = 1;
pub const NETCP_MOD_PROBE_FAILED: c_int = 2;
    ...
    NETIF_MSG_RX_STATUS)
pub const NETCP_EFUSE_ADDR_SWAP: c_int = 2;

    KNAV_QUEUE_GET_ID, (unsigned long)core::ptr::null_mut())
    ...
    KNAV_QUEUE_GET_COUNT, (unsigned long)core::ptr::null_mut())
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct netcp_device {
    pub device_list: list_head,
    pub interface_head: list_head,
    pub modpriv_head: list_head,
    pub device: *mut device,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct netcp_inst_modpriv {
    pub netcp_device: *mut netcp_device,
    pub netcp_module: *mut netcp_module,
    pub inst_list: list_head,
    pub module_priv: *mut c_void,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct netcp_intf_modpriv {
    pub netcp_priv: *mut netcp_intf,
    pub netcp_module: *mut netcp_module,
    pub intf_list: list_head,
    pub module_priv: *mut c_void,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct netcp_tx_cb {
    pub ts_context: *mut c_void,
    pub skb): *mut *mut *mut void (txtstamp)(void context, struct sk_buff,
}

    static LIST_HEAD(netcp_devices);
    static LIST_HEAD(netcp_modules);
    static DEFINE_MUTEX(netcp_modules_lock);
    let mut netcp_debug_level: static int = -1;
...
#[no_mangle]
unsafe extern "C" fn get_sw_data(index: c_int, desc: *mut knav_dma_desc) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn get_words(words: *mut dma_addr_t, num_words: c_int, desc: *mut __le32) {
...
#[no_mangle]
unsafe extern "C" fn set_sw_data(index: c_int, data: u32, desc: *mut knav_dma_desc) {
...
#[no_mangle]
unsafe extern "C" fn set_words(words: *mut u32, num_words: c_int, desc: *mut __le32) {
...
#[no_mangle]
unsafe extern "C" fn emac_arch_get_mac_addr(x: *mut c_char, efuse_mac: *mut void __iomem, swap: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netcp_register_interface(netcp: *mut netcp_intf) -> c_int {
    ...
    let mut primary_module_registered: bool = false;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn netcp_register_module(module: *mut netcp_module) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn netcp_unregister_module(module: *mut netcp_module) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct netcp_hook_list {
    pub list: list_head,
    pub hook_rtn: *mut netcp_hook_rtn,
    pub hook_data: *mut c_void,
    pub order: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn netcp_frag_free(is_frag: bool, ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn netcp_empty_rx_queue(netcp: *mut netcp_intf) {
...
#[no_mangle]
unsafe extern "C" fn netcp_process_one_rx_packet(netcp: *mut netcp_intf) -> c_int {
    ...
    let mut pkt_sz: c_uint = 0, accum_sz;
...
//
    ...
    dev_err(netcp.ndev_dev, "core::ptr::null_mut() bufptr in desc\n");
    goto free_desc;
    }
...
#[no_mangle]
unsafe extern "C" fn netcp_free_rx_buf(netcp: *mut netcp_intf, fdq: c_int) {
...
//
    buf_ptr = (void *)GET_SW_DATA0(desc);
    if (unlikely(!dma)) {
    dev_err(netcp.ndev_dev, "core::ptr::null_mut() orig_buff in desc\n");
    knav_pool_desc_put(netcp.rx_pool, desc);
    continue;
    }
    if (unlikely(!buf_ptr)) {
...
#[no_mangle]
unsafe extern "C" fn netcp_rxpool_free(netcp: *mut netcp_intf) {
    ...
    netcp.rx_pool = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn netcp_allocate_rx_buf(netcp: *mut netcp_intf, fdq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netcp_rxpool_refill(netcp: *mut netcp_intf) {
...
// NAPI poll
#[no_mangle]
unsafe extern "C" fn netcp_rx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netcp_rx_notify(arg: *mut c_void) {
...
//
    ...
    let mut subqueue: u16 = skb_get_queue_mapping(skb);
...
#[no_mangle]
unsafe extern "C" fn netcp_tx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netcp_tx_notify(arg: *mut c_void) {
    ...
    let mut pkt_len: c_uint = skb_headlen(skb);
...
// Handle the case where skb is fragmented in pages
    ...
    let mut page_offset: u32 = skb_frag_off(frag);
    let mut buf_len: u32 = skb_frag_size(frag);
    dma_addr_t desc_dma;
    u32 desc_dma_32;
...
// frag list based linkage is not supported for now.
    ...
    struct knav_dma_desc *desc)
    {
    struct netcp_tx_pipe *tx_pipe = core::ptr::null_mut();
    ...
    p_info.netcp = netcp;
    p_info.skb = skb;
    p_info.tx_pipe = core::ptr::null_mut();
    p_info.psdata_len = 0;
    p_info.ts_context = core::ptr::null_mut();
    p_info.txtstamp = core::ptr::null_mut();
    p_info.epib = desc.epib;
    p_info.psdata = (u32  *)desc.psdata;
...
// psdata points to both native-endian and device-endian data
    __le32 *psdata = (void  *)p_info.psdata;
...
// Submit the packet
#[no_mangle]
unsafe extern "C" fn netcp_ndo_start_xmit(skb: *mut sk_buff, ndev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t netcp_ndo_start_xmit(struct sk_buff *skb, struct net_device *ndev)
    {
    struct netcp_intf *netcp = netdev_priv(ndev);
    struct netcp_stats *tx_stats = &netcp.stats;
    let mut subqueue: c_int = skb_get_queue_mapping(skb);
    struct knav_dma_desc *desc;
...
#[no_mangle]
pub unsafe extern "C" fn netcp_txpipe_close(tx_pipe: *mut netcp_tx_pipe) -> c_int {
    int netcp_txpipe_close(struct netcp_tx_pipe *tx_pipe)
    {
    if (tx_pipe.dma_channel) {
    knav_dma_close_channel(tx_pipe.dma_channel);
    tx_pipe.dma_channel = core::ptr::null_mut();
    }
    return 0;
    }
    EXPORT_SYMBOL_GPL(netcp_txpipe_close);
#[no_mangle]
pub unsafe extern "C" fn netcp_txpipe_open(tx_pipe: *mut netcp_tx_pipe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netcp_addr_del(netcp: *mut netcp_intf, naddr: *mut netcp_addr) {
...
#[no_mangle]
unsafe extern "C" fn netcp_addr_clear_mark(netcp: *mut netcp_intf) {
...
#[no_mangle]
unsafe extern "C" fn netcp_addr_sweep_del(netcp: *mut netcp_intf) {
...
#[no_mangle]
unsafe extern "C" fn netcp_addr_sweep_add(netcp: *mut netcp_intf) {
...
#[no_mangle]
unsafe extern "C" fn netcp_set_promiscuous(netcp: *mut netcp_intf, promisc: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netcp_set_rx_mode(ndev: *mut net_device) {
...
// next add new entries, mark existing ones
    ...
    if (promisc)
    netcp_addr_add_mark(netcp, core::ptr::null_mut(), ADDR_ANY);
...
// Open the device
#[no_mangle]
unsafe extern "C" fn netcp_ndo_open(ndev: *mut net_device) -> c_int {
...
// Close the device
#[no_mangle]
unsafe extern "C" fn netcp_ndo_stop(ndev: *mut net_device) -> c_int {
...
// Recycle Tx descriptors from completion queue
    ...
    struct netcp_intf_modpriv *intf_modpriv;
    struct netcp_module *module;
    let mut ret: c_int = -1, err = -EOPNOTSUPP;
    if (!netif_running(ndev))
    return -EINVAL;
    for_each_module(netcp, intf_modpriv) {
    module = intf_modpriv.netcp_module;
...
#[no_mangle]
unsafe extern "C" fn netcp_ndo_tx_timeout(ndev: *mut net_device, txqueue: c_uint) {
    static void netcp_ndo_tx_timeout(struct net_device *ndev, unsigned int txqueue)
    {
    struct netcp_intf *netcp = netdev_priv(ndev);
    let mut descs: c_uint = knav_pool_count(netcp.tx_pool);
...
#[no_mangle]
unsafe extern "C" fn netcp_rx_add_vid(ndev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netcp_rx_kill_vid(ndev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
// The following are stored as 32 bit
    ...
    struct resource res;
    void __iomem *efuse = core::ptr::null_mut();
    let mut efuse_mac: u32 = 0;
    u8 efuse_mac_addr[6];
    u32 temp[2];
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn netcp_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netcp_remove(pdev: *mut platform_device) {
