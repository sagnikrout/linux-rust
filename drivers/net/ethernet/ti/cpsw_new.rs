...
//! Source: drivers/net/ethernet/ti/cpsw_new.c
#![no_std]
...
//
    ...
    let mut ale_ageout: static int = CPSW_ALE_AGEOUT_DEFAULT;
    let mut rx_packet_max: static int = CPSW_MAX_PACKET_SIZE;
    let mut descs_pool_size: static int = CPSW_CPDMA_DESCS_POOL_SIZE_DEFAULT;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpsw_devlink {
...
#[no_mangle]
unsafe extern "C" fn cpsw_is_switch_en(cpsw: *mut cpsw_common) -> bool {
    static bool cpsw_is_switch_en(struct cpsw_common *cpsw)
    {
    return !cpsw.data.dual_emac;
    }
#[no_mangle]
unsafe extern "C" fn cpsw_set_promiscious(ndev: *mut net_device, enable: bool) {
    static void cpsw_set_promiscious(struct net_device *ndev, bool enable)
    {
    struct cpsw_common *cpsw = ndev_to_cpsw(ndev);
    let mut enable_uni: bool = false;
    int i;
...
#[no_mangle]
unsafe extern "C" fn cpsw_update_vlan_mc(vdev: *mut net_device, vid: c_int, ctx: *mut c_void) -> c_int {
    static int cpsw_update_vlan_mc(struct net_device *vdev, int vid, void *ctx)
    {
    struct addr_sync_ctx *sync_ctx = ctx;
    struct netdev_hw_addr *ha;
    let mut found: c_int = 0, ret = 0;
...
#[no_mangle]
unsafe extern "C" fn cpsw_add_mc_addr(ndev: *mut net_device, addr: *const u8, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpsw_del_mc_addr(ndev: *mut net_device, addr: *const u8, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpsw_purge_vlan_mc(vdev: *mut net_device, vid: c_int, ctx: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpsw_purge_all_mc(ndev: *mut net_device, addr: *const u8, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpsw_ndo_set_rx_mode_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn cpsw_ndo_set_rx_mode(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn cpsw_rxbuf_total_len(len: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn cpsw_rx_handler(token: *mut c_void, len: c_int, status: c_int) {
    static void cpsw_rx_handler(void *token, int len, int status)
    {
    struct page *new_page, *page = token;
    void *pa = page_address(page);
    let mut headroom: c_int = CPSW_HEADROOM_NA;
...
// mark skb for recycling
    ...
    {
    struct cpsw_common *cpsw = priv.cpsw;
    let mut unreg_mcast_mask: c_int = 0;
    int mcast_mask;
    u32 port_mask;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn cpsw_restore_vlans(vdev: *mut net_device, vid: c_int, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpsw_restore(priv: *mut cpsw_priv) {
...
#[no_mangle]
unsafe extern "C" fn cpsw_init_stp_ale_entry(cpsw: *mut cpsw_common) {
...
#[no_mangle]
unsafe extern "C" fn cpsw_init_host_port_switch(cpsw: *mut cpsw_common) {
    static void cpsw_init_host_port_switch(struct cpsw_common *cpsw)
    {
    let mut vlan: c_int = cpsw.data.default_vlan;
...
#[no_mangle]
unsafe extern "C" fn cpsw_init_host_port_dual_mac(cpsw: *mut cpsw_common) {
...
#[no_mangle]
unsafe extern "C" fn cpsw_init_host_port(priv: *mut cpsw_priv) {
...
// Enable internal fifo flow control
    ...
    {
    let mut port_mask: u32 = 1 << priv.emac_port | ALE_PORT_HOST;
    struct cpsw_common *cpsw = priv.cpsw;
    u32 reg;
...
#[no_mangle]
unsafe extern "C" fn cpsw_adjust_link(ndev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(phy_interface_is_rgmii(phy): (phy->speed == 10) &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn cpsw_slave_open(slave: *mut cpsw_slave, priv: *mut cpsw_priv) {
...
#[no_mangle]
unsafe extern "C" fn cpsw_ndo_stop(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpsw_ndo_open(ndev: *mut net_device) -> c_int {
...
// Enable Interrupt pacing if configured
    ...
    cpsw_set_coalesce(ndev, &coal, core::ptr::null_mut(), core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn cpsw_ndo_set_mac_address(ndev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpsw_ndo_poll_controller(ndev: *mut net_device) {
    ...
    break;
    if (cpsw_xdp_tx_frame(priv, xdpf, core::ptr::null_mut(), priv.emac_port))
    break;
    nxmit++;
    }
    return nxmit;
...
#[no_mangle]
unsafe extern "C" fn cpsw_probe_dt(cpsw: *mut cpsw_common) -> c_int {
...
// We do not want to force this, as in some cases may not have child
    ...
    slave_data.ifphy = devm_of_phy_get(dev, port_np, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cpsw_remove_dt(cpsw: *mut cpsw_common) {
...
#[no_mangle]
unsafe extern "C" fn cpsw_create_ports(cpsw: *mut cpsw_common) -> c_int {
    static int cpsw_create_ports(struct cpsw_common *cpsw)
    {
    struct cpsw_platform_data *data = &cpsw.data;
    struct net_device *ndev, *napi_ndev = core::ptr::null_mut();
    struct device *dev = cpsw.dev;
    struct cpsw_priv *priv;
...
#[no_mangle]
unsafe extern "C" fn cpsw_unregister_ports(cpsw: *mut cpsw_common) {
...
#[no_mangle]
unsafe extern "C" fn cpsw_register_ports(cpsw: *mut cpsw_common) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cpsw_port_dev_check(ndev: *const net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cpsw_port_offload_fwd_mark_update(cpsw: *mut cpsw_common) {
    static void cpsw_port_offload_fwd_mark_update(struct cpsw_common *cpsw)
    {
    let mut set_val: c_int = 0;
    int i;
    if (!cpsw.ale_bypass &&
...
//
    ...
    err = switchdev_bridge_port_offload(ndev, ndev, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    false, extack);
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn cpsw_netdevice_port_unlink(ndev: *mut net_device) {
    static void cpsw_netdevice_port_unlink(struct net_device *ndev)
    {
    struct cpsw_priv *priv = netdev_priv(ndev);
    struct cpsw_common *cpsw = priv.cpsw;
    switchdev_bridge_port_unoffload(ndev, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    cpsw.br_members &= ~BIT(priv.emac_port);
    cpsw_port_offload_fwd_mark_update(cpsw);
    if (!cpsw.br_members)
    cpsw.hw_bridge_dev = core::ptr::null_mut();
    }
// netdev notifier
...
#[no_mangle]
unsafe extern "C" fn cpsw_register_notifiers(cpsw: *mut cpsw_common) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpsw_unregister_notifiers(cpsw: *mut cpsw_common) {
    ...
    struct cpsw_common *cpsw = dl_priv.cpsw;
    let mut vlan: c_int = cpsw.data.default_vlan;
    let mut switch_en: bool = ctx.val.vbool;
    let mut if_running: bool = false;
    int i;
    dev_dbg(cpsw.dev, "%s id:%u\n", __func__, id);
    if (id != CPSW_DL_PARAM_SWITCH_MODE)
    return  -EOPNOTSUPP;
...
// enable bypass - no forwarding; all traffic goes to Host
    ...
    BIT(DEVLINK_PARAM_CMODE_RUNTIME),
    cpsw_dl_ale_ctrl_get, cpsw_dl_ale_ctrl_set, core::ptr::null_mut()),
    };
#[no_mangle]
unsafe extern "C" fn cpsw_register_devlink(cpsw: *mut cpsw_common) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpsw_unregister_devlink(cpsw: *mut cpsw_common) {
...
#[no_mangle]
unsafe extern "C" fn cpsw_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    (u32 )ss_res.start + CPSW2_BD_OFFSET,
    descs_pool_size);
    if (ret)
    goto clean_dt_ret;
...
#[no_mangle]
unsafe extern "C" fn cpsw_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn cpsw_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn cpsw_resume(dev: *mut device) -> int __maybe_unused {
