...
//! Source: drivers/net/ethernet/ti/am65-cpsw-ethtool.c
#![no_std]
...
pub const AM65_CPSW_REGDUMP_VER: c_uint = 0x1;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct am65_cpsw_regdump_hdr {
    pub module_id: u32,
    pub len: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct am65_cpsw_regdump_item {
    pub hdr: am65_cpsw_regdump_hdr,
    pub start_ofs: u32,
    pub end_ofs: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct am65_cpsw_stats_regs {
    ...
    pub /: *mut *mut u32 ale_block_drop; / K3,
    pub /: *mut *mut u32 ale_secure_drop; / K3,
    pub /: *mut *mut u32 ale_auth_drop; / K3,
    ...
    pub ale_pol_match_red: u32,
    pub ale_pol_match_yellow: u32,
    pub /: *mut *mut u32 ale_mcast_sa_drop; / K3,
    pub /: *mut *mut u32 ale_dual_vlan_drop; / K3,
    pub /: *mut *mut u32 ale_len_err_drop; / K3,
    pub /: *mut *mut u32 ale_ip_next_hdr_drop; / K3,
    pub /: *mut *mut u32 ale_ipv4_frag_drop; / K3,
    pub __rsvd_1: [u32; 24],
    pub /: *mut *mut u32 iet_rx_assembly_err; / K3 slave,
    pub /: *mut *mut u32 iet_rx_assembly_ok; / K3 slave,
    pub /: *mut *mut u32 iet_rx_smd_err; / K3 slave,
    pub /: *mut *mut u32 iet_rx_frag; / K3 slave,
    pub /: *mut *mut u32 iet_tx_hold; / K3 slave,
    pub /: *mut *mut u32 iet_tx_frag; / K3 slave,
    pub __rsvd_2: [u32; 9],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct am65_cpsw_ethtool_stat {
...
#[no_mangle]
unsafe extern "C" fn am65_cpsw_ethtool_op_begin(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn am65_cpsw_ethtool_op_complete(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn am65_cpsw_get_msglevel(ndev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn am65_cpsw_set_msglevel(ndev: *mut net_device, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn am65_cpsw_get_eee(ndev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn am65_cpsw_set_eee(ndev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn am65_cpsw_nway_reset(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn am65_cpsw_get_regs_len(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn am65_cpsw_get_sset_count(ndev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn am65_cpsw_get_ethtool_priv_flags(ndev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn am65_cpsw_set_ethtool_priv_flags(ndev: *mut net_device, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn am65_cpsw_port_iet_rx_enable(port: *mut am65_cpsw_port, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn am65_cpsw_port_iet_tx_enable(port: *mut am65_cpsw_port, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn am65_cpsw_get_mm(ndev: *mut net_device, state: *mut ethtool_mm_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(AM65_CPSW_PN_MAC_VERIFIED: iet_status &) -> else {
    else if (iet_status & AM65_CPSW_PN_MAC_VERIFIED)
    state.verify_status = ETHTOOL_MM_VERIFY_STATUS_SUCCEEDED;
#[no_mangle]
pub unsafe extern "C" fn if(AM65_CPSW_PN_MAC_VERIFY_FAIL: iet_status &) -> else {
