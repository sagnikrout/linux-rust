...
//! Source: drivers/net/ethernet/huawei/hinic/hinic_main.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
    let mut tx_weight: static unsigned int = 64;
    module_param(tx_weight, uint, 0644);
    MODULE_PARM_DESC(tx_weight, "Number Tx packets for NAPI budget (default=64)");
    let mut rx_weight: static unsigned int = 64;
    module_param(rx_weight, uint, 0644);
    MODULE_PARM_DESC(rx_weight, "Number Rx packets for NAPI budget (default=64)");
pub const HINIC_DEV_ID_QUAD_PORT_25GE: c_uint = 0x1822;
pub const HINIC_DEV_ID_DUAL_PORT_100GE: c_uint = 0x0200;
pub const HINIC_DEV_ID_DUAL_PORT_100GE_MEZZ: c_uint = 0x0205;
pub const HINIC_DEV_ID_QUAD_PORT_25GE_MEZZ: c_uint = 0x0210;
pub const HINIC_DEV_ID_VF: c_uint = 0x375e;

    NETIF_MSG_IFUP |                  \
    NETIF_MSG_TX_ERR | NETIF_MSG_RX_ERR)
pub const HINIC_LRO_MAX_WQE_NUM_DEFAULT: c_int = 8;
pub const HINIC_LRO_RX_TIMER_DEFAULT: c_int = 16;

    container_of(work, struct hinic_rx_mode_work, work)

    container_of(rx_mode_work, struct hinic_dev, rx_mode_work)
pub const HINIC_WAIT_SRIOV_CFG_TIMEOUT: c_int = 15000;
pub const HINIC_DEAULT_TXRX_MSIX_PENDING_LIMIT: c_int = 2;
pub const HINIC_DEAULT_TXRX_MSIX_COALESC_TIMER_CFG: c_int = 32;
pub const HINIC_DEAULT_TXRX_MSIX_RESEND_TIMER_CFG: c_int = 7;
    static int change_mac_addr(struct net_device *netdev, const u8 *addr);
    static int set_features(struct hinic_dev *nic_dev,
    netdev_features_t pre_features,
    netdev_features_t features, bool force_change);
#[no_mangle]
unsafe extern "C" fn gather_rx_stats(nic_rx_stats: *mut hinic_rxq_stats, rxq: *mut hinic_rxq) {
...
#[no_mangle]
unsafe extern "C" fn gather_tx_stats(nic_tx_stats: *mut hinic_txq_stats, txq: *mut hinic_txq) {
...
//
#[no_mangle]
unsafe extern "C" fn create_txqs(nic_dev: *mut hinic_dev) -> c_int {
    ...
    nic_dev.txqs = core::ptr::null_mut();
    return err;
    }
#[no_mangle]
unsafe extern "C" fn enable_txqs_napi(nic_dev: *mut hinic_dev) {
    static void enable_txqs_napi(struct hinic_dev *nic_dev)
    {
    let mut num_txqs: c_int = hinic_hwdev_num_qps(nic_dev.hwdev);
    int i;
    for (i = 0; i < num_txqs; i++)
    napi_enable(&nic_dev.txqs[i].napi);
    }
#[no_mangle]
unsafe extern "C" fn disable_txqs_napi(nic_dev: *mut hinic_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn free_txqs(nic_dev: *mut hinic_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn create_rxqs(nic_dev: *mut hinic_dev) -> c_int {
    ...
    nic_dev.rxqs = core::ptr::null_mut();
    return err;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn free_rxqs(nic_dev: *mut hinic_dev) {
...
#[no_mangle]
unsafe extern "C" fn hinic_configure_max_qnum(nic_dev: *mut hinic_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic_rss_init(nic_dev: *mut hinic_dev) -> c_int {
    static int hinic_rss_init(struct hinic_dev *nic_dev)
    {
    u8 default_rss_key[HINIC_RSS_KEY_SIZE];
    let mut tmpl_idx: u8 = nic_dev.rss_tmpl_idx;
    u32 *indir_tbl;
    int err, i;
...
#[no_mangle]
unsafe extern "C" fn hinic_rss_deinit(nic_dev: *mut hinic_dev) {
    static void hinic_rss_deinit(struct hinic_dev *nic_dev)
    {
    hinic_rss_cfg(nic_dev, 0, nic_dev.rss_tmpl_idx);
    }
#[no_mangle]
unsafe extern "C" fn hinic_init_rss_parameters(nic_dev: *mut hinic_dev) {
...
#[no_mangle]
unsafe extern "C" fn hinic_enable_rss(nic_dev: *mut hinic_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn hinic_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hinic_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn change_mac_addr(netdev: *mut net_device, addr: *const u8) -> c_int {
    static int change_mac_addr(struct net_device *netdev, const u8 *addr)
    {
    struct hinic_dev *nic_dev = netdev_priv(netdev);
    let mut vid: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn hinic_set_mac_addr(netdev: *mut net_device, addr: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn add_mac_addr(netdev: *mut net_device, addr: *const u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn remove_mac_addr(netdev: *mut net_device, addr: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_rx_mode(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn hinic_set_rx_mode(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn hinic_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
    ...
    {
    struct hinic_dev *nic_dev = netdev_priv(netdev);
    let mut nic_rx_stats: hinic_rxq_stats = {};
    let mut nic_tx_stats: hinic_txq_stats = {};
    if (nic_dev.flags & HINIC_INTF_UP)
...
#[no_mangle]
unsafe extern "C" fn netdev_features_init(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn hinic_refresh_nic_cfg(nic_dev: *mut hinic_dev) {
    static void hinic_refresh_nic_cfg(struct hinic_dev *nic_dev)
    {
    struct hinic_nic_cfg *nic_cfg = &nic_dev.hwdev.func_to_io.nic_cfg;
    let mut pause_info: hinic_pause_config = {0};
    let mut port_cap: hinic_port_cap = {0};
...
// out_size = sizeof(*link_err);
    ...
    netdev_features_t features, bool force_change)
    {
    let mut changed: netdev_features_t = force_change ? ~0 : pre_features ^ features;
    let mut csum_en: u32 = HINIC_RX_CSUM_OFFLOAD_EN;
    let mut failed_features: netdev_features_t = 0;
    let mut ret: c_int = 0;
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn hinic_init_intr_coalesce(nic_dev: *mut hinic_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic_free_intr_coalesce(nic_dev: *mut hinic_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn nic_dev_init(pdev: *mut pci_dev) -> c_int {
...
// enable pause and disable pfc by default
    ...
    {
    let mut err: c_int = pci_enable_device(pdev);
    if (err)
...
#[no_mangle]
unsafe extern "C" fn wait_sriov_cfg_complete(nic_dev: *mut hinic_dev) {
...
#[no_mangle]
unsafe extern "C" fn hinic_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn hinic_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn hinic_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hinic_module_exit() -> void __exit {
