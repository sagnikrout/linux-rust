...
//! Source: drivers/net/ethernet/huawei/hinic3/hinic3_main.c
#![no_std]
...
pub const HINIC3_RX_BUF_LEN: c_int = 2048;
pub const HINIC3_LRO_REPLENISH_THLD: c_int = 256;

pub const HINIC3_SQ_DEPTH: c_int = 1024;
pub const HINIC3_RQ_DEPTH: c_int = 1024;
pub const HINIC3_DEFAULT_TXRX_MSIX_PENDING_LIMIT: c_int = 2;
pub const HINIC3_DEFAULT_TXRX_MSIX_COALESC_TIMER_CFG: c_int = 25;
pub const HINIC3_DEFAULT_TXRX_MSIX_RESEND_TIMER_CFG: c_int = 7;
pub const HINIC3_RX_PENDING_LIMIT_LOW: c_int = 2;
pub const HINIC3_RX_PENDING_LIMIT_HIGH: c_int = 8;
#[no_mangle]
unsafe extern "C" fn init_intr_coal_param(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn hinic3_init_intr_coalesce(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic3_free_intr_coalesce(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn hinic3_alloc_txrxqs(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic3_free_txrxqs(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn hinic3_periodic_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn hinic3_sw_init(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic3_sw_uninit(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn hinic3_assign_netdev_ops(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn netdev_feature_init(netdev: *mut net_device) {
    static void netdev_feature_init(struct net_device *netdev)
    {
    struct hinic3_nic_dev *nic_dev = netdev_priv(netdev);
    let mut hw_features: netdev_features_t = 0;
    let mut vlan_fts: netdev_features_t = 0;
    let mut cso_fts: netdev_features_t = 0;
    let mut tso_fts: netdev_features_t = 0;
...
#[no_mangle]
unsafe extern "C" fn hinic3_set_default_hw_feature(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic3_free_nic_dev(nic_dev: *mut hinic3_nic_dev) {
...
#[no_mangle]
unsafe extern "C" fn hinic3_nic_remove(adev: *mut auxiliary_device) {
...
#[no_mangle]
unsafe extern "C" fn hinic3_nic_lld_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn hinic3_nic_lld_exit() -> __exit void {
