...
//! Source: drivers/net/ethernet/huawei/hinic3/hinic3_ethtool.c
#![no_std]
...
pub const HINIC3_MGMT_VERSION_MAX_LEN: c_int = 32;
...
#[no_mangle]
unsafe extern "C" fn hinic3_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hinic3_set_msglevel(netdev: *mut net_device, data: u32) {
...
pub struct hw2ethtool_link_mode {
    pub link_mode_bit_arr: *const u32,
    pub arr_size: u32,
    pub speed: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hinic3_link_settings {
    pub speed: u32,
    pub duplex: u8,
    pub port: u8,
    pub autoneg: u8,
...
#[no_mangle]
unsafe extern "C" fn hinic3_add_speed_link_mode(bitmap: *mut c_ulong, mode: u32) {
...
// Related to enum mag_cmd_port_speed
    ...
    {
    struct hinic3_nic_dev *nic_dev = netdev_priv(netdev);
    let mut nic_pause: hinic3_nic_pause_config = {};
    int err;
    ...
    {
    struct hinic3_nic_dev *nic_dev = netdev_priv(netdev);
    let mut port_info: hinic3_nic_port_info = {};
    int err;
    ...
    let mut settings: hinic3_link_settings = {};
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn hinic3_set_ethtool_ops(netdev: *mut net_device) {
