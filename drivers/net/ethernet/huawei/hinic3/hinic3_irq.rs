...
//! Source: drivers/net/ethernet/huawei/hinic3/hinic3_irq.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hinic3_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qp_add_napi(irq_cfg: *mut hinic3_irq_cfg) {
...
#[no_mangle]
unsafe extern "C" fn qp_del_napi(irq_cfg: *mut hinic3_irq_cfg) {
...
#[no_mangle]
unsafe extern "C" fn qp_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn hinic3_request_irq(irq_cfg: *mut hinic3_irq_cfg, q_id: u16) -> c_int {
    static int hinic3_request_irq(struct hinic3_irq_cfg *irq_cfg, u16 q_id)
    {
    let mut info: hinic3_interrupt_info = {};
    struct hinic3_nic_dev *nic_dev;
...
#[no_mangle]
unsafe extern "C" fn hinic3_release_irq(irq_cfg: *mut hinic3_irq_cfg) {
    static void hinic3_release_irq(struct hinic3_irq_cfg *irq_cfg)
    {
    irq_set_affinity_hint(irq_cfg.irq_id, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn hinic3_rx_dim_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn hinic3_qps_irq_init(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hinic3_qps_irq_uninit(netdev: *mut net_device) {
