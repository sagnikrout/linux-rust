...
//! Source: drivers/net/ethernet/huawei/hinic3/hinic3_netdev_ops.c
#![no_std]
...
pub const HINIC3_LRO_DEFAULT_COAL_PKT_SIZE: c_int = 32;
pub const HINIC3_LRO_DEFAULT_TIME_LIMIT: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn hinic3_setup_num_qps(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic3_destroy_num_qps(netdev: *mut net_device) {
    ...
    q_params.irq_cfg = core::ptr::null_mut();
    err_free_rxqs_res_arr:
    kfree(q_params.rxqs_res);
    q_params.rxqs_res = core::ptr::null_mut();
    err_free_txqs_res_arr:
    kfree(q_params.txqs_res);
    q_params.txqs_res = core::ptr::null_mut();
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn hinic3_configure(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic3_remove_configure(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn hinic3_open_channel(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic3_close_channel(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn hinic3_maybe_set_port_state(netdev: *mut net_device, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic3_vport_up(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic3_vport_down(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn hinic3_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic3_close(netdev: *mut net_device) -> c_int {
    ...
    {
    let mut changed: netdev_features_t = wanted_features ^ features;
    struct hinic3_nic_dev *nic_dev = netdev_priv(netdev);
    ...
    struct hinic3_nic_dev *nic_dev = netdev_priv(netdev);
    struct hinic3_hwdev *hwdev = nic_dev.hwdev;
    let mut en: bool = !!(wanted_features & NETIF_F_LRO);
    int err;
...
// failed_features |= NETIF_F_LRO;
    ...
    netdev_features_t *failed_features)
    {
    let mut en: bool = !!(wanted_features & NETIF_F_HW_VLAN_CTAG_RX);
    let mut changed: netdev_features_t = wanted_features ^ features;
    struct hinic3_nic_dev *nic_dev = netdev_priv(netdev);
    struct hinic3_hwdev *hwdev = nic_dev.hwdev;
    int err;
...
// failed_features |= NETIF_F_HW_VLAN_CTAG_RX;
    ...
    netdev_features_t *failed_features)
    {
    let mut en: bool = !!(wanted_features & NETIF_F_HW_VLAN_CTAG_FILTER);
    let mut changed: netdev_features_t = wanted_features ^ features;
    struct hinic3_nic_dev *nic_dev = netdev_priv(netdev);
    struct hinic3_hwdev *hwdev = nic_dev.hwdev;
    int err;
...
// failed_features |= NETIF_F_HW_VLAN_CTAG_FILTER;
    ...
    {
    let mut failed: netdev_features_t = 0;
    int err;
    ...
    netdev_features_t features)
    {
    let mut features_tmp: netdev_features_t = features;
...
#[no_mangle]
pub unsafe extern "C" fn hinic3_set_hw_features(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic3_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic3_set_mac_addr(netdev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hinic3_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn hinic3_nic_set_rx_mode(netdev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn hinic3_set_netdev_ops(netdev: *mut net_device) {
