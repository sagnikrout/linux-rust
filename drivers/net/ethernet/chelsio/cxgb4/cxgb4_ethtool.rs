...
//! Source: drivers/net/ethernet/chelsio/cxgb4/cxgb4_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_strings(dev: *mut net_device, stringset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn collect_adapter_stats(adap: *mut adapter, s: *mut adapter_stats) {
...
//
#[no_mangle]
unsafe extern "C" fn speed_to_fw_caps(speed: c_int) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn lmm_to_fw_caps(link_mode_mask: *const c_ulong) -> c_uint {
    static unsigned int lmm_to_fw_caps(const unsigned long *link_mode_mask)
    {
    let mut fw_caps: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn eth_to_cc_fec(eth_fec: c_uint) -> c_uint {
    static inline unsigned int eth_to_cc_fec(unsigned int eth_fec)
    {
    let mut cc_fec: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn get_fecparam(dev: *mut net_device, fec: *mut ethtool_fecparam) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_fecparam(dev: *mut net_device, fec: *mut ethtool_fecparam) -> c_int {
...
// lc = old_lc;
    ...
    lc.requested_fc = 0;
#[no_mangle]
pub unsafe extern "C" fn if(FW_PORT_CAP32_ANEG: lc->pcaps &) -> else {
...
#[no_mangle]
unsafe extern "C" fn set_adaptive_rx_setting(dev: *mut net_device, adaptive_rx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_adaptive_rx_setting(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_dbqtimer_tick(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_dbqtimer(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn set_dbqtimer_tick(dev: *mut net_device, usecs: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn set_dbqtimer(dev: *mut net_device, usecs: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn eeprom_rd_phys(adap: *mut adapter, phys_addr: c_uint, v: *mut u32) -> c_int {
    static int eeprom_rd_phys(struct adapter *adap, unsigned int phys_addr, u32 *v)
    {
    let mut vaddr: c_int = t4_eeprom_ptov(phys_addr, adap.pf, EEPROMPFSIZE);
    if (vaddr >= 0)
    vaddr = pci_read_vpd(adap.pdev, vaddr, sizeof(u32), v);
    return vaddr < 0 ? vaddr : 0;
    }
#[no_mangle]
unsafe extern "C" fn eeprom_wr_phys(adap: *mut adapter, phys_addr: c_uint, v: u32) -> c_int {
...
pub const EEPROM_MAGIC: c_uint = 0x38E2F10C;
    ...
    if (adapter.pf > 0) {
    let mut start: u32 = 1024 + adapter.pf * EEPROMPFSIZE;
...
pub const CXGB4_PHY_SIG: c_uint = 0x130000ea;
#[no_mangle]
unsafe extern "C" fn cxgb4_validate_phy_image(data: *const u8, size: *mut u32) -> c_int {
    ...
    struct adapter *adap = netdev2adap(netdev);
    int ret;
    ret = cxgb4_validate_phy_image(data, core::ptr::null_mut());
    if (ret) {
...
//
    ...
    ret = t4_load_phy_fw(adap, MEMWIN_NIC, core::ptr::null_mut(), data, size);
    if (ret < 0) {
    ...
    {
    struct adapter *adap = netdev2adap(netdev);
    let mut mbox: c_uint = PCIE_FW_MASTER_M + 1;
    int ret;
...
pub const CXGB4_FW_SIG: c_uint = 0x4368656c;
pub const CXGB4_FW_SIG_OFFSET: c_uint = 0x160;
#[no_mangle]
unsafe extern "C" fn cxgb4_validate_fw_image(data: *const u8, size: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxgb4_validate_bootcfg_image(data: *const u8, size: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxgb4_validate_boot_image(data: *const u8, size: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxgb4_ethtool_get_flash_region(data: *const u8, size: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_flash(netdev: *mut net_device, ef: *mut ethtool_flash) -> c_int {
    static int set_flash(struct net_device *netdev, struct ethtool_flash *ef)
    {
    struct adapter *adap = netdev2adap(netdev);
    const struct firmware *fw;
    unsigned int master;
    let mut master_vld: u8 = 0;
    const u8 *fw_data;
    size_t fw_size;
    let mut size: u32 = 0;
    u32 pcie_fw;
...
#[no_mangle]
unsafe extern "C" fn get_ts_info(dev: *mut net_device, ts_info: *mut kernel_ethtool_ts_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_rss_table_size(dev: *mut net_device) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(FW_RSS_VI_CONFIG_CMD_IP4TWOTUPEN_F: v &) -> else {
...
pub unsafe extern "C" fn if(FW_RSS_VI_CONFIG_CMD_IP4TWOTUPEN_F: v &) -> else {
    ...
    RXH_L4_B_0_1 | RXH_L4_B_2_3;
#[no_mangle]
pub unsafe extern "C" fn if(FW_RSS_VI_CONFIG_CMD_IP6TWOTUPEN_F: v &) -> else {
...
#[no_mangle]
unsafe extern "C" fn get_rx_ring_count(dev: *mut net_device) -> u32 {
    ...
    const struct port_info *pi = netdev_priv(dev);
    struct adapter *adap = netdev2adap(dev);
    let mut count: c_uint = 0, index = 0;
    let mut ret: c_int = 0;
    switch (info.cmd) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !f->fs.hash) -> else {
    else if (!f.fs.hash)
...
// Add Ethtool n-tuple filters.
    ...
    struct ethtool_rxnfc *cmd)
    {
    let mut input: ethtool_rx_flow_spec_input = {};
    struct cxgb4_ethtool_filter_info *filter_info;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !fs.hash) -> else {
    else if (!fs.hash)
...
#[no_mangle]
unsafe extern "C" fn set_rxnfc(dev: *mut net_device, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_dump(dev: *mut net_device, eth_dump: *mut ethtool_dump) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_dump_flag(dev: *mut net_device, eth_dump: *mut ethtool_dump) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxgb4_fw_mod_type_info_available(fw_mod_type: c_uint) -> bool {
...
//
    ...
    {
    let mut ret: c_int = 0, offset = eprom.offset, len = eprom.len;
    struct port_info *pi = netdev_priv(dev);
    struct adapter *adapter = pi.adapter;
...
#[no_mangle]
unsafe extern "C" fn cxgb4_get_priv_flags(netdev: *mut net_device) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn set_flags(cur_flags: *mut u32, new_flags: u32, flags: u32) {
    static inline void set_flags(u32 *cur_flags, u32 new_flags, u32 flags)
    {
// cur_flags = (*cur_flags & ~flags) | (new_flags & flags);
    }
#[no_mangle]
unsafe extern "C" fn cxgb4_set_priv_flags(netdev: *mut net_device, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxgb4_lb_test(netdev: *mut net_device, lb_status: *mut u64) {
    static void cxgb4_lb_test(struct net_device *netdev, u64 *lb_status)
    {
    let mut dev_state: c_int = netif_running(netdev);
    if (dev_state) {
...
#[no_mangle]
pub unsafe extern "C" fn cxgb4_cleanup_ethtool_filters(adap: *mut adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn cxgb4_init_ethtool_filters(adap: *mut adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxgb4_set_ethtool_ops(netdev: *mut net_device) {
