...
//! Source: drivers/net/ethernet/chelsio/cxgb/pm3393.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pmread(cmac: *mut cmac, reg: u32, data32: *mut *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmwrite(cmac: *mut cmac, reg: u32, data32: u32) -> c_int {
...
// Port reset.
#[no_mangle]
unsafe extern "C" fn pm3393_reset(cmac: *mut cmac) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pm3393_interrupt_enable(cmac: *mut cmac) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm3393_interrupt_disable(cmac: *mut cmac) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm3393_interrupt_clear(cmac: *mut cmac) -> c_int {
...
// Interrupt handler
#[no_mangle]
unsafe extern "C" fn pm3393_interrupt_handler(cmac: *mut cmac) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm3393_enable(cmac: *mut cmac, which: c_int) -> c_int {
    ...
    let mut val: u32 = TXXG_CONF1_VAL | SUNI1x10GEXP_BITMSK_TXXG_TXEN0;
...
#[no_mangle]
unsafe extern "C" fn pm3393_enable_port(cmac: *mut cmac, which: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm3393_disable(cmac: *mut cmac, which: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm3393_loopback_enable(cmac: *mut cmac) -> c_int {
    static int pm3393_loopback_enable(struct cmac *cmac)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn pm3393_loopback_disable(cmac: *mut cmac) -> c_int {
    static int pm3393_loopback_disable(struct cmac *cmac)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn pm3393_set_mtu(cmac: *mut cmac, mtu: c_int) -> c_int {
    static int pm3393_set_mtu(struct cmac *cmac, int mtu)
    {
    let mut enabled: c_int = cmac.instance.enabled;
...
#[no_mangle]
unsafe extern "C" fn pm3393_set_rx_mode(cmac: *mut cmac, rm: *mut t1_rx_mode) -> c_int {
    static int pm3393_set_rx_mode(struct cmac *cmac, struct t1_rx_mode *rm)
    {
    let mut enabled: c_int = cmac.instance.enabled & MAC_DIRECTION_RX;
    u32 rx_mode;
...
#[no_mangle]
unsafe extern "C" fn pm3393_macaddress_get(cmac: *mut cmac, mac_addr[6]: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm3393_macaddress_set(cmac: *mut cmac, ma[6]: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm3393_destroy(cmac: *mut cmac) {
...
#[no_mangle]
unsafe extern "C" fn pm3393_mac_reset(adapter: *mut *mut adapter_t) -> c_int {
