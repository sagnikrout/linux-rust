...
//! Source: drivers/net/ethernet/chelsio/cxgb/vsc7326.c
#![no_std]
...
pub const STATS_TICK_SECS: c_int = 15;
...
//
pub const WM_DISABLE: c_uint = 0x01a01fff;
pub const WM_ENABLE: c_uint = 0x014a03F0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct init_table {
    pub addr: u32,
    pub data: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct _cmac_instance {
    pub index: u32,
    pub ticks: u32,
}

pub const INITBLOCK_SLEEP: c_uint = 0xffffffff;
#[no_mangle]
unsafe extern "C" fn vsc_read(adapter: *mut adapter_t, addr: u32, val: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn vsc_write(adapter: *mut adapter_t, addr: u32, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn vsc7326_full_reset(adapter: *mut *mut adapter_t) {
...
#[no_mangle]
unsafe extern "C" fn run_table(adapter: *mut adapter_t, ib: *mut init_table, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bist_rd(adapter: *mut adapter_t, moduleid: c_int, address: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x0: (result & (1 << 8)) !=) -> else {
    else if ((result & (1 << 8)) != 0x0)
    pr_err("bist read error: 0x%x\n", result);
    return result & 0xff;
    }
#[no_mangle]
unsafe extern "C" fn bist_wr(adapter: *mut adapter_t, moduleid: c_int, address: c_int, value: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x0: (result & (1 << 26)) !=) -> else {
    else if ((result & (1 << 26)) != 0x0)
    pr_err("bist write error: 0x%x\n", result);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn run_bist(adapter: *mut adapter_t, moduleid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_bist(adapter: *mut adapter_t, moduleid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enable_mem(adapter: *mut adapter_t, moduleid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn run_bist_all(adapter: *mut adapter_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac_intr_handler(mac: *mut cmac) -> c_int {
    static int mac_intr_handler(struct cmac *mac)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mac_intr_enable(mac: *mut cmac) -> c_int {
    static int mac_intr_enable(struct cmac *mac)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mac_intr_disable(mac: *mut cmac) -> c_int {
    static int mac_intr_disable(struct cmac *mac)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mac_intr_clear(mac: *mut cmac) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac_set_address(mac: *mut *mut cmac, addr[6]: u8) -> c_int {
    static int mac_set_address(struct cmac* mac, const u8 addr[6])
    {
    u32 val;
    let mut port: c_int = mac.instance.index;
...
#[no_mangle]
unsafe extern "C" fn mac_get_address(mac: *mut cmac, addr[6]: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac_reset(mac: *mut cmac) -> c_int {
    static int mac_reset(struct cmac *mac)
    {
    let mut index: c_int = mac.instance.index;
    run_table(mac.adapter, vsc7326_portinit[index],
    ARRAY_SIZE(vsc7326_portinit[index]));
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mac_set_rx_mode(mac: *mut cmac, rm: *mut t1_rx_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac_set_mtu(mac: *mut cmac, mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac_enable(mac: *mut cmac, which: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac_disable(mac: *mut cmac, which: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmon_update(mac: *mut cmac, addr: c_uint, stat: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn port_stats_update(mac: *mut cmac) {
...
// Tx stats (skip collision stats as we are full-duplex only)
    ...
    let mut port: c_uint = mac.instance.index;
...
#[no_mangle]
unsafe extern "C" fn mac_destroy(mac: *mut cmac) {
...
#[no_mangle]
unsafe extern "C" fn vsc7326_mac_reset(adapter: *mut adapter_t) -> c_int {
