...
//! Source: drivers/net/ethernet/chelsio/cxgb/mv88x201x.c
#![no_std]
...
//
pub const MV88x2010_LINK_STATUS_BUGS: c_int = 1;
#[no_mangle]
unsafe extern "C" fn led_init(cphy: *mut cphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn led_link(cphy: *mut cphy, do_enable: u32) -> c_int {
    static int led_link(struct cphy *cphy, u32 do_enable)
    {
    let mut led: u32 = 0;
pub const LINK_ENABLE_BIT: c_uint = 0x1;
...
// Port Reset
#[no_mangle]
unsafe extern "C" fn mv88x201x_reset(cphy: *mut cphy, wait: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88x201x_interrupt_enable(cphy: *mut cphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88x201x_interrupt_disable(cphy: *mut cphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88x201x_interrupt_clear(cphy: *mut cphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88x201x_interrupt_handler(cphy: *mut cphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88x201x_set_loopback(cphy: *mut cphy, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88x201x_destroy(cphy: *mut cphy) {
...
// Chip Reset
#[no_mangle]
unsafe extern "C" fn mv88x201x_phy_reset(adapter: *mut adapter_t) -> c_int {
