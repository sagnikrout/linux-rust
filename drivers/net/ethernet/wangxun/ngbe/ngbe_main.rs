...
//! Source: drivers/net/ethernet/wangxun/ngbe/ngbe_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ngbe_down_suspend(wx: *mut wx) {
...
//
#[no_mangle]
unsafe extern "C" fn ngbe_init_type_code(wx: *mut wx) {
    static void ngbe_init_type_code(struct wx *wx)
    {
    let mut wol_mask: c_int = 0, ncsi_mask = 0;
    let mut type_mask: u16 = 0, val;
...
//
#[no_mangle]
unsafe extern "C" fn ngbe_sw_init(wx: *mut wx) -> c_int {
    static int ngbe_sw_init(struct wx *wx)
    {
    struct pci_dev *pdev = wx.pdev;
    let mut msix_count: u16 = 0;
    let mut err: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn ngbe_service_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ngbe_init_service(wx: *mut wx) {
...
//
#[no_mangle]
unsafe extern "C" fn ngbe_irq_enable(wx: *mut wx, queues: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: wx->pdev->msix_enabled) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ngbe_intr(irq: int __always_unused, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn __ngbe_msix_misc(wx: *mut wx, eicr: u32) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ngbe_msix_misc(irq: int __always_unused, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ngbe_misc_and_queue(irq: int __always_unused, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ngbe_request_msix_irqs(wx: *mut wx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ngbe_request_irq(wx: *mut wx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ngbe_disable_device(wx: *mut wx) {
...
// disable transmits in the hardware now that interrupts are off
    ...
    let mut reg_idx: u8 = wx.tx_ring[i].reg_idx;
    wr32(wx, WX_PX_TR_CFG(reg_idx), WX_PX_TR_CFG_SWFLSH);
    }
    }
#[no_mangle]
unsafe extern "C" fn ngbe_reset(wx: *mut wx) {
...
#[no_mangle]
pub unsafe extern "C" fn ngbe_down(wx: *mut wx) {
...
#[no_mangle]
unsafe extern "C" fn ngbe_up_complete(wx: *mut wx) {
...
//
#[no_mangle]
unsafe extern "C" fn ngbe_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ngbe_up(wx: *mut wx) {
...
//
#[no_mangle]
unsafe extern "C" fn ngbe_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ngbe_dev_shutdown(pdev: *mut pci_dev, enable_wake: *mut bool) {
    static void ngbe_dev_shutdown(struct pci_dev *pdev, bool *enable_wake)
    {
    struct wx *wx = pci_get_drvdata(pdev);
    struct net_device *netdev;
    let mut wufc: u32 = wx.wol;
    netdev = wx.netdev;
    rtnl_lock();
...
#[no_mangle]
unsafe extern "C" fn ngbe_shutdown(pdev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ngbe_setup_tc(dev: *mut net_device, tc: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ngbe_reinit_locked(wx: *mut wx) {
...
#[no_mangle]
pub unsafe extern "C" fn ngbe_do_reset(netdev: *mut net_device, reinit: bool) {
...
//
    ...
    {
    struct net_device *netdev;
    let mut e2rom_cksum_cap: u32 = 0;
    struct wx *wx = core::ptr::null_mut();
    static int func_nums;
    let mut e2rom_ver: u16 = 0;
    let mut etrack_id: u32 = 0;
    let mut saved_ver: u32 = 0;
    int err;
...
//
#[no_mangle]
unsafe extern "C" fn ngbe_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn ngbe_suspend(pdev: *mut pci_dev, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ngbe_resume(pdev: *mut pci_dev) -> c_int {
