...
//! Source: drivers/net/ethernet/wangxun/txgbe/txgbe_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn txgbe_check_minimum_link(wx: *mut wx) {
...
//
#[no_mangle]
unsafe extern "C" fn txgbe_enumerate_functions(wx: *mut wx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn txgbe_module_detection_subtask(wx: *mut wx) {
...
#[no_mangle]
unsafe extern "C" fn txgbe_link_config_subtask(wx: *mut wx) {
...
//
#[no_mangle]
unsafe extern "C" fn txgbe_service_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn txgbe_init_service(wx: *mut wx) {
...
#[no_mangle]
unsafe extern "C" fn txgbe_up_complete(wx: *mut wx) {
...
#[no_mangle]
unsafe extern "C" fn txgbe_reset(wx: *mut wx) {
...
#[no_mangle]
unsafe extern "C" fn txgbe_disable_device(wx: *mut wx) {
...
#[no_mangle]
pub unsafe extern "C" fn txgbe_down(wx: *mut wx) {
...
#[no_mangle]
pub unsafe extern "C" fn txgbe_up(wx: *mut wx) {
...
#[no_mangle]
unsafe extern "C" fn txgbe_down_suspend(wx: *mut wx) {
...
//
#[no_mangle]
unsafe extern "C" fn txgbe_init_type_code(wx: *mut wx) {
    static void txgbe_init_type_code(struct wx *wx)
    {
    let mut device_type: u8 = wx.subsystem_device_id & 0xF0;
    switch (wx.device_id) {
...
//
#[no_mangle]
unsafe extern "C" fn txgbe_sw_init(wx: *mut wx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn txgbe_init_fdir(txgbe: *mut txgbe) {
...
//
#[no_mangle]
unsafe extern "C" fn txgbe_open(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn txgbe_close_suspend(wx: *mut wx) {
...
//
#[no_mangle]
unsafe extern "C" fn txgbe_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn txgbe_dev_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn txgbe_shutdown(pdev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn txgbe_setup_tc(dev: *mut net_device, tc: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn txgbe_reinit_locked(wx: *mut wx) {
...
#[no_mangle]
pub unsafe extern "C" fn txgbe_do_reset(netdev: *mut net_device, reinit: bool) {
...
#[no_mangle]
unsafe extern "C" fn txgbe_udp_tunnel_sync(dev: *mut net_device, table: c_uint) -> c_int {
...
//
    ...
    struct txgbe *txgbe;
    let mut eeprom_verh: u16 = 0, eeprom_verl = 0, offset = 0;
    let mut eeprom_cfg_blkh: u16 = 0, eeprom_cfg_blkl = 0;
    let mut build: u16 = 0, major = 0, patch = 0;
...
// make sure the EEPROM is good
    err = txgbe_validate_eeprom_checksum(wx, core::ptr::null_mut());
    if (err != 0) {
...
//
#[no_mangle]
unsafe extern "C" fn txgbe_remove(pdev: *mut pci_dev) {
