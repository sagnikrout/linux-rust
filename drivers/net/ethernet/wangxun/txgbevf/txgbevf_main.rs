...
//! Source: drivers/net/ethernet/wangxun/txgbevf/txgbevf_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn txgbevf_set_num_queues(wx: *mut wx) {
    static void txgbevf_set_num_queues(struct wx *wx)
    {
    let mut def_q: u32 = 0, num_tcs = 0;
    u16 rss, queue;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn txgbevf_init_type_code(wx: *mut wx) {
...
#[no_mangle]
unsafe extern "C" fn txgbevf_sw_init(wx: *mut wx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn txgbevf_remove(pdev: *mut pci_dev) {
