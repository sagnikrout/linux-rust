...
//! Source: drivers/net/ethernet/engleder/tsnep_main.c
#![no_std]
...
pub const TSNEP_COALESCE_USECS_DEFAULT: c_int = 64;
...
#[no_mangle]
unsafe extern "C" fn tsnep_enable_irq(adapter: *mut tsnep_adapter, mask: u32) {
    static void tsnep_enable_irq(struct tsnep_adapter *adapter, u32 mask)
    {
    iowrite32(mask, adapter.addr + ECM_INT_ENABLE);
    }
#[no_mangle]
unsafe extern "C" fn tsnep_disable_irq(adapter: *mut tsnep_adapter, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_irq(irq: c_int, arg: *mut c_void) -> irqreturn_t {
    static irqreturn_t tsnep_irq(int irq, void *arg)
    {
    struct tsnep_adapter *adapter = arg;
    let mut active: u32 = ioread32(adapter.addr + ECM_INT_ACTIVE);
...
#[no_mangle]
unsafe extern "C" fn tsnep_irq_txrx(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn tsnep_set_irq_coalesce(queue: *mut tsnep_queue, usecs: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tsnep_get_irq_coalesce(queue: *mut tsnep_queue) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tsnep_mdiobus_read(bus: *mut mii_bus, addr: c_int, regnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_set_link_mode(adapter: *mut tsnep_adapter) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_phy_link_status_change(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_phy_loopback(adapter: *mut tsnep_adapter, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_phy_open(adapter: *mut tsnep_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_phy_close(adapter: *mut tsnep_adapter) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_tx_ring_cleanup(tx: *mut tsnep_tx) {
    ...
    tx.page_dma[i]);
    tx.page[i] = core::ptr::null_mut();
    tx.page_dma[i] = 0;
    }
    }
    }
#[no_mangle]
unsafe extern "C" fn tsnep_tx_ring_create(tx: *mut tsnep_tx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_tx_init(tx: *mut tsnep_tx) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_tx_enable(tx: *mut tsnep_tx) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_tx_disable(tx: *mut tsnep_tx, napi: *mut napi_struct) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_tx_desc_available(tx: *mut tsnep_tx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_tx_unmap(tx: *mut tsnep_tx, index: c_int, count: c_int) -> c_int {
    ...
    DMA_TO_DEVICE);
#[no_mangle]
pub unsafe extern "C" fn if(TSNEP_TX_TYPE_MAP_PAGE: entry->type &) -> else {
...
#[no_mangle]
unsafe extern "C" fn tsnep_xdp_xmit_flush(tx: *mut tsnep_tx) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_xdp_tx_map_zc(xdpd: *mut xdp_desc, tx: *mut tsnep_tx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_xdp_xmit_zc(tx: *mut tsnep_tx) {
    static void tsnep_xdp_xmit_zc(struct tsnep_tx *tx)
    {
    let mut desc_available: c_int = tsnep_tx_desc_available(tx);
...
#[no_mangle]
unsafe extern "C" fn tsnep_tx_poll(tx: *mut tsnep_tx, napi_budget: c_int) -> bool {
    static bool tsnep_tx_poll(struct tsnep_tx *tx, int napi_budget)
    {
    struct tsnep_tx_entry *entry;
    struct netdev_queue *nq;
    let mut xsk_frames: c_int = 0;
    let mut budget: c_int = 128;
    int length;
    int count;
    nq = netdev_get_tx_queue(tx.adapter.netdev, tx.queue_index);
...
#[no_mangle]
pub unsafe extern "C" fn if(TSNEP_TX_TYPE_XDP: entry->type &) -> else {
    else if (entry.type & TSNEP_TX_TYPE_XDP)
...
#[no_mangle]
unsafe extern "C" fn tsnep_tx_pending(tx: *mut tsnep_tx) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tsnep_tx_open(tx: *mut tsnep_tx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_tx_close(tx: *mut tsnep_tx) {
    static void tsnep_tx_close(struct tsnep_tx *tx)
    {
    tsnep_tx_ring_cleanup(tx);
    }
#[no_mangle]
unsafe extern "C" fn tsnep_rx_ring_cleanup(rx: *mut tsnep_rx) {
...
// xdp is union with page
    ...
    rx.page_dma[i]);
    rx.page[i] = core::ptr::null_mut();
    rx.page_dma[i] = 0;
    }
    }
    }
#[no_mangle]
unsafe extern "C" fn tsnep_rx_ring_create(rx: *mut tsnep_rx) -> c_int {
    ...
    rx.page_pool = core::ptr::null_mut();
    goto failed;
    }
    for (i = 0; i < TSNEP_RING_SIZE; i++) {
    entry = &rx.entry[i];
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_init(rx: *mut tsnep_rx) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_enable(rx: *mut tsnep_rx) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_disable(rx: *mut tsnep_rx) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_desc_available(rx: *mut tsnep_rx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_free_page_buffer(rx: *mut tsnep_rx) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_alloc_page_buffer(rx: *mut tsnep_rx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_alloc_buffer(rx: *mut tsnep_rx, index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_reuse_buffer(rx: *mut tsnep_rx, index: c_int) {
    ...
    read.page = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn tsnep_rx_activate(rx: *mut tsnep_rx, index: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_alloc(rx: *mut tsnep_rx, count: c_int, reuse: bool) -> c_int {
    static int tsnep_rx_alloc(struct tsnep_rx *rx, int count, bool reuse)
    {
    let mut alloc_failed: bool = false;
    int i, index;
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_refill(rx: *mut tsnep_rx, count: c_int, reuse: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_reuse_buffer_zc(rx: *mut tsnep_rx, index: c_int) {
    static void tsnep_rx_reuse_buffer_zc(struct tsnep_rx *rx, int index)
    {
    struct tsnep_rx_entry *entry = &rx.entry[index];
    struct tsnep_rx_entry *read = &rx.entry[rx.read];
    tsnep_rx_set_xdp(rx, entry, read.xdp);
    read.xdp = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn tsnep_rx_alloc_zc(rx: *mut tsnep_rx, count: c_int, reuse: bool) -> c_int {
    ...
    let mut index: c_int = (rx.write + i) & TSNEP_RING_MASK;
    struct tsnep_rx_entry *entry = &rx.entry[index];
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_free_zc(rx: *mut tsnep_rx) {
    ...
    if (entry.xdp)
    xsk_buff_free(entry.xdp);
    entry.xdp = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn tsnep_rx_refill_zc(rx: *mut tsnep_rx, count: c_int, reuse: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_xsk_rx_need_wakeup(rx: *mut tsnep_rx, desc_available: c_int) {
...
// update pointers within the skb to store the data
    ...
    let mut reuse: bool = desc_available >= TSNEP_RING_RX_REUSE;
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_pending(rx: *mut tsnep_rx) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_open(rx: *mut tsnep_rx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_close(rx: *mut tsnep_rx) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_reopen(rx: *mut tsnep_rx) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_rx_reopen_xsk(rx: *mut tsnep_rx) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_pending(queue: *mut tsnep_queue) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tsnep_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_request_irq(queue: *mut tsnep_queue, first: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: queue->tx) -> else {
    else if (queue.tx)
...
#[no_mangle]
unsafe extern "C" fn tsnep_free_irq(queue: *mut tsnep_queue, first: bool) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_queue_close(queue: *mut tsnep_queue, first: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(adapter->num_tx_queues: rx->queue_index <) -> else {
...
#[no_mangle]
unsafe extern "C" fn tsnep_queue_enable(queue: *mut tsnep_queue) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_queue_disable(queue: *mut tsnep_queue) {
    static void tsnep_queue_disable(struct tsnep_queue *queue)
    {
    struct tsnep_adapter *adapter = queue.adapter;
    if (queue.rx)
    netif_queue_set_napi(adapter.netdev, queue.rx.queue_index,
    NETDEV_QUEUE_TYPE_RX, core::ptr::null_mut());
    if (queue.tx) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_netdev_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_netdev_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tsnep_enable_xsk(queue: *mut tsnep_queue, pool: *mut xsk_buff_pool) -> c_int {
    int tsnep_enable_xsk(struct tsnep_queue *queue, struct xsk_buff_pool *pool)
    {
    let mut running: bool = netif_running(queue.adapter.netdev);
    u32 frame_size;
    ...
    queue.rx.page_buffer = core::ptr::null_mut();
    return -ENOMEM;
    }
...
#[no_mangle]
pub unsafe extern "C" fn tsnep_disable_xsk(queue: *mut tsnep_queue) {
    ...
    queue.rx.xsk_pool = core::ptr::null_mut();
    queue.tx.xsk_pool = core::ptr::null_mut();
    if (running) {
    tsnep_rx_reopen(queue.rx);
    tsnep_queue_enable(queue);
    }
    kfree(queue.rx.xdp_batch);
    queue.rx.xdp_batch = core::ptr::null_mut();
    kfree(queue.rx.page_buffer);
    queue.rx.page_buffer = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn tsnep_netdev_set_multicast(netdev: *mut net_device) {
    static void tsnep_netdev_set_multicast(struct net_device *netdev)
    {
    struct tsnep_adapter *adapter = netdev_priv(netdev);
    let mut rx_filter: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn tsnep_mac_set_address(adapter: *mut tsnep_adapter, addr: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_netdev_set_mac_address(netdev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_netdev_bpf(dev: *mut net_device, bpf: *mut netdev_bpf) -> c_int {
    ...
    {
    struct tsnep_adapter *adapter = netdev_priv(dev);
    let mut cpu: u32 = smp_processor_id();
    struct netdev_queue *nq;
    struct tsnep_tx *tx;
    int nxmit;
    bool xmit;
...
#[no_mangle]
unsafe extern "C" fn tsnep_mac_init(adapter: *mut tsnep_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_mdio_init(adapter: *mut tsnep_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_phy_init(adapter: *mut tsnep_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_queue_init(adapter: *mut tsnep_adapter, queue_count: c_int) -> c_int {
    static int tsnep_queue_init(struct tsnep_adapter *adapter, int queue_count)
    {
    let mut irq_mask: u32 = ECM_INT_TX_0 | ECM_INT_RX_0;
    char name[8];
    int i;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn tsnep_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_remove(pdev: *mut platform_device) {
