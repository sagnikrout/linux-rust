...
//! Source: drivers/net/ethernet/engleder/tsnep_ptp.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn tsnep_get_system_time(adapter: *mut tsnep_adapter, time: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_ptp_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_ptp_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
// ts = ns_to_timespec64(system_time);
    ...
    struct tsnep_adapter *adapter = container_of(ptp, struct tsnep_adapter,
    ptp_clock_info);
    let mut system_time: u64 = timespec64_to_ns(ts);
    unsigned long flags;
    spin_lock_irqsave(&adapter.ptp_lock, flags);
// high dword is buffered in hardware and synchronously written to
// system time when low dword is written
...
#[no_mangle]
pub unsafe extern "C" fn tsnep_ptp_init(adapter: *mut tsnep_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tsnep_ptp_cleanup(adapter: *mut tsnep_adapter) {
