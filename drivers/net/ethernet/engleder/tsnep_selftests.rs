...
//! Source: drivers/net/ethernet/engleder/tsnep_selftests.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn enable_gc_timeout(adapter: *mut tsnep_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gc_timeout_signaled(adapter: *mut tsnep_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ack_gc_timeout(adapter: *mut tsnep_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn enable_gc(adapter: *mut tsnep_adapter, a: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn disable_gc(adapter: *mut tsnep_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gc_delayed_enable(adapter: *mut tsnep_adapter, a: bool, delay: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tsnep_test_gc_enable(adapter: *mut tsnep_adapter) -> bool {
    ...
    {
    u64 system_time;
    let mut base_time: u64 = ktime_to_ns(qopt.base_time);
    u64 n;
...
#[no_mangle]
unsafe extern "C" fn get_operation(gcl: *mut tsnep_gcl, system_time: u64, next: *mut u64) -> c_int {
    static int get_operation(struct tsnep_gcl *gcl, u64 system_time, u64 *next)
    {
    let mut n: u64 = div64_u64(system_time - gcl.base_time, gcl.cycle_time);
    let mut cycle_start: u64 = gcl.base_time + gcl.cycle_time * n;
    int i;
// next = cycle_start;
...
#[no_mangle]
unsafe extern "C" fn check_gate(adapter: *mut tsnep_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn check_gate_duration(adapter: *mut tsnep_adapter, ms: i64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn disable_taprio(adapter: *mut tsnep_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tsnep_test_taprio(adapter: *mut tsnep_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tsnep_test_taprio_change(adapter: *mut tsnep_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tsnep_test_taprio_extension(adapter: *mut tsnep_adapter) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn tsnep_ethtool_get_test_count() -> c_int {
    int tsnep_ethtool_get_test_count(void)
    {
    return TSNEP_TEST_COUNT;
    }
#[no_mangle]
pub unsafe extern "C" fn tsnep_ethtool_get_test_strings(data: *mut u8) {
