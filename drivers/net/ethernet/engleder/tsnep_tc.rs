...
//! Source: drivers/net/ethernet/engleder/tsnep_tc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tsnep_validate_gcl(qopt: *mut tc_taprio_qopt_offload) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsnep_change_duration(gcl: *mut tsnep_gcl, index: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn tsnep_gcl_start_after(gcl: *mut tsnep_gcl, limit: u64) -> u64 {
    static u64 tsnep_gcl_start_after(struct tsnep_gcl *gcl, u64 limit)
    {
    let mut start: u64 = gcl.base_time;
    u64 n;
    if (start <= limit) {
...
#[no_mangle]
unsafe extern "C" fn tsnep_gcl_start_before(gcl: *mut tsnep_gcl, limit: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn tsnep_clean_gcl(gcl: *mut tsnep_gcl) {
    static void tsnep_clean_gcl(struct tsnep_gcl *gcl)
    {
    int i;
    let mut mask: u32 = TSNEP_GCL_LAST | TSNEP_GCL_MASK;
    void __iomem *addr;
...
#[no_mangle]
unsafe extern "C" fn tsnep_extend_gcl(gcl: *mut tsnep_gcl, start: u64, extension: u32) -> u64 {
    static u64 tsnep_extend_gcl(struct tsnep_gcl *gcl, u64 start, u32 extension)
    {
    let mut ref: c_int = gcl.count - 1;
    let mut interval: u32 = gcl.operation[ref].interval + extension;
    start -= gcl.operation[ref].interval;
    return tsnep_insert_gcl_operation(gcl, ref, start, interval);
    }
#[no_mangle]
unsafe extern "C" fn tsnep_cut_gcl(gcl: *mut tsnep_gcl, start: u64, cycle_time: u64) -> u64 {
...
// find operation which shall be cutted
    for (i = 0; i < gcl.count; i++) {
    let mut sum_tmp: u64 = sum + gcl.operation[i].interval;
    u64 interval;
...
#[no_mangle]
pub unsafe extern "C" fn tsnep_tc_init(adapter: *mut tsnep_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tsnep_tc_cleanup(adapter: *mut tsnep_adapter) {
