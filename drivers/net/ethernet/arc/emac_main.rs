...
//! Source: drivers/net/ethernet/arc/emac_main.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn arc_emac_tx_avail(priv: *mut arc_emac_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn arc_emac_adjust_link(ndev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn arc_emac_tx_clean(ndev: *mut net_device) {
    ...
    let mut info: c_uint = le32_to_cpu(txbd.info);
...
//
#[no_mangle]
unsafe extern "C" fn arc_emac_rx(ndev: *mut net_device, budget: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn arc_emac_rx_miss_handle(ndev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn arc_emac_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn arc_emac_intr(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn arc_emac_poll_controller(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn arc_emac_open(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn arc_emac_set_rx_mode(ndev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn arc_free_tx_queue(ndev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn arc_free_rx_queue(ndev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn arc_emac_stop(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn arc_emac_tx(skb: *mut sk_buff, ndev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn arc_emac_set_address_internal(ndev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn arc_emac_set_address(ndev: *mut net_device, p: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn arc_emac_restart(ndev: *mut net_device) {
    static void arc_emac_restart(struct net_device *ndev)
    {
    struct arc_emac_priv *priv = netdev_priv(ndev);
    struct net_device_stats *stats = &ndev.stats;
...
// Clean Tx BD's
    ...
    for (i = 0; i < RX_BD_NUM; i++) {
    struct arc_emac_bd *rxbd = &priv.rxbd[i];
    let mut info: c_uint = le32_to_cpu(rxbd.info);
    if (!(info & FOR_EMAC)) {
    stats.rx_errors++;
    stats.rx_dropped++;
    }
...
#[no_mangle]
pub unsafe extern "C" fn arc_emac_probe(ndev: *mut net_device, interface: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn arc_emac_remove(ndev: *mut net_device) {
