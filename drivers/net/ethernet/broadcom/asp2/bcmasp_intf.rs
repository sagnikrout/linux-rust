...
//! Source: drivers/net/ethernet/broadcom/asp2/bcmasp_intf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn incr_ring(index: c_int, ring_count: c_int) -> c_int {
...
// Points to last byte of descriptor
    ...
    int ring_count)
    {
    let mut end: dma_addr_t = beg + (ring_count * DESC_SIZE);
    addr += DESC_SIZE;
    if (addr > end)
...
#[no_mangle]
unsafe extern "C" fn bcmasp_enable_tx(intf: *mut bcmasp_intf, en: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_enable_rx(intf: *mut bcmasp_intf, en: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_set_rx_mode(dev: *mut net_device) {
...
// Check if we have enough room for cnt descriptors
    ...
    {
    struct bcmasp_intf *intf = netdev_priv(dev);
    let mut header: u32 = 0, header2 = 0, epkt = 0;
    struct bcmasp_pkt_offload *offload;
    let mut header_cnt: c_uint = 0;
    u8 ip_proto;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn bcmasp_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_tx_reclaim(intf: *mut bcmasp_intf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_tx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_rx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_adj_link(dev: *mut net_device) {
    static void bcmasp_adj_link(struct net_device *dev)
    {
    struct bcmasp_intf *intf = netdev_priv(dev);
    struct phy_device *phydev = dev.phydev;
    let mut cmd_bits: u32 = 0, reg;
...
#[no_mangle]
unsafe extern "C" fn bcmasp_alloc_rx_buffers(intf: *mut bcmasp_intf) -> c_int {
...
// Page pool for SKB data areas (copy targets, not DMA buffers).
    ...
    intf.rx_page_pool = core::ptr::null_mut();
    goto free_ring_dma;
    }
    return 0;
    free_ring_dma:
...
#[no_mangle]
unsafe extern "C" fn bcmasp_reclaim_rx_buffers(intf: *mut bcmasp_intf) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_alloc_buffers(intf: *mut bcmasp_intf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_reclaim_free_buffers(intf: *mut bcmasp_intf) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_init_rx(intf: *mut bcmasp_intf) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_init_tx(intf: *mut bcmasp_intf) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_ephy_enable_set(intf: *mut bcmasp_intf, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_rgmii_mode_en_set(intf: *mut bcmasp_intf, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_phy_hw_unprepare(intf: *mut bcmasp_intf) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_netif_deinit(dev: *mut net_device, stop_phy: bool) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_stop(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_phy_hw_prepare(intf: *mut bcmasp_intf) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_phy_iface_for_connect(mode: phy_interface_t) -> phy_interface_t {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_phy_attach(intf: *mut bcmasp_intf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_netif_init(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_map_res(priv: *mut bcmasp_priv, intf: *mut bcmasp_intf) {
...
#[no_mangle]
pub unsafe extern "C" fn bcmasp_interface_destroy(intf: *mut bcmasp_intf) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_suspend_to_wol(intf: *mut bcmasp_intf) {
...
#[no_mangle]
pub unsafe extern "C" fn bcmasp_interface_suspend(intf: *mut bcmasp_intf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_resume_from_wol(intf: *mut bcmasp_intf) {
...
#[no_mangle]
pub unsafe extern "C" fn bcmasp_interface_resume(intf: *mut bcmasp_intf) -> c_int {
