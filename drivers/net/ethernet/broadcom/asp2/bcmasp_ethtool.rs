...
//! Source: drivers/net/ethernet/broadcom/asp2/bcmasp_ethtool.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcmasp_stats {
    pub stat_string: [c_char; ETH_GSTRING_LEN],
    pub type: enum bcmasp_stat_type,
    pub reg_offset: u32,
}
...
#[no_mangle]
unsafe extern "C" fn bcmasp_get_sset_count(dev: *mut net_device, string_set: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_update_mib_counters(intf: *mut bcmasp_intf) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_get_msglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_set_msglevel(dev: *mut net_device, level: u32) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_get_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_set_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_flow_insert(dev: *mut net_device, cmd: *mut ethtool_rxnfc) -> c_int {
    static int bcmasp_flow_insert(struct net_device *dev, struct ethtool_rxnfc *cmd)
    {
    struct bcmasp_intf *intf = netdev_priv(dev);
    struct bcmasp_net_filter *nfilter;
    let mut loc: u32 = cmd.fs.location;
...
#[no_mangle]
unsafe extern "C" fn bcmasp_flow_delete(dev: *mut net_device, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_flow_get(intf: *mut bcmasp_intf, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_set_rxnfc(dev: *mut net_device, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_get_eee(dev: *mut net_device, e: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcmasp_set_eee(dev: *mut net_device, e: *mut ethtool_keee) -> c_int {
