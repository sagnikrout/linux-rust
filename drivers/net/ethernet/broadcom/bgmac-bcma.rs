...
//! Source: drivers/net/ethernet/broadcom/bgmac-bcma.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn bgmac_is_bcm4707_family(core: *mut bcma_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bcma_bgmac_clk_enabled(bgmac: *mut bgmac) -> bool {
    static bool bcma_bgmac_clk_enabled(struct bgmac *bgmac)
    {
    return bcma_core_is_enabled(bgmac.bcma.core);
    }
#[no_mangle]
unsafe extern "C" fn bcma_bgmac_clk_enable(bgmac: *mut bgmac, flags: u32) {
...
#[no_mangle]
unsafe extern "C" fn bcma_bgmac_get_bus_clock(bgmac: *mut bgmac) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bcma_phy_connect(bgmac: *mut bgmac) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bgmac_probe(core: *mut bcma_device) -> c_int {
...
// bcm4707_family
    ...
    err:
    bcma_set_drvdata(core, core::ptr::null_mut());
    return err;
    }
#[no_mangle]
unsafe extern "C" fn bgmac_remove(core: *mut bcma_device) {
...
#[no_mangle]
unsafe extern "C" fn bgmac_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn bgmac_exit() -> void __exit {
