...
//! Source: drivers/net/ethernet/broadcom/bnge/bnge_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bnge_print_device_info(pdev: *mut pci_dev, idx: enum board_idx) {
...
#[no_mangle]
pub unsafe extern "C" fn bnge_aux_registered(bd: *mut bnge_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bnge_nvm_cfg_ver_get(bd: *mut bnge_dev) {
...
#[no_mangle]
unsafe extern "C" fn bnge_func_qcaps(bd: *mut bnge_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnge_func_qrcaps_qcfg(bd: *mut bnge_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnge_fw_unregister_dev(bd: *mut bnge_dev) {
...
#[no_mangle]
unsafe extern "C" fn bnge_set_dflt_rss_hash_type(bd: *mut bnge_dev) {
...
#[no_mangle]
unsafe extern "C" fn bnge_fw_register_dev(bd: *mut bnge_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnge_pci_disable(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn bnge_pci_enable(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnge_get_max_irq(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnge_map_db_bar(bd: *mut bnge_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnge_probe_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnge_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn bnge_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn bnge_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn bnge_exit_module() -> void __exit {
