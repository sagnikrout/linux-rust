...
//! Source: drivers/net/ethernet/broadcom/bgmac-platform.c
#![no_std]
...
pub const NICPM_PADRING_CFG: c_uint = 0x00000004;
pub const NICPM_IOMUX_CTRL: c_uint = 0x00000008;
pub const NICPM_PADRING_CFG_INIT_VAL: c_uint = 0x74000000;
pub const NICPM_IOMUX_CTRL_INIT_VAL_AX: c_uint = 0x21880000;
pub const NICPM_IOMUX_CTRL_INIT_VAL: c_uint = 0x3196e000;
pub const NICPM_IOMUX_CTRL_SPD_SHIFT: c_int = 10;
pub const NICPM_IOMUX_CTRL_SPD_10M: c_int = 0;
pub const NICPM_IOMUX_CTRL_SPD_100M: c_int = 1;
pub const NICPM_IOMUX_CTRL_SPD_1000M: c_int = 2;
#[no_mangle]
unsafe extern "C" fn platform_bgmac_read(bgmac: *mut bgmac, offset: u16) -> u32 {
    static u32 platform_bgmac_read(struct bgmac *bgmac, u16 offset)
    {
    return readl(bgmac.plat.base + offset);
    }
#[no_mangle]
unsafe extern "C" fn platform_bgmac_write(bgmac: *mut bgmac, offset: u16, value: u32) {
    static void platform_bgmac_write(struct bgmac *bgmac, u16 offset, u32 value)
    {
    writel(value, bgmac.plat.base + offset);
    }
#[no_mangle]
unsafe extern "C" fn platform_bgmac_idm_read(bgmac: *mut bgmac, offset: u16) -> u32 {
    static u32 platform_bgmac_idm_read(struct bgmac *bgmac, u16 offset)
    {
    return readl(bgmac.plat.idm_base + offset);
    }
#[no_mangle]
unsafe extern "C" fn platform_bgmac_idm_write(bgmac: *mut bgmac, offset: u16, value: u32) {
    static void platform_bgmac_idm_write(struct bgmac *bgmac, u16 offset, u32 value)
    {
    writel(value, bgmac.plat.idm_base + offset);
    }
#[no_mangle]
unsafe extern "C" fn platform_bgmac_clk_enabled(bgmac: *mut bgmac) -> bool {
...
#[no_mangle]
unsafe extern "C" fn platform_bgmac_clk_enable(bgmac: *mut bgmac, flags: u32) {
...
#[no_mangle]
unsafe extern "C" fn platform_bgmac_get_bus_clock(bgmac: *mut bgmac) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bgmac_nicpm_speed_set(net_dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn platform_phy_connect(bgmac: *mut bgmac) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bgmac_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bgmac_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn bgmac_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bgmac_resume(dev: *mut device) -> c_int {
