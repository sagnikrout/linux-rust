...
//! Source: drivers/net/ethernet/broadcom/bgmac-bcma-mdio.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn bcma_mdio_phy_read(bgmac: *mut bgmac, phyaddr: u8, reg: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn bcma_mdio_phy_init(bgmac: *mut bgmac) {
...
#[no_mangle]
unsafe extern "C" fn bcma_mdio_phy_reset(bus: *mut mii_bus) -> c_int {
    static int bcma_mdio_phy_reset(struct mii_bus *bus)
    {
    struct bgmac *bgmac = bus.priv;
    let mut phyaddr: u8 = bgmac.phyaddr;
...
//
#[no_mangle]
unsafe extern "C" fn bcma_mdio_mii_read(bus: *mut mii_bus, mii_id: c_int, regnum: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bcma_mdio_mii_unregister(mii_bus: *mut mii_bus) {
