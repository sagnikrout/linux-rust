...
//! Source: drivers/net/ethernet/broadcom/bnx2x/bnx2x_main.c
#![no_std]
...
pub const BNX2X_PREV_WAIT_NEEDED: c_int = 1;
...
//
    ...
    u16 pfid)
    {
    let mut size: usize = sizeof(struct event_ring_data);
    let mut addr: u32 = BAR_CSTRORM_INTMEM + CSTORM_EVENT_RING_DATA_OFFSET(pfid);
    __storm_memset_struct(bp, addr, size, (u32 *)eq_data);
    }
    static void storm_memset_eq_prod(struct bnx2x *bp, u16 eq_prod,
    u16 pfid)
    {
    let mut addr: u32 = BAR_CSTRORM_INTMEM + CSTORM_EVENT_RING_PROD_OFFSET(pfid);
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_reg_wr_ind(bp: *mut bnx2x, addr: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_reg_rd_ind(bp: *mut bnx2x, addr: u32) -> u32 {
    ...
    {
    let mut src_type: u32 = dmae.opcode & DMAE_COMMAND_SRC;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_post_dmae(bp: *mut bnx2x, dmae: *mut dmae_command, idx: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_dmae_opcode_add_comp(opcode: u32, comp_type: u8) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_dmae_opcode_clr_src_reset(opcode: u32) -> u32 {
...
// issue a dmae command over the init-channel and wait for completion
    ...
    u32 *comp)
    {
    let mut cnt: c_int = CHIP_REV_IS_SLOW(bp) ? (400000) : 4000;
    let mut rc: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_read_dmae(bp: *mut bnx2x, src_addr: u32, len32: u32) {
...
// issue the command and wait for completion
    ...
    u32 addr, u32 len)
    {
    let mut dmae_wr_max: c_int = DMAE_LEN32_WR_MAX(bp);
...
pub const STORMS_NUM: c_int = 4;
pub const REGS_IN_ENTRY: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_mc_assert(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_fw_dump_lvl(bp: *mut bnx2x, lvl: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_fw_dump(bp: *mut bnx2x) {
    static void bnx2x_fw_dump(struct bnx2x *bp)
    {
    bnx2x_fw_dump_lvl(bp, KERN_ERR);
    }
#[no_mangle]
unsafe extern "C" fn bnx2x_hc_int_disable(bp: *mut bnx2x) {
    static void bnx2x_hc_int_disable(struct bnx2x *bp)
    {
    let mut port: c_int = BP_PORT(bp);
    let mut addr: u32 = port ? HC_REG_CONFIG_1 : HC_REG_CONFIG_0;
    let mut val: u32 = REG_RD(bp, addr);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_igu_int_disable(bp: *mut bnx2x) {
    static void bnx2x_igu_int_disable(struct bnx2x *bp)
    {
    let mut val: u32 = REG_RD(bp, IGU_REG_PF_CONFIGURATION);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_int_disable(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_panic_dump(bp: *mut bnx2x, disable_int: bool) {
    void bnx2x_panic_dump(struct bnx2x *bp, bool disable_int)
    {
    int i;
    u16 j;
    struct hc_sp_status_block_data sp_sb_data;
    let mut func: c_int = BP_FUNC(bp);

    let mut start: u16 = 0, end = 0;
    u8 cos;
...
// Tx
    ...
    if (IS_PF(bp)) {
    let mut tmp_msg_en: c_int = bp.msg_enable;
    bnx2x_fw_dump(bp);
...
pub struct pbf_pN_cmd_regs {
    ...
    let mut cur_cnt: u32 = poll_count;
    ...
    {
    let mut val: u32 = bnx2x_flr_clnup_reg_poll(bp, reg, 0, poll_cnt);
    if (val != 0) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_flr_clnup_poll_count(bp: *mut bnx2x) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_tx_hw_flushed(bp: *mut bnx2x, poll_count: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_send_final_clnup(bp: *mut bnx2x, clnup_func: u8, poll_cnt: u32) -> c_int {
    int bnx2x_send_final_clnup(struct bnx2x *bp, u8 clnup_func, u32 poll_cnt)
    {
    let mut op_gen_command: u32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_is_pcie_pending(dev: *mut pci_dev) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_poll_hw_usage_counters(bp: *mut bnx2x, poll_cnt: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_hw_enable_status(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_pf_flr_clnup(bp: *mut bnx2x) -> c_int {
    static int bnx2x_pf_flr_clnup(struct bnx2x *bp)
    {
    let mut poll_cnt: u32 = bnx2x_flr_clnup_poll_count(bp);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_hc_int_enable(bp: *mut bnx2x) {
    static void bnx2x_hc_int_enable(struct bnx2x *bp)
    {
    let mut port: c_int = BP_PORT(bp);
    let mut addr: u32 = port ? HC_REG_CONFIG_1 : HC_REG_CONFIG_0;
    let mut val: u32 = REG_RD(bp, addr);
    let mut msix: bool = (bp.flags & USING_MSIX_FLAG) ? true : false;
    let mut single_msix: bool = (bp.flags & USING_SINGLE_MSIX_FLAG) ? true : false;
    let mut msi: bool = (bp.flags & USING_MSI_FLAG) ? true : false;
    if (msix) {
    val &= ~(HC_CONFIG_0_REG_SINGLE_ISR_EN_0 |
    HC_CONFIG_0_REG_INT_LINE_EN_0);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_igu_int_enable(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_int_enable(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_int_disable_sync(bp: *mut bnx2x, disable_hw: c_int) {
    void bnx2x_int_disable_sync(struct bnx2x *bp, int disable_hw)
    {
    let mut msix: c_int = (bp.flags & USING_MSIX_FLAG) ? 1 : 0;
    int i, offset;
    if (disable_hw)
...
#[no_mangle]
unsafe extern "C" fn bnx2x_trylock_hw_lock(bp: *mut bnx2x, resource: u32) -> bool {
    static bool bnx2x_trylock_hw_lock(struct bnx2x *bp, u32 resource)
    {
    u32 lock_status;
    let mut resource_bit: u32 = (1 << resource);
    let mut func: c_int = BP_FUNC(bp);
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_get_leader_lock_resource(bp: *mut bnx2x) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_trylock_leader_lock(bp: *mut bnx2x) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_schedule_sp_task(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_sp_event(fp: *mut bnx2x_fastpath, rr_cqe: *mut union eth_rx_cqe) {
    void bnx2x_sp_event(struct bnx2x_fastpath *fp, union eth_rx_cqe *rr_cqe)
    {
    struct bnx2x *bp = fp.bp;
    let mut cid: c_int = SW_CID(rr_cqe.ramrod_cqe.conn_and_cmd_data);
    let mut command: c_int = CQE_CMD(rr_cqe.ramrod_cqe.conn_and_cmd_data);
    let mut drv_cmd: enum bnx2x_queue_cmd = BNX2X_Q_CMD_MAX;
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
    irqreturn_t bnx2x_interrupt(int irq, void *dev_instance)
    {
    struct bnx2x *bp = netdev_priv(dev_instance);
    let mut status: u16 = bnx2x_ack_int(bp);
    u16 mask;
    int i;
    u8 cos;
...
// Handle Rx or Tx according to SB id
    ...
    mask = 0x2;
    if (status & (mask | 0x1)) {
    struct cnic_ops *c_ops = core::ptr::null_mut();
    rcu_read_lock();
    c_ops = rcu_dereference(bp.cnic_ops);
    if (c_ops && (bp.cnic_eth_dev.drv_state &
    CNIC_DRV_STATE_HANDLES_IRQ))
    c_ops.cnic_handler(bp.cnic_data, core::ptr::null_mut());
    rcu_read_unlock();
    status &= ~mask;
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2x_acquire_hw_lock(bp: *mut bnx2x, resource: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_release_leader_lock(bp: *mut bnx2x) -> c_int {
    int bnx2x_release_leader_lock(struct bnx2x *bp)
    {
    return bnx2x_release_hw_lock(bp, bnx2x_get_leader_lock_resource(bp));
    }
#[no_mangle]
pub unsafe extern "C" fn bnx2x_release_hw_lock(bp: *mut bnx2x, resource: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_get_gpio(bp: *mut bnx2x, gpio_num: c_int, port: u8) -> c_int {
...
// The GPIO should be swapped if swap register is set and active
    ...
    let mut gpio_mask: u32 = (1 << gpio_shift);
    u32 gpio_reg;
    int value;
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_set_gpio(bp: *mut bnx2x, gpio_num: c_int, mode: u32, port: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_set_mult_gpio(bp: *mut bnx2x, pins: u8, mode: u32) -> c_int {
    int bnx2x_set_mult_gpio(struct bnx2x *bp, u8 pins, u32 mode)
    {
    let mut gpio_reg: u32 = 0;
    let mut rc: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_set_gpio_int(bp: *mut bnx2x, gpio_num: c_int, mode: u32, port: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_set_spio(bp: *mut bnx2x, spio: c_int, mode: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_calc_fc_adv(bp: *mut bnx2x) {
    void bnx2x_calc_fc_adv(struct bnx2x *bp)
    {
    let mut cfg_idx: u8 = bnx2x_get_link_cfg_idx(bp);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_set_requested_fc(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_dropless_fc(bp: *mut bnx2x) {
    static void bnx2x_init_dropless_fc(struct bnx2x *bp)
    {
    let mut pause_enabled: u32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_initial_phy_init(bp: *mut bnx2x, load_mode: c_int) -> c_int {
    int bnx2x_initial_phy_init(struct bnx2x *bp, int load_mode)
    {
    int rc, cfx_idx = bnx2x_get_link_cfg_idx(bp);
    let mut req_line_speed: u16 = bp.link_params.req_line_speed[cfx_idx];
    if (!BP_NOMCP(bp)) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_link_set(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x__link_reset(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_force_link_reset(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_link_test(bp: *mut bnx2x, is_serdes: u8) -> u8 {
...
//
    ...
    {
    let mut all_zero: c_int = 1;
    int vn;
    for (vn = VN_0; vn < BP_MAX_VN_NUM(bp); vn++) {
    let mut vn_cfg: u32 = bp.mf_config[vn];
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !vn_min_rate) -> else {
    else if (!vn_min_rate)
...
// if ETS or all min rates are zeros - disable fairness
    ...
    let mut maxCfg: u32 = bnx2x_extract_max_cfg(bp, vn_cfg);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_cmng_fns_mode(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_read_mf_cfg(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_cmng_fns_init(bp: *mut bnx2x, read_cfg: u8, cmng_type: u8) {
...
// rate shaping and fairness are disabled
    ...
    {
    int vn;
    let mut size: usize = sizeof(struct cmng_struct_per_port);
    u32 addr = BAR_XSTRORM_INTMEM +
    XSTORM_CMNG_PER_PORT_VARS_OFFSET(port);
    __storm_memset_struct(bp, addr, size, (u32 *)&cmng.port);
    for (vn = VN_0; vn < BP_MAX_VN_NUM(bp); vn++) {
    let mut func: c_int = func_by_vn(bp, vn);
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_set_local_cmng(bp: *mut bnx2x) {
    void bnx2x_set_local_cmng(struct bnx2x *bp)
    {
    let mut cmng_fns: c_int = bnx2x_get_cmng_fns_mode(bp);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_link_attn(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x__link_status_update(bp: *mut bnx2x) {
...
//
    ...
    {
    let mut func_params: bnx2x_func_state_params = {core::ptr::null_mut()};
...
#[no_mangle]
unsafe extern "C" fn bnx2x_handle_afex_cmd(bp: *mut bnx2x, cmd: u32) {
    static void bnx2x_handle_afex_cmd(struct bnx2x *bp, u32 cmd)
    {
    struct afex_stats afex_stats;
    let mut func: u32 = BP_ABS_FUNC(bp);
    u32 mf_config;
    u16 vlan_val;
    u32 vlan_prio;
    u16 vif_id;
...
// set rate limit directly to internal RAM
    ...
    let mut size: usize = sizeof(struct rate_shaping_vars_per_vn);
    u32 addr = BAR_XSTRORM_INTMEM +
...
#[no_mangle]
unsafe extern "C" fn bnx2x_handle_update_svid_cmd(bp: *mut bnx2x) {
...
// Prepare parameters for function state transitions
    ...
    let mut func: c_int = BP_ABS_FUNC(bp);
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_pmf_update(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_fw_command(bp: *mut bnx2x, command: u32, param: u32) -> u32 {
    u32 bnx2x_fw_command(struct bnx2x *bp, u32 command, u32 param)
    {
    let mut mb_idx: c_int = BP_FW_MB_IDX(bp);
    u32 seq;
    let mut rc: u32 = 0;
    let mut cnt: u32 = 1;
    let mut delay: u8 = CHIP_REV_IS_SLOW(bp) ? 100 : 10;
...
// FW BUG!
    ...
    u16 abs_fid)
    {
    let mut size: usize = sizeof(struct tstorm_eth_function_common_config);
    u32 addr = BAR_TSTRORM_INTMEM +
    TSTORM_FUNCTION_COMMON_CONFIG_OFFSET(abs_fid);
    __storm_memset_struct(bp, addr, size, (u32 *)tcfg);
    }
#[no_mangle]
pub unsafe extern "C" fn bnx2x_func_init(bp: *mut bnx2x, p: *mut bnx2x_func_init_params) {
    void bnx2x_func_init(struct bnx2x *bp, struct bnx2x_func_init_params *p)
    {
    if (CHIP_IS_E1x(bp)) {
    let mut tcfg: tstorm_eth_function_common_config = {0};
...
// Always use mini-jumbo MTU for FCoE L2 ring
    ...
    {
    let mut max_sge: u8 = 0;
    let mut sge_sz: u16 = 0;
    let mut tpa_agg_size: u16 = 0;
    if (fp.mode != TPA_MODE_DISABLED) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_pf_init(bp: *mut bnx2x) {
    static void bnx2x_pf_init(struct bnx2x *bp)
    {
    let mut func_init: bnx2x_func_init_params = {0};
    let mut eq_data: event_ring_data = { {0} };
    if (!CHIP_IS_E1x(bp)) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_e1h_disable(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_e1h_enable(bp: *mut bnx2x) {
...
pub const DRV_INFO_ETH_STAT_NUM_MACS_REQUIRED: c_int = 3;
#[no_mangle]
unsafe extern "C" fn bnx2x_drv_info_ether_stat(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_drv_info_fcoe_stat(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_drv_info_iscsi_stat(bp: *mut bnx2x) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_config_mf_bw(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_set_mf_bw(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_handle_eee_event(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_handle_drv_info_req(bp: *mut bnx2x) {
    static void bnx2x_handle_drv_info_req(struct bnx2x *bp)
    {
    enum drv_info_opcode op_code;
    let mut drv_info_ctl: u32 = SHMEM2_RD(bp, drv_info_control);
...
//
    ...
    let mut bit: u32 = MFW_DRV_IND_READ_DONE_OFFSET((BP_ABS_FUNC(bp) >> 1));
    for (wait = 0; wait < BNX2X_UPDATE_DRV_INFO_IND_COUNT; wait++) {
    let mut indication: u32 = SHMEM2_RD(bp, mfw_drv_indication);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_update_mng_version_utility(version: *mut u8, bnx2x_format: bool) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_update_mng_version(bp: *mut bnx2x) {
    void bnx2x_update_mng_version(struct bnx2x *bp)
    {
    let mut iscsiver: u32 = DRV_VER_NOT_LOADED;
    let mut fcoever: u32 = DRV_VER_NOT_LOADED;
    let mut ethver: u32 = DRV_VER_NOT_LOADED;
    let mut idx: c_int = BP_FW_MB_IDX(bp);
    u8 *version;
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_update_mfw_dump(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_oem_event(bp: *mut bnx2x, event: u32) {
...
// must be called under the spq lock
#[no_mangle]
unsafe extern "C" fn bnx2x_sp_prod_update(bp: *mut bnx2x) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_is_contextless_ramrod(cmd: c_int, cmd_type: c_int) -> bool {
...
//
    ...
    struct eth_spe *spe;
    u16 type;
    let mut common: bool = bnx2x_is_contextless_ramrod(command, cmd_type);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_acquire_alr(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_release_alr(bp: *mut bnx2x) {
    static void bnx2x_release_alr(struct bnx2x *bp)
    {
    REG_WR(bp, MCP_REG_MCPR_ACCESS_LOCK, 0);
    }
pub const BNX2X_DEF_SB_ATT_IDX: c_uint = 0x0001;
pub const BNX2X_DEF_SB_IDX: c_uint = 0x0002;
#[no_mangle]
unsafe extern "C" fn bnx2x_update_dsb_idx(bp: *mut bnx2x) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_attn_int_asserted(bp: *mut bnx2x, asserted: u32) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_fan_failure(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_attn_int_deasserted0(bp: *mut bnx2x, attn: u32) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_attn_int_deasserted1(bp: *mut bnx2x, attn: u32) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_attn_int_deasserted2(bp: *mut bnx2x, attn: u32) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_attn_int_deasserted3(bp: *mut bnx2x, attn: u32) {
...
pub const BNX2X_PATH0_LOAD_CNT_MASK: c_uint = 0x000000ff;
pub const BNX2X_PATH0_LOAD_CNT_SHIFT: c_int = 0;
pub const BNX2X_PATH1_LOAD_CNT_MASK: c_uint = 0x0000ff00;
pub const BNX2X_PATH1_LOAD_CNT_SHIFT: c_int = 8;
pub const BNX2X_PATH0_RST_IN_PROG_BIT: c_uint = 0x00010000;
pub const BNX2X_PATH1_RST_IN_PROG_BIT: c_uint = 0x00020000;
pub const BNX2X_GLOBAL_RESET_BIT: c_uint = 0x00040000;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2x_set_reset_global(bp: *mut bnx2x) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_clear_reset_global(bp: *mut bnx2x) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_reset_is_global(bp: *mut bnx2x) -> bool {
    static bool bnx2x_reset_is_global(struct bnx2x *bp)
    {
    let mut val: u32 = REG_RD(bp, BNX2X_RECOVERY_GLOB_REG);
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_set_reset_done(bp: *mut bnx2x) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2x_set_reset_in_progress(bp: *mut bnx2x) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2x_reset_is_done(bp: *mut bnx2x, engine: c_int) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2x_set_pf_load(bp: *mut bnx2x) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2x_clear_pf_load(bp: *mut bnx2x) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_get_load_status(bp: *mut bnx2x, engine: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn _print_parity(bp: *mut bnx2x, reg: u32) {
    static void _print_parity(struct bnx2x *bp, u32 reg)
    {
    pr_cont(" [0x%08x] ", REG_RD(bp, reg));
    }
#[no_mangle]
unsafe extern "C" fn _print_next_block(idx: c_int, blk: *const c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2x_chk_parity_attn(bp: *mut bnx2x, global: *mut bool, print: bool) -> bool {
    bool bnx2x_chk_parity_attn(struct bnx2x *bp, bool *global, bool print)
    {
    let mut attn: attn_route = { {0} };
    let mut port: c_int = BP_PORT(bp);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_attn_int_deasserted4(bp: *mut bnx2x, attn: u32) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_attn_int_deasserted(bp: *mut bnx2x, deasserted: u32) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_attn_int(bp: *mut bnx2x) {
...
// read local copy of bits
    ...
    attn_bits_ack);
    let mut attn_state: u32 = bp.attn_state;
// look for changed bits
    let mut asserted: u32 = attn_bits & ~attn_ack & ~attn_state;
    let mut deasserted: u32 = ~attn_bits &  attn_ack &  attn_state;
    DP(NETIF_MSG_HW,
...
// handle bits that were raised
    ...
    {
    let mut igu_addr: u32 = bp.igu_base_addr;
    igu_addr += (IGU_CMD_INT_ACK_BASE + igu_sb_id)*8;
    bnx2x_igu_ack_sb_gen(bp, igu_sb_id, segment, index, op, update,
    igu_addr);
    }
#[no_mangle]
unsafe extern "C" fn bnx2x_update_eq_prod(bp: *mut bnx2x, prod: u16) {
...
// No memory barriers
    ...
    {
    let mut err: u8 = elem.message.error;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_handle_mcast_eqe(bp: *mut bnx2x) {
...
// If there are pending mcast commands - send them
    ...
    union event_ring_elem *elem)
    {
    let mut ramrod_flags: c_ulong = 0;
    let mut rc: c_int = 0;
    let mut echo: u32 = le32_to_cpu(elem.message.data.eth_event.echo);
    let mut cid: u32 = echo & BNX2X_SWCID_MASK;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_handle_rx_mode_eqe(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_after_function_update(bp: *mut bnx2x) {
    static void bnx2x_after_function_update(struct bnx2x *bp)
    {
    int q, rc;
    struct bnx2x_fastpath *fp;
    let mut queue_params: bnx2x_queue_state_params = {core::ptr::null_mut()};
...
#[no_mangle]
unsafe extern "C" fn bnx2x_eq_int(bp: *mut bnx2x) {
...
// elem CID originates from FW; actually LE
    ...
    let mut cmd: c_int = BNX2X_SP_RTNL_AFEX_F_UPDATE;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_sp_task(work: *mut work_struct) {
...
// what work needs to be performed?
    let mut status: u16 = bnx2x_update_dsb_idx(bp);
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_msix_sp_int(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
// end of slow path
#[no_mangle]
pub unsafe extern "C" fn bnx2x_drv_pulse(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_timer(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_fill(bp: *mut bnx2x, addr: u32, fill: c_int, len: u32) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_zero_fp_sb(bp: *mut bnx2x, fw_sb_id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_zero_sp_sb(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_map_sb_state_machines(index_data: *mut hc_index_data) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_def_sb(bp: *mut bnx2x) {
    static void bnx2x_init_def_sb(struct bnx2x *bp)
    {
    struct host_sp_status_block *def_sb = bp.def_status_blk;
    let mut mapping: dma_addr_t = bp.def_status_blk_mapping;
    int igu_sp_sb_index;
    int igu_seg_id;
    let mut port: c_int = BP_PORT(bp);
    let mut func: c_int = BP_FUNC(bp);
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_update_coalesce(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_sp_ring(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_eq_ring(bp: *mut bnx2x) {
...
// called with netif_addr_lock_bh()
#[no_mangle]
unsafe extern "C" fn bnx2x_set_storm_rx_mode(bp: *mut bnx2x) -> c_int {
    static int bnx2x_set_storm_rx_mode(struct bnx2x *bp)
    {
    let mut rx_mode_flags: c_ulong = 0, ramrod_flags = 0;
    let mut rx_accept_flags: c_ulong = 0, tx_accept_flags = 0;
    int rc;
    if (!NO_FCOE(bp))
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_internal_common(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_internal(bp: *mut bnx2x, load_code: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_fp_igu_sb_id(fp: *mut bnx2x_fastpath) -> u8 {
    static inline u8 bnx2x_fp_igu_sb_id(struct bnx2x_fastpath *fp)
    {
    return fp.bp.igu_base_sb + fp.index + CNIC_SUPPORT(fp.bp);
    }
#[no_mangle]
pub unsafe extern "C" fn bnx2x_fp_fw_sb_id(fp: *mut bnx2x_fastpath) -> u8 {
    static inline u8 bnx2x_fp_fw_sb_id(struct bnx2x_fastpath *fp)
    {
    return fp.bp.base_fw_ndsb + fp.index + CNIC_SUPPORT(fp.bp);
    }
#[no_mangle]
unsafe extern "C" fn bnx2x_fp_cl_id(fp: *mut bnx2x_fastpath) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_eth_fp(bp: *mut bnx2x, fp_idx: c_int) {
    static void bnx2x_init_eth_fp(struct bnx2x *bp, int fp_idx)
    {
    struct bnx2x_fastpath *fp = &bp.fp[fp_idx];
    u8 cos;
    let mut q_type: c_ulong = 0;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_tx_ring_one(txdata: *mut bnx2x_fp_txdata) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_tx_rings_cnic(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_tx_rings(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_fcoe_fp(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_nic_init_cnic(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_pre_irq_nic_init(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_post_irq_nic_init(bp: *mut bnx2x, load_code: u32) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_gunzip_init(bp: *mut bnx2x) -> c_int {
    static int bnx2x_gunzip_init(struct bnx2x *bp)
    {
    bp.gunzip_buf = dma_alloc_coherent(&bp.pdev.dev, FW_BUF_SIZE,
    &bp.gunzip_mapping, GFP_KERNEL);
    if (bp.gunzip_buf  == core::ptr::null_mut())
    goto gunzip_nomem1;
    bp.strm = kmalloc_obj(*bp.strm);
    if (bp.strm  == core::ptr::null_mut())
    goto gunzip_nomem2;
    bp.strm.workspace = vmalloc(zlib_inflate_workspacesize());
    if (bp.strm.workspace == core::ptr::null_mut())
    goto gunzip_nomem3;
    return 0;
    gunzip_nomem3:
    kfree(bp.strm);
    bp.strm = core::ptr::null_mut();
    gunzip_nomem2:
    dma_free_coherent(&bp.pdev.dev, FW_BUF_SIZE, bp.gunzip_buf,
    bp.gunzip_mapping);
    bp.gunzip_buf = core::ptr::null_mut();
    gunzip_nomem1:
    BNX2X_ERR("Cannot allocate firmware buffer for un-compression\n");
    return -ENOMEM;
    }
#[no_mangle]
unsafe extern "C" fn bnx2x_gunzip_end(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_gunzip(bp: *mut bnx2x, zbuf: *const u8, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_lb_pckt(bp: *mut bnx2x) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_int_mem_test(bp: *mut bnx2x) -> c_int {
    ...
    factor = 120;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CHIP_REV_IS_EMUL(bp)) -> else {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_enable_blocks_attention(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_reset_common(bp: *mut bnx2x) {
    static void bnx2x_reset_common(struct bnx2x *bp)
    {
    let mut val: u32 = 0x1400;
// reset_common
...
#[no_mangle]
unsafe extern "C" fn bnx2x_setup_dmae(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_pxp(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_setup_fan_failure_detection(bp: *mut bnx2x) {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(SHARED_HW_CFG_FAN_FAILURE_PHY_TYPE: val ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_pf_disable(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x__common_init_phy(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_config_endianity(bp: *mut bnx2x, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_set_endianity(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_reset_endianity(bp: *mut bnx2x) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_init_hw_common(bp: *mut bnx2x) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_init_hw_common_chip(bp: *mut bnx2x) -> c_int {
    static int bnx2x_init_hw_common_chip(struct bnx2x *bp)
    {
    let mut rc: c_int = bnx2x_init_hw_common(bp);
    if (rc)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_hw_port(bp: *mut bnx2x) -> c_int {
    static int bnx2x_init_hw_port(struct bnx2x *bp)
    {
    let mut port: c_int = BP_PORT(bp);
    let mut init_phase: c_int = port ? PHASE_PORT1 : PHASE_PORT0;
    u32 low, high;
    u32 val, reg;
...
#[no_mangle]
pub unsafe extern "C" fn if(4096: bp->dev->mtu >) -> else {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_ilt_wr(bp: *mut bnx2x, index: u32, addr: dma_addr_t) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_igu_clear_sb_gen(bp: *mut bnx2x, func: u8, idu_sb_id: u8, is_pf: bool) {
    void bnx2x_igu_clear_sb_gen(struct bnx2x *bp, u8 func, u8 idu_sb_id, bool is_pf)
    {
    u32 data, ctl, cnt = 100;
    let mut igu_addr_data: u32 = IGU_REG_COMMAND_REG_32LSB_DATA;
    let mut igu_addr_ctl: u32 = IGU_REG_COMMAND_REG_CTRL;
    let mut igu_addr_ack: u32 = IGU_REG_CSTORM_TYPE_0_SB_CLEANUP + (idu_sb_id/32)*4;
    let mut sb_bit: u32 = 1 << (idu_sb_id%32);
    let mut func_encode: u32 = func | (is_pf ? 1 : 0) << IGU_FID_ENCODE_IS_PF_SHIFT;
    let mut addr_encode: u32 = IGU_CMD_E2_PROD_UPD_BASE + idu_sb_id;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_igu_clear_sb(bp: *mut bnx2x, idu_sb_id: u8) {
    static void bnx2x_igu_clear_sb(struct bnx2x *bp, u8 idu_sb_id)
    {
    bnx2x_igu_clear_sb_gen(bp, BP_FUNC(bp), idu_sb_id, true /*PF*/);
    }
#[no_mangle]
unsafe extern "C" fn bnx2x_clear_func_ilt(bp: *mut bnx2x, func: u32) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_searcher(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_func_switch_update(bp: *mut bnx2x, suspend: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_reset_nic_mode(bp: *mut bnx2x) -> c_int {
    static int bnx2x_reset_nic_mode(struct bnx2x *bp)
    {
    int rc, i, port = BP_PORT(bp);
    let mut vlan_en: c_int = 0, mac_en[NUM_MACS];
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_init_hw_func_cnic(bp: *mut bnx2x) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_clean_pglue_errors(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_hw_func(bp: *mut bnx2x) -> c_int {
    static int bnx2x_init_hw_func(struct bnx2x *bp)
    {
    let mut port: c_int = BP_PORT(bp);
    let mut func: c_int = BP_FUNC(bp);
    let mut init_phase: c_int = PHASE_PF0 + func;
...
// Set NIC mode
    ...
    if (!CHIP_IS_E1x(bp)) {
    let mut pf_conf: u32 = IGU_PF_CONF_FUNC_EN;
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_free_mem_cnic(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_free_mem(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_alloc_mem_cnic(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_alloc_mem(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_clear_vlan_info(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_del_all_vlans(bp: *mut bnx2x) -> c_int {
    static int bnx2x_del_all_vlans(struct bnx2x *bp)
    {
    struct bnx2x_vlan_mac_obj *vlan_obj = &bp.sp_objs[0].vlan_obj;
    let mut ramrod_flags: c_ulong = 0, vlan_flags = 0;
    int rc;
    ...
    {
    int rc;
    let mut ramrod_flags: c_ulong = 0, vlan_mac_flags = 0;
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_set_eth_mac(bp: *mut bnx2x, set: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_setup_leading(bp: *mut bnx2x) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2x_set_int_mode(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_cid_ilt_lines(bp: *mut bnx2x) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_ilt_set_info(bp: *mut bnx2x) {
...
//
    ...
    bool leading)
    {
    let mut q_params: bnx2x_queue_state_params = {core::ptr::null_mut()};
...
#[no_mangle]
unsafe extern "C" fn bnx2x_stop_queue(bp: *mut bnx2x, index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_reset_func(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_reset_port(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_reset_hw(bp: *mut bnx2x, load_code: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_func_stop(bp: *mut bnx2x) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2x_send_unload_req(bp: *mut bnx2x, unload_mode: c_int) -> u32 {
    u32 bnx2x_send_unload_req(struct bnx2x *bp, int unload_mode)
    {
    let mut reset_code: u32 = 0;
    let mut port: c_int = BP_PORT(bp);
// Select the UNLOAD request mode
    if (unload_mode == UNLOAD_NORMAL)
    reset_code = DRV_MSG_CODE_UNLOAD_REQ_WOL_DIS;
#[no_mangle]
pub unsafe extern "C" fn if(NO_WOL_FLAG: bp->flags &) -> else {
    else if (bp.flags & NO_WOL_FLAG)
    reset_code = DRV_MSG_CODE_UNLOAD_REQ_WOL_MCP;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: bp->wol) -> else {
    let mut emac_base: u32 = port ? GRCBASE_EMAC1 : GRCBASE_EMAC0;
...
#[no_mangle]
pub unsafe extern "C" fn if(0: bnx2x_load_count[path][1 + port] ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2x_send_unload_done(bp: *mut bnx2x, keep_link: bool) {
    void bnx2x_send_unload_done(struct bnx2x *bp, bool keep_link)
    {
    let mut reset_param: u32 = keep_link ? DRV_MSG_CODE_UNLOAD_SKIP_LINK_RESET : 0;
// Report UNLOAD_DONE to MCP
    if (!BP_NOMCP(bp))
    bnx2x_fw_command(bp, DRV_MSG_CODE_UNLOAD_DONE, reset_param);
    }
#[no_mangle]
unsafe extern "C" fn bnx2x_func_wait_started(bp: *mut bnx2x) -> c_int {
    static int bnx2x_func_wait_started(struct bnx2x *bp)
    {
    let mut tout: c_int = 50;
    let mut msix: c_int = (bp.flags & USING_MSIX_FLAG) ? 1 : 0;
    if (!bp.port.pmf)
    return 0;
//
...
#[no_mangle]
unsafe extern "C" fn bnx2x_disable_ptp(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_stop_ptp(bp: *mut bnx2x) {
...
//
    ...
    bp.ptp_tx_skb = core::ptr::null_mut();
    }
// Disable PTP in HW
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_chip_cleanup(bp: *mut bnx2x, unload_mode: c_int, keep_link: bool) {
    void bnx2x_chip_cleanup(struct bnx2x *bp, int unload_mode, bool keep_link)
    {
    let mut port: c_int = BP_PORT(bp);
    int i, rc = 0;
    u8 cos;
    let mut rparam: bnx2x_mcast_ramrod_params = {core::ptr::null_mut()};
    u32 reset_code;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: bp->slowpath) -> else {
    else if (bp.slowpath)
    bnx2x_set_storm_rx_mode(bp);
...
//
    ...
    bp.ptp_clock = core::ptr::null_mut();
    }
    }
    if (!bp.nic_stopped) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_disable_close_the_gate(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_set_234_gates(bp: *mut bnx2x, close: bool) {
...
pub const SHARED_MF_CLP_MAGIC: c_uint = 0x80000000 /* `magic' bit */;
#[no_mangle]
unsafe extern "C" fn bnx2x_clp_reset_prep(bp: *mut bnx2x, magic_val: *mut u32) {
    static void bnx2x_clp_reset_prep(struct bnx2x *bp, u32 *magic_val)
    {
// Do some magic...
    let mut val: u32 = MF_CFG_RD(bp, shared_mf_config.clp_mb);
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_clp_reset_done(bp: *mut bnx2x, magic_val: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_reset_mcp_prep(bp: *mut bnx2x, magic_val: *mut u32) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_mcp_wait_one(bp: *mut bnx2x) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_init_shmem(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_reset_mcp_comp(bp: *mut bnx2x, magic_val: u32) -> c_int {
    static int bnx2x_reset_mcp_comp(struct bnx2x *bp, u32 magic_val)
    {
    let mut rc: c_int = bnx2x_init_shmem(bp);
// Restore the `magic' bit value
    if (!CHIP_IS_E1(bp))
...
#[no_mangle]
unsafe extern "C" fn bnx2x_pxp_prep(bp: *mut bnx2x) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_process_kill_chip_reset(bp: *mut bnx2x, global: bool) {
...
// Full reset masks according to the chip
    ...
    reset_mask2 = 0xffff;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CHIP_IS_E1H(bp)) -> else {
    else if (CHIP_IS_E1H(bp))
    reset_mask2 = 0x1ffff;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CHIP_IS_E2(bp)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_er_poll_igu_vq(bp: *mut bnx2x) -> c_int {
    static int bnx2x_er_poll_igu_vq(struct bnx2x *bp)
    {
    let mut cnt: u32 = 1000;
    let mut pend_bits: u32 = 0;
    do {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_process_kill(bp: *mut bnx2x, global: bool) -> c_int {
    static int bnx2x_process_kill(struct bnx2x *bp, bool global)
    {
    let mut cnt: c_int = 1000;
    let mut val: u32 = 0;
    u32 sr_cnt, blk_cnt, port_is_idle_0, port_is_idle_1, pgl_exp_rom2;
    let mut tags_63_32: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_leader_reset(bp: *mut bnx2x) -> c_int {
    static int bnx2x_leader_reset(struct bnx2x *bp)
    {
    let mut rc: c_int = 0;
    let mut global: bool = bnx2x_reset_is_global(bp);
    u32 load_code;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_recovery_failed(bp: *mut bnx2x) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_parity_recover(bp: *mut bnx2x) {
...
//
    ...
    if (bp.is_leader) {
    let mut other_engine: c_int = BP_PATH(bp) ? 0 : 1;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_udp_port_update(bp: *mut bnx2x) -> c_int {
    static int bnx2x_udp_port_update(struct bnx2x *bp)
    {
    struct bnx2x_func_switch_update_params *switch_update_params;
    let mut func_params: bnx2x_func_state_params = {core::ptr::null_mut()};
    let mut vxlan_port: u16 = 0, geneve_port = 0;
    int rc;
    switch_update_params = &func_params.params.switch_update;
// Prepare parameters for function state transitions
    __set_bit(RAMROD_COMP_WAIT, &func_params.ramrod_flags);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_udp_tunnel_sync(netdev: *mut net_device, table: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_sp_rtnl_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_period_task(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_get_pretend_reg(bp: *mut bnx2x) -> u32 {
    static u32 bnx2x_get_pretend_reg(struct bnx2x *bp)
    {
    let mut base: u32 = PXP2_REG_PGL_PRETEND_FUNC_F0;
    let mut stride: u32 = PXP2_REG_PGL_PRETEND_FUNC_F1 - base;
    ...
    {
    let mut mask: u32 = MISC_REGISTERS_RESET_REG_2_UMAC0 << port;
    u32 base_addr;
    if (!(mask & reset_reg))
    return false;
    ...
    let mut mac_stopped: bool = false;
    let mut port: u8 = BP_PORT(bp);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_prev_is_after_undi(bp: *mut bnx2x) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_prev_unload_undi_inc(bp: *mut bnx2x, inc: u8) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_prev_mcp_done(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_prev_path_mark_eeh(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_prev_is_path_marked(bp: *mut bnx2x) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_port_after_undi(bp: *mut bnx2x) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_prev_mark_path(bp: *mut bnx2x, after_undi: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_do_flr(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_prev_unload_uncommon(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_prev_unload_common(bp: *mut bnx2x) -> c_int {
    static int bnx2x_prev_unload_common(struct bnx2x *bp)
    {
    u32 reset_reg, tmp_reg = 0, rc;
    let mut prev_undi: bool = false;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_prev_unload(bp: *mut bnx2x) -> c_int {
    static int bnx2x_prev_unload(struct bnx2x *bp)
    {
    let mut time_counter: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_common_hwinfo(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CHIP_IS_57810_MF(bp)) -> else {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_igu_cam_info(bp: *mut bnx2x) -> c_int {
    static int bnx2x_get_igu_cam_info(struct bnx2x *bp)
    {
    let mut pfid: c_int = BP_FUNC(bp);
    int igu_sb_id;
    u32 val;
    u8 fid, igu_sb_cnt = 0;
    bp.igu_base_sb = 0xff;
    if (CHIP_INT_MODE_IS_BC(bp)) {
    let mut vn: c_int = BP_VN(bp);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_link_settings_supported(bp: *mut bnx2x, switch_cfg: u32) {
    static void bnx2x_link_settings_supported(struct bnx2x *bp, u32 switch_cfg)
    {
    let mut cfg_size: c_int = 0, idx, port = BP_PORT(bp);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_link_settings_requested(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_set_mac_buf(mac_buf: *mut u8, mac_lo: u32, mac_hi: u16) {
    static void bnx2x_set_mac_buf(u8 *mac_buf, u32 mac_lo, u16 mac_hi)
    {
    let mut mac_hi_be: __be16 = cpu_to_be16(mac_hi);
    let mut mac_lo_be: __be32 = cpu_to_be32(mac_lo);
    memcpy(mac_buf, &mac_hi_be, sizeof(mac_hi_be));
    memcpy(mac_buf + sizeof(mac_hi_be), &mac_lo_be, sizeof(mac_lo_be));
    }
#[no_mangle]
unsafe extern "C" fn bnx2x_get_port_hwinfo(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_get_iscsi_info(bp: *mut bnx2x) {
    void bnx2x_get_iscsi_info(struct bnx2x *bp)
    {
    let mut no_flags: u32 = NO_ISCSI_FLAG;
    let mut port: c_int = BP_PORT(bp);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_ext_wwn_info(bp: *mut bnx2x, func: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_shared_fcoe_funcs(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_fcoe_info(bp: *mut bnx2x) {
    ...
    drv_lic_key[port].max_fcoe_conn);
    let mut num_fcoe_func: u8 = bnx2x_shared_fcoe_funcs(bp);
    if (!CNIC_SUPPORT(bp)) {
    bp.flags |= NO_FCOE_FLAG;
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_cnic_info(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_cnic_mac_hwinfo(bp: *mut bnx2x) {
...
//
    if (!IS_MF_SD(bp)) {
    let mut cfg: u32 = MF_CFG_RD(bp, func_ext_config[func].func_cfg);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_mac_hwinfo(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_dropless_info(bp: *mut bnx2x) -> bool {
...
#[no_mangle]
unsafe extern "C" fn validate_set_si_mode(bp: *mut bnx2x) {
    static void validate_set_si_mode(struct bnx2x *bp)
    {
    let mut func: u8 = BP_ABS_FUNC(bp);
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_hwinfo(bp: *mut bnx2x) -> c_int {
    static int bnx2x_get_hwinfo(struct bnx2x *bp)
    {
    int /*abs*/func = BP_ABS_FUNC(bp);
    int vn;
    let mut val: u32 = 0, val2 = 0;
    let mut rc: c_int = 0;
...
// get OV configuration
    ...
    let mut mtu_idx: c_int = BP_FW_MB_IDX(bp);
    u16 mtu_size;
    u32 mtu;
...
//
    ...
    let mut other_port: u8 = !BP_PORT(bp);
    let mut other_func: u8 = BP_PATH(bp) + 2*other_port;
    val = MF_CFG_RD(bp,
...
#[no_mangle]
unsafe extern "C" fn bnx2x_read_fwinfo(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_set_modes_bitmap(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CHIP_IS_E3(bp)) -> else {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_bp(bp: *mut bnx2x) -> c_int {
...
// multiple tx priority
    ...
    bp.max_cos = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CHIP_IS_E1x(bp)) -> else {
    else if (CHIP_IS_E1x(bp))
    bp.max_cos = BNX2X_MULTI_TX_COS_E1X;
#[no_mangle]
pub unsafe extern "C" fn if(CHIP_IS_E3A0(bp): CHIP_IS_E2(bp) ||) -> else {
    else if (CHIP_IS_E2(bp) || CHIP_IS_E3A0(bp))
    bp.max_cos = BNX2X_MULTI_TX_COS_E2_E3A0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CHIP_IS_E3B0(bp)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CNIC_SUPPORT(bp)) -> else {
...
// called with rtnl_lock
#[no_mangle]
unsafe extern "C" fn bnx2x_open(dev: *mut net_device) -> c_int {
...
// called with rtnl_lock
#[no_mangle]
unsafe extern "C" fn bnx2x_close(dev: *mut net_device) -> c_int {
    static int bnx2x_close(struct net_device *dev)
    {
    struct bnx2x *bp = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_free_mcast_macs_list(mcast_group_list: *mut list_head) {
    ...
    struct bnx2x_mcast_list_elem_group *current_mcast_group = core::ptr::null_mut();
    let mut mc_count: c_int = netdev_mc_count(bp.dev);
    let mut offset: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_set_uc_list(bp: *mut bnx2x) -> c_int {
...
// Execute the pending commands
    __set_bit(RAMROD_CONT, &ramrod_flags);
    return bnx2x_set_mac_one(bp, core::ptr::null_mut(), mac_obj, false /* don't care */,
    BNX2X_UC_LIST_MAC, &ramrod_flags);
    }
#[no_mangle]
unsafe extern "C" fn bnx2x_set_mc_list_e1x(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_set_mc_list(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_set_rx_mode(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_set_rx_mode_inner(bp: *mut bnx2x) {
    void bnx2x_set_rx_mode_inner(struct bnx2x *bp)
    {
    let mut rx_mode: u32 = BNX2X_RX_MODE_NORMAL;
...
// called with rtnl_lock
#[no_mangle]
unsafe extern "C" fn bnx2x_ioctl(dev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_validate_addr(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __bnx2x_vlan_configure_vid(bp: *mut bnx2x, vid: u16, add: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_vlan_configure_vid_list(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_vlan_configure(bp: *mut bnx2x, set_rx_mode: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_vlan_reconfigure_vid(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_vlan_rx_add_vid(dev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_vlan_rx_kill_vid(dev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_check_firmware(bp: *mut bnx2x) -> c_int {
...
// Likewise for the init_ops offsets
    ...
    ops_offsets = ( __be16 *)(firmware.data + offset);
...
#[no_mangle]
unsafe extern "C" fn be32_to_cpu_n(_source: *const u8, _target: *mut u8, n: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_prep_ops(_source: *const u8, _target: *mut u8, n: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_prep_iro(_source: *const u8, _target: *mut u8, n: u32) {
...
#[no_mangle]
unsafe extern "C" fn be16_to_cpu_n(_source: *const u8, _target: *mut u8, n: u32) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_firmware(bp: *mut bnx2x) -> c_int {
...
// IRO
    ...
    bp.init_ops_offsets = core::ptr::null_mut();
    init_offsets_alloc_err:
    kfree(bp.init_ops);
    bp.init_ops = core::ptr::null_mut();
    init_ops_alloc_err:
    kfree(bp.init_data);
    bp.init_data = core::ptr::null_mut();
    request_firmware_exit:
    release_firmware(bp.firmware);
    bp.firmware = core::ptr::null_mut();
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn bnx2x_release_firmware(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x__init_func_obj(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_set_qm_cid_count(bp: *mut bnx2x) -> c_int {
    static int bnx2x_set_qm_cid_count(struct bnx2x *bp)
    {
    let mut cid_count: c_int = BNX2X_L2_MAX_CID(bp);
    if (IS_SRIOV(bp))
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_get_num_non_def_sbs(pdev: *mut pci_dev, cnic_cnt: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_max_cos_est(chip_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_is_vf(chip_id: c_int) -> c_int {
...
pub const tsgen_ctrl: c_uint = 0x0;
pub const tsgen_freecount: c_uint = 0x10;
pub const tsgen_synctime_t0: c_uint = 0x20;
pub const tsgen_offset_t0: c_uint = 0x28;
pub const tsgen_drift_t0: c_uint = 0x30;
pub const tsgen_synctime_t1: c_uint = 0x58;
pub const tsgen_offset_t1: c_uint = 0x60;
pub const tsgen_drift_t1: c_uint = 0x68;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_ptp_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
    static int bnx2x_ptp_adjfine(struct ptp_clock_info *ptp, long scaled_ppm)
    {
    struct bnx2x *bp = container_of(ptp, struct bnx2x, ptp_clock_info);
    int rc;
    let mut drift_dir: c_int = 1;
    int val, period, period1, period2, dif, dif1, dif2;
    let mut best_dif: c_int = BNX2X_MAX_PHC_DRIFT, best_period = 0, best_val = 0;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_ptp_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_ptp_gettime(ptp: *mut ptp_clock_info, ts: *mut timespec64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_register_phc(bp: *mut bnx2x) {
...
//
    if (is_kdump_kernel()) {
    let mut now: ktime_t = ktime_get_boottime();
    let mut fw_ready_time: ktime_t = ktime_set(5, 0);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_eeh_nic_unload(bp: *mut bnx2x) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_io_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_io_resume(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init() -> int __init {
    static int __init bnx2x_init(void)
    {
    int ret;
    bnx2x_wq = create_singlethread_workqueue("bnx2x");
    if (bnx2x_wq == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_cleanup() -> void __exit {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_notify_link_changed(bp: *mut bnx2x) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_set_iscsi_eth_mac_addr(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_cnic_sp_post(bp: *mut bnx2x, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_cnic_ctl_send(bp: *mut bnx2x, ctl: *mut cnic_ctl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_cnic_ctl_send_bh(bp: *mut bnx2x, ctl: *mut cnic_ctl_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2x_cnic_notify(bp: *mut bnx2x, cmd: c_int) -> c_int {
    int bnx2x_cnic_notify(struct bnx2x *bp, int cmd)
    {
    let mut ctl: cnic_ctl_info = {0};
    ctl.cmd = cmd;
    return bnx2x_cnic_ctl_send(bp, &ctl);
    }
#[no_mangle]
unsafe extern "C" fn bnx2x_cnic_cfc_comp(bp: *mut bnx2x, cid: c_int, err: u8) {
    static void bnx2x_cnic_cfc_comp(struct bnx2x *bp, int cid, u8 err)
    {
    let mut ctl: cnic_ctl_info = {0};
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_set_iscsi_eth_rx_mode(bp: *mut bnx2x, start: bool) {
    static void bnx2x_set_iscsi_eth_rx_mode(struct bnx2x *bp, bool start)
    {
    let mut accept_flags: c_ulong = 0, ramrod_flags = 0;
    let mut cl_id: u8 = bnx2x_cnic_eth_cl_id(bp, BNX2X_ISCSI_ETH_CL_ID_IDX);
    let mut sched_state: c_int = BNX2X_FILTER_ISCSI_ETH_STOP_SCHED;
    if (start) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_drv_ctl(dev: *mut net_device, ctl: *mut drv_ctl_info) -> c_int {
    ...
    let mut index: u32 = ctl.data.io.offset;
    let mut addr: dma_addr_t = ctl.data.io.dma_addr;
    bnx2x_ilt_wr(bp, index, addr);
    break;
    }
    case DRV_CTL_RET_L5_SPQ_CREDIT_CMD: {
    let mut count: c_int = ctl.data.credit.credit_count;
...
// Unset iSCSI L2 MAC
    ...
    let mut ulp_type: c_int = ctl.data.register_data.ulp_type;
    if (CHIP_IS_E3(bp)) {
    let mut idx: c_int = BP_FW_MB_IDX(bp);
    let mut cap: u32 = SHMEM2_RD(bp, drv_capabilities_flag[idx]);
    let mut path: c_int = BP_PATH(bp);
    let mut port: c_int = BP_PORT(bp);
    int i;
    u32 scratch_offset;
...
#[no_mangle]
pub unsafe extern "C" fn if(CNIC_ULP_FCOE: ulp_type ==) -> else {
...
// (host_addr + i/4));
    ...
    let mut ulp_type: c_int = ctl.data.ulp_type;
    if (CHIP_IS_E3(bp)) {
    let mut idx: c_int = BP_FW_MB_IDX(bp);
    u32 cap;
...
// For storage-only interfaces, change driver state
    ...
    {
    struct bnx2x *bp = netdev_priv(dev);
    struct bdn_fc_npiv_tbl *tbl = core::ptr::null_mut();
    u32 offset, entries;
...
//
    ...
    entries = ( u32)be32_to_cpu(( __be32)entries);
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_setup_cnic_irq_info(bp: *mut bnx2x) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_setup_cnic_info(bp: *mut bnx2x) {
    ...
    BNX2X_ERR("core::ptr::null_mut() ops received\n");
    return -EINVAL;
    }
    if (!CNIC_SUPPORT(bp)) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_unregister_cnic(dev: *mut net_device) -> c_int {
    ...
    mutex_lock(&bp.cnic_mutex);
    cp.drv_state = 0;
    RCU_INIT_POINTER(bp.cnic_ops, core::ptr::null_mut());
    mutex_unlock(&bp.cnic_mutex);
    synchronize_rcu();
    bp.cnic_enabled = false;
    kfree(bp.cnic_kwq);
    bp.cnic_kwq = core::ptr::null_mut();
    return 0;
    }
    static struct cnic_eth_dev *bnx2x_cnic_probe(struct net_device *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_rx_ustorm_prods_offset(fp: *mut bnx2x_fastpath) -> u32 {
    static u32 bnx2x_rx_ustorm_prods_offset(struct bnx2x_fastpath *fp)
    {
    struct bnx2x *bp = fp.bp;
    let mut offset: u32 = BAR_USTRORM_INTMEM;
    if (IS_VF(bp))
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2x_pretend_func(bp: *mut bnx2x, pretend_func_val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_ptp_task(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_set_rx_ts(bp: *mut bnx2x, skb: *mut sk_buff) {
...
// Read the PHC
#[no_mangle]
unsafe extern "C" fn bnx2x_cyclecounter_read(cc: *mut cyclecounter) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_init_cyclecounter(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_send_reset_timesync_ramrod(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_enable_ptp_packets(bp: *mut bnx2x) -> c_int {
...
pub const BNX2X_P2P_DETECT_PARAM_MASK: c_uint = 0x5F5;
pub const BNX2X_P2P_DETECT_RULE_MASK: c_uint = 0x3DBB;

#[no_mangle]
pub unsafe extern "C" fn bnx2x_configure_ptp_filters(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_configure_ptp(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_init_ptp(bp: *mut bnx2x) {
