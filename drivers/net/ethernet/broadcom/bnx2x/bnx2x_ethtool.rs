...
//! Source: drivers/net/ethernet/broadcom/bnx2x/bnx2x_ethtool.c
#![no_std]
...
//
pub const MAX_QUEUE_NAME_LEN: c_int = 4;
    static const struct {
    long offset;
    int size;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_port_type(bp: *mut bnx2x) -> c_int {
    static int bnx2x_get_port_type(struct bnx2x *bp)
    {
    int port_type;
    let mut phy_idx: u32 = bnx2x_get_cur_phy_idx(bp);
    ...
    {
    struct bnx2x *bp = netdev_priv(dev);
    let mut cfg_idx: c_int = bnx2x_get_link_cfg_idx(bp);
    u32 media_type;
...
// Publish LP advertised speeds and FC
    ...
    let mut status: u32 = bp.link_vars.link_status;
...
// If received a request for an unknown duplex, assume full
    ...
    if (IS_MF_SI(bp)) {
    u32 part;
    let mut line_speed: u32 = bp.link_vars.line_speed;
...
// Restore old config in case command failed
    ...
    let mut an_supported_speed: u32 = bp.port.supported[cfg_idx];
...
pub const DUMP_ALL_PRESETS: c_uint = 0x1FFF;
pub const DUMP_MAX_PRESETS: c_int = 13;
#[no_mangle]
unsafe extern "C" fn __bnx2x_get_preset_regs_len(bp: *mut bnx2x, preset: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CHIP_IS_E3A0(bp)) -> else {
...
#[no_mangle]
unsafe extern "C" fn __bnx2x_get_regs_len(bp: *mut bnx2x) -> c_int {
    static int __bnx2x_get_regs_len(struct bnx2x *bp)
    {
    u32 preset_idx;
    let mut regdump_len: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_regs_len(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __bnx2x_get_page_reg_num(bp: *mut bnx2x) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __bnx2x_get_page_write_num(bp: *mut bnx2x) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __bnx2x_get_page_read_num(bp: *mut bnx2x) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_read_pages_regs(bp: *mut bnx2x, p: *mut u32, preset: u32) {
...
// number of paged registers
    let mut num_pages: c_int = __bnx2x_get_page_reg_num(bp);
// write addresses
    const u32 *write_addr = __bnx2x_get_page_write_ar(bp);
// number of write addresses
    let mut write_num: c_int = __bnx2x_get_page_write_num(bp);
// read addresses info
    const struct reg_addr *read_addr = __bnx2x_get_page_read_ar(bp);
// number of read addresses
    let mut read_num: c_int = __bnx2x_get_page_read_num(bp);
    u32 addr, size;
...
#[no_mangle]
unsafe extern "C" fn __bnx2x_get_preset_regs(bp: *mut bnx2x, p: *mut u32, preset: u32) -> c_int {
    static int __bnx2x_get_preset_regs(struct bnx2x *bp, u32 *p, u32 preset)
    {
    u32 i, j, addr;
    const struct wreg_addr *wreg_addr_p = core::ptr::null_mut();
    if (CHIP_IS_E1(bp))
...
#[no_mangle]
unsafe extern "C" fn __bnx2x_get_regs(bp: *mut bnx2x, p: *mut u32) {
...
// Skip presets with IOR
    ...
    u32 *p = _p;
    struct bnx2x *bp = netdev_priv(dev);
    let mut dump_hdr: dump_header = {0};
    regs.version = 2;
    memset(p, 0, regs.len);
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_preset_regs_len(dev: *mut net_device, preset: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_set_dump(dev: *mut net_device, val: *mut ethtool_dump) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_set_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_msglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_set_msglevel(dev: *mut net_device, level: u32) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_nway_reset(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_link(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_eeprom_len(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_acquire_nvram_lock(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_release_nvram_lock(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_enable_nvram_access(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_disable_nvram_access(bp: *mut bnx2x) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_is_nvm_accessible(bp: *mut bnx2x) -> bool {
    ...
    (!rc && ((pm & PCI_PM_CTRL_STATE_MASK) != ( u16)PCI_D0)))
    return false;
    return true;
    }
...
// parameters already validated in ethtool_get_eeprom
    ...
    {
    struct bnx2x *bp = netdev_priv(dev);
    let mut rc: c_int = -EINVAL, phy_idx;
    u8 *user_data = data;
    let mut start_addr: c_uint = ee.offset, xfer_size = 0;
    if (!bnx2x_is_nvm_accessible(bp)) {
    DP(BNX2X_MSG_ETHTOOL | BNX2X_MSG_NVM,
    "cannot access eeprom when the interface is down\n");
    return -EAGAIN;
...
// enable access to nvram interface
    ...
    cmd_flags |= MCPR_NVM_COMMAND_LAST;
#[no_mangle]
pub unsafe extern "C" fn if(0: ((offset + 4) % BNX2X_NVRAM_PAGE_SIZE) ==) -> else {
    else if (((offset + 4) % BNX2X_NVRAM_PAGE_SIZE) == 0)
    cmd_flags |= MCPR_NVM_COMMAND_LAST;
#[no_mangle]
pub unsafe extern "C" fn if(0: (offset % BNX2X_NVRAM_PAGE_SIZE) ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: BNX2X_NUM_RX_QUEUES(bp)) -> else {
    ...
    {
    struct bnx2x *bp = netdev_priv(dev);
    let mut cfg_idx: u32 = bnx2x_get_link_cfg_idx(bp);
    if (IS_MF(bp))
    return 0;
    DP(BNX2X_MSG_ETHTOOL, "ethtool_pauseparam: cmd %d\n"
    "  autoneg %d  rx_pause %d  tx_pause %d\n",
...
#[no_mangle]
unsafe extern "C" fn bnx2x_eee_to_linkmode(mode: *mut c_ulong, eee_adv: u32) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_linkmode_to_eee(mode: *const c_ulong, shift: u32) -> u32 {
    static u32 bnx2x_linkmode_to_eee(const unsigned long *mode, u32 shift)
    {
    let mut eee_adv: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_eee(dev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_set_eee(dev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_test_registers(bp: *mut bnx2x) -> c_int {
    static int bnx2x_test_registers(struct bnx2x *bp)
    {
    int idx, i, rc = -ENODEV;
    let mut wr_val: u32 = 0, hw;
    let mut port: c_int = BP_PORT(bp);
    static const struct {
    u32 hw;
    u32 offset0;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_test_memory(bp: *mut bnx2x) -> c_int {
    ...
    {0x3ffc1, 0,   0, 0} },
    { core::ptr::null_mut(), 0xffffffff, {0, 0, 0, 0} }
    };
    if (!bnx2x_is_nvm_accessible(bp)) {
    DP(BNX2X_MSG_ETHTOOL | BNX2X_MSG_NVM,
    "cannot access eeprom when the interface is down\n");
...
#[no_mangle]
unsafe extern "C" fn bnx2x_wait_for_link(bp: *mut bnx2x, link_up: u8, is_serdes: u8) {
    static void bnx2x_wait_for_link(struct bnx2x *bp, u8 link_up, u8 is_serdes)
    {
    let mut cnt: c_int = 1400;
    if (link_up) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_run_loopback(bp: *mut bnx2x, loopback_mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_test_loopback(bp: *mut bnx2x) -> c_int {
    static int bnx2x_test_loopback(struct bnx2x *bp)
    {
    let mut rc: c_int = 0, res;
    if (BP_NOMCP(bp))
    return rc;
    if (!netif_running(bp.dev))
...
#[no_mangle]
unsafe extern "C" fn bnx2x_test_ext_loopback(bp: *mut bnx2x) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct code_entry {
    pub sram_start_addr: u32,
    pub code_attribute: u32,
pub const CODE_IMAGE_TYPE_MASK: c_uint = 0xf0800003;
pub const CODE_IMAGE_VNTAG_PROFILES_DATA: c_uint = 0xd0000003;
pub const CODE_IMAGE_LENGTH_MASK: c_uint = 0x007ffffc;
pub const CODE_IMAGE_TYPE_EXTENDED_DIR: c_uint = 0xe0000000;
    pub nvm_start_addr: u32,
}

pub const CODE_ENTRY_MAX: c_int = 16;
pub const CODE_ENTRY_EXTENDED_DIR_IDX: c_int = 15;
pub const MAX_IMAGES_IN_EXTENDED_DIR: c_int = 64;
pub const NVRAM_DIR_OFFSET: c_uint = 0x14;

    ((code & CODE_IMAGE_TYPE_MASK) == CODE_IMAGE_TYPE_EXTENDED_DIR && \
    (code & CODE_IMAGE_LENGTH_MASK) != 0)
pub const CRC32_RESIDUAL: c_uint = 0xdebb20e3;
pub const CRC_BUFF_SIZE: c_int = 256;
    ...
    {
    let mut crc: u32 = ~0;
    let mut rc: c_int = 0, done = 0;
    DP(BNX2X_MSG_ETHTOOL | BNX2X_MSG_NVM,
    "NVRAM CRC from 0x%08x to 0x%08x\n", offset, offset + size);
    while (done < size) {
    let mut count: c_int = min_t(int, size - done, CRC_BUFF_SIZE);
    ...
    u8 *buff)
    {
    let mut size: usize = entry.code_attribute & CODE_IMAGE_LENGTH_MASK;
    let mut type: u32 = entry.code_attribute & CODE_IMAGE_TYPE_MASK;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_test_dir_entry(bp: *mut bnx2x, addr: u32, buff: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_test_nvram_ext_dirs(bp: *mut bnx2x, buff: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_test_nvram_dirs(bp: *mut bnx2x, buff: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_test_nvram(bp: *mut bnx2x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_test_intr(bp: *mut bnx2x) -> c_int {
    static int bnx2x_test_intr(struct bnx2x *bp)
    {
    let mut params: bnx2x_queue_state_params = {core::ptr::null_mut()};
    if (!netif_running(bp.dev)) {
    DP(BNX2X_MSG_ETHTOOL | BNX2X_MSG_NVM,
    "cannot access eeprom when the interface is down\n");
    return -ENODEV;
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_num_stat_queues(bp: *mut bnx2x) -> c_int {
    static int bnx2x_num_stat_queues(struct bnx2x *bp)
    {
    return BNX2X_NUM_ETH_QUEUES(bp);
    }
#[no_mangle]
unsafe extern "C" fn bnx2x_get_sset_count(dev: *mut net_device, stringset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_private_flags(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_strings(dev: *mut net_device, stringset: u32, buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_rx_ring_count(dev: *mut net_device) -> u32 {
...
// For UDP either 2-tupple hash or 4-tupple hash is supported
    ...
    udp_rss_requested = 1;
#[no_mangle]
pub unsafe extern "C" fn if(RXH_IP_DST): info->data == (RXH_IP_SRC |) -> else {
...
#[no_mangle]
unsafe extern "C" fn bnx2x_get_rxfh_indir_size(dev: *mut net_device) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2x_change_num_queues(bp: *mut bnx2x, num_rss: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2x_set_ethtool_ops(bp: *mut bnx2x, netdev: *mut net_device) {
