...
//! Source: drivers/net/ethernet/broadcom/bnx2x/bnx2x_self_test.c
#![no_std]
...
pub const NA: c_uint = 0xCD;
pub const IDLE_CHK_E1: c_uint = 0x01;
pub const IDLE_CHK_E1H: c_uint = 0x02;
pub const IDLE_CHK_E2: c_uint = 0x04;
pub const IDLE_CHK_E3A0: c_uint = 0x08;
pub const IDLE_CHK_E3B0: c_uint = 0x10;
pub const IDLE_CHK_ERROR: c_int = 1;
pub const IDLE_CHK_ERROR_NO_TRAFFIC: c_int = 2;
pub const IDLE_CHK_WARNING: c_int = 3;
pub const MAX_FAIL_MSG: c_int = 256;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st_pred_args {
    pub /: *mut *mut u32 val1; / value read from first register,
    pub /: *mut *mut u32 val2; / value read from second register, if applicable,
    pub /: *mut *mut u32 imm1; / 1st value in predicate condition, left-to-right,
    pub /: *mut *mut u32 imm2; / 2nd value in predicate condition, left-to-right,
    pub /: *mut *mut u32 imm3; / 3rd value in predicate condition, left-to-right,
    pub /: *mut *mut u32 imm4; / 4th value in predicate condition, left-to-right,
}

// struct representing self test record - a single test
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st_record {
    pub chip_mask: u8,
    pub macro: u8,
    pub reg1: u32,
    pub reg2: u32,
    pub loop: u16,
    pub incr: u16,
    pub pred_args): *mut *mut int (bnx2x_predicate)(struct st_pred_args,
    pub reg3: u32,
    pub severity: u8,
    pub fail_msg: *mut c_char,
    pub pred_args: st_pred_args,
}

// predicates for self test
#[no_mangle]
unsafe extern "C" fn peq(args: *mut st_pred_args) -> c_int {
    static int peq(struct st_pred_args *args)
    {
    return (args.val1 == args.imm1);
    }
#[no_mangle]
unsafe extern "C" fn pneq(args: *mut st_pred_args) -> c_int {
    static int pneq(struct st_pred_args *args)
    {
    return (args.val1 != args.imm1);
    }
#[no_mangle]
unsafe extern "C" fn pand_neq(args: *mut st_pred_args) -> c_int {
    static int pand_neq(struct st_pred_args *args)
    {
    return ((args.val1 & args.imm1) != args.imm2);
    }
#[no_mangle]
unsafe extern "C" fn pand_neq_x2(args: *mut st_pred_args) -> c_int {
...
pub const ST_DB_LINES: c_int = 468;
...
#[no_mangle]
unsafe extern "C" fn bnx2x_self_test_log(bp: *mut bnx2x, severity: u8, message: *mut c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2x_idle_chk(bp: *mut bnx2x) -> c_int {
