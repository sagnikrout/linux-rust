...
//! Source: drivers/net/ethernet/broadcom/bnxt/bnxt_ulp.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bnxt_aux_device {
    pub name: *const c_char,
}

#[no_mangle]
unsafe extern "C" fn bnxt_auxdev_set_state(bp: *mut bnxt, idx: c_int, state: c_int) {
    static void bnxt_auxdev_set_state(struct bnxt *bp, int idx, int state)
    {
    bp.auxdev_state[idx] = state;
    }
#[no_mangle]
unsafe extern "C" fn bnxt_auxdev_is_init(bp: *mut bnxt, idx: c_int) -> bool {
    static bool bnxt_auxdev_is_init(struct bnxt *bp, int idx)
    {
    return (bp.auxdev_state[idx] == BNXT_ADEV_STATE_INIT);
    }
#[no_mangle]
unsafe extern "C" fn bnxt_auxdev_is_active(bp: *mut bnxt, idx: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bnxt_fill_msix_vecs(bp: *mut bnxt, ent: *mut bnxt_msix_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_get_ulp_msix_num(bp: *mut bnxt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_set_ulp_msix_num(bp: *mut bnxt, num: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_get_ulp_msix_num_in_use(bp: *mut bnxt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_get_ulp_stat_ctxs(bp: *mut bnxt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_set_ulp_stat_ctxs(bp: *mut bnxt, num_ulp_ctx: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_get_ulp_stat_ctxs_in_use(bp: *mut bnxt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_set_dflt_ulp_stat_ctxs(bp: *mut bnxt) {
...
//
    ...
    RCU_INIT_POINTER(ulp.ulp_ops, core::ptr::null_mut());
    goto exit;
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_unregister_dev(edev: *mut bnxt_en_dev) {
    ...
    bnxt_hwrm_func_drv_rgtr(bp, core::ptr::null_mut(), 0, true);
    RCU_INIT_POINTER(ulp.ulp_ops, core::ptr::null_mut());
    synchronize_rcu();
    ulp.max_async_event_id = 0;
    ulp.async_events_bmap = core::ptr::null_mut();
    mutex_unlock(&edev.en_dev_lock);
    netdev_unlock(dev);
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn bnxt_set_dflt_ulp_msix(bp: *mut bnxt) -> c_int {
    static int bnxt_set_dflt_ulp_msix(struct bnxt *bp)
    {
    let mut roce_msix: c_int = BNXT_MAX_ROCE_MSIX;
    if (BNXT_VF(bp))
    roce_msix = BNXT_MAX_ROCE_MSIX_VF;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: bp->port_partition_type) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_ulp_stop(bp: *mut bnxt) {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_ulp_start(bp: *mut bnxt) {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_ulp_irq_stop(bp: *mut bnxt) {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_ulp_irq_restart(bp: *mut bnxt, err: c_int) {
    ...
    if (bnxt_ulp_registered(edev)) {
    struct bnxt_ulp *ulp = edev.ulp_tbl;
    struct bnxt_msix_entry *ent = core::ptr::null_mut();
    if (!ulp.msix_requested)
    return;
    ops = netdev_lock_dereference(ulp.ulp_ops, bp.dev);
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_ulp_async_events(bp: *mut bnxt, cmpl: *mut hwrm_async_event_cmpl) {
    void bnxt_ulp_async_events(struct bnxt *bp, struct hwrm_async_event_cmpl *cmpl)
    {
    let mut event_id: u16 = le16_to_cpu(cmpl.event_id);
    struct bnxt_en_dev *edev = bp.edev[BNXT_AUXDEV_RDMA];
    struct bnxt_ulp_ops *ops;
    struct bnxt_ulp *ulp;
    if (!bnxt_ulp_registered(edev))
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_aux_devices_uninit(bp: *mut bnxt) {
...
#[no_mangle]
unsafe extern "C" fn bnxt_aux_dev_release(dev: *mut device) {
    ...
    bp.edev[aux_priv.id] = core::ptr::null_mut();
    kfree(aux_priv.edev);
    bp.aux_priv[aux_priv.id] = core::ptr::null_mut();
    kfree(aux_priv);
    }
#[no_mangle]
pub unsafe extern "C" fn bnxt_aux_devices_del(bp: *mut bnxt) {
...
#[no_mangle]
unsafe extern "C" fn bnxt_set_edev_info(edev: *mut bnxt_en_dev, bp: *mut bnxt) {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_aux_devices_add(bp: *mut bnxt) {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_aux_devices_init(bp: *mut bnxt) {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_auxdev_id_alloc(bp: *mut bnxt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_auxdev_id_free(bp: *mut bnxt, id: c_int) {
