...
//! Source: drivers/net/ethernet/silan/sc92031.c
#![no_std]
...
pub const SC92031_USE_PIO: c_int = 0;
// Maximum number of multicast addresses to filter (vs. Rx-all-multicast).
    let mut multicast_filter_limit: static int = 64;
...
pub const MAX_ETH_FRAME_SIZE: c_int = 1536;
...
// media options
pub const AUTOSELECT: c_uint = 0x00;
pub const M10_HALF: c_uint = 0x01;
pub const M10_FULL: c_uint = 0x02;
pub const M100_HALF: c_uint = 0x04;
pub const M100_FULL: c_uint = 0x08;
...
pub const MII_JAB: c_int = 16;
pub const MII_OutputStatus: c_int = 24;
pub const PHY_16_JAB_ENB: c_uint = 0x1000;
pub const PHY_16_PORT_ENB: c_uint = 0x1;
    enum IntrStatusBits {
    LinkFail       = 0x80000000,
    LinkOK         = 0x40000000,
    TimeOut        = 0x20000000,
...
// MAC0 is one of them.
#[no_mangle]
pub unsafe extern "C" fn _sc92031_dummy_read(port_base: *mut void __iomem) {
    static inline void _sc92031_dummy_read(void __iomem *port_base)
    {
    ioread32(port_base + MAC0);
    }
#[no_mangle]
unsafe extern "C" fn _sc92031_mii_wait(port_base: *mut void __iomem) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn _sc92031_mii_cmd(port_base: *mut void __iomem, cmd0: u32, cmd1: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn _sc92031_mii_scan(port_base: *mut void __iomem) {
    static void _sc92031_mii_scan(void __iomem *port_base)
    {
    _sc92031_mii_cmd(port_base, Mii_SCAN, 0x1 << 6);
    }
#[no_mangle]
unsafe extern "C" fn _sc92031_mii_read(port_base: *mut void __iomem, reg: unsigned) -> u16 {
    static u16 _sc92031_mii_read(void __iomem *port_base, unsigned reg)
    {
    return _sc92031_mii_cmd(port_base, Mii_READ, reg << 6) >> 13;
    }
#[no_mangle]
unsafe extern "C" fn _sc92031_mii_write(port_base: *mut void __iomem, reg: unsigned, val: u16) {
...
#[no_mangle]
unsafe extern "C" fn sc92031_disable_interrupts(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn sc92031_enable_interrupts(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn _sc92031_disable_tx_rx(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn _sc92031_enable_tx_rx(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn _sc92031_tx_clear(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn _sc92031_set_mar(dev: *mut net_device) {
    static void _sc92031_set_mar(struct net_device *dev)
    {
    struct sc92031_priv *priv = netdev_priv(dev);
    void __iomem *port_base = priv.port_base;
    let mut mar0: u32 = 0, mar1 = 0;
    if ((dev.flags & IFF_PROMISC) ||
    netdev_mc_count(dev) > multicast_filter_limit ||
    (dev.flags & IFF_ALLMULTI))
    mar0 = mar1 = 0xffffffff;
#[no_mangle]
pub unsafe extern "C" fn if(IFF_MULTICAST: dev->flags &) -> else {
    struct netdev_hw_addr *ha;
    netdev_for_each_mc_addr(ha, dev) {
    u32 crc;
    let mut bit: unsigned = 0;
...
#[no_mangle]
unsafe extern "C" fn _sc92031_set_rx_config(dev: *mut net_device) {
    static void _sc92031_set_rx_config(struct net_device *dev)
    {
    struct sc92031_priv *priv = netdev_priv(dev);
    void __iomem *port_base = priv.port_base;
    unsigned int old_mc_flags;
    let mut rx_config_bits: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn _sc92031_check_media(dev: *mut net_device) -> bool {
    ...
    let mut flow_ctrl_config: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn _sc92031_phy_reset(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn _sc92031_reset(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn _sc92031_tx_tasklet(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn _sc92031_rx_tasklet(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn _sc92031_link_tasklet(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn sc92031_tasklet(t: *mut tasklet_struct) {
...
#[no_mangle]
unsafe extern "C" fn sc92031_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// Update the error count.
    ...
    tx_status = len;
#[no_mangle]
pub unsafe extern "C" fn if(300: len <) -> else {
    else if (len < 300)
...
#[no_mangle]
unsafe extern "C" fn sc92031_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc92031_stop(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc92031_set_multicast_list(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn sc92031_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sc92031_poll_controller(dev: *mut net_device) {
    static void sc92031_poll_controller(struct net_device *dev)
    {
    struct sc92031_priv *priv = netdev_priv(dev);
    let mut irq: c_int = priv.pdev.irq;
    disable_irq(irq);
...
#[no_mangle]
unsafe extern "C" fn sc92031_ethtool_nway_reset(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc92031_ethtool_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc92031_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc92031_remove(pdev: *mut pci_dev) {
    static void sc92031_remove(struct pci_dev *pdev)
    {
    struct net_device *dev = pci_get_drvdata(pdev);
    struct sc92031_priv *priv = netdev_priv(dev);
    let mut port_base: *mut void __iomem = priv.port_base;
...
#[no_mangle]
unsafe extern "C" fn sc92031_suspend(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn sc92031_resume(dev_d: *mut device) -> int __maybe_unused {
