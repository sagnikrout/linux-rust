...
//! Source: drivers/net/ethernet/oa_tc6.c
#![no_std]
...
pub const OA_TC6_CTRL_PROT_REPLY_SIZE: c_int = 4;
pub const OA_TC6_CTRL_HEADER_SIZE: c_int = 4;
pub const OA_TC6_CTRL_REG_VALUE_SIZE: c_int = 4;
pub const OA_TC6_CTRL_IGNORED_SIZE: c_int = 4;
pub const OA_TC6_CTRL_MAX_REGISTERS: c_int = 128;

    (OA_TC6_CTRL_MAX_REGISTERS *\
    (OA_TC6_CTRL_REG_VALUE_SIZE +\
    OA_TC6_CTRL_PROT_REPLY_SIZE)) +\
    OA_TC6_CTRL_IGNORED_SIZE)
pub const OA_TC6_CHUNK_PAYLOAD_SIZE: c_int = 64;
pub const OA_TC6_DATA_HEADER_SIZE: c_int = 4;

    OA_TC6_CHUNK_PAYLOAD_SIZE)
pub const OA_TC6_MAX_TX_CHUNKS: c_int = 48;

    OA_TC6_CHUNK_SIZE)
pub const STATUS0_RESETC_POLL_DELAY: c_int = 1000;
pub const STATUS0_RESETC_POLL_TIMEOUT: c_int = 1000000;
...
pub struct oa_tc6 {
    ...
    pub /: *mut *mut mutex spi_ctrl_lock; / Protects spi control transfer,
    pub /: *mut *mut spinlock_t tx_skb_lock; / Protects tx skb handling,
    pub spi_ctrl_tx_buf: *mut c_void,
    pub spi_ctrl_rx_buf: *mut c_void,
    pub spi_data_tx_buf: *mut c_void,
    pub spi_data_rx_buf: *mut c_void,
    pub ongoing_tx_skb: *mut sk_buff,
    pub waiting_tx_skb: *mut sk_buff,
    pub rx_skb: *mut sk_buff,
    pub tx_skb_offset: u16,
    pub spi_data_tx_buf_offset: u16,
    pub tx_credits: u16,
    pub rx_chunks_available: u8,
    pub wait_until_start_valid: bool,
    pub int_flag: bool,
    pub disable_traffic: bool,
    pub prot_ctrl: bool,
    pub quirk_flags: enum oa_tc6_quirk_flag,
}
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_get_parity(p: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_calculate_ctrl_buf_size(length: u8, ctrl_prot: bool) -> u16 {
    static u16 oa_tc6_calculate_ctrl_buf_size(u8 length, bool ctrl_prot)
    {
    let mut reply_size: u32 = OA_TC6_CTRL_REG_VALUE_SIZE;
    if (ctrl_prot)
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_check_ctrl_write_reply(tc6: *mut oa_tc6, size: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_check_ctrl_read_reply(tc6: *mut oa_tc6, length: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn oa_tc6_read_register(tc6: *mut oa_tc6, address: u32, value: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn oa_tc6_write_register(tc6: *mut oa_tc6, address: u32, value: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_check_phy_reg_direct_access_capability(tc6: *mut oa_tc6) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_handle_link_change(netdev: *mut net_device) {
    static void oa_tc6_handle_link_change(struct net_device *netdev)
    {
    phy_print_status(netdev.phydev);
    }
#[no_mangle]
unsafe extern "C" fn oa_tc6_mdiobus_read(bus: *mut mii_bus, addr: c_int, regnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_get_phy_c45_mms(devnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_mdiobus_register(tc6: *mut oa_tc6) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_mdiobus_unregister(tc6: *mut oa_tc6) {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_phy_init(tc6: *mut oa_tc6) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_phy_exit(tc6: *mut oa_tc6) {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_read_status0(tc6: *mut oa_tc6) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_sw_reset_macphy(tc6: *mut oa_tc6) -> c_int {
    static int oa_tc6_sw_reset_macphy(struct oa_tc6 *tc6)
    {
    let mut regval: u32 = OA_TC6_RESET_SWRESET;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_unmask_macphy_error_interrupts(tc6: *mut oa_tc6) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_enable_data_transfer(tc6: *mut oa_tc6) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_drop_tx_skb(tc6: *mut oa_tc6, skb: *mut sk_buff) {
    ...
    tc6.waiting_tx_skb = core::ptr::null_mut();
    return skb;
    }
#[no_mangle]
unsafe extern "C" fn oa_tc6_cleanup_ongoing_rx_skb(tc6: *mut oa_tc6) {
    static void oa_tc6_cleanup_ongoing_rx_skb(struct oa_tc6 *tc6)
    {
    if (tc6.rx_skb) {
    tc6.netdev.stats.rx_dropped++;
    kfree_skb(tc6.rx_skb);
    tc6.rx_skb = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn oa_tc6_cleanup_ongoing_tx_skb(tc6: *mut oa_tc6) {
    static void oa_tc6_cleanup_ongoing_tx_skb(struct oa_tc6 *tc6)
    {
    oa_tc6_drop_tx_skb(tc6, tc6.ongoing_tx_skb);
    tc6.ongoing_tx_skb = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn oa_tc6_cleanup_waiting_tx_skb(tc6: *mut oa_tc6) {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_free_ongoing_skbs(tc6: *mut oa_tc6) {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_free_pending_skbs(tc6: *mut oa_tc6) {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_look_for_new_frame(tc6: *mut oa_tc6) {
...
//
#[no_mangle]
unsafe extern "C" fn oa_tc6_disable_traffic(tc6: *mut oa_tc6) {
    static void oa_tc6_disable_traffic(struct oa_tc6 *tc6)
    {
    let mut regval: u32 = OA_TC6_INT_MASK0_ALL_INTERRUPTS;
    struct sk_buff *skb;
    spin_lock_bh(&tc6.tx_skb_lock);
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_process_extended_status(tc6: *mut oa_tc6) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_process_rx_chunk_footer(tc6: *mut oa_tc6, footer: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_submit_rx_skb(tc6: *mut oa_tc6) {
...
//
#[no_mangle]
unsafe extern "C" fn oa_tc6_update_rx_skb(tc6: *mut oa_tc6, payload: *mut u8, length: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn oa_tc6_allocate_rx_skb(tc6: *mut oa_tc6) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_prcs_rx_frame_start(tc6: *mut oa_tc6, payload: *mut u8, size: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_prcs_rx_frame_end(tc6: *mut oa_tc6, payload: *mut u8, size: u16) -> c_int {
    ...
    footer);
    let mut start_valid: bool = FIELD_GET(OA_TC6_DATA_FOOTER_START_VALID, footer);
    let mut end_valid: bool = FIELD_GET(OA_TC6_DATA_FOOTER_END_VALID, footer);
    u16 size;
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_get_rx_chunk_footer(tc6: *mut oa_tc6, footer_offset: u16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_process_spi_data_rx_buf(tc6: *mut oa_tc6, length: u16) -> c_int {
    static int oa_tc6_process_spi_data_rx_buf(struct oa_tc6 *tc6, u16 length)
    {
    let mut no_of_rx_chunks: u16 = length / OA_TC6_CHUNK_SIZE;
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_add_tx_skb_to_spi_buf(tc6: *mut oa_tc6) {
    static void oa_tc6_add_tx_skb_to_spi_buf(struct oa_tc6 *tc6)
    {
    let mut end_valid: enum oa_tc6_data_end_valid_info = OA_TC6_DATA_END_INVALID;
    __be32 *tx_buf = tc6.spi_data_tx_buf + tc6.spi_data_tx_buf_offset;
    let mut remaining_len: u16 = tc6.ongoing_tx_skb.len - tc6.tx_skb_offset;
    u8 *tx_skb_data = tc6.ongoing_tx_skb.data + tc6.tx_skb_offset;
    enum oa_tc6_data_start_valid_info start_valid;
    let mut end_byte_offset: u8 = 0;
    u16 length_to_copy;
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_prepare_spi_tx_buf_for_tx_skbs(tc6: *mut oa_tc6) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_prepare_spi_tx_buf_for_rx_chunks(tc6: *mut oa_tc6, len: u16) -> u16 {
    static u16 oa_tc6_prepare_spi_tx_buf_for_rx_chunks(struct oa_tc6 *tc6, u16 len)
    {
    let mut tx_chunks: u16 = len / OA_TC6_CHUNK_SIZE;
    u16 needed_empty_chunks;
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_try_spi_transfer(tc6: *mut oa_tc6) -> c_int {
    static int oa_tc6_try_spi_transfer(struct oa_tc6 *tc6)
    {
    int ret;
    while (true) {
    let mut spi_len: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_macphy_threaded_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_update_buffer_status_from_register(tc6: *mut oa_tc6) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_macphy_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn oa_tc6_zero_align_receive_frame_enable(tc6: *mut oa_tc6) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn oa_tc6_start_xmit(tc6: *mut oa_tc6, skb: *mut sk_buff) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn oa_tc6_check_ctrl_protection(tc6: *mut oa_tc6) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn oa_tc6_exit(tc6: *mut oa_tc6) {
