...
//! Source: drivers/net/ethernet/emulex/benet/be_main.c
#![no_std]
...
//
    ...
    let mut rx_frag_size: static ushort = 2048;
...
#[no_mangle]
unsafe extern "C" fn be_queue_free(adapter: *mut be_adapter, q: *mut be_queue_info) {
...
#[no_mangle]
unsafe extern "C" fn be_reg_intr_set(adapter: *mut be_adapter, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(!enable: enabled &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn be_intr_set(adapter: *mut be_adapter, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn be_rxq_notify(adapter: *mut be_adapter, qid: u16, posted: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn be_cq_notify(adapter: *mut be_adapter, qid: u16, arm: bool, num_popped: u16) {
...
#[no_mangle]
unsafe extern "C" fn be_dev_mac_add(adapter: *mut be_adapter, mac: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_dev_mac_del(adapter: *mut be_adapter, pmac_id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn be_mac_addr_set(netdev: *mut net_device, p: *mut c_void) -> c_int {
    ...
    int status;
    u8 mac[ETH_ALEN];
    let mut old_pmac_id: u32 = adapter.pmac_id[0];
...
#[no_mangle]
unsafe extern "C" fn populate_be_v0_stats(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn populate_be_v1_stats(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn populate_be_v2_stats(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn populate_lancer_stats(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn accumulate_16bit_val(acc: *mut u32, val: u16) {
    static void accumulate_16bit_val(u32 *acc, u16 val)
    {

    let mut wrapped: bool = val < lo(*acc);
    let mut newacc: u32 = hi(*acc) + val;
    if (wrapped)
    newacc += 65536;
...
#[no_mangle]
pub unsafe extern "C" fn be_parse_stats(adapter: *mut be_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: BE3_chip(adapter)) -> else {
    else if (BE3_chip(adapter))
// for BE3
...
#[no_mangle]
pub unsafe extern "C" fn be_link_status_update(adapter: *mut be_adapter, link_status: u8) {
...
#[no_mangle]
unsafe extern "C" fn be_gso_hdr_len(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_tx_stats_update(txo: *mut be_tx_obj, skb: *mut sk_buff) {
    static void be_tx_stats_update(struct be_tx_obj *txo, struct sk_buff *skb)
    {
    struct be_tx_stats *stats = tx_stats(txo);
    let mut tx_pkts: u32 = skb_shinfo(skb).gso_segs ? : 1;
// Account for headers which get duplicated in TSO pkt
    let mut dup_hdr_len: u32 = tx_pkts > 1 ? be_gso_hdr_len(skb) * (tx_pkts - 1) : 0;
...
#[no_mangle]
unsafe extern "C" fn skb_wrb_cnt(skb: *mut sk_buff) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn wrb_fill(wrb: *mut be_eth_wrb, addr: u64, len: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn wrb_fill_dummy(wrb: *mut be_eth_wrb) {
...
#[no_mangle]
unsafe extern "C" fn skb_inner_ip_proto(skb: *mut sk_buff) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn skb_ip_proto(skb: *mut sk_buff) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn be_is_txq_full(txo: *mut be_tx_obj) -> bool {
    static inline bool be_is_txq_full(struct be_tx_obj *txo)
    {
    return atomic_read(&txo.q.used) + BE_MAX_TX_FRAG_COUNT >= txo.q.len;
    }
#[no_mangle]
pub unsafe extern "C" fn be_can_txq_wake(txo: *mut be_tx_obj) -> bool {
    static inline bool be_can_txq_wake(struct be_tx_obj *txo)
    {
    return atomic_read(&txo.q.used) < txo.q.len / 2;
    }
#[no_mangle]
pub unsafe extern "C" fn be_is_tx_compl_pending(txo: *mut be_tx_obj) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(IPPROTO_UDP: proto ==) -> else {
...
//
    ...
    {
    dma_addr_t dma;
    let mut frag_len: u32 = le32_to_cpu(wrb.frag_len);
...
#[no_mangle]
unsafe extern "C" fn be_tx_get_wrb_hdr(txo: *mut be_tx_obj) -> u32 {
    static u32 be_tx_get_wrb_hdr(struct be_tx_obj *txo)
    {
    let mut head: u32 = txo.q.head;
...
// Set up the WRB header for xmit
    ...
    {
    let mut num_frags: u32 = skb_wrb_cnt(skb);
...
#[no_mangle]
pub unsafe extern "C" fn qnq_async_evt_rcvd(adapter: *mut be_adapter) -> c_int {
...
// wrb_params)
    {
    let mut insert_vlan: bool = false;
...
#[no_mangle]
unsafe extern "C" fn be_ipv6_exthdr_check(skb: *mut sk_buff) -> bool {
    static bool be_ipv6_exthdr_check(struct sk_buff *skb)
    {
    struct ethhdr *eh = (struct ethhdr *)skb.data;
    let mut offset: u16 = ETH_HLEN;
...
#[no_mangle]
unsafe extern "C" fn be_vlan_tag_tx_chk(adapter: *mut be_adapter, skb: *mut sk_buff) -> c_int {
    static int be_vlan_tag_tx_chk(struct be_adapter *adapter, struct sk_buff *skb)
    {
    return skb_vlan_tag_present(skb) || adapter.pvid || adapter.qnq_vid;
    }
#[no_mangle]
unsafe extern "C" fn be_ipv6_tx_stall_chk(adapter: *mut be_adapter, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_xmit_flush(adapter: *mut be_adapter, txo: *mut be_tx_obj) {
...
// OS2BMC related
pub const DHCP_CLIENT_PORT: c_int = 68;
pub const DHCP_SERVER_PORT: c_int = 67;
pub const NET_BIOS_PORT1: c_int = 137;
pub const NET_BIOS_PORT2: c_int = 138;
pub const DHCPV6_RAS_PORT: c_int = 547;
    ...
    let mut nexthdr: u8 = hdr.nexthdr;
...
#[no_mangle]
unsafe extern "C" fn be_xmit(skb: *mut sk_buff, netdev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t be_xmit(struct sk_buff *skb, struct net_device *netdev)
    {
    struct be_adapter *adapter = netdev_priv(netdev);
    let mut q_idx: u16 = skb_get_queue_mapping(skb);
    struct be_tx_obj *txo = &adapter.tx_obj[q_idx];
    let mut wrb_params: be_wrb_params = { 0 };
    let mut flush: bool = !netdev_xmit_more();
    u16 wrb_cnt;
...
#[no_mangle]
unsafe extern "C" fn be_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn be_in_all_promisc(adapter: *mut be_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn be_set_vlan_promisc(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_clear_vlan_promisc(adapter: *mut be_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn be_vid_config(adapter: *mut be_adapter) -> c_int {
    static int be_vid_config(struct be_adapter *adapter)
    {
    struct device *dev = &adapter.pdev.dev;
    u16 vids[BE_NUM_VLANS_SUPPORTED];
    let mut num: u16 = 0, i = 0;
    let mut status: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn be_vlan_add_vid(netdev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_vlan_rem_vid(netdev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_set_all_promisc(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_set_mc_promisc(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_set_uc_promisc(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_clear_uc_promisc(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_set_mc_list(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_clear_mc_list(adapter: *mut be_adapter) {
    static void be_clear_mc_list(struct be_adapter *adapter)
    {
    struct net_device *netdev = adapter.netdev;
    __dev_mc_unsync(netdev, core::ptr::null_mut());
    be_cmd_rx_filter(adapter, BE_IF_FLAGS_MULTICAST, OFF);
    adapter.mc_count = 0;
    }
#[no_mangle]
unsafe extern "C" fn be_uc_mac_add(adapter: *mut be_adapter, uc_idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_uc_mac_del(adapter: *mut be_adapter, pmac_id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn be_set_uc_list(adapter: *mut be_adapter) {
    static void be_set_uc_list(struct be_adapter *adapter)
    {
    struct net_device *netdev = adapter.netdev;
    struct netdev_hw_addr *ha;
    let mut uc_promisc: bool = false;
    let mut curr_uc_macs: c_int = 0, i;
    netif_addr_lock_bh(netdev);
...
#[no_mangle]
unsafe extern "C" fn be_clear_uc_list(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn __be_set_rx_mode(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_work_set_rx_mode(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn be_set_vf_mac(netdev: *mut net_device, vf: c_int, mac: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_set_vf_tvt(adapter: *mut be_adapter, vf: c_int, vlan: u16) -> c_int {
    static int be_set_vf_tvt(struct be_adapter *adapter, int vf, u16 vlan)
    {
    struct be_vf_cfg *vf_cfg = &adapter.vf_cfg[vf];
    u16 vids[BE_NUM_VLANS_SUPPORTED];
    let mut vf_if_id: c_int = vf_cfg.if_handle;
    int status;
...
#[no_mangle]
unsafe extern "C" fn be_clear_vf_tvt(adapter: *mut be_adapter, vf: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_set_vf_spoofchk(netdev: *mut net_device, vf: c_int, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_get_new_eqd(eqo: *mut be_eq_obj) -> c_int {
    ...
    struct be_rx_obj *rxo;
    struct be_tx_obj *txo;
    let mut rx_pkts: u64 = 0, tx_pkts = 0, pkts;
    ulong now;
    u32 pps, delta;
    int i;
...
// For Skyhawk-R only
#[no_mangle]
unsafe extern "C" fn be_get_eq_delay_mult_enc(eqo: *mut be_eq_obj) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(60: eqd >) -> else {
    else if (eqd > 60)
    mult_enc = R2I_DLY_ENC_2;
#[no_mangle]
pub unsafe extern "C" fn if(20: eqd >) -> else {
    else if (eqd > 20)
...
#[no_mangle]
pub unsafe extern "C" fn be_eqd_update(adapter: *mut be_adapter, force_update: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn csum_passed(rxcp: *mut be_rx_compl_info) -> bool {
...
// Complete packet has now been moved to data
    ...
    page_info.page = core::ptr::null_mut();
...
// As the compl has been parsed, reset it; we won't touch it again
    ...
    {
    let mut order: u32 = get_order(size);
    if (order > 0)
    gfp |= __GFP_COMP;
...
//
#[no_mangle]
unsafe extern "C" fn be_post_rx_frags(rxo: *mut be_rx_obj, gfp: gfp_t, frags_needed: u32) {
    static void be_post_rx_frags(struct be_rx_obj *rxo, gfp_t gfp, u32 frags_needed)
    {
    struct be_adapter *adapter = rxo.adapter;
    struct be_rx_page_info *page_info = core::ptr::null_mut(), *prev_page_info = core::ptr::null_mut();
    struct be_queue_info *rxq = &rxo.q;
    struct page *pagep = core::ptr::null_mut();
    struct device *dev = &adapter.pdev.dev;
    struct be_eth_rx_d *rxd;
    let mut page_dmaaddr: u64 = 0, frag_dmaaddr;
...
#[no_mangle]
pub unsafe extern "C" fn be_update_tx_err(txo: *mut be_tx_obj, status: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn lancer_update_tx_err(txo: *mut be_tx_obj, status: u8) {
...
//
    ...
    struct be_queue_info *txq = &txo.q;
    struct sk_buff *skb = core::ptr::null_mut();
    let mut unmap_skb_hdr: bool = false;
    struct be_eth_wrb *wrb;
    let mut num_wrbs: u16 = 0;
    u32 frag_index;
    do {
...
// Free skb from prev req
    ...
    sent_skbs[txq.tail] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn events_get(eqo: *mut be_eq_obj) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_eq_clean(eqo: *mut be_eq_obj) {
    static void be_eq_clean(struct be_eq_obj *eqo)
    {
    let mut num: c_int = events_get(eqo);
    be_eq_notify(eqo.adapter, eqo.q.id, false, true, num, 0);
    }
// Free posted rx buffers that were not used
#[no_mangle]
unsafe extern "C" fn be_rxq_clean(rxo: *mut be_rx_obj) {
...
#[no_mangle]
unsafe extern "C" fn be_rx_cq_clean(rxo: *mut be_rx_obj) {
    static void be_rx_cq_clean(struct be_rx_obj *rxo)
    {
    struct be_queue_info *rx_cq = &rxo.cq;
    struct be_rx_compl_info *rxcp;
    struct be_adapter *adapter = rxo.adapter;
    let mut flush_wait: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn be_tx_compl_clean(adapter: *mut be_adapter) {
    static void be_tx_compl_clean(struct be_adapter *adapter)
    {
    struct device *dev = &adapter.pdev.dev;
    let mut cmpl: u16 = 0, timeo = 0, num_wrbs = 0;
...
#[no_mangle]
unsafe extern "C" fn be_evt_queues_destroy(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_evt_queues_create(adapter: *mut be_adapter) -> c_int {
...
// need enough EQs to service both RX and TX queues
    ...
    for_all_evt_queues(adapter, eqo, i) {
    let mut numa_node: c_int = dev_to_node(&adapter.pdev.dev);
...
#[no_mangle]
unsafe extern "C" fn be_mcc_queues_destroy(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_mcc_queues_create(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_tx_queues_destroy(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_tx_qs_create(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_rx_cqs_destroy(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_rx_cqs_create(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_intx(irq: c_int, dev: *mut c_void) -> irqreturn_t {
    static irqreturn_t be_intx(int irq, void *dev)
    {
    struct be_eq_obj *eqo = dev;
    struct be_adapter *adapter = eqo.adapter;
    let mut num_evts: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn be_msix(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn do_gro(rxcp: *mut be_rx_compl_info) -> bool {
...
//
    ...
    int idx)
    {
    let mut num_wrbs: c_int = 0, work_done = 0;
    struct be_tx_compl_info *txcp;
    while ((txcp = be_tx_compl_get(adapter, txo))) {
...
#[no_mangle]
pub unsafe extern "C" fn be_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
    int be_poll(struct napi_struct *napi, int budget)
    {
    struct be_eq_obj *eqo = container_of(napi, struct be_eq_obj, napi);
    struct be_adapter *adapter = eqo.adapter;
    let mut max_work: c_int = 0, work, i, num_evts;
    struct be_rx_obj *rxo;
    struct be_tx_obj *txo;
    let mut mult_enc: u32 = 0;
    num_evts = events_get(eqo);
    for_all_tx_queues_on_eq(adapter, eqo, txo, i)
...
#[no_mangle]
pub unsafe extern "C" fn be_detect_error(adapter: *mut be_adapter) {
    void be_detect_error(struct be_adapter *adapter)
    {
    let mut ue_lo: u32 = 0, ue_hi = 0, ue_lo_mask = 0, ue_hi_mask = 0;
    let mut sliport_status: u32 = 0, sliport_err1 = 0, sliport_err2 = 0;
    struct device *dev = &adapter.pdev.dev;
    u16 val;
    u32 i;
    if (be_check_error(adapter, BE_ERROR_HW))
...
#[no_mangle]
unsafe extern "C" fn be_msix_disable(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_msix_enable(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_msix_register(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_irq_register(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_irq_unregister(adapter: *mut be_adapter) {
...
// MSIx
    for_all_evt_queues(adapter, eqo, i) {
    vec = be_msix_vec_get(adapter, eqo);
    irq_update_affinity_hint(vec, core::ptr::null_mut());
    free_irq(vec, eqo);
    }
    done:
...
#[no_mangle]
unsafe extern "C" fn be_rx_qs_destroy(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_disable_if_filters(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_rx_qs_create(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_enable_if_filters(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_open(netdev: *mut net_device) -> c_int {
    ...
    adapter.flags |= BE_FLAGS_NAPI_ENABLED;
    status = be_cmd_link_status_query(adapter, core::ptr::null_mut(), &link_status, 0);
    if (!status)
...
#[no_mangle]
unsafe extern "C" fn be_vf_eth_addr_generate(adapter: *mut be_adapter, mac: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn be_vf_eth_addr_config(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_vfs_mac_query(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_vf_clear(adapter: *mut be_adapter) {
    ...
    be_cmd_set_mac(adapter, core::ptr::null_mut(), vf_cfg.if_handle,
    vf + 1);
...
#[no_mangle]
unsafe extern "C" fn be_clear_queues(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_cancel_worker(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_cancel_err_detection(adapter: *mut be_adapter) {
...
//
    ...
    {
    let mut res: be_resources = adapter.pool_res;
    let mut vf_if_cap_flags: u32 = res.vf_if_cap_flags;
    let mut res_mod: be_resources = {0};
    let mut num_vf_qs: u16 = 1;
...
//
    be_cmd_get_profile_config(adapter, &res_mod, core::ptr::null_mut(), ACTIVE_PROFILE_TYPE,
...
#[no_mangle]
unsafe extern "C" fn be_if_destroy(adapter: *mut be_adapter) {
    static void be_if_destroy(struct be_adapter *adapter)
    {
    be_cmd_if_destroy(adapter, adapter.if_handle,  0);
    kfree(adapter.pmac_id);
    adapter.pmac_id = core::ptr::null_mut();
    kfree(adapter.mc_list);
    adapter.mc_list = core::ptr::null_mut();
    kfree(adapter.uc_list);
    adapter.uc_list = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn be_clear(adapter: *mut be_adapter) -> c_int {
    static int be_clear(struct be_adapter *adapter)
    {
    struct pci_dev *pdev = adapter.pdev;
    let mut vft_res: be_resources = {0};
...
//
    ...
    be_vxlan_unset_port(adapter.netdev, 0, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn be_vfs_if_create(adapter: *mut be_adapter) -> c_int {
    static int be_vfs_if_create(struct be_adapter *adapter)
    {
    let mut res: be_resources = {0};
...
// If a FW profile exists, then cap_flags are updated
    ...
    for_all_vfs(adapter, vf_cfg, vf) {
    if (!BE3_chip(adapter)) {
    status = be_cmd_get_profile_config(adapter, &res, core::ptr::null_mut(),
    ACTIVE_PROFILE_TYPE,
    RESOURCE_LIMITS,
    vf + 1);
    if (!status) {
...
#[no_mangle]
unsafe extern "C" fn be_vf_setup_init(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_vf_setup(adapter: *mut be_adapter) -> c_int {
...
// Allow full available bandwidth
    ...
    status = be_cmd_get_hsw_config(adapter, core::ptr::null_mut(), vf + 1,
    vf_cfg.if_handle, core::ptr::null_mut(),
    &spoofchk);
    if (!status)
...
#[no_mangle]
unsafe extern "C" fn be_convert_mc_type(function_mode: u32) -> u8 {
    static u8 be_convert_mc_type(u32 function_mode)
    {
    if (function_mode & VNIC_MODE && function_mode & QNQ_MODE)
    return vNIC1;
#[no_mangle]
pub unsafe extern "C" fn if(QNQ_MODE: function_mode &) -> else {
    else if (function_mode & QNQ_MODE)
    return FLEX10;
#[no_mangle]
pub unsafe extern "C" fn if(VNIC_MODE: function_mode &) -> else {
    else if (function_mode & VNIC_MODE)
    return vNIC2;
#[no_mangle]
pub unsafe extern "C" fn if(UMC_ENABLED: function_mode &) -> else {
...
// On BE2/BE3 FW does not suggest the supported limits
    ...
    {
    let mut use_sriov: bool = adapter.num_vfs ? 1 : 0;
...
//
    ...
    let mut super_nic_res: be_resources = {0};
// On a SuperNIC profile, the driver needs to use the
// GET_PROFILE_CONFIG cmd to query the per-function TXQ limits
//
    be_cmd_get_profile_config(adapter, &super_nic_res, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn be_setup_init(adapter: *mut be_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn be_calculate_pf_pool_rss_tables(adapter: *mut be_adapter) {
    static void be_calculate_pf_pool_rss_tables(struct be_adapter *adapter)
    {
    let mut port_res: be_port_resources = {0};
    u8 rss_tables_on_port;
    let mut max_vfs: u16 = be_max_vfs(adapter);
    be_cmd_get_profile_config(adapter, core::ptr::null_mut(), &port_res, SAVED_PROFILE_TYPE,
    RESOURCE_LIMITS, 0);
...
#[no_mangle]
unsafe extern "C" fn be_get_sriov_config(adapter: *mut be_adapter) -> c_int {
    static int be_get_sriov_config(struct be_adapter *adapter)
    {
    let mut res: be_resources = {0};
    int max_vfs, old_vfs;
    be_cmd_get_profile_config(adapter, &res, core::ptr::null_mut(), ACTIVE_PROFILE_TYPE,
    RESOURCE_LIMITS, 0);
...
#[no_mangle]
unsafe extern "C" fn be_alloc_sriov_res(adapter: *mut be_adapter) {
    static void be_alloc_sriov_res(struct be_adapter *adapter)
    {
    let mut old_vfs: c_int = pci_num_vf(adapter.pdev);
    let mut vft_res: be_resources = {0};
    int status;
...
#[no_mangle]
unsafe extern "C" fn be_get_resources(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_get_config(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_mac_setup(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_schedule_worker(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_destroy_err_recovery_workq() {
    static void be_destroy_err_recovery_workq(void)
    {
    if (!be_err_recovery_workq)
    return;
    destroy_workqueue(be_err_recovery_workq);
    be_err_recovery_workq = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn be_schedule_err_detection(adapter: *mut be_adapter, delay: u32) {
...
#[no_mangle]
unsafe extern "C" fn be_setup_queues(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_if_create(adapter: *mut be_adapter) -> c_int {
    static int be_if_create(struct be_adapter *adapter)
    {
    let mut en_flags: u32 = BE_IF_FLAGS_RSS | BE_IF_FLAGS_DEFQ_RSS;
    let mut cap_flags: u32 = be_if_cap_flags(adapter);
...
#[no_mangle]
pub unsafe extern "C" fn be_update_queues(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fw_major_num(fw_ver: *const c_char) -> c_int {
    static inline int fw_major_num(const char *fw_ver)
    {
    let mut fw_major: c_int = 0, i;
...
//
#[no_mangle]
unsafe extern "C" fn be_reset_required(adapter: *mut be_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn be_func_init(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_setup(adapter: *mut be_adapter) -> c_int {
...
//
    if (!BEx_chip(adapter)) {
    status = be_cmd_get_func_config(adapter, core::ptr::null_mut());
    if (status)
    return status;
    }
...
#[no_mangle]
unsafe extern "C" fn be_netpoll(netdev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn be_load_fw(adapter: *mut be_adapter, fw_file: *mut u8) -> c_int {
...
// VEB is disabled in non-SR-IOV profiles on BE3/Lancer
    ...
    status = be_cmd_get_hsw_config(adapter, core::ptr::null_mut(), 0,
...
#[no_mangle]
unsafe extern "C" fn be_set_rx_mode(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn be_netdev_init(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn be_cleanup(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_resume(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_soft_reset(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_err_is_recoverable(adapter: *mut be_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn be_tpe_recover(adapter: *mut be_adapter) -> c_int {
    static int be_tpe_recover(struct be_adapter *adapter)
    {
    struct be_error_recovery *err_rec = &adapter.error_recovery;
    let mut status: c_int = -EAGAIN;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn be_err_recover(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_err_detection_task(work: *mut work_struct) {
    ...
    error_recovery);
    let mut resched_delay: u32 = ERR_RECOVERY_DETECTION_DELAY;
    struct device *dev = &adapter.pdev.dev;
    int recovery_status;
...
#[no_mangle]
unsafe extern "C" fn be_log_sfp_info(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn be_unmap_pci_bars(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn db_bar(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_roce_map_pci_bars(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_map_pci_bars(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_drv_cleanup(adapter: *mut be_adapter) {
...
#[no_mangle]
unsafe extern "C" fn be_drv_init(adapter: *mut be_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: BE2_chip(adapter)) -> else {
...
#[no_mangle]
unsafe extern "C" fn be_remove(pdev: *mut pci_dev) {
...
// Unit: millidegree Celsius
    ...
    be_hwmon_show_temp, core::ptr::null_mut(), 1);
...
#[no_mangle]
unsafe extern "C" fn be_probe(pdev: *mut pci_dev, pdev_id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_suspend(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn be_pci_resume(dev_d: *mut device) -> int __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn be_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn be_eeh_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn be_eeh_resume(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn be_pci_sriov_configure(pdev: *mut pci_dev, num_vfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn be_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn be_exit_module() -> void __exit {
