...
//! Source: drivers/net/ethernet/cisco/enic/enic_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn enic_intr_coal_set_rx(enic: *mut enic, timer: u32) {
...
//
    ...
    struct enic *enic = netdev_priv(netdev);
    struct vnic_enet_config *c = &enic.config;
    let mut running: c_int = netif_running(netdev);
...
#[no_mangle]
unsafe extern "C" fn enic_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn enic_set_msglevel(netdev: *mut net_device, value: u32) {
    ...
    {
    let mut coalesce_usecs_max: u32 = vnic_dev_get_intr_coal_timer_max(enic.vdev);
...
#[no_mangle]
unsafe extern "C" fn enic_grxclsrule(enic: *mut enic, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_get_rx_ring_count(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn enic_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn enic_set_ethtool_ops(netdev: *mut net_device) {
