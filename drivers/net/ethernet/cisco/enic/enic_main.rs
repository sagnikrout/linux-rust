...
//! Source: drivers/net/ethernet/cisco/enic/enic_main.c
#![no_std]
...
pub const PCI_DEVICE_ID_CISCO_VIC_ENET: c_uint = 0x0043  /* ethernet vnic */;
pub const PCI_DEVICE_ID_CISCO_VIC_ENET_DYN: c_uint = 0x0044  /* enet dynamic vnic */;
pub const PCI_DEVICE_ID_CISCO_VIC_ENET_VF: c_uint = 0x0071  /* enet SRIOV VF */;
pub const PCI_DEVICE_ID_CISCO_VIC_ENET_VF_V2: c_uint = 0x02b7  /* enet SRIOV V2 VF */;
pub const PCI_DEVICE_ID_CISCO_VIC_ENET_VF_USNIC: c_uint = 0x00cf /* enet USNIC VF */;
// Supported devices
...
pub const ENIC_LARGE_PKT_THRESHOLD: c_int = 1000;
pub const ENIC_MAX_COALESCE_TIMERS: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn enic_init_affinity_hint(enic: *mut enic) {
    static void enic_init_affinity_hint(struct enic *enic)
    {
    let mut numa_node: c_int = dev_to_node(&enic.pdev.dev);
    int i;
...
#[no_mangle]
unsafe extern "C" fn enic_free_affinity_hint(enic: *mut enic) {
...
#[no_mangle]
unsafe extern "C" fn enic_set_affinity_hint(enic: *mut enic) {
    ...
    let mut wq_intr: c_int = enic_msix_wq_intr(enic, i);
...
#[no_mangle]
unsafe extern "C" fn enic_unset_affinity_hint(enic: *mut enic) {
    static void enic_unset_affinity_hint(struct enic *enic)
    {
    int i;
    for (i = 0; i < enic.intr_count; i++)
    irq_update_affinity_hint(enic.msix_entry[i].vector, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn enic_is_dynamic(enic: *mut enic) -> c_int {
    int enic_is_dynamic(struct enic *enic)
    {
    return enic.pdev.device == PCI_DEVICE_ID_CISCO_VIC_ENET_DYN;
    }
#[no_mangle]
pub unsafe extern "C" fn enic_sriov_enabled(enic: *mut enic) -> c_int {
    int enic_sriov_enabled(struct enic *enic)
    {
    return (enic.priv_flags & ENIC_SRIOV_ENABLED) ? 1 : 0;
    }
#[no_mangle]
unsafe extern "C" fn enic_is_sriov_vf(enic: *mut enic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn enic_is_sriov_vf_v2(enic: *mut enic) -> c_int {
    int enic_is_sriov_vf_v2(struct enic *enic)
    {
    return enic.pdev.device == PCI_DEVICE_ID_CISCO_VIC_ENET_VF_V2;
    }
#[no_mangle]
pub unsafe extern "C" fn enic_is_valid_vf(enic: *mut enic, vf: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_log_q_error(enic: *mut enic) -> bool {
...
#[no_mangle]
unsafe extern "C" fn enic_msglvl_check(enic: *mut enic) {
    static void enic_msglvl_check(struct enic *enic)
    {
    let mut msg_enable: u32 = vnic_dev_msg_lvl(enic.vdev);
...
#[no_mangle]
unsafe extern "C" fn enic_mtu_check(enic: *mut enic) {
    static void enic_mtu_check(struct enic *enic)
    {
    let mut mtu: u32 = vnic_dev_mtu(enic.vdev);
...
#[no_mangle]
unsafe extern "C" fn enic_set_rx_coal_setting(enic: *mut enic) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ENIC_LINK_SPEED_4G: speed >) -> else {
...
#[no_mangle]
unsafe extern "C" fn enic_link_notify_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn enic_link_check(enic: *mut enic) {
...
#[no_mangle]
unsafe extern "C" fn enic_notify_check(enic: *mut enic) {
...
#[no_mangle]
unsafe extern "C" fn enic_isr_legacy(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t enic_isr_legacy(int irq, void *data)
    {
    struct net_device *netdev = data;
    struct enic *enic = netdev_priv(netdev);
    let mut io_intr: c_uint = ENIC_LEGACY_IO_INTR;
    let mut err_intr: c_uint = ENIC_LEGACY_ERR_INTR;
    let mut notify_intr: c_uint = ENIC_LEGACY_NOTIFY_INTR;
    u32 pba;
...
#[no_mangle]
unsafe extern "C" fn enic_isr_msi(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn enic_isr_msix(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn enic_isr_msix_err(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t enic_isr_msix_err(int irq, void *data)
    {
    struct enic *enic = data;
    let mut intr: c_uint = enic_msix_err_intr(enic);
...
#[no_mangle]
unsafe extern "C" fn enic_isr_msix_notify(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t enic_isr_msix_notify(int irq, void *data)
    {
    struct enic *enic = data;
    let mut intr: c_uint = enic_msix_notify_intr(enic);
    enic_notify_check(enic);
    vnic_intr_return_all_credits(&enic.intr[intr]);
    return IRQ_HANDLED;
    }
...
// Queue additional data fragments
    ...
    {
    let mut head_len: c_uint = skb_headlen(skb);
    let mut len_left: c_uint = skb.len - head_len;
    let mut eop: c_int = (len_left == 0);
    dma_addr_t dma_addr;
    let mut err: c_int = 0;
...
// The enic_queue_wq_desc() above does not do HW checksum
    ...
    let mut head_len: c_uint = skb_headlen(skb);
    let mut len_left: c_uint = skb.len - head_len;
    let mut hdr_len: c_uint = skb_checksum_start_offset(skb);
    let mut csum_offset: c_uint = hdr_len + skb.csum_offset;
    let mut eop: c_int = (len_left == 0);
    dma_addr_t dma_addr;
    let mut err: c_int = 0;
    dma_addr = dma_map_single(&enic.pdev.dev, skb.data, head_len,
...
#[no_mangle]
unsafe extern "C" fn enic_preload_tcp_csum_encap(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn enic_preload_tcp_csum(skb: *mut sk_buff) {
...
//
    ...
    int loopback)
    {
    let mut frag_len_left: c_uint = skb_headlen(skb);
    let mut len_left: c_uint = skb.len - frag_len_left;
    let mut eop: c_int = (len_left == 0);
...
//
    ...
    {
    let mut mss: c_uint = skb_shinfo(skb).gso_size;
    let mut vlan_tag: c_uint = 0;
    let mut vlan_tag_insert: c_int = 0;
...
// VLAN tag from trunking driver
    ...
    loopback);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: skb->encapsulation) -> else {
...
#[no_mangle]
unsafe extern "C" fn enic_mc_sync(netdev: *mut net_device, mc_addr: *const u8) -> c_int {
    static int enic_mc_sync(struct net_device *netdev, const u8 *mc_addr)
    {
    struct enic *enic = netdev_priv(netdev);
    if (enic.mc_count == ENIC_MULTICAST_PERFECT_FILTERS) {
    let mut mc_count: c_uint = netdev_mc_count(netdev);
...
#[no_mangle]
unsafe extern "C" fn enic_mc_unsync(netdev: *mut net_device, mc_addr: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_uc_sync(netdev: *mut net_device, uc_addr: *const u8) -> c_int {
    static int enic_uc_sync(struct net_device *netdev, const u8 *uc_addr)
    {
    struct enic *enic = netdev_priv(netdev);
    if (enic.uc_count == ENIC_UNICAST_PERFECT_FILTERS) {
    let mut uc_count: c_uint = netdev_uc_count(netdev);
...
#[no_mangle]
unsafe extern "C" fn enic_uc_unsync(netdev: *mut net_device, uc_addr: *const u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn enic_reset_addr_lists(enic: *mut enic) {
...
#[no_mangle]
unsafe extern "C" fn enic_set_mac_addr(netdev: *mut net_device, addr: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_set_mac_address_dynamic(netdev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_set_mac_address(netdev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_set_rx_mode(netdev: *mut net_device) {
    static void enic_set_rx_mode(struct net_device *netdev)
    {
    struct enic *enic = netdev_priv(netdev);
    let mut directed: c_int = 1;
    let mut multicast: c_int = (netdev.flags & IFF_MULTICAST) ? 1 : 0;
    let mut broadcast: c_int = (netdev.flags & IFF_BROADCAST) ? 1 : 0;
...
// netif_tx_lock held, BHs disabled
#[no_mangle]
unsafe extern "C" fn enic_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn enic_set_vf_mac(netdev: *mut net_device, vf: c_int, mac: *mut u8) -> c_int {
...
//
    ...
    struct enic_port_profile *pp;
    let mut err: c_int = 0, restore_pp = 1;
    ENIC_PP_BY_INDEX(enic, vf, pp, &err);
    if (err)
    return err;
...
// If DISASSOCIATE, clean up all assigned/saved macaddresses
    ...
    {
    struct enic *enic = netdev_priv(netdev);
    let mut response: u16 = PORT_PROFILE_RESPONSE_SUCCESS;
    struct enic_port_profile *pp;
    int err;
    ENIC_PP_BY_INDEX(enic, vf, pp, &err);
    if (err)
...
#[no_mangle]
unsafe extern "C" fn enic_set_int_moderation(enic: *mut enic, rq: *mut vnic_rq) {
    static void enic_set_int_moderation(struct enic *enic, struct vnic_rq *rq)
    {
    let mut intr: c_uint = enic_msix_rq_intr(enic, rq.index);
    struct vnic_cq *cq = &enic.cq[enic_cq_rq(enic, rq.index)];
    let mut timer: u32 = cq.tobe_rx_coal_timeval;
...
#[no_mangle]
unsafe extern "C" fn enic_calc_int_moderation(enic: *mut enic, rq: *mut vnic_rq) {
...
#[no_mangle]
unsafe extern "C" fn enic_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int enic_poll(struct napi_struct *napi, int budget)
    {
    struct net_device *netdev = napi.dev;
    struct enic *enic = netdev_priv(netdev);
    let mut cq_rq: c_uint = enic_cq_rq(enic, 0);
    let mut cq_wq: c_uint = enic_cq_wq(enic, 0);
    let mut intr: c_uint = ENIC_LEGACY_IO_INTR;
    let mut rq_work_to_do: c_uint = budget;
    let mut wq_work_to_do: c_uint = ENIC_WQ_NAPI_BUDGET;
...
#[no_mangle]
unsafe extern "C" fn enic_free_rx_cpu_rmap(enic: *mut enic) {
    static void enic_free_rx_cpu_rmap(struct enic *enic)
    {
    free_irq_cpu_rmap(enic.netdev.rx_cpu_rmap);
    enic.netdev.rx_cpu_rmap = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn enic_set_rx_cpu_rmap(enic: *mut enic) {
...
#[no_mangle]
unsafe extern "C" fn enic_poll_msix_wq(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int enic_poll_msix_wq(struct napi_struct *napi, int budget)
    {
    struct net_device *netdev = napi.dev;
    struct enic *enic = netdev_priv(netdev);
    let mut wq_index: c_uint = (napi - &enic.napi[0]) - enic.rq_count;
...
#[no_mangle]
unsafe extern "C" fn enic_poll_msix_rq(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int enic_poll_msix_rq(struct napi_struct *napi, int budget)
    {
    struct net_device *netdev = napi.dev;
    struct enic *enic = netdev_priv(netdev);
    let mut rq: c_uint = (napi - &enic.napi[0]);
    let mut cq: c_uint = enic_cq_rq(enic, rq);
    let mut intr: c_uint = enic_msix_rq_intr(enic, rq);
    let mut work_to_do: c_uint = budget;
...
#[no_mangle]
unsafe extern "C" fn enic_notify_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn enic_free_intr(enic: *mut enic) {
...
#[no_mangle]
unsafe extern "C" fn enic_request_intr(enic: *mut enic) -> c_int {
    ...
    for (i = 0; i < enic.wq_count; i++) {
    let mut wq: c_int = enic_cq_wq(enic, i);
...
#[no_mangle]
unsafe extern "C" fn enic_synchronize_irqs(enic: *mut enic) {
...
#[no_mangle]
unsafe extern "C" fn enic_dev_notify_set(enic: *mut enic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_notify_timer_start(enic: *mut enic) {
...
#[no_mangle]
unsafe extern "C" fn enic_open(netdev: *mut net_device) -> c_int {
    static int enic_open(struct net_device *netdev)
    {
    struct enic *enic = netdev_priv(netdev);
    unsigned int i;
    int err, ret;
    let mut max_pkt_len: c_uint = netdev.mtu + VLAN_ETH_HLEN;
...
// create a page pool for each RQ
    ...
    enic.rq[i].pool = core::ptr::null_mut();
...
// rtnl lock is held, process context
#[no_mangle]
unsafe extern "C" fn enic_stop(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _enic_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
    static int _enic_change_mtu(struct net_device *netdev, int new_mtu)
    {
    let mut running: bool = netif_running(netdev);
    let mut err: c_int = 0;
    ASSERT_RTNL();
    if (running) {
...
#[no_mangle]
unsafe extern "C" fn enic_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_change_mtu_work(work: *mut work_struct) {
    static void enic_change_mtu_work(struct work_struct *work)
    {
    struct enic *enic = container_of(work, struct enic, change_mtu_work);
    struct net_device *netdev = enic.netdev;
    let mut new_mtu: c_int = vnic_dev_mtu(enic.vdev);
    rtnl_lock();
...
#[no_mangle]
unsafe extern "C" fn enic_poll_controller(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn enic_dev_open(enic: *mut enic) -> c_int {
    static int enic_dev_open(struct enic *enic)
    {
    int err;
    let mut flags: u32 = CMD_OPENF_IG_DESCCACHE;
...
#[no_mangle]
unsafe extern "C" fn enic_dev_soft_reset(enic: *mut enic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_dev_hang_reset(enic: *mut enic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __enic_set_rsskey(enic: *mut enic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_set_rsskey(enic: *mut enic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_set_rsscpu(enic: *mut enic, rss_hash_bits: u8) -> c_int {
    static int enic_set_rsscpu(struct enic *enic, u8 rss_hash_bits)
    {
    dma_addr_t rss_cpu_buf_pa;
    union vnic_rss_cpu *rss_cpu_buf_va = core::ptr::null_mut();
    unsigned int i;
    int err;
    ...
    {
    let mut tso_ipid_split_en: u8 = 0;
    let mut ig_vlan_strip_en: u8 = 1;
    int err;
...
#[no_mangle]
unsafe extern "C" fn enic_set_rss_nic_cfg(enic: *mut enic) -> c_int {
    static int enic_set_rss_nic_cfg(struct enic *enic)
    {
    struct device *dev = enic_get_dev(enic);
    let mut rss_default_cpu: u8 = 0;
    let mut rss_hash_bits: u8 = 7;
    let mut rss_base_cpu: u8 = 0;
    u8 rss_hash_type;
    int res;
    let mut rss_enable: u8 = ENIC_SETTING(enic, RSS) && (enic.rq_count > 1);
    spin_lock_bh(&enic.devcmd_lock);
...
#[no_mangle]
unsafe extern "C" fn enic_set_api_busy(enic: *mut enic, busy: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn enic_has_admin_chan(enic: *mut enic) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn enic_admin_chan_reopen(enic: *mut enic) {
...
#[no_mangle]
unsafe extern "C" fn enic_reset(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn enic_tx_hang_reset(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn enic_set_intr_mode(enic: *mut enic) -> c_int {
    static int enic_set_intr_mode(struct enic *enic)
    {
    let mut admin_reserve: c_uint = enic.has_admin_channel ? 1 : 0;
    let mut min_intr: c_uint = ENIC_MSIX_MIN_INTR + admin_reserve;
    unsigned int i;
    int num_intr;
...
#[no_mangle]
unsafe extern "C" fn enic_clear_intr_mode(enic: *mut enic) {
...
#[no_mangle]
unsafe extern "C" fn enic_adjust_resources(enic: *mut enic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_free_enic_resources(enic: *mut enic) {
    static void enic_free_enic_resources(struct enic *enic)
    {
    kfree(enic.wq);
    enic.wq = core::ptr::null_mut();
    kfree(enic.rq);
    enic.rq = core::ptr::null_mut();
    kfree(enic.cq);
    enic.cq = core::ptr::null_mut();
    kfree(enic.napi);
    enic.napi = core::ptr::null_mut();
    kfree(enic.msix_entry);
    enic.msix_entry = core::ptr::null_mut();
    kfree(enic.msix);
    enic.msix = core::ptr::null_mut();
    kfree(enic.intr);
    enic.intr = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn enic_alloc_enic_resources(enic: *mut enic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_dev_deinit(enic: *mut enic) {
...
#[no_mangle]
unsafe extern "C" fn enic_dev_init(enic: *mut enic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enic_iounmap(enic: *mut enic) {
...
#[no_mangle]
unsafe extern "C" fn enic_sriov_detect_vf_type(enic: *mut enic) {
...
//
    ...
    free_vf_state:
    kfree(enic.vf_state);
    enic.vf_state = core::ptr::null_mut();
    return err;
    }
#[no_mangle]
unsafe extern "C" fn enic_sriov_v2_disable(enic: *mut enic) {
...
#[no_mangle]
unsafe extern "C" fn enic_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
//
    enic.vdev = vnic_dev_register(core::ptr::null_mut(), enic, pdev, enic.bar,
    ARRAY_SIZE(enic.bar));
    if (!enic.vdev) {
...
// MTU range: 68 - 9000
    ...
    let mut unreg_err: c_int = enic_mbox_vf_unregister(enic);
    if (unreg_err)
    netdev_warn(netdev,
...
#[no_mangle]
unsafe extern "C" fn enic_remove(pdev: *mut pci_dev) {
