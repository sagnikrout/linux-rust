...
//! Source: drivers/net/ethernet/cisco/enic/vnic_cq.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vnic_rx_bytes_counter {
    pub small_pkt_bytes_cnt: c_uint,
    pub large_pkt_bytes_cnt: c_uint,
}
...
pub struct vnic_cq {
    ...
    pub interrupt_offset: c_uint,
    pub pkt_size_counter: vnic_rx_bytes_counter,
    pub cur_rx_coal_timeval: c_uint,
    pub tobe_rx_coal_timeval: c_uint,
    pub prev_ts: ktime_t,
}
...
pub const VNIC_CQ_FC_ENABLE: c_int = 1;
pub const VNIC_CQ_FC_DISABLE: c_int = 0;
pub const VNIC_CQ_COLOR_ENABLE: c_int = 1;
pub const VNIC_CQ_INTR_ENABLE: c_int = 1;
pub const VNIC_CQ_INTR_DISABLE: c_int = 0;
pub const VNIC_CQ_ENTRY_ENABLE: c_int = 1;
pub const VNIC_CQ_MSG_ENABLE: c_int = 1;
pub const VNIC_CQ_MSG_DISABLE: c_int = 0;
extern "C" {
