...
//! Source: drivers/net/ethernet/cisco/enic/vnic_wq.h
#![no_std]
...
pub struct vnic_wq_buf {
    ...
    pub sop: c_int,
    pub desc: *mut c_void,
    pub /: *mut *mut uint64_t wr_id; / Cookie,
    pub /: *mut *mut uint8_t cq_entry; / Gets completion event from hw,
    pub /: *mut *mut uint8_t desc_skip_cnt; / Num descs to occupy,
    pub /: *mut *mut uint8_t compressed_send; / Both hdr and payload in one desc,
    pub prev: *mut vnic_wq_buf,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct devcmd2_controller {
    pub wq_ctrl: *mut vnic_wq_ctrl __iomem,
    pub cmd_ring: *mut vnic_devcmd2,
    pub result: *mut devcmd2_result,
    pub next_result: u16,
    pub result_size: u16,
    pub color: c_int,
    pub results_ring: vnic_dev_ring,
    pub wq: vnic_wq,
    pub posted: u32,
}
...
//
extern "C" {
    pub fn vnic_wq_free(wq: *mut vnic_wq);
}
extern "C" {
    pub fn vnic_wq_error_status(wq: *mut vnic_wq) -> c_uint;
}
extern "C" {
    pub fn vnic_wq_enable(wq: *mut vnic_wq);
}
extern "C" {
    pub fn vnic_wq_disable(wq: *mut vnic_wq) -> c_int;
}
