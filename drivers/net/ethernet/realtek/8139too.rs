...
//! Source: drivers/net/ethernet/realtek/8139too.c
#![no_std]
...
pub const RTL8139_DEBUG: c_int = 0;
...
// Whether to use MMIO or PIO. Default to MMIO.
    ...
    let mut use_io: static bool = true;

    let mut use_io: static bool = false;
...
pub const RX_BUF_PAD: c_int = 16;

// Number of Tx descriptor registers.
pub const NUM_TX_DESC: c_int = 4;
// max supported ethernet frame size -- must be at least (dev->mtu+18+4).
pub const MAX_ETH_FRAME_SIZE: c_int = 1792;
...
pub const RTL_MIN_IO_SIZE: c_uint = 0x80;
pub const RTL8139B_IO_SIZE: c_int = 256;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtl_extra_stats {
    pub early_rx: c_ulong,
    pub tx_buf_mapped: c_ulong,
    pub tx_timeouts: c_ulong,
    pub rx_lost_in_ring: c_ulong,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtl8139_stats {
    pub packets: u64,
    pub bytes: u64,
...
pub struct rtl8139_private {
    ...
    pub rx_ring: *mut c_uchar,
    pub /: *mut *mut unsigned int cur_rx; / RX buf index of next pkt,
    pub rx_stats: rtl8139_stats,
    pub rx_ring_dma: dma_addr_t,
    pub tx_flag: c_uint,
    pub cur_tx: c_ulong,
    pub dirty_tx: c_ulong,
    pub tx_stats: rtl8139_stats,
    pub /: *mut *mut *mut unsigned char tx_buf[NUM_TX_DESC]; / Tx bounce buffers,
    pub /: *mut *mut *mut unsigned char tx_bufs; / Tx bounce buffer region.,
    pub tx_bufs_dma: dma_addr_t,
    pub /: *mut *mut signed char phys[4]; / MII device addresses.,
// Twister tune state.
    pub twist_col: char twistie, twist_row,,
    pub 1: unsigned int watchdog_fired :,
    pub /: *mut *mut unsigned int default_port : 4; / Last dev->if_port value.,
    pub 1: unsigned int have_thread :,
    pub lock: spinlock_t,
    pub rx_lock: spinlock_t,
    pub chipset: chip_t,
    pub rx_config: u32,
    pub xstats: rtl_extra_stats,
    pub thread: delayed_work,
    pub mii: mii_if_info,
    pub regs_len: c_uint,
    pub fifo_copy_timeout: c_ulong,
}
    ...
    module_param_array(media, int, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn __rtl8139_cleanup_dev(dev: *mut net_device) {
    static void __rtl8139_cleanup_dev (struct net_device *dev)
    {
    struct rtl8139_private *tp = netdev_priv(dev);
    struct pci_dev *pdev;
    assert (dev != core::ptr::null_mut());
    assert (tp.pci_dev != core::ptr::null_mut());
    pdev = tp.pci_dev;
    if (tp.mmio_addr)
...
#[no_mangle]
unsafe extern "C" fn rtl8139_chip_reset(ioaddr: *mut void __iomem) {
...
// if unknown chip, assume array element #0, original RTL-8139 in this case
    ...
    let mut new_tmp8: u8 = tmp8 = RTL_R8 (Config1);
...
#[no_mangle]
unsafe extern "C" fn rtl8139_set_features(dev: *mut net_device, features: netdev_features_t) -> c_int {
    ...
    if (changed & NETIF_F_RXALL) {
    let mut rx_mode: c_int = tp.rx_config;
    ...
    tp.dev = dev;
    ioaddr = tp.mmio_addr;
    assert (ioaddr != core::ptr::null_mut());
...
// Find the connected MII xcvrs.
    ...
    let mut mii_status: c_int = mdio_read(dev, phy, 1);
    if (mii_status != 0xffff  &&  mii_status != 0x0000) {
    let mut advertising: u16 = mdio_read(dev, phy, 4);
    tp.phys[phy_idx++] = phy;
...
#[no_mangle]
unsafe extern "C" fn rtl8139_remove_one(pdev: *mut pci_dev) {
...
// EEPROM_Ctrl bits.
pub const EE_SHIFT_CLK: c_uint = 0x04	/* EEPROM shift clock. */;
pub const EE_CS: c_uint = 0x08	/* EEPROM chip select. */;
pub const EE_DATA_WRITE: c_uint = 0x02	/* EEPROM chip data in. */;
pub const EE_WRITE_0: c_uint = 0x00;
pub const EE_WRITE_1: c_uint = 0x02;
pub const EE_DATA_READ: c_uint = 0x01	/* EEPROM chip data out. */;
...
#[no_mangle]
unsafe extern "C" fn read_eeprom(ioaddr: *mut void __iomem, location: c_int, addr_len: c_int) -> c_int {
    static int read_eeprom(void __iomem *ioaddr, int location, int addr_len)
    {
    int i;
...
// Shift the read command bits out.
    ...
    let mut dataval: c_int = (read_cmd & (1 << i)) ? EE_DATA_WRITE : 0;
...
// Read and write the MII management registers using software-generated
    ...
    "overclocking" issues. */
pub const MDIO_DIR: c_uint = 0x80;
pub const MDIO_DATA_OUT: c_uint = 0x04;
pub const MDIO_DATA_IN: c_uint = 0x02;
pub const MDIO_CLK: c_uint = 0x01;
...
#[no_mangle]
unsafe extern "C" fn mdio_sync(ioaddr: *mut void __iomem) {
...
// Shift the read command bits out.
    for (i = 15; i >= 0; i--) {
    let mut dataval: c_int = (mii_cmd & (1 << i)) ? MDIO_DATA_OUT : 0;
...
#[no_mangle]
unsafe extern "C" fn rtl8139_open(dev: *mut net_device) -> c_int {
    static int rtl8139_open (struct net_device *dev)
    {
    struct rtl8139_private *tp = netdev_priv(dev);
    void __iomem *ioaddr = tp.mmio_addr;
    ...
    if (tp.tx_bufs == core::ptr::null_mut() || tp.rx_ring == core::ptr::null_mut()) {
    free_irq(irq, dev);
    if (tp.tx_bufs)
...
#[no_mangle]
unsafe extern "C" fn rtl_check_media(dev: *mut net_device, init_media: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_hw_start(dev: *mut net_device) {
    static void rtl8139_hw_start (struct net_device *dev)
    {
    struct rtl8139_private *tp = netdev_priv(dev);
    void __iomem *ioaddr = tp.mmio_addr;
...
#[no_mangle]
unsafe extern "C" fn rtl8139_init_ring(dev: *mut net_device) {
    static void rtl8139_init_ring (struct net_device *dev)
    {
    struct rtl8139_private *tp = netdev_priv(dev);
    int i;
...
// This must be global for CONFIG_8139TOO_TUNE_TWISTER case
    let mut next_tick: static int = 3 * HZ;
...
// Read how long it took to hear the echo.
    ...
    tp.twist_row = 3;
#[no_mangle]
pub unsafe extern "C" fn if(0x3000: linkcase ==) -> else {
    else if (linkcase == 0x3000)
    tp.twist_row = 2;
#[no_mangle]
pub unsafe extern "C" fn if(0x1000: linkcase ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_thread(work: *mut work_struct) {
    static void rtl8139_thread (struct work_struct *work)
    {
    struct rtl8139_private *tp =
    container_of(work, struct rtl8139_private, thread.work);
    struct net_device *dev = tp.mii.dev;
    let mut thr_delay: c_ulong = next_tick;
    rtnl_lock();
...
#[no_mangle]
unsafe extern "C" fn rtl8139_start_thread(tp: *mut rtl8139_private) {
    static void rtl8139_start_thread(struct rtl8139_private *tp)
    {
    tp.twistie = 0;
    ...
    tp.twistie = 1;
#[no_mangle]
pub unsafe extern "C" fn if(HAS_LNK_CHNG: tp->drv_flags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8139_tx_clear(tp: *mut rtl8139_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_tx_timeout_task(work: *mut work_struct) {
    static void rtl8139_tx_timeout_task (struct work_struct *work)
    {
    struct rtl8139_private *tp =
    container_of(work, struct rtl8139_private, thread.work);
...
#[no_mangle]
unsafe extern "C" fn rtl8139_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
    static void rtl8139_tx_timeout(struct net_device *dev, unsigned int txqueue)
    {
    struct rtl8139_private *tp = netdev_priv(dev);
    tp.watchdog_fired = 1;
...
//
    ...
    while (tx_left > 0) {
    let mut entry: c_int = dirty_tx % NUM_TX_DESC;
    int txstatus;
...
// A.C.: Reset the multicast list.
    ...
    {
    let mut left: u32 = RX_BUF_LEN - offset;
    if (size > left) {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_isr_ack(tp: *mut rtl8139_private) {
...
// Clear out errors and receive interrupts
    ...
    let mut cur_rx: c_uint = tp.cur_rx;
    let mut rx_size: c_uint = 0;
    ...
    let mut ring_offset: u32 = cur_rx % RX_BUF_LEN;
    u32 rx_status;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: time_after(jiffies, _arg: tp->fifo_copy_timeout)) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int rtl8139_poll(struct napi_struct *napi, int budget)
    {
...
// The interrupt handler does all of the Rx thread work and cleans up
    after the Tx thread. */
#[no_mangle]
unsafe extern "C" fn rtl8139_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
    static irqreturn_t rtl8139_interrupt (int irq, void *dev_instance)
    {
...
//
#[no_mangle]
unsafe extern "C" fn rtl8139_poll_controller(dev: *mut net_device) {
    static void rtl8139_poll_controller(struct net_device *dev)
    {
    struct rtl8139_private *tp = netdev_priv(dev);
    let mut irq: c_int = tp.pci_dev.irq;
...
#[no_mangle]
unsafe extern "C" fn rtl8139_set_mac_address(dev: *mut net_device, p: *mut c_void) -> c_int {
    static int rtl8139_set_mac_address(struct net_device *dev, void *p)
    {
    struct rtl8139_private *tp = netdev_priv(dev);
    void __iomem *ioaddr = tp.mmio_addr;
...
#[no_mangle]
unsafe extern "C" fn rtl8139_close(dev: *mut net_device) -> c_int {
    static int rtl8139_close (struct net_device *dev)
    {
    struct rtl8139_private *tp = netdev_priv(dev);
    void __iomem *ioaddr = tp.mmio_addr;
...
// Update the error counts.
    ...
    dma_free_coherent(&tp.pci_dev.dev, TX_BUF_TOT_LEN,
    tp.tx_bufs, tp.tx_bufs_dma);
    tp.rx_ring = core::ptr::null_mut();
    tp.tx_bufs = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rtl8139_get_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) {
    ...
    spin_lock_irq(&tp.lock);
    if (rtl_chip_info[tp.chipset].flags & HasLWake) {
    let mut cfg3: u8 = RTL_R8 (Config3);
    let mut cfg5: u8 = RTL_R8 (Config5);
...
#[no_mangle]
unsafe extern "C" fn rtl8139_set_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_get_drvinfo(dev: *mut net_device, info: *mut ethtool_drvinfo) {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_nway_reset(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_get_link(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_get_msglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_set_msglevel(dev: *mut net_device, datum: u32) {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_get_regs_len(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_get_regs(dev: *mut net_device, regs: *mut ethtool_regs, regbuf: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_get_ethtool_stats(dev: *mut net_device, stats: *mut ethtool_stats, data: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_get_strings(dev: *mut net_device, stringset: u32, data: *mut u8) {
...
unsafe extern "C" fn netdev_ioctl(dev: *mut net_device, rq: *mut ifreq, cmd: c_int) -> c_int {
    ...
    return -EINVAL;
    spin_lock_irq(&tp.lock);
    rc = generic_mii_ioctl(&tp.mii, if_mii(rq), cmd, core::ptr::null_mut());
    spin_unlock_irq(&tp.lock);
    return rc;
    }
    static void
...
#[no_mangle]
unsafe extern "C" fn rtl8139_set_rx_mode(dev: *mut net_device) {
    static void rtl8139_set_rx_mode (struct net_device *dev)
    {
    unsigned long flags;
    struct rtl8139_private *tp = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn rtl8139_suspend(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn rtl8139_resume(device: *mut device) -> int __maybe_unused {
