...
//! Source: drivers/net/ethernet/realtek/r8169_phy_config.c
#![no_std]
...
//
    ...
    {
    let mut oldpage: c_int = phy_select_page(phydev, 0x0007);
    ...
    u16 mask, u16 val)
    {
    let mut oldpage: c_int = phy_select_page(phydev, 0x0005);
    ...
    u16 mask, u16 val)
    {
    let mut oldpage: c_int = phy_select_page(phydev, 0x0a43);
...
#[no_mangle]
unsafe extern "C" fn rtl8168f_config_eee_phy(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn rtl8168g_config_eee_phy(phydev: *mut phy_device) {
    static void rtl8168g_config_eee_phy(struct phy_device *phydev)
    {
    phy_modify_paged(phydev, 0x0a43, 0x11, 0, BIT(4));
    }
#[no_mangle]
unsafe extern "C" fn rtl8168h_config_eee_phy(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn rtl8125_common_config_eee_phy(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn rtl8125_config_eee_phy(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn rtl8168d_1_common(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn rtl8125_legacy_force_mode(phydev: *mut phy_device) {
...
// PCI-E devices.
    ...
    [RTL_GIGA_MAC_VER_31] = core::ptr::null_mut(),
