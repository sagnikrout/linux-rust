...
//! Source: drivers/net/ethernet/realtek/r8169_main.c
#![no_std]
...
pub const InterFrameGap: c_uint = 0x03	/* 3 means InterFrameGap = the shortest one */;
pub const R8169_REGS_SIZE: c_int = 256;

pub const OCP_STD_PHY_BASE: c_uint = 0xa400;
pub const RTL_CFG_NO_GBIT: c_int = 1;
...
pub const RXCFG_FIFO_SHIFT: c_int = 13;
// No threshold before first PCI xfer

pub const RXCFG_DMA_SHIFT: c_int = 8;
...
pub const RTL_COALESCE_T_MAX: c_uint = 0x0fU;

    RxDescAddrLow	= 0xe4,
    RxDescAddrHigh	= 0xe8,
    EarlyTxThres	= 0xec,	/* 8169. Unit of 32 bytes. */
pub const NoEarlyTx: c_uint = 0x3f	/* Max value : no early transmit. */;
    MaxTxPacketSize	= 0xec,	/* 8101/8168. Unit of 128 bytes. */

pub const EarlySize: c_uint = 0x27;
    FuncEvent	= 0xf0,
    FuncEventMask	= 0xf4,
    ...
    CSIDR			= 0x64,
    CSIAR			= 0x68,
pub const CSIAR_FLAG: c_uint = 0x80000000;
pub const CSIAR_WRITE_CMD: c_uint = 0x80000000;
pub const CSIAR_BYTE_ENABLE: c_uint = 0x0000f000;
pub const CSIAR_ADDR_MASK: c_uint = 0x00000fff;
    PMCH			= 0x6f,

    EPHYAR			= 0x80,
pub const EPHYAR_FLAG: c_uint = 0x80000000;
pub const EPHYAR_WRITE_CMD: c_uint = 0x80000000;
pub const EPHYAR_REG_MASK: c_uint = 0x1f;
pub const EPHYAR_REG_SHIFT: c_int = 16;
pub const EPHYAR_DATA_MASK: c_uint = 0xffff;
    DLLPR			= 0xd0,
    ...
    EFUSEAR			= 0xdc,
pub const EFUSEAR_FLAG: c_uint = 0x80000000;
pub const EFUSEAR_WRITE_CMD: c_uint = 0x80000000;
pub const EFUSEAR_READ_CMD: c_uint = 0x00000000;
pub const EFUSEAR_REG_MASK: c_uint = 0x03ff;
pub const EFUSEAR_REG_SHIFT: c_int = 8;
pub const EFUSEAR_DATA_MASK: c_uint = 0xff;
    MISC_1			= 0xf2,
    ...
    ERIDR			= 0x70,
    ERIAR			= 0x74,
pub const ERIAR_FLAG: c_uint = 0x80000000;
pub const ERIAR_WRITE_CMD: c_uint = 0x80000000;
pub const ERIAR_READ_CMD: c_uint = 0x00000000;
pub const ERIAR_ADDR_BYTE_ALIGN: c_int = 4;
pub const ERIAR_TYPE_SHIFT: c_int = 16;

pub const ERIAR_MASK_SHIFT: c_int = 12;

    EPHY_RXER_NUM		= 0x7c,
    OCPDR			= 0xb0,	/* OCP GPHY access */
pub const OCPDR_WRITE_CMD: c_uint = 0x80000000;
pub const OCPDR_READ_CMD: c_uint = 0x00000000;
pub const OCPDR_REG_MASK: c_uint = 0x7f;
pub const OCPDR_GPHY_REG_SHIFT: c_int = 16;
pub const OCPDR_DATA_MASK: c_uint = 0xffff;
    OCPAR			= 0xb4,
pub const OCPAR_FLAG: c_uint = 0x80000000;
pub const OCPAR_GPHY_WRITE_CMD: c_uint = 0x8000f060;
pub const OCPAR_GPHY_READ_CMD: c_uint = 0x0000f060;
    GPHY_OCP		= 0xb8,
...
pub const LEDSEL_MASK_8125: c_uint = 0x23f;
...
// rx_mode_bits
    AcceptErr	= 0x20,
    AcceptRunt	= 0x10,
pub const RX_CONFIG_ACCEPT_ERR_MASK: c_uint = 0x30;
    AcceptBroadcast	= 0x08,
    AcceptMulticast	= 0x04,
    AcceptMyPhys	= 0x02,
    AcceptAllPhys	= 0x01,
pub const RX_CONFIG_ACCEPT_OK_MASK: c_uint = 0x0f;
pub const RX_CONFIG_ACCEPT_MASK: c_uint = 0x3f;
// TxConfigBits
...
pub const TD_MSS_MAX: c_uint = 0x07ffu	/* MSS value */;
// Second doubleword.
...
pub const GTTCPHO_MAX: c_uint = 0x7f;
// Second doubleword.
pub const TCPHO_SHIFT: c_int = 18;
pub const TCPHO_MAX: c_uint = 0x3ff;
...
pub const RTL_GSO_MAX_SIZE_V1: c_int = 32000;
pub const RTL_GSO_MAX_SEGS_V1: c_int = 24;
pub const RTL_GSO_MAX_SIZE_V2: c_int = 64000;
pub const RTL_GSO_MAX_SEGS_V2: c_int = 64;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct TxDesc {
    pub opts1: __le32,
...
// new since RTL8125
    pub tx_octets: __le64,
    pub rx_octets: __le64,
    pub rx_multicast64: __le64,
    pub tx_unicast64: __le64,
    pub tx_broadcast64: __le64,
    pub tx_multicast64: __le64,
    pub tx_pause_on: __le32,
    pub tx_pause_off: __le32,
    pub tx_pause_all: __le32,
    pub tx_deferred: __le32,
    pub tx_late_collision: __le32,
    pub tx_all_collision: __le32,
    pub tx_aborted32: __le32,
    pub align_errors32: __le32,
    pub rx_frame_too_long: __le32,
    pub rx_runt: __le32,
    pub rx_pause_on: __le32,
    pub rx_pause_off: __le32,
    pub rx_pause_all: __le32,
    pub rx_unknown_opcode: __le32,
    pub rx_mac_error: __le32,
    pub tx_underrun32: __le32,
    pub rx_mac_missed: __le32,
    pub rx_tcam_dropped: __le32,
    pub tdu: __le32,
    pub rdu: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtl8169_private {
    pub /: *mut *mut *mut void __iomem mmio_addr; / memory map physical address,
    pub pci_dev: *mut pci_dev,
    pub dev: *mut net_device,
    pub phydev: *mut phy_device,
    pub napi: napi_struct,
    pub mac_version: enum mac_version,
    pub dash_type: enum rtl_dash_type,
    pub /: *mut *mut u32 cur_rx; / Index into the Rx descriptor buffer of next Rx pkt.,
    pub /: *mut *mut u32 cur_tx; / Index into the Tx descriptor buffer of next Rx pkt.,
    pub dirty_tx: u32,
    pub /: *mut *mut *mut TxDesc TxDescArray; / 256-aligned Tx descriptor ring,
    pub /: *mut *mut *mut RxDesc RxDescArray; / 256-aligned Rx descriptor ring,
    pub TxPhyAddr: dma_addr_t,
    pub RxPhyAddr: dma_addr_t,
    pub /: *mut *mut *mut page Rx_databuff[NUM_RX_DESC]; / Rx data buffers,
    pub /: *mut *mut ring_info tx_skb[NUM_TX_DESC]; / Tx data buffers,
    pub cp_cmd: u16,
    pub tx_lpi_timer: u16,
    pub irq_mask: u32,
    pub irq: c_int,
    pub clk: *mut clk,
    struct {
    pub RTL_FLAG_MAX): DECLARE_BITMAP(flags,,
    pub work: work_struct,
    pub wk: },
    pub mac_ocp_lock: raw_spinlock_t,
    pub /: *mut *mut mutex led_lock; / serialize LED ctrl RMW access,
    pub supports_gmii:1: unsigned,
    pub aspm_manageable:1: unsigned,
    pub dash_enabled:1: unsigned,
    pub sfp_mode:1: bool,
    pub counters_phys_addr: dma_addr_t,
    pub counters: *mut rtl8169_counters,
    pub tc_offset: rtl8169_tc_offsets,
    pub saved_wolopts: u32,
    pub fw_name: *const c_char,
    pub rtl_fw: *mut rtl_fw,
    pub leds: *mut r8169_led_classdev,
    pub ocp_base: u32,
}
...
#[no_mangle]
unsafe extern "C" fn rtl_lock_config_regs(tp: *mut rtl8169_private) {
    static void rtl_lock_config_regs(struct rtl8169_private *tp)
    {
    RTL_W8(tp, Cfg9346, Cfg9346_Lock);
    }
#[no_mangle]
unsafe extern "C" fn rtl_unlock_config_regs(tp: *mut rtl8169_private) {
    static void rtl_unlock_config_regs(struct rtl8169_private *tp)
    {
    RTL_W8(tp, Cfg9346, Cfg9346_Unlock);
    }
#[no_mangle]
unsafe extern "C" fn rtl_pci_commit(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_mod_config2(tp: *mut rtl8169_private, clear: u8, set: u8) {
...
#[no_mangle]
unsafe extern "C" fn rtl_mod_config5(tp: *mut rtl8169_private, clear: u8, set: u8) {
...
#[no_mangle]
unsafe extern "C" fn rtl_is_8125(tp: *mut rtl8169_private) -> bool {
    static bool rtl_is_8125(struct rtl8169_private *tp)
    {
    return tp.mac_version >= RTL_GIGA_MAC_VER_61;
    }
#[no_mangle]
unsafe extern "C" fn rtl_is_8168evl_up(tp: *mut rtl8169_private) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rtl_supports_eee(tp: *mut rtl8169_private) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rtl_read_mac_from_reg(tp: *mut rtl8169_private, mac: *mut u8, reg: c_int) {
...
#[derive(Copy, Clone)]
pub struct rtl_cond {
    pub ): *mut *mut bool (check)(struct rtl8169_private,
...
#[no_mangle]
pub unsafe extern "C" fn rtl8168_led_mod_ctrl(tp: *mut rtl8169_private, mask: u16, val: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8168_get_led_mode(tp: *mut rtl8169_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8125_get_led_reg(index: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8125_set_led_mode(tp: *mut rtl8169_private, index: c_int, mode: u16) -> c_int {
    int rtl8125_set_led_mode(struct rtl8169_private *tp, int index, u16 mode)
    {
    let mut reg: c_int = rtl8125_get_led_reg(index);
    struct device *dev = tp_to_dev(tp);
    int ret;
    u16 val;
    ret = pm_runtime_resume_and_get(dev);
...
#[no_mangle]
pub unsafe extern "C" fn rtl8125_get_led_mode(tp: *mut rtl8169_private, index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r8168fp_adjust_ocp_cmd(tp: *mut rtl8169_private, cmd: *mut u32, type: c_int) {
...
// cmd |= 0xf70 << 18;
    ...
    u32 val, int type)
    {
    let mut cmd: u32 = ERIAR_WRITE_CMD | type | mask | addr;
...
#[no_mangle]
unsafe extern "C" fn _rtl_eri_read(tp: *mut rtl8169_private, addr: c_int, type: c_int) -> u32 {
    static u32 _rtl_eri_read(struct rtl8169_private *tp, int addr, int type)
    {
    let mut cmd: u32 = ERIAR_READ_CMD | type | ERIAR_MASK_1111 | addr;
    r8168fp_adjust_ocp_cmd(tp, &cmd, type);
    RTL_W32(tp, ERIAR, cmd);
...
#[no_mangle]
unsafe extern "C" fn rtl_eri_read(tp: *mut rtl8169_private, addr: c_int) -> u32 {
    static u32 rtl_eri_read(struct rtl8169_private *tp, int addr)
    {
    return _rtl_eri_read(tp, addr, ERIAR_EXGMAC);
    }
#[no_mangle]
unsafe extern "C" fn rtl_w0w1_eri(tp: *mut rtl8169_private, addr: c_int, p: u32, m: u32) {
    static void rtl_w0w1_eri(struct rtl8169_private *tp, int addr, u32 p, u32 m)
    {
    let mut val: u32 = rtl_eri_read(tp, addr);
    rtl_eri_write(tp, addr, ERIAR_MASK_1111, (val & ~m) | p);
    }
#[no_mangle]
unsafe extern "C" fn rtl_eri_set_bits(tp: *mut rtl8169_private, addr: c_int, p: u32) {
    static void rtl_eri_set_bits(struct rtl8169_private *tp, int addr, u32 p)
    {
    rtl_w0w1_eri(tp, addr, p, 0);
    }
#[no_mangle]
unsafe extern "C" fn rtl_eri_clear_bits(tp: *mut rtl8169_private, addr: c_int, m: u32) {
    static void rtl_eri_clear_bits(struct rtl8169_private *tp, int addr, u32 m)
    {
    rtl_w0w1_eri(tp, addr, 0, m);
    }
#[no_mangle]
unsafe extern "C" fn rtl_ocp_reg_failure(reg: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn r8168_phy_ocp_write(tp: *mut rtl8169_private, reg: u32, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn r8168_phy_ocp_read(tp: *mut rtl8169_private, reg: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __r8168_mac_ocp_write(tp: *mut rtl8169_private, reg: u32, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn r8168_mac_ocp_write(tp: *mut rtl8169_private, reg: u32, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn __r8168_mac_ocp_read(tp: *mut rtl8169_private, reg: u32) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn r8168_mac_ocp_read(tp: *mut rtl8169_private, reg: u32) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn r8127_sfp_sds_phy_reset(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn r8127_sfp_init_10g(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_sfp_init(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_sfp_reset(tp: *mut rtl8169_private) {
...
//
#[no_mangle]
unsafe extern "C" fn rtl8168g_phy_suspend_quirk(tp: *mut rtl8169_private, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn r8168g_mdio_write(tp: *mut rtl8169_private, reg: c_int, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn r8168g_mdio_read(tp: *mut rtl8169_private, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac_mcu_write(tp: *mut rtl8169_private, reg: c_int, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mac_mcu_read(tp: *mut rtl8169_private, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r8169_mdio_write(tp: *mut rtl8169_private, reg: c_int, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn r8169_mdio_read(tp: *mut rtl8169_private, reg: c_int) -> c_int {
...
pub const R8168DP_1_MDIO_ACCESS_BIT: c_uint = 0x00020000;
#[no_mangle]
unsafe extern "C" fn r8168dp_2_mdio_start(tp: *mut rtl8169_private) {
    static void r8168dp_2_mdio_start(struct rtl8169_private *tp)
    {
    RTL_W32(tp, 0xd0, RTL_R32(tp, 0xd0) & ~R8168DP_1_MDIO_ACCESS_BIT);
    }
#[no_mangle]
unsafe extern "C" fn r8168dp_2_mdio_stop(tp: *mut rtl8169_private) {
    static void r8168dp_2_mdio_stop(struct rtl8169_private *tp)
    {
    RTL_W32(tp, 0xd0, RTL_R32(tp, 0xd0) | R8168DP_1_MDIO_ACCESS_BIT);
    }
#[no_mangle]
unsafe extern "C" fn r8168dp_2_mdio_write(tp: *mut rtl8169_private, reg: c_int, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn r8168dp_2_mdio_read(tp: *mut rtl8169_private, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl_writephy(tp: *mut rtl8169_private, location: c_int, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rtl_readphy(tp: *mut rtl8169_private, location: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl_ephy_write(tp: *mut rtl8169_private, reg_addr: c_int, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rtl_ephy_read(tp: *mut rtl8169_private, reg_addr: c_int) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn r8168dp_ocp_read(tp: *mut rtl8169_private, reg: u16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn r8168ep_ocp_read(tp: *mut rtl8169_private, reg: u16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn r8168dp_oob_notify(tp: *mut rtl8169_private, cmd: u8) {
    static void r8168dp_oob_notify(struct rtl8169_private *tp, u8 cmd)
    {
    rtl_eri_write(tp, 0xe8, ERIAR_MASK_0001, cmd);
    r8168dp_ocp_write(tp, 0x1, 0x30, 0x00000001);
    }
pub const OOB_CMD_RESET: c_uint = 0x00;
pub const OOB_CMD_DRIVER_START: c_uint = 0x05;
pub const OOB_CMD_DRIVER_STOP: c_uint = 0x06;
#[no_mangle]
unsafe extern "C" fn rtl8168_get_ocp_reg(tp: *mut rtl8169_private) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn rtl8168ep_stop_cmac(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8168dp_driver_start(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8168ep_driver_start(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8125bp_driver_start(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8168_driver_start(tp: *mut rtl8169_private) {
    static void rtl8168_driver_start(struct rtl8169_private *tp)
    {
    if (tp.dash_type == RTL_DASH_DP)
    rtl8168dp_driver_start(tp);
#[no_mangle]
pub unsafe extern "C" fn if(RTL_DASH_25_BP: tp->dash_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtl8168dp_driver_stop(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8168ep_driver_stop(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8125bp_driver_stop(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8168_driver_stop(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn r8168dp_check_dash(tp: *mut rtl8169_private) -> bool {
    static bool r8168dp_check_dash(struct rtl8169_private *tp)
    {
    let mut reg: u16 = rtl8168_get_ocp_reg(tp);
    return r8168dp_ocp_read(tp, reg) & BIT(15);
    }
#[no_mangle]
unsafe extern "C" fn r8168ep_check_dash(tp: *mut rtl8169_private) -> bool {
    static bool r8168ep_check_dash(struct rtl8169_private *tp)
    {
    return r8168ep_ocp_read(tp, 0x128) & BIT(0);
    }
#[no_mangle]
unsafe extern "C" fn rtl_dash_is_enabled(tp: *mut rtl8169_private) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rtl_get_dash_type(tp: *mut rtl8169_private) -> enum rtl_dash_type {
...
#[no_mangle]
unsafe extern "C" fn rtl_set_d3_pll_down(tp: *mut rtl8169_private, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn rtl_reset_packet_filter(tp: *mut rtl8169_private) {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8168d_efuse_read(tp: *mut rtl8169_private, reg_addr: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rtl_get_events(tp: *mut rtl8169_private) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rtl_ack_events(tp: *mut rtl8169_private, bits: u32) {
...
#[no_mangle]
unsafe extern "C" fn rtl_irq_disable(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_irq_enable(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_irq_mask_and_ack(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_link_chg_patch(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_get_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) {
...
#[no_mangle]
unsafe extern "C" fn __rtl8169_set_wol(tp: *mut rtl8169_private, wolopts: u32) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_set_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_get_regs_len(dev: *mut net_device) -> c_int {
    ...
    netdev_features_t features)
    {
    let mut rx_config: u32 = RTL_R32(tp, RxConfig);
...
#[no_mangle]
pub unsafe extern "C" fn rtl8169_tx_vlan_tag(skb: *mut sk_buff) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_rx_vlan_tag(desc: *mut RxDesc, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_do_counters(tp: *mut rtl8169_private, counter_cmd: u32) {
    static void rtl8169_do_counters(struct rtl8169_private *tp, u32 counter_cmd)
    {
    let mut cmd: u32 = lower_32_bits(tp.counters_phys_addr);
...
#[no_mangle]
unsafe extern "C" fn rtl8169_update_counters(tp: *mut rtl8169_private) {
    static void rtl8169_update_counters(struct rtl8169_private *tp)
    {
    let mut val: u8 = RTL_R8(tp, ChipCmd);
//
...
#[no_mangle]
unsafe extern "C" fn rtl8169_init_counter_offsets(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_get_strings(dev: *mut net_device, stringset: u32, data: *mut u8) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtl_coalesce_info {
    pub speed: u32,
    pub scale_nsecs: [u32; 4],
}
...
// cp01 = i;
    ...
    {
    struct rtl8169_private *tp = netdev_priv(dev);
    let mut tx_fr: u32 = ec.tx_max_coalesced_frames;
    let mut rx_fr: u32 = ec.rx_max_coalesced_frames;
    u32 coal_usec_max, units;
    let mut w: u16 = 0, cp01 = 0;
    int scale;
    if (rtl_is_8125(tp))
    return -EOPNOTSUPP;
...
#[no_mangle]
unsafe extern "C" fn rtl_set_eee_txidle_timer(tp: *mut rtl8169_private) {
    static void rtl_set_eee_txidle_timer(struct rtl8169_private *tp)
    {
    let mut timer_val: c_uint = READ_ONCE(tp.dev.mtu) + ETH_HLEN + 0x20;
    switch (tp.mac_version) {
...
#[no_mangle]
unsafe extern "C" fn r8169_get_tx_lpi_timer_us(tp: *mut rtl8169_private) -> c_uint {
    static unsigned int r8169_get_tx_lpi_timer_us(struct rtl8169_private *tp)
    {
    let mut speed: c_uint = tp.phydev.speed;
    let mut timer: c_uint = tp.tx_lpi_timer;
...
#[no_mangle]
unsafe extern "C" fn rtl8169_get_eee(dev: *mut net_device, data: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_set_eee(dev: *mut net_device, data: *mut ethtool_keee) -> c_int {
    ...
    struct phy_device *phydev = tp.phydev;
    let mut duplex: c_int = cmd.base.duplex;
    let mut speed: c_int = cmd.base.speed;
    if (!tp.sfp_mode)
...
#[no_mangle]
unsafe extern "C" fn rtl_release_firmware(tp: *mut rtl8169_private) {
    static void rtl_release_firmware(struct rtl8169_private *tp)
    {
    if (tp.rtl_fw) {
    rtl_fw_release_firmware(tp.rtl_fw);
    kfree(tp.rtl_fw);
    tp.rtl_fw = core::ptr::null_mut();
    }
    }
#[no_mangle]
pub unsafe extern "C" fn r8169_apply_firmware(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_rar_exgmac_set(tp: *mut rtl8169_private, addr: *const u8) {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8168h_2_get_adc_bias_ioffset(tp: *mut rtl8169_private) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn rtl_schedule_task(tp: *mut rtl8169_private, flag: enum rtl_flag) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_init_phy(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_rar_set(tp: *mut rtl8169_private, addr: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn rtl_set_mac_address(dev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl_init_rxcfg(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_init_ring_indexes(tp: *mut rtl8169_private) {
    static void rtl8169_init_ring_indexes(struct rtl8169_private *tp)
    {
    tp.dirty_tx = tp.cur_tx = tp.cur_rx = 0;
    }
#[no_mangle]
unsafe extern "C" fn rtl_jumbo_config(tp: *mut rtl8169_private) {
    static void rtl_jumbo_config(struct rtl8169_private *tp)
    {
    let mut jumbo: bool = tp.dev.mtu > ETH_DATA_LEN;
    let mut readrq: c_int = 4096;
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_reset(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_request_firmware(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_rx_close(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_wait_txrx_fifo_empty(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_disable_rxdvgate(tp: *mut rtl8169_private) {
    static void rtl_disable_rxdvgate(struct rtl8169_private *tp)
    {
    RTL_W32(tp, MISC, RTL_R32(tp, MISC) & ~RXDV_GATED_EN);
    }
#[no_mangle]
unsafe extern "C" fn rtl_enable_rxdvgate(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_wol_enable_rx(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_prepare_power_down(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_set_tx_config_registers(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_set_rx_max_size(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_set_rx_tx_desc_registers(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_set_magic_reg(tp: *mut rtl8169_private) {
    ...
    val = 0x000fff00;
#[no_mangle]
pub unsafe extern "C" fn if(RTL_GIGA_MAC_VER_06: tp->mac_version ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtl_set_rx_mode(dev: *mut net_device) {
    static void rtl_set_rx_mode(struct net_device *dev)
    {
    let mut rx_mode: u32 = AcceptBroadcast | AcceptMyPhys | AcceptMulticast;
...
// accept all multicasts
    ...
    let mut bit_nr: u32 = eth_hw_addr_crc(ha) >> 26;
...
#[no_mangle]
unsafe extern "C" fn rtl_csi_write(tp: *mut rtl8169_private, addr: c_int, value: c_int) {
    static void rtl_csi_write(struct rtl8169_private *tp, int addr, int value)
    {
    let mut func: u32 = PCI_FUNC(tp.pci_dev.devfn);
...
#[no_mangle]
unsafe extern "C" fn rtl_csi_read(tp: *mut rtl8169_private, addr: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rtl_disable_zrxdc_timeout(tp: *mut rtl8169_private) {
    static void rtl_disable_zrxdc_timeout(struct rtl8169_private *tp)
    {
    struct pci_dev *pdev = tp.pci_dev;
    int rc;
    u8 val;
pub const RTL_GEN3_RELATED_OFF: c_uint = 0x0890;
pub const RTL_GEN3_ZRXDC_NONCOMPL: c_uint = 0x1;
...
#[no_mangle]
unsafe extern "C" fn rtl_set_aspm_entry_latency(tp: *mut rtl8169_private, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn rtl_set_def_aspm_entry_latency(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_disable_clock_request(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_enable_clock_request(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_pcie_state_l2l3_disable(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_enable_exit_l1(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_disable_exit_l1(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_enable_ltr(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_aspm_clkreq_enable(tp: *mut rtl8169_private, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168b(tp: *mut rtl8169_private) {
    static void rtl_hw_start_8168b(struct rtl8169_private *tp)
    {
    RTL_W8(tp, Config3, RTL_R8(tp, Config3) & ~Beacon_en);
    }
#[no_mangle]
unsafe extern "C" fn __rtl_hw_start_8168cp(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168cp_1(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168cp_2(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168cp_3(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168c_1(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168c_2(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168c_4(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168d(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168d_4(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168e_1(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168e_2(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168f(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168f_1(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8411(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168g(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168g_1(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168g_2(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8411b_fix_phy_down(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8411_2(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168h_1(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168ep(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168ep_3(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8117(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8102e_1(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8102e_2(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8102e_3(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8401(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8105e_1(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8105e_2(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8402(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8106(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8125_common(tp: *mut rtl8169_private) {
...
#[no_mangle]
pub unsafe extern "C" fn if(RTL_GIGA_MAC_VER_70: tp->mac_version ==) -> else {
    else if (tp.mac_version == RTL_GIGA_MAC_VER_70)
    r8168_mac_ocp_modify(tp, 0xe614, 0x0700, 0x0400);
#[no_mangle]
pub unsafe extern "C" fn if(RTL_GIGA_MAC_VER_63: tp->mac_version ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8125a_2(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8125b(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8125d(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8126a(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8127a(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_config(tp: *mut rtl8169_private) {
    ...
    [RTL_GIGA_MAC_VER_10] = core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8125(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8168(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start_8169(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_start(tp: *mut rtl8169_private) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rtl_is_8125(tp)) -> else {
    else if (rtl_is_8125(tp))
...
#[no_mangle]
unsafe extern "C" fn rtl8169_change_mtu(dev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_mark_to_asic(desc: *mut RxDesc) {
    static void rtl8169_mark_to_asic(struct RxDesc *desc)
    {
    let mut eor: u32 = le32_to_cpu(desc.opts1) & RingEnd;
    desc.opts2 = 0;
// Force memory writes to complete before releasing descriptor
    ...
    let mut node: c_int = dev_to_node(d);
    dma_addr_t mapping;
    struct page *data;
...
#[no_mangle]
unsafe extern "C" fn rtl8169_rx_clear(tp: *mut rtl8169_private) {
    ...
    tp.Rx_databuff[i] = core::ptr::null_mut();
    tp.RxDescArray[i].addr = 0;
    tp.RxDescArray[i].opts1 = 0;
    }
    }
#[no_mangle]
unsafe extern "C" fn rtl8169_rx_fill(tp: *mut rtl8169_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_init_ring(tp: *mut rtl8169_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_unmap_tx_skb(tp: *mut rtl8169_private, entry: c_uint) {
    ...
    unsigned int i;
    for (i = 0; i < n; i++) {
    let mut entry: c_uint = (start + i) % NUM_TX_DESC;
    struct ring_info *tx_skb = tp.tx_skb + entry;
    let mut len: c_uint = tx_skb.len;
    if (len) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_tx_clear(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_cleanup(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_reset_work(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
    ...
    let mut len: u32 = skb_frag_size(frag);
...
#[no_mangle]
unsafe extern "C" fn rtl_skb_is_udp(skb: *mut sk_buff) -> bool {
    static bool rtl_skb_is_udp(struct sk_buff *skb)
    {
    let mut no: c_int = skb_network_offset(skb);
...
pub const RTL_MIN_PATCH_LEN: c_int = 47;
// see rtl8125_get_patch_pad_len() in r8125 vendor driver
    static unsigned int rtl8125_quirk_udp_padto(struct rtl8169_private *tp,
    struct sk_buff *skb)
    {
    let mut padto: c_uint = 0, len = skb.len;
    ...
    let mut dest: u16 = ntohs(udp_hdr(skb).dest);
...
#[no_mangle]
unsafe extern "C" fn rtl8169_tso_csum_v1(skb: *mut sk_buff, opts: *mut u32) {
...
#[no_mangle]
pub unsafe extern "C" fn if(IPPROTO_UDP: ip->protocol ==) -> else {
    ...
    let mut mss: u32 = shinfo.gso_size;
    if (mss) {
...
pub unsafe extern "C" fn if(IPPROTO_UDP: ip_protocol ==) -> else {
    ...
    let mut padto: c_uint = rtl_quirk_packet_padto(tp, skb);
...
#[no_mangle]
unsafe extern "C" fn rtl_tx_slots_avail(tp: *mut rtl8169_private) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rtl_chip_supports_csum_v2(tp: *mut rtl8169_private) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_doorbell(tp: *mut rtl8169_private) {
    ...
    {
    struct rtl8169_private *tp = netdev_priv(dev);
    let mut entry: c_uint = tp.cur_tx % NUM_TX_DESC;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !rtl8169_tso_csum_v2(tp, _arg: skb, _arg: opts)) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtl_last_frag_len(skb: *mut sk_buff) -> c_uint {
    static unsigned int rtl_last_frag_len(struct sk_buff *skb)
    {
    struct skb_shared_info *info = skb_shinfo(skb);
    let mut nr_frags: c_uint = info.nr_frags;
    if (!nr_frags)
    return UINT_MAX;
...
// IPv4 TCP header has options field
    ...
    features &= ~NETIF_F_ALL_TSO;
#[no_mangle]
pub unsafe extern "C" fn if(6: rtl_last_frag_len(skb) <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_pcierr_interrupt(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8169_fragmented_frame(status: u32) -> c_int {
    static inline int rtl8169_fragmented_frame(u32 status)
    {
    return (status & (FirstFrag | LastFrag)) != (FirstFrag | LastFrag);
    }
#[no_mangle]
pub unsafe extern "C" fn rtl8169_rx_csum(skb: *mut sk_buff, opts1: u32) {
    static inline void rtl8169_rx_csum(struct sk_buff *skb, u32 opts1)
    {
    let mut status: u32 = opts1 & (RxProtoMask | RxCSFailMask);
...
#[no_mangle]
unsafe extern "C" fn rtl_rx(dev: *mut net_device, tp: *mut rtl8169_private, budget: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(RxCRC)): status & RxRWT || !(status & (RxRUNT |) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
    static irqreturn_t rtl8169_interrupt(int irq, void *dev_instance)
    {
    struct rtl8169_private *tp = dev_instance;
    let mut status: u32 = rtl_get_events(tp);
...
#[no_mangle]
unsafe extern "C" fn rtl_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl_enable_tx_lpi(tp: *mut rtl8169_private, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn r8169_phylink_handler(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn r8169_phy_connect(tp: *mut rtl8169_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_down(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_up(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_close(dev: *mut net_device) -> c_int {
    ...
    tp.TxPhyAddr);
    tp.TxDescArray = core::ptr::null_mut();
    tp.RxDescArray = core::ptr::null_mut();
    pm_runtime_put_sync(&pdev.dev);
    return 0;
    }

#[no_mangle]
unsafe extern "C" fn rtl8169_netpoll(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rtl_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_net_suspend(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_resume(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_runtime_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8169_runtime_idle(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtl_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtl_set_irq_mask(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_alloc_irq(tp: *mut rtl8169_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r8168g_wait_ll_share_fifo_ready(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn r8169_mdio_read_reg(mii_bus: *mut mii_bus, phyaddr: c_int, phyreg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r8169_mdio_register(tp: *mut rtl8169_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_init_8168g(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_init_8125(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_hw_initialize(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_jumbo_max(tp: *mut rtl8169_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl_init_mac_address(tp: *mut rtl8169_private) {
...
#[no_mangle]
unsafe extern "C" fn rtl_aspm_is_safe(tp: *mut rtl8169_private) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rtl_init_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
//
    ...
    if (rtl_is_8125(tp)) {
    let mut data: u16 = r8168_mac_ocp_read(tp, 0xd006);
    if ((data & 0xff) == 0x07)
    tp.sfp_mode = true;
    }
