...
//! Source: drivers/net/ethernet/realtek/8139cp.c
#![no_std]
...
pub const CP_RX_RING_SIZE: c_int = 64;
pub const CP_TX_RING_SIZE: c_int = 64;
...
pub const CP_INTERNAL_PHY: c_int = 32;
...
pub const CP_MAX_MTU: c_int = 4096;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp_dma_stats {
    pub tx_ok: __le64,
    pub rx_ok: __le64,
    pub tx_err: __le64,
    pub rx_err: __le32,
    pub rx_fifo: __le16,
    pub frame_align: __le16,
    pub tx_ok_1col: __le32,
    pub tx_ok_mcol: __le32,
    pub rx_ok_phys: __le64,
    pub rx_ok_bcast: __le64,
    pub rx_ok_mcast: __le32,
    pub tx_abort: __le16,
    pub tx_underrun: __le16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp_extra_stats {
    pub rx_frags: c_ulong,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cp_private {
    ...
    pub rx_config: u32,
    pub cpcmd: u16,
    pub cp_stats: cp_extra_stats,
    pub ____cacheline_aligned: unsigned rx_head,
    pub rx_tail: unsigned,
    pub rx_ring: *mut cp_desc,
    pub rx_skb: [*mut sk_buff; CP_RX_RING_SIZE],
    pub ____cacheline_aligned: unsigned tx_head,
    pub tx_tail: unsigned,
    pub tx_ring: *mut cp_desc,
    pub tx_skb: [*mut sk_buff; CP_TX_RING_SIZE],
    pub tx_opts: [u32; CP_TX_RING_SIZE],
    pub rx_buf_sz: unsigned,
    pub /: *mut *mut unsigned wol_enabled : 1; / Is Wake-on-LAN enabled?,
...
#[no_mangle]
pub unsafe extern "C" fn cp_set_rxbufsize(cp: *mut cp_private) {
    static inline void cp_set_rxbufsize (struct cp_private *cp)
    {
    let mut mtu: c_uint = cp.dev.mtu;
    if (mtu > ETH_DATA_LEN)
...
#[no_mangle]
pub unsafe extern "C" fn cp_rx_csum_ok(status: u32) -> c_uint {
    static inline unsigned int cp_rx_csum_ok (u32 status)
    {
    let mut protocol: c_uint = (status >> 16) & 0x3;
...
#[no_mangle]
unsafe extern "C" fn cp_rx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int cp_rx_poll(struct napi_struct *napi, int budget)
    {
    struct cp_private *cp = container_of(napi, struct cp_private, napi);
    struct net_device *dev = cp.dev;
    let mut rx_tail: c_uint = cp.rx_tail;
    let mut rx: c_int = 0;
    ...
    struct cp_desc *desc;
    let mut buflen: unsigned = cp.rx_buf_sz;
...
#[no_mangle]
unsafe extern "C" fn cp_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn cp_poll_controller(dev: *mut net_device) {
    static void cp_poll_controller(struct net_device *dev)
    {
    struct cp_private *cp = netdev_priv(dev);
    let mut irq: c_int = cp.pdev.irq;
    disable_irq(irq);
...
#[no_mangle]
unsafe extern "C" fn cp_tx(cp: *mut cp_private) {
    static void cp_tx (struct cp_private *cp)
    {
    let mut tx_head: unsigned = cp.tx_head;
    let mut tx_tail: unsigned = cp.tx_tail;
    let mut bytes_compl: unsigned = 0, pkts_compl = 0;
    ...
    cp.tx_skb[tx_tail] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn cp_tx_vlan_tag(skb: *mut sk_buff) -> u32 {
    ...
    index = first+frag;
    cp.tx_skb[index] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn __cp_set_rx_mode(dev: *mut net_device) {
    static void __cp_set_rx_mode (struct net_device *dev)
    {
    struct cp_private *cp = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn cp_set_rx_mode(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn __cp_get_stats(cp: *mut cp_private) {
...
#[no_mangle]
unsafe extern "C" fn cp_stop_hw(cp: *mut cp_private) {
...
#[no_mangle]
unsafe extern "C" fn cp_reset_hw(cp: *mut cp_private) {
    static void cp_reset_hw (struct cp_private *cp)
    {
    let mut work: unsigned = 1000;
    cpw8(Cmd, CmdReset);
    while (work--) {
...
#[no_mangle]
pub unsafe extern "C" fn cp_start_hw(cp: *mut cp_private) {
...
#[no_mangle]
unsafe extern "C" fn cp_enable_irq(cp: *mut cp_private) {
    static void cp_enable_irq(struct cp_private *cp)
    {
    cpw16_f(IntrMask, cp_intr_mask);
    }
#[no_mangle]
unsafe extern "C" fn cp_init_hw(cp: *mut cp_private) {
...
#[no_mangle]
unsafe extern "C" fn cp_refill_rx(cp: *mut cp_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp_init_rings_index(cp: *mut cp_private) {
...
#[no_mangle]
unsafe extern "C" fn cp_init_rings(cp: *mut cp_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp_alloc_rings(cp: *mut cp_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp_clean_rings(cp: *mut cp_private) {
    static void cp_clean_rings (struct cp_private *cp)
    {
    struct cp_desc *desc;
    unsigned i;
...
#[no_mangle]
unsafe extern "C" fn cp_free_rings(cp: *mut cp_private) {
    static void cp_free_rings (struct cp_private *cp)
    {
    cp_clean_rings(cp);
    dma_free_coherent(&cp.pdev.dev, CP_RING_BYTES, cp.rx_ring,
    cp.ring_dma);
    cp.rx_ring = core::ptr::null_mut();
    cp.tx_ring = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn cp_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn cp_change_mtu(dev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp_get_drvinfo(dev: *mut net_device, info: *mut ethtool_drvinfo) {
...
#[no_mangle]
unsafe extern "C" fn cp_get_regs_len(dev: *mut net_device) -> c_int {
    static int cp_get_regs_len(struct net_device *dev)
    {
    return CP_REGS_SIZE;
    }
#[no_mangle]
unsafe extern "C" fn cp_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp_nway_reset(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp_get_msglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cp_set_msglevel(dev: *mut net_device, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn cp_set_features(dev: *mut net_device, features: netdev_features_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp_get_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) {
...
#[no_mangle]
unsafe extern "C" fn cp_set_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp_get_strings(dev: *mut net_device, stringset: u32, buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn cp_ioctl(dev: *mut net_device, rq: *mut ifreq, cmd: c_int) -> c_int {
    ...
    return -EINVAL;
    spin_lock_irqsave(&cp.lock, flags);
    rc = generic_mii_ioctl(&cp.mii_if, if_mii(rq), cmd, core::ptr::null_mut());
    spin_unlock_irqrestore(&cp.lock, flags);
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn cp_set_mac_address(dev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeprom_cmd_start(ee_addr: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn eeprom_cmd(ee_addr: *mut void __iomem, cmd: c_int, cmd_len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn eeprom_cmd_end(ee_addr: *mut void __iomem) {
    ...
    int addr_len)
    {
    let mut cmd: c_int = (EE_EXTEND_CMD << addr_len) | (extend_cmd << (addr_len - 2));
    eeprom_cmd_start(ee_addr);
    eeprom_cmd(ee_addr, cmd, 3 + addr_len);
    eeprom_cmd_end(ee_addr);
    }
#[no_mangle]
unsafe extern "C" fn read_eeprom(ioaddr: *mut void __iomem, location: c_int, addr_len: c_int) -> u16 {
    ...
    int i;
    void __iomem *ee_addr = ioaddr + Cfg9346;
    let mut write_cmd: c_int = location | (EE_WRITE_CMD << addr_len);
...
#[no_mangle]
unsafe extern "C" fn cp_get_eeprom_len(dev: *mut net_device) -> c_int {
    static int cp_get_eeprom_len(struct net_device *dev)
    {
    struct cp_private *cp = netdev_priv(dev);
    int size;
    ...
    u16 val;
    let mut offset: u32 = eeprom.offset >> 1;
    let mut len: u32 = eeprom.len;
    let mut i: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn cp_set_d3_state(cp: *mut cp_private) {
...
#[no_mangle]
unsafe extern "C" fn cp_init_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn cp_suspend(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn cp_resume(device: *mut device) -> int __maybe_unused {
