...
//! Source: drivers/net/ethernet/via/via-rhine.c
#![no_std]
...
pub const RX_RING_SIZE: c_int = 64;
...
pub const MCAM_SIZE: c_int = 32;
pub const VCAM_SIZE: c_int = 32;
//
    Theory of Operation
...
//
    let mut vt8500_quirks: static u32 = rqWOL | rqForceReset | rq6patterns;
...
#[derive(Copy, Clone)]
pub struct rx_desc {
    pub rx_status: __le32,
    pub /: *mut *mut __le32 desc_length; / Chain flag, Buffer/frame length,
    pub addr: __le32,
...
pub struct tx_desc {
    ...
    pub /: *mut *mut __le32 desc_length; / Chain flag, Tx Config, Frame length,
    pub addr: __le32,
    pub next_desc: __le32,
}

// Initial value for tx_desc.desc_length, Buffer size goes to bits 0-10
pub const TXDESC: c_uint = 0x00e08000;
    enum rx_status_bits {
...
// Tx bounce buffers (Rhine-I only)
    ...
    pub slow_event_task: work_struct,
...
// Frequently used values: keep some adjacent for cache effect.
    ...
    pub rx_stats: rhine_stats,
    pub tx_stats: rhine_stats,
    pub wolopts: u8,
    pub rx_thresh: u8 tx_thresh,,
...
#[no_mangle]
unsafe extern "C" fn rhine_wait_bit(rp: *mut rhine_private, reg: u8, mask: u8, low: bool) {
    static void rhine_wait_bit(struct rhine_private *rp, u8 reg, u8 mask, bool low)
    {
    void __iomem *ioaddr = rp.base;
    int i;
    for (i = 0; i < 1024; i++) {
    let mut has_mask_bits: bool = !!(ioread8(ioaddr + reg) & mask);
...
#[no_mangle]
unsafe extern "C" fn rhine_wait_bit_high(rp: *mut rhine_private, reg: u8, mask: u8) {
    static void rhine_wait_bit_high(struct rhine_private *rp, u8 reg, u8 mask)
    {
    rhine_wait_bit(rp, reg, mask, false);
    }
#[no_mangle]
unsafe extern "C" fn rhine_wait_bit_low(rp: *mut rhine_private, reg: u8, mask: u8) {
    static void rhine_wait_bit_low(struct rhine_private *rp, u8 reg, u8 mask)
    {
    rhine_wait_bit(rp, reg, mask, true);
    }
#[no_mangle]
unsafe extern "C" fn rhine_get_events(rp: *mut rhine_private) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rhine_ack_events(rp: *mut rhine_private, mask: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn rhine_power_init(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rhine_chip_reset(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn enable_mmio(pioaddr: c_long, quirks: u32) {
...
// Check that selected MMIO registers match the PIO ones
    ...
    let mut reg: c_int = mmio_verify_registers[i++];
    let mut a: c_uchar = inb(pioaddr+reg);
    let mut b: c_uchar = readb(ioaddr+reg);
    if (a != b) {
    dev_err(hwdev,
...
//
#[no_mangle]
unsafe extern "C" fn rhine_reload_eeprom(pioaddr: c_long, dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rhine_poll(dev: *mut net_device) {
    static void rhine_poll(struct net_device *dev)
    {
    struct rhine_private *rp = netdev_priv(dev);
    let mut irq: c_int = rp.irq;
    disable_irq(irq);
...
#[no_mangle]
unsafe extern "C" fn rhine_kick_tx_threshold(rp: *mut rhine_private) {
...
#[no_mangle]
unsafe extern "C" fn rhine_tx_err(rp: *mut rhine_private, status: u32) {
...
#[no_mangle]
unsafe extern "C" fn rhine_update_rx_crc_and_missed_errord(rp: *mut rhine_private) {
...
#[no_mangle]
unsafe extern "C" fn rhine_napipoll(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int rhine_napipoll(struct napi_struct *napi, int budget)
    {
    struct rhine_private *rp = container_of(napi, struct rhine_private, napi);
    struct net_device *dev = rp.dev;
    void __iomem *ioaddr = rp.base;
    let mut enable_mask: u16 = RHINE_EVENT & 0xffff;
...
#[no_mangle]
unsafe extern "C" fn rhine_hw_init(dev: *mut net_device, pioaddr: c_long) {
...
// dev->name not defined before register_netdev()!
    ...
    name = "Rhine";
#[no_mangle]
pub unsafe extern "C" fn if(rqStatusWBRace: rp->quirks &) -> else {
    else if (rp.quirks & rqStatusWBRace)
    name = "Rhine II";
#[no_mangle]
pub unsafe extern "C" fn if(rqMgmt: rp->quirks &) -> else {
    ...
    {
    u16 mii_cmd;
    let mut mii_status: c_int = mdio_read(dev, phy_id, 1);
...
// set IFF_RUNNING
    ...
    void __iomem *ioaddr;
    let mut io_size: c_int = pdev.revision < VTunknown0 ? 128 : 256;
...
//
    ...
    let mut quirks: u32 = rqNeedEnMMIO;
...
#[no_mangle]
unsafe extern "C" fn rhine_init_one_platform(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alloc_ring(dev: *mut *mut net_device) -> c_int {
    ...
    &rp.tx_bufs_dma,
    GFP_ATOMIC);
    if (rp.tx_bufs == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn free_ring(dev: *mut *mut net_device) {
    ...
    rp.tx_ring = core::ptr::null_mut();
    if (rp.tx_bufs)
    dma_free_coherent(hwdev, PKT_BUF_SZ * TX_RING_SIZE,
    rp.tx_bufs, rp.tx_bufs_dma);
    rp.tx_bufs = core::ptr::null_mut();
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rhine_skb_dma {
    pub skb: *mut sk_buff,
    pub dma: dma_addr_t,
}
    ...
    struct rhine_private *rp = netdev_priv(dev);
    struct device *hwdev = dev.dev.parent;
    let mut size: c_int = rp.rx_buf_sz;
...
#[no_mangle]
unsafe extern "C" fn rhine_reset_rbufs(rp: *mut rhine_private) {
...
#[no_mangle]
unsafe extern "C" fn alloc_rbufs(dev: *mut net_device) -> c_int {
...
// Init the ring entries
    ...
    rp.rx_skbuff[i] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn free_rbufs(dev: *mut *mut net_device) {
    static void free_rbufs(struct net_device* dev)
    {
    struct rhine_private *rp = netdev_priv(dev);
    struct device *hwdev = dev.dev.parent;
...
#[no_mangle]
unsafe extern "C" fn alloc_tbufs(dev: *mut *mut net_device) {
    ...
    rp.tx_skbuff[i] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn free_tbufs(dev: *mut *mut net_device) {
    ...
    rp.tx_skbuff[i] = core::ptr::null_mut();
    rp.tx_buf[i] = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn rhine_check_media(dev: *mut net_device, init_media: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rhine_set_carrier(mii: *mut mii_if_info) {
...
//
#[no_mangle]
unsafe extern "C" fn rhine_set_cam(ioaddr: *mut void __iomem, idx: c_int, addr: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn rhine_set_vlan_cam(ioaddr: *mut void __iomem, idx: c_int, addr: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn rhine_set_cam_mask(ioaddr: *mut void __iomem, mask: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn rhine_set_vlan_cam_mask(ioaddr: *mut void __iomem, mask: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn rhine_init_cam_filter(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn rhine_update_vcam(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rhine_vlan_rx_add_vid(dev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rhine_vlan_rx_kill_vid(dev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rhine_enable_linkmon(rp: *mut rhine_private) {
...
#[no_mangle]
unsafe extern "C" fn rhine_disable_linkmon(rp: *mut rhine_private) {
...
#[no_mangle]
unsafe extern "C" fn mdio_read(dev: *mut net_device, phy_id: c_int, regnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdio_write(dev: *mut net_device, phy_id: c_int, regnum: c_int, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rhine_task_disable(rp: *mut rhine_private) {
...
#[no_mangle]
unsafe extern "C" fn rhine_task_enable(rp: *mut rhine_private) {
...
#[no_mangle]
unsafe extern "C" fn rhine_open(dev: *mut net_device) -> c_int {
    static int rhine_open(struct net_device *dev)
    {
    struct rhine_private *rp = netdev_priv(dev);
    void __iomem *ioaddr = rp.base;
...
#[no_mangle]
unsafe extern "C" fn rhine_reset_task(work: *mut work_struct) {
    static void rhine_reset_task(struct work_struct *work)
    {
...
#[no_mangle]
unsafe extern "C" fn rhine_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
    static void rhine_tx_timeout(struct net_device *dev, unsigned int txqueue)
    {
    struct rhine_private *rp = netdev_priv(dev);
    void __iomem *ioaddr = rp.base;
...
#[no_mangle]
pub unsafe extern "C" fn rhine_tx_queue_full(rp: *mut rhine_private) -> bool {
...
// packet too long, drop it
    ...
    rp.tx_skbuff[entry] = core::ptr::null_mut();
...
// Padding is not copied and so must be redone.
    ...
    let mut vid_pcp: u16 = skb_vlan_tag_get(skb);
...
#[no_mangle]
unsafe extern "C" fn rhine_irq_disable(rp: *mut rhine_private) {
...
// The interrupt handler does all of the Rx thread work and cleans up
    after the Tx thread. */
#[no_mangle]
unsafe extern "C" fn rhine_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
    static irqreturn_t rhine_interrupt(int irq, void *dev_instance)
    {
...
// This routine is logically part of the interrupt handler, but isolated
    for clarity. */
#[no_mangle]
unsafe extern "C" fn rhine_tx(dev: *mut net_device) {
    static void rhine_tx(struct net_device *dev)
    {
    struct rhine_private *rp = netdev_priv(dev);
    struct device *hwdev = dev.dev.parent;
    let mut pkts_compl: c_uint = 0, bytes_compl = 0;
    let mut dirty_tx: c_uint = rp.dirty_tx;
    unsigned int cur_tx;
    struct sk_buff *skb;
//
...
// find and cleanup dirty tx descriptors
    ...
    let mut entry: c_uint = dirty_tx % TX_RING_SIZE;
    let mut txstatus: u32 = le32_to_cpu(rp.tx_ring[entry].tx_status);
...
//
#[no_mangle]
pub unsafe extern "C" fn rhine_get_vlan_tci(skb: *mut sk_buff, data_size: c_int) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn rhine_rx(dev: *mut net_device, limit: c_int) -> c_int {
    static int rhine_rx(struct net_device *dev, int limit)
    {
    struct rhine_private *rp = netdev_priv(dev);
    struct device *hwdev = dev.dev.parent;
    let mut entry: c_int = rp.cur_rx % RX_RING_SIZE;
    int count;
...
// If EOP is set on the next entry, it's a new packet. Send it up.
    ...
    let mut desc_status: u32 = le32_to_cpu(desc.rx_status);
    let mut data_size: c_int = desc_status >> 16;
...
// Length should omit the CRC
    let mut pkt_len: c_int = data_size - 4;
    struct sk_buff *skb;
...
#[no_mangle]
unsafe extern "C" fn rhine_restart_tx(dev: *mut net_device) {
    struct rhine_private *rp = netdev_priv(dev);
    void __iomem *ioaddr = rp.base;
    let mut entry: c_int = rp.dirty_tx % TX_RING_SIZE;
    u32 intr_status;
//
...
#[no_mangle]
unsafe extern "C" fn rhine_slow_event_task(work: *mut work_struct) {
    static void rhine_slow_event_task(struct work_struct *work)
    {
    struct rhine_private *rp =
...
#[no_mangle]
unsafe extern "C" fn rhine_set_rx_mode(dev: *mut net_device) {
    static void rhine_set_rx_mode(struct net_device *dev)
    {
    struct rhine_private *rp = netdev_priv(dev);
    void __iomem *ioaddr = rp.base;
...
#[no_mangle]
unsafe extern "C" fn rhine_get_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) {
...
#[no_mangle]
unsafe extern "C" fn rhine_set_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
unsafe extern "C" fn netdev_ioctl(dev: *mut net_device, rq: *mut ifreq, cmd: c_int) -> c_int {
    ...
    return -EINVAL;
    mutex_lock(&rp.task_lock);
    rc = generic_mii_ioctl(&rp.mii_if, if_mii(rq), cmd, core::ptr::null_mut());
    rhine_set_carrier(&rp.mii_if);
    mutex_unlock(&rp.task_lock);
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn rhine_close(dev: *mut net_device) -> c_int {
    static int rhine_close(struct net_device *dev)
    {
    struct rhine_private *rp = netdev_priv(dev);
    void __iomem *ioaddr = rp.base;
...
#[no_mangle]
unsafe extern "C" fn rhine_remove_one_pci(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn rhine_remove_one_platform(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rhine_shutdown_pci(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn rhine_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rhine_resume(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rhine_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: avoid_D3) -> else {
    else if (avoid_D3)
...
#[no_mangle]
unsafe extern "C" fn rhine_cleanup() -> void __exit {
