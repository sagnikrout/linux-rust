...
//! Source: drivers/net/ethernet/hisilicon/hisi_femac.c
#![no_std]
...
pub const MAC_PORTSEL: c_uint = 0x0200;

pub const MAC_PORTSET: c_uint = 0x0208;

pub const MAC_SET: c_uint = 0x0210;
pub const MAX_FRAME_SIZE: c_int = 1600;

pub const RX_COALESCE_SET: c_uint = 0x0340;
pub const RX_COALESCED_FRAME_OFFSET: c_int = 24;
pub const RX_COALESCED_FRAMES: c_int = 8;
pub const RX_COALESCED_TIMER: c_uint = 0x74;
pub const QLEN_SET: c_uint = 0x0344;
pub const RX_DEPTH_OFFSET: c_int = 8;
pub const MAX_HW_FIFO_DEPTH: c_int = 64;
pub const HW_TX_FIFO_DEPTH: c_int = 12;

pub const IQFRM_DES: c_uint = 0x0354;

pub const IQ_ADDR: c_uint = 0x0358;
pub const EQ_ADDR: c_uint = 0x0360;
pub const EQFRM_LEN: c_uint = 0x0364;
pub const ADDRQ_STAT: c_uint = 0x036C;

// global control register list
pub const GLB_HOSTMAC_L32: c_uint = 0x0000;
pub const GLB_HOSTMAC_H16: c_uint = 0x0004;
pub const GLB_SOFT_RESET: c_uint = 0x0008;

pub const GLB_FWCTRL: c_uint = 0x0010;

pub const GLB_MACTCTRL: c_uint = 0x0014;

pub const GLB_IRQ_STAT: c_uint = 0x0030;
pub const GLB_IRQ_ENA: c_uint = 0x0034;

pub const GLB_IRQ_RAW: c_uint = 0x0038;

    IRQ_INT_TX_PER_PACKET | \
    IRQ_INT_TX_FIFO_EMPTY)
pub const GLB_MAC_L32_BASE: c_uint = 0x0100;
pub const GLB_MAC_H16_BASE: c_uint = 0x0104;

pub const MAX_MAC_FILTER_NUM: c_int = 8;
pub const MAX_UNICAST_ADDRESSES: c_int = 2;

    MAX_UNICAST_ADDRESSES)
// software tx and rx queue number, should be power of 2
pub const TXQ_NUM: c_int = 64;
pub const RXQ_NUM: c_int = 128;
pub const FEMAC_POLL_WEIGHT: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_femac_queue {
    pub skb: *mut sk_buff,
    pub dma_phys: *mut dma_addr_t,
    pub num: c_int,
    pub head: c_uint,
    pub tail: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_femac_priv {
    pub port_base: *mut void __iomem,
    pub glb_base: *mut void __iomem,
    pub clk: *mut clk,
    pub mac_rst: *mut reset_control,
    pub phy_rst: *mut reset_control,
    pub phy_reset_delays: [u32; DELAYS_NUM],
    pub link_status: u32,
    pub dev: *mut device,
    pub ndev: *mut net_device,
    pub txq: hisi_femac_queue,
    pub rxq: hisi_femac_queue,
    pub tx_fifo_used_cnt: u32,
    pub napi: napi_struct,
}

#[no_mangle]
unsafe extern "C" fn hisi_femac_irq_enable(priv: *mut hisi_femac_priv, irqs: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_irq_disable(priv: *mut hisi_femac_priv, irqs: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_xmit_reclaim(dev: *mut net_device) {
    ...
    val = readl(priv.port_base + ADDRQ_STAT) & TX_CNT_INUSE_MASK;
    txq.skb[txq.tail] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_adjust_link(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_rx(dev: *mut net_device, limit: c_int) -> c_int {
...
// tell hardware we will deal with this packet
    ...
    skb = rxq.skb[pos];
    if (unlikely(!skb)) {
    netdev_err(dev, "rx skb core::ptr::null_mut(). pos=%d\n", pos);
    break;
    }
    rxq.skb[pos] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_init_tx_and_rx_queues(priv: *mut hisi_femac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_free_skb_rings(priv: *mut hisi_femac_priv) {
    ...
    skb = rxq.skb[pos];
    if (unlikely(!skb)) {
    netdev_err(priv.ndev, "core::ptr::null_mut() rx skb. pos=%d, head=%d\n",
    pos, rxq.head);
    continue;
    }
    ...
    skb = txq.skb[pos];
    if (unlikely(!skb)) {
    netdev_err(priv.ndev, "core::ptr::null_mut() tx skb. pos=%d, head=%d\n",
    pos, txq.head);
    continue;
    }
    hisi_femac_tx_dma_unmap(priv, skb, pos);
    dev_kfree_skb_any(skb);
    txq.skb[pos] = core::ptr::null_mut();
    pos = (pos + 1) % txq.num;
    }
    txq.tail = pos;
    priv.tx_fifo_used_cnt = 0;
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_port_reset(priv: *mut hisi_femac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_net_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_net_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_set_mac_address(dev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_set_mc_addr_filter(priv: *mut hisi_femac_priv) {
    ...
    let mut reg: c_int = MAX_UNICAST_ADDRESSES;
    int i;
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_set_uc_addr_filter(priv: *mut hisi_femac_priv) {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_net_set_rx_mode(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_core_reset(priv: *mut hisi_femac_priv) {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_sleep_us(time_us: u32) {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_phy_reset(priv: *mut hisi_femac_priv) {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_port_init(priv: *mut hisi_femac_priv) {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_drv_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_drv_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn hisi_femac_drv_resume(pdev: *mut platform_device) -> c_int {
