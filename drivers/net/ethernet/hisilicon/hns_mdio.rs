...
//! Source: drivers/net/ethernet/hisilicon/hns_mdio.c
#![no_std]
...
pub const MDIO_TIMEOUT: c_int = 1000000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hns_mdio_sc_reg {
    pub mdio_clk_en: u16,
    pub mdio_clk_dis: u16,
    pub mdio_reset_req: u16,
    pub mdio_reset_dreq: u16,
    pub mdio_clk_st: u16,
    pub mdio_reset_st: u16,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hns_mdio_device {
    pub /: *mut *mut *mut u8 __iomem vbase; / mdio reg base address,
    pub subctrl_vbase: *mut regmap,
    pub sc_reg: hns_mdio_sc_reg,
}

// mdio reg
pub const MDIO_COMMAND_REG: c_uint = 0x0;
pub const MDIO_ADDR_REG: c_uint = 0x4;
pub const MDIO_WDATA_REG: c_uint = 0x8;
pub const MDIO_RDATA_REG: c_uint = 0xc;
pub const MDIO_STA_REG: c_uint = 0x10;
// cfg phy bit map
pub const MDIO_CMD_DEVAD_M: c_uint = 0x1f;
pub const MDIO_CMD_DEVAD_S: c_int = 0;
pub const MDIO_CMD_PRTAD_M: c_uint = 0x1f;
pub const MDIO_CMD_PRTAD_S: c_int = 5;
pub const MDIO_CMD_OP_S: c_int = 10;
pub const MDIO_CMD_ST_S: c_int = 12;
pub const MDIO_CMD_START_B: c_int = 14;
pub const MDIO_ADDR_DATA_M: c_uint = 0xffff;
pub const MDIO_ADDR_DATA_S: c_int = 0;
pub const MDIO_WDATA_DATA_M: c_uint = 0xffff;
pub const MDIO_WDATA_DATA_S: c_int = 0;
pub const MDIO_RDATA_DATA_M: c_uint = 0xffff;
pub const MDIO_RDATA_DATA_S: c_int = 0;
pub const MDIO_STATE_STA_B: c_int = 0;
    enum mdio_st_clause {
    MDIO_ST_CLAUSE_45 = 0,
    MDIO_ST_CLAUSE_22
    };
...
// peri subctrl reg
pub const MDIO_SC_CLK_EN: c_uint = 0x338;
pub const MDIO_SC_CLK_DIS: c_uint = 0x33C;
pub const MDIO_SC_RESET_REQ: c_uint = 0xA38;
pub const MDIO_SC_RESET_DREQ: c_uint = 0xA3C;
pub const MDIO_SC_CLK_ST: c_uint = 0x531C;
pub const MDIO_SC_RESET_ST: c_uint = 0x5A1C;
#[no_mangle]
unsafe extern "C" fn mdio_write_reg(base: *mut u8 __iomem, reg: u32, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn mdio_read_reg(base: *mut u8 __iomem, reg: u32) -> u32 {
    ...
    u32 val)
    {
    let mut origin: u32 = mdio_read_reg(base, reg);
...
#[no_mangle]
unsafe extern "C" fn mdio_get_reg_field(base: *mut u8 __iomem, reg: u32, mask: u32, shift: u32) -> u32 {
...
pub const MDIO_CHECK_SET_ST: c_int = 1;
pub const MDIO_CHECK_CLR_ST: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn hns_mdio_wait_ready(bus: *mut mii_bus) -> c_int {
...
// after that can do read or write
    ...
    {
    u32 cmd_reg_value;
    let mut st: u8 = is_c45 ? MDIO_ST_CLAUSE_45 : MDIO_ST_CLAUSE_22;
...
//
    ...
    {
    struct hns_mdio_device *mdio_dev = bus.priv;
    let mut reg: u16 = (u16)(regnum & 0xffff);
    u16 cmd_reg_cfg;
    int ret;
    u8 op;
...
//
#[no_mangle]
unsafe extern "C" fn hns_mdio_read_c22(bus: *mut mii_bus, phy_id: c_int, regnum: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hns_mdio_reset(bus: *mut mii_bus) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hns_mdio_probe(pdev: *mut platform_device) -> c_int {
    ...
    int ret;
    if (!pdev) {
    dev_err(core::ptr::null_mut(), "pdev is core::ptr::null_mut()!\r\n");
    return -ENODEV;
    }
    ...
    mdio_dev.subctrl_vbase = core::ptr::null_mut();
    } else {
...
//
#[no_mangle]
unsafe extern "C" fn hns_mdio_remove(pdev: *mut platform_device) {
