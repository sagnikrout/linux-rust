...
//! Source: drivers/net/ethernet/hisilicon/hibmcge/hbg_main.c
#![no_std]
...
// Copyright (c) 2024 Hisilicon Limited.
    ...
    NETIF_F_RXCSUM)
#[no_mangle]
unsafe extern "C" fn hbg_all_irq_enable(priv: *mut hbg_priv, enabled: bool) {
...
#[no_mangle]
unsafe extern "C" fn hbg_net_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hbg_hw_txrx_clear(priv: *mut hbg_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hbg_net_stop(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hbg_update_promisc_mode(netdev: *mut net_device, overflow: bool) {
...
#[no_mangle]
unsafe extern "C" fn hbg_add_mac_to_filter(priv: *mut hbg_priv, addr: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hbg_del_mac_from_filter(priv: *mut hbg_priv, addr: *const u8) {
...
// not exists
    if (hbg_get_index_from_mac_table(priv, addr, &index))
    return;
    hbg_set_mac_to_mac_table(priv, index, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn hbg_uc_sync(netdev: *mut net_device, addr: *const c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hbg_uc_unsync(netdev: *mut net_device, addr: *const c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hbg_net_set_rx_mode(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn hbg_net_set_mac_address(netdev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hbg_net_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hbg_net_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn hbg_service_task(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn hbg_err_reset_task_schedule(priv: *mut hbg_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn hbg_np_link_fail_task_schedule(priv: *mut hbg_priv) {
...
#[no_mangle]
unsafe extern "C" fn hbg_cancel_delayed_work_sync(data: *mut c_void) {
    static void hbg_cancel_delayed_work_sync(void *data)
    {
    cancel_delayed_work_sync(data);
    }
#[no_mangle]
unsafe extern "C" fn hbg_delaywork_init(priv: *mut hbg_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hbg_mac_filter_init(priv: *mut hbg_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hbg_init_user_def(priv: *mut hbg_priv) {
...
#[no_mangle]
unsafe extern "C" fn hbg_init(priv: *mut hbg_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hbg_pci_init(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hbg_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hbg_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn hbg_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hbg_module_exit() -> void __exit {
