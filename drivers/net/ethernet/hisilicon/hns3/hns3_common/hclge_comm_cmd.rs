...
//! Source: drivers/net/ethernet/hisilicon/hns3/hns3_common/hclge_comm_cmd.h
#![no_std]
...
pub const HCLGE_COMM_LINK_EVENT_REPORT_EN_B: c_int = 0;
pub const HCLGE_COMM_NCSI_ERROR_REPORT_EN_B: c_int = 1;
pub const HCLGE_COMM_PHY_IMP_EN_B: c_int = 2;
pub const HCLGE_COMM_MAC_STATS_EXT_EN_B: c_int = 3;
pub const HCLGE_COMM_SYNC_RX_RING_HEAD_EN_B: c_int = 4;
pub const HCLGE_COMM_LLRS_FEC_EN_B: c_int = 5;

pub const HCLGE_COMM_TYPE_CRQ: c_int = 0;
pub const HCLGE_COMM_TYPE_CSQ: c_int = 1;
pub const HCLGE_COMM_CMDQ_CLEAR_WAIT_TIME: c_int = 200;
// bar registers for cmdq
pub const HCLGE_COMM_NIC_CSQ_BASEADDR_L_REG: c_uint = 0x27000;
pub const HCLGE_COMM_NIC_CSQ_BASEADDR_H_REG: c_uint = 0x27004;
pub const HCLGE_COMM_NIC_CSQ_DEPTH_REG: c_uint = 0x27008;
pub const HCLGE_COMM_NIC_CSQ_TAIL_REG: c_uint = 0x27010;
pub const HCLGE_COMM_NIC_CSQ_HEAD_REG: c_uint = 0x27014;
pub const HCLGE_COMM_NIC_CRQ_BASEADDR_L_REG: c_uint = 0x27018;
pub const HCLGE_COMM_NIC_CRQ_BASEADDR_H_REG: c_uint = 0x2701C;
pub const HCLGE_COMM_NIC_CRQ_DEPTH_REG: c_uint = 0x27020;
pub const HCLGE_COMM_NIC_CRQ_TAIL_REG: c_uint = 0x27024;
pub const HCLGE_COMM_NIC_CRQ_HEAD_REG: c_uint = 0x27028;
// Vector0 interrupt CMDQ event source register(RW)
pub const HCLGE_COMM_VECTOR0_CMDQ_SRC_REG: c_uint = 0x27100;
// Vector0 interrupt CMDQ event status register(RO)
pub const HCLGE_COMM_VECTOR0_CMDQ_STATE_REG: c_uint = 0x27104;
pub const HCLGE_COMM_CMDQ_INTR_EN_REG: c_uint = 0x27108;
pub const HCLGE_COMM_CMDQ_INTR_GEN_REG: c_uint = 0x2710C;
pub const HCLGE_COMM_CMDQ_INTR_STS_REG: c_uint = 0x27104;
// this bit indicates that the driver is ready for hardware reset
pub const HCLGE_COMM_NIC_SW_RST_RDY_B: c_int = 16;

pub const HCLGE_COMM_NIC_CMQ_DESC_NUM_S: c_int = 3;
pub const HCLGE_COMM_NIC_CMQ_DESC_NUM: c_int = 1024;
pub const HCLGE_COMM_CMDQ_TX_TIMEOUT_DEFAULT: c_int = 30000;
pub const HCLGE_COMM_CMDQ_CFG_RST_TIMEOUT: c_int = 1000000;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum hclge_opcode_type {
// Generic commands
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum hclge_comm_cmd_return_status {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum HCLGE_COMM_API_CAP_BITS {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hclge_comm_caps_bit_map {
    pub imp_bit: u16,
    pub local_bit: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hclge_cmdq_tx_timeout_map {
    pub opcode: u32,
    pub tx_timeout: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hclge_comm_firmware_compat_cmd {
    pub compat: __le32,
    pub rsv: [u8; 20],
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum hclge_comm_cmd_state {
    HCLGE_COMM_STATE_CMD_DISABLE,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hclge_comm_errcode {
    pub imp_errcode: u32,
    pub common_errno: c_int,
}

pub const HCLGE_COMM_QUERY_CAP_LENGTH: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hclge_comm_query_version_cmd {
    pub firmware: __le32,
    pub hardware: __le32,
    pub api_caps: __le32,
    pub /: *mut *mut __le32 caps[HCLGE_COMM_QUERY_CAP_LENGTH]; / capabilities of device,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hclge_comm_query_scc_cmd {
    pub scc_version: __le32,
    pub rsv: [u8; 20],
}

pub const HCLGE_DESC_DATA_LEN: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hclge_desc {
    pub opcode: __le16,
    pub flag: __le16,
    pub retval: __le16,
    pub rsv: __le16,
    pub data: [__le32; HCLGE_DESC_DATA_LEN],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hclge_comm_cmq_ring {
    ...
    pub /: *mut *mut u8 ring_type; / cmq ring type,
    pub /: *mut *mut spinlock_t lock; / Command queue lock,
}

#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum hclge_comm_cmd_status {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hclge_comm_cmq_ops {
    pub is_special): int num, bool,
    pub is_special): int num, bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hclge_comm_cmq {
    pub csq: hclge_comm_cmq_ring,
    pub crq: hclge_comm_cmq_ring,
    pub tx_timeout: u16,
    pub last_status: hclge_comm_cmd_status,
    pub ops: hclge_comm_cmq_ops,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hclge_comm_hw {
    pub io_base: *mut void __iomem,
    pub mem_base: *mut void __iomem,
    pub cmq: hclge_comm_cmq,
    pub comm_state: c_ulong,
}

extern "C" {
    pub fn readl(reg: reg_addr +) -> return;
}

extern "C" {
    pub fn hclge_comm_cmd_init_regs(hw: *mut hclge_comm_hw);
}
extern "C" {
    pub fn hclge_comm_alloc_cmd_queue(hw: *mut hclge_comm_hw, ring_type: c_int) -> c_int;
}
extern "C" {
    pub fn hclge_comm_cmd_reuse_desc(desc: *mut hclge_desc, is_read: bool);
}
extern "C" {
    pub fn hclge_comm_free_cmd_desc(ring: *mut hclge_comm_cmq_ring);
}
extern "C" {
    pub fn hclge_comm_cmd_queue_init(pdev: *mut pci_dev, hw: *mut hclge_comm_hw) -> c_int;
}
