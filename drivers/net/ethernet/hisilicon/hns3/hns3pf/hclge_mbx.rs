...
//! Source: drivers/net/ethernet/hisilicon/hns3/hns3pf/hclge_mbx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hclge_errno_to_resp(errno: c_int) -> u16 {
    static u16 hclge_errno_to_resp(int errno)
    {
    let mut resp: c_int = abs(errno);
...
#[no_mangle]
pub unsafe extern "C" fn hclge_inform_vf_reset(vport: *mut hclge_vport, reset_type: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hclge_inform_reset_assert_to_vf(vport: *mut hclge_vport) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(HNAE3_FLR_RESET: hdev->reset_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn hclge_free_vector_ring_chain(head: *mut hnae3_ring_chain_node) {
...
//
    ...
    {
    struct hnae3_ring_chain_node ring_chain;
    let mut vector_id: c_int = req.msg.vector_id;
    int ret;
    ...
    {
pub const HCLGE_LIMIT_RING_NUM: c_int = 1;
pub const HCLGE_RING_TYPE_OFFSET: c_int = 0;
pub const HCLGE_TQP_INDEX_OFFSET: c_int = 1;
pub const HCLGE_INT_GL_INDEX_OFFSET: c_int = 2;
pub const HCLGE_VECTOR_ID_OFFSET: c_int = 3;
pub const HCLGE_RING_VECTOR_MAP_INFO_LEN: c_int = 4;
    struct hnae3_ring_chain_node ring_chain;
    struct hclge_desc desc;
    ...
    {
pub const HCLGE_MBX_VF_OLD_MAC_ADDR_OFFSET: c_int = 6;
...
//
    ...
    struct hclge_respond_to_vf_msg *resp_msg)
    {
pub const HCLGE_MBX_VLAN_STATE_OFFSET: c_int = 0;
pub const HCLGE_MBX_VLAN_INFO_OFFSET: c_int = 2;
    struct hnae3_handle *handle = &vport.nic;
    struct hclge_dev *hdev = vport.back;
...
//
    ...
    struct hclge_mbx_vf_to_pf_cmd *mbx_req)
    {
    let mut alive: bool = !!mbx_req.msg.data[0];
    let mut ret: c_int = 0;
    if (alive)
    ...
    struct hclge_respond_to_vf_msg *resp_msg)
    {
pub const HCLGE_TQPS_RSS_INFO_LEN: c_int = 6;
...
// get the queue related info
    ...
    struct hclge_respond_to_vf_msg *resp_msg)
    {
pub const HCLGE_TQPS_DEPTH_INFO_LEN: c_int = 4;
...
// get the queue depth info
    ...
    struct hclge_respond_to_vf_msg *resp_msg)
    {
pub const HCLGE_VF_MEDIA_TYPE_OFFSET: c_int = 0;
pub const HCLGE_VF_MODULE_TYPE_OFFSET: c_int = 1;
pub const HCLGE_VF_MEDIA_TYPE_LENGTH: c_int = 2;
    struct hclge_dev *hdev = vport.back;
...
#[no_mangle]
pub unsafe extern "C" fn hclge_push_vf_link_status(vport: *mut hclge_vport) -> c_int {
...
// send this requested info to VF
    ...
    struct hclge_mbx_vf_to_pf_cmd *mbx_req)
    {
pub const HCLGE_SUPPORTED: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn hclge_reset_vf(vport: *mut hclge_vport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_notify_vf_config(vport: *mut hclge_vport) {
...
#[no_mangle]
unsafe extern "C" fn hclge_vf_keep_alive(vport: *mut hclge_vport) {
...
// (__le16 *)resp_msg->data = cpu_to_le16(qid_in_pf);
    ...
    struct hclge_respond_to_vf_msg *resp_msg)
    {
pub const HCLGE_RSS_MBX_RESP_LEN: c_int = 8;
    struct hclge_dev *hdev = vport.back;
...
#[no_mangle]
unsafe extern "C" fn hclge_link_fail_parse(hdev: *mut hclge_dev, link_fail_code: u8) {
...
#[no_mangle]
unsafe extern "C" fn hclge_cmd_crq_empty(hw: *mut hclge_hw) -> bool {
    static bool hclge_cmd_crq_empty(struct hclge_hw *hw)
    {
    let mut tail: c_int = hclge_read_dev(hw, HCLGE_COMM_NIC_CRQ_TAIL_REG);
    let mut tail: return = = hw.hw.cmq.crq.next_to_use;
    }
#[no_mangle]
unsafe extern "C" fn hclge_handle_ncsi_error(hdev: *mut hclge_dev) {
    static void hclge_handle_ncsi_error(struct hclge_dev *hdev)
    {
    struct hnae3_ae_dev *ae_dev = hdev.ae_dev;
    ae_dev.ops.set_default_reset_request(ae_dev, HNAE3_GLOBAL_RESET);
    dev_warn(&hdev.pdev.dev, "requesting reset due to NCSI error\n");
    ae_dev.ops.reset_event(hdev.pdev, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_set_promisc_mode_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_set_unicast_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_set_multicast_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_set_vlan_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_set_alive_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_get_qinfo_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_get_qdepth_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_get_basic_info_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_get_link_status_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_queue_reset_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_reset_handler(param: *mut hclge_mbx_ops_param) -> c_int {
    static int hclge_mbx_reset_handler(struct hclge_mbx_ops_param *param)
    {
    return hclge_reset_vf(param.vport);
    }
#[no_mangle]
unsafe extern "C" fn hclge_mbx_keep_alive_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_set_mtu_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_get_qid_in_pf_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_get_rss_key_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_get_link_mode_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_vf_uninit_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_get_media_type_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_push_link_status_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_get_mac_addr_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_ncsi_error_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_handle_vf_tbl_handler(param: *mut hclge_mbx_ops_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hclge_mbx_request_handling(param: *mut hclge_mbx_ops_param) {
    static void hclge_mbx_request_handling(struct hclge_mbx_ops_param *param)
    {
    let mut cmd_func: hclge_mbx_ops_fn = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn hclge_mbx_handler(hdev: *mut hclge_dev) {
