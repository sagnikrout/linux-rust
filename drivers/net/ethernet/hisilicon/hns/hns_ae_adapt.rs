...
//! Source: drivers/net/ethernet/hisilicon/hns/hns_ae_adapt.c
#![no_std]
...
//
    ...
    let mut q_num: c_int = rcb_comm.max_q_per_vf;
    let mut vf_num: c_int = rcb_comm.max_vfn;
...
#[no_mangle]
unsafe extern "C" fn hns_ae_put_handle(handle: *mut hnae_handle) {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_wait_flow_down(handle: *mut hnae_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_ring_enable_all(handle: *mut hnae_handle, val: c_int) {
    static void hns_ae_ring_enable_all(struct hnae_handle *handle, int val)
    {
    let mut q_num: c_int = handle.q_num;
    int i;
    for (i = 0; i < q_num; i++)
    hns_rcb_ring_enable_hw(handle.qs[i], val);
    }
#[no_mangle]
unsafe extern "C" fn hns_ae_init_queue(q: *mut hnae_queue) {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_fini_queue(q: *mut hnae_queue) {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_set_mac_address(handle: *mut hnae_handle, p: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_set_multicast_one(handle: *mut hnae_handle, addr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_clr_multicast(handle: *mut hnae_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_set_mtu(handle: *mut hnae_handle, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_set_tso_stats(handle: *mut hnae_handle, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_start(handle: *mut hnae_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_stop(handle: *mut hnae_handle) {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_reset(handle: *mut hnae_handle) {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_toggle_ring_irq(ring: *mut hnae_ring, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn hns_aev2_toggle_ring_irq(ring: *mut hnae_ring, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_get_link_status(handle: *mut hnae_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_set_promisc_mode(handle: *mut hnae_handle, en: u32) {
...
// rx_usecs_high  = HNS_RCB_RX_USECS_HIGH;
    ...
    struct hnae_vf_cb *vf_cb = hns_ae_get_vf_cb(handle);
    let mut tx_bytes: u64 = 0, rx_bytes = 0, tx_packets = 0, rx_packets = 0;
    let mut rx_errors: u64 = 0, tx_errors = 0, tx_dropped = 0;
...
#[no_mangle]
unsafe extern "C" fn hns_ae_get_stats(handle: *mut hnae_handle, data: *mut u64) {
    ...
    struct  hnae_vf_cb *vf_cb;
    if (!handle || !data) {
    pr_err("hns_ae_get_stats core::ptr::null_mut() handle or data pointer!\n");
    return;
    }
    vf_cb = hns_ae_get_vf_cb(handle);
    mac_cb = hns_get_mac_cb(handle);
...
#[no_mangle]
unsafe extern "C" fn hns_ae_get_sset_count(handle: *mut hnae_handle, stringset: c_int) -> c_int {
    static int hns_ae_get_sset_count(struct hnae_handle *handle, int stringset)
    {
    let mut sset_count: u32 = 0;
    struct hns_mac_cb *mac_cb;
    struct dsaf_device *dsaf_dev = hns_ae_get_dsaf_dev(handle.dev);
    assert(handle);
    mac_cb = hns_get_mac_cb(handle);
...
#[no_mangle]
unsafe extern "C" fn hns_ae_update_led_status(handle: *mut hnae_handle) {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_get_regs(handle: *mut hnae_handle, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_get_regs_len(handle: *mut hnae_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hns_ae_get_rss_key_size(handle: *mut hnae_handle) -> u32 {
    static u32 hns_ae_get_rss_key_size(struct hnae_handle *handle)
    {
    return HNS_PPEV2_RSS_KEY_SIZE;
    }
#[no_mangle]
unsafe extern "C" fn hns_ae_get_rss_indir_size(handle: *mut hnae_handle) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn hns_dsaf_ae_init(dsaf_dev: *mut dsaf_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hns_dsaf_ae_uninit(dsaf_dev: *mut dsaf_device) {
