...
//! Source: drivers/net/ethernet/alibaba/eea/eea_rx.c
#![no_std]
...
pub const EEA_PAGE_FRAGS_NUM: c_int = 1024;
pub const EEA_RX_BUF_ALIGN: c_int = 128;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct eea_rx_ctx {
    pub len: u32,
    pub hdr_len: u32,
    pub flags: u16,
    pub more: bool,
    pub meta: *mut eea_rx_meta,
    pub stats: eea_rx_ctx_stats,
}
...
#[no_mangle]
unsafe extern "C" fn eea_rx_meta_put(rx: *mut eea_net_rx, meta: *mut eea_rx_meta) {
...
#[no_mangle]
unsafe extern "C" fn meta_align_offset(rx: *mut eea_net_rx, meta: *mut eea_rx_meta) {
...
#[no_mangle]
unsafe extern "C" fn eea_alloc_rx_buffer(rx: *mut eea_net_rx, meta: *mut eea_rx_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eea_free_rx_hdr(rx: *mut eea_net_rx, cfg: *mut eea_net_cfg) {
    ...
    meta = &rx.meta[i];
    meta.hdr_addr = core::ptr::null_mut();
    if (!meta.hdr_page)
    continue;
    dma_unmap_page(rx.dma_dev, meta.hdr_dma, PAGE_SIZE,
    DMA_FROM_DEVICE);
    put_page(meta.hdr_page);
    meta.hdr_page = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn eea_alloc_rx_hdr(ctx: *mut eea_net_init_ctx, rx: *mut eea_net_rx) -> c_int {
    static int eea_alloc_rx_hdr(struct eea_net_init_ctx *ctx, struct eea_net_rx *rx)
    {
    struct page *hdr_page = core::ptr::null_mut();
    struct eea_rx_meta *meta;
    let mut offset: u32 = 0, hdrsize;
...
#[no_mangle]
unsafe extern "C" fn eea_harden_check_size(ctx: *mut eea_rx_ctx, enet: *mut eea_net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn process_remain_buf(rx: *mut eea_net_rx, ctx: *mut eea_rx_ctx) {
    ...
    ++ctx.stats.drops;
    rx.pkt.do_drop = true;
    rx.pkt.head_skb = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn process_first_buf(rx: *mut eea_net_rx, ctx: *mut eea_rx_ctx) {
...
#[no_mangle]
unsafe extern "C" fn eea_rx_dma_sync_hdr(rx: *mut eea_net_rx, addr: dma_addr_t) {
...
#[no_mangle]
unsafe extern "C" fn eea_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eea_free_rx_buffers(rx: *mut eea_net_rx, cfg: *mut eea_net_cfg) {
...
#[no_mangle]
unsafe extern "C" fn eea_destroy_page_pool(rx: *mut eea_net_rx) {
...
#[no_mangle]
pub unsafe extern "C" fn enet_rx_stop(rx: *mut eea_net_rx) {
...
#[no_mangle]
pub unsafe extern "C" fn enet_rx_start(rx: *mut eea_net_rx) {
...
#[no_mangle]
pub unsafe extern "C" fn eea_free_rx(rx: *mut eea_net_rx, cfg: *mut eea_net_cfg) {
    ...
    rx.ering = core::ptr::null_mut();
    }
    if (rx.meta) {
    eea_free_rx_buffers(rx, cfg);
    eea_free_rx_hdr(rx, cfg);
    kvfree(rx.meta);
    rx.meta = core::ptr::null_mut();
    }
    if (rx.pp) {
    eea_destroy_page_pool(rx);
    rx.pp = core::ptr::null_mut();
    }
    kfree(rx);
    }
#[no_mangle]
unsafe extern "C" fn eea_rx_meta_init(rx: *mut eea_net_rx, num: u32) {
    static void eea_rx_meta_init(struct eea_net_rx *rx, u32 num)
    {
    struct eea_rx_meta *meta;
    int i;
    rx.free = core::ptr::null_mut();
    for (i = 0; i < num; ++i) {
    meta = &rx.meta[i];
    meta.id = i;
    meta.next = rx.free;
