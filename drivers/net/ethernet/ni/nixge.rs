...
//! Source: drivers/net/ethernet/ni/nixge.c
#![no_std]
...
pub const TX_BD_NUM: c_int = 64;
pub const RX_BD_NUM: c_int = 128;
// Axi DMA Register definitions
pub const XAXIDMA_TX_CR_OFFSET: c_uint = 0x00 /* Channel control */;
pub const XAXIDMA_TX_SR_OFFSET: c_uint = 0x04 /* Status */;
pub const XAXIDMA_TX_CDESC_OFFSET: c_uint = 0x08 /* Current descriptor pointer */;
pub const XAXIDMA_TX_TDESC_OFFSET: c_uint = 0x10 /* Tail descriptor pointer */;
pub const XAXIDMA_RX_CR_OFFSET: c_uint = 0x30 /* Channel control */;
pub const XAXIDMA_RX_SR_OFFSET: c_uint = 0x34 /* Status */;
pub const XAXIDMA_RX_CDESC_OFFSET: c_uint = 0x38 /* Current descriptor pointer */;
pub const XAXIDMA_RX_TDESC_OFFSET: c_uint = 0x40 /* Tail descriptor pointer */;
pub const XAXIDMA_CR_RUNSTOP_MASK: c_uint = 0x1 /* Start/stop DMA channel */;
pub const XAXIDMA_CR_RESET_MASK: c_uint = 0x4 /* Reset DMA engine */;
pub const XAXIDMA_BD_CTRL_LENGTH_MASK: c_uint = 0x007FFFFF /* Requested len */;
...
pub const XAXIDMA_DELAY_SHIFT: c_int = 24;
pub const XAXIDMA_COALESCE_SHIFT: c_int = 16;
...
pub const XAXIDMA_DFT_TX_WAITBOUND: c_int = 254;
pub const XAXIDMA_DFT_RX_THRESHOLD: c_int = 24;
pub const XAXIDMA_DFT_RX_WAITBOUND: c_int = 254;
pub const XAXIDMA_BD_STS_ACTUAL_LEN_MASK: c_uint = 0x007FFFFF /* Actual len */;
...
pub const NIXGE_REG_CTRL_OFFSET: c_uint = 0x4000;
pub const NIXGE_REG_INFO: c_uint = 0x00;
pub const NIXGE_REG_MAC_CTL: c_uint = 0x04;
pub const NIXGE_REG_PHY_CTL: c_uint = 0x08;
pub const NIXGE_REG_LED_CTL: c_uint = 0x0c;
pub const NIXGE_REG_MDIO_DATA: c_uint = 0x10;
pub const NIXGE_REG_MDIO_ADDR: c_uint = 0x14;
pub const NIXGE_REG_MDIO_OP: c_uint = 0x18;
pub const NIXGE_REG_MDIO_CTRL: c_uint = 0x1c;

pub const NIXGE_MDIO_CLAUSE22: c_int = 0;

pub const NIXGE_MDIO_OP_ADDRESS: c_int = 0;

pub const NIXGE_REG_MAC_LSB: c_uint = 0x1000;
pub const NIXGE_REG_MAC_MSB: c_uint = 0x1004;
// Packet size info
...
pub struct nixge_hw_dma_bd {
    ...
    pub app3: u32,
    pub app4: u32,
    pub sw_id_offset_lo: u32,
    pub sw_id_offset_hi: u32,
    pub reserved6: u32,
}
...
// IO registers, dma functions and IRQs
    pub ctrl_regs: *mut void __iomem,
    pub dma_regs: *mut void __iomem,
    pub dma_err_tasklet: tasklet_struct,
    pub tx_irq: c_int,
    pub rx_irq: c_int,
// Buffer descriptors
    pub tx_bd_v: *mut nixge_hw_dma_bd,
    pub tx_skb: *mut nixge_tx_skb,
    pub tx_bd_p: dma_addr_t,
    pub rx_bd_v: *mut nixge_hw_dma_bd,
    pub rx_bd_p: dma_addr_t,
    pub tx_bd_ci: u32,
    pub tx_bd_tail: u32,
    pub rx_bd_ci: u32,
    pub coalesce_count_rx: u32,
    pub coalesce_count_tx: u32,
}

#[no_mangle]
unsafe extern "C" fn nixge_dma_write_reg(priv: *mut nixge_priv, offset: off_t, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn nixge_dma_read_reg(priv: *const nixge_priv, offset: off_t) -> u32 {
    static u32 nixge_dma_read_reg(const struct nixge_priv *priv, off_t offset)
    {
    return readl(priv.dma_regs + offset);
    }
#[no_mangle]
unsafe extern "C" fn nixge_ctrl_write_reg(priv: *mut nixge_priv, offset: off_t, val: u32) {
    static void nixge_ctrl_write_reg(struct nixge_priv *priv, off_t offset, u32 val)
    {
    writel(val, priv.ctrl_regs + offset);
    }
#[no_mangle]
unsafe extern "C" fn nixge_ctrl_read_reg(priv: *mut nixge_priv, offset: off_t) -> u32 {
    ...
    (sleep_us), (timeout_us))
#[no_mangle]
unsafe extern "C" fn nixge_hw_dma_bd_release(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn nixge_hw_dma_bd_init(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __nixge_device_reset(priv: *mut nixge_priv, offset: off_t) {
...
#[no_mangle]
unsafe extern "C" fn nixge_device_reset(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn nixge_handle_link_change(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn nixge_start_xmit_done(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn nixge_recv(ndev: *mut net_device, budget: c_int) -> c_int {
    static int nixge_recv(struct net_device *ndev, int budget)
    {
    struct nixge_priv *priv = netdev_priv(ndev);
    struct sk_buff *skb, *new_skb;
    struct nixge_hw_dma_bd *cur_p;
    let mut tail_p: dma_addr_t = 0, cur_phys = 0;
    let mut packets: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn nixge_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nixge_tx_irq(irq: c_int, _ndev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nixge_rx_irq(irq: c_int, _ndev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nixge_dma_err_handler(t: *mut tasklet_struct) {
...
#[no_mangle]
unsafe extern "C" fn nixge_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nixge_stop(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nixge_change_mtu(ndev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __nixge_hw_set_mac_address(ndev: *mut net_device) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn nixge_net_set_mac_address(ndev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nixge_mdio_read_c22(bus: *mut mii_bus, phy_id: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nixge_mdio_setup(priv: *mut nixge_priv, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nixge_of_get_resources(pdev: *mut platform_device) -> c_int {
    ...
    if (version <= NIXGE_V2)
    priv.dma_regs = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
    else
...
#[no_mangle]
unsafe extern "C" fn nixge_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nixge_remove(pdev: *mut platform_device) {
