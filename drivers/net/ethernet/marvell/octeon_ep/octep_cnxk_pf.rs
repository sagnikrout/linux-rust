...
//! Source: drivers/net/ethernet/marvell/octeon_ep/octep_cnxk_pf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cnxk_dump_regs(oct: *mut octep_device, qno: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cnxk_reset_iq(oct: *mut octep_device, q_no: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cnxk_reset_oq(oct: *mut octep_device, q_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_reset_io_queues_cnxk_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_setup_pci_window_regs_cnxk_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_configure_ring_mapping_cnxk_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_init_config_cnxk_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_setup_iq_regs_cnxk_pf(oct: *mut octep_device, iq_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_setup_oq_regs_cnxk_pf(oct: *mut octep_device, oq_no: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octep_setup_mbox_regs_cnxk_pf(oct: *mut octep_device, q_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_poll_pfvf_mailbox_cnxk_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_pfvf_mbox_intr_handler_cnxk_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_poll_oei_cnxk_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_oei_intr_handler_cnxk_pf(dev: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn octep_poll_non_ioq_interrupts_cnxk_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_ire_intr_handler_cnxk_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_ore_intr_handler_cnxk_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_vfire_intr_handler_cnxk_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_vfore_intr_handler_cnxk_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_dma_intr_handler_cnxk_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_dma_vf_intr_handler_cnxk_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_pp_vf_intr_handler_cnxk_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_misc_intr_handler_cnxk_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_rsvd_intr_handler_cnxk_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_ioq_intr_handler_cnxk_pf(data: *mut c_void) -> irqreturn_t {
...
// soft reset
#[no_mangle]
unsafe extern "C" fn octep_soft_reset_cnxk_pf(oct: *mut octep_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octep_reinit_regs_cnxk_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_enable_interrupts_cnxk_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_disable_interrupts_cnxk_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_update_iq_read_index_cnxk_pf(iq: *mut octep_iq) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn octep_enable_iq_cnxk_pf(oct: *mut octep_device, iq_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_enable_oq_cnxk_pf(oct: *mut octep_device, oq_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_enable_io_queues_cnxk_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_disable_iq_cnxk_pf(oct: *mut octep_device, iq_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_disable_oq_cnxk_pf(oct: *mut octep_device, oq_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_disable_io_queues_cnxk_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_dump_registers_cnxk_pf(oct: *mut octep_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn octep_device_setup_cnxk_pf(oct: *mut octep_device) {
