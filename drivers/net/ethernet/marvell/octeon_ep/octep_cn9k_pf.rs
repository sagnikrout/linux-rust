...
//! Source: drivers/net/ethernet/marvell/octeon_ep/octep_cn9k_pf.c
#![no_std]
...
pub const CTRL_MBOX_MAX_PF: c_int = 128;
...
#[no_mangle]
unsafe extern "C" fn cn93_dump_regs(oct: *mut octep_device, qno: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cn93_reset_iq(oct: *mut octep_device, q_no: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn93_reset_oq(oct: *mut octep_device, q_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_reset_io_queues_cn93_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_setup_pci_window_regs_cn93_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_configure_ring_mapping_cn93_pf(oct: *mut octep_device) {
    static void octep_configure_ring_mapping_cn93_pf(struct octep_device *oct)
    {
    struct octep_config *conf = oct.conf;
    struct pci_dev *pdev = oct.pdev;
    let mut pf_srn: u64 = CFG_GET_PORTS_PF_SRN(oct.conf);
    int q;
    for (q = 0; q < CFG_GET_PORTS_ACTIVE_IO_RINGS(conf); q++) {
    let mut regval: u64 = 0;
    if (oct.pcie_port)
...
#[no_mangle]
unsafe extern "C" fn octep_init_config_cn93_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_setup_iq_regs_cn93_pf(oct: *mut octep_device, iq_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_setup_oq_regs_cn93_pf(oct: *mut octep_device, oq_no: c_int) -> c_int {
    static int octep_setup_oq_regs_cn93_pf(struct octep_device *oct, int oq_no)
    {
    u64 reg_val;
    let mut oq_ctl: u64 = 0ULL;
...
#[no_mangle]
unsafe extern "C" fn octep_setup_mbox_regs_cn93_pf(oct: *mut octep_device, q_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_poll_pfvf_mailbox(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_pfvf_mbox_intr_handler_cn93_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_poll_oei_cn93_pf(oct: *mut octep_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(CN93_SDP_EPF_OEI_RINT_DATA_BIT_HBEAT: reg &) -> else {
...
#[no_mangle]
unsafe extern "C" fn octep_oei_intr_handler_cn93_pf(dev: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn octep_poll_non_ioq_interrupts_cn93_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_ire_intr_handler_cn93_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_ore_intr_handler_cn93_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_vfire_intr_handler_cn93_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_vfore_intr_handler_cn93_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_dma_intr_handler_cn93_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_dma_vf_intr_handler_cn93_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_pp_vf_intr_handler_cn93_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_misc_intr_handler_cn93_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_rsvd_intr_handler_cn93_pf(dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_ioq_intr_handler_cn93_pf(data: *mut c_void) -> irqreturn_t {
...
// soft reset of 98xx
#[no_mangle]
unsafe extern "C" fn octep_soft_reset_cn98_pf(oct: *mut octep_device) -> c_int {
...
// soft reset of 93xx
#[no_mangle]
unsafe extern "C" fn octep_soft_reset_cn93_pf(oct: *mut octep_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octep_reinit_regs_cn93_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_enable_interrupts_cn93_pf(oct: *mut octep_device) {
    static void octep_enable_interrupts_cn93_pf(struct octep_device *oct)
    {
    let mut intr_mask: u64 = 0ULL;
    int srn, num_rings, i;
...
#[no_mangle]
unsafe extern "C" fn octep_disable_interrupts_cn93_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_update_iq_read_index_cn93_pf(iq: *mut octep_iq) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn octep_enable_iq_cn93_pf(oct: *mut octep_device, iq_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_enable_oq_cn93_pf(oct: *mut octep_device, oq_no: c_int) {
    static void octep_enable_oq_cn93_pf(struct octep_device *oct, int oq_no)
    {
    let mut reg_val: u64 = 0ULL;
    oq_no += CFG_GET_PORTS_PF_SRN(oct.conf);
...
#[no_mangle]
unsafe extern "C" fn octep_enable_io_queues_cn93_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_disable_iq_cn93_pf(oct: *mut octep_device, iq_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_disable_oq_cn93_pf(oct: *mut octep_device, oq_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_disable_io_queues_cn93_pf(oct: *mut octep_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_dump_registers_cn93_pf(oct: *mut octep_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn octep_device_setup_cn93_pf(oct: *mut octep_device) {
