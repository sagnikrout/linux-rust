...
//! Source: drivers/net/ethernet/marvell/octeon_ep/octep_pfvf_mbox.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum octep_pfvf_mbox_state {
...
pub const OCTEP_PFVF_MBOX_TIMEOUT_MS: c_int = 500;
...
pub union octep_pfvf_mbox_word {
    ...
    pub s_offloads: },
    pub __packed: },
    pub work): *mut void octep_pfvf_mbox_work(struct work_struct,
    pub oct): *mut int octep_setup_pfvf_mbox(struct octep_device,
    pub oct): *mut void octep_delete_pfvf_mbox(struct octep_device,
    pub msg): *mut *mut void octep_pfvf_notify(struct octep_device oct, struct octep_ctrl_mbox_msg,
