...
//! Source: drivers/net/ethernet/marvell/octeontx2/nic/otx2_flows.c
#![no_std]
...
pub const OTX2_DEFAULT_ACTION: c_uint = 0x1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct otx2_flow {
...
#[no_mangle]
unsafe extern "C" fn otx2_clear_ntuple_flow_info(pfvf: *mut otx2_nic, flow_cfg: *mut otx2_flow_config) {
    ...
    flow_cfg.flow_ent = core::ptr::null_mut();
    flow_cfg.max_flows = 0;
    }
#[no_mangle]
unsafe extern "C" fn otx2_mcam_pfl_info_get(pfvf: *mut otx2_nic, x4_slots: *mut u16, kw_type: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_get_dft_rl_idx(pfvf: *mut otx2_nic, mcam_idx: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_free_ntuple_mcam_entries(pfvf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_alloc_mcam_entries(pfvf: *mut otx2_nic, count: u16) -> c_int {
    int otx2_alloc_mcam_entries(struct otx2_nic *pfvf, u16 count)
    {
    struct otx2_flow_config *flow_cfg = pfvf.flow_cfg;
    struct npc_mcam_alloc_entry_req *req;
    struct npc_mcam_alloc_entry_rsp *rsp;
    let mut dft_idx: u16 = 0, x4_slots = 0;
    int ent, allocated = 0, ref;
    let mut is_x2: bool = false;
    let mut kw_type: u8 = 0;
    int rc;
...
//
    ...
    sizeof(flow_cfg.flow_ent[0]), mcam_entry_cmp, core::ptr::null_mut());
    exit:
    mutex_unlock(&pfvf.mbox.lock);
...
#[no_mangle]
pub unsafe extern "C" fn otx2_mcam_entry_init(pfvf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2vf_mcam_flow_init(pfvf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_mcam_flow_init(pf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_mcam_flow_del(pf: *mut otx2_nic) {
...
//
#[no_mangle]
unsafe extern "C" fn otx2_do_add_macfilter(pf: *mut otx2_nic, mac: *const u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_add_macfilter(netdev: *mut net_device, mac: *const u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_del_macfilter(netdev: *mut net_device, mac: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_add_flow_to_list(pfvf: *mut otx2_nic, flow: *mut otx2_flow) {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_get_maxflows(flow_cfg: *mut otx2_flow_config) -> c_int {
    ...
    u32 *rule_locs)
    {
    let mut rule_cnt: u32 = nfc.rule_cnt;
...
#[no_mangle]
pub unsafe extern "C" fn if(TCP_V4_FLOW: flow_type ==) -> else {
...
// NPC profile doesn't extract AH/ESP header fields
    ...
    req.features |= BIT_ULL(NPC_SPORT_UDP);
#[no_mangle]
pub unsafe extern "C" fn if(TCP_V6_FLOW: flow_type ==) -> else {
...
// kw_type = NPC_MCAM_KEY_X4;
    ...
    struct ethhdr *eth_mask = &fsp.m_u.ether_spec;
    struct ethhdr *eth_hdr = &fsp.h_u.ether_spec;
    let mut ring_cookie: u64 = fsp.ring_cookie;
    u32 flow_type;
...
#[no_mangle]
unsafe extern "C" fn otx2_add_flow_msg(pfvf: *mut otx2_nic, flow: *mut otx2_flow) -> c_int {
    static int otx2_add_flow_msg(struct otx2_nic *pfvf, struct otx2_flow *flow)
    {
    struct otx2_flow_config *flow_cfg = pfvf.flow_cfg;
    struct npc_install_flow_req *req, treq = { 0 };
    let mut ring_cookie: u64 = flow.flow_spec.ring_cookie;

    int vlan_prio, qidx, pfc_rule = 0;

    let mut modify: bool = false, is_x2;
    int err, vf = 0, off, sz;
    let mut kw_type: u8 = 0;
    u8 *src, *dst;
    u16 x4_slots;
...
#[no_mangle]
pub unsafe extern "C" fn otx2_add_flow(pfvf: *mut otx2_nic, nfc: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_remove_flow_msg(pfvf: *mut otx2_nic, entry: u16, all: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_update_rem_pfmac(pfvf: *mut otx2_nic, req: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_remove_flow(pfvf: *mut otx2_nic, location: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_rss_ctx_flow_del(pfvf: *mut otx2_nic, ctx_id: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_destroy_ntuple_flows(pfvf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_destroy_mcam_flows(pfvf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_install_rxvlan_offload_flow(pfvf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_delete_rxvlan_offload_flow(pfvf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_enable_rxvlan(pf: *mut otx2_nic, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_dmacflt_reinstall_flows(pf: *mut otx2_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_dmacflt_update_pfmac_flow(pfvf: *mut otx2_nic) {
