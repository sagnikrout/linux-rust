...
//! Source: drivers/net/ethernet/marvell/octeontx2/nic/cn10k_macsec.c
#![no_std]
...
pub const MCS_GCM_AES_128: c_int = 0;
pub const MCS_GCM_AES_256: c_int = 1;
pub const MCS_GCM_AES_XPN_128: c_int = 2;
pub const MCS_GCM_AES_XPN_256: c_int = 3;
pub const MCS_TCI_ES: c_uint = 0x40 /* end station */;
pub const MCS_TCI_SC: c_uint = 0x20 /* SCI present */;
pub const MCS_TCI_SCB: c_uint = 0x10 /* epon */;
pub const MCS_TCI_E: c_uint = 0x08 /* encryption */;
pub const MCS_TCI_C: c_uint = 0x04 /* changed text */;
pub const CN10K_MAX_HASH_LEN: c_int = 16;
pub const CN10K_MAX_SAK_LEN: c_int = 32;
...
#[no_mangle]
unsafe extern "C" fn cn10k_mcs_alloc_txsa(pfvf: *mut otx2_nic, hw_sa_id: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn10k_mcs_alloc_rxsa(pfvf: *mut otx2_nic, hw_sa_id: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn10k_mcs_free_txsa(pfvf: *mut otx2_nic, hw_sa_id: u16) {
...
#[no_mangle]
unsafe extern "C" fn cn10k_mcs_free_rxsa(pfvf: *mut otx2_nic, hw_sa_id: u16) {
    ...
    sc_req.sci = ( u64)cpu_to_be64(( u64)sw_rx_sc.sci);
    ...
    ssci_63_32 = ( u32)cpu_to_be32(( u32)ssci);
...
//
    ...
    req.sci = ( u64)cpu_to_be64(( u64)secy.sci);
    req.dir = MCS_TX;
...
// Link the encoding_sa only to SC out of all SAs
    ...
    map_req.sectag_sci = ( u64)cpu_to_be64(( u64)secy.sci);
...
//
    ...
    struct cn10k_mcs_txsc *txsc)
    {
    let mut sa_bmap: u8 = txsc.sa_bmap;
    let mut sa_num: u8 = 0;
    while (sa_bmap) {
    if (sa_bmap & 1) {
...
//
    ...
    struct cn10k_mcs_rxsc *rxsc)
    {
    let mut sa_bmap: u8 = rxsc.sa_bmap;
    let mut sa_num: u8 = 0;
    while (sa_bmap) {
    if (sa_bmap & 1) {
...
// When updating secy, change RX secy also
    ...
    {
    struct cn10k_mcs_cfg *cfg = pfvf.macsec_cfg;
    let mut rx_rsp: mcs_secy_stats = { 0 };
    let mut sc_rsp: mcs_sc_stats = { 0 };
    struct cn10k_mcs_rxsc *rxsc;
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_open(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_stop(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_add_secy(ctx: *mut macsec_context) -> c_int {
    ...
    return cn10k_mcs_secy_tx_cfg(pfvf, secy, txsc, core::ptr::null_mut(), 0);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_upd_secy(ctx: *mut macsec_context) -> c_int {
...
// Encoding SA got changed
    ...
    err = cn10k_mcs_secy_tx_cfg(pfvf, secy, txsc, core::ptr::null_mut(), 0);
    if (err)
    return err;
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_del_secy(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_add_txsa(ctx: *mut macsec_context) -> c_int {
    ...
    struct cn10k_mcs_cfg *cfg = pfvf.macsec_cfg;
    struct macsec_secy *secy = ctx.secy;
    let mut sa_num: u8 = ctx.sa.assoc_num;
    struct cn10k_mcs_txsc *txsc;
    int err;
    txsc = cn10k_mcs_get_txsc(cfg, secy);
    if (!txsc)
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_upd_txsa(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_del_txsa(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_add_rxsc(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_upd_rxsc(ctx: *mut macsec_context) -> c_int {
    static int cn10k_mdo_upd_rxsc(struct macsec_context *ctx)
    {
    struct otx2_nic *pfvf = macsec_netdev_priv(ctx.netdev);
    struct cn10k_mcs_cfg *cfg = pfvf.macsec_cfg;
    struct macsec_secy *secy = ctx.secy;
    let mut enable: bool = ctx.rx_sc.active;
    struct cn10k_mcs_rxsc *rxsc;
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_del_rxsc(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_add_rxsa(ctx: *mut macsec_context) -> c_int {
    ...
    struct macsec_secy *secy = ctx.secy;
    let mut sa_in_use: bool = rx_sa.active;
    let mut sa_num: u8 = ctx.sa.assoc_num;
    struct cn10k_mcs_rxsc *rxsc;
    int err;
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_upd_rxsa(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_del_rxsa(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_get_dev_stats(ctx: *mut macsec_context) -> c_int {
    static int cn10k_mdo_get_dev_stats(struct macsec_context *ctx)
    {
    struct otx2_nic *pfvf = macsec_netdev_priv(ctx.netdev);
    let mut tx_rsp: mcs_secy_stats = { 0 }, rx_rsp = { 0 };
    struct cn10k_mcs_cfg *cfg = pfvf.macsec_cfg;
    struct macsec_secy *secy = ctx.secy;
    struct cn10k_mcs_txsc *txsc;
    txsc = cn10k_mcs_get_txsc(cfg, ctx.secy);
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_get_tx_sc_stats(ctx: *mut macsec_context) -> c_int {
    static int cn10k_mdo_get_tx_sc_stats(struct macsec_context *ctx)
    {
    struct otx2_nic *pfvf = macsec_netdev_priv(ctx.netdev);
    struct cn10k_mcs_cfg *cfg = pfvf.macsec_cfg;
    let mut rsp: mcs_sc_stats = { 0 };
    struct cn10k_mcs_txsc *txsc;
    txsc = cn10k_mcs_get_txsc(cfg, ctx.secy);
    if (!txsc)
    return -ENOENT;
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_get_tx_sa_stats(ctx: *mut macsec_context) -> c_int {
    static int cn10k_mdo_get_tx_sa_stats(struct macsec_context *ctx)
    {
    struct otx2_nic *pfvf = macsec_netdev_priv(ctx.netdev);
    struct cn10k_mcs_cfg *cfg = pfvf.macsec_cfg;
    let mut rsp: mcs_sa_stats = { 0 };
    let mut sa_num: u8 = ctx.sa.assoc_num;
    struct cn10k_mcs_txsc *txsc;
    txsc = cn10k_mcs_get_txsc(cfg, ctx.secy);
    if (!txsc)
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_get_rx_sc_stats(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn10k_mdo_get_rx_sa_stats(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cn10k_handle_mcs_event(pfvf: *mut otx2_nic, event: *mut mcs_intr_info) {
    void cn10k_handle_mcs_event(struct otx2_nic *pfvf, struct mcs_intr_info *event)
    {
    struct cn10k_mcs_cfg *cfg = pfvf.macsec_cfg;
    struct macsec_tx_sa *sw_tx_sa = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn cn10k_mcs_init(pfvf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cn10k_mcs_free(pfvf: *mut otx2_nic) {
    ...
    pfvf.macsec_cfg = core::ptr::null_mut();
    }
