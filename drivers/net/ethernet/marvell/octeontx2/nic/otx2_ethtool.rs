...
//! Source: drivers/net/ethernet/marvell/octeontx2/nic/otx2_ethtool.c
#![no_std]
...
pub const OTX2_FEC_MAX_INDEX: c_int = 4;
    let mut otx2_n_dev_stats: static unsigned int = ARRAY_SIZE(otx2_dev_stats);
    let mut otx2_n_drv_stats: static unsigned int = ARRAY_SIZE(otx2_drv_stats);
    let mut otx2_n_queue_stats: static unsigned int = ARRAY_SIZE(otx2_queue_stats);
...
#[no_mangle]
unsafe extern "C" fn otx2_get_qset_strings(pfvf: *mut otx2_nic, data: *mut u8, qset: c_int) {
    static void otx2_get_qset_strings(struct otx2_nic *pfvf, u8 **data, int qset)
    {
    let mut start_qidx: c_int = qset * pfvf.hw.rx_queues;
    int qidx, stats;
...
#[no_mangle]
unsafe extern "C" fn otx2_get_strings(netdev: *mut net_device, sset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn otx2_get_phy_fec_stats(pfvf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
// Set no of Tx, Rx queues to be used
    ...
    {
    struct otx2_nic *pfvf = netdev_priv(netdev);
    let mut rx_buf_len: u32 = kernel_ring.rx_buf_len;
    let mut old_rx_buf_len: u32 = pfvf.hw.rbuf_len;
    let mut xqe_size: u32 = kernel_ring.cqe_size;
...
#[no_mangle]
pub unsafe extern "C" fn if(ec->tx_coalesce_usecs: hw->cq_time_wait ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(ec->tx_max_coalesced_frames: hw->cq_ecount_wait ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn otx2_get_rx_ring_count(dev: *mut net_device) -> u32 {
...
// Mimimum is IPv4 and IPv6, SIP/DIP
    ...
    {
    struct otx2_nic *pfvf = netdev_priv(dev);
    let mut rxh_l4: u32 = RXH_L4_B_0_1 | RXH_L4_B_2_3;
    struct otx2_rss_info *rss;
    u32 rss_cfg;
    rss = &pfvf.hw.rss_info;
...
//
    ...
    {
    let mut ntuple: bool = !!(dev.features & NETIF_F_NTUPLE);
    struct otx2_nic *pfvf = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn otx2_set_rxnfc(dev: *mut net_device, nfc: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn otx2_get_rxfh_indir_size(dev: *mut net_device) -> u32 {
...
// Configure RSS table and hash key
    ...
    otx2_set_rss_table(pfvf, DEFAULT_RSS_CONTEXT_GROUP, core::ptr::null_mut());
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn otx2_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn otx2_set_msglevel(netdev: *mut net_device, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn otx2_get_link(netdev: *mut net_device) -> u32 {
...
// LBK and SDP links are internal and always UP
    ...
    static struct cgx_fw_data *otx2_get_fwdata(struct otx2_nic *pfvf)
    {
    struct cgx_fw_data *rsp = core::ptr::null_mut();
    struct msg_req *req;
    let mut err: c_int = 0;
    mutex_lock(&pfvf.mbox.lock);
...
#[no_mangle]
pub unsafe extern "C" fn otx2_set_ethtool_ops(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_get_strings(netdev: *mut net_device, sset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2vf_set_ethtool_ops(netdev: *mut net_device) {
