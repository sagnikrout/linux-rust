...
//! Source: drivers/net/ethernet/marvell/octeontx2/nic/otx2_pf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn otx2_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
    static int otx2_change_mtu(struct net_device *netdev, int new_mtu)
    {
    struct otx2_nic *pf = netdev_priv(netdev);
    let mut if_up: bool = netif_running(netdev);
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn otx2_disable_flr_me_intr(pf: *mut otx2_nic) {
...
#[no_mangle]
unsafe extern "C" fn otx2_flr_wq_destroy(pf: *mut otx2_nic) {
    static void otx2_flr_wq_destroy(struct otx2_nic *pf)
    {
    if (!pf.flr_wq)
    return;
    destroy_workqueue(pf.flr_wq);
    pf.flr_wq = core::ptr::null_mut();
    devm_kfree(pf.dev, pf.flr_wrk);
    }
#[no_mangle]
unsafe extern "C" fn otx2_flr_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn otx2_pf_flr_intr_handler(irq: c_int, pf_irq: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn otx2_pf_me_intr_handler(irq: c_int, pf_irq: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn otx2_register_flr_me_intr(pf: *mut otx2_nic, numvfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_pf_flr_init(pf: *mut otx2_nic, num_vfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_pfvf_mbox_handler(work: *mut work_struct) {
    static void otx2_pfvf_mbox_handler(struct work_struct *work)
    {
    struct mbox_msghdr *msg = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn otx2_pfvf_mbox_up_handler(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_pfvf_mbox_intr_handler(irq: c_int, pf_irq: *mut c_void) -> irqreturn_t {
    irqreturn_t otx2_pfvf_mbox_intr_handler(int irq, void *pf_irq)
    {
    struct otx2_nic *pf = (struct otx2_nic *)(pf_irq);
    let mut vfs: c_int = pf.total_vfs;
    struct mbox *mbox;
    u64 intr;
    mbox = pf.mbox_pfvf;
...
#[no_mangle]
unsafe extern "C" fn otx2_pfvf_mbox_init(pf: *mut otx2_nic, numvfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_pfvf_mbox_destroy(pf: *mut otx2_nic) {
    ...
    if (pf.mbox_pfvf_wq) {
    destroy_workqueue(pf.mbox_pfvf_wq);
    pf.mbox_pfvf_wq = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn otx2_enable_pfvf_mbox_intr(pf: *mut otx2_nic, numvfs: c_int) {
...
#[no_mangle]
unsafe extern "C" fn otx2_disable_pfvf_mbox_intr(pf: *mut otx2_nic, numvfs: c_int) {
...
#[no_mangle]
unsafe extern "C" fn otx2_register_pfvf_mbox_intr(pf: *mut otx2_nic, numvfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_pfaf_mbox_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn otx2_handle_link_event(pf: *mut otx2_nic) {
...
#[no_mangle]
unsafe extern "C" fn otx2_pfaf_mbox_up_handler(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_pfaf_mbox_intr_handler(irq: c_int, pf_irq: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_disable_mbox_intr(pf: *mut otx2_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_register_mbox_intr(pf: *mut otx2_nic, probe_af: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_pfaf_mbox_destroy(pf: *mut otx2_nic) {
    void otx2_pfaf_mbox_destroy(struct otx2_nic *pf)
    {
    struct mbox *mbox = &pf.mbox;
    if (pf.mbox_wq) {
    destroy_workqueue(pf.mbox_wq);
    pf.mbox_wq = core::ptr::null_mut();
    }
    if (mbox.mbox.hwbase && !is_cn20k(pf.pdev))
...
#[no_mangle]
pub unsafe extern "C" fn otx2_pfaf_mbox_init(pf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_cgx_config_linkevents(pf: *mut otx2_nic, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_reset_mac_stats(pfvf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_cgx_config_loopback(pf: *mut otx2_nic, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_q_intr_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_cq_intr_handler(irq: c_int, cq_irq: *mut c_void) -> irqreturn_t {
    irqreturn_t otx2_cq_intr_handler(int irq, void *cq_irq)
    {
    struct otx2_cq_poll *cq_poll = (struct otx2_cq_poll *)cq_irq;
    struct otx2_nic *pf = (struct otx2_nic *)cq_poll.dev;
    let mut qidx: c_int = cq_poll.cint_idx;
// Disable interrupts.
//
...
#[no_mangle]
pub unsafe extern "C" fn otx2_disable_napi(pf: *mut otx2_nic) {
...
#[no_mangle]
unsafe extern "C" fn otx2_free_cq_res(pf: *mut otx2_nic) {
...
#[no_mangle]
unsafe extern "C" fn otx2_free_sq_res(pf: *mut otx2_nic) {
...
#[no_mangle]
unsafe extern "C" fn otx2_get_rbuf_size(pf: *mut otx2_nic, mtu: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_init_hw_resources(pf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_free_hw_resources(pf: *mut otx2_nic) {
...
#[no_mangle]
unsafe extern "C" fn otx2_promisc_use_mce_list(pfvf: *mut otx2_nic) -> bool {
...
#[no_mangle]
unsafe extern "C" fn otx2_do_set_rx_mode(pf: *mut otx2_nic) {
    static void otx2_do_set_rx_mode(struct otx2_nic *pf)
    {
    struct net_device *netdev = pf.netdev;
    struct nix_rx_mode *req;
    let mut promisc: bool = false;
...
#[no_mangle]
unsafe extern "C" fn otx2_set_irq_coalesce(pfvf: *mut otx2_nic) {
...
#[no_mangle]
unsafe extern "C" fn otx2_dim_work(w: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_free_queue_mem(qset: *mut otx2_qset) {
    void otx2_free_queue_mem(struct otx2_qset *qset)
    {
    kfree(qset.sq);
    qset.sq = core::ptr::null_mut();
    kfree(qset.cq);
    qset.cq = core::ptr::null_mut();
    kfree(qset.rq);
    qset.rq = core::ptr::null_mut();
    kfree(qset.napi);
    qset.napi = core::ptr::null_mut();
    }
    EXPORT_SYMBOL(otx2_free_queue_mem);
#[no_mangle]
pub unsafe extern "C" fn otx2_alloc_queue_mem(pf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_open(netdev: *mut net_device) -> c_int {
    int otx2_open(struct net_device *netdev)
    {
    struct otx2_nic *pf = netdev_priv(netdev);
    struct otx2_cq_poll *cq_poll = core::ptr::null_mut();
    struct otx2_qset *qset = &pf.qset;
    let mut err: c_int = 0, qidx, vec;
    char *irq_name;
    netif_carrier_off(netdev);
...
#[no_mangle]
pub unsafe extern "C" fn otx2_stop(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_xmit(skb: *mut sk_buff, netdev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t otx2_xmit(struct sk_buff *skb, struct net_device *netdev)
    {
    struct otx2_nic *pf = netdev_priv(netdev);
    let mut qidx: c_int = skb_get_queue_mapping(skb);
...
//
    let mut htb_maj_id: u16 = smp_load_acquire(&pf.qos.maj_id);
    ...
    txq = netdev_pick_tx(netdev, skb, core::ptr::null_mut());
    if (unlikely(qos_enabled))
...
#[no_mangle]
unsafe extern "C" fn otx2_set_rx_mode(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn otx2_rx_mode_wrk_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn otx2_reset_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn otx2_config_hw_rx_tstamp(pfvf: *mut otx2_nic, enable: bool) -> c_int {
    static int otx2_config_hw_rx_tstamp(struct otx2_nic *pfvf, bool enable)
    {
    struct msg_req *req;
    int err;
...
#[no_mangle]
unsafe extern "C" fn otx2_config_hw_tx_tstamp(pfvf: *mut otx2_nic, enable: bool) -> c_int {
    static int otx2_config_hw_tx_tstamp(struct otx2_nic *pfvf, bool enable)
    {
    struct msg_req *req;
    int err;
...
#[no_mangle]
unsafe extern "C" fn otx2_do_set_vf_mac(pf: *mut otx2_nic, vf: c_int, mac: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_set_vf_mac(netdev: *mut net_device, vf: c_int, mac: *mut u8) -> c_int {
...
// qos is currently unsupported
    ...
    {
    struct otx2_nic *pf = netdev_priv(netdev);
    let mut qidx: c_int = smp_processor_id();
    struct otx2_snd_queue *sq;
    let mut drops: c_int = 0, i;
    if (!netif_running(netdev))
    return -ENETDOWN;
    qidx += pf.hw.tx_queues;
    sq = pf.xdp_prog ? &pf.qset.sq[qidx] : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn otx2_xdp_setup(pf: *mut otx2_nic, prog: *mut bpf_prog) -> c_int {
    static int otx2_xdp_setup(struct otx2_nic *pf, struct bpf_prog *prog)
    {
    struct net_device *dev = pf.netdev;
    let mut if_up: bool = netif_running(pf.netdev);
...
#[no_mangle]
unsafe extern "C" fn otx2_xdp(netdev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_wq_init(pf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_check_pf_usable(nic: *mut otx2_nic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_realloc_msix_vectors(pf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_sriov_vfcfg_init(pf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_sriov_vfcfg_cleanup(pf: *mut otx2_nic) {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_init_rsrc(pdev: *mut pci_dev, pf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_vf_link_event_task(work: *mut work_struct) {
    static void otx2_vf_link_event_task(struct work_struct *work)
    {
    struct otx2_vf_config *config;
...
#[no_mangle]
unsafe extern "C" fn otx2_sriov_enable(pdev: *mut pci_dev, numvfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_sriov_disable(pdev: *mut pci_dev) -> c_int {
    static int otx2_sriov_disable(struct pci_dev *pdev)
    {
    struct net_device *netdev = pci_get_drvdata(pdev);
    struct otx2_nic *pf = netdev_priv(netdev);
    let mut numvfs: c_int = pci_num_vf(pdev);
    if (!numvfs)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn otx2_sriov_configure(pdev: *mut pci_dev, numvfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_ndc_sync(pf: *mut otx2_nic) {
...
#[no_mangle]
unsafe extern "C" fn otx2_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn otx2_rvupf_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn otx2_rvupf_cleanup_module() -> void __exit {
