...
//! Source: drivers/net/ethernet/marvell/octeontx2/nic/otx2_vf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn otx2vf_vfaf_mbox_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_vfaf_mbox_up_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_vfaf_mbox_intr_handler(irq: c_int, vf_irq: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_disable_mbox_intr(vf: *mut otx2_nic) {
    static void otx2vf_disable_mbox_intr(struct otx2_nic *vf)
    {
    let mut vector: c_int = pci_irq_vector(vf.pdev, RVU_VF_INT_VEC_MBOX);
...
#[no_mangle]
unsafe extern "C" fn otx2vf_register_mbox_intr(vf: *mut otx2_nic, probe_pf: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_vfaf_mbox_destroy(vf: *mut otx2_nic) {
    static void otx2vf_vfaf_mbox_destroy(struct otx2_nic *vf)
    {
    struct mbox *mbox = &vf.mbox;
    if (vf.mbox_wq) {
    destroy_workqueue(vf.mbox_wq);
    vf.mbox_wq = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn otx2vf_vfaf_mbox_init(vf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_stop(netdev: *mut net_device) -> c_int {
    static int otx2vf_stop(struct net_device *netdev)
    {
    return otx2_stop(netdev);
    }
#[no_mangle]
unsafe extern "C" fn otx2vf_xmit(skb: *mut sk_buff, netdev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_set_rx_mode(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_do_set_rx_mode(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_reset_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn otx2_vf_wq_init(vf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_realloc_msix_vectors(vf: *mut otx2_nic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    static int otx2vf_probe(struct pci_dev *pdev, const struct pci_device_id *id)
    {
    let mut num_vec: c_int = pci_msix_vec_count(pdev);
...
#[no_mangle]
unsafe extern "C" fn otx2vf_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn otx2vf_cleanup_module() -> void __exit {
