...
//! Source: drivers/net/ethernet/marvell/octeontx2/af/rvu_nix.c
#![no_std]
...
pub const MC_TX_MAX: c_int = 2048;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mce {
    pub node: hlist_node,
    pub rq_rss_index: u32,
    pub pcifunc: u16,
    pub channel: u16,
    pub dest_type: u8,
    pub is_active: u8,
...
#[no_mangle]
pub unsafe extern "C" fn rvu_get_next_nix_blkaddr(rvu: *mut rvu, blkaddr: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_nixlf_attached(rvu: *mut rvu, pcifunc: u16) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_get_nixlf_count(rvu: *mut rvu) -> c_int {
    int rvu_get_nixlf_count(struct rvu *rvu)
    {
    let mut blkaddr: c_int = 0, max = 0;
...
#[no_mangle]
pub unsafe extern "C" fn nix_get_nixlf(rvu: *mut rvu, pcifunc: u16, nixlf: *mut c_int, nix_blkaddr: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nix_mce_list_init(list: *mut nix_mce_list, max: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nix_alloc_mce_list(mcast: *mut nix_mcast, count: c_int, dir: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nix_free_mce_list(mcast: *mut nix_mcast, count: c_int, start: c_int, dir: u8) {
    ...
    {
    let mut nix_blkaddr: c_int = 0, i = 0;
...
#[no_mangle]
pub unsafe extern "C" fn nix_get_dwrr_mtu_reg(hw: *mut rvu_hwinfo, smq_link_type: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn convert_dwrr_mtu_to_bytes(dwrr_mtu: u8) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn convert_bytes_to_dwrr_mtu(bytes: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nix_rx_sync(rvu: *mut rvu, blkaddr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nix_interface_deinit(rvu: *mut rvu, pcifunc: u16, nixlf: u8) {
...
pub const NIX_BPIDS_PER_LMAC: c_int = 8;
pub const NIX_BPIDS_PER_CPT: c_int = 1;
#[no_mangle]
unsafe extern "C" fn nix_setup_bpids(rvu: *mut rvu, hw: *mut nix_hw, blkaddr: c_int) -> c_int {
...
// Reserve the BPIds for CGX and SDP
    ...
    bp.bpids.bmap = core::ptr::null_mut();
    return -ENOMEM;
    }
#[no_mangle]
pub unsafe extern "C" fn rvu_nix_flr_free_bpids(rvu: *mut rvu, pcifunc: u16) {
...
#[no_mangle]
unsafe extern "C" fn nix_get_channel(chan: u16, cpt_link: bool) -> u16 {
...
// Map channel and bpid assign to it
    ...
    {
    let mut field: nix_lso_format = {0};
// IP's Length field
...
#[no_mangle]
unsafe extern "C" fn nix_setup_lso(rvu: *mut rvu, nix_hw: *mut nix_hw, blkaddr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nix_ctx_free(rvu: *mut rvu, pfvf: *mut rvu_pfvf) {
    ...
    pfvf.rq_bmap = core::ptr::null_mut();
    pfvf.cq_bmap = core::ptr::null_mut();
    pfvf.sq_bmap = core::ptr::null_mut();
    pfvf.rq_ctx = core::ptr::null_mut();
    pfvf.sq_ctx = core::ptr::null_mut();
    pfvf.cq_ctx = core::ptr::null_mut();
    pfvf.rss_ctx = core::ptr::null_mut();
    pfvf.nix_qints_ctx = core::ptr::null_mut();
    pfvf.cq_ints_ctx = core::ptr::null_mut();
    }
...
// Mask needs to be written at RES_ADDR + 256
    ...
    NIX_MAX_CTX_SIZE);
#[no_mangle]
pub unsafe extern "C" fn if(NIX_AQ_CTYPE_SQ: req->ctype ==) -> else {
    else if (req.ctype == NIX_AQ_CTYPE_SQ)
    memcpy(mask, &req.sq_mask,
    NIX_MAX_CTX_SIZE);
#[no_mangle]
pub unsafe extern "C" fn if(NIX_AQ_CTYPE_CQ: req->ctype ==) -> else {
    else if (req.ctype == NIX_AQ_CTYPE_CQ)
    memcpy(mask, &req.cq_mask,
    NIX_MAX_CTX_SIZE);
#[no_mangle]
pub unsafe extern "C" fn if(NIX_AQ_CTYPE_RSS: req->ctype ==) -> else {
    else if (req.ctype == NIX_AQ_CTYPE_RSS)
    memcpy(mask, &req.rss_mask,
    NIX_MAX_CTX_SIZE);
#[no_mangle]
pub unsafe extern "C" fn if(NIX_AQ_CTYPE_MCE: req->ctype ==) -> else {
    else if (req.ctype == NIX_AQ_CTYPE_MCE)
    memcpy(mask, &req.mce_mask,
    NIX_MAX_CTX_SIZE);
#[no_mangle]
pub unsafe extern "C" fn if(NIX_AQ_CTYPE_BANDPROF: req->ctype ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn nix_lf_hwctx_disable(rvu: *mut rvu, req: *mut hwctx_disable_req) -> c_int {
    ...
    continue;
    aq_req.qidx = qidx;
    rc = rvu_nix_aq_enq_inst(rvu, &aq_req, core::ptr::null_mut());
    if (rc) {
    err = rc;
...
#[no_mangle]
unsafe extern "C" fn nix_lf_hwctx_lockdown(rvu: *mut rvu, req: *mut nix_aq_enq_req) -> c_int {
    ...
    err = rvu_nix_aq_enq_inst(rvu, &lock_ctx_req, core::ptr::null_mut());
    if (err)
    dev_err(rvu.dev,
...
// CN10K mbox handler
    ...
    struct rvu_hwinfo *hw = rvu.hw;
    let mut pcifunc: u16 = req.hdr.pcifunc;
    let mut cgx_id: u8 = 0, lmac_id = 0;
    let mut rules_created: bool = false;
    struct rvu_block *block;
    struct rvu_pfvf *pfvf;
    struct cgx *cgxd;
    u64 cfg, ctx_cfg;
...
// Wait until VLD(bit32) == 1 or C_CON(bit48) == 0
    ...
    int lvl, int schq)
    {
    let mut tlx_parent: u64 = 0, tlx_schedule = 0;
    switch (lvl) {
    case NIX_TXSCH_LVL_TL2:
...
//
    ...
    {
    struct rvu_hwinfo *hw = rvu.hw;
    let mut cir_reg: u64 = 0, pir_reg = 0;
    u64  cfg;
    switch (lvl) {
    case NIX_TXSCH_LVL_TL1:
...
#[no_mangle]
unsafe extern "C" fn nix_get_tx_link(rvu: *mut rvu, pcifunc: u16) -> c_int {
    static int nix_get_tx_link(struct rvu *rvu, u16 pcifunc)
    {
    struct rvu_hwinfo *hw = rvu.hw;
...
// If contiguous queues are needed, check for availability
    ...
    {
    struct rvu_hwinfo *hw = rvu.hw;
    let mut pcifunc: u16 = rsp.hdr.pcifunc;
    int idx, schq;
...
#[no_mangle]
unsafe extern "C" fn nix_txschq_free(rvu: *mut rvu, pcifunc: u16) -> c_int {
...
// Free the resource
    ...
    int lvl, u64 reg, u64 regval)
    {
    let mut regbase: u64 = reg & 0xFFFF;
    u16 schq, parent;
...
#[no_mangle]
unsafe extern "C" fn is_txschq_shaping_valid(hw: *mut rvu_hwinfo, lvl: c_int, reg: u64) -> bool {
...
//
    ...
    let mut pf: u8 = rvu_get_pf(rvu.pdev, pcifunc);
    int schq;
    u64 cfg;
...
//
    ...
    {
    let mut regval: u64 = req.vtag_size;
...
#[no_mangle]
unsafe extern "C" fn nix_free_tx_vtag_entries(rvu: *mut rvu, pcifunc: u16) {
    static void nix_free_tx_vtag_entries(struct rvu *rvu, u16 pcifunc)
    {
    struct nix_txvlan *vlan;
    struct nix_hw *nix_hw;
...
// Scan all the entries and free the ones mapped to 'pcifunc'
    ...
    struct nix_hw *nix_hw = get_nix_hw(rvu.hw, blkaddr);
    let mut pcifunc: u16 = req.hdr.pcifunc;
    let mut idx0: c_int = req.tx.vtag0_idx;
    let mut idx1: c_int = req.tx.vtag1_idx;
    struct nix_txvlan *vlan;
    let mut err: c_int = 0;
    if (!nix_hw)
    return NIX_AF_ERR_INVALID_NIXBLK;
...
// (u64 *)(&aq_req.mce_mask) = ~0ULL;
    err = rvu_nix_blk_aq_enq_inst(rvu, nix_hw, &aq_req, core::ptr::null_mut());
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn nix_delete_mcast_mce_list(mce_list: *mut nix_mce_list) {
...
#[no_mangle]
unsafe extern "C" fn nix_get_last_mce_list_index(elem: *mut nix_mcast_grp_elem) -> c_int {
...
// EOL should be set in last MCE
    ...
    {
    let mut num_entry: u32 = req.num_mce_entry;
    struct nix_mce_list *mce_list;
    struct mce *mce;
    bool is_found;
    int i;
...
// Dump the updated list to HW
    ...
    {
    struct mce *mce, *tail = core::ptr::null_mut();
...
// Add a new one to the list, at the tail
    ...
    {
    let mut err: c_int = 0, idx, next_idx, last_idx, blkaddr, npc_blkaddr;
...
// mce_idx = 0;
    ...
    int type, bool add)
    {
    let mut err: c_int = 0, nixlf, blkaddr, mcam_index, mce_idx;
    struct npc_mcam *mcam = &rvu.hw.mcam;
    struct rvu_hwinfo *hw = rvu.hw;
    struct nix_mce_list *mce_list;
    int pf;
...
#[no_mangle]
unsafe extern "C" fn nix_setup_mcast_grp(nix_hw: *mut nix_hw) {
...
#[no_mangle]
unsafe extern "C" fn nix_setup_mce_tables(rvu: *mut rvu, nix_hw: *mut nix_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nix_setup_mcast(rvu: *mut rvu, nix_hw: *mut nix_hw, blkaddr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nix_setup_txvlan(rvu: *mut rvu, nix_hw: *mut nix_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nix_setup_txschq(rvu: *mut rvu, nix_hw: *mut nix_hw, blkaddr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_get_lbk_link_max_frs(rvu: *mut rvu, max_mtu: *mut u16) {
...
#[no_mangle]
unsafe extern "C" fn rvu_get_lmac_link_max_frs(rvu: *mut rvu, max_mtu: *mut u16) {
    static void rvu_get_lmac_link_max_frs(struct rvu *rvu, u16 *max_mtu)
    {
    let mut fifo_size: c_int = rvu_cgx_get_fifolen(rvu);
...
#[no_mangle]
unsafe extern "C" fn get_flowkey_alg_idx(nix_hw: *mut nix_hw, flow_cfg: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_flowkey_fields(alg: *mut nix_rx_flowkey_alg, flow_cfg: u32) -> c_int {
    ...
    u32 l3_l4_src_dst;
    let mut l4_key_offset: c_int = 0;
    if (!alg)
    return -EINVAL;
pub const FIELDS_PER_ALG: c_int = 5;
pub const MAX_KEY_OFF: c_int = 40;
// Clear all fields
...
#[no_mangle]
unsafe extern "C" fn reserve_flowkey_alg_idx(rvu: *mut rvu, blkaddr: c_int, flow_cfg: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nix_rx_flowkey_alg_cfg(rvu: *mut rvu, blkaddr: c_int) -> c_int {
...
// TCP/UDP/SCTP v4/v6 4-tuple, rest IP pkts 2-tuple
    ...
    struct msg_rsp *rsp)
    {
    let mut from_vf: bool = req.hdr.pcifunc & RVU_PFVF_FUNC_MASK;
    let mut pcifunc: u16 = req.hdr.pcifunc;
    int blkaddr, nixlf, err;
    struct rvu_pfvf *pfvf;
    err = nix_get_nixlf(rvu, pcifunc, &nixlf, &blkaddr);
...
// untrusted VF can't configure promisc/allmulti
    ...
    (promisc || allmulti))
    return 0;
    err = nix_get_nixlf(rvu, pcifunc, &nixlf, core::ptr::null_mut());
    if (err)
    return err;
    if (nix_rx_multicast) {
...
#[no_mangle]
unsafe extern "C" fn rvu_get_lbk_link_credits(rvu: *mut rvu, lbk_max_frs: u16) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn nix_calibrate_x2p(rvu: *mut rvu, blkaddr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nix_aq_init(rvu: *mut rvu, block: *mut rvu_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_nix_setup_capabilities(rvu: *mut rvu, blkaddr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rvu_nix_block_init(rvu: *mut rvu, nix_hw: *mut nix_hw) -> c_int {
    static int rvu_nix_block_init(struct rvu *rvu, struct nix_hw *nix_hw)
    {
    const struct npc_lt_def_cfg *ltdefs;
    struct rvu_hwinfo *hw = rvu.hw;
    let mut blkaddr: c_int = nix_hw.blkaddr;
    struct rvu_block *block;
    int err;
    u64 cfg;
    block = &hw.block[blkaddr];
...
#[no_mangle]
pub unsafe extern "C" fn rvu_nix_init(rvu: *mut rvu) -> c_int {
    int rvu_nix_init(struct rvu *rvu)
    {
    struct rvu_hwinfo *hw = rvu.hw;
    struct nix_hw *nix_hw;
    let mut blkaddr: c_int = 0, err;
    let mut i: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn rvu_nix_freemem(rvu: *mut rvu) {
    ...
    {
    struct npc_mcam *mcam = &rvu.hw.mcam;
    let mut rx_action: nix_rx_action = { 0 };
    let mut tx_action: nix_tx_action = { 0 };
    int npc_blkaddr;
    npc_blkaddr = rvu_get_blkaddr(rvu, BLKTYPE_NPC, 0);
    if (elem.dir == NIX_MCAST_INGRESS) {
...
#[no_mangle]
unsafe extern "C" fn nix_mcast_update_mce_entry(rvu: *mut rvu, pcifunc: u16, is_active: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_nix_lf_teardown(rvu: *mut rvu, pcifunc: u16, blkaddr: c_int, nixlf: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rvu_nix_lf_ptp_tx_cfg(rvu: *mut rvu, pcifunc: u16, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_nix_reset_mac(pfvf: *mut rvu_pfvf, pcifunc: c_int) {
    void rvu_nix_reset_mac(struct rvu_pfvf *pfvf, int pcifunc)
    {
    let mut from_vf: bool = !!(pcifunc & RVU_PFVF_FUNC_MASK);
...
#[no_mangle]
unsafe extern "C" fn nix_config_rx_pkt_policer_precolor(rvu: *mut rvu, blkaddr: c_int) {
...
// Context is all zeros, submit to AQ
    ...
    (struct nix_aq_enq_req *)&aq_req, core::ptr::null_mut());
    if (rc)
...
#[no_mangle]
unsafe extern "C" fn nix_ipolicer_freemem(rvu: *mut rvu, nix_hw: *mut nix_hw) {
    static void nix_ipolicer_freemem(struct rvu *rvu, struct nix_hw *nix_hw)
    {
    struct nix_ipolicer *ipolicer;
    int layer;
...
#[no_mangle]
pub unsafe extern "C" fn if(BAND_PROF_MID_LAYER: layer ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn nix_free_all_bandprof(rvu: *mut rvu, pcifunc: u16) -> c_int {
    static int nix_free_all_bandprof(struct rvu *rvu, u16 pcifunc)
    {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_nix_mcast_get_mce_index(rvu: *mut rvu, pcifunc: u16, mcast_grp_idx: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_nix_mcast_flr_free_entries(rvu: *mut rvu, pcifunc: u16) {
    void rvu_nix_mcast_flr_free_entries(struct rvu *rvu, u16 pcifunc)
    {
    let mut dreq: nix_mcast_grp_destroy_req = { 0 };
    let mut ureq: nix_mcast_grp_update_req = { 0 };
    let mut ursp: nix_mcast_grp_update_rsp = { 0 };
...
// Delete group
    ...
    dreq.is_af = 1;
    rvu_mbox_handler_nix_mcast_grp_destroy(rvu, &dreq, core::ptr::null_mut());
    continue;
    }
...
//
    ...
    struct msg_rsp *rsp)
    {
    let mut uninstall_req: npc_delete_flow_req = { 0 };
    let mut uninstall_rsp: npc_delete_flow_rsp = { 0 };
    struct nix_mcast_grp_elem *elem;
    struct nix_mcast_grp *mcast_grp;
...
//
#[no_mangle]
pub unsafe extern "C" fn rvu_block_bcast_xon(rvu: *mut rvu, blkaddr: c_int) {
