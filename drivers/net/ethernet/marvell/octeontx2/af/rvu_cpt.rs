...
//! Source: drivers/net/ethernet/marvell/octeontx2/af/rvu_cpt.c
#![no_std]
...
// CPT PF device id
pub const PCI_DEVID_OTX2_CPT_PF: c_uint = 0xA0FD;
pub const PCI_DEVID_OTX2_CPT10K_PF: c_uint = 0xA0F2;
// Length of initial context fetch in 128 byte words

// Interrupt vector count of CPT RVU and RAS interrupts
pub const CPT_10K_AF_RVU_RAS_INT_VEC_CNT: c_int = 2;
// Default CPT_AF_RXC_CFG1:max_rxc_icb_cnt
pub const CPT_DFLT_MAX_RXC_ICB_CNT: c_uint = 0xC0ULL;
...
#[no_mangle]
unsafe extern "C" fn cpt_max_engines_get(rvu: *mut rvu) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn cpt_10k_flt_nvecs_get(rvu: *mut rvu, max_engs: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpt_af_flt_intr_handler(vec: c_int, ptr: *mut c_void) -> irqreturn_t {
    static irqreturn_t cpt_af_flt_intr_handler(int vec, void *ptr)
    {
    struct rvu_block *block = ptr;
    struct rvu *rvu = block.rvu;
    let mut blkaddr: c_int = block.addr;
    u64 reg, val;
    int i, eng;
    u8 grp;
...
#[no_mangle]
unsafe extern "C" fn rvu_cpt_af_flt0_intr_handler(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
    static irqreturn_t rvu_cpt_af_flt0_intr_handler(int irq, void *ptr)
    {
    return cpt_af_flt_intr_handler(CPT_AF_INT_VEC_FLT0, ptr);
    }
#[no_mangle]
unsafe extern "C" fn rvu_cpt_af_flt1_intr_handler(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
    static irqreturn_t rvu_cpt_af_flt1_intr_handler(int irq, void *ptr)
    {
    return cpt_af_flt_intr_handler(CPT_AF_INT_VEC_FLT1, ptr);
    }
#[no_mangle]
unsafe extern "C" fn rvu_cpt_af_flt2_intr_handler(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rvu_cpt_af_rvu_intr_handler(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rvu_cpt_af_ras_intr_handler(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cpt_10k_unregister_interrupts(block: *mut rvu_block, off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cpt_unregister_interrupts(rvu: *mut rvu, blkaddr: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_cpt_unregister_interrupts(rvu: *mut rvu) {
...
#[no_mangle]
unsafe extern "C" fn cpt_10k_register_interrupts(block: *mut rvu_block, off: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpt_register_interrupts(rvu: *mut rvu, blkaddr: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_cpt_register_interrupts(rvu: *mut rvu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_cpt_pf_num(rvu: *mut rvu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_cpt_pf(rvu: *mut rvu, pcifunc: u16) -> bool {
    static bool is_cpt_pf(struct rvu *rvu, u16 pcifunc)
    {
    let mut cpt_pf_num: c_int = rvu.cpt_pf_num;
...
#[no_mangle]
unsafe extern "C" fn is_cpt_vf(rvu: *mut rvu, pcifunc: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn validate_and_get_cpt_blkaddr(req_blkaddr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpt_lf_free(rvu: *mut rvu, req: *mut msg_req, blkaddr: c_int) -> c_int {
...
// Reset LF
    ...
    {
    let mut sso_pf_func: u16 = req.sso_pf_func;
    u8 nix_sel;
    u64 val;
...
//
    ...
    struct cpt_inline_ipsec_cfg_msg *req)
    {
    let mut nix_pf_func: u16 = req.nix_pf_func;
    int nix_blkaddr;
    u8 nix_sel;
    u64 val;
    val = rvu_read64(rvu, blkaddr, CPT_AF_LFX_CTL(cptlf));
...
// Set NIX_PF_FUNC
    ...
    u64 *reg_offset)
    {
    let mut offset: u64 = req.reg_offset;
...
#[no_mangle]
unsafe extern "C" fn get_ctx_pc(rvu: *mut rvu, rsp: *mut cpt_sts_rsp, blkaddr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn get_eng_sts(rvu: *mut rvu, rsp: *mut cpt_sts_rsp, blkaddr: c_int) {
    static void get_eng_sts(struct rvu *rvu, struct cpt_sts_rsp *rsp, int blkaddr)
    {
    u16 max_ses, max_ies, max_aes;
    let mut e_min: u32 = 0, e_max = 0;
    u64 reg;
...
// This message is accepted only if sent from CPT PF/VF
    ...
    !is_cpt_vf(rvu, req.hdr.pcifunc))
    return CPT_AF_ERR_ACCESS_DENIED;
    cpt_rxc_time_cfg(rvu, req, blkaddr, core::ptr::null_mut());
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn cpt_rxc_teardown(rvu: *mut rvu, blkaddr: c_int) {
...
// Restore config
    cpt_rxc_time_cfg(rvu, &prev, blkaddr, core::ptr::null_mut());
    }

#[no_mangle]
unsafe extern "C" fn cpt_lf_disable_iqueue(rvu: *mut rvu, blkaddr: c_int, slot: c_int) {
    static void cpt_lf_disable_iqueue(struct rvu *rvu, int blkaddr, int slot)
    {
    let mut timeout: c_int = 1000000;
    u64 inprog, inst_ptr;
    u64 qsize, pending;
    let mut i: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn rvu_cpt_lf_teardown(rvu: *mut rvu, pcifunc: u16, blkaddr: c_int, lf: c_int, slot: c_int) -> c_int {
...
pub const CPT_RES_LEN: c_int = 16;
...
#[no_mangle]
pub unsafe extern "C" fn rvu_cpt_ctx_flush(rvu: *mut rvu, pcifunc: u16) -> c_int {
    int rvu_cpt_ctx_flush(struct rvu *rvu, u16 pcifunc)
    {
    int nix_blkaddr, blkaddr;
    u16 max_ctx_entries, i;
    let mut slot: c_int = 0, num_lfs;
    u64 reg, cam_data;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn rvu_cpt_init(rvu: *mut rvu) -> c_int {
