...
//! Source: drivers/net/ethernet/marvell/octeontx2/af/rvu_switch.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rvu_switch_enable_lbk_link(rvu: *mut rvu, pcifunc: u16, enable: bool) {
...
// Enable LBK links with channel 63 for TX MCAM rule
    ...
    u16 chan_mask)
    {
    let mut req: npc_install_flow_req = { 0 };
    let mut rsp: npc_install_flow_rsp = { 0 };
...
#[no_mangle]
unsafe extern "C" fn rvu_switch_install_tx_rule(rvu: *mut rvu, pcifunc: u16, entry: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_switch_install_rules(rvu: *mut rvu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_switch_enable(rvu: *mut rvu) {
    void rvu_switch_enable(struct rvu *rvu)
    {
    let mut alloc_req: npc_mcam_alloc_entry_req = { 0 };
    let mut alloc_rsp: npc_mcam_alloc_entry_rsp = { 0 };
    let mut uninstall_req: npc_delete_flow_req = { 0 };
    let mut uninstall_rsp: npc_delete_flow_rsp = { 0 };
    let mut free_req: npc_mcam_free_entry_req = { 0 };
    struct rvu_switch *rswitch = &rvu.rswitch;
    struct msg_rsp rsp;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn rvu_switch_disable(rvu: *mut rvu) {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_switch_update_rules(rvu: *mut rvu, pcifunc: u16, ena: bool) {
