...
//! Source: drivers/net/ethernet/marvell/octeontx2/af/rvu_rep.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rvu_rep_up_notify(rvu: *mut rvu, event: *mut rep_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_rep_wq_handler(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_rep_notify_pfvf_state(rvu: *mut rvu, pcifunc: u16, enable: bool) -> c_int {
    ...
    {
    let mut pcifunc: u16 = req.pcifunc;
...
#[no_mangle]
unsafe extern "C" fn rvu_rep_get_vlan_id(rvu: *mut rvu, pcifunc: u16) -> u16 {
    ...
    {
    let mut rsp: nix_vtag_config_rsp = {};
    let mut req: nix_vtag_config = {};
    let mut etype: u64 = ETH_P_8021Q;
    int err;
// Insert vlan tag
...
#[no_mangle]
unsafe extern "C" fn rvu_rep_rx_vlan_cfg(rvu: *mut rvu, pcifunc: u16) -> c_int {
...
// config strip, capture and size
    ...
    u16 entry, bool rte)
    {
    let mut req: npc_install_flow_req = {};
    let mut rsp: npc_install_flow_rsp = {};
...
#[no_mangle]
pub unsafe extern "C" fn rvu_rep_install_mcam_rules(rvu: *mut rvu) -> c_int {
    int rvu_rep_install_mcam_rules(struct rvu *rvu)
    {
    struct rvu_switch *rswitch = &rvu.rswitch;
    let mut start: u16 = rswitch.start_entry;
    ...
    rvu_get_pf_numvfs(rvu, pf, &numvfs, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn rvu_rep_update_rules(rvu: *mut rvu, pcifunc: u16, ena: bool) {
    void rvu_rep_update_rules(struct rvu *rvu, u16 pcifunc, bool ena)
    {
    struct rvu_switch *rswitch = &rvu.rswitch;
    struct npc_mcam *mcam = &rvu.hw.mcam;
    let mut max: u32 = rswitch.used_entries;
    int blkaddr;
    u16 entry;
...
#[no_mangle]
pub unsafe extern "C" fn rvu_rep_pf_init(rvu: *mut rvu) -> c_int {
    int rvu_rep_pf_init(struct rvu *rvu)
    {
    let mut pcifunc: u16 = rvu.rep_pcifunc;
    struct rvu_pfvf *pfvf;
    pfvf = rvu_get_pfvf(rvu, pcifunc);
