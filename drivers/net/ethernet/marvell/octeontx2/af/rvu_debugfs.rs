...
//! Source: drivers/net/ethernet/marvell/octeontx2/af/rvu_debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_mcs_port_stats_display(filp: *mut seq_file, unused: *mut c_void, dir: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_mcs_rx_port_stats_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(mcs_rx_port_stats, mcs_rx_port_stats_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_mcs_tx_port_stats_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(mcs_tx_port_stats, mcs_tx_port_stats_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_mcs_sa_stats_display(filp: *mut seq_file, unused: *mut c_void, dir: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_mcs_rx_sa_stats_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(mcs_rx_sa_stats, mcs_rx_sa_stats_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_mcs_tx_sa_stats_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(mcs_tx_sa_stats, mcs_tx_sa_stats_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_mcs_tx_sc_stats_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(mcs_tx_sc_stats, mcs_tx_sc_stats_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_mcs_rx_sc_stats_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(mcs_rx_sc_stats, mcs_rx_sc_stats_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_mcs_flowid_stats_display(filp: *mut seq_file, unused: *mut c_void, dir: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_mcs_tx_flowid_stats_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(mcs_tx_flowid_stats, mcs_tx_flowid_stats_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_mcs_rx_flowid_stats_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(mcs_rx_flowid_stats, mcs_rx_flowid_stats_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_mcs_tx_secy_stats_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(mcs_tx_secy_stats, mcs_tx_secy_stats_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_mcs_rx_secy_stats_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(mcs_rx_secy_stats, mcs_rx_secy_stats_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_mcs_init(rvu: *mut rvu) {
...
pub const LMT_MAPTBL_ENTRY_SIZE: c_int = 16;
...
// ppos = ret;
    ...
    RVU_DEBUG_FOPS(lmtst_map_table, lmtst_map_table_display, core::ptr::null_mut());
    static void get_lf_str_list(const struct rvu_block *block, int pcifunc,
    char *lfs)
    {
    let mut lf: c_int = 0, seq = 0, len = 0, prev_lf = block.lf.max;
...
#[no_mangle]
unsafe extern "C" fn get_max_column_width(rvu: *mut rvu) -> c_int {
...
// Dumps current provisioning status of all RVU block LFs
    ...
    struct rvu *rvu = filp.private_data;
    let mut bytes_not_copied: c_int = 0;
    struct rvu_block block;
    int pf, vf, pcifunc;
    let mut buf_size: c_int = 2048;
    int lf_str_size;
    char *lfs;
    char *buf;
// don't allow partial reads
...
// ppos += off;
    ...
    RVU_DEBUG_FOPS(rsrc_status, rsrc_attach_status, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_rvu_pf_cgx_map_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
...
// There can be no CGX devices at all
    ...
    RVU_DEBUG_SEQ_FOPS(rvu_pf_cgx_map, rvu_pf_cgx_map_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_rvu_fwdata_display(s: *mut seq_file, unused: *mut c_void) -> c_int {
    static int rvu_dbg_rvu_fwdata_display(struct seq_file *s, void *unused)
    {
    struct rvu *rvu = s.private;
    struct rvu_fwdata *fwdata;
    u8 mac[ETH_ALEN];
    let mut count: c_int = 0, i;
    if (!rvu.fwdata)
    return -EAGAIN;
    fwdata = rvu.fwdata;
    seq_puts(s, "\nRVU Firmware Data:\n");
    ...
    RVU_DEBUG_SEQ_FOPS(rvu_fwdata, rvu_fwdata_display, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn print_npa_qsize(m: *mut seq_file, pfvf: *mut rvu_pfvf) {
...
//
    ...
    struct rvu_pfvf *pfvf) = core::ptr::null_mut();
    struct rvu_pfvf *pfvf;
    struct rvu *rvu;
    int qsize_id;
    u16 pcifunc;
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_npa_qsize_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_npa_aura_ctx(m: *mut seq_file, rsp: *mut npa_aq_enq_rsp) {
...
#[no_mangle]
unsafe extern "C" fn print_npa_pool_ctx(m: *mut seq_file, rsp: *mut npa_aq_enq_rsp) {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_npa_ctx_display(m: *mut seq_file, unused: *mut c_void, ctype: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_npa_aura_ctx_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_npa_pool_ctx_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ndc_blk_cache_stats(s: *mut seq_file, idx: c_int, blk_addr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_npa_ndc_cache_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(npa_ndc_cache, npa_ndc_cache_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn ndc_blk_hits_miss_stats(s: *mut seq_file, idx: c_int, blk_addr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_nix_ndc_rx_cache_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    static int rvu_dbg_nix_ndc_rx_cache_display(struct seq_file *filp, void *unused)
    {
    struct nix_hw *nix_hw = filp.private;
    let mut blkaddr: c_int = 0;
    let mut ndc_idx: c_int = 0;
    ...
    RVU_DEBUG_SEQ_FOPS(nix_ndc_rx_cache, nix_ndc_rx_cache_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_nix_ndc_tx_cache_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(nix_ndc_tx_cache, nix_ndc_tx_cache_display, core::ptr::null_mut());
    ...
    RVU_DEBUG_SEQ_FOPS(npa_ndc_hits_miss, npa_ndc_hits_miss_display, core::ptr::null_mut());
    static int rvu_dbg_nix_ndc_rx_hits_miss_display(struct seq_file *filp,
    void *unused)
    {
    struct nix_hw *nix_hw = filp.private;
    let mut ndc_idx: c_int = NPA0_U;
    let mut blkaddr: c_int = 0;
    blkaddr = (nix_hw.blkaddr == BLKADDR_NIX1 ?
    BLKADDR_NDC_NIX1_RX : BLKADDR_NDC_NIX0_RX);
    return ndc_blk_hits_miss_stats(filp, ndc_idx, blkaddr);
    }
    RVU_DEBUG_SEQ_FOPS(nix_ndc_rx_hits_miss, nix_ndc_rx_hits_miss_display, core::ptr::null_mut());
    ...
    RVU_DEBUG_SEQ_FOPS(nix_ndc_tx_hits_miss, nix_ndc_tx_hits_miss_display, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_nix_tm_tree_display(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_tm_topo(m: *mut seq_file, schq: u64, lvl: u32) {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_nix_tm_topo_display(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_nix_sq_ctx(m: *mut seq_file, rsp: *mut nix_aq_enq_rsp) {
...
#[no_mangle]
unsafe extern "C" fn print_nix_rq_ctx(m: *mut seq_file, rsp: *mut nix_aq_enq_rsp) {
...
#[no_mangle]
unsafe extern "C" fn print_nix_cq_ctx(m: *mut seq_file, rsp: *mut nix_aq_enq_rsp) {
    ...
    struct nix_aq_enq_rsp *rsp) = core::ptr::null_mut();
    struct nix_hw *nix_hw = filp.private;
    struct rvu *rvu = nix_hw.rvu;
    struct nix_aq_enq_req aq_req;
    struct nix_aq_enq_rsp rsp;
    char *ctype_string = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_nix_sq_ctx_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_nix_rq_ctx_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_nix_cq_ctx_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_nix_qsize(filp: *mut seq_file, pfvf: *mut rvu_pfvf) {
    static void print_nix_qsize(struct seq_file *filp, struct rvu_pfvf *pfvf)
    {
    if (!pfvf.cq_ctx)
    seq_puts(filp, "cq context is not initialized\n");
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_nix_qsize_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_nix_band_prof_ctx_display(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
// Ingress policers do not exist on all platforms
    ...
    RVU_DEBUG_SEQ_FOPS(nix_band_prof_ctx, nix_band_prof_ctx_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_nix_band_prof_rsrc_display(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
// Ingress policers do not exist on all platforms
    ...
    RVU_DEBUG_SEQ_FOPS(nix_band_prof_rsrc, nix_band_prof_rsrc_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_nix_init(rvu: *mut rvu, blkaddr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_npa_init(rvu: *mut rvu) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rvu_cgx_lmac_dbgfs_ctx {
    pub rvu: *mut rvu,
    pub cgxd: *mut c_void,
}
...
#[no_mangle]
unsafe extern "C" fn cgx_print_stats(s: *mut seq_file, lmac_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_derive_lmacid(s: *mut seq_file) -> c_int {
    static int rvu_dbg_derive_lmacid(struct seq_file *s)
    {
    return debugfs_get_aux_num(s.file);
    }
#[no_mangle]
unsafe extern "C" fn rvu_dbg_cgx_stat_display(s: *mut seq_file, unused: *mut c_void) -> c_int {
    static int rvu_dbg_cgx_stat_display(struct seq_file *s, void *unused)
    {
    return cgx_print_stats(s, rvu_dbg_derive_lmacid(s));
    }
    RVU_DEBUG_SEQ_FOPS(cgx_stat, cgx_stat_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn cgx_print_dmac_flt(s: *mut seq_file, lmac_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_cgx_dmac_flt_display(s: *mut seq_file, unused: *mut c_void) -> c_int {
    static int rvu_dbg_cgx_dmac_flt_display(struct seq_file *s, void *unused)
    {
    return cgx_print_dmac_flt(s, rvu_dbg_derive_lmacid(s));
    }
    RVU_DEBUG_SEQ_FOPS(cgx_dmac_flt, cgx_dmac_flt_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn cgx_print_fwdata(s: *mut seq_file, lmac_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_cgx_fwdata_display(s: *mut seq_file, unused: *mut c_void) -> c_int {
    static int rvu_dbg_cgx_fwdata_display(struct seq_file *s, void *unused)
    {
    return cgx_print_fwdata(s, rvu_dbg_derive_lmacid(s));
    }
    RVU_DEBUG_SEQ_FOPS(cgx_fwdata, cgx_fwdata_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_cgx_init(rvu: *mut rvu) {
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_npc_mcam_info_display(filp: *mut seq_file, unsued: *mut c_void) -> c_int {
...
// MCAM counters
    ...
    RVU_DEBUG_SEQ_FOPS(npc_mcam_info, npc_mcam_info_display, core::ptr::null_mut());
    ...
    RVU_DEBUG_SEQ_FOPS(npc_rx_miss_act, npc_rx_miss_stats_display, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_npc_mcam_show_rules(s: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(npc_mcam_rules, npc_mcam_show_rules, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_npc_exact_show_entries(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
// Traverse cam table entries
    ...
    RVU_DEBUG_SEQ_FOPS(npc_exact_entries, npc_exact_show_entries, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_npc_exact_show_info(s: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(npc_exact_info, npc_exact_show_info, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_npc_exact_drop_cnt(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
// channel will be always in keyword 0
    ...
    RVU_DEBUG_SEQ_FOPS(npc_exact_drop_cnt, npc_exact_drop_cnt, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_npc_init(rvu: *mut rvu) {
...
#[no_mangle]
unsafe extern "C" fn cpt_eng_sts_display(filp: *mut seq_file, eng_type: u8) -> c_int {
    static int cpt_eng_sts_display(struct seq_file *filp, u8 eng_type)
    {
    struct cpt_ctx *ctx = filp.private;
    let mut busy_sts: u64 = 0, free_sts = 0;
    let mut e_min: u32 = 0, e_max = 0, e, i;
    u16 max_ses, max_ies, max_aes;
    struct rvu *rvu = ctx.rvu;
    let mut blkaddr: c_int = ctx.blkaddr;
    u64 reg;
...
#[no_mangle]
unsafe extern "C" fn rvu_dbg_cpt_ae_sts_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    static int rvu_dbg_cpt_ae_sts_display(struct seq_file *filp, void *unused)
    {
    return cpt_eng_sts_display(filp, CPT_AE_TYPE);
    }
    RVU_DEBUG_SEQ_FOPS(cpt_ae_sts, cpt_ae_sts_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_cpt_se_sts_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    static int rvu_dbg_cpt_se_sts_display(struct seq_file *filp, void *unused)
    {
    return cpt_eng_sts_display(filp, CPT_SE_TYPE);
    }
    RVU_DEBUG_SEQ_FOPS(cpt_se_sts, cpt_se_sts_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_cpt_ie_sts_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    static int rvu_dbg_cpt_ie_sts_display(struct seq_file *filp, void *unused)
    {
    return cpt_eng_sts_display(filp, CPT_IE_TYPE);
    }
    RVU_DEBUG_SEQ_FOPS(cpt_ie_sts, cpt_ie_sts_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_cpt_engines_info_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(cpt_engines_info, cpt_engines_info_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_cpt_lfs_info_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(cpt_lfs_info, cpt_lfs_info_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_cpt_err_info_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(cpt_err_info, cpt_err_info_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_cpt_pc_display(filp: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    RVU_DEBUG_SEQ_FOPS(cpt_pc, cpt_pc_display, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rvu_dbg_cpt_init(rvu: *mut rvu, blkaddr: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_dbg_init(rvu: *mut rvu) {
    void rvu_dbg_init(struct rvu *rvu)
    {
    rvu.rvu_dbg.root = debugfs_create_dir(rvu_get_dbg_dir_name(rvu), core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn rvu_dbg_exit(rvu: *mut rvu) {
