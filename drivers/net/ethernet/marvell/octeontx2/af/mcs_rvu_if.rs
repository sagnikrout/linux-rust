...
//! Source: drivers/net/ethernet/marvell/octeontx2/af/mcs_rvu_if.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rvu_mcs_ptp_cfg(rvu: *mut rvu, rpm_id: u8, lmac_id: u8, ena: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mcs_add_intr_wq_entry(mcs: *mut mcs, event: *mut mcs_intr_event) -> c_int {
    int mcs_add_intr_wq_entry(struct mcs *mcs, struct mcs_intr_event *event)
    {
    struct mcs_intrq_entry *qentry;
    let mut pcifunc: u16 = event.pcifunc;
...
#[no_mangle]
unsafe extern "C" fn mcs_notify_pfvf(event: *mut mcs_intr_event, rvu: *mut rvu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcs_intr_handler_task(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_mcs_flr_handler(rvu: *mut rvu, pcifunc: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_mcs_set_lmac_bmap(rvu: *mut rvu) {
    static void rvu_mcs_set_lmac_bmap(struct rvu *rvu)
    {
    struct mcs *mcs = mcs_get_pdata(0);
    let mut lmac_bmap: c_ulong = 0;
    int cgx, lmac, port;
...
#[no_mangle]
pub unsafe extern "C" fn rvu_mcs_init(rvu: *mut rvu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_mcs_exit(rvu: *mut rvu) {
    void rvu_mcs_exit(struct rvu *rvu)
    {
    if (!rvu.mcs_intr_wq)
    return;
    destroy_workqueue(rvu.mcs_intr_wq);
    rvu.mcs_intr_wq = core::ptr::null_mut();
    }
