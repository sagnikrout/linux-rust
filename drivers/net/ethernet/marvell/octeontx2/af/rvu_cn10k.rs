...
//! Source: drivers/net/ethernet/marvell/octeontx2/af/rvu_cn10k.c
#![no_std]
...
// RVU LMTST
pub const LMT_TBL_OP_READ: c_int = 0;
pub const LMT_TBL_OP_WRITE: c_int = 1;
pub const LMT_MAPTBL_ENTRY_SIZE: c_int = 16;
pub const LMT_MAX_VFS: c_int = 256;
...
pub const LMT_MAP_TBL_W1_OFF: c_int = 8;
#[no_mangle]
unsafe extern "C" fn rvu_get_lmtst_tbl_index(rvu: *mut rvu, pcifunc: u16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rvu_update_lmtaddr(rvu: *mut rvu, pcifunc: u16, lmt_addr: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_reset_lmt_map_tbl(rvu: *mut rvu, pcifunc: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_set_channels_base(rvu: *mut rvu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvu_lbk_set_channels(rvu: *mut rvu) {
...
#[no_mangle]
unsafe extern "C" fn __rvu_nix_set_channels(rvu: *mut rvu, blkaddr: c_int) {
    static void __rvu_nix_set_channels(struct rvu *rvu, int blkaddr)
    {
    let mut nix_const1: u64 = rvu_read64(rvu, blkaddr, NIX_AF_CONST1);
    let mut nix_const: u64 = rvu_read64(rvu, blkaddr, NIX_AF_CONST);
...
#[no_mangle]
unsafe extern "C" fn rvu_nix_set_channels(rvu: *mut rvu) {
...
#[no_mangle]
unsafe extern "C" fn __rvu_rpm_set_channels(cgxid: c_int, lmacid: c_int, base: u16) {
...
#[no_mangle]
unsafe extern "C" fn rvu_rpm_set_channels(rvu: *mut rvu) {
    static void rvu_rpm_set_channels(struct rvu *rvu)
    {
    struct rvu_hwinfo *hw = rvu.hw;
    let mut base: u16 = hw.cgx_chan_base;
    int cgx, lmac;
...
#[no_mangle]
pub unsafe extern "C" fn rvu_program_channels(rvu: *mut rvu) {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_nix_block_cn10k_init(rvu: *mut rvu, nix_hw: *mut nix_hw) {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_apr_block_cn10k_init(rvu: *mut rvu) {
