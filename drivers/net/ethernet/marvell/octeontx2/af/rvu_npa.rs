...
//! Source: drivers/net/ethernet/marvell/octeontx2/af/rvu_npa.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn npa_lf_hwctx_disable(rvu: *mut rvu, req: *mut hwctx_disable_req) -> c_int {
    ...
    continue;
    aq_req.aura_id = id;
    rc = rvu_npa_aq_enq_inst(rvu, &aq_req, core::ptr::null_mut());
    if (rc) {
    err = rc;
...
#[no_mangle]
unsafe extern "C" fn npa_lf_hwctx_lockdown(rvu: *mut rvu, req: *mut npa_aq_enq_req) -> c_int {
    ...
    err = rvu_npa_aq_enq_inst(rvu, &lock_ctx_req, core::ptr::null_mut());
    if (err)
    dev_err(rvu.dev,
...
#[no_mangle]
unsafe extern "C" fn npa_ctx_free(rvu: *mut rvu, pfvf: *mut rvu_pfvf) {
    static void npa_ctx_free(struct rvu *rvu, struct rvu_pfvf *pfvf)
    {
    kfree(pfvf.aura_bmap);
    pfvf.aura_bmap = core::ptr::null_mut();
    qmem_free(rvu.dev, pfvf.aura_ctx);
    pfvf.aura_ctx = core::ptr::null_mut();
    kfree(pfvf.pool_bmap);
    pfvf.pool_bmap = core::ptr::null_mut();
    qmem_free(rvu.dev, pfvf.pool_ctx);
    pfvf.pool_ctx = core::ptr::null_mut();
    qmem_free(rvu.dev, pfvf.npa_qints_ctx);
    pfvf.npa_qints_ctx = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn npa_aq_ndc_config(rvu: *mut rvu, block: *mut rvu_block) {
...
#[no_mangle]
unsafe extern "C" fn npa_aq_init(rvu: *mut rvu, block: *mut rvu_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_npa_init(rvu: *mut rvu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_npa_freemem(rvu: *mut rvu) {
...
#[no_mangle]
pub unsafe extern "C" fn rvu_npa_lf_teardown(rvu: *mut rvu, pcifunc: u16, npalf: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rvu_ndc_fix_locked_cacheline(rvu: *mut rvu, blkaddr: c_int) -> c_int {
