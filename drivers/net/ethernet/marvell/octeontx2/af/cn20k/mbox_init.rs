...
//! Source: drivers/net/ethernet/marvell/octeontx2/af/cn20k/mbox_init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cn20k_afvf_mbox_intr_handler(irq: c_int, rvu_irq: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn cn20k_register_afvf_mbox_intr(rvu: *mut rvu, pf_vec_start: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cn20k_mbox_pf_common_intr_handler(irq: c_int, rvu_irq: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn cn20k_rvu_enable_mbox_intr(rvu: *mut rvu) {
...
#[no_mangle]
pub unsafe extern "C" fn cn20k_rvu_unregister_interrupts(rvu: *mut rvu) {
...
#[no_mangle]
pub unsafe extern "C" fn cn20k_register_afpf_mbox_intr(rvu: *mut rvu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cn20k_rvu_mbox_init(rvu: *mut rvu, type: c_int, ndevs: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cn20k_free_mbox_memory_type(rvu: *mut rvu, type: c_int) {
    ...
    rvu.ng_rvu.pf_mbox_addr = core::ptr::null_mut();
    break;
    case TYPE_AFVF:
    qmem_free(rvu.dev, rvu.ng_rvu.vf_mbox_addr);
    rvu.ng_rvu.vf_mbox_addr = core::ptr::null_mut();
    break;
    }
    }
#[no_mangle]
pub unsafe extern "C" fn cn20k_free_mbox_memory(rvu: *mut rvu) {
...
#[no_mangle]
pub unsafe extern "C" fn cn20k_rvu_disable_afvf_intr(rvu: *mut rvu, vfs: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn cn20k_rvu_enable_afvf_intr(rvu: *mut rvu, vfs: c_int) {
