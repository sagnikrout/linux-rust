...
//! Source: drivers/net/ethernet/marvell/prestera/prestera_main.c
#![no_std]
...
pub const PRESTERA_MTU_DEFAULT: c_int = 1536;
pub const PRESTERA_STATS_DELAY_MS: c_int = 1000;
pub const PRESTERA_MAC_ADDR_NUM_MAX: c_int = 255;
    static struct workqueue_struct *prestera_wq;
    static struct workqueue_struct *prestera_owq;
#[no_mangle]
pub unsafe extern "C" fn prestera_queue_work(work: *mut work_struct) {
    void prestera_queue_work(struct work_struct *work)
    {
    queue_work(prestera_owq, work);
    }
#[no_mangle]
pub unsafe extern "C" fn prestera_queue_delayed_work(work: *mut delayed_work, delay: c_ulong) {
    void prestera_queue_delayed_work(struct delayed_work *work, unsigned long delay)
    {
    queue_delayed_work(prestera_wq, work, delay);
    }
#[no_mangle]
pub unsafe extern "C" fn prestera_queue_drain() {
...
#[no_mangle]
pub unsafe extern "C" fn prestera_port_learning_set(port: *mut prestera_port, learn: bool) -> c_int {
    int prestera_port_learning_set(struct prestera_port *port, bool learn)
    {
    return prestera_hw_port_learning_set(port, learn);
    }
#[no_mangle]
pub unsafe extern "C" fn prestera_port_uc_flood_set(port: *mut prestera_port, flood: bool) -> c_int {
    int prestera_port_uc_flood_set(struct prestera_port *port, bool flood)
    {
    return prestera_hw_port_uc_flood_set(port, flood);
    }
#[no_mangle]
pub unsafe extern "C" fn prestera_port_mc_flood_set(port: *mut prestera_port, flood: bool) -> c_int {
    int prestera_port_mc_flood_set(struct prestera_port *port, bool flood)
    {
    return prestera_hw_port_mc_flood_set(port, flood);
    }
#[no_mangle]
pub unsafe extern "C" fn prestera_port_br_locked_set(port: *mut prestera_port, br_locked: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn prestera_port_pvid_set(port: *mut prestera_port, vid: u16) -> c_int {
    ...
    {
    struct prestera_port *port = core::ptr::null_mut(), *tmp;
    ...
    return port ? port.sw : core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn prestera_port_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prestera_port_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prestera_pcs_an_restart(pcs: *mut phylink_pcs) {
...
#[no_mangle]
unsafe extern "C" fn prestera_port_sfp_bind(port: *mut prestera_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prestera_port_sfp_unbind(port: *mut prestera_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn prestera_is_valid_mac_addr(port: *mut prestera_port, addr: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prestera_port_set_mac_address(dev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prestera_port_change_mtu(dev: *mut net_device, mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prestera_port_get_hw_stats(port: *mut prestera_port) {
...
#[no_mangle]
unsafe extern "C" fn prestera_port_stats_update(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn prestera_port_autoneg_set(port: *mut prestera_port, link_modes: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prestera_port_list_add(port: *mut prestera_port) {
...
#[no_mangle]
unsafe extern "C" fn prestera_port_list_del(port: *mut prestera_port) {
...
#[no_mangle]
unsafe extern "C" fn prestera_port_create(sw: *mut prestera_switch, id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prestera_port_destroy(port: *mut prestera_port) {
...
#[no_mangle]
unsafe extern "C" fn prestera_destroy_ports(sw: *mut prestera_switch) {
...
#[no_mangle]
unsafe extern "C" fn prestera_create_ports(sw: *mut prestera_switch) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(netif_carrier_ok(port->dev): netif_running(port->dev) &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn prestera_event_handlers_register(sw: *mut prestera_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prestera_event_handlers_unregister(sw: *mut prestera_switch) {
...
#[no_mangle]
unsafe extern "C" fn prestera_switch_set_base_mac_addr(sw: *mut prestera_switch) -> c_int {
    ...
    {
    return id < sw.lag_max ? &sw.lags[id] : core::ptr::null_mut();
    }
...
// lag_id = free_id;
    ...
    {
    struct prestera_lag *lag = core::ptr::null_mut();
    u16 id;
    for (id = 0; id < sw.lag_max; id++) {
    lag = &sw.lags[id];
    if (!lag.dev)
...
#[no_mangle]
unsafe extern "C" fn prestera_lag_port_del(port: *mut prestera_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn prestera_port_is_lag_member(port: *const prestera_port) -> bool {
    bool prestera_port_is_lag_member(const struct prestera_port *port)
    {
    return !!port.lag;
    }
#[no_mangle]
pub unsafe extern "C" fn prestera_port_lag_id(port: *const prestera_port) -> u16 {
    u16 prestera_port_lag_id(const struct prestera_port *port)
    {
    return port.lag.lag_id;
    }
#[no_mangle]
unsafe extern "C" fn prestera_lag_init(sw: *mut prestera_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prestera_lag_fini(sw: *mut prestera_switch) {
...
#[no_mangle]
pub unsafe extern "C" fn prestera_netdev_check(dev: *const net_device) -> bool {
...
// pport = netdev_priv(dev);
    ...
    {
    struct prestera_port *port = core::ptr::null_mut();
    struct netdev_nested_priv priv = {
    .data = (void *)&port,
    };
    if (prestera_netdev_check(dev))
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: netif_is_lag_master(dev)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn prestera_mdb_entry_destroy(mdb_entry: *mut prestera_mdb_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn prestera_flood_domain_destroy(flood_domain: *mut prestera_flood_domain) {
    ...
    let mut is_first_port_in_list: bool = false;
    int err;
...
#[no_mangle]
unsafe extern "C" fn prestera_netdev_event_handler_register(sw: *mut prestera_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prestera_netdev_event_handler_unregister(sw: *mut prestera_switch) {
    static void prestera_netdev_event_handler_unregister(struct prestera_switch *sw)
    {
    unregister_netdevice_notifier(&sw.netdev_nb);
    }
#[no_mangle]
unsafe extern "C" fn prestera_switch_init(sw: *mut prestera_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prestera_switch_fini(sw: *mut prestera_switch) {
...
#[no_mangle]
pub unsafe extern "C" fn prestera_device_register(dev: *mut prestera_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn prestera_device_unregister(dev: *mut prestera_device) {
...
#[no_mangle]
unsafe extern "C" fn prestera_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn prestera_module_exit() -> void __exit {
