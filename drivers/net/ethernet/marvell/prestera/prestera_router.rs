...
//! Source: drivers/net/ethernet/marvell/prestera/prestera_router.c
#![no_std]
...
// Macro flag: #define PRESTERA_IMPLICITY_RESOLVE_DEAD_NEIGH

#[repr(C)]
#[derive(Copy, Clone)]
pub struct prestera_kern_neigh_cache_key {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct prestera_kern_neigh_cache {
    pub key: prestera_kern_neigh_cache_key,
    pub ht_node: rhash_head,
    pub kern_fib_cache_list: list_head,
// Hold prepared nh_neigh info if is in_kernel
    pub nh_neigh_info: prestera_neigh_info,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct prestera_kern_fib_cache_key {
    pub addr: prestera_ip_addr,
    pub prefix_len: u32,
    pub /: *mut *mut u32 kern_tb_id; / tb_id from kernel (not fixed),
}

// Subscribing on neighbours in kernel
#[repr(C)]
#[derive(Copy, Clone)]
pub struct prestera_kern_fib_cache {
    pub key: prestera_kern_fib_cache_key,
    struct {
    pub fib_key: prestera_fib_key,
    pub fib_type: enum prestera_fib_type,
    pub nh_grp_key: prestera_nexthop_group_key,
    pub /: *mut *mut } lpm_info; / hold prepared lpm info,
// Indicate if route is not overlapped by another table
    pub /: *mut *mut rhash_head ht_node; / node of prestera_router,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct prestera_kern_neigh_cache_head {
    pub this: *mut prestera_kern_fib_cache,
    pub head: list_head,
    pub n_cache: *mut prestera_kern_neigh_cache,
    pub kern_neigh_cache_head: [}; PRESTERA_NHGR_SIZE_MAX],
    union {
    pub /: *mut *mut fib_notifier_info info; / point to any of 4/6,
    pub fen4_info: fib_entry_notifier_info,
}
...
#[no_mangle]
unsafe extern "C" fn prestera_fix_tb_id(tb_id: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __prestera_fi_is_direct(fi: *mut fib_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn prestera_fi_is_direct(fi: *mut fib_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn prestera_fi_is_nh(fi: *mut fib_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __prestera_fi6_is_direct(fi: *mut fib6_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn prestera_fi6_is_direct(fi: *mut fib6_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn prestera_fi6_is_nh(fi: *mut fib6_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn prestera_fib_info_is_direct(info: *mut fib_notifier_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn prestera_fib_info_is_nh(info: *mut fib_notifier_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn prestera_kern_fib_info_nhs(info: *mut fib_notifier_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prestera_dev_if_type(dev: *const net_device) -> c_int {
...
// Routes we must trap by design:
    ...
    if (!fib_node) {
    dev_err(sw.dev.dev, "fib_node=core::ptr::null_mut() %pI4n/%d kern_tb_id = %d",
...
#[no_mangle]
unsafe extern "C" fn prestera_k_arb_hw_evt(sw: *mut prestera_switch) {
...
#[no_mangle]
unsafe extern "C" fn __prestera_k_arb_fib_evt2nc(sw: *mut prestera_switch) {
    ...
    if (!fib_cache) {
    dev_err(sw.dev.dev, "fib_cache == core::ptr::null_mut()");
    return -ENOENT;
    }
    bfib_cache = __prestera_k_arb_util_fib_overlaps(sw, fib_cache);
    tfib_cache = __prestera_k_arb_util_fib_overlapped(sw, fib_cache);
...
#[no_mangle]
unsafe extern "C" fn __prestera_k_arb_abort_neigh_ht_cb(ptr: *mut c_void, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __prestera_k_arb_abort_fib_ht_cb(ptr: *mut c_void, arg: *mut c_void) {
    ...
    false, false,
    false);
    __prestera_k_arb_fib_nh_offload_set(sw, fib_cache, core::ptr::null_mut(),
    false, false);
// No need to destroy lpm.
// It will be aborted by destroy_ht
//
...
#[no_mangle]
unsafe extern "C" fn prestera_k_arb_abort(sw: *mut prestera_switch) {
...
//
    ...
    let mut re_key: prestera_rif_entry_key = {};
...
// Ignore if this is not latest address
    ...
    goto out;
    err = __prestera_inetaddr_event(router.sw, dev, event, core::ptr::null_mut());
    out:
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct prestera_fib_event_work {
...
#[no_mangle]
unsafe extern "C" fn __prestera_router_fib_event_work(work: *mut work_struct) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct prestera_netevent_work {
    pub work: work_struct,
    pub sw: *mut prestera_switch,
    pub n: *mut neighbour,
}
...
#[no_mangle]
unsafe extern "C" fn prestera_router_neigh_event_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn prestera_router_update_neighs_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn prestera_neigh_work_init(sw: *mut prestera_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prestera_neigh_work_fini(sw: *mut prestera_switch) {
    static void prestera_neigh_work_fini(struct prestera_switch *sw)
    {
    cancel_delayed_work_sync(&sw.router.neighs_update.dw);
    }
#[no_mangle]
pub unsafe extern "C" fn prestera_router_init(sw: *mut prestera_switch) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn prestera_router_fini(sw: *mut prestera_switch) {
