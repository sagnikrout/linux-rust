...
//! Source: drivers/net/ethernet/marvell/mvmdio.c
#![no_std]
...
pub const MVMDIO_SMI_DATA_SHIFT: c_int = 0;
pub const MVMDIO_SMI_PHY_ADDR_SHIFT: c_int = 16;
pub const MVMDIO_SMI_PHY_REG_SHIFT: c_int = 21;

pub const MVMDIO_SMI_WRITE_OPERATION: c_int = 0;

pub const MVMDIO_ERR_INT_CAUSE: c_uint = 0x007C;
pub const MVMDIO_ERR_INT_SMI_DONE: c_uint = 0x00000010;
pub const MVMDIO_ERR_INT_MASK: c_uint = 0x0080;
pub const MVMDIO_XSMI_MGNT_REG: c_uint = 0x0;
pub const MVMDIO_XSMI_PHYADDR_SHIFT: c_int = 16;
pub const MVMDIO_XSMI_DEVADDR_SHIFT: c_int = 21;

pub const MVMDIO_XSMI_ADDR_REG: c_uint = 0x8;
pub const MVMDIO_XSMI_CFG_REG: c_uint = 0xc;
pub const MVMDIO_XSMI_CLKDIV_MASK: c_uint = 0x3;
pub const MVMDIO_XSMI_CLKDIV_256: c_uint = 0x0;
pub const MVMDIO_XSMI_CLKDIV_64: c_uint = 0x1;
pub const MVMDIO_XSMI_CLKDIV_32: c_uint = 0x2;
pub const MVMDIO_XSMI_CLKDIV_8: c_uint = 0x3;
//
...
//
    pub err_interrupt: c_int,
    pub smi_busy_wait: wait_queue_head_t,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct orion_mdio_ops {
    pub ): *mut *mut int (is_done)(struct orion_mdio_dev,
}
...
#[no_mangle]
unsafe extern "C" fn orion_mdio_smi_is_done(dev: *mut orion_mdio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orion_mdio_xsmi_is_done(dev: *mut orion_mdio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn orion_mdio_xsmi_set_mdc_freq(bus: *mut mii_bus) {
...
#[no_mangle]
pub unsafe extern "C" fn if(32: div <=) -> else {
    else if (div <= 32)
    div = MVMDIO_XSMI_CLKDIV_32;
#[no_mangle]
pub unsafe extern "C" fn if(64: div <=) -> else {
    else if (div <= 64)
...
#[no_mangle]
unsafe extern "C" fn orion_mdio_err_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn orion_mdio_probe(pdev: *mut platform_device) -> c_int {
    ...
    dev.clk[0] = clk_get_optional(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(dev.clk[0])) {
...
#[no_mangle]
unsafe extern "C" fn orion_mdio_remove(pdev: *mut platform_device) {
