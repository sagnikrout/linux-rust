...
//! Source: drivers/net/ethernet/marvell/mvneta.c
#![no_std]
...
pub const MVNETA_RXQ_SHORT_POOL_ID_SHIFT: c_int = 4;
pub const MVNETA_RXQ_SHORT_POOL_ID_MASK: c_uint = 0x30;
pub const MVNETA_RXQ_LONG_POOL_ID_SHIFT: c_int = 6;
pub const MVNETA_RXQ_LONG_POOL_ID_MASK: c_uint = 0xc0;

pub const MVNETA_RXQ_BUF_SIZE_SHIFT: c_int = 19;

pub const MVNETA_RXQ_OCCUPIED_ALL_MASK: c_uint = 0x3fff;

pub const MVNETA_RXQ_ADD_NON_OCCUPIED_SHIFT: c_int = 16;
pub const MVNETA_RXQ_ADD_NON_OCCUPIED_MAX: c_int = 255;

pub const MVNETA_PORT_POOL_BUFFER_SZ_SHIFT: c_int = 3;
pub const MVNETA_PORT_POOL_BUFFER_SZ_MASK: c_uint = 0xfff8;
pub const MVNETA_PORT_RX_RESET: c_uint = 0x1cc0;

pub const MVNETA_PHY_ADDR: c_uint = 0x2000;
pub const MVNETA_PHY_ADDR_MASK: c_uint = 0x1f;
pub const MVNETA_MBUS_RETRY: c_uint = 0x2010;
pub const MVNETA_UNIT_INTR_CAUSE: c_uint = 0x2080;
pub const MVNETA_UNIT_CONTROL: c_uint = 0x20B0;

pub const MVNETA_BASE_ADDR_ENABLE: c_uint = 0x2290;
pub const MVNETA_AC5_CNM_DDR_TARGET: c_uint = 0x2;
pub const MVNETA_AC5_CNM_DDR_ATTR: c_uint = 0xb;
pub const MVNETA_ACCESS_PROTECT_ENABLE: c_uint = 0x2294;
pub const MVNETA_PORT_CONFIG: c_uint = 0x2400;
...
pub const MVNETA_PORT_CONFIG_EXTEND: c_uint = 0x2404;
pub const MVNETA_MAC_ADDR_LOW: c_uint = 0x2414;
pub const MVNETA_MAC_ADDR_HIGH: c_uint = 0x2418;
pub const MVNETA_SDMA_CONFIG: c_uint = 0x241c;
pub const MVNETA_SDMA_BRST_SIZE_16: c_int = 4;

pub const MVNETA_VLAN_PRIO_TO_RXQ: c_uint = 0x2440;

pub const MVNETA_PORT_STATUS: c_uint = 0x2444;

pub const MVNETA_RX_MIN_FRAME_SIZE: c_uint = 0x247c;
// Only exists on Armada XP and Armada 370
pub const MVNETA_SERDES_CFG: c_uint = 0x24A0;
pub const MVNETA_SGMII_SERDES_PROTO: c_uint = 0x0cc7;
pub const MVNETA_QSGMII_SERDES_PROTO: c_uint = 0x0667;
pub const MVNETA_HSGMII_SERDES_PROTO: c_uint = 0x1107;
pub const MVNETA_TYPE_PRIO: c_uint = 0x24bc;

pub const MVNETA_TXQ_CMD_1: c_uint = 0x24e4;
pub const MVNETA_TXQ_CMD: c_uint = 0x2448;
pub const MVNETA_TXQ_DISABLE_SHIFT: c_int = 8;
pub const MVNETA_TXQ_ENABLE_MASK: c_uint = 0x000000ff;
pub const MVNETA_RX_DISCARD_FRAME_COUNT: c_uint = 0x2484;
pub const MVNETA_OVERRUN_FRAME_COUNT: c_uint = 0x2488;
pub const MVNETA_GMAC_CLOCK_DIVIDER: c_uint = 0x24f4;

pub const MVNETA_ACC_MODE: c_uint = 0x2500;
pub const MVNETA_BM_ADDRESS: c_uint = 0x2504;

pub const MVNETA_CPU_RXQ_ACCESS_ALL_MASK: c_uint = 0x000000ff;
pub const MVNETA_CPU_TXQ_ACCESS_ALL_MASK: c_uint = 0x0000ff00;
...
//
pub const MVNETA_INTR_NEW_CAUSE: c_uint = 0x25a0;
pub const MVNETA_INTR_NEW_MASK: c_uint = 0x25a4;
...
pub const MVNETA_INTR_OLD_CAUSE: c_uint = 0x25a8;
pub const MVNETA_INTR_OLD_MASK: c_uint = 0x25ac;
// Data Path Port/Queue Cause Register
pub const MVNETA_INTR_MISC_CAUSE: c_uint = 0x25b0;
pub const MVNETA_INTR_MISC_MASK: c_uint = 0x25b4;

pub const MVNETA_CAUSE_BMU_ALLOC_ERR_SHIFT: c_int = 16;

pub const MVNETA_CAUSE_TXQ_ERROR_SHIFT: c_int = 24;

pub const MVNETA_INTR_ENABLE: c_uint = 0x25b8;
pub const MVNETA_TXQ_INTR_ENABLE_ALL_MASK: c_uint = 0x0000ff00;
pub const MVNETA_RXQ_INTR_ENABLE_ALL_MASK: c_uint = 0x000000ff;
pub const MVNETA_RXQ_CMD: c_uint = 0x2680;
pub const MVNETA_RXQ_DISABLE_SHIFT: c_int = 8;
pub const MVNETA_RXQ_ENABLE_MASK: c_uint = 0x000000ff;

pub const MVNETA_GMAC_CTRL_0: c_uint = 0x2c00;
pub const MVNETA_GMAC_MAX_RX_SIZE_SHIFT: c_int = 2;
pub const MVNETA_GMAC_MAX_RX_SIZE_MASK: c_uint = 0x7ffc;

pub const MVNETA_GMAC_CTRL_2: c_uint = 0x2c08;

pub const MVNETA_GMAC_STATUS: c_uint = 0x2c10;

pub const MVNETA_GMAC_AUTONEG_CONFIG: c_uint = 0x2c0c;

pub const MVNETA_GMAC_CTRL_4: c_uint = 0x2c90;

pub const MVNETA_MIB_COUNTERS_BASE: c_uint = 0x3000;
pub const MVNETA_MIB_LATE_COLLISION: c_uint = 0x7c;
pub const MVNETA_DA_FILT_SPEC_MCAST: c_uint = 0x3400;
pub const MVNETA_DA_FILT_OTH_MCAST: c_uint = 0x3500;
pub const MVNETA_DA_FILT_UCAST_BASE: c_uint = 0x3600;

pub const MVNETA_TXQ_SENT_THRESH_ALL_MASK: c_uint = 0x3fff0000;

pub const MVNETA_TXQ_DEC_SENT_SHIFT: c_int = 16;
pub const MVNETA_TXQ_DEC_SENT_MASK: c_uint = 0xff;

pub const MVNETA_TXQ_SENT_DESC_SHIFT: c_int = 16;
pub const MVNETA_TXQ_SENT_DESC_MASK: c_uint = 0x3fff0000;
pub const MVNETA_PORT_TX_RESET: c_uint = 0x3cf0;

pub const MVNETA_TXQ_CMD1_REG: c_uint = 0x3e00;

pub const MVNETA_REFILL_NUM_CLK_REG: c_uint = 0x3e08;
pub const MVNETA_REFILL_MAX_NUM_CLK: c_uint = 0x0000ffff;
pub const MVNETA_TX_MTU: c_uint = 0x3e0c;
pub const MVNETA_TX_TOKEN_SIZE: c_uint = 0x3e14;
pub const MVNETA_TX_TOKEN_SIZE_MAX: c_uint = 0xffffffff;

pub const MVNETA_TXQ_BUCKET_REFILL_PERIOD_MASK: c_uint = 0x3ff00000;
pub const MVNETA_TXQ_BUCKET_REFILL_PERIOD_SHIFT: c_int = 20;
pub const MVNETA_TXQ_BUCKET_REFILL_VALUE_MAX: c_uint = 0x0007ffff;

pub const MVNETA_TXQ_TOKEN_SIZE_MAX: c_uint = 0x7fffffff;
...
pub const MVNETA_TXQ_BUCKET_REFILL_BASE_PERIOD_NS: c_int = 100;
// Number of Base Period to wait between each bucket refill
pub const MVNETA_TXQ_BUCKET_REFILL_PERIOD: c_int = 1000;
...
pub const MVNETA_LPI_CTRL_0: c_uint = 0x2cc0;

pub const MVNETA_LPI_CTRL_1: c_uint = 0x2cc4;

pub const MVNETA_LPI_CTRL_2: c_uint = 0x2cc8;
pub const MVNETA_LPI_STATUS: c_uint = 0x2ccc;
pub const MVNETA_CAUSE_TXQ_SENT_DESC_ALL_MASK: c_uint = 0xff;
...
pub const MVNETA_RX_COAL_PKTS: c_int = 32;
pub const MVNETA_RX_COAL_USEC: c_int = 100;
...
// own.
//
pub const MVNETA_MH_SIZE: c_int = 2;
pub const MVNETA_VLAN_TAG_LEN: c_int = 4;
pub const MVNETA_TX_CSUM_DEF_SIZE: c_int = 1600;
pub const MVNETA_TX_CSUM_MAX_SIZE: c_int = 9800;
pub const MVNETA_ACC_MODE_EXT1: c_int = 1;
pub const MVNETA_ACC_MODE_EXT2: c_int = 2;
pub const MVNETA_MAX_DECODE_WIN: c_int = 6;
// Timeout constants
pub const MVNETA_TX_DISABLE_TIMEOUT_MSEC: c_int = 1000;
pub const MVNETA_RX_DISABLE_TIMEOUT_MSEC: c_int = 1000;
pub const MVNETA_TX_FIFO_EMPTY_TIMEOUT: c_int = 10000;
pub const MVNETA_TX_MTU_MAX: c_uint = 0x3ffff;
// The RSS lookup table actually has 256 entries but we do not use
// them yet
//
pub const MVNETA_RSS_LU_TABLE_SIZE: c_int = 1;
// Max number of Rx descriptors
pub const MVNETA_MAX_RXD: c_int = 512;
// Max number of Tx descriptors
pub const MVNETA_MAX_TXD: c_int = 1024;
// Max number of allowed TCP segments for software TSO
pub const MVNETA_MAX_TSO_SEGS: c_int = 100;
...
pub const MVNETA_DESC_ALIGNED_SIZE: c_int = 32;
// Number of bytes to be taken into account by HW when putting incoming data
// to the buffers. It is needed in case NET_SKB_PAD exceeds maximum packet
// offset supported in MVNETA_RXQ_CONFIG_REG(q) registers.
//
pub const MVNETA_RX_PKT_OFFSET_CORRECTION: c_int = 64;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvneta_statistic {
    pub offset: c_ushort,
    pub type: c_ushort,
    pub name: [c_char; ETH_GSTRING_LEN],
}

pub const T_REG_32: c_int = 32;
pub const T_REG_64: c_int = 64;
pub const T_SW: c_int = 1;
pub const MVNETA_XDP_PASS: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvneta_ethtool_stats {
    pub ps: mvneta_stats,
    pub skb_alloc_error: u64,
    pub refill_error: u64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvneta_pcpu_stats {
    pub syncp: u64_stats_sync,
    pub es: mvneta_ethtool_stats,
    pub rx_dropped: u64,
    pub rx_errors: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvneta_pcpu_port {
// Pointer to the shared port
    pub pp: *mut mvneta_port,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvneta_port {
    pub id: u8,
    pub ports: *mut mvneta_pcpu_port __percpu,
    pub stats: *mut mvneta_pcpu_stats __percpu,
    pub state: c_ulong,
    pub pkt_size: c_int,
    pub base: *mut void __iomem,
    pub rxqs: *mut mvneta_rx_queue,
    pub txqs: *mut mvneta_tx_queue,
    pub dev: *mut net_device,
    pub node_online: hlist_node,
...
// AXI clock
    pub clk_bus: *mut clk,
    pub mcast_count: [u8; 256],
    pub tx_ring_size: u16,
    pub rx_ring_size: u16,
    pub phy_interface: phy_interface_t,
    pub dn: *mut device_node,
    pub tx_csum_limit: c_uint,
    pub phylink: *mut phylink,
    pub phylink_config: phylink_config,
    pub phylink_pcs: phylink_pcs,
    pub comphy: *mut phy,
    pub bm_priv: *mut mvneta_bm,
    pub pool_long: *mut mvneta_bm_pool,
    pub pool_short: *mut mvneta_bm_pool,
    pub bm_win_id: c_int,
    pub ethtool_stats: [u64; ARRAY_SIZE(mvneta_statistics)],
    pub indir: [u32; MVNETA_RSS_LU_TABLE_SIZE],
// Flags for special SoC configurations
    pub neta_armada3700: bool,
    pub neta_ac5: bool,
    pub rx_offset_correction: u16,
    pub dram_target_info: *const mbus_dram_target_info,
}
...
//
pub const MVNETA_TX_L3_OFF_SHIFT: c_int = 0;
pub const MVNETA_TX_IP_HLEN_SHIFT: c_int = 8;

    MVNETA_TXD_L_DESC | \
    MVNETA_TXD_F_DESC)

pub const MVNETA_RXD_ERR_CRC: c_uint = 0x0;
pub const MVNETA_RXD_BM_POOL_SHIFT: c_int = 13;

    MVNETA_RXD_LAST_DESC)

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvneta_tx_desc {
    pub transmitting.*/: *mut *mut u32 command; / Options used by HW for packet,
    pub /: *mut *mut u16 reserved1; / csum_l4 (for future use),
    pub /: *mut *mut u16 data_size; / Data size of transmitted packet in bytes,
    pub /: *mut *mut u32 buf_phys_addr; / Physical addr of transmitted buffer,
    pub /: *mut *mut u32 reserved2; / hw_cmd - (for future use, PMT),
    pub /: *mut *mut u32 reserved3[4]; / Reserved - (for future use),
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvneta_rx_desc {
    pub /: *mut *mut u32 status; / Info about received packet,
    pub /: *mut *mut u16 reserved1; / pnc_info - (for future use, PnC),
    pub /: *mut *mut u16 data_size; / Size of received packet in bytes,
    pub /: *mut *mut u32 buf_phys_addr; / Physical address of the buffer,
    pub /: *mut *mut u32 reserved2; / pnc_flow_id (for future use, PnC),
    pub /: *mut *mut u32 buf_cookie; / cookie for access to RX buffer in rx path,
    pub /: *mut *mut u16 reserved3; / prefetch_cmd, for future use,
    pub /: *mut *mut u16 reserved4; / csum_l4 - (for future use, PnC),
    pub /: *mut *mut u32 reserved5; / pnc_extra PnC (for future use, PnC),
    pub /: *mut *mut u32 reserved6; / hw_cmd (for future use, PnC and HWF),
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvneta_tx_buf {
    pub type: enum mvneta_tx_buf_type,
    union {
...
//
    pub count: c_int,
    pub pending: c_int,
    pub tx_stop_threshold: c_int,
    pub tx_wake_threshold: c_int,
// Array of transmitted buffers
    pub buf: *mut mvneta_tx_buf,
...
// DMA buffers for TSO headers
    pub tso_hdrs: [*mut c_char; MVNETA_MAX_TSO_PAGES],
// DMA address of TSO headers
    pub tso_hdrs_phys: [dma_addr_t; MVNETA_MAX_TSO_PAGES],
...
// Virtual address of the RX buffer
    pub buf_virt_addr: *mut c_void,
// Virtual address of the RX DMA descriptors array
    pub descs: *mut mvneta_rx_desc,
...
//
    let mut rxq_number: static int = 8;
    let mut txq_number: static int = 8;
    static int rxq_def;
    let mut __read_mostly: static int rx_copybreak = 256;
...
// Write helper method
#[no_mangle]
unsafe extern "C" fn mvreg_write(pp: *mut mvneta_port, offset: u32, data: u32) {
...
// Read helper method
#[no_mangle]
unsafe extern "C" fn mvreg_read(pp: *mut mvneta_port, offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mvneta_txq_inc_get(txq: *mut mvneta_tx_queue) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_txq_inc_put(txq: *mut mvneta_tx_queue) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_mib_counters_clear(pp: *mut mvneta_port) {
...
//
#[no_mangle]
unsafe extern "C" fn mvneta_rxq_desc_is_first_last(status: u32) -> c_int {
...
// Get pointer to next RX descriptor to be processed by SW
    ...
    {
    let mut rx_desc: c_int = rxq.next_desc_to_proc;
...
#[no_mangle]
unsafe extern "C" fn mvneta_max_rx_size_set(pp: *mut mvneta_port, max_rx_size: c_int) {
...
// Get pointer to next TX descriptor to be processed (send) by HW
    ...
    {
    let mut tx_desc: c_int = txq.next_desc_to_proc;
...
//
#[no_mangle]
unsafe extern "C" fn mvneta_txq_desc_put(txq: *mut mvneta_tx_queue) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_bm_port_mbus_init(pp: *mut mvneta_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_bm_update_mtu(pp: *mut mvneta_port, mtu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_port_up(pp: *mut mvneta_port) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_port_down(pp: *mut mvneta_port) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_port_enable(pp: *mut mvneta_port) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_port_disable(pp: *mut mvneta_port) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_set_ucast_table(pp: *mut mvneta_port, queue: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_set_special_mcast_table(pp: *mut mvneta_port, queue: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_set_other_mcast_table(pp: *mut mvneta_port, queue: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_percpu_unmask_interrupt(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_percpu_mask_interrupt(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_percpu_clear_intr_cause(arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn mvneta_defaults_set(pp: *mut mvneta_port) {
    static void mvneta_defaults_set(struct mvneta_port *pp)
    {
    int cpu;
    int queue;
    u32 val;
    let mut max_cpu: c_int = num_present_cpus();
...
//
    ...
    let mut rxq_map: c_int = 0, txq_map = 0;
    int rxq, txq;
    if (!pp.neta_armada3700) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_txq_max_tx_size_set(pp: *mut mvneta_port, max_tx_size: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(IPPROTO_UDP: l4_proto ==) -> else {
...
// Display more error info
    ...
    let mut status: u32 = rx_desc.status;
...
#[no_mangle]
unsafe extern "C" fn mvneta_rx_csum(pp: *mut mvneta_port, status: u32) -> c_int {
...
//
    ...
    u32 cause)
    {
    let mut queue: c_int = fls(cause) - 1;
...
// Handle tx checksum
#[no_mangle]
unsafe extern "C" fn mvneta_skb_tx_csum(skb: *mut sk_buff) -> u32 {
    static u32 mvneta_skb_tx_csum(struct sk_buff *skb)
    {
    if (skb.ip_summed == CHECKSUM_PARTIAL) {
    let mut ip_hdr_len: c_int = 0;
    let mut l3_proto: __be16 = vlan_get_protocol(skb);
    u8 l4_proto;
    if (l3_proto == htons(ETH_P_IP)) {
...
// Drop packets received by the RXQ and free buffers
    ...
    let mut pool_id: u8 = MVNETA_RX_GET_BM_POOL_ID(rx_desc);
...
// Return dropped buffer to the pool
    ...
    rxq.page_pool = core::ptr::null_mut();
    }
    static void
...
// xdp
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn mvneta_rx_refill_queue(pp: *mut mvneta_port, rxq: *mut mvneta_rx_queue) -> c_int {
    int mvneta_rx_refill_queue(struct mvneta_port *pp, struct mvneta_rx_queue *rxq)
    {
    struct mvneta_rx_desc *rx_desc;
    let mut curr_desc: c_int = rxq.first_to_refill;
    int i;
    ...
    skb_frag_t *frag = core::ptr::null_mut();
    let mut len: c_int = xdpf.len;
    dma_addr_t dma_addr;
...
// ndo_xdp_xmit
    ...
    buf.xdpf = unlikely(i) ? core::ptr::null_mut() : xdpf;
...
// Due xdp_adjust_tail: DMA sync for_device cover max len CPU touch
    ...
    let mut data_len: c_int = -MVNETA_MH_SIZE, len;
...
// size -= len;
    ...
    {
    struct skb_shared_info *sinfo = xdp_get_shared_info_from_buff(xdp);
    let mut metasize: u32 = xdp.data - xdp.data_meta;
    struct sk_buff *skb;
    u8 num_frags;
...
// Main rx processing when using software buffer management
    ...
    struct mvneta_rx_queue *rxq)
    {
    let mut rx_proc: c_int = 0, rx_todo, refill, size = 0;
    struct net_device *dev = pp.dev;
    let mut ps: mvneta_stats = {};
    struct bpf_prog *xdp_prog;
    u32 desc_status, frame_sz;
    struct xdp_buff xdp_buf;
    xdp_init_buff(&xdp_buf, PAGE_SIZE, &rxq.xdp_rxq);
    xdp_buf.data_hard_start = core::ptr::null_mut();
...
// Main rx processing when using hardware buffer management
    ...
    struct net_device *dev = pp.dev;
    int rx_done;
    let mut rcvd_pkts: u32 = 0;
    let mut rcvd_bytes: u32 = 0;
// Get number of received packets
    rx_done = mvneta_rxq_busy_desc_num_get(pp, rxq);
    if (rx_todo > rx_done)
    rx_todo = rx_done;
...
// Fairness NAPI loop
    ...
    struct mvneta_rx_desc *rx_desc = mvneta_rxq_next_desc_get(rxq);
    struct mvneta_bm_pool *bm_pool = core::ptr::null_mut();
    struct sk_buff *skb;
    unsigned char *data;
    dma_addr_t phys_addr;
...
// Update rxq management counters
    ...
    txq.tso_hdrs[i],
    txq.tso_hdrs_phys[i]);
    txq.tso_hdrs[i] = core::ptr::null_mut();
    }
    }
    }
...
// dma = txq->tso_hdrs_phys[index] + offset;
    ...
    {
    struct mvneta_tx_buf *buf = &txq.buf[txq.txq_put_index];
    let mut hdr_len: c_int = skb_tcp_all_headers(skb);
    struct mvneta_tx_desc *tx_desc;
    dma_addr_t hdr_phys;
    char *hdr;
...
// Handle tx fragmentation processing
    ...
    let mut first_desc: c_int = txq.txq_put_index;
...
// Main tx processing
#[no_mangle]
unsafe extern "C" fn mvneta_tx(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t mvneta_tx(struct sk_buff *skb, struct net_device *dev)
    {
    struct mvneta_port *pp = netdev_priv(dev);
    let mut txq_id: u16 = skb_get_queue_mapping(skb);
...
// Free tx resources, when resetting a port
    ...
    {
    struct netdev_queue *nq = netdev_get_tx_queue(pp.dev, txq.id);
    let mut tx_done: c_int = txq.count;
...
//
#[no_mangle]
unsafe extern "C" fn mvneta_tx_done_gbe(pp: *mut mvneta_port, cause_tx_done: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn mvneta_addr_crc(addr: *mut c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_set_rx_mode(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mvneta_percpu_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mvneta_link_change(pp: *mut mvneta_port) {
    static void mvneta_link_change(struct mvneta_port *pp)
    {
    let mut gmac_stat: u32 = mvreg_read(pp, MVNETA_GMAC_STATUS);
...
//
#[no_mangle]
unsafe extern "C" fn mvneta_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
// Read cause register
    ...
    let mut cause_misc: u32 = mvreg_read(pp, MVNETA_INTR_MISC_CAUSE);
    mvreg_write(pp, MVNETA_INTR_MISC_CAUSE, 0);
...
#[no_mangle]
unsafe extern "C" fn mvneta_tx_reset(pp: *mut mvneta_port) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_rx_reset(pp: *mut mvneta_port) {
...
// Setup XPS mapping
    ...
    cpu = 0;
#[no_mangle]
pub unsafe extern "C" fn if(1: txq_number >) -> else {
...
// Free allocated resources when mvneta_txq_init() fails to allocate memory
    ...
    txq.buf               = core::ptr::null_mut();
    txq.descs             = core::ptr::null_mut();
    txq.last_desc         = 0;
...
#[no_mangle]
unsafe extern "C" fn mvneta_cleanup_txqs(pp: *mut mvneta_port) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_cleanup_rxqs(pp: *mut mvneta_port) {
...
// Init all Rx queues
#[no_mangle]
unsafe extern "C" fn mvneta_setup_rxqs(pp: *mut mvneta_port) -> c_int {
    static int mvneta_setup_rxqs(struct mvneta_port *pp)
    {
    int queue;
    for (queue = 0; queue < rxq_number; queue++) {
    let mut err: c_int = mvneta_rxq_init(pp, &pp.rxqs[queue]);
    if (err) {
...
// Init all tx queues
#[no_mangle]
unsafe extern "C" fn mvneta_setup_txqs(pp: *mut mvneta_port) -> c_int {
    static int mvneta_setup_txqs(struct mvneta_port *pp)
    {
    int queue;
    for (queue = 0; queue < txq_number; queue++) {
    let mut err: c_int = mvneta_txq_init(pp, &pp.txqs[queue]);
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_comphy_init(pp: *mut mvneta_port, interface: phy_interface_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_start_dev(pp: *mut mvneta_port) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_stop_dev(pp: *mut mvneta_port) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_percpu_enable(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_percpu_disable(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_change_mtu(dev: *mut net_device, mtu: c_int) -> c_int {
...
// Get mac address
#[no_mangle]
unsafe extern "C" fn mvneta_get_mac_addr(pp: *mut mvneta_port, addr: *mut c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_set_mac_addr(dev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MVNETA_GMAC_SPEED_100: gmac_stat &) -> else {
...
#[no_mangle]
unsafe extern "C" fn mvneta_pcs_an_restart(pcs: *mut phylink_pcs) {
    static void mvneta_pcs_an_restart(struct phylink_pcs *pcs)
    {
    struct mvneta_port *pp = mvneta_pcs_to_port(pcs);
    let mut gmac_an: u32 = mvreg_read(pp, MVNETA_GMAC_AUTONEG_CONFIG);
...
// Enable the 1ms clock
    ...
    let mut rate: c_ulong = clk_get_rate(pp.clk);
...
#[no_mangle]
unsafe extern "C" fn mvneta_mac_disable_tx_lpi(config: *mut phylink_config) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_mdio_probe(pp: *mut mvneta_port) -> c_int {
    static int mvneta_mdio_probe(struct mvneta_port *pp)
    {
    let mut wol: ethtool_wolinfo = { .cmd = ETHTOOL_GWOL };
    let mut err: c_int = phylink_of_phy_connect(pp.phylink, pp.dn, 0);
    if (err)
...
#[no_mangle]
unsafe extern "C" fn mvneta_mdio_remove(pp: *mut mvneta_port) {
...
//
#[no_mangle]
unsafe extern "C" fn mvneta_percpu_elect(pp: *mut mvneta_port) {
    static void mvneta_percpu_elect(struct mvneta_port *pp)
    {
    let mut elected_cpu: c_int = 0, max_cpu, cpu;
...
#[no_mangle]
unsafe extern "C" fn mvneta_cpu_online(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_cpu_down_prepare(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_cpu_dead(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_stop(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_ioctl(dev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_xdp(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_ethtool_nway_reset(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_ethtool_update_stats(pp: *mut mvneta_port) {
    static void mvneta_ethtool_update_stats(struct mvneta_port *pp)
    {
    let mut stats: mvneta_ethtool_stats = {};
...
#[no_mangle]
unsafe extern "C" fn mvneta_ethtool_pp_stats(pp: *mut mvneta_port, data: *mut u64) {
    static void mvneta_ethtool_pp_stats(struct mvneta_port *pp, u64 *data)
    {
    let mut stats: page_pool_stats = {};
    int i;
...
#[no_mangle]
unsafe extern "C" fn mvneta_ethtool_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
    static int mvneta_ethtool_get_sset_count(struct net_device *dev, int sset)
    {
    if (sset == ETH_SS_STATS) {
    let mut count: c_int = ARRAY_SIZE(mvneta_statistics);
    struct mvneta_port *pp = netdev_priv(dev);
    if (!pp.bm_priv)
...
#[no_mangle]
unsafe extern "C" fn mvneta_ethtool_get_rxfh_indir_size(dev: *mut net_device) -> u32 {
    static u32 mvneta_ethtool_get_rxfh_indir_size(struct net_device *dev)
    {
    return MVNETA_RSS_LU_TABLE_SIZE;
    }
#[no_mangle]
unsafe extern "C" fn mvneta_ethtool_get_rx_ring_count(dev: *mut net_device) -> u32 {
    static u32 mvneta_ethtool_get_rx_ring_count(struct net_device *dev)
    {
    return rxq_number;
    }
#[no_mangle]
unsafe extern "C" fn mvneta_config_rss(pp: *mut mvneta_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_clear_rx_prio_map(pp: *mut mvneta_port) {
    static void mvneta_clear_rx_prio_map(struct mvneta_port *pp)
    {
    mvreg_write(pp, MVNETA_VLAN_PRIO_TO_RXQ, 0);
    }
#[no_mangle]
unsafe extern "C" fn mvneta_map_vlan_prio_to_rxq(pp: *mut mvneta_port, pri: u8, rxq: u8) {
    static void mvneta_map_vlan_prio_to_rxq(struct mvneta_port *pp, u8 pri, u8 rxq)
    {
    let mut val: u32 = mvreg_read(pp, MVNETA_VLAN_PRIO_TO_RXQ);
    val &= ~MVNETA_VLAN_PRIO_RXQ_MAP(pri, 0x7);
    val |= MVNETA_VLAN_PRIO_RXQ_MAP(pri, rxq);
    mvreg_write(pp, MVNETA_VLAN_PRIO_TO_RXQ, val);
    }
#[no_mangle]
unsafe extern "C" fn mvneta_enable_per_queue_rate_limit(pp: *mut mvneta_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_disable_per_queue_rate_limit(pp: *mut mvneta_port) {
    static void mvneta_disable_per_queue_rate_limit(struct mvneta_port *pp)
    {
    let mut val: u32 = mvreg_read(pp, MVNETA_TXQ_CMD1_REG);
    val |= (MVNETA_TXQ_CMD1_BW_LIM_SEL_V1 | MVNETA_TXQ_CMD1_BW_LIM_EN);
    mvreg_write(pp, MVNETA_TXQ_CMD1_REG, val);
    }
...
// Initialize hw
#[no_mangle]
unsafe extern "C" fn mvneta_init(dev: *mut device, pp: *mut mvneta_port) -> c_int {
...
// Power up the port
#[no_mangle]
unsafe extern "C" fn mvneta_port_power_up(pp: *mut mvneta_port, phy_mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_probe(pdev: *mut platform_device) -> c_int {
    ...
    comphy = devm_of_phy_get(&pdev.dev, dn, core::ptr::null_mut());
    if (comphy == ERR_PTR(-EPROBE_DEFER))
    return -EPROBE_DEFER;
    if (IS_ERR(comphy))
    comphy = core::ptr::null_mut();
    pp.comphy = comphy;
...
// Get special SoC configurations
    ...
    if (IS_ERR(pp.clk))
    pp.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(pp.clk)) {
    err = PTR_ERR(pp.clk);
    goto err_free_irq;
    }
...
#[no_mangle]
unsafe extern "C" fn mvneta_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mvneta_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_resume(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvneta_driver_init() -> int __init {
    ...
    core::ptr::null_mut(), mvneta_cpu_dead);
    if (ret)
    goto err_dead;
...
#[no_mangle]
unsafe extern "C" fn mvneta_driver_exit() -> void __exit {
