...
//! Source: drivers/net/ethernet/marvell/pxa168_eth.c
#![no_std]
...
// Registers
//
pub const PHY_ADDRESS: c_uint = 0x0000;
pub const SMI: c_uint = 0x0010;
pub const PORT_CONFIG: c_uint = 0x0400;
pub const PORT_CONFIG_EXT: c_uint = 0x0408;
pub const PORT_COMMAND: c_uint = 0x0410;
pub const PORT_STATUS: c_uint = 0x0418;
pub const HTPR: c_uint = 0x0428;
pub const MAC_ADDR_LOW: c_uint = 0x0430;
pub const MAC_ADDR_HIGH: c_uint = 0x0438;
pub const SDMA_CONFIG: c_uint = 0x0440;
pub const SDMA_CMD: c_uint = 0x0448;
pub const INT_CAUSE: c_uint = 0x0450;
pub const INT_W_CLEAR: c_uint = 0x0454;
pub const INT_MASK: c_uint = 0x0458;
pub const ETH_F_RX_DESC_0: c_uint = 0x0480;
pub const ETH_C_RX_DESC_0: c_uint = 0x04A0;
pub const ETH_C_TX_DESC_1: c_uint = 0x04E4;
// smi register

pub const PHY_WAIT_ITERATIONS: c_int = 10;
pub const PXA168_ETH_PHY_ADDR_DEFAULT: c_int = 0;
...
pub const PCXR_PRIO_TX_OFF: c_int = 3;

// Bit definitions of the SDMA Config Reg
pub const SDCR_BSZ_OFF: c_int = 12;

pub const SDCR_RC_OFF: c_int = 2;
...
pub const NUM_RX_DESCS: c_int = 64;
pub const NUM_TX_DESCS: c_int = 64;
pub const HASH_ADD: c_int = 0;
pub const HASH_DELETE: c_int = 1;
pub const HASH_ADDR_TABLE_SIZE: c_uint = 0x4000	/* 16K (1/2K address - PCR_HS == 1) */;
pub const HOP_NUMBER: c_int = 12;
...
pub struct tx_desc {
    ...
    pub /: *mut *mut u32 buf_ptr; / pointer to buffer for this descriptor,
    pub /: *mut *mut u32 next_desc_ptr; / Pointer to next descriptor,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pxa168_eth_private {
    pub pdev: *mut platform_device,
    pub /: *mut *mut int port_num; / User Ethernet port number,
    pub phy_addr: c_int,
    pub phy_speed: c_int,
    pub phy_duplex: c_int,
    pub phy_intf: phy_interface_t,
    pub /: *mut *mut int rx_resource_err; / Rx ring resource error flag,
// Next available and first returning Rx resource
    pub rx_used_desc_q: int rx_curr_desc_q,,
// Next available and first returning Tx resource
    pub tx_used_desc_q: int tx_curr_desc_q,,
    pub p_rx_desc_area: *mut rx_desc,
    pub rx_desc_dma: dma_addr_t,
    pub rx_desc_area_size: c_int,
    pub rx_skb: *mut sk_buff,
    pub p_tx_desc_area: *mut tx_desc,
...
//
    ...
    pub smi_bus: *mut mii_bus,
// clock
    pub clk: *mut clk,
    pub pd: *mut pxa168_eth_platform_data,
//
...
// Pointer to the hardware address filter table
    pub htpr: *mut c_void,
    pub htpr_dma: dma_addr_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct addr_table_entry {
    pub lo: __le32,
    pub hi: __le32,
}
...
#[no_mangle]
pub unsafe extern "C" fn rdl(pep: *mut pxa168_eth_private, offset: c_int) -> u32 {
    static inline u32 rdl(struct pxa168_eth_private *pep, int offset)
    {
    return readl_relaxed(pep.base + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn wrl(pep: *mut pxa168_eth_private, offset: c_int, data: u32) {
    static inline void wrl(struct pxa168_eth_private *pep, int offset, u32 data)
    {
    writel_relaxed(data, pep.base + offset);
    }
#[no_mangle]
unsafe extern "C" fn abort_dma(pep: *mut pxa168_eth_private) {
    static void abort_dma(struct pxa168_eth_private *pep)
    {
    int delay;
    let mut max_retries: c_int = 40;
    do {
...
#[no_mangle]
unsafe extern "C" fn rxq_refill(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn rxq_refill_timer_wrapper(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn flip_8_bits(x: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn nibble_swap_every_byte(mac_addr: *mut c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn inverse_every_nibble(mac_addr: *mut c_uchar) {
...
//
#[no_mangle]
unsafe extern "C" fn hash_function(mac_addr_orig: *const c_uchar) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn init_hash_table(pep: *mut pxa168_eth_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_set_rx_mode(dev: *mut net_device) {
...
//
    memset(pep.htpr, 0, HASH_ADDR_TABLE_SIZE);
    update_hash_table_mac_address(pep, core::ptr::null_mut(), dev.dev_addr);
    netdev_for_each_mc_addr(ha, dev)
    update_hash_table_mac_address(pep, core::ptr::null_mut(), ha.addr);
    }
    static void pxa168_eth_get_mac_address(struct net_device *dev,
    unsigned char *addr)
    {
    struct pxa168_eth_private *pep = netdev_priv(dev);
    let mut mac_h: c_uint = rdl(pep, MAC_ADDR_HIGH);
    let mut mac_l: c_uint = rdl(pep, MAC_ADDR_LOW);
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_set_mac_address(dev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eth_port_start(dev: *mut net_device) {
    static void eth_port_start(struct net_device *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn eth_port_reset(dev: *mut net_device) {
    static void eth_port_reset(struct net_device *dev)
    {
    struct pxa168_eth_private *pep = netdev_priv(dev);
    let mut val: c_uint = 0;
...
//
#[no_mangle]
unsafe extern "C" fn txq_reclaim(dev: *mut net_device, force: c_int) -> c_int {
    ...
    if (skb)
    pep.tx_skb[tx_index] = core::ptr::null_mut();
    if (cmd_sts & TX_ERROR) {
    if (net_ratelimit())
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_tx_timeout_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rxq_process(dev: *mut net_device, budget: c_int) -> c_int {
    static int rxq_process(struct net_device *dev, int budget)
    {
    struct pxa168_eth_private *pep = netdev_priv(dev);
    struct net_device_stats *stats = &dev.stats;
    let mut received_packets: c_uint = 0;
    struct sk_buff *skb;
    while (budget-- > 0) {
...
// Do not process Rx ring in case of Rx ring resource error
    ...
    pep.rx_skb[rx_curr_desc] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_int_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_recalc_skb_size(pep: *mut pxa168_eth_private) {
...
#[no_mangle]
unsafe extern "C" fn set_port_config_ext(pep: *mut pxa168_eth_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(1536: pep->skb_size <=) -> else {
    else if (pep.skb_size <= 1536)
    skb_size = PCXR_MFL_1536;
#[no_mangle]
pub unsafe extern "C" fn if(2048: pep->skb_size <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_adjust_link(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn pxa168_init_phy(dev: *mut net_device) -> c_int {
    static int pxa168_init_phy(struct net_device *dev)
    {
    struct pxa168_eth_private *pep = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn pxa168_init_hw(pep: *mut pxa168_eth_private) -> c_int {
    static int pxa168_init_hw(struct pxa168_eth_private *pep)
    {
    let mut err: c_int = 0;
// Disable interrupts
...
#[no_mangle]
unsafe extern "C" fn rxq_init(dev: *mut net_device) -> c_int {
    static int rxq_init(struct net_device *dev)
    {
    struct pxa168_eth_private *pep = netdev_priv(dev);
    struct rx_desc *p_rx_desc;
    let mut size: c_int = 0, i = 0;
    let mut rx_desc_num: c_int = pep.rx_ring_size;
...
#[no_mangle]
unsafe extern "C" fn rxq_deinit(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn txq_init(dev: *mut net_device) -> c_int {
    static int txq_init(struct net_device *dev)
    {
    struct pxa168_eth_private *pep = netdev_priv(dev);
    struct tx_desc *p_tx_desc;
    let mut size: c_int = 0, i = 0;
    let mut tx_desc_num: c_int = pep.tx_ring_size;
...
#[no_mangle]
unsafe extern "C" fn txq_deinit(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_open(dev: *mut net_device) -> c_int {
    static int pxa168_eth_open(struct net_device *dev)
    {
    struct pxa168_eth_private *pep = netdev_priv(dev);
    int err;
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_stop(dev: *mut net_device) -> c_int {
    static int pxa168_eth_stop(struct net_device *dev)
    {
    struct pxa168_eth_private *pep = netdev_priv(dev);
    eth_port_reset(dev);
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_change_mtu(dev: *mut net_device, mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eth_alloc_tx_desc_index(pep: *mut pxa168_eth_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa168_rx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_wait_ready(pep: *mut pxa168_eth_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa168_smi_read(bus: *mut mii_bus, phy_addr: c_int, regnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_netpoll(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_probe(pdev: *mut platform_device) -> c_int {
    static int pxa168_eth_probe(struct platform_device *pdev)
    {
    struct pxa168_eth_private *pep = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn pxa168_eth_resume(pdev: *mut platform_device) -> c_int {
    static int pxa168_eth_resume(struct platform_device *pdev)
    {
    return -ENOSYS;
    }
#[no_mangle]
unsafe extern "C" fn pxa168_eth_suspend(pdev: *mut platform_device, state: pm_message_t) -> c_int {
