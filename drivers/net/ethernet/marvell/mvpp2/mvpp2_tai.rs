...
//! Source: drivers/net/ethernet/marvell/mvpp2/mvpp2_tai.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvpp2_tai {
    pub caps: ptp_clock_info,
    pub ptp_clock: *mut ptp_clock,
    pub base: *mut void __iomem,
    pub lock: spinlock_t,
    pub point: u64 period; // nanosecond period in 32.32 fixed,
// This timestamp is updated every two seconds
    pub stamp: timespec64,
}

#[no_mangle]
unsafe extern "C" fn mvpp2_tai_modify(reg: *mut void __iomem, mask: u32, set: u32) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_tai_write(val: u32, reg: *mut void __iomem) {
    static void mvpp2_tai_write(u32 val, void __iomem *reg)
    {
    writel_relaxed(val & 0xffff, reg);
    }
#[no_mangle]
unsafe extern "C" fn mvpp2_tai_read(reg: *mut void __iomem) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_tai_read_ts(ts: *mut timespec64, base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_tai_op(op: u32, base: *mut void __iomem) {
...
//
#[no_mangle]
unsafe extern "C" fn mvpp22_calc_frac_ppm(tai: *mut mvpp2_tai, abs_scaled_ppm: c_long) -> u64 {
    static u64 mvpp22_calc_frac_ppm(struct mvpp2_tai *tai, long abs_scaled_ppm)
    {
    let mut val: u64 = tai.period * abs_scaled_ppm >> 4;
    return div_u64(val, (1000000 << 12) + (abs_scaled_ppm >> 4));
    }
#[no_mangle]
unsafe extern "C" fn mvpp22_calc_max_adj(tai: *mut mvpp2_tai) -> i32 {
    static s32 mvpp22_calc_max_adj(struct mvpp2_tai *tai)
    {
    return 1000000;
    }
#[no_mangle]
unsafe extern "C" fn mvpp22_tai_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_tai_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_tai_aux_work(ptp: *mut ptp_clock_info) -> c_long {
    static long mvpp22_tai_aux_work(struct ptp_clock_info *ptp)
    {
    struct mvpp2_tai *tai = ptp_to_tai(ptp);
    mvpp22_tai_gettimex64(ptp, &tai.stamp, core::ptr::null_mut());
    return msecs_to_jiffies(2000);
    }
#[no_mangle]
unsafe extern "C" fn mvpp22_tai_set_step(tai: *mut mvpp2_tai) {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_tai_init(tai: *mut mvpp2_tai) {
...
#[no_mangle]
pub unsafe extern "C" fn mvpp22_tai_ptp_clock_index(tai: *mut mvpp2_tai) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mvpp22_tai_start(tai: *mut mvpp2_tai) {
...
#[no_mangle]
pub unsafe extern "C" fn mvpp22_tai_stop(tai: *mut mvpp2_tai) {
    void mvpp22_tai_stop(struct mvpp2_tai *tai)
    {
    ptp_cancel_worker_sync(tai.ptp_clock);
    }
#[no_mangle]
unsafe extern "C" fn mvpp22_tai_remove(priv: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn mvpp22_tai_probe(dev: *mut device, priv: *mut mvpp2) -> c_int {
