...
//! Source: drivers/net/ethernet/marvell/mvpp2/mvpp2_main.c
#![no_std]
...
// Queue modes
pub const MVPP2_QDIST_SINGLE_MODE: c_int = 0;
pub const MVPP2_QDIST_MULTI_MODE: c_int = 1;
    let mut queue_mode: static int = MVPP2_QDIST_MULTI_MODE;
    module_param(queue_mode, int, 0444);
    MODULE_PARM_DESC(queue_mode, "Set queue_mode (single=0, multi=1)");
// Utility/helper methods
#[no_mangle]
pub unsafe extern "C" fn mvpp2_write(priv: *mut mvpp2, offset: u32, data: u32) {
    void mvpp2_write(struct mvpp2 *priv, u32 offset, u32 data)
    {
    writel(data, priv.swth_base[0] + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn mvpp2_read(priv: *mut mvpp2, offset: u32) -> u32 {
    u32 mvpp2_read(struct mvpp2 *priv, u32 offset)
    {
    return readl(priv.swth_base[0] + offset);
    }
#[no_mangle]
unsafe extern "C" fn mvpp2_read_relaxed(priv: *mut mvpp2, offset: u32) -> u32 {
    static u32 mvpp2_read_relaxed(struct mvpp2 *priv, u32 offset)
    {
    return readl_relaxed(priv.swth_base[0] + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn mvpp2_cpu_to_thread(priv: *mut mvpp2, cpu: c_int) -> u32 {
    static inline u32 mvpp2_cpu_to_thread(struct mvpp2 *priv, int cpu)
    {
    return cpu % priv.nthreads;
    }
#[no_mangle]
unsafe extern "C" fn mvpp2_cm3_write(priv: *mut mvpp2, offset: u32, data: u32) {
    static void mvpp2_cm3_write(struct mvpp2 *priv, u32 offset, u32 data)
    {
    writel(data, priv.cm3_base + offset);
    }
#[no_mangle]
unsafe extern "C" fn mvpp2_cm3_read(priv: *mut mvpp2, offset: u32) -> u32 {
...
//
    ...
    let mut val: __le64 = cpu_to_le64(addr);
...
#[no_mangle]
unsafe extern "C" fn mvpp2_txq_inc_get(txq_pcpu: *mut mvpp2_txq_pcpu) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_get_nrxqs(priv: *mut mvpp2) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mvpp2_egress_port(port: *mut mvpp2_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mvpp2_txq_phys(port: c_int, txq: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(PAGE_SIZE): likely(pool->frag_size <=) -> else {
...
// Set pool buffer size
    ...
    {
    let mut thread: c_uint = mvpp2_cpu_to_thread(priv, get_cpu());
...
// Free all buffers from the pool
    ...
    {
    struct page_pool *pp = core::ptr::null_mut();
    int i;
...
#[no_mangle]
unsafe extern "C" fn mvpp2_check_hw_buf_num(priv: *mut mvpp2, bm_pool: *mut mvpp2_bm_pool) -> c_int {
...
// Check buffer counters after free
    ...
    priv.page_pool[bm_pool.id] = core::ptr::null_mut();
    }
    dma_free_coherent(dev, bm_pool.size_bytes,
    bm_pool.virt_addr,
    bm_pool.dma_addr);
...
#[no_mangle]
unsafe extern "C" fn mvpp2_bm_pools_init(dev: *mut device, priv: *mut mvpp2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp23_bm_set_8pool_mode(priv: *mut mvpp2) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_bm_pool_cleanup(priv: *mut mvpp2, pool_id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_bm_init(dev: *mut device, priv: *mut mvpp2) -> c_int {
    static int mvpp2_bm_init(struct device *dev, struct mvpp2 *priv)
    {
    let mut dma_dir: enum dma_data_direction = DMA_FROM_DEVICE;
...
// the pool in use
    ...
    priv.page_pool[j] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn mvpp2_setup_bm_pool() {
...
// Get queue physical ID
    ...
    mvpp2_frag_free(bm_pool, core::ptr::null_mut(), data);
    return core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn mvpp2_rxq_enable_fc(port: *mut mvpp2_port) {
    static void mvpp2_rxq_enable_fc(struct mvpp2_port *port)
    {
    int val, cm3_state, host_id, q;
    let mut fq: c_int = port.first_rxq;
    unsigned long flags;
...
//
    ...
    host_id = port.nqvecs;
#[no_mangle]
pub unsafe extern "C" fn if(MVPP2_QDIST_MULTI_MODE: queue_mode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_rxq_disable_fc(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_bm_pool_update_priv_fc(priv: *mut mvpp2, en: bool) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_enable_global_fc(priv: *mut mvpp2) -> c_int {
...
// Release buffer to BM
    ...
    phys_addr_t buf_phys_addr)
    {
    let mut thread: c_uint = mvpp2_cpu_to_thread(port.priv, get_cpu());
...
#[no_mangle]
unsafe extern "C" fn mvpp2_swf_bm_pool_init_shared(port: *mut mvpp2_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_swf_bm_pool_init_percpu(port: *mut mvpp2_port) -> c_int {
    ...
    port.pool_long = core::ptr::null_mut();
    port.pool_short = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mvpp2_swf_bm_pool_init(port: *mut mvpp2_port) -> c_int {
    ...
    {
    let mut csums: netdev_features_t = NETIF_F_IP_CSUM | NETIF_F_IPV6_CSUM;
...
#[no_mangle]
unsafe extern "C" fn mvpp2_bm_update_mtu(dev: *mut net_device, mtu: c_int) -> c_int {
    static int mvpp2_bm_update_mtu(struct net_device *dev, int mtu)
    {
    struct mvpp2_port *port = netdev_priv(dev);
    enum mvpp2_bm_pool_log_num new_long_pool;
    let mut pkt_size: c_int = MVPP2_RX_PKT_SIZE(mtu);
    if (port.priv.percpu_pools)
    goto out_set;
...
#[no_mangle]
pub unsafe extern "C" fn mvpp2_interrupts_enable(port: *mut mvpp2_port) {
...
#[no_mangle]
pub unsafe extern "C" fn mvpp2_interrupts_disable(port: *mut mvpp2_port) {
...
#[no_mangle]
pub unsafe extern "C" fn mvpp2_qvec_interrupt_enable(qvec: *mut mvpp2_queue_vector) {
...
#[no_mangle]
pub unsafe extern "C" fn mvpp2_qvec_interrupt_disable(qvec: *mut mvpp2_queue_vector) {
...
//
#[no_mangle]
unsafe extern "C" fn mvpp2_interrupts_mask(arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn mvpp2_interrupts_unmask(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_port_supports_xlg(port: *mut mvpp2_port) -> bool {
    static bool mvpp2_port_supports_xlg(struct mvpp2_port *port)
    {
    return port.gop_id == 0;
    }
#[no_mangle]
unsafe extern "C" fn mvpp2_port_supports_rgmii(port: *mut mvpp2_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_is_xlg(interface: phy_interface_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_modify(ptr: *mut void __iomem, mask: u32, set: u32) {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_gop_init_rgmii(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_gop_init_sgmii(port: *mut mvpp2_port) {
    ...
    val &= ~GENCONF_CTRL0_PORT2_RGMII;
#[no_mangle]
pub unsafe extern "C" fn if(3: port->gop_id ==) -> else {
    else if (port.gop_id == 3)
    val &= ~GENCONF_CTRL0_PORT3_RGMII_MII;
    regmap_write(priv.sysctrl_base, GENCONF_CTRL0, val);
    }
...
#[no_mangle]
unsafe extern "C" fn mvpp22_gop_init_10gkr(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_gop_fca_enable_periodic(port: *mut mvpp2_port, en: bool) {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_gop_fca_set_timer(port: *mut mvpp2_port, timer: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn mvpp22_gop_fca_set_periodic_timer(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_gop_init(port: *mut mvpp2_port, interface: phy_interface_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_gop_unmask_irq(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_gop_mask_irq(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_gop_setup_irq(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_port_enable(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_port_disable(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_port_periodic_xon_disable(port: *mut mvpp2_port) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvpp2_ethtool_counter {
    pub offset: c_uint,
...
//
#[no_mangle]
unsafe extern "C" fn mvpp2_read_index(priv: *mut mvpp2, index: u32, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_read_stats(port: *mut mvpp2_port) {
    static void mvpp2_read_stats(struct mvpp2_port *port)
    {
    let mut xdp_stats: mvpp2_pcpu_stats = {};
...
#[no_mangle]
unsafe extern "C" fn mvpp2_gather_hw_statistics(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_ethtool_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_mac_reset_assert(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_pcs_reset_assert(port: *mut mvpp2_port) {
...
#[no_mangle]
pub unsafe extern "C" fn mvpp2_gmac_max_rx_size_set(port: *mut mvpp2_port) {
...
// Change maximum receive size of the port
#[no_mangle]
pub unsafe extern "C" fn mvpp2_xlg_max_rx_size_set(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_defaults_set(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_ingress_enable(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_ingress_disable(port: *mut mvpp2_port) {
...
//
#[no_mangle]
unsafe extern "C" fn mvpp2_egress_enable(port: *mut mvpp2_port) {
    static void mvpp2_egress_enable(struct mvpp2_port *port)
    {
    u32 qmap;
    int queue;
    let mut tx_port_num: c_int = mvpp2_egress_port(port);
...
//
#[no_mangle]
unsafe extern "C" fn mvpp2_egress_disable(port: *mut mvpp2_port) {
...
// Get number of Rx descriptors occupied by received packets
    ...
    {
    let mut val: u32 = mvpp2_read(port.priv, MVPP2_RXQ_STATUS_REG(rxq_id));
...
//
    let mut val: u32 = used_count | (free_count << MVPP2_RXQ_NUM_NEW_OFFSET);
...
//
#[no_mangle]
unsafe extern "C" fn mvpp2_aggr_txq_pend_desc_add(port: *mut mvpp2_port, pending: c_int) {
...
//
    ...
    {
    let mut thread: c_uint = mvpp2_cpu_to_thread(port.priv, smp_processor_id());
    struct mvpp2 *priv = port.priv;
    u32 val;
...
//
#[no_mangle]
unsafe extern "C" fn mvpp2_txq_desc_put(txq: *mut mvpp2_tx_queue) {
...
//
#[no_mangle]
unsafe extern "C" fn mvpp2_txq_sent_counter_clear(arg: *mut c_void) {
...
// If the thread isn't used, don't do anything
    ...
    return;
    for (queue = 0; queue < port.ntxqs; queue++) {
    let mut id: c_int = port.txqs[queue].id;
...
#[no_mangle]
unsafe extern "C" fn mvpp2_txp_max_tx_size_set(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_usec_to_cycles(usec: u32, clk_hz: c_ulong) -> u32 {
    static u32 mvpp2_usec_to_cycles(u32 usec, unsigned long clk_hz)
    {
    let mut tmp: u64 = (u64)clk_hz * usec;
    do_div(tmp, USEC_PER_SEC);
    return tmp > U32_MAX ? U32_MAX : tmp;
    }
#[no_mangle]
unsafe extern "C" fn mvpp2_cycles_to_usec(cycles: u32, clk_hz: c_ulong) -> u32 {
    static u32 mvpp2_cycles_to_usec(u32 cycles, unsigned long clk_hz)
    {
    let mut tmp: u64 = (u64)cycles * USEC_PER_SEC;
    do_div(tmp, clk_hz);
    return tmp > U32_MAX ? U32_MAX : tmp;
    }
// Set the time delay in usec before Rx interrupt
    ...
    struct mvpp2_rx_queue *rxq)
    {
    let mut freq: c_ulong = port.priv.tclk;
    let mut val: u32 = mvpp2_usec_to_cycles(rxq.time_coal, freq);
...
#[no_mangle]
unsafe extern "C" fn mvpp2_tx_time_coal_set(port: *mut mvpp2_port) {
    static void mvpp2_tx_time_coal_set(struct mvpp2_port *port)
    {
    let mut freq: c_ulong = port.priv.tclk;
    let mut val: u32 = mvpp2_usec_to_cycles(port.tx_time_coal, freq);
...
// Push packets received by the RXQ to BM pool
    ...
    let mut status: u32 = mvpp2_rxdesc_status_get(port, rx_desc);
    int pool;
...
// WRR / EJP configuration - indirect access
    ...
    txq_pcpu.txq_put_index = 0;
    txq_pcpu.txq_get_index = 0;
    txq_pcpu.tso_headers = core::ptr::null_mut();
...
// Cleanup Tx ports
#[no_mangle]
unsafe extern "C" fn mvpp2_txq_clean(port: *mut mvpp2_port, txq: *mut mvpp2_tx_queue) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_cleanup_txqs(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_cleanup_rxqs(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_setup_rxqs(port: *mut mvpp2_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_setup_txqs(port: *mut mvpp2_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_isr_handle_ptp_queue(port: *mut mvpp2_port, nq: c_int) {
    ...
    id = (r0 >> 1) & 31;
    skb = queue.skb[id];
    queue.skb[id] = core::ptr::null_mut();
    if (skb) {
    let mut ts: u32 = r2 << 19 | r1 << 3 | r0 >> 13;
...
#[no_mangle]
unsafe extern "C" fn mvpp2_isr_handle_ptp(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_isr_handle_xlg(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_isr_handle_gmac_internal(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_port_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_hr_timer_cb(timer: *mut hrtimer) -> enum hrtimer_restart {
...
// Display more error info
    ...
    {
    let mut status: u32 = mvpp2_rxdesc_status_get(port, rx_desc);
    let mut sz: usize = mvpp2_rxdesc_size_get(port, rx_desc);
    char *err_str = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mvpp2_rx_csum(port: *mut mvpp2_port, status: u32) -> c_int {
...
// Handle tx checksum
#[no_mangle]
unsafe extern "C" fn mvpp2_skb_tx_csum(port: *mut mvpp2_port, skb: *mut sk_buff) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_xdp_finish_tx(port: *mut mvpp2_port, txq_id: u16, nxmit: c_int, nxmit_byte: c_int) {
...
// Finalize TX processing
    ...
    struct mvpp2_tx_desc *tx_desc;
    struct mvpp2_tx_queue *txq;
    let mut ret: c_int = MVPP2_XDP_TX;
    dma_addr_t dma_addr;
    txq = port.txqs[txq_id];
    txq_pcpu = per_cpu_ptr(txq.pcpu, thread);
    aggr_txq = &port.priv.aggr_txqs[thread];
...
// Main rx processing
    ...
    {
    struct net_device *dev = port.dev;
    let mut ps: mvpp2_pcpu_stats = {};
    enum dma_data_direction dma_dir;
    struct bpf_prog *xdp_prog;
    struct xdp_buff xdp;
    int rx_received;
    let mut rx_done: c_int = 0;
    let mut xdp_ret: u32 = 0;
...
// Descriptor in the middle: Not First, Not Last
    ...
    mvpp2_txq_inc_put(port, txq_pcpu, core::ptr::null_mut(), tx_desc, MVPP2_TYPE_SKB);
    }
    }
    return 0;
    cleanup:
...
// Check number of available descriptors
    ...
    len = skb.len - hdr_sz;
    while (len > 0) {
    let mut left: c_int = min_t(int, skb_shinfo(skb).gso_size, len);
    ...
    while (left > 0) {
    let mut sz: c_int = min_t(int, tso.size, left);
    left -= sz;
    descs++;
...
// Main tx processing
#[no_mangle]
unsafe extern "C" fn mvpp2_tx(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
pub unsafe extern "C" fn mvpp2_cause_error(dev: *mut net_device, cause: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_start_dev(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_stop_dev(port: *mut mvpp2_port) {
...
// Disable interrupts on all threads
    ...
    {
    let mut new_rx_pending: u16 = ring.rx_pending;
    let mut new_tx_pending: u16 = ring.tx_pending;
    if (ring.rx_pending == 0 || ring.tx_pending == 0)
    return -EINVAL;
    if (ring.rx_pending > MVPP2_MAX_RXD_MAX)
    new_rx_pending = MVPP2_MAX_RXD_MAX;
#[no_mangle]
pub unsafe extern "C" fn if(MSS_THRESHOLD_START: ring->rx_pending <) -> else {
    else if (ring.rx_pending < MSS_THRESHOLD_START)
    new_rx_pending = MSS_THRESHOLD_START;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !IS_ALIGNED(ring->rx_pending, _arg: 16)) -> else {
    else if (!IS_ALIGNED(ring.rx_pending, 16))
    new_rx_pending = ALIGN(ring.rx_pending, 16);
    if (ring.tx_pending > MVPP2_MAX_TXD_MAX)
    new_tx_pending = MVPP2_MAX_TXD_MAX;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !IS_ALIGNED(ring->tx_pending, _arg: 32)) -> else {
...
#[no_mangle]
unsafe extern "C" fn mvpp21_get_mac_address(port: *mut mvpp2_port, addr: *mut c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_irqs_init(port: *mut mvpp2_port) -> c_int {
    ...
    for (i = 0; i < port.nqvecs; i++) {
    struct mvpp2_queue_vector *qv = port.qvecs + i;
    irq_set_affinity_hint(qv.irq, core::ptr::null_mut());
    kfree(qv.mask);
    qv.mask = core::ptr::null_mut();
    free_irq(qv.irq, qv);
    }
    return err;
    }
#[no_mangle]
unsafe extern "C" fn mvpp2_irqs_deinit(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_rss_is_supported(port: *mut mvpp2_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_stop(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_set_rx_promisc(port: *mut mvpp2_port, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_set_rx_mode(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_set_mac_address(dev: *mut net_device, p: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mvpp2_bm_switch_buffers(priv: *mut mvpp2, percpu: bool) -> c_int {
    static int mvpp2_bm_switch_buffers(struct mvpp2 *priv, bool percpu)
    {
    let mut change_percpu: bool = (percpu != priv.percpu_pools);
    let mut numbufs: c_int = MVPP2_BM_POOLS_NUM, i;
    struct mvpp2_port *port = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mvpp2_change_mtu(dev: *mut net_device, mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_check_pagepool_dma(port: *mut mvpp2_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_ioctl(dev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_vlan_rx_add_vid(dev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_vlan_rx_kill_vid(dev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_xdp_setup(port: *mut mvpp2_port, bpf: *mut netdev_bpf) -> c_int {
    static int mvpp2_xdp_setup(struct mvpp2_port *port, struct netdev_bpf *bpf)
    {
    struct bpf_prog *prog = bpf.prog, *old_prog;
    let mut running: bool = netif_running(port.dev);
    let mut reset: bool = !prog != !port.xdp_prog;
...
#[no_mangle]
unsafe extern "C" fn mvpp2_xdp(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
// Ethtool methods
#[no_mangle]
unsafe extern "C" fn mvpp2_ethtool_nway_reset(dev: *mut net_device) -> c_int {
...
// get coalescing for ethtools
    ...
    {
    struct mvpp2_port *port = netdev_priv(dev);
    let mut prev_rx_ring_size: u16 = port.rx_ring_size;
    let mut prev_tx_ring_size: u16 = port.tx_ring_size;
    int err;
...
#[no_mangle]
unsafe extern "C" fn mvpp2_ethtool_get_rx_ring_count(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_ethtool_get_rxfh_indir_size(dev: *mut net_device) -> u32 {
    ...
    {
    struct mvpp2_port *port = netdev_priv(dev);
    let mut rss_context: u32 = rxfh.rss_context;
    let mut ret: c_int = 0;
    if (!mvpp22_rss_is_supported(port))
    return -EOPNOTSUPP;
    ...
    struct netlink_ext_ack *extack)
    {
    return mvpp2_modify_rxfh_context(dev, core::ptr::null_mut(), rxfh, extack);
    }
...
#[no_mangle]
unsafe extern "C" fn mvpp2_queue_vectors_deinit(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_rx_irqs_setup(port: *mut mvpp2_port) {
...
// Initialize port HW
#[no_mangle]
unsafe extern "C" fn mvpp2_port_init(port: *mut mvpp2_port) -> c_int {
...
//
    for (queue = 0; queue < port.ntxqs; queue++) {
    let mut queue_phy_id: c_int = mvpp2_txq_phys(port.id, queue);
    struct mvpp2_tx_queue *txq;
...
// For any other modes, indicate that inband is not supported.
    ...
    state.speed = SPEED_1000;
#[no_mangle]
pub unsafe extern "C" fn if(MVPP2_GMAC_STATUS0_MII_SPEED: val &) -> else {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_gmac_pcs_an_restart(pcs: *mut phylink_pcs) {
    static void mvpp2_gmac_pcs_an_restart(struct phylink_pcs *pcs)
    {
    struct mvpp2_port *port = mvpp2_pcs_gmac_to_port(pcs);
    let mut val: u32 = readl(port.base + MVPP2_GMAC_AUTONEG_CONFIG);
...
#[no_mangle]
unsafe extern "C" fn mvpp2_mac_disable_tx_lpi(config: *mut phylink_config) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_acpi_start(port: *mut mvpp2_port) {
    static void mvpp2_acpi_start(struct mvpp2_port *port)
    {
...
//
    ...
    port.phy_interface);
    mvpp2_mac_link_up(&port.phylink_config, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn mvpp2_use_acpi_compat_mode(port_fwnode: *mut fwnode_handle) -> bool {
...
// Ports initialization
    ...
    struct mvpp2 *priv)
    {
    struct phy *comphy = core::ptr::null_mut();
    struct mvpp2_port *port;
    struct mvpp2_port_pcpu *port_pcpu;
...
//
    ...
    if (port_node) {
    comphy = devm_of_phy_get(&pdev.dev, port_node, core::ptr::null_mut());
    if (IS_ERR(comphy)) {
...
#[no_mangle]
pub unsafe extern "C" fn if(2: *mut *mut port->ntxqs >= num_possible_cpus()) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(PHY_INTERFACE_MODE_5GBASER: phy_mode ==) -> else {
    else if (phy_mode == PHY_INTERFACE_MODE_5GBASER)
    port.phylink_config.mac_capabilities |=
    MAC_5000FD;
    else
...
//
    ...
    port.phylink = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn mvpp2_port_remove(port: *mut mvpp2_port) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_rx_fifo_init(priv: *mut mvpp2) {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_rx_fifo_set_hw(priv: *mut mvpp2, port: c_int, data_size: c_int) {
    static void mvpp22_rx_fifo_set_hw(struct mvpp2 *priv, int port, int data_size)
    {
    let mut attr_size: c_int = MVPP2_RX_FIFO_PORT_ATTR_SIZE(data_size);
...
//
#[no_mangle]
unsafe extern "C" fn mvpp22_rx_fifo_init(priv: *mut mvpp2) {
...
// Assign remaining RX FIFO space among all active ports.
    ...
    size = size_remainder;
#[no_mangle]
pub unsafe extern "C" fn if(0: port ==) -> else {
    else if (port == 0)
    size = max(size_remainder / remaining_ports_count,
    MVPP2_RX_FIFO_PORT_DATA_SIZE_32KB);
#[no_mangle]
pub unsafe extern "C" fn if(1: port ==) -> else {
    else if (port == 1)
    size = max(size_remainder / remaining_ports_count,
...
#[no_mangle]
unsafe extern "C" fn mvpp23_rx_fifo_fc_set_tresh(priv: *mut mvpp2) {
...
// Configure Rx FIFO Flow control thresholds
#[no_mangle]
pub unsafe extern "C" fn mvpp23_rx_fifo_fc_en(priv: *mut mvpp2, port: c_int, en: bool) {
...
#[no_mangle]
unsafe extern "C" fn mvpp22_tx_fifo_set_hw(priv: *mut mvpp2, port: c_int, size: c_int) {
    static void mvpp22_tx_fifo_set_hw(struct mvpp2 *priv, int port, int size)
    {
    let mut threshold: c_int = MVPP2_TX_FIFO_THRESHOLD(size);
...
//
#[no_mangle]
unsafe extern "C" fn mvpp22_tx_fifo_init(priv: *mut mvpp2) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_axi_init(priv: *mut mvpp2) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_init(pdev: *mut platform_device, priv: *mut mvpp2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_probe(pdev: *mut platform_device) -> c_int {
...
// firmware/bootloader.
//
    priv.sysctrl_base = core::ptr::null_mut();
    }
    if (priv.hw_version >= MVPP22 &&
...
#[no_mangle]
unsafe extern "C" fn mvpp2_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_driver_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_driver_exit() -> void __exit {
