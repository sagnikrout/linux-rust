...
//! Source: drivers/net/ethernet/marvell/mvpp2/mvpp2_debugfs.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvpp2_dbgfs_prs_entry {
    pub tid: c_int,
    pub priv: *mut mvpp2,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvpp2_dbgfs_c2_entry {
    pub id: c_int,
    pub priv: *mut mvpp2,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvpp2_dbgfs_flow_entry {
    pub flow: c_int,
    pub priv: *mut mvpp2,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvpp2_dbgfs_flow_tbl_entry {
    pub id: c_int,
    pub priv: *mut mvpp2,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvpp2_dbgfs_port_flow_entry {
    pub port: *mut mvpp2_port,
    pub dbg_fe: *mut mvpp2_dbgfs_flow_entry,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvpp2_dbgfs_entries {
// Entries for Header Parser debug info
    pub prs_entries: [mvpp2_dbgfs_prs_entry; MVPP2_PRS_TCAM_SRAM_SIZE],
// Entries for Classifier C2 engine debug info
    pub c2_entries: [mvpp2_dbgfs_c2_entry; MVPP22_CLS_C2_N_ENTRIES],
// Entries for Classifier Flow Table debug info
    pub flt_entries: [mvpp2_dbgfs_flow_tbl_entry; MVPP2_CLS_FLOWS_TBL_SIZE],
// Entries for Classifier flows debug info
    pub flow_entries: [mvpp2_dbgfs_flow_entry; MVPP2_N_PRS_FLOWS],
// Entries for per-port flows debug info
    pub port_flow_entries: [mvpp2_dbgfs_port_flow_entry; MVPP2_MAX_PORTS],
}

#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_flow_flt_hits_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
    static int mvpp2_dbgfs_flow_flt_hits_show(struct seq_file *s, void *unused)
    {
    struct mvpp2_dbgfs_flow_tbl_entry *entry = s.private;
    let mut hits: u32 = mvpp2_cls_flow_hits(entry.priv, entry.id);
    seq_printf(s, "%u\n", hits);
    return 0;
    }
    DEFINE_SHOW_ATTRIBUTE(mvpp2_dbgfs_flow_flt_hits);
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_flow_dec_hits_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
    static int mvpp2_dbgfs_flow_dec_hits_show(struct seq_file *s, void *unused)
    {
    struct mvpp2_dbgfs_flow_entry *entry = s.private;
    let mut hits: u32 = mvpp2_cls_lookup_hits(entry.priv, entry.flow);
    seq_printf(s, "%u\n", hits);
    return 0;
    }
    DEFINE_SHOW_ATTRIBUTE(mvpp2_dbgfs_flow_dec_hits);
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_flow_type_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_flow_id_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_port_flow_hash_opt_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_port_flow_engine_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_flow_c2_hits_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_flow_c2_rxq_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_flow_c2_enable_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_port_vid_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_port_parser_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_filter_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_prs_lu_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_prs_pmap_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_prs_ai_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_prs_hdata_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_prs_sram_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_prs_hits_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_prs_valid_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
    static int mvpp2_dbgfs_prs_valid_show(struct seq_file *s, void *unused)
    {
    struct mvpp2_dbgfs_prs_entry *entry = s.private;
    struct mvpp2 *priv = entry.priv;
    let mut tid: c_int = entry.tid;
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_flow_init(parent: *mut dentry, priv: *mut mvpp2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_prs_init(parent: *mut dentry, priv: *mut mvpp2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvpp2_dbgfs_cls_init(parent: *mut dentry, priv: *mut mvpp2) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mvpp2_dbgfs_exit() {
    void mvpp2_dbgfs_exit(void)
    {
    debugfs_remove(mvpp2_root);
    }
#[no_mangle]
pub unsafe extern "C" fn mvpp2_dbgfs_cleanup(priv: *mut mvpp2) {
...
#[no_mangle]
pub unsafe extern "C" fn mvpp2_dbgfs_init(priv: *mut mvpp2, name: *const c_char) {
    void mvpp2_dbgfs_init(struct mvpp2 *priv, const char *name)
    {
    struct dentry *mvpp2_dir;
    int ret, i;
    if (!mvpp2_root)
    mvpp2_root = debugfs_create_dir(MVPP2_DRIVER_NAME, core::ptr::null_mut());
