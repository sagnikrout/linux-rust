...
//! Source: drivers/net/ethernet/marvell/octeon_ep_vf/octep_vf_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn octep_vf_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn octep_vf_set_ethtool_ops(netdev: *mut net_device) {
