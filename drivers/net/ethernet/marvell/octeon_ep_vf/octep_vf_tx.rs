...
//! Source: drivers/net/ethernet/marvell/octeon_ep_vf/octep_vf_tx.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octep_vf_tx_sglist_desc {
    pub len: [u16; 4],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octep_vf_tx_buffer {
    pub skb: *mut sk_buff,
    pub dma: dma_addr_t,
    pub sglist: *mut octep_vf_tx_sglist_desc,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octep_vf_iface_tx_stats {
...
// Index in input ring where Octeon is expected to read next packet
    pub octep_vf_read_index: u16,
// This index aids in finding the window in the queue where Octeon
// has read the commands.
//
    pub flush_index: u16,
// Statistics for this input queue.
    pub stats: *mut octep_vf_iq_stats,
// Pointer to the Virtual Base addr of the input ring.
    pub desc_ring: *mut octep_vf_tx_desc_hw,
// DMA mapped base address of the input descriptor ring.
    pub desc_ring_dma: dma_addr_t,
// Info of Tx buffers pending completion.
    pub buff_info: *mut octep_vf_tx_buffer,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octep_vf_tx_desc_hw {
// Pointer where the input data is available.
    pub dptr: u64,
// Instruction Header.
    pub ih: octep_vf_instr_hdr,
    pub ih64: u64,
}
