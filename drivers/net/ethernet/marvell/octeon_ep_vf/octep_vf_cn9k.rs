...
//! Source: drivers/net/ethernet/marvell/octeon_ep_vf/octep_vf_cn9k.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cn93_vf_dump_q_regs(oct: *mut octep_vf_device, qno: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cn93_vf_reset_iq(oct: *mut octep_vf_device, q_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cn93_vf_reset_oq(oct: *mut octep_vf_device, q_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_reset_io_queues_cn93(oct: *mut octep_vf_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_init_config_cn93_vf(oct: *mut octep_vf_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_setup_iq_regs_cn93(oct: *mut octep_vf_device, iq_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_setup_oq_regs_cn93(oct: *mut octep_vf_device, oq_no: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_setup_mbox_regs_cn93(oct: *mut octep_vf_device, q_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cn93_handle_vf_mbox_intr(oct: *mut octep_vf_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_ioq_intr_handler_cn93(data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_reinit_regs_cn93(oct: *mut octep_vf_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_enable_interrupts_cn93(oct: *mut octep_vf_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_disable_interrupts_cn93(oct: *mut octep_vf_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_update_iq_read_index_cn93(iq: *mut octep_vf_iq) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_enable_iq_cn93(oct: *mut octep_vf_device, iq_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_enable_oq_cn93(oct: *mut octep_vf_device, oq_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_enable_io_queues_cn93(oct: *mut octep_vf_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_disable_iq_cn93(oct: *mut octep_vf_device, iq_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_disable_oq_cn93(oct: *mut octep_vf_device, oq_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_disable_io_queues_cn93(oct: *mut octep_vf_device) {
...
#[no_mangle]
unsafe extern "C" fn octep_vf_dump_registers_cn93(oct: *mut octep_vf_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn octep_vf_device_setup_cn93(oct: *mut octep_vf_device) {
