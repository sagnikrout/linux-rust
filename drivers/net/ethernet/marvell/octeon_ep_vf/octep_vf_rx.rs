...
//! Source: drivers/net/ethernet/marvell/octeon_ep_vf/octep_vf_rx.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octep_vf_oq_desc_hw {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octep_vf_oq_resp_hw_ext {
// Reserved.
    pub rsvd:48: u64,
// rx offload flags
    pub rx_ol_flags: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octep_vf_oq_resp_hw {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octep_vf_iface_rx_stats {
// Received packets
    pub pkts: u64,
...
// of the buffers.
//
    pub buff_info: *mut octep_vf_rx_buffer,
...
// Statistics for this OQ.
    pub stats: *mut octep_vf_oq_stats,
...
// The 8B aligned descriptor ring starts at this address.
    pub desc_ring: *mut octep_vf_oq_desc_hw,
