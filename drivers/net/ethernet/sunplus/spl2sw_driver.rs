...
//! Source: drivers/net/ethernet/sunplus/spl2sw_driver.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn spl2sw_ethernet_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spl2sw_ethernet_stop(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spl2sw_ethernet_set_rx_mode(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn spl2sw_ethernet_set_mac_address(ndev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spl2sw_ethernet_tx_timeout(ndev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn spl2sw_check_mac_vendor_id_and_convert(mac_addr: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn spl2sw_probe(pdev: *mut platform_device) -> c_int {
...
// Get clock controller.
    comm.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(comm.clk)) {
...
// Get reset controller.
    comm.rstc = devm_reset_control_get_exclusive(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(comm.rstc)) {
...
#[no_mangle]
unsafe extern "C" fn spl2sw_remove(pdev: *mut platform_device) {
