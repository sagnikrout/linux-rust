...
//! Source: drivers/net/ethernet/natsemi/jazzsonic.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn jazzsonic_open(dev: *mut *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jazzsonic_close(dev: *mut *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn jazz_sonic_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jazz_sonic_device_remove(pdev: *mut platform_device) {
