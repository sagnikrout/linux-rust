...
//! Source: drivers/net/ethernet/dec/tulip/pnic2.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn pnic2_timer(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn pnic2_start_nway(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn pnic2_lnk_change(dev: *mut net_device, csr5: c_int) {
...
//
    let mut negotiated: c_int = ((csr12 >> 16) & 0x01E0) & tp.sym_advertise;
    tp.lpar = (csr12 >> 16);
    tp.nwayset = 1;
