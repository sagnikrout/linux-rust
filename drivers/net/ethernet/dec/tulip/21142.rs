...
//! Source: drivers/net/ethernet/dec/tulip/21142.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn t21142_media_task(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn t21142_start_nway(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn t21142_lnk_change(dev: *mut net_device, csr5: c_int) {
...
// If NWay finished and we have a negotiated partner capability.
    ...
    let mut setup_done: c_int = 0;
    let mut negotiated: c_int = tp.sym_advertise & (csr12 >> 16);
    tp.lpar = csr12 >> 16;
    tp.nwayset = 1;
// If partner cannot negotiate, it is 10Mbps Half Duplex
    ...
    let mut startup: c_int = ! ((tp.chip_id == DC21143 && (tp.revision == 48 || tp.revision == 65)));
    tp.cur_index = i;
