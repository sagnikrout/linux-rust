...
//! Source: drivers/net/ethernet/dec/tulip/dmfe.c
#![no_std]
...
pub const PCI_DM9132_ID: c_uint = 0x91321282      /* Davicom DM9132 ID */;
pub const PCI_DM9102_ID: c_uint = 0x91021282      /* Davicom DM9102 ID */;
pub const PCI_DM9100_ID: c_uint = 0x91001282      /* Davicom DM9100 ID */;
pub const PCI_DM9009_ID: c_uint = 0x90091282      /* Davicom DM9009 ID */;
pub const DM9102_IO_SIZE: c_uint = 0x80;
pub const DM9102A_IO_SIZE: c_uint = 0x100;
pub const TX_MAX_SEND_CNT: c_uint = 0x1             /* Maximum tx packet per time */;
pub const TX_DESC_CNT: c_uint = 0x10            /* Allocated Tx descriptors */;
pub const RX_DESC_CNT: c_uint = 0x20            /* Allocated Rx descriptors */;

pub const TX_BUF_ALLOC: c_uint = 0x600;
pub const RX_ALLOC_SIZE: c_uint = 0x620;
pub const DM910X_RESET: c_int = 1;
pub const CR0_DEFAULT: c_uint = 0x00E00000      /* TX & RX burst mode */;
pub const CR6_DEFAULT: c_uint = 0x00080000      /* HD */;
pub const CR7_DEFAULT: c_uint = 0x180c1;
pub const CR15_DEFAULT: c_uint = 0x06            /* TxJabber RxWatchdog */;
pub const TDES0_ERR_MASK: c_uint = 0x4302          /* TXJT, LC, EC, FUE */;
pub const MAX_PACKET_SIZE: c_int = 1514;
pub const DMFE_MAX_MULTICAST: c_int = 14;
pub const RX_COPY_SIZE: c_int = 100;
pub const MAX_CHECK_PACKET: c_uint = 0x8000;
pub const DM9801_NOISE_FLOOR: c_int = 8;
pub const DM9802_NOISE_FLOOR: c_int = 5;
pub const DMFE_WOL_LINKCHANGE: c_uint = 0x20000000;
pub const DMFE_WOL_SAMPLEPACKET: c_uint = 0x10000000;
pub const DMFE_WOL_MAGICPACKET: c_uint = 0x08000000;
pub const DMFE_10MHF: c_int = 0;
pub const DMFE_100MHF: c_int = 1;
pub const DMFE_10MFD: c_int = 4;
pub const DMFE_100MFD: c_int = 5;
pub const DMFE_AUTO: c_int = 8;
pub const DMFE_1M_HPNA: c_uint = 0x10;
pub const DMFE_TXTH_72: c_uint = 0x400000	/* TX TH 72 byte */;
pub const DMFE_TXTH_96: c_uint = 0x404000	/* TX TH 96 byte */;
pub const DMFE_TXTH_128: c_uint = 0x0000		/* TX TH 128 byte */;
pub const DMFE_TXTH_256: c_uint = 0x4000		/* TX TH 256 byte */;
pub const DMFE_TXTH_512: c_uint = 0x8000		/* TX TH 512 byte */;
pub const DMFE_TXTH_1K: c_uint = 0xC000		/* TX TH 1K  byte */;
...
pub const CR9_SROM_READ: c_uint = 0x4800;
pub const CR9_SRCS: c_uint = 0x1;
pub const CR9_SRCLK: c_uint = 0x2;
pub const CR9_CRDOUT: c_uint = 0x8;
pub const SROM_DATA_0: c_uint = 0x0;
pub const SROM_DATA_1: c_uint = 0x4;
pub const PHY_DATA_1: c_uint = 0x20000;
pub const PHY_DATA_0: c_uint = 0x00000;
pub const MDCLKH: c_uint = 0x10000;
pub const PHY_POWER_DOWN: c_uint = 0x800;
pub const SROM_V41_CODE: c_uint = 0x14;
...
#[derive(Copy, Clone)]
pub struct tx_desc {
    pub /: *mut *mut __le32 tdes0, tdes1, tdes2, tdes3; / Data for the card,
    pub /: *mut *mut *mut char tx_buf_ptr; / Data for us,
    pub next_tx_desc: *mut tx_desc,
// C attribute field omitted
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_desc {
    pub /: *mut *mut __le32 rdes0, rdes1, rdes2, rdes3; / Data for the card,
    pub /: *mut *mut *mut sk_buff rx_skb_ptr; / Data for us,
    pub next_rx_desc: *mut rx_desc,
// C attribute field omitted
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmfe_board_info {
    pub /: *mut *mut u32 chip_id; / Chip vendor/Device ID,
    pub /: *mut *mut u8 chip_revision; / Chip revision,
    pub /: *mut *mut *mut net_device next_dev; / next device,
    pub /: *mut *mut *mut pci_dev pdev; / PCI device,
    pub lock: spinlock_t,
    pub /: *mut *mut *mut void __iomem ioaddr; / I/O base address,
    pub cr0_data: u32,
    pub cr5_data: u32,
    pub cr6_data: u32,
    pub cr7_data: u32,
...
// pointer for memory physical address
    pub /: *mut *mut dma_addr_t buf_pool_dma_ptr; / Tx buffer pool memory,
    pub /: *mut *mut dma_addr_t buf_pool_dma_start; / Tx buffer pool align dword,
    pub /: *mut *mut dma_addr_t desc_pool_dma_ptr; / descriptor pool memory,
    pub first_tx_desc_dma: dma_addr_t,
    pub first_rx_desc_dma: dma_addr_t,
// descriptor pointer
    pub /: *mut *mut *mut unsigned char buf_pool_ptr; / Tx buffer pool memory,
    pub /: *mut *mut *mut unsigned char buf_pool_start; / Tx buffer pool align dword,
    pub /: *mut *mut *mut unsigned char desc_pool_ptr; / descriptor pool memory,
    pub first_tx_desc: *mut tx_desc,
    pub tx_insert_ptr: *mut tx_desc,
    pub tx_remove_ptr: *mut tx_desc,
    pub first_rx_desc: *mut rx_desc,
    pub rx_insert_ptr: *mut rx_desc,
    pub /: *mut *mut *mut rx_desc rx_ready_ptr; / packet come pointer,
    pub /: *mut *mut unsigned long tx_packet_cnt; / transmitted packet count,
    pub /: *mut *mut unsigned long tx_queue_cnt; / wait to send packet count,
    pub /: *mut *mut unsigned long rx_avail_cnt; / available rx descriptor count,
    pub /: *mut *mut unsigned long interval_rx_cnt; / rx packet count a callback time,
    pub /: *mut *mut u16 HPNA_command; / For HPNA register 16,
    pub /: *mut *mut u16 HPNA_timer; / For HPNA remote device check,
    pub dbug_cnt: u16,
    pub /: *mut *mut u16 NIC_capability; / NIC media capability,
    pub /: *mut *mut u16 PHY_reg4; / Saved Phyxcer register 4 value,
    pub /: *mut *mut u8 HPNA_present; / 0:none, 1:DM9801, 2:DM9802,
    pub /: *mut *mut u8 chip_type; / Keep DM9102A chip type,
    pub /: *mut *mut u8 media_mode; / user specify media mode,
    pub /: *mut *mut u8 op_mode; / real work media mode,
    pub phy_addr: u8,
    pub /: *mut *mut u8 wait_reset; / Hardware failed, need to reset,
    pub /: *mut *mut u8 dm910x_chk_mode; / Operating mode check,
    pub /: *mut *mut u8 first_in_callback; / Flag to record state,
    pub /: *mut *mut u8 wol_mode; / user WOL settings,
    pub timer: timer_list,
// Driver defined statistic counter
    pub tx_fifo_underrun: c_ulong,
    pub tx_loss_carrier: c_ulong,
    pub tx_no_carrier: c_ulong,
    pub tx_late_collision: c_ulong,
    pub tx_excessive_collision: c_ulong,
    pub tx_jabber_timeout: c_ulong,
    pub reset_count: c_ulong,
    pub reset_cr8: c_ulong,
    pub reset_fatal: c_ulong,
    pub reset_TXtimeout: c_ulong,
// NIC SROM data
    pub srom: [c_uchar; 128],
}
...
// Global variable declaration -----------------------------
    ...
    let mut dmfe_media_mode: static unsigned char = DMFE_AUTO;
    static u32 dmfe_cr6_user_set;
// For module input parameter
    static int debug;
    static u32 cr6set;
    let mut mode: static unsigned char = 8;
    let mut chkmode: static u8 = 1;
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_init_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
//
    ...
    if (dp && of_get_property(dp, "local-mac-address", core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn dmfe_remove_one(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_open(dev: *mut net_device) -> c_int {
    static int dmfe_open(struct net_device *dev)
    {
    struct dmfe_board_info *db = netdev_priv(dev);
    let mut irq: c_int = db.pdev.irq;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_init_dm910x(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_stop(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn poll_dmfe(dev: *mut net_device) {
    static void poll_dmfe (struct net_device *dev)
    {
    struct dmfe_board_info *db = netdev_priv(dev);
    let mut irq: c_int = db.pdev.irq;
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_free_tx_pkt(dev: *mut net_device, db: *mut dmfe_board_info) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cal_CRC(Data: *mut *mut c_uchar, Len: c_uint, flag: u8) -> u32 {
    static inline u32 cal_CRC(unsigned char * Data, unsigned int Len, u8 flag)
    {
    let mut crc: u32 = crc32(~0, Data, Len);
    if (flag) crc = ~crc;
    return crc;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_rx_packet(dev: *mut net_device, db: *mut dmfe_board_info) {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_set_filter_mode(dev: *mut net_device) {
    static void dmfe_set_filter_mode(struct net_device *dev)
    {
    struct dmfe_board_info *db = netdev_priv(dev);
    unsigned long flags;
    let mut mc_count: c_int = netdev_mc_count(dev);
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_timer(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_dynamic_reset(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_free_rxbuffer(db: *mut *mut dmfe_board_info) {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_reuse_skb(db: *mut dmfe_board_info, skb: *mut *mut sk_buff) {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_descriptor_init(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn update_cr6(cr6_data: u32, ioaddr: *mut void __iomem) {
...
//
#[no_mangle]
unsafe extern "C" fn dm9132_id_table(dev: *mut net_device) {
...
// the multicast address in Hash Table : 64 bits
    ...
    let mut hash_val: u32 = cal_CRC((char *)ha.addr, 6, 0) & 0x3f;
...
//
#[no_mangle]
unsafe extern "C" fn send_filter_frame(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn allocate_rx_buffer(dev: *mut net_device) {
    ...
    if ( ( skb = netdev_alloc_skb(dev, RX_ALLOC_SIZE) ) == core::ptr::null_mut() )
    break;
...
#[no_mangle]
unsafe extern "C" fn srom_clk_write(ioaddr: *mut void __iomem, data: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn read_srom_word(ioaddr: *mut void __iomem, offset: c_int) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_sense_speed(db: *mut dmfe_board_info) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_set_phyxcer(db: *mut dmfe_board_info) {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_process_mode(db: *mut dmfe_board_info) {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_phy_read(ioaddr: *mut void __iomem, phy_addr: u8, offset: u8, chip_id: u32) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_phy_write_1bit(ioaddr: *mut void __iomem, phy_data: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_phy_read_1bit(ioaddr: *mut void __iomem) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_parse_srom(db: *mut *mut dmfe_board_info) {
    static void dmfe_parse_srom(struct dmfe_board_info * db)
    {
    let mut srom: *mut c_char = db.srom;
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_program_DM9801(db: *mut *mut dmfe_board_info, HPNA_rev: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_program_DM9802(db: *mut *mut dmfe_board_info) {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_HPNA_remote_cmd_chk(db: *mut *mut dmfe_board_info) {
...
#[no_mangle]
unsafe extern "C" fn dmfe_suspend(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn dmfe_resume(dev_d: *mut device) -> int __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_init_module() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn dmfe_cleanup_module() -> void __exit {
