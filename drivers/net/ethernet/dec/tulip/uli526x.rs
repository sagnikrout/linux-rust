...
//! Source: drivers/net/ethernet/dec/tulip/uli526x.c
#![no_std]
...
pub const PCI_ULI5261_ID: c_uint = 0x526110B9	/* ULi M5261 ID*/;
pub const PCI_ULI5263_ID: c_uint = 0x526310B9	/* ULi M5263 ID*/;
pub const ULI526X_IO_SIZE: c_uint = 0x100;
pub const TX_DESC_CNT: c_uint = 0x20            /* Allocated Tx descriptors */;
pub const RX_DESC_CNT: c_uint = 0x30            /* Allocated Rx descriptors */;

pub const TX_BUF_ALLOC: c_uint = 0x600;
pub const RX_ALLOC_SIZE: c_uint = 0x620;
pub const ULI526X_RESET: c_int = 1;
pub const CR0_DEFAULT: c_int = 0;
pub const CR6_DEFAULT: c_uint = 0x22200000;
...
pub const ULI5261_MAX_MULTICAST: c_int = 14;
pub const RX_COPY_SIZE: c_int = 100;
pub const MAX_CHECK_PACKET: c_uint = 0x8000;
pub const ULI526X_10MHF: c_int = 0;
pub const ULI526X_100MHF: c_int = 1;
pub const ULI526X_10MFD: c_int = 4;
pub const ULI526X_100MFD: c_int = 5;
pub const ULI526X_AUTO: c_int = 8;
pub const ULI526X_TXTH_72: c_uint = 0x400000	/* TX TH 72 byte */;
pub const ULI526X_TXTH_96: c_uint = 0x404000	/* TX TH 96 byte */;
pub const ULI526X_TXTH_128: c_uint = 0x0000		/* TX TH 128 byte */;
pub const ULI526X_TXTH_256: c_uint = 0x4000		/* TX TH 256 byte */;
pub const ULI526X_TXTH_512: c_uint = 0x8000		/* TX TH 512 byte */;
pub const ULI526X_TXTH_1K: c_uint = 0xC000		/* TX TH 1K  byte */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uli526x_board_info {
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uli_phy_ops {
    pub u16): *mut *mut *mut void (write)(struct uli526x_board_info , u8, u8,,
    pub u8): *mut *mut *mut u16 (read)(struct uli526x_board_info , u8,,
    pub phy: },
...
// descriptor pointer
    ...
    pub phy_addr: u8,
    pub /: *mut *mut u8 link_failed; / Ever link failed,
...
// Global variable declaration -----------------------------
    ...
    let mut uli526x_media_mode: static unsigned char = ULI526X_AUTO;
    static u32 uli526x_cr6_user_set;
// For module input parameter
    static int debug;
    static u32 cr6set;
    let mut mode: static int = 8;
...
#[no_mangle]
unsafe extern "C" fn srom_clk_write(db: *mut uli526x_board_info, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn uli526x_remove_one(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_open(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_init(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_stop(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn uli526x_poll(dev: *mut net_device) {
    static void uli526x_poll(struct net_device *dev)
    {
    struct uli526x_board_info *db = netdev_priv(dev);
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_rx_packet(dev: *mut net_device, db: *mut *mut uli526x_board_info) {
...
// Shorst packet used new SKB
    ...
    (((new_skb = netdev_alloc_skb(dev, rxlen + 2)) != core::ptr::null_mut()))) {
    skb = new_skb;
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_set_filter_mode(dev: *mut *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn uli526x_get_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_timer(t: *mut timer_list) {
    static void uli526x_timer(struct timer_list *t)
    {
...
#[no_mangle]
pub unsafe extern "C" fn if(db->link_failed: !(tmp_cr12 & 0x3) &&) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_reset_prepare(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_dynamic_reset(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_suspend(dev_d: *mut device) -> int __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_resume(dev_d: *mut device) -> int __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_free_rxbuffer(db: *mut *mut uli526x_board_info) {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_reuse_skb(db: *mut uli526x_board_info, skb: *mut *mut sk_buff) {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_descriptor_init(dev: *mut net_device, ioaddr: *mut void __iomem) {
...
pub const FLT_SHIFT: c_int = 16;

pub const FLT_SHIFT: c_int = 0;

#[no_mangle]
unsafe extern "C" fn send_filter_frame(dev: *mut net_device, mc_cnt: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn read_srom_word(db: *mut uli526x_board_info, offset: c_int) -> u16 {
    static u16 read_srom_word(struct uli526x_board_info *db, int offset)
    {
    void __iomem *ioaddr = db.ioaddr;
    let mut srom_data: u16 = 0;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_sense_speed(db: *mut *mut uli526x_board_info) -> u8 {
    ...
    phy_mode = 0x8000;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: phy_mode&0x4000) -> else {
    else if(phy_mode&0x4000)
    phy_mode = 0x4000;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: phy_mode&0x2000) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_set_phyxcer(db: *mut uli526x_board_info) {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_process_mode(db: *mut uli526x_board_info) {
...
#[no_mangle]
unsafe extern "C" fn phy_readby_cr9(db: *mut uli526x_board_info, phy_addr: u8, offset: u8) -> u16 {
...
// read 16bit data
    ...
    {
    void __iomem *ioaddr = db.ioaddr;
    let mut cr10_value: u32 = phy_addr;
...
//
#[no_mangle]
unsafe extern "C" fn phy_write_1bit(db: *mut uli526x_board_info, data: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn phy_read_1bit(db: *mut uli526x_board_info) -> u16 {
    static u16 phy_read_1bit(struct uli526x_board_info *db)
    {
    void __iomem *ioaddr = db.ioaddr;
    u16 phy_data;
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_init_module() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn uli526x_cleanup_module() -> void __exit {
