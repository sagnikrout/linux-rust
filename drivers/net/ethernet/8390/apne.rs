...
//! Source: drivers/net/ethernet/8390/apne.c
#![no_std]
...
pub const IOBASE: c_uint = 0x300;
//
    use MANUAL_CONFIG and MANUAL_OFFSET for enabling IO by hand
    you can find the values to use by looking at the cnet.device
#[no_mangle]
pub unsafe extern "C" fn example(card: the default values are for the CNET40BC) -> config file {
    config file example (the default values are for the CNET40BC card)
//
pub const MANUAL_CONFIG: c_uint = 0x20;
pub const MANUAL_OFFSET: c_uint = 0x3f8;
pub const MANUAL_HWADDR0: c_uint = 0x00;
pub const MANUAL_HWADDR1: c_uint = 0x12;
pub const MANUAL_HWADDR2: c_uint = 0x34;
pub const MANUAL_HWADDR3: c_uint = 0x56;
pub const MANUAL_HWADDR4: c_uint = 0x78;
pub const MANUAL_HWADDR5: c_uint = 0x9a;
//
...
#[no_mangle]
unsafe extern "C" fn apne_probe() -> *mut net_device  __init {
...
#[no_mangle]
unsafe extern "C" fn apne_probe1(dev: *mut net_device, ioaddr: c_int) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn apne_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t apne_interrupt(int irq, void *dev_id)
    {
...
#[no_mangle]
unsafe extern "C" fn apne_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn apne_module_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn init_pcmcia() -> c_int {
    static int init_pcmcia(void)
    {
    u_char config;
