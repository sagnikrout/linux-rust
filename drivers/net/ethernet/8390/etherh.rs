...
//! Source: drivers/net/ethernet/8390/etherh.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct etherh_priv {
    pub ioc_fast: *mut void __iomem,
    pub memc: *mut void __iomem,
    pub dma_base: *mut void __iomem,
    pub id: c_uint,
    pub ctrl_port: *mut void __iomem,
    pub ctrl: c_uchar,
    pub supported: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct etherh_data {
    pub ns8390_offset: c_ulong,
    pub dataport_offset: c_ulong,
    pub ctrlport_offset: c_ulong,
    pub ctrl_ioc: c_int,
    pub name: [c_char; 16],
    pub supported: u32,
    pub tx_start_page: c_uchar,
    pub stop_page: c_uchar,
}

    MODULE_AUTHOR("Russell King");
    MODULE_DESCRIPTION("EtherH/EtherM driver");
    MODULE_LICENSE("GPL");
pub const ETHERH500_DATAPORT: c_uint = 0x800	/* MEMC */;
pub const ETHERH500_NS8390: c_uint = 0x000	/* MEMC */;
pub const ETHERH500_CTRLPORT: c_uint = 0x800	/* IOC  */;
pub const ETHERH600_DATAPORT: c_uint = 0x040	/* MEMC */;
pub const ETHERH600_NS8390: c_uint = 0x800	/* MEMC */;
pub const ETHERH600_CTRLPORT: c_uint = 0x200	/* MEMC */;
pub const ETHERH_CP_IE: c_int = 1;
pub const ETHERH_CP_IF: c_int = 2;
pub const ETHERH_CP_HEARTBEAT: c_int = 2;
pub const ETHERH_TX_START_PAGE: c_int = 1;
pub const ETHERH_STOP_PAGE: c_int = 127;
//
// These came from CK/TEW
//
pub const ETHERM_DATAPORT: c_uint = 0x200	/* MEMC */;
pub const ETHERM_NS8390: c_uint = 0x800	/* MEMC */;
pub const ETHERM_CTRLPORT: c_uint = 0x23c	/* MEMC */;
pub const ETHERM_TX_START_PAGE: c_int = 64;
pub const ETHERM_STOP_PAGE: c_int = 127;
// ------------------------------------------------------------------------

    ((struct etherh_priv *)(((char *)netdev_priv(dev)) + sizeof(struct ei_device)))
#[no_mangle]
pub unsafe extern "C" fn etherh_set_ctrl(eh: *mut etherh_priv, mask: c_uchar) {
    static inline void etherh_set_ctrl(struct etherh_priv *eh, unsigned char mask)
    {
    let mut ctrl: c_uchar = eh.ctrl | mask;
    eh.ctrl = ctrl;
    writeb(ctrl, eh.ctrl_port);
    }
#[no_mangle]
pub unsafe extern "C" fn etherh_clr_ctrl(eh: *mut etherh_priv, mask: c_uchar) {
...
#[no_mangle]
pub unsafe extern "C" fn etherh_get_stat(eh: *mut etherh_priv) -> c_uint {
    static inline unsigned int etherh_get_stat(struct etherh_priv *eh)
    {
    return readb(eh.ctrl_port);
    }
#[no_mangle]
unsafe extern "C" fn etherh_irq_enable(ec: *mut ecard_t, irqnr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn etherh_irq_disable(ec: *mut ecard_t, irqnr: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn etherh_set_config(dev: *mut net_device, map: *mut ifmap) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn etherh_addr(addr: *mut c_char, ec: *mut expansion_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn etherm_addr(addr: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn etherh_get_drvinfo(dev: *mut net_device, info: *mut ethtool_drvinfo) {
...
#[no_mangle]
unsafe extern "C" fn etherh_get_msglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn etherh_set_msglevel(dev: *mut net_device, v: u32) {
...
#[no_mangle]
unsafe extern "C" fn etherh_remove(ec: *mut expansion_card) {
...
#[no_mangle]
unsafe extern "C" fn etherh_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn etherh_exit() -> void __exit {
