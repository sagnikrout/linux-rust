...
//! Source: drivers/net/ethernet/8390/ne2k-pci.c
#![no_std]
...
//
    ...
    long ioaddr;
    let mut flags: c_int = pci_clone_list[chip_idx].flags;
...
//
#[no_mangle]
pub unsafe extern "C" fn set_realtek_fdx(dev: *mut net_device) -> c_int {
    static inline int set_realtek_fdx(struct net_device *dev)
    {
    let mut ioaddr: c_long = dev.base_addr;
...
#[no_mangle]
pub unsafe extern "C" fn set_holtek_fdx(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ne2k_pci_set_fdx(dev: *mut net_device) -> c_int {
    static int ne2k_pci_set_fdx(struct net_device *dev)
    {
    if (ei_status.ne2k_flags & REALTEK_FDX)
    return set_realtek_fdx(dev);
#[no_mangle]
pub unsafe extern "C" fn if(HOLTEK_FDX: ei_status.ne2k_flags &) -> else {
    else if (ei_status.ne2k_flags & HOLTEK_FDX)
    return set_holtek_fdx(dev);
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn ne2k_pci_open(dev: *mut net_device) -> c_int {
    static int ne2k_pci_open(struct net_device *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn ne2k_pci_close(dev: *mut net_device) -> c_int {
    static int ne2k_pci_close(struct net_device *dev)
    {
    ei_close(dev);
...
//
#[no_mangle]
unsafe extern "C" fn ne2k_pci_reset_8390(dev: *mut net_device) {
    static void ne2k_pci_reset_8390(struct net_device *dev)
    {
    let mut reset_start_time: c_ulong = jiffies;
...
//
    ...
    struct e8390_pkt_hdr *hdr, int ring_page)
    {
    let mut nic_base: c_long = dev.base_addr;
...
// Ack intr.
    ...
    {
    let mut nic_base: c_long = NE_BASE;
...
#[no_mangle]
unsafe extern "C" fn ne2k_pci_get_msglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ne2k_pci_set_msglevel(dev: *mut net_device, v: u32) {
...
#[no_mangle]
unsafe extern "C" fn ne2k_pci_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn ne2k_pci_suspend(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn ne2k_pci_resume(dev_d: *mut device) -> int __maybe_unused {
