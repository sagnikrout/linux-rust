...
//! Source: drivers/net/ethernet/8390/xsurf100.c
#![no_std]
...
pub const XS100_IRQSTATUS_BASE: c_uint = 0x40;
pub const XS100_8390_BASE: c_uint = 0x800;
// Longword-access area. Translated to 2 16-bit access cycles by the
// X-Surf 100 FPGA
//
pub const XS100_8390_DATA32_BASE: c_uint = 0x8000;
pub const XS100_8390_DATA32_SIZE: c_uint = 0x2000;
// Sub-Areas for fast data register access; addresses relative to area begin
pub const XS100_8390_DATA_READ32_BASE: c_uint = 0x0880;
pub const XS100_8390_DATA_WRITE32_BASE: c_uint = 0x0C80;
pub const XS100_8390_DATA_AREA_SIZE: c_uint = 0x80;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xsurf100_ax_plat_data {
    pub ax: ax_plat_data,
    pub base_regs: *mut void __iomem,
    pub data_area: *mut void __iomem,
}

#[no_mangle]
unsafe extern "C" fn is_xsurf100_network_irq(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn z_memcpy_fromio32(dst: *mut c_void, src: *const void __iomem, bytes: usize) {
...
#[no_mangle]
unsafe extern "C" fn z_memcpy_toio32(dst: *mut void __iomem, src: *const c_void, bytes: usize) {
...
#[no_mangle]
unsafe extern "C" fn xs100_read(dev: *mut net_device, dst: *mut c_void, count: c_uint) {
...
// Now the normal output.
    ...
    DEFINE_RES_NAMED(IRQ_AMIGA_PORTS, 1, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn xsurf100_remove(zdev: *mut zorro_dev) {
