...
//! Source: drivers/net/ethernet/8390/mac8390.c
#![no_std]
...
pub const WD_START_PG: c_uint = 0x00	/* First page of TX buffer */;
pub const CABLETRON_RX_START_PG: c_uint = 0x00    /* First page of RX buffer */;
pub const CABLETRON_RX_STOP_PG: c_uint = 0x30    /* Last page +1 of RX ring */;
...
//
pub const DAYNA_8390_BASE: c_uint = 0x80000;
pub const DAYNA_8390_MEM: c_uint = 0x00000;
pub const CABLETRON_8390_BASE: c_uint = 0x90000;
pub const CABLETRON_8390_MEM: c_uint = 0x00000;
pub const INTERLAN_8390_BASE: c_uint = 0xE0000;
pub const INTERLAN_8390_MEM: c_uint = 0xD0000;
    enum mac8390_type {
    MAC8390_NONE = -1,
    MAC8390_APPLE,
    MAC8390_ASANTE,
...
#[no_mangle]
unsafe extern "C" fn mac8390_ident(fres: *mut nubus_rsrc) -> enum mac8390_type {
...
#[no_mangle]
unsafe extern "C" fn mac8390_testio(membase: c_ulong) -> enum mac8390_access {
    static enum mac8390_access mac8390_testio(unsigned long membase)
    {
    let mut outdata: u32 = 0xA5A0B5B0;
...
#[no_mangle]
unsafe extern "C" fn mac8390_memsize(membase: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac8390_device_probe(board: *mut nubus_board) -> c_int {
    static int mac8390_device_probe(struct nubus_board *board)
    {
    struct net_device *dev;
    let mut err: c_int = -ENODEV;
    struct nubus_rsrc *fres;
    let mut cardtype: enum mac8390_type = MAC8390_NONE;
...
#[no_mangle]
unsafe extern "C" fn mac8390_device_remove(board: *mut nubus_board) {
    ...
    MODULE_LICENSE("GPL");
#[no_mangle]
unsafe extern "C" fn mac8390_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mac8390_exit() -> void __exit {
    ...
    let mut access_bitmode: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn mac8390_open(dev: *mut net_device) -> c_int {
    static int mac8390_open(struct net_device *dev)
    {
    int err;
    __ei_open(dev);
...
#[no_mangle]
unsafe extern "C" fn mac8390_close(dev: *mut net_device) -> c_int {
    static int mac8390_close(struct net_device *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn mac8390_no_reset(dev: *mut net_device) {
    static void mac8390_no_reset(struct net_device *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn interlan_reset(dev: *mut net_device) {
    static void interlan_reset(struct net_device *dev)
    {
...
// sane block input/output
    ...
    struct e8390_pkt_hdr *hdr, int ring_page)
    {
    let mut hdr_start: c_ulong = (ring_page - WD_START_PG)<<8;
...
// Fix endianness
    ...
    struct sk_buff *skb, int ring_offset)
    {
    let mut xfer_base: c_ulong = ring_offset - (WD_START_PG<<8);
    let mut xfer_start: c_ulong = xfer_base + dev.mem_start;
    if (xfer_start + count > ei_status.rmem_end) {
// We must wrap the input move.
    let mut semi_count: c_int = ei_status.rmem_end - xfer_start;
    ...
    const unsigned char *buf, int start_page)
    {
    let mut shmem: c_long = (start_page - WD_START_PG)<<8;
...
#[no_mangle]
unsafe extern "C" fn word_memcpy_tocard(tp: c_ulong, fp: *const c_void, count: c_int) {
    static void word_memcpy_tocard(unsigned long tp, const void *fp, int count)
    {
...
#[no_mangle]
unsafe extern "C" fn word_memcpy_fromcard(tp: *mut c_void, fp: c_ulong, count: c_int) {
    static void word_memcpy_fromcard(void *tp, unsigned long fp, int count)
    {
