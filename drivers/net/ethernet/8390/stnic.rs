...
//! Source: drivers/net/ethernet/8390/stnic.c
#![no_std]
...
pub const STNIC_RUN: c_uint = 0x01	/* 1 == Run, 0 == reset. */;
...
#[no_mangle]
unsafe extern "C" fn stnic_probe() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn stnic_cleanup() -> void __exit {
