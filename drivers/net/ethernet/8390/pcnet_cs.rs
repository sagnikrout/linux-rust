...
//! Source: drivers/net/ethernet/8390/pcnet_cs.c
#![no_std]
...
pub const PCNET_CMD: c_uint = 0x00;
pub const PCNET_DATAPORT: c_uint = 0x10	/* NatSemi-defined port window offset. */;
pub const PCNET_RESET: c_uint = 0x1f	/* Issue a read to reset, a write to clear. */;
pub const PCNET_MISC: c_uint = 0x18	/* For IBM CCAE and Socket EA cards */;
pub const PCNET_START_PG: c_uint = 0x40	/* First page of TX buffer */;
pub const PCNET_STOP_PG: c_uint = 0x80	/* Last page +1 of RX ring */;
// Socket EA cards have a larger packet buffer
pub const SOCKET_START_PG: c_uint = 0x01;
pub const SOCKET_STOP_PG: c_uint = 0xff;
...
// Ugh!  Let the user hardwire the hardware address for queer cards
    ...
    module_param_array(hw_addr, int, core::ptr::null_mut(), 0);
// ====================================================================
...
pub const DELAY_OUTPUT: c_uint = 0x01;
pub const HAS_MISC_REG: c_uint = 0x02;
pub const USE_BIG_BUF: c_uint = 0x04;
pub const HAS_IBM_MISC: c_uint = 0x08;
pub const IS_DL10019: c_uint = 0x10;
pub const IS_DL10022: c_uint = 0x20;
pub const HAS_MII: c_uint = 0x40;
pub const USE_SHMEM: c_uint = 0x80	/* autodetected */;
pub const AM79C9XX_HOME_PHY: c_uint = 0x00006B90  /* HomePNA PHY */;
pub const AM79C9XX_ETH_PHY: c_uint = 0x00006B70  /* 10baseT PHY */;
pub const MII_PHYID_REV_MASK: c_uint = 0xfffffff0;
pub const MII_PHYID_REG1: c_uint = 0x02;
pub const MII_PHYID_REG2: c_uint = 0x03;
    ...
    let mut default_info: static struct hw_info = { 0, 0, 0, 0, 0 };
    let mut dl10019_info: static struct hw_info = { 0, 0, 0, 0, IS_DL10019|HAS_MII };
    let mut dl10022_info: static struct hw_info = { 0, 0, 0, 0, IS_DL10022|HAS_MII };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcnet_dev {
    pub p_dev: *mut pcmcia_device,
    pub flags: u_int,
    pub base: *mut void __iomem,
    pub watchdog: timer_list,
    pub fast_poll: int stale,,
    pub phy_id: u_char,
    pub pna_phy: u_char eth_phy,,
    pub link_status: u_short,
    pub mii_reset: u_long,
}
...
#[no_mangle]
unsafe extern "C" fn pcnet_probe(link: *mut pcmcia_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcnet_detach(link: *mut pcmcia_device) {
...
// Allocate a small memory window
    ...
    return (i < NR_INFO) ? hw_info+i : core::ptr::null_mut();
    } /* get_hwinfo */
// ======================================================================
    ...
    {
    struct net_device *dev = link.priv;
    let mut ioaddr: c_uint = dev.base_addr;
    u8 addr[ETH_ALEN];
    u_char prom[32];
    int i, j;
...
#[no_mangle]
unsafe extern "C" fn try_io_port(link: *mut pcmcia_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcnet_confcheck(p_dev: *mut pcmcia_device, priv_data: *mut c_void) -> c_int {
    static int pcnet_confcheck(struct pcmcia_device *p_dev, void *priv_data)
    {
    int *priv = priv_data;
    let mut try: c_int = (*priv & 0x1);
...
#[no_mangle]
unsafe extern "C" fn pcnet_config(link: *mut pcmcia_device) -> c_int {
    static int pcnet_config(struct pcmcia_device *link)
    {
    struct net_device *dev = link.priv;
    struct pcnet_dev *info = PRIV(dev);
    int start_pg, stop_pg, cm_offset;
    let mut has_shmem: c_int = 0;
    struct hw_info *local_hw_info;
...
// check whether forcing io_lines to 16 helps...
    ...
    if (local_hw_info == core::ptr::null_mut()) {
...
// has_shmem is ignored if use_shmem != -1
    ...
    if (info.flags & (IS_DL10019|IS_DL10022)) {
    let mut id: u_char = inb(dev.base_addr + 0x1a);
...
#[no_mangle]
unsafe extern "C" fn pcnet_release(link: *mut pcmcia_device) {
    static void pcnet_release(struct pcmcia_device *link)
    {
...
#[no_mangle]
unsafe extern "C" fn pcnet_suspend(link: *mut pcmcia_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcnet_resume(link: *mut pcmcia_device) -> c_int {
...
// ======================================================================
    ...
    ======================================================================*/
pub const DLINK_GPIO: c_uint = 0x1c;
pub const DLINK_DIAG: c_uint = 0x1d;
pub const DLINK_EEPROM: c_uint = 0x1e;
pub const MDIO_SHIFT_CLK: c_uint = 0x80;
pub const MDIO_DATA_OUT: c_uint = 0x40;
pub const MDIO_DIR_WRITE: c_uint = 0x30;

pub const MDIO_DATA_READ: c_uint = 0x10;
pub const MDIO_MASK: c_uint = 0x0f;
#[no_mangle]
unsafe extern "C" fn mdio_sync(addr: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mdio_read(addr: c_uint, phy_id: c_int, loc: c_int) -> c_int {
    static int mdio_read(unsigned int addr, int phy_id, int loc)
    {
    let mut cmd: u_int = (0x06<<10)|(phy_id<<5)|loc;
    int i, retval = 0, mask = inb(addr) & MDIO_MASK;
    mdio_sync(addr);
    for (i = 13; i >= 0; i--) {
    let mut dat: c_int = (cmd&(1<<i)) ? MDIO_DATA_WRITE1 : MDIO_DATA_WRITE0;
    outb(mask | dat, addr);
...
#[no_mangle]
unsafe extern "C" fn mdio_write(addr: c_uint, phy_id: c_int, loc: c_int, value: c_int) {
    static void mdio_write(unsigned int addr, int phy_id, int loc, int value)
    {
    let mut cmd: u_int = (0x05<<28)|(phy_id<<23)|(loc<<18)|(1<<17)|value;
...
// ======================================================================
    ...
    ======================================================================*/
pub const EE_EEP: c_uint = 0x40;
pub const EE_ASIC: c_uint = 0x10;
pub const EE_CS: c_uint = 0x08;
pub const EE_CK: c_uint = 0x04;
pub const EE_DO: c_uint = 0x02;
pub const EE_DI: c_uint = 0x01;
pub const EE_ADOT: c_uint = 0x01	/* DataOut for ASIC */;
pub const EE_READ_CMD: c_uint = 0x06;
pub const DL19FDUPLX: c_uint = 0x0400	/* DL10019 Full duplex mode */;
#[no_mangle]
unsafe extern "C" fn read_eeprom(ioaddr: c_uint, location: c_int) -> c_int {
    static int read_eeprom(unsigned int ioaddr, int location)
    {
    int i, retval = 0;
    let mut ee_addr: c_uint = ioaddr + DLINK_EEPROM;
    let mut read_cmd: c_int = location | (EE_READ_CMD << 8);
    outb(0, ee_addr);
    outb(EE_EEP|EE_CS, ee_addr);
// Shift the read command bits out.
    for (i = 10; i >= 0; i--) {
    let mut dataval: c_short = (read_cmd & (1 << i)) ? EE_DO : 0;
...
//
#[no_mangle]
unsafe extern "C" fn write_asic(ioaddr: c_uint, location: c_int, asic_data: c_short) {
...
// ====================================================================
#[no_mangle]
unsafe extern "C" fn set_misc_reg(dev: *mut net_device) {
    static void set_misc_reg(struct net_device *dev)
    {
    let mut nic_base: c_uint = dev.base_addr;
    struct pcnet_dev *info = PRIV(dev);
    u_char tmp;
    if (info.flags & HAS_MISC_REG) {
...
// ====================================================================
#[no_mangle]
unsafe extern "C" fn mii_phy_probe(dev: *mut net_device) {
    static void mii_phy_probe(struct net_device *dev)
    {
    struct pcnet_dev *info = PRIV(dev);
    let mut mii_addr: c_uint = dev.base_addr + DLINK_GPIO;
    int i;
    u_int tmp, phyid;
    for (i = 31; i >= 0; i--) {
...
#[no_mangle]
unsafe extern "C" fn pcnet_open(dev: *mut net_device) -> c_int {
    static int pcnet_open(struct net_device *dev)
    {
    int ret;
    struct pcnet_dev *info = PRIV(dev);
...
// ====================================================================
#[no_mangle]
unsafe extern "C" fn pcnet_close(dev: *mut net_device) -> c_int {
    static int pcnet_close(struct net_device *dev)
    {
    struct pcnet_dev *info = PRIV(dev);
    struct pcmcia_device *link = info.p_dev;
...
// ======================================================================
    ...
    ======================================================================*/
#[no_mangle]
unsafe extern "C" fn pcnet_reset_8390(dev: *mut net_device) {
    static void pcnet_reset_8390(struct net_device *dev)
    {
    let mut nic_base: c_uint = dev.base_addr;
    int i;
...
// ====================================================================
#[no_mangle]
unsafe extern "C" fn set_config(dev: *mut net_device, map: *mut ifmap) -> c_int {
    static int set_config(struct net_device *dev, struct ifmap *map)
    {
    struct pcnet_dev *info = PRIV(dev);
    ...
    return -EOPNOTSUPP;
#[no_mangle]
pub unsafe extern "C" fn if(2): (map->port < 1) || (map->port >) -> else {
...
// ====================================================================
#[no_mangle]
unsafe extern "C" fn ei_irq_wrapper(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t ei_irq_wrapper(int irq, void *dev_id)
    {
    struct net_device *dev = dev_id;
    struct pcnet_dev *info;
    let mut ret: irqreturn_t = ei_interrupt(irq, dev_id);
    if (ret == IRQ_HANDLED) {
    info = PRIV(dev);
    info.stale = 0;
    }
...
#[no_mangle]
unsafe extern "C" fn ei_watchdog(t: *mut timer_list) {
    static void ei_watchdog(struct timer_list *t)
    {
    struct pcnet_dev *info = timer_container_of(info, t, watchdog);
    struct net_device *dev = info.p_dev.priv;
    let mut nic_base: c_uint = dev.base_addr;
    let mut mii_addr: c_uint = nic_base + DLINK_GPIO;
    u_short link;
...
// Check for pending interrupt with expired latency timer: with
    ...
    let mut p: u_short = mdio_read(mii_addr, info.phy_id, 5);
...
// ====================================================================
#[no_mangle]
unsafe extern "C" fn ei_ioctl(dev: *mut net_device, rq: *mut ifreq, cmd: c_int) -> c_int {
    static int ei_ioctl(struct net_device *dev, struct ifreq *rq, int cmd)
    {
    struct pcnet_dev *info = PRIV(dev);
...
// ====================================================================
    ...
    {
    let mut nic_base: c_uint = dev.base_addr;
    let mut xfer_count: c_int = count;
    char *buf = skb.data;
...
// DON'T check for 'inb_p(EN0_ISR) & ENISR_RDC' here
    ...
    let mut high: c_int = inb_p(nic_base + EN0_RSARHI);
    let mut low: c_int = inb_p(nic_base + EN0_RSARLO);
    addr = (high << 8) + low;
...
// ====================================================================
#[no_mangle]
unsafe extern "C" fn copyin(dest: *mut c_void, src: *mut void __iomem, c: c_int) {
...
#[no_mangle]
unsafe extern "C" fn copyout(dest: *mut void __iomem, src: *const c_void, c: c_int) {
...
// We must wrap the input move.
    let mut semi_count: c_int = ei_status.priv - offset;
