...
#[no_mangle]
pub unsafe extern "C" fn cleanup_modue() -> last in {
...
// Macro flag: #define SUPPORT_NE_BAD_CLONES
// 0xbad = bad sig or no reset ack
pub const BAD: c_uint = 0xbad;
    ...
    module_param_array(bad, int, core::ptr::null_mut(), 0);
...
// Macro flag: #define NEEDS_PORTLIST
...
pub const NE_IO_EXTENT: c_uint = 0x20;
...
#[no_mangle]
unsafe extern "C" fn do_ne_probe(dev: *mut net_device) -> int __init {
    static int __init do_ne_probe(struct net_device *dev)
    {
    let mut base_addr: c_ulong = dev.base_addr;

    let mut orig_irq: c_int = dev.irq;

// First check any supplied i/o locations. User knows best. <cough>
    if (base_addr > 0x1ff) {	/* Check a single specified location. */
    let mut ret: c_int = ne_probe1(dev, base_addr);
    if (ret)
...
// Last resort. The semi-risky ISA auto-probe.
    ...
    let mut ioaddr: c_int = netcard_portlist[base_addr];
    dev.irq = orig_irq;
...
#[no_mangle]
unsafe extern "C" fn ne_probe_isapnp(dev: *mut net_device) -> int __init {
    static int __init ne_probe_isapnp(struct net_device *dev)
    {
    int i;
    for (i = 0; isapnp_clone_list[i].vendor != 0; i++) {
    struct pnp_dev *idev = core::ptr::null_mut();
    while ((idev = pnp_find_dev(core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn ne_probe1(dev: *mut net_device, ioaddr: c_ulong) -> int __init {
    static int __init ne_probe1(struct net_device *dev, unsigned long ioaddr)
    {
    int i;
    unsigned char SA_prom[32];
    let mut wordlength: c_int = 2;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ctron) -> else {
    else if (ctron)
    {
...
// Ack!  Well, there might be a *bad* NE*000 clone there.
    ...
    if (bad_clone_list[i].name8 == core::ptr::null_mut())
    {
    ...
    if (dev.irq < 2)
    {
    let mut cookie: c_ulong = probe_irq_on();
...
#[no_mangle]
unsafe extern "C" fn ne_reset_8390(dev: *mut net_device) {
    static void ne_reset_8390(struct net_device *dev)
    {
    let mut reset_start_time: c_ulong = jiffies;
    struct ei_device *ei_local = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn ne_get_8390_hdr(dev: *mut net_device, hdr: *mut e8390_pkt_hdr, ring_page: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ne_block_input(dev: *mut net_device, count: c_int, skb: *mut sk_buff, ring_offset: c_int) {
...
// DON'T check for 'inb_p(EN0_ISR) & ENISR_RDC' here
    ...
    const unsigned char *buf, const int start_page)
    {
    let mut nic_base: c_int = NE_BASE;
...
#[no_mangle]
unsafe extern "C" fn ne_drv_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ne_drv_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ne_loop_rm_unreg(all: c_int) {
...
// No network device == unused
    ...
    pdev_ne[this_dev] = core::ptr::null_mut();
    }
    }
    }

#[no_mangle]
unsafe extern "C" fn ne_drv_suspend(pdev: *mut platform_device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ne_drv_resume(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ne_add_devices() -> void __init {
    ...
    DRV_NAME, this_dev, core::ptr::null_mut(), 0);
    if (IS_ERR(pdev))
    continue;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct netdev_boot_setup {
    pub name: [c_char; IFNAMSIZ],
    pub map: ifmap,
}

pub const NETDEV_BOOT_SETUP_MAX: c_int = 8;
...
//
#[no_mangle]
unsafe extern "C" fn netdev_boot_setup_check(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ne_probe(unit: c_int) -> *mut net_device  __init {
...
//
#[no_mangle]
unsafe extern "C" fn netdev_boot_base(prefix: *const c_char, unit: c_int) -> c_ulong {
...
//
#[no_mangle]
unsafe extern "C" fn netdev_boot_setup_add(name: *mut c_char, map: *mut ifmap) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn netdev_boot_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ether_boot_setup(str: *mut c_char) -> int __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct devprobe2 {
    pub unit): *mut *mut *mut net_device (probe)(int,
    pub /: *mut *mut int status; / non-zero if autoprobe has failed,
}

#[no_mangle]
unsafe extern "C" fn probe_list2(unit: c_int, p: *mut devprobe2, autoprobe: c_int) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn ethif_probe2(unit: c_int) -> void __init {
    static void __init ethif_probe2(int unit)
    {
    let mut base_addr: c_ulong = netdev_boot_base("eth", unit);
    if (base_addr == 1)
    return;
...
#[no_mangle]
unsafe extern "C" fn net_olddevs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ne_init() -> int __init {
...
// Unregister unused platform_devices.
    ...
    module_init(ne_init);
#[no_mangle]
unsafe extern "C" fn ne_exit() -> void __exit {
