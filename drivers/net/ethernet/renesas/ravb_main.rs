...
//! Source: drivers/net/ethernet/renesas/ravb_main.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ravb_wait(ndev: *mut net_device, reg: enum ravb_reg, mask: u32, value: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_set_opmode(ndev: *mut net_device, opmode: u32) -> c_int {
    static int ravb_set_opmode(struct net_device *ndev, u32 opmode)
    {
    let mut csr_ops: u32 = 1U << (opmode & CCC_OPC);
    let mut ccc_mask: u32 = CCC_OPC;
    int error;
...
#[no_mangle]
unsafe extern "C" fn ravb_set_rate_gbeth(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ravb_set_rate_rcar(ndev: *mut net_device) {
...
//
    ...
    if (ret) {
    let mut mahr: u32 = ravb_read(ndev, MAHR);
    let mut malr: u32 = ravb_read(ndev, MALR);
    u8 addr[ETH_ALEN];
    addr[0] = (mahr >> 24) & 0xFF;
    addr[1] = (mahr >> 16) & 0xFF;
    addr[2] = (mahr >>  8) & 0xFF;
...
#[no_mangle]
unsafe extern "C" fn ravb_mdio_ctrl(ctrl: *mut mdiobb_ctrl, mask: u32, set: c_int) {
...
// MDC pin control
#[no_mangle]
unsafe extern "C" fn ravb_set_mdc(ctrl: *mut mdiobb_ctrl, level: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ravb_set_mdio_dir(ctrl: *mut mdiobb_ctrl, output: c_int) {
...
// Set data bit
#[no_mangle]
unsafe extern "C" fn ravb_set_mdio_data(ctrl: *mut mdiobb_ctrl, value: c_int) {
...
// Get data bit
#[no_mangle]
unsafe extern "C" fn ravb_get_mdio_data(ctrl: *mut mdiobb_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_tx_free(ndev: *mut net_device, q: c_int, free_txed_only: bool) -> c_int {
    static int ravb_tx_free(struct net_device *ndev, int q, bool free_txed_only)
    {
    struct ravb_private *priv = netdev_priv(ndev);
    struct net_device_stats *stats = &priv.stats[q];
    let mut num_tx_desc: c_uint = priv.num_tx_desc;
    struct ravb_tx_desc *desc;
    unsigned int entry;
    let mut free_num: c_int = 0;
    u32 size;
...
// Last packet descriptor?
    ...
    priv.tx_skb[q][entry] = core::ptr::null_mut();
    if (txed)
    stats.tx_packets++;
    }
    free_num++;
...
#[no_mangle]
unsafe extern "C" fn ravb_rx_ring_free(ndev: *mut net_device, q: c_int) {
    ...
    priv.rx_desc_dma[q]);
    priv.rx_ring[q].raw = core::ptr::null_mut();
    }
// Free skb's and DMA buffers for Ethernet AVB
#[no_mangle]
unsafe extern "C" fn ravb_ring_free(ndev: *mut net_device, q: c_int) {
    ...
    priv.tx_desc_dma[q]);
    priv.tx_ring[q] = core::ptr::null_mut();
    }
// Free RX buffers
    ...
    priv.rx_buffers[q] = core::ptr::null_mut();
    page_pool_destroy(priv.rx_pool[q]);
// Free aligned TX buffers
    kfree(priv.tx_align[q]);
    priv.tx_align[q] = core::ptr::null_mut();
// Free TX skb ringbuffer.
// SKBs are freed by ravb_tx_free() call above.
//
    kfree(priv.tx_skb[q]);
    priv.tx_skb[q] = core::ptr::null_mut();
    }
    static int
...
#[no_mangle]
unsafe extern "C" fn ravb_ring_format(ndev: *mut net_device, q: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ravb_ring_init(ndev: *mut net_device, q: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_csum_init_gbeth(ndev: *mut net_device) {
    static void ravb_csum_init_gbeth(struct net_device *ndev)
    {
    let mut tx_enable: bool = ndev.features & NETIF_F_HW_CSUM;
    let mut rx_enable: bool = ndev.features & NETIF_F_RXCSUM;
...
#[no_mangle]
unsafe extern "C" fn ravb_emac_init_gbeth(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ravb_emac_init_rcar(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ravb_emac_init_rcar_gen4(ndev: *mut net_device) {
    static void ravb_emac_init_rcar_gen4(struct net_device *ndev)
    {
    struct ravb_private *priv = netdev_priv(ndev);
    let mut mii: bool = priv.phy_interface == PHY_INTERFACE_MODE_MII;
    ravb_modify(ndev, APSR, APSR_MIISELECT, mii ? APSR_MIISELECT : 0);
    ravb_emac_init_rcar(ndev);
    }
// E-MAC init function
#[no_mangle]
unsafe extern "C" fn ravb_emac_init(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ravb_dmac_init_gbeth(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_dmac_init_rcar(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_dmac_init(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_get_tx_tstamp(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ravb_rx_csum_gbeth(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn ravb_rx_csum(skb: *mut sk_buff) {
...
//
    ...
    skb.csum = csum_unfold(( __sum16)get_unaligned_le16(hw_csum));
    skb.ip_summed = CHECKSUM_COMPLETE;
    skb_trim(skb, skb.len - sizeof(__sum16));
    }
// Packet receive function for Gigabit Ethernet
#[no_mangle]
unsafe extern "C" fn ravb_rx_gbeth(ndev: *mut net_device, budget: c_int, q: c_int) -> c_int {
...
// non-NULL when valid.
//
    priv.rx_1st_skb = core::ptr::null_mut();
    }
// Mark this RX buffer as consumed.
    rx_buff.page = core::ptr::null_mut();
    }
    }
    refill:
...
#[no_mangle]
unsafe extern "C" fn ravb_rx_rcar(ndev: *mut net_device, budget: c_int, q: c_int) -> c_int {
...
// Packet receive function for Ethernet AVB
#[no_mangle]
unsafe extern "C" fn ravb_rx(ndev: *mut net_device, budget: c_int, q: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_rcv_snd_disable(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ravb_rcv_snd_enable(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ravb_stop_dma(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_emac_interrupt_unlocked(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ravb_emac_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t ravb_emac_interrupt(int irq, void *dev_id)
    {
    struct net_device *ndev = dev_id;
    struct ravb_private *priv = netdev_priv(ndev);
    struct device *dev = &priv.pdev.dev;
    let mut result: irqreturn_t = IRQ_HANDLED;
...
#[no_mangle]
unsafe extern "C" fn ravb_error_interrupt(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ravb_queue_interrupt(ndev: *mut net_device, q: c_int) -> bool {
    static bool ravb_queue_interrupt(struct net_device *ndev, int q)
    {
    struct ravb_private *priv = netdev_priv(ndev);
    const struct ravb_hw_info *info = priv.info;
    let mut ris0: u32 = ravb_read(ndev, RIS0);
    let mut ric0: u32 = ravb_read(ndev, RIC0);
    let mut tis: u32 = ravb_read(ndev, TIS);
    let mut tic: u32 = ravb_read(ndev, TIC);
...
#[no_mangle]
unsafe extern "C" fn ravb_timestamp_interrupt(ndev: *mut net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ravb_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ravb_multi_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ravb_dma_interrupt(irq: c_int, dev_id: *mut c_void, q: c_int) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ravb_be_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t ravb_be_interrupt(int irq, void *dev_id)
    {
    return ravb_dma_interrupt(irq, dev_id, RAVB_BE);
    }
#[no_mangle]
unsafe extern "C" fn ravb_nc_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t ravb_nc_interrupt(int irq, void *dev_id)
    {
    return ravb_dma_interrupt(irq, dev_id, RAVB_NC);
    }
#[no_mangle]
unsafe extern "C" fn ravb_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
    ...
    const struct ravb_hw_info *info = priv.info;
    unsigned long flags;
    let mut q: c_int = napi - priv.napi;
    let mut mask: c_int = BIT(q);
    int work_done;
...
#[no_mangle]
unsafe extern "C" fn ravb_set_duplex_gbeth(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ravb_adjust_link(ndev: *mut net_device) {
...
// PHY init function
#[no_mangle]
unsafe extern "C" fn ravb_phy_init(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_phy_start(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_get_msglevel(ndev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ravb_set_msglevel(ndev: *mut net_device, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn ravb_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_get_strings(ndev: *mut net_device, stringset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn ravb_get_wol(ndev: *mut net_device, wol: *mut ethtool_wolinfo) {
...
#[no_mangle]
unsafe extern "C" fn ravb_set_wol(ndev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_set_config_mode(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_set_gti(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ravb_compute_gti(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_parse_delay_mode(np: *mut device_node, ndev: *mut net_device) {
    static void ravb_parse_delay_mode(struct device_node *np, struct net_device *ndev)
    {
    struct ravb_private *priv = netdev_priv(ndev);
    let mut explicit_delay: bool = false;
    u32 delay;
...
#[no_mangle]
unsafe extern "C" fn ravb_set_delay_mode(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ravb_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_tx_timeout(ndev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ravb_tx_timeout_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ravb_can_tx_csum_gbeth(skb: *mut sk_buff) -> bool {
    static bool ravb_can_tx_csum_gbeth(struct sk_buff *skb)
    {
    let mut net_protocol: u16 = ntohs(skb.protocol);
    u8 inner_protocol;
...
#[no_mangle]
unsafe extern "C" fn ravb_start_xmit(skb: *mut sk_buff, ndev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t ravb_start_xmit(struct sk_buff *skb, struct net_device *ndev)
    {
    struct ravb_private *priv = netdev_priv(ndev);
    const struct ravb_hw_info *info = priv.info;
    let mut num_tx_desc: c_uint = priv.num_tx_desc;
    let mut q: u16 = skb_get_queue_mapping(skb);
...
//
    ...
    drop:
    dev_kfree_skb_any(skb);
    priv.tx_skb[q][entry / num_tx_desc] = core::ptr::null_mut();
    goto exit;
    }
...
#[no_mangle]
unsafe extern "C" fn ravb_set_rx_mode(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ravb_close(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_change_mtu(ndev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_set_rx_csum(ndev: *mut net_device, enable: bool) {
...
// Enable TX and RX
    ...
    u32 val, u32 mask)
    {
    let mut csr0: u32 = CSR0_TPE | CSR0_RPE;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ravb_mdio_init(priv: *mut ravb_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_mdio_release(priv: *mut ravb_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_setup_irqs(priv: *mut ravb_private) -> c_int {
    ...
    int error;
    if (!info.multi_irqs)
    return ravb_setup_irq(priv, core::ptr::null_mut(), core::ptr::null_mut(), &ndev.irq, ravb_interrupt);
    ...
    error = ravb_setup_irq(priv, "ch0", "ch0:rx_be", core::ptr::null_mut(), ravb_be_interrupt);
    if (error)
    return error;
    error = ravb_setup_irq(priv, "ch1", "ch1:rx_nc", core::ptr::null_mut(), ravb_nc_interrupt);
    if (error)
    return error;
    error = ravb_setup_irq(priv, "ch18", "ch18:tx_be", core::ptr::null_mut(), ravb_be_interrupt);
    if (error)
    return error;
    return ravb_setup_irq(priv, "ch19", "ch19:tx_nc", core::ptr::null_mut(), ravb_nc_interrupt);
    }
#[no_mangle]
unsafe extern "C" fn ravb_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ravb_wol_setup(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_wol_restore(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ravb_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(ravb_runtime_suspend, ravb_runtime_resume, core::ptr::null_mut())
    };
