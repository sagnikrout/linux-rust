...
//! Source: drivers/net/ethernet/renesas/rswitch_main.c
#![no_std]
...
pub const RSWITCH_GPTP_OFFSET_S4: c_uint = 0x00018000;
#[no_mangle]
unsafe extern "C" fn rswitch_reg_wait(addr: *mut void __iomem, offs: u32, mask: u32, expected: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rswitch_modify(addr: *mut void __iomem, reg: enum rswitch_reg, clear: u32, set: u32) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_reset(priv: *mut rswitch_private) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_clock_enable(priv: *mut rswitch_private) {
    static void rswitch_clock_enable(struct rswitch_private *priv)
    {
    iowrite32(RCEC_ACE_DEFAULT | RCEC_RCE, priv.addr + RCEC);
    }
#[no_mangle]
unsafe extern "C" fn rswitch_clock_disable(priv: *mut rswitch_private) {
    ...
    unsigned int port)
    {
    let mut val: u32 = ioread32(coma_addr + RCEC);
    if (val & RCEC_RCE)
...
#[no_mangle]
unsafe extern "C" fn rswitch_bpool_config(priv: *mut rswitch_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_coma_init(priv: *mut rswitch_private) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_top_init(priv: *mut rswitch_private) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_fwd_init(priv: *mut rswitch_private) -> c_int {
    static int rswitch_fwd_init(struct rswitch_private *priv)
    {
    let mut all_ports_mask: u32 = GENMASK(RSWITCH_NUM_AGENTS - 1, 0);
    unsigned int i;
    u32 reg_val;
...
#[no_mangle]
unsafe extern "C" fn rswitch_gwca_mcast_table_reset(priv: *mut rswitch_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_gwca_axi_ram_reset(priv: *mut rswitch_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_is_any_data_irq(priv: *mut rswitch_private, dis: *mut u32, tx: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rswitch_get_data_irq_status(priv: *mut rswitch_private, dis: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_get_num_cur_queues(gq: *mut rswitch_gwca_queue) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rswitch_is_queue_rxed(gq: *mut rswitch_gwca_queue) -> bool {
    ...
    gq.rx_bufs[index] = core::ptr::null_mut();
    }
    return -ENOMEM;
    }
    ...
    gq.rx_ring = core::ptr::null_mut();
    for (i = 0; i < gq.ring_size; i++)
    skb_free_frag(gq.rx_bufs[i]);
    kfree(gq.rx_bufs);
    gq.rx_bufs = core::ptr::null_mut();
    } else {
    dma_free_coherent(ndev.dev.parent,
    sizeof(struct rswitch_ext_desc) *
    (gq.ring_size + 1), gq.tx_ring, gq.ring_dma);
    gq.tx_ring = core::ptr::null_mut();
    kfree(gq.skbs);
    gq.skbs = core::ptr::null_mut();
    kfree(gq.unmap_addrs);
    gq.unmap_addrs = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn rswitch_gwca_ts_queue_free(priv: *mut rswitch_private) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_desc_set_dptr(desc: *mut rswitch_desc, addr: dma_addr_t) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_desc_get_dptr(desc: *const rswitch_desc) -> dma_addr_t {
    ...
    struct rswitch_gwca_queue *gq)
    {
    let mut ring_size: c_uint = sizeof(struct rswitch_ext_desc) * gq.ring_size;
    ...
    struct rswitch_gwca_queue *gq)
    {
    let mut ring_size: c_uint = sizeof(struct rswitch_ext_ts_desc) * gq.ring_size;
    struct rswitch_ext_ts_desc *desc;
    struct rswitch_desc *linkfix;
    int err;
...
#[no_mangle]
unsafe extern "C" fn rswitch_gwca_linkfix_alloc(priv: *mut rswitch_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_gwca_linkfix_free(priv: *mut rswitch_private) {
    ...
    gwca.linkfix_table = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn rswitch_gwca_ts_queue_alloc(priv: *mut rswitch_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_txdmac_alloc(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_txdmac_free(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_txdmac_init(priv: *mut rswitch_private, index: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_rxdmac_alloc(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_rxdmac_free(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_rxdmac_init(priv: *mut rswitch_private, index: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_gwca_hw_init(priv: *mut rswitch_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_gwca_hw_deinit(priv: *mut rswitch_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_gwca_halt(priv: *mut rswitch_private) -> c_int {
    ...
    struct rswitch_ext_ts_desc *desc)
    {
    let mut dma_addr: dma_addr_t = rswitch_desc_get_dptr(&desc.desc);
    let mut pkt_len: u16 = le16_to_cpu(desc.desc.info_ds) & RX_DS;
    let mut die_dt: u8 = desc.desc.die_dt & DT_MASK;
...
// Check whether the descriptor is unexpected order
    ...
    gq.skb_fstart = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rswitch_rx(ndev: *mut net_device, quota: *mut c_int) -> bool {
    ...
    out:
    gq.rx_bufs[gq.cur] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rswitch_tx_free(ndev: *mut net_device) {
    ...
    gq.skbs[gq.dirty] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn rswitch_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
    ...
    goto out;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rdev->priv->gwca_halt) -> else {
    else if (rdev.priv.gwca_halt)
    goto err;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rswitch_is_queue_rxed(rdev->rx_queue)) -> else {
...
#[no_mangle]
unsafe extern "C" fn rswitch_queue_interrupt(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_data_irq(priv: *mut rswitch_private, dis: *mut u32) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rswitch_gwca_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rswitch_gwca_request_irqs(priv: *mut rswitch_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_ts(priv: *mut rswitch_private) {
    ...
    goto next;
    ts_skb = xchg(&rdev.ts_skb[tag], core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rswitch_gwca_ts_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rswitch_gwca_ts_request_irqs(priv: *mut rswitch_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_etha_read_mac_address(etha: *mut rswitch_etha) {
    static void rswitch_etha_read_mac_address(struct rswitch_etha *etha)
    {
    let mut mrmac0: u32 = ioread32(etha.addr + MRMAC0);
    let mut mrmac1: u32 = ioread32(etha.addr + MRMAC1);
...
#[no_mangle]
unsafe extern "C" fn rswitch_etha_write_mac_address(etha: *mut rswitch_etha, mac: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_etha_wait_link_verification(etha: *mut rswitch_etha) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_rmac_setting(etha: *mut rswitch_etha, mac: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_etha_enable_mii(etha: *mut rswitch_etha) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_etha_hw_init(etha: *mut rswitch_etha, mac: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_etha_mii_read_c22(bus: *mut mii_bus, phyad: c_int, regad: c_int) -> c_int {
...
// Call of_node_put(port) after done
    ...
    {
    struct device_node *port = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rswitch_etha_get_params(rdev: *mut rswitch_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_mii_register(rdev: *mut rswitch_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_mii_unregister(rdev: *mut rswitch_device) {
    static void rswitch_mii_unregister(struct rswitch_device *rdev)
    {
    if (rdev.etha.mii) {
    mdiobus_unregister(rdev.etha.mii);
    mdiobus_free(rdev.etha.mii);
    rdev.etha.mii = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn rswitch_adjust_link(ndev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rdev->serdes->power_count) -> else {
...
#[no_mangle]
unsafe extern "C" fn rswitch_phy_device_init(rdev: *mut rswitch_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_phy_device_deinit(rdev: *mut rswitch_device) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_serdes_set_params(rdev: *mut rswitch_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_ether_port_init_one(rdev: *mut rswitch_device) -> c_int {
    ...
    rdev.serdes = devm_of_phy_get(&rdev.priv.pdev.dev, rdev.np_port, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rswitch_ether_port_deinit_one(rdev: *mut rswitch_device) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_ether_port_init_all(priv: *mut rswitch_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_ether_port_deinit_all(priv: *mut rswitch_private) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_stop(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_ext_desc_get_die_dt(nr_desc: c_uint, index: c_uint) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rswitch_ext_desc_get_len(die_dt: u8, orig_len: c_uint) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn rswitch_start_xmit(skb: *mut sk_buff, ndev: *mut net_device) -> netdev_tx_t {
...
// DT_FSTART should be set at last. So, this is reverse order.
    ...
    return ret;
    err_unmap:
    gq.skbs[(gq.cur + nr_desc - 1) % gq.ring_size] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn is_rdev(ndev: *const net_device) -> bool {
    bool is_rdev(const struct net_device *ndev)
    {
    return (ndev.netdev_ops == &rswitch_netdev_ops);
    }
#[no_mangle]
unsafe extern "C" fn rswitch_get_ts_info(ndev: *mut net_device, info: *mut kernel_ethtool_ts_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_etha_init(priv: *mut rswitch_private, index: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_device_alloc(priv: *mut rswitch_private, index: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_device_free(priv: *mut rswitch_private, index: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rswitch_init(priv: *mut rswitch_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_eth_sw_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rswitch_deinit(priv: *mut rswitch_private) {
...
#[no_mangle]
unsafe extern "C" fn renesas_eth_sw_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn renesas_eth_sw_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_eth_sw_resume(dev: *mut device) -> c_int {
