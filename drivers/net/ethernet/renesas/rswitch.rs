...
//! Source: drivers/net/ethernet/renesas/rswitch.h
#![no_std]
...
pub const RSWITCH_MAX_NUM_QUEUES: c_int = 128;
pub const RSWITCH_NUM_AGENTS: c_int = 5;
pub const RSWITCH_NUM_PORTS: c_int = 3;

pub const TX_RING_SIZE: c_int = 1024;
pub const RX_RING_SIZE: c_int = 4096;

pub const RSWITCH_MAX_MTU: c_int = 9600;

pub const RSWITCH_DESC_BUF_SIZE: c_int = 2048;

pub const RSWITCH_ALIGN: c_int = 128;

pub const RSWITCH_MAX_CTAG_PCP: c_int = 7;
pub const RSWITCH_TIMEOUT_US: c_int = 100000;
pub const RSWITCH_TOP_OFFSET: c_uint = 0x00008000;
pub const RSWITCH_COMA_OFFSET: c_uint = 0x00009000;
pub const RSWITCH_ETHA_OFFSET: c_uint = 0x0000a000	/* with RMAC */;
pub const RSWITCH_ETHA_SIZE: c_uint = 0x00002000	/* with RMAC */;
pub const RSWITCH_GWCA0_OFFSET: c_uint = 0x00010000;
pub const RSWITCH_GWCA1_OFFSET: c_uint = 0x00012000;
// TODO: hardcoded ETHA/GWCA settings for now

pub const GWCA_NUM_IRQS: c_int = 8;
pub const GWCA_INDEX: c_int = 0;
pub const AGENT_INDEX_GWCA: c_int = 3;
pub const GWCA_IPV_NUM: c_int = 0;

pub const FWRO: c_int = 0;

pub const TARO: c_int = 0;
pub const RMRO: c_uint = 0x1000;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum rswitch_reg {
    FWGC		= FWRO + 0x0000,
    FWTTC0		= FWRO + 0x0010,
    FWTTC1		= FWRO + 0x0014,
    FWLBMC		= FWRO + 0x0018,
...
pub const MPIC_PIS_GMII: c_int = 2;
pub const MPIC_PIS_XGMII: c_int = 4;

pub const MPIC_LSC_100M: c_int = 1;
pub const MPIC_LSC_1G: c_int = 2;
pub const MPIC_LSC_2_5G: c_int = 3;

pub const MPSM_MMF_C22: c_int = 0;
pub const MPSM_MMF_C45: c_int = 1;

pub const MPSM_POP_ADDRESS: c_int = 0;
pub const MPSM_POP_WRITE: c_int = 1;
pub const MPSM_POP_READ_C22: c_int = 2;
pub const MPSM_POP_READ_C45: c_int = 3;

// GWCA
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum rswitch_gwca_mode {
    GWMC_OPC_RESET,
    GWMC_OPC_DISABLE,
    GWMC_OPC_CONFIG,
    GWMC_OPC_OPERATION,
...
pub const RRC_RR_CLR: c_int = 0;

pub const CABPPFLC_INIT_VALUE: c_uint = 0x00800080;
// MFWD

pub const RSW_AGEING_CLK_PER_US: c_uint = 0x140;
pub const RSW_AGEING_TIME: c_int = 300;
// TOP
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rswitch_desc {
    pub /: *mut *mut __le16 info_ds; / Descriptor size,
    pub /: *mut *mut u8 die_dt; / Descriptor interrupt enable and type,
    pub /: *mut *mut __u8 dptrh; / Descriptor pointer MSB,
    pub /: *mut *mut __le32 dptrl; / Descriptor pointer LSW,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rswitch_ts_desc {
    pub desc: rswitch_desc,
    pub ts_nsec: __le32,
    pub ts_sec: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rswitch_ext_desc {
    pub desc: rswitch_desc,
    pub info1: __le64,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rswitch_ext_ts_desc {
    pub desc: rswitch_desc,
    pub info1: __le64,
    pub ts_nsec: __le32,
    pub ts_sec: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rswitch_etha {
    pub index: c_uint,
    pub addr: *mut void __iomem,
    pub coma_addr: *mut void __iomem,
    pub external_phy: bool,
    pub mii: *mut mii_bus,
    pub phy_interface: phy_interface_t,
    pub psmcs: u32,
    pub mac_addr: [u8; MAX_ADDR_LEN],
    pub link: c_int,
    pub speed: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rswitch_gwca_queue {
    pub tx_ring: *mut rswitch_ext_desc,
    pub rx_ring: *mut rswitch_ext_ts_desc,
    pub ts_ring: *mut rswitch_ts_desc,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rswitch_gwca {
    pub index: c_uint,
    pub linkfix_table: *mut rswitch_desc,
    pub linkfix_table_dma: dma_addr_t,
    pub linkfix_table_size: u32,
    pub queues: *mut rswitch_gwca_queue,
    pub num_queues: c_int,
    pub ts_queue: rswitch_gwca_queue,
    pub RSWITCH_MAX_NUM_QUEUES): DECLARE_BITMAP(used,,
    pub tx_irq_bits: [u32; RSWITCH_NUM_IRQ_REGS],
    pub rx_irq_bits: [u32; RSWITCH_NUM_IRQ_REGS],
}

pub const NUM_QUEUES_PER_NDEV: c_int = 2;
pub const TS_TAGS_PER_PORT: c_int = 256;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rswitch_device {
    pub priv: *mut rswitch_private,
    pub ndev: *mut net_device,
    pub napi: napi_struct,
    pub addr: *mut void __iomem,
    pub tx_queue: *mut rswitch_gwca_queue,
    pub rx_queue: *mut rswitch_gwca_queue,
    pub ts_skb: [*mut sk_buff; TS_TAGS_PER_PORT],
    pub TS_TAGS_PER_PORT): DECLARE_BITMAP(ts_skb_used,,
    pub disabled: bool,
    pub list: list_head,
    pub port: c_int,
    pub etha: *mut rswitch_etha,
    pub np_port: *mut device_node,
    pub serdes: *mut phy,
    pub /: *mut *mut *mut net_device brdev; / master bridge device,
    pub 1: unsigned int learning_requested :,
    pub 1: unsigned int learning_offloaded :,
    pub 1: unsigned int forwarding_requested :,
    pub 1: unsigned int forwarding_offloaded :,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rswitch_mfwd_mac_table_entry {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rswitch_mfwd {
    pub mac_table_entries: *mut rswitch_mac_table_entry,
    pub num_mac_table_entries: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rswitch_private {
    pub pdev: *mut platform_device,
    pub addr: *mut void __iomem,
    pub ptp_priv: *mut rcar_gen4_ptp_private,
    pub rdev: [*mut rswitch_device; RSWITCH_NUM_PORTS],
    pub RSWITCH_NUM_PORTS): DECLARE_BITMAP(opened_ports,,
    pub gwca: rswitch_gwca,
    pub etha: [rswitch_etha; RSWITCH_NUM_PORTS],
    pub mfwd: rswitch_mfwd,
    pub port_list: list_head,
    pub /: *mut *mut spinlock_t lock; / lock interrupt registers' control,
    pub clk: *mut clk,
    pub etha_no_runtime_change: bool,
    pub gwca_halt: bool,
    pub offload_brdev: *mut net_device,
    pub tstamp_tx_ctrl: hwtstamp_tx_types,
    pub tstamp_rx_ctrl: hwtstamp_rx_filters,
}

extern "C" {
    pub fn is_rdev(ndev: *const net_device) -> bool;
}
extern "C" {
    pub fn rswitch_modify(addr: *mut void __iomem, reg: rswitch_reg, clear: u32, set: u32);
}
