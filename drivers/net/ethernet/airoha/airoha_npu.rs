...
//! Source: drivers/net/ethernet/airoha/airoha_npu.c
#![no_std]
...
pub const NPU_EN7581_FIRMWARE_RV32_MAX_SIZE: c_uint = 0x200000;
pub const NPU_EN7581_FIRMWARE_DATA_MAX_SIZE: c_uint = 0x10000;
pub const NPU_DUMP_SIZE: c_int = 512;
pub const REG_NPU_LOCAL_SRAM: c_uint = 0x0;
pub const NPU_PC_BASE_ADDR: c_uint = 0x305000;

pub const NPU_CLUSTER_BASE_ADDR: c_uint = 0x306000;

pub const NPU_MBOX_BASE_ADDR: c_uint = 0x30c000;

pub const NPU_WLAN_BASE_ADDR: c_uint = 0x30d000;

pub const NPU_TIMER_BASE_ADDR: c_uint = 0x310100;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct airoha_npu_soc_data {
    pub fw_rv32: airoha_npu_fw,
    pub fw_data: airoha_npu_fw,
}

pub const PPE_TYPE_L2B_IPV4: c_int = 2;
pub const PPE_TYPE_L2B_IPV4_IPV6: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ppe_mbox_data {
    pub func_type: u32,
    pub func_id: u32,
    union {
    struct {
    ...
    pub set_info: },
    struct {
    pub npu_stats_addr: u32,
    pub foe_stats_addr: u32,
    pub stats_info: },
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wlan_mbox_data {
    pub ifindex:4: u32,
    pub func_type:4: u32,
    pub func_id: u32,
    pub d): DECLARE_FLEX_ARRAY(u8,,
}
...
// dts if available.
//
    if (of_find_property(dev.of_node, "firmware-name", core::ptr::null_mut()))
...
#[no_mangle]
unsafe extern "C" fn airoha_npu_mbox_handler(irq: c_int, npu_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn airoha_npu_wdt_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn airoha_npu_wdt_handler(irq: c_int, core_instance: *mut c_void) -> irqreturn_t {
    static irqreturn_t airoha_npu_wdt_handler(int irq, void *core_instance)
    {
    struct airoha_npu_core *core = core_instance;
    struct airoha_npu *npu = core.npu;
    let mut c: c_int = core - &npu.cores[0];
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn airoha_npu_ppe_init(npu: *mut airoha_npu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airoha_npu_ppe_deinit(npu: *mut airoha_npu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airoha_npu_wlan_init_memory(npu: *mut airoha_npu) -> c_int {
    static int airoha_npu_wlan_init_memory(struct airoha_npu *npu)
    {
    let mut cmd: enum airoha_npu_wlan_set_cmd = WLAN_FUNC_SET_WAIT_NPU_BAND0_ONCPU;
    let mut val: u32 = 0;
    int err;
...
#[no_mangle]
unsafe extern "C" fn airoha_npu_wlan_irq_status_set(npu: *mut airoha_npu, val: u32) {
    static void airoha_npu_wlan_irq_status_set(struct airoha_npu *npu, u32 val)
    {
    regmap_write(npu.regmap, REG_IRQ_STATUS, val);
    }
#[no_mangle]
unsafe extern "C" fn airoha_npu_wlan_irq_status_get(npu: *mut airoha_npu, q: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn airoha_npu_wlan_irq_enable(npu: *mut airoha_npu, q: c_int) {
...
#[no_mangle]
unsafe extern "C" fn airoha_npu_wlan_irq_disable(npu: *mut airoha_npu, q: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn airoha_npu_put(npu: *mut airoha_npu) {
...
#[no_mangle]
unsafe extern "C" fn airoha_npu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airoha_npu_remove(pdev: *mut platform_device) {
