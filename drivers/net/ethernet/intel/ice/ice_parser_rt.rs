...
//! Source: drivers/net/ethernet/intel/ice/ice_parser_rt.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ice_rt_tsr_set(rt: *mut ice_parser_rt, tsr: u16) {
    static void ice_rt_tsr_set(struct ice_parser_rt *rt, u16 tsr)
    {
    rt.gpr[ICE_GPR_TSR_IDX] = tsr;
    }
#[no_mangle]
unsafe extern "C" fn ice_rt_ho_set(rt: *mut ice_parser_rt, ho: u16) {
...
#[no_mangle]
unsafe extern "C" fn ice_rt_np_set(rt: *mut ice_parser_rt, pc: u16) {
    static void ice_rt_np_set(struct ice_parser_rt *rt, u16 pc)
    {
    rt.gpr[ICE_GPR_NP_IDX] = pc;
    }
#[no_mangle]
unsafe extern "C" fn ice_rt_nn_set(rt: *mut ice_parser_rt, node: u16) {
...
#[no_mangle]
unsafe extern "C" fn ice_rt_gpr_set(rt: *mut ice_parser_rt, idx: c_int, val: u16) {
...
#[no_mangle]
unsafe extern "C" fn ice_rt_err_set(rt: *mut ice_parser_rt, idx: c_uint, set: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_parser_rt_reset(rt: *mut ice_parser_rt) {
...
//
    ...
    int pkt_len)
    {
    let mut len: c_int = min(ICE_PARSER_MAX_PKT_LEN, pkt_len);
    let mut ho: u16 = rt.gpr[ICE_GPR_HO_IDX];
    ...
    {
    let mut tsr: u8 = (u8)rt.gpr[ICE_GPR_TSR_IDX];
    let mut ho: u16 = rt.gpr[ICE_GPR_HO_IDX];
    u8 *key = rt.bst_key;
    int idd, i;
...
#[no_mangle]
unsafe extern "C" fn ice_bit_rev_u16(v: u16, len: c_int) -> u16 {
    static u16 ice_bit_rev_u16(u16 v, int len)
    {
    return bitrev16(v) >> (BITS_PER_TYPE(v) - len);
    }
#[no_mangle]
unsafe extern "C" fn ice_bit_rev_u32(v: u32, len: c_int) -> u32 {
    static u32 ice_bit_rev_u32(u32 v, int len)
    {
    return bitrev32(v) >> (BITS_PER_TYPE(v) - len);
    }
#[no_mangle]
unsafe extern "C" fn ice_hv_bit_sel(rt: *mut ice_parser_rt, start: c_int, len: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(ICE_NPKB_OPC_BUILD: kb->opc ==) -> else {
    else if (kb.opc == ICE_NPKB_OPC_BUILD)
    return rt.gpr[kb.start_reg0] |
    ((u32)rt.gpr[kb.len_reg1] << BITS_PER_TYPE(u16));
#[no_mangle]
pub unsafe extern "C" fn if(ICE_NPKB_OPC_BYPASS: kb->opc ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ice_flag_get(rt: *mut ice_parser_rt, index: c_uint) -> bool {
    static bool ice_flag_get(struct ice_parser_rt *rt, unsigned int index)
    {
    let mut word: c_int = index / ICE_GPR_FLG_SIZE;
    let mut id: c_int = index % ICE_GPR_FLG_SIZE;
...
#[no_mangle]
unsafe extern "C" fn ice_gpr_add(rt: *mut ice_parser_rt, idx: c_int, val: u16) {
...
#[no_mangle]
unsafe extern "C" fn ice_pg_exe(rt: *mut ice_parser_rt) {
...
#[no_mangle]
unsafe extern "C" fn ice_flg_add(rt: *mut ice_parser_rt, idx: c_int, val: bool) {
...
#[no_mangle]
unsafe extern "C" fn ice_flg_update(rt: *mut ice_parser_rt, alu: *mut ice_alu) {
...
#[no_mangle]
unsafe extern "C" fn ice_po_update(rt: *mut ice_parser_rt, alu: *mut ice_alu) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ICE_PO_OFF_HDR_SUB: alu->proto_offset_opc ==) -> else {
    else if (alu.proto_offset_opc == ICE_PO_OFF_HDR_SUB)
    rt.po = (u16)(rt.gpr[ICE_GPR_HO_IDX] - alu.proto_offset);
#[no_mangle]
pub unsafe extern "C" fn if(ICE_PO_OFF_REMAIN: alu->proto_offset_opc ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ice_err_add(rt: *mut ice_parser_rt, idx: c_int, val: bool) {
...
#[no_mangle]
unsafe extern "C" fn ice_alu_exe(rt: *mut ice_parser_rt, alu: *mut ice_alu) {
...
#[no_mangle]
unsafe extern "C" fn ice_alu0_exe(rt: *mut ice_parser_rt) {
...
#[no_mangle]
unsafe extern "C" fn ice_alu1_exe(rt: *mut ice_parser_rt) {
...
#[no_mangle]
unsafe extern "C" fn ice_alu2_exe(rt: *mut ice_parser_rt) {
...
#[no_mangle]
unsafe extern "C" fn ice_pu_exe(rt: *mut ice_parser_rt) {
...
#[no_mangle]
unsafe extern "C" fn ice_alu_pg_exe(rt: *mut ice_parser_rt) {
...
#[no_mangle]
unsafe extern "C" fn ice_proto_off_update(rt: *mut ice_parser_rt) {
...
#[no_mangle]
unsafe extern "C" fn ice_marker_set(rt: *mut ice_parser_rt, idx: c_int) {
    static void ice_marker_set(struct ice_parser_rt *rt, int idx)
    {
    let mut byte: c_uint = idx / BITS_PER_BYTE;
    let mut bit: c_uint = idx % BITS_PER_BYTE;
    rt.markers[byte] |= (u8)BIT(bit);
    }
#[no_mangle]
unsafe extern "C" fn ice_marker_update(rt: *mut ice_parser_rt) {
    ...
    let mut marker: u8 = mk_grp.markers[i];
...
#[no_mangle]
unsafe extern "C" fn ice_ptype_resolve(rt: *mut ice_parser_rt) -> u16 {
