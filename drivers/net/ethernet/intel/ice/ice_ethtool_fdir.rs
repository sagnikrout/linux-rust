...
//! Source: drivers/net/ethernet/intel/ice/ice_ethtool_fdir.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ice_fltr_to_ethtool_flow(flow: enum ice_fltr_ptype) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_ethtool_flow_to_fltr(eth: c_int) -> enum ice_fltr_ptype {
...
//
#[no_mangle]
unsafe extern "C" fn ice_is_mask_valid(mask: u64, field: u64) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_get_ethtool_fdir_entry(hw: *mut ice_hw, cmd: *mut ethtool_rxnfc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_fdir_rem_adq_chnl(hw: *mut ice_hw, vsi_idx: u16) {
    ...
    let mut prof_id: u64 = prof.prof_id[tun];
...
//
    ...
    {
    let mut flow: c_int = (int)flow_type & ~FLOW_EXT;
    ...
    prof.fdir_seg[tun] = core::ptr::null_mut();
    }
    prof.cnt = 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_fdir_release_flows(hw: *mut ice_hw) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_fdir_replay_flows(hw: *mut ice_hw) {
...
pub const ICE_USERDEF_FLEX_OFFS_S: c_int = 16;

// 0x1fe is the maximum value for offsets stored in the internal
// filtering tables.
//
pub const ICE_USERDEF_FLEX_MAX_OFFS_VAL: c_uint = 0x1fe;
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_fdir_num_avail_fltr(hw: *mut ice_hw, vsi: *mut ice_vsi) -> c_int {
    int ice_fdir_num_avail_fltr(struct ice_hw *hw, struct ice_vsi *vsi)
    {
    let mut vsi_num: u16 = ice_get_hw_vsi_num(hw, vsi.idx);
    u16 num_guar;
    u16 num_be;
...
//
    ...
    struct ice_flow_prof *prof = core::ptr::null_mut();
    struct ice_fd_hw_prof *hw_prof;
    struct ice_hw *hw = &pf.hw;
    let mut entry1_h: u64 = 0;
    let mut entry2_h: u64 = 0;
    bool del_last;
    int err;
    int idx;
...
//
    ...
    err_unroll:
    entry1_h = 0;
    hw_prof.fdir_seg[tun] = core::ptr::null_mut();
...
//
    ...
    let mut vsi_num: u16 = ice_get_hw_vsi_num(hw, hw_prof.vsi_h[idx]);
...
#[no_mangle]
pub unsafe extern "C" fn if(ICE_FLTR_PTYPE_NONF_IPV4_UDP: flow ==) -> else {
    else if (flow == ICE_FLTR_PTYPE_NONF_IPV4_UDP)
    ret = ice_set_init_fdir_seg(seg, ICE_FLOW_SEG_HDR_IPV4,
    ICE_FLOW_SEG_HDR_UDP);
#[no_mangle]
pub unsafe extern "C" fn if(ICE_FLTR_PTYPE_NONF_IPV6_TCP: flow ==) -> else {
    else if (flow == ICE_FLTR_PTYPE_NONF_IPV6_TCP)
    ret = ice_set_init_fdir_seg(seg, ICE_FLOW_SEG_HDR_IPV6,
    ICE_FLOW_SEG_HDR_TCP);
#[no_mangle]
pub unsafe extern "C" fn if(ICE_FLTR_PTYPE_NONF_IPV6_UDP: flow ==) -> else {
...
// Source MAC address
    ...
    ICE_FLOW_FLD_OFF_INVAL, false);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !is_zero_ether_addr(eth_spec->h_source)) -> else {
...
// Destination MAC address
    ...
    ICE_FLOW_FLD_OFF_INVAL, false);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !is_zero_ether_addr(eth_spec->h_dest)) -> else {
...
//
    ...
    struct ice_hw *hw = &pf.hw;
    let mut perfect_filter: bool = false;
    int ret;
    seg = devm_kzalloc(dev, sizeof(*seg), GFP_KERNEL);
    if (!seg)
    return -ENOMEM;
...
//
#[no_mangle]
unsafe extern "C" fn ice_update_per_q_fltr(vsi: *mut ice_vsi, q_index: u32, inc: bool) {
...
//
    ...
    int tun;
    for (tun = 0; tun < ICE_FD_HW_SEG_MAX; tun++) {
    let mut is_tun: bool = tun == ICE_FD_HW_SEG_TUN;
    int err;
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_fdir_replay_fltrs(pf: *mut ice_pf) {
    void ice_fdir_replay_fltrs(struct ice_pf *pf)
    {
    struct ice_fdir_fltr *f_rule;
    struct ice_hw *hw = &pf.hw;
    list_for_each_entry(f_rule, &hw.fdir_list_head, fltr_node) {
    let mut err: c_int = ice_fdir_write_all_fltr(pf, f_rule, true);
    if (err)
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_fdir_create_dflt_rules(pf: *mut ice_pf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_fdir_del_all_fltrs(vsi: *mut ice_vsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_vsi_manage_fdir(vsi: *mut ice_vsi, ena: bool) {
...
//
    ...
    {
    struct ice_hw *hw = &pf.hw;
    let mut need_perfect: bool = false;
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_del_fdir_ethtool(vsi: *mut ice_vsi, cmd: *mut ethtool_rxnfc) -> c_int {
...
// Do not delete filters during reset
    ...
    return -EBUSY;
    mutex_lock(&hw.fdir_fltr_lock);
    val = ice_fdir_update_list_entry(pf, core::ptr::null_mut(), fsp.location);
    mutex_unlock(&hw.fdir_fltr_lock);
    return val;
    }
//
...
//
    ...
    {
    let mut q_index: i16 = ICE_FDIR_NO_QUEUE_IDX;
    let mut orig_q_index: u16 = 0;
    struct ice_pf *pf;
    struct ice_hw *hw;
    int flow_type;
    u16 dest_vsi;
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_add_fdir_ethtool(vsi: *mut ice_vsi, cmd: *mut ethtool_rxnfc) -> c_int {
