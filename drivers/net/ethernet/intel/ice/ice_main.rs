...
//! Source: drivers/net/ethernet/intel/ice/ice_main.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn netif_is_ice(dev: *const net_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ice_get_tx_pending(ring: *mut ice_tx_ring) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn ice_check_for_hang_subtask(pf: *mut ice_pf) {
    static void ice_check_for_hang_subtask(struct ice_pf *pf)
    {
    struct ice_vsi *vsi = core::ptr::null_mut();
    struct ice_hw *hw;
    unsigned int i;
    int packets;
    u32 v;
...
//
#[no_mangle]
unsafe extern "C" fn ice_init_mac_fltr(pf: *mut ice_pf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_add_mac_to_sync_list(netdev: *mut net_device, addr: *const u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_add_mac_to_unsync_list(netdev: *mut net_device, addr: *const u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_vsi_fltr_changed(vsi: *mut ice_vsi) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ice_set_promisc(vsi: *mut ice_vsi, promisc_m: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_clear_promisc(vsi: *mut ice_vsi, promisc_m: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_vsi_sync_fltr(vsi: *mut ice_vsi) -> c_int {
    static int ice_vsi_sync_fltr(struct ice_vsi *vsi)
    {
    struct ice_vsi_vlan_ops *vlan_ops = ice_get_compat_vsi_vlan_ops(vsi);
    struct device *dev = ice_pf_to_dev(vsi.back);
    struct net_device *netdev = vsi.netdev;
    let mut promisc_forced_on: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn ice_sync_fltr_subtask(pf: *mut ice_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_pf_dis_all_vsi(pf: *mut ice_pf, locked: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_do_reset(pf: *mut ice_pf, reset_type: enum ice_reset_req) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_reset_subtask(pf: *mut ice_pf) {
    static void ice_reset_subtask(struct ice_pf *pf)
    {
    let mut reset_type: enum ice_reset_req = ICE_RESET_INVAL;
...
//
#[no_mangle]
unsafe extern "C" fn ice_print_topo_conflict(vsi: *mut ice_vsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_print_link_msg(vsi: *mut ice_vsi, isup: bool) {
...
// Get FEC mode requested based on PHY caps last SW configuration
    ...
    ICE_AQC_REPORT_ACTIVE_CFG, caps, core::ptr::null_mut());
    if (status)
...
//
#[no_mangle]
unsafe extern "C" fn ice_vsi_link_event(vsi: *mut ice_vsi, link_up: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_set_dflt_mib(pf: *mut ice_pf) {
    static void ice_set_dflt_mib(struct ice_pf *pf)
    {
    struct device *dev = ice_pf_to_dev(pf);
    u8 mib_type, *buf, *lldpmib = core::ptr::null_mut();
...
// Octet 1 left as all zeros - PFC disabled
    ...
    len = FIELD_GET(ICE_LLDP_TLV_LEN_M, typelen);
    offset += len + 2;
    if (ice_aq_set_lldp_mib(hw, mib_type, (void *)lldpmib, offset, core::ptr::null_mut()))
...
//
#[no_mangle]
unsafe extern "C" fn ice_check_phy_fw_load(pf: *mut ice_pf, link_cfg_err: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_check_module_power(pf: *mut ice_pf, link_cfg_err: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_check_link_cfg_err(pf: *mut ice_pf, link_cfg_err: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_watchdog_subtask(pf: *mut ice_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_init_link_events(pi: *mut ice_port_info) -> c_int {
    ...
    if (ice_aq_set_event_mask(pi.hw, pi.lport, mask, core::ptr::null_mut())) {
    dev_dbg(ice_hw_to_dev(pi.hw), "Failed to set link event mask for port %d\n",
    pi.lport);
    return -EIO;
    }
    if (ice_aq_get_link_info(pi, true, core::ptr::null_mut(), core::ptr::null_mut())) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_aq_cancel_waiting_tasks(pf: *mut ice_pf) {
...
pub const ICE_MBX_OVERFLOW_WATERMARK: c_int = 64;
//
...
//
#[no_mangle]
unsafe extern "C" fn __ice_clean_ctrlq(pf: *mut ice_pf, q_type: enum ice_ctl_q) -> c_int {
...
// Notify any thread that might be waiting for this event
    ...
    ice_vc_process_vf_msg(pf, &event, core::ptr::null_mut());
    ice_mbx_vf_dec_trig_e830(hw, &event);
    } else {
    let mut val: u16 = hw.mailboxq.num_rq_entries;
...
//
#[no_mangle]
unsafe extern "C" fn ice_ctrlq_pending(hw: *mut ice_hw, cq: *mut ice_ctl_q_info) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ice_clean_adminq_subtask(pf: *mut ice_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_clean_mailboxq_subtask(pf: *mut ice_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_clean_sbq_subtask(pf: *mut ice_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_service_task_schedule(pf: *mut ice_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_service_task_complete(pf: *mut ice_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_service_task_stop(pf: *mut ice_pf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_service_task_restart(pf: *mut ice_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_service_timer(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_handle_mdd_event(pf: *mut ice_pf) {
...
// find what triggered an MDD event
    ...
    let mut pf_num: u8 = FIELD_GET(GL_MDET_TX_PQM_PF_NUM_M, reg);
    let mut vf_num: u16 = FIELD_GET(GL_MDET_TX_PQM_VF_NUM_M, reg);
    let mut event: u8 = FIELD_GET(GL_MDET_TX_PQM_MAL_TYPE_M, reg);
    let mut queue: u16 = FIELD_GET(GL_MDET_TX_PQM_QNUM_M, reg);
    ...
    let mut pf_num: u8 = FIELD_GET(GL_MDET_TX_TCLAN_PF_NUM_M, reg);
    let mut vf_num: u16 = FIELD_GET(GL_MDET_TX_TCLAN_VF_NUM_M, reg);
    let mut event: u8 = FIELD_GET(GL_MDET_TX_TCLAN_MAL_TYPE_M, reg);
    let mut queue: u16 = FIELD_GET(GL_MDET_TX_TCLAN_QNUM_M, reg);
    if (netif_msg_tx_err(pf))
    dev_info(dev, "Malicious Driver Detection event %d on TX queue %d PF# %d VF# %d\n",
    event, queue, pf_num, vf_num);
    ...
    let mut pf_num: u8 = FIELD_GET(GL_MDET_RX_PF_NUM_M, reg);
    let mut vf_num: u16 = FIELD_GET(GL_MDET_RX_VF_NUM_M, reg);
    let mut event: u8 = FIELD_GET(GL_MDET_RX_MAL_TYPE_M, reg);
    let mut queue: u16 = FIELD_GET(GL_MDET_RX_QNUM_M, reg);
...
//
    mutex_lock(&pf.vfs.table_lock);
    ice_for_each_vf(pf, bkt, vf) {
    let mut reset_vf_tx: bool = false, reset_vf_rx = false;
...
//
#[no_mangle]
unsafe extern "C" fn ice_init_nvm_phy_type(pi: *mut ice_port_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_init_link_dflt_override(pi: *mut ice_port_info) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_init_phy_cfg_dflt_override(pi: *mut ice_port_info) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_init_phy_user_cfg(pi: *mut ice_port_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_phy_cfg(vsi: *mut ice_vsi, link_en: bool) -> c_int {
...
//
    ...
    let mut phy_low: u64 = 0, phy_high = 0;
...
// Enable/Disable link and link update
    ...
    cfg.caps &= ~ICE_AQ_PHY_ENA_LINK;
    err = ice_aq_set_phy_cfg(&pf.hw, pi, cfg, core::ptr::null_mut());
    if (err)
...
//
#[no_mangle]
unsafe extern "C" fn ice_check_media_subtask(pf: *mut ice_pf) {
...
#[no_mangle]
unsafe extern "C" fn ice_service_task_recovery_mode(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_service_task(work: *mut work_struct) {
    ...
    pf.health_reporters.tx_hang_buf.tx_ring = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn ice_set_ctrlq_len(hw: *mut ice_hw) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_schedule_reset(pf: *mut ice_pf, reset: enum ice_reset_req) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_vsi_ena_irq(vsi: *mut ice_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_vsi_req_irq_msix(vsi: *mut ice_vsi, basename: *mut c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_xdp_alloc_setup_rings(vsi: *mut ice_vsi) -> c_int {
    ...
    let mut xdp_q_idx: u16 = vsi.alloc_txq + i;
    struct ice_ring_stats *ring_stats;
    ...
    xdp_ring.vsi = vsi;
    xdp_ring.netdev = core::ptr::null_mut();
    xdp_ring.dev = dev;
    ...
    vsi.xdp_rings[i].ring_stats = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ice_vsi_assign_bpf_prog(vsi: *mut ice_vsi, prog: *mut bpf_prog) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_map_xdp_rings(vsi: *mut ice_vsi) {
    void ice_map_xdp_rings(struct ice_vsi *vsi)
    {
    let mut xdp_rings_rem: c_int = vsi.num_xdp_txq;
    int v_idx, q_idx;
...
//
#[no_mangle]
unsafe extern "C" fn ice_unmap_xdp_rings(vsi: *mut ice_vsi) {
...
//
    ...
    vsi.xdp_rings[i] = core::ptr::null_mut();
    }
    err_map_xdp:
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_destroy_xdp_rings(vsi: *mut ice_vsi, cfg_type: enum ice_xdp_cfg) -> c_int {
...
//
    ...
    if (cfg_type == ICE_XDP_CFG_PART)
    return 0;
    ice_vsi_assign_bpf_prog(vsi, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn ice_vsi_rx_napi_schedule(vsi: *mut ice_vsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_vsi_determine_xdp_res(vsi: *mut ice_vsi) -> c_int {
    int ice_vsi_determine_xdp_res(struct ice_vsi *vsi)
    {
    let mut avail: u16 = ice_get_avail_txq_count(vsi.back);
    let mut cpus: u16 = num_possible_cpus();
    if (avail < cpus / 2)
    return -ENOMEM;
...
//
#[no_mangle]
unsafe extern "C" fn ice_max_xdp_frame_size(vsi: *mut ice_vsi) -> c_int {
...
//
    ...
    {
    let mut frame_size: c_uint = vsi.netdev.mtu + ICE_ETH_PKT_HDR_PAD;
    let mut ret: c_int = 0, xdp_ring_err = 0;
    bool if_running;
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_xdp(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_ena_misc_vector(pf: *mut ice_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_ll_ts_intr(irq: int __always_unused, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ice_misc_intr(irq: int __always_unused, data: *mut c_void) -> irqreturn_t {
...
// disable any further VFLR event notifications
    ...
    let mut reg: u32 = rd32(hw, PFINT_OICR_ENA);
...
// we have a reset warning
    ...
    pf.corer_count++;
#[no_mangle]
pub unsafe extern "C" fn if(ICE_RESET_GLOBR: reset ==) -> else {
    else if (reset == ICE_RESET_GLOBR)
    pf.globr_count++;
#[no_mangle]
pub unsafe extern "C" fn if(ICE_RESET_EMPR: reset ==) -> else {
...
//
    ...
    let mut tmr_idx: u8 = hw.func_caps.ts_func_info.tmr_index_owned;
    let mut gltsyn_stat: u32 = rd32(hw, GLTSYN_STAT(tmr_idx));
...
//
    ...
    ice_service_task_schedule(pf);
    if (ret == IRQ_HANDLED)
    ice_irq_dynamic_ena(hw, core::ptr::null_mut(), core::ptr::null_mut());
    return ret;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ice_misc_intr_thread_fn(irq: int __always_unused, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ice_dis_ctrlq_interrupts(hw: *mut ice_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_free_irq_msix_ll_ts(pf: *mut ice_pf) {
    static void ice_free_irq_msix_ll_ts(struct ice_pf *pf)
    {
    let mut irq_num: c_int = pf.ll_ts_irq.virq;
...
//
#[no_mangle]
unsafe extern "C" fn ice_free_irq_msix_misc(pf: *mut ice_pf) {
    static void ice_free_irq_msix_misc(struct ice_pf *pf)
    {
    let mut misc_irq_num: c_int = pf.oicr_irq.virq;
    struct ice_hw *hw = &pf.hw;
...
//
#[no_mangle]
unsafe extern "C" fn ice_ena_ctrlq_interrupts(hw: *mut ice_hw, reg_idx: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_req_irq_msix_misc(pf: *mut ice_pf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_set_ops(vsi: *mut ice_vsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_set_netdev_features(netdev: *mut net_device) {
    void ice_set_netdev_features(struct net_device *netdev)
    {
    struct ice_pf *pf = ice_netdev_to_pf(netdev);
    let mut is_dvm_ena: bool = ice_is_dvm_ena(&pf.hw);
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_fill_rss_lut(lut: *mut u8, rss_table_size: u16, rss_size: u16) {
...
//
    ...
    {
    let mut params: ice_vsi_cfg_params = {};
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_vlan_rx_add_vid(netdev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_vlan_rx_kill_vid(netdev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_rep_indr_tc_block_unbind(cb_priv: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_tc_indir_block_unregister(vsi: *mut ice_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_tc_indir_block_register(vsi: *mut ice_vsi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_get_avail_txq_count(pf: *mut ice_pf) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_get_avail_rxq_count(pf: *mut ice_pf) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_deinit_pf(pf: *mut ice_pf) {
...
// note that we unroll also on ice_init_pf() failure here
    ...
    pf.avail_txqs = core::ptr::null_mut();
    }
    if (pf.avail_rxqs) {
    bitmap_free(pf.avail_rxqs);
    pf.avail_rxqs = core::ptr::null_mut();
    }
    if (pf.txtime_txqs) {
    bitmap_free(pf.txtime_txqs);
    pf.txtime_txqs = core::ptr::null_mut();
    }
    if (pf.ptp.clock)
...
//
#[no_mangle]
unsafe extern "C" fn ice_set_pf_caps(pf: *mut ice_pf) {
...
#[no_mangle]
pub unsafe extern "C" fn ice_start_service_task(pf: *mut ice_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_init_pf(pf: *mut ice_pf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_is_wol_supported(hw: *mut ice_hw) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_vsi_recfg_qs(vsi: *mut ice_vsi, new_rx: c_int, new_tx: c_int, locked: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_set_safe_mode_vlan_cfg(pf: *mut ice_pf) {
...
// allow all VLANs on Tx and don't strip on Rx
    ...
    status = ice_update_vsi(hw, vsi.idx, ctxt, core::ptr::null_mut());
    if (status) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_log_pkg_init(hw: *mut ice_hw, state: enum ice_ddp_state) {
...
//
    ...
    {
    let mut state: enum ice_ddp_state = ICE_DDP_PKG_ERR;
    struct device *dev = ice_pf_to_dev(pf);
    struct ice_hw *hw = &pf.hw;
// Load DDP Package
...
//
#[no_mangle]
unsafe extern "C" fn ice_verify_cacheline_size(pf: *mut ice_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_send_version(pf: *mut ice_pf) -> c_int {
    ...
    return ice_aq_send_driver_ver(&pf.hw, &dv, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ice_init_fdir(pf: *mut ice_pf) -> c_int {
...
//
    ...
    pf.vsi[pf.ctrl_vsi_idx] = core::ptr::null_mut();
    pf.ctrl_vsi_idx = ICE_NO_VSI;
    }
    return err;
    }
#[no_mangle]
unsafe extern "C" fn ice_deinit_fdir(pf: *mut ice_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_request_fw(pf: *mut ice_pf, firmware: *const firmware) -> c_int {
...
//
    ...
    {
    let mut num_tx_sched_layers: u8 = hw.num_tx_sched_layers;
    struct ice_pf *pf = hw.back;
    struct device *dev;
    int err;
    dev = ice_pf_to_dev(pf);
...
//
#[no_mangle]
unsafe extern "C" fn ice_init_supported_rxdids(hw: *mut ice_hw, pf: *mut ice_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_init_ddp_config(hw: *mut ice_hw, pf: *mut ice_pf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_print_wake_reason(pf: *mut ice_pf) {
    static void ice_print_wake_reason(struct ice_pf *pf)
    {
    let mut wus: u32 = pf.wakeup_reason;
    const char *wake_str;
// if no wake event, nothing to print
    ...
    wake_str = "Link\n";
#[no_mangle]
pub unsafe extern "C" fn if(PFPM_WUS_MAG_M: wus &) -> else {
    else if (wus & PFPM_WUS_MAG_M)
    wake_str = "Magic Packet\n";
#[no_mangle]
pub unsafe extern "C" fn if(PFPM_WUS_MNG_M: wus &) -> else {
    else if (wus & PFPM_WUS_MNG_M)
    wake_str = "Management\n";
#[no_mangle]
pub unsafe extern "C" fn if(PFPM_WUS_FW_RST_WK_M: wus &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ice_register_netdev(vsi: *mut ice_vsi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ice_unregister_netdev(vsi: *mut ice_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_cfg_netdev(vsi: *mut ice_vsi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ice_decfg_netdev(vsi: *mut ice_vsi) {
...
#[no_mangle]
pub unsafe extern "C" fn ice_init_dev_hw(pf: *mut ice_pf) {
...
#[no_mangle]
pub unsafe extern "C" fn ice_init_dev(pf: *mut ice_pf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ice_deinit_dev(pf: *mut ice_pf) {
...
#[no_mangle]
unsafe extern "C" fn ice_init_features(pf: *mut ice_pf) {
...
#[no_mangle]
unsafe extern "C" fn ice_deinit_features(pf: *mut ice_pf) {
...
#[no_mangle]
unsafe extern "C" fn ice_init_wakeup(pf: *mut ice_pf) {
...
#[no_mangle]
unsafe extern "C" fn ice_init_link(pf: *mut ice_pf) {
...
#[no_mangle]
unsafe extern "C" fn ice_init_pf_sw(pf: *mut ice_pf) -> c_int {
    static int ice_init_pf_sw(struct ice_pf *pf)
    {
    let mut dvm: bool = ice_is_dvm_ena(&pf.hw);
    struct ice_vsi *vsi;
    int err;
...
// record the sw_id available for later use
    ...
    err = ice_aq_set_port_params(pf.hw.port_info, dvm, core::ptr::null_mut());
    if (err)
...
#[no_mangle]
unsafe extern "C" fn ice_deinit_pf_sw(pf: *mut ice_pf) {
...
#[no_mangle]
unsafe extern "C" fn ice_alloc_vsis(pf: *mut ice_pf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ice_dealloc_vsis(pf: *mut ice_pf) {
    static void ice_dealloc_vsis(struct ice_pf *pf)
    {
    devm_kfree(ice_pf_to_dev(pf), pf.vsi_stats);
    pf.vsi_stats = core::ptr::null_mut();
    pf.num_alloc_vsi = 0;
    devm_kfree(ice_pf_to_dev(pf), pf.vsi);
    pf.vsi = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ice_init_devlink(pf: *mut ice_pf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ice_deinit_devlink(pf: *mut ice_pf) {
...
#[no_mangle]
unsafe extern "C" fn ice_init(pf: *mut ice_pf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ice_deinit(pf: *mut ice_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_load(pf: *mut ice_pf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_unload(pf: *mut ice_pf) {
...
#[no_mangle]
unsafe extern "C" fn ice_probe_recovery_mode(pf: *mut ice_pf) -> c_int {
...
//
    ...
    let mut need_dev_deinit: bool = false;
...
// Disable service task until DOWN bit is cleared
    ...
    pci_save_state(pdev);
    hw.back = pf;
    hw.port_info = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ice_set_wake(pf: *mut ice_pf) {
    static void ice_set_wake(struct ice_pf *pf)
    {
    struct ice_hw *hw = &pf.hw;
    let mut wol: bool = pf.wol_ena;
...
//
#[no_mangle]
unsafe extern "C" fn ice_setup_mc_magic_wake(pf: *mut ice_pf) {
...
// Get current MAC address in case it's an LAA
    ...
    status = ice_aq_manage_mac_write(hw, mac_addr, flags, core::ptr::null_mut());
    if (status)
...
//
#[no_mangle]
unsafe extern "C" fn ice_remove(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_shutdown(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_prepare_for_shutdown(pf: *mut ice_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_reinit_interrupt_scheme(pf: *mut ice_pf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_resume(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_pci_err_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
//
#[no_mangle]
unsafe extern "C" fn ice_pci_err_resume(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_pci_err_reset_prepare(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_pci_err_reset_done(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_module_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn ice_module_exit() -> void __exit {
...
//
#[no_mangle]
unsafe extern "C" fn ice_set_mac_address(netdev: *mut net_device, pi: *mut c_void) -> c_int {
...
// write new MAC address to the firmware
    ...
    err = ice_aq_manage_mac_write(hw, mac, flags, core::ptr::null_mut());
    if (err) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_set_rx_mode(netdev: *mut net_device) {
...
//
    ...
    {
    let mut enable_stripping: bool = true, enable_insertion = true;
    struct ice_vsi_vlan_ops *vlan_ops;
    let mut strip_err: c_int = 0, insert_err = 0;
    let mut vlan_ethertype: u16 = 0;
    vlan_ops = ice_get_compat_vsi_vlan_ops(vsi);
    if (features & (NETIF_F_HW_VLAN_STAG_RX | NETIF_F_HW_VLAN_STAG_TX))
    vlan_ethertype = ETH_P_8021AD;
#[no_mangle]
pub unsafe extern "C" fn if(NETIF_F_HW_VLAN_CTAG_TX): features & (NETIF_F_HW_VLAN_CTAG_RX |) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ice_set_loopback(vsi: *mut ice_vsi, ena: bool) -> c_int {
    static int ice_set_loopback(struct ice_vsi *vsi, bool ena)
    {
    let mut if_running: bool = netif_running(vsi.netdev);
    int ret;
    ...
    ret = ice_aq_set_mac_loopback(&vsi.back.hw, ena, core::ptr::null_mut());
    if (ret)
...
//
    ...
    let mut ena: bool = !!(features & NETIF_F_NTUPLE);
...
// don't turn off hw_tc_offload when ADQ is already enabled
    ...
    let mut ena: bool = !!(features & NETIF_F_HW_TC);
...
//
#[no_mangle]
unsafe extern "C" fn ice_vsi_vlan_setup(vsi: *mut ice_vsi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_vsi_cfg_lan(vsi: *mut ice_vsi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ice_tx_dim_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ice_rx_dim_work(work: *mut work_struct) {
...
pub const ICE_DIM_DEFAULT_PROFILE_IX: c_int = 1;
//
...
//
#[no_mangle]
unsafe extern "C" fn ice_init_moderation(q_vector: *mut ice_q_vector) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_napi_enable_all(vsi: *mut ice_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_up_complete(vsi: *mut ice_vsi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_up(vsi: *mut ice_vsi) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ice_vsi_tx_stats {
    pub pkts: u64,
    pub bytes: u64,
    pub tx_restart_q: u64,
    pub tx_busy: u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ice_vsi_rx_stats {
    pub pkts: u64,
    pub bytes: u64,
    pub rx_non_eop_descs: u64,
...
//
#[no_mangle]
unsafe extern "C" fn ice_update_vsi_ring_stats(vsi: *mut ice_vsi) {
    static void ice_update_vsi_ring_stats(struct ice_vsi *vsi)
    {
    struct rtnl_link_stats64 *net_stats, *stats_prev;
    let mut tx_stats: ice_vsi_tx_stats = {};
    let mut rx_stats: ice_vsi_rx_stats = {};
    struct ice_pf *pf = vsi.back;
    rcu_read_lock();
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_update_vsi_stats(vsi: *mut ice_vsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_update_pf_stats(pf: *mut ice_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_get_stats64(netdev: *mut net_device, stats: *mut rtnl_link_stats64) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_napi_disable_all(vsi: *mut ice_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_vsi_dis_irq(vsi: *mut ice_vsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_down(vsi: *mut ice_vsi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_down_up(vsi: *mut ice_vsi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_vsi_setup_tx_rings(vsi: *mut ice_vsi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_vsi_setup_rx_rings(vsi: *mut ice_vsi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_vsi_open_ctrl(vsi: *mut ice_vsi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_vsi_open(vsi: *mut ice_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_vsi_release_all(pf: *mut ice_pf) {
    static void ice_vsi_release_all(struct ice_pf *pf)
    {
    int err, i;
    if (!pf.vsi)
...
//
#[no_mangle]
unsafe extern "C" fn ice_vsi_rebuild_by_type(pf: *mut ice_pf, type: enum ice_vsi_type) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_update_pf_netdev_link(pf: *mut ice_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_rebuild(pf: *mut ice_pf, reset_type: enum ice_reset_req) {
    static void ice_rebuild(struct ice_pf *pf, enum ice_reset_req reset_type)
    {
    struct ice_vsi *vsi = ice_get_main_vsi(pf);
    struct device *dev = ice_pf_to_dev(pf);
...
pub const ICE_EMP_RESET_SLEEP_MS: c_int = 5000;
...
// Reload DDP Package after CORER/GLOBR reset
    ice_load_pkg(core::ptr::null_mut(), pf);
    }
    ...
    err = ice_aq_set_mac_cfg(hw, ICE_AQ_SET_MAC_FRAME_SIZE_MAX, core::ptr::null_mut());
    if (err) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
    ...
    prog = vsi.xdp_prog;
    if (prog && !prog.aux.xdp_has_frags) {
    let mut frame_size: c_int = ice_max_xdp_frame_size(vsi);
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_set_rss_lut(vsi: *mut ice_vsi, lut: *mut u8, lut_size: u16) -> c_int {
    int ice_set_rss_lut(struct ice_vsi *vsi, u8 *lut, u16 lut_size)
    {
    let mut params: ice_aq_get_set_rss_lut_params = {};
    struct ice_hw *hw = &vsi.back.hw;
    int status;
    if (!lut)
    return -EINVAL;
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_set_rss_key(vsi: *mut ice_vsi, seed: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_get_rss_lut(vsi: *mut ice_vsi, lut: *mut u8, lut_size: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_get_rss_key(vsi: *mut ice_vsi, seed: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_get_rss(vsi: *mut ice_vsi, seed: *mut u8, lut: *mut u8, lut_size: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_set_rss_hfunc(vsi: *mut ice_vsi, hfunc: u8) -> c_int {
    ...
    err = ice_update_vsi(hw, vsi.idx, ctx, core::ptr::null_mut());
    if (err) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_vsi_update_bridge_mode(vsi: *mut ice_vsi, bmode: u16) -> c_int {
...
// change from VEB to VEPA mode
    ...
    ret = ice_update_vsi(hw, vsi.idx, ctxt, core::ptr::null_mut());
    if (ret) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
    void ice_tx_timeout(struct net_device *netdev, unsigned int txqueue)
    {
    struct ice_netdev_priv *np = netdev_priv(netdev);
    struct ice_tx_ring *tx_ring = core::ptr::null_mut();
    struct ice_vsi *vsi = np.vsi;
    struct ice_pf *pf = vsi.back;
    u32 i;
    pf.tx_timeout_count++;
...
//
    ...
    {
    let mut non_power_of_2_qcount: c_int = 0;
    struct ice_pf *pf = vsi.back;
    let mut max_rss_q_cnt: c_int = 0;
    let mut sum_min_rate: u64 = 0;
    struct device *dev;
    int i, speed;
    u8 num_tc;
    if (vsi.type != ICE_VSI_PF)
    ...
    for (i = 0; num_tc; i++) {
    let mut qcount: c_int = mqprio_qopt.qopt.count[i];
...
//
#[no_mangle]
unsafe extern "C" fn ice_add_vsi_to_fdir(pf: *mut ice_pf, vsi: *mut ice_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_add_channel(pf: *mut ice_pf, sw_id: u16, ch: *mut ice_channel) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_chnl_cfg_res(vsi: *mut ice_vsi, ch: *mut ice_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_create_q_channel(vsi: *mut ice_vsi, ch: *mut ice_channel) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_rem_all_chnl_fltrs(pf: *mut ice_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_remove_q_channels(vsi: *mut ice_vsi, rem_fltr: bool) {
...
// Reset queue contexts
    ...
    if (tx_ring.q_vector)
    tx_ring.q_vector.ch = core::ptr::null_mut();
    }
    if (rx_ring) {
    rx_ring.ch = core::ptr::null_mut();
    if (rx_ring.q_vector)
    rx_ring.q_vector.ch = core::ptr::null_mut();
    }
    }
...
// clear the channel VSI map which is stored in main VSI
    ...
    vsi.tc_map_vsi[i] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ice_rebuild_channels(pf: *mut ice_pf) -> c_int {
    static int ice_rebuild_channels(struct ice_pf *pf)
    {
    struct device *dev = ice_pf_to_dev(pf);
    struct ice_vsi *main_vsi;
    let mut rem_adv_fltr: bool = true;
    struct ice_channel *ch;
    struct ice_vsi *vsi;
    let mut tc_idx: c_int = 1;
    int i, err;
...
//
#[no_mangle]
unsafe extern "C" fn ice_create_q_channels(vsi: *mut ice_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ice_setup_tc_mqprio_qdisc(netdev: *mut net_device, type_data: *mut c_void) -> c_int {
...
// logic to rebuild VSI, same like ethtool -L
    let mut offset: u16 = 0, qcount_tx = 0, qcount_rx = 0;
    for (i = 0; i < num_tcf; i++) {
...
// fallback to current number of queues
    ...
    if (test_bit(ICE_FLAG_TC_MQPRIO, pf.flags)) {
    let mut max_tx_rate: u64 = vsi.mqprio_qopt.max_rate[0];
    let mut min_tx_rate: u64 = vsi.mqprio_qopt.min_rate[0];
...
//
#[no_mangle]
unsafe extern "C" fn ice_cfg_txtime(tx_ring: *mut ice_tx_ring) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_open(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_open_internal(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_stop(netdev: *mut net_device) -> c_int {
    ...
    let mut link_err: c_int = ice_phy_cfg(vsi, false);
    if (link_err) {
...
//
    ...
    {
    let mut gso: bool = skb_is_gso(skb);
    size_t len;
