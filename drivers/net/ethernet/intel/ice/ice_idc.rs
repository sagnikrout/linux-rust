...
//! Source: drivers/net/ethernet/intel/ice/ice_idc.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_send_event_to_aux(pf: *mut ice_pf, event: *mut iidc_rdma_event) {
...
//
#[no_mangle]
unsafe extern "C" fn ice_adev_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_plug_aux_dev(pf: *mut ice_pf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_unplug_aux_dev(pf: *mut ice_pf) {
    ...
    pf.cdev_info.adev = core::ptr::null_mut();
    mutex_unlock(&pf.adev_mutex);
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_rdma_finalize_setup(pf: *mut ice_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_init_rdma(pf: *mut ice_pf) -> c_int {
    ...
    ret = xa_alloc(&ice_aux_id, &pf.aux_idx, core::ptr::null_mut(), XA_LIMIT(1, INT_MAX),
    GFP_KERNEL);
    if (ret) {
    ...
    err_privd_alloc:
    kfree(cdev);
    pf.cdev_info = core::ptr::null_mut();
    return ret;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ice_deinit_rdma(pf: *mut ice_pf) {
