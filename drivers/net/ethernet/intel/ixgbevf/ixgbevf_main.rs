...
//! Source: drivers/net/ethernet/intel/ixgbevf/ixgbevf_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_service_event_schedule(adapter: *mut ixgbevf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_service_event_complete(adapter: *mut ixgbevf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_remove_adapter(hw: *mut ixgbe_hw) {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_check_remove(hw: *mut ixgbe_hw, reg: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_read_reg(hw: *mut ixgbe_hw, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_get_tx_completed(ring: *mut ixgbevf_ring) -> u64 {
    static u64 ixgbevf_get_tx_completed(struct ixgbevf_ring *ring)
    {
    return ring.stats.packets;
    }
#[no_mangle]
unsafe extern "C" fn ixgbevf_get_tx_pending(ring: *mut ixgbevf_ring) -> u32 {
    static u32 ixgbevf_get_tx_pending(struct ixgbevf_ring *ring)
    {
    struct ixgbevf_adapter *adapter = netdev_priv(ring.netdev);
    struct ixgbe_hw *hw = &adapter.hw;
    let mut head: u32 = IXGBE_READ_REG(hw, IXGBE_VFTDH(ring.reg_idx));
    let mut tail: u32 = IXGBE_READ_REG(hw, IXGBE_VFTDT(ring.reg_idx));
    if (head != tail)
    return (head < tail) ?
...
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_check_tx_hang(tx_ring: *mut ixgbevf_ring) -> bool {
    static inline bool ixgbevf_check_tx_hang(struct ixgbevf_ring *tx_ring)
    {
    let mut tx_done: u32 = ixgbevf_get_tx_completed(tx_ring);
    let mut tx_done_old: u32 = tx_ring.tx_stats.tx_done_old;
    let mut tx_pending: u32 = ixgbevf_get_tx_pending(tx_ring);
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_tx_timeout_reset(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_tx_timeout(netdev: *mut net_device, txqueue: unsigned int __always_unused) {
...
//
    ...
    let mut total_bytes: c_uint = 0, total_packets = 0, total_ipsec = 0;
    let mut budget: c_uint = tx_ring.count / 2;
...
//
    ...
    let mut vid: u16 = le16_to_cpu(rx_desc.wb.upper.vlan);
...
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_rx_offset(rx_ring: *mut ixgbevf_ring) -> c_uint {
...
//
    ...
    union ixgbe_adv_rx_desc *rx_desc;
    struct ixgbevf_rx_buffer *bi;
    let mut i: c_uint = rx_ring.next_to_use;
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_can_reuse_rx_page(rx_buffer: *mut ixgbevf_rx_buffer) -> bool {
    static bool ixgbevf_can_reuse_rx_page(struct ixgbevf_rx_buffer *rx_buffer)
    {
...
//
    ...
    let mut truesize: c_uint = ixgbevf_rx_pg_size(rx_ring) / 2;
...
pub const IXGBEVF_XDP_PASS: c_int = 0;
pub const IXGBEVF_XDP_CONSUMED: c_int = 1;
pub const IXGBEVF_XDP_TX: c_int = 2;
...
// set next_to_watch value indicating a packet is present
    ...
    struct xdp_buff *xdp)
    {
    let mut result: c_int = IXGBEVF_XDP_PASS;
    ...
    unsigned int size)
    {
    let mut truesize: c_uint = ixgbevf_rx_frame_truesize(rx_ring, size);
    ...
    int budget)
    {
    let mut total_rx_bytes: c_uint = 0, total_rx_packets = 0, frame_sz = 0;
    struct ixgbevf_adapter *adapter = q_vector.adapter;
    let mut cleaned_count: u16 = ixgbevf_desc_unused(rx_ring);
    struct sk_buff *skb = rx_ring.skb;
    let mut xdp_xmit: bool = false;
    struct xdp_buff xdp;
...
// retrieve a buffer from the ring
    if (!skb) {
    let mut offset: c_uint = ixgbevf_rx_offset(rx_ring);
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_write_eitr(q_vector: *mut ixgbevf_q_vector) {
    void ixgbevf_write_eitr(struct ixgbevf_q_vector *q_vector)
    {
    struct ixgbevf_adapter *adapter = q_vector.adapter;
    struct ixgbe_hw *hw = &adapter.hw;
    let mut v_idx: c_int = q_vector.v_idx;
    let mut itr_reg: u32 = q_vector.itr & IXGBE_MAX_EITR;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_configure_msix(adapter: *mut ixgbevf_adapter) {
...
//
    ...
    {
    let mut bytes: c_int = ring_container.total_bytes;
    let mut packets: c_int = ring_container.total_packets;
    u32 timepassed_us;
    u64 bytes_perint;
    let mut itr_setting: u8 = ring_container.itr;
    if (packets == 0)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn if(10: bytes_perint <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_set_itr(q_vector: *mut ixgbevf_q_vector) {
    static void ixgbevf_set_itr(struct ixgbevf_q_vector *q_vector)
    {
    let mut new_itr: u32 = q_vector.itr;
    u8 current_itr;
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_msix_other(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_msix_clean_rings(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_request_msix_irqs(adapter: *mut ixgbevf_adapter) -> c_int {
    static int ixgbevf_request_msix_irqs(struct ixgbevf_adapter *adapter)
    {
    struct net_device *netdev = adapter.netdev;
    let mut q_vectors: c_int = adapter.num_msix_vectors - NON_Q_VECTORS;
    let mut ri: c_uint = 0, ti = 0;
    int vector, err;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_request_irq(adapter: *mut ixgbevf_adapter) -> c_int {
    static int ixgbevf_request_irq(struct ixgbevf_adapter *adapter)
    {
    let mut err: c_int = ixgbevf_request_msix_irqs(adapter);
    if (err)
    hw_dbg(&adapter.hw, "request_irq failed, Error %d\n", err);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn ixgbevf_free_irq(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_irq_disable(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_irq_enable(adapter: *mut ixgbevf_adapter) {
...
//
    ...
    let mut wait_loop: c_int = 10;
    let mut txdctl: u32 = IXGBE_TXDCTL_ENABLE;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_configure_tx(adapter: *mut ixgbevf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_setup_psrtype(adapter: *mut ixgbevf_adapter) {
...
pub const IXGBEVF_MAX_RX_DESC_POLL: c_int = 10;
    static void ixgbevf_disable_rx_queue(struct ixgbevf_adapter *adapter,
    struct ixgbevf_ring *ring)
    {
    struct ixgbe_hw *hw = &adapter.hw;
    let mut wait_loop: c_int = IXGBEVF_MAX_RX_DESC_POLL;
    u32 rxdctl;
    let mut reg_idx: u8 = ring.reg_idx;
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_init_rss_key(adapter: *mut ixgbevf_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_setup_vfmrqc(adapter: *mut ixgbevf_adapter) {
    static void ixgbevf_setup_vfmrqc(struct ixgbevf_adapter *adapter)
    {
    struct ixgbe_hw *hw = &adapter.hw;
    let mut vfmrqc: u32 = 0, vfreta = 0;
    let mut rss_i: u16 = adapter.num_rx_queues;
    u8 i, j;
...
// Limit the maximum frame size so we don't overrun the skb
    ...
    {
    struct net_device *netdev = adapter.netdev;
    let mut max_frame: c_uint = netdev.mtu + ETH_HLEN + ETH_FCS_LEN;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_configure_rx(adapter: *mut ixgbevf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_restore_vlan(adapter: *mut ixgbevf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_write_uc_addr_list(netdev: *mut net_device) -> c_int {
...
//
    hw.mac.ops.set_uc_addr(hw, 0, core::ptr::null_mut());
    }
    return count;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_set_rx_mode(netdev: *mut net_device) {
    static void ixgbevf_set_rx_mode(struct net_device *netdev)
    {
    struct ixgbevf_adapter *adapter = netdev_priv(netdev);
    struct ixgbe_hw *hw = &adapter.hw;
    let mut flags: c_uint = netdev.flags;
    int xcast_mode;
// request the most inclusive mode we need
    if (flags & IFF_PROMISC)
    xcast_mode = IXGBEVF_XCAST_MODE_PROMISC;
#[no_mangle]
pub unsafe extern "C" fn if(IFF_ALLMULTI: flags &) -> else {
    else if (flags & IFF_ALLMULTI)
    xcast_mode = IXGBEVF_XCAST_MODE_ALLMULTI;
#[no_mangle]
pub unsafe extern "C" fn if(IFF_MULTICAST): flags & (IFF_BROADCAST |) -> else {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_napi_enable_all(adapter: *mut ixgbevf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_napi_disable_all(adapter: *mut ixgbevf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_configure_dcb(adapter: *mut ixgbevf_adapter) -> c_int {
    static int ixgbevf_configure_dcb(struct ixgbevf_adapter *adapter)
    {
    struct ixgbe_hw *hw = &adapter.hw;
    let mut def_q: c_uint = 0;
    let mut num_tcs: c_uint = 0;
    let mut num_rx_queues: c_uint = adapter.num_rx_queues;
    let mut num_tx_queues: c_uint = adapter.num_tx_queues;
    int err;
    spin_lock_bh(&adapter.mbx_lock);
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_configure(adapter: *mut ixgbevf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_save_reset_stats(adapter: *mut ixgbevf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_init_last_counter_stats(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_set_features(adapter: *mut ixgbevf_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ixgbe_mbox_api_15: hw->api_version ==) -> else {
    else if (hw.api_version == ixgbe_mbox_api_15)
// pf_features |= IXGBEVF_PF_SUP_ESX_MBX;
    }
#[no_mangle]
unsafe extern "C" fn ixgbevf_negotiate_api(adapter: *mut ixgbevf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_up_complete(adapter: *mut ixgbevf_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_up(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_clean_rx_ring(rx_ring: *mut ixgbevf_ring) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_clean_tx_ring(tx_ring: *mut ixgbevf_ring) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_clean_all_rx_rings(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_clean_all_tx_rings(adapter: *mut ixgbevf_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_down(adapter: *mut ixgbevf_adapter) {
...
// disable transmits in the hardware now that interrupts are off
    for (i = 0; i < adapter.num_tx_queues; i++) {
    let mut reg_idx: u8 = adapter.tx_ring[i].reg_idx;
    IXGBE_WRITE_REG(hw, IXGBE_VFTXDCTL(reg_idx),
    IXGBE_TXDCTL_SWFLSH);
    }
    for (i = 0; i < adapter.num_xdp_queues; i++) {
    let mut reg_idx: u8 = adapter.xdp_ring[i].reg_idx;
    IXGBE_WRITE_REG(hw, IXGBE_VFTXDCTL(reg_idx),
    IXGBE_TXDCTL_SWFLSH);
    }
...
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_reinit_locked(adapter: *mut ixgbevf_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_reset(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_set_num_queues(adapter: *mut ixgbevf_adapter) {
...
// we need as many queues as traffic classes
    ...
    let mut rss: u16 = min_t(u16, num_online_cpus(), IXGBEVF_MAX_RSS_QUEUES);
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_set_interrupt_capability(adapter: *mut ixgbevf_adapter) -> c_int {
...
//
    ...
    {
    struct ixgbevf_q_vector *q_vector;
    let mut reg_idx: c_int = txr_idx + xdp_idx;
    struct ixgbevf_ring *ring;
    int ring_count, size;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_free_q_vector(adapter: *mut ixgbevf_adapter, v_idx: c_int) {
    ...
    ixgbevf_for_each_ring(ring, q_vector.tx) {
    if (ring_is_xdp(ring))
    adapter.xdp_ring[ring.queue_index] = core::ptr::null_mut();
    else
    adapter.tx_ring[ring.queue_index] = core::ptr::null_mut();
    }
    ixgbevf_for_each_ring(ring, q_vector.rx)
    adapter.rx_ring[ring.queue_index] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_alloc_q_vectors(adapter: *mut ixgbevf_adapter) -> c_int {
    static int ixgbevf_alloc_q_vectors(struct ixgbevf_adapter *adapter)
    {
    let mut q_vectors: c_int = adapter.num_msix_vectors - NON_Q_VECTORS;
    let mut rxr_remaining: c_int = adapter.num_rx_queues;
    let mut txr_remaining: c_int = adapter.num_tx_queues;
    let mut xdp_remaining: c_int = adapter.num_xdp_queues;
    let mut rxr_idx: c_int = 0, txr_idx = 0, xdp_idx = 0, v_idx = 0;
    int err;
    if (q_vectors >= (rxr_remaining + txr_remaining + xdp_remaining)) {
    for (; rxr_remaining; v_idx++, q_vectors--) {
    let mut rqpv: c_int = DIV_ROUND_UP(rxr_remaining, q_vectors);
...
// update counts and index
    ...
    let mut rqpv: c_int = DIV_ROUND_UP(rxr_remaining, q_vectors);
    let mut tqpv: c_int = DIV_ROUND_UP(txr_remaining, q_vectors);
    let mut xqpv: c_int = DIV_ROUND_UP(xdp_remaining, q_vectors);
    err = ixgbevf_alloc_q_vector(adapter, v_idx,
    tqpv, txr_idx,
    xqpv, xdp_idx,
    rqpv, rxr_idx);
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_free_q_vectors(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_reset_interrupt_capability(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_init_interrupt_scheme(adapter: *mut ixgbevf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_clear_interrupt_scheme(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_sw_init(adapter: *mut ixgbevf_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_zero_ether_addr(adapter->hw.mac.addr)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_update_stats(adapter: *mut ixgbevf_adapter) {
    void ixgbevf_update_stats(struct ixgbevf_adapter *adapter)
    {
    struct ixgbe_hw *hw = &adapter.hw;
    let mut alloc_rx_page_failed: u64 = 0, alloc_rx_buff_failed = 0;
    let mut alloc_rx_page: u64 = 0, hw_csum_rx_error = 0;
    int i;
    if (test_bit(__IXGBEVF_DOWN, &adapter.state) ||
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_service_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_reset_subtask(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_check_hang_subtask(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_watchdog_update_link(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_watchdog_link_is_up(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_watchdog_link_is_down(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_watchdog_subtask(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_service_task(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_free_tx_resources(tx_ring: *mut ixgbevf_ring) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_free_all_tx_resources(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_setup_tx_resources(tx_ring: *mut ixgbevf_ring) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_setup_all_tx_resources(adapter: *mut ixgbevf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_setup_all_rx_resources(adapter: *mut ixgbevf_adapter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_free_rx_resources(rx_ring: *mut ixgbevf_ring) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_free_all_rx_resources(adapter: *mut ixgbevf_adapter) {
    static void ixgbevf_free_all_rx_resources(struct ixgbevf_adapter *adapter)
    {
    int i;
    for (i = 0; i < adapter.num_rx_queues; i++)
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_open(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_close_suspend(adapter: *mut ixgbevf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_queue_reset_subtask(adapter: *mut ixgbevf_adapter) {
    static void ixgbevf_queue_reset_subtask(struct ixgbevf_adapter *adapter)
    {
...
// remove payload length from inner checksum
    ...
    csum_replace_by_diff(&l4.tcp.check, ( __wsum)htonl(paylen));
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_tx_cmd_type(tx_flags: u32) -> __le32 {
...
// set segmentation enable bits for TSO/FSO
    ...
    {
    let mut olinfo_status: __le32 = cpu_to_le32(paylen << IXGBE_ADVTXD_PAYLEN_SHIFT);
...
//
    ...
    let mut cmd_type: __le32 = ixgbevf_tx_cmd_type(tx_flags);
    let mut i: u16 = tx_ring.next_to_use;
    tx_desc = IXGBEVF_TX_DESC(tx_ring, i);
...
#[no_mangle]
unsafe extern "C" fn __ixgbevf_maybe_stop_tx(tx_ring: *mut ixgbevf_ring, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_maybe_stop_tx(tx_ring: *mut ixgbevf_ring, size: c_int) -> c_int {
    ...
    let mut ipsec_tx: ixgbevf_ipsec_tx_data = { 0 };

    unsigned short f;

    let mut hdr_len: u8 = 0;
    u8 *dst_mac = skb_header_pointer(skb, 0, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_xmit_frame(skb: *mut sk_buff, netdev: *mut net_device) -> netdev_tx_t {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_set_mac(netdev: *mut net_device, p: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
    static int ixgbevf_change_mtu(struct net_device *netdev, int new_mtu)
    {
    struct ixgbevf_adapter *adapter = netdev_priv(netdev);
    struct ixgbe_hw *hw = &adapter.hw;
    let mut max_frame: c_int = new_mtu + ETH_HLEN + ETH_FCS_LEN;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_suspend(dev_d: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_resume(dev_d: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_shutdown(pdev: *mut pci_dev) {
...
pub const IXGBEVF_MAX_MAC_HDR_LEN: c_int = 127;
pub const IXGBEVF_MAX_NETWORK_HDR_LEN: c_int = 511;
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_xdp_setup(dev: *mut net_device, prog: *mut bpf_prog) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_xdp(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_assign_netdev_ops(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
    static int ixgbevf_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
    {
    struct net_device *netdev;
    struct ixgbevf_adapter *adapter = core::ptr::null_mut();
    struct ixgbe_hw *hw = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_remove(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_io_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_io_resume(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_init_module() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbevf_exit_module() -> void __exit {
    static void __exit ixgbevf_exit_module(void)
    {
    pci_unregister_driver(&ixgbevf_driver);
    if (ixgbevf_wq) {
    destroy_workqueue(ixgbevf_wq);
    ixgbevf_wq = core::ptr::null_mut();
    }
    }
