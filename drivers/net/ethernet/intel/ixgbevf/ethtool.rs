...
//! Source: drivers/net/ethernet/intel/ixgbevf/ethtool.c
#![no_std]
...
pub struct ixgbe_stats {
    ...
    cmd.base.port = -1;
    if (adapter.link_up) {
    let mut speed: __u32 = SPEED_10000;
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_set_msglevel(netdev: *mut net_device, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_get_regs_len(netdev: *mut net_device) -> c_int {
    static int ixgbevf_get_regs_len(struct net_device *netdev)
    {
pub const IXGBE_REGS_LEN: c_int = 45;
    ...
    u32 *regs_buff = p;
    let mut regs_len: u32 = ixgbevf_get_regs_len(netdev);
    u8 i;
    memset(p, 0, regs_len);
...
// Transmit
    ...
    {
    struct ixgbevf_adapter *adapter = netdev_priv(netdev);
    struct ixgbevf_ring *tx_ring = core::ptr::null_mut(), *rx_ring = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_get_sset_count(netdev: *mut net_device, stringset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_link_test(adapter: *mut ixgbevf_adapter, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_reg_test(adapter: *mut ixgbevf_adapter, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_nway_reset(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_get_rx_ring_count(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_get_rxfh_indir_size(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_get_priv_flags(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ixgbevf_set_priv_flags(netdev: *mut net_device, priv_flags: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ixgbevf_set_ethtool_ops(netdev: *mut net_device) {
