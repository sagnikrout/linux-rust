...
//! Source: drivers/net/ethernet/intel/ixgbevf/mbx.h
#![no_std]
...
pub const IXGBE_VFMAILBOX_REQ: c_uint = 0x00000001 /* Request for PF Ready bit */;
pub const IXGBE_VFMAILBOX_ACK: c_uint = 0x00000002 /* Ack PF message received */;
pub const IXGBE_VFMAILBOX_VFU: c_uint = 0x00000004 /* VF owns the mailbox buffer */;
pub const IXGBE_VFMAILBOX_PFU: c_uint = 0x00000008 /* PF owns the mailbox buffer */;
pub const IXGBE_VFMAILBOX_PFSTS: c_uint = 0x00000010 /* PF wrote a message in the MB */;
pub const IXGBE_VFMAILBOX_PFACK: c_uint = 0x00000020 /* PF ack the previous VF msg */;
pub const IXGBE_VFMAILBOX_RSTI: c_uint = 0x00000040 /* PF has reset indication */;
pub const IXGBE_VFMAILBOX_RSTD: c_uint = 0x00000080 /* PF has indicated reset done */;
pub const IXGBE_VFMAILBOX_R2C_BITS: c_uint = 0x000000B0 /* All read to clear bits */;
...
//
pub const IXGBE_VT_MSGTYPE_SUCCESS: c_uint = 0x80000000 /* Messages or'd with this;
// have succeeded
//
pub const IXGBE_VT_MSGTYPE_FAILURE: c_uint = 0x40000000 /* Messages or'd with this;
// have failed
//
...
pub const IXGBE_VF_GET_QUEUE: c_uint = 0x09 /* get queue configuration */;
// GET_QUEUES return data indices within the mailbox

// mailbox API, version 1.2 VF requests
pub const IXGBE_VF_GET_RETA: c_uint = 0x0a	/* VF request for RETA */;
pub const IXGBE_VF_GET_RSS_KEY: c_uint = 0x0b	/* get RSS hash key */;
