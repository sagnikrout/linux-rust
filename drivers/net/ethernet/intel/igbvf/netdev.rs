...
//! Source: drivers/net/ethernet/intel/igbvf/netdev.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_desc_unused(ring: *mut igbvf_ring) -> c_int {
...
//
    ...
    vid = be16_to_cpu(( __be16)vlan) & E1000_RXD_SPC_VLAN_MASK;
    else
...
//
    ...
    buffer_info.page = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_clean_tx_ring(tx_ring: *mut igbvf_ring) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igbvf_free_tx_resources(tx_ring: *mut igbvf_ring) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_clean_rx_ring(rx_ring: *mut igbvf_ring) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igbvf_free_rx_resources(rx_ring: *mut igbvf_ring) {
...
//
    ...
    {
    let mut retval: enum latency_range = itr_setting;
    if (packets == 0)
...
#[no_mangle]
unsafe extern "C" fn igbvf_range_to_itr(current_range: enum latency_range) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igbvf_set_itr(adapter: *mut igbvf_adapter) {
...
// conservative mode (itr 3) eliminates the lowest_latency setting
    ...
    let mut current_itr: u32 = adapter.tx_ring.itr_val;
...
//
    ...
    let mut current_itr: u32 = adapter.rx_ring.itr_val;
    new_itr = new_itr > current_itr ?
    min(current_itr + (new_itr >> 2), new_itr) :
    new_itr;
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_clean_tx_irq(tx_ring: *mut igbvf_ring) -> bool {
...
// clear next_to_watch to prevent false hangs
    buffer_info.next_to_watch = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn igbvf_msix_other(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn igbvf_intr_msix_tx(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn igbvf_intr_msix_rx(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_configure_msix(adapter: *mut igbvf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igbvf_reset_interrupt_capability(adapter: *mut igbvf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_set_interrupt_capability(adapter: *mut igbvf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_request_msix(adapter: *mut igbvf_adapter) -> c_int {
    static int igbvf_request_msix(struct igbvf_adapter *adapter)
    {
    struct net_device *netdev = adapter.netdev;
    let mut err: c_int = 0, vector = 0;
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_alloc_queues(adapter: *mut igbvf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_request_irq(adapter: *mut igbvf_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igbvf_free_irq(adapter: *mut igbvf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_irq_disable(adapter: *mut igbvf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_irq_enable(adapter: *mut igbvf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int igbvf_poll(struct napi_struct *napi, int budget)
    {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_set_rlpml(adapter: *mut igbvf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igbvf_restore_vlan(adapter: *mut igbvf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_configure_tx(adapter: *mut igbvf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_setup_srrctl(adapter: *mut igbvf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_configure_rx(adapter: *mut igbvf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_set_multi(netdev: *mut net_device) {
    static void igbvf_set_multi(struct net_device *netdev)
    {
    struct igbvf_adapter *adapter = netdev_priv(netdev);
    struct e1000_hw *hw = &adapter.hw;
    struct netdev_hw_addr *ha;
    u8  *mta_list = core::ptr::null_mut();
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_set_uni(netdev: *mut net_device) -> c_int {
...
// Clear all unicast MAC filters
    hw.mac.ops.set_uc_addr(hw, E1000_VF_MAC_FILTER_CLR, core::ptr::null_mut());
    spin_unlock_bh(&hw.mbx_lock);
...
#[no_mangle]
unsafe extern "C" fn igbvf_set_rx_mode(netdev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_configure(adapter: *mut igbvf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_reset(adapter: *mut igbvf_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn igbvf_up(adapter: *mut igbvf_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn igbvf_down(adapter: *mut igbvf_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn igbvf_reinit_locked(adapter: *mut igbvf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_sw_init(adapter: *mut igbvf_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igbvf_initialize_last_counter_stats(adapter: *mut igbvf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_open(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_close(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_set_mac(netdev: *mut net_device, p: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn igbvf_update_stats(adapter: *mut igbvf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igbvf_print_link_info(adapter: *mut igbvf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igbvf_has_link(adapter: *mut igbvf_adapter) -> bool {
    static bool igbvf_has_link(struct igbvf_adapter *adapter)
    {
    struct e1000_hw *hw = &adapter.hw;
    let mut ret_val: i32 = E1000_SUCCESS;
    bool link_active;
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_watchdog(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn igbvf_watchdog_task(work: *mut work_struct) {
...
pub const IGBVF_TX_FLAGS_CSUM: c_uint = 0x00000001;
pub const IGBVF_TX_FLAGS_VLAN: c_uint = 0x00000002;
pub const IGBVF_TX_FLAGS_TSO: c_uint = 0x00000004;
pub const IGBVF_TX_FLAGS_IPV4: c_uint = 0x00000008;
pub const IGBVF_TX_FLAGS_VLAN_MASK: c_uint = 0xffff0000;
pub const IGBVF_TX_FLAGS_VLAN_SHIFT: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn igbvf_maybe_stop_tx(netdev: *mut net_device, size: c_int) -> c_int {
...
pub const IGBVF_MAX_TXD_PWR: c_int = 16;
...
// clear timestamp and dma mappings for remaining portion of packet
    ...
    u8 hdr_len)
    {
    union e1000_adv_tx_desc *tx_desc = core::ptr::null_mut();
    struct igbvf_buffer *buffer_info;
    let mut olinfo_status: u32 = 0, cmd_type_len;
    unsigned int i;
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_tx_timeout(netdev: *mut net_device, txqueue: unsigned int __always_unused) {
...
#[no_mangle]
unsafe extern "C" fn igbvf_reset_task(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(2048: max_frame <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn igbvf_ioctl(netdev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igbvf_suspend(dev_d: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igbvf_resume(dev_d: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igbvf_shutdown(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_netpoll(netdev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_io_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_io_resume(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_io_prepare(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_io_reset_done(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn igbvf_print_device_info(adapter: *mut igbvf_adapter) {
...
pub const IGBVF_MAX_MAC_HDR_LEN: c_int = 127;
pub const IGBVF_MAX_NETWORK_HDR_LEN: c_int = 511;
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_remove(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_init_module() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn igbvf_exit_module() -> void __exit {
