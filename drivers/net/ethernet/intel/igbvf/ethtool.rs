...
//! Source: drivers/net/ethernet/intel/igbvf/ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn igbvf_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn igbvf_set_msglevel(netdev: *mut net_device, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn igbvf_get_regs_len(netdev: *mut net_device) -> c_int {
    static int igbvf_get_regs_len(struct net_device *netdev)
    {
pub const IGBVF_REGS_LEN: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn igbvf_get_eeprom_len(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igbvf_link_test(adapter: *mut igbvf_adapter, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igbvf_nway_reset(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igbvf_get_sset_count(dev: *mut net_device, stringset: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn igbvf_set_ethtool_ops(netdev: *mut net_device) {
