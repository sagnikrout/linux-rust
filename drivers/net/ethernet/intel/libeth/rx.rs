...
//! Source: drivers/net/ethernet/intel/libeth/rx.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn libeth_rx_hw_len_mtu(pp: *const page_pool_params, max_len: u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn libeth_rx_fq_create(fq: *mut libeth_fq, napi_dev: *mut c_void) -> c_int {
    int libeth_rx_fq_create(struct libeth_fq *fq, void *napi_dev)
    {
    struct napi_struct *napi = fq.no_napi ? core::ptr::null_mut() : napi_dev;
    struct page_pool_params pp = {
    ...
    .netdev		= napi ? napi.dev : core::ptr::null_mut(),
    .napi		= napi,
    };
...
//
#[no_mangle]
pub unsafe extern "C" fn libeth_rx_fq_destroy(fq: *mut libeth_fq) {
...
//
#[no_mangle]
pub unsafe extern "C" fn libeth_rx_recycle_slow(netmem: netmem_ref) -> void __cold {
...
//
#[no_mangle]
pub unsafe extern "C" fn libeth_rx_pt_gen_hash_type(pt: *mut libeth_rx_pt) {
