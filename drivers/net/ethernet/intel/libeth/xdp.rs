...
//! Source: drivers/net/ethernet/intel/libeth/xdp.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __acquires(_arg: &lock->lock) {
...
#[no_mangle]
pub unsafe extern "C" fn __releases(_arg: &lock->lock) {
...
//
    ...
    let mut left: u32 = bq.count - sent;
...
#[no_mangle]
pub unsafe extern "C" fn if(LIBETH_XDP_TX_NDO): !(flags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn __libeth_xdp_return_stash(stash: *mut libeth_xdp_buff_stash) {
    void __libeth_xdp_return_stash(struct libeth_xdp_buff_stash *stash)
    {
    LIBETH_XDP_ONSTACK_BUFF(xdp);
    libeth_xdp_load_stash(xdp, stash);
    libeth_xdp_return_buff_slow(xdp);
    stash.data = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn libeth_xdp_return_buff_slow(xdp: *mut libeth_xdp_buff) -> void __cold {
...
//
    ...
    u32 len)
    {
    let mut netmem: netmem_ref = fqe.netmem;
...
//
#[no_mangle]
pub unsafe extern "C" fn libeth_xdp_queue_threshold(count: u32) -> u32 {
...
//
    ...
    dev.xsk_tx_metadata_ops = zc_segs ? tmo : core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn libeth_xdp_set_redirect(dev: *mut net_device, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn libeth_xdp_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn libeth_xdp_module_exit() -> void __exit {
