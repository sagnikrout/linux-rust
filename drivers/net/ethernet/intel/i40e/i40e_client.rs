...
//! Source: drivers/net/ethernet/intel/i40e/i40e_client.c
#![no_std]
...
//
    static
#[no_mangle]
pub unsafe extern "C" fn i40e_client_get_params(vsi: *mut i40e_vsi, params: *mut i40e_params) -> c_int {
    ...
    let mut tc: u8 = dcb_cfg.etscfg.prioritytable[i];
    u16 qs_handle;
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_notify_client_of_l2_param_changes(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_client_release_qvlist(ldev: *mut i40e_info) {
    ...
    ldev.qvlist_info = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_notify_client_of_netdev_close(pf: *mut i40e_pf, reset: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_notify_client_of_vf_reset(pf: *mut i40e_pf, vf_id: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_notify_client_of_vf_enable(pf: *mut i40e_pf, num_vfs: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_vf_client_capable(pf: *mut i40e_pf, vf_id: u32) -> c_int {
    int i40e_vf_client_capable(struct i40e_pf *pf, u32 vf_id)
    {
    struct i40e_client_instance *cdev = pf.cinst;
    let mut capable: c_int = false;
    if (!cdev || !cdev.client)
    goto out;
...
#[no_mangle]
pub unsafe extern "C" fn i40e_client_update_msix_info(pf: *mut i40e_pf) {
...
#[no_mangle]
unsafe extern "C" fn i40e_auxiliary_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn i40e_register_auxiliary_dev(ldev: *mut i40e_info, name: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_client_add_instance(pf: *mut i40e_pf) {
    static void i40e_client_add_instance(struct i40e_pf *pf)
    {
    struct i40e_vsi *vsi = i40e_pf_get_main_vsi(pf);
    struct i40e_client_instance *cdev = core::ptr::null_mut();
    struct netdev_hw_addr *mac = core::ptr::null_mut();
...
//
    static
#[no_mangle]
pub unsafe extern "C" fn i40e_client_del_instance(pf: *mut i40e_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_client_subtask(pf: *mut i40e_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_lan_add_device(pf: *mut i40e_pf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_lan_del_device(pf: *mut i40e_pf) -> c_int {
...
// TODO: for now do not allow setting VF's VSI setting
    ...
    err = i40e_aq_get_vsi_params(&pf.hw, &ctxt, core::ptr::null_mut());
    ...
    if (update) {
    err = i40e_aq_update_vsi_params(&vsi.back.hw, &ctxt, core::ptr::null_mut());
    if (err) {
    dev_info(&pf.pdev.dev,
...
#[no_mangle]
pub unsafe extern "C" fn i40e_client_device_register(ldev: *mut i40e_info, client: *mut i40e_client) {
...
#[no_mangle]
pub unsafe extern "C" fn i40e_client_device_unregister(ldev: *mut i40e_info) {
    ...
    pf.cinst.client = core::ptr::null_mut();
