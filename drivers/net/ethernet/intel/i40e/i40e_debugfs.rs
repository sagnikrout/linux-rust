...
//! Source: drivers/net/ethernet/intel/i40e/i40e_debugfs.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dbg_dump_vsi_seid(pf: *mut i40e_pf, seid: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dbg_dump_aq_desc(pf: *mut i40e_pf) {
...
//
    ...
    {
    let mut is_rx_ring: bool = type == RING_TYPE_RX;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dbg_dump_vsi_no_seid(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dbg_dump_veb_seid(pf: *mut i40e_pf, seid: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dbg_dump_veb_all(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dbg_dump_vf(pf: *mut i40e_pf, vf_id: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dbg_dump_vf_all(pf: *mut i40e_pf) {
...
// check the range on address
    ...
    ret = i40e_asq_send_command(&pf.hw, desc, core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (!ret) {
...
// Get main VSI
    ...
    int ret;
    ret = i40e_aq_stop_lldp(&pf.hw, false, false, core::ptr::null_mut());
    if (ret) {
    dev_info(&pf.pdev.dev,
    ...
    main_vsi.seid, 0, true, core::ptr::null_mut(),
    core::ptr::null_mut());
    if (ret) {
    dev_info(&pf.pdev.dev,
    ...
    ret = i40e_aq_add_rem_control_packet_filter(&pf.hw,
    pf.hw.mac.addr, ETH_P_LLDP, 0,
    main_vsi.seid, 0, false, core::ptr::null_mut(),
    core::ptr::null_mut());
    if (ret) {
    dev_info(&pf.pdev.dev,
...
// Continue and start FW LLDP anyways
    ...
    ret = i40e_aq_start_lldp(&pf.hw, false, core::ptr::null_mut());
    if (ret) {
    dev_info(&pf.pdev.dev,
...
// read at least 1k bytes, no more than 4kB
    ...
    bytes, (u8 *)buff, true, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_dbg_pf_init(pf: *mut i40e_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_dbg_pf_exit(pf: *mut i40e_pf) {
    void i40e_dbg_pf_exit(struct i40e_pf *pf)
    {
    debugfs_remove_recursive(pf.i40e_dbg_pf);
    pf.i40e_dbg_pf = core::ptr::null_mut();
    }
//
// i40e_dbg_init - start up debugfs for the driver
//
#[no_mangle]
pub unsafe extern "C" fn i40e_dbg_init() {
    void i40e_dbg_init(void)
    {
    i40e_dbg_root = debugfs_create_dir(i40e_driver_name, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_dbg_exit() {
    void i40e_dbg_exit(void)
    {
    debugfs_remove_recursive(i40e_dbg_root);
    i40e_dbg_root = core::ptr::null_mut();
    }
