...
//! Source: drivers/net/ethernet/intel/i40e/i40e_dcb_nl.c
#![no_std]
...
pub const I40E_DCBNL_STATUS_SUCCESS: c_int = 0;
pub const I40E_DCBNL_STATUS_ERROR: c_int = 1;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_get_pfc_delay(hw: *mut i40e_hw, delay: *mut u16) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dcbnl_getstate(netdev: *mut net_device) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dcbnl_setstate(netdev: *mut net_device, state: u8) -> u8 {
    static u8 i40e_dcbnl_setstate(struct net_device *netdev, u8 state)
    {
    struct i40e_pf *pf = i40e_netdev_to_pf(netdev);
    let mut ret: c_int = I40E_DCBNL_STATUS_SUCCESS;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dcbnl_cee_set_all(netdev: *mut net_device) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dcbnl_get_cap(netdev: *mut net_device, capid: c_int, cap: *mut u8) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dcbnl_getnumtcs(netdev: *mut net_device, tcid: c_int, num: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dcbnl_setnumtcs(netdev: *mut net_device, tcid: c_int, num: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dcbnl_getpfcstate(netdev: *mut net_device) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dcbnl_setpfcstate(netdev: *mut net_device, state: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dcbnl_getapp(netdev: *mut net_device, idtype: u8, id: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dcbnl_setdcbx(netdev: *mut net_device, mode: u8) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dcbnl_getdcbx(dev: *mut net_device) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_dcbnl_set_all(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_dcbnl_setup(vsi: *mut i40e_vsi) {
