...
//! Source: drivers/net/ethernet/intel/i40e/i40e_main.c
#![no_std]
...
pub const I40E_MAX_VF_COUNT: c_int = 128;
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_free_dma_mem(hw: *mut i40e_hw, mem: *mut i40e_dma_mem) -> c_int {
    int i40e_free_dma_mem(struct i40e_hw *hw, struct i40e_dma_mem *mem)
    {
    struct i40e_pf *pf = i40e_hw_to_pf(hw);
    dma_free_coherent(&pf.pdev.dev, mem.size, mem.va, mem.pa);
    mem.va = core::ptr::null_mut();
    mem.pa = 0;
    mem.size = 0;
    return 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_free_virt_mem(hw: *mut i40e_hw, mem: *mut i40e_virt_mem) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_put_lump(pile: *mut i40e_lump_tracking, index: u16, id: u16) -> c_int {
    static int i40e_put_lump(struct i40e_lump_tracking *pile, u16 index, u16 id)
    {
    let mut valid_id: c_int = (id | I40E_PILE_VALID_BIT);
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_service_event_schedule(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
    static void i40e_tx_timeout(struct net_device *netdev, unsigned int txqueue)
    {
    struct i40e_netdev_priv *np = netdev_priv(netdev);
    struct i40e_vsi *vsi = np.vsi;
    struct i40e_pf *pf = vsi.back;
    struct i40e_ring *tx_ring = core::ptr::null_mut();
    unsigned int i;
    u32 head, val;
    pf.tx_timeout_count++;
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_vsi_reset_stats(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_pf_reset_stats(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_compute_pci_to_hw_id(vsi: *mut i40e_vsi, hw: *mut i40e_hw) -> u32 {
    static u32 i40e_compute_pci_to_hw_id(struct i40e_vsi *vsi, struct i40e_hw *hw)
    {
    let mut pf_count: c_int = i40e_get_pf_count(hw);
...
//
#[no_mangle]
unsafe extern "C" fn i40e_stat_update_and_clear32(hw: *mut i40e_hw, reg: u32, stat: *mut u64) {
    static void i40e_stat_update_and_clear32(struct i40e_hw *hw, u32 reg, u64 *stat)
    {
    let mut new_data: u32 = rd32(hw, reg);
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_update_eth_stats(vsi: *mut i40e_vsi) {
    void i40e_update_eth_stats(struct i40e_vsi *vsi)
    {
    let mut stat_idx: c_int = le16_to_cpu(vsi.info.stat_counter_idx);
    struct i40e_pf *pf = vsi.back;
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_update_veb_stats(veb: *mut i40e_veb) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_update_vsi_stats(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_update_pf_stats(pf: *mut i40e_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_update_stats(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_count_all_filters(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_count_active_filters(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_is_vsi_in_vlan(vsi: *mut i40e_vsi) -> bool {
...
//
    ...
    int vlan_filters)
    {
    let mut pvid: i16 = le16_to_cpu(vsi.info.pvid);
...
// Update the filters about to be added in place
    ...
    new.f.vlan = pvid;
#[no_mangle]
pub unsafe extern "C" fn if(I40E_VLAN_ANY: vlan_filters && new->f->vlan ==) -> else {
    else if (vlan_filters && new.f.vlan == I40E_VLAN_ANY)
    new.f.vlan = 0;
#[no_mangle]
pub unsafe extern "C" fn if(0: !vlan_filters && new->f->vlan ==) -> else {
...
// Determine the new vlan we will be adding
    ...
    new_vlan = pvid;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: vlan_filters) -> else {
...
//
    ...
    new_mac.f.vlan = i40e_get_vf_new_vlan(vsi, new_mac, core::ptr::null_mut(),
    vlan_filters, trusted);
    }
    hash_for_each_safe(vsi.mac_filter_hash, bkt, h, f, hlist) {
    new_vlan = i40e_get_vf_new_vlan(vsi, core::ptr::null_mut(), f, vlan_filters,
    trusted);
    if (new_vlan != f.vlan) {
    add_head = i40e_add_filter(vsi, f.macaddr, new_vlan);
    if (!add_head)
...
//
#[no_mangle]
unsafe extern "C" fn i40e_rm_default_mac_filter(vsi: *mut i40e_vsi, macaddr: *mut u8) {
...
// Ignore error returns, some firmware does it this way...
    ...
    i40e_aq_remove_macvlan(&pf.hw, vsi.seid, &element, 1, core::ptr::null_mut());
    memset(&element, 0, sizeof(element));
    ether_addr_copy(element.mac_addr, macaddr);
    element.vlan_tag = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn __i40e_del_filter(vsi: *mut i40e_vsi, f: *mut i40e_mac_filter) {
...
//
    ...
    const u8 *macaddr)
    {
    struct i40e_mac_filter *f, *add = core::ptr::null_mut();
    struct hlist_node *h;
    int bkt;
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_del_mac_filter(vsi: *mut i40e_vsi, macaddr: *const u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_set_mac(netdev: *mut net_device, p: *mut c_void) -> c_int {
...
//
    ...
    addr.sa_data, core::ptr::null_mut());
    if (ret)
...
//
    ...
    if (lut) {
    let mut pf_lut: bool = vsi.type == I40E_VSI_MAIN;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_config_rss(vsi: *mut i40e_vsi) -> c_int {
...
//
    ...
    u8 enabled_tc)
    {
    let mut qcount: u16 = 0, max_qcount, qmap, sections = 0;
    int i, override_q, pow, num_qps, ret;
    let mut netdev_tc: u8 = 0, offset = 0;
    if (vsi.type != I40E_VSI_MAIN)
    return -EINVAL;
...
//
    ...
    {
    struct i40e_pf *pf = vsi.back;
    let mut num_tc_qps: u16 = 0;
    let mut sections: u16 = 0;
    let mut netdev_tc: u8 = 0;
    let mut numtc: u16 = 1;
    u16 qcount;
    u8 offset;
    u16 qmap;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(I40E_FLAG_MSIX_ENA, _arg: pf->flags)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_addr_sync(netdev: *mut net_device, addr: *const u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_addr_unsync(netdev: *mut net_device, addr: *const u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_set_rx_mode(netdev: *mut net_device) {
...
//
    ...
    let mut key: u64 = i40e_addr_to_hkey(f.macaddr);
...
//
    ...
    int aq_ret;
    aq_ret = i40e_aq_remove_macvlan_v2(hw, vsi.seid, list, num_del, core::ptr::null_mut(),
    &aq_status);
...
//
    ...
    enum libie_aq_err aq_status;
    int fcnt;
    i40e_aq_add_macvlan_v2(hw, vsi.seid, list, num_add, core::ptr::null_mut(), &aq_status);
...
//
#[no_mangle]
unsafe extern "C" fn i40e_set_promiscuous(pf: *mut i40e_pf, promisc: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_sync_vsi_filters(vsi: *mut i40e_vsi) -> c_int {
    int i40e_sync_vsi_filters(struct i40e_vsi *vsi)
    {
    struct hlist_head tmp_add_list, tmp_del_list;
    struct i40e_mac_filter *f;
    struct i40e_new_mac_filter *new, *add_head = core::ptr::null_mut();
    struct i40e_hw *hw = &vsi.back.hw;
    bool old_overflow, new_overflow;
    let mut failed_filters: c_uint = 0;
    let mut vlan_filters: c_uint = 0;
    char vsi_name[16] = "PF";
    let mut filter_list_len: c_int = 0;
    let mut changed_flags: u32 = 0;
    struct hlist_node *h;
    struct i40e_pf *pf;
    let mut num_add: c_int = 0;
    let mut num_del: c_int = 0;
    let mut aq_ret: c_int = 0;
    let mut retval: c_int = 0;
    u16 cmd_flags;
    int list_size;
    int bkt;
...
#[no_mangle]
pub unsafe extern "C" fn if(I40E_VSI_MAIN: vsi->type !=) -> else {
...
//
    ...
    vlan_filters);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pf->vf) -> else {
    else if (pf.vf)
...
// Determine the number of active and failed filters.
    ...
    vsi.active_filters++;
#[no_mangle]
pub unsafe extern "C" fn if(I40E_FILTER_FAILED: f->state ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_sync_filters_subtask(pf: *mut i40e_pf) {
    ...
    let mut ret: c_int = i40e_sync_vsi_filters(vsi);
    if (ret) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_calculate_vsi_rx_buf_len(vsi: *mut i40e_vsi) -> u16 {
...
//
    ...
    {
    let mut rx_buf_len: u16 = i40e_calculate_vsi_rx_buf_len(vsi);
    u16 chain_len;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_vlan_stripping_enable(vsi: *mut i40e_vsi) {
...
// Don't modify stripping options if a port VLAN is active
    ...
    ctxt.seid = vsi.seid;
    ctxt.info = vsi.info;
    ret = i40e_aq_update_vsi_params(&vsi.back.hw, &ctxt, core::ptr::null_mut());
    if (ret) {
    dev_info(&vsi.back.pdev.dev,
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_vlan_stripping_disable(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_add_vlan_all_mac(vsi: *mut i40e_vsi, vid: i16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_vsi_add_vlan(vsi: *mut i40e_vsi, vid: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_rm_vlan_all_mac(vsi: *mut i40e_vsi, vid: i16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_vsi_kill_vlan(vsi: *mut i40e_vsi, vid: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_restore_vlan(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_vsi_add_pvid(vsi: *mut i40e_vsi, vid: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_vsi_remove_pvid(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_setup_tx_resources(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_free_tx_resources(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_setup_rx_resources(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_free_rx_resources(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_config_xps_tx_ring(ring: *mut i40e_ring) {
...
//
    ...
    {
    let mut xdp_on: bool = i40e_enabled_xdp_vsi(ring.vsi);
    let mut qid: c_int = ring.queue_index;
    if (ring_is_xdp(ring))
...
//
#[no_mangle]
unsafe extern "C" fn i40e_configure_tx_ring(ring: *mut i40e_ring) -> c_int {
    static int i40e_configure_tx_ring(struct i40e_ring *ring)
    {
    struct i40e_vsi *vsi = ring.vsi;
    let mut pf_q: u16 = vsi.base_queue + ring.queue_index;
    struct i40e_hw *hw = &vsi.back.hw;
    struct i40e_hmc_obj_txq tx_ctx;
    let mut qtx_ctl: u32 = 0;
    let mut err: c_int = 0;
    if (ring_is_xdp(ring))
...
//
#[no_mangle]
unsafe extern "C" fn i40e_rx_offset(rx_ring: *mut i40e_ring) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_configure_rx_ring(ring: *mut i40e_ring) -> c_int {
    static int i40e_configure_rx_ring(struct i40e_ring *ring)
    {
    struct i40e_vsi *vsi = ring.vsi;
    let mut chain_len: u32 = vsi.back.hw.func_caps.rx_buf_chain_len;
    let mut pf_q: u16 = vsi.base_queue + ring.queue_index;
    struct i40e_hw *hw = &vsi.back.hw;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_configure_tx(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_configure_rx(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_config_dcb_rings(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_set_vsi_rx_mode(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_reset_fdir_filter_cnt(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_fdir_filter_restore(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_configure(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_configure_msix(vsi: *mut i40e_vsi) {
    static void i40e_vsi_configure_msix(struct i40e_vsi *vsi)
    {
    let mut has_xdp: bool = i40e_enabled_xdp_vsi(vsi);
    struct i40e_pf *pf = vsi.back;
    struct i40e_hw *hw = &pf.hw;
    u16 vector;
    int i, q;
...
// begin of linked list for RX queue assigned to this vector
    ...
    let mut nextqp: u32 = has_xdp ? qp + vsi.alloc_queue_pairs : qp;
    u32 val;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_enable_misc_int_causes(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_configure_msi_and_legacy(vsi: *mut i40e_vsi) {
    static void i40e_configure_msi_and_legacy(struct i40e_vsi *vsi)
    {
    let mut nextqp: u32 = i40e_enabled_xdp_vsi(vsi) ? vsi.alloc_queue_pairs : 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_irq_dynamic_disable_icr0(pf: *mut i40e_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_irq_dynamic_enable_icr0(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_msix_clean_rings(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_request_irq_msix(vsi: *mut i40e_vsi, basename: *mut c_char) -> c_int {
    static int i40e_vsi_request_irq_msix(struct i40e_vsi *vsi, char *basename)
    {
    let mut q_vectors: c_int = vsi.num_q_vectors;
    struct i40e_pf *pf = vsi.back;
    let mut base: c_int = vsi.base_vector;
    let mut rx_int_idx: c_int = 0;
    let mut tx_int_idx: c_int = 0;
    int vector, err;
    int irq_num;
    int cpu;
...
//
    ...
    vector--;
    irq_num = pf.msix_entries[base + vector].vector;
    irq_set_affinity_notifier(irq_num, core::ptr::null_mut());
    irq_update_affinity_hint(irq_num, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_disable_irq(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_enable_irq(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_free_misc_vector(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// disable any further VFLR event notifications
    ...
    let mut reg: u32 = rd32(hw, I40E_PFINT_ICR0_ENA);
    ...
    let mut prttsyn_stat: u32 = rd32(hw, I40E_PRTTSYN_STAT_0);
...
//
#[no_mangle]
unsafe extern "C" fn i40e_clean_fdir_tx_irq(tx_ring: *mut i40e_ring, budget: c_int) -> bool {
...
// clear next_to_watch to prevent false hangs
    tx_buf.next_to_watch = core::ptr::null_mut();
...
// unmap skb header data
    ...
    tx_buf.raw_buf = core::ptr::null_mut();
    tx_buf.tx_flags = 0;
    tx_buf.next_to_watch = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn i40e_fdir_clean_ring(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_map_vector_to_qp(vsi: *mut i40e_vsi, v_idx: c_int, qp_idx: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_map_rings_to_vectors(vsi: *mut i40e_vsi) {
    static void i40e_vsi_map_rings_to_vectors(struct i40e_vsi *vsi)
    {
    let mut qp_remaining: c_int = vsi.num_queue_pairs;
    let mut q_vectors: c_int = vsi.num_q_vectors;
    int num_ringpairs;
    let mut v_start: c_int = 0;
    let mut qp_idx: c_int = 0;
...
//
    ...
    q_vector.rx.count = 0;
    q_vector.tx.count = 0;
    q_vector.rx.ring = core::ptr::null_mut();
    q_vector.tx.ring = core::ptr::null_mut();
    while (num_ringpairs--) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_request_irq(vsi: *mut i40e_vsi, basename: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(I40E_FLAG_MSI_ENA, _arg: pf->flags)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_netpoll(netdev: *mut net_device) {
...
pub const I40E_QTX_ENA_WAIT_COUNT: c_int = 50;
//
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pf_txq_wait(pf: *mut i40e_pf, pf_q: c_int, enable: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_control_tx_q(pf: *mut i40e_pf, pf_q: c_int, enable: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_enable_tx(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pf_rxq_wait(pf: *mut i40e_pf, pf_q: c_int, enable: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_control_rx_q(pf: *mut i40e_pf, pf_q: c_int, enable: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_control_wait_rx_q(pf: *mut i40e_pf, pf_q: c_int, enable: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_enable_rx(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_vsi_start_rings(vsi: *mut i40e_vsi) -> c_int {
...
pub const I40E_DISABLE_TX_GAP_MSEC: c_int = 50;
//
// i40e_vsi_stop_rings - Stop a VSI's rings
// @vsi: the VSI being configured
//
#[no_mangle]
pub unsafe extern "C" fn i40e_vsi_stop_rings(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_vsi_stop_rings_no_wait(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_free_irq(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_free_q_vector(vsi: *mut i40e_vsi, v_idx: c_int) {
...
// disassociate q_vector from rings
    ...
    ring.q_vector = core::ptr::null_mut();
    i40e_for_each_ring(ring, q_vector.rx)
    ring.q_vector = core::ptr::null_mut();
// only VSI w/ an associated netdev is set up w/ NAPI
    if (vsi.netdev)
    netif_napi_del(&q_vector.napi);
    vsi.q_vectors[v_idx] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_free_q_vectors(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_reset_interrupt_capability(pf: *mut i40e_pf) {
...
// If we're in Legacy mode, the interrupt was cleaned in vsi_close
    ...
    pf.msix_entries = core::ptr::null_mut();
    kfree(pf.irq_pile);
    pf.irq_pile = core::ptr::null_mut();
    } else if (test_bit(I40E_FLAG_MSI_ENA, pf.flags)) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_clear_interrupt_scheme(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_napi_enable_all(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_napi_disable_all(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_close(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_quiesce_vsi(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_unquiesce_vsi(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pf_quiesce_all_vsi(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pf_unquiesce_all_vsi(pf: *mut i40e_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_vsi_wait_queues_disabled(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pf_wait_queues_disabled(pf: *mut i40e_pf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_get_iscsi_tc_map(pf: *mut i40e_pf) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dcb_get_num_tc(dcbcfg: *mut i40e_dcbx_config) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dcb_get_enabled_tc(dcbcfg: *mut i40e_dcbx_config) -> u8 {
    static u8 i40e_dcb_get_enabled_tc(struct i40e_dcbx_config *dcbcfg)
    {
    let mut num_tc: u8 = i40e_dcb_get_num_tc(dcbcfg);
    let mut enabled_tc: u8 = 1;
    u8 i;
    for (i = 0; i < num_tc; i++)
    enabled_tc |= BIT(i);
    return enabled_tc;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_mqprio_get_enabled_tc(pf: *mut i40e_pf) -> u8 {
    static u8 i40e_mqprio_get_enabled_tc(struct i40e_pf *pf)
    {
    struct i40e_vsi *vsi = i40e_pf_get_main_vsi(pf);
    let mut num_tc: u8 = vsi.mqprio_qopt.qopt.num_tc;
    let mut enabled_tc: u8 = 1, i;
    for (i = 1; i < num_tc; i++)
    enabled_tc |= BIT(i);
    return enabled_tc;
    }
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pf_get_num_tc(pf: *mut i40e_pf) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pf_get_tc_map(pf: *mut i40e_pf) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_get_bw_info(vsi: *mut i40e_vsi) -> c_int {
    static int i40e_vsi_get_bw_info(struct i40e_vsi *vsi)
    {
    let mut bw_ets_config: i40e_aqc_query_vsi_ets_sla_config_resp = {0};
    let mut bw_config: i40e_aqc_query_vsi_bw_config_resp = {0};
    struct i40e_pf *pf = vsi.back;
    struct i40e_hw *hw = &pf.hw;
    u32 tc_bw_max;
    int ret;
...
// Get the VSI level BW configuration
    ret = i40e_aq_query_vsi_bw_config(hw, vsi.seid, &bw_config, core::ptr::null_mut());
    if (ret) {
    dev_info(&pf.pdev.dev,
...
// There is no need to reset BW when mqprio mode is on.
    ...
    ret = i40e_aq_config_vsi_tc_bw(&pf.hw, vsi.seid, &bw_data, core::ptr::null_mut());
    if (ret) {
    dev_info(&pf.pdev.dev,
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_config_netdev_tc(vsi: *mut i40e_vsi, enabled_tc: u8) {
...
// Get the actual TC# for the UP
    let mut ets_tc: u8 = dcbcfg.etscfg.prioritytable[i];
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_update_adq_vsi_queues(vsi: *mut i40e_vsi, vsi_offset: c_int) -> c_int {
    int i40e_update_adq_vsi_queues(struct i40e_vsi *vsi, int vsi_offset)
    {
    let mut ctxt: i40e_vsi_context = {};
    struct i40e_pf *pf;
    struct i40e_hw *hw;
    int ret;
    if (!vsi)
    ...
    ret = i40e_aq_update_vsi_params(hw, &ctxt, core::ptr::null_mut());
    if (ret) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_config_tc(vsi: *mut i40e_vsi, enabled_tc: u8) -> c_int {
...
// Enable ETS TCs with equal BW Share for now across all VSIs
    ...
    let mut valid_tc: u8 = bw_config.tc_valid_bits & enabled_tc;
    if (!valid_tc)
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_reconfig_tc(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_get_link_speed(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_bw_bytes_to_mbits(vsi: *mut i40e_vsi, max_tx_rate: u64) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_set_bw_limit(vsi: *mut i40e_vsi, seid: u16, max_tx_rate: u64) -> c_int {
...
// Tx rate credits are in values of 50Mbps, 0 is disabled
    ...
    I40E_MAX_BW_INACTIVE_ACCUM, core::ptr::null_mut());
    if (ret)
    dev_err(&pf.pdev.dev,
...
//
#[no_mangle]
unsafe extern "C" fn i40e_remove_queue_channels(vsi: *mut i40e_vsi) {
...
// Reset queue contexts
    ...
    tx_ring.ch = core::ptr::null_mut();
    rx_ring = vsi.rx_rings[pf_q];
    rx_ring.ch = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn i40e_get_max_queues_for_channel(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_reconfig_rss(vsi: *mut i40e_vsi, rss_size: u16) -> c_int {
...
// Now time to create VSI
    ret = i40e_aq_add_vsi(hw, &ctxt, core::ptr::null_mut());
    if (ret) {
    dev_info(&pf.pdev.dev,
...
//
#[no_mangle]
unsafe extern "C" fn i40e_validate_and_set_switch_mode(vsi: *mut i40e_vsi) -> c_int {
...
// configure VSI for BW limit
    if (ch.max_tx_rate) {
    let mut credits: u64 = ch.max_tx_rate;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_configure_queue_channels(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_veb_config_tc(veb: *mut i40e_veb, enabled_tc: u8) -> c_int {
    int i40e_veb_config_tc(struct i40e_veb *veb, u8 enabled_tc)
    {
    let mut bw_data: i40e_aqc_configure_switching_comp_bw_config_data = {0};
    struct i40e_pf *pf = veb.pf;
    let mut ret: c_int = 0;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_dcb_reconfigure(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_resume_port_tx(pf: *mut i40e_pf) -> c_int {
    static int i40e_resume_port_tx(struct i40e_pf *pf)
    {
    struct i40e_hw *hw = &pf.hw;
    int ret;
    ret = i40e_aq_resume_port_tx(hw, core::ptr::null_mut());
    if (ret) {
    dev_info(&pf.pdev.dev,
...
//
#[no_mangle]
unsafe extern "C" fn i40e_suspend_port_tx(pf: *mut i40e_pf) -> c_int {
    static int i40e_suspend_port_tx(struct i40e_pf *pf)
    {
    struct i40e_hw *hw = &pf.hw;
    int ret;
    ret = i40e_aq_suspend_port_tx(hw, pf.mac_seid, core::ptr::null_mut());
    if (ret) {
    dev_info(&pf.pdev.dev,
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_hw_dcb_config(pf: *mut i40e_pf, new_cfg: *mut i40e_dcbx_config) -> c_int {
    ...
    struct i40e_hw *hw = &pf.hw;
    let mut num_ports: u8 = hw.num_ports;
    bool need_reconfig;
    let mut ret: c_int = -EINVAL;
    let mut lltc_map: u8 = 0;
    let mut tc_map: u8 = 0;
    u8 new_numtc;
    u8 i;
...
// Configure Port ETS Tx Scheduler
    ...
    i40e_aqc_opc_modify_switching_comp_ets, core::ptr::null_mut());
    if (ret) {
    dev_info(&pf.pdev.dev,
...
// Inform the FW about changes to DCB configuration
    ret = i40e_aq_dcb_updated(&pf.hw, core::ptr::null_mut());
    if (ret) {
    dev_info(&pf.pdev.dev,
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_dcb_sw_default_config(pf: *mut i40e_pf) -> c_int {
...
// Enable ETS on the Physical port
    ...
    (hw, pf.mac_seid, &ets_data,
    i40e_aqc_opc_enable_switching_comp_ets, core::ptr::null_mut());
    if (err) {
    dev_info(&pf.pdev.dev,
...
//
#[no_mangle]
unsafe extern "C" fn i40e_init_pf_dcb(pf: *mut i40e_pf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_print_link_message(vsi: *mut i40e_vsi, isup: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_up_complete(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_reinit_locked(vsi: *mut i40e_vsi) {
    static void i40e_vsi_reinit_locked(struct i40e_vsi *vsi)
    {
    struct i40e_pf *pf = vsi.back;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_force_link_state(pf: *mut i40e_pf, is_up: bool) -> c_int {
    static int i40e_force_link_state(struct i40e_pf *pf, bool is_up)
    {
    struct i40e_aq_get_phy_abilities_resp abilities;
    let mut config: i40e_aq_set_phy_config = {0};
    let mut non_zero_phy_type: bool = is_up;
    struct i40e_hw *hw = &pf.hw;
    u64 mask;
    u8 speed;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn if(0: is_up && abilities.phy_type != 0 && abilities.link_speed !=) -> else {
...
// Copy the old settings, except of phy_type
    ...
    err = i40e_aq_set_phy_config(hw, &config, core::ptr::null_mut());
    if (err) {
    dev_err(&pf.pdev.dev,
...
//
    ...
    i40e_aq_set_link_restart_an(hw, is_up, core::ptr::null_mut());
    return 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_up(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_down(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_set_default_tc_config(vsi: *mut i40e_vsi) {
...
//
    ...
    element.vlan_tag = 0;
    element.flags = I40E_AQC_MACVLAN_DEL_PERFECT_MATCH;
    status = i40e_aq_remove_macvlan(hw, seid, &element, 1, core::ptr::null_mut());
...
//
    ...
    status = i40e_aq_add_macvlan(hw, seid, &element, 1, core::ptr::null_mut());
// aq_err = hw->aq.asq_last_status;
    return status;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn i40e_reset_ch_rings(vsi: *mut i40e_vsi, ch: *mut i40e_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_free_macvlan_channels(vsi: *mut i40e_vsi) {
...
//
    ...
    {
    struct i40e_channel *ch = core::ptr::null_mut(), *ch_tmp, *iter;
    let mut ret: c_int = 0, num_tc = 1,  i, aq_err;
    struct i40e_pf *pf = vsi.back;
    struct i40e_hw *hw = &pf.hw;
...
// if we cannot add the MAC rule then disable the offload
    ...
    pf_q = ch.base_queue + i;
    rx_ring = vsi.rx_rings[pf_q];
    rx_ring.netdev = core::ptr::null_mut();
    }
    dev_info(&pf.pdev.dev,
...
//
    ...
    {
    struct i40e_netdev_priv *np = netdev_priv(netdev);
    let mut q_per_macvlan: u16 = 0, macvlan_cnt = 0, vectors;
    struct i40e_vsi *vsi = np.vsi;
    struct i40e_pf *pf = vsi.back;
    struct i40e_fwd_adapter *fwd;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_del_all_macvlans(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_fwd_del(netdev: *mut net_device, vdev: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_setup_tc(netdev: *mut net_device, type_data: *mut c_void) -> c_int {
    ...
    struct i40e_vsi *vsi = np.vsi;
    struct i40e_pf *pf = vsi.back;
    let mut enabled_tc: u8 = 0, num_tc, hw;
...
// Configure VSI for enabled TCs
    ...
    if (!ret) {
    let mut credits: u64 = max_tx_rate;
    do_div(credits, I40E_BW_CREDIT_DIVISOR);
    dev_dbg(&vsi.back.pdev.dev,
    "Set tx rate of %llu Mbps (count of 50Mbps %llu) for vsi.seid %u\n",
    max_tx_rate,
...
//
    ...
    let mut n_proto_mask: u16 = 0, n_proto_key = 0, addr_type = 0;
    struct i40e_pf *pf = vsi.back;
    let mut field_flags: u8 = 0;
...
//
    ...
    {
    let mut tc: c_int = tc_classid_to_hwtc(vsi.netdev, cls_flower.classid);
    struct i40e_cloud_filter *filter = core::ptr::null_mut();
    struct i40e_pf *pf = vsi.back;
    let mut err: c_int = 0;
    if (tc < 0) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_open(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_netif_set_realnum_tx_rx_queues(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_vsi_open(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_fdir_filter_exit(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_cloud_filter_exit(pf: *mut i40e_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_close(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_do_reset(pf: *mut i40e_pf, reset_flags: u32, lock_acquired: bool) {
...
//
    ...
    struct i40e_dcbx_config *new_cfg)
    {
    let mut need_reconfig: bool = false;
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_do_reset_safe(pf: *mut i40e_pf, reset_flags: u32) {
...
//
    ...
    let mut queue: u32 = le32_to_cpu(data.prtdcb_rupto);
    let mut qtx_ctl: u32 = le32_to_cpu(data.otx_ctl);
    struct i40e_hw *hw = &pf.hw;
    struct i40e_vf *vf;
    u16 vf_id;
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_get_current_fd_count(pf: *mut i40e_pf) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_get_global_fd_count(pf: *mut i40e_pf) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_reenable_fdir_sb(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_reenable_fdir_atr(pf: *mut i40e_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_fdir_check_and_reenable(pf: *mut i40e_pf) {
...
pub const I40E_MIN_FD_FLUSH_INTERVAL: c_int = 10;
pub const I40E_MIN_FD_FLUSH_SB_ATR_UNSTABLE: c_int = 30;
//
// i40e_fdir_flush_and_replay - Function to flush all FD filters and replay SB
// @pf: board private structure
//
#[no_mangle]
unsafe extern "C" fn i40e_fdir_flush_and_replay(pf: *mut i40e_pf) {
    static void i40e_fdir_flush_and_replay(struct i40e_pf *pf)
    {
    unsigned long min_flush_time;
    let mut flush_wait_retry: c_int = 50;
    let mut disable_atr: bool = false;
    int fd_room;
    int reg;
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_get_current_atr_cnt(pf: *mut i40e_pf) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_fdir_reinit_subtask(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_link_event(vsi: *mut i40e_vsi, link_up: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_veb_link_event(veb: *mut i40e_veb, link_up: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_link_event(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_watchdog_subtask(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_reset_subtask(pf: *mut i40e_pf) {
    static void i40e_reset_subtask(struct i40e_pf *pf)
    {
    let mut reset_flags: u32 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_clean_adminq_subtask(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_verify_eeprom(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_enable_pf_switch_lb(pf: *mut i40e_pf) {
    ...
    ctxt.vf_num = 0;
    ret = i40e_aq_get_vsi_params(&pf.hw, &ctxt, core::ptr::null_mut());
    if (ret) {
    dev_info(&pf.pdev.dev,
...
//
#[no_mangle]
unsafe extern "C" fn i40e_disable_pf_switch_lb(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_config_bridge_mode(veb: *mut i40e_veb) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_reconstitute_veb(veb: *mut i40e_veb) -> c_int {
    static int i40e_reconstitute_veb(struct i40e_veb *veb)
    {
    struct i40e_vsi *ctl_vsi = core::ptr::null_mut();
    struct i40e_pf *pf = veb.pf;
    struct i40e_vsi *vsi;
    int v, ret;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_fdir_sb_setup(pf: *mut i40e_pf) {
    static void i40e_fdir_sb_setup(struct i40e_pf *pf)
    {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_fdir_teardown(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_rebuild_cloud_filters(vsi: *mut i40e_vsi, seid: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_rebuild_channels(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_clean_xps_state(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_prep_for_reset(pf: *mut i40e_pf) {
    static void i40e_prep_for_reset(struct i40e_pf *pf)
    {
    struct i40e_hw *hw = &pf.hw;
    struct i40e_vsi *vsi;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_send_version(pf: *mut i40e_pf) {
    ...
    i40e_aq_send_driver_version(&pf.hw, &dv, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn i40e_get_oem_version(hw: *mut i40e_hw) {
    static void i40e_get_oem_version(struct i40e_hw *hw)
    {
    let mut block_offset: u16 = 0xffff;
    let mut block_length: u16 = 0;
    let mut capabilities: u16 = 0;
    let mut gen_snap: u16 = 0;
    let mut release: u16 = 0;
pub const I40E_SR_NVM_OEM_VERSION_PTR: c_uint = 0x1B;
pub const I40E_NVM_OEM_LENGTH_OFFSET: c_uint = 0x00;
pub const I40E_NVM_OEM_CAPABILITIES_OFFSET: c_uint = 0x01;
pub const I40E_NVM_OEM_GEN_OFFSET: c_uint = 0x02;
pub const I40E_NVM_OEM_RELEASE_OFFSET: c_uint = 0x03;
pub const I40E_NVM_OEM_CAPABILITIES_MASK: c_uint = 0x000F;
pub const I40E_NVM_OEM_LENGTH: c_int = 3;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_reset(pf: *mut i40e_pf) -> c_int {
    static int i40e_reset(struct i40e_pf *pf)
    {
    struct i40e_hw *hw = &pf.hw;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_rebuild(pf: *mut i40e_pf, reinit: bool, lock_acquired: bool) {
    static void i40e_rebuild(struct i40e_pf *pf, bool reinit, bool lock_acquired)
    {
    let mut is_recovery_mode_reported: bool = i40e_check_recovery_mode(pf);
    struct i40e_vsi *vsi = i40e_pf_get_main_vsi(pf);
    struct i40e_hw *hw = &pf.hw;
    struct i40e_veb *veb;
    int ret;
...
//
    if (i40e_is_tc_mqprio_enabled(pf)) {
    i40e_aq_set_dcb_parameters(hw, false, core::ptr::null_mut());
    } else {
    if (I40E_IS_X710TL_DEVICE(hw.device_id) &&
    (hw.phy.link_info.link_speed &
    (I40E_LINK_SPEED_2_5GB | I40E_LINK_SPEED_5GB))) {
    ...
    i40e_aq_set_dcb_parameters(hw, true, core::ptr::null_mut());
...
//
    ...
    I40E_AQ_EVENT_MODULE_QUAL_FAIL), core::ptr::null_mut());
    if (ret)
...
//
pub const I40E_REG_MSS: c_uint = 0x000E64DC;
pub const I40E_REG_MSS_MIN_MASK: c_uint = 0x3FF0000;
pub const I40E_64BYTE_MSS: c_uint = 0x400000;
    ...
    msleep(75);
    ret = i40e_aq_set_link_restart_an(&pf.hw, true, core::ptr::null_mut());
    if (ret)
...
//
#[no_mangle]
unsafe extern "C" fn i40e_handle_reset_warning(pf: *mut i40e_pf, lock_acquired: bool) {
    static void i40e_handle_reset_warning(struct i40e_pf *pf, bool lock_acquired)
    {
    i40e_prep_for_reset(pf);
...
//
#[no_mangle]
unsafe extern "C" fn i40e_print_vfs_mdd_events(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_handle_mdd_event(pf: *mut i40e_pf) {
    static void i40e_handle_mdd_event(struct i40e_pf *pf)
    {
    struct i40e_hw *hw = &pf.hw;
    let mut mdd_detected: bool = false;
    struct i40e_vf *vf;
    u32 reg;
    int i;
...
// find what triggered the MDD event
    ...
    let mut pf_num: u8 = FIELD_GET(I40E_GL_MDET_TX_PF_NUM_MASK, reg);
    let mut vf_num: u16 = FIELD_GET(I40E_GL_MDET_TX_VF_NUM_MASK, reg);
    let mut event: u8 = FIELD_GET(I40E_GL_MDET_TX_EVENT_MASK, reg);
    ...
    let mut func: u8 = FIELD_GET(I40E_GL_MDET_RX_FUNCTION_MASK, reg);
    let mut event: u8 = FIELD_GET(I40E_GL_MDET_RX_EVENT_MASK, reg);
...
// see if one of the VFs needs its hand slapped
    ...
    let mut is_mdd_on_tx: bool = false;
    let mut is_mdd_on_rx: bool = false;
    vf = &(pf.vf[i]);
...
//
#[no_mangle]
unsafe extern "C" fn i40e_service_task(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_service_timer(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_set_num_rings_in_vsi(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_alloc_arrays(vsi: *mut i40e_vsi, alloc_qvectors: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_mem_alloc(pf: *mut i40e_pf, type: enum i40e_vsi_type) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_free_arrays(vsi: *mut i40e_vsi, free_qvectors: bool) {
    static void i40e_vsi_free_arrays(struct i40e_vsi *vsi, bool free_qvectors)
    {
// free the ring and vector containers
    if (free_qvectors) {
    kfree(vsi.q_vectors);
    vsi.q_vectors = core::ptr::null_mut();
    }
    kfree(vsi.tx_rings);
    vsi.tx_rings = core::ptr::null_mut();
    vsi.rx_rings = core::ptr::null_mut();
    vsi.xdp_rings = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn i40e_clear_rss_config_user(vsi: *mut i40e_vsi) {
    static void i40e_clear_rss_config_user(struct i40e_vsi *vsi)
    {
    if (!vsi)
    return;
    kfree(vsi.rss_hkey_user);
    vsi.rss_hkey_user = core::ptr::null_mut();
    kfree(vsi.rss_lut_user);
    vsi.rss_lut_user = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_clear(vsi: *mut i40e_vsi) -> c_int {
    static int i40e_vsi_clear(struct i40e_vsi *vsi)
    {
    struct i40e_pf *pf;
    if (!vsi)
    ...
    mutex_lock(&pf.switch_mutex);
    if (!pf.vsi[vsi.idx]) {
    dev_err(&pf.pdev.dev, "pf.vsi[%d] is core::ptr::null_mut(), just free vsi[%d](type %d)\n",
...
// updates the PF for this cleared vsi
    ...
    pf.vsi[vsi.idx] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_clear_rings(vsi: *mut i40e_vsi) {
    ...
    WRITE_ONCE(vsi.tx_rings[i], core::ptr::null_mut());
    WRITE_ONCE(vsi.rx_rings[i], core::ptr::null_mut());
    if (vsi.xdp_rings)
    WRITE_ONCE(vsi.xdp_rings[i], core::ptr::null_mut());
    }
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn i40e_alloc_rings(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_reserve_msix_vectors(pf: *mut i40e_pf, vectors: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_init_msix(pf: *mut i40e_pf) -> c_int {
    ...
    int v_budget, i;
    int v_actual;
    let mut iwarp_requested: c_int = 0;
    if (!test_bit(I40E_FLAG_MSIX_ENA, pf.flags))
    return -ENODEV;
...
// can we reserve enough for iWARP?
    ...
    pf.num_iwarp_msix = 0;
#[no_mangle]
pub unsafe extern "C" fn if(pf->num_iwarp_msix: vectors_left <) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_alloc_q_vector(vsi: *mut i40e_vsi, v_idx: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_alloc_q_vectors(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_init_interrupt_scheme(pf: *mut i40e_pf) -> c_int {
    static int i40e_init_interrupt_scheme(struct i40e_pf *pf)
    {
    let mut vectors: c_int = 0;
    ssize_t size;
    if (test_bit(I40E_FLAG_MSIX_ENA, pf.flags)) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_restore_interrupt_scheme(pf: *mut i40e_pf) -> c_int {
    static int i40e_restore_interrupt_scheme(struct i40e_pf *pf)
    {
    struct i40e_vsi *vsi;
    int err, i;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_setup_misc_vector_for_recovery_mode(pf: *mut i40e_pf) -> c_int {
    static int i40e_setup_misc_vector_for_recovery_mode(struct i40e_pf *pf)
    {
    int err;
    if (test_bit(I40E_FLAG_MSIX_ENA, pf.flags)) {
    ...
    let mut flags: u32 = test_bit(I40E_FLAG_MSI_ENA, pf.flags) ? 0 : IRQF_SHARED;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_setup_misc_vector(pf: *mut i40e_pf) -> c_int {
    static int i40e_setup_misc_vector(struct i40e_pf *pf)
    {
    struct i40e_hw *hw = &pf.hw;
    let mut err: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_config_rss(vsi: *mut i40e_vsi, seed: *mut u8, lut: *mut u8, lut_size: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_get_rss(vsi: *mut i40e_vsi, seed: *mut u8, lut: *mut u8, lut_size: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pf_config_rss(pf: *mut i40e_pf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_reconfig_rss_queues(pf: *mut i40e_pf, queue_count: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_get_partition_bw_setting(pf: *mut i40e_pf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_set_partition_bw_setting(pf: *mut i40e_pf) -> c_int {
...
// Set the new bandwidths
    status = i40e_aq_configure_partition_bw(&pf.hw, &bw_data, core::ptr::null_mut());
    return status;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn i40e_is_total_port_shutdown_enabled(pf: *mut i40e_pf) -> bool {
    static bool i40e_is_total_port_shutdown_enabled(struct i40e_pf *pf)
    {

pub const I40E_FEATURES_ENABLE_PTR: c_uint = 0x2A;
pub const I40E_CURRENT_SETTING_PTR: c_uint = 0x2B;
pub const I40E_LINK_BEHAVIOR_WORD_OFFSET: c_uint = 0x2D;
pub const I40E_LINK_BEHAVIOR_WORD_LENGTH: c_uint = 0x1;

pub const I40E_LINK_BEHAVIOR_PORT_BIT_LENGTH: c_int = 4;
    let mut sr_emp_sr_settings_ptr: u16 = 0;
    let mut features_enable: u16 = 0;
    let mut link_behavior: u16 = 0;
    let mut read_status: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_sw_init(pf: *mut i40e_pf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_set_ntuple(pf: *mut i40e_pf, features: netdev_features_t) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_clear_rss_lut(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_set_loopback(vsi: *mut i40e_vsi, ena: bool) -> c_int {
    ...
    if (if_running)
    i40e_down(vsi);
    ret = i40e_aq_set_mac_loopback(&vsi.back.hw, ena, core::ptr::null_mut());
    if (ret)
...
//
    ...
    struct i40e_hw *hw = &np.vsi.back.hw;
    int ret;
    ret = i40e_aq_del_udp_tunnel(hw, ti.hw_priv, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_multicast_ether_addr(addr)) -> else {
...
// Find the HW bridge for the PF VSI
    ...
    0, 0, nlflags, filter_mask, core::ptr::null_mut());
    }
//
...
//
    ...
    struct netlink_ext_ack *extack)
    {
    let mut frame_size: c_int = i40e_max_vsi_frame_size(vsi, prog);
    struct i40e_pf *pf = vsi.back;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_enter_busy_conf(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_exit_busy_conf(vsi: *mut i40e_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_queue_pair_reset_stats(vsi: *mut i40e_vsi, queue_pair: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_queue_pair_clean_rings(vsi: *mut i40e_vsi, queue_pair: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_queue_pair_enable_irq(vsi: *mut i40e_vsi, queue_pair: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_queue_pair_disable_irq(vsi: *mut i40e_vsi, queue_pair: c_int) {
...
//
    if (test_bit(I40E_FLAG_MSIX_ENA, pf.flags)) {
    let mut intpf: u32 = vsi.base_vector + rxr.q_vector.v_idx;
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_queue_pair_disable(vsi: *mut i40e_vsi, queue_pair: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_queue_pair_enable(vsi: *mut i40e_vsi, queue_pair: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_config_netdev(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_delete(vsi: *mut i40e_vsi) {
    static void i40e_vsi_delete(struct i40e_vsi *vsi)
    {
// remove default VSI is not allowed
    if (vsi == vsi.back.vsi[vsi.back.lan_vsi])
    return;
    i40e_aq_delete_element(&vsi.back.hw, vsi.seid, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_is_vsi_uplink_mode_veb(vsi: *mut i40e_vsi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_add_vsi(vsi: *mut i40e_vsi) -> c_int {
    static int i40e_add_vsi(struct i40e_vsi *vsi)
    {
    let mut ret: c_int = -ENODEV;
    struct i40e_pf *pf = vsi.back;
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_vsi_release(vsi: *mut i40e_vsi) -> c_int {
...
// clear the sync flag on all filters
    if (vsi.netdev) {
    __dev_uc_unsync(vsi.netdev, core::ptr::null_mut());
    __dev_mc_unsync(vsi.netdev, core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn i40e_vsi_setup_vectors(vsi: *mut i40e_vsi) -> c_int {
...
// map all of the rings to the q_vectors
    ...
    if (vsi.type == I40E_VSI_MAIN)
    i40e_devlink_destroy_port(pf);
    i40e_aq_delete_element(&pf.hw, vsi.seid, core::ptr::null_mut());
    err_vsi:
    i40e_vsi_clear(vsi);
    return core::ptr::null_mut();
    }
...
//
    ...
    {
    struct i40e_vsi *vsi = core::ptr::null_mut();
    struct i40e_veb *veb = core::ptr::null_mut();
    u16 alloc_queue_pairs;
    int v_idx;
    int ret;
...
//
    ...
    vsi.tc_config.enabled_tc);
#[no_mangle]
pub unsafe extern "C" fn if(0: (vsi->flags & I40E_VSI_FLAG_VEB_OWNER) ==) -> else {
...
// get vsi sw struct
    ...
    pf.lan_vsi = v_idx;
#[no_mangle]
pub unsafe extern "C" fn if(I40E_VSI_SRIOV: type ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_veb_get_bw_info(veb: *mut i40e_veb) -> c_int {
    static int i40e_veb_get_bw_info(struct i40e_veb *veb)
    {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_veb_mem_alloc(pf: *mut i40e_pf) -> c_int {
...
//
    i = 0;
    while ((i < I40E_MAX_VEB) && (pf.veb[i] != core::ptr::null_mut()))
    i++;
    if (i >= I40E_MAX_VEB) {
    ret = -ENOMEM;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_switch_branch_release(branch: *mut i40e_veb) {
    static void i40e_switch_branch_release(struct i40e_veb *branch)
    {
    struct i40e_pf *pf = branch.pf;
    let mut branch_seid: u16 = branch.seid;
    let mut veb_idx: u16 = branch.idx;
    struct i40e_vsi *vsi;
    struct i40e_veb *veb;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_veb_clear(veb: *mut i40e_veb) {
    ...
    pf.veb[veb.idx] = core::ptr::null_mut();
    mutex_unlock(&pf.switch_mutex);
    }
    kfree(veb);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_veb_release(veb: *mut i40e_veb) {
...
// For regular VEB move the owner VSI to uplink port
    ...
    i40e_aq_delete_element(&pf.hw, veb.seid, core::ptr::null_mut());
    i40e_veb_clear(veb);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn i40e_add_veb(veb: *mut i40e_veb, vsi: *mut i40e_vsi) -> c_int {
    static int i40e_add_veb(struct i40e_veb *veb, struct i40e_vsi *vsi)
    {
    struct i40e_pf *pf = veb.pf;
    let mut enable_stats: bool = !!test_bit(I40E_FLAG_VEB_STATS_ENA, pf.flags);
    int ret;
    ret = i40e_aq_add_veb(&pf.hw, veb.uplink_seid, vsi ? vsi.seid : 0,
    veb.enabled_tc, vsi ? false : true,
    &veb.seid, enable_stats, core::ptr::null_mut());
...
// get statistics counter
    ret = i40e_aq_get_veb_parameters(&pf.hw, veb.seid, core::ptr::null_mut(), core::ptr::null_mut(),
    &veb.stats_idx, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    if (ret) {
    dev_info(&pf.pdev.dev,
...
//
    ...
    {
    let mut downlink_seid: u16 = le16_to_cpu(ele.downlink_seid);
    let mut uplink_seid: u16 = le16_to_cpu(ele.uplink_seid);
    let mut element_type: u8 = ele.element_type;
    let mut seid: u16 = le16_to_cpu(ele.seid);
    struct i40e_veb *veb;
    if (printconfig)
    dev_info(&pf.pdev.dev,
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_fetch_switch_configuration(pf: *mut i40e_pf, printconfig: bool) -> c_int {
    int i40e_fetch_switch_configuration(struct i40e_pf *pf, bool printconfig)
    {
    struct i40e_aqc_get_switch_config_resp *sw_config;
    let mut next_seid: u16 = 0;
    let mut ret: c_int = 0;
    u8 *aq_buf;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_setup_pf_switch(pf: *mut i40e_pf, reinit: bool, lock_acquired: bool) -> c_int {
    static int i40e_setup_pf_switch(struct i40e_pf *pf, bool reinit, bool lock_acquired)
    {
    struct i40e_vsi *main_vsi;
    let mut flags: u16 = 0;
...
//
    ...
    uplink_seid, 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: reinit) -> else {
    else if (reinit)
...
//
#[no_mangle]
unsafe extern "C" fn i40e_determine_queue_usage(pf: *mut i40e_pf) {
    static void i40e_determine_queue_usage(struct i40e_pf *pf)
    {
    int queues_left;
    int q_max;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_setup_pf_filter_control(pf: *mut i40e_pf) -> c_int {
    static int i40e_setup_pf_filter_control(struct i40e_pf *pf)
    {
...
pub const INFO_STRING_LEN: c_int = 255;

#[no_mangle]
unsafe extern "C" fn i40e_print_features(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_get_platform_mac_addr(pdev: *mut pci_dev, pf: *mut i40e_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_set_fec_in_flags(fec_cfg: u8, flags: *mut c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_check_recovery_mode(pf: *mut i40e_pf) -> bool {
    static bool i40e_check_recovery_mode(struct i40e_pf *pf)
    {
    let mut val: u32 = rd32(&pf.hw, I40E_GL_FWSTS);
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pf_loop_reset(pf: *mut i40e_pf) -> c_int {
    static int i40e_pf_loop_reset(struct i40e_pf *pf)
    {
// wait max 10 seconds for PF reset to succeed
    let mut time_end: c_ulong = jiffies + 10 * HZ;
    struct i40e_hw *hw = &pf.hw;
    int ret;
    ret = i40e_pf_reset(hw);
...
//
#[no_mangle]
unsafe extern "C" fn i40e_check_fw_empr(pf: *mut i40e_pf) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_handle_resets(pf: *mut i40e_pf) -> c_int {
    static int i40e_handle_resets(struct i40e_pf *pf)
    {
    let mut pfr: c_int = i40e_pf_loop_reset(pf);
    let mut is_empr: bool = i40e_check_fw_empr(pf);
    if (is_empr || pfr != 0)
...
//
#[no_mangle]
unsafe extern "C" fn i40e_init_recovery_mode(pf: *mut i40e_pf, hw: *mut i40e_hw) -> c_int {
    static int i40e_init_recovery_mode(struct i40e_pf *pf, struct i40e_hw *hw)
    {
    struct i40e_vsi *vsi;
    int err;
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_set_subsystem_device_id(hw: *mut i40e_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
// provide nvm, fw, api versions, vendor:device id, subsys vendor:device id
    ...
    I40E_FW_MINOR_VERSION(hw));
#[no_mangle]
pub unsafe extern "C" fn if(_arg: i40e_is_aq_api_ver_lt(hw, _arg: 1, _arg: 4)) -> else {
...
//
    ...
    i40e_aq_stop_lldp(hw, true, false, core::ptr::null_mut());
    }
...
//
    ...
    if (test_bit(I40E_HW_CAP_RESTART_AUTONEG, pf.hw.caps)) {
    msleep(75);
    err = i40e_aq_set_link_restart_an(&pf.hw, true, core::ptr::null_mut());
    if (err)
    dev_info(&pf.pdev.dev, "link restart failed, err %pe aq_err %s\n",
    ERR_PTR(err),
    libie_aq_str(pf.hw.aq.asq_last_status));
...
pub const PCI_SPEED_SIZE: c_int = 8;
pub const PCI_WIDTH_SIZE: c_int = 8;
...
// get the requested speeds from the fw
    err = i40e_aq_get_phy_capabilities(hw, false, false, &abilities, core::ptr::null_mut());
    if (err)
...
// get the supported phy types from the fw
    err = i40e_aq_get_phy_capabilities(hw, false, true, &abilities, core::ptr::null_mut());
    if (err)
    dev_dbg(&pf.pdev.dev, "get supported phy types ret =  %pe last_status =  %s\n",
    ERR_PTR(err), libie_aq_str(pf.hw.aq.asq_last_status));
pub const MAX_FRAME_SIZE_DEFAULT: c_uint = 0x2600;
    err = i40e_aq_set_mac_config(hw, MAX_FRAME_SIZE_DEFAULT, core::ptr::null_mut());
    if (err)
...
//
#[no_mangle]
unsafe extern "C" fn i40e_remove(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_enable_mc_magic_wake(pf: *mut i40e_pf) {
...
//
    ...
    ret = i40e_aq_mac_address_write(hw, flags, mac_addr, core::ptr::null_mut());
    if (ret) {
    dev_err(&pf.pdev.dev,
...
//
#[no_mangle]
unsafe extern "C" fn i40e_io_suspend(pf: *mut i40e_pf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_io_resume(pf: *mut i40e_pf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pci_error_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pci_error_reset_prepare(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pci_error_reset_done(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pci_error_resume(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_shutdown(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_resume(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_init_module() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_exit_module() -> void __exit {
