...
//! Source: drivers/net/ethernet/intel/i40e/i40e_ptp.c
#![no_std]
...
//
pub const I40E_PTP_40GB_INCVAL: c_uint = 0x0199999999ULL;
pub const I40E_PTP_10GB_INCVAL_MULT: c_int = 2;
pub const I40E_PTP_5GB_INCVAL_MULT: c_int = 2;
pub const I40E_PTP_1GB_INCVAL_MULT: c_int = 20;
pub const I40E_ISGN: c_uint = 0x80000000;
pub const I40E_SUBDEV_ID_25G_PTP_PIN: c_uint = 0xB;
    enum i40e_ptp_pin {
    SDP3_2 = 0,
    SDP3_3,
    GPIO_4
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i40e_ptp_pins_settings {
    pub sdp3_2: enum i40e_ptp_gpio_pin_state,
    pub sdp3_3: enum i40e_ptp_gpio_pin_state,
    pub gpio_4: enum i40e_ptp_gpio_pin_state,
    pub led2_0: enum i40e_ptp_led_pin_state,
    pub led2_1: enum i40e_ptp_led_pin_state,
    pub led3_0: enum i40e_ptp_led_pin_state,
    pub led3_1: enum i40e_ptp_led_pin_state,
}
...
//
#[no_mangle]
unsafe extern "C" fn i40e_ptp_extts0_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_is_ptp_pin_dev(hw: *mut i40e_hw) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_can_set_pins(pf: *mut i40e_pf) -> enum i40e_can_set_pins {
...
//
#[no_mangle]
unsafe extern "C" fn i40_ptp_reset_timing_events(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_ptp_write(pf: *mut i40e_pf, ts: *const timespec64) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_ptp_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_ptp_set_1pps_signal_hw(pf: *mut i40e_pf) {
    ...
    i40e_ptp_read(pf, &now, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn i40e_ptp_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pin_state(index: c_int, func: c_int) -> enum i40e_ptp_gpio_pin_state {
    static enum i40e_ptp_gpio_pin_state i40e_pin_state(int index, int func)
    {
    let mut state: enum i40e_ptp_gpio_pin_state = off;
...
//
    ...
    {
    enum i40e_ptp_gpio_pin_state *pin = core::ptr::null_mut();
    struct i40e_ptp_pins_settings pins;
    int pin_index;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_ptp_get_rx_events(pf: *mut i40e_pf) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_ptp_rx_hang(pf: *mut i40e_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_ptp_tx_hang(pf: *mut i40e_pf) {
...
//
    ...
    skb = pf.ptp_tx_skb;
    pf.ptp_tx_skb = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_ptp_tx_hwtstamp(pf: *mut i40e_pf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_ptp_rx_hwtstamp(pf: *mut i40e_pf, skb: *mut sk_buff, index: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_ptp_set_increment(pf: *mut i40e_pf) {
    ...
    i40e_aq_get_link_info(&pf.hw, true, core::ptr::null_mut(), core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_ptp_free_pins(pf: *mut i40e_pf) {
    void i40e_ptp_free_pins(struct i40e_pf *pf)
    {
    if (i40e_is_ptp_pin_dev(&pf.hw)) {
    kfree(pf.ptp_pins);
    kfree(pf.ptp_caps.pin_config);
    pf.ptp_pins = core::ptr::null_mut();
    pf.ptp_caps.pin_config = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn i40e_ptp_init_leds_hw(hw: *mut i40e_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_ptp_set_pins_hw(pf: *mut i40e_pf) {
...
//
    ...
    struct i40e_ptp_pins_settings *pins)
    {
    let mut pin_caps: enum i40e_can_set_pins = i40e_can_set_pins(pf);
    let mut i: c_int = 0;
    if (pin_caps == CANT_DO_PINS)
    return -EOPNOTSUPP;
#[no_mangle]
pub unsafe extern "C" fn if(CAN_DO_PINS: pin_caps ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_ptp_alloc_pins(pf: *mut i40e_pf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_init_pin_config(pf: *mut i40e_pf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_ptp_create_clock(pf: *mut i40e_pf) -> c_long {
...
// no need to create a clock device if we already have one
    ...
    if (i40e_is_ptp_pin_dev(&pf.hw)) {
    let mut err: c_int = i40e_init_pin_config(pf);
    if (err)
    return err;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_ptp_save_hw_time(pf: *mut i40e_pf) {
    void i40e_ptp_save_hw_time(struct i40e_pf *pf)
    {
// don't try to access the PTP clock if it's not enabled
    if (!test_bit(I40E_FLAG_PTP_ENA, pf.flags))
    return;
    i40e_ptp_gettimex(&pf.ptp_caps, &pf.ptp_prev_hw_time, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_ptp_restore_hw_time(pf: *mut i40e_pf) {
    void i40e_ptp_restore_hw_time(struct i40e_pf *pf)
    {
    let mut delta: ktime_t = ktime_sub(ktime_get(), pf.ptp_reset_start);
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_ptp_init(pf: *mut i40e_pf) {
...
// ensure we have a clock device
    ...
    if (err) {
    pf.ptp_clock = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn i40e_ptp_stop(pf: *mut i40e_pf) {
