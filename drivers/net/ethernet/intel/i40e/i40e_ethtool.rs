...
//! Source: drivers/net/ethernet/intel/i40e/i40e_ethtool.c
#![no_std]
...
//
    ...
    {
    let mut size: c_uint = ARRAY_SIZE(i40e_gstrings_queue_stats);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i40e_cp_veb_tc_stats {
    pub tc_rx_packets: u64,
    pub tc_rx_bytes: u64,
    pub tc_tx_packets: u64,
    pub tc_tx_bytes: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i40e_pfc_stats {
    pub priority_xon_rx: u64,
    pub priority_xoff_rx: u64,
    pub priority_xon_tx: u64,
    pub priority_xoff_tx: u64,
    pub priority_xon_2_xoff: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i40e_priv_flags {
    pub flag_string: [c_char; ETH_GSTRING_LEN],
    pub bitno: u8,
    pub read_only: bool,
}
...
//
#[no_mangle]
unsafe extern "C" fn i40e_partition_setting_complaint(pf: *mut i40e_pf) {
...
//
    ...
    let mut phy_types: u64 = pf.hw.phy.phy_types;
...
//
    ...
    let mut link_speed: u32 = hw_link_info.link_speed;
...
//
    ...
    struct i40e_link_status *hw_link_info = &hw.phy.link_info;
    let mut link_up: bool = hw_link_info.link_info & I40E_AQ_LINK_UP;
    ethtool_link_ksettings_zero_link_mode(ks, supported);
    ethtool_link_ksettings_zero_link_mode(ks, advertising);
    if (link_up)
...
pub const I40E_LBIT_SIZE: c_int = 8;
//
...
//
    ...
    {
    let mut link_speed: enum i40e_aq_link_speed = I40E_LINK_SPEED_UNKNOWN;
    let mut speed_changed: bool = false;
    int i, j;
    static const struct {
    __u32 speed;
...
//
    ...
    struct i40e_hw *hw = &pf.hw;
    let mut autoneg_changed: bool = false;
...
// make the aq call
    status = i40e_aq_set_phy_config(hw, &config, core::ptr::null_mut());
    if (status) {
    netdev_info(netdev,
...
#[no_mangle]
unsafe extern "C" fn i40e_set_fec_cfg(netdev: *mut net_device, fec_cfg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(I40E_AQ_CONFIG_FEC_RS_ENA: hw->phy.link_info.fec_info &) -> else {
...
#[no_mangle]
unsafe extern "C" fn i40e_nway_reset(netdev: *mut net_device) -> c_int {
...
// restart autonegotiation
    ...
    struct i40e_pf *pf = np.vsi.back;
    struct i40e_hw *hw = &pf.hw;
    let mut link_up: bool = hw.phy.link_info.link_info & I40E_AQ_LINK_UP;
    let mut ret: c_int = 0;
    ret = i40e_aq_set_link_restart_an(hw, link_up, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
pub unsafe extern "C" fn if(!pause->tx_pause: pause->rx_pause &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn i40e_get_msglevel(netdev: *mut net_device) -> u32 {
    static u32 i40e_get_msglevel(struct net_device *netdev)
    {
    struct i40e_netdev_priv *np = netdev_priv(netdev);
    struct i40e_pf *pf = np.vsi.back;
    let mut debug_mask: u32 = pf.hw.debug_mask;
    if (debug_mask)
    netdev_info(netdev, "i40e debug_mask: 0x%08X\n", debug_mask);
    return pf.msg_enable;
    }
#[no_mangle]
unsafe extern "C" fn i40e_set_msglevel(netdev: *mut net_device, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn i40e_get_regs_len(netdev: *mut net_device) -> c_int {
    static int i40e_get_regs_len(struct net_device *netdev)
    {
    let mut reg_count: c_int = 0;
    int i;
...
// loop through the diags reg table for what to print
    ...
    struct i40e_pf *pf = np.vsi.back;
    let mut ret_val: c_int = 0, len, offset;
    u8 *eeprom_buff;
    u16 i, sectors;
    bool last;
    u32 magic;
pub const I40E_NVM_SECTOR_SIZE: c_int = 4096;
    if (eeprom.len == 0)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn i40e_get_eeprom_len(netdev: *mut net_device) -> c_int {
    static int i40e_get_eeprom_len(struct net_device *netdev)
    {
    struct i40e_netdev_priv *np = netdev_priv(netdev);
    struct i40e_hw *hw = &np.vsi.back.hw;
    u32 val;
pub const X722_EEPROM_SCOPE_LIMIT: c_uint = 0x5B9FFF;
    if (hw.mac.type == I40E_MAC_X722) {
...
// check for NVMUpdate access method
#[no_mangle]
pub unsafe extern "C" fn if(hw->device_id: !eeprom->magic || (eeprom->magic >> 16) !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn i40e_active_tx_ring_index(vsi: *mut i40e_vsi, index: u16) -> bool {
    ...
    struct i40e_ring *tx_rings = core::ptr::null_mut(), *rx_rings = core::ptr::null_mut();
    struct i40e_netdev_priv *np = netdev_priv(netdev);
    struct i40e_hw *hw = &np.vsi.back.hw;
    struct i40e_vsi *vsi = np.vsi;
    struct i40e_pf *pf = vsi.back;
...
// setup call
//
    tx_rings[i].desc = core::ptr::null_mut();
    tx_rings[i].rx_bi = core::ptr::null_mut();
...
// setup call
//
    rx_rings[i].desc = core::ptr::null_mut();
    rx_rings[i].rx_bi = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn i40e_get_stats_count(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i40e_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
// intelligently
//
    i40e_add_ethtool_stats(&data, veb_stats ? veb : core::ptr::null_mut(),
    ...
    i40e_add_ethtool_stats(&data, core::ptr::null_mut(),
    i40e_gstrings_veb_tc_stats);
    }
    i40e_add_ethtool_stats(&data, pf, i40e_gstrings_stats);
    for (i = 0; i < I40E_MAX_USER_PRIORITY; i++) {
    let mut pfc: i40e_pfc_stats = i40e_get_pfc_stats(pf, i);
...
//
#[no_mangle]
unsafe extern "C" fn i40e_get_stat_strings(netdev: *mut net_device, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn i40e_get_priv_flag_strings(netdev: *mut net_device, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn i40e_link_test(netdev: *mut net_device, data: *mut u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn i40e_reg_test(netdev: *mut net_device, data: *mut u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn i40e_eeprom_test(netdev: *mut net_device, data: *mut u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn i40e_intr_test(netdev: *mut net_device, data: *mut u64) -> u64 {
    static u64 i40e_intr_test(struct net_device *netdev, u64 *data)
    {
    struct i40e_netdev_priv *np = netdev_priv(netdev);
    struct i40e_pf *pf = np.vsi.back;
    let mut swc_old: u16 = pf.sw_int_count;
...
#[no_mangle]
pub unsafe extern "C" fn i40e_active_vfs(pf: *mut i40e_pf) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn i40e_active_vmdqs(pf: *mut i40e_pf) -> bool {
    ...
    {
    struct i40e_netdev_priv *np = netdev_priv(netdev);
    let mut if_running: bool = netif_running(netdev);
    struct i40e_pf *pf = np.vsi.back;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_set_wol(netdev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
// is this a new value?
    ...
    if (!test_bit(I40E_HW_CAP_AQ_PHY_ACCESS, hw.caps))
    i40e_aq_set_phy_debug(hw, 0, core::ptr::null_mut());
    }
    break;
    default:
    break;
...
//
    ...
    queue = 0;
#[no_mangle]
pub unsafe extern "C" fn if(vsi->num_queue_pairs: queue >=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_check_mask(mask: u64, field: u64) -> c_int {
    static int i40e_check_mask(u64 mask, u64 field)
    {
    let mut value: u64 = mask & field;
    if (value == field)
    return 1;
#[no_mangle]
...
//
    ...
    let mut userdef: i40e_rx_flow_userdef = {0};
    struct i40e_fdir_filter *rule = core::ptr::null_mut();
    struct hlist_node *node2;
    struct i40e_vsi *vsi;
    u64 input_set;
    u16 index;
...
//
    let mut ring_vf: u64 = vsi.vf_id + 1;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_get_rx_ring_count(netdev: *mut net_device) -> u32 {
...
//
    ...
    u64 i_setc)
    {
    let mut i_set: u64 = i_setc;
    let mut src_l3: u64 = 0, dst_l3 = 0;
...
pub const FLOW_PCTYPES_SIZE: c_int = 64;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_prune_flex_pit_list(pf: *mut i40e_pf) {
...
//
    ...
    return -EBUSY;
    ret = i40e_update_ethtool_fdir_entry(vsi, core::ptr::null_mut(), fsp.location, cmd);
...
//
#[no_mangle]
unsafe extern "C" fn i40e_unused_pit_index(pf: *mut i40e_pf) -> u8 {
    static u8 i40e_unused_pit_index(struct i40e_pf *pf)
    {
    let mut available_index: c_ulong = 0xFF;
...
//
    ...
    int flex_pit_start)
    {
    struct i40e_flex_pit *entry = core::ptr::null_mut();
...
//
    for (j = i + 1; j < 3; j++) {
    let mut offset: u16 = entry.src_offset + j;
    let mut index: c_int = flex_pit_start + i;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_reprogram_flex_pit(pf: *mut i40e_pf) {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_pit_index_to_mask(pit_index: c_int) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_print_input_set(vsi: *mut i40e_vsi, old: u64, new: u64) {
...
// Show change of flexible filter entries
    ...
    let mut flex_mask: u64 = i40e_pit_index_to_mask(i);
...
//
    ...
    let mut new_flex_offset: bool = false;
    let mut flex_l3: bool = false;
    u16 *fdir_filter_count;
    u16 index, src_offset = 0;
    let mut pit_index: u8 = 0;
    int err;
    switch (fsp.flow_type & ~FLOW_EXT) {
    case SCTP_V4_FLOW:
    index = LIBIE_FILTER_PCTYPE_NONF_IPV4_SCTP;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !tcp_ip4_spec->ip4src) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !tcp_ip4_spec->ip4dst) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !tcp_ip4_spec->psrc) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !tcp_ip4_spec->pdst) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(: *mut ipv6_addr_any((struct in6_addr) -> else {
...
// L4 source port
    ...
    new_mask |= I40E_L4_SRC_MASK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !tcp_ip6_spec->psrc) -> else {
...
// L4 destination port
    ...
    new_mask |= I40E_L4_DST_MASK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !tcp_ip6_spec->pdst) -> else {
...
// IPv4 source address
    ...
    new_mask |= I40E_L3_SRC_MASK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !usr_ip4_spec->ip4src) -> else {
...
// IPv4 destination address
    ...
    new_mask |= I40E_L3_DST_MASK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !usr_ip4_spec->ip4dst) -> else {
...
//
    ...
    struct i40e_flex_pit *l3_flex_pit = core::ptr::null_mut(), *flex_pit = core::ptr::null_mut();
...
//
    ...
    struct ethtool_rx_flow_spec *fsp;
    struct i40e_fdir_filter *input;
    let mut dest_vsi: u16 = 0, q_index = 0;
    struct i40e_pf *pf;
...
//
    ...
    let mut ring: u32 = ethtool_get_flow_spec_ring(fsp.ring_cookie);
    let mut vf: u8 = ethtool_get_flow_spec_ring_vf(fsp.ring_cookie);
    if (!vf) {
...
//
    i40e_update_ethtool_fdir_entry(vsi, input, fsp.location, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn i40e_set_rxnfc(netdev: *mut net_device, cmd: *mut ethtool_rxnfc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_max_channels(vsi: *mut i40e_vsi) -> c_uint {
...
//
    ...
    struct ethtool_channels *ch)
    {
    let mut drop: u8 = I40E_FILTER_PROGRAM_DESC_DEST_DROP_PACKET;
    struct i40e_netdev_priv *np = netdev_priv(dev);
    let mut count: c_uint = ch.combined_count;
    struct i40e_vsi *vsi = np.vsi;
    struct i40e_pf *pf = vsi.back;
    struct i40e_fdir_filter *rule;
    struct hlist_node *node2;
...
//
#[no_mangle]
unsafe extern "C" fn i40e_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_get_rxfh_indir_size(netdev: *mut net_device) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_get_priv_flags(dev: *mut net_device) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn i40e_set_priv_flags(dev: *mut net_device, flags: u32) -> c_int {
...
// Flush current ATR settings if ATR was disabled
    ...
    let mut sw_flags: u16 = 0, valid_flags = 0;
    int ret;
...
// not a fatal problem, just keep going
    ...
    i40e_aq_cfg_lldp_mib_change_event(&pf.hw, false, core::ptr::null_mut());
    i40e_aq_stop_lldp(&pf.hw, true, false, core::ptr::null_mut());
    } else {
    status = i40e_aq_start_lldp(&pf.hw, false, core::ptr::null_mut());
    if (status) {
...
//
    ...
    struct i40e_pf *pf = vsi.back;
    struct i40e_hw *hw = &pf.hw;
    let mut sff8472_comp: u32 = 0;
    let mut sff8472_swap: u32 = 0;
    let mut sff8636_rev: u32 = 0;
    let mut type: u32 = 0;
    int status;
// Check if firmware supports reading module EEPROM.
    ...
    &sff8472_comp, core::ptr::null_mut());
    if (status)
    return -EIO;
    status = i40e_aq_get_phy_register(hw,
    I40E_AQ_PHY_REG_ACCESS_EXTERNAL_MODULE,
    ...
    &sff8472_swap, core::ptr::null_mut());
    if (status)
    return -EIO;
...
//
    ...
    is_sfp = true;
    for (i = 0; i < ee.len; i++) {
    let mut offset: u32 = i + ee.offset;
    let mut addr: u32 = is_sfp ? I40E_I2C_EEPROM_DEV_ADDR : 0;
...
// Compute memory page number and offset.
    ...
    status = i40e_aq_get_phy_register(hw,
    I40E_AQ_PHY_REG_ACCESS_EXTERNAL_MODULE,
    addr, true, offset, &value, core::ptr::null_mut());
    if (status)
    return -EIO;
    data[i] = value;
    }
    ...
    {
    let mut eee_capability: c_int = le16_to_cpu(eee_capability_);
...
#[no_mangle]
unsafe extern "C" fn i40e_get_eee(netdev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
// Get initial PHY capabilities
    status = i40e_aq_get_phy_capabilities(hw, false, true, &phy_cfg, core::ptr::null_mut());
    if (status)
    return -EAGAIN;
...
// Get current configuration
    status = i40e_aq_get_phy_capabilities(hw, false, false, &phy_cfg, core::ptr::null_mut());
    if (status)
    return -EAGAIN;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i40e_ethtool_not_used {
    pub value: bool,
...
#[no_mangle]
unsafe extern "C" fn i40e_set_eee(netdev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i40e_set_ethtool_ops(netdev: *mut net_device) {
