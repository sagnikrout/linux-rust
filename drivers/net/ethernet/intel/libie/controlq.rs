...
//! Source: drivers/net/ethernet/intel/libie/controlq.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn libie_ctlq_free_fq(ctlq: *mut libie_ctlq_info) {
...
//
#[no_mangle]
unsafe extern "C" fn libie_ctlq_init_fq(ctlq: *mut libie_ctlq_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn libie_ctlq_post_rx_buffs(ctlq: *mut libie_ctlq_info) -> c_int {
    int libie_ctlq_post_rx_buffs(struct libie_ctlq_info *ctlq)
    {
    let mut ntp: u32 = ctlq.next_to_post, ntc = ctlq.next_to_clean, num_to_post;
...
//
#[no_mangle]
unsafe extern "C" fn libie_ctlq_alloc_tx_msgs(ctlq: *mut libie_ctlq_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn libie_ctlq_dealloc_ring_res(ctlq: *mut libie_ctlq_info) {
...
//
#[no_mangle]
unsafe extern "C" fn libie_ctlq_alloc_queue_res(ctlq: *mut libie_ctlq_info) -> c_int {
    static int libie_ctlq_alloc_queue_res(struct libie_ctlq_info *ctlq)
    {
    let mut size: usize = array_size(ctlq.ring_len, sizeof(*ctlq.descs));
    struct libie_cp_dma_mem *dma = &ctlq.ring_mem;
...
//
#[no_mangle]
unsafe extern "C" fn libie_ctlq_init_regs(ctlq: *mut libie_ctlq_info) {
...
//
#[no_mangle]
pub unsafe extern "C" fn libie_ctlq_deinit(ctx: *mut libie_ctlq_ctx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn libie_ctlq_send_desc_avail(ctlq: *const libie_ctlq_info) -> u32 {
    u32 libie_ctlq_send_desc_avail(const struct libie_ctlq_info *ctlq)
    {
    let mut ntu: u32 = ctlq.next_to_use, ntc = ctlq.next_to_clean;
...
//
#[no_mangle]
pub unsafe extern "C" fn libie_ctlq_send(ctlq: *mut libie_ctlq_info, num_q_msg: u32) {
    void libie_ctlq_send(struct libie_ctlq_info *ctlq, u32 num_q_msg)
    {
    let mut ntu: u32 = ctlq.next_to_use;
    lockdep_assert_held(&ctlq.lock);
...
//
#[no_mangle]
pub unsafe extern "C" fn libie_ctlq_send_clean(params: *const libie_ctlq_clean_params) -> u32 {
...
//
    ...
    {
    let mut qword: u64 = le64_to_cpu(desc.qword0);
...
//
#[no_mangle]
unsafe extern "C" fn libie_xn_check_async_timeout(xnm: *mut libie_ctlq_xn_manager) {
    ...
    xn.resp_cb(xn.send_ctx, core::ptr::null_mut(), -ETIMEDOUT);
    xn.state = LIBIE_CTLQ_XN_IDLE;
    spin_unlock(&xn.xn_lock);
    libie_ctlq_xn_push_free(xnm, xn);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn libie_ctlq_xn_recv(params: *mut libie_ctlq_xn_recv_params) -> u32 {
    u32 libie_ctlq_xn_recv(struct libie_ctlq_xn_recv_params *params)
    {
    struct libie_ctlq_msg ctlq_msg;
    let mut budget: u32 = params.budget;
...
//
    ...
    struct libie_ctlq_xn *xn)
    {
    let mut buf_len: usize = params.send_buf.iov_len;
    ...
    xn.tx_msg = dma_mem == &xn.small_dma_mem ? ctlq_msg : core::ptr::null_mut();
    if (params.ctlq_msg)
...
//
#[no_mangle]
pub unsafe extern "C" fn libie_ctlq_xn_send(params: *mut libie_ctlq_xn_send_params) -> c_int {
    int libie_ctlq_xn_send(struct libie_ctlq_xn_send_params *params)
    {
    let mut free_send: bool = !libie_cp_can_send_onstack(params.send_buf.iov_len);
    struct libie_ctlq_xn *xn;
    int ret;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct libie_ctlq_xn_rel_tx_ctx {
    pub dev: *mut device,
...
//
#[no_mangle]
pub unsafe extern "C" fn libie_ctlq_xn_shutdown(xnm: *mut libie_ctlq_xn_manager) {
    void libie_ctlq_xn_shutdown(struct libie_ctlq_xn_manager *xnm)
    {
    let mut must_wait: bool = false;
    u32 i;
...
//
#[no_mangle]
pub unsafe extern "C" fn libie_ctlq_xn_init(params: *mut libie_ctlq_xn_init_params) -> c_int {
