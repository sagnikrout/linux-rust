...
//! Source: drivers/net/ethernet/intel/libie/fwlog.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn libie_fwlog_ring_empty(rings: *mut libie_fwlog_ring) -> bool {
    static bool libie_fwlog_ring_empty(struct libie_fwlog_ring *rings)
    {
    return rings.head == rings.tail;
    }
#[no_mangle]
unsafe extern "C" fn libie_fwlog_ring_increment(item: *mut u16, size: u16) {
    static void libie_fwlog_ring_increment(u16 *item, u16 size)
    {
// item = (*item + 1) & (size - 1);
    }
#[no_mangle]
unsafe extern "C" fn libie_fwlog_alloc_ring_buffs(rings: *mut libie_fwlog_ring) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn libie_fwlog_free_ring_buffs(rings: *mut libie_fwlog_ring) {
...
//
#[no_mangle]
unsafe extern "C" fn libie_fwlog_realloc_rings(fwlog: *mut libie_fwlog, index: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn libie_fwlog_supported(fwlog: *mut libie_fwlog) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn libie_aq_fwlog_register(fwlog: *mut libie_fwlog, reg: bool) -> c_int {
    ...
    return fwlog.send_cmd(fwlog.priv, &desc, core::ptr::null_mut(), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn libie_fwlog_register(fwlog: *mut libie_fwlog) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn libie_fwlog_unregister(fwlog: *mut libie_fwlog) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn libie_find_module_by_dentry(modules: *mut dentry, d: *mut dentry) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn libie_debugfs_module_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn libie_debugfs_module_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn libie_fwlog_ring_full(rings: *mut libie_fwlog_ring) -> bool {
    ...
    return true;
#[no_mangle]
pub unsafe extern "C" fn if(1)): head > tail && (tail == (head -) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn libie_fwlog_set_supported(fwlog: *mut libie_fwlog) {
...
//
#[no_mangle]
pub unsafe extern "C" fn libie_fwlog_init(fwlog: *mut libie_fwlog, api: *mut libie_fwlog_api) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn libie_fwlog_deinit(fwlog: *mut libie_fwlog) {
...
//
    ...
    fwlog.debugfs_modules = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn libie_get_fwlog_data(fwlog: *mut libie_fwlog, buf: *mut u8, len: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn libie_fwlog_reregister(fwlog: *mut libie_fwlog) {
