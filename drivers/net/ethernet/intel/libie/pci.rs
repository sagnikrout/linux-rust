...
//! Source: drivers/net/ethernet/intel/libie/pci.c
#![no_std]
...
//
    ...
    int bar_idx)
    {
    let mut end_offset: resource_size_t = offset + size;
    struct libie_pci_mmio_region *mr;
    list_for_each_entry(mr, mmio_list, list) {
    let mut mr_end: resource_size_t = mr.offset + mr.size;
    let mut mr_start: resource_size_t = mr.offset;
...
//
#[no_mangle]
pub unsafe extern "C" fn libie_pci_unmap_all_mmio_regions(mmio_info: *mut libie_mmio_info) {
...
//
#[no_mangle]
pub unsafe extern "C" fn libie_pci_init_dev(pdev: *mut pci_dev) -> c_int {
