...
//! Source: drivers/net/ethernet/intel/igc/igc_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn igc_ethtool_get_regs_len(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igc_ethtool_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn igc_ethtool_set_msglevel(netdev: *mut net_device, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn igc_ethtool_nway_reset(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igc_ethtool_get_link(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn igc_ethtool_get_eeprom_len(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igc_ethtool_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igc_ethtool_get_previous_rx_coalesce(adapter: *mut igc_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igc_ethtool_get_previous_tx_coalesce(adapter: *mut igc_adapter) -> c_int {
...
pub unsafe extern "C" fn if(3: ec->tx_coalesce_usecs && ec->tx_coalesce_usecs <=) -> else {
    ...
    struct igc_nfc_rule *rule = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn igc_ethtool_get_rx_ring_count(dev: *mut net_device) -> u32 {
...
//
    ...
    let mut flags: u8 = rule.filter.match_flags;
...
//
#[no_mangle]
pub unsafe extern "C" fn igc_write_rss_key(adapter: *mut igc_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn igc_write_rss_indir_tbl(adapter: *mut igc_adapter) {
    void igc_write_rss_indir_tbl(struct igc_adapter *adapter)
    {
    struct igc_hw *hw = &adapter.hw;
    let mut reg: u32 = IGC_RETA(0);
    let mut shift: u32 = 0;
    let mut i: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn igc_ethtool_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
    static u32 igc_ethtool_get_rxfh_key_size(struct net_device *netdev)
    {
    return IGC_RSS_KEY_SIZE;
    }
#[no_mangle]
unsafe extern "C" fn igc_ethtool_get_rxfh_indir_size(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn igc_ethtool_get_priv_flags(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn igc_ethtool_set_priv_flags(netdev: *mut net_device, priv_flags: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn igc_ethtool_get_frame_ass_error(reg_value: u32) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn igc_ethtool_get_frame_smd_error(reg_value: u32) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn igc_ethtool_set_ops(netdev: *mut net_device) {
