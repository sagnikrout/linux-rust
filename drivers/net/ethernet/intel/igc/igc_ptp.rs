...
//! Source: drivers/net/ethernet/intel/igc/igc_ptp.c
#![no_std]
...
pub const IGC_PTM_STAT_SLEEP: c_int = 2;
pub const IGC_PTM_STAT_TIMEOUT: c_int = 100;
// SYSTIM read access for I225
#[no_mangle]
pub unsafe extern "C" fn igc_ptp_read(adapter: *mut igc_adapter, ts: *mut timespec64) {
...
#[no_mangle]
unsafe extern "C" fn igc_ptp_adjfine_i225(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igc_ptp_adjtime_i225(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igc_pin_direction(pin: c_int, input: c_int, ctrl: *mut u32, ctrl_ext: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn igc_pin_perout(igc: *mut igc_adapter, chan: c_int, pin: c_int, freq: c_int) {
...
#[no_mangle]
unsafe extern "C" fn igc_pin_extts(igc: *mut igc_adapter, chan: c_int, pin: c_int) {
...
// Make sure this pin is not enabled as an output.
    ...
    unsigned long flags;
    struct timespec64 ts;
    let mut use_freq: c_int = 0, pin = -1;
...
// Reject requests failing to enable both edges.
    ...
    let mut i: c_int = rq.perout.index;
...
//
#[no_mangle]
pub unsafe extern "C" fn igc_ptp_rx_pktstamp(adapter: *mut igc_adapter, buf: *mut __le32) -> ktime_t {
...
#[no_mangle]
unsafe extern "C" fn igc_ptp_disable_rx_timestamp(adapter: *mut igc_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igc_ptp_enable_rx_timestamp(adapter: *mut igc_adapter) {
...
// become NULL as well.
//
    tstamp.xsk_tx_buffer = core::ptr::null_mut();
...
// Trigger txrx interrupt for transmit completion
    ...
    tstamp.skb = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn igc_ptp_clear_tx_tstamp(adapter: *mut igc_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igc_ptp_clear_xsk_tx_tstamp_queue(adapter: *mut igc_adapter, queue_id: u16) {
...
#[no_mangle]
unsafe extern "C" fn igc_ptp_disable_tx_timestamp(adapter: *mut igc_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igc_ptp_enable_tx_timestamp(adapter: *mut igc_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn igc_ptp_tx_hang(adapter: *mut igc_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igc_ptp_tx_hwtstamp(adapter: *mut igc_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igc_ptp_tx_tstamp_event(adapter: *mut igc_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igc_is_crosststamp_supported(adapter: *mut igc_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn igc_device_tstamp_to_system(tstamp: u64) -> system_counterval_t {
...
#[no_mangle]
unsafe extern "C" fn igc_ptm_log_error(adapter: *mut igc_adapter, ptm_stat: u32) {
...
#[no_mangle]
unsafe extern "C" fn igc_ptm_trigger(hw: *mut igc_hw) {
...
#[no_mangle]
unsafe extern "C" fn igc_ptm_reset(hw: *mut igc_hw) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igc_ptp_init(adapter: *mut igc_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igc_ptp_time_save(adapter: *mut igc_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igc_ptp_time_restore(adapter: *mut igc_adapter) {
    static void igc_ptp_time_restore(struct igc_adapter *adapter)
    {
    let mut ts: timespec64 = adapter.prev_ptp_time;
    ktime_t delta;
...
#[no_mangle]
unsafe extern "C" fn igc_ptm_stop(adapter: *mut igc_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igc_ptp_suspend(adapter: *mut igc_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igc_ptp_stop(adapter: *mut igc_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igc_ptp_reset(adapter: *mut igc_adapter) {
