...
//! Source: drivers/net/ethernet/intel/idpf/idpf_lib.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn idpf_init_vector_stack(adapter: *mut idpf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_deinit_vector_stack(adapter: *mut idpf_adapter) {
    ...
    stack = &adapter.vector_stack;
    kfree(stack.vec_idx);
    stack.vec_idx = core::ptr::null_mut();
    mutex_unlock(&adapter.vector_lock);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_mb_intr_rel_irq(adapter: *mut idpf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_intr_rel(adapter: *mut idpf_adapter) {
    ...
    adapter.rdma_msix_entries = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn idpf_mb_intr_clean(irq: int __always_unused, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_mb_irq_enable(adapter: *mut idpf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_mb_intr_req_irq(adapter: *mut idpf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_mb_intr_init(adapter: *mut idpf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_vector_lifo_push(adapter: *mut idpf_adapter, vec_idx: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_vector_lifo_pop(adapter: *mut idpf_adapter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_intr_req(adapter: *mut idpf_adapter) -> c_int {
    int idpf_intr_req(struct idpf_adapter *adapter)
    {
    u16 num_lan_vecs, min_lan_vecs, num_rdma_vecs = 0, min_rdma_vecs = 0;
    let mut default_vports: u16 = idpf_get_default_vports(adapter);
...
//
#[no_mangle]
unsafe extern "C" fn idpf_del_all_flow_steer_filters(vport: *mut idpf_vport) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_del_all_mac_filters(vport: *mut idpf_vport) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_restore_mac_filters(vport: *mut idpf_vport) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_remove_mac_filters(vport: *mut idpf_vport) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_deinit_mac_addr(vport: *mut idpf_vport) {
...
#[no_mangle]
unsafe extern "C" fn idpf_detach_and_close(adapter: *mut idpf_adapter) {
    static void idpf_detach_and_close(struct idpf_adapter *adapter)
    {
    let mut max_vports: c_int = adapter.max_vports;
...
#[no_mangle]
unsafe extern "C" fn idpf_attach_and_open(adapter: *mut idpf_adapter) {
...
//
    ...
    vport_config.flags)) {
    rtnl_lock();
    dev_open(netdev, core::ptr::null_mut());
    rtnl_unlock();
    }
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn idpf_cfg_netdev(vport: *mut idpf_vport) -> c_int {
    static int idpf_cfg_netdev(struct idpf_vport *vport)
    {
    struct idpf_adapter *adapter = vport.adapter;
    struct idpf_vport_config *vport_config;
    let mut other_offloads: netdev_features_t = 0;
    let mut csum_offloads: netdev_features_t = 0;
    let mut tso_offloads: netdev_features_t = 0;
    netdev_features_t dflt_features;
    struct idpf_netdev_priv *np;
    struct net_device *netdev;
    let mut idx: u16 = vport.idx;
    int err;
...
//
    ...
    vport.netdev = core::ptr::null_mut();
    return err;
    }
// assign netdev_ops
...
//
#[no_mangle]
unsafe extern "C" fn idpf_get_free_slot(adapter: *mut idpf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_remove_features(vport: *mut idpf_vport) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_vport_stop(vport: *mut idpf_vport, rtnl: bool) {
    ...
    let mut vport_id: u32 = vport.vport_id;
    if (!test_bit(IDPF_VPORT_UP, np.state))
    return;
    if (rtnl)
    rtnl_lock();
...
//
#[no_mangle]
unsafe extern "C" fn idpf_stop(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_decfg_netdev(vport: *mut idpf_vport) {
    ...
    vport.netdev = core::ptr::null_mut();
    adapter.netdevs[idx] = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn idpf_vport_rel(vport: *mut idpf_vport) {
    ...
    rss_data.rss_key = core::ptr::null_mut();
...
// Release all the allocated vectors on the stack
    ...
    rsrc.q_vector_idxs = core::ptr::null_mut();
    idpf_vport_deinit_queue_reg_chunks(vport_config);
    kfree(adapter.vport_params_recvd[idx]);
    adapter.vport_params_recvd[idx] = core::ptr::null_mut();
    kfree(vport);
...
//
#[no_mangle]
unsafe extern "C" fn idpf_vport_dealloc(vport: *mut idpf_vport) {
    static void idpf_vport_dealloc(struct idpf_vport *vport)
    {
    struct idpf_adapter *adapter = vport.adapter;
    let mut i: c_uint = vport.idx;
    ...
    np.vport = core::ptr::null_mut();
    }
    idpf_vport_rel(vport);
    adapter.vports[i] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn idpf_is_hsplit_supported(vport: *const idpf_vport) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_vport_get_hsplit(vport: *const idpf_vport) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_vport_set_hsplit(vport: *const idpf_vport, val: u8) -> bool {
    bool idpf_vport_set_hsplit(const struct idpf_vport *vport, u8 val)
    {
    struct idpf_vport_user_config_data *config;
    if (!idpf_is_hsplit_supported(vport))
    let mut val: return = = ETHTOOL_TCP_DATA_SPLIT_UNKNOWN;
    config = &vport.adapter.vport_config[vport.idx].user_config;
    switch (val) {
...
//
    ...
    {
    struct idpf_rss_data *rss_data;
    let mut idx: u16 = adapter.next_vport;
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_statistics_task(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_mbx_task(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_service_task(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_restore_features(vport: *mut idpf_vport) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_set_real_num_queues(vport: *mut idpf_vport) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_up_complete(vport: *mut idpf_vport) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_rx_init_buf_tail(rsrc: *mut idpf_q_vec_rsrc) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_vport_open(vport: *mut idpf_vport, rtnl: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_init_task(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_sriov_ena(adapter: *mut idpf_adapter, num_vfs: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_sriov_configure(pdev: *mut pci_dev, num_vfs: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_deinit_task(adapter: *mut idpf_adapter) {
...
//
    ...
    int i;
    for (i = 0; i < 2000; i++) {
    let mut reg_val: u32 = readl(reset_reg.rstat);
...
//
#[no_mangle]
unsafe extern "C" fn idpf_init_hard_reset(adapter: *mut idpf_adapter) {
...
// Prepare for reset
    ...
    let mut is_reset: bool = idpf_is_reset_detected(adapter);
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_vc_event_task(work: *mut work_struct) {
...
//
    ...
    {
    struct idpf_netdev_priv *np = netdev_priv(vport.netdev);
    let mut vport_is_up: bool = test_bit(IDPF_VPORT_UP, np.state);
    struct idpf_q_vec_rsrc *rsrc = &vport.dflt_qv_rsrc;
    struct idpf_adapter *adapter = vport.adapter;
    struct idpf_vport_config *vport_config;
...
//
#[no_mangle]
unsafe extern "C" fn idpf_addr_sync(netdev: *mut net_device, addr: *const u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_addr_unsync(netdev: *mut net_device, addr: *const u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_set_rx_mode(netdev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_open(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
//
    ...
    let mut stale_size: c_int = skb_frag_size(stale);
    sum += skb_frag_size(frag++);
...
//
    ...
    {
    struct idpf_netdev_priv *np = netdev_priv(netdev);
    let mut max_tx_hdr_size: u16 = np.max_tx_hdr_size;
    size_t len;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: idpf_chk_tso_segment(skb, _arg: np->tx_max_bufs)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_set_mac(netdev: *mut net_device, p: *mut c_void) -> c_int {
