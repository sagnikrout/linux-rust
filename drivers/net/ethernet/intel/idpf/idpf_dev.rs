...
//! Source: drivers/net/ethernet/intel/idpf/idpf_dev.c
#![no_std]
...
pub const IDPF_PF_ITR_IDX_SPACING: c_uint = 0x4;
//
...
//
#[no_mangle]
unsafe extern "C" fn idpf_mb_intr_reg_init(adapter: *mut idpf_adapter) {
    ...
    let mut dyn_ctl: u32 = le32_to_cpu(adapter.caps.mailbox_dyn_ctl);
...
//
    ...
    let mut num_vecs: u16 = rsrc.num_q_vectors;
    ...
    let mut vec_id: u16 = rsrc.q_vector_idxs[i] - IDPF_MBX_Q_VEC;
...
//
#[no_mangle]
unsafe extern "C" fn idpf_reset_reg_init(adapter: *mut idpf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_ptp_reg_init(adapter: *const idpf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_idc_register(adapter: *mut idpf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_reg_ops_init(adapter: *mut idpf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_dev_ops_init(adapter: *mut idpf_adapter) {
