...
//! Source: drivers/net/ethernet/intel/idpf/idpf_main.c
#![no_std]
...
pub const IDPF_NETWORK_ETHERNET_PROGIF: c_uint = 0x01;

    (PCI_CLASS_NETWORK_ETHERNET << 8 | IDPF_NETWORK_ETHERNET_PROGIF)
pub const IDPF_VF_TEST_VAL: c_uint = 0xfeed0000u;
...
//
#[no_mangle]
unsafe extern "C" fn idpf_get_device_type(pdev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_decfg_device(adapter: *mut idpf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_remove(pdev: *mut pci_dev) {
...
//
    ...
    adapter.netdevs[i] = core::ptr::null_mut();
    }
    destroy_wqs:
    ...
    adapter.vport_config[i] = core::ptr::null_mut();
    }
    kfree(adapter.vport_config);
    adapter.vport_config = core::ptr::null_mut();
    kfree(adapter.netdevs);
    adapter.netdevs = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn idpf_shutdown(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_cfg_device(adapter: *mut idpf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
