...
//! Source: drivers/net/ethernet/intel/idpf/idpf_ethtool.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn idpf_get_rx_ring_count(netdev: *mut net_device) -> u32 {
...
//
    ...
    {
    struct idpf_fsteer_fltr *fltr, *parent = core::ptr::null_mut(), *f;
    struct idpf_netdev_priv *np = netdev_priv(netdev);
    struct idpf_vport_user_config_data *user_config;
...
#[no_mangle]
unsafe extern "C" fn idpf_set_rxnfc(netdev: *mut net_device, cmd: *mut ethtool_rxnfc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_get_rxfh_indir_size(netdev: *mut net_device) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_get_stat_strings(netdev: *mut net_device, data: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_get_strings(netdev: *mut net_device, sset: u32, data: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_add_empty_queue_stats(data: *mut u64, qtype: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_add_port_stats(vport: *mut idpf_vport, data: *mut u64) {
    static void idpf_add_port_stats(struct idpf_vport *vport, u64 **data)
    {
    let mut size: c_uint = IDPF_PORT_STATS_LEN;
    unsigned int start;
    unsigned int i;
    do {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_collect_queue_stats(vport: *mut idpf_vport) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_get_msglevel(netdev: *mut net_device) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_set_msglevel(netdev: *mut net_device, data: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_set_ethtool_ops(netdev: *mut net_device) {
