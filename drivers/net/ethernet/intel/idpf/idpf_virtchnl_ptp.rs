...
//! Source: drivers/net/ethernet/intel/idpf/idpf_virtchnl_ptp.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_ptp_get_caps(adapter: *mut idpf_adapter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_ptp_set_dev_clk_time(adapter: *mut idpf_adapter, time: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_ptp_adj_dev_clk_time(adapter: *mut idpf_adapter, delta: i64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_ptp_adj_dev_clk_fine(adapter: *mut idpf_adapter, incval: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_ptp_get_vport_tstamps_caps(vport: *mut idpf_vport) -> c_int {
...
//
    ...
    ptp_tx_tstamp.skb = core::ptr::null_mut();
    list_add(&ptp_tx_tstamp.list_member,
...
//
    ...
    struct idpf_vport *tstamp_vport = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_ptp_get_tx_tstamp(vport: *mut idpf_vport) -> c_int {
