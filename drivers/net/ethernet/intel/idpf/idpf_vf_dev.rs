...
//! Source: drivers/net/ethernet/intel/idpf/idpf_vf_dev.c
#![no_std]
...
pub const IDPF_VF_ITR_IDX_SPACING: c_uint = 0x40;
//
...
//
#[no_mangle]
unsafe extern "C" fn idpf_vf_mb_intr_reg_init(adapter: *mut idpf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_vf_reset_reg_init(adapter: *mut idpf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_idc_vf_register(adapter: *mut idpf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn idpf_vf_reg_ops_init(adapter: *mut idpf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn idpf_vf_dev_ops_init(adapter: *mut idpf_adapter) {
