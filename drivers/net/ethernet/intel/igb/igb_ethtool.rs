...
//! Source: drivers/net/ethernet/intel/igb/igb_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn igb_get_link(netdev: *mut net_device) -> u32 {
...
//
    ...
    pause.rx_pause = 1;
#[no_mangle]
pub unsafe extern "C" fn if(e1000_fc_tx_pause: hw->fc.current_mode ==) -> else {
    else if (hw.fc.current_mode == e1000_fc_tx_pause)
    pause.tx_pause = 1;
#[no_mangle]
pub unsafe extern "C" fn if(e1000_fc_full: hw->fc.current_mode ==) -> else {
    pause.rx_pause = 1;
    pause.tx_pause = 1;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn igb_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn igb_set_msglevel(netdev: *mut net_device, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn igb_get_regs_len(netdev: *mut net_device) -> c_int {
    static int igb_get_regs_len(struct net_device *netdev)
    {
pub const IGB_REGS_LEN: c_int = 740;
...
#[no_mangle]
unsafe extern "C" fn igb_get_eeprom_len(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_reg_test(adapter: *mut igb_adapter, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_eeprom_test(adapter: *mut igb_adapter, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_test_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn igb_intr_test(adapter: *mut igb_adapter, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_free_desc_rings(adapter: *mut igb_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igb_setup_desc_rings(adapter: *mut igb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_phy_disable_receiver(adapter: *mut igb_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igb_integrated_phy_loopback(adapter: *mut igb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_set_phy_loopback(adapter: *mut igb_adapter) -> c_int {
    static int igb_set_phy_loopback(struct igb_adapter *adapter)
    {
    return igb_integrated_phy_loopback(adapter);
    }
#[no_mangle]
unsafe extern "C" fn igb_setup_loopback_test(adapter: *mut igb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_loopback_cleanup(adapter: *mut igb_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igb_run_loopback_test(adapter: *mut igb_adapter) -> c_int {
    ...
    u16 i, j, lc, good_cnt;
    let mut ret_val: c_int = 0;
    let mut size: c_uint = IGB_RX_HDR_LEN;
...
#[no_mangle]
unsafe extern "C" fn igb_loopback_test(adapter: *mut igb_adapter, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_link_test(adapter: *mut igb_adapter, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_get_wol(netdev: *mut net_device, wol: *mut ethtool_wolinfo) {
...
#[no_mangle]
unsafe extern "C" fn igb_set_wol(netdev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(3: ec->tx_coalesce_usecs && ec->tx_coalesce_usecs <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn igb_nway_reset(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_get_strings(netdev: *mut net_device, stringset: u32, data: *mut u8) {
...
// 82576 does not support timestamping all packets.
    ...
    struct igb_nfc_filter *rule = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn igb_get_rx_ring_count(dev: *mut net_device) -> u32 {
    ...
    {
    struct igb_adapter *adapter = netdev_priv(dev);
    let mut flags: u32 = adapter.flags;
...
// if we changed something we need to update flags
    ...
    struct e1000_hw *hw = &adapter.hw;
    let mut mrqc: u32 = rd32(E1000_MRQC);
...
#[no_mangle]
pub unsafe extern "C" fn igb_add_filter(adapter: *mut igb_adapter, input: *mut igb_nfc_filter) -> c_int {
    ...
    {
    struct e1000_hw *hw = &adapter.hw;
    let mut etqf: u32 = rd32(E1000_ETQF(reg_index));
    etqf &= ~E1000_ETQF_QUEUE_ENABLE;
    etqf &= ~E1000_ETQF_QUEUE_MASK;
    etqf &= ~E1000_ETQF_FILTER_ENABLE;
...
#[no_mangle]
pub unsafe extern "C" fn igb_erase_filter(adapter: *mut igb_adapter, input: *mut igb_nfc_filter) -> c_int {
...
// Only support matching addresses by the full mask
    ...
    int err;
    spin_lock(&adapter.nfc_lock);
    err = igb_update_ethtool_nfc_entry(adapter, core::ptr::null_mut(), fsp.location);
    spin_unlock(&adapter.nfc_lock);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn igb_set_rxnfc(dev: *mut net_device, cmd: *mut ethtool_rxnfc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_write_rss_key(adapter: *mut igb_adapter) {
    void igb_write_rss_key(struct igb_adapter *adapter)
    {
    struct e1000_hw *hw = &adapter.hw;
    ASSERT_RTNL();
    for (int i = 0; i < IGB_RSS_KEY_SIZE / 4; i++) {
    let mut val: u32 = get_unaligned_le32(&adapter.rss_key[i * 4]);
    wr32(E1000_RSSRK(i), val);
    }
    }
#[no_mangle]
unsafe extern "C" fn igb_get_eee(netdev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
//
    ...
    let mut adv1g_eee: bool = true, adv100m_eee = true;
    s32 ret_val;
    if ((hw.mac.type < e1000_i350) ||
    (hw.phy.media_type != e1000_media_type_copper))
    return -EOPNOTSUPP;
...
#[no_mangle]
unsafe extern "C" fn igb_get_rxfh_indir_size(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn igb_write_rss_indir_tbl(adapter: *mut igb_adapter) {
    void igb_write_rss_indir_tbl(struct igb_adapter *adapter)
    {
    struct e1000_hw *hw = &adapter.hw;
    let mut reg: u32 = E1000_RETA(0);
    let mut shift: u32 = 0;
    let mut i: c_int = 0;
    switch (hw.mac.type) {
    case e1000_82575:
...
#[no_mangle]
unsafe extern "C" fn igb_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn igb_max_channels(adapter: *mut igb_adapter) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn igb_get_priv_flags(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn igb_set_priv_flags(netdev: *mut net_device, priv_flags: u32) -> c_int {
    static int igb_set_priv_flags(struct net_device *netdev, u32 priv_flags)
    {
    struct igb_adapter *adapter = netdev_priv(netdev);
    let mut flags: c_uint = adapter.flags;
...
#[no_mangle]
pub unsafe extern "C" fn igb_set_ethtool_ops(netdev: *mut net_device) {
