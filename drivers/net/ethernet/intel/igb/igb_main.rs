...
#[no_mangle]
unsafe extern "C" fn igb_regdump(hw: *mut e1000_hw, reginfo: *mut igb_reg_info) {
...
#[no_mangle]
unsafe extern "C" fn igb_dump(adapter: *mut igb_adapter) {
...
#[derive(Copy, Clone)]
pub struct my_u0 {
    pub rx_ring: *mut igb_ring,
    pub rx_desc: *mut union e1000_adv_rx_desc,
    pub staterr: u32,
    pub n: u16 i,,
...
// Print Registers
    ...
    pub )igb_reg_info_tbl: *mut for (reginfo = (struct igb_reg_info,
    pub {: reginfo->name; reginfo++),
    pub reginfo): igb_regdump(hw,,
    }
// Print TX Ring Summary
    ...
    pub buffer_info: *mut igb_tx_buffer,
...
//
    pub {: for (n = 0; n < adapter->num_tx_queues; n++),
    pub adapter->tx_ring[n]: tx_ring =,
    pub tx_ring->queue_index): pr_info("TX QUEUE INDEX = %d\n",,
    pub bi->skb\n"): pr_info("T [desc] [address 63:0 ] [PlPOCIStDDM Ln] [bi->dma ] leng ntw timestamp,
    pub {: for (i = 0; tx_ring->desc && (i < tx_ring->count); i++),
    pub next_desc: *const c_char,
    pub buffer_info: *mut igb_tx_buffer,
    pub i): tx_desc = IGB_TX_DESC(tx_ring,,
...
//
    ...
    pub format\n"): pr_info("R [desc] [ PktBuf A0] [ HeadBuf DD] [bi->dma ] [bi->skb] <-- Adv Rx Read,
    pub format\n"): pr_info("RWB[desc] [PcsmIpSHl PtRs] [vl er S cks ln] ---------------- [bi->skb] <-- Adv Rx Write-Back,
    pub {: for (i = 0; i < rx_ring->count; i++),
    pub next_desc: *const c_char,
    pub (dma_addr_t)0: dma_addr_t dma =,
    pub NULL: *mut *mut igb_rx_buffer buffer_info =,
    pub i): rx_desc = IGB_RX_DESC(rx_ring,,
...
//
#[no_mangle]
unsafe extern "C" fn igb_get_i2c_data(data: *mut c_void) -> c_int {
    static int igb_get_i2c_data(void *data)
    {
    pub )data: *mut *mut igb_adapter adapter = (igb_adapter,
    pub &adapter->hw: *mut *mut e1000_hw hw =,
    pub rd32(E1000_I2CPARAMS): s32 i2cctl =,
    pub E1000_I2C_DATA_IN): return !!(i2cctl &,
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn igb_set_i2c_data(data: *mut c_void, state: c_int) {
    ...
    pub rd32(E1000_I2CPARAMS): s32 i2cctl =,
    if (state) {
    pub E1000_I2C_DATA_OE_N: i2cctl |= E1000_I2C_DATA_OUT |,
    } else {
    pub ~E1000_I2C_DATA_OE_N: i2cctl &=,
    pub ~E1000_I2C_DATA_OUT: i2cctl &=,
    }
    pub i2cctl): wr32(E1000_I2CPARAMS,,
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn igb_set_i2c_clk(data: *mut c_void, state: c_int) {
    ...
    pub rd32(E1000_I2CPARAMS): s32 i2cctl =,
    if (state) {
    pub E1000_I2C_CLK_OE_N: i2cctl |= E1000_I2C_CLK_OUT |,
    } else {
    pub ~E1000_I2C_CLK_OUT: i2cctl &=,
    pub ~E1000_I2C_CLK_OE_N: i2cctl &=,
    }
    pub i2cctl): wr32(E1000_I2CPARAMS,,
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn igb_get_i2c_clk(data: *mut c_void) -> c_int {
    static int igb_get_i2c_clk(void *data)
    {
    pub )data: *mut *mut igb_adapter adapter = (igb_adapter,
    pub &adapter->hw: *mut *mut e1000_hw hw =,
    pub rd32(E1000_I2CPARAMS): s32 i2cctl =,
    pub E1000_I2C_CLK_IN): return !!(i2cctl &,
    }
...
//
#[no_mangle]
unsafe extern "C" fn igb_init_module() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn igb_exit_module() -> void __exit {
...
//
#[no_mangle]
unsafe extern "C" fn igb_cache_ring_register(adapter: *mut igb_adapter) {
    static void igb_cache_ring_register(struct igb_adapter *adapter)
    {
    let mut i: c_int = 0, j = 0;
    let mut rbase_offset: u32 = adapter.vfs_allocated_count;
...
#[no_mangle]
pub unsafe extern "C" fn igb_rd32(hw: *mut e1000_hw, reg: u32) -> u32 {
...
//
    ...
    {
    let mut ivar: u32 = array_rd32(E1000_IVAR0, index);
...
#[no_mangle]
unsafe extern "C" fn igb_assign_vector(q_vector: *mut igb_q_vector, msix_vector: c_int) {
    static void igb_assign_vector(struct igb_q_vector *q_vector, int msix_vector)
    {
    struct igb_adapter *adapter = q_vector.adapter;
    struct e1000_hw *hw = &adapter.hw;
    let mut rx_queue: c_int = IGB_N0_QUEUE;
    let mut tx_queue: c_int = IGB_N0_QUEUE;
    let mut msixbm: u32 = 0;
    if (q_vector.rx.ring)
...
//
#[no_mangle]
unsafe extern "C" fn igb_configure_msix(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_request_msix(adapter: *mut igb_adapter) -> c_int {
    static int igb_request_msix(struct igb_adapter *adapter)
    {
    let mut num_q_vectors: c_uint = adapter.num_q_vectors;
    struct net_device *netdev = adapter.netdev;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: q_vector->tx.ring) -> else {
    else if (q_vector.tx.ring)
    sprintf(q_vector.name, "%s-tx-%u", netdev.name,
    q_vector.tx.ring.queue_index);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: q_vector->rx.ring) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn igb_free_q_vector(adapter: *mut igb_adapter, v_idx: c_int) {
    static void igb_free_q_vector(struct igb_adapter *adapter, int v_idx)
    {
    struct igb_q_vector *q_vector = adapter.q_vector[v_idx];
    adapter.q_vector[v_idx] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn igb_reset_q_vector(adapter: *mut igb_adapter, v_idx: c_int) {
...
//
    ...
    return;
    if (q_vector.tx.ring)
    adapter.tx_ring[q_vector.tx.ring.queue_index] = core::ptr::null_mut();
    if (q_vector.rx.ring)
    adapter.rx_ring[q_vector.rx.ring.queue_index] = core::ptr::null_mut();
    netif_napi_del(&q_vector.napi);
    }
#[no_mangle]
unsafe extern "C" fn igb_reset_interrupt_capability(adapter: *mut igb_adapter) {
    static void igb_reset_interrupt_capability(struct igb_adapter *adapter)
    {
    let mut v_idx: c_int = adapter.num_q_vectors;
    if (adapter.flags & IGB_FLAG_HAS_MSIX)
    pci_disable_msix(adapter.pdev);
#[no_mangle]
pub unsafe extern "C" fn if(IGB_FLAG_HAS_MSI: adapter->flags &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn igb_free_q_vectors(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_clear_interrupt_scheme(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_set_interrupt_capability(adapter: *mut igb_adapter, msix: bool) {
...
// disable iov and allow time for transactions to clear
    ...
    adapter.vf_mac_list = core::ptr::null_mut();
    kfree(adapter.vf_data);
    adapter.vf_data = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn igb_alloc_q_vectors(adapter: *mut igb_adapter) -> c_int {
    static int igb_alloc_q_vectors(struct igb_adapter *adapter)
    {
    let mut q_vectors: c_int = adapter.num_q_vectors;
    let mut rxr_remaining: c_int = adapter.num_rx_queues;
    let mut txr_remaining: c_int = adapter.num_tx_queues;
    let mut rxr_idx: c_int = 0, txr_idx = 0, v_idx = 0;
    int err;
...
// update counts and index
    ...
    let mut rqpv: c_int = DIV_ROUND_UP(rxr_remaining, q_vectors - v_idx);
    let mut tqpv: c_int = DIV_ROUND_UP(txr_remaining, q_vectors - v_idx);
    err = igb_alloc_q_vector(adapter, q_vectors, v_idx,
...
//
#[no_mangle]
unsafe extern "C" fn igb_init_interrupt_scheme(adapter: *mut igb_adapter, msix: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn igb_request_irq(adapter: *mut igb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_free_irq(adapter: *mut igb_adapter) {
    static void igb_free_irq(struct igb_adapter *adapter)
    {
    if (adapter.flags & IGB_FLAG_HAS_MSIX) {
    let mut vector: c_int = 0, i;
...
//
#[no_mangle]
unsafe extern "C" fn igb_irq_disable(adapter: *mut igb_adapter) {
...
//
    if (adapter.flags & IGB_FLAG_HAS_MSIX) {
    let mut regval: u32 = rd32(E1000_EIAM);
...
//
#[no_mangle]
unsafe extern "C" fn igb_irq_enable(adapter: *mut igb_adapter) {
    static void igb_irq_enable(struct igb_adapter *adapter)
    {
    struct e1000_hw *hw = &adapter.hw;
    if (adapter.flags & IGB_FLAG_HAS_MSIX) {
    let mut ims: u32 = E1000_IMS_LSC | E1000_IMS_DOUTSYNC | E1000_IMS_DRSTA;
    let mut regval: u32 = rd32(E1000_EIAC);
    wr32(E1000_EIAC, regval | adapter.eims_enable_mask);
...
#[no_mangle]
unsafe extern "C" fn igb_update_mng_vlan(adapter: *mut igb_adapter) {
    static void igb_update_mng_vlan(struct igb_adapter *adapter)
    {
    struct e1000_hw *hw = &adapter.hw;
    let mut pf_id: u16 = adapter.vfs_allocated_count;
    let mut vid: u16 = adapter.hw.mng_cookie.vlan_id;
...
//
#[no_mangle]
unsafe extern "C" fn igb_release_hw_control(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_get_hw_control(adapter: *mut igb_adapter) {
...
#[no_mangle]
unsafe extern "C" fn enable_fqtss(adapter: *mut igb_adapter, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn is_fqtss_enabled(adapter: *mut igb_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn set_queue_mode(hw: *mut e1000_hw, queue: c_int, mode: enum queue_mode) {
...
#[no_mangle]
unsafe extern "C" fn is_any_cbs_enabled(adapter: *mut igb_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_any_txtime_enabled(adapter: *mut igb_adapter) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn igb_config_tx_modes(adapter: *mut igb_adapter, queue: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_setup_tx_mode(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_configure(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_power_up_link(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_power_down_link(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_check_swap_media(adapter: *mut igb_adapter) {
    static void igb_check_swap_media(struct igb_adapter *adapter)
    {
    struct e1000_hw *hw = &adapter.hw;
    u32 ctrl_ext, connsw;
    let mut swap_now: bool = false;
    ctrl_ext = rd32(E1000_CTRL_EXT);
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_up(adapter: *mut igb_adapter) -> c_int {
...
// notify VFs that reset has been completed
    if (adapter.vfs_allocated_count) {
    let mut reg_data: u32 = rd32(E1000_CTRL_EXT);
...
#[no_mangle]
pub unsafe extern "C" fn igb_down(adapter: *mut igb_adapter) {
...
// flush both disables and wait for them to finish
    ...
    igb_set_queue_napi(adapter, i, core::ptr::null_mut());
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn igb_reinit_locked(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_enable_mas(adapter: *mut igb_adapter) {
    static void igb_enable_mas(struct igb_adapter *adapter)
    {
    struct e1000_hw *hw = &adapter.hw;
    let mut connsw: u32 = rd32(E1000_CONNSW);
...
//
#[no_mangle]
unsafe extern "C" fn igb_set_i2c_bb(hw: *mut e1000_hw) {
...
#[no_mangle]
pub unsafe extern "C" fn igb_reset(adapter: *mut igb_adapter) {
...
// RAR registers were cleared during init_hw, clear mac table
    ...
    __dev_uc_unsync(adapter.netdev, core::ptr::null_mut());
...
// guarantee we can provide a unique filter for the unicast address
    ...
    let mut vfn: c_int = adapter.vfs_allocated_count;
    if (netdev_uc_count(dev) >= igb_available_rars(adapter, vfn))
    return -ENOMEM;
    }
    return ndo_dflt_fdb_add(ndm, tb, dev, addr, vid, flags);
    }
pub const IGB_MAX_MAC_HDR_LEN: c_int = 127;
pub const IGB_MAX_NETWORK_HDR_LEN: c_int = 511;
...
#[no_mangle]
unsafe extern "C" fn igb_offload_apply(adapter: *mut igb_adapter, queue: i32) {
...
// CBS offloading is only supported by queue 0 and queue 1.
    ...
    ( __be16)match.key.vlan_priority;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn igb_xdp_setup(dev: *mut net_device, bpf: *mut netdev_bpf) -> c_int {
    static int igb_xdp_setup(struct net_device *dev, struct netdev_bpf *bpf)
    {
    int i, frame_size = dev.mtu + IGB_ETH_PKT_HDR_PAD;
    struct igb_adapter *adapter = netdev_priv(dev);
    struct bpf_prog *prog = bpf.prog, *old_prog;
    let mut running: bool = netif_running(dev);
    bool need_reset;
...
#[no_mangle]
unsafe extern "C" fn igb_xdp(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn igb_xdp_xmit_back(adapter: *mut igb_adapter, xdp: *mut xdp_buff) -> c_int {
...
//
    ...
    igb_xdp_tx_queue_mapping(adapter) : core::ptr::null_mut();
    if (unlikely(!tx_ring))
    return IGB_XDP_CONSUMED;
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_set_fw_version(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_init_mas(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_init_i2c(adapter: *mut igb_adapter) -> i32 {
...
//
#[no_mangle]
unsafe extern "C" fn igb_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
// Check the NVM for wake support on non-port A ports
    ...
    &eeprom_data);
#[no_mangle]
pub unsafe extern "C" fn if(1: hw->bus.func ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn igb_sriov_reinit(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_disable_sriov(pdev: *mut pci_dev, reinit: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_enable_sriov(pdev: *mut pci_dev, num_vfs: c_int, reinit: bool) -> c_int {
    static int igb_enable_sriov(struct pci_dev *pdev, int num_vfs, bool reinit)
    {
    struct net_device *netdev = pci_get_drvdata(pdev);
    struct igb_adapter *adapter = netdev_priv(netdev);
    let mut old_vfs: c_int = pci_num_vf(pdev);
...
//
#[no_mangle]
unsafe extern "C" fn igb_remove_i2c(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_remove(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_probe_vfs(adapter: *mut igb_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn igb_get_max_rss_queues(adapter: *mut igb_adapter) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn igb_init_queue_configuration(adapter: *mut igb_adapter) {
    static void igb_init_queue_configuration(struct igb_adapter *adapter)
    {
    u32 max_rss_queues;
...
//
#[no_mangle]
unsafe extern "C" fn igb_sw_init(adapter: *mut igb_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __igb_open(netdev: *mut net_device, resuming: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn igb_open(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __igb_close(netdev: *mut net_device, suspending: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn igb_close(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_setup_tx_resources(tx_ring: *mut igb_ring) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn igb_setup_all_tx_resources(adapter: *mut igb_adapter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_setup_tctl(adapter: *mut igb_adapter) {
...
//
    ...
    {
    struct e1000_hw *hw = &adapter.hw;
    let mut txdctl: u32 = 0;
    let mut tdba: u64 = ring.dma;
    let mut reg_idx: c_int = ring.reg_idx;
...
//
#[no_mangle]
unsafe extern "C" fn igb_configure_tx(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_setup_rx_resources(rx_ring: *mut igb_ring) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn igb_setup_all_rx_resources(adapter: *mut igb_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn igb_setup_mrqc(adapter: *mut igb_adapter) {
...
// Set the default pool for the PF's first queue
    let mut vtctl: u32 = rd32(E1000_VT_CTL);
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_setup_rctl(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_setup_srrctl(adapter: *mut igb_adapter, ring: *mut igb_ring) {
    void igb_setup_srrctl(struct igb_adapter *adapter, struct igb_ring *ring)
    {
    struct e1000_hw *hw = &adapter.hw;
    let mut reg_idx: c_int = ring.reg_idx;
    let mut srrctl: u32 = 0;
    u32 buf_size;
    if (ring.xsk_pool)
    buf_size = xsk_pool_get_rx_frame_size(ring.xsk_pool);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ring_uses_large_buffer(ring)) -> else {
...
//
    ...
    let mut rdba: u64 = ring.dma;
    let mut reg_idx: c_int = ring.reg_idx;
    let mut rxdctl: u32 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn igb_configure_rx(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_free_tx_resources(tx_ring: *mut igb_ring) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_free_all_tx_resources(adapter: *mut igb_adapter) {
...
// unmap any remaining paged data
    ...
    skip_for_xsk:
    tx_buffer.next_to_watch = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn igb_clean_all_tx_rings(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_free_rx_resources(rx_ring: *mut igb_ring) {
    ...
    rx_ring.rx_buffer_info_zc = core::ptr::null_mut();
    } else {
    vfree(rx_ring.rx_buffer_info);
    rx_ring.rx_buffer_info = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn igb_free_all_rx_resources(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_clean_rx_ring(rx_ring: *mut igb_ring) {
    void igb_clean_rx_ring(struct igb_ring *rx_ring)
    {
    let mut i: u16 = rx_ring.next_to_clean;
    dev_kfree_skb(rx_ring.skb);
    rx_ring.skb = core::ptr::null_mut();
    if (rx_ring.xsk_pool) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_clean_all_rx_rings(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_set_mac(netdev: *mut net_device, p: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn igb_write_mc_addr_list(netdev: *mut net_device) -> c_int {
...
// nothing to program, so clear mc list
    igb_update_mc_addr_list(hw, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn igb_vlan_promisc_enable(adapter: *mut igb_adapter) -> c_int {
...
// Add PF to all active pools
    ...
    let mut vlvf: u32 = rd32(E1000_VLVF(i));
    vlvf |= BIT(pf_id);
...
#[no_mangle]
unsafe extern "C" fn igb_scrub_vfta(adapter: *mut igb_adapter, vfta_offset: u32) {
    static void igb_scrub_vfta(struct igb_adapter *adapter, u32 vfta_offset)
    {
    struct e1000_hw *hw = &adapter.hw;
    u32 vfta[VFTA_BLOCK_SIZE] = { 0 };
    let mut vid_start: u32 = vfta_offset * 32;
    let mut vid_end: u32 = vid_start + (VFTA_BLOCK_SIZE * 32);
...
#[no_mangle]
unsafe extern "C" fn igb_vlan_promisc_disable(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_set_rx_mode(netdev: *mut net_device) {
    static void igb_set_rx_mode(struct net_device *netdev)
    {
    struct igb_adapter *adapter = netdev_priv(netdev);
    struct e1000_hw *hw = &adapter.hw;
    let mut vfn: c_uint = adapter.vfs_allocated_count;
    let mut rctl: u32 = 0, vmolr = 0, rlpml = MAX_JUMBO_FRAME_SIZE;
    int count;
...
#[no_mangle]
unsafe extern "C" fn igb_check_wvbr(adapter: *mut igb_adapter) {
...
pub const IGB_STAGGERED_QUEUE_OFFSET: c_int = 8;
#[no_mangle]
unsafe extern "C" fn igb_spoof_check(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_update_phy_info(t: *mut timer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_has_link(adapter: *mut igb_adapter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn igb_thermal_sensor_event(hw: *mut e1000_hw, event: u32) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn igb_check_lvmmc(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_watchdog(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn igb_watchdog_task(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_update_ring_itr(q_vector: *mut igb_q_vector) {
    static void igb_update_ring_itr(struct igb_q_vector *q_vector)
    {
    let mut new_val: c_int = q_vector.itr_val;
    let mut avg_wire_size: c_int = 0;
    struct igb_adapter *adapter = q_vector.adapter;
...
//
    ...
    {
    let mut packets: c_uint = ring_container.total_packets;
    let mut bytes: c_uint = ring_container.total_bytes;
    let mut itrval: u8 = ring_container.itr;
...
#[no_mangle]
unsafe extern "C" fn igb_set_itr(q_vector: *mut igb_q_vector) {
    static void igb_set_itr(struct igb_q_vector *q_vector)
    {
    struct igb_adapter *adapter = q_vector.adapter;
    let mut new_itr: u32 = q_vector.itr_val;
    let mut current_itr: u8 = 0;
// for non-gigabit speeds, just fix the interrupt rate at 4000
    if (adapter.link_speed != SPEED_1000) {
    current_itr = 0;
    new_itr = IGB_4K_ITR;
...
#[no_mangle]
unsafe extern "C" fn igb_tx_csum(tx_ring: *mut igb_ring, first: *mut igb_tx_buffer) {
...
#[no_mangle]
unsafe extern "C" fn igb_tx_cmd_type(skb: *mut sk_buff, tx_flags: u32) -> u32 {
...
// insert frame checksum
    ...
    {
    let mut olinfo_status: u32 = paylen << E1000_ADVTXD_PAYLEN_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn __igb_maybe_stop_tx(tx_ring: *mut igb_ring, size: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn igb_maybe_stop_tx(tx_ring: *mut igb_ring, size: u16) -> c_int {
    ...
    let mut cmd_type: u32 = igb_tx_cmd_type(skb, tx_flags);
    let mut i: u16 = tx_ring.next_to_use;
    tx_desc = IGB_TX_DESC(tx_ring, i);
...
// clear dma mappings for failed tx_buffer_info map
    ...
    dma_unmap_len_set(tx_buffer, len, 0);
    dev_kfree_skb_any(tx_buffer.skb);
    tx_buffer.skb = core::ptr::null_mut();
    tx_ring.next_to_use = i;
    return -1;
    }
    ...
    let mut len: u32 = xdpf.len, cmd_type, olinfo_status;
    void *data = xdpf.data;
...
pub unsafe extern "C" fn if(_arg: !tso) -> else {
    ...
    struct sk_buff *skb)
    {
    let mut r_idx: c_uint = skb.queue_mapping;
...
//
#[no_mangle]
unsafe extern "C" fn igb_tx_timeout(netdev: *mut net_device, txqueue: unsigned int __always_unused) {
...
#[no_mangle]
unsafe extern "C" fn igb_reset_task(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
    static int igb_change_mtu(struct net_device *netdev, int new_mtu)
    {
    struct igb_adapter *adapter = netdev_priv(netdev);
    let mut max_frame: c_int = new_mtu + IGB_ETH_PKT_HDR_PAD;
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_update_stats(adapter: *mut igb_adapter) {
...
//
    ...
    for (i = 0; i < adapter.num_rx_queues; i++) {
    struct igb_ring *ring = adapter.rx_ring[i];
    let mut rqdpc: u32 = rd32(E1000_RQDPC(i));
    if (hw.mac.type >= e1000_i210)
...
#[no_mangle]
unsafe extern "C" fn igb_perout(adapter: *mut igb_adapter, tsintr_tt: c_int) {
    static void igb_perout(struct igb_adapter *adapter, int tsintr_tt)
    {
    let mut pin: c_int = ptp_find_pin(adapter.ptp_clock, PTP_PF_PEROUT, tsintr_tt);
    struct e1000_hw *hw = &adapter.hw;
    struct timespec64 ts;
    u32 tsauxc;
    ...
    let mut ns: i64 = timespec64_to_ns(&adapter.perout[tsintr_tt].period);
...
#[no_mangle]
unsafe extern "C" fn igb_extts(adapter: *mut igb_adapter, tsintr_tt: c_int) {
    static void igb_extts(struct igb_adapter *adapter, int tsintr_tt)
    {
    let mut pin: c_int = ptp_find_pin(adapter.ptp_clock, PTP_PF_EXTTS, tsintr_tt);
    let mut auxstmpl: c_int = (tsintr_tt == 1) ? E1000_AUXSTMPL1 : E1000_AUXSTMPL0;
    let mut auxstmph: c_int = (tsintr_tt == 1) ? E1000_AUXSTMPH1 : E1000_AUXSTMPH0;
    struct e1000_hw *hw = &adapter.hw;
...
#[no_mangle]
unsafe extern "C" fn igb_tsync_interrupt(adapter: *mut igb_adapter) {
    ...
    struct e1000_hw *hw = &adapter.hw;
    let mut tsicr: u32 = rd32(E1000_TSICR);
    struct ptp_clock_event event;
    if (hw.mac.type == e1000_82580) {
...
#[no_mangle]
unsafe extern "C" fn igb_msix_other(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t igb_msix_other(int irq, void *data)
    {
    struct igb_adapter *adapter = data;
    struct e1000_hw *hw = &adapter.hw;
    let mut icr: u32 = rd32(E1000_ICR);
...
#[no_mangle]
unsafe extern "C" fn igb_write_itr(q_vector: *mut igb_q_vector) {
    static void igb_write_itr(struct igb_q_vector *q_vector)
    {
    struct igb_adapter *adapter = q_vector.adapter;
    let mut itr_val: u32 = q_vector.itr_val & 0x7FFC;
    if (!q_vector.set_itr)
    return;
    if (!itr_val)
    itr_val = 0x4;
...
#[no_mangle]
unsafe extern "C" fn igb_msix_ring(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// Write the ITR value calculated from the previous interrupt.
    ...
    {
    struct e1000_hw *hw = &adapter.hw;
    let mut txctrl: u32 = dca3_get_tag(tx_ring.dev, cpu);
    if (hw.mac.type != e1000_82575)
...
//
    ...
    {
    struct e1000_hw *hw = &adapter.hw;
    let mut rxctrl: u32 = dca3_get_tag(&adapter.pdev.dev, cpu);
    if (hw.mac.type != e1000_82575)
...
#[no_mangle]
unsafe extern "C" fn igb_update_dca(q_vector: *mut igb_q_vector) {
...
#[no_mangle]
unsafe extern "C" fn igb_setup_dca(adapter: *mut igb_adapter) {
...
#[no_mangle]
unsafe extern "C" fn __igb_notify_dca(dev: *mut device, data: *mut c_void) -> c_int {
    ...
    struct pci_dev *pdev = adapter.pdev;
    struct e1000_hw *hw = &adapter.hw;
    let mut event: c_ulong = *(unsigned long *)data;
    switch (event) {
...
//
    ...
    {
    int ret_val;
    ret_val = driver_for_each_device(&igb_driver.driver, core::ptr::null_mut(), &event,
    __igb_notify_dca);
    return ret_val ? NOTIFY_BAD : NOTIFY_DONE;
    }

#[no_mangle]
unsafe extern "C" fn igb_vf_configure(adapter: *mut igb_adapter, vf: c_int) -> c_int {
    static int igb_vf_configure(struct igb_adapter *adapter, int vf)
    {
...
#[no_mangle]
unsafe extern "C" fn igb_ping_all_vfs(adapter: *mut igb_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igb_set_vf_promisc(adapter: *mut igb_adapter, msgbuf: *mut u32, vf: u32) -> c_int {
    static int igb_set_vf_promisc(struct igb_adapter *adapter, u32 *msgbuf, u32 vf)
    {
    struct e1000_hw *hw = &adapter.hw;
    let mut vmolr: u32 = rd32(E1000_VMOLR(vf));
...
// there are flags left unprocessed, likely not supported
    ...
    u32 *msgbuf, u32 vf)
    {
    let mut n: c_int = FIELD_GET(E1000_VT_MSGINFO_MASK, msgbuf[0]);
...
#[no_mangle]
unsafe extern "C" fn igb_restore_vf_multicasts(adapter: *mut igb_adapter) {
    static void igb_restore_vf_multicasts(struct igb_adapter *adapter)
    {
    struct e1000_hw *hw = &adapter.hw;
    ...
    int i, j;
    for (i = 0; i < adapter.vfs_allocated_count; i++) {
    let mut vmolr: u32 = rd32(E1000_VMOLR(i));
...
#[no_mangle]
unsafe extern "C" fn igb_clear_vf_vfta(adapter: *mut igb_adapter, vf: u32) {
...
#[no_mangle]
unsafe extern "C" fn igb_find_vlvf_entry(hw: *mut e1000_hw, vlan: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_update_pf_vlvf(adapter: *mut igb_adapter, vid: u32) {
...
// Disable the filter so this falls into the default pool.
    ...
    bool add, u32 vf)
    {
    let mut pf_id: c_int = adapter.vfs_allocated_count;
    struct e1000_hw *hw = &adapter.hw;
    int err;
...
#[no_mangle]
unsafe extern "C" fn igb_set_vmvir(adapter: *mut igb_adapter, vid: u32, vf: u32) {
...
#[no_mangle]
unsafe extern "C" fn igb_disable_port_vlan(adapter: *mut igb_adapter, vf: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_set_vf_vlan_msg(adapter: *mut igb_adapter, msgbuf: *mut u32, vf: u32) -> c_int {
    static int igb_set_vf_vlan_msg(struct igb_adapter *adapter, u32 *msgbuf, u32 vf)
    {
    let mut add: c_int = FIELD_GET(E1000_VT_MSGINFO_MASK, msgbuf[0]);
    let mut vid: c_int = (msgbuf[1] & E1000_VLVF_VLANID_MASK);
    int ret;
    if (adapter.vf_data[vf].pf_vlan)
    return -1;
...
#[no_mangle]
pub unsafe extern "C" fn igb_vf_reset(adapter: *mut igb_adapter, vf: u32) {
...
#[no_mangle]
unsafe extern "C" fn igb_vf_reset_event(adapter: *mut igb_adapter, vf: u32) {
...
#[no_mangle]
unsafe extern "C" fn igb_vf_reset_msg(adapter: *mut igb_adapter, vf: u32) {
...
#[no_mangle]
unsafe extern "C" fn igb_flush_mac_table(adapter: *mut igb_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igb_available_rars(adapter: *mut igb_adapter, queue: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_set_default_mac_filter(adapter: *mut igb_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igb_uc_sync(netdev: *mut net_device, addr: *const c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_uc_unsync(netdev: *mut net_device, addr: *const c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_set_vf_mac_addr(adapter: *mut igb_adapter, msg: *mut u32, vf: c_int) -> c_int {
    static int igb_set_vf_mac_addr(struct igb_adapter *adapter, u32 *msg, int vf)
    {
    struct pci_dev *pdev = adapter.pdev;
    struct vf_data_storage *vf_data = &adapter.vf_data[vf];
    let mut info: u32 = msg[0] & E1000_VT_MSGINFO_MASK;
...
#[no_mangle]
unsafe extern "C" fn igb_rcv_ack_from_vf(adapter: *mut igb_adapter, vf: u32) {
    static void igb_rcv_ack_from_vf(struct igb_adapter *adapter, u32 vf)
    {
    struct e1000_hw *hw = &adapter.hw;
    struct vf_data_storage *vf_data = &adapter.vf_data[vf];
    let mut msg: u32 = E1000_VT_MSGTYPE_NACK;
...
#[no_mangle]
unsafe extern "C" fn igb_rcv_msg_from_vf(adapter: *mut igb_adapter, vf: u32) {
...
#[no_mangle]
unsafe extern "C" fn igb_msg_task(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_set_uta(adapter: *mut igb_adapter, set: bool) {
    static void igb_set_uta(struct igb_adapter *adapter, bool set)
    {
    struct e1000_hw *hw = &adapter.hw;
    let mut uta: u32 = set ? ~0 : 0;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn igb_intr_msi(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn igb_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn igb_ring_irq_enable(q_vector: *mut igb_q_vector) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
    ...
    let mut clean_complete: bool = true;
...
//
#[no_mangle]
unsafe extern "C" fn igb_clean_tx_irq(q_vector: *mut igb_q_vector, napi_budget: c_int) -> bool {
    static bool igb_clean_tx_irq(struct igb_q_vector *q_vector, int napi_budget)
    {
    let mut total_bytes: c_uint = 0, total_packets = 0;
    struct igb_adapter *adapter = q_vector.adapter;
    let mut budget: c_uint = q_vector.tx.work_limit;
    struct igb_ring *tx_ring = q_vector.tx.ring;
    let mut i: c_uint = tx_ring.next_to_clean;
    union e1000_adv_tx_desc *tx_desc;
    struct igb_tx_buffer *tx_buffer;
    struct xsk_buff_pool *xsk_pool;
    let mut cpu: c_int = smp_processor_id();
    let mut xsk_xmit_done: bool = true;
    struct netdev_queue *nq;
    let mut xsk_frames: u32 = 0;
    if (test_bit(__IGB_DOWN, &adapter.state))
    return true;
...
//
    ...
    let mut nta: u16 = rx_ring.next_to_alloc;
...
//
    ...
    int rx_buf_pgcnt)
    {
    let mut pagecnt_bias: c_uint = rx_buffer.pagecnt_bias;
...
//
    ...
    let mut truesize: c_uint = igb_rx_pg_size(rx_ring) / 2;
    ...
    let mut size: c_uint = xdp.data_end - xdp.data;
...
// update all of the pointers
    ...
    let mut metasize: c_uint = xdp.data - xdp.data_meta;
    struct sk_buff *skb;
// prefetch first cache line of first page
...
// update buffer offset
    ...
    unsigned int size)
    {
    let mut truesize: c_uint = igb_rx_frame_truesize(rx_ring, size);
...
//
    ...
    union e1000_adv_rx_desc *rx_desc)
    {
    let mut ntc: u32 = rx_ring.next_to_clean + 1;
...
//
    ...
    vid = be16_to_cpu(( __be16)rx_desc.wb.upper.vlan);
    else
...
#[no_mangle]
unsafe extern "C" fn igb_rx_offset(rx_ring: *mut igb_ring) -> c_uint {
...
// clear contents of rx_buffer
    rx_buffer.page = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn igb_finalize_xdp(adapter: *mut igb_adapter, status: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn igb_clean_rx_irq(q_vector: *mut igb_q_vector, budget: c_int) -> c_int {
    static int igb_clean_rx_irq(struct igb_q_vector *q_vector, const int budget)
    {
    let mut total_bytes: c_uint = 0, total_packets = 0;
    struct igb_adapter *adapter = q_vector.adapter;
    struct igb_ring *rx_ring = q_vector.rx.ring;
    let mut cleaned_count: u16 = igb_desc_unused(rx_ring);
    struct sk_buff *skb = rx_ring.skb;
    let mut xdp_xmit: c_uint = 0;
    struct xdp_buff xdp;
    let mut frame_sz: u32 = 0;
    int rx_buf_pgcnt;
    let mut xdp_res: c_int = 0;
// Frame size depend on rx_ring setup when PAGE_SIZE=4K
    ...
    union e1000_adv_rx_desc *rx_desc;
    struct igb_rx_buffer *rx_buffer;
    let mut timestamp: ktime_t = 0;
    let mut pkt_offset: c_int = 0;
    unsigned int size;
    void *pktbuf;
...
// retrieve a buffer from the ring
    ...
    let mut offset: c_uint = pkt_offset + igb_rx_offset(rx_ring);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ring_uses_build_skb(rx_ring)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_alloc_rx_buffers(rx_ring: *mut igb_ring, cleaned_count: u16) {
    void igb_alloc_rx_buffers(struct igb_ring *rx_ring, u16 cleaned_count)
    {
    union e1000_adv_rx_desc *rx_desc;
    struct igb_rx_buffer *bi;
    let mut i: u16 = rx_ring.next_to_use;
    u16 bufsz;
// nothing to do
    if (!cleaned_count)
    return;
...
//
#[no_mangle]
unsafe extern "C" fn igb_mii_ioctl(netdev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn igb_ioctl(netdev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn igb_read_pci_cfg(hw: *mut e1000_hw, reg: u32, value: *mut u16) {
...
#[no_mangle]
pub unsafe extern "C" fn igb_write_pci_cfg(hw: *mut e1000_hw, reg: u32, value: *mut u16) {
...
#[no_mangle]
pub unsafe extern "C" fn igb_read_pcie_cap_reg(hw: *mut e1000_hw, reg: u32, value: *mut u16) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn igb_write_pcie_cap_reg(hw: *mut e1000_hw, reg: u32, value: *mut u16) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn igb_vlan_mode(netdev: *mut net_device, features: netdev_features_t) {
    static void igb_vlan_mode(struct net_device *netdev, netdev_features_t features)
    {
    struct igb_adapter *adapter = netdev_priv(netdev);
    struct e1000_hw *hw = &adapter.hw;
    u32 ctrl, rctl;
    let mut enable: bool = !!(features & NETIF_F_HW_VLAN_CTAG_RX);
    if (enable) {
...
#[no_mangle]
unsafe extern "C" fn igb_restore_vlan(adapter: *mut igb_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn igb_set_spd_dplx(adapter: *mut igb_adapter, spd: u32, dplx: u8) -> c_int {
...
// clear MDI, MDI(-X) override is only allowed when autoneg enabled
    ...
    let mut wufc: u32 = runtime ? E1000_WUFC_LNKC : adapter.wol;
    bool wake;
    rtnl_lock();
...
#[no_mangle]
unsafe extern "C" fn igb_deliver_wake_packet(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn igb_suspend(dev: *mut device) -> c_int {
    static int igb_suspend(struct device *dev)
    {
    return __igb_shutdown(to_pci_dev(dev), core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn __igb_resume(dev: *mut device, rpm: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_resume(dev: *mut device) -> c_int {
    static int igb_resume(struct device *dev)
    {
    return __igb_resume(dev, false);
    }
#[no_mangle]
unsafe extern "C" fn igb_runtime_idle(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_runtime_suspend(dev: *mut device) -> c_int {
    static int igb_runtime_suspend(struct device *dev)
    {
    return __igb_shutdown(to_pci_dev(dev), core::ptr::null_mut(), 1);
    }
#[no_mangle]
unsafe extern "C" fn igb_runtime_resume(dev: *mut device) -> c_int {
    static int igb_runtime_resume(struct device *dev)
    {
    return __igb_resume(dev, true);
    }
#[no_mangle]
unsafe extern "C" fn igb_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn igb_pci_sriov_configure(dev: *mut pci_dev, num_vfs: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn igb_io_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
//
#[no_mangle]
unsafe extern "C" fn igb_io_resume(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_rar_set_index(adapter: *mut igb_adapter, index: u32) {
...
//
    let mut rar_entry: c_int = hw.mac.rar_entry_count - (vf + 1);
...
#[no_mangle]
unsafe extern "C" fn igb_ndo_set_vf_mac(netdev: *mut net_device, vf: c_int, mac: *mut u8) -> c_int {
    static int igb_ndo_set_vf_mac(struct net_device *netdev, int vf, u8 *mac)
    {
    struct igb_adapter *adapter = netdev_priv(netdev);
...
#[no_mangle]
unsafe extern "C" fn igb_link_mbps(internal_link_speed: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_check_vf_rate_limit(adapter: *mut igb_adapter) {
    static void igb_check_vf_rate_limit(struct igb_adapter *adapter)
    {
    int actual_link_speed, i;
    let mut reset_rate: bool = false;
...
#[no_mangle]
unsafe extern "C" fn igb_ndo_set_vf_trust(netdev: *mut net_device, vf: c_int, setting: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_vmm_control(adapter: *mut igb_adapter) {
...
#[no_mangle]
unsafe extern "C" fn igb_init_dmac(adapter: *mut igb_adapter, pba: u32) {
    static void igb_init_dmac(struct igb_adapter *adapter, u32 pba)
    {
    struct e1000_hw *hw = &adapter.hw;
    u32 dmac_thr;
...
//
    ...
    let mut reg: u32 = rd32(E1000_PCIEMISC);
...
//
    ...
    struct i2c_client *this_client = adapter.i2c_client;
    s32 status;
    let mut swfw_mask: u16 = E1000_SWFW_PHY0_SM;
    if (!this_client)
    return E1000_ERR_I2C;
    if (hw.mac.ops.acquire_swfw_sync(hw, swfw_mask))
    return E1000_ERR_SWFW_SYNC;
...
#[no_mangle]
pub unsafe extern "C" fn igb_reinit_queues(adapter: *mut igb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_nfc_filter_exit(adapter: *mut igb_adapter) {
    static void igb_nfc_filter_exit(struct igb_adapter *adapter)
    {
    struct igb_nfc_filter *rule;
    spin_lock(&adapter.nfc_lock);
...
#[no_mangle]
unsafe extern "C" fn igb_nfc_filter_restore(adapter: *mut igb_adapter) {
    static void igb_nfc_filter_restore(struct igb_adapter *adapter)
    {
    struct igb_nfc_filter *rule;
    spin_lock(&adapter.nfc_lock);
