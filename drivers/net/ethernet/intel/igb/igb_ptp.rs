...
//! Source: drivers/net/ethernet/intel/igb/igb_ptp.c
#![no_std]
...
pub const IGB_NBITS_82580: c_int = 40;
pub const IGB_82580_BASE_PERIOD: c_uint = 0x800000000;
    static void igb_ptp_tx_hwtstamp(struct igb_adapter *adapter);
    static void igb_ptp_sdp_init(struct igb_adapter *adapter);
// SYSTIM read access for the 82576
#[no_mangle]
unsafe extern "C" fn igb_ptp_read_82576(cc: *mut cyclecounter) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn igb_ptp_read_82580(cc: *mut cyclecounter) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn igb_ptp_adjfine_82576(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_ptp_adjfine_82580(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_ptp_adjtime_82576(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_ptp_adjtime_i210(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn igb_pin_direction(pin: c_int, input: c_int, ctrl: *mut u32, ctrl_ext: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn igb_pin_extts(igb: *mut igb_adapter, chan: c_int, pin: c_int) {
...
#[no_mangle]
unsafe extern "C" fn igb_pin_perout(igb: *mut igb_adapter, chan: c_int, pin: c_int, freq: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_ptp_tx_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn igb_ptp_overflow_check(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_ptp_rx_hang(adapter: *mut igb_adapter) {
    void igb_ptp_rx_hang(struct igb_adapter *adapter)
    {
    struct e1000_hw *hw = &adapter.hw;
    let mut tsyncrxctl: u32 = rd32(E1000_TSYNCRXCTL);
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_ptp_tx_hang(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn igb_ptp_tx_hwtstamp(adapter: *mut igb_adapter) {
    static void igb_ptp_tx_hwtstamp(struct igb_adapter *adapter)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_ptp_rx_rgtstamp(q_vector: *mut igb_q_vector, skb: *mut sk_buff) {
...
//
    ...
    {
    struct e1000_hw *hw = &adapter.hw;
    let mut tsync_tx_ctl: u32 = E1000_TSYNCTXCTL_ENABLED;
    let mut tsync_rx_ctl: u32 = E1000_TSYNCRXCTL_ENABLED;
    let mut tsync_rx_cfg: u32 = 0;
    let mut is_l4: bool = false;
...
// L4 Queue Filter[3]: filter by destination port and protocol
    ...
    wr32(E1000_IMIR(3), ( unsigned int)htons(PTP_EV_PORT));
    wr32(E1000_IMIREXT(3),
    (E1000_IMIREXT_SIZE_BP | E1000_IMIREXT_CTRL_BP));
    if (hw.mac.type == e1000_82576) {
// enable source port check
    wr32(E1000_SPQF(3), ( unsigned int)htons(PTP_EV_PORT));
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_ptp_init(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_ptp_sdp_init(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_ptp_suspend(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_ptp_stop(adapter: *mut igb_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn igb_ptp_reset(adapter: *mut igb_adapter) {
