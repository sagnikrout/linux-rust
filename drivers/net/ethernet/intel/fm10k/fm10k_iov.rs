...
//! Source: drivers/net/ethernet/intel/fm10k/fm10k_iov.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_iov_event(interface: *mut fm10k_intfc) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_iov_mbx(interface: *mut fm10k_intfc) -> i32 {
...
//
    ...
    let mut glort: u16 = vf_info.glort;
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_iov_suspend(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_mask_aer_comp_abort(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_iov_resume(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_iov_update_pvid(interface: *mut fm10k_intfc, glort: u16, pvid: u16) -> i32 {
    s32 fm10k_iov_update_pvid(struct fm10k_intfc *interface, u16 glort, u16 pvid)
    {
    struct fm10k_iov_data *iov_data = interface.iov_data;
    struct fm10k_hw *hw = &interface.hw;
    struct fm10k_vf_info *vf_info;
    let mut vf_idx: u16 = (glort - hw.mac.dglort_map) & FM10K_DGLORTMAP_NONE;
...
#[no_mangle]
unsafe extern "C" fn fm10k_iov_free_data(pdev: *mut pci_dev) {
...
// drop iov_data from interface
    ...
    interface.iov_data = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn fm10k_iov_alloc_data(pdev: *mut pci_dev, num_vfs: c_int) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_iov_disable(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_iov_configure(pdev: *mut pci_dev, num_vfs: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_iov_update_stats(interface: *mut fm10k_intfc) {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_ndo_set_vf_mac(netdev: *mut net_device, vf_idx: c_int, mac: *mut u8) -> c_int {
