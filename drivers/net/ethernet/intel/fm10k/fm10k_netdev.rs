...
//! Source: drivers/net/ethernet/intel/fm10k/fm10k_netdev.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_setup_tx_resources(tx_ring: *mut fm10k_ring) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_setup_all_tx_resources(interface: *mut fm10k_intfc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_setup_rx_resources(rx_ring: *mut fm10k_ring) -> c_int {
...
// Round up to nearest 4K
    ...
    rx_ring.rx_buffer = core::ptr::null_mut();
    return -ENOMEM;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_setup_all_rx_resources(interface: *mut fm10k_intfc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_clean_tx_ring(tx_ring: *mut fm10k_ring) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_free_tx_resources(tx_ring: *mut fm10k_ring) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_clean_all_tx_rings(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_free_all_tx_resources(interface: *mut fm10k_intfc) {
    static void fm10k_free_all_tx_resources(struct fm10k_intfc *interface)
    {
    let mut i: c_int = interface.num_tx_queues;
    while (i--)
    fm10k_free_tx_resources(interface.tx_ring[i]);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_clean_rx_ring(rx_ring: *mut fm10k_ring) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_free_rx_resources(rx_ring: *mut fm10k_ring) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_clean_all_rx_rings(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_free_all_rx_resources(interface: *mut fm10k_intfc) {
    static void fm10k_free_all_rx_resources(struct fm10k_intfc *interface)
    {
    let mut i: c_int = interface.num_rx_queues;
    while (i--)
    fm10k_free_rx_resources(interface.rx_ring[i]);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_request_glort_range(interface: *mut fm10k_intfc) {
    static void fm10k_request_glort_range(struct fm10k_intfc *interface)
    {
    struct fm10k_hw *hw = &interface.hw;
    let mut mask: u16 = (~hw.mac.dglort_map) >> FM10K_DGLORTMAP_MASK_SHIFT;
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_restore_udp_port_info(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_udp_tunnel_sync(dev: *mut net_device, table: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_open(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fm10k_xmit_frame(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t fm10k_xmit_frame(struct sk_buff *skb, struct net_device *dev)
    {
    struct fm10k_intfc *interface = netdev_priv(dev);
    let mut num_tx_queues: c_int = READ_ONCE(interface.num_tx_queues);
...
//
    ...
    let mut pad_len: c_int = 17 - skb.len;
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
    static void fm10k_tx_timeout(struct net_device *netdev, unsigned int txqueue)
    {
    struct fm10k_intfc *interface = netdev_priv(netdev);
    struct fm10k_ring *tx_ring;
    let mut real_tx_hang: bool = false;
    ...
    real_tx_hang = true;
pub const TX_TIMEO_LIMIT: c_int = 16000;
    if (real_tx_hang) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_host_mbx_ready(interface: *mut fm10k_intfc) -> bool {
...
// Don't free requests for other interfaces
    ...
    {
    struct fm10k_intfc *interface = netdev_priv(netdev);
    let mut glort: u16 = interface.glort;
    let mut vid: u16 = interface.vid;
    let mut set: bool = !!(vid / VLAN_N_VID);
    int err;
...
#[no_mangle]
unsafe extern "C" fn fm10k_update_vid(netdev: *mut net_device, vid: u16, set: bool) -> c_int {
...
// disable the default VLAN ID on ring if we have an active VLAN
    ...
    let mut rx_vid: u16 = rx_ring.vid & (VLAN_N_VID - 1);
...
#[no_mangle]
unsafe extern "C" fn fm10k_find_next_vlan(interface: *mut fm10k_intfc, vid: u16) -> u16 {
    static u16 fm10k_find_next_vlan(struct fm10k_intfc *interface, u16 vid)
    {
    struct fm10k_hw *hw = &interface.hw;
    let mut default_vid: u16 = hw.mac.default_vid;
    let mut vid_limit: u16 = vid < default_vid ? default_vid : VLAN_N_VID;
    vid = find_next_bit(interface.active_vlans, vid_limit, ++vid);
    return vid;
    }
#[no_mangle]
unsafe extern "C" fn fm10k_clear_unused_vlans(interface: *mut fm10k_intfc) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_set_mac(dev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fm10k_set_rx_mode(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_restore_rx_state(interface: *mut fm10k_intfc) {
...
#[no_mangle]
pub unsafe extern "C" fn if(IFF_ALLMULTI: netdev->flags &) -> else {
    else if (netdev.flags & IFF_ALLMULTI)
    xcast_mode = FM10K_XCAST_MODE_ALLMULTI;
#[no_mangle]
pub unsafe extern "C" fn if(IFF_MULTICAST): netdev->flags & (IFF_BROADCAST |) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_reset_rx_state(interface: *mut fm10k_intfc) {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_setup_tc(dev: *mut net_device, tc: u8) -> c_int {
...
// flag to indicate SWPRI has yet to be updated
    ...
    struct fm10k_intfc *interface = netdev_priv(dev);
    struct fm10k_l2_accel *l2_accel = interface.l2_accel;
    struct fm10k_l2_accel *old_l2_accel = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fm10k_dfwd_del_station(dev: *mut net_device, priv: *mut c_void) {
...
// Remove any rules specific to this dglort
    ...
    fm10k_mbx_unlock(interface);
// record removal
    l2_accel.macvlan[i] = core::ptr::null_mut();
    l2_accel.count--;
// configure default DGLORT mapping for RSS/DCB
    dglort.idx = fm10k_dglort_pf_rss;
    dglort.inner_rss = 1;
...
// If table is empty remove it
    if (l2_accel.count == 0) {
    fm10k_assign_l2_accel(interface, core::ptr::null_mut());
