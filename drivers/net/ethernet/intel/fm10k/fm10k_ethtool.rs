...
//! Source: drivers/net/ethernet/intel/fm10k/fm10k_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fm10k_get_stat_strings(dev: *mut net_device, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
    static int fm10k_get_sset_count(struct net_device *dev, int sset)
    {
    struct fm10k_intfc *interface = netdev_priv(dev);
    struct fm10k_hw *hw = &interface.hw;
    let mut stats_len: c_int = FM10K_STATIC_STATS_LEN;
    switch (sset) {
    case ETH_SS_TEST:
...
pub const FM10K_REGS_LEN_Q: c_int = 29;
#[no_mangle]
unsafe extern "C" fn fm10k_get_reg_q(hw: *mut fm10k_hw, buff: *mut u32, i: c_int) {
...
pub const FM10K_REGS_LEN_VSI: c_int = 43;
#[no_mangle]
unsafe extern "C" fn fm10k_get_reg_vsi(hw: *mut fm10k_hw, buff: *mut u32, i: c_int) {
    static void fm10k_get_reg_vsi(struct fm10k_hw *hw, u32 *buff, int i)
    {
    let mut idx: c_int = 0, j;
...
#[no_mangle]
unsafe extern "C" fn fm10k_get_regs_len(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fm10k_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fm10k_set_msglevel(netdev: *mut net_device, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_get_rx_ring_count(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fm10k_mbx_test(interface: *mut fm10k_intfc, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fm10k_get_priv_flags(netdev: *mut net_device) -> u32 {
    static u32 fm10k_get_priv_flags(struct net_device *netdev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn fm10k_set_priv_flags(netdev: *mut net_device, priv_flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fm10k_get_reta_size(netdev: *mut net_device __always_unused) -> u32 {
    static u32 fm10k_get_reta_size(struct net_device __always_unused *netdev)
    {
    return FM10K_RETA_SIZE * FM10K_RETA_ENTRIES_PER_REG;
    }
#[no_mangle]
pub unsafe extern "C" fn fm10k_write_reta(interface: *mut fm10k_intfc, indir: *const u32) {
    void fm10k_write_reta(struct fm10k_intfc *interface, const u32 *indir)
    {
    let mut rss_i: u16 = interface.ring_feature[RING_F_RSS].indices;
    struct fm10k_hw *hw = &interface.hw;
    u32 table[4];
    int i, j;
...
#[no_mangle]
unsafe extern "C" fn fm10k_get_reta(netdev: *mut net_device, indir: *mut u32) -> c_int {
    ...
    let mut reta: u32 = interface.reta[i];
    indir[0] = (reta << 24) >> 24;
    indir[1] = (reta << 16) >> 24;
    indir[2] = (reta <<  8) >> 24;
    indir[3] = (reta) >> 24;
...
#[no_mangle]
unsafe extern "C" fn fm10k_set_reta(netdev: *mut net_device, indir: *const u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fm10k_get_rssrk_size(netdev: *mut net_device __always_unused) -> u32 {
...
// We do not allow change in unsupported parameters
    ...
    let mut rssrk: u32 = le32_to_cpu(*(__le32 *)rxfh.key);
...
#[no_mangle]
unsafe extern "C" fn fm10k_max_channels(dev: *mut net_device) -> c_uint {
    static unsigned int fm10k_max_channels(struct net_device *dev)
    {
    struct fm10k_intfc *interface = netdev_priv(dev);
    let mut max_combined: c_uint = interface.hw.mac.max_queues;
    let mut tcs: u8 = netdev_get_num_tc(dev);
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_set_ethtool_ops(dev: *mut net_device) {
