...
//! Source: drivers/net/ethernet/intel/fm10k/fm10k_pci.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_read_pci_cfg_word(hw: *mut fm10k_hw, reg: u32) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_read_reg(hw: *mut fm10k_hw, reg: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fm10k_hw_ready(interface: *mut fm10k_intfc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_macvlan_schedule(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_stop_macvlan_task(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_resume_macvlan_task(interface: *mut fm10k_intfc) {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_service_event_schedule(interface: *mut fm10k_intfc) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_service_event_complete(interface: *mut fm10k_intfc) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_stop_service_event(interface: *mut fm10k_intfc) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_start_service_event(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_service_timer(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_prepare_for_reset(interface: *mut fm10k_intfc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fm10k_handle_reset(interface: *mut fm10k_intfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fm10k_detach_subtask(interface: *mut fm10k_intfc) {
...
//
    ...
    interface.hw.hw_addr = core::ptr::null_mut();
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn fm10k_reset_subtask(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_configure_swpri_map(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_watchdog_update_host_state(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_mbx_subtask(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_watchdog_host_is_ready(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_watchdog_host_not_ready(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_update_stats(interface: *mut fm10k_intfc) {
    void fm10k_update_stats(struct fm10k_intfc *interface)
    {
    struct net_device_stats *net_stats = &interface.netdev.stats;
    struct fm10k_hw *hw = &interface.hw;
    let mut hw_csum_tx_good: u64 = 0, hw_csum_rx_good = 0, rx_length_errors = 0;
    let mut rx_switch_errors: u64 = 0, rx_drops = 0, rx_pp_errors = 0;
    let mut rx_link_errors: u64 = 0;
    let mut rx_errors: u64 = 0, rx_csum_errors = 0, tx_csum_errors = 0;
    let mut restart_queue: u64 = 0, tx_busy = 0, alloc_failed = 0;
    let mut rx_bytes_nic: u64 = 0, rx_pkts_nic = 0, rx_drops_nic = 0;
    let mut tx_bytes_nic: u64 = 0, tx_pkts_nic = 0;
    u64 bytes, pkts;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_watchdog_flush_tx(interface: *mut fm10k_intfc) {
    static void fm10k_watchdog_flush_tx(struct fm10k_intfc *interface)
    {
    let mut some_tx_pending: c_int = 0;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_watchdog_subtask(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_check_hang_subtask(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_service_task(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_macvlan_task(work: *mut work_struct) {
...
//
    ...
    let mut size: u32 = ring.count * sizeof(struct fm10k_tx_desc);
    let mut txint: u32 = FM10K_INT_MAP_DISABLE;
    let mut txdctl: u32 = BIT(FM10K_TXDCTL_MAX_TIME_SHIFT) | FM10K_TXDCTL_ENABLE;
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_configure_tx(interface: *mut fm10k_intfc) {
...
//
    ...
    struct fm10k_hw *hw = &interface.hw;
    let mut size: u32 = ring.count * sizeof(union fm10k_rx_desc);
    u32 rxqctl, rxdctl = FM10K_RXDCTL_WRITE_BACK_MIN_DELAY;
    let mut srrctl: u32 = FM10K_SRRCTL_BUFFER_CHAINING_EN;
    let mut rxint: u32 = FM10K_INT_MAP_DISABLE;
    let mut rx_pause: u8 = interface.rx_pause;
    let mut reg_idx: u8 = ring.reg_idx;
// disable queue to avoid issues while updating state
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_update_rx_drop_en(interface: *mut fm10k_intfc) {
    ...
    let mut rxdctl: u32 = FM10K_RXDCTL_WRITE_BACK_MIN_DELAY;
    let mut reg_idx: u8 = ring.reg_idx;
    if (!(rx_pause & BIT(ring.qos_pc)))
    rxdctl |= FM10K_RXDCTL_DROP_ON_EMPTY;
    fm10k_write_reg(hw, FM10K_RXDCTL(reg_idx), rxdctl);
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_configure_dglort(interface: *mut fm10k_intfc) {
    static void fm10k_configure_dglort(struct fm10k_intfc *interface)
    {
    let mut dglort: fm10k_dglort_cfg = { 0 };
    struct fm10k_hw *hw = &interface.hw;
    int i;
    u32 mrqc;
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_configure_rx(interface: *mut fm10k_intfc) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_napi_enable_all(interface: *mut fm10k_intfc) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_msix_clean_rings(irq: int __always_unused, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fm10k_msix_mbx_vf(irq: int __always_unused, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fm10k_report_fault(interface: *mut fm10k_intfc, eicr: u32) {
    static void fm10k_report_fault(struct fm10k_intfc *interface, u32 eicr)
    {
    struct fm10k_hw *hw = &interface.hw;
    let mut fault: fm10k_fault = { 0 };
    int type, err;
...
#[no_mangle]
unsafe extern "C" fn fm10k_reset_drop_on_empty(interface: *mut fm10k_intfc, eicr: u32) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_msix_mbx_pf(irq: int __always_unused, data: *mut c_void) -> irqreturn_t {
...
// service mailboxes
    if (fm10k_mbx_trylock(interface)) {
    let mut err: i32 = mbx.ops.process(hw, mbx);
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_mbx_free_irq(interface: *mut fm10k_intfc) {
...
// disable Mailbox cause
    ...
    {
    let mut vlan_override: bool = hw.mac.vlan_override;
    let mut default_vid: u16 = hw.mac.default_vid;
    struct fm10k_intfc *interface;
    s32 err;
...
#[no_mangle]
unsafe extern "C" fn fm10k_mbx_request_irq_vf(interface: *mut fm10k_intfc) -> c_int {
...
// Use timer0 for interrupt moderation on the mailbox
    let mut itr: u32 = entry.entry | FM10K_INT_MAP_TIMER0;
...
// enable interrupt
    ...
    {
    struct fm10k_intfc *interface;
    let mut dglort_map: u32 = hw.mac.dglort_map;
    s32 err;
    interface = container_of(hw, struct fm10k_intfc, hw);
...
#[no_mangle]
unsafe extern "C" fn fm10k_mbx_request_irq_pf(interface: *mut fm10k_intfc) -> c_int {
    ...
    int err;
// Use timer0 for interrupt moderation on the mailbox
    let mut mbx_itr: u32 = entry.entry | FM10K_INT_MAP_TIMER0;
    let mut other_itr: u32 = entry.entry | FM10K_INT_MAP_IMMEDIATE;
// register mailbox handlers
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_mbx_request_irq(interface: *mut fm10k_intfc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_qv_free_irq(interface: *mut fm10k_intfc) {
    void fm10k_qv_free_irq(struct fm10k_intfc *interface)
    {
    let mut vector: c_int = interface.num_q_vectors;
    struct msix_entry *entry;
...
// clear the affinity_mask in the IRQ descriptor
    irq_set_affinity_hint(entry.vector, core::ptr::null_mut());
// disable interrupts
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_qv_request_irq(interface: *mut fm10k_intfc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_up(interface: *mut fm10k_intfc) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_napi_disable_all(interface: *mut fm10k_intfc) {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_down(interface: *mut fm10k_intfc) {
...
//
    ...
    goto skip_tx_dma_drain;
pub const TX_DMA_DRAIN_RETRIES: c_int = 25;
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_prepare_suspend(interface: *mut fm10k_intfc) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_handle_resume(interface: *mut fm10k_intfc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_resume(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_io_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_io_resume(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_io_reset_prepare(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_io_reset_done(pdev: *mut pci_dev) {
    static void fm10k_io_reset_done(struct pci_dev *pdev)
    {
    struct fm10k_intfc *interface = pci_get_drvdata(pdev);
    let mut err: c_int = fm10k_handle_resume(interface);
    if (err) {
    dev_warn(&pdev.dev,
    "%s failed: %d\n", __func__, err);
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_register_pci_driver() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_unregister_pci_driver() {
