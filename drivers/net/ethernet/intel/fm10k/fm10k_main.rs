...
//! Source: drivers/net/ethernet/intel/fm10k/fm10k_main.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_init_module() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_exit_module() -> void __exit {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_alloc_rx_buffers(rx_ring: *mut fm10k_ring, cleaned_count: u16) {
...
//
    ...
    let mut truesize: c_uint = FM10K_RX_BUFSZ;

    let mut truesize: c_uint = ALIGN(size, 512);
...
// update all of the pointers
    ...
    struct sk_buff *skb)
    {
    let mut size: c_uint = le16_to_cpu(rx_desc.w.length);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !fm10k_test_staterr(rx_desc, _arg: FM10K_RXD_STATUS_L4CS)) -> else {
...
// check to see if DGLORT belongs to a MACVLAN
    if (l2_accel) {
    let mut idx: u16 = le16_to_cpu(FM10K_CB(skb).fi.w.dglort) - 1;
    idx -= l2_accel.dglort;
    if (idx < l2_accel.size && l2_accel.macvlan[idx])
    dev = l2_accel.macvlan[idx];
    else
    l2_accel = core::ptr::null_mut();
    }
...
//
    ...
    if (rx_desc.w.vlan) {
    let mut vid: u16 = le16_to_cpu(rx_desc.w.vlan);
    if ((vid & VLAN_VID_MASK) != rx_ring.vid)
    __vlan_hwaccel_put_tag(skb, htons(ETH_P_8021Q), vid);
#[no_mangle]
pub unsafe extern "C" fn if(VLAN_PRIO_MASK: vid &) -> else {
...
//
    ...
    let mut cleaned_count: u16 = fm10k_desc_unused(rx_ring);
...
pub struct fm10k_nvgre_hdr {
    ...
    let mut hlen: c_int = ip_hdrlen(skb);
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_tx_encap_offload(skb: *mut sk_buff) -> __be16 {
    __be16 fm10k_tx_encap_offload(struct sk_buff *skb)
    {
    let mut l4_hdr: u8 = 0, inner_l4_hdr = 0, inner_l4_hlen;
...
#[no_mangle]
unsafe extern "C" fn fm10k_tx_desc_flags(skb: *mut sk_buff, tx_flags: u32) -> u8 {
    static u8 fm10k_tx_desc_flags(struct sk_buff *skb, u32 tx_flags)
    {
// set type for advanced descriptor with frame checksum insertion
    let mut desc_flags: u32 = 0;
...
// return true if we just wrapped the ring
    let mut i: return = = tx_ring.count;
    }
#[no_mangle]
unsafe extern "C" fn __fm10k_maybe_stop_tx(tx_ring: *mut fm10k_ring, size: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_maybe_stop_tx(tx_ring: *mut fm10k_ring, size: u16) -> c_int {
    ...
    let mut flags: u8 = fm10k_tx_desc_flags(skb, tx_flags);
...
#[no_mangle]
unsafe extern "C" fn fm10k_get_tx_completed(ring: *mut fm10k_ring) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_get_tx_pending(ring: *mut fm10k_ring, in_sw: bool) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn fm10k_check_tx_hang(tx_ring: *mut fm10k_ring) -> bool {
    bool fm10k_check_tx_hang(struct fm10k_ring *tx_ring)
    {
    let mut tx_done: u32 = fm10k_get_tx_completed(tx_ring);
    let mut tx_done_old: u32 = tx_ring.tx_stats.tx_done_old;
    let mut tx_pending: u32 = fm10k_get_tx_pending(tx_ring, true);
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_tx_timeout_reset(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_update_itr(ring_container: *mut fm10k_ring_container) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
//
    ...
    let mut work: c_int = fm10k_clean_rx_irq(q_vector, ring, per_ring_budget);
    work_done += work;
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_set_qos_queues(interface: *mut fm10k_intfc) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_set_rss_queues(interface: *mut fm10k_intfc) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_set_num_queues(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_reset_num_queues(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_free_q_vector(interface: *mut fm10k_intfc, v_idx: c_int) {
    ...
    fm10k_for_each_ring(ring, q_vector.tx)
    interface.tx_ring[ring.queue_index] = core::ptr::null_mut();
    fm10k_for_each_ring(ring, q_vector.rx)
    interface.rx_ring[ring.queue_index] = core::ptr::null_mut();
    interface.q_vector[v_idx] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_alloc_q_vectors(interface: *mut fm10k_intfc) -> c_int {
    static int fm10k_alloc_q_vectors(struct fm10k_intfc *interface)
    {
    let mut q_vectors: c_uint = interface.num_q_vectors;
    let mut rxr_remaining: c_uint = interface.num_rx_queues;
    let mut txr_remaining: c_uint = interface.num_tx_queues;
    let mut rxr_idx: c_uint = 0, txr_idx = 0, v_idx = 0;
    int err;
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_free_q_vectors(interface: *mut fm10k_intfc) {
    static void fm10k_free_q_vectors(struct fm10k_intfc *interface)
    {
    let mut v_idx: c_int = interface.num_q_vectors;
    fm10k_reset_num_queues(interface);
    while (v_idx--)
    fm10k_free_q_vector(interface, v_idx);
    }
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_reset_msix_capability(interface: *mut fm10k_intfc) {
    static void fm10k_reset_msix_capability(struct fm10k_intfc *interface)
    {
    pci_disable_msix(interface.pdev);
    kfree(interface.msix_entries);
    interface.msix_entries = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_init_msix_capability(interface: *mut fm10k_intfc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_cache_ring_qos(interface: *mut fm10k_intfc) -> bool {
    static bool fm10k_cache_ring_qos(struct fm10k_intfc *interface)
    {
    struct net_device *dev = interface.netdev;
    int pc, offset, rss_i, i;
    let mut pc_stride: u16 = interface.ring_feature[RING_F_QOS].mask + 1;
    let mut num_pcs: u8 = netdev_get_num_tc(dev);
    if (num_pcs <= 1)
    return false;
    rss_i = interface.ring_feature[RING_F_RSS].indices;
    for (pc = 0, offset = 0; pc < num_pcs; pc++, offset += rss_i) {
    let mut q_idx: c_int = pc;
    for (i = 0; i < rss_i; i++) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_cache_ring_rss(interface: *mut fm10k_intfc) {
...
//
#[no_mangle]
unsafe extern "C" fn fm10k_assign_rings(interface: *mut fm10k_intfc) {
...
#[no_mangle]
unsafe extern "C" fn fm10k_init_reta(interface: *mut fm10k_intfc) {
...
// do nothing if all of the elements are in bounds
    ...
    repopulate_reta:
    fm10k_write_reta(interface, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_init_queueing_scheme(interface: *mut fm10k_intfc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fm10k_clear_queueing_scheme(interface: *mut fm10k_intfc) {
