...
//! Source: drivers/net/ethernet/intel/e1000e/ptp.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn e1000e_phc_adjfine(ptp: *mut ptp_clock_info, delta: c_long) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn e1000e_phc_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
//
    ...
    adapter, core::ptr::null_mut(), xtstamp);
    }
...
#[no_mangle]
unsafe extern "C" fn e1000e_systim_overflow_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn e1000e_ptp_init(adapter: *mut e1000_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn e1000e_ptp_remove(adapter: *mut e1000_adapter) {
