...
//! Source: drivers/net/ethernet/intel/e1000e/ethtool.c
#![no_std]
...
// the e1000 autoneg seems to match ethtool nicely
    ...
    let mut status: u32 = er32(STATUS);
    if (status & E1000_STATUS_LU) {
    if (status & E1000_STATUS_SPEED_1000)
    speed = SPEED_1000;
#[no_mangle]
pub unsafe extern "C" fn if(E1000_STATUS_SPEED_100: status &) -> else {
...
#[no_mangle]
unsafe extern "C" fn e1000_set_spd_dplx(adapter: *mut e1000_adapter, spd: u32, dplx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn e1000_set_msglevel(netdev: *mut net_device, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn e1000_get_regs_len(netdev: *mut net_device __always_unused) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000_get_eeprom_len(netdev: *mut net_device) -> c_int {
...
//
    ...
    {
    struct e1000_adapter *adapter = netdev_priv(netdev);
    struct e1000_ring *temp_tx = core::ptr::null_mut(), *temp_rx = core::ptr::null_mut();
    let mut err: c_int = 0, size = sizeof(struct e1000_ring);
    let mut set_tx: bool = false, set_rx = false;
...
#[no_mangle]
unsafe extern "C" fn e1000_reg_test(adapter: *mut e1000_adapter, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000_eeprom_test(adapter: *mut e1000_adapter, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000_test_intr(irq: int __always_unused, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn e1000_intr_test(adapter: *mut e1000_adapter, data: *mut u64) -> c_int {
    static int e1000_intr_test(struct e1000_adapter *adapter, u64 *data)
    {
    struct net_device *netdev = adapter.netdev;
    struct e1000_hw *hw = &adapter.hw;
    u32 mask;
    let mut shared_int: u32 = 1;
    let mut irq: u32 = adapter.pdev.irq;
    int i;
    let mut ret_val: c_int = 0;
    let mut int_mode: c_int = E1000E_INT_MODE_LEGACY;
// data = 0;
...
#[no_mangle]
unsafe extern "C" fn e1000_free_desc_rings(adapter: *mut e1000_adapter) {
...
#[no_mangle]
unsafe extern "C" fn e1000_setup_desc_rings(adapter: *mut e1000_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000_phy_disable_receiver(adapter: *mut e1000_adapter) {
...
#[no_mangle]
unsafe extern "C" fn e1000_integrated_phy_loopback(adapter: *mut e1000_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000_set_82571_fiber_loopback(adapter: *mut e1000_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000_set_es2lan_mac_loopback(adapter: *mut e1000_adapter) -> c_int {
    static int e1000_set_es2lan_mac_loopback(struct e1000_adapter *adapter)
    {
    struct e1000_hw *hw = &adapter.hw;
    let mut ctrlext: u32 = er32(CTRL_EXT);
    let mut ctrl: u32 = er32(CTRL);
...
pub const KMRNCTRLSTA_OPMODE_1GB_FD_GMII: c_uint = 0x0582;
    ew32(KMRNCTRLSTA,
    (KMRNCTRLSTA_OPMODE | KMRNCTRLSTA_OPMODE_1GB_FD_GMII));
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn e1000_setup_loopback_test(adapter: *mut e1000_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000_loopback_cleanup(adapter: *mut e1000_adapter) {
...
#[no_mangle]
unsafe extern "C" fn e1000_run_loopback_test(adapter: *mut e1000_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000_loopback_test(adapter: *mut e1000_adapter, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000_link_test(adapter: *mut e1000_adapter, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000_set_wol(netdev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000_nway_reset(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000e_get_eee(netdev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000e_set_eee(netdev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e1000e_get_priv_flags(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn e1000e_set_priv_flags(netdev: *mut net_device, priv_flags: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn e1000e_set_ethtool_ops(netdev: *mut net_device) {
