...
//! Source: drivers/net/ethernet/intel/ixd/ixd_lib.c
#![no_std]
...
pub const IXD_DFLT_MBX_Q_LEN: c_int = 64;
//
...
//
#[no_mangle]
unsafe extern "C" fn ixd_adapter_fill_dflt_ctlqs(adapter: *mut ixd_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixd_deinit_dflt_mbx(adapter: *mut ixd_adapter) {
    ...
    adapter.arq = core::ptr::null_mut();
    adapter.asq = core::ptr::null_mut();
    adapter.xnm = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ixd_init_dflt_mbx(adapter: *mut ixd_adapter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixd_init_task(work: *mut work_struct) {
