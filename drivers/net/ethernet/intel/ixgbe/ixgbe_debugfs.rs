...
//! Source: drivers/net/ethernet/intel/ixgbe/ixgbe_debugfs.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_dbg_adapter_init(adapter: *mut ixgbe_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_dbg_adapter_exit(adapter: *mut ixgbe_adapter) {
    void ixgbe_dbg_adapter_exit(struct ixgbe_adapter *adapter)
    {
    debugfs_remove_recursive(adapter.ixgbe_dbg_adapter);
    adapter.ixgbe_dbg_adapter = core::ptr::null_mut();
    }
//
// ixgbe_dbg_init - start up debugfs for the driver
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_dbg_init() {
    void ixgbe_dbg_init(void)
    {
    ixgbe_dbg_root = debugfs_create_dir(ixgbe_driver_name, core::ptr::null_mut());
    }
//
// ixgbe_dbg_exit - clean out the driver's debugfs entries
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_dbg_exit() {
