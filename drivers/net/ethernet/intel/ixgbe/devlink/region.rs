...
//! Source: drivers/net/ethernet/intel/ixgbe/devlink/region.c
#![no_std]
...
//
    ...
    let mut read_sz: u32 = min_t(u32, IXGBE_DEVLINK_READ_BLK_SIZE, left);
...
//
    ...
    if (!caps)
    return -ENOMEM;
    err = ixgbe_aci_list_caps(hw, caps, IXGBE_ACI_MAX_BUFFER_SIZE, core::ptr::null_mut(),
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_devlink_init_regions(adapter: *mut ixgbe_adapter) {
    ...
    adapter.nvm_region = core::ptr::null_mut();
    }
    ...
    adapter.sram_region = core::ptr::null_mut();
    }
    ...
    adapter.devcaps_region = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_devlink_destroy_regions(adapter: *mut ixgbe_adapter) {
