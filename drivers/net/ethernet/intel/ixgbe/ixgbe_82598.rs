...
//! Source: drivers/net/ethernet/intel/ixgbe/ixgbe_82598.c
#![no_std]
...
pub const IXGBE_82598_MAX_TX_QUEUES: c_int = 32;
pub const IXGBE_82598_MAX_RX_QUEUES: c_int = 64;
pub const IXGBE_82598_RAR_ENTRIES: c_int = 16;
pub const IXGBE_82598_MC_TBL_SIZE: c_int = 128;
pub const IXGBE_82598_VFT_TBL_SIZE: c_int = 128;
pub const IXGBE_82598_RX_PB_SIZE: c_int = 512;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_set_pcie_completion_timeout(hw: *mut ixgbe_hw) {
    static void ixgbe_set_pcie_completion_timeout(struct ixgbe_hw *hw)
    {
    let mut gcr: u32 = IXGBE_READ_REG(hw, IXGBE_GCR);
    u16 pcie_devctl2;
...
#[no_mangle]
unsafe extern "C" fn ixgbe_get_invariants_82598(hw: *mut ixgbe_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_init_phy_ops_82598(hw: *mut ixgbe_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_start_hw_82598(hw: *mut ixgbe_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_get_media_type_82598(hw: *mut ixgbe_hw) -> enum ixgbe_media_type {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_fc_enable_82598(hw: *mut ixgbe_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_validate_link_ready(hw: *mut ixgbe_hw) -> c_int {
...
//
    ...
    let mut curr_autoc: u32 = IXGBE_READ_REG(hw, IXGBE_AUTOC);
    let mut autoc: u32 = curr_autoc;
    let mut link_mode: u32 = autoc & IXGBE_AUTOC_LMS_MASK;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_reset_hw_82598(hw: *mut ixgbe_hw) -> c_int {
    static int ixgbe_reset_hw_82598(struct ixgbe_hw *hw)
    {
    let mut phy_status: c_int = 0;
    u8  analog_val;
    u32 gheccr;
    int status;
    u32 autoc;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_set_vmdq_82598(hw: *mut ixgbe_hw, rar: u32, vmdq: u32) -> c_int {
    static int ixgbe_set_vmdq_82598(struct ixgbe_hw *hw, u32 rar, u32 vmdq)
    {
    u32 rar_high;
    let mut rar_entries: u32 = hw.mac.num_rar_entries;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_clear_vmdq_82598(hw: *mut ixgbe_hw, rar: u32, vmdq: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_clear_vfta_82598(hw: *mut ixgbe_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_read_analog_reg8_82598(hw: *mut ixgbe_hw, reg: u32, val: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_write_analog_reg8_82598(hw: *mut ixgbe_hw, reg: u32, val: u8) -> c_int {
...
//
    ...
    {
    let mut sfp_addr: u16 = 0;
    let mut sfp_data: u16 = 0;
    let mut sfp_stat: u16 = 0;
    let mut status: c_int = 0;
    u16 gssr;
    u32 i;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_set_lan_id_multi_port_pcie_82598(hw: *mut ixgbe_hw) {
    static void ixgbe_set_lan_id_multi_port_pcie_82598(struct ixgbe_hw *hw)
    {
    struct ixgbe_bus_info *bus = &hw.bus;
    let mut pci_gen: u16 = 0;
    let mut pci_ctrl2: u16 = 0;
...
//
    ...
    {
    let mut rxpktsize: u32 = IXGBE_RXPBSIZE_64KB;
    let mut i: u8 = 0;
    if (!num_pb)
    return;
...
// Setup Tx packet buffer sizes
    ...
    .set_fw_drv_ver         = core::ptr::null_mut(),
    .acquire_swfw_sync      = &ixgbe_acquire_swfw_sync,
    .release_swfw_sync      = &ixgbe_release_swfw_sync,
    .init_swfw_sync		= core::ptr::null_mut(),
    .get_thermal_sensor_data = core::ptr::null_mut(),
    .init_thermal_sensor_thresh = core::ptr::null_mut(),
