...
//! Source: drivers/net/ethernet/intel/ixgbe/ixgbe_82599.c
#![no_std]
...
pub const IXGBE_82599_MAX_TX_QUEUES: c_int = 128;
pub const IXGBE_82599_MAX_RX_QUEUES: c_int = 128;
pub const IXGBE_82599_RAR_ENTRIES: c_int = 128;
pub const IXGBE_82599_MC_TBL_SIZE: c_int = 128;
pub const IXGBE_82599_VFT_TBL_SIZE: c_int = 128;
pub const IXGBE_82599_RX_PB_SIZE: c_int = 512;
...
#[no_mangle]
pub unsafe extern "C" fn ixgbe_mng_enabled(hw: *mut ixgbe_hw) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_init_mac_link_ops_82599(hw: *mut ixgbe_hw) {
...
//
    ...
    mac.ops.disable_tx_laser = core::ptr::null_mut();
    mac.ops.enable_tx_laser = core::ptr::null_mut();
    mac.ops.flap_tx_laser = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn ixgbe_setup_sfp_modules_82599(hw: *mut ixgbe_hw) -> c_int {
    ...
    hw.phy.ops.reset = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn prot_autoc_write_82599(hw: *mut ixgbe_hw, autoc: u32, locked: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_get_invariants_82599(hw: *mut ixgbe_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_init_phy_ops_82599(hw: *mut ixgbe_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_get_media_type_82599(hw: *mut ixgbe_hw) -> enum ixgbe_media_type {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_stop_mac_link_on_d3_82599(hw: *mut ixgbe_hw) {
    static void ixgbe_stop_mac_link_on_d3_82599(struct ixgbe_hw *hw)
    {
    u32 autoc2_reg;
    let mut ee_ctrl_2: u16 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_disable_tx_laser_multispeed_fiber(hw: *mut ixgbe_hw) {
    static void ixgbe_disable_tx_laser_multispeed_fiber(struct ixgbe_hw *hw)
    {
    let mut esdp_reg: u32 = IXGBE_READ_REG(hw, IXGBE_ESDP);
// Blocked by MNG FW so bail
    if (ixgbe_check_reset_blocked(hw))
    return;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_enable_tx_laser_multispeed_fiber(hw: *mut ixgbe_hw) {
    static void ixgbe_enable_tx_laser_multispeed_fiber(struct ixgbe_hw *hw)
    {
    let mut esdp_reg: u32 = IXGBE_READ_REG(hw, IXGBE_ESDP);
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_flap_tx_laser_multispeed_fiber(hw: *mut ixgbe_hw) {
    static void ixgbe_flap_tx_laser_multispeed_fiber(struct ixgbe_hw *hw)
    {
// Blocked by MNG FW so bail
    if (ixgbe_check_reset_blocked(hw))
...
//
    ...
    bool autoneg_wait_to_complete)
    {
    let mut link_speed: ixgbe_link_speed = IXGBE_LINK_SPEED_UNKNOWN;
    let mut autoc_reg: u32 = IXGBE_READ_REG(hw, IXGBE_AUTOC);
...
//
    ...
    bool autoneg_wait_to_complete)
    {
    let mut link_capabilities: ixgbe_link_speed = IXGBE_LINK_SPEED_UNKNOWN;
    u32 pma_pmd_10g_serial, pma_pmd_1g, link_mode, links_reg, i;
    let mut autoc2: u32 = IXGBE_READ_REG(hw, IXGBE_AUTOC2);
    let mut autoneg: bool = false;
    int status;
// holds the value of AUTOC register at this current point in time
    let mut current_autoc: u32 = IXGBE_READ_REG(hw, IXGBE_AUTOC);
// holds the cached value of AUTOC register
    let mut orig_autoc: u32 = 0;
// temporary variable used for comparison purposes
    let mut autoc: u32 = current_autoc;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_reset_hw_82599(hw: *mut ixgbe_hw) -> c_int {
...
// Setup SFP module if there is one present.
    ...
    return status;
// Reset PHY
    if (hw.phy.reset_disable == false && hw.phy.ops.reset != core::ptr::null_mut())
    hw.phy.ops.reset(hw);
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_fdir_check_cmd_complete(hw: *mut ixgbe_hw, fdircmd: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_reinit_fdir_tables_82599(hw: *mut ixgbe_hw) -> c_int {
    int ixgbe_reinit_fdir_tables_82599(struct ixgbe_hw *hw)
    {
    let mut fdirctrl: u32 = IXGBE_READ_REG(hw, IXGBE_FDIRCTRL);
    u32 fdircmd;
    int err;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_fdir_enable_82599(hw: *mut ixgbe_hw, fdirctrl: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_init_fdir_signature_82599(hw: *mut ixgbe_hw, fdirctrl: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_init_fdir_perfect_82599(hw: *mut ixgbe_hw, fdirctrl: u32) -> c_int {
...
//
    ...
    let mut sig_hash: u32 = 0, bucket_hash = 0, common_hash = 0;
...
//
    ...
    {
    u32 hi_hash_dword, lo_hash_dword, flow_vm_vlan;
    let mut bucket_hash: u32 = 0;
    let mut hi_dword: __be32 = 0;
    int i;
...
//
    input.formatted.bkt_hash = ( __be16)(bucket_hash & 0x1FFF);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_get_fdirtcpm_82599(input_mask: *mut union ixgbe_atr_input) -> u32 {
    static u32 ixgbe_get_fdirtcpm_82599(union ixgbe_atr_input *input_mask)
    {
    let mut mask: u32 = ntohs(input_mask.formatted.dst_port);
...
// mask IPv6 since it is currently not supported
    let mut fdirm: u32 = IXGBE_FDIRM_DIPv6;
    u32 fdirtcpm;
//
...
// no VLAN fields masked
    ...
    switch (( u16)input_mask.formatted.flex_bytes & 0xFFFF) {
    case 0x0000:
// Mask Flex Bytes
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_read_analog_reg8_82599(hw: *mut ixgbe_hw, reg: u32, val: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_write_analog_reg8_82599(hw: *mut ixgbe_hw, reg: u32, val: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_start_hw_82599(hw: *mut ixgbe_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_identify_phy_82599(hw: *mut ixgbe_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_enable_rx_dma_82599(hw: *mut ixgbe_hw, regval: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_verify_fw_version_82599(hw: *mut ixgbe_hw) -> c_int {
    static int ixgbe_verify_fw_version_82599(struct ixgbe_hw *hw)
    {
    u16 fw_offset, fw_ptp_cfg_offset;
    let mut status: c_int = -EACCES;
    let mut fw_version: u16 = 0;
    u16 offset;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_verify_lesm_fw_enabled_82599(hw: *mut ixgbe_hw) -> bool {
    static bool ixgbe_verify_lesm_fw_enabled_82599(struct ixgbe_hw *hw)
    {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_reset_pipeline_82599(hw: *mut ixgbe_hw) -> c_int {
    static int ixgbe_reset_pipeline_82599(struct ixgbe_hw *hw)
    {
    u32 i, autoc_reg, autoc2_reg;
    let mut anlp1_reg: u32 = 0;
    int ret_val;
// Enable link if disabled in NVM
    autoc2_reg = IXGBE_READ_REG(hw, IXGBE_AUTOC2);
...
// Release I2C bus ownership.
    ...
    .init_swfw_sync		= core::ptr::null_mut(),
