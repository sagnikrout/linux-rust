...
//! Source: drivers/net/ethernet/intel/ixgbe/ixgbe_ptp.c
#![no_std]
...
//
pub const IXGBE_INCVAL_10GB: c_uint = 0x66666666;
pub const IXGBE_INCVAL_1GB: c_uint = 0x40000000;
pub const IXGBE_INCVAL_100: c_uint = 0x50000000;
pub const IXGBE_INCVAL_SHIFT_10GB: c_int = 28;
pub const IXGBE_INCVAL_SHIFT_1GB: c_int = 24;
pub const IXGBE_INCVAL_SHIFT_100: c_int = 21;
pub const IXGBE_INCVAL_SHIFT_82599: c_int = 7;
pub const IXGBE_INCPER_SHIFT_82599: c_int = 24;
...
//
pub const IXGBE_X550_BASE_PERIOD: c_uint = 0xC80000000ULL;
pub const IXGBE_E610_BASE_PERIOD: c_uint = 0x333333333ULL;
pub const INCVALUE_MASK: c_uint = 0x7FFFFFFF;
pub const ISGN: c_uint = 0x80000000;
//
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_ptp_setup_sdp_X540(adapter: *mut ixgbe_adapter) {
    static void ixgbe_ptp_setup_sdp_X540(struct ixgbe_adapter *adapter)
    {
    struct cyclecounter *cc = &adapter.hw_cc;
    struct ixgbe_hw *hw = &adapter.hw;
    u32 esdp, tsauxc, clktiml, clktimh, trgttiml, trgttimh, rem;
    let mut ns: u64 = 0, clock_edge = 0, clock_period;
    unsigned long flags;
...
//
pub const IXGBE_TSAUXC_DIS_TS_CLEAR: c_uint = 0x40000000;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_ptp_read_X550(cc: *mut cyclecounter) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_ptp_read_82599(cc: *mut cyclecounter) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_ptp_adjfine_82599(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_ptp_adjfine_X550(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_ptp_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_ptp_check_pps_event(adapter: *mut ixgbe_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_ptp_overflow_check(adapter: *mut ixgbe_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_ptp_rx_hang(adapter: *mut ixgbe_adapter) {
    void ixgbe_ptp_rx_hang(struct ixgbe_adapter *adapter)
    {
    struct ixgbe_hw *hw = &adapter.hw;
    let mut tsyncrxctl: u32 = IXGBE_READ_REG(hw, IXGBE_TSYNCRXCTL);
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_ptp_clear_tx_timestamp(adapter: *mut ixgbe_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_ptp_tx_hang(adapter: *mut ixgbe_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_ptp_tx_hwtstamp(adapter: *mut ixgbe_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_ptp_tx_hwtstamp_work(work: *mut work_struct) {
...
//
    ...
    {
    struct ixgbe_hw *hw = &adapter.hw;
    let mut tsync_tx_ctl: u32 = IXGBE_TSYNCTXCTL_ENABLED;
    let mut tsync_rx_ctl: u32 = IXGBE_TSYNCRXCTL_ENABLED;
    let mut tsync_rx_mtrl: u32 = PTP_EV_PORT << 16;
    let mut aflags: u32 = adapter.flags;
    let mut is_l2: bool = false;
    u32 regval;
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_ptp_start_cyclecounter(adapter: *mut ixgbe_adapter) {
    void ixgbe_ptp_start_cyclecounter(struct ixgbe_adapter *adapter)
    {
    struct ixgbe_hw *hw = &adapter.hw;
    struct cyclecounter cc;
    unsigned long flags;
    let mut incval: u32 = 0;
    let mut fuse0: u32 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_ptp_init_systime(adapter: *mut ixgbe_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_ptp_reset(adapter: *mut ixgbe_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_ptp_create_clock(adapter: *mut ixgbe_adapter) -> c_long {
...
// do nothing if we already have a clock device
    ...
    break;
    default:
    adapter.ptp_clock = core::ptr::null_mut();
    adapter.ptp_setup_sdp = core::ptr::null_mut();
    return -EOPNOTSUPP;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_ptp_init(adapter: *mut ixgbe_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_ptp_suspend(adapter: *mut ixgbe_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ixgbe_ptp_stop(adapter: *mut ixgbe_adapter) {
