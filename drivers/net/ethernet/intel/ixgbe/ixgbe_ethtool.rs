...
//! Source: drivers/net/ethernet/intel/ixgbe/ixgbe_ethtool.c
#![no_std]
...
// If the thing changed then we'll update and use new autoneg.
    ...
    struct ixgbe_adapter *adapter = ixgbe_from_netdev(netdev);
    struct ixgbe_hw *hw = &adapter.hw;
    let mut fc: ixgbe_fc_info = hw.fc;
...
pub unsafe extern "C" fn if(pause->tx_pause: !pause->rx_pause &&) -> else {
    ...
    fc.requested_mode = ixgbe_fc_full;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pause->rx_pause) -> else {
    else if (pause.rx_pause)
    fc.requested_mode = ixgbe_fc_rx_pause;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pause->tx_pause) -> else {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_set_msglevel(netdev: *mut net_device, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_get_regs_len(netdev: *mut net_device) -> c_int {
    static int ixgbe_get_regs_len(struct net_device *netdev)
    {
pub const IXGBE_REGS_LEN: c_int = 1145;
...
#[no_mangle]
unsafe extern "C" fn ixgbe_get_eeprom_len(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ixgbe_refresh_fw_version(adapter: *mut ixgbe_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_get_max_rxd(adapter: *mut ixgbe_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_get_max_txd(adapter: *mut ixgbe_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_link_test(adapter: *mut ixgbe_adapter, data: *mut u64) -> c_int {
    static int ixgbe_link_test(struct ixgbe_adapter *adapter, u64 *data)
    {
    struct ixgbe_hw *hw = &adapter.hw;
    bool link_up;
    let mut link_speed: u32 = 0;
...
pub const WRITE_NO_TEST: c_int = 3;
pub const TABLE32_TEST: c_int = 4;
pub const TABLE64_TEST_LO: c_int = 5;
pub const TABLE64_TEST_HI: c_int = 6;
...
#[no_mangle]
unsafe extern "C" fn ixgbe_reg_test(adapter: *mut ixgbe_adapter, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_eeprom_test(adapter: *mut ixgbe_adapter, data: *mut u64) -> c_int {
    static int ixgbe_eeprom_test(struct ixgbe_adapter *adapter, u64 *data)
    {
    struct ixgbe_hw *hw = &adapter.hw;
    if (hw.eeprom.ops.validate_checksum(hw, core::ptr::null_mut()))
// data = 1;
    else
// data = 0;
    return *data;
...
#[no_mangle]
unsafe extern "C" fn ixgbe_test_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_intr_test(adapter: *mut ixgbe_adapter, data: *mut u64) -> c_int {
    static int ixgbe_intr_test(struct ixgbe_adapter *adapter, u64 *data)
    {
    struct net_device *netdev = adapter.netdev;
    u32 mask, i = 0, shared_int = true;
    let mut irq: u32 = adapter.pdev.irq;
// data = 0;
...
#[no_mangle]
unsafe extern "C" fn ixgbe_free_desc_rings(adapter: *mut ixgbe_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_setup_desc_rings(adapter: *mut ixgbe_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_setup_loopback_test(adapter: *mut ixgbe_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_loopback_cleanup(adapter: *mut ixgbe_adapter) {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_run_loopback_test(adapter: *mut ixgbe_adapter) -> c_int {
    static int ixgbe_run_loopback_test(struct ixgbe_adapter *adapter)
    {
    struct ixgbe_ring *tx_ring = &adapter.test_tx_ring;
    struct ixgbe_ring *rx_ring = &adapter.test_rx_ring;
    int i, j, lc, good_cnt, ret_val = 0;
    let mut size: c_uint = 1024;
    netdev_tx_t tx_ret_val;
    struct sk_buff *skb;
    let mut flags_orig: u32 = adapter.flags;
...
#[no_mangle]
unsafe extern "C" fn ixgbe_loopback_test(adapter: *mut ixgbe_adapter, data: *mut u64) -> c_int {
...
// clear testing bit and return adapter to previous state
    ...
    ixgbe_open(netdev);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: hw->mac.ops.disable_tx_laser) -> else {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_set_wol(netdev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_nway_reset(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ixgbe_update_rsc(adapter: *mut ixgbe_adapter) -> bool {
...
//
    ...
    struct ixgbe_fdir_filter *rule = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ixgbe_rss_indir_tbl_max(adapter: *mut ixgbe_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_get_rx_ring_count(dev: *mut net_device) -> u32 {
...
// program filters to filter memory
    ...
    int err;
    spin_lock(&adapter.fdir_perfect_lock);
    err = ixgbe_update_ethtool_fdir_entry(adapter, core::ptr::null_mut(), fsp.location);
    spin_unlock(&adapter.fdir_perfect_lock);
    return err;
    }
    ...
    {
    struct ixgbe_adapter *adapter = ixgbe_from_netdev(dev);
    let mut flags2: u32 = adapter.flags2;
//
...
// if we changed something we need to update flags
    ...
    struct ixgbe_hw *hw = &adapter.hw;
    u32 mrqc;
    let mut pf_pool: c_uint = adapter.num_vfs;
...
#[no_mangle]
unsafe extern "C" fn ixgbe_set_rxnfc(dev: *mut net_device, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
    static u32 ixgbe_get_rxfh_key_size(struct net_device *netdev)
    {
    return IXGBE_RSS_KEY_SIZE;
    }
#[no_mangle]
unsafe extern "C" fn ixgbe_rss_indir_size(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_get_reta(adapter: *mut ixgbe_adapter, indir: *mut u32) {
    static void ixgbe_get_reta(struct ixgbe_adapter *adapter, u32 *indir)
    {
    int i, reta_size = ixgbe_rss_indir_tbl_entries(adapter);
    let mut rss_m: u16 = adapter.ring_feature[RING_F_RSS].mask;
    if (adapter.flags & IXGBE_FLAG_SRIOV_ENABLED)
    ...
    struct ixgbe_adapter *adapter = ixgbe_from_netdev(netdev);
    int i;
    let mut reta_entries: u32 = ixgbe_rss_indir_tbl_entries(adapter);
...
#[no_mangle]
unsafe extern "C" fn ixgbe_max_channels(adapter: *mut ixgbe_adapter) -> c_uint {
    static unsigned int ixgbe_max_channels(struct ixgbe_adapter *adapter)
    {
    unsigned int max_combined;
    let mut tcs: u8 = adapter.hw_tcs;
...
// report flow director queues as maximum channels
    ...
    let mut max_rss_indices: u8 = ixgbe_max_rss_indices(adapter);
...
// We have a SFP which supports a revision of SFF-8472.
    ...
    struct ixgbe_adapter *adapter = ixgbe_from_netdev(dev);
    struct ixgbe_hw *hw = &adapter.hw;
    let mut status: c_int = -EFAULT;
    let mut databyte: u8 = 0xFF;
    let mut i: c_int = 0;
    if (ee.len == 0)
    return -EINVAL;
    if (hw.phy.type == ixgbe_phy_fw)
...
// I2C reads can take long time
    ...
    {
    struct ixgbe_adapter *adapter = ixgbe_from_netdev(netdev);
    let mut keee_stored: ethtool_keee = {};
    int err;
...
#[no_mangle]
unsafe extern "C" fn ixgbe_get_eee(netdev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_set_eee(netdev: *mut net_device, edata: *mut ethtool_keee) -> c_int {
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ret_val) -> else {
    else if (ret_val)
    return ret_val;
...
#[no_mangle]
unsafe extern "C" fn ixgbe_get_priv_flags(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ixgbe_set_priv_flags(netdev: *mut net_device, priv_flags: u32) -> c_int {
    static int ixgbe_set_priv_flags(struct net_device *netdev, u32 priv_flags)
    {
    struct ixgbe_adapter *adapter = ixgbe_from_netdev(netdev);
    let mut flags2: c_uint = adapter.flags2;
    unsigned int i;
...
#[no_mangle]
pub unsafe extern "C" fn ixgbe_set_ethtool_ops(netdev: *mut net_device) {
