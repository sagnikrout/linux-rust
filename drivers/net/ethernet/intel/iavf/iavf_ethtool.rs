...
//! Source: drivers/net/ethernet/intel/iavf/iavf_ethtool.c
#![no_std]
...
//
    ...
    {
    let mut size: c_uint = ARRAY_SIZE(iavf_gstrings_queue_stats);
...
//
#[no_mangle]
unsafe extern "C" fn iavf_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
//
    ...
    struct iavf_ring *tx_ring = core::ptr::null_mut(), *rx_ring = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn iavf_get_stat_strings(netdev: *mut net_device, data: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_get_strings(netdev: *mut net_device, sset: u32, data: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_get_msglevel(netdev: *mut net_device) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_set_msglevel(netdev: *mut net_device, data: u32) {
...
//
    ...
    queue = 0;
#[no_mangle]
pub unsafe extern "C" fn if(adapter->num_active_queues: queue >=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_fltr_to_ethtool_flow(flow: enum iavf_fdir_flow_type) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_ethtool_flow_to_fltr(eth: c_int) -> enum iavf_fdir_flow_type {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_is_mask_valid(mask: u64, field: u64) -> bool {
...
pub const IAVF_USERDEF_FLEX_OFFS_S: c_int = 16;

    let mut value: u32 = be32_to_cpu(fsp.h_ext.data[i]);
    let mut mask: u32 = be32_to_cpu(fsp.m_ext.data[i]);
    if (!value || !mask)
    continue;
...
//
pub const IAVF_USERDEF_FLEX_MAX_OFFS_VAL: c_int = 504;
...
//
    ...
    struct iavf_fdir_fltr *rule = core::ptr::null_mut();
    let mut ret: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn iavf_add_fdir_ethtool(adapter: *mut iavf_adapter, cmd: *mut ethtool_rxnfc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_del_fdir_ethtool(adapter: *mut iavf_adapter, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iavf_adv_rss_parse_hdrs(cmd: *const ethtool_rxfh_fields) -> u32 {
    static u32 iavf_adv_rss_parse_hdrs(const struct ethtool_rxfh_fields *cmd)
    {
    let mut hdrs: u32 = IAVF_ADV_RSS_FLOW_SEG_HDR_NONE;
    ...
    {
    let mut hfld: u64 = IAVF_ADV_RSS_HASH_INVALID;
    ...
    let mut rss_new_add: bool = false;
    let mut symm: bool = false;
    u64 hash_flds;
    let mut err: c_int = 0;
    u32 hdrs;
    netdev_assert_locked(adapter.netdev);
...
//
#[no_mangle]
unsafe extern "C" fn iavf_set_rxnfc(netdev: *mut net_device, cmd: *mut ethtool_rxnfc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_get_rx_ring_count(netdev: *mut net_device) -> u32 {
...
//
    ...
    {
    struct iavf_adapter *adapter = netdev_priv(netdev);
    let mut num_req: u32 = ch.combined_count;
...
//
#[no_mangle]
unsafe extern "C" fn iavf_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_get_rxfh_indir_size(netdev: *mut net_device) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_set_ethtool_ops(netdev: *mut net_device) {
