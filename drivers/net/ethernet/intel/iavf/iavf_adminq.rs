...
//! Source: drivers/net/ethernet/intel/iavf/iavf_adminq.h
#![no_std]
...
pub const IAVF_ADMINQ_DESC_ALIGNMENT: c_int = 4096;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iavf_adminq_ring {
    pub /: *mut *mut iavf_virt_mem dma_head; / space for dma structures,
    pub /: *mut *mut iavf_dma_mem desc_buf; / descriptor ring memory,
    pub /: *mut *mut iavf_virt_mem cmd_buf; / command buffer memory,
    pub asq_bi: *mut iavf_dma_mem,
    pub arq_bi: *mut iavf_dma_mem,
    pub r: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iavf_asq_cmd_details {
    pub /: *mut *mut *mut void callback; / cast from type IAVF_ADMINQ_CALLBACK,
    pub cookie: u64,
    pub flags_ena: u16,
    pub flags_dis: u16,
    pub async: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iavf_arq_event_info {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iavf_adminq_info {
    pub /: *mut *mut iavf_adminq_ring arq; / receive queue,
    pub /: *mut *mut iavf_adminq_ring asq; / send queue,
...
// general information
pub const IAVF_AQ_LARGE_BUF: c_int = 512;

extern "C" {
    pub fn iavf_fill_default_direct_cmd_desc(desc: *mut libie_aq_desc, opcode: u16);
}
