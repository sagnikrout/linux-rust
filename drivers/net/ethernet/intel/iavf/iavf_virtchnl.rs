...
//! Source: drivers/net/ethernet/intel/iavf/iavf_virtchnl.c
#![no_std]
...
//
    ...
    status = iavf_aq_send_msg_to_pf(hw, op, 0, msg, len, core::ptr::null_mut());
    if (status)
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_send_api_ver(adapter: *mut iavf_adapter) -> c_int {
...
//
    status = iavf_clean_arq_element(hw, event, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_verify_api_ver(adapter: *mut iavf_adapter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_send_vf_config_msg(adapter: *mut iavf_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iavf_send_vf_offload_vlan_v2_msg(adapter: *mut iavf_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iavf_send_vf_supported_rxdids_msg(adapter: *mut iavf_adapter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_send_vf_ptp_caps_msg(adapter: *mut iavf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_validate_num_queues(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_get_vf_config(adapter: *mut iavf_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iavf_get_vf_vlan_v2_caps(adapter: *mut iavf_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iavf_get_vf_supported_rxdids(adapter: *mut iavf_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iavf_get_vf_ptp_caps(adapter: *mut iavf_adapter) -> c_int {
    int iavf_get_vf_ptp_caps(struct iavf_adapter *adapter)
    {
    let mut caps: virtchnl_ptp_caps = {};
    struct iavf_arq_event_info event;
    int err;
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_configure_queues(adapter: *mut iavf_adapter) {
    void iavf_configure_queues(struct iavf_adapter *adapter)
    {
    struct virtchnl_vsi_queue_config_info *vqci;
    let mut pairs: c_int = adapter.num_active_queues;
    struct virtchnl_queue_pair_info *vqpi;
    u32 i, max_frame;
    let mut rx_flags: u8 = 0;
    size_t len;
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_enable_queues(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_disable_queues(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_map_queues(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_add_ether_addrs(adapter: *mut iavf_adapter) {
    void iavf_add_ether_addrs(struct iavf_adapter *adapter)
    {
    struct virtchnl_ether_addr_list *veal;
    struct iavf_mac_filter *f;
    let mut i: c_int = 0, count = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_del_ether_addrs(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_mac_add_ok(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_mac_add_reject(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_vlan_add_reject(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_add_vlans(adapter: *mut iavf_adapter) {
...
// bail because we already have a command pending
    ...
    let mut max_vlans: u16 = adapter.vlan_v2_caps.filtering.max_filters;
    let mut current_vlans: u16 = iavf_get_num_vlans_added(adapter);
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_del_vlans(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_set_promiscuous(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_request_stats(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_get_rss_hashcfg(adapter: *mut iavf_adapter) {
...
// bail because we already have a command pending
    ...
    iavf_send_pf_msg(adapter, VIRTCHNL_OP_GET_RSS_HASHCFG_CAPS, core::ptr::null_mut(), 0);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_set_rss_hashcfg(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_set_rss_key(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_set_rss_lut(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_set_rss_hfunc(adapter: *mut iavf_adapter) {
    void iavf_set_rss_hfunc(struct iavf_adapter *adapter)
    {
    struct virtchnl_rss_hfunc *vrh;
    let mut len: c_int = sizeof(*vrh);
    if (adapter.current_op != VIRTCHNL_OP_UNKNOWN) {
// bail because we already have a command pending
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_enable_vlan_stripping(adapter: *mut iavf_adapter) {
...
// bail because we already have a command pending
    ...
    iavf_send_pf_msg(adapter, VIRTCHNL_OP_ENABLE_VLAN_STRIPPING, core::ptr::null_mut(), 0);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_disable_vlan_stripping(adapter: *mut iavf_adapter) {
...
// bail because we already have a command pending
    ...
    iavf_send_pf_msg(adapter, VIRTCHNL_OP_DISABLE_VLAN_STRIPPING, core::ptr::null_mut(), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn iavf_tpid_to_vc_ethertype(tpid: u16) -> u32 {
...
//
    ...
    let mut vc_ethertype: u16 = iavf_tpid_to_vc_ethertype(tpid);
...
#[no_mangle]
pub unsafe extern "C" fn if(ETH_P_8021AD: tpid ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_enable_vlan_stripping_v2(adapter: *mut iavf_adapter, tpid: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_disable_vlan_stripping_v2(adapter: *mut iavf_adapter, tpid: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_enable_vlan_insertion_v2(adapter: *mut iavf_adapter, tpid: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_disable_vlan_insertion_v2(adapter: *mut iavf_adapter, tpid: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_virtchnl_send_ptp_cmd(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_print_link_message(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_get_qos_caps(adapter: *mut iavf_adapter) {
...
// bail because we already have a command pending
    ...
    iavf_send_pf_msg(adapter, VIRTCHNL_OP_GET_QOS_CAPS, core::ptr::null_mut(), 0);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_cfg_queues_quanta_size(adapter: *mut iavf_adapter) {
    void iavf_cfg_queues_quanta_size(struct iavf_adapter *adapter)
    {
    let mut quanta_size: c_int = IAVF_DEFAULT_QUANTA_SIZE;
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_cfg_queues_bw(adapter: *mut iavf_adapter) {
    void iavf_cfg_queues_bw(struct iavf_adapter *adapter)
    {
    struct virtchnl_queues_bw_cfg *qs_bw_cfg;
    struct net_shaper *q_shaper;
    let mut qs_to_update: c_int = 0;
    int i, inx = 0;
    size_t len;
    if (adapter.current_op != VIRTCHNL_OP_UNKNOWN) {
// bail because we already have a command pending
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_enable_channels(adapter: *mut iavf_adapter) {
    void iavf_enable_channels(struct iavf_adapter *adapter)
    {
    struct virtchnl_tc_info *vti = core::ptr::null_mut();
    size_t len;
    int i;
    if (adapter.current_op != VIRTCHNL_OP_UNKNOWN) {
// bail because we already have a command pending
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_disable_channels(adapter: *mut iavf_adapter) {
...
// bail because we already have a command pending
    ...
    iavf_send_pf_msg(adapter, VIRTCHNL_OP_DISABLE_CHANNELS, core::ptr::null_mut(), 0);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_add_cloud_filter(adapter: *mut iavf_adapter) {
    void iavf_add_cloud_filter(struct iavf_adapter *adapter)
    {
    struct iavf_cloud_filter *cf;
    struct virtchnl_filter *f;
    let mut len: c_int = 0, count = 0;
    if (adapter.current_op != VIRTCHNL_OP_UNKNOWN) {
// bail because we already have a command pending
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_del_cloud_filter(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_add_fdir_filter(adapter: *mut iavf_adapter) {
    void iavf_add_fdir_filter(struct iavf_adapter *adapter)
    {
    struct iavf_fdir_fltr *fdir;
    struct virtchnl_fdir_add *f;
    let mut process_fltr: bool = false;
    int len;
    if (adapter.current_op != VIRTCHNL_OP_UNKNOWN) {
// bail because we already have a command pending
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_del_fdir_filter(adapter: *mut iavf_adapter) {
    void iavf_del_fdir_filter(struct iavf_adapter *adapter)
    {
    let mut f: virtchnl_fdir_del = {};
    struct iavf_fdir_fltr *fdir;
    let mut process_fltr: bool = false;
    int len;
    if (adapter.current_op != VIRTCHNL_OP_UNKNOWN) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_add_adv_rss_cfg(adapter: *mut iavf_adapter) {
    void iavf_add_adv_rss_cfg(struct iavf_adapter *adapter)
    {
    struct virtchnl_rss_cfg *rss_cfg;
    struct iavf_adv_rss *rss;
    let mut process_rss: bool = false;
    int len;
    if (adapter.current_op != VIRTCHNL_OP_UNKNOWN) {
// bail because we already have a command pending
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_del_adv_rss_cfg(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_request_reset(adapter: *mut iavf_adapter) -> c_int {
    int iavf_request_reset(struct iavf_adapter *adapter)
    {
    int err;
// Don't check CURRENT_OP - this is always higher priority
    err = iavf_send_pf_msg(adapter, VIRTCHNL_OP_RESET_VF, core::ptr::null_mut(), 0);
    adapter.current_op = VIRTCHNL_OP_UNKNOWN;
    return err;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn iavf_activate_fdir_filters(adapter: *mut iavf_adapter) {
    static void iavf_activate_fdir_filters(struct iavf_adapter *adapter)
    {
    struct iavf_fdir_fltr *f, *ftmp;
    let mut add_filters: bool = false;
    spin_lock_bh(&adapter.fdir_fltr_lock);
...
//
    ...
    let mut link_up: bool = iavf_get_vpe_link_status(adapter, vpe);
    switch (vpe.event) {
...
//
    ...
    let mut len: u16 = IAVF_VIRTCHNL_VF_RESOURCE_SIZE;
