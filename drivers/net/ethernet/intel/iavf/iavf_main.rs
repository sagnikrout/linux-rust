...
//! Source: drivers/net/ethernet/intel/iavf/iavf_main.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn iavf_status_to_errno(status: enum iavf_status) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn virtchnl_status_to_errno(v_status: enum virtchnl_status_code) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_is_reset_in_progress(adapter: *mut iavf_adapter) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_free_dma_mem(hw: *mut iavf_hw, mem: *mut iavf_dma_mem) -> enum iavf_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_free_virt_mem(hw: *mut iavf_hw, mem: *mut iavf_virt_mem) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_schedule_reset(adapter: *mut iavf_adapter, flags: u64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_schedule_aq_request(adapter: *mut iavf_adapter, flags: u64) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_misc_irq_disable(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_misc_irq_enable(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_irq_disable(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_irq_enable_queues(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_irq_enable(adapter: *mut iavf_adapter, flush: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_msix_aq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_msix_clean_rings(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_map_rings_to_vectors(adapter: *mut iavf_adapter) {
    static void iavf_map_rings_to_vectors(struct iavf_adapter *adapter)
    {
    let mut rings_remaining: c_int = adapter.num_active_queues;
    let mut ridx: c_int = 0, vidx = 0;
    int q_vectors;
...
//
    ...
    let mut rx_int_idx: c_uint = 0, tx_int_idx = 0;
    int irq_num, err;
...
//
#[no_mangle]
unsafe extern "C" fn iavf_request_misc_irq(adapter: *mut iavf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_free_traffic_irqs(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_free_misc_irq(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_configure_tx(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_select_rx_desc_format(adapter: *const iavf_adapter) -> u8 {
    static u8 iavf_select_rx_desc_format(const struct iavf_adapter *adapter)
    {
    let mut rxdids: u64 = adapter.supp_rxdids;
...
//
#[no_mangle]
unsafe extern "C" fn iavf_configure_rx(adapter: *mut iavf_adapter) {
...
//
    ...
    struct iavf_vlan vlan)
    {
    struct iavf_vlan_filter *f = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn iavf_del_vlan(adapter: *mut iavf_adapter, vlan: iavf_vlan) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_get_num_vlans_added(adapter: *mut iavf_adapter) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_get_max_vlans_allowed(adapter: *mut iavf_adapter) -> u16 {
...
//
    ...
    return VLAN_N_VID;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: VLAN_V2_ALLOWED(adapter)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_max_vlans_added(adapter: *mut iavf_adapter) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_set_mac(netdev: *mut net_device, p: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_addr_sync(netdev: *mut net_device, addr: *const u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_addr_unsync(netdev: *mut net_device, addr: *const u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_promiscuous_mode_changed(adapter: *mut iavf_adapter) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_napi_enable_all(adapter: *mut iavf_adapter) {
    static void iavf_napi_enable_all(struct iavf_adapter *adapter)
    {
    int q_idx;
    struct iavf_q_vector *q_vector;
    let mut q_vectors: c_int = adapter.num_msix_vectors - NONQ_VECS;
...
//
#[no_mangle]
unsafe extern "C" fn iavf_napi_disable_all(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_configure(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_up_complete(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_clear_mac_filters(adapter: *mut iavf_adapter) {
...
// clear the sync flag on all filters
    ...
    __dev_mc_unsync(adapter.netdev, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn iavf_clear_cloud_filters(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_clear_fdir_filters(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_clear_adv_rss_conf(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_down(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_free_queues(adapter: *mut iavf_adapter) {
    ...
    adapter.tx_rings = core::ptr::null_mut();
    kfree(adapter.rx_rings);
    adapter.rx_rings = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_set_queue_vlan_tag_loc(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_alloc_queues(adapter: *mut iavf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_set_interrupt_capability(adapter: *mut iavf_adapter) -> c_int {
    static int iavf_set_interrupt_capability(struct iavf_adapter *adapter)
    {
    int vector, v_budget;
    let mut pairs: c_int = 0;
    let mut err: c_int = 0;
    if (!adapter.vsi_res) {
    err = -EIO;
    goto out;
...
//
#[no_mangle]
unsafe extern "C" fn iavf_config_rss_aq(adapter: *mut iavf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_config_rss_reg(adapter: *mut iavf_adapter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_config_rss(adapter: *mut iavf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_fill_rss_lut(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_init_rss(adapter: *mut iavf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_alloc_q_vectors(adapter: *mut iavf_adapter) -> c_int {
    static int iavf_alloc_q_vectors(struct iavf_adapter *adapter)
    {
    let mut q_idx: c_int = 0, num_q_vectors, irq_num;
    struct iavf_q_vector *q_vector;
...
//
#[no_mangle]
unsafe extern "C" fn iavf_free_q_vectors(adapter: *mut iavf_adapter) {
    ...
    adapter.q_vectors = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn iavf_reset_interrupt_capability(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_init_interrupt_scheme(adapter: *mut iavf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_free_interrupt_scheme(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_free_rss(adapter: *mut iavf_adapter) {
    static void iavf_free_rss(struct iavf_adapter *adapter)
    {
    kfree(adapter.rss_key);
    adapter.rss_key = core::ptr::null_mut();
    kfree(adapter.rss_lut);
    adapter.rss_lut = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn iavf_reinit_interrupt_scheme(adapter: *mut iavf_adapter, running: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_finish_config(work: *mut work_struct) {
    static void iavf_finish_config(struct work_struct *work)
    {
    struct iavf_adapter *adapter;
    let mut netdev_released: bool = false;
    int pairs, err;
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_schedule_finish_config(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_process_aq_command(adapter: *mut iavf_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(NETIF_F_HW_VLAN_STAG_TX): prev_features & (NETIF_F_HW_VLAN_STAG_RX |) -> else {
    else if (prev_features & (NETIF_F_HW_VLAN_STAG_RX | NETIF_F_HW_VLAN_STAG_TX))
    vlan_ethertype = ETH_P_8021AD;
#[no_mangle]
pub unsafe extern "C" fn if(NETIF_F_HW_VLAN_CTAG_TX): prev_features & (NETIF_F_HW_VLAN_CTAG_RX |) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_startup(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_init_version_check(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_parse_vf_resource_msg(adapter: *mut iavf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_init_get_resources(adapter: *mut iavf_adapter) {
    static void iavf_init_get_resources(struct iavf_adapter *adapter)
    {
    struct pci_dev *pdev = adapter.pdev;
    struct iavf_hw *hw = &adapter.hw;
...
//
    ...
    adapter.vf_res = core::ptr::null_mut();
    err:
    iavf_change_state(adapter, __IAVF_INIT_FAILED);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn iavf_init_send_offload_vlan_v2_caps(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_init_recv_offload_vlan_v2_caps(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_init_send_supported_rxdids(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_init_recv_supported_rxdids(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_init_send_ptp_caps(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_init_recv_ptp_caps(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_init_process_extended_caps(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_init_config_adapter(adapter: *mut iavf_adapter) {
...
// Setup initial PTP configuration
    ...
    let mut IAVF_NO_RESCHED: static int = -1;
// return: msec delay for requeueing itself
#[no_mangle]
unsafe extern "C" fn iavf_watchdog_step(adapter: *mut iavf_adapter) -> c_int {
...
//
    ...
    let mut ret: c_int = iavf_process_aq_command(adapter);
...
#[no_mangle]
unsafe extern "C" fn iavf_watchdog_task(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_disable_vf(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_reconfig_qs_bw(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_reset_step(adapter: *mut iavf_adapter) {
...
#[no_mangle]
unsafe extern "C" fn iavf_reset_task(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_adminq_task(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_free_all_tx_resources(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_setup_all_tx_resources(adapter: *mut iavf_adapter) -> c_int {
    static int iavf_setup_all_tx_resources(struct iavf_adapter *adapter)
    {
    int i, err = 0;
    for (i = 0; i < adapter.num_active_queues; i++) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_setup_all_rx_resources(adapter: *mut iavf_adapter) -> c_int {
    static int iavf_setup_all_rx_resources(struct iavf_adapter *adapter)
    {
    int i, err = 0;
    for (i = 0; i < adapter.num_active_queues; i++) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_free_all_rx_resources(adapter: *mut iavf_adapter) {
...
//
    ...
    {
    let mut total_max_rate: u64 = 0;
    let mut tx_rate_rem: u32 = 0;
    int i, num_qps = 0;
...
//
#[no_mangle]
unsafe extern "C" fn iavf_del_all_cloud_filters(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn __iavf_setup_tc(netdev: *mut net_device, type_data: *mut c_void) -> c_int {
    static int __iavf_setup_tc(struct net_device *netdev, void *type_data)
    {
    struct tc_mqprio_qopt_offload *mqprio_qopt = type_data;
    struct iavf_adapter *adapter = netdev_priv(netdev);
    struct virtchnl_vf_resource *vfres = adapter.vf_res;
    let mut num_tc: u8 = 0, total_qps = 0;
    let mut ret: c_int = 0, netdev_tc = 0;
    u64 max_tx_rate;
    u16 mode;
    int i;
...
// Report the tc mapping up the stack
    ...
    for (i = 0; i < IAVF_MAX_TRAFFIC_CLASS; i++) {
    let mut qcount: u16 = mqprio_qopt.qopt.count[i];
    let mut qoffset: u16 = mqprio_qopt.qopt.offset[i];
    if (i < num_tc)
...
//
    ...
    let mut n_proto_mask: u16 = 0;
    let mut n_proto_key: u16 = 0;
    let mut field_flags: u8 = 0;
    let mut addr_type: u16 = 0;
    let mut n_proto: u16 = 0;
    let mut i: c_int = 0;
...
//
    ...
    {
    struct iavf_cloud_filter *filter = core::ptr::null_mut();
    if (!cookie)
    return core::ptr::null_mut();
...
//
    ...
    {
    let mut tc: c_int = tc_classid_to_hwtc(adapter.netdev, cls_flower.classid);
    struct iavf_cloud_filter *filter;
    int err;
    if (tc < 0) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_restore_fdir_filters(adapter: *mut iavf_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_open(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_close(netdev: *mut net_device) -> c_int {
    static int iavf_close(struct net_device *netdev)
    {
    struct iavf_adapter *adapter = netdev_priv(netdev);
    u64 aq_to_restore;
...
//
#[no_mangle]
unsafe extern "C" fn iavf_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_disable_fdir(adapter: *mut iavf_adapter) {
    static void iavf_disable_fdir(struct iavf_adapter *adapter)
    {
    struct iavf_fdir_fltr *fdir, *fdirtmp;
    let mut del_filters: bool = false;
...
//
    ...
    {
    let mut hw_features: netdev_features_t = 0;
...
//
    ...
    {
    let mut features: netdev_features_t = 0;
    if (!adapter.vf_res || !adapter.vf_res.vf_cap_flags)
    return features;
    if (VLAN_ALLOWED(adapter)) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_check_reset_complete(hw: *mut iavf_hw) -> c_int {
    static int iavf_check_reset_complete(struct iavf_hw *hw)
    {
    u32 rstat;
    int i;
...
//
#[no_mangle]
pub unsafe extern "C" fn iavf_process_config(adapter: *mut iavf_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
    static int iavf_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
    {
    struct net_device *netdev;
    struct iavf_adapter *adapter = core::ptr::null_mut();
    struct iavf_hw *hw = core::ptr::null_mut();
    int err, len;
...
//
#[no_mangle]
unsafe extern "C" fn iavf_suspend(dev_d: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_resume(dev_d: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_remove(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_shutdown(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_init_module() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn iavf_exit_module() -> void __exit {
