...
//! Source: drivers/net/ethernet/microsoft/mana/hw_channel.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mana_hwc_get_msg_index(hwc: *mut hw_channel_context, msg_id: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mana_hwc_put_msg_index(hwc: *mut hw_channel_context, msg_id: u16) {
    ...
    err = mana_gd_post_and_ring(hwc_rxq.gdma_wq, &req.wqe_req, core::ptr::null_mut());
    if (err)
...
#[no_mangle]
unsafe extern "C" fn mana_hwc_comp_event(ctx: *mut c_void, q_self: *mut gdma_queue) {
    static void mana_hwc_comp_event(void *ctx, struct gdma_queue *q_self)
    {
    let mut comp_data: hwc_rx_oob = {};
...
#[no_mangle]
unsafe extern "C" fn mana_hwc_destroy_cq(gc: *mut gdma_context, hwc_cq: *mut hwc_cq) {
...
// hwc_wq_ptr = hwc_wq;
    ...
    req.wqe_req.client_data_unit = 0;
    err = mana_gd_post_and_ring(hwc_txq.gdma_wq, &req.wqe_req, core::ptr::null_mut());
    if (err)
...
#[no_mangle]
pub unsafe extern "C" fn mana_hwc_create_channel(gc: *mut gdma_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_hwc_destroy_channel(gc: *mut gdma_context) {
...
//
    ...
    hwc.caller_ctx = core::ptr::null_mut();
    ...
    hwc.hwc_timeout = 0;
    kfree(hwc);
    gc.hwc.driver_data = core::ptr::null_mut();
    gc.hwc.gdma_context = core::ptr::null_mut();
    vfree(gc.cq_table);
    gc.cq_table = core::ptr::null_mut();
    }
    ...
    struct hwc_caller_ctx *ctx;
    let mut dest_vrcq: u32 = 0;
    let mut dest_vrq: u32 = 0;
    u32 command;
    u16 msg_id;
    int err;
