...
//! Source: drivers/net/ethernet/microsoft/mana/shm_channel.c
#![no_std]
...
pub const PAGE_FRAME_L48_WIDTH_BYTES: c_int = 6;

pub const PAGE_FRAME_L48_MASK: c_uint = 0x0000FFFFFFFFFFFF;
pub const PAGE_FRAME_H4_WIDTH_BITS: c_int = 4;
pub const VECTOR_MASK: c_uint = 0xFFFF;

pub const SMC_MSG_TYPE_ESTABLISH_HWC: c_int = 1;
pub const SMC_MSG_TYPE_ESTABLISH_HWC_VERSION: c_int = 0;
pub const SMC_MSG_TYPE_DESTROY_HWC: c_int = 2;
pub const SMC_MSG_TYPE_DESTROY_HWC_VERSION: c_int = 0;
pub const SMC_MSG_DIRECTION_REQUEST: c_int = 0;
pub const SMC_MSG_DIRECTION_RESPONSE: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn mana_smc_poll_register(base: *mut void __iomem, reset: bool) -> c_int {
...
// Validate the operation result
    ...
    {
    union smc_proto_hdr *hdr;
    let mut all_addr_h4bits: u16 = 0;
    let mut frame_addr_seq: u16 = 0;
    let mut frame_addr: u64 = 0;
    u8 shm_buf[32];
    u64 *shmem;
    u32 *dword;
    u8 *ptr;
...
#[no_mangle]
pub unsafe extern "C" fn mana_smc_teardown_hwc(sc: *mut shm_channel, reset_vf: bool) -> c_int {
    int mana_smc_teardown_hwc(struct shm_channel *sc, bool reset_vf)
    {
    let mut hdr: union smc_proto_hdr = {};
    int err;
