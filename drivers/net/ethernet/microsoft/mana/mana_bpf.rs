...
//! Source: drivers/net/ethernet/microsoft/mana/mana_bpf.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mana_xdp_tx(skb: *mut sk_buff, ndev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn mana_chn_setxdp(apc: *mut mana_port_context, prog: *mut bpf_prog) {
...
#[no_mangle]
pub unsafe extern "C" fn mana_bpf(ndev: *mut net_device, bpf: *mut netdev_bpf) -> c_int {
