...
//! Source: drivers/net/ethernet/microsoft/mana/gdma_main.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mana_dev_recovery {
    pub list: list_head,
    pub pdev: *mut pci_dev,
    pub type: enum gdma_eqe_type,
}
...
#[no_mangle]
unsafe extern "C" fn mana_gd_r32(g: *mut gdma_context, offset: u64) -> u32 {
    static u32 mana_gd_r32(struct gdma_context *g, u64 offset)
    {
    return readl(g.bar0_va + offset);
    }
#[no_mangle]
unsafe extern "C" fn mana_gd_r64(g: *mut gdma_context, offset: u64) -> u64 {
    static u64 mana_gd_r64(struct gdma_context *g, u64 offset)
    {
    return readq(g.bar0_va + offset);
    }
#[no_mangle]
unsafe extern "C" fn mana_gd_init_pf_regs(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mana_gd_init_vf_regs(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mana_gd_init_registers(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_need_log(gc: *mut gdma_context, err: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mana_gd_query_max_resources(pdev: *mut pci_dev) -> c_int {
    static int mana_gd_query_max_resources(struct pci_dev *pdev)
    {
    struct gdma_context *gc = pci_get_drvdata(pdev);
    let mut resp: gdma_query_max_resources_resp = {};
    let mut req: gdma_general_req = {};
...
#[no_mangle]
unsafe extern "C" fn mana_gd_query_hwc_timeout(pdev: *mut pci_dev, timeout_val: *mut u32) -> c_int {
    static int mana_gd_query_hwc_timeout(struct pci_dev *pdev, u32 *timeout_val)
    {
    struct gdma_context *gc = pci_get_drvdata(pdev);
    let mut resp: gdma_query_hwc_timeout_resp = {};
    let mut req: gdma_query_hwc_timeout_req = {};
    int err;
...
#[no_mangle]
unsafe extern "C" fn mana_gd_detect_devices(pdev: *mut pci_dev) -> c_int {
    static int mana_gd_detect_devices(struct pci_dev *pdev)
    {
    struct gdma_context *gc = pci_get_drvdata(pdev);
    let mut resp: gdma_list_devices_resp = {};
    let mut req: gdma_general_req = {};
    struct gdma_dev_id dev;
    let mut found_dev: c_int = 0;
    u16 dev_type;
    int err;
    u32 i;
...
// length is a power of 2 above PAGE_SIZE, so this divides exactly.
    ...
    length, npages);
    gmi.virt_addr = core::ptr::null_mut();
    gmi.dma_handle = 0;
    gmi.length = length;
    gmi.nr_pages = npages;
    return 0;
    ...
    gmi.pages_dma = core::ptr::null_mut();
    free_va:
    kvfree(gmi.pages_va);
    gmi.pages_va = core::ptr::null_mut();
    return -ENOMEM;
    }
#[no_mangle]
pub unsafe extern "C" fn mana_gd_free_memory(gmi: *mut gdma_mem_info) {
    ...
    {
    let mut resp: gdma_create_queue_resp = {};
    let mut req: gdma_create_queue_req = {};
    int err;
...
#[no_mangle]
unsafe extern "C" fn mana_gd_disable_queue(queue: *mut gdma_queue) -> c_int {
    static int mana_gd_disable_queue(struct gdma_queue *queue)
    {
    struct gdma_context *gc = queue.gdma_dev.gdma_context;
    let mut req: gdma_disable_queue_req = {};
    let mut resp: gdma_general_resp = {};
    int err;
...
pub const DOORBELL_OFFSET_SQ: c_uint = 0x0;
pub const DOORBELL_OFFSET_RQ: c_uint = 0x400;
pub const DOORBELL_OFFSET_CQ: c_uint = 0x800;
pub const DOORBELL_OFFSET_EQ: c_uint = 0xFF8;
pub const DOORBELL_OFFSET_DIM: c_uint = 0x820;
    ...
    let mut e: union gdma_doorbell_entry = {};
    switch (q_type) {
    case GDMA_EQ:
    e.eq.id = qid;
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_wq_ring_doorbell(gc: *mut gdma_context, queue: *mut gdma_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_ring_cq(cq: *mut gdma_queue, arm_bit: u8) {
    void mana_gd_ring_cq(struct gdma_queue *cq, u8 arm_bit)
    {
    struct gdma_context *gc = cq.gdma_dev.gdma_context;
    let mut num_cqe: u32 = cq.queue_size / GDMA_CQE_SIZE;
    let mut head: u32 = cq.head % (num_cqe << GDMA_CQE_OWNER_BITS);
...
pub const MANA_SERVICE_PERIOD: c_int = 10;
#[no_mangle]
unsafe extern "C" fn mana_serv_rescan(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mana_serv_fpga(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mana_serv_reset(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mana_do_service(type: enum gdma_eqe_type, pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mana_recovery_delayed_func(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mana_serv_func(w: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mana_schedule_serv_work(gc: *mut gdma_context, type: enum gdma_eqe_type) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mana_gd_ring_contig_avail(q: *const gdma_queue, offset: u32) -> u32 {
...
//
    ...
    {
    let mut size: u32 = q.queue_size;
    let mut off: loff_t = *pos;
    ...
    while (count) {
    let mut offset: u32 = off;
    let mut avail: u32 = mana_gd_ring_contig_avail(q, offset);
    let mut chunk: usize = min_t(size_t, count, avail);
...
#[no_mangle]
unsafe extern "C" fn mana_gd_process_eqe(eq: *mut gdma_queue) {
    static void mana_gd_process_eqe(struct gdma_queue *eq)
    {
    let mut head: u32 = eq.head % (eq.queue_size / GDMA_EQE_SIZE);
...
#[no_mangle]
unsafe extern "C" fn mana_gd_process_eq_events(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mana_gd_deregister_irq(queue: *mut gdma_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_test_eq(gc: *mut gdma_context, eq: *mut gdma_queue) -> c_int {
    int mana_gd_test_eq(struct gdma_context *gc, struct gdma_queue *eq)
    {
    let mut req: gdma_generate_test_event_req = {};
    let mut resp: gdma_general_resp = {};
    ...
    struct gdma_queue *queue)
    {
    let mut log2_num_entries: u32 = ilog2(spec.queue_size / GDMA_CQE_SIZE);
    queue.head |= INITIALIZED_OWNER_BIT(log2_num_entries);
    ...
    struct gdma_queue *queue)
    {
    let mut id: u32 = queue.id;
    if (id >= gc.max_num_cqs)
    return;
    if (!gc.cq_table[id])
    return;
    gc.cq_table[id] = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(GDMA_CQ: spec->type ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_destroy_dma_region(gc: *mut gdma_context, dma_region_handle: u64) -> c_int {
    int mana_gd_destroy_dma_region(struct gdma_context *gc, u64 dma_region_handle)
    {
    let mut req: gdma_destroy_dma_region_req = {};
    let mut resp: gdma_general_resp = {};
    int err;
    ...
    struct gdma_mem_info *gmi)
    {
    let mut num_page: c_uint = gmi.length / MANA_PAGE_SIZE;
    struct gdma_create_dma_region_req *req = core::ptr::null_mut();
    let mut resp: gdma_create_dma_region_resp = {};
    struct gdma_context *gc = gd.gdma_context;
    struct hw_channel_context *hwc;
    let mut length: u32 = gmi.length;
    size_t req_msg_size;
    int err;
    int i;
    if (length < MANA_PAGE_SIZE || !is_power_of_2(length))
    ...
    if (gmi.nr_pages > 0) {
    let mut subpages: c_uint = PAGE_SIZE / MANA_PAGE_SIZE;
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_destroy_queue(gc: *mut gdma_context, queue: *mut gdma_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_verify_vf_version(pdev: *mut pci_dev) -> c_int {
    int mana_gd_verify_vf_version(struct pci_dev *pdev)
    {
    struct gdma_context *gc = pci_get_drvdata(pdev);
    let mut resp: gdma_verify_ver_resp = {};
    let mut req: gdma_verify_ver_req = {};
    struct hw_channel_context *hwc;
    int err;
    hwc = gc.hwc.driver_data;
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_register_device(gd: *mut gdma_dev) -> c_int {
    int mana_gd_register_device(struct gdma_dev *gd)
    {
    struct gdma_context *gc = gd.gdma_context;
    let mut resp: gdma_register_device_resp = {};
    let mut req: gdma_general_req = {};
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_deregister_device(gd: *mut gdma_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_wq_avail_space(wq: *mut gdma_queue) -> u32 {
    u32 mana_gd_wq_avail_space(struct gdma_queue *wq)
    {
    let mut used_space: u32 = (wq.head - wq.tail) * GDMA_WQE_BU_SIZE;
    let mut wq_size: u32 = wq.queue_size;
    WARN_ON_ONCE(used_space > wq_size);
    return wq_size - used_space;
    }
    u8 *mana_gd_get_wqe_ptr(const struct gdma_queue *wq, u32 wqe_offset)
    {
    let mut offset: u32 = (wqe_offset * GDMA_WQE_BU_SIZE) & (wq.queue_size - 1);
    ...
    u8 *wqe_ptr)
    {
    let mut oob_in_sgl: bool = !!(wqe_req.flags & GDMA_WR_OOB_IN_SGL);
    let mut pad_data: bool = !!(wqe_req.flags & GDMA_WR_PAD_BY_SGE0);
...
//
    ...
    {
    let mut size_to_end: u32 = mana_gd_ring_contig_avail(wq, sgl_offset);
    let mut sgl_size: u32 = sizeof(struct gdma_sge) * wqe_req.num_sge;
    ...
    {
    let mut client_oob_size: u32 = wqe_req.inline_oob_size;
    u32 sgl_data_size;
    u32 max_wqe_size;
    u32 wqe_offset;
    u32 sgl_offset;
...
#[no_mangle]
unsafe extern "C" fn mana_gd_read_cqe(cq: *mut gdma_queue, comp: *mut gdma_comp) -> c_int {
    static int mana_gd_read_cqe(struct gdma_queue *cq, struct gdma_comp *comp)
    {
    let mut num_cqe: c_uint = cq.queue_size / sizeof(struct gdma_cqe);
    u32 owner_bits, new_bits, old_bits;
    struct gdma_cqe *cqe;
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_poll_cq(cq: *mut gdma_queue, comp: *mut gdma_comp, num_cqe: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mana_gd_intr(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_put_gic(gc: *mut gdma_context, use_msi_bitmap: bool, msi: c_int) {
    ...
    goto out;
    irq = gic.irq;
    irq_update_affinity_hint(irq, core::ptr::null_mut());
    free_irq(irq, gic);
    if (gic.dyn_msix) {
    irq_map.virq = irq;
    irq_map.index = msi;
...
// msi_requested = msi;
    ...
    if (irq == -EINVAL) {
    irq_map = pci_msix_alloc_irq_at(dev, msi, core::ptr::null_mut());
    if (!irq_map.virq) {
    err = irq_map.index;
    dev_err(gc.dev,
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_alloc_res_map(res_avail: u32, r: *mut gdma_resource) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_free_res_map(r: *mut gdma_resource) {
    void mana_gd_free_res_map(struct gdma_resource *r)
    {
    bitmap_free(r.map);
    r.map = core::ptr::null_mut();
    r.size = 0;
    }
//
...
#[no_mangle]
unsafe extern "C" fn mana_irq_setup_linear(irqs: *mut c_uint, len: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mana_gd_setup_dyn_irqs(pdev: *mut pci_dev, nvec: c_int) -> c_int {
...
// affinity.
//
    let mut first_unassigned: c_int = num_online_cpus();
...
#[no_mangle]
unsafe extern "C" fn mana_gd_setup_irqs(pdev: *mut pci_dev, nvec: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mana_gd_setup_hwc_irqs(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mana_gd_setup_remaining_irqs(pdev: *mut pci_dev) -> c_int {
...
// allocate only remaining IRQs
    ...
    irq_map = pci_msix_alloc_irq_at(pdev, i, core::ptr::null_mut());
    if (!irq_map.virq) {
    err = irq_map.index;
...
#[no_mangle]
unsafe extern "C" fn mana_gd_remove_irqs(pdev: *mut pci_dev) {
    ...
    gc.msi_bitmap = core::ptr::null_mut();
    gc.max_num_msix = 0;
    gc.num_msix_usable = 0;
    }
#[no_mangle]
unsafe extern "C" fn mana_gd_setup(pdev: *mut pci_dev) -> c_int {
...
// Set bit for HWC
    ...
    gc.service_wq = core::ptr::null_mut();
    remove_debugfs:
    debugfs_remove_recursive(gc.mana_pci_debugfs);
    gc.mana_pci_debugfs = core::ptr::null_mut();
    dev_err(&pdev.dev, "%s failed (error %d)\n", __func__, err);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn mana_gd_cleanup_device(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mana_is_pf(dev_id: c_ushort) -> bool {
    static bool mana_is_pf(unsigned short dev_id)
    {
    let mut dev_id: return = = MANA_PF_DEVICE_ID || dev_id == MANA_PF2_DEVICE_ID;
    }
#[no_mangle]
unsafe extern "C" fn mana_gd_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mana_gd_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_suspend(pdev: *mut pci_dev, state: pm_message_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_gd_resume(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mana_gd_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mana_sriov_configure(pdev: *mut pci_dev, numvfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mana_driver_init() -> int __init {
    ...
    mana_debugfs_root = debugfs_create_dir("mana", core::ptr::null_mut());
    err = pci_register_driver(&mana_driver);
    if (err) {
    debugfs_remove(mana_debugfs_root);
    mana_debugfs_root = core::ptr::null_mut();
    }
    return err;
    }
#[no_mangle]
unsafe extern "C" fn mana_driver_exit() -> void __exit {
