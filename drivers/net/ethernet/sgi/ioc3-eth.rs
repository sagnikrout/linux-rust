...
//! Source: drivers/net/ethernet/sgi/ioc3-eth.c
#![no_std]
...
//
pub const RX_BUFFS: c_int = 64;

// 128 TX buffers (not tunable)
pub const TX_RING_ENTRIES: c_int = 128;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ioc3_private {
    pub regs: *mut ioc3_ethregs,
    pub dma_dev: *mut device,
    pub ssram: *mut u32,
    pub /: *mut *mut *mut unsigned long rxr; / pointer to receiver ring,
    pub tx_ring: *mut c_void,
    pub txr: *mut ioc3_etxd,
    pub rxr_dma: dma_addr_t,
    pub txr_dma: dma_addr_t,
    pub rx_skbs: [*mut sk_buff; RX_RING_ENTRIES],
    pub tx_skbs: [*mut sk_buff; TX_RING_ENTRIES],
    pub /: *mut *mut int rx_ci; / RX consumer index,
    pub /: *mut *mut int rx_pi; / RX producer index,
    pub /: *mut *mut int tx_ci; / TX consumer index,
    pub /: *mut *mut int tx_pi; / TX producer index,
    pub txqlen: c_int,
    pub ehar_l: u32 emcr, ehar_h,,
    pub ioc3_lock: spinlock_t,
    pub mii: mii_if_info,
// Members used by autonegotiation
    pub ioc3_timer: timer_list,
}
...
#[no_mangle]
pub unsafe extern "C" fn aligned_rx_skb_addr(addr: c_ulong) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn ioc3_map(addr: dma_addr_t, attr: c_ulong) -> c_ulong {
...
pub const ERBAR_VAL: c_int = 0;

#[no_mangle]
unsafe extern "C" fn ioc3eth_nvmem_match(dev: *mut device, data: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioc3eth_get_mac_addr(res: *mut resource, mac_addr[6]: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ioc3_set_mac_address(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ioc3_set_mac_address(dev: *mut net_device, addr: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ioc3_mdio_read(dev: *mut net_device, phy: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioc3_mdio_write(dev: *mut net_device, phy: c_int, reg: c_int, data: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ioc3_tcpudp_checksum(skb: *mut sk_buff, hwsum: u32, len: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn ioc3_rx(dev: *mut net_device) {
...
//
    ...
    RX_BUF_SIZE, DMA_FROM_DEVICE);
    netif_rx(skb);
    ip.rx_skbs[rx_entry] = core::ptr::null_mut();	/* Poison  */
...
#[no_mangle]
pub unsafe extern "C" fn ioc3_tx(dev: *mut net_device) {
    ...
    ip.tx_skbs[o_entry] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ioc3_error(dev: *mut net_device, eisr: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn ioc3_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn ioc3_setup_duplex(ip: *mut ioc3_private) {
...
#[no_mangle]
unsafe extern "C" fn ioc3_timer(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn ioc3_mii_init(ip: *mut ioc3_private) -> c_int {
    static int ioc3_mii_init(struct ioc3_private *ip)
    {
    u16 word;
    int i;
...
#[no_mangle]
unsafe extern "C" fn ioc3_mii_start(ip: *mut ioc3_private) {
...
#[no_mangle]
pub unsafe extern "C" fn ioc3_tx_unmap(ip: *mut ioc3_private, entry: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn ioc3_clean_tx_ring(ip: *mut ioc3_private) {
    static inline void ioc3_clean_tx_ring(struct ioc3_private *ip)
    {
    struct sk_buff *skb;
    int i;
    ...
    if (skb) {
    ioc3_tx_unmap(ip, i);
    ip.tx_skbs[i] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ioc3_free_rx_bufs(ip: *mut ioc3_private) {
    static void ioc3_free_rx_bufs(struct ioc3_private *ip)
    {
...
#[no_mangle]
unsafe extern "C" fn ioc3_alloc_rx_bufs(dev: *mut net_device) -> c_int {
    static int ioc3_alloc_rx_bufs(struct net_device *dev)
    {
    struct ioc3_private *ip = netdev_priv(dev);
    struct ioc3_erxbuf *rxb;
...
#[no_mangle]
pub unsafe extern "C" fn ioc3_ssram_disc(ip: *mut ioc3_private) {
    static inline void ioc3_ssram_disc(struct ioc3_private *ip)
    {
    struct ioc3_ethregs *regs = ip.regs;
    u32 *ssram0 = &ip.ssram[0x0000];
    u32 *ssram1 = &ip.ssram[0x4000];
    let mut pattern: u32 = 0x5555;
...
#[no_mangle]
unsafe extern "C" fn ioc3_init(dev: *mut net_device) {
    static void ioc3_init(struct net_device *dev)
    {
    struct ioc3_private *ip = netdev_priv(dev);
    struct ioc3_ethregs *regs = ip.regs;
...
#[no_mangle]
unsafe extern "C" fn ioc3_start(ip: *mut ioc3_private) {
    static void ioc3_start(struct ioc3_private *ip)
    {
    struct ioc3_ethregs *regs = ip.regs;
    unsigned long ring;
...
#[no_mangle]
pub unsafe extern "C" fn ioc3_stop(ip: *mut ioc3_private) {
    static inline void ioc3_stop(struct ioc3_private *ip)
    {
    struct ioc3_ethregs *regs = ip.regs;
...
#[no_mangle]
unsafe extern "C" fn ioc3_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioc3_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioc3eth_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioc3eth_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ioc3_start_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t ioc3_start_xmit(struct sk_buff *skb, struct net_device *dev)
    {
    struct ioc3_private *ip = netdev_priv(dev);
    struct ioc3_etxd *desc;
...
//
    ...
    let mut proto: c_int = ntohs(ih.protocol);
    unsigned int csoff;
    u32 csum, ehsum;
    u16 *eh;
...
// Very short packet, pad with zeros at the end.
    ...
    let mut b2: c_ulong = (data | 0x3fffUL) + 1UL;
    let mut s1: c_ulong = b2 - data;
    let mut s2: c_ulong = data + len - b2;
    dma_addr_t d1, d2;
...
#[no_mangle]
unsafe extern "C" fn ioc3_timeout(dev: *mut net_device, txqueue: c_uint) {
    static void ioc3_timeout(struct net_device *dev, unsigned int txqueue)
    {
    struct ioc3_private *ip = netdev_priv(dev);
...
//
#[no_mangle]
pub unsafe extern "C" fn ioc3_hash(addr: *const c_uchar) -> c_uint {
    static inline unsigned int ioc3_hash(const unsigned char *addr)
    {
...
#[no_mangle]
unsafe extern "C" fn ioc3_nway_reset(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioc3_get_link(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ioc3_ioctl(dev: *mut net_device, rq: *mut ifreq, cmd: c_int) -> c_int {
    static int ioc3_ioctl(struct net_device *dev, struct ifreq *rq, int cmd)
    {
    struct ioc3_private *ip = netdev_priv(dev);
    int rc;
    spin_lock_irq(&ip.ioc3_lock);
    rc = generic_mii_ioctl(&ip.mii, if_mii(rq), cmd, core::ptr::null_mut());
    spin_unlock_irq(&ip.ioc3_lock);
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn ioc3_set_multicast_list(dev: *mut net_device) {
    static void ioc3_set_multicast_list(struct net_device *dev)
    {
    struct ioc3_private *ip = netdev_priv(dev);
    struct ioc3_ethregs *regs = ip.regs;
