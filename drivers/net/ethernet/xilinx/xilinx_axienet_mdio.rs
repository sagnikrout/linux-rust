...
//! Source: drivers/net/ethernet/xilinx/xilinx_axienet_mdio.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn axienet_mdio_wait_until_ready(lp: *mut axienet_local) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_mdio_mdc_enable(lp: *mut axienet_local) {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_mdio_mdc_disable(lp: *mut axienet_local) {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_mdio_read(bus: *mut mii_bus, phy_id: c_int, reg: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_mdio_enable(lp: *mut axienet_local, np: *mut device_node) -> c_int {
    static int axienet_mdio_enable(struct axienet_local *lp, struct device_node *np)
    {
    let mut mdio_freq: u32 = DEFAULT_MDIO_FREQ;
    u32 host_clock;
    u32 clk_div;
    int ret;
    lp.mii_clk_div = 0;
...
//
    np1 = of_find_node_by_name(core::ptr::null_mut(), "cpu");
    if (!np1) {
...
//
#[no_mangle]
pub unsafe extern "C" fn axienet_mdio_setup(lp: *mut axienet_local) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn axienet_mdio_teardown(lp: *mut axienet_local) {
