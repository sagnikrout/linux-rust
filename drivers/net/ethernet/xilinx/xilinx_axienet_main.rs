...
//! Source: drivers/net/ethernet/xilinx/xilinx_axienet_main.c
#![no_std]
...
pub const TX_BD_NUM_DEFAULT: c_int = 128;
pub const RX_BD_NUM_DEFAULT: c_int = 1024;

pub const TX_BD_NUM_MAX: c_int = 4096;
pub const RX_BD_NUM_MAX: c_int = 4096;
pub const DMA_NUM_APP_WORDS: c_int = 5;
pub const LEN_APP: c_int = 4;
pub const RX_BUF_NUM_DEFAULT: c_int = 128;
// Must be shorter than length of ethtool_drvinfo.driver field to fit

pub const AXIENET_REGS_N: c_int = 40;
...
//
#[no_mangle]
pub unsafe extern "C" fn axienet_dma_in32(lp: *mut axienet_local, reg: off_t) -> u32 {
    ...
    struct axidma_bd *desc)
    {
    let mut ret: dma_addr_t = desc.phys;
    if (lp.features & XAE_FEATURE_DMA_64BIT)
...
//
#[no_mangle]
unsafe extern "C" fn axienet_dma_bd_release(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn axienet_dma_rate(lp: *mut axienet_local) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_calc_cr(lp: *mut axienet_local, count: u32, usec: u32) -> u32 {
...
//
    if (count > 1) {
    let mut clk_rate: u64 = axienet_dma_rate(lp);
    u32 timer;
...
//
    ...
    {
    let mut clk_rate: u64 = axienet_dma_rate(lp);
    let mut timer: u64 = FIELD_GET(XAXIDMA_DELAY_MASK, cr);
...
//
#[no_mangle]
unsafe extern "C" fn axienet_dma_start(lp: *mut axienet_local) {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_dma_bd_init(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn netdev_set_mac_address(ndev: *mut net_device, p: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_set_multicast_list(ndev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_setoptions(ndev: *mut net_device, options: u32) {
...
#[no_mangle]
unsafe extern "C" fn axienet_stat(lp: *mut axienet_local, stat: enum temac_stat) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn axienet_stats_update(lp: *mut axienet_local, reset: bool) {
    ...
    let mut counter: u32 = axienet_ior(lp, XAE_STATS_OFFSET + stat * 8);
...
#[no_mangle]
unsafe extern "C" fn axienet_refresh_stats(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn __axienet_device_reset(lp: *mut axienet_local) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_dma_stop(lp: *mut axienet_local) {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_device_reset(ndev: *mut net_device) -> c_int {
...
//
    ...
    axienet_set_mac_address(ndev, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn axienet_dma_tx_cb(data: *mut c_void, result: *const dmaengine_result) {
...
//
    ...
    {
    struct dma_async_tx_descriptor *dma_tx_desc = core::ptr::null_mut();
    struct axienet_local *lp = netdev_priv(ndev);
...
//
#[no_mangle]
unsafe extern "C" fn axienet_tx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_dma_rx_cb(data: *mut c_void, result: *const dmaengine_result) {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_rx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_tx_irq(irq: c_int, _ndev: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_rx_irq(irq: c_int, _ndev: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_eth_irq(irq: c_int, _ndev: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_rx_submit_desc(ndev: *mut net_device) {
    static void axienet_rx_submit_desc(struct net_device *ndev)
    {
    struct dma_async_tx_descriptor *dma_rx_desc = core::ptr::null_mut();
    struct axienet_local *lp = netdev_priv(ndev);
    struct skbuf_dma_descriptor *skbuf_dma;
    struct sk_buff *skb;
    dma_addr_t addr;
...
//
#[no_mangle]
unsafe extern "C" fn axienet_init_dmaengine(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_init_legacy_dma(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_open(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_stop(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_change_mtu(ndev: *mut net_device, new_mtu: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_poll_controller(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn axienet_ioctl(dev: *mut net_device, rq: *mut ifreq, cmd: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_ethtools_get_regs_len(ndev: *mut net_device) -> c_int {
...
//
    ...
    {
    u32 *data = (u32 *)ret;
    let mut len: usize = sizeof(u32) * AXIENET_REGS_N;
    struct axienet_local *lp = netdev_priv(ndev);
    regs.version = 0;
    regs.len = len;
    memset(data, 0, len);
...
//
    ...
    let mut reg: u32 = axienet_dma_in32(lp, XAXIDMA_RX_CR_OFFSET);
...
//
#[no_mangle]
unsafe extern "C" fn axienet_dim_coalesce_count_rx(lp: *mut axienet_local) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_rx_dim_work(work: *mut work_struct) {
    static void axienet_rx_dim_work(struct work_struct *work)
    {
    struct axienet_local *lp =
    container_of(work, struct axienet_local, rx_dim.work);
    let mut cr: u32 = axienet_calc_cr(lp, axienet_dim_coalesce_count_rx(lp), 0);
...
//
    ...
    let mut reg: u32 = axienet_dma_in32(lp, XAXIDMA_TX_CR_OFFSET);
// Don't enable IRQs if they are disabled by NAPI
    if (reg & XAXIDMA_IRQ_ALL_MASK)
    cr = lp.tx_dma_cr;
    else
...
//
    ...
    {
    struct axienet_local *lp = netdev_priv(ndev);
    let mut new_dim: bool = ecoalesce.use_adaptive_rx_coalesce;
    let mut old_dim: bool = lp.rx_dim_enabled;
...
#[no_mangle]
unsafe extern "C" fn axienet_ethtools_nway_reset(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axienet_ethtools_get_strings(dev: *mut net_device, stringset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn axienet_ethtools_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axienet_pcs_an_restart(pcs: *mut phylink_pcs) {
...
//
#[no_mangle]
unsafe extern "C" fn axienet_dma_err_handler(work: *mut work_struct) {
    static void axienet_dma_err_handler(struct work_struct *work)
    {
    u32 i;
    u32 axienet_status;
...
// Don't bother if we are going to stop anyway
    ...
    cur_p = &lp.tx_bd_v[i];
    if (cur_p.cntrl) {
    let mut addr: dma_addr_t = desc_get_phys_addr(lp, cur_p);
...
//
#[no_mangle]
unsafe extern "C" fn axienet_probe(pdev: *mut platform_device) -> c_int {
...
//
    lp.axi_clk = devm_clk_get_optional_enabled(&pdev.dev, core::ptr::null_mut());
    }
...
// Check for these resources directly on the Ethernet node.
    lp.dma_regs = devm_platform_get_and_ioremap_resource(pdev, 1, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn axienet_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn axienet_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn axienet_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axienet_resume(dev: *mut device) -> c_int {
