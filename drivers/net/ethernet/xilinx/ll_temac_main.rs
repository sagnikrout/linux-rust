...
//! Source: drivers/net/ethernet/xilinx/ll_temac_main.c
#![no_std]
...
pub const TX_BD_NUM_DEFAULT: c_int = 64;
...
//
#[no_mangle]
pub unsafe extern "C" fn temac_indirect_busywait(lp: *mut temac_local) -> c_int {
    int temac_indirect_busywait(struct temac_local *lp)
    {
    let mut timeout: ktime_t = ktime_add_ns(ktime_get(), HARD_ACS_RDY_POLL_NS);
...
//
#[no_mangle]
pub unsafe extern "C" fn temac_indirect_in32(lp: *mut temac_local, reg: c_int) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn temac_indirect_in32_locked(lp: *mut temac_local, reg: c_int) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn temac_indirect_out32(lp: *mut temac_local, reg: c_int, value: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn temac_indirect_out32_locked(lp: *mut temac_local, reg: c_int, value: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn temac_dma_in32_be(lp: *mut temac_local, reg: c_int) -> u32 {
    static u32 temac_dma_in32_be(struct temac_local *lp, int reg)
    {
    return ioread32be(lp.sdma_regs + (reg << 2));
    }
#[no_mangle]
unsafe extern "C" fn temac_dma_in32_le(lp: *mut temac_local, reg: c_int) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn temac_dma_out32_be(lp: *mut temac_local, reg: c_int, value: u32) {
    static void temac_dma_out32_be(struct temac_local *lp, int reg, u32 value)
    {
    iowrite32be(value, lp.sdma_regs + (reg << 2));
    }
#[no_mangle]
unsafe extern "C" fn temac_dma_out32_le(lp: *mut temac_local, reg: c_int, value: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn temac_dma_dcr_in(lp: *mut temac_local, reg: c_int) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn temac_dma_dcr_out(lp: *mut temac_local, reg: c_int, value: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn temac_dma_bd_release(ndev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn temac_dma_bd_init(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn temac_do_set_mac_address(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn temac_init_mac_address(ndev: *mut net_device, address: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn temac_set_mac_address(ndev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn temac_set_multicast_list(ndev: *mut net_device) {
    ...
    let mut i: c_int = 0;
    unsigned long flags;
    let mut promisc_mode_disabled: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn temac_setoptions(ndev: *mut net_device, options: u32) -> u32 {
...
// Initialize temac
#[no_mangle]
unsafe extern "C" fn temac_device_reset(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn temac_adjust_link(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ptr_to_txbd(p: *mut c_void, bd: *mut cdmac_bd) {
...
#[no_mangle]
unsafe extern "C" fn temac_start_xmit_done(ndev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn temac_check_tx_bd_space(lp: *mut temac_local, num_frag: c_int) -> c_int {
...
// Space might have just been freed - check again
    ...
    let mut csum_start_off: c_uint = skb_checksum_start_offset(skb);
    let mut csum_index_off: c_uint = csum_start_off + skb.csum_offset;
...
#[no_mangle]
unsafe extern "C" fn ll_temac_recv_buffers_available(lp: *mut temac_local) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ll_temac_recv(ndev: *mut net_device) {
    static void ll_temac_recv(struct net_device *ndev)
    {
    struct temac_local *lp = netdev_priv(ndev);
    unsigned long flags;
    int rx_bd;
    let mut update_tail: bool = false;
...
//
    ...
    let mut bdstat: c_uint = be32_to_cpu(bd.app0);
    int length;
...
// The skb buffer is now owned by network stack above
    lp.rx_skb[lp.rx_bd_ci] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ll_temac_restart_work_func(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ll_temac_tx_irq(irq: c_int, _ndev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ll_temac_rx_irq(irq: c_int, _ndev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn temac_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn temac_stop(ndev: *mut net_device) -> c_int {
...
//
    ...
    static DEVICE_ATTR(llink_regs, 0440, temac_show_llink_regs, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn temac_probe(pdev: *mut platform_device) -> c_int {
...
// Setup checksum offload, but default to off if not specified
    lp.temac_features = 0;
    if (temac_np) {
    p = (__be32 *)of_get_property(temac_np, "xlnx,txcsum", core::ptr::null_mut());
    if (p && be32_to_cpu(*p))
    lp.temac_features |= TEMAC_FEATURE_TX_CSUM;
    p = (__be32 *)of_get_property(temac_np, "xlnx,rxcsum", core::ptr::null_mut());
    if (p && be32_to_cpu(*p))
...
#[no_mangle]
unsafe extern "C" fn temac_remove(pdev: *mut platform_device) {
