...
//! Source: drivers/net/ethernet/mucse/rnpgbe/rnpgbe_main.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn rnpgbe_open(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rnpgbe_close(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rnpgbe_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    static int rnpgbe_probe(struct pci_dev *pdev, const struct pci_device_id *id)
    {
    let mut board_type: c_int = id.driver_data;
    int err;
...
//
#[no_mangle]
unsafe extern "C" fn rnpgbe_rm_adapter(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn rnpgbe_remove(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn rnpgbe_dev_shutdown(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn rnpgbe_shutdown(pdev: *mut pci_dev) {
