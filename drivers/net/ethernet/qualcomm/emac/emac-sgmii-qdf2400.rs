...
//! Source: drivers/net/ethernet/qualcomm/emac/emac-sgmii-qdf2400.c
#![no_std]
...
pub const EMAC_SGMII_LN_DRVR_CTRL1: c_uint = 0x0010;
...
pub const EMAC_SGMII_LN_PARALLEL_RATE: c_uint = 0x007C;
pub const EMAC_SGMII_LN_CML_CTRL_MODE0: c_uint = 0x00C0;
pub const EMAC_SGMII_LN_MIXER_CTRL_MODE0: c_uint = 0x00D8;
pub const EMAC_SGMII_LN_VGA_INITVAL: c_uint = 0x013C;
pub const EMAC_SGMII_LN_UCDR_FO_GAIN_MODE0: c_uint = 0x0184;
pub const EMAC_SGMII_LN_UCDR_SO_GAIN_MODE0: c_uint = 0x0190;
pub const EMAC_SGMII_LN_UCDR_SO_CONFIG: c_uint = 0x019C;
pub const EMAC_SGMII_LN_RX_BAND: c_uint = 0x01A4;
pub const EMAC_SGMII_LN_RX_RCVR_PATH1_MODE0: c_uint = 0x01C0;
pub const EMAC_SGMII_LN_RSM_CONFIG: c_uint = 0x01F8;
pub const EMAC_SGMII_LN_SIGDET_ENABLES: c_uint = 0x0230;
pub const EMAC_SGMII_LN_SIGDET_CNTRL: c_uint = 0x0234;
pub const EMAC_SGMII_LN_SIGDET_DEGLITCH_CNTRL: c_uint = 0x0238;
pub const EMAC_SGMII_LN_RX_EN_SIGNAL: c_uint = 0x02AC;
pub const EMAC_SGMII_LN_RX_MISC_CNTRL0: c_uint = 0x02B8;
pub const EMAC_SGMII_LN_DRVR_LOGIC_CLKDIV: c_uint = 0x02C8;
pub const EMAC_SGMII_LN_RX_RESECODE_OFFSET: c_uint = 0x02CC;
...
#[no_mangle]
pub unsafe extern "C" fn emac_sgmii_init_qdf2400(adpt: *mut emac_adapter) -> c_int {
