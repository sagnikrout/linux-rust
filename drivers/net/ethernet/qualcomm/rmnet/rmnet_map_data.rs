...
//! Source: drivers/net/ethernet/qualcomm/rmnet/rmnet_map_data.c
#![no_std]
...
pub const RMNET_MAP_DEAGGR_SPACING: c_int = 64;
...
// checksum computed over the pseudo header.
//
    ip_header_csum = ( __be16)ip_fast_csum(ip6h, sizeof(*ip6h) / 4);
...
#[no_mangle]
unsafe extern "C" fn rmnet_map_complement_ipv4_txporthdr_csum_field(ip4h: *mut iphdr) {
...
// csum = ~(*csum);
    ...
    let mut ip_len: u16 = ((struct iphdr *)iph).ihl * 4;
    proto = ((struct iphdr *)iph).protocol;
    trans = iph + ip_len;
    } else if (IS_ENABLED(CONFIG_IPV6) &&
    skb.protocol == htons(ETH_P_IPV6)) {
    let mut ip_len: u16 = sizeof(struct ipv6hdr);
...
#[no_mangle]
pub unsafe extern "C" fn rmnet_map_validate_packet_len(skb: *mut sk_buff, port: *mut rmnet_port) -> u32 {
    u32 rmnet_map_validate_packet_len(struct sk_buff *skb, struct rmnet_port *port)
    {
    struct rmnet_map_v5_csum_header *next_hdr = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn rmnet_map_checksum_downlink_packet(skb: *mut sk_buff, len: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reset_aggr_params(port: *mut rmnet_port) {
    static void reset_aggr_params(struct rmnet_port *port)
    {
    port.skbagg_head = core::ptr::null_mut();
    port.agg_count = 0;
    port.agg_state = 0;
    memset(&port.agg_time, 0, sizeof(struct timespec64));
    }
#[no_mangle]
unsafe extern "C" fn rmnet_send_skb(port: *mut rmnet_port, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn rmnet_map_flush_tx_packet_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rmnet_map_flush_tx_packet_queue(t: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
pub unsafe extern "C" fn rmnet_map_tx_aggregate_init(port: *mut rmnet_port) {
...
#[no_mangle]
pub unsafe extern "C" fn rmnet_map_tx_aggregate_exit(port: *mut rmnet_port) {
