...
//! Source: drivers/net/ethernet/amd/mvme147.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct m147lance_private {
    pub lance: lance_private,
    pub ram: c_ulong,
}
...
#[no_mangle]
unsafe extern "C" fn mvme147lance_probe() -> *mut net_device  __init {
...
#[no_mangle]
unsafe extern "C" fn m147lance_writerap(lp: *mut lance_private, value: c_ushort) {
    static void m147lance_writerap(struct lance_private *lp, unsigned short value)
    {
    out_be16(lp.base + LANCE_RAP, value);
    }
#[no_mangle]
unsafe extern "C" fn m147lance_writerdp(lp: *mut lance_private, value: c_ushort) {
    static void m147lance_writerdp(struct lance_private *lp, unsigned short value)
    {
    out_be16(lp.base + LANCE_RDP, value);
    }
#[no_mangle]
unsafe extern "C" fn m147lance_readrdp(lp: *mut lance_private) -> c_ushort {
    static unsigned short m147lance_readrdp(struct lance_private *lp)
    {
    return in_be16(lp.base + LANCE_RDP);
    }
#[no_mangle]
unsafe extern "C" fn m147lance_open(dev: *mut net_device) -> c_int {
    static int m147lance_open(struct net_device *dev)
    {
    int status;
...
#[no_mangle]
unsafe extern "C" fn m147lance_close(dev: *mut net_device) -> c_int {
    static int m147lance_close(struct net_device *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn m147lance_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn m147lance_exit() -> void __exit {
