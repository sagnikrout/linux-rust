...
//! Source: drivers/net/ethernet/amd/xgbe/xgbe-desc.c
#![no_std]
...
//
    ...
    ring.rdesc = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn xgbe_free_ring_resources(pdata: *mut xgbe_prv_data) {
    ...
    {
    void *mem;
    let mut cur_node: c_int = dev_to_node(dev);
...
#[no_mangle]
unsafe extern "C" fn xgbe_alloc_ring_resources(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_wrapper_tx_descriptor_init(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_wrapper_rx_descriptor_init(pdata: *mut xgbe_prv_data) {
    ...
    rdata.state_saved = 0;
    rdata.state.skb = core::ptr::null_mut();
    rdata.state.len = 0;
    rdata.state.error = 0;
    }
    }
#[no_mangle]
unsafe extern "C" fn xgbe_map_tx_skb(channel: *mut xgbe_channel, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_init_function_ptrs_desc(desc_if: *mut xgbe_desc_if) {
