...
//! Source: drivers/net/ethernet/amd/xgbe/xgbe-debugfs.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_debugfs_init(pdata: *mut xgbe_prv_data) {
...
// Set defaults
    ...
    if (!buf)
    return;
    pdata.xgbe_debugfs = debugfs_create_dir(buf, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_debugfs_exit(pdata: *mut xgbe_prv_data) {
    void xgbe_debugfs_exit(struct xgbe_prv_data *pdata)
    {
    debugfs_remove_recursive(pdata.xgbe_debugfs);
    pdata.xgbe_debugfs = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn xgbe_debugfs_rename(pdata: *mut xgbe_prv_data) {
