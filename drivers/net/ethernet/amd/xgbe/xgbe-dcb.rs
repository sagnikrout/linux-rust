...
//! Source: drivers/net/ethernet/amd/xgbe/xgbe-dcb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn xgbe_dcb_getdcbx(netdev: *mut net_device) -> u8 {
    static u8 xgbe_dcb_getdcbx(struct net_device *netdev)
    {
    return DCB_CAP_DCBX_HOST | DCB_CAP_DCBX_VER_IEEE;
    }
#[no_mangle]
unsafe extern "C" fn xgbe_dcb_setdcbx(netdev: *mut net_device, dcbx: u8) -> u8 {
    static u8 xgbe_dcb_setdcbx(struct net_device *netdev, u8 dcbx)
    {
    struct xgbe_prv_data *pdata = netdev_priv(netdev);
    let mut support: u8 = xgbe_dcb_getdcbx(netdev);
