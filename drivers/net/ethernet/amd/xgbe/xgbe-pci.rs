...
//! Source: drivers/net/ethernet/amd/xgbe/xgbe-pci.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_multi_msi(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_irqs(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_pci_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_pci_synchronize_irqs(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_pci_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_pci_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_pci_init() -> c_int {
    int xgbe_pci_init(void)
    {
    return pci_register_driver(&xgbe_driver);
    }
#[no_mangle]
pub unsafe extern "C" fn xgbe_pci_exit() {
