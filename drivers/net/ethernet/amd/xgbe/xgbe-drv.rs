...
//! Source: drivers/net/ethernet/amd/xgbe/xgbe-drv.c
#![no_std]
...
//
    ...
    let mut ecc_sec_info_threshold: static unsigned int = 10;
    let mut ecc_sec_warn_threshold: static unsigned int = 10000;
    let mut ecc_sec_period: static unsigned int = 600;
    let mut ecc_ded_threshold: static unsigned int = 2;
    let mut ecc_ded_period: static unsigned int = 600;
...
#[no_mangle]
unsafe extern "C" fn xgbe_free_channels(pdata: *mut xgbe_prv_data) {
    ...
    pdata.channel[i] = core::ptr::null_mut();
    }
    pdata.channel_count = 0;
    }
#[no_mangle]
unsafe extern "C" fn xgbe_alloc_channels(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_tx_avail_desc(ring: *mut xgbe_ring) -> c_uint {
    static inline unsigned int xgbe_tx_avail_desc(struct xgbe_ring *ring)
    {
    return (ring.rdesc_count - (ring.cur - ring.dirty));
    }
#[no_mangle]
pub unsafe extern "C" fn xgbe_rx_dirty_desc(ring: *mut xgbe_ring) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn xgbe_calc_rx_buf_size(netdev: *mut net_device, mtu: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: channel->tx_ring) -> else {
    else if (channel.tx_ring)
    int_id = XGMAC_INT_DMA_CH_SR_TI;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: channel->rx_ring) -> else {
...
#[no_mangle]
unsafe extern "C" fn xgbe_enable_rx_tx_ints(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_disable_rx_tx_ints(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_ecc_isr_bh_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_ecc_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xgbe_isr_bh_work(work: *mut work_struct) {
...
//
    ...
    for (i = 0; i < pdata.channel_count; i++) {
    let mut schedule_napi: bool = false;
...
#[no_mangle]
unsafe extern "C" fn xgbe_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xgbe_dma_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xgbe_tx_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_service(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_service_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_init_timers(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_start_timers(pdata: *mut xgbe_prv_data) {
    static void xgbe_start_timers(struct xgbe_prv_data *pdata)
    {
    mod_timer(&pdata.service_timer, jiffies + HZ);
    }
#[no_mangle]
unsafe extern "C" fn xgbe_stop_timers(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_get_all_hw_features(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_napi_enable(pdata: *mut xgbe_prv_data, add: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_napi_disable(pdata: *mut xgbe_prv_data, del: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_request_irqs(pdata: *mut xgbe_prv_data) -> c_int {
...
// Using an unsigned int, 'i' will go to UINT_MAX and exit
    ...
    channel = pdata.channel[i];
    irq_set_affinity_hint(channel.dma_irq, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn xgbe_free_irqs(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_init_tx_coalesce(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_init_rx_coalesce(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_free_tx_data(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_free_rx_data(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_powerdown(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_powerup(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_free_memory(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_alloc_memory(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_start(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_stop(pdata: *mut xgbe_prv_data) {
    ...
    xgbe_stop_timers(pdata);
    flush_workqueue(pdata.dev_workqueue);
    xgbe_vxlan_unset_port(netdev, 0, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn xgbe_stopdev(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_full_restart_dev(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_restart_dev(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_restart(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_prep_vlan(skb: *mut sk_buff, packet: *mut xgbe_packet_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_prep_tso(skb: *mut sk_buff, packet: *mut xgbe_packet_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_is_vxlan(skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgbe_is_tso(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_xmit(skb: *mut sk_buff, netdev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn xgbe_set_rx_mode(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_set_mac_address(netdev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_change_mtu(netdev: *mut net_device, mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_poll_controller(netdev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(rxhash: !(features & NETIF_F_RXHASH) &&) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(rxvlan: !(features & NETIF_F_HW_VLAN_CTAG_RX) &&) -> else {
    else if (!(features & NETIF_F_HW_VLAN_CTAG_RX) && rxvlan)
    hw_if.disable_rx_vlan_stripping(pdata);
    if ((features & NETIF_F_HW_VLAN_CTAG_FILTER) && !rxvlan_filter)
    hw_if.enable_rx_vlan_filtering(pdata);
#[no_mangle]
pub unsafe extern "C" fn if(rxvlan_filter: !(features & NETIF_F_HW_VLAN_CTAG_FILTER) &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn xgbe_rx_refresh(channel: *mut xgbe_channel) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_tx_poll(channel: *mut xgbe_channel) -> c_int {
    ...
    int force_cleanup;
    let mut tx_packets: c_uint = 0, tx_bytes = 0;
    unsigned int cur;
    DBGPR("-.xgbe_tx_poll\n");
...
#[no_mangle]
unsafe extern "C" fn xgbe_rx_poll(channel: *mut xgbe_channel, budget: c_int) -> c_int {
...
//
    ...
    buf2_len,
    rdata.rx.buf.dma_len);
    rdata.rx.buf.pa.pages = core::ptr::null_mut();
    }
    }
    skip_data:
...
#[no_mangle]
unsafe extern "C" fn xgbe_one_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_all_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_print_pkt(netdev: *mut net_device, skb: *mut sk_buff, tx_rx: bool) {
    ...
    let mut len: c_uint = min(skb.len - i, 32U);
