...
//! Source: drivers/net/ethernet/amd/xgbe/xgbe-hwtstamp.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_get_tstamp_time(pdata: *mut xgbe_prv_data) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_get_tx_tstamp(pdata: *mut xgbe_prv_data) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_config_tstamp(pdata: *mut xgbe_prv_data, mac_tscr: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_tx_tstamp(work: *mut work_struct) {
    ...
    pdata.tx_tstamp_skb = core::ptr::null_mut();
    unlock:
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_init_ptp(pdata: *mut xgbe_prv_data) -> c_int {
