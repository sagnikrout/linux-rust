...
//! Source: drivers/net/ethernet/amd/xgbe/xgbe-dev.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_get_max_frame(pdata: *mut xgbe_prv_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_pbl_val(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_osp_mode(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_rsf_mode(pdata: *mut xgbe_prv_data, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_tsf_mode(pdata: *mut xgbe_prv_data, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_rx_coalesce(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_tx_coalesce(pdata: *mut xgbe_prv_data) -> c_int {
    static int xgbe_config_tx_coalesce(struct xgbe_prv_data *pdata)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn xgbe_config_rx_buffer_size(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_tso_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_sph_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_disable_sph_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_write_rss_hash_key(pdata: *mut xgbe_prv_data) -> c_int {
    static int xgbe_write_rss_hash_key(struct xgbe_prv_data *pdata)
    {
    let mut key_regs: c_uint = sizeof(pdata.rss_key) / sizeof(u32);
...
#[no_mangle]
unsafe extern "C" fn xgbe_write_rss_lookup_table(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_set_rss_hash_key(pdata: *mut xgbe_prv_data, key: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_enable_rss(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_disable_rss(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_rss(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_set_vxlan_id(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_enable_vxlan(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_disable_vxlan(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_get_fc_queue_count(pdata: *mut xgbe_prv_data) -> c_uint {
    static unsigned int xgbe_get_fc_queue_count(struct xgbe_prv_data *pdata)
    {
    let mut max_q_count: c_uint = XGMAC_MAX_FLOW_CONTROL_QUEUES;
...
#[no_mangle]
unsafe extern "C" fn xgbe_disable_tx_flow_control(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_enable_tx_flow_control(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_disable_rx_flow_control(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_enable_rx_flow_control(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_tx_flow_control(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_rx_flow_control(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_flow_control(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_enable_dma_interrupts(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_enable_mtl_interrupts(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_enable_mac_interrupts(pdata: *mut xgbe_prv_data) {
    static void xgbe_enable_mac_interrupts(struct xgbe_prv_data *pdata)
    {
    let mut mac_ier: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn xgbe_enable_ecc_interrupts(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_disable_ecc_ded(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_set_speed(pdata: *mut xgbe_prv_data, speed: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_enable_rx_vlan_stripping(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_disable_rx_vlan_stripping(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_enable_rx_vlan_filtering(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_disable_rx_vlan_filtering(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_vid_crc32_le(vid_le: __le16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn xgbe_update_vlan_hash_table(pdata: *mut xgbe_prv_data) -> c_int {
    static int xgbe_update_vlan_hash_table(struct xgbe_prv_data *pdata)
    {
    u32 crc;
    u16 vid;
    __le16 vid_le;
    let mut vlan_hash_table: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn xgbe_set_mac_addn_addrs(pdata: *mut xgbe_prv_data) {
...
// Clear remaining additional MAC address entries
    while (addn_macs--)
    xgbe_set_mac_reg(pdata, core::ptr::null_mut(), &mac_reg);
    }
#[no_mangle]
unsafe extern "C" fn xgbe_set_mac_hash_table(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_add_mac_addresses(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_set_mac_address(pdata: *mut xgbe_prv_data, addr: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_rx_mode(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_clr_gpio(pdata: *mut xgbe_prv_data, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_set_gpio(pdata: *mut xgbe_prv_data, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_create_mdio_sca_c22(port: c_int, reg: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn xgbe_create_mdio_sca_c45(port: c_int, da: c_uint, reg: c_int) -> c_uint {
    ...
    {
    let mut reg_val: c_uint = XGMAC_IOREAD(pdata, MAC_MDIOCL22R);
    switch (mode) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_tx_complete(rdesc: *mut xgbe_ring_desc) -> c_int {
    static int xgbe_tx_complete(struct xgbe_ring_desc *rdesc)
    {
    return !XGMAC_GET_BITS_LE(rdesc.desc3, TX_NORMAL_DESC3, OWN);
    }
#[no_mangle]
unsafe extern "C" fn xgbe_disable_rx_csum(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_enable_rx_csum(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_tx_desc_reset(rdata: *mut xgbe_ring_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_tx_desc_init(channel: *mut xgbe_channel) {
    static void xgbe_tx_desc_init(struct xgbe_channel *channel)
    {
    struct xgbe_ring *ring = channel.tx_ring;
    struct xgbe_ring_data *rdata;
    int i;
    let mut start_index: c_int = ring.cur;
    DBGPR("-.tx_desc_init\n");
...
// Update the starting address of descriptor ring
    ...
    {
    struct xgbe_ring_desc *rdesc = rdata.rdesc;
    let mut rx_usecs: c_uint = pdata.rx_usecs;
    let mut rx_frames: c_uint = pdata.rx_frames;
    unsigned int inte;
...
#[no_mangle]
unsafe extern "C" fn xgbe_rx_desc_init(channel: *mut xgbe_channel) {
    static void xgbe_rx_desc_init(struct xgbe_channel *channel)
    {
    struct xgbe_prv_data *pdata = channel.pdata;
    struct xgbe_ring *ring = channel.rx_ring;
    struct xgbe_ring_data *rdata;
    let mut start_index: c_uint = ring.cur;
    unsigned int i;
    DBGPR("-.rx_desc_init\n");
...
#[no_mangle]
unsafe extern "C" fn xgbe_dev_xmit(channel: *mut xgbe_channel) {
    ...
    let mut start_index: c_int = ring.cur;
    let mut cur_index: c_int = ring.cur;
    int i;
    DBGPR("-.xgbe_dev_xmit\n");
...
//
    ...
    tx_set_ic = 0;
#[no_mangle]
pub unsafe extern "C" fn if(pdata->tx_frames: tx_packets >) -> else {
    else if (tx_packets > pdata.tx_frames)
    tx_set_ic = 1;
#[no_mangle]
pub unsafe extern "C" fn if(tx_packets: (ring->coalesce_count % pdata->tx_frames) <) -> else {
...
#[no_mangle]
unsafe extern "C" fn xgbe_dev_read(channel: *mut xgbe_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_is_context_desc(rdesc: *mut xgbe_ring_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_is_last_desc(rdesc: *mut xgbe_ring_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __xgbe_exit(pdata: *mut xgbe_prv_data) -> c_int {
    static int __xgbe_exit(struct xgbe_prv_data *pdata)
    {
    let mut count: c_uint = 2000;
    DBGPR("-.xgbe_exit\n");
...
#[no_mangle]
unsafe extern "C" fn xgbe_exit(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_flush_tx_queues(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_dma_bus(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_dma_cache(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_mtl_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_flow_control_threshold(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_get_tx_fifo_size(pdata: *mut xgbe_prv_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn xgbe_get_rx_fifo_size(pdata: *mut xgbe_prv_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn xgbe_get_pfc_delay(pdata: *mut xgbe_prv_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn xgbe_get_pfc_queues(pdata: *mut xgbe_prv_data) -> c_uint {
...
//
    ...
    if (rem_fifo) {
    let mut inc_fifo: c_uint = rem_fifo / prio_queues;
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_tx_fifo_size(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_rx_fifo_size(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_queue_mapping(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_tc(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_dcb_tc(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_dcb_pfc(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_mac_address(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_jumbo_enable(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_mac_speed(pdata: *mut xgbe_prv_data) {
    static void xgbe_config_mac_speed(struct xgbe_prv_data *pdata)
    {
    xgbe_set_speed(pdata, pdata.phy_speed);
    }
#[no_mangle]
unsafe extern "C" fn xgbe_config_checksum_offload(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_vlan_support(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_mmc_read(pdata: *mut xgbe_prv_data, reg_lo: c_uint) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn xgbe_tx_mmc_int(pdata: *mut xgbe_prv_data) {
    static void xgbe_tx_mmc_int(struct xgbe_prv_data *pdata)
    {
    struct xgbe_mmc_stats *stats = &pdata.mmc_stats;
    let mut mmc_isr: c_uint = XGMAC_IOREAD(pdata, MMC_TISR);
...
#[no_mangle]
unsafe extern "C" fn xgbe_rx_mmc_int(pdata: *mut xgbe_prv_data) {
    static void xgbe_rx_mmc_int(struct xgbe_prv_data *pdata)
    {
    struct xgbe_mmc_stats *stats = &pdata.mmc_stats;
    let mut mmc_isr: c_uint = XGMAC_IOREAD(pdata, MMC_RISR);
...
#[no_mangle]
unsafe extern "C" fn xgbe_read_mmc_stats(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_config_mmc(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_enable_tx(pdata: *mut xgbe_prv_data) {
...
//
#[no_mangle]
unsafe extern "C" fn xgbe_wait_for_dma_tx_complete(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_disable_tx(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_enable_rx(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_disable_rx(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_powerup_tx(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_powerdown_tx(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_powerup_rx(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_powerdown_rx(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_init(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_init_function_ptrs_dev(hw_if: *mut xgbe_hw_if) {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_enable_mac_loopback(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_disable_mac_loopback(pdata: *mut xgbe_prv_data) {
