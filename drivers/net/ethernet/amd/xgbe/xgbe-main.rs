...
//! Source: drivers/net/ethernet/amd/xgbe/xgbe-main.c
#![no_std]
...
//
    ...
    NETIF_MSG_IFUP);
#[no_mangle]
unsafe extern "C" fn xgbe_default_config(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_init_all_fptrs(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_free_pdata(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_set_counts(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_config_netdev(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_deconfig_netdev(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_mod_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn xgbe_mod_exit() -> void __exit {
