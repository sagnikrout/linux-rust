...
//! Source: drivers/net/ethernet/amd/xgbe/xgbe-ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn xgbe_get_strings(netdev: *mut net_device, stringset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_get_sset_count(netdev: *mut net_device, stringset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn xgbe_set_msglevel(netdev: *mut net_device, msglevel: u32) {
    ...
    let mut jiffy_us: c_uint = jiffies_to_usecs(1);
...
#[no_mangle]
unsafe extern "C" fn xgbe_get_rx_ring_count(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn xgbe_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn xgbe_get_rxfh_indir_size(netdev: *mut net_device) -> u32 {
