...
//! Source: drivers/net/ethernet/amd/xgbe/xgbe-platform.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn xgbe_acpi_support(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_of_support(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_platform_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_platform_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_platform_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_platform_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_platform_init() -> c_int {
    int xgbe_platform_init(void)
    {
    return platform_driver_register(&xgbe_driver);
    }
#[no_mangle]
pub unsafe extern "C" fn xgbe_platform_exit() {
