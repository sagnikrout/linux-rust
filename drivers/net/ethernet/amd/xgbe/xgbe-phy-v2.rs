...
//! Source: drivers/net/ethernet/amd/xgbe/xgbe-phy-v2.c
#![no_std]
...
pub const XGBE_MUTEX_RELEASE: c_uint = 0x80000000;
pub const XGBE_SFP_DIRECT: c_int = 7;
// I2C target addresses
pub const XGBE_SFP_SERIAL_ID_ADDRESS: c_uint = 0x50;
pub const XGBE_SFP_DIAG_INFO_ADDRESS: c_uint = 0x51;
pub const XGBE_SFP_PHY_ADDRESS: c_uint = 0x56;
pub const XGBE_GPIO_ADDRESS_PCA9555: c_uint = 0x20;
// SFP sideband signal indicators

// Rate-change complete wait/retry count
pub const XGBE_RATECHANGE_COUNT: c_int = 500;
// CDR delay values for KR support (in usec)
pub const XGBE_CDR_DELAY_INIT: c_int = 10000;
pub const XGBE_CDR_DELAY_INC: c_int = 10000;
pub const XGBE_CDR_DELAY_MAX: c_int = 100000;
// RRC frequency during link status check
pub const XGBE_RRC_FREQUENCY: c_int = 10;
    enum xgbe_port_mode {
...
pub const XGBE_SFP_BASE_ID: c_int = 0;
pub const XGBE_SFP_ID_SFP: c_uint = 0x03;
pub const XGBE_SFP_BASE_EXT_ID: c_int = 1;
pub const XGBE_SFP_EXT_ID_SFP: c_uint = 0x04;
pub const XGBE_SFP_BASE_10GBE_CC: c_int = 3;

pub const XGBE_SFP_BASE_1GBE_CC: c_int = 6;

pub const XGBE_SFP_BASE_CABLE: c_int = 8;

pub const XGBE_SFP_BASE_BR: c_int = 12;
pub const XGBE_SFP_BASE_BR_1GBE_MIN: c_uint = 0x0a;
pub const XGBE_SFP_BASE_BR_10GBE_MIN: c_uint = 0x64;
pub const XGBE_SFP_BASE_CU_CABLE_LEN: c_int = 18;
pub const XGBE_SFP_BASE_VENDOR_NAME: c_int = 20;
pub const XGBE_SFP_BASE_VENDOR_NAME_LEN: c_int = 16;
pub const XGBE_SFP_BASE_VENDOR_PN: c_int = 40;
pub const XGBE_SFP_BASE_VENDOR_PN_LEN: c_int = 16;
pub const XGBE_SFP_BASE_VENDOR_REV: c_int = 56;
pub const XGBE_SFP_BASE_VENDOR_REV_LEN: c_int = 4;
pub const XGBE_SFP_BASE_CC: c_int = 63;
// SFP Serial ID Extended ID values relative to an offset of 64
pub const XGBE_SFP_BASE_VENDOR_SN: c_int = 4;
pub const XGBE_SFP_BASE_VENDOR_SN_LEN: c_int = 16;
pub const XGBE_SFP_EXTD_OPT1: c_int = 1;

pub const XGBE_SFP_EXTD_DIAG: c_int = 28;

pub const XGBE_SFP_EXTD_SFF_8472: c_int = 30;
pub const XGBE_SFP_EXTD_CC: c_int = 31;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgbe_sfp_eeprom {
    pub base: [u8; 64],
    pub extd: [u8; 32],
    pub vendor: [u8; 32],
}
...
pub const XGBE_SFP_EEPROM_BASE_LEN: c_int = 256;
pub const XGBE_SFP_EEPROM_DIAG_LEN: c_int = 256;

    XGBE_SFP_EEPROM_DIAG_LEN)

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgbe_sfp_ascii {
    union {
    pub 1]: char vendor[XGBE_SFP_BASE_VENDOR_NAME_LEN +,
    pub 1]: char partno[XGBE_SFP_BASE_VENDOR_PN_LEN +,
    pub 1]: char rev[XGBE_SFP_BASE_VENDOR_REV_LEN +,
    pub 1]: char serno[XGBE_SFP_BASE_VENDOR_SN_LEN +,
    pub u: },
}
...
pub const XGBE_PHY_REDRV_MODE_REG: c_uint = 0x12b0;
// PHY related configuration information
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgbe_phy_data {
    pub port_mode: enum xgbe_port_mode,
    pub port_id: c_uint,
    pub port_speeds: c_uint,
    pub conn_type: enum xgbe_conn_type,
    pub cur_mode: enum xgbe_mode,
    pub start_mode: enum xgbe_mode,
    pub rrc_count: c_uint,
    pub mdio_addr: c_uint,
// SFP Support
    pub sfp_comm: enum xgbe_sfp_comm,
    pub sfp_mux_address: c_uint,
    pub sfp_mux_channel: c_uint,
    pub sfp_gpio_address: c_uint,
    pub sfp_gpio_mask: c_uint,
    pub sfp_gpio_inputs: c_uint,
    pub sfp_gpio_rx_los: c_uint,
    pub sfp_gpio_tx_fault: c_uint,
    pub sfp_gpio_mod_absent: c_uint,
    pub sfp_gpio_rate_select: c_uint,
    pub sfp_rx_los: c_uint,
    pub sfp_tx_fault: c_uint,
    pub sfp_mod_absent: c_uint,
    pub sfp_changed: c_uint,
    pub sfp_phy_avail: c_uint,
    pub sfp_cable_len: c_uint,
    pub sfp_base: enum xgbe_sfp_base,
    pub sfp_cable: enum xgbe_sfp_cable,
    pub sfp_speed: enum xgbe_sfp_speed,
    pub sfp_eeprom: xgbe_sfp_eeprom,
// External PHY support
    pub phydev_mode: enum xgbe_mdio_mode,
    pub mii: *mut mii_bus,
    pub phydev: *mut phy_device,
    pub mdio_reset: enum xgbe_mdio_reset,
    pub mdio_reset_addr: c_uint,
    pub mdio_reset_gpio: c_uint,
// Re-driver support
    pub redrv: c_uint,
    pub redrv_if: c_uint,
    pub redrv_addr: c_uint,
    pub redrv_lane: c_uint,
    pub redrv_model: c_uint,
// KR AN support
    pub phy_cdr_notrack: c_uint,
    pub phy_cdr_delay: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfp_put_mux(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfp_get_mux(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_put_comm_ownership(pdata: *mut xgbe_prv_data) {
    static void xgbe_phy_put_comm_ownership(struct xgbe_prv_data *pdata)
    {
    mutex_unlock(&xgbe_phy_comm_lock);
    }
#[no_mangle]
unsafe extern "C" fn xgbe_phy_get_comm_ownership(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_i2c_mii_write(pdata: *mut xgbe_prv_data, reg: c_int, val: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(XGBE_CONN_TYPE_MDIO: phy_data->conn_type &) -> else {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_i2c_mii_read(pdata: *mut xgbe_prv_data, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_mii_read_c22(mii: *mut mii_bus, addr: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfp_phy_settings(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_free_phy_device(pdata: *mut xgbe_prv_data) {
    ...
    phy_data.phydev = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn xgbe_phy_finisar_phy_quirks(pdata: *mut xgbe_prv_data) -> bool {
    static bool xgbe_phy_finisar_phy_quirks(struct xgbe_prv_data *pdata)
    {
    struct xgbe_phy_data *phy_data = pdata.phy_data;
    let mut phy_id: c_uint = phy_data.phydev.phy_id;
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_belfuse_phy_quirks(pdata: *mut xgbe_prv_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_external_phy_quirks(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_find_phy_device(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfp_external_phy(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_check_sfp_rx_los(phy_data: *mut xgbe_phy_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_check_sfp_tx_fault(phy_data: *mut xgbe_phy_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_check_sfp_mod_absent(phy_data: *mut xgbe_phy_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfp_parse_eeprom(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
pub unsafe extern "C" fn if(XGBE_SFP_BASE_10GBE_CC_SR: sfp_base[XGBE_SFP_BASE_10GBE_CC] &) -> else {
    else if (sfp_base[XGBE_SFP_BASE_10GBE_CC] & XGBE_SFP_BASE_10GBE_CC_SR)
    phy_data.sfp_base = XGBE_SFP_BASE_10000_SR;
#[no_mangle]
pub unsafe extern "C" fn if(XGBE_SFP_BASE_10GBE_CC_LR: sfp_base[XGBE_SFP_BASE_10GBE_CC] &) -> else {
    else if (sfp_base[XGBE_SFP_BASE_10GBE_CC] & XGBE_SFP_BASE_10GBE_CC_LR)
    phy_data.sfp_base = XGBE_SFP_BASE_10000_LR;
#[no_mangle]
pub unsafe extern "C" fn if(XGBE_SFP_BASE_10GBE_CC_LRM: sfp_base[XGBE_SFP_BASE_10GBE_CC] &) -> else {
    else if (sfp_base[XGBE_SFP_BASE_10GBE_CC] & XGBE_SFP_BASE_10GBE_CC_LRM)
    phy_data.sfp_base = XGBE_SFP_BASE_10000_LRM;
#[no_mangle]
pub unsafe extern "C" fn if(XGBE_SFP_BASE_10GBE_CC_ER: sfp_base[XGBE_SFP_BASE_10GBE_CC] &) -> else {
    else if (sfp_base[XGBE_SFP_BASE_10GBE_CC] & XGBE_SFP_BASE_10GBE_CC_ER)
    phy_data.sfp_base = XGBE_SFP_BASE_10000_ER;
#[no_mangle]
pub unsafe extern "C" fn if(XGBE_SFP_BASE_1GBE_CC_SX: sfp_base[XGBE_SFP_BASE_1GBE_CC] &) -> else {
    else if (sfp_base[XGBE_SFP_BASE_1GBE_CC] & XGBE_SFP_BASE_1GBE_CC_SX)
    phy_data.sfp_base = XGBE_SFP_BASE_1000_SX;
#[no_mangle]
pub unsafe extern "C" fn if(XGBE_SFP_BASE_1GBE_CC_LX: sfp_base[XGBE_SFP_BASE_1GBE_CC] &) -> else {
    else if (sfp_base[XGBE_SFP_BASE_1GBE_CC] & XGBE_SFP_BASE_1GBE_CC_LX)
    phy_data.sfp_base = XGBE_SFP_BASE_1000_LX;
#[no_mangle]
pub unsafe extern "C" fn if(XGBE_SFP_BASE_1GBE_CC_CX: sfp_base[XGBE_SFP_BASE_1GBE_CC] &) -> else {
    else if (sfp_base[XGBE_SFP_BASE_1GBE_CC] & XGBE_SFP_BASE_1GBE_CC_CX)
    phy_data.sfp_base = XGBE_SFP_BASE_1000_CX;
#[no_mangle]
pub unsafe extern "C" fn if(XGBE_SFP_BASE_1GBE_CC_T: sfp_base[XGBE_SFP_BASE_1GBE_CC] &) -> else {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfp_verify_eeprom(cc_in: u8, buf: *mut u8, len: c_uint) -> bool {
    static bool xgbe_phy_sfp_verify_eeprom(u8 cc_in, u8 *buf, unsigned int len)
    {
    u8 cc;
    for (cc = 0; len; buf++, len--)
    cc += *buf;
    let mut cc: return = = cc_in;
    }
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfp_read_eeprom(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfp_signals(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfp_mod_absent(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfp_reset(phy_data: *mut xgbe_phy_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfp_detect(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_phydev_flowctrl(pdata: *mut xgbe_prv_data) {
    static void xgbe_phy_phydev_flowctrl(struct xgbe_prv_data *pdata)
    {
    struct ethtool_link_ksettings *lks = &pdata.phy.lks;
    struct xgbe_phy_data *phy_data = pdata.phy_data;
    let mut lcl_adv: u16 = 0, rmt_adv = 0;
    u8 fc;
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_an37_sgmii_outcome(pdata: *mut xgbe_prv_data) -> enum xgbe_mode {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_an37_outcome(pdata: *mut xgbe_prv_data) -> enum xgbe_mode {
...
// Set flow control based on auto-negotiation result
    ...
    pdata.phy.rx_pause = 1;
#[no_mangle]
pub unsafe extern "C" fn if(0x100: lp_reg &) -> else {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_an73_redrv_outcome(pdata: *mut xgbe_prv_data) -> enum xgbe_mode {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_an73_outcome(pdata: *mut xgbe_prv_data) -> enum xgbe_mode {
...
// Compare Advertisement and Link Partner register 2
    ...
    mode = XGBE_MODE_KR;
#[no_mangle]
pub unsafe extern "C" fn if(0x20: ad_reg &) -> else {
    else if (ad_reg & 0x20)
    mode = XGBE_MODE_KX_1000;
    else
    mode = XGBE_MODE_UNKNOWN;
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_an_sfp_mode(phy_data: *mut xgbe_phy_data) -> enum xgbe_an_mode {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_set_redrv_mode(pdata: *mut xgbe_prv_data) {
...
pub const MAX_RX_ADAPT_RETRIES: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn xgbe_rx_adaptation(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_rx_adaptation(pdata: *mut xgbe_prv_data) {
...
//
#[no_mangle]
unsafe extern "C" fn xgbe_phy_stop_data_path(pdata: *mut xgbe_prv_data) {
...
//
#[no_mangle]
unsafe extern "C" fn xgbe_phy_start_data_path(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_rx_reset(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_pll_ctrl(pdata: *mut xgbe_prv_data, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_rrc(pdata: *mut xgbe_prv_data) {
    static void xgbe_phy_rrc(struct xgbe_prv_data *pdata)
    {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_power_off(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn enable_rx_adap(pdata: *mut xgbe_prv_data, mode: enum xgbe_mode) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfi_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
pub unsafe extern "C" fn if(3: phy_data->sfp_cable_len <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_x_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sgmii_1000_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sgmii_100_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sgmii_10_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_switch_baset_mode(pdata: *mut xgbe_prv_data) -> enum xgbe_mode {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_switch_bp_2500_mode(pdata: *mut xgbe_prv_data) -> enum xgbe_mode {
    static enum xgbe_mode xgbe_phy_switch_bp_2500_mode(struct xgbe_prv_data *pdata)
    {
    return XGBE_MODE_KX_2500;
    }
#[no_mangle]
unsafe extern "C" fn xgbe_phy_switch_bp_mode(pdata: *mut xgbe_prv_data) -> enum xgbe_mode {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_get_bp_2500_mode(speed: c_int) -> enum xgbe_mode {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_get_bp_mode(speed: c_int) -> enum xgbe_mode {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_valid_speed_bp_2500_mode(speed: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_valid_speed_bp_mode(speed: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfp_gpio_setup(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfp_comm_setup(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_sfp_setup(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_int_mdio_reset(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_i2c_mdio_reset(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_mdio_reset(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(XGBE_MDIO_RESET_INT_GPIO: phy_data->mdio_reset ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_redrv_error(phy_data: *mut xgbe_phy_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_mdio_reset_setup(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_port_mode_mismatch(pdata: *mut xgbe_prv_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_conn_type_mismatch(pdata: *mut xgbe_prv_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_port_enabled(pdata: *mut xgbe_prv_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_cdr_track(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_cdr_notrack(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_an_post(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_an_pre(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_init_function_ptrs_phy_v2(phy_if: *mut xgbe_phy_if) {
