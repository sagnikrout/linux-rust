...
//! Source: drivers/net/ethernet/amd/xgbe/xgbe-mdio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn xgbe_an37_clear_interrupts(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an37_disable_interrupts(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an37_enable_interrupts(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an73_clear_interrupts(pdata: *mut xgbe_prv_data) {
    static void xgbe_an73_clear_interrupts(struct xgbe_prv_data *pdata)
    {
    XMDIO_WRITE(pdata, MDIO_MMD_AN, MDIO_AN_INT, 0);
    }
#[no_mangle]
unsafe extern "C" fn xgbe_an73_disable_interrupts(pdata: *mut xgbe_prv_data) {
    static void xgbe_an73_disable_interrupts(struct xgbe_prv_data *pdata)
    {
    XMDIO_WRITE(pdata, MDIO_MMD_AN, MDIO_AN_INTMASK, 0);
    }
#[no_mangle]
unsafe extern "C" fn xgbe_an73_enable_interrupts(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an_enable_interrupts(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an_clear_interrupts_all(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_kr_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_kx_2500_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_kx_1000_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_sfi_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_x_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_sgmii_1000_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_sgmii_10_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_sgmii_100_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_cur_mode(pdata: *mut xgbe_prv_data) -> enum xgbe_mode {
    static enum xgbe_mode xgbe_cur_mode(struct xgbe_prv_data *pdata)
    {
    return pdata.phy_if.phy_impl.cur_mode(pdata);
    }
#[no_mangle]
unsafe extern "C" fn xgbe_in_kr_mode(pdata: *mut xgbe_prv_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgbe_switch_mode(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an37_restart(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an37_disable(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an73_restart(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an73_disable(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an_restart(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an_disable(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an_disable_all(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an73_page_received(pdata: *mut xgbe_prv_data) -> enum xgbe_an {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an73_incompat_link(pdata: *mut xgbe_prv_data) -> enum xgbe_an {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an37_isr(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an73_isr(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an_isr_bh_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an_combined_isr(pdata: *mut xgbe_prv_data) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an_irq_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an37_state_machine(pdata: *mut xgbe_prv_data) {
    static void xgbe_an37_state_machine(struct xgbe_prv_data *pdata)
    {
    let mut cur_state: enum xgbe_an = pdata.an_state;
    if (!pdata.an_int)
    return;
...
#[no_mangle]
unsafe extern "C" fn xgbe_an73_state_machine(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an_state_machine(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an37_init(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an73_init(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_an_init(pdata: *mut xgbe_prv_data) {
...
// Set up advertisement registers based on current settings
    ...
    return "rx/tx";
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pdata->rx_pause) -> else {
    else if (pdata.rx_pause)
    return "rx";
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pdata->tx_pause) -> else {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_print_status(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_adjust_link(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_config_fixed(pdata: *mut xgbe_prv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __xgbe_phy_config_aneg(pdata: *mut xgbe_prv_data, set_mode: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_config_aneg(pdata: *mut xgbe_prv_data) -> c_int {
    static int xgbe_phy_config_aneg(struct xgbe_prv_data *pdata)
    {
    return __xgbe_phy_config_aneg(pdata, true);
    }
#[no_mangle]
unsafe extern "C" fn xgbe_phy_reconfig_aneg(pdata: *mut xgbe_prv_data) -> c_int {
    static int xgbe_phy_reconfig_aneg(struct xgbe_prv_data *pdata)
    {
    return __xgbe_phy_config_aneg(pdata, false);
    }
#[no_mangle]
unsafe extern "C" fn xgbe_phy_aneg_done(pdata: *mut xgbe_prv_data) -> bool {
    static bool xgbe_phy_aneg_done(struct xgbe_prv_data *pdata)
    {
    return (pdata.an_result == XGBE_AN_COMPLETE);
    }
#[no_mangle]
unsafe extern "C" fn xgbe_check_link_timeout(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_status_aneg(pdata: *mut xgbe_prv_data) -> enum xgbe_mode {
    static enum xgbe_mode xgbe_phy_status_aneg(struct xgbe_prv_data *pdata)
    {
    return pdata.phy_if.phy_impl.an_outcome(pdata);
    }
#[no_mangle]
unsafe extern "C" fn xgbe_phy_status_result(pdata: *mut xgbe_prv_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_status(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_dump_phy_registers(pdata: *mut xgbe_prv_data) {
...
#[no_mangle]
unsafe extern "C" fn xgbe_phy_best_advertised_speed(pdata: *mut xgbe_prv_data) -> c_int {
    ...
    return SPEED_10000;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: XGBE_ADV(lks, _arg: 10000baseT_Full)) -> else {
    else if (XGBE_ADV(lks, 10000baseT_Full))
    return SPEED_10000;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: XGBE_ADV(lks, _arg: 2500baseX_Full)) -> else {
    else if (XGBE_ADV(lks, 2500baseX_Full))
    return SPEED_2500;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: XGBE_ADV(lks, _arg: 2500baseT_Full)) -> else {
    else if (XGBE_ADV(lks, 2500baseT_Full))
    return SPEED_2500;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: XGBE_ADV(lks, _arg: 1000baseKX_Full)) -> else {
    else if (XGBE_ADV(lks, 1000baseKX_Full))
    return SPEED_1000;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: XGBE_ADV(lks, _arg: 1000baseT_Full)) -> else {
    else if (XGBE_ADV(lks, 1000baseT_Full))
    return SPEED_1000;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: XGBE_ADV(lks, _arg: 100baseT_Full)) -> else {
    else if (XGBE_ADV(lks, 100baseT_Full))
    return SPEED_100;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: XGBE_ADV(lks, _arg: 10baseT_Full)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn xgbe_init_function_ptrs_phy(phy_if: *mut xgbe_phy_if) {
