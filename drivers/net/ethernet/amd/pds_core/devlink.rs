...
//! Source: drivers/net/ethernet/amd/pds_core/devlink.c
#![no_std]
...
// Copyright(c) 2023 Advanced Micro Devices, Inc
    ...
    let mut flags: u16 = le16_to_cpu(info.flags);
...
#[no_mangle]
unsafe extern "C" fn pdsc_dl_report_fw_ver(req: *mut devlink_info_req, fw_ver: *mut c_char) -> c_int {
...
//
    ...
    let mut fw_list: pds_core_fw_list_info = {};
    struct pdsc *pdsc = devlink_priv(dl);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !pdsc_is_fw_good(pdsc)) -> else {
