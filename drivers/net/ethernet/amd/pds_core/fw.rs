...
//! Source: drivers/net/ethernet/amd/pds_core/fw.c
#![no_std]
...
pub const PDSC_FW_SELECT_TIMEOUT: c_int = 30;
// Number of periodic log updates during fw file download
pub const PDSC_FW_INTERVAL_FRACTION: c_int = 32;
...
//
    ...
    [PDS_CORE_FW_TYPE_MAIN]      = core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn pdsc_fw_components_invalidate(pdsc: *mut pdsc) {
...
#[no_mangle]
unsafe extern "C" fn pdsc_name_to_fw_type(name: *const c_char) -> u8 {
...
// "fw" without suffix maps to main firmware
    ...
    let mut comp: union pds_core_dev_comp = {};
    return pdsc_devcmd_locked(pdsc, &cmd, &comp, pdsc.devcmd_timeout);
    }
#[no_mangle]
unsafe extern "C" fn pdsc_devcmd_fw_install(pdsc: *mut pdsc) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pdsc_component_priv {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pds_core_fwu_priv {
    pub context: pldmfw,
    pub params: *mut devlink_flash_update_params,
...
#[no_mangle]
unsafe extern "C" fn pdsc_free_fwu_priv(priv: *mut pds_core_fwu_priv) {
...
#[no_mangle]
unsafe extern "C" fn pdsc_component_type_exists(pdsc: *mut pdsc, type: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pdsc_get_component_type_by_id(pdsc: *mut pdsc, component_id: u16) -> u8 {
    ...
    struct device *dev = context.dev;
    let mut comp: union pds_core_dev_comp = {};
    let mut cmd: union pds_core_dev_cmd = {};
    struct pdsc *pdsc = priv.pdsc;
    let mut skip_component: bool = false;
    let mut requested_type: u8 = 0;
    u16 buf_sz, tbl_sz;
    let mut err: c_int = 0;
    dev_dbg(dev,
...
#[no_mangle]
pub unsafe extern "C" fn pdsc_get_component_info(pdsc: *mut pdsc) -> c_int {
...
//
    ...
    let mut timeout: c_ulong = 300 * HZ;
    unsigned long start_time;
    unsigned long end_time;
    int err;
    start_time = jiffies;
...
//
    ...
    const char *component_name = core::ptr::null_mut();
    struct device *dev = context.dev;
    struct pdsc *pdsc = priv.pdsc;
    u16 buf_sz, info_sz;
    struct devlink *dl;
...
#[no_mangle]
unsafe extern "C" fn pdsc_devcmd_finalize_update(pdsc: *mut pdsc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pdsc_finalize_update(context: *mut pldmfw) -> c_int {
    ...
    {
    let mut priv: pds_core_fwu_priv = {};
    int err;
    ...
    if (params.component) {
    let mut type: u8 = pdsc_name_to_fw_type(params.component);
