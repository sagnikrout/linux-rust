...
//! Source: drivers/net/ethernet/amd/pds_core/dev.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn pdsc_err_to_errno(code: enum pds_core_status_code) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pdsc_is_fw_running(pdsc: *mut pdsc) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pdsc_is_fw_good(pdsc: *mut pdsc) -> bool {
    bool pdsc_is_fw_good(struct pdsc *pdsc)
    {
    let mut fw_running: bool = pdsc_is_fw_running(pdsc);
    u8 gen;
...
#[no_mangle]
unsafe extern "C" fn pdsc_devcmd_status(pdsc: *mut pdsc) -> u8 {
    static u8 pdsc_devcmd_status(struct pdsc *pdsc)
    {
    return ioread8(&pdsc.cmd_regs.comp.status);
    }
#[no_mangle]
unsafe extern "C" fn pdsc_devcmd_done(pdsc: *mut pdsc) -> bool {
    static bool pdsc_devcmd_done(struct pdsc *pdsc)
    {
    return ioread32(&pdsc.cmd_regs.done) & PDS_CORE_DEV_CMD_DONE;
    }
#[no_mangle]
unsafe extern "C" fn pdsc_devcmd_dbell(pdsc: *mut pdsc) {
...
#[no_mangle]
unsafe extern "C" fn pdsc_devcmd_clean(pdsc: *mut pdsc) {
...
#[no_mangle]
pub unsafe extern "C" fn pdsc_deferred_dma_free(pdsc: *mut pdsc) {
...
#[no_mangle]
pub unsafe extern "C" fn pdsc_devcmd_init(pdsc: *mut pdsc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pdsc_devcmd_reset(pdsc: *mut pdsc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pdsc_init_devinfo(pdsc: *mut pdsc) {
...
#[no_mangle]
unsafe extern "C" fn pdsc_identify_ver(pdsc: *mut pdsc, drv_ident_ver: u8) -> c_int {
    static int pdsc_identify_ver(struct pdsc *pdsc, u8 drv_ident_ver)
    {
    let mut do_msg: bool = drv_ident_ver == PDS_CORE_IDENTITY_VERSION_1;
    let mut drv: pds_core_drv_identity = {};
    size_t sz;
    int err;
    int n;
...
#[no_mangle]
unsafe extern "C" fn pdsc_identify(pdsc: *mut pdsc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pdsc_dev_uninit(pdsc: *mut pdsc) {
    ...
    pdsc.intr_info = core::ptr::null_mut();
    pdsc.nintrs = 0;
    }
    pci_free_irq_vectors(pdsc.pdev);
    }
#[no_mangle]
pub unsafe extern "C" fn pdsc_dev_init(pdsc: *mut pdsc) -> c_int {
