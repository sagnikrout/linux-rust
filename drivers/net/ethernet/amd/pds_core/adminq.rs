...
//! Source: drivers/net/ethernet/amd/pds_core/adminq.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pdsc_process_notifyq(qcq: *mut pdsc_qcq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pdsc_adminq_inc_if_up(pdsc: *mut pdsc) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pdsc_process_adminq(qcq: *mut pdsc_qcq) {
...
#[no_mangle]
pub unsafe extern "C" fn pdsc_work_thread(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn pdsc_adminq_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// Post the request
    ...
    bool fast_poll)
    {
    let mut poll_interval: c_ulong = 200;
