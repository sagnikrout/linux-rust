...
//! Source: drivers/net/ethernet/amd/pds_core/main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pdsc_wdtimer_cb(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn pdsc_unmap_bars(pdsc: *mut pdsc) {
    static void pdsc_unmap_bars(struct pdsc *pdsc)
    {
    struct pdsc_dev_bar *bars = pdsc.bars;
    unsigned int i;
    pdsc.info_regs = core::ptr::null_mut();
    pdsc.cmd_regs = core::ptr::null_mut();
    pdsc.intr_status = core::ptr::null_mut();
    pdsc.intr_ctrl = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pdsc_map_bars(pdsc: *mut pdsc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pdsc_sriov_configure(pdev: *mut pci_dev, num_vfs: c_int) -> c_int {
    ...
    kfree(pdsc.vfs);
    pdsc.vfs = core::ptr::null_mut();
    pdsc.num_vfs = 0;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn pdsc_init_vf(vf: *mut pdsc) -> c_int {
...
pub const PDSC_WQ_NAME_LEN: c_int = 24;
#[no_mangle]
unsafe extern "C" fn pdsc_init_pf(pdsc: *mut pdsc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pdsc_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pdsc_remove(pdev: *mut pci_dev) {
...
//
    ...
    pdsc.fw_reporter = core::ptr::null_mut();
    }
    ...
    pf.vfs[pdsc.vf_id].vf = core::ptr::null_mut();
    }
    } else {
...
#[no_mangle]
unsafe extern "C" fn pdsc_stop_health_thread(pdsc: *mut pdsc) {
    static void pdsc_stop_health_thread(struct pdsc *pdsc)
    {
...
#[no_mangle]
unsafe extern "C" fn pdsc_restart_health_thread(pdsc: *mut pdsc) {
...
#[no_mangle]
unsafe extern "C" fn pdsc_reset_prepare(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pdsc_reset_done(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pdsc_pci_error_resume(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pdsc_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pdsc_cleanup_module() -> void __exit {
