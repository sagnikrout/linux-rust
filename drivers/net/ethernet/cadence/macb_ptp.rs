...
//! Source: drivers/net/ethernet/cadence/macb_ptp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gem_tsu_incr_set(bp: *mut macb, incr_spec: *mut tsu_incr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gem_ptp_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gem_ptp_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
    ...
    gem_tsu_get_time(&bp.ptp_clock_info, &now, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn gem_ptp_init_timer(bp: *mut macb) {
...
#[no_mangle]
unsafe extern "C" fn gem_ptp_init_tsu(bp: *mut macb) {
...
#[no_mangle]
unsafe extern "C" fn gem_ptp_clear_timer(bp: *mut macb) {
...
//
    gem_tsu_get_time(&bp.ptp_clock_info, &tsu, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn gem_ptp_init(netdev: *mut net_device) {
...
// nominal frequency and maximum adjustment in ppb
    ...
    return;
    } else if (bp.ptp_clock == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn gem_ptp_remove(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn gem_ptp_set_one_step_sync(bp: *mut macb, enable: u8) {
    ...
    {
    let mut tx_bd_control: enum macb_bd_control = TSTAMP_DISABLED;
    let mut rx_bd_control: enum macb_bd_control = TSTAMP_DISABLED;
    struct macb *bp = netdev_priv(netdev);
    u32 regval;
    if (!macb_dma_ptp(bp))
    return -EOPNOTSUPP;
