...
//! Source: drivers/net/ethernet/cadence/macb_main.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sifive_fu540_macb_mgmt {
    pub reg: *mut void __iomem,
    pub rate: c_ulong,
    pub hw: clk_hw,
}

pub const MACB_RX_BUFFER_SIZE: c_int = 128;

pub const MIN_RX_RING_SIZE: c_int = 64;
pub const MAX_RX_RING_SIZE: c_int = 8192;

pub const MIN_TX_RING_SIZE: c_int = 64;
pub const MAX_TX_RING_SIZE: c_int = 4096;
...
pub const MACB_TX_LEN_ALIGN: c_int = 8;
...
pub const HS_SPEED_10000M: c_int = 4;
pub const MACB_SERDES_RATE_10G: c_int = 1;
// Graceful stop timeouts in us. We should allow up to
// 1 frame time (10 Mbits/s, full-duplex, ignoring collisions)
//
pub const MACB_HALT_TIMEOUT: c_int = 14000;
...
//
#[no_mangle]
unsafe extern "C" fn macb_dma_desc_get_size(bp: *mut macb) -> c_uint {
    static unsigned int macb_dma_desc_get_size(struct macb *bp)
    {
    let mut desc_size: c_uint = sizeof(struct macb_dma_desc);
    if (macb_dma64(bp))
...
#[no_mangle]
unsafe extern "C" fn macb_adj_dma_desc_idx(bp: *mut macb, desc_idx: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn macb_tx_ring_wrap(bp: *mut macb, index: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn macb_tx_dma(queue: *mut macb_queue, index: c_uint) -> dma_addr_t {
...
#[no_mangle]
unsafe extern "C" fn macb_rx_ring_wrap(bp: *mut macb, index: c_uint) -> c_uint {
...
// I/O accessors
#[no_mangle]
unsafe extern "C" fn hw_readl_native(bp: *mut macb, offset: c_int) -> u32 {
    static u32 hw_readl_native(struct macb *bp, int offset)
    {
    return __raw_readl(bp.regs + offset);
    }
#[no_mangle]
unsafe extern "C" fn hw_writel_native(bp: *mut macb, offset: c_int, value: u32) {
    static void hw_writel_native(struct macb *bp, int offset, u32 value)
    {
    __raw_writel(value, bp.regs + offset);
    }
#[no_mangle]
unsafe extern "C" fn hw_readl(bp: *mut macb, offset: c_int) -> u32 {
    static u32 hw_readl(struct macb *bp, int offset)
    {
    return readl_relaxed(bp.regs + offset);
    }
#[no_mangle]
unsafe extern "C" fn hw_writel(bp: *mut macb, offset: c_int, value: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_is_native_io(addr: *mut void __iomem) -> bool {
    static bool hw_is_native_io(void __iomem *addr)
    {
    let mut value: u32 = MACB_BIT(LLB);
    __raw_writel(value, addr + MACB_NCR);
    value = __raw_readl(addr + MACB_NCR);
// Write 0 back to disable everything
    __raw_writel(0, addr + MACB_NCR);
    let mut value: return = = MACB_BIT(LLB);
    }
#[no_mangle]
unsafe extern "C" fn hw_is_gem(addr: *mut void __iomem, native_io: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn macb_set_hwaddr(bp: *mut macb) {
...
#[no_mangle]
unsafe extern "C" fn macb_get_hwaddr(bp: *mut macb) {
...
#[no_mangle]
unsafe extern "C" fn macb_mdio_wait_for_idle(bp: *mut macb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_mdio_read_c22(bus: *mut mii_bus, mii_id: c_int, regnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_init_buffers(bp: *mut macb) {
...
//
#[no_mangle]
unsafe extern "C" fn macb_set_tx_clk(bp: *mut macb, speed: c_int) {
...
#[no_mangle]
unsafe extern "C" fn macb_pcs_an_restart(pcs: *mut phylink_pcs) {
...
#[no_mangle]
unsafe extern "C" fn macb_tx_lpi_set(bp: *mut macb, enable: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn macb_tx_all_queues_idle(bp: *mut macb) -> bool {
...
#[no_mangle]
unsafe extern "C" fn macb_tx_lpi_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn macb_tx_lpi_schedule(bp: *mut macb) {
...
//
#[no_mangle]
unsafe extern "C" fn macb_tx_lpi_wake(bp: *mut macb) {
...
#[no_mangle]
unsafe extern "C" fn macb_mac_disable_tx_lpi(config: *mut phylink_config) {
...
#[no_mangle]
unsafe extern "C" fn gem_shuffle_tx_one_ring(queue: *mut macb_queue) {
...
#[no_mangle]
unsafe extern "C" fn gem_shuffle_tx_rings(bp: *mut macb) {
...
#[no_mangle]
pub unsafe extern "C" fn if(PHY_INTERFACE_MODE_SGMII: interface ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn macb_phy_handle_exists(dn: *mut device_node) -> bool {
    static bool macb_phy_handle_exists(struct device_node *dn)
    {
    dn = of_parse_phandle(dn, "phy-handle", 0);
    of_node_put(dn);
    return dn != core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn macb_phylink_connect(bp: *mut macb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_mii_probe(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_mdiobus_register(bp: *mut macb, mdio_np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_mii_init(bp: *mut macb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_update_stats(bp: *mut macb) {
    static void macb_update_stats(struct macb *bp)
    {
    u64 *p = &bp.hw_stats.macb.rx_pause_frames;
    u64 *end = &bp.hw_stats.macb.tx_pause_frames + 1;
    let mut offset: c_int = MACB_PFR;
    WARN_ON((unsigned long)(end - p - 1) != (MACB_TPF - MACB_PFR) / 4);
    for (; p < end; p++, offset += 4)
// p += bp->macb_reg_readl(bp, offset);
    }
#[no_mangle]
unsafe extern "C" fn macb_halt_tx(bp: *mut macb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_tx_unmap(bp: *mut macb, tx_skb: *mut macb_tx_skb, budget: c_int) {
...
#[no_mangle]
unsafe extern "C" fn macb_set_addr(bp: *mut macb, desc: *mut macb_dma_desc, addr: dma_addr_t) {
...
#[no_mangle]
unsafe extern "C" fn macb_get_addr(bp: *mut macb, desc: *mut macb_dma_desc) -> dma_addr_t {
...
#[no_mangle]
unsafe extern "C" fn macb_tx_error_task(work: *mut work_struct) {
    static void macb_tx_error_task(struct work_struct *work)
    {
    struct macb_queue *queue = container_of(work, struct macb_queue,
    tx_error_task);
    let mut q: c_uint = queue - queue.bp.queues;
    struct macb *bp = queue.bp;
    struct macb_tx_skb *tx_skb;
    struct macb_dma_desc *desc;
    let mut halt_timeout: bool = false;
    struct sk_buff *skb;
    unsigned long flags;
    unsigned int tail;
...
#[no_mangle]
unsafe extern "C" fn ptp_one_step_sync(skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn macb_tx_complete(queue: *mut macb_queue, budget: c_int) -> c_int {
    static int macb_tx_complete(struct macb_queue *queue, int budget)
    {
    struct macb *bp = queue.bp;
    let mut q: c_uint = queue - bp.queues;
    unsigned long flags;
    unsigned int tail;
    unsigned int head;
...
#[no_mangle]
unsafe extern "C" fn gem_rx_refill(queue: *mut macb_queue) {
...
// now everything is ready for receiving packet
    queue.rx_skbuff[entry] = core::ptr::null_mut();
...
// Make descriptor updates visible to hardware
    ...
    skb_put(skb, len);
    for (frag = first_frag; ; frag++) {
    let mut frag_len: c_uint = bp.rx_buffer_size;
...
#[no_mangle]
pub unsafe extern "C" fn macb_init_rx_ring(queue: *mut macb_queue) {
    static inline void macb_init_rx_ring(struct macb_queue *queue)
    {
    struct macb_dma_desc *desc = core::ptr::null_mut();
    struct macb *bp = queue.bp;
    dma_addr_t addr;
    int i;
    ...
    {
    struct macb *bp = queue.bp;
    let mut reset_rx_queue: bool = false;
    let mut first_frag: c_int = -1;
    unsigned int tail;
...
#[no_mangle]
unsafe extern "C" fn macb_rx_pending(queue: *mut macb_queue) -> bool {
...
#[no_mangle]
unsafe extern "C" fn macb_rx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_tx_restart(queue: *mut macb_queue) {
...
#[no_mangle]
unsafe extern "C" fn macb_tx_complete_pending(queue: *mut macb_queue) -> bool {
...
#[no_mangle]
unsafe extern "C" fn macb_tx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_hresp_error_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn macb_wol_interrupt(queue: *mut macb_queue, status: u32) {
...
#[no_mangle]
unsafe extern "C" fn gem_wol_interrupt(queue: *mut macb_queue, status: u32) {
...
#[no_mangle]
unsafe extern "C" fn macb_interrupt_misc(queue: *mut macb_queue, status: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn macb_poll_controller(netdev: *mut net_device) {
    ...
    let mut eof: c_uint = 1, mss_mfs = 0;
    struct macb_tx_skb *tx_skb = core::ptr::null_mut();
    struct macb_dma_desc *desc;
...
#[no_mangle]
pub unsafe extern "C" fn macb_clear_csum(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_pad_and_fcs(skb: *mut sk_buff, netdev: *mut net_device) -> c_int {
    static int macb_pad_and_fcs(struct sk_buff **skb, struct net_device *netdev)
    {
    bool cloned = skb_cloned(*skb) || skb_header_cloned(*skb) ||
    skb_is_nonlinear(*skb);
    let mut padlen: c_int = ETH_ZLEN - (*skb).len;
...
// set FCS to packet
    ...
    {
    struct macb *bp = netdev_priv(netdev);
    let mut q: c_uint = skb_get_queue_mapping(skb);
...
#[no_mangle]
unsafe extern "C" fn macb_init_rx_buffer_size(bp: *mut macb, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn gem_free_rx_buffers(bp: *mut macb) {
    ...
    queue.rx_skbuff = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn macb_free_rx_buffers(bp: *mut macb) {
    ...
    queue.rx_buffers = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn macb_tx_ring_size_per_queue(bp: *mut macb) -> c_uint {
    static unsigned int macb_tx_ring_size_per_queue(struct macb *bp)
    {
    return macb_dma_desc_get_size(bp) * bp.tx_ring_size + bp.tx_bd_rd_prefetch;
    }
#[no_mangle]
unsafe extern "C" fn macb_rx_ring_size_per_queue(bp: *mut macb) -> c_uint {
    static unsigned int macb_rx_ring_size_per_queue(struct macb *bp)
    {
    return macb_dma_desc_get_size(bp) * bp.rx_ring_size + bp.rx_bd_rd_prefetch;
    }
#[no_mangle]
unsafe extern "C" fn macb_free(bp: *mut macb) {
    ...
    kfree(queue.tx_skb);
    queue.tx_skb = core::ptr::null_mut();
    }
    queue.tx_head = 0;
    queue.tx_tail = 0;
    queue.tx_ring = core::ptr::null_mut();
    queue.rx_ring = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn gem_alloc_rx_buffers(bp: *mut macb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_alloc_rx_buffers(bp: *mut macb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_alloc(bp: *mut macb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gem_init_rx_ring(queue: *mut macb_queue) {
...
#[no_mangle]
unsafe extern "C" fn gem_init_rings(bp: *mut macb) {
...
#[no_mangle]
unsafe extern "C" fn macb_init_rings(bp: *mut macb) {
...
#[no_mangle]
unsafe extern "C" fn macb_reset_hw(bp: *mut macb) {
    static void macb_reset_hw(struct macb *bp)
    {
    struct macb_queue *queue;
    unsigned int q;
    let mut ctrl: u32 = macb_readl(bp, NCR);
...
#[no_mangle]
unsafe extern "C" fn gem_mdc_clk_div(bp: *mut macb) -> u32 {
    static u32 gem_mdc_clk_div(struct macb *bp)
    {
    u32 config;
    let mut pclk_hz: c_ulong = clk_get_rate(bp.pclk);
    if (pclk_hz <= 20000000)
    config = GEM_BF(CLK, GEM_CLK_DIV8);
#[no_mangle]
pub unsafe extern "C" fn if(40000000: pclk_hz <=) -> else {
    else if (pclk_hz <= 40000000)
    config = GEM_BF(CLK, GEM_CLK_DIV16);
#[no_mangle]
pub unsafe extern "C" fn if(80000000: pclk_hz <=) -> else {
    else if (pclk_hz <= 80000000)
    config = GEM_BF(CLK, GEM_CLK_DIV32);
#[no_mangle]
pub unsafe extern "C" fn if(120000000: pclk_hz <=) -> else {
    else if (pclk_hz <= 120000000)
    config = GEM_BF(CLK, GEM_CLK_DIV48);
#[no_mangle]
pub unsafe extern "C" fn if(160000000: pclk_hz <=) -> else {
    else if (pclk_hz <= 160000000)
    config = GEM_BF(CLK, GEM_CLK_DIV64);
#[no_mangle]
pub unsafe extern "C" fn if(240000000: pclk_hz <=) -> else {
    else if (pclk_hz <= 240000000)
    config = GEM_BF(CLK, GEM_CLK_DIV96);
#[no_mangle]
pub unsafe extern "C" fn if(320000000: pclk_hz <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn macb_mdc_clk_div(bp: *mut macb) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn macb_dbw(bp: *mut macb) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn macb_configure_dma(bp: *mut macb) {
...
#[no_mangle]
unsafe extern "C" fn macb_init_hw(bp: *mut macb) {
...
#[no_mangle]
pub unsafe extern "C" fn if(NETIF_F_RXCSUM: macb_is_gem(bp) && bp->netdev->features &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn hash_bit_value(bitnr: c_int, addr: *mut __u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hash_get_index(addr: *mut __u8) -> c_int {
    static int hash_get_index(__u8 *addr)
    {
    int i, j, bitval;
    let mut hash_index: c_int = 0;
    for (j = 0; j < 6; j++) {
...
#[no_mangle]
unsafe extern "C" fn macb_sethashtable(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn macb_set_rx_mode(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn macb_open(netdev: *mut net_device) -> c_int {
    static int macb_open(struct net_device *netdev)
    {
    let mut bufsz: usize = netdev.mtu + ETH_HLEN + ETH_FCS_LEN + NET_IP_ALIGN;
    struct macb *bp = netdev_priv(netdev);
    struct macb_queue *queue;
    unsigned int q;
    int err;
...
#[no_mangle]
unsafe extern "C" fn macb_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_set_mac_addr(netdev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gem_update_stats(bp: *mut macb) {
    ...
    let mut offset: u32 = gem_statistics[i].offset;
    let mut val: u64 = bp.macb_reg_readl(bp, offset);
...
#[no_mangle]
unsafe extern "C" fn gem_get_stats(bp: *mut macb, nstat: *mut rtnl_link_stats64) {
...
#[no_mangle]
unsafe extern "C" fn gem_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gem_get_ethtool_strings(netdev: *mut net_device, sset: u32, p: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn macb_get_regs_len(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_get_wol(netdev: *mut net_device, wol: *mut ethtool_wolinfo) {
...
#[no_mangle]
unsafe extern "C" fn macb_set_wol(netdev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gem_get_tsu_rate(bp: *mut macb) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gem_get_ptp_max_adj() -> i32 {
...
#[no_mangle]
unsafe extern "C" fn gem_enable_flow_filters(bp: *mut macb, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn gem_prog_cmp_regs(bp: *mut macb, fs: *mut ethtool_rx_flow_spec) {
    static void gem_prog_cmp_regs(struct macb *bp, struct ethtool_rx_flow_spec *fs)
    {
    struct ethtool_tcpip4_spec *tp4sp_v, *tp4sp_m;
    let mut index: u16 = fs.location;
    u32 w0, w1, t2_scr;
    let mut cmp_a: bool = false;
    let mut cmp_b: bool = false;
    let mut cmp_c: bool = false;
    if (!macb_is_gem(bp))
    return;
...
#[no_mangle]
unsafe extern "C" fn gem_get_rx_ring_count(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gem_set_rxnfc(netdev: *mut net_device, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_get_eee(netdev: *mut net_device, eee: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_set_eee(netdev: *mut net_device, eee: *mut ethtool_keee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_ioctl(netdev: *mut net_device, rq: *mut ifreq, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_restore_features(bp: *mut macb) {
    static void macb_restore_features(struct macb *bp)
    {
    struct net_device *netdev = bp.netdev;
    let mut features: netdev_features_t = netdev.features;
    struct ethtool_rx_fs_item *item;
// TX checksum offload
    macb_set_txcsum_feature(bp, features);
// RX checksum offload
...
// RX Flow Filters
    ...
    {
    let mut total_on_time: u64 = 0, start_time_sec = 0, start_time = conf.base_time;
    let mut configured_queues: u32 = 0, speed = 0, start_time_nsec;
...
#[no_mangle]
unsafe extern "C" fn macb_taprio_destroy(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn macb_tx_timeout(netdev: *mut net_device, q: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn macb_probe_queues(dev: *mut device, mem: *mut void __iomem, native_io: bool) -> c_int {
    static int macb_probe_queues(struct device *dev, void __iomem *mem, bool native_io)
    {
// BIT(0) is never set but queue 0 always exists.
    let mut queue_mask: c_uint = 0x1;
...
#[no_mangle]
unsafe extern "C" fn macb_init_dflt(pdev: *mut platform_device) -> c_int {
...
// init Rx flow definitions
    ...
    val = bp.usrio.rmii;
#[no_mangle]
pub unsafe extern "C" fn if(MACB_CAPS_USRIO_DEFAULT_IS_MII_GMII): !(bp->caps &) -> else {
...
// 1518 rounded up
pub const AT91ETHER_MAX_RBUFF_SZ: c_uint = 0x600;
// max number of receive buffers
pub const AT91ETHER_MAX_RX_DESCR: c_int = 9;
    static struct sifive_fu540_macb_mgmt *mgmt;
#[no_mangle]
unsafe extern "C" fn at91ether_alloc_coherent(bp: *mut macb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at91ether_free_coherent(bp: *mut macb) {
...
#[no_mangle]
unsafe extern "C" fn at91ether_start(bp: *mut macb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at91ether_stop(bp: *mut macb) {
...
#[no_mangle]
unsafe extern "C" fn at91ether_open(netdev: *mut net_device) -> c_int {
...
// Close the interface
#[no_mangle]
unsafe extern "C" fn at91ether_close(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn at91ether_rx(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn at91ether_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// The TCOM bit is set even if the transmission failed
    ...
    bp.rm9200_txq[desc].skb = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn at91ether_poll_controller(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn at91ether_init(pdev: *mut platform_device) -> c_int {
    ...
    req.rate = 2500000;
#[no_mangle]
pub unsafe extern "C" fn if(2500000: req->rate ==) -> else {
    else if (req.rate == 2500000)
    req.rate = 2500000;
#[no_mangle]
pub unsafe extern "C" fn if(13750000): WARN_ON(req->rate <) -> else {
    else if (WARN_ON(req.rate < 13750000))
    req.rate = 2500000;
#[no_mangle]
pub unsafe extern "C" fn if(25000000): WARN_ON(req->rate <) -> else {
    else if (WARN_ON(req.rate < 25000000))
    req.rate = 25000000;
#[no_mangle]
pub unsafe extern "C" fn if(25000000: req->rate ==) -> else {
    else if (req.rate == 25000000)
    req.rate = 25000000;
#[no_mangle]
pub unsafe extern "C" fn if(75000000): WARN_ON(req->rate <) -> else {
    else if (WARN_ON(req.rate < 75000000))
    req.rate = 25000000;
#[no_mangle]
pub unsafe extern "C" fn if(125000000): WARN_ON(req->rate <) -> else {
    else if (WARN_ON(req.rate < 125000000))
    req.rate = 125000000;
#[no_mangle]
pub unsafe extern "C" fn if(125000000: req->rate ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn fu540_c000_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_reset_optional(pdev: *mut platform_device) -> c_int {
...
// Ensure PHY device used in SGMII mode is ready
    bp.phy = devm_phy_optional_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(bp.phy))
...
#[no_mangle]
unsafe extern "C" fn eyeq5_init(pdev: *mut platform_device) -> c_int {
    ...
    int ret;
    bp.phy = devm_phy_get(dev, core::ptr::null_mut());
    if (IS_ERR(bp.phy))
...
#[no_mangle]
unsafe extern "C" fn macb_alloc_tieoff(bp: *mut macb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macb_free_tieoff(bp: *mut macb) {
    ...
    bp.rx_ring_tieoff,
    bp.rx_ring_tieoff_dma);
    bp.rx_ring_tieoff = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn macb_probe(pdev: *mut platform_device) -> c_int {
    static int macb_probe(struct platform_device *pdev)
    {
    struct clk *pclk, *hclk = core::ptr::null_mut(), *tx_clk = core::ptr::null_mut(), *rx_clk = core::ptr::null_mut();
    struct device_node *np = pdev.dev.of_node;
    const struct macb_config *macb_config;
    struct clk *tsu_clk = core::ptr::null_mut();
    phy_interface_t interface;
    struct net_device *netdev;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: macb_config->max_tx_length) -> else {
...
#[no_mangle]
unsafe extern "C" fn macb_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn macb_suspend(dev: *mut device) -> int __maybe_unused {
    static int __maybe_unused macb_suspend(struct device *dev)
    {
    struct net_device *netdev = dev_get_drvdata(dev);
    struct macb *bp = netdev_priv(netdev);
    struct in_ifaddr *ifa = core::ptr::null_mut();
    struct macb_queue *queue;
...
#[no_mangle]
unsafe extern "C" fn macb_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn macb_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
pub unsafe extern "C" fn if(MACB_CAPS_NEED_TSUCLK): !(bp->caps &) -> else {
    else if (!(bp.caps & MACB_CAPS_NEED_TSUCLK))
    macb_clks_disable(core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), bp.tsu_clk);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn macb_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn macb_shutdown(pdev: *mut platform_device) {
    ...
    SET_RUNTIME_PM_OPS(macb_runtime_suspend, macb_runtime_resume, core::ptr::null_mut())
    };
