...
//! Source: drivers/net/ethernet/brocade/bna/bfa_ioc_ct.c
#![no_std]
...
//
    ...
    .ioc_isr_mode_set    = core::ptr::null_mut(),
    .ioc_notify_fail     = bfa_ioc_ct_notify_fail,
    .ioc_ownership_reset = bfa_ioc_ct_ownership_reset,
    .ioc_sync_start      = bfa_ioc_ct_sync_start,
    .ioc_sync_join       = bfa_ioc_ct_sync_join,
...
//
    ...
    let mut fcmode: bool = (asic_mode == BFI_ASIC_MODE_FC);
...
pub const CT2_NFC_VER_VALID: c_uint = 0x143;
