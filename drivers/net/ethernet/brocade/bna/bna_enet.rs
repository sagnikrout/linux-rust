...
//! Source: drivers/net/ethernet/brocade/bna/bna_enet.c
#![no_std]
...
//
    ...
    struct bfi_msgq_mhdr *msghdr)
    {
    let mut ethport_up: c_int = ethport_is_up(ethport);
    ethport.flags &= ~BNA_ETHPORT_F_PORT_ENABLED;
    if (ethport_up)
...
//
    ...
    u64 *stats_src;
    u64 *stats_dst;
    let mut tx_enet_mask: u32 = ntohl(stats_req.tx_enet_mask);
    let mut rx_enet_mask: u32 = ntohl(stats_req.rx_enet_mask);
    int count;
    int i;
...
// ETHPORT
    ...
    (_ethport).stop_cbfn = core::ptr::null_mut();				\
    ...
    (ethport).adminup_cbfn = core::ptr::null_mut();				\
    ...
    bfa_msgq_cmd_set(&ethport.msgq_cmd, core::ptr::null_mut(), core::ptr::null_mut(),
...
// up_resp_wait->last_resp_wait transition on ETHPORT_T_STOP
    ...
    ethport.stop_cbfn = core::ptr::null_mut();
    ethport.adminup_cbfn = core::ptr::null_mut();
    bfa_fsm_set_state(ethport, bna_ethport_sm_stopped);
    }
    static void
...
// ENET
    ...
    (enet).stop_cbfn = core::ptr::null_mut();				\
    (enet).stop_cbarg = core::ptr::null_mut();				\
    cbfn(cbarg);						\
    }								\
    } while (0)
    ...
    cbfn = (enet).mtu_cbfn;				\
    (enet).mtu_cbfn = core::ptr::null_mut();				\
    cbfn((enet).bna.bnad);				\
    }								\
    } while (0)
...
//
    ...
    bfa_msgq_cmd_set(&enet.msgq_cmd, core::ptr::null_mut(), core::ptr::null_mut(),
...
// IOCETH
    ...
    (_ioceth).stop_cbfn = core::ptr::null_mut();				\
    (_ioceth).stop_cbarg = core::ptr::null_mut();				\
    cbfn(cbarg);						\
    }								\
    } while (0)
...
// No-op
    ...
    bfa_msgq_cmd_set(&ioceth.msgq_cmd, core::ptr::null_mut(), core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn bna_attr_init(ioceth: *mut bna_ioceth) {
...
//
    ...
    ioceth.stop_cbfn = core::ptr::null_mut();
    ioceth.stop_cbarg = core::ptr::null_mut();
...
// A separate queue to allow synchronous setting of a list of MACs
    ...
    {
    ucam_mod.bna = core::ptr::null_mut();
    }
    static void
...
// A separate queue to allow synchronous setting of a list of MACs
    ...
    {
    mcam_mod.bna = core::ptr::null_mut();
    }
    static void
    ...
    bfa_msgq_cmd_set(&bna.stats_mod.stats_get_cmd, core::ptr::null_mut(), core::ptr::null_mut(),
