...
//! Source: drivers/net/ethernet/brocade/bna/bfi_reg.h
#![no_std]
...
pub const OP_MODE: c_uint = 0x0001460c;
...
pub const FW_INIT_HALT_P0: c_uint = 0x000191ac;
pub const __FW_INIT_HALT_P: c_uint = 0x00000001;
pub const FW_INIT_HALT_P1: c_uint = 0x000191bc;
pub const PMM_1T_RESET_REG_P0: c_uint = 0x0002381c;
pub const __PMM_1T_RESET_P: c_uint = 0x00000001;
pub const PMM_1T_RESET_REG_P1: c_uint = 0x00023c1c;
