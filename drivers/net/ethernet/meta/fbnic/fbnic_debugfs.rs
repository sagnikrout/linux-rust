...
//! Source: drivers/net/ethernet/meta/fbnic/fbnic_debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_desc_break(s: *mut seq_file, i: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_twd_desc_seq_show(s: *mut seq_file, i: c_int) {
    static void fbnic_dbg_twd_desc_seq_show(struct seq_file *s, int i)
    {
    struct fbnic_ring *ring = s.private;
    let mut twd: u64 = le64_to_cpu(ring.desc[i]);
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_twq_desc_seq_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_tcq_desc_seq_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
// Display descriptor
    ...
    for (i = 0; i <= ring.size_mask; i++) {
    let mut tcd: u64 = le64_to_cpu(ring.desc[i]);
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_bdq_desc_seq_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
// Display descriptor
    ...
    let mut bd: u64 = le64_to_cpu(ring.desc[i]);
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_rcd_desc_seq_show(s: *mut seq_file, i: c_int) {
    static void fbnic_dbg_rcd_desc_seq_show(struct seq_file *s, int i)
    {
    struct fbnic_ring *ring = s.private;
    let mut rcd: u64 = le64_to_cpu(ring.desc[i]);
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_rcq_desc_seq_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_desc_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_dbg_nv_init(nv: *mut fbnic_napi_vector) {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_dbg_nv_exit(nv: *mut fbnic_napi_vector) {
    void fbnic_dbg_nv_exit(struct fbnic_napi_vector *nv)
    {
    debugfs_remove_recursive(nv.dbg_nv);
    nv.dbg_nv = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_mac_addr_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_tce_tcam_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_act_tcam_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_ip_src_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_ip_dst_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_ipo_src_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_ipo_dst_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
// Generate header
    ...
    let mut desc: u64 = __fbnic_mbx_rd_desc(fbd, mbx_idx, i);
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_fw_mbx_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_fw_log_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_dbg_pcie_stats_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_dbg_fbd_init(fbd: *mut fbnic_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_dbg_fbd_exit(fbd: *mut fbnic_dev) {
    void fbnic_dbg_fbd_exit(struct fbnic_dev *fbd)
    {
    debugfs_remove_recursive(fbd.dbg_fbd);
    fbd.dbg_fbd = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn fbnic_dbg_init() {
    void fbnic_dbg_init(void)
    {
    fbnic_dbg_root = debugfs_create_dir(fbnic_driver_name, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn fbnic_dbg_exit() {
    void fbnic_dbg_exit(void)
    {
    debugfs_remove_recursive(fbnic_dbg_root);
    fbnic_dbg_root = core::ptr::null_mut();
    }
