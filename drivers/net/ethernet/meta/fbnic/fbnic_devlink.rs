...
//! Source: drivers/net/ethernet/meta/fbnic/fbnic_devlink.c
#![no_std]
...
pub const FBNIC_SN_STR_LEN: c_int = 24;
    ...
    let mut anti_rollback_ver: u32 = 0;
...
// Wait for firmware to ack firmware upgrade start
    ...
    let mut size: u32 = component.component_size;
    struct fbnic_fw_completion *cmpl;
    ...
    component.identifier);
    devlink_flash_update_status_notify(devlink, buf, core::ptr::null_mut(), 0,
    size);
    return -EINVAL;
    }
...
//
    ...
    if (err) {
    fbnic_fw_xmit_fw_write_chunk(fbd, core::ptr::null_mut(), 0, 0, err);
    err_no_msg:
...
// First iteration installs completion
    struct fbnic_fw_completion *cmpl_arg = index ? core::ptr::null_mut() : fw_cmpl;
...
#[no_mangle]
pub unsafe extern "C" fn __printf(_arg: 2, _arg: 3) {
    void __printf(2, 3)
...
#[no_mangle]
unsafe extern "C" fn fbnic_read_otp_status(fbd: *mut fbnic_dev) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_devlink_otp_check(fbd: *mut fbnic_dev, msg: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_devlink_health_create(fbd: *mut fbnic_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_devlink_health_destroy(fbd: *mut fbnic_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_devlink_free(fbd: *mut fbnic_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_devlink_register(fbd: *mut fbnic_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_devlink_unregister(fbd: *mut fbnic_dev) {
