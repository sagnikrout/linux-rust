...
//! Source: drivers/net/ethernet/meta/fbnic/fbnic_phylink.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fbnic_phylink_select_interface(aui: u8) -> phy_interface_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn fbnic_phylink_create(netdev: *mut net_device) -> c_int {
    ...
    phylink = phylink_create(&fbn.phylink_config, core::ptr::null_mut(),
...
//
#[no_mangle]
pub unsafe extern "C" fn fbnic_phylink_destroy(netdev: *mut net_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fbnic_phylink_pmd_training_complete_notify(netdev: *mut net_device) {
