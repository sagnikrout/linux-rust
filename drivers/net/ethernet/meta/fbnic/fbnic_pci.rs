...
//! Source: drivers/net/ethernet/meta/fbnic/fbnic_pci.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_rd32(fbd: *mut fbnic_dev, reg: u32) -> u32 {
...
// Hardware is giving us all 1's reads, assume it is gone
    WRITE_ONCE(fbd.uc_addr0, core::ptr::null_mut());
    WRITE_ONCE(fbd.uc_addr4, core::ptr::null_mut());
    dev_err(fbd.dev,
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_fw_present(fbd: *mut fbnic_dev) -> bool {
    bool fbnic_fw_present(struct fbnic_dev *fbd)
    {
    return !!READ_ONCE(fbd.uc_addr4);
    }
#[no_mangle]
pub unsafe extern "C" fn fbnic_fw_wr32(fbd: *mut fbnic_dev, reg: u32, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_fw_rd32(fbd: *mut fbnic_dev, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fbnic_service_task_start(fbn: *mut fbnic_net) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_service_task_stop(fbn: *mut fbnic_net) {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_up(fbn: *mut fbnic_net) {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_down_noidle(fbn: *mut fbnic_net) {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_down(fbn: *mut fbnic_net) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_fw_config_after_crash(fbd: *mut fbnic_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_health_check(fbd: *mut fbnic_dev) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_service_task(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn fbnic_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fbnic_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __fbnic_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __fbnic_pm_attach(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_pm_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn fbnic_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_err_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn fbnic_err_resume(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn fbnic_init_module() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn fbnic_exit_module() -> void __exit {
