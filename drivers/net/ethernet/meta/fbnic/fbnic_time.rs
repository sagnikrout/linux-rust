...
//! Source: drivers/net/ethernet/meta/fbnic/fbnic_time.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn __fbnic_time_get_slow(fbd: *mut fbnic_dev) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn __fbnic_time_set_addend(fbd: *mut fbnic_dev, addend: u64) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_ptp_fresh_check(fbd: *mut fbnic_dev) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_ptp_refresh_time(fbd: *mut fbnic_dev, fbn: *mut fbnic_net) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_ptp_do_aux_work(ptp: *mut ptp_clock_info) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn fbnic_ptp_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_ptp_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_ptp_reset(fbd: *mut fbnic_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_time_init(fbn: *mut fbnic_net) {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_time_start(fbn: *mut fbnic_net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_time_stop(fbn: *mut fbnic_net) {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_ptp_setup(fbd: *mut fbnic_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_ptp_destroy(fbd: *mut fbnic_dev) {
