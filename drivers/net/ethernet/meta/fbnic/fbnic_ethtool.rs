...
//! Source: drivers/net/ethernet/meta/fbnic/fbnic_ethtool.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fbnic_stat {
    pub string: [u8; ETH_GSTRING_LEN],
    pub size: c_uint,
    pub offset: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn fbnic_get_regs_len(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_clone_free(clone: *mut fbnic_net) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_get_rxb_enqueue_strings(data: *mut u8, idx: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_get_rxb_fifo_strings(data: *mut u8, idx: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_get_rxb_dequeue_strings(data: *mut u8, idx: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_get_xdp_queue_strings(data: *mut u8, idx: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_get_strings(dev: *mut net_device, sset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_get_xdp_queue_stats(ring: *mut fbnic_ring, data: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn fbnic_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_get_rss_hash_idx(flow_type: u32) -> c_int {
...
// Report maximum rule count
    ...
    let mut idx: c_int = i + FBNIC_RPC_ACT_TBL_NFC_OFFSET;
...
#[no_mangle]
unsafe extern "C" fn fbnic_get_cls_rule(fbn: *mut fbnic_net, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(FBNIC_RPC_ACT_TBL0_Q_SEL: act_tcam->dest &) -> else {
...
#[no_mangle]
unsafe extern "C" fn fbnic_get_rx_ring_count(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fbnic_cls_rule_any_loc(fbd: *mut fbnic_dev) -> c_int {
    ...
    {
    let mut flow_value: u16 = 0, flow_mask = 0xffff, ip_value = 0, ip_mask = 0xffff;
    let mut sport: u16 = 0, sport_mask = ~0, dport = 0, dport_mask = ~0;
    let mut misc: u16 = 0, misc_mask = ~0;
    u32 dest = FIELD_PREP(FBNIC_RPC_ACT_TBL0_DEST_MASK,
    FBNIC_RPC_ACT_TBL0_DEST_HOST);
    struct fbnic_ip_addr *ip_src = core::ptr::null_mut(), *ip_dst = core::ptr::null_mut();
    struct fbnic_mac_addr *mac_addr = core::ptr::null_mut();
    struct ethtool_rx_flow_spec *fsp;
    struct fbnic_dev *fbd = fbn.fbd;
    struct fbnic_act_tcam *act_tcam;
    ...
    let mut ring_idx: u32 = ethtool_get_flow_spec_ring(fsp.ring_cookie);
...
#[no_mangle]
unsafe extern "C" fn fbnic_set_rxnfc(netdev: *mut net_device, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
    static u32 fbnic_get_rxfh_key_size(struct net_device *netdev)
    {
    return FBNIC_RPC_RSS_KEY_BYTE_LEN;
    }
#[no_mangle]
unsafe extern "C" fn fbnic_get_rxfh_indir_size(netdev: *mut net_device) -> u32 {
    ...
    let mut rss_key: u32 = fbn.rss_key[i / 4] << ((i % 4) * 8);
    ...
    {
    let mut hash_opt_idx: c_int = fbnic_get_rss_hash_idx(cmd.flow_type);
    struct fbnic_net *fbn = netdev_priv(netdev);
    if (hash_opt_idx < 0)
    return -EINVAL;
...
// Verify the fields asked for can actually be assigned based on type
    ...
    let mut num_rx: c_uint = fbn.num_rx_queues;
    unsigned int i;
    for (i = 0; i < FBNIC_RPC_RSS_TBL_SIZE; i++)
...
#[no_mangle]
unsafe extern "C" fn fbnic_ethtool_regs_test(netdev: *mut net_device, data: *mut u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fbnic_ethtool_msix_test(netdev: *mut net_device, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbnic_ethtool_mbx_self_test(netdev: *mut net_device, data: *mut u64) -> c_int {
...
// data = fbnic_fw_mbx_self_test(fbd);
    ...
    eth_test.flags |= ETH_TEST_FL_FAILED;
    if (if_running && netif_open(netdev, core::ptr::null_mut())) {
    netdev_err(netdev,
...
// (u16 *)data = fbn->fbd->ps_timeout;
    ...
    switch (tun.id) {
    case ETHTOOL_PFC_PREVENTION_TOUT: {
    let mut ps_timeout: u16 = *(u16 *)data;
...
#[no_mangle]
unsafe extern "C" fn fbnic_set_counter(stat: *mut u64, counter: *mut fbnic_stat_counter) {
...
#[no_mangle]
pub unsafe extern "C" fn fbnic_set_ethtool_ops(dev: *mut net_device) {
