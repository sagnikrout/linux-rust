...
//! Source: drivers/net/ethernet/microchip/lan966x/lan966x_vlan.c
#![no_std]
...
pub const VLANACCESS_CMD_IDLE: c_int = 0;
pub const VLANACCESS_CMD_READ: c_int = 1;
pub const VLANACCESS_CMD_WRITE: c_int = 2;
pub const VLANACCESS_CMD_INIT: c_int = 3;
#[no_mangle]
unsafe extern "C" fn lan966x_vlan_get_status(lan966x: *mut lan966x) -> c_int {
    static int lan966x_vlan_get_status(struct lan966x *lan966x)
    {
    return lan_rd(lan966x, ANA_VLANACCESS);
    }
#[no_mangle]
unsafe extern "C" fn lan966x_vlan_wait_for_completion(lan966x: *mut lan966x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_vlan_set_mask(lan966x: *mut lan966x, vid: u16) {
    static void lan966x_vlan_set_mask(struct lan966x *lan966x, u16 vid)
    {
    let mut mask: u16 = lan966x.vlan_mask[vid];
    bool cpu_dis;
...
#[no_mangle]
unsafe extern "C" fn lan966x_vlan_port_add_vlan_mask(port: *mut lan966x_port, vid: u16) {
    static void lan966x_vlan_port_add_vlan_mask(struct lan966x_port *port, u16 vid)
    {
    struct lan966x *lan966x = port.lan966x;
    let mut p: u8 = port.chip_port;
    lan966x.vlan_mask[vid] |= BIT(p);
    lan966x_vlan_set_mask(lan966x, vid);
    }
#[no_mangle]
unsafe extern "C" fn lan966x_vlan_port_del_vlan_mask(port: *mut lan966x_port, vid: u16) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_vlan_port_any_vlan_mask(lan966x: *mut lan966x, vid: u16) -> bool {
    static bool lan966x_vlan_port_any_vlan_mask(struct lan966x *lan966x, u16 vid)
    {
    return !!(lan966x.vlan_mask[vid] & ~BIT(CPU_PORT));
    }
#[no_mangle]
unsafe extern "C" fn lan966x_vlan_cpu_add_vlan_mask(lan966x: *mut lan966x, vid: u16) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_vlan_cpu_del_vlan_mask(lan966x: *mut lan966x, vid: u16) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_vlan_cpu_add_cpu_vlan_mask(lan966x: *mut lan966x, vid: u16) {
    static void lan966x_vlan_cpu_add_cpu_vlan_mask(struct lan966x *lan966x, u16 vid)
    {
    __set_bit(vid, lan966x.cpu_vlan_mask);
    }
#[no_mangle]
unsafe extern "C" fn lan966x_vlan_cpu_del_cpu_vlan_mask(lan966x: *mut lan966x, vid: u16) {
    static void lan966x_vlan_cpu_del_cpu_vlan_mask(struct lan966x *lan966x, u16 vid)
    {
    __clear_bit(vid, lan966x.cpu_vlan_mask);
    }
#[no_mangle]
pub unsafe extern "C" fn lan966x_vlan_cpu_member_cpu_vlan_mask(lan966x: *mut lan966x, vid: u16) -> bool {
    bool lan966x_vlan_cpu_member_cpu_vlan_mask(struct lan966x *lan966x, u16 vid)
    {
    return test_bit(vid, lan966x.cpu_vlan_mask);
    }
#[no_mangle]
unsafe extern "C" fn lan966x_vlan_port_get_pvid(port: *mut lan966x_port) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn lan966x_vlan_port_remove_vid(port: *mut lan966x_port, vid: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn lan966x_vlan_port_rew_host(port: *mut lan966x_port) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_vlan_port_apply(port: *mut lan966x_port) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_vlan_port_del_vlan(port: *mut lan966x_port, vid: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_vlan_cpu_add_vlan(lan966x: *mut lan966x, vid: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_vlan_cpu_del_vlan(lan966x: *mut lan966x, vid: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_vlan_init(lan966x: *mut lan966x) {
