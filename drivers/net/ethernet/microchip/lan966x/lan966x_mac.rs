...
//! Source: drivers/net/ethernet/microchip/lan966x/lan966x_mac.c
#![no_std]
...
pub const LAN966X_MAC_COLUMNS: c_int = 4;
...
pub const MACACCESS_CMD_SYNC_GET_NEXT: c_int = 8;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lan966x_mac_entry {
    pub list: list_head,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lan966x_mac_raw_entry {
    pub mach: u32,
    pub macl: u32,
    pub maca: u32,
    pub processed: bool,
...
#[no_mangle]
unsafe extern "C" fn lan966x_mac_get_status(lan966x: *mut lan966x) -> c_int {
    static int lan966x_mac_get_status(struct lan966x *lan966x)
    {
    return lan_rd(lan966x, ANA_MACACCESS);
    }
#[no_mangle]
unsafe extern "C" fn lan966x_mac_wait_for_completion(lan966x: *mut lan966x) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_mac_cpu_learn(lan966x: *mut lan966x, addr: *const c_char, vid: u16) -> c_int {
    int lan966x_mac_cpu_learn(struct lan966x *lan966x, const char *addr, u16 vid)
    {
    return lan966x_mac_learn(lan966x, PGID_CPU, addr, vid, ENTRYTYPE_LOCKED);
    }
#[no_mangle]
pub unsafe extern "C" fn lan966x_mac_cpu_forget(lan966x: *mut lan966x, addr: *const c_char, vid: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_mac_init(lan966x: *mut lan966x) {
...
// Clear the MAC table
    ...
    {
    struct lan966x_mac_entry *res = core::ptr::null_mut();
    struct lan966x_mac_entry *mac_entry;
...
// Issue a read command
    ...
    {
    let mut info: switchdev_notifier_fdb_info = { 0 };
    info.addr = mac;
    info.vid = vid;
    info.offloaded = true;
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_mac_purge_entries(lan966x: *mut lan966x) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_mac_irq_handler(lan966x: *mut lan966x) -> irqreturn_t {
