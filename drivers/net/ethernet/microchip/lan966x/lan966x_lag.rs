...
//! Source: drivers/net/ethernet/microchip/lan966x/lan966x_lag.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lan966x_lag_set_aggr_pgids(lan966x: *mut lan966x) {
    static void lan966x_lag_set_aggr_pgids(struct lan966x *lan966x)
    {
    let mut visited: u32 = GENMASK(lan966x.num_phys_ports - 1, 0);
    int p, lag, i;
...
// Now, set PGIDs for each active LAG
    ...
    let mut num_active_ports: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn lan966x_lag_set_port_ids(lan966x: *mut lan966x) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_lag_update_ids(lan966x: *mut lan966x) {
    ...
    return 0;
    out:
    port.bond = core::ptr::null_mut();
    lan966x_lag_update_ids(lan966x);
    return err;
    }
#[no_mangle]
pub unsafe extern "C" fn lan966x_lag_port_leave(port: *mut lan966x_port, bond: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_lag_first_port(lag: *mut net_device, dev: *mut net_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_lag_get_mask(lan966x: *mut lan966x, bond: *mut net_device) -> u32 {
