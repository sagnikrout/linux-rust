...
//! Source: drivers/net/ethernet/microchip/lan966x/lan966x_port.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lan966x_wm_enc(value: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lan966x_port_link_down(port: *mut lan966x_port) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_port_link_up(port: *mut lan966x_port) {
    static void lan966x_port_link_up(struct lan966x_port *port)
    {
    struct lan966x_port_config *config = &port.config;
    struct lan966x *lan966x = port.lan966x;
    let mut speed: c_int = 0, mode = 0;
    let mut atop_wm: c_int = 0;
    switch (config.speed) {
    case SPEED_10:
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_port_config_down(port: *mut lan966x_port) {
    void lan966x_port_config_down(struct lan966x_port *port)
    {
    lan966x_port_link_down(port);
    }
#[no_mangle]
pub unsafe extern "C" fn lan966x_port_config_up(port: *mut lan966x_port) {
...
#[no_mangle]
pub unsafe extern "C" fn if(PHY_INTERFACE_MODE_2500BASEX: state->interface ==) -> else {
    ...
    {
    struct lan966x *lan966x = port.lan966x;
    let mut inband_aneg: bool = false;
    bool outband;
    let mut full_preamble: bool = false;
...
// Set default pcp and dei for untagged frames
    ...
    {
    let mut mode: u8 = LAN966X_PORT_REW_TAG_CTRL_CLASSIFIED;
    u8 pcp, dei;
    if (qos.enable)
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_port_init(port: *mut lan966x_port) {
