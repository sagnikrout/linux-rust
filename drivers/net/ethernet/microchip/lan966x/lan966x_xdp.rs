...
//! Source: drivers/net/ethernet/microchip/lan966x/lan966x_xdp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lan966x_xdp_setup(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_xdp(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_xdp_run(port: *mut lan966x_port, page: *mut page, data_len: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_xdp_present(lan966x: *mut lan966x) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_xdp_port_init(port: *mut lan966x_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_xdp_port_deinit(port: *mut lan966x_port) {
