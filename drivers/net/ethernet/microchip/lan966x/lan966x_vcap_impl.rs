...
//! Source: drivers/net/ethernet/microchip/lan966x/lan966x_vcap_impl.c
#![no_std]
...
pub const LAN966X_IS1_LOOKUPS: c_int = 3;
pub const LAN966X_IS2_LOOKUPS: c_int = 2;
pub const LAN966X_ES0_LOOKUPS: c_int = 1;
pub const LAN966X_STAT_ESDX_GRN_BYTES: c_uint = 0x300;
pub const LAN966X_STAT_ESDX_GRN_PKTS: c_uint = 0x301;
pub const LAN966X_STAT_ESDX_YEL_BYTES: c_uint = 0x302;
pub const LAN966X_STAT_ESDX_YEL_PKTS: c_uint = 0x303;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lan966x_vcap_cmd_cb {
    pub lan966x: *mut lan966x,
    pub instance: u32,
}

#[no_mangle]
unsafe extern "C" fn lan966x_vcap_read_update_ctrl(cb: *const lan966x_vcap_cmd_cb) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lan966x_vcap_wait_update(lan966x: *mut lan966x, instance: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_vcap_is1_cid_to_lookup(cid: c_int) -> c_int {
    static int lan966x_vcap_is1_cid_to_lookup(int cid)
    {
    let mut lookup: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn lan966x_vcap_is2_cid_to_lookup(cid: c_int) -> c_int {
...
// Collect all keysets for the port in a list
    ...
    u16 l3_proto)
    {
    let mut keysetlist: vcap_keyset_list = {};
...
#[no_mangle]
unsafe extern "C" fn lan966x_vcap_is2_is_first_chain(rule: *mut vcap_rule) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lan966x_vcap_cache_erase(admin: *mut vcap_admin) {
...
//
    ...
    struct lan966x_port *port = netdev_priv(dev);
    struct lan966x *lan966x = port.lan966x;
    let mut instance: c_int = admin.tgt_inst;
    u32 *keystr, *mskstr, *actstr;
    keystr = &admin.cache.keystream[start];
    mskstr = &admin.cache.maskstream[start];
    actstr = &admin.cache.actionstream[start];
...
#[no_mangle]
unsafe extern "C" fn lan966x_vcap_admin_free(admin: *mut vcap_admin) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_vcap_init(lan966x: *mut lan966x) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_vcap_deinit(lan966x: *mut lan966x) {
