...
//! Source: drivers/net/ethernet/microchip/lan966x/lan966x_police.c
#![no_std]
...
// 0-8 : 9 port policers
pub const POL_IDX_PORT: c_int = 0;
// Policer order: Serial (QoS -> Port -> VCAP)
pub const POL_ORDER: c_uint = 0x1d3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lan966x_tc_policer {
// kilobit per second
    pub rate: u32,
// bytes
    pub burst: u32,
...
#[no_mangle]
unsafe extern "C" fn lan966x_police_del(port: *mut lan966x_port, pol_idx: u16) {
