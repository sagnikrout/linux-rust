...
//! Source: drivers/net/ethernet/microchip/lan966x/lan966x_taprio.c
#![no_std]
...
pub const LAN966X_TAPRIO_TIMEOUT_MS: c_int = 1000;
pub const LAN966X_TAPRIO_ENTRIES_PER_PORT: c_int = 2;
// Minimum supported cycle time in nanoseconds

// Maximum supported cycle time in nanoseconds

// Total number of TAS GCL entries
pub const LAN966X_TAPRIO_NUM_GCL: c_int = 256;
...
#[no_mangle]
unsafe extern "C" fn lan966x_taprio_list_index(port: *mut lan966x_port, entry: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lan966x_taprio_list_state_get(port: *mut lan966x_port) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lan966x_taprio_shutdown(port: *mut lan966x_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_taprio_check(qopt: *mut tc_taprio_qopt_offload) -> c_int {
...
//
    ...
    let mut tmp: u64 = current_time - org_base_time;
    let mut rem: u32 = 0;
    if (tmp > cycle_time)
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_taprio_speed_set(port: *mut lan966x_port, speed: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_taprio_del(port: *mut lan966x_port) -> c_int {
    int lan966x_taprio_del(struct lan966x_port *port)
    {
    return lan966x_taprio_shutdown(port);
    }
#[no_mangle]
pub unsafe extern "C" fn lan966x_taprio_init(lan966x: *mut lan966x) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_taprio_deinit(lan966x: *mut lan966x) {
