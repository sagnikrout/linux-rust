...
//! Source: drivers/net/ethernet/microchip/lan966x/lan966x_mdb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lan966x_mdb_entry {
    pub list: list_head,
    pub mac: [c_uchar; ETH_ALEN],
    pub vid: u16,
    pub ports: u16,
    pub pgid: *mut lan966x_pgid_entry,
    pub cpu_copy: u8,
}

#[no_mangle]
pub unsafe extern "C" fn lan966x_mdb_init(lan966x: *mut lan966x) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_mdb_purge_mdb_entries(lan966x: *mut lan966x) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_mdb_purge_pgid_entries(lan966x: *mut lan966x) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_mdb_deinit(lan966x: *mut lan966x) {
    ...
    enum macaccess_entry_type type)
    {
    let mut cpu_port: bool = netif_is_bridge_master(mdb.obj.orig_dev);
    struct lan966x *lan966x = port.lan966x;
    struct lan966x_mdb_entry *mdb_entry;
    unsigned char mac[ETH_ALEN];
    let mut cpu_copy: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_mdb_write_entries(lan966x: *mut lan966x, vid: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_mdb_erase_entries(lan966x: *mut lan966x, vid: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_mdb_clear_entries(lan966x: *mut lan966x) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_mdb_restore_entries(lan966x: *mut lan966x) {
