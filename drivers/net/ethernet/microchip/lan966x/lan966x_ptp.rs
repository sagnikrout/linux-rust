...
//! Source: drivers/net/ethernet/microchip/lan966x/lan966x_ptp.c
#![no_std]
...
pub const LAN9X66_CLOCK_RATE: c_int = 165617754;
pub const LAN966X_MAX_PTP_ID: c_int = 512;
...
pub const TOD_ACC_PIN: c_uint = 0x7;
...
//
pub const LAN966X_VCAP_PTP_RULE_ID: c_int = 1000000;
...
#[no_mangle]
unsafe extern "C" fn lan966x_ptp_get_nominal_value() -> u64 {
...
#[no_mangle]
unsafe extern "C" fn lan966x_ptp_add_l2_rule(port: *mut lan966x_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_ptp_add_ipv4_rules(port: *mut lan966x_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_ptp_add_ipv6_rules(port: *mut lan966x_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_ptp_del_l2_rule(port: *mut lan966x_port) -> c_int {
    static int lan966x_ptp_del_l2_rule(struct lan966x_port *port)
    {
    return lan966x_ptp_del_trap(port, LAN966X_VCAP_L2_PTP_TRAP);
    }
#[no_mangle]
unsafe extern "C" fn lan966x_ptp_del_ipv4_rules(port: *mut lan966x_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_ptp_del_ipv6_rules(port: *mut lan966x_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_ptp_add_traps(port: *mut lan966x_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_ptp_del_traps(port: *mut lan966x_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_ptp_txtstamp_old_release(port: *mut lan966x_port) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_ptp_irq_handler(irq: c_int, args: *mut c_void) -> irqreturn_t {
    irqreturn_t lan966x_ptp_irq_handler(int irq, void *args)
    {
    let mut budget: c_int = LAN966X_MAX_PTP_ID;
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_ptp_ext_irq_handler(irq: c_int, args: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn lan966x_ptp_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
    static int lan966x_ptp_adjfine(struct ptp_clock_info *ptp, long scaled_ppm)
    {
    struct lan966x_phc *phc = container_of(ptp, struct lan966x_phc, info);
    struct lan966x *lan966x = phc.lan966x;
    unsigned long flags;
    let mut neg_adj: bool = 0;
    u64 tod_inc;
    u64 ref;
    if (!scaled_ppm)
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_ptp_gettime64(ptp: *mut ptp_clock_info, ts: *mut timespec64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_ptp_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_ptp_init(lan966x: *mut lan966x) -> c_int {
    int lan966x_ptp_init(struct lan966x *lan966x)
    {
    let mut tod_adj: u64 = lan966x_ptp_get_nominal_value();
    struct lan966x_port *port;
    int err, i;
    if (!lan966x.ptp)
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_ptp_deinit(lan966x: *mut lan966x) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_ptp_get_period_ps() -> u32 {
