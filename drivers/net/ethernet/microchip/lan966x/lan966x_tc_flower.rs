...
//! Source: drivers/net/ethernet/microchip/lan966x/lan966x_tc_flower.c
#![no_std]
...
pub const LAN966X_FORCE_UNTAGED: c_int = 3;
...
// This works for IS1->ES0
    ...
    let mut l3_proto: u16 = ETH_P_ALL;
...
// Force untag
    ...
    let mut err: c_int = -ENOENT, rule_id;
