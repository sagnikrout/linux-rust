...
//! Source: drivers/net/ethernet/microchip/lan966x/lan966x_fdma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_channel_active(lan966x: *mut lan966x) -> c_int {
    static int lan966x_fdma_channel_active(struct lan966x *lan966x)
    {
    return lan_rd(lan966x, FDMA_CH_ACTIVE);
    }
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_rx_free_pages(rx: *mut lan966x_rx) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_rx_free_page(rx: *mut lan966x_rx) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_rx_alloc_page_pool(rx: *mut lan966x_rx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_rx_alloc(rx: *mut lan966x_rx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_rx_start(rx: *mut lan966x_rx) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_rx_disable(rx: *mut lan966x_rx) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_rx_reload(rx: *mut lan966x_rx) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_tx_alloc(tx: *mut lan966x_tx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_tx_free(tx: *mut lan966x_tx) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_tx_activate(tx: *mut lan966x_tx) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_tx_disable(tx: *mut lan966x_tx) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_tx_reload(tx: *mut lan966x_tx) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_wakeup_netdev(lan966x: *mut lan966x) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_stop_netdev(lan966x: *mut lan966x) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_tx_clear_buf(lan966x: *mut lan966x, weight: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_rx_check_frame(rx: *mut lan966x_rx, src_port: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_napi_poll(napi: *mut napi_struct, weight: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_fdma_irq_handler(irq: c_int, args: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_get_next_dcb(tx: *mut lan966x_tx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_tx_start(tx: *mut lan966x_tx) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_fdma_xmit_xdpf(port: *mut lan966x_port, ptr: *mut c_void, len: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_fdma_xmit(skb: *mut sk_buff, ifh: *mut __be32, dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_get_max_mtu(lan966x: *mut lan966x) -> c_int {
    static int lan966x_fdma_get_max_mtu(struct lan966x *lan966x)
    {
    let mut max_mtu: c_int = 0;
    int i;
    for (i = 0; i < lan966x.num_phys_ports; ++i) {
    struct lan966x_port *port;
    int mtu;
...
#[no_mangle]
unsafe extern "C" fn lan966x_qsys_sw_status(lan966x: *mut lan966x) -> c_int {
    static int lan966x_qsys_sw_status(struct lan966x *lan966x)
    {
    return lan_rd(lan966x, QSYS_SW_STATUS(CPU_PORT));
    }
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_reload(lan966x: *mut lan966x, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan966x_fdma_get_max_frame(lan966x: *mut lan966x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __lan966x_fdma_reload(lan966x: *mut lan966x, max_mtu: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_fdma_change_mtu(lan966x: *mut lan966x) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_fdma_reload_page_pool(lan966x: *mut lan966x) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_fdma_netdev_init(lan966x: *mut lan966x, dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_fdma_netdev_deinit(lan966x: *mut lan966x, dev: *mut net_device) {
    void lan966x_fdma_netdev_deinit(struct lan966x *lan966x, struct net_device *dev)
    {
    if (lan966x.fdma_ndev == dev) {
    netif_napi_del(&lan966x.napi);
    lan966x.fdma_ndev = core::ptr::null_mut();
    }
    }
#[no_mangle]
pub unsafe extern "C" fn lan966x_fdma_init(lan966x: *mut lan966x) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan966x_fdma_deinit(lan966x: *mut lan966x) {
