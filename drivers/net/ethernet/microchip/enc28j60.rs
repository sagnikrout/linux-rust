...
pub const MAX_TX_RETRYCOUNT: c_int = 16;
    enum {
    RXFILTER_NORMAL,
    RXFILTER_MULTI,
    RXFILTER_PROMISC
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct enc28j60_net {
    pub netdev: *mut net_device,
    pub spi: *mut spi_device,
    pub lock: mutex,
    pub tx_skb: *mut sk_buff,
    pub tx_work: work_struct,
    pub setrx_work: work_struct,
    pub restart_work: work_struct,
    pub /: *mut *mut u8 bank; / current register bank selected,
    pub /: *mut *mut u16 next_pk_ptr; / next packet pointer within FIFO,
    pub /: *mut *mut u16 max_pk_counter; / statistics: max packet counter,
    pub tx_retry_count: u16,
    pub hw_enable: bool,
    pub full_duplex: bool,
    pub rxfilter: c_int,
    pub msg_enable: u32,
    pub spi_transfer_buf: [u8; SPI_TRANSFER_BUF_LEN],
}
...
//
#[no_mangle]
unsafe extern "C" fn spi_write_buf(priv: *mut enc28j60_net, len: c_int, data: *const u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn spi_read_op(priv: *mut enc28j60_net, op: u8, addr: u8) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn spi_write_op(priv: *mut enc28j60_net, op: u8, addr: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_soft_reset(priv: *mut enc28j60_net) {
...
//
#[no_mangle]
unsafe extern "C" fn enc28j60_set_bank(priv: *mut enc28j60_net, addr: u8) {
    static void enc28j60_set_bank(struct enc28j60_net *priv, u8 addr)
    {
    let mut b: u8 = (addr & BANK_MASK) >> 5;
...
//
#[no_mangle]
unsafe extern "C" fn nolock_reg_bfset(priv: *mut enc28j60_net, addr: u8, mask: u8) {
...
#[no_mangle]
unsafe extern "C" fn locked_reg_bfset(priv: *mut enc28j60_net, addr: u8, mask: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn nolock_reg_bfclr(priv: *mut enc28j60_net, addr: u8, mask: u8) {
...
#[no_mangle]
unsafe extern "C" fn locked_reg_bfclr(priv: *mut enc28j60_net, addr: u8, mask: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn nolock_regb_read(priv: *mut enc28j60_net, address: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn locked_regb_read(priv: *mut enc28j60_net, address: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nolock_regw_read(priv: *mut enc28j60_net, address: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn locked_regw_read(priv: *mut enc28j60_net, address: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nolock_regb_write(priv: *mut enc28j60_net, address: u8, data: u8) {
...
#[no_mangle]
unsafe extern "C" fn locked_regb_write(priv: *mut enc28j60_net, address: u8, data: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn nolock_regw_write(priv: *mut enc28j60_net, address: u8, data: u16) {
...
#[no_mangle]
unsafe extern "C" fn locked_regw_write(priv: *mut enc28j60_net, address: u8, data: u16) {
...
#[no_mangle]
unsafe extern "C" fn poll_ready(priv: *mut enc28j60_net, reg: u8, mask: u8, val: u8) -> c_int {
    static int poll_ready(struct enc28j60_net *priv, u8 reg, u8 mask, u8 val)
    {
    struct device *dev = &priv.spi.dev;
    let mut timeout: c_ulong = jiffies + msecs_to_jiffies(20);
...
//
#[no_mangle]
unsafe extern "C" fn wait_phy_ready(priv: *mut enc28j60_net) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn enc28j60_phy_read(priv: *mut enc28j60_net, address: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_phy_write(priv: *mut enc28j60_net, address: u8, data: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn enc28j60_set_hw_macaddr(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn enc28j60_set_mac_address(dev: *mut net_device, addr: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn enc28j60_dump_regs(priv: *mut enc28j60_net, msg: *const c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn erxrdpt_workaround(next_packet_ptr: u16, start: u16, end: u16) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn rx_packet_start(ptr: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nolock_rxfifo_init(priv: *mut enc28j60_net, start: u16, end: u16) {
...
#[no_mangle]
unsafe extern "C" fn nolock_txfifo_init(priv: *mut enc28j60_net, start: u16, end: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn enc28j60_lowpower(priv: *mut enc28j60_net, is_low: bool) {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_hw_init(priv: *mut enc28j60_net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_hw_enable(priv: *mut enc28j60_net) {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_hw_disable(priv: *mut enc28j60_net) {
...
//
#[no_mangle]
unsafe extern "C" fn enc28j60_read_tsv(priv: *mut enc28j60_net, tsv[TSV_SIZE]: u8) {
...
#[no_mangle]
unsafe extern "C" fn dump_packet(msg: *const c_char, len: c_int, data: *const c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn enc28j60_hw_rx(ndev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn enc28j60_get_free_rxfifo(priv: *mut enc28j60_net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(erxrd: erxwr ==) -> else {
    else if (erxwr == erxrd)
...
//
#[no_mangle]
unsafe extern "C" fn enc28j60_check_link_status(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_tx_clear(ndev: *mut net_device, err: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn enc28j60_rx_interrupt(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn enc28j60_hw_tx(priv: *mut enc28j60_net) {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_tx_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_tx_timeout(ndev: *mut net_device, txqueue: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn enc28j60_net_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_net_close(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn enc28j60_set_multicast_list(dev: *mut net_device) {
    static void enc28j60_set_multicast_list(struct net_device *dev)
    {
    struct enc28j60_net *priv = netdev_priv(dev);
    let mut oldfilter: c_int = priv.rxfilter;
...
#[no_mangle]
unsafe extern "C" fn enc28j60_setrx_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_restart_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_get_msglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_set_msglevel(dev: *mut net_device, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_chipset_init(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enc28j60_probe(spi: *mut spi_device) -> c_int {
...
//
    ret = request_threaded_irq(spi.irq, core::ptr::null_mut(), enc28j60_irq, IRQF_ONESHOT,
    DRV_NAME, priv);
    if (ret < 0) {
    if (netif_msg_probe(priv))
...
#[no_mangle]
unsafe extern "C" fn enc28j60_remove(spi: *mut spi_device) {
