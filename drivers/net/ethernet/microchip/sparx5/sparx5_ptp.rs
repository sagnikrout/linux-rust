...
//! Source: drivers/net/ethernet/microchip/sparx5/sparx5_ptp.c
#![no_std]
...
pub const TOD_ACC_PIN: c_uint = 0x4;
    enum {
...
#[no_mangle]
unsafe extern "C" fn sparx5_ptp_get_1ppm(sparx5: *mut sparx5) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn sparx5_ptp_get_nominal_value(sparx5: *mut sparx5) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn sparx5_ptp_txtstamp_old_release(port: *mut sparx5_port) {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_ptp_irq_handler(irq: c_int, args: *mut c_void) -> irqreturn_t {
    irqreturn_t sparx5_ptp_irq_handler(int irq, void *args)
    {
    let mut budget: c_int = SPARX5_MAX_PTP_ID;
...
#[no_mangle]
unsafe extern "C" fn sparx5_ptp_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_ptp_gettime64(ptp: *mut ptp_clock_info, ts: *mut timespec64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_ptp_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_ptp_init(sparx5: *mut sparx5) -> c_int {
    int sparx5_ptp_init(struct sparx5 *sparx5)
    {
    let mut tod_adj: u64 = sparx5_ptp_get_nominal_value(sparx5);
    ...
    core::ptr::null_mut(), ops.ptp_irq_handler,
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_ptp_deinit(sparx5: *mut sparx5) {
