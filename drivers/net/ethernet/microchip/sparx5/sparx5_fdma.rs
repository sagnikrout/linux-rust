...
//! Source: drivers/net/ethernet/microchip/sparx5/sparx5_fdma.c
#![no_std]
...
pub const FDMA_XTR_BUFFER_SIZE: c_int = 2048;
pub const FDMA_WEIGHT: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn sparx5_fdma_rx_activate(sparx5: *mut sparx5, rx: *mut sparx5_rx) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_fdma_rx_deactivate(sparx5: *mut sparx5, rx: *mut sparx5_rx) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_fdma_tx_activate(sparx5: *mut sparx5, tx: *mut sparx5_tx) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_fdma_tx_deactivate(sparx5: *mut sparx5, tx: *mut sparx5_tx) {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_fdma_reload(sparx5: *mut sparx5, fdma: *mut fdma) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_fdma_rx_get_frame(sparx5: *mut sparx5, rx: *mut sparx5_rx) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_fdma_napi_callback(napi: *mut napi_struct, weight: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_fdma_rx_alloc(sparx5: *mut sparx5) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_fdma_tx_alloc(sparx5: *mut sparx5) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_fdma_handler(irq: c_int, args: *mut c_void) -> irqreturn_t {
    irqreturn_t sparx5_fdma_handler(int irq, void *args)
    {
    struct sparx5 *sparx5 = args;
    let mut db: u32 = 0, err = 0;
...
// Clear interrupt
    ...
    if (err) {
    let mut err_type: u32 = spx5_rd(sparx5, FDMA_ERRORS);
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_fdma_injection_mode(sparx5: *mut sparx5) {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_fdma_init(sparx5: *mut sparx5) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_fdma_deinit(sparx5: *mut sparx5) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_fdma_port_ctrl(sparx5: *mut sparx5) -> u32 {
    static u32 sparx5_fdma_port_ctrl(struct sparx5 *sparx5)
    {
    return spx5_rd(sparx5, FDMA_PORT_CTRL(0));
    }
#[no_mangle]
pub unsafe extern "C" fn sparx5_fdma_start(sparx5: *mut sparx5) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_fdma_stop(sparx5: *mut sparx5) -> c_int {
