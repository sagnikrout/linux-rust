...
//! Source: drivers/net/ethernet/microchip/sparx5/sparx5_mactable.c
#![no_std]
...
pub const MAC_ENTRY_ADDR_TYPE_UPSID_PN: c_int = 0;
pub const MAC_ENTRY_ADDR_TYPE_UPSID_CPU_OR_INT: c_int = 1;
pub const MAC_ENTRY_ADDR_TYPE_GLAG: c_int = 2;
pub const MAC_ENTRY_ADDR_TYPE_MC_IDX: c_int = 3;
pub const TABLE_UPDATE_SLEEP_US: c_int = 10;
pub const TABLE_UPDATE_TIMEOUT_US: c_int = 100000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sparx5_mact_entry {
    pub list: list_head,
...
#[no_mangle]
unsafe extern "C" fn sparx5_mact_get_status(sparx5: *mut sparx5) -> c_int {
    static int sparx5_mact_get_status(struct sparx5 *sparx5)
    {
    return spx5_rd(sparx5, LRN_COMMON_ACCESS_CTRL);
    }
#[no_mangle]
unsafe extern "C" fn sparx5_mact_wait_for_completion(sparx5: *mut sparx5) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_mc_unsync(dev: *mut net_device, addr: *const c_uchar) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_mc_sync(dev: *mut net_device, addr: *const c_uchar) -> c_int {
...
// Issue an unlearn command
    ...
    {
    struct sparx5_mact_entry *mact_entry;
    struct sparx5_mact_entry *res = core::ptr::null_mut();
    ...
    call_switchdev_notifiers(type, dev, &info.info, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn sparx5_mact_pull_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_set_ageing(sparx5: *mut sparx5, msecs: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_mact_init(sparx5: *mut sparx5) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_mact_deinit(sparx5: *mut sparx5) {
