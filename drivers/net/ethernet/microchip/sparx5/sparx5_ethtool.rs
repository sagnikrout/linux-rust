...
//! Source: drivers/net/ethernet/microchip/sparx5/sparx5_ethtool.c
#![no_std]
...
pub const SPX5_PORT_POLICER_DROPS: c_int = 0;
// Add a potentially wrapping 32 bit value to a 64 bit counter
#[no_mangle]
unsafe extern "C" fn sparx5_update_counter(cnt: *mut u64, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_get_queue_sys_stats(sparx5: *mut sparx5, portno: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_get_ana_ac_stats_stats(sparx5: *mut sparx5, portno: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_get_device_stats(sparx5: *mut sparx5, portno: c_int) {
    static void sparx5_get_device_stats(struct sparx5 *sparx5, int portno)
    {
    u64 *portstats = &sparx5.stats[portno * sparx5.num_stats];
    let mut tinst: u32 = sparx5_port_dev_index(sparx5, portno);
    let mut dev: u32 = sparx5_to_high_dev(sparx5, portno);
    void __iomem *inst;
...
#[no_mangle]
unsafe extern "C" fn sparx5_get_asm_stats(sparx5: *mut sparx5, portno: c_int) {
    ...
    let mut portno: c_int = port.portno;
    void __iomem *inst;
    u64 *portstats;
    portstats = &sparx5.stats[portno * sparx5.num_stats];
...
#[no_mangle]
unsafe extern "C" fn sparx5_get_sset_count(ndev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_get_sset_strings(ndev: *mut net_device, sset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_update_port_stats(sparx5: *mut sparx5, portno: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_update_stats(sparx5: *mut sparx5) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_check_stats_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_config_stats(sparx5: *mut sparx5) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_config_port_stats(sparx5: *mut sparx5, portno: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_stats_init(sparx5: *mut sparx5) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_stats_deinit(sparx5: *mut sparx5) {
