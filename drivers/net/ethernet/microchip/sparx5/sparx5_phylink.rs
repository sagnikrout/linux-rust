...
//! Source: drivers/net/ethernet/microchip/sparx5/sparx5_phylink.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn port_conf_has_changed(a: *mut sparx5_port_config, b: *mut sparx5_port_config) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sparx5_pcs_aneg_restart(pcs: *mut phylink_pcs) {
