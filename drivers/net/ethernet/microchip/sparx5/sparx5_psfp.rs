...
//! Source: drivers/net/ethernet/microchip/sparx5/sparx5_psfp.c
#![no_std]
...
pub const SPX5_PSFP_SF_CNT: c_int = 1024;
pub const SPX5_PSFP_SG_CONFIG_CHANGE_SLEEP: c_int = 1000;
pub const SPX5_PSFP_SG_CONFIG_CHANGE_TIMEO: c_int = 100000;
...
#[no_mangle]
unsafe extern "C" fn sparx5_psfp_sf_get(sparx5: *mut sparx5, id: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_psfp_sf_put(sparx5: *mut sparx5, id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_psfp_sg_get(sparx5: *mut sparx5, idx: u32, id: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_psfp_sg_put(sparx5: *mut sparx5, id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_psfp_fm_get(sparx5: *mut sparx5, idx: u32, id: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_psfp_fm_put(sparx5: *mut sparx5, id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_psfp_isdx_get_sf(sparx5: *mut sparx5, isdx: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_psfp_isdx_get_fm(sparx5: *mut sparx5, isdx: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_psfp_sf_get_sg(sparx5: *mut sparx5, sfid: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_isdx_conf_set(sparx5: *mut sparx5, isdx: u32, sfid: u32, fmid: u32) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_psfp_ipv_to_ips(ipv: i32) -> u32 {
    static u32 sparx5_psfp_ipv_to_ips(s32 ipv)
    {
    return ipv > 0 ? (ipv | BIT(3)) : 0;
    }
#[no_mangle]
unsafe extern "C" fn sparx5_psfp_sgid_get_status(sparx5: *mut sparx5) -> c_int {
    static int sparx5_psfp_sgid_get_status(struct sparx5 *sparx5)
    {
    return spx5_rd(sparx5, ANA_AC_SG_ACCESS_CTRL);
    }
#[no_mangle]
unsafe extern "C" fn sparx5_psfp_sgid_wait_for_completion(sparx5: *mut sparx5) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_psfp_sg_config_change(sparx5: *mut sparx5, id: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_psfp_sf_del(sparx5: *mut sparx5, id: u32) -> c_int {
    int sparx5_psfp_sf_del(struct sparx5 *sparx5, u32 id)
    {
    let mut sf: sparx5_psfp_sf = { 0 };
    sparx5_psfp_sf_set(sparx5, id, &sf);
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_psfp_sg_del(sparx5: *mut sparx5, id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_psfp_fm_del(sparx5: *mut sparx5, id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_psfp_init(sparx5: *mut sparx5) {
