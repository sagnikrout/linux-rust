...
//! Source: drivers/net/ethernet/microchip/sparx5/sparx5_netdev.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __ifh_encode_bitfield(ifh: *mut c_void, value: u64, pos: u32, width: u32) {
    static void __ifh_encode_bitfield(void *ifh, u64 value, u32 pos, u32 width)
    {
    u8 *ifh_hdr = ifh;
// Calculate the Start IFH byte position of this IFH bit position
    let mut byte: u32 = (35 - (pos / 8));
// Calculate the Start bit position in the Start IFH byte
    let mut bit: u32 = (pos % 8);
    let mut encode: u64 = GENMASK_ULL(bit + width - 1, bit) & (value << bit);
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_set_port_ifh(sparx5: *mut sparx5, ifh_hdr: *mut c_void, portno: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_set_port_ifh_rew_op(ifh_hdr: *mut c_void, rew_op: u32) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_port_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_port_stop(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_set_mac_address(dev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_netdevice_check(dev: *const net_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_register_netdevs(sparx5: *mut sparx5) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_destroy_netdevs(sparx5: *mut sparx5) {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_unregister_netdevs(sparx5: *mut sparx5) {
