...
//! Source: drivers/net/ethernet/microchip/sparx5/sparx5_switchdev.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sparx5_switchdev_event_work {
...
#[no_mangle]
unsafe extern "C" fn sparx5_port_update_mcast_ip_flood(port: *mut sparx5_port, flood_flag: bool) {
    static void sparx5_port_update_mcast_ip_flood(struct sparx5_port *port, bool flood_flag)
    {
    let mut should_flood: bool = flood_flag || port.is_mrouter;
...
// Enable uc/mc/bc flooding
    ...
    let mut flags: switchdev_brport_flags = {0};
    struct sparx5 *sparx5 = port.sparx5;
    switchdev_bridge_port_unoffload(port.ndev, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    clear_bit(port.portno, sparx5.bridge_mask);
    if (bitmap_empty(sparx5.bridge_mask, SPX5_PORTS))
    sparx5.hw_bridge_dev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn sparx5_port_add_addr(dev: *mut net_device, up: bool) -> c_int {
    static int sparx5_port_add_addr(struct net_device *dev, bool up)
    {
    struct sparx5_port *port = netdev_priv(dev);
    struct sparx5 *sparx5 = port.sparx5;
    let mut vid: u16 = port.pvid;
    if (up)
    sparx5_mact_learn(sparx5, sparx5_get_pgid(sparx5, PGID_CPU),
...
#[no_mangle]
unsafe extern "C" fn sparx5_switchdev_bridge_fdb_event_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_schedule_work(work: *mut work_struct) {
...
// entry_out = entry;
    ...
    u16 vid)
    {
    struct sparx5_mdb_entry *e, *found = core::ptr::null_mut();
    mutex_lock(&sparx5.mdb_lock);
    list_for_each_entry(e, &sparx5.mdb_entries, list) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_cpu_copy_ena(spx5: *mut sparx5, pgid: u16, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_register_notifier_blocks(s5: *mut sparx5) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_unregister_notifier_blocks(s5: *mut sparx5) {
