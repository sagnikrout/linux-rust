...
//! Source: drivers/net/ethernet/microchip/sparx5/sparx5_dcb.c
#![no_std]
...
// Default priority checks
    ...
    err = -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(SPX5_PRIOS: app->priority >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn sparx5_dcb_apptrust_contains(portno: c_int, selector: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sparx5_dcb_app_update(dev: *mut net_device) -> c_int {
    ...
    let mut qos: sparx5_port_qos = {0};
    let mut app_itr: dcb_app = {0};
...
#[no_mangle]
unsafe extern "C" fn sparx5_dcb_ieee_delapp(dev: *mut net_device, app: *mut dcb_app) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_dcb_ieee_setapp(dev: *mut net_device, app: *mut dcb_app) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_dcb_delrewr(dev: *mut net_device, app: *mut dcb_app) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sparx5_dcb_setrewr(dev: *mut net_device, app: *mut dcb_app) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sparx5_dcb_init(sparx5: *mut sparx5) -> c_int {
