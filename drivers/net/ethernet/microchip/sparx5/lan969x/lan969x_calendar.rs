...
//! Source: drivers/net/ethernet/microchip/sparx5/lan969x/lan969x_calendar.c
#![no_std]
...
pub const LAN969X_DSM_CAL_DEVS_PER_TAXI: c_int = 10;
pub const LAN969X_DSM_CAL_TAXIS: c_int = 5;
...
#[no_mangle]
unsafe extern "C" fn lan969x_dsm_cal_idx_get(calendar: *mut u32, cal_len: u32, cal_idx: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan969x_dsm_cal_get_dev(speed: c_int) -> enum lan969x_dsm_cal_dev {
...
#[no_mangle]
unsafe extern "C" fn lan969x_dsm_cal_get_speed(dev: enum lan969x_dsm_cal_dev) -> c_int {
...
// Maximum bandwidth for this taxi
    ...
    let mut portno: u32 = data.taxi_ports[i];
...
//
    for (int i = 0; i < LAN969X_DSM_CAL_DEVS_PER_TAXI; i++) {
    let mut taxi_speed: u32 = data.taxi_speeds[i];
...
// Search for a calendar length that fits all active devices.
    ...
    let mut bw_per_slot: u32 = taxi_bw / cal_len;
    n_slots = 0;
