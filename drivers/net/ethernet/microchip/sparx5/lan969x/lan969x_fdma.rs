...
//! Source: drivers/net/ethernet/microchip/sparx5/lan969x/lan969x_fdma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lan969x_fdma_get_next_dcb(tx: *mut sparx5_tx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan969x_fdma_tx_clear_buf(sparx5: *mut sparx5, weight: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lan969x_fdma_free_pages(rx: *mut sparx5_rx) {
...
#[no_mangle]
unsafe extern "C" fn lan969x_fdma_rx_alloc(sparx5: *mut sparx5) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan969x_fdma_tx_alloc(sparx5: *mut sparx5) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan969x_fdma_rx_init(sparx5: *mut sparx5) {
...
#[no_mangle]
unsafe extern "C" fn lan969x_fdma_tx_init(sparx5: *mut sparx5) {
...
#[no_mangle]
pub unsafe extern "C" fn lan969x_fdma_napi_poll(napi: *mut napi_struct, weight: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan969x_fdma_init(sparx5: *mut sparx5) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lan969x_fdma_deinit(sparx5: *mut sparx5) -> c_int {
