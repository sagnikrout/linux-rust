...
//! Source: drivers/net/ethernet/microchip/vcap/vcap_api_kunit.c
#![no_std]
...
// implementation
//
pub const TEST_BUF_CNT: c_int = 100;
pub const TEST_BUF_SZ: c_int = 350;
pub const STREAMWSIZE: c_int = 64;
    ...
    let mut test_netdev: static struct net_device = {};
...
// Callback used by the VCAP API
#[no_mangle]
unsafe extern "C" fn test_cache_erase(admin: *mut vcap_admin) {
...
#[no_mangle]
unsafe extern "C" fn vcap_test_api_init(admin: *mut vcap_admin) {
...
// Helper function to create a rule of a specific size
    ...
    let mut keyset: enum vcap_keyfield_set = VCAP_KFS_NO_VALUE;
    let mut actionset: enum vcap_actionfield_set = VCAP_AFS_NO_VALUE;
    int ret;
// init before testing
    memset(test_updateaddr, 0, sizeof(test_updateaddr));
    test_updateaddridx = 0;
...
// Allocate the rule
    ...
    id);
    KUNIT_EXPECT_PTR_NE(test, core::ptr::null_mut(), rule);
...
#[no_mangle]
unsafe extern "C" fn test_init_rule_deletion() {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_set_bit_1_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_set_bit_0_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_iterator_init_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_iterator_next_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_encode_typegroups_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_encode_bit_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_encode_field_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_encode_short_field_test(test: *mut kunit) {
    static void vcap_api_encode_short_field_test(struct kunit *test)
    {
    struct vcap_stream_iter iter;
    let mut sw_width: c_int = 21;
    u32 stream[6] = {0};
...
#[no_mangle]
unsafe extern "C" fn vcap_api_encode_keyfield_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_encode_max_keyfield_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_encode_actionfield_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_keyfield_typegroup_test(test: *mut kunit) {
    ...
    KUNIT_EXPECT_PTR_NE(test, core::ptr::null_mut(), tg);
    ...
    KUNIT_EXPECT_PTR_EQ(test, core::ptr::null_mut(), tg);
    }
#[no_mangle]
unsafe extern "C" fn vcap_api_actionfield_typegroup_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_vcap_keyfields_test(test: *mut kunit) {
    ...
    KUNIT_EXPECT_PTR_NE(test, core::ptr::null_mut(), ft);
// Keyset that is not available and within the maximum keyset enum value
    ...
    KUNIT_EXPECT_PTR_EQ(test, core::ptr::null_mut(), ft);
...
#[no_mangle]
unsafe extern "C" fn vcap_api_vcap_actionfields_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_encode_rule_keyset_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_encode_rule_actionset_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_free_ckf(rule: *mut vcap_rule) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_rule_add_keyvalue_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_free_caf(rule: *mut vcap_rule) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_rule_add_actionvalue_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_rule_find_keyset_basic_test(test: *mut kunit) {
    static void vcap_api_rule_find_keyset_basic_test(struct kunit *test)
    {
    let mut matches: vcap_keyset_list = {};
    struct vcap_admin admin = {
    .vtype = VCAP_TYPE_IS2,
    };
    struct vcap_rule_internal ri = {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_rule_find_keyset_failed_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_rule_find_keyset_many_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_encode_rule_test(test: *mut kunit) {
...
// Data used by VCAP Library callback
    ...
    struct vcap_rule *rule;
    struct vcap_rule_internal *ri;
    let mut vcap_chain_id: c_int = 8000000;
    let mut user: enum vcap_user = VCAP_USER_VCAP_UTIL;
    let mut priority: u16 = 10;
    let mut id: c_int = 100;
    int ret;
    ...
    let mut port_mask_rng_value: u32 = 0x05;
    let mut port_mask_rng_mask: u32 = 0x0f;
    let mut igr_port_mask_value: u32 = 0xffabcd01;
    let mut igr_port_mask_mask: u32 = ~0;
...
#[no_mangle]
unsafe extern "C" fn vcap_api_set_rule_counter_test(test: *mut kunit) {
    ...
    let mut ctr: vcap_counter = { .value = 0, .sticky = false};
    let mut ctr2: vcap_counter = { .value = 101, .sticky = true};
    int ret;
    vcap_test_api_init(&is2_admin);
...
#[no_mangle]
unsafe extern "C" fn vcap_api_get_rule_counter_test(test: *mut kunit) {
    ...
    let mut ctr: vcap_counter = {};
    let mut ctr2: vcap_counter = {};
    int ret;
    vcap_test_api_init(&is2_admin);
...
#[no_mangle]
unsafe extern "C" fn vcap_api_rule_insert_in_order_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_rule_insert_reverse_order_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_rule_remove_at_end_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_rule_remove_in_middle_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_rule_remove_in_front_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_next_lookup_basic_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_next_lookup_advanced_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_filter_unsupported_keys_test(test: *mut kunit) {
...
// Drop unsupported keys from the rule
    ret = vcap_filter_rule_keys(&ri.data, core::ptr::null_mut(), 0, true);
    KUNIT_EXPECT_EQ(test, 0, ret);
...
#[no_mangle]
unsafe extern "C" fn vcap_api_filter_keylist_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_rule_chain_path_test(test: *mut kunit) {
