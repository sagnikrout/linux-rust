...
//! Source: drivers/net/ethernet/microchip/vcap/vcap_api_debugfs_kunit.c
#![no_std]
...
pub unsafe extern "C" fn __printf(_arg: 2, _arg: 3) -> static {
    static __printf(2, 3)
#[no_mangle]
pub unsafe extern "C" fn test_prf(out: *mut c_void, fmt: *const c_char, ...) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_addr_keyset_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_show_admin_raw_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_show_admin_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn vcap_api_show_admin_rule_test(test: *mut kunit) {
