...
//! Source: drivers/net/ethernet/microchip/encx24j600-regmap.c
#![no_std]
...
//
    ...
    {
    let mut ret: c_int = 0;
    let mut bank_opcode: c_int = BANK_SELECT(bank);
...
#[no_mangle]
unsafe extern "C" fn regmap_lock_mutex(context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn regmap_unlock_mutex(context: *mut c_void) {
    ...
    {
    struct encx24j600_context *ctx = context;
    let mut banked_reg: u8 = reg & ADDR_MASK;
    let mut bank: u8 = ((reg & BANK_MASK) >> BANK_SHIFT);
    let mut cmd: u8 = RCRU;
    let mut ret: c_int = 0;
    let mut i: c_int = 0;
    u8 tx_buf[2];
...
//
    ...
    struct encx24j600_context *ctx = context;
    let mut ret: c_int = 0;
    let mut set_mask: c_uint = mask & val;
    let mut clr_mask: c_uint = mask & ~val;
...
#[no_mangle]
pub unsafe extern "C" fn regmap_encx24j600_spi_read(context: *mut c_void, reg: u8, data: *mut u8, count: usize) -> c_int {
    ...
    {
    let mut reg: u8 = *(const u8 *)reg_buf;
    if (reg_size != 1) {
...
#[no_mangle]
unsafe extern "C" fn encx24j600_regmap_readable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn encx24j600_regmap_writeable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn encx24j600_regmap_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn encx24j600_regmap_precious(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn encx24j600_phymap_readable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn encx24j600_phymap_writeable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn encx24j600_phymap_volatile(dev: *mut device, reg: c_uint) -> bool {
