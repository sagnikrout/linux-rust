...
//! Source: drivers/net/ethernet/wiznet/w5100-spi.c
#![no_std]
...
pub const W5100_SPI_WRITE_OPCODE: c_uint = 0xf0;
pub const W5100_SPI_READ_OPCODE: c_uint = 0x0f;
#[no_mangle]
unsafe extern "C" fn w5100_spi_read(ndev: *mut net_device, addr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w5100_spi_write(ndev: *mut net_device, addr: u32, data: u8) -> c_int {
    static int w5100_spi_write(struct net_device *ndev, u32 addr, u8 data)
    {
    struct spi_device *spi = to_spi_device(ndev.dev.parent);
    u8 cmd[4] = { W5100_SPI_WRITE_OPCODE, addr >> 8, addr & 0xff, data};
    return spi_write_then_read(spi, cmd, sizeof(cmd), core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn w5100_spi_read16(ndev: *mut net_device, addr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w5100_spi_write16(ndev: *mut net_device, addr: u32, data: u16) -> c_int {
    ...
    int i;
    for (i = 0; i < len; i++) {
    let mut ret: c_int = w5100_spi_read(ndev, addr + i);
    if (ret < 0)
    return ret;
    buf[i] = ret;
    }
    ...
    int i;
    for (i = 0; i < len; i++) {
    let mut ret: c_int = w5100_spi_write(ndev, addr + i, buf[i]);
    if (ret)
    return ret;
    }
    return 0;
...
pub const W5200_SPI_WRITE_OPCODE: c_uint = 0x80;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct w5200_spi_priv {
// Serialize access to cmd_buf
    pub cmd_lock: mutex,
// DMA (thus cache coherency maintenance) requires the
// transfer buffers to live in their own cache lines.
//
    pub ____cacheline_aligned: u8 cmd_buf[4],
}
...
#[no_mangle]
unsafe extern "C" fn w5200_spi_init(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w5200_spi_read(ndev: *mut net_device, addr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w5200_spi_write(ndev: *mut net_device, addr: u32, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w5200_spi_read16(ndev: *mut net_device, addr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w5200_spi_write16(ndev: *mut net_device, addr: u32, data: u16) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct w5500_spi_priv {
// Serialize access to cmd_buf
    pub cmd_lock: mutex,
// DMA (thus cache coherency maintenance) requires the
// transfer buffers to live in their own cache lines.
//
    pub ____cacheline_aligned: u8 cmd_buf[3],
}
...
#[no_mangle]
unsafe extern "C" fn w5500_spi_init(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w5500_spi_read(ndev: *mut net_device, addr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w5500_spi_write(ndev: *mut net_device, addr: u32, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w5500_spi_read16(ndev: *mut net_device, addr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w5500_spi_write16(ndev: *mut net_device, addr: u32, data: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w5100_spi_probe(spi: *mut spi_device) -> c_int {
    static int w5100_spi_probe(struct spi_device *spi)
    {
    const struct w5100_ops *ops;
    kernel_ulong_t driver_data;
    const void *mac = core::ptr::null_mut();
    u8 tmpmac[ETH_ALEN];
    int priv_size;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn w5100_spi_remove(spi: *mut spi_device) {
