...
//! Source: drivers/net/ethernet/samsung/sxgbe/sxgbe_main.c
#![no_std]
...
pub const DMA_TX_SIZE: c_int = 512;
pub const DMA_RX_SIZE: c_int = 1024;
pub const TC_DEFAULT: c_int = 64;

// The default timer value as per the sxgbe specification 1 sec(1000 ms)
pub const SXGBE_DEFAULT_LPI_TIMER: c_int = 1000;
    let mut debug: static int = -1;
    let mut eee_timer: static int = SXGBE_DEFAULT_LPI_TIMER;
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_verify_args() {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_enable_eee_mode(priv: *const sxgbe_priv_data) {
...
#[no_mangle]
pub unsafe extern "C" fn sxgbe_disable_eee_mode(priv: *const *const sxgbe_priv_data) {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_eee_ctrl_timer(t: *mut timer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sxgbe_eee_init(priv: *const *const sxgbe_priv_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_eee_adjust(priv: *const sxgbe_priv_data) {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_clk_csr_set(priv: *mut sxgbe_priv_data) {
    static void sxgbe_clk_csr_set(struct sxgbe_priv_data *priv)
    {
    let mut clk_rate: u32 = clk_get_rate(priv.sxgbe_clk);
...
#[no_mangle]
pub unsafe extern "C" fn if(SXGBE_CSR_F_250M: clk_rate <=) -> else {
    else if (clk_rate <= SXGBE_CSR_F_250M)
    priv.clk_csr = SXGBE_CSR_150_250M;
#[no_mangle]
pub unsafe extern "C" fn if(SXGBE_CSR_F_300M: clk_rate <=) -> else {
    else if (clk_rate <= SXGBE_CSR_F_300M)
    priv.clk_csr = SXGBE_CSR_250_300M;
#[no_mangle]
pub unsafe extern "C" fn if(SXGBE_CSR_F_350M: clk_rate <=) -> else {
    else if (clk_rate <= SXGBE_CSR_F_350M)
    priv.clk_csr = SXGBE_CSR_300_350M;
#[no_mangle]
pub unsafe extern "C" fn if(SXGBE_CSR_F_400M: clk_rate <=) -> else {
    else if (clk_rate <= SXGBE_CSR_F_400M)
    priv.clk_csr = SXGBE_CSR_350_400M;
#[no_mangle]
pub unsafe extern "C" fn if(SXGBE_CSR_F_500M: clk_rate <=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn sxgbe_tx_avail(queue: *mut sxgbe_tx_queue, tx_qsize: c_int) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_init_phy(ndev: *mut net_device) -> c_int {
    ...
    let mut phy_iface: c_int = priv.plat.interface;
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_clear_descriptors(priv: *mut sxgbe_priv_data) {
    static void sxgbe_clear_descriptors(struct sxgbe_priv_data *priv)
    {
    int i, j;
    let mut txsize: c_uint = priv.dma_tx_size;
    let mut rxsize: c_uint = priv.dma_rx_size;
...
// allocate memory for RX descriptors
    ...
    if (rx_ring.dma_rx == core::ptr::null_mut())
    return -ENOMEM;
...
//
#[no_mangle]
unsafe extern "C" fn init_dma_desc_rings(netd: *mut net_device) -> c_int {
    static int init_dma_desc_rings(struct net_device *netd)
    {
    int queue_num, ret;
    struct sxgbe_priv_data *priv = netdev_priv(netd);
    let mut tx_rsize: c_int = priv.dma_tx_size;
    let mut rx_rsize: c_int = priv.dma_rx_size;
...
#[no_mangle]
unsafe extern "C" fn tx_free_ring_skbufs(txqueue: *mut sxgbe_tx_queue) {
    ...
    txqueue.tx_skbuff[dma_desc] = core::ptr::null_mut();
    txqueue.tx_skbuff_dma[dma_desc] = 0;
    }
    }
#[no_mangle]
unsafe extern "C" fn dma_free_tx_skbufs(priv: *mut sxgbe_priv_data) {
...
#[no_mangle]
unsafe extern "C" fn free_dma_desc_resources(priv: *mut sxgbe_priv_data) {
...
#[no_mangle]
unsafe extern "C" fn txring_mem_alloc(priv: *mut sxgbe_priv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rxring_mem_alloc(priv: *mut sxgbe_priv_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_mtl_operation_mode(priv: *mut sxgbe_priv_data) {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_tx_queue_clean(tqueue: *mut sxgbe_tx_queue) {
    static void sxgbe_tx_queue_clean(struct sxgbe_tx_queue *tqueue)
    {
    struct sxgbe_priv_data *priv = tqueue.priv_ptr;
    let mut tx_rsize: c_uint = priv.dma_tx_size;
    struct netdev_queue *dev_txq;
    let mut queue_no: u8 = tqueue.queue_no;
    ...
    let mut entry: c_uint = tqueue.dirty_tx % tx_rsize;
...
// Check if the descriptor is owned by the DMA.
    ...
    if (likely(skb)) {
    dev_kfree_skb(skb);
    tqueue.tx_skbuff[entry] = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_tx_all_clean(priv: *const *const sxgbe_priv_data) {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_restart_tx_queue(priv: *mut sxgbe_priv_data, queue_num: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_reset_all_tx_queues(priv: *mut sxgbe_priv_data) {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_get_hw_features(priv: *const *const sxgbe_priv_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_check_ether_addr(priv: *mut sxgbe_priv_data) {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_init_dma_engine(priv: *mut sxgbe_priv_data) -> c_int {
    static int sxgbe_init_dma_engine(struct sxgbe_priv_data *priv)
    {
    let mut pbl: c_int = DEFAULT_DMA_PBL, fixed_burst = 0, burst_map = 0;
    int queue_num;
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_init_mtl_engine(priv: *mut sxgbe_priv_data) {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_disable_mtl_engine(priv: *mut sxgbe_priv_data) {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_tx_timer(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_tx_init_coalesce(priv: *mut sxgbe_priv_data) {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_tx_del_timer(priv: *mut sxgbe_priv_data) {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_open(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_release(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t sxgbe_xmit(struct sk_buff *skb, struct net_device *dev)
    {
    unsigned int entry, frag_num;
    let mut cksum_flag: c_int = 0;
    struct netdev_queue *dev_txq;
    let mut txq_index: unsigned = skb_get_queue_mapping(skb);
    struct sxgbe_priv_data *priv = netdev_priv(dev);
    let mut tx_rsize: c_uint = priv.dma_tx_size;
    struct sxgbe_tx_queue *tqueue = priv.txq[txq_index];
    struct sxgbe_tx_norm_desc *tx_desc, *first_desc;
    struct sxgbe_tx_ctxt_desc *ctxt_desc = core::ptr::null_mut();
    let mut nr_frags: c_int = skb_shinfo(skb).nr_frags;
    let mut no_pagedlen: c_int = skb_headlen(skb);
    let mut is_jumbo: c_int = 0;
    let mut cur_mss: u16 = skb_shinfo(skb).gso_size;
    let mut ctxt_desc_req: u32 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_rx_refill(priv: *mut sxgbe_priv_data) {
    static void sxgbe_rx_refill(struct sxgbe_priv_data *priv)
    {
    let mut rxsize: c_uint = priv.dma_rx_size;
    let mut bfsize: c_int = priv.dma_buf_sz;
    let mut qnum: u8 = priv.cur_rx_qnum;
    for (; priv.rxq[qnum].cur_rx - priv.rxq[qnum].dirty_rx > 0;
    priv.rxq[qnum].dirty_rx++) {
    let mut entry: c_uint = priv.rxq[qnum].dirty_rx % rxsize;
    struct sxgbe_rx_norm_desc *p;
    p = priv.rxq[qnum].dma_rx + entry;
    if (likely(priv.rxq[qnum].rx_skbuff[entry] == core::ptr::null_mut())) {
    struct sk_buff *skb;
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_rx(priv: *mut sxgbe_priv_data, limit: c_int) -> c_int {
    static int sxgbe_rx(struct sxgbe_priv_data *priv, int limit)
    {
    let mut qnum: u8 = priv.cur_rx_qnum;
    let mut rxsize: c_uint = priv.dma_rx_size;
    let mut entry: c_uint = priv.rxq[qnum].cur_rx;
    let mut next_entry: c_uint = 0;
...
//
    ...
    priv.rxq[qnum].rx_skbuff[entry] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_common_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t sxgbe_common_interrupt(int irq, void *dev_id)
    {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_tx_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t sxgbe_tx_interrupt(int irq, void *dev_id)
    {
    int status;
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_rx_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t sxgbe_rx_interrupt(int irq, void *dev_id)
    {
    int status;
...
#[no_mangle]
pub unsafe extern "C" fn sxgbe_get_stat64(ioaddr: *mut void __iomem, reg_lo: c_int, reg_hi: c_int) -> u64 {
    static inline u64 sxgbe_get_stat64(void __iomem *ioaddr, int reg_lo, int reg_hi)
    {
    let mut val: u64 = readl(ioaddr + reg_lo);
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_change_mtu(dev: *mut net_device, new_mtu: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_set_rx_mode(dev: *mut net_device) {
...
//
    let mut bit_nr: c_int = bitrev32(~crc32_le(~0, ha.addr, 6)) >> 26;
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_poll_controller(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_ioctl(dev: *mut net_device, rq: *mut ifreq, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_get_ops(ops_ptr: *const *const sxgbe_ops) {
...
//
#[no_mangle]
unsafe extern "C" fn sxgbe_hw_init(priv: *const *const sxgbe_priv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_sw_reset(addr: *mut void __iomem) -> c_int {
    static int sxgbe_sw_reset(void __iomem *addr)
    {
    let mut retry_count: c_int = 10;
...
//
#[no_mangle]
pub unsafe extern "C" fn sxgbe_drv_remove(ndev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn sxgbe_suspend(ndev: *mut net_device) -> c_int {
    int sxgbe_suspend(struct net_device *ndev)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn sxgbe_resume(ndev: *mut net_device) -> c_int {
    int sxgbe_resume(struct net_device *ndev)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn sxgbe_freeze(ndev: *mut net_device) -> c_int {
    int sxgbe_freeze(struct net_device *ndev)
    {
    return -ENOSYS;
    }
#[no_mangle]
pub unsafe extern "C" fn sxgbe_restore(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_cmdline_opt(str: *mut c_char) -> int __init {
