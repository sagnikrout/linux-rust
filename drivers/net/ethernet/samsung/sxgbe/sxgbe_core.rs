...
//! Source: drivers/net/ethernet/samsung/sxgbe/sxgbe_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sxgbe_core_init(ioaddr: *mut void __iomem) {
...
// Dump MAC registers
#[no_mangle]
unsafe extern "C" fn sxgbe_core_dump_regs(ioaddr: *mut void __iomem) {
    static void sxgbe_core_dump_regs(void __iomem *ioaddr)
    {
    }
#[no_mangle]
unsafe extern "C" fn sxgbe_get_lpi_status(ioaddr: *mut void __iomem, irq_status: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_core_pmt(ioaddr: *mut void __iomem, mode: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_enable_tx(ioaddr: *mut void __iomem, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_enable_rx(ioaddr: *mut void __iomem, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_get_controller_version(ioaddr: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_core_set_speed(ioaddr: *mut void __iomem, speed: c_uchar) {
    static void sxgbe_core_set_speed(void __iomem *ioaddr, unsigned char speed)
    {
    let mut tx_cfg: u32 = readl(ioaddr + SXGBE_CORE_TX_CONFIG_REG);
...
#[no_mangle]
unsafe extern "C" fn sxgbe_core_enable_rxqueue(ioaddr: *mut void __iomem, queue_num: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_core_disable_rxqueue(ioaddr: *mut void __iomem, queue_num: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_set_eee_mode(ioaddr: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_reset_eee_mode(ioaddr: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_set_eee_pls(ioaddr: *mut void __iomem, link: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_enable_rx_csum(ioaddr: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_disable_rx_csum(ioaddr: *mut void __iomem) {
