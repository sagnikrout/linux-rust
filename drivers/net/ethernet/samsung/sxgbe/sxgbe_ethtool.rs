...
//! Source: drivers/net/ethernet/samsung/sxgbe/sxgbe_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sxgbe_getmsglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_setmsglevel(dev: *mut net_device, level: u32) {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_get_strings(dev: *mut net_device, stringset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
    ...
    char *p;
    if (priv.eee_enabled) {
    let mut val: c_int = phy_get_eee_err(dev.phydev);
    if (val)
...
#[no_mangle]
unsafe extern "C" fn sxgbe_riwt2usec(riwt: u32, priv: *mut sxgbe_priv_data) -> u32 {
    static u32 sxgbe_riwt2usec(u32 riwt, struct sxgbe_priv_data *priv)
    {
    let mut clk: c_ulong = clk_get_rate(priv.sxgbe_clk);
    if (!clk)
    return 0;
    return (riwt * 256) / (clk / 1000000);
    }
#[no_mangle]
unsafe extern "C" fn sxgbe_usec2riwt(usec: u32, priv: *mut sxgbe_priv_data) -> u32 {
    ...
    return -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !priv->use_riwt) -> else {
...
#[no_mangle]
unsafe extern "C" fn sxgbe_get_regs_len(dev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sxgbe_set_ethtool_ops(netdev: *mut net_device) {
