...
//! Source: drivers/net/ethernet/mellanox/mlxbf_gige/mlxbf_gige_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_get_regs_len(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_get_sset_count(netdev: *mut net_device, stringset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_llu_counters_enabled(priv: *mut mlxbf_gige) -> bool {
