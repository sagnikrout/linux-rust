...
//! Source: drivers/net/ethernet/mellanox/mlxbf_gige/mlxbf_gige_mdio.c
#![no_std]
...
pub const MLXBF_GIGE_MDC_CLK_NS: c_int = 400;
pub const MLXBF_GIGE_MDIO_PLL_I1CLK_REG1: c_uint = 0x4;
pub const MLXBF_GIGE_MDIO_PLL_I1CLK_REG2: c_uint = 0x8;
pub const MLXBF_GIGE_MDIO_CORE_F_SHIFT: c_int = 0;

pub const MLXBF_GIGE_MDIO_CORE_R_SHIFT: c_int = 26;

pub const MLXBF_GIGE_MDIO_CORE_OD_SHIFT: c_int = 0;

// Support clause 22
pub const MLXBF_GIGE_MDIO_CL22_ST1: c_uint = 0x1;
pub const MLXBF_GIGE_MDIO_CL22_WRITE: c_uint = 0x1;
pub const MLXBF_GIGE_MDIO_CL22_READ: c_uint = 0x2;
// Busy bit is set by software and cleared by hardware
pub const MLXBF_GIGE_MDIO_SET_BUSY: c_uint = 0x1;
pub const MLXBF_GIGE_BF2_COREPLL_ADDR: c_uint = 0x02800c30;
pub const MLXBF_GIGE_BF2_COREPLL_SIZE: c_uint = 0x0000000c;
pub const MLXBF_GIGE_BF3_COREPLL_ADDR: c_uint = 0x13409824;
pub const MLXBF_GIGE_BF3_COREPLL_SIZE: c_uint = 0x00000010;
...
#[no_mangle]
unsafe extern "C" fn calculate_i1clk(priv: *mut mlxbf_gige) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn mdio_period_map(priv: *mut mlxbf_gige) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_mdio_read(bus: *mut mii_bus, phy_add: c_int, phy_reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_mdio_cfg(priv: *mut mlxbf_gige) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_mdio_probe(pdev: *mut platform_device, priv: *mut mlxbf_gige) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_mdio_remove(priv: *mut mlxbf_gige) {
