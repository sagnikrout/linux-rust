...
//! Source: drivers/net/ethernet/mellanox/mlxbf_gige/mlxbf_gige_tx.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_tx_init(priv: *mut mlxbf_gige) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_tx_deinit(priv: *mut mlxbf_gige) {
    ...
    priv.tx_wqe_base = core::ptr::null_mut();
    priv.tx_wqe_base_dma = 0;
    priv.tx_cc = core::ptr::null_mut();
    priv.tx_cc_dma = 0;
    priv.tx_wqe_next = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_tx_buffs_avail(priv: *mut mlxbf_gige) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_handle_tx_complete(priv: *mut mlxbf_gige) -> bool {
...
//
    ...
    priv.tx_skb[tx_wqe_index] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_update_tx_wqe_next(priv: *mut mlxbf_gige) {
