...
//! Source: drivers/net/ethernet/mellanox/mlxbf_gige/mlxbf_gige_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_initial_mac(priv: *mut mlxbf_gige) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_cache_stats(priv: *mut mlxbf_gige) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_clean_port(priv: *mut mlxbf_gige) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_stop(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_set_rx_mode(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_bf2_adjust_link(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_bf3_adjust_link(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_bf2_set_phy_link_mode(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_bf3_set_phy_link_mode(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_shutdown(pdev: *mut platform_device) {
