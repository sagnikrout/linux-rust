...
//! Source: drivers/net/ethernet/mellanox/mlxbf_gige/mlxbf_gige_intr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_error_intr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_rx_intr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_gige_llu_plu_intr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t mlxbf_gige_llu_plu_intr(int irq, void *dev_id)
    {
    return IRQ_HANDLED;
    }
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_request_irqs(priv: *mut mlxbf_gige) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_free_irqs(priv: *mut mlxbf_gige) {
