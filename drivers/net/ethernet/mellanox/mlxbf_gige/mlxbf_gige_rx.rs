...
//! Source: drivers/net/ethernet/mellanox/mlxbf_gige/mlxbf_gige_rx.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_enable_multicast_rx(priv: *mut mlxbf_gige) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_disable_multicast_rx(priv: *mut mlxbf_gige) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_enable_promisc(priv: *mut mlxbf_gige) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_disable_promisc(priv: *mut mlxbf_gige) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_rx_init(priv: *mut mlxbf_gige) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_rx_deinit(priv: *mut mlxbf_gige) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxbf_gige_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
