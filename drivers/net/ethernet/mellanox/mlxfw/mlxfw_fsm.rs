...
//! Source: drivers/net/ethernet/mellanox/mlxfw/mlxfw_fsm.c
#![no_std]
...
pub const MLXFW_FSM_STATE_WAIT_CYCLE_MS: c_int = 200;
pub const MLXFW_FSM_STATE_WAIT_TIMEOUT_MS: c_int = 30000;
...
// supported = false;
    ...
    {
    struct mlxfw_mfa2_file *mfa2_file;
    let mut reactivate_supp: bool = true;
    u32 fwhandle;
    int err;
    ...
    mlxfw_status_notify(mlxfw_dev, "Activating image", core::ptr::null_mut(), 0, 0);
    ...
    mlxfw_status_notify(mlxfw_dev, "Firmware flash done", core::ptr::null_mut(), 0, 0);
