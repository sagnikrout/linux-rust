...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/esw/acl/ingress_ofld.c
#![no_std]
...
// Untagged packets - push prio tag VLAN, allow
    ...
    core::ptr::null_mut(), &flow_act, core::ptr::null_mut(), 0);
    ...
    vport.ingress.offloads.modify_metadata_rule = core::ptr::null_mut();
    }
    return err;
    }
    ...
    flow_rule = mlx5_add_flow_rules(vport.ingress.acl, core::ptr::null_mut(), &flow_act, core::ptr::null_mut(), 0);
    if (IS_ERR(flow_rule)) {
...
// Only destroy ingress acl created in this function.
    ...
    vport.ingress.offloads.drop_rule = core::ptr::null_mut();
    }
...
//
    ...
    vport.ingress.offloads.metadata_prio_tag_grp = core::ptr::null_mut();
    }
    prio_tag_err:
    if (!IS_ERR_OR_NULL(vport.ingress.offloads.drop_grp)) {
    mlx5_destroy_flow_group(vport.ingress.offloads.drop_grp);
    vport.ingress.offloads.drop_grp = core::ptr::null_mut();
    }
    drop_err:
    kvfree(flow_group_in);
    return ret;
...
#[no_mangle]
unsafe extern "C" fn esw_acl_ingress_ofld_groups_destroy(vport: *mut mlx5_vport) {
    ...
    vport.ingress.offloads.metadata_allmatch_grp = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn esw_acl_ingress_ofld_setup(esw: *mut mlx5_eswitch, vport: *mut mlx5_vport) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_esw_acl_ingress_vport_drop_rule_create(esw: *mut mlx5_eswitch, vport_num: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_esw_acl_ingress_vport_drop_rule_destroy(esw: *mut mlx5_eswitch, vport_num: u16) {
