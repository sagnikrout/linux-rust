...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/esw/ipsec.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn esw_ipsec_vf_query_generic(dev: *mut mlx5_core_dev, vport_num: u16, result: *mut bool) -> c_int {
    static int esw_ipsec_vf_query_generic(struct mlx5_core_dev *dev, u16 vport_num, bool *result)
    {
    let mut query_sz: c_int = MLX5_ST_SZ_BYTES(query_hca_cap_out);
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_esw_ipsec_vf_offload_get(dev: *mut mlx5_core_dev, vport: *mut mlx5_vport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esw_ipsec_vf_set_generic(dev: *mut mlx5_core_dev, vport_num: u16, ipsec_ofld: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esw_ipsec_vf_crypto_aux_caps_set(dev: *mut mlx5_core_dev, vport_num: u16, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esw_ipsec_offload_supported(dev: *mut mlx5_core_dev, vport_num: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_esw_ipsec_vf_offload_supported(dev: *mut mlx5_core_dev) -> bool {
