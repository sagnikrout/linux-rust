...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/esw/adj_vport.c
#![no_std]
...
// Copyright (c) 2025, NVIDIA CORPORATION & AFFILIATES. All rights reserved.
    ...
    let mut op_mod: u8 = MLX5_VPORT_STATE_OP_MOD_ESW_VPORT;
    struct mlx5_vport *esw_vport;
    let mut speed: u32 = 0;
    int err;
    err = mlx5_query_vport_max_tx_speed(dev, op_mod, vport,
    true, &speed, core::ptr::null_mut());
    if (err) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_esw_destroy_esw_vport(dev: *mut mlx5_core_dev, vport: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_esw_adjacent_vhcas_cleanup(esw: *mut mlx5_eswitch) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_esw_adjacent_vhcas_setup(esw: *mut mlx5_eswitch) {
    void mlx5_esw_adjacent_vhcas_setup(struct mlx5_eswitch *esw)
    {
    let mut delegated_vhca_max: u32 = MLX5_CAP_GEN_2(esw.dev, delegated_vhca_max);
