...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/steering/sws/dr_ptrn.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5dr_ptrn_mgr {
    pub dmn: *mut mlx5dr_domain,
    pub ptrn_icm_pool: *mut mlx5dr_icm_pool,
// cache for modify_header ptrn
    pub ptrn_list: list_head,
    pub /: *mut *mut mutex modify_hdr_mutex; / protect the pattern cache,
}
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_ptrn_mgr_destroy(mgr: *mut mlx5dr_ptrn_mgr) {
