...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/steering/sws/dr_ste_v0.c
#![no_std]
...
pub const SVLAN_ETHERTYPE: c_uint = 0x88a8;
...
#[no_mangle]
unsafe extern "C" fn dr_ste_v0_get_miss_addr(hw_ste_p: *mut u8) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn dr_ste_v0_rx_set_flow_tag(hw_ste_p: *mut u8, flow_tag: u32) {
...
#[no_mangle]
unsafe extern "C" fn dr_ste_v0_set_counter_id(hw_ste_p: *mut u8, ctr_id: u32) {
...
#[no_mangle]
unsafe extern "C" fn dr_ste_v0_set_go_back_bit(hw_ste_p: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn dr_ste_v0_set_rx_decap(hw_ste_p: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn dr_ste_v0_set_rx_pop_vlan(hw_ste_p: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn dr_ste_v0_set_rx_decap_l3(hw_ste_p: *mut u8, vlan: bool) {
...
pub const DR_STE_DECAP_L3_MIN_ACTION_NUM: c_int = 5;
    static int
...
pub const ICMP_TYPE_OFFSET_FIRST_DW: c_int = 24;
pub const ICMP_CODE_OFFSET_FIRST_DW: c_int = 16;
    static int
...
//
    ...
    {
    struct mlx5dr_match_misc *misc = &value.misc;
    let mut id: c_int = misc.source_eswitch_owner_vhca_id;
...
// Find port GVMI based on the eswitch_owner_vhca_id
    ...
    vport_dmn = dmn;
#[no_mangle]
pub unsafe extern "C" fn if(peer->info.caps.gvmi): peer && (id ==) -> else {
...
// misc4_field_value = 0;
    ...
    {
    struct mlx5dr_match_misc3 *misc3 = &value.misc3;
    let mut parser_id: u8 = sb.caps.flex_parser_id_geneve_tlv_option_0;
