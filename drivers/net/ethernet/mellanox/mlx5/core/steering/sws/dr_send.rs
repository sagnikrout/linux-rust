...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/steering/sws/dr_send.c
#![no_std]
...
pub const QUEUE_SIZE: c_int = 128;
pub const SIGNAL_PER_DIV_QUEUE: c_int = 16;
pub const TH_NUMS_TO_DRAIN: c_int = 2;
pub const DR_SEND_INFO_POOL_SIZE: c_int = 1000;
    enum { CQ_OK = 0, CQ_EMPTY = -1, CQ_POLL_ERR = -2 };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dr_data_seg {
    pub addr: u64,
    pub length: u32,
    pub lkey: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct postsend_info {
    pub type: enum send_info_type,
    pub write: dr_data_seg,
    pub read: dr_data_seg,
    pub remote_addr: u64,
    pub rkey: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dr_qp_rtr_attr {
    pub dgid_attr: mlx5dr_cmd_gid_attr,
    pub mtu: enum ib_mtu,
    pub qp_num: u32,
    pub port_num: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5dr_send_info_pool_obj {
    pub ste_send_info: mlx5dr_ste_send_info,
    pub pool: *mut mlx5dr_send_info_pool,
    pub list_node: list_head,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5dr_send_info_pool {
    pub free_list: list_head,
}

#[no_mangle]
unsafe extern "C" fn dr_send_info_pool_fill(pool: *mut mlx5dr_send_info_pool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_send_info_pool_destroy(pool: *mut mlx5dr_send_info_pool) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_send_info_pool_destroy(dmn: *mut mlx5dr_domain) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_send_info_pool_create(dmn: *mut mlx5dr_domain) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_send_info_free(ste_send_info: *mut mlx5dr_ste_send_info) {
...
#[no_mangle]
unsafe extern "C" fn dr_parse_cqe(dr_cq: *mut mlx5dr_cq, cqe64: *mut mlx5_cqe64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_cq_poll_one(dr_cq: *mut mlx5dr_cq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_poll_cq(dr_cq: *mut mlx5dr_cq, ne: c_int) -> c_int {
    ...
    let mut err: return = = CQ_POLL_ERR ? err : npolled;
    }
...
#[no_mangle]
unsafe extern "C" fn dr_cmd_notify_hw(dr_qp: *mut mlx5dr_qp, ctrl: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dr_post_send(dr_qp: *mut mlx5dr_qp, send_info: *mut postsend_info) {
...
// Read into dedicated sync buffer
    ...
    int *num_stes)
    {
    let mut chunk_byte_size: u32 = mlx5dr_icm_pool_get_chunk_byte_size(htbl.chunk);
    int alloc_size;
...
//
    ...
    {
    let mut send_info: postsend_info = {};
    ...
    {
    let mut byte_size: u32 = mlx5dr_icm_pool_get_chunk_byte_size(htbl.chunk);
...
// Send the data iteration times
    ...
    let mut ste_index: u32 = i * (byte_size / DR_STE_SIZE);
    let mut send_info: postsend_info = {};
...
//
    ...
    let mut ste_off: u32 = j * DR_STE_SIZE;
...
// Send the data iteration times
    for (i = 0; i < iterations; i++) {
    let mut ste_index: u8 = i * (byte_size / DR_STE_SIZE);
    let mut send_info: postsend_info = {};
    send_info.write.addr = (uintptr_t)data;
    send_info.write.length = byte_size;
    send_info.write.lkey = 0;
...
#[no_mangle]
unsafe extern "C" fn dr_send_allow_fl(caps: *mut mlx5dr_cmd_caps) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_prepare_qp_to_rts(dmn: *mut mlx5dr_domain) -> c_int {
    static int dr_prepare_qp_to_rts(struct mlx5dr_domain *dmn)
    {
    struct mlx5dr_qp *dr_qp = dmn.send_ring.qp;
    let mut rts_attr: dr_qp_rts_attr = {};
    let mut rtr_attr: dr_qp_rtr_attr = {};
    let mut mtu: enum ib_mtu = IB_MTU_1024;
    let mut gid_index: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn dr_destroy_cq(mdev: *mut mlx5_core_dev, cq: *mut mlx5dr_cq) {
...
#[no_mangle]
unsafe extern "C" fn dr_create_mkey(mdev: *mut mlx5_core_dev, pdn: u32, mkey: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_dereg_mr(mdev: *mut mlx5_core_dev, mr: *mut mlx5dr_mr) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_send_ring_alloc(dmn: *mut mlx5dr_domain) -> c_int {
    int mlx5dr_send_ring_alloc(struct mlx5dr_domain *dmn)
    {
    let mut init_attr: dr_qp_init_attr = {};
    int cq_size;
    int size;
    int ret;
