...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/steering/sws/dr_ste_v3.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dr_ste_v3_set_rx_decap(hw_ste_p: *mut u8, s_action: *mut u8) {
