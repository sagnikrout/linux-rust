...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/steering/sws/dr_action.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mlx5dr_action_supp_fwd_fdb_multi_ft(dev: *mut mlx5_core_dev) -> bool {
...
pub const WITH_VLAN_NUM_HW_ACTIONS: c_int = 6;
    ...
    let mut rx_rule: bool = nic_dmn.type == DR_DOMAIN_NIC_TYPE_RX;
    struct mlx5dr_domain *dmn = matcher.tbl.dmn;
    u8 action_type_set[DR_ACTION_TYP_MAX] = {};
    let mut attr: mlx5dr_ste_actions_attr = {};
    struct mlx5dr_action *dest_action = core::ptr::null_mut();
    let mut state: u32 = DR_ACTION_STATE_NO_ACTION;
    enum dr_action_domain action_domain;
    let mut recalc_cs_required: bool = false;
    u8 *last_ste;
    int i, ret;
    ...
    let mut max_actions_type: c_int = 1;
    u32 action_type;
    action = actions[i];
...
#[no_mangle]
unsafe extern "C" fn dr_action_create_range_definer(action: *mut mlx5dr_action) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_action_destroy_range_definer(action: *mut mlx5dr_action) {
...
//
    ...
    struct mlx5dr_action *action;
    let mut reformat_req: bool = false;
    let mut is_ft_wire: bool = false;
    let mut num_dst_ft: u16 = 0;
    let mut num_of_ref: u32 = 0;
    u32 ref_act_cnt;
    u16 last_dest;
    int ret;
    int i;
...
pub const CVLAN_ETHERTYPE: c_uint = 0x8100;
pub const SVLAN_ETHERTYPE: c_uint = 0x88a8;
    ...
    __be32 vlan_hdr)
    {
    let mut vlan_hdr_h: u32 = ntohl(vlan_hdr);
    let mut ethertype: u16 = vlan_hdr_h >> 16;
    struct mlx5dr_action *action;
...
// Get SW modify action type
    ...
    {
    let mut sw_field: u16 = MLX5_GET(set_action_in, sw_action, field);
    ...
    {
    let mut sw_field: u16 = MLX5_GET(set_action_in, sw_action, field);
    let mut sw_field: return = = MLX5_ACTION_IN_FIELD_OUT_IP_TTL;
    }
    ...
    const struct mlx5dr_ste_action_modify_field *hw_src_action_info;
    struct mlx5dr_domain *dmn = action.rewrite.dmn;
    __be64 *modify_ttl_sw_action = core::ptr::null_mut();
    int ret, i, hw_idx = 0;
    __be64 *sw_action;
    __be64 hw_action;
    let mut hw_field: u16 = 0;
    let mut l3_type: u32 = 0;
    let mut l4_type: u32 = 0;
// modify_ttl = false;
...
// modify TTL is handled separately, as a last action
    ...
    modify_ttl_sw_action = core::ptr::null_mut();
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_action_get_pkt_reformat_id(action: *mut mlx5dr_action) -> u32 {
    u32 mlx5dr_action_get_pkt_reformat_id(struct mlx5dr_action *action)
    {
    return action.reformat.id;
    }
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_action_destroy(action: *mut mlx5dr_action) -> c_int {
