...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/steering/sws/dr_domain.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_domain_is_support_ptrn_arg(dmn: *mut mlx5dr_domain) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_domain_init_modify_header_resources(dmn: *mut mlx5dr_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_domain_destroy_modify_header_resources(dmn: *mut mlx5dr_domain) {
...
#[no_mangle]
unsafe extern "C" fn dr_domain_init_csum_recalc_fts(dmn: *mut mlx5dr_domain) {
...
#[no_mangle]
unsafe extern "C" fn dr_domain_uninit_csum_recalc_fts(dmn: *mut mlx5dr_domain) {
...
#[no_mangle]
unsafe extern "C" fn dr_domain_init_mem_resources(dmn: *mut mlx5dr_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_domain_uninit_mem_resources(dmn: *mut mlx5dr_domain) {
...
#[no_mangle]
unsafe extern "C" fn dr_domain_init_resources(dmn: *mut mlx5dr_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_domain_uninit_resources(dmn: *mut mlx5dr_domain) {
...
#[no_mangle]
unsafe extern "C" fn dr_domain_query_esw_mgr(dmn: *mut mlx5dr_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_domain_query_uplink(dmn: *mut mlx5dr_domain) {
...
#[no_mangle]
unsafe extern "C" fn dr_domain_is_esw_mgr_vport(dmn: *mut mlx5dr_domain, vport: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_domain_clear_vports(dmn: *mut mlx5dr_domain) {
...
#[no_mangle]
unsafe extern "C" fn dr_domain_caps_uninit(dmn: *mut mlx5dr_domain) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_domain_destroy(dmn: *mut mlx5dr_domain) -> c_int {
