...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/steering/sws/dr_icm_pool.c
#![no_std]
...
pub const DR_ICM_MODIFY_HDR_ALIGN_BASE: c_int = 64;
pub const DR_ICM_POOL_STE_HOT_MEM_PERCENT: c_int = 25;
pub const DR_ICM_POOL_MODIFY_HDR_PTRN_HOT_MEM_PERCENT: c_int = 50;
pub const DR_ICM_POOL_MODIFY_ACTION_HOT_MEM_PERCENT: c_int = 90;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5dr_icm_hot_chunk {
    pub buddy_mem: *mut mlx5dr_icm_buddy_mem,
    pub seg: c_uint,
    pub size: enum mlx5dr_icm_chunk_size,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5dr_icm_pool {
    pub icm_type: enum mlx5dr_icm_type,
    pub max_log_chunk_sz: enum mlx5dr_icm_chunk_size,
    pub dmn: *mut mlx5dr_domain,
    pub chunks_kmem_cache: *mut kmem_cache,
// memory management
    pub /: *mut *mut mutex mutex; / protect the ICM pool and ICM buddy,
    pub buddy_mem_list: list_head,
// Hardware may be accessing this memory but at some future,
// undetermined time, it might cease to do so.
// sync_ste command sets them free.
//
    pub hot_chunks_arr: *mut mlx5dr_icm_hot_chunk,
    pub hot_chunks_num: u32,
    pub hot_memory_size: u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5dr_icm_dm {
    pub obj_id: u32,
    pub type: enum mlx5_sw_icm_type,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5dr_icm_mr {
    pub mkey: u32,
    pub dm: mlx5dr_icm_dm,
    pub dmn: *mut mlx5dr_domain,
    pub length: usize,
    pub icm_start_addr: u64,
}
    ...
    u32 *mkey)
    {
    let mut inlen: u32 = MLX5_ST_SZ_BYTES(create_mkey_in);
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_icm_pool_get_chunk_mr_addr(chunk: *mut mlx5dr_icm_chunk) -> u64 {
    u64 mlx5dr_icm_pool_get_chunk_mr_addr(struct mlx5dr_icm_chunk *chunk)
    {
    let mut offset: u32 = mlx5dr_icm_pool_dm_type_to_entry_size(chunk.buddy_mem.pool.icm_type);
    return (u64)offset * chunk.seg;
    }
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_icm_pool_get_chunk_rkey(chunk: *mut mlx5dr_icm_chunk) -> u32 {
    u32 mlx5dr_icm_pool_get_chunk_rkey(struct mlx5dr_icm_chunk *chunk)
    {
    return chunk.buddy_mem.icm_mr.mkey;
    }
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_icm_pool_get_chunk_icm_addr(chunk: *mut mlx5dr_icm_chunk) -> u64 {
    u64 mlx5dr_icm_pool_get_chunk_icm_addr(struct mlx5dr_icm_chunk *chunk)
    {
    let mut size: u32 = mlx5dr_icm_pool_dm_type_to_entry_size(chunk.buddy_mem.pool.icm_type);
    return (u64)chunk.buddy_mem.icm_mr.icm_start_addr + size * chunk.seg;
    }
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_icm_pool_get_chunk_byte_size(chunk: *mut mlx5dr_icm_chunk) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_icm_pool_get_chunk_num_of_entries(chunk: *mut mlx5dr_icm_chunk) -> u32 {
    ...
    let mut dm_type: enum mlx5_sw_icm_type = 0;
    struct mlx5dr_icm_mr *icm_mr;
    let mut log_align_base: usize = 0;
    int err;
...
#[no_mangle]
unsafe extern "C" fn dr_icm_pool_mr_destroy(icm_mr: *mut mlx5dr_icm_mr) {
...
#[no_mangle]
unsafe extern "C" fn dr_icm_buddy_get_ste_size(buddy: *mut mlx5dr_icm_buddy_mem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_icm_chunk_ste_init(chunk: *mut mlx5dr_icm_chunk, offset: c_int) {
    static void dr_icm_chunk_ste_init(struct mlx5dr_icm_chunk *chunk, int offset)
    {
    let mut num_of_entries: c_int = mlx5dr_icm_pool_get_chunk_num_of_entries(chunk);
    struct mlx5dr_icm_buddy_mem *buddy = chunk.buddy_mem;
    let mut ste_size: c_int = dr_icm_buddy_get_ste_size(buddy);
    let mut index: c_int = offset / DR_STE_SIZE;
...
#[no_mangle]
unsafe extern "C" fn dr_icm_buddy_init_ste_cache(buddy: *mut mlx5dr_icm_buddy_mem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_icm_buddy_cleanup_ste_cache(buddy: *mut mlx5dr_icm_buddy_mem) {
...
#[no_mangle]
unsafe extern "C" fn dr_icm_buddy_create(pool: *mut mlx5dr_icm_pool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_icm_buddy_destroy(buddy: *mut mlx5dr_icm_buddy_mem) {
    static void dr_icm_buddy_destroy(struct mlx5dr_icm_buddy_mem *buddy)
    {
    let mut icm_type: enum mlx5dr_icm_type = buddy.pool.icm_type;
...
#[no_mangle]
unsafe extern "C" fn dr_icm_pool_is_sync_required(pool: *mut mlx5dr_icm_pool) -> bool {
    static bool dr_icm_pool_is_sync_required(struct mlx5dr_icm_pool *pool)
    {
    return pool.hot_memory_size > pool.th;
    }
#[no_mangle]
unsafe extern "C" fn dr_icm_pool_clear_hot_chunks_arr(pool: *mut mlx5dr_icm_pool) {
...
#[no_mangle]
unsafe extern "C" fn dr_icm_pool_sync_all_buddy_pools(pool: *mut mlx5dr_icm_pool) -> c_int {
...
//
    ...
    enum mlx5dr_icm_chunk_size chunk_size)
    {
    struct mlx5dr_icm_chunk *chunk = core::ptr::null_mut();
    struct mlx5dr_icm_buddy_mem *buddy;
    unsigned int seg;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_icm_free_chunk(chunk: *mut mlx5dr_icm_chunk) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_icm_pool_free_htbl(pool: *mut mlx5dr_icm_pool, htbl: *mut mlx5dr_ste_htbl) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_icm_pool_destroy(pool: *mut mlx5dr_icm_pool) {
