...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/steering/sws/dr_buddy.c
#![no_std]
...
// Allocating max_order bitmaps, one for each order
    ...
    let mut size: c_uint = 1 << (buddy.max_order - i);
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_buddy_cleanup(buddy: *mut mlx5dr_icm_buddy_mem) {
