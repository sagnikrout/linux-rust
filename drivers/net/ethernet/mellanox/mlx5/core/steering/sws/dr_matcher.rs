...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/steering/sws/dr_matcher.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_smac_set(spec: *mut mlx5dr_match_spec) -> bool {
    static bool dr_mask_is_smac_set(struct mlx5dr_match_spec *spec)
    {
    return (spec.smac_47_16 || spec.smac_15_0);
    }
#[no_mangle]
unsafe extern "C" fn dr_mask_is_dmac_set(spec: *mut mlx5dr_match_spec) -> bool {
    static bool dr_mask_is_dmac_set(struct mlx5dr_match_spec *spec)
    {
    return (spec.dmac_47_16 || spec.dmac_15_0);
    }
#[no_mangle]
unsafe extern "C" fn dr_mask_is_l3_base_set(spec: *mut mlx5dr_match_spec) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_tcp_udp_base_set(spec: *mut mlx5dr_match_spec) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_ipv4_set(spec: *mut mlx5dr_match_spec) -> bool {
    static bool dr_mask_is_ipv4_set(struct mlx5dr_match_spec *spec)
    {
    return (spec.dst_ip_31_0 || spec.src_ip_31_0);
    }
#[no_mangle]
unsafe extern "C" fn dr_mask_is_ipv4_5_tuple_set(spec: *mut mlx5dr_match_spec) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_eth_l2_tnl_set(misc: *mut mlx5dr_match_misc) -> bool {
    static bool dr_mask_is_eth_l2_tnl_set(struct mlx5dr_match_misc *misc)
    {
    return misc.vxlan_vni;
    }
#[no_mangle]
unsafe extern "C" fn dr_mask_is_ttl_set(spec: *mut mlx5dr_match_spec) -> bool {
    static bool dr_mask_is_ttl_set(struct mlx5dr_match_spec *spec)
    {
    return spec.ttl_hoplimit;
    }
#[no_mangle]
unsafe extern "C" fn dr_mask_is_ipv4_ihl_set(spec: *mut mlx5dr_match_spec) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_tnl_gre_set(misc: *mut mlx5dr_match_misc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_tnl_geneve_set(misc: *mut mlx5dr_match_misc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_tnl_geneve_tlv_opt(misc3: *mut mlx5dr_match_misc3) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_tnl_gtpu_set(misc3: *mut mlx5dr_match_misc3) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_supp_tnl_gtpu(caps: *mut mlx5dr_cmd_caps) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_supp_tnl_gtpu_dw_0(caps: *mut mlx5dr_cmd_caps) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_supp_tnl_gtpu_teid(caps: *mut mlx5dr_cmd_caps) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_supp_tnl_gtpu_dw_2(caps: *mut mlx5dr_cmd_caps) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_supp_tnl_gtpu_first_ext(caps: *mut mlx5dr_cmd_caps) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_supp_icmp_v4(caps: *mut mlx5dr_cmd_caps) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_supp_icmp_v6(caps: *mut mlx5dr_cmd_caps) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_icmpv6_set(misc3: *mut mlx5dr_match_misc3) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dr_mask_is_icmpv6_set(&mask->misc3)) -> else {
    else if (dr_mask_is_icmpv6_set(&mask.misc3))
    return dr_matcher_supp_icmp_v6(&dmn.info.caps);
    return false;
    }
#[no_mangle]
unsafe extern "C" fn dr_mask_is_wqe_metadata_set(misc2: *mut mlx5dr_match_misc2) -> bool {
    static bool dr_mask_is_wqe_metadata_set(struct mlx5dr_match_misc2 *misc2)
    {
    return misc2.metadata_reg_a;
    }
#[no_mangle]
unsafe extern "C" fn dr_mask_is_reg_c_0_3_set(misc2: *mut mlx5dr_match_misc2) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_reg_c_4_7_set(misc2: *mut mlx5dr_match_misc2) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_gvmi_or_qpn_set(misc: *mut mlx5dr_match_misc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_flex_parser_0_3_set(misc4: *mut mlx5dr_match_misc4) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_flex_parser_id_4_7_set(flex_parser_id: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_flex_parser_4_7_set(misc4: *mut mlx5dr_match_misc4) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_supp_tnl_mpls_over_gre(caps: *mut mlx5dr_cmd_caps) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_supp_tnl_mpls_over_udp(caps: *mut mlx5dr_cmd_caps) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_mask_is_tnl_header_0_1_set(misc5: *mut mlx5dr_match_misc5) -> bool {
    ...
    let mut mask: mlx5dr_match_param = {};
    let mut allow_empty_match: bool = false;
...
// Create a temporary mask to track and clear used mask fields
    ...
    &matcher.mask, core::ptr::null_mut());
    if (ret)
    return ret;
...
// Outer
    ...
    &mask, inner, rx);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dr_mask_is_tnl_geneve(&mask, _arg: dmn)) -> else {
    ...
    inner, rx);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dr_mask_is_tnl_mpls_over_udp(&mask, _arg: dmn)) -> else {
...
//
    ...
    return 0;
    next_nic_matcher = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: next_nic_matcher) -> else {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_uninit_nic(nic_matcher: *mut mlx5dr_matcher_rx_tx) {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_uninit_fdb(matcher: *mut mlx5dr_matcher) {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_uninit(matcher: *mut mlx5dr_matcher) {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_init_fdb(matcher: *mut mlx5dr_matcher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_add_to_dbg_list(matcher: *mut mlx5dr_matcher) {
...
#[no_mangle]
unsafe extern "C" fn dr_matcher_remove_from_dbg_list(matcher: *mut mlx5dr_matcher) {
...
// Connect previous anchor hash table to next matcher or to the default address
    ...
    info.type = CONNECT_MISS;
    info.miss_icm_addr = nic_tbl.default_icm_addr;
    prev_anchor.chunk.ste_arr[0].next_htbl = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn mlx5dr_matcher_destroy(matcher: *mut mlx5dr_matcher) -> c_int {
