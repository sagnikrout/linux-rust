...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/en_accel/ktls_tx.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_ktls_get_stop_room(mdev: *mut mlx5_core_dev, params: *mut mlx5e_params) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_ktls_set_tisc(mdev: *mut mlx5_core_dev, tisc: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_ktls_create_tis(mdev: *mut mlx5_core_dev, tisn: *mut u32) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5e_ktls_offload_context_tx {
// fast path
    pub expected_seq: u32,
    pub tisn: u32,
    pub ctx_post_pending: bool,
// control / resync
    pub /: *mut *mut list_head list_node; / member of the pool,
    pub crypto_info: union mlx5e_crypto_info,
    pub tx_ctx: *mut tls_offload_context_tx,
    pub mdev: *mut mlx5_core_dev,
    pub sw_stats: *mut mlx5e_tls_sw_stats,
    pub dek: *mut mlx5_crypto_dek,
    pub 1: u8 create_err :,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5e_async_ctx {
    pub context: mlx5_async_work,
    pub async_ctx: *mut mlx5_async_ctx,
    pub priv_tx: *mut mlx5e_ktls_offload_context_tx,
    pub err: c_int,
    union {
    pub out_create: [u32; MLX5_ST_SZ_DW(create_tis_out)],
    pub out_destroy: [u32; MLX5_ST_SZ_DW(destroy_tis_out)],
}

    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5e_bulk_async_ctx {
    pub async_ctx: mlx5_async_ctx,
    pub arr): DECLARE_FLEX_ARRAY(struct mlx5e_async_ctx,,
}
...
#[no_mangle]
unsafe extern "C" fn mlx5e_bulk_async_cleanup(bulk_async: *mut mlx5e_bulk_async_ctx) {
...
#[no_mangle]
unsafe extern "C" fn create_tis_callback(status: c_int, context: *mut mlx5_async_work) {
...
#[no_mangle]
unsafe extern "C" fn destroy_tis_callback(status: c_int, context: *mut mlx5_async_work) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5e_tls_tx_pool {
    pub mdev: *mut mlx5_core_dev,
    pub sw_stats: *mut mlx5e_tls_sw_stats,
    pub /: *mut *mut mutex lock; / Protects access to the pool,
    pub list: list_head,
    pub size: usize,
    pub wq: *mut workqueue_struct,
    pub create_work: work_struct,
    pub destroy_work: work_struct,
}

#[no_mangle]
unsafe extern "C" fn create_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn destroy_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_tls_tx_pool_list_cleanup(pool: *mut mlx5e_tls_tx_pool) {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_tls_tx_pool_cleanup(pool: *mut mlx5e_tls_tx_pool) {
...
#[no_mangle]
unsafe extern "C" fn pool_push(pool: *mut mlx5e_tls_tx_pool, obj: *mut mlx5e_ktls_offload_context_tx) {
...
//
    ...
    mutex_unlock(&pool.lock);
    obj = mlx5e_tls_priv_tx_init(pool.mdev, pool.sw_stats, core::ptr::null_mut());
    if (!IS_ERR(obj))
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_ktls_del_tx(netdev: *mut net_device, tls_ctx: *mut tls_context) {
...
// wi = (struct mlx5e_tx_wqe_info) {
    ...
    {
    let mut ret: bool = priv_tx.ctx_post_pending;
    ...
    tx_fill_wi(sq, pi, num_wqebbs, 0, core::ptr::null_mut());
    sq.pc += num_wqebbs;
    }
    static void
...
unsafe extern "C" fn tx_post_fence_nop(sq: *mut mlx5e_txqsq) {
    ...
    {
    let mut progress_fence: bool = skip_static_post || !fence_first_post;
    if (!skip_static_post)
...
pub struct tx_sync_info {
    ...
    let mut ret: enum mlx5e_ktls_sync_retval = MLX5E_KTLS_SYNC_DONE;
...
// reduce the part which will be sent with the original SKB
    ...
    u64 rcd_sn)
    {
    let mut rn_be: __be64 = cpu_to_be64(rcd_sn);
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_ktls_init_tx(priv: *mut mlx5e_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_ktls_cleanup_tx(priv: *mut mlx5e_priv) {
    void mlx5e_ktls_cleanup_tx(struct mlx5e_priv *priv)
    {
    if (!mlx5e_is_ktls_tx(priv.mdev))
    goto dek_pool_destroy;
    debugfs_remove_recursive(priv.tls.debugfs.dfs_tx);
    priv.tls.debugfs.dfs_tx = core::ptr::null_mut();
    mlx5e_tls_tx_pool_cleanup(priv.tls.tx_pool);
    priv.tls.tx_pool = core::ptr::null_mut();
    dek_pool_destroy:
    if (mlx5e_is_ktls_device(priv.mdev))
