...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/en_accel/ktls_rx.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct accel_rule {
    pub work: work_struct,
    pub priv: *mut mlx5e_priv,
    pub rule: *mut mlx5_flow_handle,
}

pub const PROGRESS_PARAMS_WRITE_UNIT: c_int = 64;

    (ALIGN(sizeof(struct mlx5_wqe_tls_progress_params_seg), \
    PROGRESS_PARAMS_WRITE_UNIT))
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5e_ktls_rx_resync_buf {
    union {
    pub progress: mlx5_wqe_tls_progress_params_seg,
    pub pad: [u8; PROGRESS_PARAMS_PADDED_SIZE],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5e_ktls_rx_resync_ctx {
    pub core: tls_offload_resync_async,
    pub work: work_struct,
    pub priv: *mut mlx5e_priv,
    pub refcnt: refcount_t,
    pub sw_rcd_sn_be: __be64,
    pub seq: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5e_ktls_offload_context_rx {
    pub crypto_info: union mlx5e_crypto_info,
    pub rule: accel_rule,
    pub sk: *mut sock,
    pub rq_stats: *mut mlx5e_rq_stats,
    pub sw_stats: *mut mlx5e_tls_sw_stats,
    pub add_ctx: completion,
    pub tir: mlx5e_tir,
    pub dek: *mut mlx5_crypto_dek,
    pub rxq: u32,
    pub MLX5E_NUM_PRIV_RX_FLAGS): DECLARE_BITMAP(flags,,
// resync
    pub /: *mut *mut spinlock_t lock; / protects resync fields,
    pub resync: mlx5e_ktls_rx_resync_ctx,
    pub list: list_head,
}

#[no_mangle]
unsafe extern "C" fn mlx5e_ktls_priv_rx_put(priv_rx: *mut mlx5e_ktls_offload_context_rx) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_ktls_priv_rx_get(priv_rx: *mut mlx5e_ktls_offload_context_rx) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5e_ktls_resync_resp {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_ktls_rx_resync_destroy_resp_list(resp_list: *mut mlx5e_ktls_resync_resp) {
...
#[no_mangle]
unsafe extern "C" fn accel_rule_handle_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn accel_rule_init(rule: *mut accel_rule, priv: *mut mlx5e_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn resync_handle_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn resync_queue_get_psv(sk: *mut sock) -> bool {
...
// Runs in NAPI
#[no_mangle]
unsafe extern "C" fn resync_update_sn(rq: *mut mlx5e_rq, skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_ktls_handle_ctx_completion(wi: *mut mlx5e_icosq_wqe_info) {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_ktls_sk_get_rxq(sk: *mut sock) -> c_int {
    static int mlx5e_ktls_sk_get_rxq(struct sock *sk)
    {
    let mut rxq: c_int = sk_rx_queue_get(sk);
    if (unlikely(rxq == -1))
    rxq = 0;
    return rxq;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_ktls_del_rx(netdev: *mut net_device, tls_ctx: *mut tls_context) {
    ...
    mlx5e_set_ktls_rx_priv_ctx(tls_ctx, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_ktls_rx_handle_resync_list(sq: *mut mlx5e_icosq, budget: c_int) -> bool {
