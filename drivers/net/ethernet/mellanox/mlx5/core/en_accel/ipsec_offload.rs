...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/en_accel/ipsec_offload.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_ipsec_device_caps(mdev: *mut mlx5_core_dev) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mlx5_create_ipsec_obj(sa_entry: *mut mlx5e_ipsec_sa_entry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_destroy_ipsec_obj(sa_entry: *mut mlx5e_ipsec_sa_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_ipsec_create_sa_ctx(sa_entry: *mut mlx5e_ipsec_sa_entry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_ipsec_free_sa_ctx(sa_entry: *mut mlx5e_ipsec_sa_entry) {
    ...
    let mut modify_field_select: u64 = 0;
...
// general object fields set
    ...
    {
    let mut data: mlx5_wqe_aso_ctrl_seg = {};
...
#[no_mangle]
unsafe extern "C" fn mlx5e_ipsec_aso_update_hard(sa_entry: *mut mlx5e_ipsec_sa_entry) {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_ipsec_handle_limits(sa_entry: *mut mlx5e_ipsec_sa_entry) {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_ipsec_handle_event(_work: *mut work_struct) {
    ...
    let mut tmp: mlx5_accel_esp_xfrm_attrs = {};
    struct mlx5_accel_esp_xfrm_attrs *attrs;
    let mut need_modify: bool = false;
    int ret;
    attrs = &sa_entry.attrs;
    spin_lock_bh(&sa_entry.x.lock);
    ret = mlx5e_ipsec_aso_query(sa_entry, core::ptr::null_mut());
    if (ret)
    goto unlock;
    if (attrs.lft.soft_packet_limit != XFRM_INF)
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_ipsec_aso_init(ipsec: *mut mlx5e_ipsec) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_ipsec_aso_cleanup(ipsec: *mut mlx5e_ipsec) {
