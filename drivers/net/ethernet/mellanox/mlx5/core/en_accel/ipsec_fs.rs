...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/en_accel/ipsec_fs.c
#![no_std]
...
pub const MLX5_REFORMAT_TYPE_ADD_ESP_TRANSPORT_SIZE: c_int = 16;
pub const IPSEC_TUNNEL_DEFAULT_TTL: c_uint = 0x40;
pub const MLX5_IPSEC_FS_SA_SELECTOR_MAX_NUM_GROUPS: c_int = 16;
    enum {
    MLX5_IPSEC_ASO_OK,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5e_ipsec_fc {
    pub cnt: *mut mlx5_fc,
    pub drop: *mut mlx5_fc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5e_ipsec_tx {
    pub ft: mlx5e_ipsec_ft,
    pub pol: mlx5e_ipsec_miss,
    pub sa: mlx5e_ipsec_miss,
    pub status: mlx5e_ipsec_rule,
    pub ns: *mut mlx5_flow_namespace,
    pub fc: *mut mlx5e_ipsec_fc,
    pub chains: *mut mlx5_fs_chains,
    pub 1: u8 allow_tunnel_mode :,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5e_ipsec_status_checks {
    pub pass_group: *mut mlx5_flow_group,
    pub packet_offload_pass_rule: *mut mlx5_flow_handle,
    pub crypto_offload_pass_rule: *mut mlx5_flow_handle,
    pub drop_all_group: *mut mlx5_flow_group,
    pub all: mlx5e_ipsec_drop,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5e_ipsec_rx {
    pub ft: mlx5e_ipsec_ft,
    pub pol: mlx5e_ipsec_miss,
    pub sa: mlx5e_ipsec_miss,
    pub sa_sel: mlx5e_ipsec_miss,
    pub status_checks: mlx5e_ipsec_status_checks,
    pub fc: *mut mlx5e_ipsec_fc,
    pub chains: *mut mlx5_fs_chains,
    pub pol_miss_ft: *mut mlx5_flow_table,
    pub pol_miss_rule: *mut mlx5_flow_handle,
    pub 1: u8 allow_tunnel_mode :,
    pub 1: u8 ttc_rules_added :,
}

// IPsec RX flow steering
#[no_mangle]
unsafe extern "C" fn family2tt(family: u32) -> enum mlx5_traffic_types {
...
#[no_mangle]
unsafe extern "C" fn ipsec_chains_destroy(chains: *mut mlx5_fs_chains) {
...
#[no_mangle]
unsafe extern "C" fn ipsec_chains_put_table(chains: *mut mlx5_fs_chains, prio: u32) {
...
#[no_mangle]
unsafe extern "C" fn rx_add_rule_drop_replay(sa_entry: *mut mlx5e_ipsec_sa_entry, rx: *mut mlx5e_ipsec_rx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_ipsec_rx_bringup(ipsec: *mut mlx5e_ipsec, family: u32) {
...
#[no_mangle]
unsafe extern "C" fn handle_ipsec_rx_cleanup(ipsec: *mut mlx5e_ipsec, family: u32) {
...
#[no_mangle]
unsafe extern "C" fn ipsec_mpv_work_handler(_work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ipsec_rx_policy_destroy(rx: *mut mlx5e_ipsec_rx) {
    ...
    rx.sa_sel.fc = core::ptr::null_mut();
...
//
    ...
    if (IS_ERR(ft))
    return PTR_ERR(ft);
    rule = mlx5_add_flow_rules(ft, core::ptr::null_mut(), &flow_act, dest, 1);
    if (IS_ERR(rule)) {
    err = PTR_ERR(rule);
    goto err_rule;
    }
...
#[no_mangle]
unsafe extern "C" fn rx_ft_put(ipsec: *mut mlx5e_ipsec, family: u32, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rx_ft_put_policy(ipsec: *mut mlx5e_ipsec, family: u32, prio: u32, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ipsec_counter_rule_tx(mdev: *mut mlx5_core_dev, tx: *mut mlx5e_ipsec_tx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx_put(ipsec: *mut mlx5e_ipsec, tx: *mut mlx5e_ipsec_tx) {
    ...
    ipsec_esw_tx_ft_policy_set(ipsec.mdev, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn tx_ft_put(ipsec: *mut mlx5e_ipsec, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tx_ft_put_policy(ipsec: *mut mlx5e_ipsec, prio: u32, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn setup_fte_esp(spec: *mut mlx5_flow_spec) {
...
#[no_mangle]
unsafe extern "C" fn setup_fte_spi(spec: *mut mlx5_flow_spec, spi: u32, encap: bool) {
...
#[no_mangle]
unsafe extern "C" fn setup_fte_no_frags(spec: *mut mlx5_flow_spec) {
...
#[no_mangle]
unsafe extern "C" fn setup_fte_reg_a(spec: *mut mlx5_flow_spec) {
...
#[no_mangle]
unsafe extern "C" fn setup_fte_reg_c4(spec: *mut mlx5_flow_spec, reqid: u32) {
...
#[no_mangle]
unsafe extern "C" fn setup_fte_upper_proto_match(spec: *mut mlx5_flow_spec, upspec: *mut upspec) {
    ...
    {
    let mut ns_type: enum mlx5_flow_namespace_type = ipsec_fs_get_ns(ipsec, type, dir);
    u8 action[3][MLX5_UN_SZ_BYTES(set_add_copy_action_in_auto)] = {};
    struct mlx5_core_dev *mdev = ipsec.mdev;
    struct mlx5_modify_hdr *modify_hdr;
    let mut num_of_actions: u8 = 1;
...
#[no_mangle]
unsafe extern "C" fn get_reformat_type(attrs: *mut mlx5_accel_esp_xfrm_attrs) -> c_int {
...
// convert to network format
    ...
    attrs.dir);
    let mut reformat_params: mlx5_pkt_reformat_params = {};
    struct mlx5_core_dev *mdev = ipsec.mdev;
...
#[no_mangle]
unsafe extern "C" fn rx_add_rule(sa_entry: *mut mlx5e_ipsec_sa_entry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx_add_rule(sa_entry: *mut mlx5e_ipsec_sa_entry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx_add_policy(pol_entry: *mut mlx5e_ipsec_pol_entry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rx_add_policy(pol_entry: *mut mlx5e_ipsec_pol_entry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipsec_fs_destroy_counters(ipsec: *mut mlx5e_ipsec) {
...
#[no_mangle]
unsafe extern "C" fn ipsec_fs_init_counters(ipsec: *mut mlx5e_ipsec) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_accel_ipsec_fs_read_stats(priv: *mut mlx5e_priv, ipsec_stats: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_ipsec_block_tc_offload(mdev: *mut mlx5_core_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_ipsec_unblock_tc_offload(mdev: *mut mlx5_core_dev) {
    static void mlx5e_ipsec_unblock_tc_offload(struct mlx5_core_dev *mdev)
    {
    mdev.num_block_tc--;
    }
#[no_mangle]
pub unsafe extern "C" fn mlx5e_accel_ipsec_fs_add_rule(sa_entry: *mut mlx5e_ipsec_sa_entry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_accel_ipsec_fs_del_rule(sa_entry: *mut mlx5e_ipsec_sa_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_accel_ipsec_fs_add_pol(pol_entry: *mut mlx5e_ipsec_pol_entry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_accel_ipsec_fs_del_pol(pol_entry: *mut mlx5e_ipsec_pol_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_accel_ipsec_fs_cleanup(ipsec: *mut mlx5e_ipsec) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_accel_ipsec_fs_modify(sa_entry: *mut mlx5e_ipsec_sa_entry) {
    void mlx5e_accel_ipsec_fs_modify(struct mlx5e_ipsec_sa_entry *sa_entry)
    {
    let mut sa_entry_shadow: mlx5e_ipsec_sa_entry = {};
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_ipsec_fs_tunnel_allowed(sa_entry: *mut mlx5e_ipsec_sa_entry) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_ipsec_send_event(priv: *mut mlx5e_priv, event: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_ipsec_disable_events(priv: *mut mlx5e_priv) {
    void mlx5e_ipsec_disable_events(struct mlx5e_priv *priv)
    {
    struct mlx5_devcom_comp_dev *tmp = core::ptr::null_mut();
