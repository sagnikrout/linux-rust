...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/sf/devlink.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5_sf_table {
    pub /: *mut *mut *mut mlx5_core_dev dev; / To refer from notifier context.,
    pub /: *mut *mut xarray function_ids; / function id based lookup.,
    pub /: *mut *mut mutex sf_state_lock; / Serializes sf state among user cmds & vhca event handler.,
}
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_function_id_insert(table: *mut mlx5_sf_table, sf: *mut mlx5_sf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_function_id_erase(table: *mut mlx5_sf_table, sf: *mut mlx5_sf) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_free(table: *mut mlx5_sf_table, sf: *mut mlx5_sf) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_to_devlink_state(hw_state: u8) -> enum devlink_port_fn_state {
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_to_devlink_opstate(hw_state: u8) -> enum devlink_port_fn_opstate {
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_is_active(sf: *const mlx5_sf) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_deactivate(dev: *mut mlx5_core_dev, sf: *mut mlx5_sf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(DEVLINK_PORT_FN_STATE_INACTIVE: state ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_table_supported(dev: *const mlx5_core_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_dealloc(table: *mut mlx5_sf_table, sf: *mut mlx5_sf) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_del(table: *mut mlx5_sf_table, sf: *mut mlx5_sf) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_state_update_check(sf: *const mlx5_sf, new_state: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_vhca_event(nb: *mut notifier_block, opcode: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_del_all(table: *mut mlx5_sf_table) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_esw_event(nb: *mut notifier_block, event: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_sf_mdev_event(nb: *mut notifier_block, event: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_sf_notifiers_init(dev: *mut mlx5_core_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_sf_table_init(dev: *mut mlx5_core_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_sf_notifiers_cleanup(dev: *mut mlx5_core_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_sf_table_cleanup(dev: *mut mlx5_core_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_sf_table_empty(dev: *const mlx5_core_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_sf_table_esw_changed_event_handler(dev: *mut mlx5_core_dev) {
    ...
    sf.hw_state = MLX5_VHCA_STATE_ACTIVE;
#[no_mangle]
pub unsafe extern "C" fn if(MLX5_VHCA_STATE_TEARDOWN_REQUEST: sf->hw_state ==) -> else {
