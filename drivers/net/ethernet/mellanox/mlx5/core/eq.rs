...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/eq.c
#![no_std]
...
pub const MLX5_EQ_DOORBELL_OFFSET: c_uint = 0x40;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5_eq_table {
    pub comp_eqs: xarray,
    pub pages_eq: mlx5_eq_async,
    pub cmd_eq: mlx5_eq_async,
    pub async_eq: mlx5_eq_async,
    pub nh: [atomic_notifier_head; MLX5_EVENT_TYPE_MAX],
// Since CQ DB is stored in async_eq
    pub cq_err_nb: mlx5_nb,
    pub /: *mut *mut mutex lock; / sync async eqs creations,
    pub /: *mut *mut mutex comp_lock; / sync comp eqs creations,
    pub curr_comp_eqs: c_int,
    pub max_comp_eqs: c_int,
    pub irq_table: *mut mlx5_irq_table,
    pub comp_irqs: xarray,
    pub ctrl_irq: *mut mlx5_irq,
    pub rmap: *mut cpu_rmap,
    pub used_cpus: cpumask,
}
...
#[no_mangle]
unsafe extern "C" fn mlx5_cmd_destroy_eq(dev: *mut mlx5_core_dev, eqn: u8) -> c_int {
...
// caller must eventually call mlx5_cq_put on the returned cq
    ...
    struct mlx5_core_cq *cq = core::ptr::null_mut();
    rcu_read_lock();
...
//
#[no_mangle]
pub unsafe extern "C" fn mlx5_eq_poll_irq_disabled(eq: *mut mlx5_eq_comp) -> u32 {
    u32 mlx5_eq_poll_irq_disabled(struct mlx5_eq_comp *eq)
    {
    u32 count_eqe;
    disable_irq(eq.core.irqn);
    count_eqe = eq.core.cons_index;
    mlx5_eq_comp_int(&eq.irq_nb, 0, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_cmd_eq_recover(dev: *mut mlx5_core_dev) {
    void mlx5_cmd_eq_recover(struct mlx5_core_dev *dev)
    {
    struct mlx5_eq_async *eq = &dev.priv.eq_table.cmd_eq;
    int eqes;
    eqes = mlx5_eq_async_int(&eq.irq_nb, ASYNC_EQ_RECOVER, core::ptr::null_mut());
    if (eqes)
    mlx5_core_warn(dev, "Recovered %d EQEs on cmd_eq\n", eqes);
    }
#[no_mangle]
unsafe extern "C" fn init_eq_buf(eq: *mut mlx5_eq) {
    ...
    {
    let mut log_eq_size: u8 = order_base_2(param.nent + MLX5_NUM_SPARE_EQE);
    struct mlx5_cq_table *cq_table = &eq.cq_table;
    u32 out[MLX5_ST_SZ_DW(create_eq_out)] = {0};
    let mut log_eq_stride: u8 = ilog2(MLX5_EQE_SIZE);
...
#[no_mangle]
unsafe extern "C" fn destroy_unmap_eq(dev: *mut mlx5_core_dev, eq: *mut mlx5_eq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_eq_add_cq(eq: *mut mlx5_eq, cq: *mut mlx5_core_cq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_eq_del_cq(eq: *mut mlx5_eq, cq: *mut mlx5_core_cq) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_eq_table_init(dev: *mut mlx5_core_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_eq_table_cleanup(dev: *mut mlx5_core_dev) {
...
#[no_mangle]
unsafe extern "C" fn destroy_async_eq(dev: *mut mlx5_core_dev, eq: *mut mlx5_eq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gather_user_async_events(dev: *mut mlx5_core_dev, mask[4]: u64) {
...
#[no_mangle]
unsafe extern "C" fn gather_async_events_mask(dev: *mut mlx5_core_dev, mask[4]: u64) {
    static void gather_async_events_mask(struct mlx5_core_dev *dev, u64 mask[4])
    {
    let mut async_event_mask: u64 = MLX5_ASYNC_EVENT_MASK;
...
#[no_mangle]
unsafe extern "C" fn async_eq_depth_devlink_param_get(dev: *mut mlx5_core_dev) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn create_async_eqs(dev: *mut mlx5_core_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn destroy_async_eqs(dev: *mut mlx5_core_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_eq_synchronize_async_irq(dev: *mut mlx5_core_dev) {
    void mlx5_eq_synchronize_async_irq(struct mlx5_core_dev *dev)
    {
    synchronize_irq(dev.priv.eq_table.async_eq.core.irqn);
    }
#[no_mangle]
pub unsafe extern "C" fn mlx5_eq_synchronize_cmd_irq(dev: *mut mlx5_core_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_eq_destroy_generic(dev: *mut mlx5_core_dev, eq: *mut mlx5_eq) -> c_int {
    ...
    {
    let mut ci: u32 = eq.cons_index + cc;
    let mut nent: u32 = eq_get_size(eq);
    struct mlx5_eqe *eqe;
    eqe = get_eqe(eq, ci & (nent - 1));
    eqe = ((eqe.owner & 1) ^ !!(ci & nent)) ? core::ptr::null_mut() : eqe;
// Make sure we read EQ entry contents after we've
// checked the ownership bit.
//
    if (eqe)
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_eq_update_ci(eq: *mut mlx5_eq, cc: u32, arm: bool) {
...
#[no_mangle]
unsafe extern "C" fn comp_irq_release_pci(dev: *mut mlx5_core_dev, vecidx: u16) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_cpumask_default_spread(dev: *mut mlx5_core_dev, index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn comp_irq_request_pci(dev: *mut mlx5_core_dev, vecidx: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn comp_irq_release_sf(dev: *mut mlx5_core_dev, vecidx: u16) {
...
#[no_mangle]
unsafe extern "C" fn comp_irq_request_sf(dev: *mut mlx5_core_dev, vecidx: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn comp_irq_release(dev: *mut mlx5_core_dev, vecidx: u16) {
...
#[no_mangle]
unsafe extern "C" fn comp_irq_request(dev: *mut mlx5_core_dev, vecidx: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alloc_rmap(mdev: *mut mlx5_core_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_rmap(mdev: *mut mlx5_core_dev) {
    static void free_rmap(struct mlx5_core_dev *mdev)
    {
    struct mlx5_eq_table *eq_table = mdev.priv.eq_table;
    if (eq_table.rmap) {
    free_irq_cpu_rmap(eq_table.rmap);
    eq_table.rmap = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn destroy_comp_eq(dev: *mut mlx5_core_dev, eq: *mut mlx5_eq_comp, vecidx: u16) {
...
#[no_mangle]
unsafe extern "C" fn comp_eq_depth_devlink_param_get(dev: *mut mlx5_core_dev) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn create_comp_eq(dev: *mut mlx5_core_dev, vecidx: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_comp_eqn_get(dev: *mut mlx5_core_dev, vecidx: u16, eqn: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_comp_irqn_get(dev: *mut mlx5_core_dev, vector: c_int, irqn: *mut c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_comp_vectors_max(dev: *mut mlx5_core_dev) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_comp_vector_get_cpu(dev: *mut mlx5_core_dev, vector: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_core_eq_free_irqs(dev: *mut mlx5_core_dev) {
    void mlx5_core_eq_free_irqs(struct mlx5_core_dev *dev)
    {
    mlx5_irq_table_free_irqs(dev);
    }

pub const MLX5_MAX_ASYNC_EQS: c_int = 4;

pub const MLX5_MAX_ASYNC_EQS: c_int = 3;

#[no_mangle]
unsafe extern "C" fn get_num_eqs(dev: *mut mlx5_core_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_eq_table_create(dev: *mut mlx5_core_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_eq_table_destroy(dev: *mut mlx5_core_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_eq_notifier_register(dev: *mut mlx5_core_dev, nb: *mut mlx5_nb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_eq_notifier_unregister(dev: *mut mlx5_core_dev, nb: *mut mlx5_nb) -> c_int {
