...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/dpll.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5_dpll {
    pub dpll: *mut dpll_device,
    pub dpll_tracker: dpll_tracker,
    pub dpll_pin: *mut dpll_pin,
    pub pin_tracker: dpll_tracker,
    pub mdev: *mut mlx5_core_dev,
    pub wq: *mut workqueue_struct,
    pub work: delayed_work,
    struct {
    pub valid: bool,
    pub lock_status: enum dpll_lock_status,
    pub pin_state: enum dpll_pin_state,
    pub last: },
...
#[no_mangle]
unsafe extern "C" fn mlx5_dpll_clock_id_get(mdev: *mut mlx5_core_dev, clock_id: *mut u64) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5_dpll_synce_status {
    pub admin_status: enum mlx5_msees_admin_status,
    pub oper_status: enum mlx5_msees_oper_status,
    pub ho_acq: bool,
    pub oper_freq_measure: bool,
    pub failure_reason: enum mlx5_msees_failure_reason,
    pub frequency_diff: i32,
}
...
#[no_mangle]
unsafe extern "C" fn mlx5_dpll_periodic_work_queue(mdpll: *mut mlx5_dpll) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_dpll_periodic_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_dpll_netdev_dpll_pin_clear(mdpll: *mut mlx5_dpll) {
    static void mlx5_dpll_netdev_dpll_pin_clear(struct mlx5_dpll *mdpll)
    {
    if (!mdpll.tracking_netdev)
    return;
    dpll_netdev_pin_clear(mdpll.tracking_netdev);
    mdpll.tracking_netdev = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn mlx5_dpll_remove(adev: *mut auxiliary_device) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_dpll_suspend(adev: *mut auxiliary_device, state: pm_message_t) -> c_int {
    static int mlx5_dpll_suspend(struct auxiliary_device *adev, pm_message_t state)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mlx5_dpll_resume(adev: *mut auxiliary_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_dpll_init() -> int __init {
    static int __init mlx5_dpll_init(void)
    {
    return auxiliary_driver_register(&mlx5_dpll_driver);
    }
#[no_mangle]
unsafe extern "C" fn mlx5_dpll_exit() -> void __exit {
