...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/events.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5_events {
    pub dev: *mut mlx5_core_dev,
    pub wq: *mut workqueue_struct,
    pub notifiers: [mlx5_event_nb; ARRAY_SIZE(events_nbs_ref)],
// driver notifier chain for fw events
    pub fw_nh: atomic_notifier_head,
// port module events stats
    pub pme_stats: mlx5_pme_stats,
// pcie_core
    pub pcie_core_work: work_struct,
// driver notifier chain for sw events
    pub sw_nh: blocking_notifier_head,
}
...
// handles all FW events, type == eqe->type
    ...
    let mut num_bits: c_int = sizeof(bit_set) * BITS_PER_BYTE;
    int i;
...
#[no_mangle]
unsafe extern "C" fn temp_warn(nb: *mut notifier_block, type: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_module(nb: *mut notifier_block, type: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_pcie_event(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pcie_core(nb: *mut notifier_block, type: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_get_pme_stats(dev: *mut mlx5_core_dev, stats: *mut mlx5_pme_stats) {
...
#[no_mangle]
unsafe extern "C" fn forward_event(nb: *mut notifier_block, event: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_events_init(dev: *mut mlx5_core_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_events_cleanup(dev: *mut mlx5_core_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_events_start(dev: *mut mlx5_core_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_events_stop(dev: *mut mlx5_core_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mlx5_notifier_register(dev: *mut mlx5_core_dev, nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_notifier_unregister(dev: *mut mlx5_core_dev, nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_notifier_call_chain(events: *mut mlx5_events, event: c_uint, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mlx5_blocking_notifier_register(dev: *mut mlx5_core_dev, nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_blocking_notifier_unregister(dev: *mut mlx5_core_dev, nb: *mut notifier_block) -> c_int {
