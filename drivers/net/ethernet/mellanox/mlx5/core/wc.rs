...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/wc.c
#![no_std]
...
pub const TEST_WC_NUM_WQES: c_int = 255;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5_wc_cq {
...
#[no_mangle]
unsafe extern "C" fn create_wc_cq(cq: *mut mlx5_wc_cq, cqc_data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_wc_create_cq(mdev: *mut mlx5_core_dev, cq: *mut mlx5_wc_cq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_wc_destroy_cq(cq: *mut mlx5_wc_cq) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_wc_create_sq(mdev: *mut mlx5_core_dev, sq: *mut mlx5_wc_sq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_wc_destroy_sq(sq: *mut mlx5_wc_sq) {
    ...
    bool signaled)
    {
    let mut buf_size: c_int = (1 << MLX5_CAP_GEN(sq.cq.mdev, log_bf_reg_size)) / 2;
...
#[no_mangle]
unsafe extern "C" fn mlx5_wc_poll_cq(sq: *mut mlx5_wc_sq) -> c_int {
...
//
    ...
    let mut wqe_counter: c_int = be16_to_cpu(cqe.wqe_counter);
    struct mlx5_core_dev *mdev = cq.mdev;
...
#[no_mangle]
unsafe extern "C" fn mlx5_core_test_wc(mdev: *mut mlx5_core_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_wc_support_get(mdev: *mut mlx5_core_dev) -> bool {
    bool mlx5_wc_support_get(struct mlx5_core_dev *mdev)
    {
    struct mutex *wc_state_lock = &mdev.wc_state_lock;
    struct mlx5_core_dev *parent = core::ptr::null_mut();
