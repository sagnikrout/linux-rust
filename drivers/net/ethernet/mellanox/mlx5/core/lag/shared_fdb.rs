...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/lag/shared_fdb.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_lag_shared_fdb_supported_filter(ldev: *mut mlx5_lag, filter: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_lag_shared_fdb_supported(ldev: *mut mlx5_lag) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mlx5_lag_create_single_fdb_filter(ldev: *mut mlx5_lag, filter: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_lag_create_vport_lag(ldev: *mut mlx5_lag, group_id: u32) -> c_int {
    int mlx5_lag_create_vport_lag(struct mlx5_lag *ldev, u32 group_id)
    {
    let mut filter: u32 = group_id ? group_id : MLX5_LAG_FILTER_ALL;
    int master_idx = mlx5_lag_get_dev_index_by_seq_filter(ldev, MLX5_LAG_P1,
    filter);
    struct mlx5_eswitch *master_esw;
    struct mlx5_core_dev *dev0;
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_lag_destroy_vport_lag(ldev: *mut mlx5_lag, group_id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_lag_create_single_fdb(ldev: *mut mlx5_lag) -> c_int {
    int mlx5_lag_create_single_fdb(struct mlx5_lag *ldev)
    {
    return mlx5_lag_create_single_fdb_filter(ldev, MLX5_LAG_FILTER_ALL);
    }
#[no_mangle]
pub unsafe extern "C" fn mlx5_lag_destroy_single_fdb(ldev: *mut mlx5_lag) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_lag_shared_fdb_destroy(ldev: *mut mlx5_lag, group_id: u32) {
