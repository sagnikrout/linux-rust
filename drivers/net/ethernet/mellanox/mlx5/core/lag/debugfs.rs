...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/lag/debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn type_show(file: *mut seq_file, priv: *mut c_void) -> c_int {
    static int type_show(struct seq_file *file, void *priv)
    {
    struct mlx5_core_dev *dev = file.private;
    struct mlx5_lag *ldev;
    char *mode = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn port_sel_mode_show(file: *mut seq_file, priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn state_show(file: *mut seq_file, priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flags_show(file: *mut seq_file, priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mapping_show(file: *mut seq_file, priv: *mut c_void) -> c_int {
    static int mapping_show(struct seq_file *file, void *priv)
    {
    struct mlx5_core_dev *dev = file.private;
    u8 ports[MLX5_MAX_PORTS] = {};
    struct mlx5_lag *ldev;
    let mut hash: bool = false;
    bool lag_active;
    int i, idx = 0;
    int num_ports;
    ldev = mlx5_lag_dev(dev);
...
#[no_mangle]
unsafe extern "C" fn members_show(file: *mut seq_file, priv: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_ldev_add_debugfs(dev: *mut mlx5_core_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_ldev_remove_debugfs(dbg: *mut dentry) {
