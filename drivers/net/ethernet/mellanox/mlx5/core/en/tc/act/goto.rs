...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/en/tc/act/goto.c
#![no_std]
...
// Copyright (c) 2021, NVIDIA CORPORATION & AFFILIATES. All rights reserved.
    ...
    let mut is_esw: bool = mlx5e_is_eswitch_flow(flow);
    let mut ft_flow: bool = mlx5e_is_ft_flow(flow);
    let mut dest_chain: u32 = act.chain_index;
