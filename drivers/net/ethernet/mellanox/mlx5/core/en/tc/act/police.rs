...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/en/tc/act/police.c
#![no_std]
...
// change rate to bits per second
    ...
    struct mlx5_flow_attr *attr)
    {
    let mut ns: enum mlx5_flow_namespace_type = mlx5e_get_flow_namespace(parse_state.flow);
    ...
    {
    let mut params: mlx5e_flow_meter_params = {};
