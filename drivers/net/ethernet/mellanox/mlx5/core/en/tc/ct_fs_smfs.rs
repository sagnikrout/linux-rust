...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/en/tc/ct_fs_smfs.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5_ct_fs_smfs_matcher {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5_ct_fs_smfs_matchers {
    pub smfs_matchers: [mlx5_ct_fs_smfs_matcher; 6],
    pub used: list_head,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5_ct_fs_smfs {
    pub ct_nat_tbl: *mut *mut mlx5dr_table ct_tbl,,
    pub matchers: mlx5_ct_fs_smfs_matchers,
    pub matchers_nat: mlx5_ct_fs_smfs_matchers,
    pub fwd_action: *mut mlx5dr_action,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5_ct_fs_smfs_rule {
    pub fs_rule: mlx5_ct_fs_rule,
    pub rule: *mut mlx5dr_rule,
    pub count_action: *mut mlx5dr_action,
    pub smfs_matcher: *mut mlx5_ct_fs_smfs_matcher,
}
