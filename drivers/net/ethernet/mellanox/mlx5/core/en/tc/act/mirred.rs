...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/en/tc/act/mirred.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: netdev_port_same_parent_id(priv->netdev, _arg: out_dev)) -> else {
    else if (netdev_port_same_parent_id(priv.netdev, out_dev))
    err = parse_mirred(parse_state, act, priv, attr);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: netif_is_ovs_master(out_dev)) -> else {
