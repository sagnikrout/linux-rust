...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/en/tc_tun_vxlan.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mlx5e_tc_tun_can_offload_vxlan(priv: *mut mlx5e_priv) -> bool {
    static bool mlx5e_tc_tun_can_offload_vxlan(struct mlx5e_priv *priv)
    {
    return !!MLX5_CAP_ESW(priv.mdev, vxlan_encap_decap);
    }
#[no_mangle]
unsafe extern "C" fn mlx5e_tc_tun_calc_hlen_vxlan(e: *mut mlx5e_encap_entry) -> c_int {
...
// check the UDP destination port validity
    ...
    {
    let mut dst_port: c_int = be16_to_cpu(e.tun_info.key.tp_dst);
...
#[no_mangle]
unsafe extern "C" fn mlx5e_tc_tun_get_remote_ifindex(mirred_dev: *mut net_device) -> c_int {
