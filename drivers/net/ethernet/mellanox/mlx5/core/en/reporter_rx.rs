...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/en/reporter_rx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mlx5e_query_rq_state(dev: *mut mlx5_core_dev, rqn: u32, state: *mut u8) -> c_int {
    static int mlx5e_query_rq_state(struct mlx5_core_dev *dev, u32 rqn, u8 *state)
    {
    let mut outlen: c_int = MLX5_ST_SZ_BYTES(query_rq_out);
    void *out;
    void *rqc;
    int err;
...
#[no_mangle]
unsafe extern "C" fn mlx5e_wait_for_icosq_flush(icosq: *mut mlx5e_icosq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_reset_icosq_cc_pc(icosq: *mut mlx5e_icosq) {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_rx_reporter_err_icosq_cqe_recover(ctx: *mut c_void) -> c_int {
    static int mlx5e_rx_reporter_err_icosq_cqe_recover(void *ctx)
    {
    struct mlx5e_rq *xskrq = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mlx5e_rx_reporter_err_rq_cqe_recover(ctx: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_rx_reporter_timeout_recover(ctx: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_rx_reporter_recover_from_ctx(err_ctx: *mut mlx5e_err_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_health_rq_put_sw_state(fmsg: *mut devlink_fmsg, rq: *mut mlx5e_rq) {
    ...
    rq_stride = BIT(mlx5e_mpwqe_get_log_stride_size(rq.mdev, params, core::ptr::null_mut()));
    ...
    struct devlink_fmsg *fmsg)
    {
    let mut max_nch: c_uint = mlx5e_rx_res_get_max_nch(rx_res);
    int i;
    ...
    struct devlink_fmsg *fmsg)
    {
    let mut found_valid_tir: bool = false;
    int tt;
...
#[no_mangle]
unsafe extern "C" fn mlx5e_rx_reporter_diagnose_rqs(priv: *mut mlx5e_priv, fmsg: *mut devlink_fmsg) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_reporter_rx_timeout(rq: *mut mlx5e_rq) {
    void mlx5e_reporter_rx_timeout(struct mlx5e_rq *rq)
    {
    char err_str[MLX5E_REPORTER_PER_Q_MAX_LEN];
    struct mlx5e_icosq *icosq = rq.icosq;
    struct mlx5e_priv *priv = rq.priv;
    let mut err_ctx: mlx5e_err_ctx = {};
    char icosq_str[32] = {};
    err_ctx.ctx = rq;
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_reporter_rq_cqe_err(rq: *mut mlx5e_rq) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_reporter_icosq_cqe_err(icosq: *mut mlx5e_icosq) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_reporter_icosq_suspend_recovery(c: *mut mlx5e_channel) {
    void mlx5e_reporter_icosq_suspend_recovery(struct mlx5e_channel *c)
    {
    mutex_lock(&c.icosq_recovery_lock);
    }
#[no_mangle]
pub unsafe extern "C" fn mlx5e_reporter_icosq_resume_recovery(c: *mut mlx5e_channel) {
    void mlx5e_reporter_icosq_resume_recovery(struct mlx5e_channel *c)
    {
    mutex_unlock(&c.icosq_recovery_lock);
    }
pub const MLX5E_REPORTER_RX_GRACEFUL_PERIOD: c_int = 500;
pub const MLX5E_REPORTER_RX_BURST_PERIOD: c_int = 500;
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_reporter_rx_create(priv: *mut mlx5e_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_reporter_rx_destroy(priv: *mut mlx5e_priv) {
    void mlx5e_reporter_rx_destroy(struct mlx5e_priv *priv)
    {
    if (!priv.rx_reporter)
    return;
    devlink_health_reporter_destroy(priv.rx_reporter);
    priv.rx_reporter = core::ptr::null_mut();
    }
