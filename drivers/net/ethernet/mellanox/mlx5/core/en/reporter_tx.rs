...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/en/reporter_tx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mlx5e_wait_for_sq_flush(sq: *mut mlx5e_txqsq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_reset_txqsq_cc_pc(sq: *mut mlx5e_txqsq) {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_health_sq_put_sw_state(fmsg: *mut devlink_fmsg, sq: *mut mlx5e_txqsq) {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_tx_reporter_err_cqe_recover(ctx: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5e_tx_timeout_ctx {
    pub sq: *mut mlx5e_txqsq,
    pub status: signed int,
}

#[no_mangle]
unsafe extern "C" fn mlx5e_tx_reporter_timeout_recover(ctx: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_tx_reporter_ptpsq_unhealthy_recover(ctx: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mlx5e_tx_reporter_recover_from_ctx(err_ctx: *mut mlx5e_err_ctx) -> c_int {
    ...
    {
    let mut stopped: bool = netif_xmit_stopped(sq.txq);
    u8 state;
    int err;
    ...
    {
    let mut real_time: bool = mlx5_is_real_time_sq(txqsq.mdev);
    let mut sq_sz: u32 = mlx5_wq_cyc_get_size(&txqsq.wq);
    let mut sq_stride: u32 = MLX5_SEND_WQE_BB;
    ...
    {
    struct mlx5e_priv *priv = devlink_health_reporter_priv(reporter);
    let mut num_tc: u8 = mlx5e_get_dcb_num_tc(&priv.channels.params);
    u32 tc, i, tisn;
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_reporter_tx_err_cqe(sq: *mut mlx5e_txqsq) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_reporter_tx_timeout(sq: *mut mlx5e_txqsq) -> c_int {
    int mlx5e_reporter_tx_timeout(struct mlx5e_txqsq *sq)
    {
    char err_str[MLX5E_REPORTER_PER_Q_MAX_LEN];
    let mut to_ctx: mlx5e_tx_timeout_ctx = {};
    struct mlx5e_priv *priv = sq.priv;
    let mut err_ctx: mlx5e_err_ctx = {};
    to_ctx.sq = sq;
    err_ctx.ctx = &to_ctx;
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_reporter_tx_ptpsq_unhealthy(ptpsq: *mut mlx5e_ptpsq) {
...
pub const MLX5E_REPORTER_TX_GRACEFUL_PERIOD: c_int = 500;
pub const MLX5E_REPORTER_TX_BURST_PERIOD: c_int = 500;
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_reporter_tx_create(priv: *mut mlx5e_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5e_reporter_tx_destroy(priv: *mut mlx5e_priv) {
    void mlx5e_reporter_tx_destroy(struct mlx5e_priv *priv)
    {
    if (!priv.tx_reporter)
    return;
    devlink_health_reporter_destroy(priv.tx_reporter);
    priv.tx_reporter = core::ptr::null_mut();
    }
