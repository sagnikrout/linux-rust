...
//! Source: drivers/net/ethernet/mellanox/mlx5/core/en/tc_tun_geneve.c
#![no_std]
...
pub const MLX5E_GENEVE_VER: c_int = 0;
#[no_mangle]
unsafe extern "C" fn mlx5e_tc_tun_can_offload_geneve(priv: *mut mlx5e_priv) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_tc_tun_calc_hlen_geneve(e: *mut mlx5e_encap_entry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_tunnel_id_to_vni(tun_id: __be64, vni: *mut __u8) {
...
// ip_proto = IPPROTO_UDP;
    ...
    struct flow_cls_offload *f)
    {
    let mut max_tlv_option_data_len: u8 = MLX5_CAP_GEN(priv.mdev, max_geneve_tlv_option_data_len);
    let mut max_tlv_options: u8 = MLX5_CAP_GEN(priv.mdev, max_geneve_tlv_options);
    struct flow_rule *rule = flow_cls_offload_flow_rule(f);
    struct netlink_ext_ack *extack = f.common.extack;
    void *misc_c, *misc_v, *misc_3_c, *misc_3_v;
    struct geneve_opt *option_key, *option_mask;
    let mut opt_data_key: __be32 = 0, opt_data_mask = 0;
