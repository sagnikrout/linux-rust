...
//! Source: drivers/net/ethernet/mellanox/mlxsw/minimal.c
#![no_std]
...
pub const MLXSW_M_FWREV_MINOR: c_int = 2000;
pub const MLXSW_M_FWREV_SUBMINOR: c_int = 1886;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_m_line_card {
    pub active: bool,
    pub module_to_port: [c_int; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_m {
    pub ports: *mut mlxsw_m_port,
    pub core: *mut mlxsw_core,
    pub bus_info: *const mlxsw_bus_info,
    pub base_mac: [u8; ETH_ALEN],
    pub max_ports: u8,
    pub /: *mut *mut u8 max_modules_per_slot; / Maximum number of modules per-slot.,
    pub /: *mut *mut u8 num_of_slots; / Including the main board.,
    pub line_cards: *mut mlxsw_m_line_card,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_m_port {
    pub dev: *mut net_device,
    pub mlxsw_m: *mut mlxsw_m,
    pub local_port: u16,
    pub slot_index: u8,
    pub module: u8,
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_base_mac_get(mlxsw_m: *mut mlxsw_m) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_port_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_port_stop(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_reset(netdev: *mut net_device, flags: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_port_created(mlxsw_m: *mut mlxsw_m, local_port: u16) -> bool {
...
//
    ...
    return 0;
    err_register_netdev:
    mlxsw_m.ports[local_port] = core::ptr::null_mut();
    err_dev_addr_get:
    free_netdev(dev);
    err_alloc_etherdev:
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_port_remove(mlxsw_m: *mut mlxsw_m, local_port: u16) {
    ...
    u8 *last_module)
    {
    let mut max_ports: c_uint = mlxsw_core_max_ports(mlxsw_m.core);
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_linecards_init(mlxsw_m: *mut mlxsw_m) -> c_int {
    ...
    if (err)
    return err;
    mlxsw_reg_mgpir_unpack(mgpir_pl, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), &num_of_modules,
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_linecards_fini(mlxsw_m: *mut mlxsw_m) {
    static void mlxsw_m_linecards_fini(struct mlxsw_m *mlxsw_m)
    {
    let mut i: c_int = mlxsw_m.num_of_slots;
    for (i--; i >= 0; i--)
    kfree(mlxsw_m.line_cards[i]);
    kfree(mlxsw_m.line_cards);
    kfree(mlxsw_m.ports);
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_ports_module_map(mlxsw_m: *mut mlxsw_m) -> c_int {
    static int mlxsw_m_ports_module_map(struct mlxsw_m *mlxsw_m)
    {
    let mut max_ports: c_uint = mlxsw_core_max_ports(mlxsw_m.core);
    let mut last_module: u8 = max_ports;
    int i, err;
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_ports_create(mlxsw_m: *mut mlxsw_m) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_ports_remove(mlxsw_m: *mut mlxsw_m) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_fw_rev_validate(mlxsw_m: *mut mlxsw_m) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_fini(mlxsw_core: *mut mlxsw_core) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_m_module_exit() -> void __exit {
