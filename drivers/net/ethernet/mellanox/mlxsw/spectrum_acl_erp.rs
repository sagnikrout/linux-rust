...
//! Source: drivers/net/ethernet/mellanox/mlxsw/spectrum_acl_erp.c
#![no_std]
...
pub const MLXSW_SP_ACL_ERP_GENALLOC_OFFSET: c_uint = 0x100;
pub const MLXSW_SP_ACL_ERP_MAX_PER_REGION: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_acl_erp_core {
    pub 1]: unsigned int erpt_entries_size[MLXSW_SP_ACL_ATCAM_REGION_TYPE_MAX +,
    pub erp_tables: *mut gen_pool,
    pub mlxsw_sp: *mut mlxsw_sp,
    pub bf: *mut mlxsw_sp_acl_bf,
    pub num_erp_banks: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_acl_erp_key {
    pub mask: [c_char; MLXSW_REG_PTCEX_FLEX_KEY_BLOCKS_LEN],
pub const __MASK_LEN: c_uint = 0x38;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_acl_erp {
    pub key: mlxsw_sp_acl_erp_key,
    pub id: u8,
    pub index: u8,
    pub MLXSW_SP_ACL_TCAM_MASK_LEN): DECLARE_BITMAP(mask_bitmap,,
    pub list: list_head,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_acl_erp_master_mask {
    pub MLXSW_SP_ACL_TCAM_MASK_LEN): DECLARE_BITMAP(bitmap,,
    pub count: [c_uint; MLXSW_SP_ACL_TCAM_MASK_LEN],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_acl_erp_table {
    pub master_mask: mlxsw_sp_acl_erp_master_mask,
    pub MLXSW_SP_ACL_ERP_MAX_PER_REGION): DECLARE_BITMAP(erp_id_bitmap,,
    pub MLXSW_SP_ACL_ERP_MAX_PER_REGION): DECLARE_BITMAP(erp_index_bitmap,,
    pub atcam_erps_list: list_head,
    pub erp_core: *mut mlxsw_sp_acl_erp_core,
    pub aregion: *mut mlxsw_sp_acl_atcam_region,
    pub ops: *const mlxsw_sp_acl_erp_table_ops,
    pub base_index: c_ulong,
    pub num_atcam_erps: c_uint,
    pub num_max_atcam_erps: c_uint,
    pub num_ctcam_erps: c_uint,
    pub num_deltas: c_uint,
    pub objagg: *mut objagg,
    pub /: *mut *mut mutex objagg_lock; / guards objagg manipulation,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_acl_erp_table_ops {
    struct mlxsw_sp_acl_erp *
    (*erp_create)(struct mlxsw_sp_acl_erp_table *erp_table,
    pub key): *mut mlxsw_sp_acl_erp_key,
    void (*erp_destroy)(struct mlxsw_sp_acl_erp_table *erp_table,
    pub erp): *mut mlxsw_sp_acl_erp,
}
...
// p_index = index;
    ...
    {
    let mut entry_size: c_uint = mlxsw_sp_acl_erp_table_entry_size(erp_table);
    struct mlxsw_sp_acl_erp_core *erp_core = erp_table.erp_core;
    unsigned int row;
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_acl_erp_table_erp_del(erp: *mut mlxsw_sp_acl_erp) {
...
//
    ...
    struct mlxsw_sp_acl_erp_core *erp_core = erp_table.erp_core;
    let mut old_base_index: c_ulong = erp_table.base_index;
    let mut ctcam_le: bool = erp_table.num_ctcam_erps > 0;
    int err;
    ...
    {
    struct mlxsw_sp_acl_atcam_region *aregion = erp_table.aregion;
    let mut erp_bank: c_uint = mlxsw_sp_acl_erp_bank_get(erp);
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_acl_erp_region_erp_del(erp: *mut mlxsw_sp_acl_erp) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_acl_erp_ctcam_inc(erp_table: *mut mlxsw_sp_acl_erp_table) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_acl_erp_delta_inc(erp_table: *mut mlxsw_sp_acl_erp_table) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_acl_erp_ctcam_dec(erp_table: *mut mlxsw_sp_acl_erp_table) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_acl_erp_delta_dec(erp_table: *mut mlxsw_sp_acl_erp_table) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_acl_erp_mask_erp_id(erp_mask: *const mlxsw_sp_acl_erp_mask) -> u8 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_acl_erp_delta {
    pub key: mlxsw_sp_acl_erp_key,
    pub start: u16,
    pub mask: u8,
}
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_acl_erp_delta_start(delta: *const mlxsw_sp_acl_erp_delta) -> u16 {
    u16 mlxsw_sp_acl_erp_delta_start(const struct mlxsw_sp_acl_erp_delta *delta)
    {
    return delta.start;
    }
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_acl_erp_delta_mask(delta: *const mlxsw_sp_acl_erp_delta) -> u8 {
    ...
    const char *enc_key)
    {
    let mut start: u16 = delta.start;
    let mut mask: u8 = delta.mask;
    u16 tmp;
    if (!mask)
    return 0;
...
// The difference between 2 masks can be up to 8 consecutive bits.
    ...
    si = i;
#[no_mangle]
pub unsafe extern "C" fn if(1: si != i -) -> else {
    else if (si != i - 1)
    return -EINVAL;
    }
    if (si == -1) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_acl_erp_delta_destroy(priv: *mut c_void, delta_priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_acl_erp_root_destroy(priv: *mut c_void, root_priv: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_acl_erp_rehash_hints_put(hints_priv: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_acl_erp_region_fini(aregion: *mut mlxsw_sp_acl_atcam_region) {
    ...
    return -ENOMEM;
    gen_pool_set_algo(erp_core.erp_tables, gen_pool_best_fit, core::ptr::null_mut());
