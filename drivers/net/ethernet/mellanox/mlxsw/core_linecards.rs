...
//! Source: drivers/net/ethernet/mellanox/mlxsw/core_linecards.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_linecard_ini_file {
    pub size: __le16,
    union {
    pub data: [u8; 0],
    struct {
    pub hw_revision: __be16,
    pub ini_version: __be16,
    pub __dontcare: [u8; 3],
    pub type: u8,
    pub name: [u8; 20],
    pub format: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_linecard_types_info {
    pub ini_files: *mut mlxsw_linecard_ini_file,
    pub count: c_uint,
    pub data_size: usize,
    pub data: *mut c_char,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_linecard_device_fw_info {
    pub mlxfw_dev: mlxfw_dev,
    pub mlxsw_core: *mut mlxsw_core,
    pub linecard: *mut mlxsw_linecard,
}
...
// p_max_write_size = min_t(u16, *p_max_write_size,
    ...
    if (err)
    return err;
    mlxsw_reg_mcc_unpack(mcc_pl, fwhandle, core::ptr::null_mut(), &control_state);
    ...
    if (err)
    return err;
    mlxsw_reg_mcc_unpack(mcc_pl, core::ptr::null_mut(), &error_code, &control_state);
...
#[no_mangle]
unsafe extern "C" fn mlxsw_linecard_device_info_update(linecard: *mut mlxsw_linecard) -> c_int {
    static int mlxsw_linecard_device_info_update(struct mlxsw_linecard *linecard)
    {
    struct mlxsw_core *mlxsw_core = linecard.linecards.mlxsw_core;
    let mut flashable_found: bool = false;
    let mut msg_seq: u8 = 0;
    do {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_linecard_provision_fail(linecard: *mut mlxsw_linecard) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_linecards_event_ops_item {
    pub list: list_head,
    pub event_ops: *const mlxsw_linecards_event_ops,
    pub priv: *mut c_void,
}
...
#[no_mangle]
unsafe extern "C" fn mlxsw_linecard_provision_clear(linecard: *mut mlxsw_linecard) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_linecard_ready_set(linecard: *mut mlxsw_linecard) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_linecard_ready_clear(linecard: *mut mlxsw_linecard) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_linecard_active_set(linecard: *mut mlxsw_linecard) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_linecard_active_clear(linecard: *mut mlxsw_linecard) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_linecards_irq_event_handler(mlxsw_core: *mut mlxsw_core) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_linecard_status_event_to_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn __mlxsw_linecard_fix_fsm_state(linecard: *mut mlxsw_linecard) -> c_int {
    ...
    mlxsw_reg_mbct_unpack(linecard.mbct_pl, core::ptr::null_mut(), status, fsm_state);
    return err;
    }
    static int
    ...
    data = ini_file.data;
    while (size_left) {
    let mut data_size: usize = MLXSW_REG_MBCT_DATA_LEN;
    ...
    mlxsw_reg_mbct_unpack(linecard.mbct_pl, core::ptr::null_mut(),
    &status, &fsm_state);
...
pub const MLXSW_LINECARD_INI_WAIT_RETRIES: c_int = 10;
pub const MLXSW_LINECARD_INI_WAIT_MS: c_int = 500;
    static int
    ...
    enum mlxsw_reg_mbct_fsm_state fsm_state;
    enum mlxsw_reg_mbct_status status;
    let mut ini_wait_retries: c_uint = 0;
    int err;
    query_ini_status:
...
#[no_mangle]
unsafe extern "C" fn mlxsw_linecard_port_selector(priv: *mut c_void, local_port: u16) -> bool {
    ...
    let mut linecard: return = = mlxsw_core_port_linecard_get(mlxsw_core, local_port);
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_linecard_status_event {
    pub mlxsw_core: *mut mlxsw_core,
    pub mddq_pl: [c_char; MLXSW_REG_MDDQ_LEN],
    pub work: work_struct,
}

#[no_mangle]
unsafe extern "C" fn mlxsw_linecard_status_event_work(work: *mut work_struct) {
    ...
    mlxsw_linecard_status_process(linecards, core::ptr::null_mut(), event.mddq_pl);
    kfree(event);
    }
    static void
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_linecard_bct_event {
    pub mlxsw_core: *mut mlxsw_core,
    pub mbct_pl: [c_char; MLXSW_REG_MBCT_LEN],
    pub work: work_struct,
}

#[no_mangle]
unsafe extern "C" fn mlxsw_linecard_bct_event_work(work: *mut work_struct) {
...
//
    ...
    struct mlxsw_linecard_types_info *types_info)
    {
    let mut magic_size: usize = strlen(MLXSW_LINECARDS_INI_BUNDLE_MAGIC);
    struct mlxsw_linecard_ini_file *ini_file;
    let mut size: usize = types_info.data_size;
    ...
    {
    let mut magic_size: usize = strlen(MLXSW_LINECARDS_INI_BUNDLE_MAGIC);
    let mut size: usize = types_info.data_size - magic_size;
...
// val = swab32(*val);
    ...
    err_data_alloc:
    kfree(types_info);
    linecards.types_info = core::ptr::null_mut();
    return err;
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_linecard_types_fini(linecards: *mut mlxsw_linecards) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_linecards_fini(mlxsw_core: *mut mlxsw_core) {
