...
//! Source: drivers/net/ethernet/mellanox/mlxsw/spectrum_ethtool.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_ethtool_link_ext_state_opcode_mapping {
...
//
pub const MLXSW_SP_PAUSE_DELAY_BYTES: c_int = 19476;
    static int mlxsw_sp_port_set_pauseparam(struct net_device *dev,
    struct ethtool_pauseparam *pause)
    {
    struct mlxsw_sp_port *mlxsw_sp_port = netdev_priv(dev);
    let mut pause_en: bool = pause.tx_pause || pause.rx_pause;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_port_hw_stats {
    pub __nonstring: char str[ETH_GSTRING_LEN],
    pub payload): *const *const u64 (getter)(char,
    pub cells_bytes: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_port_stats {
    pub str: [c_char; ETH_GSTRING_LEN],
    pub mlxsw_sp_port): *mut *mut u64 (getter)(struct mlxsw_sp_port,
}
    ...
    let mut slot_index: u8 = mlxsw_sp_port.mapping.slot_index;
    let mut module: u8 = mlxsw_sp_port.mapping.module;
    u64 stats;
    int err;
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_port_get_prio_strings(p: *mut u8, prio: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_port_get_tc_strings(p: *mut u8, tc: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_port_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
// p_connector_type = mlxsw_reg_ptys_connector_type_get(ptys_pl);
    ...
    if (err)
    return err;
    ops.reg_ptys_eth_unpack(mlxsw_sp, ptys_pl, &eth_proto_cap, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_reset(dev: *mut net_device, flags: *mut u32) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp1_port_link_mode {
    pub mask_ethtool: enum ethtool_link_mode_bit_indices,
    pub mask: u32,
    pub speed: u32,
}
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp1_ptys_max_speed(mlxsw_sp_port: *mut mlxsw_sp_port, p_max_speed: *mut u32) -> c_int {
    ...
    int err;
    int i;
    err = mlxsw_sp_port_ptys_query(mlxsw_sp_port, &eth_proto_cap, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    if (err)
    return err;
    for (i = 0; i < MLXSW_SP1_PORT_LINK_MODE_LEN; i++) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp1_ptys_proto_cap_masked_get(eth_proto_cap: u32) -> u32 {
    static u32 mlxsw_sp1_ptys_proto_cap_masked_get(u32 eth_proto_cap)
    {
    let mut ptys_proto_cap_masked: u32 = 0;
    int i;
    for (i = 0; i < MLXSW_SP1_PORT_LINK_MODE_LEN; i++) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_port_mask_width_get(width: u8) -> u8 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp2_port_link_mode {
    pub mask_ethtool: *const enum ethtool_link_mode_bit_indices,
    pub m_ethtool_len: c_int,
    pub mask: u32,
    pub speed: u32,
    pub width: u32,
    pub mask_sup_width: u8,
}
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp2_ptys_max_speed(mlxsw_sp_port: *mut mlxsw_sp_port, p_max_speed: *mut u32) -> c_int {
...
// p_max_speed = max_speed;
    ...
    let mut cnt: return = = link_mode.m_ethtool_len;
    }
    static u32
    ...
    const struct ethtool_link_ksettings *cmd)
    {
    let mut mask_width: u8 = mlxsw_sp_port_mask_width_get(width);
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp2_ptys_proto_cap_masked_get(eth_proto_cap: u32) -> u32 {
