...
//! Source: drivers/net/ethernet/mellanox/mlxsw/core_linecard_dev.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_linecard_bdev_add(linecard: *mut mlxsw_linecard) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_linecard_bdev_del(linecard: *mut mlxsw_linecard) {
...
// Unprovisioned line cards do not have an auxiliary device.
    ...
    auxiliary_device_uninit(&linecard_bdev.adev);
    linecard.bdev = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn mlxsw_linecard_bdev_remove(adev: *mut auxiliary_device) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_linecard_driver_register() -> c_int {
    int mlxsw_linecard_driver_register(void)
    {
    return auxiliary_driver_register(&mlxsw_linecard_driver);
    }
#[no_mangle]
pub unsafe extern "C" fn mlxsw_linecard_driver_unregister() {
