...
//! Source: drivers/net/ethernet/mellanox/mlxsw/spectrum_buffers.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_sb_pr {
    pub mode: enum mlxsw_reg_sbpr_mode,
    pub size: u32,
    u8 freeze_mode:1,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_sb_cm {
    pub min_buff: u32,
    pub max_buff: u32,
    pub pool_index: u16,
    pub occ: mlxsw_cp_sb_occ,
    u8 freeze_pool:1,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_sb_pm {
    pub min_buff: u32,
    pub max_buff: u32,
    pub occ: mlxsw_cp_sb_occ,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_sb_pool_des {
    pub dir: enum mlxsw_reg_sbxx_dir,
    pub pool: u8,
}

pub const MLXSW_SP_SB_POOL_ING: c_int = 0;
pub const MLXSW_SP_SB_POOL_EGR: c_int = 4;
pub const MLXSW_SP_SB_POOL_EGR_MC: c_int = 8;
pub const MLXSW_SP_SB_POOL_ING_CPU: c_int = 9;
pub const MLXSW_SP_SB_POOL_EGR_CPU: c_int = 10;
...
pub const MLXSW_SP_SB_ING_TC_COUNT: c_int = 8;
pub const MLXSW_SP_SB_EG_TC_COUNT: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_sb_port {
    pub ing_cms: [mlxsw_sp_sb_cm; MLXSW_SP_SB_ING_TC_COUNT],
    pub eg_cms: [mlxsw_sp_sb_cm; MLXSW_SP_SB_EG_TC_COUNT],
    pub pms: *mut mlxsw_sp_sb_pm,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_sb {
    pub prs: *mut mlxsw_sp_sb_pr,
    pub ports: *mut mlxsw_sp_sb_port,
    pub cell_size: u32,
    pub max_headroom_cells: u32,
    pub sb_size: u64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_sb_vals {
    pub pool_count: c_uint,
    pub pool_dess: *const mlxsw_sp_sb_pool_des,
    pub pms: *const mlxsw_sp_sb_pm,
    pub pms_cpu: *const mlxsw_sp_sb_pm,
    pub prs: *const mlxsw_sp_sb_pr,
    pub mms: *const mlxsw_sp_sb_mm,
    pub cms_ingress: *const mlxsw_sp_sb_cm,
    pub cms_egress: *const mlxsw_sp_sb_cm,
    pub cms_cpu: *const mlxsw_sp_sb_cm,
    pub mms_count: c_uint,
    pub cms_ingress_count: c_uint,
    pub cms_egress_count: c_uint,
    pub cms_cpu_count: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_sb_ops {
    pub speed): *mut *mut u32 (int_buf_size_get)(int mtu, u32,
}

#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_cells_bytes(mlxsw_sp: *const mlxsw_sp, cells: u32) -> u32 {
    u32 mlxsw_sp_cells_bytes(const struct mlxsw_sp *mlxsw_sp, u32 cells)
    {
    return mlxsw_sp.sb.cell_size * cells;
    }
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_bytes_cells(mlxsw_sp: *const mlxsw_sp, bytes: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_sb_cm_exists(pg_buff: u8, dir: enum mlxsw_reg_sbxx_dir) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_hdroom_prios_reset_buf_idx(hdroom: *mut mlxsw_sp_hdroom) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_hdroom_bufs_reset_lossiness(hdroom: *mut mlxsw_sp_hdroom) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_hdroom_buf_threshold_get(mlxsw_sp: *const mlxsw_sp, mtu: c_int) -> u16 {
    static u16 mlxsw_sp_hdroom_buf_threshold_get(const struct mlxsw_sp *mlxsw_sp, int mtu)
    {
    return 2 * mlxsw_sp_bytes_cells(mlxsw_sp, mtu);
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_hdroom_buf_pack(pbmc_pl: *mut c_char, index: c_int, size: u16, thres: u16, lossy: bool) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_hdroom_int_buf_size_get(mlxsw_sp: *mut mlxsw_sp, mtu: c_int, speed: u32) -> u32 {
    static u32 mlxsw_sp_hdroom_int_buf_size_get(struct mlxsw_sp *mlxsw_sp, int mtu, u32 speed)
    {
    let mut buffsize: u32 = mlxsw_sp.sb_ops.int_buf_size_get(mtu, speed);
    return mlxsw_sp_bytes_cells(mlxsw_sp, buffsize) + 1;
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_hdroom_buf_is_used(hdroom: *const mlxsw_sp_hdroom, buf: c_int) -> bool {
    ...
    let mut max_mtu: c_uint = mlxsw_sp_port.dev.max_mtu;
    u16 reserve_cells;
    int i;
...
pub const MLXSW_SP_PB_UNUSED: c_int = 8;
    ...
    const struct mlxsw_sp_hdroom *hdroom)
    {
    let mut taken_headroom_cells: u32 = 0;
    int i;
    for (i = 0; i < MLXSW_SP_PB_COUNT; i++)
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_port_headroom_init(mlxsw_sp_port: *mut mlxsw_sp_port) -> c_int {
    static int mlxsw_sp_port_headroom_init(struct mlxsw_sp_port *mlxsw_sp_port)
    {
    struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port.mlxsw_sp;
    let mut hdroom: mlxsw_sp_hdroom = {};
    u32 size9;
    int prio;
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_sb_port_fini(sb_port: *mut mlxsw_sp_sb_port) {
    static void mlxsw_sp_sb_port_fini(struct mlxsw_sp_sb_port *sb_port)
    {
    kfree(sb_port.pms);
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_sb_ports_init(mlxsw_sp: *mut mlxsw_sp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_sb_ports_fini(mlxsw_sp: *mut mlxsw_sp) {
    static void mlxsw_sp_sb_ports_fini(struct mlxsw_sp *mlxsw_sp)
    {
    let mut max_ports: c_int = mlxsw_core_max_ports(mlxsw_sp.core);
    int i;
...
// Round down, unlike mlxsw_sp_bytes_cells().
    let mut sb_cells: u32 = div_u64(mlxsw_sp.sb.sb_size, mlxsw_sp.sb.cell_size);
...
//
    for (i = 0; i < prs_len; i++) {
    let mut dir: enum mlxsw_reg_sbxx_dir = pool_dess[i].dir;
    let mut size: u32 = prs[i].size;
    u32 size_cells;
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_port_sb_cms_init(mlxsw_sp_port: *mut mlxsw_sp_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_cpu_port_sb_cms_init(mlxsw_sp: *mut mlxsw_sp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_port_sb_pms_init(mlxsw_sp_port: *mut mlxsw_sp_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_cpu_port_sb_pms_init(mlxsw_sp: *mut mlxsw_sp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_sb_mms_init(mlxsw_sp: *mut mlxsw_sp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp1_pb_int_buf_size_get(mtu: c_int, speed: u32) -> u32 {
    static u32 mlxsw_sp1_pb_int_buf_size_get(int mtu, u32 speed)
    {
    return mtu * 5 / 2;
    }
#[no_mangle]
unsafe extern "C" fn __mlxsw_sp_pb_int_buf_size_get(mtu: c_int, speed: u32, buffer_factor: u32) -> u32 {
    static u32 __mlxsw_sp_pb_int_buf_size_get(int mtu, u32 speed, u32 buffer_factor)
    {
    return 3 * mtu + buffer_factor * speed / 1000;
    }
pub const MLXSW_SP2_SPAN_EG_MIRROR_BUFFER_FACTOR: c_int = 38;
#[no_mangle]
unsafe extern "C" fn mlxsw_sp2_pb_int_buf_size_get(mtu: c_int, speed: u32) -> u32 {
    static u32 mlxsw_sp2_pb_int_buf_size_get(int mtu, u32 speed)
    {
    let mut factor: c_int = MLXSW_SP2_SPAN_EG_MIRROR_BUFFER_FACTOR;
    return __mlxsw_sp_pb_int_buf_size_get(mtu, speed, factor);
    }
pub const MLXSW_SP3_SPAN_EG_MIRROR_BUFFER_FACTOR: c_int = 50;
#[no_mangle]
unsafe extern "C" fn mlxsw_sp3_pb_int_buf_size_get(mtu: c_int, speed: u32) -> u32 {
    static u32 mlxsw_sp3_pb_int_buf_size_get(int mtu, u32 speed)
    {
    let mut factor: c_int = MLXSW_SP3_SPAN_EG_MIRROR_BUFFER_FACTOR;
    return __mlxsw_sp_pb_int_buf_size_get(mtu, speed, factor);
    }
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_buffers_init(mlxsw_sp: *mut mlxsw_sp) -> c_int {
    int mlxsw_sp_buffers_init(struct mlxsw_sp *mlxsw_sp)
    {
    u32 max_headroom_size;
    let mut ing_pool_count: u16 = 0;
    let mut eg_pool_count: u16 = 0;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_buffers_fini(mlxsw_sp: *mut mlxsw_sp) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_port_buffers_init(mlxsw_sp_port: *mut mlxsw_sp_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_port_buffers_fini(mlxsw_sp_port: *mut mlxsw_sp_port) {
    ...
    {
    struct mlxsw_sp *mlxsw_sp = mlxsw_core_driver_priv(mlxsw_core);
    let mut pool_size: u32 = mlxsw_sp_bytes_cells(mlxsw_sp, size);
...
// p_threshold = mlxsw_sp_sb_threshold_out(mlxsw_sp, pool_index,
    ...
    struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port.mlxsw_sp;
    let mut local_port: u16 = mlxsw_sp_port.local_port;
    let mut pg_buff: u8 = tc_index;
    let mut dir: enum mlxsw_reg_sbxx_dir = (enum mlxsw_reg_sbxx_dir) pool_type;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_sb_sr_occ_query_cb_ctx {
    pub masked_count: u8,
    pub local_port_1: u16,
}
