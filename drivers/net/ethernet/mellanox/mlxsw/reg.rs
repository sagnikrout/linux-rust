...
//! Source: drivers/net/ethernet/mellanox/mlxsw/reg.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_reg_info {
    pub id: u16,
    pub /: *mut *mut u16 len; / In u8,
...
//
pub const MLXSW_REG_SGCR_ID: c_uint = 0x2000;
pub const MLXSW_REG_SGCR_LEN: c_uint = 0x10;
...
//
pub const MLXSW_REG_SPAD_ID: c_uint = 0x2002;
pub const MLXSW_REG_SPAD_LEN: c_uint = 0x10;
// reg_spad_base_mac
...
//
pub const MLXSW_REG_SSPR_ID: c_uint = 0x2008;
pub const MLXSW_REG_SSPR_LEN: c_uint = 0x8;
// reg_sspr_m
...
// Partition.
//
pub const MLXSW_REG_SFDAT_ID: c_uint = 0x2009;
pub const MLXSW_REG_SFDAT_LEN: c_uint = 0x8;
// reg_sfdat_swid
// Switch partition ID.
// Access: Index
//
...
//
pub const MLXSW_REG_SFD_ID: c_uint = 0x200A;
pub const MLXSW_REG_SFD_BASE_LEN: c_uint = 0x10 /* base length, without records */;
pub const MLXSW_REG_SFD_REC_LEN: c_uint = 0x10 /* record length */;
pub const MLXSW_REG_SFD_REC_MAX_COUNT: c_int = 64;
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_sfd_rec_type {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_sfd_rec_policy {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_sfd_rec_action {
// forward
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_sfd_uc_tunnel_protocol {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_tunnel_port {
...
//
pub const MLXSW_REG_SFN_ID: c_uint = 0x200B;
pub const MLXSW_REG_SFN_BASE_LEN: c_uint = 0x10 /* base length, without records */;
pub const MLXSW_REG_SFN_REC_LEN: c_uint = 0x10 /* record length */;
pub const MLXSW_REG_SFN_REC_MAX_COUNT: c_int = 64;
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_sfn_rec_type {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_sfn_uc_tunnel_protocol {
...
//
pub const MLXSW_REG_SPMS_ID: c_uint = 0x200D;
pub const MLXSW_REG_SPMS_LEN: c_uint = 0x404;
// reg_spms_local_port
// Local port number.
// Access: Index
//
...
//
pub const MLXSW_REG_SPVID_ID: c_uint = 0x200E;
pub const MLXSW_REG_SPVID_LEN: c_uint = 0x08;
// reg_spvid_tport
// Port is tunnel port.
...
//
pub const MLXSW_REG_SPVM_ID: c_uint = 0x200F;
pub const MLXSW_REG_SPVM_BASE_LEN: c_uint = 0x04 /* base length, without records */;
pub const MLXSW_REG_SPVM_REC_LEN: c_uint = 0x04 /* record length */;
pub const MLXSW_REG_SPVM_REC_MAX_COUNT: c_int = 255;
...
//
pub const MLXSW_REG_SPAFT_ID: c_uint = 0x2010;
pub const MLXSW_REG_SPAFT_LEN: c_uint = 0x08;
...
//
pub const MLXSW_REG_SFGC_ID: c_uint = 0x2011;
pub const MLXSW_REG_SFGC_LEN: c_uint = 0x14;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_sfgc_type {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_bridge_type {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_flood_table_type {
...
//
pub const MLXSW_REG_SFDF_ID: c_uint = 0x2013;
pub const MLXSW_REG_SFDF_LEN: c_uint = 0x14;
// reg_sfdf_swid
// Switch partition ID.
// Access: Index
//
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_sfdf_flush_type {
...
// max_lag-1.
//
pub const MLXSW_REG_SLDR_ID: c_uint = 0x2014;
pub const MLXSW_REG_SLDR_LEN: c_uint = 0x0C /* counting in only one port in list */;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_sldr_op {
...
//
pub const MLXSW_REG_SLCR_ID: c_uint = 0x2015;
pub const MLXSW_REG_SLCR_LEN: c_uint = 0x10;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_slcr_pp {
...
//
pub const MLXSW_REG_SLCOR_ID: c_uint = 0x2016;
pub const MLXSW_REG_SLCOR_LEN: c_uint = 0x10;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_slcor_col {
...
//
pub const MLXSW_REG_SPMLR_ID: c_uint = 0x2018;
pub const MLXSW_REG_SPMLR_LEN: c_uint = 0x8;
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_spmlr_learn_mode {
...
// virtualized ports.
//
pub const MLXSW_REG_SVFA_ID: c_uint = 0x201C;
pub const MLXSW_REG_SVFA_LEN: c_uint = 0x18;
// reg_svfa_swid
// Switch partition ID.
// Access: Index
//
...
//
pub const MLXSW_REG_SPVTR_ID: c_uint = 0x201D;
pub const MLXSW_REG_SPVTR_LEN: c_uint = 0x10;
// reg_spvtr_tport
// Port is tunnel port.
// Access: Index
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_spvtr_ipvid_mode {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_spvtr_epvid_mode {
...
//
pub const MLXSW_REG_SVPE_ID: c_uint = 0x201E;
pub const MLXSW_REG_SVPE_LEN: c_uint = 0x4;
// reg_svpe_local_port
// Local port number
// Access: Index
//
...
//
pub const MLXSW_REG_SFMR_ID: c_uint = 0x201F;
pub const MLXSW_REG_SFMR_LEN: c_uint = 0x30;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_sfmr_op {
...
//
pub const MLXSW_REG_SPVMLR_ID: c_uint = 0x2020;
pub const MLXSW_REG_SPVMLR_BASE_LEN: c_uint = 0x04 /* base length, without records */;
pub const MLXSW_REG_SPVMLR_REC_LEN: c_uint = 0x04 /* record length */;
pub const MLXSW_REG_SPVMLR_REC_MAX_COUNT: c_int = 255;
...
//
pub const MLXSW_REG_SPFSR_ID: c_uint = 0x2023;
pub const MLXSW_REG_SPFSR_LEN: c_uint = 0x08;
...
// Ethertype IDs are configured by SVER.
//
pub const MLXSW_REG_SPVC_ID: c_uint = 0x2026;
pub const MLXSW_REG_SPVC_LEN: c_uint = 0x0C;
// reg_spvc_local_port
// Local port.
// Access: Index
//
...
//
pub const MLXSW_REG_SFFP_ID: c_uint = 0x2029;
pub const MLXSW_REG_SFFP_LEN: c_uint = 0x0C;
// reg_sffp_profile_id
...
// is set.
//
pub const MLXSW_REG_SPEVET_ID: c_uint = 0x202A;
pub const MLXSW_REG_SPEVET_LEN: c_uint = 0x08;
...
//
pub const MLXSW_REG_SMPE_ID: c_uint = 0x202B;
pub const MLXSW_REG_SMPE_LEN: c_uint = 0x0C;
// reg_smpe_local_port
// Local port number.
...
//
pub const MLXSW_REG_SMID2_ID: c_uint = 0x2034;
pub const MLXSW_REG_SMID2_LEN: c_uint = 0x120;
// reg_smid2_swid
// Switch partition ID.
// Access: Index
//
...
//
pub const MLXSW_REG_CWTP_ID: c_uint = 0x2802;
pub const MLXSW_REG_CWTP_BASE_LEN: c_uint = 0x28;
pub const MLXSW_REG_CWTP_PROFILE_DATA_REC_LEN: c_uint = 0x08;
pub const MLXSW_REG_CWTP_LEN: c_uint = 0x40;
// reg_cwtp_local_port
// Local port number
// Not supported for CPU port
// Access: Index
...
// Access: RW
//
pub const MLXSW_REG_CWTP_MIN_VALUE: c_int = 64;
pub const MLXSW_REG_CWTP_MAX_PROFILE: c_int = 2;
pub const MLXSW_REG_CWTP_DEFAULT_PROFILE: c_int = 1;
...
//
pub const MLXSW_REG_CWTPM_ID: c_uint = 0x2803;
pub const MLXSW_REG_CWTPM_LEN: c_uint = 0x44;
...
// Access: RW
//
pub const MLXSW_REG_CWTPM_RESET_PROFILE: c_int = 0;
// PGCR - Policy-Engine General Configuration Register
// ---------------------------------------------------
// This register configures general Policy-Engine settings.
//
pub const MLXSW_REG_PGCR_ID: c_uint = 0x3001;
pub const MLXSW_REG_PGCR_LEN: c_uint = 0x20;
...
//
pub const MLXSW_REG_PPBT_ID: c_uint = 0x3002;
pub const MLXSW_REG_PPBT_LEN: c_uint = 0x14;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_pxbt_e {
...
//
pub const MLXSW_REG_PACL_ID: c_uint = 0x3004;
pub const MLXSW_REG_PACL_LEN: c_uint = 0x70;
// reg_pacl_v
...
// Access: Index
//
pub const MLXSW_REG_PXXX_TCAM_REGION_INFO_LEN: c_int = 16;
...
//
pub const MLXSW_REG_PAGT_ID: c_uint = 0x3005;
pub const MLXSW_REG_PAGT_BASE_LEN: c_uint = 0x30;
pub const MLXSW_REG_PAGT_ACL_LEN: c_int = 4;
pub const MLXSW_REG_PAGT_ACL_MAX_NUM: c_int = 16;
...
//
pub const MLXSW_REG_PTAR_ID: c_uint = 0x3006;
pub const MLXSW_REG_PTAR_BASE_LEN: c_uint = 0x20;
pub const MLXSW_REG_PTAR_KEY_ID_LEN: c_int = 1;
pub const MLXSW_REG_PTAR_KEY_ID_MAX_NUM: c_int = 16;

#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ptar_op {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ptar_key_type {
...
//
pub const MLXSW_REG_PPRR_ID: c_uint = 0x3008;
pub const MLXSW_REG_PPRR_LEN: c_uint = 0x14;
// reg_pprr_ipv4
...
//
pub const MLXSW_REG_PPBS_ID: c_uint = 0x300C;
pub const MLXSW_REG_PPBS_LEN: c_uint = 0x14;
// reg_ppbs_pbs_ptr
...
//
pub const MLXSW_REG_PRCR_ID: c_uint = 0x300D;
pub const MLXSW_REG_PRCR_LEN: c_uint = 0x40;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_prcr_op {
...
//
pub const MLXSW_REG_PEFA_ID: c_uint = 0x300F;
pub const MLXSW_REG_PEFA_LEN: c_uint = 0xB0;
// reg_pefa_index
...
// Access: OP
//
pub const MLXSW_REG_FLEX_ACTION_SET_LEN: c_uint = 0xA8;
...
//
pub const MLXSW_REG_PEMRBT_ID: c_uint = 0x3014;
pub const MLXSW_REG_PEMRBT_LEN: c_uint = 0x14;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_pemrbt_protocol {
...
//
pub const MLXSW_REG_PTCE2_ID: c_uint = 0x3017;
pub const MLXSW_REG_PTCE2_LEN: c_uint = 0x1D8;
// reg_ptce2_v
// Valid.
// Access: RW
//
...
// Access: Index
//
pub const MLXSW_REG_PTCEX_FLEX_KEY_BLOCKS_LEN: c_int = 96;
...
//
pub const MLXSW_REG_PERPT_ID: c_uint = 0x3021;
pub const MLXSW_REG_PERPT_LEN: c_uint = 0x80;
// reg_perpt_erpt_bank
// eRP table bank.
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_perpt_key_size {
...
//
pub const MLXSW_REG_PERAR_ID: c_uint = 0x3026;
pub const MLXSW_REG_PERAR_LEN: c_uint = 0x08;
// reg_perar_region_id
// Region identifier
// Range 0 .. cap_max_regions-1
// Access: Index
//
extern "C" {
    pub fn DIV_ROUND_UP(_arg: block_num, _arg: 4) -> return;
}
// reg_perar_hw_region
// HW Region
// Range 0 .. cap_max_regions-1
...
//
pub const MLXSW_REG_PTCE3_ID: c_uint = 0x3027;
pub const MLXSW_REG_PTCE3_LEN: c_uint = 0xF0;
// reg_ptce3_v
// Valid.
// Access: RW
//
...
// allocated.
//
pub const MLXSW_REG_PERCR_ID: c_uint = 0x302A;
pub const MLXSW_REG_PERCR_LEN: c_uint = 0x80;
// reg_percr_region_id
// Region identifier.
// Range 0..cap_max_regions-1
// Access: Index
...
// allocated.
//
pub const MLXSW_REG_PERERP_ID: c_uint = 0x302B;
pub const MLXSW_REG_PERERP_LEN: c_uint = 0x1C;
...
//
pub const MLXSW_REG_PEABFE_ID: c_uint = 0x3022;
pub const MLXSW_REG_PEABFE_BASE_LEN: c_uint = 0x10;
pub const MLXSW_REG_PEABFE_BF_REC_LEN: c_uint = 0x4;
pub const MLXSW_REG_PEABFE_BF_REC_MAX_COUNT: c_int = 256;
...
//
pub const MLXSW_REG_IEDR_ID: c_uint = 0x3804;
pub const MLXSW_REG_IEDR_BASE_LEN: c_uint = 0x10 /* base length, without records */;
pub const MLXSW_REG_IEDR_REC_LEN: c_uint = 0x8 /* record length */;
pub const MLXSW_REG_IEDR_REC_MAX_COUNT: c_int = 64;
...
//
pub const MLXSW_REG_QPTS_ID: c_uint = 0x4002;
pub const MLXSW_REG_QPTS_LEN: c_uint = 0x8;
// reg_qpts_local_port
// Local port number.
// Access: Index
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_qpts_trust_state {
...
//
pub const MLXSW_REG_QPCR_ID: c_uint = 0x4004;
pub const MLXSW_REG_QPCR_LEN: c_uint = 0x28;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_qpcr_g {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_qpcr_ir_units {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_qpcr_rate_type {
...
// Access: RW
//
pub const MLXSW_REG_QPCR_DOUBLE_RATE_ACTION: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_qpcr_action {
// Discard
...
//
// Packets
pub const MLXSW_REG_QPCR_LOWEST_CIR: c_int = 1;

pub const MLXSW_REG_QPCR_LOWEST_CBS: c_int = 4;
pub const MLXSW_REG_QPCR_HIGHEST_CBS: c_int = 24;
// Bandwidth

pub const MLXSW_REG_QPCR_LOWEST_CBS_BITS_SP1: c_int = 4;
pub const MLXSW_REG_QPCR_LOWEST_CBS_BITS_SP2: c_int = 4;
pub const MLXSW_REG_QPCR_HIGHEST_CBS_BITS_SP1: c_int = 25;
pub const MLXSW_REG_QPCR_HIGHEST_CBS_BITS_SP2: c_int = 31;
...
//
pub const MLXSW_REG_QTCT_ID: c_uint = 0x400A;
pub const MLXSW_REG_QTCT_LEN: c_uint = 0x08;
// reg_qtct_local_port
// Local port number.
// Access: Index
//
...
//
pub const MLXSW_REG_QEEC_ID: c_uint = 0x400D;
pub const MLXSW_REG_QEEC_LEN: c_uint = 0x20;
// reg_qeec_local_port
// Local port number.
// Access: Index
//
...
// Access: RW
//
pub const MLXSW_REG_QEEC_HIGHEST_SHAPER_BS: c_int = 25;
pub const MLXSW_REG_QEEC_LOWEST_SHAPER_BS_SP1: c_int = 5;
pub const MLXSW_REG_QEEC_LOWEST_SHAPER_BS_SP2: c_int = 11;
pub const MLXSW_REG_QEEC_LOWEST_SHAPER_BS_SP3: c_int = 11;
pub const MLXSW_REG_QEEC_LOWEST_SHAPER_BS_SP4: c_int = 11;
// QRWE - QoS ReWrite Enable
// -------------------------
// This register configures the rewrite enable per receive port.
//
pub const MLXSW_REG_QRWE_ID: c_uint = 0x400F;
pub const MLXSW_REG_QRWE_LEN: c_uint = 0x08;
// reg_qrwe_local_port
// Local port number.
// Access: Index
//
...
//
pub const MLXSW_REG_QPDSM_ID: c_uint = 0x4011;
pub const MLXSW_REG_QPDSM_BASE_LEN: c_uint = 0x04 /* base length, without records */;
pub const MLXSW_REG_QPDSM_PRIO_ENTRY_REC_LEN: c_uint = 0x4 /* record length */;
pub const MLXSW_REG_QPDSM_PRIO_ENTRY_REC_MAX_COUNT: c_int = 16;
...
// same default values.
//
pub const MLXSW_REG_QPDP_ID: c_uint = 0x4007;
pub const MLXSW_REG_QPDP_LEN: c_uint = 0x8;
// reg_qpdp_local_port
// Local Port. Supported for data packets from CPU port.
// Access: Index
//
...
//
pub const MLXSW_REG_QPDPM_ID: c_uint = 0x4013;
pub const MLXSW_REG_QPDPM_BASE_LEN: c_uint = 0x4 /* base length, without records */;
pub const MLXSW_REG_QPDPM_DSCP_ENTRY_REC_LEN: c_uint = 0x2 /* record length */;
pub const MLXSW_REG_QPDPM_DSCP_ENTRY_REC_MAX_COUNT: c_int = 64;
...
//
pub const MLXSW_REG_QTCTM_ID: c_uint = 0x401A;
pub const MLXSW_REG_QTCTM_LEN: c_uint = 0x08;
...
// Supported only on Spectrum-1.
//
pub const MLXSW_REG_QPSC_ID: c_uint = 0x401B;
pub const MLXSW_REG_QPSC_LEN: c_uint = 0x28;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_qpsc_port_speed {
...
//
pub const MLXSW_REG_PMLP_ID: c_uint = 0x5002;
pub const MLXSW_REG_PMLP_LEN: c_uint = 0x40;
// reg_pmlp_rxtx
...
//
pub const MLXSW_REG_PMTU_ID: c_uint = 0x5003;
pub const MLXSW_REG_PMTU_LEN: c_uint = 0x10;
// reg_pmtu_local_port
// Local port number.
// Access: Index
//
...
//
pub const MLXSW_REG_PTYS_ID: c_uint = 0x5004;
pub const MLXSW_REG_PTYS_LEN: c_uint = 0x40;
// an_disable_admin
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ptys_connector_type {
...
//
pub const MLXSW_REG_PPAD_ID: c_uint = 0x5005;
pub const MLXSW_REG_PPAD_LEN: c_uint = 0x10;
...
//
pub const MLXSW_REG_PAOS_ID: c_uint = 0x5006;
pub const MLXSW_REG_PAOS_LEN: c_uint = 0x10;
// reg_paos_swid
...
//
pub const MLXSW_REG_PFCC_ID: c_uint = 0x5007;
pub const MLXSW_REG_PFCC_LEN: c_uint = 0x20;
// reg_pfcc_local_port
// Local port number.
// Access: Index
//
...
// Access: RW
//
pub const MLXSW_REG_PFCC_ALL_PRIO: c_uint = 0xFF;
// PPCNT - Ports Performance Counters Register
// -------------------------------------------
// The PPCNT register retrieves per port performance counters.
//
pub const MLXSW_REG_PPCNT_ID: c_uint = 0x5008;
pub const MLXSW_REG_PPCNT_LEN: c_uint = 0x100;
pub const MLXSW_REG_PPCNT_COUNTERS_OFFSET: c_uint = 0x08;
// reg_ppcnt_swid
...
//
pub const MLXSW_REG_PPTB_ID: c_uint = 0x500B;
pub const MLXSW_REG_PPTB_LEN: c_uint = 0x10;
// reg_pptb_mm
// Mapping mode.
...
// Access: RW
//
pub const MLXSW_REG_PPTB_ALL_PRIO: c_uint = 0xFF;
...
//
pub const MLXSW_REG_PBMC_ID: c_uint = 0x500C;
pub const MLXSW_REG_PBMC_LEN: c_uint = 0x6C;
// reg_pbmc_local_port
// Local port number.
// Access: Index
//
...
// Access: RW
//
pub const MLXSW_REG_PBMC_PORT_SHARED_BUF_IDX: c_int = 11;
// reg_pbmc_buf_lossy
...
//
pub const MLXSW_REG_PSPA_ID: c_uint = 0x500D;
pub const MLXSW_REG_PSPA_LEN: c_uint = 0x8;
// reg_pspa_swid
// Switch partition ID.
// Access: RW
//
...
//
pub const MLXSW_REG_PMAOS_ID: c_uint = 0x5012;
pub const MLXSW_REG_PMAOS_LEN: c_uint = 0x10;
// reg_pmaos_rst
// Module reset toggle.
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_pmaos_admin_status {
...
//
pub const MLXSW_REG_PPLR_ID: c_uint = 0x5018;
pub const MLXSW_REG_PPLR_LEN: c_uint = 0x8;
// reg_pplr_local_port
// Local port number.
// Access: Index
//
...
//
pub const MLXSW_REG_PMTDB_ID: c_uint = 0x501A;
pub const MLXSW_REG_PMTDB_LEN: c_uint = 0x40;
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_pmtdb_status {
...
//
pub const MLXSW_REG_PMECR_ID: c_uint = 0x501B;
pub const MLXSW_REG_PMECR_LEN: c_uint = 0x20;
...
//
pub const MLXSW_REG_PMPE_ID: c_uint = 0x5024;
pub const MLXSW_REG_PMPE_LEN: c_uint = 0x10;
// reg_pmpe_slot_index
// Slot index.
// Access: Index
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_pmpe_module_status {
...
//
pub const MLXSW_REG_PDDR_ID: c_uint = 0x5031;
pub const MLXSW_REG_PDDR_LEN: c_uint = 0x100;
// reg_pddr_local_port
// Local port number.
// Access: Index
//
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_pddr_page_select {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_pddr_trblsh_group_opcode {
// Monitor opcodes
...
//
pub const MLXSW_REG_PMMP_ID: c_uint = 0x5044;
pub const MLXSW_REG_PMMP_LEN: c_uint = 0x2C;
// reg_pmmp_module
// Module number.
// Access: Index
//
...
//
pub const MLXSW_REG_PLLP_ID: c_uint = 0x504A;
pub const MLXSW_REG_PLLP_LEN: c_uint = 0x10;
// reg_pllp_local_port
// Local port number.
// Access: Index
//
...
// The register can only be set when the module is disabled by PMAOS register
//
pub const MLXSW_REG_PMTM_ID: c_uint = 0x5067;
pub const MLXSW_REG_PMTM_LEN: c_uint = 0x10;
// reg_pmtm_slot_index
// Slot index.
// Access: Index
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_pmtm_module_type {
...
//
pub const MLXSW_REG_HTGT_ID: c_uint = 0x7002;
pub const MLXSW_REG_HTGT_LEN: c_uint = 0x20;
// reg_htgt_swid
// Switch partition ID.
// Access: Index
//
pub const MLXSW_REG_HTGT_PATH_TYPE_LOCAL: c_uint = 0x0	/* For locally attached CPU */;
// reg_htgt_type
// CPU path type.
// Access: RW
//
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_htgt_trap_group {
...
// Access: RW
//
pub const MLXSW_REG_HTGT_INVALID_POLICER: c_uint = 0xff;
// reg_htgt_pid
// Policer ID for the trap group.
// Access: RW
//
pub const MLXSW_REG_HTGT_TRAP_TO_CPU: c_uint = 0x0;
...
// Access: RW
//
pub const MLXSW_REG_HTGT_DEFAULT_PRIORITY: c_int = 0;
// reg_htgt_priority
// Trap group priority.
...
//
pub const MLXSW_REG_HTGT_DEFAULT_TC: c_int = 7;
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_htgt_local_path_rdq {
...
//
pub const MLXSW_REG_HPKT_ID: c_uint = 0x7003;
pub const MLXSW_REG_HPKT_LEN: c_uint = 0x10;
// reg_hpkt_ack
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_hpkt_action {
...
//
pub const MLXSW_REG_RGCR_ID: c_uint = 0x8001;
pub const MLXSW_REG_RGCR_LEN: c_uint = 0x28;
// reg_rgcr_ipv4_en
// IPv4 router enable.
// Access: RW
//
...
//
pub const MLXSW_REG_RITR_ID: c_uint = 0x8002;
pub const MLXSW_REG_RITR_LEN: c_uint = 0x40;
// reg_ritr_enable
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ritr_if_type {
// VLAN interface.
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ritr_loopback_protocol {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ritr_loopback_ipip_type {
// Tunnel is IPinIP.
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ritr_loopback_ipip_options {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ritr_counter_set_type {
// No Count.
...
//
pub const MLXSW_REG_RTAR_ID: c_uint = 0x8004;
pub const MLXSW_REG_RTAR_LEN: c_uint = 0x20;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_rtar_op {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_rtar_key_type {
...
// Table.
//
pub const MLXSW_REG_RATR_ID: c_uint = 0x8008;
pub const MLXSW_REG_RATR_LEN: c_uint = 0x2C;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ratr_op {
// Read
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ratr_trap_action {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ratr_trap_id {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ratr_ipip_type {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_flow_counter_set_type {
// No count
...
//
pub const MLXSW_REG_RDPM_ID: c_uint = 0x8009;
pub const MLXSW_REG_RDPM_BASE_LEN: c_uint = 0x00;
pub const MLXSW_REG_RDPM_DSCP_ENTRY_REC_LEN: c_uint = 0x01;
pub const MLXSW_REG_RDPM_DSCP_ENTRY_REC_MAX_COUNT: c_int = 64;
pub const MLXSW_REG_RDPM_LEN: c_uint = 0x40;
...
//
pub const MLXSW_REG_RICNT_ID: c_uint = 0x800B;
pub const MLXSW_REG_RICNT_LEN: c_uint = 0x100;
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ricnt_counter_set_type {
// No Count.
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ricnt_opcode {
...
//
pub const MLXSW_REG_RRCR_ID: c_uint = 0x800F;
pub const MLXSW_REG_RRCR_LEN: c_uint = 0x24;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_rrcr_op {
// Move rules
...
//
pub const MLXSW_REG_RALTA_ID: c_uint = 0x8010;
pub const MLXSW_REG_RALTA_LEN: c_uint = 0x04;
// reg_ralta_op
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ralxx_protocol {
...
//
pub const MLXSW_REG_RALST_ID: c_uint = 0x8011;
pub const MLXSW_REG_RALST_LEN: c_uint = 0x104;
// reg_ralst_root_bin
...
// Access: Index
//
pub const MLXSW_REG_RALST_BIN_NO_CHILD: c_uint = 0xff;
pub const MLXSW_REG_RALST_BIN_OFFSET: c_uint = 0x04;
pub const MLXSW_REG_RALST_BIN_COUNT: c_int = 128;
...
//
pub const MLXSW_REG_RALTB_ID: c_uint = 0x8012;
pub const MLXSW_REG_RALTB_LEN: c_uint = 0x04;
...
//
pub const MLXSW_REG_RALUE_ID: c_uint = 0x8013;
pub const MLXSW_REG_RALUE_LEN: c_uint = 0x38;
// reg_ralue_protocol
// Protocol.
// Access: Index
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ralue_entry_type {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ralue_action_type {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_ralue_trap_action {
...
//
pub const MLXSW_REG_RAUHT_ID: c_uint = 0x8014;
pub const MLXSW_REG_RAUHT_LEN: c_uint = 0x74;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_rauht_type {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_rauht_trap_action {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_rauht_trap_id {
...
//
pub const MLXSW_REG_RALEU_ID: c_uint = 0x8015;
pub const MLXSW_REG_RALEU_LEN: c_uint = 0x28;
// reg_raleu_protocol
// Protocol.
// Access: Index
//
...
//
pub const MLXSW_REG_RAUHTD_ID: c_uint = 0x8018;
pub const MLXSW_REG_RAUHTD_BASE_LEN: c_uint = 0x20;
pub const MLXSW_REG_RAUHTD_REC_LEN: c_uint = 0x20;
pub const MLXSW_REG_RAUHTD_REC_MAX_NUM: c_int = 32;

pub const MLXSW_REG_RAUHTD_IPV4_ENT_PER_REC: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_rauhtd_type {
...
// Access: RO
//
pub const MLXSW_REG_RAUHTD_IPV4_ENT_LEN: c_uint = 0x8;
...
// Access: RO
//
pub const MLXSW_REG_RAUHTD_IPV6_ENT_LEN: c_uint = 0x20;
...
// and IPinIP.
//
pub const MLXSW_REG_RTDP_ID: c_uint = 0x8020;
pub const MLXSW_REG_RTDP_LEN: c_uint = 0x44;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_rtdp_type {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_rtdp_ipip_sip_check {
// No sip checks.
...
// IPinIP
//
pub const MLXSW_REG_RIPS_ID: c_uint = 0x8021;
pub const MLXSW_REG_RIPS_LEN: c_uint = 0x14;
// reg_rips_index
...
//
pub const MLXSW_REG_RATRAD_ID: c_uint = 0x8022;
pub const MLXSW_REG_RATRAD_LEN: c_uint = 0x210;
// Read activity
// Read and clear activity
// reg_ratrad_op
// Access: Operation
...
//
pub const MLXSW_REG_RIGR2_ID: c_uint = 0x8023;
pub const MLXSW_REG_RIGR2_LEN: c_uint = 0xB0;
pub const MLXSW_REG_RIGR2_MAX_ERIFS: c_int = 32;
...
// ------------------------------------------------------
//
pub const MLXSW_REG_RECR2_ID: c_uint = 0x8025;
pub const MLXSW_REG_RECR2_LEN: c_uint = 0x38;
// reg_recr2_pp
// Per-port configuration
// Access: Index
//
...
//
pub const MLXSW_REG_RMFT2_ID: c_uint = 0x8027;
pub const MLXSW_REG_RMFT2_LEN: c_uint = 0x174;
// reg_rmft2_v
// Valid
// Access: RW
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_sp_reg_rmft2_op {
// For Write:
// Write operation. Used to write a new entry to the table. All RW
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_rmft2_irif_mask {
...
// Note: Reserved when legacy bridge model is used.
//
pub const MLXSW_REG_REIV_ID: c_uint = 0x8034;
pub const MLXSW_REG_REIV_BASE_LEN: c_uint = 0x20 /* base length, without records */;
pub const MLXSW_REG_REIV_REC_LEN: c_uint = 0x04 /* record length */;
...
//
pub const MLXSW_REG_MFCR_ID: c_uint = 0x9001;
pub const MLXSW_REG_MFCR_LEN: c_uint = 0x08;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mfcr_pwm_frequency {
...
// This register controls the settings of the Fan Speed PWM mechanism.
//
pub const MLXSW_REG_MFSC_ID: c_uint = 0x9002;
pub const MLXSW_REG_MFSC_LEN: c_uint = 0x08;
// reg_mfsc_pwm
...
//
pub const MLXSW_REG_MFSM_ID: c_uint = 0x9003;
pub const MLXSW_REG_MFSM_LEN: c_uint = 0x08;
// reg_mfsm_tacho
...
//
pub const MLXSW_REG_MFSL_ID: c_uint = 0x9004;
pub const MLXSW_REG_MFSL_LEN: c_uint = 0x0C;
// reg_mfsl_tacho
// Fan tachometer index.
// Access: Index
//
...
//
pub const MLXSW_REG_FORE_ID: c_uint = 0x9007;
pub const MLXSW_REG_FORE_LEN: c_uint = 0x0C;
// fan_under_limit
...
//
pub const MLXSW_REG_MTCAP_ID: c_uint = 0x9009;
pub const MLXSW_REG_MTCAP_LEN: c_uint = 0x08;
...
//
pub const MLXSW_REG_MTMP_ID: c_uint = 0x900A;
pub const MLXSW_REG_MTMP_LEN: c_uint = 0x20;
// reg_mtmp_slot_index
// Slot index (0: Main board).
// Access: Index
//
pub const MLXSW_REG_MTMP_MODULE_INDEX_MIN: c_int = 64;
pub const MLXSW_REG_MTMP_GBOX_INDEX_MIN: c_int = 256;
...
//
pub const MLXSW_REG_MTWE_ID: c_uint = 0x900B;
pub const MLXSW_REG_MTWE_LEN: c_uint = 0x10;
...
//
pub const MLXSW_REG_MTBR_ID: c_uint = 0x900F;
pub const MLXSW_REG_MTBR_BASE_LEN: c_uint = 0x10 /* base length, without records */;
pub const MLXSW_REG_MTBR_REC_LEN: c_uint = 0x04 /* record length */;
pub const MLXSW_REG_MTBR_REC_MAX_COUNT: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mtbr_temp_status {
...
pub const MLXSW_REG_MTBR_BASE_MODULE_INDEX: c_int = 64;
...
//
pub const MLXSW_REG_MCIA_ID: c_uint = 0x9014;
pub const MLXSW_REG_MCIA_LEN: c_uint = 0x94;
// reg_mcia_module
// Module number.
// Access: Index
//
...
// Access: RW
//
pub const MLXSW_REG_MCIA_EEPROM_PAGE_LENGTH: c_int = 256;
pub const MLXSW_REG_MCIA_EEPROM_UP_PAGE_LENGTH: c_int = 128;
pub const MLXSW_REG_MCIA_I2C_ADDR_LOW: c_uint = 0x50;
pub const MLXSW_REG_MCIA_I2C_ADDR_HIGH: c_uint = 0x51;
pub const MLXSW_REG_MCIA_PAGE0_LO_OFF: c_uint = 0xa0;
pub const MLXSW_REG_MCIA_TH_ITEM_SIZE: c_int = 2;
pub const MLXSW_REG_MCIA_TH_PAGE_NUM: c_int = 3;
pub const MLXSW_REG_MCIA_TH_PAGE_CMIS_NUM: c_int = 2;
pub const MLXSW_REG_MCIA_PAGE0_LO: c_int = 0;
pub const MLXSW_REG_MCIA_TH_PAGE_OFF: c_uint = 0x80;

#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mcia_eeprom_module_info_rev_id {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mcia_eeprom_module_info_id {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mcia_eeprom_module_info {
...
//
pub const MLXSW_REG_MPAT_ID: c_uint = 0x901A;
pub const MLXSW_REG_MPAT_LEN: c_uint = 0x78;
// reg_mpat_pa_id
// Port Analyzer ID.
// Access: Index
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mpat_span_type {
// Local SPAN Ethernet.
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mpat_eth_rspan_version {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mpat_eth_rspan_protocol {
...
// properties.
//
pub const MLXSW_REG_MPAR_ID: c_uint = 0x901B;
pub const MLXSW_REG_MPAR_LEN: c_uint = 0x0C;
// reg_mpar_local_port
...
// information.
//
pub const MLXSW_REG_MGIR_ID: c_uint = 0x9020;
pub const MLXSW_REG_MGIR_LEN: c_uint = 0x9C;
...
// Access: RO
//
pub const MLXSW_REG_MGIR_FW_INFO_PSID_SIZE: c_int = 16;
...
//
pub const MLXSW_REG_MRSR_ID: c_uint = 0x9023;
pub const MLXSW_REG_MRSR_LEN: c_uint = 0x08;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mrsr_command {
...
//
pub const MLXSW_REG_MLCR_ID: c_uint = 0x902B;
pub const MLXSW_REG_MLCR_LEN: c_uint = 0x0C;
// reg_mlcr_local_port
// Local port number.
// Access: RW
//
pub const MLXSW_REG_MLCR_DURATION_MAX: c_uint = 0xFFFF;
...
// notifications.
//
pub const MLXSW_REG_MCION_ID: c_uint = 0x9052;
pub const MLXSW_REG_MCION_LEN: c_uint = 0x18;
// reg_mcion_module
// Module number.
// Access: Index
//
...
//
pub const MLXSW_REG_MTPPS_ID: c_uint = 0x9053;
pub const MLXSW_REG_MTPPS_LEN: c_uint = 0x3C;
// reg_mtpps_enable
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mtpps_pin_mode {
...
// Access: RW
//
pub const MLXSW_REG_MTPPS_PIN_SP_VIRTUAL_PIN: c_int = 7;
// reg_mtpps_pin
...
//
pub const MLXSW_REG_MTUTC_ID: c_uint = 0x9055;
pub const MLXSW_REG_MTUTC_LEN: c_uint = 0x1C;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mtutc_operation {
...
//
pub const MLXSW_REG_MCQI_ID: c_uint = 0x9061;
pub const MLXSW_REG_MCQI_BASE_LEN: c_uint = 0x18;
pub const MLXSW_REG_MCQI_CAP_LEN: c_uint = 0x14;
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxfw_reg_mcqi_info_type {
...
//
pub const MLXSW_REG_MCC_ID: c_uint = 0x9062;
pub const MLXSW_REG_MCC_LEN: c_uint = 0x1C;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mcc_instruction {
...
//
pub const MLXSW_REG_MCDA_ID: c_uint = 0x9063;
pub const MLXSW_REG_MCDA_BASE_LEN: c_uint = 0x10;
pub const MLXSW_REG_MCDA_MAX_DATA_LEN: c_uint = 0x80;
...
//
pub const MLXSW_REG_MCAM_ID: c_uint = 0x907F;
pub const MLXSW_REG_MCAM_LEN: c_uint = 0x48;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mcam_feature_group {
// Enhanced features.
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mcam_mng_feature_cap_mask_bits {
...
pub const MLXSW_REG_BYTES_PER_DWORD: c_uint = 0x4;
...
//
pub const MLXSW_REG_MPSC_ID: c_uint = 0x9080;
pub const MLXSW_REG_MPSC_LEN: c_uint = 0x1C;
// reg_mpsc_local_port
// Local port number
// Not supported for CPU port
// Access: Index
...
//
pub const MLXSW_REG_MGPC_ID: c_uint = 0x9081;
pub const MLXSW_REG_MGPC_LEN: c_uint = 0x18;
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mgpc_opcode {
// Nop
...
//
pub const MLXSW_REG_MPRS_ID: c_uint = 0x9083;
pub const MLXSW_REG_MPRS_LEN: c_uint = 0x14;
...
// ------------------------------------------------
//
pub const MLXSW_REG_MOGCR_ID: c_uint = 0x9086;
pub const MLXSW_REG_MOGCR_LEN: c_uint = 0x20;
// reg_mogcr_ptp_iftc
...
//
pub const MLXSW_REG_MPAGR_ID: c_uint = 0x9089;
pub const MLXSW_REG_MPAGR_LEN: c_uint = 0x0C;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mpagr_trigger {
...
// reasons.
//
pub const MLXSW_REG_MOMTE_ID: c_uint = 0x908D;
pub const MLXSW_REG_MOMTE_LEN: c_uint = 0x10;
...
//
pub const MLXSW_REG_MTPPPC_ID: c_uint = 0x9090;
pub const MLXSW_REG_MTPPPC_LEN: c_uint = 0x28;
...
// Reserved when Spectrum-2.
//
pub const MLXSW_REG_MTPPTR_ID: c_uint = 0x9091;
pub const MLXSW_REG_MTPPTR_BASE_LEN: c_uint = 0x10 /* base length, without records */;
pub const MLXSW_REG_MTPPTR_REC_LEN: c_uint = 0x10 /* record length */;
pub const MLXSW_REG_MTPPTR_REC_MAX_COUNT: c_int = 4;
...
//
pub const MLXSW_REG_MTPTPT_ID: c_uint = 0x9092;
pub const MLXSW_REG_MTPTPT_LEN: c_uint = 0x08;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mtptpt_trap_id {
...
// -------------------------------------------------------------------------
//
pub const MLXSW_REG_MTPCPC_ID: c_uint = 0x9093;
pub const MLXSW_REG_MTPCPC_LEN: c_uint = 0x2C;
// reg_mtpcpc_pport
// Per port:
...
// -------------------------------------------
//
pub const MLXSW_REG_MFGD_ID: c_uint = 0x90F0;
pub const MLXSW_REG_MFGD_LEN: c_uint = 0x0C;
...
//
pub const MLXSW_REG_MGPIR_ID: c_uint = 0x9100;
pub const MLXSW_REG_MGPIR_LEN: c_uint = 0xA0;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mgpir_device_type {
...
//
pub const MLXSW_REG_MBCT_ID: c_uint = 0x9120;
pub const MLXSW_REG_MBCT_LEN: c_uint = 0x420;
// reg_mbct_slot_index
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mbct_status {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mbct_fsm_state {
...
// Access: RO
//
pub const MLXSW_REG_MBCT_DATA_LEN: c_int = 1024;
// reg_mbct_data
// Up to 1KB of data.
// Access: WO
//
...
//
pub const MLXSW_REG_MDDT_ID: c_uint = 0x9160;
pub const MLXSW_REG_MDDT_LEN: c_uint = 0x110;
// reg_mddt_slot_index
// Slot index.
// Access: Index
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mddt_status {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mddt_method {
...
// Access: Index
//
pub const MLXSW_REG_MDDT_PAYLOAD_OFFSET: c_uint = 0x0C;
pub const MLXSW_REG_MDDT_PRM_REGISTER_HEADER_LEN: c_int = 4;
...
// of data blocks.
//
pub const MLXSW_REG_MDDQ_ID: c_uint = 0x9161;
pub const MLXSW_REG_MDDQ_LEN: c_uint = 0x30;
// reg_mddq_sie
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mddq_query_type {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mddq_slot_info_ready {
...
pub const MLXSW_REG_MDDQ_SLOT_ASCII_NAME_LEN: c_int = 20;
...
//
pub const MLXSW_REG_MDDC_ID: c_uint = 0x9163;
pub const MLXSW_REG_MDDC_LEN: c_uint = 0x30;
// reg_mddc_slot_index
// Slot index. 0 is reserved.
// Access: Index
//
...
// -----------------------------------
//
pub const MLXSW_REG_MFDE_ID: c_uint = 0x9200;
pub const MLXSW_REG_MFDE_LEN: c_uint = 0x30;
// reg_mfde_irisc_id
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mfde_severity {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mfde_event_id {
// CRspace timeout
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mfde_method {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_mfde_command_type {
...
//
pub const MLXSW_REG_TNGCR_ID: c_uint = 0xA001;
pub const MLXSW_REG_TNGCR_LEN: c_uint = 0x44;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_tngcr_type {
...
//
pub const MLXSW_REG_TNUMT_ID: c_uint = 0xA003;
pub const MLXSW_REG_TNUMT_LEN: c_uint = 0x20;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mlxsw_reg_tnumt_record_type {
...
// underlay network.
//
pub const MLXSW_REG_TNQCR_ID: c_uint = 0xA010;
pub const MLXSW_REG_TNQCR_LEN: c_uint = 0x0C;
...
// encapsulation.
//
pub const MLXSW_REG_TNQDR_ID: c_uint = 0xA011;
pub const MLXSW_REG_TNQDR_LEN: c_uint = 0x08;
...
//
pub const MLXSW_REG_TNEEM_ID: c_uint = 0xA012;
pub const MLXSW_REG_TNEEM_LEN: c_uint = 0x0C;
...
// decapsulation.
//
pub const MLXSW_REG_TNDEM_ID: c_uint = 0xA013;
pub const MLXSW_REG_TNDEM_LEN: c_uint = 0x0C;
...
// Reserved when Spectrum.
//
pub const MLXSW_REG_TNPC_ID: c_uint = 0xA020;
pub const MLXSW_REG_TNPC_LEN: c_uint = 0x18;
...
//
pub const MLXSW_REG_TIGCR_ID: c_uint = 0xA801;
pub const MLXSW_REG_TIGCR_LEN: c_uint = 0x10;
// reg_tigcr_ipip_ttlc
...
// encapsulation to the ECN of the underlay network.
//
pub const MLXSW_REG_TIEEM_ID: c_uint = 0xA812;
pub const MLXSW_REG_TIEEM_LEN: c_uint = 0x0C;
...
// decapsulation.
//
pub const MLXSW_REG_TIDEM_ID: c_uint = 0xA813;
pub const MLXSW_REG_TIDEM_LEN: c_uint = 0x0C;
...
//
pub const MLXSW_REG_SBPR_ID: c_uint = 0xB001;
pub const MLXSW_REG_SBPR_LEN: c_uint = 0x14;
// reg_sbpr_desc
...
//
pub const MLXSW_REG_SBCM_ID: c_uint = 0xB002;
pub const MLXSW_REG_SBCM_LEN: c_uint = 0x28;
// reg_sbcm_local_port
// Local port number.
...
pub const MLXSW_REG_SBXX_DYN_MAX_BUFF_MIN: c_int = 1;
pub const MLXSW_REG_SBXX_DYN_MAX_BUFF_MAX: c_int = 14;
// reg_sbcm_infi_max
...
//
pub const MLXSW_REG_SBPM_ID: c_uint = 0xB003;
pub const MLXSW_REG_SBPM_LEN: c_uint = 0x28;
// reg_sbpm_local_port
// Local port number.
// For Ingress: excludes CPU port and Router port
// For Egress: excludes IP Router
...
//
pub const MLXSW_REG_SBMM_ID: c_uint = 0xB004;
pub const MLXSW_REG_SBMM_LEN: c_uint = 0x28;
// reg_sbmm_prio
// Switch Priority.
// Access: Index
//
...
//
pub const MLXSW_REG_SBSR_ID: c_uint = 0xB005;
pub const MLXSW_REG_SBSR_BASE_LEN: c_uint = 0x5C /* base length, without records */;
pub const MLXSW_REG_SBSR_REC_LEN: c_uint = 0x8 /* record length */;
pub const MLXSW_REG_SBSR_REC_MAX_COUNT: c_int = 120;
...
// Access: OP
//
pub const MLXSW_REG_SBSR_NUM_PORTS_IN_PAGE: c_int = 256;
// reg_sbsr_port_page
...
//
pub const MLXSW_REG_SBIB_ID: c_uint = 0xB006;
pub const MLXSW_REG_SBIB_LEN: c_uint = 0x10;
// reg_sbib_local_port
// Local port number
...
//
pub const MLXSW_REG_PUDE_LEN: c_uint = 0x10;
// reg_pude_swid
// Switch partition ID with which to associate the port.
// Access: Index
//
