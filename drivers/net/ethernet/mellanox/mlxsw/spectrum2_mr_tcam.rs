...
//! Source: drivers/net/ethernet/mellanox/mlxsw/spectrum2_mr_tcam.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp2_mr_tcam {
    pub mlxsw_sp: *mut mlxsw_sp,
    pub flow_block: *mut mlxsw_sp_flow_block,
    pub ruleset4: *mut mlxsw_sp_acl_ruleset,
    pub ruleset6: *mut mlxsw_sp_acl_ruleset,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp2_mr_route {
    pub mr_tcam: *mut mlxsw_sp2_mr_tcam,
}
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp2_mr_tcam_ipv4_init(mr_tcam: *mut mlxsw_sp2_mr_tcam) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp2_mr_tcam_ipv4_fini(mr_tcam: *mut mlxsw_sp2_mr_tcam) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp2_mr_tcam_ipv6_init(mr_tcam: *mut mlxsw_sp2_mr_tcam) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp2_mr_tcam_ipv6_fini(mr_tcam: *mut mlxsw_sp2_mr_tcam) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp2_mr_tcam_init(mlxsw_sp: *mut mlxsw_sp, priv: *mut c_void) -> c_int {
    static int mlxsw_sp2_mr_tcam_init(struct mlxsw_sp *mlxsw_sp, void *priv)
    {
    struct mlxsw_sp2_mr_tcam *mr_tcam = priv;
    int err;
    mr_tcam.mlxsw_sp = mlxsw_sp;
    mr_tcam.flow_block = mlxsw_sp_flow_block_create(mlxsw_sp, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp2_mr_tcam_fini(priv: *mut c_void) {
