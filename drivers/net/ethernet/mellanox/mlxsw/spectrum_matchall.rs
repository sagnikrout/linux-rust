...
//! Source: drivers/net/ethernet/mellanox/mlxsw/spectrum_matchall.c
#![no_std]
...
// Copyright (c) 2017-2020 Mellanox Technologies. All rights reserved
    ...
    let mut agent_parms: mlxsw_sp_span_agent_parms = {};
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_mall_prio_update(block: *mut mlxsw_sp_flow_block) {
    ...
    struct mlxsw_sp_mall_entry *mall_entry;
    let mut protocol: __be16 = f.common.protocol;
...
// p_max_prio = block->mall.max_prio;
    ...
    struct netlink_ext_ack *extack)
    {
    let mut rate: u32 = mall_entry.sample.params.rate;
    if (!mall_entry.ingress) {
    ...
    .to_dev = core::ptr::null_mut(),	/* Mirror to CPU. */
