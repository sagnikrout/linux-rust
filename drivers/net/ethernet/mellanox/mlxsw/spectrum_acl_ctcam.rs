...
//! Source: drivers/net/ethernet/mellanox/mlxsw/spectrum_acl_ctcam.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_acl_ctcam_region_fini(cregion: *mut mlxsw_sp_acl_ctcam_region) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_acl_ctcam_chunk_fini(cchunk: *mut mlxsw_sp_acl_ctcam_chunk) {
