...
//! Source: drivers/net/ethernet/mellanox/mlxsw/spectrum_policer.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_policer_family {
    pub type: enum mlxsw_sp_policer_type,
    pub qpcr_type: enum mlxsw_reg_qpcr_g,
    pub mlxsw_sp: *mut mlxsw_sp,
    pub /: *mut *mut u16 start_index; / Inclusive,
    pub /: *mut *mut u16 end_index; / Exclusive,
    pub policer_idr: idr,
    pub /: *mut *mut mutex lock; / Protects policer_idr,
    pub policers_count: core::sync::atomic::AtomicI32,
    pub ops: *const mlxsw_sp_policer_family_ops,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_policer {
    pub params: mlxsw_sp_policer_params,
    pub index: u16,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_policer_family_ops {
    pub family): *mut *mut int (init)(struct mlxsw_sp_policer_family,
    pub family): *mut *mut void (fini)(struct mlxsw_sp_policer_family,
    int (*policer_index_alloc)(struct mlxsw_sp_policer_family *family,
    pub policer): *mut mlxsw_sp_policer,
    ...
    pub policer): *const mlxsw_sp_policer,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_policer_core {
    pub 1]: *mut *mut mlxsw_sp_policer_family family_arr[MLXSW_SP_POLICER_TYPE_MAX +,
    pub ops: *const mlxsw_sp_policer_core_ops,
    pub lowest_bs_bits: u8,
    pub highest_bs_bits: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_policer_core_ops {
    pub policer_core): *mut *mut int (init)(struct mlxsw_sp_policer_core,
}

#[no_mangle]
unsafe extern "C" fn mlxsw_sp_policer_rate_bytes_ps_kbps(rate_bytes_ps: u64) -> u64 {
    static u64 mlxsw_sp_policer_rate_bytes_ps_kbps(u64 rate_bytes_ps)
    {
    return div_u64(rate_bytes_ps, 1000) * BITS_PER_BYTE;
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_policer_burst_bytes_hw_units(burst_bytes: u64) -> u8 {
...
//
    let mut bs512: u64 = div_u64(burst_bytes, 64);
    if (!bs512)
    return 0;
    return fls64(bs512) - 1;
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_policer_single_rate_occ_get(priv: *mut c_void) -> u64 {
...
//
    ...
    {
    let mut rate_kbps: u64 = mlxsw_sp_policer_rate_bytes_ps_kbps(policer.params.rate);
    let mut bs: u8 = mlxsw_sp_policer_burst_bytes_hw_units(policer.params.burst);
    ...
    let mut rate_bps: u64 = params.rate * BITS_PER_BYTE;
    u8 bs;
    if (!params.bytes) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_policers_init(mlxsw_sp: *mut mlxsw_sp) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_policers_fini(mlxsw_sp: *mut mlxsw_sp) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_policer_resources_register(mlxsw_core: *mut mlxsw_core) -> c_int {
