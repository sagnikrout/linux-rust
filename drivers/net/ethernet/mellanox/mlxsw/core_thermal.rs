...
//! Source: drivers/net/ethernet/mellanox/mlxsw/core_thermal.c
#![no_std]
...
pub const MLXSW_THERMAL_MAX_STATE: c_int = 10;
pub const MLXSW_THERMAL_MIN_STATE: c_int = 2;
pub const MLXSW_THERMAL_MAX_DUTY: c_int = 255;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_cooling_states {
    pub min_state: c_int,
    pub max_state: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_thermal_cooling_device {
    pub thermal: *mut mlxsw_thermal,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_thermal_module {
    pub parent: *mut mlxsw_thermal,
    pub tzdev: *mut thermal_zone_device,
    pub trips: [thermal_trip; MLXSW_THERMAL_NUM_TRIPS],
    pub cooling_states: [mlxsw_cooling_states; MLXSW_THERMAL_NUM_TRIPS],
    pub /: *mut *mut int module; / Module or gearbox number,
    pub slot_index: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_thermal_area {
    pub tz_module_arr: *mut mlxsw_thermal_module,
    pub tz_module_num: u8,
    pub tz_gearbox_arr: *mut mlxsw_thermal_module,
    pub tz_gearbox_num: u8,
    pub slot_index: u8,
    pub active: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_thermal {
    pub core: *mut mlxsw_core,
    pub bus_info: *const mlxsw_bus_info,
    pub tzdev: *mut thermal_zone_device,
    pub polling_delay: c_int,
    pub cdevs: [mlxsw_thermal_cooling_device; MLXSW_MFCR_PWMS_MAX],
    pub trips: [thermal_trip; MLXSW_THERMAL_NUM_TRIPS],
    pub cooling_states: [mlxsw_cooling_states; MLXSW_THERMAL_NUM_TRIPS],
    pub line_cards: [mlxsw_thermal_area; ],
}

#[no_mangle]
pub unsafe extern "C" fn mlxsw_state_to_duty(state: c_int) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_duty_to_state(duty: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_thermal_module_tz_fini(tzdev: *mut thermal_zone_device) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_thermal_module_fini(module_tz: *mut mlxsw_thermal_module) {
    ...
    &area.tz_module_num, core::ptr::null_mut());
// For modular system module counter could be zero.
    ...
    if (err)
    return err;
    mlxsw_reg_mgpir_unpack(mgpir_pl, &gbox_num, &device_type, core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_thermal_fini(thermal: *mut mlxsw_thermal) {
