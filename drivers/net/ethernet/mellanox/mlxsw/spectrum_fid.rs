...
//! Source: drivers/net/ethernet/mellanox/mlxsw/spectrum_fid.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_fid_core {
    pub fid_ht: rhashtable,
    pub vni_ht: rhashtable,
    pub fid_family_arr: [*mut mlxsw_sp_fid_family; MLXSW_SP_FID_TYPE_MAX],
    pub port_fid_mappings: *mut c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_fid_port_vid {
    pub list: list_head,
    pub local_port: u16,
    pub vid: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_fid {
    pub list: list_head,
    pub rif: *mut mlxsw_sp_rif,
    pub ref_count: refcount_t,
    pub fid_index: u16,
    pub fid_offset: u16,
    pub fid_family: *mut mlxsw_sp_fid_family,
    pub ht_node: rhash_head,
    pub vni_ht_node: rhash_head,
    pub nve_type: enum mlxsw_sp_nve_type,
    pub vni: __be32,
    pub nve_flood_index: u32,
    pub nve_ifindex: c_int,
    u8 vni_valid:1,
    pub /: *mut *mut list_head port_vid_list; / Ordered by local port.,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_fid_8021q {
    pub common: mlxsw_sp_fid,
    pub vid: u16,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_fid_8021d {
    pub common: mlxsw_sp_fid,
    pub br_ifindex: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_flood_table {
    pub packet_type: enum mlxsw_sp_flood_type,
    pub /: *mut *mut enum mlxsw_flood_table_type table_type; / For flood_mode!=CFF.,
    pub table_index: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_fid_ops {
    pub arg): *const *const *const int (setup)(struct mlxsw_sp_fid fid, void,
    pub fid): *mut *mut int (configure)(struct mlxsw_sp_fid,
    pub fid): *mut *mut void (deconfigure)(struct mlxsw_sp_fid,
    int (*index_alloc)(struct mlxsw_sp_fid *fid, const void *arg,
    pub p_fid_index): *mut u16,
    bool (*compare)(const struct mlxsw_sp_fid *fid,
    pub arg): *const c_void,
    int (*port_vid_map)(struct mlxsw_sp_fid *fid,
    pub vid): *mut *mut mlxsw_sp_port port, u16,
    void (*port_vid_unmap)(struct mlxsw_sp_fid *fid,
    pub vid): *mut *mut mlxsw_sp_port port, u16,
    pub fid): *mut *mut int (vni_set)(struct mlxsw_sp_fid,
    pub fid): *mut *mut void (vni_clear)(struct mlxsw_sp_fid,
    pub fid): *mut *mut int (nve_flood_index_set)(struct mlxsw_sp_fid,
    pub fid): *mut *mut void (nve_flood_index_clear)(struct mlxsw_sp_fid,
    void (*fdb_clear_offload)(const struct mlxsw_sp_fid *fid,
    pub nve_dev): *const net_device,
    int (*vid_to_fid_rif_update)(const struct mlxsw_sp_fid *fid,
    pub rif): *const mlxsw_sp_rif,
    int (*flood_table_init)(struct mlxsw_sp_fid_family *fid_family,
    pub flood_table): *const mlxsw_sp_flood_table,
    int (*pgt_size)(const struct mlxsw_sp_fid_family *fid_family,
    pub p_pgt_size): *mut u16,
    u16 (*fid_mid)(const struct mlxsw_sp_fid *fid,
    pub flood_table): *const mlxsw_sp_flood_table,
    void (*fid_pack)(char *sfmr_pl, const struct mlxsw_sp_fid *fid,
    pub op): enum mlxsw_reg_sfmr_op,
...
//
    ...
    pub mlxsw_sp_port): *const mlxsw_sp_port,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_fid_flood_profile {
    pub flood_tables: *const mlxsw_sp_flood_table,
    pub nr_flood_tables: c_int,
    pub /: *const *const enum mlxsw_sp_fid_flood_profile_id profile_id; / For CFF mode.,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_fid_family {
    pub type: enum mlxsw_sp_fid_type,
    pub fid_size: usize,
    pub start_index: u16,
    pub end_index: u16,
    pub fids_list: list_head,
    pub fids_bitmap: *mut c_ulong,
    pub flood_profile: *const mlxsw_sp_fid_flood_profile,
    pub rif_type: enum mlxsw_sp_rif_type,
    pub ops: *const mlxsw_sp_fid_ops,
    pub mlxsw_sp: *mut mlxsw_sp,
    pub /: *mut *mut bool flood_rsp; / For flood_mode!=CFF.,
    pub bridge_type: enum mlxsw_reg_bridge_type,
    pub pgt_base: u16,
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_fid_nve_ifindex(fid: *const mlxsw_sp_fid, nve_ifindex: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_fid_vni(fid: *const mlxsw_sp_fid, vni: *mut __be32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_fid_nve_flood_index_clear(fid: *mut mlxsw_sp_fid) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_fid_nve_flood_index_is_set(fid: *const mlxsw_sp_fid) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_fid_vni_clear(fid: *mut mlxsw_sp_fid) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_fid_vni_is_set(fid: *const mlxsw_sp_fid) -> bool {
    ...
    u16 *p_pgt_size)
    {
    let mut num_fids: u16 = mlxsw_sp_fid_family_num_fids(fid_family);
// p_pgt_size = num_fids * fid_family->flood_profile->nr_flood_tables;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_rfid_port_offset_cff(local_port: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_fid_index(fid: *const mlxsw_sp_fid) -> u16 {
    u16 mlxsw_sp_fid_index(const struct mlxsw_sp_fid *fid)
    {
    return fid.fid_index;
    }
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_fid_type(fid: *const mlxsw_sp_fid) -> enum mlxsw_sp_fid_type {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_fid_8021q_vid(fid: *const mlxsw_sp_fid) -> u16 {
    u16 mlxsw_sp_fid_8021q_vid(const struct mlxsw_sp_fid *fid)
    {
    return mlxsw_sp_fid_8021q_fid(fid).vid;
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_8021q_setup(fid: *mut mlxsw_sp_fid, arg: *const c_void) -> c_int {
    static int mlxsw_sp_fid_8021q_setup(struct mlxsw_sp_fid *fid, const void *arg)
    {
    let mut vid: u16 = *(u16 *) arg;
    mlxsw_sp_fid_8021q_fid(fid).vid = vid;
    fid.fid_offset = fid.fid_index - fid.fid_family.start_index;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_sfmr_op(valid: bool) -> enum mlxsw_reg_sfmr_op {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_pgt_base_cff(fid: *const mlxsw_sp_fid) -> u16 {
    ...
    {
    struct mlxsw_sp_fid_family *fid_family = fid.fid_family;
    let mut pgt_base: u16 = mlxsw_sp_fid_pgt_base_cff(fid);
    mlxsw_sp_fid_pack(sfmr_pl, fid, op);
    ...
    {
    let mut max_ports: u16 = mlxsw_core_max_ports(mlxsw_sp.core);
    if (is_lag)
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_op(fid: *const mlxsw_sp_fid, valid: bool) -> c_int {
...
//
    ...
    fid.fid_family.ops.vid_to_fid_rif_update(fid, core::ptr::null_mut());
    return err;
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_vid_to_fid_rif_unset(fid: *const mlxsw_sp_fid) {
...
//
    ...
    {
    let mut local_port_end: u16 = (port_page + 1) * MLXSW_REG_REIV_REC_MAX_COUNT - 1;
    let mut local_port_start: u16 = port_page * MLXSW_REG_REIV_REC_MAX_COUNT;
    struct mlxsw_sp *mlxsw_sp = fid.fid_family.mlxsw_sp;
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_fid_rif_set(fid: *mut mlxsw_sp_fid, rif: *mut mlxsw_sp_rif) -> c_int {
    int mlxsw_sp_fid_rif_set(struct mlxsw_sp_fid *fid, struct mlxsw_sp_rif *rif)
    {
    let mut rif_index: u16 = mlxsw_sp_rif_index(rif);
    int err;
    ...
    mlxsw_sp_fid_vni_to_fid_rif_update(fid, core::ptr::null_mut());
    err_vni_to_fid_rif_update:
    mlxsw_sp_fid_to_fid_rif_update(fid, core::ptr::null_mut());
    return err;
    }
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_fid_rif_unset(fid: *mut mlxsw_sp_fid) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_vni_op(fid: *const mlxsw_sp_fid) -> c_int {
    ...
    struct mlxsw_sp *mlxsw_sp = fid.fid_family.mlxsw_sp;
    char svfa_pl[MLXSW_REG_SVFA_LEN];
    let mut irif_valid: bool = false;
    let mut irif_index: u16 = 0;
    if (fid.rif) {
    irif_valid = true;
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_8021d_setup(fid: *mut mlxsw_sp_fid, arg: *const c_void) -> c_int {
    static int mlxsw_sp_fid_8021d_setup(struct mlxsw_sp_fid *fid, const void *arg)
    {
    let mut br_ifindex: c_int = *(int *) arg;
    mlxsw_sp_fid_8021d_fid(fid).br_ifindex = br_ifindex;
    fid.fid_offset = fid.fid_index - fid.fid_family.start_index;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_8021d_configure(fid: *mut mlxsw_sp_fid) -> c_int {
    static int mlxsw_sp_fid_8021d_configure(struct mlxsw_sp_fid *fid)
    {
    return mlxsw_sp_fid_op(fid, true);
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_8021d_deconfigure(fid: *mut mlxsw_sp_fid) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_port_vp_mode_trans(mlxsw_sp_port: *mut mlxsw_sp_port) -> c_int {
    ...
    let mut vid: u16 = mlxsw_sp_port_vlan.vid;
    if (!fid)
    continue;
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_port_vlan_mode_trans(mlxsw_sp_port: *mut mlxsw_sp_port) {
    ...
    u16 local_port, u16 vid, bool valid)
    {
    let mut port_page: u8 = local_port / MLXSW_REG_REIV_REC_MAX_COUNT;
    let mut rec_num: u8 = local_port % MLXSW_REG_REIV_REC_MAX_COUNT;
    struct mlxsw_sp *mlxsw_sp = fid.fid_family.mlxsw_sp;
    let mut rif_index: u16 = mlxsw_sp_rif_index(fid.rif);
    char *reiv_pl;
    int err;
    reiv_pl = kmalloc(MLXSW_REG_REIV_LEN, GFP_KERNEL);
    if (!reiv_pl)
    ...
    let mut local_port: u16 = mlxsw_sp_port.local_port;
    int err;
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_8021d_vni_set(fid: *mut mlxsw_sp_fid) -> c_int {
    static int mlxsw_sp_fid_8021d_vni_set(struct mlxsw_sp_fid *fid)
    {
    return mlxsw_sp_fid_vni_op(fid);
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_8021d_vni_clear(fid: *mut mlxsw_sp_fid) {
    static void mlxsw_sp_fid_8021d_vni_clear(struct mlxsw_sp_fid *fid)
    {
    mlxsw_sp_fid_vni_op(fid);
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_8021d_nve_flood_index_set(fid: *mut mlxsw_sp_fid) -> c_int {
    static int mlxsw_sp_fid_8021d_nve_flood_index_set(struct mlxsw_sp_fid *fid)
    {
    return mlxsw_sp_fid_edit_op(fid, fid.rif);
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_8021d_nve_flood_index_clear(fid: *mut mlxsw_sp_fid) {
    ...
    const struct mlxsw_sp_flood_table *flood_table)
    {
    let mut packet_type: enum mlxsw_sp_flood_type = flood_table.packet_type;
    struct mlxsw_sp *mlxsw_sp = fid_family.mlxsw_sp;
...
// In controlled mode, the FW takes care of FID placement.
    ...
    {
    struct mlxsw_sp *mlxsw_sp = fid.fid_family.mlxsw_sp;
    let mut rif_index: u16 = *(const u16 *)arg;
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_rfid_configure(fid: *mut mlxsw_sp_fid) -> c_int {
    static int mlxsw_sp_fid_rfid_configure(struct mlxsw_sp_fid *fid)
    {
    return mlxsw_sp_fid_op(fid, true);
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_rfid_deconfigure(fid: *mut mlxsw_sp_fid) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_rfid_vni_set(fid: *mut mlxsw_sp_fid) -> c_int {
    static int mlxsw_sp_fid_rfid_vni_set(struct mlxsw_sp_fid *fid)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_rfid_vni_clear(fid: *mut mlxsw_sp_fid) {
    static void mlxsw_sp_fid_rfid_vni_clear(struct mlxsw_sp_fid *fid)
    {
    WARN_ON_ONCE(1);
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_rfid_nve_flood_index_set(fid: *mut mlxsw_sp_fid) -> c_int {
    static int mlxsw_sp_fid_rfid_nve_flood_index_set(struct mlxsw_sp_fid *fid)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_rfid_nve_flood_index_clear(fid: *mut mlxsw_sp_fid) {
    ...
    let mut router_port: u16 = mlxsw_sp_router_port(mlxsw_sp);
    err = mlxsw_sp_pgt_entry_port_set(mlxsw_sp, pgt_addr, smpe,
    router_port, true);
    if (err)
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_dummy_setup(fid: *mut mlxsw_sp_fid, arg: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_dummy_configure(fid: *mut mlxsw_sp_fid) -> c_int {
    static int mlxsw_sp_fid_dummy_configure(struct mlxsw_sp_fid *fid)
    {
    return mlxsw_sp_fid_op(fid, true);
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_dummy_deconfigure(fid: *mut mlxsw_sp_fid) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_dummy_vni_set(fid: *mut mlxsw_sp_fid) -> c_int {
    static int mlxsw_sp_fid_dummy_vni_set(struct mlxsw_sp_fid *fid)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_dummy_vni_clear(fid: *mut mlxsw_sp_fid) {
    static void mlxsw_sp_fid_dummy_vni_clear(struct mlxsw_sp_fid *fid)
    {
    WARN_ON_ONCE(1);
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_dummy_nve_flood_index_set(fid: *mut mlxsw_sp_fid) -> c_int {
    static int mlxsw_sp_fid_dummy_nve_flood_index_set(struct mlxsw_sp_fid *fid)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_dummy_nve_flood_index_clear(fid: *mut mlxsw_sp_fid) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_8021q_configure(fid: *mut mlxsw_sp_fid) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_8021q_deconfigure(fid: *mut mlxsw_sp_fid) {
    static void mlxsw_sp_fid_8021q_deconfigure(struct mlxsw_sp_fid *fid)
    {
    struct mlxsw_sp_fid_8021q *fid_8021q = mlxsw_sp_fid_8021q_fid(fid);
    if (fid.vni_valid)
    mlxsw_sp_nve_fid_disable(fid.fid_family.mlxsw_sp, fid);
    mlxsw_sp_fid_vid_to_fid_map(fid, fid_8021q.vid, false, core::ptr::null_mut());
    mlxsw_sp_fid_op(fid, false);
    }
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_fid_put(fid: *mut mlxsw_sp_fid) {
    ...
    {
    return mlxsw_sp_fid_get(mlxsw_sp, MLXSW_SP_FID_TYPE_DUMMY, core::ptr::null_mut());
    }
    static int
    ...
    {
    let mut nr_fids: u16 = tmpl.end_index - tmpl.start_index + 1;
    struct mlxsw_sp_fid_family *fid_family;
    int err;
    ...
    struct mlxsw_sp_fid_family *fid_family)
    {
    mlxsw_sp.fid_core.fid_family_arr[fid_family.type] = core::ptr::null_mut();
    if (fid_family.flood_profile)
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_port_init(mlxsw_sp_port: *const mlxsw_sp_port) -> c_int {
    static int mlxsw_sp_fid_port_init(const struct mlxsw_sp_port *mlxsw_sp_port)
    {
    let mut type_rfid: enum mlxsw_sp_fid_type = MLXSW_SP_FID_TYPE_RFID;
    struct mlxsw_sp *mlxsw_sp = mlxsw_sp_port.mlxsw_sp;
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fid_port_fini(mlxsw_sp_port: *const mlxsw_sp_port) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_port_fids_init(mlxsw_sp_port: *mut mlxsw_sp_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_port_fids_fini(mlxsw_sp_port: *mut mlxsw_sp_port) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_fid_port_join_lag(mlxsw_sp_port: *const mlxsw_sp_port) -> c_int {
    int mlxsw_sp_fid_port_join_lag(const struct mlxsw_sp_port *mlxsw_sp_port)
    {
    return mlxsw_sp_fid_port_init(mlxsw_sp_port);
    }
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_fid_port_leave_lag(mlxsw_sp_port: *const mlxsw_sp_port) {
    ...
    {
    let mut max_ports: c_uint = mlxsw_core_max_ports(mlxsw_sp.core);
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_fids_fini(mlxsw_sp: *mut mlxsw_sp) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp1_fids_init(mlxsw_sp: *mut mlxsw_sp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp2_fids_init_ctl(mlxsw_sp: *mut mlxsw_sp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp2_fids_init_cff(mlxsw_sp: *mut mlxsw_sp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp2_fids_init(mlxsw_sp: *mut mlxsw_sp) -> c_int {
