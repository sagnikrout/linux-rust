...
//! Source: drivers/net/ethernet/mellanox/mlxsw/spectrum_acl.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_acl {
    pub mlxsw_sp: *mut mlxsw_sp,
    pub afk: *mut mlxsw_afk,
    pub dummy_fid: *mut mlxsw_sp_fid,
    pub ruleset_ht: rhashtable,
    pub rules: list_head,
    pub /: *mut *mut mutex rules_lock; / Protects rules list,
    struct {
    pub dw: delayed_work,
    pub /: *mut *mut unsigned long interval; / ms,
pub const MLXSW_SP_ACL_RULE_ACTIVITY_UPDATE_PERIOD_MS: c_int = 1000;
    pub rule_activity_update: },
    pub tcam: mlxsw_sp_acl_tcam,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_acl_ruleset_ht_key {
    pub block: *mut mlxsw_sp_flow_block,
    pub chain_index: u32,
    pub ops: *const mlxsw_sp_acl_profile_ops,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_acl_ruleset {
    pub /: *mut *mut rhash_head ht_node; / Member of acl HT,
    pub ht_key: mlxsw_sp_acl_ruleset_ht_key,
    pub rule_ht: rhashtable,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_acl_rule {
    pub /: *mut *mut rhash_head ht_node; / Member of rule HT,
    pub list: list_head,
    pub /: *mut *mut unsigned long cookie; / HT key,
    pub ruleset: *mut mlxsw_sp_acl_ruleset,
...
// We hold a reference on ruleset ourselves
    ...
    block.ruleset_zero = core::ptr::null_mut();
    return err;
    }
    static void
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_acl_ruleset_ref_inc(ruleset: *mut mlxsw_sp_acl_ruleset) {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_acl_ruleset_group_id(ruleset: *mut mlxsw_sp_acl_ruleset) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_acl_rulei_commit(rulei: *mut mlxsw_sp_acl_rule_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_acl_rulei_act_continue(rulei: *mut mlxsw_sp_acl_rule_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_acl_rulei_act_terminate(rulei: *mut mlxsw_sp_acl_rule_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_acl_rulei_act_trap(rulei: *mut mlxsw_sp_acl_rule_info) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_acl_mangle_action {
    pub htype: enum flow_action_mangle_base,
...
// Shift required to extract the set value.
    pub shift: u32,
    pub field: enum mlxsw_sp_acl_mangle_field,
}
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_acl_rules_activity_update(acl: *mut mlxsw_sp_acl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_acl_rule_activity_work_schedule(acl: *mut mlxsw_sp_acl) {
    static void mlxsw_sp_acl_rule_activity_work_schedule(struct mlxsw_sp_acl *acl)
    {
    let mut interval: c_ulong = acl.rule_activity_update.interval;
    mlxsw_core_schedule_dw(&acl.rule_activity_update.dw,
    msecs_to_jiffies(interval));
    }
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_acl_rule_activity_update_work(work: *mut work_struct) {
    ...
    {
    let mut type: enum mlxsw_sp_policer_type = MLXSW_SP_POLICER_TYPE_SINGLE_RATE;
    struct mlxsw_sp_acl_rule_info *rulei;
    let mut current_packets: u64 = 0;
    let mut current_bytes: u64 = 0;
    let mut current_drops: u64 = 0;
    int err;
    rulei = mlxsw_sp_acl_rule_rulei(rule);
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_acl_init(mlxsw_sp: *mut mlxsw_sp) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_acl_fini(mlxsw_sp: *mut mlxsw_sp) {
