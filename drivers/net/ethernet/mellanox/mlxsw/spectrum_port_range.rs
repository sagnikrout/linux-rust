...
//! Source: drivers/net/ethernet/mellanox/mlxsw/spectrum_port_range.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_port_range_reg {
    pub range: mlxsw_sp_port_range,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxsw_sp_port_range_core {
    pub prr_xa: xarray,
    pub prr_ids: xa_limit,
    pub prr_count: core::sync::atomic::AtomicI32,
}
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_port_range_reg_put(mlxsw_sp: *mut mlxsw_sp, prr_index: u8) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp_port_range_reg_occ_get(priv: *mut c_void) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_port_range_init(mlxsw_sp: *mut mlxsw_sp) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlxsw_sp_port_range_fini(mlxsw_sp: *mut mlxsw_sp) {
