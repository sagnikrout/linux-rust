...
//! Source: drivers/net/ethernet/mellanox/mlxsw/spectrum_nve_vxlan.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp1_nve_vxlan_config_clear(mlxsw_sp: *mut mlxsw_sp) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp1_nve_vxlan_fini(nve: *mut mlxsw_sp_nve) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp2_nve_vxlan_config_clear(mlxsw_sp: *mut mlxsw_sp) {
...
#[no_mangle]
unsafe extern "C" fn mlxsw_sp2_nve_vxlan_fini(nve: *mut mlxsw_sp_nve) {
