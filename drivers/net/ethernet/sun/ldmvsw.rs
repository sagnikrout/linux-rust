...
//! Source: drivers/net/ethernet/sun/ldmvsw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vsw_get_msglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vsw_set_msglevel(dev: *mut net_device, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn vsw_start_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn vsw_set_rx_mode(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ldmvsw_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsw_poll_controller(dev: *mut net_device) {
    ...
    const u64 *cfghandle = core::ptr::null_mut();
    u64 a;
// Get the parent virtual-network-switch macaddr and cfghandle
    ...
    cfg_handle_prop, core::ptr::null_mut());
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn vsw_port_probe(vdev: *mut vio_dev, id: *const vio_device_id) -> c_int {
    ...
    port_id = mdesc_get_property(hp, vdev.mp, id_prop, core::ptr::null_mut());
    err = -ENODEV;
    if (!port_id) {
    pr_err("Port lacks %s property\n", id_prop);
    mdesc_release(hp);
...
#[no_mangle]
unsafe extern "C" fn vsw_port_remove(vdev: *mut vio_dev) {
...
#[no_mangle]
unsafe extern "C" fn vsw_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn vsw_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vsw_exit() -> void __exit {
