...
//! Source: drivers/net/ethernet/sun/sunvnet.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vnet_get_msglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vnet_set_msglevel(dev: *mut net_device, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn vnet_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
    ...
    case ETH_SS_STATS:
#[no_mangle]
pub unsafe extern "C" fn ARRAY_SIZE(_arg: ethtool_stats_keys) -> return {
...
#[no_mangle]
unsafe extern "C" fn vnet_get_strings(dev: *mut net_device, stringset: u32, buf: *mut u8) {
    ...
    {
    let mut hash: c_uint = vnet_hashfn(skb.data);
...
#[no_mangle]
unsafe extern "C" fn vnet_start_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t vnet_start_xmit(struct sk_buff *skb, struct net_device *dev)
    {
    return sunvnet_start_xmit_common(skb, dev, vnet_tx_port_find);
    }
#[no_mangle]
unsafe extern "C" fn vnet_set_rx_mode(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn vnet_poll_controller(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn vnet_cleanup() {
...
// vio_unregister_driver() should have cleaned up port_list
    ...
    struct vio_dev *vdev)
    {
    const u64 *local_mac = core::ptr::null_mut();
    u64 a;
    mdesc_for_each_arc(a, hp, port_node, MDESC_ARC_TYPE_BACK) {
    let mut target: u64 = mdesc_arc_target(hp, a);
    const char *name;
    name = mdesc_get_property(hp, target, "name", core::ptr::null_mut());
    if (!name || strcmp(name, "network"))
    continue;
    local_mac = mdesc_get_property(hp, target,
    local_mac_prop, core::ptr::null_mut());
    if (local_mac)
    break;
    }
    if (!local_mac)
...
#[no_mangle]
unsafe extern "C" fn vnet_port_probe(vdev: *mut vio_dev, id: *const vio_device_id) -> c_int {
    ...
    switch_port = 0;
    if (mdesc_get_property(hp, vdev.mp, "switch-port", core::ptr::null_mut()))
    switch_port = 1;
...
#[no_mangle]
unsafe extern "C" fn vnet_port_remove(vdev: *mut vio_dev) {
...
#[no_mangle]
unsafe extern "C" fn vnet_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vnet_exit() -> void __exit {
