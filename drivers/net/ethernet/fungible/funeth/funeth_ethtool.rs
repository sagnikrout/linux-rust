...
//! Source: drivers/net/ethernet/fungible/funeth/funeth_ethtool.c
#![no_std]
...
// fewer entries.
//
pub const FUNETH_MIN_QDEPTH: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn set_asym_pause(advertising: u64, ks: *mut ethtool_link_ksettings) {
...
#[no_mangle]
unsafe extern "C" fn fun_port_type(xcvr: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn fun_advert_modes(ks: *const ethtool_link_ksettings) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn fun_speed_to_link_mode(speed: c_uint) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn fun_change_advert(fp: *mut funeth_priv, new_advert: u64) -> c_int {
...
// eswitch ports don't support mode changes
    ...
    {
    const struct funeth_priv *fp = netdev_priv(netdev);
    let mut active_pause: u8 = fp.active_fc;
...
#[no_mangle]
unsafe extern "C" fn fun_restart_an(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fun_get_msglevel(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fun_set_msglevel(netdev: *mut net_device, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn fun_get_regs_len(dev: *mut net_device) -> c_int {
...
// a timer is required if there's any coalescing
    ...
    {
    const struct funeth_priv *fp = netdev_priv(netdev);
    let mut max_depth: c_uint = fp.fdev.q_depth;
...
#[no_mangle]
unsafe extern "C" fn fun_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fun_get_strings(netdev: *mut net_device, sset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn fun_get_rx_ring_count(netdev: *mut net_device) -> u32 {
    static u32 fun_get_rx_ring_count(struct net_device *netdev)
    {
    return netdev.real_num_rx_queues;
    }
#[no_mangle]
unsafe extern "C" fn fun_set_rxnfc(netdev: *mut net_device, info: *mut ethtool_rxnfc) -> c_int {
    static int fun_set_rxnfc(struct net_device *netdev, struct ethtool_rxnfc *info)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn fun_get_rxfh_indir_size(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fun_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
    ...
    algo = fp.hash_algo;
#[no_mangle]
pub unsafe extern "C" fn if(ETH_RSS_HASH_CRC32: rxfh->hfunc ==) -> else {
    else if (rxfh.hfunc == ETH_RSS_HASH_CRC32)
    algo = FUN_ETH_RSS_ALG_CRC32;
#[no_mangle]
pub unsafe extern "C" fn if(ETH_RSS_HASH_TOP: rxfh->hfunc ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn to_ethtool_fec(fun_fec: c_uint) -> c_uint {
    static unsigned int to_ethtool_fec(unsigned int fun_fec)
    {
    let mut fec: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn fun_set_ethtool_ops(netdev: *mut net_device) {
