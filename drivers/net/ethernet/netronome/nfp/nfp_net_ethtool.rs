...
//! Source: drivers/net/ethernet/netronome/nfp/nfp_net_ethtool.c
#![no_std]
...
pub const NN_ET_SWITCH_STATS_LEN: c_int = 9;
pub const NN_RVEC_GATHER_STATS: c_int = 13;
pub const NN_RVEC_PER_Q_STATS: c_int = 3;
pub const NN_CTRL_PATH_STATS: c_int = 4;
pub const SFP_SFF_REV_COMPLIANCE: c_int = 1;
#[no_mangle]
unsafe extern "C" fn nfp_net_get_nspinfo(app: *mut nfp_app, version: *mut c_char) {
...
// Use link speed from ETH table if available, otherwise try the BAR
    ...
    {
    let mut req_aneg: bool = (cmd.base.autoneg == AUTONEG_ENABLE);
    struct nfp_eth_table_port *eth_port;
    struct nfp_port *port;
    struct nfp_nsp *nsp;
    int err;
    ...
    let mut speed: u32 = cmd.base.speed / eth_port.lanes;
    ...
    {
    struct nfp_net *nn = netdev_priv(netdev);
    let mut qc_max: u32 = nn.dev_info.max_qc_size;
...
#[no_mangle]
unsafe extern "C" fn nfp_test_link(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_test_nsp(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_test_fw(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_test_reg(netdev: *mut net_device) -> c_int {
    static int nfp_test_reg(struct net_device *netdev)
    {
    struct nfp_app *app = nfp_app_from_netdev(netdev);
    struct nfp_cpp *cpp = app.cpp;
    let mut model: u32 = nfp_cpp_model(cpp);
    u32 value;
    int err;
...
#[no_mangle]
unsafe extern "C" fn link_test_supported(netdev: *mut net_device) -> bool {
    static bool link_test_supported(struct net_device *netdev)
    {
    return true;
    }
#[no_mangle]
unsafe extern "C" fn nsp_test_supported(netdev: *mut net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fw_test_supported(netdev: *mut net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn reg_test_supported(netdev: *mut net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfp_get_self_test_strings(netdev: *mut net_device, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn nfp_get_self_test_count(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_vnic_get_sw_stats_count(netdev: *mut net_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nfp_vnic_get_hw_stats_count(num_vecs: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nfp_vnic_get_tlv_stats_count(nn: *mut nfp_net) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nfp_mac_get_stats_count(netdev: *mut net_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_port_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_port_fec_ethtool_to_nsp(fec: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_port_fec_nsp_to_ethtool(fec: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn ethtool_flow_to_nfp_flag(flow_type: u32) -> u32 {
...
pub const NFP_FS_MAX_ENTRY: c_int = 1024;
#[no_mangle]
unsafe extern "C" fn nfp_net_fs_to_ethtool(entry: *mut nfp_fs_entry, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_get_fs_rule(nn: *mut nfp_net, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_get_fs_loc(nn: *mut nfp_net, rule_locs: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_get_rx_ring_count(netdev: *mut net_device) -> u32 {
    ...
    {
    struct nfp_net *nn = netdev_priv(netdev);
    let mut new_rss_cfg: u32 = nn.rss_cfg;
    u32 nfp_rss_flag;
    int err;
    if (!(nn.cap & NFP_NET_CFG_CTRL_RSS_ANY))
    return -EOPNOTSUPP;
...
#[no_mangle]
unsafe extern "C" fn nfp_net_fs_from_ethtool(entry: *mut nfp_fs_entry, fs: *mut ethtool_rx_flow_spec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_fs_check_existing(nn: *mut nfp_net, new: *mut nfp_fs_entry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_fs_add(nn: *mut nfp_net, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_fs_del(nn: *mut nfp_net, cmd: *mut ethtool_rxnfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_get_rxfh_indir_size(netdev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_get_rxfh_key_size(netdev: *mut net_device) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_get_regs_len(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_app_set_dump(netdev: *mut net_device, val: *mut ethtool_dump) -> c_int {
    ...
    return nfp_dump_nsp_diag(app, dump, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_set_ethtool_ops(netdev: *mut net_device) {
