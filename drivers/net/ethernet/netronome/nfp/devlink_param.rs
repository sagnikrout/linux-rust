...
//! Source: drivers/net/ethernet/netronome/nfp/devlink_param.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_devlink_param_u8_arg {
    pub hwinfo_name: *const c_char,
    pub default_hi_val: *const c_char,
    pub invalid_dl_val: c_int,
    pub hi_to_dl: [u8; 4],
    pub dl_to_hi: [u8; 4],
    pub max_dl_val: u8,
    pub max_hi_val: u8,
...
#[no_mangle]
unsafe extern "C" fn nfp_devlink_supports_params(pf: *mut nfp_pf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_devlink_params_register(pf: *mut nfp_pf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_devlink_params_unregister(pf: *mut nfp_pf) {
