...
//! Source: drivers/net/ethernet/netronome/nfp/nfp_net_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nfp_net_pf_get_num_ports(pf: *mut nfp_pf) -> c_int {
    static int nfp_net_pf_get_num_ports(struct nfp_pf *pf)
    {
    return nfp_pf_rtsym_read_optional(pf, "nfd_cfg_pf%u_num_ports", 1);
    }
#[no_mangle]
unsafe extern "C" fn nfp_net_pf_free_vnic(pf: *mut nfp_pf, nn: *mut nfp_net) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_pf_free_vnics(pf: *mut nfp_pf) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_pf_clean_vnic(pf: *mut nfp_pf, nn: *mut nfp_net) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_pf_alloc_irqs(pf: *mut nfp_pf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_pf_free_irqs(pf: *mut nfp_pf) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_pf_init_vnics(pf: *mut nfp_pf) -> c_int {
...
// Finish vNIC init and register
    ...
    err_free:
    nfp_app_free(pf.app);
    pf.app = core::ptr::null_mut();
    return err;
    }
#[no_mangle]
unsafe extern "C" fn nfp_net_pf_app_clean(pf: *mut nfp_pf) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_pf_app_start_ctrl(pf: *mut nfp_pf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_pf_app_stop_ctrl(pf: *mut nfp_pf) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_pf_app_start(pf: *mut nfp_pf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_pf_app_stop(pf: *mut nfp_pf) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_pci_unmap_mem(pf: *mut nfp_pf) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_pci_map_mem(pf: *mut nfp_pf) -> c_int {
    ...
    pf.mac_stats_mem = core::ptr::null_mut();
    }
    }
    ...
    pf.vf_cfg_mem = core::ptr::null_mut();
    }
    ...
    pf.vfcfg_tbl2 = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_lr2speed(linkrate: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_speed2lr(speed: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_notify_port_speed(port: *mut nfp_port) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_refresh_port_table_sync(pf: *mut nfp_pf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_refresh_vnics(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_refresh_port_table(port: *mut nfp_port) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_refresh_eth_port(port: *mut nfp_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_net_pci_probe(pf: *mut nfp_pf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_pci_remove(pf: *mut nfp_pf) {
