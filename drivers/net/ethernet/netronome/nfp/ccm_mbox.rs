...
//! Source: drivers/net/ethernet/netronome/nfp/ccm_mbox.c
#![no_std]
...
//
pub const NFP_CCM_MBOX_BATCH_LIMIT: c_int = 64;

pub const NFP_CCM_MAX_QLEN: c_int = 1024;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_ccm_mbox_cmsg_cb {
    pub state: enum nfp_net_mbox_cmsg_state,
    pub err: c_int,
    pub max_len: c_uint,
    pub exp_reply: c_uint,
    pub posted: bool,
}

#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_max_msg(nn: *mut nfp_net) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_maxlen(skb: *const sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_done(skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_in_progress(skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_set_busy(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_is_posted(skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_mark_posted(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_is_first(nn: *mut nfp_net, skb: *mut sk_buff) -> bool {
    static bool nfp_ccm_mbox_is_first(struct nfp_net *nn, struct sk_buff *skb)
    {
    return skb_queue_is_first(&nn.mbox_cmsg.queue, skb);
    }
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_should_run(nn: *mut nfp_net, skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_mark_next_runner(nn: *mut nfp_net) {
...
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_copy_in(nn: *mut nfp_net, last: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_copy_out(nn: *mut nfp_net, last: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_run_queue_unlock(nn: *mut nfp_net) {
    static void nfp_ccm_mbox_run_queue_unlock(struct nfp_net *nn)
    __releases(&nn.mbox_cmsg.queue.lock)
    {
    let mut space: c_int = nn.tlv_caps.mbox_len - NFP_NET_CFG_MBOX_SIMPLE_VAL;
...
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_skb_return(skb: *mut sk_buff) -> c_int {
...
//
    ...
    gfp_t flags)
    {
    let mut mbox_max: c_uint = nfp_ccm_mbox_max_msg(nn);
...
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_post_runq_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nfp_ccm_mbox_post_wait_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_ccm_mbox_fits(nn: *mut nfp_net, size: c_uint) -> bool {
    bool nfp_ccm_mbox_fits(struct nfp_net *nn, unsigned int size)
    {
    return nfp_ccm_mbox_max_msg(nn) >= size;
    }
#[no_mangle]
pub unsafe extern "C" fn nfp_ccm_mbox_init(nn: *mut nfp_net) -> c_int {
    int nfp_ccm_mbox_init(struct nfp_net *nn)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn nfp_ccm_mbox_clean(nn: *mut nfp_net) {
    void nfp_ccm_mbox_clean(struct nfp_net *nn)
    {
    drain_workqueue(nn.mbox_cmsg.workq);
    }
#[no_mangle]
pub unsafe extern "C" fn nfp_ccm_mbox_alloc(nn: *mut nfp_net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_ccm_mbox_free(nn: *mut nfp_net) {
