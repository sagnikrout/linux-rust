...
//! Source: drivers/net/ethernet/netronome/nfp/flower/tunnel_conf.c
#![no_std]
...
pub const NFP_FL_MAX_ROUTES: c_int = 32;
pub const NFP_TUN_PRE_TUN_RULE_LIMIT: c_int = 32;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_tun_pre_tun_rule {
    pub flags: __be32,
    pub port_idx: __be16,
    pub vlan_tci: __be16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_tun_active_tuns {
    pub seq: __be32,
    pub count: __be32,
    pub flags: __be32,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct route_ip_info {
    pub ipv4: __be32,
    pub egress_port: __be32,
    pub extra: [__be32; 2],
    pub tun_info: [}; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_tun_active_tuns_v6 {
    pub seq: __be32,
    pub count: __be32,
    pub flags: __be32,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct route_ip_info_v6 {
    pub ipv6: in6_addr,
    pub egress_port: __be32,
    pub extra: [__be32; 2],
    pub tun_info: [}; ],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_tun_req_route_ipv4 {
    pub ingress_port: __be32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_tun_req_route_ipv6 {
    pub ingress_port: __be32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_offloaded_route {
    pub list: list_head,
    pub ip_add: [u8; ],
}

pub const NFP_FL_IPV4_ADDRS_MAX: c_int = 32;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_tun_ipv4_addr {
    pub count: __be32,
    pub ipv4_addr: [__be32; NFP_FL_IPV4_ADDRS_MAX],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_ipv4_addr_entry {
    pub ipv4_addr: __be32,
    pub ref_count: c_int,
    pub list: list_head,
}

pub const NFP_FL_IPV6_ADDRS_MAX: c_int = 4;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_tun_ipv6_addr {
    pub count: __be32,
    pub ipv6_addr: [in6_addr; NFP_FL_IPV6_ADDRS_MAX],
}

pub const NFP_TUN_MAC_OFFLOAD_DEL_FLAG: c_uint = 0x2;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_tun_mac_addr_offload {
    pub flags: __be16,
    pub count: __be16,
    pub index: __be16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_neigh_update_work {
...
pub const NFP_MAX_MAC_INDEX: c_uint = 0xff;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_tun_offloaded_mac {
    pub ht_node: rhash_head,
    pub addr: [u8; ETH_ALEN],
    pub index: u16,
    pub ref_count: c_int,
    pub repr_list: list_head,
    pub bridge_count: c_int,
}
...
#[no_mangle]
pub unsafe extern "C" fn nfp_tunnel_keep_alive(app: *mut nfp_app, skb: *mut sk_buff) {
    ...
    netdev = nfp_app_dev_get(app, port, core::ptr::null_mut());
    if (!netdev)
    continue;
...
#[no_mangle]
pub unsafe extern "C" fn nfp_tunnel_keep_alive_v6(app: *mut nfp_app, skb: *mut sk_buff) {
...
//
    ...
    while ((nn_entry = rhashtable_walk_next(&iter)) != core::ptr::null_mut()) {
    if (IS_ERR(nn_entry))
    continue;
    nfp_tun_mutual_link(predt, nn_entry);
...
#[no_mangle]
unsafe extern "C" fn nfp_tun_cleanup_nn_entries(app: *mut nfp_app) {
    ...
    rhashtable_walk_enter(&priv.neigh_table, &iter);
    rhashtable_walk_start(&iter);
    while ((neigh = rhashtable_walk_next(&iter)) != core::ptr::null_mut()) {
    if (IS_ERR(neigh))
    continue;
    ext = neigh.is_ipv6 ?
    &((struct nfp_tun_neigh_v6 *)neigh.payload).ext :
    ...
    bool override)
    {
    let mut neigh_invalid: bool = !(neigh.nud_state & NUD_VALID) || neigh.dead;
    size_t neigh_size = is_ipv6 ? sizeof(struct nfp_tun_neigh_v6) :
    sizeof(struct nfp_tun_neigh_v4);
    let mut cookie: c_ulong = (unsigned long)neigh;
    struct nfp_flower_priv *priv = app.priv;
    ...
    nn_entry.flow = core::ptr::null_mut();
    if (is_ipv6) {
...
#[no_mangle]
unsafe extern "C" fn nfp_tun_neigh_update(work: *mut work_struct) {
...
// deleting.
//
    dst = ip6_dst_lookup_flow(dev_net(n.dev), core::ptr::null_mut(),
    &flow6, core::ptr::null_mut());
    if (IS_ERR(dst))
    goto out;
    dst_release(dst);
    }
...
#[no_mangle]
pub unsafe extern "C" fn nfp_tunnel_request_route_v4(app: *mut nfp_app, skb: *mut sk_buff) {
    ...
    payload = nfp_flower_cmsg_get_data(skb);
    rcu_read_lock();
    netdev = nfp_app_dev_get(app, be32_to_cpu(payload.ingress_port), core::ptr::null_mut());
    if (!netdev)
...
#[no_mangle]
pub unsafe extern "C" fn nfp_tunnel_request_route_v6(app: *mut nfp_app, skb: *mut sk_buff) {
    ...
    dst = ip6_dst_lookup_flow(dev_net(netdev), core::ptr::null_mut(), &flow, core::ptr::null_mut());
    if (IS_ERR(dst))
    goto fail_rcu_unlock;
...
#[no_mangle]
unsafe extern "C" fn nfp_tun_write_ipv4_list(app: *mut nfp_app) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_tunnel_add_ipv4_off(app: *mut nfp_app, ipv4: __be32) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_tunnel_del_ipv4_off(app: *mut nfp_app, ipv4: __be32) {
...
#[no_mangle]
unsafe extern "C" fn nfp_tun_write_ipv6_list(app: *mut nfp_app) {
...
#[no_mangle]
unsafe extern "C" fn nfp_tunnel_port_is_phy_repr(port: c_int) -> bool {
...
// If modifing MAC, remove repr from old list first.
    ...
    let mut ida_idx: c_int = -1, err;
    let mut nfp_mac_idx: u16 = 0;
...
// If MAC has global ID then extract and free the ida entry.
    ...
    {
    struct nfp_flower_non_repr_priv *nr_priv = core::ptr::null_mut();
    let mut non_repr: bool = false, *mac_offloaded;
    u8 *off_mac = core::ptr::null_mut();
    int err, port = 0;
    if (nfp_netdev_is_nfp_repr(netdev)) {
    struct nfp_flower_repr_priv *repr_priv;
    struct nfp_repr *repr;
...
#[no_mangle]
pub unsafe extern "C" fn nfp_tunnel_config_start(app: *mut nfp_app) -> c_int {
...
// Initialise priv data for neighbour offloading.
    ...
    nfp_check_rhashtable_empty, core::ptr::null_mut());
    return err;
    }
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn nfp_tunnel_config_stop(app: *mut nfp_app) {
