...
//! Source: drivers/net/ethernet/netronome/nfp/flower/metadata.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_fl_flow_table_cmp_arg {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_fl_stats_ctx_to_flow {
...
#[no_mangle]
unsafe extern "C" fn nfp_release_stats_entry(app: *mut nfp_app, stats_context_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_get_stats_entry(app: *mut nfp_app, stats_context_id: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_flower_rx_flow_stats(app: *mut nfp_app, skb: *mut sk_buff) {
    void nfp_flower_rx_flow_stats(struct nfp_app *app, struct sk_buff *skb)
    {
    let mut msg_len: c_uint = nfp_flower_cmsg_get_data_len(skb);
    struct nfp_flower_priv *priv = app.priv;
...
#[no_mangle]
unsafe extern "C" fn nfp_release_mask_id(app: *mut nfp_app, mask_id: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_mask_alloc(app: *mut nfp_app, mask_id: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_fl_obj_hashfn(data: *const c_void, len: u32, seed: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nfp_fl_key_hashfn(data: *const c_void, len: u32, seed: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nfp_zone_table_entry_destroy(zt: *mut nfp_fl_ct_zone_entry) {
...
#[no_mangle]
unsafe extern "C" fn nfp_free_zone_table_entry(ptr: *mut c_void, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nfp_free_map_table_entry(ptr: *mut c_void, arg: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_flower_metadata_cleanup(app: *mut nfp_app) {
