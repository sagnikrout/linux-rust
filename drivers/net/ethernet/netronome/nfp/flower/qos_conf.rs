...
//! Source: drivers/net/ethernet/netronome/nfp/flower/qos_conf.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_police_cfg_head {
    pub flags_opts: __be32,
    union {
    pub meter_id: __be32,
    pub port: __be32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_police_config {
    pub head: nfp_police_cfg_head,
    pub bkt_tkn_p: __be32,
    pub bkt_tkn_c: __be32,
    pub pbs: __be32,
    pub cbs: __be32,
    pub pir: __be32,
    pub cir: __be32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_police_stats_reply {
    pub head: nfp_police_cfg_head,
    pub pass_bytes: __be64,
    pub pass_pkts: __be64,
    pub drop_bytes: __be64,
    pub drop_pkts: __be64,
}
    ...
    let mut action_num: u32 = flow.rule.action.num_entries;
    struct nfp_flower_priv *fl_priv = app.priv;
    struct flow_action_entry *action = core::ptr::null_mut();
    struct nfp_flower_repr_priv *repr_priv;
    u32 netdev_port_id, i;
    struct nfp_repr *repr;
    bool pps_support;
    let mut bps_num: u32 = 0;
    let mut pps_num: u32 = 0;
    u32 burst;
    bool pps;
    u64 rate;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn nfp_flower_stats_rlim_reply(app: *mut nfp_app, skb: *mut sk_buff) {
    ...
    rcu_read_lock();
    netdev = nfp_app_dev_get(app, netdev_port_id, core::ptr::null_mut());
    if (!netdev)
...
#[no_mangle]
unsafe extern "C" fn update_stats_cache(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_flower_qos_init(app: *mut nfp_app) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_flower_qos_cleanup(app: *mut nfp_app) {
...
// Offload tc action, currently only for tc police
    ...
    {
    struct nfp_meter_entry *meter_entry = core::ptr::null_mut();
    struct nfp_flower_priv *priv = app.priv;
...
#[no_mangle]
unsafe extern "C" fn nfp_flower_del_meter_entry(app: *mut nfp_app, meter_id: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_init_meter_table(app: *mut nfp_app) -> c_int {
    ...
    while ((meter_entry = rhashtable_walk_next(&iter)) != core::ptr::null_mut()) {
    ...
    let mut action_num: u32 = fl_act.action.num_entries;
    struct nfp_flower_priv *fl_priv = app.priv;
    struct flow_action_entry *action = core::ptr::null_mut();
...
// Delete qos associate data for this interface
    ...
    config.head.flags_opts |= cpu_to_be32(NFP_FL_QOS_PPS);
    nfp_ctrl_tx(app.ctrl, skb);
    nfp_flower_setup_meter_entry(app, core::ptr::null_mut(), NFP_METER_DEL, meter_id);
    return 0;
    }
    void
