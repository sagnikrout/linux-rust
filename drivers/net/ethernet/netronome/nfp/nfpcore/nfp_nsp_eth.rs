...
//! Source: drivers/net/ethernet/netronome/nfp/nfpcore/nfp_nsp_eth.c
#![no_std]
...
pub const NSP_ETH_NBI_PORT_COUNT: c_int = 24;
...
#[no_mangle]
unsafe extern "C" fn nfp_eth_rate2speed(rate: enum nfp_eth_rate) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nfp_eth_speed2rate(speed: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nfp_eth_copy_mac_reverse(dst: *mut u8, src: *const u8) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_eth_config_cleanup_end(nsp: *mut nfp_nsp) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_eth_config_commit_end(nsp: *mut nfp_nsp) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_eth_set_mod_enable(cpp: *mut nfp_cpp, idx: c_uint, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_eth_set_configured(cpp: *mut nfp_cpp, idx: c_uint, configed: bool) -> c_int {
...
// Check if we are already in requested state
    ...
    {
    union eth_table_entry *entries = nfp_nsp_config_entries(nsp);
    let mut idx: c_uint = nfp_nsp_config_idx(nsp);
    u64 reg;
...
#[no_mangle]
pub unsafe extern "C" fn nfp_eth_set_idmode(cpp: *mut nfp_cpp, idx: c_uint, state: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __nfp_eth_set_aneg(nsp: *mut nfp_nsp, mode: enum nfp_eth_aneg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __nfp_eth_set_fec(nsp: *mut nfp_nsp, mode: enum nfp_eth_fec) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __nfp_eth_set_txpause(nsp: *mut nfp_nsp, tx_pause: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __nfp_eth_set_rxpause(nsp: *mut nfp_nsp, rx_pause: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __nfp_eth_set_speed(nsp: *mut nfp_nsp, speed: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __nfp_eth_set_split(nsp: *mut nfp_nsp, lanes: c_uint) -> c_int {
