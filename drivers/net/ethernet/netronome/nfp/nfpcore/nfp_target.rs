...
//! Source: drivers/net/ethernet/netronome/nfp/nfpcore/nfp_target.c
#![no_std]
...
pub const P32: c_int = 1;
pub const P64: c_int = 2;
...
#[no_mangle]
pub unsafe extern "C" fn PUSHPULL(_arg: (_pull), _arg: (_push)) -> return {
    return PUSHPULL((_pull), (_push))
#[no_mangle]
unsafe extern "C" fn target_rw(cpp_id: u32, pp: c_int, start: c_int, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp6000_nbi_dma(cpp_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp6000_nbi_stats(cpp_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp6000_nbi_tm(cpp_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp6000_nbi_ppc(cpp_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp6000_nbi(cpp_id: u32, address: u64) -> c_int {
    static int nfp6000_nbi(u32 cpp_id, u64 address)
    {
    let mut rel_addr: u64 = address & 0x3fFFFF;
    if (rel_addr < (1 << 20))
...
//
#[no_mangle]
unsafe extern "C" fn nfp6000_mu_common(cpp_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp6000_mu_ctm(cpp_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp6000_mu_emu(cpp_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp6000_mu_imu(cpp_id: u32) -> c_int {
    static int nfp6000_mu_imu(u32 cpp_id)
    {
    return nfp6000_mu_common(cpp_id);
    }
#[no_mangle]
unsafe extern "C" fn nfp6000_mu(cpp_id: u32, address: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x8000000000ULL: address <) -> else {
    else if (address < 0x8000000000ULL)
    pp = nfp6000_mu_emu(cpp_id);
#[no_mangle]
pub unsafe extern "C" fn if(0x9800000000ULL: address <) -> else {
    else if (address < 0x9800000000ULL)
    pp = nfp6000_mu_ctm(cpp_id);
#[no_mangle]
pub unsafe extern "C" fn if(0x9C00000000ULL: address <) -> else {
    else if (address < 0x9C00000000ULL)
    pp = nfp6000_mu_emu(cpp_id);
#[no_mangle]
pub unsafe extern "C" fn if(0xA000000000ULL: address <) -> else {
...
#[no_mangle]
unsafe extern "C" fn nfp6000_ila(cpp_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp6000_pci(cpp_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp6000_crypto(cpp_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp6000_cap_xpb(cpp_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp6000_cls(cpp_id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_target_pushpull(cpp_id: u32, address: u64) -> c_int {
...
//
pub const _NIC_NFP6000_MU_LOCALITY_DIRECT: c_int = 2;
...
// addr |= ((u64)dest_island << 24) & GENMASK_ULL(29, 24);
    ...
    const u32 *imb_table)
    {
    let mut island: c_int = NFP_CPP_ID_ISLAND_of(cpp_island_id);
    let mut target: c_int = NFP_CPP_ID_TARGET_of(cpp_island_id);
    u32 imb;
    int err;
