...
//! Source: drivers/net/ethernet/netronome/nfp/crypto/tls.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nfp_net_crypto_set_op(nn: *mut nfp_net, opcode: u8, on: bool) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_tls_del_fw(nn: *mut nfp_net, fw_handle: *mut __be32) {
...
#[no_mangle]
unsafe extern "C" fn nfp_tls_1_2_dir_to_opcode(direction: enum tls_offload_ctx_dir) -> u8 {
...
// communicate frees skb on error
    ...
    nn_dp_warn(&nn.dp, "FW returned core::ptr::null_mut() handle\n");
    err = -EINVAL;
    goto err_fw_remove;
    }
...
#[no_mangle]
unsafe extern "C" fn nfp_net_tls_reset(nn: *mut nfp_net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_tls_init(nn: *mut nfp_net) -> c_int {
