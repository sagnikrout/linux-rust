...
//! Source: drivers/net/ethernet/netronome/nfp/nfp_netvf_main.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfp_net_vf {
    pub nn: *mut nfp_net,
    struct msix_entry irq_entries[NFP_NET_NON_Q_VECTORS +
    pub q_bar: *mut u8 __iomem,
    pub ddir: *mut dentry,
}
...
#[no_mangle]
unsafe extern "C" fn nfp_netvf_get_mac_addr(nn: *mut nfp_net) {
...
#[no_mangle]
unsafe extern "C" fn nfp_netvf_pci_remove(pdev: *mut pci_dev) {
