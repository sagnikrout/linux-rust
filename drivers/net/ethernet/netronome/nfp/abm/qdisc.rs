...
//! Source: drivers/net/ethernet/netronome/nfp/abm/qdisc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nfp_abm_qdisc_is_red(qdisc: *mut nfp_qdisc) -> bool {
    static bool nfp_abm_qdisc_is_red(struct nfp_qdisc *qdisc)
    {
    return qdisc.type == NFP_QDISC_RED || qdisc.type == NFP_QDISC_GRED;
    }
#[no_mangle]
unsafe extern "C" fn nfp_abm_qdisc_child_valid(qdisc: *mut nfp_qdisc, id: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __nfp_abm_stats_update(alink: *mut nfp_abm_link, time_now: u64) {
...
#[no_mangle]
unsafe extern "C" fn nfp_abm_stats_update(alink: *mut nfp_abm_link) {
...
//
    ...
    qdisc.children[i] = core::ptr::null_mut();
    }
    }
    static void
...
#[no_mangle]
pub unsafe extern "C" fn nfp_abm_qdisc_offload_update(alink: *mut nfp_abm_link) {
...
// Count refs held by MQ instances and clear pointers
    ...
    mq.children[i] = core::ptr::null_mut();
    mq_refs++;
    }
    }
...
// We don't get TC_SETUP_ROOT_QDISC w/ MQ when netdev is unregistered
    ...
    if (alink.root_qdisc == qdisc) {
    alink.root_qdisc = core::ptr::null_mut();
...
// If limit != 0 child gets reset
    ...
    qdisc.children[0] = core::ptr::null_mut();
    } else {
