...
//! Source: drivers/net/ethernet/netronome/nfp/abm/cls.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nfp_abm_update_band_map(alink: *mut nfp_abm_link) -> c_int {
...
// Qdisc offload status may change if has_prio changed
    ...
    __be16 proto, struct netlink_ext_ack *extack)
    {
    struct nfp_abm_u32_match *match = core::ptr::null_mut(), *iter;
    unsigned int tos_off;
    u8 mask, val;
    int err;
