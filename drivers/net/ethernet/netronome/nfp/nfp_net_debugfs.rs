...
//! Source: drivers/net/ethernet/netronome/nfp/nfp_net_debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nfp_rx_q_show(file: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __nfp_tx_q_show(file: *mut seq_file, data: *mut c_void, is_xdp: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_tx_q_show(file: *mut seq_file, data: *mut c_void) -> c_int {
    static int nfp_tx_q_show(struct seq_file *file, void *data)
    {
    return __nfp_tx_q_show(file, data, false);
    }
#[no_mangle]
unsafe extern "C" fn nfp_xdp_q_show(file: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_debugfs_vnic_add(nn: *mut nfp_net, ddir: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_debugfs_dir_clean(dir: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_debugfs_create() {
    void nfp_net_debugfs_create(void)
    {
    nfp_dir = debugfs_create_dir("nfp_net", core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn nfp_net_debugfs_destroy() {
    void nfp_net_debugfs_destroy(void)
    {
    debugfs_remove_recursive(nfp_dir);
    nfp_dir = core::ptr::null_mut();
    }
