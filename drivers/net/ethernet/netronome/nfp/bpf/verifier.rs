...
//! Source: drivers/net/ethernet/netronome/nfp/bpf/verifier.c
#![no_std]
...
// Copyright (C) 2016-2018 Netronome Systems, Inc.
    ...
    {
    let mut location: c_uint = UINT_MAX;
    int imm;
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_map_update_value_ok(env: *mut bpf_verifier_env) -> bool {
...
// Rest of the checks is only if we re-parse the same insn
    ...
    let mut func_id: u32 = meta.insn.imm;
    switch (func_id) {
    ...
    meta.func_id ? &meta.arg2 : core::ptr::null_mut()))
    return -EOPNOTSUPP;
    break;
    ...
    meta.func_id ? &meta.arg2 : core::ptr::null_mut()) ||
    !nfp_bpf_stack_arg_ok("map_update", env, reg3, core::ptr::null_mut()) ||
...
//
    ...
    if (reg1.type != SCALAR_VALUE /* core::ptr::null_mut() ptr */ &&
    ...
    !nfp_bpf_stack_arg_ok("event_output", env, reg1, core::ptr::null_mut()))
    return -EOPNOTSUPP;
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_get_stack_usage(nfp_prog: *mut nfp_prog) -> c_uint {
    ...
    let mut max_depth: c_uint = 0, depth = 0, frame = 0;
    ...
    let mut idx: c_ushort = meta.subprog_idx;
...
#[no_mangle]
pub unsafe extern "C" fn nfp_bpf_finalize(env: *mut bpf_verifier_env) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_bpf_opt_remove_insns(env: *mut bpf_verifier_env, off: u32, cnt: u32) -> c_int {
