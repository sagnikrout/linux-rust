...
//! Source: drivers/net/ethernet/netronome/nfp/bpf/cmsg.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn nfp_bpf_ctrl_free_map(bpf: *mut nfp_app_bpf, nfp_map: *mut nfp_bpf_map) {
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_ctrl_op_cache_invalidate(op: enum nfp_ccm_type) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_ctrl_op_cache_capable(op: enum nfp_ccm_type) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_ctrl_op_cache_fill(op: enum nfp_ccm_type) -> bool {
...
// cache_gen = nfp_map->cache_gen;
    ...
    nfp_map.cache = core::ptr::null_mut();
    exit_unlock:
...
// Copy outputs
    ...
    dev_kfree_skb_any(skb);
    err_cache_put:
    nfp_bpf_ctrl_op_cache_put(nfp_map, op, core::ptr::null_mut(), cache_gen);
    return err;
    }
    ...
    key, value, flags, core::ptr::null_mut(), core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn nfp_bpf_ctrl_del_entry(offmap: *mut bpf_offloaded_map, key: *mut c_void) -> c_int {
    int nfp_bpf_ctrl_del_entry(struct bpf_offloaded_map *offmap, void *key)
    {
    return nfp_bpf_ctrl_entry_op(offmap, NFP_CCM_TYPE_BPF_MAP_DELETE,
    key, core::ptr::null_mut(), 0, core::ptr::null_mut(), core::ptr::null_mut());
    }
    int nfp_bpf_ctrl_lookup_entry(struct bpf_offloaded_map *offmap,
    void *key, void *value)
    {
    return nfp_bpf_ctrl_entry_op(offmap, NFP_CCM_TYPE_BPF_MAP_LOOKUP,
    key, core::ptr::null_mut(), 0, core::ptr::null_mut(), value);
    }
    int nfp_bpf_ctrl_getfirst_entry(struct bpf_offloaded_map *offmap,
    void *next_key)
    {
    return nfp_bpf_ctrl_entry_op(offmap, NFP_CCM_TYPE_BPF_MAP_GETFIRST,
    core::ptr::null_mut(), core::ptr::null_mut(), 0, next_key, core::ptr::null_mut());
    }
    int nfp_bpf_ctrl_getnext_entry(struct bpf_offloaded_map *offmap,
    void *key, void *next_key)
    {
    return nfp_bpf_ctrl_entry_op(offmap, NFP_CCM_TYPE_BPF_MAP_GETNEXT,
    key, core::ptr::null_mut(), 0, next_key, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn nfp_bpf_ctrl_cmsg_min_mtu(bpf: *mut nfp_app_bpf) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_bpf_ctrl_cmsg_mtu(bpf: *mut nfp_app_bpf) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_bpf_ctrl_cmsg_cache_cnt(bpf: *mut nfp_app_bpf) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_bpf_ctrl_msg_rx(app: *mut nfp_app, skb: *mut sk_buff) {
