...
//! Source: drivers/net/ethernet/netronome/nfp/bpf/offload.c
#![no_std]
...
//
    ...
    nfp_prog.map_records[i] = core::ptr::null_mut();
    continue;
    }
    ...
    nfp_prog.map_records = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn nfp_prog_free(nfp_prog: *mut nfp_prog) {
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_verifier_prep(prog: *mut bpf_prog) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_translate(prog: *mut bpf_prog) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_destroy(prog: *mut bpf_prog) {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_map_bpf_byte_swap(nfp_map: *mut nfp_bpf_map, value: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_ndo_bpf(app: *mut nfp_app, nn: *mut nfp_net, bpf: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_bpf_stop(nn: *mut nfp_net) -> c_int {
