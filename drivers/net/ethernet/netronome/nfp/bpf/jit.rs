...
//! Source: drivers/net/ethernet/netronome/nfp/bpf/jit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nfp_prog_push(nfp_prog: *mut nfp_prog, insn: u64) {
...
#[no_mangle]
unsafe extern "C" fn nfp_prog_current_offset(nfp_prog: *mut nfp_prog) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn emit_rtn(nfp_prog: *mut nfp_prog, base: swreg, defer: u8) {
...
#[no_mangle]
unsafe extern "C" fn emit_csr_wr(nfp_prog: *mut nfp_prog, src: swreg, addr: u16) {
...
#[no_mangle]
unsafe extern "C" fn __emit_csr_rd(nfp_prog: *mut nfp_prog, addr: u16) {
    static void __emit_csr_rd(struct nfp_prog *nfp_prog, u16 addr)
    {
    __emit_lcsr(nfp_prog, 0, 0, false, addr, false, false);
    }
#[no_mangle]
unsafe extern "C" fn emit_nop(nfp_prog: *mut nfp_prog) {
...
// --- Wrappers ---
#[no_mangle]
unsafe extern "C" fn pack_immed(imm: u32, val: *mut u16, shift: *mut enum immed_shift) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wrp_immed(nfp_prog: *mut nfp_prog, dst: swreg, imm: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn ur_load_imm_any(nfp_prog: *mut nfp_prog, imm: u32, tmp_reg: swreg) -> swreg {
...
//
#[no_mangle]
unsafe extern "C" fn re_load_imm_any(nfp_prog: *mut nfp_prog, imm: u32, tmp_reg: swreg) -> swreg {
...
#[no_mangle]
unsafe extern "C" fn wrp_nops(nfp_prog: *mut nfp_prog, count: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn wrp_mov(nfp_prog: *mut nfp_prog, dst: swreg, src: swreg) {
    static void wrp_mov(struct nfp_prog *nfp_prog, swreg dst, swreg src)
    {
    emit_alu(nfp_prog, dst, reg_none(), ALU_OP_NONE, src);
    }
#[no_mangle]
unsafe extern "C" fn wrp_reg_mov(nfp_prog: *mut nfp_prog, dst: u16, src: u16) {
...
//
    ...
    u8 offset)
    {
    let mut sc: enum shf_sc = offset ? SHF_SC_R_SHF : SHF_SC_NONE;
    let mut mask: u8 = (1 << field_len) - 1;
...
//
    ...
    {
    let mut sc: enum shf_sc = offset ? SHF_SC_L_SHF : SHF_SC_NONE;
    let mut mask: u8 = ((1 << field_len) - 1) << offset;
...
#[no_mangle]
unsafe extern "C" fn nfp_cpp_memcpy(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int nfp_cpp_memcpy(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    let mut descending_seq: bool = meta.ldst_gather_len < 0;
    let mut len: i16 = abs(meta.ldst_gather_len);
    swreg src_base, off;
    bool src_40bit_addr;
    unsigned int i;
    u8 xfer_num;
...
//
    ...
    xfer_num = 0;
#[no_mangle]
pub unsafe extern "C" fn if(BPF_DW: BPF_SIZE(meta->insn.code) !=) -> else {
...
// Load data
    ...
    bool needs_inc)
    {
    let mut should_inc: bool = needs_inc && new_gpr && !last;
    u32 idx, src_byte;
    enum shf_sc sc;
    swreg reg;
    int shf;
...
//
    ...
    {
    let mut off: i32 = nfp_prog.stack_frame_depth + meta.insn.off + ptr_off;
    let mut first: bool = true, narrow_ld, last;
    let mut needs_inc: bool = false;
    swreg stack_off_reg;
    let mut prev_gpr: u8 = 255;
    let mut gpr_byte: u32 = 0;
    let mut lm3: bool = true;
    int ret;
...
//
    ...
    enum alu_op alu_op)
    {
    let mut dst: u8 = meta.insn.dst_reg * 2, src = meta.insn.src_reg * 2;
...
#[no_mangle]
unsafe extern "C" fn cmp_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmp_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wrp_end32(nfp_prog: *mut nfp_prog, reg_in: swreg, gpr_out: u8) {
...
#[no_mangle]
unsafe extern "C" fn wrp_div_imm(nfp_prog: *mut nfp_prog, dst: u8, imm: u64) -> c_int {
    static int wrp_div_imm(struct nfp_prog *nfp_prog, u8 dst, u64 imm)
    {
    let mut dst_both: swreg = reg_both(dst), dst_a = reg_a(dst), dst_b = reg_a(dst);
...
//
    if (imm > 1U << 31) {
    let mut tmp_b: swreg = ur_load_imm_any(nfp_prog, imm, imm_b(nfp_prog));
...
#[no_mangle]
unsafe extern "C" fn adjust_head(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int adjust_head(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    let mut tmp: swreg = imm_a(nfp_prog), tmp_len = imm_b(nfp_prog);
...
#[no_mangle]
unsafe extern "C" fn adjust_tail(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
// --- Callbacks ---
#[no_mangle]
unsafe extern "C" fn mov_reg64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int mov_reg64(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    const struct bpf_insn *insn = &meta.insn;
    let mut dst: u8 = insn.dst_reg * 2;
    let mut src: u8 = insn.src_reg * 2;
...
#[no_mangle]
unsafe extern "C" fn mov_imm64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xor_reg64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int xor_reg64(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_alu64_reg(nfp_prog, meta, ALU_OP_XOR);
    }
#[no_mangle]
unsafe extern "C" fn xor_imm64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn and_reg64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int and_reg64(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_alu64_reg(nfp_prog, meta, ALU_OP_AND);
    }
#[no_mangle]
unsafe extern "C" fn and_imm64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn or_reg64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int or_reg64(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_alu64_reg(nfp_prog, meta, ALU_OP_OR);
    }
#[no_mangle]
unsafe extern "C" fn or_imm64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_reg64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_imm64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sub_reg64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sub_imm64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mul_reg64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int mul_reg64(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_mul(nfp_prog, meta, true, true);
    }
#[no_mangle]
unsafe extern "C" fn mul_imm64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int mul_imm64(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_mul(nfp_prog, meta, true, false);
    }
#[no_mangle]
unsafe extern "C" fn div_imm64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn div_reg64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn neg_reg64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __shl_imm64(nfp_prog: *mut nfp_prog, dst: u8, shift_amt: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn shl_imm64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn shl_reg64_lt32_high(nfp_prog: *mut nfp_prog, dst: u8, src: u8) {
...
#[no_mangle]
unsafe extern "C" fn shl_reg64_lt32_low(nfp_prog: *mut nfp_prog, dst: u8, src: u8) {
...
#[no_mangle]
unsafe extern "C" fn shl_reg64_lt32(nfp_prog: *mut nfp_prog, dst: u8, src: u8) {
...
#[no_mangle]
unsafe extern "C" fn shl_reg64_ge32(nfp_prog: *mut nfp_prog, dst: u8, src: u8) {
...
#[no_mangle]
unsafe extern "C" fn shl_reg64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __shr_imm64(nfp_prog: *mut nfp_prog, dst: u8, shift_amt: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn shr_imm64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn shr_reg64_lt32_high(nfp_prog: *mut nfp_prog, dst: u8, src: u8) {
...
#[no_mangle]
unsafe extern "C" fn shr_reg64_lt32_low(nfp_prog: *mut nfp_prog, dst: u8, src: u8) {
...
#[no_mangle]
unsafe extern "C" fn shr_reg64_lt32(nfp_prog: *mut nfp_prog, dst: u8, src: u8) {
...
#[no_mangle]
unsafe extern "C" fn shr_reg64_ge32(nfp_prog: *mut nfp_prog, dst: u8, src: u8) {
...
#[no_mangle]
unsafe extern "C" fn shr_reg64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __ashr_imm64(nfp_prog: *mut nfp_prog, dst: u8, shift_amt: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ashr_imm64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ashr_reg64_lt32_high(nfp_prog: *mut nfp_prog, dst: u8, src: u8) {
...
#[no_mangle]
unsafe extern "C" fn ashr_reg64_lt32_low(nfp_prog: *mut nfp_prog, dst: u8, src: u8) {
...
#[no_mangle]
unsafe extern "C" fn ashr_reg64_lt32(nfp_prog: *mut nfp_prog, dst: u8, src: u8) {
...
#[no_mangle]
unsafe extern "C" fn ashr_reg64_ge32(nfp_prog: *mut nfp_prog, dst: u8, src: u8) {
...
#[no_mangle]
unsafe extern "C" fn ashr_reg64(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mov_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mov_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xor_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int xor_reg(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_alu32_reg(nfp_prog, meta, ALU_OP_XOR);
    }
#[no_mangle]
unsafe extern "C" fn xor_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int xor_imm(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_alu32_imm(nfp_prog, meta, ALU_OP_XOR);
    }
#[no_mangle]
unsafe extern "C" fn and_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int and_reg(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_alu32_reg(nfp_prog, meta, ALU_OP_AND);
    }
#[no_mangle]
unsafe extern "C" fn and_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int and_imm(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_alu32_imm(nfp_prog, meta, ALU_OP_AND);
    }
#[no_mangle]
unsafe extern "C" fn or_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int or_reg(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_alu32_reg(nfp_prog, meta, ALU_OP_OR);
    }
#[no_mangle]
unsafe extern "C" fn or_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int or_imm(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_alu32_imm(nfp_prog, meta, ALU_OP_OR);
    }
#[no_mangle]
unsafe extern "C" fn add_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int add_reg(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_alu32_reg(nfp_prog, meta, ALU_OP_ADD);
    }
#[no_mangle]
unsafe extern "C" fn add_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int add_imm(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_alu32_imm(nfp_prog, meta, ALU_OP_ADD);
    }
#[no_mangle]
unsafe extern "C" fn sub_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int sub_reg(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_alu32_reg(nfp_prog, meta, ALU_OP_SUB);
    }
#[no_mangle]
unsafe extern "C" fn sub_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int sub_imm(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_alu32_imm(nfp_prog, meta, ALU_OP_SUB);
    }
#[no_mangle]
unsafe extern "C" fn mul_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int mul_reg(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_mul(nfp_prog, meta, false, true);
    }
#[no_mangle]
unsafe extern "C" fn mul_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int mul_imm(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_mul(nfp_prog, meta, false, false);
    }
#[no_mangle]
unsafe extern "C" fn div_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int div_reg(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return div_reg64(nfp_prog, meta);
    }
#[no_mangle]
unsafe extern "C" fn div_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int div_imm(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return div_imm64(nfp_prog, meta);
    }
#[no_mangle]
unsafe extern "C" fn neg_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int neg_reg(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    let mut dst: u8 = meta.insn.dst_reg * 2;
...
#[no_mangle]
unsafe extern "C" fn ashr_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ashr_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn shr_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn shr_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn shl_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn shl_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn end_reg32(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int end_reg32(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    const struct bpf_insn *insn = &meta.insn;
    let mut gpr: u8 = insn.dst_reg * 2;
    switch (insn.imm) {
    case 16:
...
#[no_mangle]
unsafe extern "C" fn imm_ld8_part2(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imm_ld8(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn data_ld1(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int data_ld1(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return construct_data_ld(nfp_prog, meta, meta.insn.imm, 1);
    }
#[no_mangle]
unsafe extern "C" fn data_ld2(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int data_ld2(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return construct_data_ld(nfp_prog, meta, meta.insn.imm, 2);
    }
#[no_mangle]
unsafe extern "C" fn data_ld4(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int data_ld4(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return construct_data_ld(nfp_prog, meta, meta.insn.imm, 4);
    }
#[no_mangle]
unsafe extern "C" fn data_ind_ld1(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn data_ind_ld2(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn data_ind_ld4(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    ...
    u8 size)
    {
    let mut dst: swreg = reg_both(meta.insn.dst_reg * 2);
    ...
    {
    let mut range_start: i16 = meta.pkt_cache.range_start;
    let mut range_end: i16 = meta.pkt_cache.range_end;
    swreg src_base, off;
    u8 xfer_num, len;
    bool indir;
...
// Cache memory into transfer-in registers.
    ...
    {
    let mut range_start: i16 = meta.pkt_cache.range_start;
    let mut insn_off: i16 = meta.insn.off - range_start;
    swreg dst_lo, dst_hi, src_lo, src_mid;
    let mut dst_gpr: u8 = meta.insn.dst_reg * 2;
    let mut len_lo: u8 = size, len_mid = 0;
    let mut idx: u8 = insn_off / REG_WIDTH;
    let mut off: u8 = insn_off % REG_WIDTH;
...
// Calculate the part in the third register.
    ...
    let mut src_hi: swreg = reg_xfer(idx + 2);
    ...
    let mut src_hi: swreg = reg_xfer(idx + 1);
    wrp_mov(nfp_prog, dst_lo, src_lo);
    ...
    {
    let mut off: u8 = meta.insn.off - meta.pkt_cache.range_start;
...
#[no_mangle]
unsafe extern "C" fn mem_ldx1(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int mem_ldx1(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return mem_ldx(nfp_prog, meta, 1);
    }
#[no_mangle]
unsafe extern "C" fn mem_ldx2(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int mem_ldx2(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return mem_ldx(nfp_prog, meta, 2);
    }
#[no_mangle]
unsafe extern "C" fn mem_ldx4(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int mem_ldx4(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return mem_ldx(nfp_prog, meta, 4);
    }
#[no_mangle]
unsafe extern "C" fn mem_ldx8(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mem_st1(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int mem_st1(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return mem_st(nfp_prog, meta, 1);
    }
#[no_mangle]
unsafe extern "C" fn mem_st2(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int mem_st2(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return mem_st(nfp_prog, meta, 2);
    }
#[no_mangle]
unsafe extern "C" fn mem_st4(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int mem_st4(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return mem_st(nfp_prog, meta, 4);
    }
#[no_mangle]
unsafe extern "C" fn mem_st8(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mem_stx_xdp(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mem_stx1(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int mem_stx1(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return mem_stx(nfp_prog, meta, 1);
    }
#[no_mangle]
unsafe extern "C" fn mem_stx2(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int mem_stx2(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return mem_stx(nfp_prog, meta, 2);
    }
#[no_mangle]
unsafe extern "C" fn mem_stx4(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mem_stx8(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    ...
    {
    let mut dst_gpr: u8 = meta.insn.dst_reg * 2;
    let mut src_gpr: u8 = meta.insn.src_reg * 2;
...
// Generate the branch for choosing add_imm vs add
    if (meta.xadd_maybe_16bit && meta.xadd_over_16bit) {
    let mut max_imm: swreg = imm_a(nfp_prog);
...
// Generate the add_imm if 16 bits are possible
    if (meta.xadd_maybe_16bit) {
    let mut prev_alu: swreg = imm_a(nfp_prog);
...
#[no_mangle]
unsafe extern "C" fn mem_atomic4(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mem_atomic8(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jump(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jeq_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jeq32_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jset_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int jset_imm(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    const struct bpf_insn *insn = &meta.insn;
    u64 imm = insn.imm; /* sign extend */
    let mut dst_gpr: u8 = insn.dst_reg * 2;
    swreg tmp_reg;
    tmp_reg = ur_load_imm_any(nfp_prog, imm & ~0U, imm_b(nfp_prog));
    emit_alu(nfp_prog, imm_b(nfp_prog),
...
#[no_mangle]
unsafe extern "C" fn jne_imm(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int jne_imm(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    const struct bpf_insn *insn = &meta.insn;
    u64 imm = insn.imm; /* sign extend */
    let mut is_jmp32: bool = is_mbpf_jmp32(meta);
    swreg tmp_reg;
    if (!imm) {
    if (is_jmp32)
...
#[no_mangle]
unsafe extern "C" fn jeq_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jset_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
    static int jset_reg(struct nfp_prog *nfp_prog, struct nfp_insn_meta *meta)
    {
    return wrp_test_reg(nfp_prog, meta, ALU_OP_AND, BR_BNE);
    }
#[no_mangle]
unsafe extern "C" fn jne_reg(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn helper_call(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn call(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_is_main_function(meta: *mut nfp_insn_meta) -> bool {
    static bool nfp_is_main_function(struct nfp_insn_meta *meta)
    {
    return meta.subprog_idx == 0;
    }
#[no_mangle]
unsafe extern "C" fn goto_out(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jmp_exit(nfp_prog: *mut nfp_prog, meta: *mut nfp_insn_meta) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_fixup_branches(nfp_prog: *mut nfp_prog) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_intro(nfp_prog: *mut nfp_prog) {
...
// Save return address into the stack.
    ...
    {
    let mut depth: c_uint = nfp_prog.subprog[meta.subprog_idx].stack_depth;
    nfp_prog.stack_frame_depth = round_up(depth, 4);
    nfp_subprog_prologue(nfp_prog, meta);
    }
#[no_mangle]
pub unsafe extern "C" fn nfp_is_subprog_start(meta: *mut nfp_insn_meta) -> bool {
    bool nfp_is_subprog_start(struct nfp_insn_meta *meta)
    {
    return meta.flags & FLAG_INSN_IS_SUBPROG_START;
    }
#[no_mangle]
unsafe extern "C" fn nfp_outro_tc_da(nfp_prog: *mut nfp_prog) {
...
#[no_mangle]
unsafe extern "C" fn nfp_outro_xdp(nfp_prog: *mut nfp_prog) {
...
#[no_mangle]
unsafe extern "C" fn nfp_prog_needs_callee_reg_save(nfp_prog: *mut nfp_prog) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfp_push_callee_registers(nfp_prog: *mut nfp_prog) {
...
//
    ...
    let mut adj: u8 = (reg - BPF_REG_0) * 2;
    let mut idx: u8 = (reg - BPF_REG_6) * 2;
...
#[no_mangle]
unsafe extern "C" fn nfp_pop_callee_registers(nfp_prog: *mut nfp_prog) {
...
#[no_mangle]
unsafe extern "C" fn nfp_outro(nfp_prog: *mut nfp_prog) {
...
#[no_mangle]
unsafe extern "C" fn nfp_translate(nfp_prog: *mut nfp_prog) -> c_int {
    ...
    list_for_each_entry(meta, &nfp_prog.insns, l) {
    let mut cb: instr_cb_t = instr_cb[meta.insn.code];
...
// --- Optimizations ---
#[no_mangle]
unsafe extern "C" fn nfp_bpf_opt_reg_init(nfp_prog: *mut nfp_prog) {
    static void nfp_bpf_opt_reg_init(struct nfp_prog *nfp_prog)
    {
    struct nfp_insn_meta *meta;
    list_for_each_entry(meta, &nfp_prog.insns, l) {
    let mut insn: bpf_insn = meta.insn;
...
//
#[no_mangle]
unsafe extern "C" fn nfp_bpf_opt_neg_add_sub(nfp_prog: *mut nfp_prog) {
...
#[no_mangle]
pub unsafe extern "C" fn if(BPF_SUB: BPF_OP(insn.code) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_opt_ld_mask(nfp_prog: *mut nfp_prog) {
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_opt_ld_shift(nfp_prog: *mut nfp_prog) {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_bpf_opt_ldst_gather(nfp_prog: *mut nfp_prog) {
    static void nfp_bpf_opt_ldst_gather(struct nfp_prog *nfp_prog)
    {
    struct nfp_insn_meta *head_ld_meta = core::ptr::null_mut();
    struct nfp_insn_meta *head_st_meta = core::ptr::null_mut();
    struct nfp_insn_meta *meta1, *meta2;
    struct bpf_insn *prev_ld = core::ptr::null_mut();
    struct bpf_insn *prev_st = core::ptr::null_mut();
    let mut count: u8 = 0;
    nfp_for_each_insn_walk2(nfp_prog, meta1, meta2) {
...
//
    ...
    continue;
    if (count > 1) {
    let mut prev_ld_off: i16 = prev_ld.off;
    let mut prev_st_off: i16 = prev_st.off;
    let mut head_ld_off: i16 = head_ld_meta.insn.off;
...
//
    ...
    head_ld_meta = core::ptr::null_mut();
    head_st_meta = core::ptr::null_mut();
    prev_ld = core::ptr::null_mut();
    prev_st = core::ptr::null_mut();
    count = 0;
    }
    continue;
    }
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_opt_pkt_cache(nfp_prog: *mut nfp_prog) {
    static void nfp_bpf_opt_pkt_cache(struct nfp_prog *nfp_prog)
    {
    struct nfp_insn_meta *meta, *range_node = core::ptr::null_mut();
    let mut range_start: i16 = 0, range_end = 0;
    let mut cache_avail: bool = false;
    struct bpf_insn *insn;
    let mut range_ptr_off: i32 = 0;
    let mut range_ptr_id: u32 = 0;
    list_for_each_entry(meta, &nfp_prog.insns, l) {
...
//
    ...
    let mut new_start: i16 = range_start;
    s16 end, off = insn.off;
    let mut new_end: i16 = range_end;
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_optimize(nfp_prog: *mut nfp_prog) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_replace_map_ptrs(nfp_prog: *mut nfp_prog) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_ustore_calc(prog: *mut u64, len: c_uint) -> c_int {
    static int nfp_bpf_ustore_calc(u64 *prog, unsigned int len)
    {
    __le64 *ustore = ( __le64 *)prog;
    int i;
    for (i = 0; i < len; i++) {
    int err;
...
#[no_mangle]
unsafe extern "C" fn nfp_bpf_prog_trim(nfp_prog: *mut nfp_prog) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_bpf_jit(nfp_prog: *mut nfp_prog) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_bpf_jit_prepare(nfp_prog: *mut nfp_prog) {
...
// Another pass to record jump information.
    ...
    let mut code: u64 = meta.insn.code;
...
#[no_mangle]
pub unsafe extern "C" fn nfp_bpf_supported_opcode(code: u8) -> bool {
