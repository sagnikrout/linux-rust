...
//! Source: drivers/net/ethernet/netronome/nfp/nfp_devlink.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nfp_devlink_eswitch_mode_get(devlink: *mut devlink, mode: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_devlink_port_register(app: *mut nfp_app, port: *mut nfp_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_devlink_port_unregister(port: *mut nfp_port) {
