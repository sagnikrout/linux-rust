...
//! Source: drivers/net/ethernet/netronome/nfp/nfp_net_common.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn nfp_qcp_queue_offset(dev_info: *const nfp_dev_info, queue: u16) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_reconfig_start(nn: *mut nfp_net, update: u32) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_reconfig_start_async(nn: *mut nfp_net, update: u32) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_reconfig_check_done(nn: *mut nfp_net, last_check: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __nfp_net_reconfig_wait(nn: *mut nfp_net, deadline: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_reconfig_wait(nn: *mut nfp_net, deadline: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_reconfig_timer(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_reconfig_post(nn: *mut nfp_net, update: u32) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_reconfig_sync_enter(nn: *mut nfp_net) {
    static void nfp_net_reconfig_sync_enter(struct nfp_net *nn)
    {
    let mut cancelled_timer: bool = false;
...
#[no_mangle]
unsafe extern "C" fn nfp_net_reconfig_wait_posted(nn: *mut nfp_net) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __nfp_net_reconfig(nn: *mut nfp_net, update: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_reconfig(nn: *mut nfp_net, update: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_mbox_lock(nn: *mut nfp_net, data_size: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_net_mbox_reconfig(nn: *mut nfp_net, mbox_cmd: u32) -> c_int {
    int nfp_net_mbox_reconfig(struct nfp_net *nn, u32 mbox_cmd)
    {
    let mut mbox: u32 = nn.tlv_caps.mbox_off;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_mbox_reconfig_post(nn: *mut nfp_net, mbox_cmd: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_mbox_reconfig_wait_posted(nn: *mut nfp_net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_mbox_reconfig_and_unlock(nn: *mut nfp_net, mbox_cmd: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_net_irqs_disable(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_irq_rxtx(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nfp_ctrl_irq_rxtx(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_read_link_status(nn: *mut nfp_net) {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_irq_lsc(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_irq_exn(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_tls_tx_undo(skb: *mut sk_buff, tls_handle: u64) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_calc_fl_bufsz(dp: *mut nfp_net_dp) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_calc_fl_bufsz_xsk(dp: *mut nfp_net_dp) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_vecs_init(nn: *mut nfp_net) {
    static void nfp_net_vecs_init(struct nfp_net *nn)
    {
    let mut numa_node: c_int = dev_to_node(&nn.pdev.dev);
    ...
    {
    r_vec.rx_ring = idx < dp.num_rx_rings ? &dp.rx_rings[idx] : core::ptr::null_mut();
    r_vec.tx_ring =
    idx < dp.num_stack_tx_rings ? &dp.tx_rings[idx] : core::ptr::null_mut();
    r_vec.xdp_ring = idx < dp.num_tx_rings - dp.num_stack_tx_rings ?
    &dp.tx_rings[dp.num_stack_tx_rings + idx] : core::ptr::null_mut();
    if (nfp_net_has_xsk_pool_slow(dp, idx) || r_vec.xsk_pool) {
    r_vec.xsk_pool = dp.xdp_prog ? dp.xsk_pools[idx] : core::ptr::null_mut();
    if (r_vec.xsk_pool)
    ...
    {
    irq_update_affinity_hint(r_vec.irq_vector, core::ptr::null_mut());
    nfp_net_napi_del(&nn.dp, r_vec);
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_net_rss_write_itbl(nn: *mut nfp_net) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_net_rss_write_key(nn: *mut nfp_net) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_net_coalesce_write_cfg(nn: *mut nfp_net) {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_write_mac_addr(nn: *mut nfp_net, addr: *const u8) {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_clear_config_and_disable(nn: *mut nfp_net) {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_set_config_and_enable(nn: *mut nfp_net) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_close_stack(nn: *mut nfp_net) {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_close_free_all(nn: *mut nfp_net) {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_netdev_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_ctrl_close(nn: *mut nfp_net) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_rx_dim_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_tx_dim_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_open_stack(nn: *mut nfp_net) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_open_alloc_all(nn: *mut nfp_net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_netdev_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_ctrl_open(nn: *mut nfp_net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_mbox_amsg_work(work: *mut work_struct) {
    ...
    let mut err: c_int = entry.cfg(nn, entry);
    if (err)
...
#[no_mangle]
unsafe extern "C" fn nfp_net_mc_cfg(nn: *mut nfp_net, entry: *mut nfp_mbox_amsg_entry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_mc_sync(netdev: *mut net_device, addr: *const c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_mc_unsync(netdev: *mut net_device, addr: *const c_uchar) -> c_int {
    static int nfp_net_mc_unsync(struct net_device *netdev, const unsigned char *addr)
    {
    struct nfp_net *nn = netdev_priv(netdev);
...
#[no_mangle]
unsafe extern "C" fn nfp_net_set_rx_mode(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_rss_init_itbl(nn: *mut nfp_net) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_dp_swap(nn: *mut nfp_net, dp: *mut nfp_net_dp) {
    static void nfp_net_dp_swap(struct nfp_net *nn, struct nfp_net_dp *dp)
    {
    let mut new_dp: nfp_net_dp = *dp;
// dp = nn->dp;
    nn.dp = new_dp;
...
#[no_mangle]
unsafe extern "C" fn nfp_net_dp_swap_enable(nn: *mut nfp_net, dp: *mut nfp_net_dp) -> c_int {
...
// Clear things which need to be recomputed
    new.fl_bufsz = 0;
    new.tx_rings = core::ptr::null_mut();
    new.rx_rings = core::ptr::null_mut();
    new.num_r_vecs = 0;
    new.num_stack_tx_rings = 0;
    new.txrwb = core::ptr::null_mut();
    new.txrwb_dma = 0;
    return new;
    }
#[no_mangle]
unsafe extern "C" fn nfp_net_free_dp(dp: *mut nfp_net_dp) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
    ...
    return -ENOMEM;
    dp.mtu = new_mtu;
    return nfp_net_ring_reconfig(nn, dp, core::ptr::null_mut());
    }
    static int
    nfp_net_vlan_rx_add_vid(struct net_device *netdev, __be16 proto, u16 vid)
    {
    let mut cmd: u32 = NFP_NET_CFG_MBOX_CMD_CTAG_FILTER_ADD;
    struct nfp_net *nn = netdev_priv(netdev);
    int err;
...
//
    ...
    {
    let mut cmd: u32 = NFP_NET_CFG_MBOX_CMD_CTAG_FILTER_KILL;
    struct nfp_net *nn = netdev_priv(netdev);
    int err;
// Priority tagged packets with vlan id 0 are processed by the
// NFP as untagged packets
...
#[no_mangle]
pub unsafe extern "C" fn if(FLOW_RSS): !(entry->flow_type &) -> else {
    else if (!(entry.flow_type & FLOW_RSS))
    action = FIELD_PREP(NFP_FS_QUEUE_ID, entry.action) | NFP_FS_ACT_Q;
    nn_writel(nn, addr, action);
    }
#[no_mangle]
pub unsafe extern "C" fn nfp_net_fs_add_hw(nn: *mut nfp_net, entry: *mut nfp_fs_entry) -> c_int {
    int nfp_net_fs_add_hw(struct nfp_net *nn, struct nfp_fs_entry *entry)
    {
    let mut addr: u32 = nn.tlv_caps.mbox_off + NFP_NET_CFG_MBOX_SIMPLE_VAL;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn nfp_net_fs_del_hw(nn: *mut nfp_net, entry: *mut nfp_fs_entry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_fs_clean(nn: *mut nfp_net) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_xdp_setup_drv(nn: *mut nfp_net, bpf: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_xdp_setup_hw(nn: *mut nfp_net, bpf: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_xdp(netdev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_set_mac_address(netdev: *mut net_device, addr: *mut c_void) -> c_int {
    ...
    nlflags, filter_mask, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(BRIDGE_MODE_VEB: mode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn nfp_udp_tunnel_sync(netdev: *mut net_device, table: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_net_info(nn: *mut nfp_net) {
...
//
    ...
    {
    let mut dma_mask: u64 = dma_get_mask(&pdev.dev);
    struct nfp_net *nn;
    int err;
    if (needs_netdev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_net_free(nn: *mut nfp_net) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_net_rss_key_sz(nn: *mut nfp_net) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_rss_init(nn: *mut nfp_net) {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_net_irqmod_init(nn: *mut nfp_net) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_netdev_init(nn: *mut nfp_net) {
...
#[no_mangle]
unsafe extern "C" fn nfp_net_read_caps(nn: *mut nfp_net) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_net_init(nn: *mut nfp_net) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_net_clean(nn: *mut nfp_net) {
