...
//! Source: drivers/net/ethernet/netronome/nfp/nfp_shared_buf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nfp_shared_buf_pool_unit(pf: *mut nfp_pf, sb: c_uint) -> u32 {
    static u32 nfp_shared_buf_pool_unit(struct nfp_pf *pf, unsigned int sb)
    {
    let mut sb_id: __le32 = cpu_to_le32(sb);
    unsigned int i;
...
#[no_mangle]
pub unsafe extern "C" fn nfp_shared_buf_register(pf: *mut nfp_pf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_shared_buf_unregister(pf: *mut nfp_pf) {
