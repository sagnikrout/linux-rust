...
//! Source: drivers/net/ethernet/netronome/nfp/nfd3/dp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nfp_nfd3_tx_ring_should_wake(tx_ring: *mut nfp_net_tx_ring) -> c_int {
    static int nfp_nfd3_tx_ring_should_wake(struct nfp_net_tx_ring *tx_ring)
    {
    return !nfp_net_tx_full(tx_ring, MAX_SKB_FRAGS * 4);
    }
#[no_mangle]
unsafe extern "C" fn nfp_nfd3_tx_ring_should_stop(tx_ring: *mut nfp_net_tx_ring) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_nfd3_tx(skb: *mut sk_buff, netdev: *mut net_device) -> netdev_tx_t {
...
// all descs must match except for in addr, length and eop
    ...
    tx_ring.txbufs[wr_idx].skb = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_nfd3_tx_complete(tx_ring: *mut nfp_net_tx_ring, budget: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nfp_nfd3_xdp_complete(tx_ring: *mut nfp_net_tx_ring) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_nfd3_rx_csum_has_errors(flags: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_nfd3_rx(rx_ring: *mut nfp_net_rx_ring, budget: c_int) -> c_int {
...
// Stats update
    ...
    meta_len);
    nfp_nfd3_rx_drop(dp, r_vec, rx_ring, rxbuf, core::ptr::null_mut());
    continue;
    }
    ...
    nfp_nfd3_rx_drop(dp, r_vec, rx_ring, core::ptr::null_mut(), skb);
    continue;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn nfp_nfd3_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
//
    ...
    {
    let mut real_len: c_uint = skb.len, meta_len = 0;
    struct nfp_net_tx_ring *tx_ring;
    struct nfp_nfd3_tx_buf *txbuf;
    struct nfp_nfd3_tx_desc *txd;
    struct nfp_net_dp *dp;
...
#[no_mangle]
pub unsafe extern "C" fn nfp_nfd3_ctrl_poll(t: *mut tasklet_struct) {
