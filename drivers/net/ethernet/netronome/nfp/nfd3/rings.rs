...
//! Source: drivers/net/ethernet/netronome/nfp/nfd3/rings.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nfp_nfd3_xsk_tx_bufs_free(tx_ring: *mut nfp_net_tx_ring) {
...
//
#[no_mangle]
unsafe extern "C" fn nfp_nfd3_tx_ring_free(tx_ring: *mut nfp_net_tx_ring) {
    ...
    tx_ring.cnt = 0;
    tx_ring.txbufs = core::ptr::null_mut();
    tx_ring.txds = core::ptr::null_mut();
    tx_ring.dma = 0;
    tx_ring.size = 0;
    }
//
...
//
    ...
    let mut txd_cnt: u32 = tx_ring.cnt;
    int i;
    for (i = 0; i < txd_cnt; i++) {
    struct xdp_buff *xdp;
    struct sk_buff *skb;
