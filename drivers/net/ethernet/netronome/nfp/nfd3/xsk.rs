...
//! Source: drivers/net/ethernet/netronome/nfp/nfd3/xsk.c
#![no_std]
...
// Build TX descriptor
    ...
    netdev = nfp_app_dev_get(nn.app, meta.portid, core::ptr::null_mut());
    if (unlikely(!netdev)) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_nfd3_xsk_tx_free(txbuf: *mut nfp_nfd3_tx_buf) {
    void nfp_nfd3_xsk_tx_free(struct nfp_nfd3_tx_buf *txbuf)
    {
    xsk_buff_free(txbuf.xdp);
    txbuf.dma_addr = 0;
    txbuf.xdp = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn nfp_nfd3_xsk_complete(tx_ring: *mut nfp_net_tx_ring) -> bool {
    static bool nfp_nfd3_xsk_complete(struct nfp_net_tx_ring *tx_ring)
    {
    struct nfp_net_r_vector *r_vec = tx_ring.r_vec;
    let mut done_pkts: u32 = 0, done_bytes = 0, reused = 0;
    bool done_all;
    int idx, todo;
    u32 qcp_rd_p;
...
#[no_mangle]
unsafe extern "C" fn nfp_nfd3_xsk_tx(tx_ring: *mut nfp_net_tx_ring) {
...
#[no_mangle]
pub unsafe extern "C" fn nfp_nfd3_xsk_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
