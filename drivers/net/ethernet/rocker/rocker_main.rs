...
//! Source: drivers/net/ethernet/rocker/rocker_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rocker_wait_reset(wait: *mut rocker_wait) {
...
#[no_mangle]
unsafe extern "C" fn rocker_wait_init(wait: *mut rocker_wait) {
...
#[no_mangle]
unsafe extern "C" fn rocker_wait_destroy(wait: *mut rocker_wait) {
...
#[no_mangle]
unsafe extern "C" fn rocker_wait_wake_up(wait: *mut rocker_wait) {
...
#[no_mangle]
unsafe extern "C" fn rocker_msix_vector(rocker: *const rocker, vector: c_uint) -> u32 {
    static u32 rocker_msix_vector(const struct rocker *rocker, unsigned int vector)
    {
    return rocker.msix_entries[vector].vector;
    }
#[no_mangle]
unsafe extern "C" fn rocker_msix_tx_vector(rocker_port: *const rocker_port) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rocker_msix_rx_vector(rocker_port: *const rocker_port) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn rocker_reg_test(rocker: *const rocker) -> c_int {
...
pub const ROCKER_TEST_DMA_FILL_PATTERN: c_uint = 0x96;
...
#[no_mangle]
unsafe extern "C" fn rocker_test_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rocker_basic_hw_test(rocker: *const rocker) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __pos_inc(pos: u32, limit: usize) -> u32 {
    static u32 __pos_inc(u32 pos, size_t limit)
    {
    return ++pos == limit ? 0 : pos;
    }
#[no_mangle]
unsafe extern "C" fn rocker_desc_err(desc_info: *const rocker_desc_info) -> c_int {
    static int rocker_desc_err(const struct rocker_desc_info *desc_info)
    {
    let mut err: c_int = desc_info.desc.comp_err & ~ROCKER_DMA_DESC_COMP_ERR_GEN;
    switch (err) {
    case ROCKER_OK:
    return 0;
    case -ROCKER_ENOENT:
...
#[no_mangle]
unsafe extern "C" fn rocker_desc_gen_clear(desc_info: *const rocker_desc_info) {
    static void rocker_desc_gen_clear(const struct rocker_desc_info *desc_info)
    {
    desc_info.desc.comp_err &= ~ROCKER_DMA_DESC_COMP_ERR_GEN;
    }
#[no_mangle]
unsafe extern "C" fn rocker_desc_gen(desc_info: *const rocker_desc_info) -> bool {
    static bool rocker_desc_gen(const struct rocker_desc_info *desc_info)
    {
    let mut comp_err: u32 = desc_info.desc.comp_err;
    ...
    let mut head: u32 = __pos_inc(info.head, info.size);
    desc_info = &info.desc_info[info.head];
    if (head == info.tail)
    return core::ptr::null_mut(); /* ring full */
    desc_info.tlv_size = 0;
    return desc_info;
    }
#[no_mangle]
unsafe extern "C" fn rocker_desc_commit(desc_info: *const rocker_desc_info) {
    ...
    return core::ptr::null_mut(); /* nothing to be done between head and tail */
    desc_info = &info.desc_info[info.tail];
    if (!rocker_desc_gen(desc_info))
    return core::ptr::null_mut(); /* gen bit not set, desc is not ready yet */
...
#[no_mangle]
unsafe extern "C" fn rocker_dma_ring_size_fix(size: usize) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn rocker_dma_cmd_ring_wait_alloc(desc_info: *mut rocker_desc_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_dma_cmd_ring_waits_alloc(rocker: *const rocker) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_dma_cmd_ring_waits_free(rocker: *const rocker) {
...
#[no_mangle]
unsafe extern "C" fn rocker_dma_rings_init(rocker: *mut rocker) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_dma_rings_fini(rocker: *mut rocker) {
...
#[no_mangle]
unsafe extern "C" fn rocker_port_rx_buf_len(rocker_port: *const rocker_port) -> usize {
    ...
    struct sk_buff *skb;
    let mut buf_len: usize = rocker_port_rx_buf_len(rocker_port);
    int err;
// Ensure that hw will see tlv_size zero in case of an error.
// That tells hw to use another descriptor.
//
    rocker_desc_cookie_ptr_set(desc_info, core::ptr::null_mut());
    desc_info.tlv_size = 0;
...
#[no_mangle]
unsafe extern "C" fn rocker_dma_rx_ring_skbs_alloc(rocker_port: *const rocker_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_dma_rx_ring_skbs_free(rocker_port: *const rocker_port) {
...
#[no_mangle]
unsafe extern "C" fn rocker_port_dma_rings_init(rocker_port: *mut rocker_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_port_dma_rings_fini(rocker_port: *mut rocker_port) {
    ...
    bool enable)
    {
    let mut val: u64 = rocker_read64(rocker_port.rocker, PORT_PHYS_ENABLE);
    if (enable)
...
//
#[no_mangle]
unsafe extern "C" fn rocker_cmd_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rocker_port_link_up(rocker_port: *const rocker_port) {
...
#[no_mangle]
unsafe extern "C" fn rocker_port_link_down(rocker_port: *const rocker_port) {
...
#[no_mangle]
unsafe extern "C" fn rocker_event_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rocker_tx_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rocker_rx_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// make sure name only contains alphanumeric characters
    ...
    void *priv)
    {
    let mut learning: bool = *(bool *)priv;
    struct rocker_tlv *cmd_info;
    if (rocker_tlv_put_u16(desc_info, ROCKER_TLV_CMD_TYPE,
    ROCKER_TLV_CMD_TYPE_SET_PORT_SETTINGS))
    return -EMSGSIZE;
    ...
    rocker_cmd_get_port_settings_prep, core::ptr::null_mut(),
    ...
    &copy_ecmd, core::ptr::null_mut(), core::ptr::null_mut());
    }
    ...
    macaddr, core::ptr::null_mut(), core::ptr::null_mut());
    }
    ...
    &mtu, core::ptr::null_mut(), core::ptr::null_mut());
    }
    ...
    &learning, core::ptr::null_mut(), core::ptr::null_mut());
    }
//
// Worlds manipulation
//
...
#[no_mangle]
unsafe extern "C" fn rocker_world_init(rocker: *mut rocker, mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_world_fini(rocker: *mut rocker) {
...
#[no_mangle]
unsafe extern "C" fn rocker_world_check_init(rocker_port: *mut rocker_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_world_port_pre_init(rocker_port: *mut rocker_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_world_port_init(rocker_port: *mut rocker_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_world_port_fini(rocker_port: *mut rocker_port) {
...
#[no_mangle]
unsafe extern "C" fn rocker_world_port_post_fini(rocker_port: *mut rocker_port) {
...
#[no_mangle]
unsafe extern "C" fn rocker_world_port_open(rocker_port: *mut rocker_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_world_port_stop(rocker_port: *mut rocker_port) {
...
#[no_mangle]
unsafe extern "C" fn rocker_world_fib4_abort(rocker: *mut rocker) {
...
//
#[no_mangle]
unsafe extern "C" fn rocker_port_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_port_stop(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_port_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn rocker_port_set_mac_address(dev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_port_change_mtu(dev: *mut net_device, new_mtu: c_int) -> c_int {
    static int rocker_port_change_mtu(struct net_device *dev, int new_mtu)
    {
    struct rocker_port *rocker_port = netdev_priv(dev);
    let mut running: c_int = netif_running(dev);
    int err;
    if (running)
    ...
    {
    struct rocker_port *rocker_port = netdev_priv(dev);
    let mut name: port_name = { .buf = buf, .len = len };
    int err;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rocker_fib_event_work {
    pub work: work_struct,
    union {
    pub fen_info: fib_entry_notifier_info,
    pub fr_info: fib_rule_notifier_info,
}
...
#[no_mangle]
unsafe extern "C" fn rocker_router_fib_event_work(work: *mut work_struct) {
...
//
    ...
    {
    return rocker_cmd_exec(rocker_port, false,
    rocker_cmd_get_port_stats_prep, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn rocker_port_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_port_poll_tx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_port_poll_rx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rocker_carrier_init(rocker_port: *const rocker_port) {
    static void rocker_carrier_init(const struct rocker_port *rocker_port)
    {
    const struct rocker *rocker = rocker_port.rocker;
    let mut link_status: u64 = rocker_read64(rocker, PORT_PHYS_LINK_STATUS);
    bool link_up;
...
#[no_mangle]
unsafe extern "C" fn rocker_remove_ports(rocker: *mut rocker) {
...
#[no_mangle]
unsafe extern "C" fn rocker_port_dev_addr_init(rocker_port: *mut rocker_port) {
...
pub const ROCKER_PORT_MAX_MTU: c_int = 9000;
#[no_mangle]
unsafe extern "C" fn rocker_probe_port(rocker: *mut rocker, port_number: c_uint) -> c_int {
...
// MTU range: 68 - 9000
    ...
    return 0;
    err_world_port_init:
    rocker.ports[port_number] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rocker_probe_ports(rocker: *mut rocker) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_msix_init(rocker: *mut rocker) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rocker_msix_fini(rocker: *const rocker) {
...
#[no_mangle]
unsafe extern "C" fn rocker_port_dev_check(dev: *const net_device) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rocker_switchdev_event_work {
    pub work: work_struct,
    pub fdb_info: switchdev_notifier_fdb_info,
    pub rocker_port: *mut rocker_port,
    pub event: c_ulong,
}
    ...
    rocker_port.dev, &info.info, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn rocker_switchdev_event_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rocker_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
//
    ...
    err = register_fib_notifier(&init_net, &rocker.fib_nb, core::ptr::null_mut(), core::ptr::null_mut());
    if (err)
...
#[no_mangle]
unsafe extern "C" fn rocker_remove(pdev: *mut pci_dev) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rocker_walk_data {
    pub rocker: *mut rocker,
    pub port: *mut rocker_port,
}
...
//
#[no_mangle]
unsafe extern "C" fn rocker_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn rocker_module_exit() -> void __exit {
