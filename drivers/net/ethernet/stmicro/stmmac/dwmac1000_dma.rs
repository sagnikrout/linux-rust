...
//! Source: drivers/net/ethernet/stmicro/stmmac/dwmac1000_dma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dwmac1000_dma_axi(ioaddr: *mut void __iomem, axi: *mut stmmac_axi) {
    static void dwmac1000_dma_axi(void __iomem *ioaddr, struct stmmac_axi *axi)
    {
    let mut value: u32 = readl(ioaddr + DMA_AXI_BUS_MODE);
...
#[no_mangle]
unsafe extern "C" fn dwmac1000_configure_fc(csr6: u32, rxfifosz: c_int) -> u32 {
...
//
    ...
    {
    let mut csr6: u32 = readl(ioaddr + DMA_CHAN_CONTROL(channel));
    if (mode == SF_DMA_MODE) {
...
pub unsafe extern "C" fn if(192: mode <=) -> else {
    ...
    {
    let mut hw_cap: u32 = readl(ioaddr + DMA_HW_FEATURE);
    if (!hw_cap) {
