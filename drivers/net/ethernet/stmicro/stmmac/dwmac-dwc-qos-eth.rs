...
//! Source: drivers/net/ethernet/stmicro/stmmac/dwmac-dwc-qos-eth.c
#![no_std]
...
pub const SDMEMCOMPPADCTRL: c_uint = 0x8800;

pub const AUTO_CAL_CONFIG: c_uint = 0x8804;

pub const AUTO_CAL_STATUS: c_uint = 0x880c;

    static void tegra_eqos_fix_speed(void *bsp_priv, phy_interface_t interface,
    int speed, unsigned int mode)
    {
    struct tegra_eqos *eqos = bsp_priv;
    let mut needs_calibration: bool = false;
...
#[no_mangle]
unsafe extern "C" fn tegra_eqos_remove(pdev: *mut platform_device) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dwc_eth_dwmac_data {
    int (*probe)(struct platform_device *pdev,
    struct plat_stmmacenet_data *plat_dat,
    pub res): *mut stmmac_resources,
    pub pdev): *mut *mut void (remove)(struct platform_device,
    pub stmmac_clk_name: *const c_char,
}
...
#[no_mangle]
unsafe extern "C" fn dwc_eth_dwmac_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc_eth_dwmac_remove(pdev: *mut platform_device) {
