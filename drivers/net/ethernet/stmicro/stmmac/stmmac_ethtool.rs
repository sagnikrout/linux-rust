...
//! Source: drivers/net/ethernet/stmicro/stmmac/stmmac_ethtool.c
#![no_std]
...
pub const REG_SPACE_SIZE: c_uint = 0x1060;
pub const GMAC4_REG_SPACE_SIZE: c_uint = 0x116C;
...
//
pub const GMAC4_DMA_CHAN_BASE_ADDR: c_uint = 0x00001100;
pub const ETHTOOL_DMA_OFFSET: c_int = 55;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stmmac_stats {
...
#[no_mangle]
pub unsafe extern "C" fn if(DWMAC_CORE_XGMAC: priv->plat->core_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn stmmac_ethtool_getmsglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn stmmac_ethtool_setmsglevel(dev: *mut net_device, level: u32) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_ethtool_get_regs_len(dev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(DWMAC_CORE_GMAC4: priv->plat->core_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn stmmac_nway_reset(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_get_rx_normal_irq_n(priv: *mut stmmac_priv, q: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn stmmac_get_tx_normal_irq_n(priv: *mut stmmac_priv, q: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn stmmac_get_per_qstats(priv: *mut stmmac_priv, data: *mut u64) {
    static void stmmac_get_per_qstats(struct stmmac_priv *priv, u64 *data)
    {
    let mut tx_cnt: u32 = priv.plat.tx_queues_to_use;
...
// data++ = stmmac_get_rx_normal_irq_n(priv, q);
    ...
    {
    struct stmmac_priv *priv = netdev_priv(dev);
    let mut rx_queues_count: u32 = priv.plat.rx_queues_to_use;
    let mut tx_queues_count: u32 = priv.plat.tx_queues_to_use;
    let mut napi_poll: u64 = 0, normal_irq_n = 0;
    int i, j = 0, pos, ret;
    unsigned long count;
    unsigned int start;
    if (priv.dma_cap.asp) {
...
// If supported, for new GMAC chips expose the MMC counters
    ...
    if (priv.dma_cap.eee) {
    let mut val: c_int = phylink_get_eee_err(priv.phylink);
    if (val)
...
#[no_mangle]
unsafe extern "C" fn stmmac_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_get_qstats_string(priv: *mut stmmac_priv, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_get_strings(dev: *mut net_device, stringset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_get_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_set_wol(dev: *mut net_device, wol: *mut ethtool_wolinfo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_usec2riwt(usec: u32, priv: *mut stmmac_priv) -> u32 {
    static u32 stmmac_usec2riwt(u32 usec, struct stmmac_priv *priv)
    {
    let mut clk: c_ulong = clk_get_rate(priv.plat.stmmac_clk);
    if (!clk) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_riwt2usec(riwt: u32, priv: *mut stmmac_priv) -> u32 {
    ...
    queue = 0;
#[no_mangle]
pub unsafe extern "C" fn if(max_cnt: queue >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn stmmac_get_rx_ring_count(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn stmmac_get_rxfh_key_size(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn stmmac_get_rxfh_indir_size(dev: *mut net_device) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn stmmac_set_ethtool_ops(netdev: *mut net_device) {
