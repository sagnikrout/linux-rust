...
//! Source: drivers/net/ethernet/stmicro/stmmac/dwmac-stm32.c
#![no_std]
...
pub const SYSCFG_PMCCLRR_OFFSET: c_uint = 0x40;

// CLOCK feed to PHY
pub const ETH_CK_F_25M: c_int = 25000000;
pub const ETH_CK_F_50M: c_int = 50000000;
pub const ETH_CK_F_125M: c_int = 125000000;
...
pub const SYSCFG_MCU_ETH_SEL_MII: c_int = 0;
pub const SYSCFG_MCU_ETH_SEL_RMII: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_dwmac {
    pub clk_tx: *mut clk,
    pub clk_rx: *mut clk,
    pub clk_eth_ck: *mut clk,
    pub clk_ethstp: *mut clk,
    pub syscfg_clk: *mut clk,
    pub ext_phyclk: c_int,
    pub enable_eth_ck: c_int,
    pub eth_clk_sel_reg: c_int,
    pub eth_ref_clk_sel_reg: c_int,
    pub irq_pwr_wakeup: c_int,
    pub /: *mut *mut u32 mode_reg; / MAC glue-logic mode register,
    pub mode_mask: u32,
    pub regmap: *mut regmap,
    pub speed: u32,
    pub ops: *const stm32_ops,
    pub dev: *mut device,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_ops {
    pub plat_dat): *mut *mut int (set_mode)(struct plat_stmmacenet_data,
    pub dwmac): *mut *mut int (suspend)(struct stm32_dwmac,
    pub dwmac): *mut *mut void (resume)(struct stm32_dwmac,
    int (*parse_data)(struct stm32_dwmac *dwmac,
    pub dev): *mut device,
    pub clk_rx_enable_in_suspend: bool,
    pub is_mp2: bool is_mp13,,
    pub syscfg_clr_off: u32,
}

#[no_mangle]
unsafe extern "C" fn stm32_dwmac_clk_enable(dwmac: *mut stm32_dwmac) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dwmac_init(plat_dat: *mut plat_stmmacenet_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32mp1_select_ethck_external(plat_dat: *mut plat_stmmacenet_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32mp1_validate_ethck_rate(plat_dat: *mut plat_stmmacenet_data) -> c_int {
    static int stm32mp1_validate_ethck_rate(struct plat_stmmacenet_data *plat_dat)
    {
    struct stm32_dwmac *dwmac = plat_dat.bsp_priv;
    let mut clk_rate: u32 = clk_get_rate(dwmac.clk_eth_ck);
    if (!dwmac.enable_eth_ck)
    return 0;
    switch (plat_dat.phy_interface) {
    case PHY_INTERFACE_MODE_MII:
    ...
    {
    struct stm32_dwmac *dwmac = plat_dat.bsp_priv;
    let mut reg: u32 = dwmac.mode_reg;
    int val;
...
#[no_mangle]
unsafe extern "C" fn stm32mp1_set_mode(plat_dat: *mut plat_stmmacenet_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32mcu_set_mode(plat_dat: *mut plat_stmmacenet_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dwmac_clk_disable(dwmac: *mut stm32_dwmac) {
...
// Get ETH_CLK clocks
    ...
    dwmac.clk_eth_ck = core::ptr::null_mut();
    }
...
// Optional Clock for sysconfig
    ...
    dwmac.syscfg_clk = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn stm32_dwmac_suspend(dev: *mut device, bsp_priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dwmac_resume(dev: *mut device, bsp_priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dwmac_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_dwmac_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn stm32mp1_suspend(dwmac: *mut stm32_dwmac) -> c_int {
    static int stm32mp1_suspend(struct stm32_dwmac *dwmac)
    {
    return clk_prepare_enable(dwmac.clk_ethstp);
    }
#[no_mangle]
unsafe extern "C" fn stm32mp1_resume(dwmac: *mut stm32_dwmac) {
