...
//! Source: drivers/net/ethernet/stmicro/stmmac/dwmac-meson8b.c
#![no_std]
...
pub const PRG_ETH0_CLK_M250_DIV_SHIFT: c_int = 7;
pub const PRG_ETH0_CLK_M250_DIV_WIDTH: c_int = 3;
pub const PRG_ETH0_RGMII_TX_CLK_EN: c_int = 10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson8b_dwmac_data {
    pub dwmac): *mut *mut int (set_phy_mode)(struct meson8b_dwmac,
    pub has_prg_eth1_rgmii_rx_delay: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson8b_dwmac {
    pub dev: *mut device,
    pub regs: *mut void __iomem,
    pub data: *const meson8b_dwmac_data,
    pub phy_mode: phy_interface_t,
    pub rgmii_tx_clk: *mut clk,
    pub tx_delay_ns: u32,
    pub rx_delay_ps: u32,
    pub timing_adj_clk: *mut clk,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson8b_dwmac_clk_configs {
    pub m250_mux: clk_mux,
    pub m250_div: clk_divider,
    pub fixed_div2: clk_fixed_factor,
    pub rgmii_tx_en: clk_gate,
}
...
#[no_mangle]
unsafe extern "C" fn meson8b_init_rgmii_tx_clk(dwmac: *mut meson8b_dwmac) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson8b_set_phy_mode(dwmac: *mut meson8b_dwmac) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_axg_set_phy_mode(dwmac: *mut meson8b_dwmac) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson8b_clk_disable_unprepare(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn meson8b_init_rgmii_delays(dwmac: *mut meson8b_dwmac) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(2000: dwmac->rx_delay_ps ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn meson8b_init_prg_eth(dwmac: *mut meson8b_dwmac) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson8b_dwmac_probe(pdev: *mut platform_device) -> c_int {
