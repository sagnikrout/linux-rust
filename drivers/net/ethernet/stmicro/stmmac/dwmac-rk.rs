...
//! Source: drivers/net/ethernet/stmicro/stmmac/dwmac-rk.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rk_clock_fields {
// io_clksel_cru_mask - io_clksel bit in clock GRF register which,
// when set, selects the tx clock from CRU.
//
    pub io_clksel_cru_mask: u16,
// io_clksel_io_mask - io_clksel bit in clock GRF register which,
// when set, selects the tx clock from IO.
//
    pub io_clksel_io_mask: u16,
    pub gmii_clk_sel_mask: u16,
    pub rmii_clk_sel_mask: u16,
    pub rmii_gate_en_mask: u16,
    pub rmii_mode_mask: u16,
    pub mac_speed_mask: u16,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rk_gmac_ops {
    pub bsp_priv): *mut *mut int (init)(struct rk_priv_data,
    void (*set_to_rgmii)(struct rk_priv_data *bsp_priv,
    pub rx_delay): int tx_delay, int,
    pub bsp_priv): *mut *mut void (set_to_rmii)(struct rk_priv_data,
    int (*set_speed)(struct rk_priv_data *bsp_priv,
    pub speed): phy_interface_t interface, int,
    pub bsp_priv): *mut *mut void (integrated_phy_powerup)(struct rk_priv_data,
    pub bsp_priv): *mut *mut void (integrated_phy_powerdown)(struct rk_priv_data,
    pub gmac_grf_reg: u16,
    pub gmac_phy_intf_sel_mask: u16,
    pub gmac_rmii_mode_mask: u16,
    pub clock_grf_reg: u16,
    pub clock: rk_clock_fields,
    pub gmac_grf_reg_in_php: bool,
    pub clock_grf_reg_in_php: bool,
    pub supports_rgmii: bool,
    pub supports_rmii: bool,
    pub php_grf_required: bool,
    pub regs_valid: bool,
    pub regs: [u32; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rk_priv_data {
    pub dev: *mut device,
    pub phy_iface: phy_interface_t,
    pub id: c_int,
    pub regulator: *mut regulator,
    pub ops: *const rk_gmac_ops,
    pub clk_enabled: bool,
    pub clock_input: bool,
    pub integrated_phy: bool,
    pub supports_rgmii: bool,
    pub supports_rmii: bool,
...
pub const GMAC_CLK_DIV1_125M: c_int = 0;
pub const GMAC_CLK_DIV50_2_5M: c_int = 2;
pub const GMAC_CLK_DIV5_25M: c_int = 3;
#[no_mangle]
unsafe extern "C" fn rk_gmac_rgmii_clk_div(speed: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_get_phy_intf_sel(interface: phy_interface_t) -> c_int {
    static int rk_get_phy_intf_sel(phy_interface_t interface)
    {
    let mut ret: c_int = stmmac_get_phy_intf_sel(interface);
...
#[no_mangle]
unsafe extern "C" fn rk_encode_wm16(val: u16, mask: u16) -> u32 {
    static u32 rk_encode_wm16(u16 val, u16 mask)
    {
    let mut reg_val: u32 = mask << 16;
    if (mask)
    reg_val |= mask & (val << (ffs(mask) - 1));
    return reg_val;
    }
#[no_mangle]
unsafe extern "C" fn rk_write_gmac_grf_reg(bsp_priv: *mut rk_priv_data, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_write_clock_grf_reg(bsp_priv: *mut rk_priv_data, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_set_rmii_gate_en(bsp_priv: *mut rk_priv_data, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_ungate_rmii_clock(bsp_priv: *mut rk_priv_data) -> c_int {
    static int rk_ungate_rmii_clock(struct rk_priv_data *bsp_priv)
    {
    return rk_set_rmii_gate_en(bsp_priv, false);
    }
#[no_mangle]
unsafe extern "C" fn rk_gate_rmii_clock(bsp_priv: *mut rk_priv_data) -> c_int {
    static int rk_gate_rmii_clock(struct rk_priv_data *bsp_priv)
    {
    return rk_set_rmii_gate_en(bsp_priv, true);
    }
#[no_mangle]
unsafe extern "C" fn rk_configure_io_clksel(bsp_priv: *mut rk_priv_data) -> c_int {
...
pub const RK_GRF_MACPHY_CON0: c_uint = 0xb00;

pub const RK_GRF_MACPHY_CON1: c_uint = 0xb04;
pub const RK_GRF_MACPHY_CON2: c_uint = 0xb08;

pub const RK_GRF_MACPHY_CON3: c_uint = 0xb0c;

#[no_mangle]
unsafe extern "C" fn rk_gmac_integrated_ephy_powerup(priv: *mut rk_priv_data) {
...
#[no_mangle]
unsafe extern "C" fn rk_gmac_integrated_ephy_powerdown(priv: *mut rk_priv_data) {
...
pub const PX30_GRF_GMAC_CON1: c_uint = 0x0904;
...
pub const RK3128_GRF_MAC_CON0: c_uint = 0x0168;
pub const RK3128_GRF_MAC_CON1: c_uint = 0x016c;
// RK3128_GRF_MAC_CON0
...
pub const RK3228_GRF_MAC_CON0: c_uint = 0x0900;
pub const RK3228_GRF_MAC_CON1: c_uint = 0x0904;
pub const RK3228_GRF_CON_MUX: c_uint = 0x50;
// RK3228_GRF_MAC_CON0
...
#[no_mangle]
unsafe extern "C" fn rk3228_set_to_rmii(bsp_priv: *mut rk_priv_data) {
...
#[no_mangle]
unsafe extern "C" fn rk3228_integrated_phy_powerup(priv: *mut rk_priv_data) {
...
pub const RK3288_GRF_SOC_CON1: c_uint = 0x0248;
pub const RK3288_GRF_SOC_CON3: c_uint = 0x0250;
// RK3288_GRF_SOC_CON1
...
pub const RK3308_GRF_MAC_CON0: c_uint = 0x04a0;
// RK3308_GRF_MAC_CON0
...
pub const RK3328_GRF_MAC_CON0: c_uint = 0x0900;
pub const RK3328_GRF_MAC_CON1: c_uint = 0x0904;
pub const RK3328_GRF_MAC_CON2: c_uint = 0x0908;
pub const RK3328_GRF_MACPHY_CON1: c_uint = 0xb04;
// RK3328_GRF_MAC_CON0
...
#[no_mangle]
unsafe extern "C" fn rk3328_init(bsp_priv: *mut rk_priv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3328_integrated_phy_powerup(priv: *mut rk_priv_data) {
...
pub const RK3366_GRF_SOC_CON6: c_uint = 0x0418;
pub const RK3366_GRF_SOC_CON7: c_uint = 0x041c;
// RK3366_GRF_SOC_CON6
...
pub const RK3368_GRF_SOC_CON15: c_uint = 0x043c;
pub const RK3368_GRF_SOC_CON16: c_uint = 0x0440;
...
pub const RK3399_GRF_SOC_CON5: c_uint = 0xc214;
pub const RK3399_GRF_SOC_CON6: c_uint = 0xc218;
// RK3399_GRF_SOC_CON5
...
pub const RK3506_GRF_SOC_CON8: c_uint = 0x0020;
pub const RK3506_GRF_SOC_CON11: c_uint = 0x002c;

#[no_mangle]
unsafe extern "C" fn rk3506_init(bsp_priv: *mut rk_priv_data) -> c_int {
...
pub const RK3528_VO_GRF_GMAC_CON: c_uint = 0x0018;
pub const RK3528_VO_GRF_MACPHY_CON0: c_uint = 0x001c;
pub const RK3528_VO_GRF_MACPHY_CON1: c_uint = 0x0020;
pub const RK3528_VPU_GRF_GMAC_CON5: c_uint = 0x0018;
pub const RK3528_VPU_GRF_GMAC_CON6: c_uint = 0x001c;

#[no_mangle]
unsafe extern "C" fn rk3528_init(bsp_priv: *mut rk_priv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3528_integrated_phy_powerup(bsp_priv: *mut rk_priv_data) {
...
#[no_mangle]
unsafe extern "C" fn rk3528_integrated_phy_powerdown(bsp_priv: *mut rk_priv_data) {
...
pub const RK3568_GRF_GMAC0_CON0: c_uint = 0x0380;
pub const RK3568_GRF_GMAC0_CON1: c_uint = 0x0384;
pub const RK3568_GRF_GMAC1_CON0: c_uint = 0x0388;
pub const RK3568_GRF_GMAC1_CON1: c_uint = 0x038c;
// RK3568_GRF_GMAC0_CON1 && RK3568_GRF_GMAC1_CON1

// RK3568_GRF_GMAC0_CON0 && RK3568_GRF_GMAC1_CON0

#[no_mangle]
unsafe extern "C" fn rk3568_init(bsp_priv: *mut rk_priv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3576_init(bsp_priv: *mut rk_priv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3588_init(bsp_priv: *mut rk_priv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_gmac_clk_init(plat: *mut plat_stmmacenet_data) -> c_int {
    static int rk_gmac_clk_init(struct plat_stmmacenet_data *plat)
    {
    struct rk_priv_data *bsp_priv = plat.bsp_priv;
    let mut phy_iface: c_int = bsp_priv.phy_iface;
...
#[no_mangle]
unsafe extern "C" fn gmac_clk_enable(bsp_priv: *mut rk_priv_data, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_phy_powerup(bsp_priv: *mut rk_priv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_phy_powerdown(bsp_priv: *mut rk_priv_data) {
    ...
    struct resource *res;
    int ret;
    const char *strings = core::ptr::null_mut();
    int value;
...
//
    ...
    bsp_priv.phy_reset = of_reset_control_get(plat.phy_node, core::ptr::null_mut());
    if (IS_ERR(bsp_priv.phy_reset)) {
    dev_err(&pdev.dev, "No PHY reset control found.\n");
    bsp_priv.phy_reset = core::ptr::null_mut();
    }
    }
    }
...
#[no_mangle]
unsafe extern "C" fn rk_gmac_check_ops(bsp_priv: *mut rk_priv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_gmac_powerup(bsp_priv: *mut rk_priv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_gmac_powerdown(gmac: *mut rk_priv_data) {
...
#[no_mangle]
unsafe extern "C" fn rk_gmac_suspend(dev: *mut device, bsp_priv_: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_gmac_resume(dev: *mut device, bsp_priv_: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_gmac_init(dev: *mut device, bsp_priv: *mut c_void) -> c_int {
    static int rk_gmac_init(struct device *dev, void *bsp_priv)
    {
    return rk_gmac_powerup(bsp_priv);
    }
#[no_mangle]
unsafe extern "C" fn rk_gmac_exit(dev: *mut device, bsp_priv_: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rk_gmac_probe(pdev: *mut platform_device) -> c_int {
