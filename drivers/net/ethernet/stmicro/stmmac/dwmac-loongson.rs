...
//! Source: drivers/net/ethernet/stmicro/stmmac/dwmac-loongson.c
#![no_std]
...
pub const DMA_INTR_ENA_NIE_TX_LOONGSON: c_uint = 0x00040000;
// Normal Loongson Rx Summary
pub const DMA_INTR_ENA_NIE_RX_LOONGSON: c_uint = 0x00020000;

    DMA_INTR_ENA_NIE_RX_LOONGSON | \
    DMA_INTR_ENA_RIE | DMA_INTR_ENA_TIE)
// Abnormal Loongson Tx Summary
pub const DMA_INTR_ENA_AIE_TX_LOONGSON: c_uint = 0x00010000;
// Abnormal Loongson Rx Summary
pub const DMA_INTR_ENA_AIE_RX_LOONGSON: c_uint = 0x00008000;
...
pub const DMA_STATUS_NIS_TX_LOONGSON: c_uint = 0x00040000;
// Normal Loongson Rx Interrupt Summary
pub const DMA_STATUS_NIS_RX_LOONGSON: c_uint = 0x00020000;
// Abnormal Loongson Tx Interrupt Summary
pub const DMA_STATUS_AIS_TX_LOONGSON: c_uint = 0x00010000;
// Abnormal Loongson Rx Interrupt Summary
pub const DMA_STATUS_AIS_RX_LOONGSON: c_uint = 0x00008000;
// Fatal Loongson Tx Bus Error Interrupt
pub const DMA_STATUS_FBI_TX_LOONGSON: c_uint = 0x00002000;
// Fatal Loongson Rx Bus Error Interrupt
pub const DMA_STATUS_FBI_RX_LOONGSON: c_uint = 0x00001000;
    ...
    DMA_STATUS_MSK_COMMON_LOONGSON)
pub const PCI_DEVICE_ID_LOONGSON_GMAC1: c_uint = 0x7a03;
pub const PCI_DEVICE_ID_LOONGSON_GMAC2: c_uint = 0x7a23;
pub const PCI_DEVICE_ID_LOONGSON_GNET: c_uint = 0x7a13;
pub const DWMAC_CORE_MULTICHAN_V1: c_uint = 0x10	/* Loongson custom ID 0x10 */;
pub const DWMAC_CORE_MULTICHAN_V2: c_uint = 0x12	/* Loongson custom ID 0x12 */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct loongson_data {
    pub multichan: u32,
    pub loongson_id: u32,
    pub dev: *mut device,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stmmac_pci_info {
    pub plat): *mut *mut *mut int (setup)(struct pci_dev pdev, struct plat_stmmacenet_data,
}
...
// Word around hardware bug, restart autoneg
    ...
    u32 chan)
    {
    let mut txpbl: c_int = dma_cfg.txpbl ?: dma_cfg.pbl;
    let mut rxpbl: c_int = dma_cfg.rxpbl ?: dma_cfg.pbl;
    u32 value;
...
#[no_mangle]
unsafe extern "C" fn loongson_dwmac_setup(apriv: *mut c_void, mac: *mut mac_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_dwmac_msi_clear(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn loongson_dwmac_fix_reset(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_dwmac_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    static int loongson_dwmac_probe(struct pci_dev *pdev, const struct pci_device_id *id)
    {
    struct plat_stmmacenet_data *plat;
    let mut res: stmmac_resources = {};
...
#[no_mangle]
unsafe extern "C" fn loongson_dwmac_remove(pdev: *mut pci_dev) {
