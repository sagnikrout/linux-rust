...
//! Source: drivers/net/ethernet/stmicro/stmmac/dwmac100_dma.c
#![no_std]
...
// DMA controller has two counters to track the number of the missed frames.
    ...
    void __iomem *ioaddr)
    {
    let mut csr8: u32 = readl(ioaddr + DMA_MISSED_FRAME_CTR);
    if (unlikely(csr8)) {
    ...
    let mut miss_f: c_uint = (csr8 & DMA_MISSED_FRAME_M_CNTR);
