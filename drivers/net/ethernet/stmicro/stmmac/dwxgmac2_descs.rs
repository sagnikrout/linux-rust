...
//! Source: drivers/net/ethernet/stmicro/stmmac/dwxgmac2_descs.c
#![no_std]
...
//
    ...
    {
    let mut tdes3: u32 = le32_to_cpu(p.des3);
    ...
    struct dma_desc *p)
    {
    let mut rdes3: u32 = le32_to_cpu(p.des3);
    let mut rdes2: u32 = le32_to_cpu(p.des2);
...
#[no_mangle]
unsafe extern "C" fn dwxgmac2_set_tx_owner(p: *mut dma_desc) {
    static void dwxgmac2_set_tx_owner(struct dma_desc *p)
    {
    p.des3 |= cpu_to_le32(XGMAC_TDES3_OWN);
    }
#[no_mangle]
unsafe extern "C" fn dwxgmac2_set_rx_owner(p: *mut dma_desc, disable_rx_ic: c_int) {
    static void dwxgmac2_set_rx_owner(struct dma_desc *p, int disable_rx_ic)
    {
    let mut flags: u32 = XGMAC_RDES3_OWN;
    if (!disable_rx_ic)
    flags |= XGMAC_RDES3_IOC;
    p.des3 |= cpu_to_le32(flags);
    }
#[no_mangle]
unsafe extern "C" fn dwxgmac2_wrback_get_rx_vlan_tci(p: *mut dma_desc) -> u16 {
    static u16 dwxgmac2_wrback_get_rx_vlan_tci(struct dma_desc *p)
    {
    return le32_to_cpu(p.des0) & XGMAC_RDES0_VLAN_TAG_MASK;
    }
#[no_mangle]
unsafe extern "C" fn dwxgmac2_wrback_get_rx_vlan_valid(p: *mut dma_desc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dwxgmac2_get_rx_frame_len(p: *mut dma_desc, rx_coe: c_int) -> c_int {
    static int dwxgmac2_get_rx_frame_len(struct dma_desc *p, int rx_coe)
    {
    return (le32_to_cpu(p.des3) & XGMAC_RDES3_PL);
    }
#[no_mangle]
unsafe extern "C" fn dwxgmac2_enable_tx_timestamp(p: *mut dma_desc) {
    static void dwxgmac2_enable_tx_timestamp(struct dma_desc *p)
    {
    p.des2 |= cpu_to_le32(XGMAC_TDES2_TTSE);
    }
#[no_mangle]
unsafe extern "C" fn dwxgmac2_get_tx_timestamp_status(p: *mut dma_desc) -> c_int {
    static int dwxgmac2_get_tx_timestamp_status(struct dma_desc *p)
    {
    return 0; /* Not supported */
    }
#[no_mangle]
pub unsafe extern "C" fn dwxgmac2_get_timestamp(desc: *mut c_void, ats: u32, ts: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn dwxgmac2_rx_check_timestamp(desc: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwxgmac2_release_tx_desc(p: *mut dma_desc, descriptor_mode: u8) {
...
#[no_mangle]
unsafe extern "C" fn dwxgmac2_set_tx_ic(p: *mut dma_desc) {
    static void dwxgmac2_set_tx_ic(struct dma_desc *p)
    {
    p.des2 |= cpu_to_le32(XGMAC_TDES2_IOC);
    }
#[no_mangle]
unsafe extern "C" fn dwxgmac2_set_mss(p: *mut dma_desc, mss: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn dwxgmac2_set_addr(p: *mut dma_desc, addr: dma_addr_t) {
...
#[no_mangle]
unsafe extern "C" fn dwxgmac2_clear(p: *mut dma_desc) {
...
#[no_mangle]
unsafe extern "C" fn dwxgmac2_get_rx_header_len(p: *mut dma_desc, len: *mut c_uint) {
...
#[no_mangle]
unsafe extern "C" fn dwxgmac2_set_sec_addr(p: *mut dma_desc, addr: dma_addr_t, is_valid: bool) {
...
#[no_mangle]
unsafe extern "C" fn dwxgmac2_set_sarc(p: *mut dma_desc, sarc_type: u32) {
...
// Inner VLAN
    if (inner_type) {
    let mut des: u32 = FIELD_PREP(XGMAC_TDES2_IVT, inner_tag);
...
#[no_mangle]
unsafe extern "C" fn dwxgmac2_set_vlan(p: *mut dma_desc, type: u32) {
    static void dwxgmac2_set_vlan(struct dma_desc *p, u32 type)
    {
    p.des2 |= cpu_to_le32(FIELD_PREP(XGMAC_TDES2_VTIR, type));
    }
#[no_mangle]
unsafe extern "C" fn dwxgmac2_set_tbs(p: *mut dma_edesc, sec: u32, nsec: u32) {
