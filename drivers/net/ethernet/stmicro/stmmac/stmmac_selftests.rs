...
//! Source: drivers/net/ethernet/stmicro/stmmac/stmmac_selftests.c
#![no_std]
...
pub const STMMAC_TEST_PKT_MAGIC: c_uint = 0xdeadcafecafedeadULL;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stmmac_packet_attrs {
    pub vlan: c_int,
    pub vlan_id_in: c_int,
    pub vlan_id_out: c_int,
    pub src: *mut c_uchar,
    ...
    struct udphdr *uhdr = core::ptr::null_mut();
    struct tcphdr *thdr = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: attr->vlan) -> else {
    else if (attr.vlan)
    ehdr = skb_push(skb, ETH_HLEN + 4);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: attr->remove_sa) -> else {
...
// HACK
    ...
    struct stmmac_packet_attrs *attr)
    {
    let mut ip_src: __be32 = htonl(attr.ip_src);
    let mut ip_dst: __be32 = htonl(attr.ip_dst);
    struct sk_buff *skb = core::ptr::null_mut();
    skb = arp_create(ARPOP_REQUEST, ETH_P_ARP, ip_dst, priv.dev, ip_src,
    core::ptr::null_mut(), attr.src, attr.dst);
    if (!skb)
    return core::ptr::null_mut();
    skb.pkt_type = PACKET_HOST;
    skb.dev = priv.dev;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stmmac_test_priv {
    pub packet: *mut stmmac_packet_attrs,
    pub pt: packet_type,
    pub comp: completion,
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_mac_loopback(priv: *mut stmmac_priv) -> c_int {
    static int stmmac_test_mac_loopback(struct stmmac_priv *priv)
    {
    let mut attr: stmmac_packet_attrs = { };
    attr.dst = priv.dev.dev_addr;
    return __stmmac_test_loopback(priv, &attr);
    }
#[no_mangle]
unsafe extern "C" fn stmmac_test_mmc(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_eee(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_filter_check(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_uc_filter_check(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_hash_check(priv: *mut stmmac_priv, addr: *mut c_uchar) -> bool {
    static bool stmmac_hash_check(struct stmmac_priv *priv, unsigned char *addr)
    {
    let mut mc_offset: c_int = 32 - priv.hw.mcast_bits_log2;
...
// Now, check if it collides with any existing one
    ...
    let mut nr: u32 = bitrev32(~crc32_le(~0, ha.addr, ETH_ALEN)) >> mc_offset;
...
#[no_mangle]
unsafe extern "C" fn stmmac_perfect_check(priv: *mut stmmac_priv, addr: *mut c_uchar) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_hfilt(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_pfilt(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_mcfilt(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_ucfilt(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_rss(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __stmmac_test_vlanfilt(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_vlanfilt(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_vlanfilt_perfect(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __stmmac_test_dvlanfilt(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_dvlanfilt(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_dvlanfilt_perfect(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_rxp(priv: *mut stmmac_priv) -> c_int {
    static int stmmac_test_rxp(struct stmmac_priv *priv)
    {
    unsigned char addr[ETH_ALEN] = {0xde, 0xad, 0xbe, 0xef, 0x00, 0x00};
    let mut cls_u32: tc_cls_u32_offload = { };
    let mut attr: stmmac_packet_attrs = { };
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_desc_sai(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_desc_sar(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_reg_sai(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_reg_sar(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_vlanoff_common(priv: *mut stmmac_priv, svlan: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_vlanoff(priv: *mut stmmac_priv) -> c_int {
    static int stmmac_test_vlanoff(struct stmmac_priv *priv)
    {
    return stmmac_test_vlanoff_common(priv, false);
    }
#[no_mangle]
unsafe extern "C" fn stmmac_test_svlanoff(priv: *mut stmmac_priv) -> c_int {
    ...
    let mut dummy_cookie: c_ulong = 0xdeadbeef;
    let mut attr: stmmac_packet_attrs = { };
    ...
    stmmac_rss_configure(priv, priv.hw, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_l3filt_da(priv: *mut stmmac_priv) -> c_int {
    static int stmmac_test_l3filt_da(struct stmmac_priv *priv)
    {
    let mut addr: u32 = 0x10203040;
    return __stmmac_test_l3filt(priv, addr, 0, ~0, 0);
    }
#[no_mangle]
unsafe extern "C" fn stmmac_test_l3filt_sa(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_l4filt_da_tcp(priv: *mut stmmac_priv) -> c_int {
    static int stmmac_test_l4filt_da_tcp(struct stmmac_priv *priv)
    {
    let mut dummy_port: u16 = 0x123;
    return __stmmac_test_l4filt(priv, dummy_port, 0, ~0, 0, false);
    }
#[no_mangle]
unsafe extern "C" fn stmmac_test_l4filt_sa_tcp(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_l4filt_da_udp(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_l4filt_sa_udp(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_arpoffload(priv: *mut stmmac_priv) -> c_int {
    ...
    struct stmmac_test_priv *tpriv;
    struct sk_buff *skb = core::ptr::null_mut();
    let mut ip_addr: u32 = 0xdeadcafe;
    let mut ip_src: u32 = 0xdeadbeef;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn __stmmac_test_jumbo(priv: *mut stmmac_priv, queue: u16) -> c_int {
    static int __stmmac_test_jumbo(struct stmmac_priv *priv, u16 queue)
    {
    let mut attr: stmmac_packet_attrs = { };
    let mut size: c_int = priv.dma_conf.dma_buf_sz;
    attr.dst = priv.dev.dev_addr;
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_jumbo(priv: *mut stmmac_priv) -> c_int {
    static int stmmac_test_jumbo(struct stmmac_priv *priv)
    {
    return __stmmac_test_jumbo(priv, 0);
    }
#[no_mangle]
unsafe extern "C" fn stmmac_test_mjumbo(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_sph(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_test_tbs(priv: *mut stmmac_priv) -> c_int {
...
// Check if expected time has elapsed
    ...
    let mut count: c_int = stmmac_selftest_get_count(priv);
    int i, ret;
...
#[no_mangle]
pub unsafe extern "C" fn stmmac_selftest_get_strings(priv: *mut stmmac_priv, data: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn stmmac_selftest_get_count(priv: *mut stmmac_priv) -> c_int {
