...
//! Source: drivers/net/ethernet/stmicro/stmmac/dwmac-sophgo.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sophgo_dwmac_data {
    pub has_internal_rx_delay: bool,
}
...
#[no_mangle]
unsafe extern "C" fn sophgo_dwmac_probe(pdev: *mut platform_device) -> c_int {
