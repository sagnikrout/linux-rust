...
//! Source: drivers/net/ethernet/stmicro/stmmac/dwmac-sun8i.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct emac_variant {
    pub syscon_field: *const reg_field,
    pub soc_has_internal_phy: bool,
    pub support_mii: bool,
    pub support_rmii: bool,
    pub support_rgmii: bool,
    pub rx_delay_max: u8,
    pub tx_delay_max: u8,
}
...
pub struct sunxi_priv_data {
    pub ephy_clk: *mut clk,
    pub regulator: *mut regulator,
    pub rst_ephy: *mut reset_control,
    pub variant: *const emac_variant,
    pub regmap_field: *mut regmap_field,
    pub internal_phy_powered: bool,
    pub use_internal_phy: bool,
...
pub const EMAC_BASIC_CTL0: c_uint = 0x00;
pub const EMAC_BASIC_CTL1: c_uint = 0x04;
pub const EMAC_INT_STA: c_uint = 0x08;
pub const EMAC_INT_EN: c_uint = 0x0C;
pub const EMAC_TX_CTL0: c_uint = 0x10;
pub const EMAC_TX_CTL1: c_uint = 0x14;
pub const EMAC_TX_FLOW_CTL: c_uint = 0x1C;
pub const EMAC_TX_DESC_LIST: c_uint = 0x20;
pub const EMAC_RX_CTL0: c_uint = 0x24;
pub const EMAC_RX_CTL1: c_uint = 0x28;
pub const EMAC_RX_DESC_LIST: c_uint = 0x34;
pub const EMAC_RX_FRM_FLT: c_uint = 0x38;
pub const EMAC_MDIO_CMD: c_uint = 0x48;
pub const EMAC_MDIO_DATA: c_uint = 0x4C;

pub const EMAC_TX_DMA_STA: c_uint = 0xB0;
pub const EMAC_TX_CUR_DESC: c_uint = 0xB4;
pub const EMAC_TX_CUR_BUF: c_uint = 0xB8;
pub const EMAC_RX_DMA_STA: c_uint = 0xC0;
pub const EMAC_RX_CUR_DESC: c_uint = 0xC4;
pub const EMAC_RX_CUR_BUF: c_uint = 0xC8;
// Use in EMAC_BASIC_CTL0

pub const EMAC_SPEED_1000: c_int = 0;

// Use in EMAC_BASIC_CTL1
pub const EMAC_BURSTLEN_SHIFT: c_int = 24;
// Used in EMAC_RX_FRM_FLT

// Used in RX_CTL1

pub const EMAC_RX_TH_32: c_int = 0;

// Used in TX_CTL1

pub const EMAC_TX_TH_64: c_int = 0;
...
pub const H3_EPHY_ADDR_SHIFT: c_int = 20;

pub const DWMAC_SUN8I_MDIO_MUX_INTERNAL_ID: c_int = 1;
pub const DWMAC_SUN8I_MDIO_MUX_EXTERNAL_ID: c_int = 2;
// H3/A64 specific bits

// Generic system control EMAC_CLK bits
pub const SYSCON_ETXDC_SHIFT: c_int = 10;
pub const SYSCON_ERXDC_SHIFT: c_int = 5;
...
//
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_dma_reset(ioaddr: *mut void __iomem) -> c_int {
...
//
    ...
    bool rx, bool tx)
    {
    let mut value: u32 = readl(ioaddr + EMAC_INT_EN);
    if (rx)
    value |= EMAC_RX_INT;
    if (tx)
    value |= EMAC_TX_INT;
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_enable_dma_transmission(ioaddr: *mut void __iomem, chan: u32) {
...
pub unsafe extern "C" fn if(DMA_DIR_TX: dir ==) -> else {
    ...
    v |= EMAC_RX_TH_32;
#[no_mangle]
pub unsafe extern "C" fn if(64: mode <) -> else {
    else if (mode < 64)
    v |= EMAC_RX_TH_64;
#[no_mangle]
pub unsafe extern "C" fn if(96: mode <) -> else {
    else if (mode < 96)
    v |= EMAC_RX_TH_96;
#[no_mangle]
pub unsafe extern "C" fn if(128: mode <) -> else {
    else if (mode < 128)
    v |= EMAC_RX_TH_128;
    }
    writel(v, ioaddr + EMAC_RX_CTL1);
...
pub unsafe extern "C" fn if(128: mode <) -> else {
    ...
    v |= EMAC_TX_TH_128;
#[no_mangle]
pub unsafe extern "C" fn if(192: mode <) -> else {
    else if (mode < 192)
    v |= EMAC_TX_TH_192;
#[no_mangle]
pub unsafe extern "C" fn if(256: mode <) -> else {
    else if (mode < 256)
    v |= EMAC_TX_TH_256;
    }
    writel(v, ioaddr + EMAC_TX_CTL1);
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_init(dev: *mut device, priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_set_mac(ioaddr: *mut void __iomem, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_rx_ipc_enable(hw: *mut mac_device_info) -> c_int {
    ...
    let mut macaddrs: c_int = netdev_uc_count(dev) + netdev_mc_count(dev) + 1;
    v = EMAC_FRM_FLT_CTL;
...
// Disable unused address filter slots
    ...
    sun8i_dwmac_set_umac_addr(hw, core::ptr::null_mut(), i++);
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_reset(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_ephy_nodes(priv: *mut stmmac_priv) -> c_int {
...
// Seek for internal PHY
    ...
    continue;
    gmac.rst_ephy = of_reset_control_get_exclusive(iphynode, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_power_internal_phy(priv: *mut stmmac_priv) -> c_int {
    static int sun8i_dwmac_power_internal_phy(struct stmmac_priv *priv)
    {
    struct sunxi_priv_data *gmac = priv.plat.bsp_priv;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_unpower_internal_phy(gmac: *mut sunxi_priv_data) {
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_register_mdio_mux(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_unset_syscon(gmac: *mut sunxi_priv_data) {
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_exit(dev: *mut device, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_set_mac_loopback(ioaddr: *mut void __iomem, enable: bool) {
    static void sun8i_dwmac_set_mac_loopback(void __iomem *ioaddr, bool enable)
    {
    let mut value: u32 = readl(ioaddr + EMAC_BASIC_CTL0);
    if (enable)
    value |= EMAC_LOOPBACK;
    else
    value &= ~EMAC_LOOPBACK;
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_setup(ppriv: *mut c_void, mac: *mut mac_device_info) -> c_int {
...
// If no regmap is found then the other device driver is at fault
    regmap = dev_get_regmap(&syscon_pdev.dev, core::ptr::null_mut());
    if (!regmap)
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sun8i_dwmac_shutdown(pdev: *mut platform_device) {
