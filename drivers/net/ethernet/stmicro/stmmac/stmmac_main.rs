...
//! Source: drivers/net/ethernet/stmicro/stmmac/stmmac_main.c
#![no_std]
...
// Module parameters
pub const TX_TIMEO: c_int = 5000;
    let mut watchdog: static int = TX_TIMEO;
    module_param(watchdog, int, 0644);
    MODULE_PARM_DESC(watchdog, "Transmit timeout in milliseconds (default 5s)");
    let mut debug: static int = -1;
    module_param(debug, int, 0644);
    MODULE_PARM_DESC(debug, "Message Level (-1: default, 0: no output, 16: all)");
    let mut phyaddr: static int = -1;
    module_param(phyaddr, int, 0444);
    MODULE_PARM_DESC(phyaddr, "Physical device address");

// Limit to make sure XDP TX and slow path can coexist
pub const STMMAC_XSK_TX_BUDGET_MAX: c_int = 256;
pub const STMMAC_TX_XSK_AVAIL: c_int = 16;
pub const STMMAC_RX_FILL_BATCH: c_int = 16;
pub const STMMAC_XDP_PASS: c_int = 0;

    let mut flow_ctrl: static int = 0xdead;
    module_param(flow_ctrl, int, 0644);
    MODULE_PARM_DESC(flow_ctrl, "Flow control ability [on/off] (obsolete)");
    let mut pause: static int = PAUSE_TIME;
    module_param(pause, int, 0644);
    MODULE_PARM_DESC(pause, "Flow Control Pause Time (units of 512 bit times)");
pub const TC_DEFAULT: c_int = 64;
    let mut tc: static int = TC_DEFAULT;
    module_param(tc, int, 0644);
    MODULE_PARM_DESC(tc, "DMA threshold control value");
// This is unused
pub const DEFAULT_BUFSIZE: c_int = 1536;
    let mut buf_sz: static int = DEFAULT_BUFSIZE;
    module_param(buf_sz, int, 0644);
    MODULE_PARM_DESC(buf_sz, "DMA buffer size");
    static const u32 default_msg_level = (NETIF_MSG_DRV | NETIF_MSG_PROBE |
    NETIF_MSG_LINK | NETIF_MSG_IFUP |
    NETIF_MSG_IFDOWN | NETIF_MSG_TIMER);
pub const STMMAC_DEFAULT_LPI_TIMER: c_int = 1000;
    let mut eee_timer: static unsigned int = STMMAC_DEFAULT_LPI_TIMER;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stmmac_devlink_priv {
    pub stmmac_priv: *mut stmmac_priv,
}
...
//
    ...
    {
    let mut rate: c_long = rgmii_clock(speed);
...
//
#[no_mangle]
pub unsafe extern "C" fn stmmac_axi_blen_to_mask(regval: *mut u32, blen: *const u32, len: usize) {
    void stmmac_axi_blen_to_mask(u32 *regval, const u32 *blen, size_t len)
    {
    size_t i;
    u32 val;
    for (val = i = 0; i < len; i++) {
    let mut burst: u32 = blen[i];
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_verify_args() {
...
#[no_mangle]
unsafe extern "C" fn __stmmac_disable_all_queues(priv: *mut stmmac_priv) {
    static void __stmmac_disable_all_queues(struct stmmac_priv *priv)
    {
    let mut rx_queues_cnt: u8 = priv.plat.rx_queues_to_use;
    let mut tx_queues_cnt: u8 = priv.plat.tx_queues_to_use;
    let mut maxq: u8 = max(rx_queues_cnt, tx_queues_cnt);
    u8 queue;
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_disable_all_queues(priv: *mut stmmac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_enable_all_queues(priv: *mut stmmac_priv) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_service_event_schedule(priv: *mut stmmac_priv) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_global_err(priv: *mut stmmac_priv) {
...
#[no_mangle]
unsafe extern "C" fn print_pkt(buf: *mut c_uchar, len: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn stmmac_tx_avail(priv: *mut stmmac_priv, queue: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(STMMAC_TBS_AVAIL: tx_q->tbs &) -> else {
...
#[no_mangle]
unsafe extern "C" fn stmmac_get_rx_desc_size(priv: *mut stmmac_priv) -> usize {
...
//
    let mut rx_tail_addr: u32 = rx_q.dma_rx_phy + index * sizeof(struct dma_desc);
...
//
#[no_mangle]
pub unsafe extern "C" fn stmmac_rx_dirty(priv: *mut stmmac_priv, queue: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn stmmac_eee_tx_busy(priv: *mut stmmac_priv) -> bool {
    static bool stmmac_eee_tx_busy(struct stmmac_priv *priv)
    {
    let mut tx_cnt: u8 = priv.plat.tx_queues_to_use;
    u8 queue;
...
#[no_mangle]
unsafe extern "C" fn stmmac_restart_sw_lpi_timer(priv: *mut stmmac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_try_to_start_sw_lpi(priv: *mut stmmac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_stop_sw_lpi(priv: *mut stmmac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_eee_ctrl_timer(t: *mut timer_list) {
...
//
    ...
    {
    struct skb_shared_hwtstamps *shhwtstamp = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn stmmac_update_subsecond_increment(priv: *mut stmmac_priv) {
    static void stmmac_update_subsecond_increment(struct stmmac_priv *priv)
    {
    let mut xmac: bool = dwmac_is_xmac(priv.plat.core_type);
    let mut sec_inc: u32 = 0;
    let mut temp: u64 = 0;
...
//
    ...
    let mut ptp_v2: u32 = 0;
    let mut tstamp_all: u32 = 0;
    let mut ptp_over_ipv4_udp: u32 = 0;
    let mut ptp_over_ipv6_udp: u32 = 0;
    let mut ptp_over_ethernet: u32 = 0;
    let mut snap_type_sel: u32 = 0;
    let mut ts_master_en: u32 = 0;
    let mut ts_event_en: u32 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_init_timestamping(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(priv->dma_cap.atime_stamp: priv->extend_desc &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn stmmac_setup_ptp(priv: *mut stmmac_priv) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_release_ptp(priv: *mut stmmac_priv) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_legacy_serdes_power_down(priv: *mut stmmac_priv) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_legacy_serdes_power_up(priv: *mut stmmac_priv) -> c_int {
...
// Flow Control operation
    ...
    flow_ctrl = FLOW_AUTO;
#[no_mangle]
pub unsafe extern "C" fn if(!tx_pause: rx_pause &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn stmmac_mac_disable_tx_lpi(config: *mut phylink_config) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_check_pcs_mode(priv: *mut stmmac_priv) {
    static void stmmac_check_pcs_mode(struct stmmac_priv *priv)
    {
    let mut interface: c_int = priv.plat.phy_interface;
    let mut speed: c_int = priv.plat.mac_port_sel_speed;
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_init_phy(dev: *mut net_device) -> c_int {
    static int stmmac_init_phy(struct net_device *dev)
    {
    struct stmmac_priv *priv = netdev_priv(dev);
    let mut mode: c_int = priv.plat.phy_interface;
    struct fwnode_handle *phy_fwnode;
    struct fwnode_handle *fwnode;
    struct ethtool_keee eee;
    let mut dev_flags: u32 = 0;
    int ret;
...
//
    ...
    let mut addr: c_int = priv.plat.phy_addr;
...
#[no_mangle]
unsafe extern "C" fn stmmac_phylink_setup(priv: *mut stmmac_priv) -> c_int {
...
// All full duplex speeds above 100Mbps are supported
    ...
    {
    let mut rx_cnt: u8 = priv.plat.rx_queues_to_use;
...
#[no_mangle]
unsafe extern "C" fn stmmac_rx_offset(priv: *mut stmmac_priv) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn stmmac_set_bfsize(mtu: c_int) -> c_int {
    ...
    ret = BUF_SIZE_16KiB;
#[no_mangle]
pub unsafe extern "C" fn if(BUF_SIZE_4KiB: mtu >=) -> else {
    else if (mtu >= BUF_SIZE_4KiB)
    ret = BUF_SIZE_8KiB;
#[no_mangle]
pub unsafe extern "C" fn if(BUF_SIZE_2KiB: mtu >=) -> else {
    else if (mtu >= BUF_SIZE_2KiB)
    ret = BUF_SIZE_4KiB;
#[no_mangle]
pub unsafe extern "C" fn if(DEFAULT_BUFSIZE: mtu >) -> else {
...
// Clear the TX descriptors
    ...
    let mut last: c_int = (i == (dma_conf.dma_tx_size - 1));
    struct dma_desc *p;
...
//
    ...
    struct stmmac_dma_conf *dma_conf)
    {
    let mut rx_queue_cnt: u8 = priv.plat.rx_queues_to_use;
    let mut tx_queue_cnt: u8 = priv.plat.tx_queues_to_use;
    u8 queue;
// Clear the RX descriptors
...
//
    ...
    let mut gfp: gfp_t = (GFP_ATOMIC | __GFP_NOWARN);
    ...
    buf.sec_page = core::ptr::null_mut();
...
//
    ...
    tx_q.tx_skbuff[i] = core::ptr::null_mut();
    }
...
// Setup the chained descriptor addresses
    ...
    {
    struct stmmac_priv *priv = netdev_priv(dev);
    let mut rx_count: u8 = priv.plat.rx_queues_to_use;
    int queue;
    int ret;
// RX INITIALIZATION
    netif_dbg(priv, probe, priv.dev,
    ...
    rx_q.xsk_pool = core::ptr::null_mut();
    queue--;
    }
    return ret;
    }
...
//
    ...
    tx_q.xsk_frames_done = 0;
    tx_q.xsk_pool = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_free_tx_skbufs(priv: *mut stmmac_priv) {
...
// Release the DMA TX socket buffers
    ...
    struct stmmac_dma_conf *dma_conf)
    {
    let mut tx_count: u8 = priv.plat.tx_queues_to_use;
    u8 queue;
...
//
    ...
    struct stmmac_rx_queue *rx_q = &dma_conf.rx_queue[queue];
    struct stmmac_channel *ch = &priv.channel[queue];
    let mut xdp_prog: bool = stmmac_xdp_is_enabled(priv);
    ...
    rx_q.page_pool = core::ptr::null_mut();
    return ret;
    }
...
//
    ...
    {
// RX Allocation
    let mut ret: c_int = alloc_dma_rx_desc_resources(priv, dma_conf);
    if (ret)
    return ret;
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_mac_enable_rx_queues(priv: *mut stmmac_priv) {
    static void stmmac_mac_enable_rx_queues(struct stmmac_priv *priv)
    {
    let mut rx_queues_count: u8 = priv.plat.rx_queues_to_use;
    u8 queue;
    u8 mode;
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_start_rx_dma(priv: *mut stmmac_priv, chan: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_start_tx_dma(priv: *mut stmmac_priv, chan: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_stop_rx_dma(priv: *mut stmmac_priv, chan: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_stop_tx_dma(priv: *mut stmmac_priv, chan: u32) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_enable_all_dma_irq(priv: *mut stmmac_priv) {
    static void stmmac_enable_all_dma_irq(struct stmmac_priv *priv)
    {
    let mut rx_channels_count: u8 = priv.plat.rx_queues_to_use;
    let mut tx_channels_count: u8 = priv.plat.tx_queues_to_use;
    let mut dma_csr_ch: u8 = max(rx_channels_count, tx_channels_count);
    u8 chan;
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_start_all_dma(priv: *mut stmmac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_stop_all_dma(priv: *mut stmmac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_dma_operation_mode(priv: *mut stmmac_priv) {
    static void stmmac_dma_operation_mode(struct stmmac_priv *priv)
    {
    let mut rx_channels_count: u8 = priv.plat.rx_queues_to_use;
    let mut tx_channels_count: u8 = priv.plat.tx_queues_to_use;
    let mut rxfifosz: c_int = priv.plat.rx_fifo_size;
    let mut txfifosz: c_int = priv.plat.tx_fifo_size;
    let mut txmode: u32 = 0;
    let mut rxmode: u32 = 0;
    let mut qmode: u8 = 0;
    u8 chan;
    if (rxfifosz == 0)
...
#[no_mangle]
unsafe extern "C" fn stmmac_xsk_request_timestamp(_priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_xsk_fill_timestamp(_priv: *mut c_void) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn stmmac_xsk_request_launch_time(launch_time: u64, _priv: *mut c_void) {
    static void stmmac_xsk_request_launch_time(u64 launch_time, void *_priv)
    {
    let mut ts: timespec64 = ns_to_timespec64(launch_time);
    struct stmmac_metadata_request *meta_req = _priv;
...
#[no_mangle]
unsafe extern "C" fn stmmac_xdp_xmit_zc(priv: *mut stmmac_priv, queue: u32, budget: u32) -> bool {
    static bool stmmac_xdp_xmit_zc(struct stmmac_priv *priv, u32 queue, u32 budget)
    {
    struct netdev_queue *nq = netdev_get_tx_queue(priv.dev, queue);
    struct stmmac_tx_queue *tx_q = &priv.dma_conf.tx_queue[queue];
    struct stmmac_txq_stats *txq_stats = &priv.xstats.txq_stats[queue];
    let mut csum: bool = !priv.plat.tx_queues_cfg[queue].coe_unsupported;
    struct xsk_buff_pool *pool = tx_q.xsk_pool;
    let mut entry: c_uint = tx_q.cur_tx;
    struct dma_desc *tx_desc = core::ptr::null_mut();
    struct xdp_desc xdp_desc;
    let mut work_done: bool = true;
    let mut tx_set_ic_bit: u32 = 0;
// Avoids TX time-out as we are sharing with slow path
    txq_trans_cond_update(nq);
    budget = min(budget, stmmac_tx_avail(priv, queue));
    for (; budget > 0; budget--) {
    struct stmmac_metadata_request meta_req;
    struct xsk_tx_metadata *meta = core::ptr::null_mut();
    dma_addr_t dma_addr;
    bool set_ic;
...
//
    ...
    tx_q.xdpf[entry] = core::ptr::null_mut();
    stmmac_set_desc_addr(priv, tx_desc, dma_addr);
    tx_q.tx_count_frames++;
    if (!priv.tx_coal_frames[queue])
    set_ic = false;
#[no_mangle]
pub unsafe extern "C" fn if(0: tx_q->tx_count_frames % priv->tx_coal_frames[queue] ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn stmmac_bump_dma_threshold(priv: *mut stmmac_priv, chan: u32) {
...
//
    ...
    let mut tx_packets: u32 = 0, tx_errors = 0;
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_tx_err(priv: *mut stmmac_priv, chan: u32) {
...
//
    ...
    u32 rxmode, u32 chan)
    {
    let mut rxqmode: u8 = priv.plat.rx_queues_cfg[chan].mode_to_use;
    let mut txqmode: u8 = priv.plat.tx_queues_cfg[chan].mode_to_use;
    let mut rx_channels_count: u8 = priv.plat.rx_queues_to_use;
    let mut tx_channels_count: u8 = priv.plat.tx_queues_to_use;
    let mut rxfifosz: c_int = priv.plat.rx_fifo_size;
    let mut txfifosz: c_int = priv.plat.tx_fifo_size;
...
#[no_mangle]
unsafe extern "C" fn stmmac_safety_feat_interrupt(priv: *mut stmmac_priv) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stmmac_napi_check(priv: *mut stmmac_priv, chan: u32, dir: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_dma_interrupt(priv: *mut stmmac_priv) {
    static void stmmac_dma_interrupt(struct stmmac_priv *priv)
    {
    let mut tx_channel_count: u8 = priv.plat.tx_queues_to_use;
    let mut rx_channel_count: u8 = priv.plat.rx_queues_to_use;
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_mmc_setup(priv: *mut stmmac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_get_hw_features(priv: *mut stmmac_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_check_ether_addr(priv: *mut stmmac_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn stmmac_get_phy_intf_sel(interface: phy_interface_t) -> c_int {
    int stmmac_get_phy_intf_sel(phy_interface_t interface)
    {
    let mut phy_intf_sel: c_int = -EINVAL;
    if (interface == PHY_INTERFACE_MODE_MII ||
    interface == PHY_INTERFACE_MODE_GMII)
    phy_intf_sel = PHY_INTF_SEL_GMII_MII;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: phy_interface_mode_is_rgmii(interface)) -> else {
    else if (phy_interface_mode_is_rgmii(interface))
    phy_intf_sel = PHY_INTF_SEL_RGMII;
#[no_mangle]
pub unsafe extern "C" fn if(PHY_INTERFACE_MODE_RMII: interface ==) -> else {
    else if (interface == PHY_INTERFACE_MODE_RMII)
    phy_intf_sel = PHY_INTF_SEL_RMII;
#[no_mangle]
pub unsafe extern "C" fn if(PHY_INTERFACE_MODE_REVMII: interface ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn stmmac_prereset_configure(priv: *mut stmmac_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_init_dma_engine(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_tx_timer_arm(priv: *mut stmmac_priv, queue: u32) {
    static void stmmac_tx_timer_arm(struct stmmac_priv *priv, u32 queue)
    {
    struct stmmac_tx_queue *tx_q = &priv.dma_conf.tx_queue[queue];
    let mut tx_coal_timer: u32 = priv.tx_coal_timer[queue];
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_tx_timer(t: *mut hrtimer) -> enum hrtimer_restart {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_init_coalesce(priv: *mut stmmac_priv) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_set_rings_length(priv: *mut stmmac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_set_tx_queue_weight(priv: *mut stmmac_priv) {
    static void stmmac_set_tx_queue_weight(struct stmmac_priv *priv)
    {
    let mut tx_queues_count: u8 = priv.plat.tx_queues_to_use;
    u32 weight;
    u8 queue;
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_configure_cbs(priv: *mut stmmac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_rx_queue_dma_chan_map(priv: *mut stmmac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_mac_config_rx_queues_prio(priv: *mut stmmac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_mac_config_tx_queues_prio(priv: *mut stmmac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_mac_config_rx_queues_routing(priv: *mut stmmac_priv) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_mac_config_rss(priv: *mut stmmac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_mtl_configuration(priv: *mut stmmac_priv) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_safety_feat_configuration(priv: *mut stmmac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_hw_setup(dev: *mut net_device) -> c_int {
...
// TBS
    for (chan = 0; chan < tx_cnt; chan++) {
    struct stmmac_tx_queue *tx_q = &priv.dma_conf.tx_queue[chan];
    let mut enable: c_int = tx_q.tbs & STMMAC_TBS_AVAIL;
...
// Start the ball rolling...
    ...
    if (msi.tx_irq[j] > 0) {
    irq_set_affinity_hint(msi.tx_irq[j], core::ptr::null_mut());
    ...
    for (j = irq_idx - 1; msi && j >= 0; j--) {
    if (msi.rx_irq[j] > 0) {
    irq_set_affinity_hint(msi.rx_irq[j], core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn stmmac_request_irq_multi_msi(dev: *mut net_device) -> c_int {
    static int stmmac_request_irq_multi_msi(struct net_device *dev)
    {
    struct stmmac_priv *priv = netdev_priv(dev);
    struct stmmac_msi *msi = priv.msi;
    enum request_irq_err irq_err;
    let mut irq_idx: c_int = 0;
    char *int_name;
    int ret;
    int i;
...
#[no_mangle]
unsafe extern "C" fn stmmac_request_irq_single(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_request_irq(dev: *mut net_device) -> c_int {
...
// Earlier check for TBS
    ...
    let mut tbs_en: c_int = priv.plat.tx_queues_cfg[chan].tbs_en;
...
#[no_mangle]
unsafe extern "C" fn stmmac_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __stmmac_release(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_release(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_flush_tx_descriptors(priv: *mut stmmac_priv, queue: c_int) {
    static void stmmac_flush_tx_descriptors(struct stmmac_priv *priv, int queue)
    {
    struct stmmac_tx_queue *tx_q = &priv.dma_conf.tx_queue[queue];
...
#[no_mangle]
unsafe extern "C" fn stmmac_set_gso_features(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_tso_header_size(skb: *mut sk_buff) -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_tso_valid_packet(skb: *mut sk_buff) -> bool {
    static bool stmmac_tso_valid_packet(struct sk_buff *skb)
    {
    let mut header_len: usize = stmmac_tso_header_size(skb);
    let mut gso_size: c_uint = skb_shinfo(skb).gso_size;
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_tso_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t stmmac_tso_xmit(struct sk_buff *skb, struct net_device *dev)
    {
    struct dma_desc *desc, *first, *mss_desc = core::ptr::null_mut();
    struct stmmac_priv *priv = netdev_priv(dev);
...
// Manage tx mitigation
    ...
    set_ic = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !priv->tx_coal_frames[queue]) -> else {
    else if (!priv.tx_coal_frames[queue])
    set_ic = false;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !netdev_xmit_more()) -> else {
    else if (!netdev_xmit_more())
    set_ic = true;
#[no_mangle]
pub unsafe extern "C" fn if(priv->tx_coal_frames[queue]: tx_packets >) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_has_ip_ethertype(skb: *mut sk_buff) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t stmmac_xmit(struct sk_buff *skb, struct net_device *dev)
    {
    bool enh_desc, has_vlan, set_ic, is_jumbo = false;
    struct stmmac_priv *priv = netdev_priv(dev);
    let mut nopaged_len: c_uint = skb_headlen(skb);
    let mut queue: u32 = skb_get_queue_mapping(skb);
...
// To program the descriptors according to the size of the frame
    ...
    let mut last_segment: bool = (nfrags == 0);
...
//
    ...
    let mut ts: timespec64 = ns_to_timespec64(skb.tstamp);
    stmmac_set_desc_tbs(priv, dma_desc_to_edesc(first_desc),
    ts.tv_sec, ts.tv_nsec);
    }
    for (i = 0; i < nfrags; i++) {
    const skb_frag_t *frag = &skb_shinfo(skb).frags[i];
    let mut frag_size: c_uint = skb_frag_size(frag);
    let mut last_segment: bool = (i == (nfrags - 1));
    entry = STMMAC_NEXT_ENTRY(entry, priv.dma_conf.dma_tx_size);
    WARN_ON(tx_q.tx_skbuff[entry]);
    desc = stmmac_get_tx_desc(priv, tx_q, entry);
...
#[no_mangle]
unsafe extern "C" fn stmmac_rx_vlan(dev: *mut net_device, skb: *mut sk_buff) {
    static void stmmac_rx_vlan(struct net_device *dev, struct sk_buff *skb)
    {
    struct vlan_ethhdr *veth = skb_vlan_eth_hdr(skb);
    let mut vlan_proto: __be16 = veth.h_vlan_proto;
    u16 vlanid;
...
//
#[no_mangle]
pub unsafe extern "C" fn stmmac_rx_refill(priv: *mut stmmac_priv, queue: u32) {
    static inline void stmmac_rx_refill(struct stmmac_priv *priv, u32 queue)
    {
    struct stmmac_rx_queue *rx_q = &priv.dma_conf.rx_queue[queue];
    let mut dirty: c_int = stmmac_rx_dirty(priv, queue);
    let mut entry: c_uint = rx_q.dirty_rx;
    let mut gfp: gfp_t = (GFP_ATOMIC | __GFP_NOWARN);
    if (priv.dma_cap.host_dma_width <= 32)
    gfp |= GFP_DMA32;
    while (dirty-- > 0) {
...
// Wake up Rx DMA from the suspend state if required
    ...
    {
    let mut plen: c_uint = 0, hlen = 0;
    let mut coe: c_int = priv.hw.rx_csum;
...
// GMAC4 or last descriptor
    ...
    struct xdp_buff *xdp)
    {
    let mut zc: bool = !!(xdp.rxq.mem.type == MEM_TYPE_XSK_BUFF_POOL);
...
//
    ...
    let mut datasize: c_uint = xdp.data_end - xdp.data;
    struct sk_buff *skb;
    ...
    struct stmmac_channel *ch = &priv.channel[queue];
    let mut len: c_uint = xdp.data_end - xdp.data;
...
#[no_mangle]
unsafe extern "C" fn stmmac_rx_refill_zc(priv: *mut stmmac_priv, queue: u32, budget: u32) -> bool {
    static bool stmmac_rx_refill_zc(struct stmmac_priv *priv, u32 queue, u32 budget)
    {
    struct stmmac_rx_queue *rx_q = &priv.dma_conf.rx_queue[queue];
    let mut entry: c_uint = rx_q.dirty_rx;
    struct dma_desc *rx_desc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn stmmac_rx_zc(priv: *mut stmmac_priv, limit: c_int, queue: u32) -> c_int {
    static int stmmac_rx_zc(struct stmmac_priv *priv, int limit, u32 queue)
    {
    struct stmmac_rxq_stats *rxq_stats = &priv.xstats.rxq_stats[queue];
    struct stmmac_rx_queue *rx_q = &priv.dma_conf.rx_queue[queue];
    let mut count: c_uint = 0, error = 0, len = 0;
    let mut dirty: c_int = stmmac_rx_dirty(priv, queue);
    let mut next_entry: c_uint = rx_q.cur_rx;
    let mut rx_errors: u32 = 0, rx_dropped = 0;
    unsigned int desc_size;
    struct bpf_prog *prog;
    let mut failure: bool = false;
    let mut xdp_status: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_rx(priv: *mut stmmac_priv, limit: c_int, queue: u32) -> c_int {
    static int stmmac_rx(struct stmmac_priv *priv, int limit, u32 queue)
    {
    let mut rx_errors: u32 = 0, rx_dropped = 0, rx_bytes = 0, rx_packets = 0;
    struct stmmac_rxq_stats *rxq_stats = &priv.xstats.rxq_stats[queue];
    struct stmmac_rx_queue *rx_q = &priv.dma_conf.rx_queue[queue];
    struct stmmac_channel *ch = &priv.channel[queue];
    let mut count: c_uint = 0, error = 0, len = 0;
    let mut status: c_int = 0, coe = priv.hw.rx_csum;
    let mut next_entry: c_uint = rx_q.cur_rx;
    ...
    while (count < limit) {
    let mut buf1_len: c_uint = 0, buf2_len = 0;
    enum pkt_hash_types hash_type;
    struct stmmac_rx_buffer *buf;
    struct dma_desc *np, *p;
    int entry;
...
// For Not XDP_PASS verdict
    if (IS_ERR(skb)) {
    let mut xdp_res: c_uint = -PTR_ERR(skb);
...
#[no_mangle]
unsafe extern "C" fn stmmac_napi_poll_rx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_napi_poll_tx(napi: *mut napi_struct, budget: c_int) -> c_int {
    ...
    struct stmmac_priv *priv = ch.priv_data;
    struct stmmac_txq_stats *txq_stats;
    let mut pending_packets: bool = false;
    let mut chan: u32 = ch.index;
    int work_done;
...
#[no_mangle]
unsafe extern "C" fn stmmac_napi_poll_rxtx(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int stmmac_napi_poll_rxtx(struct napi_struct *napi, int budget)
    {
    struct stmmac_channel *ch =
    container_of(napi, struct stmmac_channel, rxtx_napi);
    struct stmmac_priv *priv = ch.priv_data;
    let mut tx_pending_packets: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_set_rx_mode(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_change_mtu(dev: *mut net_device, new_mtu: c_int) -> c_int {
    static int stmmac_change_mtu(struct net_device *dev, int new_mtu)
    {
    struct stmmac_priv *priv = netdev_priv(dev);
    let mut txfifosz: c_int = priv.plat.tx_fifo_size;
    struct stmmac_dma_conf *dma_conf;
    let mut mtu: c_int = new_mtu;
    int ret;
    if (txfifosz == 0)
    txfifosz = priv.dma_cap.tx_fifo_size;
...
//
    ...
    if (priv.sph_capable) {
    let mut sph_en: bool = (priv.hw.rx_csum > 0) && priv.sph_active;
    u8 chan;
...
#[no_mangle]
unsafe extern "C" fn stmmac_common_interrupt(priv: *mut stmmac_priv) {
...
// To handle GMAC own interrupts
    ...
    let mut status: c_int = stmmac_host_irq_status(priv, &priv.xstats);
    if (unlikely(status)) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t stmmac_interrupt(int irq, void *dev_id)
    {
...
#[no_mangle]
unsafe extern "C" fn stmmac_mac_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t stmmac_mac_interrupt(int irq, void *dev_id)
    {
    struct net_device *dev = (struct net_device *)dev_id;
    struct stmmac_priv *priv = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn stmmac_safety_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t stmmac_safety_interrupt(int irq, void *dev_id)
    {
    struct net_device *dev = (struct net_device *)dev_id;
    struct stmmac_priv *priv = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn stmmac_msi_intr_tx(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t stmmac_msi_intr_tx(int irq, void *data)
    {
    struct stmmac_tx_queue *tx_q = (struct stmmac_tx_queue *)data;
    struct stmmac_dma_conf *dma_conf;
    let mut chan: c_int = tx_q.queue_index;
...
#[no_mangle]
unsafe extern "C" fn stmmac_msi_intr_rx(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t stmmac_msi_intr_rx(int irq, void *data)
    {
    struct stmmac_rx_queue *rx_q = (struct stmmac_rx_queue *)data;
    struct stmmac_dma_conf *dma_conf;
    let mut chan: c_int = rx_q.queue_index;
    struct stmmac_priv *priv;
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_ioctl(dev: *mut net_device, rq: *mut ifreq, cmd: c_int) -> c_int {
    ...
    {
    let mut gso: c_int = skb_shinfo(skb).gso_type;
...
//
    ...
    return netdev_pick_tx(dev, skb, core::ptr::null_mut()) % dev.real_num_tx_queues;
    }
#[no_mangle]
unsafe extern "C" fn stmmac_set_mac_address(ndev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_rings_status_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_dma_cap_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_init_fs(dev: *mut net_device) {
    static void stmmac_init_fs(struct net_device *dev)
    {
    struct stmmac_priv *priv = netdev_priv(dev);
    rtnl_lock();
...
#[no_mangle]
unsafe extern "C" fn stmmac_exit_fs(dev: *mut net_device) {
    static void stmmac_exit_fs(struct net_device *dev)
    {
    struct stmmac_priv *priv = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn stmmac_vid_crc32_le(vid_le: __le16) -> u32 {
    static u32 stmmac_vid_crc32_le(__le16 vid_le)
    {
    unsigned char *data = (unsigned char *)&vid_le;
    let mut data_byte: c_uchar = 0;
    let mut crc: u32 = ~0x0;
    let mut temp: u32 = 0;
    int i, bits;
...
#[no_mangle]
unsafe extern "C" fn stmmac_vlan_update(priv: *mut stmmac_priv, is_double: bool) -> c_int {
    static int stmmac_vlan_update(struct stmmac_priv *priv, bool is_double)
    {
    u32 crc, hash = 0;
    let mut pmatch: u16 = 0;
    let mut count: c_int = 0;
    let mut vid: u16 = 0;
    for_each_set_bit(vid, priv.active_vlans, VLAN_N_VID) {
    let mut vid_le: __le16 = cpu_to_le16(vid);
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_vlan_rx_add_vid(ndev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_vlan_rx_kill_vid(ndev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_vlan_restore(priv: *mut stmmac_priv) {
    static void stmmac_vlan_restore(struct stmmac_priv *priv)
    {
...
#[no_mangle]
unsafe extern "C" fn stmmac_bpf(dev: *mut net_device, bpf: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn stmmac_disable_rx_queue(priv: *mut stmmac_priv, queue: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn stmmac_enable_rx_queue(priv: *mut stmmac_priv, queue: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn stmmac_disable_tx_queue(priv: *mut stmmac_priv, queue: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn stmmac_enable_tx_queue(priv: *mut stmmac_priv, queue: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn stmmac_xdp_release(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn stmmac_xdp_open(dev: *mut net_device) -> c_int {
    int stmmac_xdp_open(struct net_device *dev)
    {
    struct stmmac_priv *priv = netdev_priv(dev);
    let mut rx_cnt: u8 = priv.plat.rx_queues_to_use;
    let mut tx_cnt: u8 = priv.plat.tx_queues_to_use;
    let mut dma_csr_ch: u8 = max(rx_cnt, tx_cnt);
    struct stmmac_rx_queue *rx_q;
    struct stmmac_tx_queue *tx_q;
    bool sph_en;
    u8 chan;
...
#[no_mangle]
pub unsafe extern "C" fn stmmac_xsk_wakeup(dev: *mut net_device, queue: u32, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_get_stats64(dev: *mut net_device, stats: *mut rtnl_link_stats64) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_reset_subtask(priv: *mut stmmac_priv) {
    ...
    dev_close(priv.dev);
    dev_open(priv.dev, core::ptr::null_mut());
    clear_bit(STMMAC_DOWN, &priv.state);
    clear_bit(STMMAC_RESETING, &priv.state);
    rtnl_unlock();
    }
#[no_mangle]
unsafe extern "C" fn stmmac_service_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_print_actphyif(priv: *mut stmmac_priv) {
    ...
    actphyif_str = core::ptr::null_mut();
    if (!actphyif_str)
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_hw_init(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: priv->dma_cap.rx_coe_type1) -> else {
...
#[no_mangle]
unsafe extern "C" fn stmmac_napi_add(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_napi_del(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn stmmac_reinit_queues(dev: *mut net_device, rx_cnt: u8, tx_cnt: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn stmmac_reinit_ringparam(dev: *mut net_device, rx_size: u32, tx_size: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_xdp_rx_timestamp(_ctx: *const xdp_md, timestamp: *mut u64) -> c_int {
...
//
    ...
    stmmac_dl_ts_coarse_set, core::ptr::null_mut()),
    };
// None of the generic devlink parameters are implemented
    let mut stmmac_devlink_ops: static struct devlink_ops = {};
#[no_mangle]
unsafe extern "C" fn stmmac_register_devlink(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_unregister_devlink(priv: *mut stmmac_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn if(DWMAC_CORE_4_00: priv->plat->enh_desc || priv->synopsys_id >=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(ndev->max_mtu: priv->plat->maxmtu <) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn stmmac_dvr_remove(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn stmmac_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_reset_rx_queue(priv: *mut stmmac_priv, queue: u32) {
    static void stmmac_reset_rx_queue(struct stmmac_priv *priv, u32 queue)
    {
    struct stmmac_rx_queue *rx_q = &priv.dma_conf.rx_queue[queue];
    rx_q.cur_rx = 0;
...
#[no_mangle]
unsafe extern "C" fn stmmac_reset_tx_queue(priv: *mut stmmac_priv, queue: u32) {
    static void stmmac_reset_tx_queue(struct stmmac_priv *priv, u32 queue)
    {
    struct stmmac_tx_queue *tx_q = &priv.dma_conf.tx_queue[queue];
    tx_q.cur_tx = 0;
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_reset_queues_param(priv: *mut stmmac_priv) {
    static void stmmac_reset_queues_param(struct stmmac_priv *priv)
    {
    let mut rx_cnt: u8 = priv.plat.rx_queues_to_use;
    let mut tx_cnt: u8 = priv.plat.tx_queues_to_use;
...
//
#[no_mangle]
pub unsafe extern "C" fn stmmac_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmmac_cmdline_opt(str: *mut c_char) -> int __init {
    static int __init stmmac_cmdline_opt(char *str)
    {
    char *opt;
    if (!str || !*str)
    return 1;
    while ((opt = strsep(&str, ",")) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn stmmac_init() -> int __init {
    static int __init stmmac_init(void)
    {

// Create debugfs main directory if it doesn't exist yet
    if (!stmmac_fs_dir)
    stmmac_fs_dir = debugfs_create_dir(STMMAC_RESOURCE_NAME, core::ptr::null_mut());
    register_netdevice_notifier(&stmmac_notifier);

    return 0;
    }
#[no_mangle]
unsafe extern "C" fn stmmac_exit() -> void __exit {
