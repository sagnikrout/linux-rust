...
//! Source: drivers/net/ethernet/stmicro/stmmac/stmmac_hwtstamp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn config_hw_tstamping(ioaddr: *mut void __iomem, data: u32) {
    static void config_hw_tstamping(void __iomem *ioaddr, u32 data)
    {
    let mut regval: u32 = readl(ioaddr + PTP_TCR);
    ...
    {
    let mut value: u32 = readl(ioaddr + PTP_TCR);
    unsigned long data;
    u32 reg_value;
...
#[no_mangle]
unsafe extern "C" fn hwtstamp_correct_latency(priv: *mut stmmac_priv) {
...
#[no_mangle]
unsafe extern "C" fn init_systime(ioaddr: *mut void __iomem, sec: u32, nsec: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn config_addend(ioaddr: *mut void __iomem, addend: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_systime(ioaddr: *mut void __iomem, systime: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn get_ptptime(ptpaddr: *mut void __iomem, ptp_time: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn timestamp_interrupt(priv: *mut stmmac_priv) {
