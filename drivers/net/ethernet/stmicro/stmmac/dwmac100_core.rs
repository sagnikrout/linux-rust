...
//! Source: drivers/net/ethernet/stmicro/stmmac/dwmac100_core.c
#![no_std]
...
//
    ...
    let mut value: u32 = readl(ioaddr + MAC_CONTROL);
    value |= MAC_CORE_INIT;
...
#[no_mangle]
unsafe extern "C" fn dwmac100_dump_mac_regs(hw: *mut mac_device_info, reg_space: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn dwmac100_rx_ipc_enable(hw: *mut mac_device_info) -> c_int {
...
//
    ...
    {
    void __iomem *ioaddr = hw.pcsr;
    let mut flow: c_uint = MAC_FLOW_CTRL_ENABLE;
    if (duplex)
...
#[no_mangle]
unsafe extern "C" fn dwmac100_pmt(hw: *mut mac_device_info, mode: c_ulong) {
    static void dwmac100_pmt(struct mac_device_info *hw, unsigned long mode)
    {
    return;
    }
#[no_mangle]
unsafe extern "C" fn dwmac100_set_mac_loopback(ioaddr: *mut void __iomem, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn dwmac100_setup(priv: *mut stmmac_priv) -> c_int {
