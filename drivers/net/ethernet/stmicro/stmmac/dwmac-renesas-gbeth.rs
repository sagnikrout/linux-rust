...
//! Source: drivers/net/ethernet/stmicro/stmmac/dwmac-renesas-gbeth.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct renesas_gbeth_of_data {
    pub clks: *const *const c_char,
    pub num_clks: u8,
    pub stmmac_flags: u32,
    pub handle_reset: bool,
    pub set_clk_tx_rate: bool,
    pub has_pcs: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct renesas_gbeth {
    pub of_data: *const renesas_gbeth_of_data,
...
#[no_mangle]
unsafe extern "C" fn renesas_gmac_pcs_init(priv: *mut stmmac_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_gmac_pcs_exit(priv: *mut stmmac_priv) {
...
#[no_mangle]
unsafe extern "C" fn renesas_gbeth_init(dev: *mut device, priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_gbeth_exit(dev: *mut device, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn renesas_gbeth_probe(pdev: *mut platform_device) -> c_int {
    ...
    gbeth.rstc = devm_reset_control_get_exclusive(dev, core::ptr::null_mut());
