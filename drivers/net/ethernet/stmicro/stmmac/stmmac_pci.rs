...
//! Source: drivers/net/ethernet/stmicro/stmmac/stmmac_pci.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn common_default_data(plat: *mut plat_stmmacenet_data) {
...
//
#[no_mangle]
unsafe extern "C" fn stmmac_pci_remove(pdev: *mut pci_dev) {
    static void stmmac_pci_remove(struct pci_dev *pdev)
    {
    stmmac_dvr_remove(&pdev.dev);
    }
// synthetic ID, no official vendor
pub const PCI_VENDOR_ID_STMMAC: c_uint = 0x0700;
pub const PCI_DEVICE_ID_STMMAC_STMMAC: c_uint = 0x1108;
pub const PCI_DEVICE_ID_SYNOPSYS_GMAC5_ID: c_uint = 0x7102;
