...
//! Source: drivers/net/bonding/bond_netlink.c
#![no_std]
...
// Limit the max delay range to 300s
    ...
    let mut queue_id: u16 = nla_get_u16(data[IFLA_BOND_SLAVE_QUEUE_ID]);
...
// queue_id option setting expects slave_name:queue_id
    ...
    let mut prio: c_int = nla_get_s32(data[IFLA_BOND_SLAVE_PRIO]);
    ...
    let mut ad_prio: u16 = nla_get_u16(data[IFLA_BOND_SLAVE_ACTOR_PORT_PRIO]);
    ...
    struct bonding *bond = netdev_priv(bond_dev);
    struct bond_opt_value newval;
    let mut miimon: c_int = 0;
    let mut err: c_int = 0;
    if (!data)
    return 0;
    if (data[IFLA_BOND_MODE]) {
    let mut mode: c_int = nla_get_u8(data[IFLA_BOND_MODE]);
    ...
    let mut ifindex: c_int = nla_get_u32(data[IFLA_BOND_ACTIVE_SLAVE]);
    struct net_device *slave_dev;
    char *active_slave = "";
    if (ifindex != 0) {
    ...
    let mut updelay: c_int = nla_get_u32(data[IFLA_BOND_UPDELAY]);
    ...
    let mut downdelay: c_int = nla_get_u32(data[IFLA_BOND_DOWNDELAY]);
    ...
    let mut delay: c_int = nla_get_u32(data[IFLA_BOND_PEER_NOTIF_DELAY]);
    ...
    let mut arp_interval: c_int = nla_get_u32(data[IFLA_BOND_ARP_INTERVAL]);
    ...
    bond_opt_initval(&newval, ( u64)target);
    ...
    let mut arp_validate: c_int = nla_get_u32(data[IFLA_BOND_ARP_VALIDATE]);
    ...
    let mut ifindex: c_int = nla_get_u32(data[IFLA_BOND_PRIMARY]);
    ...
    let mut lacp_active: c_int = nla_get_u8(data[IFLA_BOND_AD_LACP_ACTIVE]);
    ...
    let mut dynamic_lb: c_int = nla_get_u8(data[IFLA_BOND_TLB_DYNAMIC_LB]);
    ...
    let mut missed_max: c_int = nla_get_u8(data[IFLA_BOND_MISSED_MAX]);
    ...
    let mut coupled_control: c_int = nla_get_u8(data[IFLA_BOND_COUPLED_CONTROL]);
    ...
    let mut broadcast_neigh: c_int = nla_get_u8(data[IFLA_BOND_BROADCAST_NEIGH]);
    ...
    let mut fallback_mode: c_int = nla_get_u8(data[IFLA_BOND_LACP_STRICT]);
...
#[no_mangle]
unsafe extern "C" fn bond_get_size(bond_dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn bond_option_active_slave_get_ifindex_rcu(bond: *const bonding) -> c_int {
    ...
    let mut ifindex: c_int = bond_option_active_slave_get_ifindex_rcu(bond);
...
#[no_mangle]
unsafe extern "C" fn bond_get_linkxstats_size(dev: *const net_device, attr: c_int) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn bond_netlink_init() -> int __init {
    int __init bond_netlink_init(void)
    {
    return rtnl_link_register(&bond_link_ops);
    }
#[no_mangle]
pub unsafe extern "C" fn bond_netlink_fini() {
