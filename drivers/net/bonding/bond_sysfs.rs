...
//! Source: drivers/net/bonding/bond_sysfs.c
#![no_std]
...
// Show link status of the bond interface.
    ...
    {
    struct bonding *bond = to_bond(d);
    let mut active: bool = netif_carrier_ok(bond.dev);
    return sysfs_emit(buf, "%s\n", active ? "up" : "down");
    }
    static DEVICE_ATTR(mii_status, 0444, bonding_show_mii_status, core::ptr::null_mut());
// Show current 802.3ad aggregator ID.
    ...
    static DEVICE_ATTR(ad_aggregator, 0444, bonding_show_ad_aggregator, core::ptr::null_mut());
// Show number of active 802.3ad ports.
    ...
    static DEVICE_ATTR(ad_num_ports, 0444, bonding_show_ad_num_ports, core::ptr::null_mut());
// Show current 802.3ad actor key.
    ...
    static DEVICE_ATTR(ad_actor_key, 0444, bonding_show_ad_actor_key, core::ptr::null_mut());
// Show current 802.3ad partner key.
    ...
    static DEVICE_ATTR(ad_partner_key, 0444, bonding_show_ad_partner_key, core::ptr::null_mut());
// Show current 802.3ad partner mac.
    ...
    static DEVICE_ATTR(ad_partner_mac, 0444, bonding_show_ad_partner_mac, core::ptr::null_mut());
...
// Show the number of IGMP membership reports to send on link failure
    ...
    {
    struct bonding *bond = to_bond(d);
    let mut packets_per_slave: c_uint = READ_ONCE(bond.params.packets_per_slave);
    return sysfs_emit(buf, "%u\n", packets_per_slave);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_create_sysfs(bn: *mut bond_net) -> int __net_init {
...
#[no_mangle]
pub unsafe extern "C" fn bond_destroy_sysfs(bn: *mut bond_net) -> void __net_exit {
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_prepare_sysfs_group(bond: *mut bonding) {
