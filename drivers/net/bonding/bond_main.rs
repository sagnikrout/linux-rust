...
//! Source: drivers/net/bonding/bond_main.c
#![no_std]
...
// monitor all links that often (in milliseconds). <=0 disables monitoring
    let mut max_bonds: static int = BOND_DEFAULT_MAX_BONDS;
    let mut tx_queues: static int = BOND_DEFAULT_TX_QUEUES;
    let mut num_peer_notif: static int = 1;
    static int miimon;
    static int updelay;
    static int downdelay;
    let mut use_carrier: static int = 1;
    static char *mode;
    static char *primary;
    ...
    let mut resend_igmp: static int = BOND_DEFAULT_RESEND_IGMP;
    let mut packets_per_slave: static int = 1;
    let mut lp_interval: static int = BOND_ALB_DEFAULT_LP_INTERVAL;
    ...
    module_param_array(arp_ip_target, charp, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn bond_sk_check(bond: *mut bonding) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn __bond_xdp_check(mode: c_int, xmit_policy: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn bond_xdp_check(bond: *mut bonding, mode: c_int) -> bool {
...
//
    ...
    bond = netdev_priv(bond_dev);
    slave = rcu_dereference(bond.curr_active_slave);
    real_dev = slave ? slave.dev : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn bond_ipsec_add_sa_all(bond: *mut bonding) {
...
#[no_mangle]
unsafe extern "C" fn bond_ipsec_del_sa_all(bond: *mut bonding) {
    ...
    spin_lock_bh(&ipsec.xs.lock);
    ipsec.xs.xso.real_dev = core::ptr::null_mut();
// Don't double delete states killed by the user.
    ...
    goto out;
    real_dev = xs.xso.real_dev;
    xs.xso.real_dev = core::ptr::null_mut();
    if (real_dev.xfrmdev_ops &&
...
//
#[no_mangle]
unsafe extern "C" fn bond_ipsec_offload_ok(skb: *mut sk_buff, xs: *mut xfrm_state) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn bond_advance_esn_state(xs: *mut xfrm_state) {
...
//
#[no_mangle]
unsafe extern "C" fn bond_xfrm_update_stats(xs: *mut xfrm_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_set_carrier(bond: *mut bonding) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bond_update_speed_duplex(slave: *mut slave) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bond_set_promiscuity(bond: *mut bonding, inc: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bond_set_allmulti(bond: *mut bonding, inc: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bond_resend_igmp_join_requests_delayed(work: *mut work_struct) {
...
//
    ...
    err = netif_pre_changeaddr_notify(bond_dev, slave_dev.dev_addr, core::ptr::null_mut());
    if (err)
    return err;
...
//
    ...
    rv = dev_set_mac_address(new_active.dev, &ss, core::ptr::null_mut());
    if (rv) {
    ...
    rv = dev_set_mac_address(old_active.dev, &ss, core::ptr::null_mut());
    if (rv)
...
//
    ...
    struct slave *slave, *hprio = core::ptr::null_mut();
    struct list_head *iter;
...
//
    ...
    {
    struct slave *slave, *bestslave = core::ptr::null_mut();
    struct list_head *iter;
    let mut mintime: c_int = bond.params.updelay;
...
#[no_mangle]
unsafe extern "C" fn bond_should_notify_peers(bond: *mut bonding) -> bool {
    static bool bond_should_notify_peers(struct bonding *bond)
    {
    struct bond_up_slave *usable;
    struct slave *slave = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn bond_peer_notify_work_rearm(bond: *mut bonding, delay: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn bond_peer_notify_reset(bond: *mut bonding) {
...
#[no_mangle]
unsafe extern "C" fn bond_peer_notify_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn bond_peer_notify_may_events(bond: *mut bonding, force: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_change_active_slave(bond: *mut bonding, new_active: *mut slave) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_select_active_slave(bond: *mut bonding) {
...
#[no_mangle]
pub unsafe extern "C" fn slave_enable_netpoll(slave: *mut slave) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn slave_disable_netpoll(slave: *mut slave) {
    static inline void slave_disable_netpoll(struct slave *slave)
    {
    struct netpoll *np = slave.np;
    if (!np)
    return;
    slave.np = core::ptr::null_mut();
    __netpoll_free(np);
    }
#[no_mangle]
unsafe extern "C" fn bond_poll_controller(bond_dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn bond_netpoll_cleanup(bond_dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn bond_netpoll_setup(dev: *mut net_device) -> c_int {
...
// ---------------------------------- IOCTL ----------------------------------
    ...
    struct net_device *slave_dev)
    {
    let mut was_up: bool = !!(bond_dev.flags & IFF_UP);
    dev_close(bond_dev);
    bond_dev.header_ops	    = slave_dev.header_ops ?
    &bond_header_ops : core::ptr::null_mut();
    ...
    if (was_up)
    dev_open(bond_dev, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn bond_handle_frame(pskb: *mut sk_buff) -> rx_handler_result_t {
    ...
    struct slave *);
    let mut ret: c_int = RX_HANDLER_ANOTHER;
...
#[no_mangle]
unsafe extern "C" fn bond_lag_tx_type(bond: *mut bonding) -> enum netdev_lag_tx_type {
...
#[no_mangle]
unsafe extern "C" fn bond_upper_dev_unlink(bond: *mut bonding, slave: *mut slave) {
...
#[no_mangle]
unsafe extern "C" fn slave_kobj_release(kobj: *mut kobject) {
...
#[no_mangle]
unsafe extern "C" fn bond_kobj_init(slave: *mut slave) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bond_fill_ifbond(bond: *mut bonding, info: *mut ifbond) {
...
#[no_mangle]
unsafe extern "C" fn bond_fill_ifslave(slave: *mut slave, info: *mut ifslave) {
...
#[no_mangle]
unsafe extern "C" fn bond_netdev_notify_work(_work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn bond_queue_slave_event(slave: *mut slave) {
    void bond_queue_slave_event(struct slave *slave)
    {
    queue_delayed_work(slave.bond.wq, &slave.notify_work, 0);
    }
#[no_mangle]
pub unsafe extern "C" fn bond_lower_state_changed(slave: *mut slave) {
...
//
#[no_mangle]
unsafe extern "C" fn bond_ether_setup(bond_dev: *mut net_device) {
    static void bond_ether_setup(struct net_device *bond_dev)
    {
    let mut flags: c_uint = bond_dev.flags & (IFF_SLAVE | IFF_UP);
    ether_setup(bond_dev);
    bond_dev.flags |= IFF_MASTER | flags;
    bond_dev.priv_flags &= ~IFF_TX_SKB_SHARING;
    }
#[no_mangle]
pub unsafe extern "C" fn bond_xdp_set_features(bond_dev: *mut net_device) {
    void bond_xdp_set_features(struct net_device *bond_dev)
    {
    struct bonding *bond = netdev_priv(bond_dev);
    let mut val: xdp_features_t = NETDEV_XDP_ACT_MASK;
    struct list_head *iter;
    struct slave *slave;
    ASSERT_RTNL();
...
// enslave device <slave> to bond device <master>
    ...
    struct slave *new_slave = core::ptr::null_mut(), *prev_slave;
    struct sockaddr_storage ss;
    let mut res: c_int = 0, i;
...
// broadcast mode uses the all_slaves to loop through slaves.
    ...
    bond_update_slave_arr(bond, core::ptr::null_mut());
...
// Undo stages on error
    ...
    RCU_INIT_POINTER(bond.primary_slave, core::ptr::null_mut());
    if (rcu_access_pointer(bond.curr_active_slave) == new_slave) {
    block_netpoll_tx();
    bond_change_active_slave(bond, core::ptr::null_mut());
    bond_select_active_slave(bond);
    unblock_netpoll_tx();
    }
...
//
    ...
    ss.ss_family = slave_dev.type;
    dev_set_mac_address(slave_dev, &ss, core::ptr::null_mut());
    }
    err_restore_mtu:
...
//
    ...
    struct sockaddr_storage ss;
    let mut old_flags: c_int = bond_dev.flags;
    let mut old_features: netdev_features_t = bond_dev.features;
...
//
    ...
    RCU_INIT_POINTER(bond.current_arp_slave, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn bond_release(bond_dev: *mut net_device, slave_dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bond_info_query(bond_dev: *mut net_device, info: *mut ifbond) {
...
#[no_mangle]
unsafe extern "C" fn bond_slave_info_query(bond_dev: *mut net_device, info: *mut ifslave) -> c_int {
    static int bond_slave_info_query(struct net_device *bond_dev, struct ifslave *info)
    {
    struct bonding *bond = netdev_priv(bond_dev);
    struct list_head *iter;
    let mut i: c_int = 0, res = -ENODEV;
    struct slave *slave;
    bond_for_each_slave(bond, slave, iter) {
...
#[no_mangle]
unsafe extern "C" fn bond_miimon_inspect(bond: *mut bonding) -> c_int {
    static int bond_miimon_inspect(struct bonding *bond)
    {
    let mut ignore_updelay: bool = false;
...
#[no_mangle]
unsafe extern "C" fn bond_miimon_commit(bond: *mut bonding) {
    static void bond_miimon_commit(struct bonding *bond)
    {
    struct slave *slave, *primary, *active;
    let mut do_failover: bool = false;
    struct list_head *iter;
    int err;
    ASSERT_RTNL();
    bond_for_each_slave(bond, slave, iter) {
...
//
#[no_mangle]
unsafe extern "C" fn bond_mii_monitor(work: *mut work_struct) {
...
// Race avoidance with bond_close cancel of workqueue
    ...
    {
    let mut ip: __be32 = *(__be32 *)priv.data;
    let mut ip: return = = bond_confirm_addr(upper, 0, ip);
    }
#[no_mangle]
unsafe extern "C" fn bond_has_this_ip(bond: *mut bonding, ip: __be32) -> bool {
...
//
    ...
    core::ptr::null_mut(), slave_dev.dev_addr, core::ptr::null_mut());
    if (!skb) {
...
#[no_mangle]
unsafe extern "C" fn bond_arp_send_all(bond: *mut bonding, slave: *mut slave) {
...
// Not our device - skip
    ...
    &targets[i], rt.dst.dev ? rt.dst.dev.name : "core::ptr::null_mut()");
    ip_rt_put(rt);
    continue;
    found:
...
#[no_mangle]
unsafe extern "C" fn bond_validate_arp(bond: *mut bonding, slave: *mut slave, sip: __be32, tip: __be32) {
...
#[no_mangle]
unsafe extern "C" fn bond_ns_send_all(bond: *mut bonding, slave: *mut slave) {
...
// Find out through which dev should the packet go
    ...
    fl6.daddr = targets[i];
    dst = ip6_route_output(dev_net(bond.dev), core::ptr::null_mut(), &fl6);
    if (dst.error) {
    dst_release(dst);
// there's no route to target - try to send arp
// probe to generate any traffic (arp_validate=0)
...
// Not our device - skip
    ...
    &targets[i], dst.dev ? dst.dev.name : "core::ptr::null_mut()");
    dst_release(dst);
    continue;
    found:
...
#[no_mangle]
unsafe extern "C" fn bond_has_this_ip6(bond: *mut bonding, addr: *mut in6_addr) -> bool {
...
//
    ...
    let mut is_ipv6: bool = skb.protocol == __cpu_to_be16(ETH_P_IPV6);

    let mut is_arp: bool = skb.protocol == __cpu_to_be16(ETH_P_ARP);
...
#[no_mangle]
unsafe extern "C" fn bond_send_validate(bond: *mut bonding, slave: *mut slave) {
...
//
    ...
    int mod)
    {
    let mut delta_in_ticks: c_int = msecs_to_jiffies(bond.params.arp_interval);
...
//
#[no_mangle]
unsafe extern "C" fn bond_loadbalance_arp_mon(bond: *mut bonding) {
    static void bond_loadbalance_arp_mon(struct bonding *bond)
    {
    struct slave *slave, *oldcurrent;
    struct list_head *iter;
    let mut do_failover: c_int = 0, slave_state_changed = 0;
    if (!bond_has_slaves(bond))
    goto re_arm;
    rcu_read_lock();
...
//
    bond_for_each_slave_rcu(bond, slave, iter) {
    let mut last_tx: c_ulong = slave_last_tx(slave);
    bond_propose_link_state(slave, BOND_LINK_NOCHANGE);
    if (slave.link != BOND_LINK_UP) {
...
//
#[no_mangle]
unsafe extern "C" fn bond_ab_arp_inspect(bond: *mut bonding) -> c_int {
    static int bond_ab_arp_inspect(struct bonding *bond)
    {
    unsigned long last_tx, last_rx;
    struct list_head *iter;
    struct slave *slave;
    let mut commit: c_int = 0;
    bond_for_each_slave_rcu(bond, slave, iter) {
    bond_propose_link_state(slave, BOND_LINK_NOCHANGE);
...
//
#[no_mangle]
unsafe extern "C" fn bond_ab_arp_commit(bond: *mut bonding) {
...
//
#[no_mangle]
unsafe extern "C" fn bond_ab_arp_probe(bond: *mut bonding) -> bool {
    static bool bond_ab_arp_probe(struct bonding *bond)
    {
    struct slave *slave, *before = core::ptr::null_mut(), *new_slave = core::ptr::null_mut(),
// curr_arp_slave = rcu_dereference(bond->current_arp_slave),
// curr_active_slave = rcu_dereference(bond->curr_active_slave);
    struct list_head *iter;
    let mut found: bool = false;
    let mut should_notify_rtnl: bool = BOND_SLAVE_NOTIFY_LATER;
...
#[no_mangle]
unsafe extern "C" fn bond_activebackup_arp_mon(bond: *mut bonding) {
...
#[no_mangle]
unsafe extern "C" fn bond_arp_monitor(work: *mut work_struct) {
...
// Change device name
#[no_mangle]
unsafe extern "C" fn bond_event_changename(bond: *mut bonding) -> c_int {
...
//
    if (!slave) {
    netdev_dbg(slave_dev, "%s called on core::ptr::null_mut() slave\n", __func__);
    return NOTIFY_DONE;
    }
...
//
    ...
    return data;
#[no_mangle]
pub unsafe extern "C" fn if(likely(pskb_may_pull(skb: skb &&, _arg: n))) -> else {
...
// L2 hash helper
#[no_mangle]
pub unsafe extern "C" fn bond_eth_hash(skb: *mut sk_buff, data: *const c_void, mhoff: c_int, hlen: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bond_vlan_srcmac_hash(skb: *mut sk_buff, data: *const c_void, mhoff: c_int, hlen: c_int) -> u32 {
    static u32 bond_vlan_srcmac_hash(struct sk_buff *skb, const void *data, int mhoff, int hlen)
    {
    let mut srcmac_vendor: u32 = 0, srcmac_dev = 0;
...
// Extract the appropriate headers based on bond's xmit policy
    ...
    {
    let mut l34: bool = bond.params.xmit_policy == BOND_XMIT_POLICY_LAYER34;
    let mut ip_proto: c_int = -1;
    switch (bond.params.xmit_policy) {
    case BOND_XMIT_POLICY_ENCAP23:
    case BOND_XMIT_POLICY_ENCAP34:
...
#[no_mangle]
unsafe extern "C" fn bond_ip_hash(hash: u32, flow: *mut flow_keys, xmit_policy: c_int) -> u32 {
    static u32 bond_ip_hash(u32 hash, struct flow_keys *flow, int xmit_policy)
    {
    hash ^= ( u32)flow_get_u32_dst(flow) ^
    ( u32)flow_get_u32_src(flow);
    hash ^= (hash >> 16);
    hash ^= (hash >> 8);
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_xmit_hash(bond: *mut bonding, skb: *mut sk_buff) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn bond_xmit_hash_xdp(bond: *mut bonding, xdp: *mut xdp_buff) -> u32 {
    ...
    return __bond_xmit_hash(bond, core::ptr::null_mut(), xdp.data, eth.h_proto, 0,
    sizeof(struct ethhdr), xdp.data_end - xdp.data);
    }
// -------------------------- Device entry points ----------------------------
#[no_mangle]
pub unsafe extern "C" fn bond_work_init_all(bond: *mut bonding) {
...
#[no_mangle]
pub unsafe extern "C" fn bond_work_cancel_all(bond: *mut bonding) {
...
#[no_mangle]
unsafe extern "C" fn bond_open(bond_dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bond_close(bond_dev: *mut net_device) -> c_int {
    ...
    WRITE_ONCE(bond.recv_probe, core::ptr::null_mut());
...
//
    ...
    let mut nv: u64 = new[i];
    let mut ov: u64 = old[i];
    let mut delta: i64 = nv - ov;
...
#[no_mangle]
unsafe extern "C" fn bond_get_lowest_level_rcu(dev: *mut net_device) -> c_int {
    static int bond_get_lowest_level_rcu(struct net_device *dev)
    {
    struct net_device *ldev, *next, *now, *dev_stack[MAX_NEST_DEV + 1];
    struct list_head *niter, *iter, *iter_stack[MAX_NEST_DEV + 1];
    let mut cur: c_int = 0, max = 0;
    now = dev;
...
#[no_mangle]
unsafe extern "C" fn bond_eth_ioctl(bond_dev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
    static int bond_eth_ioctl(struct net_device *bond_dev, struct ifreq *ifr, int cmd)
    {
    struct bonding *bond = netdev_priv(bond_dev);
    struct mii_ioctl_data *mii = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn bond_do_ioctl(bond_dev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
    static int bond_do_ioctl(struct net_device *bond_dev, struct ifreq *ifr, int cmd)
    {
    struct bonding *bond = netdev_priv(bond_dev);
    struct net_device *slave_dev = core::ptr::null_mut();
    struct ifbond k_binfo;
    struct ifbond __user *u_binfo = core::ptr::null_mut();
    struct ifslave k_sinfo;
    struct ifslave __user *u_sinfo = core::ptr::null_mut();
    ...
    res = bond_enslave(bond_dev, slave_dev, core::ptr::null_mut());
    break;
    ...
    {
    let mut ifrdata: ifreq = { .ifr_data = data };
    switch (cmd) {
...
#[no_mangle]
unsafe extern "C" fn bond_change_rx_flags(bond_dev: *mut net_device, change: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bond_set_rx_mode(bond_dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn bond_neigh_init(n: *mut neighbour) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bond_change_mtu(bond_dev: *mut net_device, new_mtu: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bond_set_mac_address(bond_dev: *mut net_device, addr: *mut c_void) -> c_int {
...
//
    ...
    __func__, slave);
    res = dev_set_mac_address(slave.dev, addr, core::ptr::null_mut());
    if (res) {
...
// unwind from head to the slave that failed
    ...
    if (rollback_slave == slave)
    break;
    tmp_res = dev_set_mac_address(rollback_slave.dev, &tmp_ss, core::ptr::null_mut());
    if (tmp_res) {
...
//
#[no_mangle]
unsafe extern "C" fn bond_rr_gen_slave_id(bond: *mut bonding) -> u32 {
    static u32 bond_rr_gen_slave_id(struct bonding *bond)
    {
    u32 slave_id;
    struct reciprocal_value reciprocal_packets_per_slave;
    let mut packets_per_slave: c_int = bond.params.packets_per_slave;
...
//
    ...
    let mut noff: c_int = skb_network_offset(skb);
    struct iphdr *iph;
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_slave_arr_work_rearm(bond: *mut bonding, delay: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn bond_slave_arr_handler(work: *mut work_struct) {
    static void bond_slave_arr_handler(struct work_struct *work)
    {
    struct bonding *bond = container_of(work, struct bonding,
    slave_arr_work.work);
    ...
    if (!rtnl_trylock())
    goto err;
    ret = bond_update_slave_arr(bond, core::ptr::null_mut());
    rtnl_unlock();
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn bond_reset_slave_arr(bond: *mut bonding) {
    static void bond_reset_slave_arr(struct bonding *bond)
    {
    bond_set_slave_arr(bond, core::ptr::null_mut(), core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_update_slave_arr(bond: *mut bonding, skipslave: *mut slave) -> c_int {
    int bond_update_slave_arr(struct bonding *bond, struct slave *skipslave)
    {
    struct bond_up_slave *usable_slaves = core::ptr::null_mut(), *all_slaves = core::ptr::null_mut();
    struct slave *slave;
    struct list_head *iter;
    let mut agg_id: c_int = 0;
    let mut ret: c_int = 0;
    might_sleep();
...
//
    ...
    struct bonding *bond = netdev_priv(bond_dev);
    struct bond_up_slave *slaves;
    let mut xmit_suc: bool = false;
    let mut skb_used: bool = false;
    int slaves_count, i;
    if (all_slaves)
...
//
    let mut txq: u16 = skb_rx_queue_recorded(skb) ? skb_get_rx_queue(skb) : 0;
...
#[no_mangle]
unsafe extern "C" fn bond_sk_to_flow(sk: *mut sock, flow: *mut flow_keys) {
...
//
#[no_mangle]
unsafe extern "C" fn bond_sk_hash_l34(sk: *mut sock) -> u32 {
...
// L3
    ...
    {
    struct bonding *bond = netdev_priv(dev);
    struct net_device *lower = core::ptr::null_mut();
    rcu_read_lock();
...
#[no_mangle]
unsafe extern "C" fn __bond_start_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn bond_start_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
// unwind the program changes
    ...
    xdp.prog = old_prog;
    xdp.extack = core::ptr::null_mut(); /* do not overwrite original error */
    bond_for_each_slave(bond, rollback_slave, iter) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: xdp.prog) -> else {
    else if (xdp.prog)
...
#[no_mangle]
unsafe extern "C" fn bond_xdp(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bond_mode_bcast_speed(slave: *mut slave, speed: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bond_set_phc_index_flag(kernel_cfg: *mut kernel_hwtstamp_config) -> c_int {
...
//
    ...
    struct net_device *real_dev;
    let mut sw_tx_support: bool = false;
    struct list_head *iter;
    struct slave *slave;
    let mut ret: c_int = 0;
    rcu_read_lock();
...
#[no_mangle]
unsafe extern "C" fn bond_destructor(bond_dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn bond_setup(bond_dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn bond_uninit(bond_dev: *mut net_device) {
    static void bond_uninit(struct net_device *bond_dev)
    {
    struct bonding *bond = netdev_priv(bond_dev);
    struct list_head *iter;
...
#[no_mangle]
unsafe extern "C" fn bond_check_params(params: *mut bond_params) -> int __init {
    static int __init bond_check_params(struct bond_params *params)
    {
    int arp_validate_value, fail_over_mac_value, primary_reselect_value, i;
    struct bond_opt_value newval;
    const struct bond_opt_value *valptr;
    let mut arp_all_targets_value: c_int = 0;
    let mut ad_actor_sys_prio: u16 = 0;
    let mut ad_user_port_key: u16 = 0;
    __be32 arp_target[BOND_MAX_ARP_TARGETS] = { 0 };
    int arp_ip_count;
    let mut bond_mode: c_int = BOND_MODE_ROUNDROBIN;
    let mut xmit_hashtype: c_int = BOND_XMIT_POLICY_LAYER2;
    let mut lacp_fast: c_int = 0;
    int tlb_dynamic_lb;
...
// not a complete check, but good enough to catch mistakes
    if (!in4_pton(arp_ip_target[i], -1, (u8 *)&ip, -1, core::ptr::null_mut()) ||
...
#[no_mangle]
unsafe extern "C" fn bond_init(bond_dev: *mut net_device) -> c_int {
    static int bond_init(struct net_device *bond_dev)
    {
    struct bonding *bond = netdev_priv(bond_dev);
...
#[no_mangle]
pub unsafe extern "C" fn bond_get_num_tx_queues() -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_create(net: *mut net, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bond_net_init(net: *mut net) -> int __net_init {
...
//
#[no_mangle]
unsafe extern "C" fn bond_net_pre_exit(net: *mut net) -> void __net_exit {
...
//
#[no_mangle]
unsafe extern "C" fn bond_net_exit_batch(net_list: *mut list_head) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn bonding_init() -> int __init {
    ...
    res = bond_create(&init_net, core::ptr::null_mut());
    if (res)
    goto err;
    }
...
#[no_mangle]
unsafe extern "C" fn bonding_exit() -> void __exit {
