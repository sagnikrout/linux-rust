...
//! Source: drivers/net/bonding/bond_3ad.c
#![no_std]
...
// General definitions
pub const AD_SHORT_TIMEOUT: c_int = 1;
pub const AD_LONG_TIMEOUT: c_int = 0;
pub const AD_STANDBY: c_uint = 0x2;
pub const AD_MAX_TX_IN_SECOND: c_int = 3;
pub const AD_COLLECTOR_MAX_DELAY: c_int = 0;
// Timer definitions (43.4.4 in the 802.3ad standard)
pub const AD_FAST_PERIODIC_TIME: c_int = 1;
pub const AD_SLOW_PERIODIC_TIME: c_int = 30;

pub const AD_CHURN_DETECTION_TIME: c_int = 60;
pub const AD_AGGREGATE_WAIT_TIME: c_int = 2;
// Port Variables definitions used by the State Machines (43.4.7 in the
// 802.3ad standard)
//
pub const AD_PORT_BEGIN: c_uint = 0x1;
pub const AD_PORT_LACP_ENABLED: c_uint = 0x2;
pub const AD_PORT_ACTOR_CHURN: c_uint = 0x4;
pub const AD_PORT_PARTNER_CHURN: c_uint = 0x8;
pub const AD_PORT_READY: c_uint = 0x10;
pub const AD_PORT_READY_N: c_uint = 0x20;
pub const AD_PORT_MATCHED: c_uint = 0x40;
pub const AD_PORT_STANDBY: c_uint = 0x80;
pub const AD_PORT_SELECTED: c_uint = 0x100;
pub const AD_PORT_MOVED: c_uint = 0x200;
...
// |15                           6|5                   1|0
//
pub const AD_DUPLEX_KEY_MASKS: c_uint = 0x1;
pub const AD_SPEED_KEY_MASKS: c_uint = 0x3E;
pub const AD_USER_KEY_MASKS: c_uint = 0xFFC0;
...
// compare MAC addresses
    ...
    let mut ad_ticks_per_sec: static u16 = 1000 / AD_TIMER_INTERVAL;
    let mut ad_delta_in_ticks: static int = (AD_TIMER_INTERVAL * HZ) / 1000;
...
//
    ...
    {
    if (port.slave == core::ptr::null_mut())
...
// If there's no bond for this port, or bond has no slaves
    if (bond == core::ptr::null_mut())
    return core::ptr::null_mut();
    rcu_read_lock();
    first_slave = bond_first_slave_rcu(bond);
    agg = first_slave ? &(SLAVE_AD_INFO(first_slave).aggregator) : core::ptr::null_mut();
    rcu_read_unlock();
    return agg;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn __agg_has_partner(agg: *mut aggregator) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __disable_distributing_port(port: *mut port) {
...
//
#[no_mangle]
unsafe extern "C" fn __enable_collecting_port(port: *mut port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __disable_port(port: *mut port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __enable_port(port: *mut port) {
...
//
#[no_mangle]
unsafe extern "C" fn __port_move_to_attached_state(port: *mut port) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn __port_is_collecting_distributing(port: *mut port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __get_agg_selection_mode(port: *mut port) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn __check_agg_selection_timer(port: *mut port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __get_link_speed(port: *mut port) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn __get_duplex(port: *mut port) -> u8 {
    static u8 __get_duplex(struct port *port)
    {
    struct slave *slave = port.slave;
    let mut retval: u8 = 0x0;
...
#[no_mangle]
unsafe extern "C" fn __ad_actor_update_port(port: *mut port) {
...
//
#[no_mangle]
unsafe extern "C" fn __ad_timer_to_ticks(timer_type: u16, par: u16) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn __choose_matched(lacpdu: *mut lacpdu, port: *mut port) {
...
//
#[no_mangle]
unsafe extern "C" fn __record_pdu(lacpdu: *mut lacpdu, port: *mut port) {
...
//
#[no_mangle]
unsafe extern "C" fn __record_default(port: *mut port) {
...
//
#[no_mangle]
unsafe extern "C" fn __update_selected(lacpdu: *mut lacpdu, port: *mut port) {
...
//
#[no_mangle]
unsafe extern "C" fn __update_default_selected(port: *mut port) {
...
//
#[no_mangle]
unsafe extern "C" fn __update_ntt(lacpdu: *mut lacpdu, port: *mut port) {
...
//
#[no_mangle]
unsafe extern "C" fn __agg_ports_are_ready(aggregator: *mut aggregator) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __set_agg_ports_ready(aggregator: *mut aggregator, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __agg_usable_ports(agg: *mut aggregator) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __agg_active_ports(agg: *const aggregator) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __agg_ports_priority(agg: *const aggregator) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn __get_agg_bandwidth(aggregator: *mut aggregator) -> u32 {
    static u32 __get_agg_bandwidth(struct aggregator *aggregator)
    {
    let mut nports: c_int = __agg_active_ports(aggregator);
...
//
#[no_mangle]
pub unsafe extern "C" fn __update_lacpdu_from_port(port: *mut port) {
...
//
#[no_mangle]
unsafe extern "C" fn ad_lacpdu_send(port: *mut port) -> c_int {
    static int ad_lacpdu_send(struct port *port)
    {
    struct slave *slave = port.slave;
    struct sk_buff *skb;
    struct lacpdu_header *lacpdu_header;
    let mut length: c_int = sizeof(struct lacpdu_header);
...
//
#[no_mangle]
unsafe extern "C" fn ad_marker_send(port: *mut port, marker: *mut bond_marker) -> c_int {
    static int ad_marker_send(struct port *port, struct bond_marker *marker)
    {
    struct slave *slave = port.slave;
    struct sk_buff *skb;
    struct bond_marker_header *marker_header;
    let mut length: c_int = sizeof(struct bond_marker_header);
...
#[no_mangle]
unsafe extern "C" fn ad_cond_set_peer_notif(port: *mut port) {
...
//
#[no_mangle]
unsafe extern "C" fn ad_mux_machine(port: *mut port, update_slave_arr: *mut bool) {
    static void ad_mux_machine(struct port *port, bool *update_slave_arr)
    {
    struct bonding *bond = __get_bond_by_port(port);
...
//
    ...
    let mut state: c_int = AD_MUX_COLLECTING_DISTRIBUTING;
...
//
#[no_mangle]
unsafe extern "C" fn ad_rx_machine(lacpdu: *mut lacpdu, port: *mut port) {
    static void ad_rx_machine(struct lacpdu *lacpdu, struct port *port)
    {
...
//
#[no_mangle]
unsafe extern "C" fn ad_churn_machine(port: *mut port) {
...
//
#[no_mangle]
unsafe extern "C" fn ad_tx_machine(port: *mut port) {
    static void ad_tx_machine(struct port *port)
    {
...
//
#[no_mangle]
unsafe extern "C" fn ad_periodic_machine(port: *mut port) {
    static void ad_periodic_machine(struct port *port)
    {
...
// check if state machine should change state
#[no_mangle]
pub unsafe extern "C" fn if(_arg: port->sm_periodic_timer_counter) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ad_port_selection_logic(port: *mut port, update_slave_arr: *mut bool) {
    static void ad_port_selection_logic(struct port *port, bool *update_slave_arr)
    {
    struct aggregator *aggregator, *free_aggregator = core::ptr::null_mut(), *temp_aggregator;
    struct port *last_port = core::ptr::null_mut(), *curr_port;
    struct list_head *iter;
    struct bonding *bond;
    struct slave *slave;
...
// aggregator
//
    RCU_INIT_POINTER(port.aggregator, core::ptr::null_mut());
    port.next_port_in_aggregator = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn agg_device_up(agg: *const aggregator) -> c_int {
...
//
    ...
    best = (active && agg_device_up(active)) ? active : core::ptr::null_mut();
    bond_for_each_slave_rcu(bond, slave, iter) {
...
// if there is new best aggregator, activate it
    ...
    best.slave ? best.slave.dev.name : "core::ptr::null_mut()",
...
//
#[no_mangle]
unsafe extern "C" fn ad_clear_agg(aggregator: *mut aggregator) {
    static void ad_clear_agg(struct aggregator *aggregator)
    {
    if (aggregator) {
    ...
    aggregator.lag_ports = core::ptr::null_mut();
    aggregator.is_active = 0;
    aggregator.num_of_ports = 0;
    pr_debug("%s: LAG %d was cleared\n",
    aggregator.slave ?
    aggregator.slave.dev.name : "core::ptr::null_mut()",
    aggregator.aggregator_identifier);
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ad_initialize_agg(aggregator: *mut aggregator) {
    static void ad_initialize_agg(struct aggregator *aggregator)
    {
    if (aggregator) {
    ...
    aggregator.slave = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ad_initialize_port(port: *mut port, bond_params: *const bond_params) {
    static void ad_initialize_port(struct port *port, const struct bond_params *bond_params)
    {
...
// private parameters
    ...
    port.sm_tx_state = 0;
    port.aggregator = core::ptr::null_mut();
    port.next_port_in_aggregator = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ad_enable_collecting(port: *mut port) {
    static void ad_enable_collecting(struct port *port)
    {
...
//
#[no_mangle]
unsafe extern "C" fn ad_disable_distributing(port: *mut port, update_slave_arr: *mut bool) {
...
pub const AD_AGGREGATOR_SELECTION_TIMER: c_int = 8;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_3ad_initiate_agg_selection(bond: *mut bonding, timeout: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_3ad_initialize(bond: *mut bonding) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_3ad_bind_slave(slave: *mut slave) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_3ad_unbind_slave(slave: *mut slave) {
    void bond_3ad_unbind_slave(struct slave *slave)
    {
    struct port *port, *prev_port, *temp_port;
    struct aggregator *aggregator, *new_aggregator, *temp_aggregator;
    let mut select_new_active_agg: c_int = 0;
...
//
    ...
    if (!slave_iter)
    new_aggregator = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_3ad_update_ad_actor_settings(bond: *mut bonding) {
...
//
#[no_mangle]
unsafe extern "C" fn bond_agg_timer_advance(bond: *mut bonding) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_3ad_state_machine_handler(work: *mut work_struct) {
    ...
    let mut update_slave_arr: bool = false;
...
// check if there are any slaves
    ...
    port = slave ? &(SLAVE_AD_INFO(slave).port) : core::ptr::null_mut();
...
// for each port run the state machines
    ...
    ad_rx_machine(core::ptr::null_mut(), port);
...
//
#[no_mangle]
unsafe extern "C" fn bond_3ad_rx_indication(lacpdu: *mut lacpdu, slave: *mut slave) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ad_update_actor_keys(port: *mut port, reset: bool) {
    static void ad_update_actor_keys(struct port *port, bool reset)
    {
    let mut duplex: u8 = 0;
    let mut ospeed: u16 = 0, speed = 0;
    let mut old_oper_key: u16 = port.actor_oper_port_key;
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_3ad_adapter_speed_duplex_changed(slave: *mut slave) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_3ad_handle_link_change(slave: *mut slave, link: c_char) {
...
//
    bond_update_slave_arr(slave.bond, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_3ad_set_carrier(bond: *mut bonding) -> c_int {
...
//
    ...
    {
    const struct aggregator *aggregator = core::ptr::null_mut(), *tmp;
...
#[no_mangle]
pub unsafe extern "C" fn bond_3ad_get_active_agg_info(bond: *const bonding, ad_info: *mut ad_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_3ad_update_lacp_rate(bond: *mut bonding) {
    void bond_3ad_update_lacp_rate(struct bonding *bond)
    {
    struct port *port = core::ptr::null_mut();
    struct list_head *iter;
    struct slave *slave;
    int lacp_fast;
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_3ad_update_lacp_active(bond: *mut bonding) {
...
#[no_mangle]
pub unsafe extern "C" fn bond_3ad_stats_size() -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn bond_3ad_stats_fill(skb: *mut sk_buff, stats: *mut bond_3ad_stats) -> c_int {
