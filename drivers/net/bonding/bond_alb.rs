...
//! Source: drivers/net/bonding/bond_alb.c
#![no_std]
...
//
    ...
    let mut alb_delta_in_ticks: static int = HZ / ALB_TIMER_TICKS_PER_SEC;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct learning_pkt {
    pub mac_dst: [u8; ETH_ALEN],
    pub mac_src: [u8; ETH_ALEN],
    pub type: __be16,
    pub ETH_HLEN]: u8 padding[ETH_ZLEN -,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct arp_pkt {
    pub hw_addr_space: __be16,
    pub prot_addr_space: __be16,
    pub hw_addr_len: u8,
    pub prot_addr_len: u8,
    pub op_code: __be16,
    pub /: *mut *mut u8 mac_src[ETH_ALEN]; / sender hardware address,
    pub /: *mut *mut __be32 ip_src; / sender IP address,
    pub /: *mut *mut u8 mac_dst[ETH_ALEN]; / target hardware address,
    pub /: *mut *mut __be32 ip_dst; / target IP address,
}
...
// Forward declaration
    ...
    u32 ip_dst_hash);
#[no_mangle]
pub unsafe extern "C" fn _simple_hash(hash_start: *const u8, hash_size: c_int) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn tlb_init_table_entry(entry: *mut tlb_client_info, save_load: c_int) {
    ...
    entry.tx_slave = core::ptr::null_mut();
    entry.next = TLB_NULL_INDEX;
    entry.prev = TLB_NULL_INDEX;
    }
#[no_mangle]
pub unsafe extern "C" fn tlb_init_slave(slave: *mut slave) {
...
// skip this if we've already freed the tx hash table
    ...
    let mut next_index: u32 = tx_hash_table[index].next;
...
#[no_mangle]
unsafe extern "C" fn tlb_initialize(bond: *mut bonding) -> c_int {
    static int tlb_initialize(struct bonding *bond)
    {
    struct alb_bond_info *bond_info = &(BOND_ALB_INFO(bond));
    let mut size: c_int = TLB_HASH_TABLE_SIZE * sizeof(struct tlb_client_info);
...
#[no_mangle]
unsafe extern "C" fn tlb_deinitialize(bond: *mut bonding) {
    static void tlb_deinitialize(struct bonding *bond)
    {
    struct alb_bond_info *bond_info = &(BOND_ALB_INFO(bond));
    spin_lock_bh(&bond.mode_lock);
    kfree(bond_info.tx_hashtbl);
    bond_info.tx_hashtbl = core::ptr::null_mut();
    spin_unlock_bh(&bond.mode_lock);
    }
#[no_mangle]
unsafe extern "C" fn compute_gap(slave: *mut slave) -> c_longlong {
    ...
    long long max_gap;
    least_loaded = core::ptr::null_mut();
    max_gap = LLONG_MIN;
// Find the slave with the largest gap
    bond_for_each_slave_rcu(bond, slave, iter) {
    if (bond_slave_can_tx(slave)) {
    let mut gap: c_longlong = compute_gap(slave);
    if (max_gap < gap) {
    least_loaded = slave;
    max_gap = gap;
    }
    ...
    let mut next_index: u32 = slave_info.head;
...
//
#[no_mangle]
unsafe extern "C" fn rlb_update_entry_from_arp(bond: *mut bonding, arp: *mut arp_pkt) {
...
// Caller must hold rcu_read_lock()
    ...
    {
    struct alb_bond_info *bond_info = &(BOND_ALB_INFO(bond));
    struct slave *before = core::ptr::null_mut(), *rx_slave = core::ptr::null_mut(), *slave;
    struct list_head *iter;
...
//
#[no_mangle]
unsafe extern "C" fn rlb_clear_slave(bond: *mut bonding, slave: *mut slave) {
...
//
    ...
    rx_hash_table[index].slave = core::ptr::null_mut();
    }
    }
    }
    spin_unlock_bh(&bond.mode_lock);
...
#[no_mangle]
unsafe extern "C" fn rlb_update_client(client_info: *mut rlb_client_info) {
...
#[no_mangle]
unsafe extern "C" fn rlb_update_rx_clients(bond: *mut bonding) {
...
#[no_mangle]
unsafe extern "C" fn rlb_req_update_slave_clients(bond: *mut bonding, slave: *mut slave) {
...
#[no_mangle]
unsafe extern "C" fn rlb_req_update_subnet_clients(bond: *mut bonding, src_ip: __be32) {
...
//
    ...
    if (!client_info.assigned) {
    let mut prev_tbl_head: u32 = bond_info.rx_hashtbl_used_head;
...
//
    ...
    {
    struct slave *tx_slave = core::ptr::null_mut();
...
// the arp must be sent on the selected rx channel
    ...
    tx_slave ? tx_slave.dev.name : "core::ptr::null_mut()");
...
#[no_mangle]
unsafe extern "C" fn rlb_rebalance(bond: *mut bonding) {
...
#[no_mangle]
unsafe extern "C" fn rlb_init_table_entry_dst(entry: *mut rlb_client_info) {
    static void rlb_init_table_entry_dst(struct rlb_client_info *entry)
    {
    entry.used_next = RLB_NULL_INDEX;
    entry.used_prev = RLB_NULL_INDEX;
    entry.assigned = 0;
    entry.slave = core::ptr::null_mut();
    entry.vlan_id = 0;
    }
#[no_mangle]
unsafe extern "C" fn rlb_init_table_entry_src(entry: *mut rlb_client_info) {
...
#[no_mangle]
unsafe extern "C" fn rlb_init_table_entry(entry: *mut rlb_client_info) {
...
#[no_mangle]
unsafe extern "C" fn rlb_delete_table_entry_dst(bond: *mut bonding, index: u32) {
    static void rlb_delete_table_entry_dst(struct bonding *bond, u32 index)
    {
    struct alb_bond_info *bond_info = &(BOND_ALB_INFO(bond));
    let mut next_index: u32 = bond_info.rx_hashtbl[index].used_next;
    let mut prev_index: u32 = bond_info.rx_hashtbl[index].used_prev;
...
#[no_mangle]
unsafe extern "C" fn rlb_src_unlink(bond: *mut bonding, index: u32) {
    static void rlb_src_unlink(struct bonding *bond, u32 index)
    {
    struct alb_bond_info *bond_info = &(BOND_ALB_INFO(bond));
    let mut next_index: u32 = bond_info.rx_hashtbl[index].src_next;
    let mut prev_index: u32 = bond_info.rx_hashtbl[index].src_prev;
...
#[no_mangle]
unsafe extern "C" fn rlb_delete_table_entry(bond: *mut bonding, index: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn rlb_src_link(bond: *mut bonding, ip_src_hash: u32, ip_dst_hash: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn rlb_purge_src_ip(bond: *mut bonding, arp: *mut arp_pkt) {
    static void rlb_purge_src_ip(struct bonding *bond, struct arp_pkt *arp)
    {
    struct alb_bond_info *bond_info = &(BOND_ALB_INFO(bond));
    let mut ip_src_hash: u32 = _simple_hash((u8 *)&(arp.ip_src), sizeof(arp.ip_src));
    u32 index;
    spin_lock_bh(&bond.mode_lock);
    index = bond_info.rx_hashtbl[ip_src_hash].src_first;
    while (index != RLB_NULL_INDEX) {
    struct rlb_client_info *entry = &(bond_info.rx_hashtbl[index]);
    let mut next_index: u32 = entry.src_next;
...
#[no_mangle]
unsafe extern "C" fn rlb_initialize(bond: *mut bonding) -> c_int {
    static int rlb_initialize(struct bonding *bond)
    {
    struct alb_bond_info *bond_info = &(BOND_ALB_INFO(bond));
    struct rlb_client_info	*new_hashtbl;
    let mut size: c_int = RLB_HASH_TABLE_SIZE * sizeof(struct rlb_client_info);
    int i;
...
#[no_mangle]
unsafe extern "C" fn rlb_deinitialize(bond: *mut bonding) {
    static void rlb_deinitialize(struct bonding *bond)
    {
    struct alb_bond_info *bond_info = &(BOND_ALB_INFO(bond));
    spin_lock_bh(&bond.mode_lock);
    kfree(bond_info.rx_hashtbl);
    bond_info.rx_hashtbl = core::ptr::null_mut();
    bond_info.rx_hashtbl_used_head = RLB_NULL_INDEX;
    spin_unlock_bh(&bond.mode_lock);
    }
#[no_mangle]
unsafe extern "C" fn rlb_clear_vlan(bond: *mut bonding, vlan_id: c_ushort) {
    ...
    let mut next_index: u32 = bond_info.rx_hashtbl[curr_index].used_next;
...
// tlb/rlb shared functions
    ...
    struct sk_buff *skb;
    let mut size: c_int = sizeof(struct learning_pkt);
    memset(&pkt, 0, size);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct alb_walk_data {
    pub bond: *mut bonding,
    pub slave: *mut slave,
    ...
    let mut strict_match: bool = data.strict_match;
...
//
    ...
    if (dev_set_mac_address(dev, &ss, core::ptr::null_mut())) {
...
//
#[no_mangle]
unsafe extern "C" fn alb_swap_mac_addr(slave1: *mut slave, slave2: *mut slave) {
...
//
    ...
    struct slave *slave2)
    {
    let mut slaves_state_differ: c_int = (bond_slave_can_tx(slave1) != bond_slave_can_tx(slave2));
    struct slave *disabled_slave = core::ptr::null_mut();
    ASSERT_RTNL();
...
//
#[no_mangle]
unsafe extern "C" fn alb_change_hw_addr_on_detach(bond: *mut bonding, slave: *mut slave) {
...
//
#[no_mangle]
unsafe extern "C" fn alb_handle_addr_collision_on_attach(bond: *mut bonding, slave: *mut slave) -> c_int {
    static int alb_handle_addr_collision_on_attach(struct bonding *bond, struct slave *slave)
    {
    struct slave *has_bond_addr = rcu_access_pointer(bond.curr_active_slave);
    struct slave *tmp_slave1, *free_mac_slave = core::ptr::null_mut();
    struct list_head *iter;
...
//
#[no_mangle]
unsafe extern "C" fn alb_set_mac_address(bond: *mut bonding, addr: *mut c_void) -> c_int {
...
// unwind from head to the slave that failed
    ...
    dev_set_mac_address(rollback_slave.dev, &ss, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn alb_determine_nd(skb: *mut sk_buff) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn bond_alb_initialize(bond: *mut bonding, rlb_enabled: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bond_alb_deinitialize(bond: *mut bonding) {
...
#[no_mangle]
pub unsafe extern "C" fn bond_tlb_xmit(skb: *mut sk_buff, bond_dev: *mut net_device) -> netdev_tx_t {
    ...
    {
    struct alb_bond_info *bond_info = &(BOND_ALB_INFO(bond));
    let mut ip_bcast: static __be32 = htonl(0xffffffff);
    struct slave *tx_slave = core::ptr::null_mut();
    const u8 *hash_start = core::ptr::null_mut();
    let mut do_tx_balance: bool = true;
    struct ethhdr *eth_data;
    let mut hash_index: u32 = 0;
    let mut hash_size: c_int = 0;
    skb_reset_mac_header(skb);
    eth_data = eth_hdr(skb);
...
#[no_mangle]
pub unsafe extern "C" fn bond_alb_xmit(skb: *mut sk_buff, bond_dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
pub unsafe extern "C" fn bond_alb_monitor(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_alb_init_slave(bond: *mut bonding, slave: *mut slave) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_alb_deinit_slave(bond: *mut bonding, slave: *mut slave) {
    ...
    if (bond.alb_info.rlb_enabled) {
    bond.alb_info.rx_slave = core::ptr::null_mut();
    rlb_clear_slave(bond, slave);
    }
    }
#[no_mangle]
pub unsafe extern "C" fn bond_alb_handle_link_change(bond: *mut bonding, slave: *mut slave, link: c_char) {
...
//
    ...
    if (bond_update_slave_arr(bond, core::ptr::null_mut()))
...
//
#[no_mangle]
pub unsafe extern "C" fn bond_alb_handle_active_change(bond: *mut bonding, new_slave: *mut slave) {
...
// we don't care if it can't change its mac, best effort
    dev_set_mac_address(new_slave.dev, &ss, core::ptr::null_mut());
...
// Called with RTNL
#[no_mangle]
pub unsafe extern "C" fn bond_alb_set_mac_address(bond_dev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bond_alb_clear_vlan(bond: *mut bonding, vlan_id: c_ushort) {
