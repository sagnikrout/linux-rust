...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bareudp_net {
    pub bareudp_list: list_head,
    pub lock: mutex,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bareudp_conf {
    pub ethertype: __be16,
    pub port: __be16,
    pub sport_min: u16,
    pub multi_proto_mode: bool,
}

// Pseudo network device
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bareudp_dev {
    pub /: *mut *mut *mut net net; / netns for packet i/o,
    pub /: *mut *mut *mut net_device dev; / netdev for bareudp tunnel,
    pub ethertype: __be16,
    pub port: __be16,
    pub sport_min: u16,
    pub multi_proto_mode: bool,
    pub sk: *mut sock __rcu,
    pub /: *mut *mut list_head next; / bareudp node on namespace list,
    pub gro_cells: gro_cells,
}

#[no_mangle]
unsafe extern "C" fn bareudp_udp_encap_recv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bareudp_err_lookup(sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int bareudp_err_lookup(struct sock *sk, struct sk_buff *skb)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn bareudp_init(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bareudp_uninit(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn bareudp_socket_create(bareudp: *mut bareudp_dev, port: __be16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bareudp_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bareudp_sock_release(bareudp: *mut bareudp_dev) {
    static void bareudp_sock_release(struct bareudp_dev *bareudp)
    {
    struct sock *sk;
    sk = rtnl_dereference(bareudp.sk);
    rcu_assign_pointer(bareudp.sk, core::ptr::null_mut());
    udp_tunnel_sock_release(sk);
    }
#[no_mangle]
unsafe extern "C" fn bareudp_stop(dev: *mut net_device) -> c_int {
    ...
    let mut xnet: bool = !net_eq(bareudp.net, dev_net(bareudp.dev));
    let mut use_cache: bool = ip_tunnel_dst_cache_usable(skb, info);
...
#[no_mangle]
unsafe extern "C" fn bareudp_proto_valid(bareudp: *mut bareudp_dev, proto: __be16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bareudp_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t bareudp_xmit(struct sk_buff *skb, struct net_device *dev)
    {
    struct bareudp_dev *bareudp = netdev_priv(dev);
    struct ip_tunnel_info *info = core::ptr::null_mut();
    int err;
...
#[no_mangle]
unsafe extern "C" fn bareudp_setup(dev: *mut net_device) {
    ...
    {
    struct bareudp_dev *bareudp, *t = core::ptr::null_mut();
    mutex_lock(&bn.lock);
...
#[no_mangle]
unsafe extern "C" fn bareudp_dellink(dev: *mut net_device, head: *mut list_head) {
    ...
    return 0;
    err_unconfig:
    bareudp_dellink(dev, core::ptr::null_mut());
    return err;
    }
#[no_mangle]
unsafe extern "C" fn bareudp_get_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn bareudp_fill_info(skb: *mut sk_buff, dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bareudp_init_net(net: *mut net) -> __net_init int {
...
#[no_mangle]
unsafe extern "C" fn bareudp_exit_net(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn bareudp_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn bareudp_cleanup_module() -> void __exit {
