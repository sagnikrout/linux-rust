...
pub const NETKIT_NUM_RX_QUEUES_MAX: c_int = 1024;
pub const NETKIT_NUM_TX_QUEUES_MAX: c_int = 1;
pub const NETKIT_NUM_RX_QUEUES_REAL: c_int = 1;
pub const NETKIT_NUM_TX_QUEUES_REAL: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct netkit {
    pub peer: *mut net_device __rcu,
    pub active: *mut bpf_mprog_entry __rcu,
    pub policy: enum netkit_action,
    pub scrub: enum netkit_scrub,
    pub bundle: bpf_mprog_bundle,
    pub mode: enum netkit_mode,
    pub pair: enum netkit_pairing,
    pub primary: bool,
    pub headroom: u32,
}
...
#[no_mangle]
unsafe extern "C" fn netkit_xnet(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn netkit_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t netkit_xmit(struct sk_buff *skb, struct net_device *dev)
    {
    struct bpf_net_context __bpf_net_ctx, *bpf_net_ctx;
    struct netkit *nk = netkit_priv(dev);
    let mut ret: enum netkit_action = READ_ONCE(nk.policy);
    let mut ret_dev: netdev_tx_t = NET_XMIT_SUCCESS;
...
#[no_mangle]
unsafe extern "C" fn netkit_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netkit_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netkit_get_iflink(dev: *const net_device) -> c_int {
    static int netkit_get_iflink(const struct net_device *dev)
    {
    struct netkit *nk = netkit_priv(dev);
    struct net_device *peer;
    let mut iflink: c_int = 0;
    rcu_read_lock();
    peer = rcu_dereference(nk.peer);
    if (peer)
...
#[no_mangle]
unsafe extern "C" fn netkit_set_macaddr(dev: *mut net_device, sa: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netkit_set_headroom(dev: *mut net_device, headroom: c_int) {
...
#[no_mangle]
unsafe extern "C" fn netkit_xsk_supported_at_phys(dev: *const net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn netkit_xsk(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netkit_xsk_wakeup(dev: *mut net_device, queue_id: u32, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netkit_init(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netkit_queue_unlease(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn netkit_setup(dev: *mut net_device) {
    ...
    let mut scrub_prim: enum netkit_scrub = NETKIT_SCRUB_DEFAULT;
    let mut scrub_peer: enum netkit_scrub = NETKIT_SCRUB_DEFAULT;
    struct nlattr *peer_tb[IFLA_MAX + 1], **tbp, *attr;
    let mut pair: enum netkit_pairing = NETKIT_DEVICE_PAIR;
    let mut policy_prim: enum netkit_action = NETKIT_PASS;
    let mut policy_peer: enum netkit_action = NETKIT_PASS;
    let mut seen_peer: bool = false, seen_scrub = false;
    struct nlattr **data = params.data;
    let mut mode: enum netkit_mode = NETKIT_L3;
    unsigned char ifname_assign_type;
    struct nlattr **tb = params.tb;
    let mut headroom: u16 = 0, tailroom = 0;
    struct ifinfomsg *ifmp = core::ptr::null_mut();
    struct net_device *peer = core::ptr::null_mut();
    ...
    netif_carrier_off(peer);
    if (mode == NETKIT_L2)
    dev_change_flags(peer, peer.flags & ~IFF_NOARP, core::ptr::null_mut());
    err = rtnl_configure_link(peer, core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (err < 0)
    ...
    netif_carrier_off(dev);
    if (mode == NETKIT_L2)
    dev_change_flags(dev, dev.flags & ~IFF_NOARP, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn netkit_entry_sync() {
...
#[no_mangle]
pub unsafe extern "C" fn netkit_prog_attach(attr: *const union bpf_attr, prog: *mut bpf_prog) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn netkit_prog_detach(attr: *const union bpf_attr, prog: *mut bpf_prog) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn netkit_prog_query(attr: *const union bpf_attr, uattr: *mut union bpf_attr __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netkit_link_release(link: *mut bpf_link) {
...
#[no_mangle]
unsafe extern "C" fn netkit_link_dealloc(link: *mut bpf_link) {
    static void netkit_link_dealloc(struct bpf_link *link)
    {
    kfree(netkit_link(link));
    }
#[no_mangle]
unsafe extern "C" fn netkit_link_fdinfo(link: *const bpf_link, seq: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn netkit_link_detach(link: *mut bpf_link) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn netkit_link_attach(attr: *const union bpf_attr, prog: *mut bpf_prog) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netkit_release_all(dev: *mut net_device) {
    ...
    if (!entry)
    return;
    netkit_entry_update(dev, core::ptr::null_mut());
    netkit_entry_sync();
    bpf_mprog_foreach_tuple(entry, fp, cp, tuple) {
    if (tuple.link)
    netkit_link(tuple.link).dev = core::ptr::null_mut();
    else
    bpf_prog_put(tuple.prog);
    }
    }
#[no_mangle]
unsafe extern "C" fn netkit_uninit(dev: *mut net_device) {
    static void netkit_uninit(struct net_device *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn netkit_del_link(dev: *mut net_device, head: *mut list_head) {
    static void netkit_del_link(struct net_device *dev, struct list_head *head)
    {
    struct netkit *nk = netkit_priv(dev);
    struct net_device *peer = rtnl_dereference(nk.peer);
    RCU_INIT_POINTER(nk.peer, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn netkit_check_lease_unregister(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn netkit_get_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn netkit_fill_info(skb: *mut sk_buff, dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netkit_mod_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn netkit_mod_exit() -> __exit void {
