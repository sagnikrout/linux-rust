...
//! Source: drivers/net/wireguard/selftest/allowedips.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn print_node(node: *mut allowedips_node, bits: u8) -> __init void {
...
#[no_mangle]
unsafe extern "C" fn print_tree(top: *mut allowedips_node __rcu, bits: u8) -> __init void {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct horrible_allowedips {
    pub head: hlist_head,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct horrible_allowedips_node {
    pub table: hlist_node,
...
#[no_mangle]
unsafe extern "C" fn horrible_allowedips_init(table: *mut horrible_allowedips) -> __init void {
    static __init void horrible_allowedips_init(struct horrible_allowedips *table)
    {
    INIT_HLIST_HEAD(&table.head);
    }
#[no_mangle]
unsafe extern "C" fn horrible_allowedips_free(table: *mut horrible_allowedips) -> __init void {
...
#[no_mangle]
unsafe extern "C" fn horrible_cidr_to_mask(cidr: u8) -> __init inline union nf_inet_addr {
    ...
    if (cidr % 32)
    mask.all[cidr / 32] = ( u32)htonl(
    (0xFFFFFFFFUL << (32 - (cidr % 32))) & 0xFFFFFFFFUL);
    return mask;
    }
#[no_mangle]
unsafe extern "C" fn horrible_mask_to_cidr(subnet: union nf_inet_addr) -> __init inline u8 {
    ...
    {
    struct horrible_allowedips_node *other = core::ptr::null_mut(), *where = core::ptr::null_mut();
    let mut my_cidr: u8 = horrible_mask_to_cidr(node.mask);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !other) -> else {
    else if (!other)
...
#[no_mangle]
unsafe extern "C" fn randomized_test() -> __init bool {
...
#[no_mangle]
pub unsafe extern "C" fn wg_allowedips_selftest() -> bool __init {
...
// NULL peer should have no effect and return 0
    test_boolean(!remove(4, core::ptr::null_mut(), 192, 0, 0, 0, 24));
    test(4, a, 192, 0, 0, 1);
...
// Must be an exact match to remove
    ...
    test(6, a, 0x24446801, 0x40e40800, 0xdeaebeef, 0xdefbeef);
// NULL peer should have no effect and return 0
    test_boolean(!remove(6, core::ptr::null_mut(), 0x24446801, 0x40e40800, 0xdeaebeef, 0xdefbeef, 128));
    test(6, a, 0x24446801, 0x40e40800, 0xdeaebeef, 0xdefbeef);
// different peer should have no effect and return 0
...
//
    ...
    let mut family: c_int = wg_allowedips_read_node(iter_node, ip, &cidr);
    count++;
