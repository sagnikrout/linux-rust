...
#[no_mangle]
unsafe extern "C" fn eql_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn eql_setup(dev: *mut net_device) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn eql_open(dev: *mut net_device) -> c_int {
    static int eql_open(struct net_device *dev)
    {
    equalizer_t *eql = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn eql_kill_one_slave(queue: *mut slave_queue_t, slave: *mut slave_t) {
    static void eql_kill_one_slave(slave_queue_t *queue, slave_t *slave)
    {
    list_del(&slave.list);
    queue.num_slaves--;
...
#[no_mangle]
unsafe extern "C" fn eql_kill_slave_queue(queue: *mut slave_queue_t) {
...
#[no_mangle]
unsafe extern "C" fn eql_close(dev: *mut net_device) -> c_int {
    static int eql_close(struct net_device *dev)
    {
    equalizer_t *eql = netdev_priv(dev);
//
...
// queue->lock must be held
    ...
    {
    let mut best_load: c_ulong = ~0UL;
    struct list_head *this, *tmp, *head;
    slave_t *best_slave;
    best_slave = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn eql_slave_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t eql_slave_xmit(struct sk_buff *skb, struct net_device *dev)
    {
    equalizer_t *eql = netdev_priv(dev);
    slave_t *slave;
...
#[no_mangle]
pub unsafe extern "C" fn eql_is_full(queue: *mut slave_queue_t) -> c_int {
...
// queue->lock must be held
#[no_mangle]
unsafe extern "C" fn __eql_insert_slave(queue: *mut slave_queue_t, slave: *mut slave_t) -> c_int {
    static int __eql_insert_slave(slave_queue_t *queue, slave_t *slave)
    {
    if (!eql_is_full(queue)) {
    slave_t *duplicate_slave = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn eql_enslave(master_dev: *mut net_device, srqp: *mut slaving_request_t __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eql_emancipate(master_dev: *mut net_device, srqp: *mut slaving_request_t __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eql_g_slave_cfg(dev: *mut net_device, scp: *mut slave_config_t __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eql_s_slave_cfg(dev: *mut net_device, scp: *mut slave_config_t __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eql_g_master_cfg(dev: *mut net_device, mcp: *mut master_config_t __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eql_s_master_cfg(dev: *mut net_device, mcp: *mut master_config_t __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eql_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn eql_cleanup_module() -> void __exit {
