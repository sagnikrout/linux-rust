...
//! Source: drivers/net/usb/kaweth.c
#![no_std]
...
pub const KAWETH_MTU: c_int = 1514;
pub const KAWETH_BUF_SIZE: c_int = 1664;

pub const KAWETH_SCRATCH_SIZE: c_int = 32;
pub const KAWETH_FIRMWARE_BUF_SIZE: c_int = 4096;

pub const KAWETH_STATUS_BROKEN: c_uint = 0x0000001;
pub const KAWETH_STATUS_CLOSING: c_uint = 0x0000002;
pub const KAWETH_STATUS_SUSPENDING: c_uint = 0x0000004;

pub const KAWETH_PACKET_FILTER_PROMISCUOUS: c_uint = 0x01;
pub const KAWETH_PACKET_FILTER_ALL_MULTICAST: c_uint = 0x02;
pub const KAWETH_PACKET_FILTER_DIRECTED: c_uint = 0x04;
pub const KAWETH_PACKET_FILTER_BROADCAST: c_uint = 0x08;
pub const KAWETH_PACKET_FILTER_MULTICAST: c_uint = 0x10;
// Table 7
pub const KAWETH_COMMAND_GET_ETHERNET_DESC: c_uint = 0x00;
pub const KAWETH_COMMAND_MULTICAST_FILTERS: c_uint = 0x01;
pub const KAWETH_COMMAND_SET_PACKET_FILTER: c_uint = 0x02;
pub const KAWETH_COMMAND_STATISTICS: c_uint = 0x03;
pub const KAWETH_COMMAND_SET_TEMP_MAC: c_uint = 0x06;
pub const KAWETH_COMMAND_GET_TEMP_MAC: c_uint = 0x07;
pub const KAWETH_COMMAND_SET_URB_SIZE: c_uint = 0x08;
pub const KAWETH_COMMAND_SET_SOFS_WAIT: c_uint = 0x09;
pub const KAWETH_COMMAND_SCAN: c_uint = 0xFF;
pub const KAWETH_SOFS_TO_WAIT: c_uint = 0x05;
pub const INTBUFFERSIZE: c_int = 4;
pub const STATE_OFFSET: c_int = 0;
pub const STATE_MASK: c_uint = 0x40;
pub const STATE_SHIFT: c_int = 5;
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_read_configuration(kaweth: *mut kaweth_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_set_urb_size(kaweth: *mut kaweth_device, urb_size: __u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_set_sofs_wait(kaweth: *mut kaweth_device, sofs_wait: __u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_reset(kaweth: *mut kaweth_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_resubmit_int_urb(kaweth: *mut kaweth_device, mf: gfp_t) {
...
#[no_mangle]
unsafe extern "C" fn int_callback(u: *mut urb) {
    static void int_callback(struct urb *u)
    {
    struct kaweth_device *kaweth = u.context;
    int act_state;
    let mut status: c_int = u.status;
    switch (status) {
    case 0:			/* success */
    break;
...
#[no_mangle]
unsafe extern "C" fn kaweth_resubmit_tl(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_usb_receive(urb: *mut urb) {
    ...
    unsigned long flags;
    let mut count: c_int = urb.actual_length;
    let mut count2: c_int = urb.transfer_buffer_length;
    let mut pkt_len: __u16 = le16_to_cpup((__le16 *)kaweth.rx_buf);
    struct sk_buff *skb;
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_open(net: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_kill_urbs(kaweth: *mut kaweth_device) {
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_close(net: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kaweth_get_link(dev: *mut net_device) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_usb_transmit_complete(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_set_rx_mode(net: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(IFF_ALLMULTI): !netdev_mc_empty(net) || (net->flags &) -> else {
...
//
    ...
    {
    int ret;
    let mut packet_filter_bitmap: __u16 = kaweth.packet_filter_bitmap;
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_tx_timeout(net: *mut net_device, txqueue: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
    static int kaweth_suspend(struct usb_interface *intf, pm_message_t message)
    {
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_resume(intf: *mut usb_interface) -> c_int {
    static int kaweth_resume(struct usb_interface *intf)
    {
    struct kaweth_device *kaweth = usb_get_intfdata(intf);
    unsigned long flags;
...
//
    ...
    let mut bcast_addr: eth_addr_t = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
...
//
#[no_mangle]
unsafe extern "C" fn kaweth_disconnect(intf: *mut usb_interface) {
    static void kaweth_disconnect(struct usb_interface *intf)
    {
    struct kaweth_device *kaweth = usb_get_intfdata(intf);
    struct net_device *netdev;
