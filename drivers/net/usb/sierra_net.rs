...
//! Source: drivers/net/usb/sierra_net.c
#![no_std]
...
pub const SWI_USB_REQUEST_GET_FW_ATTR: c_uint = 0x06;
pub const SWI_GET_FW_ATTR_MASK: c_uint = 0x08;
// atomic counter partially included in MAC address to make sure 2 devices
// do not end up with the same MAC - concept breaks in case of > 255 ifaces
//
    let mut iface_counter: static	atomic_t = ATOMIC_INIT(0);
//
// SYNC Timer Delay definition used to set the expiry time
//

// Max. MTU supported. The modem buffers are limited to 1500
pub const SIERRA_NET_MAX_SUPPORTED_MTU: c_int = 1500;
...
//
pub const SIERRA_NET_USBCTL_BUF_LEN: c_int = 1024;
// Overriding the default usbnet rx_urb_size

// Private data structure
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sierra_net_data {
    pub /: *mut *mut u16 link_up; / air link up or down,
    pub /: *mut *mut u8 tx_hdr_template[4]; / part of HIP hdr for tx'd packets,
    pub /: *mut *mut u8 sync_msg[4]; / SYNC message,
    pub /: *mut *mut u8 shdwn_msg[4]; / Shutdown message,
// Backpointer to the container
    pub usbnet: *mut usbnet,
    pub /: *mut *mut u8 ifnum; / interface number,
// Bit masks, must be a power of 2
pub const SIERRA_NET_EVENT_RESP_AVAIL: c_uint = 0x01;
pub const SIERRA_NET_TIMER_EXPIRY: c_uint = 0x02;
    pub kevent_flags: c_ulong,
    pub sierra_net_kevent: work_struct,
    pub /: *mut *mut timer_list sync_timer; / For retrying SYNC sequence,
}
...
// HIP message type
pub const SIERRA_NET_HIP_EXTENDEDID: c_uint = 0x7F;
pub const SIERRA_NET_HIP_HSYNC_ID: c_uint = 0x60	/* Modem -> host */;
pub const SIERRA_NET_HIP_RESTART_ID: c_uint = 0x62	/* Modem -> host */;
pub const SIERRA_NET_HIP_MSYNC_ID: c_uint = 0x20	/* Host -> modem */;
pub const SIERRA_NET_HIP_SHUTD_ID: c_uint = 0x26	/* Host -> modem */;
pub const SIERRA_NET_HIP_EXT_IP_IN_ID: c_uint = 0x0202;
pub const SIERRA_NET_HIP_EXT_IP_OUT_ID: c_uint = 0x0002;
// 3G UMTS Link Sense Indication definitions
pub const SIERRA_NET_HIP_LSI_UMTSID: c_uint = 0x78;
// Reverse Channel Grant Indication HIP message
pub const SIERRA_NET_HIP_RCGI: c_uint = 0x64;
// LSI Protocol types
pub const SIERRA_NET_PROTOCOL_UMTS: c_uint = 0x01;
pub const SIERRA_NET_PROTOCOL_UMTS_DS: c_uint = 0x04;
// LSI Coverage
pub const SIERRA_NET_COVERAGE_NONE: c_uint = 0x00;
pub const SIERRA_NET_COVERAGE_NOPACKET: c_uint = 0x01;
// LSI Session
pub const SIERRA_NET_SESSION_IDLE: c_uint = 0x00;
// LSI Link types
pub const SIERRA_NET_AS_LINK_TYPE_IPV4: c_uint = 0x00;
pub const SIERRA_NET_AS_LINK_TYPE_IPV6: c_uint = 0x02;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lsi_umts {
    pub protocol: u8,
...
// eventually use a union for the rest - assume umts for now
    pub coverage: u8,
    pub /: *mut *mut u8 network_len; / network name len,
    pub /: *mut *mut u8 network[40]; / network name (UCS2, bigendian),
    pub session_state: u8,
    pub unused3: [u8; 33],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lsi_umts_single {
    pub lsi: lsi_umts,
    pub link_type: u8,
    pub /: *mut *mut u8 pdp_addr_len; / NW-supplied PDP address len,
    pub /: *mut *mut u8 pdp_addr[16]; / NW-supplied PDP address (bigendian)),
    pub unused4: [u8; 23],
    pub /: *mut *mut u8 dns1_addr_len; / NW-supplied 1st DNS address len (bigendian),
    pub /: *mut *mut u8 dns1_addr[16]; / NW-supplied 1st DNS address,
    pub /: *mut *mut u8 dns2_addr_len; / NW-supplied 2nd DNS address len,
    pub (bigendian)*/: *mut *mut u8 dns2_addr[16]; / NW-supplied 2nd DNS address,
    pub /: *mut *mut u8 wins1_addr_len; / NW-supplied 1st Wins address len,
    pub (bigendian)*/: *mut *mut u8 wins1_addr[16]; / NW-supplied 1st Wins address,
    pub /: *mut *mut u8 wins2_addr_len; / NW-supplied 2nd Wins address len,
    pub /: *mut *mut u8 wins2_addr[16]; / NW-supplied 2nd Wins address (bigendian),
    pub unused5: [u8; 4],
    pub /: *mut *mut u8 gw_addr_len; / NW-supplied GW address len,
    pub /: *mut *mut u8 gw_addr[16]; / NW-supplied GW address (bigendian),
    pub reserved: [u8; 8],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lsi_umts_dual {
    pub lsi: lsi_umts,
    pub /: *mut *mut u8 pdp_addr4_len; / NW-supplied PDP IPv4 address len,
    pub /: *mut *mut u8 pdp_addr4[4]; / NW-supplied PDP IPv4 address (bigendian)),
    pub /: *mut *mut u8 pdp_addr6_len; / NW-supplied PDP IPv6 address len,
    pub /: *mut *mut u8 pdp_addr6[16]; / NW-supplied PDP IPv6 address (bigendian)),
    pub unused4: [u8; 23],
    pub /: *mut *mut u8 dns1_addr4_len; / NW-supplied 1st DNS v4 address len (bigendian),
    pub /: *mut *mut u8 dns1_addr4[4]; / NW-supplied 1st DNS v4 address,
    pub /: *mut *mut u8 dns1_addr6_len; / NW-supplied 1st DNS v6 address len,
    pub (bigendian)*/: *mut *mut u8 dns1_addr6[16]; / NW-supplied 1st DNS v6 address,
    pub /: *mut *mut u8 dns2_addr4_len; / NW-supplied 2nd DNS v4 address len (bigendian),
    pub /: *mut *mut u8 dns2_addr4[4]; / NW-supplied 2nd DNS v4 address,
    pub /: *mut *mut u8 dns2_addr6_len; / NW-supplied 2nd DNS v6 address len,
    pub (bigendian)*/: *mut *mut u8 dns2_addr6[16]; / NW-supplied 2nd DNS v6 address,
    pub unused5: [u8; 68],
    pub __packed: },
pub const SIERRA_NET_LSI_COMMON_LEN: c_int = 4;
...
// is packet IPv4/IPv6
#[no_mangle]
pub unsafe extern "C" fn is_ip(skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn check_ethip_packet(skb: *mut sk_buff, dev: *mut usbnet) -> c_int {
...
// ----------------------------------------------------------------------------
// HIP header
pub const SIERRA_NET_HIP_HDR_LEN: c_int = 4;
// Extended HIP header
pub const SIERRA_NET_HIP_EXT_HDR_LEN: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hip_hdr {
    pub hdrlen: c_int,
    pub payload_len: param,
    pub msgid: param,
    pub msgspecific: param,
    pub extmsgid: param,
}

#[no_mangle]
unsafe extern "C" fn parse_hip(buf: *const u8, buflen: u32, hh: *mut hip_hdr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sierra_net_send_sync(dev: *mut usbnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sierra_net_set_ctx_index(priv: *mut sierra_net_data, ctx_ix: u8) {
...
#[no_mangle]
unsafe extern "C" fn sierra_net_parse_lsi(dev: *mut usbnet, data: *mut c_char, datalen: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sierra_net_dosync(dev: *mut usbnet) {
...
#[no_mangle]
unsafe extern "C" fn sierra_net_kevent(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sierra_net_defer_kevent(dev: *mut usbnet, work: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sierra_sync_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn sierra_net_status(dev: *mut usbnet, urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn sierra_net_get_link(net: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sierra_net_get_fw_attr(dev: *mut usbnet, datap: *mut u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sierra_net_bind(dev: *mut usbnet, intf: *mut usb_interface) -> c_int {
    static int sierra_net_bind(struct usbnet *dev, struct usb_interface *intf)
    {
    u8	ifacenum;
    u8	numendpoints;
    let mut fwattr: u16 = 0;
    int	status;
    struct sierra_net_data *priv;
...
#[no_mangle]
unsafe extern "C" fn sierra_net_unbind(dev: *mut usbnet, intf: *mut usb_interface) {
...
// tell modem we are going away
    ...
    sierra_net_set_private(dev, core::ptr::null_mut());
    kfree(priv);
    }
...
// ---------------------------- Receive data path ----------------------
#[no_mangle]
unsafe extern "C" fn sierra_net_rx_fixup(dev: *mut usbnet, skb: *mut sk_buff) -> c_int {
