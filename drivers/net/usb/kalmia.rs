...
//! Source: drivers/net/usb/kalmia.c
#![no_std]
...
// #define	DEBUG
// #define	VERBOSE
pub const KALMIA_HEADER_LENGTH: c_int = 6;
pub const KALMIA_ALIGN_SIZE: c_int = 4;
pub const KALMIA_USB_TIMEOUT: c_int = 10000;
// -------------------------------------------------------------------------
    static int
...
#[no_mangle]
pub unsafe extern "C" fn if(init_msg_len: act_len !=) -> else {
    netdev_err(dev.net,
    ...
    status);
#[no_mangle]
pub unsafe extern "C" fn if(expected_len: act_len !=) -> else {
