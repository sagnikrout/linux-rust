...
//! Source: drivers/net/usb/cdc_ether.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn is_rndis(desc: *mut usb_interface_descriptor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_activesync(desc: *mut usb_interface_descriptor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_wireless_rndis(desc: *mut usb_interface_descriptor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_novatel_rndis(desc: *mut usb_interface_descriptor) -> c_int {
...
pub const is_rndis(desc): c_int = 0;
pub const is_activesync(desc): c_int = 0;
pub const is_wireless_rndis(desc): c_int = 0;
pub const is_novatel_rndis(desc): c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn usbnet_cdc_update_filter(dev: *mut usbnet) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usbnet_generic_cdc_bind(dev: *mut usbnet, intf: *mut usb_interface) -> c_int {
    ...
    let mut status: c_int = -ENODEV;
    int				rndis;
    let mut android_rndis_quirk: bool = false;
...
//
#[no_mangle]
pub unsafe extern "C" fn usbnet_ether_cdc_bind(dev: *mut usbnet, intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn usbnet_cdc_unbind(dev: *mut usbnet, intf: *mut usb_interface) {
...
#[no_mangle]
pub unsafe extern "C" fn if(info->control: intf == info->data &&) -> else {
// ensure immediate exit from usbnet_disconnect
    usb_set_intfdata(info.control, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn speed_change(dev: *mut usbnet, speeds: *mut __le32) {
...
#[no_mangle]
pub unsafe extern "C" fn usbnet_cdc_status(dev: *mut usbnet, urb: *mut urb) {
...
#[no_mangle]
pub unsafe extern "C" fn usbnet_cdc_bind(dev: *mut usbnet, intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbnet_cdc_zte_bind(dev: *mut usbnet, intf: *mut usb_interface) -> c_int {
    static int usbnet_cdc_zte_bind(struct usbnet *dev, struct usb_interface *intf)
    {
    let mut status: c_int = usbnet_cdc_bind(dev, intf);
...
//
#[no_mangle]
pub unsafe extern "C" fn usbnet_cdc_zte_rx_fixup(dev: *mut usbnet, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usbnet_cdc_zte_status(dev: *mut usbnet, urb: *mut urb) {
...
pub const NOVATEL_VENDOR_ID: c_uint = 0x1410;
pub const ZTE_VENDOR_ID: c_uint = 0x19D2;
pub const DELL_VENDOR_ID: c_uint = 0x413C;
pub const REALTEK_VENDOR_ID: c_uint = 0x0bda;
pub const SAMSUNG_VENDOR_ID: c_uint = 0x04e8;
pub const LENOVO_VENDOR_ID: c_uint = 0x17ef;
pub const LINKSYS_VENDOR_ID: c_uint = 0x13b1;
pub const NVIDIA_VENDOR_ID: c_uint = 0x0955;
pub const HP_VENDOR_ID: c_uint = 0x03f0;
pub const MICROSOFT_VENDOR_ID: c_uint = 0x045e;
pub const UBLOX_VENDOR_ID: c_uint = 0x1546;
pub const TPLINK_VENDOR_ID: c_uint = 0x2357;
pub const AQUANTIA_VENDOR_ID: c_uint = 0x2eca;
pub const ASIX_VENDOR_ID: c_uint = 0x0b95;
