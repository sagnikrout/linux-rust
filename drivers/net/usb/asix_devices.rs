...
//! Source: drivers/net/usb/asix_devices.c
#![no_std]
...
pub const PHY_MODE_MARVELL: c_uint = 0x0000;
pub const MII_MARVELL_LED_CTRL: c_uint = 0x0018;
pub const MII_MARVELL_STATUS: c_uint = 0x001b;
pub const MII_MARVELL_CTRL: c_uint = 0x0014;
pub const MARVELL_LED_MANUAL: c_uint = 0x0019;
pub const MARVELL_STATUS_HWCFG: c_uint = 0x0004;
pub const MARVELL_CTRL_TXDELAY: c_uint = 0x0002;
pub const MARVELL_CTRL_RXDELAY: c_uint = 0x0080;
pub const PHY_MODE_RTL8211CL: c_uint = 0x000C;
pub const AX88772A_PHY14H: c_uint = 0x14;
pub const AX88772A_PHY14H_DEFAULT: c_uint = 0x442C;
pub const AX88772A_PHY15H: c_uint = 0x15;
pub const AX88772A_PHY15H_DEFAULT: c_uint = 0x03C8;
pub const AX88772A_PHY16H: c_uint = 0x16;
pub const AX88772A_PHY16H_DEFAULT: c_uint = 0x4044;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ax88172_int_data {
    pub res1: __le16,
    pub link: u8,
    pub res2: __le16,
    pub status: u8,
    ...
    pub __packed: },
#[no_mangle]
unsafe extern "C" fn asix_status(dev: *mut usbnet, urb: *mut urb) {
    static void asix_status(struct usbnet *dev, struct urb *urb)
    {
    pub event: *mut ax88172_int_data,
    pub link: c_int,
    if (urb.actual_length < 8)
    pub urb->transfer_buffer: event =,
    pub 0x01: link = event->link &,
    if (netif_carrier_ok(dev.net) != link) {
    pub 1): usbnet_link_change(dev, link,,
    pub link): netdev_dbg(dev->net, "Link Status is: %d\n",,
    }
    }
#[no_mangle]
unsafe extern "C" fn asix_set_netdev_dev_addr(dev: *mut usbnet, addr: *mut u8) {
    static void asix_set_netdev_dev_addr(struct usbnet *dev, u8 *addr)
    {
    if (is_valid_ether_addr(addr)) {
    pub addr): eth_hw_addr_set(dev->net,,
    } else {
    pub random\n"): netdev_info(dev->net, "invalid hw address, using,
    }
    }
// Get the PHY Identifier from the PHYSID1 & PHYSID2 MII registers
#[no_mangle]
unsafe extern "C" fn asix_get_phyid(dev: *mut usbnet) -> u32 {
...
// Poll for the rare case the FW or phy isn't ready yet.
    pub {: for (i = 0; i < 100; i++),
    pub MII_PHYSID1): phy_reg = asix_mdio_read(dev->net, dev->mii.phy_id,,
    if (phy_reg < 0)
    pub 0: return,
    ...
    if (phy_reg <= 0 || phy_reg == 0xFFFF)
    pub 0: return,
    pub 16: phy_id = (phy_reg & 0xffff) <<,
    pub MII_PHYSID2): phy_reg = asix_mdio_read(dev->net, dev->mii.phy_id,,
    if (phy_reg < 0)
    pub 0: return,
    pub 0xffff): phy_id |= (phy_reg &,
    pub phy_id: return,
    }
...
#[no_mangle]
unsafe extern "C" fn ax88172_set_multicast(net: *mut net_device) {
    static void ax88172_set_multicast(struct net_device *net)
    {
    struct usbnet *dev = netdev_priv(net);
    struct asix_data *data = (struct asix_data *)&dev.data;
    let mut rx_ctl: u8 = 0x8c;
...
#[no_mangle]
unsafe extern "C" fn ax88172_link_reset(dev: *mut usbnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn asix_phy_reset(dev: *mut usbnet, reset_bits: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ax88172_bind(dev: *mut usbnet, intf: *mut usb_interface) -> c_int {
    static int ax88172_bind(struct usbnet *dev, struct usb_interface *intf)
    {
    let mut ret: c_int = 0;
    u8 buf[ETH_ALEN] = {0};
    int i;
    let mut gpio_bits: c_ulong = dev.driver_info.data;
...
// Toggle the GPIOs in a manufacturer/model specific way
    ...
    (gpio_bits >> (i * 8)) & 0xff, 0, 0, core::ptr::null_mut(), 0);
    if (ret < 0)
    goto out;
    msleep(5);
    }
...
#[no_mangle]
unsafe extern "C" fn ax88772_ethtool_get_sset_count(ndev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ax88772_reset(dev: *mut usbnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ax88772_hw_reset(dev: *mut usbnet, in_pm: c_int) -> c_int {
    ...
    AX88772_IPG2_DEFAULT, 0, core::ptr::null_mut(), in_pm);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn ax88772a_hw_reset(dev: *mut usbnet, in_pm: c_int) -> c_int {
    ...
    goto out;
    ret = asix_write_cmd(dev, AX_CMD_SW_PHY_SELECT, priv.embd_phy |
    AX_PHYSEL_SSEN, 0, 0, core::ptr::null_mut(), in_pm);
    if (ret < 0) {
    netdev_dbg(dev.net, "Select PHY #1 failed: %d\n", ret);
    goto out;
    }
...
#[no_mangle]
unsafe extern "C" fn ax88772_suspend(dev: *mut usbnet) {
...
//
#[no_mangle]
unsafe extern "C" fn asix_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ax88772_resume(dev: *mut usbnet) {
...
#[no_mangle]
unsafe extern "C" fn asix_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ax88772_init_mdio(dev: *mut usbnet) -> c_int {
...
// mii bus name is usb-<usb bus number>-<usb device number>
    ...
    priv.mdio = core::ptr::null_mut();
    }
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn ax88772_mdio_unregister(priv: *mut asix_common_private) {
...
#[no_mangle]
unsafe extern "C" fn ax88772_init_phy(dev: *mut usbnet) -> c_int {
...
// Nothing to do
    ...
    {
    struct usbnet *dev = netdev_priv(to_net_dev(config.dev));
    let mut m: u16 = AX_MEDIUM_AC | AX_MEDIUM_RE;
...
#[no_mangle]
unsafe extern "C" fn ax88772_phylink_setup(dev: *mut usbnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ax88772_bind(dev: *mut usbnet, intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ax88772_stop(dev: *mut usbnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ax88772_unbind(dev: *mut usbnet, intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn ax88178_unbind(dev: *mut usbnet, intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn marvell_phy_init(dev: *mut usbnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8211cl_phy_init(dev: *mut usbnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn marvell_led_status(dev: *mut usbnet, speed: u16) -> c_int {
    static int marvell_led_status(struct usbnet *dev, u16 speed)
    {
    let mut reg: u16 = asix_mdio_read(dev.net, dev.mii.phy_id, MARVELL_LED_MANUAL);
...
#[no_mangle]
unsafe extern "C" fn ax88178_reset(dev: *mut usbnet) -> c_int {
    ...
    asix_write_cmd(dev, AX_CMD_WRITE_ENABLE, 0, 0, 0, core::ptr::null_mut(), 0);
    ret = asix_read_cmd(dev, AX_CMD_READ_EEPROM, 0x0017, 0, 2, &eeprom, 0);
    if (ret < 0) {
    netdev_dbg(dev.net, "Failed to read EEPROM: %d\n", ret);
    return ret;
    }
    asix_write_cmd(dev, AX_CMD_WRITE_DISABLE, 0, 0, 0, core::ptr::null_mut(), 0);
...
// Set AX88178 to enable MII/GMII/RGMII interface for external PHY
    asix_write_cmd(dev, AX_CMD_SW_PHY_SELECT, 0, 0, 0, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn ax88178_link_reset(dev: *mut usbnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ax88178_set_mfb(dev: *mut usbnet) {
    static void ax88178_set_mfb(struct usbnet *dev)
    {
    let mut mfb: u16 = AX_RX_CTL_MFB_16384;
    u16 rxctl;
    u16 medium;
...
#[no_mangle]
unsafe extern "C" fn ax88178_change_mtu(net: *mut net_device, new_mtu: c_int) -> c_int {
    static int ax88178_change_mtu(struct net_device *net, int new_mtu)
    {
    struct usbnet *dev = netdev_priv(net);
    let mut ll_mtu: c_int = new_mtu + net.hard_header_len + 4;
...
#[no_mangle]
unsafe extern "C" fn ax88178_bind(dev: *mut usbnet, intf: *mut usb_interface) -> c_int {
