...
//! Source: drivers/net/usb/ax88172a.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ax88172a_private {
    pub mdio: *mut mii_bus,
    pub phydev: *mut phy_device,
    pub phy_name: [c_char; PHY_ID_SIZE],
    pub phy_addr: u8,
    pub oldmode: u16,
    pub use_embdphy: c_int,
    pub rx_fixup_info: asix_rx_fixup_info,
}

// set MAC link settings according to information from phylib
#[no_mangle]
unsafe extern "C" fn ax88172a_adjust_link(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ax88172a_status(dev: *mut usbnet, urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn ax88172a_init_mdio(dev: *mut usbnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ax88172a_remove_mdio(dev: *mut usbnet) {
...
#[no_mangle]
unsafe extern "C" fn ax88172a_reset_phy(dev: *mut usbnet, embd_phy: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ax88172a_bind(dev: *mut usbnet, intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ax88172a_stop(dev: *mut usbnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ax88172a_unbind(dev: *mut usbnet, intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn ax88172a_reset(dev: *mut usbnet) -> c_int {
    ...
    AX88772_IPG2_DEFAULT, 0, core::ptr::null_mut(), 0);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn ax88172a_rx_fixup(dev: *mut usbnet, skb: *mut sk_buff) -> c_int {
