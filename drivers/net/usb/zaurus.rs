...
//! Source: drivers/net/usb/zaurus.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn zaurus_bind(dev: *mut usbnet, intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn always_connected(dev: *mut usbnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn blan_mdlm_bind(dev: *mut usbnet, intf: *mut usb_interface) -> c_int {
