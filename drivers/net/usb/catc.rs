...
// The catc struct.
//
pub const CTRL_RUNNING: c_int = 0;
pub const RX_RUNNING: c_int = 1;
pub const TX_RUNNING: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct catc {
    ...
    pub flags: c_ulong,
    pub tx_idx: unsigned int tx_ptr,,
    pub ctrl_tail: unsigned int ctrl_head,,
    pub ctrl_lock: spinlock_t tx_lock,,
    pub 2)]: *mut *mut u8 tx_buf[2][TX_MAX_BURST  (PKT_SZ +,
    pub 2)]: *mut *mut u8 rx_buf[RX_MAX_BURST  (PKT_SZ +,
    pub irq_buf: [u8; 2],
    pub ctrl_buf: [u8; 64],
    pub ctrl_dr: usb_ctrlrequest,
    pub timer: timer_list,
    pub stats_buf: [u8; 8],
    pub stats_vals: [u16; 4],
    pub last_stats: c_ulong,
    pub multicast: [u8; 64],
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ctrl_queue {
    pub dir: u8,
    pub request: u8,
    pub value: u16,
    pub index: u16,
    pub buf: *mut c_void,
    pub len: c_int,
    pub q): *mut *mut *mut void (callback)(struct catc catc, struct ctrl_queue,
    pub ctrl_queue: [}; CTRL_QUEUE],
    pub ctrl_urb: *mut *mut *mut *mut urb tx_urb, rx_urb, irq_urb,,
    pub /: *mut *mut u8 is_f5u011; / Set if device is an F5U011,
    pub /: *mut *mut u8 rxmode[2]; / Used for F5U011,
    pub /: *mut *mut atomic_t recq_sz; / Used for F5U011 - counter of waiting rx packets,
}
...
//
#[no_mangle]
unsafe extern "C" fn catc_rx_done(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn catc_irq_done(urb: *mut urb) {
    ...
    linksts = LinkGood;
#[no_mangle]
pub unsafe extern "C" fn if(0x20: data[1] &) -> else {
    else if (data[1] & 0x20)
    linksts = LinkBad;
    } else {
    ...
    linksts = LinkGood;
#[no_mangle]
pub unsafe extern "C" fn if(0xA0: data[0] ==) -> else {
    else if (data[0] == 0xA0)
    linksts = LinkBad;
    }
    switch (status) {
...
//
#[no_mangle]
unsafe extern "C" fn catc_tx_run(catc: *mut catc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn catc_tx_done(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn catc_tx_timeout(netdev: *mut net_device, txqueue: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn catc_ctrl_msg(catc: *mut catc, dir: u8, request: u8, value: u16, index: u16, buf: *mut c_void, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn catc_ctrl_run(catc: *mut catc) {
...
#[no_mangle]
unsafe extern "C" fn catc_ctrl_done(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn catc_stats_done(catc: *mut catc, q: *mut ctrl_queue) {
    static void catc_stats_done(struct catc *catc, struct ctrl_queue *q)
    {
    let mut index: c_int = q.index - EthStats;
    u16 data, last;
...
#[no_mangle]
unsafe extern "C" fn catc_stats_timer(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn catc_multicast(addr: *const c_uchar, multicast: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn catc_set_multicast_list(netdev: *mut net_device) {
    static void catc_set_multicast_list(struct net_device *netdev)
    {
    struct catc *catc = netdev_priv(netdev);
    struct netdev_hw_addr *ha;
    u8 broadcast[ETH_ALEN];
    let mut rx: u8 = RxEnable | RxPolarity | RxMultiCast;
    ...
    let mut crc: u32 = ether_crc_le(6, ha.addr);
    if (!catc.is_f5u011) {
...
//
#[no_mangle]
unsafe extern "C" fn catc_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn catc_stop(netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn catc_probe(intf: *mut usb_interface, id: *const usb_device_id) -> c_int {
...
// The F5U011 has the same vendor/product as the netmate but a device version of 0x130
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), 0, catc_ctrl_done, catc);
    usb_fill_bulk_urb(catc.tx_urb, usbdev, usb_sndbulkpipe(usbdev, CATC_USB_EP_BULK),
    core::ptr::null_mut(), 0, catc_tx_done, catc);
...
#[no_mangle]
unsafe extern "C" fn catc_disconnect(intf: *mut usb_interface) {
