...
//! Source: drivers/net/usb/mcs7830.c
#![no_std]
...
// requests
    ...
    USB_RECIP_DEVICE)
pub const MCS7830_RD_BREQ: c_uint = 0x0E;
pub const MCS7830_WR_BREQ: c_uint = 0x0D;
pub const MCS7830_CTRL_TIMEOUT: c_int = 1000;
pub const MCS7830_MAX_MCAST: c_int = 64;
pub const MCS7830_VENDOR_ID: c_uint = 0x9710;
pub const MCS7832_PRODUCT_ID: c_uint = 0x7832;
pub const MCS7830_PRODUCT_ID: c_uint = 0x7830;
pub const MCS7730_PRODUCT_ID: c_uint = 0x7730;
pub const SITECOM_VENDOR_ID: c_uint = 0x0DF6;
pub const LN_030_PRODUCT_ID: c_uint = 0x0021;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcs7830_data {
    pub multi_filter: [u8; 8],
    pub config: u8,
}

    static const char driver_name[] = "MOSCHIP usb-ethernet driver";
#[no_mangle]
unsafe extern "C" fn mcs7830_get_reg(dev: *mut usbnet, index: u16, size: u16, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_set_reg(dev: *mut usbnet, index: u16, size: u16, data: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_set_reg_async(dev: *mut usbnet, index: u16, size: u16, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_hif_get_mac_address(dev: *mut usbnet, addr: *mut c_uchar) -> c_int {
    static int mcs7830_hif_get_mac_address(struct usbnet *dev, unsigned char *addr)
    {
    let mut ret: c_int = mcs7830_get_reg(dev, HIF_REG_ETHERNET_ADDR, ETH_ALEN, addr);
    if (ret < 0)
    return ret;
    return 0;
    }
    ...
    {
    let mut ret: c_int = mcs7830_set_reg(dev, HIF_REG_ETHERNET_ADDR, ETH_ALEN, addr);
    if (ret < 0)
    return ret;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mcs7830_set_mac_address(netdev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_read_phy(dev: *mut usbnet, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_write_phy(dev: *mut usbnet, index: u8, val: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mcs7830_set_autoneg(dev: *mut usbnet, ptrUserPhyMode: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mcs7830_get_rev(dev: *mut usbnet) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mcs7830_rev_C_fixup(dev: *mut usbnet) {
    static void mcs7830_rev_C_fixup(struct usbnet *dev)
    {
    let mut pause_threshold: u8 = HIF_REG_PAUSE_THRESHOLD_DEFAULT;
    int retry;
...
#[no_mangle]
unsafe extern "C" fn mcs7830_hif_update_multicast_hash(dev: *mut usbnet) {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_hif_update_config(dev: *mut usbnet) {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_data_set_multicast(net: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_apply_base_config(dev: *mut usbnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_set_multicast(net: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_get_regs_len(net: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_get_regs(net: *mut net_device, regs: *mut ethtool_regs, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_bind(dev: *mut usbnet, udev: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_rx_fixup(dev: *mut usbnet, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_status(dev: *mut usbnet, urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn mcs7830_reset_resume(intf: *mut usb_interface) -> c_int {
