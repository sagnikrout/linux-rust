...
//! Source: drivers/net/usb/qmi_wwan.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmimux_priv {
    pub real_dev: *mut net_device,
    pub mux_id: u8,
}

#[no_mangle]
unsafe extern "C" fn qmimux_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmimux_stop(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmimux_start_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn qmimux_setup(dev: *mut net_device) {
    static void qmimux_setup(struct net_device *dev)
    {
    dev.header_ops      = core::ptr::null_mut();  /* No header */
...
#[no_mangle]
unsafe extern "C" fn qmimux_has_slaves(dev: *mut usbnet) -> bool {
    static bool qmimux_has_slaves(struct usbnet *dev)
    {
    return !list_empty(&dev.net.adj_list.upper);
    }
#[no_mangle]
unsafe extern "C" fn qmimux_rx_fixup(dev: *mut usbnet, skb: *mut sk_buff) -> c_int {
    ...
    struct sk_buff *skbn;
    let mut qmimux_hdr_sz: u8 = sizeof(*hdr);
...
#[no_mangle]
unsafe extern "C" fn mux_id_show(d: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn qmimux_register_device(real_dev: *mut net_device, mux_id: u8) -> c_int {
...
// Account for reference in struct qmimux_priv_priv
    dev_hold(real_dev);
    err = netdev_upper_dev_link(real_dev, new_dev, core::ptr::null_mut());
    if (err)
...
#[no_mangle]
unsafe extern "C" fn qmi_wwan_netdev_setup(net: *mut net_device) {
    static void qmi_wwan_netdev_setup(struct net_device *net)
    {
    struct usbnet *dev = netdev_priv(net);
    struct qmi_wwan_state *info = (void *)&dev.data;
    if (info.flags & QMI_WWAN_FLAG_RAWIP) {
    net.header_ops      = core::ptr::null_mut();  /* No header */
...
#[no_mangle]
unsafe extern "C" fn raw_ip_show(d: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn raw_ip_store(d: *mut device, attr: *mut device_attribute, buf: *const c_char, len: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn add_mux_show(d: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn add_mux_store(d: *mut device, attr: *mut device_attribute, buf: *const c_char, len: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn del_mux_show(d: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    static ssize_t del_mux_show(struct device *d, struct device_attribute *attr, char *buf)
    {
    return add_mux_show(d, attr, buf);
    }
#[no_mangle]
unsafe extern "C" fn del_mux_store(d: *mut device, attr: *mut device_attribute, buf: *const c_char, len: usize) -> isize {
    ...
    qmimux_unregister_device(del_dev, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn qmi_wwan_rx_fixup(dev: *mut usbnet, skb: *mut sk_buff) -> c_int {
    static int qmi_wwan_rx_fixup(struct usbnet *dev, struct sk_buff *skb)
    {
    struct qmi_wwan_state *info = (void *)&dev.data;
    let mut rawip: bool = info.flags & QMI_WWAN_FLAG_RAWIP;
    __be16 proto;
...
#[no_mangle]
unsafe extern "C" fn possibly_iphdr(data: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qmi_wwan_mac_addr(dev: *mut net_device, p: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qmi_wwan_manage_power(dev: *mut usbnet, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmi_wwan_cdc_wdm_manage_power(intf: *mut usb_interface, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmi_wwan_register_subdriver(dev: *mut usbnet) -> c_int {
    static int qmi_wwan_register_subdriver(struct usbnet *dev)
    {
    int rv;
    struct usb_driver *subdriver = core::ptr::null_mut();
    struct qmi_wwan_state *info = (void *)&dev.data;
...
//
#[no_mangle]
unsafe extern "C" fn qmi_wwan_change_dtr(dev: *mut usbnet, on: bool) -> c_int {
    static int qmi_wwan_change_dtr(struct usbnet *dev, bool on)
    {
    let mut intf: u8 = dev.intf.cur_altsetting.desc.bInterfaceNumber;
    return usbnet_write_cmd(dev, USB_CDC_REQ_SET_CONTROL_LINE_STATE,
    USB_DIR_OUT | USB_TYPE_CLASS | USB_RECIP_INTERFACE,
    on ? 0x01 : 0x00, intf, core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn qmi_wwan_bind(dev: *mut usbnet, intf: *mut usb_interface) -> c_int {
    static int qmi_wwan_bind(struct usbnet *dev, struct usb_interface *intf)
    {
    int status;
    u8 *buf = intf.cur_altsetting.extra;
    let mut len: c_int = intf.cur_altsetting.extralen;
...
// claim data interface and set it up
    ...
    usb_set_intfdata(info.data, core::ptr::null_mut());
...
// make MAC addr easily distinguishable from an IP header
    ...
    let mut addr: u8 = dev.net.dev_addr[0];
...
#[no_mangle]
unsafe extern "C" fn qmi_wwan_unbind(dev: *mut usbnet, intf: *mut usb_interface) {
...
// only if not shared
    if (other && intf != other) {
    usb_set_intfdata(other, core::ptr::null_mut());
    usb_driver_release_interface(driver, other);
    }
    info.subdriver = core::ptr::null_mut();
    info.data = core::ptr::null_mut();
    info.control = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn qmi_wwan_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmi_wwan_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quectel_ec20_detected(intf: *mut usb_interface) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qmi_wwan_disconnect(intf: *mut usb_interface) {
