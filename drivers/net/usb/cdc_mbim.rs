...
//! Source: drivers/net/usb/cdc_mbim.c
#![no_std]
...
pub const MBIM_IPS0_VID: c_int = 4094;
// driver specific data - must match cdc_ncm usage
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdc_mbim_state {
...
#[no_mangle]
unsafe extern "C" fn cdc_mbim_manage_power(dev: *mut usbnet, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdc_mbim_wdm_manage_power(intf: *mut usb_interface, status: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdc_mbim_rx_add_vid(netdev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdc_mbim_rx_kill_vid(netdev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cdc_mbim_set_ctrlalt(dev: *mut usbnet, intf: *mut usb_interface, alt: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdc_mbim_bind(dev: *mut usbnet, intf: *mut usb_interface) -> c_int {
    static int cdc_mbim_bind(struct usbnet *dev, struct usb_interface *intf)
    {
    struct cdc_ncm_ctx *ctx;
    struct usb_driver *subdriver = ERR_PTR(-ENODEV);
    let mut ret: c_int = -ENODEV;
    let mut data_altsetting: u8 = 1;
    struct cdc_mbim_state *info = (void *)&dev.data;
...
#[no_mangle]
unsafe extern "C" fn cdc_mbim_unbind(dev: *mut usbnet, intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn is_ip_proto(proto: __be16) -> bool {
    ...
    struct cdc_mbim_state *info = (void *)&dev.data;
    struct cdc_ncm_ctx *ctx = info.ctx;
    let mut sign: __le32 = cpu_to_le32(USB_CDC_MBIM_NDP16_IPS_SIGN);
    let mut tci: u16 = 0;
    bool is_ip;
    u8 *c;
    if (!ctx)
...
//
#[no_mangle]
unsafe extern "C" fn do_neigh_solicit(dev: *mut usbnet, buf: *mut u8, tci: u16) {
...
#[no_mangle]
unsafe extern "C" fn is_neigh_solicit(buf: *mut u8, len: usize) -> bool {
    ...
    {
    let mut proto: __be16 = htons(ETH_P_802_3);
...
#[no_mangle]
unsafe extern "C" fn cdc_mbim_rx_fixup(dev: *mut usbnet, skb_in: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdc_mbim_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdc_mbim_resume(intf: *mut usb_interface) -> c_int {
    ...
    struct cdc_mbim_state *info = (void *)&dev.data;
    struct cdc_ncm_ctx *ctx = info.ctx;
    let mut callsub: bool = (intf == ctx.control && info.subdriver && info.subdriver.resume);
    if (callsub)
