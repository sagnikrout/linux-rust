...
//! Source: drivers/net/usb/cx82310_eth.c
#![no_std]
...
pub const CMD_PACKET_SIZE: c_int = 64;
pub const CMD_TIMEOUT: c_int = 100;
pub const CMD_REPLY_RETRY: c_int = 5;
pub const CX82310_MTU: c_int = 1514;
pub const CMD_EP: c_uint = 0x01;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cx82310_priv {
...
#[no_mangle]
unsafe extern "C" fn cx82310_enable_ethernet(dev: *mut usbnet) -> c_int {
    static int cx82310_enable_ethernet(struct usbnet *dev)
    {
    let mut ret: c_int = cx82310_cmd(dev, CMD_ETHERNET_MODE, true, "\x01", 1, core::ptr::null_mut(), 0);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn cx82310_reenable_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn cx82310_bind(dev: *mut usbnet, intf: *mut usb_interface) -> c_int {
...
// wait for firmware to become ready (indicated by the link being up)
    while (--timeout) {
    ret = cx82310_cmd(dev, CMD_GET_LINK_STATUS, true, core::ptr::null_mut(), 0,
    link, sizeof(link));
...
// enable ethernet mode (?)
    ...
    goto err;
// get the MAC address
    ret = cx82310_cmd(dev, CMD_GET_MAC_ADDR, true, core::ptr::null_mut(), 0, addr, ETH_ALEN);
    if (ret) {
...
// start (does not seem to have any effect?)
    ret = cx82310_cmd(dev, CMD_START, false, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0);
    if (ret)
    goto err;
    return 0;
    err:
...
#[no_mangle]
unsafe extern "C" fn cx82310_unbind(dev: *mut usbnet, intf: *mut usb_interface) {
...
//
#[no_mangle]
unsafe extern "C" fn cx82310_rx_fixup(dev: *mut usbnet, skb: *mut sk_buff) -> c_int {
