...
//! Source: drivers/net/netconsole.c
#![no_std]
...
pub const MAX_PARAM_LENGTH: c_int = 256;
pub const MAX_EXTRADATA_ENTRY_LEN: c_int = 256;
pub const MAX_EXTRADATA_VALUE_LEN: c_int = 200;
// The number 3 comes from userdata entry format characters (' ', '=', '\n')

    MAX_EXTRADATA_VALUE_LEN - 3)
pub const MAX_USERDATA_ITEMS: c_int = 256;
pub const MAX_PRINT_CHUNK: c_int = 1000;
//
...
// memory pressure.
//
pub const MAX_UDP_CHUNK: c_int = 1460;
pub const MAX_SKBS: c_int = 32;
...
#[no_mangle]
unsafe extern "C" fn option_setup(opt: *mut c_char) -> int __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct netconsole_target_stats {
    pub xmit_drop_count: u64_stats_t,
    pub enomem_count: u64_stats_t,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct netconsole_target {
    pub list: list_head,

    pub group: config_group,
    pub userdata_group: config_group,
    pub userdata: *mut netcons_userdata __rcu,
    pub MAX_SYSDATA_ITEMS]: *mut *mut char sysdata[MAX_EXTRADATA_ENTRY_LEN,
// bit-wise with sysdata_feature bits
    pub sysdata_fields: u32,
// protected by target_list_lock
    pub msgcounter: u32,

    pub stats: netconsole_target_stats,
    pub state: enum target_state,
    pub extended: bool,
    pub release: bool,
    pub np: netpoll,
    pub remote_ip: union inet_addr local_ip,,
    pub ipv6: bool,
    pub remote_port: u16 local_port,,
    pub remote_mac: [u8; ETH_ALEN],
...
//
    pub 1]: char buf[MAX_PRINT_CHUNK +,
    pub resume_wq: work_struct,
    pub skb_pool: sk_buff_head,
    pub refill_wq: work_struct,
}

    static struct configfs_subsystem netconsole_subsys;
    static DEFINE_MUTEX(dynamic_netconsole_mutex);
#[no_mangle]
unsafe extern "C" fn dynamic_netconsole_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dynamic_netconsole_exit() -> void __exit {
...
//
#[no_mangle]
unsafe extern "C" fn netconsole_target_get(nt: *mut netconsole_target) {
...
#[no_mangle]
unsafe extern "C" fn netconsole_target_put(nt: *mut netconsole_target) {
...
#[no_mangle]
unsafe extern "C" fn dynamic_netconsole_mutex_lock() {
    static void dynamic_netconsole_mutex_lock(void)
    {
    mutex_lock(&dynamic_netconsole_mutex);
    }
#[no_mangle]
unsafe extern "C" fn dynamic_netconsole_mutex_unlock() {
...
#[no_mangle]
unsafe extern "C" fn bound_by_mac(nt: *mut netconsole_target) -> bool {
    static bool bound_by_mac(struct netconsole_target *nt)
    {
    return is_valid_ether_addr(nt.np.dev_mac);
    }
#[no_mangle]
unsafe extern "C" fn netcons_release_dev(nt: *mut netconsole_target) {
...
#[no_mangle]
unsafe extern "C" fn refill_skbs(nt: *mut netconsole_target) {
...
#[no_mangle]
unsafe extern "C" fn refill_skbs_work_handler(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn netconsole_skb_pool_init(nt: *mut netconsole_target) {
    static void netconsole_skb_pool_init(struct netconsole_target *nt)
    {
    refill_skbs(nt);
    }
#[no_mangle]
unsafe extern "C" fn netconsole_skb_pool_flush(nt: *mut netconsole_target) {
...
#[no_mangle]
unsafe extern "C" fn netcons_wait_carrier(np: *mut netpoll, ndev: *mut net_device) {
...
//
    ...
    let mut err: c_int = -EDESTADDRREQ;
...
//
#[no_mangle]
unsafe extern "C" fn netcons_local_ip_unset(nt: *const netconsole_target) -> bool {
...
#[no_mangle]
unsafe extern "C" fn netcons_netpoll_setup(nt: *mut netconsole_target) -> c_int {
    ...
    struct netpoll *np = &nt.np;
    let mut ip_overwritten: bool = false;
    int err;
    rtnl_lock();
    if (np.dev_name[0])
    ndev = __dev_get_by_name(net, np.dev_name);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_valid_ether_addr(np->dev_mac)) -> else {
    ...
    netcons_egress_dev(np, buf, sizeof(buf)));
    err = dev_open(ndev, core::ptr::null_mut());
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn resume_target(nt: *mut netconsole_target) {
...
#[no_mangle]
unsafe extern "C" fn process_resume_target(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn netconsole_process_cleanups_core() {
...
#[no_mangle]
unsafe extern "C" fn netconsole_print_banner(nt: *mut netconsole_target) {
...
//
#[no_mangle]
unsafe extern "C" fn netpoll_parse_ip_addr(str: *const c_char, addr: *mut union inet_addr) -> c_int {
    static int netpoll_parse_ip_addr(const char *str, union inet_addr *addr)
    {
    const char *end = core::ptr::null_mut();
    int len;
    len = strlen(str);
    if (!len)
    return -1;
...
//
#[no_mangle]
unsafe extern "C" fn netconsole_process_cleanups() {
...
#[no_mangle]
unsafe extern "C" fn trim_newline(s: *mut c_char, maxlen: usize) {
...
//
#[no_mangle]
unsafe extern "C" fn enabled_show(item: *mut config_item, buf: *mut c_char) -> isize {
    static ssize_t enabled_show(struct config_item *item, char *buf)
    {
    return sysfs_emit(buf, "%d\n", to_target(item).state == STATE_ENABLED);
    }
#[no_mangle]
unsafe extern "C" fn extended_show(item: *mut config_item, buf: *mut c_char) -> isize {
    static ssize_t extended_show(struct config_item *item, char *buf)
    {
    return sysfs_emit(buf, "%d\n", to_target(item).extended);
    }
#[no_mangle]
unsafe extern "C" fn release_show(item: *mut config_item, buf: *mut c_char) -> isize {
    static ssize_t release_show(struct config_item *item, char *buf)
    {
    return sysfs_emit(buf, "%d\n", to_target(item).release);
    }
#[no_mangle]
unsafe extern "C" fn dev_name_show(item: *mut config_item, buf: *mut c_char) -> isize {
    static ssize_t dev_name_show(struct config_item *item, char *buf)
    {
    return sysfs_emit(buf, "%s\n", to_target(item).np.dev_name);
    }
#[no_mangle]
unsafe extern "C" fn local_port_show(item: *mut config_item, buf: *mut c_char) -> isize {
    static ssize_t local_port_show(struct config_item *item, char *buf)
    {
    return sysfs_emit(buf, "%d\n", to_target(item).local_port);
    }
#[no_mangle]
unsafe extern "C" fn remote_port_show(item: *mut config_item, buf: *mut c_char) -> isize {
    static ssize_t remote_port_show(struct config_item *item, char *buf)
    {
    return sysfs_emit(buf, "%d\n", to_target(item).remote_port);
    }
#[no_mangle]
unsafe extern "C" fn local_ip_show(item: *mut config_item, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn remote_ip_show(item: *mut config_item, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn local_mac_show(item: *mut config_item, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn remote_mac_show(item: *mut config_item, buf: *mut c_char) -> isize {
    static ssize_t remote_mac_show(struct config_item *item, char *buf)
    {
    return sysfs_emit(buf, "%pM\n", to_target(item).remote_mac);
    }
#[no_mangle]
unsafe extern "C" fn transmit_errors_show(item: *mut config_item, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn sysdata_cpu_nr_enabled_show(item: *mut config_item, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn unregister_netcons_consoles() {
    static void unregister_netcons_consoles(void)
    {
    struct netconsole_target *nt;
    let mut console_type_needed: u32 = 0;
    unsigned long flags;
    spin_lock_irqsave(&target_list_lock, flags);
...
//
#[no_mangle]
unsafe extern "C" fn count_userdata_entries(nt: *mut netconsole_target) -> usize {
...
pub struct userdatum {
    ...
    pub value: [c_char; MAX_EXTRADATA_VALUE_LEN],
}
...
#[no_mangle]
unsafe extern "C" fn userdatum_value_show(item: *mut config_item, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn calc_userdata_len(nt: *mut netconsole_target) -> c_int {
...
// Skip userdata with no value set
    if (udm_item.value[0]) {
    len += snprintf(core::ptr::null_mut(), 0, " %s=%s\n", item.ci_name,
    udm_item.value);
    }
    }
    return len;
...
#[no_mangle]
unsafe extern "C" fn update_userdata(nt: *mut netconsole_target) -> c_int {
    static int update_userdata(struct netconsole_target *nt)
    {
    struct netcons_userdata *new = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn userdatum_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn userdatum_drop(group: *mut config_group, item: *mut config_item) {
...
//
#[no_mangle]
unsafe extern "C" fn netconsole_target_release(item: *mut config_item) {
    ...
    {
    struct netconsole_target *nt, *ret = core::ptr::null_mut();
    unsigned long flags;
    spin_lock_irqsave(&target_list_lock, flags);
    list_for_each_entry(nt, &target_list, list) {
...
#[no_mangle]
unsafe extern "C" fn sysdata_append_release(nt: *mut netconsole_target, offset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysdata_append_msgid(nt: *mut netconsole_target, offset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn push_udp(nt: *mut netconsole_target, skb: *mut sk_buff, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn push_eth(nt: *mut netconsole_target, skb: *mut sk_buff) {
...
//
#[no_mangle]
unsafe extern "C" fn send_udp(nt: *mut netconsole_target, msg: *const c_char, len: c_int) {
    static void send_udp(struct netconsole_target *nt, const char *msg, int len)
    {
    let mut result: c_int = netpoll_send_udp(nt, msg, len);
    ...
    {
    const char *sysdata = core::ptr::null_mut();
    const char *release;
...
#[no_mangle]
unsafe extern "C" fn append_release(buf: *mut c_char) {
    ...
    const struct netcons_userdata *userdata)
    {
    const char *userdata_ptr = core::ptr::null_mut();
    const char *sysdata_ptr = core::ptr::null_mut();
    int data_len, data_sent = 0;
    let mut userdata_offset: c_int = 0;
    let mut sysdata_offset: c_int = 0;
    let mut msgbody_offset: c_int = 0;
    let mut userdata_len: c_int = 0;
...
//
    ...
    let mut userdata_left: c_int = userdata_len - userdata_offset;
    let mut sysdata_left: c_int = sysdata_len - sysdata_offset;
    let mut msgbody_left: c_int = msgbody_len - msgbody_offset;
    let mut buf_offset: c_int = 0;
    let mut this_chunk: c_int = 0;
...
//
    ...
    struct nbcon_write_context *wctxt)
    {
    const struct netcons_userdata *userdata = core::ptr::null_mut();
    let mut userdata_len: c_int = 0;
    let mut release_len: c_int = 0;
    let mut sysdata_len: c_int = 0;
    int len;
...
//
#[no_mangle]
unsafe extern "C" fn netconsole_write(wctxt: *mut nbcon_write_context, extended: bool) {
...
#[no_mangle]
unsafe extern "C" fn netconsole_parser_cmdline(nt: *mut netconsole_target, opt: *mut c_char) -> c_int {
    static int netconsole_parser_cmdline(struct netconsole_target *nt, char *opt)
    {
    struct netpoll *np = &nt.np;
    let mut ipversion_set: bool = false;
    char *cur = opt;
    char *delim;
    int ipv6;
    if (*cur != '@') {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !mac_pton(cur, _arg: np->dev_mac)) -> else {
...
// delim = 0;
    ...
    goto parse_failed;
#[no_mangle]
pub unsafe extern "C" fn if((bool)ipv6: ipversion_set && nt->ipv6 !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn free_param_target(nt: *mut netconsole_target) {
...
#[no_mangle]
unsafe extern "C" fn init_netconsole() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cleanup_netconsole() -> void __exit {
