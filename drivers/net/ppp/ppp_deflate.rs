...
//! Source: drivers/net/ppp/ppp_deflate.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn z_comp_free(arg: *mut c_void) {
...
//
    ...
    if (state.strm.workspace == core::ptr::null_mut())
    goto out_free;
...
//
#[no_mangle]
unsafe extern "C" fn z_comp_reset(arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn z_comp_stats(arg: *mut c_void, stats: *mut compstat) {
...
//
#[no_mangle]
unsafe extern "C" fn z_decomp_free(arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn z_decomp_reset(arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn z_incomp(arg: *mut c_void, ibuf: *mut c_uchar, icnt: c_int) {
...
#[no_mangle]
unsafe extern "C" fn deflate_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn deflate_cleanup() -> void __exit {
