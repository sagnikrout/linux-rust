...
pub const MAX_CALLID: c_int = 65535;
...
#[no_mangle]
unsafe extern "C" fn lookup_chan_dst(call_id: u16, d_addr: __be32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn del_chan(sock: *mut pppox_sock) {
    static void del_chan(struct pppox_sock *sock)
    {
    spin_lock(&chan_lock);
    clear_bit(sock.proto.pptp.src_addr.call_id, callid_bitmap);
    RCU_INIT_POINTER(callid_sock[sock.proto.pptp.src_addr.call_id], core::ptr::null_mut());
    spin_unlock(&chan_lock);
    }
...
#[no_mangle]
unsafe extern "C" fn pptp_xmit(chan: *mut ppp_channel, skb: *mut sk_buff) -> c_int {
    ...
    let mut header_len: c_uint = sizeof(*hdr);
    struct flowi4 fl4;
    int islcp;
    int len;
    unsigned char *data;
...
#[no_mangle]
unsafe extern "C" fn pptp_rcv_core(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pptp_rcv(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pptp_release(sock: *mut socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pptp_sock_destruct(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn pptp_create(net: *mut net, sock: *mut socket, kern: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pptp_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pptp_exit_module() -> void __exit {
