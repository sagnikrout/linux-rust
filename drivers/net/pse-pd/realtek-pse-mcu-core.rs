...
//! Source: drivers/net/pse-pd/realtek-pse-mcu-core.c
#![no_std]
...
pub const RTPSE_MCU_DEVICE_ID_RTL8238B: c_uint = 0x0138;
pub const RTPSE_MCU_DEVICE_ID_RTL8239: c_uint = 0x0039;
pub const RTPSE_MCU_DEVICE_ID_RTL8239C: c_uint = 0x0139;
pub const RTPSE_MCU_DEVICE_ID_BCM59111: c_uint = 0xe111;
pub const RTPSE_MCU_DEVICE_ID_BCM59121: c_uint = 0xe121;
pub const RTPSE_MCU_PORT_STS_DISABLED: c_uint = 0x00;
pub const RTPSE_MCU_PORT_STS_SEARCHING: c_uint = 0x01;
pub const RTPSE_MCU_PORT_STS_DELIVERING: c_uint = 0x02;
pub const RTPSE_MCU_PORT_STS_TEST: c_uint = 0x03	/* Gen1-only; reserved on Gen2 */;
pub const RTPSE_MCU_PORT_STS_FAULT: c_uint = 0x04;
pub const RTPSE_MCU_PORT_STS_OTHER_FAULT: c_uint = 0x05	/* Gen1-only; reserved on Gen2 */;
pub const RTPSE_MCU_PORT_STS_REQUESTING: c_uint = 0x06;
// RTPSE_MCU_PORT_SET_POWER_LIMIT_TYPE values
pub const RTPSE_MCU_PORT_PW_LIMIT_TYPE_USER: c_uint = 0x02;
pub const RTPSE_MCU_MAX_PORTS: c_int = 48;
pub const RTPSE_MCU_PORT_MAX_PRIORITY: c_int = 3;
// Bounded resends when the MCU replies NOT_READY (busy).
pub const RTPSE_MCU_NOT_READY_RETRIES: c_int = 3;
// Nominal PSE rail; 802.3at/bt operating range.
pub const RTPSE_MCU_PSE_VOLTAGE_UV: c_int = 54000000;
    enum rtpse_mcu_cmd {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtpse_mcu_ext_config {
    pub num_of_pses: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtpse_mcu_port_status {
    pub sts1: u8,
    pub sts2: u8,
    pub sts3: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtpse_mcu_port_measurement {
    pub /: *mut *mut u16 voltage_raw; / 64.45mV/LSB,
    pub /: *mut *mut u16 current_raw; / 1mA/LSB,
    pub /: *mut *mut *mut u16 temperature_raw; / T(mC) = 1250  (220 - raw),
    pub /: *mut *mut u16 power_raw; / 100mW/LSB,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtpse_mcu_port_config {
    pub enable: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtpse_mcu_port_ext_config {
    pub max_power: u8,
    pub priority: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtpse_mcu_dialect {
    pub opcode: [rtpse_mcu_opcode; RTPSE_MCU_NUM_CMDS],
//
...
//
    pub info): *const *const *const void (parse_system_info)(u8 payload, struct rtpse_mcu_info,
    pub status): *const *const int (parse_port_class)(struct rtpse_mcu_port_status,
    pub mcu_type): *const *const *const char (mcu_type_str)(unsigned int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtpse_mcu_chip_info {
    pub name: *const c_char,
    pub max_mW_per_port: u32,
    pub /: *mut *mut enum rtpse_mcu_cmd pw_set_cmd; / command used by set_pw_limit,
    pub /: *mut *mut u32 pw_set_lsb_mW; / LSB of pw_set_cmd value, in mW,
    pub /: *mut *mut u32 pw_read_lsb_mW; / LSB of ext_config.max_power read-back, in mW,
}
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_msg_init(msg: *mut rtpse_mcu_msg, opcode: u8) {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_checksum(buf: *const u8, len: usize) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_port_cmd(pse: *mut rtpse_mcu_ctrl, port: c_uint, opcode: u8, arg: u8) -> c_int {
...
// Global operations
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_get_info(pse: *mut rtpse_mcu_ctrl, info: *mut rtpse_mcu_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_get_ext_config(pse: *mut rtpse_mcu_ctrl, config: *mut rtpse_mcu_ext_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_set_global_state(pse: *mut rtpse_mcu_ctrl, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_port_set_state(pse: *mut rtpse_mcu_ctrl, port: c_uint, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_port_get_pw_class(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_port_get_actual_pw(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_port_get_voltage(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_port_enable(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_port_disable(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_port_get_pw_limit(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_port_set_pw_limit(pcdev: *mut pse_controller_dev, id: c_int, max_mW: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_port_get_prio(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_port_set_prio(pcdev: *mut pse_controller_dev, id: c_int, prio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_discover(pse: *mut rtpse_mcu_ctrl, info: *mut rtpse_mcu_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_global_disable(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn rtpse_mcu_register(pse: *mut rtpse_mcu_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_gen2_parse_system_info(payload: *const u8, info: *mut rtpse_mcu_info) {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_gen2_parse_port_class(status: *const rtpse_mcu_port_status) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_gen1_parse_system_info(payload: *const u8, info: *mut rtpse_mcu_info) {
...
#[no_mangle]
unsafe extern "C" fn rtpse_mcu_gen1_parse_port_class(status: *const rtpse_mcu_port_status) -> c_int {
