...
//! Source: drivers/net/pse-pd/pd692x0.c
#![no_std]
...
pub const PD692X0_MAX_PIS: c_int = 48;
pub const PD692X0_MAX_MANAGERS: c_int = 12;
pub const PD692X0_MAX_MANAGER_PORTS: c_int = 8;

pub const PD69200_BT_PROD_VER: c_int = 24;
pub const PD69210_BT_PROD_VER: c_int = 26;
pub const PD69220_BT_PROD_VER: c_int = 29;
pub const PD692X0_FW_MAJ_VER: c_int = 3;
pub const PD692X0_FW_MIN_VER: c_int = 5;
pub const PD692X0_FW_PATCH_VER: c_int = 5;
pub const PD692X0_USER_BYTE: c_int = 42;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pd692x0_priv {
    pub client: *mut i2c_client,
    pub pcdev: pse_controller_dev,
    pub np: *mut device_node,
    pub fw_state: enum pd692x0_fw_state,
    pub fwl: *mut fw_upload,
    pub cancel_request: bool,
    pub msg_id: u8,
    pub last_cmd_key: bool,
    pub last_cmd_key_time: c_ulong,
    pub cfg_saved: bool,
    pub admin_state: [enum ethtool_c33_pse_admin_state; PD692X0_MAX_PIS],
    pub manager_reg: [*mut regulator_dev; PD692X0_MAX_MANAGERS],
    pub manager_pw_budget: [c_int; PD692X0_MAX_MANAGERS],
    pub nmanagers: c_int,
    pub port_matrix: *mut pd692x0_matrix,
}
...
#[no_mangle]
unsafe extern "C" fn pd692x0_build_msg(msg: *mut pd692x0_msg, echo: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn pd692x0_send_msg(priv: *mut pd692x0_priv, msg: *mut pd692x0_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pd692x0_reset(priv: *mut pd692x0_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pd692x0_fw_unavailable(priv: *mut pd692x0_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pd692x0_pi_enable(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pd692x0_pi_disable(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pd692x0_pse_ext_state_mapping {
    pub status_code: u32,
    pub pse_ext_state: enum ethtool_c33_pse_ext_state,
    pub pse_ext_substate: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pd692x0_class_pw {
    pub class: c_int,
    pub class_cfg_value: c_int,
    pub class_pw: c_int,
    pub max_added_class_pw: c_int,
}

pub const PD692X0_CLASS_PW_TABLE_SIZE: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn pd692x0_pi_get_pw_from_table(op_mode: c_int, added_pw: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x22: buf.sub[0] == 0x1b || buf.sub[0] ==) -> else {
    else if (buf.sub[0] == 0x1b || buf.sub[0] == 0x22)
    pw_status.c33_pw_status =
    ETHTOOL_C33_PSE_PW_D_STATUS_SEARCHING;
#[no_mangle]
pub unsafe extern "C" fn if(0x12: buf.sub[0] ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn pd692x0_get_sw_version(priv: *mut pd692x0_priv) -> pd692x0_msg_ver {
    static struct pd692x0_msg_ver pd692x0_get_sw_version(struct pd692x0_priv *priv)
    {
    struct device *dev = &priv.client.dev;
    struct pd692x0_msg msg, buf = {0};
    let mut ver: pd692x0_msg_ver = {0};
    int ret;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pd692x0_manager {
    pub port_node: [*mut device_node; PD692X0_MAX_MANAGER_PORTS],
    ...
    manager.port_node[i] = core::ptr::null_mut();
    }
    of_node_put(node);
    return ret;
    }
    ...
    manager[i].port_node[j] = core::ptr::null_mut();
    }
    of_node_put(manager[i].node);
    manager[i].node = core::ptr::null_mut();
    }
    of_node_put(node);
    of_node_put(managers_node);
    return ret;
    ...
    let mut rconfig: regulator_config = {0};
...
#[no_mangle]
pub unsafe extern "C" fn if(ALTERNATIVE_B: pairset->pinout ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn pd692x0_hw_conf_init(priv: *mut pd692x0_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pd692x0_managers_free_pw_budget(priv: *mut pd692x0_priv) {
...
#[no_mangle]
unsafe extern "C" fn pd692x0_setup_pi_matrix(pcdev: *mut pse_controller_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pd692x0_pi_get_voltage(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
pub const PD692X0_FW_LINE_MAX_SZ: c_uint = 0xff;
...
#[no_mangle]
unsafe extern "C" fn pd692x0_fw_reset(client: *const i2c_client) -> enum fw_upload_err {
    static enum fw_upload_err pd692x0_fw_reset(const struct i2c_client *client)
    {
    let mut zero: pd692x0_msg = {0};
    let mut buf: pd692x0_msg = {0};
    unsigned long timeout;
    char cmd[] = "RST";
    int ret;
...
#[no_mangle]
unsafe extern "C" fn pd692x0_fw_poll_complete(fwl: *mut fw_upload) -> enum fw_upload_err {
...
#[no_mangle]
unsafe extern "C" fn pd692x0_fw_cancel(fwl: *mut fw_upload) {
...
#[no_mangle]
unsafe extern "C" fn pd692x0_fw_cleanup(fwl: *mut fw_upload) {
...
#[no_mangle]
unsafe extern "C" fn pd692x0_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pd692x0_i2c_remove(client: *mut i2c_client) {
