...
//! Source: drivers/net/pse-pd/si3474.c
#![no_std]
...
pub const SI3474_MAX_CHANS: c_int = 8;
pub const MANUFACTURER_ID: c_uint = 0x08;
pub const IC_ID: c_uint = 0x05;

// Misc registers
pub const VENDOR_IC_ID_REG: c_uint = 0x1B;
pub const TEMPERATURE_REG: c_uint = 0x2C;
pub const FIRMWARE_REVISION_REG: c_uint = 0x41;
pub const CHIP_REVISION_REG: c_uint = 0x43;
// Main status registers
pub const POWER_STATUS_REG: c_uint = 0x10;
pub const PORT_MODE_REG: c_uint = 0x12;
pub const DETECT_CLASS_ENABLE_REG: c_uint = 0x14;
// PORTn Current
pub const PORT1_CURRENT_LSB_REG: c_uint = 0x30;
// PORTn Current [mA], return in [nA]
// 1000 * ((PORTn_CURRENT_MSB << 8) + PORTn_CURRENT_LSB) / 16384

// VPWR Voltage
pub const VPWR_LSB_REG: c_uint = 0x2E;
pub const VPWR_MSB_REG: c_uint = 0x2F;
// PORTn Voltage
pub const PORT1_VOLTAGE_LSB_REG: c_uint = 0x32;
...
#[no_mangle]
unsafe extern "C" fn si3474_get_of_channels(priv: *mut si3474_priv) -> c_int {
    ...
    let mut pairset_found: bool = false;
    u8 pairset_no;
...
#[no_mangle]
unsafe extern "C" fn si3474_setup_pi_matrix(pcdev: *mut pse_controller_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si3474_pi_enable(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si3474_pi_disable(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si3474_pi_get_chan_current(priv: *mut si3474_priv, chan: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si3474_pi_get_chan_voltage(priv: *mut si3474_priv, chan: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si3474_pi_get_voltage(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(CHAN_BIT(chan1): ret &) -> else {
...
#[no_mangle]
unsafe extern "C" fn si3474_pi_get_actual_pw(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si3474_ancillary_i2c_remove(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn si3474_i2c_probe(client: *mut i2c_client) -> c_int {
