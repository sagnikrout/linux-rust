...
//! Source: drivers/net/pse-pd/pse_core.c
#![no_std]
...
// If an error appears, release all the pairset device node kref
    ...
    pi.pairset[0].np = core::ptr::null_mut();
    of_node_put(pi.pairset[1].np);
    pi.pairset[1].np = core::ptr::null_mut();
    }
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn pse_release_pis(pcdev: *mut pse_controller_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn of_load_pse_pis(pcdev: *mut pse_controller_dev) -> c_int {
...
// no description of PSE PIs
    ...
    ret = of_count_phandle_with_args(node, "pairsets", core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn pse_pi_is_hw_enabled(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
    static int pse_pi_is_hw_enabled(struct pse_controller_dev *pcdev, int id)
    {
    let mut admin_state: pse_admin_state = {0};
    int ret;
...
//
    ...
    int i, ret = 0;
    for (i = 0; i < pcdev.nr_lines; i++) {
    let mut prio_max: c_int = pcdev.nr_lines;
    struct netlink_ext_ack extack;
...
#[no_mangle]
unsafe extern "C" fn pse_pi_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pse_pi_deallocate_pw_budget(pi: *mut pse_pi) {
...
//
#[no_mangle]
unsafe extern "C" fn _pse_pi_disable(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pse_disable_pi_pol(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
    static int pse_disable_pi_pol(struct pse_controller_dev *pcdev, int id)
    {
    let mut notifs: c_ulong = ETHTOOL_PSE_EVENT_OVER_BUDGET;
    let mut ntf: pse_ntf = {};
    int ret;
...
#[no_mangle]
unsafe extern "C" fn pse_pi_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pse_pi_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _pse_pi_get_voltage(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pse_pi_get_voltage(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pse_pi_get_current_limit(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __pse_pw_d_release(kref: *mut kref) {
...
//
#[no_mangle]
unsafe extern "C" fn pse_flush_pw_ds(pcdev: *mut pse_controller_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pse_register_pw_ds(pcdev: *mut pse_controller_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pse_send_ntf_worker(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pse_controller_register(pcdev: *mut pse_controller_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pse_controller_unregister(pcdev: *mut pse_controller_dev) {
...
#[no_mangle]
unsafe extern "C" fn devm_pse_controller_release(dev: *mut device, res: *mut c_void) {
...
pub struct pse_irq {
    pub pcdev: *mut pse_controller_dev,
    pub desc: pse_irq_desc,
    pub notifs: *mut c_ulong,
...
//
#[no_mangle]
unsafe extern "C" fn pse_to_regulator_notifs(notifs: c_ulong) -> c_ulong {
    static unsigned long pse_to_regulator_notifs(unsigned long notifs)
    {
    let mut rnotifs: c_ulong = 0;
...
//
#[no_mangle]
unsafe extern "C" fn pse_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// IRQ name len is pcdev dev name + 5 char + irq desc name + 1
    ...
    if (!h.notifs_mask)
    return -ENOMEM;
    ret = devm_request_threaded_irq(dev, irq, core::ptr::null_mut(), pse_isr,
...
// PSE control section
#[no_mangle]
unsafe extern "C" fn __pse_control_release(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn __pse_control_put_internal(psec: *mut pse_control) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pse_control_put(psec: *mut pse_control) {
...
//
    ...
    {
    let mut admin_state: pse_admin_state = {0};
    let mut pw_status: pse_pw_status = {0};
    const struct pse_controller_ops *ops;
    struct pse_controller_dev *pcdev;
    struct pse_pi *pi;
    int ret;
    ...
    let mut ext_state_info: pse_ext_state_info = {0};
    ...
    let mut pw_limit_ranges: pse_pw_limit_ranges = {0};
...
#[no_mangle]
pub unsafe extern "C" fn pse_has_podl(psec: *mut pse_control) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pse_has_c33(psec: *mut pse_control) -> bool {
