...
//! Source: drivers/net/pse-pd/tps23881.c
#![no_std]
...
pub const TPS23881_MAX_CHANS: c_int = 8;
pub const TPS23881_MAX_IRQ_RETRIES: c_int = 10;
pub const TPS23881_REG_IT: c_uint = 0x0;
pub const TPS23881_REG_IT_MASK: c_uint = 0x1;

pub const TPS23881_REG_DET_EVENT: c_uint = 0x5;
pub const TPS23881_REG_FAULT: c_uint = 0x7;
pub const TPS23881_REG_SUPF_EVENT: c_uint = 0xb;

pub const TPS23881_REG_DISC: c_uint = 0xc;
pub const TPS23881_REG_PW_STATUS: c_uint = 0x10;
pub const TPS23881_REG_OP_MODE: c_uint = 0x12;
pub const TPS23881_REG_DISC_EN: c_uint = 0x13;
pub const TPS23881_OP_MODE_SEMIAUTO: c_uint = 0xaaaa;
pub const TPS23881_REG_DIS_EN: c_uint = 0x13;
pub const TPS23881_REG_DET_CLA_EN: c_uint = 0x14;
pub const TPS23881_REG_GEN_MASK: c_uint = 0x17;

pub const TPS23881_REG_PW_EN: c_uint = 0x19;
pub const TPS23881_REG_RESET: c_uint = 0x1a;

pub const TPS23881_REG_2PAIR_POL1: c_uint = 0x1e;
pub const TPS23881_REG_PORT_MAP: c_uint = 0x26;
pub const TPS23881_REG_PORT_POWER: c_uint = 0x29;
pub const TPS23881_REG_4PAIR_POL1: c_uint = 0x2a;
pub const TPS23881_REG_INPUT_V: c_uint = 0x2e;
pub const TPS23881_REG_CHAN1_A: c_uint = 0x30;
pub const TPS23881_REG_CHAN1_V: c_uint = 0x32;
pub const TPS23881_REG_FOLDBACK: c_uint = 0x40;

pub const TPS23881_REG_FWREV: c_uint = 0x41;
pub const TPS23881_REG_DEVID: c_uint = 0x43;
pub const TPS23881_REG_CHAN1_CLASS: c_uint = 0x4c;
pub const TPS23881_REG_SRAM_CTRL: c_uint = 0x60;
pub const TPS23881_REG_SRAM_DATA: c_uint = 0x61;
pub const TPS23881_UV_STEP: c_int = 3662;
pub const TPS23881_NA_STEP: c_int = 89500;
pub const TPS23881_MW_STEP: c_int = 500;
pub const TPS23881_MIN_PI_PW_LIMIT_MW: c_int = 2000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps23881_port_desc {
    pub chan: [u8; 2],
    pub is_4p: bool,
    pub pw_pol: c_int,
    pub exist: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps23881_priv {
    pub client: *mut i2c_client,
    pub pcdev: pse_controller_dev,
    pub np: *mut device_node,
    pub port: [tps23881_port_desc; TPS23881_MAX_CHANS],
}
...
#[no_mangle]
unsafe extern "C" fn tps23881_pi_enable_manual_pol(priv: *mut tps23881_priv, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps23881_pi_enable(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps23881_pi_disable(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps23881_pi_get_voltage(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps23881_pi_get_pw_limit(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps23881_port_matrix {
    pub pi_id: u8,
    pub lgcl_chan: [u8; 2],
    pub hw_chan: [u8; 2],
    pub is_4p: bool,
...
#[no_mangle]
unsafe extern "C" fn tps23881_setup_pi_matrix(pcdev: *mut pse_controller_dev) -> c_int {
    static int tps23881_setup_pi_matrix(struct pse_controller_dev *pcdev)
    {
    struct device_node *chan_node[TPS23881_MAX_CHANS] = {core::ptr::null_mut()};
    struct tps23881_priv *priv = to_tps23881_priv(pcdev);
    int ret, i;
...
#[no_mangle]
unsafe extern "C" fn tps23881_pi_get_pw_req(pcdev: *mut pse_controller_dev, id: c_int) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps23881_info {
    pub /: *mut *mut u8 dev_id; / device ID and silicon revision,
    pub /: *const *const *const char fw_parity_name; / parity code firmware file name,
    pub /: *const *const *const char fw_sram_name; / SRAM code firmware file name,
}
...
//
#[no_mangle]
unsafe extern "C" fn tps23881_irq_export_chans_helper(reg_val: u16, field_offset: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn tps23881_setup_irq(priv: *mut tps23881_priv, irq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps23881_i2c_probe(client: *mut i2c_client) -> c_int {
