...
//! Source: drivers/net/can/spi/mcp251xfd/mcp251xfd-ring.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: priv->rx_obj_num_coalesce_irq) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_ring_init(priv: *mut mcp251xfd_priv) -> c_int {
    int mcp251xfd_ring_init(struct mcp251xfd_priv *priv)
    {
    const struct mcp251xfd_rx_ring *rx_ring;
    let mut base: u16 = 0, ram_used;
    let mut fifo_nr: u8 = 1;
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_ring_free(priv: *mut mcp251xfd_priv) {
    void mcp251xfd_ring_free(struct mcp251xfd_priv *priv)
    {
    int i;
    for (i = ARRAY_SIZE(priv.rx) - 1; i >= 0; i--) {
    kfree(priv.rx[i]);
    priv.rx[i] = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn mcp251xfd_rx_irq_timer(t: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_tx_irq_timer(t: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_ring_alloc(priv: *mut mcp251xfd_priv) -> c_int {
