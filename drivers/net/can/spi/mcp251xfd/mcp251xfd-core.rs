...
//! Source: drivers/net/can/spi/mcp251xfd/mcp251xfd-core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_vdd_enable(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_vdd_disable(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_clks_and_vdd_enable(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_clks_and_vdd_disable(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_reg_invalid(reg: u32) -> bool {
    static inline bool mcp251xfd_reg_invalid(u32 reg)
    {
    let mut reg: return = = 0x0 || reg == 0xffffffff;
    }
    static inline int
...
// mode = FIELD_GET(MCP251XFD_REG_CON_OPMOD_MASK, val);
    ...
    let mut timeout_us: c_ulong = MCP251XFD_POLL_TIMEOUT_US;
    let mut con: u32 = 0, con_reqop, osc = 0;
    u8 mode;
    int err;
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_chip_wake(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_chip_sleep(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_chip_softreset_do(priv: *const mcp251xfd_priv) -> c_int {
    static int mcp251xfd_chip_softreset_do(const struct mcp251xfd_priv *priv)
    {
    let mut cmd: __be16 = mcp251xfd_cmd_reset();
    int err;
...
// spi_write_then_read() works with non DMA-safe buffers
    return spi_write_then_read(priv.spi, &cmd, sizeof(cmd), core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn mcp251xfd_chip_softreset_check(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_chip_softreset(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_chip_clock_init(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_chip_timestamp_init(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_set_bittiming(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(CAN_CTRLMODE_TDC_MANUAL: priv->can.ctrlmode &) -> else {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_chip_rx_int_enable(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_chip_rx_int_disable(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_chip_ecc_init(priv: *mut mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_get_normal_mode(priv: *const mcp251xfd_priv) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn if(CAN_CTRLMODE_FD: priv->can.ctrlmode &) -> else {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_chip_interrupts_enable(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_chip_interrupts_disable(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_chip_xstbyen_enable(priv: *const mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_chip_start(priv: *mut mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_set_mode(ndev: *mut net_device, mode: enum can_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_handle_rxovif(priv: *mut mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_handle_txatif(priv: *mut mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_handle_ivmif(priv: *mut mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_handle_cerrif(priv: *mut mcp251xfd_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MCP251XFD_REG_TREC_TXBP: trec &) -> else {
    else if (trec & MCP251XFD_REG_TREC_TXBP)
    tx_state = CAN_STATE_ERROR_PASSIVE;
#[no_mangle]
pub unsafe extern "C" fn if(MCP251XFD_REG_TREC_TXWARN: trec &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(MCP251XFD_REG_TREC_RXWARN: trec &) -> else {
...
//
    ...
    {
    let mut mode_reference: u8 = mcp251xfd_get_normal_mode(priv);
    u8 mode;
    int err;
    err = mcp251xfd_chip_get_mode(priv, &mode);
    if (err)
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_handle_serrif(priv: *mut mcp251xfd_priv) -> c_int {
...
// Check if ECC error occurred in TX-RAM
    ...
    in_tx_ram = true;
#[no_mangle]
pub unsafe extern "C" fn if(-ENOENT: err ==) -> else {
    else if (err == -ENOENT)
    in_tx_ram = false;
    else
    return err;
...
#[no_mangle]
pub unsafe extern "C" fn if(MCP251XFD_REG_ECCSTAT_DEDIF: ecc_stat &) -> else {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_handle_spicrcif(priv: *mut mcp251xfd_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MCP251XFD_REG_CRC_CRCERRIF: crc &) -> else {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_read_regs_status(priv: *mut mcp251xfd_priv) -> c_int {
    static int mcp251xfd_read_regs_status(struct mcp251xfd_priv *priv)
    {
    let mut val_bytes: c_int = regmap_get_val_bytes(priv.map_reg);
    size_t len;
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
    ...
    let mut set_normal_mode: bool = false;
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_open(ndev: *mut net_device) -> c_int {
    ...
    err = request_threaded_irq(spi.irq, core::ptr::null_mut(), mcp251xfd_irq,
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_stop(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_register_chip_detect(priv: *mut mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_register_check_rx_int(priv: *mut mcp251xfd_priv) -> c_int {
...
//
    ...
    priv.rx_int = core::ptr::null_mut();
    return 0;
    }
    static const char * const mcp251xfd_gpio_names[] = { "GPIO0", "GPIO1" };
#[no_mangle]
unsafe extern "C" fn mcp251xfd_gpio_request(chip: *mut gpio_chip, offset: c_uint) -> c_int {
    ...
    let mut pin_mask: u32 = MCP251XFD_REG_IOCON_PM(offset);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_gpio_free(chip: *mut gpio_chip, offset: c_uint) {
    ...
    {
    struct mcp251xfd_priv *priv = gpiochip_get_data(chip);
    let mut mask: u32 = MCP251XFD_REG_IOCON_TRIS(offset);
    u32 val;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
    static int mcp251xfd_gpio_get(struct gpio_chip *chip, unsigned int offset)
    {
    struct mcp251xfd_priv *priv = gpiochip_get_data(chip);
    let mut mask: u32 = MCP251XFD_REG_IOCON_GPIO(offset);
    u32 val;
    int ret;
    ret = regmap_read(priv.map_reg, MCP251XFD_REG_IOCON, &val);
    if (ret)
...
// bit = FIELD_GET(MCP251XFD_REG_IOCON_GPIO_MASK, val) & *mask;
    ...
    {
    struct mcp251xfd_priv *priv = gpiochip_get_data(chip);
    let mut dir_mask: u32 = MCP251XFD_REG_IOCON_TRIS(offset);
    let mut val_mask: u32 = MCP251XFD_REG_IOCON_LAT(offset);
    u32 val;
    if (value)
    val = val_mask;
    else
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_gpio_set(chip: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251fdx_gpio_setup(priv: *mut mcp251xfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_register(priv: *mut mcp251xfd_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_unregister(priv: *mut mcp251xfd_priv) {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_probe(spi: *mut spi_device) -> c_int {
    ...
    reg_vdd = core::ptr::null_mut();
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_ERR(reg_vdd)) -> else {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_runtime_suspend(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_runtime_resume(device: *mut device) -> int __maybe_unused {
    ...
    mcp251xfd_runtime_resume, core::ptr::null_mut())
    };
