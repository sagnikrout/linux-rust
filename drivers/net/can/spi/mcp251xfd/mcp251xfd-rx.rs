...
//! Source: drivers/net/can/spi/mcp251xfd/mcp251xfd-rx.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_rx_fifo_sta_empty(fifo_sta: u32) -> bool {
    static inline bool mcp251xfd_rx_fifo_sta_empty(const u32 fifo_sta)
    {
    return !(fifo_sta & MCP251XFD_REG_FIFOSTA_TFNRFNIF);
    }
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_rx_fifo_sta_full(fifo_sta: u32) -> bool {
...
// rx_tail = fifo_ua / ring->obj_size;
    ...
    u8 *len_p)
    {
    let mut shift: u8 = ring.obj_num_shift_to_u8;
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_handle_rxif(priv: *mut mcp251xfd_priv) -> c_int {
