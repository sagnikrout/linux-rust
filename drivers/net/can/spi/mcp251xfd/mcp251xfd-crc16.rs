...
//! Source: drivers/net/can/spi/mcp251xfd/mcp251xfd-crc16.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_crc16_byte(crc: u16, data: u8) -> u16 {
    static inline u16 mcp251xfd_crc16_byte(u16 crc, const u8 data)
    {
    let mut index: u8 = (crc >> 8) ^ data;
    return (crc << 8) ^ mcp251xfd_crc16_table[index];
    }
#[no_mangle]
unsafe extern "C" fn mcp251xfd_crc16(crc: u16, buffer: *const u8, len: usize) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_crc16_compute(data: *const c_void, data_size: usize) -> u16 {
