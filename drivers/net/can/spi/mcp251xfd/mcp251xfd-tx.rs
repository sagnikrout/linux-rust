...
//! Source: drivers/net/can/spi/mcp251xfd/mcp251xfd-tx.c
#![no_std]
...
//
    ...
    u8 dlc;
    u32 id, flags;
    let mut len_sanitized: c_int = 0, len;
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_tx_obj_write_sync(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_work_busy(work: *mut work_struct) -> bool {
