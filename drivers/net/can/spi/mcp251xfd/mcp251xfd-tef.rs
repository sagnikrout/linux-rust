...
//! Source: drivers/net/can/spi/mcp251xfd/mcp251xfd-tef.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_tx_fifo_sta_empty(fifo_sta: u32) -> bool {
    static inline bool mcp251xfd_tx_fifo_sta_empty(u32 fifo_sta)
    {
    return fifo_sta & MCP251XFD_REG_FIFOSTA_TFERFFIF;
    }
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_tx_fifo_sta_less_than_half_full(fifo_sta: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mcp251xfd_check_tef_tail(priv: *const mcp251xfd_priv) -> c_int {
...
//
    ...
    let mut shift: u8 = tx_ring.obj_num_shift_to_u8;
...
// len_p = len;
    ...
    {
    const struct mcp251xfd_tx_ring *tx_ring = priv.tx;
    let mut val_bytes: c_int = regmap_get_val_bytes(priv.map_rx);
    if (IS_ENABLED(CONFIG_CAN_MCP251XFD_SANITY) &&
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_ecc_tefif_successful(priv: *mut mcp251xfd_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn mcp251xfd_handle_tefif(priv: *mut mcp251xfd_priv) -> c_int {
    int mcp251xfd_handle_tefif(struct mcp251xfd_priv *priv)
    {
    struct mcp251xfd_hw_tef_obj hw_tef_obj[MCP251XFD_TX_OBJ_NUM_MAX];
    let mut total_frame_len: c_uint = 0;
    u8 tef_tail, len, l;
    int err, i;
