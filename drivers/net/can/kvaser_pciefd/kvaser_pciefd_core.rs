...
//! Source: drivers/net/can/kvaser_pciefd/kvaser_pciefd_core.c
#![no_std]
...
pub const KVASER_PCIEFD_VENDOR: c_uint = 0x1a07;
// Altera based devices
pub const KVASER_PCIEFD_4HS_DEVICE_ID: c_uint = 0x000d;
pub const KVASER_PCIEFD_2HS_V2_DEVICE_ID: c_uint = 0x000e;
pub const KVASER_PCIEFD_HS_V2_DEVICE_ID: c_uint = 0x000f;
pub const KVASER_PCIEFD_MINIPCIE_HS_V2_DEVICE_ID: c_uint = 0x0010;
pub const KVASER_PCIEFD_MINIPCIE_2HS_V2_DEVICE_ID: c_uint = 0x0011;
// SmartFusion2 based devices
pub const KVASER_PCIEFD_2CAN_V3_DEVICE_ID: c_uint = 0x0012;
pub const KVASER_PCIEFD_1CAN_V3_DEVICE_ID: c_uint = 0x0013;
pub const KVASER_PCIEFD_4CAN_V2_DEVICE_ID: c_uint = 0x0014;
pub const KVASER_PCIEFD_MINIPCIE_2CAN_V3_DEVICE_ID: c_uint = 0x0015;
pub const KVASER_PCIEFD_MINIPCIE_1CAN_V3_DEVICE_ID: c_uint = 0x0016;
// Xilinx based devices
pub const KVASER_PCIEFD_M2_4CAN_DEVICE_ID: c_uint = 0x0017;
pub const KVASER_PCIEFD_8CAN_DEVICE_ID: c_uint = 0x0019;
...
pub const KVASER_PCIEFD_KCAN_FIFO_REG: c_uint = 0x100;
pub const KVASER_PCIEFD_KCAN_FIFO_LAST_REG: c_uint = 0x180;
pub const KVASER_PCIEFD_KCAN_CTRL_REG: c_uint = 0x2c0;
pub const KVASER_PCIEFD_KCAN_CMD_REG: c_uint = 0x400;
pub const KVASER_PCIEFD_KCAN_IOC_REG: c_uint = 0x404;
pub const KVASER_PCIEFD_KCAN_IEN_REG: c_uint = 0x408;
pub const KVASER_PCIEFD_KCAN_IRQ_REG: c_uint = 0x410;
pub const KVASER_PCIEFD_KCAN_TX_NR_PACKETS_REG: c_uint = 0x414;
pub const KVASER_PCIEFD_KCAN_STAT_REG: c_uint = 0x418;
pub const KVASER_PCIEFD_KCAN_MODE_REG: c_uint = 0x41c;
pub const KVASER_PCIEFD_KCAN_BTRN_REG: c_uint = 0x420;
pub const KVASER_PCIEFD_KCAN_BUS_LOAD_REG: c_uint = 0x424;
pub const KVASER_PCIEFD_KCAN_BTRD_REG: c_uint = 0x428;
pub const KVASER_PCIEFD_KCAN_PWM_REG: c_uint = 0x430;
// System identification and information registers
pub const KVASER_PCIEFD_SYSID_VERSION_REG: c_uint = 0x8;
pub const KVASER_PCIEFD_SYSID_CANFREQ_REG: c_uint = 0xc;
pub const KVASER_PCIEFD_SYSID_BUSFREQ_REG: c_uint = 0x10;
pub const KVASER_PCIEFD_SYSID_BUILD_REG: c_uint = 0x14;
// Shared receive buffer FIFO registers
pub const KVASER_PCIEFD_SRB_FIFO_LAST_REG: c_uint = 0x1f4;
// Shared receive buffer registers
pub const KVASER_PCIEFD_SRB_CMD_REG: c_uint = 0x0;
pub const KVASER_PCIEFD_SRB_IEN_REG: c_uint = 0x04;
pub const KVASER_PCIEFD_SRB_IRQ_REG: c_uint = 0x0c;
pub const KVASER_PCIEFD_SRB_STAT_REG: c_uint = 0x10;
pub const KVASER_PCIEFD_SRB_RX_NR_PACKETS_REG: c_uint = 0x14;
pub const KVASER_PCIEFD_SRB_CTRL_REG: c_uint = 0x18;
...
pub const KVASER_PCIEFD_KCAN_CTRL_TYPE_EFLUSH: c_uint = 0x4;
pub const KVASER_PCIEFD_KCAN_CTRL_TYPE_EFRAME: c_uint = 0x5;
...
pub const KVASER_PCIEFD_PACK_TYPE_DATA: c_uint = 0x0;
pub const KVASER_PCIEFD_PACK_TYPE_ACK: c_uint = 0x1;
pub const KVASER_PCIEFD_PACK_TYPE_TXRQ: c_uint = 0x2;
pub const KVASER_PCIEFD_PACK_TYPE_ERROR: c_uint = 0x3;
pub const KVASER_PCIEFD_PACK_TYPE_EFLUSH_ACK: c_uint = 0x4;
pub const KVASER_PCIEFD_PACK_TYPE_EFRAME_ACK: c_uint = 0x5;
pub const KVASER_PCIEFD_PACK_TYPE_ACK_DATA: c_uint = 0x6;
pub const KVASER_PCIEFD_PACK_TYPE_STATUS: c_uint = 0x8;
pub const KVASER_PCIEFD_PACK_TYPE_BUS_LOAD: c_uint = 0x9;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvaser_pciefd_rx_packet {
    pub header: [u32; 2],
    pub timestamp: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvaser_pciefd_tx_packet {
    pub header: [u32; 2],
    pub data: [u8; 64],
}
...
#[no_mangle]
pub unsafe extern "C" fn kvaser_pciefd_send_kcan_cmd(can: *mut kvaser_pciefd_can, cmd: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn kvaser_pciefd_request_status(can: *mut kvaser_pciefd_can) {
...
#[no_mangle]
pub unsafe extern "C" fn kvaser_pciefd_abort_flush_reset(can: *mut kvaser_pciefd_can) {
...
#[no_mangle]
pub unsafe extern "C" fn kvaser_pciefd_set_led(can: *mut kvaser_pciefd_can, on: bool) {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_enable_err_gen(can: *mut kvaser_pciefd_can) {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_disable_err_gen(can: *mut kvaser_pciefd_can) {
...
#[no_mangle]
pub unsafe extern "C" fn kvaser_pciefd_set_tx_irq(can: *mut kvaser_pciefd_can) {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_setup_controller(can: *mut kvaser_pciefd_can) {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_start_controller_flush(can: *mut kvaser_pciefd_can) {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_bus_on(can: *mut kvaser_pciefd_can) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_pwm_stop(can: *mut kvaser_pciefd_can) {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_pwm_start(can: *mut kvaser_pciefd_can) {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_stop(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_tx_avail(can: *const kvaser_pciefd_can) -> c_uint {
    ...
    let mut seq: c_uint = can.tx_idx & (can.can.echo_skb_max - 1);
...
// Prepare and save echo skb in internal slot
    WRITE_ONCE(can.can.echo_skb[seq], core::ptr::null_mut());
...
// Write header to fifo
    ...
    can.reg_base + KVASER_PCIEFD_KCAN_FIFO_REG);
    if (nr_words) {
    let mut data_last: u32 = ((u32 *)packet.data)[nr_words - 1];
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_set_bittiming(can: *mut kvaser_pciefd_can, data: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_set_nominal_bittiming(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_set_data_bittiming(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_set_mode(ndev: *mut net_device, mode: enum can_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_bec_poll_timer(data: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_setup_can_ctrls(pcie: *mut kvaser_pciefd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_reg_candev(pcie: *mut kvaser_pciefd) -> c_int {
    static int kvaser_pciefd_reg_candev(struct kvaser_pciefd *pcie)
    {
    int i;
    for (i = 0; i < pcie.nr_channels; i++) {
    let mut ret: c_int = register_candev(pcie.can[i].can.dev);
    if (ret) {
    int j;
// Unregister all successfully registered devices.
    ...
    {
    void __iomem *serdes_base;
    let mut lsb: u32 = addr & KVASER_PCIEFD_SF2_DMA_LSB_MASK;
    let mut msb: u32 = 0x0;
    if (IS_ENABLED(CONFIG_ARCH_DMA_ADDR_T_64BIT))
    ...
    {
    void __iomem *serdes_base;
    let mut lsb: u32 = addr & KVASER_PCIEFD_XILINX_DMA_LSB_MASK;
    let mut msb: u32 = 0x0;
    if (IS_ENABLED(CONFIG_ARCH_DMA_ADDR_T_64BIT))
    msb = upper_32_bits(addr);
    serdes_base = KVASER_PCIEFD_SERDES_ADDR(pcie) + 0x8 * index;
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_setup_dma(pcie: *mut kvaser_pciefd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_setup_board(pcie: *mut kvaser_pciefd) -> c_int {
...
// Turn off all loopback functionality
    ...
    let mut ch_id: u8 = FIELD_GET(KVASER_PCIEFD_PACKET_CHID_MASK, p.header[1]);
    u8 dlc;
...
#[no_mangle]
pub unsafe extern "C" fn if(255: bec->txerr >= 255 || bec->rxerr >=) -> else {
    else if (bec.txerr >= 255 || bec.rxerr >= 255)
// new_state = CAN_STATE_BUS_OFF;
#[no_mangle]
pub unsafe extern "C" fn if(KVASER_PCIEFD_SPACK_EPLR: p->header[1] &) -> else {
    else if (p.header[1] & KVASER_PCIEFD_SPACK_EPLR)
// new_state = CAN_STATE_ERROR_PASSIVE;
#[no_mangle]
pub unsafe extern "C" fn if(128: bec->txerr >= 128 || bec->rxerr >=) -> else {
    else if (bec.txerr >= 128 || bec.rxerr >= 128)
// new_state = CAN_STATE_ERROR_PASSIVE;
#[no_mangle]
pub unsafe extern "C" fn if(KVASER_PCIEFD_SPACK_EWLR: p->header[1] &) -> else {
    else if (p.header[1] & KVASER_PCIEFD_SPACK_EWLR)
// new_state = CAN_STATE_ERROR_WARNING;
#[no_mangle]
pub unsafe extern "C" fn if(96: bec->txerr >= 96 || bec->rxerr >=) -> else {
...
// Ignore control packet ACK
    ...
    let mut echo_idx: c_int = FIELD_GET(KVASER_PCIEFD_PACKET_SEQ_MASK, p.header[0]);
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_read_buffer(pcie: *mut kvaser_pciefd, dma_buf: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_receive_irq(pcie: *mut kvaser_pciefd) {
    static void kvaser_pciefd_receive_irq(struct kvaser_pciefd *pcie)
    {
    void __iomem *srb_cmd_reg = KVASER_PCIEFD_SRB_ADDR(pcie) + KVASER_PCIEFD_SRB_CMD_REG;
    let mut irq: u32 = ioread32(KVASER_PCIEFD_SRB_ADDR(pcie) + KVASER_PCIEFD_SRB_IRQ_REG);
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_transmit_irq(can: *mut kvaser_pciefd_can) {
    static void kvaser_pciefd_transmit_irq(struct kvaser_pciefd_can *can)
    {
    let mut irq: u32 = ioread32(can.reg_base + KVASER_PCIEFD_KCAN_IRQ_REG);
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_irq_handler(irq: c_int, dev: *mut c_void) -> irqreturn_t {
    static irqreturn_t kvaser_pciefd_irq_handler(int irq, void *dev)
    {
    struct kvaser_pciefd *pcie = (struct kvaser_pciefd *)dev;
    const struct kvaser_pciefd_irq_mask *irq_mask = pcie.driver_data.irq_mask;
    let mut pci_irq: u32 = ioread32(KVASER_PCIEFD_PCI_IRQ_ADDR(pcie));
    int i;
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_teardown_can_ctrls(pcie: *mut kvaser_pciefd) {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_disable_irq_srcs(pcie: *mut kvaser_pciefd) {
...
#[no_mangle]
unsafe extern "C" fn kvaser_pciefd_remove(pdev: *mut pci_dev) {
