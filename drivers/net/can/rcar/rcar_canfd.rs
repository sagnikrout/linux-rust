...
//! Source: drivers/net/can/rcar/rcar_canfd.c
#![no_std]
...
//
pub const RCANFD_RFFIFO_IDX: c_int = 0;
...
//
pub const RCANFD_CFFIFO_IDX: c_int = 0;
    struct rcar_canfd_global;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_canfd_regs {
    pub /: *mut *mut u16 rfcc; / RX FIFO Configuration/Control Register,
    pub /: *mut *mut u16 cfcc; / Common FIFO Configuration/Control Register,
    pub /: *mut *mut u16 cfsts; / Common FIFO Status Register,
    pub /: *mut *mut u16 cfpctr; / Common FIFO Pointer Control Register,
    pub /: *mut *mut u16 coffset; / Channel Data Bitrate Configuration Register,
    pub /: *mut *mut u16 rfoffset; / Receive FIFO buffer access ID register,
    pub /: *mut *mut u16 cfoffset; / Transmit/receive FIFO buffer access ID register,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_canfd_shift_data {
    pub /: *mut *mut u8 ntseg2; / Nominal Bit Rate Time Segment 2 Control,
    pub /: *mut *mut u8 ntseg1; / Nominal Bit Rate Time Segment 1 Control,
    pub /: *mut *mut u8 nsjw; / Nominal Bit Rate Resynchronization Jump Width Control,
    pub /: *mut *mut u8 dtseg2; / Data Bit Rate Time Segment 2 Control,
    pub /: *mut *mut u8 dtseg1; / Data Bit Rate Time Segment 1 Control,
    pub /: *mut *mut u8 cftml; / Common FIFO TX Message Buffer Link,
    pub /: *mut *mut u8 cfm; / Common FIFO Mode,
    pub /: *mut *mut u8 cfdc; / Common FIFO Depth Configuration,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_canfd_hw_info {
    pub nom_bittiming: *const can_bittiming_,
    pub data_bittiming: *const can_bittiming_,
    pub tdc_const: *const can_tdc_,
    pub regs: *const rcar_canfd_regs,
    pub sh: *const rcar_canfd_shift_data,
    pub rnc_field_width: u8,
    pub max_aflpn: u8,
    pub max_cftml: u8,
    pub max_channels: u8,
    pub postdiv: u8,
// hardware features
    pub /: *mut *mut unsigned shared_global_irqs:1; / Has shared global irqs,
    pub /: *mut *mut unsigned multi_channel_irqs:1; / Has multiple channel irqs,
    pub /: *mut *mut unsigned ch_interface_mode:1; / Has channel interface mode,
    pub /: *mut *mut unsigned shared_can_regs:1; / Has shared classical can registers,
    pub /: *mut *mut unsigned external_clk:1; / Has external clock,
}

// Channel priv data
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_canfd_channel {
    pub /: *mut *mut can_priv can; / Must be the first member,
    pub ndev: *mut net_device,
    pub /: *mut *mut *mut rcar_canfd_global gpriv; / Controller reference,
    pub /: *mut *mut *mut void __iomem base; / Register base address,
    pub /: *mut *mut *mut phy transceiver; / Optional transceiver,
    pub napi: napi_struct,
    pub /: *mut *mut u32 tx_head; / Incremented on xmit,
    pub /: *mut *mut u32 tx_tail; / Incremented on xmit done,
    pub /: *mut *mut u32 channel; / Channel number,
    pub /: *mut *mut spinlock_t tx_lock; / To protect tx path,
}

// Global priv data
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_canfd_global {
    pub ch: [*mut rcar_canfd_channel; RCANFD_NUM_CHANNELS],
    pub /: *mut *mut *mut void __iomem base; / Register base address,
    pub fcbase: *mut rcar_canfd_f_c __iomem,
    pub /: *mut *mut *mut platform_device pdev; / Respective platform device,
    pub /: *mut *mut *mut clk clkp; / Peripheral clock,
    pub /: *mut *mut *mut clk can_clk; / fCAN clock,
    pub /: *mut *mut *mut clk clk_ram; / Clock RAM,
    pub /: *mut *mut unsigned long channels_mask; / Enabled channels mask,
    pub /: *mut *mut bool extclk; / CANFD or Ext clock,
    pub /: *mut *mut bool fdmode; / CAN FD or Classical CAN only mode,
    pub /: *mut *mut bool fd_only_mode; / FD-Only mode for CAN-FD,
    pub rstc1: *mut reset_control,
    pub rstc2: *mut reset_control,
    pub info: *const rcar_canfd_hw_info,
}
...
// Helper functions
#[no_mangle]
pub unsafe extern "C" fn rcar_canfd_update(mask: u32, val: u32, reg: *mut u32 __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn rcar_canfd_read(base: *mut void __iomem, offset: u32) -> u32 {
    static inline u32 rcar_canfd_read(void __iomem *base, u32 offset)
    {
    return readl(base + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn rcar_canfd_write(base: *mut void __iomem, offset: u32, val: u32) {
    static inline void rcar_canfd_write(void __iomem *base, u32 offset, u32 val)
    {
    writel(val, base + offset);
    }
#[no_mangle]
unsafe extern "C" fn rcar_canfd_set_bit(base: *mut void __iomem, reg: u32, val: u32) {
    static void rcar_canfd_set_bit(void __iomem *base, u32 reg, u32 val)
    {
    rcar_canfd_update(val, val, base + reg);
    }
#[no_mangle]
unsafe extern "C" fn rcar_canfd_clear_bit(base: *mut void __iomem, reg: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_set_bit_reg(addr: *mut void __iomem, val: u32) {
    static void rcar_canfd_set_bit_reg(void __iomem *addr, u32 val)
    {
    rcar_canfd_update(val, val, addr);
    }
#[no_mangle]
unsafe extern "C" fn rcar_canfd_clear_bit_reg(addr: *mut void __iomem, val: u32) {
    static void rcar_canfd_clear_bit_reg(void __iomem *addr, u32 val)
    {
    rcar_canfd_update(val, 0, addr);
    }
#[no_mangle]
unsafe extern "C" fn rcar_canfd_update_bit_reg(addr: *mut void __iomem, mask: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_tx_failure_cleanup(ndev: *mut net_device) {
    static void rcar_canfd_tx_failure_cleanup(struct net_device *ndev)
    {
    u32 i;
    for (i = 0; i < RCANFD_FIFO_DEPTH; i++)
    can_free_echo_skb(ndev, i, core::ptr::null_mut());
    }
    static void rcar_canfd_set_rnc(struct rcar_canfd_global *gpriv, unsigned int ch,
    unsigned int num_rules)
    {
    let mut rnc_stride: c_uint = 32 / gpriv.info.rnc_field_width;
    let mut shift: c_uint = 32 - (ch % rnc_stride + 1) * gpriv.info.rnc_field_width;
    let mut w: c_uint = ch / rnc_stride;
    let mut rnc: u32 = num_rules << shift;
    rcar_canfd_set_bit(gpriv.base, RCANFD_GAFLCFG(w), rnc);
    }
#[no_mangle]
unsafe extern "C" fn rcar_canfd_reset_controller(gpriv: *mut rcar_canfd_global) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_configure_controller(gpriv: *mut rcar_canfd_global) {
...
// Channel configuration settings
    ...
    let mut rule_entry_index: u32 = rule_entry % 16;
    let mut ridx: u32 = ch + RCANFD_RFFIFO_IDX;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: gpriv->fdmode) -> else {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_configure_rx(gpriv: *mut rcar_canfd_global, ch: u32) {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_configure_tx(gpriv: *mut rcar_canfd_global, ch: u32) {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_enable_global_interrupts(gpriv: *mut rcar_canfd_global) {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_global_error(ndev: *mut net_device) {
    static void rcar_canfd_global_error(struct net_device *ndev)
    {
    struct rcar_canfd_channel *priv = netdev_priv(ndev);
    struct rcar_canfd_global *gpriv = priv.gpriv;
    struct net_device_stats *stats = &ndev.stats;
    let mut ch: u32 = priv.channel;
    u32 gerfl, sts;
    let mut ridx: u32 = ch + RCANFD_RFFIFO_IDX;
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_tx_done(ndev: *mut net_device) {
    ...
    stats.tx_packets++;
    stats.tx_bytes += can_get_echo_skb(ndev, sent, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_handle_global_err(gpriv: *mut rcar_canfd_global, ch: u32) {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_global_err_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_handle_global_receive(gpriv: *mut rcar_canfd_global, ch: u32) {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_global_receive_fifo_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_global_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(128: txerr < 128 && rxerr <) -> else {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_handle_channel_tx(gpriv: *mut rcar_canfd_global, ch: u32) {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_channel_tx_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_handle_channel_err(gpriv: *mut rcar_canfd_global, ch: u32) {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_channel_err_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_channel_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_set_bittiming(ndev: *mut net_device) {
    static void rcar_canfd_set_bittiming(struct net_device *ndev)
    {
    let mut mask: u32 = RCANFD_FDCFG_TDCO | RCANFD_FDCFG_TDCE | RCANFD_FDCFG_TDCOC;
    struct rcar_canfd_channel *priv = netdev_priv(ndev);
    struct rcar_canfd_global *gpriv = priv.gpriv;
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_start(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_stop(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_close(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_rx_pkt(priv: *mut rcar_canfd_channel) {
    ...
    cf.can_id |= CAN_RTR_FLAG;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: gpriv->info->shared_can_regs) -> else {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_rx_poll(napi: *mut napi_struct, quota: c_int) -> c_int {
...
// Enable Rx FIFO interrupts
    ...
    unsigned int ch)
    {
    let mut sts: u32 = readl(&gpriv.fcbase[ch].cfdsts);
    let mut tdcr: u32 = FIELD_GET(RCANFD_FDSTS_TDCR, sts);
    return tdcr & (gpriv.info.tdc_const.tdcv_max - 1);
    }
#[no_mangle]
unsafe extern "C" fn rcar_canfd_get_auto_tdcv(ndev: *const net_device, tdcv: *mut u32) -> c_int {
    static int rcar_canfd_get_auto_tdcv(const struct net_device *ndev, u32 *tdcv)
    {
    struct rcar_canfd_channel *priv = netdev_priv(ndev);
    let mut tdco: u32 = priv.can.fd.tdc.tdco;
    u32 tdcr;
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_do_set_mode(ndev: *mut net_device, mode: enum can_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_channel_remove(gpriv: *mut rcar_canfd_global, ch: u32) {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_global_init(gpriv: *mut rcar_canfd_global) -> c_int {
    static int rcar_canfd_global_init(struct rcar_canfd_global *gpriv)
    {
    struct device *dev = &gpriv.pdev.dev;
    let mut rule_entry: u32 = 0;
    u32 ch, sts;
    int err;
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_global_deinit(gpriv: *mut rcar_canfd_global, full: bool) {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_probe(pdev: *mut platform_device) -> c_int {
    static int rcar_canfd_probe(struct platform_device *pdev)
    {
    struct phy *transceivers[RCANFD_NUM_CHANNELS] = { core::ptr::null_mut(), };
    const struct rcar_canfd_hw_info *info;
    struct device *dev = &pdev.dev;
    void __iomem *addr;
    struct rcar_canfd_global *gpriv;
    struct device_node *of_child;
    let mut channels_mask: c_ulong = 0;
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_canfd_resume(dev: *mut device) -> c_int {
