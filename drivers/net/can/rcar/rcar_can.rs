...
//! Source: drivers/net/can/rcar/rcar_can.c
#![no_std]
...
pub const RCAR_CAN_FIFO_DEPTH: c_int = 4;
// Mailbox registers structure
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_can_mbox_regs {
    pub /: *mut *mut u32 id; / IDE and RTR bits, SID and EID,
    pub /: *mut *mut u8 stub; / Not used,
    pub /: *mut *mut u8 dlc; / Data Length Code - bits [0..3],
    pub /: *mut *mut u8 data[8]; / Data Bytes,
    pub /: *mut *mut u8 tsh; / Time Stamp Higher Byte,
    pub /: *mut *mut u8 tsl; / Time Stamp Lower Byte,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_can_regs {
    pub /: *mut *mut rcar_can_mbox_regs mb[RCAR_CAN_N_MBX]; / Mailbox registers,
    pub /: *mut *mut u32 mkr_2_9[8]; / Mask Registers 2-9,
    pub /: *mut *mut u32 fidcr[2]; / FIFO Received ID Compare Register,
    pub /: *mut *mut u32 mkivlr1; / Mask Invalid Register 1,
    pub /: *mut *mut u32 mier1; / Mailbox Interrupt Enable Register 1,
    pub /: *mut *mut u32 mkr_0_1[2]; / Mask Registers 0-1,
    pub 0*/: *mut *mut u32 mkivlr0; / Mask Invalid Register,
    pub /: *mut *mut u32 mier0; / Mailbox Interrupt Enable Register 0,
    pub pad_440: [u8; 0x3c0],
    pub /: *mut *mut u8 mctl[64]; / Message Control Registers,
    pub /: *mut *mut u16 ctlr; / Control Register,
    pub /: *mut *mut u16 str; / Status register,
    pub /: *mut *mut u8 bcr[3]; / Bit Configuration Register,
    pub /: *mut *mut u8 clkr; / Clock Select Register,
    pub /: *mut *mut u8 rfcr; / Receive FIFO Control Register,
    pub /: *mut *mut u8 rfpcr; / Receive FIFO Pointer Control Register,
    pub /: *mut *mut u8 tfcr; / Transmit FIFO Control Register,
    pub /: *mut *mut u8 tfpcr; / Transmit FIFO Pointer Control Register,
    pub /: *mut *mut u8 eier; / Error Interrupt Enable Register,
    pub /: *mut *mut u8 eifr; / Error Interrupt Factor Judge Register,
    pub /: *mut *mut u8 recr; / Receive Error Count Register,
    pub /: *mut *mut u8 tecr; / Transmit Error Count Register,
    pub /: *mut *mut u8 ecsr; / Error Code Store Register,
    pub /: *mut *mut u8 cssr; / Channel Search Support Register,
    pub /: *mut *mut u8 mssr; / Mailbox Search Status Register,
    pub /: *mut *mut u8 msmr; / Mailbox Search Mode Register,
    pub /: *mut *mut u16 tsr; / Time Stamp Register,
    pub /: *mut *mut u8 afsr; / Acceptance Filter Support Register,
    pub pad_857: u8,
    pub /: *mut *mut u8 tcr; / Test Control Register,
    pub pad_859: [u8; 7],
    pub /: *mut *mut u8 ier; / Interrupt Enable Register,
    pub /: *mut *mut u8 isr; / Interrupt Status Register,
    pub pad_862: u8,
    pub /: *mut *mut u8 mbsmr; / Mailbox Search Mask Register,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_can_priv {
    pub /: *mut *mut can_priv can; / Must be the first member!,
    pub ndev: *mut net_device,
    pub napi: napi_struct,
    pub regs: *mut rcar_can_regs __iomem,
    pub can_clk: *mut clk,
    pub tx_head: u32,
    pub tx_tail: u32,
    pub clock_select: u8,
...
pub const RCAR_CAN_N_RX_MKREGS2: c_int = 8;
...
pub const RCAR_CAN_NAPI_WEIGHT: c_int = 4;
pub const MAX_STR_READS: c_uint = 0x100;
#[no_mangle]
unsafe extern "C" fn tx_failure_cleanup(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rcar_can_error(ndev: *mut net_device) {
...
// Propagate the error condition to the CAN stack
    ...
    let mut rx_errors: c_int = 0, tx_errors = 0;
    u8 ecsr;
...
#[no_mangle]
unsafe extern "C" fn rcar_can_tx_done(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rcar_can_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rcar_can_set_bittiming(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rcar_can_start(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rcar_can_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_can_stop(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn rcar_can_close(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_can_rx_pkt(priv: *mut rcar_can_priv) {
...
#[no_mangle]
unsafe extern "C" fn rcar_can_rx_poll(napi: *mut napi_struct, quota: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_can_do_set_mode(ndev: *mut net_device, mode: enum can_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_can_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct net_device *ndev;
    void __iomem *addr;
    let mut clock_select: u32 = CLKR_CLKP1;
...
#[no_mangle]
unsafe extern "C" fn rcar_can_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rcar_can_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_can_resume(dev: *mut device) -> c_int {
