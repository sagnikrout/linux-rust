...
//! Source: drivers/net/can/softing/softing_fw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn softing_fct_cmd(card: *mut softing, cmd: i16, msg: *const c_char) -> c_int {
...
// pmem += 10 + *plen;
    ...
    uint16_t type, len;
    uint32_t addr;
    uint8_t *buf = core::ptr::null_mut(), *new_buf;
    s64 dpram_offset;
    let mut buflen: c_int = 0;
    let mut type_end: i8 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn softing_load_app_fw(file: *const c_char, card: *mut softing) -> c_int {
    ...
    let mut type_end: i8 = 0, type_entrypoint = 0;
    ret = request_firmware(&fw, file, &card.pdev.dev);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn softing_reset_chip(card: *mut softing) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn softing_chip_poweron(card: *mut softing) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn softing_initialize_timestamp(card: *mut softing) {
...
#[no_mangle]
pub unsafe extern "C" fn softing_raw2ktime(card: *mut softing, raw: u32) -> ktime_t {
...
#[no_mangle]
pub unsafe extern "C" fn softing_error_reporting(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn softing_startstop(dev: *mut net_device, up: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn softing_default_output(netdev: *mut net_device) -> c_int {
