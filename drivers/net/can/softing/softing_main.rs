...
//! Source: drivers/net/can/softing/softing_main.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn canif_is_active(netdev: *mut net_device) -> c_int {
...
// reset DPRAM
#[no_mangle]
pub unsafe extern "C" fn softing_set_reset_dpram(card: *mut softing) {
...
#[no_mangle]
pub unsafe extern "C" fn softing_clr_reset_dpram(card: *mut softing) {
...
//
#[no_mangle]
unsafe extern "C" fn softing_handle_1(card: *mut softing) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(CAN_STATE_BUS_OFF: can_state ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn softing_irq_thread(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn softing_irq_v2(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn softing_irq_v1(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn softing_netdev_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn softing_netdev_stop(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn softing_candev_set_mode(ndev: *mut net_device, mode: enum can_mode) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn softing_enable_irq(card: *mut softing, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn softing_card_shutdown(card: *mut softing) {
    static void softing_card_shutdown(struct softing *card)
    {
    let mut fw_up: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn softing_card_boot(card: *mut softing) -> c_int {
...
//
    ...
    static const DEVICE_ATTR(chip, 0444, show_chip, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn softing_netdev_register(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn softing_netdev_cleanup(netdev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn softing_pdev_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn softing_pdev_probe(pdev: *mut platform_device) -> c_int {
