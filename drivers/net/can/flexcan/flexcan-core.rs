...
pub const FLEXCAN_FDCTRL_MBDSR_8: c_uint = 0x0;
pub const FLEXCAN_FDCTRL_MBDSR_12: c_uint = 0x1;
pub const FLEXCAN_FDCTRL_MBDSR_32: c_uint = 0x2;
pub const FLEXCAN_FDCTRL_MBDSR_64: c_uint = 0x3;

// FLEXCAN FD Bit Timing register (FDCBT) bits

// FLEXCAN interrupt flag register (IFLAG) bits
// Errata ERR005829 step7: Reserve first valid MB
pub const FLEXCAN_TX_MB_RESERVED_RX_FIFO: c_int = 8;
pub const FLEXCAN_TX_MB_RESERVED_RX_MAILBOX: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct flexcan_regs {
    pub /: *mut *mut u32 mcr; / 0x00,
    pub /: *mut *mut u32 ctrl; / 0x04 - Not affected by Soft Reset,
    pub /: *mut *mut u32 timer; / 0x08,
    pub /: *mut *mut u32 tcr; / 0x0c,
    pub /: *mut *mut u32 rxgmask; / 0x10 - Not affected by Soft Reset,
    pub /: *mut *mut u32 rx14mask; / 0x14 - Not affected by Soft Reset,
    pub /: *mut *mut u32 rx15mask; / 0x18 - Not affected by Soft Reset,
    pub /: *mut *mut u32 ecr; / 0x1c,
    pub /: *mut *mut u32 esr; / 0x20,
    pub /: *mut *mut u32 imask2; / 0x24,
    pub /: *mut *mut u32 imask1; / 0x28,
    pub /: *mut *mut u32 iflag2; / 0x2c,
    pub /: *mut *mut u32 iflag1; / 0x30,
    union {			/* 0x34 */
    pub /: *mut *mut u32 gfwr_mx28; / MX28, MX53,
    pub /: *mut *mut u32 ctrl2; / MX6, VF610 - Not affected by Soft Reset,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn flexcan_read_be(addr: *mut void __iomem) -> u32 {
    static inline u32 flexcan_read_be(void __iomem *addr)
    {
    return ioread32be(addr);
    }
#[no_mangle]
pub unsafe extern "C" fn flexcan_write_be(val: u32, addr: *mut void __iomem) {
    static inline void flexcan_write_be(u32 val, void __iomem *addr)
    {
    iowrite32be(val, addr);
    }
#[no_mangle]
pub unsafe extern "C" fn flexcan_read_le(addr: *mut void __iomem) -> u32 {
    static inline u32 flexcan_read_le(void __iomem *addr)
    {
    return ioread32(addr);
    }
#[no_mangle]
pub unsafe extern "C" fn flexcan_write_le(val: u32, addr: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn flexcan_low_power_enter_ack(priv: *mut flexcan_priv) -> c_int {
    static int flexcan_low_power_enter_ack(struct flexcan_priv *priv)
    {
    struct flexcan_regs __iomem *regs = priv.regs;
    let mut timeout: c_uint = FLEXCAN_TIMEOUT_US / 10;
...
#[no_mangle]
unsafe extern "C" fn flexcan_low_power_exit_ack(priv: *mut flexcan_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flexcan_enable_wakeup_irq(priv: *mut flexcan_priv, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn flexcan_stop_mode_enable_scfw(priv: *mut flexcan_priv, enabled: bool) -> c_int {
    static int flexcan_stop_mode_enable_scfw(struct flexcan_priv *priv, bool enabled)
    {
    let mut idx: u8 = priv.scu_idx;
    u32 rsrc_id, val;
...
#[no_mangle]
pub unsafe extern "C" fn flexcan_enter_stop_mode(priv: *mut flexcan_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn flexcan_exit_stop_mode(priv: *mut flexcan_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn flexcan_error_irq_enable(priv: *const flexcan_priv) {
    static inline void flexcan_error_irq_enable(const struct flexcan_priv *priv)
    {
    struct flexcan_regs __iomem *regs = priv.regs;
    let mut reg_ctrl: u32 = (priv.reg_ctrl_default | FLEXCAN_CTRL_ERR_MSK);
    priv.write(reg_ctrl, &regs.ctrl);
    }
#[no_mangle]
pub unsafe extern "C" fn flexcan_error_irq_disable(priv: *const flexcan_priv) {
...
#[no_mangle]
unsafe extern "C" fn flexcan_clks_enable(priv: *const flexcan_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flexcan_clks_disable(priv: *const flexcan_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn flexcan_transceiver_enable(priv: *const flexcan_priv) -> c_int {
    static inline int flexcan_transceiver_enable(const struct flexcan_priv *priv)
    {
    if (priv.reg_xceiver)
    return regulator_enable(priv.reg_xceiver);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: priv->transceiver) -> else {
    else if (priv.transceiver)
    return phy_power_on(priv.transceiver);
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn flexcan_transceiver_disable(priv: *const flexcan_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flexcan_chip_enable(priv: *mut flexcan_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flexcan_chip_disable(priv: *mut flexcan_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flexcan_chip_freeze(priv: *mut flexcan_priv) -> c_int {
    static int flexcan_chip_freeze(struct flexcan_priv *priv)
    {
    struct flexcan_regs __iomem *regs = priv.regs;
    unsigned int timeout;
    let mut bitrate: u32 = priv.can.bittiming.bitrate;
    u32 reg;
    if (bitrate)
...
#[no_mangle]
unsafe extern "C" fn flexcan_chip_unfreeze(priv: *mut flexcan_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flexcan_chip_softreset(priv: *mut flexcan_priv) -> c_int {
    ...
    struct flexcan_regs __iomem *regs = priv.regs;
    let mut reg: u32 = priv.read(&regs.ecr);
...
#[no_mangle]
unsafe extern "C" fn flexcan_start_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    ...
    u32 can_id;
    u32 data;
    let mut ctrl: u32 = FLEXCAN_MB_CODE_TX_DATA | ((can_fd_len2dlc(cfd.len)) << 16);
    int i;
...
#[no_mangle]
unsafe extern "C" fn flexcan_irq_bus_err(dev: *mut net_device, reg_esr: u32) {
    ...
    struct sk_buff *skb;
    struct can_frame *cf;
    let mut rx_errors: bool = false, tx_errors = false;
    u32 timestamp;
    int err;
...
#[no_mangle]
unsafe extern "C" fn flexcan_irq_state(dev: *mut net_device, reg_esr: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn flexcan_read64_mask(priv: *mut flexcan_priv, addr: *mut void __iomem, mask: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn flexcan_write64(priv: *mut flexcan_priv, val: u64, addr: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn flexcan_read_reg_iflag_rx(priv: *mut flexcan_priv) -> u64 {
    static inline u64 flexcan_read_reg_iflag_rx(struct flexcan_priv *priv)
    {
    return flexcan_read64_mask(priv, &priv.regs.iflag1, priv.rx_mask);
    }
#[no_mangle]
pub unsafe extern "C" fn flexcan_read_reg_iflag_tx(priv: *mut flexcan_priv) -> u64 {
...
// timestamp = reg_ctrl << 16;
    ...
    cfd.flags |= CANFD_ESI;
    for (i = 0; i < cfd.len; i += sizeof(u32)) {
    let mut data: __be32 = cpu_to_be32(priv.read(&mb.data[i / sizeof(u32)]));
...
#[no_mangle]
unsafe extern "C" fn flexcan_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    u64 reg_iflag_tx;
    u32 reg_esr;
    let mut last_state: enum can_state = priv.can.state;
// reception interrupt
    if (priv.devtype_data.quirks & FLEXCAN_QUIRK_USE_RX_MAILBOX) {
    u64 reg_iflag_rx;
    int ret;
...
// transmission complete interrupt
    ...
    let mut reg_ctrl: u32 = priv.read(&priv.tx_mb.can_ctrl);
    handled = IRQ_HANDLED;
    stats.tx_bytes +=
    can_rx_offload_get_echo_skb_queue_timestamp(&priv.offload, 0,
    reg_ctrl << 16, core::ptr::null_mut());
    stats.tx_packets++;
...
#[no_mangle]
unsafe extern "C" fn flexcan_set_bittiming_ctrl(dev: *const net_device) {
...
#[no_mangle]
unsafe extern "C" fn flexcan_set_bittiming_cbt(dev: *const net_device) {
...
#[no_mangle]
unsafe extern "C" fn flexcan_set_bittiming(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn flexcan_ram_init(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn flexcan_rx_offload_setup(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flexcan_chip_interrupts_enable(dev: *const net_device) {
...
#[no_mangle]
unsafe extern "C" fn flexcan_chip_interrupts_disable(dev: *const net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn flexcan_chip_start(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __flexcan_chip_stop(dev: *mut net_device, disable_on_error: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn flexcan_chip_stop_disable_on_error(dev: *mut net_device) -> c_int {
    static inline int flexcan_chip_stop_disable_on_error(struct net_device *dev)
    {
    return __flexcan_chip_stop(dev, true);
    }
#[no_mangle]
pub unsafe extern "C" fn flexcan_chip_stop(dev: *mut net_device) -> c_int {
    static inline int flexcan_chip_stop(struct net_device *dev)
    {
    return __flexcan_chip_stop(dev, false);
    }
#[no_mangle]
unsafe extern "C" fn flexcan_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flexcan_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flexcan_set_mode(dev: *mut net_device, mode: enum can_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn register_flexcandev(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unregister_flexcandev(dev: *mut net_device) {
    static void unregister_flexcandev(struct net_device *dev)
    {
    unregister_candev(dev);
    }
#[no_mangle]
unsafe extern "C" fn flexcan_setup_stop_mode_gpr(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flexcan_setup_stop_mode_scfw(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn flexcan_setup_stop_mode(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(FLEXCAN_QUIRK_SETUP_STOP_MODE_GPR: priv->devtype_data.quirks &) -> else {
    else if (priv.devtype_data.quirks & FLEXCAN_QUIRK_SETUP_STOP_MODE_GPR)
    ret = flexcan_setup_stop_mode_gpr(pdev);
#[no_mangle]
pub unsafe extern "C" fn if(FLEXCAN_QUIRK_SETUP_STOP_MODE_SCMI: priv->devtype_data.quirks &) -> else {
    else if (priv.devtype_data.quirks & FLEXCAN_QUIRK_SETUP_STOP_MODE_SCMI)
...
#[no_mangle]
unsafe extern "C" fn flexcan_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct clk *clk_ipg = core::ptr::null_mut(), *clk_per = core::ptr::null_mut();
    struct flexcan_regs __iomem *regs;
    struct flexcan_platform_data *pdata;
    int err, irq;
    let mut clk_src: u8 = 1;
    let mut clock_freq: u32 = 0;
    reg_xceiver = devm_regulator_get_optional(&pdev.dev, "xceiver");
    if (PTR_ERR(reg_xceiver) == -EPROBE_DEFER)
    return -EPROBE_DEFER;
#[no_mangle]
pub unsafe extern "C" fn if(-ENODEV: PTR_ERR(reg_xceiver) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn flexcan_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn flexcan_suspend(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn flexcan_resume(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn flexcan_runtime_suspend(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn flexcan_runtime_resume(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn flexcan_noirq_suspend(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn flexcan_noirq_resume(device: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(flexcan_runtime_suspend, flexcan_runtime_resume, core::ptr::null_mut())
