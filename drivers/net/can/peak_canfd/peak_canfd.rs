...
//! Source: drivers/net/can/peak_canfd/peak_canfd.c
#![no_std]
...
pub const PCANFD_ECHO_SKB_MAX: c_int = 24;
...
#[no_mangle]
unsafe extern "C" fn pucan_write_cmd(priv: *mut peak_canfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pucan_set_reset_mode(priv: *mut peak_canfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pucan_set_normal_mode(priv: *mut peak_canfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pucan_set_listen_only_mode(priv: *mut peak_canfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pucan_set_std_filter(priv: *mut peak_canfd_priv, row: u8, mask: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pucan_tx_abort(priv: *mut peak_canfd_priv, flags: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pucan_clr_err_counters(priv: *mut peak_canfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pucan_set_options(priv: *mut peak_canfd_priv, opt_mask: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pucan_clr_options(priv: *mut peak_canfd_priv, opt_mask: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pucan_setup_rx_barrier(priv: *mut peak_canfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pucan_netif_rx(skb: *mut sk_buff, ts_low: __le32, ts_high: __le32) -> c_int {
...
// handle the reception of one CAN frame
    ...
    struct sk_buff *skb;
    let mut rx_msg_flags: u16 = le16_to_cpu(msg.flags);
    u8 cf_len;
...
// count bytes of the echo instead of skb
    stats.tx_bytes += can_get_echo_skb(priv.ndev, msg.client, core::ptr::null_mut());
    stats.tx_packets++;
...
// this STATUS is the CNF of the RX_BARRIER: Tx path can be setup
    ...
    let mut err: c_int = priv.enable_tx_path(priv);
    if (err)
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn pucan_handle_cache_critical(priv: *mut peak_canfd_priv) -> c_int {
...
// handle a single uCAN message
    ...
    struct pucan_rx_msg *msg)
    {
    let mut msg_type: u16 = le16_to_cpu(msg.type);
    let mut msg_size: c_int = le16_to_cpu(msg.size);
    int err;
...
#[no_mangle]
unsafe extern "C" fn peak_canfd_start(priv: *mut peak_canfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn peak_canfd_stop(priv: *mut peak_canfd_priv) {
...
#[no_mangle]
unsafe extern "C" fn peak_canfd_set_mode(ndev: *mut net_device, mode: enum can_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn peak_canfd_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn peak_canfd_set_bittiming(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn peak_canfd_set_data_bittiming(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn peak_canfd_close(ndev: *mut net_device) -> c_int {
