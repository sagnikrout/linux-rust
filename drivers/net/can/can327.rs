...
//! Source: drivers/net/can/can327.c
#![no_std]
...
pub const CAN327_NAPI_WEIGHT: c_int = 4;
pub const CAN327_SIZE_TXBUF: c_int = 32;
pub const CAN327_SIZE_RXBUF: c_int = 1024;
pub const CAN327_CAN_CONFIG_SEND_SFF: c_uint = 0x8000;
pub const CAN327_CAN_CONFIG_VARIABLE_DLC: c_uint = 0x4000;
pub const CAN327_CAN_CONFIG_RECV_BOTH_SFF_EFF: c_uint = 0x2000;
pub const CAN327_CAN_CONFIG_BAUDRATE_MULT_8_7: c_uint = 0x1000;
...
// TTY buffers
    pub txbuf: [u8; CAN327_SIZE_TXBUF],
    pub rxbuf: [u8; CAN327_SIZE_RXBUF],
// Per-channel lock
    pub lock: spinlock_t,
...
// TTY buffer accounting
    pub /: *mut *mut work_tx_work; / Flushes TTY TX buffer,
    pub /: *mut *mut *mut u8 txhead; / Next TX byte,
    pub /: *mut *mut size_t txleft; / Bytes left to TX,
    pub /: *mut *mut int rxfill; / Bytes already RX'd in buffer,
// State machine
    enum {
...
// Things we have yet to send
    pub next_init_cmd: *mut c_char,
    pub cmds_todo: c_ulong,
// The CAN frame and config the ELM327 is sending/using,
// or will send/use after finishing all cmds_todo
//
    pub can_frame_to_send: can_frame,
    pub can_config: u16,
    pub can_bitrate_divisor: u8,
// Parser state
    pub drop_next_line: bool,
...
//
    pub uart_side_failure: bool,
}

    static inline void can327_uart_side_failure(struct can327 *elm);
#[no_mangle]
unsafe extern "C" fn can327_send(elm: *mut can327, buf: *const c_void, len: usize) {
...
//
#[no_mangle]
unsafe extern "C" fn can327_kick_into_cmd_mode(elm: *mut can327) {
...
#[no_mangle]
unsafe extern "C" fn can327_send_frame(elm: *mut can327, frame: *mut can_frame) {
...
#[no_mangle]
unsafe extern "C" fn can327_init_device(elm: *mut can327) {
...
#[no_mangle]
unsafe extern "C" fn can327_feed_frame_to_netdev(elm: *mut can327, skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn can327_uart_side_failure(elm: *mut can327) {
    static inline void can327_uart_side_failure(struct can327 *elm)
    {
...
//
    ...
    {
    let mut ref_len: usize = strlen(reference);
    return (nbytes == ref_len) && !memcmp(buf, reference, ref_len);
    }
#[no_mangle]
unsafe extern "C" fn can327_parse_error(elm: *mut can327, len: usize) {
...
//
#[no_mangle]
unsafe extern "C" fn can327_parse_frame(elm: *mut can327, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn can327_parse_line(elm: *mut can327, len: usize) {
...
#[no_mangle]
unsafe extern "C" fn can327_handle_prompt(elm: *mut can327) {
...
#[no_mangle]
unsafe extern "C" fn can327_is_ready_char(c: c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn can327_drop_bytes(elm: *mut can327, i: usize) {
...
#[no_mangle]
unsafe extern "C" fn can327_parse_rxbuf(elm: *mut can327, first_new_char_idx: usize) {
...
#[no_mangle]
unsafe extern "C" fn can327_netdev_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn can327_netdev_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn can327_is_valid_rx_char(c: u8) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn can327_ldisc_tx_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn can327_ldisc_tx_wakeup(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn can327_ldisc_open(tty: *mut tty_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn can327_ldisc_close(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn can327_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn can327_exit() -> void __exit {
