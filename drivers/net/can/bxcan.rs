...
//! Source: drivers/net/can/bxcan.c
#![no_std]
...
pub const BXCAN_NAPI_WEIGHT: c_int = 3;
pub const BXCAN_TIMEOUT_US: c_int = 10000;
pub const BXCAN_RX_MB_NUM: c_int = 2;
pub const BXCAN_TX_MB_NUM: c_int = 3;
...
pub const BXCAN_FMR_REG: c_uint = 0x00;
pub const BXCAN_FM1R_REG: c_uint = 0x04;
pub const BXCAN_FS1R_REG: c_uint = 0x0c;
pub const BXCAN_FFA1R_REG: c_uint = 0x14;
pub const BXCAN_FA1R_REG: c_uint = 0x1c;
...
#[derive(Copy, Clone)]
pub struct bxcan_mb {
    pub /: *mut *mut u32 id; / can identifier,
    pub /: *mut *mut u32 dlc; / data length control and timestamp,
    pub /: *mut *mut u32 data[2]; / data,
}

// Structure of the hardware registers
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bxcan_regs {
    pub /: *mut *mut u32 mcr; / 0x00 - primary control,
    pub /: *mut *mut u32 msr; / 0x04 - primary status,
    pub /: *mut *mut u32 tsr; / 0x08 - transmit status,
    pub /: *mut *mut u32 rf0r; / 0x0c - FIFO 0,
    pub /: *mut *mut u32 rf1r; / 0x10 - FIFO 1,
    pub /: *mut *mut u32 ier; / 0x14 - interrupt enable,
    pub /: *mut *mut u32 esr; / 0x18 - error status,
    pub timing*/: *mut *mut u32 btr; / 0x1c - bit,
    pub /: *mut *mut u32 reserved0[88]; / 0x20,
    pub /: *mut *mut bxcan_mb tx_mb[BXCAN_TX_MB_NUM]; / 0x180 - tx mailbox,
    pub /: *mut *mut bxcan_mb rx_mb[BXCAN_RX_MB_NUM]; / 0x1b0 - rx mailbox,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bxcan_priv {
    pub can: can_priv,
    pub offload: can_rx_offload,
    pub dev: *mut device,
    pub ndev: *mut net_device,
    pub regs: *mut bxcan_regs __iomem,
    pub gcan: *mut regmap,
    pub tx_irq: c_int,
    pub sce_irq: c_int,
    pub cfg: enum bxcan_cfg,
    pub clk: *mut clk,
    pub /: *mut *mut spinlock_t rmw_lock; / lock for read-modify-write operations,
    pub tx_head: c_uint,
    pub tx_tail: c_uint,
    pub timestamp: u32,
}
...
#[no_mangle]
unsafe extern "C" fn bxcan_disable_filters(priv: *mut bxcan_priv, cfg: enum bxcan_cfg) {
    static void bxcan_disable_filters(struct bxcan_priv *priv, enum bxcan_cfg cfg)
    {
    let mut fid: c_uint = BXCAN_FILTER_ID(cfg);
    let mut fmask: u32 = BIT(fid);
    regmap_update_bits(priv.gcan, BXCAN_FA1R_REG, fmask, 0);
    }
#[no_mangle]
unsafe extern "C" fn bxcan_enable_filters(priv: *mut bxcan_priv, cfg: enum bxcan_cfg) {
...
#[no_mangle]
unsafe extern "C" fn bxcan_chip_softreset(priv: *mut bxcan_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bxcan_enter_init_mode(priv: *mut bxcan_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bxcan_leave_init_mode(priv: *mut bxcan_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bxcan_enter_sleep_mode(priv: *mut bxcan_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bxcan_leave_sleep_mode(priv: *mut bxcan_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bxcan_rx_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bxcan_tx_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    break;
    stats.tx_packets++;
    stats.tx_bytes += can_get_echo_skb(ndev, idx, core::ptr::null_mut());
    priv.tx_tail++;
    }
    writel(tsr, &regs.tsr);
...
#[no_mangle]
unsafe extern "C" fn bxcan_handle_state_change(ndev: *mut net_device, esr: u32) {
    static void bxcan_handle_state_change(struct net_device *ndev, u32 esr)
    {
    struct bxcan_priv *priv = netdev_priv(ndev);
    let mut new_state: enum can_state = priv.can.state;
...
#[no_mangle]
pub unsafe extern "C" fn if(BXCAN_ESR_EPVF: esr &) -> else {
    else if (esr & BXCAN_ESR_EPVF)
    new_state = CAN_STATE_ERROR_PASSIVE;
#[no_mangle]
pub unsafe extern "C" fn if(BXCAN_ESR_EWGF: esr &) -> else {
...
#[no_mangle]
unsafe extern "C" fn bxcan_handle_bus_err(ndev: *mut net_device, esr: u32) {
...
#[no_mangle]
unsafe extern "C" fn bxcan_state_change_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bxcan_chip_start(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bxcan_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bxcan_chip_stop(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn bxcan_stop(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bxcan_do_set_mode(ndev: *mut net_device, mode: enum can_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bxcan_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_property_read_bool(np, _arg: "st, _arg: can-secondary")) -> else {
...
#[no_mangle]
unsafe extern "C" fn bxcan_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn bxcan_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn bxcan_resume(dev: *mut device) -> int __maybe_unused {
