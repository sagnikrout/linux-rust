...
//! Source: drivers/net/can/sja1000/sja1000_isa.c
#![no_std]
...
pub const MAXDEV: c_int = 8;
    ...
    module_param_array(cdr, byte, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(cdr, "Clock divider register "
    "(default=0x48 [CDR_CBP | CDR_CLK_OFF])");
    module_param_array(ocr, byte, core::ptr::null_mut(), 0444);
    MODULE_PARM_DESC(ocr, "Output control register "
    "(default=0x18 [OCR_TX0_PUSHPULL])");
pub const SJA1000_IOSIZE: c_uint = 0x20;
pub const SJA1000_IOSIZE_INDIRECT: c_uint = 0x02;
    static struct platform_device *sja1000_isa_devs[MAXDEV];
#[no_mangle]
unsafe extern "C" fn sja1000_isa_mem_read_reg(priv: *const sja1000_priv, reg: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn sja1000_isa_port_read_reg(priv: *const sja1000_priv, reg: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn sja1000_isa_probe(pdev: *mut platform_device) -> c_int {
    static int sja1000_isa_probe(struct platform_device *pdev)
    {
    struct net_device *dev;
    struct sja1000_priv *priv;
    void __iomem *base = core::ptr::null_mut();
    let mut iosize: c_int = SJA1000_IOSIZE;
...
pub unsafe extern "C" fn if(_arg: clk[0]) -> else {
    ...
    priv.ocr = ocr[idx];
#[no_mangle]
pub unsafe extern "C" fn if(0xff: ocr[0] !=) -> else {
    else if (ocr[0] != 0xff)
    priv.ocr = ocr[0];
    else
    ...
    priv.cdr = cdr[idx];
#[no_mangle]
pub unsafe extern "C" fn if(0xff: cdr[0] !=) -> else {
    else if (cdr[0] != 0xff)
    priv.cdr = cdr[0];
    else
...
#[no_mangle]
unsafe extern "C" fn sja1000_isa_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sja1000_isa_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sja1000_isa_exit() -> void __exit {
