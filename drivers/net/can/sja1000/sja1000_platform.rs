...
//! Source: drivers/net/can/sja1000/sja1000_platform.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sja1000_of_data {
    pub priv_sz: usize,
    pub of): *mut *mut *mut void (init)(struct sja1000_priv priv, struct device_node,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct technologic_priv {
    pub io_lock: spinlock_t,
}

#[no_mangle]
unsafe extern "C" fn sp_read_reg8(priv: *const sja1000_priv, reg: c_int) -> u8 {
    static u8 sp_read_reg8(const struct sja1000_priv *priv, int reg)
    {
    return ioread8(priv.reg_base + reg);
    }
#[no_mangle]
unsafe extern "C" fn sp_write_reg8(priv: *const sja1000_priv, reg: c_int, val: u8) {
    static void sp_write_reg8(const struct sja1000_priv *priv, int reg, u8 val)
    {
    iowrite8(val, priv.reg_base + reg);
    }
#[no_mangle]
unsafe extern "C" fn sp_read_reg16(priv: *const sja1000_priv, reg: c_int) -> u8 {
    static u8 sp_read_reg16(const struct sja1000_priv *priv, int reg)
    {
    return ioread8(priv.reg_base + reg * 2);
    }
#[no_mangle]
unsafe extern "C" fn sp_write_reg16(priv: *const sja1000_priv, reg: c_int, val: u8) {
    static void sp_write_reg16(const struct sja1000_priv *priv, int reg, u8 val)
    {
    iowrite8(val, priv.reg_base + reg * 2);
    }
#[no_mangle]
unsafe extern "C" fn sp_read_reg32(priv: *const sja1000_priv, reg: c_int) -> u8 {
    static u8 sp_read_reg32(const struct sja1000_priv *priv, int reg)
    {
    return ioread8(priv.reg_base + reg * 4);
    }
#[no_mangle]
unsafe extern "C" fn sp_write_reg32(priv: *const sja1000_priv, reg: c_int, val: u8) {
    static void sp_write_reg32(const struct sja1000_priv *priv, int reg, u8 val)
    {
    iowrite8(val, priv.reg_base + reg * 4);
    }
#[no_mangle]
unsafe extern "C" fn sp_technologic_read_reg16(priv: *const sja1000_priv, reg: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn sp_technologic_init(priv: *mut sja1000_priv, of: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn sp_rzn1_init(priv: *mut sja1000_priv, of: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn sp_populate_of(priv: *mut sja1000_priv, of: *mut device_node) {
    ...
    if (!err && prop) {
    let mut divider: u32 = priv.can.clock.freq * 2 / prop;
    if (divider > 1)
    ...
    { .compatible = "nxp,sja1000", .data = core::ptr::null_mut(), },
...
#[no_mangle]
unsafe extern "C" fn sp_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct resource *res_mem, *res_irq = core::ptr::null_mut();
    struct sja1000_platform_data *pdata;
    struct device_node *of = pdev.dev.of_node;
    const struct sja1000_of_data *of_data = core::ptr::null_mut();
    let mut priv_sz: usize = 0;
    struct clk *clk;
...
#[no_mangle]
unsafe extern "C" fn sp_remove(pdev: *mut platform_device) {
