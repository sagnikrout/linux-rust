...
//! Source: drivers/net/can/dev/skb.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn can_flush_echo_skb(dev: *mut net_device) {
    ...
    priv.echo_skb[i] = core::ptr::null_mut();
    stats.tx_dropped++;
...
// frame_len_ptr = 0;
    ...
    priv.echo_skb[idx] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn init_can_skb(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn can_skb_init_valid(dev: *mut net_device, skb: *mut sk_buff) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn can_dropped_invalid_skb(dev: *mut net_device, skb: *mut sk_buff) -> bool {
