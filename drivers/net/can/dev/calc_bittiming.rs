...
//! Source: drivers/net/can/dev/calc_bittiming.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn can_calc_sample_point_nrz(bt: *const can_bittiming) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn can_calc_sample_point_pwm(bt: *const can_bittiming) -> c_int {
...
// sample_point_error_ptr = best_sample_point_error;
    ...
    let mut best_bitrate_error: c_uint = UINT_MAX;
    unsigned int sample_point_error;	/* diff between calculated and reference value */
    let mut best_sample_point_error: c_uint = UINT_MAX;
...
// real bitrate
    ...
    {
    let mut tdc_auto: u32 = tdc_mask & CAN_CTRLMODE_TDC_AUTO_MASK;
...
#[no_mangle]
pub unsafe extern "C" fn can_calc_pwm(dev: *mut net_device, extack: *mut netlink_ext_ack) -> c_int {
    ...
    let mut xl_tqmin: u32 = can_bit_time_tqmin(&priv.xl.data_bittiming);
    let mut xl_ns: u32 = can_tqmin_to_ns(xl_tqmin, priv.clock.freq);
    let mut nom_tqmin: u32 = can_bit_time_tqmin(&priv.bittiming);
    let mut pwm_per_bit_max: c_int = xl_tqmin / (pwm_const.pwms_min + pwm_const.pwml_min);
    int pwm_per_bit;
    u32 pwm_tqmin;
