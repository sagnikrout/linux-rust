...
//! Source: drivers/net/can/dev/dev.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn can_tx_state_to_frame(dev: *mut net_device, state: enum can_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn can_rx_state_to_frame(dev: *mut net_device, state: enum can_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn can_state_err_to_state(err: u16) -> enum can_state {
...
// rx_state = can_state_err_to_state(bec->rxerr);
    ...
    {
    struct can_priv *priv = netdev_priv(dev);
    let mut new_state: enum can_state = max(tx_state, rx_state);
...
#[no_mangle]
unsafe extern "C" fn can_restart(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn can_restart_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn can_restart_now(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn can_bus_off(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn can_setup(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn free_candev(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn can_set_default_mtu(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn can_set_cap_info(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn can_set_static_ctrlmode(dev: *mut net_device, static_mode: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn open_candev(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_can_transceiver(dev: *mut net_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn close_candev(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn can_set_termination(ndev: *mut net_device, term: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn can_get_termination(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn register_candev(dev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn unregister_candev(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn can_dev_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn can_dev_exit() -> __exit void {
