...
//! Source: drivers/net/can/dev/rx-offload.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn can_rx_offload_napi_poll(napi: *mut napi_struct, quota: c_int) -> c_int {
...
// Check if there was another interrupt
    ...
    {
    struct sk_buff *pos, *insert = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn can_rx_offload_compare(a: *mut sk_buff, b: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn can_rx_offload_irq_offload_fifo(offload: *mut can_rx_offload) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn can_rx_offload_irq_finish(offload: *mut can_rx_offload) {
...
#[no_mangle]
pub unsafe extern "C" fn can_rx_offload_threaded_irq_finish(offload: *mut can_rx_offload) {
...
#[no_mangle]
pub unsafe extern "C" fn can_rx_offload_enable(offload: *mut can_rx_offload) {
...
#[no_mangle]
pub unsafe extern "C" fn can_rx_offload_del(offload: *mut can_rx_offload) {
