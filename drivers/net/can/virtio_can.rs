...
//! Source: drivers/net/can/virtio_can.c
#![no_std]
...
// CAN device queues
pub const VIRTIO_CAN_QUEUE_TX: c_int = 0;
pub const VIRTIO_CAN_QUEUE_RX: c_int = 1;
pub const VIRTIO_CAN_QUEUE_CONTROL: c_int = 2;
pub const VIRTIO_CAN_QUEUE_COUNT: c_int = 3;

    (VIRTIO_CAN_FLAGS_EXTENDED |\
    VIRTIO_CAN_FLAGS_FD |\
    VIRTIO_CAN_FLAGS_RTR)
// Max. number of in flight TX messages
pub const VIRTIO_CAN_ECHO_SKB_MAX: c_int = 128;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_can_tx {
    pub putidx: c_uint,
    pub tx_in: virtio_can_tx_in,
// Keep virtio_can_tx_out at the end of the structure due to flex array
    pub tx_out: virtio_can_tx_out,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_can_control {
    pub cpkt_out: virtio_can_control_out,
    pub cpkt_in: virtio_can_control_in,
}

// virtio_can private data structure
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_can_priv {
...
// The virtqueues
    pub vqs: [*mut virtqueue; VIRTIO_CAN_QUEUE_COUNT],
// Lock for TX operations
    pub tx_lock: spinlock_t,
// Control queue lock
    pub ctrl_lock: mutex,
// Wait for control queue processing without polling
    pub ctrl_done: completion,
// Array of receive queue messages
    pub rpkt: *mut virtio_can_rx,
    pub can_ctr_msg: virtio_can_control,
// Data to get and maintain the putidx for local TX echo
    pub tx_putidx_ida: ida,
// In flight TX messages
    pub tx_inflight: core::sync::atomic::AtomicI32,
// Packet length
    pub rpkt_len: c_int,
// BusOff pending. Reset after successful indication to upper layer
    pub busoff_pending: bool,
// Tracks whether NAPI instances are currently enabled
    pub napi_active: bool,
}
...
#[no_mangle]
unsafe extern "C" fn virtio_can_free_candev(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_napi_enable(priv: *mut virtio_can_priv) {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_napi_disable(priv: *mut virtio_can_priv) {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_alloc_tx_idx(priv: *mut virtio_can_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn virtio_can_send_ctrl_msg(ndev: *mut net_device, msg_type: u16) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_start(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_set_mode(dev: *mut net_device, mode: enum can_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_stop(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_close(dev: *mut net_device) -> c_int {
...
//
    ...
    {
    struct scatterlist sg_out, sg_in, *sgs[2] = { &sg_out, &sg_in };
    let mut hdr_size: c_uint = sizeof(struct virtio_can_tx_out);
    struct canfd_frame *cf = (struct canfd_frame *)skb.data;
    struct virtio_can_priv *priv = netdev_priv(dev);
    struct virtqueue *vq = priv.vqs[VIRTIO_CAN_QUEUE_TX];
    let mut xmit_ret: netdev_tx_t = NETDEV_TX_OK;
...
//
    can_free_echo_skb(dev, can_tx_msg.putidx, core::ptr::null_mut());
    virtio_can_free_tx_idx(priv, can_tx_msg.putidx);
    netif_stop_queue(dev);
    kfree(can_tx_msg);
    dev.stats.tx_dropped++;
...
#[no_mangle]
unsafe extern "C" fn register_virtio_can_dev(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_read_tx_queue(vq: *mut virtqueue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_tx_poll(napi: *mut napi_struct, quota: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_tx_intr(vq: *mut virtqueue) {
...
//
#[no_mangle]
unsafe extern "C" fn virtio_can_read_rx_queue(vq: *mut virtqueue) -> c_int {
    static int virtio_can_read_rx_queue(struct virtqueue *vq)
    {
    let mut header_size: c_uint = sizeof(struct virtio_can_rx);
...
#[no_mangle]
unsafe extern "C" fn virtio_can_handle_busoff(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_rx_poll(napi: *mut napi_struct, quota: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_rx_intr(vq: *mut virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_control_intr(vq: *mut virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_config_changed(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_populate_rx_vq(vdev: *mut virtio_device) {
    static void virtio_can_populate_rx_vq(struct virtio_device *vdev)
    {
    struct virtio_can_priv *priv = vdev.priv;
    struct virtqueue *vq = priv.vqs[VIRTIO_CAN_QUEUE_RX];
    let mut buf_size: c_uint = priv.rpkt_len;
    let mut num_elements: c_int = vq.num_free;
    u8 *buf = (u8 *)priv.rpkt;
    unsigned int idx;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn virtio_can_find_vqs(priv: *mut virtio_can_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_del_vq(vdev: *mut virtio_device) {
...
// Free pending TX buffers which were allocated in virtio_can_start_xmit()
    ...
    can_free_echo_skb(priv.dev, can_tx_msg.putidx, core::ptr::null_mut());
    virtio_can_free_tx_idx(priv, can_tx_msg.putidx);
    kfree(can_tx_msg);
    }
...
#[no_mangle]
unsafe extern "C" fn virtio_can_remove(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_validate(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_probe(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_freeze(vdev: *mut virtio_device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn virtio_can_restore(vdev: *mut virtio_device) -> int __maybe_unused {
