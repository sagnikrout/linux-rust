...
//! Source: drivers/net/can/m_can/m_can_pci.c
#![no_std]
...
pub const M_CAN_PCI_MMIO_BAR: c_int = 0;
pub const M_CAN_CLOCK_FREQ_EHL: c_int = 200000000;
pub const CTL_CSR_INT_CTL_OFFSET: c_uint = 0x508;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct m_can_pci_priv {
...
#[no_mangle]
unsafe extern "C" fn m_can_pci_probe(pci: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m_can_pci_remove(pci: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn m_can_pci_suspend(dev: *mut device) -> __maybe_unused int {
    static __maybe_unused int m_can_pci_suspend(struct device *dev)
    {
    return m_can_class_suspend(dev);
    }
#[no_mangle]
unsafe extern "C" fn m_can_pci_resume(dev: *mut device) -> __maybe_unused int {
