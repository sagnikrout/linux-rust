...
//! Source: drivers/net/can/ctucanfd/ctucanfd_base.c
#![no_std]
...
pub const CTUCANFD_ID: c_uint = 0xCAFD;
// TX buffer rotation:
...
//
pub const CTUCANFD_FLAG_RX_FFW_BUFFERED: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn ctucan_write32(priv: *mut ctucan_priv, reg: enum ctu_can_fd_can_registers, val: u32) {
    static void ctucan_write32(struct ctucan_priv *priv, enum ctu_can_fd_can_registers reg, u32 val)
    {
    priv.write_reg(priv, reg, val);
    }
#[no_mangle]
unsafe extern "C" fn ctucan_read32(priv: *mut ctucan_priv, reg: enum ctu_can_fd_can_registers) -> u32 {
...
//
    ...
    {
    const char *txt = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_reset(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_set_btr(ndev: *mut net_device, bt: *mut can_bittiming, nominal: bool) -> c_int {
    static int ctucan_set_btr(struct net_device *ndev, struct can_bittiming *bt, bool nominal)
    {
    struct ctucan_priv *priv = netdev_priv(ndev);
    let mut max_ph1_len: c_int = 31;
    let mut btr: u32 = 0;
    let mut prop_seg: u32 = bt.prop_seg;
    let mut phase_seg1: u32 = bt.phase_seg1;
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_set_bittiming(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_set_data_bittiming(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_set_secondary_sample_point(ndev: *mut net_device) -> c_int {
    static int ctucan_set_secondary_sample_point(struct net_device *ndev)
    {
    struct ctucan_priv *priv = netdev_priv(ndev);
    struct can_bittiming *dbt = &priv.can.fd.data_bittiming;
    let mut ssp_offset: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_set_mode(priv: *mut ctucan_priv, mode: *const can_ctrlmode) {
    static void ctucan_set_mode(struct ctucan_priv *priv, const struct can_ctrlmode *mode)
    {
    let mut mode_reg: u32 = ctucan_read32(priv, CTUCANFD_MODE);
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_chip_start(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_do_set_mode(ndev: *mut net_device, mode: enum can_mode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_get_tx_status(priv: *mut ctucan_priv, buf: u8) -> enum ctucan_txtb_status {
    static enum ctucan_txtb_status ctucan_get_tx_status(struct ctucan_priv *priv, u8 buf)
    {
    let mut tx_status: u32 = ctucan_read32(priv, CTUCANFD_TX_STATUS);
    let mut status: enum ctucan_txtb_status = (tx_status >> (buf * 4)) & 0x7;
    return status;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_is_txt_buf_writable(priv: *mut ctucan_priv, buf: u8) -> bool {
...
// Write Data payload
    ...
    let mut data: u32 = le32_to_cpu(*(__le32 *)(cf.data + i));
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_give_txtb_cmd(priv: *mut ctucan_priv, cmd: enum ctucan_txtb_command, buf: u8) {
    static void ctucan_give_txtb_cmd(struct ctucan_priv *priv, enum ctucan_txtb_command cmd, u8 buf)
    {
    let mut tx_cmd: u32 = cmd;
    tx_cmd |= 1 << (buf + 8);
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_start_xmit(skb: *mut sk_buff, ndev: *mut net_device) -> netdev_tx_t {
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_read_rx_frame(priv: *mut ctucan_priv, cf: *mut canfd_frame, ffw: u32) {
...
// Data
    for (i = 0; i < len; i += 4) {
    let mut data: u32 = ctucan_read32(priv, CTUCANFD_RX_DATA);
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_rx(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_read_fault_state(priv: *mut ctucan_priv) -> enum can_state {
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_get_rec_tec(priv: *mut ctucan_priv, bec: *mut can_berr_counter) {
    static void ctucan_get_rec_tec(struct ctucan_priv *priv, struct can_berr_counter *bec)
    {
    let mut err_ctrs: u32 = ctucan_read32(priv, CTUCANFD_REC);
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_err_interrupt(ndev: *mut net_device, isr: u32) {
    ...
    u32 err_capt_alc;
    let mut dologerr: c_int = net_ratelimit();
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_rx_poll(napi: *mut napi_struct, quota: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_rotate_txb_prio(ndev: *mut net_device) {
    static void ctucan_rotate_txb_prio(struct net_device *ndev)
    {
    struct ctucan_priv *priv = netdev_priv(ndev);
    let mut prio: u32 = priv.txb_prio;
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_tx_interrupt(ndev: *mut net_device) {
...
//
    ...
    stats.tx_bytes += can_get_echo_skb(ndev, txtb_id, core::ptr::null_mut());
    stats.tx_packets++;
    break;
    case TXT_ERR:
...
//
    ...
    can_free_echo_skb(ndev, txtb_id, core::ptr::null_mut());
    stats.tx_dropped++;
    break;
    case TXT_ABT:
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// Ignore RI, TI, LFI, RFI, BSI
    ...
    let mut status: u32 = ctucan_get_tx_status(priv, i);
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_chip_stop(ndev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_open(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_close(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ctucan_get_berr_counter(ndev: *const net_device, bec: *mut can_berr_counter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ctucan_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ctucan_resume(dev: *mut device) -> c_int {
...
// Getting the can_clk info
    if (!can_clk_rate) {
    priv.can_clk = devm_clk_get(dev, core::ptr::null_mut());
