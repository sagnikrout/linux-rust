...
//! Source: drivers/net/can/dummy_can.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dummy_can_print_tdc(dev: *mut net_device, tdc: *mut can_tdc) {
...
#[no_mangle]
unsafe extern "C" fn dummy_can_print_ctrlmode(dev: *mut net_device) {
    ...
    let mut supported: c_ulong = can_priv.ctrlmode_supported;
    let mut enabled: u32 = can_priv.ctrlmode;
...
#[no_mangle]
unsafe extern "C" fn dummy_can_print_bittiming_info(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn dummy_can_netdev_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy_can_netdev_close(dev: *mut net_device) -> c_int {
    ...
    dev.stats.tx_bytes += can_get_echo_skb(dev, 0, core::ptr::null_mut());
    return NETDEV_TX_OK;
    }
...
#[no_mangle]
unsafe extern "C" fn dummy_can_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dummy_can_exit() -> void __exit {
