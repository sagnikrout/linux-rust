...
//! Source: drivers/net/can/at91_can.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct at91_devtype_data {
    pub rx_first: c_uint,
    pub rx_last: c_uint,
    pub tx_shift: c_uint,
    pub type: enum at91_devtype,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct at91_priv {
    ...
    pub tx_head: c_uint,
    pub tx_tail: c_uint,
    pub devtype_data: at91_devtype_data,
    pub clk: *mut clk,
    pub pdata: *mut at91_can_data,
    pub mb0_id: canid_t,
}
...
#[no_mangle]
pub unsafe extern "C" fn get_irq_mb_tx(priv: *const at91_priv) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn get_tx_head_mb(priv: *const at91_priv) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn get_tx_head_prio(priv: *const at91_priv) -> c_uint {
    static inline unsigned int get_tx_head_prio(const struct at91_priv *priv)
    {
    return (priv.tx_head >> get_head_prio_shift(priv)) & 0xf;
    }
#[no_mangle]
pub unsafe extern "C" fn get_tx_tail_mb(priv: *const at91_priv) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn at91_read(priv: *const at91_priv, reg: enum at91_reg) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn at91_can_id_to_reg_mid(can_id: canid_t) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn at91_setup_mailboxes(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn at91_set_bittiming(dev: *mut net_device) -> c_int {
    static int at91_set_bittiming(struct net_device *dev)
    {
    const struct at91_priv *priv = netdev_priv(dev);
    const struct can_bittiming *bt = &priv.can.bittiming;
    let mut reg_br: u32 = 0;
    ...
    {
    const struct at91_priv *priv = netdev_priv(dev);
    let mut reg_ecr: u32 = at91_read(priv, AT91_ECR);
    bec.rxerr = FIELD_GET(AT91_ECR_REC_MASK, reg_ecr);
    bec.txerr = FIELD_GET(AT91_ECR_TEC_MASK, reg_ecr);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn at91_chip_start(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn at91_chip_stop(dev: *mut net_device, state: enum can_state) {
...
//
#[no_mangle]
unsafe extern "C" fn at91_start_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
pub unsafe extern "C" fn at91_get_timestamp(priv: *const at91_priv) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn at91_rx_overflow_err(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn at91_irq_tx(dev: *mut net_device, reg_sr: u32) {
...
// _NOTE_: subtract AT91_MB_TX_FIRST offset from mb!
    dev.stats.tx_bytes +=
    can_get_echo_skb(dev, mb - get_mb_tx_first(priv), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn at91_irq_err_line(dev: *mut net_device, reg_sr: u32) {
...
#[no_mangle]
unsafe extern "C" fn at91_irq_err_frame(dev: *mut net_device, reg_sr: u32) {
...
#[no_mangle]
unsafe extern "C" fn at91_get_reg_sr_rx(priv: *const at91_priv, reg_sr_p: *mut u32) -> u32 {
    static u32 at91_get_reg_sr_rx(const struct at91_priv *priv, u32 *reg_sr_p)
    {
    let mut reg_sr: u32 = at91_read(priv, AT91_SR);
// reg_sr_p |= reg_sr;
    return reg_sr & get_irq_mb_rx(priv);
    }
#[no_mangle]
unsafe extern "C" fn at91_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t at91_irq(int irq, void *dev_id)
    {
    struct net_device *dev = dev_id;
    struct at91_priv *priv = netdev_priv(dev);
    let mut handled: irqreturn_t = IRQ_NONE;
    let mut reg_sr: u32 = 0, reg_sr_rx;
    int ret;
// Receive interrupt
...
#[no_mangle]
unsafe extern "C" fn at91_open(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn at91_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at91_set_mode(dev: *mut net_device, mode: enum can_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at91_can_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at91_can_remove(pdev: *mut platform_device) {
