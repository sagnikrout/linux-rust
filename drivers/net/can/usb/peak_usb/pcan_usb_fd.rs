...
//! Source: drivers/net/can/usb/peak_usb/pcan_usb_fd.c
#![no_std]
...
pub const PCAN_USBPROFD_CHANNEL_COUNT: c_int = 2;
pub const PCAN_USBFD_CHANNEL_COUNT: c_int = 1;
// PCAN-USB Pro FD adapter internal clock (Hz)
pub const PCAN_UFD_CRYSTAL_HZ: c_int = 80000000;
pub const PCAN_UFD_CMD_BUFFER_SIZE: c_int = 512;
pub const PCAN_UFD_LOSPD_PKT_SIZE: c_int = 64;
// PCAN-USB Pro FD command timeout (ms.)
pub const PCAN_UFD_CMD_TIMEOUT_MS: c_int = 1000;
// PCAN-USB Pro FD rx/tx buffers size
pub const PCAN_UFD_RX_BUFFER_SIZE: c_int = 2048;
pub const PCAN_UFD_TX_BUFFER_SIZE: c_int = 512;
// struct pcan_ufd_fw_info::type
pub const PCAN_USBFD_TYPE_STD: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcan_usb_fd_if {
    pub dev: [*mut peak_usb_device; PCAN_USB_MAX_CHANNEL],
    pub fw_info: pcan_ufd_fw_info,
    pub time_ref: peak_time_ref,
    pub cm_ignore_count: c_int,
    pub dev_opened_count: c_int,
}

// device information
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcan_usb_fd_device {
    pub dev: peak_usb_device,
    pub bec: can_berr_counter,
    pub usb_if: *mut pcan_usb_fd_if,
    pub cmd_buffer_addr: *mut u8,
}

// Extended USB commands (non uCAN commands)
// Clock Modes command
pub const PCAN_UFD_CMD_CLK_SET: c_uint = 0x80;
pub const PCAN_UFD_CLK_80MHZ: c_uint = 0x0;
pub const PCAN_UFD_CLK_60MHZ: c_uint = 0x1;
pub const PCAN_UFD_CLK_40MHZ: c_uint = 0x2;
pub const PCAN_UFD_CLK_30MHZ: c_uint = 0x3;
pub const PCAN_UFD_CLK_24MHZ: c_uint = 0x4;
pub const PCAN_UFD_CLK_20MHZ: c_uint = 0x5;
...
// LED control command
pub const PCAN_UFD_CMD_LED_SET: c_uint = 0x86;
pub const PCAN_UFD_LED_DEV: c_uint = 0x00;
pub const PCAN_UFD_LED_FAST: c_uint = 0x01;
pub const PCAN_UFD_LED_SLOW: c_uint = 0x02;
pub const PCAN_UFD_LED_ON: c_uint = 0x03;
pub const PCAN_UFD_LED_OFF: c_uint = 0x04;
...
pub const PCAN_UFD_FLTEXT_CALIBRATION: c_uint = 0x8000;
...
pub const PCAN_UFD_MSG_CALIBRATION: c_uint = 0x100;
...
pub const PCAN_UFD_MSG_OVERRUN: c_uint = 0x101;
...
pub const PCAN_UFD_CMD_DEVID_SET: c_uint = 0x81;
...
#[no_mangle]
pub unsafe extern "C" fn pufd_omsg_get_channel(om: *mut pcan_ufd_ovr_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_fd_send_cmd(dev: *mut peak_usb_device, cmd_tail: *mut c_void) -> c_int {
...
// firmware is not able to re-assemble 512 bytes buffer in full-speed
    ...
    core::ptr::null_mut(), PCAN_UFD_CMD_TIMEOUT_MS);
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_fd_build_restart_cmd(dev: *mut peak_usb_device, buf: *mut u8) -> c_int {
...
// set CAN bus on/off
#[no_mangle]
unsafe extern "C" fn pcan_usb_fd_set_bus(dev: *mut peak_usb_device, onoff: u8) -> c_int {
...
// setup LED control
#[no_mangle]
unsafe extern "C" fn pcan_usb_fd_set_can_led(dev: *mut peak_usb_device, led_mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_fd_set_can_channel_id(dev: *mut peak_usb_device, can_ch_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_fd_drv_loaded(dev: *mut peak_usb_device, loaded: bool) -> c_int {
    ...
    struct sk_buff *skb;
    let mut rx_msg_flags: u16 = le16_to_cpu(rm.flags);
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_fd_rx_msg_min_size(rx_msg_type: u16) -> usize {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_fd_decode_buf(dev: *mut peak_usb_device, urb: *mut urb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_fd_start(dev: *mut peak_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_fd_probe(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_fd_stop(dev: *mut peak_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_fd_init(dev: *mut peak_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_fd_exit(dev: *mut peak_usb_device) {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_fd_free(dev: *mut peak_usb_device) {
