...
//! Source: drivers/net/can/usb/peak_usb/pcan_usb.c
#![no_std]
...
// PCAN-USB Endpoints
pub const PCAN_USB_EP_CMDOUT: c_int = 1;

pub const PCAN_USB_EP_MSGOUT: c_int = 2;

// PCAN-USB command struct
pub const PCAN_USB_CMD_FUNC: c_int = 0;
pub const PCAN_USB_CMD_NUM: c_int = 1;
pub const PCAN_USB_CMD_ARGS: c_int = 2;
pub const PCAN_USB_CMD_ARGS_LEN: c_int = 14;

    PCAN_USB_CMD_ARGS_LEN)
// PCAN-USB commands
pub const PCAN_USB_CMD_BITRATE: c_int = 1;
pub const PCAN_USB_CMD_SET_BUS: c_int = 3;
pub const PCAN_USB_CMD_DEVID: c_int = 4;
pub const PCAN_USB_CMD_SN: c_int = 6;
pub const PCAN_USB_CMD_REGISTER: c_int = 9;
pub const PCAN_USB_CMD_EXT_VCC: c_int = 10;
pub const PCAN_USB_CMD_ERR_FR: c_int = 11;
pub const PCAN_USB_CMD_LED: c_int = 12;
// PCAN_USB_CMD_SET_BUS number arg
pub const PCAN_USB_BUS_XCVER: c_int = 2;
pub const PCAN_USB_BUS_SILENT_MODE: c_int = 3;
// PCAN_USB_CMD_xxx functions
pub const PCAN_USB_GET: c_int = 1;
pub const PCAN_USB_SET: c_int = 2;
// PCAN-USB command timeout (ms.)
pub const PCAN_USB_COMMAND_TIMEOUT: c_int = 1000;
// PCAN-USB startup timeout (ms.)
pub const PCAN_USB_STARTUP_TIMEOUT: c_int = 10;
// PCAN-USB rx/tx buffers size
pub const PCAN_USB_RX_BUFFER_SIZE: c_int = 64;
pub const PCAN_USB_TX_BUFFER_SIZE: c_int = 64;
pub const PCAN_USB_MSG_HEADER_LEN: c_int = 2;

// PCAN-USB adapter internal clock (MHz)
pub const PCAN_USB_CRYSTAL_HZ: c_int = 16000000;
// PCAN-USB USB message record status/len field

// PCAN-USB 4.1 CAN Id tx extended flags
pub const PCAN_USB_TX_SRR: c_uint = 0x01	/* SJA1000 SRR command */;
pub const PCAN_USB_TX_AT: c_uint = 0x02	/* SJA1000 AT command */;
// PCAN-USB error flags
pub const PCAN_USB_ERROR_TXFULL: c_uint = 0x01;
pub const PCAN_USB_ERROR_RXQOVR: c_uint = 0x02;
pub const PCAN_USB_ERROR_BUS_LIGHT: c_uint = 0x04;
pub const PCAN_USB_ERROR_BUS_HEAVY: c_uint = 0x08;
pub const PCAN_USB_ERROR_BUS_OFF: c_uint = 0x10;
pub const PCAN_USB_ERROR_RXQEMPTY: c_uint = 0x20;
pub const PCAN_USB_ERROR_QOVR: c_uint = 0x40;
pub const PCAN_USB_ERROR_TXQFULL: c_uint = 0x80;

    PCAN_USB_ERROR_BUS_HEAVY | \
    PCAN_USB_ERROR_BUS_OFF)
// SJA1000 modes
pub const SJA1000_MODE_NORMAL: c_uint = 0x00;
pub const SJA1000_MODE_INIT: c_uint = 0x01;
//
// tick duration = 42.666 us =>
// (tick_number * 44739243) >> 20 ~ (tick_number * 42666) / 1000
// accuracy = 10^-7
//
pub const PCAN_USB_TS_DIV_SHIFTER: c_int = 20;
pub const PCAN_USB_TS_US_PER_TICK: c_int = 44739243;
// PCAN-USB messages record types
pub const PCAN_USB_REC_ERROR: c_int = 1;
pub const PCAN_USB_REC_ANALOG: c_int = 2;
pub const PCAN_USB_REC_BUSLOAD: c_int = 3;
pub const PCAN_USB_REC_TS: c_int = 4;
pub const PCAN_USB_REC_BUSEVT: c_int = 5;
// CAN bus events notifications selection mask
pub const PCAN_USB_ERR_RXERR: c_uint = 0x02	/* ask for rxerr counter */;
pub const PCAN_USB_ERR_TXERR: c_uint = 0x04	/* ask for txerr counter */;
...
pub const PCAN_USB_ERR_CNT_DEC: c_uint = 0x00	/* counters are decreasing */;
pub const PCAN_USB_ERR_CNT_INC: c_uint = 0x80	/* counters are increasing */;
// private to PCAN-USB adapter
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcan_usb {
    pub dev: peak_usb_device,
    pub time_ref: peak_time_ref,
    pub restart_timer: timer_list,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcan_usb_msg_context {
    pub ts16: u16,
    pub prev_ts8: u8,
    pub ptr: *mut u8,
    pub end: *mut u8,
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_send_cmd(dev: *mut peak_usb_device, f: u8, n: u8, p: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_wait_rsp(dev: *mut peak_usb_device, f: u8, n: u8, p: *mut u8) -> c_int {
...
// usb device unregistered?
    ...
    return 0;
// first, send command
    err = pcan_usb_send_cmd(dev, f, n, core::ptr::null_mut());
    if (err)
    return err;
    err = usb_bulk_msg(dev.udev,
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_set_sja1000(dev: *mut peak_usb_device, mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_set_bus(dev: *mut peak_usb_device, onoff: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_set_silent(dev: *mut peak_usb_device, onoff: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_set_err_frame(dev: *mut peak_usb_device, err_mask: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_set_ext_vcc(dev: *mut peak_usb_device, onoff: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_set_led(dev: *mut peak_usb_device, onoff: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_write_mode(dev: *mut peak_usb_device, onoff: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_restart(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_restart_pending(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_get_serial(dev: *mut peak_usb_device, serial_number: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_get_can_channel_id(dev: *mut peak_usb_device, can_ch_id: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_set_can_channel_id(dev: *mut peak_usb_device, can_ch_id: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_update_ts(mc: *mut pcan_usb_msg_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_decode_ts(mc: *mut pcan_usb_msg_context, first_packet: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_handle_bus_evt(mc: *mut pcan_usb_msg_context, ir: u8) -> c_int {
...
//
    ...
    u8 status_len)
    {
    let mut rec_len: u8 = status_len & PCAN_USB_STATUSLEN_DLC;
    u8 f, n;
    int err;
// check whether function and number can be read
    ...
    if (status_len & PCAN_USB_STATUSLEN_TIMESTAMP) {
    let mut err: c_int = pcan_usb_decode_ts(mc, !mc.rec_ts_idx);
    if (err)
    return err;
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_decode_data(mc: *mut pcan_usb_msg_context, status_len: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_decode_msg(dev: *mut peak_usb_device, ibuf: *mut u8, lbuf: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_decode_buf(dev: *mut peak_usb_device, urb: *mut urb) -> c_int {
...
//
    ...
    let mut can_id_flags: u32 = cf.can_id & CAN_ERR_MASK;
    u8 *pc;
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_start(dev: *mut peak_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_init(dev: *mut peak_usb_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcan_usb_probe(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcan_usb_get_eeprom_len(netdev: *mut net_device) -> c_int {
