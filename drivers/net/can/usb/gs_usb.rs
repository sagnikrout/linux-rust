...
//! Source: drivers/net/can/usb/gs_usb.c
#![no_std]
...
pub const USB_GS_USB_1_VENDOR_ID: c_uint = 0x1d50;
pub const USB_GS_USB_1_PRODUCT_ID: c_uint = 0x606f;
pub const USB_CANDLELIGHT_VENDOR_ID: c_uint = 0x1209;
pub const USB_CANDLELIGHT_PRODUCT_ID: c_uint = 0x2323;
pub const USB_CES_CANEXT_FD_VENDOR_ID: c_uint = 0x1cd2;
pub const USB_CES_CANEXT_FD_PRODUCT_ID: c_uint = 0x606f;
pub const USB_ABE_CANDEBUGGER_FD_VENDOR_ID: c_uint = 0x16d0;
pub const USB_ABE_CANDEBUGGER_FD_PRODUCT_ID: c_uint = 0x10b8;
pub const USB_XYLANTA_SAINT3_VENDOR_ID: c_uint = 0x16d0;
pub const USB_XYLANTA_SAINT3_PRODUCT_ID: c_uint = 0x0f30;
pub const USB_CANNECTIVITY_VENDOR_ID: c_uint = 0x1209;
pub const USB_CANNECTIVITY_PRODUCT_ID: c_uint = 0xca01;
// Timestamp 32 bit timer runs at 1 MHz (1 µs tick). Worker accounts
// for timer overflow (will be after ~71 minutes)
//

pub const GS_USB_TIMESTAMP_WORK_DELAY_SEC: c_int = 1800;
...
pub const GS_USB_TERMINATION_ENABLED: c_int = 120;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gs_host_config {
    pub byte_order: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gs_device_config {
    pub reserved1: u8,
    pub reserved2: u8,
    pub reserved3: u8,
    pub icount: u8,
    ...
    pub __packed: },
pub const GS_CAN_MODE_NORMAL: c_int = 0;
...
pub struct gs_device_bittiming {
    pub prop_seg: __le32,
    pub phase_seg1: __le32,
    pub phase_seg2: __le32,
    pub sjw: __le32,
    pub brp: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gs_identify_mode {
    pub mode: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gs_device_termination_state {
    pub state: __le32,
    pub __packed: },
...
pub struct gs_device_bt_const {
    pub feature: __le32,
    pub fclk_can: __le32,
    pub tseg1_min: __le32,
    pub tseg1_max: __le32,
    pub tseg2_min: __le32,
    pub tseg2_max: __le32,
    pub sjw_max: __le32,
    pub brp_min: __le32,
    pub brp_max: __le32,
    pub brp_inc: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gs_device_bt_const_extended {
    pub feature: __le32,
    pub fclk_can: __le32,
    pub tseg1_min: __le32,
    pub tseg1_max: __le32,
    ...
    pub brp_max: __le32,
    pub brp_inc: __le32,
    pub dtseg1_min: __le32,
    pub dtseg1_max: __le32,
    pub dtseg2_min: __le32,
    pub dtseg2_max: __le32,
    pub dsjw_max: __le32,
    pub dbrp_min: __le32,
    pub dbrp_max: __le32,
    pub dbrp_inc: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct classic_can {
    pub data: [u8; 8],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct classic_can_ts {
    pub data: [u8; 8],
    pub timestamp_us: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct classic_can_quirk {
    pub data: [u8; 8],
    pub quirk: u8,
    pub __packed: },
#[repr(C)]
...
//
pub const GS_HOST_FRAME_ECHO_ID_RX: c_uint = 0xffffffff;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gs_host_frame {
    ...
    pub reserved: u8,
    union {
    pub classic_can): DECLARE_FLEX_ARRAY(struct classic_can,,
    pub classic_can_ts): DECLARE_FLEX_ARRAY(struct classic_can_ts,,
    pub classic_can_quirk): DECLARE_FLEX_ARRAY(struct classic_can_quirk,,
    pub canfd): DECLARE_FLEX_ARRAY(struct canfd,,
    pub canfd_ts): DECLARE_FLEX_ARRAY(struct canfd_ts,,
    pub canfd_quirk): DECLARE_FLEX_ARRAY(struct canfd_quirk,,
}
...
pub const GS_MAX_TX_URBS: c_int = 10;
// Only launch a max of GS_MAX_RX_URBS usb requests at a time.
pub const GS_MAX_RX_URBS: c_int = 30;
pub const GS_NAPI_WEIGHT: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gs_tx_context {
    pub dev: *mut gs_can,
    pub echo_id: c_uint,
}
...
pub struct gs_can {
    ...
    pub parent: *mut gs_usb,
    pub netdev: *mut net_device,
    pub udev: *mut usb_device,
    pub data_bt_const: can_bittiming_bt_const,,
    pub /: *mut *mut unsigned int channel; / channel number,
    pub feature: u32,
    pub hf_size_tx: c_uint,
// This lock prevents a race condition between xmit and receive.
    pub tx_ctx_lock: spinlock_t,
    pub tx_context: [gs_tx_context; GS_MAX_TX_URBS],
...
// time counter for hardware timestamps
    pub cc: cyclecounter,
    pub tc: timecounter,
    pub /: *mut *mut spinlock_t tc_lock; / spinlock to guard access tc->cycle_last,
    pub timestamp: delayed_work,
    pub hf_size_rx: c_uint,
    pub active_channels: u8,
    pub channel_cnt: u8,
    pub pipe_in: c_uint,
    pub pipe_out: c_uint,
    pub __counted_by(channel_cnt): *mut *mut gs_can canch[],
}
...
//
#[no_mangle]
unsafe extern "C" fn gs_free_tx_context(txc: *mut gs_tx_context) {
...
#[no_mangle]
unsafe extern "C" fn gs_cmd_reset(dev: *mut gs_can) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gs_usb_timestamp_read(__must_hold(&dev->tc_lock: *mut *mut cyclecounter cc)) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn gs_usb_timestamp_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn gs_usb_timestamp_init(parent: *mut gs_usb) {
...
#[no_mangle]
unsafe extern "C" fn gs_usb_timestamp_stop(parent: *mut gs_usb) {
    static void gs_usb_timestamp_stop(struct gs_usb *parent)
    {
    cancel_delayed_work_sync(&parent.timestamp);
    }
#[no_mangle]
unsafe extern "C" fn gs_update_state(dev: *mut gs_can, cf: *mut can_frame) {
    ...
    let mut ts: u32 = gs_usb_set_timestamp(dev, skb, hf);
    ...
    {
    struct can_rx_offload *offload = &dev.offload;
    let mut echo_id: u32 = hf.echo_id;
    unsigned int len;
    if (dev.feature & GS_CAN_FEATURE_HW_TIMESTAMP) {
    let mut ts: u32 = gs_usb_set_timestamp(dev, skb, hf);
...
#[no_mangle]
unsafe extern "C" fn gs_usb_receive_bulk_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn gs_usb_set_bittiming(dev: *mut gs_can) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gs_usb_set_data_bittiming(dev: *mut gs_can) -> c_int {
    ...
    let mut request: u8 = GS_USB_BREQ_DATA_BITTIMING;
...
#[no_mangle]
unsafe extern "C" fn gs_usb_xmit_callback(urb: *mut urb) {
    ...
    can_free_echo_skb(netdev, txc.echo_id, core::ptr::null_mut());
    gs_free_tx_context(txc);
    atomic_dec(&dev.active_tx_urbs);
    netif_wake_queue(netdev);
    }
...
// create a URB, and a buffer for it
    ...
    atomic_dec(&dev.active_tx_urbs);
    can_free_echo_skb(netdev, idx, core::ptr::null_mut());
    gs_free_tx_context(txc);
    usb_unanchor_urb(urb);
    if (rc == -ENODEV) {
...
#[no_mangle]
unsafe extern "C" fn gs_can_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gs_can_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gs_usb_set_identify(netdev: *mut net_device, do_identify: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gs_usb_get_termination(netdev: *mut net_device, term: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gs_usb_set_termination(netdev: *mut net_device, term: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gs_destroy_candev(dev: *mut gs_can) {
    ...
    &ep_in, &ep_out, core::ptr::null_mut(), core::ptr::null_mut());
    if (rc) {
...
#[no_mangle]
unsafe extern "C" fn gs_usb_disconnect(intf: *mut usb_interface) {
