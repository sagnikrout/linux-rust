...
//! Source: drivers/net/can/usb/nct6694_canfd.c
#![no_std]
...
//
pub const NCT6694_CANFD_MOD: c_uint = 0x05;
// Command 00h - CAN Setting and Initialization
pub const NCT6694_CANFD_SETTING: c_uint = 0x00;

// Command 01h - CAN Information
pub const NCT6694_CANFD_INFORMATION: c_uint = 0x01;
pub const NCT6694_CANFD_INFORMATION_SEL: c_uint = 0x00;
// Command 02h - CAN Event
pub const NCT6694_CANFD_EVENT: c_uint = 0x02;

    ((idx ? 0x80 : 0x00) | ((mask) & 0x7F))

// Command 10h - CAN Deliver
pub const NCT6694_CANFD_DELIVER: c_uint = 0x10;

    ((buf_cnt) & 0xFF)
// Command 11h - CAN Receive
pub const NCT6694_CANFD_RECEIVE: c_uint = 0x11;

    ((idx ? 0x80 : 0x00) | ((buf_cnt) & 0x7F))

pub const NCT6694_NAPI_WEIGHT: c_int = 32;
...
pub struct nct6694_canfd_priv {
    ...
    pub tx: nct6694_canfd_frame,
    pub rx: nct6694_canfd_frame,
    pub event: [nct6694_canfd_event; 2],
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_handle_lost_msg(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_handle_rx(ndev: *mut net_device, rx_evt: u8) {
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_handle_state_change(ndev: *mut net_device, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_handle_bus_err(ndev: *mut net_device, bus_err: u8) {
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_handle_tx(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_tx_work(work: *mut work_struct) {
    ...
    if (err) {
    can_free_echo_skb(ndev, 0, core::ptr::null_mut());
    stats.tx_dropped++;
    stats.tx_errors++;
    netif_wake_queue(ndev);
    }
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_start(ndev: *mut net_device) -> c_int {
    static int nct6694_canfd_start(struct net_device *ndev)
    {
    struct nct6694_canfd_priv *priv = netdev_priv(ndev);
    const struct can_bittiming *n_bt = &priv.can.bittiming;
    const struct can_bittiming *d_bt = &priv.can.fd.data_bittiming;
    struct nct6694_canfd_setting *setting __free(kfree) = core::ptr::null_mut();
    const struct nct6694_cmd_header cmd_hd = {
    .mod = NCT6694_CANFD_MOD,
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_stop(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_close(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_set_mode(ndev: *mut net_device, mode: enum can_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_open(ndev: *mut net_device) -> c_int {
    ...
    ret = request_threaded_irq(ndev.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_get_clock(priv: *mut nct6694_canfd_priv) -> c_int {
    static int nct6694_canfd_get_clock(struct nct6694_canfd_priv *priv)
    {
    struct nct6694_canfd_information *info __free(kfree) = core::ptr::null_mut();
    static const struct nct6694_cmd_header cmd_hd = {
    .mod = NCT6694_CANFD_MOD,
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6694_canfd_remove(pdev: *mut platform_device) {
    ...
    struct net_device *ndev = priv.ndev;
    let mut port: c_int = ndev.dev_port;
    let mut irq: c_int = ndev.irq;
