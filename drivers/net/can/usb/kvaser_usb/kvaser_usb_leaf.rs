...
//! Source: drivers/net/can/usb/kvaser_usb/kvaser_usb_leaf.c
#![no_std]
...
pub const MAX_USBCAN_NET_DEVICES: c_int = 2;
// Command header size
pub const CMD_HEADER_LEN: c_int = 2;
// Kvaser CAN message flags

// CAN states (M16C CxSTRH register)

// Leaf/usbcan command ids
pub const CMD_RX_STD_MESSAGE: c_int = 12;
pub const CMD_TX_STD_MESSAGE: c_int = 13;
pub const CMD_RX_EXT_MESSAGE: c_int = 14;
pub const CMD_TX_EXT_MESSAGE: c_int = 15;
pub const CMD_SET_BUS_PARAMS: c_int = 16;
pub const CMD_GET_BUS_PARAMS: c_int = 17;
pub const CMD_GET_BUS_PARAMS_REPLY: c_int = 18;
pub const CMD_GET_CHIP_STATE: c_int = 19;
pub const CMD_CHIP_STATE_EVENT: c_int = 20;
pub const CMD_SET_CTRL_MODE: c_int = 21;
pub const CMD_RESET_CHIP: c_int = 24;
pub const CMD_START_CHIP: c_int = 26;
pub const CMD_START_CHIP_REPLY: c_int = 27;
pub const CMD_STOP_CHIP: c_int = 28;
pub const CMD_STOP_CHIP_REPLY: c_int = 29;
pub const CMD_USBCAN_CLOCK_OVERFLOW_EVENT: c_int = 33;
pub const CMD_GET_CARD_INFO: c_int = 34;
pub const CMD_GET_CARD_INFO_REPLY: c_int = 35;
pub const CMD_GET_SOFTWARE_INFO: c_int = 38;
pub const CMD_GET_SOFTWARE_INFO_REPLY: c_int = 39;
pub const CMD_ERROR_EVENT: c_int = 45;
pub const CMD_FLUSH_QUEUE: c_int = 48;
pub const CMD_TX_ACKNOWLEDGE: c_int = 50;
pub const CMD_CAN_ERROR_EVENT: c_int = 51;
pub const CMD_FLUSH_QUEUE_REPLY: c_int = 68;
...
pub const CMD_LEAF_LOG_MESSAGE: c_int = 106;
// Leaf frequency options
pub const KVASER_USB_LEAF_SWOPTION_FREQ_MASK: c_uint = 0x60;
pub const KVASER_USB_LEAF_SWOPTION_FREQ_16_MHZ_CLK: c_int = 0;
...
//
pub const USBCAN_ERROR_STATE_NONE: c_int = 0;

// ctrl modes
pub const KVASER_CTRL_MODE_NORMAL: c_int = 1;
pub const KVASER_CTRL_MODE_SILENT: c_int = 2;
pub const KVASER_CTRL_MODE_SELFRECEPTION: c_int = 3;
pub const KVASER_CTRL_MODE_OFF: c_int = 4;
// Extended CAN identifier flag

// USBCanII timestamp

pub const KVASER_USB_USBCAN_TIMESTAMP_FACTOR: c_int = 10;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvaser_cmd_simple {
    pub tid: u8,
    pub channel: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvaser_cmd_cardinfo {
    pub tid: u8,
    pub nchannels: u8,
    pub serial_number: __le32,
    pub padding0: __le32,
    pub clock_resolution: __le32,
    pub mfgdate: __le32,
    pub ean: [__le32; 2],
    pub hw_revision: u8,
    union {
    ...
    struct {
    pub padding: u8,
    pub usbcan1: } __packed,
    pub __packed: },
    pub padding1: __le16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct leaf_cmd_softinfo {
    pub tid: u8,
    pub padding0: u8,
    pub sw_options: __le32,
    pub fw_version: __le32,
    pub max_outstanding_tx: __le16,
    pub padding1: [__le16; 9],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usbcan_cmd_softinfo {
    pub tid: u8,
    pub fw_name: [u8; 5],
    pub max_outstanding_tx: __le16,
    pub padding: [u8; 6],
    pub fw_version: __le32,
    pub checksum: __le16,
    pub sw_options: __le16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvaser_cmd_busparams {
    pub tid: u8,
    pub channel: u8,
...
pub const KVASER_USB_LEAF_LED_YELLOW_CH0_IDX: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvaser_cmd_rx_can_header {
    pub channel: u8,
    pub flag: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct leaf_cmd_rx_can {
    pub channel: u8,
    pub flag: u8,
    pub time: [__le16; 3],
    pub data: [u8; 14],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct leaf_cmd_chip_state_event {
    pub tid: u8,
    pub channel: u8,
    pub time: [__le16; 3],
    pub tx_errors_count: u8,
    pub rx_errors_count: u8,
    pub status: u8,
    pub padding: [u8; 3],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usbcan_cmd_chip_state_event {
    pub tid: u8,
    pub channel: u8,
    pub tx_errors_count: u8,
    pub rx_errors_count: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvaser_cmd_tx_acknowledge_header {
    pub channel: u8,
    pub tid: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct leaf_cmd_tx_acknowledge {
    pub channel: u8,
    pub tid: u8,
    pub time: [__le16; 3],
    pub padding: [u8; 2],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usbcan_cmd_tx_acknowledge {
    pub channel: u8,
    pub tid: u8,
    pub time: __le16,
    pub padding: [u8; 2],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct leaf_cmd_can_error_event {
    pub tid: u8,
    pub flags: u8,
    pub time: [__le16; 3],
    pub channel: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usbcan_cmd_can_error_event {
    pub tid: u8,
    pub padding: u8,
    pub tx_errors_count_ch0: u8,
    pub rx_errors_count_ch0: u8,
    pub tx_errors_count_ch1: u8,
    pub rx_errors_count_ch1: u8,
    pub status_ch0: u8,
    pub status_ch1: u8,
    pub time: __le16,
    pub __packed: },
// CMD_ERROR_EVENT error codes
pub const KVASER_USB_LEAF_ERROR_EVENT_TX_QUEUE_FULL: c_uint = 0x8;
pub const KVASER_USB_LEAF_ERROR_EVENT_PARAM: c_uint = 0x9;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct leaf_cmd_error_event {
    pub tid: u8,
    pub error_code: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usbcan_cmd_error_event {
    pub tid: u8,
    pub error_code: u8,
    pub info1: __le16,
    pub info2: __le16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usbcan_cmd_clk_overflow_event {
    pub tid: u8,
    pub padding: u8,
    pub time: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvaser_cmd_ctrl_mode {
    pub tid: u8,
    pub channel: u8,
    pub ctrl_mode: u8,
    pub padding: [u8; 3],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvaser_cmd_flush_queue {
    pub tid: u8,
    pub channel: u8,
    pub flags: u8,
    pub padding: [u8; 3],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct leaf_cmd_log_message {
    pub channel: u8,
    pub flags: u8,
    pub time: [__le16; 3],
    pub dlc: u8,
...
pub const KVASER_USB_LEAF_CAP_CMD_LISTEN_MODE: c_uint = 0x02;
pub const KVASER_USB_LEAF_CAP_CMD_ERR_REPORT: c_uint = 0x05;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub const KVASER_USB_LEAF_CAP_STAT_OK: c_uint = 0x00;
pub const KVASER_USB_LEAF_CAP_STAT_NOT_IMPL: c_uint = 0x01;
pub const KVASER_USB_LEAF_CAP_STAT_UNAVAIL: c_uint = 0x02;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct kvaser_cmd {
    ...
    pub id: u8,
    union	{
    pub simple: kvaser_cmd_simple,
    pub cardinfo: kvaser_cmd_cardinfo,
    pub busparams: kvaser_cmd_busparams,
    pub led_action_req: kvaser_cmd_led_action_req,
    pub rx_can_header: kvaser_cmd_rx_can_header,
    pub tx_acknowledge_header: kvaser_cmd_tx_acknowledge_header,
    union {
    pub softinfo: leaf_cmd_softinfo,
    pub rx_can: leaf_cmd_rx_can,
    pub chip_state_event: leaf_cmd_chip_state_event,
    pub can_error_event: leaf_cmd_can_error_event,
    pub log_message: leaf_cmd_log_message,
    pub error_event: leaf_cmd_error_event,
    pub cap_req: kvaser_cmd_cap_req,
    pub cap_res: kvaser_cmd_cap_res,
    pub tx_ack: leaf_cmd_tx_acknowledge,
    pub leaf: } __packed,
    union {
    pub softinfo: usbcan_cmd_softinfo,
    pub rx_can: usbcan_cmd_rx_can,
    pub chip_state_event: usbcan_cmd_chip_state_event,
    pub can_error_event: usbcan_cmd_can_error_event,
    pub error_event: usbcan_cmd_error_event,
    pub tx_ack: usbcan_cmd_tx_acknowledge,
    pub clk_overflow_event: usbcan_cmd_clk_overflow_event,
    pub usbcan: } __packed,
    pub tx_can: kvaser_cmd_tx_can,
    pub ctrl_mode: kvaser_cmd_ctrl_mode,
    pub flush_queue: kvaser_cmd_flush_queue,
    pub u: },
    pub __packed: },
pub const CMD_SIZE_ANY: c_uint = 0xff;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvaser_usb_err_summary {
    pub rxerr: u8 channel, status, txerr,,
    union {
    struct {
    pub error_factor: u8,
    pub leaf: },
    struct {
    pub other_ch_status: u8,
    pub error_state: u8,
    pub usbcan: },
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvaser_usb_net_leaf_priv {
    pub net: *mut kvaser_usb_net_priv,
    pub chip_state_req_work: delayed_work,
// started but not reported as bus-on yet
    pub joining_bus: bool,
}
...
// buffer size >= cmd->len ensured by caller
    ...
    u8 *cmd_tx_can_flags = core::ptr::null_mut();		/* GCC */
...
// cmd_tx_can_flags |= MSG_FLAG_REMOTE_FRAME;
    ...
    int err;
    int pos;
    let mut to: c_ulong = jiffies + msecs_to_jiffies(KVASER_USB_TIMEOUT);
...
//
    ...
    {
    u32 fw_version;
    let mut sw_options: u32 = le32_to_cpu(softinfo.sw_options);
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_get_software_info_inner(dev: *mut kvaser_usb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_get_software_info(dev: *mut kvaser_usb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_get_card_info(dev: *mut kvaser_usb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_get_capabilities_leaf(dev: *mut kvaser_usb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_get_capabilities(dev: *mut kvaser_usb) -> c_int {
...
// Sometimes the state change doesn't come after a bus-off event
    ...
    context.echo_index, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_chip_state_req_work(work: *mut work_struct) {
...
//
    ...
    const struct kvaser_cmd *cmd)
    {
    let mut es: kvaser_usb_err_summary = { };
    switch (cmd.id) {
...
//
    ...
    struct sk_buff *skb;
    struct net_device_stats *stats;
    let mut channel: u8 = cmd.u.rx_can_header.channel;
    const u8 *rx_data = core::ptr::null_mut();	/* GCC */
    let mut hwtstamp: ktime_t = 0;
    if (channel >= dev.nchannels) {
    dev_err(&dev.intf.dev,
    "Invalid channel number (%d)\n", channel);
...
//
    ...
    {
    struct kvaser_usb_net_priv *priv;
    let mut channel: u8 = cmd.u.simple.channel;
    if (channel >= dev.nchannels) {
    dev_err(&dev.intf.dev,
    "Invalid channel number (%d)\n", channel);
    return;
    ...
    {
    struct kvaser_usb_net_priv *priv;
    let mut channel: u8 = cmd.u.busparams.channel;
    if (channel >= dev.nchannels) {
    dev_err(&dev.intf.dev,
    "Invalid channel number (%d)\n", channel);
    return;
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_set_opt_mode(priv: *const kvaser_usb_net_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_start_chip(priv: *mut kvaser_usb_net_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_stop_chip(priv: *mut kvaser_usb_net_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_reset_chip(dev: *mut kvaser_usb, channel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_flush_queue(priv: *mut kvaser_usb_net_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_init_card(dev: *mut kvaser_usb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_init_channel(priv: *mut kvaser_usb_net_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_remove_channel(priv: *mut kvaser_usb_net_priv) {
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_get_busparams(priv: *mut kvaser_usb_net_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvaser_usb_leaf_setup_endpoints(dev: *mut kvaser_usb) -> c_int {
...
// use first bulk endpoint for in and out
    ...
    .dev_set_data_bittiming = core::ptr::null_mut(),
    .dev_get_data_busparams = core::ptr::null_mut(),
    ...
    .dev_get_software_details = core::ptr::null_mut(),
