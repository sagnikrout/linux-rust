...
//! Source: drivers/net/can/usb/usb_8dev.c
#![no_std]
...
// driver constants
pub const MAX_RX_URBS: c_int = 20;
pub const MAX_TX_URBS: c_int = 20;
pub const RX_BUFFER_SIZE: c_int = 64;
// vendor and product id
pub const USB_8DEV_VENDOR_ID: c_uint = 0x0483;
pub const USB_8DEV_PRODUCT_ID: c_uint = 0x1234;
// endpoints
...
// device CAN clock
pub const USB_8DEV_ABP_CLOCK: c_int = 32000000;
// setup flags
pub const USB_8DEV_SILENT: c_uint = 0x01;
pub const USB_8DEV_LOOPBACK: c_uint = 0x02;
pub const USB_8DEV_DISABLE_AUTO_RESTRANS: c_uint = 0x04;
pub const USB_8DEV_STATUS_FRAME: c_uint = 0x08;
// commands
    enum usb_8dev_cmd {
    USB_8DEV_RESET = 1,
    USB_8DEV_OPEN,
...
// command options
pub const USB_8DEV_BAUD_MANUAL: c_uint = 0x09;
pub const USB_8DEV_CMD_START: c_uint = 0x11;
pub const USB_8DEV_CMD_END: c_uint = 0x22;
pub const USB_8DEV_CMD_SUCCESS: c_int = 0;
pub const USB_8DEV_CMD_ERROR: c_int = 255;
pub const USB_8DEV_CMD_TIMEOUT: c_int = 1000;
// frames
pub const USB_8DEV_DATA_START: c_uint = 0x55;
pub const USB_8DEV_DATA_END: c_uint = 0xAA;
pub const USB_8DEV_TYPE_CAN_FRAME: c_int = 0;
pub const USB_8DEV_TYPE_ERROR_FRAME: c_int = 3;
pub const USB_8DEV_EXTID: c_uint = 0x01;
pub const USB_8DEV_RTR: c_uint = 0x02;
pub const USB_8DEV_ERR_FLAG: c_uint = 0x04;
// status
pub const USB_8DEV_STATUSMSG_OK: c_uint = 0x00  /* Normal condition. */;
pub const USB_8DEV_STATUSMSG_OVERRUN: c_uint = 0x01  /* Overrun occurred when sending */;
pub const USB_8DEV_STATUSMSG_BUSLIGHT: c_uint = 0x02  /* Error counter has reached 96 */;
pub const USB_8DEV_STATUSMSG_BUSHEAVY: c_uint = 0x03  /* Error count. has reached 128 */;
pub const USB_8DEV_STATUSMSG_BUSOFF: c_uint = 0x04  /* Device is in BUSOFF */;
pub const USB_8DEV_STATUSMSG_STUFF: c_uint = 0x20  /* Stuff Error */;
pub const USB_8DEV_STATUSMSG_FORM: c_uint = 0x21  /* Form Error */;
pub const USB_8DEV_STATUSMSG_ACK: c_uint = 0x23  /* Ack Error */;
pub const USB_8DEV_STATUSMSG_BIT0: c_uint = 0x24  /* Bit1 Error */;
pub const USB_8DEV_STATUSMSG_BIT1: c_uint = 0x25  /* Bit0 Error */;
pub const USB_8DEV_STATUSMSG_CRC: c_uint = 0x27  /* CRC Error */;
pub const USB_8DEV_RP_MASK: c_uint = 0x7F  /* Mask for Receive Error Bit */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usb_8dev_tx_urb_context {
    pub priv: *mut usb_8dev_priv,
    pub echo_index: u32,
}
...
pub struct usb_8dev_priv {
    ...
    pub tx_contexts: [usb_8dev_tx_urb_context; MAX_TX_URBS],
    pub rx_submitted: usb_anchor,
    pub bec: can_berr_counter,
    pub cmd_msg_buffer: *mut u8,
    pub usb_8dev_cmd_lock: mutex,
...
#[no_mangle]
unsafe extern "C" fn usb_8dev_send_cmd_msg(priv: *mut usb_8dev_priv, msg: *mut u8, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_8dev_cmd_open(priv: *mut usb_8dev_priv) -> c_int {
    static int usb_8dev_cmd_open(struct usb_8dev_priv *priv)
    {
    struct can_bittiming *bt = &priv.can.bittiming;
    struct usb_8dev_cmd_msg outmsg;
    struct usb_8dev_cmd_msg inmsg;
    let mut ctrlmode: u32 = priv.can.ctrlmode;
    let mut flags: u32 = USB_8DEV_STATUS_FRAME;
    __be32 beflags;
    __be16 bebrp;
...
#[no_mangle]
unsafe extern "C" fn usb_8dev_cmd_close(priv: *mut usb_8dev_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_8dev_cmd_version(priv: *mut usb_8dev_priv, res: *mut u32) -> c_int {
    ...
    let mut err: c_int = usb_8dev_send_cmd(priv, &outmsg, &inmsg);
    if (err)
    return err;
...
//
#[no_mangle]
unsafe extern "C" fn usb_8dev_set_mode(netdev: *mut net_device, mode: enum can_mode) -> c_int {
...
//
    let mut state: u8 = msg.data[0];
    let mut rxerr: u8 = msg.data[1] & USB_8DEV_RP_MASK;
    let mut txerr: u8 = msg.data[2];
    let mut rx_errors: c_int = 0;
    let mut tx_errors: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn usb_8dev_read_bulk_callback(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn usb_8dev_write_bulk_callback(urb: *mut urb) {
...
// free up our allocated buffer
    ...
    netdev.stats.tx_bytes += can_get_echo_skb(netdev, context.echo_index, core::ptr::null_mut());
// Release context
...
// Send data to device
    ...
    struct urb *urb;
    struct usb_8dev_tx_urb_context *context = core::ptr::null_mut();
    u8 *buf;
    int i, err;
    let mut size: usize = sizeof(struct usb_8dev_tx_msg);
...
// Start USB device
#[no_mangle]
unsafe extern "C" fn usb_8dev_start(priv: *mut usb_8dev_priv) -> c_int {
...
// Open USB device
#[no_mangle]
unsafe extern "C" fn usb_8dev_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unlink_all_urbs(priv: *mut usb_8dev_priv) {
...
// Close USB device
#[no_mangle]
unsafe extern "C" fn usb_8dev_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_8dev_disconnect(intf: *mut usb_interface) {
