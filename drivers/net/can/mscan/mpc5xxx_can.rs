...
//! Source: drivers/net/can/mscan/mpc5xxx_can.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpc5xxx_can_data {
    pub type: c_uint,
    u32 (*get_clock)(struct platform_device *ofdev, const char *clock_name,
    pub mscan_clksrc): *mut c_int,
    pub ofdev): *mut *mut void (put_clock)(struct platform_device,
}
...
// Determine SYS_XTAL_IN frequency from the clock domain settings
    np_cdm = of_find_matching_node(core::ptr::null_mut(), mpc52xx_cdm_ids);
    if (!np_cdm) {
...
//
    ...
    clock_source ? clock_source : "<core::ptr::null_mut()>", clockdiv);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(clock_source, _arg: "sys")) -> else {
    else if (!strcmp(clock_source, "sys"))
    clk_from = CLK_FROM_SYS;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(clock_source, _arg: "ref")) -> else {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_can_put_clock(ofdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mpc5xxx_can_probe(ofdev: *mut platform_device) -> c_int {
    ...
    struct mscan_priv *priv;
    void __iomem *base;
    const char *clock_name = core::ptr::null_mut();
    ...
    priv.reg_base = base;
    dev.irq = irq;
    clock_name = of_get_property(np, "fsl,mscan-clock-source", core::ptr::null_mut());
    priv.type = data.type;
...
#[no_mangle]
unsafe extern "C" fn mpc5xxx_can_remove(ofdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mpc5xxx_can_suspend(ofdev: *mut platform_device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpc5xxx_can_resume(ofdev: *mut platform_device) -> c_int {
