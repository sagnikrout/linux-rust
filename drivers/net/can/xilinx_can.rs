...
//! Source: drivers/net/can/xilinx_can.c
#![no_std]
...
pub const XCAN_CANFD_FRAME_SIZE: c_uint = 0x48;
...
pub const XCAN_TX_MAILBOX_IDX: c_int = 0;
// CAN register bit masks - XCAN_<REG>_<BIT>_MASK
pub const XCAN_SRR_CEN_MASK: c_uint = 0x00000002 /* CAN enable */;
pub const XCAN_SRR_RESET_MASK: c_uint = 0x00000001 /* Soft Reset the CAN core */;
pub const XCAN_MSR_LBACK_MASK: c_uint = 0x00000002 /* Loop back mode select */;
pub const XCAN_MSR_SLEEP_MASK: c_uint = 0x00000001 /* Sleep mode select */;
pub const XCAN_BRPR_BRP_MASK: c_uint = 0x000000FF /* Baud rate prescaler */;

pub const XCAN_BTR_SJW_MASK: c_uint = 0x00000180 /* Synchronous jump width */;
pub const XCAN_BTR_TS2_MASK: c_uint = 0x00000070 /* Time segment 2 */;
pub const XCAN_BTR_TS1_MASK: c_uint = 0x0000000F /* Time segment 1 */;
pub const XCAN_BTR_SJW_MASK_CANFD: c_uint = 0x000F0000 /* Synchronous jump width */;
pub const XCAN_BTR_TS2_MASK_CANFD: c_uint = 0x00000F00 /* Time segment 2 */;
pub const XCAN_BTR_TS1_MASK_CANFD: c_uint = 0x0000003F /* Time segment 1 */;
pub const XCAN_ECR_REC_MASK: c_uint = 0x0000FF00 /* Receive error counter */;
pub const XCAN_ECR_TEC_MASK: c_uint = 0x000000FF /* Transmit error counter */;
pub const XCAN_ESR_ACKER_MASK: c_uint = 0x00000010 /* ACK error */;
pub const XCAN_ESR_BERR_MASK: c_uint = 0x00000008 /* Bit error */;
pub const XCAN_ESR_STER_MASK: c_uint = 0x00000004 /* Stuff error */;
pub const XCAN_ESR_FMER_MASK: c_uint = 0x00000002 /* Form error */;
pub const XCAN_ESR_CRCER_MASK: c_uint = 0x00000001 /* CRC error */;

pub const XCAN_SR_TXFLL_MASK: c_uint = 0x00000400 /* TX FIFO is full */;
pub const XCAN_SR_ESTAT_MASK: c_uint = 0x00000180 /* Error status */;
pub const XCAN_SR_ERRWRN_MASK: c_uint = 0x00000040 /* Error warning */;
pub const XCAN_SR_NORMAL_MASK: c_uint = 0x00000008 /* Normal mode */;
pub const XCAN_SR_LBACK_MASK: c_uint = 0x00000002 /* Loop back mode */;
pub const XCAN_SR_CONFIG_MASK: c_uint = 0x00000001 /* Configuration mode */;
pub const XCAN_IXR_RXMNF_MASK: c_uint = 0x00020000 /* RX match not finished */;
pub const XCAN_IXR_TXFEMP_MASK: c_uint = 0x00004000 /* TX FIFO Empty */;
pub const XCAN_IXR_WKUP_MASK: c_uint = 0x00000800 /* Wake up interrupt */;
pub const XCAN_IXR_SLP_MASK: c_uint = 0x00000400 /* Sleep interrupt */;
pub const XCAN_IXR_BSOFF_MASK: c_uint = 0x00000200 /* Bus off interrupt */;
pub const XCAN_IXR_ERROR_MASK: c_uint = 0x00000100 /* Error interrupt */;
pub const XCAN_IXR_RXNEMP_MASK: c_uint = 0x00000080 /* RX FIFO NotEmpty intr */;
pub const XCAN_IXR_RXOFLW_MASK: c_uint = 0x00000040 /* RX FIFO Overflow intr */;
pub const XCAN_IXR_RXOK_MASK: c_uint = 0x00000010 /* Message received intr */;
pub const XCAN_IXR_TXFLL_MASK: c_uint = 0x00000004 /* Tx FIFO Full intr */;
pub const XCAN_IXR_TXOK_MASK: c_uint = 0x00000002 /* TX successful intr */;
pub const XCAN_IXR_ARBLST_MASK: c_uint = 0x00000001 /* Arbitration lost intr */;
...
pub const XCAN_IDR_ID1_MASK: c_uint = 0xFFE00000 /* Standard msg identifier */;
pub const XCAN_IDR_SRR_MASK: c_uint = 0x00100000 /* Substitute remote TXreq */;
pub const XCAN_IDR_IDE_MASK: c_uint = 0x00080000 /* Identifier extension */;
pub const XCAN_IDR_ID2_MASK: c_uint = 0x0007FFFE /* Extended message ident */;
pub const XCAN_IDR_RTR_MASK: c_uint = 0x00000001 /* Remote TX request */;
pub const XCAN_DLCR_DLC_MASK: c_uint = 0xF0000000 /* Data length code */;
pub const XCAN_FSR_FL_MASK: c_uint = 0x00003F00 /* RX Fill Level */;
pub const XCAN_2_FSR_FL_MASK: c_uint = 0x00007F00 /* RX Fill Level */;
pub const XCAN_FSR_IRI_MASK: c_uint = 0x00000080 /* RX Increment Read Index */;
pub const XCAN_FSR_RI_MASK: c_uint = 0x0000001F /* RX Read Index */;
pub const XCAN_2_FSR_RI_MASK: c_uint = 0x0000003F /* RX Read Index */;
pub const XCAN_DLCR_EDL_MASK: c_uint = 0x08000000 /* EDL Mask in DLC */;
pub const XCAN_DLCR_BRS_MASK: c_uint = 0x04000000 /* BRS Mask in DLC */;

// CAN register bit shift - XCAN_<REG>_<BIT>_SHIFT

// CAN frame length constants
pub const XCAN_FRAME_MAX_DATA_LEN: c_int = 8;
pub const XCANFD_DW_BYTES: c_int = 4;

// TX-FIFO-empty interrupt available
pub const XCAN_FLAG_TXFEMP: c_uint = 0x0001;
// RX Match Not Finished interrupt available
pub const XCAN_FLAG_RXMNF: c_uint = 0x0002;
// Extended acceptance filters with control at 0xE0
pub const XCAN_FLAG_EXT_FILTERS: c_uint = 0x0004;
// TX mailboxes instead of TX FIFO
pub const XCAN_FLAG_TX_MAILBOXES: c_uint = 0x0008;
// RX FIFO with each buffer in separate registers at 0x1100
// instead of the regular FIFO at 0x50
//
pub const XCAN_FLAG_RX_FIFO_MULTI: c_uint = 0x0010;
pub const XCAN_FLAG_CANFD_2: c_uint = 0x0020;
    enum xcan_ip_type {
    XAXI_CAN = 0,
    XZYNQ_CANPS,
    XAXI_CANFD,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xcan_devtype_data {
    pub cantype: enum xcan_ip_type,
    pub flags: c_uint,
    pub bittiming_const: *const can_bittiming_,
    pub bus_clk_name: *const c_char,
    pub btr_ts2_shift: c_uint,
    pub btr_sjw_shift: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xcan_priv {
    pub can: can_priv,
    pub /: *mut *mut spinlock_t tx_lock; / Lock for synchronizing TX interrupt handling,
    pub tx_head: c_uint,
    pub tx_tail: c_uint,
    pub tx_max: c_uint,
    pub napi: napi_struct,
    pub reg): *const *const *const u32 (read_reg)(struct xcan_priv priv, enum xcan_reg,
    ...
    pub bus_clk: *mut clk,
    pub can_clk: *mut clk,
    pub devtype: xcan_devtype_data,
    pub transceiver: *mut phy,
    pub rstc: *mut reset_control,
    pub ecc_enable: bool,
    pub syncp: u64_stats_sync,
    pub ecc_rx_2_bit_errors: u64_stats_t,
    pub ecc_rx_1_bit_errors: u64_stats_t,
    pub ecc_txol_2_bit_errors: u64_stats_t,
    pub ecc_txol_1_bit_errors: u64_stats_t,
    pub ecc_txtl_2_bit_errors: u64_stats_t,
    pub ecc_txtl_1_bit_errors: u64_stats_t,
}
...
//
#[no_mangle]
unsafe extern "C" fn xcan_read_reg_le(priv: *const xcan_priv, reg: enum xcan_reg) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_read_reg_be(priv: *const xcan_priv, reg: enum xcan_reg) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_rx_int_mask(priv: *const xcan_priv) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn set_reset_mode(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_set_bittiming(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_chip_start(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_do_set_mode(ndev: *mut net_device, mode: enum can_mode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_start_xmit_fifo(skb: *mut sk_buff, ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_start_xmit_mailbox(skb: *mut sk_buff, ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_start_xmit(skb: *mut sk_buff, ndev: *mut net_device) -> netdev_tx_t {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_rx(ndev: *mut net_device, frame_base: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xcanfd_rx(ndev: *mut net_device, frame_base: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_current_error_state(ndev: *mut net_device) -> enum can_state {
    static enum can_state xcan_current_error_state(struct net_device *ndev)
    {
    struct xcan_priv *priv = netdev_priv(ndev);
    let mut status: u32 = priv.read_reg(priv, XCAN_SR_OFFSET);
    if ((status & XCAN_SR_ESTAT_MASK) == XCAN_SR_ESTAT_MASK)
    return CAN_STATE_ERROR_PASSIVE;
#[no_mangle]
pub unsafe extern "C" fn if(XCAN_SR_ERRWRN_MASK: status &) -> else {
...
//
    ...
    {
    struct xcan_priv *priv = netdev_priv(ndev);
    let mut ecr: u32 = priv.read_reg(priv, XCAN_ECR_OFFSET);
    let mut txerr: u32 = ecr & XCAN_ECR_TEC_MASK;
    let mut rxerr: u32 = (ecr & XCAN_ECR_REC_MASK) >> XCAN_ESR_REC_SHIFT;
    let mut tx_state: enum can_state = txerr >= rxerr ? new_state : 0;
    let mut rx_state: enum can_state = txerr <= rxerr ? new_state : 0;
...
//
#[no_mangle]
unsafe extern "C" fn xcan_update_error_state_after_rxtx(ndev: *mut net_device) {
    static void xcan_update_error_state_after_rxtx(struct net_device *ndev)
    {
    struct xcan_priv *priv = netdev_priv(ndev);
    let mut old_state: enum can_state = priv.can.state;
    enum can_state new_state;
...
//
    ...
    xcan_set_error_state(ndev, new_state, skb ? cf : core::ptr::null_mut());
    if (skb)
    netif_rx(skb);
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn xcan_err_interrupt(ndev: *mut net_device, isr: u32) {
    static void xcan_err_interrupt(struct net_device *ndev, u32 isr)
    {
    struct xcan_priv *priv = netdev_priv(ndev);
    struct net_device_stats *stats = &ndev.stats;
    let mut cf: can_frame = { };
    u32 err_status;
...
// Leave device in Config Mode in bus-off state
    ...
    let mut new_state: enum can_state = xcan_current_error_state(ndev);
...
// Check for error interrupt
    ...
    let mut berr_reporting: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn xcan_state_interrupt(ndev: *mut net_device, isr: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_rx_fifo_get_next_frame(priv: *mut xcan_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_rx_poll(napi: *mut napi_struct, quota: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_tx_interrupt(ndev: *mut net_device, isr: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    u32 isr_errors, mask;
    u32 isr, ier;
    let mut rx_int_mask: u32 = xcan_rx_int_mask(priv);
...
//
#[no_mangle]
unsafe extern "C" fn xcan_chip_stop(ndev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_open(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_close(ndev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_get_auto_tdcv(ndev: *const net_device, tdcv: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xcan_get_strings(ndev: *mut net_device, stringset: u32, buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn xcan_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_suspend(dev: *mut device) -> int __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_resume(dev: *mut device) -> int __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn xcan_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(xcan_runtime_suspend, xcan_runtime_resume, core::ptr::null_mut())
    };
...
//
#[no_mangle]
unsafe extern "C" fn xcan_probe(pdev: *mut platform_device) -> c_int {
    ...
    int ret;
    int rx_max, tx_max;
    let mut hw_tx_max: u32 = 0, hw_rx_max = 0;
...
// Create a CAN device instance
    ...
    priv.rstc = devm_reset_control_get_optional_exclusive(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(priv.rstc)) {
...
// Getting the CAN can_clk info
    ...
    transceiver = devm_phy_optional_get(&pdev.dev, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn xcan_remove(pdev: *mut platform_device) {
