...
//! Source: drivers/net/can/rockchip/rockchip_canfd-rx.c
#![no_std]
...
//
    ...
    const bool is_canfd)
    {
    let mut mask_flags: u8 = CANFD_BRS | CANFD_ESI | CANFD_FDF;
    let mut mask: canid_t = CAN_EFF_FLAG;
    ...
    {
    let mut len: c_uint = sizeof(*cfd) - sizeof(cfd.data);
    u8 dlc;
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_handle_rx_int_one(priv: *mut rkcanfd_priv) -> c_int {
...
//
    ...
    {
    let mut reg: u32 = rkcanfd_read(priv, RKCANFD_REG_RX_FIFO_CTRL);
...
#[no_mangle]
pub unsafe extern "C" fn rkcanfd_handle_rx_int(priv: *mut rkcanfd_priv) -> c_int {
