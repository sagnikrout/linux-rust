...
//! Source: drivers/net/can/rockchip/rockchip_canfd-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_chip_set_reset_mode(priv: *const rkcanfd_priv) {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_chip_set_work_mode(priv: *const rkcanfd_priv) {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_set_bittiming(priv: *mut rkcanfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_chip_interrupts_enable(priv: *const rkcanfd_priv) {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_chip_interrupts_disable(priv: *const rkcanfd_priv) {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_chip_fifo_setup(priv: *mut rkcanfd_priv) {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_chip_start(priv: *mut rkcanfd_priv) {
...
#[no_mangle]
unsafe extern "C" fn __rkcanfd_chip_stop(priv: *mut rkcanfd_priv, state: enum can_state) {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_chip_stop(priv: *mut rkcanfd_priv, state: enum can_state) {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_chip_stop_sync(priv: *mut rkcanfd_priv, state: enum can_state) {
...
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_RX_ID2_RTR: reg_ec &) -> else {
    else if (reg_ec & RKCANFD_REG_ERROR_CODE_RX_ID2_RTR)
    cf.data[3] = CAN_ERR_PROT_LOC_RTR;
// RKCANFD_REG_ERROR_CODE_RX_FDF
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_RX_RES: reg_ec &) -> else {
    else if (reg_ec & RKCANFD_REG_ERROR_CODE_RX_RES)
    cf.data[3] = CAN_ERR_PROT_LOC_RES0;
// RKCANFD_REG_ERROR_CODE_RX_BRS_ESI
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_RX_DLC: reg_ec &) -> else {
    else if (reg_ec & RKCANFD_REG_ERROR_CODE_RX_DLC)
    cf.data[3] = CAN_ERR_PROT_LOC_DLC;
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_RX_DATA: reg_ec &) -> else {
    else if (reg_ec & RKCANFD_REG_ERROR_CODE_RX_DATA)
    cf.data[3] = CAN_ERR_PROT_LOC_DATA;
// RKCANFD_REG_ERROR_CODE_RX_STUFF_COUNT
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_RX_CRC: reg_ec &) -> else {
    else if (reg_ec & RKCANFD_REG_ERROR_CODE_RX_CRC)
    cf.data[3] = CAN_ERR_PROT_LOC_CRC_SEQ;
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_RX_CRC_LIM: reg_ec &) -> else {
    else if (reg_ec & RKCANFD_REG_ERROR_CODE_RX_CRC_LIM)
    cf.data[3] = CAN_ERR_PROT_LOC_ACK_DEL;
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_RX_ACK: reg_ec &) -> else {
    else if (reg_ec & RKCANFD_REG_ERROR_CODE_RX_ACK)
    cf.data[3] = CAN_ERR_PROT_LOC_ACK;
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_RX_ACK_LIM: reg_ec &) -> else {
    else if (reg_ec & RKCANFD_REG_ERROR_CODE_RX_ACK_LIM)
    cf.data[3] = CAN_ERR_PROT_LOC_ACK_DEL;
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_RX_EOF: reg_ec &) -> else {
    else if (reg_ec & RKCANFD_REG_ERROR_CODE_RX_EOF)
    cf.data[3] = CAN_ERR_PROT_LOC_EOF;
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_RX_SPACE: reg_ec &) -> else {
    else if (reg_ec & RKCANFD_REG_ERROR_CODE_RX_SPACE)
    cf.data[3] = CAN_ERR_PROT_LOC_EOF;
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_RX_BUF_INT: reg_ec &) -> else {
    ...
    cf.data[3] = CAN_ERR_PROT_LOC_SOF;
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_TX_DATA: reg_ec &) -> else {
    else if (reg_ec & RKCANFD_REG_ERROR_CODE_TX_DATA)
    cf.data[3] = CAN_ERR_PROT_LOC_DATA;
// RKCANFD_REG_ERROR_CODE_TX_STUFF_COUNT
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_TX_CRC: reg_ec &) -> else {
    else if (reg_ec & RKCANFD_REG_ERROR_CODE_TX_CRC)
    cf.data[3] = CAN_ERR_PROT_LOC_CRC_SEQ;
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_TX_ACK_EOF: reg_ec &) -> else {
    else if (reg_ec & RKCANFD_REG_ERROR_CODE_TX_ACK_EOF)
    cf.data[3] = CAN_ERR_PROT_LOC_ACK_DEL;
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_TX_ACK: reg_ec &) -> else {
    else if (reg_ec & RKCANFD_REG_ERROR_CODE_TX_ACK)
    cf.data[3] = CAN_ERR_PROT_LOC_ACK;
// RKCANFD_REG_ERROR_CODE_TX_ERROR
#[no_mangle]
pub unsafe extern "C" fn if(RKCANFD_REG_ERROR_CODE_TX_OVERLOAD: reg_ec &) -> else {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_handle_error_int(priv: *mut rkcanfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_handle_state_error_int(priv: *mut rkcanfd_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_stop(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_register_done(priv: *const rkcanfd_priv) {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_register(priv: *mut rkcanfd_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rkcanfd_unregister(priv: *mut rkcanfd_priv) {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkcanfd_remove(pdev: *mut platform_device) {
    ...
    rkcanfd_runtime_resume, core::ptr::null_mut())
    };
