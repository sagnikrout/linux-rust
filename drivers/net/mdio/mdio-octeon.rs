...
//! Source: drivers/net/mdio/mdio-octeon.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn octeon_mdiobus_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn octeon_mdiobus_remove(pdev: *mut platform_device) {
