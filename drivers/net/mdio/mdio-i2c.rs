...
//! Source: drivers/net/mdio/mdio-i2c.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn i2c_mii_valid_phy_id(phy_id: c_int) -> bool {
    static bool i2c_mii_valid_phy_id(int phy_id)
    {
    return phy_id != 0x10 && phy_id != 0x11;
    }
#[no_mangle]
unsafe extern "C" fn i2c_mii_phy_addr(phy_id: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn i2c_mii_read_default_c22(bus: *mut mii_bus, phy_id: c_int, reg: c_int) -> c_int {
...
//
pub const ROLLBALL_PHY_I2C_ADDR: c_uint = 0x51;

pub const ROLLBALL_CMD_ADDR: c_uint = 0x80;
pub const ROLLBALL_DATA_ADDR: c_uint = 0x81;
pub const ROLLBALL_CMD_WRITE: c_uint = 0x01;
pub const ROLLBALL_CMD_READ: c_uint = 0x02;
pub const ROLLBALL_CMD_DONE: c_uint = 0x04;
pub const SFP_PAGE_ROLLBALL_MDIO: c_int = 3;
...
pub unsafe extern "C" fn if(0: ret <) -> else {
    ...
    if (ret < 0)
    return ret;
    ret = i2c_rollball_mii_poll(bus, bus_addr, core::ptr::null_mut(), 0);
    if (ret < 0)
    return ret;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn i2c_mii_init_rollball(i2c: *mut i2c_adapter) -> c_int {
