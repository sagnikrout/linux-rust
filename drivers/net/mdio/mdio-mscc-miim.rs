...
//! Source: drivers/net/mdio/mdio-mscc-miim.c
#![no_std]
...
pub const MSCC_MIIM_REG_STATUS: c_uint = 0x0;

pub const MSCC_MIIM_REG_CMD: c_uint = 0x8;

pub const MSCC_MIIM_CMD_WRDATA_SHIFT: c_int = 4;
pub const MSCC_MIIM_CMD_REGAD_SHIFT: c_int = 20;
pub const MSCC_MIIM_CMD_PHYAD_SHIFT: c_int = 25;

pub const MSCC_MIIM_REG_DATA: c_uint = 0xC;

pub const MSCC_MIIM_REG_CFG: c_uint = 0x10;

pub const MSCC_PHY_REG_PHY_CFG: c_uint = 0x0;

pub const MSCC_PHY_REG_PHY_STATUS: c_uint = 0x4;
pub const LAN966X_CUPHY_COMMON_CFG: c_uint = 0x0;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mscc_miim_info {
    pub phy_reset_offset: c_uint,
    pub phy_reset_bits: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mscc_miim_dev {
    pub regs: *mut regmap,
    pub mii_status_offset: c_int,
    pub ignore_read_errors: bool,
    pub phy_regs: *mut regmap,
    pub info: *const mscc_miim_info,
    pub clk: *mut clk,
    pub bus_freq: u32,
}
...
#[no_mangle]
unsafe extern "C" fn mscc_miim_status(bus: *mut mii_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mscc_miim_wait_ready(bus: *mut mii_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mscc_miim_wait_pending(bus: *mut mii_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mscc_miim_read(bus: *mut mii_bus, mii_id: c_int, regnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mscc_miim_reset(bus: *mut mii_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mscc_miim_clk_set(bus: *mut mii_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mscc_miim_probe(pdev: *mut platform_device) -> c_int {
...
// This resource is optional
    ...
    if (!miim.info)
    return -EINVAL;
    miim.clk = devm_clk_get_optional(dev, core::ptr::null_mut());
    if (IS_ERR(miim.clk))
...
#[no_mangle]
unsafe extern "C" fn mscc_miim_remove(pdev: *mut platform_device) {
