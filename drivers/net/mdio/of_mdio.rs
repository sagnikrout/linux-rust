...
//! Source: drivers/net/mdio/of_mdio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn of_get_phy_id(device: *mut device_node, phy_id: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_mdiobus_child_is_phy(child: *mut device_node) -> bool {
...
// Ignore invalid ethernet-phy-package node
    ...
    continue;
    rc = __of_mdiobus_parse_phys(mdio, child, core::ptr::null_mut());
    if (rc && rc != -ENODEV)
    goto exit;
    continue;
    }
...
// refcount is held by phy_connect_direct() on success
    ...
    return ret ? core::ptr::null_mut() : phy;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn of_phy_is_fixed_link(np: *mut device_node) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn of_phy_register_fixed_link(np: *mut device_node) -> c_int {
    int of_phy_register_fixed_link(struct device_node *np)
    {
    let mut status: fixed_phy_status = {};
...
#[no_mangle]
pub unsafe extern "C" fn of_phy_deregister_fixed_link(np: *mut device_node) {
