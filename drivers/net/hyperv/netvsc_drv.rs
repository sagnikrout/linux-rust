...
//! Source: drivers/net/hyperv/netvsc_drv.c
#![no_std]
...
pub const RING_SIZE_MIN: c_int = 64;

// Macros to define the context of vf registration
pub const VF_REG_IN_PROBE: c_int = 1;
pub const VF_REG_IN_NOTIFIER: c_int = 2;
    let mut __ro_after_init: static unsigned int ring_size = 128;
...
#[no_mangle]
unsafe extern "C" fn netvsc_change_rx_flags(net: *mut net_device, change: c_int) {
...
#[no_mangle]
unsafe extern "C" fn netvsc_set_rx_mode(net: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn netvsc_open(net: *mut net_device) -> c_int {
...
//
    ret = dev_open(vf_netdev, core::ptr::null_mut());
    if (ret)
    netdev_warn(net,
...
#[no_mangle]
unsafe extern "C" fn netvsc_wait_until_empty(nvdev: *mut netvsc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netvsc_close(net: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn netvsc_pick_tx(ndev: *mut net_device, skb: *mut sk_buff) -> u16 {
    static u16 netvsc_pick_tx(struct net_device *ndev, struct sk_buff *skb)
    {
    let mut q_idx: c_int = sk_tx_queue_get(skb.sk);
...
//
    ...
    txq = netdev_pick_tx(vf_netdev, skb, core::ptr::null_mut());
...
//
    ...
    {
    let mut frags: c_int = skb_shinfo(skb).nr_frags;
    int i;
...
//
    ...
    let mut pfn: u64 = page_to_hvpfn(skb_frag_page(frag));
    let mut offset: u32 = skb_frag_off(frag);
...
#[no_mangle]
unsafe extern "C" fn count_skb_frag_slots(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netvsc_get_slots(skb: *mut sk_buff) -> c_int {
    static int netvsc_get_slots(struct sk_buff *skb)
    {
    char *data = skb.data;
    let mut offset: c_uint = offset_in_hvpage(data);
...
#[no_mangle]
unsafe extern "C" fn net_checksum_info(skb: *mut sk_buff) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(IPPROTO_UDP: ip6->nexthdr ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn netvsc_xmit(skb: *mut sk_buff, net: *mut net_device, xdp_tx: bool) -> c_int {
    static int netvsc_xmit(struct sk_buff *skb, struct net_device *net, bool xdp_tx)
    {
    struct net_device_context *net_device_ctx = netdev_priv(net);
    struct hv_netvsc_packet *packet = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn netvsc_xdp_xmit(skb: *mut sk_buff, ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn netvsc_comp_ipcsum(skb: *mut sk_buff) {
    ...
    let mut ppi_flags: u8 = nvchan.rsc.ppi_flags;
    struct sk_buff *skb;
    void *xbuf = xdp.data_hard_start;
    int i;
    if (xbuf) {
    let mut hdroom: c_uint = xdp.data - xdp.data_hard_start;
    let mut xlen: c_uint = xdp.data_end - xdp.data;
    let mut frag_size: c_uint = xdp.frame_sz;
...
//
    ...
    let mut q_idx: u16 = channel.offermsg.offer.sub_channel_index;
    struct sk_buff *skb;
...
//
    ...
    ++rx_stats.broadcast;
#[no_mangle]
pub unsafe extern "C" fn if(PACKET_MULTICAST: skb->pkt_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn netvsc_devinfo_put(dev_info: *mut netvsc_device_info) {
...
// Don't try continuing to try and setup sub channels
    ...
    nvdev.num_chn = 1;
    netvsc_xdp_set(ndev, core::ptr::null_mut(), core::ptr::null_mut(), nvdev);
...
// if unavailable, just proceed with one queue
    ...
    if (prog) {
    bpf_prog_inc(prog);
    ret = netvsc_xdp_set(ndev, prog, core::ptr::null_mut(), nvdev);
    if (ret) {
    bpf_prog_put(prog);
    goto err1;
    }
...
#[no_mangle]
unsafe extern "C" fn netvsc_init_settings(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn netvsc_change_mtu(ndev: *mut net_device, mtu: c_int) -> c_int {
    static int netvsc_change_mtu(struct net_device *ndev, int mtu)
    {
    struct net_device_context *ndevctx = netdev_priv(ndev);
    struct net_device *vf_netdev = rtnl_dereference(ndevctx.vf_netdev);
    struct netvsc_device *nvdev = rtnl_dereference(ndevctx.nvdev);
    let mut orig_mtu: c_int = ndev.mtu;
    struct netvsc_device_info *device_info;
    let mut ret: c_int = 0;
    if (!nvdev || nvdev.destroy)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn netvsc_set_mac_addr(ndev: *mut net_device, p: *mut c_void) -> c_int {
    ...
    return -ENODEV;
    if (vf_netdev) {
    err = dev_set_mac_address(vf_netdev, addr, core::ptr::null_mut());
    if (err)
    return err;
    }
...
// rollback change on VF
    ...
    dev_set_mac_address(vf_netdev, addr, core::ptr::null_mut());
    }
    return err;
    }
    static const struct {
...
#[no_mangle]
unsafe extern "C" fn netvsc_get_sset_count(dev: *mut net_device, string_set: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netvsc_get_strings(dev: *mut net_device, stringset: u32, data: *mut u8) {
    ...
    {
    struct net_device_context *ndc = netdev_priv(ndev);
    let mut l4_flag: u32 = RXH_L4_B_0_1 | RXH_L4_B_2_3;
...
#[no_mangle]
unsafe extern "C" fn netvsc_get_rx_ring_count(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn netvsc_get_rxfh_key_size(dev: *mut net_device) -> u32 {
    static u32 netvsc_get_rxfh_key_size(struct net_device *dev)
    {
    return NETVSC_HASH_KEYLEN;
    }
#[no_mangle]
unsafe extern "C" fn netvsc_rss_indir_size(dev: *mut net_device) -> u32 {
...
//
    ...
    netdev_features_t features)
    {
    let mut change: netdev_features_t = features ^ ndev.features;
    struct net_device_context *ndevctx = netdev_priv(ndev);
    struct netvsc_device *nvdev = rtnl_dereference(ndevctx.nvdev);
    struct net_device *vf_netdev = rtnl_dereference(ndevctx.vf_netdev);
...
#[no_mangle]
unsafe extern "C" fn netvsc_get_regs_len(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netvsc_get_msglevel(ndev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn netvsc_set_msglevel(ndev: *mut net_device, val: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn netvsc_link_change(w: *mut work_struct) {
    ...
    struct netvsc_reconfig *event = core::ptr::null_mut();
    struct netvsc_device *net_device;
    struct rndis_device *rdev;
...
//
    ...
    return core::ptr::null_mut();	/* not a netvsc device */
    net_device_ctx = netdev_priv(dev);
    if (!rtnl_dereference(net_device_ctx.nvdev))
    return core::ptr::null_mut();	/* device is removed */
    return dev;
    }
...
//
#[no_mangle]
unsafe extern "C" fn netvsc_vf_handle_frame(pskb: *mut sk_buff) -> rx_handler_result_t {
...
// set multicast etc flags on VF
    dev_change_flags(vf_netdev, ndev.flags | IFF_SLAVE, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn netvsc_vf_setup(w: *mut work_struct) {
...
//
    ...
    return core::ptr::null_mut(); /* not a PCI device */
...
#[no_mangle]
unsafe extern "C" fn netvsc_prepare_bonding(vf_netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netvsc_register_vf(vf_netdev: *mut net_device, context: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn netvsc_vf_changed(vf_netdev: *mut net_device, event: c_ulong) -> c_int {
    static int netvsc_vf_changed(struct net_device *vf_netdev, unsigned long event)
    {
    struct net_device_context *net_device_ctx;
    struct netvsc_device *netvsc_dev;
    struct net_device *ndev;
    let mut vf_is_up: bool = false;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn netvsc_unregister_vf(vf_netdev: *mut net_device) -> c_int {
    ...
    RCU_INIT_POINTER(net_device_ctx.vf_netdev, core::ptr::null_mut());
    dev_put(vf_netdev);
    ndev.needed_headroom = RNDIS_AND_PPI_SIZE;
    return NOTIFY_OK;
    }
#[no_mangle]
unsafe extern "C" fn check_dev_is_matching_vf(event_ndev: *mut net_device) -> c_int {
...
// Avoid Bonding master dev with same MAC registering as VF
    ...
    {
    struct net_device *net = core::ptr::null_mut(), *vf_netdev;
    struct net_device_context *net_device_ctx;
    struct netvsc_device_info *device_info = core::ptr::null_mut();
    struct netvsc_device *nvdev;
...
// Notify the netvsc driver of the new device
    device_info = netvsc_devinfo_get(core::ptr::null_mut());
    if (!device_info) {
    ret = -ENOMEM;
    goto devinfo_failed;
    }
...
//
    ...
    no_stats:
    hv_set_drvdata(dev, core::ptr::null_mut());
    free_netdev(net);
    no_net:
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn netvsc_remove(dev: *mut hv_device) {
    ...
    netvsc_xdp_set(net, core::ptr::null_mut(), core::ptr::null_mut(), nvdev);
    }
//
...
#[no_mangle]
unsafe extern "C" fn netvsc_suspend(dev: *mut hv_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netvsc_resume(dev: *mut hv_device) -> c_int {
...
//
    ...
    ret = netvsc_attach(net, device_info);
    netvsc_devinfo_put(device_info);
    net_device_ctx.saved_netvsc_dev_info = core::ptr::null_mut();
    rtnl_unlock();
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn netvsc_event_set_vf_ns(ndev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn netvsc_vfns_work(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn netvsc_drv_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn netvsc_drv_init() -> int __init {
