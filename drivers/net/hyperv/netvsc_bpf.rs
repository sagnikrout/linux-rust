...
//! Source: drivers/net/hyperv/netvsc_bpf.c
#![no_std]
...
//
    ...
    let mut len: u32 = nvchan.rsc.len[0];
    struct page *page = core::ptr::null_mut();
    struct bpf_prog *prog;
    let mut act: u32 = XDP_PASS;
    let mut drop: bool = true;
    xdp.data_hard_start = core::ptr::null_mut();
    rcu_read_lock();
...
#[no_mangle]
pub unsafe extern "C" fn netvsc_xdp_fraglen(len: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn netvsc_vf_setxdp(vf_netdev: *mut net_device, prog: *mut bpf_prog) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn netvsc_bpf(dev: *mut net_device, bpf: *mut netdev_bpf) -> c_int {
    ...
    netvsc_xdp_set(dev, core::ptr::null_mut(), extack, nvdev);
    }
    return ret;
    default:
    return -EINVAL;
