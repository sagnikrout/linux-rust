...
pub const HT_MAP_BITS: c_int = 4;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vrf_map {
    pub HT_MAP_BITS): DECLARE_HASHTABLE(ht,,
    pub vmap_lock: spinlock_t,
// shared_tables:
...
//
    pub shared_tables: u32,
    pub strict_mode: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vrf_map_elem {
    pub hnode: hlist_node,
    pub /: *mut *mut list_head vrf_list; / VRFs registered to this table,
    pub table_id: u32,
    pub users: c_int,
    pub ifindex: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct netns_vrf {
// protected by rtnl lock
    pub add_fib_rules: bool,
    pub vmap: vrf_map,
    pub ctl_hdr: *mut ctl_table_header,
}
...
pub struct net_vrf {
    ...
    pub tb_id: u32,
    pub /: *mut *mut list_head me_list; / entry in vrf_map_elem,
    pub ifindex: c_int,
}

#[no_mangle]
unsafe extern "C" fn vrf_tx_error(vrf_dev: *mut net_device, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn vrf_map_elem_get_vrf_ifindex(me: *mut vrf_map_elem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vrf_map_elem_free(me: *mut vrf_map_elem) {
...
#[no_mangle]
unsafe extern "C" fn vrf_map_add_elem(vmap: *mut vrf_map, me: *mut vrf_map_elem) {
    static void vrf_map_add_elem(struct vrf_map *vmap, struct vrf_map_elem *me)
    {
    let mut table_id: u32 = me.table_id;
    u32 key;
    key = jhash_1word(table_id, HASH_INITVAL);
    hash_add(vmap.ht, &me.hnode, key);
    }
#[no_mangle]
unsafe extern "C" fn vrf_map_del_elem(me: *mut vrf_map_elem) {
    static void vrf_map_del_elem(struct vrf_map_elem *me)
    {
    hash_del(&me.hnode);
    }
#[no_mangle]
unsafe extern "C" fn vrf_map_lock(__acquires(&vmap->vmap_lock: *mut *mut vrf_map vmap)) {
    static void vrf_map_lock(struct vrf_map *vmap) __acquires(&vmap.vmap_lock)
    {
    spin_lock(&vmap.vmap_lock);
    }
#[no_mangle]
unsafe extern "C" fn vrf_map_unlock(__releases(&vmap->vmap_lock: *mut *mut vrf_map vmap)) {
...
// called with rtnl lock held
    ...
    let mut table_id: u32 = vrf.tb_id;
    let mut free_new_me: bool = false;
    int users;
    int res;
...
// called with rtnl lock held
#[no_mangle]
unsafe extern "C" fn vrf_map_unregister_dev(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn vrf_ifindex_lookup_by_table_id(net: *mut net, table_id: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qdisc_tx_is_default(dev: *const net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vrf_nf_set_untracked(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn vrf_nf_reset_ct(skb: *mut sk_buff) {
    ...
    sk, skb, core::ptr::null_mut(), skb_dst(skb).dev, dst_output);
    if (likely(err == 1))
    ...
    struct flowi6 fl6;
    let mut ret: c_int = NET_XMIT_DROP;
    struct dst_entry *dst;
...
// based on ip_local_out; can't use it b/c the dst is switched pointing to us
    ...
    skb, core::ptr::null_mut(), skb_dst(skb).dev, dst_output);
    if (likely(err == 1))
    err = dst_output(net, sk, skb);
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn is_ip_tx_frame(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn vrf_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn vrf_finish_direct(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn vrf_output6(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
    static int vrf_output6(struct net *net, struct sock *sk, struct sk_buff *skb)
    {
    return NF_HOOK_COND(NFPROTO_IPV6, NF_INET_POST_ROUTING,
    net, sk, skb, core::ptr::null_mut(), skb_dst(skb).dev,
    vrf_finish_output6,
...
//
    ...
    core::ptr::null_mut(), skb.dev, vrf_output6_direct_finish);
    if (likely(err == 1))
    vrf_finish_direct(skb);
    return err;
    }
    ...
    skb, core::ptr::null_mut(), vrf_dev, vrf_ip6_out_direct_finish);
    if (likely(err == 1))
    err = vrf_output6_direct(net, sk, skb);
    if (likely(err == 1))
    return skb;
...
// holding rtnl
#[no_mangle]
unsafe extern "C" fn vrf_rt6_release(dev: *mut net_device, vrf: *mut net_vrf) {
...
#[no_mangle]
unsafe extern "C" fn vrf_rt6_create(dev: *mut net_device) -> c_int {
    static int vrf_rt6_create(struct net_device *dev)
    {
    let mut flags: c_int = DST_NOPOLICY | DST_NOXFRM;
    struct net_vrf *vrf = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn vrf_finish_output(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vrf_output(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    net, sk, skb, core::ptr::null_mut(), dev,
    vrf_finish_output,
...
//
    ...
    core::ptr::null_mut(), skb.dev, vrf_output_direct_finish);
    if (likely(err == 1))
    vrf_finish_direct(skb);
    return err;
    }
    ...
    skb.dev = vrf_dev;
    err = nf_hook(NFPROTO_IPV4, NF_INET_LOCAL_OUT, net, sk,
    skb, core::ptr::null_mut(), vrf_dev, vrf_ip_out_direct_finish);
    if (likely(err == 1))
    err = vrf_output_direct(net, sk, skb);
    if (likely(err == 1))
    return skb;
...
// holding rtnl
#[no_mangle]
unsafe extern "C" fn vrf_rtable_release(dev: *mut net_device, vrf: *mut net_vrf) {
...
#[no_mangle]
unsafe extern "C" fn vrf_rtable_create(dev: *mut net_device) -> c_int {
...
// cycle interface to flush neighbor cache and move routes across tables
    ...
    {
    let mut flags: c_uint = dev.flags;
    int ret;
...
//
    ...
    ret = netdev_master_upper_dev_link(port_dev, dev, core::ptr::null_mut(), core::ptr::null_mut(), extack);
    if (ret < 0)
    goto err;
...
//
    if (needs_sync)
    synchronize_net();
    cycle_netdev(port_dev, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn vrf_del_slave(dev: *mut net_device, port_dev: *mut net_device) -> c_int {
    static int vrf_del_slave(struct net_device *dev, struct net_device *port_dev)
    {
    return do_vrf_del_slave(dev, port_dev, true);
    }
#[no_mangle]
unsafe extern "C" fn vrf_dev_uninit(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn vrf_dev_init(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vrf_fib_table(dev: *const net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vrf_rcv_finish(net: *mut net, sk: *mut sock, skb: *mut sk_buff) -> c_int {
    ...
    {
    struct net *net = dev_net(dev);
    if (nf_hook(pf, hook, net, core::ptr::null_mut(), skb, dev, core::ptr::null_mut(), vrf_rcv_finish) != 1)
    skb = core::ptr::null_mut();    /* kfree_skb(skb) handled by nf code */
    return skb;
    }
...
//
#[no_mangle]
unsafe extern "C" fn ipv6_ndisc_frame(skb: *const sk_buff) -> bool {
    ...
    struct sk_buff *skb)
    {
    let mut orig_iif: c_int = skb.skb_iif;
    let mut need_strict: bool = rt6_need_strict(&ipv6_hdr(skb).daddr);
    let mut is_ndisc: bool = ipv6_ndisc_frame(skb);
...
//
    ...
    {
    struct net *net = dev_net(dev);
    let mut flags: c_int = RT6_LOOKUP_F_IFACE | RT6_LOOKUP_F_DST_NOREF;
...
//
    ...
    rt = vrf_ip6_route_lookup(net, dev, fl6, fl6.flowi6_oif, core::ptr::null_mut(), flags);
    if (rt)
    dst = &rt.dst;
    return dst;
    }
...
#[no_mangle]
pub unsafe extern "C" fn vrf_fib_rule_nl_size() -> usize {
...
#[no_mangle]
unsafe extern "C" fn vrf_fib_rule(dev: *const net_device, family: __u8, add_it: bool) -> c_int {
...
// rule only needs to appear once
    ...
    nlmsg_end(skb, nlh);
    if (add_it) {
    err = fib_newrule(dev_net(dev), skb, nlh, core::ptr::null_mut(), true);
    if (err == -EEXIST)
    err = 0;
    } else {
    err = fib_delrule(dev_net(dev), skb, nlh, core::ptr::null_mut(), true);
    if (err == -ENOENT)
    err = 0;
    }
    nlmsg_free(skb);
...
#[no_mangle]
unsafe extern "C" fn vrf_add_fib_rules(dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vrf_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn vrf_dellink(dev: *mut net_device, head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn vrf_nl_getsize(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn vrf_map_init(vmap: *mut vrf_map) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vrf_strict_mode(vmap: *mut vrf_map) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vrf_strict_mode_change(vmap: *mut vrf_map, new_mode: bool) -> c_int {
...
// cur_mode = true;
    ...
    struct vrf_map *vmap = netns_vrf_map(net);
    let mut proc_strict_mode: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn vrf_netns_init_sysctl(net: *mut net, nn_vrf: *mut netns_vrf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vrf_netns_exit_sysctl(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn vrf_netns_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn vrf_netns_exit(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn vrf_init_module() -> int __init {
