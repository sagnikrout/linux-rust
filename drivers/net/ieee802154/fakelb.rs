...
//! Source: drivers/net/ieee802154/fakelb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fakelb_phy {
    pub hw: *mut ieee802154_hw,
    pub page: u8,
    pub channel: u8,
    pub suspended: bool,
    pub list: list_head,
    pub list_ifup: list_head,
}

#[no_mangle]
unsafe extern "C" fn fakelb_hw_ed(hw: *mut ieee802154_hw, level: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fakelb_hw_channel(hw: *mut ieee802154_hw, page: u8, channel: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fakelb_hw_xmit(hw: *mut ieee802154_hw, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fakelb_hw_start(hw: *mut ieee802154_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fakelb_hw_stop(hw: *mut ieee802154_hw) {
...
#[no_mangle]
unsafe extern "C" fn fakelb_add_one(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fakelb_del(phy: *mut fakelb_phy) {
...
#[no_mangle]
unsafe extern "C" fn fakelb_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fakelb_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn fakelb_init_module() -> __init int {
    static __init int fakelb_init_module(void)
    {
    ieee802154fake_dev = platform_device_register_simple(
    "ieee802154fakelb", -1, core::ptr::null_mut(), 0);
    pr_warn("fakelb driver is marked as deprecated, please use mac802154_hwsim!\n");
    return platform_driver_register(&ieee802154fake_driver);
    }
#[no_mangle]
unsafe extern "C" fn fake_remove_module() -> __exit void {
