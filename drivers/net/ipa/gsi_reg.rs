...
//! Source: drivers/net/ipa/gsi_reg.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_reg_ch_c_cntxt_0_field_id {
    CHTYPE_PROTOCOL,
    CHTYPE_DIR,
    CH_EE,
    CHID,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_reg_ch_c_cntxt_1_field_id {
    CH_R_LENGTH,
    CH_ERINDEX,					/* IPA v5.0+ */
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_reg_ch_c_qos_field_id {
    WRR_WEIGHT,
    MAX_PREFETCH,
    USE_DB_ENG,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_reg_ch_c_ev_ch_e_cntxt_0_field_id {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_reg_ev_ch_c_cntxt_1_field_id {
    R_LENGTH,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_reg_ch_c_ev_ch_e_cntxt_8_field_id {
    EV_MODT,
    EV_MODC,
    EV_MOD_CNT,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_reg_gsi_status_field_id {
    ENABLED,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_reg_gsi_ch_cmd_field_id {
    CH_CHID,
    CH_OPCODE,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_ev_ch_cmd_field_id {
    EV_CHID,
    EV_OPCODE,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_generic_cmd_field_id {
    GENERIC_OPCODE,
    GENERIC_CHID,
    GENERIC_EE,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_generic_cmd_opcode {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_hw_param_2_field_id {
    IRAM_SIZE,
    NUM_CH_PER_EE,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_hw_param_4_field_id {
    EV_PER_EE,
    IRAM_PROTOCOL_COUNT,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_cntxt_intset_field_id {
    INTYPE,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_error_log_field_id {
    ERR_ARG3,
    ERR_ARG2,
    ERR_ARG1,
    ERR_CODE,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_cntxt_scratch_0_field_id {
    INTER_EE_RESULT,
    GENERIC_EE_RESULT,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum gsi_generic_ee_result {
...
//
extern "C" {
    pub fn gsi_reg_init(gsi: *mut gsi, pdev: *mut platform_device) -> c_int;
}
//
...
//
extern "C" {
    pub fn gsi_reg_exit(gsi: *mut gsi);
}
