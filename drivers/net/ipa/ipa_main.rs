...
//! Source: drivers/net/ipa/ipa_main.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn ipa_setup(ipa: *mut ipa) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ipa_teardown(ipa: *mut ipa) {
...
#[no_mangle]
unsafe extern "C" fn ipa_hardware_config_tx(ipa: *mut ipa) {
    static void ipa_hardware_config_tx(struct ipa *ipa)
    {
    let mut version: enum ipa_version = ipa.version;
    const struct reg *reg;
    u32 offset;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn ipa_hardware_config_clkon(ipa: *mut ipa) {
...
#[no_mangle]
unsafe extern "C" fn ipa_hardware_config_comp(ipa: *mut ipa) {
...
//
#[no_mangle]
unsafe extern "C" fn ipa_aggr_granularity_val(usec: u32) -> __always_inline u32 {
...
//
#[no_mangle]
unsafe extern "C" fn ipa_qtime_config(ipa: *mut ipa) {
...
#[no_mangle]
unsafe extern "C" fn ipa_hardware_config_counter(ipa: *mut ipa) {
    static void ipa_hardware_config_counter(struct ipa *ipa)
    {
    let mut granularity: u32 = ipa_aggr_granularity_val(IPA_AGGR_GRANULARITY);
    const struct reg *reg;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn ipa_hardware_config_timing(ipa: *mut ipa) {
...
#[no_mangle]
unsafe extern "C" fn ipa_hardware_config_hashing(ipa: *mut ipa) {
...
//
#[no_mangle]
unsafe extern "C" fn ipa_hardware_dcd_config(ipa: *mut ipa) {
...
#[no_mangle]
unsafe extern "C" fn ipa_hardware_dcd_deconfig(ipa: *mut ipa) {
...
//
#[no_mangle]
unsafe extern "C" fn ipa_hardware_config(ipa: *mut ipa, data: *const ipa_data) {
...
//
#[no_mangle]
unsafe extern "C" fn ipa_hardware_deconfig(ipa: *mut ipa) {
...
//
#[no_mangle]
unsafe extern "C" fn ipa_config(ipa: *mut ipa, data: *const ipa_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ipa_deconfig(ipa: *mut ipa) {
...
#[no_mangle]
unsafe extern "C" fn ipa_firmware_load(dev: *mut device) -> c_int {
...
// Use name from DTB if specified; use default for *any* error
    ...
    ret = qcom_mdt_load(dev, fw, path, IPA_PAS_ID, virt, phys, size, core::ptr::null_mut());
    if (ret) {
...
//
#[no_mangle]
unsafe extern "C" fn ipa_validate_build() {
...
#[no_mangle]
unsafe extern "C" fn ipa_firmware_loader(dev: *mut device) -> enum ipa_firmware_loader {
...
//
#[no_mangle]
unsafe extern "C" fn ipa_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipa_remove(pdev: *mut platform_device) {
