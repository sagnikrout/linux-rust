...
//! Source: drivers/net/ipa/ipa_reg.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_comp_cfg_field_id {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_clkon_cfg_field_id {
    CLKON_RX,
    CLKON_PROC,
    TX_WRAPPER,
    CLKON_MISC,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_route_field_id {
    ROUTE_DIS,
    ROUTE_DEF_PIPE,
    ROUTE_DEF_HDR_TABLE,
    ROUTE_DEF_HDR_OFST,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_shared_mem_size_field_id {
    MEM_SIZE,
    MEM_BADDR,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_qsb_max_writes_field_id {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_qsb_max_reads_field_id {
    GEN_QMB_0_MAX_READS,
    GEN_QMB_1_MAX_READS,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_filt_rout_hash_field_id {
    IPV6_ROUTER_HASH,
    IPV6_FILTER_HASH,
    IPV4_ROUTER_HASH,
    IPV4_FILTER_HASH,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_filt_rout_cache_field_id {
    ROUTER_CACHE,
    FILTER_CACHE,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_local_pkt_proc_cntxt_field_id {
    IPA_BASE_ADDR,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_counter_cfg_field_id {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_ipa_tx_cfg_field_id {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_flavor_0_field_id {
    MAX_PIPES,
    MAX_CONS_PIPES,
    MAX_PROD_PIPES,
    PROD_LOWEST,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_idle_indication_cfg_field_id {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_qtime_timestamp_cfg_field_id {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_timers_xo_clk_div_cfg_field_id {
    DIV_VALUE,
    DIV_ENABLE,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_timers_pulse_gran_cfg_field_id {
    PULSE_GRAN_0,
    PULSE_GRAN_1,
    PULSE_GRAN_2,
    PULSE_GRAN_3,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_rsrc_grp_rsrc_type_field_id {
    X_MIN_LIM,
    X_MAX_LIM,
    Y_MIN_LIM,
    Y_MAX_LIM,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_init_ctrl_field_id {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_init_cfg_field_id {
    FRAG_OFFLOAD_EN,
    CS_OFFLOAD_EN,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_init_nat_field_id {
    NAT_EN,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_init_hdr_field_id {
    HDR_LEN,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_init_hdr_ext_field_id {
    HDR_ENDIANNESS,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_init_mode_field_id {
    ENDP_MODE,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_init_aggr_field_id {
    AGGR_EN,
    AGGR_TYPE,
    BYTE_LIMIT,
    TIME_LIMIT,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_init_hol_block_en_field_id {
    HOL_BLOCK_EN,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_init_hol_block_timer_field_id {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_deaggr_field_id {
    DEAGGR_HDR_LEN,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_init_rsrc_grp_field_id {
    ENDP_RSRC_GRP,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_init_seq_field_id {
    SEQ_TYPE,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_status_field_id {
    STATUS_EN,
    STATUS_ENDP,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_filter_router_hsh_cfg_field_id {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_endp_cache_cfg_field_id {
    CACHE_MSK_SRC_ID,
    CACHE_MSK_SRC_IP,
    CACHE_MSK_DST_IP,
    CACHE_MSK_SRC_PORT,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ipa_reg_ipa_irq_uc_field_id {
    UC_INTR,
}

extern "C" {
    pub fn ipa_reg_init(ipa: *mut ipa, pdev: *mut platform_device) -> c_int;
}
extern "C" {
    pub fn ipa_reg_exit(ipa: *mut ipa);
}
