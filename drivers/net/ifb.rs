...
pub const TX_Q_LIMIT: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ifb_q_stats {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ifb_q_private {
    pub dev: *mut net_device,
    pub ifb_tasklet: tasklet_struct,
    pub tasklet_pending: c_int,
    pub txqnum: c_int,
    pub rq: sk_buff_head,
    pub tq: sk_buff_head,
    pub rx_stats: ifb_q_stats,
    pub tx_stats: ifb_q_stats,
    pub ____cacheline_aligned_in_smp: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ifb_dev_private {
    pub tx_private: *mut ifb_q_private,
}

// For ethtools stats.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ifb_q_stats_desc {
...
#[no_mangle]
unsafe extern "C" fn ifb_update_q_stats(stats: *mut ifb_q_stats, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ifb_ri_tasklet(t: *mut tasklet_struct) {
    ...
    while ((skb = __skb_dequeue(&txp.tq)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn ifb_dev_init(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ifb_get_strings(dev: *mut net_device, stringset: u32, buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn ifb_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ifb_dev_free(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ifb_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ifb_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t ifb_xmit(struct sk_buff *skb, struct net_device *dev)
    {
    struct ifb_dev_private *dp = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn ifb_close(dev: *mut net_device) -> c_int {
    static int ifb_close(struct net_device *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn ifb_open(dev: *mut net_device) -> c_int {
    static int ifb_open(struct net_device *dev)
    {
...
//
    let mut numifbs: static int = 2;
    module_param(numifbs, int, 0);
    MODULE_PARM_DESC(numifbs, "Number of ifb devices");
#[no_mangle]
unsafe extern "C" fn ifb_init_one(index: c_int) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ifb_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ifb_cleanup_module() -> void __exit {
