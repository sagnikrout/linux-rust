...
//! Source: drivers/net/fjes/fjes_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn is_extended_socket_device(device: *mut acpi_device) -> bool {
    ...
    acpi_status status;
    int result;
    status = acpi_evaluate_object(device.handle, "_STR", core::ptr::null_mut(), &buffer);
...
#[no_mangle]
unsafe extern "C" fn acpi_check_extended_socket_status(device: *mut acpi_device) -> c_int {
    static int acpi_check_extended_socket_status(struct acpi_device *device)
    {
    unsigned long long sta;
    acpi_status status;
    status = acpi_evaluate_integer(device.handle, "_STA", core::ptr::null_mut(), &sta);
    if (ACPI_FAILURE(status))
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn fjes_setup_resources(adapter: *mut fjes_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fjes_rx_irq(adapter: *mut fjes_adapter, src_epid: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fjes_stop_req_irq(adapter: *mut fjes_adapter, src_epid: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fjes_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fjes_request_irq(adapter: *mut fjes_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fjes_free_irq(adapter: *mut fjes_adapter) {
...
#[no_mangle]
unsafe extern "C" fn fjes_free_resources(adapter: *mut fjes_adapter) {
...
#[no_mangle]
unsafe extern "C" fn fjes_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fjes_close(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fjes_change_mtu(netdev: *mut net_device, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fjes_tx_retry(netdev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn fjes_netdev_setup(netdev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn fjes_rxframe_release(adapter: *mut fjes_adapter, cur_epid: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fjes_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fjes_sw_init(adapter: *mut fjes_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fjes_force_close_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn fjes_tx_stall_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn fjes_raise_intr_rxdata_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn fjes_watch_unshare_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn fjes_irq_watch_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn fjes_probe(plat_dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fjes_remove(plat_dev: *mut platform_device) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fjes_acpi_walk_context {
...
#[no_mangle]
unsafe extern "C" fn fjes_init_module() -> int __init {
    ...
    acpi_find_extended_socket_device, core::ptr::null_mut(), &fjes_context,
    core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn fjes_exit_module() -> void __exit {
