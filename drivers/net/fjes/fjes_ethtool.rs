...
//! Source: drivers/net/fjes/fjes_ethtool.c
#![no_std]
...
pub const FJES_EP_STATS_LEN: c_int = 14;
...
#[no_mangle]
unsafe extern "C" fn fjes_get_sset_count(netdev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fjes_get_regs_len(netdev: *mut net_device) -> c_int {
    static int fjes_get_regs_len(struct net_device *netdev)
    {
pub const FJES_REGS_LEN: c_int = 37;
...
#[no_mangle]
unsafe extern "C" fn fjes_set_dump(netdev: *mut net_device, dump: *mut ethtool_dump) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fjes_set_ethtool_ops(netdev: *mut net_device) {
