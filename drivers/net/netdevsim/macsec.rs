...
//! Source: drivers/net/netdevsim/macsec.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nsim_macsec_find_secy(ns: *mut netdevsim, sci: sci_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsim_macsec_find_rxsc(ns_secy: *mut nsim_secy, sci: sci_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsim_macsec_add_secy(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsim_macsec_upd_secy(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsim_macsec_del_secy(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsim_macsec_add_rxsc(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsim_macsec_upd_rxsc(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsim_macsec_del_rxsc(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsim_macsec_add_rxsa(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsim_macsec_upd_rxsa(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsim_macsec_del_rxsa(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsim_macsec_add_txsa(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsim_macsec_upd_txsa(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsim_macsec_del_txsa(ctx: *mut macsec_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nsim_macsec_init(ns: *mut netdevsim) {
...
#[no_mangle]
pub unsafe extern "C" fn nsim_macsec_teardown(ns: *mut netdevsim) {
