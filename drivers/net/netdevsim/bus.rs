...
//! Source: drivers/net/netdevsim/bus.c
#![no_std]
...
// Prevent to use nsim_bus_dev before initialization.
    ...
    addr_set ? eth_addr : core::ptr::null_mut());
    return ret ? ret : count;
    }
    let mut nsim_bus_dev_new_port_attr: static struct device_attribute = __ATTR_WO(new_port);
    static ssize_t
...
// Prevent to use nsim_bus_dev before initialization.
    ...
    let mut nsim_bus_dev_del_port_attr: static struct device_attribute = __ATTR_WO(del_port);
...
#[no_mangle]
unsafe extern "C" fn nsim_bus_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn link_device_store(bus: *const bus_type, buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn unlink_device_store(bus: *const bus_type, buf: *const c_char, count: usize) -> isize {
    ...
    err = 0;
    RCU_INIT_POINTER(nsim.peer, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn nsim_bus_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsim_bus_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn nsim_num_vf(dev: *mut device) -> c_int {
...
// Disallow using nsim_bus_dev
    ...
    nsim_bus_dev = core::ptr::null_mut();
    err_nsim_bus_dev_free:
    kfree(nsim_bus_dev);
    return ERR_PTR(err);
    }
#[no_mangle]
unsafe extern "C" fn nsim_bus_dev_del(nsim_bus_dev: *mut nsim_bus_dev) {
    static void nsim_bus_dev_del(struct nsim_bus_dev *nsim_bus_dev)
    {
// Disallow using nsim_bus_dev
    smp_store_release(&nsim_bus_dev.init, false);
...
#[no_mangle]
pub unsafe extern "C" fn nsim_bus_init() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nsim_bus_exit() {
