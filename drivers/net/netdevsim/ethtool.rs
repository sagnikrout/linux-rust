...
//! Source: drivers/net/netdevsim/ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nsim_ethtool_ring_init(ns: *mut netdevsim) {
...
#[no_mangle]
pub unsafe extern "C" fn nsim_ethtool_init(ns: *mut netdevsim) {
...
#[no_mangle]
pub unsafe extern "C" fn nsim_ethtool_fini(ns: *mut netdevsim) {
