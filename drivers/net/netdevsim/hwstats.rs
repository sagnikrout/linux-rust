...
//! Source: drivers/net/netdevsim/hwstats.c
#![no_std]
...
pub const NSIM_DEV_HWSTATS_TRAFFIC_MS: c_int = 100;
...
#[no_mangle]
unsafe extern "C" fn nsim_dev_hwstats_traffic_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nsim_dev_hwsdev_disable(hwsdev: *mut nsim_dev_hwstats_netdev) {
...
#[no_mangle]
unsafe extern "C" fn nsim_dev_hwsdev_fini(hwsdev: *mut nsim_dev_hwstats_netdev) {
    ...
    nsim_dev_hwsdev_enable(hwsdev, core::ptr::null_mut());
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nsim_dev_hwstats_fops {
    pub action: enum nsim_dev_hwstats_do,
    pub type: enum netdev_offload_xstats_type,
}
...
#[no_mangle]
pub unsafe extern "C" fn nsim_dev_hwstats_init(nsim_dev: *mut nsim_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nsim_dev_hwstats_exit(nsim_dev: *mut nsim_dev) {
