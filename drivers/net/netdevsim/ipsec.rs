...
//! Source: drivers/net/netdevsim/ipsec.c
#![no_std]
...
pub const NSIM_IPSEC_AUTH_BITS: c_int = 128;
...
#[no_mangle]
unsafe extern "C" fn nsim_ipsec_find_empty_idx(ipsec: *mut nsim_ipsec) -> c_int {
...
// search sa table
    ...
    char *alg_name = core::ptr::null_mut();
    int key_len;
    if (!xs.aead) {
...
#[no_mangle]
unsafe extern "C" fn nsim_ipsec_del_sa(dev: *mut net_device, xs: *mut xfrm_state) {
...
#[no_mangle]
pub unsafe extern "C" fn nsim_ipsec_tx(ns: *mut netdevsim, skb: *mut sk_buff) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nsim_ipsec_init(ns: *mut netdevsim) {
...
#[no_mangle]
pub unsafe extern "C" fn nsim_ipsec_teardown(ns: *mut netdevsim) {
