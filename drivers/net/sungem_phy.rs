...
//! Source: drivers/net/sungem_phy.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __sungem_phy_read(phy: *mut *mut mii_phy, id: c_int, reg: c_int) -> c_int {
    static inline int __sungem_phy_read(struct mii_phy* phy, int id, int reg)
    {
    return phy.mdio_read(phy.dev, id, reg);
    }
#[no_mangle]
pub unsafe extern "C" fn __sungem_phy_write(phy: *mut *mut mii_phy, id: c_int, reg: c_int, val: c_int) {
    static inline void __sungem_phy_write(struct mii_phy* phy, int id, int reg, int val)
    {
    phy.mdio_write(phy.dev, id, reg, val);
    }
#[no_mangle]
pub unsafe extern "C" fn sungem_phy_read(phy: *mut *mut mii_phy, reg: c_int) -> c_int {
    static inline int sungem_phy_read(struct mii_phy* phy, int reg)
    {
    return phy.mdio_read(phy.dev, phy.mii_id, reg);
    }
#[no_mangle]
pub unsafe extern "C" fn sungem_phy_write(phy: *mut *mut mii_phy, reg: c_int, val: c_int) {
    static inline void sungem_phy_write(struct mii_phy* phy, int reg, int val)
    {
    phy.mdio_write(phy.dev, phy.mii_id, reg, val);
    }
#[no_mangle]
unsafe extern "C" fn reset_one_mii_phy(phy: *mut *mut mii_phy, phy_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5201_init(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5201_suspend(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5221_init(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5221_suspend(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5241_init(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5241_suspend(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5400_init(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5400_suspend(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5401_init(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5401_suspend(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5411_init(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn genmii_setup_aneg(phy: *mut mii_phy, advertise: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn genmii_setup_forced(phy: *mut mii_phy, speed: c_int, fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn genmii_poll_link(phy: *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn genmii_read_link(phy: *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn generic_suspend(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5421_init(phy: *mut *mut mii_phy) -> c_int {
...
// Check if we can enable automatic low power
    ...
    let mut can_low_power: c_int = 1;
    if (np == core::ptr::null_mut() || of_get_property(np, "no-autolowpower", core::ptr::null_mut()))
    can_low_power = 0;
    of_node_put(np);
    if (can_low_power) {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_setup_aneg(phy: *mut mii_phy, advertise: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_setup_forced(phy: *mut mii_phy, speed: c_int, fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_read_link(phy: *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn marvell88e1111_init(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5421_poll_link(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5421_read_link(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5421_enable_fiber(phy: *mut *mut mii_phy, autoneg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5461_poll_link(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5461_read_link(phy: *mut *mut mii_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5461_enable_fiber(phy: *mut *mut mii_phy, autoneg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn marvell_setup_aneg(phy: *mut mii_phy, advertise: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn marvell_setup_forced(phy: *mut mii_phy, speed: c_int, fd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn marvell_read_link(phy: *mut mii_phy) -> c_int {
    ...
    phy.speed = SPEED_1000;
#[no_mangle]
pub unsafe extern "C" fn if(MII_M1011_PHY_SPEC_STATUS_100: status &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn sungem_phy_probe(phy: *mut mii_phy, mii_id: c_int) -> c_int {
...
// Read ID and find matching entry
    ...
    id, mii_id);
    for (i=0; (def = mii_phy_table[i]) != core::ptr::null_mut(); i++)
    if ((id & def.phy_id_mask) == def.phy_id)
    break;
// Should never be NULL (we have a generic entry), but...
    if (def == core::ptr::null_mut())
    goto fail;
    phy.def = def;
    return 0;
    fail:
