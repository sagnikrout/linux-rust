...
//! Source: drivers/net/phy/bcm-phy-ptp.c
#![no_std]
...
pub const SLICE_CTRL: c_uint = 0x0810;

pub const TX_EVENT_MODE: c_uint = 0x0811;

pub const RX_EVENT_MODE: c_uint = 0x0819;

pub const MODE_EVT_SHIFT_SYNC: c_int = 0;
pub const MODE_EVT_SHIFT_DELAY_REQ: c_int = 2;
pub const MODE_EVT_SHIFT_PDELAY_REQ: c_int = 4;
pub const MODE_EVT_SHIFT_PDELAY_RESP: c_int = 6;
pub const MODE_SEL_SHIFT_PORT: c_int = 0;
pub const MODE_SEL_SHIFT_CPU: c_int = 8;
...
pub const TX_TS_CAPTURE: c_uint = 0x0821;

pub const RX_TS_CAPTURE: c_uint = 0x0822;

pub const TIME_CODE_0: c_uint = 0x0854;
pub const TIME_CODE_1: c_uint = 0x0855;
pub const TIME_CODE_2: c_uint = 0x0856;
pub const TIME_CODE_3: c_uint = 0x0857;
pub const TIME_CODE_4: c_uint = 0x0858;
pub const DPLL_SELECT: c_uint = 0x085b;

pub const SHADOW_CTRL: c_uint = 0x085c;
pub const SHADOW_LOAD: c_uint = 0x085d;

pub const INTR_MASK: c_uint = 0x085e;
pub const INTR_STATUS: c_uint = 0x085f;

pub const NCO_FREQ_LSB: c_uint = 0x0873;
pub const NCO_FREQ_MSB: c_uint = 0x0874;
pub const NCO_TIME_0: c_uint = 0x0875;
pub const NCO_TIME_1: c_uint = 0x0876;
pub const NCO_TIME_2_CTRL: c_uint = 0x0877;

pub const SYNC_OUT_0: c_uint = 0x0878;
pub const SYNC_OUT_1: c_uint = 0x0879;
pub const SYNC_OUT_2: c_uint = 0x087a;
pub const SYNC_IN_DIVIDER: c_uint = 0x087b;
pub const SYNOUT_TS_0: c_uint = 0x087c;
pub const SYNOUT_TS_1: c_uint = 0x087d;
pub const SYNOUT_TS_2: c_uint = 0x087e;
pub const NSE_CTRL: c_uint = 0x087f;

pub const TS_READ_CTRL: c_uint = 0x0885;

pub const HB_REG_0: c_uint = 0x0886;
pub const HB_REG_1: c_uint = 0x0887;
pub const HB_REG_2: c_uint = 0x0888;
pub const HB_REG_3: c_uint = 0x08ec;
pub const HB_REG_4: c_uint = 0x08ed;
pub const HB_STAT_CTRL: c_uint = 0x088e;

pub const TS_REG_0: c_uint = 0x0889;
pub const TS_REG_1: c_uint = 0x088a;
pub const TS_REG_2: c_uint = 0x088b;
pub const TS_REG_3: c_uint = 0x08c4;
pub const TS_INFO_0: c_uint = 0x088c;
pub const TS_INFO_1: c_uint = 0x088d;
pub const TIMECODE_CTRL: c_uint = 0x08c3;

pub const TIME_SYNC: c_uint = 0x0ff5;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm_ptp_private {
    pub phydev: *mut phy_device,
    pub mii_ts: mii_timestamper,
    pub ptp_clock: *mut ptp_clock,
    pub ptp_info: ptp_clock_info,
    pub pin: ptp_pin_desc,
    pub mutex: mutex,
    ...
    pub nse_ctrl: u16,
    pub pin_active: bool,
    pub pin_work: delayed_work,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm_ptp_skb_cb {
    pub timeout: c_ulong,
    pub seq_id: u16,
    pub msgtype: u8,
    pub discard: bool,
...
#[no_mangle]
unsafe extern "C" fn bcm_ptp_framesync_disable(phydev: *mut phy_device, orig_ctrl: u16) -> u16 {
    static u16 bcm_ptp_framesync_disable(struct phy_device *phydev, u16 orig_ctrl)
    {
    let mut ctrl: u16 = orig_ctrl & ~(NSE_FRAMESYNC_MASK | NSE_CAPTURE_EN);
    bcm_phy_write_exp(phydev, NSE_CTRL, ctrl);
    return ctrl;
    }
#[no_mangle]
unsafe extern "C" fn bcm_ptp_framesync_restore(phydev: *mut phy_device, orig_ctrl: u16) {
...
#[no_mangle]
unsafe extern "C" fn bcm_ptp_framesync(phydev: *mut phy_device, ctrl: u16) {
...
// must have NSE_INIT in order to write time code
    ...
    int err;
    s64 ns;
    err = bcm_ptp_framesync_ts(priv.phydev, core::ptr::null_mut(), &ts, priv.nse_ctrl);
    if (!err) {
...
#[no_mangle]
unsafe extern "C" fn bcm_ptp_adjtime(info: *mut ptp_clock_info, delta_ns: i64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm_ptp_adjfine(info: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_ptp_do_aux_work(info: *mut ptp_clock_info) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn bcm_ptp_cancel_func(priv: *mut bcm_ptp_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_ptp_perout_work(pin_work: *mut work_struct) {
...
// no longer running
    ...
    bcm_ptp_framesync_ts(phydev, core::ptr::null_mut(), &ts, priv.nse_ctrl);
// this is 1PPS only
...
#[no_mangle]
unsafe extern "C" fn bcm_ptp_extts_work(pin_work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn bcm_ptp_extts_locked(priv: *mut bcm_ptp_private, on: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bcm_ptp_stop(priv: *mut bcm_ptp_private) {
...
#[no_mangle]
pub unsafe extern "C" fn bcm_ptp_config_init(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn bcm_ptp_init(priv: *mut bcm_ptp_private) {
