...
pub const PHY_EDPD_CONFIG: c_int = 16;
pub const PHY_EDPD_CONFIG_EXT_CROSSOVER_: c_uint = 0x0001;
// Control/Status Indication Register
pub const SPECIAL_CTRL_STS: c_int = 27;
pub const SPECIAL_CTRL_STS_OVRRD_AMDIX_: c_uint = 0x8000;
pub const SPECIAL_CTRL_STS_AMDIX_ENABLE_: c_uint = 0x4000;
pub const SPECIAL_CTRL_STS_AMDIX_STATE_: c_uint = 0x2000;
pub const EDPD_MAX_WAIT_DFLT_MS: c_int = 640;
// interval between phylib state machine runs in ms
pub const PHY_STATE_MACH_MS: c_int = 1000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct smsc_hw_stat {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct smsc_phy_priv {
    pub edpd_enable:1: c_uint,
    pub edpd_mode_set_by_user:1: c_uint,
    pub edpd_max_wait_ms: c_uint,
    pub wol_arp: bool,
}

#[no_mangle]
unsafe extern "C" fn smsc_phy_ack_interrupt(phydev: *mut phy_device) -> c_int {
    static int smsc_phy_ack_interrupt(struct phy_device *phydev)
    {
    let mut rc: c_int = phy_read(phydev, MII_LAN83C185_ISF);
    return rc < 0 ? rc : 0;
    }
#[no_mangle]
pub unsafe extern "C" fn smsc_phy_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsc_phy_config_edpd(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smsc_phy_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn smsc_phy_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsc_phy_reset(phydev: *mut phy_device) -> c_int {
    static int smsc_phy_reset(struct phy_device *phydev)
    {
    let mut rc: c_int = phy_read(phydev, MII_LAN83C185_SPECIAL_MODES);
    if (rc < 0)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn lan95xx_config_aneg_ext(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn lan87xx_read_status(phydev: *mut phy_device) -> c_int {
    ...
    let mut max_wait: c_uint = priv.edpd_max_wait_ms * 1000;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn lan87xx_phy_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan874x_phy_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsc_crc16(buffer: *const u8, len: usize) -> u16 {
...
// Need to match multicast destination address.
    ...
    rc = lan874x_set_wol_pattern(phydev, val, data, 0, core::ptr::null_mut(), 0);
    if (rc < 0)
    return rc;
    priv.wol_arp = false;
    }
...
#[no_mangle]
unsafe extern "C" fn smsc_get_sset_count(phydev: *mut phy_device) -> c_int {
    static int smsc_get_sset_count(struct phy_device *phydev)
    {
    return ARRAY_SIZE(smsc_hw_stats);
    }
#[no_mangle]
unsafe extern "C" fn smsc_get_strings(phydev: *mut phy_device, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn smsc_get_stat(phydev: *mut phy_device, i: c_int) -> u64 {
    static u64 smsc_get_stat(struct phy_device *phydev, int i)
    {
    let mut stat: smsc_hw_stat = smsc_hw_stats[i];
    int val;
    u64 ret;
...
#[no_mangle]
unsafe extern "C" fn smsc_phy_get_edpd(phydev: *mut phy_device, edpd: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !priv->edpd_max_wait_ms) -> else {
...
#[no_mangle]
unsafe extern "C" fn smsc_phy_set_edpd(phydev: *mut phy_device, edpd: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smsc_phy_probe(phydev: *mut phy_device) -> c_int {
...
// Make clk optional to keep DTB backward compatibility.
    refclk = devm_clk_get_optional_enabled_with_rate(dev, core::ptr::null_mut(),
    50 * 1000 * 1000);
    if (IS_ERR(refclk))
