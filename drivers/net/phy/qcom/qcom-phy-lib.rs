...
//! Source: drivers/net/phy/qcom/qcom-phy-lib.c
#![no_std]
...
// SPDX-License-Identifier: GPL-2.0
    ...
    MODULE_LICENSE("GPL");
#[no_mangle]
pub unsafe extern "C" fn at803x_debug_reg_read(phydev: *mut phy_device, reg: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn at803x_debug_reg_write(phydev: *mut phy_device, reg: u16, data: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn at803x_ack_interrupt(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn at803x_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn at803x_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn at803x_config_mdix(phydev: *mut phy_device, ctrl: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn at803x_prepare_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn at803x_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at803x_get_downshift(phydev: *mut phy_device, d: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at803x_set_downshift(phydev: *mut phy_device, cnt: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn at803x_cdt_fault_length(dt: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn at803x_cdt_start(phydev: *mut phy_device, cdt_start: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qca808x_cdt_fault_length_valid(cdt_code: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qca808x_cable_test_result_trans(cdt_code: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qca808x_cable_test_get_status(phydev: *mut phy_device, finished: *mut bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qca808x_led_reg_hw_control_enable(phydev: *mut phy_device, reg: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qca808x_led_reg_hw_control_status(phydev: *mut phy_device, reg: u16) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn qcom_phy_counter_config(phydev: *mut phy_device) -> c_int {
