...
//! Source: drivers/net/phy/dp83822.c
#![no_std]
...
pub const DP83822_PHY_ID: c_uint = 0x2000a240;
pub const DP83825S_PHY_ID: c_uint = 0x2000a140;
pub const DP83825I_PHY_ID: c_uint = 0x2000a150;
pub const DP83825CM_PHY_ID: c_uint = 0x2000a160;
pub const DP83825CS_PHY_ID: c_uint = 0x2000a170;
pub const DP83826C_PHY_ID: c_uint = 0x2000a130;
pub const DP83826NC_PHY_ID: c_uint = 0x2000a110;
pub const MII_DP83822_CTRL_2: c_uint = 0x0a;
pub const MII_DP83822_PHYSTS: c_uint = 0x10;
pub const MII_DP83822_PHYSCR: c_uint = 0x11;
pub const MII_DP83822_MISR1: c_uint = 0x12;
pub const MII_DP83822_MISR2: c_uint = 0x13;
pub const MII_DP83822_FCSCR: c_uint = 0x14;
pub const MII_DP83822_RCSR: c_uint = 0x17;
pub const MII_DP83822_RESET_CTRL: c_uint = 0x1f;
pub const MII_DP83822_MLEDCR: c_uint = 0x25;
pub const MII_DP83822_LDCTRL: c_uint = 0x403;
pub const MII_DP83822_LEDCFG1: c_uint = 0x460;
pub const MII_DP83822_IOCTRL: c_uint = 0x461;
pub const MII_DP83822_IOCTRL1: c_uint = 0x462;
pub const MII_DP83822_IOCTRL2: c_uint = 0x463;
pub const MII_DP83822_GENCFG: c_uint = 0x465;
pub const MII_DP83822_SOR1: c_uint = 0x467;
// DP83826 specific registers
pub const MII_DP83826_VOD_CFG1: c_uint = 0x30b;
pub const MII_DP83826_VOD_CFG2: c_uint = 0x30c;
// GENCFG
...
pub const MII_DP83822_RXSOP1: c_uint = 0x04a5;
pub const MII_DP83822_RXSOP2: c_uint = 0x04a6;
pub const MII_DP83822_RXSOP3: c_uint = 0x04a7;
// WoL Registers
pub const MII_DP83822_WOL_CFG: c_uint = 0x04a0;
pub const MII_DP83822_WOL_STAT: c_uint = 0x04a1;
pub const MII_DP83822_WOL_DA1: c_uint = 0x04a2;
pub const MII_DP83822_WOL_DA2: c_uint = 0x04a3;
pub const MII_DP83822_WOL_DA3: c_uint = 0x04a4;
// WoL bits
...
pub const DP83822_CLK_SRC_MAC_IF: c_uint = 0x0;
pub const DP83822_CLK_SRC_XI: c_uint = 0x1;
pub const DP83822_CLK_SRC_INT_REF: c_uint = 0x2;
pub const DP83822_CLK_SRC_RMII_MASTER_MODE_REF: c_uint = 0x4;
pub const DP83822_CLK_SRC_FREE_RUNNING: c_uint = 0x6;
pub const DP83822_CLK_SRC_RECOVERED: c_uint = 0x7;
pub const DP83822_LED_FN_LINK: c_uint = 0x0 /* Link established */;
pub const DP83822_LED_FN_RX_TX: c_uint = 0x1 /* Receive or Transmit activity */;
pub const DP83822_LED_FN_TX: c_uint = 0x2 /* Transmit activity */;
pub const DP83822_LED_FN_RX: c_uint = 0x3 /* Receive activity */;
pub const DP83822_LED_FN_COLLISION: c_uint = 0x4 /* Collision detected */;
pub const DP83822_LED_FN_LINK_100_BTX: c_uint = 0x5 /* 100 BTX link established */;
pub const DP83822_LED_FN_LINK_10_BT: c_uint = 0x6 /* 10BT link established */;
pub const DP83822_LED_FN_FULL_DUPLEX: c_uint = 0x7 /* Full duplex */;
pub const DP83822_LED_FN_LINK_RX_TX: c_uint = 0x8 /* Link established, blink for rx or tx activity */;
pub const DP83822_LED_FN_ACTIVE_STRETCH: c_uint = 0x9 /* Active Stretch Signal */;
pub const DP83822_LED_FN_MII_LINK: c_uint = 0xa /* MII LINK (100BT+FD) */;
pub const DP83822_LED_FN_LPI_MODE: c_uint = 0xb /* LPI Mode (EEE) */;
pub const DP83822_LED_FN_RX_TX_ERR: c_uint = 0xc /* TX/RX MII Error */;
pub const DP83822_LED_FN_LINK_LOST: c_uint = 0xd /* Link Lost */;
pub const DP83822_LED_FN_PRBS_ERR: c_uint = 0xe /* Blink for PRBS error */;
// SOR1 mode
pub const DP83822_STRAP_MODE1: c_int = 0;

pub const DP83822_COL_SHIFT: c_int = 10;

pub const DP83822_RX_ER_SHIFT: c_int = 8;
// DP83826: VOD_CFG1 & VOD_CFG2

pub const DP83826_CFG_DAC_PERCENT_PER_STEP: c_int = 625;
pub const DP83826_CFG_DAC_PERCENT_DEFAULT: c_int = 10000;
pub const DP83826_CFG_DAC_MINUS_DEFAULT: c_uint = 0x30;
pub const DP83826_CFG_DAC_PLUS_DEFAULT: c_uint = 0x10;

    ADVERTISED_FIBRE | \
    ADVERTISED_Pause | ADVERTISED_Asym_Pause)
pub const DP83822_MAX_LED_PINS: c_int = 4;
pub const DP83822_LED_INDEX_LED_0: c_int = 0;
pub const DP83822_LED_INDEX_LED_1_GPIO1: c_int = 1;
pub const DP83822_LED_INDEX_COL_GPIO2: c_int = 2;
pub const DP83822_LED_INDEX_RX_D3_GPIO3: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dp83822_private {
    pub fx_signal_det_low: bool,
    pub fx_enabled: c_int,
    pub fx_sd_enable: u16,
    pub cfg_dac_minus: u8,
    pub cfg_dac_plus: u8,
    pub wol: ethtool_wolinfo,
    pub set_gpio2_clk_out: bool,
    pub gpio2_clk_out: u32,
    pub led_pin_enable: [bool; DP83822_MAX_LED_PINS],
    pub tx_amplitude_100base_tx_index: c_int,
    pub mac_termination_index: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn dp83822_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83822_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dp83822_read_status(phydev: *mut phy_device) -> c_int {
    static int dp83822_read_status(struct phy_device *phydev)
    {
    struct dp83822_private *dp83822 = phydev.priv;
    let mut status: c_int = phy_read(phydev, MII_DP83822_PHYSTS);
    int ctrl2;
    int ret;
    if (dp83822.fx_enabled) {
...
#[no_mangle]
unsafe extern "C" fn dp83822_config_init_leds(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83822_config_init(phydev: *mut phy_device) -> c_int {
    static int dp83822_config_init(struct phy_device *phydev)
    {
    struct dp83822_private *dp83822 = phydev.priv;
    let mut rgmii_delay: c_int = 0;
    s32 rx_int_delay;
    s32 tx_int_delay;
    let mut err: c_int = 0;
    int bmcr;
    ...
    rx_int_delay = phy_get_internal_delay(phydev, core::ptr::null_mut(), 0, true);
// Set DP83822_RX_CLK_SHIFT to enable rx clk internal delay
    if (rx_int_delay > 0)
    rgmii_delay |= DP83822_RX_CLK_SHIFT;
    tx_int_delay = phy_get_internal_delay(phydev, core::ptr::null_mut(), 0, false);
...
#[no_mangle]
unsafe extern "C" fn dp8382x_config_rmii_mode(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83826_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83825_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83822_phy_reset(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83822_of_init_leds(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83822_of_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83826_to_dac_minus_one_regval(percent: c_int) -> c_int {
    static int dp83826_to_dac_minus_one_regval(int percent)
    {
    let mut tmp: c_int = DP83826_CFG_DAC_PERCENT_DEFAULT - percent;
    return tmp / DP83826_CFG_DAC_PERCENT_PER_STEP;
    }
#[no_mangle]
unsafe extern "C" fn dp83826_to_dac_plus_one_regval(percent: c_int) -> c_int {
    static int dp83826_to_dac_plus_one_regval(int percent)
    {
    let mut tmp: c_int = percent - DP83826_CFG_DAC_PERCENT_DEFAULT;
    return tmp / DP83826_CFG_DAC_PERCENT_PER_STEP;
    }
#[no_mangle]
unsafe extern "C" fn dp83826_of_init(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn dp83822_read_straps(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp8382x_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83822_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83826_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83822_suspend(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83822_resume(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83822_led_mode(index: u8, rules: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(DP83822_LED_INDEX_LED_1_GPIO1: index ==) -> else {
