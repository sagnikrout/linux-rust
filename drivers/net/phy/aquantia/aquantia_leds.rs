...
//! Source: drivers/net/phy/aquantia/aquantia_leds.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn aqr_phy_led_active_low_set(phydev: *mut phy_device, index: c_int, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aqr_phy_led_polarity_set(phydev: *mut phy_device, index: c_int, modes: c_ulong) -> c_int {
