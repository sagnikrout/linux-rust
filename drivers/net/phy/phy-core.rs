...
//! Source: drivers/net/phy/phy-core.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_interface_num_ports(interface: phy_interface_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __set_phy_supported(phydev: *mut phy_device, max_speed: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_set_max_speed(phydev: *mut phy_device, max_speed: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn of_set_phy_supported(phydev: *mut phy_device) {
...
#[no_mangle]
pub unsafe extern "C" fn of_set_phy_eee_broken(phydev: *mut phy_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_set_phy_timing_role(phydev: *mut phy_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(master, 0: "forced-slave") ==) -> else {
    else if (strcmp(master, "forced-slave") == 0)
    phydev.master_slave_set = MASTER_SLAVE_CFG_SLAVE_FORCE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(master, 0: "preferred-master") ==) -> else {
    else if (strcmp(master, "preferred-master") == 0)
    phydev.master_slave_set = MASTER_SLAVE_CFG_MASTER_PREFERRED;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(master, 0: "preferred-slave") ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_resolve_aneg_pause(phydev: *mut phy_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_resolve_aneg_linkmode(phydev: *mut phy_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_check_downshift(phydev: *mut phy_device) {
    void phy_check_downshift(struct phy_device *phydev)
    {
    __ETHTOOL_DECLARE_LINK_MODE_MASK(common);
    const struct link_capabilities *c;
    let mut speed: c_int = SPEED_UNKNOWN;
...
#[no_mangle]
unsafe extern "C" fn phy_resolve_min_speed(phydev: *mut phy_device, fdx_only: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn phy_speed_down_core(phydev: *mut phy_device) -> c_int {
    int phy_speed_down_core(struct phy_device *phydev)
    {
    let mut min_common_speed: c_int = phy_resolve_min_speed(phydev, true);
...
//
#[no_mangle]
pub unsafe extern "C" fn __phy_read_mmd(phydev: *mut phy_device, devad: c_int, regnum: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_read_mmd(phydev: *mut phy_device, devad: c_int, regnum: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __phy_write_mmd(phydev: *mut phy_device, devad: c_int, regnum: u32, val: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_write_mmd(phydev: *mut phy_device, devad: c_int, regnum: u32, val: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_modify_changed(phydev: *mut phy_device, regnum: u32, mask: u16, set: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __phy_modify(phydev: *mut phy_device, regnum: u32, mask: u16, set: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_modify(phydev: *mut phy_device, regnum: u32, mask: u16, set: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __phy_read_page(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __phy_write_page(phydev: *mut phy_device, page: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_save_page(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_select_page(phydev: *mut phy_device, page: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_restore_page(phydev: *mut phy_device, oldpage: c_int, ret: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_read_paged(phydev: *mut phy_device, page: c_int, regnum: u32) -> c_int {
    int phy_read_paged(struct phy_device *phydev, int page, u32 regnum)
    {
    let mut ret: c_int = 0, oldpage;
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_write_paged(phydev: *mut phy_device, page: c_int, regnum: u32, val: u16) -> c_int {
...
//
    ...
    u16 mask, u16 set)
    {
    let mut ret: c_int = phy_modify_paged_changed(phydev, page, regnum, mask, set);
    return ret < 0 ? ret : 0;
    }
