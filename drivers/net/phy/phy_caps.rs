...
//! Source: drivers/net/phy/phy_caps.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn speed_duplex_to_capa(speed: c_int, duplex: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_caps_init() -> int __init {
...
//
    ...
    bool exact)
    {
    const struct link_capabilities *lcap, *match = core::ptr::null_mut(), *last = core::ptr::null_mut();
    for_each_link_caps_desc_speed(lcap) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_caps_linkmode_max_speed(max_speed: u32, linkmodes: *mut c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_caps_valid(speed: c_int, duplex: c_int, linkmodes: *const c_ulong) -> bool {
    bool phy_caps_valid(int speed, int duplex, const unsigned long *linkmodes)
    {
    let mut capa: c_int = speed_duplex_to_capa(speed, duplex);
    if (capa < 0)
    return false;
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_caps_linkmodes(caps: c_ulong, linkmodes: *mut c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_caps_from_interface(interface: phy_interface_t) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_caps_mediums_from_linkmodes(linkmodes: *mut c_ulong) -> u32 {
    u32 phy_caps_mediums_from_linkmodes(unsigned long *linkmodes)
    {
    const struct link_mode_info *linkmode;
    let mut mediums: u32 = 0;
    int i;
