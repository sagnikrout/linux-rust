...
//! Source: drivers/net/phy/microchip_t1s.c
#![no_std]
...
pub const PHY_ID_LAN867X_REVB1: c_uint = 0x0007C162;
pub const PHY_ID_LAN867X_REVC1: c_uint = 0x0007C164;
pub const PHY_ID_LAN867X_REVC2: c_uint = 0x0007C165;
pub const PHY_ID_LAN867X_REVD0: c_uint = 0x0007C166;
// Both Rev.B0 and B1 clause 22 PHYID's are same due to B1 chip limitation
pub const PHY_ID_LAN865X_REVB: c_uint = 0x0007C1B3;
pub const LAN867X_REG_STS2: c_uint = 0x0019;

pub const LAN865X_REG_CFGPARAM_ADDR: c_uint = 0x00D8;
pub const LAN865X_REG_CFGPARAM_DATA: c_uint = 0x00D9;
pub const LAN865X_REG_CFGPARAM_CTRL: c_uint = 0x00DA;
pub const LAN865X_REG_STS2: c_uint = 0x0019;
// Collision Detector Control 0 Register
pub const LAN86XX_REG_COL_DET_CTRL0: c_uint = 0x0087;

pub const COL_DET_DISABLE: c_uint = 0x0000;
// LAN8670/1/2 Rev.D0 Link Status Selection Register
pub const LAN867X_REG_LINK_STATUS_CTRL: c_uint = 0x0012;

// Link Status Configuration
pub const LINK_STATUS_CONFIG_PLCA_STATUS: c_uint = 0x1;
pub const LINK_STATUS_CONFIG_SEMAPHORE: c_uint = 0x2;
pub const LINK_STATUS_SEMAPHORE_SET: c_uint = 0x1;
...
//
#[no_mangle]
unsafe extern "C" fn lan865x_revb_indirect_read(phydev: *mut phy_device, addr: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lan865x_generate_cfg_offsets(phydev: *mut phy_device, offsets[]: i8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan865x_setup_cfgparam(phydev: *mut phy_device, offsets[]: i8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan865x_setup_sqi_cfgparam(phydev: *mut phy_device, offsets[]: i8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan865x_revb_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan867x_check_reset_complete(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan867x_revc_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan867x_revb1_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan867x_revd0_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan86xx_read_status(phydev: *mut phy_device) -> c_int {
