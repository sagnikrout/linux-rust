...
//! Source: drivers/net/phy/dp83867.c
#![no_std]
...
pub const DP83867_PHY_ID: c_uint = 0x2000a231;
pub const DP83867_DEVADDR: c_uint = 0x1f;
pub const MII_DP83867_PHYCTRL: c_uint = 0x10;
pub const MII_DP83867_PHYSTS: c_uint = 0x11;
pub const MII_DP83867_MICR: c_uint = 0x12;
pub const MII_DP83867_ISR: c_uint = 0x13;
pub const DP83867_CFG2: c_uint = 0x14;
pub const DP83867_LEDCR1: c_uint = 0x18;
pub const DP83867_LEDCR2: c_uint = 0x19;
pub const DP83867_CFG3: c_uint = 0x1e;
pub const DP83867_CTRL: c_uint = 0x1f;
// Extended Registers
pub const DP83867_FLD_THR_CFG: c_uint = 0x002e;
pub const DP83867_CFG4: c_uint = 0x0031;

pub const DP83867_RGMIICTL: c_uint = 0x0032;
pub const DP83867_STRAP_STS1: c_uint = 0x006E;
pub const DP83867_STRAP_STS2: c_uint = 0x006f;
pub const DP83867_RGMIIDCTL: c_uint = 0x0086;
pub const DP83867_DSP_FFE_CFG: c_uint = 0x012c;
pub const DP83867_RXFCFG: c_uint = 0x0134;
pub const DP83867_RXFPMD1: c_uint = 0x0136;
pub const DP83867_RXFPMD2: c_uint = 0x0137;
pub const DP83867_RXFPMD3: c_uint = 0x0138;
pub const DP83867_RXFSOP1: c_uint = 0x0139;
pub const DP83867_RXFSOP2: c_uint = 0x013A;
pub const DP83867_RXFSOP3: c_uint = 0x013B;
pub const DP83867_IO_MUX_CFG: c_uint = 0x0170;
pub const DP83867_SGMIICTL: c_uint = 0x00D3;
pub const DP83867_10M_SGMII_CFG: c_uint = 0x016F;
...
// PHY CTRL bits
pub const DP83867_PHYCR_TX_FIFO_DEPTH_SHIFT: c_int = 14;
pub const DP83867_PHYCR_RX_FIFO_DEPTH_SHIFT: c_int = 12;
pub const DP83867_PHYCR_FIFO_DEPTH_MAX: c_uint = 0x03;

// RGMIIDCTL bits
pub const DP83867_RGMII_TX_CLK_DELAY_MAX: c_uint = 0xf;
pub const DP83867_RGMII_TX_CLK_DELAY_SHIFT: c_int = 4;
pub const DP83867_RGMII_RX_CLK_DELAY_MAX: c_uint = 0xf;
pub const DP83867_RGMII_RX_CLK_DELAY_SHIFT: c_int = 0;
// IO_MUX_CFG bits
pub const DP83867_IO_MUX_CFG_IO_IMPEDANCE_MASK: c_uint = 0x1f;
pub const DP83867_IO_MUX_CFG_IO_IMPEDANCE_MAX: c_uint = 0x0;
pub const DP83867_IO_MUX_CFG_IO_IMPEDANCE_MIN: c_uint = 0x1f;

pub const DP83867_IO_MUX_CFG_CLK_O_SEL_SHIFT: c_int = 8;
// PHY STS bits

    DP83867_PHYSTS_MDIX_CD)
// CFG2 bits

pub const DP83867_DOWNSHIFT_1_COUNT_VAL: c_int = 0;
pub const DP83867_DOWNSHIFT_2_COUNT_VAL: c_int = 1;
pub const DP83867_DOWNSHIFT_4_COUNT_VAL: c_int = 2;
pub const DP83867_DOWNSHIFT_8_COUNT_VAL: c_int = 3;
pub const DP83867_DOWNSHIFT_1_COUNT: c_int = 1;
pub const DP83867_DOWNSHIFT_2_COUNT: c_int = 2;
pub const DP83867_DOWNSHIFT_4_COUNT: c_int = 4;
pub const DP83867_DOWNSHIFT_8_COUNT: c_int = 8;
...
// FLD_THR_CFG
pub const DP83867_FLD_THR_CFG_ENERGY_LOST_THR_MASK: c_uint = 0x7;
pub const DP83867_LED_COUNT: c_int = 4;
// LED_DRV bits

pub const DP83867_LED_FN_RX_ERR: c_uint = 0xe /* Receive Error */;
pub const DP83867_LED_FN_RX_TX_ERR: c_uint = 0xd /* Receive Error or Transmit Error */;
pub const DP83867_LED_FN_LINK_RX_TX: c_uint = 0xb /* Link established, blink for rx or tx activity */;
pub const DP83867_LED_FN_FULL_DUPLEX: c_uint = 0xa /* Full duplex */;
pub const DP83867_LED_FN_LINK_100_1000_BT: c_uint = 0x9 /* 100/1000BT link established */;
pub const DP83867_LED_FN_LINK_10_100_BT: c_uint = 0x8 /* 10/100BT link established */;
pub const DP83867_LED_FN_LINK_10_BT: c_uint = 0x7 /* 10BT link established */;
pub const DP83867_LED_FN_LINK_100_BTX: c_uint = 0x6 /* 100 BTX link established */;
pub const DP83867_LED_FN_LINK_1000_BT: c_uint = 0x5 /* 1000 BT link established */;
pub const DP83867_LED_FN_COLLISION: c_uint = 0x4 /* Collision detected */;
pub const DP83867_LED_FN_RX: c_uint = 0x3 /* Receive activity */;
pub const DP83867_LED_FN_TX: c_uint = 0x2 /* Transmit activity */;
pub const DP83867_LED_FN_RX_TX: c_uint = 0x1 /* Receive or Transmit activity */;
pub const DP83867_LED_FN_LINK: c_uint = 0x0 /* Link established */;
    enum {
...
pub struct dp83867_private {
    ...
    pub clk_output_sel: u32,
    pub sgmii_ref_clk_en: bool,
}

#[no_mangle]
unsafe extern "C" fn dp83867_ack_interrupt(phydev: *mut phy_device) -> c_int {
    static int dp83867_ack_interrupt(struct phy_device *phydev)
    {
    let mut err: c_int = phy_read(phydev, MII_DP83867_ISR);
    if (err < 0)
    return err;
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn dp83867_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83867_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dp83867_read_status(phydev: *mut phy_device) -> c_int {
    static int dp83867_read_status(struct phy_device *phydev)
    {
    let mut status: c_int = phy_read(phydev, MII_DP83867_PHYSTS);
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn if(DP83867_PHYSTS_100: status &) -> else {
...
#[no_mangle]
unsafe extern "C" fn dp83867_get_downshift(phydev: *mut phy_device, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83867_set_downshift(phydev: *mut phy_device, cnt: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83867_config_port_mirroring(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83867_of_init_io_impedance(phydev: *mut phy_device) -> c_int {
...
pub unsafe extern "C" fn if(_arg: of_property_read_bool(of_node, _arg: "ti, _arg: min-output-impedance")) -> else {
    ...
    buf = nvmem_cell_read(cell, core::ptr::null_mut());
    nvmem_cell_put(cell);
    if (IS_ERR(buf))
    return PTR_ERR(buf);
    val = *buf;
...
#[no_mangle]
unsafe extern "C" fn dp83867_of_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83867_suspend(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83867_resume(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83867_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83867_config_init(phydev: *mut phy_device) -> c_int {
...
// Clock output selection if muxing property is set
    ...
    let mut mask: u16 = DP83867_IO_MUX_CFG_CLK_O_DISABLE;
...
#[no_mangle]
unsafe extern "C" fn dp83867_config_mdix(phydev: *mut phy_device, ctrl: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83867_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83867_phy_reset(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83867_link_change_notify(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn dp83867_loopback(phydev: *mut phy_device, enable: bool, speed: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dp83867_led_mode(index: u8, rules: c_ulong) -> c_int {
...
// rules = 0;
    ...
    {
// Default active high
    let mut polarity: u16 = DP83867_LED_POLARITY(index);
    u32 mode;
...
#[no_mangle]
unsafe extern "C" fn dp83867_config_inband(phydev: *mut phy_device, modes: c_uint) -> c_int {
