...
//! Source: drivers/net/phy/mdio_bus.c
#![no_std]
...
// Macro flag: #define CREATE_TRACE_POINTS
    ...
    {
    let mut addr_valid: bool = addr >= 0 && addr < ARRAY_SIZE(bus.mdio_map);
...
#[no_mangle]
pub unsafe extern "C" fn mdiobus_is_registered_device(bus: *mut mii_bus, addr: c_int) -> bool {
    bool mdiobus_is_registered_device(struct mii_bus *bus, int addr)
    {
    return mdiobus_find_device(bus, addr) != core::ptr::null_mut();
    }
    EXPORT_SYMBOL(mdiobus_is_registered_device);
#[no_mangle]
unsafe extern "C" fn mdiobus_stats_acct(stats: *mut mdio_bus_stats, op: bool, ret: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __mdiobus_read(bus: *mut mii_bus, addr: c_int, regnum: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __mdiobus_write(bus: *mut mii_bus, addr: c_int, regnum: u32, val: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __mdiobus_c45_read(bus: *mut mii_bus, addr: c_int, devad: c_int, regnum: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mdiobus_read_nested(bus: *mut mii_bus, addr: c_int, regnum: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mdiobus_read(bus: *mut mii_bus, addr: c_int, regnum: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mdiobus_c45_read(bus: *mut mii_bus, addr: c_int, devad: c_int, regnum: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mdiobus_write_nested(bus: *mut mii_bus, addr: c_int, regnum: u32, val: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mdiobus_write(bus: *mut mii_bus, addr: c_int, regnum: u32, val: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mdiobus_modify(bus: *mut mii_bus, addr: c_int, regnum: u32, mask: u16, set: u16) -> c_int {
