...
pub const PHY_ID_ADIN1200: c_uint = 0x0283bc20;
pub const PHY_ID_ADIN1300: c_uint = 0x0283bc30;
pub const ADIN1300_MII_EXT_REG_PTR: c_uint = 0x0010;
pub const ADIN1300_MII_EXT_REG_DATA: c_uint = 0x0011;
pub const ADIN1300_PHY_CTRL1: c_uint = 0x0012;

pub const ADIN1300_RX_ERR_CNT: c_uint = 0x0014;
pub const ADIN1300_PHY_CTRL_STATUS2: c_uint = 0x0015;

pub const ADIN1300_PHY_CTRL2: c_uint = 0x0016;

    (ADIN1300_DOWNSPEED_AN_100_EN | ADIN1300_DOWNSPEED_AN_10_EN)
pub const ADIN1300_PHY_CTRL3: c_uint = 0x0017;

pub const ADIN1300_INT_MASK_REG: c_uint = 0x0018;

    (ADIN1300_INT_LINK_STAT_CHNG_EN | ADIN1300_INT_HW_IRQ_EN)
pub const ADIN1300_INT_STATUS_REG: c_uint = 0x0019;
pub const ADIN1300_PHY_STATUS1: c_uint = 0x001a;
...
//
pub const ADIN1300_EEE_CAP_REG: c_uint = 0x8000;
pub const ADIN1300_EEE_ADV_REG: c_uint = 0x8001;
pub const ADIN1300_EEE_LPABLE_REG: c_uint = 0x8002;
pub const ADIN1300_FLD_EN_REG: c_uint = 0x8E27;
...
pub const ADIN1300_CLOCK_STOP_REG: c_uint = 0x9400;
pub const ADIN1300_LPI_WAKE_ERR_CNT_REG: c_uint = 0xa000;
pub const ADIN1300_B_100_ZPTM_DIMRX: c_uint = 0xB685;

pub const ADIN1300_CDIAG_RUN: c_uint = 0xba1b;
...
pub const ADIN1300_GE_SOFT_RESET_REG: c_uint = 0xff0c;

pub const ADIN1300_GE_CLK_CFG_REG: c_uint = 0xff1f;

pub const ADIN1300_GE_RGMII_CFG_REG: c_uint = 0xff23;
...
pub const ADIN1300_RGMII_1_60_NS: c_uint = 0x0001;
pub const ADIN1300_RGMII_1_80_NS: c_uint = 0x0002;
pub const ADIN1300_RGMII_2_00_NS: c_uint = 0x0000;
pub const ADIN1300_RGMII_2_20_NS: c_uint = 0x0006;
pub const ADIN1300_RGMII_2_40_NS: c_uint = 0x0007;
pub const ADIN1300_GE_RMII_CFG_REG: c_uint = 0xff24;

    FIELD_PREP(ADIN1300_GE_RMII_FIFO_DEPTH_MSK, x)

// RMII fifo depth values
pub const ADIN1300_RMII_4_BITS: c_uint = 0x0000;
pub const ADIN1300_RMII_8_BITS: c_uint = 0x0001;
pub const ADIN1300_RMII_12_BITS: c_uint = 0x0002;
pub const ADIN1300_RMII_16_BITS: c_uint = 0x0003;
pub const ADIN1300_RMII_20_BITS: c_uint = 0x0004;
pub const ADIN1300_RMII_24_BITS: c_uint = 0x0005;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adin_clause45_mmd_map {
    pub devad: c_int,
    pub cl45_regnum: u16,
    pub adin_regnum: u16,
}
...
pub struct adin_priv {
    pub stats: [u64; ARRAY_SIZE(adin_hw_stats)],
}

#[no_mangle]
unsafe extern "C" fn adin_lookup_reg_value(tbl: *const adin_cfg_reg_map, cfg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_config_rgmii_mode(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_config_rmii_mode(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_get_downshift(phydev: *mut phy_device, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_set_downshift(phydev: *mut phy_device, cnt: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_get_edpd(phydev: *mut phy_device, tx_interval: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_set_edpd(phydev: *mut phy_device, tx_interval: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_get_fast_down(phydev: *mut phy_device, msecs: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_set_fast_down(phydev: *mut phy_device, msecs: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_config_clk_out(phydev: *mut phy_device) -> c_int {
    static int adin_config_clk_out(struct phy_device *phydev)
    {
    struct device *dev = &phydev.mdio.dev;
    const char *val = core::ptr::null_mut();
    let mut sel: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn adin_config_zptm100(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_config_init(phydev: *mut phy_device) -> c_int {
...
// Clear pending interrupts
    let mut rc: c_int = phy_read(phydev, ADIN1300_INT_STATUS_REG);
    return rc < 0 ? rc : 0;
    }
#[no_mangle]
unsafe extern "C" fn adin_phy_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_read_mmd(phydev: *mut phy_device, devad: c_int, regnum: u16) -> c_int {
    static int adin_read_mmd(struct phy_device *phydev, int devad, u16 regnum)
    {
    struct mii_bus *bus = phydev.mdio.bus;
    let mut phy_addr: c_int = phydev.mdio.addr;
    int adin_regnum;
    int err;
...
#[no_mangle]
unsafe extern "C" fn adin_config_mdix(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_mdix_update(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_get_sset_count(phydev: *mut phy_device) -> c_int {
    static int adin_get_sset_count(struct phy_device *phydev)
    {
    return ARRAY_SIZE(adin_hw_stats);
    }
#[no_mangle]
unsafe extern "C" fn adin_get_strings(phydev: *mut phy_device, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn adin_get_stat(phydev: *mut phy_device, i: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn adin_cable_test_start(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_cable_test_report_trans(result: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adin_cable_test_report(phydev: *mut phy_device) -> c_int {
