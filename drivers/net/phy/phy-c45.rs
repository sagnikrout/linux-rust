...
//! Source: drivers/net/phy/phy-c45.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn genphy_c45_baset1_able(phydev: *mut phy_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn genphy_c45_pma_can_sleep(phydev: *mut phy_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_pma_resume(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_pma_suspend(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_pma_baset1_setup_master_slave(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_pma_setup_forced(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn genphy_c45_baset1_an_config_aneg(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_an_config_aneg(phydev: *mut phy_device) -> c_int {
    int genphy_c45_an_config_aneg(struct phy_device *phydev)
    {
    let mut changed: c_int = 0, ret;
    u32 adv;
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_an_disable_aneg(phydev: *mut phy_device) -> c_int {
    int genphy_c45_an_disable_aneg(struct phy_device *phydev)
    {
    let mut reg: u16 = MDIO_CTRL1;
    if (genphy_c45_baset1_able(phydev))
    reg = MDIO_AN_T1_CTRL;
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_restart_aneg(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_check_and_restart_aneg(phydev: *mut phy_device, restart: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_pma_soft_reset(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn genphy_c45_an_setup_master_slave(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn genphy_c45_read_master_slave(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_aneg_done(phydev: *mut phy_device) -> c_int {
    int genphy_c45_aneg_done(struct phy_device *phydev)
    {
    let mut reg: c_int = MDIO_STAT1;
    int val;
    if (genphy_c45_baset1_able(phydev))
    reg = MDIO_AN_T1_STAT;
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_read_link(phydev: *mut phy_device) -> c_int {
    int genphy_c45_read_link(struct phy_device *phydev)
    {
    let mut mmd_mask: u32 = MDIO_DEVS_PMAPMD;
    int val, devad;
    let mut link: bool = true;
...
//
    ...
    return val;
#[no_mangle]
pub unsafe extern "C" fn if(MDIO_STAT1_LSTATUS: val &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn genphy_c45_baset1_read_lpa(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_read_lpa(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_pma_baset1_read_master_slave(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_read_pma(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_read_mdix(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_read_eee_adv(phydev: *mut phy_device, adv: *mut c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn genphy_c45_read_eee_cap1(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn genphy_c45_read_eee_cap2(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_read_eee_abilities(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_an_config_eee_aneg(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_pma_baset1_read_abilities(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_pma_read_ext_abilities(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_pma_read_abilities(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_baset1_read_status(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_read_status(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gen10g_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_loopback(phydev: *mut phy_device, enable: bool, speed: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_fast_retrain(phydev: *mut phy_device, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_eee_is_active(phydev: *mut phy_device, lp: *mut c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn oatc14_cable_test_get_result_code(status: enum oatc14_hdd_status) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_oatc14_cable_test_start(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn oatc14_update_sqi_capability(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_oatc14_get_sqi_max(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genphy_c45_oatc14_get_sqi(phydev: *mut phy_device) -> c_int {
