...
//! Source: drivers/net/phy/microchip.c
#![no_std]
...
pub const PHY_ID_LAN937X_TX: c_uint = 0x0007c190;
pub const LAN937X_MODE_CTRL_STATUS_REG: c_uint = 0x11;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lan88xx_priv {
    pub chip_id: c_int,
    pub chip_rev: c_int,
    pub wolopts: __u32,
    pub downshift_cnt: u8,
}

#[no_mangle]
unsafe extern "C" fn lan88xx_read_page(phydev: *mut phy_device) -> c_int {
    static int lan88xx_read_page(struct phy_device *phydev)
    {
    return __phy_read(phydev, LAN88XX_EXT_PAGE_ACCESS);
    }
#[no_mangle]
unsafe extern "C" fn lan88xx_write_page(phydev: *mut phy_device, page: c_int) -> c_int {
    static int lan88xx_write_page(struct phy_device *phydev, int page)
    {
    return __phy_write(phydev, LAN88XX_EXT_PAGE_ACCESS, page);
    }
#[no_mangle]
unsafe extern "C" fn lan88xx_suspend(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan88xx_config_TR_regs(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn lan88xx_get_downshift(phydev: *mut phy_device, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan88xx_set_downshift(phydev: *mut phy_device, cnt: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan88xx_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan88xx_remove(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn lan88xx_set_mdix(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn lan88xx_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan88xx_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan88xx_link_change_notify(phydev: *mut phy_device) {
...
//
#[no_mangle]
unsafe extern "C" fn lan937x_tx_read_mdix_status(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lan937x_tx_read_status(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lan937x_tx_set_mdix(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lan937x_tx_config_aneg(phydev: *mut phy_device) -> c_int {
