...
//! Source: drivers/net/phy/air_an8801.c
#![no_std]
...
pub const AN8801R_PHY_ID: c_uint = 0xc0ff0421;
// MII Registers
// MII Registers - Airoha Page 1
pub const AN8801_EXT_REG_PHY: c_uint = 0x14;

// MII Registers - Airoha Page 4

// BPBUS Registers
pub const AN8801_BPBUS_REG_LED_GPIO: c_uint = 0x54;
pub const AN8801_BPBUS_REG_LED_ID_SEL: c_uint = 0x58;

pub const AN8801_BPBUS_REG_GPIO_MODE: c_uint = 0x70;
pub const AN8801_BPBUS_REG_PHY_IRQ_GPIO: c_uint = 0x7c;

pub const AN8801_PHY_IRQ_GPIO_NUM: c_int = 1;
pub const AN8801_BPBUS_REG_CKO: c_uint = 0x1a4;
pub const AN8801_CKO_OUTPUT_MODE_AUTO: c_int = 3;
pub const AN8801_BPBUS_REG_LINK_MODE: c_uint = 0x5054;

pub const AN8801_BPBUS_REG_BYPASS_PTP: c_uint = 0x21c004;

pub const AN8801_BPBUS_REG_TXDLY_STEP: c_uint = 0x21c024;

pub const RGMII_DELAY_NO_STEP: c_int = 0;
pub const RGMII_DELAY_STEP_1: c_int = 1;
pub const RGMII_DELAY_STEP_2: c_int = 2;
pub const RGMII_DELAY_STEP_3: c_int = 3;
pub const RGMII_DELAY_STEP_4: c_int = 4;
pub const RGMII_DELAY_STEP_5: c_int = 5;
pub const RGMII_DELAY_STEP_6: c_int = 6;
pub const RGMII_DELAY_STEP_7: c_int = 7;

// Default RGMII TX delay setting, corresponding to a 1.883ns delay

pub const AN8801_BPBUS_REG_RXDLY_STEP: c_uint = 0x21c02c;

// Default RGMII RX delay setting, corresponding to a 1.992ns delay,
// when align bit is set or -0.008ns otherwise.
//

pub const AN8801_BPBUS_REG_WOL_MAC_16_47: c_uint = 0x285114;
pub const AN8801_BPBUS_REG_WOL_MAC_0_15: c_uint = 0x285118;
pub const AN8801_BPBUS_REG_WAKEUP_CTL1: c_uint = 0x285400;

pub const AN8801_BPBUS_REG_WAKEUP_CTL2: c_uint = 0x285404;

pub const AN8801_WAKE_OUT_84MS: c_int = 0;
pub const AN8801_WAKE_OUT_168MS: c_int = 1;
pub const AN8801_WAKE_OUT_336MS: c_int = 2;
pub const AN8801_WAKE_OUT_672MS: c_int = 3;

pub const AN8801_BPBUS_REG_WAKE_IRQ_EN: c_uint = 0x285700;
pub const AN8801_BPBUS_REG_WAKE_IRQ_STS: c_uint = 0x285704;

// MDIO_MMD_VEND1 Registers
pub const AN8801_PHY_TX_PAIR_DLY_SEL_GBE: c_uint = 0x13;

pub const AN8801_PHY_RXADC_CTRL: c_uint = 0xd8;

pub const AN8801_PHY_RXADC_REV_0: c_uint = 0xd9;

pub const AN8801_PHY_RXADC_REV_1: c_uint = 0xda;

// MDIO_MMD_VEND2 Registers
pub const LED_BCR: c_uint = 0x21;

pub const LED_BCR_MODE_DISABLE: c_int = 0;
pub const LED_BCR_MODE_2LED: c_int = 1;
pub const LED_BCR_MODE_3LED_1: c_int = 2;
pub const LED_BCR_MODE_3LED_2: c_int = 3;
pub const LED_ON_DUR: c_uint = 0x22;

pub const LED_BLINK_DUR: c_uint = 0x23;

pub const AN8801R_NUM_LEDS: c_int = 3;
pub const AN8801_PERIOD_SHIFT: c_int = 15;

pub const AN8801_MAX_PERIOD_MS: c_int = 2147;
pub const AN8801_REG_PHY_INTERNAL0: c_uint = 0x600;
pub const AN8801_REG_PHY_INTERNAL1: c_uint = 0x601;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct an8801r_priv {
    pub wake_magic_enabled: bool,
    pub wake_lnkchg_enabled: bool,
}
...
#[no_mangle]
unsafe extern "C" fn an8801r_led_blink_ms_to_hw(req_ms: c_ulong) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn an8801r_led_trig_to_hw(rules: c_ulong, on: *mut u16, blink: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn an8801r_led_init(phydev: *mut phy_device, led_cfg: *mut u8) -> c_int {
...
// Set LED BCR Enable
    ...
    let mut led_trigger: c_ulong = 0;
    let mut led_gpio: u32 = led_id + 1;
...
#[no_mangle]
unsafe extern "C" fn an8801r_reset_wake(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn an8801r_ack_interrupt(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn an8801r_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn an8801r_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn an8801r_of_init_leds(phydev: *mut phy_device, led_cfg: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn an8801r_rgmii_delay_config(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn an8801r_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn an8801r_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn an8801r_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn an8801r_suspend(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn an8801r_resume(phydev: *mut phy_device) -> c_int {
