...
//! Source: drivers/net/phy/mii_timestamper.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mii_timestamping_desc {
    pub list: list_head,
    pub ctrl: *mut mii_timestamping_ctrl,
...
//
#[no_mangle]
pub unsafe extern "C" fn unregister_mii_tstamp_controller(device: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn unregister_mii_timestamper(mii_ts: *mut mii_timestamper) {
