...
//! Source: drivers/net/phy/mscc/mscc_main.c
#![no_std]
...
pub struct vsc85xx_probe_config {
    ...
    2600, 3400};
#[no_mangle]
unsafe extern "C" fn vsc85xx_phy_read_page(phydev: *mut phy_device) -> c_int {
    static int vsc85xx_phy_read_page(struct phy_device *phydev)
    {
    return __phy_read(phydev, MSCC_EXT_PAGE_ACCESS);
    }
#[no_mangle]
unsafe extern "C" fn vsc85xx_phy_write_page(phydev: *mut phy_device, page: c_int) -> c_int {
    static int vsc85xx_phy_write_page(struct phy_device *phydev, int page)
    {
    return __phy_write(phydev, MSCC_EXT_PAGE_ACCESS, page);
    }
#[no_mangle]
unsafe extern "C" fn vsc85xx_get_sset_count(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_get_strings(phydev: *mut phy_device, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_get_stat(phydev: *mut phy_device, i: c_int) -> u64 {
    ...
    u8 mode)
    {
    let mut mask: u16 = LED_MODE_SEL_MASK(led_num);
    let mut val: u16 = LED_MODE_SEL(led_num, mode);
    ...
    {
    let mut val: u16 = LED_COMBINE_DIS(led_num, combine_disable);
    let mut mask: u16 = LED_COMBINE_DIS_MASK(led_num);
    return phy_modify(phydev, MSCC_PHY_LED_BEHAVIOR, mask, val);
    }
#[no_mangle]
unsafe extern "C" fn vsc85xx_mdix_get(phydev: *mut phy_device, mdix: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_mdix_set(phydev: *mut phy_device, mdix: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(ETH_TP_MDI_X: mdix ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_downshift_get(phydev: *mut phy_device, count: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_downshift_set(phydev: *mut phy_device, count: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_edge_rate_magic_get(phydev: *mut phy_device) -> c_int {
    ...
    let mut sd_array_size: u8 = ARRAY_SIZE(edge_table[0].slowdown);
    if (!of_node)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_edge_rate_cntl_set(phydev: *mut phy_device, edge_rate: u8) -> c_int {
...
//
    ...
    {
    let mut rgmii_rx_delay_pos: u16 = ffs(rgmii_rx_delay_mask) - 1;
    let mut rgmii_tx_delay_pos: u16 = ffs(rgmii_tx_delay_mask) - 1;
    let mut delay_size: c_int = ARRAY_SIZE(vsc85xx_internal_delay);
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_default_config(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_tr_write(phydev: *mut phy_device, addr: u16, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn vsc8531_pre_init_seq_set(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_eee_init_seq_set(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn phy_base_write(phydev: *mut phy_device, regnum: u32, val: u16) -> c_int {
...
// phydev->bus->mdio_lock should be locked when using this function
#[no_mangle]
pub unsafe extern "C" fn phy_base_read(phydev: *mut phy_device, regnum: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc8584_csr_write(phydev: *mut phy_device, addr: u16, val: u32) {
...
// bus->mdio_lock should be locked when using this function
#[no_mangle]
pub unsafe extern "C" fn vsc8584_cmd(phydev: *mut phy_device, val: u16) -> c_int {
...
// bus->mdio_lock should be locked when using this function
#[no_mangle]
unsafe extern "C" fn vsc8584_micro_assert_reset(phydev: *mut phy_device) -> c_int {
...
// bus->mdio_lock should be locked when using this function
#[no_mangle]
unsafe extern "C" fn vsc8574_is_serdes_init(phydev: *mut phy_device) -> bool {
...
// bus->mdio_lock should be locked when using this function
#[no_mangle]
unsafe extern "C" fn vsc8574_config_pre_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc8584_pll5g_reset(phydev: *mut phy_device) -> c_int {
...
// bus->mdio_lock should be locked when using this function
#[no_mangle]
unsafe extern "C" fn vsc8584_config_pre_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc8584_get_base_addr(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_coma_mode_release(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn vsc8584_config_host_serdes(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc8574_config_host_serdes(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc8584_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc8584_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn phy_update_mcb_s6g(phydev: *mut phy_device, reg: u32, mcb: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn phy_commit_mcb_s6g(phydev: *mut phy_device, reg: u32, mcb: u8) -> c_int {
    int phy_commit_mcb_s6g(struct phy_device *phydev, u32 reg, u8 mcb)
    {
    return __phy_write_mcb_s6g(phydev, reg, mcb, PHY_MCB_S6G_WRITE);
    }
#[no_mangle]
unsafe extern "C" fn vsc8514_config_host_serdes(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc8514_config_pre_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc8514_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_ack_interrupt(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_config_inband(phydev: *mut phy_device, modes: c_uint) -> c_int {
...
// rules |= BIT(TRIGGER_NETDEV_RX) | BIT(TRIGGER_NETDEV_TX);
    ...
    {
    struct vsc8531_private *vsc8531 = phydev.priv;
    let mut mode: u8 = VSC8531_FORCE_LED_ON;
    let mut combine_disable: bool = false;
    bool has_rx, has_tx;
    int ret;
    if (index >= vsc8531.nleds)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn vsc8514_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc8574_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc8584_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc85xx_remove(phydev: *mut phy_device) {
