...
#[no_mangle]
unsafe extern "C" fn phy_link_up(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn phy_link_down(phydev: *mut phy_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_print_status(phydev: *mut phy_device) {
...
//
    ...
    {
    let mut ret: c_int = RATE_MATCH_NONE;
...
//
#[no_mangle]
unsafe extern "C" fn phy_config_interrupt(phydev: *mut phy_device, interrupts: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_restart_aneg(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_aneg_done(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_check_valid(speed: c_int, duplex: c_int, features: *mut c_ulong) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn phy_sanitize_settings(phydev: *mut phy_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_mii_ioctl(phydev: *mut phy_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
    int phy_mii_ioctl(struct phy_device *phydev, struct ifreq *ifr, int cmd)
    {
    struct mii_ioctl_data *mii_data = if_mii(ifr);
    struct kernel_hwtstamp_config kernel_cfg;
    let mut extack: netlink_ext_ack = {};
    let mut val: u16 = mii_data.val_in;
    let mut change_autoneg: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn if(BMCR_SPEED100: val &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_do_ioctl(dev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_do_ioctl_running(dev: *mut net_device, ifr: *mut ifreq, cmd: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_trigger_machine(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn phy_abort_cable_test(phydev: *mut phy_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_ethtool_get_strings(phydev: *mut phy_device, data: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_ethtool_get_sset_count(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn phy_config_aneg(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn phy_check_link_status(phydev: *mut phy_device) -> c_int {
...
//
    ...
    err = genphy_c45_eee_is_active(phydev, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_config_inband(phydev: *mut phy_device, modes: c_uint) -> c_int {
    ...
    return -EIO;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !phydev->drv->config_inband) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn _phy_start_aneg(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_start_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_poll_aneg_done(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_speed_down(phydev: *mut phy_device, sync: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_speed_up(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_start_machine(phydev: *mut phy_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_stop_machine(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn phy_process_error(phydev: *mut phy_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_error(phydev: *mut phy_device) {
...
//
#[no_mangle]
unsafe extern "C" fn phy_write_barrier(phydev: *mut phy_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_disable_interrupts(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn phy_interrupt(irq: c_int, phy_dat: *mut c_void) -> irqreturn_t {
...
//
    ...
    pm_system_wakeup();
#[no_mangle]
pub unsafe extern "C" fn if(_arg: device_may_wakeup(&netdev->dev)) -> else {
    else if (device_may_wakeup(&netdev.dev))
    pm_wakeup_dev_event(&netdev.dev, 0, true);
#[no_mangle]
pub unsafe extern "C" fn if(device_may_wakeup(parent): parent &&) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn phy_enable_interrupts(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn phy_update_stats(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_request_interrupt(phydev: *mut phy_device) {
    void phy_request_interrupt(struct phy_device *phydev)
    {
    int err;
    err = request_threaded_irq(phydev.irq, core::ptr::null_mut(), phy_interrupt,
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_free_interrupt(phydev: *mut phy_device) {
...
//
#[no_mangle]
unsafe extern "C" fn phy_get_next_update_time(phydev: *mut phy_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn _phy_state_machine(phydev: *mut phy_device) -> enum phy_state_work {
    static enum phy_state_work _phy_state_machine(struct phy_device *phydev)
    {
    let mut state_work: enum phy_state_work = PHY_STATE_WORK_NONE;
    struct net_device *dev = phydev.attached_dev;
    let mut old_state: enum phy_state = phydev.state;
    const void *func = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_state_machine(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_stop(phydev: *mut phy_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_start(phydev: *mut phy_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_mac_interrupt(phydev: *mut phy_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_loopback(phydev: *mut phy_device, enable: bool, speed: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_eee_tx_clock_stop_capable(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_eee_rx_clock_stop(phydev: *mut phy_device, clk_stop_enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_init_eee(phydev: *mut phy_device, clk_stop_enable: bool) -> c_int {
    int phy_init_eee(struct phy_device *phydev, bool clk_stop_enable)
    {
    int ret;
    if (!phydev.drv)
    return -EIO;
    ret = genphy_c45_eee_is_active(phydev, core::ptr::null_mut());
    if (ret < 0)
    return ret;
    if (!ret)
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_get_eee_err(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_ethtool_get_eee(phydev: *mut phy_device, data: *mut ethtool_keee) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_ethtool_set_eee(phydev: *mut phy_device, data: *mut ethtool_keee) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_ethtool_set_wol(phydev: *mut phy_device, wol: *mut ethtool_wolinfo) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_ethtool_get_wol(phydev: *mut phy_device, wol: *mut ethtool_wolinfo) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_ethtool_nway_reset(ndev: *mut net_device) -> c_int {
