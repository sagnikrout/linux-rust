...
//! Source: drivers/net/phy/nxp-tja11xx.c
#![no_std]
...
pub const PHY_ID_MASK: c_uint = 0xfffffff0;
pub const PHY_ID_TJA1100: c_uint = 0x0180dc40;
pub const PHY_ID_TJA1101: c_uint = 0x0180dd00;
pub const PHY_ID_TJA1102: c_uint = 0x0180dc80;
pub const PHY_ID_TJA1102S: c_uint = 0x0180dc90;
pub const MII_ECTRL: c_int = 17;

pub const MII_CFG1: c_int = 18;

pub const MII_CFG1_LED_MODE_LINKUP: c_int = 0;

pub const MII_CFG2: c_int = 19;

pub const MII_CFG2_SLEEP_REQUEST_TO_16MS: c_uint = 0x3;
pub const MII_INTSRC: c_int = 21;

pub const MII_INTEN: c_int = 22;

pub const MII_COMMSTAT: c_int = 23;

pub const MII_COMMSTAT_SQI_MAX: c_int = 7;
pub const MII_GENSTAT: c_int = 24;

pub const MII_EXTSTAT: c_int = 25;

pub const MII_COMMCFG: c_int = 27;

pub const MII_CFG3: c_int = 28;

// Configure REF_CLK as input in RMII mode

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tja11xx_priv {
    pub phydev: *mut phy_device,
    pub phy_register_work: work_struct,
    pub flags: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tja11xx_phy_stats {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_check(phydev: *mut phy_device, reg: u8, mask: u16, set: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_enable_reg_write(phydev: *mut phy_device) -> c_int {
    static int tja11xx_enable_reg_write(struct phy_device *phydev)
    {
    return phy_set_bits(phydev, MII_ECTRL, MII_ECTRL_CONFIG_EN);
    }
#[no_mangle]
unsafe extern "C" fn tja11xx_enable_link_control(phydev: *mut phy_device) -> c_int {
    static int tja11xx_enable_link_control(struct phy_device *phydev)
    {
    return phy_set_bits(phydev, MII_ECTRL, MII_ECTRL_LINK_CONTROL);
    }
#[no_mangle]
unsafe extern "C" fn tja11xx_disable_link_control(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_wakeup(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_soft_reset(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_config_aneg_cable_test(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_get_interface_mode(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_get_sqi(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_get_sqi_max(phydev: *mut phy_device) -> c_int {
    static int tja11xx_get_sqi_max(struct phy_device *phydev)
    {
    return MII_COMMSTAT_SQI_MAX;
    }
#[no_mangle]
unsafe extern "C" fn tja11xx_get_sset_count(phydev: *mut phy_device) -> c_int {
    static int tja11xx_get_sset_count(struct phy_device *phydev)
    {
    return ARRAY_SIZE(tja11xx_hw_stats);
    }
#[no_mangle]
unsafe extern "C" fn tja11xx_get_strings(phydev: *mut phy_device, data: *mut u8) {
...
// value = !!(ret & MII_INTSRC_UV_ERR);
    ...
    hdev = devm_hwmon_device_register_with_info(dev, core::ptr::null_mut(), phydev,
    &tja11xx_hwmon_chip_info,
    core::ptr::null_mut());
    return PTR_ERR_OR_ZERO(hdev);
    }
#[no_mangle]
unsafe extern "C" fn tja11xx_parse_dt(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja1102_p1_register(work: *mut work_struct) {
...
// Real PHY ID of Port 1 is 0
    phy = phy_device_create(bus, addr, PHY_ID_TJA1102, false, core::ptr::null_mut());
    if (IS_ERR(phy)) {
...
#[no_mangle]
unsafe extern "C" fn tja1102_p0_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja1102_p0_remove(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn tja1102_match_phy_device(phydev: *mut phy_device, port0: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_ack_interrupt(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_cable_test_start(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tja11xx_cable_test_report_trans(result: u32) -> c_int {
    static int tja11xx_cable_test_report_trans(u32 result)
    {
    let mut mask: u32 = MII_EXTSTAT_SHORT_DETECT | MII_EXTSTAT_OPEN_DETECT;
    if ((result & mask) == mask) {
...
#[no_mangle]
unsafe extern "C" fn tja11xx_cable_test_report(phydev: *mut phy_device) -> c_int {
