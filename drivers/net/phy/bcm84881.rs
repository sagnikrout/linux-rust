...
//! Source: drivers/net/phy/bcm84881.c
#![no_std]
...
//
pub const BCM8489X_LED_CTL: c_uint = 0xa83b;

pub const BCM8489X_MAX_LEDS: c_int = 2;
    static const struct {
    u16 mask_low;
    u16 mask_ext;
...
#[no_mangle]
unsafe extern "C" fn bcm84881_wait_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm84881_fill_possible_interfaces(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn bcm84881_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm8489x_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm84881_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm84881_get_features(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm84881_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm84881_aneg_done(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm84881_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(4: mode ==) -> else {
    else if (mode == 4)
