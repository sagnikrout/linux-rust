...
//! Source: drivers/net/phy/teranetics.c
#![no_std]
...
pub const PHY_ID_TN2020: c_uint = 0x00a19410;
...
#[no_mangle]
unsafe extern "C" fn teranetics_aneg_done(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn teranetics_read_status(phydev: *mut phy_device) -> c_int {
