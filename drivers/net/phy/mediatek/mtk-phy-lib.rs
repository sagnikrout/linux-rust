...
//! Source: drivers/net/phy/mediatek/mtk-phy-lib.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mtk_phy_read_page(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_phy_write_page(phydev: *mut phy_device, page: c_int) -> c_int {
...
// All combinations of the supported triggers are allowed
    ...
    (index ? 16 : 0);
    let mut bit_netdev: c_uint = MTK_PHY_LED_STATE_NETDEV + (index ? 16 : 0);
    let mut bit_on: c_uint = MTK_PHY_LED_STATE_FORCE_ON + (index ? 16 : 0);
...
#[no_mangle]
pub unsafe extern "C" fn mtk_phy_hw_led_blink_set(phydev: *mut phy_device, index: u8, blinking: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_phy_leds_state_init(phydev: *mut phy_device) {
    void mtk_phy_leds_state_init(struct phy_device *phydev)
    {
    int i;
    for (i = 0; i < 2; ++i)
    phydev.drv.led_hw_control_get(phydev, i, core::ptr::null_mut());
    }
