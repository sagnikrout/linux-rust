...
//! Source: drivers/net/phy/mediatek/mtk-2p5ge.c
#![no_std]
...
pub const MTK_2P5GPHY_ID_MT7988: c_uint = 0x00339c11;

pub const MT7988_2P5GE_PMB_FW_SIZE: c_uint = 0x20000;
pub const MT7988_2P5GE_PMB_FW_BASE: c_uint = 0x0f100000;
pub const MT7988_2P5GE_PMB_FW_LEN: c_uint = 0x20000;
pub const MTK_2P5GPHY_MCU_CSR_BASE: c_uint = 0x0f0f0000;
pub const MTK_2P5GPHY_MCU_CSR_LEN: c_uint = 0x20;
pub const MD32_EN_CFG: c_uint = 0x18;

pub const BASE100T_STATUS_EXTEND: c_uint = 0x10;
pub const BASE1000T_STATUS_EXTEND: c_uint = 0x11;
pub const EXTEND_CTRL_AND_STATUS: c_uint = 0x16;
pub const PHY_AUX_CTRL_STATUS: c_uint = 0x1d;

// Registers on MDIO_MMD_VEND1
pub const MTK_PHY_LPI_PCS_DSP_CTRL: c_uint = 0x121;

pub const MTK_PHY_HOST_CMD1: c_uint = 0x800e;
pub const MTK_PHY_HOST_CMD2: c_uint = 0x800f;
...
#[no_mangle]
unsafe extern "C" fn mt798x_2p5ge_phy_load_fw(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt798x_2p5ge_phy_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt798x_2p5ge_phy_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt798x_2p5ge_phy_get_features(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt798x_2p5ge_phy_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt798x_2p5ge_phy_probe(phydev: *mut phy_device) -> c_int {
