...
//! Source: drivers/net/phy/mediatek/mtk-ge-soc.c
#![no_std]
...
pub const MTK_PHY_MAX_LEDS: c_int = 2;
pub const MTK_GPHY_ID_MT7981: c_uint = 0x03a29461;
pub const MTK_GPHY_ID_MT7988: c_uint = 0x03a29481;
pub const MTK_GPHY_ID_EN7528: c_uint = 0x03a29491;
pub const MTK_GPHY_ID_AN7581: c_uint = 0x03a294c1;
pub const MTK_GPHY_ID_AN7583: c_uint = 0xc0ff0420;
...
pub const MTK_PHY_LPI_REG_14: c_uint = 0x14;

pub const MTK_PHY_LPI_REG_1c: c_uint = 0x1c;
...
pub const ANALOG_INTERNAL_OPERATION_MAX_US: c_int = 20;
pub const TXRESERVE_MIN: c_int = 0;
pub const TXRESERVE_MAX: c_int = 7;
pub const MTK_PHY_ANARG_RG: c_uint = 0x10;

// Registers on MDIO_MMD_VEND1
pub const MTK_PHY_TXVLD_DA_RG: c_uint = 0x12;

pub const MTK_PHY_TX_I2MPB_TEST_MODE_A2: c_uint = 0x16;

pub const MTK_PHY_TX_I2MPB_TEST_MODE_B1: c_uint = 0x17;

pub const MTK_PHY_TX_I2MPB_TEST_MODE_B2: c_uint = 0x18;

pub const MTK_PHY_TX_I2MPB_TEST_MODE_C1: c_uint = 0x19;

pub const MTK_PHY_TX_I2MPB_TEST_MODE_C2: c_uint = 0x20;

pub const MTK_PHY_TX_I2MPB_TEST_MODE_D1: c_uint = 0x21;

pub const MTK_PHY_TX_I2MPB_TEST_MODE_D2: c_uint = 0x22;

pub const MTK_PHY_RXADC_CTRL_RG7: c_uint = 0xc6;

pub const MTK_PHY_RXADC_CTRL_RG9: c_uint = 0xc8;

pub const MTK_PHY_LDO_OUTPUT_V: c_uint = 0xd7;
pub const MTK_PHY_RG_ANA_CAL_RG0: c_uint = 0xdb;

pub const MTK_PHY_RG_ANA_CAL_RG1: c_uint = 0xdc;

pub const MTK_PHY_RG_ANA_CAL_RG5: c_uint = 0xe0;

pub const MTK_PHY_RG_TX_FILTER: c_uint = 0xfe;
pub const MTK_PHY_RG_LPI_PCS_DSP_CTRL_REG120: c_uint = 0x120;

pub const MTK_PHY_RG_LPI_PCS_DSP_CTRL_REG122: c_uint = 0x122;

pub const MTK_PHY_RG_TESTMUX_ADC_CTRL: c_uint = 0x144;

pub const MTK_PHY_RG_CR_TX_AMP_OFFSET_A_B: c_uint = 0x172;

pub const MTK_PHY_RG_CR_TX_AMP_OFFSET_C_D: c_uint = 0x173;

pub const MTK_PHY_RG_AD_CAL_COMP: c_uint = 0x17a;

pub const MTK_PHY_RG_AD_CAL_CLK: c_uint = 0x17b;

pub const MTK_PHY_RG_AD_CALIN: c_uint = 0x17c;

pub const MTK_PHY_RG_DASN_DAC_IN0_A: c_uint = 0x17d;

pub const MTK_PHY_RG_DASN_DAC_IN0_B: c_uint = 0x17e;

pub const MTK_PHY_RG_DASN_DAC_IN0_C: c_uint = 0x17f;

pub const MTK_PHY_RG_DASN_DAC_IN0_D: c_uint = 0x180;

pub const MTK_PHY_RG_DASN_DAC_IN1_A: c_uint = 0x181;

pub const MTK_PHY_RG_DASN_DAC_IN1_B: c_uint = 0x182;

pub const MTK_PHY_RG_DASN_DAC_IN1_C: c_uint = 0x183;

pub const MTK_PHY_RG_DASN_DAC_IN1_D: c_uint = 0x184;

pub const MTK_PHY_RG_DEV1E_REG19b: c_uint = 0x19b;

pub const MTK_PHY_RG_LP_IIR2_K1_L: c_uint = 0x22a;
pub const MTK_PHY_RG_LP_IIR2_K1_U: c_uint = 0x22b;
pub const MTK_PHY_RG_LP_IIR2_K2_L: c_uint = 0x22c;
pub const MTK_PHY_RG_LP_IIR2_K2_U: c_uint = 0x22d;
pub const MTK_PHY_RG_LP_IIR2_K3_L: c_uint = 0x22e;
pub const MTK_PHY_RG_LP_IIR2_K3_U: c_uint = 0x22f;
pub const MTK_PHY_RG_LP_IIR2_K4_L: c_uint = 0x230;
pub const MTK_PHY_RG_LP_IIR2_K4_U: c_uint = 0x231;
pub const MTK_PHY_RG_LP_IIR2_K5_L: c_uint = 0x232;
pub const MTK_PHY_RG_LP_IIR2_K5_U: c_uint = 0x233;
pub const MTK_PHY_RG_DEV1E_REG234: c_uint = 0x234;

pub const MTK_PHY_RG_LPF_CNT_VAL: c_uint = 0x235;
pub const MTK_PHY_RG_DEV1E_REG238: c_uint = 0x238;

pub const MTK_PHY_RG_DEV1E_REG239: c_uint = 0x239;

pub const MTK_PHY_RG_DEV1E_REG27C: c_uint = 0x27c;

pub const MTK_PHY_RG_DEV1E_REG27D: c_uint = 0x27d;

pub const MTK_PHY_RG_DEV1E_REG2C7: c_uint = 0x2c7;

pub const MTK_PHY_RG_DEV1E_REG2D1: c_uint = 0x2d1;

pub const MTK_PHY_RG_DEV1E_REG323: c_uint = 0x323;

pub const MTK_PHY_RG_DEV1E_REG324: c_uint = 0x324;

pub const MTK_PHY_RG_DEV1E_REG326: c_uint = 0x326;

pub const MTK_PHY_LDO_PUMP_EN_PAIRAB: c_uint = 0x502;
pub const MTK_PHY_LDO_PUMP_EN_PAIRCD: c_uint = 0x503;
pub const MTK_PHY_DA_TX_R50_PAIR_A: c_uint = 0x53d;
pub const MTK_PHY_DA_TX_R50_PAIR_B: c_uint = 0x53e;
pub const MTK_PHY_DA_TX_R50_PAIR_C: c_uint = 0x53f;
pub const MTK_PHY_DA_TX_R50_PAIR_D: c_uint = 0x540;
...
//
pub const MTK_PHY_LED_BCR: c_uint = 0x21;

pub const MTK_PHY_RG_BG_RASEL: c_uint = 0x115;

// 'boottrap' register reflecting the configuration of the 4 PHY LEDs
pub const RG_GPIO_MISC_TPBANK0: c_uint = 0x6f0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_socphy_shared {
    pub boottrap: u32,
    pub priv: [mtk_socphy_priv; 4],
}
...
#[no_mangle]
unsafe extern "C" fn rext_fill_result(phydev: *mut phy_device, buf: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rext_cal_efuse(phydev: *mut phy_device, buf: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx_offset_fill_result(phydev: *mut phy_device, buf: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx_offset_cal_efuse(phydev: *mut phy_device, buf: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx_amp_fill_result(phydev: *mut phy_device, buf: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx_amp_cal_efuse(phydev: *mut phy_device, buf: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx_vcm_cal_sw(phydev: *mut phy_device, rg_txreserve_x: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt798x_phy_common_finetune(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn mt7981_phy_finetune(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn mt7988_phy_finetune(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn mt798x_phy_eee(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn mt798x_phy_calibration(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt798x_phy_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7988_phy_led_get_polarity(phydev: *mut phy_device, led_num: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt7988_phy_fix_leds_polarities(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7988_phy_probe_shared(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7988_phy_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7981_phy_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn an7581_phy_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn an7583_phy_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn en7528_phy_config_init(phydev: *mut phy_device) -> c_int {
