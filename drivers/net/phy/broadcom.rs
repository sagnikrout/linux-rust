...
//! Source: drivers/net/phy/broadcom.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm54xx_phy_priv {
    pub stats: *mut u64,
    pub ptp: *mut bcm_ptp_private,
    pub wake_irq: c_int,
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_phy_can_wakeup(phydev: *mut phy_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_config_clock_delay(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54210e_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54612e_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54616s_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm50610_a0_workaround(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_phydsp_config(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_adjust_rxrefclk(phydev: *mut phy_device) {
    static void bcm54xx_adjust_rxrefclk(struct phy_device *phydev)
    {
    u32 orig;
    int val;
    let mut clk125en: bool = true;
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_ptp_stop(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_ptp_config_init(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn bcm5481x_set_brrmode(phydev: *mut phy_device, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54811_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_iddq_set(phydev: *mut phy_device, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_set_wakeup_irq(phydev: *mut phy_device, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_suspend(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_resume(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54810_read_mmd(phydev: *mut phy_device, devnum: c_int, regnum: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm5481x_read_abilities(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5481x_config_delay_swap(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5481_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54811_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm54616s_phy_priv {
    pub mode_1000bx_en: bool,
}

#[no_mangle]
unsafe extern "C" fn bcm54616s_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54616s_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54616s_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_fet_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_fet_ack_interrupt(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_fet_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_fet_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn brcm_fet_suspend(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5221_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm5221_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_phy_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_link_change_notify(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn lre_read_master_slave(phydev: *mut phy_device) -> c_int {
    static int lre_read_master_slave(struct phy_device *phydev)
    {
    let mut cfg: c_int = MASTER_SLAVE_CFG_UNKNOWN, state;
    int val;
...
#[no_mangle]
unsafe extern "C" fn lre_read_lpa(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lre_read_status_fixed(phydev: *mut phy_device) -> c_int {
    static int lre_read_status_fixed(struct phy_device *phydev)
    {
    let mut lrecr: c_int = phy_read(phydev, MII_BCM54XX_LRECR);
    if (lrecr < 0)
    return lrecr;
...
//
#[no_mangle]
unsafe extern "C" fn lre_update_link(phydev: *mut phy_device) -> c_int {
    static int lre_update_link(struct phy_device *phydev)
    {
    let mut status: c_int = 0, lrecr;
...
//
    ...
    return status;
#[no_mangle]
pub unsafe extern "C" fn if(LRESR_LSTATUS: status &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn bcm54811_lre_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(AUTONEG_DISABLE: phydev->autoneg ==) -> else {
    else if (phydev.autoneg == AUTONEG_DISABLE)
    err = lre_read_status_fixed(phydev);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn bcm54811_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm54xx_disable_autonomous_eee(phydev: *mut phy_device) -> c_int {
