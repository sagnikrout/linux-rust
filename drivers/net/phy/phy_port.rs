...
//! Source: drivers/net/phy/phy_port.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_port_destroy(port: *mut phy_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_port_update_supported(port: *mut phy_port) {
...
//
#[no_mangle]
unsafe extern "C" fn phy_port_filter_supported(port: *mut phy_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_port_restrict_mediums(port: *mut phy_port, mediums: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_port_get_type(port: *mut phy_port) -> c_int {
