...
//! Source: drivers/net/phy/mxl-gpy.c
#![no_std]
...
// PHY ID
pub const PHY_ID_GPYx15B_MASK: c_uint = 0xFFFFFFFC;
pub const PHY_ID_GPY21xB_MASK: c_uint = 0xFFFFFFF9;
pub const PHY_ID_GPY2xx: c_uint = 0x67C9DC00;
pub const PHY_ID_GPY115B: c_uint = 0x67C9DF00;
pub const PHY_ID_GPY115C: c_uint = 0x67C9DF10;
pub const PHY_ID_GPY211B: c_uint = 0x67C9DE08;
pub const PHY_ID_GPY211C: c_uint = 0x67C9DE10;
pub const PHY_ID_GPY212B: c_uint = 0x67C9DE09;
pub const PHY_ID_GPY212C: c_uint = 0x67C9DE20;
pub const PHY_ID_GPY215B: c_uint = 0x67C9DF04;
pub const PHY_ID_GPY215C: c_uint = 0x67C9DF20;
pub const PHY_ID_GPY241B: c_uint = 0x67C9DE40;
pub const PHY_ID_GPY241BM: c_uint = 0x67C9DE80;
pub const PHY_ID_GPY245B: c_uint = 0x67C9DEC0;
pub const PHY_ID_MXL86211C: c_uint = 0xC1335400;
pub const PHY_ID_MXL86252: c_uint = 0xC1335520;
pub const PHY_ID_MXL86282: c_uint = 0xC1335500;
pub const PHY_CTL1: c_uint = 0x13;

pub const PHY_ERRCNT: c_uint = 0x15	/* Error counter */;
pub const PHY_MIISTAT: c_uint = 0x18	/* MII state */;
pub const PHY_IMASK: c_uint = 0x19	/* interrupt mask */;
pub const PHY_ISTAT: c_uint = 0x1A	/* interrupt status */;
pub const PHY_LED: c_uint = 0x1B	/* LEDs */;
pub const PHY_FWV: c_uint = 0x1E	/* firmware version */;

pub const PHY_ERRCNT_SEL_RXERR: c_int = 0;

pub const PHY_MIISTAT_SPD_10: c_int = 0;
pub const PHY_MIISTAT_SPD_100: c_int = 1;
pub const PHY_MIISTAT_SPD_1000: c_int = 2;
pub const PHY_MIISTAT_SPD_2500: c_int = 4;

    PHY_IMASK_LSPC | \
    PHY_IMASK_DXMC | \
    PHY_IMASK_ADSC | \
    PHY_IMASK_ANC)
pub const GPY_MAX_LEDS: c_int = 4;

pub const PHY_PMA_MGBT_POLARITY: c_uint = 0x82;

pub const PHY_MDI_MDI_X_NORMAL: c_uint = 0x3;
pub const PHY_MDI_MDI_X_AB: c_uint = 0x2;
pub const PHY_MDI_MDI_X_CD: c_uint = 0x1;
pub const PHY_MDI_MDI_X_CROSS: c_uint = 0x0;
// LED

// SGMII
pub const VSPEC1_SGMII_CTRL: c_uint = 0x08;

    VSPEC1_SGMII_CTRL_ANRS)
// Temperature sensor
pub const VSPEC1_TEMP_STA: c_uint = 0x0E;

// Mailbox
pub const VSPEC1_MBOX_DATA: c_uint = 0x5;
pub const VSPEC1_MBOX_ADDRLO: c_uint = 0x6;
pub const VSPEC1_MBOX_CMD: c_uint = 0x7;

// WoL
pub const VPSPEC2_WOL_CTL: c_uint = 0x0E06;
pub const VPSPEC2_WOL_AD01: c_uint = 0x0E08;
pub const VPSPEC2_WOL_AD23: c_uint = 0x0E09;
pub const VPSPEC2_WOL_AD45: c_uint = 0x0E0A;

// Internal registers, access via mbox
pub const REG_GPIO0_OUT: c_uint = 0xd3ce00;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpy_priv {
...
#[no_mangle]
unsafe extern "C" fn gpy_hwmon_register(phydev: *mut phy_device) -> c_int {
    ...
    hwmon_dev = devm_hwmon_device_register_with_info(dev, core::ptr::null_mut(), phydev,
...
#[no_mangle]
unsafe extern "C" fn gpy_ack_interrupt(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpy_mbox_read(phydev: *mut phy_device, addr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpy_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpy21x_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpy_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpy_sgmii_need_reaneg(phydev: *mut phy_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gpy_2500basex_chk(phydev: *mut phy_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gpy_sgmii_aneg_en(phydev: *mut phy_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gpy_config_mdix(phydev: *mut phy_device, ctrl: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpy_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpy_update_mdix(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpy_update_interface(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpy_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpy_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpy_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gpy_loopback(phydev: *mut phy_device, enable: bool, speed: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpy115_loopback(phydev: *mut phy_device, enable: bool, speed: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpy_config_inband(phydev: *mut phy_device, modes: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpy_update_stats(phydev: *mut phy_device) -> c_int {
