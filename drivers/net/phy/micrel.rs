...
//! Source: drivers/net/phy/micrel.c
#![no_std]
...
pub const MII_KSZPHY_OMSO: c_uint = 0x16;

// general Interrupt control/status reg in vendor specific block.
pub const MII_KSZPHY_INTCS: c_uint = 0x1B;

    KSZPHY_INTCS_LINK_DOWN)

    KSZPHY_INTCS_LINK_UP_STATUS)
// LinkMD Control/Status
pub const KSZ8081_LMD: c_uint = 0x1d;

pub const KSZ8081_LMD_STAT_NORMAL: c_int = 0;
pub const KSZ8081_LMD_STAT_OPEN: c_int = 1;
pub const KSZ8081_LMD_STAT_SHORT: c_int = 2;
pub const KSZ8081_LMD_STAT_FAIL: c_int = 3;

// Short cable (<10 meter) has been detected by LinkMD

pub const KSZ9x31_LMD: c_uint = 0x12;

pub const KSZ9x31_LMD_VCT_SEL_RESULT: c_int = 0;

pub const KSZ9x31_LMD_VCT_ST_NORMAL: c_int = 0;
pub const KSZ9x31_LMD_VCT_ST_OPEN: c_int = 1;
pub const KSZ9x31_LMD_VCT_ST_SHORT: c_int = 2;
pub const KSZ9x31_LMD_VCT_ST_FAIL: c_int = 3;

pub const KSZPHY_WIRE_PAIR_MASK: c_uint = 0x3;
pub const LAN8814_CABLE_DIAG: c_uint = 0x12;

pub const LAN8814_PAIR_BIT_SHIFT: c_int = 12;
// KSZ9x31 remote loopback register
pub const KSZ9x31_REMOTE_LOOPBACK: c_uint = 0x11;
// This is an undocumented bit of the KSZ9131RNX.
// It was reported by NXP in cooperation with Micrel.
//

pub const LAN8814_SKUS: c_uint = 0xB;
pub const LAN8814_WIRE_PAIR_MASK: c_uint = 0xF;
// Lan8814 general Interrupt control/status reg in GPHY specific block.
pub const LAN8814_INTC: c_uint = 0x18;
pub const LAN8814_INTS: c_uint = 0x1B;

    LAN8814_INT_LINK_DOWN)
pub const LAN8814_INTR_CTRL_REG: c_uint = 0x34;

pub const LAN8814_EEE_STATE: c_uint = 0x38;

pub const LAN8814_PD_CONTROLS: c_uint = 0x9d;

pub const LAN8814_PD_CONTROLS_PD_MEAS_TIME_VAL: c_uint = 0xb;
// Represents 1ppm adjustment in 2^32 format with
// each nsec contains 4 clock cycles.
// The value is calculated as following: (1/1000000)/((2^-32)/4)
//
pub const LAN8814_1PPM_FORMAT: c_int = 17179;
// Represents 1ppm adjustment in 2^32 format with
// each nsec contains 8 clock cycles.
// The value is calculated as following: (1/1000000)/((2^-32)/8)
//
pub const LAN8841_1PPM_FORMAT: c_int = 34360;
pub const PTP_RX_VERSION: c_uint = 0x0248;
pub const PTP_TX_VERSION: c_uint = 0x0288;

pub const PTP_RX_MOD: c_uint = 0x024F;

pub const PTP_RX_TIMESTAMP_EN: c_uint = 0x024D;
pub const PTP_TX_TIMESTAMP_EN: c_uint = 0x028D;

pub const PTP_TX_PARSE_L2_ADDR_EN: c_uint = 0x0284;
pub const PTP_RX_PARSE_L2_ADDR_EN: c_uint = 0x0244;
pub const PTP_TX_PARSE_IP_ADDR_EN: c_uint = 0x0285;
pub const PTP_RX_PARSE_IP_ADDR_EN: c_uint = 0x0245;
pub const LTC_HARD_RESET: c_uint = 0x023F;

pub const TSU_HARD_RESET: c_uint = 0x02C1;

pub const PTP_CMD_CTL: c_uint = 0x0200;

pub const PTP_COMMON_INT_ENA: c_uint = 0x0204;

pub const PTP_CLOCK_SET_SEC_HI: c_uint = 0x0205;
pub const PTP_CLOCK_SET_SEC_MID: c_uint = 0x0206;
pub const PTP_CLOCK_SET_SEC_LO: c_uint = 0x0207;
pub const PTP_CLOCK_SET_NS_HI: c_uint = 0x0208;
pub const PTP_CLOCK_SET_NS_LO: c_uint = 0x0209;
pub const PTP_CLOCK_READ_SEC_HI: c_uint = 0x0229;
pub const PTP_CLOCK_READ_SEC_MID: c_uint = 0x022A;
pub const PTP_CLOCK_READ_SEC_LO: c_uint = 0x022B;
pub const PTP_CLOCK_READ_NS_HI: c_uint = 0x022C;
pub const PTP_CLOCK_READ_NS_LO: c_uint = 0x022D;
pub const PTP_GPIO_SEL: c_uint = 0x0230;

pub const PTP_GPIO_CAP_MAP_LO: c_uint = 0x0232;
pub const PTP_GPIO_CAP_EN: c_uint = 0x0233;

pub const PTP_GPIO_RE_LTC_SEC_HI_CAP: c_uint = 0x0235;
pub const PTP_GPIO_RE_LTC_SEC_LO_CAP: c_uint = 0x0236;
pub const PTP_GPIO_RE_LTC_NS_HI_CAP: c_uint = 0x0237;
pub const PTP_GPIO_RE_LTC_NS_LO_CAP: c_uint = 0x0238;
pub const PTP_GPIO_FE_LTC_SEC_HI_CAP: c_uint = 0x0239;
pub const PTP_GPIO_FE_LTC_SEC_LO_CAP: c_uint = 0x023A;
pub const PTP_GPIO_FE_LTC_NS_HI_CAP: c_uint = 0x023B;
pub const PTP_GPIO_FE_LTC_NS_LO_CAP: c_uint = 0x023C;
pub const PTP_GPIO_CAP_STS: c_uint = 0x023D;

pub const PTP_OPERATING_MODE: c_uint = 0x0241;

pub const PTP_TX_MOD: c_uint = 0x028F;

pub const PTP_RX_PARSE_CONFIG: c_uint = 0x0242;

pub const PTP_TX_PARSE_CONFIG: c_uint = 0x0282;

pub const PTP_CLOCK_RATE_ADJ_HI: c_uint = 0x020C;
pub const PTP_CLOCK_RATE_ADJ_LO: c_uint = 0x020D;

pub const PTP_LTC_STEP_ADJ_HI: c_uint = 0x0212;
pub const PTP_LTC_STEP_ADJ_LO: c_uint = 0x0213;

pub const LAN8814_INTR_STS_REG: c_uint = 0x0033;

pub const PTP_CAP_INFO: c_uint = 0x022A;

pub const PTP_TX_EGRESS_SEC_HI: c_uint = 0x0296;
pub const PTP_TX_EGRESS_SEC_LO: c_uint = 0x0297;
pub const PTP_TX_EGRESS_NS_HI: c_uint = 0x0294;
pub const PTP_TX_EGRESS_NS_LO: c_uint = 0x0295;
pub const PTP_TX_MSG_HEADER2: c_uint = 0x0299;
pub const PTP_RX_INGRESS_SEC_HI: c_uint = 0x0256;
pub const PTP_RX_INGRESS_SEC_LO: c_uint = 0x0257;
pub const PTP_RX_INGRESS_NS_HI: c_uint = 0x0254;
pub const PTP_RX_INGRESS_NS_LO: c_uint = 0x0255;
pub const PTP_RX_MSG_HEADER2: c_uint = 0x0259;
pub const PTP_TSU_INT_EN: c_uint = 0x0200;

pub const PTP_TSU_INT_STS: c_uint = 0x0201;

pub const LAN8814_LED_CTRL_1: c_uint = 0x0;

pub const LAN8814_LED_CTRL_2: c_uint = 0x1;

// PHY Control 1
pub const MII_KSZPHY_CTRL_1: c_uint = 0x1e;

// PHY Control 2 / PHY Control (if no PHY Control 1)
pub const MII_KSZPHY_CTRL_2: c_uint = 0x1f;

// Vendor-specific Clause 22 register, virtualized by KSZ87xx embedded PHYs DSA driver
pub const MII_KSZ87XX_SHORT_CABLE: c_uint = 0x1a;
pub const MII_KSZ87XX_LPF_BW: c_uint = 0x1b;
pub const MII_KSZ87XX_EQ_INIT: c_uint = 0x1c;
// bitmap of PHY register to set interrupt mode

// Write/read to/from extended registers
pub const MII_KSZPHY_EXTREG: c_uint = 0x0b;
pub const KSZPHY_EXTREG_WRITE: c_uint = 0x8000;
pub const MII_KSZPHY_EXTREG_WRITE: c_uint = 0x0c;
pub const MII_KSZPHY_EXTREG_READ: c_uint = 0x0d;
// Extended registers
pub const MII_KSZPHY_CLK_CONTROL_PAD_SKEW: c_uint = 0x104;
pub const MII_KSZPHY_RX_DATA_PAD_SKEW: c_uint = 0x105;
pub const MII_KSZPHY_TX_DATA_PAD_SKEW: c_uint = 0x106;
pub const PS_TO_REG: c_int = 200;
pub const FIFO_SIZE: c_int = 8;
pub const LAN8814_PTP_GPIO_NUM: c_int = 24;
pub const LAN8814_PTP_PEROUT_NUM: c_int = 2;
pub const LAN8814_PTP_EXTTS_NUM: c_int = 3;
pub const LAN8814_BUFFER_TIME: c_int = 2;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_200MS: c_int = 13;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_100MS: c_int = 12;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_50MS: c_int = 11;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_10MS: c_int = 10;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_5MS: c_int = 9;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_1MS: c_int = 8;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_500US: c_int = 7;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_100US: c_int = 6;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_50US: c_int = 5;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_10US: c_int = 4;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_5US: c_int = 3;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_1US: c_int = 2;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_500NS: c_int = 1;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_100NS: c_int = 0;
pub const LAN8814_GPIO_EN1: c_uint = 0x20;
pub const LAN8814_GPIO_EN2: c_uint = 0x21;
pub const LAN8814_GPIO_DIR1: c_uint = 0x22;
pub const LAN8814_GPIO_DIR2: c_uint = 0x23;
pub const LAN8814_GPIO_BUF1: c_uint = 0x24;
pub const LAN8814_GPIO_BUF2: c_uint = 0x25;
...
pub const LAN8814_EVENT_A: c_int = 0;
pub const LAN8814_EVENT_B: c_int = 1;
pub const LAN8814_PTP_GENERAL_CONFIG: c_uint = 0x0201;
...
pub const LAN8842_REV_8832: c_uint = 0x8832;
pub const LAN8814_REV_LAN8814: c_uint = 0x8814;
pub const LAN8814_REV_LAN8818: c_uint = 0x8818;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kszphy_hw_stat {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kszphy_type {
    pub led_mode_reg: u32,
    pub interrupt_level_mask: u16,
    pub cable_diag_reg: u16,
    pub pair_mask: c_ulong,
    pub disable_dll_tx_bit: u16,
    pub disable_dll_rx_bit: u16,
    pub disable_dll_mask: u16,
    pub has_broadcast_disable: bool,
    pub has_nand_tree_disable: bool,
    pub has_rmii_ref_clk_sel: bool,
}

// Shared structure between the PHYs of the same package.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lan8814_shared_priv {
...
// Lock for Rx ts fifo
    ...
    pub rx_filter: enum hwtstamp_rx_filters,
    pub layer: c_int,
    pub version: c_int,
    pub ptp_clock: *mut ptp_clock,
    pub ptp_clock_info: ptp_clock_info,
...
// Lock for accessing seconds
    pub seconds_lock: spinlock_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct kszphy_phy_stats {
    pub rx_err_pkt_cnt: u64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct kszphy_priv {
    pub ptp_priv: kszphy_ptp_priv,
    pub type: *const kszphy_type,
    pub clk: *mut clk,
    pub led_mode: c_int,
    pub vct_ctrl1000: u16,
    pub rmii_ref_clk_sel: bool,
    pub rmii_ref_clk_sel_val: bool,
    pub clk_enable: bool,
    pub is_ptp_available: bool,
    pub stats: [u64; ARRAY_SIZE(kszphy_hw_stats)],
    pub phy_stats: kszphy_phy_stats,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lan8842_phy_stats {
    pub rx_packets: u64,
    pub rx_errors: u64,
    pub tx_packets: u64,
    pub tx_errors: u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lan8842_priv {
    pub phy_stats: lan8842_phy_stats,
    pub ptp_priv: kszphy_ptp_priv,
    pub rev: u16,
}
...
#[no_mangle]
unsafe extern "C" fn kszphy_ack_interrupt(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kszphy_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kszphy_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn kszphy_rmii_clk_sel(phydev: *mut phy_device, val: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kszphy_setup_led(phydev: *mut phy_device, reg: u32, val: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kszphy_broadcast_disable(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kszphy_nand_tree_disable(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kszphy_config_reset(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kszphy_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz8041_fiber_mode(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz8041_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz8041_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz8081_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz8081_config_mdix(phydev: *mut phy_device, ctrl: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz8081_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz8081_mdix_update(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz8081_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz8061_config_init(phydev: *mut phy_device) -> c_int {
...
// (const u8 *)data);
    ...
    {
    let mut val1: c_int = -1;
    let mut val2: c_int = -2;
    let mut val3: c_int = -3;
    let mut val4: c_int = -4;
    int newval;
...
#[no_mangle]
unsafe extern "C" fn ksz9021_config_init(phydev: *mut phy_device) -> c_int {
...
pub const KSZ9031_PS_TO_REG: c_int = 60;
// Extended registers
// MMD Address 0x0
pub const MII_KSZ9031RN_FLP_BURST_TX_LO: c_int = 3;
pub const MII_KSZ9031RN_FLP_BURST_TX_HI: c_int = 4;
// MMD Address 0x2
pub const MII_KSZ9031RN_CONTROL_PAD_SKEW: c_int = 4;

pub const MII_KSZ9031RN_RX_DATA_PAD_SKEW: c_int = 5;

pub const MII_KSZ9031RN_TX_DATA_PAD_SKEW: c_int = 6;

pub const MII_KSZ9031RN_CLK_PAD_SKEW: c_int = 8;
...
// 1.80ns
//
pub const RX_ID: c_uint = 0x7;
pub const RX_CLK_ID: c_uint = 0x19;
// set rx to +0.30ns and rx_clk to -0.90ns to compensate the
// internal 1.2ns delay.
//
pub const RX_ND: c_uint = 0xc;
pub const RX_CLK_ND: c_uint = 0x0;
// set tx to -0.42ns and tx_clk to +0.96ns to get 1.38ns delay
pub const TX_ID: c_uint = 0x0;
pub const TX_CLK_ID: c_uint = 0x1f;
// set tx and tx_clk to "No delay adjustment" to keep 0ns
// delay
//
pub const TX_ND: c_uint = 0x7;
pub const TX_CLK_ND: c_uint = 0xf;
// MMD Address 0x1C
pub const MII_KSZ9031RN_EDPD: c_uint = 0x23;

    static int ksz9031_set_loopback(struct phy_device *phydev, bool enable,
    int speed)
    {
    let mut ctl: u16 = BMCR_LOOPBACK;
    int val;
    if (!enable)
    ...
    phydev.speed = speed;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: speed) -> else {
    else if (speed)
    return -EINVAL;
...
//
#[no_mangle]
unsafe extern "C" fn ksz9131_loopback_enable(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ksz9131_loopback_disable(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn ksz9031_center_flp_timing(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9031_enable_edpd(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9031_config_rgmii_delay(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9031_config_init(phydev: *mut phy_device) -> c_int {
...
pub const KSZ9131_SKEW_5BIT_MAX: c_int = 2400;
pub const KSZ9131_SKEW_4BIT_MAX: c_int = 800;
pub const KSZ9131_OFFSET: c_int = 700;
pub const KSZ9131_STEP: c_int = 100;
...
#[no_mangle]
pub unsafe extern "C" fn if(skewmax: skewval >) -> else {
...
pub const KSZ9131RN_MMD_COMMON_CTRL_REG: c_int = 2;
pub const KSZ9131RN_RXC_DLL_CTRL: c_int = 76;
pub const KSZ9131RN_TXC_DLL_CTRL: c_int = 77;
pub const KSZ9131RN_DLL_ENABLE_DELAY: c_int = 0;
#[no_mangle]
unsafe extern "C" fn ksz9131_config_rgmii_delay(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ksz9131_led_errata(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9131_config_init(phydev: *mut phy_device) -> c_int {
...
pub const MII_KSZ9131_AUTO_MDIX: c_uint = 0x1C;

pub const MII_KSZ9131_DIG_AXAN_STS: c_uint = 0x14;

#[no_mangle]
unsafe extern "C" fn ksz9131_mdix_update(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9131_config_mdix(phydev: *mut phy_device, ctrl: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9131_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9131_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9477_get_features(phydev: *mut phy_device) -> c_int {
...
pub const KSZ8873MLL_GLOBAL_CONTROL_4: c_uint = 0x06;

#[no_mangle]
unsafe extern "C" fn ksz8873mll_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9031_get_features(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9031_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9x31_cable_test_start(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9x31_cable_test_result_trans(status: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9x31_cable_test_failed(status: u16) -> bool {
    static bool ksz9x31_cable_test_failed(u16 status)
    {
    let mut stat: c_int = FIELD_GET(KSZ9x31_LMD_VCT_ST_MASK, status);
    let mut stat: return = = KSZ9x31_LMD_VCT_ST_FAIL;
    }
#[no_mangle]
unsafe extern "C" fn ksz9x31_cable_test_fault_length_valid(status: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ksz9x31_cable_test_fault_length(phydev: *mut phy_device, stat: u16) -> c_int {
    static int ksz9x31_cable_test_fault_length(struct phy_device *phydev, u16 stat)
    {
    let mut dt: c_int = FIELD_GET(KSZ9x31_LMD_VCT_DATA_MASK, stat);
// KSZ9131RNX, DS00002841B-page 38, 4.14 LinkMD (R) Cable Diagnostic
//
...
#[no_mangle]
unsafe extern "C" fn ksz9x31_cable_test_wait_for_completion(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9x31_cable_test_get_pair(pair: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9x31_cable_test_one_pair(phydev: *mut phy_device, pair: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz8873mll_config_aneg(phydev: *mut phy_device) -> c_int {
    static int ksz8873mll_config_aneg(struct phy_device *phydev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ksz886x_config_mdix(phydev: *mut phy_device, ctrl: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz886x_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz886x_mdix_update(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz886x_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9477_mdix_update(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9477_read_mdix_ctrl(phydev: *mut phy_device) -> c_int {
    ...
    phydev.mdix_ctrl = ETH_TP_MDI_AUTO;
#[no_mangle]
pub unsafe extern "C" fn if(MII_KSZ9131_AUTO_MDI_SET: val &) -> else {
...
#[no_mangle]
unsafe extern "C" fn ksz9477_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9477_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ksz9477_errata_write {
    pub dev_addr: u8,
    pub reg_addr: u8,
    pub val: u16,
}
...
#[no_mangle]
unsafe extern "C" fn ksz9477_phy_errata(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9477_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kszphy_get_sset_count(phydev: *mut phy_device) -> c_int {
    static int kszphy_get_sset_count(struct phy_device *phydev)
    {
    return ARRAY_SIZE(kszphy_hw_stats);
    }
#[no_mangle]
unsafe extern "C" fn kszphy_get_strings(phydev: *mut phy_device, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn kszphy_get_stat(phydev: *mut phy_device, i: c_int) -> u64 {
    static u64 kszphy_get_stat(struct phy_device *phydev, int i)
    {
    let mut stat: kszphy_hw_stat = kszphy_hw_stats[i];
    struct kszphy_priv *priv = phydev.priv;
    int val;
    u64 ret;
...
//
pub const MII_KSZ9477_PHY_RXER_COUNTER: c_uint = 0x15;
#[no_mangle]
unsafe extern "C" fn kszphy_update_stats(phydev: *mut phy_device) -> c_int {
...
// Channel D: 0xAF
//
pub const KSZ9477_MMD_SIGNAL_QUALITY_CHAN_A: c_uint = 0xac;
...
pub const KSZ9477_MAX_CHANNELS: c_int = 4;
pub const KSZ9477_SQI_MAX: c_int = 7;
...
//
pub const KSZ9477_SQI_SAMPLE_COUNT: c_int = 40;
...
//
#[no_mangle]
unsafe extern "C" fn kszphy_get_sqi(phydev: *mut phy_device) -> c_int {
    static int kszphy_get_sqi(struct phy_device *phydev)
    {
    int sum[KSZ9477_MAX_CHANNELS] = { 0 };
    let mut worst_sqi: c_int = KSZ9477_SQI_MAX;
...
// Calculate average for each channel and find the worst SQI
    for (ch = 0; ch < channels; ch++) {
    let mut avg_raw_sqi: c_int = sum[ch] / KSZ9477_SQI_SAMPLE_COUNT;
    int mapped_sqi;
...
#[no_mangle]
unsafe extern "C" fn kszphy_get_sqi_max(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kszphy_enable_clk(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn kszphy_disable_clk(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn kszphy_generic_resume(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kszphy_generic_suspend(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kszphy_suspend(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kszphy_parse_led_mode(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn kszphy_resume(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ksz8041_resume(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz8041_suspend(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9477_resume(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz8061_resume(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz8061_suspend(phydev: *mut phy_device) -> c_int {
    static int ksz8061_suspend(struct phy_device *phydev)
    {
    return kszphy_suspend(phydev);
    }
#[no_mangle]
unsafe extern "C" fn kszphy_probe(phydev: *mut phy_device) -> c_int {
...
// unnamed clock from the generic ethernet-phy binding
    clk = devm_clk_get_optional(&phydev.mdio.dev, core::ptr::null_mut());
    }
    if (IS_ERR(clk))
    return PTR_ERR(clk);
    priv.clk = clk;
...
#[no_mangle]
unsafe extern "C" fn lan8814_cable_test_start(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz886x_cable_test_start(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz886x_cable_test_result_trans(status: u16, mask: u16) -> __always_inline int {
...
#[no_mangle]
unsafe extern "C" fn ksz886x_cable_test_failed(status: u16, mask: u16) -> __always_inline bool {
...
#[no_mangle]
unsafe extern "C" fn ksz886x_cable_test_fault_length_valid(status: u16, mask: u16) -> __always_inline bool {
...
#[no_mangle]
unsafe extern "C" fn ksz886x_cable_test_wait_for_completion(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8814_cable_test_one_pair(phydev: *mut phy_device, pair: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz886x_cable_test_one_pair(phydev: *mut phy_device, pair: c_int) -> c_int {
...
//
    ...
    {
    const struct kszphy_type *type = phydev.drv.driver_data;
    let mut pair_mask: c_ulong = type.pair_mask;
    let mut retries: c_int = 20;
    let mut ret: c_int = 0;
    int pair;
// finished = false;
...
//
pub const LAN8814_PAGE_PCS: c_int = 0;
//
...
//
pub const LAN8814_PAGE_AFE_PMA: c_int = 1;
//
...
//
pub const LAN8814_PAGE_PCS_DIGITAL: c_int = 2;
//
// LAN8814_PAGE_EEE - Selects Extended Page 3.
//
// This page contains EEE registers
//
pub const LAN8814_PAGE_EEE: c_int = 3;
//
...
//
pub const LAN8814_PAGE_COMMON_REGS: c_int = 4;
//
...
//
pub const LAN8814_PAGE_SYSTEM_CTRL: c_int = 31;
pub const LAN_EXT_PAGE_ACCESS_CONTROL: c_uint = 0x16;
pub const LAN_EXT_PAGE_ACCESS_ADDRESS_DATA: c_uint = 0x17;
pub const LAN_EXT_PAGE_ACCESS_CTRL_EP_FUNC: c_uint = 0x4000;
pub const LAN8814_QSGMII_TX_CONFIG: c_uint = 0x35;

pub const LAN8814_QSGMII_SOFT_RESET: c_uint = 0x43;

pub const LAN8814_QSGMII_PCS1G_ANEG_CONFIG: c_uint = 0x13;

pub const LAN8814_ALIGN_SWAP: c_uint = 0x4a;
pub const LAN8814_ALIGN_TX_A_B_SWAP: c_uint = 0x1;

pub const LAN8804_ALIGN_SWAP: c_uint = 0x4a;
pub const LAN8804_ALIGN_TX_A_B_SWAP: c_uint = 0x1;

pub const LAN8814_CLOCK_MANAGEMENT: c_uint = 0xd;
pub const LAN8814_LINK_QUALITY: c_uint = 0x8e;
#[no_mangle]
unsafe extern "C" fn lanphy_read_page_reg(phydev: *mut phy_device, page: c_int, addr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8814_config_ts_intr(phydev: *mut phy_device, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8814_ts_info(mii_ts: *mut mii_timestamper, info: *mut kernel_ethtool_ts_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8814_flush_fifo(phydev: *mut phy_device, egress: bool) {
...
#[no_mangle]
unsafe extern "C" fn lan8814_get_sig_rx(skb: *mut sk_buff, sig: *mut u16) -> bool {
    ...
    if (!ptp_header)
    return false;
// sig = ( u16)(ntohs(ptp_header->sequence_id));
    return true;
    }
...
#[no_mangle]
unsafe extern "C" fn lan8814_rxtstamp(mii_ts: *mut mii_timestamper, skb: *mut sk_buff, type: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lan8814_ptp_update_target(phydev: *mut phy_device, sec: time64_t) {
...
// carry into seconds
    ...
    u32 nsec;
    if (seconds > 0) {
    let mut adjustment_value: u32 = (u32)seconds;
...
#[no_mangle]
unsafe extern "C" fn lan8814_ptpci_adjtime(ptpci: *mut ptp_clock_info, delta: i64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8814_ptpci_adjfine(ptpci: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8814_ptp_disable_event(phydev: *mut phy_device, event: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lan8814_ptp_perout_off(phydev: *mut phy_device, pin: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lan8814_ptp_perout_on(phydev: *mut phy_device, pin: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lan8814_ptp_extts_on(phydev: *mut phy_device, pin: c_int, flags: u32) {
...
#[no_mangle]
unsafe extern "C" fn lan8814_ptp_extts_off(phydev: *mut phy_device, pin: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lan8814_get_sig_tx(skb: *mut sk_buff, sig: *mut u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lan8814_dequeue_tx_skb(ptp_priv: *mut kszphy_ptp_priv) {
...
#[no_mangle]
unsafe extern "C" fn lan8814_get_tx_ts(ptp_priv: *mut kszphy_ptp_priv) {
...
#[no_mangle]
unsafe extern "C" fn lan8814_get_rx_ts(ptp_priv: *mut kszphy_ptp_priv) {
...
#[no_mangle]
unsafe extern "C" fn lan8814_handle_ptp_interrupt(phydev: *mut phy_device, status: u16) {
...
#[no_mangle]
unsafe extern "C" fn lan8814_gpio_process_cap(shared: *mut lan8814_shared_priv) -> c_int {
    static int lan8814_gpio_process_cap(struct lan8814_shared_priv *shared)
    {
    struct phy_device *phydev = shared.phydev;
    let mut ptp_event: ptp_clock_event = {0};
    unsigned long nsec;
    s64 sec;
    u16 tmp;
...
#[no_mangle]
unsafe extern "C" fn lan8814_handle_gpio_interrupt(phydev: *mut phy_device, status: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8804_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8804_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
pub const LAN8804_OUTPUT_CONTROL: c_int = 25;

pub const LAN8804_CONTROL: c_int = 31;

#[no_mangle]
unsafe extern "C" fn lan8804_config_intr(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lan8814_has_ptp(phydev: *mut phy_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lan8814_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn lan8814_ack_interrupt(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8814_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8814_ptp_init(phydev: *mut phy_device) {
...
// Initialise shared lock for clock
    ...
    shared.ptp_clock_info.getcrosststamp = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn lan8814_ptp_probe_once(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8814_setup_led(phydev: *mut phy_device, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lan8814_config_init(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lan8814_release_coma_mode(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8814_clear_2psp_bit(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn lan8814_update_meas_time(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn lan8814_probe(phydev: *mut phy_device) -> c_int {
...
pub const LAN8841_MMD_TIMER_REG: c_int = 0;
pub const LAN8841_MMD0_REGISTER_17: c_int = 17;

pub const LAN8841_OPERATION_MODE_STRAP_OVERRIDE_LOW_REG: c_int = 2;

pub const LAN8841_MMD_ANALOG_REG: c_int = 28;
pub const LAN8841_ANALOG_CONTROL_1: c_int = 1;

pub const LAN8841_ANALOG_CONTROL_10: c_int = 13;

pub const LAN8841_ANALOG_CONTROL_11: c_int = 14;

pub const LAN8841_TX_LOW_I_CH_C_D_POWER_MANAGMENT: c_int = 69;
pub const LAN8841_TX_LOW_I_CH_C_D_POWER_MANAGMENT_VAL: c_uint = 0xbffc;
pub const LAN8841_BTRX_POWER_DOWN: c_int = 70;

pub const LAN8841_ADC_CHANNEL_MASK: c_int = 198;
pub const LAN8841_PTP_RX_PARSE_L2_ADDR_EN: c_int = 370;
pub const LAN8841_PTP_RX_PARSE_IP_ADDR_EN: c_int = 371;
pub const LAN8841_PTP_RX_VERSION: c_int = 374;
pub const LAN8841_PTP_TX_PARSE_L2_ADDR_EN: c_int = 434;
pub const LAN8841_PTP_TX_PARSE_IP_ADDR_EN: c_int = 435;
pub const LAN8841_PTP_TX_VERSION: c_int = 438;
pub const LAN8841_PTP_CMD_CTL: c_int = 256;

pub const LAN8841_PTP_RX_PARSE_CONFIG: c_int = 368;
pub const LAN8841_PTP_TX_PARSE_CONFIG: c_int = 432;
pub const LAN8841_PTP_RX_MODE: c_int = 381;

#[no_mangle]
unsafe extern "C" fn lan8841_config_init(phydev: *mut phy_device) -> c_int {
...
pub const LAN8841_OUTPUT_CTRL: c_int = 25;

#[no_mangle]
unsafe extern "C" fn lan8841_config_intr(phydev: *mut phy_device) -> c_int {
...
pub const LAN8841_PTP_TX_EGRESS_SEC_LO: c_int = 453;
pub const LAN8841_PTP_TX_EGRESS_SEC_HI: c_int = 452;
pub const LAN8841_PTP_TX_EGRESS_NS_LO: c_int = 451;
pub const LAN8841_PTP_TX_EGRESS_NS_HI: c_int = 450;

pub const LAN8841_PTP_TX_MSG_HEADER2: c_int = 455;
...
#[no_mangle]
unsafe extern "C" fn lan8841_ptp_process_tx_ts(ptp_priv: *mut kszphy_ptp_priv) {
...
pub const LAN8841_PTP_INT_STS: c_int = 259;

#[no_mangle]
unsafe extern "C" fn lan8841_ptp_flush_fifo(ptp_priv: *mut kszphy_ptp_priv) {
...
pub const LAN8841_PTP_GPIO_CAP_STS: c_int = 506;
pub const LAN8841_PTP_GPIO_SEL: c_int = 327;

pub const LAN8841_PTP_GPIO_RE_LTC_SEC_HI_CAP: c_int = 498;
pub const LAN8841_PTP_GPIO_RE_LTC_SEC_LO_CAP: c_int = 499;
pub const LAN8841_PTP_GPIO_RE_LTC_NS_HI_CAP: c_int = 500;
pub const LAN8841_PTP_GPIO_RE_LTC_NS_LO_CAP: c_int = 501;
pub const LAN8841_PTP_GPIO_FE_LTC_SEC_HI_CAP: c_int = 502;
pub const LAN8841_PTP_GPIO_FE_LTC_SEC_LO_CAP: c_int = 503;
pub const LAN8841_PTP_GPIO_FE_LTC_NS_HI_CAP: c_int = 504;
pub const LAN8841_PTP_GPIO_FE_LTC_NS_LO_CAP: c_int = 505;
#[no_mangle]
unsafe extern "C" fn lan8841_gpio_process_cap(ptp_priv: *mut kszphy_ptp_priv) {
...
#[no_mangle]
unsafe extern "C" fn lan8841_handle_ptp_interrupt(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn lan8841_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
pub const LAN8841_PTP_INT_EN: c_int = 260;
...
pub const LAN8841_PTP_RX_TIMESTAMP_EN: c_int = 379;
pub const LAN8841_PTP_TX_TIMESTAMP_EN: c_int = 443;
pub const LAN8841_PTP_TX_MOD: c_int = 445;
...
#[no_mangle]
pub unsafe extern "C" fn if(GENMASK(1: (ts.tv_sec &, 0: 0)) == 3 && (ts_header >> 30) ==) -> else {
...
pub const LAN8841_EVENT_A: c_int = 0;
pub const LAN8841_EVENT_B: c_int = 1;
...
pub const LAN8841_BUFFER_TIME: c_int = 2;
...
pub const LAN8841_PTP_LTC_SET_SEC_HI: c_int = 262;
pub const LAN8841_PTP_LTC_SET_SEC_MID: c_int = 263;
pub const LAN8841_PTP_LTC_SET_SEC_LO: c_int = 264;
pub const LAN8841_PTP_LTC_SET_NS_HI: c_int = 265;
pub const LAN8841_PTP_LTC_SET_NS_LO: c_int = 266;
...
pub const LAN8841_PTP_LTC_RD_SEC_HI: c_int = 358;
pub const LAN8841_PTP_LTC_RD_SEC_MID: c_int = 359;
pub const LAN8841_PTP_LTC_RD_SEC_LO: c_int = 360;
pub const LAN8841_PTP_LTC_RD_NS_HI: c_int = 361;
pub const LAN8841_PTP_LTC_RD_NS_LO: c_int = 362;
...
pub const LAN8841_PTP_LTC_STEP_ADJ_LO: c_int = 276;
pub const LAN8841_PTP_LTC_STEP_ADJ_HI: c_int = 275;

#[no_mangle]
unsafe extern "C" fn lan8841_ptp_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
pub const LAN8841_PTP_LTC_RATE_ADJ_HI: c_int = 269;

pub const LAN8841_PTP_LTC_RATE_ADJ_LO: c_int = 270;
#[no_mangle]
unsafe extern "C" fn lan8841_ptp_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
    static int lan8841_ptp_adjfine(struct ptp_clock_info *ptp, long scaled_ppm)
    {
    struct kszphy_ptp_priv *ptp_priv = container_of(ptp, struct kszphy_ptp_priv,
    ptp_clock_info);
    struct phy_device *phydev = ptp_priv.phydev;
    let mut faster: bool = true;
    u32 rate;
    if (!scaled_ppm)
    return 0;
    if (scaled_ppm < 0) {
...
pub const LAN8841_PTP_GPIO_NUM: c_int = 10;
pub const LAN8841_GPIO_EN: c_int = 128;
pub const LAN8841_GPIO_DIR: c_int = 129;
pub const LAN8841_GPIO_BUF: c_int = 130;
#[no_mangle]
unsafe extern "C" fn lan8841_ptp_perout_off(ptp_priv: *mut kszphy_ptp_priv, pin: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8841_ptp_perout_on(ptp_priv: *mut kszphy_ptp_priv, pin: c_int) -> c_int {
...
pub const LAN8841_GPIO_DATA_SEL1: c_int = 131;
pub const LAN8841_GPIO_DATA_SEL2: c_int = 132;

pub const LAN8841_GPIO_DATA_SEL_GPIO_DATA_SEL_EVENT_A: c_int = 1;
pub const LAN8841_GPIO_DATA_SEL_GPIO_DATA_SEL_EVENT_B: c_int = 2;
pub const LAN8841_PTP_GENERAL_CONFIG: c_int = 257;

pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_A: c_int = 4;
pub const LAN8841_PTP_GENERAL_CONFIG_LTC_EVENT_B: c_int = 7;
...
pub const LAN8841_PTP_GPIO_CAP_EN: c_int = 496;
...
#[no_mangle]
unsafe extern "C" fn lan8841_ptp_extts_off(ptp_priv: *mut kszphy_ptp_priv, pin: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8841_ptp_do_aux_work(ptp: *mut ptp_clock_info) -> c_long {
...
pub const LAN8841_OPERATION_MODE_STRAP_LOW_REGISTER: c_int = 3;

#[no_mangle]
unsafe extern "C" fn lan8841_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8804_resume(phydev: *mut phy_device) -> c_int {
    static int lan8804_resume(struct phy_device *phydev)
    {
    return kszphy_resume(phydev);
    }
#[no_mangle]
unsafe extern "C" fn lan8804_suspend(phydev: *mut phy_device) -> c_int {
    static int lan8804_suspend(struct phy_device *phydev)
    {
    return kszphy_generic_suspend(phydev);
    }
#[no_mangle]
unsafe extern "C" fn lan8841_resume(phydev: *mut phy_device) -> c_int {
    static int lan8841_resume(struct phy_device *phydev)
    {
    return kszphy_generic_resume(phydev);
    }
#[no_mangle]
unsafe extern "C" fn lan8841_suspend(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ksz9131_resume(phydev: *mut phy_device) -> c_int {
...
pub const LAN8842_PTP_GPIO_NUM: c_int = 16;
#[no_mangle]
unsafe extern "C" fn lan8842_ptp_probe_once(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8842_probe(phydev: *mut phy_device) -> c_int {
...
pub const LAN8814_POWER_MGMT_MODE_3_ANEG_MDI: c_uint = 0x13;
pub const LAN8814_POWER_MGMT_MODE_4_ANEG_MDIX: c_uint = 0x14;
pub const LAN8814_POWER_MGMT_MODE_5_10BT_MDI: c_uint = 0x15;
pub const LAN8814_POWER_MGMT_MODE_6_10BT_MDIX: c_uint = 0x16;
pub const LAN8814_POWER_MGMT_MODE_7_100BT_TRAIN: c_uint = 0x17;
pub const LAN8814_POWER_MGMT_MODE_8_100BT_MDI: c_uint = 0x18;
pub const LAN8814_POWER_MGMT_MODE_9_100BT_EEE_MDI_TX: c_uint = 0x19;
pub const LAN8814_POWER_MGMT_MODE_10_100BT_EEE_MDI_RX: c_uint = 0x1a;
pub const LAN8814_POWER_MGMT_MODE_11_100BT_MDIX: c_uint = 0x1b;
pub const LAN8814_POWER_MGMT_MODE_12_100BT_EEE_MDIX_TX: c_uint = 0x1c;
pub const LAN8814_POWER_MGMT_MODE_13_100BT_EEE_MDIX_RX: c_uint = 0x1d;
pub const LAN8814_POWER_MGMT_MODE_14_100BTX_EEE_TX_RX: c_uint = 0x1e;
...
pub const LAN8814_EEE_WAKE_TX_TIMER: c_uint = 0x0e;
pub const LAN8814_EEE_WAKE_TX_TIMER_MAX_VAL: c_uint = 0x1f;
...
#[no_mangle]
unsafe extern "C" fn lan8842_erratas(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8842_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8842_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8842_config_inband(phydev: *mut phy_device, modes: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8842_handle_ptp_interrupt(phydev: *mut phy_device, status: u16) {
...
#[no_mangle]
unsafe extern "C" fn lan8842_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn lan8842_get_stat(phydev: *mut phy_device, count: c_int, regs: *mut c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn lan8842_update_stats(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8842_get_fast_down(phydev: *mut phy_device, msecs: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan8842_set_fast_down(phydev: *mut phy_device, msecs: *const u8) -> c_int {
...
pub const LAN9645X_CTRL_REG: c_uint = 0x1f;

pub const LAN9645X_DAC_ICAS_AMP_POWER_DOWN: c_uint = 0x47;
pub const LAN9645X_BTRX_QBIAS_POWER_DOWN: c_uint = 0x46;
pub const LAN9645X_TX_LOW_I_CH_CD_POWER_MGMT: c_uint = 0x45;
pub const LAN9645X_TX_LOW_I_CH_B_POWER_MGMT: c_uint = 0x44;
pub const LAN9645X_TX_LOW_I_CH_A_POWER_MGMT: c_uint = 0x43;
...
#[no_mangle]
unsafe extern "C" fn lan9645x_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan9645x_suspend(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan9645x_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan9645x_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
