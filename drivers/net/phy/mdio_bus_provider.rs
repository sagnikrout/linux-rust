...
//! Source: drivers/net/phy/mdio_bus_provider.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn mdiobus_release(d: *mut device) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mdio_bus_stat_attr {
    pub attr: device_attribute,
    pub address: c_int,
    pub field_offset: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn mdio_bus_get_stat(s: *mut mdio_bus_stats, offset: c_uint) -> u64 {
...
// get global stats
    ...
    let mut addr: c_int = mdiodev.addr;
    u64 val;
    ...
    .attr = __ATTR(field, 0444, mdio_bus_stat_field_show, core::ptr::null_mut()),	\
    .address = -1,							\
    .field_offset = offsetof(struct mdio_bus_stats, field),		\
    };									\
    static const struct mdio_bus_stat_attr dev_attr_mdio_bus_device_##field = { \
    .attr = __ATTR(field, 0444, mdio_bus_device_stat_field_show, core::ptr::null_mut()), \
    .field_offset = offsetof(struct mdio_bus_stats, field),		\
    }
...
//
#[no_mangle]
unsafe extern "C" fn mdio_bus_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdio_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
//
    ...
    {
    struct mii_bus *bus;
    let mut aligned_size: usize = ALIGN(sizeof(*bus), NETDEV_ALIGN);
    size_t alloc_size;
    int i;
...
#[no_mangle]
unsafe extern "C" fn mdiobus_scan_bus_c22(bus: *mut mii_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdiobus_scan_bus_c45(bus: *mut mii_bus) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mdiobus_prevent_c45_scan(bus: *mut mii_bus) -> bool {
    static bool mdiobus_prevent_c45_scan(struct mii_bus *bus)
    {
    struct phy_device *phydev;
    mdiobus_for_each_phy(bus, phydev) {
    let mut oui: u32 = phydev.phy_id >> 10;
    if (oui == MICREL_OUI)
    return true;
    }
    return false;
...
//
#[no_mangle]
pub unsafe extern "C" fn __mdiobus_register(bus: *mut mii_bus, owner: *mut module) -> c_int {
...
// At least one method is mandatory
    ...
    bus.dev.groups = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn mdiobus_unregister(bus: *mut mii_bus) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mdiobus_free(bus: *mut mii_bus) {
...
//
    ...
    return d ? to_mii_bus(d) : core::ptr::null_mut();
    }
