...
//! Source: drivers/net/phy/marvell10g.c
#![no_std]
...
pub const MV_PHY_ALASKA_NBT_QUIRK_MASK: c_uint = 0xfffffffe;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv3310_mactype {
    pub valid: bool,
    pub fixed_interface: bool,
    pub interface_10g: phy_interface_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv3310_chip {
    pub phydev): *mut *mut bool (has_downshift)(struct phy_device,
    pub mask): *mut *mut void (init_supported_interfaces)(unsigned long,
    pub phydev): *mut *mut int (get_mactype)(struct phy_device,
    pub mactype): *mut *mut *mut int (set_mactype)(struct phy_device phydev, int,
    pub interfaces): *mut *mut int (select_mactype)(unsigned long,
    pub mactypes: *const mv3310_mactype,
    pub n_mactypes: usize,

    pub phydev): *mut *mut int (hwmon_read_temp_reg)(struct phy_device,

}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv3310_priv {
    pub PHY_INTERFACE_MODE_MAX): DECLARE_BITMAP(supported_interfaces,,
    pub mactype: *const mv3310_mactype,
    pub firmware_ver: u32,
    pub has_downshift: bool,
...
#[no_mangle]
unsafe extern "C" fn mv3310_hwmon_read_temp_reg(phydev: *mut phy_device) -> c_int {
    static int mv3310_hwmon_read_temp_reg(struct phy_device *phydev)
    {
    return phy_read_mmd(phydev, MDIO_MMD_VEND2, MV_V2_TEMP);
    }
#[no_mangle]
unsafe extern "C" fn mv2110_hwmon_read_temp_reg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_hwmon_config(phydev: *mut phy_device, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_hwmon_probe(phydev: *mut phy_device) -> c_int {
    ...
    &mv3310_hwmon_chip_info, core::ptr::null_mut());
    return PTR_ERR_OR_ZERO(priv.hwmon_dev);
    }

#[no_mangle]
pub unsafe extern "C" fn mv3310_hwmon_config(phydev: *mut phy_device, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_power_down(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_power_up(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_reset(phydev: *mut phy_device, unit: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_get_downshift(phydev: *mut phy_device, ds: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_set_downshift(phydev: *mut phy_device, ds: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_get_edpd(phydev: *mut phy_device, edpd: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_set_edpd(phydev: *mut phy_device, edpd: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_probe(phydev: *mut phy_device) -> c_int {
    static int mv3310_probe(struct phy_device *phydev)
    {
    const struct mv3310_chip *chip = to_mv3310_chip(phydev);
    struct mv3310_priv *priv;
    let mut mmd_mask: u32 = MDIO_DEVS_PMAPMD | MDIO_DEVS_AN;
    int ret;
    if (!phydev.is_c45 ||
...
#[no_mangle]
unsafe extern "C" fn mv3310_remove(phydev: *mut phy_device) {
    static void mv3310_remove(struct phy_device *phydev)
    {
    mv3310_hwmon_config(phydev, false);
    }
#[no_mangle]
unsafe extern "C" fn mv3310_suspend(phydev: *mut phy_device) -> c_int {
    static int mv3310_suspend(struct phy_device *phydev)
    {
    return mv3310_power_down(phydev);
    }
#[no_mangle]
unsafe extern "C" fn mv3310_resume(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mv3310_has_pma_ngbaset_quirk(phydev: *mut phy_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mv2110_get_mactype(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv2110_set_mactype(phydev: *mut phy_device, mactype: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv2110_select_mactype(interfaces: *mut c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(PHY_INTERFACE_MODE_10GBASER, _arg: interfaces)) -> else {
...
#[no_mangle]
unsafe extern "C" fn mv3310_get_mactype(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_set_mactype(phydev: *mut phy_device, mactype: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_select_mactype(interfaces: *mut c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(PHY_INTERFACE_MODE_RXAUI, _arg: interfaces)) -> else {
    else if (test_bit(PHY_INTERFACE_MODE_RXAUI, interfaces))
    return MV_V2_33X0_PORT_CTRL_MACTYPE_RXAUI_RATE_MATCH;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(PHY_INTERFACE_MODE_XAUI, _arg: interfaces)) -> else {
    else if (test_bit(PHY_INTERFACE_MODE_XAUI, interfaces))
    return MV_V2_3310_PORT_CTRL_MACTYPE_XAUI_RATE_MATCH;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(PHY_INTERFACE_MODE_SGMII, _arg: interfaces)) -> else {
    else if (test_bit(PHY_INTERFACE_MODE_SGMII, interfaces))
    return MV_V2_33X0_PORT_CTRL_MACTYPE_10GBASER;
    else
    return -1;
...
#[no_mangle]
unsafe extern "C" fn mv3310_fill_possible_interfaces(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn mv3310_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_get_features(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_config_mdix(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_aneg_done(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_update_interface(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn mv3310_read_status_10gbaser(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_read_status_copper(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv3310_has_downshift(phydev: *mut phy_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mv3310_init_supported_interfaces(mask: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn mv3340_init_supported_interfaces(mask: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn mv2110_init_supported_interfaces(mask: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn mv2111_init_supported_interfaces(mask: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn mv3310_get_number_of_ports(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv211x_match_phy_device(phydev: *mut phy_device, has_5g: bool) -> c_int {
