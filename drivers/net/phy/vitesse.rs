...
//! Source: drivers/net/phy/vitesse.c
#![no_std]
...
pub const MII_VSC73XX_EXT_PAGE_1E: c_uint = 0x01;
pub const MII_VSC82X4_EXT_PAGE_16E: c_uint = 0x10;
pub const MII_VSC82X4_EXT_PAGE_17E: c_uint = 0x11;
pub const MII_VSC82X4_EXT_PAGE_18E: c_uint = 0x12;
// Vitesse Extended Control Register 1
pub const MII_VSC8244_EXT_CON1: c_uint = 0x17;
pub const MII_VSC8244_EXTCON1_INIT: c_uint = 0x0000;
pub const MII_VSC8244_EXTCON1_TX_SKEW_MASK: c_uint = 0x0c00;
pub const MII_VSC8244_EXTCON1_RX_SKEW_MASK: c_uint = 0x0300;
pub const MII_VSC8244_EXTCON1_TX_SKEW: c_uint = 0x0800;
pub const MII_VSC8244_EXTCON1_RX_SKEW: c_uint = 0x0200;
// Vitesse Interrupt Mask Register
pub const MII_VSC8244_IMASK: c_uint = 0x19;
pub const MII_VSC8244_IMASK_IEN: c_uint = 0x8000;
pub const MII_VSC8244_IMASK_SPEED: c_uint = 0x4000;
pub const MII_VSC8244_IMASK_LINK: c_uint = 0x2000;
pub const MII_VSC8244_IMASK_DUPLEX: c_uint = 0x1000;
pub const MII_VSC8244_IMASK_MASK: c_uint = 0xf000;
pub const MII_VSC8221_IMASK_MASK: c_uint = 0xa000;
// Vitesse Interrupt Status Register
pub const MII_VSC8244_ISTAT: c_uint = 0x1a;
pub const MII_VSC8244_ISTAT_STATUS: c_uint = 0x8000;
pub const MII_VSC8244_ISTAT_SPEED: c_uint = 0x4000;
pub const MII_VSC8244_ISTAT_LINK: c_uint = 0x2000;
pub const MII_VSC8244_ISTAT_DUPLEX: c_uint = 0x1000;

    MII_VSC8244_ISTAT_LINK | \
    MII_VSC8244_ISTAT_DUPLEX)

// Vitesse Auxiliary Control/Status Register
pub const MII_VSC8244_AUX_CONSTAT: c_uint = 0x1c;
pub const MII_VSC8244_AUXCONSTAT_INIT: c_uint = 0x0000;
pub const MII_VSC8244_AUXCONSTAT_DUPLEX: c_uint = 0x0020;
pub const MII_VSC8244_AUXCONSTAT_SPEED: c_uint = 0x0018;
pub const MII_VSC8244_AUXCONSTAT_GBIT: c_uint = 0x0010;
pub const MII_VSC8244_AUXCONSTAT_100: c_uint = 0x0008;
pub const MII_VSC8221_AUXCONSTAT_INIT: c_uint = 0x0004 /* need to set this bit? */;
pub const MII_VSC8221_AUXCONSTAT_RESERVED: c_uint = 0x0004;
// Vitesse Extended Page Access Register
pub const MII_VSC82X4_EXT_PAGE_ACCESS: c_uint = 0x1f;
// Vitesse VSC8662 extended control register
pub const VSC8662_EXT_CON1: c_uint = 0x17;

pub const VSC8662_MAC_AN: c_uint = 0x1b;

// Vitesse VSC73XX Extended Control Register
pub const MII_VSC73XX_PHY_CTRL_EXT3: c_uint = 0x14;

pub const MII_VSC73XX_DOWNSHIFT_MAX: c_int = 5;
pub const MII_VSC73XX_DOWNSHIFT_INVAL: c_int = 1;
// VSC73XX PHY_BYPASS_CTRL register

// VSC73XX PHY_AUX_CTRL_STAT register

// Vitesse VSC8601 Extended PHY Control Register 1
pub const MII_VSC8601_EPHY_CTL: c_uint = 0x17;

pub const PHY_ID_VSC8234: c_uint = 0x000fc620;
pub const PHY_ID_VSC8244: c_uint = 0x000fc6c0;
pub const PHY_ID_VSC8572: c_uint = 0x000704d0;
pub const PHY_ID_VSC8601: c_uint = 0x00070420;
pub const PHY_ID_VSC7385: c_uint = 0x00070450;
pub const PHY_ID_VSC7388: c_uint = 0x00070480;
pub const PHY_ID_VSC7395: c_uint = 0x00070550;
pub const PHY_ID_VSC7398: c_uint = 0x00070580;
pub const PHY_ID_VSC8662: c_uint = 0x00070660;
pub const PHY_ID_VSC8221: c_uint = 0x000fc550;
pub const PHY_ID_VSC8211: c_uint = 0x000fc4b0;
    MODULE_DESCRIPTION("Vitesse PHY driver");
    MODULE_AUTHOR("Kriston Carson");
    MODULE_LICENSE("GPL");
#[no_mangle]
unsafe extern "C" fn vsc824x_add_skew(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc824x_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc8662_config_inband(phydev: *mut phy_device, modes: c_uint) -> c_int {
...
pub const VSC73XX_EXT_PAGE_ACCESS: c_uint = 0x1f;
#[no_mangle]
unsafe extern "C" fn vsc73xx_read_page(phydev: *mut phy_device) -> c_int {
    static int vsc73xx_read_page(struct phy_device *phydev)
    {
    return __phy_read(phydev, VSC73XX_EXT_PAGE_ACCESS);
    }
#[no_mangle]
unsafe extern "C" fn vsc73xx_write_page(phydev: *mut phy_device, page: c_int) -> c_int {
    static int vsc73xx_write_page(struct phy_device *phydev, int page)
    {
    return __phy_write(phydev, VSC73XX_EXT_PAGE_ACCESS, page);
    }
#[no_mangle]
unsafe extern "C" fn vsc73xx_get_downshift(phydev: *mut phy_device, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc73xx_set_downshift(phydev: *mut phy_device, cnt: u8) -> c_int {
    ...
    return -E2BIG;
#[no_mangle]
pub unsafe extern "C" fn if(MII_VSC73XX_DOWNSHIFT_INVAL: cnt ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn vsc73xx_config_init(phydev: *mut phy_device) {
...
#[no_mangle]
unsafe extern "C" fn vsc738x_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc739x_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc73xx_mdix_set(phydev: *mut phy_device, mdix: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc73xx_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc73xx_mdix_get(phydev: *mut phy_device, mdix: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc73xx_read_status(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vsc8601_add_skew(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc8601_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc82xx_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc82xx_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vsc8221_config_init(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vsc82x4_config_autocross_enable(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vsc82x4_config_aneg(phydev: *mut phy_device) -> c_int {
