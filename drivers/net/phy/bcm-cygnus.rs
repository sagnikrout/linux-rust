...
//! Source: drivers/net/phy/bcm-cygnus.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm_omega_phy_priv {
    pub stats: *mut u64,
}

// Broadcom Cygnus Phy specific registers
pub const MII_BCM_CYGNUS_AFE_VDAC_ICTRL_0: c_uint = 0x91E5 /* VDAL Control register */;
#[no_mangle]
unsafe extern "C" fn bcm_cygnus_afe_config(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_cygnus_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_cygnus_resume(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_omega_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_omega_resume(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_omega_probe(phydev: *mut phy_device) -> c_int {
