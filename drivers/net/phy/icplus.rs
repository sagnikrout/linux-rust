...
//! Source: drivers/net/phy/icplus.c
#![no_std]
...
pub const IP101A_G_IRQ_CONF_STATUS: c_uint = 0x11	/* Conf Info IRQ & Status Reg */;

pub const IP101A_G_PHY_STATUS: c_int = 18;

pub const IP101A_G_PHY_SPEC_CTRL: c_int = 30;

pub const IP101G_PAGE_CONTROL: c_uint = 0x14;

pub const IP101G_DIGITAL_IO_SPEC_CTRL: c_uint = 0x1d;

pub const IP101G_DEFAULT_PAGE: c_int = 16;
pub const IP101G_P1_CNT_CTRL: c_int = 17;

pub const IP101G_P8_CNT_CTRL: c_int = 17;

pub const IP101G_CNT_REG: c_int = 18;
pub const IP175C_PHY_ID: c_uint = 0x02430d80;
pub const IP1001_PHY_ID: c_uint = 0x02430d90;
pub const IP101A_PHY_ID: c_uint = 0x02430c54;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ip101a_g_phy_priv {
    pub sel_intr32: enum ip101gr_sel_intr32,
    pub stats: [u64; ARRAY_SIZE(ip101g_hw_stats)],
}

#[no_mangle]
unsafe extern "C" fn ip175c_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip1001_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip175c_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip175c_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip101a_g_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: device_property_read_bool(dev, _arg: "icplus, _arg: select-interrupt")) -> else {
...
#[no_mangle]
unsafe extern "C" fn ip101a_g_config_intr_pin(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip101a_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip101g_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip101a_g_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip101a_g_config_mdix(phydev: *mut phy_device) -> c_int {
    static int ip101a_g_config_mdix(struct phy_device *phydev)
    {
    let mut ctrl: u16 = 0, ctrl2 = 0;
    int oldpage;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ip101a_g_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip101a_g_ack_interrupt(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip101a_g_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip101a_g_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ip101a_read_page(phydev: *mut phy_device) -> c_int {
    static int ip101a_read_page(struct phy_device *phydev)
    {
    return IP101G_DEFAULT_PAGE;
    }
#[no_mangle]
unsafe extern "C" fn ip101a_write_page(phydev: *mut phy_device, page: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip101g_read_page(phydev: *mut phy_device) -> c_int {
    static int ip101g_read_page(struct phy_device *phydev)
    {
    return __phy_read(phydev, IP101G_PAGE_CONTROL);
    }
#[no_mangle]
unsafe extern "C" fn ip101g_write_page(phydev: *mut phy_device, page: c_int) -> c_int {
    static int ip101g_write_page(struct phy_device *phydev, int page)
    {
    return __phy_write(phydev, IP101G_PAGE_CONTROL, page);
    }
#[no_mangle]
unsafe extern "C" fn ip101a_g_has_page_register(phydev: *mut phy_device) -> c_int {
    ...
    if (ret)
    return ret;
    let mut val: return = = IP101G_PAGE_CONTROL_MASK;
    }
#[no_mangle]
unsafe extern "C" fn ip101a_g_match_phy_device(phydev: *mut phy_device, ip101a: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ip101g_get_sset_count(phydev: *mut phy_device) -> c_int {
    static int ip101g_get_sset_count(struct phy_device *phydev)
    {
    return ARRAY_SIZE(ip101g_hw_stats);
    }
#[no_mangle]
unsafe extern "C" fn ip101g_get_strings(phydev: *mut phy_device, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn ip101g_get_stat(phydev: *mut phy_device, i: c_int) -> u64 {
    static u64 ip101g_get_stat(struct phy_device *phydev, int i)
    {
    let mut stat: ip101g_hw_stat = ip101g_hw_stats[i];
    struct ip101a_g_phy_priv *priv = phydev.priv;
    int val;
    u64 ret;
