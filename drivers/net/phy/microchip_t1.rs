...
//! Source: drivers/net/phy/microchip_t1.c
#![no_std]
...
pub const PHY_ID_LAN87XX: c_uint = 0x0007c150;
pub const PHY_ID_LAN937X: c_uint = 0x0007c180;
pub const PHY_ID_LAN887X: c_uint = 0x0007c1f0;
pub const MCHP_RDS_PTP_LTC_BASE_ADDR: c_uint = 0xe000;
...
pub const PHYACC_ATTR_MODE_READ: c_int = 0;
pub const PHYACC_ATTR_MODE_WRITE: c_int = 1;
pub const PHYACC_ATTR_MODE_MODIFY: c_int = 2;
pub const PHYACC_ATTR_MODE_POLL: c_int = 3;
pub const PHYACC_ATTR_BANK_SMI: c_int = 0;
pub const PHYACC_ATTR_BANK_MISC: c_int = 1;
pub const PHYACC_ATTR_BANK_PCS: c_int = 2;
pub const PHYACC_ATTR_BANK_AFE: c_int = 3;
pub const PHYACC_ATTR_BANK_DSP: c_int = 4;
pub const PHYACC_ATTR_BANK_MAX: c_int = 7;
// measurement defines
pub const LAN87XX_CABLE_TEST_OK: c_int = 0;
pub const LAN87XX_CABLE_TEST_OPEN: c_int = 1;
pub const LAN87XX_CABLE_TEST_SAME_SHORT: c_int = 2;
// T1 Registers
pub const T1_AFE_PORT_CFG1_REG: c_uint = 0x0B;
pub const T1_POWER_DOWN_CONTROL_REG: c_uint = 0x1A;
pub const T1_SLV_FD_MULT_CFG_REG: c_uint = 0x18;
pub const T1_CDR_CFG_PRE_LOCK_REG: c_uint = 0x05;
pub const T1_CDR_CFG_POST_LOCK_REG: c_uint = 0x06;
pub const T1_LCK_STG2_MUFACT_CFG_REG: c_uint = 0x1A;
pub const T1_LCK_STG3_MUFACT_CFG_REG: c_uint = 0x1B;
pub const T1_POST_LCK_MUFACT_CFG_REG: c_uint = 0x1C;
pub const T1_TX_RX_FIFO_CFG_REG: c_uint = 0x02;
pub const T1_TX_LPF_FIR_CFG_REG: c_uint = 0x55;
pub const T1_COEF_CLK_PWR_DN_CFG: c_uint = 0x04;
pub const T1_COEF_RW_CTL_CFG: c_uint = 0x0D;
pub const T1_SQI_CONFIG_REG: c_uint = 0x2E;
pub const T1_SQI_CONFIG2_REG: c_uint = 0x4A;
pub const T1_DCQ_SQI_REG: c_uint = 0xC3;

pub const T1_MDIO_CONTROL2_REG: c_uint = 0x10;
pub const T1_INTERRUPT_SOURCE_REG: c_uint = 0x18;
pub const T1_INTERRUPT2_SOURCE_REG: c_uint = 0x08;
pub const T1_EQ_FD_STG1_FRZ_CFG: c_uint = 0x69;
pub const T1_EQ_FD_STG2_FRZ_CFG: c_uint = 0x6A;
pub const T1_EQ_FD_STG3_FRZ_CFG: c_uint = 0x6B;
pub const T1_EQ_FD_STG4_FRZ_CFG: c_uint = 0x6C;
pub const T1_EQ_WT_FD_LCK_FRZ_CFG: c_uint = 0x6D;
pub const T1_PST_EQ_LCK_STG1_FRZ_CFG: c_uint = 0x6E;
pub const T1_MODE_STAT_REG: c_uint = 0x11;

// SQI defines
pub const LAN87XX_MAX_SQI: c_uint = 0x07;
// Chiptop registers
pub const LAN887X_PMA_EXT_ABILITY_2: c_uint = 0x12;

// DSP 100M registers
pub const LAN887x_CDR_CONFIG1_100: c_uint = 0x0405;
pub const LAN887x_LOCK1_EQLSR_CONFIG_100: c_uint = 0x0411;
pub const LAN887x_SLV_HD_MUFAC_CONFIG_100: c_uint = 0x0417;
pub const LAN887x_PLOCK_MUFAC_CONFIG_100: c_uint = 0x041c;
pub const LAN887x_PROT_DISABLE_100: c_uint = 0x0425;
pub const LAN887x_KF_LOOP_SAT_CONFIG_100: c_uint = 0x0454;
// DSP 1000M registers
pub const LAN887X_LOCK1_EQLSR_CONFIG: c_uint = 0x0811;
pub const LAN887X_LOCK3_EQLSR_CONFIG: c_uint = 0x0813;
pub const LAN887X_PROT_DISABLE: c_uint = 0x0825;
pub const LAN887X_FFE_GAIN6: c_uint = 0x0843;
pub const LAN887X_FFE_GAIN7: c_uint = 0x0844;
pub const LAN887X_FFE_GAIN8: c_uint = 0x0845;
pub const LAN887X_FFE_GAIN9: c_uint = 0x0846;
pub const LAN887X_ECHO_DELAY_CONFIG: c_uint = 0x08ec;
pub const LAN887X_FFE_MAX_CONFIG: c_uint = 0x08ee;
// PCS 1000M registers
pub const LAN887X_SCR_CONFIG_3: c_uint = 0x8043;
pub const LAN887X_INFO_FLD_CONFIG_5: c_uint = 0x8048;
// T1 afe registers
pub const LAN887X_ZQCAL_CONTROL_1: c_uint = 0x8080;
pub const LAN887X_AFE_PORT_TESTBUS_CTRL2: c_uint = 0x8089;
pub const LAN887X_AFE_PORT_TESTBUS_CTRL4: c_uint = 0x808b;
pub const LAN887X_AFE_PORT_TESTBUS_CTRL6: c_uint = 0x808d;
pub const LAN887X_TX_AMPLT_1000T1_REG: c_uint = 0x80b0;
pub const LAN887X_INIT_COEFF_DFE1_100: c_uint = 0x0422;
// PMA registers
pub const LAN887X_DSP_PMA_CONTROL: c_uint = 0x810e;

// PCS 100M registers
pub const LAN887X_IDLE_ERR_TIMER_WIN: c_uint = 0x8204;
pub const LAN887X_IDLE_ERR_CNT_THRESH: c_uint = 0x8213;
// Misc registers
pub const LAN887X_REG_REG26: c_uint = 0x001a;

// Mis registers
pub const LAN887X_MIS_CFG_REG0: c_uint = 0xa00;

pub const LAN887X_MAC_MODE_RGMII: c_uint = 0x01;
pub const LAN887X_MAC_MODE_SGMII: c_uint = 0x03;
pub const LAN887X_MIS_DLL_CFG_REG0: c_uint = 0xa01;
pub const LAN887X_MIS_DLL_CFG_REG1: c_uint = 0xa02;

    LAN887X_MIS_DLL_EN)
pub const LAN887X_MIS_CFG_REG2: c_uint = 0xa03;

pub const LAN887X_MIS_PKT_STAT_REG0: c_uint = 0xa06;
pub const LAN887X_MIS_PKT_STAT_REG1: c_uint = 0xa07;
pub const LAN887X_MIS_PKT_STAT_REG3: c_uint = 0xa09;
pub const LAN887X_MIS_PKT_STAT_REG4: c_uint = 0xa0a;
pub const LAN887X_MIS_PKT_STAT_REG5: c_uint = 0xa0b;
pub const LAN887X_MIS_PKT_STAT_REG6: c_uint = 0xa0c;
// Chiptop common registers
pub const LAN887X_COMMON_LED3_LED2: c_uint = 0xc05;

pub const LAN887X_LED_LINK_ACT_ANY_SPEED: c_uint = 0x0;
// MX chip top registers
pub const LAN887X_CHIP_HARD_RST: c_uint = 0xf03e;

pub const LAN887X_CHIP_SOFT_RST: c_uint = 0xf03f;

pub const LAN887X_SGMII_CTL: c_uint = 0xf01a;

pub const LAN887X_SGMII_PCS_CFG: c_uint = 0xf034;

pub const LAN887X_EFUSE_READ_DAT9: c_uint = 0xf209;

pub const LAN887X_CALIB_CONFIG_100: c_uint = 0x437;
...
pub const LAN887X_MAX_PGA_GAIN_100: c_uint = 0x44f;
pub const LAN887X_MIN_PGA_GAIN_100: c_uint = 0x450;
pub const LAN887X_START_CBL_DIAG_100: c_uint = 0x45a;

pub const LAN887X_CBL_DIAG_STOP: c_uint = 0x0;
pub const LAN887X_CBL_DIAG_TDR_THRESH_100: c_uint = 0x45b;
pub const LAN887X_CBL_DIAG_AGC_THRESH_100: c_uint = 0x45c;
pub const LAN887X_CBL_DIAG_MIN_WAIT_CONFIG_100: c_uint = 0x45d;
pub const LAN887X_CBL_DIAG_MAX_WAIT_CONFIG_100: c_uint = 0x45e;
pub const LAN887X_CBL_DIAG_CYC_CONFIG_100: c_uint = 0x45f;
pub const LAN887X_CBL_DIAG_TX_PULSE_CONFIG_100: c_uint = 0x460;
pub const LAN887X_CBL_DIAG_MIN_PGA_GAIN_100: c_uint = 0x462;
pub const LAN887X_CBL_DIAG_AGC_GAIN_100: c_uint = 0x497;
pub const LAN887X_CBL_DIAG_POS_PEAK_VALUE_100: c_uint = 0x499;
pub const LAN887X_CBL_DIAG_NEG_PEAK_VALUE_100: c_uint = 0x49a;
pub const LAN887X_CBL_DIAG_POS_PEAK_TIME_100: c_uint = 0x49c;
pub const LAN887X_CBL_DIAG_NEG_PEAK_TIME_100: c_uint = 0x49d;
pub const MICROCHIP_CABLE_NOISE_MARGIN: c_int = 20;
pub const MICROCHIP_CABLE_TIME_MARGIN: c_int = 89;
pub const MICROCHIP_CABLE_MIN_TIME_DIFF: c_int = 96;

    (MICROCHIP_CABLE_MIN_TIME_DIFF + MICROCHIP_CABLE_TIME_MARGIN)
pub const LAN887X_INT_STS: c_uint = 0xf000;
pub const LAN887X_INT_MSK: c_uint = 0xf001;

pub const LAN887X_MX_CHIP_TOP_REG_CONTROL1: c_uint = 0xF002;

    LAN887X_INT_MSK_LINK_DOWN_MSK)

    LAN887X_MX_CHIP_TOP_LINK_MSK)
pub const LAN887X_COEFF_PWR_DN_CONFIG_100: c_uint = 0x0404;
pub const LAN887X_COEFF_PWR_DN_CONFIG_100_V: c_uint = 0x16d6;
pub const LAN887X_SQI_CONFIG_100: c_uint = 0x042e;
pub const LAN887X_SQI_CONFIG_100_V: c_uint = 0x9572;
pub const LAN887X_SQI_MSE_100: c_uint = 0x483;
pub const LAN887X_POKE_PEEK_100: c_uint = 0x040d;

pub const LAN887X_COEFF_MOD_CONFIG: c_uint = 0x080d;

pub const LAN887X_DCQ_SQI_STATUS: c_uint = 0x08b2;
// SQI raw samples count
pub const SQI_SAMPLES: c_int = 200;
// Samples percentage considered for SQI calculation
pub const SQI_INLINERS_PERCENT: c_int = 60;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lan887x_priv {
    pub stats: [u64; ARRAY_SIZE(lan887x_hw_stats)],
    pub clock: *mut mchp_rds_ptp_clock,
    pub init_done: bool,
}

#[no_mangle]
unsafe extern "C" fn lan937x_dsp_workaround(phydev: *mut phy_device, ereg: u16, bank: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan87xx_config_rgmii_delay(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan87xx_phy_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan87xx_phy_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan87xx_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn lan87xx_config_init(phydev: *mut phy_device) -> c_int {
    static int lan87xx_config_init(struct phy_device *phydev)
    {
    let mut rc: c_int = lan87xx_phy_init(phydev);
    return rc < 0 ? rc : 0;
    }
#[no_mangle]
unsafe extern "C" fn microchip_cable_test_start_common(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan87xx_cable_test_start(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan87xx_cable_test_report_trans(result: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan87xx_cable_test_report(phydev: *mut phy_device) -> c_int {
    static int lan87xx_cable_test_report(struct phy_device *phydev)
    {
    let mut pos_peak_cycle: c_int = 0, pos_peak_in_phases = 0, pos_peak_phase = 0;
    let mut neg_peak_cycle: c_int = 0, neg_peak_in_phases = 0, neg_peak_phase = 0;
    let mut noise_margin: c_int = 20, time_margin = 89, jitter_var = 30;
    let mut min_time_diff: c_int = 96, max_time_diff = 96 + time_margin;
    let mut fault: bool = false, check_a = false, check_b = false;
    let mut gain_idx: c_int = 0, pos_peak = 0, neg_peak = 0;
    let mut pos_peak_time: c_int = 0, neg_peak_time = 0;
    let mut pos_peak_in_phases_hybrid: c_int = 0;
    let mut detect: c_int = -1;
...
// process values
    ...
    detect = 2;
#[no_mangle]
pub unsafe extern "C" fn if(check_b: (neg_peak_in_phases > pos_peak_in_phases) &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn lan87xx_read_status(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan87xx_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan87xx_get_sqi(phydev: *mut phy_device) -> c_int {
    static int lan87xx_get_sqi(struct phy_device *phydev)
    {
    let mut sqi_value: u8 = 0;
    int rc;
    rc = access_ereg(phydev, PHYACC_ATTR_MODE_WRITE,
...
#[no_mangle]
unsafe extern "C" fn lan87xx_get_sqi_max(phydev: *mut phy_device) -> c_int {
    static int lan87xx_get_sqi_max(struct phy_device *phydev)
    {
    return LAN87XX_MAX_SQI;
    }
#[no_mangle]
unsafe extern "C" fn lan887x_rgmii_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_sgmii_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_config_rgmii_en(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_config_phy_interface(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_get_features(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_phy_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_phy_setup(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_100M_setup(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_1000M_setup(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_link_setup(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lan887x_phy_reset(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_phy_reconfig(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_config_aneg(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_probe(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_get_stat(phydev: *mut phy_device, i: c_int) -> u64 {
    static u64 lan887x_get_stat(struct phy_device *phydev, int i)
    {
    let mut stat: lan887x_hw_stat = lan887x_hw_stats[i];
    struct lan887x_priv *priv = phydev.priv;
    int val;
    u64 ret;
    if (stat.mmd)
...
#[no_mangle]
unsafe extern "C" fn lan887x_get_sset_count(phydev: *mut phy_device) -> c_int {
    static int lan887x_get_sset_count(struct phy_device *phydev)
    {
    return ARRAY_SIZE(lan887x_hw_stats);
    }
#[no_mangle]
unsafe extern "C" fn lan887x_get_strings(phydev: *mut phy_device, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn lan887x_config_intr(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_handle_interrupt(phydev: *mut phy_device) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn lan887x_cable_test_start(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan887x_cable_test_report(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sqi_compare(a: *const c_void, b: *const c_void) -> c_int {
    static int sqi_compare(const void *a, const void *b)
    {
    return  *(u16 *)a - *(u16 *)b;
    }
#[no_mangle]
unsafe extern "C" fn lan887x_get_sqi_100M(phydev: *mut phy_device) -> c_int {
    static int lan887x_get_sqi_100M(struct phy_device *phydev)
    {
    u16 rawtable[SQI_SAMPLES];
    let mut sqiavg: u32 = 0;
    let mut sqinum: u8 = 0;
    int rc, i;
...
// Sort SQI raw readings in ascending order
    sort(rawtable, SQI_SAMPLES, sizeof(u16), sqi_compare, core::ptr::null_mut());
...
// Get SQI average
    ...
    sqinum = 7;
#[no_mangle]
pub unsafe extern "C" fn if(94: sqiavg <) -> else {
    else if (sqiavg < 94)
    sqinum = 6;
#[no_mangle]
pub unsafe extern "C" fn if(119: sqiavg <) -> else {
    else if (sqiavg < 119)
    sqinum = 5;
#[no_mangle]
pub unsafe extern "C" fn if(150: sqiavg <) -> else {
    else if (sqiavg < 150)
    sqinum = 4;
#[no_mangle]
pub unsafe extern "C" fn if(189: sqiavg <) -> else {
    else if (sqiavg < 189)
    sqinum = 3;
#[no_mangle]
pub unsafe extern "C" fn if(237: sqiavg <) -> else {
    else if (sqiavg < 237)
    sqinum = 2;
#[no_mangle]
pub unsafe extern "C" fn if(299: sqiavg <) -> else {
    else if (sqiavg < 299)
    sqinum = 1;
    else
    sqinum = 0;
...
#[no_mangle]
unsafe extern "C" fn lan887x_get_sqi(phydev: *mut phy_device) -> c_int {
