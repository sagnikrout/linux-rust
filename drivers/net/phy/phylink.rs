...
//! Source: drivers/net/phy/phylink.c
#![no_std]
...
// private:
    ...
    pub mac_ops: *const phylink_mac_ops,
    pub config: *mut phylink_config,
    pub pcs: *mut phylink_pcs,
    pub dev: *mut device,
    pub old_link_state:1: c_uint,
    pub /: *mut *mut unsigned long phylink_disable_state; / bitmask of disables,
    pub phydev: *mut phy_device,
    pub /: *mut *mut phy_interface_t link_interface; / PHY_INTERFACE_xxx,
    pub /: *mut *mut u8 cfg_link_an_mode; / MLO_AN_xxx,
    pub /: *mut *mut u8 req_link_an_mode; / Requested MLO_AN_xxx mode,
    pub /: *mut *mut u8 act_link_an_mode; / Active MLO_AN_xxx mode,
    pub /: *mut *mut u8 link_port; / The current non-phy ethtool port,
// The link configuration settings
    pub link_config: phylink_link_state,
// The current settings
    pub cur_interface: phy_interface_t,
    pub link_gpio: *mut gpio_desc,
    pub link_irq: c_uint,
    pub link_poll: timer_list,
    pub state_mutex: mutex,
// Serialize updates to pl->phydev with phylink_resolve()
    pub phydev_mutex: mutex,
    pub phy_state: phylink_link_state,
    pub phy_ib_mode: c_uint,
    pub resolve: work_struct,
    pub pcs_neg_mode: c_uint,
    pub pcs_state: c_uint,
    pub link_failed: bool,
    pub suspend_link_up: bool,
    pub force_major_config: bool,
    pub major_config_failed: bool,
    pub mac_supports_eee_ops: bool,
    pub mac_supports_eee: bool,
    pub phy_enable_tx_lpi: bool,
    pub mac_enable_tx_lpi: bool,
    pub mac_tx_clk_stop: bool,
    pub mac_tx_lpi_timer: u32,
    pub mac_rx_clk_stop_blocked: u8,
    pub sfp_bus: *mut sfp_bus,
    pub sfp_may_have_phy: bool,
    pub sfp_port: u8,
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_set_port_modes(mask: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn phylink_is_empty_linkmode(linkmode: *const c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phylink_interface_signal_rate(interface: phy_interface_t) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn phylink_interface_max_speed(interface: phy_interface_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn phylink_caps_to_link_caps(caps: c_ulong) -> c_ulong {
    static unsigned long phylink_caps_to_link_caps(unsigned long caps)
    {
    let mut link_caps: c_ulong = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn phylink_link_caps_to_mac_caps(link_caps: c_ulong) -> c_ulong {
...
//
    ...
    unsigned long caps)
    {
    let mut link_caps: c_ulong = phylink_caps_to_link_caps(caps);
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_limit_mac_speed(config: *mut phylink_config, max_speed: u32) {
...
//
    ...
    int rate_matching)
    {
    let mut link_caps: c_ulong = phy_caps_from_interface(interface);
    let mut max_speed: c_int = phylink_interface_max_speed(interface);
    let mut caps: c_ulong = MAC_SYM_PAUSE | MAC_ASYM_PAUSE;
    let mut matched_caps: c_ulong = 0;
...
//
    ...
    struct phylink_link_state *state)
    {
    struct phylink_pcs *pcs = core::ptr::null_mut();
...
// Then validate the link parameters with the MAC
    ...
    return phylink_validate_mask(pl, core::ptr::null_mut(), supported, state,
    interfaces);
...
#[no_mangle]
unsafe extern "C" fn phylink_fill_fixedlink_supported(supported: *mut c_ulong) {
...
//
    ...
    pl.link_gpio = desc;
#[no_mangle]
pub unsafe extern "C" fn if(ERR_PTR(-EPROBE_DEFER): desc ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn phylink_resolve_an_pause(state: *mut phylink_link_state) {
...
#[no_mangle]
unsafe extern "C" fn phylink_pcs_disable(pcs: *mut phylink_pcs) {
...
#[no_mangle]
unsafe extern "C" fn phylink_pcs_enable(pcs: *mut phylink_pcs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phylink_pcs_disable_eee(pcs: *mut phylink_pcs) {
...
#[no_mangle]
unsafe extern "C" fn phylink_pcs_enable_eee(pcs: *mut phylink_pcs) {
...
#[no_mangle]
unsafe extern "C" fn phylink_pcs_poll_stop(pl: *mut phylink) {
...
#[no_mangle]
unsafe extern "C" fn phylink_pcs_poll_start(pl: *mut phylink) {
...
#[no_mangle]
pub unsafe extern "C" fn phylink_pcs_pre_init(pl: *mut phylink, pcs: *mut phylink_pcs) -> c_int {
...
// Signal to PCS driver that MAC requires RX clock for init
    ...
    const struct phylink_link_state *state)
    {
    let mut st: phylink_link_state = *state;
...
#[no_mangle]
unsafe extern "C" fn phylink_pcs_an_restart(pl: *mut phylink) {
...
#[no_mangle]
unsafe extern "C" fn phylink_get_inband_type(interface: phy_interface_t) -> enum inband_type {
...
//
    ...
    {
    let mut pcs_ib_caps: c_uint = 0;
    let mut phy_ib_caps: c_uint = 0;
    ...
    let mut pcs_ib_only: bool = false;
    let mut phy_ib_only: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn if(LINK_INBAND_ENABLE: pcs_ib_caps &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(LINK_INBAND_BYPASS: phy_ib_caps &) -> else {
    else if (phy_ib_caps & LINK_INBAND_BYPASS)
    pl.phy_ib_mode = LINK_INBAND_BYPASS;
#[no_mangle]
pub unsafe extern "C" fn if(LINK_INBAND_ENABLE: phy_ib_caps &) -> else {
...
//
    ...
    {
    struct phylink_pcs *pcs = core::ptr::null_mut();
    let mut pcs_changed: bool = false;
...
//
    ...
    if (pl.pcs)
    pl.pcs.phylink = core::ptr::null_mut();
    if (pcs)
    pcs.phylink = pl;
    pl.pcs = pcs;
    }
...
//
#[no_mangle]
unsafe extern "C" fn phylink_change_inband_advert(pl: *mut phylink) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pl->link_gpio) -> else {
...
#[no_mangle]
unsafe extern "C" fn phylink_mac_initial_config(pl: *mut phylink, force_restart: bool) {
...
#[no_mangle]
unsafe extern "C" fn phylink_deactivate_lpi(pl: *mut phylink) {
...
#[no_mangle]
unsafe extern "C" fn phylink_activate_lpi(pl: *mut phylink) {
...
#[no_mangle]
unsafe extern "C" fn phylink_link_down(pl: *mut phylink) {
...
#[no_mangle]
unsafe extern "C" fn phylink_link_is_up(pl: *mut phylink) -> bool {
    static bool phylink_link_is_up(struct phylink *pl)
    {
    return pl.netdev ? netif_carrier_ok(pl.netdev) : pl.old_link_state;
    }
#[no_mangle]
unsafe extern "C" fn phylink_resolve(w: *mut work_struct) {
    static void phylink_resolve(struct work_struct *w)
    {
    struct phylink *pl = container_of(w, struct phylink, resolve);
    struct phylink_link_state link_state;
    let mut mac_config: bool = false;
    let mut retrigger: bool = false;
...
#[no_mangle]
unsafe extern "C" fn phylink_run_resolve(pl: *mut phylink) {
...
#[no_mangle]
unsafe extern "C" fn phylink_run_resolve_and_disable(pl: *mut phylink, bit: c_int) {
    static void phylink_run_resolve_and_disable(struct phylink *pl, int bit)
    {
    let mut state: c_ulong = pl.phylink_disable_state;
...
#[no_mangle]
unsafe extern "C" fn phylink_enable_and_run_resolve(pl: *mut phylink, bit: c_int) {
...
#[no_mangle]
unsafe extern "C" fn phylink_fixed_poll(t: *mut timer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_destroy(pl: *mut phylink) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_expects_phy(pl: *mut phylink) -> bool {
...
#[no_mangle]
unsafe extern "C" fn phylink_phy_change(phydev: *mut phy_device, up: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_connect_phy(pl: *mut phylink, phy: *mut phy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_disconnect_phy(pl: *mut phylink) {
...
#[no_mangle]
unsafe extern "C" fn phylink_link_changed(pl: *mut phylink, up: bool, what: *const c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_mac_change(pl: *mut phylink, up: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_pcs_change(pcs: *mut phylink_pcs, up: bool) {
...
#[no_mangle]
unsafe extern "C" fn phylink_link_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_start(pl: *mut phylink) {
    void phylink_start(struct phylink *pl)
    {
    let mut poll: bool = false;
    ASSERT_RTNL();
...
//
    ...
    let mut irq: c_int = gpiod_to_irq(pl.link_gpio);
    if (irq > 0) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_stop(pl: *mut phylink) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_rx_clk_stop_block(pl: *mut phylink) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_rx_clk_stop_unblock(pl: *mut phylink) {
...
#[no_mangle]
unsafe extern "C" fn phylink_mac_supports_wol(pl: *mut phylink) -> bool {
...
#[no_mangle]
unsafe extern "C" fn phylink_phy_pm_speed_ctrl(pl: *mut phylink) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_suspend(pl: *mut phylink, mac_wol: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_prepare_resume(pl: *mut phylink) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_resume(pl: *mut phylink) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_ethtool_get_wol(pl: *mut phylink, wol: *mut ethtool_wolinfo) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_ethtool_set_wol(pl: *mut phylink, wol: *mut ethtool_wolinfo) -> c_int {
    int phylink_ethtool_set_wol(struct phylink *pl, struct ethtool_wolinfo *wol)
    {
    let mut w: ethtool_wolinfo = { .cmd = ETHTOOL_GWOL };
...
//
    ...
    u32 speed)
    {
    let mut best_interface: phy_interface_t = PHY_INTERFACE_MODE_NA;
    phy_interface_t interface;
    u32 max_speed;
    int i;
...
#[no_mangle]
unsafe extern "C" fn phylink_merge_link_mode(dst: *mut c_ulong, b: *const c_ulong) {
...
//
    ...
    unsigned long *adv)
    {
    let mut inband: c_uint = phylink_inband_caps(pl, interface);
    unsigned int mask;
...
//
    ...
    ASSERT_RTNL();
    if (pl.phydev) {
    let mut phy_kset: ethtool_link_ksettings = *kset;
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_ethtool_nway_reset(pl: *mut phylink) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_get_eee_err(pl: *mut phylink) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_ethtool_get_eee(pl: *mut phylink, eee: *mut ethtool_keee) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_ethtool_set_eee(pl: *mut phylink, eee: *mut ethtool_keee) -> c_int {
    int phylink_ethtool_set_eee(struct phylink *pl, struct ethtool_keee *eee)
    {
    let mut mac_eee: bool = pl.mac_supports_eee;
    let mut ret: c_int = -EOPNOTSUPP;
    ASSERT_RTNL();
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_mii_ioctl(pl: *mut phylink, ifr: *mut ifreq, cmd: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_speed_down(pl: *mut phylink, sync: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_speed_up(pl: *mut phylink) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phylink_sfp_attach(upstream: *mut c_void, bus: *mut sfp_bus) {
...
#[no_mangle]
unsafe extern "C" fn phylink_sfp_detach(upstream: *mut c_void, bus: *mut sfp_bus) {
    static void phylink_sfp_detach(void *upstream, struct sfp_bus *bus)
    {
    struct phylink *pl = upstream;
    pl.netdev.sfp_bus = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn phylink_sfp_config_phy(pl: *mut phylink, phy: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phylink_sfp_config_optical(pl: *mut phylink) -> c_int {
...
//
    ret = phylink_validate_mask(pl, core::ptr::null_mut(), pl.sfp_support, &config,
    pl.sfp_interfaces);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn phylink_sfp_module_remove(upstream: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn phylink_sfp_module_start(upstream: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phylink_sfp_module_stop(upstream: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn phylink_sfp_link_down(upstream: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn phylink_sfp_link_up(upstream: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn phylink_sfp_connect_phy(upstream: *mut c_void, phy: *mut phy_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn phylink_resolve_c73(state: *mut phylink_link_state) {
    void phylink_resolve_c73(struct phylink_link_state *state)
    {
    int i;
    for (i = 0; i < ARRAY_SIZE(phylink_c73_priority_resolution); i++) {
    let mut bit: c_int = phylink_c73_priority_resolution[i].bit;
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_mii_c22_pcs_an_restart(pcs: *mut mdio_device) {
    void phylink_mii_c22_pcs_an_restart(struct mdio_device *pcs)
    {
    let mut val: c_int = mdiodev_read(pcs, MII_BMCR);
    if (val >= 0) {
    val |= BMCR_ANRESTART;
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_replay_link_begin(pl: *mut phylink) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phylink_replay_link_end(pl: *mut phylink) {
...
#[no_mangle]
unsafe extern "C" fn phylink_init() -> int __init {
