...
//! Source: drivers/net/phy/bcm7xxx.c
#![no_std]
...
pub const MII_BCM7XXX_100TX_AUX_CTL: c_uint = 0x10;
pub const MII_BCM7XXX_100TX_FALSE_CAR: c_uint = 0x13;
pub const MII_BCM7XXX_100TX_DISC: c_uint = 0x14;
pub const MII_BCM7XXX_AUX_MODE: c_uint = 0x1d;

pub const MII_BCM7XXX_TEST: c_uint = 0x1f;

pub const MII_BCM7XXX_SHD_2_ADDR_CTRL: c_uint = 0xe;
pub const MII_BCM7XXX_SHD_2_CTRL_STAT: c_uint = 0xf;
pub const MII_BCM7XXX_SHD_2_BIAS_TRIM: c_uint = 0x1a;
pub const MII_BCM7XXX_SHD_3_PCS_CTRL: c_uint = 0x0;
pub const MII_BCM7XXX_SHD_3_PCS_STATUS: c_uint = 0x1;
pub const MII_BCM7XXX_SHD_3_EEE_CAP: c_uint = 0x2;
pub const MII_BCM7XXX_SHD_3_AN_EEE_ADV: c_uint = 0x3;
pub const MII_BCM7XXX_SHD_3_EEE_LP: c_uint = 0x4;
pub const MII_BCM7XXX_SHD_3_EEE_WK_ERR: c_uint = 0x5;
pub const MII_BCM7XXX_SHD_3_PCS_CTRL_2: c_uint = 0x6;
pub const MII_BCM7XXX_PCS_CTRL_2_DEF: c_uint = 0x4400;
pub const MII_BCM7XXX_SHD_3_AN_STAT: c_uint = 0xb;

pub const MII_BCM7XXX_SHD_3_EEE_THRESH: c_uint = 0xe;
pub const MII_BCM7XXX_EEE_THRESH_DEF: c_uint = 0x50;
pub const MII_BCM7XXX_SHD_3_TL4: c_uint = 0x23;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm7xxx_phy_priv {
    pub stats: *mut u64,
}

#[no_mangle]
unsafe extern "C" fn bcm7xxx_28nm_d0_afe_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_28nm_e0_plus_afe_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_28nm_a0_patch_afe_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_28nm_config_init(phydev: *mut phy_device) -> c_int {
    static int bcm7xxx_28nm_config_init(struct phy_device *phydev)
    {
    let mut rev: u8 = PHY_BRCM_7XXX_REV(phydev.dev_flags);
    let mut patch: u8 = PHY_BRCM_7XXX_PATCH(phydev.dev_flags);
    u8 count;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_28nm_resume(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_28nm_ephy_01_afe_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_28nm_ephy_apd_enable(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_28nm_ephy_eee_enable(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_28nm_ephy_config_init(phydev: *mut phy_device) -> c_int {
    static int bcm7xxx_28nm_ephy_config_init(struct phy_device *phydev)
    {
    let mut rev: u8 = phydev.phy_id & ~phydev.drv.phy_id_mask;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_16nm_ephy_afe_config(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_16nm_ephy_config_init(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_16nm_ephy_resume(phydev: *mut phy_device) -> c_int {
...
pub const MII_BCM7XXX_REG_INVALID: c_uint = 0xff;
#[no_mangle]
unsafe extern "C" fn bcm7xxx_28nm_ephy_regnum_to_shd(regnum: u16) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_28nm_ephy_dev_valid(devnum: c_int) -> bool {
    static bool bcm7xxx_28nm_ephy_dev_valid(int devnum)
    {
    let mut devnum: return = = MDIO_MMD_AN || devnum == MDIO_MMD_PCS;
    }
    static int bcm7xxx_28nm_ephy_read_mmd(struct phy_device *phydev,
    int devnum, u16 regnum)
    {
    let mut shd: u8 = bcm7xxx_28nm_ephy_regnum_to_shd(regnum);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_28nm_ephy_resume(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_config_init(phydev: *mut phy_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm7xxx_suspend(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_28nm_suspend(phydev: *mut phy_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm7xxx_28nm_probe(phydev: *mut phy_device) -> c_int {
    ...
    if (!priv.stats)
    return -ENOMEM;
    clk = devm_clk_get_optional_enabled(&phydev.mdio.dev, core::ptr::null_mut());
    if (IS_ERR(clk))
    return PTR_ERR(clk);
// Dummy read to a register to workaround an issue upon reset where the
// internal inverter may not allow the first MDIO transaction to pass
