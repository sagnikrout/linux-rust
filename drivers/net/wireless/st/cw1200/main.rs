...
//! Source: drivers/net/wireless/st/cw1200/main.c
#![no_std]
...
// Accept MAC address of the form macaddr=0x00,0x80,0xE1,0x30,0x40,0x50
    ...
    module_param_array_named(macaddr, cw1200_mac_template, byte, core::ptr::null_mut(), 0444);
    ...
    let mut cw1200_power_mode: c_int = wsm_power_mode_quiescent;
...
// .cancel_remain_on_channel = cw1200_cancel_remain_on_channel,
    ...
    let mut cw1200_ba_rx_tids: static int = -1;
    let mut cw1200_ba_tx_tids: static int = -1;
...
#[no_mangle]
unsafe extern "C" fn cw1200_register_common(dev: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cw1200_free_common(dev: *mut ieee80211_hw) {
    static void cw1200_free_common(struct ieee80211_hw *dev)
    {
    ieee80211_free_hw(dev);
    }
#[no_mangle]
unsafe extern "C" fn cw1200_unregister_common(dev: *mut ieee80211_hw) {
...
// Clock is in KHz
#[no_mangle]
pub unsafe extern "C" fn cw1200_dpll_from_clk(clk_khz: u16) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn cw1200_core_release(self: *mut cw1200_common) {
