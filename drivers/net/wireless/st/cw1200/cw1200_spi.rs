...
//! Source: drivers/net/wireless/st/cw1200/cw1200_spi.c
#![no_std]
...
pub struct hwbus_priv {
    ...
    pub pdata: *const cw1200_platform_data_spi,
    pub /: *mut *mut spinlock_t lock; / Serialize all bus operations,
    pub wq: wait_queue_head_t,
    pub reset: *mut gpio_desc,
    pub powerup: *mut gpio_desc,
    pub claimed: c_int,
}
...
// Header is LE16
    regaddr = ( u16)cpu_to_le16(regaddr);
...
#[no_mangle]
unsafe extern "C" fn cw1200_spi_lock(self: *mut hwbus_priv) {
...
#[no_mangle]
unsafe extern "C" fn cw1200_spi_unlock(self: *mut hwbus_priv) {
...
#[no_mangle]
unsafe extern "C" fn cw1200_spi_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cw1200_spi_irq_subscribe(self: *mut hwbus_priv) -> c_int {
    static int cw1200_spi_irq_subscribe(struct hwbus_priv *self)
    {
    int ret;
    pr_debug("SW IRQ subscribe\n");
    ret = request_threaded_irq(self.func.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn cw1200_spi_irq_unsubscribe(self: *mut hwbus_priv) {
...
#[no_mangle]
unsafe extern "C" fn cw1200_spi_off(self: *mut hwbus_priv, pdata: *const cw1200_platform_data_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cw1200_spi_on(self: *mut hwbus_priv, pdata: *const cw1200_platform_data_spi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cw1200_spi_align_size(self: *mut hwbus_priv, size: usize) -> usize {
    static size_t cw1200_spi_align_size(struct hwbus_priv *self, size_t size)
    {
    return size & 1 ? size + 1 : size;
    }
#[no_mangle]
unsafe extern "C" fn cw1200_spi_pm(self: *mut hwbus_priv, suspend: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cw1200_spi_probe(func: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cw1200_spi_disconnect(func: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn cw1200_spi_suspend(dev: *mut device) -> int __maybe_unused {
...
// XXX notify host that we have to keep CW1200 powered on?
    ...
    static SIMPLE_DEV_PM_OPS(cw1200_pm_ops, cw1200_spi_suspend, core::ptr::null_mut());
    static struct spi_driver spi_driver = {
    .probe		= cw1200_spi_probe,
    .remove		= cw1200_spi_disconnect,
    .driver = {
    .name		= "cw1200_wlan_spi",
    .pm		= IS_ENABLED(CONFIG_PM) ? &cw1200_pm_ops : core::ptr::null_mut(),
    },
    };
