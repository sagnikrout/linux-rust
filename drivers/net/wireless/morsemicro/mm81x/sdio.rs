...
//! Source: drivers/net/wireless/morsemicro/mm81x/sdio.c
#![no_std]
...
//
pub const MM81X_SDIO_BASE_ADDR_UNSET: c_uint = 0xFFFFFFFF;

pub const MM81X_SDIO_REG_ADDRESS_BASE: c_uint = 0x10000;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mm81x_sdio {
    pub enabled: bool,
    pub bulk_addr_base: u32,
    pub register_addr_base: u32,
    pub func: *mut sdio_func,
    pub id: *const sdio_device_id,
}

#[no_mangle]
unsafe extern "C" fn irq_handler(func1: *mut sdio_func) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_enable_irq(sdio: *mut mm81x_sdio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_disable_irq(sdio: *mut mm81x_sdio) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_set_irq(mors: *mut mm81x, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_calculate_base_address(address: u32, access: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_reset_base_address(sdio: *mut mm81x_sdio) {
    ...
    let mut max_retries: static int = 3;
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_claim_host(mors: *mut mm81x) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_release_host(mors: *mut mm81x) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_reg32_write(mors: *mut mm81x, address: u32, val: u32) -> c_int {
    static int mm81x_sdio_reg32_write(struct mm81x *mors, u32 address, u32 val)
    {
    let mut ret: isize = 0;
    let mut original_address: u32 = address;
    struct mm81x_sdio *sdio = (struct mm81x_sdio *)mors.drv_priv;
    struct sdio_func *func1 = sdio.func.card.sdio_func[0];
    mm81x_sdio_set_func_address_base(sdio, func1, address,
    MM81X_CONFIG_ACCESS_4BYTE);
    address &= 0x0000FFFF;
    sdio_writel(func1, ( u32)cpu_to_le32(val),
    ( u32)cpu_to_le32(address), (int *)&ret);
    if (ret)
    goto error;
    return 0;
    error:
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_reg32_read(mors: *mut mm81x, address: u32, val: *mut u32) -> c_int {
    ...
    MM81X_CONFIG_ACCESS_4BYTE);
    address &= 0x0000FFFF;
    value = sdio_readl(func1, ( u32)cpu_to_le32(address),
    (int *)&ret);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_bus_enable(mors: *mut mm81x, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_reset(func: *mut sdio_func) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_config_burst_mode(mors: *mut mm81x, enable_burst: bool) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_enable(sdio: *mut mm81x_sdio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_release(sdio: *mut mm81x_sdio) {
    ...
    {
    let mut ret: c_int = 0;
    struct mm81x *mors = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mm81x_sdio_remove(func: *mut sdio_func) {
