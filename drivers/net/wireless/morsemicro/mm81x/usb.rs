...
//! Source: drivers/net/wireless/morsemicro/mm81x/usb.c
#![no_std]
...
//
pub const URB_TIMEOUT_MS: c_int = 250;
// High speed USB 2^(4-1) * 125usec = 1msec
pub const MM81X_USB_INTERRUPT_INTERVAL: c_int = 4;
// Max bytes per USB read/write

// INT EP buffer size
pub const MM81X_EP_INT_BUFFER_SIZE: c_int = 8;
// Morse vendor IDs
pub const MM81X_VENDOR_ID: c_uint = 0x325b;
pub const MM81X_MM810X_PRODUCT_ID: c_uint = 0x8100;
// Power management runtime auto-suspend delay value in milliseconds
pub const PM_RUNTIME_AUTOSUSPEND_DELAY_MS: c_int = 100;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mm81x_usb {
    pub udev: *mut usb_device,
    pub interface: *mut usb_interface,
    pub endpoints: [mm81x_usb_endpoint; MM81X_EP_EP_MAX],
    pub errors: c_int,
// serialise USB device struct
    pub lock: mutex,
// serialise USB bus access
    pub bus_lock: mutex,
    pub ongoing_cmd: bool,
    pub ongoing_rw: bool,
    pub rw_in_wait: wait_queue_head_t,
    pub flags: c_ulong,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mm81x_usb_command {
    pub /: *mut *mut __le32 dir; / Next BULK direction,
    pub /: *mut *mut __le32 address; / Next BULK address,
    pub /: *mut *mut __le32 length; / Next BULK size,
}
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_irq_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_urb_status_is_disconnect(urb: *const urb) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_int_handler(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_int_enable(mors: *mut mm81x) -> c_int {
    ...
    urb.transfer_dma);
    error_set_urb_null:
    musb.endpoints[MM81X_EP_INT].urb = core::ptr::null_mut();
    usb_free_urb(urb);
    out:
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn mm81x_usb_int_stop(mors: *mut mm81x) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_cmd_callback(urb: *mut urb) {
...
// sync/async unlink faults aren't errors
    ...
    let mut writesize: usize = sizeof(*cmd);
    if (!test_bit(MM81X_USB_FLAG_ATTACHED, &musb.flags))
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_ndr_reset(mors: *mut mm81x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_mem_rw_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_dm_read(mors: *mut mm81x, address: u32, data: *mut u8, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_reg32_read(mors: *mut mm81x, address: u32, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_reg32_write(mors: *mut mm81x, address: u32, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_bus_enable(mors: *mut mm81x, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_claim_bus(mors: *mut mm81x) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_release_bus(mors: *mut mm81x) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_set_irq(mors: *mut mm81x, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_urb_cleanup(mors: *mut mm81x) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_disconnect(interface: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_reset_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mm81x_usb_pre_reset(intf: *mut usb_interface) -> c_int {
    static int mm81x_usb_pre_reset(struct usb_interface *intf)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mm81x_usb_post_reset(intf: *mut usb_interface) -> c_int {
