...
//! Source: drivers/net/wireless/marvell/libertas_tf/main.c
#![no_std]
...
pub const LBTF_FW_VER_MIN: c_uint = 0x05840300;
pub const LBTF_FW_VER_MAX: c_uint = 0x0584ffff;
// Module parameters
...
#[no_mangle]
unsafe extern "C" fn lbtf_cmd_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn command_timer_fn(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn lbtf_init_adapter(priv: *mut lbtf_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lbtf_free_adapter(priv: *mut lbtf_private) {
...
#[no_mangle]
unsafe extern "C" fn lbtf_tx_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: priv->skb_to_tx) -> else {
    skb = priv.skb_to_tx;
    priv.skb_to_tx = core::ptr::null_mut();
    } else {
...
#[no_mangle]
unsafe extern "C" fn lbtf_op_start(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lbtf_op_stop(hw: *mut ieee80211_hw, suspend: bool) {
...
// Flush pending command nodes
    ...
    lbtf_set_bssid(priv, 0, core::ptr::null_mut());
    priv.vif = core::ptr::null_mut();
    lbtf_deb_leave(LBTF_DEB_MACOPS);
    }
#[no_mangle]
unsafe extern "C" fn lbtf_op_config(hw: *mut ieee80211_hw, radio_idx: c_int, changed: u32) -> c_int {
    ...
    let mut mc_count: c_int = netdev_hw_addr_list_count(mc_list);
...
// new_flags &= SUPPORTED_FIF_FLAGS;
    ...
    let mut activate: bool = !is_zero_ether_addr(bss_conf.bssid);
...
#[no_mangle]
pub unsafe extern "C" fn lbtf_rx(priv: *mut lbtf_private, skb: *mut sk_buff) -> c_int {
...
//
    ...
    struct lbtf_private *priv = core::ptr::null_mut();
    lbtf_deb_enter(LBTF_DEB_MAIN);
...
#[no_mangle]
pub unsafe extern "C" fn lbtf_remove_card(priv: *mut lbtf_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lbtf_send_tx_feedback(priv: *mut lbtf_private, retrycnt: u8, fail: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn lbtf_bcn_sent(priv: *mut lbtf_private) {
...
#[no_mangle]
unsafe extern "C" fn lbtf_init_module() -> int __init {
    static int __init lbtf_init_module(void)
    {
    lbtf_deb_enter(LBTF_DEB_MAIN);
    lbtf_wq = alloc_workqueue("libertastf", WQ_MEM_RECLAIM | WQ_UNBOUND, 0);
    if (lbtf_wq == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn lbtf_exit_module() -> void __exit {
