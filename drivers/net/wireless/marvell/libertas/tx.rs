...
//! Source: drivers/net/wireless/marvell/libertas/tx.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn convert_radiotap_rate_to_mv(rate: u8) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn lbs_hard_start_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn lbs_send_tx_feedback(priv: *mut lbs_private, try_count: u32) {
