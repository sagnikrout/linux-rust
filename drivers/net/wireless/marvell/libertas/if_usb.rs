...
//! Source: drivers/net/wireless/marvell/libertas/if_usb.h
#![no_std]
...
pub const BOOT_CMD_RESP_NOT_SUPPORTED: c_uint = 0x0002;
// USB card description structure
#[repr(C)]
#[derive(Copy, Clone)]
pub struct if_usb_card {
    pub udev: *mut usb_device,
    pub /: *mut *mut *mut uint32_t model; / MODEL_,
    pub tx_urb: *mut *mut urb rx_urb,,
    pub priv: *mut lbs_private,
