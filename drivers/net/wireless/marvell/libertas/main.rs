...
//! Source: drivers/net/wireless/marvell/libertas/main.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn lbs_fw_index_to_data_rate(idx: u8) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn lbs_set_iface_type(priv: *mut lbs_private, type: enum nl80211_iftype) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lbs_start_iface(priv: *mut lbs_private) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lbs_dev_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lbs_command_queue_empty(priv: *mut lbs_private) -> bool {
    static bool lbs_command_queue_empty(struct lbs_private *priv)
    {
    unsigned long flags;
    bool ret;
    spin_lock_irqsave(&priv.driver_lock, flags);
    ret = priv.cur_cmd == core::ptr::null_mut() && list_empty(&priv.cmdpendingq);
    spin_unlock_irqrestore(&priv.driver_lock, flags);
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn lbs_stop_iface(priv: *mut lbs_private) -> c_int {
    ...
    priv.currenttxskb = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn lbs_eth_stop(dev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lbs_host_to_card_done(priv: *mut lbs_private) {
...
#[no_mangle]
pub unsafe extern "C" fn lbs_set_mac_address(dev: *mut net_device, addr: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lbs_update_mcast(priv: *mut lbs_private) {
    void lbs_update_mcast(struct lbs_private *priv)
    {
    struct cmd_ds_mac_multicast_adr mcast_cmd;
    let mut dev_flags: c_int = 0;
    int nr_addrs;
    let mut old_mac_control: c_int = priv.mac_control;
...
#[no_mangle]
unsafe extern "C" fn lbs_set_mcast_worker(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn lbs_set_multicast_list(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn lbs_thread(data: *mut c_void) -> c_int {
    ...
    shouldsleep = 0;	/* Bye */
#[no_mangle]
pub unsafe extern "C" fn if(_arg: priv->surpriseremoved) -> else {
    else if (priv.surpriseremoved)
    shouldsleep = 1;	/* We need to wait until we're _told_ to die */
#[no_mangle]
pub unsafe extern "C" fn if(PS_STATE_SLEEP: priv->psstate ==) -> else {
    else if (priv.psstate == PS_STATE_SLEEP)
    shouldsleep = 1;	/* Sleep mode. Nothing we can do till it wakes */
#[no_mangle]
pub unsafe extern "C" fn if(_arg: priv->cmd_timed_out) -> else {
    else if (priv.cmd_timed_out)
    shouldsleep = 0;	/* Command timed out. Recover */
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !priv->fw_ready) -> else {
    else if (!priv.fw_ready)
    shouldsleep = 1;	/* Firmware not ready. We're waiting for it */
#[no_mangle]
pub unsafe extern "C" fn if(_arg: priv->dnld_sent) -> else {
    else if (priv.dnld_sent)
    shouldsleep = 1;	/* Something is en route to the device already */
#[no_mangle]
pub unsafe extern "C" fn if(0: priv->tx_pending_len >) -> else {
    else if (priv.tx_pending_len > 0)
    shouldsleep = 0;	/* We've a packet to send */
#[no_mangle]
pub unsafe extern "C" fn if(_arg: priv->resp_len[priv->resp_idx]) -> else {
    else if (priv.resp_len[priv.resp_idx])
    shouldsleep = 0;	/* We have a command response */
#[no_mangle]
pub unsafe extern "C" fn if(_arg: priv->cur_cmd) -> else {
    else if (priv.cur_cmd)
    shouldsleep = 1;	/* Can't send a command; one already running */
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !list_empty(&priv->cmdpendingq)) -> else {
    else if (!list_empty(&priv.cmdpendingq))
    shouldsleep = 0;	/* We have a command to send */
#[no_mangle]
pub unsafe extern "C" fn if(_arg: kfifo_len(&priv->event_fifo)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn lbs_setup_firmware(priv: *mut lbs_private) -> c_int {
    static int lbs_setup_firmware(struct lbs_private *priv)
    {
    let mut ret: c_int = -1;
    let mut curlevel: i16 = 0, minlevel = 0, maxlevel = 0;
...
#[no_mangle]
pub unsafe extern "C" fn lbs_suspend(priv: *mut lbs_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lbs_resume(priv: *mut lbs_private) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lbs_cmd_timeout_handler(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn lbs_tx_lockup_handler(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn lbs_init_adapter(priv: *mut lbs_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lbs_free_adapter(priv: *mut lbs_private) {
...
//
    ...
    struct lbs_private *priv = core::ptr::null_mut();
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn lbs_remove_card(priv: *mut lbs_private) {
...
#[no_mangle]
pub unsafe extern "C" fn lbs_rtap_supported(priv: *mut lbs_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lbs_start_card(priv: *mut lbs_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lbs_stop_card(priv: *mut lbs_private) {
...
#[no_mangle]
pub unsafe extern "C" fn lbs_queue_event(priv: *mut lbs_private, event: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn lbs_notify_command_response(priv: *mut lbs_private, resp_idx: u8) {
...
#[no_mangle]
unsafe extern "C" fn lbs_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn lbs_exit_module() -> void __exit {
