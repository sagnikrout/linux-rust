...
//! Source: drivers/net/wireless/marvell/libertas/cmdresp.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn lbs_process_command_response(priv: *mut lbs_private, data: *mut u8, len: u32) -> c_int {
    ...
    spin_lock_irqsave(&priv.driver_lock, flags);
    if (!priv.cur_cmd) {
    lbs_deb_host("CMD_RESP: cur_cmd is core::ptr::null_mut()\n");
    ret = -1;
    spin_unlock_irqrestore(&priv.driver_lock, flags);
    goto done;
    }
...
//
    ...
    let mut action: u16 = le16_to_cpu(psmode.action);
    lbs_deb_host(
...
#[no_mangle]
pub unsafe extern "C" fn lbs_process_event(priv: *mut lbs_private, event: u32) {
