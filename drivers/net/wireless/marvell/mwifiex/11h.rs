...
//! Source: drivers/net/wireless/marvell/mwifiex/11h.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_init_11h_params(priv: *mut mwifiex_private) {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_is_11h_active(priv: *mut mwifiex_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_11h_activate(priv: *mut mwifiex_private, flag: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_dfs_cac_work_queue(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_abort_cac(priv: *mut mwifiex_private) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_dfs_chan_sw_work_queue(work: *mut work_struct) {
