...
//! Source: drivers/net/wireless/marvell/mwifiex/tdls.c
#![no_std]
...
pub const TDLS_REQ_FIX_LEN: c_int = 6;
pub const TDLS_RESP_FIX_LEN: c_int = 8;
pub const TDLS_CONFIRM_FIX_LEN: c_int = 6;
pub const MWIFIEX_TDLS_WMM_INFO_SIZE: c_int = 7;
...
// follow AP's channel bandwidth
    ...
    struct ieee80211_vht_cap *vht_cap, *ap_vht_cap = core::ptr::null_mut();
    struct mwifiex_sta_node *sta_ptr;
...
#[no_mangle]
unsafe extern "C" fn mwifiex_tdls_add_qos_capab(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn mwifiex_tdls_add_bss_co_2040(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn mwifiex_tdls_add_supported_chan(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn mwifiex_tdls_add_oper_class(skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_tdls_oper(priv: *mut mwifiex_private, peer: *const u8, action: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_get_tdls_link_status(priv: *mut mwifiex_private, mac: *const u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_disable_all_tdls_links(priv: *mut mwifiex_private) {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_tdls_check_tx(priv: *mut mwifiex_private, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_flush_auto_tdls_list(priv: *mut mwifiex_private) {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_add_auto_tdls_peer(priv: *mut mwifiex_private, mac: *const u8) {
...
// create new TDLS peer
    ...
    peer.failure_count++;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: mwifiex_is_tdls_link_setup(link_status)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_check_auto_tdls(t: *mut timer_list) {
    void mwifiex_check_auto_tdls(struct timer_list *t)
    {
    struct mwifiex_private *priv = timer_container_of(priv, t,
    auto_tdls_timer);
    struct mwifiex_auto_tdls_peer *tdls_peer;
    let mut reason: u16 = WLAN_REASON_TDLS_TEARDOWN_UNSPECIFIED;
    if (WARN_ON_ONCE(!priv || !priv.adapter)) {
    pr_err("mwifiex: %s: adapter or private structure is core::ptr::null_mut()\n",
    __func__);
    return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_setup_auto_tdls_timer(priv: *mut mwifiex_private) {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_clean_auto_tdls(priv: *mut mwifiex_private) {
...
#[no_mangle]
unsafe extern "C" fn mwifiex_config_tdls(priv: *mut mwifiex_private, enable: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_config_tdls_enable(priv: *mut mwifiex_private) -> c_int {
    int mwifiex_config_tdls_enable(struct mwifiex_private *priv)
    {
    return mwifiex_config_tdls(priv, true);
    }
#[no_mangle]
pub unsafe extern "C" fn mwifiex_config_tdls_disable(priv: *mut mwifiex_private) -> c_int {
    int mwifiex_config_tdls_disable(struct mwifiex_private *priv)
    {
    return mwifiex_config_tdls(priv, false);
    }
#[no_mangle]
pub unsafe extern "C" fn mwifiex_config_tdls_cs_params(priv: *mut mwifiex_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_stop_tdls_cs(priv: *mut mwifiex_private, peer_mac: *const u8) -> c_int {
