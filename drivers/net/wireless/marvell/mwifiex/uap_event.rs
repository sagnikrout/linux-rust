...
//! Source: drivers/net/wireless/marvell/mwifiex/uap_event.c
#![no_std]
...
pub const MWIFIEX_BSS_START_EVT_FIX_SIZE: c_int = 12;
    ...
    struct ieee_types_wmm_parameter *wmm_param_ie = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_process_uap_event(priv: *mut mwifiex_private) -> c_int {
