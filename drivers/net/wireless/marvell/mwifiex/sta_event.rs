...
//! Source: drivers/net/wireless/marvell/mwifiex/sta_event.c
#![no_std]
...
pub const MWIFIEX_IBSS_CONNECT_EVT_FIX_SIZE: c_int = 12;
...
// Need to erase the current SSID and BSSID info
    ...
    HostCmd_ACT_GEN_REMOVE, 0, core::ptr::null_mut(), false);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_process_sta_event(priv: *mut mwifiex_private) -> c_int {
