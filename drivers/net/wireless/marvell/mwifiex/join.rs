...
//! Source: drivers/net/wireless/marvell/mwifiex/join.c
#![no_std]
...
// Since WMM is not enabled, setup the queues with the
    defaults */
    mwifiex_wmm_setup_queue_priorities(priv, core::ptr::null_mut());
...
// Parameter IE Id
pub const DS_PARA_IE_ID: c_int = 3;
// Parameter IE length
pub const DS_PARA_IE_LEN: c_int = 1;
...
pub const IBSS_PARA_IE_ID: c_int = 6;
// IBSS parameter IE length
pub const IBSS_PARA_IE_LEN: c_int = 2;
...
// Use G protection
pub const USE_G_PROTECTION: c_uint = 0x02;
...
//
    ...
    struct mwifiex_bssdescriptor *bss_desc;
    let mut cmd: u16 = le16_to_cpu(resp.command);
    u8 result;
    if (!priv.attempted_bss_desc) {
    mwifiex_dbg(priv.adapter, ERROR,
...
//
#[no_mangle]
unsafe extern "C" fn mwifiex_deauthenticate_infra(priv: *mut mwifiex_private, mac: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_deauthenticate(priv: *mut mwifiex_private, mac: *mut u8) -> c_int {
    ...
    if (ret)
    cfg80211_disconnected(priv.netdev, 0, core::ptr::null_mut(), 0,
    true, GFP_KERNEL);
    break;
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_deauthenticate_all(adapter: *mut mwifiex_adapter) {
