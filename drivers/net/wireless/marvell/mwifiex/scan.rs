...
//! Source: drivers/net/wireless/marvell/mwifiex/scan.c
#![no_std]
...
pub const MWIFIEX_MAX_CHANNELS_PER_SPECIFIC_SCAN: c_int = 14;
pub const MWIFIEX_DEF_CHANNELS_PER_SCAN_CMD: c_int = 4;
...
//
    ...
    let mut ret: u8 = MWIFIEX_OUI_NOT_PRESENT;
...
#[no_mangle]
unsafe extern "C" fn mwifiex_is_hidden_ssid(ssid: *mut cfg80211_ssid) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mwifiex_complete_scan(priv: *mut mwifiex_private) {
...
#[no_mangle]
unsafe extern "C" fn mwifiex_check_next_scan_command(priv: *mut mwifiex_private) {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_cancel_scan(adapter: *mut mwifiex_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_stop_bg_scan(priv: *mut mwifiex_private) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_cmd_802_11_bg_scan_query(cmd: *mut host_cmd_ds_command) -> c_int {
...
// Normal scan
    ret = mwifiex_scan_networks(priv, core::ptr::null_mut());
