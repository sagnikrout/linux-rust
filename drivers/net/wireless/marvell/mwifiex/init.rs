...
//! Source: drivers/net/wireless/marvell/mwifiex/init.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn mwifiex_add_bss_prio_tbl(priv: *mut mwifiex_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wakeup_timer_fn(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn fw_dump_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_init_priv(priv: *mut mwifiex_private) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mwifiex_allocate_adapter(adapter: *mut mwifiex_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mwifiex_init_adapter(adapter: *mut mwifiex_adapter) {
    static void mwifiex_init_adapter(struct mwifiex_adapter *adapter)
    {
    struct mwifiex_opt_sleep_confirm *sleep_cfm_buf = core::ptr::null_mut();
    ...
    adapter.priv_link_lost = core::ptr::null_mut();
    ...
    adapter.gen_null_pkt = false;	/* Disable core::ptr::null_mut() Pkg generation by
    default */
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_set_trans_start(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn mwifiex_invalidate_lists(adapter: *mut mwifiex_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_free_cmd_buffers(adapter: *mut mwifiex_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_init_lock_list(adapter: *mut mwifiex_adapter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_init_fw(adapter: *mut mwifiex_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mwifiex_delete_bss_prio_tbl(priv: *mut mwifiex_private) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_free_priv(priv: *mut mwifiex_private) {
