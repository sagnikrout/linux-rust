...
//! Source: drivers/net/wireless/marvell/mwifiex/cfp.c
#![no_std]
...
// 100mW
pub const MWIFIEX_TX_PWR_DEFAULT: c_int = 20;
// 100mW
pub const MWIFIEX_TX_PWR_US_DEFAULT: c_int = 20;
// 50mW
pub const MWIFIEX_TX_PWR_JP_DEFAULT: c_int = 16;
// 100mW
pub const MWIFIEX_TX_PWR_FR_100MW: c_int = 20;
// 10mW
pub const MWIFIEX_TX_PWR_FR_10MW: c_int = 10;
// 100mW
pub const MWIFIEX_TX_PWR_EMEA_DEFAULT: c_int = 20;
...
pub struct region_code_mapping {
    pub code: u8,
    pub __nonstring: u8 region[IEEE80211_COUNTRY_STRING_LEN],
}
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_get_active_data_rates(priv: *mut mwifiex_private, rates: *mut u8) -> u32 {
...
//
    ...
    {
    struct mwifiex_chan_freq_power *cfp = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_get_supported_rates(priv: *mut mwifiex_private, rates: *mut u8) -> u32 {
