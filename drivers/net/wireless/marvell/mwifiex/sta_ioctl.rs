...
//! Source: drivers/net/wireless/marvell/mwifiex/sta_ioctl.c
#![no_std]
...
//
    ...
    adapter.curr_cmd.data_buf = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mwifiex_dnld_dt_txpwr_table(priv: *mut mwifiex_private) {
...
#[no_mangle]
unsafe extern "C" fn mwifiex_request_rgpower_table(priv: *mut mwifiex_private) -> c_int {
...
// World regulatory domain "00" has WW as country code
    ...
    adapter.rgpower_data = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn mwifiex_dnld_rgpower_table(priv: *mut mwifiex_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_dnld_txpwr_table(priv: *mut mwifiex_private) {
    ...
    HostCmd_ACT_GEN_SET, 0, core::ptr::null_mut(), false)) {
    mwifiex_dbg(priv.adapter, ERROR,
...
//
    ...
    int ret;
    struct mwifiex_adapter *adapter = priv.adapter;
    struct mwifiex_bssdescriptor *bss_desc = core::ptr::null_mut();
...
//
    ...
    kfree(bss_desc);
    if (ret < 0)
    priv.attempted_bss_desc = core::ptr::null_mut();
    return ret;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_cancel_hs(priv: *mut mwifiex_private, cmd_type: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_enable_hs(adapter: *mut mwifiex_adapter) -> c_int {
    ...
    priv = adapter.priv[i];
    mwifiex_deauthenticate(priv, core::ptr::null_mut());
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_disable_auto_ds(priv: *mut mwifiex_private) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_drv_get_data_rate(priv: *mut mwifiex_private, rate: *mut u32) -> c_int {
    int mwifiex_drv_get_data_rate(struct mwifiex_private *priv, u32 *rate)
    {
    int ret;
    ret = mwifiex_send_cmd(priv, HostCmd_CMD_802_11_TX_RATE_QUERY,
    HostCmd_ACT_GEN_GET, 0, core::ptr::null_mut(), true);
    if (!ret) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_drv_set_power(priv: *mut mwifiex_private, ps_mode: *mut u32) -> c_int {
    ...
    sub_cmd, BITMAP_STA_PS, core::ptr::null_mut(), true);
    if ((!ret) && (sub_cmd == DIS_AUTO_PS))
    ret = mwifiex_send_cmd(priv, HostCmd_CMD_802_11_PS_MODE_ENH,
    GET_PS, 0, core::ptr::null_mut(), false);
    return ret;
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn if(WLAN_KEY_LEN_WEP104: encrypt_key->key_len >) -> else {
...
//
    ...
    let mut unparsed_len: u16 = ie_len, cur_ie_len;
