...
//! Source: drivers/net/wireless/marvell/mwifiex/sta_cmdresp.c
#![no_std]
...
// Add RATE_DROP tlv here
    ...
    HostCmd_ACT_GEN_GET, 0, core::ptr::null_mut(), false);
    return 0;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn mwifiex_get_power_level(priv: *mut mwifiex_private, data_buf: *mut c_void) -> c_int {
...
// If rsp has NULL BSSID, Just return..... No Action
    ...
    mwifiex_dbg(priv.adapter, FATAL, "new BSSID is core::ptr::null_mut()\n");
    return 0;
    }
...
// ERP Information
    ...
    let mut reason: u16 = le16_to_cpu(cmd_tdls_oper.reason);
    let mut action: u16 = le16_to_cpu(cmd_tdls_oper.tdls_action);
...
// is_timeshare = false;
    ...
    bw = MHZ_TO_KHZ(80);
#[no_mangle]
pub unsafe extern "C" fn if(MWIFIEX_CHANNEL_NOHT40): !(chflags &) -> else {
