...
//! Source: drivers/net/wireless/marvell/mwifiex/11n_rxreorder.h
#![no_std]
...
pub const MWIFIEX_BA_WIN_SIZE_32: c_int = 32;
pub const PKT_TYPE_BAR: c_uint = 0xE7;

pub const BLOCKACKPARAM_TID_POS: c_int = 2;
pub const BLOCKACKPARAM_AMSDU_SUPP_MASK: c_uint = 0x1;
...
// cmd_addba_req);
extern "C" {
    pub fn mwifiex_11n_cleanup_reorder_tbl(priv: *mut mwifiex_private);
}
// priv, int tid,
extern "C" {
    pub fn mwifiex_11n_del_rx_reorder_tbl_by_ta(priv: *mut mwifiex_private, ta: *mut u8);
}
extern "C" {
    pub fn mwifiex_update_rxreor_flags(adapter: *mut mwifiex_adapter, flags: u8);
}
