...
//! Source: drivers/net/wireless/marvell/mwifiex/uap_cmd.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_set_sys_config_invalid_data(config: *mut mwifiex_uap_bss_param) {
...
#[no_mangle]
unsafe extern "C" fn mwifiex_uap_custom_ie_prepare(tlv: *mut u8, cmd_buf: *mut c_void, ie_size: *mut u16) -> c_int {
...
//
    ...
    u8 *pos;
    u8 qos_capa;
    let mut header_len: u16 = sizeof(struct mwifiex_ie_types_header);
    u16 tlv_len;
    int size;
...
//
    ...
    {
    let mut config_bands: u8 = 0, old_bands = priv.adapter.config_bands;
