...
//! Source: drivers/net/wireless/marvell/mwifiex/sta_tx.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_send_null_packet(priv: *mut mwifiex_private, flags: u8) -> c_int {
...
pub const NULL_PACKET_HDR: c_int = 64;
    ...
    struct sk_buff *skb;
    int ret;
    struct mwifiex_txinfo *tx_info = core::ptr::null_mut();
