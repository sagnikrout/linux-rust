...
//! Source: drivers/net/wireless/marvell/mwifiex/ie.c
#![no_std]
...
//
    ...
    {
    struct mwifiex_ie *beacon_ie = core::ptr::null_mut(), *pr_ie = core::ptr::null_mut(), *ar_ie = core::ptr::null_mut();
    let mut beacon_idx: u16 = MWIFIEX_AUTO_IDX_MASK, pr_idx = MWIFIEX_AUTO_IDX_MASK;
    let mut ar_idx: u16 = MWIFIEX_AUTO_IDX_MASK;
    let mut ret: c_int = 0;
...
//
    ...
    let mut gen_idx: u16 = MWIFIEX_AUTO_IDX_MASK, ie_len = 0;
...
//
    ...
    if (mwifiex_update_uap_custom_ie(priv, gen_ie, &gen_idx, core::ptr::null_mut(), core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn mwifiex_del_mgmt_ies(priv: *mut mwifiex_private) -> c_int {
    int mwifiex_del_mgmt_ies(struct mwifiex_private *priv)
    {
    struct mwifiex_ie *beacon_ie = core::ptr::null_mut(), *pr_ie = core::ptr::null_mut();
    struct mwifiex_ie *ar_ie = core::ptr::null_mut(), *gen_ie = core::ptr::null_mut();
    let mut ret: c_int = 0;
    ...
    core::ptr::null_mut(), &priv.proberesp_idx,
    core::ptr::null_mut(), &priv.assocresp_idx)) {
    ret = -1;
    goto done;
    }
