...
//! Source: drivers/net/wireless/marvell/mwifiex/sta_cmd.c
#![no_std]
...
//
    ...
    struct mwifiex_ps_param_in_hs *psparam_tlv = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn mwifiex_cmd_802_11_ad_hoc_stop(cmd: *mut host_cmd_ds_command) -> c_int {
...
pub const KEYPARAMSET_WEP_FIXED_LEN: c_int = 8;
...
//
    ...
    let mut key_param_len: u16 = 0, cmd_size;
    let mut ret: c_int = 0;
    cmd.command = cpu_to_le16(HostCmd_CMD_802_11_KEY_MATERIAL);
...
// buffer = stack_ptr;
    ...
    struct mwifiex_fw_mef_entry *mef_entry = core::ptr::null_mut();
    u8 *pos = (u8 *)mef_cfg;
    u16 i;
...
#[no_mangle]
unsafe extern "C" fn mwifiex_parse_cal_cfg(src: *mut u8, len: usize, dst: *mut u8) -> u32 {
...
// pos = strchr(*pos, '\n');
    ...
    {
    let mut ret: c_int = 0;
    let mut start_raw: bool = false;
    u8 *ptr, *token, *pos = core::ptr::null_mut();
    u8 *_data __free(kfree) = core::ptr::null_mut();
    struct mwifiex_adapter *adapter = priv.adapter;
    struct mwifiex_ds_misc_cmd *hostcmd __free(kfree) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mwifiex_is_cmd_supported(priv: *mut mwifiex_private, cmd_no: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mwifiex_sta_init_cmd(priv: *mut mwifiex_private, first_sta: u8) -> c_int {
    ...
    HostCmd_ACT_GEN_SET, 0, core::ptr::null_mut(),
    true);
    if (ret)
    return -1;
    }
    ret = mwifiex_send_cmd(priv, HostCmd_CMD_FUNC_INIT,
    HostCmd_ACT_GEN_SET, 0, core::ptr::null_mut(), true);
    if (ret)
    return -1;
...
//
    ...
    adapter.cal_data = core::ptr::null_mut();
    }
