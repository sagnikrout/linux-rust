...
//! Source: drivers/net/wireless/marvell/mwifiex/uap_txrx.c
#![no_std]
...
//
    ...
    let mut pkt_deleted: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn mwifiex_uap_cleanup_tx_queues(priv: *mut mwifiex_private) {
