...
//! Source: drivers/net/wireless/intel/iwlwifi/dvm/main.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn iwl_update_chain_flags(priv: *mut iwl_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_send_beacon_cmd(priv: *mut iwl_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IWL_LAST_CCK_RATE: rate >= IWL_FIRST_CCK_RATE && rate <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn iwl_bg_beacon_update(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iwl_bg_bt_runtime_config(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iwl_bg_bt_full_concurrency(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_send_statistics_request(priv: *mut iwl_priv, flags: u8, clear: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iwl_bg_statistics_periodic(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn iwl_continuous_event_trace(priv: *mut iwl_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn iwl_bg_ucode_trace(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn iwl_bg_tx_flush(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iwl_init_context(priv: *mut iwl_priv, ucode_flags: u32) {
...
#[no_mangle]
unsafe extern "C" fn iwl_rf_kill_ct_config(priv: *mut iwl_priv) {
...
#[no_mangle]
unsafe extern "C" fn iwlagn_send_calib_cfg_rt(priv: *mut iwl_priv, cfg: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwlagn_send_tx_ant_config(priv: *mut iwl_priv, valid_tx_ant: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_send_bt_config(priv: *mut iwl_priv) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_alive_start(priv: *mut iwl_priv) -> c_int {
...
// Configure Bluetooth device coexistence support
    ...
    priv.cur_rssi_ctx = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn iwl_clear_driver_stations(priv: *mut iwl_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_down(priv: *mut iwl_priv) {
    ...
    iwl_clear_ucode_stations(priv, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn iwl_bg_run_time_calib_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_prepare_restart(priv: *mut iwl_priv) {
...
#[no_mangle]
unsafe extern "C" fn iwl_bg_restart(data: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn iwl_setup_deferred_work(priv: *mut iwl_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_cancel_deferred_work(priv: *mut iwl_priv) {
...
#[no_mangle]
unsafe extern "C" fn iwl_init_drv(priv: *mut iwl_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_uninit_drv(priv: *mut iwl_priv) {
...
#[no_mangle]
unsafe extern "C" fn iwl_set_hw_params(priv: *mut iwl_priv) {
...
#[no_mangle]
unsafe extern "C" fn iwl_option_config(priv: *mut iwl_priv) {
...
#[no_mangle]
unsafe extern "C" fn iwl_eeprom_init_hw_params(priv: *mut iwl_priv) -> c_int {
...
//
    ...
    priv.workqueue = core::ptr::null_mut();
    out_uninit_drv:
    iwl_uninit_drv(priv);
    out_free_eeprom:
    kfree(priv.nvm_data);
...
#[no_mangle]
unsafe extern "C" fn iwl_op_mode_dvm_stop(op_mode: *mut iwl_op_mode) {
...
#[no_mangle]
unsafe extern "C" fn iwl_dump_nic_error_log(priv: *mut iwl_priv) {
...
#[no_mangle]
unsafe extern "C" fn iwlagn_fw_error(priv: *mut iwl_priv, ondemand: bool) {
...
// Set the FW error flag -- cleared on iwl_down
    ...
    iwl_dump_nic_event_log(priv, false, core::ptr::null_mut());
    }
...
pub const EEPROM_RF_CONFIG_TYPE_MAX: c_uint = 0x3;
#[no_mangle]
unsafe extern "C" fn iwl_nic_config(op_mode: *mut iwl_op_mode) {
...
#[no_mangle]
unsafe extern "C" fn iwl_wimax_active(op_mode: *mut iwl_op_mode) {
...
#[no_mangle]
unsafe extern "C" fn iwl_stop_sw_queue(op_mode: *mut iwl_op_mode, queue: c_int) {
    static void iwl_stop_sw_queue(struct iwl_op_mode *op_mode, int queue)
    {
    struct iwl_priv *priv = IWL_OP_MODE_GET_DVM(op_mode);
    let mut mq: c_int = priv.queue_to_mac80211[queue];
...
#[no_mangle]
unsafe extern "C" fn iwl_wake_sw_queue(op_mode: *mut iwl_op_mode, queue: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_lift_passive_no_rx(priv: *mut iwl_priv) {
...
#[no_mangle]
unsafe extern "C" fn iwl_free_skb(op_mode: *mut iwl_op_mode, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn iwl_set_hw_rfkill_state(op_mode: *mut iwl_op_mode, state: bool) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn iwl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn iwl_exit() -> void __exit {
