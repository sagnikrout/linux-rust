...
//! Source: drivers/net/wireless/intel/iwlwifi/dvm/lib.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_hw_valid_rtc_data_addr(addr: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_send_tx_power(priv: *mut iwl_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_temperature(priv: *mut iwl_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_hwrate_to_mac80211_idx(rate_n_flags: u32, band: enum nl80211_band) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iwlagn_txfifo_flush(priv: *mut iwl_priv, scd_q_msk: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_dev_txfifo_flush(priv: *mut iwl_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_send_advance_bt_config(priv: *mut iwl_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_bt_adjust_rssi_monitor(priv: *mut iwl_priv, rssi_ena: bool) {
    void iwlagn_bt_adjust_rssi_monitor(struct iwl_priv *priv, bool rssi_ena)
    {
    struct iwl_rxon_context *ctx, *found_ctx = core::ptr::null_mut();
    let mut found_ap: bool = false;
...
#[no_mangle]
unsafe extern "C" fn iwlagn_bt_traffic_is_sco(uart_msg: *mut iwl_bt_uart_msg) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iwlagn_bt_traffic_change_work(work: *mut work_struct) {
    static void iwlagn_bt_traffic_change_work(struct work_struct *work)
    {
    struct iwl_priv *priv =
    container_of(work, struct iwl_priv, bt_traffic_change_work);
    struct iwl_rxon_context *ctx;
    let mut smps_request: c_int = -1;
...
//
#[no_mangle]
pub unsafe extern "C" fn iwlagn_bt_coex_rssi_monitor(priv: *mut iwl_priv) {
    ...
    let mut kill_msk: u8 = IWL_BT_KILL_REDUCE;
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_bt_rx_handler_setup(priv: *mut iwl_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_bt_setup_deferred_work(priv: *mut iwl_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_bt_cancel_deferred_work(priv: *mut iwl_priv) {
    void iwlagn_bt_cancel_deferred_work(struct iwl_priv *priv)
    {
    cancel_work_sync(&priv.bt_traffic_change_work);
    }
#[no_mangle]
unsafe extern "C" fn is_single_rx_stream(priv: *mut iwl_priv) -> bool {
    static bool is_single_rx_stream(struct iwl_priv *priv)
    {
    return priv.current_ht_config.smps == IEEE80211_SMPS_STATIC ||
    priv.current_ht_config.single_chain_sufficient;
    }
pub const IWL_NUM_RX_CHAINS_MULTIPLE: c_int = 3;
pub const IWL_NUM_RX_CHAINS_SINGLE: c_int = 2;
pub const IWL_NUM_IDLE_CHAINS_DUAL: c_int = 2;
pub const IWL_NUM_IDLE_CHAINS_SINGLE: c_int = 1;
//
...
//
#[no_mangle]
unsafe extern "C" fn iwl_get_active_rx_chain_count(priv: *mut iwl_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iwl_get_idle_rx_chain_count(priv: *mut iwl_priv, active_cnt: c_int) -> c_int {
...
// up to 4 chains
#[no_mangle]
unsafe extern "C" fn iwl_count_chain_bitmap(chain_bitmap: u32) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn iwlagn_set_rxon_chain(priv: *mut iwl_priv, ctx: *mut iwl_rxon_context) {
    void iwlagn_set_rxon_chain(struct iwl_priv *priv, struct iwl_rxon_context *ctx)
    {
    let mut is_single: bool = is_single_rx_stream(priv);
    let mut is_cam: bool = !test_bit(STATUS_POWER_PMI, &priv.status);
...
#[no_mangle]
pub unsafe extern "C" fn iwl_toggle_tx_ant(priv: *mut iwl_priv, ant: u8, valid: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn iwlagn_convert_p1k(p1k: *mut u16, out: *mut __le16) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wowlan_key_data {
    pub ctx: *mut iwl_rxon_context,
    pub rsc_tsc: *mut iwlagn_wowlan_rsc_tsc_params_cmd,
    pub tkip: *mut iwlagn_wowlan_tkip_params_cmd,
    pub bssid: *const u8,
    pub use_tkip: bool error, use_rsc_tsc,,
}
    ...
    struct aes_sc *aes_sc, *aes_tx_sc = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_suspend(priv: *mut iwl_priv, wowlan: *mut cfg80211_wowlan) -> c_int {
    ...
    let mut tkip_cmd: iwlagn_wowlan_tkip_params_cmd = {};
...
#[no_mangle]
pub unsafe extern "C" fn iwl_dvm_send_cmd(priv: *mut iwl_priv, cmd: *mut iwl_host_cmd) -> c_int {
