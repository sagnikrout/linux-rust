...
//! Source: drivers/net/wireless/intel/iwlwifi/dvm/mac80211.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn iwlagn_mac_unregister(priv: *mut iwl_priv) {
...
#[no_mangle]
unsafe extern "C" fn __iwl_up(priv: *mut iwl_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwlagn_mac_start(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwlagn_mac_stop(hw: *mut ieee80211_hw, suspend: bool) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_resume_data {
    pub priv: *mut iwl_priv,
    pub cmd: *mut iwlagn_wowlan_status,
    pub valid: bool,
}
...
#[no_mangle]
unsafe extern "C" fn iwlagn_mac_resume(hw: *mut ieee80211_hw) -> c_int {
...
// cf. struct iwl_error_event_table
    ...
    pub error_id: u32,
    pub err_info: },
    pub status_wait: iwl_notification_wait,
    static const u16 status_cmd[] = {
    REPLY_WOWLAN_GET_STATUS,
}

    let mut status_data: iwlagn_wowlan_status = {};
...
//
    ...
    &resume_data);
    iwl_dvm_send_cmd_pdu(priv, REPLY_WOWLAN_GET_STATUS, CMD_ASYNC, 0, core::ptr::null_mut());
    iwl_dvm_send_cmd_pdu(priv, REPLY_ECHO, CMD_ASYNC, 0, core::ptr::null_mut());
// an RBD is left open in the firmware now!
    ...
    let mut reasons: u32 = le32_to_cpu(status_data.wakeup_reason);
...
#[no_mangle]
unsafe extern "C" fn iwlagn_mac_set_wakeup(hw: *mut ieee80211_hw, enabled: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_chswitch_done(priv: *mut iwl_priv, is_success: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(RSSI_EVENT_HIGH: event->u.rssi.data ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn iwlagn_mac_tx_last_beacon(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_set_mode(priv: *mut iwl_priv, ctx: *mut iwl_rxon_context) -> c_int {
...
// set up queue mappings
    ...
    struct iwl_priv *priv = IWL_MAC80211_GET_DVM(hw);
    struct iwl_vif_priv *vif_priv = (void *)vif.drv_priv;
    struct iwl_rxon_context *tmp, *ctx = core::ptr::null_mut();
    int err;
    let mut viftype: enum nl80211_iftype = ieee80211_vif_type_p2p(vif);
...
//
    ...
    let mut newviftype: enum nl80211_iftype = newtype;
    u32 interface_modes;
    int err;
    IWL_DEBUG_MAC80211(priv, "enter\n");
...
#[no_mangle]
unsafe extern "C" fn iwl_sta_modify_ps_wake(priv: *mut iwl_priv, sta_id: c_int) {
