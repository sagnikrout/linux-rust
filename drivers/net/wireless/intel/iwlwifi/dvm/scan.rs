...
//! Source: drivers/net/wireless/intel/iwlwifi/dvm/scan.c
#![no_std]
...
pub const IWL_CHANNEL_TUNE_TIME: c_int = 5;
pub const MAX_SCAN_CHANNEL: c_int = 50;
// For reset radio, need minimal dwell time only
pub const IWL_RADIO_RESET_DWELL_TIME: c_int = 5;
#[no_mangle]
unsafe extern "C" fn iwl_send_scan_abort(priv: *mut iwl_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_complete_scan(priv: *mut iwl_priv, aborted: bool) {
...
// check if scan was requested from mac80211
    ...
    priv.scan_vif = core::ptr::null_mut();
    priv.scan_request = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn iwl_process_scan_complete(priv: *mut iwl_priv) {
...
// Check if mac80211 requested scan during our internal scan
    if (priv.scan_request == core::ptr::null_mut())
    goto out_complete;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_force_scan_end(priv: *mut iwl_priv) {
...
#[no_mangle]
unsafe extern "C" fn iwl_do_scan_abort(priv: *mut iwl_priv) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_scan_cancel(priv: *mut iwl_priv) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_scan_cancel_timeout(priv: *mut iwl_priv, ms: c_ulong) {
    void iwl_scan_cancel_timeout(struct iwl_priv *priv, unsigned long ms)
    {
    let mut timeout: c_ulong = jiffies + msecs_to_jiffies(ms);
    lockdep_assert_held(&priv.mutex);
...
#[no_mangle]
pub unsafe extern "C" fn iwl_setup_rx_scan_handlers(priv: *mut iwl_priv) {
...
#[no_mangle]
unsafe extern "C" fn iwl_limit_dwell(priv: *mut iwl_priv, dwell_time: u16) -> u16 {
    static u16 iwl_limit_dwell(struct iwl_priv *priv, u16 dwell_time)
    {
    struct iwl_rxon_context *ctx;
    int limits[NUM_IWL_RXON_CTX] = {};
    let mut n_active: c_int = 0;
    u16 limit;
...
#[no_mangle]
unsafe extern "C" fn iwlagn_request_scan(priv: *mut iwl_priv, vif: *mut ieee80211_vif) -> c_int {
    ...
    let mut rx_ant: u8 = priv.nvm_data.valid_rx_ant;
    u8 rate;
    let mut is_active: bool = false;
    int  chan_mod;
    u8 active_chains;
    let mut scan_tx_antennas: u8 = priv.nvm_data.valid_tx_ant;
    int ret;
...
// use bcast addr, will not be transmitted but must be valid
    cmd_len = iwl_fill_probe_req(
    (struct ieee80211_mgmt *)scan.data,
    iwl_bcast_addr, core::ptr::null_mut(), 0,
    core::ptr::null_mut(), 0,
    scan_cmd_size - sizeof(*scan));
    break;
    default:
...
#[no_mangle]
pub unsafe extern "C" fn iwl_init_scan_params(priv: *mut iwl_priv) {
    void iwl_init_scan_params(struct iwl_priv *priv)
    {
    let mut ant_idx: u8 = fls(priv.nvm_data.valid_tx_ant) - 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_internal_short_hw_scan(priv: *mut iwl_priv) {
    void iwl_internal_short_hw_scan(struct iwl_priv *priv)
    {
    queue_work(priv.workqueue, &priv.start_internal_scan);
    }
#[no_mangle]
unsafe extern "C" fn iwl_bg_start_internal_scan(work: *mut work_struct) {
    ...
    if (iwl_scan_initiate(priv, core::ptr::null_mut(), IWL_SCAN_RADIO_RESET, priv.band))
    IWL_DEBUG_SCAN(priv, "failed to start internal short scan\n");
    unlock:
    mutex_unlock(&priv.mutex);
    }
#[no_mangle]
unsafe extern "C" fn iwl_bg_scan_check(data: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iwl_bg_abort_scan(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iwl_bg_scan_completed(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_setup_scan_deferred_work(priv: *mut iwl_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_cancel_scan_deferred_work(priv: *mut iwl_priv) {
