...
//! Source: drivers/net/wireless/intel/iwlwifi/dvm/ucode.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn iwl_set_Xtal_calib(priv: *mut iwl_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_set_temperature_offset_calib(priv: *mut iwl_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_set_temperature_offset_calib_v2(priv: *mut iwl_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_send_calib_cfg(priv: *mut iwl_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_init_alive_start(priv: *mut iwl_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_send_wimax_coex(priv: *mut iwl_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_send_prio_tbl(priv: *mut iwl_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_send_bt_env(priv: *mut iwl_priv, action: u8, type: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_alive_notify(priv: *mut iwl_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_run_init_ucode(priv: *mut iwl_priv) -> c_int {
