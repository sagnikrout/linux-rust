...
//! Source: drivers/net/wireless/intel/iwlwifi/fw/api/mac-cfg.h
#![no_std]
...
// Macro flag: #define __iwl_fw_api_mac_cfg_h__
...
pub enum iwl_mac_conf_subcmd_ids {
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_p2p_noa_attr {
    pub id: u8,
    pub len_low: u8,
    pub len_high: u8,
    pub idx: u8,
    pub ctwin: u8,
    pub desc: [ieee80211_p2p_noa_desc; IWL_P2P_NOA_DESC_COUNT],
    pub reserved: u8,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_probe_resp_data_notif {
    pub mac_id: __le32,
    pub noa_active: __le32,
    pub noa_attr: iwl_p2p_noa_attr,
    pub csa_counter: u8,
    pub reserved: [u8; 3],
    pub /: *mut *mut } __packed; / PROBE_RESPONSE_DATA_NTFY_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_missed_vap_notif {
    pub mac_id: __le32,
    pub num_beacon_intervals_elapsed: u8,
    pub profile_periodicity: u8,
    pub reserved: [u8; 2],
    pub /: *mut *mut } __packed; / MISSED_VAP_NTFY_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_channel_switch_start_notif_v1 {
    pub id_and_color: __le32,
    pub /: *mut *mut } __packed; / CHANNEL_SWITCH_START_NTFY_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_channel_switch_start_notif {
    pub link_id: __le32,
    pub /: *mut *mut } __packed; / CHANNEL_SWITCH_START_NTFY_API_S_VER_3,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_channel_switch_error_notif_v1 {
    pub mac_id: __le32,
    pub csa_err_mask: __le32,
    pub /: *mut *mut } __packed; / CHANNEL_SWITCH_ERROR_NTFY_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_channel_switch_error_notif {
    pub link_id: __le32,
    pub csa_err_mask: __le32,
    pub /: *mut *mut } __packed; / CHANNEL_SWITCH_ERROR_NTFY_API_S_VER_2,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_cancel_channel_switch_cmd {
    pub id: __le32,
    pub /: *mut *mut } __packed; / MAC_CANCEL_CHANNEL_SWITCH_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_chan_switch_te_cmd {
    pub mac_id: __le32,
    pub action: __le32,
    pub tsf: __le32,
    pub cs_count: u8,
    pub cs_delayed_bcn_count: u8,
    pub cs_mode: u8,
    pub reserved: u8,
    pub /: *mut *mut } __packed; / MAC_CHANNEL_SWITCH_TIME_EVENT_S_VER_2,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mac_low_latency_cmd {
    pub mac_id: __le32,
    pub low_latency_rx: u8,
    pub low_latency_tx: u8,
    pub reserved: __le16,
    pub /: *mut *mut } __packed; / MAC_LOW_LATENCY_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mac_client_data {
    pub is_assoc: u8,
    pub esr_transition_timeout: u8,
    pub medium_sync_delay: __le16,
    pub assoc_id: __le16,
    pub reserved1: __le16,
    pub data_policy: __le16,
    pub reserved2: __le16,
    pub ctwin: __le32,
    pub /: *mut *mut } __packed; / MAC_CONTEXT_CONFIG_CLIENT_DATA_API_S_VER_2,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mac_p2p_dev_data {
    pub is_disc_extended: __le32,
    pub /: *mut *mut } __packed; / MAC_CONTEXT_CONFIG_P2P_DEV_DATA_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_mac_config_filter_flags {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mac_wifi_gen_support_v2 {
    pub he_support: __le16,
    pub he_ap_support: __le16,
    pub eht_support: __le32,
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mac_wifi_gen_support {
    pub he_support: u8,
    pub he_ap_support: u8,
    pub eht_support: u8,
    pub uhr_support: u8,
    pub reserved: __le32,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mac_config_cmd_v3 {
    pub id_and_color: __le32,
    pub action: __le32,
// MAC_CONTEXT_TYPE_API_E
    pub mac_type: __le32,
    pub local_mld_addr: [u8; 6],
    pub reserved_for_local_mld_addr: __le16,
    pub filter_flags: __le32,
    pub wifi_gen_v2: iwl_mac_wifi_gen_support_v2,
    pub wifi_gen: iwl_mac_wifi_gen_support,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mac_nan_data {
    pub addr: [u8; ETH_ALEN],
    pub reserved: __le16,
    pub ndi_addrs: [} __packed; 2],
    pub ndi_addrs_count: __le32,
    pub /: *mut *mut } __packed; / MAC_CONTEXT_CONFIG_NAN_DATA_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_link_ctx_modify_flags {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_link_ctx_protection_flags {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_link_modify_bandwidth {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_npca_params {
    pub dis_subch_bmap: __le16,
    pub switch_delay: u8,
    pub switch_back_delay: u8,
    pub initial_qsrc: u8,
    pub min_dur_threshold: u8,
    pub flags: u8,
    pub reserved: u8,
    pub /: *mut *mut } __packed; / NPCA_PARAM_API_S_VER_2,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_link_config_cmd {
    pub action: __le32,
    pub link_id: __le32,
    pub mac_id: __le32,
    pub phy_id: __le32,
    pub local_link_addr: [u8; 6],
    pub reserved_for_local_link_addr: __le16,
    pub modify_mask: __le32,
    pub active: __le32,
    pub /: *mut *mut __le32 listen_lmac; / only _VER_1,
    pub /: *mut *mut u8 block_tx; / since _VER_5,
    pub /: *mut *mut u8 modify_bandwidth; / since _VER_6,
    pub reserved1: [u8; 2],
}
...
//
pub const IWL_FW_MAX_ACTIVE_LINKS_NUM: c_int = 2;
pub const IWL_FW_MAX_LINK_ID: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sta_cfg_cmd_v1 {
    pub sta_id: __le32,
    pub link_id: __le32,
    pub peer_mld_address: [u8; ETH_ALEN],
    pub reserved_for_peer_mld_address: __le16,
    pub peer_link_address: [u8; ETH_ALEN],
    pub reserved_for_peer_link_address: __le16,
    pub station_type: __le32,
    pub assoc_id: __le32,
    pub beamform_flags: __le32,
    pub mfp: __le32,
    pub mimo: __le32,
    pub mimo_protection: __le32,
    pub ack_enabled: __le32,
    pub trig_rnd_alloc: __le32,
    pub tx_ampdu_spacing: __le32,
    pub tx_ampdu_max_size: __le32,
    pub sp_length: __le32,
    pub uapsd_acs: __le32,
    pub pkt_ext: iwl_he_pkt_ext_v2,
    pub htc_flags: __le32,
    pub /: *mut *mut } __packed; / STA_CMD_API_S_VER_1,
//
...
pub struct iwl_sta_cfg_cmd_v2 {
    ...
    pub pkt_ext: iwl_he_pkt_ext_v2,
    pub htc_flags: __le32,
    pub use_ldpc_x2_cw: u8,
    pub use_icf: u8,
    pub dps_pad_time: u8,
    pub dps_trans_delay: u8,
    pub mic_prep_pad_delay: u8,
    pub mic_compute_pad_delay: u8,
    pub reserved: [u8; 2],
    pub /: *mut *mut } __packed; / STA_CMD_API_S_VER_2,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sta_cfg_cmd {
    pub sta_id: __le32,
    pub link_mask: __le32,
    pub peer_mld_address: [u8; ETH_ALEN],
    pub reserved_for_peer_mld_address: __le16,
    pub peer_link_address: [u8; ETH_ALEN],
    pub reserved_for_peer_link_address: __le16,
    ...
    pub mic_compute_pad_delay: u8,
    pub nmi_sta_id: u8,
    pub ndi_local_addr: [u8; ETH_ALEN],
    pub reserved: [u8; 2],
    pub /: *mut *mut } __packed; / STA_CMD_API_S_VER_3,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_aux_sta_cmd {
    pub sta_id: __le32,
    pub lmac_id: __le32,
    pub mac_addr: [u8; ETH_ALEN],
    pub reserved_for_mac_addr: __le16,
    pub /: *mut *mut } __packed; / AUX_STA_CMD_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_remove_sta_cmd {
    pub sta_id: __le32,
    pub /: *mut *mut } __packed; / REMOVE_STA_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mvm_sta_disable_tx_cmd {
    pub sta_id: __le32,
    pub disable: __le32,
    pub /: *mut *mut } __packed; / STA_DISABLE_TX_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_mvm_fw_esr_recommendation {
    ESR_RECOMMEND_LEAVE,
    ESR_FORCE_LEAVE,
    ESR_RECOMMEND_ENTER,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_esr_mode_notif_v1 {
    pub action: __le32,
    pub /: *mut *mut } __packed; / ESR_MODE_RECOMMENDATION_NTFY_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_esr_mode_notif {
    pub action: __le32,
    pub leave_reason_mask: __le32,
    pub /: *mut *mut } __packed; / ESR_MODE_RECOMMENDATION_NTFY_API_S_VER_2,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_missed_beacons_notif {
    pub link_id: __le32,
    pub consec_missed_beacons_since_last_rx: __le32,
    pub consec_missed_beacons: __le32,
    pub other_link_id: __le32,
    pub consec_missed_beacons_other_link: __le32,
    pub /: *mut *mut } __packed; / MISSED_BEACON_NTFY_API_S_VER_5,
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_esr_trans_fail_code {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_esr_trans_fail_notif {
    pub link_id: __le32,
    pub activation: __le32,
    pub err_code: __le32,
    pub /: *mut *mut } __packed; / ESR_TRANSITION_FAILED_NTFY_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_twt_operation_type {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_twt_operation_cmd {
    pub link_id: __le32,
    pub twt_operation: __le32,
    pub target_wake_time: __le64,
    pub interval_exponent: __le32,
    pub interval_mantissa: __le32,
    pub minimum_wake_duration: __le32,
    pub trigger: u8,
    pub flow_type: u8,
    pub flow_id: u8,
    pub twt_protection: u8,
    pub ndp_paging_indicator: u8,
    ...
    pub twt_channel: u8,
    pub restricted_info_present: u8,
    pub dl_bitmap_valid: u8,
    pub ul_bitmap_valid: u8,
    pub dl_tid_bitmap: u8,
    pub ul_tid_bitmap: u8,
    pub /: *mut *mut } __packed; / TWT_OPERATION_API_S_VER_1,
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_nan_band {
    IWL_NAN_BAND_5GHZ = 0,
    IWL_NAN_BAND_2GHZ = 1,
    IWL_NUM_NAN_BANDS,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_nan_band_config {
    pub rssi_close: u8,
    pub rssi_middle: u8,
    pub dw_interval: u8,
    pub reserved: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_nan_config_cmd {
    pub action: __le32,
    pub nmi_addr: [u8; 6],
    pub reserved_for_nmi_addr: __le16,
    pub discovery_beacon_interval: __le32,
    pub cluster_id: [u8; 2],
    pub sta_id: u8,
    pub hb_channel: u8,
    pub master_pref: u8,
    ...
    pub scan_period: u8,
    pub flags: u8,
    pub band_config: [iwl_nan_band_config; IWL_NUM_NAN_BANDS],
    pub nan_attr_len: __le32,
    pub nan_vendor_elems_len: __le32,
    pub beacon_data: [u8; ],
    pub /: *mut *mut } __packed; / NAN_CONFIG_CMD_API_S_VER_1, NAN_CONFIG_CMD_API_S_VER_2,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_nan_schedule_cmd_v1 {
    pub availability_map: __le32,
    pub channel_entry: [u8; 6],
    pub link_id: u8,
    pub reserved: u8,
    pub channels: [} __packed; NUM_PHY_CTX],
    pub /: *mut *mut } __packed; / NAN_SCHEDULE_CMD_API_S_VER_1,
pub const IWL_MAX_AVAILABILITY_ATTR_LEN: c_int = 54;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_nan_schedule_cmd {
    pub availability_map: __le32,
    pub channel_entry: [u8; 6],
    pub link_id: u8,
    pub reserved: u8,
    ...
    pub attr_len: u8,
    pub reserved: u8,
    pub attr: [u8; IWL_MAX_AVAILABILITY_ATTR_LEN],
    pub avail_attr: } __packed,
    pub deferred: u8,
    pub reserved: [u8; 3],
    pub /: *mut *mut } __packed; / NAN_SCHEDULE_CMD_API_S_VER_2,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_nan_peer_cmd {
    pub nmi_sta_id: u8,
    pub sequence_id: u8,
    pub committed_dw_info: __le16,
    pub max_channel_switch_time: __le16,
    pub reserved: __le16,
    pub availability_map: __le32,
    pub channel_entry: [u8; 6],
    pub link_id: u8,
    pub map_id: u8,
    pub per_phy: [} __packed; NUM_PHY_CTX],
    pub initial_ulw_size: __le32,
    pub initial_ulw: [u8; ],
    pub /: *mut *mut } __packed; / NAN_PEER_SCHEDULE_CMD_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_nan_cluster_notif_flags {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_nan_cluster_notif {
    pub cluster_id: [u8; 2],
    pub flags: u8,
    pub reserved: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_nan_dw_end_notif {
    pub band: u8,
    pub reserved: [u8; 3],
    pub /: *mut *mut } __packed; / NAN_DW_END_NTF_API_S_VER_1,
pub const IWL_NAN_MAX_ENDLESS_ULW_ATTR_LEN: c_int = 48;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_nan_ulw_attr_notif {
    pub attr_len: u8,
    pub reserved: [u8; 3],
    pub attr: [u8; IWL_NAN_MAX_ENDLESS_ULW_ATTR_LEN],
    pub /: *mut *mut } __packed; / NAN_ULW_ATTR_NOTIF_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_nan_sched_update_status {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_nan_sched_update_completed_notif {
    pub status: u8,
    pub reserved: [u8; 3],
    pub /: *mut *mut } __packed; / NAN_SCHED_UPDATE_COMPLETED_NTF_API_S_VER_1,
