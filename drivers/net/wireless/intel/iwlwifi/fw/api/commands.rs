...
//! Source: drivers/net/wireless/intel/iwlwifi/fw/api/commands.h
#![no_std]
...
// Macro flag: #define __iwl_fw_api_commands_h__
//
...
pub enum iwl_mvm_command_groups {
    LEGACY_GROUP = 0x0,
    LONG_GROUP = 0x1,
    SYSTEM_GROUP = 0x2,
    MAC_CONF_GROUP = 0x3,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_system_subcmd_ids {
//
// @SHARED_MEM_CFG_CMD:
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_statistics_subcmd_ids {
//
