...
//! Source: drivers/net/wireless/intel/iwlwifi/fw/api/tx.h
#![no_std]
...
// Macro flag: #define __iwl_fw_api_tx_h__
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_tx_pm_timeouts {
    PM_FRAME_NONE		= 0,
    PM_FRAME_MGMT		= 2,
    PM_FRAME_ASSOC		= 3,
}

pub const TX_CMD_SEC_MSK: c_uint = 0x07;
pub const TX_CMD_SEC_WEP_KEY_IDX_POS: c_int = 6;
pub const TX_CMD_SEC_WEP_KEY_IDX_MSK: c_uint = 0xc0;
//
...
//
pub const TX_CMD_LIFE_TIME_INFINITE: c_uint = 0xFFFFFFFF;

pub const TX_CMD_LIFE_TIME_EXPIRED_FRAME: c_int = 0;
//
// TID for non QoS frames - to be written in tid_tspec
//
pub const IWL_TID_NON_QOS: c_int = 0;
//
// Limits on the retransmissions - to be written in {data,rts}_retry_limit
//
pub const IWL_DEFAULT_TX_RETRY: c_int = 15;
pub const IWL_MGMT_DFAULT_RETRY_LIMIT: c_int = 3;
pub const IWL_RTS_DFAULT_RETRY_LIMIT: c_int = 60;
pub const IWL_BAR_DFAULT_RETRY_LIMIT: c_int = 60;
pub const IWL_LOW_RETRY_LIMIT: c_int = 7;
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_tx_offload_assist_flags_pos {
...
pub const IWL_TX_CMD_OFFLD_MH_MASK: c_uint = 0x1f;
pub const IWL_TX_CMD_OFFLD_IP_HDR_MASK: c_uint = 0x3f;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_tx_cmd_v6_params {
    pub len: __le16,
    pub offload_assist: __le16,
    pub tx_flags: __le32,
    pub try_cnt: u8,
    pub btkill_cnt: u8,
    pub reserved: __le16,
    pub /: *mut *mut } scratch; / DRAM_SCRATCH_API_U_VER_1,
    ...
    pub /: *mut *mut } __packed; / TX_CMD_API_S_VER_6,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_tx_cmd_v6 {
    pub params: iwl_tx_cmd_v6_params,
    pub hdr: [ieee80211_hdr; ],
    pub /: *mut *mut } __packed; / TX_CMD_API_S_VER_6,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_dram_sec_info {
    pub pn_low: __le32,
    pub pn_high: __le16,
    pub aux_info: __le16,
    pub /: *mut *mut } __packed; / DRAM_SEC_INFO_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_tx_cmd_v9 {
    pub len: __le16,
    pub offload_assist: __le16,
    pub flags: __le32,
    pub dram_info: iwl_dram_sec_info,
    pub rate_n_flags: __le32,
    pub hdr: [ieee80211_hdr; ],
    pub TX_CMD_API_S_VER_7,: *mut *mut } __packed; /,
//
...
pub struct iwl_tx_cmd {
    pub len: __le16,
    pub flags: __le16,
    pub offload_assist: __le32,
    pub dram_info: iwl_dram_sec_info,
    pub rate_n_flags: __le32,
    pub reserved: [u8; 8],
    pub hdr: [ieee80211_hdr; ],
    pub TX_CMD_API_S_VER_10,: *mut *mut } __packed; /,
// TX_CMD_API_S_VER_11
//
...
//
pub const TX_RES_INIT_RATE_INDEX_MSK: c_uint = 0x0f;
pub const TX_RES_RATE_TABLE_COLOR_POS: c_int = 4;
pub const TX_RES_RATE_TABLE_COLOR_MSK: c_uint = 0x70;
pub const TX_RES_INV_RATE_INDEX_MSK: c_uint = 0x80;
...
pub struct iwl_tx_resp_v3 {
    ...
    pub status: [agg_tx_status; ],
    pub /: *mut *mut } __packed; / TX_RSP_API_S_VER_3,
//
...
pub struct iwl_tx_resp {
    ...
    pub status: agg_tx_status,
    pub TX_RSP_API_S_VER_6,: *mut *mut } __packed; /,
// TX_RSP_API_S_VER_7,
// TX_RSP_API_S_VER_8,
// TX_RSP_API_S_VER_9
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_compressed_ba_tfd {
    pub q_num: __le16,
    pub tfd_index: __le16,
    pub scd_queue: u8,
    pub tid: u8,
    pub reserved: [u8; 2],
    pub /: *mut *mut } __packed; / COMPRESSED_BA_TFD_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_compressed_ba_ratid {
    pub q_num: u8,
    pub tid: u8,
    pub ssn: __le16,
    pub /: *mut *mut } __packed; / COMPRESSED_BA_RATID_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_mvm_ba_resp_flags {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_compressed_ba_notif {
    pub flags: __le32,
    pub sta_id: u8,
    pub reduced_txp: u8,
    pub tlc_rate_info: u8,
    pub retry_cnt: u8,
    pub query_byte_cnt: __le32,
    pub query_frame_cnt: __le16,
    pub txed: __le16,
    pub done: __le16,
    pub rts_retry_cnt: u8,
    pub reserved: u8,
    pub wireless_time: __le32,
    pub tx_rate: __le32,
    pub tfd_cnt: __le16,
    pub ra_tid_cnt: __le16,
    pub ra_tid): DECLARE_FLEX_ARRAY(struct iwl_compressed_ba_ratid,,
    pub tfd): DECLARE_FLEX_ARRAY(struct iwl_compressed_ba_tfd,,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mac_beacon_cmd_v6 {
    pub tx: iwl_tx_cmd_v6_params,
    pub template_id: __le32,
    pub tim_idx: __le32,
    pub tim_size: __le32,
    pub frame: [ieee80211_hdr; ],
    pub /: *mut *mut } __packed; / BEACON_TEMPLATE_CMD_API_S_VER_6,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mac_beacon_cmd_v7 {
    pub tx: iwl_tx_cmd_v6_params,
    pub template_id: __le32,
    pub tim_idx: __le32,
    pub tim_size: __le32,
    pub ecsa_offset: __le32,
    pub csa_offset: __le32,
    pub frame: [ieee80211_hdr; ],
    pub /: *mut *mut } __packed; / BEACON_TEMPLATE_CMD_API_S_VER_7,
// Bit flags for BEACON_TEMPLATE_CMD_API until version 10
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_mac_beacon_flags_v1 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_beacon_notif {
    pub beacon_notify_hdr: iwl_tx_resp,
    pub tsf: __le64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_extended_beacon_notif_v5 {
    pub beacon_notify_hdr: iwl_tx_resp,
    pub tsf: __le64,
    pub ibss_mgr_status: __le32,
    pub gp2: __le32,
    pub /: *mut *mut } __packed; / BEACON_NTFY_API_S_VER_5,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_extended_beacon_notif {
    pub status: __le32,
    pub tsf: __le64,
    pub ibss_mgr_status: __le32,
    pub gp2: __le32,
    pub /: *mut *mut } __packed; / BEACON_NTFY_API_S_VER_6_,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_tx_path_flush_cmd_v1 {
    pub queues_ctl: __le32,
    pub flush_ctl: __le16,
    pub reserved: __le16,
    pub /: *mut *mut } __packed; / TX_PATH_FLUSH_CMD_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_tx_path_flush_cmd {
    pub sta_id: __le32,
    pub tid_mask: __le16,
    pub reserved: __le16,
    pub /: *mut *mut } __packed; / TX_PATH_FLUSH_CMD_API_S_VER_2,
pub const IWL_TX_FLUSH_QUEUE_RSP: c_int = 16;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_flush_queue_info {
    pub tid: __le16,
    pub queue_num: __le16,
    pub read_before_flush: __le16,
    pub read_after_flush: __le16,
    pub /: *mut *mut } __packed; / TFDQ_FLUSH_INFO_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_tx_path_flush_cmd_rsp {
    pub sta_id: __le16,
    pub num_flushed_queues: __le16,
    pub queues: [iwl_flush_queue_info; IWL_TX_FLUSH_QUEUE_RSP],
    pub /: *mut *mut } __packed; / TX_PATH_FLUSH_CMD_RSP_API_S_VER_1,
// Available options for the SCD_QUEUE_CFG HCMD
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_scd_cfg_actions {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_scd_txq_cfg_cmd {
    pub token: u8,
    pub sta_id: u8,
    pub tid: u8,
    pub scd_queue: u8,
    ...
    pub ssn: __le16,
    pub reserved: __le16,
    pub /: *mut *mut } __packed; / SCD_QUEUE_CFG_CMD_API_S_VER_1,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_scd_txq_cfg_rsp {
    pub token: u8,
    pub sta_id: u8,
    pub tid: u8,
    pub scd_queue: u8,
    pub /: *mut *mut } __packed; / SCD_QUEUE_CFG_RSP_API_S_VER_1,
