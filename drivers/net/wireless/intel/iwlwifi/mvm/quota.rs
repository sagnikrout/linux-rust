...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/quota.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mvm_quota_iterator_data {
    pub n_interfaces: [c_int; MAX_BINDINGS],
    pub colors: [c_int; MAX_BINDINGS],
    pub low_latency: [c_int; MAX_BINDINGS],    pub dbgfs_min: [c_int; MAX_BINDINGS],
    pub n_low_latency_bindings: c_int,
    pub disabled_vif: *mut ieee80211_vif,
}
...
// need at least one binding per PHY
    ...
    {
    let mut cmd: iwl_time_quota_cmd = {};
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: data.dbgfs_min[i]) -> else {
