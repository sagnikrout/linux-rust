...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/link.c
#![no_std]
...
//
    ...
    let mut cmd: iwl_link_config_cmd = {};
    let mut cmd_id: c_uint = WIDE_ID(MAC_CONF_GROUP, LINK_CONFIG_CMD);
    let mut cmd_ver: u8 = iwl_fw_lookup_cmd_ver(mvm.fw, cmd_id, 1);
...
// TODO  how to set ndp_fdbk_buff_th_exp?
    ...
    struct cfg80211_chan_def *def = core::ptr::null_mut();
    rcu_read_lock();
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_init_link(link: *mut iwl_mvm_vif_link_info) {
