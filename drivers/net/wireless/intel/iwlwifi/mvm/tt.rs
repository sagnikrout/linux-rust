...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/tt.c
#![no_std]
...
pub const IWL_MVM_NUM_CTDP_STEPS: c_int = 20;
pub const IWL_MVM_MIN_CTDP_BUDGET_MW: c_int = 150;

#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_enter_ctkill(mvm: *mut iwl_mvm) {
    void iwl_mvm_enter_ctkill(struct iwl_mvm *mvm)
    {
    struct iwl_mvm_tt_mgmt *tt = &mvm.thermal_throttle;
    let mut duration: u32 = tt.params.ct_kill_duration;
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_exit_ctkill(mvm: *mut iwl_mvm) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_tt_temp_changed(mvm: *mut iwl_mvm, temp: u32) {
...
// ignore the notification if we are in test mode
    ...
    let mut len: c_int = iwl_rx_packet_payload_len(pkt);
    int temp;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_temp_notif(mvm: *mut iwl_mvm, rxb: *mut iwl_rx_cmd_buffer) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_ct_kill_notif(mvm: *mut iwl_mvm, rxb: *mut iwl_rx_cmd_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn iwl_mvm_send_temp_cmd(mvm: *mut iwl_mvm, response: bool, temp: *mut i32) -> c_int {
    static int iwl_mvm_send_temp_cmd(struct iwl_mvm *mvm, bool response, s32 *temp)
    {
    let mut cmd: iwl_host_cmd = {};
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_get_temp(mvm: *mut iwl_mvm, temp: *mut i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_exit_ctkill(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_tt_tx_protection(mvm: *mut iwl_mvm, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_tt_tx_backoff(mvm: *mut iwl_mvm, backoff: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_tt_handler(mvm: *mut iwl_mvm) {
    void iwl_mvm_tt_handler(struct iwl_mvm *mvm)
    {
    struct iwl_tt_params *params = &mvm.thermal_throttle.params;
    struct iwl_mvm_tt_mgmt *tt = &mvm.thermal_throttle;
    let mut temperature: i32 = mvm.temperature;
    let mut throttle_enable: bool = false;
    int i;
    u32 tx_backoff;
    IWL_DEBUG_TEMP(mvm, "NIC temperature: %d\n", mvm.temperature);
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_ctdp_command(mvm: *mut iwl_mvm, op: u32, state: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn compare_temps(a: *const c_void, b: *const c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_trip_walk_data {
    pub thresholds: *mut __le16,
    pub count: c_int,
}

#[no_mangle]
unsafe extern "C" fn iwl_trip_temp_cb(trip: *mut thermal_trip, arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_send_temp_report_ths_cmd(mvm: *mut iwl_mvm) -> c_int {
    int iwl_mvm_send_temp_report_ths_cmd(struct iwl_mvm *mvm)
    {
    let mut cmd: temp_report_ths_cmd = {0};
    int ret;

    let mut twd: iwl_trip_walk_data = { .thresholds = cmd.thresholds, .count = 0 };
    lockdep_assert_held(&mvm.mutex);
    if (!mvm.tz_device.tzone)
    goto send;
//
...
// compress trips to cmd array, remove uninitialized values
    ...
    if (twd.count)
    sort(cmd.thresholds, twd.count, sizeof(s16), compare_temps, core::ptr::null_mut());
    send:
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_thermal_zone_register(mvm: *mut iwl_mvm) {
    static void iwl_mvm_thermal_zone_register(struct iwl_mvm *mvm)
    {
    int i, ret;
    char name[16];
    let mut counter: static atomic_t = ATOMIC_INIT(0);
    if (!iwl_mvm_is_tt_in_fw(mvm)) {
    mvm.tz_device.tzone = core::ptr::null_mut();
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_cooling_device_register(mvm: *mut iwl_mvm) {
    ...
    mvm.cooling_dev.cdev = core::ptr::null_mut();
    return;
    }
    }
#[no_mangle]
unsafe extern "C" fn iwl_mvm_thermal_zone_unregister(mvm: *mut iwl_mvm) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_cooling_device_unregister(mvm: *mut iwl_mvm) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_ctdp_get_max_budget(mvm: *mut iwl_mvm) -> u32 {
    static u32 iwl_mvm_ctdp_get_max_budget(struct iwl_mvm *mvm)
    {
    let mut bios_power_budget: u64 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_thermal_initialize(mvm: *mut iwl_mvm, min_backoff: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_thermal_exit(mvm: *mut iwl_mvm) {
