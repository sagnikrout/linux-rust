...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/sf.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mvm_active_iface_iterator_data {
    pub ignore_vif: *mut ieee80211_vif,
    pub sta_vif_ap_sta: *mut ieee80211_sta,
    pub sta_vif_state: enum iwl_sf_state,
    pub num_active_macs: u32,
}
...
//
    ...
    {
    int i, j, watermark;
    let mut max_rx_nss: u8 = 0;
    let mut is_legacy: bool = true;
...
//
    ...
    switch (new_state) {
    case SF_UNINIT:
    iwl_mvm_fill_sf_command(mvm, &sf_cmd, core::ptr::null_mut());
    break;
    case SF_FULL_ON:
    if (!sta) {
    IWL_ERR(mvm,
