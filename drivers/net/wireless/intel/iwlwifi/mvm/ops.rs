...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/ops.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn iwl_mvm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_nic_config(op_mode: *mut iwl_op_mode) {
    static void iwl_mvm_nic_config(struct iwl_op_mode *op_mode)
    {
    struct iwl_mvm *mvm = IWL_OP_MODE_GET_MVM(op_mode);
    u8 radio_cfg_type, radio_cfg_step, radio_cfg_dash;
    u32 reg_val;
    let mut phy_config: u32 = iwl_mvm_get_phy_config(mvm);
...
// we know that ours is writable
    ...
    let mut mode: enum ieee80211_smps_mode = IEEE80211_SMPS_AUTOMATIC;
    if (!link_conf)
    return;
...
//
    ...
    iwl_mvm_intf_dual_chain_req, core::ptr::null_mut());
    }
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_rx_handlers {
    pub min_size: u16 cmd_id,,
    pub context: enum iwl_rx_handler_context,
    pub rxb): *mut *mut *mut void (fn)(struct iwl_mvm mvm, struct iwl_rx_cmd_buffer,
}
...
//
    ...
    let mut iwl_mvm_groups_size: c_uint = ARRAY_SIZE(iwl_mvm_groups);
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_min_backoff(mvm: *mut iwl_mvm) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_tx_unblock_dwork(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_fwrt_dump_start(ctx: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_fwrt_dump_end(ctx: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_fwrt_send_hcmd(ctx: *mut c_void, host_cmd: *mut iwl_host_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_d3_debug_enable(ctx: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_start_get_nvm(mvm: *mut iwl_mvm) -> c_int {
...
//
    ...
    IWL_ERR(mvm,
    "Got a core::ptr::null_mut() NVM from CSME, trying to get it from the device\n");
    }
    get_nvm_from_fw:
    rtnl_lock();
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_start_post_nvm(mvm: *mut iwl_mvm) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mvm_frob_txf_data {
    pub buf: *mut u8,
    pub buflen: usize,
}
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_frob_txf(ctx: *mut c_void, buf: *mut c_void, buflen: usize) {
...
// embedded key material exists only on old API
    ...
    return;
    rcu_read_lock();
    ieee80211_iter_keys_rcu(mvm.hw, core::ptr::null_mut(), iwl_mvm_frob_txf_key_iter, &txf);
    rcu_read_unlock();
    }
#[no_mangle]
unsafe extern "C" fn iwl_mvm_frob_hcmd(ctx: *mut c_void, hcmd: *mut c_void, len: usize) {
...
// we only use wide headers for commands
    ...
    let mut frob_start: c_uint = sizeof(*hdr), frob_end = 0;
    if (len < sizeof(hdr))
    return;
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_frob_mem(ctx: *mut c_void, mem_addr: u32, mem: *mut c_void, buflen: usize) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_me_conn_status(priv: *mut c_void, conn_info: *const iwl_mei_conn_info) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_mei_roaming_forbidden(priv: *mut c_void, forbidden: bool) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_sap_connected_wk(wk: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_mei_sap_connected(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_mei_nic_stolen(priv: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_stop_device(mvm: *mut iwl_mvm) {
...
#[no_mangle]
unsafe extern "C" fn iwl_op_mode_mvm_stop(op_mode: *mut iwl_op_mode) {
...
//
    ...
    mvm.mcast_filter_cmd = core::ptr::null_mut();
    kfree(mvm.error_recovery_buf);
    mvm.error_recovery_buf = core::ptr::null_mut();
    iwl_mvm_ptp_remove(mvm);
    iwl_trans_op_mode_leave(mvm.trans);
    iwl_phy_db_free(mvm.phy_db);
    mvm.phy_db = core::ptr::null_mut();
    kfree(mvm.nvm_data);
    kfree(mvm.mei_nvm_data);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_async_handler_entry {
    pub list: list_head,
    pub rxb: iwl_rx_cmd_buffer,
    pub context: enum iwl_rx_handler_context,
    pub rxb): *mut *mut *mut void (fn)(struct iwl_mvm mvm, struct iwl_rx_cmd_buffer,
}

#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_async_handlers_purge(mvm: *mut iwl_mvm) {
...
//
    ...
    let mut contexts: u8 = BIT(RX_HANDLER_ASYNC_LOCKED_WIPHY);
    iwl_mvm_async_handlers_by_context(mvm, contexts);
    }
#[no_mangle]
unsafe extern "C" fn iwl_mvm_async_handlers_wk(wk: *mut work_struct) {
    static void iwl_mvm_async_handlers_wk(struct work_struct *wk)
    {
    struct iwl_mvm *mvm =
    ...
    int i;
    trig = iwl_fw_dbg_trigger_on(&mvm.fwrt, core::ptr::null_mut(),
...
// don't collect on CMD 0
    ...
    int i;
    let mut tp_data: union iwl_dbg_tlv_tp_data = { .fw_pkt = pkt };
...
// we can't do much...
    ...
    struct iwl_rx_packet *pkt = rxb_addr(rxb);
    struct iwl_mvm *mvm = IWL_OP_MODE_GET_MVM(op_mode);
    let mut cmd: u16 = WIDE_ID(pkt.hdr.group_id, pkt.hdr.cmd);
    if (likely(cmd == WIDE_ID(LEGACY_GROUP, REPLY_RX_MPDU_CMD)))
    iwl_mvm_rx_rx_mpdu(mvm, napi, rxb);
#[no_mangle]
pub unsafe extern "C" fn if(WIDE_ID(LEGACY_GROUP: cmd ==, _arg: REPLY_RX_PHY_CMD)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(WIDE_ID(LEGACY_GROUP: cmd ==, _arg: FRAME_RELEASE)) -> else {
    else if (cmd == WIDE_ID(LEGACY_GROUP, FRAME_RELEASE))
    iwl_mvm_rx_frame_release(mvm, napi, rxb, 0);
#[no_mangle]
pub unsafe extern "C" fn if(WIDE_ID(LEGACY_GROUP: cmd ==, _arg: BAR_FRAME_RELEASE)) -> else {
    else if (cmd == WIDE_ID(LEGACY_GROUP, BAR_FRAME_RELEASE))
    iwl_mvm_rx_bar_frame_release(mvm, napi, rxb, 0);
#[no_mangle]
pub unsafe extern "C" fn if(WIDE_ID(DATA_PATH_GROUP: cmd ==, _arg: RX_NO_DATA_NOTIF)) -> else {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_is_static_queue(mvm: *mut iwl_mvm, queue: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IEEE80211_STA_NOTEXIST: mvmsta->sta_state !=) -> else {
    else if (mvmsta.sta_state != IEEE80211_STA_NOTEXIST)
    ieee80211_wake_queues(mvm.hw);
    goto out;
    }
    if (iwl_mvm_has_new_tx_api(mvm)) {
    let mut tid: c_int = mvm.tvqm_info[hw_queue].txq_tid;
    tid_bitmap = BIT(tid);
    } else {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_stop_sw_queue(op_mode: *mut iwl_op_mode, hw_queue: c_int) {
    static void iwl_mvm_stop_sw_queue(struct iwl_op_mode *op_mode, int hw_queue)
    {
    iwl_mvm_queue_state_change(op_mode, hw_queue, false);
    }
#[no_mangle]
unsafe extern "C" fn iwl_mvm_wake_sw_queue(op_mode: *mut iwl_op_mode, hw_queue: c_int) {
    static void iwl_mvm_wake_sw_queue(struct iwl_op_mode *op_mode, int hw_queue)
    {
    iwl_mvm_queue_state_change(op_mode, hw_queue, true);
    }
#[no_mangle]
unsafe extern "C" fn iwl_mvm_set_rfkill_state(mvm: *mut iwl_mvm) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_set_hw_ctkill_state(mvm: *mut iwl_mvm, state: bool) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_set_hw_rfkill_state(op_mode: *mut iwl_op_mode, state: bool) -> bool {
    static bool iwl_mvm_set_hw_rfkill_state(struct iwl_op_mode *op_mode, bool state)
    {
    struct iwl_mvm *mvm = IWL_OP_MODE_GET_MVM(op_mode);
    let mut rfkill_safe_init_done: bool = READ_ONCE(mvm.rfkill_safe_init_done);
    let mut unified: bool = iwl_mvm_has_unified_ucode(mvm);
    if (state)
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_free_skb(op_mode: *mut iwl_op_mode, skb: *mut sk_buff) {
...
//
    ...
    let mut src_size: u32 = mvm.fw.ucode_capa.error_log_size;
    let mut src_addr: u32 = mvm.fw.ucode_capa.error_log_addr;
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_dump(op_mode: *mut iwl_op_mode) {
    ...
    return;
    iwl_dbg_tlv_time_point(fwrt, IWL_FW_INI_TIME_POINT_USER_TRIGGER, core::ptr::null_mut());
    }

#[no_mangle]
unsafe extern "C" fn iwl_op_mode_mvm_device_powered_off(op_mode: *mut iwl_op_mode) {
...
#[no_mangle]
pub unsafe extern "C" fn if(WIDE_ID(LEGACY_GROUP: likely(cmd ==, _arg: REPLY_RX_MPDU_CMD))) -> else {
