...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/mld-mac.c
#![no_std]
...
//
    ...
    {
    let mut cmd: iwl_mac_config_cmd_v3 = {};
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_mld_mac_ctxt_add(mvm: *mut iwl_mvm, vif: *mut ieee80211_vif) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_mld_mac_ctxt_remove(mvm: *mut iwl_mvm, vif: *mut ieee80211_vif) -> c_int {
