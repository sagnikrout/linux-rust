...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/power.c
#![no_std]
...
pub const POWER_KEEP_ALIVE_PERIOD_SEC: c_int = 25;
    static
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_allow_uapsd_iface_iterator_data {
    pub current_vif: *mut ieee80211_vif,
    pub allow_uapsd: bool,
}
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_power_is_radar(link_conf: *mut ieee80211_bss_conf) -> bool {
...
// this happens on link switching, just ignore inactive ones
    ...
    let mut min_link_skip: c_uint = ~0;
...
// disable, in case we're supposed to override
    ...
    let mut dtimper: c_uint = link_conf.dtim_period ?: 1;
    let mut dtimper_tu: c_uint = dtimper * link_conf.beacon_int;
    unsigned int skip;
...
//
    ...
    let mut flag: u16 = POWER_FLAGS_UAPSD_MISBEHAVING_ENA_MSK;
    ...
    struct ieee80211_vif *vif)
    {
    let mut cmd: iwl_mac_power_cmd_v2 = {};
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_power_update_device(mvm: *mut iwl_mvm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_power_vif_assoc(mvm: *mut iwl_mvm, vif: *mut ieee80211_vif) {
...
//
    ...
    let mut ap_sta_id: u8 = le32_to_cpu(notif.sta_id);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_power_vifs {
    pub mvm: *mut iwl_mvm,
    pub bss_vif: *mut ieee80211_vif,
    pub p2p_vif: *mut ieee80211_vif,
    pub ap_vif: *mut ieee80211_vif,
...
// only a single MAC of the same type
    ...
    {
    struct iwl_mvm_vif *bss_mvmvif = core::ptr::null_mut();
    struct iwl_mvm_vif *p2p_mvmvif = core::ptr::null_mut();
    struct iwl_mvm_vif *ap_mvmvif = core::ptr::null_mut();
    let mut client_same_channel: bool = false;
    let mut ap_same_channel: bool = false;
...
// don't allow PM if any TDLS stations exist
    if (iwl_mvm_tdls_sta_count(mvm, core::ptr::null_mut()))
    return;
...
// share same channel
    ...
    struct ieee80211_vif *vif)
    {
    let mut cmd: iwl_beacon_filter_cmd = {};
    struct iwl_mvm_vif *mvmvif = iwl_mvm_vif_from_mac80211(vif);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_power_set_ps(mvm: *mut iwl_mvm) -> c_int {
...
// update device power state if it has changed
    ...
    let mut old_ps_disabled: bool = mvm.ps_disabled;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_power_update_ps(mvm: *mut iwl_mvm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_power_update_mac(mvm: *mut iwl_mvm) -> c_int {
