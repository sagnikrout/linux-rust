...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/coex.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn if(phy_ctx_id: secondary_ch_phy_id ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_send_bt_init_conf(mvm: *mut iwl_mvm) -> c_int {
    int iwl_mvm_send_bt_init_conf(struct iwl_mvm *mvm)
    {
    let mut bt_cmd: iwl_bt_coex_cmd = {};
    u32 mode;
    ...
    bool enable)
    {
    let mut cmd: iwl_bt_coex_reduced_txp_update_cmd = {};
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_bt_iterator_data {
    pub notif: *mut iwl_bt_coex_prof_old_notif,
    pub mvm: *mut iwl_mvm,
    pub primary: *mut ieee80211_chanctx_conf,
    pub secondary: *mut ieee80211_chanctx_conf,
    pub primary_ll: bool,
    pub primary_load: u8,
    pub secondary_load: u8,
}
...
#[no_mangle]
pub unsafe extern "C" fn if(BT_LOW_TRAFFIC: bt_activity_grading >=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(chanctx_conf: data->secondary ==) -> else {
...
//
    ...
    data.primary = chanctx_conf;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !data->secondary) -> else {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_bt_coex_notif_handle(mvm: *mut iwl_mvm) {
    ...
    let mut cmd: iwl_bt_coex_ci_cmd = {};
    u8 ci_bw_idx;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_bt_coex_is_ant_avail(mvm: *mut iwl_mvm, ant: u8) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_bt_coex_is_shared_ant_avail(mvm: *mut iwl_mvm) -> bool {
    ...
    {
    let mut bt_activity: u32 = le32_to_cpu(mvm.last_bt_notif.bt_activity_grading);
    if (band != NL80211_BAND_2GHZ)
    return false;
    return bt_activity >= BT_LOW_TRAFFIC;
    }
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_bt_coex_get_single_ant_msk(mvm: *mut iwl_mvm, enabled_ants: u8) -> u8 {
    ...
    let mut mplut_enabled: bool = iwl_mvm_is_mplut_supported(mvm);
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_bt_coex_vif_change(mvm: *mut iwl_mvm) {
