...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/offloading.c
#![no_std]
...
//
    ...
    let mut seq: u16 = mvm_ap_sta.tid_data[i].seq_number;
    seq -= 0x10;
    ...
    let mut enabled: u32 = 0, size;
    let mut capa_flags: u32 = mvm.fw.ucode_capa.flags;
    let mut ver: c_int = iwl_fw_lookup_cmd_ver(mvm.fw, hcmd.id, 0);
...
//
    let mut skip_tentative: bool = offload_ns;
