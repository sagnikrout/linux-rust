...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/led.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_send_led_fw_cmd(mvm: *mut iwl_mvm, on: bool) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_led_set(mvm: *mut iwl_mvm, on: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_leds_init(mvm: *mut iwl_mvm) -> c_int {
    int iwl_mvm_leds_init(struct iwl_mvm *mvm)
    {
    let mut mode: c_int = iwlwifi_mod_params.led_mode;
    int ret;
    switch (mode) {
    case IWL_LED_BLINK:
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_leds_sync(mvm: *mut iwl_mvm) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_leds_exit(mvm: *mut iwl_mvm) {
