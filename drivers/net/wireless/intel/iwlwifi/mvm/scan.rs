...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/scan.c
#![no_std]
...
pub const IWL_DENSE_EBS_SCAN_RATIO: c_int = 5;
pub const IWL_SPARSE_EBS_SCAN_RATIO: c_int = 1;
pub const IWL_SCAN_DWELL_ACTIVE: c_int = 10;
pub const IWL_SCAN_DWELL_PASSIVE: c_int = 110;
pub const IWL_SCAN_DWELL_FRAGMENTED: c_int = 44;
pub const IWL_SCAN_DWELL_EXTENDED: c_int = 90;
pub const IWL_SCAN_NUM_OF_FRAGS: c_int = 3;
// adaptive dwell max budget time [TU] for full scan
pub const IWL_SCAN_ADWELL_MAX_BUDGET_FULL_SCAN: c_int = 300;
// adaptive dwell max budget time [TU] for directed scan
pub const IWL_SCAN_ADWELL_MAX_BUDGET_DIRECTED_SCAN: c_int = 100;
// adaptive dwell default high band APs number
pub const IWL_SCAN_ADWELL_DEFAULT_HB_N_APS: c_int = 8;
// adaptive dwell default low band APs number
pub const IWL_SCAN_ADWELL_DEFAULT_LB_N_APS: c_int = 2;
// adaptive dwell default APs number in social channels (1, 6, 11)
pub const IWL_SCAN_ADWELL_DEFAULT_N_APS_SOCIAL: c_int = 10;
// number of scan channels
pub const IWL_SCAN_NUM_CHANNELS: c_int = 112;
...
pub const IWL_SCAN_ADWELL_N_APS_GO_FRIENDLY: c_int = 10;
// adaptive dwell number of APs override for social channels
pub const IWL_SCAN_ADWELL_N_APS_SOCIAL_CHS: c_int = 2;
// minimal number of 2GHz and 5GHz channels in the regular scan request
pub const IWL_MVM_6GHZ_PASSIVE_SCAN_MIN_CHANS: c_int = 4;
// Number of iterations on the channel for mei filtered scan

pub const WFA_TPC_IE_LEN: c_int = 9;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mvm_scan_timing_params {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mvm_scan_params {
// For CDB this is low band scan type, for non-CDB - type.
    pub type: enum iwl_mvm_scan_type,
    pub hb_type: enum iwl_mvm_scan_type,
    pub n_channels: u32,
    pub delay: u16,
    pub n_ssids: c_int,
    ...
    pub scan_6ghz: bool,
    pub enable_6ghz_passive: bool,
    pub respect_p2p_go_hb: bool respect_p2p_go,,
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_scan_rx_ant(mvm: *mut iwl_mvm) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_scan_rx_chain(mvm: *mut iwl_mvm) -> __le16 {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_get_traffic_load(mvm: *mut iwl_mvm) -> enum iwl_mvm_traffic_load {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mvm_scan_iter_data {
    pub global_cnt: u32,
    pub current_vif: *mut ieee80211_vif,
    pub is_dcm_with_p2p_go: bool,
}
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_rrm_scan_needed(mvm: *mut iwl_mvm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_max_scan_ie_fw_cmd_room(mvm: *mut iwl_mvm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_max_scan_ie_len(mvm: *mut iwl_mvm) -> c_int {
    int iwl_mvm_max_scan_ie_len(struct iwl_mvm *mvm)
    {
    let mut max_ie_len: c_int = iwl_mvm_max_scan_ie_fw_cmd_room(mvm);
...
//
    ...
    let mut aborted: bool = (scan_notif.status == IWL_SCAN_OFFLOAD_ABORTED);
...
#[no_mangle]
unsafe extern "C" fn iwl_ssid_exist(ssid: *mut u8, ssid_len: u8, ssid_list: *mut iwl_ssid_ie) -> c_int {
...
// ssid_bitmap = tmp_bitmap;
    ...
    let mut max_profiles: c_int = iwl_umac_scan_get_max_profiles(mvm.fw);
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_lmac_scan_abort(mvm: *mut iwl_mvm) -> c_int {
    ...
    let mut status: u32 = CAN_ABORT_STATUS;
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_add_tpc_report_ie(pos: *mut u8) {
...
// pos[7] - tx power will be inserted by the FW
    ...
    params.mac_addr : core::ptr::null_mut();
//
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_is_regular_scan(params: *mut iwl_mvm_scan_params) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_is_scan_fragmented(type: enum iwl_mvm_scan_type) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rate_to_scan_rate_flag(rate: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_scan_config_rates(mvm: *mut iwl_mvm) -> __le32 {
...
// Set both basic rates and supported rates
    ...
    u32 max_channels)
    {
    let mut type: enum iwl_mvm_scan_type = iwl_mvm_get_scan_type(mvm, core::ptr::null_mut());
...
// This function should not be called when using ADD_STA ver >=12
    ...
    lb_type = iwl_mvm_get_scan_type_band(mvm, core::ptr::null_mut(),
    NL80211_BAND_2GHZ);
    hb_type = iwl_mvm_get_scan_type_band(mvm, core::ptr::null_mut(),
    NL80211_BAND_5GHZ);
    ...
    iwl_mvm_get_scan_type(mvm, core::ptr::null_mut());
    cfg.out_of_channel_time[SCAN_LB_LMAC_IDX] =
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_legacy_config_scan(mvm: *mut iwl_mvm) -> c_int {
    ...
    enum iwl_mvm_scan_type type;
    let mut hb_type: enum iwl_mvm_scan_type = IWL_SCAN_TYPE_NOT_SET;
    int num_channels =
    ...
    if (iwl_mvm_is_cdb_supported(mvm)) {
    type = iwl_mvm_get_scan_type_band(mvm, core::ptr::null_mut(),
    NL80211_BAND_2GHZ);
    hb_type = iwl_mvm_get_scan_type_band(mvm, core::ptr::null_mut(),
    NL80211_BAND_5GHZ);
    ...
    type = iwl_mvm_get_scan_type(mvm, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_config_scan(mvm: *mut iwl_mvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_scan_uid_by_status(mvm: *mut iwl_mvm, status: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(params->ssids[0].ssid_len: params->n_ssids &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_scan_umac_ooc_priority(type: c_int) -> u32 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mvm_scan_channel_segment {
    pub start_idx: u8,
    pub end_idx: u8,
    pub first_channel_id: u8,
    pub last_channel_id: u8,
    pub channel_spacing_shift: u8,
    pub band: u8,
}
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_scan_ch_and_band_to_idx(channel_id: u8, band: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_scan_ch_n_aps_flag(vif_type: enum nl80211_iftype, ch_id: u8) -> u32 {
    ...
    let mut band: enum nl80211_band = channels[i].band;
    ...
    let mut bitmap_n_entries: usize = ARRAY_SIZE(cp.adwell_ch_override_bitmap);
    int i;
    for (i = 0; i < n_channels; i++) {
    let mut band: enum nl80211_band = channels[i].band;
    ...
    channels[i].hw_value);
    let mut iwl_band: u8 = iwl_mvm_phy_band_from_nl80211(band);
...
// TODO: this function can be merged with iwl_mvm_scan_umac_fill_ch_p_v7
    ...
    let mut s_ssid_bitmap: u32 = 0, bssid_bitmap = 0, flags = 0;
    u8 k, n_s_ssids = 0, n_bssids = 0;
    u8 max_s_ssids, max_bssids;
    bool force_passive = false, found = false, allow_passive = true,
    unsolicited_probe_on_chan = false, psc_no_listen = false;
    let mut psd_20: i8 = IEEE80211_RNR_TBTT_PARAMS_PSD_RESERVED;
//
...
#[no_mangle]
pub unsafe extern "C" fn if(params->ssids[0].ssid_len: params->n_ssids == 1 &&) -> else {
...
// set fragmented ebs for fragmented scan on HB channels
    ...
    iwl_scan_build_ssids(params, pp.direct_scan, core::ptr::null_mut());
    }
    static void
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_num_scans(mvm: *mut iwl_mvm) -> c_int {
    static int iwl_mvm_num_scans(struct iwl_mvm *mvm)
    {
    return hweight32(mvm.scan_status & IWL_MVM_SCAN_MASK);
    }
#[no_mangle]
unsafe extern "C" fn iwl_mvm_check_running_scans(mvm: *mut iwl_mvm, type: c_int) -> c_int {
...
pub const SCAN_TIMEOUT: c_int = 30000;
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_scan_timeout_wk(work: *mut work_struct) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_scan_umac_handler {
    pub version: u8,
    int (*handler)(struct iwl_mvm *mvm, struct ieee80211_vif *vif,
    pub uid): *mut *mut iwl_mvm_scan_params params, int type, int,
}
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_mei_scan_work(wk: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_mei_scan_filter_init(mei_scan_filter: *mut iwl_mei_scan_filter) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mvm_scan_respect_p2p_go_iter_data {
    pub current_vif: *mut ieee80211_vif,
    pub p2p_go: bool,
...
// exclude the given vif
    ...
    let mut params: iwl_mvm_scan_params = {};
    int ret, uid;
    let mut scan_plan: cfg80211_sched_scan_plan = { .iterations = 1 };
    lockdep_assert_held(&mvm.mutex);
...
// we should have failed registration if scan_cmd was NULL
    ...
    params.match_sets = core::ptr::null_mut();
...
//
    ...
    int ret, uid;
    int i, j;
    let mut non_psc_included: bool = false;
    lockdep_assert_held(&mvm.mutex);
    if (iwl_mvm_is_lar_supported(mvm) && !mvm.lar_regdom_set) {
...
//
    ...
    let mut uid: u32 = __le32_to_cpu(notif.uid);
    let mut aborted: bool = (notif.status == IWL_SCAN_OFFLOAD_ABORTED);
...
//
    ...
    ieee80211_scan_completed(mvm.hw, &info);
    mvm.scan_vif = core::ptr::null_mut();
    cancel_delayed_work(&mvm.scan_timeout_dwork);
    iwl_mvm_resume_tcm(mvm);
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_umac_scan_abort(mvm: *mut iwl_mvm, type: c_int, wait: *mut bool) -> c_int {
    static int iwl_mvm_umac_scan_abort(struct iwl_mvm *mvm, int type, bool *wait)
    {
    let mut abort_cmd: iwl_umac_scan_abort = {};
    struct iwl_host_cmd cmd = {
    ...
    int uid, ret;
    let mut status: u32 = IWL_UMAC_SCAN_ABORT_STATUS_NOT_FOUND;
    lockdep_assert_held(&mvm.mutex);
// wait = true;
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_scan_stop_wait(mvm: *mut iwl_mvm, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_scan_req_umac_get_size(scan_ver: u8) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_scan_size(mvm: *mut iwl_mvm) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: iwl_mvm_is_adaptive_dwell_supported(mvm)) -> else {
    else if (iwl_mvm_is_adaptive_dwell_supported(mvm))
    base_size = IWL_SCAN_REQ_UMAC_SIZE_V7;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: iwl_mvm_cdb_scan_api(mvm)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_report_scan_aborted(mvm: *mut iwl_mvm) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_scan_stop(mvm: *mut iwl_mvm, type: c_int, notify: bool) -> c_int {
