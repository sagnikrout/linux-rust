...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/ptp.c
#![no_std]
...
pub const IWL_PTP_GP2_WRAP: c_uint = 0x100000000ULL;
...
pub const IWL_PTP_GET_CROSS_TS_NUM: c_int = 5;
#[no_mangle]
unsafe extern "C" fn iwl_mvm_ptp_update_new_read(mvm: *mut iwl_mvm, gp2: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_ptp_get_adj_time(mvm: *mut iwl_mvm, base_time_ns: u64) -> u64 {
    u64 iwl_mvm_ptp_get_adj_time(struct iwl_mvm *mvm, u64 base_time_ns)
    {
    struct ptp_data *data = &mvm.ptp_data;
    let mut last_gp2_ns: u64 = mvm.ptp_data.scale_update_gp2 * NSEC_PER_USEC;
    u64 res;
    u64 diff;
...
// sys_time = (u64)le32_to_cpu(resp->platform_timestamp_hi) << 32 |
    ...
    {
    let mut diff: u64 = 0, new_diff;
    u64 tmp_sys_time;
    u32 tmp_gp2;
    int i;
    for (i = 0; i < IWL_PTP_GET_CROSS_TS_NUM; i++) {
    iwl_mvm_get_sync_time(mvm, CLOCK_REALTIME, &tmp_gp2, core::ptr::null_mut(),
    &tmp_sys_time);
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_ptp_work(wk: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_ptp_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_ptp_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_ptp_init(mvm: *mut iwl_mvm) {
...
// Give a short 'friendly name' to identify the PHC clock
    ...
    mvm.ptp_data.ptp_clock = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_ptp_remove(mvm: *mut iwl_mvm) {
