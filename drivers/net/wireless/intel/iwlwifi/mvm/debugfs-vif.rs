...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/debugfs-vif.c
#![no_std]
...
//
    ...
    let mut dtimper: c_int = vif.bss_conf.dtim_period ?: 1;
    let mut dtimper_msec: c_int = dtimper * vif.bss_conf.beacon_int;
    ...
    char buf[64];
    let mut bufsz: c_int = sizeof(buf);
    int pos;
    ...
    let mut pos: c_int = 0;
    mutex_lock(&mvm.mutex);
    iwl_mvm_get_sync_time(mvm, CLOCK_BOOTTIME, &curr_gp2, &curr_os, core::ptr::null_mut());
    mutex_unlock(&mvm.mutex);
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_vif_add_debugfs(hw: *mut ieee80211_hw, vif: *mut ieee80211_vif) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_vif_dbgfs_add_link(mvm: *mut iwl_mvm, vif: *mut ieee80211_vif) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_vif_dbgfs_rm_link(mvm: *mut iwl_mvm, vif: *mut ieee80211_vif) {
    void iwl_mvm_vif_dbgfs_rm_link(struct iwl_mvm *mvm, struct ieee80211_vif *vif)
    {
    struct iwl_mvm_vif *mvmvif = iwl_mvm_vif_from_mac80211(vif);
    debugfs_remove(mvmvif.dbgfs_slink);
    mvmvif.dbgfs_slink = core::ptr::null_mut();
    }
