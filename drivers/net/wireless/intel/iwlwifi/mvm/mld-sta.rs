...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/mld-sta.c
#![no_std]
...
//
    ...
    {
    let mut cmd_id: u32 = WIDE_ID(MAC_CONF_GROUP, STA_CONFIG_CMD);
...
//
#[no_mangle]
unsafe extern "C" fn iwl_mvm_mld_rm_sta_from_fw(mvm: *mut iwl_mvm, sta_id: u32) -> c_int {
...
//
    txq = iwl_mvm_tvqm_enable_txq(mvm, core::ptr::null_mut(), sta.sta_id, tid,
    wdg_timeout);
    if (txq < 0) {
...
//
    ...
    let mut timeout: c_uint = iwl_mvm_get_wd_timeout(mvm, vif);
    lockdep_assert_held(&mvm.mutex);
...
//
    ...
    mvm_link.fw_link_id, core::ptr::null_mut(),
    IWL_MAX_TID_COUNT, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_mld_add_aux_sta(mvm: *mut iwl_mvm, lmac_id: u32) -> c_int {
...
//
    ...
    STATION_TYPE_AUX, lmac_id, core::ptr::null_mut(),
    IWL_MAX_TID_COUNT, core::ptr::null_mut());
    }
    static int iwl_mvm_mld_disable_txq(struct iwl_mvm *mvm, u32 sta_mask,
    u16 *queueptr, u8 tid)
    {
    let mut queue: c_int = *queueptr;
    let mut ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_mld_rm_snif_sta(mvm: *mut iwl_mvm, vif: *mut ieee80211_vif) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_mld_rm_aux_sta(mvm: *mut iwl_mvm) -> c_int {
...
// send a cfg sta command to add/update a sta in firmware
    ...
    let mut agg_size: u32 = 0, mpdu_dens = 0;
...
// HTC flags
    ...
    lockdep_assert_held(&mvm.mutex);
    RCU_INIT_POINTER(mvm.fw_id_to_mac_id[mvm_sta_link.sta_id], core::ptr::null_mut());
    RCU_INIT_POINTER(mvm.fw_id_to_link_sta[mvm_sta_link.sta_id], core::ptr::null_mut());
    RCU_INIT_POINTER(mvm_sta.link[link_id], core::ptr::null_mut());
...
//
    ...
    struct iwl_mvm_vif *mvm_vif = iwl_mvm_vif_from_mac80211(vif);
    struct iwl_mvm_sta *mvm_sta = iwl_mvm_sta_from_mac80211(sta);
    let mut link_sta_added_to_fw: c_ulong = 0;
    struct ieee80211_link_sta *link_sta;
    let mut ret: c_int = 0;
    unsigned int link_id;
    lockdep_assert_held(&mvm.mutex);
...
// free all sta resources in the driver
    ...
    {
    struct iwl_mvm_sta *mvm_sta = iwl_mvm_sta_from_mac80211(sta);
    let mut sta_mask: u32 = iwl_mvm_sta_fw_id_mask(mvm, sta, -1);
    int i;
    lockdep_assert_held(&mvm.mutex);
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_mld_rm_sta_id(mvm: *mut iwl_mvm, sta_id: u8) -> c_int {
    ...
    RCU_INIT_POINTER(mvm.fw_id_to_mac_id[sta_id], core::ptr::null_mut());
