...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/fw.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mvm_alive_data {
    pub sku_id: [__le32; 3],
    pub valid: bool,
}

#[no_mangle]
unsafe extern "C" fn iwl_send_tx_ant_cfg(mvm: *mut iwl_mvm, valid_tx_ant: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_send_rss_cfg_cmd(mvm: *mut iwl_mvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_send_dqa_cmd(mvm: *mut iwl_mvm) -> c_int {
    static int iwl_mvm_send_dqa_cmd(struct iwl_mvm *mvm)
    {
    struct iwl_dqa_enable_cmd dqa_cmd = {
    .cmd_queue = cpu_to_le32(IWL_MVM_DQA_CMD_QUEUE),
    };
    let mut cmd_id: u32 = WIDE_ID(DATA_PATH_GROUP, DQA_ENABLE_CMD);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_print_pd_notification(mvm: *mut iwl_mvm) {
    static void iwl_mvm_print_pd_notification(struct iwl_mvm *mvm)
    {

    IWL_ERR(mvm, #reg_name ": 0x%x\n", iwl_read_umac_prph(trans, reg_name))
    struct iwl_trans *trans = mvm.trans;
    let mut device_family: enum iwl_device_family = trans.mac_cfg.device_family;
...
// print OPT info
    ...
    let mut alive_data: iwl_mvm_alive_data = {};
    int ret;
    let mut old_type: enum iwl_ucode_type = mvm.fwrt.cur_fw_img;
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_uats_init(mvm: *mut iwl_mvm) {
    static void iwl_mvm_uats_init(struct iwl_mvm *mvm)
    {
    struct iwl_mcc_allowed_ap_type_cmd_v1 *cmd __free(kfree) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_sgom_init(mvm: *mut iwl_mvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_send_phy_cfg_cmd(mvm: *mut iwl_mvm) -> c_int {
    static int iwl_send_phy_cfg_cmd(struct iwl_mvm *mvm)
    {
    let mut cmd_id: u32 = PHY_CONFIGURATION_CMD;
    struct iwl_phy_cfg_cmd_v3 phy_cfg_cmd;
    let mut ucode_type: enum iwl_ucode_type = mvm.fwrt.cur_fw_img;
    u8 cmd_ver;
    size_t cmd_size;
...
#[no_mangle]
unsafe extern "C" fn iwl_run_unified_mvm_ucode(mvm: *mut iwl_mvm) -> c_int {
    static int iwl_run_unified_mvm_ucode(struct iwl_mvm *mvm)
    {
    struct iwl_notification_wait init_wait;
    let mut nvm_complete: iwl_nvm_access_complete_cmd = {};
...
// if needed, we'll reset this on our way out later
    ...
    core::ptr::null_mut());
    iwl_dbg_tlv_time_point(&mvm.fwrt, IWL_FW_INI_TIME_POINT_EARLY, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn iwl_run_init_mvm_ucode(mvm: *mut iwl_mvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_config_ltr(mvm: *mut iwl_mvm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_sar_select_profile(mvm: *mut iwl_mvm, prof_a: c_int, prof_b: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_get_sar_geo_profile(mvm: *mut iwl_mvm) -> c_int {
    int iwl_mvm_get_sar_geo_profile(struct iwl_mvm *mvm)
    {
    let mut geo_tx_cmd: union iwl_geo_tx_power_profiles_cmd = {};
...
#[no_mangle]
pub unsafe extern "C" fn if(4: cmd_ver ==) -> else {
    else if (cmd_ver == 4)
    len = sizeof(geo_tx_cmd.v4);
#[no_mangle]
pub unsafe extern "C" fn if(3: cmd_ver ==) -> else {
    else if (cmd_ver == 3)
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_sar_geo_init(mvm: *mut iwl_mvm) -> c_int {
    static int iwl_mvm_sar_geo_init(struct iwl_mvm *mvm)
    {
    let mut cmd_id: u32 = WIDE_ID(PHY_OPS_GROUP, PER_CHAIN_LIMIT_OFFSET_CMD);
    let mut cmd: union iwl_geo_tx_power_profiles_cmd = {};
    u16 len;
    u32 n_bands;
    u32 n_profiles;
    let mut sk: __le32 = cpu_to_le32(0);
    int ret;
...
//
    ...
    int subband)
    {
    let mut ppag_val: i8 = fwrt.ppag_chains[chain].subbands[subband];
    if ((subband == 0 &&
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_ppag_send_cmd(mvm: *mut iwl_mvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_ppag_init(mvm: *mut iwl_mvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_tas_init(mvm: *mut iwl_mvm) {
    static void iwl_mvm_tas_init(struct iwl_mvm *mvm)
    {
    let mut cmd_id: u32 = WIDE_ID(REGULATORY_AND_NVM_GROUP, TAS_CONFIG);
    int fw_ver = iwl_fw_lookup_cmd_ver(mvm.fw, cmd_id,
    IWL_FW_CMD_VER_UNKNOWN);
    let mut selection_data: iwl_tas_selection_data = {};
    let mut cmd_v2_v4: iwl_tas_config_cmd_v2_v4 = {};
    let mut cmd_v5: iwl_tas_config_cmd = {};
    let mut data: iwl_tas_data = {};
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_get_lari_config_bitmap(fwrt: *mut iwl_fw_runtime) -> __le32 {
    static __le32 iwl_mvm_get_lari_config_bitmap(struct iwl_fw_runtime *fwrt)
    {
    int ret;
    u32 val;
    let mut config_bitmap: __le32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(DSM_VALUE_SRD_DISABLE: val ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_get_lari_config_cmd_size(cmd_ver: u8) -> usize {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_send_lari_cfg_extension(mvm: *mut iwl_mvm) {
    static void iwl_mvm_send_lari_cfg_extension(struct iwl_mvm *mvm)
    {
    struct iwl_fw_runtime *fwrt = &mvm.fwrt;
    let mut cmd: iwl_lari_config_extension_cmd = {};
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_lari_cfg(mvm: *mut iwl_mvm) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_get_bios_tables(mvm: *mut iwl_mvm) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_send_recovery_cmd(mvm: *mut iwl_mvm, flags: u32) {
    void iwl_mvm_send_recovery_cmd(struct iwl_mvm *mvm, u32 flags)
    {
    let mut error_log_size: u32 = mvm.fw.ucode_capa.error_log_size;
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_sar_init(mvm: *mut iwl_mvm) -> c_int {
    static int iwl_mvm_sar_init(struct iwl_mvm *mvm)
    {
    return iwl_mvm_sar_select_profile(mvm, 1, 1);
    }
#[no_mangle]
unsafe extern "C" fn iwl_mvm_load_rt_fw(mvm: *mut iwl_mvm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_up(mvm: *mut iwl_mvm) -> c_int {
...
// FW loaded successfully
    ...
    ret = iwl_mvm_sf_update(mvm, core::ptr::null_mut(), false);
    if (ret)
...
// init the fw <-> mac80211 STA mapping
    ...
    RCU_INIT_POINTER(mvm.fw_id_to_mac_id[i], core::ptr::null_mut());
    RCU_INIT_POINTER(mvm.fw_id_to_link_sta[i], core::ptr::null_mut());
    }
...
//
    ...
    iwl_rfi_send_config_cmd(mvm, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_load_d3_fw(mvm: *mut iwl_mvm) -> c_int {
