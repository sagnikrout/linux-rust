...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/nvm.c
#![no_std]
...
pub const NVM_WRITE_OPCODE: c_int = 1;
pub const NVM_READ_OPCODE: c_int = 0;
...
// Check no memory assumptions fail and cause an overflow
    ...
    let mut tx_ant: u8 = mvm.fw.valid_tx_ant;
    let mut rx_ant: u8 = mvm.fw.valid_rx_ant;
    int regulatory_type;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_load_nvm_to_nic(mvm: *mut iwl_mvm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_nvm_init(mvm: *mut iwl_mvm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_init_mcc(mvm: *mut iwl_mvm) -> c_int {
...
//
    ...
    MCC_SOURCE_BIOS, core::ptr::null_mut());
    if (IS_ERR_OR_NULL(regd))
    return -EIO;
    }
