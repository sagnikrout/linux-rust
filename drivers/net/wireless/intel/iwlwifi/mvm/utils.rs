...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/utils.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_rate_idx_to_plcp(idx: c_int) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_send_cmd(mvm: *mut iwl_mvm, cmd: *mut iwl_host_cmd) -> c_int {
...
//
    ...
    {
    let mut format: c_int = rate_n_flags & RATE_MCS_MOD_TYPE_MSK;
    let mut rate: c_int = rate_n_flags & RATE_LEGACY_RATE_MSK;
    let mut is_LB: bool = band == NL80211_BAND_2GHZ;
...
// CCK is not allowed in HB
    ...
    enum nl80211_band band)
    {
    let mut rate: c_int = rate_n_flags & RATE_LEGACY_RATE_MSK_V1;
    int idx;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_rate_idx_to_fw_idx(fw: *const iwl_fw, rate_idx: c_int) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_mac80211_ac_to_ucode_ac(ac: enum ieee80211_ac_numbers) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_rx_fw_error(mvm: *mut iwl_mvm, rxb: *mut iwl_rx_cmd_buffer) {
...
//
#[no_mangle]
pub unsafe extern "C" fn first_antenna(mask: u8) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_next_antenna(mvm: *mut iwl_mvm, valid: u8, last_idx: u8) -> u8 {
    u8 iwl_mvm_next_antenna(struct iwl_mvm *mvm, u8 valid, u8 last_idx)
    {
    let mut ind: u8 = last_idx;
    int i;
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_send_lq_cmd(mvm: *mut iwl_mvm, lq: *mut iwl_lq_cmd) -> c_int {
...
//
    ...
    let mut smps_mode: enum ieee80211_smps_mode = IEEE80211_SMPS_AUTOMATIC;
    int i;
    lockdep_assert_held(&mvm.mutex);
...
pub const PERIODIC_STAT_RATE: c_int = 5;
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_request_periodic_system_statistics(mvm: *mut iwl_mvm, enable: bool) -> c_int {
    int iwl_mvm_request_periodic_system_statistics(struct iwl_mvm *mvm, bool enable)
    {
    let mut flags: u32 = enable ? 0 : IWL_STATS_CFG_FLG_DISABLE_NTFY_MSK;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_request_statistics(mvm: *mut iwl_mvm, clear: bool) -> c_int {
...
//
    ...
    iwl_init_notification_wait(&mvm.notif_wait, &stats_wait,
    stats_complete, ARRAY_SIZE(stats_complete),
    iwl_wait_stats_complete, core::ptr::null_mut());
    ret = iwl_mvm_send_cmd(mvm, &cmd);
    if (ret) {
    iwl_remove_notification(&mvm.notif_wait, &stats_wait);
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_accu_radio_stats(mvm: *mut iwl_mvm) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mvm_diversity_iter_data {
    pub ctxt: *mut iwl_mvm_phy_ctxt,
    pub result: bool,
}
...
// currently we don't care about the direction
    ...
    res = iwl_mvm_update_quotas(mvm, false, core::ptr::null_mut());
    if (res)
    return res;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mvm_low_latency_iter {
    pub result: bool,
    pub result_per_band: [bool; NUM_NL80211_BANDS],
}

#[no_mangle]
unsafe extern "C" fn iwl_mvm_ll_iter(_data: *mut c_void, mac: *mut u8, vif: *mut ieee80211_vif) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_low_latency(mvm: *mut iwl_mvm) -> bool {
    bool iwl_mvm_low_latency(struct iwl_mvm *mvm)
    {
    let mut data: iwl_mvm_low_latency_iter = {};
    ieee80211_iterate_active_interfaces_atomic(
    mvm.hw, IEEE80211_IFACE_ITER_NORMAL,
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_low_latency_band(mvm: *mut iwl_mvm, band: enum nl80211_band) -> bool {
...
pub struct iwl_bss_iter_data {
    ...
    {
    let mut bss_iter_data: iwl_bss_iter_data = {};
    ieee80211_iterate_active_interfaces_atomic(
    mvm.hw, IEEE80211_IFACE_ITER_NORMAL,
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_is_vif_assoc(mvm: *mut iwl_mvm) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_tcm_load_percentage(airtime: u32, elapsed: u32) -> u8 {
    ...
    {
    let mut load: u8 = iwl_mvm_tcm_load_percentage(airtime, elapsed);
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_tcm_iter(_data: *mut c_void, mac: *mut u8, vif: *mut ieee80211_vif) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_tcm_results(mvm: *mut iwl_mvm) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mvm_tcm_uapsd_nonagg_detected_wk(wk: *mut work_struct) {
...
// remember that this AP is broken
    ...
    int mac)
    {
    let mut bytes: u64 = mvm.tcm.data[mac].uapsd_nonagg_detect.rx_bytes;
    u64 tpt;
    unsigned long rate;
    struct ieee80211_vif *vif;
...
//
    ...
    let mut vo_vi_pkts: u32 = 0;
    let mut airtime: u32 = mdata.rx.airtime + mdata.tx.airtime;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: handle_ll) -> else {
    else if (handle_ll)
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_tcm_work(work: *mut work_struct) {
    void iwl_mvm_tcm_work(struct work_struct *work)
    {
    struct delayed_work *delayed_work = to_delayed_work(work);
    struct iwl_mvm *mvm = container_of(delayed_work, struct iwl_mvm,
    tcm.work);
    let mut ts: c_ulong = jiffies;
    bool handle_uapsd =
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_pause_tcm(mvm: *mut iwl_mvm, with_cancel: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_resume_tcm(mvm: *mut iwl_mvm) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: low_latency) -> else {
    else if (low_latency)
    schedule_delayed_work(&mvm.tcm.work, MVM_LL_PERIOD);
    spin_unlock_bh(&mvm.tcm.lock);
    }
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_tcm_add_vif(mvm: *mut iwl_mvm, vif: *mut ieee80211_vif) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_tcm_rm_vif(mvm: *mut iwl_mvm, vif: *mut ieee80211_vif) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_get_systime(mvm: *mut iwl_mvm) -> u32 {
    u32 iwl_mvm_get_systime(struct iwl_mvm *mvm)
    {
    let mut reg_addr: u32 = DEVICE_SYSTEM_TIME_REG;
...
#[no_mangle]
pub unsafe extern "C" fn if(realtime: clock_type == CLOCK_REALTIME &&) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_vif_is_active(mvmvif: *mut iwl_mvm_vif) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iwl_legacy_rate_to_fw_idx(rate_n_flags: u32) -> u32 {
    static u32 iwl_legacy_rate_to_fw_idx(u32 rate_n_flags)
    {
    let mut rate: c_int = rate_n_flags & RATE_LEGACY_RATE_MSK_V1;
    int idx;
    let mut ofdm: bool = !(rate_n_flags & RATE_MCS_CCK_MSK_V1);
    let mut offset: c_int = ofdm ? IWL_FIRST_OFDM_RATE : 0;
    let mut last: c_int = ofdm ? IWL_RATE_COUNT_LEGACY : IWL_FIRST_OFDM_RATE;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_v3_rate_from_fw(rate: __le32, rate_ver: u8) -> u32 {
    u32 iwl_mvm_v3_rate_from_fw(__le32 rate, u8 rate_ver)
    {
    let mut rate_v3: u32 = 0, rate_v1;
    let mut dup: u32 = 0;
    if (rate_ver > 1)
...
// convert rate
    ...
    let mut nss: u32 = u32_get_bits(rate_v1, RATE_VHT_MCS_NSS_MSK);
    rate_v3 |= rate_v1 & RATE_VHT_MCS_RATE_CODE_MSK;
    rate_v3 |= u32_encode_bits(nss, RATE_MCS_NSS_MSK);
    if (rate_v1 & RATE_MCS_HE_MSK_V1) {
    let mut he_type_bits: u32 = rate_v1 & RATE_MCS_HE_TYPE_MSK_V1;
    let mut he_type: u32 = he_type_bits >> RATE_MCS_HE_TYPE_POS_V1;
...
// if legacy format
    ...
    let mut legacy_rate: u32 = iwl_legacy_rate_to_fw_idx(rate_v1);
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mvm_v3_rate_to_fw(rate: u32, rate_ver: u8) -> __le32 {
