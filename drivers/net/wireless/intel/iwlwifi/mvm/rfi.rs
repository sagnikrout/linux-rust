...
//! Source: drivers/net/wireless/intel/iwlwifi/mvm/rfi.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn iwl_rfi_supported(mvm: *mut iwl_mvm) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_rfi_send_config_cmd(mvm: *mut iwl_mvm, rfi_table: *mut iwl_rfi_lut_entry) -> c_int {
...
// notify FW the table is not the default one
    ...
    let mut resp_size: c_int = sizeof(*resp);
    int ret;
