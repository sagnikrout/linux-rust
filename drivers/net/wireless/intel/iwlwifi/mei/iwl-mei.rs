...
//! Source: drivers/net/wireless/intel/iwlwifi/mei/iwl-mei.h
#![no_std]
...
// Macro flag: #define __iwl_mei_h__
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_mei_pairwise_cipher {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mei_colloc_info {
    pub channel: u8,
    pub bssid: [u8; ETH_ALEN],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mei_ops {
    pub conn_info): *const iwl_mei_conn_info,
    pub csme_taking_ownership): *mut *mut *mut void (rfkill)(void priv, bool blocked, bool,
    pub forbidden): *mut *mut *mut void (roaming_forbidden)(void priv, bool,
    pub priv): *mut *mut void (sap_connected)(void,
    pub priv): *mut *mut void (nic_stolen)(void,
}
...
//
extern "C" {
    pub fn iwl_mei_is_connected() -> bool;
}
//
...
//
extern "C" {
    pub fn iwl_mei_get_ownership() -> c_int;
}
//
...
//
extern "C" {
    pub fn iwl_mei_set_rfkill_state(hw_rfkill: bool, sw_rfkill: bool);
}
//
...
//
extern "C" {
    pub fn iwl_mei_set_nic_info(mac_address: *const u8, nvm_address: *const u8);
}
//
...
//
extern "C" {
    pub fn iwl_mei_set_country_code(mcc: u16);
}
//
...
//
extern "C" {
    pub fn iwl_mei_set_power_limit(power_limit: *const __le16);
}
//
...
//
extern "C" {
    pub fn iwl_mei_register(priv: *mut c_void, ops: *const iwl_mei_ops) -> c_int;
}
//
...
//
extern "C" {
    pub fn iwl_mei_start_unregister();
}
//
...
//
extern "C" {
    pub fn iwl_mei_unregister_complete();
}
//
...
//
extern "C" {
    pub fn iwl_mei_set_netdev(netdev: *mut net_device);
}
//
...
//
extern "C" {
    pub fn iwl_mei_tx_copy_to_csme(skb: *mut sk_buff, ivlen: c_uint);
}
//
...
//
extern "C" {
    pub fn iwl_mei_host_disassociated();
}
//
...
//
extern "C" {
    pub fn iwl_mei_device_state(up: bool);
}
//
...
//
extern "C" {
    pub fn iwl_mei_alive_notif(success: bool);
}
