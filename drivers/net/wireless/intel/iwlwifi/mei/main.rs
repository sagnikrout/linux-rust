...
//! Source: drivers/net/wireless/intel/iwlwifi/mei/main.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_is_connected() -> bool {
...
pub const SAP_CONTROL_BLOCK_ID: c_uint = 0x21504153 /* SAP! in ASCII */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_q_ctrl_blk {
    pub wr_ptr: __le32,
    pub rd_ptr: __le32,
    pub size: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_dir {
    pub reserved: __le32,
    pub q_ctrl_blk: [iwl_sap_q_ctrl_blk; SAP_QUEUE_IDX_MAX],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_shared_mem_ctrl_blk {
    pub sap_id: __le32,
    pub size: __le32,
    pub dir: [iwl_sap_dir; SAP_DIRECTION_MAX],
}
...
// +-----------------------------------+
//
pub const SAP_H2M_DATA_Q_SZ: c_int = 48256;
pub const SAP_M2H_DATA_Q_SZ: c_int = 24128;
pub const SAP_H2M_NOTIF_Q_SZ_VER3: c_int = 2240;
pub const SAP_H2M_NOTIF_Q_SZ_VER4: c_int = 32768;
pub const SAP_M2H_NOTIF_Q_SZ: c_int = 62720;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mei_shared_mem_ptrs {
    pub ctrl: *mut iwl_sap_shared_mem_ctrl_blk,
    pub q_head: [*mut c_void; SAP_DIRECTION_MAX][SAP_QUEUE_IDX_MAX],
    pub q_size: [usize; SAP_DIRECTION_MAX][SAP_QUEUE_IDX_MAX],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mei_filters {
    pub rcu_head: rcu_head,
    pub filters: iwl_sap_oob_filters,
}
...
#[derive(Copy, Clone)]
pub struct iwl_mei {
    pub get_nvm_wq: wait_queue_head_t,
    pub send_csa_msg_wk: work_struct,
    pub get_ownership_wq: wait_queue_head_t,
    pub shared_mem: iwl_mei_shared_mem_ptrs,
    pub cldev: *mut mei_cl_device,
    pub nvm: *mut iwl_mei_nvm,
    pub filters: *mut iwl_mei_filters __rcu,
    pub got_ownership: bool,
    pub amt_enabled: bool,
    pub csa_throttled: bool,
    pub csme_taking_ownership: bool,
    pub link_prot_state: bool,
    pub device_down: bool,
    pub csa_throttle_end_wk: delayed_work,
    pub pldr_wq: wait_queue_head_t,
    pub pldr_active: bool,
    pub data_q_lock: spinlock_t,
    pub netdev_work: work_struct,
    pub ownership_dwork: delayed_work,
    pub sap_seq_no: core::sync::atomic::AtomicI32,
    pub seq_no: core::sync::atomic::AtomicI32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_mei_cache {
    pub ops: *const iwl_mei_ops,
    pub netdev: *mut net_device __rcu,
    pub conn_info: *const iwl_sap_notif_connection_info,
    pub power_limit: *const __le16,
    pub rf_kill: u32,
    pub mcc: u16,
    pub mac_address: [u8; 6],
    pub nvm_address: [u8; 6],
    pub sap_version: enum iwl_mei_sap_version,
    pub priv: *mut c_void,
}
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_free_shared_mem(cldev: *mut mei_cl_device) {
...
pub const HBM_DMA_BUF_ID_WLAN: c_int = 1;
    ...
    if (IS_ERR(mem.ctrl)) {
    let mut ret: c_int = PTR_ERR(mem.ctrl);
    mem.ctrl = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_alloc_shared_mem(cldev: *mut mei_cl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_init_shared_mem(mei: *mut iwl_mei) {
...
// (__le32 *)q_head = cpu_to_le32(SAP_CONTROL_BLOCK_ID);
    ...
    u32 q_sz)
    {
    let mut rd: u32 = le32_to_cpu(READ_ONCE(notif_q.rd_ptr));
    let mut wr: u32 = le32_to_cpu(READ_ONCE(notif_q.wr_ptr));
    size_t room_in_buf;
    let mut tx_sz: usize = sizeof(*hdr) + le16_to_cpu(hdr.len);
    if (rd > q_sz || wr > q_sz) {
    dev_err(&cldev.dev,
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_host_to_me_data_pending(mei: *const iwl_mei) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_send_check_shared_area(cldev: *mut mei_cl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_csa_throttle_end_wk(wk: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_add_data_to_ring(skb: *mut sk_buff, cb_tx: bool) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_send_csa_msg_wk(wk: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_rx_handler(pskb: *mut sk_buff) -> rx_handler_result_t {
    ...
    let mut rx_for_csme: bool = false;
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_netdev_work(wk: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_set_init_conf(mei: *mut iwl_mei) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: iwl_mei_cache.ops) -> else {
...
// We can now start the connection, unblock rfkill
    ...
    const struct iwl_sap_hdr *hdr)
    {
    let mut len: u16 = le16_to_cpu(hdr.len) + sizeof(*hdr);
    let mut type: u16 = le16_to_cpu(hdr.type);
    dev_dbg(&cldev.dev,
...
// _rd = rd;
    ...
    len);
    iwl_mei_read_from_q(q_head, q_sz, &rd, wr, core::ptr::null_mut(), len);
    continue;
    }
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_handle_check_shared_area(cldev: *mut mei_cl_device) {
...
//
    iwl_mei_handle_sap_rx(cldev, notif_q, q_head, core::ptr::null_mut(), q_sz);
    mutex_lock(&iwl_mei_mutex);
    dir = &mei.shared_mem.ctrl.dir[SAP_DIRECTION_ME_TO_HOST];
    notif_q = &dir.q_ctrl_blk[SAP_QUEUE_IDX_DATA];
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_rx(cldev: *mut mei_cl_device) {
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_send_start(cldev: *mut mei_cl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_enable(cldev: *mut mei_cl_device) -> c_int {
    ...
    {
    struct iwl_mei_nvm *nvm = core::ptr::null_mut();
    struct iwl_mei *mei;
    int ret;
    mutex_lock(&iwl_mei_mutex);
    if (!iwl_mei_is_connected())
...
pub const IWL_MEI_PLDR_NUM_RETRIES: c_int = 3;
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_pldr_req() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_get_ownership() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_alive_notif(success: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_host_disassociated() {
    ...
    out:
    kfree(iwl_mei_cache.conn_info);
    iwl_mei_cache.conn_info = core::ptr::null_mut();
    mutex_unlock(&iwl_mei_mutex);
    }
    EXPORT_SYMBOL_GPL(iwl_mei_host_disassociated);
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_set_rfkill_state(hw_rfkill: bool, sw_rfkill: bool) {
    void iwl_mei_set_rfkill_state(bool hw_rfkill, bool sw_rfkill)
    {
    struct iwl_mei *mei;
    let mut rfkill_state: u32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_set_nic_info(mac_address: *const u8, nvm_address: *const u8) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_set_country_code(mcc: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_set_power_limit(power_limit: *const __le16) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_set_netdev(netdev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_device_state(up: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_register(priv: *mut c_void, ops: *const iwl_mei_ops) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_start_unregister() {
...
// At this point, the wifi driver should have removed the netdev
    ...
    iwl_mei_cache.conn_info = core::ptr::null_mut();
    kfree(iwl_mei_cache.power_limit);
    iwl_mei_cache.power_limit = core::ptr::null_mut();
    iwl_mei_cache.ops = core::ptr::null_mut();
// leave iwl_mei_cache.priv non-NULL to prevent any new registration
    mutex_unlock(&iwl_mei_mutex);
    }
    EXPORT_SYMBOL_GPL(iwl_mei_start_unregister);
#[no_mangle]
pub unsafe extern "C" fn iwl_mei_unregister_complete() {
    void iwl_mei_unregister_complete(void)
    {
    mutex_lock(&iwl_mei_mutex);
    iwl_mei_cache.priv = core::ptr::null_mut();
    if (iwl_mei_global_cldev) {
    struct iwl_mei *mei =
    mei_cldev_get_drvdata(iwl_mei_global_cldev);
    if (mei.amt_enabled)
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_dbgfs_register(mei: *mut iwl_mei) {
    static void iwl_mei_dbgfs_register(struct iwl_mei *mei)
    {
    mei.dbgfs_dir = debugfs_create_dir(KBUILD_MODNAME, core::ptr::null_mut());
    if (!mei.dbgfs_dir)
    return;
...
#[no_mangle]
unsafe extern "C" fn iwl_mei_ownership_dwork(wk: *mut work_struct) {
    static void iwl_mei_ownership_dwork(struct work_struct *wk)
    {
    iwl_mei_get_ownership();
    }
pub const ALLOC_SHARED_MEM_RETRY_MAX_NUM: c_int = 3;
//
...
//
    ...
    {
    let mut alloc_retry: c_int = ALLOC_SHARED_MEM_RETRY_MAX_NUM;
    struct iwl_mei *mei;
    int ret;
...
// must be last
    ...
    free:
    mei_cldev_set_drvdata(cldev, core::ptr::null_mut());
    devm_kfree(&cldev.dev, mei);
    return ret;
    }
pub const SEND_SAP_MAX_WAIT_ITERATION: c_int = 10;
pub const IWLMEI_DEVICE_DOWN_WAIT_ITERATION: c_int = 50;
#[no_mangle]
unsafe extern "C" fn iwl_mei_remove(cldev: *mut mei_cl_device) {
...
//
    ...
    let mut iter: c_uint = IWLMEI_DEVICE_DOWN_WAIT_ITERATION;
...
//
    ...
    wake_up_all(&mei.pldr_wq);
    mutex_lock(&iwl_mei_mutex);
    iwl_mei_global_cldev = core::ptr::null_mut();
    wake_up_all(&mei.get_nvm_wq);
    iwl_mei_free_shared_mem(cldev);
    iwl_mei_dbgfs_unregister(mei);
    mei_cldev_set_drvdata(cldev, core::ptr::null_mut());
