...
//! Source: drivers/net/wireless/intel/iwlwifi/mei/sap.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_me_msg_start {
    pub hdr: iwl_sap_me_msg_hdr,
    pub shared_mem: __le64,
    pub init_data_seq_num: __le16,
    pub init_notif_seq_num: __le16,
    pub supported_versions: [u8; 64],
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_me_msg_start_ok {
    pub hdr: iwl_sap_me_msg_hdr,
    pub init_data_seq_num: __le16,
    pub init_notif_seq_num: __le16,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_sap_wifi_auth_type {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_sap_wifi_cipher_alg {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_notif_connection_info {
    pub ssid_len: __le32,
    pub ssid: [u8; 32],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_notif_conn_status {
    pub hdr: iwl_sap_hdr,
    pub link_prot_state: __le32,
    pub scan_request: __le32,
    pub conn_info: iwl_sap_notif_connection_info,
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_sap_radio_state_bitmap {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_sap_notif_host_suspends_bitmap {
    SAP_OFFER_NIC		= 1 << 0,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_notif_country_code {
    pub hdr: iwl_sap_hdr,
    pub mcc: __le16,
    pub source_id: u8,
    pub reserved: u8,
    pub diff_time: __le32,
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_notif_host_link_up {
    pub hdr: iwl_sap_hdr,
    pub conn_info: iwl_sap_notif_connection_info,
    pub colloc_channel: u8,
    pub colloc_band: u8,
    pub reserved: __le16,
    pub colloc_bssid: [u8; 6],
    pub reserved1: __le16,
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_sap_notif_link_down_type {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_notif_host_link_down {
    pub hdr: iwl_sap_hdr,
    pub type: u8,
    pub reserved: [u8; 2],
    pub reason_valid: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_notif_host_nic_info {
    pub hdr: iwl_sap_hdr,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_notif_sar_limits {
    pub hdr: iwl_sap_hdr,
    pub sar_chain_info_table: [__le16; 2][5],
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_nvm {
    pub hdr: iwl_sap_hdr,
    pub hw_addr: [u8; 6],
    pub n_hw_addrs: u8,
    pub reserved: u8,
    pub radio_cfg: __le32,
    pub caps: __le32,
    pub nvm_version: __le32,
    pub channels: [__le32; 110],
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_sap_eth_filter_flags {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_sap_flex_filter_flags {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_flex_filter {
    pub src_port: __be16,
    pub dst_port: __be16,
    pub flags: u8,
    pub reserved: u8,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_sap_ipv4_filter_flags {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_ipv4_filter {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_sap_ipv6_filter_flags {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_ipv6_filter {
    pub addr_lo24: [u8; 3],
    pub flags: u8,
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_sap_icmpv6_filter_flags {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum iwl_sap_vlan_filter_flags {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_oob_filters {
    pub flex_filters: [iwl_sap_flex_filter; 14],
    pub icmpv6_flags: __le32,
    pub ipv6_filters: [iwl_sap_ipv6_filter; 4],
    pub eth_filters: [iwl_sap_eth_filter; 5],
    pub reserved: u8,
    pub ipv4_filter: iwl_sap_ipv4_filter,
    pub vlan: [__le16; 4],
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_csme_filters {
    pub hdr: iwl_sap_hdr,
    pub mode: __le32,
    pub mac_address: [u8; 6],
    pub reserved: __le16,
    pub cbfilters: [u8; 1728],
    pub filters: iwl_sap_oob_filters,
    pub __packed: },
pub const CB_TX_DHCP_FILT_IDX: c_int = 30;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_cb_data {
    pub hdr: iwl_sap_hdr,
    pub reserved: [__le32; 7],
    pub to_me_filt_status: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_pldr_end_data {
    pub hdr: iwl_sap_hdr,
    pub version: __le32,
    pub status: __le32,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_sap_pldr_ack_data {
    pub hdr: iwl_sap_hdr,
    pub version: __le32,
    pub status: __le32,
    pub __packed: },
