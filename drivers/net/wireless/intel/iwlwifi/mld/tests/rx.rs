...
//! Source: drivers/net/wireless/intel/iwlwifi/mld/tests/rx.c
#![no_std]
...
// Driver will use tid = IWL_MAX_TID_COUNT
    ...
    let mut tid: u8 = param.dup_data_state.tid;
...
// Initialize dup data, see iwl_mld_alloc_dup_data
    ...
    {
    let mut tid: u8 = param.rx_pkt.tid;
...
#[no_mangle]
unsafe extern "C" fn test_is_dup(test: *mut kunit) {
    static void test_is_dup(struct kunit *test)
    {
    const struct is_dup_case *param = (const void *)(test.param_value);
    struct iwl_mld *mld = test.priv;
    let mut mpdu_desc: iwl_rx_mpdu_desc = { };
