...
//! Source: drivers/net/wireless/intel/iwlwifi/mld/tests/link.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fake_ieee80211_connection_loss(vif: *mut ieee80211_vif) {
    static void fake_ieee80211_connection_loss(struct ieee80211_vif *vif)
    {
    vif.cfg.assoc = false;
    }
#[no_mangle]
unsafe extern "C" fn test_missed_beacon(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dup_beacon_test_case {
    pub desc: *const c_char,
    pub bandwidth: enum nl80211_chan_width,
    pub has_he_oper: bool,
    pub dup_beacon_bit: bool,
    pub expected_adj: i8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct psd_eirp_test_case {
    pub desc: *const c_char,
    pub chandef: *const cfg80211_chan_def,
    pub power_type: enum ieee80211_ap_reg_power,
    struct {
    pub psd_20: i8,
    pub psd_oper: i8,
    pub eirp_20: i8,
    ...
    pub expected_adj: i8,
    struct {
    pub no_psd_data: bool,
    pub no_eirp_data: bool,
    pub no_reg_psd_data: bool,
    pub has_partial_psd: bool,
    pub psd_partial_count: u8,
    pub non_uniform_psd: bool,
    pub has_unusable_channels: bool,
    pub flags: },
}
...
// Set remaining subchannels
    ...
    {
    int i;
    let mut count: c_int = ilog2(num_subchannels) + 1;
...
#[no_mangle]
unsafe extern "C" fn test_dup_beacon_rssi_adjust(test: *mut kunit) {
    ...
    struct element *he_elem = core::ptr::null_mut();
    s8 result;
    ...
    let mut he_6ghz: ieee80211_he_6ghz_oper = {};
...
#[no_mangle]
unsafe extern "C" fn test_psd_eirp_rssi_adjust(test: *mut kunit) {
