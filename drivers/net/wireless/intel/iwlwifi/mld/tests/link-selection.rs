...
//! Source: drivers/net/wireless/intel/iwlwifi/mld/tests/link-selection.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct link_grading_input {
    pub link_id: u8,
    pub chandef: *const cfg80211_chan_def,
    pub active: bool,
    pub signal: i32,
    pub has_chan_util_elem: bool,
    pub chan_util: u8,
    pub chan_load_by_us: u8,
    pub dup_beacon_adj: i8,
    pub psd_eirp_adj: i8,
    pub punctured: u16,
}
...
#[no_mangle]
unsafe extern "C" fn fake_psd_eirp_rssi_adjust(link_conf: *mut ieee80211_bss_conf) -> i8 {
...
#[no_mangle]
unsafe extern "C" fn setup_link(link: *mut ieee80211_bss_conf) {
    ...
    &bss_load,
    sizeof(bss_load));
    let mut elem_len: c_uint = sizeof(*elem) + sizeof(bss_load);
...
#[no_mangle]
unsafe extern "C" fn test_link_grading(test: *mut kunit) {
    ...
    let mut link_id: u8 = test_param.link.link_id;
    let mut active: bool = test_param.link.active;
    u16 valid_links;
...
#[no_mangle]
unsafe extern "C" fn test_iwl_mld_link_pair_allows_emlsr(test: *mut kunit) {
