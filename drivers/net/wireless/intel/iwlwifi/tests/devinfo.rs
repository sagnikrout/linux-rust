...
//! Source: drivers/net/wireless/intel/iwlwifi/tests/devinfo.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn iwl_pci_print_dev_info(pfx: *const c_char, di: *const iwl_dev_info) {
    static void iwl_pci_print_dev_info(const char *pfx, const struct iwl_dev_info *di)
    {
    let mut subdevice_mask: u16 = GENMASK(di.subdevice_m_h, di.subdevice_m_l);
    char buf[100] = {};
    let mut pos: c_int = 0;
    if (di.match_rf_type)
...
#[no_mangle]
unsafe extern "C" fn devinfo_table_order(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn devinfo_discrete_match(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn devinfo_names(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn devinfo_no_cfg_dups(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn devinfo_no_name_dups(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn devinfo_check_subdev_match(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn devinfo_check_killer_subdev(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn devinfo_pci_ids(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn devinfo_no_mac_cfg_dups(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn devinfo_api_range(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn devinfo_pci_ids_config(test: *mut kunit) {
...
//
    ...
    0, 0, 0, 0, true);
    KUNIT_EXPECT_PTR_NE_MSG(test, di, core::ptr::null_mut(),
