...
//! Source: drivers/net/wireless/intel/iwlwifi/pcie/ctxt-info.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_ctxt_info_free_paging(trans: *mut iwl_trans) {
...
// access FW with +2 to make up for lmac & umac separators
    let mut fw_idx: c_int = dram.fw_cnt + i + 2;
    ...
    let mut control_flags: u32 = 0, rb_size, cb_size;
    dma_addr_t phys;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_ctxt_info_free(trans: *mut iwl_trans) {
    ...
    trans_pcie.ctxt_info = core::ptr::null_mut();
