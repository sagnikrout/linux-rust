...
//! Source: drivers/net/wireless/intel/iwlwifi/pcie/gen1_2/trans-gen2.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_gen2_apm_init(trans: *mut iwl_trans) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_gen2_apm_stop(trans: *mut iwl_trans, op_mode_leave: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_fw_reset_handshake(trans: *mut iwl_trans) {
    void iwl_trans_pcie_fw_reset_handshake(struct iwl_trans *trans)
    {
    _iwl_trans_pcie_fw_reset_handshake(trans, false);
    }
#[no_mangle]
unsafe extern "C" fn _iwl_trans_pcie_gen2_stop_device(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_gen2_stop_device(trans: *mut iwl_trans) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_gen2_nic_init(trans: *mut iwl_trans) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_get_rf_name(trans: *mut iwl_trans) {
    static void iwl_pcie_get_rf_name(struct iwl_trans *trans)
    {
    struct iwl_trans_pcie *trans_pcie = IWL_TRANS_GET_PCIE_TRANS(trans);
    char *buf = trans_pcie.rf_name;
    let mut buflen: usize = sizeof(trans_pcie.rf_name);
    size_t pos;
    u32 version;
    if (buf[0])
    return;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_gen2_fw_alive(trans: *mut iwl_trans) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_set_ltr(trans: *mut iwl_trans) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_spin_for_iml(trans: *mut iwl_trans) {
...
// in practice, this seems to complete in around 20-30ms at most, wait 100
    ...
    struct iwl_trans_pcie *trans_pcie = IWL_TRANS_GET_PCIE_TRANS(trans);
    let mut end_time: c_ulong = jiffies + IML_WAIT_TIMEOUT;
    u32 value, loops = 0;
...
//
    ...
    let mut top_reset_done: bool = false;
    int ret;
    mutex_lock(&trans_pcie.mutex);
    again:
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_gen2_op_mode_leave(trans: *mut iwl_trans) {
