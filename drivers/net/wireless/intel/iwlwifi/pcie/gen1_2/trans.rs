...
//! Source: drivers/net/wireless/intel/iwlwifi/pcie/gen1_2/trans.c
#![no_std]
...
pub const IWL_HOST_MON_BLOCK_PEMON: c_uint = 0x00;
pub const IWL_HOST_MON_BLOCK_HIPM: c_uint = 0x22;
pub const IWL_HOST_MON_BLOCK_PEMON_VEC0: c_uint = 0x00;
pub const IWL_HOST_MON_BLOCK_PEMON_VEC1: c_uint = 0x01;
pub const IWL_HOST_MON_BLOCK_PEMON_WFPM: c_uint = 0x06;
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_dump_host_monitor(trans: *mut iwl_trans) {
...
pub const IWL_FW_MEM_EXTENDED_START: c_uint = 0x40000;
pub const IWL_FW_MEM_EXTENDED_END: c_uint = 0x57FFF;
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_sw_reset(trans: *mut iwl_trans, retake_ownership: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_free_fw_monitor(trans: *mut iwl_trans) {
    ...
    fw_mon.physical);
    fw_mon.block = core::ptr::null_mut();
    fw_mon.physical = 0;
    fw_mon.size = 0;
    }
    ...
    {
    struct iwl_dram_data *fw_mon = &trans.dbg.fw_mon;
    void *block = core::ptr::null_mut();
    let mut physical: dma_addr_t = 0;
    let mut size: u32 = 0;
    u8 power;
    if (fw_mon.size) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_alloc_fw_monitor(trans: *mut iwl_trans, max_power: u8) {
...
#[no_mangle]
unsafe extern "C" fn iwl_trans_pcie_read_shr(trans: *mut iwl_trans, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn iwl_trans_pcie_write_shr(trans: *mut iwl_trans, reg: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_set_pwr(trans: *mut iwl_trans, vaux: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_apm_config(trans: *mut iwl_trans) {
...
//
#[no_mangle]
unsafe extern "C" fn iwl_pcie_apm_init(trans: *mut iwl_trans) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iwl_pcie_apm_lp_xtal_enable(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_apm_stop_master(trans: *mut iwl_trans) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_apm_stop(trans: *mut iwl_trans, op_mode_leave: bool) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_nic_init(trans: *mut iwl_trans) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_set_hw_ready(trans: *mut iwl_trans) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_prepare_card_hw(trans: *mut iwl_trans) -> c_int {
...
//
    ...
    let mut extended_addr: bool = false;
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_apply_destination_ini(trans: *mut iwl_trans) {
    static void iwl_pcie_apply_destination_ini(struct iwl_trans *trans)
    {
    let mut alloc_id: enum iwl_fw_ini_allocation_id = IWL_FW_INI_ALLOCATION_ID_DBGC1;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_apply_destination(trans: *mut iwl_trans) {
    ...
    let mut addr: u32 = le32_to_cpu(dest.reg_ops[i].addr);
    let mut val: u32 = le32_to_cpu(dest.reg_ops[i].val);
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_check_hw_rf_kill(trans: *mut iwl_trans) -> bool {
    bool iwl_pcie_check_hw_rf_kill(struct iwl_trans *trans)
    {
    struct iwl_trans_pcie *trans_pcie =  IWL_TRANS_GET_PCIE_TRANS(trans);
    let mut hw_rfkill: bool = iwl_is_rfkill_set(trans);
    let mut prev: bool = test_bit(STATUS_RFKILL_OPMODE, &trans.status);
    bool report;
    if (hw_rfkill) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_map_non_rx_causes(trans: *mut iwl_trans) {
    static void iwl_pcie_map_non_rx_causes(struct iwl_trans *trans)
    {
    struct iwl_trans_pcie *trans_pcie =  IWL_TRANS_GET_PCIE_TRANS(trans);
    let mut val: c_int = trans_pcie.def_irq | MSIX_NON_AUTO_CLEAR_CAUSE;
//
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_map_rx_causes(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_conf_msix_hw(trans_pcie: *mut iwl_trans_pcie) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_init_msix(trans_pcie: *mut iwl_trans_pcie) {
...
#[no_mangle]
unsafe extern "C" fn _iwl_trans_pcie_stop_device(trans: *mut iwl_trans, from_irq: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_synchronize_irqs(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_fw_alive(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_stop_device(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_rf_kill(trans: *mut iwl_trans, state: bool, from_irq: bool) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_d3_handshake(trans: *mut iwl_trans, suspend: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_d3_suspend(trans: *mut iwl_trans, reset: bool) -> c_int {
...
//
    ...
    u16 pci_cmd;
    let mut max_rx_queues: u32 = IWL_MAX_RX_HW_QUEUES;
...
#[no_mangle]
unsafe extern "C" fn iwl_trans_pcie_clear_persistence_bit(trans: *mut iwl_trans) -> c_int {
    ...
    let mut wprot_val: u32 = iwl_read_umac_prph_no_grab(trans, wprot);
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_gen2_force_power_gating(trans: *mut iwl_trans) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn _iwl_trans_pcie_start_hw(trans: *mut iwl_trans) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_start_hw(trans: *mut iwl_trans) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_op_mode_leave(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_write8(trans: *mut iwl_trans, ofs: u32, val: u8) {
    void iwl_trans_pcie_write8(struct iwl_trans *trans, u32 ofs, u8 val)
    {
    writeb(val, IWL_TRANS_GET_PCIE_TRANS(trans).hw_base + ofs);
    }
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_write32(trans: *mut iwl_trans, ofs: u32, val: u32) {
    void iwl_trans_pcie_write32(struct iwl_trans *trans, u32 ofs, u32 val)
    {
    writel(val, IWL_TRANS_GET_PCIE_TRANS(trans).hw_base + ofs);
    }
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_read32(trans: *mut iwl_trans, ofs: u32) -> u32 {
    u32 iwl_trans_pcie_read32(struct iwl_trans *trans, u32 ofs)
    {
    return readl(IWL_TRANS_GET_PCIE_TRANS(trans).hw_base + ofs);
    }
#[no_mangle]
unsafe extern "C" fn iwl_trans_pcie_prph_msk(trans: *mut iwl_trans) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_read_prph(trans: *mut iwl_trans, reg: u32) -> u32 {
    u32 iwl_trans_pcie_read_prph(struct iwl_trans *trans, u32 reg)
    {
    let mut mask: u32 = iwl_trans_pcie_prph_msk(trans);
    iwl_trans_pcie_write32(trans, HBUS_TARG_PRPH_RADDR,
    ((reg & mask) | (3 << 24)));
    return iwl_trans_pcie_read32(trans, HBUS_TARG_PRPH_RDAT);
    }
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_write_prph(trans: *mut iwl_trans, addr: u32, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_gen1_2_op_mode_enter(trans: *mut iwl_trans) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_free_invalid_tx_cmd(trans: *mut iwl_trans) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_alloc_invalid_tx_cmd(trans: *mut iwl_trans) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_free(trans: *mut iwl_trans) {
    ...
    trans_pcie.rba.alloc_wq = core::ptr::null_mut();
    }
    if (trans_pcie.msix_enabled) {
    for (i = 0; i < trans_pcie.alloc_vecs; i++) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_check_product_reset_mode(pdev: *mut pci_dev) {
    ...
    {
    union acpi_object *res;
    let mut mode: u16 = enable ? DSM_INTERNAL_PLDR_MODE_EN_PROD_RESET : 0;
    if (!integrated)
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_check_product_reset_status(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn iwl_trans_pcie_call_reset(pdev: *mut pci_dev) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_trans_pcie_removal {
    pub pdev: *mut pci_dev,
    pub work: work_struct,
    pub mode: enum iwl_reset_mode,
    pub integrated: bool,
}

#[no_mangle]
unsafe extern "C" fn iwl_trans_pcie_removal_wk(wk: *mut work_struct) {
    static void iwl_trans_pcie_removal_wk(struct work_struct *wk)
    {
    struct iwl_trans_pcie_removal *removal =
    container_of(wk, struct iwl_trans_pcie_removal, work);
    struct pci_dev *pdev = removal.pdev;
    static char *prop[] = {"EVENT=INACCESSIBLE", core::ptr::null_mut()};
    struct pci_bus *bus;
...
// in this case, something else already removed the device
    ...
    struct pci_dev *bt = core::ptr::null_mut();
    if (!removal.integrated) {
// discrete devices have WiFi/BT at function 0/1
    let mut slot: c_int = PCI_SLOT(pdev.devfn);
    let mut func: c_int = PCI_FUNC(pdev.devfn);
    if (func == 0)
...
// on integrated we have to look up by ID (same bus)
    ...
    struct pci_dev *tmp = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_reset(trans: *mut iwl_trans, mode: enum iwl_reset_mode) {
    void iwl_trans_pcie_reset(struct iwl_trans *trans, enum iwl_reset_mode mode)
    {
    struct iwl_trans_pcie *trans_pcie = IWL_TRANS_GET_PCIE_TRANS(trans);
    struct iwl_trans_pcie_removal *removal;
    let mut _msg: c_char = 0, *msg = &_msg;
...
//
#[no_mangle]
pub unsafe extern "C" fn _iwl_trans_pcie_grab_nic_access(trans: *mut iwl_trans, silent: bool) -> bool {
    bool _iwl_trans_pcie_grab_nic_access(struct iwl_trans *trans, bool silent)
    {
    int ret;
    struct iwl_trans_pcie *trans_pcie = IWL_TRANS_GET_PCIE_TRANS(trans);
    let mut write: u32 = CSR_GP_CNTRL_REG_FLAG_MAC_ACCESS_REQ;
    u32 mask = CSR_GP_CNTRL_REG_FLAG_MAC_CLOCK_READY |
    CSR_GP_CNTRL_REG_FLAG_GOING_TO_SLEEP;
    let mut poll: u32 = CSR_GP_CNTRL_REG_VAL_MAC_ACCESS_EN;
    if (test_bit(STATUS_TRANS_DEAD, &trans.status))
    return false;
...
//
    ...
    if (unlikely(ret)) {
    let mut cntrl: u32 = iwl_read32(trans, CSR_GP_CNTRL);
    if (silent) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_grab_nic_access(trans: *mut iwl_trans) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_resched_with_nic_access(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn __releases(_arg: nic_access_nobh) {
...
//
    ...
    void *buf, int dwords)
    {
pub const IWL_MAX_HW_ERRS: c_int = 5;
    let mut num_consec_hw_errors: c_uint = 0;
    let mut offs: c_int = 0;
    u32 *vals = buf;
    while (offs < dwords) {
// limit the time we spin here under lock to 1/2s
    let mut end: c_ulong = jiffies + HZ / 2;
...
pub const IWL_FLUSH_WAIT_MS: c_int = 2000;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_wait_txq_empty(trans: *mut iwl_trans, txq_idx: c_int) -> c_int {
...
// Make sure the NIC is still alive in the bus
    ...
    let mut write_ptr: c_int = READ_ONCE(txq.write_ptr);
//
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_wait_txqs_empty(trans: *mut iwl_trans, txq_bm: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_dump_csr(trans: *mut iwl_trans) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_dbgfs_tx_queue_priv {
    pub trans: *mut iwl_trans,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct iwl_dbgfs_tx_queue_state {
    pub pos: loff_t,
}
...
#[no_mangle]
unsafe extern "C" fn iwl_dbgfs_tx_queue_seq_stop(seq: *mut seq_file, v: *mut c_void) {
    static void iwl_dbgfs_tx_queue_seq_stop(struct seq_file *seq, void *v)
    {
    kfree(v);
    }
#[no_mangle]
unsafe extern "C" fn iwl_dbgfs_tx_queue_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_dbgfs_tx_queue_open(inode: *mut inode, filp: *mut file) -> c_int {
    ...
    rxq.free_count);
    if (rxq.rb_stts) {
    let mut r: u32 = iwl_get_closed_rb_stts(trans, rxq);
    ...
    {
    let mut buf_size_left: isize = count - *bytes_copied;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_dbgfs_register(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_debugfs_cleanup(trans: *mut iwl_trans) {
...
#[no_mangle]
unsafe extern "C" fn iwl_trans_pcie_get_cmdlen(trans: *mut iwl_trans, tfd: *mut c_void) -> u32 {
    static u32 iwl_trans_pcie_get_cmdlen(struct iwl_trans *trans, void *tfd)
    {
    struct iwl_trans_pcie *trans_pcie = IWL_TRANS_GET_PCIE_TRANS(trans);
    let mut cmdlen: u32 = 0;
    int i;
    ...
    {
    struct iwl_trans_pcie *trans_pcie = IWL_TRANS_GET_PCIE_TRANS(trans);
    let mut max_len: c_int = trans_pcie.rx_buf_bytes;
...
// data = iwl_fw_error_next_data(*data);
    ...
    struct iwl_fw_error_dump_data **data)
    {
    let mut csr_len: u32 = sizeof(**data) + IWL_CSR_TO_DUMP;
    __le32 *val;
    int i;
...
// data = iwl_fw_error_next_data(*data);
    ...
    struct iwl_fw_error_dump_data **data)
    {
    let mut fh_regs_len: u32 = FH_MEM_UPPER_BOUND - FH_MEM_LOWER_BOUND;
    __le32 *val;
    int i;
    if (!iwl_trans_grab_nic_access(trans))
    return 0;
...
// data = iwl_fw_error_next_data(*data);
    ...
    u32 monitor_len)
    {
    let mut buf_size_in_dwords: u32 = (monitor_len >> 2);
...
// convert wrtPtr to DWs, to align with all HWs
    ...
    let mut base: u32 = le32_to_cpu(fw_mon_data.fw_mon_base_ptr);
//
...
#[no_mangle]
unsafe extern "C" fn iwl_trans_get_fw_monitor_len(trans: *mut iwl_trans, len: *mut u32) -> c_int {
...
// Paged memory for gen2 HW
    ...
    if (dump_mask & BIT(IWL_FW_ERROR_DUMP_TXCMD) && cmdq) {
    let mut tfd_size: u16 = trans_pcie.txqs.tfd.size;
    data.type = cpu_to_le32(IWL_FW_ERROR_DUMP_TXCMD);
    txcmd = (void *)data.data;
    spin_lock_bh(&cmdq.lock);
    ptr = cmdq.write_ptr;
    for (i = 0; i < cmdq.n_window; i++) {
    let mut idx: u8 = iwl_txq_get_cmd_index(cmdq, ptr);
    u8 tfdidx;
    u32 caplen, cmdlen;
    if (trans.mac_cfg.gen2)
    tfdidx = idx;
...
// Paged memory for gen2 HW
    ...
    let mut page_len: u32 = trans.init_dram.paging[i].size;
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pci_interrupts(trans: *mut iwl_trans, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_trans_pcie_sync_nmi(trans: *mut iwl_trans) {
...
#[no_mangle]
unsafe extern "C" fn iwl_trans_pcie_alloc_txcmd_pool(trans: *mut iwl_trans) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IWL_DEVICE_FAMILY_AX210: trans->mac_cfg->device_family >=) -> else {
    else if (trans.mac_cfg.device_family >= IWL_DEVICE_FAMILY_AX210)
...
//
    ...
    {
    let mut ret: c_int = 0;
    let mut val: u32 = info.hw_crf_id;
    let mut step_id: u32 = REG_CRF_ID_STEP(val);
    let mut slave_id: u32 = REG_CRF_ID_SLAVE(val);
    u32 hw_wfpm_id = iwl_read_umac_prph_no_grab(iwl_trans,
    WFPM_OTP_CFG1_ADDR);
    let mut cdb_id_wfpm: u32 = WFPM_OTP_CFG1_IS_CDB(hw_wfpm_id);
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_recheck_me_status(wk: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_check_me_status(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_gen1_2_remove(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_gen1_2_activate_nic(trans: *mut iwl_trans) -> c_int {
