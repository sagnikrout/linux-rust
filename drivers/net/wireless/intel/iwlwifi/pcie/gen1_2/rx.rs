...
//! Source: drivers/net/wireless/intel/iwlwifi/pcie/gen1_2/rx.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn iwl_rxq_space(rxq: *const iwl_rxq) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_dma_addr2rbd_ptr(dma_addr: dma_addr_t) -> __le32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_rx_stop(trans: *mut iwl_trans) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IWL_DEVICE_FAMILY_BZ: trans->mac_cfg->device_family >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_rxq_check_wrptr(trans: *mut iwl_trans) {
...
//
    static
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_rxq_restock(trans: *mut iwl_trans, rxq: *mut iwl_rxq) {
...
//
    ...
    {
    struct iwl_trans_pcie *trans_pcie = IWL_TRANS_GET_PCIE_TRANS(trans);
    let mut allocsize: c_uint = PAGE_SIZE << trans_pcie.rx_page_order;
    let mut rbsize: c_uint = trans_pcie.rx_buf_bytes;
    struct page *page;
    let mut gfp_mask: gfp_t = priority;
...
// offset = trans_pcie->alloc_page_used;
    ...
    trans_pcie.alloc_page = core::ptr::null_mut();
    else
    get_page(page);
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_free_rbs_pool(trans: *mut iwl_trans) {
    ...
    trans_pcie.rx_page_order);
    trans_pcie.rx_pool[i].page = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn iwl_pcie_rx_allocator(trans: *mut iwl_trans) {
    static void iwl_pcie_rx_allocator(struct iwl_trans *trans)
    {
    struct iwl_trans_pcie *trans_pcie = IWL_TRANS_GET_PCIE_TRANS(trans);
    struct iwl_rb_allocator *rba = &trans_pcie.rba;
    struct list_head local_empty;
    let mut pending: c_int = atomic_read(&rba.req_pending);
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_rx_allocator_work(data: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_free_bd_size(trans: *mut iwl_trans) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_used_bd_size(trans: *mut iwl_trans) -> c_int {
    ...
    struct iwl_rxq *rxq)
    {
    let mut free_size: c_int = iwl_pcie_free_bd_size(trans);
    if (rxq.bd)
    dma_free_coherent(trans.dev,
    free_size * rxq.queue_size,
    rxq.bd, rxq.bd_dma);
    rxq.bd_dma = 0;
    rxq.bd = core::ptr::null_mut();
    rxq.rb_stts_dma = 0;
    rxq.rb_stts = core::ptr::null_mut();
    if (rxq.used_bd)
    dma_free_coherent(trans.dev,
    ...
    rxq.used_bd_dma = 0;
    rxq.used_bd = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn iwl_pcie_rb_stts_size(trans: *mut iwl_trans) -> usize {
    ...
    {
    struct iwl_trans_pcie *trans_pcie = IWL_TRANS_GET_PCIE_TRANS(trans);
    let mut rb_stts_size: usize = iwl_pcie_rb_stts_size(trans);
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_rx_alloc(trans: *mut iwl_trans) -> c_int {
...
//
    ...
    trans_pcie.base_rb_stts,
    trans_pcie.base_rb_stts_dma);
    trans_pcie.base_rb_stts = core::ptr::null_mut();
    trans_pcie.base_rb_stts_dma = 0;
    }
    kfree(trans_pcie.rx_pool);
    trans_pcie.rx_pool = core::ptr::null_mut();
    kfree(trans_pcie.global_table);
    trans_pcie.global_table = core::ptr::null_mut();
    kfree(trans_pcie.rxq);
    trans_pcie.rxq = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn iwl_pcie_rx_hw_init(trans: *mut iwl_trans, rxq: *mut iwl_rxq) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_rx_mq_hw_init(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_rx_init_rxb_lists(rxq: *mut iwl_rxq) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_napi_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_napi_poll_msix(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_rx_napi_sync(trans: *mut iwl_trans) {
...
#[no_mangle]
unsafe extern "C" fn _iwl_pcie_rx_init(trans: *mut iwl_trans) -> c_int {
...
// free all first - we overwrite everything here
    ...
    def_rxq.queue[i] = core::ptr::null_mut();
    for (i = 0; i < trans.info.num_rxqs; i++) {
    struct iwl_rxq *rxq = &trans_pcie.rxq[i];
    spin_lock_bh(&rxq.lock);
//
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_rx_init(trans: *mut iwl_trans) -> c_int {
    int iwl_pcie_rx_init(struct iwl_trans *trans)
    {
    struct iwl_trans_pcie *trans_pcie = IWL_TRANS_GET_PCIE_TRANS(trans);
    let mut ret: c_int = _iwl_pcie_rx_init(trans);
    if (ret)
    return ret;
    if (trans.mac_cfg.mq_rx_supported)
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_gen2_rx_init(trans: *mut iwl_trans) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_rx_free(trans: *mut iwl_trans) {
...
//
    if (!trans_pcie.rxq) {
    IWL_DEBUG_INFO(trans, "Free core::ptr::null_mut() rx context\n");
    return;
    }
    cancel_work_sync(&rba.rx_alloc);
    iwl_pcie_free_rbs_pool(trans);
...
// Move the 2 RBDs to the allocator ownership.
    ...
    let mut page_stolen: bool = false;
...
//
    if (reclaim && txq) {
    let mut sequence: u16 = le16_to_cpu(pkt.hdr.sequence);
    let mut index: c_int = SEQ_TO_INDEX(sequence);
    let mut cmd_index: c_int = iwl_txq_get_cmd_index(txq, index);
    kfree_sensitive(txq.entries[cmd_index].free_buf);
    txq.entries[cmd_index].free_buf = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn iwl_pcie_rx_handle(trans: *mut iwl_trans, queue: c_int, budget: c_int) -> c_int {
    static int iwl_pcie_rx_handle(struct iwl_trans *trans, int queue, int budget)
    {
    struct iwl_trans_pcie *trans_pcie = IWL_TRANS_GET_PCIE_TRANS(trans);
    struct iwl_rxq *rxq;
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_irq_rx_msix_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn iwl_pcie_irq_handle_error(trans: *mut iwl_trans) {
...
// W/A for WiFi/WiMAX coex and WiMAX own the RF
    ...
    let mut val: u32 = iwl_read32(trans, CSR_IPC_STATE);
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_int_cause_non_ict(trans: *mut iwl_trans) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn iwl_pcie_int_cause_ict(trans: *mut iwl_trans) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_handle_rfkill_irq(trans: *mut iwl_trans, from_irq: bool) {
...
#[no_mangle]
unsafe extern "C" fn iwl_trans_pcie_handle_reset_interrupt(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(CSR_INT_BIT_FH_TX: handled &) -> else {
    else if (handled & CSR_INT_BIT_FH_TX)
    iwl_enable_fw_load_int(trans);
// Re-enable RF_KILL if it occurred
#[no_mangle]
pub unsafe extern "C" fn if(CSR_INT_BIT_RF_KILL: handled &) -> else {
    else if (handled & CSR_INT_BIT_RF_KILL)
    iwl_enable_rfkill_int(trans);
// Re-enable the ALIVE / Rx interrupt if it occurred
#[no_mangle]
pub unsafe extern "C" fn if(CSR_INT_BIT_FH_RX): handled & (CSR_INT_BIT_ALIVE |) -> else {
...
// Free dram table
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_free_ict(trans: *mut iwl_trans) {
    ...
    trans_pcie.ict_tbl = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_alloc_ict(trans: *mut iwl_trans) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_reset_ict(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_disable_ict(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_msix_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    irqreturn_t iwl_pcie_msix_isr(int irq, void *data)
    {
    return IRQ_WAKE_THREAD;
    }
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_irq_msix_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    struct iwl_trans *trans = trans_pcie.trans;
    struct isr_statistics *isr_stats = &trans_pcie.isr_stats;
    let mut inta_fh_msk: u32 = ~MSIX_FH_INT_CAUSES_DATA_QUEUE;
    u32 inta_fh, inta_hw;
    let mut polling: bool = false;
    bool sw_err;
