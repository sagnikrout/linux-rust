...
//! Source: drivers/net/wireless/intel/iwlwifi/pcie/ctxt-info-v2.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn iwl_is_force_scu_active_approved() -> bool {
...
// control_flags |= IWL_PRPH_SCRATCH_EARLY_DEBUG_EN | dbg_flags;
    ...
    let mut control_flags_ext: u32 = 0;
    int ret;
...
// Allocate IML
    ...
    trans_pcie.ctxt_info_dma_addr);
    trans_pcie.ctxt_info_v2 = core::ptr::null_mut();
    err_free_prph_info:
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_ctxt_info_v2_kick(trans: *mut iwl_trans) {
...
#[no_mangle]
pub unsafe extern "C" fn iwl_pcie_ctxt_info_v2_free(trans: *mut iwl_trans, alive: bool) {
    ...
    trans_pcie.iml = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_set_pnvm_segments(trans: *mut iwl_trans) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_set_contig_pnvm(trans: *mut iwl_trans) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_set_reduce_power_segments(trans: *mut iwl_trans) {
...
#[no_mangle]
unsafe extern "C" fn iwl_pcie_set_contig_reduce_power(trans: *mut iwl_trans) {
