...
//! Source: drivers/net/wireless/intel/ipw2x00/libipw_crypto_tkip.c
#![no_std]
...
pub const TKIP_HDR_LEN: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct libipw_tkip_data {
pub const TKIP_KEY_LEN: c_int = 32;
    pub key: [u8; TKIP_KEY_LEN],
    pub key_set: c_int,
    pub tx_iv32: u32,
    pub tx_iv16: u16,
    pub tx_ttak: [u16; 5],
    pub tx_phase1_done: c_int,
    pub rx_iv32: u32,
    pub rx_iv16: u16,
    pub rx_ttak: [u16; 5],
    pub rx_phase1_done: c_int,
    pub rx_iv32_new: u32,
    pub rx_iv16_new: u16,
    pub dot11RSNAStatsTKIPReplays: u32,
    pub dot11RSNAStatsTKIPICVErrors: u32,
    pub dot11RSNAStatsTKIPLocalMICFailures: u32,
    pub key_idx: c_int,
    pub rx_ctx_arc4: arc4_ctx,
    pub tx_ctx_arc4: arc4_ctx,
    pub flags: c_ulong,
}

#[no_mangle]
unsafe extern "C" fn libipw_tkip_set_flags(flags: c_ulong, priv: *mut c_void) -> c_ulong {
    static unsigned long libipw_tkip_set_flags(unsigned long flags, void *priv)
    {
    struct libipw_tkip_data *_priv = priv;
    let mut old_flags: c_ulong = _priv.flags;
    _priv.flags = flags;
    return old_flags;
    }
#[no_mangle]
unsafe extern "C" fn libipw_tkip_get_flags(priv: *mut c_void) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn libipw_tkip_deinit(priv: *mut c_void) {
    static void libipw_tkip_deinit(void *priv)
    {
    kfree_sensitive(priv);
    }
#[no_mangle]
pub unsafe extern "C" fn RotR1(val: u16) -> u16 {
    static inline u16 RotR1(u16 val)
    {
    return (val >> 1) | (val << 15);
    }
#[no_mangle]
pub unsafe extern "C" fn Lo8(val: u16) -> u8 {
    static inline u8 Lo8(u16 val)
    {
    return val & 0xff;
    }
#[no_mangle]
pub unsafe extern "C" fn Hi8(val: u16) -> u8 {
    static inline u8 Hi8(u16 val)
    {
    return val >> 8;
    }
#[no_mangle]
pub unsafe extern "C" fn Lo16(val: u32) -> u16 {
    static inline u16 Lo16(u32 val)
    {
    return val & 0xffff;
    }
#[no_mangle]
pub unsafe extern "C" fn Hi16(val: u32) -> u16 {
    static inline u16 Hi16(u32 val)
    {
    return val >> 16;
    }
#[no_mangle]
pub unsafe extern "C" fn Mk16(hi: u8, lo: u8) -> u16 {
    static inline u16 Mk16(u8 hi, u8 lo)
    {
    return lo | (((u16) hi) << 8);
    }
#[no_mangle]
pub unsafe extern "C" fn Mk16_le(v: *mut *mut __le16) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn _S_(v: u16) -> u16 {
    static inline u16 _S_(u16 v)
    {
    let mut t: u16 = Sbox[Hi8(v)];
    return Sbox[Lo8(v)] ^ ((t << 8) | (t >> 8));
    }
pub const PHASE1_LOOP_COUNT: c_int = 8;
...
// WEPSeed[0..2] is transmitted as WEP IV
    ...
    return -1;
    if (rc4key == core::ptr::null_mut() || keylen < 16)
    return -1;
...
#[no_mangle]
unsafe extern "C" fn libipw_tkip_encrypt(skb: *mut sk_buff, hdr_len: c_int, priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn libipw_tkip_decrypt(skb: *mut sk_buff, hdr_len: c_int, priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn libipw_tkip_set_key(key: *mut c_void, len: c_int, seq: *mut *mut u8, priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn libipw_tkip_get_key(key: *mut c_void, len: c_int, seq: *mut *mut u8, priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn libipw_tkip_print_stats(m: *mut seq_file, priv: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn libipw_crypto_tkip_init() -> int __init {
    int __init libipw_crypto_tkip_init(void)
    {
    return libipw_register_crypto_ops(&libipw_crypt_tkip);
    }
#[no_mangle]
pub unsafe extern "C" fn libipw_crypto_tkip_exit() {
