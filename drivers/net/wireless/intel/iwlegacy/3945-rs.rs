...
//! Source: drivers/net/wireless/intel/iwlegacy/3945-rs.c
#![no_std]
...
pub const RATE_MAX_WINDOW: c_int = 62;

pub const IL39_RATE_HIGH_TH: c_int = 11520;
pub const IL_SUCCESS_UP_TH: c_int = 8960;
pub const IL_SUCCESS_DOWN_TH: c_int = 10880;
pub const RATE_MIN_FAILURE_TH: c_int = 6;
pub const RATE_MIN_SUCCESS_TH: c_int = 8;
pub const RATE_DECREASE_TH: c_int = 1920;
pub const RATE_RETRY_TH: c_int = 15;
    static u8
    il3945_get_rate_idx_by_rssi(s32 rssi, enum nl80211_band band)
    {
    let mut idx: u32 = 0;
    let mut table_size: u32 = 0;
    struct il3945_tpt_entry *tpt_table = core::ptr::null_mut();
...
//
    ...
    {
    let mut unflushed: c_int = 0;
    int i;
    unsigned long flags;
    let mut __maybe_unused: *mut il_priv il = rs_sta.il;
//
...
pub const IL_AVERAGE_PACKETS: c_int = 1500;
    static void
...
#[no_mangle]
pub unsafe extern "C" fn if(RATE_FLUSH_MAX: duration >) -> else {
...
// rate scale requires free function to be implemented
    ...
    let mut __maybe_unused: *mut il_priv il = il_priv;
    D_RATE("enter\n");
    rs_sta = &psta.rs_sta;
...
//
    ...
    struct sk_buff *skb)
    {
    let mut retries: i8 = 0, current_count;
...
//
    ...
    int idx;
    struct il3945_rs_sta *rs_sta = il_sta;
    struct il3945_rate_scale_data *win = core::ptr::null_mut();
