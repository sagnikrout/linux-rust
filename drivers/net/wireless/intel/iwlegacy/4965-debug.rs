...
//! Source: drivers/net/wireless/intel/iwlegacy/4965-debug.c
#![no_std]
...
//
    ...
    let mut pos: c_int = 0;
    char *buf;
    let mut bufsz: c_int = (sizeof(struct stats_tx) * 48) + 250;
    ssize_t ret;
...
//
    ...
    let mut pos: c_int = 0;
    char *buf;
    let mut bufsz: c_int = sizeof(struct stats_general) * 10 + 300;
    ssize_t ret;
