...
//! Source: drivers/net/wireless/ti/wlcore/main.c
#![no_std]
...
pub const WL1271_BOOT_RETRIES: c_int = 3;
pub const WL1271_WAKEUP_TIMEOUT: c_int = 500;
    ...
    let mut fwlog_mem_blocks: static int = -1;
    let mut bug_on_recovery: static int = -1;
    let mut no_recovery: static int = -1;
...
#[no_mangle]
unsafe extern "C" fn wl12xx_set_authorized(wl: *mut wl1271, wlvif: *mut wl12xx_vif) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn wl1271_recalc_rx_streaming(wl: *mut wl1271, wlvif: *mut wl12xx_vif) -> c_int {
    int wl1271_recalc_rx_streaming(struct wl1271 *wl, struct wl12xx_vif *wlvif)
    {
    let mut ret: c_int = 0;
    let mut period: c_int = wl.conf.rx_streaming.interval;
...
#[no_mangle]
unsafe extern "C" fn wl1271_rx_streaming_enable_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn wl1271_rx_streaming_disable_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn wl1271_rx_streaming_timer(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn wl12xx_rearm_tx_watchdog_locked(wl: *mut wl1271) {
...
#[no_mangle]
unsafe extern "C" fn wlcore_rc_update_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_tx_watchdog_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn wlcore_adjust_conf(wl: *mut wl1271) {
...
#[no_mangle]
unsafe extern "C" fn wlcore_fw_status(wl: *mut wl1271, status: *mut wl_fw_status) -> c_int {
    static int wlcore_fw_status(struct wl1271 *wl, struct wl_fw_status *status)
    {
    struct wl12xx_vif *wlvifsta;
    struct wl12xx_vif *wlvifap;
    struct wl12xx_vif *wlvif;
    let mut old_tx_blk_count: u32 = wl.tx_blocks_available;
...
#[no_mangle]
unsafe extern "C" fn wl1271_flush_deferred_work(wl: *mut wl1271) {
...
#[no_mangle]
unsafe extern "C" fn wl1271_netstack_work(work: *mut work_struct) {
...
pub const WL1271_IRQ_MAX_LOOPS: c_int = 256;
#[no_mangle]
unsafe extern "C" fn wlcore_irq_locked(wl: *mut wl1271) -> c_int {
    static int wlcore_irq_locked(struct wl1271 *wl)
    {
    let mut ret: c_int = 0;
    u32 intr;
    let mut loopcount: c_int = WL1271_IRQ_MAX_LOOPS;
    let mut run_tx_queue: bool = true;
...
#[no_mangle]
unsafe extern "C" fn wlcore_irq(irq: c_int, cookie: *mut c_void) -> irqreturn_t {
    static irqreturn_t wlcore_irq(int irq, void *cookie)
    {
    int ret;
    unsigned long flags;
    struct wl1271 *wl = cookie;
    let mut queue_tx_work: bool = true;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vif_counter_data {
    pub counter: u8,
    pub cur_vif: *mut ieee80211_vif,
    pub cur_vif_running: bool,
}
...
#[no_mangle]
unsafe extern "C" fn wl12xx_fetch_firmware(wl: *mut wl1271, plt: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wl12xx_queue_recovery_work(wl: *mut wl1271) {
...
#[no_mangle]
pub unsafe extern "C" fn wl12xx_copy_fwlog(wl: *mut wl1271, memblock: *mut u8, maxlen: usize) -> usize {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_read_fwlog_panic(wl: *mut wl1271) {
    static void wl12xx_read_fwlog_panic(struct wl1271 *wl)
    {
    let mut end_of_log: u32 = 0;
    int error;
...
// Traverse the memory blocks linked list
    ...
    let mut sqn_recovery_padding: u32 = WL1271_TX_SQN_POST_RECOVERY_PADDING;
...
#[no_mangle]
unsafe extern "C" fn wlcore_print_recovery(wl: *mut wl1271) {
    static void wlcore_print_recovery(struct wl1271 *wl)
    {
    let mut pc: u32 = 0;
    let mut hint_sts: u32 = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn wl1271_recovery_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn wlcore_fw_wakeup(wl: *mut wl1271) -> c_int {
    static int wlcore_fw_wakeup(struct wl1271 *wl)
    {
    return wlcore_raw_write32(wl, HW_ACCESS_ELP_CTRL_REG, ELPCTRL_WAKE_UP);
    }
#[no_mangle]
unsafe extern "C" fn wl1271_setup(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_set_power_on(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_chip_wakeup(wl: *mut wl1271, plt: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wl1271_plt_start(wl: *mut wl1271, plt_mode: enum plt_mode) -> c_int {
    int wl1271_plt_start(struct wl1271 *wl, const enum plt_mode plt_mode)
    {
    let mut retries: c_int = WL1271_BOOT_RETRIES;
...
#[no_mangle]
pub unsafe extern "C" fn wl1271_plt_stop(wl: *mut wl1271) -> c_int {
...
//
    ...
    struct wl12xx_vif *wlvif = core::ptr::null_mut();
    unsigned long flags;
    int q, mapping;
    u8 hlid;
    if (!vif) {
...
#[no_mangle]
pub unsafe extern "C" fn wl1271_tx_dummy_packet(wl: *mut wl1271) -> c_int {
...
// Initialize all fields that might be used
    ...
    {
    let mut num_fields: c_int = 0, in_field = 0, fields_size = 0;
    int i, pattern_len = 0;
    if (!p.mask) {
...
#[no_mangle]
pub unsafe extern "C" fn wl1271_rx_filter_free(filter: *mut wl12xx_rx_filter) {
...
#[no_mangle]
pub unsafe extern "C" fn wl1271_rx_filter_get_fields_size(filter: *mut wl12xx_rx_filter) -> c_int {
...
// Translate WoWLAN patterns into filters
    ...
    struct wl12xx_rx_filter *filter = core::ptr::null_mut();
    p = &wow.patterns[i];
...
#[no_mangle]
unsafe extern "C" fn wl1271_configure_resume(wl: *mut wl1271, wlvif: *mut wl12xx_vif) {
    static void wl1271_configure_resume(struct wl1271 *wl, struct wl12xx_vif *wlvif)
    {
    let mut ret: c_int = 0;
    let mut is_ap: bool = wlvif.bss_type == BSS_TYPE_AP_BSS;
    let mut is_sta: bool = wlvif.bss_type == BSS_TYPE_STA_BSS;
    if ((!is_ap) && (!is_sta))
    return;
    if ((is_sta && !test_bit(WLVIF_FLAG_STA_ASSOCIATED, &wlvif.flags)) ||
    (is_ap && !test_bit(WLVIF_FLAG_AP_STARTED, &wlvif.flags)))
    return;
    wl1271_configure_wowlan(wl, core::ptr::null_mut());
    if (is_sta) {
    if ((wl.conf.conn.suspend_wake_up_event ==
    wl.conf.conn.wake_up_event) &&
    (wl.conf.conn.suspend_listen_interval ==
...
#[no_mangle]
unsafe extern "C" fn wl1271_op_resume(hw: *mut ieee80211_hw) -> int __maybe_unused {
    static int __maybe_unused wl1271_op_resume(struct ieee80211_hw *hw)
    {
    struct wl1271 *wl = hw.priv;
    struct wl12xx_vif *wlvif;
    unsigned long flags;
    let mut run_irq_work: bool = false, pending_recovery;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn wl1271_op_start(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wlcore_op_stop_locked(wl: *mut wl1271) {
    static void wlcore_op_stop_locked(struct wl1271 *wl)
    {
    int i;
    if (wl.state == WLCORE_STATE_OFF) {
...
//
    ...
    kfree(wl.raw_fw_status);
    wl.raw_fw_status = core::ptr::null_mut();
    kfree(wl.fw_status);
    wl.fw_status = core::ptr::null_mut();
    kfree(wl.tx_res_if);
    wl.tx_res_if = core::ptr::null_mut();
    kfree(wl.target_mem_map);
    wl.target_mem_map = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn wlcore_op_stop(hw: *mut ieee80211_hw, suspend: bool) {
...
#[no_mangle]
unsafe extern "C" fn wlcore_channel_switch_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn wlcore_connection_loss_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn wlcore_pending_auth_complete_work(work: *mut work_struct) {
...
// cancel the ROC if active
    wlcore_update_inconn_sta(wl, wlvif, core::ptr::null_mut(), false);
    pm_runtime_put_autosuspend(wl.dev);
    out:
    mutex_unlock(&wl.mutex);
    }
#[no_mangle]
unsafe extern "C" fn wl12xx_allocate_rate_policy(wl: *mut wl1271, idx: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_free_rate_policy(wl: *mut wl1271, idx: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn wlcore_allocate_klv_template(wl: *mut wl1271, idx: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wlcore_free_klv_template(wl: *mut wl1271, idx: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_get_role_type(wl: *mut wl1271, wlvif: *mut wl12xx_vif) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ieee80211_vif_is_mesh(vif)) -> else {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_init_vif_data(wl: *mut wl1271, vif: *mut ieee80211_vif) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_init_fw(wl: *mut wl1271) -> c_int {
    static int wl12xx_init_fw(struct wl1271 *wl)
    {
    struct wlcore_platdev_data *pdev_data = dev_get_platdata(&wl.pdev.dev);
    let mut retries: c_int = WL1271_BOOT_RETRIES;
    let mut booted: bool = false;
    struct wiphy *wiphy = wl.hw.wiphy;
    int ret;
    while (retries) {
    retries--;
...
#[no_mangle]
unsafe extern "C" fn wl12xx_dev_role_started(wlvif: *mut wl12xx_vif) -> bool {
...
//
    ...
    bool add)
    {
    let mut current_fw: enum wl12xx_fw_type = wl.fw_type;
    let mut vif_count: u8 = vif_counter_data.counter;
...
//
#[no_mangle]
unsafe extern "C" fn wl12xx_force_active_psm(wl: *mut wl1271) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wlcore_hw_queue_iter_data {
    pub hw_queue_map: [c_ulong; BITS_TO_LONGS(WLCORE_NUM_MAC_ADDRESSES)],
// current vif
    pub vif: *mut ieee80211_vif,
// is the current vif among those iterated
    pub cur_running: bool,
}
    ...
    {
    struct ieee80211_vif *vif = wl12xx_wlvif_to_vif(wlvif);
    let mut iter_data: wlcore_hw_queue_iter_data = {};
    int i, q_base;
    if (vif.type == NL80211_IFTYPE_P2P_DEVICE) {
...
//
    ...
    wl.scan_wlvif = core::ptr::null_mut();
    wl.scan.req = core::ptr::null_mut();
    ieee80211_scan_completed(wl.hw, &info);
    }
    if (wl.sched_vif == wlvif)
    wl.sched_vif = core::ptr::null_mut();
    if (wl.roc_vif == vif) {
    wl.roc_vif = core::ptr::null_mut();
...
// clear all hlids (except system_hlid)
    ...
    wlvif.probereq = core::ptr::null_mut();
    if (wl.last_wlvif == wlvif)
    wl.last_wlvif = core::ptr::null_mut();
    list_del(&wlvif.list);
...
// mask ap events
    ...
    let mut sta_auth: u8 = wl.conf.conn.sta_sleep_auth;
...
#[no_mangle]
unsafe extern "C" fn wlcore_join(wl: *mut wl1271, wlvif: *mut wl12xx_vif) -> c_int {
    static int wlcore_join(struct wl1271 *wl, struct wl12xx_vif *wlvif)
    {
    int ret;
    let mut is_ibss: bool = (wlvif.bss_type == BSS_TYPE_IBSS);
//
...
#[no_mangle]
unsafe extern "C" fn wlcore_set_ssid(wl: *mut wl1271, wlvif: *mut wl12xx_vif) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wlcore_unset_assoc(wl: *mut wl1271, wlvif: *mut wl12xx_vif) -> c_int {
    static int wlcore_unset_assoc(struct wl1271 *wl, struct wl12xx_vif *wlvif)
    {
    int ret;
    let mut sta: bool = wlvif.bss_type == BSS_TYPE_STA_BSS;
...
#[no_mangle]
unsafe extern "C" fn wl1271_set_band_rate(wl: *mut wl1271, wlvif: *mut wl12xx_vif) {
    ...
    bool idle)
    {
    let mut cur_idle: bool = !test_bit(WLVIF_FLAG_ACTIVE, &wlvif.flags);
    if (idle == cur_idle)
    return;
    if (idle) {
...
#[no_mangle]
unsafe extern "C" fn wl1271_op_config(hw: *mut ieee80211_hw, radio_idx: c_int, changed: u32) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wl1271_filter_params {
    pub enabled: bool,
    pub mc_list_length: c_int,
    pub mc_list: [u8; ACX_MC_ADDRESS_GROUP_MAX][ETH_ALEN],
}
...
// total &= WL1271_SUPPORTED_FILTERS;
    ...
    core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: fp) -> else {
    else if (fp)
    ret = wl1271_acx_group_address_tbl(wl, wlvif,
    fp.enabled,
    fp.mc_list,
...
//
    ...
    if (wlvif.ap.recorded_keys[i] == core::ptr::null_mut())
    break;
...
#[no_mangle]
unsafe extern "C" fn wl1271_free_ap_keys(wl: *mut wl1271, wlvif: *mut wl12xx_vif) {
    static void wl1271_free_ap_keys(struct wl1271 *wl, struct wl12xx_vif *wlvif)
    {
    int i;
    for (i = 0; i < MAX_NUM_KEYS; i++) {
    kfree(wlvif.ap.recorded_keys[i]);
    wlvif.ap.recorded_keys[i] = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn wl1271_ap_init_hwenc(wl: *mut wl1271, wlvif: *mut wl12xx_vif) -> c_int {
    static int wl1271_ap_init_hwenc(struct wl1271 *wl, struct wl12xx_vif *wlvif)
    {
    int i, ret = 0;
    struct wl1271_ap_key *key;
    let mut wep_key_added: bool = false;
    for (i = 0; i < MAX_NUM_KEYS; i++) {
    u8 hlid;
    if (wlvif.ap.recorded_keys[i] == core::ptr::null_mut())
    break;
...
//
    ...
    struct wl12xx_vif *wlvif = wl12xx_vif_to_data(vif);
    int ret;
    let mut tx_seq_32: u32 = 0;
    let mut tx_seq_16: u16 = 0;
    u8 key_type;
    u8 hlid;
    bool is_pairwise;
    ...
    hlid = wlvif.sta.hlid;
    if (hlid != WL12XX_INVALID_LINK_ID) {
    let mut tx_seq: u64 = wl.links[hlid].total_freed_pkts;
...
#[no_mangle]
pub unsafe extern "C" fn wlcore_regdomain_config(wl: *mut wl1271) {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_remove_ie(skb: *mut sk_buff, eid: u8, ieoffset: c_int) {
...
// insert SSID from bss_conf
    ...
    u32 min_rate;
    int ret;
    let mut ieoffset: c_int = offsetof(struct ieee80211_mgmt, u.beacon.variable);
...
//
    ...
    let mut rate: u32 = wl1271_tx_min_rate_get(wl, wlvif.basic_rate_set);
...
// AP mode changes
    ...
    let mut rates: u32 = bss_conf.basic_rates;
...
#[no_mangle]
unsafe extern "C" fn wlcore_clear_bssid(wl: *mut wl1271, wlvif: *mut wl12xx_vif) -> c_int {
...
// STA/IBSS mode changes
    ...
    {
    struct wl12xx_vif *wlvif = wl12xx_vif_to_data(vif);
    let mut do_join: bool = false;
    let mut is_ibss: bool = (wlvif.bss_type == BSS_TYPE_IBSS);
    let mut ibss_joined: bool = false;
    let mut sta_rate_set: u32 = 0;
    int ret;
    struct ieee80211_sta *sta;
    let mut sta_exists: bool = false;
...
// Handle arp filtering. Done after join.
    ...
    let mut addr: __be32 = vif.cfg.arp_addr_list[0];
...
//
    ...
    struct wl1271 *wl = hw.priv;
    struct wl12xx_vif *wlvif = wl12xx_vif_to_data(vif);
    let mut mactime: u64 = ULLONG_MAX;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn wl1271_free_sta(wl: *mut wl1271, wlvif: *mut wl12xx_vif, hlid: u8) {
...
#[no_mangle]
unsafe extern "C" fn __wlcore_roc_completed(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wlcore_roc_completed(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wlcore_roc_complete_work(work: *mut work_struct) {
...
// this callback is atomic, so schedule a new work
    ...
    struct wl1271 *wl = hw.priv;
    let mut hlid: u8 = wl_sta.hlid;
// return in units of Kbps
    return (wl.links[hlid].fw_rate_mbps * 1000);
    }
#[no_mangle]
unsafe extern "C" fn wl1271_tx_frames_pending(hw: *mut ieee80211_hw) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn wlcore_rate_to_idx(wl: *mut wl1271, rate: u8, band: enum nl80211_band) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_derive_mac_addresses(wl: *mut wl1271, oui: u32, nic: u32) {
...
//
    ...
    let mut idx: c_int = WLCORE_NUM_MAC_ADDRESSES - 1;
...
#[no_mangle]
unsafe extern "C" fn wl12xx_get_hw_info(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1271_register_hw(wl: *mut wl1271) -> c_int {
    static int wl1271_register_hw(struct wl1271 *wl)
    {
    int ret;
    let mut oui_addr: u32 = 0, nic_addr = 0;
...
#[no_mangle]
unsafe extern "C" fn wl1271_unregister_hw(wl: *mut wl1271) {
...
#[no_mangle]
unsafe extern "C" fn wl1271_init_ieee80211(wl: *mut wl1271) -> c_int {
...
// The system link is always allocated
    ...
    wl.tx_frames[i] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn wlcore_free_hw(wl: *mut wl1271) -> c_int {
...
// Unblock any fwlog readers
    ...
    wl1271_debugfs_exit(wl);
    vfree(wl.fw);
    wl.fw = core::ptr::null_mut();
    wl.fw_type = WL12XX_FW_TYPE_NONE;
    kfree(wl.nvs);
    wl.nvs = core::ptr::null_mut();
    kfree(wl.raw_fw_status);
    kfree(wl.fw_status);
    kfree(wl.tx_res_if);
    destroy_workqueue(wl.freezable_wq);
...
#[no_mangle]
unsafe extern "C" fn wlcore_hardirq(irq: c_int, cookie: *mut c_void) -> irqreturn_t {
    static irqreturn_t wlcore_hardirq(int irq, void *cookie)
    {
    return IRQ_WAKE_THREAD;
    }
#[no_mangle]
unsafe extern "C" fn wlcore_nvs_cb(fw: *const firmware, context: *mut c_void) {
    ...
    struct resource *res;
    int ret;
    let mut hardirq_fn: irq_handler_t = core::ptr::null_mut();
    if (fw) {
...
#[no_mangle]
unsafe extern "C" fn wlcore_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn wlcore_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
// Nothing to do if no ELP mode requested
    ...
    spin_lock_irqsave(&wl.wl_lock, flags);
    wl.elp_compl = core::ptr::null_mut();
    spin_unlock_irqrestore(&wl.wl_lock, flags);
...
#[no_mangle]
pub unsafe extern "C" fn wlcore_probe(wl: *mut wl1271, pdev: *mut platform_device) -> c_int {
    ...
    wlcore_nvs_cb(core::ptr::null_mut(), wl);
    }
...
#[no_mangle]
pub unsafe extern "C" fn wlcore_remove(pdev: *mut platform_device) {
    ...
    wl.dev.driver.pm = core::ptr::null_mut();
    if (pdev_data.family && pdev_data.family.nvs_name)
    ...
    let mut wl12xx_debug_level: u32 = DEBUG_NONE;
