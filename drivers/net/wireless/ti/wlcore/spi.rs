...
//! Source: drivers/net/wireless/ti/wlcore/spi.c
#![no_std]
...
pub const WSPI_MAX_CHUNK_SIZE: c_int = 4092;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wl12xx_spi_glue {
    pub dev: *mut device,
    pub core: *mut platform_device,
    pub /: *mut *mut *mut regulator reg; / Power regulator,
}

#[no_mangle]
unsafe extern "C" fn wl12xx_spi_reset(child: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_spi_init(child: *mut device) {
...
pub const WL1271_BUSY_WORD_TIMEOUT: c_int = 1000;
#[no_mangle]
unsafe extern "C" fn wl12xx_spi_read_busy(child: *mut device) -> c_int {
    ...
    struct spi_message m;
    u32 *busy_buf;
    let mut num_busy_bytes: c_int = 0;
//
...
//
#[no_mangle]
unsafe extern "C" fn wl12xx_spi_set_power(child: *mut device, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1271_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1271_remove(spi: *mut spi_device) {
