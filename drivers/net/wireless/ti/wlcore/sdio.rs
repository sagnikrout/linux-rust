...
//! Source: drivers/net/wireless/ti/wlcore/sdio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wl12xx_sdio_power_on(glue: *mut wl12xx_sdio_glue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_sdio_power_off(glue: *mut wl12xx_sdio_glue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_sdio_set_power(child: *mut device, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1271_remove(func: *mut sdio_func) {
...
#[no_mangle]
unsafe extern "C" fn wl1271_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1271_resume(dev: *mut device) -> c_int {
