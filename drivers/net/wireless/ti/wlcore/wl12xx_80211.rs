...
//! Source: drivers/net/wireless/ti/wlcore/wl12xx_80211.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wl12xx_arp_rsp_template {
// not including ieee80211 header
    pub llc_hdr: [u8; sizeof(rfc1042_header)],
    pub llc_type: __be16,
    pub arp_hdr: arphdr,
    pub sender_hw: [u8; ETH_ALEN],
    pub sender_ip: __be32,
    pub target_hw: [u8; ETH_ALEN],
    pub target_ip: __be32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wl12xx_disconn_template {
    pub header: ieee80211_header,
    pub disconn_reason: __le16,
    pub __packed: },
