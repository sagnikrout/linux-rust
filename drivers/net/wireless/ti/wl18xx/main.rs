...
//! Source: drivers/net/wireless/ti/wl18xx/main.c
#![no_std]
...
pub const WL18XX_RX_CHECKSUM_MASK: c_uint = 0x40;
    static char *ht_mode_param = core::ptr::null_mut();
    static char *board_type_param = core::ptr::null_mut();
    let mut checksum_param: static bool = false;
    let mut num_rx_desc_param: static int = -1;
// phy paramters
    let mut dc2dc_param: static int = -1;
    let mut n_antennas_2_param: static int = -1;
    let mut n_antennas_5_param: static int = -1;
    let mut low_band_component_param: static int = -1;
    let mut low_band_component_type_param: static int = -1;
    let mut high_band_component_param: static int = -1;
    let mut high_band_component_type_param: static int = -1;
    let mut pwr_limit_reference_11_abg_param: static int = -1;
...
#[no_mangle]
unsafe extern "C" fn wl18xx_identify_chip(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl18xx_set_clk(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl18xx_boot_soft_reset(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl18xx_pre_boot(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl18xx_pre_upload(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl18xx_set_mac_and_phy(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl18xx_enable_interrupts(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl18xx_boot(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl18xx_ack_event(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl18xx_calc_tx_blocks(wl: *mut wl1271, len: u32, spare_blks: u32) -> u32 {
    static u32 wl18xx_calc_tx_blocks(struct wl1271 *wl, u32 len, u32 spare_blks)
    {
    let mut blk_size: u32 = WL18XX_TX_HW_BLOCK_SIZE;
...
#[no_mangle]
unsafe extern "C" fn wl18xx_tx_immediate_completion(wl: *mut wl1271) {
    static void wl18xx_tx_immediate_completion(struct wl1271 *wl)
    {
    wl18xx_tx_immediate_complete(wl);
    }
#[no_mangle]
unsafe extern "C" fn wl18xx_set_host_cfg_bitmap(wl: *mut wl1271, extra_mem_blk: u32) -> c_int {
    static int wl18xx_set_host_cfg_bitmap(struct wl1271 *wl, u32 extra_mem_blk)
    {
    int ret;
    let mut sdio_align_size: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn wl18xx_hw_init(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl18xx_is_mimo_supported(wl: *mut wl1271) -> bool {
...
//
    ...
    {
    let mut hw_rate_set: u32 = wlvif.rate_set;
...
#[no_mangle]
unsafe extern "C" fn wl18xx_get_pg_ver(wl: *mut wl1271, ver: *mut i8) -> c_int {
    static int wl18xx_get_pg_ver(struct wl1271 *wl, s8 *ver)
    {
    u32 fuse;
    let mut rom: i8 = 0, metal = 0, pg_ver = 0, rdl_ver = 0, package_type = 0;
    int ret;
    ret = wlcore_set_partition(wl, &wl.ptable[PART_TOP_PRCM_ELP_SOC]);
    if (ret < 0)
    goto out;
...
#[no_mangle]
unsafe extern "C" fn wl18xx_conf_init(wl: *mut wl1271, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl18xx_plt_init(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl18xx_get_mac(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl18xx_get_spare_blocks(wl: *mut wl1271, is_gem: bool) -> c_int {
...
// If we have keys requiring extra spare, indulge them
    ...
    {
    struct wl18xx_priv *priv = wl.priv;
    let mut change_spare: bool = false, special_enc;
    int ret;
...
// no modifications
    ...
    struct wl12xx_vif *wlvif)
    {
    let mut wide: bool = wlvif.rc_update_bw >= IEEE80211_STA_RX_BW_40;
...
#[no_mangle]
unsafe extern "C" fn wl18xx_convert_hwaddr(wl: *mut wl1271, hwaddr: u32) -> u32 {
    ...
    .tx_delayed_compl = core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn wl18xx_setup(wl: *mut wl1271) -> c_int {
    static int wl18xx_setup(struct wl1271 *wl)
    {
    struct wl18xx_priv *priv = wl.priv;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(ht_mode_param, _arg: "wide")) -> else {
    else if (!strcmp(ht_mode_param, "wide"))
    priv.conf.ht.mode = HT_MODE_WIDE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(ht_mode_param, _arg: "siso20")) -> else {
...
// 5Ghz is always wide
    ...
    if (!checksum_param) {
    wl18xx_ops.set_rx_csum = core::ptr::null_mut();
    wl18xx_ops.init_vif = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn wl18xx_probe(pdev: *mut platform_device) -> c_int {
