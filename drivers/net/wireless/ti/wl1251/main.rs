...
//! Source: drivers/net/wireless/ti/wl1251/main.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn wl1251_enable_interrupts(wl: *mut wl1251) {
    void wl1251_enable_interrupts(struct wl1251 *wl)
    {
    wl.if_ops.enable_irq(wl);
    }
#[no_mangle]
pub unsafe extern "C" fn wl1251_disable_interrupts(wl: *mut wl1251) {
    void wl1251_disable_interrupts(struct wl1251 *wl)
    {
    wl.if_ops.disable_irq(wl);
    }
#[no_mangle]
unsafe extern "C" fn wl1251_power_off(wl: *mut wl1251) -> c_int {
    static int wl1251_power_off(struct wl1251 *wl)
    {
    return wl.if_ops.power(wl, false);
    }
#[no_mangle]
unsafe extern "C" fn wl1251_power_on(wl: *mut wl1251) -> c_int {
    static int wl1251_power_on(struct wl1251 *wl)
    {
    return wl.if_ops.power(wl, true);
    }
#[no_mangle]
unsafe extern "C" fn wl1251_fetch_firmware(wl: *mut wl1251) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1251_fetch_nvs(wl: *mut wl1251) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1251_fw_wakeup(wl: *mut wl1251) {
...
#[no_mangle]
unsafe extern "C" fn wl1251_chip_wakeup(wl: *mut wl1251) -> c_int {
...
pub const WL1251_IRQ_LOOP_COUNT: c_int = 10;
#[no_mangle]
unsafe extern "C" fn wl1251_irq_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn wl1251_op_start(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1251_op_stop(hw: *mut ieee80211_hw, suspend: bool) {
...
// let's notify MAC80211 about the remaining pending TX frames
    ...
    wl.vif = core::ptr::null_mut();
    eth_zero_addr(wl.bssid);
    mutex_unlock(&wl.mutex);
    }
#[no_mangle]
unsafe extern "C" fn wl1251_build_null_data(wl: *mut wl1251) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1251_build_qos_null_data(wl: *mut wl1251) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1251_can_do_pm(conf: *mut ieee80211_conf, wl: *mut wl1251) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wl1251_op_config(hw: *mut ieee80211_hw, radio_idx: c_int, changed: u32) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wl1251_filter_params {
    pub enabled: bool,
...
//
    ...
    goto out;
    if (*total & FIF_ALLMULTI)
    ret = wl1251_acx_group_address_tbl(wl, false, core::ptr::null_mut(), 0);
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn wl1251_read_eeprom_byte(wl: *mut wl1251, offset: off_t, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1251_read_eeprom_mac(wl: *mut wl1251) -> c_int {
...
pub const NVS_OFF_MAC_LEN: c_uint = 0x19;
pub const NVS_OFF_MAC_ADDR_LO: c_uint = 0x1a;
pub const NVS_OFF_MAC_ADDR_HI: c_uint = 0x1b;
pub const NVS_OFF_MAC_DATA: c_uint = 0x1c;
#[no_mangle]
unsafe extern "C" fn wl1251_check_nvs_mac(wl: *mut wl1251) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1251_read_nvs_mac(wl: *mut wl1251) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1251_write_nvs_mac(wl: *mut wl1251) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1251_register_hw(wl: *mut wl1251) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wl1251_init_ieee80211(wl: *mut wl1251) -> c_int {
...
//
    ...
    wl.hw.queues = 4;
    if (wl.nvs == core::ptr::null_mut() && !wl.use_eeprom) {
...
#[no_mangle]
pub unsafe extern "C" fn wl1251_free_hw(wl: *mut wl1251) -> c_int {
    ...
    wl.rx_descriptor = core::ptr::null_mut();
