...
//! Source: drivers/net/wireless/ti/wl1251/sdio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wl1251_sdio_interrupt(func: *mut sdio_func) {
...
#[no_mangle]
unsafe extern "C" fn wl1251_sdio_read_elp(wl: *mut wl1251, addr: c_int, val: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn wl1251_sdio_write_elp(wl: *mut wl1251, addr: c_int, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn wl1251_sdio_reset(wl: *mut wl1251) {
    static void wl1251_sdio_reset(struct wl1251 *wl)
    {
    }
#[no_mangle]
unsafe extern "C" fn wl1251_sdio_enable_irq(wl: *mut wl1251) {
...
#[no_mangle]
unsafe extern "C" fn wl1251_sdio_disable_irq(wl: *mut wl1251) {
...
#[no_mangle]
unsafe extern "C" fn wl1251_line_irq(irq: c_int, cookie: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wl1251_enable_line_irq(wl: *mut wl1251) {
    static void wl1251_enable_line_irq(struct wl1251 *wl)
    {
    return enable_irq(wl.irq);
    }
#[no_mangle]
unsafe extern "C" fn wl1251_disable_line_irq(wl: *mut wl1251) {
    static void wl1251_disable_line_irq(struct wl1251 *wl)
    {
    return disable_irq(wl.irq);
    }
#[no_mangle]
unsafe extern "C" fn wl1251_sdio_set_power(wl: *mut wl1251, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1251_sdio_remove(func: *mut sdio_func) {
...
#[no_mangle]
unsafe extern "C" fn wl1251_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1251_resume(dev: *mut device) -> c_int {
