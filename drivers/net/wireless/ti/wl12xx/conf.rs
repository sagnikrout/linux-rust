...
//! Source: drivers/net/wireless/ti/wl12xx/conf.h
#![no_std]
...
pub const CONF_TX_PWR_COMPENSATION_LEN_2: c_int = 7;
pub const CONF_TX_PWR_COMPENSATION_LEN_5: c_int = 18;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wl12xx_conf_rf {
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wl12xx_priv_conf {
    pub rf: wl12xx_conf_rf,
    pub mem_wl127x: conf_memory_settings,
}

#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum wl12xx_sg_params {
//
