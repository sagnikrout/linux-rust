...
//! Source: drivers/net/wireless/ti/wl12xx/main.c
#![no_std]
...
pub const WL12XX_TX_HW_BLOCK_SPARE_DEFAULT: c_int = 1;
pub const WL12XX_TX_HW_BLOCK_GEM_SPARE: c_int = 2;
pub const WL12XX_TX_HW_BLOCK_SIZE: c_int = 252;
...
#[no_mangle]
unsafe extern "C" fn wl127x_prepare_read(wl: *mut wl1271, rx_desc: u32, len: u32) -> c_int {
...
//
    let mut mem_block: u32 = rx_desc & RX_MEM_BLOCK_MASK;
...
#[no_mangle]
unsafe extern "C" fn wl12xx_identify_chip(wl: *mut wl1271) -> c_int {
...
// write 1 to OCP_CMD
    ...
    {
    u32 val;
    let mut timeout: c_int = OCP_CMD_LOOP;
    int ret;
// write address >> 1 + 0x30000 to OCP_POR_CTR
    addr = (addr >> 1) + 0x30000;
    ret = wlcore_write32(wl, WL12XX_OCP_POR_CTR, addr);
...
#[no_mangle]
unsafe extern "C" fn wl128x_switch_tcxo_to_fref(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl128x_is_tcxo_valid(wl: *mut wl1271) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wl128x_is_fref_valid(wl: *mut wl1271) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wl128x_manually_configure_mcs_pll(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl128x_configure_mcs_pll(wl: *mut wl1271, clk: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wl128x_boot_clk(wl: *mut wl1271, selected_clock: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl127x_boot_clk(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl1271_boot_soft_reset(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_pre_boot(wl: *mut wl1271) -> c_int {
    static int wl12xx_pre_boot(struct wl1271 *wl)
    {
    struct wl12xx_priv *priv = wl.priv;
    let mut ret: c_int = 0;
    u32 clk;
    let mut selected_clock: c_int = -1;
    if (wl.chip.id == CHIP_ID_128X_PG20) {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_pre_upload(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_enable_interrupts(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_boot(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_ack_event(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_calc_tx_blocks(wl: *mut wl1271, len: u32, spare_blks: u32) -> u32 {
    static u32 wl12xx_calc_tx_blocks(struct wl1271 *wl, u32 len, u32 spare_blks)
    {
    let mut blk_size: u32 = WL12XX_TX_HW_BLOCK_SIZE;
    let mut align_len: u32 = wlcore_calc_packet_alignment(wl, len);
    ...
    struct sk_buff *skb)
    {
    let mut aligned_len: u32 = wlcore_calc_packet_alignment(wl, skb.len);
    if (wl.chip.id == CHIP_ID_128X_PG20) {
...
// calculate number of padding bytes
    let mut pad: c_int = aligned_len - skb.len;
    desc.tx_attr |=
...
#[no_mangle]
unsafe extern "C" fn wl12xx_tx_delayed_compl(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_hw_init(wl: *mut wl1271) -> c_int {
    static int wl12xx_hw_init(struct wl1271 *wl)
    {
    int ret;
    if (wl.chip.id == CHIP_ID_128X_PG20) {
    let mut host_cfg_bitmap: u32 = HOST_IF_CFG_RX_FIFO_ENABLE;
...
#[no_mangle]
unsafe extern "C" fn wl12xx_conf_init(wl: *mut wl1271) {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_mac_in_fuse(wl: *mut wl1271) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_get_fuse_mac(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_get_pg_ver(wl: *mut wl1271, ver: *mut i8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_get_mac(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_plt_init(wl: *mut wl1271) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_get_spare_blocks(wl: *mut wl1271, is_gem: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_convert_hwaddr(wl: *mut wl1271, hwaddr: u32) -> u32 {
    ...
    .tx_immediate_compl	= core::ptr::null_mut(),
    .tx_delayed_compl	= wl12xx_tx_delayed_compl,
    .hw_init		= wl12xx_hw_init,
    .init_vif		= core::ptr::null_mut(),
    .convert_fw_status	= wl12xx_convert_fw_status,
    .sta_get_ap_rate_mask	= wl12xx_sta_get_ap_rate_mask,
    .get_pg_ver		= wl12xx_get_pg_ver,
    .get_mac		= wl12xx_get_mac,
    .set_tx_desc_csum	= wl12xx_set_tx_desc_csum,
    .set_rx_csum		= core::ptr::null_mut(),
    .ap_get_mimo_wide_rate_mask = core::ptr::null_mut(),
    ...
    .pre_pkt_send		= core::ptr::null_mut(),
    .set_peer_cap		= wl12xx_set_peer_cap,
    .convert_hwaddr		= wl12xx_convert_hwaddr,
    .lnk_high_prio		= wl12xx_lnk_high_prio,
    .lnk_low_prio		= wl12xx_lnk_low_prio,
    .interrupt_notify	= core::ptr::null_mut(),
    .rx_ba_filter		= core::ptr::null_mut(),
    .ap_sleep		= core::ptr::null_mut(),
    };
...
#[no_mangle]
unsafe extern "C" fn wl12xx_setup(wl: *mut wl1271) -> c_int {
    static int wl12xx_setup(struct wl1271 *wl)
    {
    struct wl12xx_priv *priv = wl.priv;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(fref_param, _arg: "26")) -> else {
    else if (!strcmp(fref_param, "26"))
    priv.ref_clock = WL12XX_REFCLOCK_26;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(fref_param, _arg: "26x")) -> else {
    else if (!strcmp(fref_param, "26x"))
    priv.ref_clock = WL12XX_REFCLOCK_26_XTAL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(fref_param, _arg: "38.4")) -> else {
    else if (!strcmp(fref_param, "38.4"))
    priv.ref_clock = WL12XX_REFCLOCK_38;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(fref_param, _arg: "38.4x")) -> else {
    else if (!strcmp(fref_param, "38.4x"))
    priv.ref_clock = WL12XX_REFCLOCK_38_XTAL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(fref_param, _arg: "52")) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(tcxo_param, _arg: "26")) -> else {
    else if (!strcmp(tcxo_param, "26"))
    priv.tcxo_clock = WL12XX_TCXOCLOCK_26;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(tcxo_param, _arg: "38.4")) -> else {
    else if (!strcmp(tcxo_param, "38.4"))
    priv.tcxo_clock = WL12XX_TCXOCLOCK_38_4;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(tcxo_param, _arg: "52")) -> else {
    else if (!strcmp(tcxo_param, "52"))
    priv.tcxo_clock = WL12XX_TCXOCLOCK_52;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(tcxo_param, _arg: "16.368")) -> else {
    else if (!strcmp(tcxo_param, "16.368"))
    priv.tcxo_clock = WL12XX_TCXOCLOCK_16_368;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(tcxo_param, _arg: "32.736")) -> else {
    else if (!strcmp(tcxo_param, "32.736"))
    priv.tcxo_clock = WL12XX_TCXOCLOCK_32_736;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(tcxo_param, _arg: "16.8")) -> else {
    else if (!strcmp(tcxo_param, "16.8"))
    priv.tcxo_clock = WL12XX_TCXOCLOCK_16_8;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(tcxo_param, _arg: "33.6")) -> else {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wl12xx_remove(pdev: *mut platform_device) {
