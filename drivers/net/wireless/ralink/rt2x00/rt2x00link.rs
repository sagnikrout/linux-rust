...
//! Source: drivers/net/wireless/ralink/rt2x00/rt2x00link.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00link_get_avg_rssi(ewma: *mut ewma_rssi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt2x00link_antenna_get_link_rssi(rt2x00dev: *mut rt2x00_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt2x00link_antenna_get_rssi_history(rt2x00dev: *mut rt2x00_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt2x00link_antenna_reset(rt2x00dev: *mut rt2x00_dev) {
    static void rt2x00link_antenna_reset(struct rt2x00_dev *rt2x00dev)
    {
    ewma_rssi_init(&rt2x00dev.link.ant.rssi_ant);
    }
#[no_mangle]
unsafe extern "C" fn rt2x00lib_antenna_diversity_sample(rt2x00dev: *mut rt2x00_dev) {
    static void rt2x00lib_antenna_diversity_sample(struct rt2x00_dev *rt2x00dev)
    {
    struct link_ant *ant = &rt2x00dev.link.ant;
    struct antenna_setup new_ant;
    int other_antenna;
    let mut sample_current: c_int = rt2x00link_antenna_get_link_rssi(rt2x00dev);
    let mut sample_other: c_int = rt2x00link_antenna_get_rssi_history(rt2x00dev);
...
#[no_mangle]
unsafe extern "C" fn rt2x00lib_antenna_diversity_eval(rt2x00dev: *mut rt2x00_dev) {
...
#[no_mangle]
unsafe extern "C" fn rt2x00lib_antenna_diversity(rt2x00dev: *mut rt2x00_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00link_start_tuner(rt2x00dev: *mut rt2x00_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00link_stop_tuner(rt2x00dev: *mut rt2x00_dev) {
    void rt2x00link_stop_tuner(struct rt2x00_dev *rt2x00dev)
    {
    cancel_delayed_work_sync(&rt2x00dev.link.work);
    }
#[no_mangle]
pub unsafe extern "C" fn rt2x00link_reset_tuner(rt2x00dev: *mut rt2x00_dev, antenna: bool) {
    void rt2x00link_reset_tuner(struct rt2x00_dev *rt2x00dev, bool antenna)
    {
    struct link_qual *qual = &rt2x00dev.link.qual;
    let mut vgc_level: u8 = qual.vgc_level_reg;
...
#[no_mangle]
unsafe extern "C" fn rt2x00link_reset_qual(rt2x00dev: *mut rt2x00_dev) {
...
#[no_mangle]
unsafe extern "C" fn rt2x00link_tuner_sta(rt2x00dev: *mut rt2x00_dev, link: *mut link) {
...
#[no_mangle]
unsafe extern "C" fn rt2x00link_tuner(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00link_start_watchdog(rt2x00dev: *mut rt2x00_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00link_stop_watchdog(rt2x00dev: *mut rt2x00_dev) {
    void rt2x00link_stop_watchdog(struct rt2x00_dev *rt2x00dev)
    {
    cancel_delayed_work_sync(&rt2x00dev.link.watchdog_work);
    }
#[no_mangle]
unsafe extern "C" fn rt2x00link_watchdog(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00link_register(rt2x00dev: *mut rt2x00_dev) {
