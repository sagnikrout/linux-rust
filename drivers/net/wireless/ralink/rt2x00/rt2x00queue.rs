...
//! Source: drivers/net/wireless/ralink/rt2x00/rt2x00queue.h
#![no_std]
...
//
pub const DATA_FRAME_SIZE: c_int = 2432;
pub const MGMT_FRAME_SIZE: c_int = 256;
pub const AGGREGATION_SIZE: c_int = 3840;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct skb_frame_desc {
    pub flags: u8,
    pub desc_len: u8,
    pub tx_rate_idx: u8,
    pub tx_rate_flags: u8,
    pub desc: *mut c_void,
    pub iv: [__le32; 2],
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum rxdone_entry_desc_flags {
...
pub struct rxdone_entry_desc {
    ...
    pub rate_mode: u16,
    pub enc_flags: u16,
    pub encoding: mac80211_rx_encoding,
    pub bw: rate_info_bw,
    pub cipher: u8,
    pub cipher_status: u8,
    pub iv: [__le32; 2],
    pub icv: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum txdone_entry_desc_flags {
    TXDONE_UNKNOWN,
    TXDONE_SUCCESS,
    TXDONE_FALLBACK,
    TXDONE_FAILURE,
...
pub struct txentry_desc {
    ...
    pub ht: },
    pub u: },
    pub rate_mode: rate_modulation,
    pub retry_limit: c_short,
    pub cipher: cipher,
    pub key_idx: u16,
    pub iv_offset: u16,
    pub iv_len: u16,
...
pub struct queue_entry {
    ...
    pub queue: *mut data_queue,
    pub skb: *mut sk_buff,
    pub entry_idx: c_uint,
...
pub struct data_queue {
    ...
    pub entries: *mut queue_entry,
    pub qid: data_queue_qid,
    pub flags: c_ulong,
    ...
    pub count: c_uint,
    pub limit: c_ushort,
    pub threshold: c_ushort,
    pub length: c_ushort,
    pub index: [c_ushort; Q_INDEX_MAX],
    pub wd_count: c_ushort,
    pub wd_idx: c_uint,
    pub txop: c_ushort,
    pub aifs: c_ushort,
    pub cw_min: c_ushort,
    ...
    pub desc_size: c_uchar,
    pub winfo_size: c_uchar,
    pub priv_size: c_ushort,
    pub usb_endpoint: c_ushort,
    pub usb_maxpacket: c_ushort,
}
...
//
extern "C" {
    pub fn time_after(_arg: jiffies, msecs_to_jiffies(100): entry->last_action +) -> return;
}
//
...
//
extern "C" {
    pub fn le32_to_cpu(_arg: _rt2x00_desc_read(desc, _arg: word)) -> return;
}
//
