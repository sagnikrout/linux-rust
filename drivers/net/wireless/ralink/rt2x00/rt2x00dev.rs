...
//! Source: drivers/net/wireless/ralink/rt2x00/rt2x00dev.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_enable_radio(rt2x00dev: *mut rt2x00_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_disable_radio(rt2x00dev: *mut rt2x00_dev) {
...
#[no_mangle]
unsafe extern "C" fn rt2x00lib_intf_scheduled(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rt2x00lib_autowakeup(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_beacondone(rt2x00dev: *mut rt2x00_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_pretbtt(rt2x00dev: *mut rt2x00_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_dmastart(entry: *mut queue_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_dmadone(entry: *mut queue_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_txdone_bar_status(entry: *mut queue_entry) -> c_int {
...
//
    ...
    let mut txinfo: ieee80211_tx_info = {};
    bool success;
//
// Unmap the skb.
//
...
//
    ...
    struct skb_frame_desc *skbdesc = get_skb_frame_desc(entry.skb);
    let mut skbdesc_flags: u8 = skbdesc.flags;
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_txdone_noinfo(entry: *mut queue_entry, status: u32) {
...
#[no_mangle]
unsafe extern "C" fn rt2x00lib_sleep(work: *mut work_struct) {
...
// 2. Maybe the AP wants to send multicast/broadcast data?
    ...
    unsigned int i;
    let mut signal: c_int = rxdesc.signal;
    let mut type: c_int = (rxdesc.dev_flags & RXDONE_SIGNAL_MASK);
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_rxdone(entry: *mut queue_entry, gfp: gfp_t) {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_set_mac_address(rt2x00dev: *mut rt2x00_dev, eeprom_mac_addr: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt2x00lib_remove_hw(rt2x00dev: *mut rt2x00_dev) {
    ...
    rt2x00dev.hw.wiphy.bands[NL80211_BAND_2GHZ] = core::ptr::null_mut();
    rt2x00dev.hw.wiphy.bands[NL80211_BAND_5GHZ] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn rt2x00lib_probe_hw(rt2x00dev: *mut rt2x00_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rt2x00_has_cap_flag(rt2x00dev, _arg: REQUIRE_DMA)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn rt2x00lib_uninitialize(rt2x00dev: *mut rt2x00_dev) {
...
#[no_mangle]
unsafe extern "C" fn rt2x00lib_initialize(rt2x00dev: *mut rt2x00_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_start(rt2x00dev: *mut rt2x00_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_stop(rt2x00dev: *mut rt2x00_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_set_if_combinations(rt2x00dev: *mut rt2x00_dev) {
...
#[no_mangle]
unsafe extern "C" fn rt2x00dev_extra_tx_headroom(rt2x00dev: *mut rt2x00_dev) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_probe_dev(rt2x00dev: *mut rt2x00_dev) -> c_int {
...
//
    ...
    rt2x00dev.drv_data = core::ptr::null_mut();
    return retval;
    }
    EXPORT_SYMBOL_GPL(rt2x00lib_probe_dev);
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_remove_dev(rt2x00dev: *mut rt2x00_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_suspend(rt2x00dev: *mut rt2x00_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00lib_resume(rt2x00dev: *mut rt2x00_dev) -> c_int {
