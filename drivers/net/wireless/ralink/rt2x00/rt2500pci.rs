...
//! Source: drivers/net/wireless/ralink/rt2x00/rt2500pci.h
#![no_std]
...
pub const RF2525E: c_uint = 0x0004;
pub const RF5222: c_uint = 0x0010;
//
// RT2560 version
//
pub const RT2560_VERSION_B: c_int = 2;
pub const RT2560_VERSION_C: c_int = 3;
pub const RT2560_VERSION_D: c_int = 4;
//
// Signal information.
// Default offset is required for RSSI <-> dBm conversion.
//
pub const DEFAULT_RSSI_OFFSET: c_int = 121;
//
// Register layout information.
//
pub const CSR_REG_BASE: c_uint = 0x0000;
pub const CSR_REG_SIZE: c_uint = 0x0174;
pub const EEPROM_BASE: c_uint = 0x0000;
pub const EEPROM_SIZE: c_uint = 0x0200;
pub const BBP_BASE: c_uint = 0x0000;
pub const BBP_SIZE: c_uint = 0x0040;
...
//
pub const SECCSR0: c_uint = 0x0028;
...
//
pub const TXCSR8: c_uint = 0x0098;
...
//
pub const TXCSR9: c_uint = 0x0094;
...
//
pub const SECCSR3: c_uint = 0x00fc;
//
...
//
pub const TXACKCSR0: c_uint = 0x0110;
//
// ACK timeout count registers.
// ACKCNT0: TX ACK timeout count.
// ACKCNT1: RX ACK timeout count.
//
pub const ACKCNT0: c_uint = 0x0114;
pub const ACKCNT1: c_uint = 0x0118;
//
// GPIO and others.
//
...
//
pub const FIFOCSR0: c_uint = 0x0128;
pub const FIFOCSR1: c_uint = 0x012c;
//
...
//
pub const TESTCSR: c_uint = 0x0138;
//
...
// DESC_ADDRESS: Descriptor physical address of frame.
//
pub const SECCSR1: c_uint = 0x0158;

//
// BBPCSR1: BBP TX configuration.
//
pub const BBPCSR1: c_uint = 0x015c;
...
//
pub const DBANDCSR0: c_uint = 0x0160;
pub const DBANDCSR1: c_uint = 0x0164;
//
// BBPPCSR: BBP Pin control register.
//
pub const BBPPCSR: c_uint = 0x0168;
//
...
//
pub const DBGSEL0: c_uint = 0x016c;
pub const DBGSEL1: c_uint = 0x0170;
//
// BISTCSR: BBP BIST register.
//
pub const BISTCSR: c_uint = 0x0174;
//
// Multicast filter registers.
// MCAST0: Multicast filter register 0.
// MCAST1: Multicast filter register 1.
//
pub const MCAST0: c_uint = 0x0178;
pub const MCAST1: c_uint = 0x017c;
//
// UART registers.
...
//
pub const UARTCSR0: c_uint = 0x0180;
pub const UARTCSR1: c_uint = 0x0184;
pub const UARTCSR3: c_uint = 0x0188;
pub const UARTCSR4: c_uint = 0x018c;
pub const UART2CSR0: c_uint = 0x0190;
pub const UART2CSR1: c_uint = 0x0194;
pub const UART2CSR3: c_uint = 0x0198;
pub const UART2CSR4: c_uint = 0x019c;
//
// BBP registers.
...
//
pub const EEPROM_ANTENNA: c_uint = 0x10;
...
//
pub const EEPROM_NIC: c_uint = 0x11;

//
// EEPROM geography.
// GEO: Default geography setting for device.
//
pub const EEPROM_GEOGRAPHY: c_uint = 0x12;

//
// EEPROM BBP.
//
pub const EEPROM_BBP_START: c_uint = 0x13;
pub const EEPROM_BBP_SIZE: c_int = 16;

//
// EEPROM TXPOWER
//
pub const EEPROM_TXPOWER_START: c_uint = 0x23;
pub const EEPROM_TXPOWER_SIZE: c_int = 7;

//
// RSSI <-> dBm offset calibration
//
pub const EEPROM_CALIBRATE_OFFSET: c_uint = 0x3e;
