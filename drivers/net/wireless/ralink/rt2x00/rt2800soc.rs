...
//! Source: drivers/net/wireless/ralink/rt2x00/rt2800soc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rt2800soc_hwcrypt_disabled(rt2x00dev: *mut rt2x00_dev) -> bool {
    static bool rt2800soc_hwcrypt_disabled(struct rt2x00_dev *rt2x00dev)
    {
    return modparam_nohwcrypt;
    }
#[no_mangle]
unsafe extern "C" fn rt2800soc_disable_radio(rt2x00dev: *mut rt2x00_dev) {
...
#[no_mangle]
unsafe extern "C" fn rt2800soc_read_eeprom(rt2x00dev: *mut rt2x00_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt2800soc_suspend(pdev: *mut platform_device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt2800soc_resume(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt2x00soc_probe(pdev: *mut platform_device, ops: *const rt2x00_ops) -> c_int {
    ...
    if (irq < 0)
    return irq;
    clk = devm_clk_get_optional(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(clk))
    return PTR_ERR(clk);
...
#[no_mangle]
unsafe extern "C" fn rt2800soc_probe(pdev: *mut platform_device) -> c_int {
    static int rt2800soc_probe(struct platform_device *pdev)
    {
    return rt2x00soc_probe(pdev, &rt2800soc_ops);
    }
#[no_mangle]
unsafe extern "C" fn rt2800soc_remove(pdev: *mut platform_device) {
