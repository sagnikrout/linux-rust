...
//! Source: drivers/net/wireless/ralink/rt2x00/rt2x00mac.c
#![no_std]
...
// Disable hardware encryption
    rts_info.control.hw_key = core::ptr::null_mut();
//
...
//
    ...
    retval = rt2x00queue_write_tx_frame(queue, skb, core::ptr::null_mut(), true);
    if (retval) {
    ...
    let mut qid: enum data_queue_qid = skb_get_queue_mapping(skb);
    struct data_queue *queue = core::ptr::null_mut();
//
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00mac_start(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00mac_stop(hw: *mut ieee80211_hw, suspend: bool) {
    ...
    struct queue_entry *entry = core::ptr::null_mut();
    unsigned int i;
//
...
//
    ...
    NL80211_IFTYPE_UNSPECIFIED, core::ptr::null_mut(), core::ptr::null_mut());
    }
    EXPORT_SYMBOL_GPL(rt2x00mac_remove_interface);
#[no_mangle]
pub unsafe extern "C" fn rt2x00mac_config(hw: *mut ieee80211_hw, radio_idx: c_int, changed: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn memcpy_tkip(crypto: *mut rt2x00lib_crypto, key: *mut u8, key_len: u8) {
    ...
    struct rt2x00_sta *sta_priv = core::ptr::null_mut();
    if (!test_bit(DEVICE_STATE_PRESENT, &rt2x00dev.flags))
    return 0;
...
//
    ...
    rt2x00lib_config_intf(rt2x00dev, intf, vif.type, core::ptr::null_mut(),
    bss_conf.bssid);
//
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00mac_rfkill_poll(hw: *mut ieee80211_hw) {
    void rt2x00mac_rfkill_poll(struct ieee80211_hw *hw)
    {
    struct rt2x00_dev *rt2x00dev = hw.priv;
    let mut active: bool = !!rt2x00dev.ops.lib.rfkill_poll(rt2x00dev);
...
#[no_mangle]
pub unsafe extern "C" fn rt2x00mac_tx_frames_pending(hw: *mut ieee80211_hw) -> bool {
