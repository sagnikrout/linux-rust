...
//! Source: drivers/net/wireless/virtual/virt_wifi.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virt_wifi_wiphy_priv {
    pub scan_result: delayed_work,
...
pub const VIRT_WIFI_SSID_LEN: c_int = 8;
#[no_mangle]
unsafe extern "C" fn virt_wifi_inform_bss(wiphy: *mut wiphy) {
    static void virt_wifi_inform_bss(struct wiphy *wiphy)
    {
    let mut tsf: u64 = div_u64(ktime_get_boottime_ns(), 1000);
...
#[no_mangle]
unsafe extern "C" fn virt_wifi_scan_result(work: *mut work_struct) {
    ...
    let mut scan_info: cfg80211_scan_info = { .aborted = false };
...
#[no_mangle]
unsafe extern "C" fn virt_wifi_cancel_scan(wiphy: *mut wiphy) {
...
// Clean up dangling callbacks if necessary.
    ...
    let mut scan_info: cfg80211_scan_info = { .aborted = true };
// Schedules work which acquires and releases the rtnl lock.
    cfg80211_scan_done(priv.scan_request, &scan_info);
    priv.scan_request = core::ptr::null_mut();
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virt_wifi_netdev_priv {
    pub connect: delayed_work,
    pub lowerdev: *mut net_device,
    pub upperdev: *mut net_device,
    pub tx_packets: u32,
    pub tx_failed: u32,
    pub connect_requested_ssid_len: u32,
    pub connect_requested_ssid: [u8; IEEE80211_MAX_SSID_LEN],
    pub connect_requested_bss: [u8; ETH_ALEN],
    pub is_up: bool,
...
#[no_mangle]
unsafe extern "C" fn virt_wifi_connect_complete(work: *mut work_struct) {
    static void virt_wifi_connect_complete(struct work_struct *work)
    {
    struct virt_wifi_netdev_priv *priv =
    container_of(work, struct virt_wifi_netdev_priv, connect.work);
    u8 *requested_bss = priv.connect_requested_bss;
    let mut right_addr: bool = ether_addr_equal(requested_bss, fake_router_bssid);
    bool right_ssid = priv.connect_requested_ssid_len == VIRT_WIFI_SSID_LEN &&
    !memcmp(priv.connect_requested_ssid, VIRT_WIFI_SSID,
    priv.connect_requested_ssid_len);
    let mut status: u16 = WLAN_STATUS_SUCCESS;
    if (is_zero_ether_addr(requested_bss))
    requested_bss = core::ptr::null_mut();
...
// Schedules an event that acquires the rtnl lock.
    ...
    priv.is_connected ? fake_router_bssid : core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn virt_wifi_cancel_connect(netdev: *mut net_device) {
...
// Schedules an event that acquires the rtnl lock.
    cfg80211_connect_result(priv.upperdev,
    priv.connect_requested_bss, core::ptr::null_mut(), 0,
    core::ptr::null_mut(), 0,
...
// Called with the rtnl lock held. Acquires the rdev event lock.
    ...
    cfg80211_disconnected(netdev, reason_code, core::ptr::null_mut(), 0, true, GFP_KERNEL);
...
// Acquires and releases the rtnl lock.
    ...
    wiphy.bands[NL80211_BAND_60GHZ] = core::ptr::null_mut();
...
// Acquires and releases the rtnl lock.
#[no_mangle]
unsafe extern "C" fn virt_wifi_destroy_wiphy(wiphy: *mut wiphy) {
...
#[no_mangle]
unsafe extern "C" fn virt_wifi_net_device_open(dev: *mut net_device) -> c_int {
...
// Called with rtnl lock held.
#[no_mangle]
unsafe extern "C" fn virt_wifi_net_device_stop(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virt_wifi_net_device_get_iflink(dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virt_wifi_net_device_destructor(dev: *mut net_device) {
...
//
    ...
    dev.ieee80211_ptr = core::ptr::null_mut();
    }
// No lock interaction.
#[no_mangle]
unsafe extern "C" fn virt_wifi_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn virt_wifi_rx_handler(pskb: *mut sk_buff) -> rx_handler_result_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(priv->lowerdev->mtu: dev->mtu >) -> else {
...
#[no_mangle]
unsafe extern "C" fn netif_is_virt_wifi_dev(dev: *const net_device) -> bool {
...
// Acquires and releases the rtnl lock.
#[no_mangle]
unsafe extern "C" fn virt_wifi_init_module() -> int __init {
...
// Acquires and releases the rtnl lock.
#[no_mangle]
unsafe extern "C" fn virt_wifi_cleanup_module() -> void __exit {
