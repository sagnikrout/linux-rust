...
//! Source: drivers/net/wireless/virtual/mac80211_hwsim_main.c
#![no_std]
...
pub const WARN_QUEUE: c_int = 100;
pub const MAX_QUEUE: c_int = 200;
    MODULE_AUTHOR("Jouni Malinen");
    MODULE_DESCRIPTION("Software simulator of 802.11 radio(s) for mac80211");
    MODULE_LICENSE("GPL");
    let mut radios: static int = 2;
    module_param(radios, int, 0444);
    MODULE_PARM_DESC(radios, "Number of simulated radios");
    let mut channels: static int = 1;
    module_param(channels, int, 0444);
    MODULE_PARM_DESC(channels, "Number of concurrent channels");
    let mut paged_rx: static bool = false;
    module_param(paged_rx, bool, 0644);
    MODULE_PARM_DESC(paged_rx, "Use paged SKBs for RX instead of linear ones");
    let mut rctbl: static bool = false;
    module_param(rctbl, bool, 0444);
    MODULE_PARM_DESC(rctbl, "Handle rate control table");
    let mut support_p2p_device: static bool = true;
...
// Set to one of the HWSIM_REGTEST_* values above
    let mut regtest: static int = HWSIM_REGTEST_DISABLED;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hwsim_vif_priv {
    pub magic: u32,
    pub skip_beacons: [u32; IEEE80211_MLD_MAX_NUM_LINKS],
...
pub const HWSIM_VIF_MAGIC: c_uint = 0x69537748;
#[no_mangle]
pub unsafe extern "C" fn hwsim_check_magic(vif: *mut ieee80211_vif) {
...
#[no_mangle]
pub unsafe extern "C" fn hwsim_set_magic(vif: *mut ieee80211_vif) {
...
#[no_mangle]
pub unsafe extern "C" fn hwsim_clear_magic(vif: *mut ieee80211_vif) {
...
#[no_mangle]
pub unsafe extern "C" fn hwsim_check_sta_magic(sta: *mut ieee80211_sta) {
...
#[no_mangle]
pub unsafe extern "C" fn hwsim_set_sta_magic(sta: *mut ieee80211_sta) {
...
#[no_mangle]
pub unsafe extern "C" fn hwsim_clear_sta_magic(sta: *mut ieee80211_sta) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hwsim_chanctx_priv {
    pub magic: u32,
}

pub const HWSIM_CHANCTX_MAGIC: c_uint = 0x6d53774a;
#[no_mangle]
pub unsafe extern "C" fn hwsim_check_chanctx_magic(c: *mut ieee80211_chanctx_conf) {
...
#[no_mangle]
pub unsafe extern "C" fn hwsim_set_chanctx_magic(c: *mut ieee80211_chanctx_conf) {
...
#[no_mangle]
pub unsafe extern "C" fn hwsim_clear_chanctx_magic(c: *mut ieee80211_chanctx_conf) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hwsim_net {
    pub netgroup: c_int,
    pub wmediumd: u32,
}

#[no_mangle]
pub unsafe extern "C" fn hwsim_net_get_netgroup(net: *mut net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hwsim_net_set_netgroup(net: *mut net) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hwsim_net_get_wmediumd(net: *mut net) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn hwsim_net_set_wmediumd(net: *mut net, portid: u32) {
...
pub const OUI_QCA: c_uint = 0x001374;
pub const QCA_NL80211_SUBCMD_TEST: c_int = 1;
    ...
    data_len, hwsim_vendor_test_policy, core::ptr::null_mut());
    if (err)
    return err;
...
// Advertise support vendor specific events
    ...
    let mut hwsim_radios_generation: static int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hwsim_radiotap_hdr {
    pub hdr: ieee80211_radiotap_header_fixed,
    pub rt_tsft: __le64,
    pub rt_flags: u8,
    pub rt_rate: u8,
    pub rt_channel: __le16,
    pub rt_chbitmask: __le16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hwsim_radiotap_ack_hdr {
    pub hdr: ieee80211_radiotap_header_fixed,
    pub rt_flags: u8,
    pub pad: u8,
    pub rt_channel: __le16,
    ...
    {
    pub hwsim_rht_params): return rhashtable_lookup_fast(&hwsim_radios_rht, addr,,
    }
// MAC80211_HWSIM netlink family
    pub hwsim_genl_family: static struct genl_family,
...
#[no_mangle]
unsafe extern "C" fn hwsim_get_chanwidth(bw: enum nl80211_chan_width) -> c_int {
...
// sysfs attributes
#[no_mangle]
unsafe extern "C" fn hwsim_send_ps_poll(dat: *mut c_void, mac: *mut u8, vif: *mut ieee80211_vif) {
...
#[no_mangle]
unsafe extern "C" fn hwsim_fops_ps_read(dat: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwsim_fops_ps_write(dat: *mut c_void, val: u64) -> c_int {
    ...
    "%llu\n");
#[no_mangle]
unsafe extern "C" fn hwsim_write_simulate_radar(dat: *mut c_void, val: u64) -> c_int {
    static int hwsim_write_simulate_radar(void *dat, u64 val)
    {
    struct mac80211_hwsim_data *data = dat;
    ieee80211_radar_detected(data.hw, core::ptr::null_mut());
    return 0;
    }
    DEFINE_DEBUGFS_ATTRIBUTE(hwsim_simulate_radar, core::ptr::null_mut(),
...
// Check if background radar channel is configured
    ...
    GFP_KERNEL);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "cancel")) -> else {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hwsim_chanctx_iter_arg {
    pub conf: *mut ieee80211_chanctx_conf,
    pub freq_mhz: u32,
}
    ...
    {
    struct mac80211_hwsim_data *data = file.private_data;
    let mut arg: hwsim_chanctx_iter_arg = {};
    u32 bitmap;
    char buf[64];
...
#[no_mangle]
unsafe extern "C" fn hwsim_fops_group_read(dat: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwsim_fops_group_write(dat: *mut c_void, val: u64) -> c_int {
    ...
    "%llx\n");
#[no_mangle]
unsafe extern "C" fn hwsim_fops_rx_rssi_read(dat: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwsim_fops_rx_rssi_write(dat: *mut c_void, val: u64) -> c_int {
    static int hwsim_fops_rx_rssi_write(void *dat, u64 val)
    {
    struct mac80211_hwsim_data *data = dat;
    let mut rssi: c_int = (int)val;
    if (rssi >= 0 || rssi < -100)
    return -EINVAL;
    data.rx_rssi = rssi;
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn mac80211_hwsim_get_sim_tsf() -> u64 {
    ...
    let mut sim_time: u64 = mac80211_hwsim_get_sim_tsf();
    scoped_guard(spinlock_bh, &data.tsf_offset_lock) {
    return sim_time + data.tsf_offset;
    }
    }
#[no_mangle]
unsafe extern "C" fn __mac80211_hwsim_get_tsf(data: *mut mac80211_hwsim_data) -> __le64 {
    ...
    {
    struct mac80211_hwsim_data *data = hw.priv;
    let mut now: u64 = mac80211_hwsim_get_tsf(hw, vif);
    let mut delta: u64 = abs(tsf - now);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mac80211_hwsim_addr_match_data {
...
// PS-Poll
    ...
    {
    struct mac80211_hwsim_data *data = hw.priv;
    let mut _portid: u32 = READ_ONCE(data.wmediumd);
    struct sk_buff *skb;
    void *msg_head;
...
#[no_mangle]
pub unsafe extern "C" fn trans_tx_rate_flags_ieee2hwsim(rate: *mut ieee80211_tx_rate) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn mac80211_hwsim_add_vendor_rtap(skb: *mut sk_buff) {
...
// clear reserved field
    ...
    struct ieee80211_tx_info *info = IEEE80211_SKB_CB(skb);
    struct ieee80211_rx_status rx_status;
    let mut sim_tsf: u64 = mac80211_hwsim_get_sim_tsf();
...
#[no_mangle]
pub unsafe extern "C" fn if(IEEE80211_TX_RC_80_MHZ_WIDTH: info->control.rates[0].flags &) -> else {
    else if (info.control.rates[0].flags & IEEE80211_TX_RC_80_MHZ_WIDTH)
    rx_status.bw = RATE_INFO_BW_80;
#[no_mangle]
pub unsafe extern "C" fn if(IEEE80211_TX_RC_160_MHZ_WIDTH: info->control.rates[0].flags &) -> else {
...
// can happen while switching links
    ...
    let mut confbw: enum nl80211_chan_width = NL80211_CHAN_WIDTH_20_NOHT;
    u32 _portid, i;
    let mut tx_link_id: c_int = -1;
...
// No valid channel in current slot, drop frame
    ...
    struct ieee80211_link_sta *link_sta = core::ptr::null_mut();
...
//
    ...
    link, sta ? sta.addr : core::ptr::null_mut(), sta ? sta.mlo : -1);
    ieee80211_free_txskb(hw, skb);
    return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ether_addr_equal(hdr->addr3, _arg: vif->addr)) -> else {
...
// re-assign hdr since skb data may have shifted after encryption
    ...
    let mut rflags: u16 = txi.control.rates[i].flags;
// initialize to data->bw for 5/10 MHz handling
    let mut bw: enum nl80211_chan_width = data.bw;
    if (txi.control.rates[i].idx == -1)
    break;
    if (rflags & IEEE80211_TX_RC_40_MHZ_WIDTH)
    bw = NL80211_CHAN_WIDTH_40;
#[no_mangle]
pub unsafe extern "C" fn if(IEEE80211_TX_RC_80_MHZ_WIDTH: rflags &) -> else {
    else if (rflags & IEEE80211_TX_RC_80_MHZ_WIDTH)
    bw = NL80211_CHAN_WIDTH_80;
#[no_mangle]
pub unsafe extern "C" fn if(IEEE80211_TX_RC_160_MHZ_WIDTH: rflags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn mac80211_hwsim_start(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac80211_hwsim_stop(hw: *mut ieee80211_hw, suspend: bool) {
...
//
    ...
    if (ieee80211_hw_check(hw, SUPPORTS_RC_TABLE)) {
    struct ieee80211_tx_info *txi = IEEE80211_SKB_CB(skb);
    ieee80211_get_tx_rates(txi.control.vif, core::ptr::null_mut(), skb,
    txi.control.rates,
    ARRAY_SIZE(txi.control.rates));
    }
    if (_portid || hwsim_virtio_enabled)
    ...
    if (ieee80211_hw_check(hw, SUPPORTS_RC_TABLE))
    ieee80211_get_tx_rates(vif, core::ptr::null_mut(), skb,
    info.control.rates,
    ...
    let mut link_id: u32 = link_data.link_id;
    ...
    ema.bcn[i].skb);
    ema.bcn[i].skb = core::ptr::null_mut(); /* Already freed */
    }
    ...
    while ((skb = ieee80211_get_buffered_bc(hw, vif)) != core::ptr::null_mut()) {
    mac80211_hwsim_tx_frame(hw, skb,
    rcu_dereference(link_conf.chanctx_conf).def.chan);
    }
...
// TSF is the same for all VIFs, parameter is unused
    tsf_now = mac80211_hwsim_get_tsf(hw, core::ptr::null_mut());
...
// Round TBTT down to the correct time
    ...
    let mut tsf: u64 = mac80211_hwsim_get_tsf(hw, core::ptr::null_mut());
    let mut bcn_int: u32 = link_data.beacon_int;
    let mut until_tbtt: u64 = bcn_int - do_div(tsf, bcn_int);
...
// total_flags = data->rx_filter;
    ...
    let mut usable_links: u16 = ieee80211_vif_usable_links(vif);
    ...
    struct hwsim_vif_priv *vp = (void *)vif.drv_priv;
    struct mac80211_hwsim_data *data = hw.priv;
    let mut link_id: c_uint = info.link_id;
...
// keep last
    ...
    hwsim_testmode_policy, core::ptr::null_mut());
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn hw_scan_work(work: *mut work_struct) {
    ...
    hwsim.hw_scan_request = core::ptr::null_mut();
    hwsim.hw_scan_vif = core::ptr::null_mut();
    hwsim.tmp_chan = core::ptr::null_mut();
    mutex_unlock(&hwsim.mutex);
...
#[no_mangle]
unsafe extern "C" fn hw_roc_start(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn hw_roc_done(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mac80211_hwsim_tx_last_beacon(hw: *mut ieee80211_hw) -> c_int {
...
// hwsim ignores the use_rts instruction from mac80211 anyway
    ...
    {
    let mut rem: c_ulong = old_links & ~new_links;
    let mut add: c_ulong = new_links & ~old_links;
    int i;
    if (!old_links)
    rem |= BIT(0);
    if (!new_links)
    ...
    data.pmsr_request = core::ptr::null_mut();
    data.pmsr_request_wdev = core::ptr::null_mut();
    _portid = READ_ONCE(data.wmediumd);
    if (!_portid && !hwsim_virtio_enabled)
    goto out;
    skb = genlmsg_new(GENLMSG_DEFAULT_SIZE, GFP_KERNEL);
...
#[no_mangle]
unsafe extern "C" fn hwsim_pmsr_report_nl(msg: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    let mut result: cfg80211_pmsr_result = {};
...
// Macro flag: #define HWSIM_DEBUGFS_OPS
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hwsim_new_radio_params {
    pub channels: c_uint,
    pub reg_alpha2: *const c_char,
    ...
    pub hwname: *const c_char,
    pub no_vif: bool,
    pub perm_addr: *const u8,
    pub iftypes: u32,
    pub ciphers: *mut u32,
    pub n_ciphers: u8,
    pub mlo: bool,
...
#[no_mangle]
unsafe extern "C" fn mac80211_hwsim_sband_capab(sband: *mut ieee80211_supported_band) {
...
pub const HWSIM_MESH_BIT: c_int = 0;
    ...
    struct net *net;
    int idx, i;
    let mut n_limits: c_int = 0;
    let mut n_bands: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: param->use_chanctx) -> else {
...
// ieee80211_alloc_hw_nm may have used a default name
    ...
    data = hw.priv;
    data.hw = hw;
    data.dev = device_create(&hwsim_class, core::ptr::null_mut(), 0, hw, "hwsim%d", idx);
    if (IS_ERR(data.dev)) {
    printk(KERN_DEBUG
...
// give the regulatory workqueue a chance to run
    ...
    {
    void *hdr;
    let mut param: hwsim_new_radio_params = { };
    let mut res: c_int = -EMSGSIZE;
...
#[no_mangle]
unsafe extern "C" fn mac80211_hwsim_free() {
...
#[no_mangle]
unsafe extern "C" fn hwsim_mon_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn hwsim_register_wmediumd(net: *mut net, portid: u32) {
...
// now send back TX status
    ...
    void *frame_data;
    struct sk_buff *skb = core::ptr::null_mut();
    struct ieee80211_channel *channel = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn hwsim_known_ciphers(ciphers: *const u32, n_ciphers: c_int) -> bool {
    ...
    hwsim_ftm_role_capa_policy, core::ptr::null_mut())) {
    ...
    hwsim_ftm_type_capa_policy, core::ptr::null_mut())) {
    ...
    int size;
    int ret;
    ret = nla_parse_nested(tb, NL80211_PMSR_ATTR_MAX, pmsr_capa, hwsim_pmsr_capa_policy, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn hwsim_new_radio_nl(msg: *mut sk_buff, info: *mut genl_info) -> c_int {
    static int hwsim_new_radio_nl(struct sk_buff *msg, struct genl_info *info)
    {
    let mut param: hwsim_new_radio_params = { 0 };
    const char *hwname = core::ptr::null_mut();
    int ret;
    ...
    let mut idx: u32 = nla_get_u32(info.attrs[HWSIM_ATTR_REG_CUSTOM_REG]);
...
// ensure both flag and iftype support is honored
    ...
    let mut len: u32 = nla_len(info.attrs[HWSIM_ATTR_CIPHER_SUPPORT]);
    param.ciphers =
...
#[no_mangle]
unsafe extern "C" fn hwsim_del_radio_nl(msg: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwsim_get_radio_nl(msg: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    info.snd_seq, core::ptr::null_mut(), 0);
    if (res < 0) {
    nlmsg_free(skb);
    goto out_err;
    }
    ...
    {
    let mut last_idx: c_int = cb.args[0] - 1;
    struct mac80211_hwsim_data *data = core::ptr::null_mut();
    let mut res: c_int = 0;
    void *hdr;
    spin_lock_bh(&hwsim_radio_lock);
...
#[no_mangle]
unsafe extern "C" fn remove_user_radios(portid: u32, netgroup: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hwsim_init_netlink() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hwsim_init_net(net: *mut net) -> __net_init int {
    static __net_init int hwsim_init_net(struct net *net)
    {
    return hwsim_net_set_netgroup(net);
    }
#[no_mangle]
unsafe extern "C" fn hwsim_exit_net(net: *mut net) -> void __net_exit {
...
#[no_mangle]
unsafe extern "C" fn hwsim_exit_netlink() {
...
#[no_mangle]
unsafe extern "C" fn hwsim_virtio_tx_done(vq: *mut virtqueue) {
...
unsafe extern "C" fn hwsim_virtio_handle_cmd(skb: *mut sk_buff) -> c_int {
    ...
    hwsim_genl_policy, core::ptr::null_mut());
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn hwsim_virtio_rx_work(work: *mut work_struct) {
    static void hwsim_virtio_rx_work(struct work_struct *work)
    {
    struct virtqueue *vq;
    unsigned int len;
...
#[no_mangle]
unsafe extern "C" fn hwsim_virtio_rx_done(vq: *mut virtqueue) {
    static void hwsim_virtio_rx_done(struct virtqueue *vq)
    {
    schedule_work(&hwsim_virtio_rx);
    }
#[no_mangle]
unsafe extern "C" fn init_vqs(vdev: *mut virtio_device) -> c_int {
    ...
    hwsim_vqs, vqs_info, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn fill_vq(vq: *mut virtqueue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_vqs(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn hwsim_virtio_probe(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwsim_virtio_remove(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn hwsim_register_virtio_driver() -> c_int {
    static int hwsim_register_virtio_driver(void)
    {
    return register_virtio_driver(&virtio_hwsim);
    }
#[no_mangle]
unsafe extern "C" fn hwsim_unregister_virtio_driver() {
...
#[no_mangle]
pub unsafe extern "C" fn hwsim_register_virtio_driver() -> c_int {
    static inline int hwsim_register_virtio_driver(void)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn hwsim_unregister_virtio_driver() {
    static inline void hwsim_unregister_virtio_driver(void)
    {
    }

#[no_mangle]
unsafe extern "C" fn init_mac80211_hwsim() -> int __init {
    ...
    param.regd = &hwsim_world_regdom_custom_03;
#[no_mangle]
pub unsafe extern "C" fn if(1: i ==) -> else {
    else if (i == 1)
    ...
    if (param.p2p_device)
    param.iftypes |= BIT(NL80211_IFTYPE_P2P_DEVICE);
    err = mac80211_hwsim_new_radio(core::ptr::null_mut(), &param);
    if (err < 0)
    goto out_free_radios;
    }
    hwsim_mon = alloc_netdev(0, "hwsim%d", NET_NAME_UNKNOWN,
    hwsim_mon_setup);
    if (hwsim_mon == core::ptr::null_mut()) {
    err = -ENOMEM;
    goto out_free_radios;
    }
    rtnl_lock();
...
#[no_mangle]
unsafe extern "C" fn exit_mac80211_hwsim() -> void __exit {
