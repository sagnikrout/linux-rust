...
//! Source: drivers/net/wireless/virtual/mac80211_hwsim.h
#![no_std]
...
pub enum hwsim_tx_control_flags {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum hwsim_rate_info_attributes {
