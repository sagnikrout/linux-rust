...
//! Source: drivers/net/wireless/realtek/rtw88/mac80211.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rtw_ops_start(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw_ops_stop(hw: *mut ieee80211_hw, suspend: bool) {
...
#[no_mangle]
unsafe extern "C" fn rtw_ops_config(hw: *mut ieee80211_hw, radio_idx: c_int, changed: u32) -> c_int {
...
// let previous ips work finish to ensure we don't leave ips twice
    ...
    rtwvif.scan_req = core::ptr::null_mut();
    ...
    rtw_recalc_lps(rtwdev, core::ptr::null_mut());
    mutex_unlock(&rtwdev.mutex);
    }
...
// Only have one group of EDCA parameters now
    ...
    let mut edca_param: u32 = ac_to_edca_param[ac];
    u8 ecw_max, ecw_min;
    u8 aifs;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtw_iter_bitrate_mask_data {
...
#[no_mangle]
unsafe extern "C" fn rtw_ra_mask_info_update_iter(data: *mut c_void, sta: *mut ieee80211_sta) {
...
#[no_mangle]
unsafe extern "C" fn rtw_ops_resume(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw_ops_set_wakeup(hw: *mut ieee80211_hw, enabled: bool) {
