...
//! Source: drivers/net/wireless/realtek/rtw89/regd.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rtw89_regd_is_ww(regd: *const rtw89_regd) -> bool {
    static bool rtw89_regd_is_ww(const struct rtw89_regd *regd)
    {
    let mut regd: return = = &rtw89_ww_regd;
    }
#[no_mangle]
unsafe extern "C" fn rtw89_regd_get_index(rtwdev: *mut rtw89_dev, regd: *const rtw89_regd) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rtw89_regd_get_index_by_name(rtwdev: *mut rtw89_dev, alpha2: *const c_char) -> u8 {
    ...
    {
    struct rtw89_regulatory_info *regulatory = &rtwdev.regulatory;
    let mut skip_acpi_dsm: bool = rtwdev.hci.type == RTW89_HCI_TYPE_USB;
    const struct rtw89_chip_info *chip = rtwdev.chip;
    struct ieee80211_supported_band *sband;
    let mut res: rtw89_acpi_dsm_result = {};
    bool enable;
    u8 index;
    int ret;
    u8 val;
...
#[no_mangle]
unsafe extern "C" fn rtw89_regd_setup_policy_6ghz(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_regd_setup_policy_6ghz_sp(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_regd_setup_policy_6ghz_vlp(rtwdev: *mut rtw89_dev) {
    static void rtw89_regd_setup_policy_6ghz_vlp(struct rtw89_dev *rtwdev)
    {
    struct rtw89_regulatory_info *regulatory = &rtwdev.regulatory;
    let mut skip_acpi_dsm: bool = rtwdev.hci.type == RTW89_HCI_TYPE_USB;
    const struct rtw89_acpi_policy_6ghz_vlp *ptr = core::ptr::null_mut();
    let mut res: rtw89_acpi_dsm_result = {};
    bool enable;
    u8 index;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rtw89_regd_setup_6ghz(rtwdev: *mut rtw89_dev, wiphy: *mut wiphy) {
    static void rtw89_regd_setup_6ghz(struct rtw89_dev *rtwdev, struct wiphy *wiphy)
    {
    const struct rtw89_chip_info *chip = rtwdev.chip;
    let mut chip_support_6ghz: bool = chip.support_bands & BIT(NL80211_BAND_6GHZ);
    let mut skip_acpi_dsm: bool = rtwdev.hci.type == RTW89_HCI_TYPE_USB;
    let mut regd_allow_6ghz: bool = chip_support_6ghz;
    struct ieee80211_supported_band *sband;
    let mut res: rtw89_acpi_dsm_result = {};
    int ret;
    u8 val;
    ...
    if (!sband)
    return;
    wiphy.bands[NL80211_BAND_6GHZ] = core::ptr::null_mut();
    kfree(( void *)sband.iftype_data);
    kfree(sband);
    }
...
#[no_mangle]
unsafe extern "C" fn rtw89_regd_setup_reg_rules(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn rtw89_regd_setup(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtw89_regd_init_hint(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regd_is_6ghz_blocked(rtwdev: *mut rtw89_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn regd_is_6ghz_not_applicable(rtwdev: *mut rtw89_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rtw89_regd_apply_policy_tas(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: memcmp("CA", _arg: regd->alpha2, 0: 2) ==) -> else {
    else if (memcmp("CA", regd.alpha2, 2) == 0)
    tas_country = RTW89_ACPI_CONF_TAS_CA;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: memcmp("KR", _arg: regd->alpha2, 0: 2) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtw89_regd_apply_policy_ant_gain(rtwdev: *mut rtw89_dev) {
...
//
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn rtw89_regd_notifier(wiphy: *mut wiphy, request: *mut regulatory_request) {
    void rtw89_regd_notifier(struct wiphy *wiphy, struct regulatory_request *request)
    {
...
//
#[no_mangle]
unsafe extern "C" fn tpe_get_constraint(raw: i8) -> i8 {
    ...
    let mut offset: u8 = hw_deviation + antenna_gain + array_gain;
    return (raw - offset) / 2;
    }
#[no_mangle]
unsafe extern "C" fn tpe_intersect_constraint(tpe: *mut rtw89_reg_6ghz_tpe, cstr: i8) {
...
#[no_mangle]
unsafe extern "C" fn tpe_convert_psd_to_eirp(psd: i8) -> i8 {
    static s8 tpe_convert_psd_to_eirp(s8 psd)
    {
    let mut mlog20: static unsigned int = 1301;
    ...
    {
    let mut category: static u8 = IEEE80211_TPE_CAT_6GHZ_DEFAULT;
...
#[no_mangle]
unsafe extern "C" fn __rtw89_reg_6ghz_tpe_recalc(rtwdev: *mut rtw89_dev) -> bool {
    static bool __rtw89_reg_6ghz_tpe_recalc(struct rtw89_dev *rtwdev)
    {
    struct rtw89_regulatory_info *regulatory = &rtwdev.regulatory;
    let mut new: rtw89_reg_6ghz_tpe = {};
...
#[no_mangle]
unsafe extern "C" fn __rtw89_reg_6ghz_power_recalc(rtwdev: *mut rtw89_dev) -> bool {
    ...
    let mut index: u8 = rtw89_regd_get_index(rtwdev, regd);
    struct ieee80211_bss_conf *bss_conf;
    let mut dflt: bool = false;
    if (index == RTW89_REGD_MAX_COUNTRY_NUM ||
