...
//! Source: drivers/net/wireless/realtek/rtw89/mac_be.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn is_qta_poh(rtwdev: *mut rtw89_dev) -> bool {
    static bool is_qta_poh(struct rtw89_dev *rtwdev)
    {
    return rtwdev.hci.type == RTW89_HCI_TYPE_PCIE;
    }
#[no_mangle]
unsafe extern "C" fn hfc_get_mix_info_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn hfc_h2c_cfg_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn hfc_mix_cfg_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn hfc_func_en_be(rtwdev: *mut rtw89_dev, en: bool, h2c_en: bool) {
...
#[no_mangle]
unsafe extern "C" fn dle_func_en_be(rtwdev: *mut rtw89_dev, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn dle_clk_en_be(rtwdev: *mut rtw89_dev, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn dle_mix_cfg_be(rtwdev: *mut rtw89_dev, cfg: *const rtw89_dle_mem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chk_dle_rdy_be(rtwdev: *mut rtw89_dev, wde_or_ple: bool) -> c_int {
    ...
    let mut max_qt_wcpu: u16 = max(max_cfg.wcpu, min_qt_wcpu);
    u32 val;
    SET_QUOTA(hif, WDE, 0);
...
#[no_mangle]
unsafe extern "C" fn rtw89_mac_hci_func_en_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_mac_dmac_func_pre_en_be(rtwdev: *mut rtw89_dev) {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn rtw89_mac_write_xtal_si_be(rtwdev: *mut rtw89_dev, offset: u8, val: u8, mask: u8) -> c_int {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn rtw89_mac_read_xtal_si_be(rtwdev: *mut rtw89_dev, offset: u8, val: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_mac_reset_pwr_state_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_mac_disable_cpu_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_mac_fwdl_preconfig_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn set_cpu_en(rtwdev: *mut rtw89_dev, include_bb: bool) {
    static void set_cpu_en(struct rtw89_dev *rtwdev, bool include_bb)
    {
    let mut set: u32 = B_BE_WLANCPU_FWDL_EN;
    if (include_bb)
    set |= B_BE_BBMCU0_FWDL_EN;
    rtw89_write32_set(rtwdev, R_BE_WCPU_FW_CTRL, set);
    }
#[no_mangle]
unsafe extern "C" fn wcpu_on(rtwdev: *mut rtw89_dev, boot_reason: u8, dlfw: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fwdl_get_status_be(rtwdev: *mut rtw89_dev, type: enum rtw89_fwdl_check_type) -> u8 {
    ...
    bool h2c_or_fwdl)
    {
    let mut check: u32 = h2c_or_fwdl ? B_BE_H2C_PATH_RDY : B_BE_DLFW_PATH_RDY;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn dmac_func_en_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmac_share_func_en_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmac_pwr_en_be(rtwdev: *mut rtw89_dev, mac_idx: u8, en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmac_func_en_be(rtwdev: *mut rtw89_dev, mac_idx: u8, en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chip_func_en_be(rtwdev: *mut rtw89_dev) -> c_int {
    static int chip_func_en_be(struct rtw89_dev *rtwdev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn sys_init_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac_func_en_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sta_sch_init_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpdu_proc_init_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sec_eng_init_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn txpktctrl_init_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlo_init_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmac_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scheduler_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn addr_cam_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rx_fltr_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cca_ctrl_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
    static int cca_ctrl_init_be(struct rtw89_dev *rtwdev, u8 mac_idx)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn nav_ctrl_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spatial_reuse_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmac_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn trxptcl_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rst_bacam_be(rtwdev: *mut rtw89_dev) -> c_int {
...
pub const PLD_RLS_MAX_PG: c_int = 127;
pub const RX_MAX_LEN_UNIT: c_int = 512;

#[no_mangle]
unsafe extern "C" fn rmac_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn resp_pktctl_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmac_com_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ptcl_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmac_dma_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmac_init_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx_idle_poll_band_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dle_buf_req_be(rtwdev: *mut rtw89_dev, buf_len: u16, wd: bool, pkt_id: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dle_quota_change_be(rtwdev: *mut rtw89_dev, band1_en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clr_aon_intr_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn dbcc_bb_ctrl_be(rtwdev: *mut rtw89_dev, bb1_en: bool) -> c_int {
    static int dbcc_bb_ctrl_be(struct rtw89_dev *rtwdev, bool bb1_en)
    {
    let mut set: u32 = B_BE_FEN_BB1PLAT_RSTB | B_BE_FEN_BB1_IP_RSTN;
    if (bb1_en)
...
#[no_mangle]
pub unsafe extern "C" fn if(RTW89_CMAC_SEL: sel ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn err_imr_ctrl_be(rtwdev: *mut rtw89_dev, en: bool) {
    static void err_imr_ctrl_be(struct rtw89_dev *rtwdev, bool en)
    {
    let mut v32_dmac: u32 = en ? DMAC_ERR_IMR_EN : DMAC_ERR_IMR_DIS;
    let mut v32_cmac0: u32 = en ? CMAC0_ERR_IMR_EN : CMAC0_ERR_IMR_DIS;
    let mut v32_cmac1: u32 = en ? CMAC1_ERR_IMR_EN : CMAC1_ERR_IMR_DIS;
...
#[no_mangle]
unsafe extern "C" fn band1_enable_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn band1_disable_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dbcc_enable_be(rtwdev: *mut rtw89_dev, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_host_rpr_be(rtwdev: *mut rtw89_dev) -> c_int {
    static int set_host_rpr_be(struct rtw89_dev *rtwdev)
    {
    let mut chip_id: enum rtw89_core_chip_id = rtwdev.chip.chip_id;
    u32 val32;
    u32 mode;
    u32 fltr;
    u32 qid;
...
#[no_mangle]
unsafe extern "C" fn trx_init_be(rtwdev: *mut rtw89_dev) -> c_int {
    static int trx_init_be(struct rtw89_dev *rtwdev)
    {
    let mut chip_id: enum rtw89_core_chip_id = rtwdev.chip.chip_id;
    let mut qta_mode: enum rtw89_qta_mode = rtwdev.mac.qta_mode;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn rtw89_mac_cfg_ctrl_path_v2(rtwdev: *mut rtw89_dev, wl: bool) -> c_int {
    int rtw89_mac_cfg_ctrl_path_v2(struct rtw89_dev *rtwdev, bool wl)
    {
    const struct rtw89_chip_info *chip = rtwdev.chip;
    let mut gnt: rtw89_mac_ax_coex_gnt = {};
    int i;
    if (wl)
    return 0;
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn rtw89_mac_cfg_plt_be(rtwdev: *mut rtw89_dev, plt: *mut rtw89_mac_ax_plt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_mac_get_plt_cnt_be(rtwdev: *mut rtw89_dev, band: u8) -> u16 {
    ...
    {
    let mut reg: u32 = rtw89_mac_reg_by_idx(rtwdev, R_BE_CTN_DRV_TXEN, mac_idx);
    u32 val;
    int ret;
    ret = rtw89_mac_check_mac_en(rtwdev, mac_idx, RTW89_CMAC_SEL);
    if (ret)
...
#[no_mangle]
pub unsafe extern "C" fn rtw89_mac_resume_sch_tx_v2(rtwdev: *mut rtw89_dev, mac_idx: u8, tx_en: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtw89_mac_cfg_phy_rpt_be(rtwdev: *mut rtw89_dev, mac_idx: u8, enable: bool) {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn rtw89_mac_set_edcca_mode_be(rtwdev: *mut rtw89_dev, mac_idx: u8, normal: bool) {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn rtw89_mac_set_vcore_cfg_be(rtwdev: *mut rtw89_dev, vlv: u8) {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn rtw89_mac_cfg_ppdu_status_be(rtwdev: *mut rtw89_dev, mac_idx: u8, enable: bool) -> c_int {
    int rtw89_mac_cfg_ppdu_status_be(struct rtw89_dev *rtwdev, u8 mac_idx, bool enable)
    {
    let mut reg: u32 = rtw89_mac_reg_by_idx(rtwdev, R_BE_PPDU_STAT, mac_idx);
    int ret;
    ret = rtw89_mac_check_mac_en(rtwdev, mac_idx, RTW89_CMAC_SEL);
    if (ret)
    return ret;
    ...
    u32 reg_base, u32 *cr)
    {
    let mut mode: enum rtw89_qta_mode = rtwdev.mac.qta_mode;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rtw89_mac_init_bfee_be(rtwdev: *mut rtw89_dev, mac_idx: u8) -> c_int {
    ...
    {
    let mut nc: u8 = 1, nr = 3, ng = 0, cb = 1, cs = 1, ldpc_en = 1, stbc_en = 1;
    struct ieee80211_link_sta *link_sta;
    let mut mac_idx: u8 = rtwvif_link.mac_idx;
    let mut port_sel: u8 = rtwvif_link.port;
    let mut sound_dim: u8 = 3, t;
    u8 *phy_cap;
    u32 reg;
    u16 val;
    int ret;
...
// Disable stbc_en in VHT 160MHz to avoid IOT issues with certain APs
    ...
    struct rtw89_sta_link *rtwsta_link)
    {
    let mut rrsc: u32 = BIT(RTW89_MAC_BF_RRSC_6M) | BIT(RTW89_MAC_BF_RRSC_24M);
    struct ieee80211_link_sta *link_sta;
    let mut mac_idx: u8 = rtwvif_link.mac_idx;
    int ret;
    u32 reg;
...
#[no_mangle]
unsafe extern "C" fn dump_err_status_dispatcher_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_mac_dump_qta_lost_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_wow_config_mac_be(rtwdev: *mut rtw89_dev, enable_wow: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac_is_txq_empty_be(rtwdev: *mut rtw89_dev) -> bool {
...
//
    ...
    .fwdl_secure_idmem_share_mode = core::ptr::null_mut(),
