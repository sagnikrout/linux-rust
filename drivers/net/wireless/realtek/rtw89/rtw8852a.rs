...
//! Source: drivers/net/wireless/realtek/rtw89/rtw8852a.h
#![no_std]
...
pub const RF_PATH_NUM_8852A: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum rtw8852a_pmac_mode {
    NONE_TEST,
    PKTS_TX,
    PKTS_RX,
    CONT_TX
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtw8852ae_efuse {
    pub mac_addr: [u8; ETH_ALEN],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtw8852a_tssi_offset {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtw8852a_efuse {
    pub rsvd: [u8; 0x210],
    pub path_a_tssi: rtw8852a_tssi_offset,
    pub rsvd1: [u8; 10],
    pub path_b_tssi: rtw8852a_tssi_offset,
    pub rsvd2: [u8; 94],
    pub channel_plan: u8,
    pub xtal_k: u8,
    pub rsvd3: u8,
    ...
    pub rsvd9: [u8; 0xf2],
    pub u: rtw8852au_efuse,
    pub e: rtw8852ae_efuse,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtw8852a_bb_pmac_info {
    pub en_pmac_tx:1: u8,
    pub is_cck:1: u8,
    pub mode:3: u8,
    pub rsvd:3: u8,
...
extern "C" {
    pub fn rtw8852a_bb_set_plcp_tx(rtwdev: *mut rtw89_dev);
}
extern "C" {
    pub fn rtw8852a_bb_cfg_tx_path(rtwdev: *mut rtw89_dev, tx_path: u8);
}
