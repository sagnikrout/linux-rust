...
//! Source: drivers/net/wireless/realtek/rtw89/efuse_be.c
#![no_std]
...
pub const EFUSE_EXTERNALPN_ADDR_BE: c_uint = 0x1580;
pub const EFUSE_SERIALNUM_ADDR_BE: c_uint = 0x1581;
pub const EFUSE_SB_CRYP_SEL_ADDR: c_uint = 0x1582;
pub const EFUSE_SB_CRYP_SEL_SIZE: c_int = 2;
pub const EFUSE_SB_CRYP_SEL_DEFAULT: c_uint = 0xFFFF;
pub const SB_SEL_MGN_MAX_SIZE: c_int = 2;
pub const EFUSE_SEC_BE_START: c_uint = 0x1580;
pub const EFUSE_SEC_BE_SIZE: c_int = 4;
pub const EFUSE_VCORE_PWR_BE: c_uint = 0x17D6;

pub const SWR_DIG_MIN: c_int = 860;
pub const EFUSE_DIG_K_STEP: c_uint = 0xC;
pub const EFUSE_DSWR_V0_86_BE: c_uint = 0x17DA;

    static const u32 sb_sel_mgn[SB_SEL_MGN_MAX_SIZE] = {
    0x8000100, 0xC000180
    };
#[no_mangle]
unsafe extern "C" fn rtw89_enable_efuse_pwr_cut_ddv_be(rtwdev: *mut rtw89_dev) {
    static void rtw89_enable_efuse_pwr_cut_ddv_be(struct rtw89_dev *rtwdev)
    {
    const struct rtw89_chip_info *chip = rtwdev.chip;
    struct rtw89_hal *hal = &rtwdev.hal;
    let mut aphy_patch: bool = true;
...
#[no_mangle]
unsafe extern "C" fn rtw89_disable_efuse_pwr_cut_ddv_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn rtw89_cnv_efuse_state_be(rtwdev: *mut rtw89_dev, idle: bool) -> c_int {
    ...
    let mut size: u32 = efuse_block.size;
    u32 phy_idx, log_idx;
    u32 hdr, page_offset;
    u8 hdr1, hdr2, hdr3;
    u8 i, val0, val1;
...
#[no_mangle]
pub unsafe extern "C" fn rtw89_parse_efuse_map_be(rtwdev: *mut rtw89_dev) -> c_int {
    int rtw89_parse_efuse_map_be(struct rtw89_dev *rtwdev)
    {
    let mut phy_size: u32 = rtwdev.chip.physical_efuse_size;
    let mut dav_phy_size: u32 = rtwdev.chip.dav_phy_efuse_size;
    enum rtw89_efuse_block block;
    u8 *phy_map = core::ptr::null_mut();
    u8 *dav_phy_map = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn rtw89_parse_phycap_map_be(rtwdev: *mut rtw89_dev) -> c_int {
    int rtw89_parse_phycap_map_be(struct rtw89_dev *rtwdev)
    {
    let mut phycap_addr: u32 = rtwdev.chip.phycap_addr;
    let mut phycap_size: u32 = rtwdev.chip.phycap_size;
    u8 *phycap_map = core::ptr::null_mut();
    let mut ret: c_int = 0;
    if (!phycap_size)
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(1: cnt_zero >) -> else {
    else if (cnt_zero > 1)
    return U16_MAX;
    }
...
#[no_mangle]
pub unsafe extern "C" fn rtw89_efuse_read_fw_secure_be(rtwdev: *mut rtw89_dev) -> c_int {
    int rtw89_efuse_read_fw_secure_be(struct rtw89_dev *rtwdev)
    {
    struct rtw89_fw_secure *sec = &rtwdev.fw.sec;
    let mut sec_addr: u32 = EFUSE_SEC_BE_START;
    let mut sec_size: u32 = EFUSE_SEC_BE_SIZE;
...
#[no_mangle]
pub unsafe extern "C" fn rtw89_efuse_read_ecv_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtw89_efuse_read_thermal_k_be(rtwdev: *mut rtw89_dev) -> c_int {
    int rtw89_efuse_read_thermal_k_be(struct rtw89_dev *rtwdev)
    {
    struct rtw89_power_trim_info *info = &rtwdev.pwr_trim;
    let mut dump_addr: u32 = EFUSE_THERMAL_K_OFFSET_BE;
...
#[no_mangle]
unsafe extern "C" fn rtw89_efuse_read_pwr_data_vcore_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_efuse_read_pwr_data_dswr_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtw89_efuse_read_pwr_data_be(rtwdev: *mut rtw89_dev) -> c_int {
