...
//! Source: drivers/net/wireless/realtek/rtw89/mac80211.c
#![no_std]
...
//
    ...
    let mut flags: u32 = IEEE80211_SKB_CB(skb).flags;
    int ret, qsel;
...
#[no_mangle]
unsafe extern "C" fn rtw89_ops_start(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_ops_stop(hw: *mut ieee80211_hw, suspend: bool) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_ops_config(hw: *mut ieee80211_hw, radio_idx: c_int, changed: u32) -> c_int {
...
// let previous ips work finish to ensure we don't leave ips twice
    ...
    if (ret)
    return ret;
    rtw89_btc_ntfy_role_info(rtwdev, rtwvif_link, core::ptr::null_mut(), BTC_ROLE_START);
    return 0;
    }
    ...
    rtw89_leave_ps_mode(rtwdev);
    rtw89_btc_ntfy_role_info(rtwdev, rtwvif_link, core::ptr::null_mut(), BTC_ROLE_STOP);
    ...
    struct rtw89_dev *rtwdev = hw.priv;
    struct rtw89_vif *rtwvif = vif_to_rtwvif(vif);
    let mut macid: u8 = rtw89_vif_get_main_macid(rtwvif);
    let mut port: u8 = rtw89_vif_get_main_port(rtwvif);
    struct rtw89_vif_link *rtwvif_link;
    lockdep_assert_wiphy(hw.wiphy);
    ...
    rtwdev.pure_monitor_mode_vif = core::ptr::null_mut();
    rtw89_recalc_lps(rtwdev);
...
// 2^ecw - 1 = cw; ecw = log2(cw + 1)
    ...
    let mut gen: c_int = rtwdev.chip.chip_gen;
    u8 aifs, aifsn;
    u16 timer_32us;
    u32 reg;
    u32 val;
    ...
    let mut acquire_macid: bool = false;
    u8 macid;
    int ret;
    int i;
...
// for station mode, assign the mac_id from itself
    ...
    {
    struct rtw89_sta *rtwsta = sta_to_rtwsta(sta);
    let mut macid: u8 = rtw89_sta_get_main_macid(rtwsta);
    struct rtw89_vif_link *rtwvif_link;
    struct rtw89_sta_link *rtwsta_link;
    unsigned int link_id;
    int ret;
...
// Specify for all MAC ID
    ...
    rtw89_fw_h2c_cam(rtwdev, rtwvif_link, core::ptr::null_mut(), core::ptr::null_mut(), RTW89_ROLE_INFO_CHANGE);
    ...
    ret = rtw89_chip_h2c_assoc_cmac_tbl(rtwdev, rtwvif_link, core::ptr::null_mut());
    if (ret) {
    rtw89_warn(rtwdev, "failed to send h2c cmac table\n");
    return ret;
    }
    ret = rtw89_fw_h2c_role_maintain(rtwdev, rtwvif_link, core::ptr::null_mut(), RTW89_ROLE_TYPE_CHANGE);
    if (ret) {
    rtw89_warn(rtwdev, "failed to send h2c role info\n");
    return ret;
    }
    ret = rtw89_fw_h2c_join_info(rtwdev, rtwvif_link, core::ptr::null_mut(), true);
    if (ret) {
    rtw89_warn(rtwdev, "failed to send h2c join info\n");
    return ret;
    }
    ret = rtw89_fw_h2c_cam(rtwdev, rtwvif_link, core::ptr::null_mut(), core::ptr::null_mut(), RTW89_ROLE_TYPE_CHANGE);
    if (ret) {
    ...
    rtw89_chip_h2c_assoc_cmac_tbl(rtwdev, rtwvif_link, core::ptr::null_mut());
    rtw89_fw_h2c_join_info(rtwdev, rtwvif_link, core::ptr::null_mut(), true);
    }
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn __rtw89_drop_packets(rtwdev: *mut rtw89_dev, vif: *mut ieee80211_vif) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtw89_iter_bitrate_mask_data {
...
#[no_mangle]
unsafe extern "C" fn rtw89_ra_mask_info_update_iter(data: *mut c_void, sta: *mut ieee80211_sta) {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn rtw89_ops_set_antenna(hw: *mut ieee80211_hw, radio_idx: c_int, tx_ant: u32, rx_ant: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_set_tid_config_iter(data: *mut c_void, sta: *mut ieee80211_sta) {
    ...
    struct rtw89_dev *rtwdev = hw.priv;
    struct rtw89_vif *rtwvif = vif_to_rtwvif(vif);
    let mut current_links: u16 = vif.active_links;
...
// Do follow-up when all updating links exist.
    ...
    struct rtw89_dev *rtwdev = hw.priv;
    struct rtw89_vif *rtwvif = vif_to_rtwvif(vif);
    let mut clr_links: c_ulong = old_links & ~new_links;
    let mut set_links: c_ulong = new_links & ~old_links;
    let mut removing_links: bool = !old_links || clr_links;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: clr_links) -> else {
    else if (clr_links)
...
//
    rcu_assign_pointer(rtwvif.snap_link_confs, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rtw89_ops_resume(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_ops_set_wakeup(hw: *mut ieee80211_hw, enabled: bool) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_ops_rfkill_poll(hw: *mut ieee80211_hw) {
