...
//! Source: drivers/net/wireless/realtek/rtw89/pci_be.c
#![no_std]
...
pub const PL0_TMR_SCALE_ASIC: c_int = 1;
pub const PL0_TMR_ANA_172US: c_uint = 0x800;
pub const PL0_TMR_MAC_1MS: c_uint = 0x27100;
pub const PL0_TMR_AUX_1MS: c_uint = 0x1E848;
#[no_mangle]
unsafe extern "C" fn rtw89_pci_aspm_set_be(rtwdev: *mut rtw89_dev, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_l1ss_set_be(rtwdev: *mut rtw89_dev, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_clkreq_set_be(rtwdev: *mut rtw89_dev, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn _patch_pcie_power_wake_be(rtwdev: *mut rtw89_dev, power_up: bool) {
...
#[no_mangle]
unsafe extern "C" fn _patch_pre_init_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_set_io_rcy_be(rtwdev: *mut rtw89_dev) {
    static void rtw89_pci_set_io_rcy_be(struct rtw89_dev *rtwdev)
    {
    const struct rtw89_pci_info *info = rtwdev.pci_info;
    let mut scale: u32 = PL0_TMR_SCALE_ASIC;
    u32 val32;
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_ctrl_wpdma_pcie_be(rtwdev: *mut rtw89_dev, en: bool) {
    ...
    val |= B_BE_TXDMA_EN;
#[no_mangle]
pub unsafe extern "C" fn if(MAC_AX_PCIE_DISABLE: tx_en ==) -> else {
    else if (tx_en == MAC_AX_PCIE_DISABLE)
    val &= ~B_BE_TXDMA_EN;
    if (rx_en == MAC_AX_PCIE_ENABLE)
    val |= B_BE_RXDMA_EN;
#[no_mangle]
pub unsafe extern "C" fn if(MAC_AX_PCIE_DISABLE: rx_en ==) -> else {
    else if (rx_en == MAC_AX_PCIE_DISABLE)
    val &= ~B_BE_RXDMA_EN;
    if (io_en == MAC_AX_PCIE_ENABLE)
    val &= ~B_BE_STOP_AXI_MST;
#[no_mangle]
pub unsafe extern "C" fn if(MAC_AX_PCIE_DISABLE: io_en ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_clr_idx_all_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_poll_txdma_ch_idle_be(rtwdev: *mut rtw89_dev) -> c_int {
    static int rtw89_pci_poll_txdma_ch_idle_be(struct rtw89_dev *rtwdev)
    {
    const struct rtw89_pci_info *info = rtwdev.pci_info;
    let mut dma_busy1: u32 = info.dma_busy1.addr;
    let mut check: u32 = info.dma_busy1.mask;
    u32 val;
    return read_poll_timeout(rtw89_read32, val, (val & check) == 0,
    10, 1000, false, rtwdev, dma_busy1);
    }
#[no_mangle]
unsafe extern "C" fn rtw89_pci_poll_rxdma_ch_idle_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_poll_dma_all_idle_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_mode_op_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_rst_bdram_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_debounce_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_ldo_low_pwr_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_pcie_setting_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_ser_setting_be(rtwdev: *mut rtw89_dev) {
    ...
    goto be2_chips;
#[no_mangle]
pub unsafe extern "C" fn if(RTL8922A: chip_id !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_ctrl_txdma_ch_be(rtwdev: *mut rtw89_dev, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_ctrl_txdma_fw_ch_be(rtwdev: *mut rtw89_dev, enable: bool) {
    static void rtw89_pci_ctrl_txdma_fw_ch_be(struct rtw89_dev *rtwdev, bool enable)
    {
    let mut val: u32 = rtw89_read32(rtwdev, R_BE_HAXI_DMA_STOP1);
    if (enable)
    val &= ~B_BE_STOP_CH12;
    else
    val |= B_BE_STOP_CH12;
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_ops_mac_pre_init_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_ops_mac_pre_deinit_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtw89_pci_ltr_set_v2(rtwdev: *mut rtw89_dev, en: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_configure_mit_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_ops_mac_post_init_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_poll_io_idle_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_lv1rst_stop_dma_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_lv1rst_start_dma_be(rtwdev: *mut rtw89_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_disable_eq_be(rtwdev: *mut rtw89_dev) {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_suspend_be(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn rtw89_pci_resume_be(dev: *mut device) -> int __maybe_unused {
