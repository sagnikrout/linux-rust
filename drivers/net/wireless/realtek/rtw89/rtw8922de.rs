...
//! Source: drivers/net/wireless/realtek/rtw89/rtw8922de.c
#![no_std]
...
//
    ...
    .bd_idx_addr_low_power	= core::ptr::null_mut(),
    .dma_addr_set		= &rtw89_pci_ch_dma_addr_set_be_v1,
    .bd_ram_table		= core::ptr::null_mut(),
