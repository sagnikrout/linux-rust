...
//! Source: drivers/net/wireless/realtek/rtl818x/rtl8180/dev.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rtl8180_write_phy(dev: *mut ieee80211_hw, addr: u8, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn rtl8180_handle_rx(dev: *mut ieee80211_hw) {
    static void rtl8180_handle_rx(struct ieee80211_hw *dev)
    {
    struct rtl8180_priv *priv = dev.priv;
    struct rtl818x_rx_cmd_desc *cmd_desc;
    let mut count: c_uint = 32;
    u8 agc, sq;
    let mut signal: i8 = 1;
    dma_addr_t mapping;
    while (count--) {
...
// same as above
    ...
    let mut rx_status: ieee80211_rx_status = {0};
...
#[no_mangle]
unsafe extern "C" fn rtl8180_handle_tx(dev: *mut ieee80211_hw, prio: c_uint) {
    ...
    let mut flags: u32 = le32_to_cpu(entry.flags);
...
#[no_mangle]
unsafe extern "C" fn rtl8187se_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rtl8180_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    u32 tx_flags;
    u8 rc_flags;
    let mut plcp_len: u16 = 0;
    let mut rts_duration: __le16 = 0;
// do arithmetic and then convert to le16
    let mut frame_duration: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn rtl8180_set_anaparam3(priv: *mut rtl8180_priv, anaparam3: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8180_set_anaparam2(priv: *mut rtl8180_priv, anaparam2: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8180_set_anaparam(priv: *mut rtl8180_priv, anaparam: u32) {
...
#[no_mangle]
unsafe extern "C" fn rtl8187se_mac_config(dev: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn rtl8180_int_enable(dev: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn rtl8180_int_disable(dev: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn rtl8180_config_cardbus(dev: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn rtl8180_init_hw(dev: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8180_init_rx_ring(dev: *mut ieee80211_hw) -> c_int {
...
// mapping = dma_map_single(&priv->pdev->dev,
    ...
    if (dma_mapping_error(&priv.pdev.dev, *mapping)) {
    kfree_skb(skb);
    priv.rx_buf[i] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rtl8180_free_rx_ring(dev: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn rtl8180_free_tx_ring(dev: *mut ieee80211_hw, prio: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rtl8180_start(dev: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(RTL818X_CHIP_FAMILY_RTL8180: priv->chip_family ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtl8180_stop(dev: *mut ieee80211_hw, suspend: bool) {
...
#[no_mangle]
unsafe extern "C" fn rtl8180_beacon_work(work: *mut work_struct) {
...
// TODO: use actual beacon queue
    ...
    rtl8180_tx(dev, core::ptr::null_mut(), skb);
    resched:
//
...
#[no_mangle]
unsafe extern "C" fn rtl8180_config(dev: *mut ieee80211_hw, radio_idx: c_int, changed: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8187se_conf_ac_parm(dev: *mut ieee80211_hw, queue: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn if(RTL818X_CHIP_FAMILY_RTL8185: priv->chip_family ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtl8180_eeprom_register_read(eeprom: *mut eeprom_93cx6) {
...
#[no_mangle]
unsafe extern "C" fn rtl8180_eeprom_register_write(eeprom: *mut eeprom_93cx6) {
...
#[no_mangle]
unsafe extern "C" fn rtl8180_eeprom_read(priv: *mut rtl8180_priv) {
...
// OFDM TX power
    ...
    unsigned int io_len;
    int err;
    const char *chip_name, *rf_name = core::ptr::null_mut();
    u32 reg;
...
#[no_mangle]
unsafe extern "C" fn rtl8180_remove(pdev: *mut pci_dev) {
