...
//! Source: drivers/net/wireless/realtek/rtl8xxxu/8188f.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_identify_chip(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8188f_channel_to_group(channel: c_int, group: *mut c_int, cck_group: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn rtl8188f_spur_calibration(priv: *mut rtl8xxxu_priv, channel: u8) {
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_config_channel(hw: *mut ieee80211_hw) {
...
// adc buffer clk
    ...
    val32 |= BIT(20);
#[no_mangle]
pub unsafe extern "C" fn if(NL80211_CHAN_WIDTH_40: hw->conf.chandef.width ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_init_aggregation(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_init_statistics(priv: *mut rtl8xxxu_priv) {
...
pub const TX_POWER_INDEX_MAX: c_uint = 0x3F;
pub const TX_POWER_INDEX_DEFAULT_CCK: c_uint = 0x22;
pub const TX_POWER_INDEX_DEFAULT_HT40: c_uint = 0x27;
#[no_mangle]
unsafe extern "C" fn rtl8188fu_parse_efuse(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_load_firmware(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_init_phy_bb(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_init_phy_rf(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8188f_phy_lc_calibrate(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_iqk_path_a(priv: *mut rtl8xxxu_priv, lok_result: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_rx_iqk_path_a(priv: *mut rtl8xxxu_priv, lok_result: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_phy_iq_calibrate(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8188f_disabled_to_emu(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8188f_emu_to_active(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_active_to_emu(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_emu_to_disabled(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_active_to_lps(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_power_on(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8188fu_power_off(priv: *mut rtl8xxxu_priv) {
...
pub const PPG_BB_GAIN_2G_TXA_OFFSET_8188F: c_uint = 0xee;
pub const PPG_BB_GAIN_2G_TX_OFFSET_MASK: c_uint = 0x0f;
#[no_mangle]
unsafe extern "C" fn rtl8188f_enable_rf(priv: *mut rtl8xxxu_priv) {
    static void rtl8188f_enable_rf(struct rtl8xxxu_priv *priv)
    {
    u32 val32;
    let mut pg_pwrtrim: u8 = 0xff, val8;
    s8 bb_gain;
// Somehow this is not found in the efuse we read earlier.
    ...
    bb_gain = 0;
#[no_mangle]
pub unsafe extern "C" fn if(1: bb_gain &) -> else {
    else if (bb_gain & 1)
    bb_gain = bb_gain >> 1;
    else
    bb_gain = -(bb_gain >> 1);
...
#[no_mangle]
unsafe extern "C" fn rtl8188f_disable_rf(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8188f_usb_quirks(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8188f_set_crystal_cap(priv: *mut rtl8xxxu_priv, crystal_cap: u8) {
...
#[no_mangle]
unsafe extern "C" fn rtl8188f_cck_rssi(priv: *mut rtl8xxxu_priv, phy_stats: *mut rtl8723au_phy_stats) -> i8 {
