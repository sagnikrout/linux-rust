...
//! Source: drivers/net/wireless/realtek/rtl8xxxu/8710b.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rtl8710b_indirect_read32(priv: *mut rtl8xxxu_priv, addr: u32) -> u32 {
    static u32 rtl8710b_indirect_read32(struct rtl8xxxu_priv *priv, u32 addr)
    {
    struct device *dev = &priv.udev.dev;
    u32 val32, value = 0xffffffff;
    let mut polling_count: u8 = 0xff;
...
#[no_mangle]
unsafe extern "C" fn rtl8710b_indirect_write32(priv: *mut rtl8xxxu_priv, addr: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn rtl8710b_read_syson_reg(priv: *mut rtl8xxxu_priv, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rtl8710b_write_syson_reg(priv: *mut rtl8xxxu_priv, addr: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn rtl8710b_read_efuse8(priv: *mut rtl8xxxu_priv, offset: u16, data: *mut u8) -> c_int {
...
pub const EEPROM_PACKAGE_TYPE_8710B: c_uint = 0xF8;
pub const PACKAGE_QFN48M_U: c_uint = 0xee;
pub const PACKAGE_QFN48M_S: c_uint = 0xfe;
#[no_mangle]
unsafe extern "C" fn rtl8710bu_identify_chip(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8710b_revise_cck_tx_psf(priv: *mut rtl8xxxu_priv, channel: u8) {
...
#[no_mangle]
unsafe extern "C" fn rtl8710bu_config_channel(hw: *mut ieee80211_hw) {
    static void rtl8710bu_config_channel(struct ieee80211_hw *hw)
    {
    struct rtl8xxxu_priv *priv = hw.priv;
    let mut ht40: bool = conf_is_ht40(&hw.conf);
    u8 channel, subchannel = 0;
    let mut sec_ch_above: bool = 0;
    u32 val32;
    u16 val16;
...
#[no_mangle]
unsafe extern "C" fn rtl8710bu_init_aggregation(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8710bu_init_statistics(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8710b_read_efuse(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8710bu_parse_efuse(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8710bu_load_firmware(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8710bu_init_phy_bb(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8710bu_init_phy_rf(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8710bu_iqk_path_a(priv: *mut rtl8xxxu_priv, lok_result: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8710bu_rx_iqk_path_a(priv: *mut rtl8xxxu_priv, lok_result: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8710bu_phy_iq_calibrate(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8710b_emu_to_active(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8710bu_active_to_emu(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8710bu_active_to_lps(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8710bu_power_on(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8710bu_power_off(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8710b_reset_8051(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8710b_enable_rf(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8710b_disable_rf(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8710b_usb_quirks(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8710b_set_crystal_cap(priv: *mut rtl8xxxu_priv, crystal_cap: u8) {
...
#[no_mangle]
unsafe extern "C" fn rtl8710b_cck_rssi(priv: *mut rtl8xxxu_priv, phy_stats: *mut rtl8723au_phy_stats) -> i8 {
    ...
    let mut lna_idx: u8 = (phy_stats0.lna_h << 3) | phy_stats0.lna_l;
    let mut vga_idx: u8 = phy_stats0.vga;
