...
//! Source: drivers/net/wireless/realtek/rtl8xxxu/8192c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rtl8192cu_identify_chip(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8192cu_load_firmware(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(RTL8192C: priv->chip_cut || priv->rtl_chip ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtl8192cu_parse_efuse(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8192cu_init_phy_rf(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8192cu_power_on(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8192cu_power_off(priv: *mut rtl8xxxu_priv) {
...
// _DisableAnalog
    ...
    led_cdev);
    let mut ledcfg: u8 = rtl8xxxu_read8(priv, REG_LEDCFG0);
