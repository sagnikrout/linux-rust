...
//! Source: drivers/net/wireless/realtek/rtl8xxxu/8723b.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rtl8723bu_identify_chip(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8723bu_write_btreg(priv: *mut rtl8xxxu_priv, reg: u8, data: u8) {
    static void rtl8723bu_write_btreg(struct rtl8xxxu_priv *priv, u8 reg, u8 data)
    {
    struct h2c_cmd h2c;
    let mut reqnum: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn rtl8723bu_reset_8051(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8723bu_parse_efuse(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8723bu_load_firmware(priv: *mut rtl8xxxu_priv) -> c_int {
    static int rtl8723bu_load_firmware(struct rtl8xxxu_priv *priv)
    {
    return rtl8xxxu_load_firmware(priv, "rtlwifi/rtl8723bu_nic.bin");
    }
#[no_mangle]
unsafe extern "C" fn rtl8723bu_init_phy_bb(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8723bu_init_phy_rf(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8723bu_phy_init_antenna_selection(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8723bu_iqk_path_a(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8723bu_rx_iqk_path_a(priv: *mut rtl8xxxu_priv) -> c_int {
...
// Check failed
    ...
    let mut xa_agc: u8 = rtl8xxxu_read32(priv, REG_OFDM0_XA_AGC_CORE1) & 0xff;
    let mut xb_agc: u8 = rtl8xxxu_read32(priv, REG_OFDM0_XB_AGC_CORE1) & 0xff;
//
...
#[no_mangle]
unsafe extern "C" fn rtl8723bu_phy_iq_calibrate(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8723bu_active_to_emu(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8723b_emu_to_active(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8723bu_power_on(priv: *mut rtl8xxxu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8723bu_power_off(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8723b_enable_rf(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8723bu_init_aggregation(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8723bu_init_statistics(priv: *mut rtl8xxxu_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtl8723b_cck_rssi(priv: *mut rtl8xxxu_priv, phy_stats: *mut rtl8723au_phy_stats) -> i8 {
...
#[no_mangle]
pub unsafe extern "C" fn if(LED_ON: brightness ==) -> else {
    else if (brightness == LED_ON)
    ledcfg |= LEDCFG2_SW_LED_CONTROL;
#[no_mangle]
pub unsafe extern "C" fn if(RTL8XXXU_HW_LED_CONTROL: brightness ==) -> else {
