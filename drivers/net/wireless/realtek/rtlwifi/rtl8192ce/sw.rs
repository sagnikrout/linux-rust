...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8192ce/sw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rtl92c_init_aspm_vars(hw: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn rtl92c_init_sw_vars(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_81XXC_VENDOR_UMC_B_CUT(rtlhal->version)) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtl92c_deinit_sw_vars(hw: *mut ieee80211_hw) {
