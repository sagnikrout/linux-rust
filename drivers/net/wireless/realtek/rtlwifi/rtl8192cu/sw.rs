...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8192cu/sw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rtl92cu_init_sw_vars(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl92cu_deinit_sw_vars(hw: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn rtl92cu_get_btc_status() -> bool {
