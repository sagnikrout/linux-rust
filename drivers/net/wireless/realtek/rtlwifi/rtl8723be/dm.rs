...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8723be/dm.h
#![no_std]
...
pub const TXSCALE_TABLE_SIZE: c_int = 30;
// RF REG LIST
...
extern "C" {
    pub fn rtl8723be_dm_fast_antenna_training_callback(data: c_ulong);
}
extern "C" {
    pub fn rtl8723be_dm_init(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8723be_dm_watchdog(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8723be_dm_write_dig(hw: *mut ieee80211_hw, current_igi: u8);
}
extern "C" {
    pub fn rtl8723be_dm_check_txpower_tracking(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8723be_dm_init_rate_adaptive_mask(hw: *mut ieee80211_hw);
}
