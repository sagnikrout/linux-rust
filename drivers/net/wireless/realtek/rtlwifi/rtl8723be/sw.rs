...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8723be/sw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rtl8723be_init_aspm_vars(hw: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn rtl8723be_init_sw_vars(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8723be_deinit_sw_vars(hw: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn rtl8723be_get_btc_status() -> bool {
    static bool rtl8723be_get_btc_status(void)
    {
    return true;
    }
#[no_mangle]
unsafe extern "C" fn is_fw_header(hdr: *mut rtlwifi_firmware_header) -> bool {
