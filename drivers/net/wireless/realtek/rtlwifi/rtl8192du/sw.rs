...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8192du/sw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rtl92du_init_shared_data(hw: *mut ieee80211_hw) -> c_int {
    ...
    struct rtl_priv *other_rtlpriv = core::ptr::null_mut();
    struct ieee80211_hw *other_hw = core::ptr::null_mut();
    if (other_intf)
...
// The other interface doesn't exist or was not probed yet.
    ...
    rtlpriv.curveindex_2g = core::ptr::null_mut();
    rtlpriv.curveindex_5g = core::ptr::null_mut();
    rtlpriv.mutex_for_power_on_off = core::ptr::null_mut();
    rtlpriv.mutex_for_hw_init = core::ptr::null_mut();
    return -ENOMEM;
    }
...
#[no_mangle]
unsafe extern "C" fn rtl92du_deinit_shared_data(hw: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn rtl92du_init_sw_vars(hw: *mut ieee80211_hw) -> c_int {
...
// request fw
    ...
    rtlpriv.rtlhal.pfirmware = core::ptr::null_mut();
    goto error;
    }
    return 0;
    error:
...
#[no_mangle]
unsafe extern "C" fn rtl92du_deinit_sw_vars(hw: *mut ieee80211_hw) {
...
// rx
    .rx_urb_num = 8,
    .rx_max_size = 15360,
    .usb_rx_hdl = core::ptr::null_mut(),
    .usb_rx_segregate_hdl = core::ptr::null_mut(),
// tx
