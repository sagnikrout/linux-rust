...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8188ee/trx.h
#![no_std]
...
extern "C" {
    pub fn le32_get_bits(7): *mut *mut (__pdesc +, _arg: GENMASK(15, _arg: 0)) -> return;
}
...
extern "C" {
    pub fn le32_get_bits(_arg: *mut (__pdesc), _arg: BIT(23)) -> return;
}
extern "C" {
...
extern "C" {
    pub fn le32_get_bits(_arg: *mut (__pdesc), _arg: BIT(28)) -> return;
}
extern "C" {
    pub fn le32_get_bits(_arg: *mut (__pdesc), _arg: BIT(29)) -> return;
}
extern "C" {
    pub fn le32_get_bits(_arg: *mut (__pdesc), _arg: BIT(30)) -> return;
}
extern "C" {
    pub fn le32_get_bits(_arg: *mut (__pdesc), _arg: BIT(31)) -> return;
}
extern "C" {
    pub fn le32_get_bits(1): *mut *mut (__pdesc +, _arg: GENMASK(5, _arg: 0)) -> return;
}
extern "C" {
...
extern "C" {
    pub fn le32_get_bits(1): *mut *mut (__pdesc +, _arg: GENMASK(19, _arg: 16)) -> return;
}
extern "C" {
    pub fn le32_get_bits(1): *mut *mut (__pdesc +, _arg: GENMASK(23, _arg: 20)) -> return;
}
extern "C" {
    pub fn le32_get_bits(1): *mut *mut (__pdesc +, _arg: BIT(24)) -> return;
}
extern "C" {
    pub fn le32_get_bits(1): *mut *mut (__pdesc +, _arg: BIT(25)) -> return;
}
extern "C" {
    pub fn le32_get_bits(1): *mut *mut (__pdesc +, _arg: BIT(26)) -> return;
}
extern "C" {
    pub fn le32_get_bits(1): *mut *mut (__pdesc +, _arg: BIT(27)) -> return;
}
extern "C" {
    pub fn le32_get_bits(1): *mut *mut (__pdesc +, _arg: GENMASK(29, _arg: 28)) -> return;
}
extern "C" {
    pub fn le32_get_bits(1): *mut *mut (__pdesc +, _arg: BIT(30)) -> return;
}
extern "C" {
    pub fn le32_get_bits(1): *mut *mut (__pdesc +, _arg: BIT(31)) -> return;
}
extern "C" {
    pub fn le32_get_bits(2): *mut *mut (__pdesc +, _arg: GENMASK(11, _arg: 0)) -> return;
}
extern "C" {
    pub fn le32_get_bits(2): *mut *mut (__pdesc +, _arg: GENMASK(15, _arg: 12)) -> return;
}
extern "C" {
...
extern "C" {
    pub fn le32_get_bits(3): *mut *mut (__pdesc +, _arg: BIT(7)) -> return;
}
extern "C" {
...
extern "C" {
    pub fn le32_get_bits(3): *mut *mut (__pdesc +, _arg: BIT(10)) -> return;
}
extern "C" {
    pub fn le32_get_bits(3): *mut *mut (__pdesc +, _arg: BIT(11)) -> return;
}
extern "C" {
    pub fn le32_get_bits(3): *mut *mut (__pdesc +, _arg: GENMASK(13, _arg: 12)) -> return;
}
extern "C" {
    pub fn le32_get_bits(3): *mut *mut (__pdesc +, _arg: GENMASK(15, _arg: 14)) -> return;
}
extern "C" {
...
extern "C" {
    pub fn le32_to_cpu(4): *mut *mut (__pdesc +) -> return;
}
extern "C" {
...
extern "C" {
    pub fn le32_to_cpu(7): *mut *mut (__pdesc +) -> return;
}
// (__pdesc + 6) = cpu_to_le32(__val);
// (__pdesc + 7) = cpu_to_le32(__val);
// TX report 2 format in Rx desc
extern "C" {
    pub fn le32_get_bits(_arg: *mut (__status), _arg: GENMASK(8, _arg: 0)) -> return;
}
extern "C" {
    pub fn le32_to_cpu(4): *mut *mut (__status +) -> return;
}
extern "C" {
    pub fn le32_to_cpu(5): *mut *mut (__status +) -> return;
}
// Macro flag: #define RTL8188_RX_HAL_IS_CCK_RATE(rxmcs)\
#[repr(C)]
#[derive(Copy, Clone)]
pub struct phy_status_rpt {
    ...
    pub path_cfotail: [u8; 2],
    pub pcts_mask: [u8; 2],
    pub stream_rxevm: [u8; 2],
    pub path_rxsnr: [u8; 2],
...
pub struct rx_desc_88e {
    ...
    pub hw_queue): *mut *mut void rtl88ee_tx_polling(struct ieee80211_hw hw, u8,
    pub skb): *mut sk_buff,
