...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8188ee/dm.h
#![no_std]
...
pub const DM_REG_RX_DEFAULT_A_11N: c_uint = 0x858;
pub const DM_REG_RX_DEFAULT_B_11N: c_uint = 0x85A;
...
pub const RXPATHSELECTION_SS_TH_W: c_int = 30;
...
extern "C" {
    pub fn rtl88e_dm_fast_antenna_training_callback(t: *mut timer_list);
}
extern "C" {
    pub fn rtl88e_dm_init(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl88e_dm_watchdog(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl88e_dm_write_dig(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl88e_dm_init_edca_turbo(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl88e_dm_check_txpower_tracking(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl88e_dm_init_rate_adaptive_mask(hw: *mut ieee80211_hw);
}
