...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8188ee/reg.h
#![no_std]
...
pub const RF_OPTION4: c_uint = 0x7C;
...
pub const RTL8188E_EEPROM_ID: c_uint = 0x8129;
...
pub const EEPROM_CHANNELPLAN: c_uint = 0xB8;
pub const EEPROM_XTAL_88E: c_uint = 0xB9;
pub const EEPROM_THERMAL_METER_88E: c_uint = 0xBA;
pub const EEPROM_IQK_LCK_88E: c_uint = 0xBB;
pub const EEPROM_RF_BOARD_OPTION_88E: c_uint = 0xC1;
pub const EEPROM_RF_FEATURE_OPTION_88E: c_uint = 0xC2;
pub const EEPROM_RF_BT_SETTING_88E: c_uint = 0xC3;
...
pub const REG_SC_CNT: c_uint = 0x8c4;
