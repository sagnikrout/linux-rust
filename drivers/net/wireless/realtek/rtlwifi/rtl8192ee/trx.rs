...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8192ee/trx.h
#![no_std]
...
pub const RX_DESC_SIZE: c_int = 24;
pub const MAX_RECEIVE_BUFFER_SIZE: c_int = 8192;
extern "C" {
...
// (pbd + 4 * off + 2) = 0;
extern "C" {
    pub fn le32_to_cpu(1)): *mut *mut *mut ((__pdesc + 4  __offset +) -> return;
}
extern "C" {
    pub fn le32_to_cpu(2)): *mut *mut *mut ((pbd + 4  off +) -> return;
}
// Dword 0
// Dword 1
...
// DWORD 0
extern "C" {
    pub fn le32_get_bits(_arg: *mut (__status), _arg: BIT(15)) -> return;
}
extern "C" {
    pub fn le32_get_bits(_arg: *mut (__status), _arg: BIT(16)) -> return;
}
extern "C" {
    pub fn le32_get_bits(_arg: *mut (__status), _arg: GENMASK(30, _arg: 16)) -> return;
}
// DWORD 1
...
// Macro flag: #define RTL92EE_RX_HAL_IS_CCK_RATE(rxmcs)\
pub const IS_LITTLE_ENDIAN: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct rx_desc {
    ...
    pub queue_index): u8,
    pub queue_index): u8,
    pub queue_index): *mut *mut u16 rtl92ee_get_available_desc(struct ieee80211_hw hw, u8,
    ...
    pub index): *mut *mut bool rtl92ee_is_tx_desc_closed(struct ieee80211_hw hw, u8 hw_queue, u16,
    pub hw_queue): *mut *mut void rtl92ee_tx_polling(struct ieee80211_hw hw, u8,
    pub skb): *mut sk_buff,
