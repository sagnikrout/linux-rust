...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8192ee/phy.h
#![no_std]
...
extern "C" {
    pub fn rtl92ee_phy_mac_config(hw: *mut ieee80211_hw) -> bool;
}
extern "C" {
    pub fn rtl92ee_phy_bb_config(hw: *mut ieee80211_hw) -> bool;
}
extern "C" {
    pub fn rtl92ee_phy_rf_config(hw: *mut ieee80211_hw) -> bool;
}
extern "C" {
    pub fn rtl92ee_phy_get_hw_reg_originalvalue(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl92ee_phy_set_txpower_level(hw: *mut ieee80211_hw, channel: u8);
}
extern "C" {
    pub fn rtl92ee_phy_set_bw_mode_callback(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl92ee_phy_sw_chnl_callback(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl92ee_phy_sw_chnl(hw: *mut ieee80211_hw) -> u8;
}
extern "C" {
    pub fn rtl92ee_phy_iq_calibrate(hw: *mut ieee80211_hw, b_recovery: bool);
}
extern "C" {
    pub fn rtl92ee_phy_lc_calibrate(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl92ee_phy_set_rfpath_switch(hw: *mut ieee80211_hw, bmain: bool);
}
extern "C" {
    pub fn rtl92ee_phy_set_io_cmd(hw: *mut ieee80211_hw, iotype: io_type) -> bool;
}
