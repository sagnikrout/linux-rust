...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8192ee/reg.h
#![no_std]
...
pub const REG_SYS_SWR_CTRL1: c_uint = 0x0010;
pub const REG_SPS0_CTRL: c_uint = 0x0011;
pub const REG_SYS_SWR_CTRL2: c_uint = 0x0014;
pub const REG_SYS_SWR_CTRL3: c_uint = 0x0018;
...
pub const REG_AFE_CTRL2: c_uint = 0x0028;
pub const REG_MAC_PHY_CTRL: c_uint = 0x002c;
pub const REG_AFE_CTRL3: c_uint = 0x002c;
...
pub const REG_RXPKTBUF_CTRL: c_uint = 0x0142;
...
pub const REG_RSVD3: c_uint = 0x0168;
...
pub const REG_RXDMA_PRO: c_uint = 0x0290;
pub const REG_EARLY_MODE_CONTROL: c_uint = 0x02BC;
pub const REG_RSVD5: c_uint = 0x02F0;
pub const REG_RSVD6: c_uint = 0x02F4;
// -----------------------------------------------------
//
...
pub const REG_MGQ_DESA: c_uint = 0x0310;
pub const REG_VOQ_DESA: c_uint = 0x0318;
pub const REG_VIQ_DESA: c_uint = 0x0320;
pub const REG_BEQ_DESA: c_uint = 0x0328;
pub const REG_BKQ_DESA: c_uint = 0x0330;
pub const REG_RX_DESA: c_uint = 0x0338;
pub const REG_HQ0_DESA: c_uint = 0x0340;
pub const REG_HQ1_DESA: c_uint = 0x0348;
pub const REG_HQ2_DESA: c_uint = 0x0350;
pub const REG_HQ3_DESA: c_uint = 0x0358;
pub const REG_HQ4_DESA: c_uint = 0x0360;
pub const REG_HQ5_DESA: c_uint = 0x0368;
pub const REG_HQ6_DESA: c_uint = 0x0370;
pub const REG_HQ7_DESA: c_uint = 0x0378;
pub const REG_MGQ_TXBD_NUM: c_uint = 0x0380;
pub const REG_RX_RXBD_NUM: c_uint = 0x0382;
pub const REG_VOQ_TXBD_NUM: c_uint = 0x0384;
pub const REG_VIQ_TXBD_NUM: c_uint = 0x0386;
pub const REG_BEQ_TXBD_NUM: c_uint = 0x0388;
pub const REG_BKQ_TXBD_NUM: c_uint = 0x038A;
pub const REG_HI0Q_TXBD_NUM: c_uint = 0x038C;
pub const REG_HI1Q_TXBD_NUM: c_uint = 0x038E;
pub const REG_HI2Q_TXBD_NUM: c_uint = 0x0390;
pub const REG_HI3Q_TXBD_NUM: c_uint = 0x0392;
pub const REG_HI4Q_TXBD_NUM: c_uint = 0x0394;
pub const REG_HI5Q_TXBD_NUM: c_uint = 0x0396;
pub const REG_HI6Q_TXBD_NUM: c_uint = 0x0398;
pub const REG_HI7Q_TXBD_NUM: c_uint = 0x039A;
pub const REG_TSFTIMER_HCI: c_uint = 0x039C;
// Read Write Point
pub const REG_VOQ_TXBD_IDX: c_uint = 0x03A0;
pub const REG_VIQ_TXBD_IDX: c_uint = 0x03A4;
pub const REG_BEQ_TXBD_IDX: c_uint = 0x03A8;
pub const REG_BKQ_TXBD_IDX: c_uint = 0x03AC;
pub const REG_MGQ_TXBD_IDX: c_uint = 0x03B0;
pub const REG_RXQ_TXBD_IDX: c_uint = 0x03B4;
pub const REG_HI0Q_TXBD_IDX: c_uint = 0x03B8;
pub const REG_HI1Q_TXBD_IDX: c_uint = 0x03BC;
pub const REG_HI2Q_TXBD_IDX: c_uint = 0x03C0;
pub const REG_HI3Q_TXBD_IDX: c_uint = 0x03C4;
pub const REG_HI4Q_TXBD_IDX: c_uint = 0x03C8;
pub const REG_HI5Q_TXBD_IDX: c_uint = 0x03CC;
pub const REG_HI6Q_TXBD_IDX: c_uint = 0x03D0;
pub const REG_HI7Q_TXBD_IDX: c_uint = 0x03D4;
pub const REG_PCIE_HCPWM: c_uint = 0x03D8;
pub const REG_PCIE_CTRL2: c_uint = 0x03DB;
pub const REG_PCIE_HRPWM: c_uint = 0x03DC;
pub const REG_H2C_MSG_DRV2FW_INFO: c_uint = 0x03E0;
pub const REG_PCIE_C2H_MSG_REQUEST: c_uint = 0x03E4;
pub const REG_BACKDOOR_DBI_WDATA: c_uint = 0x03E8;
pub const REG_BACKDOOR_DBI_RDATA: c_uint = 0x03EC;
pub const REG_BACKDOOR_DBI_DATA: c_uint = 0x03F0;
pub const REG_MDIO: c_uint = 0x03F4;
pub const REG_MDIO_DATA: c_uint = 0x03F8;
...
pub const REG_LIFECTRL_CTRL: c_uint = 0x0426;
...
pub const REG_BCNQ1_BDNY: c_uint = 0x0457;
...
pub const REG_AMPDU_BURST_MODE: c_uint = 0x04BC;
...
pub const REG_MACID_PKT_DROP0: c_uint = 0x04D0;
// -----------------------------------------------------
//
...
// -----------------------------------------------------
//
pub const REG_MAC_CR: c_uint = 0x0600;
...
pub const REG_BFMER0_INFO: c_uint = 0x06E4;
pub const REG_BFMER1_INFO: c_uint = 0x06EC;
pub const REG_CSI_RPT_PARAM_BW20: c_uint = 0x06F4;
pub const REG_CSI_RPT_PARAM_BW40: c_uint = 0x06F8;
pub const REG_CSI_RPT_PARAM_BW80: c_uint = 0x06FC;
// Hardware Port 2
pub const REG_MACID1: c_uint = 0x0700;
pub const REG_BSSID1: c_uint = 0x0708;
pub const REG_BFMEE_SEL: c_uint = 0x0714;
...
pub const EEPROM_DEFAULT_THERMALMETER: c_uint = 0x1A;
...
pub const RTL8192E_EEPROM_ID: c_uint = 0x8129;
...
pub const EEPROM_XTAL_92E: c_uint = 0xB9;
pub const EEPROM_THERMAL_METER_92E: c_uint = 0xBA;
pub const EEPROM_IQK_LCK_92E: c_uint = 0xBB;
pub const EEPROM_RF_BOARD_OPTION_92E: c_uint = 0xC1;
pub const EEPROM_RF_FEATURE_OPTION_92E: c_uint = 0xC2;
pub const EEPROM_RF_BT_SETTING_92E: c_uint = 0xC3;
pub const EEPROM_VERSION: c_uint = 0xC4;
pub const EEPROM_CUSTOMER_ID: c_uint = 0xC5;
pub const EEPROM_RF_ANTENNA_OPT_92E: c_uint = 0xC9;
...
pub const LAST_ENTRY_OF_TX_PKT_BUFFER: c_int = 175;
