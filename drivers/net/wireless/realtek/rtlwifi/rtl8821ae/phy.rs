...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8821ae/phy.h
#![no_std]
...
pub const RTL8821AE_MAX_PATH_NUM: c_int = 2;
pub const TARGET_CHNL_NUM_2G_5G_8812: c_int = 59;
#[repr(C)]
...
pub struct tx_power_struct {
    pub cck: [u8; RTL8821AE_MAX_PATH_NUM][CHANNEL_MAX_NUMBER],
    pub ht40_1s: [u8; RTL8821AE_MAX_PATH_NUM][CHANNEL_MAX_NUMBER],
    pub ht40_2s: [u8; RTL8821AE_MAX_PATH_NUM][CHANNEL_MAX_NUMBER],
    pub ht20_diff: [u8; RTL8821AE_MAX_PATH_NUM][CHANNEL_MAX_NUMBER],
    pub legacy_ht_diff: [u8; RTL8821AE_MAX_PATH_NUM][CHANNEL_MAX_NUMBER],
    pub legacy_ht_txpowerdiff: u8,
    pub groupht20: [u8; RTL8821AE_MAX_PATH_NUM][CHANNEL_MAX_NUMBER],
    pub groupht40: [u8; RTL8821AE_MAX_PATH_NUM][CHANNEL_MAX_NUMBER],
    pub pwrgroup_cnt: u8,
...
extern "C" {
    pub fn rtl8821ae_phy_mac_config(hw: *mut ieee80211_hw) -> bool;
}
extern "C" {
    pub fn rtl8821ae_phy_bb_config(hw: *mut ieee80211_hw) -> bool;
}
extern "C" {
    pub fn rtl8821ae_phy_rf_config(hw: *mut ieee80211_hw) -> bool;
}
extern "C" {
    pub fn rtl8821ae_phy_get_hw_reg_originalvalue(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8821ae_phy_set_bw_mode_callback(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8821ae_phy_sw_chnl_callback(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8821ae_phy_sw_chnl(hw: *mut ieee80211_hw) -> u8;
}
extern "C" {
    pub fn rtl8821ae_phy_lc_calibrate(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8821ae_phy_set_rfpath_switch(hw: *mut ieee80211_hw, bmain: bool);
}
extern "C" {
    pub fn rtl8821ae_phy_set_io_cmd(hw: *mut ieee80211_hw, iotype: io_type) -> bool;
}
extern "C" {
    pub fn _rtl8812ae_get_right_chnl_place_for_iqk(chnl: u8) -> u8;
}
extern "C" {
    pub fn rtl8821ae_reset_iqk_result(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn phy_get_tx_swing_8812A(hw: *mut ieee80211_hw, band: u8, rf_path: u8) -> u32;
}
