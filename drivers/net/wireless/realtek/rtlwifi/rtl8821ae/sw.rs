...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8821ae/sw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rtl8821ae_init_aspm_vars(hw: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn rtl8821ae_init_sw_vars(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8821ae_deinit_sw_vars(hw: *mut ieee80211_hw) {
    ...
    if (rtlpriv.rtlhal.wowlan_firmware) {
    vfree(rtlpriv.rtlhal.wowlan_firmware);
    rtlpriv.rtlhal.wowlan_firmware = core::ptr::null_mut();
    }

    }
// get bt coexist status
#[no_mangle]
unsafe extern "C" fn rtl8821ae_get_btc_status() -> bool {
