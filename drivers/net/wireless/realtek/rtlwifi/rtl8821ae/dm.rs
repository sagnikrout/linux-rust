...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8821ae/dm.h
#![no_std]
...
pub const TXSCALE_TABLE_SIZE: c_int = 37;
// RF REG LIST
...
pub const DM_REG_T_METER_88E_11N: c_uint = 0x42;
// BB REG LIST
// PAGE 8
...
pub const DM_REG_CCK_CCA_11AC: c_uint = 0xA0A;
...
pub const DM_BIT_IGI_11AC: c_uint = 0xFFFFFFFF;
...
pub const DM_DIG_FA_TH0: c_int = 200;
...
pub const AVG_THERMAL_NUM_8812A: c_int = 4;
pub const TXPWR_TRACK_TABLE_SIZE: c_int = 30;
pub const MAX_PATH_NUM_8812A: c_int = 2;
pub const MAX_PATH_NUM_8821A: c_int = 1;
#[repr(C)]
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum pwr_track_control_method {
    BBSWING,
    TXAGC,
    MIX_MODE
}
...
extern "C" {
    pub fn rtl8821ae_dm_fast_antenna_training_callback(data: c_ulong);
}
extern "C" {
    pub fn rtl8821ae_dm_init(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8821ae_dm_watchdog(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8821ae_dm_write_dig(hw: *mut ieee80211_hw, current_igi: u8);
}
extern "C" {
    pub fn rtl8821ae_dm_init_edca_turbo(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8821ae_dm_check_txpower_tracking_thermalmeter(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8821ae_dm_init_rate_adaptive_mask(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8821ae_dm_clear_txpower_tracking_state(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8821ae_dm_write_cck_cca_thres(hw: *mut ieee80211_hw, current_cca: u8);
}
extern "C" {
    pub fn rtl8821ae_dm_initialize_txpower_tracking_thermalmeter(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8821ae_dm_update_init_rate(hw: *mut ieee80211_hw, rate: u8);
}
extern "C" {
    pub fn rtl8821ae_hw_rate_to_mrate(hw: *mut ieee80211_hw, rate: u8) -> u8;
}
extern "C" {
    pub fn rtl8812ae_dm_txpower_tracking_callback_thermalmeter(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8821ae_dm_txpower_tracking_callback_thermalmeter(hw: *mut ieee80211_hw);
}
