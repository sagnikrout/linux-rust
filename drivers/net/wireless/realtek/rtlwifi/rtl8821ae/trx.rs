...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8821ae/trx.h
#![no_std]
...
// Macro flag: #define RTL8821AE_RX_HAL_IS_CCK_RATE(rxmcs)\
#[repr(C)]
#[derive(Copy, Clone)]
...
// DWORD 1
    pub pwdb_all: u8,
    pub /: *mut *mut u8 cfosho[4]; / DW 1 byte 1 DW 2 byte 0,
// DWORD 2
    pub /: *mut *mut s8 cfotail[4]; / DW 2 byte 1 DW 3 byte 0,
// DWORD 3
    pub /: *mut *mut s8 rxevm[2]; / DW 3 byte 1 DW 3 byte 2,
    pub /: *mut *mut s8 rxsnr[2]; / DW 3 byte 3 DW 4 byte 0,
// DWORD 4
    pub pcts_msk_rpt: [u8; 2],
    pub /: *mut *mut u8 pdsnr[2]; / DW 4 byte 3 DW 5 Byte 0,
// DWORD 5
...
pub struct rx_desc_8821ae {
    ...
    pub hw_queue): *mut *mut void rtl8821ae_tx_polling(struct ieee80211_hw hw, u8,
    pub skb): *mut sk_buff,
