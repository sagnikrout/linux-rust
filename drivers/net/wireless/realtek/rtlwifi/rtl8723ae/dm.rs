...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8723ae/dm.h
#![no_std]
...
extern "C" {
    pub fn rtl8723e_dm_init(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8723e_dm_watchdog(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8723e_dm_write_dig(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8723e_dm_check_txpower_tracking(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8723e_dm_init_rate_adaptive_mask(hw: *mut ieee80211_hw);
}
extern "C" {
    pub fn rtl8723e_dm_rf_saving(hw: *mut ieee80211_hw, bforce_in_normal: u8);
}
extern "C" {
    pub fn rtl8723e_dm_bt_coexist(hw: *mut ieee80211_hw);
}
