...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8723ae/trx.h
#![no_std]
...
pub struct rx_desc_8723e {
    ...
    pub val): *mut *mut u8 pdesc, bool istx, u8 desc_name, u8,
    pub desc_name): *mut *mut u8 pdesc, bool istx, u8,
    pub index): u8 hw_queue, u16,
    pub hw_queue): *mut *mut void rtl8723e_tx_polling(struct ieee80211_hw hw, u8,
    pub skb): *mut sk_buff,
