...
//! Source: drivers/net/wireless/realtek/rtlwifi/rtl8723ae/sw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rtl8723e_init_aspm_vars(hw: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn rtl8723e_init_sw_vars(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8723e_deinit_sw_vars(hw: *mut ieee80211_hw) {
...
#[no_mangle]
unsafe extern "C" fn rtl8723e_get_btc_status() -> bool {
