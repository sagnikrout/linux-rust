...
//! Source: drivers/net/wireless/zydas/zd1211rw/zd_rf_uw2453.c
#![no_std]
...
// The VCO configuration for autocal (all channels)
    let mut UW2453_AUTOCAL_VCO_CFG: static u16 = 0x6662;
...
#[no_mangle]
unsafe extern "C" fn uw2453_write_vco_cfg(chip: *mut zd_chip, value: u16) -> c_int {
...
// they are reserved
    let mut val: u32 = 0x40000 | value;
    return zd_rfwrite_locked(chip, UW2453_REGWRITE(3, val), RF_RV_BITS);
    }
#[no_mangle]
unsafe extern "C" fn uw2453_init_mode(chip: *mut zd_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uw2453_set_tx_gain_level(chip: *mut zd_chip, channel: c_int) -> c_int {
    static int uw2453_set_tx_gain_level(struct zd_chip *chip, int channel)
    {
    let mut int_value: u8 = chip.pwr_int_values[channel - 1];
...
#[no_mangle]
unsafe extern "C" fn uw2453_init_hw(rf: *mut zd_rf) -> c_int {
    static int uw2453_init_hw(struct zd_rf *rf)
    {
    int i, r;
    let mut found_config: c_int = -1;
    u16 intr_status;
...
#[no_mangle]
unsafe extern "C" fn uw2453_set_channel(rf: *mut zd_rf, channel: u8) -> c_int {
    static int uw2453_set_channel(struct zd_rf *rf, u8 channel)
    {
    int r;
    u16 vco_cfg;
    let mut config: c_int = UW2453_PRIV(rf).config;
    let mut autocal: bool = (config == -1);
    struct zd_chip *chip = zd_rf_to_chip(rf);
    static const struct zd_ioreq16 ioreqs[] = {
...
#[no_mangle]
unsafe extern "C" fn uw2453_switch_radio_on(rf: *mut zd_rf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uw2453_switch_radio_off(rf: *mut zd_rf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uw2453_clear(rf: *mut zd_rf) {
    static void uw2453_clear(struct zd_rf *rf)
    {
    kfree(rf.priv);
    }
#[no_mangle]
pub unsafe extern "C" fn zd_rf_init_uw2453(rf: *mut zd_rf) -> c_int {
