...
//! Source: drivers/net/wireless/zydas/zd1211rw/zd_rf_rf2959.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bits(rw: u32, from: c_int, to: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bit(rw: u32, bit: c_int) -> c_int {
    static int bit(u32 rw, int bit)
    {
    return bits(rw, bit, bit);
    }
#[no_mangle]
unsafe extern "C" fn dump_regwrite(rw: u32) {
    static void dump_regwrite(u32 rw)
    {
    let mut reg: c_int = bits(rw, 18, 22);
    let mut rw_flag: c_int = bits(rw, 23, 23);
...
#[no_mangle]
unsafe extern "C" fn rf2959_init_hw(rf: *mut zd_rf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rf2959_set_channel(rf: *mut zd_rf, channel: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rf2959_switch_radio_on(rf: *mut zd_rf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rf2959_switch_radio_off(rf: *mut zd_rf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zd_rf_init_rf2959(rf: *mut zd_rf) -> c_int {
