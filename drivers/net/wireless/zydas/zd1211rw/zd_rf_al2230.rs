...
//! Source: drivers/net/wireless/zydas/zd1211rw/zd_rf_al2230.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn zd1211b_al2230_finalize_rf(chip: *mut zd_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zd1211_al2230_init_hw(rf: *mut zd_rf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zd1211b_al2230_init_hw(rf: *mut zd_rf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zd1211_al2230_set_channel(rf: *mut zd_rf, channel: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zd1211b_al2230_set_channel(rf: *mut zd_rf, channel: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zd1211_al2230_switch_radio_on(rf: *mut zd_rf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zd1211b_al2230_switch_radio_on(rf: *mut zd_rf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn al2230_switch_radio_off(rf: *mut zd_rf) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zd_rf_init_al2230(rf: *mut zd_rf) -> c_int {
