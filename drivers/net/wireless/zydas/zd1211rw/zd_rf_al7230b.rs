...
//! Source: drivers/net/wireless/zydas/zd1211rw/zd_rf_al7230b.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn zd1211b_al7230b_finalize(chip: *mut zd_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zd1211_al7230b_init_hw(rf: *mut zd_rf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zd1211b_al7230b_init_hw(rf: *mut zd_rf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zd1211_al7230b_set_channel(rf: *mut zd_rf, channel: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zd1211b_al7230b_set_channel(rf: *mut zd_rf, channel: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zd1211_al7230b_switch_radio_on(rf: *mut zd_rf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zd1211b_al7230b_switch_radio_on(rf: *mut zd_rf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn al7230b_switch_radio_off(rf: *mut zd_rf) -> c_int {
...
// configurations
#[no_mangle]
unsafe extern "C" fn zd1211b_al7230b_patch_6m(rf: *mut zd_rf, channel: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zd_rf_init_al7230b(rf: *mut zd_rf) -> c_int {
