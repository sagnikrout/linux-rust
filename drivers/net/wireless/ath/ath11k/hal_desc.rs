...
//! Source: drivers/net/wireless/ath/ath11k/hal_desc.h
#![no_std]
...
pub struct rx_mpdu_desc {
    pub /: *mut *mut u32 info0; / %RX_MPDU_DESC_INFO,
    pub meta_data: u32,
    pub __packed: },
// rx_mpdu_desc
// Producer: RXDMA
...
pub struct hal_reo_dest_ring {
    pub buf_addr_info: ath11k_buffer_addr,
    pub rx_mpdu_info: rx_mpdu_desc,
    pub rx_msdu_info: rx_msdu_desc,
    pub queue_addr_lo: u32,
    pub /: *mut *mut u32 info0; / %HAL_REO_DEST_RING_INFO0_,
    pub /: *mut *mut u32 info1; / %HAL_REO_DEST_RING_INFO1_,
    pub rsvd0: u32,
    pub rsvd1: u32,
    pub rsvd2: u32,
    pub rsvd3: u32,
    pub rsvd4: u32,
    pub rsvd5: u32,
    pub /: *mut *mut u32 info2; / %HAL_REO_DEST_RING_INFO2_,
    pub __packed: },
// hal_reo_dest_ring
//
// Producer: RXDMA
...
pub struct hal_reo_entrance_ring {
    ...
    pub rx_mpdu_info: rx_mpdu_desc,
    pub queue_addr_lo: u32,
    pub /: *mut *mut u32 info0; / %HAL_REO_ENTR_RING_INFO0_,
    pub /: *mut *mut u32 info1; / %HAL_REO_ENTR_RING_INFO1_,
    pub /: *mut *mut u32 info2; / %HAL_REO_DEST_RING_INFO2_,
    pub __packed: },
...
pub struct hal_sw_monitor_ring {
    pub buf_addr_info: ath11k_buffer_addr,
    pub rx_mpdu_info: rx_mpdu_desc,
    pub status_buf_addr_info: ath11k_buffer_addr,
    pub info0: u32,
    pub info1: u32,
    pub __packed: },
...
pub struct hal_tcl_status_ring {
    pub info0: u32,
    pub msdu_byte_count: u32,
    pub msdu_timestamp: u32,
    pub meta_data: [u32; 2],
    pub info1: u32,
    pub rsvd0: u32,
    pub info2: u32,
...
pub struct hal_ce_srng_src_desc {
    ...
    pub /: *mut *mut u32 buffer_addr_info; / %HAL_CE_SRC_DESC_ADDR_INFO_,
    pub /: *mut *mut u32 meta_info; / %HAL_CE_SRC_DESC_META_INFO_,
    pub /: *mut *mut u32 flags; / %HAL_CE_SRC_DESC_FLAGS_,
    pub __packed: },
//
...
pub struct hal_ce_srng_dest_desc {
    pub buffer_addr_low: u32,
    pub /: *mut *mut u32 buffer_addr_info; / %HAL_CE_DEST_DESC_ADDR_INFO_,
    pub __packed: },
...
pub struct hal_ce_srng_dst_status_desc {
    pub /: *mut *mut u32 flags; / %HAL_CE_DST_STATUS_DESC_FLAGS_,
    pub toeplitz_hash0: u32,
    pub toeplitz_hash1: u32,
    pub /: *mut *mut u32 meta_info; / HAL_CE_DST_STATUS_DESC_META_INFO_,
    pub __packed: },
...
pub struct hal_rx_mpdu_link_ptr {
    pub addr_info: ath11k_buffer_addr,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct hal_rx_reo_queue {
    pub desc_hdr: hal_desc_header,
    pub rx_queue_num: u32,
    pub info0: u32,
    pub info1: u32,
    pub pn: [u32; 4],
    pub last_rx_enqueue_timestamp: u32,
    pub last_rx_dequeue_timestamp: u32,
    pub next_aging_queue: [u32; 2],
    pub prev_aging_queue: [u32; 2],
    pub rx_bitmap: [u32; 8],
    pub info2: u32,
    pub info3: u32,
    pub info4: u32,
    pub processed_mpdus: u32,
    pub processed_msdus: u32,
    pub processed_total_bytes: u32,
    pub info5: u32,
    pub rsvd: [u32; 3],
...
pub struct hal_reo_get_queue_stats_status {
    ...
    pub info2: u32,
    pub info3: u32,
    pub num_mpdu_frames: u32,
    pub num_msdu_frames: u32,
    pub total_bytes: u32,
    pub info4: u32,
    pub info5: u32,
    pub __packed: },
