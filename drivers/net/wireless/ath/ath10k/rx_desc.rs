...
//! Source: drivers/net/wireless/ath/ath10k/rx_desc.h
#![no_std]
...
pub struct rx_attention {
    pub /: *mut *mut __le32 flags; / %RX_ATTENTION_FLAGS_,
    pub __packed: },
//
// first_mpdu
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_frag_info_common {
    pub ring0_more_count: u8,
    pub ring1_more_count: u8,
    pub ring2_more_count: u8,
    pub ring3_more_count: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_frag_info_wcn3990 {
    pub ring4_more_count: u8,
    pub ring5_more_count: u8,
    pub ring6_more_count: u8,
    pub ring7_more_count: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_frag_info {
    pub common: rx_frag_info_common,
    pub wcn3990: rx_frag_info_wcn3990,
    pub __packed: },
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_frag_info_v1 {
    pub common: rx_frag_info_common,
    pub __packed: },
//
// ring0_more_count
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum htt_rx_mpdu_encrypt_type {
...
pub const RX_MPDU_START_INFO0_PEER_IDX_MASK: c_uint = 0x000007ff;
pub const RX_MPDU_START_INFO0_PEER_IDX_LSB: c_int = 0;
pub const RX_MPDU_START_INFO0_SEQ_NUM_MASK: c_uint = 0x0fff0000;
pub const RX_MPDU_START_INFO0_SEQ_NUM_LSB: c_int = 16;
pub const RX_MPDU_START_INFO0_ENCRYPT_TYPE_MASK: c_uint = 0xf0000000;
pub const RX_MPDU_START_INFO0_ENCRYPT_TYPE_LSB: c_int = 28;

pub const RX_MPDU_START_INFO1_TID_MASK: c_uint = 0xf0000000;
pub const RX_MPDU_START_INFO1_TID_LSB: c_int = 28;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_mpdu_start {
    pub info0: __le32,
    pub pn31_0: __le32,
    pub /: *mut *mut __le32 info1; / %RX_MPDU_START_INFO1_,
    pub __packed: },
    pub pn: [u8; 6],
    pub __packed: },
    pub __packed: },
...
//
pub const RX_MPDU_END_INFO0_RESERVED_0_MASK: c_uint = 0x00001fff;
pub const RX_MPDU_END_INFO0_RESERVED_0_LSB: c_int = 0;
pub const RX_MPDU_END_INFO0_POST_DELIM_CNT_MASK: c_uint = 0x0fff0000;
pub const RX_MPDU_END_INFO0_POST_DELIM_CNT_LSB: c_int = 16;
...
// See definition in RX attention descriptor
//
pub const RX_MSDU_START_INFO0_MSDU_LENGTH_MASK: c_uint = 0x00003fff;
pub const RX_MSDU_START_INFO0_MSDU_LENGTH_LSB: c_int = 0;
pub const RX_MSDU_START_INFO0_IP_OFFSET_MASK: c_uint = 0x000fc000;
pub const RX_MSDU_START_INFO0_IP_OFFSET_LSB: c_int = 14;
pub const RX_MSDU_START_INFO0_RING_MASK_MASK: c_uint = 0x00f00000;
pub const RX_MSDU_START_INFO0_RING_MASK_LSB: c_int = 20;
pub const RX_MSDU_START_INFO0_TCP_UDP_OFFSET_MASK: c_uint = 0x7f000000;
pub const RX_MSDU_START_INFO0_TCP_UDP_OFFSET_LSB: c_int = 24;
pub const RX_MSDU_START_INFO1_MSDU_NUMBER_MASK: c_uint = 0x000000ff;
pub const RX_MSDU_START_INFO1_MSDU_NUMBER_LSB: c_int = 0;
pub const RX_MSDU_START_INFO1_DECAP_FORMAT_MASK: c_uint = 0x00000300;
pub const RX_MSDU_START_INFO1_DECAP_FORMAT_LSB: c_int = 8;
pub const RX_MSDU_START_INFO1_SA_IDX_MASK: c_uint = 0x07ff0000;
pub const RX_MSDU_START_INFO1_SA_IDX_LSB: c_int = 16;

pub const RX_MSDU_START_INFO2_DA_IDX_MASK: c_uint = 0x000007ff;
pub const RX_MSDU_START_INFO2_DA_IDX_LSB: c_int = 0;
pub const RX_MSDU_START_INFO2_IP_PROTO_FIELD_MASK: c_uint = 0x00ff0000;
pub const RX_MSDU_START_INFO2_IP_PROTO_FIELD_LSB: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_msdu_start_common {
    pub /: *mut *mut __le32 info0; / %RX_MSDU_START_INFO0_,
    pub flow_id_crc: __le32,
    pub /: *mut *mut __le32 info1; / %RX_MSDU_START_INFO1_,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_msdu_start_qca99x0 {
    pub /: *mut *mut __le32 info2; / %RX_MSDU_START_INFO2_,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_msdu_start_wcn3990 {
    pub /: *mut *mut __le32 info2; / %RX_MSDU_START_INFO2_,
    pub /: *mut *mut __le32 info3; / %RX_MSDU_START_INFO3_,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_msdu_start {
    pub common: rx_msdu_start_common,
    pub wcn3990: rx_msdu_start_wcn3990,
    pub __packed: },
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_msdu_start_v1 {
    pub common: rx_msdu_start_common,
    pub qca99x0: rx_msdu_start_qca99x0,
    pub __packed: },
    pub __packed: },
//
// msdu_length
...
// Reserved: HW should fill with zero.  FW should ignore.
//
pub const RX_MSDU_END_INFO0_REPORTED_MPDU_LENGTH_MASK: c_uint = 0x00003fff;
pub const RX_MSDU_END_INFO0_REPORTED_MPDU_LENGTH_LSB: c_int = 0;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_msdu_end_common {
    pub ip_hdr_cksum: __le16,
    pub tcp_hdr_cksum: __le16,
    pub key_id_octet: u8,
    pub classification_filter: u8,
    pub wapi_pn: [u8; 10],
    pub info0: __le32,
    pub __packed: },
pub const RX_MSDU_END_INFO1_TCP_FLAG_MASK: c_uint = 0x000001ff;
pub const RX_MSDU_END_INFO1_TCP_FLAG_LSB: c_int = 0;
pub const RX_MSDU_END_INFO1_L3_HDR_PAD_MASK: c_uint = 0x00001c00;
pub const RX_MSDU_END_INFO1_L3_HDR_PAD_LSB: c_int = 10;
pub const RX_MSDU_END_INFO1_WINDOW_SIZE_MASK: c_uint = 0xffff0000;
pub const RX_MSDU_END_INFO1_WINDOW_SIZE_LSB: c_int = 16;

pub const RX_MSDU_END_INFO2_DA_OFFSET_MASK: c_uint = 0x0000003f;
pub const RX_MSDU_END_INFO2_DA_OFFSET_LSB: c_int = 0;
pub const RX_MSDU_END_INFO2_SA_OFFSET_MASK: c_uint = 0x00000fc0;
pub const RX_MSDU_END_INFO2_SA_OFFSET_LSB: c_int = 6;
pub const RX_MSDU_END_INFO2_TYPE_OFFSET_MASK: c_uint = 0x0003f000;
pub const RX_MSDU_END_INFO2_TYPE_OFFSET_LSB: c_int = 12;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_msdu_end_qca99x0 {
    pub ipv6_crc: __le32,
    pub tcp_seq_no: __le32,
    pub tcp_ack_no: __le32,
    pub info1: __le32,
    pub info2: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_msdu_end_wcn3990 {
    pub ipv6_crc: __le32,
    pub tcp_seq_no: __le32,
    pub tcp_ack_no: __le32,
    pub info1: __le32,
    pub info2: __le32,
    pub rule_indication_0: __le32,
    pub rule_indication_1: __le32,
    pub rule_indication_2: __le32,
    pub rule_indication_3: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_msdu_end {
    pub common: rx_msdu_end_common,
    pub wcn3990: rx_msdu_end_wcn3990,
    pub __packed: },
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_msdu_end_v1 {
    pub common: rx_msdu_end_common,
    pub qca99x0: rx_msdu_end_qca99x0,
    pub __packed: },
    pub __packed: },
//
// ip_hdr_chksum
...
// Reserved: HW should fill with zero.  FW should ignore.
//
pub const HTT_RX_PPDU_START_PREAMBLE_LEGACY: c_uint = 0x04;
pub const HTT_RX_PPDU_START_PREAMBLE_HT: c_uint = 0x08;
pub const HTT_RX_PPDU_START_PREAMBLE_HT_WITH_TXBF: c_uint = 0x09;
pub const HTT_RX_PPDU_START_PREAMBLE_VHT: c_uint = 0x0C;
pub const HTT_RX_PPDU_START_PREAMBLE_VHT_WITH_TXBF: c_uint = 0x0D;

pub const RX_PPDU_START_INFO1_L_SIG_RATE_MASK: c_uint = 0x0000000f;
pub const RX_PPDU_START_INFO1_L_SIG_RATE_LSB: c_int = 0;
pub const RX_PPDU_START_INFO1_L_SIG_LENGTH_MASK: c_uint = 0x0001ffe0;
pub const RX_PPDU_START_INFO1_L_SIG_LENGTH_LSB: c_int = 5;
pub const RX_PPDU_START_INFO1_L_SIG_TAIL_MASK: c_uint = 0x00fc0000;
pub const RX_PPDU_START_INFO1_L_SIG_TAIL_LSB: c_int = 18;
pub const RX_PPDU_START_INFO1_PREAMBLE_TYPE_MASK: c_uint = 0xff000000;
pub const RX_PPDU_START_INFO1_PREAMBLE_TYPE_LSB: c_int = 24;

pub const RX_PPDU_START_INFO2_HT_SIG_VHT_SIG_A_1_MASK: c_uint = 0x00ffffff;
pub const RX_PPDU_START_INFO2_HT_SIG_VHT_SIG_A_1_LSB: c_int = 0;
pub const RX_PPDU_START_INFO3_HT_SIG_VHT_SIG_A_2_MASK: c_uint = 0x00ffffff;
pub const RX_PPDU_START_INFO3_HT_SIG_VHT_SIG_A_2_LSB: c_int = 0;

pub const RX_PPDU_START_INFO4_VHT_SIG_B_MASK: c_uint = 0x1fffffff;
pub const RX_PPDU_START_INFO4_VHT_SIG_B_LSB: c_int = 0;
pub const RX_PPDU_START_INFO5_SERVICE_MASK: c_uint = 0x0000ffff;
pub const RX_PPDU_START_INFO5_SERVICE_LSB: c_int = 0;
// No idea what this flag means. It seems to be always set in rate.

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_ppdu_start {
    pub pri20_mhz: u8,
    pub ext20_mhz: u8,
    pub ext40_mhz: u8,
    pub ext80_mhz: u8,
    ...
    pub rssi_comb: u8,
    pub rsvd0: __le16,
    pub /: *mut *mut u8 info0; / %RX_PPDU_START_INFO0_,
    pub /: *mut *mut __le32 info1; / %RX_PPDU_START_INFO1_,
    pub /: *mut *mut __le32 info2; / %RX_PPDU_START_INFO2_,
    pub /: *mut *mut __le32 info3; / %RX_PPDU_START_INFO3_,
    pub /: *mut *mut __le32 info4; / %RX_PPDU_START_INFO4_,
    pub /: *mut *mut __le32 info5; / %RX_PPDU_START_INFO5_,
    pub __packed: },
//
// rssi_chain0_pri20
...
pub const RX_PPDU_END_INFO0_RX_ANTENNA_MASK: c_uint = 0x00ffffff;
pub const RX_PPDU_END_INFO0_RX_ANTENNA_LSB: c_int = 0;

pub const RX_PPDU_END_INFO1_PEER_IDX_MASK: c_uint = 0x1ffc;
pub const RX_PPDU_END_INFO1_PEER_IDX_LSB: c_int = 2;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_ppdu_end_common {
    pub evm_p0: __le32,
    pub evm_p1: __le32,
    pub evm_p2: __le32,
    pub evm_p3: __le32,
    ...
    pub wb_timestamp: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_ppdu_end_qca988x {
    pub locationing_timestamp: u8,
    pub phy_err_code: u8,
    pub /: *mut *mut __le16 flags; / %RX_PPDU_END_FLAGS_,
    pub /: *mut *mut __le32 info0; / %RX_PPDU_END_INFO0_,
    pub bb_length: __le16,
    pub /: *mut *mut __le16 info1; / %RX_PPDU_END_INFO1_,
    pub __packed: },
pub const RX_PPDU_END_RTT_CORRELATION_VALUE_MASK: c_uint = 0x00ffffff;
pub const RX_PPDU_END_RTT_CORRELATION_VALUE_LSB: c_int = 0;
pub const RX_PPDU_END_RTT_UNUSED_MASK: c_uint = 0x7f000000;
pub const RX_PPDU_END_RTT_UNUSED_LSB: c_int = 24;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_ppdu_end_qca6174 {
    pub locationing_timestamp: u8,
    pub phy_err_code: u8,
    pub /: *mut *mut __le16 flags; / %RX_PPDU_END_FLAGS_,
    pub /: *mut *mut __le32 info0; / %RX_PPDU_END_INFO0_,
    pub /: *mut *mut __le32 rtt; / %RX_PPDU_END_RTT_,
    pub bb_length: __le16,
    pub /: *mut *mut __le16 info1; / %RX_PPDU_END_INFO1_,
    pub __packed: },

pub const RX_LOCATION_INFO_RTT_CORR_VAL_MASK: c_uint = 0x0001ffff;
pub const RX_LOCATION_INFO_RTT_CORR_VAL_LSB: c_int = 0;
pub const RX_LOCATION_INFO_FAC_STATUS_MASK: c_uint = 0x000c0000;
pub const RX_LOCATION_INFO_FAC_STATUS_LSB: c_int = 18;
pub const RX_LOCATION_INFO_PKT_BW_MASK: c_uint = 0x00700000;
pub const RX_LOCATION_INFO_PKT_BW_LSB: c_int = 20;
pub const RX_LOCATION_INFO_RTT_TX_FRAME_PHASE_MASK: c_uint = 0x01800000;
pub const RX_LOCATION_INFO_RTT_TX_FRAME_PHASE_LSB: c_int = 23;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_pkt_end {
    pub /: *mut *mut __le32 info0; / %RX_PKT_END_INFO0_,
    pub phy_timestamp_1: __le32,
    pub phy_timestamp_2: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_pkt_end_wcn3990 {
    pub /: *mut *mut __le32 info0; / %RX_PKT_END_INFO0_,
    pub phy_timestamp_1: __le64,
    pub phy_timestamp_2: __le64,
    pub __packed: },
pub const RX_LOCATION_INFO0_RTT_FAC_LEGACY_MASK: c_uint = 0x00003fff;
pub const RX_LOCATION_INFO0_RTT_FAC_LEGACY_LSB: c_int = 0;
pub const RX_LOCATION_INFO0_RTT_FAC_VHT_MASK: c_uint = 0x1fff8000;
pub const RX_LOCATION_INFO0_RTT_FAC_VHT_LSB: c_int = 15;
pub const RX_LOCATION_INFO0_RTT_STRONGEST_CHAIN_MASK: c_uint = 0xc0000000;
pub const RX_LOCATION_INFO0_RTT_STRONGEST_CHAIN_LSB: c_int = 30;

pub const RX_LOCATION_INFO1_RTT_PREAMBLE_TYPE_MASK: c_uint = 0x0000000c;
pub const RX_LOCATION_INFO1_RTT_PREAMBLE_TYPE_LSB: c_int = 2;
pub const RX_LOCATION_INFO1_PKT_BW_MASK: c_uint = 0x00000030;
pub const RX_LOCATION_INFO1_PKT_BW_LSB: c_int = 4;
pub const RX_LOCATION_INFO1_SKIP_P_SKIP_BTCF_MASK: c_uint = 0x0000ff00;
pub const RX_LOCATION_INFO1_SKIP_P_SKIP_BTCF_LSB: c_int = 8;
pub const RX_LOCATION_INFO1_RTT_MSC_RATE_MASK: c_uint = 0x000f0000;
pub const RX_LOCATION_INFO1_RTT_MSC_RATE_LSB: c_int = 16;
pub const RX_LOCATION_INFO1_RTT_PBD_LEG_BW_MASK: c_uint = 0x00300000;
pub const RX_LOCATION_INFO1_RTT_PBD_LEG_BW_LSB: c_int = 20;
pub const RX_LOCATION_INFO1_TIMING_BACKOFF_MASK: c_uint = 0x07c00000;
pub const RX_LOCATION_INFO1_TIMING_BACKOFF_LSB: c_int = 22;
pub const RX_LOCATION_INFO1_RTT_TX_FRAME_PHASE_MASK: c_uint = 0x18000000;
pub const RX_LOCATION_INFO1_RTT_TX_FRAME_PHASE_LSB: c_int = 27;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_location_info {
    pub /: *mut *mut __le32 rx_location_info0; / %RX_LOCATION_INFO0_,
    pub /: *mut *mut __le32 rx_location_info1; / %RX_LOCATION_INFO1_,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_location_info_wcn3990 {
    pub /: *mut *mut __le32 rx_location_info0; / %RX_LOCATION_INFO0_,
    pub /: *mut *mut __le32 rx_location_info1; / %RX_LOCATION_INFO1_,
    pub /: *mut *mut __le32 rx_location_info2; / %RX_LOCATION_INFO2_,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum rx_phy_ppdu_end_info0 {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum rx_phy_ppdu_end_info1 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_phy_ppdu_end {
    pub /: *mut *mut __le32 info0; / %RX_PHY_PPDU_END_INFO0_,
    pub /: *mut *mut __le32 info1; / %RX_PHY_PPDU_END_INFO1_,
    pub __packed: },
pub const RX_PPDU_END_RX_TIMING_OFFSET_MASK: c_uint = 0x00000fff;
pub const RX_PPDU_END_RX_TIMING_OFFSET_LSB: c_int = 0;
pub const RX_PPDU_END_RX_INFO_RX_ANTENNA_MASK: c_uint = 0x00ffffff;
pub const RX_PPDU_END_RX_INFO_RX_ANTENNA_LSB: c_int = 0;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_ppdu_end_qca99x0 {
    pub rx_pkt_end: rx_pkt_end,
    pub /: *mut *mut __le32 rx_location_info; / %RX_LOCATION_INFO_,
    pub rx_phy_ppdu_end: rx_phy_ppdu_end,
    pub /: *mut *mut __le32 rx_timing_offset; / %RX_PPDU_END_RX_TIMING_OFFSET_,
    pub /: *mut *mut __le32 rx_info; / %RX_PPDU_END_RX_INFO_,
    pub bb_length: __le16,
    pub /: *mut *mut __le16 info1; / %RX_PPDU_END_INFO1_,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_ppdu_end_qca9984 {
    pub rx_pkt_end: rx_pkt_end,
    pub rx_location_info: rx_location_info,
    pub rx_phy_ppdu_end: rx_phy_ppdu_end,
    pub /: *mut *mut __le32 rx_timing_offset; / %RX_PPDU_END_RX_TIMING_OFFSET_,
    pub /: *mut *mut __le32 rx_info; / %RX_PPDU_END_RX_INFO_,
    pub bb_length: __le16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_ppdu_end_wcn3990 {
    pub rx_pkt_end: rx_pkt_end_wcn3990,
    pub rx_location_info: rx_location_info_wcn3990,
    pub rx_phy_ppdu_end: rx_phy_ppdu_end,
    pub rx_timing_offset: __le32,
    pub reserved_info_0: __le32,
    pub reserved_info_1: __le32,
    pub rx_antenna_info: __le32,
    pub rx_coex_info: __le32,
    pub rx_mpdu_cnt_info: __le32,
    pub phy_timestamp_tx: __le64,
    pub rx_bb_length: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_ppdu_end {
    pub common: rx_ppdu_end_common,
    pub wcn3990: rx_ppdu_end_wcn3990,
    pub __packed: },
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_ppdu_end_v1 {
    pub common: rx_ppdu_end_common,
    pub qca988x: rx_ppdu_end_qca988x,
    pub qca6174: rx_ppdu_end_qca6174,
    pub qca99x0: rx_ppdu_end_qca99x0,
    pub qca9984: rx_ppdu_end_qca9984,
    pub __packed: },
    pub __packed: },
//
// evm_p0
...
pub const FW_RX_DESC_INFO0_EXT_MASK: c_uint = 0xC0;
pub const FW_RX_DESC_INFO0_EXT_LSB: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fw_rx_desc_base {
    pub info0: u8,
    pub __packed: },

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fw_rx_desc_hl {
    pub bits: },
    pub info0: u8,
    pub u: },
    pub version: u8,
