...
//! Source: drivers/net/wireless/ath/ath10k/wmi-tlv.h
#![no_std]
...
pub const WMI_TLV_MGMT_TX_FRAME_MAX_LEN: c_int = 64;

#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum wmi_tlv_grp_id {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ath10k_mgmt_tx_pkt_addr {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_chan_info_event {
    pub err_code: __le32,
    pub freq: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_mgmt_tx_compl_ev {
    pub desc_id: __le32,
    pub status: __le32,
    pub pdev_id: __le32,
    pub ppdu_id: __le32,
...
pub const WMI_TLV_MGMT_RX_NUM_RSSI: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_mgmt_rx_ev {
    pub channel: __le32,
    pub snr: __le32,
    pub rate: __le32,
    pub phy_mode: __le32,
    pub buf_len: __le32,
    pub status: __le32,
    pub rssi: [__le32; WMI_TLV_MGMT_RX_NUM_RSSI],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_abi_version {
    pub abi_ver0: __le32,
    pub abi_ver1: __le32,
    pub abi_ver_ns0: __le32,
    pub abi_ver_ns1: __le32,
    pub abi_ver_ns2: __le32,
    pub abi_ver_ns3: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum wmi_tlv_hw_bd_id {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_hw_bd_info {
    pub rev: u8,
    pub project_id: u8,
    pub custom_id: u8,
    pub reference_design_id: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_svc_rdy_ev {
    pub fw_build_vers: __le32,
    pub abi: wmi_tlv_abi_version,
    ...
    pub max_num_scan_chans: __le32,
    pub /: *mut *mut __le32 hw_bd_id; / 0 means hw_bd_info is invalid,
    pub hw_bd_info: [wmi_tlv_hw_bd_info; 5],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_rdy_ev {
    pub abi: wmi_tlv_abi_version,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_resource_config {
    ...
    pub host_capab: __le32,
    pub __packed: },
// structure describing host memory chunk.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct host_memory_chunk_tlv {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_init_cmd {
    pub abi: wmi_tlv_abi_version,
    pub num_host_mem_chunks: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_pdev_get_temp_cmd {
    pub /: *mut *mut __le32 pdev_id; / not used,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_pdev_temperature_event {
    pub tlv_hdr: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_pdev_set_param_cmd {
    pub /: *mut *mut __le32 pdev_id; / not used yet,
    pub param_id: __le32,
    pub param_value: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_pdev_set_rd_cmd {
    pub /: *mut *mut __le32 pdev_id; / not used yet,
    pub regd: __le32,
    pub regd_2ghz: __le32,
    pub regd_5ghz: __le32,
    pub conform_limit_2ghz: __le32,
    pub conform_limit_5ghz: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_scan_chan_list_cmd {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_peer_create_cmd {
    pub vdev_id: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_peer_assoc_cmd {
    pub mac_addr: wmi_mac_addr,
    pub vdev_id: __le32,
    pub new_assoc: __le32,
    pub assoc_id: __le32,
    pub flags: __le32,
    pub caps: __le32,
    pub listen_intval: __le32,
    pub ht_caps: __le32,
    pub max_mpdu: __le32,
    pub mpdu_density: __le32,
    pub rate_caps: __le32,
    pub nss: __le32,
    pub vht_caps: __le32,
    pub phy_mode: __le32,
    pub ht_info: [__le32; 2],
    pub num_legacy_rates: __le32,
    pub num_ht_rates: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_pdev_suspend {
    pub /: *mut *mut __le32 pdev_id; / not used yet,
    pub opt: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_pdev_set_wmm_cmd {
    pub /: *mut *mut __le32 pdev_id; / not used yet,
    pub /: *mut *mut __le32 dg_type; / no idea..,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_vdev_wmm_params {
    pub dummy: __le32,
    pub params: wmi_wmm_params,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_vdev_set_wmm_cmd {
    pub vdev_id: __le32,
    pub vdev_wmm_params: [wmi_tlv_vdev_wmm_params; 4],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_phyerr_ev {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum wmi_tlv_dbglog_log_level {
...
pub const WMI_TLV_DBGLOG_BITMAP_MAX_IDS: c_int = 512;

pub const WMI_TLV_DBGLOG_ALL_MODULES: c_uint = 0xffff;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_dbglog_cmd {
    pub param: __le32,
    pub value: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_resume_cmd {
    pub reserved: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_req_stats_cmd {
    pub /: *mut *mut __le32 stats_id; / wmi_stats_id,
    pub vdev_id: __le32,
    pub peer_macaddr: wmi_mac_addr,
    pub __packed: },
pub const WMI_TLV_PEER_RX_DURATION_HIGH_VALID_BIT: c_int = 31;

pub const WMI_TLV_PEER_RX_DURATION_SHIFT: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_peer_stats_extd {
    pub peer_macaddr: wmi_mac_addr,
    pub rx_duration: __le32,
    pub peer_tx_bytes: __le32,
    pub peer_rx_bytes: __le32,
    pub last_tx_rate_code: __le32,
    pub last_tx_power: __le32,
    pub rx_mc_bc_cnt: __le32,
    pub rx_duration_high: __le32,
    pub reserved: [__le32; 2],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_vdev_stats {
    pub vdev_id: __le32,
    pub beacon_snr: __le32,
    pub data_snr: __le32,
    pub /: *mut *mut __le32 num_tx_frames[4]; / per-AC,
    pub num_rx_frames: __le32,
    pub num_tx_frames_retries: [__le32; 4],
    pub num_tx_frames_failures: [__le32; 4],
    ...
    pub tx_rate_history: [__le32; 10],
    pub beacon_rssi_history: [__le32; 10],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_pktlog_enable {
    pub reserved: __le32,
    pub filter: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_pktlog_disable {
    pub reserved: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum wmi_tlv_bcn_tx_status {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_bcn_tx_status_ev {
    pub vdev_id: __le32,
    pub tx_status: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_bcn_prb_info {
    pub caps: __le32,
    pub erp: __le32,
    pub ies: [u8; ],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_bcn_tmpl_cmd {
    pub vdev_id: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_prb_tmpl_cmd {
    pub vdev_id: __le32,
    pub buf_len: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_p2p_go_bcn_ie {
    pub vdev_id: __le32,
    pub ie_len: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum wmi_tlv_diag_item_type {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_diag_data_ev {
    pub num_items: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_sta_keepalive_cmd {
    pub vdev_id: __le32,
    pub enabled: __le32,
...
//
    pub last_tx_rate_code: __le32,
    pub last_rx_rate_code: __le32,
    pub last_tx_bitrate_kbps: __le32,
    pub last_rx_bitrate_kbps: __le32,
    pub peer_rssi: __le32,
    pub tx_succeed: __le32,
    pub peer_rssi_per_chain: [__le32; WMI_TLV_MAX_CHAINS],
    pub __packed: },

#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_p2p_noa_ev {
    pub vdev_id: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_roam_ev {
    pub vdev_id: __le32,
    pub reason: __le32,
    pub rssi: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_wow_add_del_event_cmd {
    pub vdev_id: __le32,
    pub is_add: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_request_peer_stats_info {
    pub request_type: __le32,
    pub vdev_id: __le32,
// peer MAC address
    pub peer_macaddr: wmi_mac_addr,
    pub reset_after_request: __le32,
    pub __packed: },
// Command to set/unset chip in quiet mode
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_set_quiet_cmd {
    pub vdev_id: __le32,
// in TUs
    pub period: __le32,
// in TUs
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum wmi_tlv_wow_interface_cfg {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_wow_enable_cmd {
    pub enable: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_wow_host_wakeup_ind {
    pub reserved: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_wow_bitmap_pattern {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_wow_add_pattern_cmd {
    pub vdev_id: __le32,
    pub pattern_id: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_wow_del_pattern_cmd {
    pub vdev_id: __le32,
    pub pattern_id: __le32,
    pub pattern_type: __le32,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tdls_set_state_cmd {
    pub vdev_id: __le32,
    pub state: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tdls_peer_update_cmd {
    pub vdev_id: __le32,
    pub peer_macaddr: wmi_mac_addr,
...
pub const WMI_TLV_TDLS_PEER_SP_MASK: c_uint = 0x60;
pub const WMI_TLV_TDLS_PEER_SP_LSB: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tdls_peer_capab {
    pub peer_qos: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_adaptive_qcs {
    pub enable: __le32,
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum wmi_tlv_tx_pause_action {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_tx_pause_ev {
    pub pause_id: __le32,
    pub action: __le32,
    pub vdev_map: __le32,
    pub peer_id: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_tdls_peer_event {
    pub peer_macaddr: wmi_mac_addr,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum wmi_tlv_sys_cap_info_flags {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum wmi_tlv_rfkill_enable_radio {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum wmi_tlv_rfkill_radio_state {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_rfkill_state_change_ev {
...
extern "C" {
    pub fn ath10k_wmi_tlv_attach(ar: *mut ath10k);
}
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum wmi_nlo_auth_algorithm {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum wmi_nlo_cipher_algorithm {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum wmi_nlo_ssid_bcastnwtype {
...
pub const WMI_ENLO_FLAG_DIRECTED_SCAN: c_int = 1;
// Whether PNO event shall be triggered if the network is found on A band
pub const WMI_ENLO_FLAG_A_BAND: c_int = 2;
// Whether PNO event shall be triggered if the network is found on G band
pub const WMI_ENLO_FLAG_G_BAND: c_int = 4;
// Whether strict matching is required (i.e. firmware shall not
// match on the entire SSID)
//
pub const WMI_ENLO_FLAG_STRICT_MATCH: c_int = 8;
// Code for matching the beacon AUTH IE - additional codes TBD
// open
pub const WMI_ENLO_AUTH_CODE_OPEN: c_int = 1;
// WPA_PSK or WPA2PSK
pub const WMI_ENLO_AUTH_CODE_PSK: c_int = 2;
// any EAPOL
pub const WMI_ENLO_AUTH_CODE_EAPOL: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nlo_channel_prediction_cfg {
    pub tlv_header: __le32,
...
//
    pub stationary_threshold: __le32,
...
//
    pub full_scan_period_ms: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct enlo_candidate_score_params_t {
    pub /: *mut *mut __le32 tlv_header; / TLV tag and len;,
// minimum 5GHz RSSI for a BSSID to be considered (units = dBm)
    pub min_5ghz_rssi: __le32,
// minimum 2.4GHz RSSI for a BSSID to be considered (units = dBm)
    pub min_24ghz_rssi: __le32,
// the maximum score that a network can have before bonuses
    pub initial_score_max: __le32,
// current_connection_bonus:
// only report when there is a network's score this much higher
// than the current connection
//
    pub current_connection_bonus: __le32,
// score bonus for all networks with the same network flag
    pub same_network_bonus: __le32,
// score bonus for networks that are not open
    pub secure_bonus: __le32,
// 5GHz RSSI score bonus (applied to all 5GHz networks)
    pub band_5ghz_bonus: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct connected_nlo_bss_band_rssi_pref_t {
    pub len;*/: *mut *mut __le32 tlv_header; / TLV tag and,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_tlv_mgmt_tx_cmd {
    pub vdev_id: __le32,
    pub desc_id: __le32,
    pub chanfreq: __le32,
    pub paddr: __le64,
