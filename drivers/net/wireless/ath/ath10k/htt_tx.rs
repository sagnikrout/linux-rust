...
//! Source: drivers/net/wireless/ath/ath10k/htt_tx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_txq_calc_size(count: usize) -> u8 {
    ...
    bit = BIT(peer_id % 32);
    idx = peer_id / 32;
    ieee80211_txq_get_depth(txq, core::ptr::null_mut(), &byte_cnt);
...
#[no_mangle]
unsafe extern "C" fn __ath10k_htt_tx_txq_sync(ar: *mut ath10k) {
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_tx_txq_sync(ar: *mut ath10k) {
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_tx_dec_pending(htt: *mut ath10k_htt) {
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_tx_inc_pending(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_tx_mgmt_dec_pending(htt: *mut ath10k_htt) {
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_tx_alloc_msdu_id(htt: *mut ath10k_htt, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_tx_free_msdu_id(htt: *mut ath10k_htt, msdu_id: u16) {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_free_cont_txbuf_32(htt: *mut ath10k_htt) {
    ...
    htt.txbuf.paddr);
    htt.txbuf.vaddr_txbuff_32 = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_alloc_cont_txbuf_32(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_free_cont_txbuf_64(htt: *mut ath10k_htt) {
    ...
    htt.txbuf.paddr);
    htt.txbuf.vaddr_txbuff_64 = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_alloc_cont_txbuf_64(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_free_cont_frag_desc_32(htt: *mut ath10k_htt) {
    ...
    htt.frag_desc.paddr);
    htt.frag_desc.vaddr_desc_32 = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_alloc_cont_frag_desc_32(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_free_cont_frag_desc_64(htt: *mut ath10k_htt) {
    ...
    htt.frag_desc.paddr);
    htt.frag_desc.vaddr_desc_64 = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_alloc_cont_frag_desc_64(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_free_txq(htt: *mut ath10k_htt) {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_alloc_txq(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_free_txdone_fifo(htt: *mut ath10k_htt) {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_alloc_txdone_fifo(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_alloc_buf(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_tx_start(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_clean_up_pending(msdu_id: c_int, skb: *mut c_void, ctx: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_tx_destroy(htt: *mut ath10k_htt) {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_flush_tx_queue(htt: *mut ath10k_htt) {
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_tx_stop(htt: *mut ath10k_htt) {
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_tx_free(htt: *mut ath10k_htt) {
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_op_ep_tx_credits(ar: *mut ath10k) {
    void ath10k_htt_op_ep_tx_credits(struct ath10k *ar)
    {
    queue_work(ar.workqueue, &ar.bundle_tx_work);
    }
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_htc_tx_complete(ar: *mut ath10k, skb: *mut sk_buff) {
    void ath10k_htt_htc_tx_complete(struct ath10k *ar, struct sk_buff *skb)
    {
    struct ath10k_htt *htt = &ar.htt;
    let mut tx_done: htt_tx_done = {};
    struct htt_cmd_hdr *htt_hdr;
    struct htt_data_tx_desc *desc_hdr = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_hif_tx_complete(ar: *mut ath10k, skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_h2t_ver_req_msg(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_send_frag_desc_bank_cfg_32(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_send_frag_desc_bank_cfg_64(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_send_rx_ring_cfg_32(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_send_rx_ring_cfg_64(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_send_rx_ring_cfg_hl(htt: *mut ath10k_htt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_get_vdev_id(ar: *mut ath10k, skb: *mut sk_buff) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ath10k_htt_tx_get_tid(skb: *mut sk_buff, is_eth: bool) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn if(ATH10K_SKB_F_QOS: cb->flags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_mgmt_tx(htt: *mut ath10k_htt, msdu: *mut sk_buff) -> c_int {
    int ath10k_htt_mgmt_tx(struct ath10k_htt *htt, struct sk_buff *msdu)
    {
    struct ath10k *ar = htt.ar;
    struct device *dev = ar.dev;
    struct sk_buff *txdesc = core::ptr::null_mut();
    struct htt_cmd *cmd;
    struct ath10k_skb_cb *skb_cb = ATH10K_SKB_CB(msdu);
    let mut vdev_id: u8 = ath10k_htt_tx_get_vdev_id(ar, msdu);
    let mut len: c_int = 0;
    let mut msdu_id: c_int = -1;
    int res;
    const u8 *peer_addr;
    ...
    let mut is_eth: bool = (txmode == ATH10K_HW_TXRX_ETHERNET);
    let mut vdev_id: u8 = ath10k_htt_tx_get_vdev_id(ar, msdu);
    let mut tid: u8 = ath10k_htt_tx_get_tid(msdu, is_eth);
    let mut flags0: u8 = 0;
    let mut flags1: u16 = 0;
    let mut msdu_id: u16 = 0;
    if (!is_eth) {
    struct ieee80211_hdr *hdr = (struct ieee80211_hdr *)msdu.data;
    if ((ieee80211_is_action(hdr.frame_control) ||
    ieee80211_is_deauth(hdr.frame_control) ||
...
//
    ...
    let mut freq: u16 = 0;
    let mut frags_paddr: u32 = 0;
    u32 txbuf_paddr;
    struct htt_msdu_ext_desc *ext_desc = core::ptr::null_mut();
    struct htt_msdu_ext_desc *ext_desc_t = core::ptr::null_mut();
    res = ath10k_htt_tx_alloc_msdu_id(htt, msdu);
    if (res < 0)
    goto err;
    msdu_id = res;
...
//
    ...
    ath10k_dbg_dump(ar, ATH10K_DBG_HTT_DUMP, core::ptr::null_mut(), "htt tx msdu: ",
    msdu.data, msdu.len);
    trace_ath10k_tx_hdr(ar, msdu.data, msdu.len);
    trace_ath10k_tx_payload(ar, msdu.data, msdu.len);
    sg_items[0].transfer_id = 0;
    sg_items[0].transfer_context = core::ptr::null_mut();
    ...
    sg_items[1].transfer_context = core::ptr::null_mut();
    ...
    u16 msdu_id, flags1 = 0;
    let mut freq: u16 = 0;
    let mut frags_paddr: dma_addr_t = 0;
    dma_addr_t txbuf_paddr;
    struct htt_msdu_ext_desc_64 *ext_desc = core::ptr::null_mut();
    struct htt_msdu_ext_desc_64 *ext_desc_t = core::ptr::null_mut();
    res = ath10k_htt_tx_alloc_msdu_id(htt, msdu);
    if (res < 0)
    goto err;
    msdu_id = res;
...
#[no_mangle]
pub unsafe extern "C" fn ath10k_htt_set_tx_ops(htt: *mut ath10k_htt) {
