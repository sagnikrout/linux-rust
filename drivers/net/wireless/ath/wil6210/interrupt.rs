...
//! Source: drivers/net/wireless/ath/wil6210/interrupt.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn wil_icr_clear(x: u32, addr: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_ioread32_and_clear(addr: *mut void __iomem) -> u32 {
    static inline u32 wil_ioread32_and_clear(void __iomem *addr)
    {
    let mut x: u32 = readl(addr);
    wil_icr_clear(x, addr);
    return x;
    }
#[no_mangle]
unsafe extern "C" fn wil6210_mask_irq_tx(wil: *mut wil6210_priv) {
...
#[no_mangle]
unsafe extern "C" fn wil6210_mask_irq_tx_edma(wil: *mut wil6210_priv) {
...
#[no_mangle]
unsafe extern "C" fn wil6210_mask_irq_rx(wil: *mut wil6210_priv) {
...
#[no_mangle]
unsafe extern "C" fn wil6210_mask_irq_rx_edma(wil: *mut wil6210_priv) {
...
#[no_mangle]
unsafe extern "C" fn wil6210_mask_irq_misc(wil: *mut wil6210_priv, mask_halp: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn wil6210_mask_halp(wil: *mut wil6210_priv) {
...
#[no_mangle]
unsafe extern "C" fn wil6210_mask_irq_pseudo(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil6210_unmask_irq_tx(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil6210_unmask_irq_tx_edma(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil6210_unmask_irq_rx(wil: *mut wil6210_priv) {
    void wil6210_unmask_irq_rx(struct wil6210_priv *wil)
    {
    let mut unmask_rx_htrsh: bool = atomic_read(&wil.connected_vifs) > 0;
    wil_w(wil, RGF_DMA_EP_RX_ICR + offsetof(struct RGF_ICR, IMC),
    unmask_rx_htrsh ? WIL6210_IMC_RX : WIL6210_IMC_RX_NO_RX_HTRSH);
    }
#[no_mangle]
pub unsafe extern "C" fn wil6210_unmask_irq_rx_edma(wil: *mut wil6210_priv) {
...
#[no_mangle]
unsafe extern "C" fn wil6210_unmask_irq_misc(wil: *mut wil6210_priv, unmask_halp: bool) {
...
#[no_mangle]
unsafe extern "C" fn wil6210_unmask_halp(wil: *mut wil6210_priv) {
...
#[no_mangle]
unsafe extern "C" fn wil6210_unmask_irq_pseudo(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_mask_irq(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_unmask_irq(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_configure_interrupt_moderation_edma(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_configure_interrupt_moderation(wil: *mut wil6210_priv) {
...
#[no_mangle]
unsafe extern "C" fn wil6210_irq_rx(irq: c_int, cookie: *mut c_void) -> irqreturn_t {
    static irqreturn_t wil6210_irq_rx(int irq, void *cookie)
    {
    struct wil6210_priv *wil = cookie;
    u32 isr;
    let mut need_unmask: bool = true;
    wil6210_mask_irq_rx(wil);
...
#[no_mangle]
unsafe extern "C" fn wil6210_irq_rx_edma(irq: c_int, cookie: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wil6210_irq_tx_edma(irq: c_int, cookie: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wil6210_irq_tx(irq: c_int, cookie: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wil_notify_fw_error(wil: *mut wil6210_priv) {
...
#[no_mangle]
unsafe extern "C" fn wil_cache_mbox_regs(wil: *mut wil6210_priv) {
...
#[no_mangle]
unsafe extern "C" fn wil_validate_mbox_regs(wil: *mut wil6210_priv) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wil6210_irq_misc(irq: c_int, cookie: *mut c_void) -> irqreturn_t {
    ...
    let mut fw_assert_code: u32 = wil_r(wil, wil.rgf_fw_assert_code_addr);
...
#[no_mangle]
unsafe extern "C" fn wil6210_irq_misc_thread(irq: c_int, cookie: *mut c_void) -> irqreturn_t {
    static irqreturn_t wil6210_irq_misc_thread(int irq, void *cookie)
    {
    struct wil6210_priv *wil = cookie;
    let mut isr: u32 = wil.isr_misc;
...
// thread IRQ handler
#[no_mangle]
unsafe extern "C" fn wil6210_thread_irq(irq: c_int, cookie: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn wil6210_debug_irq_mask(wil: *mut wil6210_priv, pseudo_cause: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil6210_hardirq(irq: c_int, cookie: *mut c_void) -> irqreturn_t {
    static irqreturn_t wil6210_hardirq(int irq, void *cookie)
    {
    let mut rc: irqreturn_t = IRQ_HANDLED;
    struct wil6210_priv *wil = cookie;
    let mut pseudo_cause: u32 = wil_r(wil, RGF_DMA_PSEUDO_CAUSE);
//
...
#[no_mangle]
unsafe extern "C" fn wil6210_request_3msi(wil: *mut wil6210_priv, irq: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wil_clear32(addr: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn wil6210_clear_irq(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil6210_set_halp(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil6210_clear_halp(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil6210_init_irq(wil: *mut wil6210_priv, irq: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wil6210_fini_irq(wil: *mut wil6210_priv, irq: c_int) {
