...
//! Source: drivers/net/wireless/ath/wil6210/netdev.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn wil_has_active_ifaces(wil: *mut wil6210_priv, up: bool, ok: bool) -> bool {
    bool wil_has_active_ifaces(struct wil6210_priv *wil, bool up, bool ok)
    {
// use NULL ndev argument to check all interfaces
    return wil_has_other_active_ifaces(wil, core::ptr::null_mut(), up, ok);
    }
#[no_mangle]
unsafe extern "C" fn wil_open(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil_stop(ndev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil6210_netdev_poll_rx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil6210_netdev_poll_rx_edma(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil6210_netdev_poll_tx(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int wil6210_netdev_poll_tx(struct napi_struct *napi, int budget)
    {
    struct wil6210_priv *wil = container_of(napi, struct wil6210_priv,
    napi_tx);
    let mut tx_done: c_int = 0;
    uint i;
...
#[no_mangle]
unsafe extern "C" fn wil6210_netdev_poll_tx_edma(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil_dev_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn wil_vif_deinit(vif: *mut wil6210_vif) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_vif_free(vif: *mut wil6210_vif) {
...
#[no_mangle]
unsafe extern "C" fn wil_ndev_destructor(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn wil_connect_timer_fn(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn wil_scan_timer_fn(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn wil_p2p_discovery_timer_fn(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn wil_vif_init(vif: *mut wil6210_vif) {
...
#[no_mangle]
unsafe extern "C" fn wil_vif_find_free_mid(wil: *mut wil6210_priv) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn wil_if_free(wil: *mut wil6210_priv) {
    ...
    return;
    wil_priv_deinit(wil);
    wil.main_ndev = core::ptr::null_mut();
    wil_ndev_destructor(ndev);
    free_netdev(ndev);
    wil_cfg80211_deinit(wil);
    }
#[no_mangle]
pub unsafe extern "C" fn wil_vif_add(wil: *mut wil6210_priv, vif: *mut wil6210_vif) -> c_int {
    int wil_vif_add(struct wil6210_priv *wil, struct wil6210_vif *vif)
    {
    struct net_device *ndev = vif_to_ndev(vif);
    struct wireless_dev *wdev = vif_to_wdev(vif);
    let mut any_active: bool = wil_has_active_ifaces(wil, true, false);
    int rc;
    ASSERT_RTNL();
    if (wil.vifs[vif.mid]) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_if_add(wil: *mut wil6210_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wil_vif_remove(wil: *mut wil6210_priv, mid: u8) {
    ...
    wil6210_disconnect(vif, core::ptr::null_mut(), WLAN_REASON_DEAUTH_LEAVING);
...
// make sure no one is accessing the VIF before removing
    ...
    wil.vifs[mid] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn wil_if_remove(wil: *mut wil6210_priv) {
