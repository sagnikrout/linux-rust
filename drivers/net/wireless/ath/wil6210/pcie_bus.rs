...
//! Source: drivers/net/wireless/ath/wil6210/pcie_bus.c
#![no_std]
...
//
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn wil_set_capabilities(wil: *mut wil6210_priv) -> c_int {
    int wil_set_capabilities(struct wil6210_priv *wil)
    {
    const char *wil_fw_name;
    let mut jtag_id: u32 = wil_r(wil, RGF_USER_JTAG_DEV_ID);
...
#[no_mangle]
pub unsafe extern "C" fn wil_disable_irq(wil: *mut wil6210_priv) {
    void wil_disable_irq(struct wil6210_priv *wil)
    {
    let mut irq: c_int = wil.pdev.irq;
    disable_irq(irq);
    if (wil.n_msi == 3) {
    disable_irq(irq + 1);
    disable_irq(irq + 2);
...
#[no_mangle]
pub unsafe extern "C" fn wil_enable_irq(wil: *mut wil6210_priv) {
...
#[no_mangle]
unsafe extern "C" fn wil_remove_all_additional_vifs(wil: *mut wil6210_priv) {
...
// Bus ops
#[no_mangle]
unsafe extern "C" fn wil_if_pcie_enable(wil: *mut wil6210_priv) -> c_int {
...
//
    let mut msi_only: c_int = pdev.msi_enabled;
...
#[no_mangle]
unsafe extern "C" fn wil_if_pcie_disable(wil: *mut wil6210_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil_platform_rop_ramdump(wil_handle: *mut c_void, buf: *mut c_void, size: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil_platform_rop_fw_recovery(wil_handle: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil_platform_ops_uninit(wil: *mut wil6210_priv) {
...
#[no_mangle]
unsafe extern "C" fn wil_pcie_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    ...
    let mut bar_size: u32 = pci_resource_len(pdev, 0);
...
#[no_mangle]
unsafe extern "C" fn wil_pcie_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn wil6210_suspend(dev: *mut device, is_runtime: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil6210_resume(dev: *mut device, is_runtime: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil6210_pm_suspend(dev: *mut device) -> int __maybe_unused {
    static int __maybe_unused wil6210_pm_suspend(struct device *dev)
    {
    return wil6210_suspend(dev, false);
    }
#[no_mangle]
unsafe extern "C" fn wil6210_pm_resume(dev: *mut device) -> int __maybe_unused {
    static int __maybe_unused wil6210_pm_resume(struct device *dev)
    {
    return wil6210_resume(dev, false);
    }
#[no_mangle]
unsafe extern "C" fn wil6210_pm_runtime_idle(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn wil6210_pm_runtime_resume(dev: *mut device) -> int __maybe_unused {
    static int __maybe_unused wil6210_pm_runtime_resume(struct device *dev)
    {
    return wil6210_resume(dev, true);
    }
#[no_mangle]
unsafe extern "C" fn wil6210_pm_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn wil6210_driver_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn wil6210_driver_exit() -> void __exit {
