...
//! Source: drivers/net/wireless/ath/wil6210/main.c
#![no_std]
...
pub const WAIT_FOR_HALP_VOTE_MS: c_int = 100;
pub const WAIT_FOR_SCAN_ABORT_MS: c_int = 1000;
pub const WIL_DEFAULT_NUM_RX_STATUS_RINGS: c_int = 1;
pub const WIL_BOARD_FILE_MAX_NAMELEN: c_int = 128;
    bool debug_fw; /* = false; */
...
//
    let mut rx_ring_overflow_thrsh: c_ushort = WIL6210_RX_HIGH_TRSH_INIT;
...
//
    let mut mtu_max: c_uint = TXRX_BUF_LEN_DEFAULT - WIL_MAX_MPDU_OVERHEAD;
#[no_mangle]
unsafe extern "C" fn mtu_max_set(val: *const c_char, kp: *const kernel_param) -> c_int {
...
//
    ...
    let mut tx_ring_order: static uint = WIL_TX_RING_SIZE_ORDER_DEFAULT;
    let mut bcast_ring_order: static uint = WIL_BCAST_RING_SIZE_ORDER_DEFAULT;
#[no_mangle]
unsafe extern "C" fn ring_order_set(val: *const c_char, kp: *const kernel_param) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn wil_mem_access_lock(wil: *mut wil6210_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wil_mem_access_unlock(wil: *mut wil6210_priv) {
    void wil_mem_access_unlock(struct wil6210_priv *wil)
    {
    up_read(&wil.mem_lock);
    }
#[no_mangle]
unsafe extern "C" fn wil_ring_fini_tx(wil: *mut wil6210_priv, id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn wil_vif_is_connected(wil: *mut wil6210_priv, mid: u8) -> bool {
    ...
    let mut min_ring_id: c_int = wil_get_min_tx_ring_id(wil);
    might_sleep();
    wil_dbg_misc(wil,
...
// reorder buffers
    ...
    r = sta.tid_rx[i];
    sta.tid_rx[i] = core::ptr::null_mut();
...
// link state
    ...
    wil_bcast_fini(vif);
    wil_update_net_queues_bh(wil, vif, core::ptr::null_mut(), true);
    ...
    cfg80211_connect_result(ndev, bssid, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0,
    WLAN_STATUS_UNSPECIFIED_FAILURE,
    GFP_KERNEL);
    vif.bss = core::ptr::null_mut();
    }
    ...
    wil_update_net_queues_bh(wil, vif, core::ptr::null_mut(), false);
    }
    break;
    default:
    break;
...
#[no_mangle]
pub unsafe extern "C" fn wil_disconnect_worker(work: *mut work_struct) {
...
// already disconnected
    ...
    rc = wmi_call(wil, WMI_DISCONNECT_CMDID, vif.mid, core::ptr::null_mut(), 0,
    ...
    wil_update_net_queues_bh(wil, vif, core::ptr::null_mut(), true);
    netif_carrier_off(ndev);
    cfg80211_connect_result(ndev, core::ptr::null_mut(), core::ptr::null_mut(), 0, core::ptr::null_mut(), 0,
    WLAN_STATUS_UNSPECIFIED_FAILURE, GFP_KERNEL);
    clear_bit(wil_vif_fwconnecting, vif.status);
    }
#[no_mangle]
unsafe extern "C" fn wil_wait_for_recovery(wil: *mut wil6210_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wil_set_recovery_state(wil: *mut wil6210_priv, state: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_is_recovery_blocked(wil: *mut wil6210_priv) -> bool {
    bool wil_is_recovery_blocked(struct wil6210_priv *wil)
    {
    return no_fw_recovery && (wil.recovery_state == fw_recovery_pending);
    }
#[no_mangle]
unsafe extern "C" fn wil_fw_error_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn wil_find_free_ring(wil: *mut wil6210_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wil_ring_init_tx(vif: *mut wil6210_vif, cid: c_int) -> c_int {
    int wil_ring_init_tx(struct wil6210_vif *vif, int cid)
    {
    struct wil6210_priv *wil = vif_to_wil(vif);
    let mut rc: c_int = -EINVAL, ringid;
    if (cid < 0) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_bcast_init(vif: *mut wil6210_vif) -> c_int {
    int wil_bcast_init(struct wil6210_vif *vif)
    {
    struct wil6210_priv *wil = vif_to_wil(vif);
    let mut ri: c_int = vif.bcast_ring, rc;
...
#[no_mangle]
pub unsafe extern "C" fn wil_bcast_fini(vif: *mut wil6210_vif) {
    void wil_bcast_fini(struct wil6210_vif *vif)
    {
    struct wil6210_priv *wil = vif_to_wil(vif);
    let mut ri: c_int = vif.bcast_ring;
    if (ri < 0)
    return;
    vif.bcast_ring = -1;
...
#[no_mangle]
pub unsafe extern "C" fn wil_bcast_fini_all(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_priv_init(wil: *mut wil6210_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wil6210_bus_request(wil: *mut wil6210_priv, kbps: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_priv_deinit(wil: *mut wil6210_priv) {
...
#[no_mangle]
unsafe extern "C" fn wil_shutdown_bl(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn ARC_me_imm32(d: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn wil_freeze_bl(wil: *mut wil6210_priv) {
    static void wil_freeze_bl(struct wil6210_priv *wil)
    {
    u32 jal, upc, saved;
    let mut ivt3: u32 = ARC_IRQ_VECTOR_OFFSET(3);
...
#[no_mangle]
unsafe extern "C" fn wil_bl_prepare_halt(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_halt_cpu(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_release_cpu(wil: *mut wil6210_priv) {
...
#[no_mangle]
unsafe extern "C" fn wil_set_oob_mode(wil: *mut wil6210_priv, mode: u8) {
...
#[no_mangle]
unsafe extern "C" fn wil_wait_device_ready(wil: *mut wil6210_priv, no_flash: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil_wait_device_ready_talyn_mb(wil: *mut wil6210_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil_target_reset(wil: *mut wil6210_priv, no_flash: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil_collect_fw_info(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_refresh_fw_capabilities(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_mbox_ring_le2cpus(r: *mut wil6210_mbox_ring) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_get_board_file(wil: *mut wil6210_priv, buf: *mut c_char, len: usize) {
...
#[no_mangle]
unsafe extern "C" fn wil_get_bl_info(wil: *mut wil6210_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil_bl_crash_info(wil: *mut wil6210_priv, is_err: bool) {
...
#[no_mangle]
unsafe extern "C" fn wil_get_otp_info(wil: *mut wil6210_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil_wait_for_fw_ready(wil: *mut wil6210_priv) -> c_int {
    static int wil_wait_for_fw_ready(struct wil6210_priv *wil)
    {
    let mut to: c_ulong = msecs_to_jiffies(2000);
    let mut left: c_ulong = wait_for_completion_timeout(&wil.wmi_ready, to);
    if (0 == left) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_abort_scan(vif: *mut wil6210_vif, sync: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_abort_scan_all_vifs(wil: *mut wil6210_priv, sync: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_ps_update(wil: *mut wil6210_priv, ps_profile: enum wmi_ps_profile_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wil_pre_fw_config(wil: *mut wil6210_priv) {
...
//
    ...
    wil_w(wil, RGF_USER_FW_CALIB_RESULT, (u32 )val);
    }
    }
#[no_mangle]
unsafe extern "C" fn wil_restore_vifs(wil: *mut wil6210_priv) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn wil_clear_fw_log_addr(wil: *mut wil6210_priv) {
...
//
#[no_mangle]
pub unsafe extern "C" fn wil_reset(wil: *mut wil6210_priv, load_fw: bool) -> c_int {
    int wil_reset(struct wil6210_priv *wil, bool load_fw)
    {
    int rc, i;
    let mut status_flags: c_ulong = BIT(wil_status_resetting);
    int no_flash;
    struct wil6210_vif *vif;
    ...
    wil6210_disconnect(vif, core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn wil_fw_error_recovery(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn __wil_up(wil: *mut wil6210_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wil_up(wil: *mut wil6210_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __wil_down(wil: *mut wil6210_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wil_down(wil: *mut wil6210_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wil_find_cid(wil: *mut wil6210_priv, mid: u8, mac: *const u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wil_halp_vote(wil: *mut wil6210_priv) {
    void wil_halp_vote(struct wil6210_priv *wil)
    {
    unsigned long rc;
    let mut to_jiffies: c_ulong = msecs_to_jiffies(WAIT_FOR_HALP_VOTE_MS);
    if (wil.hw_version >= HW_VER_TALYN_MB)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn wil_halp_unvote(wil: *mut wil6210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn wil_init_txrx_ops(wil: *mut wil6210_priv) {
