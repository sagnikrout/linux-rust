...
//! Source: drivers/net/wireless/ath/carl9170/fw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn carl9170_fw_info(ar: *mut ar9170) {
...
#[no_mangle]
unsafe extern "C" fn valid_dma_addr(address: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn valid_cpu_addr(address: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn carl9170_fw_tx_sequence(ar: *mut ar9170) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn carl9170_fw(ar: *mut ar9170, data: *const __u8, len: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn carl9170_parse_firmware(ar: *mut ar9170) -> c_int {
    int carl9170_parse_firmware(struct ar9170 *ar)
    {
    const struct carl9170fw_desc_head *fw_desc = core::ptr::null_mut();
    const struct firmware *fw = ar.fw.fw;
    let mut header_offset: c_ulong = 0;
    int err;
    if (WARN_ON(!fw))
    return -EINVAL;
