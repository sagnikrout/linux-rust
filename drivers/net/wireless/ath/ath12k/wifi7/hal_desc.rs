...
//! Source: drivers/net/wireless/ath/ath12k/wifi7/hal_desc.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rx_mpdu_desc {
    pub /: *mut *mut __le32 info0; / %RX_MPDU_DESC_INFO,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum hal_rx_msdu_desc_reo_dest_ind {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_dest_ring {
    pub buf_addr_info: ath12k_buffer_addr,
    pub rx_mpdu_info: rx_mpdu_desc,
    pub rx_msdu_info: rx_msdu_desc,
    pub buf_va_lo: __le32,
    pub buf_va_hi: __le32,
    pub /: *mut *mut __le32 info0; / %HAL_REO_DEST_RING_INFO0_,
    pub __packed: },
// hal_reo_dest_ring
//
// Producer: RXDMA
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_to_ppe_ring {
    pub buffer_addr: __le32,
    pub /: *mut *mut __le32 info0; / %HAL_REO_TO_PPE_RING_INFO0_,
    pub __packed: },
// hal_reo_to_ppe_ring
//
// Producer: REO
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_entrance_ring {
    pub buf_addr_info: ath12k_buffer_addr,
    pub rx_mpdu_info: rx_mpdu_desc,
    pub queue_addr_lo: __le32,
    pub /: *mut *mut __le32 info0; / %HAL_REO_ENTR_RING_INFO0_,
    pub /: *mut *mut __le32 info1; / %HAL_REO_ENTR_RING_INFO1_,
    pub /: *mut *mut __le32 info2; / %HAL_REO_DEST_RING_INFO2_,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_cmd_hdr {
    pub info0: __le32,
    pub __packed: },

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_get_queue_stats {
    pub cmd: hal_reo_cmd_hdr,
    pub queue_addr_lo: __le32,
    pub info0: __le32,
    pub rsvd0: [__le32; 6],
    pub tlv64_pad: __le32,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_get_queue_stats_qcc2072 {
    pub cmd: hal_reo_cmd_hdr,
    pub queue_addr_lo: __le32,
    pub info0: __le32,
    pub rsvd0: [__le32; 6],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_flush_queue {
    pub cmd: hal_reo_cmd_hdr,
    pub desc_addr_lo: __le32,
    pub info0: __le32,
    pub rsvd0: [__le32; 6],
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_flush_cache {
    pub cmd: hal_reo_cmd_hdr,
    pub cache_addr_lo: __le32,
    pub info0: __le32,
    pub rsvd0: [__le32; 6],
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_tx_msdu_ext_desc {
    pub rsvd0: [__le32; 6],
    pub info0: __le32,
    pub info1: __le32,
    pub rsvd1: [__le32; 10],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_tcl_gse_cmd {
    pub ctrl_buf_addr_lo: __le32,
    pub info0: __le32,
    pub meta_data: [__le32; 2],
    pub rsvd0: [__le32; 2],
    pub info1: __le32,
    pub __packed: },
// hal_tcl_gse_cmd
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_tcl_status_ring {
    pub info0: __le32,
    pub msdu_byte_count: __le32,
    pub msdu_timestamp: __le32,
    pub meta_data: [__le32; 2],
    pub info1: __le32,
    pub rsvd0: __le32,
    pub info2: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_ce_srng_src_desc {
    pub buffer_addr_low: __le32,
    pub /: *mut *mut __le32 buffer_addr_info; / %HAL_CE_SRC_DESC_ADDR_INFO_,
    pub /: *mut *mut __le32 meta_info; / %HAL_CE_SRC_DESC_META_INFO_,
    pub /: *mut *mut __le32 flags; / %HAL_CE_SRC_DESC_FLAGS_,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_ce_srng_dest_desc {
    pub buffer_addr_low: __le32,
    pub /: *mut *mut __le32 buffer_addr_info; / %HAL_CE_DEST_DESC_ADDR_INFO_,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_ce_srng_dst_status_desc {
    pub /: *mut *mut __le32 flags; / %HAL_CE_DST_STATUS_DESC_FLAGS_,
    pub toeplitz_hash0: __le32,
    pub toeplitz_hash1: __le32,
    pub /: *mut *mut __le32 meta_info; / HAL_CE_DST_STATUS_DESC_META_INFO_,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_wbm_completion_ring_rx {
    pub addr_lo: __le32,
    pub addr_hi: __le32,
    pub info0: __le32,
    pub rx_mpdu_info: rx_mpdu_desc,
    pub rx_msdu_info: rx_msdu_desc,
    pub phy_addr_lo: __le32,
    pub info1: __le32,
    pub __packed: },

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_wbm_completion_ring_tx {
    pub buf_va_lo: __le32,
    pub buf_va_hi: __le32,
    pub info0: __le32,
    pub info1: __le32,
    pub info2: __le32,
    pub rate_stats: hal_tx_rate_stats,
    pub info3: __le32,
    pub __packed: },

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_wbm_release_ring_tx {
    pub buf_addr_info: ath12k_buffer_addr,
    pub info0: __le32,
    pub info1: __le32,
    pub info2: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_wbm_release_ring_rx {
    pub buf_addr_info: ath12k_buffer_addr,
    pub info0: __le32,
    pub rx_mpdu_info: rx_mpdu_desc,
    pub rx_msdu_info: rx_msdu_desc,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_wbm_release_ring_cc_rx {
    pub buf_va_lo: __le32,
    pub buf_va_hi: __le32,
    pub info0: __le32,
    pub rx_mpdu_info: rx_mpdu_desc,
    pub rx_msdu_info: rx_msdu_desc,
    pub buf_pa_lo: __le32,
    pub info1: __le32,
    pub __packed: },

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_wbm_release_ring {
    pub buf_addr_info: ath12k_buffer_addr,
    pub info0: __le32,
    pub info1: __le32,
    pub info2: __le32,
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum hal_wbm_tqm_rel_reason {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_wbm_buffer_ring {
    pub buf_addr_info: ath12k_buffer_addr,
}

#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum hal_mon_end_reason {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_sw_monitor_ring {
    pub buf_addr_info: ath12k_buffer_addr,
    pub rx_mpdu_info: rx_mpdu_desc,
    pub status_buff_addr_info: ath12k_buffer_addr,
    pub /: *mut *mut __le32 info0; / %HAL_SW_MONITOR_RING_INFO0,
    pub /: *mut *mut __le32 info1; / %HAL_SW_MONITOR_RING_INFO1,
    pub __packed: },
// hal_sw_monitor_ring
//
// Producer: RXDMA
...
pub const HAL_DESC_REO_OWNED: c_int = 4;
pub const HAL_DESC_REO_QUEUE_DESC: c_int = 8;
pub const HAL_DESC_REO_QUEUE_EXT_DESC: c_int = 9;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_desc_header {
    pub info0: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_rx_mpdu_link_ptr {
    pub addr_info: ath12k_buffer_addr,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_rx_msdu_details {
    pub buf_addr_info: ath12k_buffer_addr,
    pub rx_msdu_info: rx_msdu_desc,
    pub rx_msdu_ext_info: rx_msdu_ext_desc,
    pub __packed: },

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_rx_msdu_link {
    pub desc_hdr: hal_desc_header,
    pub buf_addr_info: ath12k_buffer_addr,
    pub info0: __le32,
    pub pn: [__le32; 4],
    pub msdu_link: [hal_rx_msdu_details; 6],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_rx_reo_queue_ext {
    pub desc_hdr: hal_desc_header,
    pub rsvd: __le32,
    pub mpdu_link: [hal_rx_mpdu_link_ptr; 15],
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum hal_rx_reo_queue_pn_size {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_rx_reo_queue {
    pub desc_hdr: hal_desc_header,
    pub rx_queue_num: __le32,
    pub info0: __le32,
    pub info1: __le32,
    pub pn: [__le32; 4],
    pub last_rx_enqueue_timestamp: __le32,
    pub last_rx_dequeue_timestamp: __le32,
    pub next_aging_queue: [__le32; 2],
    pub prev_aging_queue: [__le32; 2],
    pub rx_bitmap: [__le32; 9],
    pub info2: __le32,
    pub info3: __le32,
    pub info4: __le32,
    pub processed_mpdus: __le32,
    pub processed_msdus: __le32,
    pub processed_total_bytes: __le32,
    pub info5: __le32,
    pub rsvd: [__le32; 2],
    pub ext_desc: [hal_rx_reo_queue_ext; ],
    pub __packed: },
// hal_rx_reo_queue
//
// descriptor_header
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_update_rx_queue {
    pub cmd: hal_reo_cmd_hdr,
    pub queue_addr_lo: __le32,
    pub info0: __le32,
    pub info1: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_rx_reo_queue_1k {
    pub desc_hdr: hal_desc_header,
    pub rx_bitmap_1023_288: [__le32; 23],
    pub reserved: [__le32; 8],
    pub __packed: },

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_unblock_cache {
    pub cmd: hal_reo_cmd_hdr,
    pub info0: __le32,
    pub rsvd: [__le32; 7],
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_get_queue_stats_status {
    pub hdr: hal_reo_status_hdr,
    pub info0: __le32,
    pub pn: [__le32; 4],
    pub last_rx_enqueue_timestamp: __le32,
    pub last_rx_dequeue_timestamp: __le32,
    ...
    pub info2: __le32,
    pub info3: __le32,
    pub num_mpdu_frames: __le32,
    pub num_msdu_frames: __le32,
    pub total_bytes: __le32,
    pub info4: __le32,
    pub info5: __le32,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_get_queue_stats_status_qcc2072 {
    pub tlv32_padding: __le32,
    pub status: hal_reo_get_queue_stats_status,
    pub __packed: },

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_flush_queue_status {
    pub hdr: hal_reo_status_hdr,
    pub info0: __le32,
    pub rsvd0: [__le32; 21],
    pub info1: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_flush_cache_status {
    pub hdr: hal_reo_status_hdr,
    pub info0: __le32,
    pub rsvd0: [__le32; 21],
    pub info1: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_unblock_cache_status {
    pub hdr: hal_reo_status_hdr,
    pub info0: __le32,
    pub rsvd0: [__le32; 21],
    pub info1: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_flush_timeout_list_status {
    pub hdr: hal_reo_status_hdr,
    pub info0: __le32,
    pub info1: __le32,
    pub rsvd0: [__le32; 20],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_reo_desc_thresh_reached_status {
    pub hdr: hal_reo_status_hdr,
    pub info0: __le32,
    pub info1: __le32,
    pub info2: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_tcl_entrance_from_ppe_ring {
    pub buffer_addr: __le32,
    pub info0: __le32,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hal_tx_msdu_metadata {
    pub info0: __le32,
    pub rsvd0: [__le32; 6],
    pub __packed: },
