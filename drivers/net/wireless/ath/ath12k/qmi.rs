...
//! Source: drivers/net/wireless/ath/ath12k/qmi.h
#![no_std]
...
pub const ATH12K_QMI_WLANFW_TIMEOUT_MS: c_int = 10000;
pub const ATH12K_QMI_MAX_BDF_FILE_NAME_SIZE: c_int = 64;
pub const ATH12K_QMI_WLANFW_MAX_BUILD_ID_LEN_V01: c_int = 128;
pub const ATH12K_QMI_WLFW_SERVICE_VERS_V01: c_uint = 0x01;
pub const ATH12K_QMI_WLFW_SERVICE_INS_ID_V01: c_uint = 0x02;
pub const ATH12K_QMI_WLFW_SERVICE_INS_ID_V01_WCN7850: c_uint = 0x1;
pub const ATH12K_QMI_WLFW_SERVICE_INS_ID_V01_QCN9274: c_uint = 0x07;
pub const ATH12K_QMI_WLFW_SERVICE_INS_ID_V01_IPQ5332: c_uint = 0x2;
pub const ATH12K_QMI_WLANFW_MAX_TIMESTAMP_LEN_V01: c_int = 32;
pub const ATH12K_QMI_RESP_LEN_MAX: c_int = 8192;
pub const ATH12K_QMI_WLANFW_MAX_NUM_MEM_SEG_V01: c_int = 52;
pub const ATH12K_QMI_BDF_EXT_STR_LENGTH: c_uint = 0x20;
pub const ATH12K_QMI_WLFW_MAX_DEV_MEM_NUM_V01: c_int = 4;
pub const ATH12K_QMI_DEVMEM_CMEM_INDEX: c_int = 0;
pub const QMI_WLFW_REQUEST_MEM_IND_V01: c_uint = 0x0035;
pub const QMI_WLFW_FW_MEM_READY_IND_V01: c_uint = 0x0037;
pub const QMI_WLFW_FW_READY_IND_V01: c_uint = 0x0038;
pub const QMI_WLANFW_MAX_DATA_SIZE_V01: c_int = 6144;
pub const ATH12K_BOARD_ID_DEFAULT: c_uint = 0xFF;
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ath12k_qmi_file_type {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ath12k_qmi_event_type {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ath12k_qmi_driver_event {
    pub list: list_head,
    pub type: ath12k_qmi_event_type,
    pub data: *mut c_void,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ath12k_qmi_ce_cfg {
    ...
    pub shadow_reg_v3: *mut u32,
    pub shadow_reg_v3_len: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ath12k_qmi_event_msg {
    pub list: list_head,
    pub type: ath12k_qmi_event_type,
}
...
pub struct target_info {
    ...
    pub 1]: char fw_build_timestamp[ATH12K_QMI_WLANFW_MAX_TIMESTAMP_LEN_V01 +,
    pub 1]: char fw_build_id[ATH12K_QMI_WLANFW_MAX_BUILD_ID_LEN_V01 +,
    pub bdf_ext: [c_char; ATH12K_QMI_BDF_EXT_STR_LENGTH],
}
...
pub struct ath12k_qmi {
    ...
    pub ce_cfg: ath12k_qmi_ce_cfg,
    pub target_mem: [target_mem_chunk; ATH12K_QMI_WLANFW_MAX_NUM_MEM_SEG_V01],
...
// protected with struct ath12k_qmi::event_lock
    ...
    pub aux_uc_mem: m3_mem_region,
    pub service_ins_id: c_uint,
    pub dev_mem: [dev_mem_info; ATH12K_QMI_WLFW_MAX_DEV_MEM_NUM_V01],
    pub dynamic_ddr_support: u8,
}

pub const QMI_WLANFW_HOST_CAP_REQ_MSG_V01_MAX_LEN: c_int = 265;
pub const QMI_WLANFW_HOST_CAP_REQ_V01: c_uint = 0x0034;
pub const QMI_WLFW_MAX_NUM_GPIO_V01: c_int = 32;
pub const QMI_WLANFW_MAX_PLATFORM_NAME_LEN_V01: c_int = 64;
pub const QMI_WLANFW_MAX_HOST_DDR_RANGE_SIZE_V01: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmi_wlanfw_host_ddr_range {
    pub start: u64,
    pub size: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ath12k_qmi_target_mem {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum qmi_wlanfw_host_build_type {
...
pub const QMI_WLFW_MAX_NUM_MLO_CHIPS_V01: c_int = 3;
pub const QMI_WLFW_MAX_NUM_MLO_LINKS_PER_CHIP_V01: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wlfw_host_mlo_chip_info_s_v01 {
    pub chip_id: u8,
    pub num_local_links: u8,
    pub hw_link_id: [u8; QMI_WLFW_MAX_NUM_MLO_LINKS_PER_CHIP_V01],
    pub valid_mlo_link_id: [u8; QMI_WLFW_MAX_NUM_MLO_LINKS_PER_CHIP_V01],
}

#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ath12k_qmi_cnss_feature {
...
pub struct qmi_wlanfw_host_cap_req_msg_v01 {
    ...
    pub mem_cfg_mode: u8,
    pub cal_duration_valid: u8,
    pub cal_duraiton: u16,
    pub platform_name_valid: u8,
    pub 1]: char platform_name[QMI_WLANFW_MAX_PLATFORM_NAME_LEN_V01 +,
    pub ddr_range_valid: u8,
    pub ddr_range: [qmi_wlanfw_host_ddr_range; QMI_WLANFW_MAX_HOST_DDR_RANGE_SIZE_V01],
    pub host_build_type_valid: u8,
    pub host_build_type: qmi_wlanfw_host_build_type,
    pub mlo_capable_valid: u8,
    pub mlo_capable: u8,
    pub mlo_chip_id_valid: u8,
    pub mlo_chip_id: u16,
    pub mlo_group_id_valid: u8,
    pub mlo_group_id: u8,
    pub max_mlo_peer_valid: u8,
    pub max_mlo_peer: u16,
    pub mlo_num_chips_valid: u8,
    pub mlo_num_chips: u8,
    pub mlo_chip_info_valid: u8,
    pub mlo_chip_info: [wlfw_host_mlo_chip_info_s_v01; QMI_WLFW_MAX_NUM_MLO_CHIPS_V01],
    pub feature_list_valid: u8,
    pub feature_list: u64,
    pub dynamic_mem_support_valid: u8,
    pub dynamic_mem_support: u8,
}
...
pub const QMI_WLANFW_PHY_CAP_REQ_MSG_V01_MAX_LEN: c_int = 0;
pub const QMI_WLANFW_PHY_CAP_REQ_V01: c_uint = 0x0057;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmi_wlanfw_phy_cap_req_msg_v01 {
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmi_wlanfw_phy_cap_resp_msg_v01 {
    pub resp: qmi_response_type_v01,
    pub num_phy_valid: u8,
    pub num_phy: u8,
    pub board_id_valid: u8,
    pub board_id: u32,
    pub single_chip_mlo_support_valid: u8,
    pub single_chip_mlo_support: u8,
    pub dynamic_ddr_support_valid: u8,
    pub dynamic_ddr_support: u8,
}
...
pub struct qmi_wlanfw_request_mem_ind_msg_v01 {
    pub mem_seg_len: u32,
    pub mem_seg: [qmi_wlanfw_mem_seg_s_v01; ATH12K_QMI_WLANFW_MAX_NUM_MEM_SEG_V01],
}
...
pub struct qmi_wlanfw_respond_mem_req_msg_v01 {
    pub mem_seg_len: u32,
    pub mem_seg: [qmi_wlanfw_mem_seg_resp_s_v01; ATH12K_QMI_WLANFW_MAX_NUM_MEM_SEG_V01],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmi_wlanfw_shadow_reg_v3_cfg_s_v01 {
    pub addr: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmi_wlanfw_dev_mem_info_s_v01 {
    pub start: u64,
    pub size: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum qmi_wlanfw_rd_card_chain_cap_v01 {
...
pub struct qmi_wlanfw_cap_resp_msg_v01 {
    ...
    pub otp_version: u32,
    pub eeprom_caldata_read_timeout_valid: u8,
    pub eeprom_caldata_read_timeout: u32,
    pub fw_caps_valid: u8,
    pub fw_caps: u64,
    pub rd_card_chain_cap_valid: u8,
    pub rd_card_chain_cap: qmi_wlanfw_rd_card_chain_cap_v01,
    pub dev_mem_info_valid: u8,
    pub dev_mem: [qmi_wlanfw_dev_mem_info_s_v01; ATH12K_QMI_WLFW_MAX_DEV_MEM_NUM_V01],
}
...
pub const QMI_WLANFW_AUX_UC_INFO_REQ_MSG_V01_MAX_MSG_LEN: c_int = 18;
pub const QMI_WLANFW_AUX_UC_INFO_REQ_V01: c_uint = 0x005A;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmi_wlanfw_aux_uc_info_req_msg_v01 {
    pub addr: u64,
    pub size: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmi_wlanfw_aux_uc_info_resp_msg_v01 {
    pub resp: qmi_response_type_v01,
}
...
pub const QMI_WLANFW_MAX_NUM_SHADOW_REG_V3_V01: c_int = 60;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct qmi_wlanfw_wlan_cfg_req_msg_v01 {
    ...
    pub shadow_reg_v3_valid: u8,
    pub shadow_reg_v3_len: u32,
}
...
pub const ATH12K_QMI_WLANFW_WLAN_INI_REQ_V01: c_uint = 0x002F;
pub const QMI_WLANFW_WLAN_INI_REQ_MSG_V01_MAX_LEN: c_int = 7;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmi_wlanfw_wlan_ini_req_msg_v01 {
// Must be set to true if enable_fwlog is being passed
    pub enable_fwlog_valid: u8,
    pub enable_fwlog: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum ath12k_qmi_firmware_mode {
...
extern "C" {
    pub fn ath12k_qmi_firmware_stop(ab: *mut ath12k_base);
}
extern "C" {
    pub fn ath12k_qmi_deinit_service(ab: *mut ath12k_base);
}
extern "C" {
    pub fn ath12k_qmi_init_service(ab: *mut ath12k_base) -> c_int;
}
extern "C" {
    pub fn ath12k_qmi_free_resource(ab: *mut ath12k_base);
}
extern "C" {
    pub fn ath12k_qmi_trigger_host_cap(ab: *mut ath12k_base);
}
extern "C" {
    pub fn ath12k_qmi_reset_mlo_mem(ag: *mut ath12k_hw_group);
}
