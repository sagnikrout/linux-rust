...
//! Source: drivers/net/wireless/intersil/p54/main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn p54_beacon_format_ie_tim(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn p54_start(dev: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn p54_stop(dev: *mut ieee80211_hw, suspend: bool) {
...
#[no_mangle]
unsafe extern "C" fn p54_wait_for_stats(dev: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn p54_reset_stats(priv: *mut p54_common) {
...
#[no_mangle]
unsafe extern "C" fn p54_config(dev: *mut ieee80211_hw, radio_idx: c_int, changed: u32) -> c_int {
    ...
    priv.curchan = core::ptr::null_mut();
...
//
    ...
    ARRAY_SIZE(((struct p54_group_address_table *)core::ptr::null_mut()).mac_list));
//
...
#[no_mangle]
unsafe extern "C" fn p54_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn p54_flush_count(priv: *mut p54_common) -> c_uint {
    static unsigned int p54_flush_count(struct p54_common *priv)
    {
    let mut total: c_uint = 0, i;
...
#[no_mangle]
pub unsafe extern "C" fn p54_register_common(dev: *mut ieee80211_hw, pdev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p54_free_common(dev: *mut ieee80211_hw) {
    ...
    kfree(priv.survey);
    priv.iq_autocal = core::ptr::null_mut();
    priv.output_limit = core::ptr::null_mut();
    priv.curve_data = core::ptr::null_mut();
    priv.rssi_db = core::ptr::null_mut();
    priv.used_rxkeys = core::ptr::null_mut();
    priv.survey = core::ptr::null_mut();
    ieee80211_free_hw(dev);
    }
    EXPORT_SYMBOL_GPL(p54_free_common);
#[no_mangle]
pub unsafe extern "C" fn p54_unregister_common(dev: *mut ieee80211_hw) {
