...
//! Source: drivers/net/wireless/intersil/p54/led.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn p54_update_leds(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn p54_init_leds(priv: *mut p54_common) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p54_unregister_leds(priv: *mut p54_common) {
