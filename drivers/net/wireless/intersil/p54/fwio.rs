...
//! Source: drivers/net/wireless/intersil/p54/fwio.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn p54_parse_firmware(dev: *mut ieee80211_hw, fw: *const firmware) -> c_int {
    ...
    u8 *fw_version = core::ptr::null_mut();
    size_t len;
    int i;
    int maxlen;
    if (priv.rx_start)
    ...
    let mut code: u32 = le32_to_cpu(bootrec.code);
    switch (code) {
...
//
    ...
    struct p54_hdr *hdr;
    struct sk_buff *skb;
    let mut frame_len: usize = sizeof(*hdr) + payload_len;
...
#[no_mangle]
pub unsafe extern "C" fn p54_update_beacon_tim(priv: *mut p54_common, aid: u16, set: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p54_sta_unlock(priv: *mut p54_common, addr: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p54_tx_cancel(priv: *mut p54_common, req_id: __le32) -> c_int {
    int p54_tx_cancel(struct p54_common *priv, __le32 req_id)
    {
    struct sk_buff *skb;
    struct p54_txcancel *cancel;
    let mut _req_id: u32 = le32_to_cpu(req_id);
...
#[no_mangle]
pub unsafe extern "C" fn p54_setup_mac(priv: *mut p54_common) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p54_scan(priv: *mut p54_common, mode: u16, dwell: u16) -> c_int {
    ...
    unsigned int i;
    void *entry;
    let mut freq: __le16 = cpu_to_le16(priv.hw.conf.chandef.chan.center_freq);
...
#[no_mangle]
pub unsafe extern "C" fn p54_set_leds(priv: *mut p54_common) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p54_set_edcf(priv: *mut p54_common) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p54_set_ps(priv: *mut p54_common) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p54_init_xbow_synth(priv: *mut p54_common) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p54_fetch_statistics(priv: *mut p54_common) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn p54_set_groupfilter(priv: *mut p54_common) -> c_int {
