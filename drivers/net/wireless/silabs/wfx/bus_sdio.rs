...
//! Source: drivers/net/wireless/silabs/wfx/bus_sdio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wfx_sdio_copy_from_io(priv: *mut c_void, reg_id: c_uint, dst: *mut c_void, count: usize) -> c_int {
    static int wfx_sdio_copy_from_io(void *priv, unsigned int reg_id, void *dst, size_t count)
    {
    struct wfx_sdio_priv *bus = priv;
    let mut sdio_addr: c_uint = reg_id << 2;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn wfx_sdio_copy_to_io(priv: *mut c_void, reg_id: c_uint, src: *const c_void, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wfx_sdio_lock(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn wfx_sdio_unlock(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn wfx_sdio_irq_handler(func: *mut sdio_func) {
...
#[no_mangle]
unsafe extern "C" fn wfx_sdio_irq_handler_ext(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wfx_sdio_irq_subscribe(priv: *mut c_void) -> c_int {
    ...
    flags |= IRQF_ONESHOT;
    ret = devm_request_threaded_irq(&bus.func.dev, bus.of_irq, core::ptr::null_mut(),
    wfx_sdio_irq_handler_ext, flags, "wfx", bus);
    if (ret)
    return ret;
    sdio_claim_host(bus.func);
    cccr = sdio_f0_readb(bus.func, SDIO_CCCR_IENx, core::ptr::null_mut());
    cccr |= BIT(0);
    cccr |= BIT(bus.func.num);
    sdio_f0_writeb(bus.func, cccr, SDIO_CCCR_IENx, core::ptr::null_mut());
    sdio_release_host(bus.func);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn wfx_sdio_irq_unsubscribe(priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wfx_sdio_align_size(priv: *mut c_void, size: usize) -> usize {
...
#[no_mangle]
unsafe extern "C" fn wfx_sdio_set_wakeup(priv: *mut c_void, enabled: bool) {
...
#[no_mangle]
unsafe extern "C" fn wfx_sdio_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wfx_sdio_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wfx_sdio_probe(func: *mut sdio_func, id: *const sdio_device_id) -> c_int {
    ...
    let mut pm_flag: mmc_pm_flag_t = sdio_get_host_pm_caps(func);
...
#[no_mangle]
unsafe extern "C" fn wfx_sdio_remove(func: *mut sdio_func) {
