...
//! Source: drivers/net/wireless/quantenna/qtnfmac/pcie/topaz_pcie.c
#![no_std]
...
pub const TOPAZ_TX_BD_SIZE_DEFAULT: c_int = 128;
pub const TOPAZ_RX_BD_SIZE_DEFAULT: c_int = 256;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qtnf_topaz_tx_bd {
    pub addr: __le32,
    pub info: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qtnf_topaz_rx_bd {
    pub addr: __le32,
    pub info: __le32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qtnf_extra_bd_params {
    pub param1: __le32,
    pub param2: __le32,
    pub param3: __le32,
    pub param4: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qtnf_topaz_bda {
    pub bda_len: __le16,
    pub bda_version: __le16,
    pub bda_bootstate: __le32,
    pub bda_dma_mask: __le32,
    pub bda_dma_offset: __le32,
    pub bda_flags: __le32,
    pub bda_img: __le32,
    pub bda_img_size: __le32,
    pub bda_ep2h_irqstatus: __le32,
    pub bda_h2ep_irqstatus: __le32,
    pub bda_msi_addr: __le32,
    pub reserved1: [u8; 56],
    pub bda_flashsz: __le32,
    pub bda_boardname: [u8; PCIE_BDA_NAMELEN],
    pub bda_pci_pre_status: __le32,
    pub bda_pci_endian: __le32,
    pub bda_pci_post_status: __le32,
    pub bda_h2ep_txd_budget: __le32,
    pub bda_ep2h_txd_budget: __le32,
    pub bda_rc_rx_bd_base: __le32,
    pub bda_rc_rx_bd_num: __le32,
    pub bda_rc_tx_bd_base: __le32,
    pub bda_rc_tx_bd_num: __le32,
    pub bda_ep_link_state: u8,
    pub bda_rc_link_state: u8,
    pub bda_rc_msi_enabled: u8,
    pub reserved2: u8,
    pub bda_ep_next_pkt: __le32,
    pub request: [vmac_pkt_info; QTN_PCIE_RC_TX_QUEUE_LEN],
    pub __aligned(4096): qtnf_shm_ipc_region bda_shm_reg1,
    pub __aligned(4096): qtnf_shm_ipc_region bda_shm_reg2,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qtnf_pcie_topaz_state {
    pub base: qtnf_pcie_bus_priv,
    pub bda: *mut qtnf_topaz_bda __iomem,
    pub dma_msi_dummy: dma_addr_t,
    pub dma_msi_imwr: u32,
    pub tx_bd_vbase: *mut qtnf_topaz_tx_bd,
    pub rx_bd_vbase: *mut qtnf_topaz_rx_bd,
    pub ep_next_rx_pkt: *mut __le32 __iomem,
    pub txqueue_wake: *mut __le32 __iomem,
    pub ep_pmstate: *mut __le32 __iomem,
    pub rx_pkt_count: c_ulong,
}

#[no_mangle]
unsafe extern "C" fn qtnf_deassert_intx(ts: *mut qtnf_pcie_topaz_state) {
...
#[no_mangle]
pub unsafe extern "C" fn qtnf_topaz_intx_asserted(ts: *mut qtnf_pcie_topaz_state) -> c_int {
    static inline int qtnf_topaz_intx_asserted(struct qtnf_pcie_topaz_state *ts)
    {
    void __iomem *reg = ts.base.sysctl_bar + TOPAZ_PCIE_CFG0_OFFSET;
    let mut cfg: u32 = readl(reg);
    return !!(cfg & TOPAZ_ASSERT_INTX);
    }
#[no_mangle]
unsafe extern "C" fn qtnf_topaz_reset_ep(ts: *mut qtnf_pcie_topaz_state) {
...
#[no_mangle]
unsafe extern "C" fn setup_rx_irqs(ts: *mut qtnf_pcie_topaz_state) {
...
#[no_mangle]
unsafe extern "C" fn enable_rx_irqs(ts: *mut qtnf_pcie_topaz_state) {
...
#[no_mangle]
unsafe extern "C" fn disable_rx_irqs(ts: *mut qtnf_pcie_topaz_state) {
...
#[no_mangle]
unsafe extern "C" fn qtnf_topaz_ipc_gen_ep_int(arg: *mut c_void) {
...
// extra shared params
    ...
    if (!skb) {
    ts.base.rx_skb[index] = core::ptr::null_mut();
    return -ENOMEM;
    }
...
#[no_mangle]
unsafe extern "C" fn topaz_alloc_rx_buffers(ts: *mut qtnf_pcie_topaz_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qtnf_topaz_free_xfer_buffers(ts: *mut qtnf_pcie_topaz_state) {
...
#[no_mangle]
unsafe extern "C" fn qtnf_topaz_data_tx_reclaim(ts: *mut qtnf_pcie_topaz_state) {
...
#[no_mangle]
unsafe extern "C" fn qtnf_try_stop_xmit(bus: *mut qtnf_bus, ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn qtnf_try_wake_xmit(bus: *mut qtnf_bus, ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn qtnf_tx_queue_ready(ts: *mut qtnf_pcie_topaz_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qtnf_pcie_topaz_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qtnf_rx_data_ready(ts: *mut qtnf_pcie_topaz_state) -> c_int {
    static int qtnf_rx_data_ready(struct qtnf_pcie_topaz_state *ts)
    {
    let mut index: u16 = ts.base.rx_bd_r_index;
    struct qtnf_topaz_rx_bd *rxbd;
    u32 descw;
...
#[no_mangle]
unsafe extern "C" fn qtnf_topaz_rx_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qtnf_dbg_pkt_stats(s: *mut seq_file, data: *mut c_void) -> c_int {
    static int qtnf_dbg_pkt_stats(struct seq_file *s, void *data)
    {
    struct qtnf_bus *bus = dev_get_drvdata(s.private);
    struct qtnf_pcie_topaz_state *ts = get_bus_priv(bus);
    struct qtnf_pcie_bus_priv *priv = &ts.base;
    let mut tx_done_index: u32 = readl(ts.ep_next_rx_pkt);
...
#[no_mangle]
unsafe extern "C" fn qtnf_reset_dma_offset(ts: *mut qtnf_pcie_topaz_state) {
    static void qtnf_reset_dma_offset(struct qtnf_pcie_topaz_state *ts)
    {
    struct qtnf_topaz_bda __iomem *bda = ts.bda;
    let mut offset: u32 = readl(&bda.bda_dma_offset);
    if ((offset & PCIE_DMA_OFFSET_ERROR_MASK) != PCIE_DMA_OFFSET_ERROR)
    return;
    writel(0x0, &bda.bda_dma_offset);
    }
#[no_mangle]
unsafe extern "C" fn qtnf_pcie_endian_detect(ts: *mut qtnf_pcie_topaz_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qtnf_pre_init_ep(bus: *mut qtnf_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qtnf_post_init_ep(ts: *mut qtnf_pcie_topaz_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qtnf_topaz_fw_work_handler(work: *mut work_struct) {
    static void qtnf_topaz_fw_work_handler(struct work_struct *work)
    {
    struct qtnf_bus *bus = container_of(work, struct qtnf_bus, fw_work);
    struct qtnf_pcie_topaz_state *ts = (void *)get_bus_priv(bus);
    let mut bootloader_needed: c_int = readl(&ts.bda.bda_flags) & QTN_BDA_XMIT_UBOOT;
    struct pci_dev *pdev = ts.base.pdev;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn qtnf_reclaim_tasklet_fn(t: *mut tasklet_struct) {
...
#[no_mangle]
unsafe extern "C" fn qtnf_topaz_dma_mask_get() -> u64 {
...
#[no_mangle]
unsafe extern "C" fn qtnf_pcie_topaz_remove(bus: *mut qtnf_bus) {
...
#[no_mangle]
unsafe extern "C" fn qtnf_pcie_topaz_suspend(bus: *mut qtnf_bus) -> c_int {
    static int qtnf_pcie_topaz_suspend(struct qtnf_bus *bus)
    {
    struct qtnf_pcie_topaz_state *ts = get_bus_priv(bus);
    struct pci_dev *pdev = ts.base.pdev;
    writel((u32 )PCI_D3hot, ts.ep_pmstate);
    dma_wmb();
...
#[no_mangle]
unsafe extern "C" fn qtnf_pcie_topaz_resume(bus: *mut qtnf_bus) -> c_int {
    ...
    writel((u32 )PCI_D0, ts.ep_pmstate);
    dma_wmb();
    writel(TOPAZ_IPC_IRQ_WORD(TOPAZ_RC_PM_EP_IRQ),
    TOPAZ_LH_IPC4_INT(ts.base.sysctl_bar));
    return 0;
