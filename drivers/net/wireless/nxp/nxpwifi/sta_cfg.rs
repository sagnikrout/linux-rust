...
//! Source: drivers/net/wireless/nxp/nxpwifi/sta_cfg.c
#![no_std]
...
// Disable 11ax by default
    ...
    HOST_ACT_GEN_SET, 0, core::ptr::null_mut(), false);
    if (ret)
    nxpwifi_dbg(priv.adapter, ERROR,
...
// In infra mode, an deauthentication is performed first
    ...
    struct nxpwifi_bssdescriptor *bss_desc = core::ptr::null_mut();
    u16 config_bands;
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_cancel_hs(priv: *mut nxpwifi_private, cmd_type: c_int) -> c_int {
...
// Sends IOCTL request to cancel the existing Host Sleep configuration
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_enable_hs(adapter: *mut nxpwifi_adapter) -> bool {
    ...
    priv = adapter.priv[i];
    nxpwifi_deauthenticate(priv, core::ptr::null_mut());
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_disable_auto_ds(priv: *mut nxpwifi_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_drv_get_data_rate(priv: *mut nxpwifi_private, rate: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_drv_set_power(priv: *mut nxpwifi_private, ps_mode: *mut u32) -> c_int {
