...
//! Source: drivers/net/wireless/nxp/nxpwifi/join.c
#![no_std]
...
// Since WMM is not enabled, setup the queues with the defaults
    nxpwifi_wmm_setup_queue_priorities(priv, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn nxpwifi_deauthenticate_infra(priv: *mut nxpwifi_private, mac: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_deauthenticate(priv: *mut nxpwifi_private, mac: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_deauthenticate_all(adapter: *mut nxpwifi_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_band_to_radio_type(config_bands: u16) -> u8 {
