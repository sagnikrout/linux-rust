...
//! Source: drivers/net/wireless/nxp/nxpwifi/11h.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_init_11h_params(priv: *mut nxpwifi_private) {
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_is_11h_active(priv: *mut nxpwifi_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_11h_activate(priv: *mut nxpwifi_private, flag: bool) -> c_int {
    int nxpwifi_11h_activate(struct nxpwifi_private *priv, bool flag)
    {
    let mut enable: u32 = flag;
...
//
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_dfs_cac_work(wiphy: *mut wiphy, work: *mut wiphy_work) {
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_abort_cac(priv: *mut nxpwifi_private) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_dfs_chan_sw_work(wiphy: *mut wiphy, work: *mut wiphy_work) {
