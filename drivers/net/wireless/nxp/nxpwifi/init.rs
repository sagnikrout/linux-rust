...
//! Source: drivers/net/wireless/nxp/nxpwifi/init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nxpwifi_add_bss_prio_tbl(priv: *mut nxpwifi_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_init_priv(priv: *mut nxpwifi_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxpwifi_allocate_adapter(adapter: *mut nxpwifi_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxpwifi_init_adapter(adapter: *mut nxpwifi_adapter) {
    static void nxpwifi_init_adapter(struct nxpwifi_adapter *adapter)
    {
    struct nxpwifi_opt_sleep_confirm *sleep_cfm_buf = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_set_trans_start(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn nxpwifi_invalidate_lists(adapter: *mut nxpwifi_adapter) {
...
// Cancel pending work, stop timers, and free adapter buffers.
    ...
    adapter.vdll_ctrl.vdll_mem = core::ptr::null_mut();
    adapter.vdll_ctrl.vdll_len = 0;
    }
    if (adapter.vdll_ctrl.skb) {
    dev_kfree_skb_any(adapter.vdll_ctrl.skb);
    adapter.vdll_ctrl.skb = core::ptr::null_mut();
    }
    }
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_free_cmd_buffers(adapter: *mut nxpwifi_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_init_lock_list(adapter: *mut nxpwifi_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_init_fw(adapter: *mut nxpwifi_adapter) -> c_int {
    int nxpwifi_init_fw(struct nxpwifi_adapter *adapter)
    {
    int ret;
    struct nxpwifi_private *priv;
    u8 i;
    let mut first_sta: bool = true;
    adapter.hw_status = NXPWIFI_HW_STATUS_INITIALIZING;
...
#[no_mangle]
unsafe extern "C" fn nxpwifi_delete_bss_prio_tbl(priv: *mut nxpwifi_private) {
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_free_priv(priv: *mut nxpwifi_private) {
