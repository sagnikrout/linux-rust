...
//! Source: drivers/net/wireless/nxp/nxpwifi/uap_event.c
#![no_std]
...
pub const NXPWIFI_BSS_START_EVT_FIX_SIZE: c_int = 12;
    static int
    ...
    len = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ieee80211_is_reassoc_req(event->frame_control)) -> else {
...
//
    len = ETH_ALEN;
    if (len != -1) {
    let mut evt_len: u16 = le16_to_cpu(event.len);
...
//
    ...
    struct ieee80211_wmm_param_ie *wmm_param_ie = core::ptr::null_mut();
    let mut mask: c_int = IEEE80211_WMM_IE_AP_QOSINFO_PARAM_SET_CNT_MASK;
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_process_uap_event(priv: *mut nxpwifi_private) -> c_int {
