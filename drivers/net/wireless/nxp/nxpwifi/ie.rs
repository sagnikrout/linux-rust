...
//! Source: drivers/net/wireless/nxp/nxpwifi/ie.c
#![no_std]
...
// Parse beacon/probe/assoc IEs from cfg80211 and push them to FW.
    ...
    {
    struct nxpwifi_ie *beacon_ie = core::ptr::null_mut(), *pr_ie = core::ptr::null_mut(), *ar_ie = core::ptr::null_mut();
    let mut beacon_idx: u16 = NXPWIFI_AUTO_IDX_MASK, pr_idx = NXPWIFI_AUTO_IDX_MASK;
    let mut ar_idx: u16 = NXPWIFI_AUTO_IDX_MASK;
    let mut ret: c_int = 0;
...
// Parse head/tail IEs from cfg80211_beacon_data and send them to FW.
    ...
    let mut gen_idx: u16 = NXPWIFI_AUTO_IDX_MASK, ie_len = 0;
...
//
    ...
    ret = nxpwifi_update_uap_custom_ie(priv, gen_ie, &gen_idx, core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_del_mgmt_ies(priv: *mut nxpwifi_private) -> c_int {
    int nxpwifi_del_mgmt_ies(struct nxpwifi_private *priv)
    {
    struct nxpwifi_ie *beacon_ie = core::ptr::null_mut(), *pr_ie = core::ptr::null_mut();
    struct nxpwifi_ie *ar_ie = core::ptr::null_mut(), *gen_ie = core::ptr::null_mut();
    let mut ret: c_int = 0;
