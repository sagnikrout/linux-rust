...
//! Source: drivers/net/wireless/nxp/nxpwifi/sdio.h
#![no_std]
...
pub const NXPWIFI_SDIO_IO_PORT_MASK: c_uint = 0xfffff;
pub const NXPWIFI_SDIO_BYTE_MODE_MASK: c_uint = 0x80000000;
pub const NXPWIFI_MAX_FUNC2_REG_NUM: c_int = 13;
pub const NXPWIFI_SDIO_SCRATCH_SIZE: c_int = 10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nxpwifi_sdio_mpa_tx {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nxpwifi_sdio_mpa_rx {
    pub buf: *mut u8,
    pub buf_len: u32,
    pub pkt_cnt: u32,
    pub ports: u32,
...
extern "C" {
    pub fn nxpwifi_bus_register() -> c_int;
}
extern "C" {
    pub fn nxpwifi_bus_unregister();
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nxpwifi_sdio_card_reg {
    ...
    pub func1_spec_reg_table: [u8; NXPWIFI_MAX_FUNC2_REG_NUM],
}
...
pub struct sdio_mmc_card {
    ...
    pub reg: *const nxpwifi_sdio_card_reg,
    pub max_ports: u8,
    ...
    pub mpa_tx: nxpwifi_sdio_mpa_tx,
    pub mpa_rx: nxpwifi_sdio_mpa_rx,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nxpwifi_sdio_device {
    pub firmware: *const c_char,
    pub firmware_sdiouart: *const c_char,
    pub reg: *const nxpwifi_sdio_card_reg,
    pub max_ports: u8,
