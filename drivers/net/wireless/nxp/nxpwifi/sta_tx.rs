...
//! Source: drivers/net/wireless/nxp/nxpwifi/sta_tx.c
#![no_std]
...
//
    ...
    let mut hroom: c_int = adapter.intf_hdr_len;
    u32 tx_control;
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_send_null_packet(priv: *mut nxpwifi_private, flags: u8) -> c_int {
...
pub const NULL_PACKET_HDR: c_int = 64;
    let mut data_len: u32 = NULL_PACKET_HDR;
    struct sk_buff *skb;
    int ret;
    struct nxpwifi_txinfo *tx_info = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_check_last_packet_indication(priv: *mut nxpwifi_private) -> u8 {
