...
//! Source: drivers/net/wireless/nxp/nxpwifi/sta_event.c
#![no_std]
...
//
    ...
    -1, core::ptr::null_mut(), GFP_KERNEL);
    return 0;
    }
    static int
...
// Need to erase the current SSID and BSSID info
    ...
    cfg80211_disconnected(priv.netdev, reason_code, core::ptr::null_mut(),
    ...
    HOST_ACT_GEN_REMOVE, 0, core::ptr::null_mut(), false);
    }
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_reset_conn_state_work(wiphy: *mut wiphy, work: *mut wiphy_work) {
...
//
    ...
    let mut len: i32 = event_skb.len - sizeof(u32);
...
//
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_process_sta_event(priv: *mut nxpwifi_private) -> c_int {
    int nxpwifi_process_sta_event(struct nxpwifi_private *priv)
    {
    struct nxpwifi_adapter *adapter = priv.adapter;
    let mut eventcause: u32 = adapter.event_cause;
    int evt, ret = 0;
