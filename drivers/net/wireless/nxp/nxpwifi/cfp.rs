...
//! Source: drivers/net/wireless/nxp/nxpwifi/cfp.c
#![no_std]
...
// 100mW
pub const NXPWIFI_TX_PWR_DEFAULT: c_int = 20;
// 100mW
pub const NXPWIFI_TX_PWR_US_DEFAULT: c_int = 20;
// 50mW
pub const NXPWIFI_TX_PWR_JP_DEFAULT: c_int = 16;
// 100mW
pub const NXPWIFI_TX_PWR_FR_100MW: c_int = 20;
// 10mW
pub const NXPWIFI_TX_PWR_FR_10MW: c_int = 10;
// 100mW
pub const NXPWIFI_TX_PWR_EMEA_DEFAULT: c_int = 20;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct region_code_mapping {
    pub code: u8,
    pub region: [u8; IEEE80211_COUNTRY_STRING_LEN],
}
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_get_active_data_rates(priv: *mut nxpwifi_private, rates: *mut u8) -> u32 {
...
// Find Channel/Frequency/Power by band and channel or frequency.
    ...
    {
    struct nxpwifi_chan_freq_power *cfp = core::ptr::null_mut();
    struct ieee80211_supported_band *sband;
    struct ieee80211_channel *ch = core::ptr::null_mut();
    int i;
    if (!channel && !freq)
    return cfp;
...
#[no_mangle]
unsafe extern "C" fn nxpwifi_convert_config_bands(config_bands: u16) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_get_supported_rates(priv: *mut nxpwifi_private, rates: *mut u8) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn nxpwifi_is_valid_region_code(code: enum nxpwifi_region_code) -> bool {
