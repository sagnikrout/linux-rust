...
//! Source: drivers/net/wireless/microchip/wilc1000/sdio.c
#![no_std]
...
pub const WILC_SDIO_BLOCK_SIZE: c_int = 512;
    static int wilc_sdio_init(struct wilc *wilc, bool resume);
    static int wilc_sdio_deinit(struct wilc *wilc);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wilc_sdio {
    pub irq_gpio: bool,
    pub block_size: u32,
    pub isinit: bool,
    pub cmd53_buf: *mut u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdio_cmd52 {
    pub 1: u32 read_write:,
    pub 3: u32 function:,
    pub 1: u32 raw:,
    pub 17: u32 address:,
    pub 8: u32 data:,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdio_cmd53 {
    pub 1: u32 read_write:,
    pub 3: u32 function:,
    pub 1: u32 block_mode:,
    pub 1: u32 increment:,
    pub 17: u32 address:,
    pub 9: u32 count:,
    pub buffer: *mut u8,
    pub block_size: u32,
    pub use_global_buf: bool,
}

    static const struct wilc_hif_func wilc_hif_sdio;
#[no_mangle]
unsafe extern "C" fn wilc_sdio_interrupt(func: *mut sdio_func) {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_cmd52(wilc: *mut wilc, cmd: *mut sdio_cmd52) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_cmd53(wilc: *mut wilc, cmd: *mut sdio_cmd53) -> c_int {
    ...
    let mut irq_num: c_int = of_irq_get(np, 0);
    if (irq_num > 0) {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_remove(func: *mut sdio_func) {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_reset(wilc: *mut wilc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_is_init(wilc: *mut wilc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_enable_interrupt(dev: *mut wilc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_disable_interrupt(dev: *mut wilc) {
...
//
#[no_mangle]
unsafe extern "C" fn wilc_sdio_set_func0_csa_address(wilc: *mut wilc, adr: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wilc_sdio_write_reg(wilc: *mut wilc, addr: u32, data: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_write(wilc: *mut wilc, addr: u32, buf: *mut u8, size: u32) -> c_int {
    static int wilc_sdio_write(struct wilc *wilc, u32 addr, u8 *buf, u32 size)
    {
    struct sdio_func *func = dev_to_sdio_func(wilc.dev);
    struct wilc_sdio *sdio_priv = wilc.bus_data;
    let mut block_size: u32 = sdio_priv.block_size;
    struct sdio_cmd53 cmd;
    int nblk, nleft, ret;
    cmd.read_write = 1;
    if (addr > 0) {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_read_reg(wilc: *mut wilc, addr: u32, data: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_read(wilc: *mut wilc, addr: u32, buf: *mut u8, size: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wilc_sdio_deinit(wilc: *mut wilc) -> c_int {
    static int wilc_sdio_deinit(struct wilc *wilc)
    {
    struct sdio_func *func = dev_to_sdio_func(wilc.dev);
    struct wilc_sdio *sdio_priv = wilc.bus_data;
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_init(wilc: *mut wilc, resume: bool) -> c_int {
    static int wilc_sdio_init(struct wilc *wilc, bool resume)
    {
    struct sdio_func *func = dev_to_sdio_func(wilc.dev);
    struct wilc_sdio *sdio_priv = wilc.bus_data;
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_read_size(wilc: *mut wilc, size: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_read_int(wilc: *mut wilc, int_status: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_clear_int_ext(wilc: *mut wilc, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_sync_ext(wilc: *mut wilc, nint: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wilc_sdio_resume(dev: *mut device) -> c_int {
