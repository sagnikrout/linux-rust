...
//! Source: drivers/net/wireless/broadcom/brcm80211/brcmfmac/cyw/core.c
#![no_std]
...
// event definitions
pub const BRCMF_CYW_E_EXT_AUTH_REQ: c_int = 187;
pub const BRCMF_CYW_E_EXT_AUTH_FRAME_RX: c_int = 188;
pub const BRCMF_CYW_E_MGMT_FRAME_TXS: c_int = 189;
pub const BRCMF_CYW_E_MGMT_FRAME_TXS_OC: c_int = 190;
pub const BRCMF_CYW_E_LAST: c_int = 197;
pub const MGMT_AUTH_FRAME_DWELL_TIME: c_int = 4000;
    ...
    let mut pwd_len: u16 = crypto.sae_pwd_len;
    int err;
...
#[no_mangle]
unsafe extern "C" fn brcmf_cyw_alloc_fweh_info(drvr: *mut brcmf_pub) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmf_cyw_activate_events(ifp: *mut brcmf_if) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmf_cyw_get_cfg80211_ops(drvr: *mut brcmf_pub) {
    ...
    let mut mgmt_frame_len: u32 = e.datalen - sizeof(struct brcmf_rx_mgmt_data);
...
#[no_mangle]
unsafe extern "C" fn brcmf_cyw_register_event_handlers(drvr: *mut brcmf_pub) {
