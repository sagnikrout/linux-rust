...
//! Source: drivers/net/wireless/broadcom/brcm80211/brcmfmac/bca/core.c
#![no_std]
...
pub const BRCMF_BCA_E_LAST: c_int = 212;
#[no_mangle]
unsafe extern "C" fn brcmf_bca_feat_attach(ifp: *mut brcmf_if) {
...
#[no_mangle]
unsafe extern "C" fn brcmf_bca_alloc_fweh_info(drvr: *mut brcmf_pub) -> c_int {
