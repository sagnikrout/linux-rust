...
//! Source: drivers/net/wireless/broadcom/brcm80211/brcmfmac/bca/module.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn brcmf_bca_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn brcmf_bca_exit() -> void __exit {
