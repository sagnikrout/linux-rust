...
//! Source: drivers/net/wireless/broadcom/brcm80211/brcmfmac/dmi.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn brcmf_dmi_probe(settings: *mut brcmf_mp_device, chip: u32, chiprev: u32) {
