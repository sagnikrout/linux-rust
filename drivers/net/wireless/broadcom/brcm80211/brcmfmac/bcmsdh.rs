...
//! Source: drivers/net/wireless/broadcom/brcm80211/brcmfmac/bcmsdh.c
#![no_std]
...
pub const SDIOH_API_ACCESS_RETRY_LIMIT: c_int = 2;
pub const DMA_ALIGN_MASK: c_uint = 0x03;
pub const SDIO_FUNC1_BLOCKSIZE: c_int = 64;
pub const SDIO_FUNC2_BLOCKSIZE: c_int = 512;
pub const SDIO_4373_FUNC2_BLOCKSIZE: c_int = 256;
pub const SDIO_435X_FUNC2_BLOCKSIZE: c_int = 256;
pub const SDIO_4329_FUNC2_BLOCKSIZE: c_int = 128;
// Maximum milliseconds to wait for F2 to come up
pub const SDIO_WAIT_F2RDY: c_int = 3000;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcmf_sdiod_freezer {
    pub freezing: core::sync::atomic::AtomicI32,
    pub thread_count: core::sync::atomic::AtomicI32,
    pub frozen_count: u32,
    pub thread_freeze: wait_queue_head_t,
    pub resumed: completion,
}

#[no_mangle]
unsafe extern "C" fn brcmf_sdiod_oob_irqhandler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn brcmf_sdiod_ib_irqhandler(func: *mut sdio_func) {
...
#[no_mangle]
unsafe extern "C" fn brcmf_sdiod_dummy_irqhandler(func: *mut sdio_func) {
    static void brcmf_sdiod_dummy_irqhandler(struct sdio_func *func)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdiod_intr_register(sdiodev: *mut brcmf_sdio_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdiod_intr_unregister(sdiodev: *mut brcmf_sdio_dev) {
    ...
    pdata = &sdiodev.settings.bus.sdio;
    sdio_claim_host(sdiodev.func1);
    brcmf_sdiod_func0_wb(sdiodev, SDIO_CCCR_BRCM_SEPINT, 0, core::ptr::null_mut());
    brcmf_sdiod_func0_wb(sdiodev, SDIO_CCCR_IENx, 0, core::ptr::null_mut());
    sdio_release_host(sdiodev.func1);
...
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdiod_readl(sdiodev: *mut brcmf_sdio_dev, addr: u32, ret: *mut c_int) -> u32 {
...
//
    ...
    struct sk_buff *pkt_next = core::ptr::null_mut(), *src;
...
//
    ...
    while ((pkt_next = __skb_dequeue(&local_list)) != core::ptr::null_mut())
    brcmu_pkt_buf_free_skb(pkt_next);
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdiod_recv_buf(sdiodev: *mut brcmf_sdio_dev, buf: *mut u8, nbytes: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdiod_recv_pkt(sdiodev: *mut brcmf_sdio_dev, pkt: *mut sk_buff) -> c_int {
    int brcmf_sdiod_recv_pkt(struct brcmf_sdio_dev *sdiodev, struct sk_buff *pkt)
    {
    let mut addr: u32 = sdiodev.cc_core.base;
    let mut err: c_int = 0;
    ...
    {
    struct sk_buff *glom_skb = core::ptr::null_mut();
    struct sk_buff *skb;
    let mut addr: u32 = sdiodev.cc_core.base;
    let mut err: c_int = 0;
    brcmf_dbg(SDIO, "addr = 0x%x, size = %d\n",
    ...
    __skb_peek(pktq));
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !sdiodev->sg_support) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdiod_send_buf(sdiodev: *mut brcmf_sdio_dev, buf: *mut u8, nbytes: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdiod_abort(sdiodev: *mut brcmf_sdio_dev, func: *mut sdio_func) -> c_int {
    int brcmf_sdiod_abort(struct brcmf_sdio_dev *sdiodev, struct sdio_func *func)
    {
    brcmf_dbg(SDIO, "Enter\n");
// Issue abort cmd52 command through F0
    brcmf_sdiod_func0_wb(sdiodev, SDIO_CCCR_ABORT, func.num, core::ptr::null_mut());
    brcmf_dbg(SDIO, "Exit\n");
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdiod_sgtable_alloc(sdiodev: *mut brcmf_sdio_dev) {
...
#[no_mangle]
unsafe extern "C" fn brcmf_sdiod_freezer_attach(sdiodev: *mut brcmf_sdio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmf_sdiod_freezer_detach(sdiodev: *mut brcmf_sdio_dev) {
    static void brcmf_sdiod_freezer_detach(struct brcmf_sdio_dev *sdiodev)
    {
    if (sdiodev.freezer) {
    WARN_ON(atomic_read(&sdiodev.freezer.freezing));
    kfree(sdiodev.freezer);
    sdiodev.freezer = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn brcmf_sdiod_freezer_on(sdiodev: *mut brcmf_sdio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmf_sdiod_freezer_off(sdiodev: *mut brcmf_sdio_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdiod_freezing(sdiodev: *mut brcmf_sdio_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdiod_try_freeze(sdiodev: *mut brcmf_sdio_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdiod_freezer_count(sdiodev: *mut brcmf_sdio_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdiod_freezer_uncount(sdiodev: *mut brcmf_sdio_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdiod_remove(sdiodev: *mut brcmf_sdio_dev) -> c_int {
    int brcmf_sdiod_remove(struct brcmf_sdio_dev *sdiodev)
    {
    sdiodev.state = BRCMF_SDIOD_DOWN;
    if (sdiodev.bus) {
    brcmf_sdio_remove(sdiodev.bus);
    sdiodev.bus = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn brcmf_sdiod_host_fixup(host: *mut mmc_host) {
...
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdiod_probe(sdiodev: *mut brcmf_sdio_dev) -> c_int {
    int brcmf_sdiod_probe(struct brcmf_sdio_dev *sdiodev)
    {
    let mut ret: c_int = 0;
    let mut f2_blksz: c_uint = SDIO_FUNC2_BLOCKSIZE;
    sdio_claim_host(sdiodev.func1);
...
#[no_mangle]
unsafe extern "C" fn brcmf_sdiod_acpi_save_power_manageable(sdiodev: *mut brcmf_sdio_dev) {
...
//
    ...
    return 0;
    fail:
    dev_set_drvdata(&func.dev, core::ptr::null_mut());
    dev_set_drvdata(&sdiodev.func1.dev, core::ptr::null_mut());
    kfree(sdiodev);
    kfree(bus_if);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn brcmf_ops_sdio_remove(func: *mut sdio_func) {
...
// only proceed with rest of cleanup if func 1
    brcmf_sdiod_remove(sdiodev);
    dev_set_drvdata(&sdiodev.func1.dev, core::ptr::null_mut());
    dev_set_drvdata(&sdiodev.func2.dev, core::ptr::null_mut());
    kfree(bus_if);
    kfree(sdiodev);
    }
    brcmf_dbg(SDIO, "Exit\n");
...
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdio_wowl_config(dev: *mut device, enabled: bool) {
    void brcmf_sdio_wowl_config(struct device *dev, bool enabled)
    {
    struct brcmf_bus *bus_if = dev_get_drvdata(dev);
    struct brcmf_sdio_dev *sdiodev = bus_if.bus_priv.sdio;
    let mut pm_caps: mmc_pm_flag_t = sdio_get_host_pm_caps(sdiodev.func1);
...
#[no_mangle]
unsafe extern "C" fn brcmf_ops_sdio_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmf_ops_sdio_resume(dev: *mut device) -> c_int {
    ...
    let mut ret: c_int = 0;
    let mut cap_power_off: bool = !!(func.card.host.caps & MMC_CAP_POWER_OFF_CARD);
    brcmf_dbg(SDIO, "Enter: F%d\n", func.num);
    if (func.num != 2)
    return 0;
    if (!sdiodev.wowl_enabled && cap_power_off) {
...
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdio_register() -> c_int {
    int brcmf_sdio_register(void)
    {
    return sdio_register_driver(&brcmf_sdmmc_driver);
    }
#[no_mangle]
pub unsafe extern "C" fn brcmf_sdio_exit() {
