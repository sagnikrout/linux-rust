...
//! Source: drivers/net/wireless/broadcom/brcm80211/brcmfmac/wcc/module.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn brcmf_wcc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn brcmf_wcc_exit() -> void __exit {
