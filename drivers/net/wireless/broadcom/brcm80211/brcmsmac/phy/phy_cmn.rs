...
//! Source: drivers/net/wireless/broadcom/brcm80211/brcmsmac/phy/phy_cmn.c
#![no_std]
...
pub const PHY_WREG_LIMIT: c_int = 24;
#[no_mangle]
pub unsafe extern "C" fn wlc_phyreg_enter(pih: *mut brcms_phy_pub) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phyreg_exit(pih: *mut brcms_phy_pub) {
...
#[no_mangle]
pub unsafe extern "C" fn read_radio_reg(pi: *mut brcms_phy, addr: u16) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn write_radio_reg(pi: *mut brcms_phy, addr: u16, val: u16) {
...
#[no_mangle]
unsafe extern "C" fn read_radio_id(pi: *mut brcms_phy) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn and_radio_reg(pi: *mut brcms_phy, addr: u16, val: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn or_radio_reg(pi: *mut brcms_phy, addr: u16, val: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn xor_radio_reg(pi: *mut brcms_phy, addr: u16, mask: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn mod_radio_reg(pi: *mut brcms_phy, addr: u16, mask: u16, val: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn read_phy_reg(pi: *mut brcms_phy, addr: u16) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn write_phy_reg(pi: *mut brcms_phy, addr: u16, val: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn and_phy_reg(pi: *mut brcms_phy, addr: u16, val: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn or_phy_reg(pi: *mut brcms_phy, addr: u16, val: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn mod_phy_reg(pi: *mut brcms_phy, addr: u16, mask: u16, val: u16) {
...
#[no_mangle]
unsafe extern "C" fn wlc_set_phy_uninitted(pi: *mut brcms_phy) {
...
#[no_mangle]
unsafe extern "C" fn wlc_phy_timercb_phycal(ptr: *mut c_void) {
    static void wlc_phy_timercb_phycal(void *ptr)
    {
    struct brcms_phy *pi = ptr;
    let mut delay: c_uint = 5;
...
#[no_mangle]
unsafe extern "C" fn wlc_phy_get_radio_ver(pi: *mut brcms_phy) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_detach(pih: *mut brcms_phy_pub) {
    ...
    pi.phycal_timer = core::ptr::null_mut();
    }
    if (pi.sh.phy_head == pi)
    pi.sh.phy_head = pi.next;
#[no_mangle]
pub unsafe extern "C" fn if(pi: pi->sh->phy_head->next ==) -> else {
    else if (pi.sh.phy_head.next == pi)
    pi.sh.phy_head.next = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_get_encore(pih: *mut brcms_phy_pub) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_get_coreflags(pih: *mut brcms_phy_pub) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_anacore(pih: *mut brcms_phy_pub, on: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_clk_bwbits(pih: *mut brcms_phy_pub) -> u32 {
    u32 wlc_phy_clk_bwbits(struct brcms_phy_pub *pih)
    {
    struct brcms_phy *pi = container_of(pih, struct brcms_phy, pubpi_ro);
    let mut phy_bw_clkbits: u32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_por_inform(ppi: *mut brcms_phy_pub) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_initcal_enable(pih: *mut brcms_phy_pub, initcal: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_hw_clk_state_upd(pih: *mut brcms_phy_pub, newstate: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_hw_state_upd(pih: *mut brcms_phy_pub, newstate: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_init(pih: *mut brcms_phy_pub, chanspec: u16) {
    void wlc_phy_init(struct brcms_phy_pub *pih, u16 chanspec)
    {
    u32 mc;
    void (*phy_init)(struct brcms_phy *) = core::ptr::null_mut();
    struct brcms_phy *pi = container_of(pih, struct brcms_phy, pubpi_ro);
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_cal_init(pih: *mut brcms_phy_pub) {
    void wlc_phy_cal_init(struct brcms_phy_pub *pih)
    {
    struct brcms_phy *pi = container_of(pih, struct brcms_phy, pubpi_ro);
    void (*cal_init)(struct brcms_phy *) = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_down(pih: *mut brcms_phy_pub) -> c_int {
    int wlc_phy_down(struct brcms_phy_pub *pih)
    {
    struct brcms_phy *pi = container_of(pih, struct brcms_phy, pubpi_ro);
    let mut callbacks: c_int = 0;
    if (pi.phycal_timer
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_table_data_write(pi: *mut brcms_phy, width: c_uint, val: u32) {
    ...
    {
    uint idx;
    let mut tbl_id: c_uint = ptbl_info.tbl_id;
    let mut tbl_offset: c_uint = ptbl_info.tbl_offset;
    let mut tbl_width: c_uint = ptbl_info.tbl_width;
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_do_dummy_tx(pi: *mut brcms_phy, ofdm: bool, pa_on: bool) {
    void wlc_phy_do_dummy_tx(struct brcms_phy *pi, bool ofdm, bool pa_on)
    {
pub const DUMMY_PKT_LEN: c_int = 20;
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_hold_upd(pih: *mut brcms_phy_pub, id: u32, set: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_mute_upd(pih: *mut brcms_phy_pub, mute: bool, flags: u32) {
...
#[no_mangle]
unsafe extern "C" fn wlc_phy_cal_txpower_recalc_sw(pi: *mut brcms_phy) -> bool {
    static bool wlc_phy_cal_txpower_recalc_sw(struct brcms_phy *pi)
    {
    return false;
    }
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_switch_radio(pih: *mut brcms_phy_pub, on: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_bw_state_set(ppi: *mut brcms_phy_pub, bw: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_chanspec_radio_set(ppi: *mut brcms_phy_pub, newch: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_chanspec_get(ppi: *mut brcms_phy_pub) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_chanspec_set(ppi: *mut brcms_phy_pub, chanspec: u16) {
    void wlc_phy_chanspec_set(struct brcms_phy_pub *ppi, u16 chanspec)
    {
    struct brcms_phy *pi = container_of(ppi, struct brcms_phy, pubpi_ro);
    u16 m_cur_channel;
    void (*chanspec_set)(struct brcms_phy *, u16) = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_channel2freq(channel: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_txpower_get(ppi: *mut brcms_phy_pub, qdbm: *mut c_uint, override: *mut bool) -> c_int {
    int wlc_phy_txpower_get(struct brcms_phy_pub *ppi, uint *qdbm, bool *override)
    {
    struct brcms_phy *pi = container_of(ppi, struct brcms_phy, pubpi_ro);
// qdbm = pi->tx_user_target[0];
    if (override != core::ptr::null_mut())
// override = pi->txpwroverride;
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_txpower_set(ppi: *mut brcms_phy_pub, qdbm: c_uint, override: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wlc_phy_env_measure_vbat(pi: *mut brcms_phy) -> i8 {
...
#[no_mangle]
unsafe extern "C" fn wlc_phy_env_measure_temperature(pi: *mut brcms_phy) -> i8 {
...
#[no_mangle]
unsafe extern "C" fn wlc_phy_upd_env_txpwr_rate_limits(pi: *mut brcms_phy, band: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_txpower_recalc_target(pi: *mut brcms_phy) {
    void wlc_phy_txpower_recalc_target(struct brcms_phy *pi)
    {
    u8 maxtxpwr, mintxpwr, rate, pactrl;
    uint target_chan;
    u8 tx_pwr_target[TXP_NUM_RATES];
    let mut tx_pwr_max: u8 = 0;
    let mut tx_pwr_min: u8 = 255;
    let mut tx_pwr_max_rate_ind: u8 = 0;
    u8 max_num_rate;
    let mut start_rate: u8 = 0;
    u16 chspec;
    let mut band: u32 = CHSPEC2BAND(pi.radio_chanspec);
    void (*txpwr_recalc_fn)(struct brcms_phy *) = core::ptr::null_mut();
    chspec = pi.radio_chanspec;
    if (CHSPEC_CTL_SB(chspec) == WL_CHANSPEC_CTL_SB_NONE)
    target_chan = CHSPEC_CHANNEL(chspec);
#[no_mangle]
pub unsafe extern "C" fn if(WL_CHANSPEC_CTL_SB_UPPER: CHSPEC_CTL_SB(chspec) ==) -> else {
    ...
    u8 *txpwr_ptr1 = core::ptr::null_mut(), *txpwr_ptr2 = core::ptr::null_mut();
    let mut rate_start_index: c_int = 0, rate1, rate2, k;
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_machwcap_set(ppi: *mut brcms_phy_pub, machwcap: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_ofdm_rateset_war(pih: *mut brcms_phy_pub, war: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_bf_preempt_enable(pih: *mut brcms_phy_pub, bf_preempt: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_txpower_update_shm(pi: *mut brcms_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_txpower_hw_ctrl_get(ppi: *mut brcms_phy_pub) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_txpower_ipa_upd(pi: *mut brcms_phy) {
...
#[no_mangle]
unsafe extern "C" fn wlc_phy_txpower_est_power_nphy(pi: *mut brcms_phy) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_antsel_type_set(ppi: *mut brcms_phy_pub, antsel_type: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_ant_rxdiv_set(ppi: *mut brcms_phy_pub, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn wlc_phy_noise_cb(pi: *mut brcms_phy, channel: u8, noise_dbm: i8) {
...
#[no_mangle]
unsafe extern "C" fn wlc_phy_noise_read_shmem(pi: *mut brcms_phy) -> i8 {
    static s8 wlc_phy_noise_read_shmem(struct brcms_phy *pi)
    {
    u32 cmplx_pwr[PHY_CORE_MAX];
    s8 noise_dbm_ant[PHY_CORE_MAX];
    u16 lo, hi;
    let mut cmplx_pwr_tot: u32 = 0;
    let mut noise_dbm: i8 = PHY_NOISE_FIXED_VAL_NPHY;
    u8 idx, core;
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_noise_sample_intr(pih: *mut brcms_phy_pub) {
    ...
    struct brcms_phy *pi = container_of(pih, struct brcms_phy, pubpi_ro);
    let mut noise_dbm: i8 = PHY_NOISE_FIXED_VAL_NPHY;
    let mut sampling_in_progress: bool = (pi.phynoise_state != 0);
    let mut wait_for_intr: bool = true;
    switch (reason) {
    ...
    let mut wait_time: u8 = 32;
    let mut wait_crs: u8 = 0;
    u8 i;
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_compute_dB(cmplx_pwr: *mut u32, p_cmplx_pwr_dB: *mut i8, core: u8) {
    ...
    struct d11rxhdr *rxh)
    {
    let mut rssi: c_int = rxh.PhyRxStatus_1 & PRXS1_JSSI_MASK;
    let mut radioid: c_uint = pih.radioid;
    struct brcms_phy *pi = container_of(pih, struct brcms_phy, pubpi_ro);
    if ((pi.sh.corerev >= 11)
    ...
    if (ISLCNPHY(pi)) {
    let mut gidx: u8 = (rxh.PhyRxStatus_2 & 0xFC00) >> 10;
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_watchdog(pih: *mut brcms_phy_pub) {
    void wlc_phy_watchdog(struct brcms_phy_pub *pih)
    {
    struct brcms_phy *pi = container_of(pih, struct brcms_phy, pubpi_ro);
    let mut delay_phy_cal: bool = false;
    pi.sh.now++;
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_cal_perical_mphase_reset(pi: *mut brcms_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_cal_perical(pih: *mut brcms_phy_pub, reason: u8) {
    void wlc_phy_cal_perical(struct brcms_phy_pub *pih, u8 reason)
    {
    let mut nphy_currtemp: i16 = 0;
    let mut delta_temp: i16 = 0;
    let mut do_periodic_cal: bool = true;
    struct brcms_phy *pi = container_of(pih, struct brcms_phy, pubpi_ro);
    if (!ISNPHY(pi))
    return;
    if ((pi.nphy_perical == PHY_PERICAL_DISABLE) ||
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_cal_perical_mphase_restart(pi: *mut brcms_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_nbits(value: i32) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_stf_chain_init(pih: *mut brcms_phy_pub, txchain: u8, rxchain: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_stf_chain_set(pih: *mut brcms_phy_pub, txchain: u8, rxchain: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_stf_chain_active_get(pih: *mut brcms_phy_pub) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn wlc_phy_ldpc_override_set(ppi: *mut brcms_phy_pub, ldpc: bool) {
