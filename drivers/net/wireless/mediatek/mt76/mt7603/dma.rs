...
//! Source: drivers/net/wireless/mediatek/mt76/mt7603/dma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7603_poll_tx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7603_dma_init(dev: *mut mt7603_dev) -> c_int {
    ...
    MT7603_PSD_RING_SIZE, MT_TX_RING_BASE, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
    ...
    MT_MCU_RING_SIZE, MT_TX_RING_BASE, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn mt7603_dma_cleanup(dev: *mut mt7603_dev) {
