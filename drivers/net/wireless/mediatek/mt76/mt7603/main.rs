...
//! Source: drivers/net/wireless/mediatek/mt76/mt7603/main.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mt7603_init_edcca(dev: *mut mt7603_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7603_set_channel(mphy: *mut mt76_phy) -> c_int {
...
// total_flags = flags;
    ...
    let mut beacon_int: c_int = !!info.enable_beacon * info.beacon_int;
    tasklet_disable(&dev.mt76.pre_tbtt_tasklet);
...
//
    ...
    {
    struct mt7603_dev *dev = hw.priv;
    let mut cw_min: u16 = (1 << 5) - 1;
    let mut cw_max: u16 = (1 << 10) - 1;
    u32 val;
    ...
    let mut ba_size: u8 = params.buf_size;
    struct mt76_txq *mtxq;
    let mut ret: c_int = 0;
    if (!txq)
    return -EINVAL;
    ...
    msta.n_rates = i;
    mt7603_wtbl_set_rates(dev, msta, core::ptr::null_mut(), msta.rates);
...
#[no_mangle]
unsafe extern "C" fn mt7603_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mt7603_exit() -> void __exit {
