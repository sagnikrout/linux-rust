...
//! Source: drivers/net/wireless/mediatek/mt76/mt7603/init.c
#![no_std]
...
// SPDX-License-Identifier: BSD-3-Clause-Clear
    ...
    {
    let mut page_size: c_int = 128;
    int page_count;
    let mut max_len: c_int = 1792;
    let mut max_amsdu_pages: c_int = 4096 / page_size;
    let mut max_mcu_len: c_int = 4096;
    let mut max_beacon_len: c_int = 512 * 4 + max_len;
    let mut max_mcast_pages: c_int = 4 * max_len / page_size;
    let mut reserved_count: c_int = 0;
    int beacon_pages;
    int mcu_pages;
    int i;
    ...
    {
    let mut rx_chains: c_int = dev.mphy.antenna_mask;
    let mut tx_chains: c_int = hweight8(rx_chains) - 1;
...
#[no_mangle]
unsafe extern "C" fn __mt7603_reg_addr(dev: *mut mt7603_dev, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt7603_rr(mdev: *mut mt76_dev, offset: u32) -> u32 {
    static u32 mt7603_rr(struct mt76_dev *mdev, u32 offset)
    {
    struct mt7603_dev *dev = container_of(mdev, struct mt7603_dev, mt76);
    let mut addr: u32 = __mt7603_reg_addr(dev, offset);
    return dev.bus_ops.rr(mdev, addr);
    }
#[no_mangle]
unsafe extern "C" fn mt7603_wr(mdev: *mut mt76_dev, offset: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn mt7603_rmw(mdev: *mut mt76_dev, offset: u32, mask: u32, val: u32) -> u32 {
    ...
    let mut target_power: c_int = eeprom[MT_EE_TX_POWER_0_START_2G + 2] & ~BIT(7);
    u8 *rate_power = &eeprom[MT_EE_TX_POWER_CCK];
    let mut ext_pa: bool = eeprom[MT_EE_NIC_CONF_0 + 1] & BIT(1);
    u8 ext_pa_pwr;
...
#[no_mangle]
pub unsafe extern "C" fn mt7603_register_device(dev: *mut mt7603_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7603_unregister_device(dev: *mut mt7603_dev) {
