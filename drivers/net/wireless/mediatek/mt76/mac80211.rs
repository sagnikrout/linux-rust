...
//! Source: drivers/net/wireless/mediatek/mt76/mac80211.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt76_led_init(phy: *mut mt76_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76_led_cleanup(phy: *mut mt76_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_set_stream_caps(phy: *mut mt76_phy, vht: bool) {
    ...
    phy.hw.wiphy.bands[band] = core::ptr::null_mut();
    }
    static int
...
#[no_mangle]
pub unsafe extern "C" fn mt76_unregister_phy(phy: *mut mt76_phy) {
    ...
    dev.phys[phy.band_idx] = core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(mt76_unregister_phy);
#[no_mangle]
pub unsafe extern "C" fn mt76_create_page_pool(dev: *mut mt76_dev, q: *mut mt76_queue) -> c_int {
    int mt76_create_page_pool(struct mt76_dev *dev, struct mt76_queue *q)
    {
    let mut is_qrx: bool = mt76_queue_is_rx(dev, q);
    ...
    let mut idx: c_int = is_qrx ? q - dev.q_rx : -1;
...
// NAPI is available just for rx queues
    ...
    let mut err: c_int = PTR_ERR(q.page_pool);
    q.page_pool = core::ptr::null_mut();
    return err;
    }
    return 0;
    }
    ...
    dev.hw = hw;
    dev.dev = pdev;
    dev.init_wiphy = core::ptr::null_mut();
    dev.drv = drv_ops;
    dev.dma_dev = pdev;
    phy = &dev.phy;
    phy.dev = dev;
    ...
    if (ret)
    return ret;
    WARN_ON(mt76_worker_setup(hw, &dev.tx_worker, core::ptr::null_mut(), "tx"));
    set_bit(MT76_STATE_REGISTERED, &phy.state);
...
#[no_mangle]
pub unsafe extern "C" fn mt76_unregister_device(dev: *mut mt76_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_free_device(dev: *mut mt76_dev) {
    void mt76_free_device(struct mt76_dev *dev)
    {
    mt76_worker_teardown(&dev.tx_worker);
    if (dev.wq) {
    destroy_workqueue(dev.wq);
    dev.wq = core::ptr::null_mut();
    }
    mt76_npu_deinit(dev);
...
#[no_mangle]
unsafe extern "C" fn mt76_reset_phy(phy: *mut mt76_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_reset_device(dev: *mut mt76_dev) {
    ...
    rcu_assign_pointer(dev.wcid[i], core::ptr::null_mut());
    }
    rcu_read_unlock();
    INIT_LIST_HEAD(&dev.wcid_list);
    INIT_LIST_HEAD(&dev.sta_poll_list);
...
#[no_mangle]
unsafe extern "C" fn mt76_rx_release_amsdu(phy: *mut mt76_phy, q: enum mt76_rxq_id) {
    ...
    phy.rx_amsdu[q].head = core::ptr::null_mut();
    phy.rx_amsdu[q].tail = core::ptr::null_mut();
//
...
#[no_mangle]
pub unsafe extern "C" fn mt76_rx(dev: *mut mt76_dev, q: enum mt76_rxq_id, skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_has_tx_pending(phy: *mut mt76_phy) -> bool {
    ...
    msband = &phy.sband_2g;
#[no_mangle]
pub unsafe extern "C" fn if(NL80211_BAND_6GHZ: c->band ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_update_survey_active_time(phy: *mut mt76_phy, time: ktime_t) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_update_survey(phy: *mut mt76_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_update_channel(phy: *mut mt76_phy) -> c_int {
    int mt76_update_channel(struct mt76_phy *phy)
    {
    struct ieee80211_hw *hw = phy.hw;
    struct cfg80211_chan_def *chandef = &hw.conf.chandef;
    let mut offchannel: bool = hw.conf.flags & IEEE80211_CONF_OFFCHANNEL;
...
// idx -= phy->sband_6g.sband.n_channels;
    ...
    struct mt76_dev *dev = phy.dev;
    struct mt76_sband *sband = core::ptr::null_mut();
    struct ieee80211_channel *chan;
    struct mt76_channel_state *state;
    let mut phy_idx: c_int = 0;
    let mut ret: c_int = 0;
    mutex_lock(&dev.mutex);
    for (phy_idx = 0; phy_idx < ARRAY_SIZE(dev.phys); phy_idx++) {
    sband = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn mt76_rx_signal(chain_mask: u8, chain_signal: *mut i8) -> c_int {
    int mt76_rx_signal(u8 chain_mask, s8 *chain_signal)
    {
    let mut signal: c_int = -128;
    u8 chains;
    ...
    signal += 3;
#[no_mangle]
pub unsafe extern "C" fn if(2: diff <=) -> else {
    else if (diff <= 2)
    signal += 2;
#[no_mangle]
pub unsafe extern "C" fn if(6: diff <=) -> else {
    else if (diff <= 6)
    signal += 1;
    }
    return signal;
...
//
    ...
    struct ieee80211_sta *sta;
    u32 airtime;
    let mut tidno: u8 = status.qos_ctl & IEEE80211_QOS_CTL_TID_MASK;
    ...
    sta = ieee80211_find_sta_by_ifaddr(hw, hdr.addr2, core::ptr::null_mut());
    if (sta)
    ...
    while ((skb = __skb_dequeue(frames)) != core::ptr::null_mut()) {
...
// subsequent amsdu frames
    ...
    while ((skb = __skb_dequeue(&dev.rx_skb[q])) != core::ptr::null_mut()) {
    ...
    rcu_assign_pointer(dev.wcid[wcid.idx], core::ptr::null_mut());
    spin_unlock_bh(&dev.status_lock);
    mutex_unlock(&dev.mutex);
    }
    EXPORT_SYMBOL_GPL(mt76_sta_pre_rcu_remove);
#[no_mangle]
pub unsafe extern "C" fn mt76_wcid_init(wcid: *mut mt76_wcid, band_idx: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_wcid_cleanup(dev: *mut mt76_dev, wcid: *mut mt76_wcid) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_wcid_add_poll(dev: *mut mt76_dev, wcid: *mut mt76_wcid) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_get_power_bound(phy: *mut mt76_phy, txpower: i8) -> i8 {
...
// dbm = DIV_ROUND_UP(phy->txpower_cur + delta, 2);
    ...
    let mut index: u32 = sar.sub_specs[i].freq_range_index;
// SAR specifies power limitaton in 0.25dbm
    let mut power: i32 = sar.sub_specs[i].power >> 1;
...
#[no_mangle]
pub unsafe extern "C" fn mt76_csa_finish(dev: *mut mt76_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_csa_check(dev: *mut mt76_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_insert_ccmp_hdr(skb: *mut sk_buff, key_id: u8) {
    void mt76_insert_ccmp_hdr(struct sk_buff *skb, u8 key_id)
    {
    struct mt76_rx_status *status = (struct mt76_rx_status *)skb.cb;
    let mut hdr_len: c_int = ieee80211_get_hdrlen_from_skb(skb);
    u8 *hdr, *pn = status.iv;
    __skb_push(skb, 8);
    ...
    int idx, bool cck)
    {
    let mut is_2g: bool = sband.band == NL80211_BAND_2GHZ;
...
#[no_mangle]
pub unsafe extern "C" fn mt76_sw_scan_complete(hw: *mut ieee80211_hw, vif: *mut ieee80211_vif) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_ethtool_page_pool_stats(dev: *mut mt76_dev, data: *mut u64, index: *mut c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_phy_dfs_state(phy: *mut mt76_phy) -> enum mt76_dfs_state {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_vif_cleanup(dev: *mut mt76_dev, vif: *mut ieee80211_vif) {
    void mt76_vif_cleanup(struct mt76_dev *dev, struct ieee80211_vif *vif)
    {
    struct mt76_vif_link *mlink = (struct mt76_vif_link *)vif.drv_priv;
    struct mt76_vif_data *mvif = mlink.mvif;
    rcu_assign_pointer(mvif.link[0], core::ptr::null_mut());
    mt76_abort_scan(dev);
    if (mvif.roc_phy)
...
#[no_mangle]
pub unsafe extern "C" fn mt76_select_links(vif: *mut ieee80211_vif, max_active_links: c_int) -> u16 {
    u16 mt76_select_links(struct ieee80211_vif *vif, int max_active_links)
    {
    let mut usable_links: c_ulong = ieee80211_vif_usable_links(vif);
    struct  {
    u8 link_id;
    enum nl80211_band band;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt76_offchannel_cb_data {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_offchannel_notify(phy: *mut mt76_phy, offchannel: bool) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt76_rx_beacon_data {
    pub phy: *mut mt76_phy,
    pub bssid: *const u8,
}
...
#[no_mangle]
pub unsafe extern "C" fn mt76_rx_beacon(phy: *mut mt76_phy, skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_beacon_mon_check(phy: *mut mt76_phy) {
