...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x02_beacon.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt76x02_set_beacon_offsets(dev: *mut mt76x02_dev) {
    ...
    {
    let mut beacon_len: c_int = dev.beacon_ops.slot_size;
...
//
    ...
    mt76x02_mac_write_txwi(dev, txwi, skb, core::ptr::null_mut(), core::ptr::null_mut(), skb.len);
    ...
    struct sk_buff *skb)
    {
    let mut bcn_len: c_int = dev.beacon_ops.slot_size;
    let mut bcn_addr: c_int = MT_BEACON_BASE + (bcn_len * dev.beacon_data_count);
    ...
    let mut old_mask: u8 = dev.mt76.beacon_mask;
    ...
    {
    let mut timer_val: u32 = dev.mt76.beacon_int << 4;
    dev.tbtt_count++;
//
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_init_beacon_config(dev: *mut mt76x02_dev) {
