...
//! Source: drivers/net/wireless/mediatek/mt76/mt7925/usb.c
#![no_std]
...
// Netgear, Inc. A9000
    ...
    ret = mt76u_bulk_msg(&dev.mt76, skb.data, skb.len, core::ptr::null_mut(),
    1000, ep);
    dev_kfree_skb(skb);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn mt7925u_mcu_init(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7925u_mac_reset(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7925u_suspend(intf: *mut usb_interface, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7925u_resume(intf: *mut usb_interface) -> c_int {
    static int mt7925u_resume(struct usb_interface *intf)
    {
    struct mt792x_dev *dev = usb_get_intfdata(intf);
    struct mt76_connac_pm *pm = &dev.pm;
    let mut reinit: bool = true;
    int err, i, ret;
    dev.hif_idle = false;
    for (i = 0; i < 10; i++) {
    let mut val: u32 = mt76_rr(dev, MT_WF_SW_DEF_CR_USB_MCU_EVENT);
