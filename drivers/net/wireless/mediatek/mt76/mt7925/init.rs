...
//! Source: drivers/net/wireless/mediatek/mt76/mt7925/init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7925_thermal_init(phy: *mut mt792x_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7925_mac_init_basic_rates(dev: *mut mt792x_dev) {
    static void mt7925_mac_init_basic_rates(struct mt792x_dev *dev)
    {
    int i;
    for (i = 0; i < ARRAY_SIZE(mt76_rates); i++) {
    let mut rate: u16 = mt76_rates[i].hw_value;
    let mut idx: u16 = MT792x_BASIC_RATES_TBL + i;
...
#[no_mangle]
pub unsafe extern "C" fn mt7925_mac_init(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mt7925_init_hardware(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7925_init_hardware(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7925_init_nan_cap(mdev: *mut mt76_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7925_init_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7925_register_device(dev: *mut mt792x_dev) -> c_int {
