...
//! Source: drivers/net/wireless/mediatek/mt76/mt7925/pci.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7925e_init_reset(dev: *mut mt792x_dev) -> c_int {
    static int mt7925e_init_reset(struct mt792x_dev *dev)
    {
    return mt792x_wpdma_reset(dev, true);
    }
#[no_mangle]
unsafe extern "C" fn mt7925e_unregister_device(dev: *mut mt792x_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7925_reg_remap_restore(dev: *mut mt792x_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7925_reg_map_l1(dev: *mut mt792x_dev, addr: u32) -> u32 {
    static u32 mt7925_reg_map_l1(struct mt792x_dev *dev, u32 addr)
    {
    let mut offset: u32 = FIELD_GET(MT_HIF_REMAP_L1_OFFSET, addr);
    let mut base: u32 = FIELD_GET(MT_HIF_REMAP_L1_BASE, addr);
...
#[no_mangle]
unsafe extern "C" fn mt7925_reg_map_l2(dev: *mut mt792x_dev, addr: u32) -> u32 {
    static u32 mt7925_reg_map_l2(struct mt792x_dev *dev, u32 addr)
    {
    let mut base: u32 = FIELD_GET(MT_HIF_REMAP_L1_BASE, MT_HIF_REMAP_BASE_L2);
...
#[no_mangle]
unsafe extern "C" fn __mt7925_reg_addr(dev: *mut mt792x_dev, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt7925_rr(mdev: *mut mt76_dev, offset: u32) -> u32 {
    static u32 mt7925_rr(struct mt76_dev *mdev, u32 offset)
    {
    struct mt792x_dev *dev = container_of(mdev, struct mt792x_dev, mt76);
    let mut addr: u32 = __mt7925_reg_addr(dev, offset);
    return dev.bus_ops.rr(mdev, addr);
    }
#[no_mangle]
unsafe extern "C" fn mt7925_wr(mdev: *mut mt76_dev, offset: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn mt7925_rmw(mdev: *mut mt76_dev, offset: u32, mask: u32, val: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt7927_dma_init(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7928_dma_shdl_lite_init(dev: *mut mt792x_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7925_dma_init(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(is_mt7928(&dev->mt76): is_mt7925(&dev->mt76) ||) -> else {
...
#[no_mangle]
unsafe extern "C" fn mt7925_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7925_pci_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _mt7925_pci_resume(device: *mut device, restore: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7925_pci_shutdown(pdev: *mut pci_dev) {
    static void mt7925_pci_shutdown(struct pci_dev *pdev)
    {
    mt7925_pci_remove(pdev);
    }
#[no_mangle]
unsafe extern "C" fn mt7925_pci_resume(device: *mut device) -> c_int {
    static int mt7925_pci_resume(struct device *device)
    {
    return _mt7925_pci_resume(device, false);
    }
#[no_mangle]
unsafe extern "C" fn mt7925_pci_restore(device: *mut device) -> c_int {
