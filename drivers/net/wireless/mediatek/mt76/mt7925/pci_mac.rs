...
//! Source: drivers/net/wireless/mediatek/mt76/mt7925/pci_mac.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mt7925_tx_token_put(dev: *mut mt792x_dev) {
    ...
    mt7925_txwi_free(dev, txwi, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn mt7925e_mac_reset(dev: *mut mt792x_dev) -> c_int {
