...
//! Source: drivers/net/wireless/mediatek/mt76/mt7925/testmode.c
#![no_std]
...
pub const MT7925_EVT_RSP_LEN: c_int = 512;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt7925_tm_cmd {
    pub padding: [u8; 4],
    pub c: uni_cmd_testmode_ctrl,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt7925_tm_evt {
    pub param0: u32,
    pub param1: u32,
    pub __packed: },
...
#[no_mangle]
pub unsafe extern "C" fn if(MCU_UNI_CMD_TESTMODE_RX_STAT: *mut *mut *mut ((uint16_t )req->padding) ==) -> else {
