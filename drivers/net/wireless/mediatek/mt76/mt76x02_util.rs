...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x02_util.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_init_device(dev: *mut mt76x02_dev) -> c_int {
...
// total_flags = flags;
    ...
    let mut idx: c_int = wcid.idx;
    mt76x02_mac_wcid_set_drop(dev, idx, true);
    mt76x02_mac_wcid_setup(dev, idx, 0, core::ptr::null_mut());
    }
...
// vif is already set or idx is 8 for AP/Mesh/...
    ...
    rcu_assign_pointer(dev.mt76.wcid[mvif.group_wcid.idx], core::ptr::null_mut());
...
// MT76x0 GTK offloading does not work with more than one VIF
    ...
    return -EOPNOTSUPP;
    msta = sta ? (struct mt76x02_sta *)sta.drv_priv : core::ptr::null_mut();
    ...
    {
    struct mt76x02_dev *dev = hw.priv;
    let mut cw_min: u8 = 5, cw_max = 10, qid;
    u32 val;
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_set_tx_ackto(dev: *mut mt76x02_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_set_rts_threshold(hw: *mut ieee80211_hw, radio_idx: c_int, val: u32) -> c_int {
    ...
    let mut rate: ieee80211_tx_rate = {};
    if (!rates)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_remove_hdr_pad(skb: *mut sk_buff, len: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_config_mac_addr_list(dev: *mut mt76x02_dev) {
