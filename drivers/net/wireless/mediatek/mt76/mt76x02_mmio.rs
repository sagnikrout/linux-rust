...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x02_mmio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt76x02_pre_tbtt_tasklet(t: *mut tasklet_struct) {
...
// Prevent corrupt transmissions during update
    ...
    while ((skb = __skb_dequeue(&data.q)) != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn mt76x02e_pre_tbtt_enable(dev: *mut mt76x02_dev, en: bool) {
...
#[no_mangle]
unsafe extern "C" fn mt76x02e_beacon_enable(dev: *mut mt76x02_dev, en: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02e_init_beacon_config(dev: *mut mt76x02_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt76x02_process_tx_status_fifo(dev: *mut mt76x02_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt76x02_tx_worker(w: *mut mt76_worker) {
...
#[no_mangle]
unsafe extern "C" fn mt76x02_poll_tx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_dma_init(dev: *mut mt76x02_dev) -> c_int {
    ...
    MT_TX_RING_BASE, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_rx_poll_complete(mdev: *mut mt76_dev, q: enum mt76_rxq_id) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_irq_handler(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt76x02_dma_enable(dev: *mut mt76x02_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_dma_disable(dev: *mut mt76x02_dev) {
    void mt76x02_dma_disable(struct mt76x02_dev *dev)
    {
    let mut val: u32 = mt76_rr(dev, MT_WPDMA_GLO_CFG);
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_mac_start(dev: *mut mt76x02_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt76x02_tx_hang(dev: *mut mt76x02_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt76x02_reset_state(dev: *mut mt76x02_dev) {
    ...
    rcu_read_lock();
    ieee80211_iter_keys_rcu(dev.mt76.hw, core::ptr::null_mut(), mt76x02_key_sync, core::ptr::null_mut());
    rcu_read_unlock();
    ...
    if (!wcid)
    continue;
    rcu_assign_pointer(dev.mt76.wcid[i], core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mt76x02_watchdog_reset(dev: *mut mt76x02_dev) {
    static void mt76x02_watchdog_reset(struct mt76x02_dev *dev)
    {
    let mut mask: u32 = dev.mt76.mmio.irqmask;
    let mut restart: bool = dev.mt76.mcu_ops.mcu_restart;
    int i;
...
#[no_mangle]
unsafe extern "C" fn mt76x02_check_tx_hang(dev: *mut mt76x02_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_wdt_work(work: *mut work_struct) {
