...
//! Source: drivers/net/wireless/mediatek/mt76/mt792x_mac.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_mac_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_mac_set_timeing(phy: *mut mt792x_phy) {
    void mt792x_mac_set_timeing(struct mt792x_phy *phy)
    {
    let mut coverage_class: i16 = phy.coverage_class;
    ...
    let mut is_2ghz: bool = phy.mt76.chandef.chan.band == NL80211_BAND_2GHZ;
    let mut sifs: c_int = is_2ghz ? 10 : 16, offset;
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_mac_update_mib_stats(phy: *mut mt792x_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_mac_assoc_rssi(dev: *mut mt792x_dev, skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_mac_reset_counters(phy: *mut mt792x_phy) {
...
// reset airtime counters
    ...
    phy.noise = nf << 4;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: nf) -> else {
    else if (nf)
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_update_channel(mphy: *mut mt76_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_reset(mdev: *mut mt76_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_mac_init_band(dev: *mut mt792x_dev, band: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_pm_wake_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_pm_power_save_work(work: *mut work_struct) {
