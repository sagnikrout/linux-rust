...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x2/usb_mac.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt76x2u_mac_fixup_xtal(dev: *mut mt76x02_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2u_mac_reset(dev: *mut mt76x02_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2u_mac_stop(dev: *mut mt76x02_dev) -> c_int {
