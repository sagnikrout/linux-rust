...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x2/pci_init.c
#![no_std]
...
//
    ...
    offset = 0;
#[no_mangle]
pub unsafe extern "C" fn if(0x80: eep_val &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2_mac_reset(dev: *mut mt76x02_dev, hard: bool) -> c_int {
    ...
    mt76x02_mac_wcid_setup(dev, MT_VIF_WCID(i), i, core::ptr::null_mut());
    for (i = 0; i < 16; i++)
    for (k = 0; k < 4; k++)
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2_resume_device(dev: *mut mt76x02_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76x2_init_hardware(dev: *mut mt76x02_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2_stop_hardware(dev: *mut mt76x02_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2_cleanup(dev: *mut mt76x02_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2_register_device(dev: *mut mt76x02_dev) -> c_int {
