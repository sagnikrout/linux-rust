...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x2/phy.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2_apply_gain_adj(dev: *mut mt76x02_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2_phy_set_txpower(dev: *mut mt76x02_dev) {
    void mt76x2_phy_set_txpower(struct mt76x02_dev *dev)
    {
    let mut width: enum nl80211_chan_width = dev.mphy.chandef.width;
    struct ieee80211_channel *chan = dev.mphy.chandef.chan;
    struct mt76x2_tx_power_info txp;
    int txp_0, txp_1, delta = 0;
    let mut t: mt76x02_rate_power = {};
    int base_power, gain;
    mt76x2_get_power_info(dev, &txp, chan);
    if (width == NL80211_CHAN_WIDTH_40)
    delta = txp.delta_bw40;
#[no_mangle]
pub unsafe extern "C" fn if(NL80211_CHAN_WIDTH_80: width ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2_phy_tssi_compensate(dev: *mut mt76x02_dev) {
    void mt76x2_phy_tssi_compensate(struct mt76x02_dev *dev)
    {
    struct ieee80211_channel *chan = dev.mphy.chandef.chan;
    struct mt76x2_tx_power_info txp;
    let mut t: mt76x2_tssi_comp = {};
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2_phy_update_channel_gain(dev: *mut mt76x02_dev) {
    ...
    agc_35 = 0x11111516;
#[no_mangle]
pub unsafe extern "C" fn if(2: low_gain ==) -> else {
    else if (low_gain == 2)
    agc_35 = agc_37 = 0x08080808;
#[no_mangle]
pub unsafe extern "C" fn if(NL80211_CHAN_WIDTH_80: dev->mphy.chandef.width ==) -> else {
