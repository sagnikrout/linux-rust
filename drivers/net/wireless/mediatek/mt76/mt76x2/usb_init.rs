...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x2/usb_init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt76x2u_init_dma(dev: *mut mt76x02_dev) {
    static void mt76x2u_init_dma(struct mt76x02_dev *dev)
    {
    let mut val: u32 = mt76_rr(dev, MT_VEND_ADDR(CFG, MT_USB_U3DMA_CFG));
...
#[no_mangle]
unsafe extern "C" fn mt76x2u_power_on_rf_patch(dev: *mut mt76x02_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt76x2u_power_on_rf(dev: *mut mt76x02_dev, unit: c_int) {
    static void mt76x2u_power_on_rf(struct mt76x02_dev *dev, int unit)
    {
    let mut shift: c_int = unit ? 8 : 0;
    let mut val: u32 = (BIT(1) | BIT(3) | BIT(4) | BIT(5)) << shift;
// Enable RF BG
...
#[no_mangle]
unsafe extern "C" fn mt76x2u_power_on(dev: *mut mt76x02_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt76x2u_init_eeprom(dev: *mut mt76x02_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2u_init_hardware(dev: *mut mt76x02_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2u_register_device(dev: *mut mt76x02_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2u_stop_hw(dev: *mut mt76x02_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2u_cleanup(dev: *mut mt76x02_dev) {
