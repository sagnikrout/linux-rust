...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x2/usb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt76x2u_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn mt76x2u_resume(intf: *mut usb_interface) -> int __maybe_unused {
