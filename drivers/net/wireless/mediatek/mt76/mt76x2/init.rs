...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x2/init.c
#![no_std]
...
// convert to per-chain power for 2x2 devices
    ...
    {
    let mut val: u32 = mt76_rr(dev, MT_WLAN_FUN_CTRL);
    if (enable)
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2_reset_wlan(dev: *mut mt76x02_dev, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_write_mac_initvals(dev: *mut mt76x02_dev) {
