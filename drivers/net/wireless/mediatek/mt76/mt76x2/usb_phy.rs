...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x2/usb_phy.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2u_phy_calibrate(work: *mut work_struct) {
    ...
    let mut channel: u8 = chan.hw_value, bw, bw_index;
