...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x2/pci_phy.c
#![no_std]
...
//
    ...
    {
    struct ieee80211_channel *chan = dev.mphy.chandef.chan;
    let mut is_5ghz: bool = chan.band == NL80211_BAND_5GHZ;
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2_phy_set_antenna(dev: *mut mt76x02_dev) {
...
// enable mac DAC control
    ...
    let mut scan: bool = test_bit(MT76_SCANNING, &dev.mphy.state);
    let mut band: enum nl80211_band = chan.band;
    u8 channel;
    u32 ext_cca_chan[4] = {
...
// Enable LDPC Rx
    ...
    let mut val: u8 = mt76x02_eeprom_get(dev, MT_EE_BT_RCAL_RESULT);
    if (val != 0xff)
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2_phy_calibrate(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2_phy_start(dev: *mut mt76x02_dev) -> c_int {
