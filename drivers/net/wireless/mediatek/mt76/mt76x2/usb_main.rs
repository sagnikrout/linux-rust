...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x2/usb_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt76x2u_start(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76x2u_stop(hw: *mut ieee80211_hw, suspend: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x2u_set_channel(mphy: *mut mt76_phy) -> c_int {
