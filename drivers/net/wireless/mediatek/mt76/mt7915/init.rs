...
//! Source: drivers/net/wireless/mediatek/mt76/mt7915/init.c
#![no_std]
...
// state = phy->cdev_state;
    ...
    {
    struct mt7915_phy *phy = cdev.devdata;
    let mut throttling: u8 = MT7915_THERMAL_THROTTLE_MAX - state;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mt7915_thermal_get_temp(tz: *mut thermal_zone_device, temp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7915_unregister_thermal(phy: *mut mt7915_phy) {
...
#[no_mangle]
unsafe extern "C" fn mt7915_thermal_init(phy: *mut mt7915_phy) -> c_int {
...
pub const HW_TICK: c_int = 10;
    ...
    let mut pwr_delta: c_int = mt7915_eeprom_get_power_delta(dev, sband.band);
    struct mt76_power_limits limits;
    phy.sku_limit_en = true;
    phy.sku_path_en = true;
    for (i = 0; i < sband.n_channels; i++) {
    struct ieee80211_channel *chan = &sband.channels[i];
    let mut target_power: u32 = 0;
    int j;
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_init_txpower(phy: *mut mt7915_phy) {
    ...
    mt7915_mcu_rdd_background_enable(phy, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_mac_init(dev: *mut mt7915_dev) {
    void mt7915_mac_init(struct mt7915_dev *dev)
    {
    int i;
    let mut rx_len: u32 = is_mt7915(&dev.mt76) ? 0x400 : 0x680;
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_txbf_init(dev: *mut mt7915_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7915_init_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_wfsys_reset(dev: *mut mt7915_dev) {
    void mt7915_wfsys_reset(struct mt7915_dev *dev)
    {

    if (is_mt7915(&dev.mt76)) {
    let mut val: u32 = MT_TOP_PWR_KEY | MT_TOP_PWR_SW_PWR_ON | MT_TOP_PWR_PWR_ON;
...
#[no_mangle]
unsafe extern "C" fn mt7915_band_config(dev: *mut mt7915_dev) -> bool {
    static bool mt7915_band_config(struct mt7915_dev *dev)
    {
    let mut ret: bool = true;
    dev.phy.mt76.band_idx = 0;
    if (is_mt798x(&dev.mt76)) {
    let mut sku: u32 = mt7915_check_adie(dev, true);
//
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_set_stream_vht_txbf_caps(phy: *mut mt7915_phy) {
...
// cap |= IEEE80211_VHT_CAP_SU_BEAMFORMER_CAPABLE |
    ...
    let mut sts: c_int = hweight8(phy.mt76.chainmask);
    u8 c, sts_160 = sts;
...
// the maximum cap is 4 x 3, (Nr, Nc) = (3, 2)
    ...
    let mut mcs_map_160: u16 = 0;
    u8 nss_160;
    if (!is_mt7915(&dev.mt76))
    nss_160 = nss;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !dev->dbdc_support) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: nss_160) -> else {
    else if (nss_160)
    he_cap_elem.phy_cap_info[0] =
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_set_stream_he_caps(phy: *mut mt7915_phy) {
...
#[no_mangle]
unsafe extern "C" fn mt7915_unregister_ext_phy(dev: *mut mt7915_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7915_stop_hardware(dev: *mut mt7915_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_register_device(dev: *mut mt7915_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_unregister_device(dev: *mut mt7915_dev) {
