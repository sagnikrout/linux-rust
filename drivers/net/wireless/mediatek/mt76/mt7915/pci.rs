...
//! Source: drivers/net/wireless/mediatek/mt76/mt7915/pci.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7915_put_hif2(hif: *mut mt7915_hif) {
    ...
    hif_idx++;
    tmp_pdev = pci_get_device(PCI_VENDOR_ID_MEDIATEK, 0x7916, core::ptr::null_mut());
    if (!tmp_pdev) {
    tmp_pdev = pci_get_device(PCI_VENDOR_ID_MEDIATEK, 0x790a, core::ptr::null_mut());
    if (!tmp_pdev)
...
#[no_mangle]
unsafe extern "C" fn mt7915_pci_hif2_probe(pdev: *mut pci_dev) -> c_int {
    ...
    {
    struct mt7915_hif *hif2 = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mt7915_hif_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7915_pci_remove(pdev: *mut pci_dev) {
