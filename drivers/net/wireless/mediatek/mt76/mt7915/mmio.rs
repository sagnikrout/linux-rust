...
//! Source: drivers/net/wireless/mediatek/mt76/mt7915/mmio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7915_reg_map_l1(dev: *mut mt7915_dev, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt7915_reg_map_l2(dev: *mut mt7915_dev, addr: u32) -> u32 {
...
// use read to push write
    ...
    let mut ofs: u32 = is_mt798x(&dev.mt76) ? 0x400000 : 0;
...
#[no_mangle]
unsafe extern "C" fn __mt7915_reg_addr(dev: *mut mt7915_dev, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __mt7915_reg_remap_addr(dev: *mut mt7915_dev, addr: u32) -> u32 {
...
// CONN_INFRA: covert to phyiscal addr and use layer 1 remap
    ...
    size_t len)
    {
    let mut addr: u32 = __mt7915_reg_addr(dev, offset);
    if (addr) {
...
#[no_mangle]
unsafe extern "C" fn mt7915_rr(mdev: *mut mt76_dev, offset: u32) -> u32 {
    static u32 mt7915_rr(struct mt76_dev *mdev, u32 offset)
    {
    struct mt7915_dev *dev = container_of(mdev, struct mt7915_dev, mt76);
    let mut addr: u32 = __mt7915_reg_addr(dev, offset), val;
    if (addr)
...
#[no_mangle]
unsafe extern "C" fn mt7915_wr(mdev: *mut mt76_dev, offset: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn mt7915_rmw(mdev: *mut mt76_dev, offset: u32, mask: u32, val: u32) -> u32 {
    ...
    {
    let mut idx: c_int = le16_to_cpu(stats.wlan_idx);
...
#[no_mangle]
unsafe extern "C" fn mt7915_mmio_wed_reset(wed: *mut mtk_wed_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7915_irq_tasklet(t: *mut tasklet_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_irq_handler(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt7915_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mt7915_exit() -> void __exit {
