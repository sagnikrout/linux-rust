...
//! Source: drivers/net/wireless/mediatek/mt76/mt7915/mac.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt7915_dfs_radar_spec {
    pub pulse_th: mt7915_dfs_pulse,
    pub radar_pattern: [mt7915_dfs_pattern; 16],
}
