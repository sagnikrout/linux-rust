...
//! Source: drivers/net/wireless/mediatek/mt76/mt7915/soc.c
#![no_std]
...
pub const MT7981_CON_INFRA_VERSION: c_uint = 0x02090000;
pub const MT7986_CON_INFRA_VERSION: c_uint = 0x02070000;
// INFRACFG
pub const MT_INFRACFG_CONN2AP_SLPPROT: c_uint = 0x0d0;
pub const MT_INFRACFG_AP2CONN_SLPPROT: c_uint = 0x0d4;

// TOP POS
pub const MT_TOP_POS_FAST_CTRL: c_uint = 0x114;

pub const MT_TOP_POS_SKU: c_uint = 0x21c;
...
#[no_mangle]
pub unsafe extern "C" fn mt76_wmac_spi_lock(dev: *mut mt7915_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_wmac_spi_unlock(dev: *mut mt7915_dev) {
    static inline void mt76_wmac_spi_unlock(struct mt7915_dev *dev)
    {
    mt76_wr(dev, MT_SEMA_RFSPI_RELEASE, 1);
    }
#[no_mangle]
unsafe extern "C" fn mt76_wmac_rmw(base: *mut void __iomem, offset: u32, mask: u32, val: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt798x_wmac_check_adie_type(dev: *mut mt7915_dev) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_consys_reset(dev: *mut mt7915_dev, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_gpio_setup(dev: *mut mt7915_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_consys_lockup(dev: *mut mt7915_dev, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt798x_wmac_coninfra_check(dev: *mut mt7915_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt798x_wmac_coninfra_setup(dev: *mut mt7915_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt798x_wmac_sku_setup(dev: *mut mt7915_dev, adie_type: *mut u32) -> c_int {
    static int mt798x_wmac_sku_setup(struct mt7915_dev *dev, u32 *adie_type)
    {
    int ret;
    let mut adie_main: u32 = 0, adie_ext = 0;
...
#[no_mangle]
pub unsafe extern "C" fn mt7986_adie_idx(adie: u8, adie_type: u32) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn is_7975(dev: *mut mt7915_dev, adie: u8, adie_type: u32) -> bool {
    static inline bool is_7975(struct mt7915_dev *dev, u8 adie, u32 adie_type)
    {
    return mt7986_adie_idx(adie, adie_type) == 0x7975;
    }
#[no_mangle]
pub unsafe extern "C" fn is_7976(dev: *mut mt7915_dev, adie: u8, adie_type: u32) -> bool {
    static inline bool is_7976(struct mt7915_dev *dev, u8 adie, u32 adie_type)
    {
    return mt7986_adie_idx(adie, adie_type) == 0x7976;
    }
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_adie_thermal_cal(dev: *mut mt7915_dev, adie: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: FIELD_GET(MT_ADIE_XO_TRIM_EN_MASK, _arg: data)) -> else {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_adie_xtal_trim_7976(dev: *mut mt7915_dev, adie: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt798x_wmac_adie_patch_7976(dev: *mut mt7915_dev, adie: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_adie_xtal_trim_7975(dev: *mut mt7915_dev, adie: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_adie_patch_7975(dev: *mut mt7915_dev, adie: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_adie_cfg(dev: *mut mt7915_dev, adie: u8, adie_type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_subsys_pll_initial(dev: *mut mt7915_dev, band: u8) {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_subsys_setting(dev: *mut mt7915_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_bus_timeout(dev: *mut mt7915_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_clock_enable(dev: *mut mt7915_dev, adie_type: u32) {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_top_wfsys_wakeup(dev: *mut mt7915_dev, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_wm_enable(dev: *mut mt7915_dev, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_wfsys_poweron(dev: *mut mt7915_dev, enable: bool) -> c_int {
    static int mt7986_wmac_wfsys_poweron(struct mt7915_dev *dev, bool enable)
    {
    let mut mask: u32 = MT_TOP_PWR_EN_MASK | MT_TOP_PWR_KEY_MASK;
    u32 cur;
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_wfsys_setting(dev: *mut mt7915_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_wfsys_set_timeout(dev: *mut mt7915_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_sku_update(dev: *mut mt7915_dev, adie_type: u32) -> c_int {
    ...
    val = 0xf;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_7975(dev, _arg: 0, is_7975(dev: adie_type) &&, _arg: 1, _arg: adie_type)) -> else {
    else if (is_7975(dev, 0, adie_type) && is_7975(dev, 1, adie_type))
    val = 0xd;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_7976(dev, _arg: 0, _arg: adie_type)) -> else {
    else if (is_7976(dev, 0, adie_type))
    val = 0x7;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_7975(dev, _arg: 1, _arg: adie_type)) -> else {
    else if (is_7975(dev, 1, adie_type))
    val = 0x8;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_7976(dev, _arg: 1, _arg: adie_type)) -> else {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_subsys_powerup(dev: *mut mt7915_dev, adie_type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7986_wmac_wfsys_powerup(dev: *mut mt7915_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7986_wmac_enable(dev: *mut mt7915_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7986_wmac_disable(dev: *mut mt7915_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt798x_wmac_init(dev: *mut mt7915_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: clk_prepare_enable(mcu_clk)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: clk_prepare_enable(ap_conn_clk)) -> else {
...
#[no_mangle]
unsafe extern "C" fn mt798x_wmac_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt798x_wmac_remove(pdev: *mut platform_device) {
