...
//! Source: drivers/net/wireless/mediatek/mt76/mt7915/dma.c
#![no_std]
...
// Copyright (C) 2020 MediaTek Inc.
    ...
    struct mtk_wed_device *wed = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mt7915_poll_tx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7915_dma_config(dev: *mut mt7915_dev) {
...
#[no_mangle]
unsafe extern "C" fn __mt7915_dma_prefetch(dev: *mut mt7915_dev, ofs: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_dma_prefetch(dev: *mut mt7915_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7915_dma_disable(dev: *mut mt7915_dev, rst: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_dma_start(dev: *mut mt7915_dev, reset: bool, wed_reset: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7915_dma_enable(dev: *mut mt7915_dev, reset: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_dma_init(dev: *mut mt7915_dev, phy2: *mut mt7915_phy) -> c_int {
    ...
    if (!is_mt798x(mdev)) {
    let mut wed_control_rx1: u8 = is_mt7915(mdev) ? 1 : 2;
    mt76_set(dev, MT_WFDMA_HOST_CONFIG,
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_dma_reset(dev: *mut mt7915_dev, force: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_dma_cleanup(dev: *mut mt7915_dev) {
