...
//! Source: drivers/net/wireless/mediatek/mt76/mt7915/debugfs.c
#![no_std]
...
pub const FW_BIN_LOG_MAGIC: c_uint = 0x44e98caf;
// global debugfs
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hw_queue_map {
...
// WARNING: trigger firmware crash
    ...
    ssize_t ret;
    let mut bufsz: static size_t = 1024;
...
// SER statistics
    ...
    {
pub const RADAR_MAIN_CHAIN: c_int = 1;
pub const RADAR_BACKGROUND: c_int = 2;
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(fops_radar_trigger, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn mt7915_muru_stats_show(file: *mut seq_file, data: *mut c_void) -> c_int {
...
// is_global = 1;
    ...
    1500, 512, &relay_cb, core::ptr::null_mut());
    if (!dev.relay_fwlog)
    return -ENOMEM;
...
// Tx amsdu info
    ...
    for (ac = 0; ac < 4; ac++) {
    u32 qlen, ctrl, val;
    let mut idx: u32 = msta.wcid.idx >> 5;
    let mut offs: u8 = msta.wcid.idx & GENMASK(4, 0);
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_init_debugfs(phy: *mut mt7915_phy) -> c_int {
    int mt7915_init_debugfs(struct mt7915_phy *phy)
    {
    struct mt7915_dev *dev = phy.dev;
    let mut ext_phy: bool = phy != &dev.phy;
    struct dentry *dir;
    dir = mt76_register_debugfs_fops(phy.mt76, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_debugfs_rx_fw_monitor(dev: *mut mt7915_dev, data: *const c_void, len: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7915_debugfs_rx_log(dev: *mut mt7915_dev, data: *const c_void, len: c_int) -> bool {
    bool mt7915_debugfs_rx_log(struct mt7915_dev *dev, const void *data, int len)
    {
    if (get_unaligned_le32(data) != FW_BIN_LOG_MAGIC)
    return false;
    if (dev.relay_fwlog)
    mt7915_debugfs_write_fwlog(dev, core::ptr::null_mut(), 0, data, len);
    return true;
    }
