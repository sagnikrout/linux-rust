...
//! Source: drivers/net/wireless/mediatek/mt76/mt7615/debugfs.c
#![no_std]
...
// val = mt76_rr(dev, dev->mt76.debugfs_reg);
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(fops_radar_pattern, core::ptr::null_mut(),
    mt7615_radar_pattern_set, "%lld\n");
#[no_mangle]
unsafe extern "C" fn mt7615_config(data: *mut c_void, val: u64) -> c_int {
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(fops_config, core::ptr::null_mut(), mt7615_config, "%lld\n");
    static int
...
// val = dev->fw_debug;
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(fops_reset_test, core::ptr::null_mut(),
    ...
    let mut reg: u32 = is_mt7663(&dev.mt76) ? MT_MIB_ARNG(0) : MT_AGG_ASRCR0;
    int bound[7], i, range;
    if (!phy)
    return;
    ...
    let mut acs: c_int = i / MT7615_MAX_WMM_SETS;
    u32 ctrl, val, qlen = 0;
...
// val = mt7615_rf_rr(dev, dev->debugfs_rf_wf, dev->debugfs_rf_reg);
    ...
    let mut len: u32 = 32 * ((ETH_ALEN * 3) + 4) + 1;
    u8 addr[ETH_ALEN];
    char *buf;
    let mut ofs: c_int = 0;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_init_debugfs(dev: *mut mt7615_dev) -> c_int {
