...
//! Source: drivers/net/wireless/mediatek/mt76/mt7615/dma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7615_poll_tx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7615_poll_rx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_wait_pdma_busy(dev: *mut mt7615_dev) -> c_int {
    int mt7615_wait_pdma_busy(struct mt7615_dev *dev)
    {
    struct mt76_dev *mdev = &dev.mt76;
    if (!is_mt7663(mdev)) {
    let mut mask: u32 = MT_PDMA_TX_BUSY | MT_PDMA_RX_BUSY;
    let mut reg: u32 = mt7615_reg_map(dev, MT_PDMA_BUSY);
...
#[no_mangle]
unsafe extern "C" fn mt7622_dma_sched_init(dev: *mut mt7615_dev) {
    static void mt7622_dma_sched_init(struct mt7615_dev *dev)
    {
    let mut reg: u32 = mt7615_reg_map(dev, MT_DMASHDL_BASE);
    int i;
...
#[no_mangle]
unsafe extern "C" fn mt7663_dma_sched_init(dev: *mut mt7615_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_dma_start(dev: *mut mt7615_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_dma_init(dev: *mut mt7615_dev) -> c_int {
    int mt7615_dma_init(struct mt7615_dev *dev)
    {
    let mut rx_ring_size: c_int = MT7615_RX_RING_SIZE;
    u32 mask;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_dma_cleanup(dev: *mut mt7615_dev) {
