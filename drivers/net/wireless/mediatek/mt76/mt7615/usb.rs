...
//! Source: drivers/net/wireless/mediatek/mt76/mt7615/usb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7663u_rr(dev: *mut mt76_dev, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt7663u_wr(dev: *mut mt76_dev, addr: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn mt7663u_stop(hw: *mut ieee80211_hw, suspend: bool) {
...
#[no_mangle]
unsafe extern "C" fn mt7663u_cleanup(dev: *mut mt7615_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7663u_init_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mt7663u_disconnect(usb_intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn mt7663u_suspend(intf: *mut usb_interface, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7663u_resume(intf: *mut usb_interface) -> c_int {
