...
//! Source: drivers/net/wireless/mediatek/mt76/mt7615/sdio_mcu.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7663s_mcu_init_sched(dev: *mut mt7615_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mt7663s_mcu_drv_pmctrl(dev: *mut mt7615_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7663s_mcu_drv_pmctrl(dev: *mut mt7615_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7663s_mcu_fw_pmctrl(dev: *mut mt7615_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7663s_mcu_init(dev: *mut mt7615_dev) -> c_int {
