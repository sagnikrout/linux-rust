...
//! Source: drivers/net/wireless/mediatek/mt76/mt7615/pci.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7615_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7615_pci_suspend(pdev: *mut pci_dev, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7615_pci_resume(pdev: *mut pci_dev) -> c_int {
