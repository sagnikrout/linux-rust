...
//! Source: drivers/net/wireless/mediatek/mt76/mt7615/mmio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7615_irq_handler(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt7615_irq_tasklet(t: *mut tasklet_struct) {
...
#[no_mangle]
unsafe extern "C" fn __mt7615_reg_addr(dev: *mut mt7615_dev, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt7615_rr(mdev: *mut mt76_dev, offset: u32) -> u32 {
    static u32 mt7615_rr(struct mt76_dev *mdev, u32 offset)
    {
    struct mt7615_dev *dev = container_of(mdev, struct mt7615_dev, mt76);
    let mut addr: u32 = __mt7615_reg_addr(dev, offset);
    return dev.bus_ops.rr(mdev, addr);
    }
#[no_mangle]
unsafe extern "C" fn mt7615_wr(mdev: *mut mt76_dev, offset: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn mt7615_rmw(mdev: *mut mt76_dev, offset: u32, mask: u32, val: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt7615_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mt7615_exit() -> void __exit {
