...
//! Source: drivers/net/wireless/mediatek/mt76/mt7615/usb_mcu.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mt7663u_mcu_power_on(dev: *mut mt7615_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7663u_mcu_init(dev: *mut mt7615_dev) -> c_int {
