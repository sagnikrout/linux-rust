...
//! Source: drivers/net/wireless/mediatek/mt76/mt7615/usb_sdio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7663_usb_sdio_rate_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7663_usb_sdio_tx_status_data(mdev: *mut mt76_dev, update: *mut u8) -> bool {
    ...
    {
    let mut headroom: c_uint = MT_USB_TXD_SIZE;
    if (mt76_is_usb(mdev))
...
#[no_mangle]
unsafe extern "C" fn mt7663u_dma_sched_init(dev: *mut mt7615_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7663_usb_sdio_init_hardware(dev: *mut mt7615_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7663_usb_sdio_register_device(dev: *mut mt7615_dev) -> c_int {
