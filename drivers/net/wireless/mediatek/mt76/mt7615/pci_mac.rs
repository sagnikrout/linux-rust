...
//! Source: drivers/net/wireless/mediatek/mt76/mt7615/pci_mac.c
#![no_std]
...
//
    ...
    let mut nbuf: c_int = tx_info.nbuf - 1;
    int i;
    for (i = 0; i < nbuf; i++) {
...
// rept_wds_wcid = 0xff;
    ...
    tx_info.skb = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn mt7615_dma_reset(dev: *mut mt7615_dev) {
    ...
    {
    let mut reg: u32 = MT_MCU_INT_EVENT;
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_mac_reset_work(work: *mut work_struct) {
    ...
    phy2 = ext_phy ? ext_phy.priv : core::ptr::null_mut();
