...
//! Source: drivers/net/wireless/mediatek/mt76/mt7615/init.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_thermal_init(dev: *mut mt7615_dev) -> c_int {
...
// disable TDLS filtering
    ...
    dev.ops.hw_scan = core::ptr::null_mut();
    dev.ops.cancel_hw_scan = core::ptr::null_mut();
    dev.ops.sched_scan_start = core::ptr::null_mut();
    dev.ops.sched_scan_stop = core::ptr::null_mut();
    dev.ops.set_rekey_data = core::ptr::null_mut();
    dev.ops.remain_on_channel = core::ptr::null_mut();
    dev.ops.cancel_remain_on_channel = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_wait_for_mcu_init(dev: *mut mt7615_dev) -> bool {
    ...
    let mut band: enum nl80211_band = sband.band;
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_init_work(dev: *mut mt7615_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_reg_map(dev: *mut mt7615_dev, addr: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_register_ext_phy(dev: *mut mt7615_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_unregister_ext_phy(dev: *mut mt7615_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_init_device(dev: *mut mt7615_dev) {
