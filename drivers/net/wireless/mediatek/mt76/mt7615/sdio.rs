...
//! Source: drivers/net/wireless/mediatek/mt76/mt7615/sdio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7663s_txrx_worker(w: *mut mt76_worker) {
...
#[no_mangle]
unsafe extern "C" fn mt7663s_init_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mt7663s_parse_intr(dev: *mut mt76_dev, intr: *mut mt76s_intr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7663s_remove(func: *mut sdio_func) {
...
#[no_mangle]
unsafe extern "C" fn mt7663s_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7663s_resume(dev: *mut device) -> c_int {
