...
//! Source: drivers/net/wireless/mediatek/mt76/mt7615/main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7615_dev_running(dev: *mut mt7615_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt7615_start(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7615_stop(hw: *mut ieee80211_hw, suspend: bool) {
...
// ap uses hw bssid 0 and ext bssid
    ...
    mt7615_mutex_acquire(dev);
    mt7615_mcu_add_bss_info(phy, vif, core::ptr::null_mut(), false);
    mt7615_mcu_sta_add(phy, vif, core::ptr::null_mut(), false);
    mt76_testmode_reset(phy.mt76, true);
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_set_channel(mphy: *mut mt76_phy) -> c_int {
    ...
    let mut timeout: c_ulong = mt7615_get_macwork_timeout(dev);
...
// fall back to sw encryption for unsupported ciphers
    ...
    mt7615_mcu_add_bss_info(phy, vif, core::ptr::null_mut(), true);
    }
    if (cmd == SET_KEY)
// wcid_keyidx = idx;
    else {
...
#[no_mangle]
unsafe extern "C" fn mt7615_config(hw: *mut ieee80211_hw, radio_idx: c_int, changed: u32) -> c_int {
    static int mt7615_config(struct ieee80211_hw *hw, int radio_idx, u32 changed)
    {
    struct mt7615_dev *dev = mt7615_hw_dev(hw);
    struct mt7615_phy *phy = mt7615_hw_phy(hw);
    let mut band: bool = phy != &dev.phy;
    let mut ret: c_int = 0;
...
// total_flags = flags;
    ...
    mt7615_mcu_add_bss_info(phy, vif, core::ptr::null_mut(), true);
    mt7615_mcu_sta_add(phy, vif, core::ptr::null_mut(), true);
    ...
    mt7615_mac_set_rates(phy, msta, core::ptr::null_mut(), msta.rates);
    mt76_connac_pm_unref(phy.mt76, &dev.pm);
    }
    spin_unlock_bh(&dev.mt76.lock);
    }
#[no_mangle]
pub unsafe extern "C" fn mt7615_tx_worker(w: *mut mt76_worker) {
    ...
    struct mt7615_sta *msta = core::ptr::null_mut();
    int qid;
    if (control.sta) {
    ...
    let mut idx: u16 = mvif.mt76.omac_idx;
    u32 reg;
...
// TSF software adjust
    ...
    mt7615_mcu_set_roc(phy, vif, core::ptr::null_mut(), 0);
    }
#[no_mangle]
pub unsafe extern "C" fn mt7615_roc_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_roc_timer(timer: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_scan_work(work: *mut work_struct) {
...
// fall-back to sw-scan
    ...
    cancel_work_sync(&phy.roc_work);
    mt7615_mutex_acquire(phy.dev);
    err = mt7615_mcu_set_roc(phy, vif, core::ptr::null_mut(), 0);
    mt7615_mutex_release(phy.dev);
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn mt7615_resume(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7615_set_wakeup(hw: *mut ieee80211_hw, enabled: bool) {
