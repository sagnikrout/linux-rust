...
//! Source: drivers/net/wireless/mediatek/mt76/mt7615/pci_init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7615_pci_init_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mt7615_init_hardware(dev: *mut mt7615_dev) -> c_int {
    static int mt7615_init_hardware(struct mt7615_dev *dev)
    {
    let mut addr: u32 = mt7615_reg_map(dev, MT_EFUSE_BASE);
    int ret, idx;
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_register_device(dev: *mut mt7615_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7615_unregister_device(dev: *mut mt7615_dev) {
