...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x02_usb_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt76x02u_remove_dma_hdr(skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02u_tx_complete_skb(mdev: *mut mt76_dev, e: *mut mt76_queue_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02u_mac_start(dev: *mut mt76x02_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02u_skb_dma_info(skb: *mut sk_buff, port: c_int, flags: u32) -> c_int {
...
//
    ...
    let mut ampdu: bool = IEEE80211_SKB_CB(tx_info.skb).flags & IEEE80211_TX_CTL_AMPDU;
    enum mt76_qsel qsel;
    u32 flags;
    int err;
...
pub const PRE_TBTT_USEC: c_int = 8000;
...
//
pub const N_BCN_SLOTS: c_int = 5;
#[no_mangle]
unsafe extern "C" fn mt76x02u_start_pre_tbtt_timer(dev: *mut mt76x02_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt76x02u_restart_pre_tbtt_timer(dev: *mut mt76x02_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt76x02u_stop_pre_tbtt_timer(dev: *mut mt76x02_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt76x02u_pre_tbtt_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mt76x02u_pre_tbtt_interrupt(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn mt76x02u_pre_tbtt_enable(dev: *mut mt76x02_dev, en: bool) {
...
#[no_mangle]
unsafe extern "C" fn mt76x02u_beacon_enable(dev: *mut mt76x02_dev, en: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02u_init_beacon_config(dev: *mut mt76x02_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02u_exit_beacon_config(dev: *mut mt76x02_dev) {
