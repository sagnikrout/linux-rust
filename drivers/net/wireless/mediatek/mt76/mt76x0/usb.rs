...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x0/usb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt76x0_init_usb_dma(dev: *mut mt76x02_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt76x0u_cleanup(dev: *mut mt76x02_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt76x0u_stop(hw: *mut ieee80211_hw, suspend: bool) {
...
#[no_mangle]
unsafe extern "C" fn mt76x0u_start(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76x0u_init_hardware(dev: *mut mt76x02_dev, reset: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76x0u_register_device(dev: *mut mt76x02_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76x0_disconnect(usb_intf: *mut usb_interface) {
    static void mt76x0_disconnect(struct usb_interface *usb_intf)
    {
    struct mt76x02_dev *dev = usb_get_intfdata(usb_intf);
    let mut initialized: bool = test_bit(MT76_STATE_INITIALIZED, &dev.mphy.state);
    if (!initialized)
    return;
...
#[no_mangle]
unsafe extern "C" fn mt76x0_resume(usb_intf: *mut usb_interface) -> int __maybe_unused {
