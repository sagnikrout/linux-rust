...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x0/pci.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt76x0e_start(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76x0e_stop_hw(dev: *mut mt76x02_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt76x0e_stop(hw: *mut ieee80211_hw, suspend: bool) {
...
#[no_mangle]
unsafe extern "C" fn mt76x0e_init_hardware(dev: *mut mt76x02_dev, resume: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76x0e_register_device(dev: *mut mt76x02_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76x0e_cleanup(dev: *mut mt76x02_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt76x0e_suspend(pdev: *mut pci_dev, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76x0e_resume(pdev: *mut pci_dev) -> c_int {
