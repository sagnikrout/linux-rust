...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x0/usb_mcu.c
#![no_std]
...
pub const MCU_FW_URB_MAX_PAYLOAD: c_uint = 0x38f8;
...
#[no_mangle]
unsafe extern "C" fn mt76x0u_load_firmware(dev: *mut mt76x02_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x0u_mcu_init(dev: *mut mt76x02_dev) -> c_int {
