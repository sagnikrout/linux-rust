...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x02_txrx.c
#![no_std]
...
//
    ...
    let mut band: enum nl80211_band = dev.mphy.chandef.chan.band;
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_tx_get_txpwr_adj(dev: *mut mt76x02_dev, txpwr: i8, max_txpwr_adj: i8) -> i8 {
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(0: txpwr >=) -> else {
    else if (txpwr >= 0)
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_tx_set_txpwr_auto(dev: *mut mt76x02_dev, txpwr: i8) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_tx_status_data(mdev: *mut mt76_dev, update: *mut u8) -> bool {
