...
//! Source: drivers/net/wireless/mediatek/mt76/tx.c
#![no_std]
...
//
    ...
    let mut rs: ieee80211_rate_status = {};
    ...
    struct mt76_tx_cb *cb = mt76_tx_skb_cb(skb);
    let mut done: u8 = MT_TX_CB_DMA_DONE | MT_TX_CB_TXS_DONE;
    flags |= cb.flags;
    cb.flags = flags;
    if ((flags & done) != done)
    return;
...
// ieee80211_get_qos_ctl(hdr) |= IEEE80211_QOS_CTL_EOSP;
    ...
    __mt76_tx_queue_skb(phy, MT_TXQ_PSD, skb, wcid, sta, core::ptr::null_mut());
    }
    void
    ...
    struct mt76_phy *phy = hw.priv;
    struct mt76_dev *dev = phy.dev;
    struct sk_buff *last_skb = core::ptr::null_mut();
    ...
    struct mt76_dev *dev = phy.dev;
    struct ieee80211_txq *txq = mtxq_to_txq(mtxq);
    let mut qid: enum mt76_txq_id = mt76_txq_get_qid(txq);
    struct ieee80211_tx_info *info;
    struct sk_buff *skb;
    let mut n_frames: c_int = 1;
    ...
    let mut agg_ssn: u16 = mtxq.agg_ssn;
    let mut tid: u8 = txq.tid;
    mtxq.send_bar = false;
...
#[no_mangle]
pub unsafe extern "C" fn mt76_txq_schedule(phy: *mut mt76_phy, qid: enum mt76_txq_id) {
    ...
    let mut ret: c_int = 0;
    spin_lock(&head.lock);
    while ((skb = skb_peek(head)) != core::ptr::null_mut()) {
    struct ieee80211_hdr *hdr = (struct ieee80211_hdr *)skb.data;
    struct ieee80211_tx_info *info = IEEE80211_SKB_CB(skb);
    ...
    sta = wcid_to_sta(wcid);
    spin_lock(&q.lock);
    __mt76_tx_queue_skb(phy, qid, skb, wcid, sta, core::ptr::null_mut());
    dev.queue_ops.kick(dev, q);
    spin_unlock(&q.lock);
    spin_lock(&head.lock);
    }
...
#[no_mangle]
pub unsafe extern "C" fn mt76_txq_schedule_pending(phy: *mut mt76_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_txq_schedule_all(phy: *mut mt76_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_tx_worker_run(dev: *mut mt76_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_tx_worker(w: *mut mt76_worker) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_wake_tx_queue(hw: *mut ieee80211_hw, txq: *mut ieee80211_txq) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_ac_to_hwq(ac: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_skb_adjust_pad(skb: *mut sk_buff, pad: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __mt76_set_tx_blocked(dev: *mut mt76_dev, blocked: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_token_consume(dev: *mut mt76_dev, ptxwi: *mut mt76_txwi_cache) -> c_int {
