...
//! Source: drivers/net/wireless/mediatek/mt76/mt792x_dma.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_irq_handler(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_irq_tasklet(data: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_rx_poll_complete(mdev: *mut mt76_dev, q: enum mt76_rxq_id) {
...
#[no_mangle]
pub unsafe extern "C" fn if(MT_RXQ_MCU_WA: q ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mt7925_dma_prefetch_setup(dev: *mut mt792x_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7925_wfdma_setup(dev: *mut mt792x_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7927_dma_prefetch_setup(dev: *mut mt792x_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7927_wfdma_setup(dev: *mut mt792x_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7928_dma_prefetch_setup(dev: *mut mt792x_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7928_wfdma_setup(dev: *mut mt792x_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt792x_dma_prefetch(dev: *mut mt792x_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_dma_enable(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_mt7927(&dev->mt76)) -> else {
    else if (is_mt7927(&dev.mt76))
    mt7927_wfdma_setup(dev);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_mt7925(&dev->mt76)) -> else {
    else if (is_mt7925(&dev.mt76))
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_wpdma_reset(dev: *mut mt792x_dev, force: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_wpdma_reinit_cond(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_dma_disable(dev: *mut mt792x_dev, force: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_dma_cleanup(dev: *mut mt792x_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_poll_tx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_poll_rx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7927_sema_status_read(dev: *mut mt792x_dev, addr: u32) {
...
#[no_mangle]
unsafe extern "C" fn mt7927_wfsys_reset(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt792x_wfsys_reset_default(dev: *mut mt792x_dev) -> c_int {
    static int mt792x_wfsys_reset_default(struct mt792x_dev *dev)
    {
    let mut addr: u32 = is_connac2(&dev.mt76) ? 0x18000140 : 0x7c000140;
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_wfsys_reset(dev: *mut mt792x_dev) -> c_int {
