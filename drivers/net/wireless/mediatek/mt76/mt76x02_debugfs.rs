...
//! Source: drivers/net/wireless/mediatek/mt76/mt76x02_debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn read_txpower(file: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_agc(file: *mut seq_file, data: *mut c_void) -> c_int {
    ...
    let mut region: enum nl80211_dfs_regions = dev.mt76.region;
...
// val = dev->ed_monitor_enabled;
    ...
    "%lld\n");
#[no_mangle]
unsafe extern "C" fn mt76x02_read_rate_txpower(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt76x02_init_debugfs(dev: *mut mt76x02_dev) {
