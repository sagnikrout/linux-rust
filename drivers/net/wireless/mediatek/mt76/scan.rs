...
//! Source: drivers/net/wireless/mediatek/mt76/scan.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt76_scan_complete(dev: *mut mt76_dev, abort: bool) {
...
//
    ...
    let mut offchannel: bool = phy.offchannel;
...
#[no_mangle]
pub unsafe extern "C" fn mt76_abort_scan(dev: *mut mt76_dev) {
    ...
    let mut band: enum nl80211_band = dev.scan.chan.band;
    struct mt76_phy *phy = dev.scan.phy;
    ...
    rcu_read_lock();
    if (!ieee80211_tx_prepare_skb(phy.hw, vif, skb, band, core::ptr::null_mut()))
    goto out;
    ...
    mt76_tx(phy, core::ptr::null_mut(), mvif.wcid, skb);
    out:
    rcu_read_unlock();
    }
#[no_mangle]
pub unsafe extern "C" fn mt76_scan_rx_beacon(dev: *mut mt76_dev, chan: *mut ieee80211_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76_scan_work(work: *mut work_struct) {
    ...
    dev.scan.chan = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn mt76_cancel_hw_scan(hw: *mut ieee80211_hw, vif: *mut ieee80211_vif) {
