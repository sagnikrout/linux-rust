...
//! Source: drivers/net/wireless/mediatek/mt76/mt7996/init.c
#![no_std]
...
//
    ...
    let mut i: c_int = to_sensor_dev_attr(attr).index;
    int temperature;
    switch (i) {
    case 0:
...
// state = phy->cdev_state;
    ...
    {
    struct mt7996_phy *phy = cdev.devdata;
    let mut throttling: u8 = MT7996_THERMAL_THROTTLE_MAX - state;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mt7996_unregister_thermal(phy: *mut mt7996_phy) {
...
#[no_mangle]
unsafe extern "C" fn mt7996_thermal_init(phy: *mut mt7996_phy) -> c_int {
...
// control LED
    ...
    {
    let mut delta_on: u16 = 0, delta_off = 0;
pub const HW_TICK: c_int = 10;
    ...
    let mut path_delta: c_int = mt76_tx_power_path_delta(n_chains);
    let mut pwr_delta: c_int = mt7996_eeprom_get_power_delta(dev, sband.band);
    struct mt76_power_limits limits;
    for (i = 0; i < sband.n_channels; i++) {
    struct ieee80211_channel *chan = &sband.channels[i];
    let mut target_power: c_int = mt7996_eeprom_get_target_power(dev, chan);
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_init_txpower(phy: *mut mt7996_phy) {
    ...
    mt7996_mcu_rdd_background_enable(phy, core::ptr::null_mut());
    ...
    let mut n_radios: c_int = hw.wiphy.n_radio;
...
#[no_mangle]
unsafe extern "C" fn mt7996_mac_init_basic_rates(dev: *mut mt7996_dev) {
    static void mt7996_mac_init_basic_rates(struct mt7996_dev *dev)
    {
    int i;
    for (i = 0; i < ARRAY_SIZE(mt76_rates); i++) {
    let mut rate: u16 = mt76_rates[i].hw_value;
// odd index for driver, even index for firmware
    let mut idx: u16 = MT7996_BASIC_RATES_TBL + 2 * i;
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_mac_init(dev: *mut mt7996_dev) {
    void mt7996_mac_init(struct mt7996_dev *dev)
    {
pub const HIF_TXD_V2_1: c_uint = 0x21;
    int i, rx_path_type;
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_txbf_init(dev: *mut mt7996_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7996_register_phy(dev: *mut mt7996_dev, band: enum mt76_band_id) -> c_int {
...
// init wiphy according to mphy and phy
    ...
    return 0;
    error:
    mphy.dev.phys[band] = core::ptr::null_mut();
    return ret;
    }
    static void
...
#[no_mangle]
unsafe extern "C" fn mt7996_init_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_wfsys_reset(dev: *mut mt7996_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7996_rro_hw_init_v3(dev: *mut mt7996_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_rro_hw_init(dev: *mut mt7996_dev) {
    void mt7996_rro_hw_init(struct mt7996_dev *dev)
    {
    let mut reg: u32 = MT_RRO_ADDR_ELEM_SEG_ADDR0;
    int i;
    if (!mt7996_has_hwrro(dev))
    return;
...
#[no_mangle]
unsafe extern "C" fn mt7996_wed_rro_init(dev: *mut mt7996_dev) -> c_int {
    static int mt7996_wed_rro_init(struct mt7996_dev *dev)
    {
    let mut val: u32 = FIELD_PREP(WED_RRO_ADDR_SIGNATURE_MASK, 0xff);
...
#[no_mangle]
unsafe extern "C" fn mt7996_wed_rro_free(dev: *mut mt7996_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7996_wed_rro_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mt7996_variant_type_init(dev: *mut mt7996_dev) -> c_int {
    static int mt7996_variant_type_init(struct mt7996_dev *dev)
    {
    let mut val: u32 = mt76_rr(dev, MT_PAD_GPIO);
    u8 var_type;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: u32_get_bits(val, _arg: MT_PAD_GPIO_ADIE_COMB_7992)) -> else {
...
#[no_mangle]
unsafe extern "C" fn mt7996_variant_fem_init(dev: *mut mt7996_dev) -> c_int {
    static int mt7996_variant_fem_init(struct mt7996_dev *dev)
    {
pub const MT7976C_EFUSE_OFFSET: c_uint = 0x470;
...
#[no_mangle]
pub unsafe extern "C" fn if(1: adie_id == 0x7977 && adie_comb ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mt7996_init_hardware(dev: *mut mt7996_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_set_stream_vht_txbf_caps(phy: *mut mt7996_phy) {
...
// cap |= IEEE80211_VHT_CAP_SU_BEAMFORMER_CAPABLE |
    ...
    let mut non_2g: bool = band != NL80211_BAND_2GHZ;
    u8 c;
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_set_stream_he_eht_caps(phy: *mut mt7996_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_register_device(dev: *mut mt7996_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_unregister_device(dev: *mut mt7996_dev) {
