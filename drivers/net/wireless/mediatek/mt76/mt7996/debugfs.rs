...
//! Source: drivers/net/wireless/mediatek/mt76/mt7996/debugfs.c
#![no_std]
...
pub const FW_BIN_LOG_MAGIC: c_uint = 0x44d9c99a;
// global debugfs
#[repr(C)]
#[derive(Copy, Clone)]
...
// Tx amsdu info
    ...
    continue;
    for (ac = 0; ac < 4; ac++) {
    let mut idx: u32 = msta_link.wcid.idx >> 5, qlen, ctrl, val;
    let mut offs: u8 = msta_link.wcid.idx & GENMASK(4, 0);
...
// pse queue
    ...
    { core::ptr::null_mut(),				 "  MAIN1"  },
    { core::ptr::null_mut(),				 "  MAIN2"  },
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_init_debugfs(dev: *mut mt7996_dev) -> c_int {
    int mt7996_init_debugfs(struct mt7996_dev *dev)
    {
    struct dentry *dir;
    dir = mt76_register_debugfs_fops(&dev.mphy, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_debugfs_rx_fw_monitor(dev: *mut mt7996_dev, data: *const c_void, len: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_debugfs_rx_log(dev: *mut mt7996_dev, data: *const c_void, len: c_int) -> bool {
    bool mt7996_debugfs_rx_log(struct mt7996_dev *dev, const void *data, int len)
    {
    if (get_unaligned_le32(data) != FW_BIN_LOG_MAGIC)
    return false;
    if (dev.relay_fwlog)
    mt7996_debugfs_write_fwlog(dev, core::ptr::null_mut(), 0, data, len);
    return true;
    }
...
// per-station debugfs
    ...
    size_t count, loff_t *ppos)
    {
pub const SHORT_PREAMBLE: c_int = 0;
pub const LONG_PREAMBLE: c_int = 1;
