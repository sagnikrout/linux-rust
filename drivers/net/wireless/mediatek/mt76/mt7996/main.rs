...
//! Source: drivers/net/wireless/mediatek/mt76/mt7996/main.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_run(phy: *mut mt7996_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7996_start(hw: *mut ieee80211_hw) -> c_int {
    ...
    let mut queue: u8 = mt76_connac_lmac_mapping(IEEE80211_AC_VI);
...
#[no_mangle]
unsafe extern "C" fn mt7996_stop_phy(phy: *mut mt7996_phy) {
...
#[no_mangle]
unsafe extern "C" fn mt7996_stop(hw: *mut ieee80211_hw, suspend: bool) {
    static void mt7996_stop(struct ieee80211_hw *hw, bool suspend)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn get_free_idx(mask: u64, start: u8, end: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_omac_idx(type: enum nl80211_iftype, mask: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_own_mld_idx(mask: u64, group_mld: bool) -> c_int {
    static int get_own_mld_idx(u64 mask, bool group_mld)
    {
    let mut start: u8 = group_mld ? 0 : 16;
    let mut end: u8 = group_mld ? 15 : 63;
    int idx;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt7996_key_iter_data {
    pub cmd: enum set_key_cmd,
    pub link_id: c_uint,
}
    ...
    if (sta)
    return;
    WARN_ON(mt7996_set_hw_key(hw, it.cmd, vif, core::ptr::null_mut(), it.link_id, key));
    }
    ...
    struct mt7996_dev *dev = phy.dev;
    let mut band_idx: u8 = phy.mt76.band_idx;
...
//
    ...
    mt7996_mcu_add_sta(dev, link_conf, core::ptr::null_mut(), link, core::ptr::null_mut(),
    ...
    struct mt7996_vif *mvif = (struct mt7996_vif *)vif.drv_priv;
    struct mt7996_sta_link *msta_link = &link.msta_link;
    let mut link_id: c_uint = msta_link.wcid.link_id;
    ...
    struct mt7996_dev *dev = phy.dev;
    let mut idx: c_int = msta_link.wcid.idx;
    if (!link_conf)
    link_conf = &vif.bss_conf;
    if (!mlink.wcid.offchannel)
    ...
    rcu_assign_pointer(mlink.mvif.link[link_id], core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mt7996_phy_set_rxfilter(phy: *mut mt7996_phy) {
    ...
    let mut filter: u32 = phy.rxfilter;
...
#[no_mangle]
unsafe extern "C" fn mt7996_set_monitor(phy: *mut mt7996_phy, enabled: bool) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt7996_radio_data {
    pub active_mask: u32,
    pub monitor_mask: u32,
}

#[no_mangle]
unsafe extern "C" fn mt7996_remove_iter(data: *mut c_void, mac: *mut u8, vif: *mut ieee80211_vif) {
    ...
    {
    struct mt7996_vif *mvif = (struct mt7996_vif *)vif.drv_priv;
    let mut rem_links: c_ulong = mvif.mt76.valid_links;
    struct mt7996_dev *dev = mt7996_hw_dev(hw);
    let mut rdata: mt7996_radio_data = {};
...
// Remove all active links
    ...
    if (!phy)
    continue;
    mt7996_vif_link_destroy(phy, link, vif, core::ptr::null_mut());
    }
    mutex_unlock(&dev.mt76.mutex);
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_set_channel(mphy: *mut mt76_phy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(sta->valid_links: sta &&) -> else {
    else if (sta && sta.valid_links)
    links = sta.valid_links;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: vif->valid_links) -> else {
...
#[no_mangle]
unsafe extern "C" fn mt7996_config(hw: *mut ieee80211_hw, radio_idx: c_int, changed: u32) -> c_int {
...
// no need to update right away, we'll get BSS_CHANGED_QOS
    ...
    struct mt7996_dev *dev = mt7996_hw_dev(hw);
    struct mt7996_phy *phy;
    let mut filter_mask: u32 = 0, filter_set = 0;
    let mut flags: u32 = 0;
...
// odd index for driver, even index for firmware
    ...
    {
    struct mt7996_dev *dev = mt7996_hw_dev(hw);
    let mut band: u8 = link.mt76.band_idx;
    u32 *mu;
...
//
    ...
    &link.msta_link, true);
    mt7996_mcu_add_sta(dev, info, core::ptr::null_mut(), link, core::ptr::null_mut(),
    CONN_STATE_PORT_SECURE,
    !!(changed & BSS_CHANGED_BSSID));
    }
...
// switch to the secondary link
    ...
    if (phy)
    phy.mt76.num_sta--;
    rcu_assign_pointer(msta.link[link_id], core::ptr::null_mut());
    rcu_assign_pointer(dev.mt76.wcid[msta_link.wcid.idx], core::ptr::null_mut());
    ...
    struct mt7996_sta *msta = (struct mt7996_sta *)sta.drv_priv;
    struct mt7996_vif *mvif = (struct mt7996_vif *)vif.drv_priv;
    let mut links: c_ulong = sta.valid_links ? sta.valid_links : BIT(0);
    int err;
    mutex_lock(&dev.mt76.mutex);
    msta.deflink_id = IEEE80211_LINK_UNSPECIFIED;
    ...
    {
    struct mt7996_sta *msta = (struct mt7996_sta *)sta.drv_priv;
    let mut links: c_ulong = sta.valid_links;
    struct ieee80211_link_sta *link_sta;
    unsigned int link_id;
    let mut err: c_int = 0;
    mutex_lock(&dev.mt76.mutex);
    ...
    struct mt7996_sta *msta = sta ? (void *)sta.drv_priv : core::ptr::null_mut();
    struct mt76_phy *mphy = hw.priv;
    struct ieee80211_tx_info *info = IEEE80211_SKB_CB(skb);
    struct ieee80211_vif *vif = info.control.vif;
    struct mt7996_vif *mvif = vif ? (void *)vif.drv_priv : core::ptr::null_mut();
    struct mt76_wcid *wcid = &dev.mt76.global_wcid;
    let mut deflink_id: u8 = IEEE80211_LINK_UNSPECIFIED;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: mvif) -> else {
    else if (mvif)
...
#[no_mangle]
pub unsafe extern "C" fn __mt7996_get_tsf(hw: *mut ieee80211_hw, link: *mut mt7996_vif_link) -> u64 {
...
// TSF software adjust
    ...
    struct mt7996_phy *phy = dev.radio_phy[i];
    let mut band_idx: u8 = phy.mt76.band_idx;
    let mut shift: u8 = dev.chainshift[band_idx];
...
#[no_mangle]
unsafe extern "C" fn mt7996_sta_rate_ctrl_update(data: *mut c_void, sta: *mut ieee80211_sta) {
    static void mt7996_sta_rate_ctrl_update(void *data, struct ieee80211_sta *sta)
    {
    struct mt7996_sta *msta = (struct mt7996_sta *)sta.drv_priv;
    struct mt7996_sta_link *msta_link;
    struct mt7996_vif *mvif = data;
    let mut changed: u32 = IEEE80211_RC_SUPP_RATES_CHANGED;
    if (msta.vif != mvif)
    return;
...
#[no_mangle]
unsafe extern "C" fn mt7996_ethtool_worker(wi_data: *mut c_void, sta: *mut ieee80211_sta) {
...
// rdd2 already configured on a radar channel
    ...
    ret = mt7996_mcu_rdd_background_enable(phy, core::ptr::null_mut());
    if (ret)
    goto out;
    if (!running)
    goto update_phy;
    ...
    goto out;
    update_phy:
    dev.rdd2_phy = chandef ? phy : core::ptr::null_mut();
    if (chandef)
