...
//! Source: drivers/net/wireless/mediatek/mt76/mt7996/pci.c
#![no_std]
...
//
    ...
    hif = core::ptr::null_mut();
    out:
    spin_unlock_bh(&hif_lock);
    return hif;
    }
#[no_mangle]
unsafe extern "C" fn mt7996_put_hif2(hif: *mut mt7996_hif) {
    ...
    {
    hif_idx++;
    if (!pci_get_device(PCI_VENDOR_ID_MEDIATEK, MT7996_DEVICE_ID_2, core::ptr::null_mut()) &&
    !pci_get_device(PCI_VENDOR_ID_MEDIATEK, MT7992_DEVICE_ID_2, core::ptr::null_mut()) &&
    !pci_get_device(PCI_VENDOR_ID_MEDIATEK, MT7990_DEVICE_ID_2, core::ptr::null_mut()))
...
#[no_mangle]
unsafe extern "C" fn mt7996_pci_hif2_probe(pdev: *mut pci_dev) -> c_int {
    ...
    hif.irq = pdev.irq;
    pcie_bandwidth_available(pdev, core::ptr::null_mut(), &hif.speed, &hif.width);
    spin_lock_bh(&hif_lock);
...
#[no_mangle]
unsafe extern "C" fn mt7996_hif_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7996_pci_remove(pdev: *mut pci_dev) {
