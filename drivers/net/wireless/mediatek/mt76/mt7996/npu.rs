...
//! Source: drivers/net/wireless/mediatek/mt76/mt7996/npu.c
#![no_std]
...
//
    ...
    {
    let mut hif1_ofs: u32 = dev.hif2 ? MT_WFDMA0_PCIE1(0) - MT_WFDMA0(0) : 0;
    let mut phy_addr: phys_addr_t = dev.mt76.mmio.phy_addr;
    u32 dma_addr;
    int i, err;
...
#[no_mangle]
unsafe extern "C" fn mt7992_npu_rxd_init(dev: *mut mt7996_dev, npu: *mut airoha_npu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7996_npu_rxd_init(dev: *mut mt7996_dev, npu: *mut airoha_npu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7996_npu_txd_init(dev: *mut mt7996_dev, npu: *mut airoha_npu) -> c_int {
    ...
    struct airoha_npu *npu)
    {
    let mut qid: c_int = is_mt7996(&dev.mt76) ? MT_RXQ_TXFREE_BAND0 : MT_RXQ_MAIN_WA;
    let mut phy_addr: phys_addr_t = dev.mt76.mmio.phy_addr;
    ...
    {
    let mut hif1_ofs: u32 = dev.hif2 ? MT_WFDMA0_PCIE1(0) - MT_WFDMA0(0) : 0;
    let mut dma_addr: dma_addr_t = dev.mt76.mmio.phy_addr;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_npu_rx_queues_init(dev: *mut mt7996_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __mt7996_npu_hw_init(dev: *mut mt7996_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_npu_hw_init(dev: *mut mt7996_dev) -> c_int {
    ...
    let mut band: c_int = i && is_mt7996(&dev.mt76) ? MT_BAND2 : MT_BAND0;
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_npu_hw_stop(dev: *mut mt7996_dev) -> c_int {
