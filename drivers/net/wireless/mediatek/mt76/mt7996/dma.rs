...
//! Source: drivers/net/wireless/mediatek/mt76/mt7996/dma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7996_poll_tx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7996_dma_config(dev: *mut mt7996_dev) {
...
#[no_mangle]
unsafe extern "C" fn __mt7996_dma_prefetch_base(base: *mut u16, depth: u8) -> u32 {
    static u32 __mt7996_dma_prefetch_base(u16 *base, u8 depth)
    {
    let mut ret: u32 = *base << 16 | depth;
// base = *base + (depth << 4);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn __mt7996_dma_prefetch(dev: *mut mt7996_dev, ofs: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn if(mt7996_has_hwrro(dev): is_mt7996(&dev->mt76) &&) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_dma_prefetch(dev: *mut mt7996_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7996_dma_disable(dev: *mut mt7996_dev, reset: bool) {
    static void mt7996_dma_disable(struct mt7996_dev *dev, bool reset)
    {
    let mut hif1_ofs: u32 = 0;
    if (dev.hif2)
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_dma_start(dev: *mut mt7996_dev, reset: bool, wed_reset: bool) {
...
// enable interrupts for TX/RX rings
    ...
    let mut wed_irq_mask: u32 = irq_mask;
...
#[no_mangle]
unsafe extern "C" fn mt7996_dma_enable(dev: *mut mt7996_dev, reset: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_dma_rro_init(dev: *mut mt7996_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !mt76_npu_device_active(&dev->mt76)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_dma_rro_start(dev: *mut mt7996_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_dma_init(dev: *mut mt7996_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_dma_reset(dev: *mut mt7996_dev, force: bool) {
    void mt7996_dma_reset(struct mt7996_dev *dev, bool force)
    {
    struct mt76_phy *phy2 = dev.mt76.phys[MT_BAND1];
    struct mt76_phy *phy3 = dev.mt76.phys[MT_BAND2];
    let mut hif1_ofs: u32 = MT_WFDMA0_PCIE1(0) - MT_WFDMA0(0);
    int i;
    mt76_clear(dev, MT_WFDMA0_GLO_CFG,
    MT_WFDMA0_GLO_CFG_TX_DMA_EN |
    MT_WFDMA0_GLO_CFG_RX_DMA_EN);
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_dma_cleanup(dev: *mut mt7996_dev) {
