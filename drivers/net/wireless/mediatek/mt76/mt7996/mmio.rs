...
//! Source: drivers/net/wireless/mediatek/mt76/mt7996/mmio.c
#![no_std]
...
pub const INVALID_REG_ADDR: c_uint = 0xffffffff;
...
#[no_mangle]
unsafe extern "C" fn mt7996_reg_map_l1(dev: *mut mt7996_dev, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt7996_reg_map_l2(dev: *mut mt7996_dev, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt7996_reg_map_cbtop(dev: *mut mt7996_dev, addr: u32) -> u32 {
    static u32 mt7996_reg_map_cbtop(struct mt7996_dev *dev, u32 addr)
    {
    let mut offset: u32 = FIELD_GET(MT_HIF_REMAP_CBTOP_OFFSET, addr);
    let mut base: u32 = FIELD_GET(MT_HIF_REMAP_CBTOP_BASE, addr);
...
#[no_mangle]
unsafe extern "C" fn __mt7996_reg_addr(dev: *mut mt7996_dev, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __mt7996_reg_remap_addr(dev: *mut mt7996_dev, addr: u32) -> u32 {
...
// CONN_INFRA: covert to phyiscal addr and use layer 1 remap
    ...
    size_t len)
    {
    let mut addr: u32 = __mt7996_reg_addr(dev, offset);
...
#[no_mangle]
unsafe extern "C" fn mt7996_rr(mdev: *mut mt76_dev, offset: u32) -> u32 {
    static u32 mt7996_rr(struct mt76_dev *mdev, u32 offset)
    {
    struct mt7996_dev *dev = container_of(mdev, struct mt7996_dev, mt76);
    let mut addr: u32 = __mt7996_reg_addr(dev, offset), val;
    if (addr != INVALID_REG_ADDR)
...
#[no_mangle]
unsafe extern "C" fn mt7996_wr(mdev: *mut mt76_dev, offset: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn mt7996_rmw(mdev: *mut mt76_dev, offset: u32, mask: u32, val: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt7996_mmio_wed_reset(wed: *mut mtk_wed_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7996_irq_tasklet(t: *mut tasklet_struct) {
    ...
    let mut val: u32 = mt76_rr(dev, MT_MCU_CMD);
...
#[no_mangle]
pub unsafe extern "C" fn mt7996_irq_handler(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt7996_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mt7996_exit() -> void __exit {
