...
//! Source: drivers/net/wireless/mediatek/mt76/mt7921/sdio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7921s_txrx_worker(w: *mut mt76_worker) {
...
#[no_mangle]
unsafe extern "C" fn mt7921s_unregister_device(dev: *mut mt792x_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7921s_parse_intr(dev: *mut mt76_dev, intr: *mut mt76s_intr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7921s_remove(func: *mut sdio_func) {
...
#[no_mangle]
unsafe extern "C" fn mt7921s_suspend(__dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7921s_resume(__dev: *mut device) -> c_int {
