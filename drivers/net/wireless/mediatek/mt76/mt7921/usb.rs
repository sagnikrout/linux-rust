...
//! Source: drivers/net/wireless/mediatek/mt76/mt7921/usb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7921u_mcu_init(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7921u_mac_reset(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7921u_suspend(intf: *mut usb_interface, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7921u_resume(intf: *mut usb_interface) -> c_int {
