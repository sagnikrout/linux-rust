...
//! Source: drivers/net/wireless/mediatek/mt76/mt7921/pci.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7921e_init_reset(dev: *mut mt792x_dev) -> c_int {
    static int mt7921e_init_reset(struct mt792x_dev *dev)
    {
    return mt792x_wpdma_reset(dev, true);
    }
#[no_mangle]
unsafe extern "C" fn mt7921e_unregister_device(dev: *mut mt792x_dev) {
...
#[no_mangle]
unsafe extern "C" fn __mt7921_reg_addr(dev: *mut mt792x_dev, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt7921_rr(mdev: *mut mt76_dev, offset: u32) -> u32 {
    static u32 mt7921_rr(struct mt76_dev *mdev, u32 offset)
    {
    struct mt792x_dev *dev = container_of(mdev, struct mt792x_dev, mt76);
    let mut addr: u32 = __mt7921_reg_addr(dev, offset);
    return dev.bus_ops.rr(mdev, addr);
    }
#[no_mangle]
unsafe extern "C" fn mt7921_wr(mdev: *mut mt76_dev, offset: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn mt7921_rmw(mdev: *mut mt76_dev, offset: u32, mask: u32, val: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt7921_dma_init(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7921_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7921_pci_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7921_pci_resume(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7921_aer_rr(mdev: *mut mt76_dev, offset: u32) -> u32 {
    static u32 mt7921_aer_rr(struct mt76_dev *mdev, u32 offset)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mt7921_aer_wr(mdev: *mut mt76_dev, offset: u32, val: u32) {
    static void mt7921_aer_wr(struct mt76_dev *mdev, u32 offset, u32 val)
    {
    ;
    }
#[no_mangle]
unsafe extern "C" fn mt791_aer_rmw(mdev: *mut mt76_dev, offset: u32, mask: u32, val: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt7921_pci_set_aer_bus_hung_ops(dev: *mut mt792x_dev) {
    ...
    struct mt76_dev *mdev = pci_get_drvdata(pdev);
    struct mt792x_dev *dev = container_of(mdev, struct mt792x_dev, mt76);
    let mut aer_unc_val: u32 = 0, aer_co_val = 0;
...
#[no_mangle]
unsafe extern "C" fn mt7921_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn mt7921_pci_shutdown(pdev: *mut pci_dev) {
