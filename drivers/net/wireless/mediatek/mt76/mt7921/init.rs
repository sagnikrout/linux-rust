...
//! Source: drivers/net/wireless/mediatek/mt76/mt7921/init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7921_thermal_init(phy: *mut mt792x_phy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7921_mac_init(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mt7921_init_hardware(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7921_init_hardware(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7921_init_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7921_register_device(dev: *mut mt792x_dev) -> c_int {
