...
//! Source: drivers/net/wireless/mediatek/mt76/mt7921/main.c
#![no_std]
...
// Copyright (C) 2020 MediaTek Inc.
    ...
    {
    int i, idx = 0;
    let mut nss: c_int = hweight8(phy.mt76.chainmask);
...
#[no_mangle]
pub unsafe extern "C" fn mt7921_set_stream_he_caps(phy: *mut mt792x_phy) {
...
#[no_mangle]
pub unsafe extern "C" fn __mt7921_start(phy: *mut mt792x_phy) -> c_int {
    ...
    if (err)
    return err;
    err = mt7921_set_tx_sar_pwr(mphy.hw, core::ptr::null_mut());
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn mt7921_start(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7921_stop(hw: *mut ieee80211_hw, suspend: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7921_roc_abort_sync(dev: *mut mt792x_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7921_roc_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mt7921_abort_roc(phy: *mut mt792x_phy, vif: *mut mt792x_vif) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7921_set_channel(mphy: *mut mt76_phy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7921_set_runtime_pm(dev: *mut mt792x_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7921_config(hw: *mut ieee80211_hw, radio_idx: c_int, changed: u32) -> c_int {
    ...
    ret = mt7921_set_tx_sar_pwr(hw, core::ptr::null_mut());
    if (ret)
    goto out;
    }
    ...
    struct mt792x_dev *dev = mt792x_hw_dev(hw);
    let mut flags: u32 = MT7921_FILTER_ENABLE;
...
#[no_mangle]
pub unsafe extern "C" fn mt7921_scan_work(work: *mut work_struct) {
    ...
    struct mt76_connac_hw_scan_done *event = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mt7921_resume(hw: *mut ieee80211_hw) -> c_int {
    ...
    if (err)
    goto out;
    err = mt7921_mcu_sta_update(dev, core::ptr::null_mut(), vif, true,
    MT76_STA_INFO_STATE_NONE);
    out:
    mt792x_mutex_release(dev);
    return err;
...
#[no_mangle]
pub unsafe extern "C" fn mt7921_csa_work(work: *mut work_struct) {
    ...
    {
    struct mt792x_vif *mvif = (struct mt792x_vif *)vif.drv_priv;
    let mut beacon_interval: u16 = vif.bss_conf.beacon_int;
...
#[no_mangle]
unsafe extern "C" fn mt7921_rfkill_poll(hw: *mut ieee80211_hw) {
