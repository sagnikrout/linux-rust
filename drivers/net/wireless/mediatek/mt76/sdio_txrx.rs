...
//! Source: drivers/net/wireless/mediatek/mt76/sdio_txrx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt76s_refill_sched_quota(dev: *mut mt76_dev, data: *mut u32) -> c_int {
    ...
    let mut pse_mcu_quota: u32 = FIELD_GET(TXQ_CNT_L, data[2]);
    let mut pse_data_quota: u32 = 0, ple_data_quota = 0;
    ...
    {
    let mut len: c_int = min_t(int, data_len, MT_SKB_HEAD_LEN);
    struct sk_buff *skb;
    ...
    let mut index: c_int = (q.head + i) % q.ndesc;
...
#[no_mangle]
unsafe extern "C" fn mt76s_rx_handler(dev: *mut mt76_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mt76s_xmit_queue(dev: *mut mt76_dev, data: *mut u8, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76s_tx_run_queue(dev: *mut mt76_dev, q: *mut mt76_queue) -> c_int {
    static int mt76s_tx_run_queue(struct mt76_dev *dev, struct mt76_queue *q)
    {
    int err, nframes = 0, len = 0, pse_sz = 0, ple_sz = 0;
    let mut mcu: bool = q == dev.q_mcu[MT_MCUQ_WM];
    struct mt76_sdio *sdio = &dev.sdio;
    u8 pad;
...
#[no_mangle]
pub unsafe extern "C" fn mt76s_txrx_worker(sdio: *mut mt76_sdio) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76s_sdio_irq(func: *mut sdio_func) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76s_txqs_empty(dev: *mut mt76_dev) -> bool {
