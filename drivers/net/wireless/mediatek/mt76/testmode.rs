...
//! Source: drivers/net/wireless/mediatek/mt76/testmode.h
#![no_std]
...
//
pub const MT76_TM_TIMEOUT: c_int = 10;
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mt76_testmode_stats_attr {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mt76_testmode_rx_attr {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum mt76_testmode_tx_mode {
    MT76_TM_TX_MODE_CCK,
