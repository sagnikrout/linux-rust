...
// Copyright (C) 2023 MediaTek Inc.
    ...
    struct wiphy *wiphy)
    {
    let mut cnm: bool = !!(dev.fw_features & MT792x_FW_CAP_CNM);
    let mut nan: bool = !!(dev.fw_features & MT792x_FW_CAP_NAN);
    let mut n_base: c_int = ARRAY_SIZE(if_comb_chanctx_base);
    let mut n_nan: c_int = ARRAY_SIZE(if_comb_chanctx_nan);
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_stop(hw: *mut ieee80211_hw, suspend: bool) {
    ...
    let mut idx: c_int = mlink.wcid.idx;
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_get_tsf(hw: *mut ieee80211_hw, vif: *mut ieee80211_vif) -> u64 {
    u64 mt792x_get_tsf(struct ieee80211_hw *hw, struct ieee80211_vif *vif)
    {
    struct mt792x_vif *mvif = (struct mt792x_vif *)vif.drv_priv;
    struct mt792x_dev *dev = mt792x_hw_dev(hw);
    let mut omac_idx: u8 = mvif.bss_conf.mt76.omac_idx;
    union {
    u64 t64;
    u32 t32[2];
    } tsf;
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_tx_worker(w: *mut mt76_worker) {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_roc_timer(timer: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_csa_timer(timer: *mut timer_list) {
    ...
    {
    let mut limits: mt76_power_limits = {};
    struct ieee80211_bss_conf *link_conf;
    ...
    mconf = link_conf ? mt792x_link_conf_to_mconf(link_conf) : core::ptr::null_mut();
...
// dbm = DIV_ROUND_UP(max_power, 2);
    ...
    mvif.bss_conf.mt76.ctx = core::ptr::null_mut();
    mutex_unlock(&dev.mt76.mutex);
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_set_wakeup(hw: *mut ieee80211_hw, enabled: bool) {
...
// per vif counters
    ...
    {
    struct mt792x_vif *mvif = (struct mt792x_vif *)vif.drv_priv;
    let mut stats_size: c_int = ARRAY_SIZE(mt792x_gstrings_stats);
    struct mt792x_phy *phy = mt792x_hw_phy(hw);
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_init_wiphy(hw: *mut ieee80211_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt792x_needs_cnm_runtime(drv_data: *const c_void) -> bool {
...
// fw_features |= MT792x_FW_CAP_CNM;
    ...
    ops.remain_on_channel = core::ptr::null_mut();
    ops.cancel_remain_on_channel = core::ptr::null_mut();
    ops.add_chanctx = ieee80211_emulate_add_chanctx;
    ops.remove_chanctx = ieee80211_emulate_remove_chanctx;
    ops.change_chanctx = ieee80211_emulate_change_chanctx;
    ops.switch_vif_chanctx = ieee80211_emulate_switch_vif_chanctx;
    ops.assign_vif_chanctx = core::ptr::null_mut();
    ops.unassign_vif_chanctx = core::ptr::null_mut();
    ops.mgd_prepare_tx = core::ptr::null_mut();
    ops.mgd_complete_tx = core::ptr::null_mut();
    }
    return ops;
    }
    EXPORT_SYMBOL_GPL(mt792x_get_mac80211_ops);
#[no_mangle]
pub unsafe extern "C" fn mt792x_init_wcid(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_mcu_drv_pmctrl(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_mcu_fw_pmctrl(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __mt792xe_mcu_drv_pmctrl(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt792xe_mcu_drv_pmctrl(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt792xe_mcu_fw_pmctrl(dev: *mut mt792x_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_load_firmware(dev: *mut mt792x_dev) -> c_int {
...
// activate again
    ...
    ret = mt76_connac2_load_ram(&dev.mt76, mt792x_ram_name(dev), core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn mt792x_config_mac_addr_list(dev: *mut mt792x_dev) {
