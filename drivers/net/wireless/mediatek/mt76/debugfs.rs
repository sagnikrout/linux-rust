...
//! Source: drivers/net/wireless/mediatek/mt76/debugfs.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mt76_queues_read(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76_rx_queues_read(s: *mut seq_file, data: *mut c_void) -> c_int {
