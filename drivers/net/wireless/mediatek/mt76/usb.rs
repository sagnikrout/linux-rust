...
//! Source: drivers/net/wireless/mediatek/mt76/usb.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ___mt76u_rr(dev: *mut mt76_dev, req: u8, req_type: u8, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __mt76u_rr(dev: *mut mt76_dev, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mt76u_rr(dev: *mut mt76_dev, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __mt76u_wr(dev: *mut mt76_dev, addr: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn mt76u_wr(dev: *mut mt76_dev, addr: u32, val: u32) {
...
//
    ...
    {
    struct mt76_usb *usb = &dev.usb;
    let mut i: c_int = 0, batch_len, ret;
    u8 *val = data;
    len = round_up(len, 4);
    mutex_lock(&usb.usb_ctrl_mtx);
    while (i < len) {
    ...
    USB_DIR_OUT | USB_TYPE_VENDOR,
    val & 0xffff, offset, core::ptr::null_mut(), 0);
    __mt76u_vendor_request(dev, req,
    USB_DIR_OUT | USB_TYPE_VENDOR,
    val >> 16, offset + 2, core::ptr::null_mut(), 0);
    mutex_unlock(&dev.usb.usb_ctrl_mtx);
    }
...
#[no_mangle]
unsafe extern "C" fn mt76u_check_sg(dev: *mut mt76_dev) -> bool {
    ...
    {
    let mut qid: enum mt76_rxq_id = q - &dev.q_rx[MT_RXQ_MAIN];
    int offset;
    ...
    int sg_max_size)
    {
    let mut size: c_uint = sizeof(struct urb);
    if (dev.usb.sg_en)
...
#[no_mangle]
unsafe extern "C" fn mt76u_urb_free(urb: *mut urb) {
...
// fast path
    ...
    let mut data_len: c_int = urb.num_sgs ? urb.sg[0].length : urb.actual_length;
    ...
    dev.drv.rx_skb(dev, MT_RXQ_MAIN, skb, core::ptr::null_mut());
    return nsgs;
    }
#[no_mangle]
unsafe extern "C" fn mt76u_complete_rx(urb: *mut urb) {
    ...
    struct urb *urb)
    {
    let mut ep: c_int = qid == MT_RXQ_MAIN ? MT_EP_IN_PKT_RX : MT_EP_IN_CMD_RESP;
    ...
    {
    let mut qid: c_int = q - &dev.q_rx[MT_RXQ_MAIN];
    struct urb *urb;
    int err, count;
    while (true) {
...
//
#[no_mangle]
unsafe extern "C" fn mt76u_napi_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76u_rx_worker(w: *mut mt76_worker) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76u_alloc_mcu_queue(dev: *mut mt76_dev) -> c_int {
    ...
    q.entry[i].urb = core::ptr::null_mut();
    }
    page_pool_destroy(q.page_pool);
    q.page_pool = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn mt76u_free_rx(dev: *mut mt76_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76u_stop_rx(dev: *mut mt76_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76u_resume_rx(dev: *mut mt76_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76u_status_worker(w: *mut mt76_worker) {
...
#[no_mangle]
unsafe extern "C" fn mt76u_tx_status_data(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mt76u_complete_tx(urb: *mut urb) {
    ...
    let mut idx: u16 = q.head;
    int err;
    if (q.queued == q.ndesc)
    return -ENOSPC;
    skb.prev = skb.next = core::ptr::null_mut();
    err = dev.drv.tx_prepare_skb(dev, core::ptr::null_mut(), qid, wcid, sta, &tx_info);
    if (err < 0)
    return err;
...
#[no_mangle]
unsafe extern "C" fn mt76u_tx_kick(dev: *mut mt76_dev, q: *mut mt76_queue) {
    ...
    {
    let mut ac: u8 = qid < IEEE80211_NUM_ACS ? qid : IEEE80211_AC_BE;
...
#[no_mangle]
unsafe extern "C" fn mt76u_alloc_tx(dev: *mut mt76_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76u_free_tx(dev: *mut mt76_dev) {
    ...
    q.entry[j].urb = core::ptr::null_mut();
    }
    }
    }
#[no_mangle]
pub unsafe extern "C" fn mt76u_stop_tx(dev: *mut mt76_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt76u_queues_deinit(dev: *mut mt76_dev) {
    ...
    dev.napi_dev = core::ptr::null_mut();
    }
    mt76u_free_rx(dev);
    mt76u_free_tx(dev);
    }
...
#[no_mangle]
pub unsafe extern "C" fn mt76u_alloc_queues(dev: *mut mt76_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt76u_init(dev: *mut mt76_dev, intf: *mut usb_interface) -> c_int {
