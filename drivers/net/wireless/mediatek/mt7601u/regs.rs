...
//! Source: drivers/net/wireless/mediatek/mt7601u/regs.h
#![no_std]
...
pub const MT_USB_DMA_CFG: c_uint = 0x238;
...
pub const MT_BBP_CSR_CFG: c_uint = 0x101c;
...
pub const MT_TBTT_TIMER_CFG: c_uint = 0x1124;
...
// Macro flag: #define MT_TXOP_CTRL
...
pub const MT_HT_FBK_CFG0: c_uint = 0x1354;
pub const MT_HT_FBK_CFG1: c_uint = 0x1358;
...
pub const MT_PROT_RATE_OFDM_6: c_uint = 0x4000;
pub const MT_PROT_RATE_OFDM_24: c_uint = 0x4004;
pub const MT_PROT_RATE_DUP_OFDM_24: c_uint = 0x4084;
...
pub const MT_TX0_BB_GAIN_ATTEN: c_uint = 0x13c0;
...
pub const MT_RX_STA_CNT0: c_uint = 0x1700;
pub const MT_RX_STA_CNT1: c_uint = 0x1704;
pub const MT_RX_STA_CNT2: c_uint = 0x1708;
pub const MT_TX_STA_CNT0: c_uint = 0x170c;
pub const MT_TX_STA_CNT1: c_uint = 0x1710;
pub const MT_TX_STA_CNT2: c_uint = 0x1714;
