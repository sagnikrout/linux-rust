...
//! Source: drivers/net/wireless/mediatek/mt7601u/init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7601u_chip_onoff(dev: *mut mt7601u_dev, enable: bool, reset: bool) {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_reset_csr_bbp(dev: *mut mt7601u_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_init_usb_dma(dev: *mut mt7601u_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_init_bbp(dev: *mut mt7601u_dev) -> c_int {
    ...
    {
    let mut base: u16 = MT_BEACON_BASE;
    u32 regs[4] = {};
    int i;
    for (i = 0; i < 16; i++) {
    let mut addr: u16 = dev.beacon_offsets[i];
...
#[no_mangle]
unsafe extern "C" fn mt7601u_write_mac_initvals(dev: *mut mt7601u_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_init_wcid_mem(dev: *mut mt7601u_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_init_key_mem(dev: *mut mt7601u_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_init_wcid_attr_mem(dev: *mut mt7601u_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_reset_counters(dev: *mut mt7601u_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7601u_mac_start(dev: *mut mt7601u_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_mac_stop_hw(dev: *mut mt7601u_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7601u_mac_stop(dev: *mut mt7601u_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_stop_hardware(dev: *mut mt7601u_dev) {
    static void mt7601u_stop_hardware(struct mt7601u_dev *dev)
    {
    mt7601u_chip_onoff(dev, false, false);
    }
#[no_mangle]
pub unsafe extern "C" fn mt7601u_init_hardware(dev: *mut mt7601u_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7601u_cleanup(dev: *mut mt7601u_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7601u_register_device(dev: *mut mt7601u_dev) -> c_int {
