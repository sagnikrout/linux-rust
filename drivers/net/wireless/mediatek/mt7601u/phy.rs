...
//! Source: drivers/net/wireless/mediatek/mt7601u/phy.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7601u_bbp_wr(dev: *mut mt7601u_dev, offset: u8, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_bbp_rr(dev: *mut mt7601u_dev, offset: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_bbp_rmw(dev: *mut mt7601u_dev, offset: u8, mask: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_bbp_rmc(dev: *mut mt7601u_dev, offset: u8, mask: u8, val: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn mt7601u_wait_bbp_ready(dev: *mut mt7601u_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7601u_bbp_set_ctrlch(dev: *mut mt7601u_dev, below: bool) -> u32 {
...
// bw40 */ { -2, 16, 34 }
    ...
    let mut bw: c_int = FIELD_GET(MT_RXWI_RATE_BW, rate);
    let mut aux_lna: c_int = FIELD_GET(MT_RXWI_ANT_AUX_LNA, rxwi.ant);
    let mut lna_id: c_int = FIELD_GET(MT_RXWI_GAIN_RSSI_LNA_ID, rxwi.gain);
    int val;
...
#[no_mangle]
unsafe extern "C" fn mt7601u_vco_cal(dev: *mut mt7601u_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_set_bw_filter(dev: *mut mt7601u_dev, cal: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_load_bbp_temp_table_bw(dev: *mut mt7601u_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_bbp_temp(dev: *mut mt7601u_dev, mode: c_int, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_apply_ch14_fixup(dev: *mut mt7601u_dev, hw_chan: c_int) {
...
// Note: vendor code is buggy here for negative values
    ...
    {
pub const FREQ_PLAN_REGS: c_int = 4;
    ...
    chan_idx -= 2;
#[no_mangle]
pub unsafe extern "C" fn if(NL80211_CHAN_HT40PLUS: chan_idx < 12 && chan_type ==) -> else {
...
pub const BBP_R47_F_TSSI: c_int = 0;
pub const BBP_R47_F_PKT_T: c_int = 1;
pub const BBP_R47_F_TX_RATE: c_int = 2;
pub const BBP_R47_F_TEMP: c_int = 4;
//
...
//
#[no_mangle]
unsafe extern "C" fn mt7601u_bbp_r47_get(dev: *mut mt7601u_dev, reg: u8, flag: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_read_bootup_temp(dev: *mut mt7601u_dev) -> i8 {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_read_temp(dev: *mut mt7601u_dev) -> i8 {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_rxdc_cal(dev: *mut mt7601u_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mt7601u_phy_recalibrate_after_assoc(dev: *mut mt7601u_dev) {
...
#[no_mangle]
unsafe extern "C" fn lin2dBd(linear: u16) -> i16 {
    static s16 lin2dBd(u16 linear)
    {
    let mut exp: c_short = 0;
...
#[no_mangle]
unsafe extern "C" fn mt7601u_tssi_dc_gain_cal(dev: *mut mt7601u_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_temp_comp(dev: *mut mt7601u_dev, on: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(lo_temp: temp >) -> else {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_current_tx_power(dev: *mut mt7601u_dev) -> c_int {
    static int mt7601u_current_tx_power(struct mt7601u_dev *dev)
    {
    return dev.ee.chan_pwr[dev.chandef.chan.hw_value - 1];
    }
#[no_mangle]
unsafe extern "C" fn mt7601u_use_hvga(dev: *mut mt7601u_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_tssi_read_ready(dev: *mut mt7601u_dev) -> bool {
    static bool mt7601u_tssi_read_ready(struct mt7601u_dev *dev)
    {
    return !(mt7601u_bbp_rr(dev, 47) & 0x10);
    }
#[no_mangle]
unsafe extern "C" fn mt7601u_tssi_cal(dev: *mut mt7601u_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(9: dev->chandef.chan->hw_value <) -> else {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_agc_default(dev: *mut mt7601u_dev) -> u8 {
    static u8 mt7601u_agc_default(struct mt7601u_dev *dev)
    {
    return (dev.ee.lna_gain - 8) * 2 + 0x34;
    }
#[no_mangle]
unsafe extern "C" fn mt7601u_agc_reset(dev: *mut mt7601u_dev) {
    static void mt7601u_agc_reset(struct mt7601u_dev *dev)
    {
    let mut agc: u8 = mt7601u_agc_default(dev);
    mt7601u_bbp_wr(dev, 66,	agc);
    }
#[no_mangle]
pub unsafe extern "C" fn mt7601u_agc_save(dev: *mut mt7601u_dev) {
    void mt7601u_agc_save(struct mt7601u_dev *dev)
    {
    dev.agc_save = mt7601u_bbp_rr(dev, 66);
    }
#[no_mangle]
pub unsafe extern "C" fn mt7601u_agc_restore(dev: *mut mt7601u_dev) {
    void mt7601u_agc_restore(struct mt7601u_dev *dev)
    {
    mt7601u_bbp_wr(dev, 66, dev.agc_save);
    }
#[no_mangle]
unsafe extern "C" fn mt7601u_agc_tune(dev: *mut mt7601u_dev) {
    static void mt7601u_agc_tune(struct mt7601u_dev *dev)
    {
    let mut val: u8 = mt7601u_agc_default(dev);
    long avg_rssi;
    if (test_bit(MT7601U_STATE_SCANNING, &dev.state))
    return;
...
//
    ...
    val -= 0x20;
#[no_mangle]
pub unsafe extern "C" fn if(-60: avg_rssi <=) -> else {
    else if (avg_rssi <= -60)
    val -= 0x10;
...
#[no_mangle]
unsafe extern "C" fn mt7601u_phy_calibrate(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(deactivate_threshold: abs(last_offset) <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_phy_freq_cal(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_init_cal(dev: *mut mt7601u_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt7601u_bbp_set_bw(dev: *mut mt7601u_dev, bw: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mt7601u_set_rx_path(dev: *mut mt7601u_dev, path: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mt7601u_set_tx_dac(dev: *mut mt7601u_dev, dac: u8) {
    void mt7601u_set_tx_dac(struct mt7601u_dev *dev, u8 dac)
    {
    mt7601u_bbp_rmc(dev, 1, 0x18, dac << 3);
    }
#[no_mangle]
pub unsafe extern "C" fn mt7601u_phy_init(dev: *mut mt7601u_dev) -> c_int {
