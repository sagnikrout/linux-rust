...
//! Source: drivers/net/wireless/mediatek/mt7601u/tx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn q2hwq(q: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn skb2q(skb: *mut sk_buff) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn mt7601u_tx_pktid_enc(dev: *mut mt7601u_dev, rate: u8, is_probe: bool) -> u8 {
    static u8 mt7601u_tx_pktid_enc(struct mt7601u_dev *dev, u8 rate, bool is_probe)
    {
    let mut encoded: u8 = (rate + 1) + is_probe *  8;
...
//
    ...
    {
    let mut req_rate: u8 = stat.pktid;
    let mut eff_rate: u8 = stat.rate & 0x7;
    req_rate -= 1;
    if (req_rate > 7) {
    stat.is_probe = true;
    req_rate -= 8;
// Decide between MCS0 and MCS7 which share pktid 9
    ...
    {
    let mut pkt_len: c_int = (unsigned long)info.status.status_driver_data[0];
...
#[no_mangle]
pub unsafe extern "C" fn mt7601u_tx_status(dev: *mut mt7601u_dev, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn mt7601u_skb_rooms(dev: *mut mt7601u_dev, skb: *mut sk_buff) -> c_int {
    ...
    let mut ba_size: u8 = IEEE80211_MIN_AMPDU_BUF;
    ...
    struct mt76_sta *msta = core::ptr::null_mut();
    struct mt76_wcid *wcid = dev.mon_wcid;
    struct mt76_txwi *txwi;
    let mut pkt_len: c_int = skb.len;
    let mut hw_q: c_int = skb2q(skb);
...
#[no_mangle]
pub unsafe extern "C" fn mt7601u_tx_stat(work: *mut work_struct) {
    ...
    msecs_to_jiffies(10));
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_and_clear_bit(MT7601U_STATE_MORE_STATS, _arg: &dev->state)) -> else {
    ...
    {
    struct mt7601u_dev *dev = hw.priv;
    let mut cw_min: u8 = 5, cw_max = 10, hw_q = q2hwq(queue);
    u32 val;
