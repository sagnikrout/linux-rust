...
// Lock for source_gc_list
    ...
    let mut mld2_all_node: static struct in6_addr = MLD2_ALL_NODE_INIT;
...
#[no_mangle]
unsafe extern "C" fn __amt_source_gc_work() {
...
#[no_mangle]
unsafe extern "C" fn amt_source_gc_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn amt_addr_equal(a: *mut union amt_addr, b: *mut union amt_addr) -> bool {
    static bool amt_addr_equal(union amt_addr *a, union amt_addr *b)
    {
    return !memcmp(a, b, sizeof(union amt_addr));
    }
#[no_mangle]
unsafe extern "C" fn amt_source_hash(tunnel: *mut amt_tunnel_list, src: *mut union amt_addr) -> u32 {
    static u32 amt_source_hash(struct amt_tunnel_list *tunnel, union amt_addr *src)
    {
    let mut hash: u32 = jhash(src, sizeof(*src), tunnel.amt.hash_seed);
    ...
    union amt_addr *src)
    {
    let mut hash: u32 = amt_source_hash(tunnel, src);
    struct amt_source_node *snode;
...
#[no_mangle]
unsafe extern "C" fn amt_group_hash(tunnel: *mut amt_tunnel_list, group: *mut union amt_addr) -> u32 {
    static u32 amt_group_hash(struct amt_tunnel_list *tunnel, union amt_addr *group)
    {
    let mut hash: u32 = jhash(group, sizeof(*group), tunnel.amt.hash_seed);
    return reciprocal_scale(hash, tunnel.amt.hash_buckets);
    }
    ...
    bool v6)
    {
    let mut hash: u32 = amt_group_hash(tunnel, group);
    struct amt_group_node *gnode;
...
#[no_mangle]
unsafe extern "C" fn amt_destroy_source(snode: *mut amt_source_node) {
...
#[no_mangle]
unsafe extern "C" fn amt_del_group(amt: *mut amt_dev, gnode: *mut amt_group_node) {
...
//
#[no_mangle]
unsafe extern "C" fn amt_source_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn amt_group_work(work: *mut work_struct) {
    ...
    struct amt_dev *amt = gnode.amt;
    struct amt_source_node *snode;
    let mut delete_group: bool = true;
    struct hlist_node *t;
    int i, buckets;
...
//
    ...
    let mut hlen: c_int = LL_RESERVED_SPACE(amt.dev);
    let mut tlen: c_int = amt.dev.needed_tailroom;
...
#[no_mangle]
unsafe extern "C" fn amt_send_discovery(amt: *mut amt_dev) {
    ...
    skb.ip_summed = CHECKSUM_NONE;
    ip_select_ident(amt.net, skb, core::ptr::null_mut());
    ip_send_check(iph);
...
#[no_mangle]
unsafe extern "C" fn amt_send_request(amt: *mut amt_dev, v6: bool) {
...
#[no_mangle]
unsafe extern "C" fn amt_send_mld_gq(amt: *mut amt_dev, tunnel: *mut amt_tunnel_list) {
...
#[no_mangle]
unsafe extern "C" fn amt_secret_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn amt_event_send_discovery(amt: *mut amt_dev) {
...
#[no_mangle]
unsafe extern "C" fn amt_discovery_work(work: *mut work_struct) {
    static void amt_discovery_work(struct work_struct *work)
    {
    struct amt_dev *amt = container_of(to_delayed_work(work),
    struct amt_dev,
    discovery_wq);
    if (amt_queue_event(amt, AMT_EVENT_SEND_DISCOVERY, core::ptr::null_mut()))
    mod_delayed_work(amt_wq, &amt.discovery_wq,
    msecs_to_jiffies(AMT_DISCOVERY_TIMEOUT));
    }
#[no_mangle]
unsafe extern "C" fn amt_event_send_request(amt: *mut amt_dev) {
...
#[no_mangle]
unsafe extern "C" fn amt_req_work(work: *mut work_struct) {
    static void amt_req_work(struct work_struct *work)
    {
    struct amt_dev *amt = container_of(to_delayed_work(work),
    struct amt_dev,
    req_wq);
    if (amt_queue_event(amt, AMT_EVENT_SEND_REQUEST, core::ptr::null_mut()))
    ...
    bool v6)
    {
    let mut remote_ip: __be32 = READ_ONCE(amt.remote_ip);
...
#[no_mangle]
unsafe extern "C" fn amt_dev_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t amt_dev_xmit(struct sk_buff *skb, struct net_device *dev)
    {
    struct amt_dev *amt = netdev_priv(dev);
    struct amt_tunnel_list *tunnel;
    struct amt_group_node *gnode;
    let mut group: union amt_addr = {0,};
...
#[no_mangle]
unsafe extern "C" fn amt_parse_type(skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amt_clear_groups(tunnel: *mut amt_tunnel_list) {
...
#[no_mangle]
unsafe extern "C" fn amt_tunnel_expire(work: *mut work_struct) {
...
//
    ...
    let mut len: c_int = skb_transport_offset(skb) + sizeof(*ihrv3);
...
//
    ...
    let mut len: c_int = skb_transport_offset(skb) + sizeof(*mld2r);
...
#[no_mangle]
unsafe extern "C" fn amt_advertisement_handler(amt: *mut amt_dev, skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn amt_multicast_data_handler(amt: *mut amt_dev, skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn amt_update_handler(amt: *mut amt_dev, skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn amt_discovery_handler(amt: *mut amt_dev, skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn amt_request_handler(amt: *mut amt_dev, skb: *mut sk_buff) -> bool {
    ...
    mac = siphash_3u32(( u32)tunnel.ip4,
    ( u32)tunnel.source_port,
    ( u32)tunnel.nonce,
    &tunnel.key);
    tunnel.mac = mac >> 16;
...
#[no_mangle]
unsafe extern "C" fn amt_gw_rcv(amt: *mut amt_dev, skb: *mut sk_buff) {
    static void amt_gw_rcv(struct amt_dev *amt, struct sk_buff *skb)
    {
    let mut type: c_int = amt_parse_type(skb);
    let mut err: c_int = 1;
    if (type == -1)
    goto drop;
    if (amt.mode == AMT_MODE_GATEWAY) {
...
#[no_mangle]
unsafe extern "C" fn amt_rcv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amt_event_work(work: *mut work_struct) {
    ...
    amt.events[amt.event_idx].skb = core::ptr::null_mut();
    amt.nr_events--;
    amt.event_idx++;
    amt.event_idx %= AMT_MAX_EVENTS;
    spin_unlock_bh(&amt.lock);
...
#[no_mangle]
unsafe extern "C" fn amt_err_lookup(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amt_socket_create(amt: *mut amt_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amt_dev_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amt_dev_stop(dev: *mut net_device) -> c_int {
...
// shutdown
    ...
    RCU_INIT_POINTER(amt.sk, core::ptr::null_mut());
    synchronize_net();
    if (sk)
    ...
    amt.events[i].skb = core::ptr::null_mut();
    }
    amt.ready4 = false;
    amt.ready6 = false;
    amt.req_cnt = 0;
...
#[no_mangle]
unsafe extern "C" fn amt_dev_init(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amt_dev_uninit(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn amt_link_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn amt_dellink(dev: *mut net_device, head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn amt_get_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn amt_fill_info(skb: *mut sk_buff, dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amt_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn amt_fini() -> void __exit {
