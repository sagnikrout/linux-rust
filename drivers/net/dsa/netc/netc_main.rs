...
//! Source: drivers/net/dsa/netc/netc_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn netc_destroy_fdb_list(priv: *mut netc_switch) {
...
#[no_mangle]
unsafe extern "C" fn netc_destroy_vlan_list(priv: *mut netc_switch) {
...
#[no_mangle]
unsafe extern "C" fn netc_mac_port_wr(np: *mut netc_port, reg: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_get_capability(np: *mut netc_port) {
    ...
    struct device *dev)
    {
    if (of_find_property(node, "clock-names", core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn netc_init_switch_id(priv: *mut netc_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netc_get_switch_capabilities(priv: *mut netc_switch) {
...
#[no_mangle]
unsafe extern "C" fn netc_init_all_ports(priv: *mut netc_switch) -> c_int {
    static int netc_init_all_ports(struct netc_switch *priv)
    {
    struct device *dev = priv.dev;
    struct netc_port *np;
    struct dsa_port *dp;
    let mut ett_offset: c_int = 0;
    int err;
...
#[no_mangle]
unsafe extern "C" fn netc_init_ntmp_tbl_versions(priv: *mut netc_switch) {
...
#[no_mangle]
unsafe extern "C" fn netc_init_all_cbdrs(priv: *mut netc_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netc_remove_all_cbdrs(priv: *mut netc_switch) {
...
#[no_mangle]
unsafe extern "C" fn netc_num_available_ports(priv: *mut netc_switch) -> u32 {
    static u32 netc_num_available_ports(struct netc_switch *priv)
    {
    struct dsa_port *dp;
    let mut num_ports: u32 = 0;
    dsa_switch_for_each_available_port(dp, priv.ds)
    num_ports++;
    return num_ports;
    }
#[no_mangle]
unsafe extern "C" fn netc_init_ntmp_bitmap_sizes(priv: *mut netc_switch) -> c_int {
    static int netc_init_ntmp_bitmap_sizes(struct netc_switch *priv)
    {
    let mut num_ports: u32 = netc_num_available_ports(priv);
    struct netc_switch_regs *regs = &priv.regs;
    struct ntmp_user *ntmp = &priv.ntmp;
    u32 val;
    if (!num_ports)
...
#[no_mangle]
unsafe extern "C" fn netc_init_ntmp_bitmaps(priv: *mut netc_switch) -> c_int {
    ...
    ntmp.ett_gid_bitmap = core::ptr::null_mut();
    return -ENOMEM;
    }
#[no_mangle]
unsafe extern "C" fn netc_free_ntmp_bitmaps(priv: *mut netc_switch) {
    static void netc_free_ntmp_bitmaps(struct netc_switch *priv)
    {
    struct ntmp_user *ntmp = &priv.ntmp;
    bitmap_free(ntmp.ect_gid_bitmap);
    ntmp.ect_gid_bitmap = core::ptr::null_mut();
    bitmap_free(ntmp.ett_gid_bitmap);
    ntmp.ett_gid_bitmap = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn netc_init_ntmp_user(priv: *mut netc_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netc_free_ntmp_user(priv: *mut netc_switch) {
...
#[no_mangle]
unsafe extern "C" fn netc_clean_fdbt_ageing_entries(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn netc_switch_dos_default_config(priv: *mut netc_switch) {
...
#[no_mangle]
unsafe extern "C" fn netc_switch_vfht_default_config(priv: *mut netc_switch) {
...
#[no_mangle]
unsafe extern "C" fn netc_switch_fixed_config(priv: *mut netc_switch) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_set_all_tc_msdu(np: *mut netc_port) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_set_mlo(np: *mut netc_port, mlo: enum netc_mlo) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_set_pvid(np: *mut netc_port, pvid: u16) {
    static void netc_port_set_pvid(struct netc_port *np, u16 pvid)
    {
    netc_port_rmw(np, NETC_BPDVR, BPDVR_VID, pvid);
    }
#[no_mangle]
unsafe extern "C" fn netc_port_set_vlan_aware(np: *mut netc_port, aware: bool) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_fixed_config(np: *mut netc_port) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_default_config(np: *mut netc_port) {
...
#[no_mangle]
unsafe extern "C" fn netc_available_port_bitmap(priv: *mut netc_switch) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn netc_add_standalone_vlan_entry(priv: *mut netc_switch) -> c_int {
    static int netc_add_standalone_vlan_entry(struct netc_switch *priv)
    {
    let mut bitmap_stg: u32 = VFT_STG_ID(0) | netc_available_port_bitmap(priv);
...
//
    ...
    let mut port: c_int = np.dp.index;
    let mut cfg: u32 = 0;
    int err;
...
#[no_mangle]
unsafe extern "C" fn netc_add_standalone_fdb_bcast_entry(priv: *mut netc_switch) -> c_int {
    static int netc_add_standalone_fdb_bcast_entry(struct netc_switch *priv)
    {
    const u8 bcast[ETH_ALEN] = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff};
    struct dsa_port *dp, *cpu_dp = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn netc_port_set_pbpmcr(np: *mut netc_port, mapping: u64) {
    static void netc_port_set_pbpmcr(struct netc_port *np, u64 mapping)
    {
    let mut pbpmcr0: u32 = lower_32_bits(mapping);
    let mut pbpmcr1: u32 = upper_32_bits(mapping);
    netc_port_wr(np, NETC_PBPMCR0, pbpmcr0);
    netc_port_wr(np, NETC_PBPMCR1, pbpmcr1);
    }
#[no_mangle]
unsafe extern "C" fn netc_ipv_to_buffer_pool_mapping(priv: *mut netc_switch) {
    static void netc_ipv_to_buffer_pool_mapping(struct netc_switch *priv)
    {
    let mut bp_per_port: c_int = priv.num_bp / priv.info.num_ports;
    let mut q: c_int = NETC_IPV_NUM / bp_per_port;
    let mut r: c_int = NETC_IPV_NUM % bp_per_port;
    let mut num: c_int = q + r;
...
//
    for (int i = 0; i < priv.info.num_ports; i++) {
    let mut base_id: u32 = i * bp_per_port;
    let mut bp_id: u32 = base_id;
...
#[no_mangle]
unsafe extern "C" fn netc_switch_bpt_default_config(priv: *mut netc_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netc_setup(ds: *mut dsa_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netc_destroy_all_lists(priv: *mut netc_switch) {
...
#[no_mangle]
unsafe extern "C" fn netc_free_host_flood_rules(priv: *mut netc_switch) {
...
//
    kfree(np.host_flood);
    np.host_flood = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn netc_teardown(ds: *mut dsa_switch) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_is_emdio_consumer(node: *mut device_node) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn netc_switch_check_emdio_is_ready(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netc_switch_pci_init(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netc_switch_get_ip_revision(priv: *mut netc_switch) {
    static void netc_switch_get_ip_revision(struct netc_switch *priv)
    {
    struct netc_switch_regs *regs = &priv.regs;
    let mut val: u32 = netc_glb_rd(regs, NETC_IPBRR0);
    ...
    {
    let mut vuda_sqta: u32 = FMTEID_VUDA_SQTA;
    let mut efm_cfg: u16 = 0;
...
// length change: twos-complement notation
    ...
    let mut num_ports: u32 = netc_num_available_ports(priv);
    struct ntmp_user *ntmp = &priv.ntmp;
    let mut ect_eid: u32 = NTMP_NULL_ENTRY_ID;
...
//
    ...
    struct netc_vlan_entry *entry)
    {
    let mut untagged: bool = !!(entry.untagged_port_bitmap & BIT(np.dp.index));
    let mut num_ports: u32 = netc_num_available_ports(np.switch_priv);
    let mut ett_eid: u32 = le32_to_cpu(entry.cfge.et_eid);
    struct netc_switch *priv = np.switch_priv;
    let mut ect_eid: u32 = NTMP_NULL_ENTRY_ID;
    int err;
    if (ett_eid == NTMP_NULL_ENTRY_ID)
...
//
    ...
    {
    let mut old_untagged: bool = !!(entry.untagged_port_bitmap & BIT(port));
...
#[no_mangle]
unsafe extern "C" fn netc_port_del_vlan_entry(np: *mut netc_port, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netc_port_disable(ds: *mut dsa_switch, port: c_int) {
...
//
    ...
    int port, int mtu)
    {
    let mut max_frame_size: u32 = mtu + VLAN_ETH_HLEN + ETH_FCS_LEN;
    netc_port_set_max_frame_size(NETC_PORT(ds, port), max_frame_size);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn netc_port_max_mtu(ds: *mut dsa_switch, port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netc_vlan_unaware_pvid(bridge: *mut dsa_bridge) -> u16 {
...
//
    ...
    if (!vid)
    vid = netc_vlan_unaware_pvid(br_ndev ? &db.bridge : core::ptr::null_mut());
    ...
    {
    struct netc_switch *priv = ds.priv;
    let mut resume_eid: u32 = NTMP_NULL_ENTRY_ID;
...
// Enable ingress port filter table lookup
    ...
    {
    struct netc_switch *priv = np.switch_priv;
    let mut disable_host_flood: bool = false;
    if (!host_flood)
    return;
...
// Remove the old host flood entry
    ...
    {
    struct net_device *br_ndev = core::ptr::null_mut();
    struct dsa_port *dp;
    dsa_switch_for_each_available_port(dp, ds) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_remove_dynamic_entries(np: *mut netc_port) {
...
#[no_mangle]
unsafe extern "C" fn netc_set_ageing_time(ds: *mut dsa_switch, msecs: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netc_port_fast_age(ds: *mut dsa_switch, port: c_int) {
    ...
    {
    let mut mask: u32 = PM_IF_MODE_IFMODE | PM_IF_MODE_REVMII;
    let mut val: u32 = 0;
    switch (phy_mode) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_set_speed(np: *mut netc_port, speed: c_int) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_set_tx_pause(np: *mut netc_port, tx_pause: bool) {
    ...
    let mut old_cfge: bpt_cfge_data = *cfge;
    if (tx_pause) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_set_rx_pause(np: *mut netc_port, rx_pause: bool) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_mac_rx_enable(np: *mut netc_port) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_wait_rx_empty(np: *mut netc_port, mac: c_int) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_mac_rx_graceful_stop(np: *mut netc_port) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_mac_tx_enable(np: *mut netc_port) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_wait_tx_empty(np: *mut netc_port, mac: c_int) {
...
#[no_mangle]
unsafe extern "C" fn netc_port_mac_tx_graceful_stop(np: *mut netc_port) {
...
#[no_mangle]
unsafe extern "C" fn netc_switch_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn netc_switch_shutdown(pdev: *mut pci_dev) {
