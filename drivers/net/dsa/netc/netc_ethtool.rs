...
//! Source: drivers/net/dsa/netc/netc_ethtool.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn netc_port_get_sset_count(ds: *mut dsa_switch, port: c_int, sset: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn netc_port_get_ethtool_stats(ds: *mut dsa_switch, port: c_int, data: *mut u64) {
