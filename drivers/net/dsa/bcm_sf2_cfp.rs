...
//! Source: drivers/net/dsa/bcm_sf2_cfp.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cfp_udf_slice_layout {
    pub slices: [u8; UDFS_PER_SLICE],
    pub mask_value: u32,
    pub base_offset: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cfp_udf_layout {
    pub udfs: [cfp_udf_slice_layout; UDF_NUM_SLICES],
}
...
#[no_mangle]
pub unsafe extern "C" fn bcm_sf2_get_num_udf_slices(layout: *const u8) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn udf_upper_bits(num_udf: c_int) -> u32 {
    static inline u32 udf_upper_bits(int num_udf)
    {
    return GENMASK(num_udf - 1, 0) >> (UDFS_PER_SLICE - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn udf_lower_bits(num_udf: c_int) -> u32 {
    ...
    {
    let mut offset: u32 = layout.udfs[slice_num].base_offset;
    unsigned int i;
    for (i = 0; i < UDFS_PER_SLICE; i++)
...
#[no_mangle]
unsafe extern "C" fn bcm_sf2_cfp_op(priv: *mut bcm_sf2_priv, op: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bcm_sf2_cfp_rule_size(priv: *mut bcm_sf2_priv) -> c_uint {
...
//
    ...
    {
    let mut vlan_tci: __be16 = 0, vlan_m_tci = htons(0xffff);
...
//
    ...
    struct ethtool_rx_flow_spec *fs)
    {
    struct cfp_rule *rule = core::ptr::null_mut();
    let mut fs_size: usize = 0;
    let mut ret: c_int = 1;
...
//
    ...
    let mut ring_cookie: __u64 = fs.ring_cookie;
...
// We cannot support matching multiple VLAN IDs yet
    ...
    vlan.flags = 0;
    ret = ds.ops.port_vlan_add(ds, port_num, &vlan, core::ptr::null_mut());
    if (ret)
    return ret;
    }
//
...
// If this was an IPv6 rule, delete is companion rule too
    if (next_loc)
    ret = bcm_sf2_cfp_rule_del_one(priv, port, next_loc, core::ptr::null_mut());
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn bcm_sf2_cfp_rule_del(priv: *mut bcm_sf2_priv, port: c_int, loc: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_sf2_invert_masks(flow: *mut ethtool_rx_flow_spec) {
...
// We implement the search doing a TCAM search operation
    ...
    u32 *rule_locs)
    {
    let mut index: c_uint = 1, rules_cnt = 0;
...
#[no_mangle]
pub unsafe extern "C" fn bcm_sf2_cfp_rst(priv: *mut bcm_sf2_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bcm_sf2_cfp_exit(ds: *mut dsa_switch) {
...
#[no_mangle]
pub unsafe extern "C" fn bcm_sf2_cfp_resume(ds: *mut dsa_switch) -> c_int {
    ...
    {
    struct bcm_sf2_priv *priv = bcm_sf2_to_priv(ds);
    let mut s: c_uint = ARRAY_SIZE(bcm_sf2_cfp_stats);
...
#[no_mangle]
pub unsafe extern "C" fn bcm_sf2_cfp_get_sset_count(ds: *mut dsa_switch, port: c_int, sset: c_int) -> c_int {
