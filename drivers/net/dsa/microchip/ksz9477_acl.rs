...
//! Source: drivers/net/dsa/microchip/ksz9477_acl.c
#![no_std]
...
pub const KSZ9477_PORT_ACL_0: c_uint = 0x600;
...
pub const KSZ9477_ACL_MD_DISABLE: c_int = 0;
pub const KSZ9477_ACL_MD_L2_MAC: c_int = 1;
pub const KSZ9477_ACL_MD_L3_IP: c_int = 2;
pub const KSZ9477_ACL_MD_L4_TCP_UDP: c_int = 3;

pub const KSZ9477_ACL_ENB_L2_COUNTER: c_int = 0;
pub const KSZ9477_ACL_ENB_L2_TYPE: c_int = 1;
pub const KSZ9477_ACL_ENB_L2_MAC: c_int = 2;
pub const KSZ9477_ACL_ENB_L2_MAC_TYPE: c_int = 3;
// only IPv4 src or dst can be used with mask
pub const KSZ9477_ACL_ENB_L3_IPV4_ADDR_MASK: c_int = 1;
// only IPv4 src and dst can be used without mask
pub const KSZ9477_ACL_ENB_L3_IPV4_ADDR_SRC_DST: c_int = 2;
pub const KSZ9477_ACL_ENB_L4_IP_PROTO: c_int = 0;
pub const KSZ9477_ACL_ENB_L4_TCP_SRC_DST_PORT: c_int = 1;
pub const KSZ9477_ACL_ENB_L4_UDP_SRC_DST_PORT: c_int = 2;
pub const KSZ9477_ACL_ENB_L4_TCP_SEQ_NUMBER: c_int = 3;

pub const KSZ9477_ACL_SD_DST: c_int = 0;

pub const KSZ9477_ACL_EQ_NOT_EQUAL: c_int = 0;

pub const KSZ9477_ACL_PM_DISABLE: c_int = 0;
pub const KSZ9477_ACL_PM_HIGHER: c_int = 1;
pub const KSZ9477_ACL_PM_LOWER: c_int = 2;
pub const KSZ9477_ACL_PM_REPLACE: c_int = 3;

pub const KSZ9477_PORT_ACL_CTRL_0: c_uint = 0x0612;
...
//
#[no_mangle]
unsafe extern "C" fn ksz9477_acl_is_valid_matching_rule(entry: *mut u8) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ksz9477_sort_acl_entr_no_back(dev: *mut ksz_device, port: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ksz9477_sort_acl_entries(dev: *mut ksz_device, port: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ksz9477_acl_wait_ready(dev: *mut ksz_device, port: c_int) -> c_int {
    static int ksz9477_acl_wait_ready(struct ksz_device *dev, int port)
    {
    let mut wr_mask: c_uint = KSZ9477_ACL_WRITE_DONE | KSZ9477_ACL_READ_DONE;
...
//
#[no_mangle]
unsafe extern "C" fn ksz9477_acl_port_enable(dev: *mut ksz_device, port: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ksz9477_acl_port_disable(dev: *mut ksz_device, port: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ksz9477_acl_write_list(dev: *mut ksz_device, port: c_int) -> c_int {
...
//
    ...
    {
    let mut entries_count: c_int = acles.entries_count;
    int ret, i, src_count;
    let mut src_idx: c_int = -1;
    if (!entries_count)
    return;
...
//
#[no_mangle]
pub unsafe extern "C" fn ksz9477_port_acl_init(dev: *mut ksz_device, port: c_int) -> c_int {
...
//
    ...
    dev.ports[port].acl_priv = core::ptr::null_mut();
    return ret;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ksz9477_port_acl_free(dev: *mut ksz_device, port: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ksz9477_acl_action_rule_cfg(entry: *mut u8, force_prio: bool, prio_val: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ksz9477_acl_processing_rule_set_action(entry: *mut u8, action_idx: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn ksz9477_acl_processing_rule_add_match(entry: *mut u8, match_idx: u8) {
    static void ksz9477_acl_processing_rule_add_match(u8 *entry, u8 match_idx)
    {
    let mut vale: u8 = entry[KSZ9477_ACL_PORT_ACCESS_E];
    let mut valf: u8 = entry[KSZ9477_ACL_PORT_ACCESS_F];
    if (match_idx < 8)
    valf |= BIT(match_idx);
    else
...
// Add both match entries to first processing rule
    ...
    let mut is_src: bool = src_mac ? true : false;
