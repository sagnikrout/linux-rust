...
//! Source: drivers/net/dsa/microchip/ksz9477_tc_flower.c
#![no_std]
...
pub const KSZ9477_MAX_TC: c_int = 7;
//
...
//
    ...
    u8 *src_mac = core::ptr::null_mut();
    u8 *dst_mac = core::ptr::null_mut();
    let mut ethtype: u16 = 0;
...
//
    ...
    let mut prio_force: bool = false;
    let mut prio_val: u8 = 0;
    int i;
