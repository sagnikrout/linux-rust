...
//! Source: drivers/net/dsa/microchip/lan937x_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lan937x_cfg(dev: *mut ksz_device, addr: u32, bits: u8, set: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lan937x_create_phy_addr_map(dev: *mut ksz_device, side_mdio: bool) -> c_int {
...
// simple direct mapping
    ...
    offset = 0;
#[no_mangle]
pub unsafe extern "C" fn if(SW_VPHY_ADD_CFG): !(strap_val & SW_CASCADE_ID_CFG) && (strap_val &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn lan937x_mdio_bus_preinit(dev: *mut ksz_device, side_mdio: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan937x_vphy_ind_addr_wr(dev: *mut ksz_device, addr: c_int, reg: c_int) -> c_int {
    static int lan937x_vphy_ind_addr_wr(struct ksz_device *dev, int addr, int reg)
    {
    let mut addr_base: u16 = REG_PORT_T1_PHY_CTRL_BASE;
    u16 temp;
...
#[no_mangle]
unsafe extern "C" fn lan937x_phy_read16(ds: *mut dsa_switch, addr: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan937x_phy_write16(ds: *mut dsa_switch, addr: c_int, reg: c_int, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan937x_reset_switch(dev: *mut ksz_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan937x_port_setup(dev: *mut ksz_device, port: c_int, cpu_port: bool) {
...
#[no_mangle]
unsafe extern "C" fn lan937x_dsa_port_setup(ds: *mut dsa_switch, port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan937x_config_cpu_port(ds: *mut dsa_switch) {
...
#[no_mangle]
unsafe extern "C" fn lan937x_change_mtu(ds: *mut dsa_switch, port: c_int, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan937x_set_ageing_time(ds: *mut dsa_switch, msecs: c_uint) -> c_int {
    static int lan937x_set_ageing_time(struct dsa_switch *ds, unsigned int msecs)
    {
    struct ksz_device *dev = ds.priv;
    u8 data, mult, value8;
    let mut in_msec: bool = false;
    u32 max_val, value;
    let mut secs: u32 = msecs;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn if(MAX_TIMER_VAL: *mut *mut secs > 7) -> else {
...
#[no_mangle]
unsafe extern "C" fn lan937x_set_rgmii_tx_delay(dev: *mut ksz_device, port: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lan937x_set_rgmii_rx_delay(dev: *mut ksz_device, port: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lan937x_setup_rgmii_delay(dev: *mut ksz_device, port: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lan937x_tc_cbs_set_cinc(dev: *mut ksz_device, port: c_int, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lan937x_switch_init(dev: *mut ksz_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lan937x_mdio_register(dev: *mut ksz_device) -> c_int {
    static int lan937x_mdio_register(struct ksz_device *dev)
    {
    struct device_node *parent_bus_node;
    struct mii_bus *parent_bus = core::ptr::null_mut();
    struct dsa_switch *ds = dev.ds;
...
#[no_mangle]
unsafe extern "C" fn lan937x_setup(ds: *mut dsa_switch) -> c_int {
