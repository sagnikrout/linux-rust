...
//! Source: drivers/net/dsa/realtek/rtl8366-core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rtl8366_mc_is_used(priv: *mut realtek_priv, mc_index: c_int, used: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8366_enable_vlan4k(priv: *mut realtek_priv, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8366_enable_vlan(priv: *mut realtek_priv, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8366_reset_vlan(priv: *mut realtek_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8366_get_sset_count(ds: *mut dsa_switch, port: c_int, sset: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8366_get_ethtool_stats(ds: *mut dsa_switch, port: c_int, data: *mut u64) {
