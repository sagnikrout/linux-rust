...
//! Source: drivers/net/dsa/realtek/rtl8365mb_table.h
#![no_std]
...
pub const RTL8365MB_TABLE_ENTRY_MAX_SIZE: c_int = 10;
//
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum rtl8365mb_table_l2_method {
