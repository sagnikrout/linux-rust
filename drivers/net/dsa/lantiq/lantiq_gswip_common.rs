...
//! Source: drivers/net/dsa/lantiq/lantiq_gswip_common.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gswip_pce_table_entry {
    pub pData->table_index: u16 index; // PCE_TBL_ADDR.ADDR =,
    pub pData->table: u16 table; // PCE_TBL_CTRL.ADDR =,
    pub key: [u16; 8],
    pub val: [u16; 5],
    pub mask: u16,
    pub gmap: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gswip_rmon_cnt_desc {
    pub size: c_uint,
    pub offset: c_uint,
...
#[no_mangle]
unsafe extern "C" fn gswip_mdio_poll(priv: *mut gswip_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gswip_mdio_wr(bus: *mut mii_bus, addr: c_int, reg: c_int, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gswip_mdio_rd(bus: *mut mii_bus, addr: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gswip_mdio(priv: *mut gswip_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gswip_add_single_port_br(priv: *mut gswip_priv, port: c_int, add: bool) -> c_int {
    static int gswip_add_single_port_br(struct gswip_priv *priv, int port, bool add)
    {
    let mut vlan_active: gswip_pce_table_entry = {0,};
    let mut vlan_mapping: gswip_pce_table_entry = {0,};
    int err;
...
#[no_mangle]
unsafe extern "C" fn gswip_port_setup(ds: *mut dsa_switch, port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gswip_port_disable(ds: *mut dsa_switch, port: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gswip_pce_load_microcode(priv: *mut gswip_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gswip_port_commit_pvid(priv: *mut gswip_priv, port: c_int) {
    ...
    return;
    if (br) {
    let mut pvid: u16 = GSWIP_VLAN_UNAWARE_PVID;
...
// Use port based VLAN
    ...
    {
    let mut tx_delay: u32 = GSWIP_MII_PCDU_TXDLY_DEFAULT;
    let mut rx_delay: u32 = GSWIP_MII_PCDU_RXDLY_DEFAULT;
...
#[no_mangle]
unsafe extern "C" fn gswip_setup(ds: *mut dsa_switch) -> c_int {
    static int gswip_setup(struct dsa_switch *ds)
    {
    let mut cpu_ports: c_uint = dsa_cpu_ports(ds);
    struct gswip_priv *priv = ds.priv;
...
// disable port fetch/store dma on all ports
    ...
    gswip_port_vlan_filtering(ds, i, false, core::ptr::null_mut());
    }
// enable Switch
...
#[no_mangle]
unsafe extern "C" fn gswip_teardown(ds: *mut dsa_switch) {
    ...
    {
    let mut vlan_active: gswip_pce_table_entry = {0,};
    let mut max_ports: c_uint = priv.hw_info.max_ports;
    let mut idx: c_int = -1;
    int err;
    int i;
...
#[no_mangle]
unsafe extern "C" fn gswip_vlan_active_remove(priv: *mut gswip_priv, idx: c_int) -> c_int {
    ...
    priv.vlans[idx].bridge = core::ptr::null_mut();
    return err;
    }
    ...
    let mut vlan_mapping: gswip_pce_table_entry = {0,};
    let mut max_ports: c_uint = priv.hw_info.max_ports;
    let mut cpu_ports: c_uint = dsa_cpu_ports(priv.ds);
    let mut active_vlan_created: bool = false;
    let mut fid: c_int = -1, idx = -1;
    int i, err;
...
#[no_mangle]
unsafe extern "C" fn gswip_port_fast_age(ds: *mut dsa_switch, port: c_int) {
    static void gswip_port_fast_age(struct dsa_switch *ds, int port)
    {
    struct gswip_priv *priv = ds.priv;
    let mut mac_bridge: gswip_pce_table_entry = {0,};
    int i;
    int err;
    for (i = 0; i < 2048; i++) {
...
#[no_mangle]
unsafe extern "C" fn gswip_port_stp_state_set(ds: *mut dsa_switch, port: c_int, state: u8) {
...
#[no_mangle]
unsafe extern "C" fn gswip_port_max_mtu(ds: *mut dsa_switch, port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gswip_port_change_mtu(ds: *mut dsa_switch, port: c_int, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gswip_port_set_link(priv: *mut gswip_priv, port: c_int, link: bool) {
    ...
    phy_interface_t interface)
    {
    let mut mdio_phy: u32 = 0, mii_cfg = 0, mac_ctrl_0 = 0;
    switch (speed) {
    case SPEED_10:
...
#[no_mangle]
unsafe extern "C" fn gswip_port_set_duplex(priv: *mut gswip_priv, port: c_int, duplex: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gswip_get_sset_count(ds: *mut dsa_switch, port: c_int, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gswip_phylink_mac_disable_tx_lpi(config: *mut phylink_config) {
...
#[no_mangle]
unsafe extern "C" fn gswip_support_eee(ds: *mut dsa_switch, port: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gswip_validate_cpu_port(ds: *mut dsa_switch) -> c_int {
    static int gswip_validate_cpu_port(struct dsa_switch *ds)
    {
    struct gswip_priv *priv = ds.priv;
    struct dsa_port *cpu_dp;
    let mut cpu_port: c_int = -1;
    dsa_switch_for_each_cpu_port(cpu_dp, ds) {
    if (cpu_port != -1)
...
#[no_mangle]
pub unsafe extern "C" fn gswip_probe_common(priv: *mut gswip_priv, version: u32) -> c_int {
