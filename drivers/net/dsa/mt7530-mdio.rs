...
//! Source: drivers/net/dsa/mt7530-mdio.c
#![no_std]
...
// val = (hi << 16) | (lo & 0xffff);
    ...
    pcs = mtk_pcs_lynxi_create(priv.dev, core::ptr::null_mut(), regmap,
...
#[no_mangle]
unsafe extern "C" fn mt7530_shutdown(mdiodev: *mut mdio_device) {
