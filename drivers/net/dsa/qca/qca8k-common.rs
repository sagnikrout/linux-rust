...
//! Source: drivers/net/dsa/qca/qca8k-common.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn qca8k_read(priv: *mut qca8k_priv, reg: u32, val: *mut u32) -> c_int {
    int qca8k_read(struct qca8k_priv *priv, u32 reg, u32 *val)
    {
    return regmap_read(priv.regmap, reg, val);
    }
#[no_mangle]
pub unsafe extern "C" fn qca8k_write(priv: *mut qca8k_priv, reg: u32, val: u32) -> c_int {
    int qca8k_write(struct qca8k_priv *priv, u32 reg, u32 val)
    {
    return regmap_write(priv.regmap, reg, val);
    }
#[no_mangle]
pub unsafe extern "C" fn qca8k_rmw(priv: *mut qca8k_priv, reg: u32, mask: u32, write_val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qca8k_busy_wait(priv: *mut qca8k_priv, reg: u32, mask: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qca8k_fdb_read(priv: *mut qca8k_priv, fdb: *mut qca8k_fdb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qca8k_fdb_flush(priv: *mut qca8k_priv) {
...
#[no_mangle]
unsafe extern "C" fn qca8k_vlan_del(priv: *mut qca8k_priv, port: u8, vid: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qca8k_mib_init(priv: *mut qca8k_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qca8k_port_set_status(priv: *mut qca8k_priv, port: c_int, enable: c_int) {
    void qca8k_port_set_status(struct qca8k_priv *priv, int port, int enable)
    {
    let mut mask: u32 = QCA8K_PORT_STATUS_TXMAC | QCA8K_PORT_STATUS_RXMAC;
...
#[no_mangle]
pub unsafe extern "C" fn qca8k_get_sset_count(ds: *mut dsa_switch, port: c_int, sset: c_int) -> c_int {
    ...
    {
    let mut lpi_en: u32 = QCA8K_REG_EEE_CTRL_LPI_EN(port);
    struct qca8k_priv *priv = ds.priv;
    u32 reg;
    int ret;
    mutex_lock(&priv.reg_mutex);
...
#[no_mangle]
pub unsafe extern "C" fn qca8k_port_stp_state_set(ds: *mut dsa_switch, port: c_int, state: u8) {
    void qca8k_port_stp_state_set(struct dsa_switch *ds, int port, u8 state)
    {
    struct dsa_port *dp = dsa_to_port(ds, port);
    struct qca8k_priv *priv = ds.priv;
    let mut learning: bool = false;
    u32 stp_state;
    switch (state) {
    ...
    bool join)
    {
    let mut isolated: bool = !!(priv.port_isolated_map & BIT(port)), other_isolated;
    struct dsa_port *dp = dsa_to_port(priv.ds, port), *other_dp;
    let mut port_mask: u32 = BIT(dp.cpu_dp.index);
    int i, ret;
    for (i = 0; i < QCA8K_NUM_PORTS; i++) {
    if (i == port)
    continue;
...
#[no_mangle]
pub unsafe extern "C" fn qca8k_port_fast_age(ds: *mut dsa_switch, port: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn qca8k_set_ageing_time(ds: *mut dsa_switch, msecs: c_uint) -> c_int {
    int qca8k_set_ageing_time(struct dsa_switch *ds, unsigned int msecs)
    {
    struct qca8k_priv *priv = ds.priv;
    let mut secs: c_uint = msecs / 1000;
    u32 val;
...
#[no_mangle]
pub unsafe extern "C" fn qca8k_port_disable(ds: *mut dsa_switch, port: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn qca8k_port_change_mtu(ds: *mut dsa_switch, port: c_int, new_mtu: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qca8k_port_max_mtu(ds: *mut dsa_switch, port: c_int) -> c_int {
...
// Set the vid to the port vlan id if no vid is set
    ...
    {
    struct qca8k_priv *priv = ds.priv;
    let mut port_mask: u16 = BIT(port);
    ...
    {
    struct qca8k_priv *priv = ds.priv;
    let mut _fdb: qca8k_fdb = { 0 };
    let mut cnt: c_int = QCA8K_NUM_FDB_RECORDS;
    bool is_static;
    let mut ret: c_int = 0;
    mutex_lock(&priv.reg_mutex);
...
#[no_mangle]
pub unsafe extern "C" fn qca8k_read_switch_id(priv: *mut qca8k_priv) -> c_int {
