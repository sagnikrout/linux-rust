...
//! Source: drivers/net/dsa/qca/ar9331.c
#![no_std]
...
pub const AR9331_SW_PORTS: c_int = 6;
// dummy reg to change page
pub const AR9331_SW_REG_PAGE: c_uint = 0x40000;
// Global Interrupt
pub const AR9331_SW_REG_GINT: c_uint = 0x10;
pub const AR9331_SW_REG_GINT_MASK: c_uint = 0x14;

pub const AR9331_SW_REG_FLOOD_MASK: c_uint = 0x2c;

pub const AR9331_SW_REG_GLOBAL_CTRL: c_uint = 0x30;

pub const AR9331_SW_REG_MDIO_CTRL: c_uint = 0x98;
...
pub const AR9331_SW_PORT_STATUS_SPEED_1000: c_int = 2;
pub const AR9331_SW_PORT_STATUS_SPEED_100: c_int = 1;
pub const AR9331_SW_PORT_STATUS_SPEED_10: c_int = 0;
...
pub const AR9331_SW_PORT_CTRL_PORT_STATE_DISABLED: c_int = 0;
pub const AR9331_SW_PORT_CTRL_PORT_STATE_BLOCKING: c_int = 1;
pub const AR9331_SW_PORT_CTRL_PORT_STATE_LISTENING: c_int = 2;
pub const AR9331_SW_PORT_CTRL_PORT_STATE_LEARNING: c_int = 3;
pub const AR9331_SW_PORT_CTRL_PORT_STATE_FORWARD: c_int = 4;

pub const AR9331_SW_8021Q_MODE_SECURE: c_int = 3;
pub const AR9331_SW_8021Q_MODE_CHECK: c_int = 2;
pub const AR9331_SW_8021Q_MODE_FALLBACK: c_int = 1;
pub const AR9331_SW_8021Q_MODE_NONE: c_int = 0;
...
pub const AR9331_SW_MDIO_PHY_MODE_PAGE: c_int = 3;
pub const AR9331_SW_MDIO_PHY_MODE_REG: c_int = 2;
pub const AR9331_SW_MDIO_PHY_MODE_BYPASS: c_int = 0;

// Empirical determined values
pub const AR9331_SW_MDIO_POLL_SLEEP_US: c_int = 1;
pub const AR9331_SW_MDIO_POLL_TIMEOUT_US: c_int = 20;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ar9331_sw_stats_raw {
    pub /: *mut *mut u32 rxbroad; / 0x00,
    pub /: *mut *mut u32 rxpause; / 0x04,
    pub /: *mut *mut u32 rxmulti; / 0x08,
    pub /: *mut *mut u32 rxfcserr; / 0x0c,
    pub /: *mut *mut u32 rxalignerr; / 0x10,
    pub /: *mut *mut u32 rxrunt; / 0x14,
    pub /: *mut *mut u32 rxfragment; / 0x18,
    pub /: *mut *mut u32 rx64byte; / 0x1c,
    pub /: *mut *mut u32 rx128byte; / 0x20,
    pub /: *mut *mut u32 rx256byte; / 0x24,
    pub /: *mut *mut u32 rx512byte; / 0x28,
    pub /: *mut *mut u32 rx1024byte; / 0x2c,
    pub /: *mut *mut u32 rx1518byte; / 0x30,
    pub /: *mut *mut u32 rxmaxbyte; / 0x34,
    pub /: *mut *mut u32 rxtoolong; / 0x38,
    pub /: *mut *mut u32 rxgoodbyte; / 0x3c,
    pub rxgoodbyte_hi: u32,
    pub /: *mut *mut u32 rxbadbyte; / 0x44,
    pub rxbadbyte_hi: u32,
    pub /: *mut *mut u32 rxoverflow; / 0x4c,
    pub /: *mut *mut u32 filtered; / 0x50,
    pub /: *mut *mut u32 txbroad; / 0x54,
    pub /: *mut *mut u32 txpause; / 0x58,
    pub /: *mut *mut u32 txmulti; / 0x5c,
    pub /: *mut *mut u32 txunderrun; / 0x60,
    pub /: *mut *mut u32 tx64byte; / 0x64,
    pub /: *mut *mut u32 tx128byte; / 0x68,
    pub /: *mut *mut u32 tx256byte; / 0x6c,
    pub /: *mut *mut u32 tx512byte; / 0x70,
    pub /: *mut *mut u32 tx1024byte; / 0x74,
    pub /: *mut *mut u32 tx1518byte; / 0x78,
    pub /: *mut *mut u32 txmaxbyte; / 0x7c,
    pub /: *mut *mut u32 txoversize; / 0x80,
    pub /: *mut *mut u32 txbyte; / 0x84,
    pub txbyte_hi: u32,
    pub /: *mut *mut u32 txcollision; / 0x8c,
    pub /: *mut *mut u32 txabortcol; / 0x90,
    pub /: *mut *mut u32 txmulticol; / 0x94,
    pub /: *mut *mut u32 txsinglecol; / 0x98,
    pub /: *mut *mut u32 txexcdefer; / 0x9c,
    pub /: *mut *mut u32 txdefer; / 0xa0,
    pub /: *mut *mut u32 txlatecol; / 0xa4,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ar9331_sw_port {
    pub idx: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ar9331_sw_priv {
    pub dev: *mut device,
    pub ds: dsa_switch,
    pub ops: dsa_switch_ops,
    pub irqdomain: *mut irq_domain,
    pub irq_mask: u32,
    pub lock_irq: mutex,
    pub /: *mut *mut *mut mii_bus mbus; / mdio master,
    pub /: *mut *mut *mut mii_bus sbus; / mdio slave,
    pub regmap: *mut regmap,
    pub sw_reset: *mut reset_control,
    pub port: [ar9331_sw_port; AR9331_SW_PORTS],
}
...
//
#[no_mangle]
unsafe extern "C" fn ar9331_sw_reset(priv: *mut ar9331_sw_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_mbus_read(mbus: *mut mii_bus, port: c_int, regnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_mbus_init(priv: *mut ar9331_sw_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_setup_port(ds: *mut dsa_switch, port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_setup(ds: *mut dsa_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_port_disable(ds: *mut dsa_switch, port: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ar9331_read_stats(port: *mut ar9331_sw_port) {
...
#[no_mangle]
unsafe extern "C" fn ar9331_do_stats_poll(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_mask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_unmask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_irq_bus_lock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_irq_bus_sync_unlock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_irq_unmap(d: *mut irq_domain, irq: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_irq_init(priv: *mut ar9331_sw_priv) -> c_int {
    ...
    ret = devm_request_threaded_irq(dev, irq, core::ptr::null_mut(), ar9331_sw_irq,
...
#[no_mangle]
unsafe extern "C" fn __ar9331_mdio_write(sbus: *mut mii_bus, mode: u8, reg: u16, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ar9331_mdio_read(sbus: *mut mii_bus, reg: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar9331_mdio_write(ctx: *mut c_void, reg: u32, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_bus_write(context: *mut c_void, data: *const c_void, count: usize) -> c_int {
    static int ar9331_sw_bus_write(void *context, const void *data, size_t count)
    {
    let mut reg: u32 = *(u32 *)data;
    let mut val: u32 = *((u32 *)data + 1);
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_probe(mdiodev: *mut mdio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_remove(mdiodev: *mut mdio_device) {
...
#[no_mangle]
unsafe extern "C" fn ar9331_sw_shutdown(mdiodev: *mut mdio_device) {
