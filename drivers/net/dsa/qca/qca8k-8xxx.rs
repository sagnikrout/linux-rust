...
//! Source: drivers/net/dsa/qca/qca8k-8xxx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qca8k_rw_reg_ack_handler(ds: *mut dsa_switch, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn qca8k_mdio_header_fill_seq_num(skb: *mut sk_buff, seq_num: u32) {
...
#[no_mangle]
unsafe extern "C" fn qca8k_read_eth(priv: *mut qca8k_priv, reg: u32, val: *mut u32, len: c_int) -> c_int {
    ...
    bool ack;
    int ret;
    skb = qca8k_alloc_mdio_header(MDIO_READ, reg, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn qca8k_write_eth(priv: *mut qca8k_priv, reg: u32, val: *mut u32, len: c_int) -> c_int {
...
//
    ...
    {
    let mut internal_mdio_mask: u32 = 0, external_mdio_mask = 0, reg;
...
#[no_mangle]
unsafe extern "C" fn qca8k_find_cpu_port(ds: *mut dsa_switch) -> c_int {
...
// Internal PHY
    ...
    let mut port: c_int = pcs_to_qca8k_pcs(pcs).port;
    u32 reg;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn qca8k_pcs_an_restart(pcs: *mut phylink_pcs) {
...
#[no_mangle]
unsafe extern "C" fn qca8k_mib_autocast_handler(ds: *mut dsa_switch, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn qca8k_get_phy_flags(ds: *mut dsa_switch, port: c_int) -> u32 {
...
// Ethernet MIB/MDIO is only supported for CPU port 0
    ...
    priv.mgmt_conduit = operational ? (struct net_device *)conduit : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qca8k_setup_hol_fixup(priv: *mut qca8k_priv, port: c_int) {
...
// Start by setting up the register mapping
    priv.regmap = devm_regmap_init(&mdiodev.dev, core::ptr::null_mut(), priv,
    &qca8k_regmap_config);
...
#[no_mangle]
unsafe extern "C" fn qca8k_sw_shutdown(mdiodev: *mut mdio_device) {
...
#[no_mangle]
unsafe extern "C" fn qca8k_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qca8k_resume(dev: *mut device) -> c_int {
