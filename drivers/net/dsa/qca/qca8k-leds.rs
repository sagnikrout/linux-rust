...
//! Source: drivers/net/dsa/qca/qca8k-leds.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qca8k_phy_to_port(phy: c_int) -> u32 {
...
// Assume brightness ON only when the LED is set to always ON
    let mut val: return = = QCA8K_LED_ALWAYS_ON;
    }
    static int
