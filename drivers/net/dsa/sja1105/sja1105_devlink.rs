...
//! Source: drivers/net/dsa/sja1105/sja1105_devlink.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn sja1105_static_config_get_max_size(priv: *mut sja1105_private) -> usize {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sja1105_region {
    pub ops: *const devlink_region_ops,
    pub priv): *mut *mut size_t (get_size)(struct sja1105_private,
}
...
#[no_mangle]
unsafe extern "C" fn sja1105_setup_devlink_regions(ds: *mut dsa_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_teardown_devlink_regions(ds: *mut dsa_switch) {
...
#[no_mangle]
pub unsafe extern "C" fn sja1105_devlink_setup(ds: *mut dsa_switch) -> c_int {
    int sja1105_devlink_setup(struct dsa_switch *ds)
    {
    return sja1105_setup_devlink_regions(ds);
    }
#[no_mangle]
pub unsafe extern "C" fn sja1105_devlink_teardown(ds: *mut dsa_switch) {
