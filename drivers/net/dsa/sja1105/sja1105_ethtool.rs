...
//! Source: drivers/net/dsa/sja1105/sja1105_ethtool.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sja1105_port_counter {
    pub area: enum sja1105_stats_area,
...
// Ether Stats
    ...
    let mut size: usize = c.is_64bit ? 8 : 4;
    u8 buf[8] = {0};
    u64 regs;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn sja1105_get_ethtool_stats(ds: *mut dsa_switch, port: c_int, data: *mut u64) {
...
#[no_mangle]
pub unsafe extern "C" fn sja1105_get_sset_count(ds: *mut dsa_switch, port: c_int, sset: c_int) -> c_int {
    int sja1105_get_sset_count(struct dsa_switch *ds, int port, int sset)
    {
    struct sja1105_private *priv = ds.priv;
    enum sja1105_counter_index max_ctr, i;
    let mut sset_count: c_int = 0;
