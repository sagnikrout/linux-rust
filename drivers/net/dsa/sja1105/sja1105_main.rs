...
//! Source: drivers/net/dsa/sja1105/sja1105_main.c
#![no_std]
...
pub const SJA1105_UNKNOWN_MULTICAST: c_uint = 0x010000000000ull;
...
#[no_mangle]
unsafe extern "C" fn sja1105_is_vlan_configured(priv: *mut sja1105_private, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_drop_untagged(ds: *mut dsa_switch, port: c_int, drop: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_pvid_apply(priv: *mut sja1105_private, port: c_int, pvid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_commit_pvid(ds: *mut dsa_switch, port: c_int) -> c_int {
    ...
    struct sja1105_private *priv = ds.priv;
    struct sja1105_vlan_lookup_entry *vlan;
    let mut drop_untagged: bool = false;
    int match, rc;
    u16 pvid;
...
#[no_mangle]
unsafe extern "C" fn sja1105_init_mac_settings(priv: *mut sja1105_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_init_mii_settings(priv: *mut sja1105_private) -> c_int {
...
// Override table based on PHYLINK DT bindings
    ...
    let mut role: sja1105_mii_role_t = XMII_MAC;
...
#[no_mangle]
unsafe extern "C" fn sja1105_init_static_fdb(priv: *mut sja1105_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_init_l2_lookup_params(priv: *mut sja1105_private) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sja1105_init_static_vlan(priv: *mut sja1105_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_init_l2_forwarding(priv: *mut sja1105_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1110_init_pcp_remapping(priv: *mut sja1105_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_init_l2_forwarding_params(priv: *mut sja1105_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sja1105_frame_memory_partitioning(priv: *mut sja1105_private) {
...
//
#[no_mangle]
unsafe extern "C" fn sja1110_select_tdmaconfigidx(priv: *mut sja1105_private) {
...
// Retagging port will operate at 1 Gbps
    tdmaconfigidx = 5;
#[no_mangle]
pub unsafe extern "C" fn if(port_4_is_2500: port_3_is_2500 &&) -> else {
    else if (port_3_is_2500 && port_4_is_2500)
// Retagging port will operate at 100 Mbps
    tdmaconfigidx = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: port_3_is_2500) -> else {
    else if (port_3_is_2500)
// Retagging port will operate at 1 Gbps
    tdmaconfigidx = 3;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: port_4_is_2500) -> else {
...
//
    ...
    for (port = 0; port < ds.num_ports; port++) {
    let mut is_upstream: bool = dsa_is_upstream_port(ds, port);
    let mut is_dsa_link: bool = dsa_is_dsa_port(ds, port);
...
#[no_mangle]
unsafe extern "C" fn sja1105_init_general_params(priv: *mut sja1105_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_init_avb_params(priv: *mut sja1105_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_init_l2_policing(priv: *mut sja1105_private) -> c_int {
...
// Setup shared indices for the matchall policers
    for (port = 0; port < ds.num_ports; port++) {
    let mut mcast: c_int = (ds.num_ports * (SJA1105_NUM_TC + 1)) + port;
...
// Setup the matchall policer parameters
    for (port = 0; port < ds.num_ports; port++) {
    let mut mtu: c_int = VLAN_ETH_FRAME_LEN + ETH_FCS_LEN;
    if (dsa_is_cpu_port(ds, port) || dsa_is_dsa_port(ds, port))
    mtu += VLAN_HLEN;
...
#[no_mangle]
unsafe extern "C" fn sja1105_static_config_load(priv: *mut sja1105_private) -> c_int {
...
//
    ...
    {
    let mut phy_mode: phy_interface_t = priv.phy_mode[port];
    struct device *dev = &priv.spidev.dev;
    let mut rx_delay: c_int = -1, tx_delay = -1;
...
#[no_mangle]
unsafe extern "C" fn sja1105_parse_dt(priv: *mut sja1105_private) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sja1105et_fdb_index(bin: c_int, way: c_int) -> c_int {
    ...
    let mut l2_lookup: sja1105_l2_lookup_entry = {0};
    let mut index: c_int = sja1105et_fdb_index(bin, way);
...
// Return an invalid entry index if not found
    ...
    {
    let mut l2_lookup: sja1105_l2_lookup_entry = {0}, tmp;
    struct sja1105_private *priv = ds.priv;
    struct device *dev = ds.dev;
    let mut last_unused: c_int = -1;
    int start, end, i;
    int bin, way, rc;
...
//
    ...
    rc = sja1105_dynamic_config_write(priv, BLK_IDX_L2_LOOKUP,
    tmp.index, core::ptr::null_mut(), false);
    if (rc < 0)
    return rc;
    }
    return sja1105_static_fdb_change(priv, port, &l2_lookup, true);
...
#[no_mangle]
unsafe extern "C" fn sja1105_fast_age(ds: *mut dsa_switch, port: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sja1105_manage_flood_domains(priv: *mut sja1105_private) -> c_int {
    ...
    for (from = 0; from < ds.num_ports; from++) {
    let mut fl_domain: u64 = 0, bc_domain = 0;
...
#[no_mangle]
unsafe extern "C" fn sja1105_find_unused_cbs_shaper(priv: *mut sja1105_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_reload_cbs(priv: *mut sja1105_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_vlan_del(priv: *mut sja1105_private, port: c_int, vid: u16) -> c_int {
...
//
    ...
    {
    struct sja1105_private *priv = ds.priv;
    let mut allowed_ingress: bool = true;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn sja1105_dsa_8021q_vlan_del(ds: *mut dsa_switch, port: c_int, vid: u16) -> c_int {
    ...
    {
    let mut mgmt_route: sja1105_mgmt_entry = {0};
    struct sja1105_private *priv = ds.priv;
    struct ethhdr *hdr;
...
//
#[no_mangle]
unsafe extern "C" fn sja1105_port_deferred_xmit(work: *mut kthread_work) {
    ...
    struct sja1105_private *priv = ds.priv;
    let mut port: c_int = xmit_work.dp.index;
...
#[no_mangle]
unsafe extern "C" fn sja1105_change_mtu(ds: *mut dsa_switch, port: c_int, new_mtu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_get_max_mtu(ds: *mut dsa_switch, port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_port_policer_del(ds: *mut dsa_switch, port: c_int) {
    ...
    let mut multicast: bool = !!(flags.val & BR_MCAST_FLOOD);
    let mut unicast: bool = !!(flags.val & BR_FLOOD);
    ...
    let mut learn_ena: bool = !!(flags.val & BR_LEARNING);
...
//
#[no_mangle]
unsafe extern "C" fn sja1105_setup(ds: *mut dsa_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_teardown(ds: *mut dsa_switch) {
...
#[no_mangle]
unsafe extern "C" fn sja1105_check_device_id(priv: *mut sja1105_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn sja1105_shutdown(spi: *mut spi_device) {
