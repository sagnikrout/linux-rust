...
//! Source: drivers/net/dsa/sja1105/sja1105_clocking.c
#![no_std]
...
pub const SJA1105_SIZE_CGU_CMD: c_int = 4;

// Common structure for CFG_PAD_MIIx_RX and CFG_PAD_MIIx_TX
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sja1105_cfg_pad_mii {
    pub d32_os: u64,
    pub d32_ih: u64,
    pub d32_ipud: u64,
    pub d10_ih: u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sja1105_cfg_pad_mii_id {
    pub rxc_stable_ovr: u64,
    pub rxc_delay: u64,
    pub rxc_bypass: u64,
    pub rxc_pd: u64,
    pub txc_stable_ovr: u64,
    pub txc_delay: u64,
    pub txc_bypass: u64,
    pub txc_pd: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sja1105_cgu_pll_ctrl {
    pub pllclksrc: u64,
    pub msel: u64,
    pub autoblock: u64,
    pub psel: u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sja1105_cgu_mii_ctrl {
    pub clksrc: u64,
    pub autoblock: u64,
    pub pd: u64,
}
...
// AGU
    ...
    {
    const struct sja1105_regs *regs = priv.info.regs;
    let mut pad_mii_tx: sja1105_cfg_pad_mii = {0};
    u8 packed_buf[SJA1105_SIZE_CGU_CMD] = {0};
...
#[no_mangle]
unsafe extern "C" fn sja1105_cfg_pad_rx_config(priv: *mut sja1105_private, port: c_int) -> c_int {
    static int sja1105_cfg_pad_rx_config(struct sja1105_private *priv, int port)
    {
    const struct sja1105_regs *regs = priv.info.regs;
    let mut pad_mii_rx: sja1105_cfg_pad_mii = {0};
    u8 packed_buf[SJA1105_SIZE_CGU_CMD] = {0};
...
// plain input (default)
    ...
    enum packing_op op)
    {
    let mut size: c_int = SJA1105_SIZE_CGU_CMD;
...
//
#[no_mangle]
pub unsafe extern "C" fn sja1105pqrs_setup_rgmii_delay(ctx: *const c_void, port: c_int) -> c_int {
    int sja1105pqrs_setup_rgmii_delay(const void *ctx, int port)
    {
    const struct sja1105_private *priv = ctx;
    const struct sja1105_regs *regs = priv.info.regs;
    let mut pad_mii_id: sja1105_cfg_pad_mii_id = {0};
    let mut rx_delay: c_int = priv.rgmii_rx_delay_ps[port];
    let mut tx_delay: c_int = priv.rgmii_tx_delay_ps[port];
    u8 packed_buf[SJA1105_SIZE_CGU_CMD] = {0};
    int rc;
    if (rx_delay)
...
#[no_mangle]
pub unsafe extern "C" fn sja1110_setup_rgmii_delay(ctx: *const c_void, port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_cgu_rmii_pll_config(priv: *mut sja1105_private) -> c_int {
    static int sja1105_cgu_rmii_pll_config(struct sja1105_private *priv)
    {
    const struct sja1105_regs *regs = priv.info.regs;
    u8 packed_buf[SJA1105_SIZE_CGU_CMD] = {0};
    let mut pll: sja1105_cgu_pll_ctrl = {0};
    struct device *dev = priv.ds.dev;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn sja1105_clocking_setup_port(priv: *mut sja1105_private, port: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sja1105_clocking_setup(priv: *mut sja1105_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sja1110_disable_microcontroller(priv: *mut sja1105_private) -> c_int {
