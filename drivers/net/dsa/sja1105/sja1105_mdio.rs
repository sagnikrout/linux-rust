...
//! Source: drivers/net/dsa/sja1105/sja1105_mdio.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn sja1105_pcs_mdio_read_c45(bus: *mut mii_bus, phy: c_int, mmd: c_int, reg: c_int) -> c_int {
    ...
    rc = sja1105_xfer_u32(priv, SPI_READ, addr, &tmp, core::ptr::null_mut());
    if (rc < 0)
    return rc;
    return tmp & 0xffff;
    }
    ...
    if (mmd != MDIO_MMD_VEND1 && mmd != MDIO_MMD_VEND2)
    return -EINVAL;
    return sja1105_xfer_u32(priv, SPI_WRITE, addr, &tmp, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn sja1110_pcs_mdio_read_c45(bus: *mut mii_bus, phy: c_int, mmd: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_base_t1_mdio_read_c22(bus: *mut mii_bus, phy: c_int, reg: c_int) -> c_int {
    ...
    rc = sja1105_xfer_u32(priv, SPI_WRITE, addr, &reg, core::ptr::null_mut());
    if (rc < 0)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn sja1105_base_tx_mdio_read(bus: *mut mii_bus, phy: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sja1105_mdiobus_base_tx_unregister(priv: *mut sja1105_private) {
    ...
    priv.mdio_base_tx = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn sja1105_mdiobus_base_t1_unregister(priv: *mut sja1105_private) {
    ...
    priv.mdio_base_t1 = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn sja1105_mdiobus_pcs_register(priv: *mut sja1105_private) -> c_int {
...
//
    ...
    priv.pcs[port] = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn sja1105_mdiobus_pcs_unregister(priv: *mut sja1105_private) {
    ...
    priv.mdio_pcs = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn sja1105_mdiobus_register(ds: *mut dsa_switch) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sja1105_mdiobus_unregister(ds: *mut dsa_switch) {
