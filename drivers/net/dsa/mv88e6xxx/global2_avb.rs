...
//! Source: drivers/net/dsa/mv88e6xxx/global2_avb.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn mv88e6xxx_g2_avb_wait(chip: *mut mv88e6xxx_chip) -> c_int {
    static int mv88e6xxx_g2_avb_wait(struct mv88e6xxx_chip *chip)
    {
    let mut bit: c_int = __bf_shf(MV88E6352_G2_AVB_CMD_BUSY);
