...
//! Source: drivers/net/dsa/mv88e6xxx/global1_atu.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mv88e6xxx_g1_atu_fid_write(chip: *mut mv88e6xxx_chip, fid: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mv88e6xxx_g1_atu_set_learn2all(chip: *mut mv88e6xxx_chip, learn2all: bool) -> c_int {
    ...
    unsigned int msecs)
    {
    let mut coeff: c_uint = chip.info.age_time_coeff;
    let mut min: c_uint = 0x01 * coeff;
    let mut max: c_uint = 0xff * coeff;
    u8 age_time;
    u16 val;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn mv88e6165_g1_atu_get_hash(chip: *mut mv88e6xxx_chip, hash: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mv88e6165_g1_atu_set_hash(chip: *mut mv88e6xxx_chip, hash: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88e6xxx_g1_atu_op_wait(chip: *mut mv88e6xxx_chip) -> c_int {
    static int mv88e6xxx_g1_atu_op_wait(struct mv88e6xxx_chip *chip)
    {
    let mut bit: c_int = __bf_shf(MV88E6XXX_G1_ATU_OP_BUSY);
    return mv88e6xxx_g1_wait_bit(chip, MV88E6XXX_G1_ATU_OP, bit, 0);
    }
#[no_mangle]
unsafe extern "C" fn mv88e6xxx_g1_read_atu_violation(chip: *mut mv88e6xxx_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88e6xxx_g1_atu_op(chip: *mut mv88e6xxx_chip, fid: u16, op: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mv88e6xxx_g1_atu_get_next(chip: *mut mv88e6xxx_chip, fid: u16) -> c_int {
    int mv88e6xxx_g1_atu_get_next(struct mv88e6xxx_chip *chip, u16 fid)
    {
    return mv88e6xxx_g1_atu_op(chip, fid, MV88E6XXX_G1_ATU_OP_GET_NEXT_DB);
    }
#[no_mangle]
unsafe extern "C" fn mv88e6xxx_g1_atu_fid_read(chip: *mut mv88e6xxx_chip, fid: *mut u16) -> c_int {
    static int mv88e6xxx_g1_atu_fid_read(struct mv88e6xxx_chip *chip, u16 *fid)
    {
    let mut val: u16 = 0, upper = 0, op = 0;
...
// Offset 0x0C: ATU Data Register
    ...
    struct mv88e6xxx_atu_entry *entry)
    {
    let mut data: u16 = entry.state & 0xf;
    if (entry.state) {
    if (entry.trunk)
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: fid) -> else {
    else if (fid)
    op = MV88E6XXX_G1_ATU_OP_FLUSH_MOVE_NON_STATIC_DB;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: all) -> else {
    else if (all)
...
#[no_mangle]
pub unsafe extern "C" fn mv88e6xxx_g1_atu_flush(chip: *mut mv88e6xxx_chip, fid: u16, all: bool) -> c_int {
    ...
    {
    let mut entry: mv88e6xxx_atu_entry = { 0 };
    unsigned long mask;
    int shift;
    ...
    bool all)
    {
    let mut from_port: c_int = port;
    let mut to_port: c_int = chip.info.atu_move_port_mask;
    return mv88e6xxx_g1_atu_move(chip, fid, from_port, to_port, all);
    }
#[no_mangle]
unsafe extern "C" fn mv88e6xxx_g1_atu_prob_irq_thread_fn(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn mv88e6xxx_g1_atu_prob_irq_setup(chip: *mut mv88e6xxx_chip) -> c_int {
    ...
    err = request_threaded_irq(chip.atu_prob_irq, core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn mv88e6xxx_g1_atu_prob_irq_free(chip: *mut mv88e6xxx_chip) {
