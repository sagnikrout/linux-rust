...
//! Source: drivers/net/dsa/mv88e6xxx/pcs-639x.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv88e639x_pcs {
    pub mdio: mdio_device,
    pub sgmii_pcs: phylink_pcs,
    pub xg_pcs: phylink_pcs,
    pub erratum_3_14: bool,
    pub supports_5g: bool,
    pub interface: phy_interface_t,
    pub irq: c_uint,
    pub name: [c_char; 64],
    pub mpcs): *mut *mut irqreturn_t (handle_irq)(struct mv88e639x_pcs,
}

#[no_mangle]
unsafe extern "C" fn mv88e639x_read(mpcs: *mut mv88e639x_pcs, regnum: u16, val: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88e639x_write(mpcs: *mut mv88e639x_pcs, regnum: u16, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88e639x_pcs_handle_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// Use polling mode
    ...
    mpcs.irq = irq;
    return request_threaded_irq(irq, core::ptr::null_mut(), mv88e639x_pcs_handle_irq,
    IRQF_ONESHOT, mpcs.name, mpcs);
    }
#[no_mangle]
unsafe extern "C" fn mv88e639x_pcs_teardown(chip: *mut mv88e6xxx_chip, port: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mv88e639x_sgmii_handle_irq(mpcs: *mut mv88e639x_pcs) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mv88e639x_sgmii_pcs_enable(pcs: *mut phylink_pcs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88e639x_sgmii_pcs_disable(pcs: *mut phylink_pcs) {
...
#[no_mangle]
unsafe extern "C" fn mv88e6390_erratum_3_14(mpcs: *mut mv88e639x_pcs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88e639x_sgmii_pcs_an_restart(pcs: *mut phylink_pcs) {
...
#[no_mangle]
unsafe extern "C" fn mv88e639x_xg_pcs_enable(mpcs: *mut mv88e639x_pcs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88e639x_xg_pcs_disable(mpcs: *mut mv88e639x_pcs) {
...
#[no_mangle]
unsafe extern "C" fn mv88e6390_xg_handle_irq(mpcs: *mut mv88e639x_pcs) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mv88e6390_xg_control_irq(mpcs: *mut mv88e639x_pcs, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88e6390_xg_pcs_enable(pcs: *mut phylink_pcs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88e6390_xg_pcs_disable(pcs: *mut phylink_pcs) {
...
#[no_mangle]
unsafe extern "C" fn mv88e6390_pcs_enable_checker(mpcs: *mut mv88e639x_pcs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88e6390_pcs_init(chip: *mut mv88e6xxx_chip, port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88e6393x_power_lane(mpcs: *mut mv88e639x_pcs, enable: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mv88e6393x_erratum_4_6(mpcs: *mut mv88e639x_pcs) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mv88e6393x_erratum_4_8(mpcs: *mut mv88e639x_pcs) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mv88e6393x_erratum_5_2(mpcs: *mut mv88e639x_pcs) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mv88e6393x_fix_2500basex_an(mpcs: *mut mv88e639x_pcs, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88e6393x_sgmii_pcs_disable(pcs: *mut phylink_pcs) {
...
#[no_mangle]
unsafe extern "C" fn mv88e6393x_xg_handle_irq(mpcs: *mut mv88e639x_pcs) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mv88e6393x_xg_control_irq(mpcs: *mut mv88e639x_pcs, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88e6393x_xg_pcs_enable(pcs: *mut phylink_pcs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv88e6393x_xg_pcs_disable(pcs: *mut phylink_pcs) {
...
#[no_mangle]
unsafe extern "C" fn mv88e6393x_pcs_init(chip: *mut mv88e6xxx_chip, port: c_int) -> c_int {
