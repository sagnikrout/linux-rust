...
//! Source: drivers/net/dsa/mv88e6xxx/leds.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mv88e6xxx_port_led_write(chip: *mut mv88e6xxx_chip, port: c_int, reg: u16) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv88e6xxx_led_hwconfig {
    pub led: c_int,
    pub portmask: u8,
    pub rules: c_ulong,
    pub fiber: bool,
    pub blink_activity: bool,
    pub selector: u16,
}
...
#[no_mangle]
pub unsafe extern "C" fn mv88e6xxx_port_setup_leds(chip: *mut mv88e6xxx_chip, port: c_int) -> c_int {
    int mv88e6xxx_port_setup_leds(struct mv88e6xxx_chip *chip, int port)
    {
    struct fwnode_handle *led = core::ptr::null_mut(), *leds = core::ptr::null_mut();
