...
//! Source: drivers/net/dsa/ocelot/felix_vsc9959.c
#![no_std]
...
pub const VSC9959_NUM_PORTS: c_int = 6;
pub const VSC9959_TAS_GCL_ENTRY_MAX: c_int = 63;
pub const VSC9959_TAS_MIN_GATE_LEN_NS: c_int = 35;
pub const VSC9959_VCAP_POLICER_BASE: c_int = 63;
pub const VSC9959_VCAP_POLICER_MAX: c_int = 383;
pub const VSC9959_SWITCH_PCI_BAR: c_int = 4;
pub const VSC9959_IMDIO_PCI_BAR: c_int = 0;
...
pub const VSC9959_INIT_TIMEOUT: c_int = 50000;
pub const VSC9959_GCB_RST_SLEEP: c_int = 100;
pub const VSC9959_SYS_RAMINIT_SLEEP: c_int = 80;
#[no_mangle]
unsafe extern "C" fn vsc9959_gcb_soft_rst_status(ocelot: *mut ocelot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc9959_sys_ram_init_status(ocelot: *mut ocelot) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vsc9959_reset(ocelot: *mut ocelot) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vsc9959_wm_enc(value: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn vsc9959_wm_dec(wm: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn vsc9959_wm_stat(val: u32, inuse: *mut u32, maxuse: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn vsc9959_mdio_bus_alloc(ocelot: *mut ocelot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc9959_mdio_bus_free(ocelot: *mut ocelot) {
...
//
#[no_mangle]
unsafe extern "C" fn vsc9959_tas_remaining_gate_len_ps(gate_len_ns: u64) -> u64 {
...
//
    ...
    let mut gates_ever_opened: u8 = 0;
    int tc, i, n;
// Initialize arrays
...
#[no_mangle]
unsafe extern "C" fn vsc9959_port_qmaxsdu_get(ocelot: *mut ocelot, port: c_int, tc: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vsc9959_tas_tc_max_sdu(taprio: *mut tc_taprio_qopt_offload, tc: c_int) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn vsc9959_tas_guard_bands_update(ocelot: *mut ocelot, port: c_int) {
...
//
    ...
    for (tc = 0; tc < OCELOT_NUM_TC; tc++) {
    let mut requested_max_sdu: u32 = vsc9959_tas_tc_max_sdu(taprio, tc);
...
//
    ...
    let mut nr_of_cycles: u64 = current_time - base_time;
...
#[no_mangle]
unsafe extern "C" fn vsc9959_tas_read_cfg_status(ocelot: *mut ocelot) -> u32 {
    ...
    ocelot_port.taprio = core::ptr::null_mut();
    vsc9959_tas_guard_bands_update(ocelot, port);
    mutex_unlock(&ocelot.fwd_domain_lock);
    return 0;
...
#[no_mangle]
unsafe extern "C" fn vsc9959_tas_clock_adjust(ocelot: *mut ocelot) {
...
// Re-enable time-aware shaper
    ...
    let mut port_ix: c_int = port * 8 + cbs_qopt.queue;
    u32 rate, burst;
...
#[no_mangle]
unsafe extern "C" fn vsc9959_qos_query_caps(base: *mut tc_query_caps_base) -> c_int {
...
pub const VSC9959_PSFP_SFID_MAX: c_int = 175;
pub const VSC9959_PSFP_GATE_ID_MAX: c_int = 183;
pub const VSC9959_PSFP_POLICER_BASE: c_int = 63;
pub const VSC9959_PSFP_POLICER_MAX: c_int = 383;
pub const VSC9959_PSFP_GATE_LIST_NUM: c_int = 4;
pub const VSC9959_PSFP_GATE_CYCLETIME_MIN: c_int = 5000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct felix_stream {
    pub list: list_head,
    pub id: c_ulong,
    pub dummy: bool,
    pub ports: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct felix_stream_filter_counters {
    pub match: u64,
    pub not_pass_gate: u64,
    pub not_pass_sdu: u64,
    pub red: u64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct felix_stream_filter {
    pub stats: felix_stream_filter_counters,
    pub list: list_head,
...
pub struct felix_stream_gate {
    ...
    pub basetime: u64,
    pub cycletime: u64,
    pub cycletime_ext: u64,
    pub num_entries: u32,
    pub __counted_by(num_entries): action_gate_entry entries[],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct felix_stream_gate_entry {
    pub list: list_head,
    pub refcount: refcount_t,
    pub index: u32,
}
...
//
    ...
    {
    if (!stream.dummy)
    vsc9959_mact_stream_set(ocelot, stream, core::ptr::null_mut());
    list_del(&stream.list);
    kfree(stream);
    }
#[no_mangle]
unsafe extern "C" fn vsc9959_sfi_access_status(ocelot: *mut ocelot) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vsc9959_psfp_sfidmask_set(ocelot: *mut ocelot, sfid: u32, ports: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc9959_psfp_sfi_table_del(ocelot: *mut ocelot, index: u32) {
...
#[no_mangle]
unsafe extern "C" fn vsc9959_sgi_cfg_status(ocelot: *mut ocelot) -> u32 {
    ...
    let mut ips: u32 = (e[i].ipv < 0) ? 0 : (e[i].ipv + 8);
    ...
    let mut sgi: felix_stream_gate = {0};
    struct ocelot_psfp_list *psfp;
    u8 z;
    psfp = &ocelot.psfp;
    ...
    let mut sfi: felix_stream_filter = {0};
    const struct flow_action_entry *a;
    struct felix_stream *stream_entry;
    let mut stream: felix_stream = {0};
    struct felix_stream_gate *sgi;
    struct ocelot_psfp_list *psfp;
...
// Check if stream is set.
    ...
    vsc9959_mact_stream_set(ocelot, stream_entry, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn vsc9959_update_stats(ocelot: *mut ocelot) {
...
#[no_mangle]
unsafe extern "C" fn vsc9959_psfp_init(ocelot: *mut ocelot) {
...
//
#[no_mangle]
unsafe extern "C" fn vsc9959_cut_through_fwd(ocelot: *mut ocelot) {
    ...
    struct ocelot_port *ocelot_port = ocelot.ports[port];
    struct ocelot_mm_state *mm = &ocelot.mm[port];
    let mut min_speed: c_int = ocelot_port.speed;
...
//
#[no_mangle]
unsafe extern "C" fn vsc9959_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vsc9959_request_irq(ocelot: *mut ocelot) -> c_int {
    static int vsc9959_request_irq(struct ocelot *ocelot)
    {
    struct pci_dev *pdev = to_pci_dev(ocelot.dev);
    return devm_request_threaded_irq(ocelot.dev, pdev.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn felix_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn felix_pci_shutdown(pdev: *mut pci_dev) {
