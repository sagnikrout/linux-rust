...
//! Source: drivers/net/dsa/ocelot/seville_vsc9953.c
#![no_std]
...
pub const VSC9953_NUM_PORTS: c_int = 10;
pub const VSC9953_VCAP_POLICER_BASE: c_int = 11;
pub const VSC9953_VCAP_POLICER_MAX: c_int = 31;
pub const VSC9953_VCAP_POLICER_BASE2: c_int = 120;
pub const VSC9953_VCAP_POLICER_MAX2: c_int = 161;
...
pub const VSC9953_INIT_TIMEOUT: c_int = 50000;
pub const VSC9953_GCB_RST_SLEEP: c_int = 100;
pub const VSC9953_SYS_RAMINIT_SLEEP: c_int = 80;
#[no_mangle]
unsafe extern "C" fn vsc9953_gcb_soft_rst_status(ocelot: *mut ocelot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsc9953_sys_ram_init_status(ocelot: *mut ocelot) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vsc9953_reset(ocelot: *mut ocelot) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vsc9953_wm_enc(value: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn vsc9953_wm_dec(wm: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn vsc9953_wm_stat(val: u32, inuse: *mut u32, maxuse: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn vsc9953_mdio_bus_alloc(ocelot: *mut ocelot) -> c_int {
...
// Needed in order to initialize the bus mutex lock
    rc = devm_of_mdiobus_register(dev, bus, core::ptr::null_mut());
    if (rc < 0) {
...
#[no_mangle]
unsafe extern "C" fn vsc9953_mdio_bus_free(ocelot: *mut ocelot) {
...
#[no_mangle]
unsafe extern "C" fn seville_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seville_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn seville_shutdown(pdev: *mut platform_device) {
