...
//! Source: drivers/net/pcs/pcs-rzn1-miic.c
#![no_std]
...
pub const MIIC_PRCMD: c_uint = 0x0;
pub const MIIC_ESID_CODE: c_uint = 0x4;
pub const MIIC_MODCTRL: c_uint = 0x8;
pub const MIIC_PHY_LINK: c_uint = 0x14;

pub const CONV_MODE_10MBPS: c_int = 0;
pub const CONV_MODE_100MBPS: c_int = 1;
pub const CONV_MODE_1000MBPS: c_int = 2;

pub const CONV_MODE_MII: c_int = 0;
pub const CONV_MODE_RMII: c_int = 1;
pub const CONV_MODE_RGMII: c_int = 2;

pub const MIIC_CONVRST: c_uint = 0x114;

pub const MIIC_SWCTRL: c_uint = 0x304;
pub const MIIC_SWDUPC: c_uint = 0x308;
pub const MIIC_MODCTRL_CONF_CONV_MAX: c_int = 6;

pub const MIIC_MAX_NUM_RSTS: c_int = 2;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct modctrl_match {
    pub mode_cfg: u32,
    pub conv: [u8; MIIC_MODCTRL_CONF_CONV_MAX],
}
...
pub struct miic {
    ...
    pub dev: *mut device,
    pub lock: spinlock_t,
    pub rsts: [reset_control_bulk_data; MIIC_MAX_NUM_RSTS],
    pub of_data: *const miic_of_data,
    pub link_cfg: miic_phy_link_cfg,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct miic_of_data {
    pub match_table: *mut modctrl_match,
    pub match_table_count: u8,
    pub conf_conv_count: u8,
    pub conf_to_string: *const *const c_char,
    pub conf_to_string_count: u8,
    pub index_to_string: *const *const c_char,
    pub index_to_string_count: u8,
    pub miic_port_start: u8,
    pub miic_port_max: u8,
    pub sw_mode_mask: u8,
    pub reset_ids: *const *const c_char,
    pub reset_count: u8,
    pub init_unlock_lock_regs: bool,
    pub value): *mut *mut *mut void (miic_write)(struct miic miic, int offset, u32,
    pub type: enum miic_type,
}
...
#[no_mangle]
unsafe extern "C" fn miic_unlock_regs(miic: *mut miic) {
...
#[no_mangle]
unsafe extern "C" fn miic_lock_regs(miic: *mut miic) {
...
#[no_mangle]
unsafe extern "C" fn miic_reg_writel_unlocked(miic: *mut miic, offset: c_int, value: u32) {
    static void miic_reg_writel_unlocked(struct miic *miic, int offset, u32 value)
    {
    writel(value, miic.base + offset);
    }
#[no_mangle]
unsafe extern "C" fn miic_reg_writel_locked(miic: *mut miic, offset: c_int, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn miic_reg_writel(miic: *mut miic, offset: c_int, value: u32) {
    static void miic_reg_writel(struct miic *miic, int offset, u32 value)
    {
    miic.of_data.miic_write(miic, offset, value);
    }
#[no_mangle]
unsafe extern "C" fn miic_reg_readl(miic: *mut miic, offset: c_int) -> u32 {
    static u32 miic_reg_readl(struct miic *miic, int offset)
    {
    return readl(miic.base + offset);
    }
#[no_mangle]
unsafe extern "C" fn miic_reg_rmw(miic: *mut miic, offset: c_int, mask: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn miic_converter_enable(miic: *mut miic, port: c_int, enable: c_int) {
    ...
    let mut port: c_int = miic_port.port;
    switch (interface) {
...
//
    ...
    struct miic_port *miic_port = phylink_pcs_to_miic_port(pcs);
    struct miic *miic = miic_port.miic;
    let mut conv_speed: u32 = 0, val = 0;
    let mut port: c_int = miic_port.port;
...
#[no_mangle]
unsafe extern "C" fn miic_pre_init(pcs: *mut phylink_pcs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn miic_destroy(pcs: *mut phylink_pcs) {
...
#[no_mangle]
unsafe extern "C" fn miic_init_hw(miic: *mut miic, cfg_mode: u32) -> c_int {
    static int miic_init_hw(struct miic *miic, u32 cfg_mode)
    {
    let mut sw_mode_mask: u8 = miic.of_data.sw_mode_mask;
    int port;
...
#[no_mangle]
unsafe extern "C" fn miic_modctrl_match(table_val: *mut i8, dt_val: *mut i8, count: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn miic_dump_conf(miic: *mut miic, conf: *mut i8) {
...
#[no_mangle]
unsafe extern "C" fn miic_match_dt_conf(miic: *mut miic, dt_val: *mut i8, mode_cfg: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn miic_parse_dt(miic: *mut miic, mode_cfg: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn miic_reset_control_bulk_assert(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn miic_reset_control_init(miic: *mut miic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn miic_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn miic_remove(pdev: *mut platform_device) {
