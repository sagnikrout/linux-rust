...
//! Source: drivers/net/vxlan/vxlan_vnifilter.c
#![no_std]
...
//
    ...
    let mut vni: __be32 = *(__be32 *)arg.key;
...
#[no_mangle]
pub unsafe extern "C" fn vxlan_vs_del_vnigrp(vxlan: *mut vxlan_dev) {
...
#[no_mangle]
unsafe extern "C" fn vxlan_vnifilter_entry_nlmsg_size() -> usize {
    static size_t vxlan_vnifilter_entry_nlmsg_size(void)
    {
#[no_mangle]
pub unsafe extern "C" fn NLMSG_ALIGN(tunnel_msg): sizeof(struct) -> return {
    ...
    let mut vs: u32 = be32_to_cpu(vbegin.vni);
    let mut ve: u32 = 0;
    if (vbegin != vend)
    ...
    goto out_err;
    nlmsg_end(skb, nlh);
    rtnl_notify(skb, net, 0, RTNLGRP_TUNNEL, core::ptr::null_mut(), GFP_KERNEL);
    return;
    out_err:
    ...
    {
    struct vxlan_vni_node *tmp, *v, *vbegin = core::ptr::null_mut(), *vend = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn vxlan_vnifilter_dump(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
// old_remote_ip,
    ...
    struct vxlan_rdst *dst = &vxlan.default_dst;
    union vxlan_addr *newrip = core::ptr::null_mut(), *oldrip = core::ptr::null_mut();
    union vxlan_addr old_remote_ip;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn vxlan_vni_free(vninode: *mut vxlan_vni_node) {
    ...
    {
    struct vxlan_vni_node *vninode;
    let mut v: __be32 = cpu_to_be32(vni);
...
#[no_mangle]
unsafe extern "C" fn vxlan_vni_node_rcu_free(rcu: *mut rcu_head) {
    ...
    let mut vni_start: u32 = 0, vni_end = 0;
    union vxlan_addr group;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn vxlan_vnigroup_uninit(vxlan: *mut vxlan_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn vxlan_vnigroup_init(vxlan: *mut vxlan_dev) -> c_int {
...
// this should validate the header and check for remaining bytes
    err = nlmsg_parse(nlh, sizeof(*tmsg), core::ptr::null_mut(), VXLAN_VNIFILTER_MAX,
    ...
    {THIS_MODULE, PF_BRIDGE, RTM_GETTUNNEL, core::ptr::null_mut(), vxlan_vnifilter_dump, 0},
    {THIS_MODULE, PF_BRIDGE, RTM_NEWTUNNEL, vxlan_vnifilter_process, core::ptr::null_mut(), 0},
    {THIS_MODULE, PF_BRIDGE, RTM_DELTUNNEL, vxlan_vnifilter_process, core::ptr::null_mut(), 0},
    };
#[no_mangle]
pub unsafe extern "C" fn vxlan_vnifilter_init() -> c_int {
    int vxlan_vnifilter_init(void)
    {
    return rtnl_register_many(vxlan_vnifilter_rtnl_msg_handlers);
    }
#[no_mangle]
pub unsafe extern "C" fn vxlan_vnifilter_uninit() {
