...
//
    ...
    IFF_BACKPRESSURE)
pub const GOODCOPY_LEN: c_int = 128;
pub const FLT_EXACT_COUNT: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tap_filter {
    pub /: *mut *mut unsigned int count; / Number of addrs. Zero means disabled,
    pub /: *mut *mut u32 mask[2]; / Mask of the hashed addrs,
    pub addr: [c_uchar; FLT_EXACT_COUNT][ETH_ALEN],
}

// MAX_TAP_QUEUES 256 is chosen to allow rx/tx queues to be equal
// to max number of VCPUs in guest.
pub const MAX_TAP_QUEUES: c_int = 256;
pub const MAX_TAP_FLOWS: c_int = 4096;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tun_flow_entry {
    pub hash_link: hlist_node,
    pub rcu: rcu_head,
    pub tun: *mut tun_struct,
    pub rxhash: u32,
    pub rps_rxhash: u32,
...
pub const TUN_NUM_FLOW_ENTRIES: c_int = 1024;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tun_struct {
    pub tfiles: [*mut tun_file __rcu; MAX_TAP_QUEUES],
    pub numqueues: c_uint,
    pub flags: c_uint,
    pub owner: kuid_t,
    pub group: kgid_t,
    ...
    pub sndbuf: c_int,
    pub txflt: tap_filter,
    pub fprog: sock_fprog,
// protected by rtnl lock
    pub filter_attached: bool,
    pub msg_enable: u32,
    pub lock: spinlock_t,
    pub flows: [hlist_head; TUN_NUM_FLOW_ENTRIES],
    pub flow_gc_timer: timer_list,
    pub ageing_time: c_ulong,
    pub numdisabled: c_uint,
    pub disabled: list_head,
    pub security: *mut c_void,
    pub flow_count: u32,
    pub rx_batched: u32,
    pub rx_frame_errors: atomic_long_t,
    pub xdp_prog: *mut bpf_prog __rcu,
    pub steering_prog: *mut tun_prog __rcu,
    pub filter_prog: *mut tun_prog __rcu,
    pub link_ksettings: ethtool_link_ksettings,
// init args
    pub file: *mut file,
    pub ifr: *mut ifreq,
}
...
#[no_mangle]
unsafe extern "C" fn tun_napi_receive(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_napi_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_napi_enable(tfile: *mut tun_file) {
...
#[no_mangle]
unsafe extern "C" fn tun_napi_disable(tfile: *mut tun_file) {
...
#[no_mangle]
unsafe extern "C" fn tun_napi_del(tfile: *mut tun_file) {
...
#[no_mangle]
unsafe extern "C" fn tun_napi_frags_enabled(tfile: *const tun_file) -> bool {
    static bool tun_napi_frags_enabled(const struct tun_file *tfile)
    {
    return tfile.napi_frags_enabled;
    }
#[no_mangle]
pub unsafe extern "C" fn tun_hashfn(rxhash: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tun_flow_delete(tun: *mut tun_struct, e: *mut tun_flow_entry) {
...
#[no_mangle]
unsafe extern "C" fn tun_flow_flush(tun: *mut tun_struct) {
...
#[no_mangle]
unsafe extern "C" fn tun_flow_delete_by_queue(tun: *mut tun_struct, queue_index: u16) {
...
#[no_mangle]
unsafe extern "C" fn tun_flow_cleanup(t: *mut timer_list) {
    static void tun_flow_cleanup(struct timer_list *t)
    {
    struct tun_struct *tun = timer_container_of(tun, t, flow_gc_timer);
    let mut delay: c_ulong = tun.ageing_time;
    let mut next_timer: c_ulong = jiffies + delay;
    ...
    struct tun_flow_entry *e;
    let mut delay: c_ulong = tun.ageing_time;
    let mut queue_index: u16 = tfile.queue_index;
...
//
#[no_mangle]
pub unsafe extern "C" fn tun_flow_save_rps_rxhash(e: *mut tun_flow_entry, hash: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn tun_automq_select_queue(tun: *mut tun_struct, skb: *mut sk_buff) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn tun_ebpf_select_queue(tun: *mut tun_struct, skb: *mut sk_buff) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn tun_not_capable(tun: *mut tun_struct) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tun_set_real_num_queues(tun: *mut tun_struct) {
...
#[no_mangle]
unsafe extern "C" fn tun_disable_queue(tun: *mut tun_struct, tfile: *mut tun_file) {
    ...
    tfile.detached = core::ptr::null_mut();
    list_del_init(&tfile.next);
    WRITE_ONCE(tun.numdisabled, tun.numdisabled - 1);
    return tun;
    }
#[no_mangle]
pub unsafe extern "C" fn tun_ptr_free(ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tun_queue_purge(tfile: *mut tun_file) {
    static void tun_queue_purge(struct tun_file *tfile)
    {
    void *ptr;
    while ((ptr = ptr_ring_consume(&tfile.tx_ring)) != core::ptr::null_mut())
    tun_ptr_free(ptr);
    skb_queue_purge(&tfile.sk.sk_write_queue);
    skb_queue_purge(&tfile.sk.sk_error_queue);
    }
#[no_mangle]
unsafe extern "C" fn __tun_detach(tfile: *mut tun_file, clean: bool) {
    ...
    let mut index: u16 = tfile.queue_index;
    ...
    if (clean) {
    RCU_INIT_POINTER(tfile.tun, core::ptr::null_mut());
    sock_put(&tfile.sk);
    } else {
...
#[no_mangle]
unsafe extern "C" fn tun_detach(tfile: *mut tun_file, clean: bool) {
    ...
    rtnl_lock();
    tun = rtnl_dereference(tfile.tun);
    dev = tun ? tun.dev : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tun_detach_all(dev: *mut net_device) {
...
// Setup XDP RX-queue info, for new tfile getting attached
    ...
    MEM_TYPE_PAGE_SHARED, core::ptr::null_mut());
    if (err < 0) {
    xdp_rxq_info_unreg(&tfile.xdp_rxq);
    goto out;
    }
...
#[no_mangle]
unsafe extern "C" fn tun_put(tun: *mut tun_struct) {
...
// TAP filtering
#[no_mangle]
unsafe extern "C" fn addr_hash_set(mask: *mut u32, addr: *const u8) {
    static void addr_hash_set(u32 *mask, const u8 *addr)
    {
    let mut n: c_int = ether_crc(ETH_ALEN, addr) >> 26;
    mask[n >> 5] |= (1 << (n & 31));
    }
#[no_mangle]
unsafe extern "C" fn addr_hash_test(mask: *const u32, addr: *const u8) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn update_filter(filter: *mut tap_filter, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn run_filter(filter: *mut tap_filter, skb: *const sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn check_filter(filter: *mut tap_filter, skb: *const sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_net_init(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_net_uninit(dev: *mut net_device) {
...
// Net device open.
#[no_mangle]
unsafe extern "C" fn tun_net_open(dev: *mut net_device) -> c_int {
...
// Net device close.
#[no_mangle]
unsafe extern "C" fn tun_net_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_automq_xmit(tun: *mut tun_struct, skb: *mut sk_buff) {
...
// Net device start xmit
#[no_mangle]
unsafe extern "C" fn tun_net_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t tun_net_xmit(struct sk_buff *skb, struct net_device *dev)
    {
    let mut drop_reason: enum skb_drop_reason = SKB_DROP_REASON_NOT_SPECIFIED;
    struct tun_struct *tun = netdev_priv(dev);
    let mut txq: c_int = skb.queue_mapping;
...
#[no_mangle]
unsafe extern "C" fn tun_net_mclist(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn tun_set_headroom(dev: *mut net_device, new_hr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tun_xdp(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_net_change_carrier(dev: *mut net_device, new_carrier: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __tun_xdp_flush_tfile(tfile: *mut tun_file) {
...
#[no_mangle]
unsafe extern "C" fn tun_xdp_tx(dev: *mut net_device, xdp: *mut xdp_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_flow_init(tun: *mut tun_struct) {
    static void tun_flow_init(struct tun_struct *tun)
    {
    int i;
    for (i = 0; i < TUN_NUM_FLOW_ENTRIES; i++)
...
#[no_mangle]
unsafe extern "C" fn tun_flow_uninit(tun: *mut tun_struct) {
    static void tun_flow_uninit(struct tun_struct *tun)
    {
...
pub const MAX_MTU: c_int = 65535;
// Initialize net device.
#[no_mangle]
unsafe extern "C" fn tun_net_initialize(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn tun_sock_writeable(tun: *mut tun_struct, tfile: *mut tun_file) -> bool {
...
// Poll
#[no_mangle]
unsafe extern "C" fn tun_chr_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
//
    ...
    let mut fragsz: usize = iov.iov_len;
    struct page *page;
    void *frag;
...
// Under a page?  Don't bother with paged skb.
    ...
    struct sk_buff_head *queue = &tfile.sk.sk_write_queue;
    struct sk_buff_head process_queue;
    let mut rx_batched: u32 = tun.rx_batched;
    let mut rcv: bool = false;
    ...
    let mut buflen: c_int = SKB_DATA_ALIGN(sizeof(struct skb_shared_info));
    char *buf;
    size_t copied;
    let mut pad: c_int = TUN_RX_PAD;
    let mut metasize: c_int = 0;
    let mut err: c_int = 0;
    rcu_read_lock();
...
// Get packet from user space buffer
    ...
    {
    let mut pi: tun_pi = { 0, cpu_to_be16(ETH_P_IP) };
    struct sk_buff *skb;
    let mut total_len: usize = iov_iter_count(from);
    let mut len: usize = total_len, align = tun.align, linear;
    struct virtio_net_hdr_v1_hash_tunnel hdr;
    struct virtio_net_hdr *gso;
    int good_linear;
    int copylen;
    let mut hdr_len: c_int = 0;
    let mut zerocopy: bool = false;
    int err;
    let mut rxhash: u32 = 0;
    let mut skb_xdp: c_int = 1;
    let mut frags: bool = tun_napi_frags_enabled(tfile);
    let mut drop_reason: enum skb_drop_reason = SKB_DROP_REASON_NOT_SPECIFIED;
...
//
    ...
    let mut vnet_hdr_sz: c_int = READ_ONCE(tun.vnet_hdr_sz);
...
// copy skb_ubuf_info for callback when skb has no error
    ...
    uarg.ops.complete(core::ptr::null_mut(), uarg, false);
    }
...
// Exercise flow dissector code path.
    ...
    unlock_frags:
    if (frags) {
    tfile.napi.skb = core::ptr::null_mut();
    mutex_unlock(&tfile.napi_mutex);
    }
    return err ?: total_len;
    }
#[no_mangle]
unsafe extern "C" fn tun_chr_write_iter(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
    ...
    struct tun_struct *tun = tun_get(tfile);
    ssize_t result;
    let mut noblock: c_int = 0;
    if (!tun)
    return -EBADFD;
    if ((file.f_flags & O_NONBLOCK) || (iocb.ki_flags & IOCB_NOWAIT))
    noblock = 1;
    result = tun_get_user(tun, tfile, core::ptr::null_mut(), from, noblock, false);
    tun_put(tun);
    return result;
    }
    ...
    {
    let mut vnet_hdr_sz: c_int = 0;
    let mut size: usize = xdp_frame.len;
    ssize_t ret;
    if (tun.flags & IFF_VNET_HDR) {
    let mut gso: virtio_net_hdr = { 0 };
...
// Put packet to the user space buffer
    ...
    struct iov_iter *iter)
    {
    let mut pi: tun_pi = { 0, skb.protocol };
    ssize_t total;
    let mut vlan_offset: c_int = 0;
    let mut vlan_hlen: c_int = 0;
    let mut vnet_hdr_sz: c_int = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn tun_chr_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
    static ssize_t tun_chr_read_iter(struct kiocb *iocb, struct iov_iter *to)
    {
    struct file *file = iocb.ki_filp;
    struct tun_file *tfile = file.private_data;
    struct tun_struct *tun = tun_get(tfile);
    let mut len: isize = iov_iter_count(to), ret;
    let mut noblock: c_int = 0;
    if (!tun)
    return -EBADFD;
    if ((file.f_flags & O_NONBLOCK) || (iocb.ki_flags & IOCB_NOWAIT))
    noblock = 1;
    ret = tun_do_read(tun, tfile, to, noblock, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn tun_prog_free(rcu: *mut rcu_head) {
    ...
    {
    struct tun_prog *old, *new = core::ptr::null_mut();
    if (prog) {
    new = kmalloc_obj(*new);
    if (!new)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn tun_free_netdev(dev: *mut net_device) {
    ...
    tun_flow_uninit(tun);
    security_tun_dev_free_security(tun.security);
    __tun_set_ebpf(tun, &tun.steering_prog, core::ptr::null_mut());
    __tun_set_ebpf(tun, &tun.filter_prog, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tun_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn tun_get_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn tun_fill_info(skb: *mut sk_buff, dev: *const net_device) -> c_int {
    static int tun_fill_info(struct sk_buff *skb, const struct net_device *dev)
    {
    const struct tun_struct *tun = netdev_priv(dev);
    let mut flags: c_uint = READ_ONCE(tun.flags);
    let mut owner: kuid_t = READ_ONCE(tun.owner);
    let mut group: kgid_t = READ_ONCE(tun.group);
...
#[no_mangle]
unsafe extern "C" fn tun_sock_write_space(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn tun_put_page(tpage: *mut tun_page) {
    ...
    netdev_features_t features;
    let mut rxhash: u32 = 0, act;
    let mut buflen: c_int = xdp.frame_sz;
    let mut metasize: c_int = 0;
    let mut ret: c_int = 0;
    let mut skb_xdp: bool = false;
    struct page *page;
...
#[no_mangle]
unsafe extern "C" fn tun_sendmsg(sock: *mut socket, m: *mut msghdr, total_len: usize) -> c_int {
    ...
    struct bpf_net_context __bpf_net_ctx, *bpf_net_ctx;
    struct tun_page tpage;
    let mut n: c_int = ctl.num;
    let mut flush: c_int = 0, queued = 0;
    ...
    ret = tun_get_user(tun, tfile, ctl ? ctl.ptr : core::ptr::null_mut(), &m.msg_iter,
...
#[no_mangle]
unsafe extern "C" fn tun_ptr_peek_len(ptr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_peek_len(sock: *mut socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_flags(tun: *mut tun_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_set_iff(net: *mut net, file: *mut file, ifr: *mut ifreq) -> c_int {
    ...
    tun = netdev_priv(dev);
#[no_mangle]
pub unsafe extern "C" fn if(&tap_netdev_ops: (ifr->ifr_flags & IFF_TAP) && dev->netdev_ops ==) -> else {
...
// TAP device
    ...
    tun.rx_batched = 0;
    RCU_INIT_POINTER(tun.steering_prog, core::ptr::null_mut());
    tun.ifr = ifr;
    tun.file = file;
...
#[no_mangle]
unsafe extern "C" fn tun_get_iff(tun: *mut tun_struct, ifr: *mut ifreq) {
...
// privs required.
#[no_mangle]
unsafe extern "C" fn set_offload(tun: *mut tun_struct, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_detach_filter(tun: *mut tun_struct, n: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tun_attach_filter(tun: *mut tun_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_set_sndbuf(tun: *mut tun_struct) {
...
#[no_mangle]
unsafe extern "C" fn tun_set_queue(file: *mut file, ifr: *mut ifreq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_get_addr_len(type: c_ushort) -> c_uchar {
    ...
    struct tun_struct *tun;
    let mut argp: *mut void __user = (void __user*)arg;
...
#[no_mangle]
unsafe extern "C" fn tun_chr_fasync(fd: c_int, file: *mut file, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_chr_open(inode: *mut inode, file: *mut *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_chr_close(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tun_chr_show_fdinfo(m: *mut seq_file, file: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn tun_get_drvinfo(dev: *mut net_device, info: *mut ethtool_drvinfo) {
...
#[no_mangle]
unsafe extern "C" fn tun_get_msglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tun_set_msglevel(dev: *mut net_device, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn tun_queue_resize(tun: *mut tun_struct) -> c_int {
    static int tun_queue_resize(struct tun_struct *tun)
    {
    struct net_device *dev = tun.dev;
    struct tun_file *tfile;
    struct ptr_ring **rings;
    let mut n: c_int = tun.numqueues + tun.numdisabled;
    int ret, i;
...
#[no_mangle]
unsafe extern "C" fn tun_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tun_cleanup() -> void __exit {
...
// Callers must hold ring.consumer_lock
#[no_mangle]
pub unsafe extern "C" fn tun_wake_queue(file: *mut file, consumed: c_int) {
