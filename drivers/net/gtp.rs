...
#[derive(Copy, Clone)]
pub struct pdp_ctx {
    pub hlist_tid: hlist_node,
    pub hlist_addr: hlist_node,
    union {
    struct {
    pub tid: u64,
    pub flow: u16,
    ...
    pub tx_seq: core::sync::atomic::AtomicI32,
...
pub struct gtp_dev {
    ...
    pub tid_hash: *mut hlist_head,
    pub addr_hash: *mut hlist_head,
    pub restart_count: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct echo_info {
    pub af: u16,
    pub gtp_version: u8,
    union {
    pub addr: in_addr,
...
#[no_mangle]
pub unsafe extern "C" fn gtp0_hashfn(tid: u64) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn gtp1u_hashfn(tid: u32) -> u32 {
    static inline u32 gtp1u_hashfn(u32 tid)
    {
    return jhash_1word(tid, gtp_h_initval);
    }
#[no_mangle]
pub unsafe extern "C" fn ipv4_hashfn(ip: __be32) -> u32 {
    static inline u32 ipv4_hashfn(__be32 ip)
    {
    return jhash_1word(( u32)ip, gtp_h_initval);
    }
#[no_mangle]
unsafe extern "C" fn ipv6_hashfn(ip6: *const in6_addr) -> u32 {
    static u32 ipv6_hashfn(const struct in6_addr *ip6)
    {
    return jhash_2words(( u32)ip6.s6_addr32[0],
    ( u32)ip6.s6_addr32[1], gtp_h_initval);
    }
...
//
    ...
    dst = ip6_dst_lookup_flow(net, sk, fl6, core::ptr::null_mut());
    if (IS_ERR(dst))
...
//
#[no_mangle]
unsafe extern "C" fn gtp0_validate_echo_hdr(gtp0: *mut gtp0_header) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gtp0_build_echo_msg(hdr: *mut gtp0_header, msg_type: __u8) {
...
#[no_mangle]
unsafe extern "C" fn gtp0_send_echo_resp_ip(gtp: *mut gtp_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gtp0_send_echo_resp(gtp: *mut gtp_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gtp0_handle_echo_resp_ip(skb: *mut sk_buff, echo: *mut echo_info) {
...
#[no_mangle]
unsafe extern "C" fn gtp0_handle_echo_resp(gtp: *mut gtp_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gtp_proto_to_family(proto: __u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gtp0_udp_encap_recv(gtp: *mut gtp_dev, skb: *mut sk_buff) -> c_int {
...
// msg_type has to be GTP_ECHO_REQ or GTP_ECHO_RSP
#[no_mangle]
unsafe extern "C" fn gtp1u_build_echo_msg(hdr: *mut gtp1_header_long, msg_type: __u8) {
...
#[no_mangle]
unsafe extern "C" fn gtp1u_send_echo_resp(gtp: *mut gtp_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gtp1u_handle_echo_resp(gtp: *mut gtp_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gtp1u_udp_encap_recv(gtp: *mut gtp_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __gtp_encap_destroy(sk: *mut sock) {
    ...
    if (gtp) {
    if (gtp.sk0 == sk)
    gtp.sk0 = core::ptr::null_mut();
    else
    gtp.sk1u = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn gtp_encap_destroy(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn gtp_encap_disable_sock(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn gtp_encap_disable(gtp: *mut gtp_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn gtp_encap_recv(sk: *mut sock, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gtp_dev_uninit(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn gtp0_push_header(skb: *mut sk_buff, pctx: *mut pdp_ctx) {
    static inline void gtp0_push_header(struct sk_buff *skb, struct pdp_ctx *pctx)
    {
    let mut payload_len: c_int = skb.len;
    struct gtp0_header *gtp0;
...
#[no_mangle]
pub unsafe extern "C" fn gtp1_push_header(skb: *mut sk_buff, pctx: *mut pdp_ctx) {
...
#[no_mangle]
unsafe extern "C" fn gtp_push_header(skb: *mut sk_buff, pktinfo: *mut gtp_pktinfo) {
...
#[no_mangle]
unsafe extern "C" fn gtp_dev_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t gtp_dev_xmit(struct sk_buff *skb, struct net_device *dev)
    {
    let mut proto: c_uint = ntohs(skb.protocol);
    struct gtp_pktinfo pktinfo;
    int err;
...
#[no_mangle]
unsafe extern "C" fn gtp_link_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn gtp_destructor(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(UDP_ENCAP_GTP1U: type ==) -> else {
    ...
    tuncfg.encap_destroy = core::ptr::null_mut();
    ...
    let mut role: c_uint = GTP_ROLE_GGSN;
    struct gtp_dev *gtp;
    struct gtp_net *gn;
    int hashsize, err;
...
#[no_mangle]
unsafe extern "C" fn gtp_dellink(dev: *mut net_device, head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn gtp_get_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn gtp_fill_info(skb: *mut sk_buff, dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gtp_hashtable_new(gtp: *mut gtp_dev, hsize: c_int) -> c_int {
    static int gtp_hashtable_new(struct gtp_dev *gtp, int hsize)
    {
    int i;
    gtp.addr_hash = kmalloc_objs(struct hlist_head, hsize,
    GFP_KERNEL | __GFP_NOWARN);
    if (gtp.addr_hash == core::ptr::null_mut())
    return -ENOMEM;
    gtp.tid_hash = kmalloc_objs(struct hlist_head, hsize,
    GFP_KERNEL | __GFP_NOWARN);
    if (gtp.tid_hash == core::ptr::null_mut())
    goto err1;
    gtp.hash_size = hsize;
    for (i = 0; i < hsize; i++) {
...
#[no_mangle]
unsafe extern "C" fn gtp_encap_enable(gtp: *mut gtp_dev, data[]: *mut nlattr) -> c_int {
    static int gtp_encap_enable(struct gtp_dev *gtp, struct nlattr *data[])
    {
    struct sock *sk1u = core::ptr::null_mut();
    struct sock *sk0 = core::ptr::null_mut();
    if (!data[IFLA_GTP_FD0] && !data[IFLA_GTP_FD1])
    return -EINVAL;
    if (data[IFLA_GTP_FD0]) {
    let mut fd0: c_int = nla_get_u32(data[IFLA_GTP_FD0]);
    if (fd0 >= 0) {
    ...
    let mut fd1: c_int = nla_get_u32(data[IFLA_GTP_FD1]);
    if (fd1 >= 0) {
    ...
    {
    struct gtp_dev *gtp = core::ptr::null_mut();
    struct net_device *dev;
    struct net *net;
...
#[no_mangle]
unsafe extern "C" fn gtp_pdp_fill(pctx: *mut pdp_ctx, info: *mut genl_info) {
...
#[no_mangle]
unsafe extern "C" fn ip_pdp_peer_fill(pctx: *mut pdp_ctx, info: *mut genl_info) {
...
#[no_mangle]
unsafe extern "C" fn ipv4_pdp_fill(pctx: *mut pdp_ctx, info: *mut genl_info) {
...
#[no_mangle]
unsafe extern "C" fn ipv6_pdp_fill(pctx: *mut pdp_ctx, info: *mut genl_info) -> bool {
    ...
    {
    struct pdp_ctx *pctx, *pctx_tid = core::ptr::null_mut();
    ...
    family);
#[no_mangle]
pub unsafe extern "C" fn if(GTP_V1: version ==) -> else {
    ...
    pctx.u.v0.tid, pctx);
#[no_mangle]
pub unsafe extern "C" fn if(GTP_V1: pctx->gtp_version ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn pdp_context_free(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn pdp_context_delete(pctx: *mut pdp_ctx) {
    static void pdp_context_delete(struct pdp_ctx *pctx)
    {
...
#[no_mangle]
unsafe extern "C" fn gtp_genl_new_pdp(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
pub unsafe extern "C" fn if(GTP_V1: version ==) -> else {
    ...
    let mut ip: __be32 = nla_get_be32(nla[GTPA_MS_ADDRESS]);
    if (family != AF_INET)
    return ERR_PTR(-EINVAL);
    return ipv4_pdp_find(gtp, ip);
    } else if (nla[GTPA_MS_ADDR6]) {
    let mut addr: in6_addr = nla_get_in6_addr(nla[GTPA_MS_ADDR6]);
    if (family != AF_INET6)
    return ERR_PTR(-EINVAL);
    if (addr.s6_addr32[2] ||
    addr.s6_addr32[3])
    ...
    let mut gtp_version: u32 = nla_get_u32(nla[GTPA_VERSION]);
...
#[no_mangle]
unsafe extern "C" fn gtp_genl_del_pdp(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gtp_tunnel_notify(pctx: *mut pdp_ctx, cmd: u8, allocation: gfp_t) -> c_int {
    static int gtp_tunnel_notify(struct pdp_ctx *pctx, u8 cmd, gfp_t allocation)
    {
    struct sk_buff *msg;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn gtp_genl_get_pdp(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    static int gtp_genl_get_pdp(struct sk_buff *skb, struct genl_info *info)
    {
    struct pdp_ctx *pctx = core::ptr::null_mut();
    struct sk_buff *skb2;
    int err;
    if (!info.attrs[GTPA_VERSION])
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn gtp_genl_send_echo_req(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gtp_net_init(net: *mut net) -> int __net_init {
...
#[no_mangle]
unsafe extern "C" fn gtp_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gtp_fini() -> void __exit {
