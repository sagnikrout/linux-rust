...
//! Source: drivers/net/team/team_core.c
#![no_std]
...
//
    ...
    return netif_is_team_port(dev) ? port : core::ptr::null_mut();
    }
//
...
//
    ...
    return dev_set_mac_address(port_dev, &addr, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn team_port_set_orig_dev_addr(port: *mut team_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn team_modeop_port_enter(team: *mut team, port: *mut team_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn team_lower_state_changed(port: *mut team_port) {
...
#[no_mangle]
unsafe extern "C" fn team_refresh_port_linkup(port: *mut team_port) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct team_option_inst {
    pub list: list_head,
    pub tmp_list: list_head,
    pub option: *mut team_option,
    pub info: team_option_inst_info,
    pub changed: bool,
    pub removed: bool,
}
...
#[no_mangle]
unsafe extern "C" fn __team_option_inst_del(opt_inst: *mut team_option_inst) {
    ...
    int err;
    if (!option.per_port) {
    err = __team_option_inst_add(team, option, core::ptr::null_mut());
    if (err)
...
#[no_mangle]
pub unsafe extern "C" fn team_option_inst_set_change(opt_inst_info: *mut team_option_inst_info) {
...
#[no_mangle]
pub unsafe extern "C" fn team_options_change_check(team: *mut team) {
...
#[no_mangle]
unsafe extern "C" fn is_good_mode_name(name: *const c_char) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn team_mode_register(mode: *const team_mode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn team_mode_unregister(mode: *const team_mode) {
    ...
    {
    struct team_mode_item *mitem;
    const struct team_mode *mode = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn team_mode_put(mode: *const team_mode) {
    static void team_mode_put(const struct team_mode *mode)
    {
    module_put(mode.owner);
    }
#[no_mangle]
unsafe extern "C" fn team_dummy_transmit(team: *mut team, skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn team_is_mode_set(team: *mut team) -> bool {
    static bool team_is_mode_set(struct team *team)
    {
    return team.mode != &__team_no_mode;
    }
#[no_mangle]
unsafe extern "C" fn team_set_no_mode(team: *mut team) {
...
#[no_mangle]
unsafe extern "C" fn team_adjust_ops(team: *mut team) {
...
//
    team.ops.init = core::ptr::null_mut();
    team.ops.exit = core::ptr::null_mut();
    team.ops.port_enter = core::ptr::null_mut();
    team.ops.port_leave = core::ptr::null_mut();
    team.ops.port_change_dev_addr = core::ptr::null_mut();
    team.ops.port_tx_disabled = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn team_change_mode(team: *mut team, kind: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn team_notify_peers_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn team_notify_peers(team: *mut team) {
...
//
#[no_mangle]
unsafe extern "C" fn team_mcast_rejoin_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn team_mcast_rejoin(team: *mut team) {
...
#[no_mangle]
unsafe extern "C" fn team_handle_frame(pskb: *mut sk_buff) -> rx_handler_result_t {
...
//
#[no_mangle]
unsafe extern "C" fn team_queue_override_init(team: *mut team) -> c_int {
    static int team_queue_override_init(struct team *team)
    {
    struct list_head *listarr;
    let mut queue_cnt: c_uint = netdev_from_priv(team).num_tx_queues - 1;
    unsigned int i;
    if (!queue_cnt)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn team_queue_override_fini(team: *mut team) {
...
//
#[no_mangle]
unsafe extern "C" fn team_queue_override_transmit(team: *mut team, skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __team_queue_override_enabled_check(team: *mut team) {
...
#[no_mangle]
unsafe extern "C" fn __reconstruct_port_hlist(team: *mut team, rm_index: c_int) {
...
//
    ...
    struct team_port *port)
    {
    let mut rx_was_enabled: bool = team_port_rx_enabled(port);
    let mut tx_was_enabled: bool = team_port_tx_enabled(port);
...
#[no_mangle]
unsafe extern "C" fn team_port_enter(team: *mut team, port: *mut team_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn team_port_leave(team: *mut team, port: *mut team_port) {
...
#[no_mangle]
unsafe extern "C" fn __team_port_enable_netpoll(port: *mut team_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn team_port_enable_netpoll(port: *mut team_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn team_port_disable_netpoll(port: *mut team_port) {
    static void team_port_disable_netpoll(struct team_port *port)
    {
    struct netpoll *np = port.np;
    if (!np)
    return;
    port.np = core::ptr::null_mut();
    __netpoll_free(np);
    }
...
unsafe extern "C" fn team_port_disable_netpoll(port: *mut team_port) {
    ...
    core::ptr::null_mut(), &lag_upper_info, extack);
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn team_upper_dev_unlink(team: *mut team, port: *mut team_port) {
...
#[no_mangle]
unsafe extern "C" fn team_port_del(team: *mut team, port_dev: *mut net_device, unregister: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn team_mode_option_get(team: *mut team, ctx: *mut team_gsetter_ctx) {
    static void team_mode_option_get(struct team *team, struct team_gsetter_ctx *ctx)
    {
    ctx.data.str_val = team.mode.kind;
    }
#[no_mangle]
unsafe extern "C" fn team_mode_option_set(team: *mut team, ctx: *mut team_gsetter_ctx) -> c_int {
    ...
    {
    struct team_port *port = ctx.info.port;
    let mut priority: i32 = ctx.data.s32_val;
    ...
    {
    struct team_port *port = ctx.info.port;
    let mut new_queue_id: u16 = ctx.data.u32_val;
...
#[no_mangle]
unsafe extern "C" fn team_init(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn team_uninit(dev: *mut net_device) {
    ...
    __team_change_mode(team, core::ptr::null_mut()); /* cleanup */
...
#[no_mangle]
unsafe extern "C" fn team_destructor(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn team_open(dev: *mut net_device) -> c_int {
    static int team_open(struct net_device *dev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn team_close(dev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn team_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn team_change_rx_flags(dev: *mut net_device, change: c_int) {
...
#[no_mangle]
unsafe extern "C" fn team_set_rx_mode(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn team_set_mac_address(dev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn team_change_mtu(dev: *mut net_device, new_mtu: c_int) -> c_int {
    ...
    let mut rx_dropped: u32 = 0, tx_dropped = 0, rx_nohandler = 0;
    unsigned int start;
    int i;
...
#[no_mangle]
unsafe extern "C" fn team_vlan_rx_add_vid(dev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn team_vlan_rx_kill_vid(dev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn team_poll_controller(dev: *mut net_device) {
    static void team_poll_controller(struct net_device *dev)
    {
    }
#[no_mangle]
unsafe extern "C" fn __team_netpoll_cleanup(team: *mut team) {
...
#[no_mangle]
unsafe extern "C" fn team_netpoll_cleanup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn team_netpoll_setup(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn team_del_slave(dev: *mut net_device, port_dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn team_del_slave_on_unregister(dev: *mut net_device, port_dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn team_change_carrier(dev: *mut net_device, new_carrier: bool) -> c_int {
...
//
    ...
    &team_header_ops : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn team_setup(dev: *mut net_device) {
...
// Don't allow team devices to change network namespaces.
    ...
    if (tb[IFLA_ADDRESS] == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn team_get_num_tx_queues() -> c_uint {
    static unsigned int team_get_num_tx_queues(void)
    {
    return TEAM_DEFAULT_NUM_TX_QUEUES;
    }
#[no_mangle]
unsafe extern "C" fn team_get_num_rx_queues() -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn team_nl_noop_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn team_nl_team_put(team: *mut team) {
...
#[no_mangle]
unsafe extern "C" fn team_nl_send_unicast(skb: *mut sk_buff, team: *mut team, portid: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn team_nl_options_get_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    struct list_head *sel_opt_inst_list);
#[no_mangle]
pub unsafe extern "C" fn team_nl_options_set_doit(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    let mut opt_array_index: u32 = 0;
    let mut opt_is_array: bool = false;
    struct team_option_inst *opt_inst;
    char *opt_name;
    let mut opt_found: bool = false;
...
//
    ...
    NLM_F_ACK, team_nl_send_unicast, core::ptr::null_mut());
    team_nl_team_put(team);
    rtnl_unlock:
    rtnl_unlock();
    return err;
...
#[no_mangle]
unsafe extern "C" fn team_nl_init() -> int __init {
    static int __init team_nl_init(void)
    {
    return genl_register_family(&team_nl_family);
    }
#[no_mangle]
unsafe extern "C" fn team_nl_fini() -> void __exit {
...
//
#[no_mangle]
unsafe extern "C" fn __team_options_change_check(team: *mut team) {
    static void __team_options_change_check(struct team *team)
    {
    int err;
    struct team_option_inst *opt_inst;
...
// rtnl lock is held
#[no_mangle]
unsafe extern "C" fn __team_port_change_send(port: *mut team_port, linkup: bool) {
...
#[no_mangle]
unsafe extern "C" fn __team_carrier_check(team: *mut team) {
    static void __team_carrier_check(struct team *team)
    {
    struct team_port *port;
    bool team_linkup;
...
#[no_mangle]
unsafe extern "C" fn __team_port_change_check(port: *mut team_port, linkup: bool) {
...
#[no_mangle]
unsafe extern "C" fn __team_port_change_port_added(port: *mut team_port, linkup: bool) {
    static void __team_port_change_port_added(struct team_port *port, bool linkup)
    {
    __team_port_change_send(port, linkup);
    __team_carrier_check(port.team);
...
#[no_mangle]
unsafe extern "C" fn __team_port_change_port_removed(port: *mut team_port) {
    static void __team_port_change_port_removed(struct team_port *port)
    {
    port.removed = true;
...
#[no_mangle]
unsafe extern "C" fn team_port_change_check(port: *mut team_port, linkup: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn team_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn team_module_exit() -> void __exit {
