...
pub const MACSEC_TAG_LEN: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct macsec_eth_header {
    pub eth: ethhdr,
// SecTAG
    pub tci_an: u8,
    ...
    pub packet_number: __be32,
    pub /: *mut *mut u8 secure_channel_id[8]; / optional,
    pub __packed: },
// minimum secure data length deemed "not short", see IEEE 802.1AE-2006 9.7
pub const MIN_NON_SHORT_LEN: c_int = 48;
pub const GCM_AES_IV_LEN: c_int = 12;

    pub \: for (sc = rcu_dereference_bh(secy->rx_sc);,
    pub \: sc;,
    sc = rcu_dereference_bh(sc.next))

    pub \: for (sc = rtnl_dereference(secy->rx_sc);,
    pub \: sc;,
    sc = rtnl_dereference(sc.next))

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gcm_iv_xpn {
    union {
    pub short_secure_channel_id: [u8; 4],
    pub ssci: ssci_t,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcpu_secy_stats {
    pub stats: macsec_dev_stats,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct macsec_dev {
    pub secy: macsec_secy,
    pub real_dev: *mut net_device,
    pub dev_tracker: netdevice_tracker,
    pub stats: *mut pcpu_secy_stats __percpu,
    pub secys: list_head,
    pub gro_cells: gro_cells,
    pub offload: enum macsec_offload,
    pub insert_tx_tag: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct macsec_cb {
    pub req: *mut aead_request,
    union {
...
#[no_mangle]
unsafe extern "C" fn free_rx_sc_rcu(head: *mut rcu_head) {
    ...
    {
    return refcount_inc_not_zero(&sc.refcnt) ? sc : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn macsec_rxsc_put(sc: *mut macsec_rx_sc) {
...
#[no_mangle]
unsafe extern "C" fn free_rxsa_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn macsec_rxsa_put(sa: *mut macsec_rx_sa) {
...
#[no_mangle]
unsafe extern "C" fn free_txsa_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn macsec_txsa_put(sa: *mut macsec_tx_sa) {
...
pub const MACSEC_GCM_AES_128_SAK_LEN: c_int = 16;
pub const MACSEC_GCM_AES_256_SAK_LEN: c_int = 32;

pub const DEFAULT_ENCODING_SA: c_int = 0;

#[no_mangle]
unsafe extern "C" fn make_sci(addr: *const u8, port: __be16) -> sci_t {
...
#[no_mangle]
unsafe extern "C" fn macsec_active_sci(secy: *mut macsec_secy) -> sci_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(MACSEC_DEFAULT_ICV_LEN: secy->icv_len !=) -> else {
    else if (secy.icv_len != MACSEC_DEFAULT_ICV_LEN)
    h.tci_an |= MACSEC_TCI_C;
    h.tci_an |= tx_sc.encoding_sa;
    }
#[no_mangle]
unsafe extern "C" fn macsec_set_shortlen(h: *mut macsec_eth_header, data_len: usize) {
...
#[no_mangle]
unsafe extern "C" fn macsec_is_offloaded(macsec: *mut macsec_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(MACSEC_OFFLOAD_MAC: offload ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn macsec_validate_skb(skb: *mut sk_buff, icv_len: u16, xpn: bool) -> bool {
    static bool macsec_validate_skb(struct sk_buff *skb, u16 icv_len, bool xpn)
    {
    struct macsec_eth_header *h = (struct macsec_eth_header *)skb.data;
    let mut len: c_int = skb.len - 2 * ETH_ALEN;
    let mut extra_len: c_int = macsec_extra_len(!!(h.tci_an & MACSEC_TCI_SC)) + icv_len;
...
// length check, f) g) h) i)
    if (h.short_length)
    let mut len: return = = extra_len + h.short_length;
...
#[no_mangle]
unsafe extern "C" fn macsec_fill_iv(iv: *mut c_uchar, sci: sci_t, pn: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn macsec_pn_wrapped(secy: *mut macsec_secy, tx_sa: *mut macsec_tx_sa) {
...
#[no_mangle]
unsafe extern "C" fn macsec_encrypt_finish(skb: *mut sk_buff, dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn macsec_msdu_len(skb: *mut sk_buff) -> c_uint {
    static unsigned int macsec_msdu_len(struct sk_buff *skb)
    {
    struct macsec_dev *macsec = macsec_priv(skb.dev);
    struct macsec_secy *secy = &macsec.secy;
    let mut sci_present: bool = macsec_skb_cb(skb).has_sci;
    return skb.len - macsec_hdr_len(sci_present) - secy.icv_len;
    }
    static void macsec_count_tx(struct sk_buff *skb, struct macsec_tx_sc *tx_sc,
    struct macsec_tx_sa *tx_sa)
    {
    let mut msdu_len: c_uint = macsec_msdu_len(skb);
...
#[no_mangle]
unsafe extern "C" fn count_tx(dev: *mut net_device, ret: c_int, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn macsec_encrypt_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn macsec_post_decrypt(skb: *mut sk_buff, secy: *mut macsec_secy, pn: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn macsec_reset_skb(skb: *mut sk_buff, dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn macsec_finalize_skb(skb: *mut sk_buff, icv_len: u8, hdr_len: u8) {
...
#[no_mangle]
unsafe extern "C" fn count_rx(dev: *mut net_device, len: c_int) {
    static void count_rx(struct net_device *dev, int len)
    {
    dev_sw_netstats_rx_add(dev, len);
    }
#[no_mangle]
unsafe extern "C" fn macsec_decrypt_done(data: *mut c_void, err: c_int) {
    ...
    u32 hdr_pn;
    let mut icv_len: u16 = secy.icv_len;
    ...
    if (secy.xpn) {
    let mut recovered_pn: pn_t = rx_sa.next_pn_halves;
...
//
    let mut len: c_int = skb.len - macsec_hdr_len(macsec_skb_cb(skb).has_sci);
    aead_request_set_crypt(req, sg, sg, len, iv);
...
#[no_mangle]
unsafe extern "C" fn handle_not_macsec(skb: *mut sk_buff) -> enum rx_handler_result {
    static enum rx_handler_result handle_not_macsec(struct sk_buff *skb)
    {
// Deliver to the uncontrolled port by default
    let mut ret: enum rx_handler_result = RX_HANDLER_PASS;
...
//
    ...
    ops = macsec_get_ops(macsec, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn macsec_handle_frame(pskb: *mut sk_buff) -> rx_handler_result_t {
    static rx_handler_result_t macsec_handle_frame(struct sk_buff **pskb)
    {
    struct sk_buff *skb = *pskb;
    struct net_device *dev = skb.dev;
    struct macsec_eth_header *hdr;
    struct macsec_secy *secy = core::ptr::null_mut();
    struct macsec_rx_sc *rx_sc;
    struct macsec_rx_sa *rx_sa;
    struct macsec_rxh_data *rxd;
    struct macsec_dev *macsec;
...
// ethernet header is part of crypto processing
    ...
    sc = sc ? macsec_rxsc_get(sc) : core::ptr::null_mut();
    if (sc) {
    secy = &macsec.secy;
    rx_sc = sc;
    break;
...
#[no_mangle]
unsafe extern "C" fn clear_rx_sa(rx_sa: *mut macsec_rx_sa) {
...
#[no_mangle]
unsafe extern "C" fn clear_tx_sa(tx_sa: *mut macsec_tx_sa) {
    ...
    struct nlattr **attrs)
    {
    let mut ifindex: c_int = nla_get_u32(attrs[MACSEC_ATTR_IFINDEX]);
    struct net_device *dev;
...
#[no_mangle]
unsafe extern "C" fn nla_get_offload(nla: *const nlattr) -> enum macsec_offload {
    static enum macsec_offload nla_get_offload(const struct nlattr *nla)
    {
    return ( enum macsec_offload)nla_get_u8(nla);
    }
#[no_mangle]
unsafe extern "C" fn nla_get_sci(nla: *const nlattr) -> sci_t {
    static sci_t nla_get_sci(const struct nlattr *nla)
    {
    return ( sci_t)nla_get_u64(nla);
    }
    static int nla_put_sci(struct sk_buff *skb, int attrtype, sci_t value,
    int padattr)
    {
    return nla_put_u64_64bit(skb, attrtype, ( u64)value, padattr);
    }
#[no_mangle]
unsafe extern "C" fn nla_get_ssci(nla: *const nlattr) -> ssci_t {
    static ssci_t nla_get_ssci(const struct nlattr *nla)
    {
    return ( ssci_t)nla_get_u32(nla);
    }
#[no_mangle]
unsafe extern "C" fn nla_put_ssci(skb: *mut sk_buff, attrtype: c_int, value: ssci_t) -> c_int {
    static int nla_put_ssci(struct sk_buff *skb, int attrtype, ssci_t value)
    {
    return nla_put_u32(skb, attrtype, ( u64)value);
    }
...
#[no_mangle]
unsafe extern "C" fn parse_sa_config(attrs: *mut nlattr, tb_sa: *mut nlattr) -> c_int {
    static int parse_sa_config(struct nlattr **attrs, struct nlattr **tb_sa)
    {
    if (!attrs[MACSEC_ATTR_SA_CONFIG])
    return -EINVAL;
    if (nla_parse_nested_deprecated(tb_sa, MACSEC_SA_ATTR_MAX, attrs[MACSEC_ATTR_SA_CONFIG], macsec_genl_sa_policy, core::ptr::null_mut()))
    return -EINVAL;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn parse_rxsc_config(attrs: *mut nlattr, tb_rxsc: *mut nlattr) -> c_int {
    static int parse_rxsc_config(struct nlattr **attrs, struct nlattr **tb_rxsc)
    {
    if (!attrs[MACSEC_ATTR_RXSC_CONFIG])
    return -EINVAL;
    if (nla_parse_nested_deprecated(tb_rxsc, MACSEC_RXSC_ATTR_MAX, attrs[MACSEC_ATTR_RXSC_CONFIG], macsec_genl_rxsc_policy, core::ptr::null_mut()))
    return -EINVAL;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn validate_add_rxsa(attrs: *mut nlattr) -> bool {
...
#[no_mangle]
unsafe extern "C" fn macsec_add_rxsa(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsec_add_rxsc(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    static int macsec_add_rxsc(struct sk_buff *skb, struct genl_info *info)
    {
    struct net_device *dev;
    let mut sci: sci_t = MACSEC_UNDEF_SCI;
    struct nlattr **attrs = info.attrs;
    struct macsec_rx_sc *rx_sc;
    struct nlattr *tb_rxsc[MACSEC_RXSC_ATTR_MAX + 1];
    struct macsec_secy *secy;
...
#[no_mangle]
unsafe extern "C" fn validate_add_txsa(attrs: *mut nlattr) -> bool {
...
#[no_mangle]
unsafe extern "C" fn macsec_add_txsa(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsec_del_rxsa(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
// If h/w offloading is available, propagate to the device
    ...
    RCU_INIT_POINTER(rx_sc.sa[assoc_num], core::ptr::null_mut());
    clear_rx_sa(rx_sa);
    rtnl_unlock();
    return 0;
    cleanup:
...
#[no_mangle]
unsafe extern "C" fn macsec_del_rxsc(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsec_del_txsa(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
// If h/w offloading is available, propagate to the device
    ...
    RCU_INIT_POINTER(tx_sc.sa[assoc_num], core::ptr::null_mut());
    clear_tx_sa(tx_sa);
    rtnl_unlock();
    return 0;
    cleanup:
...
#[no_mangle]
unsafe extern "C" fn validate_upd_sa(attrs: *mut nlattr) -> bool {
...
#[no_mangle]
unsafe extern "C" fn macsec_upd_txsa(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsec_upd_rxsa(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsec_upd_rxsc(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    if (tb_rxsc[MACSEC_RXSC_ATTR_ACTIVE]) {
    let mut new: bool = !!nla_get_u8(tb_rxsc[MACSEC_RXSC_ATTR_ACTIVE]);
    if (rx_sc.active != new)
...
#[no_mangle]
unsafe extern "C" fn macsec_is_configured(macsec: *mut macsec_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn macsec_set_head_tail_room(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn macsec_inherit_tso_max(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn macsec_upd_offload(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    ...
    macsec_genl_offload_policy, core::ptr::null_mut()))
    return -EINVAL;
    rtnl_lock();
    dev = get_dev_from_nl(genl_info_net(info), attrs);
    if (IS_ERR(dev)) {
...
#[no_mangle]
unsafe extern "C" fn copy_tx_sa_stats(skb: *mut sk_buff, sum: *mut macsec_tx_sa_stats) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_rx_sc_stats(skb: *mut sk_buff, sum: *mut macsec_rx_sc_stats) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_tx_sc_stats(skb: *mut sk_buff, sum: *mut macsec_tx_sc_stats) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_secy_stats(dev: *mut net_device, sum: *mut macsec_dev_stats) {
...
#[no_mangle]
unsafe extern "C" fn copy_secy_stats(skb: *mut sk_buff, sum: *mut macsec_dev_stats) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nla_put_secy(secy: *mut macsec_secy, skb: *mut sk_buff) -> c_int {
    ...
    {
    let mut tx_sc_stats: macsec_tx_sc_stats = {0, };
    let mut tx_sa_stats: macsec_tx_sa_stats = {0, };
    let mut rx_sc_stats: macsec_rx_sc_stats = {0, };
    let mut rx_sa_stats: macsec_rx_sa_stats = {0, };
    struct macsec_dev *macsec = netdev_priv(dev);
    let mut dev_stats: macsec_dev_stats = {0, };
    struct macsec_tx_sc *tx_sc = &secy.tx_sc;
...
#[no_mangle]
unsafe extern "C" fn macsec_dump_txsc(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsec_dev_init(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsec_dev_uninit(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn macsec_dev_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsec_dev_stop(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsec_dev_change_rx_flags(dev: *mut net_device, change: c_int) {
...
#[no_mangle]
unsafe extern "C" fn macsec_dev_set_rx_mode(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn macsec_set_mac_address(dev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsec_change_mtu(dev: *mut net_device, new_mtu: c_int) -> c_int {
    static int macsec_change_mtu(struct net_device *dev, int new_mtu)
    {
    struct macsec_dev *macsec = macsec_priv(dev);
    let mut extra: c_uint = macsec.secy.icv_len + macsec_extra_len(true);
...
#[no_mangle]
unsafe extern "C" fn macsec_get_iflink(dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsec_free_netdev(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn macsec_setup(dev: *mut net_device) {
    ...
    struct macsec_tx_sa *tx_sa;
    let mut encoding_sa: u8 = nla_get_u8(data[IFLA_MACSEC_ENCODING_SA]);
    ...
    let mut replay_window: u32 = nla_get_u32(data[IFLA_MACSEC_WINDOW]);
...
// for XPN cipher suites
    ...
    {
    struct macsec_dev *macsec = macsec_priv(dev);
    let mut macsec_offload_state_change: bool = false;
    enum macsec_offload offload;
    struct macsec_tx_sc tx_sc;
    struct macsec_secy secy;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn macsec_del_dev(macsec: *mut macsec_dev) {
    ...
    if (sa) {
    RCU_INIT_POINTER(macsec.secy.tx_sc.sa[i], core::ptr::null_mut());
    clear_tx_sa(sa);
    }
    }
    }
#[no_mangle]
unsafe extern "C" fn macsec_common_dellink(dev: *mut net_device, head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn macsec_dellink(dev: *mut net_device, head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn sci_exists(dev: *mut net_device, sci: sci_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dev_to_sci(dev: *mut net_device, port: __be16) -> sci_t {
    static sci_t dev_to_sci(struct net_device *dev, __be16 port)
    {
    return make_sci(dev.dev_addr, port);
    }
#[no_mangle]
unsafe extern "C" fn macsec_add_dev(dev: *mut net_device, sci: sci_t, icv_len: u8) -> c_int {
...
//
    ...
    let mut icv_len: u8 = MACSEC_DEFAULT_ICV_LEN;
...
// send_sci must be set to true when transmit sci explicitly is set
    ...
    let mut send_sci: u8 = !!nla_get_u8(data[IFLA_MACSEC_INC_SCI]);
    if (!send_sci)
    return -EINVAL;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(data[IFLA_MACSEC_PORT]: data &&) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn macsec_netdev_is_offloaded(dev: *mut net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn macsec_get_size(dev: *const net_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn is_macsec_master(dev: *mut net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn macsec_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn macsec_exit() -> void __exit {
