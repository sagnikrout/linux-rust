...
//! Source: drivers/net/thunderbolt/main.c
#![no_std]
...
pub const TBNET_LOGIN_DELAY: c_int = 4500;
pub const TBNET_LOGIN_TIMEOUT: c_int = 500;
pub const TBNET_LOGOUT_TIMEOUT: c_int = 1000;
pub const TBNET_RING_SIZE: c_int = 256;
pub const TBNET_LOGIN_RETRIES: c_int = 60;
pub const TBNET_LOGOUT_RETRIES: c_int = 10;
pub const TBNET_THROTTLING: c_int = 128000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct thunderbolt_ip_frame_header {
    pub frame_size: __le32,
    pub frame_index: __le16,
    pub frame_id: __le16,
    pub frame_count: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct thunderbolt_ip_header {
    pub route_hi: u32,
    pub route_lo: u32,
    pub length_sn: u32,
    pub uuid: uuid_t,
    pub initiator_uuid: uuid_t,
    pub target_uuid: uuid_t,
    pub type: u32,
    pub command_id: u32,
}

pub const TBIP_HDR_SN_SHIFT: c_int = 27;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct thunderbolt_ip_login {
    pub hdr: thunderbolt_ip_header,
    pub proto_version: u32,
    pub transmit_path: u32,
    pub reserved: [u32; 4],
}

pub const TBIP_LOGIN_PROTO_VERSION: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct thunderbolt_ip_login_response {
    pub hdr: thunderbolt_ip_header,
    pub status: u32,
    pub receiver_mac: [u32; 2],
    pub receiver_mac_len: u32,
    pub reserved: [u32; 4],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct thunderbolt_ip_logout {
    pub hdr: thunderbolt_ip_header,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct thunderbolt_ip_status {
    pub hdr: thunderbolt_ip_header,
    pub status: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tbnet_ring {
    pub frames: [tbnet_frame; TBNET_RING_SIZE],
    pub cons: c_uint,
    pub prod: c_uint,
...
#[derive(Copy, Clone)]
pub struct tbnet {
    pub svc: *const tb_service,
    pub xd: *mut tb_xdomain,
    pub handler: tb_protocol_handler,
    pub dev: *mut net_device,
    pub napi: napi_struct,
    pub stats: tbnet_stats,
    pub skb: *mut sk_buff,
    pub command_id: core::sync::atomic::AtomicI32,
    pub login_sent: bool,
    pub login_received: bool,
    pub local_transmit_path: c_int,
    pub remote_transmit_path: c_int,
    pub connection_lock: mutex,
    pub login_retries: c_int,
    pub login_work: delayed_work,
    pub connected_work: work_struct,
    pub disconnect_work: work_struct,
    pub rx_hdr: thunderbolt_ip_frame_header,
    pub rx_ring: tbnet_ring,
    pub frame_id: core::sync::atomic::AtomicI32,
    pub tx_ring: tbnet_ring,
}
...
// ThunderboltIP protocol UUID: 798f589e-3616-8a47-97c6-5664a920c8dd
    ...
    let mut tbnet_e2e: static bool = true;
...
#[no_mangle]
unsafe extern "C" fn tbnet_login_request(net: *mut tbnet, sequence: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tbnet_logout_request(net: *mut tbnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn start_login(net: *mut tbnet) {
...
#[no_mangle]
unsafe extern "C" fn stop_login(net: *mut tbnet) {
...
#[no_mangle]
unsafe extern "C" fn tbnet_free_buffers(ring: *mut tbnet_ring) {
    ...
    tf.page = core::ptr::null_mut();
    }
    ring.cons = 0;
    ring.prod = 0;
    }
#[no_mangle]
unsafe extern "C" fn tbnet_tear_down(net: *mut tbnet, send_logout: bool) {
...
#[no_mangle]
unsafe extern "C" fn tbnet_handle_packet(buf: *const c_void, size: usize, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tbnet_available_buffers(ring: *const tbnet_ring) -> c_uint {
    static unsigned int tbnet_available_buffers(const struct tbnet_ring *ring)
    {
    return ring.prod - ring.cons;
    }
#[no_mangle]
unsafe extern "C" fn tbnet_alloc_rx_buffers(net: *mut tbnet, nbuffers: c_uint) -> c_int {
    ...
    while (nbuffers--) {
    struct device *dma_dev = tb_ring_dma_device(ring.ring);
    let mut index: c_uint = ring.prod & (TBNET_RING_SIZE - 1);
...
#[no_mangle]
unsafe extern "C" fn tbnet_alloc_tx_buffers(net: *mut tbnet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tbnet_connect_failed(net: *mut tbnet) {
...
#[no_mangle]
unsafe extern "C" fn tbnet_connected_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tbnet_login_work(work: *mut work_struct) {
    static void tbnet_login_work(struct work_struct *work)
    {
    struct tbnet *net = container_of(work, typeof(*net), login_work.work);
    let mut delay: c_ulong = msecs_to_jiffies(TBNET_LOGIN_DELAY);
    int ret;
    if (netif_carrier_ok(net.dev))
    return;
...
#[no_mangle]
unsafe extern "C" fn tbnet_disconnect_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tbnet_start_poll(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tbnet_open(dev: *mut net_device) -> c_int {
    ...
    net.tx_ring.ring = core::ptr::null_mut();
    return hopid;
    }
...
#[no_mangle]
unsafe extern "C" fn tbnet_stop(dev: *mut net_device) -> c_int {
    ...
    net.rx_ring.ring = core::ptr::null_mut();
...
// Remove payload length from checksum
    let mut paylen: u32 = skb.len - skb_transport_offset(skb);
    let mut wsum: __wsum = ( __wsum)htonl(paylen);
...
#[no_mangle]
pub unsafe extern "C" fn if(IPPROTO_UDP: ip_hdr(skb)->protocol ==) -> else {
...
// len = skb_frag_size(frag);
    ...
    let mut frame_id: u16 = atomic_read(&net.frame_id);
...
// If overall packet is bigger than the frame data size
    ...
    let mut size_left: c_uint = TBNET_MAX_PAYLOAD_SIZE;
...
#[no_mangle]
unsafe extern "C" fn tbnet_generate_mac(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn tbnet_probe(svc: *mut tb_service) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tbnet_remove(svc: *mut tb_service) {
...
#[no_mangle]
unsafe extern "C" fn tbnet_shutdown(svc: *mut tb_service) {
    static void tbnet_shutdown(struct tb_service *svc)
    {
    tbnet_tear_down(tb_service_get_drvdata(svc), true);
    }
#[no_mangle]
unsafe extern "C" fn tbnet_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tbnet_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tbnet_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tbnet_exit() -> void __exit {
