...
//! Source: drivers/net/vmxnet3/vmxnet3_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vmxnet3_enable_encap_offloads(netdev: *mut net_device, features: netdev_features_t) {
...
#[no_mangle]
unsafe extern "C" fn vmxnet3_disable_encap_offloads(netdev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn vmxnet3_set_features(netdev: *mut net_device, features: netdev_features_t) -> c_int {
    ...
    NETIF_F_GSO_UDP_TUNNEL_CSUM;
    let mut udp_tun_enabled: u8 = (netdev.features & tun_offload_mask) != 0;
...
#[no_mangle]
unsafe extern "C" fn vmxnet3_get_rx_ring_count(netdev: *mut net_device) -> u32 {
    ...
    struct vmxnet3_adapter *adapter = netdev_priv(netdev);
    struct UPT1_RSSConf *rssConf = adapter.rss_conf;
    let mut n: c_uint = rssConf.indTableSize;
...
#[no_mangle]
pub unsafe extern "C" fn vmxnet3_set_ethtool_ops(netdev: *mut net_device) {
