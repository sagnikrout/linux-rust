...
//! Source: drivers/net/virtio_net.c
#![no_std]
...
// #define DEBUG
    ...
    let mut napi_weight: static int = NAPI_POLL_WEIGHT;
    module_param(napi_weight, int, 0444);
    let mut csum: static bool = true, gso = true, napi_tx = true;
    module_param(csum, bool, 0444);
    module_param(gso, bool, 0444);
    module_param(napi_tx, bool, 0644);
pub const VIRTIO_OFFLOAD_MAP_MIN: c_int = 46;
pub const VIRTIO_OFFLOAD_MAP_MAX: c_int = 47;
pub const VIRTIO_FEATURES_MAP_MIN: c_int = 65;

    VIRTIO_OFFLOAD_MAP_MIN)
#[no_mangle]
unsafe extern "C" fn virtio_is_mapped_offload(obit: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn virtio_offload_to_feature(obit: c_uint) -> c_uint {
...
pub const GOOD_COPY_LEN: c_int = 128;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtnet_stat_desc {
    pub desc: [c_char; ETH_GSTRING_LEN],
    pub offset: usize,
    pub qstat_offset: usize,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtnet_sq_free_stats {
    pub packets: u64,
    pub bytes: u64,
    pub napi_packets: u64,
    pub napi_bytes: u64,
    pub xsk: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtnet_sq_stats {
    pub syncp: u64_stats_sync,
    pub packets: u64_stats_t,
    pub bytes: u64_stats_t,
    pub xdp_tx: u64_stats_t,
    pub xdp_tx_drops: u64_stats_t,
    pub kicks: u64_stats_t,
    pub tx_timeouts: u64_stats_t,
    pub stop: u64_stats_t,
    pub wake: u64_stats_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtnet_rq_stats {
    pub syncp: u64_stats_sync,
    pub packets: u64_stats_t,
    pub bytes: u64_stats_t,
    pub drops: u64_stats_t,
    pub xdp_packets: u64_stats_t,
    pub xdp_tx: u64_stats_t,
    pub xdp_redirects: u64_stats_t,
    pub xdp_drops: u64_stats_t,
    pub kicks: u64_stats_t,
}
...
pub const VIRTNET_Q_TYPE_RX: c_int = 0;
pub const VIRTNET_Q_TYPE_TX: c_int = 1;
pub const VIRTNET_Q_TYPE_CQ: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtnet_interrupt_coalesce {
    pub max_packets: u32,
    pub max_usecs: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct send_queue {
// Virtqueue associated with this send _queue
    pub vq: *mut virtqueue,
// TX: fragments + linear part + virtio header
    pub 2]: scatterlist sg[MAX_SKB_FRAGS +,
// Name of the send queue: output.$index
    pub name: [c_char; 16],
    pub stats: virtnet_sq_stats,
    pub intr_coal: virtnet_interrupt_coalesce,
    pub napi: napi_struct,
// Record whether sq is in reset state.
    pub reset: bool,
    pub xsk_pool: *mut xsk_buff_pool,
    pub xsk_hdr_dma_addr: dma_addr_t,
}

// Internal representation of a receive virtqueue
#[repr(C)]
#[derive(Copy, Clone)]
pub struct receive_queue {
// Virtqueue associated with this receive_queue
    pub vq: *mut virtqueue,
    pub napi: napi_struct,
    pub xdp_prog: *mut bpf_prog __rcu,
    pub stats: virtnet_rq_stats,
...
// Dynamic Interrupt Moderation
    pub dim: dim,
    pub packets_in_napi: u32,
    pub intr_coal: virtnet_interrupt_coalesce,
// Chain pages by the private ptr.
    pub pages: *mut page,
// Average packet length for mergeable receive buffers.
    pub mrg_avg_pkt_len: ewma_pkt_len,
    pub page_pool: *mut page_pool,
// True if page_pool handles DMA mapping via PP_FLAG_DMA_MAP
    pub use_page_pool_dma: bool,
// RX: fragments + linear part + virtio header
    pub 2]: scatterlist sg[MAX_SKB_FRAGS +,
// Min single buffer size for mergeable buffers case.
    pub min_buf_len: c_uint,
// Name of this receive queue: input.$index
    pub name: [c_char; 16],
    pub xdp_rxq: xdp_rxq_info,
    pub xsk_pool: *mut xsk_buff_pool,
// xdp rxq used by xsk
    pub xsk_rxq_info: xdp_rxq_info,
    pub xsk_buffs: *mut xdp_buff,
}

// Control VQ buffers: protected by the rtnl lock
#[repr(C)]
#[derive(Copy, Clone)]
pub struct control_buf {
    pub hdr: virtio_net_ctrl_hdr,
    pub status: virtio_net_ctrl_ack,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtnet_info {
    pub vdev: *mut virtio_device,
    pub cvq: *mut virtqueue,
    pub dev: *mut net_device,
    pub sq: *mut send_queue,
    pub rq: *mut receive_queue,
    pub status: c_uint,
...
// # of XDP queue pairs currently used by the driver
    pub xdp_queue_pairs: u16,
// xdp_queue_pairs may be 0, when xdp is already loaded. So add this.
    pub xdp_enabled: bool,
// I like... big packets and I cannot lie!
    pub big_packets: bool,
// number of sg entries allocated for big packets
    pub big_packets_num_skbfrags: c_uint,
// Host will merge rx buffers for big packets (shake it! shake it!)
    pub mergeable_rx_bufs: bool,
// Host supports rss and/or hash report
    pub has_rss: bool,
    pub has_rss_hash_report: bool,
    pub rss_key_size: u8,
    pub rss_indir_table_size: u16,
    pub rss_hash_types_supported: u32,
    pub rss_hash_types_saved: u32,
// Has control virtqueue
    pub has_cvq: bool,
// Lock to protect the control VQ
    pub cvq_lock: mutex,
// Host can handle any s/g split between our header and packet data
    pub any_header_sg: bool,
// Packet virtio header size
    pub hdr_len: u8,
// UDP tunnel support
    pub tx_tnl: bool,
    pub rx_tnl: bool,
    pub rx_tnl_csum: bool,
// Work struct for config space updates
    pub config_work: work_struct,
// Work struct for setting rx mode
    pub rx_mode_work: work_struct,
// OK to queue work setting RX mode?
    pub rx_mode_work_enabled: bool,
// Does the affinity hint is set for virtqueues?
    pub affinity_hint_set: bool,
// CPU hotplug instances for online & dead
    pub node: hlist_node,
    pub node_dead: hlist_node,
    pub ctrl: *mut control_buf,
// Ethtool settings
    pub duplex: u8,
    pub speed: u32,
...
// Interrupt coalescing settings
    pub intr_coal_tx: virtnet_interrupt_coalesce,
    pub intr_coal_rx: virtnet_interrupt_coalesce,
    pub guest_offloads: c_ulong,
    pub guest_offloads_capable: c_ulong,
// failover when STANDBY feature enabled
    pub failover: *mut failover,
    pub device_stats_cap: u64,
    pub rss_hdr: *mut virtio_net_rss_config_hdr,
// Must be last as it ends in a flexible-array member.
    TRAILING_OVERLAP(struct virtio_net_rss_config_trailer, rss_trailer, hash_key_data,
    pub rss_hash_key_data: [u8; NETDEV_RSS_KEY_LEN],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct padded_vnet_hdr {
    pub hdr: virtio_net_hdr_v1_hash,
//
// hdr is in a separate sg buffer, and data sg buffer shares same page
// with this header sg. This padding makes next sg 16 byte aligned
// after the header.
//
    pub padding: [c_char; 12],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_net_common_hdr {
    union {
    pub hdr: virtio_net_hdr,
    pub mrg_hdr: virtio_net_hdr_mrg_rxbuf,
    pub hash_v1_hdr: virtio_net_hdr_v1_hash,
    pub tnl_hdr: virtio_net_hdr_v1_hash_tunnel,
}
...
#[no_mangle]
unsafe extern "C" fn virtnet_rss_hdr_size(vi: *const virtnet_info) -> usize {
    static size_t virtnet_rss_hdr_size(const struct virtnet_info *vi)
    {
    let mut indir_table_size: u16 = vi.has_rss ? vi.rss_indir_table_size : 1;
    return struct_size(vi.rss_hdr, indirection_table, indir_table_size);
    }
#[no_mangle]
unsafe extern "C" fn virtnet_rss_trailer_size(vi: *const virtnet_info) -> usize {
...
pub const VIRTIO_XSK_FLAG_OFFSET: c_int = 2;
#[no_mangle]
unsafe extern "C" fn virtnet_xmit_ptr_unpack(ptr: *mut c_void) -> enum virtnet_xmit_type {
    static enum virtnet_xmit_type virtnet_xmit_ptr_unpack(void **ptr)
    {
    let mut p: c_ulong = (unsigned long)*ptr;
...
#[no_mangle]
unsafe extern "C" fn virtnet_ptr_to_xsk_buff_len(ptr: *mut c_void) -> u32 {
    static u32 virtnet_ptr_to_xsk_buff_len(void *ptr)
    {
    return ((unsigned long)ptr) >> VIRTIO_XSK_FLAG_OFFSET;
    }
#[no_mangle]
unsafe extern "C" fn sg_fill_dma(sg: *mut scatterlist, addr: dma_addr_t, len: u32) {
    ...
    unsigned int len;
    void *ptr;
    while ((ptr = virtqueue_get_buf(sq.vq, &len)) != core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn vq2txq(vq: *mut virtqueue) -> c_int {
    static int vq2txq(struct virtqueue *vq)
    {
    return (vq.index - 1) / 2;
    }
#[no_mangle]
unsafe extern "C" fn txq2vq(txq: c_int) -> c_int {
    static int txq2vq(int txq)
    {
    return txq * 2 + 1;
    }
#[no_mangle]
unsafe extern "C" fn vq2rxq(vq: *mut virtqueue) -> c_int {
    static int vq2rxq(struct virtqueue *vq)
    {
    return vq.index / 2;
    }
#[no_mangle]
unsafe extern "C" fn rxq2vq(rxq: c_int) -> c_int {
    static int rxq2vq(int rxq)
    {
    return rxq * 2;
    }
#[no_mangle]
unsafe extern "C" fn vq_type(vi: *mut virtnet_info, qid: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn give_pages(rq: *mut receive_queue, page: *mut page) {
...
#[no_mangle]
unsafe extern "C" fn enable_rx_mode_work(vi: *mut virtnet_info) {
...
#[no_mangle]
unsafe extern "C" fn disable_rx_mode_work(vi: *mut virtnet_info) {
    ...
    {
    let mut index: c_uint = vq2txq(sq.vq);
...
#[no_mangle]
unsafe extern "C" fn skb_xmit_done(vq: *mut virtqueue) {
    static void skb_xmit_done(struct virtqueue *vq)
    {
    struct virtnet_info *vi = vq.vdev.priv;
    let mut index: c_uint = vq2txq(vq);
...
pub const MRG_CTX_HEADER_SHIFT: c_int = 22;
...
#[no_mangle]
unsafe extern "C" fn mergeable_ctx_to_headroom(mrg_ctx: *mut c_void) -> c_uint {
    static unsigned int mergeable_ctx_to_headroom(void *mrg_ctx)
    {
    return (unsigned long)mrg_ctx >> MRG_CTX_HEADER_SHIFT;
    }
#[no_mangle]
unsafe extern "C" fn mergeable_ctx_to_truesize(mrg_ctx: *mut c_void) -> c_uint {
...
// Called from bottom half context
    ...
    struct page *page_to_free = core::ptr::null_mut();
...
//
    ...
    while (len) {
    let mut frag_size: c_uint = min((unsigned)PAGE_SIZE - offset, len);
...
#[no_mangle]
unsafe extern "C" fn virtnet_rq_unmap_free_buf(vq: *mut virtqueue, buf: *mut c_void) {
    static void virtnet_rq_unmap_free_buf(struct virtqueue *vq, void *buf)
    {
    struct virtnet_info *vi = vq.vdev.priv;
    struct receive_queue *rq;
    let mut i: c_int = vq2rxq(vq);
    rq = &vi.rq[i];
    if (rq.xsk_pool) {
    ...
    bool in_napi)
    {
    let mut stats: virtnet_sq_free_stats = {0};
...
#[no_mangle]
unsafe extern "C" fn is_xdp_raw_buffer_queue(vi: *mut virtnet_info, q: c_int) -> bool {
    static bool is_xdp_raw_buffer_queue(struct virtnet_info *vi, int q)
    {
    if (q < (vi.curr_queue_pairs - vi.xdp_queue_pairs))
    return false;
#[no_mangle]
pub unsafe extern "C" fn if(vi->curr_queue_pairs: q <) -> else {
...
//
    ...
    struct send_queue *sq)
    {
    let mut use_napi: bool = sq.napi.weight;
    int qnum;
    qnum = sq - vi.sq;
...
//
    ...
    xsk_buffs[i], core::ptr::null_mut(), gfp);
    if (err)
    goto err;
    }
    return num;
    ...
    let mut stats: virtnet_sq_free_stats = {};
    struct net_device *dev = vi.dev;
    let mut kicks: u64 = 0;
    int sent;
...
#[no_mangle]
unsafe extern "C" fn xsk_wakeup(napi: *mut napi_struct, vq: *mut virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_xsk_wakeup(dev: *mut net_device, qid: u32, flag: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_xsk_completed(sq: *mut send_queue, num: c_int) {
    static void virtnet_xsk_completed(struct send_queue *sq, int num)
    {
...
#[no_mangle]
unsafe extern "C" fn put_xdp_frags(rq: *mut receive_queue, xdp: *mut xdp_buff) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_get_headroom(vi: *mut virtnet_info) -> c_uint {
...
//
    ...
    unsigned int *len)
    {
    let mut tailroom: c_int = SKB_DATA_ALIGN(sizeof(struct skb_shared_info));
    struct page *page;
...
// len = page_off - XDP_PACKET_HEADROOM;
    ...
    struct virtnet_rq_stats *stats)
    {
    let mut header_offset: c_uint = VIRTNET_RX_PAD + xdp_headroom;
    let mut headroom: c_uint = vi.hdr_len + header_offset;
    struct virtio_net_hdr_mrg_rxbuf *hdr = buf + header_offset;
    struct page *page = virt_to_head_page(buf);
    struct page *xdp_page;
    struct xdp_buff xdp;
    struct sk_buff *skb;
    let mut metasize: c_uint = 0;
    u32 act;
...
// Partially checksummed packets must be dropped.
    ...
    let mut offset: c_int = buf - page_address(page) + header_offset;
    let mut tlen: c_uint = len + vi.hdr_len;
    let mut num_buf: c_int = 1;
...
// Recalculate length in case bpf program changed it
    ...
    struct virtnet_rq_stats *stats)
    {
    let mut xdp_headroom: c_uint = mergeable_ctx_to_headroom(ctx);
    let mut buflen: c_uint = mergeable_ctx_to_truesize(ctx);
    struct page *page = virt_to_head_page(buf);
    struct sk_buff *skb;
...
//
    ...
    int len;
    while (num_buf-- > 1) {
    buf = virtnet_rq_get_buf(rq, &len, core::ptr::null_mut());
    if (unlikely(!buf)) {
    pr_debug("%s: rx error: %d buffers missing\n",
    dev.name, num_buf);
    DEV_STATS_INC(dev, rx_length_errors);
...
// TODO: build xdp in big mode
    ...
    struct skb_shared_info *shinfo;
    let mut xdp_frags_truesz: c_uint = 0;
...
// xdp_frags_truesize = xdp_frags_truesz;
    ...
    struct virtio_net_hdr_mrg_rxbuf *hdr)
    {
    let mut truesize: c_uint = mergeable_ctx_to_truesize(ctx);
    let mut headroom: c_uint = mergeable_ctx_to_headroom(ctx);
    struct page *xdp_page;
...
// page = xdp_page;
    ...
    {
    struct virtio_net_hdr_mrg_rxbuf *hdr = buf;
    let mut num_buf: c_int = virtio16_to_cpu(vi.vdev, hdr.num_buffers);
    struct page *page = virt_to_head_page(buf);
    let mut offset: c_int = buf - page_address(page);
    let mut xdp_frags_truesz: c_uint = 0;
    struct sk_buff *head_skb;
    unsigned int frame_sz;
    struct xdp_buff xdp;
...
//
    ...
    gfp_t gfp)
    {
    let mut xdp_headroom: c_uint = virtnet_get_headroom(vi);
    let mut len: c_uint = vi.hdr_len + VIRTNET_RX_PAD + GOOD_PACKET_LEN + xdp_headroom;
    ...
    gfp_t gfp)
    {
    struct page *first, *list = core::ptr::null_mut();
    char *p;
    int i, err, offset;
...
// chain first in list head
    ...
    let mut hdr_len: usize = vi.hdr_len;
    unsigned int len;
    if (room)
    ...
    {
    let mut headroom: c_uint = virtnet_get_headroom(vi);
    let mut tailroom: c_uint = headroom ? sizeof(struct skb_shared_info) : 0;
    let mut room: c_uint = SKB_DATA_ALIGN(headroom + tailroom);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: vi->big_packets) -> else {
    else if (vi.big_packets)
...
#[no_mangle]
unsafe extern "C" fn skb_recv_done(rvq: *mut virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_napi_enable(rq: *mut receive_queue) {
    static void virtnet_napi_enable(struct receive_queue *rq)
    {
    struct virtnet_info *vi = rq.vq.vdev.priv;
    let mut qidx: c_int = vq2rxq(rq.vq);
    virtnet_napi_do_enable(rq.vq, &rq.napi);
    netif_queue_set_napi(vi.dev, qidx, NETDEV_QUEUE_TYPE_RX, &rq.napi);
    }
#[no_mangle]
unsafe extern "C" fn virtnet_napi_tx_enable(sq: *mut send_queue) {
    static void virtnet_napi_tx_enable(struct send_queue *sq)
    {
    struct virtnet_info *vi = sq.vq.vdev.priv;
    struct napi_struct *napi = &sq.napi;
    let mut qidx: c_int = vq2txq(sq.vq);
    if (!napi.weight)
    return;
...
#[no_mangle]
unsafe extern "C" fn virtnet_napi_tx_disable(sq: *mut send_queue) {
    ...
    let mut qidx: c_int = vq2txq(sq.vq);
    if (napi.weight) {
    netif_queue_set_napi(vi.dev, qidx, NETDEV_QUEUE_TYPE_TX, core::ptr::null_mut());
    napi_disable(napi);
    }
    }
#[no_mangle]
unsafe extern "C" fn virtnet_napi_disable(rq: *mut receive_queue) {
    static void virtnet_napi_disable(struct receive_queue *rq)
    {
    struct virtnet_info *vi = rq.vq.vdev.priv;
    struct napi_struct *napi = &rq.napi;
    let mut qidx: c_int = vq2rxq(rq.vq);
    netif_queue_set_napi(vi.dev, qidx, NETDEV_QUEUE_TYPE_RX, core::ptr::null_mut());
    napi_disable(napi);
    }
    ...
    while (packets < budget &&
    (buf = virtqueue_get_buf(rq.vq, &len)) != core::ptr::null_mut()) {
    receive_buf(vi, rq, buf, len, core::ptr::null_mut(), xdp_xmit, stats);
    packets++;
    }
    }
    return packets;
    ...
    {
    struct virtnet_info *vi = rq.vq.vdev.priv;
    let mut stats: virtnet_rq_stats = {};
    int i, packets;
    if (rq.xsk_pool)
...
//
    ...
    let mut offset: usize = virtnet_rq_stats_desc[i].offset;
...
#[no_mangle]
unsafe extern "C" fn virtnet_poll_cleantx(rq: *mut receive_queue, budget: c_int) {
    static void virtnet_poll_cleantx(struct receive_queue *rq, int budget)
    {
    struct virtnet_info *vi = rq.vq.vdev.priv;
    let mut index: c_uint = vq2rxq(rq.vq);
    struct send_queue *sq = &vi.sq[index];
    struct netdev_queue *txq = netdev_get_tx_queue(vi.dev, index);
...
#[no_mangle]
unsafe extern "C" fn virtnet_rx_dim_update(vi: *mut virtnet_info, rq: *mut receive_queue) {
    static void virtnet_rx_dim_update(struct virtnet_info *vi, struct receive_queue *rq)
    {
    let mut cur_sample: dim_sample = {};
...
#[no_mangle]
unsafe extern "C" fn virtnet_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_disable_queue_pair(vi: *mut virtnet_info, qp_index: c_int) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_enable_queue_pair(vi: *mut virtnet_info, qp_index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_cancel_dim(vi: *mut virtnet_info, dim: *mut dim) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_update_settings(vi: *mut virtnet_info) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_create_page_pools(vi: *mut virtnet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_destroy_page_pools(vi: *mut virtnet_info) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_poll_tx(napi: *mut napi_struct, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xmit_skb(sq: *mut send_queue, skb: *mut sk_buff, orphan: bool) -> c_int {
    ...
    int num_sg;
    let mut hdr_len: unsigned = vi.hdr_len;
    bool feature_hdrlen;
    bool can_push;
...
#[no_mangle]
unsafe extern "C" fn start_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t start_xmit(struct sk_buff *skb, struct net_device *dev)
    {
    struct virtnet_info *vi = netdev_priv(dev);
    let mut qnum: c_int = skb_get_queue_mapping(skb);
    struct send_queue *sq = &vi.sq[qnum];
    int err;
    struct netdev_queue *txq = netdev_get_tx_queue(dev, qnum);
    let mut xmit_more: bool = netdev_xmit_more();
    let mut use_napi: bool = sq.napi.weight;
    bool kick;
    if (!use_napi)
    free_old_xmit(sq, txq, false);
...
// Don't wait up for transmitted skbs to be freed.
    ...
    struct receive_queue *rq)
    {
    let mut running: bool = netif_running(vi.dev);
    if (running) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_rx_pause_all(vi: *mut virtnet_info) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_rx_resume_all(vi: *mut virtnet_info) {
    ...
    {
    let mut old_ring_num: c_uint = virtqueue_get_vring_size(rq.vq);
    struct xdp_buff **tmp_xsk_buffs = core::ptr::null_mut();
    int err, qindex;
    qindex = rq - vi.rq;
    ...
    err = virtqueue_resize(rq.vq, ring_num, virtnet_rq_unmap_free_buf, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn virtnet_tx_pause(vi: *mut virtnet_info, sq: *mut send_queue) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_tx_resume(vi: *mut virtnet_info, sq: *mut send_queue) {
...
//
    ...
    let mut out_num: u32 = 0, tmp, in_num = 0;
    bool ok;
    int ret;
...
//
    ...
    struct scatterlist *out)
    {
    return virtnet_send_command_reply(vi, class, cmd, out, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn virtnet_set_mac_address(dev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_ack_link_announce(vi: *mut virtnet_info) {
    static void virtnet_ack_link_announce(struct virtnet_info *vi)
    {
    if (!virtnet_send_command(vi, VIRTIO_NET_CTRL_ANNOUNCE,
    VIRTIO_NET_CTRL_ANNOUNCE_ACK, core::ptr::null_mut()))
    dev_warn(&vi.dev.dev, "Failed to ack link announce.\n");
    }
    static bool virtnet_commit_rss_command(struct virtnet_info *vi);
#[no_mangle]
unsafe extern "C" fn virtnet_rss_update_by_qpairs(vi: *mut virtnet_info, queue_pairs: u16) {
    static void virtnet_rss_update_by_qpairs(struct virtnet_info *vi, u16 queue_pairs)
    {
    let mut indir_val: u32 = 0;
    let mut i: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn virtnet_set_queues(vi: *mut virtnet_info, queue_pairs: u16) -> c_int {
    static int virtnet_set_queues(struct virtnet_info *vi, u16 queue_pairs)
    {
    struct virtio_net_ctrl_mq *mq __free(kfree) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn virtnet_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_rx_mode_work(work: *mut work_struct) {
    static void virtnet_rx_mode_work(struct work_struct *work)
    {
    struct virtnet_info *vi =
    container_of(work, struct virtnet_info, rx_mode_work);
    u8 *promisc_allmulti  __free(kfree) = core::ptr::null_mut();
    struct net_device *dev = vi.dev;
...
#[no_mangle]
unsafe extern "C" fn virtnet_set_rx_mode(dev: *mut net_device) {
    ...
    {
    struct virtnet_info *vi = netdev_priv(dev);
    __virtio16 *_vid __free(kfree) = core::ptr::null_mut();
    struct scatterlist sg;
...
#[no_mangle]
unsafe extern "C" fn virtnet_clean_affinity(vi: *mut virtnet_info) {
    static void virtnet_clean_affinity(struct virtnet_info *vi)
    {
    int i;
    if (vi.affinity_hint_set) {
    for (i = 0; i < vi.max_queue_pairs; i++) {
    virtqueue_set_affinity(vi.rq[i].vq, core::ptr::null_mut());
    virtqueue_set_affinity(vi.sq[i].vq, core::ptr::null_mut());
    }
    vi.affinity_hint_set = false;
    }
    }
#[no_mangle]
unsafe extern "C" fn virtnet_set_affinity(vi: *mut virtnet_info) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_cpu_online(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_cpu_dead(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_cpu_down_prep(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_cpu_notif_add(vi: *mut virtnet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_cpu_notif_remove(vi: *mut virtnet_info) {
    ...
    {
    struct virtio_net_ctrl_coal_vq *coal_vq __free(kfree) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn virtnet_commit_rss_command(vi: *mut virtnet_info) -> bool {
    static bool virtnet_commit_rss_command(struct virtnet_info *vi)
    {
    struct net_device *dev = vi.dev;
...
#[no_mangle]
unsafe extern "C" fn virtnet_init_default_rss(vi: *mut virtnet_info) {
    ...
    {
    struct virtnet_info *vi = netdev_priv(dev);
    let mut new_hashtypes: u32 = vi.rss_hash_types_saved;
    let mut is_disable: bool = info.data & RXH_DISCARD;
    let mut is_l4: bool = info.data == (RXH_IP_SRC | RXH_IP_DST | RXH_L4_B_0_1 | RXH_L4_B_2_3);
...
// TODO: Eliminate OOO packets during switching
    ...
    {
    struct virtnet_info *vi = netdev_priv(dev);
    let mut queue_pairs: u16 = channels.combined_count;
    int err;
...
#[no_mangle]
unsafe extern "C" fn virtnet_get_stats_string(vi: *mut virtnet_info, type: c_int, qid: c_int, data: *mut u8) {
    ...
    virtnet_stats_sprintf(&p, core::ptr::null_mut(), noq_fmt, num, -1, desc);
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn stats_sum_queue(sum: *mut u64, num: u32, q_value: *mut u64, q_num: u32) {
    static void stats_sum_queue(u64 *sum, u32 num, u64 *q_value, u32 q_num)
    {
    let mut step: u32 = num;
    int i, j;
    u64 *p;
    for (i = 0; i < num; ++i) {
    p = sum + i;
...
// skip the total fields of pairs
    ...
    int qid, int *idx)
    {
    let mut qtype: c_int = vq_type(vi, qid);
    let mut bitmap: u64 = ctx.bitmap[qtype];
    if (!bitmap)
    return;
...
#[no_mangle]
unsafe extern "C" fn virtnet_get_strings(dev: *mut net_device, stringset: u32, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
    static int virtnet_get_sset_count(struct net_device *dev, int sset)
    {
    struct virtnet_info *vi = netdev_priv(dev);
    let mut ctx: virtnet_stats_ctx = {0};
    u32 pair_count;
    switch (sset) {
    case ETH_SS_STATS:
    virtnet_stats_ctx_init(vi, &ctx, core::ptr::null_mut(), false);
    ...
    {
    struct virtio_net_ctrl_coal_tx *coal_tx __free(kfree) = core::ptr::null_mut();
    ...
    struct ethtool_coalesce *ec)
    {
    struct virtio_net_ctrl_coal_rx *coal_rx __free(kfree) = core::ptr::null_mut();
    let mut rx_ctrl_dim_on: bool = !!ec.use_adaptive_rx_coalesce;
...
#[no_mangle]
unsafe extern "C" fn virtnet_rx_dim_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_coal_params_supported(ec: *mut ethtool_coalesce) -> c_int {
...
// should_update = true;
    ...
    let mut update_napi: bool = false;
...
#[no_mangle]
unsafe extern "C" fn virtnet_init_settings(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_get_rxfh_key_size(dev: *mut net_device) -> u32 {
    static u32 virtnet_get_rxfh_key_size(struct net_device *dev)
    {
    return ((struct virtnet_info *)netdev_priv(dev)).rss_key_size;
    }
#[no_mangle]
unsafe extern "C" fn virtnet_get_rxfh_indir_size(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn virtnet_get_rx_ring_count(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn virtnet_freeze_down(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_restore_up(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_set_guest_offloads(vi: *mut virtnet_info, offloads: u64) -> c_int {
    static int virtnet_set_guest_offloads(struct virtnet_info *vi, u64 offloads)
    {
    __virtio64 *_offloads __free(kfree) = core::ptr::null_mut();
    struct scatterlist sg;
...
#[no_mangle]
unsafe extern "C" fn virtnet_clear_guest_offloads(vi: *mut virtnet_info) -> c_int {
    static int virtnet_clear_guest_offloads(struct virtnet_info *vi)
    {
    let mut offloads: u64 = 0;
    if (!vi.guest_offloads)
    return 0;
    return virtnet_set_guest_offloads(vi, offloads);
    }
#[no_mangle]
unsafe extern "C" fn virtnet_restore_guest_offloads(vi: *mut virtnet_info) -> c_int {
    static int virtnet_restore_guest_offloads(struct virtnet_info *vi)
    {
    let mut offloads: u64 = vi.guest_offloads;
    if (!vi.guest_offloads)
    return 0;
    return virtnet_set_guest_offloads(vi, offloads);
    }
    ...
    virtnet_rx_pause(vi, rq);
    err = virtqueue_reset(rq.vq, virtnet_rq_unmap_free_buf, core::ptr::null_mut());
    if (err) {
...
//
    ...
    return 0;
    err_sq:
    virtnet_rq_bind_xsk_pool(vi, rq, core::ptr::null_mut());
    err_rq:
...
#[no_mangle]
unsafe extern "C" fn virtnet_xsk_pool_disable(dev: *mut net_device, qid: u16) -> c_int {
    ...
    rq = &vi.rq[qid];
    pool = rq.xsk_pool;
    err = virtnet_rq_bind_xsk_pool(vi, rq, core::ptr::null_mut());
    err |= virtnet_sq_bind_xsk_pool(vi, sq, core::ptr::null_mut());
    xsk_pool_dma_unmap(pool, 0);
...
#[no_mangle]
unsafe extern "C" fn virtnet_xsk_pool_setup(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
    ...
    sizeof(struct skb_shared_info));
    let mut max_sz: c_uint = PAGE_SIZE - room - ETH_HLEN;
    struct virtnet_info *vi = netdev_priv(dev);
    struct bpf_prog *old_prog;
    let mut xdp_qp: u16 = 0, curr_qp;
    int i, err;
...
#[no_mangle]
unsafe extern "C" fn virtnet_xdp(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_init_irq_moder(vi: *mut virtnet_info) -> c_int {
    static int virtnet_init_irq_moder(struct virtnet_info *vi)
    {
    let mut profile_flags: u8 = 0, coal_flags = 0;
    int ret, i;
    ...
    0, virtnet_rx_dim_work, core::ptr::null_mut());
    if (ret)
    return ret;
    for (i = 0; i < vi.max_queue_pairs; i++)
...
#[no_mangle]
unsafe extern "C" fn virtnet_free_irq_moder(vi: *mut virtnet_info) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_config_changed_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_config_changed(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_free_queues(vi: *mut virtnet_info) {
...
#[no_mangle]
unsafe extern "C" fn _free_receive_bufs(vi: *mut virtnet_info) {
    ...
    RCU_INIT_POINTER(vi.rq[i].xdp_prog, core::ptr::null_mut());
    if (old_prog)
    bpf_prog_put(old_prog);
    }
    }
#[no_mangle]
unsafe extern "C" fn free_receive_bufs(vi: *mut virtnet_info) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_sq_free_unused_buf(vq: *mut virtqueue, buf: *mut c_void) {
    static void virtnet_sq_free_unused_buf(struct virtqueue *vq, void *buf)
    {
    struct virtnet_info *vi = vq.vdev.priv;
    struct send_queue *sq;
    let mut i: c_int = vq2txq(vq);
    sq = &vi.sq[i];
...
#[no_mangle]
unsafe extern "C" fn virtnet_sq_free_unused_buf_done(vq: *mut virtqueue) {
    static void virtnet_sq_free_unused_buf_done(struct virtqueue *vq)
    {
    struct virtnet_info *vi = vq.vdev.priv;
    let mut i: c_int = vq2txq(vq);
...
#[no_mangle]
unsafe extern "C" fn free_unused_bufs(vi: *mut virtnet_info) {
    static void free_unused_bufs(struct virtnet_info *vi)
    {
    void *buf;
    int i;
    ...
    while ((buf = virtqueue_detach_unused_buf(vq)) != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn virtnet_del_vqs(vi: *mut virtnet_info) {
    static void virtnet_del_vqs(struct virtnet_info *vi)
    {
    struct virtio_device *vdev = vi.vdev;
    virtnet_clean_affinity(vi);
...
//
#[no_mangle]
unsafe extern "C" fn mergeable_min_buf_len(vi: *mut virtnet_info, vq: *mut virtqueue) -> c_uint {
    static unsigned int mergeable_min_buf_len(struct virtnet_info *vi, struct virtqueue *vq)
    {
    let mut hdr_len: c_uint = vi.hdr_len;
    let mut rq_size: c_uint = virtqueue_get_vring_size(vq);
    let mut packet_len: c_uint = vi.big_packets ? IP_MAX_MTU : vi.dev.max_mtu;
    let mut buf_len: c_uint = hdr_len + ETH_HLEN + VLAN_HLEN + packet_len;
    let mut min_buf_len: c_uint = DIV_ROUND_UP(buf_len, rq_size);
    return max(max(min_buf_len, hdr_len) - hdr_len,
    (unsigned int)GOOD_PACKET_LEN);
    }
#[no_mangle]
unsafe extern "C" fn virtnet_find_vqs(vi: *mut virtnet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_alloc_queues(vi: *mut virtnet_info) -> c_int {
    ...
    goto err_rq;
    for (i = 0; i < vi.max_queue_pairs; i++) {
    vi.rq[i].pages = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn init_vqs(vi: *mut virtnet_info) -> c_int {
    static int init_vqs(struct virtnet_info *vi)
    {
    int ret;
// Allocate send & receive queues
    ...
    let mut queue_index: c_uint = get_netdev_rx_queue_index(queue);
    let mut headroom: c_uint = virtnet_get_headroom(vi);
    let mut tailroom: c_uint = headroom ? sizeof(struct skb_shared_info) : 0;
...
#[no_mangle]
unsafe extern "C" fn virtnet_validate_features(vdev: *mut virtio_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn virtnet_validate(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_check_guest_gso(vi: *const virtnet_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn virtnet_set_big_packets(vi: *mut virtnet_info, mtu: c_int) {
    static void virtnet_set_big_packets(struct virtnet_info *vi, const int mtu)
    {
    let mut guest_gso: bool = virtnet_check_guest_gso(vi);
...
pub const VIRTIO_NET_HASH_REPORT_MAX_TABLE: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn virtnet_probe(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: vi->has_rss_hash_report) -> else {
...
//
    ...
    if (virtio_has_feature(vi.vdev, VIRTIO_NET_F_DEVICE_STATS)) {
    struct virtio_net_stats_capabilities *stats_cap  __free(kfree) = core::ptr::null_mut();
    struct scatterlist sg;
    __le64 v;
...
#[no_mangle]
unsafe extern "C" fn remove_vq_common(vi: *mut virtnet_info) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_remove(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtnet_freeze(vdev: *mut virtio_device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn virtnet_restore(vdev: *mut virtio_device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn virtio_net_driver_init() -> __init int {
    ...
    core::ptr::null_mut(), virtnet_cpu_dead);
    if (ret)
    goto err_dead;
...
#[no_mangle]
unsafe extern "C" fn virtio_net_driver_exit() -> __exit void {
