...
//! Source: drivers/net/mctp/mctp-usblib-test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mctp_usblib_test_dev {
    pub ndev: *mut net_device,
    pub mdev: *mut mctp_dev,
    pub rx_pkts: sk_buff_head,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mctp_usblib_test_ctx {
    pub dev: *mut mctp_usblib_test_dev,
    pub rt: mctp_route,
}
...
// we don't track any TXed packets at present
    ...
    let mut ep_maxpacket: static u16 = 512;
    let mut local_eid: static mctp_eid_t = 8;
#[no_mangle]
unsafe extern "C" fn mctp_usblib_dev_setup(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn mctp_usblib_test_dev_action(data: *mut c_void) {
    ...
    return core::ptr::null_mut();
    rtnl_lock();
    rc = dev_open(ndev, core::ptr::null_mut());
    rtnl_unlock();
    if (rc)
    return core::ptr::null_mut();
    return dev;
...
#[no_mangle]
unsafe extern "C" fn mctp_usblib_test_fini_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn action_rx_fini(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn mctp_usblib_test_rx_single(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mctp_usblib_test_pkt_span {
    ...
    size_t *len)
    {
    let mut pkt_len: usize = 0, xfer_len = 0;
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn mctp_usblib_test_rx_pkt_span(test: *mut kunit) {
