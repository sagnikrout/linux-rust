...
//! Source: drivers/net/mctp/mctp-i2c.c
#![no_std]
...
pub const MCTP_I2C_MAXBLOCK: c_int = 255;
// One byte is taken by source_slave

// Allow space for dest_address, command, byte_count, data, PEC

pub const MCTP_I2C_MINLEN: c_int = 8;
pub const MCTP_I2C_COMMANDCODE: c_uint = 0x0f;
pub const MCTP_I2C_TX_WORK_LEN: c_int = 100;
// Sufficient for 64kB at min mtu
pub const MCTP_I2C_TX_QUEUE_LEN: c_int = 1100;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mctp_i2c_client {
    pub client: *mut i2c_client,
    pub lladdr: u8,
    pub sel: *mut mctp_i2c_dev,
    pub devs: list_head,
    pub /: *mut *mut spinlock_t sel_lock; / Protects sel and devs,
    pub /: *mut *mut list_head list; / For driver_clients,
}

// Header on the wire.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mctp_i2c_hdr {
    pub dest_slave: u8,
    pub command: u8,
...
//
    ...
    {
    struct mctp_i2c_client *mcli = core::ptr::null_mut();
    struct i2c_adapter *root = core::ptr::null_mut();
    int rc;
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_free_client(mcli: *mut mctp_i2c_client) {
...
// Switch the mctp i2c device to receive responses
    ...
    struct mctp_i2c_dev *midev = core::ptr::null_mut();
    unsigned long flags;
    let mut rc: c_int = 0;
    spin_lock_irqsave(&mcli.sel_lock, flags);
    midev = mcli.sel;
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_recv(midev: *mut mctp_i2c_dev) -> c_int {
    static int mctp_i2c_recv(struct mctp_i2c_dev *midev)
    {
...
//
#[no_mangle]
unsafe extern "C" fn mctp_i2c_lock_nest(midev: *mut mctp_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_unlock_nest(midev: *mut mctp_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_unlock_reset(midev: *mut mctp_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_xmit(midev: *mut mctp_i2c_dev, skb: *mut sk_buff) {
    static void mctp_i2c_xmit(struct mctp_i2c_dev *midev, struct sk_buff *skb)
    {
    struct net_device_stats *stats = &midev.ndev.stats;
    enum mctp_i2c_flow_state fs;
    struct mctp_i2c_hdr *hdr;
    let mut msg: i2c_msg = {0};
    u8 *pecp;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_flow_release(midev: *mut mctp_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_tx_thread(data: *mut c_void) -> c_int {
    ...
    let mut queue_release: bool = false;
    unsigned long flags;
    spin_lock_irqsave(&midev.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_net_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_midev_free(midev: *mut mctp_i2c_dev) {
    ...
    midev.tx_thread = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_unregister(midev: *mut mctp_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_ndo_uninit(dev: *mut net_device) {
    static void mctp_i2c_ndo_uninit(struct net_device *dev)
    {
    struct mctp_i2c_dev *midev = netdev_priv(dev);
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_ndo_open(dev: *mut net_device) -> c_int {
    static int mctp_i2c_ndo_open(struct net_device *dev)
    {
    struct mctp_i2c_dev *midev = netdev_priv(dev);
    unsigned long flags;
...
// Removes any netdev for adap. mcli is the parent root i2c client
    ...
    struct i2c_adapter *adap)
    {
    struct mctp_i2c_dev *midev = core::ptr::null_mut(), *m = core::ptr::null_mut();
    unsigned long flags;
    WARN_ON(!mutex_is_locked(&driver_clients_lock));
    spin_lock_irqsave(&mcli.sel_lock, flags);
...
//
#[no_mangle]
unsafe extern "C" fn mctp_i2c_adapter_match(adap: *mut i2c_adapter, match_no_of: bool) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn mctp_i2c_client_try_attach(dev: *mut device, data: *mut c_void) -> c_int {
    static int mctp_i2c_client_try_attach(struct device *dev, void *data)
    {
    struct i2c_adapter *adap = core::ptr::null_mut(), *root = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_notify_add(dev: *mut device) {
    static void mctp_i2c_notify_add(struct device *dev)
    {
    struct mctp_i2c_client *mcli = core::ptr::null_mut(), *m = core::ptr::null_mut();
    struct i2c_adapter *root = core::ptr::null_mut(), *adap = core::ptr::null_mut();
    int rc;
    adap = mctp_i2c_get_adapter(dev, &root);
    if (!adap)
    return;
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_notify_del(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_remove(client: *mut i2c_client) {
    static void mctp_i2c_remove(struct i2c_client *client)
    {
    struct mctp_i2c_client *mcli = i2c_get_clientdata(client);
    struct mctp_i2c_dev *midev = core::ptr::null_mut(), *tmp = core::ptr::null_mut();
    mutex_lock(&driver_clients_lock);
    list_del(&mcli.list);
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_mod_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn mctp_i2c_mod_exit() -> __exit void {
