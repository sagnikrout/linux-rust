...
//! Source: drivers/net/ipvlan/ipvlan_l3s.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ipvlan_netns {
    pub ipvl_nf_hook_refcnt: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn ipvlan_register_nf_hook(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_unregister_nf_hook(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn ipvlan_migrate_l3s_hook(oldnet: *mut net, newnet: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_ns_exit(net: *mut net) {
...
#[no_mangle]
pub unsafe extern "C" fn ipvlan_l3s_init() -> c_int {
    int ipvlan_l3s_init(void)
    {
    return register_pernet_subsys(&ipvlan_net_ops);
    }
#[no_mangle]
pub unsafe extern "C" fn ipvlan_l3s_cleanup() {
    void ipvlan_l3s_cleanup(void)
    {
    unregister_pernet_subsys(&ipvlan_net_ops);
    }
#[no_mangle]
pub unsafe extern "C" fn ipvlan_l3s_register(port: *mut ipvl_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipvlan_l3s_unregister(port: *mut ipvl_port) {
