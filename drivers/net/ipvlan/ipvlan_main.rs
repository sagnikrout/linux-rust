...
//! Source: drivers/net/ipvlan/ipvlan_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ipvlan_port_create(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_port_destroy(port: *mut ipvl_port) {
    ...
    while ((skb = __skb_dequeue(&port.backlog)) != core::ptr::null_mut()) {
    dev_put(skb.dev);
    kfree_skb(skb);
    }
...
#[no_mangle]
unsafe extern "C" fn ipvlan_port_put(port: *mut ipvl_port) {
    ...
    {
    struct ipvl_port *port = core::ptr::null_mut();
    rcu_read_lock();
...
#[no_mangle]
unsafe extern "C" fn ipvlan_init(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_uninit(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_stop(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_change_rx_flags(dev: *mut net_device, change: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_set_multicast_mac_filter(dev: *mut net_device) {
...
//
    ...
    let mut rx_errs: u32 = 0, tx_drps = 0;
    u32 strt;
    int idx;
...
#[no_mangle]
unsafe extern "C" fn ipvlan_vlan_rx_add_vid(dev: *mut net_device, proto: __be16, vid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_get_iflink(dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_adjust_mtu(ipvlan: *mut ipvl_dev, dev: *mut net_device) {
    static void ipvlan_adjust_mtu(struct ipvl_dev *ipvlan, struct net_device *dev)
    {
    ipvlan.dev.mtu = dev.mtu;
    }
#[no_mangle]
unsafe extern "C" fn netif_is_ipvlan(dev: *const net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_ethtool_get_msglevel(dev: *mut net_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_ethtool_set_msglevel(dev: *mut net_device, value: u32) {
    ...
    let mut nmode: u16 = nla_get_u16(data[IFLA_IPVLAN_MODE]);
    err = ipvlan_set_port_mode(port, nmode, extack);
    }
    if (!err && data[IFLA_IPVLAN_FLAGS]) {
    let mut flags: u16 = nla_get_u16(data[IFLA_IPVLAN_FLAGS]);
...
#[no_mangle]
unsafe extern "C" fn ipvlan_nl_getsize(dev: *const net_device) -> usize {
    ...
    return 0;
    if (data[IFLA_IPVLAN_MODE]) {
    let mut mode: u16 = nla_get_u16(data[IFLA_IPVLAN_MODE]);
...
// Also both flags can't be active at the same time.
    ...
    struct net_device *phy_dev;
    int err;
    let mut mode: u16 = IPVLAN_MODE_L3;
    if (!tb[IFLA_LINK])
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn ipvlan_link_delete(dev: *mut net_device, head: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn ipvlan_link_setup(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn ipvlan_link_register(ops: *mut rtnl_link_ops) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_add_addr(ipvlan: *mut ipvl_dev, iaddr: *mut c_void, is_v6: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_del_addr(ipvlan: *mut ipvl_dev, iaddr: *mut c_void, is_v6: bool) {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_is_valid_dev(dev: *const net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_add_addr6(ipvlan: *mut ipvl_dev, ip6_addr: *mut in6_addr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_del_addr6(ipvlan: *mut ipvl_dev, ip6_addr: *mut in6_addr) {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_add_addr4(ipvlan: *mut ipvl_dev, ip4_addr: *mut in_addr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_del_addr4(ipvlan: *mut ipvl_dev, ip4_addr: *mut in_addr) {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ipvlan_cleanup_module() -> void __exit {
