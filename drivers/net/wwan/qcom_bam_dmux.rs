...
//! Source: drivers/net/wwan/qcom_bam_dmux.c
#![no_std]
...
pub const BAM_DMUX_NUM_SKB: c_int = 32;
pub const BAM_DMUX_HDR_MAGIC: c_uint = 0x33fc;
pub const BAM_DMUX_AUTOSUSPEND_DELAY: c_int = 1000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bam_dmux_skb_dma {
    pub dmux: *mut bam_dmux,
    pub skb: *mut sk_buff,
    pub addr: dma_addr_t,
}
...
pub struct bam_dmux {
    pub dev: *mut device,
    pub pc_irq: c_int,
    pub pc_ack_state: bool pc_state,,
    pub pc_ack: *mut *mut qcom_smem_state pc,,
    pub pc_ack_mask: u32 pc_mask,,
    pub pc_wait: wait_queue_head_t,
    pub pc_ack_completion: completion,
    pub tx: *mut *mut dma_chan rx,,
    pub rx_skbs: [bam_dmux_skb_dma; BAM_DMUX_NUM_SKB],
    pub tx_skbs: [bam_dmux_skb_dma; BAM_DMUX_NUM_SKB],
    pub /: *mut *mut spinlock_t tx_lock; / Protect tx_skbs, tx_next_skb,
    pub tx_next_skb: c_uint,
    pub tx_deferred_skb: atomic_long_t,
    pub tx_wakeup_work: work_struct,
    pub BAM_DMUX_NUM_CH): DECLARE_BITMAP(remote_channels,,
    pub register_netdev_work: work_struct,
    pub netdevs: [*mut net_device; BAM_DMUX_NUM_CH],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bam_dmux_netdev {
    pub dmux: *mut bam_dmux,
    pub ch: u8,
}

#[no_mangle]
unsafe extern "C" fn bam_dmux_pc_vote(dmux: *mut bam_dmux, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_pc_ack(dmux: *mut bam_dmux) {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_tx_wake_queues(dmux: *mut bam_dmux) {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_tx_stop_queues(dmux: *mut bam_dmux) {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_tx_done(skb_dma: *mut bam_dmux_skb_dma) {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_tx_callback(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_skb_dma_submit_tx(skb_dma: *mut bam_dmux_skb_dma) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_send_cmd(bndev: *mut bam_dmux_netdev, cmd: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_netdev_open(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_netdev_stop(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn needed_room(avail: c_uint, needed: c_uint) -> c_uint {
    ...
    struct sk_buff *skb)
    {
    let mut head: c_uint = needed_room(skb_headroom(skb), BAM_DMUX_HDR_SIZE);
    let mut pad: c_uint = sizeof(u32) - skb.len % sizeof(u32);
    let mut tail: c_uint = needed_room(skb_tailroom(skb), pad);
    struct bam_dmux_hdr *hdr;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_tx_wakeup_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_netdev_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_register_netdev_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_skb_dma_submit_rx(skb_dma: *mut bam_dmux_skb_dma) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_skb_dma_queue_rx(skb_dma: *mut bam_dmux_skb_dma, gfp: gfp_t) -> bool {
    static bool bam_dmux_skb_dma_queue_rx(struct bam_dmux_skb_dma *skb_dma, gfp_t gfp)
    {
    if (!skb_dma.skb) {
    skb_dma.skb = __netdev_alloc_skb(core::ptr::null_mut(), BAM_DMUX_BUFFER_SIZE, gfp);
    if (!skb_dma.skb)
    return false;
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_cmd_data(skb_dma: *mut bam_dmux_skb_dma) {
    ...
    skb_dma.skb = core::ptr::null_mut(); /* Hand over to network stack */
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_cmd_open(dmux: *mut bam_dmux, hdr: *mut bam_dmux_hdr) {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_cmd_close(dmux: *mut bam_dmux, hdr: *mut bam_dmux_hdr) {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_rx_callback(data: *mut c_void) {
    static void bam_dmux_rx_callback(void *data)
    {
    struct bam_dmux_skb_dma *skb_dma = data;
    struct bam_dmux *dmux = skb_dma.dmux;
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_power_on(dmux: *mut bam_dmux) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_pc_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t bam_dmux_pc_irq(int irq, void *data)
    {
    struct bam_dmux *dmux = data;
    let mut new_state: bool = !dmux.pc_state;
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_pc_ack_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    ret = devm_request_threaded_irq(dev, pc_ack_irq, core::ptr::null_mut(), bam_dmux_pc_ack_irq,
    IRQF_ONESHOT, core::ptr::null_mut(), dmux);
    if (ret)
    goto err_disable_pm;
    ret = devm_request_threaded_irq(dev, dmux.pc_irq, core::ptr::null_mut(), bam_dmux_pc_irq,
    IRQF_ONESHOT, core::ptr::null_mut(), dmux);
    if (ret)
    goto err_disable_pm;
...
#[no_mangle]
unsafe extern "C" fn bam_dmux_remove(pdev: *mut platform_device) {
...
// Make sure everything is cleaned up before we return
    ...
    SET_RUNTIME_PM_OPS(bam_dmux_runtime_suspend, bam_dmux_runtime_resume, core::ptr::null_mut())
    };
