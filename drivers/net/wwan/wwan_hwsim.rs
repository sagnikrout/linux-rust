...
//! Source: drivers/net/wwan/wwan_hwsim.c
#![no_std]
...
//
    ...
    let mut wwan_hwsim_devsnum: static int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wwan_hwsim_dev {
    pub list: list_head,
    pub id: c_uint,
    pub dev: device,
    pub del_work: work_struct,
    pub debugfs_topdir: *mut dentry,
    pub debugfs_portcreate: *mut dentry,
    pub /: *mut *mut spinlock_t ports_lock; / Serialize ports creation/deletion,
    pub port_idx: c_uint,
    pub ports: list_head,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wwan_hwsim_port {
    pub list: list_head,
    pub id: c_uint,
    pub dev: *mut wwan_hwsim_dev,
    pub wwan: *mut wwan_port,
    pub del_work: work_struct,
    pub debugfs_topdir: *mut dentry,
    union {
    struct {
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_netdev_setup(ndev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_at_emul_start(wport: *mut wwan_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_at_emul_stop(wport: *mut wwan_port) {
...
//
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_at_emul_tx(wport: *mut wwan_port, in: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_nmea_emul_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_nmea_emul_start(wport: *mut wwan_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_nmea_emul_stop(wport: *mut wwan_port) {
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_nmea_emul_tx(wport: *mut wwan_port, in: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(WWAN_PORT_NMEA: type ==) -> else {
    ...
    port.wwan = wwan_create_port(&dev.dev, type, ops, core::ptr::null_mut(), port);
    if (IS_ERR(port.wwan)) {
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_port_del(port: *mut wwan_hwsim_port) {
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_port_del_work(work: *mut work_struct) {
    static void wwan_hwsim_port_del_work(struct work_struct *work)
    {
    struct wwan_hwsim_port *port =
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_dev_release(sysdev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_dev_del(dev: *mut wwan_hwsim_dev) {
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_dev_del_work(work: *mut work_struct) {
    static void wwan_hwsim_dev_del_work(struct work_struct *work)
    {
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_init_devs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_free_devs() {
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_init() -> int __init {
    ...
    if (err)
    goto err_wq_destroy;
    wwan_hwsim_debugfs_topdir = debugfs_create_dir("wwan_hwsim", core::ptr::null_mut());
    wwan_hwsim_debugfs_devcreate =
    debugfs_create_file("devcreate", 0200,
    wwan_hwsim_debugfs_topdir, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn wwan_hwsim_exit() -> void __exit {
