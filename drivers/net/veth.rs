...
pub const VETH_RING_SIZE: c_int = 256;

pub const VETH_XDP_TX_BULK_SIZE: c_int = 16;
pub const VETH_XDP_BATCH: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct veth_stats {
    pub rx_drops: u64,
// xdp
    pub xdp_packets: u64,
    pub xdp_bytes: u64,
    ...
    pub xdp_tx: u64,
    pub xdp_tx_err: u64,
    pub peer_tq_xdp_xmit: u64,
    pub peer_tq_xdp_xmit_err: u64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct veth_rq_stats {
    pub vs: veth_stats,
...
#[derive(Copy, Clone)]
pub struct veth_rq {
    pub xdp_napi: napi_struct,
    pub /: *mut *mut *mut napi___rcu napi; / points to xdp_napi when the latter is initialized,
    pub dev: *mut net_device,
    pub xdp_prog: *mut bpf_prog __rcu,
    pub xdp_mem: xdp_mem_info,
    pub stats: veth_rq_stats,
    pub rx_notify_masked: bool,
    pub xdp_ring: ptr_ring,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct veth_priv {
    pub peer: *mut net_device __rcu,
    pub dropped: core::sync::atomic::AtomicI64,
    pub _xdp_prog: *mut bpf_prog,
    pub rq: *mut veth_rq,
    pub requested_headroom: c_uint,
    pub peer_tracker: netdevice_tracker,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct veth_xdp_tx_bq {
    pub q: [*mut xdp_frame; VETH_XDP_TX_BULK_SIZE],
    pub count: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn veth_get_drvinfo(dev: *mut net_device, info: *mut ethtool_drvinfo) {
...
#[no_mangle]
unsafe extern "C" fn veth_get_strings(dev: *mut net_device, stringset: u32, buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn veth_get_sset_count(dev: *mut net_device, sset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veth_get_page_pool_stats(dev: *mut net_device, data: *mut u64) {
    static void veth_get_page_pool_stats(struct net_device *dev, u64 *data)
    {

    struct veth_priv *priv = netdev_priv(dev);
    let mut pp_stats: page_pool_stats = {};
    int i;
    for (i = 0; i < dev.real_num_rx_queues; i++) {
...
// general routines
#[no_mangle]
unsafe extern "C" fn veth_is_xdp_frame(ptr: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn veth_ptr_free(ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __veth_xdp_flush(rq: *mut veth_rq) {
...
#[no_mangle]
unsafe extern "C" fn veth_xdp_rx(rq: *mut veth_rq, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veth_xmit(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
    static netdev_tx_t veth_xmit(struct sk_buff *skb, struct net_device *dev)
    {
    struct veth_priv *rcv_priv, *priv = netdev_priv(dev);
    struct veth_rq *rq = core::ptr::null_mut();
    struct netdev_queue *txq;
    struct net_device *rcv;
    let mut length: c_int = skb.len;
    let mut use_napi: bool = false;
    int ret, rxq;
    rcu_read_lock();
...
#[no_mangle]
unsafe extern "C" fn veth_stats_rx(result: *mut veth_stats, dev: *mut net_device) {
    ...
    if (peer) {
    let mut tot_peer: rtnl_link_stats64 = {};
...
#[no_mangle]
unsafe extern "C" fn veth_set_multicast_list(dev: *mut net_device) {
    static void veth_set_multicast_list(struct net_device *dev)
    {
    }
#[no_mangle]
unsafe extern "C" fn veth_select_rxq(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veth_xdp_flush_bq(rq: *mut veth_rq, bq: *mut veth_xdp_tx_bq) {
...
#[no_mangle]
unsafe extern "C" fn veth_xdp_flush(rq: *mut veth_rq, bq: *mut veth_xdp_tx_bq) {
...
#[no_mangle]
unsafe extern "C" fn veth_xdp_get(xdp: *mut xdp_buff) {
...
// check if bpf_xdp_adjust_head was used
    ...
    __skb_push(skb, off);
#[no_mangle]
pub unsafe extern "C" fn if(0: off <) -> else {
    else if (off < 0)
    __skb_pull(skb, -off);
...
#[no_mangle]
unsafe extern "C" fn veth_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int veth_poll(struct napi_struct *napi, int budget)
    {
    struct veth_rq *rq =
    container_of(napi, struct veth_rq, xdp_napi);
    struct veth_priv *priv = netdev_priv(rq.dev);
    let mut queue_idx: c_int = rq - priv.rq;
    struct netdev_queue *peer_txq;
    let mut stats: veth_stats = {};
...
// NAPI functions as RCU section
    ...
    netdev_get_tx_queue(peer_dev, queue_idx) : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn veth_create_page_pool(rq: *mut veth_rq) -> c_int {
    ...
    let mut err: c_int = PTR_ERR(rq.page_pool);
...
#[no_mangle]
unsafe extern "C" fn __veth_napi_enable_range(dev: *mut net_device, start: c_int, end: c_int) -> c_int {
    ...
    priv.rq[i].page_pool = core::ptr::null_mut();
    }
    return err;
    }
#[no_mangle]
unsafe extern "C" fn __veth_napi_enable(dev: *mut net_device) -> c_int {
    static int __veth_napi_enable(struct net_device *dev)
    {
    return __veth_napi_enable_range(dev, 0, dev.real_num_rx_queues);
    }
#[no_mangle]
unsafe extern "C" fn veth_napi_del_range(dev: *mut net_device, start: c_int, end: c_int) {
    ...
    for (i = start; i < end; i++) {
    struct veth_rq *rq = &priv.rq[i];
    rcu_assign_pointer(priv.rq[i].napi, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn veth_napi_del(dev: *mut net_device) {
    static void veth_napi_del(struct net_device *dev)
    {
    veth_napi_del_range(dev, 0, dev.real_num_rx_queues);
    }
#[no_mangle]
unsafe extern "C" fn veth_gro_requested(dev: *const net_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn veth_enable_xdp(dev: *mut net_device) -> c_int {
    static int veth_enable_xdp(struct net_device *dev)
    {
    let mut napi_already_on: bool = veth_gro_requested(dev) && (dev.flags & IFF_UP);
    struct veth_priv *priv = netdev_priv(dev);
    int err, i;
...
#[no_mangle]
unsafe extern "C" fn veth_disable_xdp(dev: *mut net_device) {
    static void veth_disable_xdp(struct net_device *dev)
    {
    struct veth_priv *priv = netdev_priv(dev);
    int i;
    for (i = 0; i < dev.real_num_rx_queues; i++)
    rcu_assign_pointer(priv.rq[i].xdp_prog, core::ptr::null_mut());
    if (!netif_running(dev) || !veth_gro_requested(dev))
    veth_napi_del(dev);
    veth_disable_xdp_range(dev, 0, dev.real_num_rx_queues, false);
    }
#[no_mangle]
unsafe extern "C" fn veth_napi_enable_range(dev: *mut net_device, start: c_int, end: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veth_napi_enable(dev: *mut net_device) -> c_int {
    static int veth_napi_enable(struct net_device *dev)
    {
    return veth_napi_enable_range(dev, 0, dev.real_num_rx_queues);
    }
#[no_mangle]
unsafe extern "C" fn veth_disable_range_safe(dev: *mut net_device, start: c_int, end: c_int) {
...
#[no_mangle]
unsafe extern "C" fn veth_enable_range_safe(dev: *mut net_device, start: c_int, end: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veth_set_xdp_features(dev: *mut net_device) {
...
// avoid braking XDP, if that is enabled
    peer = rtnl_dereference(priv.peer);
    peer_priv = peer ? netdev_priv(peer) : core::ptr::null_mut();
...
// try to allocate new resources, as needed
    ...
    if (err) {
    let mut err2: c_int = netif_set_real_num_rx_queues(dev, old_rx_count);
...
#[no_mangle]
unsafe extern "C" fn veth_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veth_close(dev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: veth_gro_requested(dev)) -> else {
    else if (veth_gro_requested(dev))
    veth_napi_del(dev);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn is_valid_veth_mtu(mtu: c_int) -> c_int {
    static int is_valid_veth_mtu(int mtu)
    {
    return mtu >= ETH_MIN_MTU && mtu <= ETH_MAX_MTU;
    }
#[no_mangle]
unsafe extern "C" fn veth_alloc_queues(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veth_free_queues(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn veth_dev_init(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veth_dev_free(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn veth_poll_controller(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn veth_get_iflink(dev: *const net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veth_set_rx_headroom(dev: *mut net_device, new_hr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn veth_xdp(dev: *mut net_device, xdp: *mut netdev_bpf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veth_xdp_rx_timestamp(ctx: *const xdp_md, timestamp: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veth_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn veth_disable_gro(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn veth_init_queues(dev: *mut net_device, tb[]: *mut nlattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn veth_dellink(dev: *mut net_device, head: *mut list_head) {
...
//
#[no_mangle]
unsafe extern "C" fn veth_init() -> __init int {
    static __init int veth_init(void)
    {
    return rtnl_link_register(&veth_link_ops);
    }
#[no_mangle]
unsafe extern "C" fn veth_exit() -> __exit void {
