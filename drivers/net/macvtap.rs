...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct macvtap_dev {
    pub vlan: macvlan_dev,
    pub tap: tap_dev,
}
...
//
    ...
    NETIF_F_TSO6)
#[no_mangle]
unsafe extern "C" fn macvtap_count_tx_dropped(tap: *mut tap_dev) {
...
#[no_mangle]
unsafe extern "C" fn macvtap_count_rx_dropped(tap: *mut tap_dev) {
...
#[no_mangle]
unsafe extern "C" fn macvtap_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn macvtap_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn macvtap_exit() -> void __exit {
