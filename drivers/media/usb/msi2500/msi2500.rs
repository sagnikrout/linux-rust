...
//! Source: drivers/media/usb/msi2500/msi2500.c
#![no_std]
...
pub const MAX_ISOC_ERRORS: c_int = 20;
//
...
// Note if taking both locks v4l2_lock must always be locked first!
    ...
    pub /: *mut *mut mutex vb_queue_lock; / Protects vb_queue and capt_file,
// Pointer to our usb_device, will be NULL after unplug
    pub /: *mut *mut *mut usb_device udev; / Both mutexes most be hold when setting!,
    pub f_adc: c_uint,
    pub pixelformat: u32,
    pub buffersize: u32,
    pub num_formats: c_uint,
    pub /: *mut *mut unsigned int isoc_errors; / number of contiguous ISOC errors,
    pub /: *mut *mut unsigned int vb_full; / vb is full and packets dropped,
    pub urbs: [*mut urb; MAX_ISO_BUFS],
// Controls
    pub hdl: v4l2_ctrl_handler,
    pub /: *mut *mut u32 next_sample; / for track lost packets,
    pub /: *mut *mut u32 sample; / for sample rate calc,
...
// Private functions
    ...
    {
    unsigned long flags;
    struct msi2500_frame_buf *buf = core::ptr::null_mut();
...
// calculate sample rate and output it in 10 seconds intervals
    ...
    let mut samples: c_uint = dev.next_sample - dev.sample;
...
// Get free framebuffer
    ...
    if (unlikely(fbuf == core::ptr::null_mut())) {
    dev.vb_full++;
    dev_dbg_ratelimited(dev.dev,
...
#[no_mangle]
unsafe extern "C" fn msi2500_iso_stop(dev: *mut msi2500_dev) {
...
#[no_mangle]
unsafe extern "C" fn msi2500_iso_free(dev: *mut msi2500_dev) {
...
#[no_mangle]
unsafe extern "C" fn msi2500_isoc_cleanup(dev: *mut msi2500_dev) {
...
// Both v4l2_lock and vb_queue_lock should be locked when calling this
#[no_mangle]
unsafe extern "C" fn msi2500_isoc_init(dev: *mut msi2500_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi2500_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn msi2500_buf_queue(vb: *mut vb2_buffer) {
...
pub const CMD_WREG: c_uint = 0x41;
pub const CMD_START_STREAMING: c_uint = 0x43;
pub const CMD_STOP_STREAMING: c_uint = 0x45;
pub const CMD_READ_UNKNOWN: c_uint = 0x48;
...
#[no_mangle]
unsafe extern "C" fn msi2500_ctrl_msg(dev: *mut msi2500_dev, cmd: u8, data: u32) -> c_int {
    static int msi2500_ctrl_msg(struct msi2500_dev *dev, u8 cmd, u32 data)
    {
    int ret;
    let mut request: u8 = cmd;
    let mut requesttype: u8 = USB_DIR_OUT | USB_TYPE_VENDOR;
    let mut value: u16 = (data >> 0) & 0xffff;
    let mut index: u16 = (data >> 16) & 0xffff;
    msi2500_dbg_usb_control_msg(dev.dev, request, requesttype,
    value, index, core::ptr::null_mut(), 0);
    ret = usb_control_msg(dev.udev, usb_sndctrlpipe(dev.udev, 0), request,
    requesttype, value, index, core::ptr::null_mut(), 0, 2000);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn msi2500_set_usb_adc(dev: *mut msi2500_dev) -> c_int {
...
//
pub const F_REF: c_int = 24000000;
pub const DIV_PRE_N: c_int = 2;
pub const DIV_LO_OUT: c_int = 12;
    reg3 = 0x01000303;
    reg4 = 0x00000004;
// XXX: Filters? AGC? VCO band?
    ...
    reg3 |= 0x1 << 20;
#[no_mangle]
pub unsafe extern "C" fn if(7000000: f_sr <) -> else {
    else if (f_sr < 7000000)
    reg3 |= 0x5 << 20;
#[no_mangle]
pub unsafe extern "C" fn if(8500000: f_sr <) -> else {
...
#[no_mangle]
unsafe extern "C" fn msi2500_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi2500_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn msi2500_g_tuner(file: *mut file, priv: *mut c_void, v: *mut v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi2500_video_release(v: *mut v4l2_device) {
...
// currently all controls are from subdev
    v4l2_ctrl_add_handler(&dev.hdl, sd.ctrl_handler, core::ptr::null_mut(), true);
