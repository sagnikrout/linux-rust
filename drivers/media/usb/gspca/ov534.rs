...
//! Source: drivers/media/usb/gspca/ov534.c
#![no_std]
...
pub const OV534_REG_ADDRESS: c_uint = 0xf1	/* sensor address */;
pub const OV534_REG_SUBADDR: c_uint = 0xf2;
pub const OV534_REG_WRITE: c_uint = 0xf3;
pub const OV534_REG_READ: c_uint = 0xf4;
pub const OV534_REG_OPERATION: c_uint = 0xf5;
pub const OV534_REG_STATUS: c_uint = 0xf6;
pub const OV534_OP_WRITE_3: c_uint = 0x37;
pub const OV534_OP_WRITE_2: c_uint = 0x33;
pub const OV534_OP_READ_2: c_uint = 0xf9;
pub const CTRL_TIMEOUT: c_int = 500;
pub const DEFAULT_FRAME_RATE: c_int = 30;
...
#[no_mangle]
unsafe extern "C" fn ov534_reg_write(gspca_dev: *mut gspca_dev, reg: u16, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn ov534_reg_read(gspca_dev: *mut gspca_dev, reg: u16) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ov534_set_led(gspca_dev: *mut gspca_dev, status: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sccb_check_status(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sccb_reg_write(gspca_dev: *mut gspca_dev, reg: u8, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn sccb_reg_read(gspca_dev: *mut gspca_dev, reg: u16) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn u8(_arg: *mut data)[2], len: c_int) -> const {
...
#[no_mangle]
unsafe extern "C" fn set_frame_rate(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn sethue(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn setsaturation(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn getgain(gspca_dev: *mut gspca_dev) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn getexposure(gspca_dev: *mut gspca_dev) -> i32 {
...
// get only aec[9:2]
    ...
    let mut hi: u8 = sccb_reg_read(gspca_dev, 0x08);
    let mut lo: u8 = sccb_reg_read(gspca_dev, 0x10);
    return (hi << 8 | lo) >> 1;
    }
    }
#[no_mangle]
unsafe extern "C" fn setagc(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn setawb(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn setaec(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn setsharpness(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn setlightfreq(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn ov534_g_volatile_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov534_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// Values for bmHeaderInfo (Video and Still Image Payload Headers, 2.4.3.3)
    ...
    __u32 this_pts;
    u16 this_fid;
    let mut remaining_len: c_int = len;
    int payload_len;
...
// -- device connect --
#[no_mangle]
unsafe extern "C" fn sd_probe(intf: *mut usb_interface, id: *const usb_device_id) -> c_int {
