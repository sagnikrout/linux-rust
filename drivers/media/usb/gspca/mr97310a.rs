...
//! Source: drivers/media/usb/gspca/mr97310a.c
#![no_std]
...
pub const CAM_TYPE_CIF: c_int = 0;
pub const CAM_TYPE_VGA: c_int = 1;
pub const MR97310A_BRIGHTNESS_DEFAULT: c_int = 0;
pub const MR97310A_EXPOSURE_MIN: c_int = 0;
pub const MR97310A_EXPOSURE_MAX: c_int = 4095;
pub const MR97310A_EXPOSURE_DEFAULT: c_int = 1000;
pub const MR97310A_GAIN_MIN: c_int = 0;
pub const MR97310A_GAIN_MAX: c_int = 31;
pub const MR97310A_GAIN_DEFAULT: c_int = 25;
pub const MR97310A_CONTRAST_MIN: c_int = 0;
pub const MR97310A_CONTRAST_MAX: c_int = 31;
pub const MR97310A_CONTRAST_DEFAULT: c_int = 23;
pub const MR97310A_CS_GAIN_MIN: c_int = 0;
pub const MR97310A_CS_GAIN_MAX: c_uint = 0x7ff;
pub const MR97310A_CS_GAIN_DEFAULT: c_uint = 0x110;

pub const MR97310A_MIN_CLOCKDIV_MIN: c_int = 3;
pub const MR97310A_MIN_CLOCKDIV_MAX: c_int = 8;
pub const MR97310A_MIN_CLOCKDIV_DEFAULT: c_int = 3;
    MODULE_AUTHOR("Kyle Guinn <elyk03@gmail.com>,Theodore Kilgore <kilgota@auburn.edu>");
    MODULE_DESCRIPTION("GSPCA/Mars-Semi MR97310A USB Camera Driver");
    MODULE_LICENSE("GPL");
// global parameters
    let mut force_sensor_type: static int = -1;
...
pub struct sd {
    ...
    pub min_clockdiv: *mut v4l2_ctrl,
}
...
#[no_mangle]
unsafe extern "C" fn mr_write(gspca_dev: *mut gspca_dev, len: c_int) -> c_int {
    static int mr_write(struct gspca_dev *gspca_dev, int len)
    {
    int rc;
    rc = usb_bulk_msg(gspca_dev.dev,
    usb_sndbulkpipe(gspca_dev.dev, 4),
    gspca_dev.usb_buf, len, core::ptr::null_mut(), 500);
    if (rc < 0)
...
#[no_mangle]
unsafe extern "C" fn mr_read(gspca_dev: *mut gspca_dev, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sensor_write1(gspca_dev: *mut gspca_dev, reg: u8, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cam_get_response16(gspca_dev: *mut gspca_dev, reg: u8, verbose: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zero_the_pointer(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stream_start(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stream_stop(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn lcd_stop(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn isoc_enable(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn start_cif_cam(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn start_vga_cam(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setexposure(gspca_dev: *mut gspca_dev, expo: i32, min_clockdiv: i32) {
    static void setexposure(struct gspca_dev *gspca_dev, s32 expo, s32 min_clockdiv)
    {
    struct sd *sd = (struct sd *) gspca_dev;
    let mut exposure: c_int = MR97310A_EXPOSURE_DEFAULT;
    u8 buf[2];
...
// We have both a clock divider and an exposure register.
    ...
    let mut clockdiv: u8 = (60 * expo + 7999) / 8000;
// Limit framerate to not exceed usb bandwidth
    if (clockdiv < min_clockdiv && gspca_dev.pixfmt.width >= 320)
    clockdiv = min_clockdiv;
#[no_mangle]
pub unsafe extern "C" fn if(2: clockdiv <) -> else {
    else if (clockdiv < 2)
    clockdiv = 2;
...
#[no_mangle]
pub unsafe extern "C" fn if(2: sd->cam_type == CAM_TYPE_VGA && sd->sensor_type ==) -> else {
...
unsafe extern "C" fn sd_init_controls(gspca_dev: *mut gspca_dev) -> c_int {
    ...
    let mut has_brightness: bool = false;
    let mut has_argus_brightness: bool = false;
    let mut has_contrast: bool = false;
    let mut has_gain: bool = false;
    let mut has_cs_gain: bool = false;
    let mut has_exposure: bool = false;
    let mut has_clockdiv: bool = false;
...
// All controls need to be disabled if VGA sensor_type is 0
    ...
    ; /* no controls! */
#[no_mangle]
pub unsafe extern "C" fn if(2: sd->sensor_type ==) -> else {
    else if (sd.sensor_type == 2)
    has_exposure = has_cs_gain = has_contrast = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sd->do_lcd_stop) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: has_argus_brightness) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: has_cs_gain) -> else {
    else if (has_cs_gain)
    ...
    if (has_clockdiv)
    sd.min_clockdiv = v4l2_ctrl_new_custom(hdl, &clockdiv, core::ptr::null_mut());
    if (hdl.error) {
