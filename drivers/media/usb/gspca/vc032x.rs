...
//! Source: drivers/media/usb/gspca/vc032x.c
#![no_std]
...
pub struct sd {
    ...
    u8 sensor;
    u8 flags;
pub const FL_SAMSUNG: c_uint = 0x01		/* SamsungQ1 (2 sensors) */;
pub const FL_HFLIP: c_uint = 0x02		/* mirrored by default */;
pub const FL_VFLIP: c_uint = 0x04		/* vertical flipped by default */;
    };
    enum bridges {
    BRIDGE_VC0321,
    BRIDGE_VC0323,
...
pub const OV7660_REG_MVFP: c_uint = 0x1e;
pub const OV7660_MVFP_MIRROR: c_uint = 0x20;
pub const OV7660_MVFP_VFLIP: c_uint = 0x10;
...
#[no_mangle]
unsafe extern "C" fn vc032x_probe_sensor(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setcontrast(gspca_dev: *mut gspca_dev, val: u8) {
    static void setcontrast(struct gspca_dev *gspca_dev, u8 val)
    {
    i2c_write(gspca_dev, 0x99, &val, 1);
    }
#[no_mangle]
unsafe extern "C" fn setcolors(gspca_dev: *mut gspca_dev, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn sethvflip(gspca_dev: *mut gspca_dev, hflip: bool, vflip: bool) {
...
#[no_mangle]
unsafe extern "C" fn setgain(gspca_dev: *mut gspca_dev, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn setbacklight(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn setwb(gspca_dev: *mut gspca_dev) {
...
unsafe extern "C" fn sd_start(gspca_dev: *mut gspca_dev) -> c_int {
    ...
    struct sd *sd = (struct sd *) gspca_dev;
    const u8 (*init)[4];
    const u8 *GammaT = core::ptr::null_mut();
    const u8 *MatrixT = core::ptr::null_mut();
    int mode;
...
// fixme: is this useful?
    ...
    reg_w(gspca_dev, 0x89, 0x058c, 0x00ff);
#[no_mangle]
pub unsafe extern "C" fn if(FL_SAMSUNG): !(sd->flags &) -> else {
...
unsafe extern "C" fn sd_init_controls(gspca_dev: *mut gspca_dev) -> c_int {
    ...
    let mut has_sat: bool = false;
    let mut has_hvflip: bool = false;
    let mut has_freq: bool = false;
    let mut has_backlight: bool = false;
    let mut has_exposure: bool = false;
    let mut has_autogain: bool = false;
    let mut has_gain: bool = false;
    let mut has_sharpness: bool = false;
    switch (sd.sensor) {
    case SENSOR_HV7131R:
    case SENSOR_MI0360:
    case SENSOR_PO3130NC:
