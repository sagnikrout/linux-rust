...
//! Source: drivers/media/usb/gspca/m5602/m5602_core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn m5602_read_bridge(sd: *mut sd, address: u8, i2c_data: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn m5602_write_bridge(sd: *mut sd, address: u8, i2c_data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m5602_wait_for_i2c(sd: *mut sd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m5602_dump_bridge(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn m5602_probe_sensor(sd: *mut sd) -> c_int {
...
// More sensor probe function goes here
    ...
    sd.sensor = core::ptr::null_mut();
    return -ENODEV;
    }
    static int m5602_configure(struct gspca_dev *gspca_dev,
    const struct usb_device_id *id);
#[no_mangle]
unsafe extern "C" fn m5602_init(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m5602_init_controls(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m5602_start_transfer(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m5602_stop_transfer(gspca_dev: *mut gspca_dev) {
...
// Probe sensor
    ...
    cam.cam_mode = core::ptr::null_mut();
    cam.nmodes = 0;
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn m5602_disconnect(intf: *mut usb_interface) {
