...
//! Source: drivers/media/usb/gspca/spca505.c
#![no_std]
...
pub struct sd {
    ...
    pub subtype: u8,
pub const IntelPCCameraPro: c_int = 0;
pub const Nxultra: c_int = 1;
}
...
pub const SPCA50X_REG_USB: c_uint = 0x02	/* spca505 501 */;
pub const SPCA50X_USB_CTRL: c_uint = 0x00	/* spca505 */;
pub const SPCA50X_CUSB_ENABLE: c_uint = 0x01 /* spca505 */;
pub const SPCA50X_REG_GLOBAL: c_uint = 0x03	/* spca505 */;
pub const SPCA50X_GMISC0_IDSEL: c_uint = 0x01 /* Global control device ID select spca505 */;
pub const SPCA50X_GLOBAL_MISC0: c_uint = 0x00 /* Global control miscellaneous 0 spca505 */;
pub const SPCA50X_GLOBAL_MISC1: c_uint = 0x01 /* 505 */;
pub const SPCA50X_GLOBAL_MISC3: c_uint = 0x03 /* 505 */;
pub const SPCA50X_GMISC3_SAA7113RST: c_uint = 0x20	/* Not sure about this one spca505 */;
// Image format and compression control
pub const SPCA50X_REG_COMPRESS: c_uint = 0x04;
//
...
//
// jfm
pub const initial_brightness: c_uint = 0x7f	/* 0x0(white)-0xff(black) */;
