...
//! Source: drivers/media/usb/gspca/spca1528.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wait_status_0(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn wait_status_1(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn setcolor(gspca_dev: *mut gspca_dev, val: i32) {
