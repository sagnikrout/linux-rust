...
//! Source: drivers/media/usb/gspca/sq905c.c
#![no_std]
...
pub const SQ905C_CMD_TIMEOUT: c_int = 500;
pub const SQ905C_DATA_TIMEOUT: c_int = 1000;
// Maximum transfer size to use.
pub const SQ905C_MAX_TRANSFER: c_uint = 0x8000;
pub const FRAME_HEADER_LEN: c_uint = 0x50;
// Commands. These go in the "value" slot.
pub const SQ905C_CLEAR: c_uint = 0xa0		/* clear everything */;
pub const SQ905C_GET_ID: c_uint = 0x14f4		/* Read version number */;
pub const SQ905C_CAPTURE_LOW: c_uint = 0xa040	/* Starts capture at 160x120 */;
pub const SQ905C_CAPTURE_MED: c_uint = 0x1440	/* Starts capture at 320x240 */;
pub const SQ905C_CAPTURE_HI: c_uint = 0x2840	/* Starts capture at 320x240 */;
// For capture, this must go in the "index" slot.
pub const SQ905C_CAPTURE_INDEX: c_uint = 0x110f;
...
#[no_mangle]
unsafe extern "C" fn sq905c_command(gspca_dev: *mut gspca_dev, command: u16, index: u16) -> c_int {
    ...
    command, index, core::ptr::null_mut(), 0,
    SQ905C_CMD_TIMEOUT);
    if (ret < 0) {
...
//
#[no_mangle]
unsafe extern "C" fn sq905c_dostream(work: *mut work_struct) {
