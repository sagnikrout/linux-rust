...
//! Source: drivers/media/usb/gspca/dtcs033.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dtcs033_usb_requests {
    pub bRequestType: u8,
    pub bRequest: u8,
    pub wValue: u16,
    pub wIndex: u16,
...
// -- controls: exposure and gain --
    ...
    {
// gain [dB] encoding
    let mut sGain: u16 = (u16)gain;
    let mut gainVal: u16 = 224+(sGain-14)*(768-224)/(33-14);
    let mut wIndex: u16 = 0x0100|(0x00FF&gainVal);
    let mut wValue: u16 = (0xFF00&gainVal)>>8;
// exposure time [msec] encoding
    let mut sXTime: u16 = (u16)expo;
    let mut xtimeVal: u16 = (524*(150-(sXTime-1)))/150;
    const u8 bRequestType =
    USB_DIR_OUT | USB_TYPE_VENDOR | USB_RECIP_DEVICE;
    let mut bRequest: u8 = 0x18;
    reg_rw(gspca_dev,
...
#[no_mangle]
unsafe extern "C" fn dtcs033_init_controls(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dtcs033_start(gspca_dev: *mut gspca_dev) -> c_int {
    static int dtcs033_start(struct gspca_dev *gspca_dev)
    {
...
#[no_mangle]
unsafe extern "C" fn dtcs033_stopN(gspca_dev: *mut gspca_dev) {
    static void dtcs033_stopN(struct gspca_dev *gspca_dev)
    {
