...
//! Source: drivers/media/usb/gspca/ov534_9.c
#![no_std]
...
pub const QVGA_MODE: c_int = 0;
    {320, 240, V4L2_PIX_FMT_JPEG, V4L2_FIELD_NONE,
    .bytesperline = 320,
    .sizeimage = 320 * 240 * 3 / 8 + 590,
    .colorspace = V4L2_COLORSPACE_JPEG},
pub const VGA_MODE: c_int = 1;
    {640, 480, V4L2_PIX_FMT_JPEG, V4L2_FIELD_NONE,
    .bytesperline = 640,
    .sizeimage = 640 * 480 * 3 / 8 + 590,
    .colorspace = V4L2_COLORSPACE_JPEG},
pub const SVGA_MODE: c_int = 2;
    {800, 600, V4L2_PIX_FMT_JPEG, V4L2_FIELD_NONE,
    .bytesperline = 800,
    .sizeimage = 800 * 600 * 3 / 8 + 590,
    .colorspace = V4L2_COLORSPACE_JPEG},
pub const XGA_MODE: c_int = 3;
    {1024, 768, V4L2_PIX_FMT_JPEG, V4L2_FIELD_NONE,
    .bytesperline = 1024,
    .sizeimage = 1024 * 768 * 3 / 8 + 590,
    .colorspace = V4L2_COLORSPACE_JPEG},
pub const SXGA_MODE: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn reg_w_i(gspca_dev: *mut gspca_dev, reg: u16, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn reg_w(gspca_dev: *mut gspca_dev, reg: u16, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn reg_r(gspca_dev: *mut gspca_dev, reg: u16) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn sccb_write(gspca_dev: *mut gspca_dev, reg: u8, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn sccb_read(gspca_dev: *mut gspca_dev, reg: u16) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn set_led(gspca_dev: *mut gspca_dev, status: c_int) {
...
#[no_mangle]
unsafe extern "C" fn setbrightness(gspca_dev: *mut gspca_dev, brightness: i32) {
    ...
    val = 0x71;
#[no_mangle]
pub unsafe extern "C" fn if(20: sval <) -> else {
    else if (sval < 20)
    val = 0x94;
    else
    val = 0xe6;
...
#[no_mangle]
unsafe extern "C" fn setautogain(gspca_dev: *mut gspca_dev, autogain: i32) {
...
#[no_mangle]
unsafe extern "C" fn setexposure(gspca_dev: *mut gspca_dev, exposure: i32) {
...
#[no_mangle]
unsafe extern "C" fn setsatur(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn setlightfreq(gspca_dev: *mut gspca_dev, freq: i32) {
...
#[no_mangle]
unsafe extern "C" fn sd_start_ov361x(gspca_dev: *mut gspca_dev) -> c_int {
