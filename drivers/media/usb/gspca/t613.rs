...
//! Source: drivers/media/usb/gspca/t613.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct additional_sensor_data {
    pub n3: [u8; 6],
    pub n4sz: *const *const u8 n4,,
    pub reg8e: u8 reg80,,
    pub nset8: [u8; 6],
    pub data1: [u8; 10],
    pub data2: [u8; 9],
...
#[no_mangle]
unsafe extern "C" fn om6802_sensor_init(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn setcontrast(gspca_dev: *mut gspca_dev, contrast: i32) {
...
#[no_mangle]
unsafe extern "C" fn setgamma(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn setawb_n_RGB(gspca_dev: *mut gspca_dev) {
    ...
    red_gain = 0x40;
#[no_mangle]
pub unsafe extern "C" fn if(0x10: red_gain <) -> else {
    ...
    blue_gain = 0x40;
#[no_mangle]
pub unsafe extern "C" fn if(0x10: blue_gain <) -> else {
...
#[no_mangle]
unsafe extern "C" fn setmirror(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn seteffect(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn poll_sensor(gspca_dev: *mut gspca_dev) {
...
// If the last button state is pressed, release it now!
    ...
    if (len > 20) {
    let mut state: u8 = (data[20] & 0x80) ? 1 : 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(0xd9: data[len - 2] == 0xff && data[len - 1] ==) -> else {
...
pub unsafe extern "C" fn if(0x10: blue_gain <) -> else {
    ...
    green_gain = 0x40;
#[no_mangle]
pub unsafe extern "C" fn if(0x10: green_gain <) -> else {
