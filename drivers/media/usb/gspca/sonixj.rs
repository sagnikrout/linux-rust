...
//! Source: drivers/media/usb/gspca/sonixj.c
#![no_std]
...
pub const QUALITY_MIN: c_int = 25;
pub const QUALITY_MAX: c_int = 90;
pub const QUALITY_DEF: c_int = 70;
    u8 reg01;
    u8 reg17;
    u8 reg18;
    u8 flags;
...
pub const AG_CNT_START: c_int = 13;
    u8 bridge;
pub const BRIDGE_SN9C102P: c_int = 0;
pub const BRIDGE_SN9C105: c_int = 1;
pub const BRIDGE_SN9C110: c_int = 2;
pub const BRIDGE_SN9C120: c_int = 3;
...
// device flags
pub const F_PDN_INV: c_uint = 0x01	/* inverse pin S_PWR_DN / sn_xxx tables */;
pub const F_ILLUM: c_uint = 0x02	/* presence of illuminator */;
// sn9c1xx definitions
// register 0x01
pub const S_PWR_DN: c_uint = 0x01	/* sensor power down */;
pub const S_PDN_INV: c_uint = 0x02	/* inverse pin S_PWR_DN */;
pub const V_TX_EN: c_uint = 0x04	/* video transfer enable */;
pub const LED: c_uint = 0x08	/* output to pin LED */;
pub const SCL_SEL_OD: c_uint = 0x20	/* open-drain mode */;
pub const SYS_SEL_48M: c_uint = 0x40	/* system clock 0: 24MHz, 1: 48MHz */;
// register 0x17
pub const MCK_SIZE_MASK: c_uint = 0x1f	/* sensor master clock */;
pub const SEN_CLK_EN: c_uint = 0x20	/* enable sensor clock */;
pub const DEF_EN: c_uint = 0x80	/* defect pixel by 0: soft, 1: hard */;
...
#[no_mangle]
unsafe extern "C" fn i2c_r(gspca_dev: *mut gspca_dev, reg: u8, len: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn u8(_arg: *mut data)[8]) -> const {
    const u8 (*data)[8])
    {
    while ((*data)[0] != 0) {
    if ((*data)[0] != DELAY)
...
#[no_mangle]
unsafe extern "C" fn hv7131r_probe(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn mi0360_probe(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn ov7630_probe(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn ov7648_probe(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn po2030n_probe(gspca_dev: *mut gspca_dev) {
...
pub const CONTRAST_MAX: c_int = 127;
    sd.contrast = v4l2_ctrl_new_std(hdl, &sd_ctrl_ops,
    V4L2_CID_CONTRAST, 0, CONTRAST_MAX, 1, 20);
pub const COLORS_DEF: c_int = 25;
...
// expo = 0..255 -> a = 19..43
    ...
    expo = 0x0635;
#[no_mangle]
pub unsafe extern "C" fn if(0x0001: expo <) -> else {
    else if (expo < 0x0001)
    expo = 0x0001;
    expoMi[3] = expo >> 8;
    expoMi[4] = expo;
...
pub unsafe extern "C" fn if(0x0001: expo <) -> else {
    ...
    expo = 0x0390;
#[no_mangle]
pub unsafe extern "C" fn if(0x0060: expo <) -> else {
    else if (expo < 0x0060)
    expo = 0x0060;
    expo_c1[3] = expo >> 8;
    expo_c1[4] = expo;
...
unsafe extern "C" fn setbrightness(gspca_dev: *mut gspca_dev) {
    ...
    struct sd *sd = (struct sd *) gspca_dev;
    unsigned int expo;
    let mut brightness: c_int = sd.brightness.val;
    u8 k2;
    ...
    expo = 0x002dc6c0;
#[no_mangle]
pub unsafe extern "C" fn if(0x02a0: expo <) -> else {
    else if (expo < 0x02a0)
    expo = 0x02a0;
...
#[no_mangle]
unsafe extern "C" fn setcontrast(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn setredblue(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn setgamma(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn setillum(gspca_dev: *mut gspca_dev) {
...
unsafe extern "C" fn setfreq(gspca_dev: *mut gspca_dev) {
    ...
    let mut reg2a: u8 = 0, reg2b = 0, reg2d = 0;
...
#[no_mangle]
unsafe extern "C" fn setjpegqual(gspca_dev: *mut gspca_dev) {
...
unsafe extern "C" fn do_autogain(gspca_dev: *mut gspca_dev) {
    ...
    int delta;
    int expotimes;
    let mut luma_mean: u8 = 130;
    let mut luma_delta: u8 = 20;
...
#[no_mangle]
pub unsafe extern "C" fn if(QUALITY_MAX: new_qual >) -> else {
