...
//! Source: drivers/media/usb/gspca/zc3xx.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
    let mut force_sensor: static int = -1;
...
#[no_mangle]
unsafe extern "C" fn setmatrix(gspca_dev: *mut gspca_dev) {
...
// ms-win
    ...
    [SENSOR_CS2102K] =	core::ptr::null_mut(),
    [SENSOR_GC0303] =	gc0303_matrix,
    [SENSOR_GC0305] =	gc0305_matrix,
    [SENSOR_HDCS2020] =	core::ptr::null_mut(),
    [SENSOR_HV7131B] =	core::ptr::null_mut(),
    [SENSOR_HV7131R] =	po2030_matrix,
    [SENSOR_ICM105A] =	po2030_matrix,
    [SENSOR_MC501CB] =	core::ptr::null_mut(),
    [SENSOR_MT9V111_1] =	gc0305_matrix,
    [SENSOR_MT9V111_3] =	gc0305_matrix,
    [SENSOR_OV7620] =	ov7620_matrix,
    [SENSOR_OV7630C] =	core::ptr::null_mut(),
    [SENSOR_PAS106] =	core::ptr::null_mut(),
...
unsafe extern "C" fn setsharpness(gspca_dev: *mut gspca_dev, val: i32) {
    ...
    g = 0xff;
#[no_mangle]
pub unsafe extern "C" fn if(0: g <) -> else {
    else if (g < 0)
    g = 0;
...
pub unsafe extern "C" fn if(0: contrast <) -> else {
    ...
    gr[i - 1] = (g - gp2) / 2;
#[no_mangle]
pub unsafe extern "C" fn if(0: i !=) -> else {
    else if (i != 0)
    gr[0] = gp1 == 0 ? 0 : (g - gp1);
    gp2 = gp1;
    gp1 = g;
...
#[no_mangle]
unsafe extern "C" fn setquality(gspca_dev: *mut gspca_dev) {
...
unsafe extern "C" fn setlightfreq(gspca_dev: *mut gspca_dev, val: i32) {
    ...
    [SENSOR_CS2102K] = {
    cs2102_NoFlicker, cs2102_NoFlickerScale,
    core::ptr::null_mut(), core::ptr::null_mut(), /* currently disabled */
...
//
#[no_mangle]
unsafe extern "C" fn transfer_update(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(2: reg07 >) -> else {
    else if (reg07 > 2)
...
#[no_mangle]
unsafe extern "C" fn send_unknown(gspca_dev: *mut gspca_dev, sensor: c_int) {
...
// start probe 2 wires
#[no_mangle]
unsafe extern "C" fn start_2wr_probe(gspca_dev: *mut gspca_dev, sensor: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sif_probe(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vga_2wr_probe(gspca_dev: *mut gspca_dev) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sensor_by_chipset_revision {
    pub revision: u16,
    pub internal_sensor_id: u8,
}
...
#[no_mangle]
unsafe extern "C" fn vga_3wr_probe(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zcxx_probeSensor(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zcxx_g_volatile_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zcxx_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(SENSOR_OV7620: sd->sensor ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn sd_pre_start(gspca_dev: *mut gspca_dev) -> c_int {
