...
//! Source: drivers/media/usb/gspca/spca500.c
#![no_std]
...
pub struct sd {
    ...
    pub subtype: c_char,
pub const AgfaCl20: c_int = 0;
pub const AiptekPocketDV: c_int = 1;
pub const BenqDC1016: c_int = 2;
pub const CreativePCCam300: c_int = 3;
pub const DLinkDSC350: c_int = 4;
pub const Gsmartmini: c_int = 5;
pub const IntelPocketPCCamera: c_int = 6;
pub const KodakEZ200: c_int = 7;
pub const LogitechClickSmart310: c_int = 8;
pub const LogitechClickSmart510: c_int = 9;
pub const LogitechTraveler: c_int = 10;
pub const MustekGsmart300: c_int = 11;
pub const Optimedia: c_int = 12;
pub const PalmPixDC85: c_int = 13;
pub const ToptroIndus: c_int = 14;
...
pub const SPCA500_OFFSET_PADDINGLB: c_int = 2;
pub const SPCA500_OFFSET_PADDINGHB: c_int = 3;
pub const SPCA500_OFFSET_MODE: c_int = 4;
pub const SPCA500_OFFSET_IMGWIDTH: c_int = 5;
pub const SPCA500_OFFSET_IMGHEIGHT: c_int = 6;
pub const SPCA500_OFFSET_IMGMODE: c_int = 7;
pub const SPCA500_OFFSET_QTBLINDEX: c_int = 8;
pub const SPCA500_OFFSET_FRAMSEQ: c_int = 9;
pub const SPCA500_OFFSET_CDSPINFO: c_int = 10;
pub const SPCA500_OFFSET_GPIO: c_int = 11;
pub const SPCA500_OFFSET_AUGPIO: c_int = 12;
pub const SPCA500_OFFSET_DATA: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn spca500_ping310(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn spca500_clksmart310_init(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn spca500_full_reset(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spca500_synch310(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spca500_reinit(gspca_dev: *mut gspca_dev) {
