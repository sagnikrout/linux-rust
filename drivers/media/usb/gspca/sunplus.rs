...
//! Source: drivers/media/usb/gspca/sunplus.c
#![no_std]
...
pub struct sd {
    ...
    pub autogain: bool,
    pub bridge: u8,
pub const BRIDGE_SPCA504: c_int = 0;
pub const BRIDGE_SPCA504B: c_int = 1;
pub const BRIDGE_SPCA504C: c_int = 2;
pub const BRIDGE_SPCA533: c_int = 3;
pub const BRIDGE_SPCA536: c_int = 4;
    pub subtype: u8,
pub const AiptekMiniPenCam13: c_int = 1;
pub const LogitechClickSmart420: c_int = 2;
pub const LogitechClickSmart820: c_int = 3;
pub const MegapixV4: c_int = 4;
pub const MegaImageVI: c_int = 5;
...
pub const SPCA50X_OFFSET_DATA: c_int = 10;
pub const SPCA504_PCCAM600_OFFSET_SNAPSHOT: c_int = 3;
pub const SPCA504_PCCAM600_OFFSET_COMPRESS: c_int = 4;
pub const SPCA504_PCCAM600_OFFSET_MODE: c_int = 5;
pub const SPCA504_PCCAM600_OFFSET_DATA: c_int = 14;
// Frame packet header offsets for the spca533
pub const SPCA533_OFFSET_DATA: c_int = 16;
pub const SPCA533_OFFSET_FRAMSEQ: c_int = 15;
// Frame packet header offsets for the spca536
pub const SPCA536_OFFSET_DATA: c_int = 4;
pub const SPCA536_OFFSET_FRAMSEQ: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cmd {
    pub req: u8,
...
#[no_mangle]
unsafe extern "C" fn spca504_read_info(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn spca504B_PollingDataReady(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn spca504B_WaitCmdStatus(gspca_dev: *mut gspca_dev) {
    static void spca504B_WaitCmdStatus(struct gspca_dev *gspca_dev)
    {
    let mut count: c_int = 50;
    while (--count > 0) {
...
#[no_mangle]
unsafe extern "C" fn spca50x_GetFirmware(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn spca504B_SetSizeType(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn spca504_wait_status(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn spca504B_setQtable(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn init_ctl_reg(gspca_dev: *mut gspca_dev) {
    static void init_ctl_reg(struct gspca_dev *gspca_dev)
    {
    struct sd *sd = (struct sd *) gspca_dev;
    let mut pollreg: c_int = 1;
    switch (sd.bridge) {
    case BRIDGE_SPCA504:
    case BRIDGE_SPCA504C:
    pollreg = 0;
