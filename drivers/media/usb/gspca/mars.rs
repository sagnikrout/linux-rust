...
//! Source: drivers/media/usb/gspca/mars.c
#![no_std]
...
pub struct sd {
    ...
    pub illum_top: *mut v4l2_ctrl,
    pub illum_bottom: *mut v4l2_ctrl,
}
...
#[no_mangle]
unsafe extern "C" fn setilluminators(gspca_dev: *mut gspca_dev, top: bool, bottom: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: bottom) -> else {
    else if (bottom)
...
#[no_mangle]
unsafe extern "C" fn mars_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
