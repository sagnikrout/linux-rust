...
//! Source: drivers/media/usb/gspca/spca506.c
#![no_std]
...
pub const SAA7113_bright: c_uint = 0x0a	/* defaults 0x80 */;
pub const SAA7113_contrast: c_uint = 0x0b	/* defaults 0x47 */;
pub const SAA7113_saturation: c_uint = 0x0c	/* defaults 0x40 */;
pub const SAA7113_hue: c_uint = 0x0d	/* defaults 0x00 */;
pub const SAA7113_I2C_BASE_WRITE: c_uint = 0x4a;
...
#[no_mangle]
unsafe extern "C" fn spca506_Initi2c(gspca_dev: *mut gspca_dev) {
...
// fixme: check if channel == 0..3 and 6..9 (8 values)
    let mut setbit0: __u8 = 0x00;
    let mut setbit1: __u8 = 0x00;
    let mut videomask: __u8 = 0x00;
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_SECAM: norme &) -> else {
