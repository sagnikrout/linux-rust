...
//! Source: drivers/media/usb/gspca/sonixb.c
#![no_std]
...
// Some documentation on known sonixb registers:
    ...
    0x13	vstart
#[no_mangle]
pub unsafe extern "C" fn hsize(16: *mut *mut hsize = register-value) -> 0x15 {
    0x15	hsize (hsize = register-value * 16)
#[no_mangle]
pub unsafe extern "C" fn vsize(16: *mut *mut vsize = register-value) -> 0x16 {
    0x16	vsize (vsize = register-value * 16)
#[no_mangle]
pub unsafe extern "C" fn quality(driver: according to sn9c102) -> 0x17	bit 0 toggle compression {
...
#[no_mangle]
pub unsafe extern "C" fn area(32: *mut *mut for avg_lum) startx (startx = register-value) -> 0x1c	auto_exposure {
    0x1c	auto_exposure area (for avg_lum) startx (startx = register-value * 32)
#[no_mangle]
pub unsafe extern "C" fn area(32: *mut *mut for avg_lum) starty (starty = register-value) -> 0x1d	auto_exposure {
    0x1d	auto_exposure area (for avg_lum) starty (starty = register-value * 32)
#[no_mangle]
pub unsafe extern "C" fn area(32: *mut *mut for avg_lum) stopx (hsize = (0x1e - 0x1c)) -> 0x1e	auto_exposure {
    0x1e	auto_exposure area (for avg_lum) stopx (hsize = (0x1e - 0x1c) * 32)
#[no_mangle]
pub unsafe extern "C" fn area(32: *mut *mut for avg_lum) stopy (vsize = (0x1f - 0x1d)) -> 0x1f	auto_exposure {
...
pub struct sd {
    ...
    pub plfreq: *mut v4l2_ctrl,
    pub avg_lum: core::sync::atomic::AtomicI32,
    pub prev_avg_lum: c_int,
    pub exposure_knee: c_int,
    pub header_read: c_int,
    pub /: *mut *mut u8 header[12]; / Header without sof marker,
    pub autogain_ignore_frames: c_uchar,
    pub frames_to_drop: c_uchar,
    pub /: *mut *mut __u8 bridge; / Type of bridge,
pub const BRIDGE_101: c_int = 0;

pub const BRIDGE_103: c_int = 1;
    pub /: *mut *mut __u8 sensor; / Type of image sensor chip,
pub const SENSOR_HV7131D: c_int = 0;
pub const SENSOR_HV7131R: c_int = 1;
pub const SENSOR_OV6650: c_int = 2;
pub const SENSOR_OV7630: c_int = 3;
pub const SENSOR_PAS106: c_int = 4;
pub const SENSOR_PAS202: c_int = 5;
pub const SENSOR_TAS5110C: c_int = 6;
pub const SENSOR_TAS5110D: c_int = 7;
pub const SENSOR_TAS5130CXX: c_int = 8;
    pub reg11: __u8,
}
...
pub struct sensor_data {
    pub bridge_init: *const __u8,
    pub sensor_init: *mut sensor_init_t,
    pub sensor_init_size: c_int,
    pub flags: c_int,
    pub sensor_addr: __u8,
}

// sensor_data flags
pub const F_SIF: c_uint = 0x01	/* sif or vga */;
// priv field of struct v4l2_pix_format flags (do not use low nibble!)
pub const MODE_RAW: c_uint = 0x10		/* raw bayer mode */;
pub const MODE_REDUCED_SIF: c_uint = 0x20	/* vga mode (320x240 / 160x120) on sif cam */;
pub const COMP: c_uint = 0xc7		/* 0x87 //0x07 */;
pub const COMP1: c_uint = 0xc9		/* 0x89 //0x09 */;
pub const MCK_INIT: c_uint = 0x63;
pub const MCK_INIT1: c_uint = 0x20		/*fixme: Bayer - 0x50 for JPEG ??*/;
pub const SYS_CLK: c_uint = 0x04;
...
pub const AUTOGAIN_IGNORE_FRAMES: c_int = 1;
...
#[no_mangle]
pub unsafe extern "C" fn bit(offset: bit0 1 > negative) -> 0x07 offset sign {
...
// "Known" PAS202BCB registers:
    ...
    0x09 Red Gain
#[no_mangle]
pub unsafe extern "C" fn bit(offset: bit0 1 > negative) -> 0x0b offset sign {
...
#[no_mangle]
unsafe extern "C" fn i2c_w(gspca_dev: *mut gspca_dev, buf: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn setbrightness(gspca_dev: *mut gspca_dev) {
...
unsafe extern "C" fn setgain(gspca_dev: *mut gspca_dev) {
    ...
    {
    struct sd *sd = (struct sd *) gspca_dev;
    let mut gain: u8 = gspca_dev.gain.val;
    switch (sd.sensor) {
    case SENSOR_HV7131D: {
    __u8 i2c[] =
...
// Note the datasheet wrongly says line mode exposure uses reg
    ...
    let mut reg: u16 = gspca_dev.exposure.val;
    i2c[3] = reg >> 8;
    i2c[4] = reg & 0xff;
    i2c_w(gspca_dev, i2c);
    break;
...
// register 19's high nibble contains the sn9c10x clock divider
    ...
    let mut reg: u8 = gspca_dev.exposure.val;
    reg = (reg << 4) | 0x0b;
...
// ov6645 datasheet says reg10_max is 9a, but that uses
    ...
    reg11 = 1;
#[no_mangle]
pub unsafe extern "C" fn if(16: reg11 >) -> else {
    else if (reg11 > 16)
    reg11 = 16;
...
// Don't allow this to get below 10 when using autogain, the
    ...
    reg10 = 10;
#[no_mangle]
pub unsafe extern "C" fn if(reg10_max: reg10 >) -> else {
...
#[no_mangle]
unsafe extern "C" fn setfreq(gspca_dev: *mut gspca_dev) {
...
// SIF sensors tend to overexpose, so keep this small
    ...
    let mut gain_knee: c_int = (s32)gspca_dev.gain.maximum * 9 / 10;
...
#[no_mangle]
unsafe extern "C" fn find_sof(gspca_dev: *mut gspca_dev, data: *mut u8, len: c_int) -> *mut u8 {
...
//
    ...
    sd.header_read++;
#[no_mangle]
pub unsafe extern "C" fn if(0xff: data[i] !=) -> else {
    else if (data[i] != 0xff)
    sd.header_read = 0;
    break;
    case 3:
...
pub unsafe extern "C" fn if(0xff: data[i] ==) -> else {
    ...
    {
    let mut fr_h_sz: c_int = 0, lum_offset = 0, len_after_sof = 0;
    struct sd *sd = (struct sd *) gspca_dev;
    struct cam *cam = &gspca_dev.cam;
    u8 *sof;
...
// In raw mode we sometimes get some garbage after the frame
    ignore this */
    int used;
    let mut size: c_int = cam.cam_mode[gspca_dev.curr_mode].sizeimage;
