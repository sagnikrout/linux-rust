...
//! Source: drivers/media/usb/gspca/w996Xcf.c
#![no_std]
...
// --------------------------------------------------------------------------
    ...
    --------------------------------------------------------------------------*/
#[no_mangle]
unsafe extern "C" fn w9968cf_write_fsb(sd: *mut sd, data: *mut *mut u16) {
...
// --------------------------------------------------------------------------
    ...
    --------------------------------------------------------------------------*/
#[no_mangle]
unsafe extern "C" fn w9968cf_write_sb(sd: *mut sd, value: u16) {
...
// We don't use reg_w here, as that would cause all writes when
    ...
    value, 0x01, core::ptr::null_mut(), 0, 500);
...
// --------------------------------------------------------------------------
    ...
    --------------------------------------------------------------------------*/
#[no_mangle]
unsafe extern "C" fn w9968cf_read_sb(sd: *mut sd) -> c_int {
...
// --------------------------------------------------------------------------
    ...
    --------------------------------------------------------------------------*/
#[no_mangle]
unsafe extern "C" fn w9968cf_upload_quantizationtables(sd: *mut sd) {
...
//
#[no_mangle]
unsafe extern "C" fn w9968cf_smbus_start(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn w9968cf_smbus_stop(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn w9968cf_smbus_write_byte(sd: *mut sd, v: u8) {
...
#[no_mangle]
unsafe extern "C" fn w9968cf_smbus_read_byte(sd: *mut sd, v: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn w9968cf_smbus_write_nack(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn w9968cf_smbus_read_ack(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn w9968cf_i2c_w(sd: *mut sd, reg: u8, value: u8) {
    static void w9968cf_i2c_w(struct sd *sd, u8 reg, u8 value)
    {
    struct gspca_dev *gspca_dev = (struct gspca_dev *)sd;
    let mut data: *mut u16 = (u16 *)sd.gspca_dev.usb_buf;
...
#[no_mangle]
unsafe extern "C" fn w9968cf_i2c_r(sd: *mut sd, reg: u8) -> c_int {
...
// --------------------------------------------------------------------------
    ...
    --------------------------------------------------------------------------*/
#[no_mangle]
unsafe extern "C" fn w9968cf_configure(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn w9968cf_init(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn w9968cf_set_crop_window(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn w9968cf_mode_init_regs(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn w9968cf_stop0(sd: *mut sd) {
