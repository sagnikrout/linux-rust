...
//! Source: drivers/media/usb/gspca/xirlink_cit.c
#![no_std]
...
pub struct sd {
    ...
    pub lighting: *mut v4l2_ctrl,
    pub model: u8,

pub const CIT_MODEL3: c_int = 3;
pub const CIT_MODEL4: c_int = 4;
pub const CIT_IBM_NETCAM_PRO: c_int = 5;
    pub input_index: u8,
    pub button_state: u8,
    pub stop_on_control_change: u8,
    pub sof_read: u8,
    pub sof_len: u8,
}
...
// TESTME the old ibmcam driver repeats certain commands to Model1 cameras, we
    ...
    let mut cit_model1_ntries: static int = 5;
    let mut cit_model1_ntries2: static int = 2;
#[no_mangle]
unsafe extern "C" fn cit_write_reg(gspca_dev: *mut gspca_dev, value: u16, index: u16) -> c_int {
    ...
    value, index, core::ptr::null_mut(), 0, 1000);
    if (err < 0)
...
#[no_mangle]
unsafe extern "C" fn cit_read_reg(gspca_dev: *mut gspca_dev, index: u16, verbose: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cit_send_FF_04_02(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn cit_send_00_04_06(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn cit_send_x_00(gspca_dev: *mut gspca_dev, x: c_ushort) {
...
#[no_mangle]
unsafe extern "C" fn cit_send_x_00_05(gspca_dev: *mut gspca_dev, x: c_ushort) {
...
#[no_mangle]
unsafe extern "C" fn cit_send_x_00_05_02(gspca_dev: *mut gspca_dev, x: c_ushort) {
...
#[no_mangle]
unsafe extern "C" fn cit_send_x_01_00_05(gspca_dev: *mut gspca_dev, x: u16) {
...
#[no_mangle]
unsafe extern "C" fn cit_send_x_00_05_02_01(gspca_dev: *mut gspca_dev, x: u16) {
...
#[no_mangle]
unsafe extern "C" fn cit_send_x_00_05_02_08_01(gspca_dev: *mut gspca_dev, x: u16) {
...
#[no_mangle]
unsafe extern "C" fn cit_Packet_Format1(gspca_dev: *mut gspca_dev, fkey: u16, val: u16) {
...
#[no_mangle]
unsafe extern "C" fn cit_PacketFormat2(gspca_dev: *mut gspca_dev, fkey: u16, val: u16) {
...
#[no_mangle]
unsafe extern "C" fn cit_model2_Packet2(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn cit_model2_Packet1(gspca_dev: *mut gspca_dev, v1: u16, v2: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn cit_model3_Packet1(gspca_dev: *mut gspca_dev, v1: u16, v2: u16) {
...
#[no_mangle]
unsafe extern "C" fn cit_model4_Packet1(gspca_dev: *mut gspca_dev, v1: u16, v2: u16) {
...
#[no_mangle]
unsafe extern "C" fn cit_model4_BrightnessPacket(gspca_dev: *mut gspca_dev, val: u16) {
...
#[no_mangle]
unsafe extern "C" fn cit_init_model0(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cit_init_ibm_netcam_pro(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cit_set_brightness(gspca_dev: *mut gspca_dev, val: i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cit_set_contrast(gspca_dev: *mut gspca_dev, val: i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cit_set_hue(gspca_dev: *mut gspca_dev, val: i32) -> c_int {
...
// Scale 0 - 127 to 0x05 - 0x37
    let mut i: c_int = 0x05 + val * 1000 / 2540;
...
#[no_mangle]
unsafe extern "C" fn cit_set_sharpness(gspca_dev: *mut gspca_dev, val: i32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cit_set_lighting(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn cit_set_hflip(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn cit_restart_stream(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cit_get_packet_size(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cit_get_clock_div(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cit_start_model0(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cit_start_model1(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cit_start_model2(gspca_dev: *mut gspca_dev) -> c_int {
    static int cit_start_model2(struct gspca_dev *gspca_dev)
    {
    struct sd *sd = (struct sd *) gspca_dev;
    let mut clock_div: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn cit_start_model3(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cit_start_model4(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cit_start_ibm_netcam_pro(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_isoc_nego(gspca_dev: *mut gspca_dev) -> c_int {
...
// For this model the SOF always starts at offset 0
    ...
    sd.sof_read++;
#[no_mangle]
pub unsafe extern "C" fn if(0x00: data[i] ==) -> else {
    else if (data[i] == 0x00)
    sd.sof_read = 1;
    else
    sd.sof_read = 0;
...
#[no_mangle]
unsafe extern "C" fn cit_check_button(gspca_dev: *mut gspca_dev) {
