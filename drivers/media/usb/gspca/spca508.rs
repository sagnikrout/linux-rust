...
//! Source: drivers/media/usb/gspca/spca508.c
#![no_std]
...
pub struct sd {
    ...
    pub subtype: u8,
pub const CreativeVista: c_int = 0;
pub const HamaUSBSightcam: c_int = 1;
pub const HamaUSBSightcam2: c_int = 2;
pub const IntelEasyPCCamera: c_int = 3;
pub const MicroInnovationIC200: c_int = 4;
pub const ViewQuestVQ110: c_int = 5;
}
...
pub const SPCA508_OFFSET_DATA: c_int = 37;
//
...
#[no_mangle]
unsafe extern "C" fn reg_write(gspca_dev: *mut gspca_dev, index: u16, value: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn u16(_arg: *mut data)[2]) -> const {
    const u16 (*data)[2])
    {
    let mut ret: c_int = 0;
    while ((*data)[1] != 0) {
