...
//! Source: drivers/media/usb/gspca/sn9c20x.c
#![no_std]
...
//
pub const SCALE_MASK: c_uint = 0x0f;
pub const SCALE_160x120: c_int = 0;
pub const SCALE_320x240: c_int = 1;
pub const SCALE_640x480: c_int = 2;
pub const SCALE_1280x1024: c_int = 3;
pub const MODE_RAW: c_uint = 0x10;
pub const MODE_JPEG: c_uint = 0x20;
pub const MODE_SXGA: c_uint = 0x80;
pub const SENSOR_OV9650: c_int = 0;
pub const SENSOR_OV9655: c_int = 1;
pub const SENSOR_SOI968: c_int = 2;
pub const SENSOR_OV7660: c_int = 3;
pub const SENSOR_OV7670: c_int = 4;
pub const SENSOR_MT9V011: c_int = 5;
pub const SENSOR_MT9V111: c_int = 6;
pub const SENSOR_MT9V112: c_int = 7;
pub const SENSOR_MT9M001: c_int = 8;
pub const SENSOR_MT9M111: c_int = 9;
pub const SENSOR_MT9M112: c_int = 10;
pub const SENSOR_HV7131R: c_int = 11;
pub const SENSOR_MT9VPRB: c_int = 12;
// camera flags
pub const HAS_NO_BUTTON: c_uint = 0x1;
pub const LED_REVERSE: c_uint = 0x2 /* some cameras unset gpio to turn on leds */;
pub const FLIP_DETECT: c_uint = 0x4;
pub const HAS_LED_TORCH: c_uint = 0x8;
...
pub const MIN_AVG_LUM: c_int = 80;
pub const MAX_AVG_LUM: c_int = 130;
    atomic_t avg_lum;
    u8 old_step;
    u8 older_step;
    u8 exposure_step;
...
#[no_mangle]
unsafe extern "C" fn reg_r(gspca_dev: *mut gspca_dev, reg: u16, length: u16) {
...
#[no_mangle]
unsafe extern "C" fn reg_w1(gspca_dev: *mut gspca_dev, reg: u16, value: u8) {
    static void reg_w1(struct gspca_dev *gspca_dev, u16 reg, const u8 value)
    {
    reg_w(gspca_dev, reg, &value, 1);
    }
#[no_mangle]
unsafe extern "C" fn i2c_w(gspca_dev: *mut gspca_dev, buffer: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn i2c_w1(gspca_dev: *mut gspca_dev, reg: u8, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn i2c_w2(gspca_dev: *mut gspca_dev, reg: u8, val: u16) {
...
#[no_mangle]
unsafe extern "C" fn i2c_r1(gspca_dev: *mut gspca_dev, reg: u8, val: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn i2c_r2(gspca_dev: *mut gspca_dev, reg: u8, val: *mut u16) {
...
#[no_mangle]
unsafe extern "C" fn ov9650_init_sensor(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn ov9655_init_sensor(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn soi968_init_sensor(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn ov7660_init_sensor(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn ov7670_init_sensor(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt9v_init_sensor(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt9m112_init_sensor(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt9m111_init_sensor(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt9m001_init_sensor(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn hv7131r_init_sensor(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn set_gamma(gspca_dev: *mut gspca_dev, val: i32) {
    static void set_gamma(struct gspca_dev *gspca_dev, s32 val)
    {
    u8 gamma[17];
    let mut gval: u8 = val * 0xb8 / 0x100;
    gamma[0] = 0x0a;
...
#[no_mangle]
unsafe extern "C" fn set_redblue(gspca_dev: *mut gspca_dev, blue: i32, red: i32) {
...
#[no_mangle]
unsafe extern "C" fn set_hvflip(gspca_dev: *mut gspca_dev, hflip: i32, vflip: i32) {
...
#[no_mangle]
unsafe extern "C" fn set_exposure(gspca_dev: *mut gspca_dev, expo: i32) {
...
#[no_mangle]
unsafe extern "C" fn set_gain(gspca_dev: *mut gspca_dev, g: i32) {
...
#[no_mangle]
unsafe extern "C" fn set_led_mode(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn set_quality(gspca_dev: *mut gspca_dev, val: i32) {
...
// this sensor doesn't have the exposure control and
    ...
    because sd.exposure == core::ptr::null_mut(). */
...
#[no_mangle]
unsafe extern "C" fn configure_sensor_output(gspca_dev: *mut gspca_dev, mode: c_int) {
...
unsafe extern "C" fn sd_isoc_init(gspca_dev: *mut gspca_dev) -> c_int {
    ...
    let mut flags: u32 = gspca_dev.cam.cam_mode[(int)gspca_dev.curr_mode].priv;
//
...
unsafe extern "C" fn sd_start(gspca_dev: *mut gspca_dev) -> c_int {
    ...
    {
    struct sd *sd = (struct sd *) gspca_dev;
    let mut mode: c_int = gspca_dev.cam.cam_mode[(int) gspca_dev.curr_mode].priv;
    let mut width: c_int = gspca_dev.pixfmt.width;
    let mut height: c_int = gspca_dev.pixfmt.height;
    u8 fmt, scale = 0;
    ...
    fmt = 0x2d;
#[no_mangle]
pub unsafe extern "C" fn if(MODE_JPEG: mode &) -> else {
...
#[no_mangle]
unsafe extern "C" fn do_autoexposure(gspca_dev: *mut gspca_dev, avg_lum: u16) {
    static void do_autoexposure(struct gspca_dev *gspca_dev, u16 avg_lum)
    {
    struct sd *sd = (struct sd *) gspca_dev;
    let mut cur_exp: i32 = v4l2_ctrl_g_ctrl(sd.exposure);
    let mut max: i32 = sd.exposure.maximum - sd.exposure_step;
    let mut min: i32 = sd.exposure.minimum + sd.exposure_step;
    s16 new_exp;
//
...
#[no_mangle]
unsafe extern "C" fn do_autogain(gspca_dev: *mut gspca_dev, avg_lum: u16) {
    static void do_autogain(struct gspca_dev *gspca_dev, u16 avg_lum)
    {
    struct sd *sd = (struct sd *) gspca_dev;
    let mut cur_gain: i32 = v4l2_ctrl_g_ctrl(sd.gain);
...
#[no_mangle]
unsafe extern "C" fn sd_dqcallback(gspca_dev: *mut gspca_dev) {
    static void sd_dqcallback(struct gspca_dev *gspca_dev)
    {
    struct sd *sd = (struct sd *) gspca_dev;
    int avg_lum;
    if (sd.autogain == core::ptr::null_mut() || !v4l2_ctrl_g_ctrl(sd.autogain))
    return;
...
#[no_mangle]
unsafe extern "C" fn qual_upd(work: *mut work_struct) {
    static void qual_upd(struct work_struct *work)
    {
    struct sd *sd = container_of(work, struct sd, work);
    struct gspca_dev *gspca_dev = &sd.gspca_dev;
    let mut qual: i32 = v4l2_ctrl_g_ctrl(sd.jpegqual);
...
// else, compute the filling rate and a new JPEG quality
    ...
    new_qual = -3;
#[no_mangle]
pub unsafe extern "C" fn if(75: r <) -> else {
    else if (r < 75)
    new_qual = 2;
    }
    if (new_qual != 0) {
...
// Note: we are in interrupt context, so we can't
    ...
    directly instead. */
    let mut curqual: i32 = sd.jpegqual.cur.val;
    sd.nchg = 0;
    new_qual += curqual;
    if (new_qual < sd.jpegqual.minimum)
    new_qual = sd.jpegqual.minimum;
#[no_mangle]
pub unsafe extern "C" fn if(sd->jpegqual->maximum: new_qual >) -> else {
