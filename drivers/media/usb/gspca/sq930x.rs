...
//! Source: drivers/media/usb/gspca/sq930x.c
#![no_std]
...
pub struct sd {
    ...
    u8 sensor;
    u8 type;
pub const Generic: c_int = 0;
pub const Creative_live_motion: c_int = 1;
    };
    enum sensors {
    SENSOR_ICX098BQ,
    SENSOR_LZ24BP,
...
// sq930x registers
pub const SQ930_CTRL_UCBUS_IO: c_uint = 0x0001;
pub const SQ930_CTRL_I2C_IO: c_uint = 0x0002;
pub const SQ930_CTRL_GPIO: c_uint = 0x0005;
pub const SQ930_CTRL_CAP_START: c_uint = 0x0010;
pub const SQ930_CTRL_CAP_STOP: c_uint = 0x0011;
pub const SQ930_CTRL_SET_EXPOSURE: c_uint = 0x001d;
pub const SQ930_CTRL_RESET: c_uint = 0x001e;
pub const SQ930_CTRL_GET_DEV_INFO: c_uint = 0x001f;
// gpio 1 (8..15)
pub const SQ930_GPIO_DFL_I2C_SDA: c_uint = 0x0001;
pub const SQ930_GPIO_DFL_I2C_SCL: c_uint = 0x0002;
pub const SQ930_GPIO_RSTBAR: c_uint = 0x0004;
pub const SQ930_GPIO_EXTRA1: c_uint = 0x0040;
pub const SQ930_GPIO_EXTRA2: c_uint = 0x0080;
// gpio 3 (24..31)
pub const SQ930_GPIO_POWER: c_uint = 0x0200;
pub const SQ930_GPIO_DFL_LED: c_uint = 0x1000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ucbus_write_cmd {
    pub bw_addr: u16,
    pub bw_data: u8,
}
...
#[no_mangle]
unsafe extern "C" fn gpio_set(sd: *mut sd, val: u16, mask: u16) {
...
#[no_mangle]
unsafe extern "C" fn bridge_init(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn cmos_probe(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn mt9v111_init(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn global_init(sd: *mut sd, first_time: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lz24bp_ppl(sd: *mut sd, ppl: u16) {
...
#[no_mangle]
unsafe extern "C" fn setexposure(gspca_dev: *mut gspca_dev, expo: i32, gain: i32) {
...
#[no_mangle]
unsafe extern "C" fn send_start(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn send_stop(gspca_dev: *mut gspca_dev) {
