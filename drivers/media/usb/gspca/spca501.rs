...
//! Source: drivers/media/usb/gspca/spca501.c
#![no_std]
...
pub struct sd {
    ...
    pub contrast: c_ushort,
    pub brightness: __u8,
    pub colors: __u8,
    pub blue_balance: __u8,
    pub red_balance: __u8,
    pub subtype: c_char,
pub const Arowana300KCMOSCamera: c_int = 0;
pub const IntelCreateAndShare: c_int = 1;
pub const KodakDVC325: c_int = 2;
pub const MystFromOriUnknownCamera: c_int = 3;
pub const SmileIntlCamera: c_int = 4;
pub const ThreeComHomeConnectLite: c_int = 5;
pub const ViewQuestM318B: c_int = 6;
}
...
pub const SPCA50X_REG_USB: c_uint = 0x2	/* spca505 501 */;
//
// Data to initialize a SPCA501. From a capture file provided by Bill Roehl
// With SPCA501 chip description
//

pub const SPCA501_SNAPBIT: c_uint = 0x80;
pub const SPCA501_SNAPCTRL: c_uint = 0x10;
// Frame packet header offsets for the spca501
pub const SPCA501_OFFSET_GPIO: c_int = 1;
pub const SPCA501_OFFSET_TYPE: c_int = 2;
pub const SPCA501_OFFSET_TURN3A: c_int = 3;
pub const SPCA501_OFFSET_FRAMSEQ: c_int = 4;
pub const SPCA501_OFFSET_COMPRESS: c_int = 5;
pub const SPCA501_OFFSET_QUANT: c_int = 6;
pub const SPCA501_OFFSET_QUANT2: c_int = 7;
pub const SPCA501_OFFSET_DATA: c_int = 8;

// SPCA501 CCDSP control
pub const SPCA501_REG_CCDSP: c_uint = 0x01;
// SPCA501 control/status registers
pub const SPCA501_REG_CTLRL: c_uint = 0x02;
// registers for color correction and YUV transformation
pub const SPCA501_A11: c_uint = 0x08;
pub const SPCA501_A12: c_uint = 0x09;
pub const SPCA501_A13: c_uint = 0x0A;
pub const SPCA501_A21: c_uint = 0x0B;
pub const SPCA501_A22: c_uint = 0x0C;
pub const SPCA501_A23: c_uint = 0x0D;
pub const SPCA501_A31: c_uint = 0x0E;
pub const SPCA501_A32: c_uint = 0x0F;
pub const SPCA501_A33: c_uint = 0x10;
...
#[no_mangle]
pub unsafe extern "C" fn Value(_arg: hex) -> Bit {
    Bit  Value (hex)
    0    01
    1    02
    2    04
...
#[no_mangle]
unsafe extern "C" fn write_vector(gspca_dev: *mut gspca_dev, data[][3]: __u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setblue_balance(gspca_dev: *mut gspca_dev, val: i32) {
    static void setblue_balance(struct gspca_dev *gspca_dev, s32 val)
    {
    reg_write(gspca_dev, SPCA501_REG_CCDSP, 0x11, val);
    }
#[no_mangle]
unsafe extern "C" fn setred_balance(gspca_dev: *mut gspca_dev, val: i32) {
