...
//! Source: drivers/media/usb/gspca/finepix.c
#![no_std]
...
pub const FPIX_TIMEOUT: c_int = 250;
// Maximum transfer size to use. The windows driver reads by chunks of
// 0x2000 bytes, so do the same. Note: reading more seems to work
// too.
pub const FPIX_MAX_TRANSFER: c_uint = 0x2000;
...
pub const NEXT_FRAME_DELAY: c_int = 35;
...
//
#[no_mangle]
unsafe extern "C" fn dostream(work: *mut work_struct) {
