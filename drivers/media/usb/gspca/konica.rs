...
//! Source: drivers/media/usb/gspca/konica.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
pub const WHITEBAL_REG: c_uint = 0x01;
pub const BRIGHTNESS_REG: c_uint = 0x02;
pub const SHARPNESS_REG: c_uint = 0x03;
pub const CONTRAST_REG: c_uint = 0x04;
pub const SATURATION_REG: c_uint = 0x05;
// specific webcam descriptor
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sd {
    pub /: *mut *mut gspca_dev gspca_dev; / !! must be the first item,
    pub last_data_urb: *mut urb,
    pub snapshot_pressed: u8,
}
...
#[no_mangle]
unsafe extern "C" fn reg_r(gspca_dev: *mut gspca_dev, value: u16, index: u16) {
...
#[no_mangle]
unsafe extern "C" fn konica_stream_on(gspca_dev: *mut gspca_dev) {
    static void konica_stream_on(struct gspca_dev *gspca_dev)
    {
    reg_w(gspca_dev, 1, 0x0b);
    }
#[no_mangle]
unsafe extern "C" fn konica_stream_off(gspca_dev: *mut gspca_dev) {
...
// reception of an URB
#[no_mangle]
unsafe extern "C" fn sd_isoc_irq(urb: *mut urb) {
    static void sd_isoc_irq(struct urb *urb)
    {
...
// if this is a data URB (ep 0x82), wait
    ...
    sd.last_data_urb = core::ptr::null_mut();
...
//
    ...
    let mut button_state: u8 = st & 0x40 ? 1 : 0;
