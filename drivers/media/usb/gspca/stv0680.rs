...
//! Source: drivers/media/usb/gspca/stv0680.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn stv0680_handle_error(gspca_dev: *mut gspca_dev, ret: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stv0680_get_video_mode(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stv0680_set_video_mode(gspca_dev: *mut gspca_dev, mode: u8) -> c_int {
