...
//! Source: drivers/media/usb/gspca/ov519.c
#![no_std]
...
// are getting "Failed to read sensor ID..."
    let mut i2c_detect_tries: static int = 10;
...
pub struct sd {
    ...
    u8 packet_nr;
    char bridge;
pub const BRIDGE_OV511: c_int = 0;
pub const BRIDGE_OV511PLUS: c_int = 1;
pub const BRIDGE_OV518: c_int = 2;
pub const BRIDGE_OV518PLUS: c_int = 3;

pub const BRIDGE_OVFX2: c_int = 5;
pub const BRIDGE_W9968CF: c_int = 6;
pub const BRIDGE_MASK: c_int = 7;
    char invert_led;
pub const BRIDGE_INVERT_LED: c_int = 8;
    char snapshot_pressed;
    char snapshot_needs_reset;
// Determined by sensor type
    u8 sif;
pub const QUALITY_MIN: c_int = 50;
pub const QUALITY_MAX: c_int = 70;
pub const QUALITY_DEF: c_int = 50;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ctrl_valid {
    pub has_brightness:1: c_uint,
    pub has_contrast:1: c_uint,
    pub has_exposure:1: c_uint,
    pub has_autogain:1: c_uint,
    pub has_sat:1: c_uint,
    pub has_hvflip:1: c_uint,
    pub has_autobright:1: c_uint,
    pub has_freq:1: c_uint,
}
...
pub const R51x_FIFO_PSIZE: c_uint = 0x30	/* 2 bytes wide w/ OV518(+) */;
pub const R51x_SYS_RESET: c_uint = 0x50;
// Reset type flags
pub const OV511_RESET_OMNICE: c_uint = 0x08;
pub const R51x_SYS_INIT: c_uint = 0x53;
pub const R51x_SYS_SNAP: c_uint = 0x52;
pub const R51x_SYS_CUST_ID: c_uint = 0x5f;
pub const R51x_COMP_LUT_BEGIN: c_uint = 0x80;
// OV511 Camera interface register numbers
pub const R511_CAM_DELAY: c_uint = 0x10;
pub const R511_CAM_EDGE: c_uint = 0x11;
pub const R511_CAM_PXCNT: c_uint = 0x12;
pub const R511_CAM_LNCNT: c_uint = 0x13;
pub const R511_CAM_PXDIV: c_uint = 0x14;
pub const R511_CAM_LNDIV: c_uint = 0x15;
pub const R511_CAM_UV_EN: c_uint = 0x16;
pub const R511_CAM_LINE_MODE: c_uint = 0x17;
pub const R511_CAM_OPTS: c_uint = 0x18;
pub const R511_SNAP_FRAME: c_uint = 0x19;
pub const R511_SNAP_PXCNT: c_uint = 0x1a;
pub const R511_SNAP_LNCNT: c_uint = 0x1b;
pub const R511_SNAP_PXDIV: c_uint = 0x1c;
pub const R511_SNAP_LNDIV: c_uint = 0x1d;
pub const R511_SNAP_UV_EN: c_uint = 0x1e;
pub const R511_SNAP_OPTS: c_uint = 0x1f;
pub const R511_DRAM_FLOW_CTL: c_uint = 0x20;
pub const R511_FIFO_OPTS: c_uint = 0x31;
pub const R511_I2C_CTL: c_uint = 0x40;
pub const R511_SYS_LED_CTL: c_uint = 0x55	/* OV511+ only */;
pub const R511_COMP_EN: c_uint = 0x78;
pub const R511_COMP_LUT_EN: c_uint = 0x79;
// OV518 Camera interface register numbers
pub const R518_GPIO_OUT: c_uint = 0x56	/* OV518(+) only */;
pub const R518_GPIO_CTL: c_uint = 0x57	/* OV518(+) only */;
// OV519 Camera interface register numbers
pub const OV519_R10_H_SIZE: c_uint = 0x10;
pub const OV519_R11_V_SIZE: c_uint = 0x11;
pub const OV519_R12_X_OFFSETL: c_uint = 0x12;
pub const OV519_R13_X_OFFSETH: c_uint = 0x13;
pub const OV519_R14_Y_OFFSETL: c_uint = 0x14;
pub const OV519_R15_Y_OFFSETH: c_uint = 0x15;
pub const OV519_R16_DIVIDER: c_uint = 0x16;
pub const OV519_R20_DFR: c_uint = 0x20;
pub const OV519_R25_FORMAT: c_uint = 0x25;
// OV519 System Controller register numbers
pub const OV519_R51_RESET1: c_uint = 0x51;
pub const OV519_R54_EN_CLK1: c_uint = 0x54;
pub const OV519_R57_SNAPSHOT: c_uint = 0x57;
pub const OV519_GPIO_DATA_OUT0: c_uint = 0x71;
pub const OV519_GPIO_IO_CTRL0: c_uint = 0x72;
...
// I2C registers
pub const R51x_I2C_W_SID: c_uint = 0x41;
pub const R51x_I2C_SADDR_3: c_uint = 0x42;
pub const R51x_I2C_SADDR_2: c_uint = 0x43;
pub const R51x_I2C_R_SID: c_uint = 0x44;
pub const R51x_I2C_DATA: c_uint = 0x45;
pub const R518_I2C_CTL: c_uint = 0x47	/* OV518(+) only */;
pub const OVFX2_I2C_ADDR: c_uint = 0x00;
// I2C ADDRESSES
pub const OV7xx0_SID: c_uint = 0x42;
pub const OV_HIRES_SID: c_uint = 0x60		/* OV9xxx / OV2xxx / OV3xxx */;
pub const OV8xx0_SID: c_uint = 0xa0;
pub const OV6xx0_SID: c_uint = 0xc0;
// OV7610 registers
pub const OV7610_REG_GAIN: c_uint = 0x00	/* gain setting (5:0) */;
pub const OV7610_REG_BLUE: c_uint = 0x01	/* blue channel balance */;
pub const OV7610_REG_RED: c_uint = 0x02	/* red channel balance */;
pub const OV7610_REG_SAT: c_uint = 0x03	/* saturation */;
pub const OV8610_REG_HUE: c_uint = 0x04	/* 04 reserved */;
pub const OV7610_REG_CNT: c_uint = 0x05	/* Y contrast */;
pub const OV7610_REG_BRT: c_uint = 0x06	/* Y brightness */;
pub const OV7610_REG_COM_C: c_uint = 0x14	/* misc common regs */;
pub const OV7610_REG_ID_HIGH: c_uint = 0x1c	/* manufacturer ID MSB */;
pub const OV7610_REG_ID_LOW: c_uint = 0x1d	/* manufacturer ID LSB */;
pub const OV7610_REG_COM_I: c_uint = 0x29	/* misc settings */;
// OV7660 and OV7670 registers
pub const OV7670_R00_GAIN: c_uint = 0x00	/* Gain lower 8 bits (rest in vref) */;
pub const OV7670_R01_BLUE: c_uint = 0x01	/* blue gain */;
pub const OV7670_R02_RED: c_uint = 0x02	/* red gain */;
pub const OV7670_R03_VREF: c_uint = 0x03	/* Pieces of GAIN, VSTART, VSTOP */;
pub const OV7670_R04_COM1: c_uint = 0x04	/* Control 1 */;
// #define OV7670_R07_AECHH	0x07	 * AEC MS 5 bits
pub const OV7670_R0C_COM3: c_uint = 0x0c	/* Control 3 */;
pub const OV7670_R0D_COM4: c_uint = 0x0d	/* Control 4 */;
pub const OV7670_R0E_COM5: c_uint = 0x0e	/* All "reserved" */;
pub const OV7670_R0F_COM6: c_uint = 0x0f	/* Control 6 */;
pub const OV7670_R10_AECH: c_uint = 0x10	/* More bits of AEC value */;
pub const OV7670_R11_CLKRC: c_uint = 0x11	/* Clock control */;
pub const OV7670_R12_COM7: c_uint = 0x12	/* Control 7 */;
pub const OV7670_COM7_FMT_VGA: c_uint = 0x00;
// #define   OV7670_COM7_YUV	 0x00	 * YUV
pub const OV7670_COM7_FMT_QVGA: c_uint = 0x10	/* QVGA format */;
pub const OV7670_COM7_FMT_MASK: c_uint = 0x38;
pub const OV7670_COM7_RESET: c_uint = 0x80	/* Register reset */;
pub const OV7670_R13_COM8: c_uint = 0x13	/* Control 8 */;
pub const OV7670_COM8_AEC: c_uint = 0x01	/* Auto exposure enable */;
pub const OV7670_COM8_AWB: c_uint = 0x02	/* White balance enable */;
pub const OV7670_COM8_AGC: c_uint = 0x04	/* Auto gain enable */;
pub const OV7670_COM8_BFILT: c_uint = 0x20	/* Band filter enable */;
pub const OV7670_COM8_AECSTEP: c_uint = 0x40	/* Unlimited AEC step size */;
pub const OV7670_COM8_FASTAEC: c_uint = 0x80	/* Enable fast AGC/AEC */;
pub const OV7670_R14_COM9: c_uint = 0x14	/* Control 9 - gain ceiling */;
pub const OV7670_R15_COM10: c_uint = 0x15	/* Control 10 */;
pub const OV7670_R17_HSTART: c_uint = 0x17	/* Horiz start high bits */;
pub const OV7670_R18_HSTOP: c_uint = 0x18	/* Horiz stop high bits */;
pub const OV7670_R19_VSTART: c_uint = 0x19	/* Vert start high bits */;
pub const OV7670_R1A_VSTOP: c_uint = 0x1a	/* Vert stop high bits */;
pub const OV7670_R1E_MVFP: c_uint = 0x1e	/* Mirror / vflip */;
pub const OV7670_MVFP_VFLIP: c_uint = 0x10	/* vertical flip */;
pub const OV7670_MVFP_MIRROR: c_uint = 0x20	/* Mirror image */;
pub const OV7670_R24_AEW: c_uint = 0x24	/* AGC upper limit */;
pub const OV7670_R25_AEB: c_uint = 0x25	/* AGC lower limit */;
pub const OV7670_R26_VPT: c_uint = 0x26	/* AGC/AEC fast mode op region */;
pub const OV7670_R32_HREF: c_uint = 0x32	/* HREF pieces */;
pub const OV7670_R3A_TSLB: c_uint = 0x3a	/* lots of stuff */;
pub const OV7670_R3B_COM11: c_uint = 0x3b	/* Control 11 */;
pub const OV7670_COM11_EXP: c_uint = 0x02;
pub const OV7670_COM11_HZAUTO: c_uint = 0x10	/* Auto detect 50/60 Hz */;
pub const OV7670_R3C_COM12: c_uint = 0x3c	/* Control 12 */;
pub const OV7670_R3D_COM13: c_uint = 0x3d	/* Control 13 */;
pub const OV7670_COM13_GAMMA: c_uint = 0x80	/* Gamma enable */;
pub const OV7670_COM13_UVSAT: c_uint = 0x40	/* UV saturation auto adjustment */;
pub const OV7670_R3E_COM14: c_uint = 0x3e	/* Control 14 */;
pub const OV7670_R3F_EDGE: c_uint = 0x3f	/* Edge enhancement factor */;
pub const OV7670_R40_COM15: c_uint = 0x40	/* Control 15 */;
// #define   OV7670_COM15_R00FF	 0xc0	 *	00 to FF
pub const OV7670_R41_COM16: c_uint = 0x41	/* Control 16 */;
pub const OV7670_COM16_AWBGAIN: c_uint = 0x08	/* AWB gain enable */;
// end of ov7660 common registers
pub const OV7670_R55_BRIGHT: c_uint = 0x55	/* Brightness */;
pub const OV7670_R56_CONTRAS: c_uint = 0x56	/* Contrast control */;
pub const OV7670_R69_GFIX: c_uint = 0x69	/* Fix gain control */;
// #define OV7670_R8C_RGB444	0x8c	 * RGB 444 control
pub const OV7670_R9F_HAECC1: c_uint = 0x9f	/* Hist AEC/AGC control 1 */;
pub const OV7670_RA0_HAECC2: c_uint = 0xa0	/* Hist AEC/AGC control 2 */;
pub const OV7670_RA5_BD50MAX: c_uint = 0xa5	/* 50hz banding step limit */;
pub const OV7670_RA6_HAECC3: c_uint = 0xa6	/* Hist AEC/AGC control 3 */;
pub const OV7670_RA7_HAECC4: c_uint = 0xa7	/* Hist AEC/AGC control 4 */;
pub const OV7670_RA8_HAECC5: c_uint = 0xa8	/* Hist AEC/AGC control 5 */;
pub const OV7670_RA9_HAECC6: c_uint = 0xa9	/* Hist AEC/AGC control 6 */;
pub const OV7670_RAA_HAECC7: c_uint = 0xaa	/* Hist AEC/AGC control 7 */;
pub const OV7670_RAB_BD60MAX: c_uint = 0xab	/* 60hz banding step limit */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov_regvals {
    pub reg: u8,
    pub val: u8,
}
...
#[no_mangle]
unsafe extern "C" fn ov7670_abs_to_sm(v: c_uchar) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn reg_w(sd: *mut sd, index: u16, value: u16) {
...
// Avoid things going to fast for the bridge with a xhci host
    ...
    value, index, core::ptr::null_mut(), 0, 500);
    goto leave;
    default:
    req = 1;
    }
...
#[no_mangle]
unsafe extern "C" fn reg_r(sd: *mut sd, index: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ov518_reg_w32(sd: *mut sd, index: u16, value: u32, n: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ov511_i2c_w(sd: *mut sd, reg: u8, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn ov511_i2c_r(sd: *mut sd, reg: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ov518_i2c_r(sd: *mut sd, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ovfx2_i2c_w(sd: *mut sd, reg: u8, value: u8) {
    ...
    0x02,
    USB_DIR_OUT | USB_TYPE_VENDOR | USB_RECIP_DEVICE,
    (u16) value, (u16) reg, core::ptr::null_mut(), 0, 500);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn ovfx2_i2c_r(sd: *mut sd, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_w(sd: *mut sd, reg: u8, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn i2c_r(sd: *mut sd, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ov51x_stop(sd: *mut sd) {
...
#[no_mangle]
pub unsafe extern "C" fn ov51x_restart(sd: *mut sd) {
...
//
#[no_mangle]
unsafe extern "C" fn init_ov_sensor(sd: *mut sd, slave: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov_hires_configure(sd: *mut sd) {
...
//
#[no_mangle]
unsafe extern "C" fn ov8xx0_configure(sd: *mut sd) {
...
//
#[no_mangle]
unsafe extern "C" fn ov7xx0_configure(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn ov6xx0_configure(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn ov51x_led_control(sd: *mut sd, on: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sd_reset_snapshot(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn ov51x_upload_quan_tables(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn ov511_configure(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn ov518_configure(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn ov519_configure(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn ovfx2_configure(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn ov519_set_mode(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn ov519_set_fr(sd: *mut sd) {
...
//
    ...
    fr = 0;
#[no_mangle]
pub unsafe extern "C" fn if(25: sd->frame_rate >=) -> else {
    else if (sd.frame_rate >= 25)
    fr = 1;
#[no_mangle]
pub unsafe extern "C" fn if(20: sd->frame_rate >=) -> else {
    else if (sd.frame_rate >= 20)
    fr = 2;
#[no_mangle]
pub unsafe extern "C" fn if(15: sd->frame_rate >=) -> else {
    else if (sd.frame_rate >= 15)
    fr = 3;
#[no_mangle]
pub unsafe extern "C" fn if(10: sd->frame_rate >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn sd_isoc_init(gspca_dev: *mut gspca_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ov511_mode_init_regs(sd: *mut sd) {
    static void ov511_mode_init_regs(struct sd *sd)
    {
    struct gspca_dev *gspca_dev = (struct gspca_dev *)sd;
    int hsegs, vsegs, packet_size, fps, needed;
    let mut interlaced: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn ov518_mode_init_regs(sd: *mut sd) {
...
//
#[no_mangle]
unsafe extern "C" fn ov519_mode_init_regs(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn mode_init_ov_sensor_regs(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn sethvflip(gspca_dev: *mut gspca_dev, hflip: i32, vflip: i32) {
...
#[no_mangle]
unsafe extern "C" fn set_ov_sensor_window(sd: *mut sd) {
...
#[no_mangle]
unsafe extern "C" fn sd_stop0(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn ov51x_handle_button(gspca_dev: *mut gspca_dev, state: u8) {
...
// The last few packets of the frame (which are all 0's
    ...
    numbered 0 */
#[no_mangle]
pub unsafe extern "C" fn if(data[len]: sd->packet_nr == 0 ||) -> else {
...
#[no_mangle]
unsafe extern "C" fn setautobright(gspca_dev: *mut gspca_dev, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn setfreq_i(sd: *mut sd, val: i32) {
...
#[no_mangle]
unsafe extern "C" fn sd_g_volatile_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
