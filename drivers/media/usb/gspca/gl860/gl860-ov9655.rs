...
//! Source: drivers/media/usb/gspca/gl860/gl860-ov9655.c
#![no_std]
...
// ==========================================================================
#[no_mangle]
pub unsafe extern "C" fn ov9655_init_settings(gspca_dev: *mut gspca_dev) {
...
// ==========================================================================
#[no_mangle]
unsafe extern "C" fn ov9655_init_at_startup(gspca_dev: *mut gspca_dev) -> c_int {
    static int ov9655_init_at_startup(struct gspca_dev *gspca_dev)
    {
...
#[no_mangle]
unsafe extern "C" fn ov9655_init_pre_alt(gspca_dev: *mut gspca_dev) -> c_int {
    static int ov9655_init_pre_alt(struct gspca_dev *gspca_dev)
    {
    struct sd *sd = (struct sd *) gspca_dev;
...
#[no_mangle]
unsafe extern "C" fn ov9655_init_post_alt(gspca_dev: *mut gspca_dev) -> c_int {
    static int ov9655_init_post_alt(struct gspca_dev *gspca_dev)
    {
...
#[no_mangle]
unsafe extern "C" fn ov9655_configure_alt(gspca_dev: *mut gspca_dev) -> c_int {
    static int ov9655_configure_alt(struct gspca_dev *gspca_dev)
    {
    let mut reso: i32 = gspca_dev.cam.cam_mode[(s32) gspca_dev.curr_mode].priv;
    switch (reso) {
...
#[no_mangle]
unsafe extern "C" fn ov9655_camera_settings(gspca_dev: *mut gspca_dev) -> c_int {
    static int ov9655_camera_settings(struct gspca_dev *gspca_dev)
    {
    struct sd *sd = (struct sd *) gspca_dev;
...
#[no_mangle]
unsafe extern "C" fn ov9655_post_unset_alt(gspca_dev: *mut gspca_dev) {
    static void ov9655_post_unset_alt(struct gspca_dev *gspca_dev)
    {
    ctrl_out(gspca_dev, 0x40, 5, 0x0000, 0x0000, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x0061, 0x0000, 0, core::ptr::null_mut());
    }
