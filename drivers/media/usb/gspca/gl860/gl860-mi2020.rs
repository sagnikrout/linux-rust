...
//! Source: drivers/media/usb/gspca/gl860/gl860-mi2020.c
#![no_std]
...
// ==========================================================================
#[no_mangle]
pub unsafe extern "C" fn mi2020_init_settings(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn mi2020_init_at_startup(gspca_dev: *mut gspca_dev) -> c_int {
    static int mi2020_init_at_startup(struct gspca_dev *gspca_dev)
    {
    u8 c;
    ...
    ctrl_out(gspca_dev, 0x40,  1, 0x7a00, 0x8030,  0, core::ptr::null_mut());
    ctrl_in(gspca_dev, 0xc0,  2, 0x7a00, 0x8030,  1, &c);
    common(gspca_dev);
    msleep(61);
// ctrl_out(gspca_dev, 0x40, 11, 0x0000, 0x0000,  0, NULL);
// msleep(36);
    ctrl_out(gspca_dev, 0x40,  1, 0x0001, 0x0000,  0, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mi2020_init_pre_alt(gspca_dev: *mut gspca_dev) -> c_int {
    static int mi2020_init_pre_alt(struct gspca_dev *gspca_dev)
    {
    struct sd *sd = (struct sd *) gspca_dev;
    sd.mirrorMask =  0;
...
#[no_mangle]
unsafe extern "C" fn mi2020_init_post_alt(gspca_dev: *mut gspca_dev) -> c_int {
    static int mi2020_init_post_alt(struct gspca_dev *gspca_dev)
    {
    struct sd *sd = (struct sd *) gspca_dev;
    ...
    common(gspca_dev);
    msleep(142);
    ctrl_out(gspca_dev, 0x40,  1, 0x0010, 0x0010,  0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40,  1, 0x0003, 0x00c1,  0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40,  1, 0x0042, 0x00c2,  0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40,  1, 0x006a, 0x000d,  0, core::ptr::null_mut());
    switch (reso) {
    case IMAGE_640:
    case IMAGE_800:
    if (reso != IMAGE_800)
    ...
    ctrl_out(gspca_dev, 0x40, 1, 0x0010, 0x0010, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x0000, 0x00c1, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x0041, 0x00c2, 0, core::ptr::null_mut());
    msleep(120);
    break;
    case IMAGE_1280:
    case IMAGE_1600:
    ...
    ctrl_out(gspca_dev, 0x40, 1, 0x0001, 0x0010, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x0000, 0x00c1, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x0041, 0x00c2, 0, core::ptr::null_mut());
    msleep(1850);
    }
    ctrl_out(gspca_dev, 0x40, 1, 0x0040, 0x0000, 0, core::ptr::null_mut());
    msleep(40);
// AC power frequency
...
#[no_mangle]
unsafe extern "C" fn mi2020_configure_alt(gspca_dev: *mut gspca_dev) -> c_int {
    static int mi2020_configure_alt(struct gspca_dev *gspca_dev)
    {
    let mut reso: i32 = gspca_dev.cam.cam_mode[(s32) gspca_dev.curr_mode].priv;
    switch (reso) {
...
#[no_mangle]
unsafe extern "C" fn mi2020_camera_settings(gspca_dev: *mut gspca_dev) -> c_int {
    static int mi2020_camera_settings(struct gspca_dev *gspca_dev)
    {
    struct sd *sd = (struct sd *) gspca_dev;
    let mut reso: i32 = gspca_dev.cam.cam_mode[(s32) gspca_dev.curr_mode].priv;
...
#[no_mangle]
unsafe extern "C" fn mi2020_post_unset_alt(gspca_dev: *mut gspca_dev) {
    static void mi2020_post_unset_alt(struct gspca_dev *gspca_dev)
    {
