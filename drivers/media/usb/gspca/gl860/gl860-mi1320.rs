...
//! Source: drivers/media/usb/gspca/gl860/gl860-mi1320.c
#![no_std]
...
// ==========================================================================
#[no_mangle]
pub unsafe extern "C" fn mi1320_init_settings(gspca_dev: *mut gspca_dev) {
...
unsafe extern "C" fn common(gspca_dev: *mut gspca_dev) {
    ...
    ctrl_out(gspca_dev, 0x40, 1, 0x0041, 0x0000, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mi1320_init_at_startup(gspca_dev: *mut gspca_dev) -> c_int {
    static int mi1320_init_at_startup(struct gspca_dev *gspca_dev)
    {
...
#[no_mangle]
unsafe extern "C" fn mi1320_init_pre_alt(gspca_dev: *mut gspca_dev) -> c_int {
    static int mi1320_init_pre_alt(struct gspca_dev *gspca_dev)
    {
    struct sd *sd = (struct sd *) gspca_dev;
    sd.mirrorMask = 0;
...
#[no_mangle]
unsafe extern "C" fn mi1320_init_post_alt(gspca_dev: *mut gspca_dev) -> c_int {
    static int mi1320_init_post_alt(struct gspca_dev *gspca_dev)
    {
...
#[no_mangle]
unsafe extern "C" fn mi1320_sensor_settings(gspca_dev: *mut gspca_dev) -> c_int {
    static int mi1320_sensor_settings(struct gspca_dev *gspca_dev)
    {
...
#[no_mangle]
unsafe extern "C" fn mi1320_configure_alt(gspca_dev: *mut gspca_dev) -> c_int {
    static int mi1320_configure_alt(struct gspca_dev *gspca_dev)
    {
    let mut reso: i32 = gspca_dev.cam.cam_mode[(s32) gspca_dev.curr_mode].priv;
    switch (reso) {
...
#[no_mangle]
unsafe extern "C" fn mi1320_camera_settings(gspca_dev: *mut gspca_dev) -> c_int {
    static int mi1320_camera_settings(struct gspca_dev *gspca_dev)
    {
    struct sd *sd = (struct sd *) gspca_dev;
    ...
    let mut freq: i32 = (sd.vcur.AC50Hz > 0);
    s32 i;
    if (freq != sd.vold.AC50Hz) {
    sd.vold.AC50Hz = freq;
    freq = 2 * (freq == 0);
    ctrl_out(gspca_dev, 0x40, 1, 0xba00, 0x00f0, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba02, 0x00f1, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba00       , 0x005b, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba01 + freq, 0x00f1, 0, core::ptr::null_mut());
    }
    ...
    0x0010, 0x0010, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1,
    0x0003, 0x00c1, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1,
    0x0042, 0x00c2, 0, core::ptr::null_mut());
    ...
    0x0010, 0x0010, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1,
    0x0004, 0x00c1, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1,
    0x0043, 0x00c2, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 3,
    ...
    ctrl_out(gspca_dev, 0x40, 1, 0xba00, 0x00f0, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba01, 0x00f1, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba00 + bright, 0x0034, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba00 + bright, 0x00f1, 0, core::ptr::null_mut());
    }
    ...
    ctrl_out(gspca_dev, 0x40, 1, 0xba00, 0x00f0, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba01, 0x00f1, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba00      , 0x0025, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba00 + sat, 0x00f1, 0, core::ptr::null_mut());
    }
    ...
    ctrl_out(gspca_dev, 0x40, 1, 0xba00, 0x00f0, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba01, 0x00f1, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba00        , 0x0005, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba00 + sharp, 0x00f1, 0, core::ptr::null_mut());
    }
    if (hue != sd.vold.hue) {
// 0=normal  1=NB  2="sepia"  3=negative  4=other  5=other2
    ...
    ctrl_out(gspca_dev, 0x40, 1, 0xba00, 0x00f0, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba01, 0x00f1, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba70, 0x00e2, 0, core::ptr::null_mut());
    ...
    ctrl_out(gspca_dev, 0x40, 1, 0xba00, 0x00f0, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba01, 0x00f1, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba74, 0x0006, 0, core::ptr::null_mut());
    ...
    ctrl_out(gspca_dev, 0x40, 1, 0xba00, 0x00f0, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba01, 0x00f1, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba04      , 0x003b, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0xba02 + gam, 0x00f1, 0, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn mi1320_post_unset_alt(gspca_dev: *mut gspca_dev) {
    static void mi1320_post_unset_alt(struct gspca_dev *gspca_dev)
    {
