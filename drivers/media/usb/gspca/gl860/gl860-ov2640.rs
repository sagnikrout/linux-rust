...
//! Source: drivers/media/usb/gspca/gl860/gl860-ov2640.c
#![no_std]
...
// ==========================================================================
#[no_mangle]
pub unsafe extern "C" fn ov2640_init_settings(gspca_dev: *mut gspca_dev) {
...
// ==========================================================================
#[no_mangle]
unsafe extern "C" fn common(gspca_dev: *mut gspca_dev) {
    static void common(struct gspca_dev *gspca_dev)
    {
    fetch_validx(gspca_dev, tbl_common, ARRAY_SIZE(tbl_common));
    }
#[no_mangle]
unsafe extern "C" fn ov2640_init_at_startup(gspca_dev: *mut gspca_dev) -> c_int {
    static int ov2640_init_at_startup(struct gspca_dev *gspca_dev)
    {
    ...
    ctrl_out(gspca_dev, 0x40, 1, 0x00ef, 0x0006, 0, core::ptr::null_mut());
    ctrl_in(gspca_dev, 0xc0, 2, 0x0000, 0x0000, 1, c51);
    ctrl_out(gspca_dev, 0x40, 1, 0x0051, 0x0000, 0, core::ptr::null_mut());
// ctrl_out(gspca_dev, 0x40, 11, 0x0000, 0x0000, 0, NULL);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ov2640_init_pre_alt(gspca_dev: *mut gspca_dev) -> c_int {
    static int ov2640_init_pre_alt(struct gspca_dev *gspca_dev)
    {
    struct sd *sd = (struct sd *) gspca_dev;
    sd.mirrorMask = 0;
...
#[no_mangle]
unsafe extern "C" fn ov2640_init_post_alt(gspca_dev: *mut gspca_dev) -> c_int {
    static int ov2640_init_post_alt(struct gspca_dev *gspca_dev)
    {
    let mut reso: i32 = gspca_dev.cam.cam_mode[(s32) gspca_dev.curr_mode].priv;
    s32 n; /* reserved for FETCH functions */
    ctrl_out(gspca_dev, 0x40, 5, 0x0001, 0x0000, 0, core::ptr::null_mut());
    ...
    ctrl_out(gspca_dev, 0x40, 1, 0x601d, 0x0086, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6001, 0x00d7, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6082, 0x00d3, 0, core::ptr::null_mut());
    }
    n = fetch_validx(gspca_dev, tbl_big3, ARRAY_SIZE(tbl_big3));
    if (reso == IMAGE_1280) {
    ctrl_out(gspca_dev, 0x40, 1, 0x6001, 0x00ff, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 3, 0x0000, 0x0200,
    12, dat_1280);
    } else {
    ctrl_out(gspca_dev, 0x40, 1, 0x6020, 0x008c, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6001, 0x00ff, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6076, 0x0018, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 3, 0x0000, 0x0200,
    12, dat_1600);
    }
    break;
...
#[no_mangle]
unsafe extern "C" fn ov2640_configure_alt(gspca_dev: *mut gspca_dev) -> c_int {
    static int ov2640_configure_alt(struct gspca_dev *gspca_dev)
    {
    let mut reso: i32 = gspca_dev.cam.cam_mode[(s32) gspca_dev.curr_mode].priv;
    switch (reso) {
...
#[no_mangle]
unsafe extern "C" fn ov2640_camera_settings(gspca_dev: *mut gspca_dev) -> c_int {
    static int ov2640_camera_settings(struct gspca_dev *gspca_dev)
    {
    struct sd *sd = (struct sd *) gspca_dev;
    let mut backlight: i32 = sd.vcur.backlight;
    let mut bright: i32 = sd.vcur.brightness;
    let mut sharp: i32 = sd.vcur.sharpness;
    let mut gam: i32 = sd.vcur.gamma;
    let mut cntr: i32 = sd.vcur.contrast;
    let mut sat: i32 = sd.vcur.saturation;
    let mut hue: i32 = sd.vcur.hue;
    let mut wbal: i32 = sd.vcur.whitebal;
    let mut mirror: i32 = (((sd.vcur.mirror > 0) ^ sd.mirrorMask) == 0);
    let mut flip: i32 = (((sd.vcur.flip   > 0) ^ sd.mirrorMask) == 0);
...
// No sd->vold.backlight=backlight; (to be done again later)
    ...
    bright = 0;
    ctrl_out(gspca_dev, 0x40, 1, 0x6000         , 0x00ff, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6009         , 0x007c, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6000 + bright, 0x007d, 0, core::ptr::null_mut());
    }
    ...
    wbal = 0;
    ctrl_out(gspca_dev, 0x40, 1, 0x6000       , 0x00ff, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6003       , 0x007c, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6000 + wbal, 0x007d, 0, core::ptr::null_mut());
    }
    ...
    cntr = 0;
    ctrl_out(gspca_dev, 0x40, 1, 0x6000       , 0x00ff, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6007       , 0x007c, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6000 + cntr, 0x007d, 0, core::ptr::null_mut());
    }
    ...
    sat = 0;
    ctrl_out(gspca_dev, 0x40, 1, 0x6000      , 0x00ff, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6001      , 0x007c, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6000 + sat, 0x007d, 0, core::ptr::null_mut());
    }
    ...
    sharp = 0;
    ctrl_out(gspca_dev, 0x40, 1, 0x6000        , 0x00ff, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6001        , 0x0092, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x60c0 + sharp, 0x0093, 0, core::ptr::null_mut());
    }
    if (hue != sd.vold.hue) {
    sd.vold.hue = hue;
    ...
    hue = 0;
    ctrl_out(gspca_dev, 0x40, 1, 0x6000     , 0x00ff, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6002     , 0x007c, 0, core::ptr::null_mut());
    ...
    gam = 0;
    ctrl_out(gspca_dev, 0x40, 1, 0x6000      , 0x00ff, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6008      , 0x007c, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6000 + gam, 0x007d, 0, core::ptr::null_mut());
    }
    ...
    mirror = 0x80 * mirror;
    ctrl_out(gspca_dev, 0x40, 1, 0x6001, 0x00ff, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6000, 0x8004, 0, core::ptr::null_mut());
    ctrl_in(gspca_dev, 0xc0, 2, 0x6000, 0x8004, 1, c28);
    ctrl_out(gspca_dev, 0x40, 1, 0x6028 + mirror, 0x0004, 0, core::ptr::null_mut());
    flip = 0x50 * flip + mirror;
    ctrl_out(gspca_dev, 0x40, 1, 0x6001, 0x00ff, 0, core::ptr::null_mut());
    ctrl_out(gspca_dev, 0x40, 1, 0x6000, 0x8004, 0, core::ptr::null_mut());
    ctrl_in(gspca_dev, 0xc0, 2, 0x6000, 0x8004, 1, ca8);
    ctrl_out(gspca_dev, 0x40, 1, 0x6028 + flip, 0x0004, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ov2640_post_unset_alt(gspca_dev: *mut gspca_dev) {
    static void ov2640_post_unset_alt(struct gspca_dev *gspca_dev)
    {
    ctrl_out(gspca_dev, 0x40, 5, 0x0000, 0x0000, 0, core::ptr::null_mut());
    msleep(20);
