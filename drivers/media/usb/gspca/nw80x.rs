...
//! Source: drivers/media/usb/gspca/nw80x.c
#![no_std]
...
pub const AG_CNT_START: c_int = 13;
    pub exp_too_low_cnt: u8,
    pub exp_too_high_cnt: u8,
    pub bridge: u8,
    pub webcam: u8,
}
...
#[no_mangle]
unsafe extern "C" fn swap_bits(v: c_int) -> c_int {
