...
//! Source: drivers/media/usb/gspca/pac7302.c
#![no_std]
...
pub const PAC7302_RGB_BALANCE_MIN: c_int = 0;
pub const PAC7302_RGB_BALANCE_MAX: c_int = 200;
pub const PAC7302_RGB_BALANCE_DEFAULT: c_int = 100;
pub const PAC7302_GAIN_DEFAULT: c_int = 15;
pub const PAC7302_GAIN_KNEE: c_int = 42;
...
pub struct sd {
    ...
    u8 flags;
pub const FL_HFLIP: c_uint = 0x01		/* mirrored by default */;
pub const FL_VFLIP: c_uint = 0x02		/* vertical flipped by default */;
    u8 sof_read;
...
pub const LOAD_PAGE3: c_int = 255;
pub const END_OF_SEQUENCE: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn setbrightcont(gspca_dev: *mut gspca_dev) {
...
// 150 / (s32)sd->brightness->maximum; /* 200 ?
    ...
    v = 0;
#[no_mangle]
pub unsafe extern "C" fn if(0xff: v >) -> else {
    else if (v > 0xff)
    v = 0xff;
...
#[no_mangle]
unsafe extern "C" fn setcolors(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn setwhitebalance(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn rgbbalance_ctrl_to_reg_value(rgb_ctrl_val: i32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn setredbalance(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn setbluebalance(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn setgain(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn setexposure(gspca_dev: *mut gspca_dev) {
...
//
    ...
    clockdiv = 6;
#[no_mangle]
pub unsafe extern "C" fn if(63: clockdiv >) -> else {
    else if (clockdiv > 63)
    clockdiv = 63;
//
...
#[no_mangle]
unsafe extern "C" fn sethvflip(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn setsharpness(gspca_dev: *mut gspca_dev) {
