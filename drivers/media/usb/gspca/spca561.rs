...
//! Source: drivers/media/usb/gspca/spca561.c
#![no_std]
...
pub const EXPO12A_DEF: c_int = 3;
    __u8 expo12a;		/* expo/gain? for rev 12a */
    __u8 chip_revision;
pub const Rev012A: c_int = 0;
pub const Rev072A: c_int = 1;
    signed char ag_cnt;
...
pub const SPCA561_OFFSET_SNAP: c_int = 1;
pub const SPCA561_OFFSET_TYPE: c_int = 2;
pub const SPCA561_OFFSET_COMPRESS: c_int = 3;
pub const SPCA561_OFFSET_FRAMSEQ: c_int = 4;
pub const SPCA561_OFFSET_GPIO: c_int = 5;
pub const SPCA561_OFFSET_USBBUFF: c_int = 6;
pub const SPCA561_OFFSET_WIN2GRAVE: c_int = 7;
pub const SPCA561_OFFSET_WIN2RAVE: c_int = 8;
pub const SPCA561_OFFSET_WIN2BAVE: c_int = 9;
pub const SPCA561_OFFSET_WIN2GBAVE: c_int = 10;
pub const SPCA561_OFFSET_WIN1GRAVE: c_int = 11;
pub const SPCA561_OFFSET_WIN1RAVE: c_int = 12;
pub const SPCA561_OFFSET_WIN1BAVE: c_int = 13;
pub const SPCA561_OFFSET_WIN1GBAVE: c_int = 14;
pub const SPCA561_OFFSET_FREQ: c_int = 15;
pub const SPCA561_OFFSET_VSYNC: c_int = 16;
pub const SPCA561_INDEX_I2C_BASE: c_uint = 0x8800;
pub const SPCA561_SNAPBIT: c_uint = 0x20;
pub const SPCA561_SNAPCTRL: c_uint = 0x40;
...
#[no_mangle]
unsafe extern "C" fn reg_w_val(gspca_dev: *mut gspca_dev, index: __u16, value: __u8) {
...
#[no_mangle]
unsafe extern "C" fn i2c_write(gspca_dev: *mut gspca_dev, value: __u16, reg: __u16) {
    static void i2c_write(struct gspca_dev *gspca_dev, __u16 value, __u16 reg)
    {
    let mut retry: c_int = 60;
...
#[no_mangle]
unsafe extern "C" fn i2c_read(gspca_dev: *mut gspca_dev, reg: __u16, mode: __u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __u16(_arg: *mut sensormap)[2]) -> const {
...
#[no_mangle]
pub unsafe extern "C" fn __u16(_arg: *mut sensor)[2]) -> const {
...
#[no_mangle]
unsafe extern "C" fn init_161rev12A(gspca_dev: *mut gspca_dev) {
...
#[no_mangle]
unsafe extern "C" fn sd_init_12a(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_init_72a(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setwhite(gspca_dev: *mut gspca_dev, white: i32, contrast: i32) {
...
#[no_mangle]
pub unsafe extern "C" fn if(128: val <) -> else {
    else if (val < 128)
...
#[no_mangle]
unsafe extern "C" fn sd_start_12a(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_start_72a(gspca_dev: *mut gspca_dev) -> c_int {
...
// v= (128*R-(53*(Gr+Gb))-21*B) >> 8;
    ...
    gainG = 0x3f;
#[no_mangle]
pub unsafe extern "C" fn if(3: gainG <) -> else {
    else if (gainG < 3)
    gainG = 3;
    ...
    expotimes = 0x0256;
#[no_mangle]
pub unsafe extern "C" fn if(3: expotimes <) -> else {
    else if (expotimes < 3)
    expotimes = 3;
...
#[no_mangle]
unsafe extern "C" fn sd_init_controls_12a(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_init_controls_72a(gspca_dev: *mut gspca_dev) -> c_int {
