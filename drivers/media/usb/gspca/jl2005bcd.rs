...
//! Source: drivers/media/usb/gspca/jl2005bcd.c
#![no_std]
...
pub const JL2005C_CMD_TIMEOUT: c_int = 500;
pub const JL2005C_DATA_TIMEOUT: c_int = 1000;
// Maximum transfer size to use.
pub const JL2005C_MAX_TRANSFER: c_uint = 0x200;
pub const FRAME_HEADER_LEN: c_int = 16;
// specific webcam descriptor
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sd {
    pub /: *mut *mut gspca_dev gspca_dev; / !! must be the first item,
    pub firmware_id: [c_uchar; 6],
    pub cap_mode: *const v4l2_pix_format,
// Driver stuff
    pub work_struct: work_struct,
    pub frame_brightness: u8,
    pub /: *mut *mut int block_size; / block size of camera,
    pub /: *mut *mut int vga; / 1 if vga cam, 0 if cif cam,
}
...
#[no_mangle]
unsafe extern "C" fn jl2005c_write2(gspca_dev: *mut gspca_dev, command: *mut c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jl2005c_read1(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jl2005c_read_reg(gspca_dev: *mut gspca_dev, reg: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jl2005c_start_new_frame(gspca_dev: *mut gspca_dev) -> c_int {
    static int jl2005c_start_new_frame(struct gspca_dev *gspca_dev)
    {
    int i;
    int retval;
    let mut frame_brightness: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn jl2005c_get_firmware_id(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jl2005c_stream_start_vga_small(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jl2005c_stream_start_cif_lg(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jl2005c_stream_start_cif_small(gspca_dev: *mut gspca_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jl2005c_stop(gspca_dev: *mut gspca_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn jl2005c_dostream(work: *mut work_struct) {
