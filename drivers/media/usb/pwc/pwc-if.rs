...
//! Source: drivers/media/usb/pwc/pwc-if.c
#![no_std]
...
pub const MAX_DEV_HINTS: c_int = 20;
pub const MAX_ISOC_ERRORS: c_int = 20;

    let mut pwc_trace: c_int = PWC_DEBUG_LEVEL;

    let mut power_save: static int = -1;
...
// dma_handle = dma_map_single(dmadev, buffer, size, DMA_FROM_DEVICE);
    ...
    struct pwc_frame_buf *buf = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pwc_snapshot_button(pdev: *mut pwc_device, down: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pwc_frame_complete(pdev: *mut pwc_device) {
...
// Check for underflow first
    ...
    pdev.fill_buf = core::ptr::null_mut();
    pdev.vsync = 0;
    }
    } /* !drop_frames */
    pdev.vframe_count++;
...
//
#[no_mangle]
unsafe extern "C" fn pwc_isoc_handler(urb: *mut urb) {
    ...
    if (pdev.fill_buf == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn pwc_isoc_init(pdev: *mut pwc_device) -> c_int {
    ...
    struct usb_host_interface *idesc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pwc_iso_stop(pdev: *mut pwc_device) {
...
#[no_mangle]
unsafe extern "C" fn pwc_iso_free(pdev: *mut pwc_device) {
...
// Freeing ISOC buffers one by one
    ...
    urb.transfer_dma);
    usb_free_urb(urb);
    pdev.urbs[i] = core::ptr::null_mut();
    }
    }
    }
// Both v4l2_lock and vb_queue_lock should be locked when calling this
#[no_mangle]
unsafe extern "C" fn pwc_isoc_cleanup(pdev: *mut pwc_device) {
    static void pwc_isoc_cleanup(struct pwc_device *pdev)
    {
...
#[no_mangle]
unsafe extern "C" fn pwc_video_release(v: *mut v4l2_device) {
...
// nbuffers = MIN_FRAMES;
#[no_mangle]
pub unsafe extern "C" fn if(MAX_FRAMES: *mut *mut nbuffers >) -> else {
...
#[no_mangle]
unsafe extern "C" fn buffer_init(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn buffer_cleanup(vb: *mut vb2_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn usb_pwc_probe(intf: *mut usb_interface, id: *const usb_device_id) -> c_int {
    static int usb_pwc_probe(struct usb_interface *intf, const struct usb_device_id *id)
    {
    struct usb_device *udev = interface_to_usbdev(intf);
    struct pwc_device *pdev = core::ptr::null_mut();
    int vendor_id, product_id, type_id;
    int rc;
    let mut features: c_int = 0;
    let mut compression: c_int = 0;
    let mut my_power_save: c_int = power_save;
...
#[no_mangle]
pub unsafe extern "C" fn if(0x069A: vendor_id ==) -> else {
    switch(product_id) {
    case 0x0001:
...
#[no_mangle]
pub unsafe extern "C" fn if(0x046d: vendor_id ==) -> else {
    switch(product_id) {
    case 0x08b0:
...
#[no_mangle]
pub unsafe extern "C" fn if(0x055d: vendor_id ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x041e: vendor_id ==) -> else {
    switch(product_id) {
    case 0x400c:
...
#[no_mangle]
pub unsafe extern "C" fn if(0x04cc: vendor_id ==) -> else {
    switch(product_id) {
    case 0x8116:
...
#[no_mangle]
pub unsafe extern "C" fn if(0x06be: vendor_id ==) -> else {
    switch(product_id) {
    case 0x8116:
...
#[no_mangle]
pub unsafe extern "C" fn if(0x0d81: vendor_id ==) -> else {
    switch(product_id) {
    case 0x1900:
...
// register webcam snapshot button input device
    ...
    pdev.button_dev = core::ptr::null_mut();
    goto err_video_unreg;
    }
...
#[no_mangle]
unsafe extern "C" fn usb_pwc_disconnect(intf: *mut usb_interface) {
    static void usb_pwc_disconnect(struct usb_interface *intf)
    {
