...
//! Source: drivers/media/usb/pwc/pwc-v4l.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn pwc_init_controls(pdev: *mut pwc_device) -> c_int {
...
// auto white balance, red gain, blue gain
    ...
    cfg.def = def;
    pdev.auto_white_balance = v4l2_ctrl_new_custom(hdl, &cfg, core::ptr::null_mut());
...
// autocontour, contour
    ...
    cfg.def = def == 0;
    pdev.autocontour = v4l2_ctrl_new_custom(hdl, &cfg, core::ptr::null_mut());
    if (!pdev.autocontour)
    return hdl.error;
    ...
    cfg = pwc_contour_cfg;
    cfg.def = def;
    pdev.contour = v4l2_ctrl_new_custom(hdl, &cfg, core::ptr::null_mut());
...
// backlight
    ...
    cfg.name = v4l2_ctrl_get_name(cfg.id);
    cfg.def = def == 0;
    pdev.backlight = v4l2_ctrl_new_custom(hdl, &cfg, core::ptr::null_mut());
// flikker rediction
    r = pwc_get_u8_ctrl(pdev, GET_LUM_CTL,
    ...
    cfg.name = v4l2_ctrl_get_name(cfg.id);
    cfg.def = def == 0;
    pdev.flicker = v4l2_ctrl_new_custom(hdl, &cfg, core::ptr::null_mut());
// Dynamic noise reduction
    ...
    cfg.def = def;
    pdev.noise_reduction = v4l2_ctrl_new_custom(hdl, &cfg, core::ptr::null_mut());
// Save / Restore User / Factory Settings
    pdev.save_user = v4l2_ctrl_new_custom(hdl, &pwc_save_user_cfg, core::ptr::null_mut());
...
// Auto White Balance speed & delay
    ...
    cfg.def = def;
    pdev.awb_speed = v4l2_ctrl_new_custom(hdl, &cfg, core::ptr::null_mut());
    r = pwc_get_u8_ctrl(pdev, GET_CHROM_CTL,
    ...
    cfg.def = def;
    pdev.awb_delay = v4l2_ctrl_new_custom(hdl, &cfg, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn pwc_vidioc_try_fmt(pdev: *mut pwc_device, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwc_s_fmt_vid_cap(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwc_querycap(file: *mut file, fh: *mut c_void, cap: *mut v4l2_capability) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwc_enum_input(file: *mut file, fh: *mut c_void, i: *mut v4l2_input) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwc_g_input(file: *mut file, fh: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwc_s_input(file: *mut file, fh: *mut c_void, i: c_uint) -> c_int {
    static int pwc_s_input(struct file *file, void *fh, unsigned int i)
    {
    return i ? -EINVAL : 0;
    }
#[no_mangle]
unsafe extern "C" fn pwc_g_volatile_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    static int pwc_g_volatile_ctrl(struct v4l2_ctrl *ctrl)
    {
...
#[no_mangle]
unsafe extern "C" fn pwc_set_awb(pdev: *mut pwc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwc_set_autogain(pdev: *mut pwc_device) -> c_int {
...
// For CODEC2 models which have separate autogain and auto exposure
#[no_mangle]
unsafe extern "C" fn pwc_set_exposure_auto(pdev: *mut pwc_device) -> c_int {
    static int pwc_set_exposure_auto(struct pwc_device *pdev)
    {
    int ret;
    let mut is_auto: c_int = pdev.exposure_auto.val == V4L2_EXPOSURE_AUTO;
...
#[no_mangle]
unsafe extern "C" fn pwc_set_autogain_expo(pdev: *mut pwc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwc_set_motor(pdev: *mut pwc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwc_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    static int pwc_s_ctrl(struct v4l2_ctrl *ctrl)
    {
    struct pwc_device *pdev =
    container_of(ctrl.handler, struct pwc_device, ctrl_handler);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: DEVICE_USE_CODEC3(pdev->type)) -> else {
    else if (DEVICE_USE_CODEC3(pdev.type))
...
#[no_mangle]
unsafe extern "C" fn pwc_enum_fmt_vid_cap(file: *mut file, fh: *mut c_void, f: *mut v4l2_fmtdesc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwc_g_fmt_vid_cap(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwc_try_fmt_vid_cap(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
    ...
    {
    struct pwc_device *pdev = video_drvdata(file);
    let mut i: c_uint = 0, index = fsize.index;
