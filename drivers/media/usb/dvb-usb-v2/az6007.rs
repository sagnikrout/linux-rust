...
//! Source: drivers/media/usb/dvb-usb-v2/az6007.c
#![no_std]
...
pub const FX2_OED: c_uint = 0xb5;
pub const AZ6007_READ_DATA: c_uint = 0xb7;
pub const AZ6007_I2C_RD: c_uint = 0xb9;
pub const AZ6007_POWER: c_uint = 0xbc;
pub const AZ6007_I2C_WR: c_uint = 0xbd;
pub const FX2_SCON1: c_uint = 0xc0;
pub const AZ6007_TS_THROUGH: c_uint = 0xc7;
pub const AZ6007_READ_IR: c_uint = 0xb4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct az6007_device_state {
    pub mutex: mutex,
    pub ca_mutex: mutex,
    pub ca: dvb_ca_en50221,
    pub warm:1: unsigned,
    pub int): *mut *mut *mut int (gate_ctrl) (struct dvb_frontend ,,
    pub data: [c_uchar; 4096],
}
...
#[no_mangle]
unsafe extern "C" fn az6007_streaming_ctrl(fe: *mut dvb_frontend, onoff: c_int) -> c_int {
    static int az6007_streaming_ctrl(struct dvb_frontend *fe, int onoff)
    {
    struct dvb_usb_device *d = fe_to_d(fe);
    pr_debug("%s: %s\n", __func__, onoff ? "enable" : "disable");
    return az6007_write(d, 0xbc, onoff, 0, core::ptr::null_mut(), 0);
    }

// remote control stuff (does not work with my box)
#[no_mangle]
unsafe extern "C" fn az6007_rc_query(d: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn az6007_get_rc_config(d: *mut dvb_usb_device, rc: *mut dvb_usb_rc) -> c_int {
    ...
    index = value;
    blen = 0;
    ret = az6007_write(d, req, value1, index, core::ptr::null_mut(), blen);
    if (ret != 0)
...
#[no_mangle]
unsafe extern "C" fn CI_CamReady(ca: *mut dvb_ca_en50221, slot: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn az6007_ci_slot_reset(ca: *mut dvb_ca_en50221, slot: c_int) -> c_int {
    ...
    index = 0;
    blen = 0;
    ret = az6007_write(d, req, value, index, core::ptr::null_mut(), blen);
    if (ret != 0) {
    pr_warn("usb out operation failed. (%d)\n", ret);
    goto failed;
    }
...
#[no_mangle]
unsafe extern "C" fn az6007_ci_slot_shutdown(ca: *mut dvb_ca_en50221, slot: c_int) -> c_int {
    static int az6007_ci_slot_shutdown(struct dvb_ca_en50221 *ca, int slot)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn az6007_ci_slot_ts_enable(ca: *mut dvb_ca_en50221, slot: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn az6007_ci_poll_slot_status(ca: *mut dvb_ca_en50221, slot: c_int, open: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn az6007_ci_uninit(d: *mut dvb_usb_device) {
    static void az6007_ci_uninit(struct dvb_usb_device *d)
    {
    struct az6007_device_state *state;
    pr_debug("%s()\n", __func__);
    if (core::ptr::null_mut() == d)
    return;
    state = d_to_priv(d);
    if (core::ptr::null_mut() == state)
    return;
    if (core::ptr::null_mut() == state.ca.data)
    return;
    dvb_ca_en50221_release(&state.ca);
    memset(&state.ca, 0, sizeof(state.ca));
    }
#[no_mangle]
unsafe extern "C" fn az6007_ci_init(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn az6007_read_mac_addr(adap: *mut dvb_usb_adapter, mac[6]: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn az6007_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn az6007_cablestar_hdci_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn az6007_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn az6007_power_ctrl(d: *mut dvb_usb_device, onoff: c_int) -> c_int {
    ...
    ret = az6007_write(d, AZ6007_POWER, 0, 2, core::ptr::null_mut(), 0);
    if (ret < 0)
    return ret;
    msleep(60);
    ret = az6007_write(d, AZ6007_POWER, 1, 4, core::ptr::null_mut(), 0);
    if (ret < 0)
    return ret;
    msleep(100);
    ret = az6007_write(d, AZ6007_POWER, 1, 3, core::ptr::null_mut(), 0);
    if (ret < 0)
    return ret;
    msleep(20);
    ret = az6007_write(d, AZ6007_POWER, 1, 4, core::ptr::null_mut(), 0);
    ...
    return ret;
    msleep(400);
    ret = az6007_write(d, FX2_SCON1, 0, 3, core::ptr::null_mut(), 0);
    if (ret < 0)
    return ret;
    msleep(150);
    ret = az6007_write(d, FX2_SCON1, 1, 3, core::ptr::null_mut(), 0);
    if (ret < 0)
    return ret;
    msleep(430);
    ret = az6007_write(d, AZ6007_POWER, 0, 0, core::ptr::null_mut(), 0);
    if (ret < 0)
    return ret;
    state.warm = true;
    return 0;
    ...
    if (!onoff)
    return 0;
    az6007_write(d, AZ6007_POWER, 0, 0, core::ptr::null_mut(), 0);
    az6007_write(d, AZ6007_TS_THROUGH, 0, 0, core::ptr::null_mut(), 0);
    return 0;
    }
// I2C
...
#[no_mangle]
unsafe extern "C" fn az6007_i2c_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn az6007_identify_state(d: *mut dvb_usb_device, name: *const c_char) -> c_int {
...
// Try to read the mac address
    ...
    kfree(mac);
    if (ret == COLD) {
    __az6007_write(d.udev, 0x09, 1, 0, core::ptr::null_mut(), 0);
    __az6007_write(d.udev, 0x00, 0, 0, core::ptr::null_mut(), 0);
    __az6007_write(d.udev, 0x00, 0, 0, core::ptr::null_mut(), 0);
    }
...
#[no_mangle]
unsafe extern "C" fn az6007_usb_disconnect(intf: *mut usb_interface) {
...
// ditch get_rc_config as it can't work (TS35 remote, I believe it's rc5)
    .get_rc_config       = core::ptr::null_mut(),
    .read_mac_address    = az6007_read_mac_addr,
    .download_firmware   = az6007_download_firmware,
    .identify_state	     = az6007_identify_state,
    .power_ctrl          = az6007_power_ctrl,
...
#[no_mangle]
unsafe extern "C" fn az6007_suspend(intf: *mut usb_interface, msg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn az6007_resume(intf: *mut usb_interface) -> c_int {
