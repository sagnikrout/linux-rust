...
//! Source: drivers/media/usb/dvb-usb-v2/dvb_usb_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_i2c_init(d: *mut dvb_usb_device) -> c_int {
    ...
    if (ret < 0) {
    d.i2c_adap.algo = core::ptr::null_mut();
    goto err;
    }
    return 0;
    err:
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_i2c_exit(d: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_usb_read_remote_control(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_remote_init(d: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_remote_exit(d: *mut dvb_usb_device) -> c_int {
    ...
    d.rc_dev = core::ptr::null_mut();
    }
    return 0;
    }

pub const dvb_usbv2_remote_init(args...): c_int = 0;
// Macro flag: #define dvb_usbv2_remote_exit(args...)
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_adapter_stream_init(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_adapter_stream_exit(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_media_device_init(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_media_device_register(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_media_device_unregister(adap: *mut dvb_usb_adapter) {
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_adapter_dvb_init(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    adap.dvb_adap.priv = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_adapter_dvb_exit(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_device_power_ctrl(d: *mut dvb_usb_device, onoff: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_usb_fe_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_adapter_frontend_init(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_adapter_frontend_exit(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_adapter_init(d: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_adapter_exit(d: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_exit(d: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_init(d: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_usbv2_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_usbv2_suspend(intf: *mut usb_interface, msg: pm_message_t) -> c_int {
    int dvb_usbv2_suspend(struct usb_interface *intf, pm_message_t msg)
    {
    struct dvb_usb_device *d = usb_get_intfdata(intf);
    let mut ret: c_int = 0, i, active_fe;
...
#[no_mangle]
unsafe extern "C" fn dvb_usbv2_resume_common(d: *mut dvb_usb_device) -> c_int {
...
// resume usb streaming
    usb_urb_submitv2(&d.adapter[i].stream, core::ptr::null_mut());
    if (d.props.streaming_ctrl)
...
#[no_mangle]
pub unsafe extern "C" fn dvb_usbv2_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_usbv2_reset_resume(intf: *mut usb_interface) -> c_int {
