...
//! Source: drivers/media/usb/dvb-usb-v2/dvbsky.c
#![no_std]
...
pub const DVBSKY_BUF_LEN: c_int = 64;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dvbsky_state {
    pub ibuf: [u8; DVBSKY_BUF_LEN],
    pub obuf: [u8; DVBSKY_BUF_LEN],
    pub last_lock: u8,
...
#[no_mangle]
unsafe extern "C" fn dvbsky_stream_ctrl(d: *mut dvb_usb_device, onoff: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvbsky_streaming_ctrl(fe: *mut dvb_frontend, onoff: c_int) -> c_int {
...
// GPIO
#[no_mangle]
unsafe extern "C" fn dvbsky_gpio_ctrl(d: *mut dvb_usb_device, gport: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvbsky_i2c_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn dvbsky_rc_query(d: *mut dvb_usb_device) -> c_int {
    static int dvbsky_rc_query(struct dvb_usb_device *d)
    {
    let mut code: u32 = 0xffff, scancode;
...
#[no_mangle]
unsafe extern "C" fn dvbsky_get_rc_config(d: *mut dvb_usb_device, rc: *mut dvb_usb_rc) -> c_int {
    static int dvbsky_get_rc_config(struct dvb_usb_device *d, struct dvb_usb_rc *rc)
    {
    if (dvb_usb_dvbsky_disable_rc) {
    rc.map_name = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn dvbsky_read_mac_addr(adap: *mut dvb_usb_adapter, mac[6]: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvbsky_s960_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
// attach demod
    ...
    state.i2c_client_demod = dvb_module_probe("m88ds3103", core::ptr::null_mut(),
    &d.i2c_adap,
...
// attach tuner
    ...
    state.i2c_client_tuner = dvb_module_probe("ts2020", core::ptr::null_mut(),
    i2c_adapter,
    0x60, &ts2020_config);
...
#[no_mangle]
unsafe extern "C" fn dvbsky_s960c_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
// attach ci controller
    ...
    state.i2c_client_ci = dvb_module_probe("sp2", core::ptr::null_mut(),
    &d.i2c_adap,
    0x40, &sp2_config);
...
#[no_mangle]
unsafe extern "C" fn dvbsky_t680c_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
// attach demod
    ...
    state.i2c_client_demod = dvb_module_probe("si2168", core::ptr::null_mut(),
    &d.i2c_adap,
    0x64, &si2168_config);
    if (!state.i2c_client_demod)
    return -ENODEV;
// attach tuner
    ...
    state.i2c_client_tuner = dvb_module_probe("si2157", core::ptr::null_mut(),
    i2c_adapter,
    0x60, &si2157_config);
    if (!state.i2c_client_tuner) {
    dvb_module_release(state.i2c_client_demod);
...
#[no_mangle]
unsafe extern "C" fn dvbsky_t330_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvbsky_mygica_t230c_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvbsky_identify_state(d: *mut dvb_usb_device, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvbsky_init(d: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvbsky_frontend_detach(adap: *mut dvb_usb_adapter) -> c_int {
