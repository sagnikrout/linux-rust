...
//! Source: drivers/media/usb/dvb-usb-v2/gl861.c
#![no_std]
...
// USB control message buffer
    pub buf: [u8; 16],
    pub demod_sub_i2c: *mut i2c_adapter,
    pub i2c_client_demod: *mut i2c_client,
    pub i2c_client_tuner: *mut i2c_client,
}

pub const CMD_WRITE_SHORT: c_uint = 0x01;
pub const CMD_READ: c_uint = 0x02;
pub const CMD_WRITE: c_uint = 0x03;
...
#[no_mangle]
unsafe extern "C" fn gl861_short_write(d: *mut dvb_usb_device, addr: u8, reg: u8, val: u8) -> c_int {
    static int gl861_short_write(struct dvb_usb_device *d, u8 addr, u8 reg, u8 val)
    {
    return gl861_ctrl_msg(d, CMD_WRITE_SHORT,
    (addr << 9) | val, reg, core::ptr::null_mut(), 0);
    }
...
#[no_mangle]
unsafe extern "C" fn gl861_i2c_functionality(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gl861_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
    static int gl861_frontend_attach(struct dvb_usb_adapter *adap)
    {
    adap.fe[0] = dvb_attach(zl10353_attach, &gl861_zl10353_config,
    &adap_to_d(adap).i2c_adap);
    if (adap.fe[0] == core::ptr::null_mut())
    return -EIO;
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn gl861_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
    static int gl861_tuner_attach(struct dvb_usb_adapter *adap)
    {
    return dvb_attach(qt1010_attach,
    adap.fe[0], &adap_to_d(adap).i2c_adap,
    &gl861_qt1010_config) == core::ptr::null_mut() ? -ENODEV : 0;
    }
#[no_mangle]
unsafe extern "C" fn gl861_init(d: *mut dvb_usb_device) -> c_int {
...
pub const FRIIO_LED_RUNNING: c_uint = 0x6400ff64;
pub const FRIIO_LED_STOPPED: c_uint = 0x96ff00ff;
// control PIC16F676 attached to Friio
    ...
    u8 *buf;
    u32 mask;
    let mut power: u8 = (power_on) ? FRIIO_CTL_LNB : 0;
...
//
#[no_mangle]
unsafe extern "C" fn friio_reset(d: *mut dvb_usb_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn friio_power_ctrl(d: *mut dvb_usb_device, onoff: c_int) -> c_int {
    static int friio_power_ctrl(struct dvb_usb_device *d, int onoff)
    {
    return onoff ? friio_reset(d) : 0;
    }
#[no_mangle]
unsafe extern "C" fn friio_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn friio_frontend_detach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn friio_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn friio_tuner_detach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn friio_init(d: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn friio_exit(d: *mut dvb_usb_device) {
    static void friio_exit(struct dvb_usb_device *d)
    {
    friio_ext_ctl(d, FRIIO_LED_STOPPED, false);
    }
#[no_mangle]
unsafe extern "C" fn friio_streaming_ctrl(fe: *mut dvb_frontend, onoff: c_int) -> c_int {
    ...
    &gl861_props, "MSI Mega Sky 55801 DVB-T USB2.0", core::ptr::null_mut()) },
    { DVB_USB_DEVICE(USB_VID_ALINK, USB_PID_ALINK_DTU,
    &gl861_props, "A-LINK DTU DVB-T USB2.0", core::ptr::null_mut()) },
    { DVB_USB_DEVICE(USB_VID_774, USB_PID_FRIIO_WHITE,
    &friio_props, "774 Friio White ISDB-T USB2.0", core::ptr::null_mut()) },
    { }
    };
