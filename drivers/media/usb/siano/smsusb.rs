...
//! Source: drivers/media/usb/siano/smsusb.c
#![no_std]
...
pub const USB1_BUFFER_SIZE: c_uint = 0x1000;
pub const USB2_BUFFER_SIZE: c_uint = 0x2000;
pub const MAX_BUFFERS: c_int = 50;
pub const MAX_URBS: c_int = 10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct smsusb_urb_t {
    pub entry: list_head,
    pub cb: *mut smscore_buffer_t,
    pub dev: *mut smsusb_device_t,
    pub urb: *mut urb,
// For the bottom half
    pub wq: work_struct,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct smsusb_device_t {
    pub udev: *mut usb_device,
    pub coredev: *mut smscore_device_t,
    pub surbs: [smsusb_urb_t; MAX_URBS],
    pub response_alignment: c_int,
    pub buffer_size: c_int,
    pub in_ep: c_uchar,
    pub out_ep: c_uchar,
    pub state: enum smsusb_state,
}
...
//
#[no_mangle]
unsafe extern "C" fn do_submit_urb(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn smsusb_onresponse(urb: *mut urb) {
...
// This function can sleep
    ...
    if (!surb.cb) {
    pr_err("smscore_getbuffer(...) returned core::ptr::null_mut()\n");
    return -ENOMEM;
    }
    }
    usb_fill_bulk_urb(
...
#[no_mangle]
unsafe extern "C" fn smsusb_stop_streaming(dev: *mut smsusb_device_t) {
    ...
    dev.surbs[i].cb = core::ptr::null_mut();
    }
    }
    }
#[no_mangle]
unsafe extern "C" fn smsusb_start_streaming(dev: *mut smsusb_device_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsusb_sendrequest(context: *mut c_void, buffer: *mut c_void, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsusb1_load_firmware(udev: *mut usb_device, id: c_int, board_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsusb1_detectmode(context: *mut c_void, mode: *mut c_int) {
...
// mode = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strstr(product_string, _arg: "BDA")) -> else {
    else if (strstr(product_string, "BDA"))
// mode = 4;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strstr(product_string, _arg: "DVBT")) -> else {
    else if (strstr(product_string, "DVBT"))
// mode = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strstr(product_string, _arg: "TDMB")) -> else {
    else if (strstr(product_string, "TDMB"))
// mode = 2;
    pr_debug("%d \"%s\"\n", *mode, product_string);
    }
#[no_mangle]
unsafe extern "C" fn smsusb1_setmode(context: *mut c_void, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsusb_term_device(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn smsusb_init_device(intf: *mut usb_interface, board_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsusb_disconnect(intf: *mut usb_interface) {
    static void smsusb_disconnect(struct usb_interface *intf)
    {
    smsusb_term_device(intf);
    }
#[no_mangle]
unsafe extern "C" fn smsusb_suspend(intf: *mut usb_interface, msg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsusb_resume(intf: *mut usb_interface) -> c_int {
