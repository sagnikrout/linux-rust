...
//! Source: drivers/media/usb/ttusb-budget/dvb-ttusb-budget.c
#![no_std]
...
pub const ISO_BUF_COUNT: c_int = 4;
pub const FRAMES_PER_ISO_BUF: c_int = 4;
pub const ISO_FRAME_SIZE: c_int = 912;
pub const TTUSB_MAXCHANNEL: c_int = 32;

pub const TTUSB_REV_2_2: c_uint = 0x22;

pub const MAX_SEND: c_uint = 0x28;
pub const MAX_RCV: c_uint = 0x20;
//
...
// and one for USB access.
    ...
    pub disconnecting: c_int,
    pub iso_streaming: c_int,
    pub bulk_out_pipe: c_uint,
    pub bulk_in_pipe: c_uint,
    pub isoc_in_pipe: c_uint,
    pub iso_buffer: *mut c_void,
    pub iso_urb: [*mut urb; ISO_BUF_COUNT],
    pub running_feed_count: c_int,
    pub last_channel: c_int,
    pub last_filter: c_int,
    pub /: *mut *mut u8 c; / transaction counter, wraps around...,
    pub tone: enum fe_sec_tone_mode,
    pub voltage: enum fe_sec_voltage,
    pub muxpack: int mux_state; // 0..2 - MuxSyncWord, 3 - nMuxPacks, 4 -,
    pub mux_npacks: u8,
    pub 8]: u8 muxpack[256 +,
    pub muxpack_len: int muxpack_ptr,,
    pub insync: c_int,
    pub /: *mut *mut int cc; / MuxCounter - will increment on EVERY MUX PACKET,
// (including stuffing. yes. really.)
    pub send_buf: [u8; MAX_SEND],
    pub last_result: [u8; MAX_RCV],
    pub revision: c_int,
    pub fe: *mut *mut dvb_frontend,
}

#[no_mangle]
unsafe extern "C" fn ttusb_cmd(ttusb: *mut ttusb, data: *mut u8, len: c_int, len_result: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn master_xfer(adapter: *mut *mut i2c_adapter, msg: *mut i2c_msg, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ttusb_boot_dsp(ttusb: *mut ttusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ttusb_del_channel(ttusb: *mut ttusb, channel_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ttusb_del_filter(ttusb: *mut ttusb, filter_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ttusb_init_controller(ttusb: *mut ttusb) -> c_int {
...
// set i2c bit rate
    ...
    {
    let mut ttusb: *mut ttusb = (struct ttusb*) fe.dvb.priv;
...
#[no_mangle]
unsafe extern "C" fn ttusb_update_lnb(ttusb: *mut ttusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ttusb_set_tone(fe: *mut dvb_frontend, tone: enum fe_sec_tone_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ttusb_set_led_freq(ttusb: *mut ttusb, freq: u8) {
...
// section data
    let mut pusi: c_int = muxpack[0] & 0x40;
    let mut channel: c_int = muxpack[0] & 0x1F;
    let mut payload: c_int = muxpack[1];
...
// we have TS data here!
    let mut pid: c_int = ((muxpack[1] & 0x0F) << 8) | muxpack[2];
    int channel;
...
#[no_mangle]
unsafe extern "C" fn ttusb_process_frame(ttusb: *mut ttusb, data: *mut *mut u8, len: c_int) {
    static void ttusb_process_frame(struct ttusb *ttusb, u8 * data, int len)
    {
    let mut maxwork: c_int = 1024;
    while (len) {
    if (!(maxwork--)) {
...
// determine length
    ...
    188 + 4;
#[no_mangle]
pub unsafe extern "C" fn if(0x00: ttusb->muxpack[0] ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ttusb_iso_irq(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn ttusb_free_iso_urbs(ttusb: *mut ttusb) {
...
#[no_mangle]
unsafe extern "C" fn ttusb_alloc_iso_urbs(ttusb: *mut ttusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ttusb_stop_iso_xfer(ttusb: *mut ttusb) {
...
#[no_mangle]
unsafe extern "C" fn ttusb_start_iso_xfer(ttusb: *mut ttusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ttusb_stop_feed(dvbdmxfeed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ttusb_setup_interfaces(ttusb: *mut ttusb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stc_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stc_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn functionality(adapter: *mut i2c_adapter) -> u32 {
    static u32 functionality(struct i2c_adapter *adapter)
    {
    return I2C_FUNC_I2C;
    }
#[no_mangle]
unsafe extern "C" fn alps_tdmb7_tuner_set_params(fe: *mut dvb_frontend) -> c_int {
    static int alps_tdmb7_tuner_set_params(struct dvb_frontend *fe)
    {
    struct dtv_frontend_properties *p = &fe.dtv_property_cache;
    let mut ttusb: *mut ttusb = (struct ttusb*) fe.dvb.priv;
    u8 data[4];
    let mut msg: i2c_msg = {.addr=0x61, .flags=0, .buf=data, .len=sizeof(data) };
    u32 div;
...
#[no_mangle]
unsafe extern "C" fn philips_tdm1316l_tuner_init(fe: *mut *mut dvb_frontend) -> c_int {
    static int philips_tdm1316l_tuner_init(struct dvb_frontend* fe)
    {
    let mut ttusb: *mut ttusb = (struct ttusb*) fe.dvb.priv;
    static u8 td1316_init[] = { 0x0b, 0xf5, 0x85, 0xab };
    static u8 disable_mc44BC374c[] = { 0x1d, 0x74, 0xa0, 0x68 };
    let mut tuner_msg: i2c_msg = { .addr=0x60, .flags=0, .buf=td1316_init, .len=sizeof(td1316_init) };
...
unsafe extern "C" fn philips_tdm1316l_tuner_set_params(fe: *mut dvb_frontend) -> c_int {
    ...
    let mut ttusb: *mut ttusb = (struct ttusb*) fe.dvb.priv;
    u8 tuner_buf[4];
    let mut tuner_msg: i2c_msg = {.addr=0x60, .flags=0, .buf=tuner_buf, .len=sizeof(tuner_buf) };
...
#[no_mangle]
unsafe extern "C" fn philips_tdm1316l_request_firmware(fe: *mut *mut dvb_frontend, fw: *const firmware, name: *mut *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alps_stv0299_set_symbol_rate(fe: *mut dvb_frontend, srate: u32, ratio: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn philips_tsa5059_tuner_set_params(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ttusb_novas_grundig_29504_491_tuner_set_params(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alps_tdbe2_tuner_set_params(fe: *mut dvb_frontend) -> c_int {
    static int alps_tdbe2_tuner_set_params(struct dvb_frontend *fe)
    {
    struct dtv_frontend_properties *p = &fe.dtv_property_cache;
    let mut ttusb: *mut ttusb = fe.dvb.priv;
    u32 div;
    u8 data[4];
    let mut msg: i2c_msg = { .addr = 0x62, .flags = 0, .buf = data, .len = sizeof(data) };
...
#[no_mangle]
unsafe extern "C" fn read_pwm(ttusb: *mut *mut ttusb) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn frontend_init(ttusb: *mut *mut ttusb) {
...
#[no_mangle]
unsafe extern "C" fn ttusb_probe(intf: *mut usb_interface, id: *const usb_device_id) -> c_int {
...
// i2c
    ...
    ttusb.i2c_adap.algo_data         = core::ptr::null_mut();
    ...
    ttusb.dvb_demux.priv = core::ptr::null_mut();
    ...
    ttusb.dvb_demux.write_to_decoder = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ttusb_disconnect(intf: *mut usb_interface) {
