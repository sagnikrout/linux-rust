...
//! Source: drivers/media/usb/uvc/uvc_metadata.c
#![no_std]
...
//
    ...
    struct v4l2_meta_format *fmt = &format.fmt.meta;
    let mut fmeta: u32 = V4L2_META_FMT_UVC;
    u32 buffersize;
    if (format.type != vfh.vdev.queue.type)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn uvc_meta_detect_msxu(dev: *mut uvc_device) -> c_int {
    static int uvc_meta_detect_msxu(struct uvc_device *dev)
    {
    u32 *data __free(kfree) = core::ptr::null_mut();
    struct uvc_entity *entity;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn uvc_meta_register(stream: *mut uvc_streaming) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn uvc_meta_init(dev: *mut uvc_device) -> c_int {
