...
//! Source: drivers/media/usb/uvc/uvc_video.c
#![no_std]
...
//
    ...
    int timeout)
    {
    let mut type: u8 = USB_TYPE_CLASS | USB_RECIP_INTERFACE;
    unsigned int pipe;
...
//
    ...
    {
    const struct uvc_format *format = core::ptr::null_mut();
    const struct uvc_frame *frame = core::ptr::null_mut();
    unsigned int i;
//
...
//
    ...
    ctrl.bmHint > 255) {
    let mut corrected_format_index: u8 = ctrl.bmHint >> 8;
...
#[no_mangle]
unsafe extern "C" fn uvc_video_ctrl_size(stream: *mut uvc_streaming) -> usize {
...
//
    ...
    return 26;
#[no_mangle]
pub unsafe extern "C" fn if(0x0150: stream->dev->uvc_version <) -> else {
    ...
    {
    let mut size: u16 = uvc_video_ctrl_size(stream);
    u8 *data;
    int ret;
...
//
pub const UVC_MIN_HW_TIMESTAMP_DIFF: c_int = 100;
#[no_mangle]
pub unsafe extern "C" fn uvc_video_get_time() -> ktime_t {
...
#[no_mangle]
pub unsafe extern "C" fn sof_diff(a: u16, b: u16) -> u16 {
...
//
    ...
    let mut has_pts: bool = false;
    let mut has_scr: bool = false;
...
// in the ring buffer
//
    if (has_pts && buf != core::ptr::null_mut())
...
//
    ...
    let mut delta_sof: u16 = (sample.host_sof - sample.dev_sof) & 255;
    if (delta_sof >= 10)
...
#[no_mangle]
unsafe extern "C" fn uvc_video_clock_reset(clock: *mut uvc_clock) {
...
//
#[no_mangle]
unsafe extern "C" fn uvc_video_clock_host_sof(sample: *const uvc_clock_sample) -> u16 {
...
//
    ...
    sof += 2048 << 16;
#[no_mangle]
pub unsafe extern "C" fn if(16): sof > mean + (1024 <<) -> else {
...
#[no_mangle]
unsafe extern "C" fn uvc_video_stats_update(stream: *mut uvc_streaming) {
...
#[no_mangle]
unsafe extern "C" fn uvc_video_stats_start(stream: *mut uvc_streaming) {
...
#[no_mangle]
unsafe extern "C" fn uvc_video_stats_stop(stream: *mut uvc_streaming) {
...
//
#[no_mangle]
unsafe extern "C" fn uvc_video_copy_data_work(work: *mut work_struct) {
...
// Release reference taken on this buffer.
    ...
    {
    let mut active_op: c_uint = uvc_urb.async_operations;
...
// If an error occurred skip the rest of the payload.
    if (ret < 0 || buf == core::ptr::null_mut()) {
...
// Prepare video data for processing.
    if (!stream.bulk.skip_payload && buf != core::ptr::null_mut())
...
//
    ...
    let mut len: c_int = stream.urb_size, ret;
    if (buf == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn uvc_video_complete(urb: *mut urb) {
    ...
    struct uvc_buffer *buf = core::ptr::null_mut();
    struct uvc_buffer *buf_meta = core::ptr::null_mut();
    int ret;
    switch (urb.status) {
    case 0:
    break;
...
//
    ...
    uvc_urb.buffer = core::ptr::null_mut();
    uvc_urb.sgt = core::ptr::null_mut();
    }
    stream.urb_size = 0;
    }
...
// Retry allocations until one succeed.
    ...
    let mut urb_size: c_uint = psize * npackets;
...
//
    ...
    struct usb_host_endpoint *best_ep = core::ptr::null_mut();
    let mut best_psize: c_uint = UINT_MAX;
    unsigned int bandwidth;
    unsigned int altsetting;
    let mut intfnum: c_int = stream.intfnum;
...
//
#[no_mangle]
pub unsafe extern "C" fn uvc_video_suspend(stream: *mut uvc_streaming) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn uvc_video_resume(stream: *mut uvc_streaming, reset: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn uvc_video_init(stream: *mut uvc_streaming) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: stream->intf->num_altsetting >) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn uvc_video_start_streaming(stream: *mut uvc_streaming) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn uvc_video_stop_streaming(stream: *mut uvc_streaming) {
