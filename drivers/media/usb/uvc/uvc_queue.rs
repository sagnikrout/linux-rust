...
//! Source: drivers/media/usb/uvc/uvc_queue.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn uvc_buffer_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uvc_buffer_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn uvc_buffer_finish(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn uvc_start_streaming_video(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uvc_stop_streaming_video(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn uvc_stop_streaming_meta(vq: *mut vb2_queue) {
...
//
#[no_mangle]
pub unsafe extern "C" fn uvc_queue_cancel(queue: *mut uvc_video_queue, disconnect: c_int) {
...
#[no_mangle]
unsafe extern "C" fn uvc_queue_buffer_complete(ref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn uvc_queue_buffer_release(buf: *mut uvc_buffer) {
