...
//! Source: drivers/media/usb/uvc/uvc_driver.c
#![no_std]
...
//
    ...
    let mut uvc_clock_param: c_uint = CLOCK_MONOTONIC;
    unsigned int uvc_hw_timestamps_param;
    let mut uvc_no_drop_param: c_uint = 1;
    let mut uvc_quirks_param: static unsigned int = -1;
    unsigned int uvc_dbg_param;
    let mut uvc_timeout_param: c_uint = UVC_CTRL_STREAMING_TIMEOUT;
...
#[no_mangle]
unsafe extern "C" fn uvc_colorspace(primaries: u8) -> enum v4l2_colorspace {
...
#[no_mangle]
unsafe extern "C" fn uvc_xfer_func(transfer_characteristics: u8) -> enum v4l2_xfer_func {
...
#[no_mangle]
unsafe extern "C" fn uvc_ycbcr_enc(matrix_coefficients: u8) -> enum v4l2_ycbcr_encoding {
...
//
    ...
    {
    let mut id: u16 = UVC_HARDWARE_ENTITY_ID(term.id);
...
//
#[no_mangle]
unsafe extern "C" fn uvc_stream_delete(stream: *mut uvc_streaming) {
...
// intervals += n;
    ...
    let mut width_multiplier: c_uint = 1;
    unsigned int i, n;
    u8 ftype;
    int ret;
    if (buflen < 4)
...
// Some devices report bpp that doesn't match the format.
    ...
    if (info) {
    let mut div: c_uint = info.hdiv * info.vdiv;
    n = info.bpp[0] * div;
...
//
    ...
    struct usb_interface *intf)
    {
    struct uvc_streaming *streaming = core::ptr::null_mut();
    struct uvc_format *format;
    struct uvc_frame *frame;
    struct usb_host_interface *alts = &intf.altsetting[0];
    const unsigned char *_buffer, *buffer = alts.extra;
    int _buflen, buflen = alts.extralen;
    let mut nformats: c_uint = 0, nframes = 0, nintervals = 0;
    ...
    if (streaming == core::ptr::null_mut()) {
...
// Parse the header descriptor.
    ...
    GFP_KERNEL);
    if (streaming.header.bmaControls == core::ptr::null_mut()) {
    ret = -ENOMEM;
    goto error;
    }
    buflen -= buffer[0];
...
//
    ...
    type_name = "Camera";
#[no_mangle]
pub unsafe extern "C" fn if(UVC_ITT_MEDIA_TRANSPORT_INPUT: UVC_ENTITY_TYPE(term) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn uvc_parse_control(dev: *mut uvc_device) -> c_int {
    static int uvc_parse_control(struct uvc_device *dev)
    {
    struct usb_host_interface *alts = dev.intf.cur_altsetting;
    const unsigned char *buffer = alts.extra;
    let mut buflen: c_int = alts.extralen;
    int ret;
//
...
//
#[no_mangle]
unsafe extern "C" fn uvc_gpio_event(dev: *mut uvc_device) {
...
#[no_mangle]
unsafe extern "C" fn uvc_gpio_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn uvc_gpio_parse(dev: *mut uvc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uvc_gpio_init_irq(dev: *mut uvc_device) -> c_int {
    ...
    return 0;
    ret = request_threaded_irq(unit.gpio.irq, core::ptr::null_mut(), uvc_gpio_irq,
...
#[no_mangle]
unsafe extern "C" fn uvc_gpio_deinit(dev: *mut uvc_device) {
...
//
    ...
    if (chain.processing != core::ptr::null_mut()) {
    uvc_dbg(chain.dev, DESCR,
...
// Single-input selector units are ignored.
    if (entity.bNrInPins == 1)
    break;
    if (chain.selector != core::ptr::null_mut()) {
    uvc_dbg(chain.dev, DESCR,
    ...
    int found;
// Forward scan
    forward = core::ptr::null_mut();
    found = 0;
    while (1) {
    forward = uvc_entity_by_reference(chain.dev, entity.id,
    forward);
    if (forward == core::ptr::null_mut())
    break;
    if (forward == prev)
    continue;
...
// Single-input selector units are ignored.
    ...
    if (term == core::ptr::null_mut() || !UVC_ENTITY_IS_ITERM(term)) {
    uvc_dbg(chain.dev, DESCR,
...
// _entity = entity;
    ...
    while (entity != core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn uvc_scan_fallback(dev: *mut uvc_device) -> c_int {
    static int uvc_scan_fallback(struct uvc_device *dev)
    {
    struct uvc_video_chain *chain;
    struct uvc_entity *iterm = core::ptr::null_mut();
    struct uvc_entity *oterm = core::ptr::null_mut();
    struct uvc_entity *entity;
...
//
    ...
    if (iterm == core::ptr::null_mut() || oterm == core::ptr::null_mut())
    return -EINVAL;
...
//
#[no_mangle]
unsafe extern "C" fn uvc_scan_device(dev: *mut uvc_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uvc_delete(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn uvc_release(vdev: *mut video_device) {
...
//
#[no_mangle]
unsafe extern "C" fn uvc_unregister_video(dev: *mut uvc_device) {
...
#[no_mangle]
unsafe extern "C" fn uvc_register_chains(dev: *mut uvc_device) -> c_int {
...
//
    let mut uvc_quirk_none: static struct uvc_device_info = { 0 };
...
// Allocate memory for the device and initialize it.
    ...
    udev.devpath);
    if (udev.product != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn uvc_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn uvc_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __uvc_resume(intf: *mut usb_interface, reset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uvc_resume(intf: *mut usb_interface) -> c_int {
    static int uvc_resume(struct usb_interface *intf)
    {
    return __uvc_resume(intf, 0);
    }
#[no_mangle]
unsafe extern "C" fn uvc_reset_resume(intf: *mut usb_interface) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uvc_clock_param_get(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uvc_clock_param_set(val: *const c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcasecmp(val, 0: "realtime") ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn param_set_nodrop(val: *const c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uvc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn uvc_cleanup() -> void __exit {
