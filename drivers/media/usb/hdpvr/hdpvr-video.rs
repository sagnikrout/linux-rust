...
//! Source: drivers/media/usb/hdpvr/hdpvr-video.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn list_size(list: *mut list_head) -> c_uint {
...
// urb callback
#[no_mangle]
unsafe extern "C" fn hdpvr_read_bulk_callback(urb: *mut urb) {
...
#[no_mangle]
pub unsafe extern "C" fn hdpvr_cancel_queue(dev: *mut hdpvr_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdpvr_free_queue(q: *mut list_head) -> c_int {
...
// function expects dev->io_mutex to be hold by caller
#[no_mangle]
pub unsafe extern "C" fn hdpvr_free_buffers(dev: *mut hdpvr_device) -> c_int {
...
// function expects dev->io_mutex to be hold by caller
#[no_mangle]
pub unsafe extern "C" fn hdpvr_alloc_buffers(dev: *mut hdpvr_device, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdpvr_submit_buffers(dev: *mut hdpvr_device) -> c_int {
    static int hdpvr_submit_buffers(struct hdpvr_device *dev)
    {
    struct hdpvr_buffer *buf;
    struct urb *urb;
    let mut ret: c_int = 0, err_count = 0;
...
#[no_mangle]
unsafe extern "C" fn hdpvr_transmit_buffers(work: *mut work_struct) {
...
// function expects dev->io_mutex to be hold by caller
#[no_mangle]
unsafe extern "C" fn hdpvr_start_streaming(dev: *mut hdpvr_device) -> c_int {
...
// start streaming 2 request
    ...
    0xb8, 0x38, 0x1, 0, core::ptr::null_mut(), 0, 8000);
    v4l2_dbg(MSG_BUFFER, hdpvr_debug, &dev.v4l2_dev,
...
// function expects dev->io_mutex to be hold by caller
#[no_mangle]
unsafe extern "C" fn hdpvr_stop_streaming(dev: *mut hdpvr_device) -> c_int {
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(STATUS_STREAMING: dev->status !=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn hdpvr_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdpvr_release(file: *mut file) -> c_int {
...
//
    ...
    {
    struct hdpvr_device *dev = video_drvdata(file);
    struct hdpvr_buffer *buf = core::ptr::null_mut();
    struct urb *urb;
    let mut ret: c_int = 0;
    int rem, cnt;
    if (*pos)
...
#[no_mangle]
unsafe extern "C" fn hdpvr_poll(filp: *mut file, wait: *mut poll_table) -> __poll_t {
    ...
    let mut mask: __poll_t = v4l2_ctrl_poll(filp, wait);
...
#[no_mangle]
unsafe extern "C" fn vidioc_querystd(file: *mut file, priv: *mut c_void, a: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_enum_input(file: *mut file, priv: *mut c_void, i: *mut v4l2_input) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdpvr_try_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdpvr_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// break;
    case V4L2_CID_MPEG_VIDEO_BITRATE_MODE: {
    let mut peak_bitrate: c_uint = dev.video_bitrate_peak.val / 100000;
    let mut bitrate: c_uint = dev.video_bitrate.val / 100000;
    if (ctrl.is_new) {
...
#[no_mangle]
unsafe extern "C" fn hdpvr_device_release(vdev: *mut video_device) {
...
// deregister I2C adapter
    ...
    let mut ac3: bool = dev.flags & HDPVR_FLAG_AC3_CAP;
    int res;
