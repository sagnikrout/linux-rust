...
//! Source: drivers/media/usb/hdpvr/hdpvr-control.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn hdpvr_config_call(dev: *mut hdpvr_device, value: c_uint, valbuf: u8) -> c_int {
    int hdpvr_config_call(struct hdpvr_device *dev, uint value, u8 valbuf)
    {
    int ret;
    let mut request_type: c_char = 0x38, snd_request = 0x01;
...
#[no_mangle]
pub unsafe extern "C" fn get_video_info(dev: *mut hdpvr_device, vidinf: *mut hdpvr_video_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_input_lines_info(dev: *mut hdpvr_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hdpvr_set_bitrate(dev: *mut hdpvr_device) -> c_int {
    ...
    dev.usbc_buf[1] = 0;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_MPEG_AUDIO_ENCODING_AC3: codec ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn hdpvr_set_options(dev: *mut hdpvr_device) -> c_int {
