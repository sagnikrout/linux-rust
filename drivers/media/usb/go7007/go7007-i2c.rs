...
//! Source: drivers/media/usb/go7007/go7007-i2c.c
#![no_std]
...
pub const SPI_I2C_ADDR_BASE: c_uint = 0x1400;

pub const I2C_STATE_MASK: c_uint = 0x0007;
pub const I2C_READ_READY_MASK: c_uint = 0x0008;
// There is only one I2C port on the TW2804 that feeds all four GO7007 VIPs
// on the Adlink PCI-MPG24, so access is shared between all of them.
    static DEFINE_MUTEX(adlink_mpg24_i2c_mutex);
#[no_mangle]
pub unsafe extern "C" fn adlink_mpg24_i2c_lock(go: *mut go7007) {
...
#[no_mangle]
pub unsafe extern "C" fn adlink_mpg24_i2c_unlock(go: *mut go7007) {
...
#[no_mangle]
unsafe extern "C" fn go7007_functionality(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn go7007_i2c_init(go: *mut go7007) -> c_int {
