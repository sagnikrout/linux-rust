...
//! Source: drivers/media/usb/go7007/go7007-usb.c
#![no_std]
...
pub const HPI_STATUS_ADDR: c_uint = 0xFFF4;
pub const INT_PARAM_ADDR: c_uint = 0xFFF6;
pub const INT_INDEX_ADDR: c_uint = 0xFFF8;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct go7007_usb_board {
    pub flags: c_uint,
    pub main_info: go7007_board_info,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct go7007_usb {
    pub board: *const go7007_usb_board,
    pub i2c_lock: mutex,
    pub usbdev: *mut usb_device,
    pub video_urbs: [*mut urb; 8],
    pub audio_urbs: [*mut urb; 8],
...
#[no_mangle]
unsafe extern "C" fn go7007_usb_interface_reset(go: *mut go7007) -> c_int {
...
// Reset buffer in EZ-USB
    ...
    if (go7007_usb_vendor_request(go, 0x10, 0, 0, core::ptr::null_mut(), 0, 0) < 0 ||
    go7007_usb_vendor_request(go, 0x10, 0, 0, core::ptr::null_mut(), 0, 0) < 0)
    return -1;
// Reset encoder again
    if (go7007_write_interrupt(go, 0x0001, 0x0001) < 0)
    return -1;
...
#[no_mangle]
unsafe extern "C" fn go7007_usb_readinterrupt_complete(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn go7007_usb_read_interrupt(go: *mut go7007) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn go7007_usb_read_video_pipe_complete(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn go7007_usb_read_audio_pipe_complete(urb: *mut urb) {
    ...
    if (go.audio_deliver != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn go7007_usb_stream_start(go: *mut go7007) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn go7007_usb_stream_stop(go: *mut go7007) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn go7007_usb_send_firmware(go: *mut go7007, data: *mut u8, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn go7007_usb_release(go: *mut go7007) {
...
#[no_mangle]
unsafe extern "C" fn go7007_usb_functionality(adapter: *mut i2c_adapter) -> u32 {
...
// USB add/remove functions
    ...
    if (go == core::ptr::null_mut())
    return -ENOMEM;
    usb = kzalloc_obj(struct go7007_usb);
    if (usb == core::ptr::null_mut()) {
    kfree(go);
    return -ENOMEM;
    }
    usb.board = board;
...
// Allocate the URB and buffer for receiving incoming interrupts
    ...
    if (usb.intr_urb == core::ptr::null_mut())
    goto allocfail;
    usb.intr_urb.transfer_buffer = kmalloc_array(2, sizeof(u16),
    GFP_KERNEL);
    if (usb.intr_urb.transfer_buffer == core::ptr::null_mut())
    goto allocfail;
...
// Allocate the URBs and buffers for receiving the video stream
    ...
    if (usb.video_urbs[i] == core::ptr::null_mut())
    goto allocfail;
    usb.video_urbs[i].transfer_buffer =
    kmalloc(v_urb_len, GFP_KERNEL);
    if (usb.video_urbs[i].transfer_buffer == core::ptr::null_mut())
    goto allocfail;
...
// Allocate the URBs and buffers for receiving the audio stream
    ...
    if (usb.audio_urbs[i] == core::ptr::null_mut())
    goto allocfail;
    usb.audio_urbs[i].transfer_buffer = kmalloc(4096,
    GFP_KERNEL);
    if (usb.audio_urbs[i].transfer_buffer == core::ptr::null_mut())
    goto allocfail;
...
#[no_mangle]
unsafe extern "C" fn go7007_usb_disconnect(intf: *mut usb_interface) {
