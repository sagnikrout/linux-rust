...
//! Source: drivers/media/usb/go7007/go7007-driver.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn go7007_read_interrupt(go: *mut go7007, value: *mut u16, data: *mut u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn go7007_read_addr(go: *mut go7007, addr: u16, data: *mut u16) -> c_int {
    int go7007_read_addr(struct go7007 *go, u16 addr, u16 *data)
    {
    let mut count: c_int = 100;
    u16 value;
...
//
#[no_mangle]
unsafe extern "C" fn go7007_load_encoder(go: *mut go7007) -> c_int {
    ...
    if (go.boot_fw == core::ptr::null_mut()) {
...
//
#[no_mangle]
pub unsafe extern "C" fn go7007_boot_encoder(go: *mut go7007, init_i2c: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn go7007_init_encoder(go: *mut go7007) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn go7007_reset_encoder(go: *mut go7007) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn init_i2c_module(adapter: *mut i2c_adapter, i2c: *const *const go_i2c) -> c_int {
    ...
    sd = v4l2_i2c_new_subdev_board(v4l2_dev, adapter, &info, core::ptr::null_mut());
    if (sd) {
    if (i2c.is_video)
    go.sd_video = sd;
    if (i2c.is_audio)
...
//
#[no_mangle]
unsafe extern "C" fn go7007_remove(v4l2_dev: *mut v4l2_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn go7007_register_encoder(go: *mut go7007, num_i2c_devs: unsigned) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn go7007_start_encoder(go: *mut go7007) -> c_int {
    ...
    let mut idx: c_int = y * go.width / 16 + x;
...
//
#[no_mangle]
pub unsafe extern "C" fn store_byte(vb: *mut go7007_buffer, byte: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn go7007_motion_regions(go: *mut go7007, vb: *mut go7007_buffer) {
    ...
    let mut motion_regions: u32 = 0;
    let mut stride: unsigned = (go.width + 7) >> 3;
    unsigned x, y;
    int i;
    for (i = 0; i < 216; ++i)
...
//
    ...
    {
    u32 *bytesused;
    struct go7007_buffer *vb_tmp = core::ptr::null_mut();
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn write_bitmap_word(go: *mut go7007) {
...
//
#[no_mangle]
pub unsafe extern "C" fn go7007_parse_video_stream(go: *mut go7007, buf: *mut u8, length: c_int) {
    ...
    vb.frame_offset = 0;
    vb.modet_active = 0;
    vb = go.active_buf = core::ptr::null_mut();
    }
    switch (go.state) {
    case STATE_DATA:
    switch (buf[i]) {
...
// get a new buffer
    ...
    if (vb == core::ptr::null_mut() || go.seen_frame)
...
#[no_mangle]
pub unsafe extern "C" fn go7007_update_board(go: *mut go7007) {
