...
//! Source: drivers/media/usb/go7007/go7007-v4l2.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn valid_pixelformat(pixelformat: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn get_frame_type_flag(vb: *mut go7007_buffer, format: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn get_resolution(go: *mut go7007, width: *mut c_int, height: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_formatting(go: *mut go7007) {
...
#[no_mangle]
unsafe extern "C" fn set_capture_size(go: *mut go7007, fmt: *mut v4l2_format, try: c_int) -> c_int {
    static int set_capture_size(struct go7007 *go, struct v4l2_format *fmt, int try)
    {
    let mut sensor_height: c_int = 0, sensor_width = 0;
    int width, height;
    if (fmt != core::ptr::null_mut() && !valid_pixelformat(fmt.fmt.pix.pixelformat))
    return -EINVAL;
    ...
    width = sensor_width;
#[no_mangle]
pub unsafe extern "C" fn if(144: fmt->fmt.pix.width <) -> else {
    ...
    height = sensor_height;
#[no_mangle]
pub unsafe extern "C" fn if(96: fmt->fmt.pix.height <) -> else {
    ...
    if (fmt != core::ptr::null_mut()) {
    let mut pixelformat: u32 = fmt.fmt.pix.pixelformat;
    ...
    call_all(&go.v4l2_dev, pad, set_fmt, core::ptr::null_mut(), &format);
    } else {
    if (width <= sensor_width / 4) {
...
#[no_mangle]
unsafe extern "C" fn go7007_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn go7007_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn go7007_buf_finish(vb: *mut vb2_buffer) {
    ...
    struct go7007_buffer *go7007_vb =
    container_of(vbuf, struct go7007_buffer, vb);
    let mut frame_type_flag: u32 = get_frame_type_flag(go7007_vb, go.format);
...
#[no_mangle]
unsafe extern "C" fn go7007_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
    ...
    go.next_seq = 0;
    go.active_buf = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn go7007_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn vidioc_g_std(file: *mut file, priv: *mut c_void, std: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn go7007_s_std(go: *mut go7007) -> c_int {
    ...
    set_capture_size(go, core::ptr::null_mut(), 0);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn vidioc_s_std(file: *mut file, priv: *mut c_void, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_querystd(file: *mut file, priv: *mut c_void, std: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_g_input(file: *mut file, priv: *mut c_void, input: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_g_audio(file: *mut file, fh: *mut c_void, a: *mut v4l2_audio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn go7007_s_input(go: *mut go7007) {
    static void go7007_s_input(struct go7007 *go)
    {
    let mut input: c_uint = go.input;
    v4l2_subdev_call(go.sd_video, video, s_routing,
    go.board_info.inputs[input].video_input, 0,
    go.board_info.video_config);
    if (go.board_info.num_aud_inputs) {
    let mut aud_input: c_int = go.board_info.inputs[input].audio_index;
    v4l2_subdev_call(go.sd_audio, audio, s_routing,
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_input(file: *mut file, priv: *mut c_void, input: c_uint) -> c_int {
...
// stored.
    return v4l2_event_subscribe(fh, sub, 30, core::ptr::null_mut());
    default:
    return v4l2_ctrl_subscribe_event(fh, sub);
    }
    }
#[no_mangle]
unsafe extern "C" fn go7007_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn go7007_v4l2_ctrl_init(go: *mut go7007) -> c_int {
    int go7007_v4l2_ctrl_init(struct go7007 *go)
    {
    struct v4l2_ctrl_handler *hdl = &go.hdl;
    struct v4l2_ctrl *ctrl;
    v4l2_ctrl_handler_init(hdl, 22);
    go.mpeg_video_gop_size = v4l2_ctrl_new_std(hdl, core::ptr::null_mut(),
    V4L2_CID_MPEG_VIDEO_GOP_SIZE, 0, 34, 1, 15);
    go.mpeg_video_gop_closure = v4l2_ctrl_new_std(hdl, core::ptr::null_mut(),
    V4L2_CID_MPEG_VIDEO_GOP_CLOSURE, 0, 1, 1, 1);
    go.mpeg_video_bitrate = v4l2_ctrl_new_std(hdl, core::ptr::null_mut(),
    V4L2_CID_MPEG_VIDEO_BITRATE,
    64000, 10000000, 1, 9800000);
    go.mpeg_video_b_frames = v4l2_ctrl_new_std(hdl, core::ptr::null_mut(),
    V4L2_CID_MPEG_VIDEO_B_FRAMES, 0, 2, 2, 0);
    go.mpeg_video_rep_seqheader = v4l2_ctrl_new_std(hdl, core::ptr::null_mut(),
    V4L2_CID_MPEG_VIDEO_REPEAT_SEQ_HEADER, 0, 1, 1, 1);
    go.mpeg_video_aspect_ratio = v4l2_ctrl_new_std_menu(hdl, core::ptr::null_mut(),
    V4L2_CID_MPEG_VIDEO_ASPECT,
    V4L2_MPEG_VIDEO_ASPECT_16x9, 0,
    V4L2_MPEG_VIDEO_ASPECT_1x1);
    ctrl = v4l2_ctrl_new_std(hdl, core::ptr::null_mut(),
    ...
    v4l2_ctrl_new_custom(hdl, &go7007_pixel_threshold0_ctrl, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &go7007_motion_threshold0_ctrl, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &go7007_mb_threshold0_ctrl, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &go7007_pixel_threshold1_ctrl, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &go7007_motion_threshold1_ctrl, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &go7007_mb_threshold1_ctrl, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &go7007_pixel_threshold2_ctrl, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &go7007_motion_threshold2_ctrl, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &go7007_mb_threshold2_ctrl, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &go7007_pixel_threshold3_ctrl, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &go7007_motion_threshold3_ctrl, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &go7007_mb_threshold3_ctrl, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &go7007_mb_regions_ctrl, core::ptr::null_mut());
    go.modet_mode = v4l2_ctrl_new_std_menu(hdl, core::ptr::null_mut(),
    V4L2_CID_DETECT_MD_MODE,
    V4L2_DETECT_MD_MODE_REGION_GRID,
    1 << V4L2_DETECT_MD_MODE_THRESHOLD_GRID,
    V4L2_DETECT_MD_MODE_DISABLED);
    if (hdl.error) {
    let mut rv: c_int = hdl.error;
...
#[no_mangle]
pub unsafe extern "C" fn go7007_v4l2_init(go: *mut go7007) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn go7007_v4l2_remove(go: *mut go7007) {
