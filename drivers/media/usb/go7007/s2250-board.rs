...
//! Source: drivers/media/usb/go7007/s2250-board.c
#![no_std]
...
//
pub const TLV320_ADDRESS: c_uint = 0x34;
pub const VPX322_ADDR_ANALOGCONTROL1: c_uint = 0x02;
pub const VPX322_ADDR_BRIGHTNESS0: c_uint = 0x0127;
pub const VPX322_ADDR_BRIGHTNESS1: c_uint = 0x0131;
pub const VPX322_ADDR_CONTRAST0: c_uint = 0x0128;
pub const VPX322_ADDR_CONTRAST1: c_uint = 0x0132;
pub const VPX322_ADDR_HUE: c_uint = 0x00dc;
pub const VPX322_ADDR_SAT: c_uint = 0x0030;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct go7007_usb {
    pub board: *mut go7007_usb_board,
    pub i2c_lock: mutex,
...
pub struct s2250 {
    ...
    pub hue: c_int,
    pub reg12b_val: c_int,
    pub audio_input: c_int,
    pub audio: *mut i2c_client,
}
...
#[no_mangle]
unsafe extern "C" fn write_reg(client: *mut i2c_client, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_reg_fp(client: *mut i2c_client, addr: u16, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_reg_fp(client: *mut i2c_client, addr: u16, val: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_regs(client: *mut i2c_client, regs: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_regs_fp(client: *mut i2c_client, regs: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2250_s_std(sd: *mut v4l2_subdev, norm: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2250_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2250_log_status(sd: *mut v4l2_subdev) -> c_int {
...
// --------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn s2250_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2250_remove(client: *mut i2c_client) {
