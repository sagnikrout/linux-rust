...
//! Source: drivers/media/usb/au0828/au0828-i2c.c
#![no_std]
...
pub const I2C_WAIT_DELAY: c_int = 25;
pub const I2C_WAIT_RETRY: c_int = 1000;
#[no_mangle]
pub unsafe extern "C" fn i2c_slave_did_read_ack(i2c_adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_wait_read_ack(i2c_adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_is_read_busy(i2c_adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_wait_read_done(i2c_adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_is_write_done(i2c_adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_wait_write_done(i2c_adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_is_busy(i2c_adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_wait_done(i2c_adap: *mut i2c_adapter) -> c_int {
...
// FIXME: Implement join handling correctly
    ...
    int i, strobe = 0;
    struct au0828_dev *dev = i2c_adap.algo_data;
    let mut i2c_speed: u8 = dev.board.i2c_clk_divider;
    dprintk(4, "%s()\n", __func__);
...
#[no_mangle]
unsafe extern "C" fn au0828_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn do_i2c_scan(name: *mut c_char, c: *mut i2c_client) {
...
#[no_mangle]
pub unsafe extern "C" fn au0828_i2c_register(dev: *mut au0828_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn au0828_i2c_unregister(dev: *mut au0828_dev) -> c_int {
