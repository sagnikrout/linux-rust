...
//! Source: drivers/media/usb/au0828/au0828-core.c
#![no_std]
...
pub const _AU0828_BULKPIPE: c_uint = 0x03;
pub const _BULKPIPESIZE: c_uint = 0xffff;
    static int send_control_msg(struct au0828_dev *dev, u16 request, u32 value,
    u16 index);
    static int recv_control_msg(struct au0828_dev *dev, u16 request, u32 value,
    u16 index, unsigned char *cp, u16 size);
// USB Direction
pub const CMD_REQUEST_IN: c_uint = 0x00;
pub const CMD_REQUEST_OUT: c_uint = 0x01;
#[no_mangle]
pub unsafe extern "C" fn au0828_readreg(dev: *mut au0828_dev, reg: u16) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn au0828_writereg(dev: *mut au0828_dev, reg: u16, val: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn au0828_unregister_media_device(dev: *mut au0828_dev) {
...
// clear enable_source, disable_source
    ...
    dev.media_dev.source_priv = core::ptr::null_mut();
    dev.media_dev.enable_source = core::ptr::null_mut();
    dev.media_dev.disable_source = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn au0828_usb_release(dev: *mut au0828_dev) {
...
#[no_mangle]
unsafe extern "C" fn au0828_usb_disconnect(interface: *mut usb_interface) {
    static void au0828_usb_disconnect(struct usb_interface *interface)
    {
    struct au0828_dev *dev = usb_get_intfdata(interface);
    dprintk(1, "%s()\n", __func__);
// there is a small window after disconnect, before
    dev.usbdev is core::ptr::null_mut(), for poll (e.g: IR) try to access
...
//
    ...
    int ret;
    struct media_entity *entity, *mixer = core::ptr::null_mut(), *decoder = core::ptr::null_mut();
    if (!new) {
//
...
//
    ...
    mixer = entity;
#[no_mangle]
pub unsafe extern "C" fn if(MEDIA_ENT_F_ATV_DECODER: entity->function ==) -> else {
...
// Callers should hold graph_mutex
#[no_mangle]
unsafe extern "C" fn au0828_disable_source(entity: *mut media_entity) {
...
//
    let mut owner_is_audio: bool = false;
...
// video device has users > 1
    ...
    return;
    dev.active_link_user = core::ptr::null_mut();
    dev.active_link_user_pipe = core::ptr::null_mut();
...
// stop pipeline
    ...
    dev.active_source.name, dev.active_sink.name,
    dev.active_link_owner.name, ret);
    dev.active_link = core::ptr::null_mut();
    dev.active_link_owner = core::ptr::null_mut();
    dev.active_source = core::ptr::null_mut();
    dev.active_sink = core::ptr::null_mut();
    dev.active_link_shared = false;
    dev.active_link_user = core::ptr::null_mut();
    }
    }
    ...
    int ret;
    struct media_entity *entity, *demod = core::ptr::null_mut();
...
//
    au0828_media_graph_notify(core::ptr::null_mut(), (void *) dev);
    }
//
...
// Remote controller
    ...
    dev.board.name == core::ptr::null_mut() ? "Unset" : dev.board.name);
    mutex_unlock(&dev.lock);
...
#[no_mangle]
unsafe extern "C" fn au0828_resume(interface: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au0828_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn au0828_exit() -> void __exit {
