...
//! Source: drivers/media/usb/au0828/au0828-video.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn i2c_gate_ctrl(dev: *mut au0828_dev, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn check_dev(dev: *mut au0828_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn au0828_irq_callback(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn au0828_uninit_isoc(dev: *mut au0828_dev) {
    ...
    usb_free_urb(urb);
    dev.isoc_ctl.urb[i] = core::ptr::null_mut();
    }
    dev.isoc_ctl.transfer_buffer[i] = core::ptr::null_mut();
    }
    kfree(dev.isoc_ctl.urb);
    kfree(dev.isoc_ctl.transfer_buffer);
    dev.isoc_ctl.urb = core::ptr::null_mut();
    dev.isoc_ctl.transfer_buffer = core::ptr::null_mut();
...
//
    ...
    dev.isoc_ctl.buf = core::ptr::null_mut();
...
//
    ...
    if (list_empty(&dma_q.active)) {
    au0828_isocdbg("No active queue to serve\n");
    dev.isoc_ctl.vbi_buf = core::ptr::null_mut();
// buf = NULL;
    return;
    }
// Get the next buffer
...
//
#[no_mangle]
pub unsafe extern "C" fn au0828_isoc_copy(dev: *mut au0828_dev, urb: *mut urb) -> c_int {
    ...
    unsigned char *outp = core::ptr::null_mut();
    unsigned char *vbioutp = core::ptr::null_mut();
    int i, len = 0, rc = 1;
    unsigned char *p;
    unsigned char fbyte;
    ...
    if (vbi_buf != core::ptr::null_mut())
    vbioutp = vb2_plane_vaddr(&vbi_buf.vb.vb2_buf, 0);
    for (i = 0; i < urb.number_of_packets; i++) {
    let mut status: c_int = urb.iso_frame_desc[i].status;
    if (status < 0) {
...
// As long as isoc traffic is arriving, keep
    ...
    if (dev.vbi_read >= vbi_field_size && buf != core::ptr::null_mut())
    au0828_copy_video(dev, dma_q, buf, p, outp, len);
    }
    return rc;
    }
#[no_mangle]
pub unsafe extern "C" fn au0828_usb_v4l2_media_release(dev: *mut au0828_dev) {
...
#[no_mangle]
unsafe extern "C" fn au0828_usb_v4l2_release(v4l2_dev: *mut v4l2_device) {
...
// This control handler will inherit the controls from au8522
    ...
    let mut size: c_ulong = dev.height * dev.bytesperline;
    if (*nplanes)
...
#[no_mangle]
unsafe extern "C" fn au0828_i2s_init(dev: *mut au0828_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn au0828_analog_stream_enable(d: *mut au0828_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au0828_analog_stream_disable(d: *mut au0828_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au0828_analog_stream_reset(dev: *mut au0828_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn au0828_stream_interrupt(dev: *mut au0828_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn au0828_start_analog_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au0828_stop_streaming(vq: *mut vb2_queue) {
    ...
    spin_lock_irqsave(&dev.slock, flags);
    if (dev.isoc_ctl.buf != core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn au0828_stop_vbi_streaming(vq: *mut vb2_queue) {
    ...
    spin_lock_irqsave(&dev.slock, flags);
    if (dev.isoc_ctl.vbi_buf != core::ptr::null_mut()) {
...
//
#[no_mangle]
pub unsafe extern "C" fn au0828_analog_unregister(dev: *mut au0828_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au0828_vid_buffer_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn au0828_vbi_buffer_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn au0828_v4l2_open(filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au0828_v4l2_close(filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au0828_init_tuner(dev: *mut au0828_dev) {
...
// If we've never sent the standard in tuner core, do so now.
    ...
    {
    int ret;
    let mut width: c_int = format.fmt.pix.width;
    let mut height: c_int = format.fmt.pix.height;
...
#[no_mangle]
unsafe extern "C" fn au0828_s_input(dev: *mut au0828_dev, index: c_int) {
    ...
    if (AUVI_INPUT(i).audio_setup == core::ptr::null_mut())
    continue;
    if (i == index)
    enable = 1;
    else
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_input(file: *mut file, priv: *mut c_void, index: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_enumaudio(file: *mut file, priv: *mut c_void, a: *mut v4l2_audio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_audio(file: *mut file, priv: *mut c_void, a: *const v4l2_audio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_g_tuner(file: *mut file, priv: *mut c_void, t: *mut v4l2_tuner) -> c_int {
    ...
    {
    struct au0828_dev *dev = video_drvdata(file);
    let mut new_freq: v4l2_frequency = *freq;
    if (freq.tuner != 0)
    return -EINVAL;
    dprintk(1, "%s called std_set %d dev_state %ld\n", __func__,
    dev.std_set_in_tuner_core, dev.dev_state);
...
#[no_mangle]
unsafe extern "C" fn vidioc_log_status(file: *mut file, fh: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_dqbuf(file: *mut file, priv: *mut c_void, b: *mut v4l2_buffer) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn au0828_v4l2_suspend(dev: *mut au0828_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn au0828_v4l2_resume(dev: *mut au0828_dev) {
...
#[no_mangle]
unsafe extern "C" fn au0828_vb2_setup(dev: *mut au0828_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au0828_analog_create_entities(dev: *mut au0828_dev) {
...
// we find our isoc in endpoint
    let mut tmp: u16 = le16_to_cpu(endpoint.wMaxPacketSize);
