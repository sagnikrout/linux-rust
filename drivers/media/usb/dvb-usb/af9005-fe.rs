...
//! Source: drivers/media/usb/dvb-usb/af9005-fe.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct af9005_fe_state {
    pub d: *mut dvb_usb_device,
    pub stat: enum fe_status,
// retraining parameters
    pub original_fcw: u32,
    pub original_rf_top: u16,
    pub original_if_top: u16,
    pub original_if_min: u16,
    pub original_aci0_if_top: u16,
    pub original_aci1_if_top: u16,
    pub original_aci0_if_min: u16,
    pub original_if_unplug_th: u8,
    pub original_rf_unplug_th: u8,
    pub original_dtop_if_unplug_th: u8,
    pub original_dtop_rf_unplug_th: u8,
// statistics
    pub pre_vit_error_count: u32,
    pub pre_vit_bit_count: u32,
    pub ber: u32,
    pub post_vit_error_count: u32,
    pub post_vit_bit_count: u32,
    pub unc: u32,
    pub abort_count: u16,
    pub opened: c_int,
    pub strong: c_int,
...
#[no_mangle]
unsafe extern "C" fn af9005_is_fecmon_available(fe: *mut dvb_frontend, available: *mut c_int) -> c_int {
...
// abort_count = loc_abort_count;
    ...
    u16 * abort_count)
    {
    let mut loc_cw_count: u32 = 0, loc_err_count;
    let mut loc_abort_count: u16 = 0;
    int ret;
    ret =
...
#[no_mangle]
unsafe extern "C" fn af9005_reset_pre_viterbi(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af9005_reset_post_viterbi(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af9005_get_statistic(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af9005_fe_refresh_state(fe: *mut dvb_frontend) -> c_int {
...
// statistics
    ...
    u8 temp;
    int ret;
    if (fe.ops.tuner_ops.release == core::ptr::null_mut())
    return -ENODEV;
// stat = 0;
...
#[no_mangle]
unsafe extern "C" fn af9005_fe_read_ber(fe: *mut dvb_frontend, ber: *mut *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af9005_fe_read_unc_blocks(fe: *mut dvb_frontend, unc: *mut *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af9005_fe_read_snr(fe: *mut dvb_frontend, snr: *mut *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af9005_fe_program_cfoe(d: *mut dvb_usb_device, bw: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af9005_fe_select_bw(d: *mut dvb_usb_device, bw: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af9005_fe_power(fe: *mut dvb_frontend, on: c_int) -> c_int {
    ...
    ret = af9005_send_command(state.d, 0x03, &temp, 1, core::ptr::null_mut(), 0);
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn af9005_fe_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn c6(_arg: 2) -> read eepr {
    read eepr c6 (2)
#[no_mangle]
pub unsafe extern "C" fn c7(_arg: 2) -> read eepr {
    read eepr c7 (2)
    misc ctrl 3 . 1
#[no_mangle]
pub unsafe extern "C" fn ca(_arg: 6) -> read eepr {
    read eepr ca (6)
...
// read if1 from eeprom
    ...
    &af9005_mt2060_config, if1) == core::ptr::null_mut()) {
    ...
    &af9005_qt1010_config) ==core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn af9005_fe_sleep(fe: *mut dvb_frontend) -> c_int {
    static int af9005_fe_sleep(struct dvb_frontend *fe)
    {
    return af9005_fe_power(fe, 0);
    }
#[no_mangle]
unsafe extern "C" fn af9005_ts_bus_ctrl(fe: *mut dvb_frontend, acquire: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af9005_fe_set_frontend(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af9005_fe_release(fe: *mut dvb_frontend) {
    ...
    {
    struct af9005_fe_state *state = core::ptr::null_mut();
