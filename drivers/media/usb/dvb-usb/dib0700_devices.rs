...
//! Source: drivers/media/usb/dvb-usb/dib0700_devices.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dib0700_adapter_state {
    pub ): *mut *mut int (set_param_save) (struct dvb_frontend,
    pub frontend_firmware: *const firmware,
    pub dib7000p_ops: dib7000p_ops,
    pub dib8000_ops: dib8000_ops,
}
...
#[no_mangle]
unsafe extern "C" fn bristol_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    (10 + adap.id) << 1, &bristol_dib3000mc_config[adap.id])) == core::ptr::null_mut() ? -ENODEV : 0;
    }
#[no_mangle]
unsafe extern "C" fn eeprom_read(adap: *mut i2c_adapter, adrs: u8, pval: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk7700P2_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    return adap.fe_adap[0].fe == core::ptr::null_mut() ? -ENODEV : 0;
    }
#[no_mangle]
unsafe extern "C" fn stk7700d_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk7700d_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    &stk7700d_mt2266_config[adap.id]) == core::ptr::null_mut() ? -ENODEV : 0;
    }
...
#[no_mangle]
unsafe extern "C" fn stk7700ph_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk7700ph_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_attach(_arg: xc2028_attach, _arg: adap->fe_adap[0].fe, _arg: &stk7700ph_xc3028_config) -> return {
    return dvb_attach(xc2028_attach, adap.fe_adap[0].fe, &stk7700ph_xc3028_config)
    == core::ptr::null_mut() ? -ENODEV : 0;
    }
pub const DEFAULT_RC_INTERVAL: c_int = 50;
//
...
//
#[no_mangle]
unsafe extern "C" fn dib0700_rc_query_old_firmware(d: *mut dvb_usb_device) -> c_int {
...
// info("%d: %2X %2X %2X %2X",dvb_usb_dib0700_ir_proto,(int)st->buf[3 - 2],(int)st->buf[3 - 3],(int)st->buf[3 - 1],(int)st->buf[3]);
    dib0700_rc_setup(d, core::ptr::null_mut()); /* reset ir sensor data to prevent false events */
...
#[no_mangle]
unsafe extern "C" fn stk7700p_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk7700p_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    if1) == core::ptr::null_mut() ? -ENODEV : 0;
    }
// DIB7070 generic
...
#[no_mangle]
unsafe extern "C" fn dib7070_tuner_reset(fe: *mut dvb_frontend, onoff: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib7070_tuner_sleep(fe: *mut dvb_frontend, onoff: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib7070_set_param_override(fe: *mut dvb_frontend) -> c_int {
    ...
    struct dib0700_adapter_state *state = adap.priv;
    u16 offset;
    let mut band: u8 = BAND_OF_FREQUENCY(p.frequency/1000);
    switch (band) {
...
#[no_mangle]
unsafe extern "C" fn dib7770_set_param_override(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib7770p_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    &dib7770p_dib0070_config) == core::ptr::null_mut())
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn dib7070p_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
    static int dib7070p_tuner_attach(struct dvb_usb_adapter *adap)
    {
    struct dib0700_adapter_state *st = adap.priv;
    struct i2c_adapter *tun_i2c = st.dib7000p_ops.get_i2c_master(adap.fe_adap[0].fe, DIBX000_I2C_INTERFACE_TUNER, 1);
    if (adap.id == 0) {
    if (dvb_attach(dib0070_attach, adap.fe_adap[0].fe, tun_i2c, &dib7070p_dib0070_config[0]) == core::ptr::null_mut())
    return -ENODEV;
    } else {
    if (dvb_attach(dib0070_attach, adap.fe_adap[0].fe, tun_i2c, &dib7070p_dib0070_config[1]) == core::ptr::null_mut())
    return -ENODEV;
    }
    st.set_param_save = adap.fe_adap[0].fe.ops.tuner_ops.set_params;
...
#[no_mangle]
unsafe extern "C" fn stk7700p_pid_filter_ctrl(adapter: *mut dvb_usb_adapter, onoff: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk70x0p_pid_filter(adapter: *mut dvb_usb_adapter, index: c_int, pid: u16, onoff: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk70x0p_pid_filter_ctrl(adapter: *mut dvb_usb_adapter, onoff: c_int) -> c_int {
...
// STK7070P
#[no_mangle]
unsafe extern "C" fn stk7070p_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk7770p_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib80xx_tuner_reset(fe: *mut dvb_frontend, onoff: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib80xx_tuner_sleep(fe: *mut dvb_frontend, onoff: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib807x_set_param_override(fe: *mut dvb_frontend) -> c_int {
    static int dib807x_set_param_override(struct dvb_frontend *fe)
    {
    struct dtv_frontend_properties *p = &fe.dtv_property_cache;
    struct dvb_usb_adapter *adap = fe.dvb.priv;
    struct dib0700_adapter_state *state = adap.priv;
    let mut offset: u16 = dib0070_wbd_offset(fe);
    let mut band: u8 = BAND_OF_FREQUENCY(p.frequency/1000);
    switch (band) {
    case BAND_VHF:
    offset += 750;
...
#[no_mangle]
unsafe extern "C" fn dib807x_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    if (adap.id == 0) {
    if (dvb_attach(dib0070_attach, adap.fe_adap[0].fe, tun_i2c,
    &dib807x_dib0070_config[0]) == core::ptr::null_mut())
    return -ENODEV;
    } else {
    if (dvb_attach(dib0070_attach, adap.fe_adap[0].fe, tun_i2c,
    &dib807x_dib0070_config[1]) == core::ptr::null_mut())
    return -ENODEV;
    }
    st.set_param_save = adap.fe_adap[0].fe.ops.tuner_ops.set_params;
...
// STK807x
#[no_mangle]
unsafe extern "C" fn stk807x_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
// STK807xPVR
#[no_mangle]
unsafe extern "C" fn stk807xpvr_frontend_attach0(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk807xpvr_frontend_attach1(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib8090_get_adc_power(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib8090_agc_control(fe: *mut dvb_frontend, restart: u8) {
...
#[no_mangle]
unsafe extern "C" fn dib8090_compute_pll_parameters(fe: *mut dvb_frontend) -> u8 {
    static u8 dib8090_compute_pll_parameters(struct dvb_frontend *fe)
    {
    let mut optimal_pll_ratio: u8 = 20;
...
#[no_mangle]
unsafe extern "C" fn dib8096_set_param_override(fe: *mut dvb_frontend) -> c_int {
    ...
    u32 timf;
    let mut ret: c_int = 0;
    let mut tune_state: enum frontend_tune_state = CT_SHUTDOWN;
    switch (band) {
    default:
...
// Get optimize PLL ratio to remove spurious
    ...
    timf = 21387946;
#[no_mangle]
pub unsafe extern "C" fn if(18: pll_ratio ==) -> else {
    else if (pll_ratio == 18)
    timf = 20199727;
#[no_mangle]
pub unsafe extern "C" fn if(19: pll_ratio ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(CT_AGC_STEP_1: tune_state ==) -> else {
    dib0090_get_current_gain(fe, core::ptr::null_mut(), core::ptr::null_mut(), &rf_gain_limit, &ltgain);
...
#[no_mangle]
unsafe extern "C" fn dib809x_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk809x_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk809x_frontend1_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nim8096md_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    if (dvb_attach(dib0090_register, fe_slave, tun_i2c, &dib809x_dib0090_config) == core::ptr::null_mut())
    return -ENODEV;
    fe_slave.dvb = adap.fe_adap[0].fe.dvb;
    fe_slave.ops.tuner_ops.set_params = dib8096_set_param_override;
    }
    tun_i2c = st.dib8000_ops.get_i2c_master(adap.fe_adap[0].fe, DIBX000_I2C_INTERFACE_TUNER, 1);
    if (dvb_attach(dib0090_register, adap.fe_adap[0].fe, tun_i2c, &dib809x_dib0090_config) == core::ptr::null_mut())
    return -ENODEV;
    st.set_param_save = adap.fe_adap[0].fe.ops.tuner_ops.set_params;
    adap.fe_adap[0].fe.ops.tuner_ops.set_params = dib8096_set_param_override;
    return 0;
...
#[no_mangle]
unsafe extern "C" fn nim8096md_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
// Needed to increment refcount
    ...
    let mut fe_slave: return = = core::ptr::null_mut() ?  -ENODEV : 0;
    }
// TFE8096P
...
// P_agc_use_sd_mod1=0, P_agc_use_sd_mod2=0,
    ...
    .ls_cfg_pad_drv			= 0,
    .data_tx_drv			= 0,
    .low_if					= core::ptr::null_mut(),
    .in_soc					= 1,
    .force_cband_input		= 0,
    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dibx090p_best_adc {
    pub timf: u32,
    pub pll_loopdiv: u32,
    pub pll_prediv: u32,
}
...
#[no_mangle]
unsafe extern "C" fn dib8096p_get_best_sampling(fe: *mut dvb_frontend, adc: *mut dibx090p_best_adc) -> c_int {
    static int dib8096p_get_best_sampling(struct dvb_frontend *fe, struct dibx090p_best_adc *adc)
    {
    let mut spur: u8 = 0, prediv = 0, loopdiv = 0, min_prediv = 1, max_prediv = 1;
    let mut xtal: u16 = 12000;
    ...
    let mut fdem_min: u32 = 66000;
    let mut fcp: u32 = 0, fs = 0, fdem = 0, fmem = 0;
    let mut harmonic_id: u32 = 0;
    adc.timf = 0;
...
#[no_mangle]
unsafe extern "C" fn dib8096p_agc_startup(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tfe8096p_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    if (!dvb_attach(dib8000_attach, &state.dib8000_ops))
    return -ENODEV;
    dib0700_get_version(adap.dev, core::ptr::null_mut(), core::ptr::null_mut(), &fw_version, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn tfe8096p_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    &tfe8096p_dib0090_config) == core::ptr::null_mut())
    return -ENODEV;
...
// STK9090M
#[no_mangle]
unsafe extern "C" fn dib90x0_pid_filter(adapter: *mut dvb_usb_adapter, index: c_int, pid: u16, onoff: c_int) -> c_int {
    static int dib90x0_pid_filter(struct dvb_usb_adapter *adapter, int index, u16 pid, int onoff)
    {
    return dib9000_fw_pid_filter(adapter.fe_adap[0].fe, index, pid, onoff);
    }
#[no_mangle]
unsafe extern "C" fn dib90x0_pid_filter_ctrl(adapter: *mut dvb_usb_adapter, onoff: c_int) -> c_int {
    static int dib90x0_pid_filter_ctrl(struct dvb_usb_adapter *adapter, int onoff)
    {
    return dib9000_fw_pid_filter_ctrl(adapter.fe_adap[0].fe, onoff);
    }
#[no_mangle]
unsafe extern "C" fn dib90x0_tuner_reset(fe: *mut dvb_frontend, onoff: c_int) -> c_int {
    static int dib90x0_tuner_reset(struct dvb_frontend *fe, int onoff)
    {
    return dib9000_set_gpio(fe, 5, 0, !onoff);
    }
#[no_mangle]
unsafe extern "C" fn dib90x0_tuner_sleep(fe: *mut dvb_frontend, onoff: c_int) -> c_int {
    static int dib90x0_tuner_sleep(struct dvb_frontend *fe, int onoff)
    {
    return dib9000_set_gpio(fe, 0, 0, onoff);
    }
#[no_mangle]
unsafe extern "C" fn dib01x0_pmu_update(i2c: *mut i2c_adapter, data: *mut u16, len: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk9090m_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib9090_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    return -ENODEV;
    if (dvb_attach(dib0090_fw_register, adap.fe_adap[0].fe, i2c, &dib9090_dib0090_config) == core::ptr::null_mut())
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn nim9090md_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nim9090md_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    if (dvb_attach(dib0090_fw_register, adap.fe_adap[0].fe, i2c, &nim9090md_dib0090_config[0]) == core::ptr::null_mut())
    return -ENODEV;
    i2c = dib9000_get_i2c_master(adap.fe_adap[0].fe, DIBX000_I2C_INTERFACE_GPIO_1_2, 0);
    if (!i2c)
    return -ENODEV;
    ...
    if (fe_slave != core::ptr::null_mut()) {
    i2c = dib9000_get_component_bus_interface(adap.fe_adap[0].fe);
    dib9000_set_i2c_adapter(fe_slave, i2c);
    i2c = dib9000_get_tuner_interface(fe_slave);
    if (dvb_attach(dib0090_fw_register, fe_slave, i2c, &nim9090md_dib0090_config[1]) == core::ptr::null_mut())
    return -ENODEV;
    fe_slave.dvb = adap.fe_adap[0].fe.dvb;
...
// NIM7090
#[no_mangle]
unsafe extern "C" fn dib7090p_get_best_sampling(fe: *mut dvb_frontend, adc: *mut dibx090p_best_adc) -> c_int {
    ...
    let mut fdem_max: u32 = 76000;
    let mut fdem_min: u32 = 69500;
    let mut fcp: u32 = 0, fs = 0, fdem = 0;
    let mut harmonic_id: u32 = 0;
    adc.pll_loopdiv = loopdiv;
    adc.pll_prediv = prediv;
    adc.timf = 0;
...
#[no_mangle]
unsafe extern "C" fn dib7090_agc_startup(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib7090_agc_restart(fe: *mut dvb_frontend, restart: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tfe7790p_update_lna(fe: *mut dvb_frontend, agc_global: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tfe7090p_pvr_update_lna(fe: *mut dvb_frontend, agc_global: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nim7090_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nim7090_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    if (dvb_attach(dib0090_register, adap.fe_adap[0].fe, tun_i2c, &nim7090_dib0090_config) == core::ptr::null_mut())
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn tfe7090pvr_frontend0_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tfe7090pvr_frontend1_attach(adap: *mut dvb_usb_adapter) -> c_int {
    static int tfe7090pvr_frontend1_attach(struct dvb_usb_adapter *adap)
    {
    struct i2c_adapter *i2c;
    struct dib0700_adapter_state *state = adap.priv;
    if (adap.dev.adapter[0].fe_adap[0].fe == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn tfe7090pvr_tuner0_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    if (dvb_attach(dib0090_register, adap.fe_adap[0].fe, tun_i2c, &tfe7090pvr_dib0090_config[0]) == core::ptr::null_mut())
    return -ENODEV;
    st.dib7000p_ops.set_gpio(adap.fe_adap[0].fe, 8, 0, 1);
    st.set_param_save = adap.fe_adap[0].fe.ops.tuner_ops.set_params;
    adap.fe_adap[0].fe.ops.tuner_ops.set_params = dib7090_agc_startup;
...
#[no_mangle]
unsafe extern "C" fn tfe7090pvr_tuner1_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    if (dvb_attach(dib0090_register, adap.fe_adap[0].fe, tun_i2c, &tfe7090pvr_dib0090_config[1]) == core::ptr::null_mut())
    return -ENODEV;
    st.dib7000p_ops.set_gpio(adap.fe_adap[0].fe, 8, 0, 1);
    st.set_param_save = adap.fe_adap[0].fe.ops.tuner_ops.set_params;
    adap.fe_adap[0].fe.ops.tuner_ops.set_params = dib7090_agc_startup;
...
#[no_mangle]
unsafe extern "C" fn tfe7790p_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tfe7790p_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
    ...
    if (dvb_attach(dib0090_register, adap.fe_adap[0].fe, tun_i2c,
    &tfe7790p_dib0090_config) == core::ptr::null_mut())
    return -ENODEV;
    st.dib7000p_ops.set_gpio(adap.fe_adap[0].fe, 8, 0, 1);
    st.set_param_save = adap.fe_adap[0].fe.ops.tuner_ops.set_params;
    adap.fe_adap[0].fe.ops.tuner_ops.set_params = dib7090_agc_startup;
...
#[no_mangle]
unsafe extern "C" fn stk7070pd_init(dev: *mut dvb_usb_device) {
...
#[no_mangle]
unsafe extern "C" fn stk7070pd_frontend_attach0(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk7070pd_frontend_attach1(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn novatd_sleep_override(fe: *mut *mut dvb_frontend) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn novatd_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5h1411_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xc5000_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pctv340e_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xc4000_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lgdt3305_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxl5007t_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
    static int mxl5007t_tuner_attach(struct dvb_usb_adapter *adap)
    {
    return dvb_attach(mxl5007t_attach, adap.fe_adap[0].fe,
    &adap.dev.i2c_adap, 0x60,
    &hcw_mxl5007t_config) == core::ptr::null_mut() ? -ENODEV : 0;
    }
#[no_mangle]
unsafe extern "C" fn xbox_one_attach(adap: *mut dvb_usb_adapter) -> c_int {
    static int xbox_one_attach(struct dvb_usb_adapter *adap)
    {
    struct dib0700_state *st = adap.dev.priv;
    struct i2c_client *client_demod, *client_tuner;
    struct dvb_usb_device *d = adap.dev;
    let mut mn88472_config: mn88472_config = { };
...
// DVB-USB and USB stuff follows
    ...
    { &dib0700_usb_id_table[HAUPPAUGE_NOVA_T_STICK], &dib0700_usb_id_table[HAUPPAUGE_NOVA_T_STICK_2], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    ...
    { &dib0700_usb_id_table[UNIWILL_STK7700P], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    ...
    {   "Gigabyte U7000",
    { &dib0700_usb_id_table[GIGABYTE_U7000], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    }
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[HAUPPAUGE_NOVA_T_500], &dib0700_usb_id_table[HAUPPAUGE_NOVA_T_500_2], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    .devices = {
    {   "Pinnacle PCTV 2000e",
    { &dib0700_usb_id_table[PINNACLE_PCTV2000E], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Terratec Cinergy DT XS Diversity",
    { &dib0700_usb_id_table[TERRATEC_CINERGY_DT_XS_DIVERSITY], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Hauppauge Nova-TD Stick/Elgato Eye-TV Diversity",
    { &dib0700_usb_id_table[HAUPPAUGE_NOVA_TD_STICK], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "DiBcom STK7700D reference design",
    { &dib0700_usb_id_table[DIBCOM_STK7700D], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "YUAN High-Tech DiBcom STK7700D",
    { &dib0700_usb_id_table[YUAN_STK7700D_2], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[ASUS_U3000], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Yuan EC372S",
    { &dib0700_usb_id_table[YUAN_EC372S], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Terratec Cinergy T Express",
    { &dib0700_usb_id_table[TERRATEC_CINERGY_T_EXPRESS], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    }
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[DIBCOM_STK7070P], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Pinnacle PCTV DVB-T Flash Stick",
    { &dib0700_usb_id_table[PINNACLE_PCTV_DVB_T_FLASH], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Artec T14BR DVB-T",
    { &dib0700_usb_id_table[ULTIMA_ARTEC_T14BR], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "ASUS My Cinema U3100 Mini DVBT Tuner",
    { &dib0700_usb_id_table[ASUS_U3100], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Hauppauge Nova-T Stick",
    { &dib0700_usb_id_table[HAUPPAUGE_NOVA_T_STICK_3], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Hauppauge Nova-T MyTV.t",
    { &dib0700_usb_id_table[HAUPPAUGE_MYTV_T], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Pinnacle PCTV 72e",
    { &dib0700_usb_id_table[PINNACLE_PCTV72E], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Pinnacle PCTV 73e",
    { &dib0700_usb_id_table[PINNACLE_PCTV73E], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Elgato EyeTV DTT",
    { &dib0700_usb_id_table[ELGATO_EYETV_DTT], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Yuan PD378S",
    { &dib0700_usb_id_table[YUAN_PD378S], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Elgato EyeTV Dtt Dlx PD378S",
    { &dib0700_usb_id_table[ELGATO_EYETV_DTT_Dlx], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Elgato EyeTV DTT rev. 2",
    { &dib0700_usb_id_table[ELGATO_EYETV_DTT_2], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    .devices = {
    {   "Pinnacle PCTV 73A",
    { &dib0700_usb_id_table[PINNACLE_PCTV73A], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Pinnacle PCTV 73e SE",
    { &dib0700_usb_id_table[PCTV_PINNACLE_PCTV73ESE], &dib0700_usb_id_table[PINNACLE_PCTV73ESE], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Pinnacle PCTV 282e",
    { &dib0700_usb_id_table[PCTV_PINNACLE_PCTV282E], &dib0700_usb_id_table[PINNACLE_PCTV282E], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[HAUPPAUGE_NOVA_TD_STICK_52009], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "PCTV 2002e",
    { &dib0700_usb_id_table[PCTV_2002E], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "PCTV 2002e SE",
    { &dib0700_usb_id_table[PCTV_2002E_SE], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[DIBCOM_STK7070PD], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Pinnacle PCTV Dual DVB-T Diversity Stick",
    { &dib0700_usb_id_table[PINNACLE_PCTV_DUAL_DIVERSITY_DVB_T], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Hauppauge Nova-TD-500 (84xxx)",
    { &dib0700_usb_id_table[HAUPPAUGE_NOVA_T_500_3], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {  "Terratec Cinergy DT USB XS Diversity/ T5",
    { &dib0700_usb_id_table[TERRATEC_CINERGY_DT_XS_DIVERSITY_2],
    &dib0700_usb_id_table[TERRATEC_T5], core::ptr::null_mut()},
    { core::ptr::null_mut() },
    },
    {  "Sony PlayTV",
    { &dib0700_usb_id_table[SONY_PLAYTV], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[ELGATO_EYETV_DIVERSITY], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[TERRATEC_CINERGY_HT_USB_XE], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Pinnacle Expresscard 320cx",
    { &dib0700_usb_id_table[PINNACLE_EXPRESSCARD_320CX], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Terratec Cinergy HT Express",
    { &dib0700_usb_id_table[TERRATEC_CINERGY_HT_EXPRESS], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Gigabyte U8000-RH",
    { &dib0700_usb_id_table[GIGABYTE_U8000], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "YUAN High-Tech STK7700PH",
    { &dib0700_usb_id_table[YUAN_STK7700PH], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Asus My Cinema-U3000Hybrid",
    { &dib0700_usb_id_table[ASUS_U3000H], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "YUAN High-Tech MC770",
    { &dib0700_usb_id_table[YUAN_MC770], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Leadtek WinFast DTV Dongle H",
    { &dib0700_usb_id_table[LEADTEK_WINFAST_DTV_DONGLE_H], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "YUAN High-Tech STK7700D",
    { &dib0700_usb_id_table[YUAN_STK7700D], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Hama DVB=T Hybrid USB Stick",
    { &dib0700_usb_id_table[HAMA_DVBT_HYBRID], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[PINNACLE_PCTV801E], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Pinnacle PCTV HD USB Stick",
    { &dib0700_usb_id_table[PINNACLE_PCTV801E_SE], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[HAUPPAUGE_TIGER_ATSC], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Hauppauge ATSC MiniCard (B210)",
    { &dib0700_usb_id_table[HAUPPAUGE_TIGER_ATSC_B210], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    }, { DIB0700_DEFAULT_DEVICE_PROPERTIES,
    ...
    { &dib0700_usb_id_table[DIBCOM_STK7770P], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Terratec Cinergy T USB XXS (HD)/ T3",
    { &dib0700_usb_id_table[TERRATEC_CINERGY_T_XXS],
    &dib0700_usb_id_table[TERRATEC_T3],
    &dib0700_usb_id_table[TERRATEC_CINERGY_T_XXS_2], core::ptr::null_mut()},
    { core::ptr::null_mut() },
    },
    {   "TechniSat AirStar TeleStick 2",
    { &dib0700_usb_id_table[TECHNISAT_AIRSTAR_TELESTICK_2], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Medion CTX1921 DVB-T USB",
    { &dib0700_usb_id_table[MEDION_CREATIX_CTX1921], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[DIBCOM_STK807XP], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Prolink Pixelview SBTVD",
    { &dib0700_usb_id_table[PIXELVIEW_SBTVD], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "EvolutePC TVWay+",
    { &dib0700_usb_id_table[EVOLUTEPC_TVWAY_PLUS], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[DIBCOM_STK807XPVR], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[DIBCOM_STK8096GP], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[DIBCOM_NIM9090M], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[DIBCOM_NIM8096MD], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[DIBCOM_NIM9090MD], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[DIBCOM_NIM7090], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[DIBCOM_TFE7090PVR], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[PINNACLE_PCTV340E], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    {   "Pinnacle PCTV Hybrid Stick Solo",
    { &dib0700_usb_id_table[PINNACLE_PCTV340E_SE], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[DIBCOM_TFE7790P], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[DIBCOM_TFE8096P], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    &dib0700_usb_id_table[DIBCOM_STK8096PVR], core::ptr::null_mut()},
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
    ...
    { &dib0700_usb_id_table[MICROSOFT_XBOX_ONE_TUNER], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    },
    };
    let mut dib0700_device_count: c_int = ARRAY_SIZE(dib0700_devices);
