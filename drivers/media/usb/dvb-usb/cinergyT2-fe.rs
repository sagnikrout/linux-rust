...
//! Source: drivers/media/usb/dvb-usb/cinergyT2-fe.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn compute_tps(op: *mut dtv_frontend_properties) -> u16 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cinergyt2_fe_state {
    pub fe: dvb_frontend,
    pub d: *mut dvb_usb_device,
    pub data: [c_uchar; 64],
    pub data_mutex: mutex,
    pub status: dvbt_get_status_msg,
}
...
#[no_mangle]
unsafe extern "C" fn cinergyt2_fe_read_ber(fe: *mut dvb_frontend, ber: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cinergyt2_fe_read_unc_blocks(fe: *mut dvb_frontend, unc: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cinergyt2_fe_read_snr(fe: *mut dvb_frontend, snr: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cinergyt2_fe_init(fe: *mut dvb_frontend) -> c_int {
    static int cinergyt2_fe_init(struct dvb_frontend *fe)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn cinergyt2_fe_sleep(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cinergyt2_fe_set_frontend(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cinergyt2_fe_release(fe: *mut dvb_frontend) {
