...
//! Source: drivers/media/usb/dvb-usb/pctv452e.c
#![no_std]
...
pub const ISOC_INTERFACE_ALTERNATIVE: c_int = 3;
pub const SYNC_BYTE_OUT: c_uint = 0xaa;
pub const SYNC_BYTE_IN: c_uint = 0x55;
// guessed: (copied from ttusb-budget)
pub const PCTV_CMD_RESET: c_uint = 0x15;
// command to poll IR receiver
pub const PCTV_CMD_IR: c_uint = 0x1b;
// command to send I2C
pub const PCTV_CMD_I2C: c_uint = 0x31;

// pctv452e sends us this amount of data for each issued usb-command
pub const PCTV_ANSWER_LEN: c_int = 64;
// Wait up to 1000ms for device
pub const PCTV_TIMEOUT: c_int = 1000;

pub const PCTV_LED_GREEN: c_uint = 0x82;
pub const PCTV_LED_ORANGE: c_uint = 0x02;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pctv452e_state {
    pub ca: dvb_ca_en50221,
    pub ca_mutex: mutex,
    pub /: *mut *mut u8 c; / transaction counter, wraps around...,
    pub /: *mut *mut u8 initialized; / set to 1 if 0x15 has been sent,
    pub last_rc_key: u16,
}
...
#[no_mangle]
unsafe extern "C" fn tt3650_ci_slot_shutdown(ca: *mut dvb_ca_en50221, slot: c_int) -> c_int {
    static int tt3650_ci_slot_shutdown(struct dvb_ca_en50221 *ca, int slot)
    {
    return tt3650_ci_set_video_port(ca, slot, /* enable */ 0);
    }
#[no_mangle]
unsafe extern "C" fn tt3650_ci_slot_ts_enable(ca: *mut dvb_ca_en50221, slot: c_int) -> c_int {
    static int tt3650_ci_slot_ts_enable(struct dvb_ca_en50221 *ca, int slot)
    {
    return tt3650_ci_set_video_port(ca, slot, /* enable */ 1);
    }
#[no_mangle]
unsafe extern "C" fn tt3650_ci_slot_reset(ca: *mut dvb_ca_en50221, slot: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tt3650_ci_uninit(d: *mut dvb_usb_device) {
...
#[no_mangle]
unsafe extern "C" fn tt3650_ci_init(a: *mut dvb_usb_adapter) -> c_int {
...
pub const CMD_BUFFER_SIZE: c_uint = 0x28;
...
#[no_mangle]
unsafe extern "C" fn pctv452e_i2c_func(adapter: *mut i2c_adapter) -> u32 {
    static u32 pctv452e_i2c_func(struct i2c_adapter *adapter)
    {
    return I2C_FUNC_I2C;
    }
#[no_mangle]
unsafe extern "C" fn pctv452e_power_ctrl(d: *mut dvb_usb_device, i: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pctv452e_rc_query(d: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pctv452e_read_mac_address(d: *mut dvb_usb_device, mac[6]: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pctv452e_frontend_attach(a: *mut dvb_usb_adapter) -> c_int {
    ...
    a.fe_adap[0].fe,
    &a.dev.i2c_adap) == core::ptr::null_mut()) {
...
// Error ignored.
    ...
    a.fe_adap[0].fe,
    &a.dev.i2c_adap,
    &pctv452e_isl6423_config) == core::ptr::null_mut()) {
    err("Cannot attach isl6423\n");
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn pctv452e_tuner_attach(a: *mut dvb_usb_adapter) -> c_int {
...
// parameter for the MPEG2-data transfer
    ...
    .devices = {
    { .name = "PCTV HDTV USB",
    .cold_ids = { core::ptr::null_mut(), core::ptr::null_mut() }, /* this is a warm only device */
    .warm_ids = { &pctv452e_usb_table[PINNACLE_PCTV_452E], core::ptr::null_mut() }
    },
    { core::ptr::null_mut() },
    }
    };
...
// parameter for the MPEG2-data transfer
    ...
    .cold_ids = { core::ptr::null_mut(), core::ptr::null_mut() }, /* this is a warm only device */
    .warm_ids = { &pctv452e_usb_table[TECHNOTREND_CONNECT_S2_3600], core::ptr::null_mut() }
    },
    { .name = "Technotrend TT Connect S2-3650-CI",
    .cold_ids = { core::ptr::null_mut(), core::ptr::null_mut() },
    .warm_ids = { &pctv452e_usb_table[TECHNOTREND_CONNECT_S2_3650_CI], core::ptr::null_mut() }
    },
    { core::ptr::null_mut() },
    }
    };
#[no_mangle]
unsafe extern "C" fn pctv452e_usb_disconnect(intf: *mut usb_interface) {
