...
//! Source: drivers/media/usb/dvb-usb/nova-t-usb2.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn nova_t_rc_query(d: *mut dvb_usb_device, event: *mut u32, state: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nova_t_read_mac_address(d: *mut dvb_usb_device, mac[6]: u8) -> c_int {
...
// parameter for the MPEG2-data transfer
    ...
    { &nova_t_table[HAUPPAUGE_WINTV_NOVA_T_USB2_COLD], core::ptr::null_mut() },
    { &nova_t_table[HAUPPAUGE_WINTV_NOVA_T_USB2_WARM], core::ptr::null_mut() },
    },
    { core::ptr::null_mut() },
    }
    };
