...
//! Source: drivers/media/usb/dvb-usb/a800.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn a800_power_ctrl(d: *mut dvb_usb_device, onoff: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn a800_rc_query(d: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(2: key[0] ==) -> else {
    else if (key[0] == 2)
    rc_repeat(d.rc_dev);
    out:
    kfree(key);
...
// parameter for the MPEG2-data transfer
    ...
    { &a800_table[AVERMEDIA_DVBT_USB2_COLD], core::ptr::null_mut() },
    { &a800_table[AVERMEDIA_DVBT_USB2_WARM], core::ptr::null_mut() },
    },
    }
    };
