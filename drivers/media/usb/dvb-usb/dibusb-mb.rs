...
//! Source: drivers/media/usb/dvb-usb/dibusb-mb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dib3000mb_i2c_gate_ctrl(fe: *mut *mut dvb_frontend, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dibusb_dib3000mb_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dibusb_thomson_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dibusb_panasonic_tuner_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
// this out.
#[no_mangle]
unsafe extern "C" fn dibusb_tuner_probe_and_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
// parameter for the MPEG2-data transfer
    ...
    { &dibusb_dib3000mb_table[WIDEVIEW_DVBT_USB_COLD],  core::ptr::null_mut() },
    { &dibusb_dib3000mb_table[WIDEVIEW_DVBT_USB_WARM],  core::ptr::null_mut() },
    },
    {	"Compro Videomate DVB-U2000 - DVB-T USB1.1 (please confirm to linux-dvb)",
    { &dibusb_dib3000mb_table[COMPRO_DVBU2000_COLD], &dibusb_dib3000mb_table[COMPRO_DVBU2000_UNK_COLD], core::ptr::null_mut()},
    { &dibusb_dib3000mb_table[COMPRO_DVBU2000_WARM], core::ptr::null_mut() },
    },
    {	"DiBcom USB1.1 DVB-T reference design (MOD3000)",
    { &dibusb_dib3000mb_table[DIBCOM_MOD3000_COLD],  core::ptr::null_mut() },
    { &dibusb_dib3000mb_table[DIBCOM_MOD3000_WARM],  core::ptr::null_mut() },
    },
    {	"KWorld V-Stream XPERT DTV - DVB-T USB1.1",
    { &dibusb_dib3000mb_table[EMPIA_VSTREAM_COLD], core::ptr::null_mut() },
    { &dibusb_dib3000mb_table[EMPIA_VSTREAM_WARM], core::ptr::null_mut() },
    },
    {	"Grandtec USB1.1 DVB-T",
    { &dibusb_dib3000mb_table[GRANDTEC_DVBT_USB_COLD],  &dibusb_dib3000mb_table[GRANDTEC_MOD3000_COLD], core::ptr::null_mut() },
    { &dibusb_dib3000mb_table[GRANDTEC_DVBT_USB_WARM], &dibusb_dib3000mb_table[GRANDTEC_MOD3000_WARM], core::ptr::null_mut() },
    },
    {	"Unknown USB1.1 DVB-T device ???? please report the name to the author",
    { &dibusb_dib3000mb_table[UNK_HYPER_PALTEK_COLD], core::ptr::null_mut() },
    { &dibusb_dib3000mb_table[UNK_HYPER_PALTEK_WARM], core::ptr::null_mut() },
    },
    {	"TwinhanDTV USB-Ter USB1.1 / Magic Box I / HAMA USB1.1 DVB-T device",
    { &dibusb_dib3000mb_table[VISIONPLUS_VP7041_COLD], &dibusb_dib3000mb_table[TWINHAN_VP7041_COLD], core::ptr::null_mut()},
    { &dibusb_dib3000mb_table[VISIONPLUS_VP7041_WARM], &dibusb_dib3000mb_table[TWINHAN_VP7041_WARM], core::ptr::null_mut()},
    },
    {	"Artec T1 USB1.1 TVBOX with AN2135",
    { &dibusb_dib3000mb_table[ULTIMA_TVBOX_COLD], core::ptr::null_mut() },
    { &dibusb_dib3000mb_table[ULTIMA_TVBOX_WARM], core::ptr::null_mut() },
    },
    {	"VideoWalker DVB-T USB",
    { &dibusb_dib3000mb_table[KYE_DVB_T_COLD], core::ptr::null_mut() },
    { &dibusb_dib3000mb_table[KYE_DVB_T_WARM], core::ptr::null_mut() },
    },
    }
    };
    static struct dvb_usb_device_properties dibusb1_1_an2235_properties = {
...
// parameter for the MPEG2-data transfer
    ...
    { &dibusb_dib3000mb_table[ULTIMA_TVBOX_AN2235_COLD], core::ptr::null_mut() },
    { &dibusb_dib3000mb_table[ULTIMA_TVBOX_AN2235_WARM], core::ptr::null_mut() },
    },

    {	"Artec T1 USB1.1 TVBOX with AN2235 (faulty USB IDs)",
    { &dibusb_dib3000mb_table[ULTIMA_TVBOX_ANCHOR_COLD], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    { core::ptr::null_mut() },
...
// parameter for the MPEG2-data transfer
    ...
    { &dibusb_dib3000mb_table[ADSTECH_USB2_COLD], core::ptr::null_mut() },
    { &dibusb_dib3000mb_table[ADSTECH_USB2_WARM], core::ptr::null_mut() },
    },
    {	"KWorld Xpert DVB-T USB2.0",
    { &dibusb_dib3000mb_table[KWORLD_VSTREAM_COLD], core::ptr::null_mut() },
    { core::ptr::null_mut() }
    },
    { core::ptr::null_mut() },
    }
...
// parameter for the MPEG2-data transfer
    ...
    .devices = {
    {	"Artec T1 USB2.0",
    { &dibusb_dib3000mb_table[ULTIMA_TVBOX_USB2_COLD], core::ptr::null_mut() },
    { &dibusb_dib3000mb_table[ULTIMA_TVBOX_USB2_WARM], core::ptr::null_mut() },
    },
    { core::ptr::null_mut() },
    }
    };
