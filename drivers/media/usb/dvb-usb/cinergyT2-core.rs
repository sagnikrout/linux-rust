...
//! Source: drivers/media/usb/dvb-usb/cinergyT2-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cinergyt2_streaming_ctrl(adap: *mut dvb_usb_adapter, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cinergyt2_power_ctrl(d: *mut dvb_usb_device, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cinergyt2_frontend_attach(adap: *mut dvb_usb_adapter) -> c_int {
...
pub const RC_REPEAT_DELAY: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn cinergyt2_rc_query(d: *mut dvb_usb_device, event: *mut u32, state: *mut c_int) -> c_int {
...
// parameter for the MPEG2-data transfer
    ...
    .cold_ids = {core::ptr::null_mut()},
    .warm_ids = { &cinergyt2_usb_table[TERRATEC_CINERGY_T2], core::ptr::null_mut() },
    },
    { core::ptr::null_mut() },
    }
    };
