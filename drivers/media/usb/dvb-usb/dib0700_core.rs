...
//! Source: drivers/media/usb/dvb-usb/dib0700_core.c
#![no_std]
...
// debug
    ...
    let mut nb_packet_buffer_size: static int = 21;
...
#[no_mangle]
unsafe extern "C" fn dib0700_ctrl_wr(d: *mut dvb_usb_device, tx: *mut u8, txlen: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dib0700_ctrl_rd(d: *mut dvb_usb_device, tx: *mut u8, txlen: u8, rx: *mut u8, rxlen: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dib0700_set_gpio(d: *mut dvb_usb_device, gpio: enum dib07x0_gpios, gpio_dir: u8, gpio_val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib0700_set_usb_xfer_len(d: *mut dvb_usb_device, nb_ts_packets: u16) -> c_int {
...
// The new i2c firmware messages are more reliable and in particular
    ...
    let mut en_start: u8 = 0;
    let mut en_stop: u8 = 0;
    int result, i;
...
#[no_mangle]
unsafe extern "C" fn dib0700_i2c_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn dib0700_set_i2c_speed(d: *mut dvb_usb_device, scl_kHz: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dib0700_ctrl_clock(d: *mut dvb_usb_device, clk_MHz: u32, clock_out_gp3: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib0700_jumpram(udev: *mut usb_device, address: u32) -> c_int {
    static int dib0700_jumpram(struct usb_device *udev, u32 address)
    {
    let mut ret: c_int = 0, actlen;
    u8 *buf;
...
#[no_mangle]
pub unsafe extern "C" fn dib0700_download_firmware(udev: *mut usb_device, fw: *const firmware) -> c_int {
    int dib0700_download_firmware(struct usb_device *udev, const struct firmware *fw)
    {
    struct hexline hx;
    let mut pos: c_int = 0, ret, act_len, i, adap_num;
    u8 *buf;
    u32 fw_version;
...
#[no_mangle]
pub unsafe extern "C" fn dib0700_streaming_ctrl(adap: *mut dvb_usb_adapter, onoff: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dib0700_change_protocol(rc: *mut rc_dev, rc_proto: *mut u64) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dib0700_rc_response {
    pub report_id: u8,
    pub data_state: u8,
    union {
    struct {
...
pub const RC_MSG_SIZE_V1_20: c_int = 6;
#[no_mangle]
unsafe extern "C" fn dib0700_rc_urb_completion(purb: *mut urb) {
...
#[no_mangle]
pub unsafe extern "C" fn dib0700_rc_setup(d: *mut dvb_usb_device, intf: *mut usb_interface) -> c_int {
...
// Starting in firmware 1.20, the RC info is provided on a bulk pipe
    ...
    if (purb == core::ptr::null_mut())
    return -ENOMEM;
    purb.transfer_buffer = kzalloc(RC_MSG_SIZE_V1_20, GFP_KERNEL);
    if (purb.transfer_buffer == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn dib0700_disconnect(intf: *mut usb_interface) {
