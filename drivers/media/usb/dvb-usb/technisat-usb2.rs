...
//! Source: drivers/media/usb/dvb-usb/technisat-usb2.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct technisat_usb2_state {
    pub dev: *mut dvb_usb_device,
    pub green_led_work: delayed_work,
    pub power_state: u8,
    pub last_scan_code: u16,
    pub buf: [u8; 64],
}
...
// vendor requests
pub const SET_IFCLK_TO_EXTERNAL_TSCLK_VENDOR_REQUEST: c_uint = 0xB3;
pub const SET_FRONT_END_RESET_VENDOR_REQUEST: c_uint = 0xB4;
pub const GET_VERSION_INFO_VENDOR_REQUEST: c_uint = 0xB5;
pub const SET_GREEN_LED_VENDOR_REQUEST: c_uint = 0xB6;
pub const SET_RED_LED_VENDOR_REQUEST: c_uint = 0xB7;
pub const GET_IR_DATA_VENDOR_REQUEST: c_uint = 0xB8;
pub const SET_LED_TIMER_DIVIDER_VENDOR_REQUEST: c_uint = 0xB9;
pub const SET_USB_REENUMERATION: c_uint = 0xBA;
// i2c-access methods
pub const I2C_SPEED_100KHZ_BIT: c_uint = 0x40;
pub const I2C_STATUS_NAK: c_int = 7;
pub const I2C_STATUS_OK: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn technisat_usb2_i2c_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn technisat_usb2_frontend_reset(udev: *mut usb_device) {
...
#[no_mangle]
unsafe extern "C" fn technisat_usb2_set_led_timer(d: *mut dvb_usb_device, red: u8, green: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn technisat_usb2_green_led_control(work: *mut work_struct) {
...
// power control
#[no_mangle]
unsafe extern "C" fn technisat_usb2_power_ctrl(d: *mut dvb_usb_device, level: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn technisat_usb2_eeprom_dump(d: *mut dvb_usb_device) {
...
#[no_mangle]
unsafe extern "C" fn technisat_usb2_calc_lrc(b: *const u8, length: u16) -> u8 {
...
pub const EEPROM_MAC_START: c_uint = 0x3f8;
pub const EEPROM_MAC_TOTAL: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn technisat_usb2_frontend_attach(a: *mut dvb_usb_adapter) -> c_int {
...
// if everything was successful assign a nice name to the frontend
    ...
    a.fe_adap[0].fe = core::ptr::null_mut();
    }
    }
    technisat_usb2_set_led_timer(a.dev, 1, 1);
    return a.fe_adap[0].fe == core::ptr::null_mut() ? -ENODEV : 0;
    }
// Remote control
...
//
pub const NOMINAL_IR_BIT_TRANSITION_TIME_US: c_int = 889;

pub const FIRMWARE_CLOCK_TICK: c_int = 83333;
pub const FIRMWARE_CLOCK_DIVISOR: c_int = 256;
pub const IR_PERCENT_TOLERANCE: c_int = 15;

#[no_mangle]
unsafe extern "C" fn technisat_usb2_get_ir(d: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn technisat_usb2_rc_query(d: *mut dvb_usb_device) -> c_int {
    static int technisat_usb2_rc_query(struct dvb_usb_device *d)
    {
    let mut ret: c_int = technisat_usb2_get_ir(d);
    if (ret < 0)
    return ret;
    if (ret == 0)
    return 0;
...
// device description
    ...
    { &technisat_usb2_id_table[TECHNISAT_USB2_DVB_S2], core::ptr::null_mut() },
    { core::ptr::null_mut() },
    },
    },
    .rc.core = {
...
#[no_mangle]
unsafe extern "C" fn technisat_usb2_disconnect(intf: *mut usb_interface) {
