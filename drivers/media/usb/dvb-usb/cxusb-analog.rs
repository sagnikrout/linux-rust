...
//! Source: drivers/media/usb/dvb-usb/cxusb-analog.c
#![no_std]
...
// * controls support
    ...
    let mut size: c_uint = cxdev.width * cxdev.height * 2;
    if (*num_planes > 0) {
    if (*num_planes != 1)
    return -EINVAL;
    if (sizes[0] < size)
...
#[no_mangle]
unsafe extern "C" fn cxusb_medion_v_buf_init(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxusb_auxbuf_paylen(auxbuf: *mut cxusb_medion_auxbuf) -> c_uint {
...
// (bt656->buf++) = val;
    ...
    maxlinesamples);
#[no_mangle]
pub unsafe extern "C" fn if(LINE_SAMPLES: bt656->fmode ==) -> else {
    else if (bt656.fmode == LINE_SAMPLES)
...
//
    ...
    VB2_BUF_STATE_DONE);
    cxdev.vbuf = core::ptr::null_mut();
    cxdev.bt656.buf = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cxusb_medion_v_complete_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn cxusb_medion_v_complete(u: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn cxusb_medion_urbs_free(cxdev: *mut cxusb_medion_dev) {
    ...
    cxdev.streamurbs[i] = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn cxusb_medion_norm2field_order(norm: v4l2_std_id) -> u32 {
    static u32 cxusb_medion_norm2field_order(v4l2_std_id norm)
    {
    let mut is625: bool = norm & V4L2_STD_625_50;
    let mut is525: bool = norm & V4L2_STD_525_60;
    if (!is625 && !is525)
...
#[no_mangle]
unsafe extern "C" fn cxusb_medion_field_order(cxdev: *mut cxusb_medion_dev) -> u32 {
...
//
    ...
    ret_unstream_md:
    cxusb_ctrl_msg(dvbdev, CMD_STREAMING_OFF, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0);
    ret_unstream_cx:
...
#[no_mangle]
unsafe extern "C" fn cxusb_medion_v_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn cxusub_medion_v_buf_queue(vb: *mut vb2_buffer) {
...
// cxusb_vprintk(dvbdev, OPS, "mmmm.. a fresh buffer...\n");
    ...
    let mut radiocaps: static __u32 = V4L2_CAP_TUNER | V4L2_CAP_RADIO;
    ...
    ret = v4l2_subdev_call(cxdev.cx25840, pad, set_fmt, core::ptr::null_mut(), &subfmt);
    if (ret != 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn cxusb_medion_log_status(file: *mut file, fh: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxusb_medion_analog_init(dvbdev: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxusb_videoradio_open(f: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxusb_videoradio_release(f: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxusb_medion_v4l2_release(v4l2_dev: *mut v4l2_device) {
...
#[no_mangle]
unsafe extern "C" fn cxusb_medion_videodev_release(vdev: *mut video_device) {
...
#[no_mangle]
unsafe extern "C" fn cxusb_medion_register_analog_video(dvbdev: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxusb_medion_register_analog_radio(dvbdev: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxusb_medion_register_analog_subdevs(dvbdev: *mut dvb_usb_device) -> c_int {
...
// attach cx25840 capture chip
    ...
    &dvbdev.i2c_adap,
    "cx25840", 0x44, core::ptr::null_mut());
    if (!cxdev.cx25840) {
...
#[no_mangle]
pub unsafe extern "C" fn cxusb_medion_register_analog(dvbdev: *mut dvb_usb_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxusb_medion_unregister_analog(dvbdev: *mut dvb_usb_device) {
