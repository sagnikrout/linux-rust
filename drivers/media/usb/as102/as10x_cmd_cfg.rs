...
//! Source: drivers/media/usb/as102/as10x_cmd_cfg.c
#![no_std]
...
// pvalue = le32_to_cpu(( __le32)prsp->body.context.rsp.reg_val.u.value32);
...
// pcmd->body.context.req.reg_val.mode initialization is not required
    pcmd.body.context.req.reg_val.u.value32 = ( u32)cpu_to_le32(value);
    pcmd.body.context.req.tag = cpu_to_le16(tag);
...
//
#[no_mangle]
pub unsafe extern "C" fn as10x_cmd_eLNA_change_mode(adap: *mut as10x_bus_adapter_t, mode: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn as10x_context_rsp_parse(prsp: *mut as10x_cmd_t, proc_id: u16) -> c_int {
