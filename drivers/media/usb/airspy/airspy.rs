...
//! Source: drivers/media/usb/airspy/airspy.c
#![no_std]
...
pub const USB_STATE_URB_BUF: c_int = 2;
    pub flags: c_ulong,
    pub dev: *mut device,
...
// videobuf2 queue and queued buffers list
    ...
    pub /: *mut *mut unsigned sequence; / Buffer sequence counter,
...
// Private functions
    ...
    {
    unsigned long flags;
    struct airspy_frame_buf *buf = core::ptr::null_mut();
...
// calculate sample rate and output it in 10 seconds intervals
    ...
    let mut samples: c_uint = s.sample - s.sample_measured;
...
//
#[no_mangle]
unsafe extern "C" fn airspy_urb_complete(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn airspy_kill_urbs(s: *mut airspy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airspy_submit_urbs(s: *mut airspy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airspy_free_stream_bufs(s: *mut airspy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airspy_alloc_stream_bufs(s: *mut airspy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airspy_free_urbs(s: *mut airspy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airspy_alloc_urbs(s: *mut airspy) -> c_int {
...
// allocate the URBs
    ...
    s.urb_list[j] = core::ptr::null_mut();
    }
    s.urbs_initialized = 0;
    return -ENOMEM;
    }
...
#[no_mangle]
unsafe extern "C" fn airspy_cleanup_queued_bufs(s: *mut airspy) {
...
#[no_mangle]
unsafe extern "C" fn airspy_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn airspy_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn airspy_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
// start hardware streaming
    ret = airspy_ctrl_msg(s, CMD_RECEIVER_MODE, 1, 0, core::ptr::null_mut(), 0);
    if (ret)
    goto err_kill_urbs;
...
#[no_mangle]
unsafe extern "C" fn airspy_stop_streaming(vq: *mut vb2_queue) {
...
// stop hardware streaming
    airspy_ctrl_msg(s, CMD_RECEIVER_MODE, 0, 0, core::ptr::null_mut(), 0);
    airspy_kill_urbs(s);
    airspy_free_urbs(s);
    airspy_free_stream_bufs(s);
...
#[no_mangle]
unsafe extern "C" fn airspy_g_tuner(file: *mut file, priv: *mut c_void, v: *mut v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airspy_video_release(v: *mut v4l2_device) {
...
#[no_mangle]
unsafe extern "C" fn airspy_set_lna_gain(s: *mut airspy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airspy_set_mixer_gain(s: *mut airspy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airspy_set_if_gain(s: *mut airspy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airspy_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
