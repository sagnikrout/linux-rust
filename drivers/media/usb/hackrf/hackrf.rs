...
//! Source: drivers/media/usb/hackrf/hackrf.c
#![no_std]
...
// format descriptions for capture and preview
    ...
    let mut NUM_FORMATS: static unsigned int = ARRAY_SIZE(formats);
// intermediate buffers with raw data from the USB device
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hackrf_buffer {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hackrf_dev {

pub const RX_ON: c_int = 4;
pub const TX_ON: c_int = 5;
pub const RX_ADC_FREQUENCY: c_int = 11;
pub const TX_DAC_FREQUENCY: c_int = 12;
pub const RX_BANDWIDTH: c_int = 13;
pub const TX_BANDWIDTH: c_int = 14;
pub const RX_RF_FREQUENCY: c_int = 15;
pub const TX_RF_FREQUENCY: c_int = 16;
pub const RX_RF_GAIN: c_int = 17;
pub const TX_RF_GAIN: c_int = 18;
pub const RX_IF_GAIN: c_int = 19;
pub const RX_LNA_GAIN: c_int = 20;
pub const TX_LNA_GAIN: c_int = 21;
    pub flags: c_ulong,
    pub intf: *mut usb_interface,
    pub dev: *mut device,
    pub udev: *mut usb_device,
    pub rx_vdev: video_device,
    pub tx_vdev: video_device,
    pub v4l2_dev: v4l2_device,
// videobuf2 queue and queued buffers list
    pub rx_vb2_queue: vb2_queue,
    pub tx_vb2_queue: vb2_queue,
    pub rx_buffer_list: list_head,
    pub tx_buffer_list: list_head,
    pub /: *mut *mut spinlock_t buffer_list_lock; / Protects buffer_list,
    pub /: *mut *mut unsigned int sequence; / Buffer sequence counter,
    pub /: *mut *mut unsigned int vb_full; / vb is full and packets dropped,
    pub /: *mut *mut unsigned int vb_empty; / vb is empty and packets dropped,
// Note if taking both locks v4l2_lock must always be locked first!
    pub /: *mut *mut mutex v4l2_lock; / Protects everything else,
    pub /: *mut *mut mutex vb_queue_lock; / Protects vb_queue,
    pub urb_list: [*mut urb; MAX_BULK_BUFS],
    pub buf_num: c_int,
    pub buf_size: c_ulong,
    pub buf_list: [*mut u8; MAX_BULK_BUFS],
    pub dma_addr: [dma_addr_t; MAX_BULK_BUFS],
    pub urbs_initialized: c_int,
    pub urbs_submitted: c_int,
// USB control message buffer
pub const BUF_SIZE: c_int = 24;
    pub buf: [u8; BUF_SIZE],
// Current configuration
    ...
    pub buffersize: u32,
// Controls
    pub rx_ctrl_handler: v4l2_ctrl_handler,
    pub rx_bandwidth_auto: *mut v4l2_ctrl,
    pub rx_bandwidth: *mut v4l2_ctrl,
    pub rx_rf_gain: *mut v4l2_ctrl,
    pub rx_lna_gain: *mut v4l2_ctrl,
    pub rx_if_gain: *mut v4l2_ctrl,
    pub tx_ctrl_handler: v4l2_ctrl_handler,
    pub tx_bandwidth_auto: *mut v4l2_ctrl,
    pub tx_bandwidth: *mut v4l2_ctrl,
    pub tx_rf_gain: *mut v4l2_ctrl,
    pub tx_lna_gain: *mut v4l2_ctrl,
// Sample rate calc
    pub jiffies_next: c_ulong,
    pub sample: c_uint,
    pub sample_measured: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn hackrf_set_params(dev: *mut hackrf_dev) -> c_int {
    ...
    let mut rx: bool = test_bit(RX_ON, &dev.flags);
    let mut tx: bool = test_bit(TX_ON, &dev.flags);
    static const struct {
    u32 freq;
    } bandwidth_lut[] = {
    { 1750000}, /*  1.75 MHz */
...
// bandwidth
    ...
    uitmp1, uitmp2, core::ptr::null_mut(), 0);
    if (ret)
    goto err;
    }
// RX / TX RF frequency
...
// RX RF gain
    ...
    ret = hackrf_ctrl_msg(dev, CMD_AMP_ENABLE, u8tmp, 0, core::ptr::null_mut(), 0);
    if (ret)
    goto err;
...
// Private functions
    ...
    {
    unsigned long flags;
    struct hackrf_buffer *buffer = core::ptr::null_mut();
...
// calculate sample rate and output it in 10 seconds intervals
    ...
    let mut samples: c_uint = dev.sample - dev.sample_measured;
...
//
#[no_mangle]
unsafe extern "C" fn hackrf_urb_complete_in(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn hackrf_urb_complete_out(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn hackrf_kill_urbs(dev: *mut hackrf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hackrf_submit_urbs(dev: *mut hackrf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hackrf_free_stream_bufs(dev: *mut hackrf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hackrf_alloc_stream_bufs(dev: *mut hackrf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hackrf_free_urbs(dev: *mut hackrf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hackrf_alloc_urbs(dev: *mut hackrf_dev, rcv: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hackrf_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn hackrf_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn hackrf_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
// start hardware streaming
    ret = hackrf_ctrl_msg(dev, CMD_SET_TRANSCEIVER_MODE, mode, 0, core::ptr::null_mut(), 0);
    if (ret)
    goto err;
    mutex_unlock(&dev.v4l2_lock);
    return 0;
...
#[no_mangle]
unsafe extern "C" fn hackrf_stop_streaming(vq: *mut vb2_queue) {
...
// stop hardware streaming
    hackrf_ctrl_msg(dev, CMD_SET_TRANSCEIVER_MODE, 0, 0, core::ptr::null_mut(), 0);
    hackrf_kill_urbs(dev);
    hackrf_free_urbs(dev);
    hackrf_free_stream_bufs(dev);
    ...
    ret = 0;
#[no_mangle]
pub unsafe extern "C" fn if(1: v->index ==) -> else {
    else if (v.index == 1)
    ret = 0;
    else
    ret = -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn hackrf_g_tuner(file: *mut file, priv: *mut c_void, v: *mut v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hackrf_video_release(v: *mut v4l2_device) {
...
#[no_mangle]
unsafe extern "C" fn hackrf_s_ctrl_rx(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hackrf_s_ctrl_tx(ctrl: *mut v4l2_ctrl) -> c_int {
