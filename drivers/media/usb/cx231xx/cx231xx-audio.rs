...
//! Source: drivers/media/usb/cx231xx/cx231xx-audio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cx231xx_isoc_audio_deinit(dev: *mut cx231xx) -> c_int {
    ...
    dev.adev.urb[i] = core::ptr::null_mut();
    kfree(dev.adev.transfer_buffer[i]);
    dev.adev.transfer_buffer[i] = core::ptr::null_mut();
    }
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn cx231xx_bulk_audio_deinit(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_audio_isocirq(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_audio_bulkirq(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_init_audio_isoc(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_init_audio_bulk(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_cx231xx_capture_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_cx231xx_pcm_close(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_cx231xx_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_audio_init(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_audio_fini(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_alsa_register() -> int __init {
    static int __init cx231xx_alsa_register(void)
    {
    return cx231xx_register_extension(&audio_ops);
    }
#[no_mangle]
unsafe extern "C" fn cx231xx_alsa_unregister() -> void __exit {
