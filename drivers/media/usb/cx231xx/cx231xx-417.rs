...
//! Source: drivers/media/usb/cx231xx/cx231xx-417.c
#![no_std]
...
pub const CX231xx_FIRM_IMAGE_SIZE: c_int = 376836;

// for polaris ITVC
pub const ITVC_WRITE_DIR: c_uint = 0x03FDFC00;
pub const ITVC_READ_DIR: c_uint = 0x0001FC00;
pub const MCI_MEMORY_DATA_BYTE0: c_uint = 0x00;
pub const MCI_MEMORY_DATA_BYTE1: c_uint = 0x08;
pub const MCI_MEMORY_DATA_BYTE2: c_uint = 0x10;
pub const MCI_MEMORY_DATA_BYTE3: c_uint = 0x18;
pub const MCI_MEMORY_ADDRESS_BYTE2: c_uint = 0x20;
pub const MCI_MEMORY_ADDRESS_BYTE1: c_uint = 0x28;
pub const MCI_MEMORY_ADDRESS_BYTE0: c_uint = 0x30;
pub const MCI_REGISTER_DATA_BYTE0: c_uint = 0x40;
pub const MCI_REGISTER_DATA_BYTE1: c_uint = 0x48;
pub const MCI_REGISTER_DATA_BYTE2: c_uint = 0x50;
pub const MCI_REGISTER_DATA_BYTE3: c_uint = 0x58;
pub const MCI_REGISTER_ADDRESS_BYTE0: c_uint = 0x60;
pub const MCI_REGISTER_ADDRESS_BYTE1: c_uint = 0x68;
pub const MCI_REGISTER_MODE: c_uint = 0x70;
// Read and write modes for polaris ITVC
pub const MCI_MODE_REGISTER_READ: c_uint = 0x000;
pub const MCI_MODE_REGISTER_WRITE: c_uint = 0x100;
pub const MCI_MODE_MEMORY_READ: c_uint = 0x000;
pub const MCI_MODE_MEMORY_WRITE: c_uint = 0x4000;
    let mut mpeglines: static unsigned int = 128;
    module_param(mpeglines, int, 0644);
    MODULE_PARM_DESC(mpeglines, "number of lines in an MPEG buffer, range 2-32");
    let mut mpeglinesize: static unsigned int = 512;
    module_param(mpeglinesize, int, 0644);
    MODULE_PARM_DESC(mpeglinesize,
    "number of bytes in each line of an MPEG buffer, range 512-1024");
    let mut v4l_debug: static unsigned int = 1;
...
pub const IVTV_CMD_HW_BLOCKS_RST: c_uint = 0xFFFFFFFF;
// Firmware API commands
pub const IVTV_API_STD_TIMEOUT: c_int = 500;
// Registers
// IVTV_REG_OFFSET
...
// |+-------+-------+-------+-------+-------+-------+-------+-------+
//
pub const MC417_MIWR: c_uint = 0x8000;
pub const MC417_MIRD: c_uint = 0x4000;
pub const MC417_MICS: c_uint = 0x2000;
pub const MC417_MIRDY: c_uint = 0x1000;
pub const MC417_MIADDR: c_uint = 0x0F00;
pub const MC417_MIDATA: c_uint = 0x00FF;
...
pub const MC417_UART_GPIO_EN: c_uint = 0x00000001;
// Values for speed control
pub const MC417_SPD_CTL_SLOW: c_uint = 0x1;
pub const MC417_SPD_CTL_MEDIUM: c_uint = 0x0;
pub const MC417_SPD_CTL_FAST: c_uint = 0x3     /* b'1x, but we use b'11 */;
// Values for GPIO select
pub const MC417_GPIO_SEL_GPIO3: c_uint = 0x3;
pub const MC417_GPIO_SEL_GPIO2: c_uint = 0x2;
pub const MC417_GPIO_SEL_GPIO1: c_uint = 0x1;
pub const MC417_GPIO_SEL_GPIO0: c_uint = 0x0;
pub const CX23417_GPIO_MASK: c_uint = 0xFC0003FF;
#[no_mangle]
unsafe extern "C" fn set_itvc_reg(dev: *mut cx231xx, gpio_direction: u32, value: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_itvc_reg(dev: *mut cx231xx, gpio_direction: u32, val_ptr: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wait_for_mci_complete(dev: *mut cx231xx) -> c_int {
    static int wait_for_mci_complete(struct cx231xx *dev)
    {
    u32 gpio;
    let mut gpio_direction: u32 = 0;
    let mut count: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn mc417_register_write(dev: *mut cx231xx, address: u16, value: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc417_register_read(dev: *mut cx231xx, address: u16, value: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc417_memory_write(dev: *mut cx231xx, address: u32, value: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc417_memory_read(dev: *mut cx231xx, address: u32, value: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_find_mailbox(dev: *mut cx231xx) -> c_int {
    static int cx231xx_find_mailbox(struct cx231xx *dev)
    {
    u32 signature[4] = {
    0x12345678, 0x34567812, 0x56781234, 0x78123456
    };
    let mut signaturecnt: c_int = 0;
    u32 value;
    int i;
    let mut ret: c_int = 0;
    dprintk(2, "%s()\n", __func__);
...
#[no_mangle]
unsafe extern "C" fn cx231xx_load_firmware(dev: *mut cx231xx) -> c_int {
    ...
    int i, retval = 0;
    let mut value: u32 = 0;
    let mut gpio_output: u32 = 0;
// u32 checksum = 0;
// u32 *dataptr;
    let mut transfer_size: u32 = 0;
    let mut fw_data: u32 = 0;
...
// u32 current_fw[800];
    ...
    p_fw = p_current_fw;
    if (p_current_fw == core::ptr::null_mut()) {
    dprintk(2, "FAIL!!!\n");
    return -ENOMEM;
    }
    p_buffer = vmalloc(EP5_BUF_SIZE);
    if (p_buffer == core::ptr::null_mut()) {
    dprintk(2, "FAIL!!!\n");
    vfree(p_current_fw);
    return -ENOMEM;
    }
...
// (p_buffer + i) = (u8)((*(p_fw + (frame * 128 * 8 + (i / 4))) & 0xFF000000) >> 24);
    ...
    p_current_fw = p_fw;
    vfree(p_current_fw);
    p_current_fw = core::ptr::null_mut();
    vfree(p_buffer);
    uninitGPIO(dev);
    release_firmware(firmware);
...
#[no_mangle]
unsafe extern "C" fn cx231xx_codec_settings(dev: *mut cx231xx) {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_initialize_codec(dev: *mut cx231xx) -> c_int {
...
// ------------------------------------------------------------------
    ...
    let mut size: c_uint = mpeglinesize * mpeglines;
...
#[no_mangle]
unsafe extern "C" fn cx231xx_isoc_copy(dev: *mut cx231xx, urb: *mut urb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_bulk_copy(dev: *mut cx231xx, urb: *mut urb) -> c_int {
...
// do this before setting alternate!
    ...
    spin_lock_irqsave(&dev.video_mode.slock, flags);
    if (dev.USE_ISO)
    dev.video_mode.isoc_ctl.buf = core::ptr::null_mut();
    else
    dev.video_mode.bulk_ctl.buf = core::ptr::null_mut();
    spin_unlock_irqrestore(&dev.video_mode.slock, flags);
...
// ------------------------------------------------------------------
    ...
    let mut is_50hz: bool = dev.encodernorm.id & V4L2_STD_625_50;
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_std(file: *mut file, priv: *mut c_void, id: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_log_status(file: *mut file, priv: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_417_unregister(dev: *mut cx231xx) {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_s_video_encoding(cxhdl: *mut cx2341x_handler, val: u32) -> c_int {
    ...
    let mut is_mpeg1: c_int = val == V4L2_MPEG_VIDEO_ENCODING_MPEG_1;
...
// fix videodecoder resolution
    ...
    v4l2_subdev_call(dev.sd_cx25840, pad, set_fmt, core::ptr::null_mut(), &format);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn cx231xx_s_audio_sampling_freq(cxhdl: *mut cx2341x_handler, idx: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_417_register(dev: *mut cx231xx) -> c_int {
...
// Set default TV standard
    ...
    dev.sd_cx25840.ctrl_handler, core::ptr::null_mut(), true);
