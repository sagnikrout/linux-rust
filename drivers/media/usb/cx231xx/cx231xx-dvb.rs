...
//! Source: drivers/media/usb/cx231xx/cx231xx-dvb.c
#![no_std]
...
pub const CX231XX_DVB_NUM_BUFS: c_int = 5;
pub const CX231XX_DVB_MAX_PACKETSIZE: c_int = 564;
pub const CX231XX_DVB_MAX_PACKETS: c_int = 64;
pub const CX231XX_DVB_MAX_FRONTENDS: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cx231xx_dvb {
    pub frontend: [*mut dvb_frontend; CX231XX_DVB_MAX_FRONTENDS],
...
#[no_mangle]
pub unsafe extern "C" fn dvb_isoc_copy(dev: *mut cx231xx, urb: *mut urb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_bulk_copy(dev: *mut cx231xx, urb: *mut urb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn start_streaming(dvb: *mut cx231xx_dvb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stop_streaming(dvb: *mut cx231xx_dvb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn start_feed(feed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stop_feed(feed: *mut dvb_demux_feed) -> c_int {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn cx231xx_dvb_bus_ctrl(fe: *mut dvb_frontend, acquire: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn attach_xc5000(addr: u8, dev: *mut cx231xx) -> c_int {
    ...
    dev.dvb.frontend[0] = core::ptr::null_mut();
    return -EINVAL;
    }
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_set_analog_freq(dev: *mut cx231xx, freq: u32) -> c_int {
    int cx231xx_set_analog_freq(struct cx231xx *dev, u32 freq)
    {
    if (dev.dvb && dev.dvb.frontend[0]) {
    struct dvb_tuner_ops *dops = &dev.dvb.frontend[0].ops.tuner_ops;
    if (dops.set_analog_params != core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_reset_analog_tuner(dev: *mut cx231xx) -> c_int {
    int cx231xx_reset_analog_tuner(struct cx231xx *dev)
    {
    let mut status: c_int = 0;
    if (dev.dvb && dev.dvb.frontend[0]) {
    struct dvb_tuner_ops *dops = &dev.dvb.frontend[0].ops.tuner_ops;
    if (dops.init != core::ptr::null_mut() && !dev.xc_fw_load_done) {
    dev_dbg(dev.dev,
...
#[no_mangle]
unsafe extern "C" fn unregister_dvb(dvb: *mut cx231xx_dvb) {
...
// remove I2C tuner
    ...
    dvb.i2c_client_tuner = core::ptr::null_mut();
// remove I2C demod(s)
...
#[no_mangle]
unsafe extern "C" fn dvb_init(dev: *mut cx231xx) -> c_int {
...
// define general-purpose callback pointer
    ...
    {
    let mut si2165_pdata: si2165_platform_data = {};
// attach demod
    si2165_pdata.fe = &dev.dvb.frontend[0];
    si2165_pdata.chip_mode = SI2165_MODE_PLL_XTAL;
    si2165_pdata.ref_freq_hz = 16000000;
// perform probe/init/attach
    client = dvb_module_probe("si2165", core::ptr::null_mut(), demod_i2c,
    ...
    dev.dvb.frontend[0].ops.i2c_gate_ctrl = core::ptr::null_mut();
// define general-purpose callback pointer
    dvb.frontend[0].callback = cx231xx_tuner_callback;
    dvb_attach(tda18271_attach, dev.dvb.frontend[0],
    dev.board.tuner_addr, tuner_i2c,
    &hcw_tda18271_config);
    dev.cx231xx_reset_analog_tuner = core::ptr::null_mut();
    break;
    }
...
// perform probe/init/attach
    client = dvb_module_probe("si2157", core::ptr::null_mut(), tuner_i2c,
...
// perform probe/init/attach
    client = dvb_module_probe("lgdt3306a", core::ptr::null_mut(), demod_i2c,
    dev.board.demod_addr,
    &lgdt3306a_config);
    if (!client) {
    result = -ENODEV;
...
// perform probe/init/attach
    client = dvb_module_probe("si2168", core::ptr::null_mut(), demod_i2c,
    dev.board.demod_addr,
    &si2168_config);
    if (!client) {
    result = -ENODEV;
...
// perform probe/init/attach
    ...
    {
    let mut mn88473_config: mn88473_config = {};
// attach demodulator chip
    mn88473_config.i2c_wr_max = 16;
    mn88473_config.xtal = 25000000;
    mn88473_config.fe = &dev.dvb.frontend[0];
// perform probe/init/attach
    client = dvb_module_probe("mn88473", core::ptr::null_mut(), demod_i2c,
    dev.board.demod_addr,
    &mn88473_config);
    if (!client) {
    result = -ENODEV;
...
// attach second demodulator chip
    ...
    si2168_config.ts_clock_inv = true;
// perform probe/init/attach
    client = dvb_module_probe("si2168", core::ptr::null_mut(), adapter,
...
// attach tuner
    ...
    si2157_config.inversion = true;
// perform probe/init/attach
    client = dvb_module_probe("si2157", core::ptr::null_mut(), adapter,
    dev.board.tuner_addr,
    &si2157_config);
    if (!client) {
    result = -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn dvb_fini(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_dvb_register() -> int __init {
    static int __init cx231xx_dvb_register(void)
    {
    return cx231xx_register_extension(&dvb_ops);
    }
#[no_mangle]
unsafe extern "C" fn cx231xx_dvb_unregister() -> void __exit {
