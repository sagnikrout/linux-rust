...
//! Source: drivers/media/usb/cx231xx/cx231xx-cards.c
#![no_std]
...
//
    ...
    let mut transfer_mode: static int = 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_tuner_callback(ptr: *mut c_void, component: c_int, command: c_int, arg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_reset_out(dev: *mut cx231xx) {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_enable_OSC(dev: *mut cx231xx) {
    static void cx231xx_enable_OSC(struct cx231xx *dev)
    {
    cx231xx_set_gpio_value(dev, CX23417_OSC_EN, 1);
    }
#[no_mangle]
unsafe extern "C" fn cx231xx_sleep_s5h1432(dev: *mut cx231xx) {
    static void cx231xx_sleep_s5h1432(struct cx231xx *dev)
    {
    cx231xx_set_gpio_value(dev, SLEEP_S5H1432, 0);
    }
#[no_mangle]
pub unsafe extern "C" fn cx231xx_set_model(dev: *mut cx231xx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_pre_card_setup(dev: *mut cx231xx) {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_config_tuner(dev: *mut cx231xx) {
...
// configure tuner
    ...
    let mut len_todo: c_int = len;
    u8 *eedata_cur = eedata;
    int i;
    struct i2c_msg msg_write = { .addr = client.addr, .flags = 0,
    .buf = &start_offset, .len = 1 };
    let mut msg_read: i2c_msg = { .addr = client.addr, .flags = I2C_M_RD };
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_card_setup(dev: *mut cx231xx) {
...
// request some modules
    ...
    "cx25840", 0x88 >> 1, core::ptr::null_mut());
    if (dev.sd_cx25840 == core::ptr::null_mut())
    dev_err(dev.dev,
...
// Initialize the tuner
    ...
    tuner_i2c,
    "tuner",
    dev.tuner_addr, core::ptr::null_mut());
    if (dev.sd_tuner == core::ptr::null_mut())
    dev_err(dev.dev,
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_config(dev: *mut cx231xx) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_config_i2c(dev: *mut cx231xx) {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_unregister_media_device(dev: *mut cx231xx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_release_resources(dev: *mut cx231xx) {
...
#[no_mangle]
unsafe extern "C" fn request_modules(dev: *mut cx231xx) {
...
#[no_mangle]
unsafe extern "C" fn flush_request_modules(dev: *mut cx231xx) {
...
//
#[no_mangle]
unsafe extern "C" fn cx231xx_usb_disconnect(interface: *mut usb_interface) {
