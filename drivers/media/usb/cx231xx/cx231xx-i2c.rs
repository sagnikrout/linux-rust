...
//! Source: drivers/media/usb/cx231xx/cx231xx-i2c.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn get_real_i2c_port(dev: *mut cx231xx, bus_nr: c_int) -> c_int {
    ...
    {
    let mut i2c_port: c_int = get_real_i2c_port(dev, bus.nr);
...
//
    ...
    let mut size: u16 = 0;
    let mut loop: u8 = 0;
    let mut saddr_len: u8 = 1;
    u8 *buf_ptr = core::ptr::null_mut();
    let mut saddr: u16 = 0;
    let mut need_gpio: u8 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(1: msg->len ==) -> else {
    else if (msg.len == 1)
    saddr = msg.buf[0];
    switch (saddr) {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: msg1->len ==) -> else {
    else if (msg1.len == 1)
    saddr = msg1.buf[0];
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_do_i2c_scan(dev: *mut cx231xx, i2c_port: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_i2c_register(bus: *mut cx231xx_i2c) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_i2c_unregister(bus: *mut cx231xx_i2c) {
...
//
#[no_mangle]
unsafe extern "C" fn cx231xx_i2c_mux_select(muxc: *mut i2c_mux_core, chan_id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_i2c_mux_create(dev: *mut cx231xx) -> c_int {
    int cx231xx_i2c_mux_create(struct cx231xx *dev)
    {
    dev.muxc = i2c_mux_alloc(&dev.i2c_bus[1].i2c_adap, dev.dev, 2, 0, 0,
    cx231xx_i2c_mux_select, core::ptr::null_mut());
    if (!dev.muxc)
    return -ENOMEM;
    dev.muxc.priv = dev;
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_i2c_mux_register(dev: *mut cx231xx, mux_no: c_int) -> c_int {
    int cx231xx_i2c_mux_register(struct cx231xx *dev, int mux_no)
    {
    return i2c_mux_add_adapter(dev.muxc, 0, mux_no);
    }
#[no_mangle]
pub unsafe extern "C" fn cx231xx_i2c_mux_unregister(dev: *mut cx231xx) {
