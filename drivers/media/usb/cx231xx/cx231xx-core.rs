...
//! Source: drivers/media/usb/cx231xx/cx231xx-core.c
#![no_std]
...
// #define ENABLE_DEBUG_ISOC_FRAMES
    ...
    let mut alt: static int = CX231XX_PINOUT;
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_remove_from_devlist(dev: *mut cx231xx) {
    void cx231xx_remove_from_devlist(struct cx231xx *dev)
    {
    if (dev == core::ptr::null_mut())
    return;
    if (dev.udev == core::ptr::null_mut())
    return;
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_add_into_devlist(dev: *mut cx231xx) {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_register_extension(ops: *mut cx231xx_ops) -> c_int {
    int cx231xx_register_extension(struct cx231xx_ops *ops)
    {
    struct cx231xx *dev = core::ptr::null_mut();
    mutex_lock(&cx231xx_devlist_mutex);
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_unregister_extension(ops: *mut cx231xx_ops) {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_init_extension(dev: *mut cx231xx) {
    void cx231xx_init_extension(struct cx231xx *dev)
    {
    struct cx231xx_ops *ops = core::ptr::null_mut();
    mutex_lock(&cx231xx_devlist_mutex);
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_close_extension(dev: *mut cx231xx) {
...
//
    ...
    let mut saddr_len: u8 = 0;
    let mut _i2c_period: u8 = 0;
    let mut _i2c_nostop: u8 = 0;
    let mut _i2c_reserve: u8 = 0;
...
//
    ...
    let mut val: u8 = 0;
    int ret;
    let mut pipe: c_int = usb_rcvctrlpipe(dev.udev, 0);
    if (dev.state & DEV_DISCONNECTED)
    return -ENODEV;
    ...
    {
    int ret;
    let mut pipe: c_int = 0;
    let mut unsend_size: c_int = 0;
    u8 *pdata;
    if (dev.state & DEV_DISCONNECTED)
    return -ENODEV;
...
//
    ...
    let mut val: u8 = 0;
    int ret;
    let mut pipe: c_int = usb_sndctrlpipe(dev.udev, 0);
    if (dev.state & DEV_DISCONNECTED)
    return -ENODEV;
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_set_video_alternate(dev: *mut cx231xx) -> c_int {
    int cx231xx_set_video_alternate(struct cx231xx *dev)
    {
    int errCode, prev_alt = dev.video_mode.alt;
    let mut min_pkt_size: c_uint = dev.width * 2 + 4;
    let mut usb_interface_index: u32 = 0;
...
// Get the correct video interface Index
    ...
    if (dev.video_mode.alt_max_pkt_size != core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_set_alt_setting(dev: *mut cx231xx, index: u8, alt: u8) -> c_int {
    int cx231xx_set_alt_setting(struct cx231xx *dev, u8 index, u8 alt)
    {
    let mut status: c_int = 0;
    let mut usb_interface_index: u32 = 0;
    let mut max_pkt_size: u32 = 0;
    switch (index) {
    case INDEX_TS1:
    usb_interface_index =
    dev.current_pcb_config.hs_config_info[0].interface_info.
    ...
    if (dev.ts1_mode.alt_max_pkt_size != core::ptr::null_mut())
    ...
    audio_index + 1;
    dev.adev.alt = alt;
    if (dev.adev.alt_max_pkt_size != core::ptr::null_mut())
    ...
    if (dev.vbi_mode.alt_max_pkt_size != core::ptr::null_mut())
    ...
    if (dev.sliced_cc_mode.alt_max_pkt_size != core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_gpio_set(dev: *mut cx231xx, gpio: *mut cx231xx_reg_seq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_demod_reset(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_fw_load(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_set_mode(dev: *mut cx231xx, set_mode: enum cx231xx_mode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_ep5_bulkout(dev: *mut cx231xx, firmware: *mut u8, size: u16) -> c_int {
    int cx231xx_ep5_bulkout(struct cx231xx *dev, u8 *firmware, u16 size)
    {
    let mut errCode: c_int = 0;
    let mut actlen: c_int = -1;
...
//
#[no_mangle]
unsafe extern "C" fn cx231xx_isoc_irq_callback(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn cx231xx_bulk_irq_callback(urb: *mut urb) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_uninit_isoc(dev: *mut cx231xx) {
    void cx231xx_uninit_isoc(struct cx231xx *dev)
    {
    struct cx231xx_dmaqueue *dma_q = &dev.video_mode.vidq;
    struct urb *urb;
    int i;
    let mut broken_pipe: bool = false;
    ...
    usb_free_urb(urb);
    dev.video_mode.isoc_ctl.urb[i] = core::ptr::null_mut();
    }
    dev.video_mode.isoc_ctl.transfer_buffer[i] = core::ptr::null_mut();
    }
    if (broken_pipe) {
    ...
    dev.video_mode.isoc_ctl.urb = core::ptr::null_mut();
    dev.video_mode.isoc_ctl.transfer_buffer = core::ptr::null_mut();
    dev.video_mode.isoc_ctl.num_bufs = 0;
    dma_q.p_left_data = core::ptr::null_mut();
    if (dev.mode_tv == 0)
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_uninit_bulk(dev: *mut cx231xx) {
    ...
    usb_free_urb(urb);
    dev.video_mode.bulk_ctl.urb[i] = core::ptr::null_mut();
    }
    dev.video_mode.bulk_ctl.transfer_buffer[i] = core::ptr::null_mut();
    }
    if (broken_pipe) {
    cx231xx_isocdbg("Reset endpoint to recover broken pipe.");
    usb_reset_endpoint(dev.udev, dev.video_mode.end_point_addr);
    ...
    kfree(dma_q.p_left_data);
    dev.video_mode.bulk_ctl.urb = core::ptr::null_mut();
    dev.video_mode.bulk_ctl.transfer_buffer = core::ptr::null_mut();
...
// De-allocates all pending stuff
    ...
    if (dma_q.p_left_data == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_stop_TS1(dev: *mut cx231xx) {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_start_TS1(dev: *mut cx231xx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_dev_init(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_dev_uninit(dev: *mut cx231xx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_mode_register(dev: *mut cx231xx, address: u16, mode: u32) -> c_int {
...
//
    ...
    saddr = 0;
#[no_mangle]
pub unsafe extern "C" fn if(1: saddr_len ==) -> else {
    else if (saddr_len == 1)
    saddr &= 0xff;
...
// usb send command
    ...
    &req_data);
#[no_mangle]
pub unsafe extern "C" fn if(1: master ==) -> else {
    else if (master == 1)
    status = dev.cx231xx_send_usb_command(&dev.i2c_bus[1],
    &req_data);
#[no_mangle]
pub unsafe extern "C" fn if(2: master ==) -> else {
    else if (master == 2)
...
// data = value[0];
#[no_mangle]
pub unsafe extern "C" fn if(4: data_len ==) -> else {
    else if (data_len == 4)
// data =
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_set_field(field_mask: u32, data: u32) -> u32 {
