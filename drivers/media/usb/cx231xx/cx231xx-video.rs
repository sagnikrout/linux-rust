...
//! Source: drivers/media/usb/cx231xx/cx231xx-video.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cx231xx_enable_analog_tuner(dev: *mut cx231xx) -> c_int {
    static int cx231xx_enable_analog_tuner(struct cx231xx *dev)
    {

    struct media_device *mdev = dev.media_dev;
    struct media_entity  *entity, *decoder = core::ptr::null_mut(), *source;
...
#[no_mangle]
pub unsafe extern "C" fn print_err_status(dev: *mut cx231xx, packet: c_int, status: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_isoc_copy(dev: *mut cx231xx, urb: *mut urb) -> c_int {
    static inline int cx231xx_isoc_copy(struct cx231xx *dev, struct urb *urb)
    {
    struct cx231xx_dmaqueue *dma_q = urb.context;
    int i;
    unsigned char *p_buffer;
    let mut bytes_parsed: u32 = 0, buffer_size = 0;
    let mut sav_eav: u8 = 0;
    if (!dev)
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_bulk_copy(dev: *mut cx231xx, urb: *mut urb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_find_next_SAV_EAV(p_buffer: *mut u8, buffer_size: u32, p_bytes_used: *mut u32) -> u8 {
...
// looking for skipped line which occurred in PAL 720x480 mode.
    ...
    u32 bytes_to_copy;
    struct cx231xx_buffer *buf;
    let mut _line_size: u32 = dev.width * 2;
...
// reset the counters
    ...
    {
    u8 *p_out_buffer = core::ptr::null_mut();
    let mut current_line_bytes_copied: u32 = 0;
    struct cx231xx_buffer *buf;
    let mut _line_size: u32 = dev.width << 1;
    void *startwrite;
    int offset, lencopy;
    if (dev.USE_ISO)
    buf = dev.video_mode.isoc_ctl.buf;
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_swab(from: *mut u16, to: *mut u16, len: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_is_buffer_done(dev: *mut cx231xx, dma_q: *mut cx231xx_dmaqueue) -> u8 {
    u8 cx231xx_is_buffer_done(struct cx231xx *dev, struct cx231xx_dmaqueue *dma_q)
    {
    let mut buffer_complete: u8 = 0;
// Dual field stream
...
// v4l2 interface
#[no_mangle]
pub unsafe extern "C" fn video_mux(dev: *mut cx231xx, index: c_int) {
...
// set new image size
    ...
    call_all(dev, pad, set_fmt, core::ptr::null_mut(), &format);
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_v4l2_create_entities(dev: *mut cx231xx) {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_g_input(file: *mut file, priv: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_g_tuner(file: *mut file, priv: *mut c_void, t: *mut v4l2_tuner) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_s_tuner(file: *mut file, priv: *mut c_void, t: *const v4l2_tuner) -> c_int {
    ...
    let mut if_frequency: u32 = 5400000;
    dev_dbg(dev.dev,
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_B: dev->norm &) -> else {
    else if (dev.norm & V4L2_STD_B)
    if_frequency = 6000000;  /*6.0MHz	*/
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_SECAM_DK): dev->norm & (V4L2_STD_PAL_DK |) -> else {
    else if (dev.norm & (V4L2_STD_PAL_DK | V4L2_STD_SECAM_DK))
    if_frequency = 6900000;  /*6.9MHz	*/
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_GH: dev->norm &) -> else {
    else if (dev.norm & V4L2_STD_GH)
    if_frequency = 7100000;  /*7.1MHz	*/
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_PAL_I: dev->norm &) -> else {
    else if (dev.norm & V4L2_STD_PAL_I)
    if_frequency = 7250000;  /*7.25MHz	*/
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_SECAM_L: dev->norm &) -> else {
    else if (dev.norm & V4L2_STD_SECAM_L)
    if_frequency = 6900000;  /*6.9MHz	*/
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_SECAM_LC: dev->norm &) -> else {
    ...
    {
    struct cx231xx *dev = video_drvdata(file);
    let mut is_50hz: bool = dev.norm & V4L2_STD_625_50;
...
#[no_mangle]
unsafe extern "C" fn radio_s_tuner(file: *mut file, priv: *mut c_void, t: *const v4l2_tuner) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cx231xx_v4l2_open(filp: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_release_analog_resources(dev: *mut cx231xx) {
...
//
#[no_mangle]
unsafe extern "C" fn cx231xx_close(filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_v4l2_close(filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_register_analog_devices(dev: *mut cx231xx) -> c_int {
