...
//! Source: drivers/media/usb/cx231xx/cx231xx-avcore.c
#![no_std]
...
pub const TUNER_MODE_FM_RADIO: c_int = 0;
//
    -: BLOCK ARRANGEMENT :-
    I2S block ----------------------|
    [I2S audio]			|
...
//
#[no_mangle]
unsafe extern "C" fn verve_write_byte(dev: *mut cx231xx, saddr: u8, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn verve_read_byte(dev: *mut cx231xx, saddr: u8, data: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn initGPIO(dev: *mut cx231xx) {
    void initGPIO(struct cx231xx *dev)
    {
    let mut _gpio_direction: u32 = 0;
    let mut value: u32 = 0;
    let mut val: u8 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn uninitGPIO(dev: *mut cx231xx) {
...
//
#[no_mangle]
unsafe extern "C" fn afe_write_byte(dev: *mut cx231xx, saddr: u16, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afe_read_byte(dev: *mut cx231xx, saddr: u16, data: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_afe_init_super_block(dev: *mut cx231xx, ref_count: u32) -> c_int {
    int cx231xx_afe_init_super_block(struct cx231xx *dev, u32 ref_count)
    {
    let mut status: c_int = 0;
    let mut temp: u8 = 0;
    let mut afe_power_status: u8 = 0;
    let mut i: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_afe_init_channels(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_afe_setup_AFE_for_baseband(dev: *mut cx231xx) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_afe_set_input_mux(dev: *mut cx231xx, input_mux: u32) -> c_int {
    int cx231xx_afe_set_input_mux(struct cx231xx *dev, u32 input_mux)
    {
    let mut ch1_setting: u8 = (u8) input_mux;
    let mut ch2_setting: u8 = (u8) (input_mux >> 8);
    let mut ch3_setting: u8 = (u8) (input_mux >> 16);
    let mut status: c_int = 0;
    let mut value: u8 = 0;
    if (ch1_setting != 0) {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_afe_set_mode(dev: *mut cx231xx, mode: enum AFE_MODE) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_afe_adjust_ref_count(dev: *mut cx231xx, video_input: u32) -> c_int {
    int cx231xx_afe_adjust_ref_count(struct cx231xx *dev, u32 video_input)
    {
    let mut input_mode: u8 = 0;
    let mut ntf_mode: u8 = 0;
    let mut status: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn vid_blk_write_byte(dev: *mut cx231xx, saddr: u16, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vid_blk_read_byte(dev: *mut cx231xx, saddr: u16, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vid_blk_write_word(dev: *mut cx231xx, saddr: u16, data: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vid_blk_read_word(dev: *mut cx231xx, saddr: u16, data: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_check_fw(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_set_video_input_mux(dev: *mut cx231xx, input: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_enable656(dev: *mut cx231xx) {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_disable656(dev: *mut cx231xx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_do_mode_ctrl_overrides(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_unmute_audio(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stopAudioFirmware(dev: *mut cx231xx) -> c_int {
    static int stopAudioFirmware(struct cx231xx *dev)
    {
    return vid_blk_write_byte(dev, DL_CTL_CONTROL, 0x03);
    }
#[no_mangle]
unsafe extern "C" fn restartAudioFirmware(dev: *mut cx231xx) -> c_int {
    static int restartAudioFirmware(struct cx231xx *dev)
    {
    return vid_blk_write_byte(dev, DL_CTL_CONTROL, 0x13);
    }
#[no_mangle]
pub unsafe extern "C" fn cx231xx_set_audio_input(dev: *mut cx231xx, input: u8) -> c_int {
    int cx231xx_set_audio_input(struct cx231xx *dev, u8 input)
    {
    let mut status: c_int = 0;
    let mut ainput: enum AUDIO_INPUT = AUDIO_INPUT_LINE;
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_init_ctrl_pin_status(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_enable_i2c_port_3(dev: *mut cx231xx, is_port_3: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn update_HH_register_after_set_DIF(dev: *mut cx231xx) {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_dump_SC_reg(dev: *mut cx231xx) {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_Setup_AFE_for_LowIF(dev: *mut cx231xx) {
...
//
    ...
    {
    let mut colibri_carrier_offset: u32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_Get_Colibri_CarrierOffset(mode: u32, standerd: u32) -> u32 {
    ...
    let mut dif_misc_ctrl_value: u32 = 0;
    let mut pll_freq_u64: u64 = 0;
    let mut i: u32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_dif_set_standard(dev: *mut cx231xx, standard: u32) -> c_int {
    int cx231xx_dif_set_standard(struct cx231xx *dev, u32 standard)
    {
    let mut status: c_int = 0;
    let mut dif_misc_ctrl_value: u32 = 0;
    let mut func_mode: u32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_tuner_pre_channel_change(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_tuner_post_channel_change(dev: *mut cx231xx) -> c_int {
...
// SECAM L/B/D standards
    ...
    status = vid_blk_write_word(dev, DIF_AGC_IF_REF, dwval);
    let mut status: return = = sizeof(dwval) ? 0 : -EIO;
    }
//
// I 2 S - B L O C K    C O N T R O L   functions
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_i2s_blk_initialize(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_i2s_blk_set_audio_input(dev: *mut cx231xx, audio_input: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_set_power_mode(dev: *mut cx231xx, mode: enum AV_MODE) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_start_stream(dev: *mut cx231xx, ep_mask: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_stop_stream(dev: *mut cx231xx, ep_mask: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_initialize_stream_xfer(dev: *mut cx231xx, media_type: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_capture_start(dev: *mut cx231xx, start: c_int, media_type: u8) -> c_int {
    int cx231xx_capture_start(struct cx231xx *dev, int start, u8 media_type)
    {
    let mut rc: c_int = -1;
    let mut ep_mask: u32 = -1;
...
//
#[no_mangle]
unsafe extern "C" fn cx231xx_set_gpio_bit(dev: *mut cx231xx, gpio_bit: u32, gpio_val: u32) -> c_int {
    static int cx231xx_set_gpio_bit(struct cx231xx *dev, u32 gpio_bit, u32 gpio_val)
    {
    let mut status: c_int = 0;
    gpio_val = ( u32)cpu_to_le32(gpio_val);
    status = cx231xx_send_gpio_cmd(dev, gpio_bit, (u8 *)&gpio_val, 4, 0, 0);
    return status;
    }
#[no_mangle]
unsafe extern "C" fn cx231xx_get_gpio_bit(dev: *mut cx231xx, gpio_bit: u32, gpio_val: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_set_gpio_value(dev: *mut cx231xx, pin_number: c_int, pin_value: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_gpio_i2c_start(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_gpio_i2c_end(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_gpio_i2c_write_byte(dev: *mut cx231xx, data: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_gpio_i2c_read_byte(dev: *mut cx231xx, buf: *mut u8) -> c_int {
    int cx231xx_gpio_i2c_read_byte(struct cx231xx *dev, u8 *buf)
    {
    let mut value: u8 = 0;
    let mut status: c_int = 0;
    let mut gpio_logic_value: u32 = 0;
    u8 i;
// read byte
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_gpio_i2c_read_ack(dev: *mut cx231xx) -> c_int {
    int cx231xx_gpio_i2c_read_ack(struct cx231xx *dev)
    {
    let mut status: c_int = 0;
    let mut gpio_logic_value: u32 = 0;
    let mut nCnt: c_int = 10;
    let mut nInit: c_int = nCnt;
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_gpio_i2c_write_ack(dev: *mut cx231xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx231xx_gpio_i2c_write_nak(dev: *mut cx231xx) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_gpio_i2c_read(dev: *mut cx231xx, dev_addr: u8, buf: *mut u8, len: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx231xx_gpio_i2c_write(dev: *mut cx231xx, dev_addr: u8, buf: *mut u8, len: u8) -> c_int {
