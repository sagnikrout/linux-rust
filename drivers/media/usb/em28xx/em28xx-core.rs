...
//! Source: drivers/media/usb/em28xx/em28xx-core.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn em28xx_read_reg_req(dev: *mut em28xx, req: u8, reg: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_read_reg(dev: *mut em28xx, reg: u16) -> c_int {
...
//
    ...
    int ret;
    struct usb_device *udev = interface_to_usbdev(dev.intf);
    let mut pipe: c_int = usb_sndctrlpipe(udev, 0);
    if (dev.disconnected)
    return -ENODEV;
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_write_regs(dev: *mut em28xx, reg: u16, buf: *mut c_char, len: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_write_reg(dev: *mut em28xx, reg: u16, val: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn em28xx_toggle_reg_bits(dev: *mut em28xx, reg: u16, bitmask: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_is_ac97_ready(dev: *mut em28xx) -> c_int {
    static int em28xx_is_ac97_ready(struct em28xx *dev)
    {
    let mut timeout: c_ulong = jiffies + msecs_to_jiffies(EM28XX_AC97_XFER_TIMEOUT);
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn em28xx_read_ac97(dev: *mut em28xx, reg: u8) -> c_int {
    int em28xx_read_ac97(struct em28xx *dev, u8 reg)
    {
    int ret;
    let mut addr: u8 = (reg & 0x7f) | 0x80;
    __le16 val;
...
//
#[no_mangle]
pub unsafe extern "C" fn em28xx_write_ac97(dev: *mut em28xx, reg: u8, val: u16) -> c_int {
    int em28xx_write_ac97(struct em28xx *dev, u8 reg, u16 val)
    {
    int ret;
    let mut addr: u8 = reg & 0x7f;
    __le16 value;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct em28xx_vol_itable {
    pub mux: enum em28xx_amux,
    pub reg: u8,
}
...
#[no_mangle]
unsafe extern "C" fn set_ac97_input(dev: *mut em28xx) -> c_int {
    static int set_ac97_input(struct em28xx *dev)
    {
    int ret, i;
    let mut amux: enum em28xx_amux = dev.ctl_ainput;
//
...
#[no_mangle]
unsafe extern "C" fn em28xx_set_audio_source(dev: *mut em28xx) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct em28xx_vol_otable {
    pub mux: enum em28xx_aout,
    pub reg: u8,
}
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_audio_analog_set(dev: *mut em28xx) -> c_int {
...
// Sets volume
    ...
    let mut sel: c_int = ac97_return_record_select(dev.ctl_aoutput);
//
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_audio_setup(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x838476: (vid >> 8) ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn em2828X_decoder_vmux(dev: *mut em28xx, vin: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_capture_start(dev: *mut em28xx, start: c_int) -> c_int {
    int em28xx_capture_start(struct em28xx *dev, int start)
    {
    int rc;
    const struct em28xx_led *led = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(PRIMARY_TS: dev->ts ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_gpio_set(dev: *mut em28xx, gpio: *const em28xx_reg_seq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_set_mode(dev: *mut em28xx, set_mode: enum em28xx_mode) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_irq_callback(urb: *mut urb) {
...
//
#[no_mangle]
pub unsafe extern "C" fn em28xx_uninit_usb_xfer(dev: *mut em28xx, mode: enum em28xx_mode) {
    ...
    usb_unlink_urb(urb);
    usb_free_urb(urb);
    usb_bufs.urb[i] = core::ptr::null_mut();
    }
    }
    kfree(usb_bufs.urb);
    kfree(usb_bufs.buf);
    usb_bufs.urb = core::ptr::null_mut();
    usb_bufs.buf = core::ptr::null_mut();
    usb_bufs.num_bufs = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn em28xx_stop_urbs(dev: *mut em28xx) {
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_register_extension(ops: *mut em28xx_ops) -> c_int {
    int em28xx_register_extension(struct em28xx_ops *ops)
    {
    struct em28xx *dev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_unregister_extension(ops: *mut em28xx_ops) {
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_init_extension(dev: *mut em28xx) {
    void em28xx_init_extension(struct em28xx *dev)
    {
    const struct em28xx_ops *ops = core::ptr::null_mut();
    mutex_lock(&em28xx_devlist_mutex);
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_close_extension(dev: *mut em28xx) {
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_suspend_extension(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_resume_extension(dev: *mut em28xx) -> c_int {
