...
//! Source: drivers/media/usb/em28xx/em28xx-audio.c
#![no_std]
...
pub const EM28XX_MAX_AUDIO_BUFS: c_int = 5;
pub const EM28XX_MIN_AUDIO_PACKETS: c_int = 64;
...
#[no_mangle]
unsafe extern "C" fn em28xx_deinit_isoc_audio(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_audio_isocirq(urb: *mut urb) {
    static void em28xx_audio_isocirq(struct urb *urb)
    {
    struct em28xx            *dev = urb.context;
    int                      i;
    unsigned int             oldptr;
    let mut period_elapsed: c_int = 0;
    int                      status;
    unsigned char            *cp;
    unsigned int             stride;
...
#[no_mangle]
unsafe extern "C" fn em28xx_init_audio_isoc(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_em28xx_capture_open(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_em28xx_pcm_close(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_em28xx_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn audio_trigger(work: *mut work_struct) {
...
//
    ...
    {
    struct em28xx *dev = snd_kcontrol_chip(kcontrol);
    let mut val: u16 = value.value.integer.value[0];
    struct snd_pcm_substream *substream = dev.adev.capture_pcm_substream;
    let mut nonblock: c_int = 0;
    int rc;
    if (dev.disconnected)
...
#[no_mangle]
unsafe extern "C" fn em28xx_audio_free_urb(dev: *mut em28xx) {
...
// high bandwidth multiplier, as encoded in highspeed endpoint descriptors
    ...
    {
    let mut size: c_int = le16_to_cpu(e.wMaxPacketSize);
    if (udev.speed == USB_SPEED_HIGH)
    return (size & 0x7ff) *  (1 + (((size) >> 11) & 0x03));
    return size & 0x7ff;
    }
#[no_mangle]
unsafe extern "C" fn em28xx_audio_urb_init(dev: *mut em28xx) -> c_int {
    static int em28xx_audio_urb_init(struct em28xx *dev)
    {
    struct usb_interface *intf;
    struct usb_endpoint_descriptor *e, *ep = core::ptr::null_mut();
    struct usb_device *udev = interface_to_usbdev(dev.intf);
...
#[no_mangle]
unsafe extern "C" fn em28xx_audio_init(dev: *mut em28xx) -> c_int {
...
//
    ...
    card_free:
    snd_card_free(card);
    adev.sndcard = core::ptr::null_mut();
    return err;
    }
#[no_mangle]
unsafe extern "C" fn em28xx_audio_fini(dev: *mut em28xx) -> c_int {
...
//
    ...
    dev.adev.sndcard = core::ptr::null_mut();
    }
    kref_put(&dev.ref, em28xx_free_device);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn em28xx_audio_suspend(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_audio_resume(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_alsa_register() -> int __init {
    static int __init em28xx_alsa_register(void)
    {
    return em28xx_register_extension(&audio_ops);
    }
#[no_mangle]
unsafe extern "C" fn em28xx_alsa_unregister() -> void __exit {
