...
//! Source: drivers/media/usb/em28xx/em28xx-camera.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn em28xx_initialize_mt9m111(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_initialize_mt9m001(dev: *mut em28xx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_probe_sensor_micron(dev: *mut em28xx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_probe_sensor_omnivision(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_detect_sensor(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_init_camera(dev: *mut em28xx) -> c_int {
...
//
    ...
    &mt9v011_info, core::ptr::null_mut()))
    return -ENODEV;
...
//
    ...
    subdev =
    v4l2_i2c_new_subdev_board(&v4l2.v4l2_dev, adap,
    &ov2640_info, core::ptr::null_mut());
    if (!subdev)
    return -ENODEV;
    format.format.code = MEDIA_BUS_FMT_YUYV8_2X8;
    format.format.width = 640;
    format.format.height = 480;
    v4l2_subdev_call(subdev, pad, set_fmt, core::ptr::null_mut(), &format);
