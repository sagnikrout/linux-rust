...
//! Source: drivers/media/usb/em28xx/em28xx-cards.c
#![no_std]
...
// Copyright (C) 2012 Frank Schäfer <fschaefer.oss@googlemail.com>
    ...
    let mut usb_xfer_mode: static int = -1;
...
//
    ...
    let mut em28xx_bcount: static unsigned int = ARRAY_SIZE(em28xx_boards);
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_tuner_callback(ptr: *mut c_void, component: c_int, command: c_int, arg: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_set_model(dev: *mut em28xx) {
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_pre_card_setup(dev: *mut em28xx) {
    static void em28xx_pre_card_setup(struct em28xx *dev)
    {
//
...
#[no_mangle]
unsafe extern "C" fn em28xx_hint_board(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_card_setup(dev: *mut em28xx) {
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_setup_xc3028(dev: *mut em28xx, ctl: *mut xc2028_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn if(EM28XX_USB_AUDIO_VENDOR: dev->usb_audio_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn request_modules(dev: *mut em28xx) {
...
#[no_mangle]
unsafe extern "C" fn flush_request_modules(dev: *mut em28xx) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: udev->manufacturer) -> else {
...
#[no_mangle]
unsafe extern "C" fn em28xx_unregister_media_device(dev: *mut em28xx) {
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_release_resources(dev: *mut em28xx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn em28xx_free_device(ref: *mut kref) {
...
//
    ...
    {
    int retval;
    const char *chip_name = core::ptr::null_mut();
    dev.intf = intf;
...
// Based on the Chip ID, set the device configuration
    ...
    let mut idProd: __le16 = udev.descriptor.idProduct;
    if (le16_to_cpu(idProd) == 0x2710)
    chip_name = "em2710";
#[no_mangle]
pub unsafe extern "C" fn if(0x2820: le16_to_cpu(idProd) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn em28xx_duplicate_dev(dev: *mut em28xx) -> c_int {
    static int em28xx_duplicate_dev(struct em28xx *dev)
    {
    int nr;
    struct em28xx *sec_dev = kmemdup(dev, sizeof(*sec_dev), GFP_KERNEL);
    if (!sec_dev) {
    dev.dev_next = core::ptr::null_mut();
    return -ENOMEM;
    }
...
// No free device slots
    ...
    sec_dev.dev_next = core::ptr::null_mut();
...
//
    ...
    int retval;
    let mut has_vendor_audio: bool = false, has_video = false, has_dvb = false;
    int i, nr, try_bulk;
    let mut ifnum: c_int = intf.altsetting[0].desc.bInterfaceNumber;
    char *speed;
...
// Select USB transfer types to use
    ...
    if (retval)
    goto err_free;
    dev.dev_next.board.ir_codes = core::ptr::null_mut(); /* No IR for 2nd tuner */
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_usb_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn em28xx_usb_resume(intf: *mut usb_interface) -> c_int {
