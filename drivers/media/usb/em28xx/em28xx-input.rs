...
//! Source: drivers/media/usb/em28xx/em28xx-input.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct em28xx_ir_poll_result {
    pub toggle_bit:1: c_uint,
    pub read_count:7: c_uint,
    pub protocol: enum rc_proto,
    pub scancode: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct em28xx_IR {
    pub dev: *mut em28xx,
    pub rc: *mut rc_dev,
    pub phys: [c_char; 32],
// poll decoder
    ...
    pub full_code:1: c_uint,
    pub last_readcount: c_uint,
    pub rc_proto: u64,
    pub i2c_client: *mut i2c_client,
    int  (*get_key_i2c)(struct i2c_client *ir, enum rc_proto *protocol,
    pub scancode): *mut u32,
    pub r): *mut *mut *mut int (get_key)(struct em28xx_IR ir, struct em28xx_ir_poll_result,
}
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_i2c_ir_handle_key(ir: *mut em28xx_IR) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_ir_handle_key(ir: *mut em28xx_IR) {
...
#[no_mangle]
unsafe extern "C" fn em28xx_ir_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn em28xx_ir_start(rc: *mut rc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_ir_stop(rc: *mut rc_dev) {
...
#[no_mangle]
unsafe extern "C" fn em2860_ir_change_protocol(rc_dev: *mut rc_dev, rc_proto: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em2874_ir_change_protocol(rc_dev: *mut rc_dev, rc_proto: *mut u64) -> c_int {
    static int em2874_ir_change_protocol(struct rc_dev *rc_dev, u64 *rc_proto)
    {
    struct em28xx_IR *ir = rc_dev.priv;
    struct em28xx *dev = ir.dev;
    let mut ir_config: u8 = EM2874_IR_RC5;
...
#[no_mangle]
unsafe extern "C" fn em28xx_ir_change_protocol(rc_dev: *mut rc_dev, rc_proto: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_probe_i2c_ir(dev: *mut em28xx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_query_buttons(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn em28xx_register_snapshot_button(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_init_buttons(dev: *mut em28xx) {
    static void em28xx_init_buttons(struct em28xx *dev)
    {
    let mut i: u8 = 0, j = 0;
    let mut addr_new: bool = false;
...
// Add read address to list of polling addresses
    if (addr_new) {
    let mut index: c_uint = dev.num_button_polling_addresses;
...
#[no_mangle]
unsafe extern "C" fn em28xx_shutdown_buttons(dev: *mut em28xx) {
...
// Deregister input devices
    ...
    dev.sbutton_input_dev = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn em28xx_ir_init(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_ir_fini(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_ir_suspend(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_ir_resume(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_rc_register() -> int __init {
    static int __init em28xx_rc_register(void)
    {
    return em28xx_register_extension(&rc_ops);
    }
#[no_mangle]
unsafe extern "C" fn em28xx_rc_unregister() -> void __exit {
