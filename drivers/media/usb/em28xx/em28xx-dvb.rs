...
//! Source: drivers/media/usb/em28xx/em28xx-dvb.c
#![no_std]
...
// Due to DRX-K - probably need changes
    pub gate): *mut *mut *mut int (gate_ctrl)(struct dvb_frontend fe, int,
    pub pll_mutex: semaphore,
    pub dont_attach_fe1: bool,
    pub lna_gpio: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_dvb_urb_data_copy(dev: *mut em28xx, urb: *mut urb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_start_streaming(dvb: *mut em28xx_dvb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_stop_streaming(dvb: *mut em28xx_dvb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_start_feed(feed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_stop_feed(feed: *mut dvb_demux_feed) -> c_int {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn em28xx_dvb_bus_ctrl(fe: *mut dvb_frontend, acquire: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_set_analog_freq(dev: *mut em28xx, freq: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drxk_gate_ctrl(fe: *mut dvb_frontend, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hauppauge_hvr930c_init(dev: *mut em28xx) {
...
#[no_mangle]
unsafe extern "C" fn terratec_h5_init(dev: *mut em28xx) {
...
#[no_mangle]
unsafe extern "C" fn terratec_htc_stick_init(dev: *mut em28xx) {
...
#[no_mangle]
unsafe extern "C" fn terratec_htc_usb_xs_init(dev: *mut em28xx) {
...
#[no_mangle]
unsafe extern "C" fn pctv_520e_init(dev: *mut em28xx) {
...
#[no_mangle]
unsafe extern "C" fn em28xx_pctv_290e_set_lna(fe: *mut dvb_frontend) -> c_int {
    ...
    ret = gpio_request_one(dvb.lna_gpio, flags, core::ptr::null_mut());
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn em28xx_pctv_292e_set_lna(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_mt352_terratec_xs_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn px_bcud_init(dev: *mut em28xx) {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn em28xx_attach_xc3028(addr: u8, dev: *mut em28xx) -> noinline_for_stack int {
    ...
    dev.dvb.fe[0] = core::ptr::null_mut();
    return -EINVAL;
    }
...
// ------------------------------------------------------------------
    ...
    {
    int result;
    let mut create_rf_connector: bool = false;
    mutex_init(&dvb.lock);
// register adapter
...
#[no_mangle]
unsafe extern "C" fn em28xx_unregister_dvb(dvb: *mut em28xx_dvb) {
...
#[no_mangle]
unsafe extern "C" fn em28174_dvb_init_pctv_460e(dev: *mut em28xx) -> c_int {
    static int em28174_dvb_init_pctv_460e(struct em28xx *dev)
    {
    struct em28xx_dvb *dvb = dev.dvb;
    let mut tda10071_pdata: tda10071_platform_data = {};
    let mut a8293_pdata: a8293_platform_data = {};
...
// attach SEC
    ...
    dvb.i2c_client_sec = dvb_module_probe("a8293", core::ptr::null_mut(),
    &dev.i2c_adap[dev.def_i2c_bus],
    0x08, &a8293_pdata);
...
#[no_mangle]
unsafe extern "C" fn em28178_dvb_init_pctv_461e(dev: *mut em28xx) -> c_int {
    static int em28178_dvb_init_pctv_461e(struct em28xx *dev)
    {
    struct em28xx_dvb *dvb = dev.dvb;
    struct i2c_adapter *i2c_adapter;
    let mut m88ds3103_pdata: m88ds3103_platform_data = {};
    let mut ts2020_config: ts2020_config = {};
    let mut a8293_pdata: a8293_platform_data = {};
// attach demod
    ...
    dvb.i2c_client_demod[0] = dvb_module_probe("m88ds3103", core::ptr::null_mut(),
    &dev.i2c_adap[dev.def_i2c_bus],
...
#[no_mangle]
unsafe extern "C" fn em28178_dvb_init_pctv_461e_vX(dev: *mut em28xx, version: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28178_dvb_init_pctv_292e(dev: *mut em28xx) -> c_int {
    static int em28178_dvb_init_pctv_292e(struct em28xx *dev)
    {
    struct em28xx_dvb *dvb = dev.dvb;
    struct i2c_adapter *adapter;
    let mut si2168_config: si2168_config = {};
    let mut si2157_config: si2157_config = {};
// attach demod
    si2168_config.i2c_adapter = &adapter;
    si2168_config.fe = &dvb.fe[0];
    si2168_config.ts_mode = SI2168_TS_PARALLEL;
    si2168_config.spectral_inversion = true;
    dvb.i2c_client_demod[0] = dvb_module_probe("si2168", core::ptr::null_mut(),
    &dev.i2c_adap[dev.def_i2c_bus],
    0x64, &si2168_config);
    if (!dvb.i2c_client_demod[0])
    return -ENODEV;
// attach tuner
    ...
    dvb.i2c_client_tuner = dvb_module_probe("si2157", core::ptr::null_mut(),
    adapter,
    0x60, &si2157_config);
    if (!dvb.i2c_client_tuner) {
    dvb_module_release(dvb.i2c_client_demod[0]);
...
#[no_mangle]
unsafe extern "C" fn em28178_dvb_init_terratec_t2_stick_hd(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28178_dvb_init_plex_px_bcud(dev: *mut em28xx) -> c_int {
    static int em28178_dvb_init_plex_px_bcud(struct em28xx *dev)
    {
    struct em28xx_dvb *dvb = dev.dvb;
    let mut tc90522_config: tc90522_config = {};
    let mut qm1d1c0042_config: qm1d1c0042_config = {};
// attach demod
...
// attach tuner
    ...
    dvb.i2c_client_tuner = dvb_module_probe("qm1d1c0042", core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn em28174_dvb_init_hauppauge_wintv_dualhd_dvb(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28174_dvb_init_hauppauge_wintv_dualhd_01595(dev: *mut em28xx) -> c_int {
    static int em28174_dvb_init_hauppauge_wintv_dualhd_01595(struct em28xx *dev)
    {
    struct em28xx_dvb *dvb = dev.dvb;
    struct i2c_adapter *adapter;
    let mut lgdt3306a_config: lgdt3306a_config = {};
    let mut si2157_config: si2157_config = {};
    unsigned char addr;
// attach demod
    ...
    dvb.i2c_client_demod[0] = dvb_module_probe("lgdt3306a", core::ptr::null_mut(),
    &dev.i2c_adap[dev.def_i2c_bus],
...
#[no_mangle]
unsafe extern "C" fn em2874_dvb_init_hauppauge_usb_quadhd(dev: *mut em28xx) -> c_int {
    static int em2874_dvb_init_hauppauge_usb_quadhd(struct em28xx *dev)
    {
    struct em28xx_dvb *dvb = dev.dvb;
    let mut mxl692_config: mxl692_config = {};
    unsigned char addr;
// attach demod/tuner combo
    mxl692_config.id = (dev.ts == PRIMARY_TS) ? 0 : 1;
    mxl692_config.fe = &dvb.fe[0];
    addr = (dev.ts == PRIMARY_TS) ? 0x60 : 0x63;
    dvb.i2c_client_demod[0] = dvb_module_probe("mxl692", core::ptr::null_mut(),
    &dev.i2c_adap[dev.def_i2c_bus],
    addr, &mxl692_config);
    if (!dvb.i2c_client_demod[0])
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn em2828X_dvb_init_hauppauge_wintv_935_v2(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em2828X_dvb_init_hauppauge_wintv_955_v2(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em2828X_dvb_init_hauppauge_wintv_975_v2(dev: *mut em28xx) -> c_int {
...
// attach demod
    ...
    si2168_config.ts_mode = SI2168_TS_SERIAL;
    si2168_config.ts_clock_inv = true;
    dvb.i2c_client_demod[1] = dvb_module_probe("si2168", core::ptr::null_mut(),
    &dev.i2c_adap[dev.def_i2c_bus],
    0x64, &si2168_config);
...
#[no_mangle]
unsafe extern "C" fn em28xx_dvb_init(dev: *mut em28xx) -> c_int {
    static int em28xx_dvb_init(struct em28xx *dev)
    {
    let mut result: c_int = 0, dvb_alt = 0;
...
// This device does not support the extension
    ...
    return -ENOMEM;
    dev.dvb = dvb;
    dvb.fe[0] = core::ptr::null_mut();
    dvb.fe[1] = core::ptr::null_mut();
    dvb.i2c_client_demod[0] = core::ptr::null_mut();
    dvb.i2c_client_demod[1] = core::ptr::null_mut();
...
//
    ...
    dvb.fe[0] = dvb_attach(drxd_attach, &em28xx_drxd, core::ptr::null_mut(),
    &dev.i2c_adap[dev.def_i2c_bus],
    &dev.intf.dev);
    if (em28xx_attach_xc3028(0x61, dev) < 0) {
    result = -EINVAL;
...
// enable LNA for DVB-T, DVB-T2 and DVB-C
    ...
    GPIOF_OUT_INIT_LOW, core::ptr::null_mut());
    if (result)
    dev_err(&dev.intf.dev,
...
// attach demodulator
    ...
    if (dvb.fe[0]) {
// disable I2C-gate
    dvb.fe[0].ops.i2c_gate_ctrl = core::ptr::null_mut();
// attach tuner
    if (!dvb_attach(tda18271_attach, dvb.fe[0], 0x60,
    &dev.i2c_adap[dev.def_i2c_bus],
    &em28xx_cxd2820r_tda18271_config)) {
...
// attach tuner
    ...
    dvb.i2c_client_tuner = dvb_module_probe("tda18212", core::ptr::null_mut(),
    adapter, 0x60,
...
#[no_mangle]
pub unsafe extern "C" fn prevent_sleep(ops: *mut dvb_frontend_ops) {
    static inline void prevent_sleep(struct dvb_frontend_ops *ops)
    {
    ops.set_voltage = core::ptr::null_mut();
    ops.sleep = core::ptr::null_mut();
    ops.tuner_ops.sleep = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn em28xx_dvb_fini(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_dvb_suspend(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_dvb_resume(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_dvb_register() -> int __init {
    static int __init em28xx_dvb_register(void)
    {
    return em28xx_register_extension(&dvb_ops);
    }
#[no_mangle]
unsafe extern "C" fn em28xx_dvb_unregister() -> void __exit {
