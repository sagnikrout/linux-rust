...
//! Source: drivers/media/usb/em28xx/em28xx-video.c
#![no_std]
...
pub const EM25XX_FRMDATAHDR_BYTE1: c_uint = 0x02;
pub const EM25XX_FRMDATAHDR_BYTE2_STILL_IMAGE: c_uint = 0x20;
pub const EM25XX_FRMDATAHDR_BYTE2_FRAME_END: c_uint = 0x02;
pub const EM25XX_FRMDATAHDR_BYTE2_FRAME_ID: c_uint = 0x01;
...
#[no_mangle]
pub unsafe extern "C" fn norm_maxw(dev: *mut em28xx) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn norm_maxh(dev: *mut em28xx) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn em28xx_vbi_supported(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_analogtv_supported(dev: *mut em28xx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_wake_i2c(dev: *mut em28xx) {
...
#[no_mangle]
unsafe extern "C" fn em28xx_colorlevels_set_default(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_set_outfmt(dev: *mut em28xx) -> c_int {
...
// PAL
    ...
    {
    let mut cwidth: u8 = width >> 2;
    let mut cheight: u8 = height >> 2;
    let mut overflow: u8 = (height >> 9 & 0x02) | (width >> 10 & 0x01);
...
#[no_mangle]
unsafe extern "C" fn em28xx_scaler_set(dev: *mut em28xx, h: u16, v: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_resolution_set(dev: *mut em28xx) -> c_int {
    static int em28xx_resolution_set(struct em28xx *dev)
    {
    struct em28xx_v4l2 *v4l2 = dev.v4l2;
    let mut width: c_int = norm_maxw(dev);
    let mut height: c_int = norm_maxh(dev);
// Properly setup VBI
    v4l2.vbi_width = 720;
    if (v4l2.norm & V4L2_STD_525_60)
    v4l2.vbi_height = 12;
...
#[no_mangle]
unsafe extern "C" fn em2828X_decoder_set_std(dev: *mut em28xx, norm: v4l2_std_id) {
...
#[no_mangle]
unsafe extern "C" fn em28xx_set_alternate(dev: *mut em28xx) -> c_int {
    ...
    int err;
    int i;
    let mut min_pkt_size: c_uint = v4l2.width * 2 + 4;
//
...
//
    ...
    let mut bytesperline: c_int = v4l2.width << 1;
...
//
    ...
    let mut vbi_size: c_int = v4l2.vbi_width * v4l2.vbi_height;
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_urb_data_copy(dev: *mut em28xx, urb: *mut urb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_resource(f_type: enum v4l2_buf_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn res_get(dev: *mut em28xx, f_type: enum v4l2_buf_type) -> c_int {
    static int res_get(struct em28xx *dev, enum v4l2_buf_type f_type)
    {
    let mut res_type: c_int = get_resource(f_type);
// is it free?
...
#[no_mangle]
unsafe extern "C" fn res_free(dev: *mut em28xx, f_type: enum v4l2_buf_type) {
...
#[no_mangle]
unsafe extern "C" fn em28xx_v4l2_media_release(dev: *mut em28xx) {
    ...
    dev.v4l2.decoder = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_enable_analog_tuner(dev: *mut em28xx) -> c_int {
    ...
    struct media_link *link, *found_link = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn em28xx_v4l2_create_entities(dev: *mut em28xx) {
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_start_analog_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_stop_streaming(vq: *mut vb2_queue) {
...
// Last active user, so shutdown all the URBS
    ...
    VB2_BUF_STATE_ERROR);
    dev.usb_ctl.vid_buf = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn em28xx_stop_vbi_streaming(vq: *mut vb2_queue) {
...
// Last active user, so shutdown all the URBS
    ...
    VB2_BUF_STATE_ERROR);
    dev.usb_ctl.vbi_buf = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn em28xx_vb2_setup(dev: *mut em28xx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn video_mux(dev: *mut em28xx, index: c_int) {
...
#[no_mangle]
unsafe extern "C" fn em28xx_ctrl_notify(ctrl: *mut v4l2_ctrl, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn em28xx_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    {
    let mut maxw: c_uint = norm_maxw(dev);
    let mut maxh: c_uint = norm_maxh(dev);
...
// FIXME: TOP? NONE? BOTTOM? ALTENATE?
    ...
    struct em28xx         *dev   = video_drvdata(file);
    struct em28xx_v4l2    *v4l2  = dev.v4l2;
    let mut width: c_uint = f.fmt.pix.width;
    let mut height: c_uint = f.fmt.pix.height;
    let mut maxw: c_uint = norm_maxw(dev);
    let mut maxh: c_uint = norm_maxh(dev);
...
#[no_mangle]
unsafe extern "C" fn vidioc_g_std(file: *mut file, priv: *mut c_void, norm: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_querystd(file: *mut file, priv: *mut c_void, norm: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_std(file: *mut file, priv: *mut c_void, norm: v4l2_std_id) -> c_int {
...
// set new image size
    ...
    {
    let mut ival: v4l2_subdev_frame_interval = { 0 };
    struct em28xx      *dev  = video_drvdata(file);
    struct em28xx_v4l2 *v4l2 = dev.v4l2;
    let mut rc: c_int = 0;
    ...
    pad, get_frame_interval, core::ptr::null_mut(),
    &ival);
    if (!rc)
    ...
    pad, set_frame_interval, core::ptr::null_mut(),
    &ival);
    if (!rc)
    p.parm.capture.timeperframe = ival.interval;
    return rc;
...
unsafe extern "C" fn vidioc_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
    ...
    unsigned int index)
    {
    let mut idx: c_uint = dev.amux_map[index];
//
...
#[no_mangle]
unsafe extern "C" fn vidioc_enumaudio(file: *mut file, fh: *mut c_void, a: *mut v4l2_audio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_g_audio(file: *mut file, priv: *mut c_void, a: *mut v4l2_audio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_reg_len(reg: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_free_v4l2(v4l2_dev: *mut v4l2_device) {
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_v4l2_open(filp: *mut file) -> c_int {
    static int em28xx_v4l2_open(struct file *filp)
    {
    struct video_device *vdev = video_devdata(filp);
    struct em28xx *dev = video_drvdata(filp);
    struct em28xx_v4l2 *v4l2;
    let mut fh_type: enum v4l2_buf_type = 0;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_v4l2_fini(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_v4l2_suspend(dev: *mut em28xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn em28xx_v4l2_resume(dev: *mut em28xx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_v4l2_close(filp: *mut file) -> c_int {
    ...
    _vb2_fop_release(filp, core::ptr::null_mut());
    if (last_user) {
...
#[no_mangle]
unsafe extern "C" fn em28xx_tuner_setup(dev: *mut em28xx, tuner_addr: c_ushort) {
...
#[no_mangle]
unsafe extern "C" fn em28xx_v4l2_init(dev: *mut em28xx) -> c_int {
...
// request some modules
    ...
    v4l2_i2c_new_subdev(&v4l2.v4l2_dev,
    &dev.i2c_adap[dev.def_i2c_bus],
    "tvaudio", dev.board.tvaudio_addr, core::ptr::null_mut());
// Initialize tuner and camera
    if (dev.board.tuner_type != TUNER_ABSENT) {
    let mut tuner_addr: c_ushort = dev.board.tuner_addr;
    let mut has_demod: c_int = (dev.board.tda9887_conf & TDA9887_PRESENT);
    if (dev.board.radio.type)
    v4l2_i2c_new_subdev(&v4l2.v4l2_dev,
    &dev.i2c_adap[dev.def_i2c_bus],
    ...
    v4l2_i2c_new_subdev(&v4l2.v4l2_dev,
    &dev.i2c_adap[dev.def_i2c_bus],
    "tuner", tuner_addr, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn em28xx_video_register() -> int __init {
    static int __init em28xx_video_register(void)
    {
    return em28xx_register_extension(&v4l2_ops);
    }
#[no_mangle]
unsafe extern "C" fn em28xx_video_unregister() -> void __exit {
