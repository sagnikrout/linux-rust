...
//! Source: drivers/media/usb/em28xx/em28xx-i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn em28xx_i2c_timeout(dev: *mut em28xx) -> c_int {
    static int em28xx_i2c_timeout(struct em28xx *dev)
    {
    let mut time: c_int = EM28XX_I2C_XFER_TIMEOUT;
...
//
#[no_mangle]
unsafe extern "C" fn em2800_i2c_send_bytes(dev: *mut em28xx, addr: u8, buf: *mut u8, len: u16) -> c_int {
    static int em2800_i2c_send_bytes(struct em28xx *dev, u8 addr, u8 *buf, u16 len)
    {
    let mut timeout: c_ulong = jiffies + em28xx_i2c_timeout(dev);
    int ret;
    u8 b2[6];
    if (len < 1 || len > 4)
    return -EOPNOTSUPP;
...
//
#[no_mangle]
unsafe extern "C" fn em2800_i2c_recv_bytes(dev: *mut em28xx, addr: u8, buf: *mut u8, len: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn em2800_i2c_check_for_device(dev: *mut em28xx, addr: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_i2c_recv_bytes(dev: *mut em28xx, addr: u16, buf: *mut u8, len: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn em28xx_i2c_check_for_device(dev: *mut em28xx, addr: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn em25xx_bus_B_check_for_device(dev: *mut em28xx, addr: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_check_for_device(i2c_bus: *mut em28xx_i2c_bus, addr: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(EM28XX_I2C_ALGO_EM2800: i2c_bus->algo_type ==) -> else {
    else if (i2c_bus.algo_type == EM28XX_I2C_ALGO_EM2800)
    rc = em2800_i2c_check_for_device(dev, addr);
#[no_mangle]
pub unsafe extern "C" fn if(EM28XX_I2C_ALGO_EM25XX_BUS_B: i2c_bus->algo_type ==) -> else {
...
//
    ...
    struct em28xx *dev = i2c_bus.dev;
    let mut bus: c_uint = i2c_bus.bus;
    int addr, rc, i;
    u8 reg;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn em28xx_hash_mem(buf: *mut c_char, length: c_int, bits: c_int) -> c_ulong {
...
//
    ...
    {
    let mut remain: c_int = len, rsize, rsize_max, ret;
    u8 buf[2];
// Sanity check
...
//
#[no_mangle]
unsafe extern "C" fn functionality(i2c_adap: *mut i2c_adapter) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn em28xx_do_i2c_scan(dev: *mut em28xx, bus: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn em28xx_i2c_unregister(dev: *mut em28xx, bus: c_uint) -> c_int {
