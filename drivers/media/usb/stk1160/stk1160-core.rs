...
//! Source: drivers/media/usb/stk1160/stk1160-core.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn stk1160_read_reg(dev: *mut stk1160, reg: u16, value: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn stk1160_write_reg(dev: *mut stk1160, reg: u16, value: u16) -> c_int {
    ...
    value, reg, core::ptr::null_mut(), 0, 1000);
    if (ret < 0) {
...
#[no_mangle]
pub unsafe extern "C" fn stk1160_select_input(dev: *mut stk1160) {
...
#[no_mangle]
unsafe extern "C" fn stk1160_reg_reset(dev: *mut stk1160) {
...
#[no_mangle]
unsafe extern "C" fn stk1160_release(v4l2_dev: *mut v4l2_device) {
...
//
    ...
    let mut has_video: bool = false, has_audio = false;
    const char *speed;
...
// Alloc an array for all possible max_pkt_size
    ...
    GFP_KERNEL);
    if (alt_max_pkt_size == core::ptr::null_mut())
    return -ENOMEM;
//
...
#[no_mangle]
unsafe extern "C" fn stk1160_disconnect(interface: *mut usb_interface) {
