...
//! Source: drivers/media/usb/stk1160/stk1160-video.c
#![no_std]
...
//
    ...
    {
    struct stk1160_buffer *buf = core::ptr::null_mut();
...
// Current buffer must be NULL when this functions gets called
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn stk1160_buffer_done(dev: *mut stk1160) {
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn stk1160_copy_video(dev: *mut stk1160, src: *mut u8, len: c_int) {
    void stk1160_copy_video(struct stk1160 *dev, u8 *src, int len)
    {
    int linesdone, lineoff, lencopy, offset;
    let mut bytesperline: c_int = dev.width * 2;
    struct stk1160_buffer *buf = dev.isoc_ctl.buf;
    u8 *dst = buf.mem;
    int remain;
//
...
//
#[no_mangle]
unsafe extern "C" fn stk1160_process_isoc(dev: *mut stk1160, urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn stk1160_isoc_irq(urb: *mut urb) {
...
//
#[no_mangle]
pub unsafe extern "C" fn stk1160_cancel_isoc(dev: *mut stk1160) {
...
#[no_mangle]
unsafe extern "C" fn stk_free_urb(dev: *mut stk1160, stk_urb: *mut stk1160_urb) {
    ...
    stk_urb.transfer_buffer = core::ptr::null_mut();
    stk_urb.sgt = core::ptr::null_mut();
    stk_urb.urb = core::ptr::null_mut();
    stk_urb.dev = core::ptr::null_mut();
    stk_urb.dma = 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn stk1160_free_isoc(dev: *mut stk1160) {
...
//
#[no_mangle]
pub unsafe extern "C" fn stk1160_uninit_isoc(dev: *mut stk1160) {
...
//
#[no_mangle]
pub unsafe extern "C" fn stk1160_alloc_isoc(dev: *mut stk1160) -> c_int {
