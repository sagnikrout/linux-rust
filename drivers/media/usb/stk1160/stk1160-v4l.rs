...
//! Source: drivers/media/usb/stk1160/stk1160-v4l.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stk1160_decimate_ctrl {
    pub row_en: bool col_en,,
    pub row_mode: enum stk1160_decimate_mode col_mode,,
    pub row_n: unsigned int col_n,,
}
...
#[no_mangle]
unsafe extern "C" fn stk1160_set_std(dev: *mut stk1160) {
...
//
#[no_mangle]
unsafe extern "C" fn stk1160_set_alternate(dev: *mut stk1160) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stk1160_start_streaming(dev: *mut stk1160) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk1160_stop_hw(dev: *mut stk1160) {
...
#[no_mangle]
unsafe extern "C" fn stk1160_stop_streaming(dev: *mut stk1160) -> c_int {
...
//
    ...
    {
    struct stk1160 *dev = video_drvdata(file);
    return stk1160_try_fmt(dev, f, core::ptr::null_mut());
    }
...
// Calling with NULL disables frame decimation
    stk1160_set_fmt(dev, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn stk1160_clear_queue(dev: *mut stk1160, vb2_state: enum vb2_buffer_state) {
...
#[no_mangle]
pub unsafe extern "C" fn stk1160_vb2_setup(dev: *mut stk1160) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn stk1160_video_register(dev: *mut stk1160) -> c_int {
