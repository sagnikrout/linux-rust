...
//! Source: drivers/media/usb/s2255/s2255drv.c
#![no_std]
...
pub const S2255_DEF_JPEG_QUAL: c_int = 50;
// vendor request in
pub const S2255_VR_IN: c_int = 0;
// vendor request out
pub const S2255_VR_OUT: c_int = 1;
// firmware query
pub const S2255_VR_FW: c_uint = 0x30;
// USB endpoint number for configuring the device
pub const S2255_CONFIG_EP: c_int = 2;
// maximum time for DSP to start responding after last FW word loaded(ms)
pub const S2255_DSP_BOOTTIME: c_int = 800;
// maximum time to wait for firmware to load (ms)

pub const S2255_MIN_BUFS: c_int = 2;
pub const S2255_SETMODE_TIMEOUT: c_int = 500;
pub const S2255_VIDSTATUS_TIMEOUT: c_int = 350;

pub const MAX_CHANNELS: c_int = 4;
pub const SYS_FRAMES: c_int = 4;
// maximum size is PAL full size plus room for the marker header(s)

pub const LINE_SZ_4CIFS_NTSC: c_int = 640;
pub const LINE_SZ_2CIFS_NTSC: c_int = 640;
pub const LINE_SZ_1CIFS_NTSC: c_int = 320;
pub const LINE_SZ_4CIFS_PAL: c_int = 704;
pub const LINE_SZ_2CIFS_PAL: c_int = 704;
pub const LINE_SZ_1CIFS_PAL: c_int = 352;
pub const NUM_LINES_4CIFS_NTSC: c_int = 240;
pub const NUM_LINES_2CIFS_NTSC: c_int = 240;
pub const NUM_LINES_1CIFS_NTSC: c_int = 240;
pub const NUM_LINES_4CIFS_PAL: c_int = 288;
pub const NUM_LINES_2CIFS_PAL: c_int = 288;
pub const NUM_LINES_1CIFS_PAL: c_int = 288;
pub const LINE_SZ_DEF: c_int = 640;
pub const NUM_LINES_DEF: c_int = 240;
// predefined settings
pub const FORMAT_NTSC: c_int = 1;
pub const FORMAT_PAL: c_int = 2;

// SCALE_4CIFSI is the 2 fields interpolated into one

pub const MASK_COLOR: c_uint = 0x000000ff;
pub const MASK_JPG_QUALITY: c_uint = 0x0000ff00;
pub const MASK_INPUT_TYPE: c_uint = 0x000f0000;
// frame decimation.
...
pub const DEF_BRIGHT: c_int = 0;
pub const DEF_CONTRAST: c_uint = 0x5c;
pub const DEF_SATURATION: c_uint = 0x80;
pub const DEF_HUE: c_int = 0;
// usb config commands

pub const CMD_2255: c_uint = 0xc2255000;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct s2255_mode {
    pub /: *mut *mut u32 format; / input video format (NTSC, PAL),
    pub /: *mut *mut u32 scale; / output video scale,
    pub /: *mut *mut u32 color; / output video color format,
    pub /: *mut *mut u32 fdec; / frame decimation,
    pub /: *mut *mut u32 bright; / brightness,
    pub /: *mut *mut u32 contrast; / contrast,
    pub /: *mut *mut u32 saturation; / saturation,
    pub only)*/: *mut *mut u32 hue; / hue (NTSC,
    pub (==0)*/: *mut *mut u32 single; / capture 1 frame at a time (!=0), continuously,
    pub /: *mut *mut u32 usb_block; / block size. should be 4096 of DEF_USB_BLOCK,
    pub /: *mut *mut u32 restart; / if DSP requires restart,
}

pub const S2255_READ_IDLE: c_int = 0;
pub const S2255_READ_FRAME: c_int = 1;
// frame structure
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s2255_framei {
    pub size: c_ulong,
    pub S2255_READ_FRAME*/: *mut *mut unsigned long state; / state:S2255_READ_IDLE,,
    pub /: *mut *mut *mut void lpvbits; / image data,
    pub /: *mut *mut unsigned long cur_size; / current data copied to it,
}

// image buffer structure
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s2255_bufferi {
    pub /: *mut *mut unsigned long num_frames; / number of frames in buffer,
    pub /: *mut *mut s2255_framei frame[SYS_FRAMES]; / array of FRAME structures,
}

    DEF_FDEC, DEF_BRIGHT, DEF_CONTRAST, DEF_SATURATION, \
    DEF_HUE, 0, DEF_USB_BLOCK, 0}
// for firmware loading, fw_state
pub const S2255_FW_NOTLOADED: c_int = 0;
pub const S2255_FW_LOADED_DSPWAIT: c_int = 1;
pub const S2255_FW_SUCCESS: c_int = 2;
pub const S2255_FW_FAILED: c_int = 3;
pub const S2255_FW_DISCONNECTING: c_int = 4;
...
pub struct s2255_fw {
    ...
    pub fw_size: c_int,
    pub fw_urb: *mut urb,
    pub fw_state: core::sync::atomic::AtomicI32,
    pub pfw_data: *mut c_void,
    pub wait_fw: wait_queue_head_t,
    pub fw: *const firmware,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct s2255_pipeinfo {
    pub max_transfer_size: u32,
    pub cur_transfer_size: u32,
    pub transfer_buffer: *mut u8,
    pub state: u32,
    pub stream_urb: *mut c_void,
    pub struct*/: *mut *mut *mut void dev; / back pointer to s2255_dev,
    pub err_count: u32,
    pub idx: u32,
}
...
#[derive(Copy, Clone)]
pub struct s2255_vc {
    pub dev: *mut s2255_dev,
    pub vdev: video_device,
    pub hdl: v4l2_ctrl_handler,
    pub jpegqual_ctrl: *mut v4l2_ctrl,
    pub resources: c_int,
    pub buf_list: list_head,
    pub buffer: s2255_bufferi,
    pub mode: s2255_mode,
    pub std: v4l2_std_id,
// jpeg compression
    pub jpegqual: c_uint,
// capture parameters (for high quality mode full size)
    pub cap_parm: v4l2_captureparm,
    pub cur_frame: c_int,
    pub last_frame: c_int,
// allocated image size
    pub req_image_size: c_ulong,
// received packet size
    pub pkt_size: c_ulong,
    pub bad_payload: c_int,
    pub frame_count: c_ulong,
// if JPEG image
    pub jpg_size: c_int,
// if channel configured to default state
    pub configured: c_int,
    pub wait_setmode: wait_queue_head_t,
    pub setmode_ready: c_int,
// video status items
    pub vidstatus: c_int,
    pub wait_vidstatus: wait_queue_head_t,
    pub vidstatus_ready: c_int,
    pub width: c_uint,
    pub height: c_uint,
    pub field: enum v4l2_field,
    pub fmt: *const s2255_fmt,
    pub /: *mut *mut int idx; / channel number on device, 0-3,
    pub vb_vidq: vb2_queue,
    pub /: *mut *mut mutex vb_lock; / streaming lock,
    pub qlock: spinlock_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct s2255_dev {
    pub vc: [s2255_vc; MAX_CHANNELS],
    pub v4l2_dev: v4l2_device,
    pub num_channels: refcount_t,
    pub frames: c_int,
    pub /: *mut *mut mutex lock; / channels[].vdev.lock,
    pub /: *mut *mut mutex cmdlock; / protects cmdbuf,
    pub udev: *mut usb_device,
    pub interface: *mut usb_interface,
    pub read_endpoint: u8,
    pub timer: timer_list,
    pub fw_data: *mut s2255_fw,
    pub pipe: s2255_pipeinfo,
    pub /: *mut *mut u32 cc; / current channel,
    pub frame_ready: c_int,
    pub chn_ready: c_int,
// dsp firmware version (f2255usb.bin)
    pub dsp_fw_ver: c_int,
    pub /: *mut *mut u16 pid; / product id,
pub const S2255_CMDBUF_SIZE: c_int = 512;
    pub cmdbuf: *mut __le32,
}
...
pub const S2255_CUR_DSP_FWVER: c_int = 10104;
// Need DSP version 5+ for video status feature
pub const S2255_MIN_DSP_STATUS: c_int = 5;
pub const S2255_MIN_DSP_COLORFILTER: c_int = 8;
...
// for reasons above.
//
pub const S2255_V4L2_YC_ON: c_int = 1;
pub const S2255_V4L2_YC_OFF: c_int = 0;

// frame prefix size (sent once every frame)
pub const PREFIX_SIZE: c_int = 512;
...
// Enable jpeg capture.
    let mut jpeg_enable: static int = 1;
...
// USB device table
pub const USB_SENSORAY_VID: c_uint = 0x1943;
...
#[no_mangle]
unsafe extern "C" fn norm_maxw(vc: *mut s2255_vc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn norm_maxh(vc: *mut s2255_vc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn norm_minw(vc: *mut s2255_vc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn norm_minh(vc: *mut s2255_vc) -> c_int {
...
//
    ...
    unsigned char *p_cb;
    unsigned char *p_cr;
    let mut size: c_ulong = height * width;
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn s2255_reset_dsppower(dev: *mut s2255_dev) {
    static void s2255_reset_dsppower(struct s2255_dev *dev)
    {
    s2255_vendor_req(dev, 0x40, 0x0000, 0x0001, core::ptr::null_mut(), 0, 1);
    msleep(50);
    s2255_vendor_req(dev, 0x50, 0x0000, 0x0000, core::ptr::null_mut(), 0, 1);
    msleep(600);
    s2255_vendor_req(dev, 0x10, 0x0000, 0x0000, core::ptr::null_mut(), 0, 1);
    }
// kickstarts the firmware loading. from probe
//
#[no_mangle]
unsafe extern "C" fn s2255_timer(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn s2255_fwchunk_complete(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn s2255_got_frame(vc: *mut s2255_vc, jpgsize: c_int) {
...
unsafe extern "C" fn buffer_prepare(vb: *mut vb2_buffer) -> c_int {
    ...
    let mut w: c_int = vc.width;
    let mut h: c_int = vc.height;
    unsigned long size;
    if (!vc.fmt)
    return -EINVAL;
    if (w < norm_minw(vc) ||
...
unsafe extern "C" fn buffer_queue(vb: *mut vb2_buffer) {
    ...
    {
    struct s2255_vc *vc = video_drvdata(file);
    let mut is_ntsc: c_int = vc.std & V4L2_STD_525_60;
...
// color mode
    ...
    mode.restart = 1;
#[no_mangle]
pub unsafe extern "C" fn if(vc->mode.scale: mode.scale !=) -> else {
    else if (mode.scale != vc.mode.scale)
    mode.restart = 1;
#[no_mangle]
pub unsafe extern "C" fn if(vc->mode.format: mode.format !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn get_transfer_size(mode: *mut s2255_mode) -> u32 {
    static u32 get_transfer_size(struct s2255_mode *mode)
    {
    let mut lines_per_frame: c_int = LINE_SZ_DEF;
    let mut pixels_per_line: c_int = NUM_LINES_DEF;
    u32 out_image_size;
    u32 usb_in_size;
...
#[no_mangle]
unsafe extern "C" fn s2255_print_cfg(sdev: *mut s2255_dev, mode: *mut s2255_mode) {
...
#[no_mangle]
unsafe extern "C" fn s2255_cmd_status(vc: *mut s2255_vc, pstatus: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
    static int start_streaming(struct vb2_queue *vq, unsigned int count)
    {
    struct s2255_vc *vc = vb2_get_drv_priv(vq);
    int j;
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_std(file: *mut file, priv: *mut c_void, i: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_g_std(file: *mut file, priv: *mut c_void, i: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_g_input(file: *mut file, priv: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2255_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
pub const NUM_SIZE_ENUMS: c_int = 3;
    ...
    let mut is_ntsc: c_int = vc.std & V4L2_STD_525_60;
pub const NUM_FRAME_ENUMS: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn s2255_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2255_destroy(dev: *mut s2255_dev) {
    static void s2255_destroy(struct s2255_dev *dev)
    {
...
// make sure firmware still not trying to load
    ...
    dev.fw_data.fw_urb = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn s2255_video_device_release(vdev: *mut video_device) {
...
#[no_mangle]
unsafe extern "C" fn s2255_probe_v4l(dev: *mut s2255_dev) -> c_int {
    static int s2255_probe_v4l(struct s2255_dev *dev)
    {
    int ret;
    int i;
    let mut cur_nr: c_int = video_nr;
    struct s2255_vc *vc;
    struct vb2_queue *q;
...
//
#[no_mangle]
unsafe extern "C" fn save_frame(dev: *mut s2255_dev, pipe_info: *mut s2255_pipeinfo) -> c_int {
    static int save_frame(struct s2255_dev *dev, struct s2255_pipeinfo *pipe_info)
    {
    char *pdest;
    let mut offset: u32 = 0;
    let mut bframe: c_int = 0;
    char *psrc;
...
// skip the marker 512 bytes (and offset if out of sync)
    ...
    if (!frm.lpvbits) {
    dprintk(dev, 1, "s2255 frame buffer == core::ptr::null_mut().%p %p %d %d",
    frm, dev, dev.cc, idx);
    return -ENOMEM;
    }
...
//
#[no_mangle]
unsafe extern "C" fn s2255_get_fx2fw(dev: *mut s2255_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s2255_create_sys_buffers(vc: *mut s2255_vc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2255_release_sys_buffers(vc: *mut s2255_vc) -> c_int {
    static int s2255_release_sys_buffers(struct s2255_vc *vc)
    {
    unsigned long i;
    for (i = 0; i < SYS_FRAMES; i++) {
    vfree(vc.buffer.frame[i].lpvbits);
    vc.buffer.frame[i].lpvbits = core::ptr::null_mut();
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn s2255_board_init(dev: *mut s2255_dev) -> c_int {
    static int s2255_board_init(struct s2255_dev *dev)
    {
    let mut mode_def: s2255_mode = DEF_MODEI_NTSC_CONT;
    int fw_ver;
    int j;
...
#[no_mangle]
unsafe extern "C" fn s2255_board_shutdown(dev: *mut s2255_dev) -> c_int {
    static int s2255_board_shutdown(struct s2255_dev *dev)
    {
    u32 i;
...
#[no_mangle]
unsafe extern "C" fn read_pipe_completion(purb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn s2255_start_readpipe(dev: *mut s2255_dev) -> c_int {
    static int s2255_start_readpipe(struct s2255_dev *dev)
    {
    int pipe;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn s2255_start_acquire(vc: *mut s2255_vc) -> c_int {
    static int s2255_start_acquire(struct s2255_vc *vc)
    {
    int res;
    unsigned long chn_rev;
...
#[no_mangle]
unsafe extern "C" fn s2255_stop_acquire(vc: *mut s2255_vc) -> c_int {
    static int s2255_stop_acquire(struct s2255_vc *vc)
    {
    int res;
    unsigned long chn_rev;
...
#[no_mangle]
unsafe extern "C" fn s2255_stop_readpipe(dev: *mut s2255_dev) {
    static void s2255_stop_readpipe(struct s2255_dev *dev)
    {
    struct s2255_pipeinfo *pipe = &dev.pipe;
    pipe.state = 0;
...
// cancel urb
    ...
    pipe.stream_urb = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn s2255_fwload_start(dev: *mut s2255_dev) {
    static void s2255_fwload_start(struct s2255_dev *dev)
    {
    s2255_reset_dsppower(dev);
...
// standard usb probe function
    ...
    {
    struct s2255_dev *dev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn s2255_disconnect(interface: *mut usb_interface) {
    static void s2255_disconnect(struct usb_interface *interface)
    {
    struct s2255_dev *dev = to_s2255_dev(usb_get_intfdata(interface));
    int i;
    let mut channels: c_int = refcount_read(&dev.num_channels);
    mutex_lock(&dev.lock);
