...
//! Source: drivers/media/tuners/msi001.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn msi001_wreg(dev: *mut msi001_dev, data: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi001_set_tuner(dev: *mut msi001_dev) -> c_int {
    ...
    let mut f_rf: c_uint = dev.f_tuner;
//
// bandwidth (Hz)
...
//
    let mut f_if: c_uint = 0;
pub const F_REF: c_int = 24000000;
pub const DIV_PRE_N: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn msi001_standby(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi001_g_tuner(sd: *mut v4l2_subdev, v: *mut v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi001_s_tuner(sd: *mut v4l2_subdev, v: *const v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi001_g_frequency(sd: *mut v4l2_subdev, f: *mut v4l2_frequency) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi001_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi001_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi001_remove(spi: *mut spi_device) {
