...
//! Source: drivers/media/tuners/tda18271-maps.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tda18271_pll_map {
    pub lomax: u32,
    pub /: *mut *mut u8 pd; / post div,
    pub /: *mut *mut u8 d; / div,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tda18271_map {
    pub rfmax: u32,
    pub val: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tda18271_thermo_map {
    pub d: u8,
    pub r0: u8,
    pub r1: u8,
}
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_lookup_thermometer(fe: *mut dvb_frontend) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tda18271_cid_target_map {
    pub rfmax: u32,
    pub target: u8,
    pub limit: u16,
}
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_lookup_rf_band(fe: *mut dvb_frontend, freq: *mut u32, rf_band: *mut u8) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tda18271_map_layout {
    pub main_pll: *mut tda18271_pll_map,
    pub cal_pll: *mut tda18271_pll_map,
    pub rf_cal: *mut tda18271_map,
    pub rf_cal_kmco: *mut tda18271_map,
    pub rf_cal_dc_over_dt: *mut tda18271_map,
    pub bp_filter: *mut tda18271_map,
    pub rf_band: *mut tda18271_map,
    pub gain_taper: *mut tda18271_map,
    pub ir_measure: *mut tda18271_map,
}
...
// ---------------------------------------------------------------------
    ...
    {
    struct tda18271_priv *priv = fe.tuner_priv;
    struct tda18271_pll_map *map = core::ptr::null_mut();
    let mut i: c_uint = 0;
    char *map_name;
    let mut ret: c_int = 0;
    BUG_ON(!priv.maps);
...
// div      = map[i].d;
    ...
    {
    struct tda18271_priv *priv = fe.tuner_priv;
    struct tda18271_map *map = core::ptr::null_mut();
    let mut i: c_uint = 0;
    char *map_name;
    let mut ret: c_int = 0;
    BUG_ON(!priv.maps);
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_assign_map_layout(fe: *mut dvb_frontend) -> c_int {
