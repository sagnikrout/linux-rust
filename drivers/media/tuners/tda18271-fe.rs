...
//! Source: drivers/media/tuners/tda18271-fe.c
#![no_std]
...
//
    ...
    let mut tda18271_cal_on_startup: static int = -1;
...
// ---------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn tda18271_toggle_output(fe: *mut dvb_frontend, standby: c_int) -> c_int {
...
// ---------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn charge_pump_source(fe: *mut dvb_frontend, force: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_set_if_notch(fe: *mut dvb_frontend) {
...
#[no_mangle]
unsafe extern "C" fn tda18271_read_thermometer(fe: *mut dvb_frontend) -> c_int {
...
// frequency dependent parameters
    ...
    rf_tab = regs[R_EB14];
    i = tda18271_lookup_rf_band(fe, &freq, core::ptr::null_mut());
    if (tda_fail(i))
    return i;
...
#[no_mangle]
unsafe extern "C" fn tda18271_por(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda18271_calibrate_rf(fe: *mut dvb_frontend, freq: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda18271_powerscan_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda18271_rf_tracking_filters_init(fe: *mut dvb_frontend, freq: u32) -> c_int {
...
pub const RF1: c_int = 0;
pub const RF2: c_int = 1;
pub const RF3: c_int = 2;
    u32 rf_default[3];
    u32 rf_freq[3];
    s32 prog_cal[3];
    s32 prog_tab[3];
...
#[no_mangle]
unsafe extern "C" fn tda18271_calc_rf_filter_curve(fe: *mut dvb_frontend) -> c_int {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn tda18271c2_rf_cal_init(fe: *mut dvb_frontend) -> c_int {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn tda18271_ir_cal_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda18271_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda18271_sleep(fe: *mut dvb_frontend) -> c_int {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn tda18271_agc(fe: *mut dvb_frontend) -> c_int {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn tda18271_set_params(fe: *mut dvb_frontend) -> c_int {
    static int tda18271_set_params(struct dvb_frontend *fe)
    {
    struct dtv_frontend_properties *c = &fe.dtv_property_cache;
    let mut delsys: u32 = c.delivery_system;
    let mut bw: u32 = c.bandwidth_hz;
    let mut freq: u32 = c.frequency;
    struct tda18271_priv *priv = fe.tuner_priv;
...
#[no_mangle]
unsafe extern "C" fn tda18271_release(fe: *mut dvb_frontend) {
    ...
    fe.tuner_priv = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn tda18271_get_frequency(fe: *mut dvb_frontend, frequency: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda18271_get_bandwidth(fe: *mut dvb_frontend, bandwidth: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda18271_get_if_frequency(fe: *mut dvb_frontend, frequency: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda18271_dump_std_map(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda18271_get_id(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_need_cal_on_startup(cfg: *mut tda18271_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda18271_set_config(fe: *mut dvb_frontend, priv_cfg: *mut c_void) -> c_int {
...
// override default std map with values in config struct
    ...
    struct tda18271_config *cfg)
    {
    struct tda18271_priv *priv = core::ptr::null_mut();
    int instance, ret;
    mutex_lock(&tda18271_list_mutex);
