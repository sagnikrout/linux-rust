...
//! Source: drivers/media/tuners/tda18271-common.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tda18271_i2c_gate_ctrl(fe: *mut dvb_frontend, enable: c_int) -> c_int {
...
// ---------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn tda18271_dump_regs(fe: *mut dvb_frontend, extended: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_read_regs(fe: *mut dvb_frontend) -> c_int {
    int tda18271_read_regs(struct dvb_frontend *fe)
    {
    struct tda18271_priv *priv = fe.tuner_priv;
    unsigned char *regs = priv.tda18271_regs;
    let mut buf: c_uchar = 0x00;
    int ret;
    struct i2c_msg msg[] = {
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_read_extended(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_write_regs(fe: *mut dvb_frontend, idx: c_int, len: c_int) -> c_int {
...
// ---------------------------------------------------------------------
    ...
    struct tda18271_priv *priv = fe.tuner_priv;
    unsigned char *regs = priv.tda18271_regs;
    let mut r_cp: c_int = (pll == TDA18271_CAL_PLL) ? R_EB7 : R_EB4;
    regs[r_cp] &= ~0x20;
    regs[r_cp] |= ((force & 1) << 5);
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_init_regs(fe: *mut dvb_frontend) -> c_int {
...
// ---------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn tda18271_calc_main_pll(fe: *mut dvb_frontend, freq: u32) -> c_int {
...
// sets main post divider & divider bytes, but does not write them
    ...
    u8 d, pd;
    u32 div;
    let mut ret: c_int = tda18271_lookup_pll_map(fe, MAIN_PLL, &freq, &pd, &d);
    if (tda_fail(ret))
    goto fail;
    regs[R_MPD]   = (0x7f & pd);
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_calc_cal_pll(fe: *mut dvb_frontend, freq: u32) -> c_int {
...
// sets cal post divider & divider bytes, but does not write them
    ...
    u8 d, pd;
    u32 div;
    let mut ret: c_int = tda18271_lookup_pll_map(fe, CAL_PLL, &freq, &pd, &d);
    if (tda_fail(ret))
    goto fail;
    regs[R_CPD]   = pd;
    div =  ((d * (freq / 1000)) << 7) / 125;
...
// ---------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn tda18271_calc_bp_filter(fe: *mut dvb_frontend, freq: *mut u32) -> c_int {
...
// sets bp filter bits, but does not write them
    ...
    unsigned char *regs = priv.tda18271_regs;
    u8 val;
    let mut ret: c_int = tda18271_lookup_map(fe, BP_FILTER, freq, &val);
    if (tda_fail(ret))
    goto fail;
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_calc_km(fe: *mut dvb_frontend, freq: *mut u32) -> c_int {
...
// sets K & M bits, but does not write them
    ...
    unsigned char *regs = priv.tda18271_regs;
    u8 val;
    let mut ret: c_int = tda18271_lookup_map(fe, RF_CAL_KMCO, freq, &val);
    if (tda_fail(ret))
    goto fail;
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_calc_rf_band(fe: *mut dvb_frontend, freq: *mut u32) -> c_int {
...
// sets rf band bits, but does not write them
    ...
    unsigned char *regs = priv.tda18271_regs;
    u8 val;
    let mut ret: c_int = tda18271_lookup_map(fe, RF_BAND, freq, &val);
    if (tda_fail(ret))
    goto fail;
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_calc_gain_taper(fe: *mut dvb_frontend, freq: *mut u32) -> c_int {
...
// sets gain taper bits, but does not write them
    ...
    unsigned char *regs = priv.tda18271_regs;
    u8 val;
    let mut ret: c_int = tda18271_lookup_map(fe, GAIN_TAPER, freq, &val);
    if (tda_fail(ret))
    goto fail;
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_calc_ir_measure(fe: *mut dvb_frontend, freq: *mut u32) -> c_int {
...
// sets IR Meas bits, but does not write them
    ...
    unsigned char *regs = priv.tda18271_regs;
    u8 val;
    let mut ret: c_int = tda18271_lookup_map(fe, IR_MEASURE, freq, &val);
    if (tda_fail(ret))
    goto fail;
    regs[R_EP5] &= ~0x07;
    regs[R_EP5] |= (0x07 & val);
...
#[no_mangle]
pub unsafe extern "C" fn tda18271_calc_rf_cal(fe: *mut dvb_frontend, freq: *mut u32) -> c_int {
...
// sets rf cal byte (RFC_Cprog), but does not write it
    ...
    unsigned char *regs = priv.tda18271_regs;
    u8 val;
    let mut ret: c_int = tda18271_lookup_map(fe, RF_CAL, freq, &val);
