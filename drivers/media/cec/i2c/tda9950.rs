...
//! Source: drivers/media/cec/i2c/tda9950.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tda9950_priv {
    pub client: *mut i2c_client,
    pub hdmi: *mut device,
    pub adap: *mut cec_adapter,
    pub glue: *mut tda9950_glue,
    pub addresses: u16,
    pub rx_msg: cec_msg,
...
#[no_mangle]
unsafe extern "C" fn tda9950_write_range(client: *mut i2c_client, addr: u8, p: *mut u8, cnt: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda9950_write(client: *mut i2c_client, addr: u8, val: u8) {
    static void tda9950_write(struct i2c_client *client, u8 addr, u8 val)
    {
    tda9950_write_range(client, addr, &val, 1);
    }
#[no_mangle]
unsafe extern "C" fn tda9950_read_range(client: *mut i2c_client, addr: u8, p: *mut u8, cnt: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda9950_read(client: *mut i2c_client, addr: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn tda9950_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tda9950_cec_adap_log_addr(adap: *mut cec_adapter, addr: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tda9950_glue_open(priv: *mut tda9950_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda9950_glue_release(priv: *mut tda9950_priv) {
...
#[no_mangle]
unsafe extern "C" fn tda9950_open(priv: *mut tda9950_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda9950_release(priv: *mut tda9950_priv) {
...
#[no_mangle]
unsafe extern "C" fn tda9950_cec_adap_enable(adap: *mut cec_adapter, enable: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tda9950_devm_glue_exit(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tda9950_devm_glue_init(dev: *mut device, glue: *mut tda9950_glue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda9950_cec_del(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tda9950_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    ret = devm_request_threaded_irq(dev, client.irq, core::ptr::null_mut(), tda9950_irq,
    irqflags | IRQF_SHARED | IRQF_ONESHOT,
    dev_name(&client.dev), priv);
    if (ret < 0)
    return ret;
    priv.notify = cec_notifier_cec_adap_register(priv.hdmi, core::ptr::null_mut(),
    priv.adap);
    if (!priv.notify)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn tda9950_remove(client: *mut i2c_client) {
