...
//! Source: drivers/media/cec/core/cec-pin.c
#![no_std]
...
// start bit timings
pub const CEC_TIM_START_BIT_LOW: c_int = 3700;
pub const CEC_TIM_START_BIT_LOW_MIN: c_int = 3500;
pub const CEC_TIM_START_BIT_LOW_MAX: c_int = 3900;
pub const CEC_TIM_START_BIT_TOTAL: c_int = 4500;
pub const CEC_TIM_START_BIT_TOTAL_MIN: c_int = 4300;
pub const CEC_TIM_START_BIT_TOTAL_MAX: c_int = 4700;
// data bit timings
pub const CEC_TIM_DATA_BIT_0_LOW: c_int = 1500;
pub const CEC_TIM_DATA_BIT_0_LOW_MIN: c_int = 1300;
pub const CEC_TIM_DATA_BIT_0_LOW_MAX: c_int = 1700;
pub const CEC_TIM_DATA_BIT_1_LOW: c_int = 600;
pub const CEC_TIM_DATA_BIT_1_LOW_MIN: c_int = 400;
pub const CEC_TIM_DATA_BIT_1_LOW_MAX: c_int = 800;
pub const CEC_TIM_DATA_BIT_TOTAL: c_int = 2400;
pub const CEC_TIM_DATA_BIT_TOTAL_MIN: c_int = 2050;
pub const CEC_TIM_DATA_BIT_TOTAL_MAX: c_int = 2750;
// earliest safe time to sample the bit state
pub const CEC_TIM_DATA_BIT_SAMPLE: c_int = 850;
// earliest time the bit is back to 1 (T7 + 50)
pub const CEC_TIM_DATA_BIT_HIGH: c_int = 1750;
// when idle, sample once per millisecond
pub const CEC_TIM_IDLE_SAMPLE: c_int = 1000;
// when processing the start bit, sample twice per millisecond
pub const CEC_TIM_START_BIT_SAMPLE: c_int = 500;
// when polling for a state change, sample once every 50 microseconds
pub const CEC_TIM_SAMPLE: c_int = 50;

//
// Total data bit time that is too short/long for a valid bit,
// used for error injection.
//
pub const CEC_TIM_DATA_BIT_TOTAL_SHORT: c_int = 1800;
pub const CEC_TIM_DATA_BIT_TOTAL_LONG: c_int = 2900;
//
// Total start bit time that is too short/long for a valid bit,
// used for error injection.
//
pub const CEC_TIM_START_BIT_TOTAL_SHORT: c_int = 4100;
pub const CEC_TIM_START_BIT_TOTAL_LONG: c_int = 5000;
// Data bits are 0-7, EOM is bit 8 and ACK is bit 9
pub const EOM_BIT: c_int = 8;
pub const ACK_BIT: c_int = 9;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cec_state {
...
#[no_mangle]
unsafe extern "C" fn cec_pin_update(pin: *mut cec_pin, v: bool, force: bool) {
...
#[no_mangle]
unsafe extern "C" fn cec_pin_read(pin: *mut cec_pin) -> bool {
    static bool cec_pin_read(struct cec_pin *pin)
    {
    let mut v: bool = call_pin_op(pin, read);
    cec_pin_update(pin, v, false);
    return v;
    }
#[no_mangle]
unsafe extern "C" fn cec_pin_insert_glitch(pin: *mut cec_pin, rising_edge: bool) {
...
#[no_mangle]
unsafe extern "C" fn cec_pin_low(pin: *mut cec_pin) {
...
#[no_mangle]
unsafe extern "C" fn cec_pin_high(pin: *mut cec_pin) -> bool {
    ...
    let mut cmd: u16 = cec_pin_rx_error_inj(pin);
    let mut e: u64 = pin.error_inj[cmd];
    let mut mode: c_uint = (e >> mode_offset) & CEC_ERROR_INJ_MODE_MASK;
    if (arg_idx >= 0) {
    let mut pos: u8 = pin.error_inj_args[cmd][arg_idx];
    if (arg)
// arg = pos;
#[no_mangle]
pub unsafe extern "C" fn if(pin->rx_bit: pos !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn rx_nack(pin: *mut cec_pin) -> bool {
    static bool rx_nack(struct cec_pin *pin)
    {
    return rx_error_inj(pin, CEC_ERROR_INJ_RX_NACK_OFFSET, -1, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn rx_low_drive(pin: *mut cec_pin) -> bool {
    static bool rx_low_drive(struct cec_pin *pin)
    {
    return rx_error_inj(pin, CEC_ERROR_INJ_RX_LOW_DRIVE_OFFSET,
    CEC_ERROR_INJ_RX_LOW_DRIVE_ARG_IDX, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn rx_add_byte(pin: *mut cec_pin) -> bool {
    static bool rx_add_byte(struct cec_pin *pin)
    {
    return rx_error_inj(pin, CEC_ERROR_INJ_RX_ADD_BYTE_OFFSET, -1, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn rx_remove_byte(pin: *mut cec_pin) -> bool {
    static bool rx_remove_byte(struct cec_pin *pin)
    {
    return rx_error_inj(pin, CEC_ERROR_INJ_RX_REMOVE_BYTE_OFFSET, -1, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn rx_arb_lost(pin: *mut cec_pin, poll: *mut u8) -> bool {
    ...
    let mut cmd: u16 = cec_pin_tx_error_inj(pin);
    let mut e: u64 = pin.error_inj[cmd];
    let mut mode: c_uint = (e >> mode_offset) & CEC_ERROR_INJ_MODE_MASK;
    if (arg_idx >= 0) {
    let mut pos: u8 = pin.error_inj_args[cmd][arg_idx];
...
// arg = pos;
#[no_mangle]
pub unsafe extern "C" fn if(pin->tx_bit: pos !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn tx_no_eom(pin: *mut cec_pin) -> bool {
    static bool tx_no_eom(struct cec_pin *pin)
    {
    return tx_error_inj(pin, CEC_ERROR_INJ_TX_NO_EOM_OFFSET, -1, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tx_early_eom(pin: *mut cec_pin) -> bool {
    static bool tx_early_eom(struct cec_pin *pin)
    {
    return tx_error_inj(pin, CEC_ERROR_INJ_TX_EARLY_EOM_OFFSET, -1, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tx_short_bit(pin: *mut cec_pin) -> bool {
    static bool tx_short_bit(struct cec_pin *pin)
    {
    return tx_error_inj(pin, CEC_ERROR_INJ_TX_SHORT_BIT_OFFSET,
    CEC_ERROR_INJ_TX_SHORT_BIT_ARG_IDX, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tx_long_bit(pin: *mut cec_pin) -> bool {
    static bool tx_long_bit(struct cec_pin *pin)
    {
    return tx_error_inj(pin, CEC_ERROR_INJ_TX_LONG_BIT_OFFSET,
    CEC_ERROR_INJ_TX_LONG_BIT_ARG_IDX, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tx_custom_bit(pin: *mut cec_pin) -> bool {
    static bool tx_custom_bit(struct cec_pin *pin)
    {
    return tx_error_inj(pin, CEC_ERROR_INJ_TX_CUSTOM_BIT_OFFSET,
    CEC_ERROR_INJ_TX_CUSTOM_BIT_ARG_IDX, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tx_short_start(pin: *mut cec_pin) -> bool {
    static bool tx_short_start(struct cec_pin *pin)
    {
    return tx_error_inj(pin, CEC_ERROR_INJ_TX_SHORT_START_OFFSET, -1, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tx_long_start(pin: *mut cec_pin) -> bool {
    static bool tx_long_start(struct cec_pin *pin)
    {
    return tx_error_inj(pin, CEC_ERROR_INJ_TX_LONG_START_OFFSET, -1, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tx_custom_start(pin: *mut cec_pin) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tx_last_bit(pin: *mut cec_pin) -> bool {
    static bool tx_last_bit(struct cec_pin *pin)
    {
    return tx_error_inj(pin, CEC_ERROR_INJ_TX_LAST_BIT_OFFSET,
    CEC_ERROR_INJ_TX_LAST_BIT_ARG_IDX, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tx_add_bytes(pin: *mut cec_pin) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn tx_remove_byte(pin: *mut cec_pin) -> bool {
    static bool tx_remove_byte(struct cec_pin *pin)
    {
    return tx_error_inj(pin, CEC_ERROR_INJ_TX_REMOVE_BYTE_OFFSET, -1, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tx_low_drive(pin: *mut cec_pin) -> bool {
    static bool tx_low_drive(struct cec_pin *pin)
    {
    return tx_error_inj(pin, CEC_ERROR_INJ_TX_LOW_DRIVE_OFFSET,
    CEC_ERROR_INJ_TX_LOW_DRIVE_ARG_IDX, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn cec_pin_to_idle(pin: *mut cec_pin) {
...
//
#[no_mangle]
unsafe extern "C" fn cec_pin_tx_states(pin: *mut cec_pin, ts: ktime_t) {
...
//
    let mut idx: c_uint = (pin.tx_bit / 10);
    let mut val: u8 = idx;
    ...
    pin.tx_extra_bytes;
    let mut tx_byte_idx: c_uint = pin.tx_bit / 10;
...
//
#[no_mangle]
unsafe extern "C" fn cec_pin_rx_states(pin: *mut cec_pin, ts: ktime_t) {
...
//
#[no_mangle]
unsafe extern "C" fn cec_pin_timer(timer: *mut hrtimer) -> enum hrtimer_restart {
...
// Generate custom pulse
    ...
    if (pin.state != CEC_ST_IDLE || pin.ops.enable_irq == core::ptr::null_mut() ||
...
#[no_mangle]
unsafe extern "C" fn cec_pin_thread_func(_adap: *mut c_void) -> c_int {
...
// Error injection: remove byte from message
    ...
    let mut tx_status: c_uint = pin.work_tx_status;
    pin.work_tx_status = 0;
    cec_transmit_attempt_done_ts(adap, tx_status,
    pin.work_tx_ts);
    }
    while (atomic_read_acquire(&pin.work_pin_num_events)) {
    let mut idx: c_uint = pin.work_pin_events_rd;
    let mut v: u8 = pin.work_pin_events[idx];
...
#[no_mangle]
unsafe extern "C" fn cec_pin_adap_enable(adap: *mut cec_adapter, enable: bool) -> c_int {
    ...
    let mut err: c_int = PTR_ERR(pin.kthread);
    pr_err("cec-pin: kernel_thread() failed\n");
    pin.kthread = core::ptr::null_mut();
    return err;
    }
    }
    hrtimer_start(&pin.timer, ns_to_ktime(0),
...
#[no_mangle]
unsafe extern "C" fn cec_pin_adap_log_addr(adap: *mut cec_adapter, log_addr: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cec_pin_start_timer(pin: *mut cec_pin) {
...
#[no_mangle]
unsafe extern "C" fn cec_pin_adap_free(adap: *mut cec_adapter) {
    ...
    if (pin.ops.free)
    pin.ops.free(adap);
    adap.pin = core::ptr::null_mut();
    kfree(pin);
    }
#[no_mangle]
unsafe extern "C" fn cec_pin_received(adap: *mut cec_adapter, msg: *mut cec_msg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cec_pin_changed(adap: *mut cec_adapter, value: bool) {
