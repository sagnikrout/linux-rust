...
//! Source: drivers/media/cec/core/cec-pin-error-inj.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cec_error_inj_cmd {
    pub mode_offset: c_uint,
    pub arg_idx: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn cec_pin_rx_error_inj(pin: *mut cec_pin) -> u16 {
    u16 cec_pin_rx_error_inj(struct cec_pin *pin)
    {
    let mut cmd: u16 = CEC_ERROR_INJ_OP_ANY;
...
#[no_mangle]
pub unsafe extern "C" fn cec_pin_tx_error_inj(pin: *mut cec_pin) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn cec_pin_error_inj_parse_line(adap: *mut cec_adapter, line: *mut c_char) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(comma, _arg: "once")) -> else {
    else if (!strcmp(comma, "once"))
    mode = CEC_ERROR_INJ_MODE_ONCE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(comma, _arg: "always")) -> else {
    else if (!strcmp(comma, "always"))
    mode = CEC_ERROR_INJ_MODE_ALWAYS;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(comma, _arg: "toggle")) -> else {
...
#[no_mangle]
unsafe extern "C" fn cec_pin_show_cmd(sf: *mut seq_file, cmd: u32, mode: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn cec_pin_error_inj_show(adap: *mut cec_adapter, sf: *mut seq_file) -> c_int {
