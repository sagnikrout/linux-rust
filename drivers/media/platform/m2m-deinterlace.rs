...
//! Source: drivers/media/platform/m2m-deinterlace.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct deinterlace_q_data {
    pub width: c_uint,
    pub height: c_uint,
    pub sizeimage: c_uint,
    pub fmt: *mut deinterlace_fmt,
...
//
#[no_mangle]
unsafe extern "C" fn deinterlace_job_ready(priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn deinterlace_job_abort(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn deinterlace_device_run(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn vidioc_g_fmt(ctx: *mut deinterlace_ctx, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_try_fmt(f: *mut v4l2_format, fmt: *mut deinterlace_fmt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_fmt(ctx: *mut deinterlace_ctx, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn deinterlace_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn deinterlace_buf_queue(vb: *mut vb2_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn deinterlace_open(file: *mut file) -> c_int {
    static int deinterlace_open(struct file *file)
    {
    struct deinterlace_dev *pcdev = video_drvdata(file);
    struct deinterlace_ctx *ctx = core::ptr::null_mut();
    ctx = kzalloc_obj(*ctx);
    if (!ctx)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn deinterlace_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn deinterlace_probe(pdev: *mut platform_device) -> c_int {
    ...
    pcdev.dma_chan = dma_request_channel(mask, core::ptr::null_mut(), pcdev);
    if (!pcdev.dma_chan)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn deinterlace_remove(pdev: *mut platform_device) {
