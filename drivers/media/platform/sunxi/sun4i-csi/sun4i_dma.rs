...
//! Source: drivers/media/platform/sunxi/sun4i-csi/sun4i_dma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sun4i_csi_capture_start(csi: *mut sun4i_csi) {
    static void sun4i_csi_capture_start(struct sun4i_csi *csi)
    {
    writel(CSI_CPT_CTRL_VIDEO_START, csi.regs + CSI_CPT_CTRL_REG);
    }
#[no_mangle]
unsafe extern "C" fn sun4i_csi_capture_stop(csi: *mut sun4i_csi) {
    ...
    let mut num_planes: c_uint = csi.fmt.num_planes;
    unsigned int i;
    if (*nplanes) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_csi_buffer_prepare(vb: *mut vb2_buffer) -> c_int {
    ...
    let mut size: c_ulong = csi.fmt.plane_fmt[i].sizeimage;
    ...
    unsigned int slot)
    {
    let mut addr: dma_addr_t = csi.scratch.paddr;
    unsigned int plane;
    dev_dbg(csi.dev,
    ...
    csi.current_buf[slot] = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn sun4i_csi_buffer_fill_slot(csi: *mut sun4i_csi, slot: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_csi_buffer_fill_all(csi: *mut sun4i_csi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_csi_buffer_flip(csi: *mut sun4i_csi, sequence: c_uint) -> c_int {
    static int sun4i_csi_buffer_flip(struct sun4i_csi *csi, unsigned int sequence)
    {
    let mut reg: u32 = readl(csi.regs + CSI_BUF_CTRL_REG);
    unsigned int next;
...
#[no_mangle]
unsafe extern "C" fn sun4i_csi_buffer_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_csi_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
    ...
    unsigned int i;
    int ret;
    csi_fmt = sun4i_csi_find_format(&csi.fmt.pixelformat, core::ptr::null_mut());
    if (!csi_fmt) {
    ret = -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn sun4i_csi_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_csi_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_csi_dma_register(csi: *mut sun4i_csi, irq: c_int) -> c_int {
    ...
    csi.current_buf[i] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_csi_dma_unregister(csi: *mut sun4i_csi) {
