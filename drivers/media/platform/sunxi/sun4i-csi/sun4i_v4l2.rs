...
//! Source: drivers/media/platform/sunxi/sun4i-csi/sun4i_v4l2.c
#![no_std]
...
pub const CSI_DEFAULT_WIDTH: c_int = 640;
pub const CSI_DEFAULT_HEIGHT: c_int = 480;
...
// i = 0;
    ...
    unsigned int i;
    _fmt = sun4i_csi_find_format(&pix.pixelformat, core::ptr::null_mut());
    if (!_fmt)
...
// Clamp the width and height to our capabilities
    ...
    let mut hsub: c_uint = i > 0 ? _fmt.hsub : 1;
    let mut vsub: c_uint = i > 0 ? _fmt.vsub : 1;
    unsigned int bpl;
...
#[no_mangle]
unsafe extern "C" fn sun4i_csi_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_csi_release(file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_csi_v4l2_register(csi: *mut sun4i_csi) -> c_int {
