...
//! Source: drivers/media/platform/sunxi/sun8i-rotate/sun8i_rotate.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rotate_read(dev: *mut rotate_dev, reg: u32) -> u32 {
    static inline u32 rotate_read(struct rotate_dev *dev, u32 reg)
    {
    return readl(dev.base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn rotate_write(dev: *mut rotate_dev, reg: u32, value: u32) {
    static inline void rotate_write(struct rotate_dev *dev, u32 reg, u32 value)
    {
    writel(value, dev.base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn rotate_set_bits(dev: *mut rotate_dev, reg: u32, bits: u32) {
...
#[no_mangle]
unsafe extern "C" fn rotate_device_run(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rotate_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rotate_prepare_format(pix_fmt: *mut v4l2_pix_format) {
...
#[no_mangle]
unsafe extern "C" fn rotate_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rotate_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn rotate_queue_cleanup(vq: *mut vb2_queue, state: u32) {
...
#[no_mangle]
unsafe extern "C" fn rotate_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rotate_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn rotate_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rotate_setup_ctrls(ctx: *mut rotate_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rotate_open(file: *mut file) -> c_int {
    static int rotate_open(struct file *file)
    {
    struct rotate_dev *dev = video_drvdata(file);
    struct rotate_ctx *ctx = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rotate_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rotate_probe(pdev: *mut platform_device) -> c_int {
    ...
    dev.rstc = devm_reset_control_get(dev.dev, core::ptr::null_mut());
    if (IS_ERR(dev.rstc)) {
...
#[no_mangle]
unsafe extern "C" fn rotate_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rotate_runtime_resume(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rotate_runtime_suspend(device: *mut device) -> c_int {
