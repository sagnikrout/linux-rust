...
//! Source: drivers/media/platform/nxp/imx7-media-csi.c
#![no_std]
...
pub const IMX7_CSI_PAD_SINK: c_int = 0;
pub const IMX7_CSI_PAD_SRC: c_int = 1;
pub const IMX7_CSI_PADS_NUM: c_int = 2;
// csi control reg 1
...
pub const CSI_MCLK_VF: c_int = 1;
pub const CSI_MCLK_ENC: c_int = 2;
pub const CSI_MCLK_RAW: c_int = 4;
pub const CSI_MCLK_I2C: c_int = 8;
pub const CSI_CSICR1: c_uint = 0x00;
pub const CSI_CSICR2: c_uint = 0x04;
pub const CSI_CSICR3: c_uint = 0x08;
pub const CSI_STATFIFO: c_uint = 0x0c;
pub const CSI_CSIRXFIFO: c_uint = 0x10;
pub const CSI_CSIRXCNT: c_uint = 0x14;
pub const CSI_CSISR: c_uint = 0x18;
pub const CSI_CSIDBG: c_uint = 0x1c;
pub const CSI_CSIDMASA_STATFIFO: c_uint = 0x20;
pub const CSI_CSIDMATS_STATFIFO: c_uint = 0x24;
pub const CSI_CSIDMASA_FB1: c_uint = 0x28;
pub const CSI_CSIDMASA_FB2: c_uint = 0x2c;
pub const CSI_CSIFBUF_PARA: c_uint = 0x30;
pub const CSI_CSIIMAG_PARA: c_uint = 0x34;
pub const CSI_CSICR18: c_uint = 0x48;
pub const CSI_CSICR19: c_uint = 0x4c;

// In bytes, per queue

pub const IMX7_CSI_VIDEO_EOF_TIMEOUT: c_int = 2000;

pub const IMX7_CSI_DEF_PIX_WIDTH: c_int = 640;
pub const IMX7_CSI_DEF_PIX_HEIGHT: c_int = 480;
    enum imx_csi_model {
    IMX7_CSI_IMX7 = 0,
    IMX7_CSI_IMX8MQ,
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx7_csi_vb2_buffer {
...
// Resources and locks
    ...
    pub irq: c_int,
    pub mclk: *mut clk,
    pub /: *mut *mut spinlock_t irqlock; / Protects last_eof,
...
// V4L2 subdev
    pub sd: v4l2_subdev,
    pub pad: [media_pad; IMX7_CSI_PADS_NUM],
// Video device
    pub /: *mut *mut *mut video_device vdev; / Video device,
    pub /: *mut *mut media_pad vdev_pad; / Video device pad,
    pub /: *mut *mut v4l2_pix_format vdev_fmt; / The user format,
    pub vdev_cc: *const imx7_csi_pixfmt,
    pub /: *mut *mut v4l2_rect vdev_compose; / The compose rectangle,
    pub /: *mut *mut mutex vdev_mutex; / Protect vdev operations,
    pub /: *mut *mut vb2_queue q; / The videobuf2 queue,
    pub /: *mut *mut list_head ready_q; / List of queued buffers,
    pub /: *mut *mut spinlock_t q_lock; / Protect ready_q,
// Buffers and streaming state
    pub active_vb2_buf: [*mut imx7_csi_vb2_buffer; 2],
    pub underrun_buf: imx7_csi_dma_buf,
    pub is_streaming: bool,
    pub buf_num: c_int,
    pub frame_sequence: u32,
    pub last_eof: bool,
    pub last_eof_completion: completion,
    pub model: enum imx_csi_model,
}
...
//
#[no_mangle]
unsafe extern "C" fn imx7_csi_reg_read(csi: *mut imx7_csi, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_irq_clear(csi: *mut imx7_csi) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_init_default(csi: *mut imx7_csi) {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_hw_enable_irq(csi: *mut imx7_csi) {
    static void imx7_csi_hw_enable_irq(struct imx7_csi *csi)
    {
    let mut cr1: u32 = imx7_csi_reg_read(csi, CSI_CSICR1);
    cr1 |= BIT_RFF_OR_INT;
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_hw_disable_irq(csi: *mut imx7_csi) {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_hw_enable(csi: *mut imx7_csi) {
    static void imx7_csi_hw_enable(struct imx7_csi *csi)
    {
    let mut cr: u32 = imx7_csi_reg_read(csi, CSI_CSICR18);
    cr |= BIT_CSI_HW_ENABLE;
    imx7_csi_reg_write(csi, cr, CSI_CSICR18);
    }
#[no_mangle]
unsafe extern "C" fn imx7_csi_hw_disable(csi: *mut imx7_csi) {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_dma_reflash(csi: *mut imx7_csi) {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_rx_fifo_clear(csi: *mut imx7_csi) {
    static void imx7_csi_rx_fifo_clear(struct imx7_csi *csi)
    {
    let mut cr1: u32 = imx7_csi_reg_read(csi, CSI_CSICR1) & ~BIT_FCC;
    imx7_csi_reg_write(csi, cr1, CSI_CSICR1);
    imx7_csi_reg_write(csi, cr1 | BIT_CLR_RXFIFO, CSI_CSICR1);
    imx7_csi_reg_write(csi, cr1 | BIT_FCC, CSI_CSICR1);
    }
#[no_mangle]
unsafe extern "C" fn imx7_csi_dmareq_rff_enable(csi: *mut imx7_csi) {
    static void imx7_csi_dmareq_rff_enable(struct imx7_csi *csi)
    {
    let mut cr3: u32 = imx7_csi_reg_read(csi, CSI_CSICR3);
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_dmareq_rff_disable(csi: *mut imx7_csi) {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_setup_vb2_buf(csi: *mut imx7_csi) {
    ...
    csi.active_vb2_buf[i] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_dma_setup(csi: *mut imx7_csi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_dma_stop(csi: *mut imx7_csi) {
...
//
    ...
    let mut width: c_int = out_pix.width;
    let mut stride: u32 = 0;
    let mut cr3: u32 = BIT_FRMCNT_RST;
    u32 cr1, cr18;
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_baseaddr_switch_on_second_frame(csi: *mut imx7_csi) {
    static void imx7_csi_baseaddr_switch_on_second_frame(struct imx7_csi *csi)
    {
    let mut cr18: u32 = imx7_csi_reg_read(csi, CSI_CSICR18);
    cr18 |= BIT_BASEADDR_SWITCH_EN | BIT_BASEADDR_SWITCH_SEL |
    BIT_BASEADDR_CHG_ERR_EN;
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_enable(csi: *mut imx7_csi) {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_disable(csi: *mut imx7_csi) {
...
//
#[no_mangle]
unsafe extern "C" fn imx7_csi_error_recovery(csi: *mut imx7_csi) {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_vb2_buf_done(csi: *mut imx7_csi) {
...
// get next queued buffer
    ...
    dma_addr = csi.underrun_buf.dma_addr;
    csi.active_vb2_buf[csi.buf_num] = core::ptr::null_mut();
    }
    imx7_csi_update_buf(csi, dma_addr, csi.buf_num);
    }
#[no_mangle]
unsafe extern "C" fn imx7_csi_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn imx7_csi_enum_mbus_formats(code: *mut u32, index: u32) -> c_int {
...
//
    ...
    struct v4l2_format *f)
    {
    __imx7_csi_video_try_fmt(&f.fmt.pix, core::ptr::null_mut());
    return 0;
    }
...
//
    ...
    let mut q_num_bufs: c_uint = vb2_get_num_buffers(vq);
    struct v4l2_pix_format *pix = &csi.vdev_fmt;
    let mut count: c_uint = *nbuffers;
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_video_buf_init(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_video_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_video_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_video_validate_fmt(csi: *mut imx7_csi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_video_stop_streaming(vq: *mut vb2_queue) {
...
//
#[no_mangle]
unsafe extern "C" fn imx7_csi_video_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_video_release(file: *mut file) -> c_int {
...
//
    static struct imx7_csi_vb2_buffer *imx7_csi_video_next_buf(struct imx7_csi *csi)
    {
    struct imx7_csi_vb2_buffer *buf = core::ptr::null_mut();
    unsigned long flags;
    spin_lock_irqsave(&csi.q_lock, flags);
// get next queued buffer
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_video_init_format(csi: *mut imx7_csi) {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_video_register(csi: *mut imx7_csi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_video_unregister(csi: *mut imx7_csi) {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_video_init(csi: *mut imx7_csi) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imx7_csi_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imx7_csi_try_colorimetry(tryfmt: *mut v4l2_mbus_framefmt) {
    static void imx7_csi_try_colorimetry(struct v4l2_mbus_framefmt *tryfmt)
    {
    const struct imx7_csi_pixfmt *cc;
    let mut is_rgb: bool = false;
...
// outfmt = format.format;
    ...
    {
    struct imx7_csi *csi = v4l2_get_subdevdata(sd);
    struct media_pad *pad = core::ptr::null_mut();
    unsigned int i;
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_registered(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_unregistered(sd: *mut v4l2_subdev) {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_notify_complete(notifier: *mut v4l2_async_notifier) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_async_register(csi: *mut imx7_csi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_media_cleanup(csi: *mut imx7_csi) {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_media_dev_init(csi: *mut imx7_csi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_media_init(csi: *mut imx7_csi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7_csi_remove(pdev: *mut platform_device) {
