...
//! Source: drivers/media/platform/nxp/imx8mq-mipi-csi2.c
#![no_std]
...
pub const MIPI_CSI2_PAD_SINK: c_int = 0;
pub const MIPI_CSI2_PAD_SOURCE: c_int = 1;
pub const MIPI_CSI2_PADS_NUM: c_int = 2;
pub const MIPI_CSI2_DEF_PIX_WIDTH: c_int = 640;
pub const MIPI_CSI2_DEF_PIX_HEIGHT: c_int = 480;
// Register map definition
// i.MX8MQ CSI-2 controller CSR
pub const CSI2RX_CFG_NUM_LANES: c_uint = 0x100;
pub const CSI2RX_CFG_DISABLE_DATA_LANES: c_uint = 0x104;
pub const CSI2RX_BIT_ERR: c_uint = 0x108;
pub const CSI2RX_IRQ_STATUS: c_uint = 0x10c;
pub const CSI2RX_IRQ_MASK: c_uint = 0x110;
pub const CSI2RX_IRQ_MASK_ALL: c_uint = 0x1ff;
pub const CSI2RX_IRQ_MASK_ULPS_STATUS_CHANGE: c_uint = 0x8;
pub const CSI2RX_ULPS_STATUS: c_uint = 0x114;
pub const CSI2RX_PPI_ERRSOT_HS: c_uint = 0x118;
pub const CSI2RX_PPI_ERRSOTSYNC_HS: c_uint = 0x11c;
pub const CSI2RX_PPI_ERRESC: c_uint = 0x120;
pub const CSI2RX_PPI_ERRSYNCESC: c_uint = 0x124;
pub const CSI2RX_PPI_ERRCONTROL: c_uint = 0x128;
pub const CSI2RX_CFG_DISABLE_PAYLOAD_0: c_uint = 0x12c;
pub const CSI2RX_CFG_VID_VC_IGNORE: c_uint = 0x180;
pub const CSI2RX_CFG_VID_VC: c_uint = 0x184;
pub const CSI2RX_CFG_VID_P_FIFO_SEND_LEVEL: c_uint = 0x188;
pub const CSI2RX_CFG_DISABLE_PAYLOAD_1: c_uint = 0x130;
    struct csi_state;
    enum {
    ST_POWERED	= 1,
    ST_STREAMING	= 2,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx8mq_plat_data {
    pub hs_settle): *mut *mut *mut int (enable)(struct csi_state state, u32,
    pub state): *mut *mut void (disable)(struct csi_state,
    pub use_reg_csr: bool,
}
...
//
pub const CSI2RX_SEND_LEVEL: c_int = 64;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct csi_state {
    pub dev: *mut device,
    pub pdata: *const imx8mq_plat_data,
    ...
    pub sd: v4l2_subdev,
    pub pads: [media_pad; MIPI_CSI2_PADS_NUM],
    pub notifier: v4l2_async_notifier,
    pub src_sd: *mut v4l2_subdev,
    pub bus: v4l2_mbus_config_mipi_csi2,
    pub /: *mut *mut mutex lock; / Protect state,
    pub state: u32,
    pub phy_gpr: *mut regmap,
    pub phy_gpr_reg: u8,
...
#[no_mangle]
unsafe extern "C" fn imx8mq_gpr_enable(state: *mut csi_state, hs_settle: u32) -> c_int {
...
// i.MX8QXP
//
pub const CSI2SS_PL_CLK_INTERVAL_US: c_int = 100;
pub const CSI2SS_PL_CLK_TIMEOUT_US: c_int = 100000;
pub const CSI2SS_PLM_CTRL: c_uint = 0x0;

pub const CSI2SS_PHY_CTRL: c_uint = 0x4;

pub const CSI2SS_DATA_TYPE_DISABLE_BF: c_uint = 0x38;

pub const CSI2SS_CTRL_CLK_RESET: c_uint = 0x44;

#[no_mangle]
unsafe extern "C" fn imx8qxp_gpr_enable(state: *mut csi_state, hs_settle: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_gpr_disable(state: *mut csi_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn imx8mq_mipi_csi_write(state: *mut csi_state, reg: u32, val: u32) {
    static inline void imx8mq_mipi_csi_write(struct csi_state *state, u32 reg, u32 val)
    {
    writel(val, state.regs + reg);
    }
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_sw_reset(state: *mut csi_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_set_params(state: *mut csi_state) {
    static void imx8mq_mipi_csi_set_params(struct csi_state *state)
    {
    let mut lanes: c_int = state.bus.num_data_lanes;
...
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_stop_stream(state: *mut csi_state) {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_async_register(state: *mut csi_state) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_pm_suspend(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_runtime_resume(dev: *mut device) -> c_int {
    ...
    imx8mq_mipi_csi_runtime_resume, core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_subdev_init(state: *mut csi_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_release_icc(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_init_icc(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_parse_dt(state: *mut csi_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_mipi_csi_remove(pdev: *mut platform_device) {
