...
//! Source: drivers/media/platform/nxp/imx-mipi-csis.c
#![no_std]
...
pub const MIPI_CSIS_DEF_PIX_WIDTH: c_int = 640;
pub const MIPI_CSIS_DEF_PIX_HEIGHT: c_int = 480;
// Register map definition
// CSIS version
pub const MIPI_CSIS_VERSION: c_uint = 0x00;
pub const MIPI_CSIS_VERSION_IMX7D: c_uint = 0x03030505;
pub const MIPI_CSIS_VERSION_IMX8MP: c_uint = 0x03060301;
// CSIS common control
pub const MIPI_CSIS_CMN_CTRL: c_uint = 0x04;

// CSIS clock control
pub const MIPI_CSIS_CLK_CTRL: c_uint = 0x08;

// CSIS Interrupt mask
pub const MIPI_CSIS_INT_MSK: c_uint = 0x10;

// CSIS Interrupt source
pub const MIPI_CSIS_INT_SRC: c_uint = 0x14;

pub const MIPI_CSIS_INT_SRC_ERRORS: c_uint = 0xfffff;
// D-PHY status control
pub const MIPI_CSIS_DPHY_STATUS: c_uint = 0x20;

// D-PHY common control
pub const MIPI_CSIS_DPHY_CMN_CTRL: c_uint = 0x24;

// D-PHY Master and Slave Control register Low
pub const MIPI_CSIS_DPHY_BCTRL_L: c_uint = 0x30;

// D-PHY Master and Slave Control register High
pub const MIPI_CSIS_DPHY_BCTRL_H: c_uint = 0x34;
// D-PHY Slave Control register Low
pub const MIPI_CSIS_DPHY_SCTRL_L: c_uint = 0x38;
// D-PHY Slave Control register High
pub const MIPI_CSIS_DPHY_SCTRL_H: c_uint = 0x3c;
// ISP Configuration register

// ISP Image Resolution register

pub const CSIS_MAX_PIX_WIDTH: c_uint = 0xffff;
pub const CSIS_MAX_PIX_HEIGHT: c_uint = 0xffff;
// ISP SYNC register

// ISP shadow registers

// Debug control register
pub const MIPI_CSIS_DBG_CTRL: c_uint = 0xc0;
pub const MIPI_CSIS_DBG_INTR_MSK: c_uint = 0xc4;

pub const MIPI_CSIS_DBG_INTR_SRC: c_uint = 0xc8;

// Non-image packet data buffers
pub const MIPI_CSIS_PKTDATA_ODD: c_uint = 0x2000;
pub const MIPI_CSIS_PKTDATA_EVEN: c_uint = 0x3000;

pub const MIPI_CSIS_MAX_CHANNELS: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mipi_csis_event {
    pub debug: bool,
    pub channel: c_uint,
    pub mask: u32,
...
pub const MIPI_CSIS_NUM_ERROR_EVENTS: c_int = 38;
    enum mipi_csis_clk {
    MIPI_CSIS_CLK_PCLK,
    MIPI_CSIS_CLK_WRAP,
    MIPI_CSIS_CLK_PHY,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mipi_csis_info {
    pub version: enum mipi_csis_version,
    pub num_clocks: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mipi_csis_device {
    pub dev: *mut device,
    pub regs: *mut void __iomem,
    pub clks: *mut clk_bulk_data,
    pub mrst: *mut reset_control,
    pub mipi_phy_regulator: *mut regulator,
    pub info: *const mipi_csis_info,
    pub num_channels: c_uint,
    pub sd: v4l2_subdev,
    pub pads: [media_pad; CSIS_PADS_NUM],
    pub notifier: v4l2_async_notifier,
    struct {
    pub sd: *mut v4l2_subdev,
    pub pad: *const media_pad,
    pub source: },
    ...
    pub /: *mut *mut spinlock_t slock; / Protect events,
    pub events: [mipi_csis_event; MIPI_CSIS_NUM_EVENTS],
...
//
#[no_mangle]
pub unsafe extern "C" fn mipi_csis_read(csis: *mut mipi_csis_device, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_enable_interrupts(csis: *mut mipi_csis_device, on: bool) {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_sw_reset(csis: *mut mipi_csis_device) {
    static void mipi_csis_sw_reset(struct mipi_csis_device *csis)
    {
    let mut val: u32 = mipi_csis_read(csis, MIPI_CSIS_CMN_CTRL);
    mipi_csis_write(csis, MIPI_CSIS_CMN_CTRL,
    val | MIPI_CSIS_CMN_CTRL_SW_RESET);
    usleep_range(10, 20);
    }
#[no_mangle]
unsafe extern "C" fn mipi_csis_system_enable(csis: *mut mipi_csis_device, on: c_int) {
...
//
    ...
    const struct csis_pix_format *csis_fmt)
    {
    let mut lanes: c_int = csis.num_data_lanes;
    u32 val;
    val = mipi_csis_read(csis, MIPI_CSIS_CMN_CTRL);
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_clk_enable(csis: *mut mipi_csis_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_clk_disable(csis: *mut mipi_csis_device) {
    static void mipi_csis_clk_disable(struct mipi_csis_device *csis)
    {
    clk_bulk_disable_unprepare(csis.info.num_clocks, csis.clks);
    }
#[no_mangle]
unsafe extern "C" fn mipi_csis_clk_get(csis: *mut mipi_csis_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_stop_stream(csis: *mut mipi_csis_device) {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_queue_event_sof(csis: *mut mipi_csis_device) {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn mipi_csis_phy_enable(csis: *mut mipi_csis_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_phy_disable(csis: *mut mipi_csis_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_phy_reset(csis: *mut mipi_csis_device) {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_phy_init(csis: *mut mipi_csis_device) -> c_int {
    static int mipi_csis_phy_init(struct mipi_csis_device *csis)
    {
    if (csis.info.version != MIPI_CSIS_V3_3)
    return 0;
// Get MIPI PHY reset and regulator.
    csis.mrst = devm_reset_control_get_exclusive(csis.dev, core::ptr::null_mut());
    if (IS_ERR(csis.mrst))
...
//
#[no_mangle]
unsafe extern "C" fn mipi_csis_clear_counters(csis: *mut mipi_csis_device) {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_log_counters(csis: *mut mipi_csis_device, non_errors: bool) {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_dump_regs(csis: *mut mipi_csis_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_dump_regs_show(m: *mut seq_file, private: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_debugfs_init(csis: *mut mipi_csis_device) {
    ...
    csis.debugfs_root = debugfs_create_dir(dev_name(csis.dev), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_debugfs_exit(csis: *mut mipi_csis_device) {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_log_status(sd: *mut v4l2_subdev) -> c_int {
...
// We only care about the link to the source.
    ...
    csis.source.sd = core::ptr::null_mut();
    csis.source.pad = core::ptr::null_mut();
    }
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_async_register(csis: *mut mipi_csis_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mipi_csis_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_runtime_resume(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mipi_csis_subdev_init(csis: *mut mipi_csis_device) -> c_int {
    ...
    sd.ctrl_handler = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_parse_dt(csis: *mut mipi_csis_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipi_csis_remove(pdev: *mut platform_device) {
