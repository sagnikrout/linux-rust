...
//! Source: drivers/media/platform/nxp/imx8-isi/imx8-isi-m2m.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxc_isi_m2m_ctx_queue_data {
    pub format: v4l2_pix_format_mplane,
    pub info: *const mxc_isi_format_info,
    pub sequence: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxc_isi_m2m_ctx {
    pub fh: v4l2_fh,
    pub m2m: *mut mxc_isi_m2m,
// Protects the m2m vb2 queues
    pub vb2_lock: mutex,
    struct {
    pub out: mxc_isi_m2m_ctx_queue_data,
    pub cap: mxc_isi_m2m_ctx_queue_data,
    pub queues: },
    struct {
...
//
#[no_mangle]
unsafe extern "C" fn mxc_isi_m2m_frame_write_done(pipe: *mut mxc_isi_pipe, status: u32) {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_m2m_device_run(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_m2m_vb2_buffer_init(vb2: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_m2m_vb2_buffer_prepare(vb2: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_m2m_vb2_buffer_queue(vb2: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_m2m_vb2_prepare_streaming(q: *mut vb2_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_m2m_vb2_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_m2m_vb2_unprepare_streaming(q: *mut vb2_queue) {
...
//
    if (m2m.last_ctx == ctx)
    m2m.last_ctx = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_m2m_ctx_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_m2m_ctx_ctrls_create(ctx: *mut mxc_isi_m2m_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_m2m_ctx_ctrls_delete(ctx: *mut mxc_isi_m2m_ctx) {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_m2m_open(file: *mut file) -> c_int {
    ...
    ctx.fh.m2m_ctx = core::ptr::null_mut();
    goto err_fh;
    }
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_m2m_release(file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_m2m_suspend(m2m: *mut mxc_isi_m2m) {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_m2m_resume(m2m: *mut mxc_isi_m2m) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_m2m_register(isi: *mut mxc_isi_dev, v4l2_dev: *mut v4l2_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_m2m_unregister(isi: *mut mxc_isi_dev) -> c_int {
