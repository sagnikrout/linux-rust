...
//! Source: drivers/media/platform/nxp/imx8-isi/imx8-isi-video.c
#![no_std]
...
// JPEG
    ...
    let mut is_rgb: bool = fmt.encoding == MXC_ISI_ENC_RGB;
    pix.quantization =
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_video_free_discard_buffers(video: *mut mxc_isi_video) {
    ...
    buf.dma);
    buf.addr = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn mxc_isi_video_alloc_discard_buffers(video: *mut mxc_isi_video) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_video_validate_format(video: *mut mxc_isi_video) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_video_queue_first_buffers(video: *mut mxc_isi_video) {
...
//
    ...
    let mut size: c_uint = pix.plane_fmt[0].bytesperline * pix.height;
    for (i = 1; i < info.color_planes; ++i) {
    let mut vsub: c_uint = i > 1 ? info.vsub : 1;
    ...
    unsigned int i;
    for (i = 0; i < info.mem_planes; i++) {
    let mut size: c_ulong = pix.plane_fmt[i].sizeimage;
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_vb2_buffer_init(vb2: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_vb2_buffer_prepare(vb2: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_vb2_buffer_queue(vb2: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_video_init_channel(video: *mut mxc_isi_video) {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_vb2_prepare_streaming(q: *mut vb2_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_vb2_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_vb2_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_vb2_unprepare_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_video_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_video_ctrls_create(video: *mut mxc_isi_video) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_video_ctrls_delete(video: *mut mxc_isi_video) {
...
//
#[no_mangle]
unsafe extern "C" fn mxc_isi_video_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_video_release(file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_video_suspend(pipe: *mut mxc_isi_pipe) {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_video_resume(pipe: *mut mxc_isi_pipe) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_video_unregister(pipe: *mut mxc_isi_pipe) {
