...
//! Source: drivers/media/platform/nxp/imx8-isi/imx8-isi-pipe.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_get_vc(pipe: *mut mxc_isi_pipe) -> c_int {
    ...
    let mut source_pad: c_uint = xbar.num_sinks + pipe.id;
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_pipe_enable(pipe: *mut mxc_isi_pipe) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_pipe_disable(pipe: *mut mxc_isi_pipe) {
...
//
#[no_mangle]
unsafe extern "C" fn mxc_isi_pipe_irq_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_pipe_init(isi: *mut mxc_isi_dev, id: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_pipe_cleanup(pipe: *mut mxc_isi_pipe) {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_pipe_release(pipe: *mut mxc_isi_pipe) {
