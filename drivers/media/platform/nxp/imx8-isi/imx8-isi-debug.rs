...
//! Source: drivers/media/platform/nxp/imx8-isi/imx8-isi-debug.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_debug_dump_regs_show(m: *mut seq_file, p: *mut c_void) -> c_int {
    static int mxc_isi_debug_dump_regs_show(struct seq_file *m, void *p)
    {

#[repr(C)]
#[derive(Copy, Clone)]
pub struct debug_regs {
    pub offset: u32,
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_debug_init(isi: *mut mxc_isi_dev) {
    void mxc_isi_debug_init(struct mxc_isi_dev *isi)
    {
    unsigned int i;
    isi.debugfs_root = debugfs_create_dir(dev_name(isi.dev), core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_debug_cleanup(isi: *mut mxc_isi_dev) {
