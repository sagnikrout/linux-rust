...
//! Source: drivers/media/platform/nxp/imx8-isi/imx8-isi-crossbar.c
#![no_std]
...
//
    ...
    let mut sink_streams: u64 = 0;
    let mut sink_pad: c_int = -1;
//
...
// remote_pad = pad->index;
    ...
    {
    struct mxc_isi_crossbar *xbar = to_isi_crossbar(sd);
    let mut routing: v4l2_subdev_krouting = { };
...
//
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_crossbar_init(isi: *mut mxc_isi_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_crossbar_cleanup(xbar: *mut mxc_isi_crossbar) {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_crossbar_register(xbar: *mut mxc_isi_crossbar) -> c_int {
    int mxc_isi_crossbar_register(struct mxc_isi_crossbar *xbar)
    {
    return v4l2_device_register_subdev(&xbar.isi.v4l2_dev, &xbar.sd);
    }
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_crossbar_unregister(xbar: *mut mxc_isi_crossbar) {
