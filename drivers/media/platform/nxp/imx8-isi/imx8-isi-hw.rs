...
//! Source: drivers/media/platform/nxp/imx8-isi/imx8-isi-hw.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_read(pipe: *mut mxc_isi_pipe, reg: u32) -> u32 {
    static inline u32 mxc_isi_read(struct mxc_isi_pipe *pipe, u32 reg)
    {
    return readl(pipe.regs + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_write(pipe: *mut mxc_isi_pipe, reg: u32, val: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_channel_set_inbuf(pipe: *mut mxc_isi_pipe, dma_addr: dma_addr_t) {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_channel_m2m_start(pipe: *mut mxc_isi_pipe) {
...
//
    ...
    u32 *dec)
    {
    let mut ratio: c_uint = from / to;
    if (ratio < 2)
// dec = 1;
#[no_mangle]
pub unsafe extern "C" fn if(4: ratio <) -> else {
    else if (ratio < 4)
// dec = 2;
#[no_mangle]
pub unsafe extern "C" fn if(8: ratio <) -> else {
    else if (ratio < 8)
// dec = 4;
    else
// dec = 8;
...
// RGB->YUV
    ...
    const u32 *coeffs = core::ptr::null_mut();
    u32 val;
    val = mxc_isi_read(pipe, CHNL_IMG_CTRL);
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_channel_set_alpha(pipe: *mut mxc_isi_pipe, alpha: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_channel_set_flip(pipe: *mut mxc_isi_pipe, hflip: bool, vflip: bool) {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_channel_set_panic_threshold(pipe: *mut mxc_isi_pipe) {
...
// Channel control
    ...
    {
    let mut bpl: c_uint = format.plane_fmt[0].bytesperline;
...
//
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_channel_irq_status(pipe: *mut mxc_isi_pipe, clear: bool) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_channel_irq_clear(pipe: *mut mxc_isi_pipe) {
    void mxc_isi_channel_irq_clear(struct mxc_isi_pipe *pipe)
    {
    mxc_isi_write(pipe, CHNL_STS, 0xffffffff);
    }
#[no_mangle]
unsafe extern "C" fn mxc_isi_channel_irq_enable(pipe: *mut mxc_isi_pipe) {
...
#[no_mangle]
unsafe extern "C" fn mxc_isi_channel_irq_disable(pipe: *mut mxc_isi_pipe) {
...
//
#[no_mangle]
unsafe extern "C" fn mxc_isi_channel_sw_reset(pipe: *mut mxc_isi_pipe, enable_clk: bool) {
...
#[no_mangle]
unsafe extern "C" fn __mxc_isi_channel_get(pipe: *mut mxc_isi_pipe) {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_channel_get(pipe: *mut mxc_isi_pipe) {
...
#[no_mangle]
unsafe extern "C" fn __mxc_isi_channel_put(pipe: *mut mxc_isi_pipe) {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_channel_put(pipe: *mut mxc_isi_pipe) {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_channel_enable(pipe: *mut mxc_isi_pipe) {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_channel_disable(pipe: *mut mxc_isi_pipe) {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_channel_release(pipe: *mut mxc_isi_pipe) {
    void mxc_isi_channel_release(struct mxc_isi_pipe *pipe)
    {
    mutex_lock(&pipe.lock);
    pipe.irq_handler = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_channel_chain(pipe: *mut mxc_isi_pipe) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mxc_isi_channel_unchain(pipe: *mut mxc_isi_pipe) {
