...
//! Source: drivers/media/platform/nxp/dw100/dw100.c
#![no_std]
...
pub const DW100_ALIGN_W: c_int = 3;
pub const DW100_ALIGN_H: c_int = 3;
pub const DW100_BLOCK_SIZE: c_int = 16;
...
// in use.
//
pub const DW100_MAX_CTRLS: c_int = 1;
pub const DW100_CTRL_DEWARPING_MAP: c_int = 0;
    enum {
    DW100_QUEUE_SRC = 0,
    DW100_QUEUE_DST = 1,
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw100_q_data {
    pub pix_fmt: v4l2_pix_format_mplane,
    pub sequence: c_uint,
    pub fmt: *const dw100_fmt,
    pub crop: v4l2_rect,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw100_ctx {
    pub fh: v4l2_fh,
    pub dw_dev: *mut dw100_device,
    pub hdl: v4l2_ctrl_handler,
    pub ctrls: [*mut v4l2_ctrl; DW100_MAX_CTRLS],
...
// Look Up Table for pixel remapping
    ...
    pub map_size: usize,
    pub map_width: c_uint,
    pub map_height: c_uint,
    pub user_map_is_set: bool,
    pub user_map_is_dirty: bool,
// Source and destination queue data
    pub q_data: [dw100_q_data; 2],
}
...
#[no_mangle]
pub unsafe extern "C" fn to_dw100_fmt_type(type: enum v4l2_buf_type) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dw100_read(dw_dev: *mut dw100_device, reg: u32) -> u32 {
    static inline u32 dw100_read(struct dw100_device *dw_dev, u32 reg)
    {
    return readl(dw_dev.mmio + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn dw100_write(dw_dev: *mut dw100_device, reg: u32, val: u32) {
    static inline void dw100_write(struct dw100_device *dw_dev, u32 reg, u32 val)
    {
    writel(val, dw_dev.mmio + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn dw100_dump_regs(m: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw100_get_n_vertices_from_length(length: u32) -> u32 {
    static u32 dw100_get_n_vertices_from_length(u32 length)
    {
    return DIV_ROUND_UP(length, DW100_BLOCK_SIZE) + 1;
    }
#[no_mangle]
unsafe extern "C" fn dw100_map_convert_to_uq12_4(a: u32) -> u16 {
    static u16 dw100_map_convert_to_uq12_4(u32 a)
    {
    return (u16)((a & 0xfff) << 4);
    }
#[no_mangle]
unsafe extern "C" fn dw100_map_format_coordinates(xq: u16, yq: u16) -> u32 {
    static u32 dw100_map_format_coordinates(u16 xq, u16 yq)
    {
    return (u32)((yq << 16) | xq);
    }
#[no_mangle]
unsafe extern "C" fn dw100_update_mapping(ctx: *mut dw100_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn dw100_create_mapping(ctx: *mut dw100_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw100_destroy_mapping(ctx: *mut dw100_ctx) {
    static void dw100_destroy_mapping(struct dw100_ctx *ctx)
    {
    if (ctx.map) {
    dma_free_coherent(&ctx.dw_dev.pdev.dev, ctx.map_size,
    ctx.map, ctx.map_dma);
    ctx.map = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn dw100_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw100_buf_out_validate(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw100_buf_prepare(vb: *mut vb2_buffer) -> c_int {
    ...
    let mut size: c_ulong = pix_fmt.plane_fmt[i].sizeimage;
...
#[no_mangle]
unsafe extern "C" fn dw100_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn dw100_buf_request_complete(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn dw100_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw100_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn dw100_open(file: *mut file) -> c_int {
    ...
    ctx.ctrls[i] = v4l2_ctrl_new_custom(hdl, &controls[i], core::ptr::null_mut());
    if (hdl.error) {
...
#[no_mangle]
unsafe extern "C" fn dw100_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw100_g_fmt_vid(file: *mut file, priv: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw100_try_fmt(file: *mut file, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw100_s_fmt(ctx: *mut dw100_ctx, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw100_job_finish(dw_dev: *mut dw100_device, with_error: bool) {
...
#[no_mangle]
unsafe extern "C" fn dw100_hw_reset(dw_dev: *mut dw100_device) {
...
#[no_mangle]
unsafe extern "C" fn dw100_hw_init_ctrl(dw_dev: *mut dw100_device) {
...
#[no_mangle]
unsafe extern "C" fn dw100_hw_set_pixel_boundary(dw_dev: *mut dw100_device) {
...
#[no_mangle]
unsafe extern "C" fn dw100_hw_set_scale(dw_dev: *mut dw100_device, scale: u8) {
...
#[no_mangle]
unsafe extern "C" fn dw100_hw_set_roi(dw_dev: *mut dw100_device, x: u32, y: u32) {
...
// HW Scale is UQ1.7 encoded
    ...
    let mut addr_y: dma_addr_t = vb2_dma_contig_plane_dma_addr(buffer, 0);
    dma_addr_t addr_uv;
...
#[no_mangle]
unsafe extern "C" fn dw100_hw_clear_irq(dw_dev: *mut dw100_device, irq: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn dw100_hw_enable_irq(dw_dev: *mut dw100_device) {
...
#[no_mangle]
unsafe extern "C" fn dw100_hw_disable_irq(dw_dev: *mut dw100_device) {
    static void dw100_hw_disable_irq(struct dw100_device *dw_dev)
    {
    dw100_write(dw_dev, DW100_INTERRUPT_STATUS, 0);
    }
#[no_mangle]
unsafe extern "C" fn dw_hw_get_pending_irqs(dw_dev: *mut dw100_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn dw100_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dw100_irq_thread_fn(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dw100_device_run(priv: *mut c_void) {
    ...
    dw100_update_mapping(ctx);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ctx->user_map_is_dirty) -> else {
...
#[no_mangle]
unsafe extern "C" fn dw100_dump_regs_show(m: *mut seq_file, private: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw100_debugfs_init(dw_dev: *mut dw100_device) {
    static void dw100_debugfs_init(struct dw100_device *dw_dev)
    {
    dw_dev.debugfs_root =
    debugfs_create_dir(dev_name(&dw_dev.pdev.dev), core::ptr::null_mut());
    debugfs_create_file("dump_regs", 0600, dw_dev.debugfs_root, dw_dev,
    &dw100_dump_regs_fops);
    }
#[no_mangle]
unsafe extern "C" fn dw100_debugfs_exit(dw_dev: *mut dw100_device) {
    static void dw100_debugfs_exit(struct dw100_device *dw_dev)
    {
    debugfs_remove_recursive(dw_dev.debugfs_root);
    }
#[no_mangle]
unsafe extern "C" fn dw100_probe(pdev: *mut platform_device) -> c_int {
    ...
    dw_dev.num_clks = ret;
    dw_dev.mmio = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dw100_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dw100_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn dw100_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    dw100_runtime_resume, core::ptr::null_mut())
    };
    static const struct of_device_id dw100_dt_ids[] = {
    { .compatible = "nxp,imx8mp-dw100", .data = core::ptr::null_mut() },
    { },
    };
