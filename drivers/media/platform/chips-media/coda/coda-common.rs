...
//! Source: drivers/media/platform/chips-media/coda/coda-common.c
#![no_std]
...
pub const CODADX6_MAX_INSTANCES: c_int = 4;
pub const CODA_MAX_FORMATS: c_int = 5;

pub const MIN_W: c_int = 48;
pub const MIN_H: c_int = 16;
...
#[no_mangle]
pub unsafe extern "C" fn coda_read(dev: *mut coda_dev, reg: u32) -> c_uint {
    ...
    {
    let mut base_y: u32 = vb2_dma_contig_plane_dma_addr(&buf.vb2_buf, 0);
    u32 base_cb, base_cr;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct coda_video_device {
    pub name: *const c_char,
    pub type: enum coda_inst_type,
    pub ops: *const coda_context_ops,
    pub direct: bool,
    pub src_formats: [u32; CODA_MAX_FORMATS],
    pub dst_formats: [u32; CODA_MAX_FORMATS],
}
...
//
#[no_mangle]
unsafe extern "C" fn coda_format_normalize_yuv(fourcc: u32) -> u32 {
    ...
    let mut num_codecs: c_int = dev.devtype.num_codecs;
    int k;
...
// vdev)
    ...
    struct vdoa_data *vdoa_data = core::ptr::null_mut();
    vdoa_node = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,imx6q-vdoa");
    if (!vdoa_node)
    return core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_BUF_TYPE_VIDEO_CAPTURE: f->type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn coda_try_pixelformat(ctx: *mut coda_ctx, f: *mut v4l2_format) -> c_int {
...
// use_vdoa = false;
    ...
    err = vdoa_context_configure(core::ptr::null_mut(), round_up(f.fmt.pix.width, 16),
...
// keep 16 pixel alignment of 8-bit pixel data
    ...
    const struct coda_codec *codec;
    struct vb2_queue *src_vq;
    let mut hscale: c_int = 0;
    let mut vscale: c_int = 0;
    int ret;
    bool use_vdoa;
...
#[no_mangle]
unsafe extern "C" fn coda_set_default_colorspace(fmt: *mut v4l2_pix_format) {
...
#[no_mangle]
pub unsafe extern "C" fn if(576: fmt->width <= 720 && fmt->height <=) -> else {
...
// Setting the coded format determines the selected codec
    ...
    if (ret)
    return ret;
    ret = coda_s_fmt(ctx, f, core::ptr::null_mut());
    if (ret)
    return ret;
    ctx.colorspace = f.fmt.pix.colorspace;
    ctx.xfer_func = f.fmt.pix.xfer_func;
...
#[no_mangle]
unsafe extern "C" fn coda_dqbuf(file: *mut file, priv: *mut c_void, buf: *mut v4l2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_wake_up_capture_queue(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda_mark_last_meta(ctx: *mut coda_ctx) -> bool {
...
#[no_mangle]
unsafe extern "C" fn coda_mark_last_dst_buf(ctx: *mut coda_ctx) -> bool {
    ...
    ctx.bit_stream_param &= ~CODA_BIT_STREAM_END_FLAG;
    coda_fill_bitstream(ctx, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn coda_g_parm(file: *mut file, fh: *mut c_void, a: *mut v4l2_streamparm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn coda_approximate_timeperframe(timeperframe: *mut v4l2_fract) {
    static void coda_approximate_timeperframe(struct v4l2_fract *timeperframe)
    {
    let mut s: v4l2_fract = *timeperframe;
    struct v4l2_fract f0;
    let mut f1: v4l2_fract = { 1, 0 };
    let mut f2: v4l2_fract = { 0, 1 };
...
#[no_mangle]
unsafe extern "C" fn coda_timeperframe_to_frate(timeperframe: *mut v4l2_fract) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn coda_s_parm(file: *mut file, fh: *mut c_void, a: *mut v4l2_streamparm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn coda_device_run(m2m_priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn coda_pic_run_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn coda_job_ready(m2m_priv: *mut c_void) -> c_int {
    static int coda_job_ready(void *m2m_priv)
    {
    struct coda_ctx *ctx = m2m_priv;
    let mut src_bufs: c_int = v4l2_m2m_num_src_bufs_ready(ctx.fh.m2m_ctx);
//
...
//
    ...
    let mut num_metas: c_int = ctx.num_metas;
    struct coda_buffer_meta *meta;
    unsigned int count;
...
#[no_mangle]
unsafe extern "C" fn coda_job_abort(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn set_default_params(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_update_menu_ctrl(ctrl: *mut v4l2_ctrl, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn coda_queue_source_change_event(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda_buf_queue(vb: *mut vb2_buffer) {
...
//
    ...
    buf.dentry = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn coda_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn coda_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_encode_ctrls(ctx: *mut coda_ctx) {
    static void coda_encode_ctrls(struct coda_ctx *ctx)
    {
    let mut max_gop_size: c_int = (ctx.dev.devtype.product == CODA_DX6) ? 60 : 99;
...
#[no_mangle]
unsafe extern "C" fn coda_jpeg_encode_ctrls(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda_decode_ctrls(ctx: *mut coda_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn if(CODA_960: ctx->dev->devtype->product ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn coda_ctrls_setup(ctx: *mut coda_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_queue_init(ctx: *mut coda_ctx, vq: *mut vb2_queue) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn coda_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_hw_init(dev: *mut coda_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_register_device(dev: *mut coda_dev, i: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_firmware_request(dev: *mut coda_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_fw_callback(fw: *const firmware, context: *mut c_void) {
    static void coda_fw_callback(const struct firmware *fw, void *context)
    {
...
#[no_mangle]
unsafe extern "C" fn coda_probe(pdev: *mut platform_device) -> c_int {
...
// Get vdoa_data if supported by the platform
    ...
    ida_init(&dev.ida);
    dev.debugfs_root = debugfs_create_dir("coda", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn coda_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn coda_runtime_resume(dev: *mut device) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(core::ptr::null_mut(), coda_runtime_resume, core::ptr::null_mut())
