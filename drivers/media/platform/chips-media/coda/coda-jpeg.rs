...
//! Source: drivers/media/platform/chips-media/coda/coda-jpeg.c
#![no_std]
...
pub const SOI_MARKER: c_uint = 0xffd8;
pub const APP9_MARKER: c_uint = 0xffe9;
pub const DRI_MARKER: c_uint = 0xffdd;
pub const DQT_MARKER: c_uint = 0xffdb;
pub const DHT_MARKER: c_uint = 0xffc4;
pub const SOF_MARKER: c_uint = 0xffc0;
pub const SOS_MARKER: c_uint = 0xffda;
pub const EOI_MARKER: c_uint = 0xffd9;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct coda_huff_tab {
    pub 12]: u8 luma_dc[16 +,
    pub 12]: u8 chroma_dc[16 +,
    pub 162]: u8 luma_ac[16 +,
    pub 162]: u8 chroma_ac[16 +,
// DC Luma, DC Chroma, AC Luma, AC Chroma
    pub 16]: *mut *mut s16 min[4,
    pub 16]: *mut *mut s16 max[4,
    pub 16]: *mut *mut s8 ptr[4,
}
...
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_chroma_format(pixfmt: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coda_jpeg_write_tables(ctx: *mut coda_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coda_jpeg_check_buffer(ctx: *mut coda_ctx, vb: *mut vb2_buffer) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn coda_jpeg_decode_header(ctx: *mut coda_ctx, vb: *mut vb2_buffer) -> c_int {
    int coda_jpeg_decode_header(struct coda_ctx *ctx, struct vb2_buffer *vb)
    {
    struct coda_dev *dev = ctx.dev;
    u8 *buf = vb2_plane_vaddr(vb, 0);
    let mut len: usize = vb2_get_plane_payload(vb, 0);
...
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_dec_huff_setup(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_qmat_setup(ctx: *mut coda_ctx) {
...
pub const DC_TABLE_INDEX0: c_int = 0;
pub const AC_TABLE_INDEX0: c_int = 1;
pub const DC_TABLE_INDEX1: c_int = 2;
pub const AC_TABLE_INDEX1: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_gen_dec_huff_tab(ctx: *mut coda_ctx, tab_num: c_int) -> c_int {
    static int coda9_jpeg_gen_dec_huff_tab(struct coda_ctx *ctx, int tab_num)
    {
    let mut ptr_cnt: c_int = 0, huff_code = 0, zero_flag = 0, data_flag = 0;
    u8 *huff_bits;
    s16 *huff_max;
    s16 *huff_min;
    s8 *huff_ptr;
...
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_load_huff_tab(ctx: *mut coda_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_write_huff_tab(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_load_qmat_tab(ctx: *mut coda_ctx) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct coda_jpeg_stream {
    pub curr: *mut u8,
    pub end: *mut u8,
}

#[no_mangle]
pub unsafe extern "C" fn coda_jpeg_put_byte(byte: u8, stream: *mut coda_jpeg_stream) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coda_jpeg_put_word(word: u16, stream: *mut coda_jpeg_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_encode_header(ctx: *mut coda_ctx, len: c_int, buf: *mut u8) -> c_int {
    static int coda9_jpeg_encode_header(struct coda_ctx *ctx, int len, u8 *buf)
    {
    let mut stream: coda_jpeg_stream = { buf, buf + len };
    struct coda_q_data *q_data_src;
...
//
#[no_mangle]
unsafe extern "C" fn coda_scale_quant_table(q_tab: *mut u8, scale: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn coda_set_jpeg_compression_quality(ctx: *mut coda_ctx, quality: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_start_encoding(ctx: *mut coda_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_prepare_encode(ctx: *mut coda_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(CODA9_JPEG_FORMAT_224: chroma_format ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_finish_encode(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_encode_timeout(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_release(ctx: *mut coda_ctx) {
    static void coda9_jpeg_release(struct coda_ctx *ctx)
    {
    int i;
    if (ctx.params.jpeg_qmat_tab[0] == luma_q)
    ctx.params.jpeg_qmat_tab[0] = core::ptr::null_mut();
    if (ctx.params.jpeg_qmat_tab[1] == chroma_q)
    ctx.params.jpeg_qmat_tab[1] = core::ptr::null_mut();
    for (i = 0; i < 3; i++)
...
//
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_start_decoding(ctx: *mut coda_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_prepare_decode(ctx: *mut coda_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda9_jpeg_finish_decode(ctx: *mut coda_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn coda9_jpeg_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
