...
//! Source: drivers/media/platform/chips-media/coda/coda-h264.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn coda_sps_parse_profile(ctx: *mut coda_ctx, vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coda_h264_filler_nal(size: c_int, p: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coda_h264_padding(size: c_int, p: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coda_h264_profile(profile_idc: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coda_h264_level(level_idc: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rbsp_read_bit(rbsp: *mut rbsp) -> c_int {
    static inline int rbsp_read_bit(struct rbsp *rbsp)
    {
    let mut shift: c_int = 7 - (rbsp.pos % 8);
    let mut ofs: c_int = rbsp.pos++ / 8;
    if (ofs >= rbsp.size)
    return -EINVAL;
    return (rbsp.buf[ofs] >> shift) & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn rbsp_write_bit(rbsp: *mut rbsp, bit: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rbsp_read_bits(rbsp: *mut rbsp, num: c_int, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rbsp_write_bits(rbsp: *mut rbsp, num: c_int, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rbsp_read_uev(rbsp: *mut rbsp, val: *mut c_uint) -> c_int {
    static int rbsp_read_uev(struct rbsp *rbsp, unsigned int *val)
    {
    let mut leading_zero_bits: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn rbsp_write_uev(rbsp: *mut rbsp, value: c_uint) -> c_int {
    static int rbsp_write_uev(struct rbsp *rbsp, unsigned int value)
    {
    int i;
    int ret;
    let mut tmp: c_int = value + 1;
    let mut leading_zero_bits: c_int = fls(tmp) - 1;
...
#[no_mangle]
unsafe extern "C" fn rbsp_read_sev(rbsp: *mut rbsp, val: *mut c_int) -> c_int {
...
// seq_parameter_set_id
    ret = rbsp_read_uev(&sps, core::ptr::null_mut());
    if (ret)
    return ret;
...
// offset_for_non_ref_pic
    ret = rbsp_read_sev(&sps, core::ptr::null_mut());
    if (ret)
    return ret;
