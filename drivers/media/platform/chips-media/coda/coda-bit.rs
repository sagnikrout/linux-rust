...
//! Source: drivers/media/platform/chips-media/coda/coda-bit.c
#![no_std]
...
pub const CODA7_PS_BUF_SIZE: c_uint = 0x28000;

pub const CODA_DEFAULT_GAMMA: c_int = 4096;

    static void coda_free_bitstream_buffer(struct coda_ctx *ctx);
#[no_mangle]
pub unsafe extern "C" fn coda_is_initialized(dev: *mut coda_dev) -> c_int {
    static inline int coda_is_initialized(struct coda_dev *dev)
    {
    return coda_read(dev, CODA_REG_BIT_CUR_PC) != 0;
    }
#[no_mangle]
pub unsafe extern "C" fn coda_isbusy(dev: *mut coda_dev) -> c_ulong {
    static inline unsigned long coda_isbusy(struct coda_dev *dev)
    {
    return coda_read(dev, CODA_REG_BIT_BUSY);
    }
#[no_mangle]
unsafe extern "C" fn coda_wait_timeout(dev: *mut coda_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_command_async(ctx: *mut coda_ctx, cmd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn coda_command_sync(ctx: *mut coda_ctx, cmd: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coda_hw_reset(ctx: *mut coda_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_kfifo_sync_from_device(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda_kfifo_sync_to_device_full(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda_kfifo_sync_to_device_write(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda_h264_bitstream_pad(ctx: *mut coda_ctx, size: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coda_bitstream_flush(ctx: *mut coda_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_bitstream_queue(ctx: *mut coda_ctx, buf: *const u8, size: u32) -> c_int {
    static int coda_bitstream_queue(struct coda_ctx *ctx, const u8 *buf, u32 size)
    {
    let mut n: u32 = kfifo_in(&ctx.bitstream_fifo, buf, size);
    return (n < size) ? -ENOSPC : 0;
    }
    ...
    struct vb2_v4l2_buffer *src_buf)
    {
    let mut payload: c_ulong = vb2_get_plane_payload(&src_buf.vb2_buf, 0);
    u8 *vaddr = vb2_plane_vaddr(&src_buf.vb2_buf, 0);
    int ret;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn coda_fill_bitstream(ctx: *mut coda_ctx, buffer_list: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn coda_bit_stream_end_flag(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda_parabuf_write(ctx: *mut coda_ctx, index: c_int, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn coda_free_framebuffers(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda_free_context_buffers(ctx: *mut coda_ctx) {
...
// worst case slice size
    ...
    let mut crop_right: u32 = round_up(r.width, 16) -  r.width;
    let mut crop_bottom: u32 = round_up(r.height, 16) - r.height;
...
#[no_mangle]
unsafe extern "C" fn coda_slice_mode(ctx: *mut coda_ctx) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn coda_enc_param_change(ctx: *mut coda_ctx) -> c_int {
    static int coda_enc_param_change(struct coda_ctx *ctx)
    {
    struct coda_dev *dev = ctx.dev;
    let mut change_enable: u32 = 0;
    u32 success;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn coda_iram_alloc(iram: *mut coda_iram_info, size: usize) -> phys_addr_t {
...
#[no_mangle]
unsafe extern "C" fn coda_setup_iram(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda_firmware_supported(vernum: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn coda_check_firmware(dev: *mut coda_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda9_set_frame_cache(ctx: *mut coda_ctx, fourcc: u32) {
...
#[no_mangle]
unsafe extern "C" fn coda_start_encoding(ctx: *mut coda_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_prepare_encode(ctx: *mut coda_ctx) -> c_int {
    ...
    struct coda_dev *dev = ctx.dev;
    int force_ipicture;
    let mut quant_param: c_int = 0;
    u32 pic_stream_buffer_addr, pic_stream_buffer_size;
    let mut rot_mode: u32 = 0;
    u32 dst_fourcc;
    u32 reg;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn coda_frame_type_char(flags: u32) -> c_char {
...
#[no_mangle]
unsafe extern "C" fn coda_finish_encode(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda_seq_end_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn coda_bit_release(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn coda_free_bitstream_buffer(ctx: *mut coda_ctx) {
    static void coda_free_bitstream_buffer(struct coda_ctx *ctx)
    {
    if (ctx.bitstream.vaddr == core::ptr::null_mut())
    return;
    dma_free_wc(ctx.dev.dev, ctx.bitstream.size, ctx.bitstream.vaddr,
    ctx.bitstream.paddr);
    ctx.bitstream.vaddr = core::ptr::null_mut();
    kfifo_init(&ctx.bitstream_fifo, core::ptr::null_mut(), 0);
    }
...
#[no_mangle]
unsafe extern "C" fn coda_reorder_enable(ctx: *mut coda_ctx) -> bool {
...
#[no_mangle]
unsafe extern "C" fn coda_decoder_drop_used_metas(ctx: *mut coda_ctx) {
...
#[no_mangle]
unsafe extern "C" fn __coda_decoder_seq_init(ctx: *mut coda_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_dec_seq_init_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn __coda_start_decoding(ctx: *mut coda_ctx) -> c_int {
...
// Set secondary AXI IRAM
    ...
    if (dev.devtype.product == CODA_HX4 ||
    dev.devtype.product == CODA_7541) {
    let mut max_mb_x: c_int = 1920 / 16;
    let mut max_mb_y: c_int = 1088 / 16;
    let mut max_mb_num: c_int = max_mb_x * max_mb_y;
...
#[no_mangle]
unsafe extern "C" fn coda_start_decoding(ctx: *mut coda_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coda_prepare_decode(ctx: *mut coda_ctx) -> c_int {
...
// Run coda_start_decoding (again) if not yet initialized
    if (!ctx.initialized) {
    let mut ret: c_int = __coda_start_decoding(ctx);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn coda_finish_decode(ctx: *mut coda_ctx) {
    ...
    int decoded_idx;
    int display_idx;
    struct coda_internal_frame *decoded_frame = core::ptr::null_mut();
    u32 src_fourcc;
    int success;
    u32 err_mb;
    let mut err_vdoa: c_int = 0;
    u32 val;
    if (ctx.aborting)
    return;
// Update kfifo out pointer from coda bitstream read pointer
...
// no frame was decoded, but we might have a display frame
    ...
    ctx.sequence_offset++;
#[no_mangle]
pub unsafe extern "C" fn if(0: ctx->display_idx <) -> else {
...
#[no_mangle]
unsafe extern "C" fn coda_decode_timeout(ctx: *mut coda_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn coda_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
