...
//! Source: drivers/media/platform/chips-media/wave5/wave5-vpu-enc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn start_encode(inst: *mut vpu_instance, fail_res: *mut u32) -> c_int {
    ...
    let mut stride: u32 = inst.src_fmt.plane_fmt[0].bytesperline;
    let mut luma_size: u32 = 0;
    let mut chroma_size: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_finish_encode(inst: *mut vpu_instance) {
    static void wave5_vpu_enc_finish_encode(struct vpu_instance *inst)
    {
    struct v4l2_m2m_ctx *m2m_ctx = inst.v4l2_fh.m2m_ctx;
    int ret;
    struct enc_output_info enc_output_info;
    struct vb2_v4l2_buffer *src_buf = core::ptr::null_mut();
    struct vb2_v4l2_buffer *dst_buf = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_querycap(file: *mut file, fh: *mut c_void, cap: *mut v4l2_capability) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_enum_framesizes(f: *mut file, fh: *mut c_void, fsize: *mut v4l2_frmsizeenum) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_enum_fmt_cap(file: *mut file, fh: *mut c_void, f: *mut v4l2_fmtdesc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_try_fmt_cap(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_s_fmt_cap(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_g_fmt_cap(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_enum_fmt_out(file: *mut file, fh: *mut c_void, f: *mut v4l2_fmtdesc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_try_fmt_out(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_s_fmt_out(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_g_selection(file: *mut file, fh: *mut c_void, s: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_s_selection(file: *mut file, fh: *mut c_void, s: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_encoder_cmd(file: *mut file, fh: *mut c_void, ec: *mut v4l2_encoder_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_g_parm(file: *mut file, fh: *mut c_void, a: *mut v4l2_streamparm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_s_parm(file: *mut file, fh: *mut c_void, a: *mut v4l2_streamparm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_buf_queue(vb: *mut vb2_buffer) {
    ...
    {
    let mut input: enc_wave_param = inst.enc_param;
    const struct v4l2_format_info *info;
    let mut num_ctu_row: u32 = ALIGN(inst.dst_fmt.height, 64) / 64;
    let mut num_mb_row: u32 = ALIGN(inst.dst_fmt.height, 16) / 16;
    info = v4l2_format_info(inst.src_fmt.pixelformat);
    if (!info)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn prepare_fb(inst: *mut vpu_instance) -> c_int {
    static int prepare_fb(struct vpu_instance *inst)
    {
    let mut fb_stride: u32 = ALIGN(inst.dst_fmt.width, 32);
    let mut fb_height: u32 = ALIGN(inst.dst_fmt.height, 32);
    int i, ret = 0;
    for (i = 0; i < inst.fbc_buf_count; i++) {
    let mut luma_size: u32 = fb_stride * fb_height;
    let mut chroma_size: u32 = ALIGN(fb_stride / 2, 16) * fb_height;
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
    ...
    wave5_vpu_enc_give_command(inst, ENABLE_MIRRORING, core::ptr::null_mut());
    wave5_vpu_enc_give_command(inst, SET_MIRROR_DIRECTION,
    &inst.mirror_direction);
    }
    if (inst.rot_angle) {
    wave5_vpu_enc_give_command(inst, ENABLE_ROTATION, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn streamoff_output(inst: *mut vpu_instance, q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn streamoff_capture(inst: *mut vpu_instance, q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_stop_streaming(q: *mut vb2_queue) {
    static void wave5_vpu_enc_stop_streaming(struct vb2_queue *q)
    {
    struct vpu_instance *inst = vb2_get_drv_priv(q);
    let mut check_cmd: bool = true;
//
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_queue_init(priv: *mut c_void, src_vq: *mut vb2_queue, dst_vq: *mut vb2_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_device_run(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_job_ready(priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_open_enc(filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_enc_release(filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wave5_vpu_enc_register_device(dev: *mut vpu_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wave5_vpu_enc_unregister_device(dev: *mut vpu_device) {
