...
//! Source: drivers/media/platform/chips-media/wave5/wave5-vpu-dec.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn switch_state(inst: *mut vpu_instance, state: enum vpu_instance_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_instance_state(inst: *mut vpu_instance, state: enum vpu_instance_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_set_eos_on_firmware(inst: *mut vpu_instance) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_last_src_buffer_consumed(m2m_ctx: *mut v4l2_m2m_ctx) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wave5_handle_src_buffer(inst: *mut vpu_instance, rd_ptr: dma_addr_t) {
    ...
    let mut rd_offs: usize = rd_ptr - inst.bitstream_vbuf.daddr;
    let mut last_rd_offs: usize = inst.last_rd_ptr - inst.bitstream_vbuf.daddr;
    ...
    let mut src_size: usize = vb2_get_plane_payload(&src_buf.vb2_buf, 0);
...
// Handle the case the last bitstream buffer has been picked
    ...
    int ret;
    m2m_ctx.last_src_buf = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn start_decode(inst: *mut vpu_instance, fail_res: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flag_last_buffer_done(inst: *mut vpu_instance) {
...
#[no_mangle]
unsafe extern "C" fn send_eos_event(inst: *mut vpu_instance) {
...
#[no_mangle]
unsafe extern "C" fn wave5_update_min_bufs_ctrl(inst: *mut vpu_instance, fbc_buf_count: u32) {
...
#[no_mangle]
unsafe extern "C" fn handle_dynamic_resolution_change(inst: *mut vpu_instance) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_finish_decode(inst: *mut vpu_instance) {
    static void wave5_vpu_dec_finish_decode(struct vpu_instance *inst)
    {
    struct v4l2_m2m_ctx *m2m_ctx = inst.v4l2_fh.m2m_ctx;
    struct dec_output_info dec_info;
    int ret;
    struct vb2_v4l2_buffer *dec_buf = core::ptr::null_mut();
    struct vb2_v4l2_buffer *disp_buf = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_querycap(file: *mut file, fh: *mut c_void, cap: *mut v4l2_capability) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_enum_framesizes(f: *mut file, fh: *mut c_void, fsize: *mut v4l2_frmsizeenum) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_enum_fmt_cap(file: *mut file, fh: *mut c_void, f: *mut v4l2_fmtdesc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_try_fmt_cap(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_s_fmt_cap(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_g_fmt_cap(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_enum_fmt_out(file: *mut file, fh: *mut c_void, f: *mut v4l2_fmtdesc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_try_fmt_out(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_s_fmt_out(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_g_selection(file: *mut file, fh: *mut c_void, s: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_s_selection(file: *mut file, fh: *mut c_void, s: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_stop(inst: *mut vpu_instance) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_start(inst: *mut vpu_instance) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_decoder_cmd(file: *mut file, fh: *mut c_void, dc: *mut v4l2_decoder_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_prepare_fb(inst: *mut vpu_instance) -> c_int {
    static int wave5_prepare_fb(struct vpu_instance *inst)
    {
    int linear_num;
    int non_linear_num;
    let mut fb_stride: c_int = 0, fb_height = 0;
...
// In case the count has reduced, clean up leftover framebuffer memory
    ...
    let mut buf_addr_y: dma_addr_t = 0, buf_addr_cb = 0, buf_addr_cr = 0;
    let mut buf_size: u32 = 0;
    let mut fb_stride: u32 = inst.dst_fmt.width;
    let mut luma_size: u32 = fb_stride * inst.dst_fmt.height;
    u32 chroma_size;
...
//
    ...
    {
    size_t size;
    let mut offset: usize = wr_ptr - ring_buffer.daddr;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn fill_ringbuffer(inst: *mut vpu_instance) -> c_int {
    ...
    while ((vpu_buf = inst_src_buf_remove(inst)) != core::ptr::null_mut()) {
    struct vb2_v4l2_buffer *vbuf = &vpu_buf.v4l2_m2m_buf.vb;
    struct vpu_buf *ring_buffer = &inst.bitstream_vbuf;
    let mut src_size: usize = vb2_get_plane_payload(&vbuf.vb2_buf, 0);
    void *src_buf = vb2_plane_vaddr(&vbuf.vb2_buf, 0);
    let mut rd_ptr: dma_addr_t = 0;
    let mut wr_ptr: dma_addr_t = 0;
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_buf_queue_src(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_buf_queue_dst(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_allocate_ring_buffer(inst: *mut vpu_instance) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn streamoff_output(q: *mut vb2_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn streamoff_capture(q: *mut vb2_queue) -> c_int {
    ...
    wave5_vpu_dec_give_command(inst, DEC_RESET_FRAMEBUF_INFO, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_queue_init(priv: *mut c_void, src_vq: *mut vb2_queue, dst_vq: *mut vb2_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn initialize_sequence(inst: *mut vpu_instance) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_is_draining_or_eos(inst: *mut vpu_instance) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_device_run(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_job_abort(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_job_ready(priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_open_dec(filp: *mut file) -> c_int {
    static int wave5_vpu_open_dec(struct file *filp)
    {
    struct video_device *vdev = video_devdata(filp);
    struct vpu_device *dev = video_drvdata(filp);
    struct vpu_instance *inst = core::ptr::null_mut();
...
//
    ...
    v4l2_ctrl_new_std(&inst.v4l2_ctrl_hdl, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn wave5_vpu_dec_release(filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wave5_vpu_dec_register_device(dev: *mut vpu_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wave5_vpu_dec_unregister_device(dev: *mut vpu_device) {
