...
//! Source: drivers/media/platform/arm/mali-c55/mali-c55-capture.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mali_c55_cap_dev_read(cap_dev: *mut mali_c55_cap_dev, addr: c_uint) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_format_is_raw(mbus_code: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_link_validate(link: *mut media_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_buf_queue(vb: *mut vb2_buffer) {
    ...
    for (i = 0; i < cap_dev.format.format.num_planes; i++) {
    let mut size: c_ulong = cap_dev.format.format.plane_fmt[i].sizeimage;
...
#[no_mangle]
unsafe extern "C" fn mali_c55_buf_init(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_set_next_buffer(cap_dev: *mut mali_c55_cap_dev) {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_cap_dev_stream_disable(cap_dev: *mut mali_c55_cap_dev) {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_cap_dev_stream_enable(cap_dev: *mut mali_c55_cap_dev) {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_cap_dev_format_configure(cap_dev: *mut mali_c55_cap_dev) {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_vb2_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_vb2_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_try_fmt(pix_mp: *mut v4l2_pix_format_mplane) {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_register_capture_devs(mali_c55: *mut mali_c55) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_unregister_capture_devs(mali_c55: *mut mali_c55) {
