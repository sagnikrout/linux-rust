...
//! Source: drivers/media/platform/arm/mali-c55/mali-c55-stats.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mali_c55_stats_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_stats_stop_streaming(q: *mut vb2_queue) {
    ...
    struct mali_c55_stats_buf *buf = core::ptr::null_mut();
    spin_lock(&stats.buffers.lock);
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_unregister_stats(mali_c55: *mut mali_c55) {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_register_stats(mali_c55: *mut mali_c55) -> c_int {
