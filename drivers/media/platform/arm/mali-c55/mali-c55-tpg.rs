...
//! Source: drivers/media/platform/arm/mali-c55/mali-c55-tpg.c
#![no_std]
...
pub const MALI_C55_TPG_SRC_PAD: c_int = 0;
pub const MALI_C55_TPG_FIXED_HBLANK: c_uint = 0x20;
pub const MALI_C55_TPG_DEFAULT_MIN_VBLANK: c_int = 66;
pub const MALI_C55_TPG_DEFAULT_DEF_VBLANK: c_int = 626;
pub const MALI_C55_TPG_MAX_VBLANK: c_uint = 0xffff;
pub const MALI_C55_TPG_PIXEL_RATE: c_int = 100000000;
...
#[no_mangle]
unsafe extern "C" fn mali_c55_tpg_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_tpg_init_controls(mali_c55: *mut mali_c55) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_register_tpg(mali_c55: *mut mali_c55) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_unregister_tpg(mali_c55: *mut mali_c55) {
