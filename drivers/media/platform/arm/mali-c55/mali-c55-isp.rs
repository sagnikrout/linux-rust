...
//! Source: drivers/media/platform/arm/mali-c55/mali-c55-isp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mali_c55_isp_stop(mali_c55: *mut mali_c55) {
...
//
    ...
    isp.remote_src = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_isp_queue_event_sof(mali_c55: *mut mali_c55) {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_subdev_link_validate(link: *mut media_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_isp_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_isp_init_controls(mali_c55: *mut mali_c55) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_register_isp(mali_c55: *mut mali_c55) -> c_int {
    ...
    isp.mali_c55 = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn mali_c55_unregister_isp(mali_c55: *mut mali_c55) {
