...
//! Source: drivers/media/platform/arm/mali-c55/mali-c55-resizer.c
#![no_std]
...
pub const MALI_C55_RSZ_COEFS_BANKS: c_int = 8;
pub const MALI_C55_RSZ_COEFS_ENTRIES: c_int = 64;
...
//
    ...
    {
    let mut rsz_ratio: c_uint = (rsz_out * 1000U) / rsz_in;
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn mali_c55_resizer_program_coefficients(rsz: *mut mali_c55_resizer) {
...
//
#[no_mangle]
unsafe extern "C" fn mali_c55_rsz_get_active_sink(state: *mut v4l2_subdev_state) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn mali_c55_rsz_shift_mbus_code(mbus_code: u32) -> u32 {
    ...
    let mut active_sink: c_uint = UINT_MAX;
    struct v4l2_mbus_framefmt *src_fmt;
    struct v4l2_subdev_route *route;
    let mut active_routes: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn mali_c55_unregister_resizer(rsz: *mut mali_c55_resizer) {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_register_resizers(mali_c55: *mut mali_c55) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_unregister_resizers(mali_c55: *mut mali_c55) {
