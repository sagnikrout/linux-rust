...
//! Source: drivers/media/platform/arm/mali-c55/mali-c55-core.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn mali_c55_write(mali_c55: *mut mali_c55, addr: c_uint, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_read(mali_c55: *mut mali_c55, addr: c_uint) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_ctx_write(mali_c55: *mut mali_c55, addr: c_uint, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn __mali_c55_ctx_read(ctx: *mut mali_c55_context, addr: c_uint) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_ctx_read(mali_c55: *mut mali_c55, addr: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_remove_links(mali_c55: *mut mali_c55) {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_create_links(mali_c55: *mut mali_c55) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_unregister_entities(mali_c55: *mut mali_c55) {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_swap_next_config(mali_c55: *mut mali_c55) {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_register_entities(mali_c55: *mut mali_c55) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_notifier_complete(notifier: *mut v4l2_async_notifier) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_parse_endpoint(mali_c55: *mut mali_c55) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_media_frameworks_init(mali_c55: *mut mali_c55) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_media_frameworks_deinit(mali_c55: *mut mali_c55) {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_pipeline_ready(mali_c55: *mut mali_c55) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_check_hwcfg(mali_c55: *mut mali_c55) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_isr(irq: c_int, context: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn __mali_c55_power_off(mali_c55: *mut mali_c55) {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn __mali_c55_power_on(mali_c55: *mut mali_c55) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
// happening.
//
    ret = request_threaded_irq(mali_c55.irqnum, core::ptr::null_mut(), mali_c55_isr,
...
#[no_mangle]
unsafe extern "C" fn mali_c55_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_remove(pdev: *mut platform_device) {
