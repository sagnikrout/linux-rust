...
//! Source: drivers/media/platform/arm/mali-c55/mali-c55-params.c
#![no_std]
...
// If the block is flagged disabled, set all of the gains to 1.0
    ...
    let mut addr: __u32 = lut_base + (i * 4);
...
#[no_mangle]
unsafe extern "C" fn mali_c55_params_buf_init(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_params_buf_cleanup(vb: *mut vb2_buffer) {
    static void mali_c55_params_buf_cleanup(struct vb2_buffer *vb)
    {
    struct vb2_v4l2_buffer *vbuf = to_vb2_v4l2_buffer(vb);
    struct mali_c55_params_buf *buf = to_mali_c55_params_buf(vbuf);
    kvfree(buf.config);
    buf.config = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn mali_c55_params_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_params_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn mali_c55_params_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_params_write_config(mali_c55: *mut mali_c55) {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_unregister_params(mali_c55: *mut mali_c55) {
...
#[no_mangle]
pub unsafe extern "C" fn mali_c55_register_params(mali_c55: *mut mali_c55) -> c_int {
