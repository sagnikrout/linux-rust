...
//! Source: drivers/media/platform/ti/cal/cal-video.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cal_legacy_g_input(file: *mut file, priv: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cal_legacy_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cal_legacy_g_parm(file: *mut file, fh: *mut c_void, a: *mut v4l2_streamparm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cal_legacy_s_parm(file: *mut file, fh: *mut c_void, a: *mut v4l2_streamparm) -> c_int {
...
// info = fmtinfo;
    ...
    {
    struct cal_ctx *ctx = video_drvdata(file);
    cal_mc_try_fmt(ctx, f, core::ptr::null_mut());
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn cal_buffer_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cal_buffer_queue(vb: *mut vb2_buffer) {
...
// Release all queued buffers.
    ...
    ctx.dma.pending = core::ptr::null_mut();
    }
    if (ctx.dma.active) {
    vb2_buffer_done(&ctx.dma.active.vb.vb2_buf, state);
    ctx.dma.active = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn cal_video_check_format(ctx: *mut cal_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cal_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cal_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn cal_ctx_v4l2_init_formats(ctx: *mut cal_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cal_ctx_v4l2_init_mc_format(ctx: *mut cal_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cal_ctx_v4l2_register(ctx: *mut cal_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cal_ctx_v4l2_unregister(ctx: *mut cal_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn cal_ctx_v4l2_init(ctx: *mut cal_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cal_ctx_v4l2_cleanup(ctx: *mut cal_ctx) {
