...
//! Source: drivers/media/platform/ti/cal/cal-camerarx.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn camerarx_read(phy: *mut cal_camerarx, offset: u32) -> u32 {
    static inline u32 camerarx_read(struct cal_camerarx *phy, u32 offset)
    {
    return ioread32(phy.base + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn camerarx_write(phy: *mut cal_camerarx, offset: u32, val: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn cal_camerarx_get_ext_link_freq(phy: *mut cal_camerarx) -> i64 {
    static s64 cal_camerarx_get_ext_link_freq(struct cal_camerarx *phy)
    {
    struct v4l2_mbus_config_mipi_csi2 *mipi_csi2 = &phy.endpoint.bus.mipi_csi2;
    let mut num_lanes: u32 = mipi_csi2.num_data_lanes;
...
#[no_mangle]
unsafe extern "C" fn cal_camerarx_lane_config(phy: *mut cal_camerarx) {
    static void cal_camerarx_lane_config(struct cal_camerarx *phy)
    {
    let mut val: u32 = cal_read(phy.cal, CAL_CSI2_COMPLEXIO_CFG(phy.instance));
    let mut lane_mask: u32 = CAL_CSI2_COMPLEXIO_CFG_CLOCK_POSITION_MASK;
    let mut polarity_mask: u32 = CAL_CSI2_COMPLEXIO_CFG_CLOCK_POL_MASK;
...
#[no_mangle]
unsafe extern "C" fn cal_camerarx_enable(phy: *mut cal_camerarx) {
    static void cal_camerarx_enable(struct cal_camerarx *phy)
    {
    let mut num_lanes: u32 = phy.cal.data.camerarx[phy.instance].num_lanes;
...
#[no_mangle]
pub unsafe extern "C" fn cal_camerarx_disable(phy: *mut cal_camerarx) {
...
//
pub const TCLK_TERM: c_int = 0;
pub const TCLK_MISS: c_int = 1;
pub const TCLK_SETTLE: c_int = 14;
#[no_mangle]
unsafe extern "C" fn cal_camerarx_config(phy: *mut cal_camerarx, link_freq: i64) {
...
#[no_mangle]
unsafe extern "C" fn cal_camerarx_power(phy: *mut cal_camerarx, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn cal_camerarx_wait_reset(phy: *mut cal_camerarx) {
...
#[no_mangle]
unsafe extern "C" fn cal_camerarx_wait_stop_state(phy: *mut cal_camerarx) {
...
#[no_mangle]
unsafe extern "C" fn cal_camerarx_enable_irqs(phy: *mut cal_camerarx) {
...
#[no_mangle]
unsafe extern "C" fn cal_camerarx_disable_irqs(phy: *mut cal_camerarx) {
...
#[no_mangle]
unsafe extern "C" fn cal_camerarx_ppi_enable(phy: *mut cal_camerarx) {
...
#[no_mangle]
unsafe extern "C" fn cal_camerarx_ppi_disable(phy: *mut cal_camerarx) {
...
#[no_mangle]
unsafe extern "C" fn cal_camerarx_start(phy: *mut cal_camerarx, sink_stream: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cal_camerarx_stop(phy: *mut cal_camerarx, sink_stream: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cal_camerarx_i913_errata(phy: *mut cal_camerarx) {
    void cal_camerarx_i913_errata(struct cal_camerarx *phy)
    {
    let mut reg10: u32 = camerarx_read(phy, CAL_CSI2_PHY_REG10);
...
#[no_mangle]
unsafe extern "C" fn cal_camerarx_parse_dt(phy: *mut cal_camerarx) -> c_int {
...
//
    ...
    let mut lane: c_uint = endpoint.bus.mipi_csi2.data_lanes[i];
    if (lane > 4) {
...
#[no_mangle]
pub unsafe extern "C" fn cal_camerarx_destroy(phy: *mut cal_camerarx) {
