...
//! Source: drivers/media/platform/ti/omap/omap_vout.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn omap_vout_try_format(pix: *mut v4l2_pix_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_vout_calculate_offset(vout: *mut omap_vout_device) -> c_int {
    ...
    let mut ps: c_int = 2, line_length = 0;
    ovid = &vout.vid_info;
    ...
    ps = 2;
#[no_mangle]
pub unsafe extern "C" fn if(pix->pixelformat: V4L2_PIX_FMT_RGB32 ==) -> else {
    else if (V4L2_PIX_FMT_RGB32 == pix.pixelformat)
    ps = 4;
#[no_mangle]
pub unsafe extern "C" fn if(pix->pixelformat: V4L2_PIX_FMT_RGB24 ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn video_mode_to_dss_mode(vout: *mut omap_vout_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn omapvid_init(vout: *mut omap_vout_device, addr: dma_addr_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn omapvid_apply_changes(vout: *mut omap_vout_device) -> c_int {
    ...
    fid = 1;
#[no_mangle]
pub unsafe extern "C" fn if(DISPC_IRQ_EVSYNC_EVEN: irqstatus &) -> else {
...
#[no_mangle]
unsafe extern "C" fn omap_vout_isr(arg: *mut c_void, irqstatus: c_uint) {
...
// get the display device attached to the overlay
    ...
    irq = DISPC_IRQ_VSYNC;
#[no_mangle]
pub unsafe extern "C" fn if(OMAP_DSS_CHANNEL_LCD2: mgr_id ==) -> else {
...
// Video1 plane does not support global alpha on OMAP3
    ...
    win.global_alpha = 0;
    win.clips = core::ptr::null_mut();
    win.clipcount = 0;
    win.bitmap = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn vidioc_g_selection(file: *mut file, fh: *mut c_void, sel: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_selection(file: *mut file, fh: *mut c_void, sel: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_vout_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    struct omapvideo_info *ovid;
    let mut rotation: c_int = ctrl.val;
    ovid = &vout.vid_info;
    ...
    {
    struct omapvideo_info *ovid;
    let mut mirror: c_uint = ctrl.val;
    ovid = &vout.vid_info;
    ...
    let mut size: c_int = vout.pix.sizeimage;
...
#[no_mangle]
unsafe extern "C" fn omap_vout_vb2_prepare(vb: *mut vb2_buffer) -> c_int {
    ...
    let mut buf_phy_addr: dma_addr_t = vb2_dma_contig_plane_dma_addr(vb, 0);
...
#[no_mangle]
unsafe extern "C" fn omap_vout_vb2_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn omap_vout_vb2_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_vout_vb2_stop_streaming(vq: *mut vb2_queue) {
...
// Turn of the pipeline
    ...
    struct omap_vout_device *vout = video_drvdata(file);
    struct omap_overlay_manager_info info;
    let mut key_type: enum omap_dss_trans_key_type = OMAP_DSS_COLOR_KEY_GFX_DST;
    ovid = &vout.vid_info;
    ovl = ovid.overlays[0];
...
#[no_mangle]
unsafe extern "C" fn vidioc_g_output(file: *mut file, priv: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_output(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_vout_setup_video_data(vout: *mut omap_vout_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn omap_vout_create_video_devices(pdev: *mut platform_device) -> int __init {
    static int __init omap_vout_create_video_devices(struct platform_device *pdev)
    {
    let mut ret: c_int = 0, k;
    struct omap_vout_device *vout;
    struct video_device *vfd = core::ptr::null_mut();
    struct v4l2_device *v4l2_dev = platform_get_drvdata(pdev);
...
// Driver functions
#[no_mangle]
unsafe extern "C" fn omap_vout_cleanup_device(vout: *mut omap_vout_device) {
...
#[no_mangle]
unsafe extern "C" fn omap_vout_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn omap_vout_probe(pdev: *mut platform_device) -> int __init {
    static int __init omap_vout_probe(struct platform_device *pdev)
    {
    let mut ret: c_int = 0, i;
    struct omap_overlay *ovl;
    struct omap_dss_device *dssdev = core::ptr::null_mut();
    struct omap_dss_device *def_display;
    struct omap2video_device *vid_dev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn omap_vout_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn omap_vout_cleanup() {
