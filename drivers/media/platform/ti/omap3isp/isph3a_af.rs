...
//! Source: drivers/media/platform/ti/omap3isp/isph3a_af.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn h3a_af_setup_regs(af: *mut ispstat, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn h3a_af_enable(af: *mut ispstat, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn h3a_af_busy(af: *mut ispstat) -> c_int {
    static int h3a_af_busy(struct ispstat *af)
    {
#[no_mangle]
pub unsafe extern "C" fn isp_reg_readl(_arg: af->isp, _arg: OMAP3_ISP_IOMEM_H3A, _arg: ISPH3A_PCR) -> return {
    return isp_reg_readl(af.isp, OMAP3_ISP_IOMEM_H3A, ISPH3A_PCR)
    & ISPH3A_PCR_BUSYAF;
    }
#[no_mangle]
unsafe extern "C" fn h3a_af_get_buf_size(conf: *mut omap3isp_h3a_af_config) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn h3a_af_validate_params(af: *mut ispstat, new_conf: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(OMAP3ISP_AF_MAX_BUF_SIZE: user_cfg->buf_size >) -> else {
...
#[no_mangle]
unsafe extern "C" fn h3a_af_set_params(af: *mut ispstat, new_conf: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn h3a_af_ioctl(sd: *mut v4l2_subdev, cmd: c_uint, arg: *mut c_void) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn omap3isp_h3a_af_init(isp: *mut isp_device) -> c_int {
    int omap3isp_h3a_af_init(struct isp_device *isp)
    {
    struct ispstat *af = &isp.isp_af;
    struct omap3isp_h3a_af_config *af_cfg;
    struct omap3isp_h3a_af_config *af_recover_cfg = core::ptr::null_mut();
    int ret;
    af_cfg = kzalloc_obj(*af_cfg);
    if (af_cfg == core::ptr::null_mut())
    return -ENOMEM;
    af.ops = &h3a_af_ops;
    af.priv = af_cfg;
...
#[no_mangle]
pub unsafe extern "C" fn omap3isp_h3a_af_cleanup(isp: *mut isp_device) {
