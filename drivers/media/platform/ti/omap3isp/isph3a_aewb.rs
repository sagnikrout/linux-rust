...
//! Source: drivers/media/platform/ti/omap3isp/isph3a_aewb.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn h3a_aewb_setup_regs(aewb: *mut ispstat, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn h3a_aewb_enable(aewb: *mut ispstat, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn h3a_aewb_busy(aewb: *mut ispstat) -> c_int {
    static int h3a_aewb_busy(struct ispstat *aewb)
    {
#[no_mangle]
pub unsafe extern "C" fn isp_reg_readl(_arg: aewb->isp, _arg: OMAP3_ISP_IOMEM_H3A, _arg: ISPH3A_PCR) -> return {
    return isp_reg_readl(aewb.isp, OMAP3_ISP_IOMEM_H3A, ISPH3A_PCR)
    & ISPH3A_PCR_BUSYAEAWB;
    }
#[no_mangle]
unsafe extern "C" fn h3a_aewb_get_buf_size(conf: *mut omap3isp_h3a_aewb_config) -> u32 {
...
// Number of configured windows + extra row for black data
    let mut win_count: u32 = (conf.ver_win_count + 1) * conf.hor_win_count;
//
...
#[no_mangle]
unsafe extern "C" fn h3a_aewb_validate_params(aewb: *mut ispstat, new_conf: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(OMAP3ISP_AEWB_MAX_BUF_SIZE: user_cfg->buf_size >) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn h3a_aewb_set_params(aewb: *mut ispstat, new_conf: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn h3a_aewb_ioctl(sd: *mut v4l2_subdev, cmd: c_uint, arg: *mut c_void) -> c_long {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap3isp_h3a_aewb_init(isp: *mut isp_device) -> c_int {
    int omap3isp_h3a_aewb_init(struct isp_device *isp)
    {
    struct ispstat *aewb = &isp.isp_aewb;
    struct omap3isp_h3a_aewb_config *aewb_cfg;
    struct omap3isp_h3a_aewb_config *aewb_recover_cfg = core::ptr::null_mut();
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn omap3isp_h3a_aewb_cleanup(isp: *mut isp_device) {
