...
//! Source: drivers/media/platform/ti/vpe/vpe.c
#![no_std]
...
pub const MAX_W: c_int = 2048;
pub const MAX_H: c_int = 2048;
// required alignments

// flags that indicate a format can be used for capture/output

// used as plane indices
pub const VPE_MAX_PLANES: c_int = 2;
pub const VPE_LUMA: c_int = 0;
pub const VPE_CHROMA: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vpe_us_coeffs {
    pub anchor_fid0_c0: c_ushort,
    pub anchor_fid0_c1: c_ushort,
    pub anchor_fid0_c2: c_ushort,
    pub anchor_fid0_c3: c_ushort,
    pub interp_fid0_c0: c_ushort,
    pub interp_fid0_c1: c_ushort,
    pub interp_fid0_c2: c_ushort,
    pub interp_fid0_c3: c_ushort,
    pub anchor_fid1_c0: c_ushort,
    pub anchor_fid1_c1: c_ushort,
    pub anchor_fid1_c2: c_ushort,
    pub anchor_fid1_c3: c_ushort,
    pub interp_fid1_c0: c_ushort,
    pub interp_fid1_c1: c_ushort,
    pub interp_fid1_c2: c_ushort,
    pub interp_fid1_c3: c_ushort,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vpe_dei_regs {
    pub /: *mut *mut unsigned long mdt_spacial_freq_thr_reg; / VPE_DEI_REG2,
    pub /: *mut *mut unsigned long edi_config_reg; / VPE_DEI_REG3,
    pub /: *mut *mut unsigned long edi_lut_reg0; / VPE_DEI_REG4,
    pub /: *mut *mut unsigned long edi_lut_reg1; / VPE_DEI_REG5,
    pub /: *mut *mut unsigned long edi_lut_reg2; / VPE_DEI_REG6,
    pub /: *mut *mut unsigned long edi_lut_reg3; / VPE_DEI_REG7,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vpe_port_data {
    pub /: *mut *mut enum vpdma_channel channel; / VPDMA channel,
    pub /: *mut *mut u8 vb_index; / input frame f, f-1, f-2 index,
    pub /: *mut *mut u8 vb_part; / plane index for co-panar formats,
}

//
// Define indices into the port_data tables
//
pub const VPE_PORT_LUMA1_IN: c_int = 0;
pub const VPE_PORT_CHROMA1_IN: c_int = 1;
pub const VPE_PORT_LUMA2_IN: c_int = 2;
pub const VPE_PORT_CHROMA2_IN: c_int = 3;
pub const VPE_PORT_LUMA3_IN: c_int = 4;
pub const VPE_PORT_CHROMA3_IN: c_int = 5;
pub const VPE_PORT_MV_IN: c_int = 6;
pub const VPE_PORT_MV_OUT: c_int = 7;
pub const VPE_PORT_LUMA_OUT: c_int = 8;
pub const VPE_PORT_CHROMA_OUT: c_int = 9;
pub const VPE_PORT_RGB_OUT: c_int = 10;
...
#[derive(Copy, Clone)]
pub struct vpe_fmt {
    pub /: *mut *mut u32 fourcc; / standard format identifier,
    pub /: *mut *mut u8 types; / CAPTURE and/or OUTPUT,
    pub /: *mut *mut u8 coplanar; / set for unpacked Luma and Chroma,
// vpdma format info for each plane
    pub vpdma_fmt: [*const vpdma_data_format; VPE_MAX_PLANES],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vpe_q_data {
// current v4l2 format info
    pub format: v4l2_format,
    pub flags: c_uint,
    pub /: *mut *mut v4l2_rect c_rect; / crop/compose rectangle,
    pub /: *mut *mut *mut vpe_fmt fmt; / format info,
}
...
pub struct vpe_dev {
    ...
    pub /: *mut *mut atomic_t num_instances; / count of driver instances,
    pub /: *mut *mut dma_addr_t loaded_mmrs; / shadow mmrs in device,
    pub dev_mutex: mutex,
    pub lock: spinlock_t,
    pub irq: c_int,
    ...
    pub /: *mut *mut *mut vpdma_data vpdma; / vpdma data handle,
    pub /: *mut *mut *mut sc_data sc; / scaler data handle,
    pub /: *mut *mut *mut csc_data csc; / csc data handle,
}
...
pub struct vpe_ctx {
    ...
    pub /: *mut *mut unsigned int field; / current field,
    pub /: *mut *mut unsigned int sequence; / current frame/field seq,
    pub /: *mut *mut unsigned int aborting; / abort after next irq,
    pub /: *mut *mut unsigned int bufs_per_job; / input buffers per batch,
    pub /: *mut *mut unsigned int bufs_completed; / bufs done in this batch,
    pub /: *mut *mut vpe_q_data q_data[2]; / src & dst queue data,
    pub src_vbs: [*mut vb2_v4l2_buffer; VPE_MAX_SRC_BUFS],
    pub dst_vb: *mut vb2_v4l2_buffer,
    pub /: *mut *mut dma_addr_t mv_buf_dma[2]; / dma addrs of motion vector in/out bufs,
    pub /: *mut *mut *mut void mv_buf[2]; / virtual addrs of motion vector bufs,
    pub /: *mut *mut size_t mv_buf_size; / current motion vector buffer size,
    pub /: *mut *mut vpdma_buf mmr_adb; / shadow reg addr/data block,
    pub /: *mut *mut vpdma_buf sc_coeff_h; / h coeff buffer,
    pub /: *mut *mut vpdma_buf sc_coeff_v; / v coeff buffer,
    pub /: *mut *mut vpdma_desc_list desc_list; / DMA descriptor list,
    pub /: *mut *mut bool deinterlacing; / using de-interlacer,
    pub /: *mut *mut bool load_mmrs; / have new shadow reg values,
    pub src_mv_buf_selector: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn read_reg(dev: *mut vpe_dev, offset: c_int) -> u32 {
    static u32 read_reg(struct vpe_dev *dev, int offset)
    {
    return ioread32(dev.base + offset);
    }
#[no_mangle]
unsafe extern "C" fn write_reg(dev: *mut vpe_dev, offset: c_int, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn get_field(value: u32, mask: u32, shift: c_int) -> c_int {
    static int get_field(u32 value, u32 mask, int shift)
    {
    return (value & (mask << shift)) >> shift;
    }
#[no_mangle]
unsafe extern "C" fn read_field_reg(dev: *mut vpe_dev, offset: c_int, mask: u32, shift: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_field(valp: *mut u32, field: u32, mask: u32, shift: c_int) {
    static void write_field(u32 *valp, u32 field, u32 mask, int shift)
    {
    let mut val: u32 = *valp;
    val &= ~(mask << shift);
...
// valp = val;
    ...
    u32 mask, int shift)
    {
    let mut val: u32 = read_reg(dev, offset);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vpe_mmr_adb {
    pub out_fmt_hdr: vpdma_adb_hdr,
    pub out_fmt_reg: [u32; 1],
    pub out_fmt_pad: [u32; 3],
    pub us1_hdr: vpdma_adb_hdr,
    pub us1_regs: [u32; 8],
    pub us2_hdr: vpdma_adb_hdr,
    pub us2_regs: [u32; 8],
    pub us3_hdr: vpdma_adb_hdr,
    pub us3_regs: [u32; 8],
    pub dei_hdr: vpdma_adb_hdr,
    pub dei_regs: [u32; 8],
    pub sc_hdr0: vpdma_adb_hdr,
    pub sc_regs0: [u32; 7],
    pub sc_pad0: [u32; 1],
    pub sc_hdr8: vpdma_adb_hdr,
    pub sc_regs8: [u32; 6],
    pub sc_pad8: [u32; 2],
    pub sc_hdr17: vpdma_adb_hdr,
    pub sc_regs17: [u32; 9],
    pub sc_pad17: [u32; 3],
    pub csc_hdr: vpdma_adb_hdr,
    pub csc_regs: [u32; 6],
    pub csc_pad: [u32; 2],
}
...
//
#[no_mangle]
unsafe extern "C" fn init_adb_hdrs(ctx: *mut vpe_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn realloc_mv_buffers(ctx: *mut vpe_ctx, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_mv_buffers(ctx: *mut vpe_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn free_vbs(ctx: *mut vpe_ctx) {
    static void free_vbs(struct vpe_ctx *ctx)
    {
    struct vpe_dev *dev = ctx.dev;
    unsigned long flags;
    if (ctx.src_vbs[2] == core::ptr::null_mut())
    return;
    ...
    ctx.src_vbs[2] = core::ptr::null_mut();
    ctx.src_vbs[1] = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn vpe_set_clock_enable(dev: *mut vpe_dev, on: bool) {
...
#[no_mangle]
unsafe extern "C" fn vpe_top_reset(dev: *mut vpe_dev) {
...
#[no_mangle]
unsafe extern "C" fn vpe_top_vpdma_reset(dev: *mut vpe_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn set_us_coefficients(ctx: *mut vpe_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn set_cfg_modes(ctx: *mut vpe_ctx) {
...
#[no_mangle]
unsafe extern "C" fn set_line_modes(ctx: *mut vpe_ctx) {
    static void set_line_modes(struct vpe_ctx *ctx)
    {
    struct vpe_fmt *fmt = ctx.q_data[Q_DATA_SRC].fmt;
    let mut line_mode: c_int = 1;
    if (fmt.fourcc == V4L2_PIX_FMT_NV12 ||
    fmt.fourcc == V4L2_PIX_FMT_NV21)
...
//
#[no_mangle]
unsafe extern "C" fn set_src_registers(ctx: *mut vpe_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn set_dst_registers(ctx: *mut vpe_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn set_dei_regs(ctx: *mut vpe_ctx) {
    static void set_dei_regs(struct vpe_ctx *ctx)
    {
    struct vpe_mmr_adb *mmr_adb = ctx.mmr_adb.addr;
    struct vpe_q_data *s_q_data = &ctx.q_data[Q_DATA_SRC];
    let mut src_h: c_uint = s_q_data.c_rect.height;
    let mut src_w: c_uint = s_q_data.c_rect.width;
    u32 *dei_mmr0 = &mmr_adb.dei_regs[0];
    let mut deinterlace: bool = true;
    let mut val: u32 = 0;
//
...
#[no_mangle]
unsafe extern "C" fn set_dei_shadow_registers(ctx: *mut vpe_ctx) {
...
#[no_mangle]
unsafe extern "C" fn config_edi_input_mode(ctx: *mut vpe_ctx, mode: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn set_srcdst_params(ctx: *mut vpe_ctx) -> c_int {
    ...
    let mut src_w: c_uint = s_q_data.c_rect.width;
    let mut src_h: c_uint = s_q_data.c_rect.height;
    let mut dst_w: c_uint = d_q_data.c_rect.width;
    let mut dst_h: c_uint = d_q_data.c_rect.height;
...
//
    ...
    free_vbs(ctx);
    ctx.src_vbs[2] = ctx.src_vbs[1] = ctx.src_vbs[0] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn job_ready(priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn job_abort(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn vpe_dump_regs(dev: *mut vpe_dev) {
...
#[no_mangle]
unsafe extern "C" fn add_out_dtd(ctx: *mut vpe_ctx, port: c_int) {
    ...
    let mut mv_buf_selector: c_int = !ctx.src_mv_buf_selector;
...
// to incorporate interleaved formats
    let mut plane: c_int = fmt.coplanar ? p_data.vb_part : 0;
    pix = &q_data.format.fmt.pix_mp;
...
#[no_mangle]
unsafe extern "C" fn add_in_dtd(ctx: *mut vpe_ctx, port: c_int) {
    ...
    const struct vpdma_data_format *vpdma_fmt;
    let mut mv_buf_selector: c_int = ctx.src_mv_buf_selector;
    let mut field: c_int = vbuf.field == V4L2_FIELD_BOTTOM;
...
// Toggle for each vb_index and each operation
    ...
    if (field) {
    let mut height: c_int = pix.height / 2;
    int bpp;
    if (fmt.fourcc == V4L2_PIX_FMT_NV12 ||
    fmt.fourcc == V4L2_PIX_FMT_NV21)
    bpp = 1;
...
//
#[no_mangle]
unsafe extern "C" fn enable_irqs(ctx: *mut vpe_ctx) {
...
#[no_mangle]
unsafe extern "C" fn disable_irqs(ctx: *mut vpe_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn device_run(priv: *mut c_void) {
...
//
    ...
    WARN_ON(ctx.src_vbs[0] == core::ptr::null_mut());
    } else {
    ctx.src_vbs[0] = v4l2_m2m_src_buf_remove(ctx.fh.m2m_ctx);
    WARN_ON(ctx.src_vbs[0] == core::ptr::null_mut());
    }
    ctx.dst_vb = v4l2_m2m_dst_buf_remove(ctx.fh.m2m_ctx);
    WARN_ON(ctx.dst_vb == core::ptr::null_mut());
    if (ctx.deinterlacing) {
    if (ctx.src_vbs[2] == core::ptr::null_mut()) {
    ctx.src_vbs[2] = ctx.src_vbs[0];
    WARN_ON(ctx.src_vbs[2] == core::ptr::null_mut());
    ctx.src_vbs[1] = ctx.src_vbs[0];
    WARN_ON(ctx.src_vbs[1] == core::ptr::null_mut());
    }
//
...
#[no_mangle]
unsafe extern "C" fn dei_error(ctx: *mut vpe_ctx) {
...
#[no_mangle]
unsafe extern "C" fn ds1_uv_error(ctx: *mut vpe_ctx) {
...
#[no_mangle]
unsafe extern "C" fn vpe_irq(irq_vpe: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    unsigned long flags;
    u32 irqst0, irqst1;
    let mut list_complete: bool = false;
...
//
    ctx.src_vbs[0] = core::ptr::null_mut();
    ctx.dst_vb = core::ptr::null_mut();
    if (ctx.aborting)
    goto finished;
    ctx.bufs_completed++;
...
#[no_mangle]
unsafe extern "C" fn __enum_fmt(f: *mut v4l2_fmtdesc, type: u32) -> c_int {
    static int __enum_fmt(struct v4l2_fmtdesc *f, u32 type)
    {
    int i, index;
    struct vpe_fmt *fmt = core::ptr::null_mut();
    index = 0;
...
#[no_mangle]
unsafe extern "C" fn vpe_g_fmt(file: *mut file, priv: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(!fmt->coplanar: pix->num_planes > 1 &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn vpe_try_fmt(file: *mut file, priv: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __vpe_s_fmt(ctx: *mut vpe_ctx, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_FIELD_SEQ_TB: qpix->field ==) -> else {
    else if (qpix.field == V4L2_FIELD_SEQ_TB)
    q_data.flags |= Q_DATA_INTERLACED_SEQ_TB;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_FIELD_SEQ_BT: qpix->field ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn vpe_s_fmt(file: *mut file, priv: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __vpe_try_selection(ctx: *mut vpe_ctx, s: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vpe_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vpe_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vpe_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn check_srcdst_sizes(ctx: *mut vpe_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vpe_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vpe_stop_streaming(q: *mut vb2_queue) {
...
//
#[no_mangle]
unsafe extern "C" fn vpe_open(file: *mut file) -> c_int {
    ...
    v4l2_ctrl_new_custom(hdl, &vpe_bufs_per_job, core::ptr::null_mut());
    if (hdl.error) {
    ret = hdl.error;
    goto exit_fh;
    }
...
#[no_mangle]
unsafe extern "C" fn vpe_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vpe_runtime_get(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vpe_runtime_put(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn vpe_fw_cb(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn vpe_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vpe_remove(pdev: *mut platform_device) {
