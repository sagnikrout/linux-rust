...
//! Source: drivers/media/platform/ti/j721e-csi2rx/j721e-csi2rx.c
#![no_std]
...
pub const SHIM_CNTL: c_uint = 0x10;

pub const SHIM_DMACNTX_YUV422_MODE_11: c_int = 3;
pub const SHIM_DMACNTX_SIZE_8: c_int = 0;
pub const SHIM_DMACNTX_SIZE_16: c_int = 1;
pub const SHIM_DMACNTX_SIZE_32: c_int = 2;

pub const TI_CSI2RX_MAX_PIX_PER_CLK: c_int = 4;
pub const TI_CSI2RX_MAX_CTX: c_int = 32;
//
...
pub const TI_CSI2RX_PAD_SINK: c_int = 0;
pub const TI_CSI2RX_PAD_FIRST_SOURCE: c_int = 1;

pub const DRAIN_TIMEOUT_MS: c_int = 50;

pub const CSI2RX_BRIDGE_SOURCE_PAD: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_csi2rx_fmt {
    pub /: *mut *mut u32 fourcc; / Four character code.,
    pub /: *mut *mut u32 code; / Mbus code.,
    pub /: *mut *mut u32 csi_dt; / CSI Data type.,
    pub /: *mut *mut u8 bpp; / Bits per pixel.,
    pub /: *mut *mut u8 size; / Data size shift when unpacking.,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_csi2rx_buffer {
// Common v4l2 buffer. Must be first.
    pub vb: vb2_v4l2_buffer,
    pub list: list_head,
    pub ctx: *mut ti_csi2rx_ctx,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_csi2rx_ctx {
    pub csi: *mut ti_csi2rx_dev,
    pub vdev: video_device,
    pub vidq: vb2_queue,
    pub /: *mut *mut mutex mutex; / To serialize ioctls.,
    pub v_fmt: v4l2_format,
    pub dma: ti_csi2rx_dma,
    pub pad: media_pad,
...
// Clamp width and height to sensible maximums (16K x 16K)
    ...
    {
    const struct ti_csi2rx_fmt *fmt = core::ptr::null_mut();
    if (f.mbus_code) {
...
#[no_mangle]
unsafe extern "C" fn csi_async_notifier_complete(notifier: *mut v4l2_async_notifier) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_notifier_register(csi: *mut ti_csi2rx_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_request_max_ppc(csi: *mut ti_csi2rx_dev) {
    static void ti_csi2rx_request_max_ppc(struct ti_csi2rx_dev *csi)
    {
    let mut ppc: u8 = TI_CSI2RX_MAX_PIX_PER_CLK;
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_setup_shim(ctx: *mut ti_csi2rx_ctx) {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_drain_callback(param: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_drain_dma(ctx: *mut ti_csi2rx_ctx) -> c_int {
    static int ti_csi2rx_drain_dma(struct ti_csi2rx_ctx *ctx)
    {
    struct ti_csi2rx_dev *csi = ctx.csi;
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_dma_submit_pending(ctx: *mut ti_csi2rx_ctx) -> c_int {
    static int ti_csi2rx_dma_submit_pending(struct ti_csi2rx_ctx *ctx)
    {
    struct ti_csi2rx_dma *dma = &ctx.dma;
    struct ti_csi2rx_buffer *buf;
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_dma_callback(param: *mut c_void) {
...
//
    ...
    unsigned long addr;
    struct dma_async_tx_descriptor *desc;
    let mut len: usize = ctx.v_fmt.fmt.pix.sizeimage;
    dma_cookie_t cookie;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_stop_dma(ctx: *mut ti_csi2rx_ctx) {
...
//
    ...
    let mut size: c_uint = ctx.v_fmt.fmt.pix.sizeimage;
    if (*nplanes) {
    if (sizes[0] < size)
    return -EINVAL;
    size = sizes[0];
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_buffer_prepare(vb: *mut vb2_buffer) -> c_int {
    static int ti_csi2rx_buffer_prepare(struct vb2_buffer *vb)
    {
    struct ti_csi2rx_ctx *ctx = vb2_get_drv_priv(vb.vb2_queue);
    let mut size: c_ulong = ctx.v_fmt.fmt.pix.sizeimage;
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_buffer_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_get_stream(ctx: *mut ti_csi2rx_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_get_vc_and_dt(ctx: *mut ti_csi2rx_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_cleanup_v4l2(csi: *mut ti_csi2rx_dev) {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_cleanup_notifier(csi: *mut ti_csi2rx_dev) {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_cleanup_ctx(ctx: *mut ti_csi2rx_ctx) {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_init_vb2q(ctx: *mut ti_csi2rx_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_link_validate(link: *mut media_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_init_dma(ctx: *mut ti_csi2rx_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_v4l2_init(csi: *mut ti_csi2rx_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_init_ctx(ctx: *mut ti_csi2rx_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_probe(pdev: *mut platform_device) -> c_int {
    static int ti_csi2rx_probe(struct platform_device *pdev)
    {
    struct device_node *np = pdev.dev.of_node;
    struct ti_csi2rx_dev *csi;
    let mut ret: c_int = 0, i, count;
...
#[no_mangle]
unsafe extern "C" fn ti_csi2rx_remove(pdev: *mut platform_device) {
