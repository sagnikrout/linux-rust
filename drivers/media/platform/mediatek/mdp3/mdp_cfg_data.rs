...
//! Source: drivers/media/platform/mediatek/mdp3/mdp_cfg_data.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mdp_cfg_get_id_inner(mdp_dev: *mut mdp_dev, id: enum mtk_mdp_comp_id) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn mdp_cfg_get_id_public(mdp_dev: *mut mdp_dev, inner_id: i32) -> enum mtk_mdp_comp_id {
    enum mtk_mdp_comp_id mdp_cfg_get_id_public(struct mdp_dev *mdp_dev, s32 inner_id)
    {
    let mut public_id: enum mtk_mdp_comp_id = MDP_COMP_NONE;
    u32 i;
...
#[no_mangle]
pub unsafe extern "C" fn mdp_cfg_comp_is_dummy(mdp_dev: *mut mdp_dev, inner_id: i32) -> bool {
    bool mdp_cfg_comp_is_dummy(struct mdp_dev *mdp_dev, s32 inner_id)
    {
    let mut id: enum mtk_mdp_comp_id = mdp_cfg_get_id_public(mdp_dev, inner_id);
    let mut type: enum mdp_comp_type = mdp_dev.mdp_data.comp_data[id].match.type;
