...
//! Source: drivers/media/platform/mediatek/vcodec/decoder/mtk_vcodec_dec_stateful.c
#![no_std]
...
pub const DEFAULT_OUT_FMT_IDX: c_int = 0;
pub const DEFAULT_CAP_FMT_IDX: c_int = 3;
//
...
//
    ...
    {
    struct vdec_fb *disp_frame_buffer = core::ptr::null_mut();
...
//
    ...
    {
    struct mtk_video_dec_buf *dstbuf;
    struct vdec_fb *free_frame_buffer = core::ptr::null_mut();
    struct vb2_v4l2_buffer *vb;
...
#[no_mangle]
unsafe extern "C" fn clean_display_buffer(ctx: *mut mtk_vcodec_dec_ctx) {
...
#[no_mangle]
unsafe extern "C" fn clean_free_buffer(ctx: *mut mtk_vcodec_dec_ctx) {
...
#[no_mangle]
unsafe extern "C" fn mtk_vdec_queue_res_chg_event(ctx: *mut mtk_vcodec_dec_ctx) {
...
unsafe extern "C" fn mtk_vdec_flush_decoder(ctx: *mut mtk_vcodec_dec_ctx) -> c_int {
    ...
    bool res_chg;
    int ret;
    ret = vdec_if_decode(ctx, core::ptr::null_mut(), core::ptr::null_mut(), &res_chg);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn mtk_vdec_pic_info_update(ctx: *mut mtk_vcodec_dec_ctx) -> c_int {
    static int mtk_vdec_pic_info_update(struct mtk_vcodec_dec_ctx *ctx)
    {
    let mut dpbsize: c_uint = 0;
    int ret;
...
// update dst buf status
    ...
    mutex_unlock(&ctx.lock);
    vdec_if_decode(ctx, core::ptr::null_mut(), core::ptr::null_mut(), &res_chg);
    clean_display_buffer(ctx);
    ...
    if (!buf.va) {
    v4l2_m2m_job_finish(dev.m2m_dev_dec, ctx.m2m_ctx);
    mtk_v4l2_vdec_err(ctx, "[%d] id=%d src_addr is core::ptr::null_mut()!!", ctx.id,
...
#[no_mangle]
unsafe extern "C" fn vb2ops_vdec_stateful_buf_queue(vb: *mut vb2_buffer) {
...
// This shouldn't happen. Just in case.
    ...
    ret = vdec_if_decode(ctx, &src_mem, core::ptr::null_mut(), &res_chg);
    if (ret || !res_chg) {
//
...
#[no_mangle]
unsafe extern "C" fn mtk_vdec_g_v_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
