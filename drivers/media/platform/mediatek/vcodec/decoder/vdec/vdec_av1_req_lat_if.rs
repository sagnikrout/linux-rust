...
//! Source: drivers/media/platform/mediatek/vcodec/decoder/vdec/vdec_av1_req_lat_if.c
#![no_std]
...
pub const AV1_TILE_BUF_SIZE: c_int = 64;
pub const AV1_SCALE_SUBPEL_BITS: c_int = 10;
pub const AV1_REF_SCALE_SHIFT: c_int = 14;

pub const AV1_CDF_TABLE_BUFFER_SIZE: c_int = 16384;
...
pub const MINQ: c_int = 0;
pub const MAXQ: c_int = 255;
...
pub const SEG_LVL_ALT_Q: c_int = 0;
pub const SECONDARY_FILTER_STRENGTH_NUM_BITS: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_init_vsi {
    pub architecture: u32,
    pub reserved: u32,
    pub core_vsi: u64,
    pub cdf_table_addr: u64,
    pub cdf_table_size: u32,
    pub iq_table_addr: u64,
    pub iq_table_size: u32,
    pub vsi_size: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_state {
    pub err: c_int,
    pub full: u32,
    pub timeout: u32,
    pub perf: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_tile_group {
    pub num_tiles: u32,
    pub tile_size: [u32; V4L2_AV1_MAX_TILE_COUNT],
    pub tile_start_offset: [u32; V4L2_AV1_MAX_TILE_COUNT],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_scale_factors {
    pub is_scaled: u8,
    pub x_scale: c_int,
    pub y_scale: c_int,
    pub x_step: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_frame_refs {
    pub ref_fb_idx: c_int,
    pub ref_map_idx: c_int,
    pub scale_factors: vdec_av1_slice_scale_factors,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_sm {
    pub skip_mode_allowed: u8,
    pub skip_mode_present: u8,
    pub skip_mode_frame: [c_int; 2],
}
...
pub struct vdec_av1_slice_seg {
    ...
    pub feature_data: [c_int; V4L2_AV1_MAX_SEGMENTS][V4L2_AV1_SEG_LVL_MAX],
    pub feature_enabled_mask: [u16; V4L2_AV1_MAX_SEGMENTS],
    pub segid_preskip: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_delta_q_lf {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_quantization {
    pub base_q_idx: c_int,
    pub qindex: [c_int; V4L2_AV1_MAX_SEGMENTS],
    pub delta_qydc: c_int,
    pub delta_qudc: c_int,
    pub delta_quac: c_int,
    pub delta_qvdc: c_int,
    pub delta_qvac: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_lr {
    pub use_lr: u8,
    pub use_chroma_lr: u8,
    pub frame_restoration_type: [u8; V4L2_AV1_NUM_PLANES_MAX],
    pub loop_restoration_size: [u32; V4L2_AV1_NUM_PLANES_MAX],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_loop_filter {
    pub loop_filter_level: [u8; 4],
    pub loop_filter_ref_deltas: [c_int; V4L2_AV1_TOTAL_REFS_PER_FRAME],
    pub loop_filter_mode_deltas: [c_int; 2],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_cdef {
    pub cdef_damping: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_mfmv {
    pub mfmv_valid_ref: [u32; 3],
    pub mfmv_dir: [u32; 3],
    pub mfmv_ref_to_cur: [c_int; 3],
    pub mfmv_ref_frame_idx: [c_int; 3],
    pub mfmv_count: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_tile {
    pub tile_cols: u8,
    pub tile_rows: u8,
    pub 1]: int mi_col_starts[V4L2_AV1_MAX_TILE_COLS +,
    pub 1]: int mi_row_starts[V4L2_AV1_MAX_TILE_ROWS +,
    pub context_update_tile_id: u8,
    pub uniform_tile_spacing_flag: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_uncompressed_header {
    pub use_ref_frame_mvs: u8,
    pub order_hint: c_int,
    pub gm: [vdec_av1_slice_gm; V4L2_AV1_TOTAL_REFS_PER_FRAME],
    ...
    pub skip_mode: vdec_av1_slice_sm,
    pub seg: vdec_av1_slice_seg,
    pub delta_q_lf: vdec_av1_slice_delta_q_lf,
    pub quant: vdec_av1_slice_quantization,
    pub lr: vdec_av1_slice_lr,
    pub superres_denom: u32,
    pub loop_filter: vdec_av1_slice_loop_filter,
    pub cdef: vdec_av1_slice_cdef,
    pub mfmv: vdec_av1_slice_mfmv,
    pub tile: vdec_av1_slice_tile,
    pub frame_is_intra: u8,
    pub loss_less_array: [u8; V4L2_AV1_MAX_SEGMENTS],
    pub coded_loss_less: u8,
    pub mi_rows: u32,
    pub mi_cols: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_seq_header {
    pub bitdepth: u8,
    pub enable_superres: u8,
    pub enable_filter_intra: u8,
    pub enable_intra_edge_filter: u8,
    pub enable_interintra_compound: u8,
    pub enable_masked_compound: u8,
    pub enable_dual_filter: u8,
    pub enable_jnt_comp: u8,
    pub mono_chrome: u8,
    pub enable_order_hint: u8,
    pub order_hint_bits: u8,
    pub use_128x128_superblock: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_frame {
    pub uh: vdec_av1_slice_uncompressed_header,
    pub seq: vdec_av1_slice_seq_header,
    pub large_scale_tile: u8,
    pub cur_ts: u64,
    pub prev_fb_idx: c_int,
    pub ref_frame_sign_bias: [u8; V4L2_AV1_TOTAL_REFS_PER_FRAME],
    pub order_hints: [u32; V4L2_AV1_REFS_PER_FRAME],
    pub ref_frame_valid: [u32; V4L2_AV1_REFS_PER_FRAME],
    pub ref_frame_map: [c_int; V4L2_AV1_TOTAL_REFS_PER_FRAME],
    pub frame_refs: [vdec_av1_slice_frame_refs; V4L2_AV1_REFS_PER_FRAME],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_work_buffer {
    pub mv_addr: vdec_av1_slice_mem,
    pub cdf_addr: vdec_av1_slice_mem,
    pub segid_addr: vdec_av1_slice_mem,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_frame_info {
    pub frame_type: u8,
    pub frame_is_intra: u8,
    pub order_hint: c_int,
    pub order_hints: [u32; V4L2_AV1_REFS_PER_FRAME],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_slot {
    pub frame_info: [vdec_av1_slice_frame_info; AV1_MAX_FRAME_BUF_COUNT],
    pub timestamp: [u64; AV1_MAX_FRAME_BUF_COUNT],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_fb {
    pub y: vdec_av1_slice_mem,
    pub c: vdec_av1_slice_mem,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_vsi {
// lat
    pub bs: vdec_av1_slice_mem,
    pub work_buffer: [vdec_av1_slice_work_buffer; AV1_MAX_FRAME_BUF_COUNT],
    pub cdf_table: vdec_av1_slice_mem,
    pub cdf_tmp: vdec_av1_slice_mem,
// LAT stage's output, Core stage's input
    pub rd_mv: vdec_av1_slice_mem,
    pub ube: vdec_av1_slice_mem,
    pub trans: vdec_av1_slice_mem,
    pub err_map: vdec_av1_slice_mem,
    pub row_info: vdec_av1_slice_mem,
// core
    pub fb: vdec_av1_slice_fb,
    pub ref: [vdec_av1_slice_fb; V4L2_AV1_REFS_PER_FRAME],
    pub iq_table: vdec_av1_slice_mem,
// lat and core share
    pub tile: vdec_av1_slice_mem,
    pub slots: vdec_av1_slice_slot,
    pub slot_id: i8,
    pub frame: vdec_av1_slice_frame,
    pub state: vdec_av1_slice_state,
    pub cur_lst_tile_id: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_pfc {
    pub vsi: vdec_av1_slice_vsi,
    pub ref_idx: [u64; V4L2_AV1_REFS_PER_FRAME],
    pub seq: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_av1_slice_instance {
    pub ctx: *mut mtk_vcodec_dec_ctx,
    pub vpu: vdec_vpu_inst,
    pub iq_table: mtk_vcodec_mem,
    pub cdf_table: mtk_vcodec_mem,
    pub mv: [mtk_vcodec_mem; AV1_MAX_FRAME_BUF_COUNT],
    pub cdf: [mtk_vcodec_mem; AV1_MAX_FRAME_BUF_COUNT],
    pub seg: [mtk_vcodec_mem; AV1_MAX_FRAME_BUF_COUNT],
    pub cdf_temp: mtk_vcodec_mem,
    pub tile: mtk_vcodec_mem,
    pub slots: vdec_av1_slice_slot,
    pub tile_group: vdec_av1_slice_tile_group,
// for resolution change and get_pic_info
    pub level: enum vdec_av1_slice_resolution_level,
    pub width: u32,
    pub height: u32,
    pub frame_type: u32,
    pub irq_enabled: u32,
    pub inneracing_mode: u32,
// MicroP vsi
    union {
    pub init_vsi: *mut vdec_av1_slice_init_vsi,
    pub vsi: *mut vdec_av1_slice_vsi,
}
...
#[no_mangle]
pub unsafe extern "C" fn vdec_av1_slice_get_msb(n: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_av1_slice_init_cdf_table(instance: *mut vdec_av1_slice_instance) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_av1_slice_init_iq_table(instance: *mut vdec_av1_slice_instance) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_av1_slice_get_new_slot(vsi: *mut vdec_av1_slice_vsi) -> c_int {
    static int vdec_av1_slice_get_new_slot(struct vdec_av1_slice_vsi *vsi)
    {
    struct vdec_av1_slice_slot *slots = &vsi.slots;
    let mut new_slot_idx: c_int = AV1_INVALID_IDX;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn vdec_av1_slice_clear_fb(frame_info: *mut vdec_av1_slice_frame_info) {
...
#[no_mangle]
unsafe extern "C" fn vdec_av1_slice_decrease_ref_count(slots: *mut vdec_av1_slice_slot, fb_idx: c_int) {
    ...
    let mut timestamp: u64 = slots.timestamp[slot_id];
    let mut ref_used: bool = false;
...
// ensure current frame is properly mapped if referenced
    for (ref_id = 0; ref_id < V4L2_AV1_TOTAL_REFS_PER_FRAME; ref_id++) {
    let mut timestamp: u64 = vsi.slots.timestamp[vsi.slot_id];
    if (ctrl_fh.reference_frame_ts[ref_id] == timestamp)
...
#[no_mangle]
unsafe extern "C" fn vdec_av1_slice_free_working_buffer(instance: *mut vdec_av1_slice_instance) {
...
#[no_mangle]
unsafe extern "C" fn vdec_av1_slice_resolve_divisor_32(D: u32, shift: *mut c_short) -> c_short {
...
#[no_mangle]
unsafe extern "C" fn vdec_av1_slice_get_shear_params(gm_params: *mut vdec_av1_slice_gm) {
    ...
    let mut mib_size_log2: u32 = seq.use_128x128_superblock ? 5 : 4;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn vdec_av1_slice_setup_state(vsi: *mut vdec_av1_slice_vsi) {
    ...
    let mut ref_upscaled_width: u32 = ref_frame_info.upscaled_width;
    let mut ref_frame_height: u32 = ref_frame_info.frame_height;
    let mut frame_width: u32 = uh.frame_width;
    let mut frame_height: u32 = uh.frame_height;
    ...
    let mut ref_idx: c_int = ctrl_fh.ref_frame_idx[i];
...
#[no_mangle]
unsafe extern "C" fn vdec_av1_slice_get_previous(vsi: *mut vdec_av1_slice_vsi) {
...
// reset segment buffer
    ...
    let mut allow_update_cdf: u32 = 0;
    let mut sb_boundary_x_m1: u32 = 0, sb_boundary_y_m1 = 0;
    int tile_info_base;
    u64 tile_buf_pa;
    u32 *tile_info_buf = instance.tile.va;
    let mut pa: u64 = (u64)bs.dma_addr;
...
#[no_mangle]
unsafe extern "C" fn vdec_av1_slice_init(ctx: *mut mtk_vcodec_dec_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_av1_slice_deinit(h_vdec: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn vdec_av1_slice_get_pic_info(instance: *mut vdec_av1_slice_instance) {
...
#[no_mangle]
unsafe extern "C" fn vdec_av1_slice_get_param(h_vdec: *mut c_void, type: enum vdec_get_param_type, out: *mut c_void) -> c_int {
...
// bs NULL means flush decoder
    ...
    ret = vpu_dec_start(&instance.vpu, core::ptr::null_mut(), 0);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn vdec_av1_slice_core_decode(lat_buf: *mut vdec_lat_buf) -> c_int {
    static int vdec_av1_slice_core_decode(struct vdec_lat_buf *lat_buf)
    {
    struct vdec_av1_slice_instance *instance;
    struct vdec_av1_slice_pfc *pfc;
    struct mtk_vcodec_dec_ctx *ctx = core::ptr::null_mut();
