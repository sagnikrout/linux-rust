...
//! Source: drivers/media/platform/mediatek/vcodec/decoder/vdec/vdec_hevc_req_multi_if.c
#![no_std]
...
pub const HEVC_MAX_MV_NUM: c_int = 32;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_hevc_sps_param {
    pub video_parameter_set_id: c_uchar,
    pub seq_parameter_set_id: c_uchar,
    pub pic_width_in_luma_samples: c_ushort,
    pub pic_height_in_luma_samples: c_ushort,
    pub bit_depth_luma_minus8: c_uchar,
    pub bit_depth_chroma_minus8: c_uchar,
    pub log2_max_pic_order_cnt_lsb_minus4: c_uchar,
    pub sps_max_dec_pic_buffering_minus1: c_uchar,
    pub sps_max_num_reorder_pics: c_uchar,
    pub sps_max_latency_increase_plus1: c_uchar,
    pub log2_min_luma_coding_block_size_minus3: c_uchar,
    pub log2_diff_max_min_luma_coding_block_size: c_uchar,
    pub log2_min_luma_transform_block_size_minus2: c_uchar,
    pub log2_diff_max_min_luma_transform_block_size: c_uchar,
    ...
    pub sps_max_sub_layers_minus1: c_uchar,
    pub separate_colour_plane: c_uchar,
    pub scaling_list_enabled: c_uchar,
    pub amp_enabled: c_uchar,
    pub sample_adaptive_offset: c_uchar,
    pub pcm_enabled: c_uchar,
    pub pcm_loop_filter_disabled: c_uchar,
    pub long_term_ref_pics_enabled: c_uchar,
    pub sps_temporal_mvp_enabled: c_uchar,
    pub strong_intra_smoothing_enabled: c_uchar,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_hevc_pps_param {
    pub pic_parameter_set_id: c_uchar,
    ...
    pub column_width_minus1: [c_uchar; 20],
    pub row_height_minus1: [c_uchar; 22],
    pub pps_beta_offset_div2: c_char,
    pub pps_tc_offset_div2: c_char,
    pub log2_parallel_merge_level_minus2: c_uchar,
    pub dependent_slice_segment_enabled: c_char,
    pub output_flag_present: c_char,
    pub sign_data_hiding_enabled: c_char,
    pub cabac_init_present: c_char,
    pub constrained_intra_pred: c_char,
    pub transform_skip_enabled: c_char,
    pub cu_qp_delta_enabled: c_char,
    pub pps_slice_chroma_qp_offsets_present: c_char,
    pub weighted_pred: c_char,
    pub weighted_bipred: c_char,
    pub transquant_bypass_enabled: c_char,
    pub pps_flag_tiles_enabled: c_char,
    pub entropy_coding_sync_enabled: c_char,
    pub loop_filter_across_tiles_enabled: c_char,
    pub pps_loop_filter_across_slices_enabled: c_char,
    pub deblocking_filter_override_enabled: c_char,
    pub pps_disable_deflocking_filter: c_char,
    pub lists_modification_present: c_char,
    pub slice_segment_header_extersion_present: c_char,
    pub deblocking_filter_control_present: c_char,
    pub uniform_spacing: c_char,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_hevc_slice_header_param {
    pub slice_type: c_uint,
    pub num_active_ref_layer_pics: c_uint,
    pub slice_qp: c_int,
    pub slice_qp_delta_cb: c_int,
    pub slice_qp_delta_cr: c_int,
    pub num_ref_idx: [c_int; 3],
    pub col_ref_idx: c_uint,
    pub five_minus_max_num_merge_cand: c_uint,
    pub slice_deblocking_filter_beta_offset_div2: c_int,
    pub slice_deblocking_filter_tc_offset_div2: c_int,
    pub sao_enable_flag: c_uchar,
    pub sao_enable_flag_chroma: c_uchar,
    pub cabac_init_flag: c_uchar,
    pub slice_tmvp_flags_present: c_uchar,
    pub col_from_l0_flag: c_uchar,
    pub mvd_l1_zero_flag: c_uchar,
    pub slice_loop_filter_across_slices_enabled_flag: c_uchar,
    pub deblocking_filter_disable_flag: c_uchar,
    pub slice_reg0: c_uint,
    pub slice_reg1: c_uint,
    pub slice_reg2: c_uint,
    pub num_rps_curr_temp_list: c_uint,
    pub ref_list_mode: c_uint,
    pub str_num_delta_pocs: c_int,
    pub str_num_negtive_pos_pics: c_int,
    pub num_long_term: c_int,
    pub num_long_term_sps: c_int,
    pub max_cu_width: c_uint,
    pub max_cu_height: c_uint,
    pub num_entry_point_offsets: c_uint,
    pub last_lcu_x_in_tile: [c_uint; 17],
    pub last_lcu_y_in_tile: [c_uint; 17],
    pub nal_unit_type: c_uchar,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct slice_api_hevc_scaling_matrix {
    pub scaling_list_4x4: [c_uchar; 6][16],
    pub scaling_list_8x8: [c_uchar; 6][64],
    pub scaling_list_16x16: [c_uchar; 6][64],
    pub scaling_list_32x32: [c_uchar; 2][64],
    pub scaling_list_dc_coef_16x16: [c_uchar; 6],
    pub scaling_list_dc_coef_32x32: [c_uchar; 2],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct slice_hevc_dpb_entry {
    pub timestamp: u64,
    pub flags: c_uchar,
    pub field_pic: c_uchar,
    pub pic_order_cnt_val: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct slice_api_hevc_decode_param {
    pub dpb: [slice_hevc_dpb_entry; V4L2_HEVC_DPB_ENTRIES_NUM_MAX],
    pub pic_order_cnt_val: c_int,
    pub short_term_ref_pic_set_size: c_ushort,
    pub long_term_ref_pic_set_size: c_ushort,
    pub num_active_dpb_entries: c_uchar,
    pub num_poc_st_curr_before: c_uchar,
    pub num_poc_st_curr_after: c_uchar,
    pub num_poc_lt_curr: c_uchar,
    pub poc_st_curr_before: [c_uchar; V4L2_HEVC_DPB_ENTRIES_NUM_MAX],
    pub poc_st_curr_after: [c_uchar; V4L2_HEVC_DPB_ENTRIES_NUM_MAX],
    pub poc_lt_curr: [c_uchar; V4L2_HEVC_DPB_ENTRIES_NUM_MAX],
    pub num_delta_pocs_of_ref_rps_idx: c_uchar,
    pub flags: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_hevc_slice_lat_dec_param {
    pub sps: mtk_hevc_sps_param,
    pub pps: mtk_hevc_pps_param,
    pub slice_header: mtk_hevc_slice_header_param,
    pub scaling_matrix: slice_api_hevc_scaling_matrix,
    pub decode_params: slice_api_hevc_decode_param,
    pub hevc_dpb_info: [mtk_hevc_dpb_info; V4L2_HEVC_DPB_ENTRIES_NUM_MAX],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_hevc_slice_info {
    pub wdma_end_addr_offset: u64,
    pub timeout: u64,
    pub vdec_fb_va: u64,
    pub crc: [u32; 8],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_hevc_slice_mem {
    union {
    pub buf: u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_hevc_slice_fb {
    pub y: vdec_hevc_slice_mem,
    pub c: vdec_hevc_slice_mem,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_hevc_slice_vsi {
// used in LAT stage
    pub bs: vdec_hevc_slice_mem,
    pub ube: vdec_hevc_slice_mem,
    pub trans: vdec_hevc_slice_mem,
    pub err_map: vdec_hevc_slice_mem,
    pub slice_bc: vdec_hevc_slice_mem,
    pub wrap: vdec_hevc_slice_mem,
    pub fb: vdec_hevc_slice_fb,
    pub mv_buf_dma: [vdec_hevc_slice_mem; HEVC_MAX_MV_NUM],
    pub dec: vdec_hevc_slice_info,
    pub hevc_slice_params: vdec_hevc_slice_lat_dec_param,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_hevc_slice_share_info {
    pub sps: v4l2_ctrl_hevc_sps,
    pub dec_params: v4l2_ctrl_hevc_decode_params,
    pub hevc_slice_params: vdec_hevc_slice_lat_dec_param,
    pub trans: vdec_hevc_slice_mem,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_hevc_slice_inst {
    pub slice_dec_num: c_uint,
    pub ctx: *mut mtk_vcodec_dec_ctx,
    pub mv_buf: [mtk_vcodec_mem; HEVC_MAX_MV_NUM],
    pub vpu: vdec_vpu_inst,
    pub vsi: *mut vdec_hevc_slice_vsi,
    pub vsi_core: *mut vdec_hevc_slice_vsi,
    pub wrap_addr: mtk_vcodec_mem,
    pub hevc_slice_param: vdec_hevc_slice_lat_dec_param,
    pub resolution_changed: c_uint,
    pub realloc_mv_buf: c_uint,
    pub cap_num_planes: c_uint,
}

#[no_mangle]
unsafe extern "C" fn vdec_hevc_get_mv_buf_size(width: c_uint, height: c_uint) -> c_uint {
    static unsigned int vdec_hevc_get_mv_buf_size(unsigned int width, unsigned int height)
    {
    let mut unit_size: c_uint = (width / 16) * (height / 16) + 8;
    return 64 * unit_size;
    }
    ...
    {
    let mut buf_sz: c_uint = vdec_hevc_get_mv_buf_size(pic.buf_w, pic.buf_h);
...
#[no_mangle]
unsafe extern "C" fn vdec_hevc_slice_free_mv_buf(inst: *mut vdec_hevc_slice_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_hevc_slice_get_pic_info(inst: *mut vdec_hevc_slice_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_hevc_slice_init(ctx: *mut mtk_vcodec_dec_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_hevc_slice_deinit(h_vdec: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn vdec_hevc_slice_core_decode(lat_buf: *mut vdec_lat_buf) -> c_int {
