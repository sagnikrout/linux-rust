...
//! Source: drivers/media/platform/mediatek/vcodec/decoder/vdec/vdec_vp9_req_lat_if.c
#![no_std]
...
pub const VP9_RESET_FRAME_CONTEXT_NONE0: c_int = 0;
pub const VP9_RESET_FRAME_CONTEXT_NONE1: c_int = 1;
pub const VP9_RESET_FRAME_CONTEXT_SPEC: c_int = 2;
pub const VP9_RESET_FRAME_CONTEXT_ALL: c_int = 3;
pub const VP9_TILE_BUF_SIZE: c_int = 4096;
pub const VP9_PROB_BUF_SIZE: c_int = 2560;
pub const VP9_COUNTS_BUF_SIZE: c_int = 16384;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_vp9_slice_frame_ctx {
    struct {
    pub probs: [u8; 6][3],
    pub padding: [u8; 2],
    pub coef_probs: [}; 4][2][2][6],
    pub y_mode_prob: [u8; 4][16],
    pub switch_interp_prob: [u8; 4][16],
    pub /: *mut *mut u8 seg[32]; / ignore,
    pub comp_inter_prob: [u8; 16],
    pub comp_ref_prob: [u8; 16],
    pub single_ref_prob: [u8; 5][2],
    pub single_ref_prob_padding: [u8; 6],
    pub joint: [u8; 3],
    pub joint_padding: [u8; 13],
    struct {
    pub sign: u8,
    pub classes: [u8; 10],
    pub padding: [u8; 5],
    ...
    pub class0_bits: [}; 2],
    struct {
    pub class0_fp: [u8; 2][3],
    pub fp: [u8; 3],
    pub class0_hp: u8,
    pub hp: u8,
    pub padding: [u8; 5],
    pub class0_fp_hp: [}; 2],
    pub uv_mode_prob: [u8; 10][16],
    pub uv_mode_prob_padding: [u8; 2][16],
    pub partition_prob: [u8; 16][4],
    pub inter_mode_probs: [u8; 7][4],
    pub skip_probs: [u8; 4],
    pub tx_p8x8: [u8; 2][4],
    pub tx_p16x16: [u8; 2][4],
    pub tx_p32x32: [u8; 2][4],
    pub intra_inter_prob: [u8; 8],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_vp9_slice_frame_counts {
    union {
    struct {
    pub band_0: [u32; 3],
    pub padding0: [u32; 1],
    pub band_1_5: [u32; 5][6],
    pub padding1: [u32; 2],
    pub eob_branch: [}; 4][2][2],
    pub 4]: *mut *mut u32 eob_branch_space[256,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_vp9_slice_counts_map {
    pub skip: [u32; 3][2],
    pub y_mode: [u32; 4][10],
    pub filter: [u32; 4][3],
    pub sign: [u32; 2][2],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_vp9_slice_uncompressed_header {
    pub profile: u8,
    pub last_frame_type: u8,
    pub frame_type: u8,
    pub last_show_frame: u8,
    pub show_frame: u8,
...
// segmentation_params
    ...
    pub padding1: [u8; 1],
    pub segmentation_temporal_udpate: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_vp9_slice_compressed_header {
    pub tx_mode: u8,
    pub ref_mode: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_vp9_slice_tiles {
    pub size: [u32; 4][64],
    pub mi_rows: [u32; 4],
    pub mi_cols: [u32; 64],
    pub actual_rows: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_vp9_slice_reference {
    pub frame_width: u16,
    pub frame_height: u16,
    pub bit_depth: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_vp9_slice_frame {
    pub uh: vdec_vp9_slice_uncompressed_header,
    pub ch: vdec_vp9_slice_compressed_header,
    pub tiles: vdec_vp9_slice_tiles,
    pub ref: [vdec_vp9_slice_reference; 3],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_vp9_slice_bs {
    pub buf: vdec_vp9_slice_mem,
    pub frame: vdec_vp9_slice_mem,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_vp9_slice_fb {
    pub y: vdec_vp9_slice_mem,
    pub c: vdec_vp9_slice_mem,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_vp9_slice_state {
    pub err: c_int,
    pub full: c_uint,
    pub timeout: c_uint,
    pub perf: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_vp9_slice_vsi {
// used in LAT stage
    pub bs: vdec_vp9_slice_bs,
// used in Core stage
    pub fb: vdec_vp9_slice_fb,
    pub ref: [vdec_vp9_slice_fb; 3],
    pub mv: [vdec_vp9_slice_mem; 2],
    pub seg: [vdec_vp9_slice_mem; 2],
    pub tile: vdec_vp9_slice_mem,
    pub prob: vdec_vp9_slice_mem,
    pub counts: vdec_vp9_slice_mem,
// LAT stage's output, Core stage's input
    pub ube: vdec_vp9_slice_mem,
    pub trans: vdec_vp9_slice_mem,
    pub err_map: vdec_vp9_slice_mem,
    pub row_info: vdec_vp9_slice_mem,
// decoding parameters
    pub frame: vdec_vp9_slice_frame,
    pub state: vdec_vp9_slice_state,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_vp9_slice_pfc {
    pub vsi: vdec_vp9_slice_vsi,
    pub ref_idx: [u64; 3],
    pub seq: c_int,
// LAT/Core CRC
    pub state: [vdec_vp9_slice_state; 2],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_vp9_slice_instance {
    pub ctx: *mut mtk_vcodec_dec_ctx,
    pub vpu: vdec_vpu_inst,
    pub seq: c_int,
    pub level: enum vdec_vp9_slice_resolution_level,
...
// maintain vp9 reference frame state
    pub dpb: [vdec_vp9_slice_ref; VB2_MAX_FRAME],
//
// normal working buffers
// mv[0]/seg[0]/tile/prob/counts is used for LAT
// mv[1]/seg[1] is used for CORE
//
    pub mv: [mtk_vcodec_mem; 2],
    pub seg: [mtk_vcodec_mem; 2],
    pub tile: mtk_vcodec_mem,
    pub prob: mtk_vcodec_mem,
    pub counts: mtk_vcodec_mem,
// 4 prob tables
    pub frame_ctx: [vdec_vp9_slice_frame_ctx; 4],
// 4 helper tables
    pub frame_ctx_helper: v4l2_vp9_frame_context,
    pub dirty: [c_uchar; 4],
// MicroP vsi
    union {
    pub init_vsi: *mut vdec_vp9_slice_init_vsi,
    pub vsi: *mut vdec_vp9_slice_vsi,
}
...
#[no_mangle]
unsafe extern "C" fn vdec_vp9_slice_init_default_frame_ctx(instance: *mut vdec_vp9_slice_instance) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_vp9_slice_free_working_buffer(instance: *mut vdec_vp9_slice_instance) {
...
#[no_mangle]
unsafe extern "C" fn vdec_vp9_slice_tile_offset(idx: c_int, mi_num: c_int, tile_log2: c_int) -> c_int {
    static int vdec_vp9_slice_tile_offset(int idx, int mi_num, int tile_log2)
    {
    let mut sbs: c_int = (mi_num + 7) >> 3;
    let mut offset: c_int = ((idx * sbs) >> tile_log2) << 3;
    return min(offset, mi_num);
    }
    static
#[no_mangle]
pub unsafe extern "C" fn vdec_vp9_slice_setup_single_from_src_to_dst(instance: *mut vdec_vp9_slice_instance) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_vp9_slice_setup_state(vsi: *mut vdec_vp9_slice_vsi) {
...
//
    ...
    vsi.row_info.buf = 0;
    vsi.row_info.size = 0;
    vdec_vp9_slice_setup_core_buffer(instance, pfc, vsi, fb, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn vdec_vp9_slice_init(ctx: *mut mtk_vcodec_dec_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_vp9_slice_deinit(h_vdec: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn vdec_vp9_slice_get_pic_info(instance: *mut vdec_vp9_slice_instance) {
...
#[no_mangle]
unsafe extern "C" fn vdec_vp9_slice_get_param(h_vdec: *mut c_void, type: enum vdec_get_param_type, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_vp9_slice_core_decode(lat_buf: *mut vdec_lat_buf) -> c_int {
    static int vdec_vp9_slice_core_decode(struct vdec_lat_buf *lat_buf)
    {
    struct vdec_vp9_slice_instance *instance;
    struct vdec_vp9_slice_pfc *pfc;
