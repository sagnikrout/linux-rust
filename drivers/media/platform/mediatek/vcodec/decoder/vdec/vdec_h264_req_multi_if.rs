...
//! Source: drivers/media/platform/mediatek/vcodec/decoder/vdec/vdec_h264_req_multi_if.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_h264_slice_info {
    pub nal_info: u16,
    pub timeout: u16,
    pub bs_buf_size: u32,
    pub bs_buf_addr: u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_h264_slice_vsi {
// LAT dec addr
    pub wdma_err_addr: u64,
    pub wdma_start_addr: u64,
    pub wdma_end_addr: u64,
    pub slice_bc_start_addr: u64,
    pub slice_bc_end_addr: u64,
    pub row_info_start_addr: u64,
    pub row_info_end_addr: u64,
    pub trans_start: u64,
    pub trans_end: u64,
    pub wdma_end_addr_offset: u64,
    pub mv_buf_dma: [u64; H264_MAX_MV_NUM],
    pub dec: vdec_h264_slice_info,
    pub h264_slice_params: vdec_h264_slice_lat_dec_param,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_h264_slice_share_info {
    pub sps: v4l2_ctrl_h264_sps,
    pub dec_params: v4l2_ctrl_h264_decode_params,
    pub h264_slice_params: vdec_h264_slice_lat_dec_param,
    pub trans_start: u64,
    pub trans_end: u64,
    pub nal_info: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_h264_slice_mem {
    union {
    pub buf: u64,
    pub dma_addr: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_h264_slice_fb {
    pub y: vdec_h264_slice_mem,
    pub c: vdec_h264_slice_mem,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_h264_slice_info_ext {
    pub wdma_end_addr_offset: u64,
    pub nal_info: u16,
    pub timeout: u16,
    pub reserved: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_h264_slice_vsi_ext {
// LAT dec addr
    pub bs: vdec_h264_slice_mem,
    pub fb: vdec_h264_slice_fb,
    pub ube: vdec_h264_slice_mem,
    pub trans: vdec_h264_slice_mem,
    pub row_info: vdec_h264_slice_mem,
    pub err_map: vdec_h264_slice_mem,
    pub slice_bc: vdec_h264_slice_mem,
    pub mv_buf_dma: [vdec_h264_slice_mem; H264_MAX_MV_NUM],
    pub dec: vdec_h264_slice_info_ext,
    pub h264_slice_params: vdec_h264_slice_lat_dec_param,
}
...
pub struct vdec_h264_slice_inst {
    ...
    union {
    struct {
    pub vsi: *mut vdec_h264_slice_vsi,
    pub vsi_core: *mut vdec_h264_slice_vsi,
    pub vsi_ctx: vdec_h264_slice_vsi,
}
...
#[no_mangle]
unsafe extern "C" fn get_vdec_sig_decode_parameters(inst: *mut vdec_h264_slice_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_h264_slice_free_mv_buf(inst: *mut vdec_h264_slice_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_h264_slice_get_pic_info(inst: *mut vdec_h264_slice_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_h264_slice_core_decode_ext(lat_buf: *mut vdec_lat_buf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_h264_slice_core_decode(lat_buf: *mut vdec_lat_buf) -> c_int {
