...
//! Source: drivers/media/platform/mediatek/vcodec/encoder/venc/venc_vp8_if.c
#![no_std]
...
pub const VENC_BITSTREAM_FRAME_SIZE: c_uint = 0x0098;
pub const VENC_BITSTREAM_HEADER_LEN: c_uint = 0x00e8;
// This ac_tag is vp8 frame tag.
pub const MAX_AC_TAG_SIZE: c_int = 10;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct venc_vp8_vpu_config {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct venc_vp8_vsi {
    pub config: venc_vp8_vpu_config,
    pub work_bufs: [venc_vp8_vpu_buf; VENC_VP8_VPU_WORK_BUF_MAX],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct venc_vp8_inst {
    pub hw_base: *mut void __iomem,
    pub work_bufs: [mtk_vcodec_mem; VENC_VP8_VPU_WORK_BUF_MAX],
    pub work_buf_allocated: bool,
    pub frm_cnt: c_uint,
    pub ts_mode: c_uint,
    pub vpu_inst: venc_vpu_inst,
    pub vsi: *mut venc_vp8_vsi,
    pub ctx: *mut mtk_vcodec_enc_ctx,
}

#[no_mangle]
pub unsafe extern "C" fn vp8_enc_read_reg(inst: *mut venc_vp8_inst, addr: u32) -> u32 {
    static inline u32 vp8_enc_read_reg(struct venc_vp8_inst *inst, u32 addr)
    {
    return readl(inst.hw_base + addr);
    }
#[no_mangle]
unsafe extern "C" fn vp8_enc_free_work_buf(inst: *mut venc_vp8_inst) {
...
#[no_mangle]
unsafe extern "C" fn vp8_enc_alloc_work_buf(inst: *mut venc_vp8_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vp8_enc_wait_venc_done(inst: *mut venc_vp8_inst) -> c_uint {
...
// bs_size = bs_frm_size + bs_hdr_len + ac_tag_size;
    ...
    ret = vpu_enc_encode(&inst.vpu_inst, 0, frm_buf, bs_buf, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn vp8_enc_init(ctx: *mut mtk_vcodec_enc_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vp8_enc_deinit(handle: *mut c_void) -> c_int {
