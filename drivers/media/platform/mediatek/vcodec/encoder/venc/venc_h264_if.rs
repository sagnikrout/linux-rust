...
//! Source: drivers/media/platform/mediatek/vcodec/encoder/venc/venc_h264_if.c
#![no_std]
...
pub const VENC_PIC_BITSTREAM_BYTE_CNT: c_uint = 0x0098;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct venc_h264_vpu_config {
    pub input_fourcc: u32,
    pub bitrate: u32,
    pub pic_w: u32,
    pub pic_h: u32,
    pub buf_w: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct venc_h264_vsi {
    pub config: venc_h264_vpu_config,
    pub work_bufs: [venc_h264_vpu_buf; VENC_H264_VPU_WORK_BUF_MAX],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct venc_h264_vpu_config_ext {
    pub input_fourcc: u32,
    pub bitrate: u32,
    pub pic_w: u32,
    pub pic_h: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct venc_h264_vpu_buf_34 {
    pub iova: u64,
    pub vpua: u32,
    pub size: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct venc_h264_vsi_34 {
    pub config: venc_h264_vpu_config_ext,
    pub work_bufs: [venc_h264_vpu_buf_34; VENC_H264_VPU_WORK_BUF_MAX],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct venc_h264_inst {
    pub hw_base: *mut void __iomem,
    pub work_bufs: [mtk_vcodec_mem; VENC_H264_VPU_WORK_BUF_MAX],
    pub pps_buf: mtk_vcodec_mem,
    pub work_buf_allocated: bool,
    pub frm_cnt: c_uint,
    pub skip_frm_cnt: c_uint,
    pub prepend_hdr: c_uint,
    pub vpu_inst: venc_vpu_inst,
    pub vsi: *mut venc_h264_vsi,
    pub vsi_34: *mut venc_h264_vsi_34,
    pub ctx: *mut mtk_vcodec_enc_ctx,
}

#[no_mangle]
pub unsafe extern "C" fn h264_read_reg(inst: *mut venc_h264_inst, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn h264_enc_free_work_buf(inst: *mut venc_h264_inst) {
...
#[no_mangle]
unsafe extern "C" fn h264_enc_alloc_work_buf(inst: *mut venc_h264_inst, is_34bit: bool) -> c_int {
    static int h264_enc_alloc_work_buf(struct venc_h264_inst *inst, bool is_34bit)
    {
    struct venc_h264_vpu_buf *wb = core::ptr::null_mut();
    struct venc_h264_vpu_buf_34 *wb_34 = core::ptr::null_mut();
    int i;
    u32 vpua, wb_size;
    let mut ret: c_int = 0;
    if (is_34bit)
...
#[no_mangle]
unsafe extern "C" fn h264_enc_wait_venc_done(inst: *mut venc_h264_inst) -> c_uint {
...
// I frame
    ...
    ret = vpu_enc_encode(&inst.vpu_inst, H264_BS_MODE_SPS, core::ptr::null_mut(), bs_buf, core::ptr::null_mut());
    if (ret)
    return ret;
...
// bs_size = h264_read_reg(inst, VENC_PIC_BITSTREAM_BYTE_CNT);
    ...
    let mut ret: c_int = 0;
    unsigned int irq_status;
    ret = vpu_enc_encode(&inst.vpu_inst, H264_BS_MODE_PPS, core::ptr::null_mut(), bs_buf, core::ptr::null_mut());
    if (ret)
    return ret;
    irq_status = h264_enc_wait_venc_done(inst);
...
#[no_mangle]
unsafe extern "C" fn h264_enc_init(ctx: *mut mtk_vcodec_enc_ctx) -> c_int {
    static int h264_enc_init(struct mtk_vcodec_enc_ctx *ctx)
    {
    let mut is_ext: bool = MTK_ENC_CTX_IS_EXT(ctx);
    let mut ret: c_int = 0;
    ...
    int hdr_sz;
    int hdr_sz_ext;
    let mut filler_sz: c_int = 0;
    let mut bs_alignment: c_int = 128;
    ...
    struct venc_h264_inst *inst = (struct venc_h264_inst *)handle;
    struct mtk_vcodec_enc_ctx *ctx = inst.ctx;
    let mut is_34bit: bool = MTK_ENC_IOVA_IS_34BIT(ctx);
...
#[no_mangle]
unsafe extern "C" fn h264_enc_deinit(handle: *mut c_void) -> c_int {
