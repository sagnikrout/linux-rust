...
//! Source: drivers/media/platform/amlogic/c3/mipi-adapter/c3-mipi-adap.c
#![no_std]
...
pub const ADAP_SUBMD_SHIFT: c_int = 16;

pub const MIPI_ADAP_CLOCK_NUM_MAX: c_int = 3;
...
pub const MIPI_ADAP_MAX_WIDTH: c_int = 2888;
pub const MIPI_ADAP_MIN_WIDTH: c_int = 160;
pub const MIPI_ADAP_MAX_HEIGHT: c_int = 2240;
pub const MIPI_ADAP_MIN_HEIGHT: c_int = 120;
pub const MIPI_ADAP_DEFAULT_WIDTH: c_int = 1920;
pub const MIPI_ADAP_DEFAULT_HEIGHT: c_int = 1080;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct c3_adap_info {
    pub clocks: [*mut c_char; MIPI_ADAP_CLOCK_NUM_MAX],
    pub clock_num: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct c3_adap_device {
    pub dev: *mut device,
    pub top: *mut void __iomem,
    pub fd: *mut void __iomem,
    pub rd: *mut void __iomem,
    pub clks: [clk_bulk_data; MIPI_ADAP_CLOCK_NUM_MAX],
    pub sd: v4l2_subdev,
    pub pads: [media_pad; C3_MIPI_ADAP_PAD_MAX],
    pub notifier: v4l2_async_notifier,
    pub src_pad: *mut media_pad,
    pub info: *const c3_adap_info,
}

// Format helpers
#[repr(C)]
#[derive(Copy, Clone)]
pub struct c3_adap_pix_format {
    pub code: u32,
    pub type: u8,
}
...
#[no_mangle]
unsafe extern "C" fn c3_mipi_adap_cfg_top(adap: *mut c3_adap_device) {
...
#[no_mangle]
unsafe extern "C" fn c3_mipi_adap_cfg_rd0(adap: *mut c3_adap_device) {
...
// V4L2 subdev operations
    ...
    adap.src_pad = core::ptr::null_mut();
    pm_runtime_put(adap.dev);
    return 0;
    }
...
// PM runtime
#[no_mangle]
unsafe extern "C" fn c3_mipi_adap_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c3_mipi_adap_runtime_resume(dev: *mut device) -> c_int {
    ...
    c3_mipi_adap_runtime_resume, core::ptr::null_mut())
    };
// Probe/remove & platform driver
#[no_mangle]
unsafe extern "C" fn c3_mipi_adap_subdev_init(adap: *mut c3_adap_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c3_mipi_adap_subdev_deinit(adap: *mut c3_adap_device) {
...
#[no_mangle]
unsafe extern "C" fn c3_mipi_adap_async_register(adap: *mut c3_adap_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c3_mipi_adap_async_unregister(adap: *mut c3_adap_device) {
...
#[no_mangle]
unsafe extern "C" fn c3_mipi_adap_ioremap_resource(adap: *mut c3_adap_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c3_mipi_adap_get_clocks(adap: *mut c3_adap_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c3_mipi_adap_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c3_mipi_adap_remove(pdev: *mut platform_device) {
