...
//! Source: drivers/media/platform/amlogic/c3/isp/c3-isp-core.c
#![no_std]
...
pub const C3_ISP_PHASE_OFFSET_0: c_int = 0;
pub const C3_ISP_PHASE_OFFSET_1: c_int = 1;
pub const C3_ISP_PHASE_OFFSET_NONE: c_uint = 0xff;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct c3_isp_core_format_info {
    pub mbus_code: u32,
    pub pads: u32,
    pub xofst: u8,
    pub yofst: u8,
...
#[no_mangle]
unsafe extern "C" fn c3_isp_core_enable(isp: *mut c3_isp_device) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_core_disable(isp: *mut c3_isp_device) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_core_streams_ready(core: *mut c3_isp_core) -> bool {
    static bool c3_isp_core_streams_ready(struct c3_isp_core *core)
    {
    let mut n_links: c_uint = 0;
    ...
    let mut n_links: return = = core.isp.pipe.start_count;
    }
    ...
    core.src_pad = core::ptr::null_mut();
    c3_isp_core_disable(core.isp);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn c3_isp_core_link_validate(link: *mut media_link) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_core_queue_sof(isp: *mut c3_isp_device) {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_core_register(isp: *mut c3_isp_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_core_unregister(isp: *mut c3_isp_device) {
