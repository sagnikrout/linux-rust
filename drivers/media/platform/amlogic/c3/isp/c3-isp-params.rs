...
//! Source: drivers/media/platform/amlogic/c3/isp/c3-isp-params.c
#![no_std]
...
// Set blc offset of each color channel
    ...
    C3_ISP_PARAMS_BLOCK_INFO_CBK(block, data, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn c3_isp_params_cfg_blocks(params: *mut c3_isp_params) {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_params_pre_cfg(isp: *mut c3_isp_device) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_params_vb2_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_params_vb2_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_params_vb2_buf_init(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_params_vb2_buf_cleanup(vb: *mut vb2_buffer) {
    static void c3_isp_params_vb2_buf_cleanup(struct vb2_buffer *vb)
    {
    struct vb2_v4l2_buffer *v4l2_buf = to_vb2_v4l2_buffer(vb);
    struct c3_isp_params_buffer *buf = to_c3_isp_params_buffer(v4l2_buf);
    kvfree(buf.cfg);
    buf.cfg = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn c3_isp_params_vb2_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_params_register(isp: *mut c3_isp_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_params_unregister(isp: *mut c3_isp_device) {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_params_isr(isp: *mut c3_isp_device) {
