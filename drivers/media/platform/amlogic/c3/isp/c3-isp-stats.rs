...
//! Source: drivers/media/platform/amlogic/c3/isp/c3-isp-stats.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn c3_isp_stats_cfg_dmawr_addr(stats: *mut c3_isp_stats) {
    static void c3_isp_stats_cfg_dmawr_addr(struct c3_isp_stats *stats)
    {
    let mut awb_dma_size: u32 = sizeof(struct c3_isp_awb_stats);
    let mut ae_dma_size: u32 = sizeof(struct c3_isp_ae_stats);
    let mut awb_dma_addr: u32 = stats.buff.dma_addr;
    u32 af_dma_addr;
    u32 ae_dma_addr;
...
#[no_mangle]
unsafe extern "C" fn c3_isp_stats_cfg_buff(stats: *mut c3_isp_stats) {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_stats_pre_cfg(isp: *mut c3_isp_device) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_stats_vb2_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_stats_vb2_buf_prepare(vb: *mut vb2_buffer) -> c_int {
    static int c3_isp_stats_vb2_buf_prepare(struct vb2_buffer *vb)
    {
    struct c3_isp_stats *stats = vb2_get_drv_priv(vb.vb2_queue);
    let mut size: c_uint = stats.vfmt.fmt.meta.buffersize;
...
#[no_mangle]
unsafe extern "C" fn c3_isp_stats_vb2_buf_init(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_stats_vb2_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_stats_register(isp: *mut c3_isp_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_stats_unregister(isp: *mut c3_isp_device) {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_stats_isr(isp: *mut c3_isp_device) {
