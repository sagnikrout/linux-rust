...
//! Source: drivers/media/platform/amlogic/c3/isp/c3-isp-resizer.c
#![no_std]
...
pub const C3_ISP_PPS_LUT_H_NUM: c_int = 33;
pub const C3_ISP_PPS_LUT_CTYPE_0: c_int = 0;
pub const C3_ISP_PPS_LUT_CTYPE_2: c_int = 2;
pub const C3_ISP_SCL_EN: c_int = 1;
pub const C3_ISP_SCL_DIS: c_int = 0;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct c3_isp_rsz_format_info {
    pub mbus_code: u32,
    pub pads: u32,
    pub is_raw: bool,
}
...
// rsz_find_format_by_index(u32 index, u32 pad)
    ...
    {
    let mut thsize: c_int = io_size.thsize;
    let mut tvsize: c_int = io_size.tvsize;
    let mut ohsize: u32 = io_size.ohsize;
    let mut ovsize: u32 = io_size.ovsize;
    let mut ihsize: u32 = io_size.ihsize;
    let mut max_hsize: u32 = io_size.max_hsize;
    int h_int;
    int v_int;
    int h_fract;
    int v_fract;
...
#[no_mangle]
unsafe extern "C" fn c3_isp_rsz_pps_lut(rsz: *mut c3_isp_resizer, ctype: u32) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_rsz_pps_disable(rsz: *mut c3_isp_resizer) {
...
// Set vertical scaler bank length
    ...
    vsc_tap_num_alt = 4;
#[no_mangle]
pub unsafe extern "C" fn if(max_hsize: ihsize_after_pre_hsc_alt <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_rsz_stop(rsz: *mut c3_isp_resizer) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_rsz_register(rsz: *mut c3_isp_resizer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_rsz_unregister(rsz: *mut c3_isp_resizer) {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_resizers_register(isp: *mut c3_isp_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_resizers_unregister(isp: *mut c3_isp_device) {
