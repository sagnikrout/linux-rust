...
//! Source: drivers/media/platform/amlogic/c3/isp/c3-isp-capture.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn c3_isp_cap_wrmifx3_buff(cap: *mut c3_isp_capture) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_cap_wrmifx3_format(cap: *mut c3_isp_capture) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_cap_dummy_buff_create(cap: *mut c3_isp_capture) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_cap_dummy_buff_destroy(cap: *mut c3_isp_capture) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_cap_cfg_buff(cap: *mut c3_isp_capture) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_cap_start(cap: *mut c3_isp_capture) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_cap_stop(cap: *mut c3_isp_capture) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_cap_done(cap: *mut c3_isp_capture) {
...
#[no_mangle]
unsafe extern "C" fn c3_cap_try_fmt(pix_mp: *mut v4l2_pix_format_mplane) {
    ...
    let mut hdiv: c_uint = (i == 0) ? 1 : info.hdiv;
    let mut vdiv: c_uint = (i == 0) ? 1 : info.vdiv;
...
#[no_mangle]
unsafe extern "C" fn c3_isp_cap_link_validate(link: *mut media_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_vb2_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_vb2_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_vb2_buf_init(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_vb2_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn c3_isp_register_capture(cap: *mut c3_isp_capture) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_captures_register(isp: *mut c3_isp_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_captures_unregister(isp: *mut c3_isp_device) {
...
#[no_mangle]
pub unsafe extern "C" fn c3_isp_captures_isr(isp: *mut c3_isp_device) {
