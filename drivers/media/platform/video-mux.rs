...
//! Source: drivers/media/platform/video-mux.c
#![no_std]
...
pub struct video_mux {
    ...
    let mut source_pad: u16 = entity.num_pads - 1;
    let mut ret: c_int = 0;
//
...
#[no_mangle]
unsafe extern "C" fn video_mux_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
    ...
    let mut source_pad: u16 = sd.entity.num_pads - 1;
...
#[no_mangle]
unsafe extern "C" fn video_mux_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    vmux.mux = devm_mux_control_get(dev, core::ptr::null_mut());
    if (IS_ERR(vmux.mux)) {
...
#[no_mangle]
unsafe extern "C" fn video_mux_remove(pdev: *mut platform_device) {
