...
//! Source: drivers/media/platform/renesas/rcar-isp/core-io.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn risp_io_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn risp_io_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn risp_io_buffer_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn risp_io_buffer_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn risp_io_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn risp_io_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn risp_io_input_g_fmt(file: *mut file, priv: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn risp_io_input_s_fmt(file: *mut file, priv: *mut c_void, f: *mut v4l2_format) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn risp_io_params_buf_init(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn risp_io_params_buf_cleanup(vb: *mut vb2_buffer) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct risp_conf_dma_write_desc {
    pub buf: *mut u32,
    pub base: u32,
    pub count: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn risp_conf_dma_prepare(priv: *mut c_void, offset: u32, value: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn risp_io_params_buffer_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn risp_core_io_destroy(io: *mut rcar_isp_core_io) {
