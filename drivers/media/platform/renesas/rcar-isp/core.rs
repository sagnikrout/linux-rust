...
//! Source: drivers/media/platform/renesas/rcar-isp/core.c
#![no_std]
...
pub const ISP_CS_STREAMER_MODE_REG: c_uint = 0x7000;
pub const ISP_CS_STREAMER_MODE_STREAMER_EN: c_uint = 0xf;
pub const ISP_CS_STREAMER_VBLANK_REG: c_uint = 0x7004;
pub const ISP_CS_STREAMER_HBLANK_REG: c_uint = 0x7008;
pub const ISP_CS_STREAMER_CONFIG_DMA_CONTROL_REG: c_uint = 0x7100;

pub const ISP_CS_STREAMER_CONFIG_DMA_CONTROL1_REG: c_uint = 0x2100;

pub const ISP_CS_STREAMER_CONFIG_DMA_CONTROL2_REG: c_uint = 0x2104;
pub const ISP_CORE_ISPCORE_INT_STATUS: c_uint = 0x80000;
pub const ISP_CORE_ISPCORE_INT_ENABLE: c_uint = 0x80004;

pub const ISPCORE_DMA_IMAGE_FLUSH_OUT_PADDING_PIXEL_EOF_SHIFT: c_int = 16;

#[no_mangle]
unsafe extern "C" fn risp_cs_write(core: *mut rcar_isp_core, offset: u32, value: u32) {
    static void risp_cs_write(struct rcar_isp_core *core, u32 offset, u32 value)
    {
    iowrite32(value, core.csbase + offset);
    }
#[no_mangle]
unsafe extern "C" fn risp_cs_read(core: *mut rcar_isp_core, offset: u32) -> u32 {
    static u32 risp_cs_read(struct rcar_isp_core *core, u32 offset)
    {
    return ioread32(core.csbase + offset);
    }
#[no_mangle]
unsafe extern "C" fn risp_core_write(core: *mut rcar_isp_core, offset: u32, value: u32) {
    static void risp_core_write(struct rcar_isp_core *core, u32 offset, u32 value)
    {
    iowrite32(value, core.base + offset);
    }
#[no_mangle]
unsafe extern "C" fn risp_core_read(core: *mut rcar_isp_core, offset: u32) -> u32 {
    ...
    let mut have_config: bool = !!params_buf[0];
...
#[no_mangle]
unsafe extern "C" fn risp_core_job_run(core: *mut rcar_isp_core) {
...
//
    ...
    core.vspx.job = core::ptr::null_mut();
    kfree(job);
    dev_err(core.dev, "Failed to run job");
    }
    }
#[no_mangle]
unsafe extern "C" fn risp_core_pixfmt_to_vspx(pixfmt: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn risp_core_job_prepare(core: *mut rcar_isp_core) -> c_int {
    int risp_core_job_prepare(struct rcar_isp_core *core)
    {
    struct vsp1_isp_job_desc *vspx_job;
    let mut vspx_pixfmt: c_int = -EINVAL;
    struct rcar_isp_job *job;
    int ret;
...
//
    ...
    let mut isp_pixfmt: u32 = core.io[i].format.fmt.pix_mp.pixelformat;
    ...
    case RISP_CORE_PARAMS: {
    u32 *params_buf = (u32 *)buf.vsp_buffer.cpu_addr;
    let mut pairs: u32 = params_buf[0];
//
...
#[no_mangle]
unsafe extern "C" fn risp_core_pix2bus(io: *const rcar_isp_core_io) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn risp_core_try_next_job(core: *mut rcar_isp_core) {
...
#[no_mangle]
unsafe extern "C" fn risp_core_vspx_frame_end(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn risp_core_power_on(core: *mut rcar_isp_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn risp_core_power_off(core: *mut rcar_isp_core) {
...
#[no_mangle]
pub unsafe extern "C" fn risp_core_start_streaming(core: *mut rcar_isp_core) -> c_int {
...
// Start RPP ISP
    ret = rppx1_start(core.rpp, &inputfmt, &hvout, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
pub unsafe extern "C" fn risp_core_stop_streaming(core: *mut rcar_isp_core) {
...
#[no_mangle]
unsafe extern "C" fn risp_core_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn risp_core_create_subdev(core: *mut rcar_isp_core) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn risp_core_registered(core: *mut rcar_isp_core, sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn risp_core_remove(core: *mut rcar_isp_core) {
