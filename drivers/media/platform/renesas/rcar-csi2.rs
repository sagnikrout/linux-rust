...
//! Source: drivers/media/platform/renesas/rcar-csi2.c
#![no_std]
...
pub const TREF_REG: c_uint = 0x00;

// Software Reset
pub const SRST_REG: c_uint = 0x04;

// PHY Operation Control
pub const PHYCNT_REG: c_uint = 0x08;

// Checksum Control
pub const CHKSUM_REG: c_uint = 0x0c;
...
//
pub const VCDT_REG: c_uint = 0x10;
pub const VCDT2_REG: c_uint = 0x14;

// Frame Data Type Select
pub const FRDT_REG: c_uint = 0x18;
// Field Detection Control
pub const FLD_REG: c_uint = 0x1c;

// Automatic Standby Control
pub const ASTBY_REG: c_uint = 0x20;
// Long Data Type Setting 0
pub const LNGDT0_REG: c_uint = 0x28;
// Long Data Type Setting 1
pub const LNGDT1_REG: c_uint = 0x2c;
// Interrupt Enable
pub const INTEN_REG: c_uint = 0x30;

// Interrupt Source Mask
pub const INTCLOSE_REG: c_uint = 0x34;
// Interrupt Status Monitor
pub const INTSTATE_REG: c_uint = 0x38;

// Interrupt Error Status Monitor
pub const INTERRSTATE_REG: c_uint = 0x3c;
// Short Packet Data
pub const SHPDAT_REG: c_uint = 0x40;
// Short Packet Count
pub const SHPCNT_REG: c_uint = 0x44;
// LINK Operation Control
pub const LINKCNT_REG: c_uint = 0x48;

// Lane Swap
pub const LSWAP_REG: c_uint = 0x4c;

// PHY Test Interface Write Register
pub const PHTW_REG: c_uint = 0x50;

pub const PHYFRX_REG: c_uint = 0x64;

// V4H BASE registers
pub const V4H_N_LANES_REG: c_uint = 0x0004;
pub const V4H_CSI2_RESETN_REG: c_uint = 0x0008;
pub const V4H_PHY_MODE_REG: c_uint = 0x001c;
pub const V4H_PHY_MODE_DPHY: c_int = 0;
pub const V4H_PHY_MODE_CPHY: c_int = 1;
pub const V4H_PHY_SHUTDOWNZ_REG: c_uint = 0x0040;
pub const V4H_DPHY_RSTZ_REG: c_uint = 0x0044;
pub const V4H_FLDC_REG: c_uint = 0x0804;
pub const V4H_FLDD_REG: c_uint = 0x0808;
pub const V4H_IDIC_REG: c_uint = 0x0810;
pub const V4H_PHY_EN_REG: c_uint = 0x2000;

pub const V4H_ST_PHYST_REG: c_uint = 0x2814;

// V4H PPI registers

pub const V4H_PPI_STARTUP_RW_COMMON_STARTUP_1_1_REG: c_uint = 0x21822;
pub const V4H_PPI_CALIBCTRL_RW_COMMON_BG_0_REG: c_uint = 0x2184c;
pub const V4H_PPI_RW_LPDCOCAL_TIMEBASE_REG: c_uint = 0x21c02;
pub const V4H_PPI_RW_LPDCOCAL_NREF_REG: c_uint = 0x21c04;
pub const V4H_PPI_RW_LPDCOCAL_NREF_RANGE_REG: c_uint = 0x21c06;
pub const V4H_PPI_RW_LPDCOCAL_TWAIT_CONFIG_REG: c_uint = 0x21c0a;
pub const V4H_PPI_RW_LPDCOCAL_VT_CONFIG_REG: c_uint = 0x21c0c;
pub const V4H_PPI_RW_LPDCOCAL_COARSE_CFG_REG: c_uint = 0x21c10;

pub const V4H_PPI_RW_COMMON_CFG_REG: c_uint = 0x21c6c;
pub const V4H_PPI_RW_TERMCAL_CFG_0_REG: c_uint = 0x21c80;
pub const V4H_PPI_RW_OFFSETCAL_CFG_0_REG: c_uint = 0x21ca0;
// V4H CORE registers

pub const V4H_CORE_DIG_COMMON_RW_DESKEW_FINE_MEM_REG: c_uint = 0x23fe0;

// V4H C-PHY

pub const V4H_CORE_DIG_CLANE_0_RW_CFG_0_REG: c_uint = 0x2a000;
pub const V4H_CORE_DIG_CLANE_0_RW_LP_0_REG: c_uint = 0x2a080;

pub const V4H_CORE_DIG_CLANE_1_RW_CFG_0_REG: c_uint = 0x2a400;
pub const V4H_CORE_DIG_CLANE_1_RW_LP_0_REG: c_uint = 0x2a480;

pub const V4H_CORE_DIG_CLANE_1_RW_HS_TX_6_REG: c_uint = 0x2a60c;
pub const V4H_CORE_DIG_CLANE_2_RW_CFG_0_REG: c_uint = 0x2a800;
pub const V4H_CORE_DIG_CLANE_2_RW_LP_0_REG: c_uint = 0x2a880;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcsi2_cphy_setting {
    pub msps: u16,
    pub rx2: u16,
    pub trio0: u16,
    pub trio1: u16,
...
// V4M registers
pub const V4M_OVR1_REG: c_uint = 0x0848;

pub const V4M_FRXM_REG: c_uint = 0x2004;

pub const V4M_PHYPLL_REG: c_uint = 0x02050;
pub const V4M_CSI0CLKFCPR_REG: c_uint = 0x02054;
pub const V4M_PHTW_REG: c_uint = 0x02060;
pub const V4M_PHTR_REG: c_uint = 0x02064;
pub const V4M_PHTC_REG: c_uint = 0x02068;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct phtw_value {
    pub data: u8,
    pub code: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcsi2_mbps_info {
    pub mbps: u16,
    pub reg: u8,
    pub /: *mut *mut u16 osc_freq; / V4M,
}
...
pub const PHTC_REG: c_uint = 0x58;

// PHY Frequency Control
pub const PHYPLL_REG: c_uint = 0x68;
...
pub const PHEERM_REG: c_uint = 0x74;
// PHY Clock Lane Monitor
pub const PHCLM_REG: c_uint = 0x78;

// PHY Data Lane Monitor
pub const PHDLM_REG: c_uint = 0x7c;
// CSI0CLK Frequency Configuration Preset Register
pub const CSI0CLKFCPR_REG: c_uint = 0x260;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_csi2_format {
    pub code: u32,
    pub datatype: c_uint,
    pub bpp: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcsi2_cphy_line_order {
    pub order: enum v4l2_mbus_csi2_cphy_line_orders_type,
    pub cfg: u16,
    pub ctrl29: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcsi2_register_layout {
    pub phtw: c_uint,
    pub phypll: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_csi2_info {
    pub regs: *const rcsi2_register_layout,
    pub mbps): *mut *mut *mut int (init_phtw)(struct rcar_csi2 priv, unsigned int,
    pub priv): *mut *mut int (phy_post_init)(struct rcar_csi2,
    int (*start_receiver)(struct rcar_csi2 *priv,
    pub state): *mut v4l2_subdev_state,
    pub priv): *mut *mut void (enter_standby)(struct rcar_csi2,
    pub hsfreqrange: *const rcsi2_mbps_info,
    pub csi0clkfreqrange: c_uint,
    pub num_channels: c_uint,
    pub clear_ulps: bool,
    pub use_isp: bool,
    pub support_dphy: bool,
    pub support_cphy: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_csi2 {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub info: *const rcar_csi2_info,
    pub rstc: *mut reset_control,
    pub subdev: v4l2_subdev,
    pub pads: [media_pad; NR_OF_RCAR_CSI2_PAD],
    pub notifier: v4l2_async_notifier,
    pub remote: *mut v4l2_subdev,
    pub remote_pad: c_uint,
    pub channel_vc: [c_int; 4],
    pub stream_count: c_int,
    pub cphy: bool,
    pub lanes: c_ushort,
    pub lane_swap: [c_uchar; 4],
    pub line_orders: [enum v4l2_mbus_csi2_cphy_line_orders_type; 3],
}
...
#[no_mangle]
unsafe extern "C" fn rcsi2_num_pads(priv: *const rcar_csi2) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rcsi2_read(priv: *mut rcar_csi2, reg: c_uint) -> u32 {
    static u32 rcsi2_read(struct rcar_csi2 *priv, unsigned int reg)
    {
    return ioread32(priv.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn rcsi2_write(priv: *mut rcar_csi2, reg: c_uint, data: u32) {
    static void rcsi2_write(struct rcar_csi2 *priv, unsigned int reg, u32 data)
    {
    iowrite32(data, priv.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn rcsi2_read16(priv: *mut rcar_csi2, reg: c_uint) -> u16 {
    static u16 rcsi2_read16(struct rcar_csi2 *priv, unsigned int reg)
    {
    return ioread16(priv.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn rcsi2_write16(priv: *mut rcar_csi2, reg: c_uint, data: u16) {
    static void rcsi2_write16(struct rcar_csi2 *priv, unsigned int reg, u16 data)
    {
    iowrite16(data, priv.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn rcsi2_modify16(priv: *mut rcar_csi2, reg: c_uint, data: u16, mask: u16) {
...
#[no_mangle]
unsafe extern "C" fn rcsi2_phtw_write(priv: *mut rcar_csi2, data: u8, code: u8) -> c_int {
...
// Wait for DWEN and CWEN to be cleared by hardware.
    ...
    const struct rcsi2_mbps_info *prev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rcsi2_enter_standby_gen3(priv: *mut rcar_csi2) {
...
#[no_mangle]
unsafe extern "C" fn rcsi2_enter_standby(priv: *mut rcar_csi2) {
...
#[no_mangle]
unsafe extern "C" fn rcsi2_exit_standby(priv: *mut rcar_csi2) -> c_int {
...
// Wait for the clock and data lanes to enter LP-11 state.
    for (timeout = 0; timeout <= 20; timeout++) {
    let mut lane_mask: u32 = (1 << lanes) - 1;
...
#[no_mangle]
unsafe extern "C" fn rcsi2_set_phypll(priv: *mut rcar_csi2, mbps: c_uint) -> c_int {
    ...
    unsigned int *lanes)
    {
    let mut mbus_config: v4l2_mbus_config = { 0 };
    int ret;
// lanes = priv->lanes;
...
// Clear Ultra Low Power interrupt.
    ...
    {
    const struct rcsi2_cphy_line_order *info = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rcsi2_wait_phy_start_v4h(priv: *mut rcar_csi2, match: u32) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcsi2_d_phy_setting_v4h_lut_value {
    pub mbps: c_uint,
    pub cfg_1: c_uchar,
    pub cfg_5_94: c_uchar,
    pub cfg_5_30: c_uchar,
    pub lane_ctrl_2_8: c_uchar,
    pub rw_hs_rx_3_83: c_uchar,
    pub rw_hs_rx_3_20: c_uchar,
    pub rw_hs_rx_6: c_uchar,
    pub rw_hs_rx_1: c_uchar,
}
...
#[no_mangle]
unsafe extern "C" fn rcsi2_d_phy_setting_v4h(priv: *mut rcar_csi2, mbps: c_int) -> c_int {
...
//
    ...
    struct v4l2_subdev_state *state)
    {
    const struct rcsi2_cphy_setting *cphy = core::ptr::null_mut();
    unsigned int lanes;
    int mbps;
    int ret;
    ret = rcsi2_get_active_lanes(priv, &lanes);
...
// T6: Analog programming
    ...
    let mut val_2_9: u16 = mbps > 2500 ? 0x14 : mbps > 1500 ? 0x04 : 0x00;
    let mut val_2_15: u16 = mbps > 1500 ? 0x03 : 0x00;
    for (unsigned int l = 0; l < 5; l++) {
    rcsi2_write16(priv, V4H_CORE_DIG_IOCTRL_RW_AFE_LANEl_CTRL_2_REG(l, 9),
    val_2_9);
...
#[no_mangle]
unsafe extern "C" fn rcsi2_d_phy_setting_v4m(priv: *mut rcar_csi2, mbps: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcsi2_set_osc_freq(priv: *mut rcar_csi2, mbps: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcsi2_init_common_v4m(priv: *mut rcar_csi2, mbps: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcsi2_start(priv: *mut rcar_csi2, state: *mut v4l2_subdev_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcsi2_stop(priv: *mut rcar_csi2) {
    ...
    {
    struct rcar_csi2 *priv = sd_to_csi2(sd);
    let mut num_pads: c_uint = rcsi2_num_pads(priv);
...
#[no_mangle]
unsafe extern "C" fn rcsi2_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rcsi2_irq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rcsi2_parse_dt(priv: *mut rcar_csi2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcsi2_init_phtw_h3_v3h_m3n(priv: *mut rcar_csi2, mbps: c_uint) -> c_int {
    static int rcsi2_init_phtw_h3_v3h_m3n(struct rcar_csi2 *priv, unsigned int mbps)
    {
    return __rcsi2_init_phtw_h3_v3h_m3n(priv, mbps);
    }
#[no_mangle]
unsafe extern "C" fn rcsi2_init_phtw_h3es2(priv: *mut rcar_csi2, mbps: c_uint) -> c_int {
    static int rcsi2_init_phtw_h3es2(struct rcar_csi2 *priv, unsigned int mbps)
    {
    return __rcsi2_init_phtw_h3_v3h_m3n(priv, 0);
    }
#[no_mangle]
unsafe extern "C" fn rcsi2_init_phtw_v3m_e3(priv: *mut rcar_csi2, mbps: c_uint) -> c_int {
    static int rcsi2_init_phtw_v3m_e3(struct rcar_csi2 *priv, unsigned int mbps)
    {
    return rcsi2_phtw_write_mbps(priv, mbps, phtw_mbps_v3m_e3, 0x44);
    }
#[no_mangle]
unsafe extern "C" fn rcsi2_phy_post_init_v3m_e3(priv: *mut rcar_csi2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcsi2_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcsi2_remove(pdev: *mut platform_device) {
