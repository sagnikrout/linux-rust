...
//! Source: drivers/media/platform/renesas/rcar-vin/rcar-v4l2.c
#![no_std]
...
pub const RVIN_DEFAULT_WIDTH: c_int = 800;
pub const RVIN_DEFAULT_HEIGHT: c_int = 600;
...
#[no_mangle]
unsafe extern "C" fn rvin_format_sizeimage(pix: *mut v4l2_pix_format) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rvin_format_align(vin: *mut rvin_dev, pix: *mut v4l2_pix_format) {
...
#[no_mangle]
unsafe extern "C" fn rvin_remote_rectangle(vin: *mut rvin_dev, rect: *mut v4l2_rect) -> c_int {
    ...
    index = pad.index;
    fmt.pad = index;
    ret = v4l2_subdev_call(sd, pad, get_fmt, core::ptr::null_mut(), &fmt);
    if (ret)
    return ret;
...
// HW supports modifying configuration while running
    ...
    return v4l2_event_subscribe(fh, sub, 4, core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn rvin_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rvin_release(file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rvin_v4l2_unregister(vin: *mut rvin_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn rvin_v4l2_register(vin: *mut rvin_dev) -> c_int {
