...
//! Source: drivers/media/platform/renesas/vsp1/vsp1_drv.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn vsp1_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vsp1_uapi_create_links(vsp1: *mut vsp1_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsp1_destroy_entities(vsp1: *mut vsp1_device) {
...
#[no_mangle]
unsafe extern "C" fn vsp1_create_entities(vsp1: *mut vsp1_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vsp1_reset_wpf(vsp1: *mut vsp1_device, index: c_uint) -> c_int {
    int vsp1_reset_wpf(struct vsp1_device *vsp1, unsigned int index)
    {
    let mut version: u32 = vsp1.version & VI6_IP_VERSION_MODEL_MASK;
...
#[no_mangle]
unsafe extern "C" fn vsp1_device_init(vsp1: *mut vsp1_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsp1_mask_all_interrupts(vsp1: *mut vsp1_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vsp1_device_get(vsp1: *mut vsp1_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vsp1_device_put(vsp1: *mut vsp1_device) {
...
//
#[no_mangle]
unsafe extern "C" fn vsp1_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsp1_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsp1_pm_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsp1_pm_runtime_resume(dev: *mut device) -> c_int {
...
//
    ...
    RUNTIME_PM_OPS(vsp1_pm_runtime_suspend, vsp1_pm_runtime_resume, core::ptr::null_mut())
    };
// -----------------------------------------------------------------------------
// Platform Driver
//
...
#[no_mangle]
unsafe extern "C" fn vsp1_probe(pdev: *mut platform_device) -> c_int {
...
// I/O and IRQ resources (clock managed by the clock PM domain).
    ...
    if (irq < 0)
    return irq;
    vsp1.rstc = devm_reset_control_get_optional_shared(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(vsp1.rstc))
...
#[no_mangle]
unsafe extern "C" fn vsp1_remove(pdev: *mut platform_device) {
