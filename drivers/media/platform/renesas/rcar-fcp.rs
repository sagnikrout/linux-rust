...
//! Source: drivers/media/platform/renesas/rcar-fcp.c
#![no_std]
...
pub const RCAR_FCP_REG_RST: c_uint = 0x0010;

pub const RCAR_FCP_REG_STA: c_uint = 0x0018;
...
#[no_mangle]
pub unsafe extern "C" fn rcar_fcp_write(fcp: *mut rcar_fcp_device, reg: u32, val: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rcar_fcp_put(fcp: *mut rcar_fcp_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rcar_fcp_enable(fcp: *mut rcar_fcp_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rcar_fcp_disable(fcp: *mut rcar_fcp_device) {
...
#[no_mangle]
pub unsafe extern "C" fn rcar_fcp_soft_reset(fcp: *mut rcar_fcp_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rcar_fcp_probe(pdev: *mut platform_device) -> c_int {
    static int rcar_fcp_probe(struct platform_device *pdev)
    {
    struct rcar_fcp_device *fcp;
    fcp = devm_kzalloc(&pdev.dev, sizeof(*fcp), GFP_KERNEL);
    if (fcp == core::ptr::null_mut())
    return -ENOMEM;
    fcp.dev = &pdev.dev;
...
#[no_mangle]
unsafe extern "C" fn rcar_fcp_remove(pdev: *mut platform_device) {
