...
//! Source: drivers/media/platform/renesas/rcar_drif.c
#![no_std]
...
pub const RCAR_DRIF_SITMDR1: c_uint = 0x00;
pub const RCAR_DRIF_SITMDR2: c_uint = 0x04;
pub const RCAR_DRIF_SITMDR3: c_uint = 0x08;
pub const RCAR_DRIF_SIRMDR1: c_uint = 0x10;
pub const RCAR_DRIF_SIRMDR2: c_uint = 0x14;
pub const RCAR_DRIF_SIRMDR3: c_uint = 0x18;
pub const RCAR_DRIF_SICTR: c_uint = 0x28;
pub const RCAR_DRIF_SIFCTR: c_uint = 0x30;
pub const RCAR_DRIF_SISTR: c_uint = 0x40;
pub const RCAR_DRIF_SIIER: c_uint = 0x44;
pub const RCAR_DRIF_SIRFDR: c_uint = 0x60;
...
// Constants
pub const RCAR_DRIF_NUM_HWBUFS: c_int = 32;
pub const RCAR_DRIF_MAX_DEVS: c_int = 4;
pub const RCAR_DRIF_DEFAULT_NUM_HWBUFS: c_int = 16;

pub const RCAR_DRIF_MAX_CHANNEL: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_drif_frame_buf {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_drif_graph_ep {
    pub /: *mut *mut *mut v4l2_subdev subdev; / Async matched subdev,
}

// DMA buffer
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_drif_hwbuf {
    pub /: *mut *mut *mut void addr; / CPU-side address,
    pub /: *mut *mut unsigned int status; / Buffer status flags,
}

// Internal channel
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_drif {
    pub /: *mut *mut *mut rcar_drif_sdr sdr; / Group device,
    pub /: *mut *mut *mut platform_device pdev; / Channel's pdev,
    pub /: *mut *mut *mut void __iomem base; / Base register address,
    pub /: *mut *mut resource_size_t start; / I/O resource offset,
    pub /: *mut *mut *mut dma_chan dmach; / Reserved DMA channel,
    pub /: *mut *mut *mut clk clk; / Module clock,
    pub /: *mut *mut rcar_drif_hwbuf buf[RCAR_DRIF_NUM_HWBUFS]; / H/W bufs,
    pub /: *mut *mut dma_addr_t dma_handle; / Handle for all bufs,
    pub /: *mut *mut unsigned int num; / Channel number,
    pub /: *mut *mut bool acting_sdr; / Channel acting as SDR device,
}

// DRIF V4L2 SDR
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_drif_sdr {
    pub /: *mut *mut *mut device dev; / Platform device,
    pub /: *mut *mut *mut video_device vdev; / V4L2 SDR device,
    pub /: *mut *mut v4l2_device v4l2_dev; / V4L2 device,
// Videobuf2 queue and queued buffers list
    pub vb_queue: vb2_queue,
    pub queued_bufs: list_head,
    pub /: *mut *mut spinlock_t queued_bufs_lock; / Protects queued_bufs,
    pub /: *mut *mut spinlock_t dma_lock; / To serialize DMA cb of channels,
    pub /: *mut *mut mutex v4l2_mutex; / To serialize ioctls,
    pub /: *mut *mut mutex vb_queue_mutex; / To serialize streaming ioctls,
    pub /: *mut *mut v4l2_ctrl_handler ctrl_hdl; / SDR control handler,
    pub /: *mut *mut v4l2_async_notifier notifier; / For subdev (tuner),
    pub /: *mut *mut rcar_drif_graph_ep ep; / Endpoint V4L2 async data,
// Current V4L2 SDR format ptr
    pub fmt: *const rcar_drif_format,
// Device tree SYNC properties
    pub mdr1: u32,
// Internals
    pub /: *mut *mut *mut rcar_drif ch[RCAR_DRIF_MAX_CHANNEL]; / DRIFx0,1,
    pub /: *mut *mut unsigned long hw_ch_mask; / Enabled channels per DT,
    pub /: *mut *mut unsigned long cur_ch_mask; / Used channels for an SDR FMT,
    pub /: *mut *mut u32 num_hw_ch; / Num of DT enabled channels,
    pub /: *mut *mut u32 num_cur_ch; / Num of used channels,
    pub /: *mut *mut u32 hwbuf_size; / Each DMA buffer size,
    pub /: *mut *mut u32 produced; / Buffers produced by sdr dev,
}

// Register access functions
#[no_mangle]
unsafe extern "C" fn rcar_drif_write(ch: *mut rcar_drif, offset: u32, data: u32) {
    static void rcar_drif_write(struct rcar_drif *ch, u32 offset, u32 data)
    {
    writel(data, ch.base + offset);
    }
#[no_mangle]
unsafe extern "C" fn rcar_drif_read(ch: *mut rcar_drif, offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rcar_drif_release_dmachannels(sdr: *mut rcar_drif_sdr) {
    ...
    sdr.ch[i].dmach = core::ptr::null_mut();
    }
    }
// Allocate DMA channels
#[no_mangle]
unsafe extern "C" fn rcar_drif_alloc_dmachannels(sdr: *mut rcar_drif_sdr) -> c_int {
...
// Set MDR defaults
#[no_mangle]
pub unsafe extern "C" fn rcar_drif_set_mdr1(sdr: *mut rcar_drif_sdr) {
...
#[no_mangle]
unsafe extern "C" fn rcar_drif_set_format(sdr: *mut rcar_drif_sdr) -> c_int {
...
// Release DMA buffers
#[no_mangle]
unsafe extern "C" fn rcar_drif_release_buf(sdr: *mut rcar_drif_sdr) {
...
// First entry contains the dma buf ptr
    ...
    ch.buf[0].addr = core::ptr::null_mut();
    }
    }
    }
// Request DMA buffers
#[no_mangle]
unsafe extern "C" fn rcar_drif_request_buf(sdr: *mut rcar_drif_sdr) -> c_int {
...
// Enqueue buffer
#[no_mangle]
unsafe extern "C" fn rcar_drif_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
pub unsafe extern "C" fn rcar_drif_bufs_done(buf: *mut rcar_drif_hwbuf) -> bool {
    static inline bool rcar_drif_bufs_done(struct rcar_drif_hwbuf **buf)
    {
    return (buf[0].status & buf[1].status & RCAR_DRIF_BUF_DONE);
    }
#[no_mangle]
pub unsafe extern "C" fn rcar_drif_bufs_overflow(buf: *mut rcar_drif_hwbuf) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rcar_drif_channel_complete(ch: *mut rcar_drif, idx: u32) {
...
#[no_mangle]
unsafe extern "C" fn rcar_drif_dma_complete(dma_async_param: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rcar_drif_qbuf(ch: *mut rcar_drif) -> c_int {
    static int rcar_drif_qbuf(struct rcar_drif *ch)
    {
    struct rcar_drif_sdr *sdr = ch.sdr;
    let mut addr: dma_addr_t = ch.dma_handle;
...
// Enable reception
#[no_mangle]
unsafe extern "C" fn rcar_drif_enable_rx(sdr: *mut rcar_drif_sdr) -> c_int {
...
// Disable reception
#[no_mangle]
unsafe extern "C" fn rcar_drif_disable_rx(sdr: *mut rcar_drif_sdr) {
...
// Stop channel
#[no_mangle]
unsafe extern "C" fn rcar_drif_stop_channel(ch: *mut rcar_drif) {
...
#[no_mangle]
unsafe extern "C" fn rcar_drif_stop(sdr: *mut rcar_drif_sdr) {
...
// Start channel
#[no_mangle]
unsafe extern "C" fn rcar_drif_start_channel(ch: *mut rcar_drif) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_drif_start(sdr: *mut rcar_drif_sdr) -> c_int {
...
// Start streaming
#[no_mangle]
unsafe extern "C" fn rcar_drif_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
// Stop streaming
#[no_mangle]
unsafe extern "C" fn rcar_drif_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn rcar_drif_set_default_format(sdr: *mut rcar_drif_sdr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_drif_sdr_register(sdr: *mut rcar_drif_sdr) -> c_int {
...
// Register V4L2 SDR device
    ...
    sdr.vdev = core::ptr::null_mut();
    dev_err(sdr.dev, "failed video_register_device (%d)\n", ret);
    }
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn rcar_drif_sdr_unregister(sdr: *mut rcar_drif_sdr) {
...
// Free ctrl handler if initialized
    ...
    sdr.v4l2_dev.ctrl_handler = core::ptr::null_mut();
    sdr.ep.subdev = core::ptr::null_mut();
    rcar_drif_sdr_unregister(sdr);
    rdrif_dbg(sdr, "unbind asd %s\n", subdev.name);
    }
// Sub-device registered notification callback
#[no_mangle]
unsafe extern "C" fn rcar_drif_notify_complete(notifier: *mut v4l2_async_notifier) -> c_int {
...
//
    ...
    sdr.ep.subdev.ctrl_handler, core::ptr::null_mut(), true);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn rcar_drif_parse_subdevs(sdr: *mut rcar_drif_sdr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_drif_primary_bond(pdev: *mut platform_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rcar_drif_sdr_probe(sdr: *mut rcar_drif_sdr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_drif_sdr_remove(sdr: *mut rcar_drif_sdr) {
...
// DRIF channel probe
#[no_mangle]
unsafe extern "C" fn rcar_drif_probe(pdev: *mut platform_device) -> c_int {
...
// DRIF channel remove
#[no_mangle]
unsafe extern "C" fn rcar_drif_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rcar_drif_suspend(dev: *mut device) -> c_int {
    static int rcar_drif_suspend(struct device *dev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn rcar_drif_resume(dev: *mut device) -> c_int {
