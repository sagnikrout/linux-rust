...
//! Source: drivers/media/platform/renesas/renesas-ceu.c
#![no_std]
...
pub const CEU_CAPSR: c_uint = 0x00 /* Capture start register			*/;
pub const CEU_CAPCR: c_uint = 0x04 /* Capture control register		*/;
pub const CEU_CAMCR: c_uint = 0x08 /* Capture interface control register	*/;
pub const CEU_CAMOR: c_uint = 0x10 /* Capture interface offset register	*/;
pub const CEU_CAPWR: c_uint = 0x14 /* Capture interface width register	*/;
pub const CEU_CAIFR: c_uint = 0x18 /* Capture interface input format register */;
pub const CEU_CRCNTR: c_uint = 0x28 /* CEU register control register		*/;
pub const CEU_CRCMPR: c_uint = 0x2c /* CEU register forcible control register	*/;
pub const CEU_CFLCR: c_uint = 0x30 /* Capture filter control register		*/;
pub const CEU_CFSZR: c_uint = 0x34 /* Capture filter size clip register	*/;
pub const CEU_CDWDR: c_uint = 0x38 /* Capture destination width register	*/;
pub const CEU_CDAYR: c_uint = 0x3c /* Capture data address Y register		*/;
pub const CEU_CDACR: c_uint = 0x40 /* Capture data address C register		*/;
pub const CEU_CFWCR: c_uint = 0x5c /* Firewall operation control register	*/;
pub const CEU_CDOCR: c_uint = 0x64 /* Capture data output control register	*/;
pub const CEU_CEIER: c_uint = 0x70 /* Capture event interrupt enable register	*/;
pub const CEU_CETCR: c_uint = 0x74 /* Capture event flag clear register	*/;
pub const CEU_CSTSR: c_uint = 0x7c /* Capture status register			*/;
pub const CEU_CSRTR: c_uint = 0x80 /* Capture software reset register		*/;
...
pub const CEU_CETCR_ALL_IRQS_RZ: c_uint = 0x397f313;
pub const CEU_CETCR_ALL_IRQS_SH4: c_uint = 0x3d7f313;
...
pub const CEU_MAX_WIDTH: c_int = 2560;
pub const CEU_MAX_HEIGHT: c_int = 1920;
pub const CEU_MAX_BPL: c_int = 8188;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ceu_mbus_fmt {
    pub mbus_code: u32,
    pub fmt_order: u32,
    pub fmt_order_swap: u32,
    pub swapped: bool,
    pub bps: u8,
    pub bpp: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ceu_subdev {
    pub asd: v4l2_async_connection,
    pub v4l2_sd: *mut v4l2_subdev,
// per-subdevice mbus configuration options
    pub mbus_flags: c_uint,
    pub mbus_fmt: ceu_mbus_fmt,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ceu_device {
    pub dev: *mut device,
    pub vdev: video_device,
    pub v4l2_dev: v4l2_device,
// subdevices descriptors
    pub subdevs: *mut ceu_subdev,
// the subdevice currently in use
    pub sd: *mut ceu_subdev,
    pub sd_index: c_uint,
    pub num_sd: c_uint,
...
#[no_mangle]
unsafe extern "C" fn ceu_fmt_mplane(pix: *mut v4l2_pix_format_mplane) -> bool {
...
// --- CEU HW operations ---
#[no_mangle]
unsafe extern "C" fn ceu_write(priv: *mut ceu_device, reg_offs: c_uint, data: u32) {
    static void ceu_write(struct ceu_device *priv, unsigned int reg_offs, u32 data)
    {
    iowrite32(data, priv.base + reg_offs);
    }
#[no_mangle]
unsafe extern "C" fn ceu_read(priv: *mut ceu_device, reg_offs: c_uint) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn ceu_soft_reset(ceudev: *mut ceu_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ceu_hw_config(ceudev: *mut ceu_device) -> c_int {
    ...
    let mut mbus_flags: c_uint = ceu_sd.mbus_flags;
...
//
#[no_mangle]
unsafe extern "C" fn ceu_capture(ceudev: *mut ceu_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ceu_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ceu_vb2_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn ceu_vb2_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ceu_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
// Clean and program interrupts for first capture.
    ...
    ceudev.active = core::ptr::null_mut();
    spin_unlock_irqrestore(&ceudev.lock, irqflags);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn ceu_stop_streaming(vq: *mut vb2_queue) {
...
//
#[no_mangle]
unsafe extern "C" fn ceu_try_fmt(ceudev: *mut ceu_device, v4l2_fmt: *mut v4l2_format) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ceu_set_fmt(ceudev: *mut ceu_device, v4l2_fmt: *mut v4l2_format) -> c_int {
...
//
    ...
    ret = v4l2_subdev_call(v4l2_sd, pad, set_fmt, core::ptr::null_mut(), &format);
    if (ret)
    return ret;
...
//
#[no_mangle]
unsafe extern "C" fn ceu_set_default_fmt(ceudev: *mut ceu_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ceu_init_mbus_fmt(ceudev: *mut ceu_device) -> c_int {
    static int ceu_init_mbus_fmt(struct ceu_device *ceudev)
    {
    struct ceu_subdev *ceu_sd = ceudev.sd;
    struct ceu_mbus_fmt *mbus_fmt = &ceu_sd.mbus_fmt;
    struct v4l2_subdev *v4l2_sd = ceu_sd.v4l2_sd;
    let mut yuyv_bus_fmt: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn ceu_runtime_resume(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ceu_runtime_suspend(dev: *mut device) -> c_int {
...
// --- File Operations ---
#[no_mangle]
unsafe extern "C" fn ceu_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ceu_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ceu_g_input(file: *mut file, priv: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ceu_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ceu_g_parm(file: *mut file, fh: *mut c_void, a: *mut v4l2_streamparm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ceu_s_parm(file: *mut file, fh: *mut c_void, a: *mut v4l2_streamparm) -> c_int {
...
// Just check if user supplied pixel format is supported.
    ...
    if (!ceu_fmt)
    return -EINVAL;
    ret = v4l2_subdev_call(v4l2_sd, pad, enum_frame_interval, core::ptr::null_mut(),
    &fie);
    if (ret)
    return ret;
...
//
#[no_mangle]
unsafe extern "C" fn ceu_vdev_release(vdev: *mut video_device) {
...
#[no_mangle]
unsafe extern "C" fn ceu_notify_complete(notifier: *mut v4l2_async_notifier) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ceu_init_async_subdevs(ceudev: *mut ceu_device, n_sd: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ceu_parse_dt(ceudev: *mut ceu_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ceu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ceu_remove(pdev: *mut platform_device) {
    ...
    RUNTIME_PM_OPS(ceu_runtime_suspend, ceu_runtime_resume, core::ptr::null_mut())
    };
