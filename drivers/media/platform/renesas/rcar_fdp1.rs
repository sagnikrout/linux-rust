...
//! Source: drivers/media/platform/renesas/rcar_fdp1.c
#![no_std]
...
pub const FDP1_NUMBER_JOBS: c_int = 8;
...
pub const FD1_CTL_CMD: c_uint = 0x0000;

// Sync generator register - Imm
pub const FD1_CTL_SGCMD: c_uint = 0x0004;

// Register set end register - Imm
pub const FD1_CTL_REGEND: c_uint = 0x0008;

// Channel activation register - Vupdt
pub const FD1_CTL_CHACT: c_uint = 0x000c;

// Operation Mode Register - Vupdt
pub const FD1_CTL_OPMODE: c_uint = 0x0010;

pub const FD1_CTL_VPERIOD: c_uint = 0x0014;
pub const FD1_CTL_CLKCTRL: c_uint = 0x0018;

// Software reset register
pub const FD1_CTL_SRESET: c_uint = 0x001c;

// Control status register (V-update-status)
pub const FD1_CTL_STATUS: c_uint = 0x0024;

pub const FD1_CTL_STATUS_VINT_CNT_SHIFT: c_int = 16;

pub const FD1_CTL_VCYCLE_STAT: c_uint = 0x0028;
// Interrupt enable register
pub const FD1_CTL_IRQENB: c_uint = 0x0038;
// Interrupt status register
pub const FD1_CTL_IRQSTA: c_uint = 0x003c;
// Interrupt control register
pub const FD1_CTL_IRQFSET: c_uint = 0x0040;
// Common IRQ Bit settings

    FD1_CTL_IRQ_VINTE | \
    FD1_CTL_IRQ_FREE)
// RPF
pub const FD1_RPF_SIZE: c_uint = 0x0060;

pub const FD1_RPF_SIZE_H_SHIFT: c_int = 16;
pub const FD1_RPF_SIZE_V_SHIFT: c_int = 0;
pub const FD1_RPF_FORMAT: c_uint = 0x0064;

pub const FD1_RPF_PSTRIDE: c_uint = 0x0068;
pub const FD1_RPF_PSTRIDE_Y_SHIFT: c_int = 16;
pub const FD1_RPF_PSTRIDE_C_SHIFT: c_int = 0;
// RPF0 Source Component Y Address register
pub const FD1_RPF0_ADDR_Y: c_uint = 0x006c;
// RPF1 Current Picture Registers
pub const FD1_RPF1_ADDR_Y: c_uint = 0x0078;
pub const FD1_RPF1_ADDR_C0: c_uint = 0x007c;
pub const FD1_RPF1_ADDR_C1: c_uint = 0x0080;
// RPF2 next picture register
pub const FD1_RPF2_ADDR_Y: c_uint = 0x0084;
pub const FD1_RPF_SMSK_ADDR: c_uint = 0x0090;
pub const FD1_RPF_SWAP: c_uint = 0x0094;
// WPF
pub const FD1_WPF_FORMAT: c_uint = 0x00c0;
pub const FD1_WPF_FORMAT_PDV_SHIFT: c_int = 24;

pub const FD1_WPF_RNDCTL: c_uint = 0x00c4;

pub const FD1_WPF_PSTRIDE: c_uint = 0x00c8;
pub const FD1_WPF_PSTRIDE_Y_SHIFT: c_int = 16;
pub const FD1_WPF_PSTRIDE_C_SHIFT: c_int = 0;
// WPF Destination picture
pub const FD1_WPF_ADDR_Y: c_uint = 0x00cc;
pub const FD1_WPF_ADDR_C0: c_uint = 0x00d0;
pub const FD1_WPF_ADDR_C1: c_uint = 0x00d4;
pub const FD1_WPF_SWAP: c_uint = 0x00d8;
pub const FD1_WPF_SWAP_OSWAP_SHIFT: c_int = 0;
pub const FD1_WPF_SWAP_SSWAP_SHIFT: c_int = 4;
// WPF/RPF Common

// IPC
pub const FD1_IPC_MODE: c_uint = 0x0100;

pub const FD1_IPC_SMSK_THRESH: c_uint = 0x0104;
pub const FD1_IPC_SMSK_THRESH_CONST: c_uint = 0x00010002;
pub const FD1_IPC_COMB_DET: c_uint = 0x0108;
pub const FD1_IPC_COMB_DET_CONST: c_uint = 0x00200040;
pub const FD1_IPC_MOTDEC: c_uint = 0x010c;
pub const FD1_IPC_MOTDEC_CONST: c_uint = 0x00008020;
// DLI registers
pub const FD1_IPC_DLI_BLEND: c_uint = 0x0120;
pub const FD1_IPC_DLI_BLEND_CONST: c_uint = 0x0080ff02;
pub const FD1_IPC_DLI_HGAIN: c_uint = 0x0124;
pub const FD1_IPC_DLI_HGAIN_CONST: c_uint = 0x001000ff;
pub const FD1_IPC_DLI_SPRS: c_uint = 0x0128;
pub const FD1_IPC_DLI_SPRS_CONST: c_uint = 0x009004ff;
pub const FD1_IPC_DLI_ANGLE: c_uint = 0x012c;
pub const FD1_IPC_DLI_ANGLE_CONST: c_uint = 0x0004080c;
pub const FD1_IPC_DLI_ISOPIX0: c_uint = 0x0130;
pub const FD1_IPC_DLI_ISOPIX0_CONST: c_uint = 0xff10ff10;
pub const FD1_IPC_DLI_ISOPIX1: c_uint = 0x0134;
pub const FD1_IPC_DLI_ISOPIX1_CONST: c_uint = 0x0000ff10;
// Sensor registers
pub const FD1_IPC_SENSOR_TH0: c_uint = 0x0140;
pub const FD1_IPC_SENSOR_TH0_CONST: c_uint = 0x20208080;
pub const FD1_IPC_SENSOR_TH1: c_uint = 0x0144;
pub const FD1_IPC_SENSOR_TH1_CONST: c_int = 0;
pub const FD1_IPC_SENSOR_CTL0: c_uint = 0x0170;
pub const FD1_IPC_SENSOR_CTL0_CONST: c_uint = 0x00002201;
pub const FD1_IPC_SENSOR_CTL1: c_uint = 0x0174;
pub const FD1_IPC_SENSOR_CTL1_CONST: c_int = 0;
pub const FD1_IPC_SENSOR_CTL2: c_uint = 0x0178;
pub const FD1_IPC_SENSOR_CTL2_X_SHIFT: c_int = 16;
pub const FD1_IPC_SENSOR_CTL2_Y_SHIFT: c_int = 0;
pub const FD1_IPC_SENSOR_CTL3: c_uint = 0x017c;
pub const FD1_IPC_SENSOR_CTL3_0_SHIFT: c_int = 16;
pub const FD1_IPC_SENSOR_CTL3_1_SHIFT: c_int = 0;
// Line memory pixel number register
pub const FD1_IPC_LMEM: c_uint = 0x01e0;
pub const FD1_IPC_LMEM_LINEAR: c_int = 1024;
pub const FD1_IPC_LMEM_TILE: c_int = 960;
// Internal Data (HW Version)
pub const FD1_IP_INTDATA: c_uint = 0x0800;
// R-Car Gen2 HW manual says zero, but actual value matches R-Car H3 ES1.x
pub const FD1_IP_GEN2: c_uint = 0x02010101;
pub const FD1_IP_M3W: c_uint = 0x02010202;
pub const FD1_IP_H3: c_uint = 0x02010203;
pub const FD1_IP_M3N: c_uint = 0x02010204;
pub const FD1_IP_E3: c_uint = 0x02010205;
// LUTs
pub const FD1_LUT_DIF_ADJ: c_uint = 0x1000;
pub const FD1_LUT_SAD_ADJ: c_uint = 0x1400;
pub const FD1_LUT_BLD_GAIN: c_uint = 0x1800;
pub const FD1_LUT_DIF_GAIN: c_uint = 0x1c00;
pub const FD1_LUT_MDET: c_uint = 0x2000;
//
...
#[no_mangle]
unsafe extern "C" fn fdp1_fmt_is_rgb(fmt: *const fdp1_fmt) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fdp1_q_data {
    pub fmt: *const fdp1_fmt,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fdp1_field_buffer {
    pub vb: *mut vb2_v4l2_buffer,
    pub addrs: [dma_addr_t; 3],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fdp1_buffer {
    pub m2m_buf: v4l2_m2m_buffer,
    pub fields: [fdp1_field_buffer; 2],
...
#[derive(Copy, Clone)]
pub struct fdp1_job {
    pub previous: *mut fdp1_field_buffer,
    pub active: *mut fdp1_field_buffer,
    pub next: *mut fdp1_field_buffer,
    pub dst: *mut fdp1_field_buffer,
...
pub struct fdp1_dev {
    ...
    pub device_process_lock: spinlock_t,
    pub regs: *mut void __iomem,
    pub irq: c_uint,
    pub dev: *mut device,
// Job Queues
    pub jobs: [fdp1_job; FDP1_NUMBER_JOBS],
    pub free_job_list: list_head,
    pub queued_job_list: list_head,
    pub hw_job_list: list_head,
    pub clk_rate: c_uint,
...
//
    pub fields_queue: list_head,
    pub buffers_queued: c_uint,
//
...
#[no_mangle]
unsafe extern "C" fn fdp1_job_free(fdp1: *mut fdp1_dev, job: *mut fdp1_job) {
...
#[no_mangle]
unsafe extern "C" fn queue_job(fdp1: *mut fdp1_dev, job: *mut fdp1_job) {
...
#[no_mangle]
unsafe extern "C" fn queue_hw_job(fdp1: *mut fdp1_dev, job: *mut fdp1_job) {
...
#[no_mangle]
unsafe extern "C" fn fdp1_read(fdp1: *mut fdp1_dev, reg: c_uint) -> u32 {
    static u32 fdp1_read(struct fdp1_dev *fdp1, unsigned int reg)
    {
    let mut value: u32 = ioread32(fdp1.regs + reg);
    if (debug >= 2)
    dprintk(fdp1, "Read 0x%08x from 0x%04x\n", value, reg);
    return value;
    }
#[no_mangle]
unsafe extern "C" fn fdp1_write(fdp1: *mut fdp1_dev, val: u32, reg: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn fdp1_set_ipc_dli(ctx: *mut fdp1_ctx) {
...
#[no_mangle]
unsafe extern "C" fn fdp1_set_ipc_sensor(ctx: *mut fdp1_ctx) {
    static void fdp1_set_ipc_sensor(struct fdp1_ctx *ctx)
    {
    struct fdp1_dev *fdp1 = ctx.fdp1;
    struct fdp1_q_data *src_q_data = &ctx.out_q;
    unsigned int x0, x1;
    let mut hsize: c_uint = src_q_data.format.width;
    let mut vsize: c_uint = src_q_data.format.height;
    x0 = hsize / 3;
    x1 = 2 * hsize / 3;
...
#[no_mangle]
unsafe extern "C" fn fdp1_set_lut(fdp1: *mut fdp1_dev) {
...
// WPF Swap needs both ISWAP and OSWAP setting
    ...
    {
    struct fdp1_dev *fdp1 = ctx.fdp1;
    let mut opmode: u32 = FD1_CTL_OPMODE_VIMD_NOINTERRUPT;
...
//
#[no_mangle]
unsafe extern "C" fn fdp1_device_process(ctx: *mut fdp1_ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fdp1_m2m_job_ready(priv: *mut c_void) -> c_int {
    static int fdp1_m2m_job_ready(void *priv)
    {
    struct fdp1_ctx *ctx = priv;
    struct fdp1_q_data *src_q_data = &ctx.out_q;
    let mut srcbufs: c_int = 1;
    let mut dstbufs: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn fdp1_m2m_job_abort(priv: *mut c_void) {
...
//
    ...
    struct fdp1_dev *fdp1 = ctx.fdp1;
    struct fdp1_job *job;
    let mut buffers_required: c_uint = 1;
    dprintk(fdp1, "+\n");
...
//
#[no_mangle]
unsafe extern "C" fn fdp1_m2m_device_run(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn fdp1_enum_fmt(f: *mut v4l2_fmtdesc, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fdp1_g_fmt(file: *mut file, priv: *mut c_void, f: *mut v4l2_format) -> c_int {
...
// Compute and clamp the stride and image size.
    ...
    let mut hsub: c_uint = i > 0 ? fmt.hsub : 1;
    let mut vsub: c_uint = i > 0 ? fmt.vsub : 1;
// From VSP : TODO: Confirm alignment limits for FDP1
    let mut align: c_uint = 128;
    unsigned int bpl;
...
#[no_mangle]
unsafe extern "C" fn fdp1_try_fmt(file: *mut file, priv: *mut c_void, f: *mut v4l2_format) -> c_int {
    static int fdp1_try_fmt(struct file *file, void *priv, struct v4l2_format *f)
    {
    struct fdp1_ctx *ctx = file_to_ctx(file);
    if (f.type == V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE)
    fdp1_try_fmt_output(ctx, core::ptr::null_mut(), &f.fmt.pix_mp);
    else
    fdp1_try_fmt_capture(ctx, core::ptr::null_mut(), &f.fmt.pix_mp);
...
#[no_mangle]
unsafe extern "C" fn fdp1_s_fmt(file: *mut file, priv: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fdp1_g_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fdp1_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fdp1_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fdp1_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn fdp1_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
//
    ...
    if (ctx.smsk_cpu == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn fdp1_stop_streaming(q: *mut vb2_queue) {
...
// Free smsk_data
    ...
    ctx.smsk_cpu = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn fdp1_open(file: *mut file) -> c_int {
    static int fdp1_open(struct file *file)
    {
    struct fdp1_dev *fdp1 = video_drvdata(file);
    struct v4l2_pix_format_mplane format;
    struct fdp1_ctx *ctx = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fdp1_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fdp1_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(int_status: FD1_CTL_IRQ_FREE &) -> else {
    else if (FD1_CTL_IRQ_FREE & int_status)
    device_frame_end(fdp1, VB2_BUF_STATE_DONE);
    return IRQ_HANDLED;
    }
#[no_mangle]
unsafe extern "C" fn fdp1_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fdp1_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn fdp1_pm_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fdp1_pm_runtime_resume(dev: *mut device) -> c_int {
...
// Program in the static LUTs
    ...
    RUNTIME_PM_OPS(fdp1_pm_runtime_suspend, fdp1_pm_runtime_resume, core::ptr::null_mut())
    };
