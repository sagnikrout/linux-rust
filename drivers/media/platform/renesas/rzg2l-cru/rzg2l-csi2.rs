...
//! Source: drivers/media/platform/renesas/rzg2l-cru/rzg2l-csi2.c
#![no_std]
...
pub const CSI2nMCG: c_uint = 0x0;

// Module Control Register 0
pub const CSI2nMCT0: c_uint = 0x10;

// Module Control Register 2
pub const CSI2nMCT2: c_uint = 0x18;

// Module Control Register 3
pub const CSI2nMCT3: c_uint = 0x1c;

// Reset Control Register
pub const CSI2nRTCT: c_uint = 0x28;

// Reset Status Register
pub const CSI2nRTST: c_uint = 0x2c;

// Receive Data Type Enable Low Register
pub const CSI2nDTEL: c_uint = 0x60;
// Receive Data Type Enable High Register
pub const CSI2nDTEH: c_uint = 0x64;
// DPHY registers
// D-PHY Control Register 0
pub const CSIDPHYCTRL0: c_uint = 0x400;

// D-PHY Timing Register 0
pub const CSIDPHYTIM0: c_uint = 0x404;

// D-PHY Timing Register 1
pub const CSIDPHYTIM1: c_uint = 0x408;

// D-PHY Skew Adjustment Function
pub const CSIDPHYSKW0: c_uint = 0x460;

    CSIDPHYSKW0_UTIL_DL1_SKW_ADJ(1) | \
    CSIDPHYSKW0_UTIL_DL2_SKW_ADJ(1) | \
    CSIDPHYSKW0_UTIL_DL3_SKW_ADJ(1))
// DPHY registers on RZ/V2H(P) SoC
pub const CRUm_S_TIMCTL: c_uint = 0x41c;

pub const CRUm_S_DPHYCTL_MSB: c_uint = 0x434;

pub const CRUm_SWAPCTL: c_uint = 0x438;
pub const VSRSTS_RETRIES: c_int = 20;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_csi2 {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub presetn: *mut reset_control,
    pub cmn_rstb: *mut reset_control,
    pub info: *const rzg2l_csi2_info,
    pub sysclk: *mut clk,
    pub vclk: *mut clk,
    pub vclk_rate: c_ulong,
    pub subdev: v4l2_subdev,
    pub pads: [media_pad; NR_OF_RZG2L_CSI2_PAD],
    pub notifier: v4l2_async_notifier,
    pub remote_source: *mut v4l2_subdev,
    pub lanes: c_ushort,
    pub hsfreq: c_ulong,
    pub dphy_enabled: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_csi2_info {
    pub csi2): *mut *mut int (dphy_enable)(struct rzg2l_csi2,
    pub csi2): *mut *mut int (dphy_disable)(struct rzg2l_csi2,
    pub has_system_clk: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_csi2_timings {
    pub t_init: u32,
    pub tclk_miss: u32,
    pub tclk_settle: u32,
    pub ths_settle: u32,
    pub tclk_prepare: u32,
    pub ths_prepare: u32,
    pub max_hsfreq: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzv2h_csi2_s_hssettlectl {
    pub hsfreq: c_uint,
    pub s_hssettlectl: u16,
}
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_read(csi2: *mut rzg2l_csi2, reg: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_set(csi2: *mut rzg2l_csi2, reg: c_uint, set: u32) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_clr(csi2: *mut rzg2l_csi2, reg: c_uint, clr: u32) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_calc_mbps(csi2: *mut rzg2l_csi2) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_dphy_disable(csi2: *mut rzg2l_csi2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_dphy_enable(csi2: *mut rzg2l_csi2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_dphy_setting(sd: *mut v4l2_subdev, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_mipi_link_enable(csi2: *mut rzg2l_csi2) -> c_int {
    static int rzg2l_csi2_mipi_link_enable(struct rzg2l_csi2 *csi2)
    {
    let mut vclk_rate: c_ulong = csi2.vclk_rate / HZ_PER_MHZ;
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_mipi_link_disable(csi2: *mut rzg2l_csi2) -> c_int {
    static int rzg2l_csi2_mipi_link_disable(struct rzg2l_csi2 *csi2)
    {
    let mut timeout: c_uint = VSRSTS_RETRIES;
// Stop LINK reception
...
#[no_mangle]
unsafe extern "C" fn rzv2h_csi2_dphy_disable(csi2: *mut rzg2l_csi2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_csi2_dphy_enable(csi2: *mut rzg2l_csi2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_mipi_link_setting(sd: *mut v4l2_subdev, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
    static int rzg2l_csi2_s_stream(struct v4l2_subdev *sd, int enable)
    {
    struct rzg2l_csi2 *csi2 = sd_to_csi2(sd);
    let mut s_stream_ret: c_int = 0;
    int ret;
    if (enable) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_pre_streamon(sd: *mut v4l2_subdev, flags: u32) -> c_int {
    static int rzg2l_csi2_pre_streamon(struct v4l2_subdev *sd, u32 flags)
    {
    return rzg2l_csi2_dphy_setting(sd, 1);
    }
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_post_streamoff(sd: *mut v4l2_subdev) -> c_int {
...
// src_format = *sink_format;
    ...
    {
    let mut fmt: v4l2_subdev_format = { .pad = RZG2L_CSI2_SINK, };
    struct rzg2l_csi2 *csi2 = sd_to_csi2(sd);
...
//
    ...
    {
    struct rzg2l_csi2 *csi2 = notifier_to_csi2(notifier);
    csi2.remote_source = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_parse_dt(csi2: *mut rzg2l_csi2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_validate_csi2_lanes(csi2: *mut rzg2l_csi2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_pm_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_csi2_pm_runtime_resume(dev: *mut device) -> c_int {
    ...
    rzg2l_csi2_pm_runtime_resume, core::ptr::null_mut())
    };
