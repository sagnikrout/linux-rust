...
//! Source: drivers/media/platform/renesas/rzg2l-cru/rzg2l-video.c
#![no_std]
...
pub const RZG2L_TIMEOUT_MS: c_int = 100;
pub const RZG2L_RETRIES: c_int = 10;

pub const RZG2L_CRU_STRIDE_MAX: c_int = 32640;
pub const RZG2L_CRU_STRIDE_ALIGN: c_int = 128;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_cru_buffer {
...
//
#[no_mangle]
unsafe extern "C" fn __rzg2l_cru_write(cru: *mut rzg2l_cru_dev, offset: u32, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn __rzg2l_cru_read(cru: *mut rzg2l_cru_dev, offset: u32) -> u32 {
...
// Return the buffer in progress first, if not completed yet.
    let mut slot: c_uint = cru.active_slot;
    if (cru.queue_buf[slot]) {
    vb2_buffer_done(&cru.queue_buf[slot].vb2_buf, state);
    cru.queue_buf[slot] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_buffer_queue(vb: *mut vb2_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_fill_hw_slot(cru: *mut rzg2l_cru_dev, slot: c_int) {
...
// Direct frames to the scratch buffer.
    ...
    cru.queue_buf[next_slot] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_initialize_axi(cru: *mut rzg2l_cru_dev) {
...
//
    ...
    if (info.has_stride) {
    let mut stride: u32 = cru.format.bytesperline;
    u32 amnis;
...
#[no_mangle]
pub unsafe extern "C" fn rzg3e_fifo_empty(cru: *mut rzg2l_cru_dev) -> bool {
    bool rzg3e_fifo_empty(struct rzg2l_cru_dev *cru)
    {
    let mut amnfifopntr: u32 = rzg2l_cru_read(cru, AMnFIFOPNTR);
...
#[no_mangle]
pub unsafe extern "C" fn rzg2l_fifo_empty(cru: *mut rzg2l_cru_dev) -> bool {
    ...
    let mut amnfifopntr_w: return = = amnfifopntr_r_y;
    }
#[no_mangle]
pub unsafe extern "C" fn rzg2l_cru_stop_image_processing(cru: *mut rzg2l_cru_dev) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_get_virtual_channel(cru: *mut rzg2l_cru_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rzg3e_cru_enable_interrupts(cru: *mut rzg2l_cru_dev) {
    void rzg3e_cru_enable_interrupts(struct rzg2l_cru_dev *cru)
    {
    rzg2l_cru_write(cru, CRUnIE2, CRUnIE2_FExE(cru.svc_channel));
    }
#[no_mangle]
pub unsafe extern "C" fn rzg3e_cru_disable_interrupts(cru: *mut rzg2l_cru_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn rzg2l_cru_enable_interrupts(cru: *mut rzg2l_cru_dev) {
    void rzg2l_cru_enable_interrupts(struct rzg2l_cru_dev *cru)
    {
    rzg2l_cru_write(cru, CRUnIE, CRUnIE_EFE);
    }
#[no_mangle]
pub unsafe extern "C" fn rzg2l_cru_disable_interrupts(cru: *mut rzg2l_cru_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn rzg2l_cru_start_image_processing(cru: *mut rzg2l_cru_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_set_stream(cru: *mut rzg2l_cru_dev, on: c_int) -> c_int {
    ...
    if (!on) {
    let mut stream_off_ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_stop_streaming(cru: *mut rzg2l_cru_dev) {
    static void rzg2l_cru_stop_streaming(struct rzg2l_cru_dev *cru)
    {
    rzg2l_cru_set_stream(cru, 0);
    }
#[no_mangle]
pub unsafe extern "C" fn rzg2l_cru_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn rzg3e_cru_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_start_streaming_vq(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_stop_streaming_vq(vq: *mut vb2_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn rzg2l_cru_dma_unregister(cru: *mut rzg2l_cru_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn rzg2l_cru_dma_register(cru: *mut rzg2l_cru_dev) -> c_int {
...
// Initialize the top-level structure
    ...
    cru.queue_buf[i] = core::ptr::null_mut();
// buffer queue
...
//
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_release(file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_video_link_validate(link: *mut media_link) -> c_int {
    ...
    ret = v4l2_subdev_call(subdev, pad, get_fmt, core::ptr::null_mut(), &fmt);
    if (ret < 0)
    let mut ret: return = = -ENOIOCTLCMD ? -EINVAL : ret;
...
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_v4l2_init(cru: *mut rzg2l_cru_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn rzg2l_cru_video_unregister(cru: *mut rzg2l_cru_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn rzg2l_cru_video_register(cru: *mut rzg2l_cru_dev) -> c_int {
