...
//! Source: drivers/media/platform/renesas/rzg2l-cru/rzg2l-ip.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_ip_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
// src_format = *sink_format;
    ...
    {
    let mut fmt: v4l2_subdev_format = { .pad = RZG2L_CRU_IP_SINK, };
...
#[no_mangle]
pub unsafe extern "C" fn rzg2l_cru_ip_subdev_register(cru: *mut rzg2l_cru_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rzg2l_cru_ip_subdev_unregister(cru: *mut rzg2l_cru_dev) {
