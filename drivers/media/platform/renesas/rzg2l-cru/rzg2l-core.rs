...
//! Source: drivers/media/platform/renesas/rzg2l-cru/rzg2l-core.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_group_notify_complete(notifier: *mut v4l2_async_notifier) -> c_int {
...
// Create media device link between CRU IP <-> CRU OUTPUT
    ...
    if (cru.csi.asd == asd) {
    cru.csi.subdev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_mc_parse_of(cru: *mut rzg2l_cru_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_mc_parse_of_graph(cru: *mut rzg2l_cru_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_media_init(cru: *mut rzg2l_cru_dev) -> c_int {
    static int rzg2l_cru_media_init(struct rzg2l_cru_dev *cru)
    {
    struct media_device *mdev = core::ptr::null_mut();
    ...
    if (ret) {
    mutex_lock(&cru.mdev_lock);
    cru.v4l2_dev.mdev = core::ptr::null_mut();
    mutex_unlock(&cru.mdev_lock);
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_cru_remove(pdev: *mut platform_device) {
