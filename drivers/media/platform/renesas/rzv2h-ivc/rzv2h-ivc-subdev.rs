...
//! Source: drivers/media/platform/renesas/rzv2h-ivc/rzv2h-ivc-subdev.c
#![no_std]
...
pub const RZV2H_IVC_N_INPUTS_PER_OUTPUT: c_int = 6;
//
...
#[no_mangle]
unsafe extern "C" fn rzv2h_ivc_get_mbus_output_from_input(mbus_code: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_ivc_registered(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_ivc_link_validate(link: *mut media_link) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rzv2h_ivc_initialise_subdevice(ivc: *mut rzv2h_ivc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rzv2h_ivc_deinit_subdevice(ivc: *mut rzv2h_ivc) {
