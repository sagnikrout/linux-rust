...
//! Source: drivers/media/platform/renesas/rzv2h-ivc/rzv2h-ivc-video.c
#![no_std]
...
pub const RZV2H_IVC_FIXED_HBLANK: c_uint = 0x20;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzv2h_ivc_buf {
...
#[no_mangle]
pub unsafe extern "C" fn rzv2h_ivc_buffer_done(ivc: *mut rzv2h_ivc) {
    ...
    ivc.buffers.curr = core::ptr::null_mut();
    }
    buf.vb.sequence = ivc.buffers.sequence++;
    vb2_buffer_done(&buf.vb.vb2_buf, VB2_BUF_STATE_DONE);
    }
#[no_mangle]
pub unsafe extern "C" fn rzv2h_ivc_transfer_buffer(ivc: *mut rzv2h_ivc) {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_ivc_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_ivc_format_configure(ivc: *mut rzv2h_ivc) {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_ivc_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_ivc_stop_streaming(q: *mut vb2_queue) {
    static void rzv2h_ivc_stop_streaming(struct vb2_queue *q)
    {
    struct rzv2h_ivc *ivc = vb2_get_drv_priv(q);
    let mut loop: c_uint = 5;
//
...
#[no_mangle]
pub unsafe extern "C" fn rzv2h_ivc_init_vdev(ivc: *mut rzv2h_ivc, v4l2_dev: *mut v4l2_device) -> c_int {
    int rzv2h_ivc_init_vdev(struct rzv2h_ivc *ivc, struct v4l2_device *v4l2_dev)
    {
    let mut pix: v4l2_pix_format_mplane = { };
...
#[no_mangle]
pub unsafe extern "C" fn rzv2h_deinit_video_dev_and_queue(ivc: *mut rzv2h_ivc) {
