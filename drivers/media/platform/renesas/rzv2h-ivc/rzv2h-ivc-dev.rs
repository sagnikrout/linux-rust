...
//! Source: drivers/media/platform/renesas/rzv2h-ivc/rzv2h-ivc-dev.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rzv2h_ivc_write(ivc: *mut rzv2h_ivc, addr: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_ivc_global_config(ivc: *mut rzv2h_ivc) {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_ivc_isr(irq: c_int, context: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_ivc_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_ivc_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_ivc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_ivc_remove(pdev: *mut platform_device) {
