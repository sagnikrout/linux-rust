...
//! Source: drivers/media/platform/allegro-dvt/allegro-core.c
#![no_std]
...
//
pub const ALLEGRO_WIDTH_MIN: c_int = 128;
pub const ALLEGRO_WIDTH_DEFAULT: c_int = 1920;
pub const ALLEGRO_WIDTH_MAX: c_int = 3840;
pub const ALLEGRO_HEIGHT_MIN: c_int = 64;
pub const ALLEGRO_HEIGHT_DEFAULT: c_int = 1080;
pub const ALLEGRO_HEIGHT_MAX: c_int = 2160;

pub const ALLEGRO_GOP_SIZE_DEFAULT: c_int = 25;
pub const ALLEGRO_GOP_SIZE_MAX: c_int = 1000;
//
...
//
pub const AL5_MCU_RESET: c_uint = 0x0000;

pub const AL5_MCU_RESET_MODE: c_uint = 0x0004;

pub const AL5_MCU_STA: c_uint = 0x0008;

pub const AL5_MCU_WAKEUP: c_uint = 0x000c;
pub const AL5_ICACHE_ADDR_OFFSET_MSB: c_uint = 0x0010;
pub const AL5_ICACHE_ADDR_OFFSET_LSB: c_uint = 0x0014;
pub const AL5_DCACHE_ADDR_OFFSET_MSB: c_uint = 0x0018;
pub const AL5_DCACHE_ADDR_OFFSET_LSB: c_uint = 0x001c;
pub const AL5_MCU_INTERRUPT: c_uint = 0x0100;
pub const AL5_ITC_CPU_IRQ_MSK: c_uint = 0x0104;
pub const AL5_ITC_CPU_IRQ_CLR: c_uint = 0x0108;
pub const AL5_ITC_CPU_IRQ_STA: c_uint = 0x010C;

pub const AXI_ADDR_OFFSET_IP: c_uint = 0x0208;
//
...
pub const SIZE_MACROBLOCK: c_int = 16;
// Encoding options
pub const LOG2_MAX_FRAME_NUM: c_int = 4;
pub const LOG2_MAX_PIC_ORDER_CNT: c_int = 10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct allegro_mbox {
    pub dev: *mut allegro_dev,
    pub head: c_uint,
    pub tail: c_uint,
    pub data: c_uint,
    pub size: usize,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct allegro_encoder_buffer {
    pub size: c_uint,
...
// mutex protecting vb2_queue structure
    ...
    pub sram: *mut regmap,
    pub settings: *mut regmap,
    pub clk_core: *mut clk,
    pub clk_mcu: *mut clk,
    pub fw_info: *const fw_info,
    pub firmware: allegro_buffer,
    pub suballocator: allegro_buffer,
    pub has_encoder_buffer: bool,
    pub encoder_buffer: allegro_encoder_buffer,
    pub init_complete: completion,
    pub initialized: bool,
// The mailbox interface
    pub mbox_command: *mut allegro_mbox,
    pub mbox_status: *mut allegro_mbox,
//
...
pub struct allegro_channel {
    ...
    pub height: c_uint,
    pub stride: c_uint,
    pub framerate: v4l2_fract,
    pub colorspace: enum v4l2_colorspace,
    pub ycbcr_enc: enum v4l2_ycbcr_encoding,
    pub quantization: enum v4l2_quantization,
    pub xfer_func: enum v4l2_xfer_func,
    pub pixelformat: u32,
    pub sizeimage_raw: c_uint,
    pub osequence: c_uint,
    pub codec: u32,
    pub sizeimage_encoded: c_uint,
    pub csequence: c_uint,
    pub frame_rc_enable: bool,
    pub bitrate: c_uint,
    pub bitrate_peak: c_uint,
    pub config_blob: allegro_buffer,
    pub log2_max_frame_num: c_uint,
    pub temporal_mvp_enable: bool,
    pub enable_loop_filter_across_tiles: bool,
    pub enable_loop_filter_across_slices: bool,
    pub enable_deblocking_filter_override: bool,
    pub enable_reordering: bool,
    pub dbf_ovr_en: bool,
    pub num_ref_idx_l0: c_uint,
    pub num_ref_idx_l1: c_uint,
// Maximum range for motion estimation
    pub b_hrz_me_range: c_int,
    pub b_vrt_me_range: c_int,
    pub p_hrz_me_range: c_int,
    pub p_vrt_me_range: c_int,
// Size limits of coding unit
    pub min_cu_size: c_int,
    pub max_cu_size: c_int,
// Size limits of transform unit
    pub min_tu_size: c_int,
    pub max_tu_size: c_int,
    pub max_transfo_depth_intra: c_int,
    pub max_transfo_depth_inter: c_int,
    pub mpeg_video_h264_profile: *mut v4l2_ctrl,
    pub mpeg_video_h264_level: *mut v4l2_ctrl,
    pub mpeg_video_h264_i_frame_qp: *mut v4l2_ctrl,
    pub mpeg_video_h264_max_qp: *mut v4l2_ctrl,
    pub mpeg_video_h264_min_qp: *mut v4l2_ctrl,
    pub mpeg_video_h264_p_frame_qp: *mut v4l2_ctrl,
    pub mpeg_video_h264_b_frame_qp: *mut v4l2_ctrl,
    pub mpeg_video_hevc_profile: *mut v4l2_ctrl,
    pub mpeg_video_hevc_level: *mut v4l2_ctrl,
    pub mpeg_video_hevc_tier: *mut v4l2_ctrl,
    pub mpeg_video_hevc_i_frame_qp: *mut v4l2_ctrl,
    pub mpeg_video_hevc_max_qp: *mut v4l2_ctrl,
    pub mpeg_video_hevc_min_qp: *mut v4l2_ctrl,
    pub mpeg_video_hevc_p_frame_qp: *mut v4l2_ctrl,
    pub mpeg_video_hevc_b_frame_qp: *mut v4l2_ctrl,
    pub mpeg_video_frame_rc_enable: *mut v4l2_ctrl,
    struct { /* video bitrate mode control cluster */
    pub mpeg_video_bitrate_mode: *mut v4l2_ctrl,
    pub mpeg_video_bitrate: *mut v4l2_ctrl,
    pub mpeg_video_bitrate_peak: *mut v4l2_ctrl,
}
...
pub struct fw_info {
    ...
    pub mailbox_cmd: c_uint,
    pub mailbox_status: c_uint,
    pub mailbox_size: usize,
    pub mailbox_version: enum mcu_msg_version,
    pub suballocator_size: usize,
}
...
#[no_mangle]
pub unsafe extern "C" fn to_mcu_addr(dev: *mut allegro_dev, phys: dma_addr_t) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn to_mcu_size(dev: *mut allegro_dev, size: usize) -> u32 {
    static inline u32 to_mcu_size(struct allegro_dev *dev, size_t size)
    {
    return lower_32_bits(size);
    }
#[no_mangle]
pub unsafe extern "C" fn to_codec_addr(dev: *mut allegro_dev, phys: dma_addr_t) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ptr_to_u64(ptr: *const c_void) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn allegro_next_user_id(dev: *mut allegro_dev) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn allegro_free_channel(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn allegro_ref_put_channel(channel: *mut allegro_channel) -> c_int {
    static int allegro_ref_put_channel(struct allegro_channel *channel)
    {
    return kref_put(&channel.ref, allegro_free_channel);
    }
#[no_mangle]
pub unsafe extern "C" fn channel_exists(channel: *mut allegro_channel) -> bool {
    static inline bool channel_exists(struct allegro_channel *channel)
    {
    return channel.mcu_channel_id != -1;
    }
pub const AL_ERROR: c_uint = 0x80;
pub const AL_ERR_INIT_FAILED: c_uint = 0x81;
pub const AL_ERR_NO_FRAME_DECODED: c_uint = 0x82;
pub const AL_ERR_RESOLUTION_CHANGE: c_uint = 0x85;
pub const AL_ERR_NO_MEMORY: c_uint = 0x87;
pub const AL_ERR_STREAM_OVERFLOW: c_uint = 0x88;
pub const AL_ERR_TOO_MANY_SLICES: c_uint = 0x89;
pub const AL_ERR_BUF_NOT_READY: c_uint = 0x8c;
pub const AL_ERR_NO_CHANNEL_AVAILABLE: c_uint = 0x8d;
pub const AL_ERR_RESOURCE_UNAVAILABLE: c_uint = 0x8e;
pub const AL_ERR_NOT_ENOUGH_CORES: c_uint = 0x8f;
pub const AL_ERR_REQUEST_MALFORMED: c_uint = 0x90;
pub const AL_ERR_CMD_NOT_ALLOWED: c_uint = 0x91;
pub const AL_ERR_INVALID_CMD_VALUE: c_uint = 0x92;
    ...
    unsigned int height)
    {
    let mut offset: c_uint = ENCODER_STREAM_OFFSET;
    unsigned int num_blocks = DIV_ROUND_UP(width, SIZE_MACROBLOCK) *
    DIV_ROUND_UP(height, SIZE_MACROBLOCK);
    let mut pcm_size: c_uint = SZ_256;
    let mut partition_table: c_uint = SZ_256;
    ...
    {
    let mut pic_width_in_mb: c_uint = DIV_ROUND_UP(width, SIZE_MACROBLOCK);
    let mut frame_height_in_mb: c_uint = DIV_ROUND_UP(height, SIZE_MACROBLOCK);
    let mut frame_size_in_mb: c_uint = pic_width_in_mb * frame_height_in_mb;
    let mut level: enum v4l2_mpeg_video_h264_level = V4L2_MPEG_VIDEO_H264_LEVEL_4_0;
//
...
#[no_mangle]
unsafe extern "C" fn h264_maximum_bitrate(level: enum v4l2_mpeg_video_h264_level) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn h264_maximum_cpb_size(level: enum v4l2_mpeg_video_h264_level) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn hevc_maximum_bitrate(level: enum v4l2_mpeg_video_hevc_level) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn hevc_maximum_cpb_size(level: enum v4l2_mpeg_video_hevc_level) -> c_uint {
    ...
    {
    int i;
    let mut id: c_uint = fw.size;
    let mut id_codec: c_uint = fw_codec.size;
...
//
    ...
    buffer.vaddr = core::ptr::null_mut();
    buffer.size = 0;
    }
    }
//
...
//
    ...
    size_t size_no_wrap;
    let mut err: c_int = 0;
    let mut stride: c_int = regmap_get_reg_stride(sram);
    if (!src)
    return -EINVAL;
    if (size > mbox.size)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn allegro_mbox_get_available(mbox: *mut allegro_mbox) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn allegro_mbox_send(mbox: *mut allegro_mbox, msg: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn allegro_mbox_notify(mbox: *mut allegro_mbox) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v4l2_pixelformat_to_mcu_format(pixelformat: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn v4l2_colorspace_to_mcu_colorspace(colorspace: enum v4l2_colorspace) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn v4l2_profile_to_mcu_profile(profile: enum v4l2_mpeg_video_h264_profile) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn v4l2_level_to_mcu_level(level: enum v4l2_mpeg_video_h264_level) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn hevc_profile_to_mcu_profile(profile: enum v4l2_mpeg_video_hevc_profile) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn hevc_level_to_mcu_level(level: enum v4l2_mpeg_video_hevc_level) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn hevc_tier_to_mcu_tier(tier: enum v4l2_mpeg_video_hevc_tier) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn v4l2_cpb_size_to_mcu(cpb_size: c_uint, bitrate: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn get_qp_delta(minuend: c_int, subtrahend: c_int) -> i16 {
...
#[no_mangle]
unsafe extern "C" fn allegro_channel_get_entropy_mode(channel: *mut allegro_channel) -> u32 {
    static u32 allegro_channel_get_entropy_mode(struct allegro_channel *channel)
    {
pub const ALLEGRO_ENTROPY_MODE_CAVLC: c_int = 0;
pub const ALLEGRO_ENTROPY_MODE_CABAC: c_int = 1;
// HEVC always uses CABAC, but this has to be explicitly set
    ...
    {
    let mut i_frame_qp: c_int = allegro_channel_get_i_frame_qp(channel);
    let mut p_frame_qp: c_int = allegro_channel_get_p_frame_qp(channel);
    let mut b_frame_qp: c_int = allegro_channel_get_b_frame_qp(channel);
    let mut bitrate_mode: c_int = v4l2_ctrl_g_ctrl(channel.mpeg_video_bitrate_mode);
    let mut cpb_size: c_uint = v4l2_ctrl_g_ctrl(channel.mpeg_video_cpb_size);
...
// copied to mcu_msg_encode_frame_response
    ...
    let mut use_encoder_buffer: bool = v4l2_ctrl_g_ctrl(channel.encoder_buffer);
    memset(&msg, 0, sizeof(msg));
...
#[no_mangle]
unsafe extern "C" fn allegro_mcu_push_buffer_intermediate(channel: *mut allegro_channel) -> c_int {
    static int allegro_mcu_push_buffer_intermediate(struct allegro_channel *channel)
    {
    let mut type: enum mcu_msg_type = MCU_MSG_TYPE_PUSH_BUFFER_INTERMEDIATE;
    return allegro_mcu_push_buffer_internal(channel, type);
    }
#[no_mangle]
unsafe extern "C" fn allegro_mcu_push_buffer_reference(channel: *mut allegro_channel) -> c_int {
    static int allegro_mcu_push_buffer_reference(struct allegro_channel *channel)
    {
    let mut type: enum mcu_msg_type = MCU_MSG_TYPE_PUSH_BUFFER_REFERENCE;
    return allegro_mcu_push_buffer_internal(channel, type);
    }
...
#[no_mangle]
unsafe extern "C" fn destroy_reference_buffers(channel: *mut allegro_channel) {
...
#[no_mangle]
unsafe extern "C" fn destroy_intermediate_buffers(channel: *mut allegro_channel) {
    ...
    ssize_t size;
    let mut size_mb: c_uint = SIZE_MACROBLOCK;
// Calculation of crop units in Rec. ITU-T H.264 (04/2017) p. 76
    let mut crop_unit_x: c_uint = 2;
    let mut crop_unit_y: c_uint = 2;
    enum v4l2_mpeg_video_h264_profile profile;
    enum v4l2_mpeg_video_h264_level level;
...
#[no_mangle]
unsafe extern "C" fn allegro_channel_eos_event(channel: *mut allegro_channel) {
    ...
    ssize_t size;
    let mut num_ref_frames: c_uint = channel.num_ref_idx_l0;
    let mut profile: i32 = v4l2_ctrl_g_ctrl(channel.mpeg_video_hevc_profile);
    let mut level: i32 = v4l2_ctrl_g_ctrl(channel.mpeg_video_hevc_level);
    let mut tier: i32 = v4l2_ctrl_g_ctrl(channel.mpeg_video_hevc_tier);
    vps = kzalloc_obj(*vps);
    if (!vps)
    return -ENOMEM;
    ...
    struct vb2_v4l2_buffer *buffer = core::ptr::null_mut();
    mutex_lock(&channel.shadow_list_lock);
    ...
    let mut state: enum vb2_buffer_state = VB2_BUF_STATE_ERROR;
    char *curr;
    ssize_t len;
    ssize_t free;
...
#[no_mangle]
unsafe extern "C" fn allegro_hardirq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn allegro_irq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn allegro_free_fw_codec(dev: *mut allegro_dev) {
...
#[no_mangle]
unsafe extern "C" fn allegro_mcu_start(dev: *mut allegro_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn allegro_mcu_reset(dev: *mut allegro_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn allegro_mcu_interrupt(dev: *mut allegro_dev) {
    static void allegro_mcu_interrupt(struct allegro_dev *dev)
    {
    regmap_write(dev.regmap, AL5_MCU_INTERRUPT, BIT(0));
    }
#[no_mangle]
unsafe extern "C" fn allegro_destroy_channel(channel: *mut allegro_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn allegro_create_channel(channel: *mut allegro_channel) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn allegro_channel_adjust(channel: *mut allegro_channel) {
    static void allegro_channel_adjust(struct allegro_channel *channel)
    {
    struct allegro_dev *dev = channel.dev;
    let mut codec: u32 = channel.codec;
...
#[no_mangle]
unsafe extern "C" fn allegro_set_default_params(channel: *mut allegro_channel) {
...
#[no_mangle]
unsafe extern "C" fn allegro_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn allegro_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn allegro_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn allegro_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_CID_MPEG_VIDEO_H264_P_FRAME_QP: ctrl->id ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn allegro_try_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn allegro_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn allegro_open(file: *mut file) -> c_int {
    static int allegro_open(struct file *file)
    {
    struct video_device *vdev = video_devdata(file);
    struct allegro_dev *dev = video_get_drvdata(vdev);
    struct allegro_channel *channel = core::ptr::null_mut();
    ...
    &allegro_encoder_buffer_ctrl_config, core::ptr::null_mut());
    v4l2_ctrl_new_std(handler,
    &allegro_ctrl_ops,
...
#[no_mangle]
unsafe extern "C" fn allegro_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn allegro_channel_cmd_stop(channel: *mut allegro_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn allegro_channel_cmd_start(channel: *mut allegro_channel) -> c_int {
    ...
    switch (sub.type) {
    case V4L2_EVENT_EOS:
    return v4l2_event_subscribe(fh, sub, 0, core::ptr::null_mut());
    default:
...
#[no_mangle]
unsafe extern "C" fn allegro_register_device(dev: *mut allegro_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn allegro_device_run(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn allegro_mcu_hw_deinit(dev: *mut allegro_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn allegro_fw_callback(fw: *const firmware, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn allegro_firmware_request_nowait(dev: *mut allegro_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn allegro_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn allegro_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn allegro_runtime_resume(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn allegro_runtime_suspend(device: *mut device) -> c_int {
