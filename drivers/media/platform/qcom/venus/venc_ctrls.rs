...
//! Source: drivers/media/platform/qcom/venus/venc_ctrls.c
#![no_std]
...
pub const BITRATE_MIN: c_int = 32000;
pub const BITRATE_MAX: c_int = 160000000;
pub const BITRATE_DEFAULT: c_int = 1000000;

pub const BITRATE_STEP: c_int = 100;
pub const SLICE_BYTE_SIZE_MAX: c_int = 1024;
pub const SLICE_BYTE_SIZE_MIN: c_int = 1024;
pub const SLICE_MB_SIZE_MAX: c_int = 300;

    V4L2_MPEG_VIDEO_H264_LOOP_FILTER_MODE_DISABLED_AT_SLICE_BOUNDARY
pub const MAX_LTR_FRAME_COUNT: c_int = 4;
#[no_mangle]
unsafe extern "C" fn venc_calc_bpframes(gop_size: u32, conseq_b: u32, bf: *mut u32, pf: *mut u32) -> c_int {
    static int venc_calc_bpframes(u32 gop_size, u32 conseq_b, u32 *bf, u32 *pf)
    {
    let mut half: u32 = (gop_size - 1) >> 1;
    u32 b, p, ratio;
...
// pf = p;
    ...
    let mut ptype: u32 = HFI_PROPERTY_CONFIG_VENC_TARGET_BITRATE;
    let mut brate: hfi_bitrate = { .bitrate = bitrate, .layer_id = layer_id };
...
unsafe extern "C" fn venc_op_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    let mut en: hfi_enable = { .enable = 1 };
...
#[no_mangle]
unsafe extern "C" fn venc_op_g_volatile_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn venc_ctrl_init(inst: *mut venus_inst) -> c_int {
    ...
    let mut p_hdr10_cll: v4l2_ctrl_hdr10_cll_info = { 1000, 400 };
