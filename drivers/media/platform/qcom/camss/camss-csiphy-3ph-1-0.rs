...
//! Source: drivers/media/platform/qcom/camss/camss-csiphy-3ph-1-0.c
#![no_std]
...
pub const CSIPHY_3PH_LNn_CFG4_T_HS_CLK_MISS: c_uint = 0xa4;
pub const CSIPHY_3PH_LNn_CFG4_T_HS_CLK_MISS_660: c_uint = 0xa5;

pub const CSIPHY_3PH_LNn_CFG5_T_HS_DTERM: c_uint = 0x02;
pub const CSIPHY_3PH_LNn_CFG5_HS_REC_EQ_FQ_INT: c_uint = 0x50;

pub const CSIPHY_3PH_LNn_TEST_IMP_HS_TERM_IMP: c_uint = 0xa;

pub const CSIPHY_3PH_LNn_CFG7_SWI_T_INIT: c_uint = 0x2;

pub const CSIPHY_3PH_LNn_CFG9_SWI_T_WAKEUP: c_uint = 0x1;

pub const CSIPHY_3PH_LNn_CSI_LANE_CTRL15_SWI_SOT_SYMBOL: c_uint = 0xb8;

    ((offset) + (common_status_offset) + 0x4 * (n))
pub const CSIPHY_DEFAULT_PARAMS: c_int = 0;
pub const CSIPHY_LANE_ENABLE: c_int = 1;
pub const CSIPHY_SETTLE_CNT_LOWER_BYTE: c_int = 2;
pub const CSIPHY_SETTLE_CNT_HIGHER_BYTE: c_int = 3;
pub const CSIPHY_DNP_PARAMS: c_int = 4;
pub const CSIPHY_2PH_REGS: c_int = 5;
pub const CSIPHY_3PH_REGS: c_int = 6;
pub const CSIPHY_SKEW_CAL: c_int = 7;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct csiphy_lane_regs {
    pub reg_addr: i32,
    pub reg_data: i32,
    pub delay_us: u32,
    pub csiphy_param_type: u32,
}
...
#[no_mangle]
unsafe extern "C" fn csiphy_is_gen2(version: u32) -> bool {
