...
//! Source: drivers/media/platform/qcom/camss/camss-vfe-4-7.c
#![no_std]
...
pub const VFE_0_BUS_BDG_QOS_CFG_0_CFG: c_uint = 0xaaa9aaa9;
...
pub const VFE_0_BUS_BDG_QOS_CFG_7_CFG: c_uint = 0x0001aaa9;
pub const VFE48_0_BUS_BDG_QOS_CFG_0_CFG: c_uint = 0xaaa5aaa5;
pub const VFE48_0_BUS_BDG_QOS_CFG_3_CFG: c_uint = 0xaa55aaa5;
pub const VFE48_0_BUS_BDG_QOS_CFG_4_CFG: c_uint = 0xaa55aa55;
pub const VFE48_0_BUS_BDG_QOS_CFG_7_CFG: c_uint = 0x0005aa55;
pub const VFE_0_BUS_BDG_DS_CFG_0: c_uint = 0x424;
pub const VFE_0_BUS_BDG_DS_CFG_0_CFG: c_uint = 0xcccc0011;
...
pub const VFE_0_BUS_BDG_DS_CFG_16_CFG: c_uint = 0x40000103;
pub const VFE48_0_BUS_BDG_DS_CFG_0_CFG: c_uint = 0xcccc1111;
pub const VFE48_0_BUS_BDG_DS_CFG_16_CFG: c_uint = 0x00000110;
...
pub const VFE48_0_BUS_IMAGE_MASTER_CMD: c_uint = 0xcec;
...
#[no_mangle]
pub unsafe extern "C" fn if(1: vfe_id ==) -> else {
    else if (vfe_id == 1)
