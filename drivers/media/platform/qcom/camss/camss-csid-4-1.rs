...
//! Source: drivers/media/platform/qcom/camss/camss-csid-4-1.c
#![no_std]
...
pub const CAMSS_CSID_RST_CMD: c_uint = 0x00c;

pub const CAMSS_CSID_CID_n_CFG_DECODE_FORMAT_SHIFT: c_int = 4;

pub const CAMSS_CSID_IRQ_CLEAR_CMD: c_uint = 0x060;
pub const CAMSS_CSID_IRQ_MASK: c_uint = 0x064;
pub const CAMSS_CSID_IRQ_STATUS: c_uint = 0x068;
pub const CAMSS_CSID_TG_CTRL: c_uint = 0x0a0;
pub const CAMSS_CSID_TG_CTRL_DISABLE: c_uint = 0xa06436;
pub const CAMSS_CSID_TG_CTRL_ENABLE: c_uint = 0xa06437;
pub const CAMSS_CSID_TG_VC_CFG: c_uint = 0x0a4;
