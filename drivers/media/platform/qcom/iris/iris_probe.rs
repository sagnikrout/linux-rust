...
//! Source: drivers/media/platform/qcom/iris/iris_probe.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn iris_init_icc(core: *mut iris_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_init_power_domains(core: *mut iris_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_init_clocks(core: *mut iris_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_init_resets(core: *mut iris_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_init_resources(core: *mut iris_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_register_video_device(core: *mut iris_core, type: enum domain_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_sys_error_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iris_pm_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn iris_pm_resume(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(iris_pm_suspend, iris_pm_resume, core::ptr::null_mut())
    };
