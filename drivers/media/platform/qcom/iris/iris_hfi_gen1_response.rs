...
//! Source: drivers/media/platform/qcom/iris/iris_hfi_gen1_response.c
#![no_std]
...
//
    ...
    let mut num_properties_changed: u32 = pkt.event_data2;
    ...
    let mut event: hfi_event_data = {0};
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_session_event_notify(inst: *mut iris_inst, packet: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_sys_init_done(core: *mut iris_core, packet: *mut c_void) {
    ...
    {
    let mut req_bytes: c_int = pkt.hdr.size - sizeof(*pkt);
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_sys_property_info(core: *mut iris_core, packet: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_session_etb_done(inst: *mut iris_inst, packet: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_session_ftb_done(inst: *mut iris_inst, packet: *mut c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iris_hfi_gen1_response_pkt_info {
    pub pkt: u32,
    pub pkt_sz: u32,
}
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_handle_response(core: *mut iris_core, response: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_flush_debug_queue(core: *mut iris_core, packet: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn iris_hfi_gen1_response_handler(core: *mut iris_core) {
