...
//! Source: drivers/media/platform/qcom/iris/iris_hfi_gen1_command.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_buf_type_from_driver(buffer_type: enum iris_buffer_type) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_sys_init(core: *mut iris_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_sys_image_version(core: *mut iris_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_sys_interframe_powercollapse(core: *mut iris_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_sys_pc_prep(core: *mut iris_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_session_open(inst: *mut iris_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_session_close(inst: *mut iris_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_session_start(inst: *mut iris_inst, plane: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_session_stop(inst: *mut iris_inst, plane: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: V4L2_TYPE_IS_CAPTURE(plane)) -> else {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_session_continue(inst: *mut iris_inst, plane: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_queue_input_buffer(inst: *mut iris_inst, buf: *mut iris_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_queue_output_buffer(inst: *mut iris_inst, buf: *mut iris_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_queue_internal_buffer(inst: *mut iris_inst, buf: *mut iris_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_session_queue_buffer(inst: *mut iris_inst, buf: *mut iris_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_session_unset_buffers(inst: *mut iris_inst, buf: *mut iris_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_session_drain(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen1_session_drain(struct iris_inst *inst, u32 plane)
    {
    if (inst.domain == DECODER) {
    let mut ip_pkt: hfi_session_empty_buffer_compressed_pkt = {0};
    ...
    let mut ip_pkt: hfi_session_empty_buffer_uncompressed_pkt = {0};
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_set_resolution(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen1_set_resolution(struct iris_inst *inst, u32 plane)
    {
    let mut ptype: u32 = HFI_PROPERTY_PARAM_FRAME_SIZE;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_decide_core(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen1_decide_core(struct iris_inst *inst, u32 plane)
    {
    let mut ptype: u32 = HFI_PROPERTY_CONFIG_VIDEOCORES_USAGE;
    struct hfi_videocores_usage_type cu;
    cu.video_core_enable_mask = HFI_CORE_ID_1;
    return hfi_gen1_set_property(inst, ptype, &cu, sizeof(cu));
    }
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_set_raw_format(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen1_set_raw_format(struct iris_inst *inst, u32 plane)
    {
    let mut ptype: u32 = HFI_PROPERTY_PARAM_UNCOMPRESSED_FORMAT_SELECT;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_set_format_constraints(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen1_set_format_constraints(struct iris_inst *inst, u32 plane)
    {
    let mut ptype: u32 = HFI_PROPERTY_PARAM_UNCOMPRESSED_PLANE_ACTUAL_CONSTRAINTS_INFO;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_set_num_bufs(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen1_set_num_bufs(struct iris_inst *inst, u32 plane)
    {
    let mut ptype: u32 = HFI_PROPERTY_PARAM_BUFFER_COUNT_ACTUAL;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_set_multistream(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen1_set_multistream(struct iris_inst *inst, u32 plane)
    {
    let mut ptype: u32 = HFI_PROPERTY_PARAM_VDEC_MULTI_STREAM;
    let mut multi: hfi_multi_stream = {0};
    int ret;
    if (iris_split_mode_enabled(inst)) {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_set_bufsize(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen1_set_bufsize(struct iris_inst *inst, u32 plane)
    {
    let mut ptype: u32 = HFI_PROPERTY_PARAM_BUFFER_SIZE_ACTUAL;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_set_frame_rate(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen1_set_frame_rate(struct iris_inst *inst, u32 plane)
    {
    let mut ptype: u32 = HFI_PROPERTY_CONFIG_FRAME_RATE;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_set_stride(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen1_set_stride(struct iris_inst *inst, u32 plane)
    {
    let mut ptype: u32 = HFI_PROPERTY_PARAM_UNCOMPRESSED_PLANE_ACTUAL_INFO;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen1_session_set_config_params(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen1_session_set_config_params(struct iris_inst *inst, u32 plane)
    {
    struct iris_hfi_prop_type_handle const *handler = core::ptr::null_mut();
    let mut handler_size: u32 = 0;
    struct iris_core *core = inst.core;
...
#[no_mangle]
pub unsafe extern "C" fn iris_hfi_gen1_sys_ops_init(core: *mut iris_core) {
