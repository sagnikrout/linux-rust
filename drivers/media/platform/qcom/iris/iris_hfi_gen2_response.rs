...
//! Source: drivers/media/platform/qcom/iris/iris_hfi_gen2_response.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iris_hfi_gen2_core_hfi_range {
    pub begin: u32,
    pub end: u32,
    pub pkt): *mut *mut *mut int (handle)(struct iris_core core, struct iris_hfi_packet,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct iris_hfi_gen2_inst_hfi_range {
    pub begin: u32,
    pub end: u32,
    pub pkt): *mut *mut *mut int (handle)(struct iris_inst inst, struct iris_hfi_packet,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct iris_hfi_gen2_packet_handle {
    pub type: enum hfi_buffer_type,
    pub pkt): *mut *mut *mut int (handle)(struct iris_inst inst, struct iris_hfi_packet,
}
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_is_valid_hfi_buffer_type(buffer_type: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_is_valid_hfi_port(port: u32, buffer_type: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_get_driver_buffer_flags(inst: *mut iris_inst, hfi_flags: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(keyframe: inst_hfi_gen2->hfi_frame_info.picture_type &) -> else {
    else if (inst_hfi_gen2.hfi_frame_info.picture_type & keyframe)
    driver_flags |= V4L2_BUF_FLAG_KEYFRAME;
#[no_mangle]
pub unsafe extern "C" fn if(HFI_GEN2_PICTURE_P: inst_hfi_gen2->hfi_frame_info.picture_type &) -> else {
    else if (inst_hfi_gen2.hfi_frame_info.picture_type & HFI_GEN2_PICTURE_P)
    driver_flags |= V4L2_BUF_FLAG_PFRAME;
#[no_mangle]
pub unsafe extern "C" fn if(HFI_GEN2_PICTURE_B: inst_hfi_gen2->hfi_frame_info.picture_type &) -> else {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_validate_packet_payload(pkt: *mut iris_hfi_packet) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_validate_packet(response_pkt: *mut u8, core_resp_pkt: *mut u8) -> c_int {
    ...
    let mut response_pkt_size: u32 = *(u32 *)response_pkt;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_validate_hdr_packet(core: *mut iris_core, hdr: *mut iris_hfi_header) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_handle_dequeue_buffers(inst: *mut iris_inst) {
    static void iris_hfi_gen2_handle_dequeue_buffers(struct iris_inst *inst)
    {
    struct v4l2_m2m_ctx *m2m_ctx = inst.m2m_ctx;
    struct v4l2_m2m_buffer *buffer, *n;
    struct iris_buffer *buf = core::ptr::null_mut();
    ...
    struct iris_hfi_buffer *buffer)
    {
    let mut buf_type: u32 = iris_hfi_gen2_buf_type_to_driver(inst, buffer.type);
...
#[no_mangle]
pub unsafe extern "C" fn if(HFI_PORT_BITSTREAM: pkt->port ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(HFI_BUFFER_RAW: buffer->type ==) -> else {
    ...
    return iris_hfi_gen2_handle_input_buffer(inst, buffer);
#[no_mangle]
pub unsafe extern "C" fn if(HFI_BUFFER_BITSTREAM: buffer->type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_read_input_subcr_params(inst: *mut iris_inst) {
    ...
    let mut req_bytes: u32 = pkt.size - sizeof(*pkt);
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_init_src_change_param(inst: *mut iris_inst) {
    static void iris_hfi_gen2_init_src_change_param(struct iris_inst *inst)
    {
    struct iris_inst_hfi_gen2 *inst_hfi_gen2 = to_iris_inst_hfi_gen2(inst);
    struct v4l2_pix_format_mplane *pixmp_ip = &inst.fmt_src.fmt.pix_mp;
    struct v4l2_pix_format_mplane *pixmp_op = &inst.fmt_dst.fmt.pix_mp;
    let mut bottom_offset: u32 = (pixmp_ip.height - inst.crop.height);
    let mut right_offset: u32 = (pixmp_ip.width - inst.crop.width);
    struct hfi_subscription_params *subsc_params;
    u32 primaries, matrix_coeff, transfer_char;
    let mut colour_description_present_flag: u32 = 0;
    let mut video_signal_type_present_flag: u32 = 0;
    u32 full_range, video_format = 0;
    let mut left_offset: u32 = inst.crop.left;
    let mut top_offset: u32 = inst.crop.top;
    subsc_params = &inst_hfi_gen2.src_subcr_params;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_handle_response(core: *mut iris_core, response: *mut c_void) -> c_int {
    ...
    if (ret)
    return iris_hfi_gen2_handle_system_error(core, core::ptr::null_mut());
    if (!hdr.session_id)
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_flush_debug_queue(core: *mut iris_core, packet: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn iris_hfi_gen2_response_handler(core: *mut iris_core) {
    void iris_hfi_gen2_response_handler(struct iris_core *core)
    {
    if (iris_vpu_watchdog(core, core.intr_status)) {
    let mut pkt: iris_hfi_packet = {.type = HFI_SYS_ERROR_WD_TIMEOUT};
