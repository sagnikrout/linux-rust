...
//! Source: drivers/media/platform/qcom/iris/iris_hfi_gen2_command.c
#![no_std]
...
pub const UNSPECIFIED_COLOR_FORMAT: c_int = 5;
pub const NUM_SYS_INIT_PACKETS: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_sys_init(core: *mut iris_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_sys_image_version(core: *mut iris_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_sys_interframe_powercollapse(core: *mut iris_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_sys_pc_prep(core: *mut iris_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_get_port(inst: *mut iris_inst, plane: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_raw_resolution(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen2_set_raw_resolution(struct iris_inst *inst, u32 plane)
    {
    let mut resolution: u32 = inst.enc_raw_width << 16 | inst.enc_raw_height;
    let mut port: u32 = iris_hfi_gen2_get_port(inst, plane);
...
#[no_mangle]
pub unsafe extern "C" fn iris_hfi_get_aligned_resolution(inst: *mut iris_inst, width: u32, height: u32) -> u32 {
    static inline u32 iris_hfi_get_aligned_resolution(struct iris_inst *inst, u32 width, u32 height)
    {
    let mut codec_align: u32 = inst.codec == V4L2_PIX_FMT_HEVC ? 32 : 16;
    return (ALIGN(width, codec_align) << 16 | ALIGN(height, codec_align));
    }
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_bitstream_resolution(inst: *mut iris_inst, plane: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_crop_offsets(inst: *mut iris_inst, plane: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_bit_depth(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen2_set_bit_depth(struct iris_inst *inst, u32 plane)
    {
    struct iris_inst_hfi_gen2 *inst_hfi_gen2 = to_iris_inst_hfi_gen2(inst);
    let mut port: u32 = iris_hfi_gen2_get_port(inst, plane);
    let mut bitdepth: u32 = BIT_DEPTH_8;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_coded_frames(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen2_set_coded_frames(struct iris_inst *inst, u32 plane)
    {
    struct iris_inst_hfi_gen2 *inst_hfi_gen2 = to_iris_inst_hfi_gen2(inst);
    let mut port: u32 = iris_hfi_gen2_get_port(inst, plane);
    let mut coded_frames: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_min_output_count(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen2_set_min_output_count(struct iris_inst *inst, u32 plane)
    {
    struct iris_inst_hfi_gen2 *inst_hfi_gen2 = to_iris_inst_hfi_gen2(inst);
    let mut min_output: u32 = inst.buffers[BUF_OUTPUT].min_count;
    let mut port: u32 = iris_hfi_gen2_get_port(inst, plane);
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_picture_order_count(inst: *mut iris_inst, plane: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_colorspace(inst: *mut iris_inst, plane: u32) -> c_int {
    ...
    let mut video_signal_type_present_flag: u32 = 0, color_info;
    let mut matrix_coeff: u32 = HFI_MATRIX_COEFF_RESERVED;
    let mut video_format: u32 = UNSPECIFIED_COLOR_FORMAT;
    let mut full_range: u32 = V4L2_QUANTIZATION_DEFAULT;
    let mut transfer_char: u32 = HFI_TRANSFER_RESERVED;
    let mut port: u32 = iris_hfi_gen2_get_port(inst, plane);
    let mut colour_description_present_flag: u32 = 0;
    let mut primaries: u32 = HFI_PRIMARIES_RESERVED;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_profile(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen2_set_profile(struct iris_inst *inst, u32 plane)
    {
    struct iris_inst_hfi_gen2 *inst_hfi_gen2 = to_iris_inst_hfi_gen2(inst);
    let mut port: u32 = iris_hfi_gen2_get_port(inst, V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE);
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_level(inst: *mut iris_inst, plane: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_opb_enable(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen2_set_opb_enable(struct iris_inst *inst, u32 plane)
    {
    let mut port: u32 = iris_hfi_gen2_get_port(inst, plane);
    let mut opb_enable: u32 = iris_split_mode_enabled(inst);
    return iris_hfi_gen2_session_set_property(inst,
    HFI_PROP_OPB_ENABLE,
    HFI_HOST_FLAGS_NONE,
    port,
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_colorformat(inst: *mut iris_inst, plane: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_linear_stride_scanline(inst: *mut iris_inst, plane: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_ubwc_stride_scanline(inst: *mut iris_inst, plane: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_tier(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen2_set_tier(struct iris_inst *inst, u32 plane)
    {
    let mut port: u32 = iris_hfi_gen2_get_port(inst, V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE);
    struct iris_inst_hfi_gen2 *inst_hfi_gen2 = to_iris_inst_hfi_gen2(inst);
    let mut tier_cap: u32 = (inst.codec == V4L2_PIX_FMT_AV1) ? TIER_AV1 : TIER;
    let mut tier: u32 = inst.fw_caps[tier_cap].value;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_frame_rate(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen2_set_frame_rate(struct iris_inst *inst, u32 plane)
    {
    let mut port: u32 = iris_hfi_gen2_get_port(inst, V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE);
    let mut frame_rate: u32 = inst.frame_rate << 16;
    return iris_hfi_gen2_session_set_property(inst,
    HFI_PROP_FRAME_RATE,
    HFI_HOST_FLAGS_NONE,
    port,
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_film_grain(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen2_set_film_grain(struct iris_inst *inst, u32 plane)
    {
    let mut port: u32 = iris_hfi_gen2_get_port(inst, V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE);
    struct iris_inst_hfi_gen2 *inst_hfi_gen2 = to_iris_inst_hfi_gen2(inst);
    let mut film_grain: u32 = inst.fw_caps[FILM_GRAIN].value;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_super_block(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen2_set_super_block(struct iris_inst *inst, u32 plane)
    {
    let mut port: u32 = iris_hfi_gen2_get_port(inst, V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE);
    struct iris_inst_hfi_gen2 *inst_hfi_gen2 = to_iris_inst_hfi_gen2(inst);
    let mut super_block: u32 = inst.fw_caps[SUPER_BLOCK].value;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_session_set_config_params(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen2_session_set_config_params(struct iris_inst *inst, u32 plane)
    {
    const struct iris_firmware_data *fdata = inst.core.iris_firmware_data;
    let mut config_params_size: u32 = 0, i, j;
    const u32 *config_params = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_session_set_codec(inst: *mut iris_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_session_set_default_header(inst: *mut iris_inst) -> c_int {
    static int iris_hfi_gen2_session_set_default_header(struct iris_inst *inst)
    {
    struct iris_inst_hfi_gen2 *inst_hfi_gen2 = to_iris_inst_hfi_gen2(inst);
    let mut default_header: u32 = false;
    iris_hfi_gen2_packet_session_property(inst,
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_session_open(inst: *mut iris_inst) -> c_int {
    ...
    inst_hfi_gen2.packet = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_session_close(inst: *mut iris_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_subscribe_change_param(inst: *mut iris_inst, plane: u32) -> c_int {
    ...
    const u32 *change_param = core::ptr::null_mut();
    let mut change_param_size: u32 = 0;
    u32 payload[32] = {0};
    let mut hfi_port: u32 = 0, i;
    int ret;
    if (inst.domain == ENCODER)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_subscribe_property(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen2_subscribe_property(struct iris_inst *inst, u32 plane)
    {
    struct iris_core *core = inst.core;
    let mut subscribe_prop_size: u32 = 0, i;
    const u32 *subcribe_prop = core::ptr::null_mut();
    u32 payload[32] = {0};
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_session_start(inst: *mut iris_inst, plane: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_session_stop(inst: *mut iris_inst, plane: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_session_pause(inst: *mut iris_inst, plane: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_session_resume_drc(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen2_session_resume_drc(struct iris_inst *inst, u32 plane)
    {
    struct iris_inst_hfi_gen2 *inst_hfi_gen2 = to_iris_inst_hfi_gen2(inst);
    let mut payload: u32 = HFI_CMD_SETTINGS_CHANGE;
    iris_hfi_gen2_packet_session_command(inst,
    HFI_CMD_RESUME,
    (HFI_HOST_FLAGS_RESPONSE_REQUIRED |
    HFI_HOST_FLAGS_INTR_REQUIRED),
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_session_resume_drain(inst: *mut iris_inst, plane: u32) -> c_int {
    static int iris_hfi_gen2_session_resume_drain(struct iris_inst *inst, u32 plane)
    {
    struct iris_inst_hfi_gen2 *inst_hfi_gen2 = to_iris_inst_hfi_gen2(inst);
    let mut payload: u32 = HFI_CMD_DRAIN;
    iris_hfi_gen2_packet_session_command(inst,
    HFI_CMD_RESUME,
    (HFI_HOST_FLAGS_RESPONSE_REQUIRED |
    HFI_HOST_FLAGS_INTR_REQUIRED),
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_session_drain(inst: *mut iris_inst, plane: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_buf_type_from_driver(domain: u32, buffer_type: enum iris_buffer_type) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_set_num_comv(inst: *mut iris_inst) -> c_int {
    static int iris_hfi_gen2_set_num_comv(struct iris_inst *inst)
    {
    let mut num_comv: u32 = inst.buffers[BUF_OUTPUT].min_count;
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_session_queue_buffer(inst: *mut iris_inst, buffer: *mut iris_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iris_hfi_gen2_session_release_buffer(inst: *mut iris_inst, buffer: *mut iris_buffer) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iris_hfi_gen2_sys_ops_init(core: *mut iris_core) {
