...
//! Source: drivers/media/platform/st/sti/delta/delta-v4l2.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn frame_size(w: u32, h: u32, fmt: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn frame_stride(w: u32, fmt: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dump_au(ctx: *mut delta_ctx, au: *mut delta_au) {
...
#[no_mangle]
unsafe extern "C" fn dump_frame(ctx: *mut delta_ctx, frame: *mut delta_frame) {
...
#[no_mangle]
unsafe extern "C" fn delta_au_done(ctx: *mut delta_ctx, au: *mut delta_au, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn requeue_free_frames(ctx: *mut delta_ctx) {
...
#[no_mangle]
unsafe extern "C" fn delta_recycle(ctx: *mut delta_ctx, frame: *mut delta_frame) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn delta_push_dts(ctx: *mut delta_ctx, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn delta_pop_dts(ctx: *mut delta_ctx, val: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn delta_flush_dts(ctx: *mut delta_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn frame_alignment(fmt: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn estimated_au_size(w: u32, h: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_default_params(ctx: *mut delta_ctx) {
...
#[no_mangle]
unsafe extern "C" fn register_format(format: u32, formats[]: u32, nb_of_formats: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn register_formats(delta: *mut delta_dev) {
...
#[no_mangle]
unsafe extern "C" fn register_decoders(delta: *mut delta_dev) {
...
#[no_mangle]
unsafe extern "C" fn delta_g_fmt_frame(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
// align colorspace & friends on stream ones if any set
    ...
    struct delta_dev *delta = ctx.dev;
    struct v4l2_pix_format *pix = &f.fmt.pix;
    let mut streamformat: u32 = pix.pixelformat;
    const struct delta_dec *dec;
    u32 width, height;
    u32 au_size;
    dec = delta_find_decoder(ctx, streamformat, ctx.frameinfo.pixelformat);
...
// adjust width & height
    ...
    struct delta_dev *delta = ctx.dev;
    struct v4l2_pix_format *pix = &f.fmt.pix;
    let mut pixelformat: u32 = pix.pixelformat;
    const struct delta_dec *dec;
    u32 width, height;
...
#[no_mangle]
unsafe extern "C" fn delta_s_fmt_frame(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
// up to aligned dimensions
    ...
    {
    struct delta_dev *delta = ctx.dev;
    let mut ev: v4l2_event = {.type = V4L2_EVENT_EOS};
//
// Send EOS to user:
...
#[no_mangle]
unsafe extern "C" fn delta_decoder_stop_cmd(ctx: *mut delta_ctx) -> c_int {
    static int delta_decoder_stop_cmd(struct delta_ctx *ctx)
    {
    const struct delta_dec *dec = ctx.dec;
    struct delta_dev *delta = ctx.dev;
    struct delta_frame *frame = core::ptr::null_mut();
    let mut ret: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn delta_run_work(work: *mut work_struct) {
...
// no more decoded frames
    ...
    if (!frame) {
    dev_err(delta.dev,
    "%s  core::ptr::null_mut() decoded frame\n",
    ctx.name);
    goto out;
    }
// pop timestamp and mark frame with it
...
#[no_mangle]
unsafe extern "C" fn delta_device_run(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn delta_job_abort(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn delta_job_ready(priv: *mut c_void) -> c_int {
...
//
    ...
    let mut size: c_uint = ctx.max_au_size;
    if (*num_planes)
...
#[no_mangle]
unsafe extern "C" fn delta_vb2_au_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dump_frames_status(ctx: *mut delta_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn delta_get_sync(ctx: *mut delta_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn delta_put_autosuspend(ctx: *mut delta_ctx) {
...
#[no_mangle]
unsafe extern "C" fn delta_vb2_au_queue(vb: *mut vb2_buffer) {
    ...
    struct delta_au *au;
    let mut ret: c_int = 0;
    struct vb2_v4l2_buffer *vbuf = core::ptr::null_mut();
    struct delta_streaminfo *streaminfo = &ctx.streaminfo;
    struct delta_frameinfo *frameinfo = &ctx.frameinfo;
...
#[no_mangle]
unsafe extern "C" fn delta_vb2_au_stop_streaming(q: *mut vb2_queue) {
...
// return all buffers to vb2 in ERROR state
    ...
    struct delta_streaminfo *streaminfo = &ctx.streaminfo;
    struct delta_frameinfo *frameinfo = &ctx.frameinfo;
    let mut size: c_uint = frameinfo.size;
//
...
#[no_mangle]
unsafe extern "C" fn delta_vb2_frame_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn delta_vb2_frame_finish(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn delta_vb2_frame_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn delta_vb2_frame_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn delta_open(file: *mut file) -> c_int {
    static int delta_open(struct file *file)
    {
    struct delta_dev *delta = video_drvdata(file);
    struct delta_ctx *ctx = core::ptr::null_mut();
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn delta_release(file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn delta_register_device(delta: *mut delta_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn delta_unregister_device(delta: *mut delta_dev) {
...
#[no_mangle]
unsafe extern "C" fn delta_probe(pdev: *mut platform_device) -> c_int {
...
// get clock resources
    ...
    DELTA_PREFIX);
    delta.clk_flash_promip = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn delta_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn delta_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn delta_runtime_resume(dev: *mut device) -> c_int {
