...
//! Source: drivers/media/platform/st/sti/hva/hva-debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn format_ctx(s: *mut seq_file, ctx: *mut hva_ctx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hva_dbg_perf_begin(ctx: *mut hva_ctx) {
    ...
    u32 bitrate;
    struct hva_ctx_dbg *dbg = &ctx.dbg;
    let mut prev: ktime_t = dbg.begin;
    dbg.begin = ktime_get();
...
#[no_mangle]
pub unsafe extern "C" fn hva_dbg_perf_end(ctx: *mut hva_ctx, stream: *mut hva_stream) {
...
#[no_mangle]
unsafe extern "C" fn hva_dbg_perf_compute(ctx: *mut hva_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn device_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn encoders_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn last_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hva_debugfs_create(hva: *mut hva_dev) {
    void hva_debugfs_create(struct hva_dev *hva)
    {
    hva.dbg.debugfs_entry = debugfs_create_dir(HVA_NAME, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn hva_debugfs_remove(hva: *mut hva_dev) {
    void hva_debugfs_remove(struct hva_dev *hva)
    {
    debugfs_remove_recursive(hva.dbg.debugfs_entry);
    hva.dbg.debugfs_entry = core::ptr::null_mut();
    }
//
// context (instance) debug info
//
#[no_mangle]
unsafe extern "C" fn ctx_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hva_dbg_ctx_create(ctx: *mut hva_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn hva_dbg_ctx_remove(ctx: *mut hva_ctx) {
