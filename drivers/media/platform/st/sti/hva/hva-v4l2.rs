...
//! Source: drivers/media/platform/st/sti/hva/hva-v4l2.c
#![no_std]
...
pub const MIN_FRAMES: c_int = 1;
pub const MIN_STREAMS: c_int = 1;
pub const HVA_MIN_WIDTH: c_int = 32;
pub const HVA_MAX_WIDTH: c_int = 1920;
pub const HVA_MIN_HEIGHT: c_int = 32;
pub const HVA_MAX_HEIGHT: c_int = 1920;
// HVA requires a 16x16 pixels alignment for frames
pub const HVA_WIDTH_ALIGNMENT: c_int = 16;
pub const HVA_HEIGHT_ALIGNMENT: c_int = 16;

pub const HVA_DEFAULT_FRAME_NUM: c_int = 1;
pub const HVA_DEFAULT_FRAME_DEN: c_int = 30;
...
#[no_mangle]
pub unsafe extern "C" fn estimated_stream_size(w: u32, h: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_default_params(ctx: *mut hva_ctx) {
...
#[no_mangle]
unsafe extern "C" fn register_formats(hva: *mut hva_dev) {
...
#[no_mangle]
unsafe extern "C" fn register_encoders(hva: *mut hva_dev) {
...
#[no_mangle]
unsafe extern "C" fn hva_dbg_summary(ctx: *mut hva_ctx) {
...
#[no_mangle]
unsafe extern "C" fn hva_g_fmt_stream(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hva_g_fmt_frame(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hva_s_fmt_stream(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hva_s_fmt_frame(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hva_g_parm(file: *mut file, fh: *mut c_void, sp: *mut v4l2_streamparm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hva_s_parm(file: *mut file, fh: *mut c_void, sp: *mut v4l2_streamparm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hva_qbuf(file: *mut file, priv: *mut c_void, buf: *mut v4l2_buffer) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hva_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hva_ctrls_setup(ctx: *mut hva_ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hva_run_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn hva_device_run(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hva_job_abort(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hva_job_ready(priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hva_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hva_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn hva_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
// save the context identifier in the context
    ...
    return 0;
    err_ctx:
    hva.instances[ctx.id] = core::ptr::null_mut();
    hva.nb_of_instances--;
    err:
...
#[no_mangle]
unsafe extern "C" fn hva_stop_streaming(vq: *mut vb2_queue) {
...
//
#[no_mangle]
unsafe extern "C" fn queue_init(ctx: *mut hva_ctx, vq: *mut vb2_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hva_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hva_release(file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hva_register_device(hva: *mut hva_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hva_unregister_device(hva: *mut hva_dev) {
...
#[no_mangle]
unsafe extern "C" fn hva_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hva_remove(pdev: *mut platform_device) {
