...
//! Source: drivers/media/platform/st/sti/bdisp/bdisp-v4l2.c
#![no_std]
...
pub const BDISP_MAX_CTRL_NUM: c_int = 10;

// User configuration change

pub const BDISP_MIN_W: c_int = 1;
pub const BDISP_MAX_W: c_int = 8191;
pub const BDISP_MIN_H: c_int = 1;
pub const BDISP_MAX_H: c_int = 8191;
...
pub const BDISP_DEF_WIDTH: c_int = 1920;
pub const BDISP_DEF_HEIGHT: c_int = 1080;
...
#[no_mangle]
pub unsafe extern "C" fn bdisp_ctx_state_lock_set(state: u32, ctx: *mut bdisp_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn bdisp_ctx_state_lock_clear(state: u32, ctx: *mut bdisp_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn bdisp_ctx_state_is_set(mask: u32, ctx: *mut bdisp_ctx) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bdisp_job_finish(ctx: *mut bdisp_ctx, vb_state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_ctx_stop_req(ctx: *mut bdisp_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __bdisp_job_abort(ctx: *mut bdisp_ctx) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_job_abort(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_get_bufs(ctx: *mut bdisp_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdisp_device_run(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __bdisp_s_ctrl(ctx: *mut bdisp_ctx, ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdisp_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdisp_ctrls_create(ctx: *mut bdisp_ctx) -> c_int {
    ...
    let mut err: c_int = ctx.ctrl_handler.error;
...
#[no_mangle]
unsafe extern "C" fn bdisp_ctrls_delete(ctx: *mut bdisp_ctx) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdisp_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
    static int bdisp_start_streaming(struct vb2_queue *q, unsigned int count)
    {
    struct bdisp_ctx *ctx = q.drv_priv;
    struct vb2_v4l2_buffer *buf;
    let mut ret: c_int = pm_runtime_resume_and_get(ctx.bdisp_dev.dev);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_open(file: *mut file) -> c_int {
    static int bdisp_open(struct file *file)
    {
    struct bdisp_dev *bdisp = video_drvdata(file);
    struct bdisp_ctx *ctx = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn bdisp_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdisp_enum_fmt(file: *mut file, fh: *mut c_void, f: *mut v4l2_fmtdesc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdisp_g_fmt(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdisp_try_fmt(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdisp_s_fmt(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_rect_enclosed(a: *mut v4l2_rect, b: *mut v4l2_rect) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdisp_streamon(file: *mut file, fh: *mut c_void, type: enum v4l2_buf_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdisp_register_device(bdisp: *mut bdisp_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdisp_unregister_device(bdisp: *mut bdisp_dev) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_irq_thread(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bdisp_irq_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bdisp_irq_timeout(ptr: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_m2m_suspend(bdisp: *mut bdisp_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdisp_m2m_resume(bdisp: *mut bdisp_dev) -> c_int {
    ...
    spin_lock_irqsave(&bdisp.slock, flags);
    ctx = bdisp.m2m.ctx;
    bdisp.m2m.ctx = core::ptr::null_mut();
    spin_unlock_irqrestore(&bdisp.slock, flags);
...
#[no_mangle]
unsafe extern "C" fn bdisp_runtime_resume(dev: *mut device) -> c_int {
    static int bdisp_runtime_resume(struct device *dev)
    {
    struct bdisp_dev *bdisp = dev_get_drvdata(dev);
    let mut ret: c_int = clk_enable(bdisp.clock);
    if (ret)
    return ret;
    return bdisp_m2m_resume(bdisp);
    }
#[no_mangle]
unsafe extern "C" fn bdisp_runtime_suspend(dev: *mut device) -> c_int {
    static int bdisp_runtime_suspend(struct device *dev)
    {
    struct bdisp_dev *bdisp = dev_get_drvdata(dev);
    let mut ret: c_int = bdisp_m2m_suspend(bdisp);
    if (!ret)
    clk_disable(bdisp.clock);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn bdisp_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdisp_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bdisp_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_probe(pdev: *mut platform_device) -> c_int {
