...
//! Source: drivers/media/platform/st/sti/bdisp/bdisp-debug.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn bdisp_dbg_perf_begin(bdisp: *mut bdisp_dev) {
    void bdisp_dbg_perf_begin(struct bdisp_dev *bdisp)
    {
    bdisp.dbg.hw_start = ktime_get();
    }
#[no_mangle]
pub unsafe extern "C" fn bdisp_dbg_perf_end(bdisp: *mut bdisp_dev) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_dbg_dump_ins(s: *mut seq_file, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_dbg_dump_tty(s: *mut seq_file, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_dbg_dump_xy(s: *mut seq_file, val: u32, name: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_dbg_dump_sz(s: *mut seq_file, val: u32, name: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_dbg_dump_fctl(s: *mut seq_file, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn if(BLT_FCTL_Y_HV_SAMPLE: (val & BLT_FCTL_Y_HV_SCALE) ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(BLT_FCTL_HV_SAMPLE: (val & BLT_FCTL_HV_SCALE) ==) -> else {
    else if ((val & BLT_FCTL_HV_SCALE) == BLT_FCTL_HV_SAMPLE)
    seq_puts(s, "Sample Chroma");
    seq_putc(s, '\n');
    }
#[no_mangle]
unsafe extern "C" fn bdisp_dbg_dump_rsf(s: *mut seq_file, val: u32, name: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn bdisp_dbg_dump_rzi(s: *mut seq_file, val: u32, name: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn last_nodes_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn last_nodes_raw_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn last_request_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regs_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
pub const SECOND: c_int = 1000000;
#[no_mangle]
unsafe extern "C" fn perf_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bdisp_debugfs_create(bdisp: *mut bdisp_dev) {
    void bdisp_debugfs_create(struct bdisp_dev *bdisp)
    {
    char dirname[16];
    snprintf(dirname, sizeof(dirname), "%s%d", BDISP_NAME, bdisp.id);
    bdisp.dbg.debugfs_entry = debugfs_create_dir(dirname, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn bdisp_debugfs_remove(bdisp: *mut bdisp_dev) {
    void bdisp_debugfs_remove(struct bdisp_dev *bdisp)
    {
    debugfs_remove_recursive(bdisp.dbg.debugfs_entry);
    bdisp.dbg.debugfs_entry = core::ptr::null_mut();
    }
