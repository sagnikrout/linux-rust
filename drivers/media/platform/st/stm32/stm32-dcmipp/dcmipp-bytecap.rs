...
//! Source: drivers/media/platform/st/stm32/stm32-dcmipp/dcmipp-bytecap.c
#![no_std]
...
pub const DCMIPP_PRSR: c_uint = 0x1f8;
pub const DCMIPP_CMIER: c_uint = 0x3f0;

    DCMIPP_CMIER_P0FRAMEIE |\
    DCMIPP_CMIER_P0OVRIE)
pub const DCMIPP_CMSR1: c_uint = 0x3f4;
pub const DCMIPP_CMSR2: c_uint = 0x3f8;

pub const DCMIPP_CMFCR: c_uint = 0x3fc;
pub const DCMIPP_P0FSCR: c_uint = 0x404;

pub const DCMIPP_P0FCTCR: c_uint = 0x500;

pub const DCMIPP_P0DCCNTR: c_uint = 0x5b0;
pub const DCMIPP_P0DCLMTR: c_uint = 0x5b4;

pub const DCMIPP_P0PPM0AR1: c_uint = 0x5c4;
pub const DCMIPP_P0SR: c_uint = 0x5f8;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dcmipp_bytecap_pix_map {
    pub code: c_uint,
    pub pixelformat: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dcmipp_bytecap_device {
    pub ved: dcmipp_ent_device,
...
//
    pub next: *mut *mut dcmipp_buf active,,
...
//
    ...
    vcap.active = core::ptr::null_mut();
    spin_unlock_irq(&vcap.irqlock);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn dcmipp_dump_status(vcap: *mut dcmipp_bytecap_device) {
...
//
#[no_mangle]
unsafe extern "C" fn dcmipp_bytecap_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn dcmipp_bytecap_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dcmipp_bytecap_buf_queue(vb2_buf: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn dcmipp_bytecap_buf_init(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dcmipp_bytecap_release(vdev: *mut video_device) {
...
#[no_mangle]
pub unsafe extern "C" fn dcmipp_bytecap_ent_release(ved: *mut dcmipp_ent_device) {
...
#[no_mangle]
unsafe extern "C" fn dcmipp_bytecap_irq_thread(irq: c_int, arg: *mut c_void) -> irqreturn_t {
    static irqreturn_t dcmipp_bytecap_irq_thread(int irq, void *arg)
    {
    struct dcmipp_bytecap_device *vcap =
    container_of(arg, struct dcmipp_bytecap_device, ved);
    let mut bytesused: usize = 0;
    spin_lock_irq(&vcap.irqlock);
//
...
#[no_mangle]
unsafe extern "C" fn dcmipp_bytecap_irq_callback(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dcmipp_bytecap_link_validate(link: *mut media_link) -> c_int {
    ...
    int ret, i;
    ret = v4l2_subdev_call(source_sd, pad, get_fmt, core::ptr::null_mut(), &source_fmt);
    if (ret < 0)
    return 0;
    ...
    struct vb2_queue *q;
    let mut pad_flag: c_ulong = MEDIA_PAD_FL_SINK;
    let mut ret: c_int = 0;
