...
//! Source: drivers/media/platform/st/stm32/stm32-dcmipp/dcmipp-byteproc.c
#![no_std]
...
pub const DCMIPP_P0SCSTR: c_uint = 0x504;
pub const DCMIPP_P0SCSTR_HSTART_SHIFT: c_int = 0;
pub const DCMIPP_P0SCSTR_VSTART_SHIFT: c_int = 16;
pub const DCMIPP_P0SCSZR: c_uint = 0x508;

pub const DCMIPP_P0SCSZR_HSIZE_SHIFT: c_int = 0;
pub const DCMIPP_P0SCSZR_VSIZE_SHIFT: c_int = 16;
pub const DCMIPP_P0PPCR: c_uint = 0x5c0;
pub const DCMIPP_P0PPCR_BSM_1_2: c_uint = 0x1;
pub const DCMIPP_P0PPCR_BSM_1_4: c_uint = 0x2;
pub const DCMIPP_P0PPCR_BSM_2_4: c_uint = 0x3;

pub const DCMIPP_P0PPCR_BSM_SHIFT: c_uint = 0x7;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dcmipp_byteproc_pix_map {
    pub code: c_uint,
    pub bpp: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dcmipp_byteproc_device {
...
// Adjust width /2 or /4 for 8bits formats and /2 for 16bits formats
    ...
    r.width = fmt.width / 4;
#[no_mangle]
pub unsafe extern "C" fn if(2): r->width <= (fmt->width /) -> else {
...
#[no_mangle]
unsafe extern "C" fn dcmipp_byteproc_adjust_fmt(fmt: *mut v4l2_mbus_framefmt) {
...
#[no_mangle]
pub unsafe extern "C" fn if(2): (vpix->code == MEDIA_BUS_FMT_Y8_1X8) && (hprediv ==) -> else {
    else if ((vpix.code == MEDIA_BUS_FMT_Y8_1X8) && (hprediv == 2))
    val |= DCMIPP_P0PPCR_BSM_1_2 << DCMIPP_P0PPCR_BSM_SHIFT;
#[no_mangle]
pub unsafe extern "C" fn if(2: hprediv ==) -> else {
    else if (hprediv == 2)
...
#[no_mangle]
unsafe extern "C" fn dcmipp_byteproc_release(sd: *mut v4l2_subdev) {
...
#[no_mangle]
pub unsafe extern "C" fn dcmipp_byteproc_ent_release(ved: *mut dcmipp_ent_device) {
