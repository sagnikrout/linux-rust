...
//! Source: drivers/media/platform/st/stm32/stm32-dcmipp/dcmipp-input.c
#![no_std]
...
pub const DCMIPP_PRCR: c_uint = 0x104;
pub const DCMIPP_PRCR_FORMAT_SHIFT: c_int = 16;
pub const DCMIPP_PRCR_FORMAT_YUV422: c_uint = 0x1e;
pub const DCMIPP_PRCR_FORMAT_RGB565: c_uint = 0x22;
pub const DCMIPP_PRCR_FORMAT_RGB888: c_uint = 0x24;
pub const DCMIPP_PRCR_FORMAT_RAW8: c_uint = 0x2a;
pub const DCMIPP_PRCR_FORMAT_RAW10: c_uint = 0x2b;
pub const DCMIPP_PRCR_FORMAT_RAW12: c_uint = 0x2c;
pub const DCMIPP_PRCR_FORMAT_RAW14: c_uint = 0x2d;
pub const DCMIPP_PRCR_FORMAT_G8: c_uint = 0x4a;
pub const DCMIPP_PRCR_FORMAT_G10: c_uint = 0x4b;
pub const DCMIPP_PRCR_FORMAT_G12: c_uint = 0x4c;
pub const DCMIPP_PRCR_FORMAT_G14: c_uint = 0x4d;
pub const DCMIPP_PRCR_FORMAT_BYTE_STREAM: c_uint = 0x5a;

pub const DCMIPP_PRESCR: c_uint = 0x108;
pub const DCMIPP_PRESUR: c_uint = 0x10c;
pub const DCMIPP_CMCR: c_uint = 0x204;

pub const DCMIPP_P0FSCR: c_uint = 0x404;

pub const DCMIPP_P0FSCR_DTMODE_SHIFT: c_int = 16;
pub const DCMIPP_P0FSCR_DTMODE_DTIDA: c_uint = 0x00;
pub const DCMIPP_P0FSCR_DTMODE_ALLDT: c_uint = 0x03;

pub const DCMIPP_P0FSCR_DTIDA_SHIFT: c_int = 0;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dcmipp_inp_pix_map {
    pub code_sink: c_uint,
    pub code_src: c_uint,
// Parallel related information
    pub prcr_format: u8,
    pub prcr_swapcycles: u8,
...
//
    ...
    {
    let mut i: c_uint = 0;
    let mut prev_code: u32 = 0, cur_code;
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_MBUS_CSI2_DPHY: inp->ved.bus_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn dcmipp_inp_release(sd: *mut v4l2_subdev) {
...
#[no_mangle]
pub unsafe extern "C" fn dcmipp_inp_ent_release(ved: *mut dcmipp_ent_device) {
