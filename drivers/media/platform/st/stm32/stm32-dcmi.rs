...
//! Source: drivers/media/platform/st/stm32/stm32-dcmi.c
#![no_std]
...
pub const DCMI_CR: c_uint = 0x00 /* Control Register */;
pub const DCMI_SR: c_uint = 0x04 /* Status Register */;
pub const DCMI_RIS: c_uint = 0x08 /* Raw Interrupt Status register */;
pub const DCMI_IER: c_uint = 0x0C /* Interrupt Enable Register */;
pub const DCMI_MIS: c_uint = 0x10 /* Masked Interrupt Status register */;
pub const DCMI_ICR: c_uint = 0x14 /* Interrupt Clear Register */;
pub const DCMI_ESCR: c_uint = 0x18 /* Embedded Synchronization Code Register */;
pub const DCMI_ESUR: c_uint = 0x1C /* Embedded Synchronization Unmask Register */;
pub const DCMI_CWSTRT: c_uint = 0x20 /* Crop Window STaRT */;
pub const DCMI_CWSIZE: c_uint = 0x24 /* Crop Window SIZE */;
pub const DCMI_DR: c_uint = 0x28 /* Data Register */;
pub const DCMI_IDR: c_uint = 0x2C /* IDentifier Register */;
...
pub const OVERRUN_ERROR_THRESHOLD: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dcmi_format {
    pub fourcc: u32,
    pub mbus_code: u32,
    pub bpp: u8,
}
...
pub struct dcmi_buf {
    ...
    pub prepared: bool,
    pub sgt: sg_table,
    pub sgt_mdma: sg_table,
    pub dma_desc: *mut dma_async_tx_descriptor,
    pub mdma_desc: *mut dma_async_tx_descriptor,
    pub size: usize,
    pub list: list_head,
}
...
// Protects the access of variables shared within the interrupt
    ...
    pub crop: v4l2_rect,
    pub do_crop: bool,
    pub sd_formats: *const dcmi_format,
    pub num_of_sd_formats: c_uint,
    pub sd_format: *const dcmi_format,
    pub sd_framesizes: *mut dcmi_framesize,
    pub num_of_sd_framesizes: c_uint,
    pub sd_framesize: dcmi_framesize,
    pub sd_bounds: v4l2_rect,
// Protect this data structure
    ...
    pub dma_cookie: dma_cookie_t,
    pub dma_max_burst: u32,
// Elements for the MDMA - DMA chaining
    pub sram_pool: *mut gen_pool,
    pub mdma_chan: *mut dma_chan,
    pub sram_buf: *mut c_void,
    pub sram_buf_size: u32,
    pub sram_dma_buf: dma_addr_t,
    pub mdma_cookie: dma_cookie_t,
    pub misr: u32,
    pub errors_count: c_int,
    pub overrun_count: c_int,
    pub buffers_count: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn reg_set(base: *mut void __iomem, reg: u32, mask: u32) {
    static inline void reg_set(void __iomem *base, u32 reg, u32 mask)
    {
    reg_write(base, reg, reg_read(base, reg) | mask);
    }
#[no_mangle]
pub unsafe extern "C" fn reg_clear(base: *mut void __iomem, reg: u32, mask: u32) {
    ...
    dcmi.buffers_count++;
    dcmi.active = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn dcmi_restart_capture(dcmi: *mut stm32_dcmi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dcmi_start_capture(dcmi: *mut stm32_dcmi, buf: *mut dcmi_buf) -> c_int {
    static int dcmi_start_capture(struct stm32_dcmi *dcmi, struct dcmi_buf *buf)
    {
    int ret;
    if (!buf)
...
#[no_mangle]
unsafe extern "C" fn dcmi_set_crop(dcmi: *mut stm32_dcmi) {
...
#[no_mangle]
unsafe extern "C" fn dcmi_process_frame(dcmi: *mut stm32_dcmi) {
...
#[no_mangle]
unsafe extern "C" fn dcmi_irq_thread(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dcmi_irq_callback(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dcmi_buf_init(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dcmi_buf_prepare(vb: *mut vb2_buffer) -> c_int {
    ...
    if (!buf.prepared) {
    let mut max_size: u32 = dcmi.dma_max_burst;
...
//
    ...
    let mut bytes: usize = min_t(size_t, size, max_size);
    if (!dcmi.mdma_chan) {
...
#[no_mangle]
unsafe extern "C" fn dcmi_buf_cleanup(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn dcmi_buf_queue(vb: *mut vb2_buffer) {
...
// Walk searching for entity having no sink
    ...
    struct media_pad *sink_pad = core::ptr::null_mut();
    struct media_pad *src_pad = core::ptr::null_mut();
    struct media_pad *pad = core::ptr::null_mut();
    let mut fmt: v4l2_subdev_format = *format;
...
// Propagate format on sink pad if any, otherwise source pad
    ...
    fmt.pad = pad.index;
    ret = v4l2_subdev_call(subdev, pad, set_fmt, core::ptr::null_mut(), &fmt);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn dcmi_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dcmi_stop_streaming(vq: *mut vb2_queue) {
...
// fmt = dcmi->fmt;
    ...
    unsigned int fourcc)
    {
    let mut num_formats: c_uint = dcmi.num_of_sd_formats;
    ...
    {
    struct dcmi_framesize *match = core::ptr::null_mut();
    unsigned int i;
    let mut min_err: c_uint = UINT_MAX;
    for (i = 0; i < dcmi.num_of_sd_framesizes; i++) {
    struct dcmi_framesize *fsize = &dcmi.sd_framesizes[i];
    let mut w_err: c_int = (fsize.width - pix.width);
    let mut h_err: c_int = (fsize.height - pix.height);
    let mut err: c_int = w_err + h_err;
...
#[no_mangle]
unsafe extern "C" fn dcmi_set_fmt(dcmi: *mut stm32_dcmi, f: *mut v4l2_format) -> c_int {
...
// pix to mbus format
    ...
    {
    struct stm32_dcmi *dcmi = video_drvdata(file);
    return dcmi_try_fmt(dcmi, f, core::ptr::null_mut(), core::ptr::null_mut());
    }
    ...
    int ret;
    ret = v4l2_subdev_call(dcmi.source, pad, get_fmt, core::ptr::null_mut(), &fmt);
    if (ret)
    return ret;
...
//
    ...
    for (i = 0; i < dcmi.num_of_sd_framesizes; i++) {
    struct dcmi_framesize *fsize = &dcmi.sd_framesizes[i];
    let mut pixsize: c_uint = fsize.width * fsize.height;
...
#[no_mangle]
unsafe extern "C" fn dcmi_g_input(file: *mut file, priv: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dcmi_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
    ...
    enum_frame_interval, core::ptr::null_mut(), &fie);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn dcmi_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dcmi_release(file: *mut file) -> c_int {
    ...
    ret = _vb2_fop_release(file, core::ptr::null_mut());
    if (fh_singular)
    v4l2_subdev_call(sd, core, s_power, 0);
    mutex_unlock(&dcmi.lock);
    return ret;
...
#[no_mangle]
unsafe extern "C" fn dcmi_set_default_fmt(dcmi: *mut stm32_dcmi) -> c_int {
    ...
    int ret;
    ret = dcmi_try_fmt(dcmi, &f, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn dcmi_formats_init(dcmi: *mut stm32_dcmi) -> c_int {
    static int dcmi_formats_init(struct stm32_dcmi *dcmi)
    {
    const struct dcmi_format *sd_fmts[ARRAY_SIZE(dcmi_formats)];
    let mut num_fmts: c_uint = 0, i, j;
    struct v4l2_subdev *subdev = dcmi.source;
    struct v4l2_subdev_mbus_code_enum mbus_code = {
    .which = V4L2_SUBDEV_FORMAT_ACTIVE,
    };
    while (!v4l2_subdev_call(subdev, pad, enum_mbus_code,
    core::ptr::null_mut(), &mbus_code)) {
...
#[no_mangle]
unsafe extern "C" fn dcmi_framesizes_init(dcmi: *mut stm32_dcmi) -> c_int {
    static int dcmi_framesizes_init(struct stm32_dcmi *dcmi)
    {
    let mut num_fsize: c_uint = 0;
    struct v4l2_subdev *subdev = dcmi.source;
    struct v4l2_subdev_frame_size_enum fse = {
    .which = V4L2_SUBDEV_FORMAT_ACTIVE,
...
#[no_mangle]
unsafe extern "C" fn dcmi_graph_notify_complete(notifier: *mut v4l2_async_notifier) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dcmi_graph_init(dcmi: *mut stm32_dcmi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dcmi_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (!dcmi)
    return -ENOMEM;
    dcmi.rstc = devm_reset_control_get_exclusive(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(dcmi.rstc))
...
#[no_mangle]
unsafe extern "C" fn dcmi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dcmi_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dcmi_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dcmi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dcmi_resume(dev: *mut device) -> c_int {
...
// clock enable
    ...
    RUNTIME_PM_OPS(dcmi_runtime_suspend, dcmi_runtime_resume, core::ptr::null_mut())
    };
