...
//! Source: drivers/media/platform/xilinx/xilinx-tpg.c
#![no_std]
...
pub const XTPG_PATTERN_CONTROL: c_uint = 0x0100;

pub const XTPG_PATTERN_CONTROL_COLOR_MASK_SHIFT: c_int = 6;

pub const XTPG_MOTION_SPEED: c_uint = 0x0104;
pub const XTPG_CROSS_HAIRS: c_uint = 0x0108;
pub const XTPG_CROSS_HAIRS_ROW_SHIFT: c_int = 0;

pub const XTPG_CROSS_HAIRS_COLUMN_SHIFT: c_int = 16;

pub const XTPG_ZPLATE_HOR_CONTROL: c_uint = 0x010c;
pub const XTPG_ZPLATE_VER_CONTROL: c_uint = 0x0110;
pub const XTPG_ZPLATE_START_SHIFT: c_int = 0;

pub const XTPG_ZPLATE_SPEED_SHIFT: c_int = 16;

pub const XTPG_BOX_SIZE: c_uint = 0x0114;
pub const XTPG_BOX_COLOR: c_uint = 0x0118;
pub const XTPG_STUCK_PIXEL_THRESH: c_uint = 0x011c;
pub const XTPG_NOISE_GAIN: c_uint = 0x0120;
pub const XTPG_BAYER_PHASE: c_uint = 0x0124;
pub const XTPG_BAYER_PHASE_RGGB: c_int = 0;
pub const XTPG_BAYER_PHASE_GRBG: c_int = 1;
pub const XTPG_BAYER_PHASE_GBRG: c_int = 2;
pub const XTPG_BAYER_PHASE_BGGR: c_int = 3;
pub const XTPG_BAYER_PHASE_OFF: c_int = 4;
//
...
//
pub const XTPG_MIN_HBLANK: c_int = 3;

pub const XTPG_MIN_VBLANK: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xtpg_device {
    pub xvip: xvip_device,
    pub pads: [media_pad; 2],
    pub npads: c_uint,
    pub has_input: bool,
    pub formats: [v4l2_mbus_framefmt; 2],
    pub default_format: v4l2_mbus_framefmt,
    pub vip_format: *const xvip_video_format,
    pub bayer: bool,
    pub ctrl_handler: v4l2_ctrl_handler,
    pub hblank: *mut v4l2_ctrl,
    pub vblank: *mut v4l2_ctrl,
    pub pattern: *mut v4l2_ctrl,
    pub streaming: bool,
    pub vtc: *mut xvtc_device,
    pub vtmux_gpio: *mut gpio_desc,
}
...
#[no_mangle]
unsafe extern "C" fn xtpg_get_bayer_phase(code: c_uint) -> u32 {
    ...
    {
    let mut pattern_mask: u32 = (1 << (xtpg.pattern.maximum + 1)) - 1;
//
...
//
#[no_mangle]
unsafe extern "C" fn xtpg_s_stream(subdev: *mut v4l2_subdev, enable: c_int) -> c_int {
    static int xtpg_s_stream(struct v4l2_subdev *subdev, int enable)
    {
    struct xtpg_device *xtpg = to_tpg(subdev);
    let mut width: c_uint = xtpg.formats[0].width;
    let mut height: c_uint = xtpg.formats[0].height;
    bool passthrough;
    u32 bayer_phase;
    if (!enable) {
    xvip_stop(&xtpg.xvip);
...
#[no_mangle]
unsafe extern "C" fn xtpg_open(subdev: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xtpg_close(subdev: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
    static int xtpg_close(struct v4l2_subdev *subdev, struct v4l2_subdev_fh *fh)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn xtpg_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xtpg_pm_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn xtpg_pm_resume(dev: *mut device) -> int __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn xtpg_parse_of(xtpg: *mut xtpg_device) -> c_int {
    static int xtpg_parse_of(struct xtpg_device *xtpg)
    {
    struct device *dev = xtpg.xvip.dev;
    struct device_node *node = xtpg.xvip.dev.of_node;
    let mut nports: c_uint = 0;
    let mut has_endpoint: bool = false;
...
// Get and check the format description
    ...
    if (nports == 0) {
    endpoint = of_graph_get_next_port_endpoint(port, core::ptr::null_mut());
    if (endpoint)
    has_endpoint = true;
...
#[no_mangle]
unsafe extern "C" fn xtpg_probe(pdev: *mut platform_device) -> c_int {
...
// Initialize V4L2 subdevice and media entity
    ...
    v4l2_ctrl_new_custom(&xtpg.ctrl_handler, &xtpg_ctrls[i], core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn xtpg_remove(pdev: *mut platform_device) {
