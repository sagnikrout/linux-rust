...
//! Source: drivers/media/platform/xilinx/xilinx-csi2rxss.c
#![no_std]
...
pub const XCSI_CCR_OFFSET: c_uint = 0x00;

pub const XCSI_PCR_OFFSET: c_uint = 0x04;

pub const XCSI_CSR_OFFSET: c_uint = 0x10;

pub const XCSI_GIER_OFFSET: c_uint = 0x20;

pub const XCSI_ISR_OFFSET: c_uint = 0x24;
pub const XCSI_IER_OFFSET: c_uint = 0x28;
...
pub const XCSI_SPKTR_OFFSET: c_uint = 0x30;

pub const XCSI_SPKT_FIFO_DEPTH: c_int = 31;
pub const XCSI_VCXR_OFFSET: c_uint = 0x34;

pub const XCSI_CLKINFR_OFFSET: c_uint = 0x3C;

pub const XCSI_DLXINFR_OFFSET: c_uint = 0x40;

pub const XCSI_MAXDL_COUNT: c_uint = 0x4;
pub const XCSI_VCXINF1R_OFFSET: c_uint = 0x60;

pub const XCSI_VCXINF1R_LINECOUNT_SHIFT: c_int = 16;

pub const XCSI_VCXINF2R_OFFSET: c_uint = 0x64;

pub const XCSI_MAXVCX_COUNT: c_int = 16;
//
// Sink pad connected to sensor source pad.
// Source pad connected to next module like demosaic.
//
pub const XCSI_MEDIA_PADS: c_int = 2;
pub const XCSI_DEFAULT_WIDTH: c_int = 1920;
pub const XCSI_DEFAULT_HEIGHT: c_int = 1080;
pub const XCSI_VCX_START: c_int = 4;
pub const XCSI_MAX_VC: c_int = 4;
pub const XCSI_MAX_VCX: c_int = 16;
pub const XCSI_NEXTREG_OFFSET: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xcsi2rxss_state {
    pub subdev: v4l2_subdev,
    pub format: v4l2_mbus_framefmt,
    pub default_format: v4l2_mbus_framefmt,
    pub events: [u32; XCSI_NUM_EVENTS],
    pub vcx_events: [u32; XCSI_VCX_NUM_EVENTS],
    pub dev: *mut device,
    pub rsubdev: *mut v4l2_subdev,
...
// used to protect access to this struct
    pub lock: mutex,
    pub pads: [media_pad; XCSI_MEDIA_PADS],
    pub streaming: bool,
    pub enable_active_lanes: bool,
    pub en_vcx: bool,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn xcsi2rxss_read(xcsi2rxss: *mut xcsi2rxss_state, addr: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn xcsi2rxss_get_nth_mbus(dt: u32, n: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn xcsi2rxss_get_dt(mbus: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn xcsi2rxss_soft_reset(state: *mut xcsi2rxss_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xcsi2rxss_hard_reset(state: *mut xcsi2rxss_state) {
...
#[no_mangle]
unsafe extern "C" fn xcsi2rxss_reset_event_counters(state: *mut xcsi2rxss_state) {
...
#[no_mangle]
unsafe extern "C" fn xcsi2rxss_log_counters(state: *mut xcsi2rxss_state) {
...
#[no_mangle]
unsafe extern "C" fn xcsi2rxss_log_status(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xcsi2rxss_start_stream(state: *mut xcsi2rxss_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xcsi2rxss_stop_stream(state: *mut xcsi2rxss_state) {
...
//
#[no_mangle]
unsafe extern "C" fn xcsi2rxss_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xcsi2rxss_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xcsi2rxss_parse_of(xcsi2rxss: *mut xcsi2rxss_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xcsi2rxss_probe(pdev: *mut platform_device) -> c_int {
    static int xcsi2rxss_probe(struct platform_device *pdev)
    {
    struct v4l2_subdev *subdev;
    struct xcsi2rxss_state *xcsi2rxss;
    let mut num_clks: c_int = ARRAY_SIZE(xcsi2rxss_clks);
...
#[no_mangle]
unsafe extern "C" fn xcsi2rxss_remove(pdev: *mut platform_device) {
