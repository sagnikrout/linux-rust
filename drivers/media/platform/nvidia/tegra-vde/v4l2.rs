...
//! Source: drivers/media/platform/nvidia/tegra-vde/v4l2.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tegra_set_control_data(ctx: *mut tegra_ctx, data: *mut c_void, id: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_vde_prepare_control_data(ctx: *mut tegra_ctx, id: u32) {
    ...
    tegra_set_control_data(ctx, core::ptr::null_mut(), id);
    }
...
#[no_mangle]
unsafe extern "C" fn tegra_buf_out_validate(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __tegra_buf_cleanup(vb: *mut vb2_buffer, i: c_uint) {
    ...
    tb.a[i] = core::ptr::null_mut();
    }
    if (tb.iova[i]) {
    tegra_vde_iommu_unmap(ctx.vde, tb.iova[i]);
    tb.iova[i] = core::ptr::null_mut();
    }
    }
    if (tb.aux) {
    tegra_vde_free_bo(tb.aux);
    tb.aux = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn tegra_buf_init(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_buf_cleanup(vb: *mut vb2_buffer) {
    static void tegra_buf_cleanup(struct vb2_buffer *vb)
    {
    __tegra_buf_cleanup(vb, vb.num_planes);
    }
#[no_mangle]
unsafe extern "C" fn tegra_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn tegra_buf_request_complete(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn tegra_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
    static int tegra_start_streaming(struct vb2_queue *vq, unsigned int count)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tegra_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn tegra_reset_coded_fmt(ctx: *mut tegra_ctx) {
    ...
    let mut hdiv: c_uint = (i == 0) ? 1 : 2;
    let mut vdiv: c_uint = (i == 0) ? 1 : 2;
//
...
#[no_mangle]
unsafe extern "C" fn tegra_reset_decoded_fmt(ctx: *mut tegra_ctx) {
...
#[no_mangle]
unsafe extern "C" fn tegra_decode_complete(work: *mut work_struct) {
...
// f = ctx->coded_fmt;
    ...
    struct tegra_ctx *ctx = file_to_tegra_ctx(file);
    const struct tegra_vde_soc *soc = ctx.vde.soc;
    let mut size: c_int = pix_mp.plane_fmt[0].sizeimage;
...
#[no_mangle]
unsafe extern "C" fn tegra_init_ctrls(ctx: *mut tegra_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_init_m2m(ctx: *mut tegra_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_device_run(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tegra_request_validate(req: *mut media_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_vde_v4l2_init(vde: *mut tegra_vde) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_vde_v4l2_deinit(vde: *mut tegra_vde) {
