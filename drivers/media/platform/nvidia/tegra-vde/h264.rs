...
//! Source: drivers/media/platform/nvidia/tegra-vde/h264.c
#![no_std]
...
pub const FLAG_B_FRAME: c_uint = 0x1;
pub const FLAG_REFERENCE: c_uint = 0x2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_vde_h264_decoder_ctx {
    pub dpb_frames_nb: c_uint,
    pub dpb_ref_frames_with_earlier_poc_nb: c_uint,
    pub baseline_profile: c_uint,
    pub level_idc: c_uint,
    pub log2_max_pic_order_cnt_lsb: c_uint,
    pub log2_max_frame_num: c_uint,
    pub pic_order_cnt_type: c_uint,
    pub direct_8x8_inference_flag: c_uint,
    pub pic_width_in_mbs: c_uint,
    pub pic_height_in_mbs: c_uint,
    pub pic_init_qp: c_uint,
    pub deblocking_filter_control_present_flag: c_uint,
    pub constrained_intra_pred_flag: c_uint,
    pub chroma_qp_index_offset: c_uint,
    pub pic_order_present_flag: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct h264_reflists {
    pub p: [v4l2_h264_reference; V4L2_H264_NUM_DPB_ENTRIES],
    pub b0: [v4l2_h264_reference; V4L2_H264_NUM_DPB_ENTRIES],
    pub b1: [v4l2_h264_reference; V4L2_H264_NUM_DPB_ENTRIES],
}

#[no_mangle]
unsafe extern "C" fn tegra_vde_wait_mbe(vde: *mut tegra_vde) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_vde_mbe_set_0xa_reg(vde: *mut tegra_vde, reg: c_int, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra_vde_wait_bsev(vde: *mut tegra_vde, wait_dma: bool) -> c_int {
    ...
    {
    let mut y_addr: u32 = frame ? frame.y_addr  : 0x6CDEAD00;
    let mut cb_addr: u32 = frame ? frame.cb_addr : 0x6CDEAD00;
    let mut cr_addr: u32 = frame ? frame.cr_addr : 0x6CDEAD00;
    let mut value1: u32 = frame ? ((frame.luma_atoms_pitch << 16) | mbs_height) : 0;
    let mut value2: u32 = frame ? ((frame.chroma_atoms_pitch << 6) | 1) : 0;
    ...
    for (; idx < 17; idx++)
    tegra_vde_setup_frameid(vde, core::ptr::null_mut(), idx, 0, 0);
    }
...
#[no_mangle]
unsafe extern "C" fn tegra_vde_decode_abort(vde: *mut tegra_vde) {
...
#[no_mangle]
unsafe extern "C" fn tegra_vde_decode_end(vde: *mut tegra_vde) -> c_int {
...
//
    ...
    size_t min_size)
    {
    let mut offset: u64 = vb.planes[plane_id].data_offset;
...
//
    ...
    tb.b_frame = false;
    err = tegra_vde_h264_setup_frame(ctx, h264, core::ptr::null_mut(), &dst.vb2_buf, 0,
    h264.dpb_frames_nb++);
    if (err)
    return err;
    ...
    let mut dpb_idx: c_int = dpb_id[i].index;
...
#[no_mangle]
unsafe extern "C" fn to_tegra_vde_h264_level_idc(level_idc: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_vde_h264_decode_run(ctx: *mut tegra_ctx) -> c_int {
    int tegra_vde_h264_decode_run(struct tegra_ctx *ctx)
    {
    struct vb2_v4l2_buffer *src = v4l2_m2m_next_src_buf(ctx.fh.m2m_ctx);
    struct tegra_m2m_buffer *bitstream = vb_to_tegra_buf(&src.vb2_buf);
    let mut bitstream_size: usize = vb2_get_plane_payload(&src.vb2_buf, 0);
    struct tegra_vde_h264_decoder_ctx h264;
    struct tegra_vde *vde = ctx.vde;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn tegra_vde_h264_decode_wait(ctx: *mut tegra_ctx) -> c_int {
