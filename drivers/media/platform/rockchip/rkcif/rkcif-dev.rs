...
//! Source: drivers/media/platform/rockchip/rkcif/rkcif-dev.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rkcif_register(rkcif: *mut rkcif_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkcif_unregister(rkcif: *mut rkcif_device) {
...
#[no_mangle]
unsafe extern "C" fn rkcif_notifier_complete(notifier: *mut v4l2_async_notifier) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkcif_isr(irq: c_int, ctx: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rkcif_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkcif_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rkcif_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkcif_runtime_resume(dev: *mut device) -> c_int {
