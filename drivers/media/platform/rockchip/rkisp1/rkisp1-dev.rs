...
//! Source: drivers/media/platform/rockchip/rkisp1/rkisp1-dev.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rkisp1_isr_data {
    pub name: *const c_char,
    pub ctx): *mut *mut irqreturn_t (isr)(int irq, void,
    pub line_mask: u32,
}
...
#[no_mangle]
unsafe extern "C" fn rkisp1_subdev_notifier_complete(notifier: *mut v4l2_async_notifier) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_subdev_notifier_destroy(asc: *mut v4l2_async_connection) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_subdev_notifier_register(rkisp1: *mut rkisp1_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rkisp1_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
// Make sure the IRQ handler will see the above
    ...
    SET_RUNTIME_PM_OPS(rkisp1_runtime_suspend, rkisp1_runtime_resume, core::ptr::null_mut())
    };
// ----------------------------------------------------------------------------
// Core
//
#[no_mangle]
unsafe extern "C" fn rkisp1_create_links(rkisp1: *mut rkisp1_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_entities_unregister(rkisp1: *mut rkisp1_device) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_entities_register(rkisp1: *mut rkisp1_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_isr(irq: c_int, ctx: *mut c_void) -> irqreturn_t {
...
//
    ...
    { core::ptr::null_mut(), rkisp1_isr, BIT(RKISP1_IRQ_ISP) | BIT(RKISP1_IRQ_MI) | BIT(RKISP1_IRQ_MIPI) },
    };
    ...
    { core::ptr::null_mut(), rkisp1_isr, BIT(RKISP1_IRQ_ISP) | BIT(RKISP1_IRQ_MI) },
    };
...
#[no_mangle]
unsafe extern "C" fn rkisp1_init_clocks(rkisp1: *mut rkisp1_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_init_pm_domains(rkisp1: *mut rkisp1_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_remove(pdev: *mut platform_device) {
