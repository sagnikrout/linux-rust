...
//! Source: drivers/media/platform/rockchip/rkisp1/rkisp1-resizer.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rkisp1_rsz_yuv_mbus_info {
    pub mbus_code: u32,
    pub hdiv: u32,
    pub vdiv: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rkisp1_rsz_config {
// constrains
    pub max_rsz_width: c_int,
    pub max_rsz_height: c_int,
    pub min_rsz_width: c_int,
    pub min_rsz_height: c_int,
// registers
    struct {
    pub yuvmode_mask: u32,
    pub rawmode_mask: u32,
    pub h_offset: u32,
    pub v_offset: u32,
    pub h_size: u32,
    pub v_size: u32,
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_rsz_read(rsz: *mut rkisp1_resizer, offset: u32) -> u32 {
...
//
    ...
    {
    let mut dc_ctrl: u32 = rkisp1_read(rsz.rkisp1, RKISP1_CIF_DUAL_CROP_CTRL);
...
//
    ...
    enum rkisp1_shadow_regs_when when)
    {
    let mut ctrl_cfg: u32 = rkisp1_rsz_read(rsz, RKISP1_CIF_RSZ_CTRL);
    if (when == RKISP1_SHADOW_REGS_ASYNC)
...
#[no_mangle]
unsafe extern "C" fn rkisp1_rsz_calc_ratio(len_sink: u32, len_src: u32) -> u32 {
...
//
    ...
    let mut index: c_uint = code.index;
    unsigned int i;
...
//
#[no_mangle]
unsafe extern "C" fn rkisp1_rsz_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
    ...
    let mut when: enum rkisp1_shadow_regs_when = RKISP1_SHADOW_REGS_SYNC;
...
#[no_mangle]
unsafe extern "C" fn rkisp1_rsz_unregister(rsz: *mut rkisp1_resizer) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_rsz_register(rsz: *mut rkisp1_resizer) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_resizer_devs_register(rkisp1: *mut rkisp1_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_resizer_devs_unregister(rkisp1: *mut rkisp1_device) {
