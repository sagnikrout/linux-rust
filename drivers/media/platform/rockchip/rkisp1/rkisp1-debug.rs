...
//! Source: drivers/media/platform/rockchip/rkisp1/rkisp1-debug.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rkisp1_debug_register {
    pub reg: u32,
    pub shd: u32,
...
pub const RKISP1_MAX_REG_LENGTH: c_int = 21;
    ...
    {
    let mut width: c_int = RKISP1_MAX_REG_LENGTH;
    u32 val, shd;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rkisp1_debug_dump_core_regs_show(m: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_debug_dump_isp_regs_show(m: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_debug_dump_rsz_regs_show(m: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_debug_dump_mi_mp_show(m: *mut seq_file, p: *mut c_void) -> c_int {
...
pub const RKISP1_DEBUG_DATA_COUNT_BINS: c_int = 32;

#[no_mangle]
unsafe extern "C" fn rkisp1_debug_input_status_show(m: *mut seq_file, p: *mut c_void) -> c_int {
    static int rkisp1_debug_input_status_show(struct seq_file *m, void *p)
    {
    struct rkisp1_device *rkisp1 = m.private;
    u16 data_count[RKISP1_DEBUG_DATA_COUNT_BINS] = { };
    let mut hsync_count: c_uint = 0;
    let mut vsync_count: c_uint = 0;
    unsigned int i;
    u32 data;
    u32 val;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_debug_init(rkisp1: *mut rkisp1_device) {
    void rkisp1_debug_init(struct rkisp1_device *rkisp1)
    {
    struct rkisp1_debug *debug = &rkisp1.debug;
    struct dentry *regs_dir;
    debug.debugfs_dir = debugfs_create_dir(dev_name(rkisp1.dev), core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_debug_cleanup(rkisp1: *mut rkisp1_device) {
