...
//! Source: drivers/media/platform/rockchip/rkisp1/rkisp1-params.c
#![no_std]
...
pub const RKISP1_ISP_PARAMS_REQ_BUFS_MIN: c_int = 2;
pub const RKISP1_ISP_PARAMS_REQ_BUFS_MAX: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn rkisp1_ctk_enable(params: *mut rkisp1_params, en: bool) {
...
// AWB window size
    ...
    bool en)
    {
    let mut reg_val: u32 = rkisp1_read(params.rkisp1, RKISP1_CIF_ISP_AWB_PROP_V10);
// switch off
...
// Measurements require AWB block be active.
    ...
    bool en)
    {
    let mut reg_val: u32 = rkisp1_read(params.rkisp1, RKISP1_CIF_ISP_AWB_PROP_V12);
// switch off
    reg_val &= RKISP1_CIF_ISP_AWB_MODE_MASK_NONE;
    if (en) {
    if (arg.awb_mode == RKISP1_CIF_ISP_AWB_MODE_RGB)
...
// avoid to override the old enable value
    ...
    let mut effect: u32 = cur_ie_config.effect;
    let mut quantization: u32 = params.quantization;
...
// avoid to override the old enable value
    ...
    arg.num_afm_win);
    let mut afm_ctrl: u32 = rkisp1_read(params.rkisp1, RKISP1_CIF_ISP_AFM_CTRL);
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn rkisp1_ie_enable(params: *mut rkisp1_params, en: bool) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_csm_config(params: *mut rkisp1_params) {
    static void rkisp1_csm_config(struct rkisp1_params *params)
    {
#[repr(C)]
#[derive(Copy, Clone)]
pub struct csm_coeffs {
    pub limited: [u16; 9],
    pub full: [u16; 9],
}
...
// ISP De-noise Pre-Filter(DPF) function
    ...
    {
    let mut points_per_reg: c_uint = 6;
...
#[no_mangle]
pub unsafe extern "C" fn if(RKISP1_EXT_PARAMS_FL_BLOCK_ENABLE: block->header.flags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_params_isr(rkisp1: *mut rkisp1_device) {
...
//
    ...
    {
    let mut hst: rkisp1_cif_isp_hst_config = rkisp1_hst_params_default_config;
    struct rkisp1_params_buffer *cur_buf;
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_params_post_configure(params: *mut rkisp1_params) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rkisp1_params_disable(params: *mut rkisp1_params) {
    ...
    rkisp1_param_clear_bits(params, RKISP1_CIF_ISP_FILT_MODE,
    RKISP1_CIF_ISP_FLT_ENA);
    params.ops.awb_meas_enable(params, core::ptr::null_mut(), false);
    rkisp1_param_clear_bits(params, RKISP1_CIF_ISP_CTRL,
    RKISP1_CIF_ISP_CTRL_ISP_AWB_ENA);
    rkisp1_param_clear_bits(params, RKISP1_CIF_ISP_EXP_CTRL,
    RKISP1_CIF_ISP_EXP_ENA);
    ...
    rkisp1_param_clear_bits(params, RKISP1_CIF_C_PROC_CTRL,
    RKISP1_CIF_C_PROC_CTR_ENABLE);
    params.ops.hst_enable(params, core::ptr::null_mut(), false);
    rkisp1_param_clear_bits(params, RKISP1_CIF_ISP_AFM_CTRL,
    RKISP1_CIF_ISP_AFM_ENA);
    rkisp1_ie_enable(params, false);
    rkisp1_param_clear_bits(params, RKISP1_CIF_ISP_DPF_MODE,
...
#[no_mangle]
unsafe extern "C" fn rkisp1_params_vb2_buf_init(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_params_vb2_buf_cleanup(vb: *mut vb2_buffer) {
    static void rkisp1_params_vb2_buf_cleanup(struct vb2_buffer *vb)
    {
    struct vb2_v4l2_buffer *vbuf = to_vb2_v4l2_buffer(vb);
    struct rkisp1_params_buffer *params_buf = to_rkisp1_params_buffer(vbuf);
    kvfree(params_buf.cfg);
    params_buf.cfg = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn rkisp1_params_vb2_buf_queue(vb: *mut vb2_buffer) {
    ...
    let mut payload_size: usize = vb2_get_plane_payload(vb, 0);
...
#[no_mangle]
unsafe extern "C" fn rkisp1_params_vb2_buf_prepare(vb: *mut vb2_buffer) -> c_int {
    ...
    let mut payload: usize = vb2_get_plane_payload(vb, 0);
...
#[no_mangle]
unsafe extern "C" fn rkisp1_params_vb2_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_params_ctrl_init(params: *mut rkisp1_params) -> c_int {
    ...
    v4l2_ctrl_new_custom(&params.ctrls, &ctrl_config, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_params_register(rkisp1: *mut rkisp1_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_params_unregister(rkisp1: *mut rkisp1_device) {
