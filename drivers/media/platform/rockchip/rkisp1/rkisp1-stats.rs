...
//! Source: drivers/media/platform/rockchip/rkisp1/rkisp1-stats.c
#![no_std]
...
pub const RKISP1_ISP_STATS_REQ_BUFS_MIN: c_int = 2;
pub const RKISP1_ISP_STATS_REQ_BUFS_MAX: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn rkisp1_stats_vb2_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_stats_vb2_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_stats_vb2_stop_streaming(vq: *mut vb2_queue) {
...
// Protect against concurrent access from ISR?
    ...
    let mut reg_val: u32 = rkisp1_read(rkisp1, RKISP1_CIF_ISP_HIST_BIN_0_V10 + i * 4);
    ...
    struct rkisp1_buffer *cur_buf = core::ptr::null_mut();
    let mut frame_sequence: c_uint = stats.rkisp1.isp.frame_sequence;
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_stats_isr(stats: *mut rkisp1_stats, isp_ris: u32) {
    void rkisp1_stats_isr(struct rkisp1_stats *stats, u32 isp_ris)
    {
    struct rkisp1_device *rkisp1 = stats.rkisp1;
    let mut isp_mis_tmp: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn rkisp1_init_stats(stats: *mut rkisp1_stats) {
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_stats_register(rkisp1: *mut rkisp1_device) -> c_int {
    ...
    stats.rkisp1 = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn rkisp1_stats_unregister(rkisp1: *mut rkisp1_device) {
