...
//! Source: drivers/media/platform/rockchip/rkisp1/rkisp1-isp.c
#![no_std]
...
//
pub const ISP_DEWARP_CONTROL: c_uint = 0x0138;
...
#[no_mangle]
unsafe extern "C" fn rkisp1_gasket_disable(rkisp1: *mut rkisp1_device) {
...
//
    ...
    {
    struct rkisp1_device *rkisp1 = isp.rkisp1;
    let mut isp_ctrl: u32 = 0, irq_mask = 0, acq_mult = 0, acq_prop = 0;
...
// Configure MUX
    ...
    {
    struct rkisp1_device *rkisp1 = isp.rkisp1;
    let mut dpcl: u32 = rkisp1_read(rkisp1, RKISP1_CIF_VI_DPCL);
    if (mbus_type == V4L2_MBUS_BT656 || mbus_type == V4L2_MBUS_PARALLEL)
    dpcl |= RKISP1_CIF_VI_DPCL_IF_SEL_PARALLEL;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_MBUS_CSI2_DPHY: mbus_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_isp_stop(isp: *mut rkisp1_isp) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_config_clk(isp: *mut rkisp1_isp) {
...
#[no_mangle]
pub unsafe extern "C" fn if(RKISP1_ISP_PAD_SOURCE_VIDEO: fmt->pad ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(RKISP1_ISP_PAD_SOURCE_VIDEO: sel->pad ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_subdev_link_validate(link: *mut media_link) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rkisp1_isp_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_isp_register(rkisp1: *mut rkisp1_device) -> c_int {
    ...
    isp.sd.v4l2_dev = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn rkisp1_isp_unregister(rkisp1: *mut rkisp1_device) {
...
//
#[no_mangle]
unsafe extern "C" fn rkisp1_isp_sof(isp: *mut rkisp1_isp) {
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_isp_isr(irq: c_int, ctx: *mut c_void) -> irqreturn_t {
