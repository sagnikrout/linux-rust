...
//! Source: drivers/media/platform/rockchip/rkisp1/rkisp1-capture.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rkisp1_capture_fmt_cfg {
    pub fourcc: u32,
    pub 1: u32 uv_swap :,
    pub 1: u32 yc_swap :,
    pub 1: u32 byte_swap :,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rkisp1_capture_ops {
    pub cap): *mut *mut void (config)(struct rkisp1_capture,
    pub cap): *mut *mut void (stop)(struct rkisp1_capture,
    pub cap): *mut *mut void (enable)(struct rkisp1_capture,
    pub cap): *mut *mut void (disable)(struct rkisp1_capture,
    pub cap): *mut *mut void (set_data_path)(struct rkisp1_capture,
    pub cap): *mut *mut bool (is_stopped)(struct rkisp1_capture,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rkisp1_capture_config {
    pub fmts: *const rkisp1_capture_fmt_cfg,
    pub fmt_size: c_int,
    struct {
    pub y_size_init: u32,
    pub cb_size_init: u32,
    pub cr_size_init: u32,
    pub y_base_ad_init: u32,
    pub cb_base_ad_init: u32,
    pub cr_base_ad_init: u32,
    pub y_offs_cnt_init: u32,
    pub cb_offs_cnt_init: u32,
    pub cr_offs_cnt_init: u32,
    pub mi: },
}
...
//
#[no_mangle]
unsafe extern "C" fn rkisp1_mi_config_ctrl(cap: *mut rkisp1_capture) {
    static void rkisp1_mi_config_ctrl(struct rkisp1_capture *cap)
    {
    let mut mi_ctrl: u32 = rkisp1_read(cap.rkisp1, RKISP1_CIF_MI_CTRL);
...
#[no_mangle]
unsafe extern "C" fn rkisp1_irq_frame_end_enable(cap: *mut rkisp1_capture) {
    static void rkisp1_irq_frame_end_enable(struct rkisp1_capture *cap)
    {
    let mut mi_imsc: u32 = rkisp1_read(cap.rkisp1, RKISP1_CIF_MI_IMSC);
    mi_imsc |= RKISP1_CIF_MI_FRAME(cap);
    rkisp1_write(cap.rkisp1, RKISP1_CIF_MI_IMSC, mi_imsc);
    }
#[no_mangle]
unsafe extern "C" fn rkisp1_mp_config(cap: *mut rkisp1_capture) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_sp_config(cap: *mut rkisp1_capture) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_mp_disable(cap: *mut rkisp1_capture) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_sp_disable(cap: *mut rkisp1_capture) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_mp_enable(cap: *mut rkisp1_capture) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_sp_enable(cap: *mut rkisp1_capture) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_mp_sp_stop(cap: *mut rkisp1_capture) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_mp_is_stopped(cap: *mut rkisp1_capture) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_sp_is_stopped(cap: *mut rkisp1_capture) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_mp_set_data_path(cap: *mut rkisp1_capture) {
    static void rkisp1_mp_set_data_path(struct rkisp1_capture *cap)
    {
    let mut dpcl: u32 = rkisp1_read(cap.rkisp1, RKISP1_CIF_VI_DPCL);
...
#[no_mangle]
unsafe extern "C" fn rkisp1_sp_set_data_path(cap: *mut rkisp1_capture) {
...
//
#[no_mangle]
unsafe extern "C" fn rkisp1_dummy_buf_create(cap: *mut rkisp1_capture) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_dummy_buf_destroy(cap: *mut rkisp1_capture) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_set_next_buf(cap: *mut rkisp1_capture) {
    static void rkisp1_set_next_buf(struct rkisp1_capture *cap)
    {
    let mut shift: u8 = rkisp1_has_feature(cap.rkisp1, DMA_34BIT) ? 2 : 0;
    cap.buf.curr = cap.buf.next;
    cap.buf.next = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn rkisp1_handle_buffer(cap: *mut rkisp1_capture) {
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_capture_isr(irq: c_int, ctx: *mut c_void) -> irqreturn_t {
    irqreturn_t rkisp1_capture_isr(int irq, void *ctx)
    {
    struct device *dev = ctx;
    struct rkisp1_device *rkisp1 = dev_get_drvdata(dev);
    let mut dev_count: c_uint = rkisp1_path_count(rkisp1);
    unsigned int i;
    u32 status;
...
#[no_mangle]
unsafe extern "C" fn rkisp1_vb2_buf_init(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_vb2_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_vb2_buf_prepare(vb: *mut vb2_buffer) -> c_int {
    static int rkisp1_vb2_buf_prepare(struct vb2_buffer *vb)
    {
    struct rkisp1_capture *cap = vb.vb2_queue.drv_priv;
    unsigned int i;
    for (i = 0; i < cap.pix.fmt.num_planes; i++) {
    let mut size: c_ulong = cap.pix.fmt.plane_fmt[i].sizeimage;
    ...
    cap.buf.curr = core::ptr::null_mut();
    }
    if (cap.buf.next) {
...
//
#[no_mangle]
unsafe extern "C" fn rkisp1_cap_stream_enable(cap: *mut rkisp1_capture) {
    static void rkisp1_cap_stream_enable(struct rkisp1_capture *cap)
    {
    struct rkisp1_device *rkisp1 = cap.rkisp1;
    struct rkisp1_capture *other = &rkisp1.capture_devs[cap.id ^ 1];
    let mut has_self_path: bool = rkisp1_has_feature(rkisp1, SELF_PATH);
...
#[no_mangle]
unsafe extern "C" fn rkisp1_cap_stream_disable(cap: *mut rkisp1_capture) {
...
//
#[no_mangle]
unsafe extern "C" fn rkisp1_pipeline_stream_disable(cap: *mut rkisp1_capture) {
...
//
#[no_mangle]
unsafe extern "C" fn rkisp1_pipeline_stream_enable(cap: *mut rkisp1_capture) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_vb2_stop_streaming(queue: *mut vb2_queue) {
...
//
    ...
    {
    let mut yc_swap_support: bool = rkisp1_has_feature(cap.rkisp1, MAIN_STRIDE);
    unsigned int i;
    for (i = 0; i < cap.config.fmt_size; i++) {
...
// fmt_info = info;
    ...
    rkisp1_try_fmt(cap, &f.fmt.pix_mp, core::ptr::null_mut(), core::ptr::null_mut());
    return 0;
    }
    ...
    {
    struct rkisp1_capture *cap = video_drvdata(file);
    const struct rkisp1_capture_fmt_cfg *fmt = core::ptr::null_mut();
    let mut yc_swap_support: bool = rkisp1_has_feature(cap.rkisp1, MAIN_STRIDE);
    unsigned int i, n = 0;
...
#[no_mangle]
unsafe extern "C" fn rkisp1_capture_link_validate(link: *mut media_link) -> c_int {
    ...
    int ret;
    ret = v4l2_subdev_call(sd, pad, get_fmt, core::ptr::null_mut(), &sd_fmt);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn rkisp1_unregister_capture(cap: *mut rkisp1_capture) {
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_capture_devs_unregister(rkisp1: *mut rkisp1_device) {
...
#[no_mangle]
unsafe extern "C" fn rkisp1_register_capture(cap: *mut rkisp1_capture) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rkisp1_capture_devs_register(rkisp1: *mut rkisp1_device) -> c_int {
