...
//! Source: drivers/media/platform/rockchip/rkvdec/rkvdec-vdpu381-h264.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rkvdec_sps {
    pub 4: u16 seq_parameter_set_id:,
    pub 8: u16 profile_idc:,
    pub 1: u16 constraint_set3_flag:,
    pub 2: u16 chroma_format_idc:,
    pub 3: u16 bit_depth_luma:,
    pub 3: u16 bit_depth_chroma:,
    pub 1: u16 qpprime_y_zero_transform_bypass_flag:,
    pub 4: u16 log2_max_frame_num_minus4:,
    pub 5: u16 max_num_ref_frames:,
    pub 2: u16 pic_order_cnt_type:,
    pub 4: u16 log2_max_pic_order_cnt_lsb_minus4:,
    pub 1: u16 delta_pic_order_always_zero_flag:,
    pub 12: u16 pic_width_in_mbs:,
    pub 12: u16 pic_height_in_mbs:,
    pub 1: u16 frame_mbs_only_flag:,
    pub 1: u16 mb_adaptive_frame_field_flag:,
    pub 1: u16 direct_8x8_inference_flag:,
    pub 1: u16 mvc_extension_enable:,
    pub 2: u16 num_views:,
    pub 12: u16 reserved_bits:,
    pub reserved: [u16; 11],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rkvdec_pps {
    pub 8: u16 pic_parameter_set_id:,
    pub 5: u16 pps_seq_parameter_set_id:,
    pub 1: u16 entropy_coding_mode_flag:,
    pub 1: u16 bottom_field_pic_order_in_frame_present_flag:,
    pub 5: u16 num_ref_idx_l0_default_active_minus1:,
    pub 5: u16 num_ref_idx_l1_default_active_minus1:,
    pub 1: u16 weighted_pred_flag:,
    pub 2: u16 weighted_bipred_idc:,
    pub 7: u16 pic_init_qp_minus26:,
    pub 6: u16 pic_init_qs_minus26:,
    pub 5: u16 chroma_qp_index_offset:,
    pub 1: u16 deblocking_filter_control_present_flag:,
    pub 1: u16 constrained_intra_pred_flag:,
    pub 1: u16 redundant_pic_cnt_present:,
    pub 1: u16 transform_8x8_mode_flag:,
    pub 5: u16 second_chroma_qp_index_offset:,
    pub 1: u16 scaling_list_enable_flag:,
    pub scaling_list_address: u32,
    pub is_longterm: u16,
    pub reserved: [u8; 3],
    pub __packed: },
#[repr(C)]
...
pub struct rkvdec_h264_ctx {
    ...
    pub regs: rkvdec_vdpu381_regs_h264,
}
