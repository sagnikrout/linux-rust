...
//! Source: drivers/media/platform/rockchip/rkvdec/rkvdec-vdpu381-hevc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rkvdec_hevc_sps {
    pub 4: u16 video_parameters_set_id :,
    pub 4: u16 seq_parameters_set_id_sps :,
    pub 2: u16 chroma_format_idc :,
    pub 16: u16 width :,
    pub 16: u16 height :,
    pub 4: u16 bit_depth_luma :,
    pub 4: u16 bit_depth_chroma :,
    pub 5: u16 max_pic_order_count_lsb :,
    pub 2: u16 diff_max_min_luma_coding_block_size :,
    pub 3: u16 min_luma_coding_block_size :,
    pub 3: u16 min_transform_block_size :,
    pub 2: u16 diff_max_min_transform_block_size :,
    pub 3: u16 max_transform_hierarchy_depth_inter :,
    pub 3: u16 max_transform_hierarchy_depth_intra :,
    pub 1: u16 scaling_list_enabled_flag :,
    pub 1: u16 amp_enabled_flag :,
    pub 1: u16 sample_adaptive_offset_enabled_flag :,
    pub 1: u16 pcm_enabled_flag :,
    pub 4: u16 pcm_sample_bit_depth_luma :,
    pub 4: u16 pcm_sample_bit_depth_chroma :,
    pub 1: u16 pcm_loop_filter_disabled_flag :,
    pub 3: u16 diff_max_min_pcm_luma_coding_block_size :,
    pub 3: u16 min_pcm_luma_coding_block_size :,
    pub 7: u16 num_short_term_ref_pic_sets :,
    pub 1: u16 long_term_ref_pics_present_flag :,
    pub 6: u16 num_long_term_ref_pics_sps :,
    pub 1: u16 sps_temporal_mvp_enabled_flag :,
    pub 1: u16 strong_intra_smoothing_enabled_flag :,
    pub 7: u16 reserved_0 :,
    pub 4: u16 sps_max_dec_pic_buffering_minus1 :,
    pub 3: u16 reserved_0_2 :,
    pub 8: u16 reserved_f :,
    pub __packed: },
// PPS
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rkvdec_hevc_pps {
    pub 6: u16 picture_parameters_set_id :,
    pub 4: u16 seq_parameters_set_id_pps :,
    pub 1: u16 dependent_slice_segments_enabled_flag :,
    pub 1: u16 output_flag_present_flag :,
    pub 13: u16 num_extra_slice_header_bits :,
    pub 1: u16 sign_data_hiding_enabled_flag :,
    pub 1: u16 cabac_init_present_flag :,
    pub 4: u16 num_ref_idx_l0_default_active :,
    pub 4: u16 num_ref_idx_l1_default_active :,
    pub 7: u16 init_qp_minus26 :,
    pub 1: u16 constrained_intra_pred_flag :,
    pub 1: u16 transform_skip_enabled_flag :,
    pub 1: u16 cu_qp_delta_enabled_flag :,
    pub 3: u16 log2_min_cb_size :,
    pub 5: u16 pps_cb_qp_offset :,
    pub 5: u16 pps_cr_qp_offset :,
    pub 1: u16 pps_slice_chroma_qp_offsets_present_flag :,
    pub 1: u16 weighted_pred_flag :,
    pub 1: u16 weighted_bipred_flag :,
    pub 1: u16 transquant_bypass_enabled_flag :,
    pub 1: u16 tiles_enabled_flag :,
    pub 1: u16 entropy_coding_sync_enabled_flag :,
    pub 1: u16 pps_loop_filter_across_slices_enabled_flag :,
    pub 1: u16 loop_filter_across_tiles_enabled_flag :,
    pub 1: u16 deblocking_filter_override_enabled_flag :,
    pub 1: u16 pps_deblocking_filter_disabled_flag :,
    pub 4: u16 pps_beta_offset_div2 :,
    pub 4: u16 pps_tc_offset_div2 :,
    pub 1: u16 lists_modification_present_flag :,
    pub 3: u16 log2_parallel_merge_level :,
    pub 1: u16 slice_segment_header_extension_present_flag :,
    pub 3: u16 zeroes :,
    pub 5: u16 num_tile_columns :,
    pub 5: u16 num_tile_rows :,
    pub 4: u16 sps_pps_mode :,
    pub 14: u16 reserved_bits :,
    pub reserved: u16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rkvdec_hevc_tile {
    pub 12: u16 value0 :,
    pub 12: u16 value1 :,
    pub __packed: },
#[repr(C)]
...
pub struct rkvdec_sps_pps_packet {
    pub sps: rkvdec_hevc_sps,
    pub pps: rkvdec_hevc_pps,
    pub column_width: [rkvdec_hevc_tile; 10],
    pub row_height: [rkvdec_hevc_tile; 11],
    pub zeroes: [u32; 3],
    pub 6: u32 zeroes_bits :,
    pub 2: u32 padding_bits :,
    pub padding: u32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rkvdec_hevc_priv_tbl {
    pub param_set: [rkvdec_sps_pps_packet; 64],
    pub rps: rkvdec_rps,
...
pub struct rkvdec_hevc_ctx {
    ...
    pub regs: rkvdec_vdpu381_regs_hevc,
}
...
#[no_mangle]
unsafe extern "C" fn set_ref_valid(regs: *mut rkvdec_vdpu381_regs_hevc, id: c_int, valid: u32) {
...
unsafe extern "C" fn rkvdec_write_regs(ctx: *mut rkvdec_ctx) {
    ...
    dma_addr_t rlc_addr;
    let mut hor_virstride: u32 = 0;
    let mut ver_virstride: u32 = 0;
    let mut y_virstride: u32 = 0;
    u32 offset;
    u32 pixels;
    dma_addr_t dst_addr;
    u32 i;
...
// Set ref pic address & poc
    ...
    let mut buf_dma: dma_addr_t = vb2_dma_contig_plane_dma_addr(vb_buf, 0);
    let mut valid: u32 = !!(dec_params.num_active_dpb_entries > i);
