...
//! Source: drivers/media/platform/rockchip/rga/rga-buf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rga_buf_init(vb: *mut vb2_buffer) -> c_int {
    ...
    int plane)
    {
    let mut stride: u32 = f.pix.plane_fmt[0].bytesperline;
    if (plane == 0)
    return 0;
    if (plane == 1)
...
#[no_mangle]
unsafe extern "C" fn rga_buf_prepare(vb: *mut vb2_buffer) -> c_int {
    ...
    struct rga_ctx *ctx = vb2_get_drv_priv(vb.vb2_queue);
    struct rga_frame *f = rga_get_frame(ctx, vb.vb2_queue.type);
    let mut n_desc: isize = 0;
    let mut curr_desc: usize = 0;
    int i;
    const struct v4l2_format_info *info;
...
#[no_mangle]
unsafe extern "C" fn rga_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn rga_buf_cleanup(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn rga_buf_prepare_streaming(q: *mut vb2_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rga_buf_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rga_buf_stop_streaming(q: *mut vb2_queue) {
