...
//! Source: drivers/media/platform/broadcom/bcm2835-unicam.c
#![no_std]
...
pub const UNICAM_DMA_BPL_ALIGNMENT: c_int = 16;
//
...
//
pub const UNICAM_IMAGE_BPL_ALIGNMENT: c_int = 32;
...
//
pub const UNICAM_IMAGE_MIN_WIDTH: c_int = 16;
pub const UNICAM_IMAGE_MIN_HEIGHT: c_int = 16;
...
// size computation.
//
pub const UNICAM_META_MIN_WIDTH: c_int = 1;
pub const UNICAM_META_MIN_HEIGHT: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct unicam_format_info {
    pub fourcc: u32,
    pub unpacked_fourcc: u32,
    pub code: u32,
    pub depth: u8,
    pub csi_dt: u8,
    pub unpack: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct unicam_node {
    pub registered: bool,
    pub id: c_uint,
// Pointer to the current v4l2_buffer
    pub cur_frm: *mut unicam_buffer,
// Pointer to the next v4l2_buffer
    pub next_frm: *mut unicam_buffer,
...
// Pointer to the parent handle
    pub dev: *mut unicam_device,
    pub pad: media_pad,
//
// Dummy buffer intended to be used by unicam
// if we have no other queued buffers to swap to.
//
    pub dummy_buf: unicam_buffer,
    pub dummy_buf_cpu_addr: *mut c_void,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct unicam_device {
    pub kref: kref,
// peripheral base address
    pub base: *mut void __iomem,
// clock gating base address
    pub clk_gate_base: *mut void __iomem,
// lp clock handle
    pub clock: *mut clk,
// vpu clock handle
    pub vpu_clock: *mut clk,
// V4l2 device
...
// Internal subdev
    struct {
    pub sd: v4l2_subdev,
    pub pads: [media_pad; UNICAM_SD_NUM_PADS],
    pub enabled_streams: c_uint,
    pub subdev: },
...
// Lock used for the video devices of both nodes
    pub lock: mutex,
    pub node: [unicam_node; UNICAM_MAX_NODES],
}
...
#[no_mangle]
unsafe extern "C" fn unicam_release(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn unicam_put(unicam: *mut unicam_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn unicam_sd_pad_is_source(pad: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_metadata_node(node: *mut unicam_node) -> bool {
    static inline bool is_metadata_node(struct unicam_node *node)
    {
    return node.video_dev.device_caps & V4L2_CAP_META_CAPTURE;
    }
#[no_mangle]
pub unsafe extern "C" fn is_image_node(node: *mut unicam_node) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn unicam_clk_write(unicam: *mut unicam_device, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn unicam_reg_read(unicam: *mut unicam_device, offset: u32) -> u32 {
    static inline u32 unicam_reg_read(struct unicam_device *unicam, u32 offset)
    {
    return readl(unicam.base + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn unicam_reg_write(unicam: *mut unicam_device, offset: u32, val: u32) {
    static inline void unicam_reg_write(struct unicam_device *unicam, u32 offset, u32 val)
    {
    writel(val, unicam.base + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn unicam_get_field(value: u32, mask: u32) -> c_int {
    static inline int unicam_get_field(u32 value, u32 mask)
    {
    return (value & mask) >> __ffs(mask);
    }
#[no_mangle]
pub unsafe extern "C" fn unicam_set_field(valp: *mut u32, field: u32, mask: u32) {
...
// valp = val;
    ...
    u32 field, u32 mask)
    {
    let mut val: u32 = unicam_reg_read(unicam, offset);
...
#[no_mangle]
unsafe extern "C" fn unicam_get_lines_done(unicam: *mut unicam_device) -> c_uint {
    ...
    let mut stride: c_uint = node.fmt.fmt.pix.bytesperline;
...
#[no_mangle]
unsafe extern "C" fn unicam_schedule_next_buffer(node: *mut unicam_node) {
...
#[no_mangle]
unsafe extern "C" fn unicam_schedule_dummy_buffer(node: *mut unicam_node) {
    static void unicam_schedule_dummy_buffer(struct unicam_node *node)
    {
    let mut node_id: c_int = is_image_node(node) ? UNICAM_IMAGE_NODE : UNICAM_METADATA_NODE;
    dev_dbg(node.dev.dev, "Scheduling dummy buffer for node %d\n", node_id);
    unicam_wr_dma_addr(node, &node.dummy_buf);
    node.next_frm = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn unicam_queue_event_sof(unicam: *mut unicam_device) {
...
#[no_mangle]
unsafe extern "C" fn unicam_isr(irq: c_int, dev: *mut c_void) -> irqreturn_t {
    static irqreturn_t unicam_isr(int irq, void *dev)
    {
    struct unicam_device *unicam = dev;
    let mut lines_done: c_uint = unicam_get_lines_done(dev);
    let mut sequence: c_uint = unicam.sequence;
    unsigned int i;
    u32 ista, sta;
    bool fe;
    u64 ts;
...
//
    if (fe) {
    let mut inc_seq: bool = unicam.frame_started;
//
...
#[no_mangle]
unsafe extern "C" fn unicam_cfg_image_id(unicam: *mut unicam_device, vc: u8, dt: u8) {
...
#[no_mangle]
unsafe extern "C" fn unicam_enable_ed(unicam: *mut unicam_device) {
    static void unicam_enable_ed(struct unicam_device *unicam)
    {
    let mut val: u32 = unicam_reg_read(unicam, UNICAM_DCS);
...
#[no_mangle]
unsafe extern "C" fn unicam_start_metadata(unicam: *mut unicam_device) {
...
#[no_mangle]
unsafe extern "C" fn unicam_disable(unicam: *mut unicam_device) {
...
#[no_mangle]
unsafe extern "C" fn unicam_subdev_init(unicam: *mut unicam_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unicam_subdev_cleanup(unicam: *mut unicam_device) {
...
#[no_mangle]
unsafe extern "C" fn unicam_buffer_prepare(vb: *mut vb2_buffer) -> c_int {
    ...
    state);
    node.cur_frm = core::ptr::null_mut();
    node.next_frm = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn unicam_num_data_lanes(unicam: *mut unicam_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unicam_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(UNICAM_SD_PAD_SOURCE_METADATA: pad->index ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn unicam_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn unicam_buffer_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn unicam_log_status(file: *mut file, fh: *mut c_void) -> c_int {
...
// status for sub devices
    ...
    return v4l2_event_subscribe(fh, sub, 2, core::ptr::null_mut());
    default:
    return -EINVAL;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn unicam_video_link_validate(link: *mut media_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unicam_node_release(vdev: *mut video_device) {
...
#[no_mangle]
unsafe extern "C" fn unicam_set_default_format(node: *mut unicam_node) {
...
#[no_mangle]
unsafe extern "C" fn unicam_unregister_nodes(unicam: *mut unicam_device) {
...
//
#[no_mangle]
unsafe extern "C" fn unicam_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unicam_runtime_suspend(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(unicam_runtime_suspend, unicam_runtime_resume, core::ptr::null_mut())
    };
// -----------------------------------------------------------------------------
// V4L2 async notifier
//
...
#[no_mangle]
unsafe extern "C" fn unicam_async_complete(notifier: *mut v4l2_async_notifier) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unicam_async_nf_init(unicam: *mut unicam_device) -> c_int {
    static int unicam_async_nf_init(struct unicam_device *unicam)
    {
    let mut ep: v4l2_fwnode_endpoint = { };
...
// Get and parse the local endpoint.
    ...
    let mut num_data_lanes: c_uint = ep.bus.mipi_csi2.num_data_lanes;
...
//
#[no_mangle]
unsafe extern "C" fn unicam_media_init(unicam: *mut unicam_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unicam_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unicam_remove(pdev: *mut platform_device) {
