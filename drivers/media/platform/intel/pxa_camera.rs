...
//! Source: drivers/media/platform/intel/pxa_camera.c
#![no_std]
...
// Camera Interface
pub const CICR0: c_uint = 0x0000;
pub const CICR1: c_uint = 0x0004;
pub const CICR2: c_uint = 0x0008;
pub const CICR3: c_uint = 0x000C;
pub const CICR4: c_uint = 0x0010;
pub const CISR: c_uint = 0x0014;
pub const CIFR: c_uint = 0x0018;
pub const CITOR: c_uint = 0x001C;
pub const CIBR0: c_uint = 0x0028;
pub const CIBR1: c_uint = 0x0030;
pub const CIBR2: c_uint = 0x0038;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pxa_mbus_pixelfmt {
    pub name: *const c_char,
    pub fourcc: u32,
    pub packing: enum pxa_mbus_packing,
    pub order: enum pxa_mbus_order,
    pub layout: enum pxa_mbus_layout,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pxa_mbus_lookup {
    pub code: u32,
    pub fmt: pxa_mbus_pixelfmt,
}
...
#[no_mangle]
unsafe extern "C" fn pxa_mbus_bytes_per_line(width: u32, mf: *const pxa_mbus_pixelfmt) -> i32 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pxa_camera_format_xlate {
    pub code: u32,
    pub host_fmt: *const pxa_mbus_pixelfmt,
}
...
// our descriptor lists for Y, U and V channels
    pub descs: [*mut dma_async_tx_descriptor; 3],
    pub cookie: [dma_cookie_t; 3],
    pub sg: [*mut scatterlist; 3],
    pub sg_len: [c_int; 3],
    pub plane_sizes: [usize; 3],
    pub inwork: c_int,
    pub active_dma: enum pxa_camera_active_dma,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pxa_camera_dev {
    pub v4l2_dev: v4l2_device,
    pub vdev: video_device,
    pub notifier: v4l2_async_notifier,
    pub vb2_vq: vb2_queue,
    pub sensor: *mut v4l2_subdev,
    pub user_formats: *mut pxa_camera_format_xlate,
    pub current_fmt: *const pxa_camera_format_xlate,
    pub current_pix: v4l2_pix_format,
//
...
//
    ...
    pub channels: c_int,
    pub dma_chans: [*mut dma_chan; 3],
    pub pdata: *mut pxacamera_platform_data,
    pub res: *mut resource,
    pub platform_flags: c_ulong,
    pub ciclk: c_ulong,
    pub mclk: c_ulong,
    pub mclk_divisor: u32,
    pub /: *mut *mut u16 width_flags; / max 10 bits,
    pub capture: list_head,
    pub lock: spinlock_t,
    pub mlock: mutex,
    pub buf_sequence: c_uint,
    pub active: *mut pxa_buffer,
    pub eof_bh_work: work_struct,
    pub save_cicr: [u32; 5],
}
...
// pxa_mbus_xlate_by_fourcc(struct pxa_camera_format_xlate *user_formats,
    ...
    while (!v4l2_subdev_call(subdev, pad, enum_mbus_code, core::ptr::null_mut(), &code)) {
    raw_fmts++;
    code.index++;
    }
//
...
//
    ...
    ret = get_formats(v4l2_dev, i, core::ptr::null_mut());
    if (ret < 0)
    return ERR_PTR(ret);
    fmts += ret;
    }
...
#[no_mangle]
unsafe extern "C" fn pxa_camera_dma_irq_y(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pxa_camera_dma_irq_u(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pxa_camera_dma_irq_v(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn pxa_dma_start_channels(pcdev: *mut pxa_camera_dev) {
...
#[no_mangle]
unsafe extern "C" fn pxa_dma_stop_channels(pcdev: *mut pxa_camera_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pxa_camera_start_capture(pcdev: *mut pxa_camera_dev) {
...
#[no_mangle]
unsafe extern "C" fn pxa_camera_stop_capture(pcdev: *mut pxa_camera_dev) {
    ...
    cicr0 = __raw_readl(pcdev.base + CICR0) & ~CICR0_ENB;
    __raw_writel(cicr0, pcdev.base + CICR0);
    pcdev.active = core::ptr::null_mut();
    dev_dbg(pcdev_to_dev(pcdev), "%s\n", __func__);
    }
...
//
    ...
    {
    let mut is_dma_stopped: bool = last_submitted != last_issued;
    dev_dbg(pcdev_to_dev(pcdev),
...
//
    ...
    {
    let mut mclk: c_ulong = pcdev.mclk;
    u32 div;
...
// We want a timeout > 1 pixel time, not ">="
    let mut ciclk_per_pixel: u32 = pcdev.ciclk / pclk + 1;
    __raw_writel(ciclk_per_pixel, pcdev.base + CITOR);
    }
#[no_mangle]
unsafe extern "C" fn pxa_camera_activate(pcdev: *mut pxa_camera_dev) {
...
#[no_mangle]
unsafe extern "C" fn pxa_camera_deactivate(pcdev: *mut pxa_camera_dev) {
    static void pxa_camera_deactivate(struct pxa_camera_dev *pcdev)
    {
    clk_disable_unprepare(pcdev.clk);
    }
#[no_mangle]
unsafe extern "C" fn pxa_camera_eof_bh_work(t: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pxa_camera_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    let mut ret: c_int = sensor_call(pcdev, sensor, g_skip_top_lines, &y_skip_top);
    if (ret < 0)
    y_skip_top = 0;
//
...
//
#[no_mangle]
unsafe extern "C" fn pxa_buffer_cleanup(buf: *mut pxa_buffer) {
    ...
    kfree(buf.sg[i]);
    buf.descs[i] = core::ptr::null_mut();
    buf.sg[i] = core::ptr::null_mut();
    buf.sg_len[i] = 0;
    buf.plane_sizes[i] = 0;
    }
    buf.nb_planes = 0;
    ...
    let mut nb_channels: c_int = pcdev.channels;
    int i, ret = 0;
    let mut size: c_ulong = vb2_plane_size(vb, 0);
    switch (nb_channels) {
    case 1:
...
#[no_mangle]
unsafe extern "C" fn pxac_vb2_cleanup(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn pxac_vb2_queue(vb: *mut vb2_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn pxac_vb2_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxac_vb2_init(vb: *mut vb2_buffer) -> c_int {
    ...
    let mut size: c_int = pcdev.current_pix.sizeimage;
    dev_dbg(pcdev_to_dev(pcdev),
...
#[no_mangle]
unsafe extern "C" fn pxac_vb2_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxac_vb2_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn pxa_camera_init_videobuf2(pcdev: *mut pxa_camera_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pxa_camera_set_bus_param(pcdev: *mut pxa_camera_dev) -> c_int {
    static int pxa_camera_set_bus_param(struct pxa_camera_dev *pcdev)
    {
    let mut bus_width: c_uint = pcdev.current_fmt.host_fmt.bits_per_sample;
    let mut cfg: v4l2_mbus_config = {.type = V4L2_MBUS_PARALLEL,};
    let mut pixfmt: u32 = pcdev.current_fmt.host_fmt.fourcc;
    int mbus_config;
    int ret;
...
//
    ...
    V4L2_MBUS_SLAVE);
    let mut flags: c_uint = cfg.bus.parallel.flags;
...
#[no_mangle]
unsafe extern "C" fn pxa_camera_packing_supported(fmt: *const pxa_mbus_pixelfmt) -> bool {
    ...
    let mut formats: c_int = 0, ret;
    struct v4l2_subdev_mbus_code_enum code = {
    .which = V4L2_SUBDEV_FORMAT_ACTIVE,
    .index = idx,
    };
    const struct pxa_mbus_pixelfmt *fmt;
    ret = sensor_call(pcdev, pad, enum_mbus_code, core::ptr::null_mut(), &code);
    if (ret < 0)
// No more formats
    return 0;
...
#[no_mangle]
unsafe extern "C" fn pxa_camera_build_formats(pcdev: *mut pxa_camera_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa_camera_destroy_formats(pcdev: *mut pxa_camera_dev) {
    static void pxa_camera_destroy_formats(struct pxa_camera_dev *pcdev)
    {
    kfree(pcdev.user_formats);
    }
#[no_mangle]
unsafe extern "C" fn pxa_camera_check_frame(width: u32, height: u32) -> c_int {
...
// limit to pxa hardware capabilities
    ...
    let mut pixfmt: __u32 = pix.pixelformat;
    int ret;
...
// TODO: support interlaced at least in pass-through mode
    ...
    ret = sensor_call(pcdev, pad, set_fmt, core::ptr::null_mut(), &format);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn pxac_vidioc_g_input(file: *mut file, priv: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxac_vidioc_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxac_sensor_set_power(pcdev: *mut pxa_camera_dev, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxac_fops_camera_open(filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxac_fops_camera_release(filp: *mut file) -> c_int {
    ...
    ret = _vb2_fop_release(filp, core::ptr::null_mut());
    if (fh_singular)
...
// vdev = pxa_camera_videodev_template;
    ...
    if (err)
    goto out;
    err = sensor_call(pcdev, pad, set_fmt, core::ptr::null_mut(), &format);
    if (err)
    ...
    pcdev.sensor = core::ptr::null_mut();
    } else {
...
//
#[no_mangle]
unsafe extern "C" fn pxa_camera_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa_camera_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa_camera_probe(pdev: *mut platform_device) -> c_int {
    ...
    pcdev.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(pcdev.clk))
...
#[no_mangle]
unsafe extern "C" fn pxa_camera_remove(pdev: *mut platform_device) {
