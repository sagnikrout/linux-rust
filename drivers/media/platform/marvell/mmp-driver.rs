...
//! Source: drivers/media/platform/marvell/mmp-driver.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn mmpcam_calc_dphy(mcam: *mut mcam_camera) {
...
#[no_mangle]
unsafe extern "C" fn mmpcam_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mcam_init_clk(mcam: *mut mcam_camera) {
    static void mcam_init_clk(struct mcam_camera *mcam)
    {
    unsigned int i;
    for (i = 0; i < NR_MCAM_CLK; i++) {
    if (mcam_clks[i] != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn mmpcam_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmpcam_remove(pdev: *mut platform_device) {
...
//
#[no_mangle]
unsafe extern "C" fn mmpcam_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mmpcam_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mmpcam_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mmpcam_resume(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(mmpcam_runtime_suspend, mmpcam_runtime_resume, core::ptr::null_mut())
