...
//! Source: drivers/media/platform/samsung/s5p-mfc/s5p_mfc.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn clear_work_bit(ctx: *mut s5p_mfc_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn set_work_bit(ctx: *mut s5p_mfc_ctx) {
...
// Remove from hw execution round robin
#[no_mangle]
pub unsafe extern "C" fn clear_work_bit_irqsave(ctx: *mut s5p_mfc_ctx) {
...
// Add to hw execution round robin
#[no_mangle]
pub unsafe extern "C" fn set_work_bit_irqsave(ctx: *mut s5p_mfc_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn s5p_mfc_get_new_ctx(dev: *mut s5p_mfc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn s5p_mfc_cleanup_queue(lh: *mut list_head, vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_watchdog(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_watchdog_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_handle_frame_all_extracted(ctx: *mut s5p_mfc_ctx) {
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_handle_frame_copy_time(ctx: *mut s5p_mfc_ctx) {
...
//
    ...
    let mut addr: u32 = (u32)vb2_dma_contig_plane_dma_addr(&dst_buf.b.vb2_buf, 0);
    if (addr == dec_y_addr) {
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_handle_frame_new(ctx: *mut s5p_mfc_ctx, err: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_handle_stream_complete(ctx: *mut s5p_mfc_ctx) {
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_irq(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
// Open an MFC node
#[no_mangle]
unsafe extern "C" fn s5p_mfc_open(file: *mut file) -> c_int {
    static int s5p_mfc_open(struct file *file)
    {
    struct video_device *vdev = video_devdata(file);
    struct s5p_mfc_dev *dev = video_drvdata(file);
    struct s5p_mfc_ctx *ctx = core::ptr::null_mut();
    struct vb2_queue *q;
    let mut ret: c_int = 0;
    mfc_debug_enter();
...
// Deinit when failure occurred
    ...
    err_bad_node:
    dev.ctx[ctx.num] = core::ptr::null_mut();
    err_no_ctx:
...
// Release MFC context
#[no_mangle]
unsafe extern "C" fn s5p_mfc_release(file: *mut file) -> c_int {
...
// Poll
    ...
    struct vb2_buffer *src_vb = core::ptr::null_mut(), *dst_vb = core::ptr::null_mut();
...
// Mmap
#[no_mangle]
unsafe extern "C" fn s5p_mfc_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_memdev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_configure_2port_memory(mfc_dev: *mut s5p_mfc_dev) -> c_int {
    static int s5p_mfc_configure_2port_memory(struct s5p_mfc_dev *mfc_dev)
    {
    struct device *dev = &mfc_dev.plat_dev.dev;
    void *bank2_virt;
    dma_addr_t bank2_dma_addr;
    let mut align_size: c_ulong = 1 << MFC_BASE_ALIGN_ORDER;
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_unconfigure_2port_memory(mfc_dev: *mut s5p_mfc_dev) {
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_configure_common_memory(mfc_dev: *mut s5p_mfc_dev) -> c_int {
    static int s5p_mfc_configure_common_memory(struct s5p_mfc_dev *mfc_dev)
    {
    struct device *dev = &mfc_dev.plat_dev.dev;
    let mut mem_size: c_ulong = SZ_4M;
    if (IS_ENABLED(CONFIG_DMA_CMA) || exynos_is_iommu_available(dev))
    mem_size = SZ_8M;
    if (mfc_mem_size)
    mem_size = memparse(mfc_mem_size, core::ptr::null_mut());
...
//
    ...
    let mut offset: c_uint = 1 << MFC_BASE_ALIGN_ORDER;
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_unconfigure_common_memory(mfc_dev: *mut s5p_mfc_dev) {
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_configure_dma_memory(mfc_dev: *mut s5p_mfc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_unconfigure_dma_memory(mfc_dev: *mut s5p_mfc_dev) {
...
// MFC probe function
#[no_mangle]
unsafe extern "C" fn s5p_mfc_probe(pdev: *mut platform_device) -> c_int {
...
// Remove the driver
#[no_mangle]
unsafe extern "C" fn s5p_mfc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5p_mfc_resume(dev: *mut device) -> c_int {
