...
//! Source: drivers/media/platform/samsung/exynos-gsc/gsc-m2m.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gsc_m2m_ctx_stop_req(ctx: *mut gsc_ctx) -> c_int {
    ...
    let mut ret: return = = 0 ? -ETIMEDOUT : ret;
    }
#[no_mangle]
unsafe extern "C" fn __gsc_m2m_job_abort(ctx: *mut gsc_ctx) {
...
#[no_mangle]
unsafe extern "C" fn gsc_m2m_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __gsc_m2m_cleanup_queue(ctx: *mut gsc_ctx) {
...
#[no_mangle]
unsafe extern "C" fn gsc_m2m_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn gsc_m2m_job_finish(ctx: *mut gsc_ctx, vb_state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gsc_m2m_job_abort(priv: *mut c_void) {
    static void gsc_m2m_job_abort(void *priv)
    {
    __gsc_m2m_job_abort((struct gsc_ctx *)priv);
    }
#[no_mangle]
unsafe extern "C" fn gsc_get_bufs(ctx: *mut gsc_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gsc_m2m_device_run(priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gsc_m2m_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gsc_m2m_buf_queue(vb: *mut vb2_buffer) {
    ...
    frame = &ctx.d_frame;
    pix = &f.fmt.pix_mp;
    frame.fmt = find_fmt(&pix.pixelformat, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn is_rectangle_enclosed(a: *mut v4l2_rect, b: *mut v4l2_rect) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gsc_m2m_open(file: *mut file) -> c_int {
    static int gsc_m2m_open(struct file *file)
    {
    struct gsc_dev *gsc = video_drvdata(file);
    struct gsc_ctx *ctx = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn gsc_m2m_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gsc_m2m_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gsc_register_m2m_device(gsc: *mut gsc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gsc_unregister_m2m_device(gsc: *mut gsc_dev) {
