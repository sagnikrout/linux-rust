...
//! Source: drivers/media/platform/verisilicon/rockchip_vpu_hw.c
#![no_std]
...
pub const ROCKCHIP_VPU981_MIN_SIZE: c_int = 64;
//
// Supported formats.
//
...
#[no_mangle]
unsafe extern "C" fn rockchip_vpu1_vepu_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rockchip_vpu2_vdpu_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rockchip_vpu2_vepu_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rk3588_vpu981_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rk3036_vpu_hw_init(vpu: *mut hantro_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3066_vpu_hw_init(vpu: *mut hantro_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_vpu_hw_init(vpu: *mut hantro_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3066_vpu_dec_reset(ctx: *mut hantro_ctx) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_vpu1_enc_reset(ctx: *mut hantro_ctx) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_vpu2_dec_reset(ctx: *mut hantro_ctx) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_vpu2_enc_reset(ctx: *mut hantro_ctx) {
