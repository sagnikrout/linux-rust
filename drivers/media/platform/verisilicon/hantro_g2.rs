...
//! Source: drivers/media/platform/verisilicon/hantro_g2.c
#![no_std]
...
pub const G2_ALIGN: c_int = 16;
#[no_mangle]
unsafe extern "C" fn hantro_g2_active(ctx: *mut hantro_ctx) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn hantro_g2_reset(ctx: *mut hantro_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn hantro_g2_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn hantro_g2_chroma_offset(ctx: *mut hantro_ctx) -> usize {
    size_t hantro_g2_chroma_offset(struct hantro_ctx *ctx)
    {
    return ctx.ref_fmt.plane_fmt[0].bytesperline *	ctx.ref_fmt.height;
    }
#[no_mangle]
pub unsafe extern "C" fn hantro_g2_motion_vectors_offset(ctx: *mut hantro_ctx) -> usize {
...
#[no_mangle]
unsafe extern "C" fn hantro_g2_mv_size(ctx: *mut hantro_ctx) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn hantro_g2_luma_compress_offset(ctx: *mut hantro_ctx) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn hantro_g2_chroma_compress_offset(ctx: *mut hantro_ctx) -> usize {
