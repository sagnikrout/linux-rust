...
//! Source: drivers/media/platform/verisilicon/hantro_vp8.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vp8_prob_tbl_packed {
    pub prob_mb_skip_false: u8,
    pub prob_intra: u8,
    pub prob_ref_last: u8,
    pub prob_ref_golden: u8,
    pub prob_segment: [u8; 3],
    pub padding0: u8,
    pub prob_luma_16x16_pred_mode: [u8; 4],
    pub prob_chroma_pred_mode: [u8; 3],
    pub padding1: u8,
// mv prob
    pub prob_mv_context: [u8; 2][V4L2_VP8_MV_PROB_CNT],
    pub padding2: [u8; 2],
// coeff probs
    pub prob_coeffs: [u8; 4][8][3][V4L2_VP8_COEFF_PROB_CNT],
    pub padding3: [u8; 96],
}
...
#[no_mangle]
pub unsafe extern "C" fn hantro_vp8_dec_init(ctx: *mut hantro_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hantro_vp8_dec_exit(ctx: *mut hantro_ctx) {
