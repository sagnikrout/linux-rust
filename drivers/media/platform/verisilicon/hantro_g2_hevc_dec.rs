...
//! Source: drivers/media/platform/verisilicon/hantro_g2_hevc_dec.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn prepare_tile_info_buffer(ctx: *mut hantro_ctx) {
...
#[no_mangle]
unsafe extern "C" fn compute_header_skip_length(ctx: *mut hantro_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_params(ctx: *mut hantro_ctx) {
...
#[no_mangle]
unsafe extern "C" fn set_ref_pic_list(ctx: *mut hantro_ctx) {
...
#[no_mangle]
unsafe extern "C" fn set_ref(ctx: *mut hantro_ctx) -> c_int {
    ...
    let mut cr_offset: usize = hantro_g2_chroma_offset(ctx);
    let mut mv_offset: usize = hantro_g2_motion_vectors_offset(ctx);
    let mut compress_luma_offset: usize = hantro_g2_luma_compress_offset(ctx);
    let mut compress_chroma_offset: usize = hantro_g2_chroma_compress_offset(ctx);
    u32 max_ref_frames;
    u16 dpb_longterm_e;
...
//
    ...
    let mut poc_diff: c_char = decode_params.pic_order_cnt_val - dpb[i].pic_order_cnt_val;
...
#[no_mangle]
unsafe extern "C" fn set_buffers(ctx: *mut hantro_ctx) {
...
#[no_mangle]
unsafe extern "C" fn prepare_scaling_list_buffer(ctx: *mut hantro_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn hantro_g2_hevc_dec_run(ctx: *mut hantro_ctx) -> c_int {
