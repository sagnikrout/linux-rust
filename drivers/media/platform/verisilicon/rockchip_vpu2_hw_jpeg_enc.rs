...
//! Source: drivers/media/platform/verisilicon/rockchip_vpu2_hw_jpeg_enc.c
#![no_std]
...
pub const VEPU_JPEG_QUANT_TABLE_COUNT: c_int = 16;
...
#[no_mangle]
pub unsafe extern "C" fn rockchip_vpu2_jpeg_enc_run(ctx: *mut hantro_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rockchip_vpu2_jpeg_enc_done(ctx: *mut hantro_ctx) {
    void rockchip_vpu2_jpeg_enc_done(struct hantro_ctx *ctx)
    {
    struct hantro_dev *vpu = ctx.dev;
    let mut bytesused: u32 = vepu_read(vpu, VEPU_REG_STR_BUF_LIMIT) / 8;
