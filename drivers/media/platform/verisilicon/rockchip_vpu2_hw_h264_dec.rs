...
//! Source: drivers/media/platform/verisilicon/rockchip_vpu2_hw_h264_dec.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn set_params(ctx: *mut hantro_ctx, src_buf: *mut vb2_v4l2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn set_ref(ctx: *mut hantro_ctx) {
...
// Set up addresses of DPB buffers.
    ...
    let mut dma_addr: dma_addr_t = hantro_h264_get_ref_buf(ctx, i);
    vdpu_write_relaxed(vpu, dma_addr, VDPU_REG_REFER_BASE(i));
    }
    }
#[no_mangle]
unsafe extern "C" fn set_buffers(ctx: *mut hantro_ctx, src_buf: *mut vb2_v4l2_buffer) {
...
// Higher profiles require DMV buffer appended to reference frames.
    ...
    let mut bytes_per_mb: c_uint = 384;
...
#[no_mangle]
pub unsafe extern "C" fn rockchip_vpu2_h264_dec_run(ctx: *mut hantro_ctx) -> c_int {
