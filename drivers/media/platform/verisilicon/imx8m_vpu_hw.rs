...
//! Source: drivers/media/platform/verisilicon/imx8m_vpu_hw.c
#![no_std]
...
pub const CTRL_SOFT_RESET: c_uint = 0x00;

pub const CTRL_CLOCK_ENABLE: c_uint = 0x04;

pub const CTRL_G1_DEC_FUSE: c_uint = 0x08;
pub const CTRL_G1_PP_FUSE: c_uint = 0x0c;
pub const CTRL_G2_DEC_FUSE: c_uint = 0x10;
#[no_mangle]
unsafe extern "C" fn imx8m_soft_reset(vpu: *mut hantro_dev, reset_bits: u32) {
...
#[no_mangle]
unsafe extern "C" fn imx8m_clk_enable(vpu: *mut hantro_dev, clock_bits: u32) {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_runtime_resume(vpu: *mut hantro_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_vpu_hw_init(vpu: *mut hantro_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8m_vpu_g1_reset(ctx: *mut hantro_ctx) {
