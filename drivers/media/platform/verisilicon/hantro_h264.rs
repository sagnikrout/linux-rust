...
//! Source: drivers/media/platform/verisilicon/hantro_h264.c
#![no_std]
...
pub const POC_BUFFER_SIZE: c_int = 34;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hantro_h264_dec_priv_tbl {
    pub cabac_table: [u32; CABAC_INIT_BUFFER_SIZE],
    pub poc: [u32; POC_BUFFER_SIZE],
    pub scaling_list: [u8; SCALING_LIST_SIZE],
}
...
//
    ...
    let mut num_list_4x4: usize = ARRAY_SIZE(scaling.scaling_list_4x4);
    let mut list_len_4x4: usize = ARRAY_SIZE(scaling.scaling_list_4x4[0]);
    let mut list_len_8x8: usize = ARRAY_SIZE(scaling.scaling_list_8x8[0]);
...
#[no_mangle]
unsafe extern "C" fn prepare_table(ctx: *mut hantro_ctx) {
    ...
    let mut dpb_longterm: u32 = 0;
    let mut dpb_valid: u32 = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn update_dpb(ctx: *mut hantro_ctx) {
...
// cdpb = *ndpb;
    ...
    let mut cur_poc: i32 = ctx.h264_dec.cur_poc;
    u32 flags;
...
#[no_mangle]
pub unsafe extern "C" fn hantro_h264_get_ref_nbr(ctx: *mut hantro_ctx, dpb_idx: c_uint) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn hantro_h264_dec_prepare_run(ctx: *mut hantro_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hantro_h264_dec_exit(ctx: *mut hantro_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn hantro_h264_dec_init(ctx: *mut hantro_ctx) -> c_int {
