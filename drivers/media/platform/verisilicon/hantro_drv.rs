...
//! Source: drivers/media/platform/verisilicon/hantro_drv.c
#![no_std]
...
//
    ...
    return ctrl ? ctrl.p_cur.p : core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn hantro_get_ref(ctx: *mut hantro_ctx, ts: u64) -> dma_addr_t {
...
#[no_mangle]
pub unsafe extern "C" fn hantro_watchdog(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn hantro_start_prepare_run(ctx: *mut hantro_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn hantro_end_prepare_run(ctx: *mut hantro_ctx) {
...
#[no_mangle]
unsafe extern "C" fn hantro_try_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hantro_jpeg_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hantro_vp9_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    let mut bit_depth: c_int = ctrl.p_new.p_vp9_frame.bit_depth;
...
#[no_mangle]
unsafe extern "C" fn hantro_hevc_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    const struct v4l2_ctrl_hevc_sps *sps = ctrl.p_new.p_hevc_sps;
    let mut bit_depth: c_int = sps.bit_depth_luma_minus8 + 8;
    if (ctx.bit_depth == bit_depth)
    return 0;
    return hantro_reset_raw_fmt(ctx, bit_depth, HANTRO_AUTO_POSTPROC);
    }
...
#[no_mangle]
unsafe extern "C" fn hantro_av1_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    {
    let mut bit_depth: c_int = ctrl.p_new.p_av1_sequence.bit_depth;
    let mut need_postproc: bool = HANTRO_AUTO_POSTPROC;
...
//
    ...
    &controls[i].cfg, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn hantro_open(filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hantro_release(filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hantro_detach_func(func: *mut hantro_func) {
...
#[no_mangle]
unsafe extern "C" fn hantro_add_func(vpu: *mut hantro_dev, funcid: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hantro_add_enc_func(vpu: *mut hantro_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hantro_add_dec_func(vpu: *mut hantro_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hantro_remove_enc_func(vpu: *mut hantro_dev) {
    static void hantro_remove_enc_func(struct hantro_dev *vpu)
    {
    hantro_remove_func(vpu, MEDIA_ENT_F_PROC_VIDEO_ENCODER);
    }
#[no_mangle]
unsafe extern "C" fn hantro_remove_dec_func(vpu: *mut hantro_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn hantro_disable_multicore(vpu: *mut hantro_dev) -> c_int {
...
// The first compatible and available node found is considered the main core
    do {
    node = of_find_compatible_node(node, core::ptr::null_mut(), compatible);
...
#[no_mangle]
unsafe extern "C" fn hantro_probe(pdev: *mut platform_device) -> c_int {
...
//
    vpu.clocks[0].clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn hantro_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn hantro_runtime_resume(dev: *mut device) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(core::ptr::null_mut(), hantro_runtime_resume, core::ptr::null_mut())
    };
