...
//! Source: drivers/media/platform/aspeed/aspeed-video.c
#![no_std]
...
pub const ASPEED_VIDEO_V4L2_MIN_BUF_REQ: c_int = 3;

pub const ASPEED_VIDEO_JPEG_NUM_QUALITIES: c_int = 12;
pub const ASPEED_VIDEO_JPEG_HEADER_SIZE: c_int = 10;
pub const ASPEED_VIDEO_JPEG_QUANT_SIZE: c_int = 116;
pub const ASPEED_VIDEO_JPEG_DCT_SIZE: c_int = 34;
pub const MAX_FRAME_RATE: c_int = 60;
pub const MAX_HEIGHT: c_int = 1200;
pub const MAX_WIDTH: c_int = 1920;
pub const MIN_HEIGHT: c_int = 480;
pub const MIN_WIDTH: c_int = 640;
pub const NUM_POLARITY_CHECKS: c_int = 10;
pub const INVALID_RESOLUTION_RETRIES: c_int = 2;

pub const DIRECT_FETCH_THRESHOLD: c_uint = 0x0c0000 /* 1024 * 768 */;
pub const VE_MAX_SRC_BUFFER_SIZE: c_uint = 0x8ca000 /* 1920 * 1200, 32bpp */;
pub const VE_JPEG_HEADER_SIZE: c_uint = 0x006000 /* 512 * 12 * 4 */;
pub const VE_BCD_BUFF_SIZE: c_uint = 0x9000 /* (1920/8) * (1200/8) */;
pub const VE_PROTECTION_KEY: c_uint = 0x000;
pub const VE_PROTECTION_KEY_UNLOCK: c_uint = 0x1a038aa8;
pub const VE_SEQ_CTRL: c_uint = 0x004;

pub const VE_CTRL: c_uint = 0x008;

pub const VE_TGS_0: c_uint = 0x00c;
pub const VE_TGS_1: c_uint = 0x010;

pub const VE_SCALING_FACTOR: c_uint = 0x014;
pub const VE_SCALING_FILTER0: c_uint = 0x018;
pub const VE_SCALING_FILTER1: c_uint = 0x01c;
pub const VE_SCALING_FILTER2: c_uint = 0x020;
pub const VE_SCALING_FILTER3: c_uint = 0x024;
pub const VE_BCD_CTRL: c_uint = 0x02C;

pub const VE_CAP_WINDOW: c_uint = 0x030;
pub const VE_COMP_WINDOW: c_uint = 0x034;
pub const VE_COMP_PROC_OFFSET: c_uint = 0x038;
pub const VE_COMP_OFFSET: c_uint = 0x03c;
pub const VE_JPEG_ADDR: c_uint = 0x040;
pub const VE_SRC0_ADDR: c_uint = 0x044;
pub const VE_SRC_SCANLINE_OFFSET: c_uint = 0x048;
pub const VE_SRC1_ADDR: c_uint = 0x04c;
pub const VE_BCD_ADDR: c_uint = 0x050;
pub const VE_COMP_ADDR: c_uint = 0x054;
pub const VE_STREAM_BUF_SIZE: c_uint = 0x058;

pub const VE_COMP_CTRL: c_uint = 0x060;

pub const VE_CB_ADDR: c_uint = 0x06C;
pub const AST2400_VE_COMP_SIZE_READ_BACK: c_uint = 0x078;
pub const AST2600_VE_COMP_SIZE_READ_BACK: c_uint = 0x084;
pub const VE_SRC_LR_EDGE_DET: c_uint = 0x090;

pub const VE_SRC_TB_EDGE_DET: c_uint = 0x094;

pub const VE_MODE_DETECT_STATUS: c_uint = 0x098;

pub const VE_SYNC_STATUS: c_uint = 0x09c;

pub const VE_H_TOTAL_PIXELS: c_uint = 0x0A0;
pub const VE_INTERRUPT_CTRL: c_uint = 0x304;
pub const VE_INTERRUPT_STATUS: c_uint = 0x308;

pub const VE_MODE_DETECT: c_uint = 0x30c;

pub const VE_MEM_RESTRICT_START: c_uint = 0x310;
pub const VE_MEM_RESTRICT_END: c_uint = 0x314;
// SCU's registers
pub const SCU_MISC_CTRL: c_uint = 0xC0;

// GFX's registers
pub const GFX_CTRL: c_uint = 0x60;

pub const GFX_H_DISPLAY: c_uint = 0x70;

pub const GFX_V_DISPLAY: c_uint = 0x78;

pub const GFX_DISPLAY_ADDR: c_uint = 0x80;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_video_buffer {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_video_perf {
    pub last_sample: ktime_t,
    pub totaltime: u32,
    pub duration: u32,
...
pub struct aspeed_video {
    ...
    pub active_timings: v4l2_bt_timings,
    pub detected_timings: v4l2_bt_timings,
    pub v4l2_input_status: u32,
    pub queue: vb2_queue,
    pub vdev: video_device,
    pub /: *mut *mut mutex video_lock; / v4l2 and videobuf2 lock,
    pub scu: *mut regmap,
    pub gfx: *mut regmap,
    pub version: u32,
    pub jpeg_mode: u32,
    pub comp_size_read: u32,
    pub wait: wait_queue_head_t,
    pub /: *mut *mut spinlock_t lock; / buffer list lock,
    pub res_work: delayed_work,
    pub buffers: list_head,
    pub flags: c_ulong,
    pub sequence: c_uint,
    pub max_compressed_size: c_uint,
    pub srcs: [aspeed_video_addr; 2],
    pub jpeg: aspeed_video_addr,
    pub bcd: aspeed_video_addr,
    pub yuv420: bool,
    pub format: enum aspeed_video_format,
    pub hq_mode: bool,
    pub input: enum aspeed_video_input,
    pub frame_rate: c_uint,
    pub jpeg_quality: c_uint,
    pub jpeg_hq_quality: c_uint,
    pub frame_bottom: c_uint,
    pub frame_left: c_uint,
    pub frame_right: c_uint,
    pub frame_top: c_uint,
    pub perf: aspeed_video_perf,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_video_config {
    pub version: u32,
    pub jpeg_mode: u32,
    pub comp_size_read: u32,
}
    ...
    struct aspeed_video_addr *addr);
#[no_mangle]
unsafe extern "C" fn aspeed_video_init_jpeg_table(table: *mut u32, yuv420: bool) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_update_jpeg_table(table: *mut u32, yuv420: bool) {
    ...
    u32 bits)
    {
    let mut t: u32 = readl(video.base + reg);
    let mut before: u32 = t;
    t &= ~clear;
    t |= bits;
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_read(video: *mut aspeed_video, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_write(video: *mut aspeed_video, reg: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn update_perf(p: *mut aspeed_video_perf) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_start_frame(video: *mut aspeed_video) -> c_int {
    static int aspeed_video_start_frame(struct aspeed_video *video)
    {
    dma_addr_t addr;
    unsigned long flags;
    struct aspeed_video_buffer *buf;
    let mut seq_ctrl: u32 = aspeed_video_read(video, VE_SEQ_CTRL);
    let mut bcd_buf_need: bool = (video.format != VIDEO_FMT_STANDARD);
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_enable_mode_detect(video: *mut aspeed_video) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_off(video: *mut aspeed_video) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_on(video: *mut aspeed_video) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_reset(v: *mut aspeed_video) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_irq_res_change(video: *mut aspeed_video, delay: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_swap_src_buf(v: *mut aspeed_video) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_irq(irq: c_int, arg: *mut c_void) -> irqreturn_t {
    static irqreturn_t aspeed_video_irq(int irq, void *arg)
    {
    struct aspeed_video *video = arg;
    let mut sts: u32 = aspeed_video_read(video, VE_INTERRUPT_STATUS);
//
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_check_and_set_polarity(video: *mut aspeed_video) {
    static void aspeed_video_check_and_set_polarity(struct aspeed_video *video)
    {
    int i;
    let mut hsync_counter: c_int = 0;
    let mut vsync_counter: c_int = 0;
    u32 sts, ctrl;
...
//
    ...
    {
    int i, j;
    let mut compression_buffer_size_reg: u32 = 0;
    unsigned int size;
    let mut num_compression_packets: c_uint = 4;
    let mut compression_packet_size: c_uint = 1024;
...
//
    ...
    struct v4l2_bt_timings *det)
    {
    let mut invalid_resolution: bool = true;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_get_resolution(video: *mut aspeed_video) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_set_resolution(video: *mut aspeed_video) {
    static void aspeed_video_set_resolution(struct aspeed_video *video)
    {
    struct v4l2_bt_timings *act = &video.active_timings;
    let mut size: c_uint = act.width * ALIGN(act.height, 8);
...
//
    let mut width: u32 = ALIGN(act.width, 64);
...
//
#[no_mangle]
unsafe extern "C" fn aspeed_video_update_timings(video: *mut aspeed_video, timings: *mut v4l2_bt_timings) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_update_regs(video: *mut aspeed_video) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_init_regs(video: *mut aspeed_video) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_start(video: *mut aspeed_video) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_stop(video: *mut aspeed_video) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_get_input(file: *mut file, fh: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_set_input(file: *mut file, fh: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_resolution_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_release(file: *mut file) -> c_int {
    ...
    rc = _vb2_fop_release(file, core::ptr::null_mut());
    mutex_unlock(&video.video_lock);
    return rc;
    }
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_debugfs_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_debugfs_remove(video: *mut aspeed_video) {
    static void aspeed_video_debugfs_remove(struct aspeed_video *video)
    {
    debugfs_remove_recursive(debugfs_entry);
    debugfs_entry = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn aspeed_video_debugfs_create(video: *mut aspeed_video) {
    static void aspeed_video_debugfs_create(struct aspeed_video *video)
    {
    debugfs_entry = debugfs_create_file(DEVICE_NAME, 0444, core::ptr::null_mut(),
    video,
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_setup_video(video: *mut aspeed_video) -> c_int {
    ...
    v4l2_ctrl_new_custom(hdl, &aspeed_ctrl_HQ_mode, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &aspeed_ctrl_HQ_jpeg_quality, core::ptr::null_mut());
    rc = hdl.error;
    if (rc) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_init(video: *mut aspeed_video) -> c_int {
    ...
    rc = devm_request_threaded_irq(dev, irq, core::ptr::null_mut(), aspeed_video_irq,
    ...
    video.reset = devm_reset_control_get(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_video_remove(pdev: *mut platform_device) {
