...
//! Source: drivers/media/platform/nuvoton/npcm-video.c
#![no_std]
...
pub const MIN_WIDTH: c_int = 320;
pub const MIN_HEIGHT: c_int = 240;
pub const MIN_LP: c_int = 512;
pub const MAX_LP: c_int = 4096;
pub const RECT_W: c_int = 16;
pub const RECT_H: c_int = 16;
pub const BITMAP_SIZE: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm_video_addr {
    pub size: usize,
    pub dma: dma_addr_t,
    pub virt: *mut c_void,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rect_list_info {
    pub list: *mut rect_list,
    pub first: *mut rect_list,
    pub head: *mut list_head,
    pub index: c_uint,
    pub tile_perline: c_uint,
    pub tile_perrow: c_uint,
    pub offset_perline: c_uint,
...
pub struct npcm_ece {
    ...
    pub clients: core::sync::atomic::AtomicI32,
...
pub struct npcm_fmt {
    pub fourcc: c_uint,
    pub /: *mut *mut unsigned int bpp; / bytes per pixel,
}
...
#[no_mangle]
unsafe extern "C" fn npcm_video_ece_prepend_rect_header(addr: *mut c_void, x: u16, y: u16, w: u16, h: u16) {
    static void npcm_video_ece_prepend_rect_header(void *addr, u16 x, u16 y, u16 w, u16 h)
    {
    let mut x_pos: __be16 = cpu_to_be16(x);
    let mut y_pos: __be16 = cpu_to_be16(y);
    let mut width: __be16 = cpu_to_be16(w);
    let mut height: __be16 = cpu_to_be16(h);
    ...
    {
    struct regmap *ece = video.ece.regmap;
    let mut rect_offset: c_uint = (r_off_y * video.bytesperline) + (r_off_x * 2);
    let mut w_size: c_uint = ECE_TILE_W, h_size = ECE_TILE_H;
...
#[no_mangle]
unsafe extern "C" fn npcm_video_ece_read_rect_offset(video: *mut npcm_video) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn npcm_video_ece_set_lp(video: *mut npcm_video, pitch: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_video_ece_clear_rect_offset(video: *mut npcm_video) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_ece_ctrl_reset(video: *mut npcm_video) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_ece_ip_reset(video: *mut npcm_video) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_ece_stop(video: *mut npcm_video) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_free_diff_table(video: *mut npcm_video) {
    ...
    struct rect_list *list = core::ptr::null_mut();
    struct v4l2_rect *r;
...
#[no_mangle]
unsafe extern "C" fn npcm_video_get_rect_list(video: *mut npcm_video, index: c_uint) {
    static void npcm_video_get_rect_list(struct npcm_video *video, unsigned int index)
    {
    struct v4l2_bt_timings *act = &video.active_timings;
    struct rect_list_info info;
    let mut tile_cnt: c_uint = 0, mod;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn npcm_video_is_mga(video: *mut npcm_video) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_hres(video: *mut npcm_video) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_vres(video: *mut npcm_video) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_vcd_ip_reset(video: *mut npcm_video) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_vcd_state_machine_reset(video: *mut npcm_video) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_gfx_reset(video: *mut npcm_video) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_kvm_bw(video: *mut npcm_video, set_bw: bool) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_pclk(video: *mut npcm_video) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_get_bpp(video: *mut npcm_video) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_get_linepitch(video: *mut npcm_video) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_command(video: *mut npcm_video, value: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_init_reg(video: *mut npcm_video) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_start_frame(video: *mut npcm_video) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_get_diff_rect(video: *mut npcm_video, index: c_uint) {
    static void npcm_video_get_diff_rect(struct npcm_video *video, unsigned int index)
    {
    let mut width: c_uint = video.active_timings.width;
    let mut height: c_uint = video.active_timings.height;
...
#[no_mangle]
unsafe extern "C" fn npcm_video_detect_resolution(video: *mut npcm_video) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_start(video: *mut npcm_video) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_stop(video: *mut npcm_video) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_raw(video: *mut npcm_video, index: c_int, addr: *mut c_void) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_irq(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_get_input(file: *mut file, fh: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_set_input(file: *mut file, fh: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    video.ctrl_cmd = VCD_CMD_OPERATION_CAPTURE;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_NPCM_CAPTURE_MODE_DIFF: ctrl->val ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_buf_finish(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn npcm_video_setup_video(video: *mut npcm_video) -> c_int {
    ...
    v4l2_ctrl_new_custom(&video.ctrl_handler, &npcm_ctrl_capture_mode, core::ptr::null_mut());
    video.rect_cnt_ctrl = v4l2_ctrl_new_custom(&video.ctrl_handler,
    &npcm_ctrl_rect_count, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn npcm_video_ece_init(video: *mut npcm_video) -> c_int {
    static int npcm_video_ece_init(struct npcm_video *video)
    {
    struct device_node *ece_node __free(device_node) = core::ptr::null_mut();
    ...
    video.ece.reset = devm_reset_control_get(ece_dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn npcm_video_init(video: *mut npcm_video) -> c_int {
    ...
    rc = devm_request_threaded_irq(dev, irq, core::ptr::null_mut(), npcm_video_irq,
...
#[no_mangle]
unsafe extern "C" fn npcm_video_probe(pdev: *mut platform_device) -> c_int {
    ...
    video.reset = devm_reset_control_get(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn npcm_video_remove(pdev: *mut platform_device) {
