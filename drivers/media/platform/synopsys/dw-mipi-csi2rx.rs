...
//! Source: drivers/media/platform/synopsys/dw-mipi-csi2rx.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw_mipi_csi2rx_drvdata {
    pub regs: *const u32,
    pub csi2): *mut *mut void (dphy_assert_reset)(struct dw_mipi_csi2rx_device,
    pub csi2): *mut *mut void (dphy_deassert_reset)(struct dw_mipi_csi2rx_device,
    pub csi2): *mut *mut void (ipi_enable)(struct dw_mipi_csi2rx_device,
    pub csi2): *mut *mut int (wait_for_phy_stopstate)(struct dw_mipi_csi2rx_device,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw_mipi_csi2rx_format {
    pub code: u32,
    pub depth: u8,
    pub csi_dt: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw_mipi_csi2rx_device {
    pub dev: *mut device,
    ...
    pub formats: *const dw_mipi_csi2rx_format,
    pub formats_num: c_uint,
    pub pads: [media_pad; DW_MIPI_CSI2RX_PAD_MAX],
    pub notifier: v4l2_async_notifier,
    pub sd: v4l2_subdev,
    pub bus_type: enum v4l2_mbus_type,
    pub lanes_num: u32,
    pub enabled_streams: u64,
    pub drvdata: *const dw_mipi_csi2rx_drvdata,
}
...
// Bayer formats
    ...
    enum dw_mipi_csi2rx_regs_index index)
    {
    let mut off: u32 = (~DW_REG_EXIST) & csi2.drvdata.regs[index];
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_csi2rx_start(csi2: *mut dw_mipi_csi2rx_device) -> c_int {
    static int dw_mipi_csi2rx_start(struct dw_mipi_csi2rx_device *csi2)
    {
    struct media_pad *source_pad;
    union phy_configure_opts opts;
    let mut lanes: u32 = csi2.lanes_num;
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_csi2rx_stop(csi2: *mut dw_mipi_csi2rx_device) {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_csi2rx_register_notifier(csi2: *mut dw_mipi_csi2rx_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_csi2rx_register(csi2: *mut dw_mipi_csi2rx_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_csi2rx_unregister(csi2: *mut dw_mipi_csi2rx_device) {
...
#[no_mangle]
unsafe extern "C" fn imx93_csi2rx_dphy_assert_reset(csi2: *mut dw_mipi_csi2rx_device) {
...
#[no_mangle]
unsafe extern "C" fn imx93_csi2rx_dphy_deassert_reset(csi2: *mut dw_mipi_csi2rx_device) {
...
#[no_mangle]
unsafe extern "C" fn imx93_csi2rx_dphy_ipi_enable(csi2: *mut dw_mipi_csi2rx_device) {
    static void imx93_csi2rx_dphy_ipi_enable(struct dw_mipi_csi2rx_device *csi2)
    {
    let mut dt: c_int = csi2.formats.csi_dt;
    u32 val;
// Do IPI soft reset
...
#[no_mangle]
unsafe extern "C" fn imx93_csi2rx_wait_for_phy_stopstate(csi2: *mut dw_mipi_csi2rx_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_csi2rx_probe(pdev: *mut platform_device) -> c_int {
    ...
    csi2.clks_num = ret;
    csi2.phy = devm_phy_get(dev, core::ptr::null_mut());
    if (IS_ERR(csi2.phy))
    return dev_err_probe(dev, PTR_ERR(csi2.phy),
    "failed to get MIPI CSI-2 PHY\n");
    csi2.reset = devm_reset_control_get_optional_exclusive(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_csi2rx_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_csi2rx_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mipi_csi2rx_runtime_resume(dev: *mut device) -> c_int {
    ...
    dw_mipi_csi2rx_runtime_resume, core::ptr::null_mut());
