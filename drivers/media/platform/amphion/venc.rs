...
//! Source: drivers/media/platform/amphion/venc.c
#![no_std]
...
pub const VENC_MAX_BUF_CNT: c_int = 8;
pub const VENC_MIN_BUFFER_OUT: c_int = 6;
pub const VENC_MIN_BUFFER_CAP: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct venc_t {
    pub params: vpu_encode_params,
    pub request_key_frame: u32,
    pub input_ready: u32,
    pub cpb_size: u32,
    pub bitrate_change: bool,
    pub enc: [vpu_buffer; VENC_MAX_BUF_CNT],
    pub ref: [vpu_buffer; VENC_MAX_BUF_CNT],
    pub act: [vpu_buffer; VENC_MAX_BUF_CNT],
    ...
    pub enable: u32,
    pub stopped: u32,
    pub memory_resource_configured: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct venc_frame_t {
    pub list: list_head,
    pub info: vpu_enc_pic_info,
    pub bytesused: u32,
    pub timestamp: i64,
}
...
#[no_mangle]
unsafe extern "C" fn venc_querycap(file: *mut file, fh: *mut c_void, cap: *mut v4l2_capability) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_enum_fmt(file: *mut file, fh: *mut c_void, f: *mut v4l2_fmtdesc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_enum_framesizes(file: *mut file, fh: *mut c_void, fsize: *mut v4l2_frmsizeenum) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_enum_frameintervals(file: *mut file, fh: *mut c_void, fival: *mut v4l2_frmivalenum) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_g_fmt(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_try_fmt(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_s_fmt(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_g_parm(file: *mut file, fh: *mut c_void, parm: *mut v4l2_streamparm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_s_parm(file: *mut file, fh: *mut c_void, parm: *mut v4l2_streamparm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_g_selection(file: *mut file, fh: *mut c_void, s: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_valid_crop(venc: *mut venc_t, res: *const vpu_core_resources) -> c_int {
    static int venc_valid_crop(struct venc_t *venc, const struct vpu_core_resources *res)
    {
    struct v4l2_rect *rect = core::ptr::null_mut();
    u32 min_width;
    u32 min_height;
    u32 src_width;
    u32 src_height;
...
#[no_mangle]
unsafe extern "C" fn venc_s_selection(file: *mut file, fh: *mut c_void, s: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_drain(inst: *mut vpu_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_request_eos(inst: *mut vpu_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_encoder_cmd(file: *mut file, fh: *mut c_void, cmd: *mut v4l2_encoder_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_subscribe_event(fh: *mut v4l2_fh, sub: *const v4l2_event_subscription) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_op_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_ctrl_init(inst: *mut vpu_inst) -> c_int {
    ...
    V4L2_MPEG_VIDEO_HEADER_MODE_JOINED_WITH_1ST_FRAME);
    v4l2_ctrl_new_std(&inst.ctrl_handler, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn venc_check_ready(inst: *mut vpu_inst, type: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn venc_get_enable_mask(type: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn venc_set_enable(venc: *mut venc_t, type: u32, enable: c_int) {
    static void venc_set_enable(struct venc_t *venc, u32 type, int enable)
    {
    let mut mask: u32 = venc_get_enable_mask(type);
    if (enable)
    venc.enable |= mask;
    else
    venc.enable &= ~mask;
...
#[no_mangle]
unsafe extern "C" fn venc_get_enable(venc: *mut venc_t, type: u32) -> u32 {
    static u32 venc_get_enable(struct venc_t *venc, u32 type)
    {
    return venc.enable & venc_get_enable_mask(type);
    }
#[no_mangle]
unsafe extern "C" fn venc_input_done(inst: *mut vpu_inst) {
...
//
#[no_mangle]
unsafe extern "C" fn venc_precheck_encoded_frame(inst: *mut vpu_inst, frame: *mut venc_frame_t) -> c_int {
    ...
    if (frame.bytesused) {
    let mut rptr: u32 = frame.info.wptr;
...
#[no_mangle]
unsafe extern "C" fn venc_get_encoded_frames(inst: *mut vpu_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_frame_encoded(inst: *mut vpu_inst, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_set_last_buffer_dequeued(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn venc_stop_done(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn venc_event_notify(inst: *mut vpu_inst, event: u32, data: *mut c_void) {
    static void venc_event_notify(struct vpu_inst *inst, u32 event, void *data)
    {
    }
#[no_mangle]
unsafe extern "C" fn venc_release(inst: *mut vpu_inst) {
    static void venc_release(struct vpu_inst *inst)
    {
    }
#[no_mangle]
unsafe extern "C" fn venc_cleanup(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn venc_start_session(inst: *mut vpu_inst, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_cleanup_mem_resource(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn venc_cleanup_frames(venc: *mut venc_t) {
...
#[no_mangle]
unsafe extern "C" fn venc_stop_session(inst: *mut vpu_inst, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_process_output(inst: *mut vpu_inst, vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_process_capture(inst: *mut vpu_inst, vb: *mut vb2_buffer) -> c_int {
    static int venc_process_capture(struct vpu_inst *inst, struct vb2_buffer *vb)
    {
    struct venc_t *venc;
    struct venc_frame_t *frame = core::ptr::null_mut();
    struct vb2_v4l2_buffer *vbuf;
    int ret;
    venc = inst.priv;
    if (list_empty(&venc.frames))
...
#[no_mangle]
unsafe extern "C" fn venc_on_queue_empty(inst: *mut vpu_inst, type: u32) {
...
#[no_mangle]
unsafe extern "C" fn venc_get_debug_info(inst: *mut vpu_inst, str: *mut c_char, size: u32, i: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn venc_init(file: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn venc_open(file: *mut file) -> c_int {
