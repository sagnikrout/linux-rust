...
//! Source: drivers/media/platform/amphion/vdec.c
#![no_std]
...
pub const VDEC_SLOT_CNT_DFT: c_int = 32;
pub const VDEC_MIN_BUFFER_CAP: c_int = 8;
pub const VDEC_MIN_BUFFER_OUT: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_fs_info {
    pub name: [c_char; 8],
    pub type: u32,
    pub max_count: u32,
    pub req_count: u32,
    ...
    pub index: u32,
    pub size: u32,
    pub buffer: [vpu_buffer; 32],
    pub tag: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdec_frame_store_t {
    pub curr: *mut vpu_vb2_buffer,
    pub pend: *mut vpu_vb2_buffer,
    pub addr: dma_addr_t,
    pub state: c_uint,
    pub tag: u32,
}
...
#[derive(Copy, Clone)]
pub struct vdec_t {
    pub seq_hdr_found: u32,
    pub udata: vpu_buffer,
    pub params: vpu_decode_params,
    pub codec_info: vpu_dec_codec_info,
    pub state: enum vpu_codec_state,
    pub slots: *mut vdec_frame_store_t,
    pub slot_count: u32,
    pub req_frame_count: u32,
    pub mbi: vdec_fs_info,
    pub dcp: vdec_fs_info,
    pub seq_tag: u32,
    pub reset_codec: bool,
    pub fixed_fmt: bool,
    pub decoded_frame_count: u32,
    pub display_frame_count: u32,
    pub sequence: u32,
    pub eos_received: u32,
    pub is_source_changed: bool,
    pub source_change: u32,
    pub drain: u32,
    pub aborting: bool,
}
...
#[no_mangle]
unsafe extern "C" fn vdec_ctrl_init(inst: *mut vpu_inst) -> c_int {
    ...
    0, 1, 1, 0);
    v4l2_ctrl_new_std_menu(&inst.ctrl_handler, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn vdec_attach_frame_store(inst: *mut vpu_inst, vb: *mut vb2_buffer) {
    static void vdec_attach_frame_store(struct vpu_inst *inst, struct vb2_buffer *vb)
    {
    struct vb2_v4l2_buffer *vbuf = to_vb2_v4l2_buffer(vb);
    struct vpu_vb2_buffer *vpu_buf = to_vpu_vb2_buffer(vbuf);
    struct vdec_t *vdec = inst.priv;
    struct vdec_frame_store_t *new_slots = core::ptr::null_mut();
    dma_addr_t addr;
    int i;
...
#[no_mangle]
unsafe extern "C" fn vdec_reset_frame_store(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_handle_resolution_change(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_update_state(inst: *mut vpu_inst, state: enum vpu_codec_state, force: u32) -> c_int {
    static int vdec_update_state(struct vpu_inst *inst, enum vpu_codec_state state, u32 force)
    {
    struct vdec_t *vdec = inst.priv;
    let mut pre_state: enum vpu_codec_state = inst.state;
    ...
    inst.state = state;
#[no_mangle]
pub unsafe extern "C" fn if(VPU_CODEC_STATE_DYAMIC_RESOLUTION_CHANGE: state ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn vdec_set_last_buffer_dequeued(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_querycap(file: *mut file, fh: *mut c_void, cap: *mut v4l2_capability) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_enum_fmt(file: *mut file, fh: *mut c_void, f: *mut v4l2_fmtdesc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_g_fmt(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_try_fmt(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_s_fmt_common(inst: *mut vpu_inst, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_s_fmt(file: *mut file, fh: *mut c_void, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_g_selection(file: *mut file, fh: *mut c_void, s: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_drain(inst: *mut vpu_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_cmd_start(inst: *mut vpu_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_cmd_stop(inst: *mut vpu_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_decoder_cmd(file: *mut file, fh: *mut c_void, cmd: *mut v4l2_decoder_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_subscribe_event(fh: *mut v4l2_fh, sub: *const v4l2_event_subscription) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_check_ready(inst: *mut vpu_inst, type: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vdec_frame_decoded(inst: *mut vpu_inst, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_buf_done(inst: *mut vpu_inst, frame: *mut vpu_frame_info) {
...
#[no_mangle]
unsafe extern "C" fn vdec_stop_done(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_check_source_change(inst: *mut vpu_inst, hdr: *mut vpu_dec_codec_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vdec_init_fmt(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_init_crop(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_init_mbi(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_init_dcp(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_request_one_fs(fs: *mut vdec_fs_info) {
...
#[no_mangle]
unsafe extern "C" fn vdec_alloc_fs_buffer(inst: *mut vpu_inst, fs: *mut vdec_fs_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_alloc_fs(inst: *mut vpu_inst, fs: *mut vdec_fs_info) {
...
#[no_mangle]
unsafe extern "C" fn vdec_clear_fs(fs: *mut vdec_fs_info) {
...
#[no_mangle]
unsafe extern "C" fn vdec_response_fs(inst: *mut vpu_inst, fs: *mut vdec_fs_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_response_frame_abnormal(inst: *mut vpu_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_response_frame(inst: *mut vpu_inst, vbuf: *mut vb2_v4l2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_response_fs_request(inst: *mut vpu_inst, force: bool) {
...
#[no_mangle]
unsafe extern "C" fn vdec_response_fs_release(inst: *mut vpu_inst, id: u32, tag: u32) {
...
#[no_mangle]
unsafe extern "C" fn vdec_recycle_buffer(inst: *mut vpu_inst, vbuf: *mut vb2_v4l2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn vdec_release_curr_frame_store(inst: *mut vpu_inst, id: u32) {
    ...
    vdec.slots[id].curr = core::ptr::null_mut();
    ...
    vdec.slots[id].pend = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn vdec_clear_slots(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_update_v4l2_ctrl(inst: *mut vpu_inst, id: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn vdec_update_v4l2_profile_level(inst: *mut vpu_inst, hdr: *mut vpu_dec_codec_info) {
...
#[no_mangle]
unsafe extern "C" fn vdec_event_seq_hdr(inst: *mut vpu_inst, hdr: *mut vpu_dec_codec_info) {
...
#[no_mangle]
unsafe extern "C" fn vdec_event_resolution_change(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_event_req_fs(inst: *mut vpu_inst, fs: *mut vpu_fs_info) {
...
#[no_mangle]
unsafe extern "C" fn vdec_evnet_rel_fs(inst: *mut vpu_inst, fs: *mut vpu_fs_info) {
...
#[no_mangle]
unsafe extern "C" fn vdec_event_eos(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_event_notify(inst: *mut vpu_inst, event: u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn vdec_process_output(inst: *mut vpu_inst, vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_process_capture(inst: *mut vpu_inst, vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_on_queue_empty(inst: *mut vpu_inst, type: u32) {
...
#[no_mangle]
unsafe extern "C" fn vdec_abort(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_stop(inst: *mut vpu_inst, free: bool) {
...
#[no_mangle]
unsafe extern "C" fn vdec_release(inst: *mut vpu_inst) {
...
#[no_mangle]
unsafe extern "C" fn vdec_cleanup(inst: *mut vpu_inst) {
    ...
    if (vdec) {
    kfree(vdec.slots);
    vdec.slots = core::ptr::null_mut();
    vdec.slot_count = 0;
    }
    kfree(vdec);
    inst.priv = core::ptr::null_mut();
    kfree(inst);
    }
#[no_mangle]
unsafe extern "C" fn vdec_init_params(vdec: *mut vdec_t) {
...
#[no_mangle]
unsafe extern "C" fn vdec_start(inst: *mut vpu_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_start_session(inst: *mut vpu_inst, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_stop_session(inst: *mut vpu_inst, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_get_slot_debug_info(inst: *mut vpu_inst, str: *mut c_char, size: u32, i: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_get_debug_info(inst: *mut vpu_inst, str: *mut c_char, size: u32, i: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdec_init(file: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn vdec_open(file: *mut file) -> c_int {
