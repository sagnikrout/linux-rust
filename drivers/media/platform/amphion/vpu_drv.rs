...
//! Source: drivers/media/platform/amphion/vpu_drv.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn vpu_writel(vpu: *mut vpu_dev, reg: u32, val: u32) {
    void vpu_writel(struct vpu_dev *vpu, u32 reg, u32 val)
    {
    writel(val, vpu.base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn vpu_readl(vpu: *mut vpu_dev, reg: u32) -> u32 {
    u32 vpu_readl(struct vpu_dev *vpu, u32 reg)
    {
    return readl(vpu.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn vpu_dev_get(vpu: *mut vpu_dev) {
...
#[no_mangle]
unsafe extern "C" fn vpu_dev_put(vpu: *mut vpu_dev) {
    static void vpu_dev_put(struct vpu_dev *vpu)
    {
    atomic_dec(&vpu.ref_vpu);
    }
#[no_mangle]
unsafe extern "C" fn vpu_enc_get(vpu: *mut vpu_dev) {
...
#[no_mangle]
unsafe extern "C" fn vpu_enc_put(vpu: *mut vpu_dev) {
    static void vpu_enc_put(struct vpu_dev *vpu)
    {
    atomic_dec(&vpu.ref_enc);
    }
#[no_mangle]
unsafe extern "C" fn vpu_dec_get(vpu: *mut vpu_dev) {
...
#[no_mangle]
unsafe extern "C" fn vpu_dec_put(vpu: *mut vpu_dev) {
    static void vpu_dec_put(struct vpu_dev *vpu)
    {
    atomic_dec(&vpu.ref_dec);
    }
#[no_mangle]
unsafe extern "C" fn vpu_init_media_device(vpu: *mut vpu_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vpu_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (ret)
    goto err_vpu_media;
    vpu.debugfs = debugfs_create_dir("amphion_vpu", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn vpu_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn vpu_driver_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vpu_driver_exit() -> void __exit {
