...
//! Source: drivers/media/platform/microchip/microchip-isc-scaler.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn isc_scaler_prepare_fmt(framefmt: *mut v4l2_mbus_framefmt) {
...
#[no_mangle]
pub unsafe extern "C" fn isc_scaler_init(isc: *mut isc_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isc_scaler_link(isc: *mut isc_device) -> c_int {
