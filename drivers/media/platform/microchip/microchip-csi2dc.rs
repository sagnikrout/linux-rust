...
//! Source: drivers/media/platform/microchip/microchip-csi2dc.c
#![no_std]
...
pub const CSI2DC_GCFG: c_uint = 0x0;
...
pub const CSI2DC_GCTLR: c_uint = 0x04;

// Global status register
pub const CSI2DC_GS: c_uint = 0x08;
// SSP interrupt status register
pub const CSI2DC_SSPIS: c_uint = 0x28;
// Pipe update register
pub const CSI2DC_PU: c_uint = 0xc0;
// Video pipe attributes update

// Pipe update status register
pub const CSI2DC_PUS: c_uint = 0xc4;
// Video pipeline Interrupt Status Register
pub const CSI2DC_VPISR: c_uint = 0xf4;
// Video pipeline enable register
pub const CSI2DC_VPE: c_uint = 0xf8;

// Video pipeline configuration register
pub const CSI2DC_VPCFG: c_uint = 0xfc;
// Data type
...
pub const CSI2DC_VPCFG_DM_DECODER8TO12: c_int = 0;
...
pub const CSI2DC_VPCOL: c_uint = 0x100;
// Column number

// Video pipeline row register
pub const CSI2DC_VPROW: c_uint = 0x104;
// Row number

// Version register
pub const CSI2DC_VERSION: c_uint = 0x1fc;
// register read/write helpers

    (st).base + (reg))
// supported RAW data types
pub const CSI2DC_DT_RAW6: c_uint = 0x28;
pub const CSI2DC_DT_RAW7: c_uint = 0x29;
pub const CSI2DC_DT_RAW8: c_uint = 0x2a;
pub const CSI2DC_DT_RAW10: c_uint = 0x2b;
pub const CSI2DC_DT_RAW12: c_uint = 0x2c;
pub const CSI2DC_DT_RAW14: c_uint = 0x2d;
// YUV data types
pub const CSI2DC_DT_YUV422_8B: c_uint = 0x1e;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct csi2dc_device {
    pub base: *mut void __iomem,
    pub csi2dc_sd: v4l2_subdev,
    pub dev: *mut device,
    pub pclk: *mut clk,
    pub scck: *mut clk,
    pub format: v4l2_mbus_framefmt,
    pub cur_fmt: *const csi2dc_format,
    pub try_fmt: *const csi2dc_format,
    pub pads: [media_pad; CSI2DC_PADS_NUM],
    pub clk_gated: bool,
    pub video_pipe: bool,
    pub parallel_mode: bool,
    pub vc: u32,
    pub notifier: v4l2_async_notifier,
    pub input_sd: *mut v4l2_subdev,
    pub remote_pad: u32,
}
    ...
    {
    struct csi2dc_device *csi2dc = csi2dc_sd_to_csi2dc_device(csi2dc_sd);
    const struct csi2dc_format *fmt, *try_fmt = core::ptr::null_mut();
    struct v4l2_mbus_framefmt *v4l2_try_fmt;
    unsigned int i;
//
...
#[no_mangle]
unsafe extern "C" fn csi2dc_power(csi2dc: *mut csi2dc_device, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn csi2dc_get_mbus_config(csi2dc: *mut csi2dc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn csi2dc_vp_update(csi2dc: *mut csi2dc_device) {
...
#[no_mangle]
unsafe extern "C" fn csi2dc_s_stream(csi2dc_sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn csi2dc_default_format(csi2dc: *mut csi2dc_device) {
...
#[no_mangle]
unsafe extern "C" fn csi2dc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn csi2dc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn csi2dc_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn csi2dc_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(csi2dc_runtime_suspend, csi2dc_runtime_resume, core::ptr::null_mut())
    };
