...
//! Source: drivers/media/platform/microchip/microchip-isc-base.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn isc_update_v4l2_ctrls(isc: *mut isc_device) {
...
#[no_mangle]
pub unsafe extern "C" fn isc_update_awb_ctrls(isc: *mut isc_device) {
...
#[no_mangle]
pub unsafe extern "C" fn isc_reset_awb_ctrls(isc: *mut isc_device) {
...
// offsets are in 2's complements
    ...
    let mut size: c_uint = isc.fmt.fmt.pix.sizeimage;
    if (*nplanes)
...
#[no_mangle]
unsafe extern "C" fn isc_buffer_prepare(vb: *mut vb2_buffer) -> c_int {
    static int isc_buffer_prepare(struct vb2_buffer *vb)
    {
    struct vb2_v4l2_buffer *vbuf = to_vb2_v4l2_buffer(vb);
    struct isc_device *isc = vb2_get_drv_priv(vb.vb2_queue);
    let mut size: c_ulong = isc.fmt.fmt.pix.sizeimage;
...
#[no_mangle]
unsafe extern "C" fn isc_crop_pfe(isc: *mut isc_device) {
...
#[no_mangle]
unsafe extern "C" fn isc_start_dma(isc: *mut isc_device) {
    static void isc_start_dma(struct isc_device *isc)
    {
    struct regmap *regmap = isc.regmap;
    let mut sizeimage: u32 = isc.fmt.fmt.pix.sizeimage;
    u32 dctrl_dview;
    dma_addr_t addr0;
...
#[no_mangle]
unsafe extern "C" fn isc_set_pipeline(isc: *mut isc_device, pipeline: u32) {
...
#[no_mangle]
unsafe extern "C" fn isc_update_profile(isc: *mut isc_device) -> c_int {
    static int isc_update_profile(struct isc_device *isc)
    {
    struct regmap *regmap = isc.regmap;
    u32 sr;
    let mut counter: c_int = 100;
...
#[no_mangle]
unsafe extern "C" fn isc_set_histogram(isc: *mut isc_device, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn isc_configure(isc: *mut isc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_prepare_streaming(vq: *mut vb2_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_unprepare_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn isc_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn isc_buffer_queue(vb: *mut vb2_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn isc_try_validate_formats(isc: *mut isc_device) -> c_int {
    static int isc_try_validate_formats(struct isc_device *isc)
    {
    int ret;
    let mut bayer: bool = false, yuv = false, rgb = false, grey = false;
...
//
#[no_mangle]
unsafe extern "C" fn isc_try_configure_rlp_dma(isc: *mut isc_device, direct_dump: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn isc_try_configure_pipeline(isc: *mut isc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_try_fmt(isc: *mut isc_device, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_set_fmt(isc: *mut isc_device, f: *mut v4l2_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_link_validate(link: *mut media_link) -> c_int {
    ...
    int ret;
    int i;
    struct isc_format *sd_fmt = core::ptr::null_mut();
...
// Get current format from subdev
    ret = v4l2_subdev_call(isc.current_subdev.sd, pad, get_fmt, core::ptr::null_mut(),
    &format);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn isc_g_input(file: *mut file, priv: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_g_parm(file: *mut file, fh: *mut c_void, a: *mut v4l2_streamparm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_s_parm(file: *mut file, fh: *mut c_void, a: *mut v4l2_streamparm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_release(file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn microchip_isc_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn isc_hist_count(isc: *mut isc_device, min: *mut u32, max: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn isc_wb_update(ctrls: *mut isc_ctrls) {
...
#[no_mangle]
unsafe extern "C" fn isc_awb_work(w: *mut work_struct) {
    ...
    struct regmap *regmap = isc.regmap;
    struct isc_ctrls *ctrls = &isc.ctrls;
    let mut hist_id: u32 = ctrls.hist_id;
    u32 baysel;
    unsigned long flags;
    u32 min, max;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn isc_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_s_awb_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_g_volatile_awb_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_ctrl_init(isc: *mut isc_device) -> c_int {
...
// do_white_balance is a button, so min,max,step,default are ignored
    ...
    v4l2_ctrl_activate(isc.do_wb_ctrl, false);
    isc.r_gain_ctrl = v4l2_ctrl_new_custom(hdl, &isc_r_gain_ctrl, core::ptr::null_mut());
    isc.b_gain_ctrl = v4l2_ctrl_new_custom(hdl, &isc_b_gain_ctrl, core::ptr::null_mut());
    isc.gr_gain_ctrl = v4l2_ctrl_new_custom(hdl, &isc_gr_gain_ctrl, core::ptr::null_mut());
    isc.gb_gain_ctrl = v4l2_ctrl_new_custom(hdl, &isc_gb_gain_ctrl, core::ptr::null_mut());
    isc.r_off_ctrl = v4l2_ctrl_new_custom(hdl, &isc_r_off_ctrl, core::ptr::null_mut());
    isc.b_off_ctrl = v4l2_ctrl_new_custom(hdl, &isc_b_off_ctrl, core::ptr::null_mut());
    isc.gr_off_ctrl = v4l2_ctrl_new_custom(hdl, &isc_gr_off_ctrl, core::ptr::null_mut());
    isc.gb_off_ctrl = v4l2_ctrl_new_custom(hdl, &isc_gb_off_ctrl, core::ptr::null_mut());
//
...
#[no_mangle]
unsafe extern "C" fn isc_set_default_fmt(isc: *mut isc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_async_complete(notifier: *mut v4l2_async_notifier) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn microchip_isc_subdev_cleanup(isc: *mut isc_device) {
...
#[no_mangle]
pub unsafe extern "C" fn microchip_isc_pipeline_init(isc: *mut isc_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isc_mc_init(isc: *mut isc_device, ver: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isc_mc_cleanup(isc: *mut isc_device) {
...
pub const MICROCHIP_ISC_REG_MAX: c_uint = 0xd5c;
