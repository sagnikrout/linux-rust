...
//! Source: drivers/media/platform/microchip/microchip-sama7g5-isc.c
#![no_std]
...
pub const ISC_SAMA7G5_MAX_SUPPORT_WIDTH: c_int = 3264;
pub const ISC_SAMA7G5_MAX_SUPPORT_HEIGHT: c_int = 2464;
...
#[no_mangle]
unsafe extern "C" fn isc_sama7g5_config_csc(isc: *mut isc_device) {
...
#[no_mangle]
unsafe extern "C" fn isc_sama7g5_config_cbc(isc: *mut isc_device) {
...
#[no_mangle]
unsafe extern "C" fn isc_sama7g5_config_cc(isc: *mut isc_device) {
...
#[no_mangle]
unsafe extern "C" fn isc_sama7g5_config_dpc(isc: *mut isc_device) {
    static void isc_sama7g5_config_dpc(struct isc_device *isc)
    {
    let mut bay_cfg: u32 = isc.config.sd_format.cfa_baycfg;
    struct regmap *regmap = isc.regmap;
...
#[no_mangle]
unsafe extern "C" fn isc_sama7g5_config_gam(isc: *mut isc_device) {
...
#[no_mangle]
unsafe extern "C" fn isc_sama7g5_config_rlp(isc: *mut isc_device) {
    static void isc_sama7g5_config_rlp(struct isc_device *isc)
    {
    struct regmap *regmap = isc.regmap;
    let mut rlp_mode: u32 = isc.config.rlp_cfg_mode;
    regmap_update_bits(regmap, ISC_RLP_CFG + isc.offsets.rlp,
    ISC_RLP_CFG_MODE_MASK | ISC_RLP_CFG_LSH |
    ISC_RLP_CFG_YMODE_MASK, rlp_mode);
    }
#[no_mangle]
unsafe extern "C" fn isc_sama7g5_adapt_pipeline(isc: *mut isc_device) {
...
#[no_mangle]
unsafe extern "C" fn xisc_parse_dt(dev: *mut device, isc: *mut isc_device) -> c_int {
    ...
    let mut v4l2_epn: v4l2_fwnode_endpoint = { .bus_type = 0 };
    int ret;
...
#[no_mangle]
unsafe extern "C" fn microchip_xisc_probe(pdev: *mut platform_device) -> c_int {
...
// sama7g5-isc : ISPCK does not exist, ISC is clocked by MCK
    ...
    subdev_entity.epn = core::ptr::null_mut();
    if (IS_ERR(asd)) {
    ret = PTR_ERR(asd);
    goto cleanup_subdev;
    }
...
#[no_mangle]
unsafe extern "C" fn microchip_xisc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn xisc_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn xisc_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(xisc_runtime_suspend, xisc_runtime_resume, core::ptr::null_mut())
    };
