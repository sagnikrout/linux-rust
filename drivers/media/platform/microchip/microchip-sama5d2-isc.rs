...
//! Source: drivers/media/platform/microchip/microchip-sama5d2-isc.c
#![no_std]
...
pub const ISC_SAMA5D2_MAX_SUPPORT_WIDTH: c_int = 2592;
pub const ISC_SAMA5D2_MAX_SUPPORT_HEIGHT: c_int = 1944;
...
#[no_mangle]
unsafe extern "C" fn isc_sama5d2_config_csc(isc: *mut isc_device) {
...
#[no_mangle]
unsafe extern "C" fn isc_sama5d2_config_cbc(isc: *mut isc_device) {
...
#[no_mangle]
unsafe extern "C" fn isc_sama5d2_config_cc(isc: *mut isc_device) {
...
#[no_mangle]
unsafe extern "C" fn isc_sama5d2_adapt_pipeline(isc: *mut isc_device) {
...
#[no_mangle]
unsafe extern "C" fn isc_parse_dt(dev: *mut device, isc: *mut isc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn microchip_isc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn microchip_isc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn isc_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn isc_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(isc_runtime_suspend, isc_runtime_resume, core::ptr::null_mut())
    };
