...
//! Source: drivers/media/radio/radio-si476x.c
#![no_std]
...
pub const FM_FREQ_RANGE_LOW: c_int = 64000000;
pub const FM_FREQ_RANGE_HIGH: c_int = 108000000;
pub const AM_FREQ_RANGE_LOW: c_int = 520000;
pub const AM_FREQ_RANGE_HIGH: c_int = 30000000;
...
#[no_mangle]
pub unsafe extern "C" fn si476x_radio_freq_is_inside_of_the_band(freq: u32, band: c_int) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct si476x_radio_ops {
    pub ): *mut *mut *mut int (tune_freq)(struct si476x_core , struct si476x_tune_freq_args,
    pub bool): *mut *mut *mut int (seek_start)(struct si476x_core , bool,,
    int (*rsq_status)(struct si476x_core *, struct si476x_rsq_status_args *,
    pub ): *mut si476x_rsq_status_report,
    int (*rds_blckcnt)(struct si476x_core *, bool,
    pub ): *mut si476x_rds_blockcount_report,
    int (*phase_diversity)(struct si476x_core *,
    pub si476x_phase_diversity_mode): enum,
    pub ): *mut *mut int (phase_div_status)(struct si476x_core,
    int (*acf_status)(struct si476x_core *,
    pub ): *mut si476x_acf_status_report,
    int (*agc_status)(struct si476x_core *,
    pub ): *mut si476x_agc_status_report,
}
...
//
    ...
    .rds_blckcnt		= core::ptr::null_mut(),
    .phase_diversity	= core::ptr::null_mut(),
    .phase_div_status	= core::ptr::null_mut(),
    .acf_status		= si476x_core_cmd_am_acf_status,
    .agc_status		= core::ptr::null_mut(),
    };
    switch (func) {
...
//
    ...
    int err;
    enum si476x_func func;
    let mut rangelow: u32 = seek.rangelow, rangehigh = seek.rangehigh;
    struct si476x_radio *radio = video_drvdata(file);
...
#[no_mangle]
unsafe extern "C" fn si476x_radio_g_volatile_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    static int si476x_radio_g_volatile_ctrl(struct v4l2_ctrl *ctrl)
    {
    int retval;
...
#[no_mangle]
unsafe extern "C" fn si476x_radio_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    static int si476x_radio_s_ctrl(struct v4l2_ctrl *ctrl)
    {
    int retval;
...
#[no_mangle]
unsafe extern "C" fn si476x_radio_fops_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si476x_radio_fops_release(file: *mut file) -> c_int {
...
// block if no new data available
    ...
    {
    struct si476x_radio *radio = video_drvdata(file);
    let mut req_events: __poll_t = poll_requested_events(pts);
    let mut err: __poll_t = v4l2_ctrl_poll(file, pts);
...
#[no_mangle]
unsafe extern "C" fn si476x_radio_init_debugfs(radio: *mut si476x_radio) {
    static void si476x_radio_init_debugfs(struct si476x_radio *radio)
    {
    radio.debugfs = debugfs_create_dir(dev_name(radio.v4l2dev.dev), core::ptr::null_mut());
    ...
    if (ctrl == core::ptr::null_mut() && rval)
...
#[no_mangle]
unsafe extern "C" fn si476x_radio_probe(pdev: *mut platform_device) -> c_int {
    static int si476x_radio_probe(struct platform_device *pdev)
    {
    int rval;
    struct si476x_radio *radio;
    struct v4l2_ctrl *ctrl;
    let mut instance: static atomic_t = ATOMIC_INIT(0);
...
#[no_mangle]
unsafe extern "C" fn si476x_radio_remove(pdev: *mut platform_device) {
