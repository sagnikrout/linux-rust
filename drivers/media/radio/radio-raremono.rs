...
//! Source: drivers/media/radio/radio-raremono.c
#![no_std]
...
pub const USB_TIMEOUT: c_int = 10000;
// Frequency limits in KHz
pub const FM_FREQ_RANGE_LOW: c_int = 64000;
pub const FM_FREQ_RANGE_HIGH: c_int = 108000;
pub const AM_FREQ_RANGE_LOW: c_int = 520;
pub const AM_FREQ_RANGE_HIGH: c_int = 1710;
pub const SW_FREQ_RANGE_LOW: c_int = 2300;
pub const SW_FREQ_RANGE_HIGH: c_int = 26100;
...
// Set frequency.
#[no_mangle]
unsafe extern "C" fn raremono_cmd_main(radio: *mut raremono_device, band: unsigned, freq: unsigned) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usb_raremono_disconnect(intf: *mut usb_interface) {
...
// band = bands[band->index];
    ...
    band = BAND_FM;
#[no_mangle]
pub unsafe extern "C" fn if(8: *mut *mut f->frequency <= (AM_FREQ_RANGE_HIGH + SW_FREQ_RANGE_LOW)) -> else {
...
#[no_mangle]
unsafe extern "C" fn raremono_device_release(v4l2_dev: *mut v4l2_device) {
