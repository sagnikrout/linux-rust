...
//! Source: drivers/media/radio/radio-keene.c
#![no_std]
...
pub const USB_KEENE_VENDOR: c_uint = 0x046d;
pub const USB_KEENE_PRODUCT: c_uint = 0x0a0e;
...
pub struct keene_device {
    ...
    pub lock: mutex,
    pub buffer: *mut u8,
    pub curfreq: unsigned,
    pub tx: u8,
    pub pa: u8,
    pub stereo: bool,
    pub muted: bool,
    pub preemph_75_us: bool,
}
...
#[no_mangle]
unsafe extern "C" fn keene_cmd_main(radio: *mut keene_device, freq: unsigned, play: bool) -> c_int {
    static int keene_cmd_main(struct keene_device *radio, unsigned freq, bool play)
    {
    let mut freq_send: c_ushort = freq ? (freq - 76 * 16000) / 800 : 0;
    int ret;
    radio.buffer[0] = 0x00;
    radio.buffer[1] = 0x50;
...
#[no_mangle]
unsafe extern "C" fn keene_cmd_set(radio: *mut keene_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usb_keene_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn usb_keene_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_keene_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keene_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_keene_video_device_release(v4l2_dev: *mut v4l2_device) {
