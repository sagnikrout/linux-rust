...
//! Source: drivers/media/radio/radio-miropcm20.c
#![no_std]
...
pub const RDS_BUSYMASK: c_uint = 0x10   /* Bit 4 */;
pub const RDS_CLOCKMASK: c_uint = 0x08   /* Bit 3 */;

pub const RDS_STATUS: c_uint = 0x01;
pub const RDS_STATIONNAME: c_uint = 0x02;
pub const RDS_TEXT: c_uint = 0x03;
pub const RDS_ALTFREQ: c_uint = 0x04;
pub const RDS_TIMEDATE: c_uint = 0x05;
pub const RDS_PI_CODE: c_uint = 0x06;
pub const RDS_PTYTATP: c_uint = 0x07;
pub const RDS_RESET: c_uint = 0x08;
pub const RDS_RXVALUE: c_uint = 0x09;
...
pub struct pcm20 {
    ...
    pub rds_radio_test: *mut v4l2_ctrl,
...
#[no_mangle]
unsafe extern "C" fn rds_waitread(aci: *mut snd_miro_aci) -> c_int {
    static int rds_waitread(struct snd_miro_aci *aci)
    {
    u8 byte;
    let mut i: c_int = 2000;
    do {
...
#[no_mangle]
unsafe extern "C" fn rds_rawwrite(aci: *mut snd_miro_aci, byte: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rds_write(aci: *mut snd_miro_aci, byte: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rds_readcycle_nowait(aci: *mut snd_miro_aci) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rds_readcycle(aci: *mut snd_miro_aci) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rds_ack(aci: *mut snd_miro_aci) -> c_int {
    static int rds_ack(struct snd_miro_aci *aci)
    {
    let mut i: c_int = rds_readcycle(aci);
    if (i < 0)
    return -1;
    if (i & RDS_DATAMASK)
    return 0;  /* ACK  */
...
#[no_mangle]
unsafe extern "C" fn rds_cmd(aci: *mut snd_miro_aci, cmd: u8, databuffer[]: u8, datasize: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcm20_setfreq(dev: *mut pcm20, freq: c_ulong) -> c_int {
...
// needs this hack
    freql = freq & 0xff;
    freqh = freq >> 8;
    rds_cmd(aci, RDS_RESET, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn sanitize(p: *mut c_char, size: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pcm20_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcm20_thread(data: *mut c_void) -> c_int {
    static int pcm20_thread(void *data)
    {
    struct pcm20 *dev = data;
    let mut no_rds_start_counter: unsigned = 5;
    let mut sleep_msecs: unsigned = 2000;
    let mut no_rds_counter: unsigned = no_rds_start_counter;
    for (;;) {
    char text_buffer[66];
    u8 buf;
    int res;
...
#[no_mangle]
unsafe extern "C" fn pcm20_open(file: *mut file) -> c_int {
    static int pcm20_open(struct file *file)
    {
    struct pcm20 *dev = video_drvdata(file);
    let mut res: c_int = v4l2_fh_open(file);
...
#[no_mangle]
unsafe extern "C" fn pcm20_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcm20_init() -> int __init {
    ...
    dev.rds_pty = v4l2_ctrl_new_std(hdl, core::ptr::null_mut(),
    V4L2_CID_RDS_RX_PTY, 0, 0x1f, 1, 0);
    dev.rds_ps_name = v4l2_ctrl_new_std(hdl, core::ptr::null_mut(),
    V4L2_CID_RDS_RX_PS_NAME, 0, 8, 8, 0);
    dev.rds_radio_test = v4l2_ctrl_new_std(hdl, core::ptr::null_mut(),
    V4L2_CID_RDS_RX_RADIO_TEXT, 0, 64, 64, 0);
    dev.rds_ta = v4l2_ctrl_new_std(hdl, core::ptr::null_mut(),
    V4L2_CID_RDS_RX_TRAFFIC_ANNOUNCEMENT, 0, 1, 1, 0);
    dev.rds_tp = v4l2_ctrl_new_std(hdl, core::ptr::null_mut(),
    V4L2_CID_RDS_RX_TRAFFIC_PROGRAM, 0, 1, 1, 0);
    dev.rds_ms = v4l2_ctrl_new_std(hdl, core::ptr::null_mut(),
    ...
    MODULE_LICENSE("GPL");
#[no_mangle]
unsafe extern "C" fn pcm20_cleanup() -> void __exit {
