...
//! Source: drivers/media/radio/si470x/radio-si470x-usb.c
#![no_std]
...
// USB timeout
    let mut usb_timeout: static unsigned int = 500;
    module_param(usb_timeout, uint, 0644);
    MODULE_PARM_DESC(usb_timeout, "USB timeout (ms): *500*");
// RDS buffer blocks
    let mut rds_buf: static unsigned int = 100;
    module_param(rds_buf, uint, 0444);
    MODULE_PARM_DESC(rds_buf, "RDS buffer entries: *100*");
// RDS maximum block errors
    let mut max_rds_errors: static unsigned short = 1;
...
pub const ENTIRE_REPORT: c_int = 17;
...
pub const RDS_REPORT: c_int = 18;
// Report 19: LED state
pub const LED_REPORT_SIZE: c_int = 3;
pub const LED_REPORT: c_int = 19;
// Report 19: stream
pub const STREAM_REPORT_SIZE: c_int = 3;
pub const STREAM_REPORT: c_int = 19;
// Report 20: scratch
pub const SCRATCH_PAGE_SIZE: c_int = 63;

pub const SCRATCH_REPORT: c_int = 20;
// Reports 19-22: flash upgrade of the C8051F321
pub const WRITE_REPORT_SIZE: c_int = 4;
pub const WRITE_REPORT: c_int = 19;
pub const FLASH_REPORT_SIZE: c_int = 64;
pub const FLASH_REPORT: c_int = 20;
pub const CRC_REPORT_SIZE: c_int = 3;
pub const CRC_REPORT: c_int = 21;
pub const RESPONSE_REPORT_SIZE: c_int = 2;
pub const RESPONSE_REPORT: c_int = 22;
// Report 23: currently unused, but can accept 60 byte reports on the HID
// interrupt out endpoint 2 every 1 millisecond
pub const UNUSED_REPORT: c_int = 23;
pub const MAX_REPORT_SIZE: c_int = 64;
//
// Software/Hardware Versions from Scratch Page
//
pub const RADIO_HW_VERSION: c_int = 1;
//
// LED State Definitions
//
pub const LED_COMMAND: c_uint = 0x35;
pub const NO_CHANGE_LED: c_uint = 0x00;
pub const ALL_COLOR_LED: c_uint = 0x01	/* streaming state */;
pub const BLINK_GREEN_LED: c_uint = 0x02	/* connect state */;
pub const BLINK_RED_LED: c_uint = 0x04;
pub const BLINK_ORANGE_LED: c_uint = 0x10	/* disconnect state */;
pub const SOLID_GREEN_LED: c_uint = 0x20	/* tuning/seeking state */;
pub const SOLID_RED_LED: c_uint = 0x40	/* bootload state */;
pub const SOLID_ORANGE_LED: c_uint = 0x80;
//
// Stream State Definitions
//
pub const STREAM_COMMAND: c_uint = 0x36;
pub const STREAM_VIDPID: c_uint = 0x00;
pub const STREAM_AUDIO: c_uint = 0xff;
//
// Bootloader / Flash Commands
//
// unique id sent to bootloader and required to put into a bootload state
pub const UNIQUE_BL_ID: c_uint = 0x34;
// mask for the flash data
pub const FLASH_DATA_MASK: c_uint = 0x55;
// bootloader commands
pub const GET_SW_VERSION_COMMAND: c_uint = 0x00;
pub const SET_PAGE_COMMAND: c_uint = 0x01;
pub const ERASE_PAGE_COMMAND: c_uint = 0x02;
pub const WRITE_PAGE_COMMAND: c_uint = 0x03;
pub const CRC_ON_PAGE_COMMAND: c_uint = 0x04;
pub const READ_FLASH_BYTE_COMMAND: c_uint = 0x05;
pub const RESET_DEVICE_COMMAND: c_uint = 0x06;
pub const GET_HW_VERSION_COMMAND: c_uint = 0x07;
pub const BLANK: c_uint = 0xff;
// bootloader command responses
pub const COMMAND_OK: c_uint = 0x01;
pub const COMMAND_FAILED: c_uint = 0x02;
pub const COMMAND_PENDING: c_uint = 0x03;
//
...
//
#[no_mangle]
unsafe extern "C" fn si470x_get_report(radio: *mut si470x_device, buf: *mut c_void, size: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn si470x_set_report(radio: *mut si470x_device, buf: *mut c_void, size: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn si470x_get_register(radio: *mut si470x_device, regnr: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn si470x_set_register(radio: *mut si470x_device, regnr: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn si470x_get_all_registers(radio: *mut si470x_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn si470x_get_scratch_page_versions(radio: *mut si470x_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn si470x_int_in_callback(urb: *mut urb) {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: bler >) -> else {
    else if (bler > 0)
...
#[no_mangle]
unsafe extern "C" fn si470x_fops_open(file: *mut file) -> c_int {
    static int si470x_fops_open(struct file *file)
    {
    return v4l2_fh_open(file);
    }
#[no_mangle]
unsafe extern "C" fn si470x_fops_release(file: *mut file) -> c_int {
    static int si470x_fops_release(struct file *file)
    {
    return v4l2_fh_release(file);
    }
#[no_mangle]
unsafe extern "C" fn si470x_usb_release(v4l2_dev: *mut v4l2_device) {
...
#[no_mangle]
unsafe extern "C" fn si470x_start_usb(radio: *mut si470x_device) -> c_int {
...
//
    ...
    let mut version_warning: c_uchar = 0;
// private data allocation and initialization
    ...
    if (radio.usb_buf == core::ptr::null_mut()) {
    retval = -ENOMEM;
    goto err_radio;
    }
...
//
#[no_mangle]
unsafe extern "C" fn si470x_usb_driver_resume(intf: *mut usb_interface) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn si470x_usb_driver_disconnect(intf: *mut usb_interface) {
