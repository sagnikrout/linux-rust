...
//! Source: drivers/media/radio/si470x/radio-si470x-i2c.c
#![no_std]
...
pub const WRITE_REG_NUM: c_int = 8;
...
unsafe extern "C" fn si470x_fops_open(file: *mut file) -> c_int {
    ...
    let mut retval: c_int = v4l2_fh_open(file);
    if (retval)
    return retval;
...
//
#[no_mangle]
unsafe extern "C" fn si470x_i2c_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn si470x_i2c_probe(client: *mut i2c_client) -> c_int {
...
// rds buffer configuration
    ...
    retval = devm_request_threaded_irq(&client.dev, client.irq, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn si470x_i2c_remove(client: *mut i2c_client) {
...
//
#[no_mangle]
unsafe extern "C" fn si470x_i2c_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn si470x_i2c_resume(dev: *mut device) -> c_int {
