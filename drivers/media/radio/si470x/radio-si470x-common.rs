...
//! Source: drivers/media/radio/si470x/radio-si470x-common.c
#![no_std]
...
// 2:  50 kHz
    let mut space: static unsigned short = 2;
    module_param(space, ushort, 0444);
    MODULE_PARM_DESC(space, "Spacing: 0=200kHz 1=100kHz *2=50kHz*");
// De-emphasis
// 0: 75 us (USA)
// 1: 50 us (Europe, Australia, Japan)
    let mut de: static unsigned short = 1;
    module_param(de, ushort, 0444);
    MODULE_PARM_DESC(de, "De-emphasis: 0=75us *1=50us*");
// Tune timeout
    let mut tune_timeout: static unsigned int = 3000;
    module_param(tune_timeout, uint, 0644);
    MODULE_PARM_DESC(tune_timeout, "Tune timeout: *3000*");
// Seek timeout
    let mut seek_timeout: static unsigned int = 5000;
...
//
#[no_mangle]
unsafe extern "C" fn si470x_set_band(radio: *mut si470x_device, band: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn si470x_set_chan(radio: *mut si470x_device, chan: c_ushort) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn si470x_get_step(radio: *mut si470x_device) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn si470x_get_freq(radio: *mut si470x_device, freq: *mut c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn si470x_set_freq(radio: *mut si470x_device, freq: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn si470x_start(radio: *mut si470x_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn si470x_stop(radio: *mut si470x_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn si470x_rds_on(radio: *mut si470x_device) -> c_int {
...
//
    ...
    let mut retval: __poll_t = v4l2_ctrl_poll(file, pts);
...
//
#[no_mangle]
unsafe extern "C" fn si470x_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
