...
//! Source: drivers/media/radio/radio-zoltrix.c
#![no_std]
...
pub struct zoltrix {
    ...
    return zol ? &zol.isa : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn zoltrix_s_mute_volume(isa: *mut radio_isa_card, mute: bool, vol: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zoltrix_s_frequency(isa: *mut radio_isa_card, freq: u32) -> c_int {
    static int zoltrix_s_frequency(struct radio_isa_card *isa, u32 freq)
    {
    struct zoltrix *zol = container_of(isa, struct zoltrix, isa);
    struct v4l2_device *v4l2_dev = &isa.v4l2_dev;
    unsigned long long bitmask, f, m;
    let mut stereo: bool = isa.stereo;
    int i;
    if (freq == 0) {
...
// Get signal strength
#[no_mangle]
unsafe extern "C" fn zoltrix_g_rxsubchans(isa: *mut radio_isa_card) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn zoltrix_g_signal(isa: *mut radio_isa_card) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn zoltrix_s_stereo(isa: *mut radio_isa_card, stereo: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zoltrix_init() -> int __init {
    static int __init zoltrix_init(void)
    {
    return isa_register_driver(&zoltrix_driver.driver, ZOLTRIX_MAX);
    }
#[no_mangle]
unsafe extern "C" fn zoltrix_exit() -> void __exit {
