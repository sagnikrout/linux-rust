...
//! Source: drivers/media/radio/radio-sf16fmi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fmi_set_pins(handle: *mut c_void, pins: u8) {
    static void fmi_set_pins(void *handle, u8 pins)
    {
    struct fmi *fmi = handle;
    let mut bits: u8 = FMI_BIT_TUN_STRQ;
    if (!fmi.mute)
    bits |= FMI_BIT_VOL_SW;
    if (pins & LM7000_DATA)
...
#[no_mangle]
pub unsafe extern "C" fn fmi_mute(fmi: *mut fmi) {
...
#[no_mangle]
pub unsafe extern "C" fn fmi_unmute(fmi: *mut fmi) {
...
#[no_mangle]
pub unsafe extern "C" fn fmi_getsigstr(fmi: *mut fmi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fmi_set_freq(fmi: *mut fmi) {
...
#[no_mangle]
unsafe extern "C" fn fmi_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isapnp_fmi_probe() -> int __init {
    static int __init isapnp_fmi_probe(void)
    {
    let mut i: c_int = 0;
    while (id_table[i].card_vendor != 0 && dev == core::ptr::null_mut()) {
    dev = pnp_find_dev(core::ptr::null_mut(), id_table[i].vendor,
    id_table[i].function, core::ptr::null_mut());
    i++;
    }
    if (!dev)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn fmi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fmi_exit() -> void __exit {
