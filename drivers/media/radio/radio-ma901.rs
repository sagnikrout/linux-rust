...
//! Source: drivers/media/radio/radio-ma901.c
#![no_std]
...
pub const USB_MA901_VENDOR: c_uint = 0x16c0;
pub const USB_MA901_PRODUCT: c_uint = 0x05df;
...
pub const MA901_VOLUME_MAX: c_int = 16;
pub const MA901_VOLUME_MIN: c_int = 0;
// Commands that device should understand
// List isn't full and will be updated with implementation of new functions
//
pub const MA901_RADIO_SET_FREQ: c_uint = 0x03;
pub const MA901_RADIO_SET_VOLUME: c_uint = 0x04;
pub const MA901_RADIO_SET_MONO_STEREO: c_uint = 0x05;
// Comfortable defines for ma901radio_set_stereo
pub const MA901_WANT_STEREO: c_uint = 0x50;
pub const MA901_WANT_MONO: c_uint = 0xd0;
// module parameter
...
#[no_mangle]
unsafe extern "C" fn ma901radio_set_freq(radio: *mut ma901radio_device, freq: c_int) -> c_int {
    static int ma901radio_set_freq(struct ma901radio_device *radio, int freq)
    {
    let mut freq_send: c_uint = 0x300 + (freq >> 5) / 25;
    int retval;
    radio.buffer[0] = 0x0a;
...
#[no_mangle]
unsafe extern "C" fn ma901radio_set_volume(radio: *mut ma901radio_device, vol_to_set: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ma901_set_stereo(radio: *mut ma901radio_device, stereo: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usb_ma901radio_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn usb_ma901radio_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usb_ma901radio_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
    static int usb_ma901radio_suspend(struct usb_interface *intf, pm_message_t message)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn usb_ma901radio_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_ma901radio_release(v4l2_dev: *mut v4l2_device) {
