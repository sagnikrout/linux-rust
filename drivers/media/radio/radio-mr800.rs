...
//! Source: drivers/media/radio/radio-mr800.c
#![no_std]
...
pub const USB_AMRADIO_VENDOR: c_uint = 0x07ca;
pub const USB_AMRADIO_PRODUCT: c_uint = 0xb800;
...
pub const BUFFER_LENGTH: c_int = 8;
pub const USB_TIMEOUT: c_int = 500;
...
//
pub const AMRADIO_SET_FREQ: c_uint = 0xa4;
pub const AMRADIO_GET_READY_FLAG: c_uint = 0xa5;
pub const AMRADIO_GET_SIGNAL: c_uint = 0xa7;
pub const AMRADIO_GET_FREQ: c_uint = 0xa8;
pub const AMRADIO_SET_SEARCH_UP: c_uint = 0xa9;
pub const AMRADIO_SET_SEARCH_DOWN: c_uint = 0xaa;
pub const AMRADIO_SET_MUTE: c_uint = 0xab;
pub const AMRADIO_SET_RIGHT_MUTE: c_uint = 0xac;
pub const AMRADIO_SET_LEFT_MUTE: c_uint = 0xad;
pub const AMRADIO_SET_MONO: c_uint = 0xae;
pub const AMRADIO_SET_SEARCH_LVL: c_uint = 0xb0;
pub const AMRADIO_STOP_SEARCH: c_uint = 0xb1;
// Comfortable defines for amradio_set_stereo
pub const WANT_STEREO: c_uint = 0x00;
pub const WANT_MONO: c_uint = 0x01;
// module parameter
...
#[no_mangle]
unsafe extern "C" fn amradio_set_mute(radio: *mut amradio_device, mute: bool) -> c_int {
    static int amradio_set_mute(struct amradio_device *radio, bool mute)
    {
    int ret = amradio_send_cmd(radio,
    AMRADIO_SET_MUTE, mute, core::ptr::null_mut(), 0, false);
    if (!ret)
    radio.muted = mute;
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn amradio_set_freq(radio: *mut amradio_device, freq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amradio_set_stereo(radio: *mut amradio_device, stereo: bool) -> c_int {
    static int amradio_set_stereo(struct amradio_device *radio, bool stereo)
    {
    int ret = amradio_send_cmd(radio,
    AMRADIO_SET_MONO, !stereo, core::ptr::null_mut(), 0, false);
    if (!ret)
    radio.stereo = stereo;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn amradio_get_stat(radio: *mut amradio_device, is_stereo: *mut bool, signal: *mut u32) -> c_int {
    static int amradio_get_stat(struct amradio_device *radio, bool *is_stereo, u32 *signal)
    {
    int ret = amradio_send_cmd(radio,
    AMRADIO_GET_SIGNAL, 0, core::ptr::null_mut(), 0, true);
    if (ret)
    return ret;
...
//
#[no_mangle]
unsafe extern "C" fn usb_amradio_disconnect(intf: *mut usb_interface) {
...
// vidioc_g_frequency - get tuner radio frequency
    ...
    0, core::ptr::null_mut(), 0, true);
    if (retval)
    continue;
    amradio_send_cmd(radio, AMRADIO_GET_FREQ, 0, core::ptr::null_mut(), 0, true);
...
// To check: sometimes radio->curfreq is set to out of range value
    ...
    amradio_send_cmd(radio, AMRADIO_STOP_SEARCH, 0, core::ptr::null_mut(), 0, false);
    amradio_set_freq(radio, radio.curfreq);
    return retval;
    }
#[no_mangle]
unsafe extern "C" fn usb_amradio_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_amradio_init(radio: *mut amradio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_amradio_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_amradio_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_amradio_release(v4l2_dev: *mut v4l2_device) {
