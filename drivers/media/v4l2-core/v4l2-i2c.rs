...
//! Source: drivers/media/v4l2-core/v4l2-i2c.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_i2c_subdev_unregister(sd: *mut v4l2_subdev) {
...
// i2c_client and v4l2_subdev point to one another
    ...
    v4l2_i2c_subdev_set_name(sd, client, core::ptr::null_mut(), core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_i2c_subdev_addr(sd: *mut v4l2_subdev) -> c_ushort {
