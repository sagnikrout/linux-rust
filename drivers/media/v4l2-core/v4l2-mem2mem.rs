...
//! Source: drivers/media/v4l2-core/v4l2-mem2mem.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v4l2_m2m_dev {
    pub curr_ctx: *mut v4l2_m2m_ctx,

    pub source: *mut media_entity,
    ...
    pub job_spinlock: spinlock_t,
    pub job_work: work_struct,
    pub job_queue_flags: c_ulong,
    ...
    struct vb2_v4l2_buffer *ret = core::ptr::null_mut();
    unsigned long flags;
    spin_lock_irqsave(&q_ctx.rdy_spinlock, flags);
...
//
#[no_mangle]
unsafe extern "C" fn v4l2_m2m_try_run(m2m_dev: *mut v4l2_m2m_dev) {
    static void v4l2_m2m_try_run(struct v4l2_m2m_dev *m2m_dev)
    {
    unsigned long flags;
    spin_lock_irqsave(&m2m_dev.job_spinlock, flags);
    if (core::ptr::null_mut() != m2m_dev.curr_ctx) {
    spin_unlock_irqrestore(&m2m_dev.job_spinlock, flags);
...
//
#[no_mangle]
pub unsafe extern "C" fn v4l2_m2m_try_schedule(m2m_ctx: *mut v4l2_m2m_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn v4l2_m2m_device_run_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn v4l2_m2m_cancel_job(m2m_ctx: *mut v4l2_m2m_ctx) {
...
//
    ...
    m2m_dev.curr_ctx = core::ptr::null_mut();
    return true;
    }
...
//
    ...
    let mut schedule_next: bool = false;
    unsigned long flags;
    spin_lock_irqsave(&m2m_dev.job_spinlock, flags);
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_m2m_suspend(m2m_dev: *mut v4l2_m2m_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_m2m_resume(m2m_dev: *mut v4l2_m2m_dev) {
...
// If count == 0, then the owner has released all buffers and he
    ...
    if (ret == 0)
    vq.owner = reqbufs.count ? file.private_data : core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn v4l2_update_last_buf_state(m2m_ctx: *mut v4l2_m2m_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_BUF_FLAG_IN_REQUEST): !(buf->flags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_m2m_unregister_media_controller(m2m_dev: *mut v4l2_m2m_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_m2m_release(m2m_dev: *mut v4l2_m2m_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_m2m_get(m2m_dev: *mut v4l2_m2m_dev) {
...
#[no_mangle]
unsafe extern "C" fn v4l2_m2m_release_from_kref(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_m2m_put(m2m_dev: *mut v4l2_m2m_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_m2m_ctx_release(m2m_ctx: *mut v4l2_m2m_ctx) {
...
// wait until the current context is dequeued from job_queue
    ...
    {
    let mut mask: u32 = V4L2_BUF_FLAG_TIMECODE | V4L2_BUF_FLAG_TSTAMP_SRC_MASK;
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_m2m_request_queue(req: *mut media_request) {
    void v4l2_m2m_request_queue(struct media_request *req)
    {
    struct media_request_object *obj, *obj_safe;
    struct v4l2_m2m_ctx *m2m_ctx = core::ptr::null_mut();
//
...
//
#[no_mangle]
pub unsafe extern "C" fn v4l2_m2m_fop_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_m2m_fop_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
