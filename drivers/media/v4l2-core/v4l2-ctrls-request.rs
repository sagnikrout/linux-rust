...
//! Source: drivers/media/v4l2-core/v4l2-ctrls-request.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_ctrl_handler_init_request(hdl: *mut v4l2_ctrl_handler) {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_ctrl_handler_free_request(hdl: *mut v4l2_ctrl_handler) {
...
#[no_mangle]
unsafe extern "C" fn v4l2_ctrl_request_queue(obj: *mut media_request_object) {
...
#[no_mangle]
unsafe extern "C" fn v4l2_ctrl_request_unbind(obj: *mut media_request_object) {
...
#[no_mangle]
unsafe extern "C" fn v4l2_ctrl_request_release(obj: *mut media_request_object) {
    ...
    return (ref && ref.p_req_valid) ? ref.ctrl : core::ptr::null_mut();
    }
...
//
    ...
    {
    struct media_request_object *obj = core::ptr::null_mut();
...
//
    ...
    struct v4l2_ctrl *ctrl = ref.ctrl;
    struct v4l2_ctrl *master = ctrl.cluster[0];
    let mut have_new_data: bool = false;
    int i;
//
...
//
    ...
    let mut new_auto_val: i32 = *master.p_new.p_s32;
//
...
//
    ...
    ret = try_or_set_cluster(core::ptr::null_mut(), master, true, 0);
    v4l2_ctrl_unlock(master);
    if (ret)
    break;
    }
