...
//! Source: drivers/media/v4l2-core/v4l2-flash-led-class.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn v4l2_flash_g_volatile_ctrl(c: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __software_strobe_mode_inactive(ctrls: *mut v4l2_ctrl) -> bool {
...
#[no_mangle]
unsafe extern "C" fn v4l2_flash_s_ctrl(c: *mut v4l2_ctrl) -> c_int {
...
//
    ...
    {
    struct led_classdev_flash *fled_cdev = v4l2_flash.fled_cdev;
    struct led_classdev *led_cdev = fled_cdev ? &fled_cdev.led_cdev : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn __sync_device_with_v4l2_controls(v4l2_flash: *mut v4l2_flash) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn v4l2_flash_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v4l2_flash_close(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
    ...
    ret = media_entity_pads_init(&sd.entity, 0, core::ptr::null_mut());
    if (ret < 0)
    return ERR_PTR(ret);
    ...
    {
    return __v4l2_flash_init(dev, fwn, fled_cdev, core::ptr::null_mut(), ops, config);
    }
    ...
    struct v4l2_flash_config *config)
    {
    return __v4l2_flash_init(dev, fwn, core::ptr::null_mut(), iled_cdev, core::ptr::null_mut(), config);
    }
    EXPORT_SYMBOL_GPL(v4l2_flash_indicator_init);
#[no_mangle]
pub unsafe extern "C" fn v4l2_flash_release(v4l2_flash: *mut v4l2_flash) {
