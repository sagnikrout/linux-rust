...
//! Source: drivers/media/v4l2-core/v4l2-vp9.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fastdiv(dividend: u32, divisor: u16) -> u32 {
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(1: divisor ==) -> else {
    else if (divisor == 1)
    return dividend;
...
#[no_mangle]
unsafe extern "C" fn inv_recenter_nonneg(v: c_int, m: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn update_prob(delta: c_int, prob: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_coeff(deltas[6][6][3]: u8, probs[6][6][3]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn update_mv_prob(delta: c_int, prob: c_int) -> c_int {
...
// Counterpart to 6.3 compressed_header(), but parsing has been done in userspace.
    ...
    {
    int i;
    let mut fctx_idx: u8 = dec_params.frame_context_idx;
    if (dec_params.flags & V4L2_VP9_FRAME_FLAG_KEY_FRAME ||
    dec_params.flags & V4L2_VP9_FRAME_FLAG_INTRA_ONLY ||
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_VP9_RESET_FRAME_CTX_SPEC: dec_params->reset_frame_context ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn merge_prob(pre_prob: u8, ct0: u32, ct1: u32, count_sat: u16, max_update_factor: u32) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn noncoef_merge_prob(pre_prob: u8, ct0: u32, ct1: u32) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn merge_probs_variant_a(p: *mut u8, c: *const u32, count_sat: u16, update_factor: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn merge_probs_variant_b(p: *mut u8, c: *const u32, count_sat: u16, update_factor: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn merge_probs_variant_c(p: *mut u8, c: *const u32) {
...
#[no_mangle]
unsafe extern "C" fn merge_probs_variant_d(p: *mut u8, c: *const u32) {
    static void merge_probs_variant_d(u8 *p, const u32 *c)
    {
    let mut sum: u32 = 0, s2;
...
#[no_mangle]
pub unsafe extern "C" fn merge_probs_variant_e(p: *mut u8, c: *const u32) {
...
#[no_mangle]
pub unsafe extern "C" fn merge_probs_variant_f(p: *mut u8, c: *const u32) {
...
#[no_mangle]
unsafe extern "C" fn merge_probs_variant_g(p: *mut u8, c: *const u32) {
...
#[no_mangle]
pub unsafe extern "C" fn adapt_probs_variant_a_coef(p: *mut u8, c: *const u32, update_factor: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn adapt_probs_variant_b_coef(p: *mut u8, c: *const u32, update_factor: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn adapt_prob(prob: u8, counts[2]: u32) -> u8 {
