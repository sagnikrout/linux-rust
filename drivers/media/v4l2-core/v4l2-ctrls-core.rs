...
//! Source: drivers/media/v4l2-core/v4l2-ctrls-core.c
#![no_std]
...
pub const V4L2_HEVC_MAX_SHORT_TERM_REF_PIC_SETS: c_int = 64;
pub const V4L2_HEVC_MAX_LONG_TERM_REF_PICS_SPS: c_int = 32;
...
#[no_mangle]
pub unsafe extern "C" fn send_initial_event(fh: *mut v4l2_fh, ctrl: *mut v4l2_ctrl) {
    void send_initial_event(struct v4l2_fh *fh, struct v4l2_ctrl *ctrl)
    {
    struct v4l2_event ev;
    let mut changes: u32 = V4L2_EVENT_CTRL_CH_FLAGS;
...
#[no_mangle]
pub unsafe extern "C" fn send_event(fh: *mut v4l2_fh, ctrl: *mut v4l2_ctrl, changes: u32) {
    ...
    let mut idx: c_uint = i * ctrl.elem_size;
...
//
    ...
    {
    unsigned int i;
    let mut tot_elems: u32 = ctrl.elems;
    let mut elems: u32 = tot_elems - from_idx;
    s64 value;
    switch (which) {
    ...
    let mut offset: c_uint = i * ctrl.elem_size;
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_ctrl_type_op_log(ctrl: *const v4l2_ctrl) {
    void v4l2_ctrl_type_op_log(const struct v4l2_ctrl *ctrl)
    {
    let mut ptr: union v4l2_ctrl_ptr = ctrl.p_cur;
    if (ctrl.is_array) {
    unsigned i;
...
#[no_mangle]
unsafe extern "C" fn validate_av1_quantization(q: *mut v4l2_av1_quantization) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_av1_segmentation(s: *mut v4l2_av1_segmentation) -> c_int {
    ...
    let mut limit: i32 = segmentation_feature_max[j];
...
#[no_mangle]
unsafe extern "C" fn validate_av1_loop_filter(lf: *mut v4l2_av1_loop_filter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_av1_cdef(cdef: *mut v4l2_av1_cdef) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_av1_loop_restauration(lr: *mut v4l2_av1_loop_restoration) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_av1_film_grain(fg: *mut v4l2_ctrl_av1_film_grain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_av1_frame(f: *mut v4l2_ctrl_av1_frame) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn validate_av1_sequence(s: *mut v4l2_ctrl_av1_sequence) -> c_int {
    static int validate_av1_sequence(struct v4l2_ctrl_av1_sequence *s)
    {
    let mut mono: bool = s.flags & V4L2_AV1_SEQUENCE_FLAG_MONO_CHROME;
    let mut sx: bool = s.flags & V4L2_AV1_SEQUENCE_FLAG_SUBSAMPLING_X;
    let mut sy: bool = s.flags & V4L2_AV1_SEQUENCE_FLAG_SUBSAMPLING_Y;
    let mut uv_dq: bool = s.flags & V4L2_AV1_SEQUENCE_FLAG_SEPARATE_UV_DELTA_Q;
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_ctrl_notify(ctrl: *mut v4l2_ctrl, notify: v4l2_ctrl_notify_fnc, priv: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn new_to_cur(fh: *mut v4l2_fh, ctrl: *mut v4l2_ctrl, ch_flags: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn cur_to_new(ctrl: *mut v4l2_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn req_alloc_array(ref: *mut v4l2_ctrl_ref, elems: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn new_to_req(ref: *mut v4l2_ctrl_ref) {
...
#[no_mangle]
pub unsafe extern "C" fn cur_to_req(ref: *mut v4l2_ctrl_ref) {
...
#[no_mangle]
pub unsafe extern "C" fn req_to_new(ref: *mut v4l2_ctrl_ref) -> c_int {
...
//
    ...
    let mut sz: c_uint = ref.p_req_elems * ctrl.elem_size;
...
#[no_mangle]
pub unsafe extern "C" fn handler_set_err(hdl: *mut v4l2_ctrl_handler, err: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_ctrl_handler_free(hdl: *mut v4l2_ctrl_handler) -> c_int {
...
// Free all controls owned by the handler
    ...
    kvfree(hdl.buckets);
    hdl.buckets = core::ptr::null_mut();
    hdl.cached = core::ptr::null_mut();
...
// Not in cache, search the hash
    ref = hdl.buckets ? hdl.buckets[bucket] : core::ptr::null_mut();
...
// Find a control with the given ID. Take the handler's lock first.
    ...
    {
    struct v4l2_ctrl_ref *ref = core::ptr::null_mut();
    if (hdl) {
    mutex_lock(hdl.lock);
    ref = find_ref(hdl, id);
    mutex_unlock(hdl.lock);
...
// Find a control with the given ID.
    ...
    return ref ? ref.ctrl : core::ptr::null_mut();
    }
...
// Allocate a new v4l2_ctrl_ref and hook it into the handler.
    ...
    let mut id: u32 = ctrl.id;
    let mut class_ctrl: u32 = V4L2_CTRL_ID2WHICH(id) | 1;
    int bucket = id % hdl.nr_of_buckets;	/* which bucket to use */
    let mut size_extra_req: c_uint = 0;
    if (ctrl_ref)
// ctrl_ref = NULL;
//
...
//
    ...
    id != class_ctrl && find_ref_lock(hdl, class_ctrl) == core::ptr::null_mut())
    if (!v4l2_ctrl_new_std(hdl, core::ptr::null_mut(), class_ctrl, 0, 0, 0, 0))
    return hdl.error;
    if (hdl.error)
    return hdl.error;
...
// Add a new control
    ...
    struct v4l2_ctrl *ctrl;
    unsigned sz_extra;
    let mut nr_of_dims: unsigned = 0;
    let mut elems: unsigned = 1;
    bool is_array;
...
// Sanity checks
    if (id == 0 || name == core::ptr::null_mut() || !elem_size ||
    id >= V4L2_CID_PRIVATE_BASE ||
    (type == V4L2_CTRL_TYPE_MENU && qmenu == core::ptr::null_mut()) ||
    (type == V4L2_CTRL_TYPE_INTEGER_MENU && qmenu_int == core::ptr::null_mut())) {
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_CTRL_TYPE_CTRL_CLASS: type ==) -> else {
    ...
    ctrl.qmenu = qmenu;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_CTRL_TYPE_INTEGER_MENU: type ==) -> else {
    ...
    cur_to_new(ctrl);
    if (handler_new_ref(hdl, ctrl, core::ptr::null_mut(), false, false)) {
    kvfree(ctrl.p_array);
    kvfree(ctrl);
    return core::ptr::null_mut();
    }
    ...
    let mut type: enum v4l2_ctrl_type = cfg.type;
    let mut flags: u32 = cfg.flags;
    let mut min: i64 = cfg.min;
    let mut max: i64 = cfg.max;
    let mut step: u64 = cfg.step;
    let mut def: i64 = cfg.def;
...
// Helper function for standard non-menu controls
    ...
    return v4l2_ctrl_new(hdl, ops, core::ptr::null_mut(), id, name, type,
    min, max, step, def, core::ptr::null_mut(), 0,
    flags, core::ptr::null_mut(), core::ptr::null_mut(), ptr_null, ptr_null,
    ptr_null, core::ptr::null_mut());
    }
...
// Helper function for standard menu controls
    ...
    {
    const char * const *qmenu = core::ptr::null_mut();
    const s64 *qmenu_int = core::ptr::null_mut();
    let mut qmenu_int_len: c_uint = 0;
    const char *name;
    enum v4l2_ctrl_type type;
    s64 min;
    let mut max: i64 = _max;
    let mut def: i64 = _def;
    u64 step;
    u32 flags;
    v4l2_ctrl_fill(id, &name, &type, &min, &max, &step, &def, &flags);
    if (type == V4L2_CTRL_TYPE_MENU)
...
pub unsafe extern "C" fn if(V4L2_CTRL_TYPE_INTEGER_MENU: type ==) -> else {
    ...
    return v4l2_ctrl_new(hdl, ops, core::ptr::null_mut(), id, name, type,
    0, max, mask, def, core::ptr::null_mut(), 0,
...
//
    ...
    v4l2_ctrl_fill(id, &name, &type, &min, &max, &step, &def, &flags);
    if (type != V4L2_CTRL_TYPE_MENU || qmenu == core::ptr::null_mut()) {
    handler_set_err(hdl, -EINVAL);
    return core::ptr::null_mut();
    }
    return v4l2_ctrl_new(hdl, ops, core::ptr::null_mut(), id, name, type,
    0, max, mask, def, core::ptr::null_mut(), 0,
    flags, qmenu, core::ptr::null_mut(), ptr_null, ptr_null,
    ptr_null, core::ptr::null_mut());
    }
...
// Helper function for standard compound controls
    ...
    return v4l2_ctrl_new(hdl, ops, core::ptr::null_mut(), id, name, type,
    min, max, step, def, core::ptr::null_mut(), 0,
    flags, core::ptr::null_mut(), core::ptr::null_mut(), p_def, p_min, p_max, core::ptr::null_mut());
    }
...
// Helper function for standard integer menu controls
    ...
    return v4l2_ctrl_new(hdl, ops, core::ptr::null_mut(), id, name, type,
    0, max, 0, def, core::ptr::null_mut(), 0,
    flags, core::ptr::null_mut(), qmenu_int, ptr_null, ptr_null,
    ptr_null, core::ptr::null_mut());
    }
...
// Filter any unwanted controls
    ...
    continue;
    ret = handler_new_ref(hdl, ctrl, core::ptr::null_mut(), from_other_dev, false);
    if (ret)
    break;
    }
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_ctrl_radio_filter(ctrl: *const v4l2_ctrl) -> bool {
...
// Cluster controls
#[no_mangle]
pub unsafe extern "C" fn v4l2_ctrl_cluster(ncontrols: unsigned, controls: *mut v4l2_ctrl) {
    void v4l2_ctrl_cluster(unsigned ncontrols, struct v4l2_ctrl **controls)
    {
    let mut has_volatiles: bool = false;
    int i;
// The first control is the master control and it must not be NULL
    if (WARN_ON(ncontrols == 0 || controls[0] == core::ptr::null_mut()))
    return;
...
//
#[no_mangle]
pub unsafe extern "C" fn update_from_auto_cluster(master: *mut v4l2_ctrl) {
...
//
#[no_mangle]
unsafe extern "C" fn cluster_changed(master: *mut v4l2_ctrl) -> c_int {
    ...
    let mut ctrl_changed: bool = false;
    if (!ctrl)
    continue;
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_ctrl_activate(ctrl: *mut v4l2_ctrl, active: bool) {
    void v4l2_ctrl_activate(struct v4l2_ctrl *ctrl, bool active)
    {
// invert since the actual flag is called 'inactive'
    let mut inactive: bool = !active;
    bool old;
    if (ctrl == core::ptr::null_mut())
    return;
    if (inactive)
...
// clear V4L2_CTRL_FLAG_INACTIVE
    ...
    if (old != inactive)
    send_event(core::ptr::null_mut(), ctrl, V4L2_EVENT_CTRL_CH_FLAGS);
    }
    EXPORT_SYMBOL(v4l2_ctrl_activate);
#[no_mangle]
pub unsafe extern "C" fn __v4l2_ctrl_grab(ctrl: *mut v4l2_ctrl, grabbed: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn __v4l2_ctrl_handler_setup(hdl: *mut v4l2_ctrl_handler) -> c_int {
    int __v4l2_ctrl_handler_setup(struct v4l2_ctrl_handler *hdl)
    {
    struct v4l2_ctrl *ctrl;
    let mut ret: c_int = 0;
    if (hdl == core::ptr::null_mut())
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_ctrl_handler_setup(hdl: *mut v4l2_ctrl_handler) -> c_int {
