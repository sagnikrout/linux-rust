...
//! Source: drivers/media/v4l2-core/v4l2-fwnode.c
#![no_std]
...
//
    ...
    let mut flags: c_uint = 0, lanes_used = 0;
    u32 array[1 + V4L2_MBUS_CSI2_MAX_DATA_LANES];
    let mut clock_lane: u32 = 0;
    let mut num_data_lanes: c_uint = 0;
    let mut use_default_lane_mapping: bool = false;
    unsigned int i;
    u32 v;
    int rval;
...
// Only D-PHY has a clock lane.
    ...
    struct v4l2_fwnode_endpoint *vep)
    {
    let mut bus_type: u32 = V4L2_FWNODE_BUS_TYPE_GUESS;
    enum v4l2_mbus_type mbus_type;
    int rval;
//
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_fwnode_endpoint_free(vep: *mut v4l2_fwnode_endpoint) {
    void v4l2_fwnode_endpoint_free(struct v4l2_fwnode_endpoint *vep)
    {
    if (IS_ERR_OR_NULL(vep))
    return;
    kfree(vep.link_frequencies);
    vep.link_frequencies = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_fwnode_put_link(link: *mut v4l2_fwnode_link) {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_fwnode_connector_free(connector: *mut v4l2_fwnode_connector) {
    ...
    connector.label = core::ptr::null_mut();
...
// The connector-type is stored within the compatible string.
    ...
    connector.label = err ? core::ptr::null_mut() : kstrdup_const(label, GFP_KERNEL);
...
//
    ...
    core::ptr::null_mut(), 0, index, &args));
    index++) {
...
//
    ret = fwnode_property_get_reference_args(fwnode, prop, core::ptr::null_mut(), nprops,
    index, &fwnode_args);
    if (ret)
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v4l2_fwnode_int_props {
    pub name: *const c_char,
    pub props: *const *const c_char,
    pub nprops: c_uint,
}
...
//
    ...
    let mut nprops: c_uint = p.nprops;
    index = 0;
    do {
...
#[no_mangle]
pub unsafe extern "C" fn __v4l2_async_register_subdev_sensor(sd: *mut v4l2_subdev, module: *mut module) -> c_int {
