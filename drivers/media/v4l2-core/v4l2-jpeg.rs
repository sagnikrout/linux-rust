...
//! Source: drivers/media/v4l2-core/v4l2-jpeg.c
#![no_std]
...
pub const SOF0: c_uint = 0xffc0	/* start of frame */;
pub const SOF1: c_uint = 0xffc1;
pub const SOF2: c_uint = 0xffc2;
pub const SOF3: c_uint = 0xffc3;
pub const SOF5: c_uint = 0xffc5;
pub const SOF7: c_uint = 0xffc7;
pub const JPG: c_uint = 0xffc8	/* extensions */;
pub const SOF9: c_uint = 0xffc9;
pub const SOF11: c_uint = 0xffcb;
pub const SOF13: c_uint = 0xffcd;
pub const SOF15: c_uint = 0xffcf;
pub const DHT: c_uint = 0xffc4	/* huffman table */;
pub const DAC: c_uint = 0xffcc	/* arithmetic coding conditioning */;
pub const RST0: c_uint = 0xffd0	/* restart */;
pub const RST7: c_uint = 0xffd7;
pub const SOI: c_uint = 0xffd8	/* start of image */;
pub const EOI: c_uint = 0xffd9	/* end of image */;
pub const SOS: c_uint = 0xffda	/* start of stream */;
pub const DQT: c_uint = 0xffdb	/* quantization table */;
pub const DNL: c_uint = 0xffdc	/* number of lines */;
pub const DRI: c_uint = 0xffdd	/* restart interval */;
pub const DHP: c_uint = 0xffde	/* hierarchical progression */;
pub const EXP: c_uint = 0xffdf	/* expand reference */;
pub const APP0: c_uint = 0xffe0	/* application data */;
pub const APP14: c_uint = 0xffee	/* application data for colour encoding */;
pub const APP15: c_uint = 0xffef;
pub const JPG0: c_uint = 0xfff0	/* extensions */;
pub const JPG13: c_uint = 0xfffd;
pub const COM: c_uint = 0xfffe	/* comment */;
pub const TEM: c_uint = 0xff01	/* temporary */;
...
#[no_mangle]
unsafe extern "C" fn jpeg_get_byte(stream: *mut jpeg_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jpeg_get_word_be(stream: *mut jpeg_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jpeg_skip(stream: *mut jpeg_stream, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jpeg_next_marker(stream: *mut jpeg_stream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v4l2_jpeg_decode_subsampling(nf: u8, h_v: u8) -> c_int {
...
// no chroma subsampling for 4-component images
    ...
    {
    let mut len: c_int = jpeg_get_word_be(stream);
    if (len < 0)
    return len;
// Lf = 8 + 3 * Nf, Nf >= 1
    if (len < 8 + 3)
...
// Lq = 2 + n * 65 (for baseline DCT), n >= 1
    ...
    u8 pq, tq, *qk;
    int ret;
    let mut pq_tq: c_int = jpeg_get_byte(stream);
    if (pq_tq < 0)
    return pq_tq;
...
// Table B.5 - Huffman table specification parameter sizes and values
    ...
    u8 tc, th, *table;
    let mut tc_th: c_int = jpeg_get_byte(stream);
    int i, ret;
    if (tc_th < 0)
    return tc_th;
...
#[no_mangle]
unsafe extern "C" fn jpeg_skip_segment(stream: *mut jpeg_stream) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn v4l2_jpeg_parse_header(buf: *mut c_void, len: usize, out: *mut v4l2_jpeg_header) -> c_int {
