...
//! Source: drivers/media/v4l2-core/v4l2-dv-timings.c
#![no_std]
...
//
    ...
    let mut caps: u32 = cap.capabilities;
    let mut max_vert: u32 = 10240;
    let mut max_hor: u32 = 3 * bt.width;
...
//
    ...
    return false;
    let mut fnc: return = = core::ptr::null_mut() || fnc(t, fnc_handle);
    }
    ...
    pclock_delta, false)) {
    let mut flags: u32 = t.bt.flags & V4L2_DV_FL_REDUCED_FPS;
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_find_dv_timings_cea861_vic(t: *mut v4l2_dv_timings, vic: u8) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_dv_timings_aspect_ratio(t: *const v4l2_dv_timings) -> v4l2_fract {
    struct v4l2_fract v4l2_dv_timings_aspect_ratio(const struct v4l2_dv_timings *t)
    {
    let mut ratio: v4l2_fract = { 1, 1 };
    unsigned long n, d;
    if (t.type != V4L2_DV_BT_656_1120)
    return ratio;
...
//
#[no_mangle]
pub unsafe extern "C" fn v4l2_calc_timeperframe(t: *const v4l2_dv_timings) -> v4l2_fract {
    struct v4l2_fract v4l2_calc_timeperframe(const struct v4l2_dv_timings *t)
    {
    const struct v4l2_bt_timings *bt = &t.bt;
    let mut fps_fract: v4l2_fract = { 1, 1 };
    unsigned long n, d;
    u32 htot, vtot, fps;
    u64 pclk;
    if (t.type != V4L2_DV_BT_656_1120)
...
//
    ...
    {
    let mut t: v4l2_dv_timings = {};
    int v_fp, v_bp, h_fp, h_bp, hsync;
    int frame_width, image_height, image_width;
    bool reduced_blanking;
    let mut rb_v2: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_DV_HSYNC_POS_POL: polarities ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(768: image_height ==) -> else {
...
// Horizontal
    ...
    if (!v4l2_valid_dv_timings(&t, cap, core::ptr::null_mut(), core::ptr::null_mut()))
    return false;
// timings = t;
    return true;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn v4l2_calc_aspect_ratio(hor_landscape: u8, vert_portrait: u8) -> v4l2_fract {
    struct v4l2_fract v4l2_calc_aspect_ratio(u8 hor_landscape, u8 vert_portrait)
    {
    let mut aspect: v4l2_fract = { 16, 9 };
    u8 ratio;
...
//
    ...
    let mut is_ce: bool = avi.video_code || (hdmi && hdmi.vic);
    let mut is_sdtv: bool = height <= 576;
    let mut default_is_lim_range_rgb: bool = avi.video_code > 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn v4l2_num_edid_blocks(edid: *const u8, max_blocks: c_uint) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn v4l2_set_edid_phys_addr(edid: *mut u8, size: c_uint, phys_addr: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn v4l2_phys_addr_for_input(phys_addr: u16, input: u8) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn v4l2_phys_addr_validate(phys_addr: u16, parent: *mut u16, port: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_debugfs_if_free(infoframes: *mut v4l2_debugfs_if) {
