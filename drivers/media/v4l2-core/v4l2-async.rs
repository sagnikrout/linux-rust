...
//! Source: drivers/media/v4l2-core/v4l2-async.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn v4l2_async_nf_call_complete(n: *mut v4l2_async_notifier) -> c_int {
    ...
    let mut matched: bool = ase.endpoint == match.fwnode;
    dev_dbg(sd.dev,
...
// Unbind all sub-devices in the notifier tree.
    ...
    notifier.parent = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn __v4l2_async_nf_register(notifier: *mut v4l2_async_notifier) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_async_nf_register(notifier: *mut v4l2_async_notifier) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_async_nf_unregister(notifier: *mut v4l2_async_notifier) {
...
#[no_mangle]
unsafe extern "C" fn __v4l2_async_nf_cleanup(notifier: *mut v4l2_async_notifier) {
    ...
    notifier.sd = core::ptr::null_mut();
    notifier.v4l2_dev = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn v4l2_async_nf_cleanup(notifier: *mut v4l2_async_notifier) {
...
#[no_mangle]
pub unsafe extern "C" fn __v4l2_async_register_subdev(sd: *mut v4l2_subdev, module: *mut module) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_async_unregister_subdev(sd: *mut v4l2_subdev) {
    ...
    sd.subdev_notifier = core::ptr::null_mut();
    if (sd.asc_list.next) {
    if (list_empty(&sd.asc_list)) {
//
...
//
    ...
    sd.async_list.next = core::ptr::null_mut();
    mutex_unlock(&list_lock);
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: notifier->sd) -> else {
    else if (notifier.sd)
...
#[no_mangle]
unsafe extern "C" fn pending_subdevs_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v4l2_async_init() -> int __init {
    static int __init v4l2_async_init(void)
    {
    v4l2_async_debugfs_dir = debugfs_create_dir("v4l2-async", core::ptr::null_mut());
    debugfs_create_file("pending_async_subdevices", 0444,
    v4l2_async_debugfs_dir, core::ptr::null_mut(),
    &pending_subdevs_fops);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn v4l2_async_exit() -> void __exit {
