...
//! Source: drivers/media/v4l2-core/v4l2-dev.c
#![no_std]
...
pub const VIDEO_NUM_DEVICES: c_int = 256;
...
// Any types not assigned to fixed minor ranges must be mapped to
    ...
    let mut idx: c_int = (vfl_type > VFL_TYPE_RADIO) ? VFL_TYPE_MAX - 1 : vfl_type;
...
#[no_mangle]
pub unsafe extern "C" fn devnode_set(vdev: *mut video_device) {
...
#[no_mangle]
pub unsafe extern "C" fn devnode_clear(vdev: *mut video_device) {
...
#[no_mangle]
pub unsafe extern "C" fn devnode_find(vdev: *mut video_device, from: c_int, to: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn video_device_release(vdev: *mut video_device) {
...
#[no_mangle]
pub unsafe extern "C" fn video_device_release_empty(vdev: *mut video_device) {
...
#[no_mangle]
pub unsafe extern "C" fn video_get(vdev: *mut video_device) {
    static inline void video_get(struct video_device *vdev)
    {
    get_device(&vdev.dev);
    }
#[no_mangle]
pub unsafe extern "C" fn video_put(vdev: *mut video_device) {
...
#[no_mangle]
unsafe extern "C" fn v4l2_device_release(cd: *mut device) {
...
// Free up this device for reuse
    video_devices[vdev.minor] = core::ptr::null_mut();
// Delete the cdev on this minor as well
    cdev_del(vdev.cdev);
// Just in case some driver tries to access this from
    the release() callback. */
    vdev.cdev = core::ptr::null_mut();
...
//
    if (v4l2_dev.release == core::ptr::null_mut())
    v4l2_dev = core::ptr::null_mut();
...
// Priority handling
#[no_mangle]
pub unsafe extern "C" fn prio_is_valid(prio: enum v4l2_priority) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_prio_init(global: *mut v4l2_prio_state) {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_prio_open(global: *mut v4l2_prio_state, local: *mut enum v4l2_priority) {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_prio_close(global: *mut v4l2_prio_state, local: enum v4l2_priority) {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_prio_max(global: *mut v4l2_prio_state) -> enum v4l2_priority {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_prio_check(global: *mut v4l2_prio_state, local: enum v4l2_priority) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v4l2_poll(filp: *mut file, poll: *mut poll_table_struct) -> __poll_t {
    static __poll_t v4l2_poll(struct file *filp, struct poll_table_struct *poll)
    {
    struct video_device *vdev = video_devdata(filp);
    let mut res: __poll_t = EPOLLERR | EPOLLHUP | EPOLLPRI;
    if (video_is_registered(vdev)) {
    if (!vdev.fops.poll)
...
#[no_mangle]
unsafe extern "C" fn v4l2_ioctl(filp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn v4l2_mmap(filp: *mut file, vm: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v4l2_open(inode: *mut inode, filp: *mut file) -> c_int {
...
// return ENODEV if the video device has already been removed.
    if (vdev == core::ptr::null_mut() || !video_is_registered(vdev)) {
    mutex_unlock(&videodev_lock);
    return -ENODEV;
    }
...
#[no_mangle]
unsafe extern "C" fn v4l2_release(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_index(vdev: *mut video_device) -> c_int {
...
// This can be static since this function is called with the global
    ...
    if (video_devices[i] != core::ptr::null_mut() &&
...
//
#[no_mangle]
unsafe extern "C" fn determine_valid_ioctls(vdev: *mut video_device) {
    ...
    let mut is_vbi: bool = vdev.vfl_type == VFL_TYPE_VBI;
    let mut is_radio: bool = vdev.vfl_type == VFL_TYPE_RADIO;
    let mut is_sdr: bool = vdev.vfl_type == VFL_TYPE_SDR;
    let mut is_tch: bool = vdev.vfl_type == VFL_TYPE_TOUCH;
    bool is_meta = vdev.vfl_type == VFL_TYPE_VIDEO &&
    (vdev.device_caps & meta_caps);
    let mut is_rx: bool = vdev.vfl_dir != VFL_DIR_TX;
    let mut is_tx: bool = vdev.vfl_dir != VFL_DIR_RX;
    let mut is_io_mc: bool = vdev.device_caps & V4L2_CAP_IO_MC;
    let mut has_streaming: bool = vdev.device_caps & V4L2_CAP_STREAMING;
    let mut is_edid: bool = vdev.device_caps & V4L2_CAP_EDID;
...
#[no_mangle]
unsafe extern "C" fn video_register_media_controller(vdev: *mut video_device) -> c_int {
...
// FIXME: how to create the other interface links?
    ...
    let mut i: c_int = 0;
    int ret;
    let mut minor_offset: c_int = 0;
    let mut minor_cnt: c_int = VIDEO_NUM_DEVICES;
...
// Use device name 'swradio' because 'sdr' was already taken.
    ...
    vdev.vfl_type = type;
    vdev.cdev = core::ptr::null_mut();
    if (vdev.dev_parent == core::ptr::null_mut())
    vdev.dev_parent = vdev.v4l2_dev.dev;
    if (vdev.ctrl_handler == core::ptr::null_mut())
    vdev.ctrl_handler = vdev.v4l2_dev.ctrl_handler;
// If the prio state pointer is NULL, then use the v4l2_device
    prio state. */
    if (vdev.prio == core::ptr::null_mut())
...
// Part 3: Initialize the character device
    ...
    if (vdev.cdev == core::ptr::null_mut()) {
    ret = -ENOMEM;
    goto cleanup;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn video_unregister_device(vdev: *mut video_device) {
...
//
    ...
    v4l2_debugfs_root_dir = debugfs_create_dir("v4l2", core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn video_device_pipeline_stop(vdev: *mut video_device) {
...
#[no_mangle]
pub unsafe extern "C" fn __video_device_pipeline_stop(vdev: *mut video_device) {
...
#[no_mangle]
pub unsafe extern "C" fn video_device_pipeline_alloc_start(vdev: *mut video_device) -> __must_check int {
...
//
#[no_mangle]
unsafe extern "C" fn videodev_init() -> int __init {
    static int __init videodev_init(void)
    {
    let mut dev: dev_t = MKDEV(VIDEO_MAJOR, 0);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn videodev_exit() -> void __exit {
    ...
    v4l2_debugfs_root_dir = core::ptr::null_mut();
    }
