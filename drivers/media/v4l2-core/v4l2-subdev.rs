...
//! Source: drivers/media/v4l2-core/v4l2-subdev.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v4l2_subdev_stream_config {
    pub pad: u32,
    pub stream: u32,
    pub enabled: bool,
...
// not restricted.
//
pub const V4L2_SUBDEV_MAX_STREAM_ID: c_int = 63;

#[no_mangle]
unsafe extern "C" fn subdev_fh_init(fh: *mut v4l2_subdev_fh, sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn subdev_fh_free(fh: *mut v4l2_subdev_fh) {
    static void subdev_fh_free(struct v4l2_subdev_fh *fh)
    {
    __v4l2_subdev_state_free(fh.state);
    fh.state = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn subdev_open(file: *mut file) -> c_int {
    ...
    if (subdev_fh == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn subdev_close(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn v4l2_subdev_enable_privacy_led(sd: *mut v4l2_subdev) {
...
#[no_mangle]
unsafe extern "C" fn v4l2_subdev_disable_privacy_led(sd: *mut v4l2_subdev) {
...
#[no_mangle]
pub unsafe extern "C" fn check_which(which: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn check_pad(sd: *mut v4l2_subdev, pad: u32) -> c_int {
...
// allow pad 0 on subdevices not registered as media entities
    ...
    if (!edid)
    return -EINVAL;
    if (edid.blocks && edid.edid == core::ptr::null_mut())
    return -EINVAL;
    return check_pad(sd, edid.pad);
    }
#[no_mangle]
unsafe extern "C" fn call_get_edid(sd: *mut v4l2_subdev, edid: *mut v4l2_subdev_edid) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn call_set_edid(sd: *mut v4l2_subdev, edid: *mut v4l2_subdev_edid) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn call_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
//
    ...
    let mut copy_routes: u32 = min(routing.len_routes, state.routing.num_routes);
    ...
    struct v4l2_fh *vfh = file_to_v4l2_fh(file);
    struct v4l2_subdev_fh *subdev_fh = to_v4l2_subdev_fh(vfh);
    let mut ro_subdev: bool = test_bit(V4L2_FL_SUBDEV_RO_DEVNODE, &vdev.flags);
    let mut streams_subdev: bool = sd.flags & V4L2_SUBDEV_FL_STREAMS;
...
//
    ...
    struct v4l2_subdev_route *routes =
    (struct v4l2_subdev_route *)(uintptr_t)routing.routes;
    let mut krouting: v4l2_subdev_krouting = {};
    let mut num_active_routes: c_uint = 0;
    unsigned int i;
    if (!v4l2_subdev_enable_streams_api)
    return -ENOIOCTLCMD;
    if (!(sd.flags & V4L2_SUBDEV_FL_STREAMS))
...
#[no_mangle]
unsafe extern "C" fn subdev_do_ioctl_lock(file: *mut file, cmd: c_uint, arg: *mut c_void) -> c_long {
    static long subdev_do_ioctl_lock(struct file *file, unsigned int cmd, void *arg)
    {
    struct video_device *vdev = video_devdata(file);
    struct mutex *lock = vdev.lock;
    let mut ret: c_long = -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn subdev_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn v4l2_subdev_link_validate_locked(link: *mut media_link, states_locked: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_subdev_link_validate(link: *mut media_link) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __v4l2_subdev_state_free(state: *mut v4l2_subdev_state) {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_subdev_cleanup(sd: *mut v4l2_subdev) {
    void v4l2_subdev_cleanup(struct v4l2_subdev *sd)
    {
    struct v4l2_async_subdev_endpoint *ase, *ase_tmp;
    __v4l2_subdev_state_free(sd.active_state);
    sd.active_state = core::ptr::null_mut();
// Uninitialised sub-device, bail out here.
    ...
    {
    let mut new_configs: v4l2_subdev_stream_configs = { 0 };
    struct v4l2_subdev_route *route;
    u32 idx;
...
// stream_configs = new_configs;
    ...
    let mut new_routing: v4l2_subdev_krouting = { 0 };
    size_t bytes;
    int r;
...
// other_stream = route->source_stream;
    ...
    struct v4l2_subdev_route *route;
    let mut streams0: u64 = 0;
    let mut streams1: u64 = 0;
    for_each_active_route(routing, route) {
    if (route.sink_pad == pad0 && route.source_pad == pad1 &&
...
// streams = streams0;
    ...
    {
    u32 *remote_pads = core::ptr::null_mut();
    unsigned int i, j;
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_subdev_s_stream_helper(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
    int v4l2_subdev_s_stream_helper(struct v4l2_subdev *sd, int enable)
    {
    struct v4l2_subdev_state *state;
    struct v4l2_subdev_route *route;
    struct media_pad *pad;
    let mut source_mask: u64 = 0;
    let mut pad_index: c_int = -1;
...
// Iterate over sink pads
    ...
    let mut have_source_fd: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_subdev_init(sd: *mut v4l2_subdev, ops: *const v4l2_subdev_ops) {
    ...
    sd.name[0] = '\0';
    sd.grp_id = 0;
    sd.dev_priv = core::ptr::null_mut();
    sd.host_priv = core::ptr::null_mut();
    sd.privacy_led = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_subdev_is_streaming(sd: *mut v4l2_subdev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_subdev_get_privacy_led(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_subdev_put_privacy_led(sd: *mut v4l2_subdev) {
