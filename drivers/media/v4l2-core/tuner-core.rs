...
//! Source: drivers/media/v4l2-core/tuner-core.c
#![no_std]
...
// insmod options used at runtime => read/write
    ...
    module_param_array(tv_range, int, core::ptr::null_mut(), 0644);
    module_param_array(radio_range, int, core::ptr::null_mut(), 0644);
...
// keep track of the current settings
    pub std: v4l2_std_id,
    pub tv_freq: c_uint,
    pub radio_freq: c_uint,
    pub audmode: c_uint,
    pub mode: enum v4l2_tuner_type,
    pub /: *mut *mut unsigned int mode_mask; / Combination of allowable modes,
    pub /: *mut *mut bool standby; / Standby mode,
    pub /: *mut *mut unsigned int type; / chip type id,
    pub config: *mut c_void,
    pub name: *const c_char,
    pub pad: [media_pad; TUNER_NUM_PADS],
}
...
#[no_mangle]
unsafe extern "C" fn tuner_detach(fe: *mut dvb_frontend) {
...
//
    ...
    if (core::ptr::null_mut() == fe_tuner_ops.set_analog_params) {
...
#[no_mangle]
unsafe extern "C" fn fe_standby(fe: *mut dvb_frontend) {
...
#[no_mangle]
unsafe extern "C" fn fe_set_config(fe: *mut dvb_frontend, priv_cfg: *mut c_void) -> c_int {
...
//
    ...
    t.type = type;
    t.config = new_config;
    if (tuner_callback != core::ptr::null_mut()) {
    dprintk("defining GPIO callback\n");
    t.fe.callback = tuner_callback;
    }
// discard private data, in case set_type() was previously called
    tuner_detach(&t.fe);
    t.fe.analog_demod_priv = core::ptr::null_mut();
    switch (t.type) {
    case TUNER_MT2032:
...
// only when the digital dvb_attach() occurs
    ...
    if ((core::ptr::null_mut() == analog_ops.set_params) &&
...
// tv = NULL;
    ...
    if (*radio == core::ptr::null_mut() && mode_mask == T_RADIO)
// radio = pos;
// Note: currently TDA9887 is the only demod-only
    device. If other devices appear then we need to
    make this test more general. */
    else if (*tv == core::ptr::null_mut() && pos.type != TUNER_TDA9887 &&
...
//
#[no_mangle]
unsafe extern "C" fn tuner_probe(client: *mut i2c_client) -> c_int {
...
// Initializes only the first TV tuner on this adapter. Why only the
    ...
    tuner_lookup(t.i2c.adapter, &radio, &tv);
    if (tv == core::ptr::null_mut()) {
    t.mode_mask = T_ANALOG_TV;
    if (radio == core::ptr::null_mut())
    t.mode_mask |= T_RADIO;
...
//
#[no_mangle]
unsafe extern "C" fn tuner_remove(client: *mut i2c_client) {
...
//
#[no_mangle]
pub unsafe extern "C" fn check_mode(t: *mut tuner, mode: enum v4l2_tuner_type) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn set_mode(t: *mut tuner, mode: enum v4l2_tuner_type) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn set_freq(t: *mut tuner, freq: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn set_tv_freq(c: *mut i2c_client, freq: c_uint) {
    static void set_tv_freq(struct i2c_client *c, unsigned int freq)
    {
    struct tuner *t = to_tuner(i2c_get_clientdata(c));
    struct analog_demod_ops *analog_ops = &t.fe.ops.analog_ops;
...
//
#[no_mangle]
unsafe extern "C" fn tuner_fixup_std(t: *mut tuner, std: v4l2_std_id) -> v4l2_std_id {
...
//
#[no_mangle]
unsafe extern "C" fn set_radio_freq(c: *mut i2c_client, freq: c_uint) {
    static void set_radio_freq(struct i2c_client *c, unsigned int freq)
    {
    struct tuner *t = to_tuner(i2c_get_clientdata(c));
    struct analog_demod_ops *analog_ops = &t.fe.ops.analog_ops;
...
//
#[no_mangle]
unsafe extern "C" fn tuner_status(fe: *mut dvb_frontend) {
    static void tuner_status(struct dvb_frontend *fe)
    {
    struct tuner *t = fe.analog_demod_priv;
...
//
#[no_mangle]
unsafe extern "C" fn tuner_s_radio(sd: *mut v4l2_subdev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tuner_standby(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tuner_s_std(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tuner_s_frequency(sd: *mut v4l2_subdev, f: *const v4l2_frequency) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tuner_g_frequency(sd: *mut v4l2_subdev, f: *mut v4l2_frequency) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tuner_g_tuner(sd: *mut v4l2_subdev, vt: *mut v4l2_tuner) -> c_int {
    ...
    let mut signal: u16 = (u16)vt.signal;
...
//
#[no_mangle]
unsafe extern "C" fn tuner_s_tuner(sd: *mut v4l2_subdev, vt: *const v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tuner_log_status(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tuner_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(analog_ops->standby: !t->standby &&) -> else {
    else if (!t.standby && analog_ops.standby)
    analog_ops.standby(&t.fe);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tuner_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !t->standby) -> else {
    else if (!t.standby)
...
#[no_mangle]
unsafe extern "C" fn tuner_command(client: *mut i2c_client, cmd: unsigned, arg: *mut c_void) -> c_int {
