...
//! Source: drivers/media/v4l2-core/v4l2-compat-ioctl32.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v4l2_window32 {
    pub w: v4l2_rect,
    pub /: *mut *mut __u32 field; / enum v4l2_field,
    pub chromakey: __u32,
    pub /: *mut *mut compat_caddr_t clips; / always NULL,
    pub /: *mut *mut __u32 clipcount; / always 0,
    pub /: *mut *mut compat_caddr_t bitmap; / always NULL,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v4l2_create_buffers32 {
    pub index: __u32,
    pub count: __u32,
    pub /: *mut *mut __u32 memory; / enum v4l2_memory,
    pub format: v4l2_format32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v4l2_plane32 {
    pub bytesused: __u32,
    pub length: __u32,
    union {
    pub mem_offset: __u32,
    pub userptr: compat_long_t,
    pub fd: __s32,
    pub m: },
...
pub struct v4l2_buffer32 {
    ...
    pub /: *mut *mut __u32 field; / enum v4l2_field,
    struct {
    pub tv_sec: compat_s64,
    pub tv_usec: compat_s64,
    pub timestamp: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v4l2_buffer32_time32 {
    pub index: __u32,
    pub /: *mut *mut __u32 type; / enum v4l2_buf_type,
    pub bytesused: __u32,
    pub flags: __u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v4l2_framebuffer32 {
    pub capability: __u32,
    pub flags: __u32,
    pub base: compat_caddr_t,
    struct {
    pub width: __u32,
    pub height: __u32,
...
pub struct v4l2_input32 {
    ...
    pub /: *mut *mut __u32 tuner; / Associated tuner,
    pub std: compat_u64,
    pub status: __u32,
    pub capabilities: __u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v4l2_ext_controls32 {
    pub which: __u32,
    pub count: __u32,
    pub error_idx: __u32,
    pub request_fd: __s32,
    pub reserved: [__u32; 1],
    pub /: *mut *mut *mut compat_caddr_t controls; / actually struct v4l2_ext_control32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct v4l2_ext_control32 {
    pub id: __u32,
    pub size: __u32,
    ...
    pub value: __s32,
    pub value64: __s64,
    pub /: *mut *mut *mut compat_caddr_t string; / actually char,
}

    } __attribute__ ((packed));
// Return true if this control is a pointer type.
#[no_mangle]
pub unsafe extern "C" fn ctrl_is_pointer(file: *mut file, id: u32) -> bool {
    static inline bool ctrl_is_pointer(struct file *file, u32 id)
    {
    struct video_device *vdev = video_devdata(file);
    struct v4l2_fh *fh = file_to_v4l2_fh(file);
    struct v4l2_ctrl_handler *hdl = core::ptr::null_mut();
    let mut qec: v4l2_query_ext_ctrl = { id };
    const struct v4l2_ioctl_ops *ops = vdev.ioctl_ops;
    if (fh.ctrl_handler)
    hdl = fh.ctrl_handler;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: vdev->ctrl_handler) -> else {
    ...
    return false;
    return !ops.vidioc_query_ext_ctrl(file, core::ptr::null_mut(), &qec) &&
...
// p64 = (struct v4l2_ext_controls) {
    ...
    .controls	= (void  *)compat_ptr(ec32.controls),
    };
    return 0;
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v4l2_event32 {
    pub type: __u32,
    union {
    pub value64: compat_s64,
    pub data: [__u8; 64],
    pub u: },
    pub pending: __u32,
    pub sequence: __u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v4l2_event32_time32 {
    pub type: __u32,
    union {
    pub value64: compat_s64,
    pub data: [__u8; 64],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v4l2_edid32 {
    pub pad: __u32,
    pub start_block: __u32,
    pub blocks: __u32,
    pub reserved: [__u32; 5],
    pub edid: compat_caddr_t,
}
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_compat_translate_cmd(cmd: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_compat_get_user(arg: *mut void __user, parg: *mut c_void, cmd: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn v4l2_compat_put_user(arg: *mut void __user, parg: *mut c_void, cmd: c_uint) -> c_int {
    ...
    let mut num_planes: u32 = b64.length;
    if (num_planes == 0)
    return 0;
    while (num_planes--) {
    ...
    int n;
    for (n = 0; n < ecs64.count; n++) {
    let mut size: c_uint = sizeof(*ec32);
//
...
//
#[no_mangle]
pub unsafe extern "C" fn v4l2_compat_ioctl32(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: vdev->fops->compat_ioctl32) -> else {
