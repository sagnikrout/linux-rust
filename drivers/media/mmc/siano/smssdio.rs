...
//! Source: drivers/media/mmc/siano/smssdio.c
#![no_std]
...
// Registers
pub const SMSSDIO_DATA: c_uint = 0x00;
pub const SMSSDIO_INT: c_uint = 0x04;
pub const SMSSDIO_BLOCK_SIZE: c_int = 128;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct smssdio_device {
    pub func: *mut sdio_func,
    pub coredev: *mut smscore_device_t,
    pub split_cb: *mut smscore_buffer_t,
}
...
//
#[no_mangle]
unsafe extern "C" fn smssdio_sendrequest(context: *mut c_void, buffer: *mut c_void, size: usize) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smssdio_interrupt(func: *mut sdio_func) {
...
//
    ...
    if (smsdev.split_cb == core::ptr::null_mut()) {
    ...
    smsdev.split_cb = core::ptr::null_mut();
    }
    if (size) {
    void *buffer;
...
//
    ...
    ret = smscore_register_device(&params, &smsdev.coredev, GFP_DMA, core::ptr::null_mut());
    if (ret < 0)
    goto free;
...
#[no_mangle]
unsafe extern "C" fn smssdio_remove(func: *mut sdio_func) {
