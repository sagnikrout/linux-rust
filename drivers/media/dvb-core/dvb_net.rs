...
//! Source: drivers/media/dvb-core/dvb_net.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn iov_crc32(c: __u32, iov: *mut kvec, cnt: c_uint) -> __u32 {
...
pub const DVB_NET_MULTICAST_MAX: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn hexdump(buf: *const c_uchar, len: c_ushort) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dvb_net_priv {
    pub in_use: c_int,
    pub pid: u16,
    pub net: *mut net_device,
    pub host: *mut dvb_net,
    pub demux: *mut dmx_demux,
    pub secfeed: *mut dmx_section_feed,
    pub secfilter: *mut dmx_section_filter,
    pub tsfeed: *mut dmx_ts_feed,
    pub multi_num: c_int,
    pub multi_secfilter: [*mut dmx_section_filter; DVB_NET_MULTICAST_MAX],
    pub multi_macs: [c_uchar; DVB_NET_MULTICAST_MAX][6],
    pub rx_mode: c_int,
pub const RX_MODE_UNI: c_int = 0;
pub const RX_MODE_MULTI: c_int = 1;
pub const RX_MODE_ALL_MULTI: c_int = 2;
pub const RX_MODE_PROMISC: c_int = 3;
    pub set_multicast_list_wq: work_struct,
    pub restart_net_feed_wq: work_struct,
    pub /: *mut *mut unsigned char feedtype; / Either FEED_TYPE_ or FEED_TYPE_ULE,
    pub /: *mut *mut int need_pusi; / Set to 1, if synchronization on PUSI required.,
    pub /: *mut *mut unsigned char tscc; / TS continuity counter after sync on PUSI.,
    pub /: *mut *mut *mut sk_buff ule_skb; / ULE SNDU decodes into this buffer.,
    pub /: *mut *mut *mut unsigned char ule_next_hdr; / Pointer into skb to next ULE extension header.,
    pub /: *mut *mut unsigned short ule_sndu_len; / ULE SNDU length in bytes, w/o D-Bit.,
    pub /: *mut *mut unsigned short ule_sndu_type; / ULE SNDU type field, complete.,
    pub /: *mut *mut unsigned char ule_sndu_type_1; / ULE SNDU type field, if split across 2 TS cells.,
    pub present: *mut *mut unsigned char ule_dbit; / Whether the DestMAC address,
// or not (bit is set).
    pub /: *mut *mut unsigned char ule_bridged; / Whether the ULE_BRIDGED extension header was found.,
    pub /: *mut *mut int ule_sndu_remain; / Nr. of bytes still required for current ULE SNDU.,
    pub /: *mut *mut unsigned long ts_count; / Current ts cell counter.,
    pub mutex: mutex,
}
...
pub const TS_SZ: c_int = 188;
pub const TS_SYNC: c_uint = 0x47;
pub const TS_TEI: c_uint = 0x80;
pub const TS_SC: c_uint = 0xC0;
pub const TS_PUSI: c_uint = 0x40;
pub const TS_AF_A: c_uint = 0x20;
pub const TS_AF_D: c_uint = 0x10;
// ULE Extension Header handlers.
pub const ULE_TEST: c_int = 0;
pub const ULE_BRIDGED: c_int = 1;
pub const ULE_OPTEXTHDR_PADDING: c_int = 0;
#[no_mangle]
unsafe extern "C" fn ule_test_sndu(p: *mut dvb_net_priv) -> c_int {
    static int ule_test_sndu( struct dvb_net_priv *p )
    {
    return -1;
    }
#[no_mangle]
unsafe extern "C" fn ule_bridged_sndu(p: *mut dvb_net_priv) -> c_int {
    static int ule_bridged_sndu( struct dvb_net_priv *p )
    {
    struct ethhdr *hdr = (struct ethhdr*) p.ule_next_hdr;
    if(ntohs(hdr.h_proto) < ETH_P_802_3_MIN) {
    let mut framelen: c_int = p.ule_sndu_len - ((p.ule_next_hdr+sizeof(struct ethhdr)) - p.ule_skb.data);
...
#[no_mangle]
unsafe extern "C" fn ule_exthdr_padding(p: *mut dvb_net_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn handle_one_ule_extension(p: *mut dvb_net_priv) -> c_int {
    static int handle_one_ule_extension( struct dvb_net_priv *p )
    {
// Table of mandatory extension header handlers.  The header type is the index.
    static int (*ule_mandatory_ext_handlers[255])( struct dvb_net_priv *p ) =
    { [0] = ule_test_sndu, [1] = ule_bridged_sndu, [2] = core::ptr::null_mut(),  };
// Table of optional extension header handlers.  The header type is the index.
    static int (*ule_optional_ext_handlers[255])( struct dvb_net_priv *p ) =
    { [0] = ule_exthdr_padding, [1] = core::ptr::null_mut(), };
    let mut ext_len: c_int = 0;
    let mut hlen: c_uchar = (p.ule_sndu_type & 0x0700) >> 8;
    let mut htype: c_uchar = p.ule_sndu_type & 0x00FF;
...
#[no_mangle]
unsafe extern "C" fn handle_ule_extensions(p: *mut dvb_net_priv) -> c_int {
    static int handle_ule_extensions( struct dvb_net_priv *p )
    {
    let mut total_ext_len: c_int = 0, l;
...
#[no_mangle]
pub unsafe extern "C" fn reset_ule(p: *mut dvb_net_priv) {
    static inline void reset_ule( struct dvb_net_priv *p )
    {
    p.ule_skb = core::ptr::null_mut();
    p.ule_next_hdr = core::ptr::null_mut();
    p.ule_sndu_len = 0;
    p.ule_sndu_type = 0;
    p.ule_sndu_type_1 = 0;
    p.ule_sndu_remain = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dvb_net_ule_handle {
    pub dev: *mut net_device,
    pub priv: *mut dvb_net_priv,
    pub ethh: *mut ethhdr,
    pub buf: *const u8,
    pub buf_len: usize,
    pub skipped: c_ulong,
    pub from_where: *const *const *const u8 ts, ts_end,,
    pub new_ts: u8 ts_remain, how_much,,
    pub error: bool,
}

#[no_mangle]
unsafe extern "C" fn dvb_net_ule_new_ts_cell(h: *mut dvb_net_ule_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_net_ule_ts_pusi(h: *mut dvb_net_ule_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_net_ule_new_ts(h: *mut dvb_net_ule_handle) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dvb_net_ule_new_payload(h: *mut dvb_net_ule_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_net_ule_should_drop(h: *mut dvb_net_ule_handle) -> c_int {
...
// There is an extension header.  Handle it accordingly.
    let mut l: c_int = handle_ule_extensions(h.priv);
    if (l < 0) {
//
...
#[no_mangle]
unsafe extern "C" fn dvb_net_ule(dev: *mut net_device, buf: *const u8, buf_len: usize) {
    ...
    .ethh = core::ptr::null_mut(),
    .buf = buf,
    .buf_len = buf_len,
    .skipped = 0L,
    .ts = core::ptr::null_mut(),
    .ts_end = core::ptr::null_mut(),
    .from_where = core::ptr::null_mut(),
    .ts_remain = 0,
    .how_much = 0,
    .new_ts = 1,
    .error = false,
...
// Check if new payload needs to be started.
    if (h.priv.ule_skb == core::ptr::null_mut()) {
...
// Check CRC32, we've got it in our skb already.
    let mut ulen: __be16 = htons(h.priv.ule_sndu_len);
    let mut utype: __be16 = htons(h.priv.ule_sndu_type);
    const u8 *tail;
    struct kvec iov[3] = {
    { &ulen, sizeof ulen },
    { &utype, sizeof utype },
    ...
    let mut ule_crc: u32 = ~0L, expected_crc;
    if (h.priv.ule_dbit) {
...
// Next ULE SNDU starts right there.
    h.new_ts = 0;
    h.priv.ule_skb = core::ptr::null_mut();
    h.priv.ule_sndu_type_1 = 0;
    h.priv.ule_sndu_len = 0;
...
// hexdump(h.ts, 188);
    ...
    if (buffer2)
    pr_warn("buffer2 not core::ptr::null_mut(): %p.\n", buffer2);
...
#[no_mangle]
unsafe extern "C" fn dvb_net_tx(skb: *mut sk_buff, dev: *mut net_device) -> netdev_tx_t {
...
#[no_mangle]
unsafe extern "C" fn dvb_net_feed_start(dev: *mut net_device) -> c_int {
    ...
    pr_err("%s: BUG %d\n", __func__, __LINE__);
    priv.secfeed=core::ptr::null_mut();
    priv.secfilter=core::ptr::null_mut();
    priv.tsfeed = core::ptr::null_mut();
    ...
    let mut timeout: ktime_t = ns_to_ktime(10 * NSEC_PER_MSEC);
...
#[no_mangle]
unsafe extern "C" fn dvb_net_feed_stop(dev: *mut net_device) -> c_int {
    ...
    priv.multi_secfilter[i] = core::ptr::null_mut();
    }
    }
    priv.demux.release_section_feed(priv.demux, priv.secfeed);
    priv.secfeed = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dvb_set_mc_filter(dev: *mut net_device, addr: *mut c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wq_set_multicast_list(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn dvb_net_set_multicast_list(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn wq_restart_net_feed(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn dvb_net_set_mac(dev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_net_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_net_stop(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_net_setup(dev: *mut net_device) {
...
#[no_mangle]
unsafe extern "C" fn get_if(dvbnet: *mut dvb_net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_net_add_if(dvbnet: *mut dvb_net, pid: u16, feedtype: u8) -> c_int {
...
// compatibility fix to keep dvb0_0 format
    ...
    dvbnet.device[if_num] = core::ptr::null_mut();
    free_netdev(net);
    return result;
    }
...
#[no_mangle]
unsafe extern "C" fn dvb_net_remove_if(dvbnet: *mut dvb_net, num: c_ulong) -> c_int {
    ...
    dvbnet.state[num]=0;
    dvbnet.device[num] = core::ptr::null_mut();
    free_netdev(net);
    return 0;
    }
    ...
    struct dvb_net_if *dvbnetif = parg;
    let mut if_num: c_int = dvbnetif.if_num;
...
#[no_mangle]
unsafe extern "C" fn locked_dvb_net_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_net_close(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_net_release(dvbnet: *mut dvb_net) {
