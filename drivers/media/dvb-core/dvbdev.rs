...
//! Source: drivers/media/dvb-core/dvbdev.c
#![no_std]
...
pub const MAX_DVB_MINORS: c_int = 256;

pub const DVB_MAX_IDS: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn dvb_device_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_generic_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_generic_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvbdev_get_free_id(adap: *mut dvb_adapter, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_media_device_free(dvbdev: *mut dvb_device) {
    ...
    kfree(dvbdev.entity);
    kfree(dvbdev.pads);
    dvbdev.entity = core::ptr::null_mut();
    dvbdev.pads = core::ptr::null_mut();
    }
    ...
    dvbdev.tsout_entity = core::ptr::null_mut();
    dvbdev.tsout_pads = core::ptr::null_mut();
    dvbdev.tsout_num_entities = 0;
    }
    if (dvbdev.intf_devnode) {
    media_devnode_remove(dvbdev.intf_devnode);
    dvbdev.intf_devnode = core::ptr::null_mut();
    }
    if (dvbdev.adapter.conn) {
    media_device_unregister_entity(dvbdev.adapter.conn);
    kfree(dvbdev.adapter.conn);
    dvbdev.adapter.conn = core::ptr::null_mut();
    kfree(dvbdev.adapter.conn_pads);
    dvbdev.adapter.conn_pads = core::ptr::null_mut();
    }
...
//
    ...
    {
    struct dvb_device *dvbdev;
    struct file_operations *dvbdevfops = core::ptr::null_mut();
    struct dvbdevfops_node *node = core::ptr::null_mut(), *new_node = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn dvb_remove_device(dvbdev: *mut dvb_device) {
    void dvb_remove_device(struct dvb_device *dvbdev)
    {
    if (!dvbdev)
    return;
    down_write(&minor_rwsem);
    dvb_minors[dvbdev.minor] = core::ptr::null_mut();
    dvb_device_put(dvbdev);
    up_write(&minor_rwsem);
    dvb_media_device_free(dvbdev);
...
#[no_mangle]
unsafe extern "C" fn dvb_free_device(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_device_put(dvbdev: *mut dvb_device) {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_unregister_device(dvbdev: *mut dvb_device) {
    ...
    {
    struct media_device *mdev = adap.mdev;
    struct media_entity *entity, *tuner = core::ptr::null_mut(), *demod = core::ptr::null_mut(), *conn;
    struct media_entity *demux = core::ptr::null_mut(), *ca = core::ptr::null_mut();
    struct media_link *link;
    struct media_interface *intf;
    let mut demux_pad: c_uint = 0;
    let mut dvr_pad: c_uint = 0;
    let mut ntuner: c_uint = 0, ndemod = 0;
...
//
    if (ntuner > 1)
    tuner = core::ptr::null_mut();
    if (ndemod > 1)
    demod = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dvbdev_check_free_adapter_num(num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvbdev_get_free_adapter_num() -> c_int {
...
// use the one the driver asked for
    ...
    adap.device = device;
    adap.mfe_shared = 0;
    adap.mfe_dvbdev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn dvb_unregister_adapter(adap: *mut dvb_adapter) -> c_int {
...
//
    ...
    {
    char    sbuf[128] = {};
    void    *mbuf = core::ptr::null_mut();
    void    *parg = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn dvb_module_release(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn dvb_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_dvbdev() -> int __init {
    static int __init init_dvbdev(void)
    {
    int retval;
    let mut dev: dev_t = MKDEV(DVB_MAJOR, 0);
...
#[no_mangle]
unsafe extern "C" fn exit_dvbdev() -> void __exit {
