...
//! Source: drivers/media/dvb-core/dvb_vb2.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn _buffer_prepare(vb: *mut vb2_buffer) -> c_int {
    static int _buffer_prepare(struct vb2_buffer *vb)
    {
    struct dvb_vb2_ctx *ctx = vb2_get_drv_priv(vb.vb2_queue);
    let mut size: c_ulong = ctx.buf_siz;
...
#[no_mangle]
unsafe extern "C" fn _buffer_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn _start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn _fill_dmx_buffer(vb: *mut vb2_buffer, pb: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn _fill_vb2_buffer(vb: *mut vb2_buffer, planes: *mut vb2_plane) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_vb2_release(ctx: *mut dvb_vb2_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_vb2_stream_on(ctx: *mut dvb_vb2_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_vb2_stream_off(ctx: *mut dvb_vb2_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_vb2_is_streaming(ctx: *mut dvb_vb2_ctx) -> c_int {
    ...
    {
    let mut flags: c_ulong = 0;
    void *vbuf = core::ptr::null_mut();
    let mut todo: c_int = len;
...
#[no_mangle]
pub unsafe extern "C" fn dvb_vb2_reqbufs(ctx: *mut dvb_vb2_ctx, req: *mut dmx_requestbuffers) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_vb2_querybuf(ctx: *mut dvb_vb2_ctx, b: *mut dmx_buffer) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_vb2_expbuf(ctx: *mut dvb_vb2_ctx, exp: *mut dmx_exportbuffer) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_vb2_qbuf(ctx: *mut dvb_vb2_ctx, b: *mut dmx_buffer) -> c_int {
    ...
    ret = vb2_core_qbuf(&ctx.vb_q, vb2, b, core::ptr::null_mut());
    if (ret) {
    dprintk(1, "[%s] index=%d errno=%d\n", ctx.name,
    b.index, ret);
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn dvb_vb2_dqbuf(ctx: *mut dvb_vb2_ctx, b: *mut dmx_buffer) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_vb2_mmap(ctx: *mut dvb_vb2_ctx, vma: *mut vm_area_struct) -> c_int {
