...
//! Source: drivers/media/dvb-core/dvb_frontend.c
#![no_std]
...
// Macro flag: #define __DVB_CORE__

    static int dvb_frontend_debug;
    static int dvb_shutdown_timeout;
    static int dvb_force_auto_inversion;
    static int dvb_override_tune_delay;
    let mut dvb_powerdown_on_sleep: static int = 1;
    let mut dvb_mfe_wait_time: static int = 5;
...
pub const FESTATE_IDLE: c_int = 1;
pub const FESTATE_RETUNE: c_int = 2;
pub const FESTATE_TUNING_FAST: c_int = 4;
pub const FESTATE_TUNING_SLOW: c_int = 8;
pub const FESTATE_TUNED: c_int = 16;
pub const FESTATE_ZIGZAG_FAST: c_int = 32;
pub const FESTATE_ZIGZAG_SLOW: c_int = 64;
pub const FESTATE_DISEQC: c_int = 128;
pub const FESTATE_ERROR: c_int = 256;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dvb_frontend_private {
// thread/frontend values
    pub dvbdev: *mut dvb_device,
    pub parameters_out: dvb_frontend_parameters,
    pub events: dvb_fe_events,
    pub sem: semaphore,
    pub list_head: list_head,
    pub wait_queue: wait_queue_head_t,
    pub thread: *mut task_struct,
    pub release_jiffies: c_ulong,
    pub wakeup: c_uint,
    pub status: enum fe_status,
    pub tune_mode_flags: c_ulong,
    pub delay: c_uint,
    pub reinitialise: c_uint,
    pub tone: c_int,
    pub voltage: c_int,
// swzigzag values
    pub state: c_uint,
    pub bending: c_uint,
    pub lnb_drift: c_int,
    pub inversion: c_uint,
    pub auto_step: c_uint,
    pub auto_sub_step: c_uint,
    pub started_auto_step: c_uint,
    pub min_delay: c_uint,
    pub max_drift: c_uint,
    pub step_size: c_uint,
    pub quality: c_int,
    pub check_wrapped: c_uint,
    pub algo_status: enum dvbfe_search,
...
#[no_mangle]
unsafe extern "C" fn __dvb_frontend_free(fe: *mut dvb_frontend) {
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_free(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_put(fe: *mut dvb_frontend) {
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_get(fe: *mut dvb_frontend) {
...
#[no_mangle]
unsafe extern "C" fn has_get_frontend(fe: *mut dvb_frontend) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dvbv3_type(delivery_system: u32) -> enum dvbv3_emulation_type {
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_clear_events(fe: *mut dvb_frontend) {
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_init(fe: *mut dvb_frontend) {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_frontend_reinitialise(fe: *mut dvb_frontend) {
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_swzigzag_update_delay(fepriv: *mut dvb_frontend_private, locked: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn dvb_frontend_swzigzag_autotune(fe: *mut dvb_frontend, check_wrapped: c_int) -> c_int {
    static int dvb_frontend_swzigzag_autotune(struct dvb_frontend *fe, int check_wrapped)
    {
    int autoinversion;
    let mut ready: c_int = 0;
    let mut fe_set_err: c_int = 0;
    struct dvb_frontend_private *fepriv = fe.frontend_priv;
    struct dtv_frontend_properties *c = &fe.dtv_property_cache, tmp;
    let mut original_inversion: c_int = c.inversion;
    let mut original_frequency: u32 = c.frequency;
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_swzigzag(fe: *mut dvb_frontend) {
    static void dvb_frontend_swzigzag(struct dvb_frontend *fe)
    {
    let mut s: enum fe_status = FE_NONE;
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_is_exiting(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_should_wakeup(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_wakeup(fe: *mut dvb_frontend) {
    static void dvb_frontend_wakeup(struct dvb_frontend *fe)
    {
    struct dvb_frontend_private *fepriv = fe.frontend_priv;
    fepriv.wakeup = 1;
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_thread(data: *mut c_void) -> c_int {
    ...
    let mut re_tune: bool = false;
    let mut semheld: bool = false;
    dev_dbg(fe.dvb.device, "%s:\n", __func__);
    fepriv.check_wrapped = 0;
    fepriv.quality = 0;
    fepriv.delay = 3 * HZ;
...
// Track the carrier if the search was successful
    ...
    fepriv.thread = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_stop(fe: *mut dvb_frontend) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dvb_frontend_sleep_until(waketime: *mut ktime_t, add_usec: u32) {
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_start(fe: *mut dvb_frontend) -> c_int {
    ...
    {
    struct dtv_frontend_properties *c = &fe.dtv_property_cache;
    let mut tuner_min: u32 = fe.ops.tuner_ops.info.frequency_min_hz;
    let mut tuner_max: u32 = fe.ops.tuner_ops.info.frequency_max_hz;
    let mut frontend_min: u32 = fe.ops.info.frequency_min_hz;
    let mut frontend_max: u32 = fe.ops.info.frequency_max_hz;
// freq_min = max(frontend_min, tuner_min);
    if (frontend_max == 0)
// freq_max = tuner_max;
#[no_mangle]
pub unsafe extern "C" fn if(0: tuner_max ==) -> else {
    else if (tuner_max == 0)
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_get_stepsize(fe: *mut dvb_frontend) -> u32 {
    static u32 dvb_frontend_get_stepsize(struct dvb_frontend *fe)
    {
    struct dtv_frontend_properties *c = &fe.dtv_property_cache;
    let mut fe_step: u32 = fe.ops.info.frequency_stepsize_hz;
    let mut tuner_step: u32 = fe.ops.tuner_ops.info.frequency_step_hz;
    let mut step: u32 = max(fe_step, tuner_step);
    switch (c.delivery_system) {
    case SYS_DSS:
    case SYS_DVBS:
    case SYS_DVBS2:
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_check_parameters(fe: *mut dvb_frontend) -> c_int {
...
// range check: frequency
    dvb_frontend_get_frequency_limits(fe, &freq_min, &freq_max, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_clear_cache(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_dvbv3_delsys(delsys: u32) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn emulate_delivery_system(fe: *mut dvb_frontend, delsys: u32) -> c_int {
...
//
    ...
    {
    int ncaps;
    let mut delsys: u32 = SYS_UNDEFINED;
    struct dtv_frontend_properties *c = &fe.dtv_property_cache;
...
//
#[no_mangle]
unsafe extern "C" fn dvbv3_set_delivery_system(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_tuning_algo_parameters(fe: *mut dvb_frontend) {
    static void prepare_tuning_algo_parameters(struct dvb_frontend *fe)
    {
    struct dtv_frontend_properties *c = &fe.dtv_property_cache;
    struct dvb_frontend_private *fepriv = fe.frontend_priv;
    let mut fetunesettings: dvb_frontend_tune_settings = { 0 };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct compat_dtv_property {
    pub cmd: __u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct compat_dtv_properties {
    pub num: __u32,
    pub props: compat_uptr_t,
}
    ...
    struct compat_dtv_properties prop, *tvps = core::ptr::null_mut();
    struct compat_dtv_property *tvp = core::ptr::null_mut();
...
//
    ...
    struct compat_dtv_properties prop, *tvps = core::ptr::null_mut();
    struct compat_dtv_property *tvp = core::ptr::null_mut();
    let mut getp: dtv_frontend_properties = fe.dtv_property_cache;
    if (copy_from_user(&prop, compat_ptr(arg), sizeof(prop)))
    return -EFAULT;
    tvps = &prop;
//
...
//
    if (fepriv.state != FESTATE_IDLE) {
    err = dtv_get_frontend(fe, &getp, core::ptr::null_mut());
    if (err < 0) {
    kfree(tvp);
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn dtv_set_frontend(fe: *mut dvb_frontend) -> c_int {
    static int dtv_set_frontend(struct dvb_frontend *fe)
    {
    struct dvb_frontend_private *fepriv = fe.frontend_priv;
    struct dtv_frontend_properties *c = &fe.dtv_property_cache;
    let mut rolloff: u32 = 0;
...
// Request the search algorithm to search
    ...
    {
    struct dvb_frontend_private *fepriv = fe.frontend_priv;
    struct dtv_property *tvp = core::ptr::null_mut();
...
//
    let mut swcmd: c_ulong = ((unsigned long)parg) << 1;
    ktime_t nexttime;
    ktime_t tv[10];
    int i;
    let mut last: u8 = 1;
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_poll(file: *mut file, wait: *mut poll_table_struct) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn __dvb_frontend_open(inode: *mut inode, file: *mut file) -> c_int {
...
// empty event queue
    ...
    let mut mferetry: c_int = (dvb_mfe_wait_time << 1);
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_frontend_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_frontend_suspend(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: fe->ops.tuner_ops.sleep) -> else {
    else if (fe.ops.tuner_ops.sleep)
    ret = fe.ops.tuner_ops.sleep(fe);
    if (fe.ops.suspend)
    ret = fe.ops.suspend(fe);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: fe->ops.sleep) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_frontend_resume(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: fe->ops.init) -> else {
    else if (fe.ops.init)
    ret = fe.ops.init(fe);
    if (fe.ops.tuner_ops.resume)
    ret = fe.ops.tuner_ops.resume(fe);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: fe->ops.tuner_ops.init) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_unregister_frontend(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dvb_frontend_detach(fe: *mut dvb_frontend) {
