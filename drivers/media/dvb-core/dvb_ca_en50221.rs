...
//! Source: drivers/media/dvb-core/dvb_ca_en50221.c
#![no_std]
...
pub const INIT_TIMEOUT_SECS: c_int = 10;
pub const HOST_LINK_BUF_SIZE: c_uint = 0x200;
pub const RX_BUFFER_SIZE: c_int = 65535;
pub const MAX_RX_PACKETS_PER_ITERATION: c_int = 10;
pub const CTRLIF_DATA: c_int = 0;
pub const CTRLIF_COMMAND: c_int = 1;
pub const CTRLIF_STATUS: c_int = 1;
pub const CTRLIF_SIZE_LOW: c_int = 2;
pub const CTRLIF_SIZE_HIGH: c_int = 3;

pub const CMDREG_FRIE: c_uint = 0x40	/* Enable FR interrupt */;
pub const CMDREG_DAIE: c_uint = 0x80	/* Enable DA interrupt */;

pub const STATUSREG_FR: c_uint = 0x40	/* module free */;
pub const STATUSREG_DA: c_uint = 0x80	/* data available */;
pub const DVB_CA_SLOTSTATE_NONE: c_int = 0;
pub const DVB_CA_SLOTSTATE_UNINITIALISED: c_int = 1;
pub const DVB_CA_SLOTSTATE_RUNNING: c_int = 2;
pub const DVB_CA_SLOTSTATE_INVALID: c_int = 3;
pub const DVB_CA_SLOTSTATE_WAITREADY: c_int = 4;
pub const DVB_CA_SLOTSTATE_VALIDATE: c_int = 5;
pub const DVB_CA_SLOTSTATE_WAITFR: c_int = 6;
pub const DVB_CA_SLOTSTATE_LINKINIT: c_int = 7;
// Information on a CA slot
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dvb_ca_slot {
// current state of the CAM
    pub slot_state: c_int,
// mutex used for serializing access to one CI slot
    pub slot_lock: mutex,
// Number of CAMCHANGES that have occurred since last processing
    pub camchange_count: core::sync::atomic::AtomicI32,
// Type of last CAMCHANGE
    pub camchange_type: c_int,
// base address of CAM config
    pub config_base: u32,
// value to write into Config Control register
    pub config_option: u8,
// if 1, the CAM supports DA IRQs
    pub da_irq_supported:1: u8,
// size of the buffer to use when talking to the CAM
    pub link_buf_size: c_int,
// buffer for incoming packets
    pub rx_buffer: dvb_ringbuffer,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dvb_ca_private {
    pub refcount: kref,
// pointer back to the public data structure
    pub pub: *mut dvb_ca_en50221,
// the DVB device
...
#[no_mangle]
unsafe extern "C" fn dvb_ca_private_free(ca: *mut dvb_ca_private) {
...
#[no_mangle]
unsafe extern "C" fn dvb_ca_private_release(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn dvb_ca_private_get(ca: *mut dvb_ca_private) {
    static void dvb_ca_private_get(struct dvb_ca_private *ca)
    {
    kref_get(&ca.refcount);
    }
#[no_mangle]
unsafe extern "C" fn dvb_ca_private_put(ca: *mut dvb_ca_private) {
...
//
#[no_mangle]
unsafe extern "C" fn dvb_ca_en50221_check_camstatus(ca: *mut dvb_ca_private, slot: c_int) -> c_int {
...
// poll mode
    ...
    if (!cam_changed) {
    let mut cam_present_old: c_int = (sl.slot_state != DVB_CA_SLOTSTATE_NONE);
...
//
#[no_mangle]
unsafe extern "C" fn dvb_ca_en50221_link_init(ca: *mut dvb_ca_private, slot: c_int) -> c_int {
...
//
    ...
    int _tuple_type;
    int _tuple_length;
    let mut _address: c_int = *address;
...
//
#[no_mangle]
unsafe extern "C" fn dvb_ca_en50221_parse_attributes(ca: *mut dvb_ca_private, slot: c_int) -> c_int {
    static int dvb_ca_en50221_parse_attributes(struct dvb_ca_private *ca, int slot)
    {
    struct dvb_ca_slot *sl;
    let mut address: c_int = 0;
    int tuple_length;
    int tuple_type;
    u8 tuple[257];
    char *dvb_str;
    int rasz;
    int status;
    let mut got_cftableentry: c_int = 0;
    let mut end_chain: c_int = 0;
    int i;
    let mut manfid: u16 = 0;
    let mut devid: u16 = 0;
// CISTPL_DEVICE_0A
...
//
#[no_mangle]
unsafe extern "C" fn dvb_ca_en50221_set_configoption(ca: *mut dvb_ca_private, slot: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dvb_ca_en50221_slot_shutdown(ca: *mut dvb_ca_private, slot: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dvb_ca_en50221_camready_irq(pubca: *mut dvb_ca_en50221, slot: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dvb_ca_en50221_frda_irq(pubca: *mut dvb_ca_en50221, slot: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn dvb_ca_en50221_thread_wakeup(ca: *mut dvb_ca_private) {
    static void dvb_ca_en50221_thread_wakeup(struct dvb_ca_private *ca)
    {
    dprintk("%s\n", __func__);
    ca.wakeup = 1;
...
//
#[no_mangle]
unsafe extern "C" fn dvb_ca_en50221_thread_update_delay(ca: *mut dvb_ca_private) {
    static void dvb_ca_en50221_thread_update_delay(struct dvb_ca_private *ca)
    {
    int delay;
    let mut curdelay: c_int = 100000000;
    int slot;
//
...
//
#[no_mangle]
unsafe extern "C" fn dvb_ca_en50221_poll_cam_gone(ca: *mut dvb_ca_private, slot: c_int) -> c_int {
...
// poll slots for data
    pktcount = 0;
    while (dvb_ca_en50221_read_data(ca, slot, core::ptr::null_mut(), 0) > 0) {
    if (!ca.open)
    break;
//
...
//
#[no_mangle]
unsafe extern "C" fn dvb_ca_en50221_thread(data: *mut c_void) -> c_int {
...
//
    ...
    {
    int slot;
    let mut slot_count: c_int = 0;
    int idx;
    size_t fraglen;
    let mut connection_id: c_int = -1;
...
//
    ...
    let mut connection_id: c_int = -1;
    size_t idx, idx2;
    let mut last_fragment: c_int = 0;
    size_t fraglen;
    int pktlen;
    let mut dispose: c_int = 0;
    dprintk("%s\n", __func__);
//
...
//
#[no_mangle]
unsafe extern "C" fn dvb_ca_en50221_io_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dvb_ca_en50221_io_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dvb_ca_en50221_io_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
//
    ...
    {
    int ret;
    struct dvb_ca_private *ca = core::ptr::null_mut();
    int i;
    dprintk("%s\n", __func__);
    if (slot_count < 1)
    return -EINVAL;
...
// create a kthread for monitoring this CA device
    ...
    kfree(ca);
    exit:
    pubca.private = core::ptr::null_mut();
    return ret;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn dvb_ca_en50221_release(pubca: *mut dvb_ca_en50221) {
