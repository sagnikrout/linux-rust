...
//! Source: drivers/media/firewire/firedtv-avc.c
#![no_std]
...
pub const FCP_COMMAND_REGISTER: c_uint = 0xfffff0000b00ULL;
pub const AVC_CTYPE_CONTROL: c_uint = 0x0;
pub const AVC_CTYPE_STATUS: c_uint = 0x1;
pub const AVC_CTYPE_NOTIFY: c_uint = 0x3;
pub const AVC_RESPONSE_ACCEPTED: c_uint = 0x9;
pub const AVC_RESPONSE_STABLE: c_uint = 0xc;
pub const AVC_RESPONSE_CHANGED: c_uint = 0xd;
pub const AVC_RESPONSE_INTERIM: c_uint = 0xf;

pub const AVC_OPCODE_VENDOR: c_uint = 0x00;
pub const AVC_OPCODE_READ_DESCRIPTOR: c_uint = 0x09;
pub const AVC_OPCODE_DSIT: c_uint = 0xc8;
pub const AVC_OPCODE_DSD: c_uint = 0xcb;
pub const DESCRIPTOR_TUNER_STATUS: c_uint = 0x80;
pub const DESCRIPTOR_SUBUNIT_IDENTIFIER: c_uint = 0x00;
pub const SFE_VENDOR_DE_COMPANYID_0: c_uint = 0x00 /* OUI of Digital Everywhere */;
pub const SFE_VENDOR_DE_COMPANYID_1: c_uint = 0x12;
pub const SFE_VENDOR_DE_COMPANYID_2: c_uint = 0x87;
pub const SFE_VENDOR_OPCODE_REGISTER_REMOTE_CONTROL: c_uint = 0x0a;
pub const SFE_VENDOR_OPCODE_LNB_CONTROL: c_uint = 0x52;
pub const SFE_VENDOR_OPCODE_TUNE_QPSK: c_uint = 0x58 /* for DVB-S */;
pub const SFE_VENDOR_OPCODE_GET_FIRMWARE_VERSION: c_uint = 0x00;
pub const SFE_VENDOR_OPCODE_HOST2CA: c_uint = 0x56;
pub const SFE_VENDOR_OPCODE_CA2HOST: c_uint = 0x57;
pub const SFE_VENDOR_OPCODE_CISTATUS: c_uint = 0x59;
pub const SFE_VENDOR_OPCODE_TUNE_QPSK2: c_uint = 0x60 /* for DVB-S2 */;
pub const SFE_VENDOR_TAG_CA_RESET: c_uint = 0x00;
pub const SFE_VENDOR_TAG_CA_APPLICATION_INFO: c_uint = 0x01;
pub const SFE_VENDOR_TAG_CA_PMT: c_uint = 0x02;
pub const SFE_VENDOR_TAG_CA_DATE_TIME: c_uint = 0x04;
pub const SFE_VENDOR_TAG_CA_MMI: c_uint = 0x05;
pub const SFE_VENDOR_TAG_CA_ENTER_MENU: c_uint = 0x07;
pub const EN50221_LIST_MANAGEMENT_ONLY: c_uint = 0x03;
pub const EN50221_TAG_APP_INFO: c_uint = 0x9f8021;
pub const EN50221_TAG_CA_INFO: c_uint = 0x9f8031;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct avc_command_frame {
    pub ctype: u8,
    pub subunit: u8,
    pub opcode: u8,
    pub operand: [u8; 509],
...
#[no_mangle]
pub unsafe extern "C" fn clear_operands(c: *mut avc_command_frame, from: c_int, to: c_int) {
    static inline void clear_operands(struct avc_command_frame *c, int from, int to)
    {
    memset(&c.operand[from], 0, to - from + 1);
    }
#[no_mangle]
unsafe extern "C" fn pad_operands(c: *mut avc_command_frame, from: c_int) {
    static void pad_operands(struct avc_command_frame *c, int from)
    {
    let mut to: c_int = ALIGN(from, 4);
    if (from <= to && to <= LAST_OPERAND)
    clear_operands(c, from, to);
    }
pub const AVC_DEBUG_READ_DESCRIPTOR: c_uint = 0x0001;
pub const AVC_DEBUG_DSIT: c_uint = 0x0002;
pub const AVC_DEBUG_DSD: c_uint = 0x0004;
pub const AVC_DEBUG_REGISTER_REMOTE_CONTROL: c_uint = 0x0008;
pub const AVC_DEBUG_LNB_CONTROL: c_uint = 0x0010;
pub const AVC_DEBUG_TUNE_QPSK: c_uint = 0x0020;
pub const AVC_DEBUG_TUNE_QPSK2: c_uint = 0x0040;
pub const AVC_DEBUG_HOST2CA: c_uint = 0x0080;
pub const AVC_DEBUG_CA2HOST: c_uint = 0x0100;
pub const AVC_DEBUG_APPLICATION_PMT: c_uint = 0x4000;
pub const AVC_DEBUG_FCP_PAYLOADS: c_uint = 0x8000;
...
//
    ...
    const char *ret = ctype < ARRAY_SIZE(ctypes) ? ctypes[ctype] : core::ptr::null_mut();
    return ret ? ret : "?";
    }
    ...
    "ReadDescriptor" : core::ptr::null_mut();
    case AVC_OPCODE_DSIT:
    return avc_debug & AVC_DEBUG_DSIT ?
    "DirectSelectInfo.Type" : core::ptr::null_mut();
    case AVC_OPCODE_DSD:
    return avc_debug & AVC_DEBUG_DSD ? "DirectSelectData" : core::ptr::null_mut();
    default:
    return "Unknown";
    }
    if (length < 7 ||
    ...
    "RegisterRC" : core::ptr::null_mut();
    case SFE_VENDOR_OPCODE_LNB_CONTROL:
    return avc_debug & AVC_DEBUG_LNB_CONTROL ? "LNBControl" : core::ptr::null_mut();
    case SFE_VENDOR_OPCODE_TUNE_QPSK:
    return avc_debug & AVC_DEBUG_TUNE_QPSK ? "TuneQPSK" : core::ptr::null_mut();
    case SFE_VENDOR_OPCODE_TUNE_QPSK2:
    return avc_debug & AVC_DEBUG_TUNE_QPSK2 ? "TuneQPSK2" : core::ptr::null_mut();
    case SFE_VENDOR_OPCODE_HOST2CA:
    return avc_debug & AVC_DEBUG_HOST2CA ? "Host2CA" : core::ptr::null_mut();
    case SFE_VENDOR_OPCODE_CA2HOST:
    return avc_debug & AVC_DEBUG_CA2HOST ? "CA2Host" : core::ptr::null_mut();
    }
    return "Vendor/Unknown";
    }
#[no_mangle]
unsafe extern "C" fn debug_fcp(data: *const u8, length: c_int) {
...
#[no_mangle]
unsafe extern "C" fn debug_pmt(msg: *mut c_char, length: c_int) {
...
#[no_mangle]
unsafe extern "C" fn avc_write(fdtv: *mut firedtv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_register_rc(r: *mut avc_response_frame) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn avc_recv(fdtv: *mut firedtv, data: *mut c_void, length: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_pid_filter(fdtv: *mut firedtv, operand: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avc_tuner_set_pids(fdtv: *mut firedtv, pidc: c_uchar, pid[]: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avc_tuner_get_ts(fdtv: *mut firedtv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avc_identify_subunit(fdtv: *mut firedtv) -> c_int {
...
pub const SIZEOF_ANTENNA_INPUT_INFO: c_int = 22;
#[no_mangle]
pub unsafe extern "C" fn avc_tuner_status(fdtv: *mut firedtv, stat: *mut firedtv_tuner_status) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avc_register_remote_control(fdtv: *mut firedtv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avc_remote_ctrl_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn avc_tuner_host2ca(fdtv: *mut firedtv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_ca_object_pos(r: *mut avc_response_frame) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_ca_object_length(r: *mut avc_response_frame) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avc_ca_reset(fdtv: *mut firedtv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avc_ca_pmt(fdtv: *mut firedtv, msg: *mut c_char, length: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avc_ca_get_time_date(fdtv: *mut firedtv, interval: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avc_ca_enter_menu(fdtv: *mut firedtv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avc_ca_get_mmi(fdtv: *mut firedtv, mmi_object: *mut c_char, len: *mut c_uint) -> c_int {
...
pub const CMP_OUTPUT_PLUG_CONTROL_REG_0: c_uint = 0xfffff0000904ULL;
#[no_mangle]
unsafe extern "C" fn cmp_read(fdtv: *mut firedtv, addr: u64, data: *mut __be32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmp_lock(fdtv: *mut firedtv, addr: u64, data[]: __be32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_opcr(opcr: __be32, mask: u32, shift: u32) -> u32 {
    static inline u32 get_opcr(__be32 opcr, u32 mask, u32 shift)
    {
    return (be32_to_cpu(opcr) >> shift) & mask;
    }
#[no_mangle]
pub unsafe extern "C" fn set_opcr(opcr: *mut __be32, value: u32, mask: u32, shift: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn cmp_establish_pp_connection(fdtv: *mut firedtv, plug: c_int, channel: c_int) -> c_int {
    int cmp_establish_pp_connection(struct firedtv *fdtv, int plug, int channel)
    {
    __be32 old_opcr, opcr[2];
    let mut opcr_address: u64 = CMP_OUTPUT_PLUG_CONTROL_REG_0 + (plug << 2);
...
#[no_mangle]
pub unsafe extern "C" fn cmp_break_pp_connection(fdtv: *mut firedtv, plug: c_int, channel: c_int) {
