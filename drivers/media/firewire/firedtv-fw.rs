...
//! Source: drivers/media/firewire/firedtv-fw.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn fdtv_lock(fdtv: *mut firedtv, addr: u64, data: *mut c_void) -> c_int {
    int fdtv_lock(struct firedtv *fdtv, u64 addr, void *data)
    {
    return node_req(fdtv, addr, data, 8, TCODE_LOCK_COMPARE_SWAP);
    }
#[no_mangle]
pub unsafe extern "C" fn fdtv_read(fdtv: *mut firedtv, addr: u64, data: *mut c_void) -> c_int {
    int fdtv_read(struct firedtv *fdtv, u64 addr, void *data)
    {
    return node_req(fdtv, addr, data, 4, TCODE_READ_QUADLET_REQUEST);
    }
#[no_mangle]
pub unsafe extern "C" fn fdtv_write(fdtv: *mut firedtv, addr: u64, data: *mut c_void, len: usize) -> c_int {
...
pub const ISO_HEADER_SIZE: c_int = 4;
pub const CIP_HEADER_SIZE: c_int = 8;
pub const MPEG2_TS_HEADER_SIZE: c_int = 4;

pub const IRQ_INTERVAL: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fdtv_ir_context {
    pub context: *mut fw_iso_context,
    pub buffer: fw_iso_buffer,
    pub interrupt_packet: c_int,
    pub current_packet: c_int,
    pub pages: [*mut c_char; N_PAGES],
}

#[no_mangle]
unsafe extern "C" fn queue_iso(ctx: *mut fdtv_ir_context, index: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fdtv_start_iso(fdtv: *mut firedtv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fdtv_stop_iso(fdtv: *mut firedtv) {
    ...
    void *callback_data)
    {
    struct firedtv *f, *fdtv = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn node_probe(unit: *mut fw_unit, id: *const ieee1394_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn node_remove(unit: *mut fw_unit) {
...
#[no_mangle]
unsafe extern "C" fn node_update(unit: *mut fw_unit) {
...
pub const DIGITAL_EVERYWHERE_OUI: c_uint = 0x001287;
pub const AVC_UNIT_SPEC_ID_ENTRY: c_uint = 0x00a02d;
pub const AVC_SW_VERSION_ENTRY: c_uint = 0x010001;
...
#[no_mangle]
unsafe extern "C" fn fdtv_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fdtv_exit() -> void __exit {
