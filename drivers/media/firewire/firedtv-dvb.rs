...
//! Source: drivers/media/firewire/firedtv-dvb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn alloc_channel(fdtv: *mut firedtv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn collect_channels(fdtv: *mut firedtv, pidc: *mut c_int, pid[]: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn dealloc_channel(fdtv: *mut firedtv, i: c_int) {
    static inline void dealloc_channel(struct firedtv *fdtv, int i)
    {
    __clear_bit(i, &fdtv.channel_active);
    }
#[no_mangle]
pub unsafe extern "C" fn fdtv_start_feed(dvbdmxfeed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fdtv_stop_feed(dvbdmxfeed: *mut dvb_demux_feed) -> c_int {
    ...
    demux.pesfilter[dvbdmxfeed.pes_type] = core::ptr::null_mut();
    }
    if (!(dvbdmxfeed.ts_type & TS_DECODER &&
...
#[no_mangle]
pub unsafe extern "C" fn fdtv_dvb_register(fdtv: *mut firedtv, name: *const c_char) -> c_int {
...
// DMX_TS_FILTERING | DMX_SECTION_FILTERING
    ...
    fdtv.demux.write_to_decoder = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn fdtv_dvb_unregister(fdtv: *mut firedtv) {
