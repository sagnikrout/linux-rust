...
//! Source: drivers/media/i2c/s5k5baf.c
#![no_std]
...
pub const S5K5BAG_FW_TAG_LEN: c_int = 2;
pub const S5K5BAG_FW_MAX_COUNT: c_int = 16;
pub const S5K5BAF_CIS_WIDTH: c_int = 1600;
pub const S5K5BAF_CIS_HEIGHT: c_int = 1200;
pub const S5K5BAF_WIN_WIDTH_MIN: c_int = 8;
pub const S5K5BAF_WIN_HEIGHT_MIN: c_int = 8;
pub const S5K5BAF_GAIN_RED_DEF: c_int = 127;
pub const S5K5BAF_GAIN_GREEN_DEF: c_int = 95;
pub const S5K5BAF_GAIN_BLUE_DEF: c_int = 180;
// Default number of MIPI CSI-2 data lanes used
pub const S5K5BAF_DEF_NUM_LANES: c_int = 1;
pub const AHB_MSB_ADDR_PTR: c_uint = 0xfcfc;
//
// Register interface pages (the most significant word of the address)
//
pub const PAGE_IF_HW: c_uint = 0xd000;
pub const PAGE_IF_SW: c_uint = 0x7000;
//
// H/W register Interface (PAGE_IF_HW)
//
pub const REG_SW_LOAD_COMPLETE: c_uint = 0x0014;
pub const REG_CMDWR_PAGE: c_uint = 0x0028;
pub const REG_CMDWR_ADDR: c_uint = 0x002a;
pub const REG_CMDRD_PAGE: c_uint = 0x002c;
pub const REG_CMDRD_ADDR: c_uint = 0x002e;
pub const REG_CMD_BUF: c_uint = 0x0f12;
pub const REG_SET_HOST_INT: c_uint = 0x1000;
pub const REG_CLEAR_HOST_INT: c_uint = 0x1030;
pub const REG_PATTERN_SET: c_uint = 0x3100;
pub const REG_PATTERN_WIDTH: c_uint = 0x3118;
pub const REG_PATTERN_HEIGHT: c_uint = 0x311a;
pub const REG_PATTERN_PARAM: c_uint = 0x311c;
//
// S/W register interface (PAGE_IF_SW)
//
// Firmware revision information
pub const REG_FW_APIVER: c_uint = 0x012e;
pub const S5K5BAF_FW_APIVER: c_uint = 0x0001;
pub const REG_FW_REVISION: c_uint = 0x0130;
pub const REG_FW_SENSOR_ID: c_uint = 0x0152;
// Initialization parameters
// Master clock frequency in KHz
pub const REG_I_INCLK_FREQ_L: c_uint = 0x01b8;
pub const REG_I_INCLK_FREQ_H: c_uint = 0x01ba;

pub const REG_I_USE_NPVI_CLOCKS: c_uint = 0x01c6;
pub const NPVI_CLOCKS: c_int = 1;
pub const REG_I_USE_NMIPI_CLOCKS: c_uint = 0x01c8;
pub const NMIPI_CLOCKS: c_int = 1;
pub const REG_I_BLOCK_INTERNAL_PLL_CALC: c_uint = 0x01ca;
// Clock configurations, n = 0..2. REG_I_* frequency unit is 4 kHz.

pub const SCLK_PVI_FREQ: c_int = 24000;
pub const SCLK_MIPI_FREQ: c_int = 48000;
pub const PCLK_MIN_FREQ: c_int = 6000;
pub const PCLK_MAX_FREQ: c_int = 48000;
pub const REG_I_USE_REGS_API: c_uint = 0x01de;
pub const REG_I_INIT_PARAMS_UPDATED: c_uint = 0x01e0;
pub const REG_I_ERROR_INFO: c_uint = 0x01e2;
// General purpose parameters
pub const REG_USER_BRIGHTNESS: c_uint = 0x01e4;
pub const REG_USER_CONTRAST: c_uint = 0x01e6;
pub const REG_USER_SATURATION: c_uint = 0x01e8;
pub const REG_USER_SHARPBLUR: c_uint = 0x01ea;
pub const REG_G_SPEC_EFFECTS: c_uint = 0x01ee;
pub const REG_G_ENABLE_PREV: c_uint = 0x01f0;
pub const REG_G_ENABLE_PREV_CHG: c_uint = 0x01f2;
pub const REG_G_NEW_CFG_SYNC: c_uint = 0x01f8;
pub const REG_G_PREVREQ_IN_WIDTH: c_uint = 0x01fa;
pub const REG_G_PREVREQ_IN_HEIGHT: c_uint = 0x01fc;
pub const REG_G_PREVREQ_IN_XOFFS: c_uint = 0x01fe;
pub const REG_G_PREVREQ_IN_YOFFS: c_uint = 0x0200;
pub const REG_G_PREVZOOM_IN_WIDTH: c_uint = 0x020a;
pub const REG_G_PREVZOOM_IN_HEIGHT: c_uint = 0x020c;
pub const REG_G_PREVZOOM_IN_XOFFS: c_uint = 0x020e;
pub const REG_G_PREVZOOM_IN_YOFFS: c_uint = 0x0210;
pub const REG_G_INPUTS_CHANGE_REQ: c_uint = 0x021a;
pub const REG_G_ACTIVE_PREV_CFG: c_uint = 0x021c;
pub const REG_G_PREV_CFG_CHG: c_uint = 0x021e;
pub const REG_G_PREV_OPEN_AFTER_CH: c_uint = 0x0220;
pub const REG_G_PREV_CFG_ERROR: c_uint = 0x0222;
pub const CFG_ERROR_RANGE: c_uint = 0x0b;
pub const REG_G_PREV_CFG_BYPASS_CHANGED: c_uint = 0x022a;
pub const REG_G_ACTUAL_P_FR_TIME: c_uint = 0x023a;
pub const REG_G_ACTUAL_P_OUT_RATE: c_uint = 0x023c;
pub const REG_G_ACTUAL_C_FR_TIME: c_uint = 0x023e;
pub const REG_G_ACTUAL_C_OUT_RATE: c_uint = 0x0240;
// Preview control section. n = 0...4.

pub const PVI_MASK_MIPI: c_uint = 0x52;

pub const CLK_PVI_INDEX: c_int = 0;

pub const FR_RATE_DYNAMIC: c_int = 0;
pub const FR_RATE_FIXED: c_int = 1;
pub const FR_RATE_FIXED_ACCURATE: c_int = 2;

pub const FR_RATE_Q_DYNAMIC: c_int = 0;
...
pub const REG_SF_USR_EXPOSURE_L: c_uint = 0x03bc;
pub const REG_SF_USR_EXPOSURE_H: c_uint = 0x03be;
pub const REG_SF_USR_EXPOSURE_CHG: c_uint = 0x03c0;
pub const REG_SF_USR_TOT_GAIN: c_uint = 0x03c2;
pub const REG_SF_USR_TOT_GAIN_CHG: c_uint = 0x03c4;
pub const REG_SF_RGAIN: c_uint = 0x03c6;
pub const REG_SF_RGAIN_CHG: c_uint = 0x03c8;
pub const REG_SF_GGAIN: c_uint = 0x03ca;
pub const REG_SF_GGAIN_CHG: c_uint = 0x03cc;
pub const REG_SF_BGAIN: c_uint = 0x03ce;
pub const REG_SF_BGAIN_CHG: c_uint = 0x03d0;
pub const REG_SF_WBGAIN_CHG: c_uint = 0x03d2;
pub const REG_SF_FLICKER_QUANT: c_uint = 0x03d4;
pub const REG_SF_FLICKER_QUANT_CHG: c_uint = 0x03d6;
// Output interface (parallel/MIPI) setup
pub const REG_OIF_EN_MIPI_LANES: c_uint = 0x03f2;
pub const REG_OIF_EN_PACKETS: c_uint = 0x03f4;
pub const EN_PACKETS_CSI2: c_uint = 0xc3;
pub const REG_OIF_CFG_CHG: c_uint = 0x03f6;
// Auto-algorithms enable mask
pub const REG_DBG_AUTOALG_EN: c_uint = 0x03f8;

// Pointers to color correction matrices
pub const REG_PTR_CCM_HORIZON: c_uint = 0x06d0;
pub const REG_PTR_CCM_INCANDESCENT: c_uint = 0x06d4;
pub const REG_PTR_CCM_WARM_WHITE: c_uint = 0x06d8;
pub const REG_PTR_CCM_COOL_WHITE: c_uint = 0x06dc;
pub const REG_PTR_CCM_DL50: c_uint = 0x06e0;
pub const REG_PTR_CCM_DL65: c_uint = 0x06e4;
pub const REG_PTR_CCM_OUTDOOR: c_uint = 0x06ec;
...
pub const PAD_CIS: c_int = 0;
pub const PAD_OUT: c_int = 1;
pub const NUM_CIS_PADS: c_int = 1;
pub const NUM_ISP_PADS: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s5k5baf_pixfmt {
    pub code: u32,
    pub colorspace: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s5k5baf_ctrls {
    pub handler: v4l2_ctrl_handler,
    struct { /* Auto / manual white balance cluster */
    pub awb: *mut v4l2_ctrl,
    pub gain_red: *mut v4l2_ctrl,
    pub gain_blue: *mut v4l2_ctrl,
}
...
pub struct s5k5baf {
    ...
    pub nlanes: u8,
    pub supplies: [regulator_bulk_data; S5K5BAF_NUM_SUPPLIES],
    pub clock: *mut clk,
    pub fw: *mut s5k5baf_fw,
    pub cis_sd: v4l2_subdev,
    pub cis_pad: media_pad,
    pub sd: v4l2_subdev,
    pub pads: [media_pad; NUM_ISP_PADS],
// protects the struct members below
    pub lock: mutex,
    pub error: c_int,
    pub crop_sink: v4l2_rect,
    pub compose: v4l2_rect,
    pub crop_source: v4l2_rect,
...
// cache for REG_DBG_AUTOALG_EN register
    pub auto_alg: u16,
    pub ctrls: s5k5baf_ctrls,
    pub streaming:1: c_uint,
    pub apply_cfg:1: c_uint,
    pub apply_crop:1: c_uint,
    pub valid_auto_alg:1: c_uint,
    pub power: c_uint,
}
...
#[no_mangle]
pub unsafe extern "C" fn s5k5baf_is_cis_subdev(sd: *mut v4l2_subdev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_i2c_read(state: *mut s5k5baf, addr: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_i2c_write(state: *mut s5k5baf, addr: u16, val: u16) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_read(state: *mut s5k5baf, addr: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_write(state: *mut s5k5baf, addr: u16, val: u16) {
    ...
    while (count > 0) {
    let mut n: c_int = min_t(int, count, ARRAY_SIZE(buf) - 1);
    int ret, i;
    for (i = 1; i <= n; ++i)
...
//
#[no_mangle]
unsafe extern "C" fn s5k5baf_write_nseq(state: *mut s5k5baf, nseq: *const u16) {
    static void s5k5baf_write_nseq(struct s5k5baf *state, const u16 *nseq)
    {
    int count;
    while ((count = *nseq++)) {
    let mut addr: u16 = *nseq++;
    --count;
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_synchronize(state: *mut s5k5baf, timeout: c_int, addr: u16) {
    static void s5k5baf_synchronize(struct s5k5baf *state, int timeout, u16 addr)
    {
    let mut end: c_ulong = jiffies + msecs_to_jiffies(timeout);
    u16 reg;
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_patch(state: *mut s5k5baf) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_clocks(state: *mut s5k5baf) {
    static void s5k5baf_hw_set_clocks(struct s5k5baf *state)
    {
    let mut mclk: c_ulong = clk_get_rate(state.clock) / 1000;
    u16 status;
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_ccm(state: *mut s5k5baf) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_cis(state: *mut s5k5baf) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_sync_cfg(state: *mut s5k5baf) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_mirror(state: *mut s5k5baf) {
    static void s5k5baf_hw_set_mirror(struct s5k5baf *state)
    {
    let mut flip: u16 = state.ctrls.vflip.val | (state.ctrls.vflip.val << 1);
    s5k5baf_write(state, REG_P_PREV_MIRROR(0), flip);
    if (state.streaming)
    s5k5baf_hw_sync_cfg(state);
    }
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_alg(state: *mut s5k5baf, alg: u16, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_awb(state: *mut s5k5baf, awb: c_int) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_user_exposure(state: *mut s5k5baf, exposure: c_int) {
    static void s5k5baf_hw_set_user_exposure(struct s5k5baf *state, int exposure)
    {
    let mut time: c_uint = exposure / 10;
    s5k5baf_write_seq(state, REG_SF_USR_EXPOSURE_L,
    time & 0xffff, time >> 16, 1);
    }
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_user_gain(state: *mut s5k5baf, gain: c_int) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_auto_exposure(state: *mut s5k5baf, value: c_int) {
    ...
    let mut exp_time: c_uint = state.ctrls.exposure.val;
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_anti_flicker(state: *mut s5k5baf, v: c_int) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_colorfx(state: *mut s5k5baf, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_find_pixfmt(mf: *mut v4l2_mbus_framefmt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_clear_error(state: *mut s5k5baf) -> c_int {
    static int s5k5baf_clear_error(struct s5k5baf *state)
    {
    let mut ret: c_int = state.error;
    state.error = 0;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_video_bus(state: *mut s5k5baf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_get_cfg_error(state: *mut s5k5baf) -> u16 {
    static u16 s5k5baf_get_cfg_error(struct s5k5baf *state)
    {
    let mut err: u16 = s5k5baf_read(state, REG_G_PREV_CFG_ERROR);
    if (err)
    s5k5baf_write(state, REG_G_PREV_CFG_ERROR, 0);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_fiv(state: *mut s5k5baf, fiv: u16) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_find_min_fiv(state: *mut s5k5baf) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_validate_cfg(state: *mut s5k5baf) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_crop_rects(state: *mut s5k5baf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_config(state: *mut s5k5baf) {
    static void s5k5baf_hw_set_config(struct s5k5baf *state)
    {
    let mut reg_fmt: u16 = s5k5baf_formats[state.pixfmt].reg_p_fmt;
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_test_pattern(state: *mut s5k5baf, id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_power_off(state: *mut s5k5baf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_init(state: *mut s5k5baf) {
...
//
#[no_mangle]
unsafe extern "C" fn s5k5baf_initialize_data(state: *mut s5k5baf) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_load_setfile(state: *mut s5k5baf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_set_power(sd: *mut v4l2_subdev, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_hw_set_stream(state: *mut s5k5baf, enable: c_int) {
    static void s5k5baf_hw_set_stream(struct s5k5baf *state, int enable)
    {
    s5k5baf_write_seq(state, REG_G_ENABLE_PREV, enable, 1);
    }
#[no_mangle]
unsafe extern "C" fn s5k5baf_s_stream(sd: *mut v4l2_subdev, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_try_cis_format(mf: *mut v4l2_mbus_framefmt) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_try_isp_format(mf: *mut v4l2_mbus_framefmt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_get_sel_rect(pad: u32, target: u32) -> enum selection_rect {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_is_bound_target(target: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_bound_range(start: *mut u32, len: *mut u32, max: u32) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_bound_rect(r: *mut v4l2_rect, width: u32, height: u32) {
    ...
    let mut i: enum selection_rect = first;
// rects[first] = *v;
    do {
    r = rects[i];
    br = rects[i - 1];
...
//
#[no_mangle]
unsafe extern "C" fn s5k5baf_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_initialize_ctrls(state: *mut s5k5baf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5k5baf_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_check_fw_revision(state: *mut s5k5baf) -> c_int {
    static int s5k5baf_check_fw_revision(struct s5k5baf *state)
    {
    let mut api_ver: u16 = 0, fw_rev = 0, s_id = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_registered(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_unregistered(sd: *mut v4l2_subdev) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_configure_gpios(state: *mut s5k5baf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_parse_device_node(state: *mut s5k5baf, dev: *mut device) -> c_int {
    static int s5k5baf_parse_device_node(struct s5k5baf *state, struct device *dev)
    {
    struct device_node *node = dev.of_node;
    struct device_node *node_ep;
    let mut ep: v4l2_fwnode_endpoint = { .bus_type = 0 };
    int ret;
    if (!node) {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_configure_regulators(state: *mut s5k5baf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_probe(c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5k5baf_remove(c: *mut i2c_client) {
