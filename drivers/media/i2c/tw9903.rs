...
//! Source: drivers/media/i2c/tw9903.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tw9903_s_std(sd: *mut v4l2_subdev, norm: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw9903_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw9903_log_status(sd: *mut v4l2_subdev) -> c_int {
...
// --------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn tw9903_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw9903_remove(client: *mut i2c_client) {
