...
//! Source: drivers/media/i2c/ov08d10.c
#![no_std]
...
pub const OV08D10_ROWCLK: c_int = 36000;
pub const OV08D10_DATA_LANES: c_int = 2;
pub const OV08D10_RGB_DEPTH: c_int = 10;
pub const OV08D10_REG_PAGE: c_uint = 0xfd;
pub const OV08D10_REG_GLOBAL_EFFECTIVE: c_uint = 0x01;
pub const OV08D10_REG_CHIP_ID_0: c_uint = 0x00;
pub const OV08D10_REG_CHIP_ID_1: c_uint = 0x01;

pub const OV08D10_CHIP_ID: c_uint = 0x5608;
pub const OV08D10_REG_MODE_SELECT: c_uint = 0xa0;
pub const OV08D10_MODE_STANDBY: c_uint = 0x00;
pub const OV08D10_MODE_STREAMING: c_uint = 0x01;
// vertical-timings from sensor
pub const OV08D10_REG_VTS_H: c_uint = 0x05;
pub const OV08D10_REG_VTS_L: c_uint = 0x06;
pub const OV08D10_VTS_MAX: c_uint = 0x7fff;
// Exposure controls from sensor
pub const OV08D10_REG_EXPOSURE_H: c_uint = 0x02;
pub const OV08D10_REG_EXPOSURE_M: c_uint = 0x03;
pub const OV08D10_REG_EXPOSURE_L: c_uint = 0x04;
pub const OV08D10_EXPOSURE_MIN: c_int = 6;
pub const OV08D10_EXPOSURE_MAX_MARGIN: c_int = 6;
pub const OV08D10_EXPOSURE_STEP: c_int = 1;
// Analog gain controls from sensor
pub const OV08D10_REG_ANALOG_GAIN: c_uint = 0x24;
pub const OV08D10_ANAL_GAIN_MIN: c_int = 128;
pub const OV08D10_ANAL_GAIN_MAX: c_int = 2047;
pub const OV08D10_ANAL_GAIN_STEP: c_int = 1;
// Digital gain controls from sensor
pub const OV08D10_REG_MWB_DGAIN_C: c_uint = 0x21;
pub const OV08D10_REG_MWB_DGAIN_F: c_uint = 0x22;
pub const OV08D10_DGTL_GAIN_MIN: c_int = 0;
pub const OV08D10_DGTL_GAIN_MAX: c_int = 4095;
pub const OV08D10_DGTL_GAIN_STEP: c_int = 1;
pub const OV08D10_DGTL_GAIN_DEFAULT: c_int = 1024;
// Test Pattern Control
pub const OV08D10_REG_TEST_PATTERN: c_uint = 0x12;
pub const OV08D10_TEST_PATTERN_ENABLE: c_uint = 0x01;
pub const OV08D10_TEST_PATTERN_DISABLE: c_uint = 0x00;
// Flip Mirror Controls from sensor
pub const OV08D10_REG_FLIP_OPT: c_uint = 0x32;
pub const OV08D10_REG_FLIP_MASK: c_uint = 0x3;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov08d10_reg {
    pub address: u8,
    pub val: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov08d10_reg_list {
    pub num_of_regs: u32,
    pub regs: *const ov08d10_reg,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov08d10_link_freq_config {
    pub reg_list: [ov08d10_reg_list; ARRAY_SIZE(ov08d10_xvclk_freqs)],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov08d10_mode {
...
pub struct ov08d10 {
    ...
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(ov08d10_supply_names)],
    pub xvclk_index: u8,
    pub sd: v4l2_subdev,
    pub pad: media_pad,
...
// Current mode
    pub cur_mode: *const ov08d10_mode,
// To serialize asynchronous callbacks
    pub mutex: mutex,
// lanes index
    pub nlanes: u8,
    pub priv_lane: *const ov08d10_lane_cfg,
    pub modes_size: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov08d10_lane_cfg {
    pub link_freq_menu: [i64; 2],
    pub link_freq_configs: [ov08d10_link_freq_config; 2],
    pub sp_modes: [ov08d10_mode; 3],
}
...
#[no_mangle]
unsafe extern "C" fn ov08d10_get_format_code(ov08d10: *mut ov08d10) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_modes_num(ov08d10: *const ov08d10) -> c_uint {
    ...
    {
    let mut pixel_rate: u64 = link_freq_menu[f_index] * 2 * nlanes;
    ...
    u32 f_index, u8 nlanes)
    {
    let mut ppl: u64 = hts * to_rate(link_freq_menu, f_index, nlanes);
...
#[no_mangle]
unsafe extern "C" fn ov08d10_update_analog_gain(ov08d10: *mut ov08d10, a_gain: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_update_digital_gain(ov08d10: *mut ov08d10, d_gain: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_set_exposure(ov08d10: *mut ov08d10, exposure: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_set_vblank(ov08d10: *mut ov08d10, vblank: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_test_pattern(ov08d10: *mut ov08d10, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_set_ctrl_flip(ov08d10: *mut ov08d10, ctrl_val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_init_controls(ov08d10: *mut ov08d10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_start_streaming(ov08d10: *mut ov08d10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_stop_streaming(ov08d10: *mut ov08d10) {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_identify_module(ov08d10: *mut ov08d10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_get_hwcfg(ov08d10: *mut ov08d10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ov08d10_probe(client: *mut i2c_client) -> c_int {
    ...
    ov08d10.clk = devm_v4l2_sensor_clk_get(ov08d10.dev, core::ptr::null_mut());
    ...
    ov08d10.reset = devm_reset_control_get_optional_exclusive(ov08d10.dev, core::ptr::null_mut());
    ...
    ov08d10_power_off, ov08d10_power_on, core::ptr::null_mut());
