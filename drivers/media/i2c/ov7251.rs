...
//! Source: drivers/media/i2c/ov7251.c
#![no_std]
...
pub const OV7251_SC_MODE_SELECT: c_uint = 0x0100;
pub const OV7251_SC_MODE_SELECT_SW_STANDBY: c_uint = 0x0;
pub const OV7251_SC_MODE_SELECT_STREAMING: c_uint = 0x1;
pub const OV7251_CHIP_ID_HIGH: c_uint = 0x300a;
pub const OV7251_CHIP_ID_HIGH_BYTE: c_uint = 0x77;
pub const OV7251_CHIP_ID_LOW: c_uint = 0x300b;
pub const OV7251_CHIP_ID_LOW_BYTE: c_uint = 0x50;
pub const OV7251_SC_GP_IO_IN1: c_uint = 0x3029;
pub const OV7251_AEC_EXPO_0: c_uint = 0x3500;
pub const OV7251_AEC_EXPO_1: c_uint = 0x3501;
pub const OV7251_AEC_EXPO_2: c_uint = 0x3502;
pub const OV7251_AEC_AGC_ADJ_0: c_uint = 0x350a;
pub const OV7251_AEC_AGC_ADJ_1: c_uint = 0x350b;
pub const OV7251_TIMING_FORMAT1: c_uint = 0x3820;

pub const OV7251_TIMING_FORMAT2: c_uint = 0x3821;

pub const OV7251_PRE_ISP_00: c_uint = 0x5e00;

pub const OV7251_PLL1_PRE_DIV_REG: c_uint = 0x30b4;
pub const OV7251_PLL1_MULT_REG: c_uint = 0x30b3;
pub const OV7251_PLL1_DIVIDER_REG: c_uint = 0x30b1;
pub const OV7251_PLL1_PIX_DIV_REG: c_uint = 0x30b0;
pub const OV7251_PLL1_MIPI_DIV_REG: c_uint = 0x30b5;
pub const OV7251_PLL2_PRE_DIV_REG: c_uint = 0x3098;
pub const OV7251_PLL2_MULT_REG: c_uint = 0x3099;
pub const OV7251_PLL2_DIVIDER_REG: c_uint = 0x309d;
pub const OV7251_PLL2_SYS_DIV_REG: c_uint = 0x309a;
pub const OV7251_PLL2_ADC_DIV_REG: c_uint = 0x309b;
pub const OV7251_NATIVE_WIDTH: c_int = 656;
pub const OV7251_NATIVE_HEIGHT: c_int = 496;
pub const OV7251_ACTIVE_START_LEFT: c_int = 4;
pub const OV7251_ACTIVE_START_TOP: c_int = 4;
pub const OV7251_ACTIVE_WIDTH: c_int = 648;
pub const OV7251_ACTIVE_HEIGHT: c_int = 488;
pub const OV7251_FIXED_PPL: c_int = 928;
pub const OV7251_TIMING_VTS_REG: c_uint = 0x380e;
pub const OV7251_TIMING_MIN_VTS: c_int = 1;
pub const OV7251_TIMING_MAX_VTS: c_uint = 0xffff;
pub const OV7251_INTEGRATION_MARGIN: c_int = 20;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov7251_mode_info {
    pub width: u32,
    pub height: u32,
    pub vts: u32,
    pub data: *const reg_value,
    pub data_size: u32,
    pub pixel_clock: u32,
    pub link_freq: u32,
    pub exposure_max: u16,
    pub exposure_def: u16,
    pub timeperframe: v4l2_fract,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov7251_pll1_cfg {
    pub pre_div: c_uint,
    pub mult: c_uint,
    pub div: c_uint,
    pub pix_div: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov7251_pll_cfgs {
    pub pll2: *const ov7251_pll2_cfg,
    pub pll1: [*const ov7251_pll1_cfg; ],
}
...
pub struct ov7251 {
    ...
    pub core_regulator: *mut regulator,
    pub analog_regulator: *mut regulator,
    pub pll_cfgs: *const ov7251_pll_cfgs,
    pub link_freq_idx: enum supported_link_freqs,
    pub current_mode: *const ov7251_mode_info,
    pub ctrls: v4l2_ctrl_handler,
    pub pixel_clock: *mut v4l2_ctrl,
...
// Cached register values
    pub aec_pk_manual: u8,
    pub pre_isp_00: u8,
    pub timing_format1: u8,
    pub timing_format2: u8,
    pub /: *mut *mut mutex lock; / lock to protect power state, ctrls and mode,
    pub power_on: bool,
...
#[no_mangle]
unsafe extern "C" fn ov7251_regulators_enable(ov7251: *mut ov7251) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7251_regulators_disable(ov7251: *mut ov7251) {
...
#[no_mangle]
unsafe extern "C" fn ov7251_write_reg(ov7251: *mut ov7251, reg: u16, val: u8) -> c_int {
    ...
    {
    u8 regbuf[5];
    let mut nregbuf: u8 = sizeof(reg) + num * sizeof(*val);
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ov7251_read_reg(ov7251: *mut ov7251, reg: u16, val: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7251_pll_configure(ov7251: *mut ov7251) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7251_set_exposure(ov7251: *mut ov7251, exposure: i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7251_set_gain(ov7251: *mut ov7251, gain: i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7251_set_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7251_set_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7251_set_hflip(ov7251: *mut ov7251, value: i32) -> c_int {
    static int ov7251_set_hflip(struct ov7251 *ov7251, s32 value)
    {
    let mut val: u8 = ov7251.timing_format2;
    int ret;
    if (value)
...
#[no_mangle]
unsafe extern "C" fn ov7251_set_vflip(ov7251: *mut ov7251, value: i32) -> c_int {
    static int ov7251_set_vflip(struct ov7251 *ov7251, s32 value)
    {
    let mut val: u8 = ov7251.timing_format1;
    int ret;
    if (value)
...
#[no_mangle]
unsafe extern "C" fn ov7251_set_test_pattern(ov7251: *mut ov7251, value: i32) -> c_int {
    static int ov7251_set_test_pattern(struct ov7251 *ov7251, s32 value)
    {
    let mut val: u8 = ov7251.pre_isp_00;
    int ret;
    if (value)
...
#[no_mangle]
unsafe extern "C" fn ov7251_vts_configure(ov7251: *mut ov7251, vblank: i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7251_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avg_fps(t: *const v4l2_fract) -> u32 {
    ...
    let mut fps_req: c_uint = avg_fps(timeperframe);
...
#[no_mangle]
unsafe extern "C" fn ov7251_s_stream(subdev: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7251_check_hwcfg(ov7251: *mut ov7251) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7251_detect_chip(ov7251: *mut ov7251) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7251_init_ctrls(ov7251: *mut ov7251) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7251_probe(client: *mut i2c_client) -> c_int {
...
// get system clock (xclk)
    ov7251.xclk = devm_v4l2_sensor_clk_get(dev, core::ptr::null_mut());
    ...
    ov7251_init_state(&ov7251.sd, core::ptr::null_mut());
    return 0;
    err_pm_runtime:
...
#[no_mangle]
unsafe extern "C" fn ov7251_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(ov7251_set_power_off, ov7251_set_power_on, core::ptr::null_mut())
    };
