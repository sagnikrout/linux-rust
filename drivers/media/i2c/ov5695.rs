...
//! Source: drivers/media/i2c/ov5695.c
#![no_std]
...
pub const OV5695_XVCLK_FREQ: c_int = 24000000;
pub const CHIP_ID: c_uint = 0x005695;
pub const OV5695_REG_CHIP_ID: c_uint = 0x300a;
pub const OV5695_REG_CTRL_MODE: c_uint = 0x0100;
pub const OV5695_MODE_SW_STANDBY: c_uint = 0x0;

pub const OV5695_REG_EXPOSURE: c_uint = 0x3500;
pub const OV5695_EXPOSURE_MIN: c_int = 4;
pub const OV5695_EXPOSURE_STEP: c_int = 1;
pub const OV5695_VTS_MAX: c_uint = 0x7fff;
pub const OV5695_REG_ANALOG_GAIN: c_uint = 0x3509;
pub const ANALOG_GAIN_MIN: c_uint = 0x10;
pub const ANALOG_GAIN_MAX: c_uint = 0xf8;
pub const ANALOG_GAIN_STEP: c_int = 1;
pub const ANALOG_GAIN_DEFAULT: c_uint = 0xf8;
pub const OV5695_REG_DIGI_GAIN_H: c_uint = 0x350a;
pub const OV5695_REG_DIGI_GAIN_L: c_uint = 0x350b;
pub const OV5695_DIGI_GAIN_L_MASK: c_uint = 0x3f;
pub const OV5695_DIGI_GAIN_H_SHIFT: c_int = 6;
pub const OV5695_DIGI_GAIN_MIN: c_int = 0;

pub const OV5695_DIGI_GAIN_STEP: c_int = 1;
pub const OV5695_DIGI_GAIN_DEFAULT: c_int = 1024;
pub const OV5695_REG_TEST_PATTERN: c_uint = 0x4503;
pub const OV5695_TEST_PATTERN_ENABLE: c_uint = 0x80;
pub const OV5695_TEST_PATTERN_DISABLE: c_uint = 0x0;
pub const OV5695_REG_VTS: c_uint = 0x380e;
pub const REG_NULL: c_uint = 0xFFFF;
pub const OV5695_REG_VALUE_08BIT: c_int = 1;
pub const OV5695_REG_VALUE_16BIT: c_int = 2;
pub const OV5695_REG_VALUE_24BIT: c_int = 3;
pub const OV5695_LANES: c_int = 2;
pub const OV5695_BITS_PER_SAMPLE: c_int = 10;
...
pub const OV5695_LINK_FREQ_420MHZ: c_int = 420000000;
...
// val = be32_to_cpu(data_be);
    ...
    int dist;
    let mut cur_best_fit: c_int = 0;
    let mut cur_best_fit_dist: c_int = -1;
    int i;
...
#[no_mangle]
unsafe extern "C" fn ov5695_enable_test_pattern(ov5695: *mut ov5695, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ov5695_start_stream(ov5695: *mut ov5695) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ov5695_stop_stream(ov5695: *mut ov5695) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5695_s_stream(sd: *mut v4l2_subdev, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ov5695_power_on(ov5695: *mut ov5695) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ov5695_power_off(ov5695: *mut ov5695) {
...
#[no_mangle]
unsafe extern "C" fn ov5695_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn ov5695_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn ov5695_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
// No crop or compose
    ...
    ov5695_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn ov5695_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5695_initialize_controls(ov5695: *mut ov5695) -> c_int {
    ...
    h_blank = mode.hts_def - mode.width;
    ov5695.hblank = v4l2_ctrl_new_std(handler, core::ptr::null_mut(), V4L2_CID_HBLANK,
...
#[no_mangle]
unsafe extern "C" fn ov5695_configure_regulators(ov5695: *mut ov5695) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5695_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5695_remove(client: *mut i2c_client) {
