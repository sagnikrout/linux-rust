...
//! Source: drivers/media/i2c/ov2740.c
#![no_std]
...
pub const OV2740_MCLK: c_int = 19200000;
pub const OV2740_DATA_LANES: c_int = 2;
pub const OV2740_RGB_DEPTH: c_int = 10;
pub const OV2740_REG_CHIP_ID: c_uint = 0x300a;
pub const OV2740_CHIP_ID: c_uint = 0x2740;
pub const OV2740_REG_MODE_SELECT: c_uint = 0x0100;
pub const OV2740_MODE_STANDBY: c_uint = 0x00;
pub const OV2740_MODE_STREAMING: c_uint = 0x01;
// vertical-timings from sensor
pub const OV2740_REG_VTS: c_uint = 0x380e;
// horizontal-timings from sensor
pub const OV2740_REG_HTS: c_uint = 0x380c;
// Exposure controls from sensor
pub const OV2740_REG_EXPOSURE: c_uint = 0x3500;
pub const OV2740_EXPOSURE_MIN: c_int = 4;
pub const OV2740_EXPOSURE_MAX_MARGIN: c_int = 8;
pub const OV2740_EXPOSURE_STEP: c_int = 1;
// Analog gain controls from sensor
pub const OV2740_REG_ANALOG_GAIN: c_uint = 0x3508;
pub const OV2740_ANAL_GAIN_MIN: c_int = 128;
pub const OV2740_ANAL_GAIN_MAX: c_int = 1983;
pub const OV2740_ANAL_GAIN_STEP: c_int = 1;
// Digital gain controls from sensor
pub const OV2740_REG_MWB_R_GAIN: c_uint = 0x500a;
pub const OV2740_REG_MWB_G_GAIN: c_uint = 0x500c;
pub const OV2740_REG_MWB_B_GAIN: c_uint = 0x500e;
pub const OV2740_DGTL_GAIN_MIN: c_int = 1024;
pub const OV2740_DGTL_GAIN_MAX: c_int = 4095;
pub const OV2740_DGTL_GAIN_STEP: c_int = 1;
pub const OV2740_DGTL_GAIN_DEFAULT: c_int = 1024;
// Test Pattern Control
pub const OV2740_REG_TEST_PATTERN: c_uint = 0x5040;

pub const OV2740_TEST_PATTERN_BAR_SHIFT: c_int = 2;
// Group Access
pub const OV2740_REG_GROUP_ACCESS: c_uint = 0x3208;
pub const OV2740_GROUP_HOLD_START: c_uint = 0x0;
pub const OV2740_GROUP_HOLD_END: c_uint = 0x10;
pub const OV2740_GROUP_HOLD_LAUNCH: c_uint = 0xa0;
// ISP CTRL00
pub const OV2740_REG_ISP_CTRL00: c_uint = 0x5000;
// ISP CTRL01
pub const OV2740_REG_ISP_CTRL01: c_uint = 0x5001;
// Customer Addresses: 0x7010 - 0x710F
pub const CUSTOMER_USE_OTP_SIZE: c_uint = 0x100;
// OTP registers from sensor
pub const OV2740_REG_OTP_CUSTOMER: c_uint = 0x7010;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov2740_reg_list {
    pub num_of_regs: u32,
    pub regs: *const ov2740_reg,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov2740_link_freq_config {
    pub reg_list: ov2740_reg_list,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov2740_mode {
...
// GPIOs, clocks, regulators
    ...
    pub clk: *mut clk,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(ov2740_supply_name)],
// Current mode
    pub cur_mode: *const ov2740_mode,
// NVM data information
    pub nvm: *mut nvm_data,
// Supported modes
    pub supported_modes: *const ov2740_mode,
    pub supported_modes_count: c_int,
...
unsafe extern "C" fn to_pixel_rate(f_index: u32) -> u64 {
    ...
    {
    let mut pixel_rate: u64 = link_freq_menu_items[f_index] * 2 * OV2740_DATA_LANES;
    do_div(pixel_rate, OV2740_RGB_DEPTH);
    return pixel_rate;
    }
#[no_mangle]
unsafe extern "C" fn ov2740_read_reg(ov2740: *mut ov2740, reg: u16, len: u16, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2740_write_reg(ov2740: *mut ov2740, reg: u16, len: u16, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2740_identify_module(ov2740: *mut ov2740) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2740_update_digital_gain(ov2740: *mut ov2740, d_gain: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2740_test_pattern(ov2740: *mut ov2740, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2740_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2740_init_controls(ov2740: *mut ov2740) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2740_load_otp_data(nvm: *mut nvm_data) -> c_int {
    static int ov2740_load_otp_data(struct nvm_data *nvm)
    {
    struct device *dev = regmap_get_device(nvm.regmap);
    struct ov2740 *ov2740 = to_ov2740(dev_get_drvdata(dev));
    let mut isp_ctrl00: u32 = 0;
    let mut isp_ctrl01: u32 = 0;
    int ret;
    if (nvm.nvm_buffer)
    return 0;
...
//
    ...
    nvm.nvm_buffer = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn ov2740_start_streaming(ov2740: *mut ov2740) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2740_stop_streaming(ov2740: *mut ov2740) {
...
#[no_mangle]
unsafe extern "C" fn ov2740_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2740_check_hwcfg(ov2740: *mut ov2740) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2740_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ov2740_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2740_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2740_probe(client: *mut i2c_client) -> c_int {
