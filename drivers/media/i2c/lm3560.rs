...
//! Source: drivers/media/i2c/lm3560.c
#![no_std]
...
pub const REG_ENABLE: c_uint = 0x10;
pub const REG_TORCH_BR: c_uint = 0xa0;
pub const REG_FLASH_BR: c_uint = 0xb0;
pub const REG_FLASH_TOUT: c_uint = 0xc0;
pub const REG_FLAG: c_uint = 0xd0;
pub const REG_CONFIG1: c_uint = 0xe0;
// fault mask

pub const LM3560_FLASH_TOUT_MIN: c_int = 32;
pub const LM3560_FLASH_TOUT_STEP: c_int = 32;
pub const LM3560_FLASH_TOUT_MAX: c_int = 1024;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm3560_flash_config {
    pub flash_brt_min_ua: u32,
    pub flash_brt_max_ua: u32,
    pub flash_brt_step_ua: u32,
    pub torch_brt_min_ua: u32,
    pub torch_brt_max_ua: u32,
    pub torch_brt_step_ua: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm3560_flash {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub lock: mutex,
    pub hwen_gpio: *mut gpio_desc,
    pub vin_supply: *mut regulator,
    pub led_mode: enum v4l2_flash_led_mode,
    pub ctrls_led: [v4l2_ctrl_handler; LM3560_LED_MAX],
    pub subdev_led: [v4l2_subdev; LM3560_LED_MAX],
    pub LM3560_LED_MAX): DECLARE_BITMAP(led_id,,
    pub peak: enum lm3560_peak_current,
    pub max_flash_timeout: u32,
    pub max_flash_brt: [u32; LM3560_LED_MAX],
    pub max_torch_brt: [u32; LM3560_LED_MAX],
    pub config: *const lm3560_flash_config,
}

    container_of(_ctrl.handler, struct lm3560_flash, ctrls_led[_no])
// enable mode control
#[no_mangle]
unsafe extern "C" fn lm3560_mode_ctrl(flash: *mut lm3560_flash) -> c_int {
...
// v4l2 controls
#[no_mangle]
unsafe extern "C" fn lm3560_get_ctrl(ctrl: *mut v4l2_ctrl, led_no: enum lm3560_led_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3560_set_ctrl(ctrl: *mut v4l2_ctrl, led_no: enum lm3560_led_id) -> c_int {
...
unsafe extern "C" fn lm3560_led0_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    let mut max_flash_brt: u32 = flash.max_flash_brt[led_no];
    let mut max_torch_brt: u32 = flash.max_torch_brt[led_no];
...
// initialize device
    ...
    if (rval)
    goto err_out;
    rval = media_entity_pads_init(&flash.subdev_led[led_no].entity, 0, core::ptr::null_mut());
    if (rval < 0)
    goto err_out;
...
#[no_mangle]
unsafe extern "C" fn lm3560_init_device(flash: *mut lm3560_flash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3560_power_off(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn lm3560_power_on(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn lm3560_subdev_cleanup(flash: *mut lm3560_flash) {
...
#[no_mangle]
unsafe extern "C" fn lm3560_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3560_remove(client: *mut i2c_client) {
...
//
    ...
    SET_RUNTIME_PM_OPS(lm3560_power_off, lm3560_power_on, core::ptr::null_mut())
    };
