...
//! Source: drivers/media/i2c/saa7185.c
#![no_std]
...
// -----------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn saa7185_read(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7185_write(sd: *mut v4l2_subdev, reg: u8, value: u8) -> c_int {
...
// The following should not be needed
    ...
    0x74, 0x00,		/* core::ptr::null_mut()       */
    0x75, 0x00,		/* core::ptr::null_mut()       */
    0x76, 0x00,		/* core::ptr::null_mut()       */
...
#[no_mangle]
unsafe extern "C" fn saa7185_init(sd: *mut v4l2_subdev, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7185_s_std_output(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn saa7185_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7185_remove(client: *mut i2c_client) {
