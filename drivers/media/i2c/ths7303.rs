...
//! Source: drivers/media/i2c/ths7303.c
#![no_std]
...
pub const THS7303_CHANNEL_1: c_int = 1;
pub const THS7303_CHANNEL_2: c_int = 2;
pub const THS7303_CHANNEL_3: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ths7303_state {
    pub sd: v4l2_subdev,
    pub pdata: *const ths7303_platform_data,
...
#[no_mangle]
unsafe extern "C" fn ths7303_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ths7303_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ths7303_s_std_output(sd: *mut v4l2_subdev, norm: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ths7303_config(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(70000000: state->bt.pixelclock >) -> else {
    else if (state.bt.pixelclock > 70000000)
    res = ths7303_setval(sd, THS7303_FILTER_MODE_720P_1080I);
#[no_mangle]
pub unsafe extern "C" fn if(20000000: state->bt.pixelclock >) -> else {
    else if (state.bt.pixelclock > 20000000)
    res = ths7303_setval(sd, THS7303_FILTER_MODE_480P_576P);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: state->std_id) -> else {
...
#[no_mangle]
unsafe extern "C" fn ths7303_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ths7303_log_channel_status(sd: *mut v4l2_subdev, reg: u8) {
    static void ths7303_log_channel_status(struct v4l2_subdev *sd, u8 reg)
    {
    let mut val: u8 = ths7303_read(sd, reg);
    if ((val & 0x7) == 0) {
...
#[no_mangle]
unsafe extern "C" fn ths7303_log_status(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ths7303_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ths7303_remove(client: *mut i2c_client) {
