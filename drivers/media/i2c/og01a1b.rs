...
//! Source: drivers/media/i2c/og01a1b.c
#![no_std]
...
pub const OG01A1B_MCLK: c_int = 19200000;
pub const OG01A1B_DATA_LANES: c_int = 2;

pub const OG01A1B_CHIP_ID: c_uint = 0x470141;

pub const OG01A1B_MODE_STANDBY: c_uint = 0x00;
pub const OG01A1B_MODE_STREAMING: c_uint = 0x01;
// vertical-timings from sensor

pub const OG01A1B_VTS_120FPS: c_uint = 0x0498;
pub const OG01A1B_VTS_120FPS_MIN: c_uint = 0x0498;
pub const OG01A1B_VTS_MAX: c_uint = 0x7fff;
// horizontal-timings from sensor

// Exposure controls from sensor

pub const OG01A1B_EXPOSURE_MIN: c_int = 1;
pub const OG01A1B_EXPOSURE_MAX_MARGIN: c_int = 14;
pub const OG01A1B_EXPOSURE_STEP: c_int = 1;
// Analog gain controls from sensor

pub const OG01A1B_ANAL_GAIN_MIN: c_int = 16;

pub const OG01A1B_ANAL_GAIN_STEP: c_int = 1;
// Digital gain controls from sensor

pub const OG01A1B_DGTL_GAIN_MIN: c_int = 1024;

pub const OG01A1B_DGTL_GAIN_STEP: c_int = 1;
pub const OG01A1B_DGTL_GAIN_DEFAULT: c_int = 1024;
// Test Pattern Control

pub const OG01A1B_TEST_PATTERN_BAR_SHIFT: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct og01a1b_link_freq_config {
    pub reg_list: og01a1b_reg_list,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct og01a1b_mode {
...
// Current mode
    pub cur_mode: *const og01a1b_mode,
// Selected media bus format output
    pub code: u32,
}

#[no_mangle]
unsafe extern "C" fn to_pixel_rate(f_index: u32, bpp: u32) -> u64 {
    static u64 to_pixel_rate(u32 f_index, u32 bpp)
    {
    let mut pixel_rate: u64 = link_freq_menu_items[f_index] * 2 * OG01A1B_DATA_LANES;
    do_div(pixel_rate, bpp);
    return pixel_rate;
    }
#[no_mangle]
unsafe extern "C" fn to_pixels_per_line(hts: u32, f_index: u32, bpp: u32) -> u64 {
    static u64 to_pixels_per_line(u32 hts, u32 f_index, u32 bpp)
    {
    let mut ppl: u64 = hts * to_pixel_rate(f_index, bpp);
    do_div(ppl, OG01A1B_SCLK);
    return ppl;
    }
#[no_mangle]
unsafe extern "C" fn og01a1b_test_pattern(og01a1b: *mut og01a1b, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn og01a1b_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// V4L2 controls values will be applied only when power is already up
    ...
    og01a1b.cur_mode.height + ctrl.val, core::ptr::null_mut());
    break;
...
#[no_mangle]
unsafe extern "C" fn og01a1b_init_controls(og01a1b: *mut og01a1b) -> c_int {
    ...
    let mut link_freq_index: c_uint = og01a1b.cur_mode.link_freq_index;
    ...
    OG01A1B_MODE_STREAMING, core::ptr::null_mut());
    if (ret) {
    ...
    int ret;
    ret = cci_write(og01a1b.regmap, OG01A1B_REG_MODE_SELECT,
    OG01A1B_MODE_STANDBY, core::ptr::null_mut());
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn og01a1b_identify_module(og01a1b: *mut og01a1b) -> c_int {
    static int og01a1b_identify_module(struct og01a1b *og01a1b)
    {
    int ret;
    u64 val;
    ret = cci_read(og01a1b.regmap, OG01A1B_REG_CHIP_ID, &val, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn og01a1b_check_hwcfg(og01a1b: *mut og01a1b) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn og01a1b_power_on(dev: *mut device) -> c_int {
    static int og01a1b_power_on(struct device *dev)
    {
    let mut delay: c_ulong = DIV_ROUND_UP(8192UL * USEC_PER_SEC, OG01A1B_MCLK);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: og01a1b->xvclk) -> else {
...
#[no_mangle]
unsafe extern "C" fn og01a1b_power_off(dev: *mut device) -> c_int {
    static int og01a1b_power_off(struct device *dev)
    {
    let mut delay: c_ulong = DIV_ROUND_UP(512 * USEC_PER_SEC, OG01A1B_MCLK);
    struct v4l2_subdev *sd = dev_get_drvdata(dev);
    struct og01a1b *og01a1b = to_og01a1b(sd);
    if (og01a1b.xvclk)
    usleep_range(delay, 2 * delay);
...
#[no_mangle]
unsafe extern "C" fn og01a1b_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn og01a1b_probe(client: *mut i2c_client) -> c_int {
    ...
    "failed to init CCI\n");
    og01a1b.xvclk = devm_v4l2_sensor_clk_get(og01a1b.dev, core::ptr::null_mut());
    ...
    og01a1b.avdd = core::ptr::null_mut();
    }
    ...
    og01a1b.dovdd = core::ptr::null_mut();
    }
    ...
    og01a1b.dvdd = core::ptr::null_mut();
    }
...
// Enable runtime PM and turn off the device
    ...
    SET_RUNTIME_PM_OPS(og01a1b_power_off, og01a1b_power_on, core::ptr::null_mut())
    };
