...
//! Source: drivers/media/i2c/adv7183.c
#![no_std]
...
pub struct adv7183 {
    ...
    pub /: *mut *mut v4l2_std_id std; / Current set standard,
    pub input: u32,
    pub output: u32,
    pub reset_pin: *mut gpio_desc,
    pub oe_pin: *mut gpio_desc,
...
#[no_mangle]
pub unsafe extern "C" fn adv7183_read(sd: *mut v4l2_subdev, reg: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7183_log_status(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7183_g_std(sd: *mut v4l2_subdev, std: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7183_s_std(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
    ...
    reg |= 0x60;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_NTSC_443: std ==) -> else {
    else if (std == V4L2_STD_NTSC_443)
    reg |= 0x70;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_PAL_N: std ==) -> else {
    else if (std == V4L2_STD_PAL_N)
    reg |= 0x90;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_PAL_M: std ==) -> else {
    else if (std == V4L2_STD_PAL_M)
    reg |= 0xA0;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_PAL_Nc: std ==) -> else {
...
pub unsafe extern "C" fn if(V4L2_STD_PAL: std &) -> else {
    ...
    reg |= 0x80;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_NTSC: std &) -> else {
...
#[no_mangle]
unsafe extern "C" fn adv7183_reset(sd: *mut v4l2_subdev, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7183_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    static int adv7183_s_ctrl(struct v4l2_ctrl *ctrl)
    {
    struct v4l2_subdev *sd = to_sd(ctrl);
    let mut val: c_int = ctrl.val;
    switch (ctrl.id) {
...
#[no_mangle]
unsafe extern "C" fn adv7183_querystd(sd: *mut v4l2_subdev, std: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7183_g_input_status(sd: *mut v4l2_subdev, status: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7183_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7183_g_register(sd: *mut v4l2_subdev, reg: *mut v4l2_dbg_register) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7183_s_register(sd: *mut v4l2_subdev, reg: *const v4l2_dbg_register) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7183_probe(client: *mut i2c_client) -> c_int {
...
// wait 5ms before any further i2c writes are performed
    ...
    adv7183_set_fmt(sd, core::ptr::null_mut(), &fmt);
...
#[no_mangle]
unsafe extern "C" fn adv7183_remove(client: *mut i2c_client) {
