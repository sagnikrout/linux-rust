...
//! Source: drivers/media/i2c/upd64083.c
#![no_std]
...
// ------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn upd64083_write(sd: *mut v4l2_subdev, reg: u8, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn upd64083_read(sd: *mut v4l2_subdev, reg: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn upd64083_g_register(sd: *mut v4l2_subdev, reg: *mut v4l2_dbg_register) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn upd64083_s_register(sd: *mut v4l2_subdev, reg: *const v4l2_dbg_register) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn upd64083_log_status(sd: *mut v4l2_subdev) -> c_int {
...
// i2c implementation
#[no_mangle]
unsafe extern "C" fn upd64083_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn upd64083_remove(client: *mut i2c_client) {
