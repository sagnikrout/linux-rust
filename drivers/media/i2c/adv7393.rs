...
//! Source: drivers/media/i2c/adv7393.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn adv7393_write(sd: *mut v4l2_subdev, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7393_setstd(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7393_setoutput(sd: *mut v4l2_subdev, output_type: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(ADV7393_COMPONENT_ID: output_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn adv7393_log_status(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7393_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7393_s_std_output(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7393_initialize(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7393_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7393_remove(client: *mut i2c_client) {
