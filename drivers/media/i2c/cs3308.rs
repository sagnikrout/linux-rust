...
//! Source: drivers/media/i2c/cs3308.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
#[no_mangle]
pub unsafe extern "C" fn cs3308_write(sd: *mut v4l2_subdev, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cs3308_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs3308_g_register(sd: *mut v4l2_subdev, reg: *mut v4l2_dbg_register) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs3308_s_register(sd: *mut v4l2_subdev, reg: *const v4l2_dbg_register) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn cs3308_probe(client: *mut i2c_client) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn cs3308_remove(client: *mut i2c_client) {
