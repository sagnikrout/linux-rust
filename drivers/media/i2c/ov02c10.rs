...
//! Source: drivers/media/i2c/ov02c10.c
#![no_std]
...
pub const OV02C10_MCLK: c_int = 19200000;
pub const OV02C10_RGB_DEPTH: c_int = 10;

pub const OV02C10_CHIP_ID: c_uint = 0x5602;

// vertical-timings from sensor

pub const OV02C10_VTS_MAX: c_uint = 0xffff;
// Exposure controls from sensor

pub const OV02C10_EXPOSURE_MIN: c_int = 4;
pub const OV02C10_EXPOSURE_MAX_MARGIN: c_int = 8;
pub const OV02C10_EXPOSURE_STEP: c_int = 1;
// Analog gain controls from sensor

pub const OV02C10_ANAL_GAIN_MIN: c_uint = 0x10;
pub const OV02C10_ANAL_GAIN_MAX: c_uint = 0xf8;
pub const OV02C10_ANAL_GAIN_STEP: c_int = 1;
pub const OV02C10_ANAL_GAIN_DEFAULT: c_uint = 0x10;
// Digital gain controls from sensor

pub const OV02C10_DGTL_GAIN_MIN: c_uint = 0x0400;
pub const OV02C10_DGTL_GAIN_MAX: c_uint = 0x3fff;
pub const OV02C10_DGTL_GAIN_STEP: c_int = 1;
pub const OV02C10_DGTL_GAIN_DEFAULT: c_uint = 0x0400;
// Rotate

pub const OV02C10_CONFIG_ROTATE: c_uint = 0x18;
// Test Pattern Control

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov02c10_mode {
...
// Sensor register settings for this resolution
    pub reg_sequence: *const reg_sequence,
    pub sequence_length: c_int,
// Sensor register settings for 1 or 2 lane config
    pub lane_settings: [*const reg_sequence; 2],
    pub lane_settings_length: [c_int; 2],
}
...
// V4L2 Controls
    ...
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(ov02c10_supply_names)],
// MIPI lane info
...
#[no_mangle]
unsafe extern "C" fn ov02c10_test_pattern(ov02c10: *mut ov02c10, pattern: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov02c10_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    let mut height: u32 = supported_modes[0].height;
    s64 exposure_max;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ov02c10_init_controls(ov02c10: *mut ov02c10) -> c_int {
...
//
    ...
    if (ret)
    goto out;
    ret = cci_write(ov02c10.regmap, OV02C10_REG_STREAM_CONTROL, 1, core::ptr::null_mut());
    out:
    if (ret)
    pm_runtime_put(ov02c10.dev);
    return ret;
    ...
    {
    struct ov02c10 *ov02c10 = to_ov02c10(sd);
    cci_write(ov02c10.regmap, OV02C10_REG_STREAM_CONTROL, 0, core::ptr::null_mut());
    pm_runtime_put(ov02c10.dev);
    return 0;
    }
// This function tries to get power control resources
#[no_mangle]
unsafe extern "C" fn ov02c10_get_pm_resources(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov02c10_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov02c10_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov02c10_identify_module(ov02c10: *mut ov02c10) -> c_int {
    static int ov02c10_identify_module(struct ov02c10 *ov02c10)
    {
    u64 chip_id;
    int ret;
    ret = cci_read(ov02c10.regmap, OV02C10_REG_CHIP_ID, &chip_id, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn ov02c10_check_hwcfg(ov02c10: *mut ov02c10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov02c10_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ov02c10_probe(client: *mut i2c_client) -> c_int {
    ...
    ov02c10.img_clk = devm_v4l2_sensor_clk_get(ov02c10.dev, core::ptr::null_mut());
...
// Check HW config
    ...
    ov02c10_power_on, core::ptr::null_mut());
