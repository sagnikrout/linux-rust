...
//! Source: drivers/media/i2c/thp7312.c
#![no_std]
...
pub const THP7312_OUTPUT_ENABLE: c_uint = 0x01;
pub const THP7312_OUTPUT_DISABLE: c_uint = 0x00;

pub const THP7312_REG_SET_OUTPUT_COLOR_UYVY: c_uint = 0x00;
pub const THP7312_REG_SET_OUTPUT_COLOR_YUY2: c_uint = 0x04;

pub const THP7312_VIDEO_IMAGE_SIZE_640x360: c_uint = 0x52;
pub const THP7312_VIDEO_IMAGE_SIZE_640x460: c_uint = 0x03;
pub const THP7312_VIDEO_IMAGE_SIZE_1280x720: c_uint = 0x0a;
pub const THP7312_VIDEO_IMAGE_SIZE_1920x1080: c_uint = 0x0b;
pub const THP7312_VIDEO_IMAGE_SIZE_3840x2160: c_uint = 0x0d;
pub const THP7312_VIDEO_IMAGE_SIZE_4160x3120: c_uint = 0x14;
pub const THP7312_VIDEO_IMAGE_SIZE_2016x1512: c_uint = 0x20;
pub const THP7312_VIDEO_IMAGE_SIZE_2048x1536: c_uint = 0x21;

pub const THP7312_VIDEO_FRAME_RATE_MODE1: c_uint = 0x80;
pub const THP7312_VIDEO_FRAME_RATE_MODE2: c_uint = 0x81;
pub const THP7312_VIDEO_FRAME_RATE_MODE3: c_uint = 0x82;

pub const THP7312_AE_FLICKER_MODE_50: c_uint = 0x00;
pub const THP7312_AE_FLICKER_MODE_60: c_uint = 0x01;
pub const THP7312_AE_FLICKER_MODE_DISABLE: c_uint = 0x80;

pub const THP7312_WB_MODE_AUTO: c_uint = 0x00;
pub const THP7312_WB_MODE_MANUAL: c_uint = 0x11;

pub const THP7312_REG_AF_CONTROL_AF: c_uint = 0x01;
pub const THP7312_REG_AF_CONTROL_MANUAL: c_uint = 0x10;
pub const THP7312_REG_AF_CONTROL_LOCK: c_uint = 0x80;

pub const THP7312_REG_AF_SETTING_ONESHOT_CONTRAST: c_uint = 0x00;
pub const THP7312_REG_AF_SETTING_ONESHOT_PDAF: c_uint = 0x40;
pub const THP7312_REG_AF_SETTING_ONESHOT_HYBRID: c_uint = 0x80;
pub const THP7312_REG_AF_SETTING_CONTINUOUS_CONTRAST: c_uint = 0x30;
pub const THP7312_REG_AF_SETTING_CONTINUOUS_PDAF: c_uint = 0x70;
pub const THP7312_REG_AF_SETTING_CONTINUOUS_HYBRID: c_uint = 0xf0;
...
pub const THP7312_FW_MEMORY_IO_GPIO0: c_int = 1;
pub const THP7312_FW_MEMORY_IO_GPIO1: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct thp7312_frame_rate {
    pub fps: u32,
    pub link_freq: u32,
    pub reg_frame_rate_mode: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct thp7312_mode_info {
    pub width: u32,
    pub height: u32,
    pub reg_image_size: u8,
    pub rates: *const thp7312_frame_rate,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct thp7312_sensor_info {
    pub model: *const c_char,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct thp7312_sensor {
    pub info: *const thp7312_sensor_info,
    pub lane_remap: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct thp7312_device {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub sd: v4l2_subdev,
    pub pad: media_pad,
    pub reset_gpio: *mut gpio_desc,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(thp7312_supply_name)],
    pub iclk: *mut clk,
    pub lane_remap: u8,
    pub sensors: [thp7312_sensor; 1],
    pub boot_mode: enum thp7312_boot_mode,
    pub ctrl_handler: v4l2_ctrl_handler,
    pub ctrls_applied: bool,
    pub link_freq: i64,
    struct {
...
// Lock to protect fw_cancel
    ...
    bool nearest)
    {
    const struct thp7312_frame_rate *best_rate = core::ptr::null_mut();
    const struct thp7312_frame_rate *rate;
    let mut best_delta: c_uint = UINT_MAX;
    if (!mode)
    return core::ptr::null_mut();
    for (rate = mode.rates; rate.fps && best_delta; ++rate) {
    let mut delta: c_uint = abs(rate.fps - fps);
    if (delta <= best_delta) {
    best_delta = delta;
    best_rate = rate;
    }
...
#[no_mangle]
unsafe extern "C" fn thp7312_map_data_lanes(lane_remap: *mut u8, lanes: *const u8, num_lanes: u8) -> c_int {
    static int thp7312_map_data_lanes(u8 *lane_remap, const u8 *lanes, u8 num_lanes)
    {
    let mut used_lanes: u8 = 0;
    let mut val: u8 = 0;
    unsigned int i;
//
...
#[no_mangle]
unsafe extern "C" fn thp7312_set_mipi_lanes(thp7312: *mut thp7312_device) -> c_int {
...
// Should never happen
    ...
    THP7312_REG_SET_OUTPUT_COLOR_COMPRESSION, val, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn thp7312_stream_enable(thp7312: *mut thp7312_device, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thp7312_check_status_stream_mode(thp7312: *mut thp7312_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thp7312_reset(thp7312: *mut thp7312_device) {
...
//
#[no_mangle]
unsafe extern "C" fn __thp7312_power_off(thp7312: *mut thp7312_device) {
...
#[no_mangle]
unsafe extern "C" fn thp7312_power_off(thp7312: *mut thp7312_device) {
    static void thp7312_power_off(struct thp7312_device *thp7312)
    {
    __thp7312_power_off(thp7312);
    }
#[no_mangle]
unsafe extern "C" fn __thp7312_power_on(thp7312: *mut thp7312_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thp7312_power_on(thp7312: *mut thp7312_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thp7312_pm_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn thp7312_pm_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    thp7312_pm_runtime_resume, core::ptr::null_mut())
    };
// -----------------------------------------------------------------------------
// V4L2 Subdev Operations
//
#[no_mangle]
unsafe extern "C" fn thp7312_find_bus_code(code: u32) -> bool {
    ...
    const struct thp7312_frame_rate *rate;
    const struct thp7312_mode_info *mode;
    let mut index: c_uint = fie.index;
...
#[no_mangle]
unsafe extern "C" fn thp7312_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thp7312_set_focus(thp7312: *mut thp7312_device) -> c_int {
    static int thp7312_set_focus(struct thp7312_device *thp7312)
    {
    let mut new_state: enum thp7312_focus_state = thp7312.focus_state;
    bool continuous;
    u8 af_control;
    u8 af_setting;
    let mut ret: c_int = 0;
// Start by programming the manual focus position if it has changed.
    ...
    THP7312_REG_MANUAL_FOCUS_POSITION, value, core::ptr::null_mut());
    if (ret)
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: thp7312->focus_start->is_new) -> else {
...
pub unsafe extern "C" fn if(_arg: thp7312->focus_start->is_new) -> else {
    ...
    new_state = THP7312_FOCUS_STATE_ONESHOT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: thp7312->focus_absolute->is_new) -> else {
...
#[no_mangle]
unsafe extern "C" fn thp7312_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thp7312_init_controls(thp7312: *mut thp7312_device) -> c_int {
...
//
    ...
    v4l2_ctrl_new_custom(hdl, af_method, core::ptr::null_mut());
    thp7312.focus_start =
    v4l2_ctrl_new_std(hdl, &thp7312_ctrl_ops,
...
// Set properties from fwnode (e.g. rotation, orientation).
    ...
    ctrl = v4l2_ctrl_new_custom(hdl, ctrl_cfg, core::ptr::null_mut());
    if (ctrl_cfg.id == V4L2_CID_THP7312_NOISE_REDUCTION_AUTO)
    thp7312.noise_reduction_auto = ctrl;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_CID_THP7312_NOISE_REDUCTION_ABSOLUTE: ctrl_cfg->id ==) -> else {
...
pub const THP7312_FLASH_MEMORY_ERASE_TIMEOUT: c_int = 40;
pub const THP7312_FLASH_MAX_REG_READ_SIZE: c_int = 10;
pub const THP7312_FLASH_MAX_REG_DATA_SIZE: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn thp7312_read_firmware_version(thp7312: *mut thp7312_device) -> c_int {
    ...
    rdbuf, sizeof(rdbuf))
#[no_mangle]
unsafe extern "C" fn thp7312_fw_prepare_config(thp7312: *mut thp7312_device) -> enum fw_upload_err {
    ...
    THP7312_FW_MEMORY_IO_GPIO0, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn thp7312_fw_prepare_check(thp7312: *mut thp7312_device) -> enum fw_upload_err {
...
#[no_mangle]
unsafe extern "C" fn thp7312_fw_prepare_reset(thp7312: *mut thp7312_device) -> enum fw_upload_err {
    static enum fw_upload_err thp7312_fw_prepare_reset(struct thp7312_device *thp7312)
    {
    struct device *dev = thp7312.dev;
    int ret;
    ret = cci_write(thp7312.regmap, THP7312_REG_FW_RESET_FLASH, 0x81, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn thp7312_flash_erase(thp7312: *mut thp7312_device) -> enum fw_upload_err {
...
//
    ...
    let mut bank_addr: u32 = 0x10000000 | (i * THP7312_RAM_BANK_SIZE);
    unsigned int bank_size;
    unsigned int num_chunks;
    ret = cci_write(thp7312.regmap, THP7312_REG_FW_DEST_BANK_ADDR,
    bank_addr, core::ptr::null_mut());
    if (ret)
    return FW_UPLOAD_ERR_HW_ERROR;
    ...
    let mut cmd_size: static u32 = sizeof(thp7312_cmd_write_ram_to_flash);
    u64 val;
    int ret;
    ...
    {
    struct device *dev = thp7312.dev;
    let mut header_size: u16 = fw_size - THP7312_FW_RAM_SIZE;
    u8 command[sizeof(thp7312_cmd_calc_crc) + 6];
    let mut cmd_size: static u32 = sizeof(thp7312_cmd_calc_crc);
    let mut size: u32 = THP7312_FW_RAM_SIZE - 4;
    u32 fw_crc;
    u64 crc;
    int ret;
    ...
    ret = cci_read(thp7312.regmap, THP7312_REG_FW_CRC_RESULT, &crc, core::ptr::null_mut());
    if (ret < 0)
    return FW_UPLOAD_ERR_RW_ERROR;
    if (fw_crc != crc) {
    ...
    struct thp7312_device *thp7312 = fw_upload.dd_handle;
    struct device *dev = thp7312.dev;
    let mut header_size: u16 = size - THP7312_FW_RAM_SIZE;
    enum fw_upload_err ret;
    bool cancel;
    mutex_lock(&thp7312.fw_lock);
...
#[no_mangle]
unsafe extern "C" fn thp7312_fw_poll_complete(fw_upload: *mut fw_upload) -> enum fw_upload_err {
...
//
#[no_mangle]
unsafe extern "C" fn thp7312_fw_cancel(fw_upload: *mut fw_upload) {
...
#[no_mangle]
unsafe extern "C" fn thp7312_register_flash_mode(thp7312: *mut thp7312_device) -> c_int {
    ...
    ret = cci_read(thp7312.regmap, THP7312_REG_FW_STATUS, &val, core::ptr::null_mut());
    if (ret) {
...
//
#[no_mangle]
unsafe extern "C" fn thp7312_get_regulators(thp7312: *mut thp7312_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thp7312_parse_dt(thp7312: *mut thp7312_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn thp7312_probe(client: *mut i2c_client) -> c_int {
    ...
    thp7312.iclk = devm_clk_get(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn thp7312_remove(client: *mut i2c_client) {
