...
//! Source: drivers/media/i2c/imx319.c
#![no_std]
...
pub const IMX319_REG_MODE_SELECT: c_uint = 0x0100;
pub const IMX319_MODE_STANDBY: c_uint = 0x00;
pub const IMX319_MODE_STREAMING: c_uint = 0x01;
// Chip ID
pub const IMX319_REG_CHIP_ID: c_uint = 0x0016;
pub const IMX319_CHIP_ID: c_uint = 0x0319;
// V_TIMING internal
pub const IMX319_REG_FLL: c_uint = 0x0340;
pub const IMX319_FLL_MAX: c_uint = 0xffff;
// Exposure control
pub const IMX319_REG_EXPOSURE: c_uint = 0x0202;
pub const IMX319_EXPOSURE_MIN: c_int = 1;
pub const IMX319_EXPOSURE_STEP: c_int = 1;
pub const IMX319_EXPOSURE_DEFAULT: c_uint = 0x04f6;
//
...
//
// Analog gain control
pub const IMX319_REG_ANALOG_GAIN: c_uint = 0x0204;
pub const IMX319_ANA_GAIN_MIN: c_int = 0;
pub const IMX319_ANA_GAIN_MAX: c_int = 960;
pub const IMX319_ANA_GAIN_STEP: c_int = 1;
pub const IMX319_ANA_GAIN_DEFAULT: c_int = 0;
// Digital gain control
pub const IMX319_REG_DPGA_USE_GLOBAL_GAIN: c_uint = 0x3ff9;
pub const IMX319_REG_DIG_GAIN_GLOBAL: c_uint = 0x020e;
pub const IMX319_DGTL_GAIN_MIN: c_int = 256;
pub const IMX319_DGTL_GAIN_MAX: c_int = 4095;
pub const IMX319_DGTL_GAIN_STEP: c_int = 1;
pub const IMX319_DGTL_GAIN_DEFAULT: c_int = 256;
// Test Pattern Control
pub const IMX319_REG_TEST_PATTERN: c_uint = 0x0600;
pub const IMX319_TEST_PATTERN_DISABLED: c_int = 0;
pub const IMX319_TEST_PATTERN_SOLID_COLOR: c_int = 1;
pub const IMX319_TEST_PATTERN_COLOR_BARS: c_int = 2;
pub const IMX319_TEST_PATTERN_GRAY_COLOR_BARS: c_int = 3;
pub const IMX319_TEST_PATTERN_PN9: c_int = 4;
// Flip Control
pub const IMX319_REG_ORIENTATION: c_uint = 0x0101;
// default link frequency and external clock

pub const IMX319_EXT_CLK: c_int = 19200000;
pub const IMX319_LINK_FREQ_INDEX: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx319_reg {
    pub address: u16,
    pub val: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx319_reg_list {
    pub num_of_regs: u32,
    pub regs: *const imx319_reg,
}

// Mode : resolution and related config&values
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx319_mode {
// Frame width
    pub width: u32,
// Frame height
    pub height: u32,
...
// Default register values
    pub reg_list: imx319_reg_list,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx319_hwcfg {
...
// Current mode
    pub cur_mode: *const imx319_mode,
    pub hwcfg: *mut imx319_hwcfg,
//
...
#[no_mangle]
unsafe extern "C" fn imx319_get_format_code(imx319: *mut imx319) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn imx319_read_reg(imx319: *mut imx319, reg: u16, len: u32, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx319_write_reg(imx319: *mut imx319, reg: u16, len: u32, val: u32) -> c_int {
...
// Open sub-device
#[no_mangle]
unsafe extern "C" fn imx319_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx319_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// Verify chip ID
#[no_mangle]
unsafe extern "C" fn imx319_identify_module(imx319: *mut imx319) -> c_int {
...
// Start streaming
#[no_mangle]
unsafe extern "C" fn imx319_start_streaming(imx319: *mut imx319) -> c_int {
...
// Stop streaming
#[no_mangle]
unsafe extern "C" fn imx319_stop_streaming(imx319: *mut imx319) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx319_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx319_init_controls(imx319: *mut imx319) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx319_probe(client: *mut i2c_client) -> c_int {
    ...
    clk = devm_v4l2_sensor_clk_get(imx319.dev, core::ptr::null_mut());
    if (IS_ERR(clk))
...
#[no_mangle]
unsafe extern "C" fn imx319_remove(client: *mut i2c_client) {
