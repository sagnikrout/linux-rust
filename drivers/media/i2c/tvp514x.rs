...
//! Source: drivers/media/i2c/tvp514x.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tvp514x_std_info {
    pub width: c_ulong,
    pub height: c_ulong,
    pub video_std: u8,
    pub standard: v4l2_standard,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tvp514x_decoder {
    pub sd: v4l2_subdev,
    pub hdl: v4l2_ctrl_handler,
    pub tvp514x_regs: [tvp514x_reg; ARRAY_SIZE(tvp514x_reg_list_default)],
    pub pdata: *const tvp514x_platform_data,
    pub ver: c_int,
    pub streaming: c_int,
    pub pix: v4l2_pix_format,
    pub num_fmts: c_int,
    pub fmt_list: *const v4l2_fmtdesc,
    pub current_std: enum tvp514x_std,
    pub num_stds: c_int,
    pub std_list: *const tvp514x_std_info,
...
//
#[no_mangle]
unsafe extern "C" fn tvp514x_read_reg(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dump_reg(sd: *mut v4l2_subdev, reg: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn tvp514x_write_reg(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tvp514x_query_current_std(sd: *mut v4l2_subdev) -> enum tvp514x_std {
...
#[no_mangle]
unsafe extern "C" fn tvp514x_reg_dump(sd: *mut v4l2_subdev) {
...
//
#[no_mangle]
unsafe extern "C" fn tvp514x_querystd(sd: *mut v4l2_subdev, std_id: *mut v4l2_std_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tvp514x_s_std(sd: *mut v4l2_subdev, std_id: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp514x_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    static int tvp514x_s_ctrl(struct v4l2_ctrl *ctrl)
    {
    struct v4l2_subdev *sd = to_sd(ctrl);
    struct tvp514x_decoder *decoder = to_decoder(sd);
    let mut err: c_int = -EINVAL, value;
    value = ctrl.val;
    switch (ctrl.id) {
    ...
    value = 0x7F;
#[no_mangle]
pub unsafe extern "C" fn if(-180: value ==) -> else {
    else if (value == -180)
    value = 0x80;
...
#[no_mangle]
unsafe extern "C" fn tvp514x_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
    static int tvp514x_s_stream(struct v4l2_subdev *sd, int enable)
    {
    let mut err: c_int = 0;
    struct tvp514x_decoder *decoder = to_decoder(sd);
...
// Detect if not already detected
    ...
    {
    let mut pad: u32 = code.pad;
    let mut index: u32 = code.index;
    ...
    {
    struct tvp514x_decoder *decoder = to_decoder(sd);
    let mut which: __u32 = format.which;
    if (format.pad)
    return -EINVAL;
...
// Default to NTSC 8-bit YUV 422
    ...
    {
    struct tvp514x_platform_data *pdata = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tvp514x_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp514x_remove(client: *mut i2c_client) {
