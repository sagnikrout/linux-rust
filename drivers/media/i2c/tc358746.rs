...
//! Source: drivers/media/i2c/tc358746.c
#![no_std]
...
// 16-bit registers
pub const CHIPID_REG: c_uint = 0x0000;

pub const SYSCTL_REG: c_uint = 0x0002;

pub const CONFCTL_REG: c_uint = 0x0004;

pub const PDATAF_MODE0: c_int = 0;
pub const PDATAF_MODE1: c_int = 1;
pub const PDATAF_MODE2: c_int = 2;

pub const FIFOCTL_REG: c_uint = 0x0006;
pub const DATAFMT_REG: c_uint = 0x0008;

pub const MCLKCTL_REG: c_uint = 0x000c;

pub const PLLCTL0_REG: c_uint = 0x0016;

pub const PLLCTL1_REG: c_uint = 0x0018;

pub const CLKCTL_REG: c_uint = 0x0020;

pub const MCLKDIV_8: c_int = 0;
pub const MCLKDIV_4: c_int = 1;
pub const MCLKDIV_2: c_int = 2;
pub const WORDCNT_REG: c_uint = 0x0022;
pub const PP_MISC_REG: c_uint = 0x0032;

// 32-bit registers
pub const CLW_DPHYCONTTX_REG: c_uint = 0x0100;
pub const CLW_CNTRL_REG: c_uint = 0x0140;
pub const D0W_CNTRL_REG: c_uint = 0x0144;

pub const STARTCNTRL_REG: c_uint = 0x0204;

pub const LINEINITCNT_REG: c_uint = 0x0210;
pub const LPTXTIMECNT_REG: c_uint = 0x0214;
pub const TCLK_HEADERCNT_REG: c_uint = 0x0218;

pub const TCLK_TRAILCNT_REG: c_uint = 0x021C;
pub const THS_HEADERCNT_REG: c_uint = 0x0220;

pub const TWAKEUP_REG: c_uint = 0x0224;
pub const TCLK_POSTCNT_REG: c_uint = 0x0228;
pub const THS_TRAILCNT_REG: c_uint = 0x022C;
pub const HSTXVREGEN_REG: c_uint = 0x0234;
pub const TXOPTIONCNTRL_REG: c_uint = 0x0238;
pub const CSI_CONTROL_REG: c_uint = 0x040C;

pub const CSI_CONFW_REG: c_uint = 0x0500;

pub const MODE_SET: c_uint = 0x5;

pub const CSI_CONTROL_ADDRESS: c_uint = 0x3;

pub const CSI_START_REG: c_uint = 0x0518;
...
pub struct tc358746 {
    pub sd: v4l2_subdev,
    pub pads: [media_pad; TC358746_NR_PADS],
    pub notifier: v4l2_async_notifier,
    pub csi_vep: v4l2_fwnode_endpoint,
    pub ctrl_hdl: v4l2_ctrl_handler,
    pub regmap: *mut regmap,
    pub refclk: *mut clk,
    pub reset_gpio: *mut gpio_desc,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(tc358746_supplies)],
    pub mclk_hw: clk_hw,
    pub mclk_rate: c_ulong,
    pub mclk_prediv: u8,
    pub mclk_postdiv: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tc358746_format {
    pub code: u32,
    pub csi_format: bool,
    pub bus_width: c_uchar,
    pub bpp: c_uchar,
// Register values
    pub /: *mut *mut u8 pdformat; / Peripheral Data Format,
    pub /: *mut *mut u8 pdataf; / Parallel Data Format Option,
}
...
#[no_mangle]
unsafe extern "C" fn tc358746_src_mbus_code(code: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tc358746_valid_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tc358746_write(tc358746: *mut tc358746, reg: u32, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc358746_read(tc358746: *mut tc358746, reg: u32, val: *mut u32) -> c_int {
...
unsafe extern "C" fn tc358746_sw_reset(tc358746: *mut tc358746) -> c_int {
    ...
    {
    let mut post: u8 = tc358746.pll_post_div;
    let mut pre: u16 = tc358746.pll_pre_div;
    let mut mul: u16 = tc358746.pll_mul;
    u32 val, mask;
    int err;
...
pub const TC358746_VB_PRECISION: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn tc358746_apply_misc_config(tc358746: *mut tc358746) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc358746_ps_to_cnt(cfg_val: c_ulong, clk_hz: c_ulong) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tc358746_us_to_cnt(cfg_val: c_ulong, clk_hz: c_ulong) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tc358746_apply_dphy_config(tc358746: *mut tc358746) -> c_int {
...
pub const MAX_DATA_LANES: c_int = 4;
#[no_mangle]
unsafe extern "C" fn tc358746_enable_csi_lanes(tc358746: *mut tc358746, enable: c_int) -> c_int {
    static int tc358746_enable_csi_lanes(struct tc358746 *tc358746, int enable)
    {
    let mut lanes: c_uint = tc358746.dphy_cfg.lanes;
    unsigned int lane;
    u32 reg, val;
    int err;
...
#[no_mangle]
unsafe extern "C" fn tc358746_enable_csi_module(tc358746: *mut tc358746, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc358746_enable_parallel_port(tc358746: *mut tc358746, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc358746_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
// src_fmt = *sink_fmt;
    ...
    let mut min_delta: u32 = 0xffffffff;
    let mut prediv_max: u16 = 17;
    let mut prediv_min: u16 = 1;
    let mut m_best: u16 = 0, mul;
    let mut p_best: u16 = 1, p;
    u8 postdiv;
    ...
    postdiv = 1;
#[no_mangle]
pub unsafe extern "C" fn if(HZ_PER_MHZ: *mut *mut fout >= 250) -> else {
    else if (fout >= 250 * HZ_PER_MHZ)
    postdiv = 2;
#[no_mangle]
pub unsafe extern "C" fn if(HZ_PER_MHZ: *mut *mut fout >= 125) -> else {
...
#[no_mangle]
unsafe extern "C" fn tc358746_mclk_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(4: tc358746->mclk_prediv ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn tc358746_mclk_disable(hw: *mut clk_hw) {
    ...
    {
    let mut pll_rate: c_ulong = tc358746.pll_rate;
...
// The MCLK <-> PLL gap is to high -> use largest possible div
    ...
    prediv = 8;
#[no_mangle]
pub unsafe extern "C" fn if(MCLKDIV_4: prediv ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn tc358746_setup_mclk_provider(tc358746: *mut tc358746) -> c_int {
    static int tc358746_setup_mclk_provider(struct tc358746 *tc358746)
    {
    let mut mclk_initdata: clk_init_data = { };
    struct device *dev = tc358746.sd.dev;
...
#[no_mangle]
unsafe extern "C" fn tc358746_init_hw(tc358746: *mut tc358746) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc358746_init_controls(tc358746: *mut tc358746) -> c_int {
...
// frequencies.
//
    ctrl = v4l2_ctrl_new_int_menu(&tc358746.ctrl_hdl, core::ptr::null_mut(),
    ...
    let mut flags: u32 = MEDIA_LNK_FL_ENABLED | MEDIA_LNK_FL_IMMUTABLE;
...
#[no_mangle]
unsafe extern "C" fn tc358746_async_register(tc358746: *mut tc358746) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc358746_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc358746_remove(client: *mut i2c_client) {
...
//
#[no_mangle]
unsafe extern "C" fn tc358746_clk_enable(tc358746: *mut tc358746) {
    static void tc358746_clk_enable(struct tc358746 *tc358746)
    {
    clk_prepare_enable(tc358746.refclk);
    }
#[no_mangle]
unsafe extern "C" fn tc358746_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc358746_resume(dev: *mut device) -> c_int {
...
//
    ...
    tc358746_resume, core::ptr::null_mut());
