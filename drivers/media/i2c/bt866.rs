...
//! Source: drivers/media/i2c/bt866.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bt866_write(encoder: *mut bt866, subaddr: u8, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bt866_s_std_output(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bt866_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bt866_remove(client: *mut i2c_client) {
