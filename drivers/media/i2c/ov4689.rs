...
//! Source: drivers/media/i2c/ov4689.c
#![no_std]
...
pub const OV4689_MODE_SW_STANDBY: c_uint = 0x0;

pub const CHIP_ID: c_uint = 0x004688;

pub const OV4689_EXPOSURE_MIN: c_int = 4;
pub const OV4689_EXPOSURE_STEP: c_int = 1;

pub const OV4689_GAIN_STEP: c_int = 1;
pub const OV4689_GAIN_DEFAULT: c_uint = 0x80;

pub const OV4689_DIG_GAIN_MIN: c_int = 1;
pub const OV4689_DIG_GAIN_MAX: c_uint = 0x7fff;
pub const OV4689_DIG_GAIN_STEP: c_int = 1;
pub const OV4689_DIG_GAIN_DEFAULT: c_uint = 0x800;

pub const OV4689_HTS_DIVIDER: c_int = 4;
pub const OV4689_HTS_MAX: c_uint = 0x7fff;

pub const OV4689_VTS_MAX: c_uint = 0x7fff;

    OV4689_TIMING_FLIP_DIGITAL)

pub const OV4689_ANCHOR_LEFT_START_DEF: c_int = 576;

pub const OV4689_ANCHOR_LEFT_END_DEF: c_int = 831;

pub const OV4689_ANCHOR_RIGHT_START_DEF: c_int = 1984;

pub const OV4689_ANCHOR_RIGHT_END_DEF: c_int = 2239;

pub const OV4689_WB_GAIN_MIN: c_int = 1;
pub const OV4689_WB_GAIN_MAX: c_uint = 0xfff;
pub const OV4689_WB_GAIN_STEP: c_int = 1;
pub const OV4689_WB_GAIN_DEFAULT: c_uint = 0x400;

pub const OV4689_TEST_PATTERN_ENABLE: c_uint = 0x80;
pub const OV4689_TEST_PATTERN_DISABLE: c_uint = 0x0;
pub const OV4689_LANES: c_int = 4;
pub const OV4689_XVCLK_FREQ: c_int = 24000000;
pub const OV4689_PIXEL_ARRAY_WIDTH: c_int = 2720;
pub const OV4689_PIXEL_ARRAY_HEIGHT: c_int = 1536;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov4689_mode {
    pub id: enum ov4689_mode_id,
    pub width: u32,
    pub height: u32,
    pub hts_def: u32,
    pub hts_min: u32,
    ...
    pub exp_def: u32,
    pub pixel_rate: u32,
    pub reg_list: *const cci_reg_sequence,
    pub num_regs: c_uint,
}
...
pub struct ov4689 {
    ...
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(ov4689_supply_names)],
    pub subdev: v4l2_subdev,
    pub pad: media_pad,
    pub clock_rate: u32,
    pub ctrl_handler: v4l2_ctrl_handler,
    pub exposure: *mut v4l2_ctrl,
    pub cur_mode: *const ov4689_mode,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov4689_gain_range {
    pub logical_min: u32,
    pub logical_max: u32,
    pub offset: u32,
    pub divider: u32,
...
#[no_mangle]
unsafe extern "C" fn ov4689_enable_test_pattern(ov4689: *mut ov4689, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov4689_setup_timings(ov4689: *mut ov4689) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov4689_setup_blc_anchors(ov4689: *mut ov4689) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov4689_s_stream(sd: *mut v4l2_subdev, on: c_int) -> c_int {
    ...
    OV4689_MODE_STREAMING, core::ptr::null_mut());
    if (ret) {
    pm_runtime_put(dev);
    goto unlock_and_return;
    }
    ...
    OV4689_MODE_SW_STANDBY, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn ov4689_cal_delay(ov4689: *mut ov4689, cycles: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ov4689_power_on(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn ov4689_power_off(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(ov4689_power_off, ov4689_power_on, core::ptr::null_mut())
    };
...
//
#[no_mangle]
unsafe extern "C" fn ov4689_map_gain(ov4689: *mut ov4689, logical_gain: c_int, result: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov4689_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov4689_initialize_controls(ov4689: *mut ov4689) -> c_int {
    ...
    v4l2_ctrl_new_std(handler, core::ptr::null_mut(), V4L2_CID_PIXEL_RATE, 0,
    ...
    let mut id: u64 = 0;
    int ret;
    ret = cci_read(ov4689.regmap, OV4689_REG_CHIP_ID, &id, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn ov4689_configure_regulators(ov4689: *mut ov4689) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov4689_check_link_frequency(ep: *mut v4l2_fwnode_endpoint) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn ov4689_check_hwcfg(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov4689_probe(client: *mut i2c_client) -> c_int {
    ...
    ov4689.xvclk = devm_v4l2_sensor_clk_get(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ov4689_remove(client: *mut i2c_client) {
