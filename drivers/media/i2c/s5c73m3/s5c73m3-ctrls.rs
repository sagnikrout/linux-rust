...
//! Source: drivers/media/i2c/s5c73m3/s5c73m3-ctrls.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_get_af_status(state: *mut s5c73m3, ctrl: *mut v4l2_ctrl) -> c_int {
    static int s5c73m3_get_af_status(struct s5c73m3 *state, struct v4l2_ctrl *ctrl)
    {
    let mut reg: u16 = REG_AF_STATUS_UNFOCUSED;
    let mut ret: c_int = s5c73m3_read(state, REG_AF_STATUS, &reg);
    switch (reg) {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_g_volatile_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_colorfx(state: *mut s5c73m3, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_exposure(state: *mut s5c73m3, auto_exp: c_int) -> c_int {
    ...
    let mut exp_bias: u16 = ctrls.exposure_bias.val;
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_white_balance(state: *mut s5c73m3, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_af_run(state: *mut s5c73m3, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_3a_lock(state: *mut s5c73m3, ctrl: *mut v4l2_ctrl) -> c_int {
    static int s5c73m3_3a_lock(struct s5c73m3 *state, struct v4l2_ctrl *ctrl)
    {
    let mut awb_lock: bool = ctrl.val & V4L2_LOCK_WHITE_BALANCE;
    let mut ae_lock: bool = ctrl.val & V4L2_LOCK_EXPOSURE;
    let mut af_lock: bool = ctrl.val & V4L2_LOCK_FOCUS;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_auto_focus(state: *mut s5c73m3, caf: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_contrast(state: *mut s5c73m3, val: c_int) -> c_int {
    static int s5c73m3_set_contrast(struct s5c73m3 *state, int val)
    {
    let mut reg: u16 = (val < 0) ? -val + 2 : val;
    return s5c73m3_isp_command(state, COMM_CONTRAST, reg);
    }
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_saturation(state: *mut s5c73m3, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_sharpness(state: *mut s5c73m3, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_iso(state: *mut s5c73m3, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_stabilization(state: *mut s5c73m3, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_jpeg_quality(state: *mut s5c73m3, quality: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(75: quality <=) -> else {
    else if (quality <= 75)
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_scene_program(state: *mut s5c73m3, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_power_line_freq(state: *mut s5c73m3, val: c_int) -> c_int {
    static int s5c73m3_set_power_line_freq(struct s5c73m3 *state, int val)
    {
    let mut pwr_line_freq: c_uint = COMM_FLICKER_NONE;
    switch (val) {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn s5c73m3_init_controls(state: *mut s5c73m3) -> c_int {
    int s5c73m3_init_controls(struct s5c73m3 *state)
    {
    const struct v4l2_ctrl_ops *ops = &s5c73m3_ctrl_ops;
    struct s5c73m3_ctrls *ctrls = &state.ctrls;
    struct v4l2_ctrl_handler *hdl = &ctrls.handler;
    let mut ret: c_int = v4l2_ctrl_handler_init(hdl, 22);
    if (ret)
    return ret;
// White balance
