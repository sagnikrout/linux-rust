...
//! Source: drivers/media/i2c/s5c73m3/s5c73m3-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_i2c_write(client: *mut i2c_client, addr: u16, data: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_i2c_read(client: *mut i2c_client, addr: u16, data: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn s5c73m3_write(state: *mut s5c73m3, addr: u32, data: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn s5c73m3_read(state: *mut s5c73m3, addr: u32, data: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_check_status(state: *mut s5c73m3, value: c_uint) -> c_int {
    static int s5c73m3_check_status(struct s5c73m3 *state, unsigned int value)
    {
    let mut start: c_ulong = jiffies;
    let mut end: c_ulong = start + msecs_to_jiffies(2000);
    int ret;
    u16 status;
    ...
    if (ret == 0 && status != value) {
    let mut i2c_status: u16 = 0;
    let mut i2c_seq_status: u16 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn s5c73m3_isp_command(state: *mut s5c73m3, command: u16, data: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_af_softlanding(state: *mut s5c73m3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_load_fw(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_frame_size(state: *mut s5c73m3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_frame_rate(state: *mut s5c73m3) -> c_int {
    static int s5c73m3_set_frame_rate(struct s5c73m3 *state)
    {
    int ret;
    if (state.ctrls.stabilization.val)
    return 0;
    if (WARN_ON(state.fiv == core::ptr::null_mut()))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_oif_s_stream(sd: *mut v4l2_subdev, on: c_int) -> c_int {
    ...
    let mut reg: u16 = 0;
    while (steps-- > 0) {
    let mut ret: c_int = s5c73m3_read(state, 0x30100010, &reg);
    if (ret < 0)
    return ret;
    if (reg == value)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_read_fw_version(state: *mut s5c73m3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_fw_update_from(state: *mut s5c73m3) -> c_int {
    static int s5c73m3_fw_update_from(struct s5c73m3 *state)
    {
    struct v4l2_subdev *sd = &state.sensor_sd;
    let mut status: u16 = COMM_FW_UPDATE_NOT_READY;
    int ret;
    let mut count: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_spi_boot(state: *mut s5c73m3, load_fw: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_timing_register_for_vdd(state: *mut s5c73m3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_set_fw_file_version(state: *mut s5c73m3) {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_get_fw_version(state: *mut s5c73m3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_rom_boot(state: *mut s5c73m3, load_fw: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_isp_init(state: *mut s5c73m3) -> c_int {
    ...
    let mut best_dist: c_int = INT_MAX;
    int i;
    fs = s5c73m3_resolutions[idx];
    best_fs = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_oif_get_pad_code(pad: c_int, index: c_int) -> c_int {
    ...
    struct v4l2_subdev_format *fmt)
    {
    const struct s5c73m3_frame_size *frame_size = core::ptr::null_mut();
    struct s5c73m3 *state = sensor_sd_to_s5c73m3(sd);
...
// mf = fmt->format;
    ...
    struct s5c73m3 *state = oif_sd_to_s5c73m3(sd);
    int i;
    if (pad != OIF_SOURCE_PAD || fd == core::ptr::null_mut())
    return -EINVAL;
    mutex_lock(&state.lock);
    fd.num_entries = 2;
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_oif_log_status(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_oif_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __s5c73m3_power_on(state: *mut s5c73m3) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5c73m3_enable_clk(state: *mut s5c73m3) {
    static void s5c73m3_enable_clk(struct s5c73m3 *state)
    {
    clk_prepare_enable(state.clock);
    }
#[no_mangle]
unsafe extern "C" fn __s5c73m3_power_off(state: *mut s5c73m3) -> c_int {
    ...
    let mut r: c_int = regulator_enable(state.supplies[i].consumer);
    if (r < 0)
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_oif_set_power(sd: *mut v4l2_subdev, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_oif_registered(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_oif_unregistered(sd: *mut v4l2_subdev) {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_get_dt_data(state: *mut s5c73m3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5c73m3_remove(client: *mut i2c_client) {
