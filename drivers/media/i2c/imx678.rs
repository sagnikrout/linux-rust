...
//! Source: drivers/media/i2c/imx678.c
#![no_std]
...
pub const IMX678_MODE_STANDBY: c_uint = 0x01;
pub const IMX678_MODE_STREAMING: c_uint = 0x00;
pub const IMX678_STREAM_DELAY_US: c_int = 25000;
pub const IMX678_STREAM_DELAY_RANGE_US: c_int = 1000;
...
//
pub const IMX678_PIXEL_RATE: c_int = 594000000;
pub const IMX678_PIX_PER_CLK: c_int = 8;
// VMAX - Frame Length in Lines

pub const IMX678_VMAX_MAX: c_uint = 0xfffff;
pub const IMX678_VMAX_DEFAULT: c_int = 2250;
// HMAX - Line Length in Cycles (8 Pixels)

pub const IMX678_HMAX_MAX: c_uint = 0xffff;
// SHR internal

pub const IMX678_SHR_MIN: c_int = 8;
// Exposure control
pub const IMX678_EXPOSURE_MIN: c_int = 2;
pub const IMX678_EXPOSURE_STEP: c_int = 1;
pub const IMX678_EXPOSURE_DEFAULT: c_int = 1000;
//
...
pub const IMX678_ANA_GAIN_MIN_NORMAL: c_int = 0;
pub const IMX678_ANA_GAIN_MAX_NORMAL: c_int = 100;
pub const IMX678_ANA_GAIN_STEP: c_int = 1;
pub const IMX678_ANA_GAIN_DEFAULT: c_int = 0;
// Crop
...
pub const IMX678_ID: c_uint = 0x02a6;
pub const IMX678_MODULE_ID_DELAY: c_int = 80000;
// Common configuration registers

// Test pattern generator

pub const IMX678_TPG_ALL_000: c_int = 0;
pub const IMX678_TPG_ALL_FFF: c_int = 1;
pub const IMX678_TPG_ALL_555: c_int = 2;
pub const IMX678_TPG_ALL_AAA: c_int = 3;
pub const IMX678_TPG_TOG_555_AAA: c_int = 4;
pub const IMX678_TPG_TOG_AAA_555: c_int = 5;
pub const IMX678_TPG_TOG_000_555: c_int = 6;
pub const IMX678_TPG_TOG_555_000: c_int = 7;
pub const IMX678_TPG_TOG_000_FFF: c_int = 8;
pub const IMX678_TPG_TOG_FFF_000: c_int = 9;
pub const IMX678_TPG_H_COLOR_BARS: c_int = 10;
pub const IMX678_TPG_V_COLOR_BARS: c_int = 11;

pub const IMX678_TPG_COLORWIDTH_80PIX: c_int = 0;
pub const IMX678_TPG_COLORWIDTH_160PIX: c_int = 1;
pub const IMX678_TPG_COLORWIDTH_320PIX: c_int = 2;
pub const IMX678_TPG_COLORWIDTH_640PIX: c_int = 3;

pub const IMX678_INTERFACE_2L_4L: c_uint = 0x07;
pub const IMX678_INTERFACE_8L_2x4L: c_uint = 0x7f;
// Minimum output resolution
pub const IMX678_PIXEL_ARRAY_MIN_WIDTH: c_int = 1040;
pub const IMX678_PIXEL_ARRAY_MIN_HEIGHT: c_int = 956;
// Sensor windowing register alignment
pub const IMX678_CROP_HWIDTH_ALIGN: c_int = 16;
pub const IMX678_CROP_VWIDTH_ALIGN: c_int = 4;
pub const IMX678_CROP_HST_ALIGN: c_int = 4;
pub const IMX678_CROP_VST_ALIGN: c_int = 4;
// Subdev pads
pub const IMX678_SOURCE_PAD: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx678_model_info {
    pub type: enum imx678_type,
    pub codes: *const u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx678_inck_cfg {
    pub /: *mut *mut u32 xclk_hz; / platform clock rate,
    pub /: *mut *mut u8 inck_sel; / value for reg,
}
...
pub struct imx678 {
    ...
    pub pad: media_pad,
    pub cci: *mut regmap,
    pub info: *const imx678_model_info,
    pub xclk: *mut clk,
    pub xclk_freq: u32,
// chosen INCK_SEL register value
    pub inck_sel_val: u8,
// Link configurations
    pub lane_mode: enum imx678_lanemode,
    pub link_freq_bitmap: c_ulong,
    pub reset_gpio: *mut gpio_desc,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(imx678_supply_name)],
...
#[no_mangle]
unsafe extern "C" fn imx678_default_mbus_code(imx678: *mut imx678) -> u32 {
    static u32 imx678_default_mbus_code(struct imx678 *imx678)
    {
    return imx678.info.codes[0];
    }
#[no_mangle]
unsafe extern "C" fn imx678_mbus_code_supported(imx678: *mut imx678, code: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn imx678_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    let mut current_exposure: u32 = imx678.exposure.cur.val;
...
//
    ...
    let mut shr: u32 = imx678.vmax - imx678.exposure.val;
    ...
    let mut hmax: u32 = (format.width + ctrl.val) / IMX678_PIX_PER_CLK;
...
#[no_mangle]
unsafe extern "C" fn imx678_write_common(imx678: *mut imx678) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx678_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx678_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx678_identify_model(imx678: *mut imx678) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx678_init_controls(imx678: *mut imx678) -> c_int {
    static int imx678_init_controls(struct imx678 *imx678)
    {
    struct v4l2_ctrl_handler *ctrl_hdlr;
    let mut hmax_4lane: u32 = min_hmax_4lane[__ffs(imx678.link_freq_bitmap)];
    let mut lane_scale: u32 = imx678.lane_mode == IMX678_LANEMODE_2L ? 2 : 1;
    struct i2c_client *client = v4l2_get_subdevdata(&imx678.sd);
...
#[no_mangle]
unsafe extern "C" fn imx678_check_hwcfg(dev: *mut device, imx678: *mut imx678) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx678_probe(client: *mut i2c_client) -> c_int {
    ...
    return -EINVAL;
    imx678.xclk = devm_v4l2_sensor_clk_get(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn imx678_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(imx678_power_off, imx678_power_on, core::ptr::null_mut())
    };
