...
//! Source: drivers/media/i2c/saa7110.c
#![no_std]
...
pub const SAA7110_NR_REG: c_uint = 0x35;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct saa7110 {
    pub sd: v4l2_subdev,
    pub hdl: v4l2_ctrl_handler,
    pub reg: [u8; SAA7110_NR_REG],
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn saa7110_write(sd: *mut v4l2_subdev, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7110_write_block(sd: *mut v4l2_subdev, data: *const u8, len: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7110_read(sd: *mut v4l2_subdev) -> c_int {
...
// SAA7110 functions
// -----------------------------------------------------------------------
pub const FRESP_06H_COMPST: c_uint = 0x03	/*0x13*/;
pub const FRESP_06H_SVIDEO: c_uint = 0x83	/*0xC0*/;
#[no_mangle]
unsafe extern "C" fn saa7110_selmux(sd: *mut v4l2_subdev, chan: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn determine_norm(sd: *mut v4l2_subdev) -> v4l2_std_id {
...
#[no_mangle]
unsafe extern "C" fn saa7110_g_input_status(sd: *mut v4l2_subdev, pstatus: *mut u32) -> c_int {
    static int saa7110_g_input_status(struct v4l2_subdev *sd, u32 *pstatus)
    {
    struct saa7110 *decoder = to_saa7110(sd);
    let mut res: c_int = V4L2_IN_ST_NO_SIGNAL;
    let mut status: c_int = saa7110_read(sd);
...
#[no_mangle]
unsafe extern "C" fn saa7110_querystd(sd: *mut v4l2_subdev, std: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7110_s_std(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7110_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7110_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn saa7110_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7110_remove(client: *mut i2c_client) {
