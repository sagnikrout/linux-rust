...
//! Source: drivers/media/i2c/hi847.c
#![no_std]
...
pub const HI847_REG_VALUE_08BIT: c_int = 1;
pub const HI847_REG_VALUE_16BIT: c_int = 2;
pub const HI847_REG_VALUE_24BIT: c_int = 3;

pub const HI847_MCLK: c_int = 19200000;
pub const HI847_DATA_LANES: c_int = 4;
pub const HI847_RGB_DEPTH: c_int = 10;
pub const HI847_REG_CHIP_ID: c_uint = 0x0716;
pub const HI847_CHIP_ID: c_uint = 0x0847;
pub const HI847_REG_MODE_SELECT: c_uint = 0x0B00;
pub const HI847_MODE_STANDBY: c_uint = 0x0000;
pub const HI847_MODE_STREAMING: c_uint = 0x0100;
pub const HI847_REG_MODE_TG: c_uint = 0x027E;
pub const HI847_REG_MODE_TG_ENABLE: c_uint = 0x0100;
pub const HI847_REG_MODE_TG_DISABLE: c_uint = 0x0000;
// vertical-timings from sensor
pub const HI847_REG_FLL: c_uint = 0x020E;
pub const HI847_FLL_30FPS: c_uint = 0x0B51;
pub const HI847_FLL_30FPS_MIN: c_uint = 0x0B51;
pub const HI847_FLL_60FPS: c_uint = 0x05A9;
pub const HI847_FLL_60FPS_MIN: c_uint = 0x05A9;
pub const HI847_FLL_MAX: c_uint = 0x7fff;
// horizontal-timings from sensor
pub const HI847_REG_LLP: c_uint = 0x0206;
// Exposure controls from sensor
pub const HI847_REG_EXPOSURE: c_uint = 0x020A;
pub const HI847_EXPOSURE_MIN: c_int = 4;
pub const HI847_EXPOSURE_MAX_MARGIN: c_int = 4;
pub const HI847_EXPOSURE_STEP: c_int = 1;
// Analog gain controls from sensor
pub const HI847_REG_ANALOG_GAIN: c_uint = 0x0212;
pub const HI847_ANAL_GAIN_MIN: c_int = 0;
pub const HI847_ANAL_GAIN_MAX: c_int = 240;
pub const HI847_ANAL_GAIN_STEP: c_int = 1;
// Digital gain controls from sensor
pub const HI847_REG_MWB_GR_GAIN: c_uint = 0x0214;
pub const HI847_REG_MWB_GB_GAIN: c_uint = 0x0216;
pub const HI847_REG_MWB_R_GAIN: c_uint = 0x0218;
pub const HI847_REG_MWB_B_GAIN: c_uint = 0x021A;
pub const HI847_DGTL_GAIN_MIN: c_int = 1;
pub const HI847_DGTL_GAIN_MAX: c_int = 8191;
pub const HI847_DGTL_GAIN_STEP: c_int = 1;
pub const HI847_DGTL_GAIN_DEFAULT: c_int = 512;
// Test Pattern Control

pub const HI847_REG_ISP_TPG_EN: c_uint = 0x0001;
pub const HI847_REG_TEST_PATTERN: c_uint = 0x0C0A;
// Flip Mirror Controls from sensor
pub const HI847_REG_MIRROR_FLIP: c_uint = 0x0202;
pub const HI847_REG_FORMAT_X: c_uint = 0x0F04;
pub const HI847_REG_FORMAT_Y: c_uint = 0x0F06;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hi847_reg_list {
    pub num_of_regs: u32,
    pub regs: *const hi847_reg,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hi847_link_freq_config {
    pub reg_list: hi847_reg_list,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hi847_mode {
...
unsafe extern "C" fn to_pixel_rate(f_index: u32) -> u64 {
    ...
    {
    let mut pixel_rate: u64 = link_freq_menu_items[f_index] * 2 * HI847_DATA_LANES;
    do_div(pixel_rate, HI847_RGB_DEPTH);
    return pixel_rate;
    }
#[no_mangle]
unsafe extern "C" fn hi847_read_reg(hi847: *mut hi847, reg: u16, len: u16, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi847_write_reg(hi847: *mut hi847, reg: u16, len: u16, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi847_update_digital_gain(hi847: *mut hi847, d_gain: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi847_test_pattern(hi847: *mut hi847, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi847_grbg_shift(hi847: *mut hi847) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi847_set_ctrl_hflip(hi847: *mut hi847, ctrl_val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi847_set_ctrl_vflip(hi847: *mut hi847, ctrl_val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi847_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi847_init_controls(hi847: *mut hi847) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi847_start_streaming(hi847: *mut hi847) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi847_stop_streaming(hi847: *mut hi847) {
...
#[no_mangle]
unsafe extern "C" fn hi847_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi847_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi847_identify_module(hi847: *mut hi847) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi847_check_hwcfg(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi847_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn hi847_probe(client: *mut i2c_client) -> c_int {
    ...
    hi847.clk = devm_v4l2_sensor_clk_get(hi847.dev, core::ptr::null_mut());
    if (IS_ERR(hi847.clk))
