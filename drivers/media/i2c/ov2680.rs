...
//! Source: drivers/media/i2c/ov2680.c
#![no_std]
...
pub const OV2680_CHIP_ID: c_uint = 0x2680;

pub const OV2680_FRAME_RATE: c_int = 30;
pub const OV2680_NATIVE_WIDTH: c_int = 1616;
pub const OV2680_NATIVE_HEIGHT: c_int = 1216;
pub const OV2680_NATIVE_START_LEFT: c_int = 0;
pub const OV2680_NATIVE_START_TOP: c_int = 0;
pub const OV2680_ACTIVE_WIDTH: c_int = 1600;
pub const OV2680_ACTIVE_HEIGHT: c_int = 1200;
pub const OV2680_ACTIVE_START_LEFT: c_int = 8;
pub const OV2680_ACTIVE_START_TOP: c_int = 8;
pub const OV2680_MIN_CROP_WIDTH: c_int = 2;
pub const OV2680_MIN_CROP_HEIGHT: c_int = 2;
pub const OV2680_MIN_VBLANK: c_int = 4;
pub const OV2680_MAX_VBLANK: c_uint = 0xffff;
// Fixed pre-div of 1/2
pub const OV2680_PLL_PREDIV0: c_int = 2;
// Pre-div configurable through reg 0x3080, left at its default of 0x02 : 1/2
pub const OV2680_PLL_PREDIV: c_int = 2;
// 66MHz pixel clock: 66MHz / 1704 * 1294 = 30fps
pub const OV2680_PIXELS_PER_LINE: c_int = 1704;
pub const OV2680_LINES_PER_FRAME_30FPS: c_int = 1294;
// Max exposure time is VTS - 8
pub const OV2680_INTEGRATION_TIME_MARGIN: c_int = 8;
pub const OV2680_DEFAULT_WIDTH: c_int = 800;
pub const OV2680_DEFAULT_HEIGHT: c_int = 600;
// For enum_frame_size() full-size + binned-/quarter-size
pub const OV2680_FRAME_SIZES: c_int = 2;
...
pub struct ov2680_mode {
    ...
    pub h_end: u16,
    pub v_end: u16,
    pub h_output_size: u16,
    pub v_output_size: u16,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov2680_dev {
    pub dev: *mut device,
    ...
    pub link_freq: [i64; 1],
    pub pixel_rate: u64,
    pub supplies: [regulator_bulk_data; OV2680_NUM_SUPPLIES],
    pub pwdn_gpio: *mut gpio_desc,
    pub /: *mut *mut mutex lock; / protect members,
    pub is_streaming: bool,
    pub ctrls: ov2680_ctrls,
    pub mode: ov2680_mode,
}
...
#[no_mangle]
unsafe extern "C" fn ov2680_power_up(sensor: *mut ov2680_dev) {
...
#[no_mangle]
unsafe extern "C" fn ov2680_power_down(sensor: *mut ov2680_dev) {
...
#[no_mangle]
unsafe extern "C" fn ov2680_calc_mode(sensor: *mut ov2680_dev) {
    static void ov2680_calc_mode(struct ov2680_dev *sensor)
    {
    let mut width: c_int = sensor.mode.fmt.width;
    let mut height: c_int = sensor.mode.fmt.height;
    let mut orig_width: c_int = width;
    let mut orig_height: c_int = height;
...
#[no_mangle]
unsafe extern "C" fn ov2680_set_mode(sensor: *mut ov2680_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2680_set_vflip(sensor: *mut ov2680_dev, val: i32) -> c_int {
    ...
    BIT(2), val ? BIT(2) : 0, core::ptr::null_mut());
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn ov2680_set_hflip(sensor: *mut ov2680_dev, val: i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2680_test_pattern_set(sensor: *mut ov2680_dev, value: c_int) -> c_int {
    static int ov2680_test_pattern_set(struct ov2680_dev *sensor, int value)
    {
    let mut ret: c_int = 0;
    if (!value)
    return cci_update_bits(sensor.regmap, OV2680_REG_ISP_CTRL00,
    BIT(7), 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ov2680_gain_set(sensor: *mut ov2680_dev, gain: u32) -> c_int {
    static int ov2680_gain_set(struct ov2680_dev *sensor, u32 gain)
    {
    return cci_write(sensor.regmap, OV2680_REG_GAIN_PK, gain, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ov2680_exposure_set(sensor: *mut ov2680_dev, exp: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2680_exposure_update_range(sensor: *mut ov2680_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2680_stream_enable(sensor: *mut ov2680_dev) -> c_int {
    static int ov2680_stream_enable(struct ov2680_dev *sensor)
    {
    int ret;
    ret = cci_write(sensor.regmap, OV2680_REG_PLL_MULTIPLIER,
    sensor.pll_mult, core::ptr::null_mut());
    if (ret < 0)
    return ret;
...
// Restore value of all ctrls
    ...
    if (ret < 0)
    return ret;
    return cci_write(sensor.regmap, OV2680_REG_STREAM_CTRL, 1, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ov2680_stream_disable(sensor: *mut ov2680_dev) -> c_int {
    static int ov2680_stream_disable(struct ov2680_dev *sensor)
    {
    return cci_write(sensor.regmap, OV2680_REG_STREAM_CTRL, 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ov2680_power_off(sensor: *mut ov2680_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2680_power_on(sensor: *mut ov2680_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2680_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2680_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// Only apply changes to the controls if the device is powered up
    ...
    sensor.mode.fmt.height + ctrl.val, core::ptr::null_mut());
    break;
    default:
    ret = -EINVAL;
    break;
...
#[no_mangle]
unsafe extern "C" fn ov2680_mode_init(sensor: *mut ov2680_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2680_v4l2_register(sensor: *mut ov2680_dev) -> c_int {
    ...
    0, 1023, 1, 250);
    ctrls.link_freq = v4l2_ctrl_new_int_menu(hdl, core::ptr::null_mut(), V4L2_CID_LINK_FREQ,
...
#[no_mangle]
unsafe extern "C" fn ov2680_get_regulators(sensor: *mut ov2680_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2680_check_id(sensor: *mut ov2680_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2680_parse_dt(sensor: *mut ov2680_dev) -> c_int {
...
//
    ep_fwnode = fwnode_graph_get_next_endpoint(dev_fwnode(dev), core::ptr::null_mut());
    if (!ep_fwnode)
...
#[no_mangle]
unsafe extern "C" fn ov2680_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2680_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ov2680_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov2680_resume(dev: *mut device) -> c_int {
