...
//! Source: drivers/media/i2c/cs53l32a.c
#![no_std]
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn cs53l32a_write(sd: *mut v4l2_subdev, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs53l32a_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs53l32a_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs53l32a_log_status(sd: *mut v4l2_subdev) -> c_int {
    static int cs53l32a_log_status(struct v4l2_subdev *sd)
    {
    struct cs53l32a_state *state = to_state(sd);
    let mut v: u8 = cs53l32a_read(sd, 0x01);
...
//
#[no_mangle]
unsafe extern "C" fn cs53l32a_probe(client: *mut i2c_client) -> c_int {
...
// Check if the adapter supports the needed features
    ...
    for (i = 1; i <= 7; i++) {
    let mut v: u8 = cs53l32a_read(sd, i);
...
#[no_mangle]
unsafe extern "C" fn cs53l32a_remove(client: *mut i2c_client) {
