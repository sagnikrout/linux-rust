...
//! Source: drivers/media/i2c/ov7670.c
#![no_std]
...
//
pub const OV7670_I2C_ADDR: c_uint = 0x42;
pub const PLL_FACTOR: c_int = 4;
// Registers
pub const REG_GAIN: c_uint = 0x00	/* Gain lower 8 bits (rest in vref) */;
pub const REG_BLUE: c_uint = 0x01	/* blue gain */;
pub const REG_RED: c_uint = 0x02	/* red gain */;
pub const REG_VREF: c_uint = 0x03	/* Pieces of GAIN, VSTART, VSTOP */;
pub const REG_COM1: c_uint = 0x04	/* Control 1 */;
pub const COM1_CCIR656: c_uint = 0x40  /* CCIR656 enable */;
pub const REG_BAVE: c_uint = 0x05	/* U/B Average level */;
pub const REG_GbAVE: c_uint = 0x06	/* Y/Gb Average level */;
pub const REG_AECHH: c_uint = 0x07	/* AEC MS 5 bits */;
pub const REG_RAVE: c_uint = 0x08	/* V/R Average level */;
pub const REG_COM2: c_uint = 0x09	/* Control 2 */;
pub const COM2_SSLEEP: c_uint = 0x10	/* Soft sleep mode */;
pub const REG_PID: c_uint = 0x0a	/* Product ID MSB */;
pub const REG_VER: c_uint = 0x0b	/* Product ID LSB */;
pub const REG_COM3: c_uint = 0x0c	/* Control 3 */;
pub const COM3_SWAP: c_uint = 0x40	  /* Byte swap */;
pub const COM3_SCALEEN: c_uint = 0x08	  /* Enable scaling */;
pub const COM3_DCWEN: c_uint = 0x04	  /* Enable downsamp/crop/window */;
pub const REG_COM4: c_uint = 0x0d	/* Control 4 */;
pub const REG_COM5: c_uint = 0x0e	/* All "reserved" */;
pub const REG_COM6: c_uint = 0x0f	/* Control 6 */;
pub const REG_AECH: c_uint = 0x10	/* More bits of AEC value */;
pub const REG_CLKRC: c_uint = 0x11	/* Clocl control */;
pub const CLK_EXT: c_uint = 0x40	  /* Use external clock directly */;
pub const CLK_SCALE: c_uint = 0x3f	  /* Mask for internal clock scale */;
pub const REG_COM7: c_uint = 0x12	/* Control 7 */;
pub const COM7_RESET: c_uint = 0x80	  /* Register reset */;
pub const COM7_FMT_MASK: c_uint = 0x38;
pub const COM7_FMT_VGA: c_uint = 0x00;
pub const COM7_FMT_CIF: c_uint = 0x20	  /* CIF format */;
pub const COM7_FMT_QVGA: c_uint = 0x10	  /* QVGA format */;
pub const COM7_FMT_QCIF: c_uint = 0x08	  /* QCIF format */;
pub const COM7_RGB: c_uint = 0x04	  /* bits 0 and 2 - RGB format */;
pub const COM7_YUV: c_uint = 0x00	  /* YUV */;
pub const COM7_BAYER: c_uint = 0x01	  /* Bayer format */;
pub const COM7_PBAYER: c_uint = 0x05	  /* "Processed bayer" */;
pub const REG_COM8: c_uint = 0x13	/* Control 8 */;
...
pub const REG_COM9: c_uint = 0x14	/* Control 9  - gain ceiling */;
pub const REG_COM10: c_uint = 0x15	/* Control 10 */;
...
pub const REG_MIDH: c_uint = 0x1c	/* Manuf. ID high */;
pub const REG_MIDL: c_uint = 0x1d	/* Manuf. ID low */;
pub const REG_MVFP: c_uint = 0x1e	/* Mirror / vflip */;
...
pub const REG_HSYST: c_uint = 0x30	/* HSYNC rising edge delay */;
pub const REG_HSYEN: c_uint = 0x31	/* HSYNC falling edge delay */;
pub const REG_HREF: c_uint = 0x32	/* HREF pieces */;
pub const REG_TSLB: c_uint = 0x3a	/* lots of stuff */;
pub const TSLB_YLAST: c_uint = 0x04	  /* UYVY or VYUY - see com13 */;
pub const REG_COM11: c_uint = 0x3b	/* Control 11 */;
pub const COM11_NIGHT: c_uint = 0x80	  /* NIght mode enable */;
pub const COM11_NMFR: c_uint = 0x60	  /* Two bit NM frame rate */;
pub const COM11_HZAUTO: c_uint = 0x10	  /* Auto detect 50/60 Hz */;
pub const COM11_50HZ: c_uint = 0x08	  /* Manual 50Hz select */;
pub const COM11_EXP: c_uint = 0x02;
pub const REG_COM12: c_uint = 0x3c	/* Control 12 */;
pub const COM12_HREF: c_uint = 0x80	  /* HREF always */;
pub const REG_COM13: c_uint = 0x3d	/* Control 13 */;
...
pub const REG_COM14: c_uint = 0x3e	/* Control 14 */;
pub const COM14_DCWEN: c_uint = 0x10	  /* DCW/PCLK-scale enable */;
pub const REG_EDGE: c_uint = 0x3f	/* Edge enhancement factor */;
pub const REG_COM15: c_uint = 0x40	/* Control 15 */;
...
pub const REG_COM16: c_uint = 0x41	/* Control 16 */;
pub const COM16_AWBGAIN: c_uint = 0x08	  /* AWB gain enable */;
pub const REG_COM17: c_uint = 0x42	/* Control 17 */;
pub const COM17_AECWIN: c_uint = 0xc0	  /* AEC window - must match COM4 */;
pub const COM17_CBAR: c_uint = 0x08	  /* DSP Color bar */;
//
...
//
pub const REG_CMATRIX_BASE: c_uint = 0x4f;
pub const CMATRIX_LEN: c_int = 6;
pub const REG_CMATRIX_SIGN: c_uint = 0x58;
pub const REG_BRIGHT: c_uint = 0x55	/* Brightness */;
pub const REG_CONTRAS: c_uint = 0x56	/* Contrast control */;
pub const REG_GFIX: c_uint = 0x69	/* Fix gain control */;
pub const REG_DBLV: c_uint = 0x6b	/* PLL control an debugging */;
pub const DBLV_BYPASS: c_uint = 0x0a	  /* Bypass PLL */;
pub const DBLV_X4: c_uint = 0x4a	  /* clock x4 */;
pub const DBLV_X6: c_uint = 0x8a	  /* clock x6 */;
pub const DBLV_X8: c_uint = 0xca	  /* clock x8 */;
pub const REG_SCALING_XSC: c_uint = 0x70	/* Test pattern and horizontal scale factor */;
pub const TEST_PATTTERN_0: c_uint = 0x80;
pub const REG_SCALING_YSC: c_uint = 0x71	/* Test pattern and vertical scale factor */;
pub const TEST_PATTTERN_1: c_uint = 0x80;
pub const REG_REG76: c_uint = 0x76	/* OV's name */;
pub const R76_BLKPCOR: c_uint = 0x80	  /* Black pixel correction enable */;
pub const R76_WHTPCOR: c_uint = 0x40	  /* White pixel correction enable */;
pub const REG_RGB444: c_uint = 0x8c	/* RGB 444 control */;
pub const R444_ENABLE: c_uint = 0x02	  /* Turn on RGB444, overrides 5x5 */;
pub const R444_RGBX: c_uint = 0x01	  /* Empty nibble at end */;
pub const REG_HAECC1: c_uint = 0x9f	/* Hist AEC/AGC control 1 */;
pub const REG_HAECC2: c_uint = 0xa0	/* Hist AEC/AGC control 2 */;
pub const REG_BD50MAX: c_uint = 0xa5	/* 50hz banding step limit */;
pub const REG_HAECC3: c_uint = 0xa6	/* Hist AEC/AGC control 3 */;
pub const REG_HAECC4: c_uint = 0xa7	/* Hist AEC/AGC control 4 */;
pub const REG_HAECC5: c_uint = 0xa8	/* Hist AEC/AGC control 5 */;
pub const REG_HAECC6: c_uint = 0xa9	/* Hist AEC/AGC control 6 */;
pub const REG_HAECC7: c_uint = 0xaa	/* Hist AEC/AGC control 7 */;
pub const REG_BD60MAX: c_uint = 0xab	/* 60hz banding step limit */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov7670_win_size {
    pub width: c_int,
    pub height: c_int,
    pub com7_bit: c_uchar,
    pub /: *mut *mut int hstart; / Start/stop values for the camera. Note,
    pub /: *mut *mut int hstop; / that they do not always make complete,
    pub /: *mut *mut int vstart; / sense to humans, but evidently the sensor,
    pub /: *mut *mut int vstop; / will do the right thing...,
    pub /: *mut *mut *mut regval_list regs; / Regs to tweak,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov7670_devtype {
// formats supported for each model
    pub win_sizes: *mut ov7670_win_size,
    pub n_win_sizes: c_uint,
// callbacks for frame rate control
    pub ): *mut *mut *mut int (set_framerate)(struct v4l2_subdev , struct v4l2_fract,
    pub ): *mut *mut *mut void (get_framerate)(struct v4l2_subdev , struct v4l2_fract,
}
...
// value = (unsigned char)ret;
    ...
    {
    struct i2c_client *client = v4l2_get_subdevdata(sd);
    let mut ret: c_int = i2c_smbus_write_byte_data(client, reg, value);
...
//
#[no_mangle]
unsafe extern "C" fn ov7670_write_array(sd: *mut v4l2_subdev, vals: *mut regval_list) -> c_int {
    static int ov7670_write_array(struct v4l2_subdev *sd, struct regval_list *vals)
    {
    while (vals.reg_num != 0xff || vals.value != 0xff) {
    let mut ret: c_int = ov7670_write(sd, vals.reg_num, vals.value);
    if (ret < 0)
    return ret;
    vals++;
    }
...
//
#[no_mangle]
unsafe extern "C" fn ov7670_reset(sd: *mut v4l2_subdev, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_init(sd: *mut v4l2_subdev, val: u32) -> c_int {
    static int ov7670_init(struct v4l2_subdev *sd, u32 val)
    {
    return ov7670_write_array(sd, ov7670_default_regs);
    }
#[no_mangle]
unsafe extern "C" fn ov7670_detect(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7675_apply_framerate(sd: *mut v4l2_subdev) -> c_int {
...
//
    ...
    clkrc = CLK_EXT;
#[no_mangle]
pub unsafe extern "C" fn if(CLK_SCALE: clkrc >) -> else {
...
//
    ...
    div = 1;
#[no_mangle]
pub unsafe extern "C" fn if(CLK_SCALE: div >) -> else {
...
// Vertical: similar arrangement, but only 10 bits.
    ...
    struct ov7670_win_size *wsize;
    struct ov7670_info *info = to_state(sd);
    let mut n_win_sizes: c_uint = info.devtype.n_win_sizes;
    let mut win_sizes_limit: c_uint = n_win_sizes;
...
//
    ...
    if (ret_wsize != core::ptr::null_mut())
// ret_wsize = wsize;
//
...
#[no_mangle]
unsafe extern "C" fn ov7670_apply_fmt(sd: *mut v4l2_subdev) -> c_int {
...
//
    ...
    ret = ov7670_try_fmt_internal(sd, &format.format, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret)
    return ret;
...
//
    ...
    struct ov7670_info *info = to_state(sd);
    int i;
    let mut num_valid: c_int = -1;
    let mut index: __u32 = fse.index;
    let mut n_win_sizes: c_uint = info.devtype.n_win_sizes;
    if (fse.pad)
    return -EINVAL;
//
...
#[no_mangle]
unsafe extern "C" fn ov7670_sine(theta: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_cosine(theta: c_int) -> c_int {
    ...
    theta -= 360;
#[no_mangle]
pub unsafe extern "C" fn if(-180: theta <) -> else {
    else if (theta < -180)
    theta += 360;
...
#[no_mangle]
unsafe extern "C" fn ov7670_s_sat_hue(sd: *mut v4l2_subdev, sat: c_int, hue: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_s_brightness(sd: *mut v4l2_subdev, value: c_int) -> c_int {
    static int ov7670_s_brightness(struct v4l2_subdev *sd, int value)
    {
    let mut com8: c_uchar = 0, v;
...
#[no_mangle]
unsafe extern "C" fn ov7670_s_contrast(sd: *mut v4l2_subdev, value: c_int) -> c_int {
    static int ov7670_s_contrast(struct v4l2_subdev *sd, int value)
    {
    return ov7670_write(sd, REG_CONTRAS, (unsigned char) value);
    }
#[no_mangle]
unsafe extern "C" fn ov7670_s_hflip(sd: *mut v4l2_subdev, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_s_vflip(sd: *mut v4l2_subdev, value: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ov7670_g_gain(sd: *mut v4l2_subdev, value: *mut __s32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_s_gain(sd: *mut v4l2_subdev, value: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ov7670_s_autogain(sd: *mut v4l2_subdev, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_s_exp(sd: *mut v4l2_subdev, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_s_test_pattern(sd: *mut v4l2_subdev, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_g_volatile_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_g_register(sd: *mut v4l2_subdev, reg: *mut v4l2_dbg_register) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_s_register(sd: *mut v4l2_subdev, reg: *const v4l2_dbg_register) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_power_on(sd: *mut v4l2_subdev) {
...
#[no_mangle]
unsafe extern "C" fn ov7670_power_off(sd: *mut v4l2_subdev) {
...
#[no_mangle]
unsafe extern "C" fn ov7670_s_power(sd: *mut v4l2_subdev, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ov7670_init_gpio(client: *mut i2c_client, info: *mut ov7670_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov7670_remove(client: *mut i2c_client) {
