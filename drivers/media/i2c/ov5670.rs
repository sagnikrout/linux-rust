...
//! Source: drivers/media/i2c/ov5670.c
#![no_std]
...
pub const OV5670_XVCLK_FREQ: c_int = 19200000;
pub const OV5670_REG_CHIP_ID: c_uint = 0x300a;
pub const OV5670_CHIP_ID: c_uint = 0x005670;
pub const OV5670_REG_MODE_SELECT: c_uint = 0x0100;
pub const OV5670_MODE_STANDBY: c_uint = 0x00;
pub const OV5670_MODE_STREAMING: c_uint = 0x01;
pub const OV5670_REG_SOFTWARE_RST: c_uint = 0x0103;
pub const OV5670_SOFTWARE_RST: c_uint = 0x01;
pub const OV5670_MIPI_SC_CTRL0_REG: c_uint = 0x3018;

    GENMASK(7, 5))

// vertical-timings from sensor
pub const OV5670_REG_VTS: c_uint = 0x380e;
pub const OV5670_VTS_30FPS: c_uint = 0x0808 /* default for 30 fps */;
pub const OV5670_VTS_MAX: c_uint = 0xffff;
// horizontal-timings from sensor
pub const OV5670_REG_HTS: c_uint = 0x380c;
//
...
pub const OV5670_REG_EXPOSURE: c_uint = 0x3500;
pub const OV5670_EXPOSURE_MIN: c_int = 4;
pub const OV5670_EXPOSURE_STEP: c_int = 1;
// Analog gain controls from sensor
pub const OV5670_REG_ANALOG_GAIN: c_uint = 0x3508;
pub const ANALOG_GAIN_MIN: c_int = 0;
pub const ANALOG_GAIN_MAX: c_int = 8191;
pub const ANALOG_GAIN_STEP: c_int = 1;
pub const ANALOG_GAIN_DEFAULT: c_int = 128;
// Digital gain controls from sensor
pub const OV5670_REG_R_DGTL_GAIN: c_uint = 0x5032;
pub const OV5670_REG_G_DGTL_GAIN: c_uint = 0x5034;
pub const OV5670_REG_B_DGTL_GAIN: c_uint = 0x5036;
pub const OV5670_DGTL_GAIN_MIN: c_int = 0;
pub const OV5670_DGTL_GAIN_MAX: c_int = 4095;
pub const OV5670_DGTL_GAIN_STEP: c_int = 1;
pub const OV5670_DGTL_GAIN_DEFAULT: c_int = 1024;
// Test Pattern Control
pub const OV5670_REG_TEST_PATTERN: c_uint = 0x4303;

pub const OV5670_REG_TEST_PATTERN_CTRL: c_uint = 0x4320;
pub const OV5670_REG_VALUE_08BIT: c_int = 1;
pub const OV5670_REG_VALUE_16BIT: c_int = 2;
pub const OV5670_REG_VALUE_24BIT: c_int = 3;
// Pixel Array
pub const OV5670_NATIVE_WIDTH: c_int = 2624;
pub const OV5670_NATIVE_HEIGHT: c_int = 1980;
// Initial number of frames to skip to avoid possible garbage
pub const OV5670_NUM_OF_SKIP_FRAMES: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov5670_reg {
    pub address: u16,
    pub val: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov5670_reg_list {
    pub num_of_regs: u32,
    pub regs: *const ov5670_reg,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov5670_link_freq_config {
    pub reg_list: ov5670_reg_list,
}
...
pub const OV5670_LINK_FREQ_422MHZ: c_int = 422400000;
pub const OV5670_LINK_FREQ_422MHZ_INDEX: c_int = 0;
...
// Current mode
    pub cur_mode: *const ov5670_mode,
// xvclk input clock
    pub xvclk: *mut clk,
// Regulators
    pub supplies: [regulator_bulk_data; OV5670_NUM_SUPPLIES],
// Power-down and reset gpios.
    pub /: *mut *mut *mut gpio_desc pwdn_gpio; / PWDNB pin.,
    pub /: *mut *mut *mut gpio_desc reset_gpio; / XSHUTDOWN pin.,
...
#[no_mangle]
unsafe extern "C" fn ov5670_update_digital_gain(ov5670: *mut ov5670, d_gain: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5670_enable_test_pattern(ov5670: *mut ov5670, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5670_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// Initialize control handlers
#[no_mangle]
unsafe extern "C" fn ov5670_init_controls(ov5670: *mut ov5670) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5670_get_skip_frames(sd: *mut v4l2_subdev, frames: *mut u32) -> c_int {
...
// Verify chip ID
#[no_mangle]
unsafe extern "C" fn ov5670_identify_module(ov5670: *mut ov5670) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5670_mipi_configure(ov5670: *mut ov5670) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5670_start_streaming(ov5670: *mut ov5670) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5670_stop_streaming(ov5670: *mut ov5670) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5670_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5670_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn ov5670_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn ov5670_regulators_probe(ov5670: *mut ov5670) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5670_gpio_probe(ov5670: *mut ov5670) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5670_probe(client: *mut i2c_client) -> c_int {
    static int ov5670_probe(struct i2c_client *client)
    {
    struct fwnode_handle *handle;
    struct ov5670 *ov5670;
    let mut input_clk: u32 = 0;
    bool full_power;
    int ret;
    ...
    ov5670.xvclk = devm_v4l2_sensor_clk_get(ov5670.dev, core::ptr::null_mut());
...
//
    handle = fwnode_graph_get_next_endpoint(dev_fwnode(ov5670.dev), core::ptr::null_mut());
    if (!handle)
...
#[no_mangle]
unsafe extern "C" fn ov5670_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(ov5670_runtime_suspend, ov5670_runtime_resume, core::ptr::null_mut())
    };
