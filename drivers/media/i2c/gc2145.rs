...
//! Source: drivers/media/i2c/gc2145.c
#![no_std]
...
// Chip ID
pub const GC2145_CHIP_ID: c_uint = 0x2145;
// Page 0
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gc2145_mode {
    pub width: c_uint,
    pub height: c_uint,
    pub reg_seq: *const cci_reg_sequence,
    pub reg_seq_size: usize,
...
pub const GC2145_DEFAULT_EXPOSURE: c_uint = 0x04e2;
pub const GC2145_DEFAULT_GLOBAL_GAIN: c_uint = 0x55;
...
pub const GC2145_640_480_PIXELRATE: c_int = 30000000;
pub const GC2145_640_480_LINKFREQ: c_int = 120000000;
pub const GC2145_640_480_HBLANK: c_uint = 0x0130;
pub const GC2145_640_480_VBLANK: c_uint = 0x000c;
...
pub const GC2145_1280_720_PIXELRATE: c_int = 48000000;
pub const GC2145_1280_720_LINKFREQ: c_int = 192000000;
pub const GC2145_1280_720_HBLANK: c_uint = 0x0156;
pub const GC2145_1280_720_VBLANK: c_uint = 0x0011;
...
pub const GC2145_1600_1200_PIXELRATE: c_int = 60000000;
pub const GC2145_1600_1200_LINKFREQ: c_int = 240000000;
pub const GC2145_1600_1200_HBLANK: c_uint = 0x0156;
pub const GC2145_1600_1200_VBLANK: c_uint = 0x0010;
...
// Mode configs
pub const GC2145_MODE_640X480: c_int = 0;
pub const GC2145_MODE_1280X720: c_int = 1;
pub const GC2145_MODE_1600X1200: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gc2145_format {
    pub code: c_uint,
    pub colorspace: c_uint,
    pub datatype: c_uchar,
    pub output_fmt: c_uchar,
    pub switch_bit: bool,
    pub row_col_switch: c_uchar,
}
...
pub struct gc2145 {
    ...
    pub supplies: [regulator_bulk_data; GC2145_NUM_SUPPLIES],
// V4L2 controls
    pub ctrls: gc2145_ctrls,
// Current mode
    pub mode: *const gc2145_mode,
}
...
#[no_mangle]
unsafe extern "C" fn gc2145_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gc2145_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gc2145_get_regulators(gc2145: *mut gc2145) -> c_int {
...
// Verify chip ID
#[no_mangle]
unsafe extern "C" fn gc2145_identify_module(gc2145: *mut gc2145) -> c_int {
    static int gc2145_identify_module(struct gc2145 *gc2145)
    {
    struct i2c_client *client = v4l2_get_subdevdata(&gc2145.sd);
    int ret;
    u64 chip_id;
    ret = cci_read(gc2145.regmap, GC2145_REG_CHIP_ID, &chip_id, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn gc2145_set_ctrl_test_pattern(gc2145: *mut gc2145, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gc2145_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    BIT(0), (ctrl.val ? BIT(0) : 0), core::ptr::null_mut());
    break;
    case V4L2_CID_VFLIP:
    ret = cci_update_bits(gc2145.regmap, GC2145_REG_ANALOG_MODE1,
    BIT(1), (ctrl.val ? BIT(1) : 0), core::ptr::null_mut());
    break;
    default:
    ret = -EINVAL;
    break;
...
#[no_mangle]
unsafe extern "C" fn gc2145_init_controls(gc2145: *mut gc2145) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gc2145_check_hwcfg(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gc2145_probe(client: *mut i2c_client) -> c_int {
...
// Get system clock (xclk)
    gc2145.xclk = devm_v4l2_sensor_clk_get(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn gc2145_remove(client: *mut i2c_client) {
    ...
    RUNTIME_PM_OPS(gc2145_power_off, gc2145_power_on, core::ptr::null_mut())
    };
