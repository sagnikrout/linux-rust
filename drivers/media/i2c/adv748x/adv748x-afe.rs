...
//! Source: drivers/media/i2c/adv748x/adv748x-afe.c
#![no_std]
...
// SDP
//
pub const ADV748X_AFE_STD_AD_PAL_BG_NTSC_J_SECAM: c_uint = 0x0;
pub const ADV748X_AFE_STD_AD_PAL_BG_NTSC_J_SECAM_PED: c_uint = 0x1;
pub const ADV748X_AFE_STD_AD_PAL_N_NTSC_J_SECAM: c_uint = 0x2;
pub const ADV748X_AFE_STD_AD_PAL_N_NTSC_M_SECAM: c_uint = 0x3;
pub const ADV748X_AFE_STD_NTSC_J: c_uint = 0x4;
pub const ADV748X_AFE_STD_NTSC_M: c_uint = 0x5;
pub const ADV748X_AFE_STD_PAL60: c_uint = 0x6;
pub const ADV748X_AFE_STD_NTSC_443: c_uint = 0x7;
pub const ADV748X_AFE_STD_PAL_BG: c_uint = 0x8;
pub const ADV748X_AFE_STD_PAL_N: c_uint = 0x9;
pub const ADV748X_AFE_STD_PAL_M: c_uint = 0xa;
pub const ADV748X_AFE_STD_PAL_M_PED: c_uint = 0xb;
pub const ADV748X_AFE_STD_PAL_COMB_N: c_uint = 0xc;
pub const ADV748X_AFE_STD_PAL_COMB_N_PED: c_uint = 0xd;
pub const ADV748X_AFE_STD_PAL_SECAM: c_uint = 0xe;
pub const ADV748X_AFE_STD_PAL_SECAM_PED: c_uint = 0xf;
#[no_mangle]
unsafe extern "C" fn adv748x_afe_read_ro_map(state: *mut adv748x_state, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv748x_afe_std(std: v4l2_std_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adv748x_afe_s_input(afe: *mut adv748x_afe, input: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adv748x_afe_g_std(sd: *mut v4l2_subdev, norm: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv748x_afe_s_std(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
    static int adv748x_afe_s_std(struct v4l2_subdev *sd, v4l2_std_id std)
    {
    struct adv748x_afe *afe = adv748x_sd_to_afe(sd);
    struct adv748x_state *state = adv748x_afe_to_state(afe);
    let mut afe_std: c_int = adv748x_afe_std(std);
    if (afe_std < 0)
    return afe_std;
...
#[no_mangle]
unsafe extern "C" fn adv748x_afe_querystd(sd: *mut v4l2_subdev, std: *mut v4l2_std_id) -> c_int {
...
// Read detected standard
    ret = adv748x_afe_status(afe, core::ptr::null_mut(), std);
...
#[no_mangle]
unsafe extern "C" fn adv748x_afe_g_tvnorms(sd: *mut v4l2_subdev, norm: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv748x_afe_g_input_status(sd: *mut v4l2_subdev, status: *mut u32) -> c_int {
    ...
    int ret;
    mutex_lock(&state.mutex);
    ret = adv748x_afe_status(afe, status, core::ptr::null_mut());
    mutex_unlock(&state.mutex);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn adv748x_afe_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
    static int adv748x_afe_s_stream(struct v4l2_subdev *sd, int enable)
    {
    struct adv748x_afe *afe = adv748x_sd_to_afe(sd);
    struct adv748x_state *state = adv748x_afe_to_state(afe);
    let mut signal: u32 = V4L2_IN_ST_NO_SIGNAL;
    int ret;
    mutex_lock(&state.mutex);
    if (enable) {
    ...
    adv748x_afe_status(afe, &signal, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn adv748x_afe_propagate_pixelrate(afe: *mut adv748x_afe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv748x_afe_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv748x_afe_init_controls(afe: *mut adv748x_afe) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adv748x_afe_init(afe: *mut adv748x_afe) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adv748x_afe_cleanup(afe: *mut adv748x_afe) {
