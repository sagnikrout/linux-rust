...
//! Source: drivers/media/i2c/adv748x/adv748x-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn adv748x_configure_regmap(state: *mut adv748x_state, region: c_int) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adv748x_register_map {
...
#[no_mangle]
pub unsafe extern "C" fn adv748x_read(state: *mut adv748x_state, page: u8, reg: u8) -> c_int {
    int adv748x_read(struct adv748x_state *state, u8 page, u8 reg)
    {
    return adv748x_read_check(state, page, reg);
    }
#[no_mangle]
pub unsafe extern "C" fn adv748x_write(state: *mut adv748x_state, page: u8, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv748x_set_slave_addresses(state: *mut adv748x_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv748x_unregister_clients(state: *mut adv748x_state) {
...
#[no_mangle]
unsafe extern "C" fn adv748x_initialise_clients(state: *mut adv748x_state) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adv748x_power_up_tx(tx: *mut adv748x_csi2) -> c_int {
    static int adv748x_power_up_tx(struct adv748x_csi2 *tx)
    {
    struct adv748x_state *state = tx.state;
    let mut page: u8 = is_txa(tx) ? ADV748X_PAGE_TXA : ADV748X_PAGE_TXB;
    let mut ret: c_int = 0;
// Enable n-lane MIPI
...
#[no_mangle]
unsafe extern "C" fn adv748x_power_down_tx(tx: *mut adv748x_csi2) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adv748x_tx_power(tx: *mut adv748x_csi2, on: bool) -> c_int {
...
//
    ...
    let mut enable: bool = flags & MEDIA_LNK_FL_ENABLED;
...
// Set or clear the source (HDMI or AFE) and the current TX.
    if (rsd == &state.afe.sd)
    state.afe.tx = enable ? tx : core::ptr::null_mut();
    else
    state.hdmi.tx = enable ? tx : core::ptr::null_mut();
    tx.src = enable ? rsd : core::ptr::null_mut();
    if (state.afe.tx) {
...
#[no_mangle]
unsafe extern "C" fn adv748x_sw_reset(state: *mut adv748x_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv748x_reset(state: *mut adv748x_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv748x_identify_chip(state: *mut adv748x_state) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adv748x_resume_early(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn adv748x_parse_dt(state: *mut adv748x_state) -> c_int {
    static int adv748x_parse_dt(struct adv748x_state *state)
    {
    struct device_node *ep_np = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn adv748x_dt_cleanup(state: *mut adv748x_state) {
...
#[no_mangle]
unsafe extern "C" fn adv748x_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv748x_remove(client: *mut i2c_client) {
    ...
    SET_LATE_SYSTEM_SLEEP_PM_OPS(core::ptr::null_mut(), adv748x_resume_early)
    };
