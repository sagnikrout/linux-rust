...
//! Source: drivers/media/i2c/sony-btf-mpx.c
#![no_std]
...
//
    let mut force_mpx_mode: static int = -1;
    module_param(force_mpx_mode, int, 0644);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sony_btf_mpx {
    pub sd: v4l2_subdev,
    pub mpxmode: c_int,
    pub audmode: u32,
}
...
#[no_mangle]
unsafe extern "C" fn mpx_write(client: *mut i2c_client, dev: c_int, addr: c_int, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpx_setup(t: *mut sony_btf_mpx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sony_btf_mpx_s_std(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
    static int sony_btf_mpx_s_std(struct v4l2_subdev *sd, v4l2_std_id std)
    {
    struct sony_btf_mpx *t = to_state(sd);
    let mut default_mpx_mode: c_int = 0;
    if (std & V4L2_STD_PAL_BG)
    default_mpx_mode = 1;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_PAL_I: std &) -> else {
    else if (std & V4L2_STD_PAL_I)
    default_mpx_mode = 4;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_PAL_DK: std &) -> else {
    else if (std & V4L2_STD_PAL_DK)
    default_mpx_mode = 6;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_SECAM_L: std &) -> else {
...
#[no_mangle]
unsafe extern "C" fn sony_btf_mpx_g_tuner(sd: *mut v4l2_subdev, vt: *mut v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sony_btf_mpx_s_tuner(sd: *mut v4l2_subdev, vt: *const v4l2_tuner) -> c_int {
...
// --------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn sony_btf_mpx_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sony_btf_mpx_remove(client: *mut i2c_client) {
