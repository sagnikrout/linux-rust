...
//! Source: drivers/media/i2c/rdacm20.c
#![no_std]
...
pub const OV10635_I2C_ADDRESS: c_uint = 0x30;
pub const OV10635_SOFTWARE_RESET: c_uint = 0x0103;
pub const OV10635_PID: c_uint = 0x300a;
pub const OV10635_VER: c_uint = 0x300b;
pub const OV10635_SC_CMMN_SCCB_ID: c_uint = 0x300c;

pub const OV10635_VERSION: c_uint = 0xa635;
pub const OV10635_WIDTH: c_int = 1280;
pub const OV10635_HEIGHT: c_int = 800;
// VTS = PCLK / FPS / HTS / 2 (= 88MHz / 1572 / 30 / 2)
pub const OV10635_HTS: c_int = 1572;
// FPS = 29,9998
pub const OV10635_VTS: c_int = 933;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rdacm20_device {
    pub dev: *mut device,
    pub serializer: max9271_device,
    pub sensor: *mut i2c_client,
    pub sd: v4l2_subdev,
    pub pad: media_pad,
...
#[no_mangle]
unsafe extern "C" fn ov10635_read16(dev: *mut rdacm20_device, reg: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ov10635_write(dev: *mut rdacm20_device, reg: u16, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov10635_write(dev: *mut rdacm20_device, reg: u16, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rdacm20_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rdacm20_initialize(dev: *mut rdacm20_device) -> c_int {
    static int rdacm20_initialize(struct rdacm20_device *dev)
    {
    let mut retry: c_uint = 3;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rdacm20_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rdacm20_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn rdacm20_shutdown(client: *mut i2c_client) {
