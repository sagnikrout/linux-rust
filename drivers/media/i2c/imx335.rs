...
//! Source: drivers/media/i2c/imx335.c
#![no_std]
...
pub const IMX335_MODE_STANDBY: c_uint = 0x01;
pub const IMX335_MODE_STREAMING: c_uint = 0x00;
// Group hold register

// Lines per frame

pub const IMX335_EXPOSURE_MIN: c_int = 1;
pub const IMX335_SHUTTER_MIN: c_int = 9;
pub const IMX335_SHUTTER_MIN_BINNED: c_int = 17;
pub const IMX335_EXPOSURE_STEP: c_int = 1;
pub const IMX335_EXPOSURE_DEFAULT: c_uint = 0x0648;

// Analog and Digital gain control

pub const IMX335_AGAIN_MIN: c_int = 0;
pub const IMX335_AGAIN_MAX: c_int = 100;
pub const IMX335_AGAIN_STEP: c_int = 1;
pub const IMX335_AGAIN_DEFAULT: c_int = 0;
// Vertical flip

// Test pattern generator

pub const IMX335_TPG_ALL_000: c_int = 0;
pub const IMX335_TPG_ALL_FFF: c_int = 1;
pub const IMX335_TPG_ALL_555: c_int = 2;
pub const IMX335_TPG_ALL_AAA: c_int = 3;
pub const IMX335_TPG_TOG_555_AAA: c_int = 4;
pub const IMX335_TPG_TOG_AAA_555: c_int = 5;
pub const IMX335_TPG_TOG_000_555: c_int = 6;
pub const IMX335_TPG_TOG_555_000: c_int = 7;
pub const IMX335_TPG_TOG_000_FFF: c_int = 8;
pub const IMX335_TPG_TOG_FFF_000: c_int = 9;
pub const IMX335_TPG_H_COLOR_BARS: c_int = 10;
pub const IMX335_TPG_V_COLOR_BARS: c_int = 11;

// Chip ID

pub const IMX335_ID: c_uint = 0x00;
// Data Lanes

pub const IMX335_2LANE: c_int = 1;
pub const IMX335_4LANE: c_int = 3;

// Input clock rate
pub const IMX335_INCLK_RATE: c_int = 24000000;
// CSI2 HW configuration

pub const IMX335_NUM_DATA_LANES: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx335_mode {
    pub scan_mode: enum imx335_scan_mode,
    pub width: u32,
    pub height: u32,
    pub code: u32,
    pub hblank: u32,
    ...
    pub vblank_max: u32,
    pub pclk: u64,
    pub reg_list: imx335_reg_list,
    pub vflip_normal: imx335_reg_list,
    pub vflip_inverted: imx335_reg_list,
}
...
pub struct imx335 {
    ...
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(imx335_supply_name)],
    pub cci: *mut regmap,
    pub inclk: *mut clk,
...
//
#[no_mangle]
unsafe extern "C" fn imx335_update_exp_gain(imx335: *mut imx335, exposure: u32, gain: u32) -> c_int {
...
//
    ret_hold = cci_write(imx335.cci, IMX335_REG_HOLD, 0, core::ptr::null_mut());
    if (ret_hold)
    ret = ret_hold;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn imx335_update_vertical_flip(imx335: *mut imx335, vflip: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx335_update_test_pattern(imx335: *mut imx335, pattern_index: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx335_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// Propagate change of current control to all related controls
    ...
    let mut shutter_min: u32 = IMX335_SHUTTER_MIN;
    u32 lpfr;
...
#[no_mangle]
unsafe extern "C" fn imx335_get_format_code(imx335: *mut imx335, code: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx335_set_framefmt(imx335: *mut imx335) -> c_int {
...
//
    let mut ret: c_int = 0;
    let mut bpp: u8 = imx335.cur_mbus_code == MEDIA_BUS_FMT_SRGGB10_1X10 ? 10 : 12;
    let mut ad_conv: u8 = bpp;
...
// Write sensor common registers
    ...
    ARRAY_SIZE(imx335_common_regs), core::ptr::null_mut());
    if (ret) {
    dev_err(imx335.dev, "fail to write initial registers\n");
    goto err_rpm_put;
    }
...
// Configure lanes
    ...
    imx335.lane_mode, core::ptr::null_mut());
    if (ret)
    goto err_rpm_put;
...
// Start streaming
    ...
    IMX335_MODE_STREAMING, core::ptr::null_mut());
    if (ret) {
...
// Initial regulator stabilization period
    ...
    int ret;
    ret = cci_write(imx335.cci, IMX335_REG_MODE_SELECT,
    IMX335_MODE_STANDBY, core::ptr::null_mut());
    pm_runtime_put(imx335.dev);
    return ret;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn imx335_detect(imx335: *mut imx335) -> c_int {
    static int imx335_detect(struct imx335 *imx335)
    {
    int ret;
    u64 val;
    ret = cci_read(imx335.cci, IMX335_REG_ID, &val, core::ptr::null_mut());
    if (ret)
    return ret;
    if (val != IMX335_ID) {
...
//
#[no_mangle]
unsafe extern "C" fn imx335_parse_hw_config(imx335: *mut imx335) -> c_int {
...
// Get sensor input clock
    imx335.inclk = devm_v4l2_sensor_clk_get(imx335.dev, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn imx335_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx335_power_off(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imx335_init_controls(imx335: *mut imx335) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx335_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx335_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(imx335_power_off, imx335_power_on, core::ptr::null_mut())
    };
