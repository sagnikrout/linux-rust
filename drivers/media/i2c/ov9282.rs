...
//! Source: drivers/media/i2c/ov9282.c
#![no_std]
...
pub const OV9282_MODE_STANDBY: c_uint = 0x00;
pub const OV9282_MODE_STREAMING: c_uint = 0x01;

pub const OV9282_PLL_CTRL_0D_RAW8: c_uint = 0x60;
pub const OV9282_PLL_CTRL_0D_RAW10: c_uint = 0x50;

pub const OV9282_TIMING_HTS_MAX: c_uint = 0x7fff;
// Lines per frame

// Chip ID

pub const OV9282_ID: c_uint = 0x9281;
// Output enable registers

// Exposure control

pub const OV9282_EXPOSURE_MIN: c_int = 1;
pub const OV9282_EXPOSURE_OFFSET: c_int = 25;
pub const OV9282_EXPOSURE_STEP: c_int = 1;
pub const OV9282_EXPOSURE_DEFAULT: c_uint = 0x0282;
// AEC/AGC manual

pub const OV9282_AEC_MANUAL_DEFAULT: c_uint = 0x00;
// Analog gain control

pub const OV9282_AGAIN_MIN: c_uint = 0x10;
pub const OV9282_AGAIN_MAX: c_uint = 0xff;
pub const OV9282_AGAIN_STEP: c_int = 1;
pub const OV9282_AGAIN_DEFAULT: c_uint = 0x10;
// Group hold register

pub const OV9282_ANA_CORE2_RAW8: c_uint = 0x07;
pub const OV9282_ANA_CORE2_RAW10: c_uint = 0x05;

// Flash/Strobe control registers

pub const OV9282_STROBE_FRAME_SPAN_DEFAULT: c_uint = 0x0000001a;
// Input clock rate
pub const OV9282_INCLK_RATE: c_int = 24000000;
// CSI2 HW configuration
pub const OV9282_LINK_FREQ: c_int = 400000000;
pub const OV9282_NUM_DATA_LANES: c_int = 2;
// Pixel rate
...
pub const OV9282_REG_MIN: c_uint = 0x00;
pub const OV9282_REG_MAX: c_uint = 0xfffff;
pub const OV9282_STROBE_SPAN_FACTOR: c_int = 192;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov9282_mode {
    pub width: u32,
    pub height: u32,
    pub hblank_min: [u32; 2],
    pub vblank: u32,
    pub vblank_min: u32,
    pub vblank_max: u32,
    pub link_freq_idx: u32,
    pub crop: v4l2_rect,
    pub reg_list: ov9282_reg_list,
}
...
pub struct ov9282 {
    ...
    pub inclk: *mut clk,
    pub supplies: [regulator_bulk_data; OV9282_NUM_SUPPLIES],
    pub ctrl_handler: v4l2_ctrl_handler,
    pub link_freq_ctrl: *mut v4l2_ctrl,
    pub hblank_ctrl: *mut v4l2_ctrl,
    pub vblank_ctrl: *mut v4l2_ctrl,
    struct {
    pub exp_ctrl: *mut v4l2_ctrl,
    pub again_ctrl: *mut v4l2_ctrl,
}
...
pub const MODE_1280_800: c_int = 0;
pub const MODE_1280_720: c_int = 1;
pub const MODE_640_400: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn ov9282_exposure_to_us(ov9282: *mut ov9282, exposure: u32) -> u32 {
    static u32 ov9282_exposure_to_us(struct ov9282 *ov9282, u32 exposure)
    {
// calculate exposure time in µs
    let mut frame_width: u32 = ov9282.cur_mode.width + ov9282.hblank_ctrl.val;
    let mut trow_us: u32 = frame_width / (ov9282.pixel_rate.val / 1000000UL);
...
//
#[no_mangle]
unsafe extern "C" fn ov9282_update_exp_gain(ov9282: *mut ov9282, exposure: u32, gain: u32) -> c_int {
    static int ov9282_update_exp_gain(struct ov9282 *ov9282, u32 exposure, u32 gain)
    {
    let mut exposure_us: u32 = ov9282_exposure_to_us(ov9282, exposure);
    int ret, ret_hold;
    dev_dbg(ov9282.dev, "Set exp %u (~%u us), analog gain %u",
    exposure, exposure_us, gain);
    ret = cci_write(ov9282.regmap, OV9282_REG_HOLD, 0x01, core::ptr::null_mut());
    if (ret)
    return ret;
    ret = cci_write(ov9282.regmap, OV9282_REG_EXPOSURE, exposure << 4, core::ptr::null_mut());
    if (ret)
    goto error_release_group_hold;
    ret = cci_write(ov9282.regmap, OV9282_REG_AGAIN, gain, core::ptr::null_mut());
    if (ret)
    goto error_release_group_hold;
    ...
    ret_hold = cci_write(ov9282.regmap, OV9282_REG_HOLD, 0, core::ptr::null_mut());
    return ret ? ret : ret_hold;
    }
#[no_mangle]
unsafe extern "C" fn ov9282_us_to_flash_duration(ov9282: *mut ov9282, value: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ov9282_flash_duration_to_us(ov9282: *mut ov9282, value: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ov9282_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// Set controls only if sensor is in power on state
    ...
    ret = cci_write(ov9282.regmap, OV9282_REG_LPFR, lpfr, core::ptr::null_mut());
    break;
    case V4L2_CID_HFLIP:
    ret = cci_update_bits(ov9282.regmap, OV9282_REG_TIMING_FORMAT_2,
    OV9282_FLIP_BIT, ctrl.val ? OV9282_FLIP_BIT : 0, core::ptr::null_mut());
    break;
    case V4L2_CID_VFLIP:
...
#[no_mangle]
unsafe extern "C" fn ov9282_try_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    let mut us: u32 = ctrl.val;
    let mut fd: u32 = ov9282_us_to_flash_duration(ov9282, us);
// get nearest strobe_duration value
    let mut us0: u32 = ov9282_flash_duration_to_us(ov9282, fd);
    let mut us1: u32 = ov9282_flash_duration_to_us(ov9282, fd + 1);
...
// Write common registers
    ...
    ARRAY_SIZE(common_regs), core::ptr::null_mut());
    if (ret) {
    ...
    bitdepth_regs[bitdepth_index], 2, core::ptr::null_mut());
    if (ret) {
...
// Write sensor mode registers
    ...
    reg_list.num_of_regs, core::ptr::null_mut());
    if (ret) {
...
// Start streaming
    ...
    OV9282_MODE_STREAMING, core::ptr::null_mut());
    if (ret) {
    ...
    int ret;
    ret = cci_write(ov9282.regmap, OV9282_REG_MODE_SELECT,
    OV9282_MODE_STANDBY, core::ptr::null_mut());
    pm_runtime_put(ov9282.dev);
    return ret;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ov9282_detect(ov9282: *mut ov9282) -> c_int {
    static int ov9282_detect(struct ov9282 *ov9282)
    {
    int ret;
    u64 val;
    ret = cci_read(ov9282.regmap, OV9282_REG_ID, &val, core::ptr::null_mut());
    if (ret)
    return ret;
    if (val != OV9282_ID) {
...
#[no_mangle]
unsafe extern "C" fn ov9282_configure_regulators(ov9282: *mut ov9282) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ov9282_parse_hw_config(ov9282: *mut ov9282) -> c_int {
...
// Get sensor input clock
    ov9282.inclk = devm_v4l2_sensor_clk_get(ov9282.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ov9282_power_on(dev: *mut device) -> c_int {
    ...
    ov9282.noncontinuous_clock ? OV9282_GATED_CLOCK : 0, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn ov9282_power_off(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ov9282_init_controls(ov9282: *mut ov9282) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov9282_probe(client: *mut i2c_client) -> c_int {
...
// Initialize subdev
    ...
    device_get_match_data(ov9282.dev), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ov9282_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(ov9282_power_off, ov9282_power_on, core::ptr::null_mut())
    };
