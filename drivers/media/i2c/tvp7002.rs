...
//! Source: drivers/media/i2c/tvp7002.c
#![no_std]
...
// End of registers
pub const TVP7002_EOR: c_uint = 0x5c;
// Read write definition for registers
pub const TVP7002_READ: c_int = 0;
pub const TVP7002_WRITE: c_int = 1;
pub const TVP7002_RESERVED: c_int = 2;
// Interlaced vs progressive mask and shift
pub const TVP7002_IP_SHIFT: c_int = 5;

// Shift for CPL and LPF registers
pub const TVP7002_CL_SHIFT: c_int = 8;
pub const TVP7002_CL_MASK: c_uint = 0x0f;
// Debug functions
    static bool debug;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tvp7002_timings_definition {
    pub timings: v4l2_dv_timings,
    pub p_settings: *const i2c_reg_value,
    pub color_space: enum v4l2_colorspace,
    pub scanmode: enum v4l2_field,
    pub progressive: u16,
...
pub struct tvp7002 {
    ...
    pub pdata: *const tvp7002_config,
    pub ver: c_int,
    pub streaming: c_int,
    pub current_timings: *const tvp7002_timings_definition,
    pub pad: media_pad,
}
...
//
#[no_mangle]
unsafe extern "C" fn tvp7002_read(sd: *mut v4l2_subdev, addr: u8, dst: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tvp7002_write(sd: *mut v4l2_subdev, addr: u8, value: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tvp7002_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tvp7002_query_dv(sd: *mut v4l2_subdev, index: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tvp7002_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tvp7002_log_status(sd: *mut v4l2_subdev) -> c_int {
...
// V4L2 top level operation handlers
    ...
    struct tvp7002_config *pdata = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn tvp7002_probe(c: *mut i2c_client) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tvp7002_remove(c: *mut i2c_client) {
