...
//! Source: drivers/media/i2c/ov8856.c
#![no_std]
...
pub const OV8856_REG_VALUE_08BIT: c_int = 1;
pub const OV8856_REG_VALUE_16BIT: c_int = 2;
pub const OV8856_REG_VALUE_24BIT: c_int = 3;

pub const OV8856_XVCLK_19_2: c_int = 19200000;
pub const OV8856_DATA_LANES: c_int = 4;
pub const OV8856_RGB_DEPTH: c_int = 10;
pub const OV8856_REG_CHIP_ID: c_uint = 0x300a;
pub const OV8856_CHIP_ID: c_uint = 0x00885a;
pub const OV8856_REG_MODE_SELECT: c_uint = 0x0100;
pub const OV8856_MODE_STANDBY: c_uint = 0x00;
pub const OV8856_MODE_STREAMING: c_uint = 0x01;
// module revisions
pub const OV8856_2A_MODULE: c_uint = 0x01;
pub const OV8856_1B_MODULE: c_uint = 0x02;
// the OTP read-out buffer is at 0x7000 and 0xf is the offset
// of the byte in the OTP that means the module revision
//
pub const OV8856_MODULE_REVISION: c_uint = 0x700f;
pub const OV8856_OTP_MODE_CTRL: c_uint = 0x3d84;
pub const OV8856_OTP_LOAD_CTRL: c_uint = 0x3d81;
pub const OV8856_OTP_MODE_AUTO: c_uint = 0x00;

// vertical-timings from sensor
pub const OV8856_REG_VTS: c_uint = 0x380e;
pub const OV8856_VTS_MAX: c_uint = 0x7fff;
// horizontal-timings from sensor
pub const OV8856_REG_HTS: c_uint = 0x380c;
// Exposure controls from sensor
pub const OV8856_REG_EXPOSURE: c_uint = 0x3500;
pub const OV8856_EXPOSURE_MIN: c_int = 6;
pub const OV8856_EXPOSURE_MAX_MARGIN: c_int = 6;
pub const OV8856_EXPOSURE_STEP: c_int = 1;
// Analog gain controls from sensor
pub const OV8856_REG_ANALOG_GAIN: c_uint = 0x3508;
pub const OV8856_ANAL_GAIN_MIN: c_int = 128;
pub const OV8856_ANAL_GAIN_MAX: c_int = 2047;
pub const OV8856_ANAL_GAIN_STEP: c_int = 1;
// Digital gain controls from sensor
pub const OV8856_REG_DIGITAL_GAIN: c_uint = 0x350a;
pub const OV8856_REG_MWB_R_GAIN: c_uint = 0x5019;
pub const OV8856_REG_MWB_G_GAIN: c_uint = 0x501b;
pub const OV8856_REG_MWB_B_GAIN: c_uint = 0x501d;
pub const OV8856_DGTL_GAIN_MIN: c_int = 0;
pub const OV8856_DGTL_GAIN_MAX: c_int = 4095;
pub const OV8856_DGTL_GAIN_STEP: c_int = 1;
pub const OV8856_DGTL_GAIN_DEFAULT: c_int = 1024;
// Test Pattern Control
pub const OV8856_REG_TEST_PATTERN: c_uint = 0x5e00;

pub const OV8856_TEST_PATTERN_BAR_SHIFT: c_int = 2;
pub const NUM_REGS: c_int = 7;
pub const NUM_MODE_REGS: c_int = 187;
pub const NUM_MODE_REGS_2: c_int = 200;
// Flip Mirror Controls from sensor
pub const OV8856_REG_FORMAT1: c_uint = 0x3820;
pub const OV8856_REG_FORMAT2: c_uint = 0x3821;

pub const OV8856_REG_FLIP_OPT_1: c_uint = 0x376b;
pub const OV8856_REG_FLIP_OPT_2: c_uint = 0x5001;
pub const OV8856_REG_FLIP_OPT_3: c_uint = 0x502e;
pub const OV8856_REG_MIRROR_OPT_1: c_uint = 0x5004;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov8856_reg_list {
    pub num_of_regs: u32,
    pub regs: *const ov8856_reg,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov8856_link_freq_config {
    pub reg_list: ov8856_reg_list,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov8856_mode {
...
// Default MEDIA_BUS_FMT for this mode
    pub default_mbus_index: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov8856_mipi_data_rates {
    pub regs_0: [ov8856_reg; NUM_REGS],
    pub regs_1: [ov8856_reg; NUM_REGS],
}
...
pub struct ov8856 {
    ...
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(ov8856_supply_names)],
// V4L2 Controls
...
// Current mode
    pub cur_mode: *const ov8856_mode,
// Application specified mbus format
    pub cur_mbus_index: u32,
// To serialize asynchronous callbacks
    pub mutex: mutex,
// lanes index
    pub nlanes: u8,
    pub priv_lane: *const ov8856_lane_cfg,
    pub modes_size: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov8856_lane_cfg {
    pub link_freq_menu_items: [i64; 2],
    pub link_freq_configs: [ov8856_link_freq_config; 2],
    pub supported_modes: [ov8856_mode; 4],
}
...
#[no_mangle]
unsafe extern "C" fn ov8856_modes_num(ov8856: *const ov8856) -> c_uint {
    ...
    {
    let mut pixel_rate: u64 = link_freq_menu_items[f_index] * 2 * nlanes;
    ...
    u32 f_index, u8 nlanes)
    {
    let mut ppl: u64 = hts * to_rate(link_freq_menu_items, f_index, nlanes);
    do_div(ppl, OV8856_SCLK);
    return ppl;
    }
#[no_mangle]
unsafe extern "C" fn ov8856_read_reg(ov8856: *mut ov8856, reg: u16, len: u16, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_write_reg(ov8856: *mut ov8856, reg: u16, len: u16, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_identify_module(ov8856: *mut ov8856) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_update_digital_gain(ov8856: *mut ov8856, d_gain: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_test_pattern(ov8856: *mut ov8856, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_set_ctrl_hflip(ov8856: *mut ov8856, ctrl_val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_set_ctrl_vflip(ov8856: *mut ov8856, ctrl_val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_init_controls(ov8856: *mut ov8856) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_start_streaming(ov8856: *mut ov8856) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_stop_streaming(ov8856: *mut ov8856) {
...
#[no_mangle]
unsafe extern "C" fn ov8856_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_get_hwcfg(ov8856: *mut ov8856) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8856_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ov8856_probe(client: *mut i2c_client) -> c_int {
...
// Set the device's state to active if it's in D0 state.
    ...
    SET_RUNTIME_PM_OPS(ov8856_power_off, ov8856_power_on, core::ptr::null_mut())
    };
