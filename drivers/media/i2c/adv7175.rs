...
//! Source: drivers/media/i2c/adv7175.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
pub const I2C_ADV7175: c_uint = 0xd4;
pub const I2C_ADV7176: c_uint = 0x54;
    static int debug;
...
// -----------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn adv7175_write(sd: *mut v4l2_subdev, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adv7175_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_subcarrier_freq(sd: *mut v4l2_subdev, pass_through: c_int) {
...
pub const MR050: c_uint = 0x11	/* 0x09 */;
pub const MR060: c_uint = 0x14	/* 0x0c */;
// -----------------------------------------------------------------------
pub const TR0MODE: c_uint = 0x46;
pub const TR0RST: c_uint = 0x80;
pub const TR1CAPT: c_uint = 0x80;
pub const TR1PLAY: c_uint = 0x00;
...
#[no_mangle]
unsafe extern "C" fn adv7175_init(sd: *mut v4l2_subdev, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7175_s_std_output(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
// udelay(10);
    ...
    let mut val: u8 = adv7175_read(sd, 0x7);
    if (format.pad)
    return -EINVAL;
    if ((val & 0x40) == (1 << 6))
...
#[no_mangle]
unsafe extern "C" fn adv7175_s_power(sd: *mut v4l2_subdev, on: c_int) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn adv7175_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7175_remove(client: *mut i2c_client) {
