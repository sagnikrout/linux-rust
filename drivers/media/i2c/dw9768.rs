...
//! Source: drivers/media/i2c/dw9768.c
#![no_std]
...
//
pub const DW9768_FOCUS_STEPS: c_int = 1;
//
...
//
pub const DW9768_RING_PD_CONTROL_REG: c_uint = 0x02;
pub const DW9768_PD_MODE_OFF: c_uint = 0x00;
...
//
pub const DW9768_MSB_ADDR: c_uint = 0x03;
pub const DW9768_LSB_ADDR: c_uint = 0x04;
pub const DW9768_STATUS_ADDR: c_uint = 0x05;
//
...
// 101 4
//
pub const DW9768_AAC_PRESC_REG: c_uint = 0x06;
...
//
pub const DW9768_AAC_TIME_REG: c_uint = 0x07;
//
// DW9768 requires waiting time (delay time) of t_OPR after power-up,
// or in the case of PD reset taking place.
//
pub const DW9768_T_OPR_US: c_int = 1000;

pub const DW9768_AAC_MODE_DEFAULT: c_int = 2;
pub const DW9768_AAC_TIME_DEFAULT: c_uint = 0x20;
pub const DW9768_CLOCK_PRE_SCALE_DEFAULT: c_int = 1;
//
...
//
pub const DW9768_MOVE_STEPS: c_int = 16;
...
#[derive(Copy, Clone)]
pub struct dw9768 {
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(dw9768_supply_names)],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw9768_aac_mode_ot_multi {
    pub aac_mode_enum: u32,
    pub ot_multi_base100: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw9768_clk_presc_dividing_rate {
    pub clk_presc_enum: u32,
    pub dividing_rate_base100: u32,
}
...
#[no_mangle]
unsafe extern "C" fn dw9768_find_ot_multi(aac_mode_param: u32) -> u32 {
    static u32 dw9768_find_ot_multi(u32 aac_mode_param)
    {
    let mut cur_ot_multi_base100: u32 = 70;
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn dw9768_find_dividing_rate(presc_param: u32) -> u32 {
    static u32 dw9768_find_dividing_rate(u32 presc_param)
    {
    let mut cur_clk_dividing_rate_base100: u32 = 100;
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn dw9768_mod_reg(dw9768: *mut dw9768, reg: u8, mask: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw9768_set_dac(dw9768: *mut dw9768, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw9768_init(dw9768: *mut dw9768) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw9768_release(dw9768: *mut dw9768) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw9768_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw9768_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw9768_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw9768_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
    static int dw9768_open(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
    {
    return pm_runtime_resume_and_get(sd.dev);
    }
#[no_mangle]
unsafe extern "C" fn dw9768_close(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
    ...
    let mut dw9768_ops: static struct v4l2_subdev_ops = { };
#[no_mangle]
unsafe extern "C" fn dw9768_init_controls(dw9768: *mut dw9768) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw9768_probe(client: *mut i2c_client) -> c_int {
...
// Initialize subdev
    ...
    ret = media_entity_pads_init(&dw9768.sd.entity, 0, core::ptr::null_mut());
    if (ret < 0)
    goto err_free_handler;
...
#[no_mangle]
unsafe extern "C" fn dw9768_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(dw9768_runtime_suspend, dw9768_runtime_resume, core::ptr::null_mut())
    };
