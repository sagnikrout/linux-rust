...
//! Source: drivers/media/i2c/wm8775.c
#![no_std]
...
pub const ALC_HOLD: c_uint = 0x85 /* R17: use zero cross detection, ALC hold time 42.6 ms */;
pub const ALC_EN: c_uint = 0x100  /* R17: ALC enable */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wm8775_state {
    pub sd: v4l2_subdev,
    pub hdl: v4l2_ctrl_handler,
    pub mute: *mut v4l2_ctrl,
    pub vol: *mut v4l2_ctrl,
    pub bal: *mut v4l2_ctrl,
    pub loud: *mut v4l2_ctrl,
    pub /: *mut *mut u8 input; / Last selected input (0-0xf),
}
...
#[no_mangle]
unsafe extern "C" fn wm8775_write(sd: *mut v4l2_subdev, reg: c_int, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8775_set_audio(sd: *mut v4l2_subdev, quietly: c_int) {
    static void wm8775_set_audio(struct v4l2_subdev *sd, int quietly)
    {
    struct wm8775_state *state = to_state(sd);
    u8 vol_l, vol_r;
    let mut muted: c_int = 0 != state.mute.val;
    let mut volume: u16 = (u16)state.vol.val;
    let mut balance: u16 = (u16)state.bal.val;
...
#[no_mangle]
unsafe extern "C" fn wm8775_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8775_log_status(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8775_s_frequency(sd: *mut v4l2_subdev, freq: *const v4l2_frequency) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wm8775_probe(client: *mut i2c_client) -> c_int {
    static int wm8775_probe(struct i2c_client *client)
    {
    struct wm8775_state *state;
    struct v4l2_subdev *sd;
    int err;
    let mut is_nova_s: bool = false;
...
#[no_mangle]
unsafe extern "C" fn wm8775_remove(client: *mut i2c_client) {
