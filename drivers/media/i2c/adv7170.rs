...
//! Source: drivers/media/i2c/adv7170.c
#![no_std]
...
// -----------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn adv7170_write(sd: *mut v4l2_subdev, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adv7170_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
// -----------------------------------------------------------------------
pub const TR0MODE: c_uint = 0x4c;
pub const TR0RST: c_uint = 0x80;
pub const TR1CAPT: c_uint = 0x00;
...
#[no_mangle]
unsafe extern "C" fn adv7170_s_std_output(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
// udelay(10);
    ...
    let mut val: u8 = adv7170_read(sd, 0x7);
    if (format.pad)
    return -EINVAL;
    if ((val & 0x40) == (1 << 6))
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn adv7170_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7170_remove(client: *mut i2c_client) {
