...
//! Source: drivers/media/i2c/saa717x.c
#![no_std]
...
pub struct saa717x_state {
    ...
    pub playback: c_int,
    pub audio: c_int,
    pub tuner_audio_mode: c_int,
    pub audio_main_mute: c_int,
    pub audio_main_vol_r: c_int,
    pub audio_main_vol_l: c_int,
    pub audio_main_bass: u16,
    pub audio_main_treble: u16,
    pub audio_main_volume: u16,
    pub audio_main_balance: u16,
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn saa717x_write(sd: *mut v4l2_subdev, reg: u32, value: u32) -> c_int {
    static int saa717x_write(struct v4l2_subdev *sd, u32 reg, u32 value)
    {
    struct i2c_client *client = v4l2_get_subdevdata(sd);
    struct i2c_adapter *adap = client.adapter;
    let mut fw_addr: c_int = reg == 0x454 || (reg >= 0x464 && reg <= 0x478) || reg == 0x480 || reg == 0x488;
    unsigned char mm1[6];
    struct i2c_msg msg;
    msg.flags = 0;
...
#[no_mangle]
unsafe extern "C" fn saa717x_write_regs(sd: *mut v4l2_subdev, data: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn saa717x_read(sd: *mut v4l2_subdev, reg: u32) -> u32 {
    static u32 saa717x_read(struct v4l2_subdev *sd, u32 reg)
    {
    struct i2c_client *client = v4l2_get_subdevdata(sd);
    struct i2c_adapter *adap = client.adapter;
    let mut fw_addr: c_int = (reg >= 0x404 && reg <= 0x4b8) || reg == 0x528;
    unsigned char mm1[2];
...
#[no_mangle]
unsafe extern "C" fn set_audio_mode(sd: *mut v4l2_subdev, audio_mode: c_int) {
...
// scaling staff
#[no_mangle]
unsafe extern "C" fn set_v_scale(sd: *mut v4l2_subdev, task: c_int, yscale: c_int) {
...
#[no_mangle]
unsafe extern "C" fn saa717x_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// saa717x have mode0-mode9 but mode5 is reserved.
    ...
    let mut input_line: c_int = input;
...
#[no_mangle]
pub unsafe extern "C" fn if(6: input_line >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn saa717x_g_register(sd: *mut v4l2_subdev, reg: *mut v4l2_dbg_register) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa717x_s_register(sd: *mut v4l2_subdev, reg: *const v4l2_dbg_register) -> c_int {
    static int saa717x_s_register(struct v4l2_subdev *sd, const struct v4l2_dbg_register *reg)
    {
    let mut addr: u16 = reg.reg & 0xffff;
...
#[no_mangle]
unsafe extern "C" fn saa717x_s_radio(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa717x_s_std(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa717x_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
// change audio mode
#[no_mangle]
unsafe extern "C" fn saa717x_s_tuner(sd: *mut v4l2_subdev, vt: *const v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa717x_g_tuner(sd: *mut v4l2_subdev, vt: *mut v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa717x_log_status(sd: *mut v4l2_subdev) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn saa717x_probe(client: *mut i2c_client) -> c_int {
...
// Check if the adapter supports the needed features
    ...
    p = "saa7173";
#[no_mangle]
pub unsafe extern "C" fn if(0x32: id ==) -> else {
    else if (id == 0x32)
    p = "saa7174A";
#[no_mangle]
pub unsafe extern "C" fn if(0x6c: id ==) -> else {
    else if (id == 0x6c)
    p = "saa7174HL";
    else
    p = "saa7171";
...
#[no_mangle]
unsafe extern "C" fn saa717x_remove(client: *mut i2c_client) {
