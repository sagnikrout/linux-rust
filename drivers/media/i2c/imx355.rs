...
//! Source: drivers/media/i2c/imx355.c
#![no_std]
...
pub const IMX355_MODE_STANDBY: c_uint = 0x00;
pub const IMX355_MODE_STREAMING: c_uint = 0x01;
// Chip ID

pub const IMX355_CHIP_ID: c_uint = 0x0355;

// PLL registers that depend on the external clock frequency

pub const IMX355_PLL_OP_PREDIV: c_int = 2;
pub const IMX355_PLL_IVT_PCK_DIV: c_int = 5;
// V_TIMING internal

pub const IMX355_FLL_MAX: c_uint = 0xffff;
pub const IMX355_VBLANK_MIN: c_int = 20;

pub const IMX355_LLP_MAX: c_uint = 0xffff;

// Exposure control

pub const IMX355_EXPOSURE_MIN: c_int = 1;
pub const IMX355_EXPOSURE_STEP: c_int = 1;
pub const IMX355_EXPOSURE_DEFAULT: c_uint = 0x0282;
pub const IMX355_EXPOSURE_OFFSET: c_int = 10;
// Analog gain control

pub const IMX355_ANA_GAIN_MIN: c_int = 0;
pub const IMX355_ANA_GAIN_MAX: c_int = 960;
pub const IMX355_ANA_GAIN_STEP: c_int = 1;
pub const IMX355_ANA_GAIN_DEFAULT: c_int = 0;
// Digital gain control

pub const IMX355_DGTL_GAIN_MIN: c_int = 256;
pub const IMX355_DGTL_GAIN_MAX: c_int = 4095;
pub const IMX355_DGTL_GAIN_STEP: c_int = 1;
pub const IMX355_DGTL_GAIN_DEFAULT: c_int = 256;
// Test Pattern Control

pub const IMX355_TEST_PATTERN_DISABLED: c_int = 0;
pub const IMX355_TEST_PATTERN_SOLID_COLOR: c_int = 1;
pub const IMX355_TEST_PATTERN_COLOR_BARS: c_int = 2;
pub const IMX355_TEST_PATTERN_GRAY_COLOR_BARS: c_int = 3;
pub const IMX355_TEST_PATTERN_PN9: c_int = 4;

// Flip Control

pub const IMX355_PIXEL_ARRAY_TOP: c_int = 0;
pub const IMX355_PIXEL_ARRAY_LEFT: c_int = 0;
pub const IMX355_PIXEL_ARRAY_WIDTH: c_int = 3280;
pub const IMX355_PIXEL_ARRAY_HEIGHT: c_int = 2464;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx355_reg_list {
    pub num_of_regs: u32,
...
// Default register values
    pub reg_list: imx355_reg_list,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx355_clk_params {
    pub ext_clk: u32,
    pub /: *mut *mut u16 extclk_freq; / External clock (MHz) in 8.8 fixed point),
    pub /: *mut *mut u16 pll_op_mpy[2]; / OP system PLL multiplier,
    pub /: *mut *mut u8 pll_op_prediv[2]; / OP system pre PLL d,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx355_hwcfg {
    pub link_freq_menu: i64,
...
// V4L2 Controls
    ...
    pub hwcfg: *mut imx355_hwcfg,
    pub clk_params: *const imx355_clk_params,
...
#[no_mangle]
unsafe extern "C" fn imx355_get_format_code(imx355: *mut imx355) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn imx355_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// Start streaming
#[no_mangle]
unsafe extern "C" fn imx355_start_streaming(imx355: *mut imx355) -> c_int {
    static int imx355_start_streaming(struct imx355 *imx355)
    {
    const struct v4l2_mbus_framefmt *fmt;
    struct v4l2_subdev_state *state;
    const struct imx355_mode *mode;
    let mut lane_idx: c_int = imx355.hwcfg.num_lanes == 4 ? 0 : 1;
    struct v4l2_rect *crop;
    u64 link_bitrate;
    u8 binning_mode;
    let mut ret: c_int = 0;
...
// Stop streaming
#[no_mangle]
unsafe extern "C" fn imx355_stop_streaming(imx355: *mut imx355) -> c_int {
    static int imx355_stop_streaming(struct imx355 *imx355)
    {
    return cci_write(imx355.regmap, IMX355_REG_MODE_SELECT,
    IMX355_MODE_STANDBY, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn imx355_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
// Verify chip ID
#[no_mangle]
unsafe extern "C" fn imx355_identify_module(imx355: *mut imx355) -> c_int {
    static int imx355_identify_module(struct imx355 *imx355)
    {
    int ret;
    u64 val;
    ret = cci_read(imx355.regmap, IMX355_REG_CHIP_ID, &val, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn imx355_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx355_power_on(dev: *mut device) -> c_int {
    ...
    imx355_power_on, core::ptr::null_mut());
// Initialize control handlers
#[no_mangle]
unsafe extern "C" fn imx355_init_controls(imx355: *mut imx355) -> c_int {
...
// Initialize vblank/hblank/exposure parameters based on current mode
    ...
    imx355.hblank = v4l2_ctrl_new_std(ctrl_hdlr, core::ptr::null_mut(), V4L2_CID_HBLANK,
...
#[no_mangle]
unsafe extern "C" fn imx355_probe(client: *mut i2c_client) -> c_int {
    ...
    imx355.clk = devm_v4l2_sensor_clk_get(imx355.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn imx355_remove(client: *mut i2c_client) {
