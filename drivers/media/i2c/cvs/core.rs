...
//! Source: drivers/media/i2c/cvs/core.c
#![no_std]
...
pub const FW_READY_DELAY_MS: c_int = 100;
pub const PCI_DEVICE_ID_INTEL_IPU7: c_uint = 0x645d	/* MTL / LNL */;
pub const PCI_DEVICE_ID_INTEL_IPU7P5: c_uint = 0xb05d	/* ARL / PTL */;
pub const PCI_DEVICE_ID_INTEL_IPU8: c_uint = 0xd719	/* NVL */;
//
...
//
    ...
    let mut gpio_wake: static struct acpi_gpio_params = { 0, 0, false };
    let mut gpio_rst: static struct acpi_gpio_params = { 1, 0, false };
    let mut gpio_req: static struct acpi_gpio_params = { 2, 0, false };
    let mut gpio_resp: static struct acpi_gpio_params = { 3, 0, false };
    ...
    let mut lgpio_req: static struct acpi_gpio_params = { 0, 0, false };
    let mut lgpio_resp: static struct acpi_gpio_params = { 1, 0, false };
...
//
#[no_mangle]
unsafe extern "C" fn cvs_set_quirks(ctx: *mut icvs, vid: u16, pid: u16) {
...
//
    ...
    size_t size)
    {
    let mut prefix_size: usize = ctx.prefix ? sizeof(u32) : 0;
    let mut read_size: usize = size + prefix_size;
...
//
#[no_mangle]
unsafe extern "C" fn cvs_write_i2c(ctx: *mut icvs, data: *const c_void, size: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cvs_checksum(data: *const c_void, len: usize) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn cvs_config_mipi(ctx: *mut icvs, c: *mut icvs_cmd, len: usize) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cvs_get_device_state(ctx: *mut icvs, state: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cvs_hw_init(ctx: *mut icvs) -> c_int {
    static int cvs_hw_init(struct icvs *ctx)
    {
    let mut n: icvs_resp = { };
    let mut cmd: __be16 = cpu_to_be16(ICVS_GET_DEV_VID_PID);
    u32 resp;
    int ret;
//
...
//
#[no_mangle]
unsafe extern "C" fn cvs_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn cvs_reset(ctx: *mut icvs) {
...
//
#[no_mangle]
unsafe extern "C" fn cvs_recv(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cvs_send(ctx: *mut icvs, cmd: *mut icvs_cmd, len: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cvs_set_link_owner(ctx: *mut icvs, owner: enum icvs_csi_link_owner) -> c_int {
    ...
    let mut cmd_size: usize = sizeof(cmd.cmd_id) + sizeof(cmd.param.param);
...
//
#[no_mangle]
unsafe extern "C" fn cvs_configure_dev_caps(ctx: *mut icvs) -> c_int {
    static int cvs_configure_dev_caps(struct icvs *ctx)
    {
    let mut cmd: icvs_cmd = { .cmd_id = cpu_to_be16(ICVS_SET_DEV_HOST_ID) };
    let mut sz: usize = sizeof(cmd.cmd_id) + sizeof(cmd.param.host_id);
    if (ctx.quirks & ICVS_NO_CAPS)
    return 0;
...
//
#[no_mangle]
unsafe extern "C" fn cvs_core_probe(dev: *mut device, i2c: *mut i2c_client) -> c_int {
    static int cvs_core_probe(struct device *dev, struct i2c_client *i2c)
    {
    struct pci_dev *ipu = core::ptr::null_mut();
    struct icvs *ctx;
    int ret;
// Locate IPU device
    ...
    icvs_ipu7_tbl[i].device, core::ptr::null_mut());
    if (!ipu)
    return -ENODEV;
    ...
    ctx.i2c_client = i2c;
    ret = gpiod_count(dev, core::ptr::null_mut());
    switch (ret) {
    case ICVS_GPIO_SYNC:
    ...
    ret = devm_request_threaded_irq(dev, ctx.irq, core::ptr::null_mut(),
    cvs_irq_handler,
...
//
    ctx.i2c_client = core::ptr::null_mut();
    goto fail_i2c;
    }
...
//
#[no_mangle]
unsafe extern "C" fn cvs_probe(i2c: *mut i2c_client) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cvs_core_remove(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn cvs_remove(client: *mut i2c_client) {
...
//
#[no_mangle]
unsafe extern "C" fn cvs_suspend(dev: *mut device) -> int __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn cvs_resume(dev: *mut device) -> int __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn cvs_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn cvs_runtime_suspend(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(cvs_runtime_suspend, cvs_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn cvs_platform_probe(pdev: *mut platform_device) -> c_int {
    static int cvs_platform_probe(struct platform_device *pdev)
    {
    return cvs_core_probe(&pdev.dev, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn cvs_platform_remove(pdev: *mut platform_device) {
...
//
#[no_mangle]
unsafe extern "C" fn cvs_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn cvs_exit() -> void __exit {
