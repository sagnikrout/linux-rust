...
//! Source: drivers/media/i2c/cvs/v4l2.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn csi_set_link_cfg(ctx: *mut icvs, link_freq: u64) -> c_int {
    ...
    let mut cmd_size: usize = sizeof(cmd.cmd_id) + sizeof(cmd.param.conf);
...
//
#[no_mangle]
unsafe extern "C" fn cvs_csi_init_controls(ctx: *mut icvs) -> c_int {
    static int cvs_csi_init_controls(struct icvs *ctx)
    {
    struct v4l2_ctrl *privacy_ctrl;
    v4l2_ctrl_handler_init(&ctx.ctrl_handler, 1);
    privacy_ctrl = v4l2_ctrl_new_std(&ctx.ctrl_handler, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn cvs_csi_parse_firmware(ctx: *mut icvs) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cvs_csi_init(ctx: *mut icvs, dev: *mut device, i2c: *mut i2c_client) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cvs_csi_remove(ctx: *mut icvs) {
