...
//! Source: drivers/media/i2c/hi556.c
#![no_std]
...
pub const HI556_REG_VALUE_08BIT: c_int = 1;
pub const HI556_REG_VALUE_16BIT: c_int = 2;
pub const HI556_REG_VALUE_24BIT: c_int = 3;

pub const HI556_MCLK: c_int = 19200000;
pub const HI556_DATA_LANES: c_int = 2;
pub const HI556_RGB_DEPTH: c_int = 10;
pub const HI556_REG_CHIP_ID: c_uint = 0x0f16;
pub const HI556_CHIP_ID: c_uint = 0x0556;
pub const HI556_REG_MODE_SELECT: c_uint = 0x0a00;
pub const HI556_MODE_STANDBY: c_uint = 0x0000;
pub const HI556_MODE_STREAMING: c_uint = 0x0100;
// vertical-timings from sensor
pub const HI556_REG_FLL: c_uint = 0x0006;
pub const HI556_FLL_30FPS: c_uint = 0x0814;
pub const HI556_FLL_30FPS_MIN: c_uint = 0x0814;
pub const HI556_FLL_MAX: c_uint = 0x7fff;
// horizontal-timings from sensor
pub const HI556_REG_LLP: c_uint = 0x0008;
// Exposure controls from sensor
pub const HI556_REG_EXPOSURE: c_uint = 0x0074;
pub const HI556_EXPOSURE_MIN: c_int = 6;
pub const HI556_EXPOSURE_MAX_MARGIN: c_int = 2;
pub const HI556_EXPOSURE_STEP: c_int = 1;
// Analog gain controls from sensor
pub const HI556_REG_ANALOG_GAIN: c_uint = 0x0077;
pub const HI556_ANAL_GAIN_MIN: c_int = 0;
pub const HI556_ANAL_GAIN_MAX: c_int = 240;
pub const HI556_ANAL_GAIN_STEP: c_int = 1;
// Digital gain controls from sensor
pub const HI556_REG_MWB_GR_GAIN: c_uint = 0x0078;
pub const HI556_REG_MWB_GB_GAIN: c_uint = 0x007a;
pub const HI556_REG_MWB_R_GAIN: c_uint = 0x007c;
pub const HI556_REG_MWB_B_GAIN: c_uint = 0x007e;
pub const HI556_DGTL_GAIN_MIN: c_int = 0;
pub const HI556_DGTL_GAIN_MAX: c_int = 2048;
pub const HI556_DGTL_GAIN_STEP: c_int = 1;
pub const HI556_DGTL_GAIN_DEFAULT: c_int = 256;
// Test Pattern Control

pub const HI556_REG_ISP_TPG_EN: c_uint = 0x01;
pub const HI556_REG_TEST_PATTERN: c_uint = 0x0201;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hi556_reg_list {
    pub num_of_regs: u32,
    pub regs: *const hi556_reg,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hi556_link_freq_config {
    pub reg_list: hi556_reg_list,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hi556_mode {
...
// GPIOs, clocks, etc.
    ...
    pub clk: *mut clk,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(hi556_supply_names)],
// Current mode
    pub cur_mode: *const hi556_mode,
...
unsafe extern "C" fn to_pixel_rate(f_index: u32) -> u64 {
    ...
    {
    let mut pixel_rate: u64 = link_freq_menu_items[f_index] * 2 * HI556_DATA_LANES;
    do_div(pixel_rate, HI556_RGB_DEPTH);
    return pixel_rate;
    }
#[no_mangle]
unsafe extern "C" fn hi556_read_reg(hi556: *mut hi556, reg: u16, len: u16, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi556_write_reg(hi556: *mut hi556, reg: u16, len: u16, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi556_update_digital_gain(hi556: *mut hi556, d_gain: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi556_test_pattern(hi556: *mut hi556, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi556_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi556_init_controls(hi556: *mut hi556) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi556_identify_module(hi556: *mut hi556) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi556_start_streaming(hi556: *mut hi556) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi556_stop_streaming(hi556: *mut hi556) {
...
#[no_mangle]
unsafe extern "C" fn hi556_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi556_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi556_check_hwcfg(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi556_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn hi556_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi556_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi556_probe(client: *mut i2c_client) -> c_int {
