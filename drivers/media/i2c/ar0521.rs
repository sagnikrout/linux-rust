...
//! Source: drivers/media/i2c/ar0521.c
#![no_std]
...
pub const AR0521_ANA_GAIN_MIN: c_uint = 0x00;
pub const AR0521_ANA_GAIN_MAX: c_uint = 0x3f;
pub const AR0521_ANA_GAIN_STEP: c_uint = 0x01;
pub const AR0521_ANA_GAIN_DEFAULT: c_uint = 0x00;
// AR0521 registers
pub const AR0521_REG_VT_PIX_CLK_DIV: c_uint = 0x0300;
pub const AR0521_REG_FRAME_LENGTH_LINES: c_uint = 0x0340;
pub const AR0521_REG_CHIP_ID: c_uint = 0x3000;
pub const AR0521_REG_COARSE_INTEGRATION_TIME: c_uint = 0x3012;
pub const AR0521_REG_ROW_SPEED: c_uint = 0x3016;
pub const AR0521_REG_EXTRA_DELAY: c_uint = 0x3018;
pub const AR0521_REG_RESET: c_uint = 0x301A;
pub const AR0521_REG_RESET_DEFAULTS: c_uint = 0x0238;
pub const AR0521_REG_RESET_GROUP_PARAM_HOLD: c_uint = 0x8000;

pub const AR0521_REG_ANA_GAIN_CODE_GLOBAL: c_uint = 0x3028;
pub const AR0521_REG_GREEN1_GAIN: c_uint = 0x3056;
pub const AR0521_REG_BLUE_GAIN: c_uint = 0x3058;
pub const AR0521_REG_RED_GAIN: c_uint = 0x305A;
pub const AR0521_REG_GREEN2_GAIN: c_uint = 0x305C;
pub const AR0521_REG_GLOBAL_GAIN: c_uint = 0x305E;
pub const AR0521_REG_HISPI_TEST_MODE: c_uint = 0x3066;
pub const AR0521_REG_HISPI_TEST_MODE_LP11: c_uint = 0x0004;
pub const AR0521_REG_TEST_PATTERN_MODE: c_uint = 0x3070;
pub const AR0521_REG_SERIAL_FORMAT: c_uint = 0x31AE;
pub const AR0521_REG_SERIAL_FORMAT_MIPI: c_uint = 0x0200;
pub const AR0521_REG_HISPI_CONTROL_STATUS: c_uint = 0x31C6;
pub const AR0521_REG_HISPI_CONTROL_STATUS_FRAMER_TEST_MODE_ENABLE: c_uint = 0x80;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ar0521_dev {
    pub i2c_client: *mut i2c_client,
    pub sd: v4l2_subdev,
    pub pad: media_pad,
    pub extclk: *mut clk,
    pub extclk_freq: u32,
    pub supplies: [*mut regulator; ARRAY_SIZE(ar0521_supply_names)],
    pub reset_gpio: *mut gpio_desc,
// lock to protect all members below
    pub lock: mutex,
    pub fmt: v4l2_mbus_framefmt,
    pub ctrls: ar0521_ctrls,
    pub lane_count: c_uint,
    struct {
    pub pre: u16,
    pub mult: u16,
    pub pre2: u16,
...
#[no_mangle]
unsafe extern "C" fn div64_round(v: u64, d: u32) -> u32 {
    static u32 div64_round(u64 v, u32 d)
    {
    return div_u64(v + (d >> 1), d);
    }
#[no_mangle]
unsafe extern "C" fn div64_round_up(v: u64, d: u32) -> u32 {
    static u32 div64_round_up(u64 v, u32 d)
    {
    return div_u64(v + d - 1, d);
    }
#[no_mangle]
unsafe extern "C" fn ar0521_code_to_bpp(sensor: *mut ar0521_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar0521_write_reg(sensor: *mut ar0521_dev, reg: u16, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar0521_set_geometry(sensor: *mut ar0521_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar0521_set_gains(sensor: *mut ar0521_dev) -> c_int {
    static int ar0521_set_gains(struct ar0521_dev *sensor)
    {
    let mut green: c_int = sensor.ctrls.gain.val;
    let mut red: c_int = max(green + sensor.ctrls.red_balance.val, 0);
    let mut blue: c_int = max(green + sensor.ctrls.blue_balance.val, 0);
    let mut gain: c_uint = min(red, min(green, blue));
...
#[no_mangle]
unsafe extern "C" fn calc_pll(sensor: *mut ar0521_dev, freq: u32, pre_ptr: *mut u16, mult_ptr: *mut u16) -> u32 {
    static u32 calc_pll(struct ar0521_dev *sensor, u32 freq, u16 *pre_ptr, u16 *mult_ptr)
    {
    let mut pre: u16 = 1, mult = 1, new_pre;
    let mut pll: u32 = AR0521_PLL_MAX + 1;
...
#[no_mangle]
unsafe extern "C" fn ar0521_calc_pll(sensor: *mut ar0521_dev) {
...
#[no_mangle]
unsafe extern "C" fn ar0521_pll_config(sensor: *mut ar0521_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar0521_set_stream(sensor: *mut ar0521_dev, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar0521_adj_fmt(fmt: *mut v4l2_mbus_framefmt) {
...
#[no_mangle]
unsafe extern "C" fn ar0521_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar0521_init_controls(sensor: *mut ar0521_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ar0521_power_off(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ar0521_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar0521_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar0521_pre_streamon(sd: *mut v4l2_subdev, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar0521_post_streamoff(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar0521_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar0521_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ar0521_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(ar0521_power_off, ar0521_power_on, core::ptr::null_mut())
    };
