...
//! Source: drivers/media/i2c/dw9719.c
#![no_std]
...
pub const DW9719_MAX_FOCUS_POS: c_int = 1023;
pub const DW9719_CTRL_STEPS: c_int = 16;
pub const DW9719_CTRL_DELAY_US: c_int = 1000;

pub const DW9718S_CONTROL_SAC_SHIFT: c_int = 1;
pub const DW9718S_CONTROL_SAC_MASK: c_uint = 0x7;

pub const DW9718S_DEFAULT_SAC: c_int = 4;

pub const DW9718S_SW_VCM_FREQ_MASK: c_uint = 0xF;
pub const DW9718S_DEFAULT_VCM_FREQ: c_int = 0;

pub const DW9718S_SACT_PERIOD_8_8MS: c_uint = 0x19;

pub const DW9719_ID: c_uint = 0xF1;
pub const DW9761_ID: c_uint = 0xF4;

pub const DW9719_STANDBY: c_uint = 0x00;
pub const DW9719_SHUTDOWN: c_uint = 0x01;
pub const DW9719_ENABLE_RINGING: c_uint = 0x02;

pub const DW9719_MODE_SAC_SHIFT: c_int = 4;
pub const DW9719_DEFAULT_SAC: c_int = 4;
pub const DW9761_DEFAULT_SAC: c_int = 6;

pub const DW9719_DEFAULT_VCM_FREQ: c_uint = 0x60;
pub const DW9761_DEFAULT_VCM_FREQ: c_uint = 0x3E;

pub const DW9761_DEFAULT_VCM_PRELOAD: c_uint = 0x73;
pub const DW9800K_DEFAULT_SAC: c_int = 1;
pub const DW9800K_MODE_SAC_SHIFT: c_int = 6;
pub const DW9800K_DEFAULT_VCM_FREQ: c_uint = 0x10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw9719_device {
    pub sd: v4l2_subdev,
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub regulator: *mut regulator,
    pub model: enum dw9719_model,
    pub mode_low_bits: u32,
    pub sac_mode: u32,
    pub vcm_freq: u32,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw9719_v4l2_ctrls {
...
#[no_mangle]
unsafe extern "C" fn dw9719_power_down(dw9719: *mut dw9719_device) -> c_int {
    static int dw9719_power_down(struct dw9719_device *dw9719)
    {
    let mut reg_pwr: u32 = dw9719.model == DW9718S ? DW9718S_PD : DW9719_CONTROL;
//
// Worth engaging the internal SHUTDOWN mode especially due to the
// regulator being potentially shared with other devices.
//
    if (cci_write(dw9719.regmap, reg_pwr, DW9719_SHUTDOWN, core::ptr::null_mut()))
    dev_err(dw9719.dev, "Error writing to power register\n");
    return regulator_disable(dw9719.regulator);
    }
#[no_mangle]
unsafe extern "C" fn dw9719_power_up(dw9719: *mut dw9719_device, detect: bool) -> c_int {
...
//
    cci_write(dw9719.regmap, reg_pwr, DW9719_STANDBY, core::ptr::null_mut());
...
// These models do not have an INFO register
    ...
    ret = cci_read(dw9719.regmap, DW9719_INFO, &val, core::ptr::null_mut());
    if (ret < 0)
    return ret;
    switch (val) {
    case DW9719_ID:
...
#[no_mangle]
unsafe extern "C" fn dw9719_t_focus_abs(dw9719: *mut dw9719_device, value: i32) -> c_int {
    static int dw9719_t_focus_abs(struct dw9719_device *dw9719, s32 value)
    {
    u32 reg = dw9719.model == DW9718S ? DW9718S_VCM_CURRENT
    : DW9719_VCM_CURRENT;
    return cci_write(dw9719.regmap, reg, value, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn dw9719_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw9719_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw9719_resume(dev: *mut device) -> c_int {
    static int dw9719_resume(struct device *dev)
    {
    struct v4l2_subdev *sd = dev_get_drvdata(dev);
    struct dw9719_device *dw9719 = to_dw9719_device(sd);
    let mut current_focus: c_int = dw9719.ctrls.focus.val;
    int ret;
    int val;
...
#[no_mangle]
unsafe extern "C" fn dw9719_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
    static int dw9719_open(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
    {
    return pm_runtime_resume_and_get(sd.dev);
    }
#[no_mangle]
unsafe extern "C" fn dw9719_close(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw9719_init_controls(dw9719: *mut dw9719_device) -> c_int {
    ...
    let mut dw9719_ops: static struct v4l2_subdev_ops = { };
#[no_mangle]
unsafe extern "C" fn dw9719_probe(client: *mut i2c_client) -> c_int {
    ...
    if (ret)
    return ret;
    ret = media_entity_pads_init(&dw9719.sd.entity, 0, core::ptr::null_mut());
    if (ret < 0)
...
#[no_mangle]
unsafe extern "C" fn dw9719_remove(client: *mut i2c_client) {
