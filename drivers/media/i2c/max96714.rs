...
//! Source: drivers/media/i2c/max96714.c
#![no_std]
...
pub const MAX96714_DEVICE_ID: c_uint = 0xc9;
pub const MAX96714F_DEVICE_ID: c_uint = 0xca;
pub const MAX96714_NPORTS: c_int = 2;
pub const MAX96714_PAD_SINK: c_int = 0;
pub const MAX96714_PAD_SOURCE: c_int = 1;
pub const MAX96714_CSI_NLANES: c_int = 4;
// DEV
...
#[no_mangle]
unsafe extern "C" fn max96714_enable_tx_port(priv: *mut max96714_priv) -> c_int {
    ...
    MAX96714_MIPI_STDBY_MASK, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn max96714_disable_tx_port(priv: *mut max96714_priv) -> c_int {
    static int max96714_disable_tx_port(struct max96714_priv *priv)
    {
    return cci_update_bits(priv.regmap, MAX96714_MIPI_STDBY_N,
    MAX96714_MIPI_STDBY_MASK, 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn max96714_tx_port_enabled(priv: *mut max96714_priv) -> bool {
    static bool max96714_tx_port_enabled(struct max96714_priv *priv)
    {
    u64 val;
    cci_read(priv.regmap, MAX96714_MIPI_STDBY_N, &val, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn max96714_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    priv.pattern ? MAX96714_FORCE_CSI_OUT : 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn max96714_link_locked(priv: *mut max96714_priv) -> bool {
    static bool max96714_link_locked(struct max96714_priv *priv)
    {
    let mut val: u64 = 0;
    cci_read(priv.regmap, MAX96714_LINK_LOCK, &val, core::ptr::null_mut());
    return val & MAX96714_LINK_LOCK_BIT;
    }
#[no_mangle]
unsafe extern "C" fn max96714_link_status(priv: *mut max96714_priv) {
...
#[no_mangle]
unsafe extern "C" fn max96714_pipe_locked(priv: *mut max96714_priv) -> bool {
    static bool max96714_pipe_locked(struct max96714_priv *priv)
    {
    u64 val;
    cci_read(priv.regmap, MAX96714_VIDEO_RX8, &val, core::ptr::null_mut());
    return val & MAX96714_VID_LOCK;
    }
#[no_mangle]
unsafe extern "C" fn max96714_pipe_status(priv: *mut max96714_priv) {
...
#[no_mangle]
unsafe extern "C" fn max96714_csi_status(priv: *mut max96714_priv) {
    static void max96714_csi_status(struct max96714_priv *priv)
    {
    struct device *dev = &priv.client.dev;
    let mut freq: u64 = 0;
    cci_read(priv.regmap, MAX96714_BACKTOP25, &freq, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn max96714_log_status(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max96714_v4l2_notifier_register(priv: *mut max96714_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max96714_create_subdev(priv: *mut max96714_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max96714_destroy_subdev(priv: *mut max96714_priv) {
...
#[no_mangle]
unsafe extern "C" fn max96714_i2c_mux_select(mux: *mut i2c_mux_core, chan: u32) -> c_int {
    static int max96714_i2c_mux_select(struct i2c_mux_core *mux, u32 chan)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn max96714_i2c_mux_init(priv: *mut max96714_priv) -> c_int {
    static int max96714_i2c_mux_init(struct max96714_priv *priv)
    {
    priv.mux = i2c_mux_alloc(priv.client.adapter, &priv.client.dev,
    1, 0, I2C_MUX_LOCKED | I2C_MUX_GATE,
    max96714_i2c_mux_select, core::ptr::null_mut());
    if (!priv.mux)
    return -ENOMEM;
    return i2c_mux_add_adapter(priv.mux, 0, 0);
    }
#[no_mangle]
unsafe extern "C" fn max96714_init_tx_port(priv: *mut max96714_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max96714_rxport_enable_poc(priv: *mut max96714_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max96714_rxport_disable_poc(priv: *mut max96714_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max96714_parse_dt_txport(priv: *mut max96714_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max96714_parse_dt_rxport(priv: *mut max96714_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max96714_parse_dt(priv: *mut max96714_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max96714_enable_core_hw(priv: *mut max96714_priv) -> c_int {
...
// wait min 2 ms for power up to finish
    ...
    ret = cci_read(priv.regmap, MAX96714_REG13, &val, core::ptr::null_mut());
    if (ret) {
    ...
    ret = cci_read(priv.regmap, MAX96714_DEV_REV, &val, core::ptr::null_mut());
    if (ret)
    goto err_pd_gpio;
    dev_dbg(dev, "Found %x (rev %lx)\n", MAX96714F_DEVICE_ID,
    (u8)val & MAX96714_DEV_REV_MASK);
    ret = cci_read(priv.regmap, MAX96714_MIPI_TX52, &val, core::ptr::null_mut());
    if (ret)
    goto err_pd_gpio;
...
#[no_mangle]
unsafe extern "C" fn max96714_disable_core_hw(priv: *mut max96714_priv) {
    static void max96714_disable_core_hw(struct max96714_priv *priv)
    {
    gpiod_set_value_cansleep(priv.pd_gpio, 1);
    }
#[no_mangle]
unsafe extern "C" fn max96714_get_hw_resources(priv: *mut max96714_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max96714_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max96714_remove(client: *mut i2c_client) {
