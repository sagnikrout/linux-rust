...
//! Source: drivers/media/i2c/mt9m001.c
#![no_std]
...
pub const MT9M001_CHIP_VERSION: c_uint = 0x00;
pub const MT9M001_ROW_START: c_uint = 0x01;
pub const MT9M001_COLUMN_START: c_uint = 0x02;
pub const MT9M001_WINDOW_HEIGHT: c_uint = 0x03;
pub const MT9M001_WINDOW_WIDTH: c_uint = 0x04;
pub const MT9M001_HORIZONTAL_BLANKING: c_uint = 0x05;
pub const MT9M001_VERTICAL_BLANKING: c_uint = 0x06;
pub const MT9M001_OUTPUT_CONTROL: c_uint = 0x07;
pub const MT9M001_SHUTTER_WIDTH: c_uint = 0x09;
pub const MT9M001_FRAME_RESTART: c_uint = 0x0b;
pub const MT9M001_SHUTTER_DELAY: c_uint = 0x0c;
pub const MT9M001_RESET: c_uint = 0x0d;
pub const MT9M001_READ_OPTIONS1: c_uint = 0x1e;
pub const MT9M001_READ_OPTIONS2: c_uint = 0x20;
pub const MT9M001_GLOBAL_GAIN: c_uint = 0x35;
pub const MT9M001_CHIP_ENABLE: c_uint = 0xF1;
pub const MT9M001_MAX_WIDTH: c_int = 1280;
pub const MT9M001_MAX_HEIGHT: c_int = 1024;
pub const MT9M001_MIN_WIDTH: c_int = 48;
pub const MT9M001_MIN_HEIGHT: c_int = 32;
pub const MT9M001_COLUMN_SKIP: c_int = 20;
pub const MT9M001_ROW_SKIP: c_int = 12;
pub const MT9M001_DEFAULT_HBLANK: c_int = 9;
pub const MT9M001_DEFAULT_VBLANK: c_int = 25;
// MT9M001 has only one fixed colorspace per pixelcode
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt9m001_datafmt {
    pub code: u32,
...
// exposure/auto-exposure cluster
    pub autoexposure: *mut v4l2_ctrl,
...
pub struct mt9m001_reg {
    ...
    int i;
    for (i = 0; i < num; i++) {
    let mut ret: c_int = reg_write(client, regs[i].reg, regs[i].data);
    if (ret)
    return ret;
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn mt9m001_init(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9m001_apply_selection(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9m001_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
// No support for scaling so far, just crop. TODO: use skipping
    ret = mt9m001_set_selection(sd, core::ptr::null_mut(), &sel);
    if (!ret) {
    mf.width	= mt9m001.rect.width;
    mf.height	= mt9m001.rect.height;
    mt9m001.fmt	= fmt;
...
#[no_mangle]
unsafe extern "C" fn mt9m001_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9m001_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9m001_g_volatile_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9m001_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// Pack it into 0..1 step 0.125, register values 0..8
    let mut range: c_ulong = ctrl.default_value - ctrl.minimum;
...
// We assume qctrl->maximum - qctrl->default_value - 1 > 0
    let mut range: c_ulong = ctrl.maximum - ctrl.default_value - 1;
    unsigned long gain = ((ctrl.val - (s32)ctrl.default_value - 1) *
    111 + range / 2) / range + 9;
    if (gain <= 32)
    data = gain;
#[no_mangle]
pub unsafe extern "C" fn if(64: gain <=) -> else {
    else if (gain <= 64)
    ...
    let mut range: c_ulong = exp.maximum - exp.minimum;
...
//
#[no_mangle]
unsafe extern "C" fn mt9m001_video_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9m001_g_skip_top_lines(sd: *mut v4l2_subdev, lines: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9m001_probe(client: *mut i2c_client) -> c_int {
    ...
    if (!mt9m001)
    return -ENOMEM;
    mt9m001.clk = devm_v4l2_sensor_clk_get(&client.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mt9m001_remove(client: *mut i2c_client) {
...
//
    ...
    SET_RUNTIME_PM_OPS(mt9m001_power_off, mt9m001_power_on, core::ptr::null_mut())
    };
