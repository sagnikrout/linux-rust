...
//! Source: drivers/media/i2c/imx283.c
#![no_std]
...
pub const IMX283_CHIP_ID: c_uint = 0x0b	// Default power on state;

pub const IMX283_ACTIVE: c_int = 0;

pub const IMX283_PLSTMG08_VAL: c_uint = 0x77;
...
pub const IMX283_SHR_MIN: c_int = 11;
//
// Analog gain control
...
pub const IMX283_ANA_GAIN_MIN: c_int = 0;
pub const IMX283_ANA_GAIN_MAX: c_int = 1957;
pub const IMX283_ANA_GAIN_STEP: c_int = 1;
pub const IMX283_ANA_GAIN_DEFAULT: c_uint = 0x0;
//
...
pub const IMX283_DGTL_GAIN_MIN: c_int = 0;
pub const IMX283_DGTL_GAIN_MAX: c_int = 3;
pub const IMX283_DGTL_GAIN_DEFAULT: c_int = 0;
pub const IMX283_DGTL_GAIN_STEP: c_int = 1;

// Master Mode Operation Control

pub const IMX283_XMSTA_START: c_int = 0;

// PLL Standby

pub const IMX283_STBPL_NORMAL: c_uint = 0x00;
pub const IMX283_STBPL_STANDBY: c_uint = 0x03;
// Input Frequency Setting

pub const IMX283_PLSTMG02_VAL: c_uint = 0x00;

// Test pattern generator

pub const IMX283_TPG_PAT_ALL_000: c_uint = 0x00;
pub const IMX283_TPG_PAT_ALL_FFF: c_uint = 0x01;
pub const IMX283_TPG_PAT_ALL_555: c_uint = 0x02;
pub const IMX283_TPG_PAT_ALL_AAA: c_uint = 0x03;
pub const IMX283_TPG_PAT_H_COLOR_BARS: c_uint = 0x0a;
pub const IMX283_TPG_PAT_V_COLOR_BARS: c_uint = 0x0b;
// Exposure control
pub const IMX283_EXPOSURE_MIN: c_int = 52;
pub const IMX283_EXPOSURE_STEP: c_int = 1;
pub const IMX283_EXPOSURE_DEFAULT: c_int = 1000;
pub const IMX283_EXPOSURE_MAX: c_int = 49865;
pub const IMAGE_PAD: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx283_reg_list {
    pub num_of_regs: c_uint,
...
// minimum V-timing in lines
    pub min_vmax: u32,
// default H-timing
    pub default_hmax: u32,
// default V-timing
    pub default_vmax: u32,
// minimum SHR
    pub min_shr: u32,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx283_input_frequency {
    pub mhz: c_uint,
    pub reg_count: c_uint,
    pub regs: [cci_reg_sequence; 4],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx283_readout_mode {
    pub mdsel1: u8,
    pub mdsel2: u8,
    pub mdsel3: u8,
    pub mdsel4: u8,
...
pub struct imx283 {
    pub dev: *mut device,
    pub cci: *mut regmap,
    pub freq: *const imx283_input_frequency,
    pub sd: v4l2_subdev,
    pub pad: media_pad,
    pub xclk: *mut clk,
    pub reset_gpio: *mut gpio_desc,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(imx283_supply_name)],
// V4L2 Controls
    ...
    pub mipi_clk_noncontinuous: bool,
...
// Calculate the Pixel Rate based on the current mode
    ...
    {
    let mut link_frequency: u64 = link_frequencies[__ffs(imx283.link_freq_bitmap)];
    let mut bpp: c_uint = mode.bpp;
    const unsigned int ddr = 2; /* Double Data Rate */
    const unsigned int lanes = 4; /* Only 4 lane support */
    let mut numerator: u64 = link_frequency * ddr * lanes;
    do_div(numerator, bpp);
    return numerator;
    }
// Convert from a variable pixel_rate to 72 MHz clock cycles
#[no_mangle]
unsafe extern "C" fn imx283_internal_clock(pixel_rate: c_uint, pixels: c_uint) -> u64 {
...
//
    let mut iclk_pre: u32 = 72;
    let mut pclk_pre: u32 = pixel_rate / HZ_PER_MHZ;
    let mut numerator: u64 = pixels * iclk_pre;
    do_div(numerator, pclk_pre);
    return numerator;
    }
// Internal clock (72MHz) to Pixel Rate clock (Variable)
#[no_mangle]
unsafe extern "C" fn imx283_iclk_to_pix(pixel_rate: c_uint, cycles: c_uint) -> u64 {
...
//
    let mut iclk_pre: u32 = 72;
    let mut pclk_pre: u32 = pixel_rate / HZ_PER_MHZ;
    let mut numerator: u64 = cycles * pclk_pre;
...
// Number of clocks per internal offset period
    ...
    {
    u32 svr = 0; /* SVR feature is not currently supported */
    let mut min_shr: u64 = mode.min_shr;
// Global Shutter is not supported
    let mut max_shr: u64 = (svr + 1) * imx283.vmax - 4;
...
#[no_mangle]
unsafe extern "C" fn imx283_update_test_pattern(imx283: *mut imx283, pattern_index: u32) -> c_int {
    ...
    return -EINVAL;
    if (!pattern_index)
    return cci_write(imx283.cci, IMX283_REG_TPG_CTRL, 0x00, core::ptr::null_mut());
    ret = cci_write(imx283.cci, IMX283_REG_TPG_PAT,
    imx283_tpg_val[pattern_index], core::ptr::null_mut());
    if (ret)
    return ret;
    return cci_write(imx283.cci, IMX283_REG_TPG_CTRL,
    IMX283_TPG_CTRL_CLKEN | IMX283_TPG_CTRL_PATEN, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn imx283_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
//
    ...
    ctrl.val, shr);
    ret = cci_write(imx283.cci, IMX283_REG_SHR, shr, core::ptr::null_mut());
    break;
    ...
    ret = cci_write(imx283.cci, IMX283_REG_HMAX, imx283.hmax, core::ptr::null_mut());
    break;
    case V4L2_CID_VBLANK:
    imx283.vmax = mode.height + ctrl.val;
    dev_dbg(imx283.dev, "V4L2_CID_VBLANK : %d  VMAX : %u\n",
    ctrl.val, imx283.vmax);
    ret = cci_write(imx283.cci, IMX283_REG_VMAX, imx283.vmax, core::ptr::null_mut());
    break;
    case V4L2_CID_ANALOGUE_GAIN:
    ret = cci_write(imx283.cci, IMX283_REG_ANALOG_GAIN, ctrl.val, core::ptr::null_mut());
    break;
    case V4L2_CID_DIGITAL_GAIN:
    ret = cci_write(imx283.cci, IMX283_REG_DIGITAL_GAIN, ctrl.val, core::ptr::null_mut());
    break;
    case V4L2_CID_VFLIP:
//
...
// crop = mode->crop;
    ...
    const struct imx283_mode *mode)
    {
    let mut pixel_rate: u64 = imx283_pixel_rate(imx283, mode);
...
#[no_mangle]
unsafe extern "C" fn imx283_standby_cancel(imx283: *mut imx283) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx283_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx283_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx283_get_regulators(imx283: *mut imx283) -> c_int {
...
// Verify chip ID
#[no_mangle]
unsafe extern "C" fn imx283_identify_module(imx283: *mut imx283) -> c_int {
    static int imx283_identify_module(struct imx283 *imx283)
    {
    int ret;
    u64 val;
    ret = cci_read(imx283.cci, IMX283_REG_CHIP_ID, &val, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn imx283_init_controls(imx283: *mut imx283) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx283_parse_endpoint(imx283: *mut imx283) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx283_probe(client: *mut i2c_client) -> c_int {
...
// Get system clock (xclk)
    imx283.xclk = devm_v4l2_sensor_clk_get(imx283.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn imx283_remove(client: *mut i2c_client) {
    ...
    imx283_power_on, core::ptr::null_mut());
