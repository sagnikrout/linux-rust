...
//! Source: drivers/media/i2c/ov5647.c
#![no_std]
...
//
pub const PWDN_ACTIVE_DELAY_MS: c_int = 20;

pub const OV5647_REG_MIPI_CTRL14_CHANNEL_SHIFT: c_int = 6;

pub const OV5647_CHIP_ID: c_uint = 0x5647;
pub const REG_TERM: c_uint = 0xfffe;
pub const VAL_TERM: c_uint = 0xfe;
pub const REG_DLY: c_uint = 0xffff;
// OV5647 native and active pixel array size

pub const OV5647_VBLANK_MIN: c_int = 24;
pub const OV5647_VTS_MAX: c_int = 32767;
pub const OV5647_HTS_MAX: c_uint = 0x1fff;
pub const OV5647_EXPOSURE_MIN: c_int = 4;
pub const OV5647_EXPOSURE_STEP: c_int = 1;
pub const OV5647_EXPOSURE_DEFAULT: c_int = 1000;
pub const OV5647_EXPOSURE_MAX: c_int = 65535;
// regulator supplies
...
pub const FREQ_INDEX_FULL: c_int = 0;
pub const FREQ_INDEX_VGA: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov5647_mode {
    pub format: v4l2_mbus_framefmt,
    pub crop: v4l2_rect,
    pub pixel_rate: u64,
    pub link_freq_index: c_uint,
    pub hts: c_int,
    pub vts: c_int,
    pub reg_list: *const reg_sequence,
    pub num_regs: c_uint,
}
...
pub struct ov5647 {
    ...
    pub pad: media_pad,
    pub xclk: *mut clk,
    pub pwdn: *mut gpio_desc,
    pub supplies: [regulator_bulk_data; OV5647_NUM_SUPPLIES],
    pub clock_ncont: bool,
    pub ctrls: v4l2_ctrl_handler,
    pub mode: *const ov5647_mode,
...
#[no_mangle]
unsafe extern "C" fn ov5647_set_virtual_channel(sd: *mut v4l2_subdev, channel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5647_set_mode(sd: *mut v4l2_subdev) -> c_int {
    ...
    u64 resetval, rdval;
    int ret;
    ret = cci_read(sensor.regmap, OV5647_SW_STANDBY, &rdval, core::ptr::null_mut());
    if (ret < 0)
    return ret;
    ...
    if (ret < 0)
    return ret;
    ret = cci_read(sensor.regmap, OV5647_SW_STANDBY, &resetval, core::ptr::null_mut());
    if (ret < 0)
    return ret;
    if (!(resetval & 0x01)) {
    dev_err(&client.dev, "Device was in SW standby");
    ret = cci_write(sensor.regmap, OV5647_SW_STANDBY, 0x01, core::ptr::null_mut());
    if (ret < 0)
    return ret;
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn ov5647_stream_stop(sensor: *mut ov5647) -> c_int {
    ...
    struct i2c_client *client = v4l2_get_subdevdata(sd);
    struct ov5647 *sensor = to_sensor(sd);
    let mut val: u8 = MIPI_CTRL00_BUS_IDLE;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ov5647_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5647_power_off(dev: *mut device) -> c_int {
...
// Enter software standby
    ret = cci_update_bits(sensor.regmap, OV5647_SW_STANDBY, 0x01, 0x00, core::ptr::null_mut());
    if (ret < 0)
    ...
    int ret;
    u64 val;
    ret = cci_read(sensor.regmap, reg.reg & 0xff, &val, core::ptr::null_mut());
    if (ret < 0)
    return ret;
    reg.val = val;
    reg.size = 1;
    ...
    {
    struct ov5647 *sensor = to_sensor(sd);
    return cci_write(sensor.regmap, reg.reg & 0xff, reg.val & 0xff, core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn ov5647_get_mbus_code(sd: *mut v4l2_subdev) -> u32 {
    static u32 ov5647_get_mbus_code(struct v4l2_subdev *sd)
    {
    struct ov5647 *sensor = to_sensor(sd);
// The control values are only 0 or 1.
    let mut index: c_int = sensor.hflip.val | (sensor.vflip.val << 1);
...
#[no_mangle]
unsafe extern "C" fn ov5647_detect(sd: *mut v4l2_subdev) -> c_int {
    ...
    u64 read;
    int ret;
    ret = cci_write(sensor.regmap, OV5647_SW_RESET, 0x01, core::ptr::null_mut());
    if (ret < 0)
    return ret;
    ret = cci_read(sensor.regmap, OV5647_REG_CHIPID, &read, core::ptr::null_mut());
    if (ret < 0)
    ...
    return cci_write(sensor.regmap, OV5647_SW_RESET, 0x00, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ov5647_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5647_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
//
    ...
    ctrl.val == V4L2_EXPOSURE_MANUAL ? BIT(0) : 0, core::ptr::null_mut());
    break;
    case V4L2_CID_ANALOGUE_GAIN:
// 10 bits of gain, 2 in the high register.
    ret = cci_write(sensor.regmap, OV5647_REG_GAIN,
    ctrl.val & 0x3ff, core::ptr::null_mut());
    break;
...
//
    ...
    sensor.mode.format.height + ctrl.val, core::ptr::null_mut());
    break;
    ...
    ov5647_test_pattern_val[ctrl.val], core::ptr::null_mut());
    break;
    case V4L2_CID_HFLIP:
// There's an in-built hflip in the sensor, so account for that here.
    ...
    ctrl.val ? BIT(1) : 0, core::ptr::null_mut());
    break;
    default:
    dev_info(&client.dev,
...
#[no_mangle]
unsafe extern "C" fn ov5647_init_controls(sensor: *mut ov5647) -> c_int {
...
// By default, PIXEL_RATE is read only, but it does change per mode
    sensor.pixel_rate = v4l2_ctrl_new_std(&sensor.ctrls, core::ptr::null_mut(),
    V4L2_CID_PIXEL_RATE,
    ...
    sensor.link_freq =
    v4l2_ctrl_new_int_menu(&sensor.ctrls, core::ptr::null_mut(), V4L2_CID_LINK_FREQ,
...
#[no_mangle]
unsafe extern "C" fn ov5647_parse_dt(sensor: *mut ov5647, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5647_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5647_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(ov5647_power_off, ov5647_power_on, core::ptr::null_mut())
    };
