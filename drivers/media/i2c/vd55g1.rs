...
//! Source: drivers/media/i2c/vd55g1.c
#![no_std]
...
pub const VD55G1_SYSTEM_FSM_READY_TO_BOOT: c_uint = 0x01;
pub const VD55G1_SYSTEM_FSM_SW_STBY: c_uint = 0x02;
pub const VD55G1_SYSTEM_FSM_STREAMING: c_uint = 0x03;

pub const VD55G1_BOOT_BOOT: c_int = 1;
pub const VD55G1_BOOT_PATCH_AND_BOOT: c_int = 2;

pub const VD55G1_STBY_START_STREAM: c_int = 1;

pub const VD55G1_STREAMING_STOP_STREAM: c_int = 1;

pub const VD55G1_PATGEN_TYPE_SHIFT: c_int = 4;

pub const VD55G1_READOUT_CTRL_BIN_MODE_NORMAL: c_int = 0;
pub const VD55G1_READOUT_CTRL_BIN_MODE_DIGITAL_X2: c_int = 1;

pub const VD55G1_DUSTER_DISABLE: c_int = 0;

pub const VD55G1_EXPOSURE_MAX_COARSE_DEF: c_uint = 0x7fff;
pub const VD55G1_EXPOSURE_MAX_COARSE_SUB: c_int = 446;
...
pub const VD55G1_GPIO_MODE_FSYNC_OUT: c_uint = 0x00;
pub const VD55G1_GPIO_MODE_IN: c_uint = 0x01;
pub const VD55G1_GPIO_MODE_STROBE: c_uint = 0x02;

    CCI_REG8(0x0536 + VD55G1_CTX_OFFSET * (ctx))
pub const VD55G1_VT_MODE_NORMAL: c_int = 0;
pub const VD55G1_VT_MODE_SUBTRACTION: c_int = 1;

    CCI_REG8(0x0537 + VD55G1_CTX_OFFSET * (ctx))
pub const VD55G1_MASK_FRAME_CTRL_OUTPUT: c_int = 0;
pub const VD55G1_MASK_FRAME_CTRL_MASK: c_int = 1;

    CCI_REG32_LE(0x52D + VD55G1_CTX_OFFSET * (ctx))
pub const VD55G1_WIDTH: c_int = 804;
pub const VD55G1_HEIGHT: c_int = 704;
pub const VD55G1_MODE_IDX_DEF: c_int = 0;
pub const VD55G1_NB_GPIOS: c_int = 4;
pub const VD55G1_DGAIN_DEF: c_int = 256;
pub const VD55G1_AGAIN_DEF: c_int = 19;
pub const VD55G1_EXPO_MAX_TERM: c_int = 64;
pub const VD55G1_EXPO_DEF: c_int = 500;
pub const VD55G1_LINE_LENGTH_MIN: c_int = 1128;
pub const VD55G1_LINE_LENGTH_SUB_MIN: c_int = 1344;
pub const VD55G1_VBLANK_MIN: c_int = 86;
pub const VD55G1_VBLANK_MAX: c_uint = 0xffff;

pub const VD55G1_MIPI_MARGIN: c_int = 900;
pub const VD55G1_CTX_OFFSET: c_uint = 0x50;
pub const VD55G1_FWPATCH_REVISION_MAJOR: c_int = 2;
pub const VD55G1_FWPATCH_REVISION_MINOR: c_int = 9;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vd55g1_version {
    pub name: *mut c_char,
    pub id: enum vd55g1_model_id,
    pub color: enum vd55g1_color_version,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vd55g1_vblank_limits {
    pub min: u16,
    pub def: u16,
    pub max: u16,
}
...
pub struct vd55g1 {
    pub dev: *mut device,
    pub version: *const vd55g1_version,
    pub sd: v4l2_subdev,
    pub pad: media_pad,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(vd55g1_supply_name)],
    pub reset_gpio: *mut gpio_desc,
    pub xclk: *mut clk,
    pub regmap: *mut regmap,
    pub xclk_freq: u32,
    pub oif_ctrl: u16,
    pub gpios: [u8; VD55G1_NB_GPIOS],
    pub ext_leds_mask: c_ulong,
    pub mipi_rate: u32,
    pub pixel_clock: u32,
    pub link_freq: u64,
...
#[no_mangle]
unsafe extern "C" fn vd55g1_get_fmt_bpp(code: u32) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_get_fmt_data_type(code: u32) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_get_fmt_code(sensor: *mut vd55g1, code: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_wait_state(sensor: *mut vd55g1, state: c_int, err: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_prepare_clock_tree(sensor: *mut vd55g1) -> c_int {
...
// MIPI bus is double data rate
    ...
    mipi_div = 4;
#[no_mangle]
pub unsafe extern "C" fn if(MEGA: *mut *mut sensor->mipi_rate <= 600) -> else {
    ...
    pixel_div = 5;
#[no_mangle]
pub unsafe extern "C" fn if(HZ_PER_MHZ: *mut *mut sys_clk <= 900) -> else {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_update_patgen(sensor: *mut vd55g1, patgen_index: u32) -> c_int {
    static int vd55g1_update_patgen(struct vd55g1 *sensor, u32 patgen_index)
    {
    static const u8 index2val[] = {
    0x0, 0x22, 0x28
    };
    let mut pattern: u32 = index2val[patgen_index];
    let mut reg: u32 = pattern << VD55G1_PATGEN_TYPE_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn vd55g1_update_expo_cluster(sensor: *mut vd55g1, is_auto: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_lock_exposure(sensor: *mut vd55g1, lock_val: u32) -> c_int {
    static int vd55g1_lock_exposure(struct vd55g1 *sensor, u32 lock_val)
    {
    let mut ae_lock: bool = lock_val & V4L2_LOCK_EXPOSURE;
...
#[no_mangle]
unsafe extern "C" fn vd55g1_read_expo_cluster(sensor: *mut vd55g1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_update_exposure_target(sensor: *mut vd55g1, index: c_int) -> c_int {
...
//
    ...
    let mut exposure_target: c_int = index2exposure_target[index];
    return vd55g1_write(sensor, VD55G1_REG_AE_TARGET_PERCENTAGE,
    exposure_target, core::ptr::null_mut());
    }
...
// format conversion.
//
    let mut line_length: c_uint = crop.width + sensor.hblank_ctrl.val;
    unsigned int line_time_us = DIV_ROUND_UP(line_length * MEGA,
    sensor.pixel_clock);
    let mut d_gain: u8 = DIV_ROUND_CLOSEST(sensor.dgain_ctrl.val, 1 << 8);
    let mut a_gain: u8 = DIV_ROUND_CLOSEST(32, (32 - sensor.again_ctrl.val));
...
#[no_mangle]
unsafe extern "C" fn vd55g1_update_hdr_mode(sensor: *mut vd55g1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_update_gpios(sensor: *mut vd55g1, gpio_mask: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_ro_ctrls_setup(sensor: *mut vd55g1, crop: *mut v4l2_rect) -> c_int {
    ...
    crop.width + sensor.hblank_ctrl.val, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn vd55g1_grab_ctrls(sensor: *mut vd55g1, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_patch(sensor: *mut vd55g1) -> c_int {
...
// Version 2 needs a patch while version 3 does not
    ...
    ret = vd55g1_wait_state(sensor, VD55G1_SYSTEM_FSM_SW_STBY, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_g_volatile_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    struct v4l2_mbus_framefmt *format =
    v4l2_subdev_state_get_format(state, 0);
    let mut hblank: c_uint = vd55g1_get_hblank_min(sensor, format, crop);
...
#[no_mangle]
unsafe extern "C" fn vd55g1_init_ctrls(sensor: *mut vd55g1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_detect(sensor: *mut vd55g1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_power_on(dev: *mut device) -> c_int {
    ...
    ret = vd55g1_wait_state(sensor, VD55G1_SYSTEM_FSM_READY_TO_BOOT, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_parse_dt_gpios(sensor: *mut vd55g1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_parse_dt(sensor: *mut vd55g1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_subdev_init(sensor: *mut vd55g1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_subdev_cleanup(sensor: *mut vd55g1) {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_get_regulators(sensor: *mut vd55g1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd55g1_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(vd55g1_power_off, vd55g1_power_on, core::ptr::null_mut())
    };
