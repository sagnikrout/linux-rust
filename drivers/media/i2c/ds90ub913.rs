...
//! Source: drivers/media/i2c/ds90ub913.c
#![no_std]
...
pub const UB913_PAD_SINK: c_int = 0;
pub const UB913_PAD_SOURCE: c_int = 1;
//
// UB913 has 4 gpios, but gpios 3 and 4 are reserved for external oscillator
// mode. Thus we only support 2 gpios for now.
//
pub const UB913_NUM_GPIOS: c_int = 2;
pub const UB913_REG_RESET_CTL: c_uint = 0x01;

pub const UB913_REG_GENERAL_CFG: c_uint = 0x03;

pub const UB913_REG_MODE_SEL: c_uint = 0x05;

pub const UB913_REG_CRC_ERRORS_LSB: c_uint = 0x0a;
pub const UB913_REG_CRC_ERRORS_MSB: c_uint = 0x0b;
pub const UB913_REG_GENERAL_STATUS: c_uint = 0x0c;

pub const UB913_REG_SCL_HIGH_TIME: c_uint = 0x11;
pub const UB913_REG_SCL_LOW_TIME: c_uint = 0x12;
pub const UB913_REG_PLL_OVR: c_uint = 0x35;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ub913_data {
    ...
    pub clkout_clk_hw: *mut clk_hw,
    pub plat_data: *mut ds90ub9xx_platform_data,
    pub pclk_polarity_rising: bool,
}
...
//
#[no_mangle]
unsafe extern "C" fn ub913_gpio_get_direction(gc: *mut gpio_chip, offset: c_uint) -> c_int {
    ...
    let mut reg_idx: c_uint = offset / 2;
    let mut field_idx: c_uint = offset % 2;
...
#[no_mangle]
unsafe extern "C" fn ub913_gpio_set(gc: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ub913_gpiochip_probe(priv: *mut ub913_data) -> c_int {
...
// Initialize GPIOs 0 and 1 to local control, tri-state
    ub913_write(priv, UB913_REG_GPIO_CFG(0), 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ub913_gpiochip_remove(priv: *mut ub913_data) {
...
#[no_mangle]
unsafe extern "C" fn ub913_log_status(sd: *mut v4l2_subdev) -> c_int {
    ...
    u8 v, v1, v2;
    int ret;
    ret = ub913_read(priv, UB913_REG_MODE_SEL, &v, core::ptr::null_mut());
    if (ret)
    return ret;
...
// clear CRC errors
    ...
    if (ret)
    return ret;
    ret = ub913_read(priv, UB913_REG_GENERAL_STATUS, &v, core::ptr::null_mut());
    if (ret)
    return ret;
    dev_info(dev, "GENERAL_STATUS %#02x\n", v);
    ret = ub913_read(priv, UB913_REG_PLL_OVR, &v, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn ub913_v4l2_notifier_register(priv: *mut ub913_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ub913_v4l2_nf_unregister(priv: *mut ub913_data) {
...
#[no_mangle]
unsafe extern "C" fn ub913_register_clkout(priv: *mut ub913_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ub913_i2c_master_init(priv: *mut ub913_data) -> c_int {
...
// i2c fast mode
    ...
    ret = ub913_write(priv, UB913_REG_SCL_HIGH_TIME, scl_high, core::ptr::null_mut());
    if (ret)
    return ret;
    ret = ub913_write(priv, UB913_REG_SCL_LOW_TIME, scl_low, core::ptr::null_mut());
    if (ret)
    return ret;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ub913_add_i2c_adapter(priv: *mut ub913_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ub913_parse_dt(priv: *mut ub913_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_MBUS_PCLK_SAMPLE_FALLING: vep.bus.parallel.flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn ub913_hw_init(priv: *mut ub913_data) -> c_int {
    ...
    priv.pclk_polarity_rising), core::ptr::null_mut());
    if (ret)
    return ret;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ub913_subdev_init(priv: *mut ub913_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ub913_subdev_uninit(priv: *mut ub913_data) {
...
#[no_mangle]
unsafe extern "C" fn ub913_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ub913_remove(client: *mut i2c_client) {
