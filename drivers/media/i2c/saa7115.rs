...
//! Source: drivers/media/i2c/saa7115.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct saa711x_state {
    pub sd: v4l2_subdev,
    pub pads: [media_pad; SAA711X_NUM_PADS],
    pub hdl: v4l2_ctrl_handler,
    struct {
// chroma gain control cluster
    pub agc: *mut v4l2_ctrl,
...
// -----------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn saa711x_write(sd: *mut v4l2_subdev, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_has_reg(id: c_int, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_writeregs(sd: *mut v4l2_subdev, regs: *const c_uchar) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa711x_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_decode_vps(dst: *mut u8, p: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_decode_wss(p: *mut u8) -> c_int {
    ...
    int i;
    for (i = 0; i < 16; i++) {
    let mut b1: c_int = wss_bits[p[i] & 7];
    let mut b2: c_int = wss_bits[(p[i] >> 3) & 7];
    if (b1 == b2)
    return -1;
    wss |= b2 << i;
    }
...
#[no_mangle]
unsafe extern "C" fn saa711x_s_clock_freq(sd: *mut v4l2_subdev, freq: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_g_volatile_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_set_size(sd: *mut v4l2_subdev, width: c_int, height: c_int) -> c_int {
    ...
    int VSCY;
    int res;
    let mut is_50hz: c_int = state.std & V4L2_STD_625_50;
    let mut Vsrc: c_int = is_50hz ? 576 : 480;
...
#[no_mangle]
unsafe extern "C" fn saa711x_set_v4lstd(sd: *mut v4l2_subdev, std: v4l2_std_id) {
...
// This works for NTSC-M, SECAM-L and the 50Hz PAL variants.
    ...
    let mut reg: u8 = saa711x_read(sd, R_08_SYNC_CNTL);
...
#[no_mangle]
pub unsafe extern "C" fn BGDHI((3.58MHz: 4.43Mhz) NTSC M) -> 000 PAL {
    000 PAL BGDHI (4.43Mhz)         NTSC M (3.58MHz)
    001 NTSC 4.43 (50 Hz)           PAL 4.43 (60 Hz)
    010 Combination-PAL N (3.58MHz) NTSC 4.43 (60 Hz)
#[no_mangle]
pub unsafe extern "C" fn N((3.58MHz: 3.58MHz) PAL M) -> 011 NTSC {
    011 NTSC N (3.58MHz)            PAL M (3.58MHz)
    100 reserved                    NTSC-Japan (3.58MHz)
//
    if (state.ident <= SAA7113 ||
    state.ident == GM7113C) {
    let mut reg: u8 = saa711x_read(sd, R_0E_CHROMA_CNTL_1) & 0x8f;
...
// restart task B if needed
    let mut taskb: c_int = saa711x_read(sd, R_80_GLOBAL_CNTL_1) & 0x10;
...
#[no_mangle]
unsafe extern "C" fn saa711x_set_lcr(sd: *mut v4l2_subdev, fmt: *mut v4l2_sliced_vbi_format) {
...
// enable/disable raw VBI capturing
    saa711x_writeregs(sd, fmt == core::ptr::null_mut() ?
    saa7115_cfg_vbi_on :
    saa7115_cfg_vbi_off);
    }
#[no_mangle]
unsafe extern "C" fn saa711x_g_sliced_fmt(sd: *mut v4l2_subdev, sliced: *mut v4l2_sliced_vbi_format) -> c_int {
...
// done if using raw VBI
    ...
    return 0;
    for (i = 2; i <= 23; i++) {
    let mut v: u8 = saa711x_read(sd, i - 2 + R_41_LCR_BASE);
...
#[no_mangle]
unsafe extern "C" fn saa711x_s_raw_fmt(sd: *mut v4l2_subdev, fmt: *mut v4l2_vbi_format) -> c_int {
    static int saa711x_s_raw_fmt(struct v4l2_subdev *sd, struct v4l2_vbi_format *fmt)
    {
    saa711x_set_lcr(sd, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn saa711x_s_sliced_fmt(sd: *mut v4l2_subdev, fmt: *mut v4l2_sliced_vbi_format) -> c_int {
...
// Decode the sliced VBI data stream as created by the saa7115.
    ...
    code. */
#[no_mangle]
unsafe extern "C" fn saa711x_decode_vbi_line(sd: *mut v4l2_subdev, vbi: *mut v4l2_decode_vbi_line) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_g_tuner(sd: *mut v4l2_subdev, vt: *mut v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_s_std(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_s_radio(sd: *mut v4l2_subdev) -> c_int {
    ...
    {
    struct saa711x_state *state = to_state(sd);
    let mut mask: u8 = (state.ident <= SAA7111A) ? 0xf8 : 0xf0;
...
#[no_mangle]
unsafe extern "C" fn saa711x_s_gpio(sd: *mut v4l2_subdev, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_s_crystal_freq(sd: *mut v4l2_subdev, freq: u32, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_reset(sd: *mut v4l2_subdev, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_g_vbi_data(sd: *mut v4l2_subdev, data: *mut v4l2_sliced_vbi_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_querystd(sd: *mut v4l2_subdev, std: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_g_input_status(sd: *mut v4l2_subdev, status: *mut u32) -> c_int {
    static int saa711x_g_input_status(struct v4l2_subdev *sd, u32 *status)
    {
    struct saa711x_state *state = to_state(sd);
    let mut reg1e: c_int = 0x80;
    int reg1f;
...
#[no_mangle]
unsafe extern "C" fn saa711x_g_register(sd: *mut v4l2_subdev, reg: *mut v4l2_dbg_register) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_s_register(sd: *mut v4l2_subdev, reg: *const v4l2_dbg_register) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa711x_log_status(sd: *mut v4l2_subdev) -> c_int {
...
pub const CHIP_VER_SIZE: c_int = 16;
// -----------------------------------------------------------------------
...
#[no_mangle]
unsafe extern "C" fn saa711x_probe(client: *mut i2c_client) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn saa711x_remove(client: *mut i2c_client) {
