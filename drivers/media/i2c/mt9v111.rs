...
//! Source: drivers/media/i2c/mt9v111.c
#![no_std]
...
//
pub const MT9V111_CHIP_ID_HIGH: c_uint = 0x82;
pub const MT9V111_CHIP_ID_LOW: c_uint = 0x3a;
pub const MT9V111_R01_ADDR_SPACE: c_uint = 0x01;
pub const MT9V111_R01_IFP: c_uint = 0x01;
pub const MT9V111_R01_CORE: c_uint = 0x04;
pub const MT9V111_IFP_R06_OPMODE_CTRL: c_uint = 0x06;

pub const MT9V111_IFP_R07_IFP_RESET: c_uint = 0x07;

pub const MT9V111_IFP_R08_OUTFMT_CTRL: c_uint = 0x08;

pub const MT9V111_IFP_R3A_OUTFMT_CTRL2: c_uint = 0x3a;

pub const MT9V111_IFP_RA5_HPAN: c_uint = 0xa5;
pub const MT9V111_IFP_RA6_HZOOM: c_uint = 0xa6;
pub const MT9V111_IFP_RA7_HOUT: c_uint = 0xa7;
pub const MT9V111_IFP_RA8_VPAN: c_uint = 0xa8;
pub const MT9V111_IFP_RA9_VZOOM: c_uint = 0xa9;
pub const MT9V111_IFP_RAA_VOUT: c_uint = 0xaa;

pub const MT9V111_CORE_R03_WIN_HEIGHT: c_uint = 0x03;
pub const MT9V111_CORE_R03_WIN_V_OFFS: c_int = 2;
pub const MT9V111_CORE_R04_WIN_WIDTH: c_uint = 0x04;
pub const MT9V111_CORE_R04_WIN_H_OFFS: c_int = 114;
pub const MT9V111_CORE_R05_HBLANK: c_uint = 0x05;
pub const MT9V111_CORE_R05_MIN_HBLANK: c_uint = 0x09;

pub const MT9V111_CORE_R05_DEF_HBLANK: c_uint = 0x26;
pub const MT9V111_CORE_R06_VBLANK: c_uint = 0x06;
pub const MT9V111_CORE_R06_MIN_VBLANK: c_uint = 0x03;

pub const MT9V111_CORE_R06_DEF_VBLANK: c_uint = 0x04;
pub const MT9V111_CORE_R07_OUT_CTRL: c_uint = 0x07;

pub const MT9V111_CORE_R09_PIXEL_INT: c_uint = 0x09;

pub const MT9V111_CORE_R0D_CORE_RESET: c_uint = 0x0d;

pub const MT9V111_CORE_RFF_CHIP_VER: c_uint = 0xff;
pub const MT9V111_PIXEL_ARRAY_WIDTH: c_int = 640;
pub const MT9V111_PIXEL_ARRAY_HEIGHT: c_int = 480;
pub const MT9V111_MAX_CLKIN: c_int = 27000000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt9v111_dev {
    pub dev: *mut device,
    pub client: *mut i2c_client,
    pub addr_space: u8,
    pub sd: v4l2_subdev,
    pub pad: media_pad,
    pub auto_awb: *mut v4l2_ctrl,
...
// Clock provider and system clock frequency.
    pub clk: *mut clk,
    pub sysclk: u32,
    pub oe: *mut gpio_desc,
    pub standby: *mut gpio_desc,
...
// --- Device I/O access ---
#[no_mangle]
unsafe extern "C" fn __mt9v111_read(c: *mut i2c_client, reg: u8, val: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mt9v111_write(c: *mut i2c_client, reg: u8, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mt9v111_addr_space_select(c: *mut i2c_client, addr_space: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9v111_read(c: *mut i2c_client, addr_space: u8, reg: u8, val: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9v111_write(c: *mut i2c_client, addr_space: u8, reg: u8, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mt9v111_power_on(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mt9v111_power_off(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mt9v111_hw_reset(mt9v111: *mut mt9v111_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mt9v111_sw_reset(mt9v111: *mut mt9v111_dev) -> c_int {
...
//
    ...
    (frm_cols + vb);
    let mut t_fps: c_uint = DIV_ROUND_CLOSEST(pclk, t_frame);
    diff = abs(fps - t_fps);
    if (diff < best_diff) {
    best_diff = diff;
    best_fps = t_fps;
...
#[no_mangle]
unsafe extern "C" fn mt9v111_hw_config(mt9v111: *mut mt9v111_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9v111_s_power(sd: *mut v4l2_subdev, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9v111_s_stream(subdev: *mut v4l2_subdev, enable: c_int) -> c_int {
...
// --- V4L2 ctrl ---
#[no_mangle]
unsafe extern "C" fn mt9v111_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9v111_chip_probe(mt9v111: *mut mt9v111_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9v111_probe(client: *mut i2c_client) -> c_int {
    ...
    mt9v111.clk = devm_v4l2_sensor_clk_get(&client.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mt9v111_remove(client: *mut i2c_client) {
