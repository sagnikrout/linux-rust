...
//! Source: drivers/media/i2c/vd56g3.c
#![no_std]
...
pub const VD56G3_MODEL_ID: c_uint = 0x5603;

pub const VD56G3_REVISION_CUT3: c_uint = 0x31;

pub const VD56G3_OPTICAL_REVISION_MONO: c_int = 0;
pub const VD56G3_OPTICAL_REVISION_BAYER: c_int = 1;

pub const VD56G3_SYSTEM_FSM_READY_TO_BOOT: c_uint = 0x01;
pub const VD56G3_SYSTEM_FSM_SW_STBY: c_uint = 0x02;
pub const VD56G3_SYSTEM_FSM_STREAMING: c_uint = 0x03;

pub const VD56G3_CMD_ACK: c_int = 0;
pub const VD56G3_CMD_BOOT: c_int = 1;

pub const VD56G3_CMD_START_STREAM: c_int = 1;

pub const VD56G3_CMD_STOP_STREAM: c_int = 1;

pub const VD56G3_DUSTER_DISABLE: c_int = 0;
pub const VD56G3_DUSTER_ENABLE_DEF_MODULES: c_uint = 0x13;

pub const VD56G3_DARKCAL_ENABLE: c_int = 1;
pub const VD56G3_DARKCAL_DISABLE_DARKAVG: c_int = 2;

pub const VD56G3_PATGEN_ENABLE: c_int = 1;
pub const VD56G3_PATGEN_TYPE_SHIFT: c_int = 4;

pub const VD56G3_EXP_MODE_AUTO: c_int = 0;
pub const VD56G3_EXP_MODE_FREEZE: c_int = 1;
pub const VD56G3_EXP_MODE_MANUAL: c_int = 2;

pub const VD56G3_GPIOX_GPIO_IN: c_uint = 0x01;
pub const VD56G3_GPIOX_STROBE_MODE: c_uint = 0x02;

pub const READOUT_NORMAL: c_uint = 0x00;
pub const READOUT_DIGITAL_BINNING_X2: c_uint = 0x01;
// The VD56G3 is a portrait image sensor with native resolution of 1124x1364.
pub const VD56G3_NATIVE_WIDTH: c_int = 1124;
pub const VD56G3_NATIVE_HEIGHT: c_int = 1364;
pub const VD56G3_DEFAULT_MODE: c_int = 0;
// PLL settings

pub const VD56G3_VT_CLOCK_DIV: c_int = 5;
// External clock must be in [6Mhz-27Mhz]

// Line length and Frame length (settings are for standard 10bits ADC mode)
pub const VD56G3_LINE_LENGTH_MIN: c_int = 1236;
pub const VD56G3_VBLANK_MIN: c_int = 110;
pub const VD56G3_FRAME_LENGTH_DEF_60FPS: c_int = 2168;
pub const VD56G3_FRAME_LENGTH_MAX: c_uint = 0xffff;
// Exposure settings
pub const VD56G3_EXPOSURE_MARGIN: c_int = 75;
pub const VD56G3_EXPOSURE_MIN: c_int = 5;
pub const VD56G3_EXPOSURE_DEFAULT: c_int = 1420;
// Output Interface settings
pub const VD56G3_MAX_CSI_DATA_LANES: c_int = 2;

// GPIOs
pub const VD56G3_NB_GPIOS: c_int = 8;
// regulator supplies
...
pub struct vd56g3 {
    ...
    pub sd: v4l2_subdev,
    pub pad: media_pad,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(vd56g3_supply_names)],
...
#[no_mangle]
unsafe extern "C" fn vd56g3_wait_state(sensor: *mut vd56g3, state: c_int, err: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_get_bpp(code: __u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_get_datatype(code: __u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_read_expo_cluster(sensor: *mut vd56g3, force_cur_val: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_update_patgen(sensor: *mut vd56g3, patgen_index: u32) -> c_int {
    static int vd56g3_update_patgen(struct vd56g3 *sensor, u32 patgen_index)
    {
    let mut pattern: u32 = patgen_index <= 2 ? patgen_index : patgen_index + 13;
    let mut patgen: u16 = pattern << VD56G3_PATGEN_TYPE_SHIFT;
    let mut duster: u8 = VD56G3_DUSTER_ENABLE_DEF_MODULES;
    let mut darkcal: u8 = VD56G3_DARKCAL_ENABLE;
    let mut ret: c_int = 0;
    if (patgen_index) {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_update_expo_cluster(sensor: *mut vd56g3, is_auto: bool) -> c_int {
    static int vd56g3_update_expo_cluster(struct vd56g3 *sensor, bool is_auto)
    {
    let mut expo_state: u8 = is_auto ? VD56G3_EXP_MODE_AUTO : VD56G3_EXP_MODE_MANUAL;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn vd56g3_lock_exposure(sensor: *mut vd56g3, lock_val: u32) -> c_int {
    static int vd56g3_lock_exposure(struct vd56g3 *sensor, u32 lock_val)
    {
    let mut ae_lock: bool = lock_val & V4L2_LOCK_EXPOSURE;
    let mut expo_state: u8 = ae_lock ? VD56G3_EXP_MODE_FREEZE : VD56G3_EXP_MODE_AUTO;
    if (sensor.ae_ctrl.val == V4L2_EXPOSURE_AUTO)
    return cci_write(sensor.regmap, VD56G3_REG_EXP_MODE,
    expo_state, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn vd56g3_write_gpiox(sensor: *mut vd56g3, gpio_mask: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_g_volatile_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// Interact with HW only when it is powered ON
    ...
    ae_compensation, core::ptr::null_mut());
    break;
    case V4L2_CID_VBLANK:
    ret = cci_write(sensor.regmap, VD56G3_REG_FRAME_LENGTH,
    frame_length, core::ptr::null_mut());
    break;
...
#[no_mangle]
unsafe extern "C" fn vd56g3_update_controls(sensor: *mut vd56g3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_init_controls(sensor: *mut vd56g3) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vd56g3_get_mbus_code(sensor: *mut vd56g3, code: u32) -> u32 {
...
// locked controls must be unlocked
    ...
    struct v4l2_subdev_state *sd_state)
    {
    let mut def_mode: c_uint = VD56G3_DEFAULT_MODE;
...
//
#[no_mangle]
unsafe extern "C" fn vd56g3_power_on(dev: *mut device) -> c_int {
...
// power on
    ...
    ret = vd56g3_wait_state(sensor, VD56G3_SYSTEM_FSM_READY_TO_BOOT, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_power_off(dev: *mut device) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(vd56g3_power_off, vd56g3_power_on, core::ptr::null_mut())
    };
// -----------------------------------------------------------------------------
...
#[no_mangle]
unsafe extern "C" fn vd56g3_parse_dt_gpios(sensor: *mut vd56g3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_parse_dt(sensor: *mut vd56g3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_get_regulators(sensor: *mut vd56g3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_prepare_clock_tree(sensor: *mut vd56g3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_detect(sensor: *mut vd56g3) -> c_int {
    ...
    ret = cci_read(sensor.regmap, VD56G3_REG_MODEL_ID, &model_id, core::ptr::null_mut());
    if (ret)
    return ret;
    ...
    &optical_revision, core::ptr::null_mut());
    if (ret)
    return ret;
    sensor.is_mono =
...
#[no_mangle]
unsafe extern "C" fn vd56g3_subdev_init(sensor: *mut vd56g3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_subdev_cleanup(sensor: *mut vd56g3) {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vd56g3_remove(client: *mut i2c_client) {
