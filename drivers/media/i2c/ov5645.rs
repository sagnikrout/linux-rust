...
//! Source: drivers/media/i2c/ov5645.c
#![no_std]
...
pub const OV5645_SYSTEM_CTRL0: c_uint = 0x3008;
pub const OV5645_SYSTEM_CTRL0_START: c_uint = 0x02;
pub const OV5645_SYSTEM_CTRL0_STOP: c_uint = 0x42;
pub const OV5645_CHIP_ID_HIGH: c_uint = 0x300a;
pub const OV5645_CHIP_ID_HIGH_BYTE: c_uint = 0x56;
pub const OV5645_CHIP_ID_LOW: c_uint = 0x300b;
pub const OV5645_CHIP_ID_LOW_BYTE: c_uint = 0x45;
pub const OV5645_IO_MIPI_CTRL00: c_uint = 0x300e;
pub const OV5645_PAD_OUTPUT00: c_uint = 0x3019;
pub const OV5645_AWB_MANUAL_CONTROL: c_uint = 0x3406;

pub const OV5645_AEC_PK_MANUAL: c_uint = 0x3503;

pub const OV5645_TIMING_TC_REG20: c_uint = 0x3820;

pub const OV5645_TIMING_TC_REG21: c_uint = 0x3821;

pub const OV5645_MIPI_CTRL00: c_uint = 0x4800;
pub const OV5645_PRE_ISP_TEST_SETTING_1: c_uint = 0x503d;
pub const OV5645_TEST_PATTERN_MASK: c_uint = 0x3;

pub const OV5645_SDE_SAT_U: c_uint = 0x5583;
pub const OV5645_SDE_SAT_V: c_uint = 0x5584;
// regulator supplies
...
pub struct ov5645 {
    ...
    pub crop: v4l2_rect,
    pub xclk: *mut clk,
    pub supplies: [regulator_bulk_data; OV5645_NUM_SUPPLIES],
    pub current_mode: *const ov5645_mode_info,
    pub ctrls: v4l2_ctrl_handler,
    pub pixel_clock: *mut v4l2_ctrl,
    pub link_freq: *mut v4l2_ctrl,
// Cached register values
    pub aec_pk_manual: u8,
    pub timing_tc_reg20: u8,
    pub timing_tc_reg21: u8,
...
#[no_mangle]
unsafe extern "C" fn ov5645_write_reg(ov5645: *mut ov5645, reg: u16, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5645_read_reg(ov5645: *mut ov5645, reg: u16, val: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5645_set_aec_mode(ov5645: *mut ov5645, mode: u32) -> c_int {
    static int ov5645_set_aec_mode(struct ov5645 *ov5645, u32 mode)
    {
    let mut val: u8 = ov5645.aec_pk_manual;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ov5645_set_agc_mode(ov5645: *mut ov5645, enable: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ov5645_set_power_off(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ov5645_set_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5645_set_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5645_set_saturation(ov5645: *mut ov5645, value: i32) -> c_int {
    static int ov5645_set_saturation(struct ov5645 *ov5645, s32 value)
    {
    let mut reg_value: u32 = (value * 0x10) + 0x40;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ov5645_set_hflip(ov5645: *mut ov5645, value: i32) -> c_int {
    static int ov5645_set_hflip(struct ov5645 *ov5645, s32 value)
    {
    let mut val: u8 = ov5645.timing_tc_reg21;
    int ret;
    if (value == 0)
...
#[no_mangle]
unsafe extern "C" fn ov5645_set_vflip(ov5645: *mut ov5645, value: i32) -> c_int {
    static int ov5645_set_vflip(struct ov5645 *ov5645, s32 value)
    {
    let mut val: u8 = ov5645.timing_tc_reg20;
    int ret;
    if (value == 0)
...
#[no_mangle]
unsafe extern "C" fn ov5645_set_test_pattern(ov5645: *mut ov5645, value: i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5645_set_awb(ov5645: *mut ov5645, enable_auto: i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5645_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov5645_probe(client: *mut i2c_client) -> c_int {
...
// get system clock (xclk)
    ov5645.xclk = devm_v4l2_sensor_clk_get_legacy(dev, core::ptr::null_mut(), false, 0);
...
#[no_mangle]
unsafe extern "C" fn ov5645_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(ov5645_set_power_off, ov5645_set_power_on, core::ptr::null_mut())
    };
