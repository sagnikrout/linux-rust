...
//! Source: drivers/media/i2c/cx25840/cx25840-audio.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn cx25840_set_audclk_freq(client: *mut i2c_client, freq: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx25836_set_audclk_freq(client: *mut i2c_client, freq: u32) -> c_int {
    static inline int cx25836_set_audclk_freq(struct i2c_client *client, u32 freq)
    {
    return cx25840_set_audclk_freq(client, freq);
    }
#[no_mangle]
unsafe extern "C" fn cx23885_set_audclk_freq(client: *mut i2c_client, freq: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx231xx_set_audclk_freq(client: *mut i2c_client, freq: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_audclk_freq(client: *mut i2c_client, freq: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx25840_audio_set_path(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn set_volume(client: *mut i2c_client, volume: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_balance(client: *mut i2c_client, balance: c_int) {
    static void set_balance(struct i2c_client *client, int balance)
    {
    let mut bal: c_int = balance >> 8;
    if (bal > 0x80) {
// PATH1_BAL_LEFT
...
#[no_mangle]
pub unsafe extern "C" fn cx25840_s_clock_freq(sd: *mut v4l2_subdev, freq: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx25840_audio_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
