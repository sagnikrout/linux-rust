...
//! Source: drivers/media/i2c/vgxy61.c
#![no_std]
...
pub const VG5661_MODEL_ID: c_uint = 0x5661;
pub const VG5761_MODEL_ID: c_uint = 0x5761;

pub const VGXY61_SYSTEM_FSM_SW_STBY: c_uint = 0x03;
pub const VGXY61_SYSTEM_FSM_STREAMING: c_uint = 0x04;

pub const VGXY61_NVM_OK: c_uint = 0x04;

pub const VGXY61_STBY_NO_REQ: c_int = 0;

pub const VGXY61_STREAMING_NO_REQ: c_int = 0;

pub const VGXY61_PATGEN_LONG_TYPE_SHIFT: c_int = 18;
pub const VGXY61_PATGEN_SHORT_TYPE_SHIFT: c_int = 4;

pub const VGXY61_SIGNALS_GPIO_ID_SHIFT: c_int = 4;

pub const VGX661_WIDTH: c_int = 1464;
pub const VGX661_HEIGHT: c_int = 1104;
pub const VGX761_WIDTH: c_int = 1944;
pub const VGX761_HEIGHT: c_int = 1204;
pub const VGX661_DEFAULT_MODE: c_int = 1;
pub const VGX761_DEFAULT_MODE: c_int = 1;
pub const VGX661_SHORT_ROT_TERM: c_int = 93;
pub const VGX761_SHORT_ROT_TERM: c_int = 90;
pub const VGXY61_EXPOS_ROT_TERM: c_int = 66;
pub const VGXY61_WRITE_MULTIPLE_CHUNK_MAX: c_int = 16;
pub const VGXY61_NB_GPIOS: c_int = 4;
pub const VGXY61_NB_POLARITIES: c_int = 5;
pub const VGXY61_FRAME_LENGTH_DEF: c_int = 1313;
pub const VGXY61_MIN_FRAME_LENGTH: c_int = 1288;
pub const VGXY61_MIN_EXPOSURE: c_int = 10;
pub const VGXY61_HDR_LINEAR_RATIO: c_int = 10;
pub const VGXY61_TIMEOUT_MS: c_int = 500;

pub const VGXY61_FWPATCH_REVISION_MAJOR: c_int = 2;
pub const VGXY61_FWPATCH_REVISION_MINOR: c_int = 0;
pub const VGXY61_FWPATCH_REVISION_MICRO: c_int = 5;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vgxy61_mode_info {
    pub width: u32,
    pub height: u32,
    pub bin_mode: enum vgxy61_bin_mode,
    pub crop: v4l2_rect,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vgxy61_fmt_desc {
    pub code: u32,
    pub bpp: u8,
    pub data_type: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vgxy61_dev {
    pub i2c_client: *mut i2c_client,
    pub regmap: *mut regmap,
    pub sd: v4l2_subdev,
    pub pad: media_pad,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(vgxy61_supply_name)],
    ...
    pub oif_ctrl: u16,
    pub nb_of_lane: c_uint,
    pub data_rate_in_mbps: u32,
    pub pclk: u32,
    pub line_length: u16,
    pub rot_term: u16,
    pub gpios_polarity: bool,
// Lock to protect all members below
    pub lock: mutex,
    pub ctrl_handler: v4l2_ctrl_handler,
    pub pixel_rate_ctrl: *mut v4l2_ctrl,
    pub expo_ctrl: *mut v4l2_ctrl,
    pub vblank_ctrl: *mut v4l2_ctrl,
    pub vflip_ctrl: *mut v4l2_ctrl,
    pub hflip_ctrl: *mut v4l2_ctrl,
    pub streaming: bool,
    pub fmt: v4l2_mbus_framefmt,
    pub sensor_modes: *const vgxy61_mode_info,
    pub sensor_modes_nb: c_uint,
    pub default_mode: *const vgxy61_mode_info,
    pub current_mode: *const vgxy61_mode_info,
    pub hflip: bool,
    pub vflip: bool,
    pub hdr: enum vgxy61_hdr_mode,
    pub expo_long: u16,
    pub expo_short: u16,
    pub expo_max: u16,
    pub expo_min: u16,
    ...
    pub analog_gain: u8,
    pub strobe_mode: enum vgxy61_strobe_mode,
    pub pattern: u32,
}

#[no_mangle]
unsafe extern "C" fn get_bpp_by_code(code: __u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn get_data_type_by_code(code: __u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn compute_pll_parameters_by_freq(freq: u32, prediv: *mut u8, mult: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn get_pixel_rate(sensor: *mut vgxy61_dev) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn get_chunk_size(sensor: *mut vgxy61_dev) -> c_uint {
    static unsigned int get_chunk_size(struct vgxy61_dev *sensor)
    {
    struct i2c_adapter *adapter = sensor.i2c_client.adapter;
    let mut max_write_len: c_int = VGXY61_WRITE_MULTIPLE_CHUNK_MAX;
    ...
    {
    let mut chunk_size: c_uint = get_chunk_size(sensor);
    int ret;
    unsigned int sz;
    while (nb) {
    ...
    {
    let mut loop_delay_ms: c_uint = 10;
    u64 val;
    int ret;
    return read_poll_timeout(cci_read, ret,
    ((ret < 0) || (val == poll_val)),
    loop_delay_ms * 1000, timeout_ms * 1000,
    false, sensor.regmap, reg, &val, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn vgxy61_check_bw(sensor: *mut vgxy61_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgxy61_apply_exposure(sensor: *mut vgxy61_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgxy61_get_regulators(sensor: *mut vgxy61_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgxy61_apply_reset(sensor: *mut vgxy61_dev) -> c_int {
...
// Ensure the first rule of thumb can't be negative
    let mut min_vblank_hdr: u16 = VGXY61_MIN_EXPOSURE + sensor.rot_term + 1;
...
#[no_mangle]
unsafe extern "C" fn vgxy61_update_analog_gain(sensor: *mut vgxy61_dev, target: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgxy61_update_digital_gain(sensor: *mut vgxy61_dev, target: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgxy61_apply_patgen(sensor: *mut vgxy61_dev, index: u32) -> c_int {
    ...
    let mut pattern: u32 = index2val[index];
    ...
    return cci_write(sensor.regmap, VGXY61_REG_PATGEN_CTRL, reg, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn vgxy61_update_patgen(sensor: *mut vgxy61_dev, pattern: u32) -> c_int {
...
// Take the minimum from all rules
    ...
    let mut new_expo_short: u16 = 0;
    let mut expo_short_max: u16 = 0;
    let mut expo_long_min: u16 = VGXY61_MIN_EXPOSURE;
    let mut expo_long_max: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn vgxy61_apply_settings(sensor: *mut vgxy61_dev) -> c_int {
    ...
    sensor.analog_gain, core::ptr::null_mut());
    if (ret)
    return ret;
    ...
    sensor.hflip | (sensor.vflip << 1), core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn vgxy61_stream_enable(sensor: *mut vgxy61_dev) -> c_int {
    ...
    VGXY61_STREAMING_REQ_START, core::ptr::null_mut());
    if (ret)
    goto err_rpm_put;
...
#[no_mangle]
unsafe extern "C" fn vgxy61_stream_disable(sensor: *mut vgxy61_dev) -> c_int {
    static int vgxy61_stream_disable(struct vgxy61_dev *sensor)
    {
    struct i2c_client *client = v4l2_get_subdevdata(&sensor.sd);
    int ret;
    ret = cci_write(sensor.regmap, VGXY61_REG_STREAMING,
    VGXY61_STREAMING_REQ_STOP, core::ptr::null_mut());
    if (ret)
    goto err_str_dis;
    ret = vgxy61_poll_reg(sensor, VGXY61_REG_STREAMING,
...
#[no_mangle]
unsafe extern "C" fn vgxy61_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgxy61_init_controls(sensor: *mut vgxy61_dev) -> c_int {
...
//
    ...
    {
    let mut ep: v4l2_fwnode_endpoint = { .bus_type = V4L2_MBUS_CSI2_DPHY };
    struct i2c_client *client = sensor.i2c_client;
...
#[no_mangle]
unsafe extern "C" fn vgxy61_configure(sensor: *mut vgxy61_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgxy61_patch(sensor: *mut vgxy61_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgxy61_detect_cut_version(sensor: *mut vgxy61_dev) -> c_int {
    static int vgxy61_detect_cut_version(struct vgxy61_dev *sensor)
    {
    struct i2c_client *client = sensor.i2c_client;
    u64 device_rev;
    int ret;
    ret = cci_read(sensor.regmap, VGXY61_REG_REVISION, &device_rev, core::ptr::null_mut());
    if (ret < 0)
    return ret;
    switch (device_rev >> 8) {
    case 0xA:
...
#[no_mangle]
unsafe extern "C" fn vgxy61_detect(sensor: *mut vgxy61_dev) -> c_int {
    static int vgxy61_detect(struct vgxy61_dev *sensor)
    {
    struct i2c_client *client = sensor.i2c_client;
    u64 st, id = 0;
    int ret;
    ret = cci_read(sensor.regmap, VGXY61_REG_MODEL_ID, &id, core::ptr::null_mut());
    if (ret < 0)
    return ret;
    ...
    if (ret)
    return ret;
    ret = cci_read(sensor.regmap, VGXY61_REG_NVM, &st, core::ptr::null_mut());
    if (ret < 0)
    return ret;
    if (st != VGXY61_NVM_OK)
...
#[no_mangle]
unsafe extern "C" fn vgxy61_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgxy61_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgxy61_fill_sensor_param(sensor: *mut vgxy61_dev) {
...
#[no_mangle]
unsafe extern "C" fn vgxy61_probe(client: *mut i2c_client) -> c_int {
    ...
    sensor.xclk = devm_v4l2_sensor_clk_get(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn vgxy61_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(vgxy61_power_off, vgxy61_power_on, core::ptr::null_mut())
    };
