...
//! Source: drivers/media/i2c/msp3400-kthreads.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct msp3400c_carrier_detect {
    pub cdo: c_int,
    pub name: *mut c_char,
}
...
// ------------------------------------------------------------------------
    ...
    {
    int i;
    for (i = 0; msp_stdlist[i].name != core::ptr::null_mut(); i++)
    if (msp_stdlist[i].retval == std)
    return msp_stdlist[i].name;
    return "unknown";
    }
#[no_mangle]
unsafe extern "C" fn msp_standard_std(std: c_int) -> v4l2_std_id {
...
#[no_mangle]
unsafe extern "C" fn msp_set_source(client: *mut i2c_client, src: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn msp3400c_set_carrier(client: *mut i2c_client, cdo1: c_int, cdo2: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn msp3400c_set_mode(client: *mut i2c_client, mode: c_int) {
    void msp3400c_set_mode(struct i2c_client *client, int mode)
    {
    struct msp_state *state = to_state(i2c_get_clientdata(client));
    struct msp3400c_init_data_dem *data = &msp3400c_init_data[mode];
    let mut tuner: c_int = (state.route_in >> 3) & 1;
    int i;
...
#[no_mangle]
unsafe extern "C" fn msp3400c_set_audmode(client: *mut i2c_client) {
    ...
    let mut audmode: c_int = state.audmode;
...
// if bilingual
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_TUNER_SUB_LANG2: state->rxsubchans &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_TUNER_MODE_MONO: audmode !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn msp3400c_print_mode(client: *mut i2c_client) {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn msp3400c_detect_stereo(client: *mut i2c_client) -> c_int {
    static int msp3400c_detect_stereo(struct i2c_client *client)
    {
    struct msp_state *state = to_state(i2c_get_clientdata(client));
    int val;
    let mut rxsubchans: c_int = state.rxsubchans;
    let mut newnicam: c_int = state.nicam_on;
...
#[no_mangle]
unsafe extern "C" fn watch_stereo(client: *mut i2c_client) {
...
#[no_mangle]
pub unsafe extern "C" fn msp3400c_thread(data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn msp3410d_thread(data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn msp34xxg_modus(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msp34xxg_set_source(client: *mut i2c_client, reg: u16, in: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(state->has_dolby_pro_logic: in >= MSP_DSP_IN_MAIN_AVC &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn msp34xxg_set_sources(client: *mut i2c_client) {
    static void msp34xxg_set_sources(struct i2c_client *client)
    {
    struct msp_state *state = to_state(i2c_get_clientdata(client));
    let mut in: u32 = state.route_in;
...
#[no_mangle]
unsafe extern "C" fn msp34xxg_reset(client: *mut i2c_client) {
...
#[no_mangle]
pub unsafe extern "C" fn msp34xxg_thread(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msp34xxg_detect_stereo(client: *mut i2c_client) -> c_int {
    static int msp34xxg_detect_stereo(struct i2c_client *client)
    {
    struct msp_state *state = to_state(i2c_get_clientdata(client));
    let mut status: c_int = msp_read_dem(client, 0x0200);
    let mut is_bilingual: c_int = status & 0x100;
    let mut is_stereo: c_int = status & 0x40;
    let mut oldrx: c_int = state.rxsubchans;
    if (state.mode == MSP_MODE_EXTERN)
    return 0;
    state.rxsubchans = 0;
    if (is_stereo)
...
#[no_mangle]
unsafe extern "C" fn msp34xxg_set_audmode(client: *mut i2c_client) {
...
#[no_mangle]
pub unsafe extern "C" fn msp_set_audmode(client: *mut i2c_client) {
...
#[no_mangle]
pub unsafe extern "C" fn msp_detect_stereo(client: *mut i2c_client) -> c_int {
