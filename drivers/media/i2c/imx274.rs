...
//! Source: drivers/media/i2c/imx274.c
#![no_std]
...
//
pub const IMX274_SHR_REG_MSB: c_uint = 0x300D /* SHR */;
pub const IMX274_SHR_REG_LSB: c_uint = 0x300C /* SHR */;
pub const IMX274_SVR_REG_MSB: c_uint = 0x300F /* SVR */;
pub const IMX274_SVR_REG_LSB: c_uint = 0x300E /* SVR */;
pub const IMX274_HTRIM_EN_REG: c_uint = 0x3037;
pub const IMX274_HTRIM_START_REG_LSB: c_uint = 0x3038;
pub const IMX274_HTRIM_START_REG_MSB: c_uint = 0x3039;
pub const IMX274_HTRIM_END_REG_LSB: c_uint = 0x303A;
pub const IMX274_HTRIM_END_REG_MSB: c_uint = 0x303B;
pub const IMX274_VWIDCUTEN_REG: c_uint = 0x30DD;
pub const IMX274_VWIDCUT_REG_LSB: c_uint = 0x30DE;
pub const IMX274_VWIDCUT_REG_MSB: c_uint = 0x30DF;
pub const IMX274_VWINPOS_REG_LSB: c_uint = 0x30E0;
pub const IMX274_VWINPOS_REG_MSB: c_uint = 0x30E1;
pub const IMX274_WRITE_VSIZE_REG_LSB: c_uint = 0x3130;
pub const IMX274_WRITE_VSIZE_REG_MSB: c_uint = 0x3131;
pub const IMX274_Y_OUT_SIZE_REG_LSB: c_uint = 0x3132;
pub const IMX274_Y_OUT_SIZE_REG_MSB: c_uint = 0x3133;
pub const IMX274_VMAX_REG_1: c_uint = 0x30FA /* VMAX, MSB */;
pub const IMX274_VMAX_REG_2: c_uint = 0x30F9 /* VMAX */;
pub const IMX274_VMAX_REG_3: c_uint = 0x30F8 /* VMAX, LSB */;
pub const IMX274_HMAX_REG_MSB: c_uint = 0x30F7 /* HMAX */;
pub const IMX274_HMAX_REG_LSB: c_uint = 0x30F6 /* HMAX */;
pub const IMX274_ANALOG_GAIN_ADDR_LSB: c_uint = 0x300A /* ANALOG GAIN LSB */;
pub const IMX274_ANALOG_GAIN_ADDR_MSB: c_uint = 0x300B /* ANALOG GAIN MSB */;
pub const IMX274_DIGITAL_GAIN_REG: c_uint = 0x3012 /* Digital Gain */;
pub const IMX274_VFLIP_REG: c_uint = 0x301A /* VERTICAL FLIP */;
pub const IMX274_TEST_PATTERN_REG: c_uint = 0x303D /* TEST PATTERN */;
pub const IMX274_STANDBY_REG: c_uint = 0x3000 /* STANDBY */;
pub const IMX274_TABLE_WAIT_MS: c_int = 0;
pub const IMX274_TABLE_END: c_int = 1;
// regulator supplies
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx274_mode {
    pub init_regs: *const reg_8,
    pub wbin_ratio: u8,
    pub hbin_ratio: u8,
    pub min_frame_len: c_int,
    pub min_SHR: c_int,
    pub max_fps: c_int,
    pub nocpiop: c_int,
}
...
pub struct stimx274 {
    ...
    pub ctrls: imx274_ctrls,
    pub crop: v4l2_rect,
    pub format: v4l2_mbus_framefmt,
    pub frame_interval: v4l2_fract,
    pub regmap: *mut regmap,
    pub reset_gpio: *mut gpio_desc,
    pub supplies: [regulator_bulk_data; IMX274_NUM_SUPPLIES],
    pub inck: *mut clk,
    pub /: *mut *mut mutex lock; / mutex lock for operations,
    pub mode: *const imx274_mode,
}
...
#[no_mangle]
pub unsafe extern "C" fn msleep_range(delay_base: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn imx274_write_table(priv: *mut stimx274, table[]: reg_8) -> c_int {
    ...
    u8 val;
    let mut range_start: c_int = -1;
    let mut range_count: c_int = 0;
    u8 range_vals[16];
    let mut max_range_vals: c_int = ARRAY_SIZE(range_vals);
    for (next = table;; next++) {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: range_count >) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn imx274_write_reg(priv: *mut stimx274, addr: u16, val: u8) -> c_int {
...
//
    ...
    size_t nbytes)
    {
    let mut val_le: __le32 = cpu_to_le32(val);
    int err;
...
//
#[no_mangle]
unsafe extern "C" fn imx274_mode_regs(priv: *mut stimx274) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imx274_start_stream(priv: *mut stimx274) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imx274_reset(priv: *mut stimx274, rst: c_int) {
...
#[no_mangle]
unsafe extern "C" fn imx274_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx274_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx274_regulators_get(dev: *mut device, imx274: *mut stimx274) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx274_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
//
    ...
    let mut best_goodness: c_int = INT_MIN;
    ...
    let mut wratio: u8 = imx274_modes[i].wbin_ratio;
    let mut hratio: u8 = imx274_modes[i].hbin_ratio;
...
#[no_mangle]
unsafe extern "C" fn imx274_apply_trimming(imx274: *mut stimx274) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imx274_load_default(priv: *mut stimx274) {
...
#[no_mangle]
unsafe extern "C" fn imx274_s_stream(sd: *mut v4l2_subdev, on: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imx274_get_frame_length(priv: *mut stimx274, val: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(priv->mode->min_SHR: *mut *mut val <) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn imx274_set_digital_gain(priv: *mut stimx274, dgain: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imx274_set_gain(priv: *mut stimx274, ctrl: *mut v4l2_ctrl) -> c_int {
    static int imx274_set_gain(struct stimx274 *priv, struct v4l2_ctrl *ctrl)
    {
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn if(IMX274_MIN_GAIN: gain <) -> else {
    else if (gain < IMX274_MIN_GAIN)
    gain = IMX274_MIN_GAIN;
    if (gain <= IMX274_MAX_ANALOG_GAIN)
    digital_gain = 1;
#[no_mangle]
pub unsafe extern "C" fn if(2: *mut *mut gain <= IMX274_MAX_ANALOG_GAIN) -> else {
    else if (gain <= IMX274_MAX_ANALOG_GAIN * 2)
    digital_gain = 2;
#[no_mangle]
pub unsafe extern "C" fn if(4: *mut *mut gain <= IMX274_MAX_ANALOG_GAIN) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn imx274_set_coarse_time(priv: *mut stimx274, val: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imx274_set_exposure(priv: *mut stimx274, val: c_int) -> c_int {
    static int imx274_set_exposure(struct stimx274 *priv, int val)
    {
    int err;
    u32 hmax;
...
//
#[no_mangle]
unsafe extern "C" fn imx274_set_vflip(priv: *mut stimx274, val: c_int) -> c_int {
    static int imx274_set_vflip(struct stimx274 *priv, int val)
    {
    int err;
...
//
#[no_mangle]
unsafe extern "C" fn imx274_set_test_pattern(priv: *mut stimx274, val: c_int) -> c_int {
    static int imx274_set_test_pattern(struct stimx274 *priv, int val)
    {
    let mut err: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn imx274_set_frame_length(priv: *mut stimx274, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx274_fwnode_parse(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx274_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx274_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(imx274_power_off, imx274_power_on, core::ptr::null_mut())
    };
