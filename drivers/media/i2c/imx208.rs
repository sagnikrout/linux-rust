...
//! Source: drivers/media/i2c/imx208.c
#![no_std]
...
pub const IMX208_REG_MODE_SELECT: c_uint = 0x0100;
pub const IMX208_MODE_STANDBY: c_uint = 0x00;
pub const IMX208_MODE_STREAMING: c_uint = 0x01;
// Chip ID
pub const IMX208_REG_CHIP_ID: c_uint = 0x0000;
pub const IMX208_CHIP_ID: c_uint = 0x0208;
// V_TIMING internal
pub const IMX208_REG_VTS: c_uint = 0x0340;
pub const IMX208_VTS_60FPS: c_uint = 0x0472;
pub const IMX208_VTS_BINNING: c_uint = 0x0239;
pub const IMX208_VTS_60FPS_MIN: c_uint = 0x0458;
pub const IMX208_VTS_BINNING_MIN: c_uint = 0x0230;
pub const IMX208_VTS_MAX: c_uint = 0xffff;
// HBLANK control - read only
pub const IMX208_PPL_384MHZ: c_int = 2248;
pub const IMX208_PPL_96MHZ: c_int = 2248;
// Exposure control
pub const IMX208_REG_EXPOSURE: c_uint = 0x0202;
pub const IMX208_EXPOSURE_MIN: c_int = 4;
pub const IMX208_EXPOSURE_STEP: c_int = 1;
pub const IMX208_EXPOSURE_DEFAULT: c_uint = 0x190;
pub const IMX208_EXPOSURE_MAX: c_int = 65535;
// Analog gain control
pub const IMX208_REG_ANALOG_GAIN: c_uint = 0x0204;
pub const IMX208_ANA_GAIN_MIN: c_int = 0;
pub const IMX208_ANA_GAIN_MAX: c_uint = 0x00e0;
pub const IMX208_ANA_GAIN_STEP: c_int = 1;
pub const IMX208_ANA_GAIN_DEFAULT: c_uint = 0x0;
// Digital gain control
pub const IMX208_REG_GR_DIGITAL_GAIN: c_uint = 0x020e;
pub const IMX208_REG_R_DIGITAL_GAIN: c_uint = 0x0210;
pub const IMX208_REG_B_DIGITAL_GAIN: c_uint = 0x0212;
pub const IMX208_REG_GB_DIGITAL_GAIN: c_uint = 0x0214;
pub const IMX208_DIGITAL_GAIN_SHIFT: c_int = 8;
// Orientation
pub const IMX208_REG_ORIENTATION_CONTROL: c_uint = 0x0101;
// Test Pattern Control
pub const IMX208_REG_TEST_PATTERN_MODE: c_uint = 0x0600;
pub const IMX208_TEST_PATTERN_DISABLE: c_uint = 0x0;
pub const IMX208_TEST_PATTERN_SOLID_COLOR: c_uint = 0x1;
pub const IMX208_TEST_PATTERN_COLOR_BARS: c_uint = 0x2;
pub const IMX208_TEST_PATTERN_GREY_COLOR: c_uint = 0x3;
pub const IMX208_TEST_PATTERN_PN9: c_uint = 0x4;
pub const IMX208_TEST_PATTERN_FIX_1: c_uint = 0x100;
pub const IMX208_TEST_PATTERN_FIX_2: c_uint = 0x101;
pub const IMX208_TEST_PATTERN_FIX_3: c_uint = 0x102;
pub const IMX208_TEST_PATTERN_FIX_4: c_uint = 0x103;
pub const IMX208_TEST_PATTERN_FIX_5: c_uint = 0x104;
pub const IMX208_TEST_PATTERN_FIX_6: c_uint = 0x105;
// OTP Access
pub const IMX208_OTP_BASE: c_uint = 0x3500;
pub const IMX208_OTP_SIZE: c_int = 40;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx208_reg {
    pub address: u16,
    pub val: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx208_reg_list {
    pub num_of_regs: u32,
    pub regs: *const imx208_reg,
}

// Link frequency config
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx208_link_freq_config {
    pub pixels_per_line: u32,
// PLL registers for this link frequency
    pub reg_list: imx208_reg_list,
}

// Mode : resolution and related config&values
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx208_mode {
// Frame width
    pub width: u32,
// Frame height
    pub height: u32,
...
pub const IMX208_DATA_RATE_DOUBLE: c_int = 2;
pub const IMX208_NUM_OF_LANES: c_int = 2;
pub const IMX208_PIXEL_BITS: c_int = 10;
    enum {
...
// Current mode
    pub cur_mode: *const imx208_mode,
//
...
// OTP data
    pub otp_read: bool,
    pub otp_data: [c_char; IMX208_OTP_SIZE],
...
#[no_mangle]
unsafe extern "C" fn imx208_get_format_code(imx208: *mut imx208) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn imx208_read_reg(imx208: *mut imx208, reg: u16, len: u32, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx208_write_reg(imx208: *mut imx208, reg: u16, len: u32, val: u32) -> c_int {
...
// Open sub-device
#[no_mangle]
unsafe extern "C" fn imx208_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx208_update_digital_gain(imx208: *mut imx208, len: u32, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx208_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx208_identify_module(imx208: *mut imx208) -> c_int {
...
// Start streaming
#[no_mangle]
unsafe extern "C" fn imx208_start_streaming(imx208: *mut imx208) -> c_int {
...
// Stop streaming
#[no_mangle]
unsafe extern "C" fn imx208_stop_streaming(imx208: *mut imx208) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx208_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx208_read_otp(imx208: *mut imx208) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx208_init_controls(imx208: *mut imx208) -> c_int {
...
// By default, PIXEL_RATE is read only
    ...
    v4l2_ctrl_new_custom(ctrl_hdlr, &imx208_digital_gain_control, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn imx208_free_controls(imx208: *mut imx208) {
    static void imx208_free_controls(struct imx208 *imx208)
    {
    v4l2_ctrl_handler_free(imx208.sd.ctrl_handler);
    }
#[no_mangle]
unsafe extern "C" fn imx208_probe(client: *mut i2c_client) -> c_int {
    ...
    imx208.clk = devm_v4l2_sensor_clk_get(imx208.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn imx208_remove(client: *mut i2c_client) {
