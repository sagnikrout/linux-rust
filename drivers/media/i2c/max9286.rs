...
//! Source: drivers/media/i2c/max9286.c
#![no_std]
...
pub const MAX9286_REG_FSYNC_PERIOD_L: c_uint = 0x06;
pub const MAX9286_REG_FSYNC_PERIOD_M: c_uint = 0x07;
pub const MAX9286_REG_FSYNC_PERIOD_H: c_uint = 0x08;
// Register 0x0a
...
pub const MAX9286_REV_AMP_HIGH: c_int = 170;
// Register 0x3f

// Register 0x49
pub const MAX9286_VIDEO_DETECT_MASK: c_uint = 0x0f;
// Register 0x69
...
//
pub const MAX9286_NUM_GMSL: c_int = 4;
pub const MAX9286_N_SINKS: c_int = 4;
pub const MAX9286_N_PADS: c_int = 5;
pub const MAX9286_SRC_PAD: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max9286_format_info {
    pub code: u32,
    pub datatype: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max9286_asd {
    pub base: v4l2_async_connection,
    pub source: *mut max9286_source,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max9286_priv {
    pub client: *mut i2c_client,
    pub gpiod_pwdn: *mut gpio_desc,
    pub sd: v4l2_subdev,
    pub pads: [media_pad; MAX9286_N_PADS],
    pub regulator: *mut regulator,
    pub gpio: gpio_chip,
    pub gpio_state: u8,
    pub mux: *mut i2c_mux_core,
    pub mux_channel: c_uint,
    pub mux_open: bool,
// The initial reverse control channel amplitude.
    pub init_rev_chan_mv: u32,
    pub rev_chan_mv: u32,
    pub i2c_mstbt: u8,
    pub bus_width: u32,
    pub use_gpio_poc: bool,
    pub gpio_poc: [u32; 2],
    pub ctrls: v4l2_ctrl_handler,
    pub pixelrate_ctrl: *mut v4l2_ctrl,
    pub pixelrate: c_uint,
    pub nsources: c_uint,
    pub source_mask: c_uint,
    pub route_mask: c_uint,
    pub bound_sources: c_uint,
    pub csi2_data_lanes: c_uint,
    pub sources: [max9286_source; MAX9286_NUM_GMSL],
    ...
    for ((source) = core::ptr::null_mut(); ((source) = next_source((priv), (source))); )
...
//
#[no_mangle]
unsafe extern "C" fn max9286_read(priv: *mut max9286_priv, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max9286_write(priv: *mut max9286_priv, reg: u8, val: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn max9286_i2c_mux_configure(priv: *mut max9286_priv, conf: u8) {
...
#[no_mangle]
unsafe extern "C" fn max9286_i2c_mux_open(priv: *mut max9286_priv) {
...
#[no_mangle]
unsafe extern "C" fn max9286_i2c_mux_close(priv: *mut max9286_priv) {
...
#[no_mangle]
unsafe extern "C" fn max9286_i2c_mux_select(muxc: *mut i2c_mux_core, chan: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max9286_i2c_mux_init(priv: *mut max9286_priv) -> c_int {
    ...
    max9286_i2c_mux_select, core::ptr::null_mut());
    if (!priv.mux)
    return -ENOMEM;
    priv.mux.priv = priv;
    for_each_source(priv, source) {
    let mut index: c_uint = to_index(priv, source);
...
#[no_mangle]
unsafe extern "C" fn max9286_configure_i2c(priv: *mut max9286_priv, localack: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn max9286_check_video_links(priv: *mut max9286_priv) -> c_int {
...
//
    ...
    {
    let mut conflink_mask: c_uint = (source_mask & 0x0f) << 4;
    unsigned int i;
    int ret;
//
...
//
    ...
    {
    const struct max9286_format_info *info = core::ptr::null_mut();
    unsigned int i;
...
//
#[no_mangle]
unsafe extern "C" fn max9286_set_pixelrate(priv: *mut max9286_priv) -> c_int {
    static int max9286_set_pixelrate(struct max9286_priv *priv)
    {
    struct max9286_source *source = core::ptr::null_mut();
    let mut pixelrate: u64 = 0;
    for_each_source(priv, source) {
    struct v4l2_ctrl *ctrl;
    let mut source_rate: u64 = 0;
...
#[no_mangle]
unsafe extern "C" fn max9286_v4l2_notifier_register(priv: *mut max9286_priv) -> c_int {
    ...
    for_each_source(priv, source) {
    let mut i: c_uint = to_index(priv, source);
...
#[no_mangle]
unsafe extern "C" fn max9286_v4l2_notifier_unregister(priv: *mut max9286_priv) {
...
#[no_mangle]
unsafe extern "C" fn max9286_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max9286_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max9286_v4l2_register(priv: *mut max9286_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max9286_v4l2_unregister(priv: *mut max9286_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn max9286_setup(priv: *mut max9286_priv) -> c_int {
...
//
    ...
    cfg |= MAX9286_HIBW;
#[no_mangle]
pub unsafe extern "C" fn if(32: priv->bus_width ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn max9286_gpiochip_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max9286_register_gpio(priv: *mut max9286_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max9286_parse_gpios(priv: *mut max9286_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max9286_poc_power_on(priv: *mut max9286_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max9286_poc_power_off(priv: *mut max9286_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max9286_poc_enable(priv: *mut max9286_priv, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max9286_init(priv: *mut max9286_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max9286_cleanup_dt(priv: *mut max9286_priv) {
    static void max9286_cleanup_dt(struct max9286_priv *priv)
    {
    struct max9286_source *source;
    for_each_source(priv, source) {
    fwnode_handle_put(source.fwnode);
    source.fwnode = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn max9286_parse_dt(priv: *mut max9286_priv) -> c_int {
    static int max9286_parse_dt(struct max9286_priv *priv)
    {
    struct device *dev = &priv.client.dev;
    struct device_node *i2c_mux;
    struct device_node *node = core::ptr::null_mut();
    let mut i2c_mux_mask: c_uint = 0;
    u32 reverse_channel_microvolt;
    let mut i2c_clk_freq: u32 = 105000;
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn max9286_get_poc_supplies(priv: *mut max9286_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max9286_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max9286_remove(client: *mut i2c_client) {
