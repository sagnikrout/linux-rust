...
//! Source: drivers/media/i2c/ov08x40.c
#![no_std]
...
pub const OV08X40_REG_VALUE_08BIT: c_int = 1;
pub const OV08X40_REG_VALUE_16BIT: c_int = 2;
pub const OV08X40_REG_VALUE_24BIT: c_int = 3;
pub const OV08X40_REG_MODE_SELECT: c_uint = 0x0100;
pub const OV08X40_MODE_STANDBY: c_uint = 0x00;
pub const OV08X40_MODE_STREAMING: c_uint = 0x01;
pub const OV08X40_REG_AO_STANDBY: c_uint = 0x1000;
pub const OV08X40_AO_STREAMING: c_uint = 0x04;
pub const OV08X40_REG_MS_SELECT: c_uint = 0x1001;
pub const OV08X40_MS_STANDBY: c_uint = 0x00;
pub const OV08X40_MS_STREAMING: c_uint = 0x04;
pub const OV08X40_REG_SOFTWARE_RST: c_uint = 0x0103;
pub const OV08X40_SOFTWARE_RST: c_uint = 0x01;
// Chip ID
pub const OV08X40_REG_CHIP_ID: c_uint = 0x300a;
pub const OV08X40_CHIP_ID: c_uint = 0x560858;
// V_TIMING internal
pub const OV08X40_REG_VTS: c_uint = 0x380e;
pub const OV08X40_VTS_30FPS: c_uint = 0x09c4	/* the VTS need to be half in normal mode */;
pub const OV08X40_VTS_BIN_30FPS: c_uint = 0x115c;
pub const OV08X40_VTS_MAX: c_uint = 0x7fff;
// H TIMING internal
pub const OV08X40_REG_HTS: c_uint = 0x380c;
pub const OV08X40_HTS_30FPS: c_uint = 0x0280;
// Exposure control
pub const OV08X40_REG_EXPOSURE: c_uint = 0x3500;
pub const OV08X40_EXPOSURE_MAX_MARGIN: c_int = 8;
pub const OV08X40_EXPOSURE_BIN_MAX_MARGIN: c_int = 2;
pub const OV08X40_EXPOSURE_MIN: c_int = 4;
pub const OV08X40_EXPOSURE_STEP: c_int = 1;
pub const OV08X40_EXPOSURE_DEFAULT: c_uint = 0x40;
// Short Exposure control
pub const OV08X40_REG_SHORT_EXPOSURE: c_uint = 0x3540;
// Analog gain control
pub const OV08X40_REG_ANALOG_GAIN: c_uint = 0x3508;
pub const OV08X40_ANA_GAIN_MIN: c_uint = 0x80;
pub const OV08X40_ANA_GAIN_MAX: c_uint = 0x07c0;
pub const OV08X40_ANA_GAIN_STEP: c_int = 1;
pub const OV08X40_ANA_GAIN_DEFAULT: c_uint = 0x80;
// Digital gain control
pub const OV08X40_REG_DGTL_GAIN_H: c_uint = 0x350a;
pub const OV08X40_REG_DGTL_GAIN_M: c_uint = 0x350b;
pub const OV08X40_REG_DGTL_GAIN_L: c_uint = 0x350c;

pub const OV08X40_DGTL_GAIN_L_SHIFT: c_int = 6;
pub const OV08X40_DGTL_GAIN_L_MASK: c_uint = 0x3;
pub const OV08X40_DGTL_GAIN_M_SHIFT: c_int = 2;
pub const OV08X40_DGTL_GAIN_M_MASK: c_uint = 0xff;
pub const OV08X40_DGTL_GAIN_H_SHIFT: c_int = 10;
pub const OV08X40_DGTL_GAIN_H_MASK: c_uint = 0x1F;
// Test Pattern Control
pub const OV08X40_REG_TEST_PATTERN: c_uint = 0x50C1;
pub const OV08X40_REG_ISP: c_uint = 0x5000;
pub const OV08X40_REG_SHORT_TEST_PATTERN: c_uint = 0x53C1;

pub const OV08X40_TEST_PATTERN_MASK: c_uint = 0xcf;
pub const OV08X40_TEST_PATTERN_BAR_SHIFT: c_int = 4;
// Flip Control
pub const OV08X40_REG_VFLIP: c_uint = 0x3820;
pub const OV08X40_REG_MIRROR: c_uint = 0x3821;
// Horizontal Window Offset
pub const OV08X40_REG_H_WIN_OFFSET: c_uint = 0x3811;
// Vertical Window Offset
pub const OV08X40_REG_V_WIN_OFFSET: c_uint = 0x3813;
// Burst Register
pub const OV08X40_REG_XTALK_FIRST_A: c_uint = 0x5a80;
pub const OV08X40_REG_XTALK_LAST_A: c_uint = 0x5b9f;
pub const OV08X40_REG_XTALK_FIRST_B: c_uint = 0x5bc0;
pub const OV08X40_REG_XTALK_LAST_B: c_uint = 0x5f1f;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov08x40_reg_list {
    pub num_of_regs: u32,
    pub regs: *const ov08x40_reg,
}

// Link frequency config
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov08x40_link_freq_config {
// registers for this link frequency
    pub reg_list: ov08x40_reg_list,
}

// Mode : resolution and related config&values
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov08x40_mode {
// Frame width
    pub width: u32,
// Frame height
    pub height: u32,
...
// Exposure calculation
    pub exposure_margin: u16,
    pub exposure_shift: u16,
}
...
pub const OV08X40_XVCLK: c_int = 19200000;
pub const OV08X40_DATA_LANES: c_int = 4;
//
// pixel_rate = link_freq * data-rate * nr_of_lanes / bits_per_sample
// data rate => double data rate; number of lanes => 4; bits per pixel => 10
//
#[no_mangle]
unsafe extern "C" fn link_freq_to_pixel_rate(f: u64) -> u64 {
...
// V4L2 Controls
    ...
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(ov08x40_supply_names)],
// Current mode
    pub cur_mode: *const ov08x40_mode,
...
#[no_mangle]
unsafe extern "C" fn ov08x40_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08x40_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08x40_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08x40_update_digital_gain(ov08x: *mut ov08x40, d_gain: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08x40_enable_test_pattern(ov08x: *mut ov08x40, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08x40_set_ctrl_hflip(ov08x: *mut ov08x40, ctrl_val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08x40_set_ctrl_vflip(ov08x: *mut ov08x40, ctrl_val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08x40_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08x40_start_streaming(ov08x: *mut ov08x40) -> c_int {
...
// Stop streaming
#[no_mangle]
unsafe extern "C" fn ov08x40_stop_streaming(ov08x: *mut ov08x40) -> c_int {
...
// Verify chip ID
#[no_mangle]
unsafe extern "C" fn ov08x40_identify_module(ov08x: *mut ov08x40) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08x40_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08x40_init_controls(ov08x: *mut ov08x40) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08x40_free_controls(ov08x: *mut ov08x40) {
...
#[no_mangle]
unsafe extern "C" fn ov08x40_check_hwcfg(ov08x: *mut ov08x40) -> c_int {
...
//
    ...
    if (ret)
    goto out_err;
    ov08x.xvclk = devm_v4l2_sensor_clk_get(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ov08x40_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov08x40_remove(client: *mut i2c_client) {
    ...
    ov08x40_power_on, core::ptr::null_mut());
