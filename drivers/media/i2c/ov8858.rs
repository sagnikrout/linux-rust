...
//! Source: drivers/media/i2c/ov8858.c
#![no_std]
...
pub const OV8858_XVCLK_FREQ: c_int = 24000000;
pub const OV8858_REG_SIZE_SHIFT: c_int = 16;
pub const OV8858_REG_ADDR_MASK: c_uint = 0xffff;

pub const OV8858_MODE_SW_STANDBY: c_uint = 0x0;
pub const OV8858_MODE_STREAMING: c_uint = 0x1;

pub const OV8858_CHIP_ID: c_uint = 0x008858;

pub const OV8858_R1A: c_uint = 0xb0;
pub const OV8858_R2A: c_uint = 0xb2;

pub const OV8858_EXPOSURE_MIN: c_int = 4;
pub const OV8858_EXPOSURE_STEP: c_int = 1;
pub const OV8858_EXPOSURE_MARGIN: c_int = 4;

pub const OV8858_LONG_GAIN_MIN: c_uint = 0x0;
pub const OV8858_LONG_GAIN_MAX: c_uint = 0x7ff;
pub const OV8858_LONG_GAIN_STEP: c_int = 1;
pub const OV8858_LONG_GAIN_DEFAULT: c_uint = 0x80;

pub const OV8858_LONG_DIGIGAIN_H_MASK: c_uint = 0x3fc0;
pub const OV8858_LONG_DIGIGAIN_L_MASK: c_uint = 0x3f;
pub const OV8858_LONG_DIGIGAIN_H_SHIFT: c_int = 2;
pub const OV8858_LONG_DIGIGAIN_MIN: c_uint = 0x0;
pub const OV8858_LONG_DIGIGAIN_MAX: c_uint = 0x3fff;
pub const OV8858_LONG_DIGIGAIN_STEP: c_int = 1;
pub const OV8858_LONG_DIGIGAIN_DEFAULT: c_uint = 0x200;

pub const OV8858_VTS_MAX: c_uint = 0x7fff;

pub const OV8858_TEST_PATTERN_ENABLE: c_uint = 0x80;
pub const OV8858_TEST_PATTERN_DISABLE: c_uint = 0x0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct regval_modes {
    pub mode_2lanes: *const regval,
    pub mode_4lanes: *const regval,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov8858_mode {
    pub width: u32,
    pub height: u32,
    pub hts_def: u32,
    pub vts_def: u32,
    pub exp_def: u32,
    pub reg_modes: regval_modes,
}
...
pub struct ov8858 {
    ...
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(ov8858_supply_names)],
...
//
#[no_mangle]
unsafe extern "C" fn ov8858_write(ov8858: *mut ov8858, reg: u32, val: u32, err: *mut c_int) -> c_int {
    ...
    let mut len: c_uint = (reg >> OV8858_REG_SIZE_SHIFT) & 3;
    let mut addr: u16 = reg & OV8858_REG_ADDR_MASK;
    u8 buf[6];
    int ret;
    if (err && *err)
    return *err;
...
#[no_mangle]
unsafe extern "C" fn ov8858_write_array(ov8858: *mut ov8858, regs: *const regval) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8858_read(ov8858: *mut ov8858, reg: u32, val: *mut u32) -> c_int {
    static int ov8858_read(struct ov8858 *ov8858, u32 reg, u32 *val)
    {
    struct i2c_client *client = v4l2_get_subdevdata(&ov8858.subdev);
    let mut reg_addr_be: __be16 = cpu_to_be16(reg & OV8858_REG_ADDR_MASK);
    let mut len: c_uint = (reg >> OV8858_REG_SIZE_SHIFT) & 3;
...
// 200 usec max to let PLL stabilize.
    ...
    OV8858_MODE_STREAMING, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn ov8858_stop_stream(ov8858: *mut ov8858) -> c_int {
    static int ov8858_stop_stream(struct ov8858 *ov8858)
    {
    return ov8858_write(ov8858, OV8858_REG_SC_CTRL0100,
    OV8858_MODE_SW_STANDBY, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ov8858_s_stream(sd: *mut v4l2_subdev, on: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ov8858_enable_test_pattern(ov8858: *mut ov8858, pattern: u32) -> c_int {
    ...
    return ov8858_write(ov8858, OV8858_REG_TEST_PATTERN, val, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ov8858_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
//
    ...
    digi_gain, core::ptr::null_mut());
    break;
    case V4L2_CID_VBLANK:
    ret = ov8858_write(ov8858, OV8858_REG_VTS,
    ctrl.val + format.height, core::ptr::null_mut());
    break;
...
//
#[no_mangle]
unsafe extern "C" fn ov8858_power_on(ov8858: *mut ov8858) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8858_power_off(ov8858: *mut ov8858) {
...
#[no_mangle]
unsafe extern "C" fn ov8858_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8858_runtime_suspend(dev: *mut device) -> c_int {
    ...
    ov8858_runtime_resume, core::ptr::null_mut())
    };
// ----------------------------------------------------------------------------
// Probe and initialization
//
#[no_mangle]
unsafe extern "C" fn ov8858_init_ctrls(ov8858: *mut ov8858) -> c_int {
...
// pixel rate = link frequency * 2 * lanes / bpp
    ...
    h_blank = mode.hts_def - mode.width;
    ov8858.hblank = v4l2_ctrl_new_std(handler, core::ptr::null_mut(), V4L2_CID_HBLANK,
...
#[no_mangle]
unsafe extern "C" fn ov8858_check_sensor_id(ov8858: *mut ov8858) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8858_configure_regulators(ov8858: *mut ov8858) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8858_parse_of(ov8858: *mut ov8858) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8858_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov8858_remove(client: *mut i2c_client) {
