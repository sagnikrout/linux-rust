...
//! Source: drivers/media/i2c/ccs/ccs-core.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ccs_assign_limit(ptr: *mut c_void, width: c_uint, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn ccs_read_all_limits(sensor: *mut ccs_sensor) -> c_int {
    ...
    sensor.ccs_limits = core::ptr::null_mut();
    ...
    let mut reg: u32 = ccs_limits[i].reg;
    let mut width: c_uint = CCI_REG_WIDTH_BYTES(reg);
    unsigned int j;
    if (l == CCS_L_LAST) {
    dev_err(&client.dev,
...
#[no_mangle]
unsafe extern "C" fn ccs_mipi_csi2_data_type(bpp: c_uint) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ccs_read_frame_fmt(sensor: *mut ccs_sensor) -> c_int {
    static int ccs_read_frame_fmt(struct ccs_sensor *sensor)
    {
    struct i2c_client *client = v4l2_get_subdevdata(&sensor.src.sd);
    u8 fmt_model_type, fmt_model_subtype, ncol_desc, nrow_desc;
    unsigned int i;
    let mut pixel_count: c_int = 0;
    let mut line_count: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ccs_pll_configure(sensor: *mut ccs_sensor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccs_pll_try(sensor: *mut ccs_sensor, pll: *mut ccs_pll) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(sink_comp->height: sink_crop->height ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ccs_pll_update(sensor: *mut ccs_sensor) -> c_int {
    ...
    u8 scale_m;
    int rval;
    ccs_get_binning(sensor, core::ptr::null_mut(), &binh, &binv);
    if (sensor.scaler)
    ccs_get_scaling(sensor, core::ptr::null_mut(), &scale_m);
    else
...
#[no_mangle]
unsafe extern "C" fn ccs_pixel_order(sensor: *mut ccs_sensor) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ccs_update_mbus_formats(sensor: *mut ccs_sensor) {
    ...
    let mut pixel_order: c_uint = ccs_pixel_order(sensor);
...
#[no_mangle]
unsafe extern "C" fn ccs_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    struct i2c_client *client = v4l2_get_subdevdata(&sensor.src.sd);
    struct v4l2_subdev_state *state;
    const struct v4l2_rect *pa_src = core::ptr::null_mut();
    int pm_status;
...
#[no_mangle]
unsafe extern "C" fn ccs_init_controls(sensor: *mut ccs_sensor) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ccs_init_late_controls(sensor: *mut ccs_sensor) -> c_int {
    ...
    unsigned int i;
    for (i = 0; i < ARRAY_SIZE(sensor.test_data); i++) {
    let mut max_value: c_int = (1 << sensor.csi_format.width) - 1;
...
#[no_mangle]
unsafe extern "C" fn ccs_free_controls(sensor: *mut ccs_sensor) {
...
#[no_mangle]
unsafe extern "C" fn ccs_get_mbus_formats(sensor: *mut ccs_sensor) -> c_int {
    static int ccs_get_mbus_formats(struct ccs_sensor *sensor)
    {
    struct i2c_client *client = v4l2_get_subdevdata(&sensor.src.sd);
    struct ccs_pll *pll = &sensor.pll;
    let mut compressed_max_bpp: u8 = 0;
    unsigned int type, n;
...
#[no_mangle]
unsafe extern "C" fn ccs_pll_blanking_update(sensor: *mut ccs_sensor) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ccs_change_cci_addr(sensor: *mut ccs_sensor) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ccs_setup_flash_strobe(sensor: *mut ccs_sensor) -> c_int {
    static int ccs_setup_flash_strobe(struct ccs_sensor *sensor)
    {
    struct ccs_flash_strobe_parms *strobe_setup;
    let mut ext_freq: c_uint = sensor.hwcfg.ext_clk;
    u32 tmp;
...
//
#[no_mangle]
unsafe extern "C" fn ccs_write_msr_regs(sensor: *mut ccs_sensor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccs_update_phy_ctrl(sensor: *mut ccs_sensor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccs_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccs_power_off(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ccs_pm_get_init(sensor: *mut ccs_sensor) -> c_int {
...
// Output size from sensor
    ...
    sensor.hwcfg.strobe_setup != core::ptr::null_mut() &&
    sensor.hwcfg.strobe_setup.trigger != 0) {
...
#[no_mangle]
unsafe extern "C" fn ccs_pre_streamon(subdev: *mut v4l2_subdev, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccs_post_streamoff(subdev: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccs_get_mbus_code(subdev: *mut v4l2_subdev, pad: c_uint) -> u32 {
...
// old_csi_format = sensor->csi_format;
    unsigned long *valid_link_freqs;
    let mut code: u32 = fmt.format.code;
    unsigned int i;
    int rval;
...
//
pub const SCALING_GOODNESS: c_int = 100000;
pub const SCALING_GOODNESS_EXTREME: c_int = 100000000;
...
//
    ...
    let mut scale_m: u32 = CCS_LIM(sensor, SCALER_N_MIN);
    let mut mode: c_int = CCS_SCALING_MODE_HORIZONTAL;
    u32 try[4];
    let mut ntry: u32 = 0;
    unsigned int i;
    let mut best: c_int = INT_MIN;
...
// We only implement crop in three places.
    ...
    struct ccs_sensor *sensor = to_ccs_sensor(subdev);
    struct ccs_subdev *ssd = to_ccs_subdev(subdev);
    let mut src_size: v4l2_rect = { 0 }, *crop;
...
#[no_mangle]
unsafe extern "C" fn ccs_get_native_size(ssd: *mut ccs_subdev, r: *mut v4l2_rect) {
...
#[no_mangle]
unsafe extern "C" fn ccs_get_skip_frames(subdev: *mut v4l2_subdev, frames: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccs_get_skip_top_lines(subdev: *mut v4l2_subdev, lines: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ccs_identify_module(sensor: *mut ccs_sensor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccs_unregistered(subdev: *mut v4l2_subdev) {
...
#[no_mangle]
unsafe extern "C" fn ccs_registered(subdev: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccs_cleanup(sensor: *mut ccs_sensor) {
...
//
#[no_mangle]
unsafe extern "C" fn ccs_get_hwconfig(sensor: *mut ccs_sensor, dev: *mut device) -> c_int {
    static int ccs_get_hwconfig(struct ccs_sensor *sensor, struct device *dev)
    {
    let mut bus_cfg: v4l2_fwnode_endpoint = { .bus_type = V4L2_MBUS_UNKNOWN };
...
//
    ...
    let mut is_ccs: bool = !(ccsdev.flags & CCS_DEVICE_FLAG_IS_SMIA);
    let mut is_smiapp: bool = sensor.minfo.smiapp_version;
    u16 manufacturer_id;
    u16 model_id;
    u16 revision_number;
//
...
#[no_mangle]
unsafe extern "C" fn ccs_probe(client: *mut i2c_client) -> c_int {
    ...
    sensor.ext_clk = devm_v4l2_sensor_clk_get(&client.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ccs_remove(client: *mut i2c_client) {
    ...
    let mut ccs_device: static struct ccs_device = {};
    ...
    SET_RUNTIME_PM_OPS(ccs_power_off, ccs_power_on, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn ccs_module_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccs_module_cleanup() {
