...
//! Source: drivers/media/i2c/adv7842.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adv7842_format_info {
    pub code: u32,
    pub op_ch_sel: u8,
    pub rgb_out: bool,
    pub swap_cb_cr: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adv7842_state {
    pub pdata: adv7842_platform_data,
    pub sd: v4l2_subdev,
    pub 1]: media_pad pads[ADV7842_PAD_SOURCE +,
    pub hdl: v4l2_ctrl_handler,
    pub mode: enum adv7842_mode,
    pub timings: v4l2_dv_timings,
    pub vid_std_select: enum adv7842_vid_std_select,
    pub format: *const adv7842_format_info,
...
#[no_mangle]
unsafe extern "C" fn adv7842_check_dv_timings(t: *const v4l2_dv_timings, hdl: *mut c_void) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adv7842_video_standards {
    pub timings: v4l2_dv_timings,
    pub vid_std: u8,
    pub v_freq: u8,
}
...
#[no_mangle]
pub unsafe extern "C" fn io_write_and_or(sd: *mut v4l2_subdev, reg: u8, mask: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avlink_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avlink_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cec_write_clr_set(sd: *mut v4l2_subdev, reg: u8, mask: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn infoframe_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sdp_io_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sdp_io_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sdp_io_write_and_or(sd: *mut v4l2_subdev, reg: u8, mask: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sdp_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sdp_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sdp_write_and_or(sd: *mut v4l2_subdev, reg: u8, mask: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn afe_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn afe_write_and_or(sd: *mut v4l2_subdev, reg: u8, mask: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rep_write_and_or(sd: *mut v4l2_subdev, reg: u8, mask: u8, val: u8) -> c_int {
    static inline int rep_write_and_or(struct v4l2_subdev *sd, u8 reg, u8 mask, u8 val)
    {
    return rep_write(sd, reg, (rep_read(sd, reg) & mask) | val);
    }
#[no_mangle]
pub unsafe extern "C" fn edid_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn edid_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hdmi_write_and_or(sd: *mut v4l2_subdev, reg: u8, mask: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cp_write_and_or(sd: *mut v4l2_subdev, reg: u8, mask: u8, val: u8) -> c_int {
    static inline int cp_write_and_or(struct v4l2_subdev *sd, u8 reg, u8 mask, u8 val)
    {
    return cp_write(sd, reg, (cp_read(sd, reg) & mask) | val);
    }
#[no_mangle]
pub unsafe extern "C" fn vdp_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vdp_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn main_reset(sd: *mut v4l2_subdev) {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn adv7842_read_cable_det(sd: *mut v4l2_subdev) -> u16 {
    static u16 adv7842_read_cable_det(struct v4l2_subdev *sd)
    {
    let mut reg: u8 = io_read(sd, 0x6f);
    let mut val: u16 = 0;
    if (reg & 0x02)
    val |= 1; /* port A */
    if (reg & 0x01)
...
#[no_mangle]
unsafe extern "C" fn adv7842_delayed_work_enable_hotplug(work: *mut work_struct) {
    ...
    let mut present: c_int = state.hdmi_edid.present;
    let mut mask: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn edid_write_vga_segment(sd: *mut v4l2_subdev) -> c_int {
    static int edid_write_vga_segment(struct v4l2_subdev *sd)
    {
    struct i2c_client *client = v4l2_get_subdevdata(sd);
    struct adv7842_state *state = to_state(sd);
    const u8 *edid = state.vga_edid.edid;
    let mut blocks: u32 = state.vga_edid.blocks;
    let mut err: c_int = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn edid_write_hdmi_segment(sd: *mut v4l2_subdev, port: u8) -> c_int {
    static int edid_write_hdmi_segment(struct v4l2_subdev *sd, u8 port)
    {
    struct i2c_client *client = v4l2_get_subdevdata(sd);
    struct adv7842_state *state = to_state(sd);
    const u8 *edid = state.hdmi_edid.edid;
    let mut blocks: u32 = state.hdmi_edid.blocks;
...
#[no_mangle]
unsafe extern "C" fn adv7842_inv_register(sd: *mut v4l2_subdev) {
...
#[no_mangle]
unsafe extern "C" fn adv7842_s_detect_tx_5v_ctrl(sd: *mut v4l2_subdev) -> c_int {
    static int adv7842_s_detect_tx_5v_ctrl(struct v4l2_subdev *sd)
    {
    struct adv7842_state *state = to_state(sd);
    let mut cable_det: u16 = adv7842_read_cable_det(sd);
...
// disable embedded syncs for auto graphics mode
    ...
    let mut cp_start_vbi: u16 = height - bt.vfrontporch + 1;
    let mut cp_end_vbi: u16 = bt.vsync + bt.vbackporch + 1;
...
#[no_mangle]
unsafe extern "C" fn adv7842_set_offset(sd: *mut v4l2_subdev, auto_offset: bool, offset_a: u16, offset_b: u16, offset_c: u16) {
...
#[no_mangle]
unsafe extern "C" fn adv7842_set_gain(sd: *mut v4l2_subdev, auto_gain: bool, gain_a: u16, gain_b: u16, gain_c: u16) {
...
#[no_mangle]
unsafe extern "C" fn adv7842_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// custom ctrls
    ...
    let mut R: u8 = (ctrl.val & 0xff0000) >> 16;
    let mut G: u8 = (ctrl.val & 0x00ff00) >> 8;
    let mut B: u8 = (ctrl.val & 0x0000ff);
// RGB -> YUV, numerical approximation
    let mut Y: c_int = 66 * R + 129 * G + 25 * B;
    let mut U: c_int = -38 * R - 74 * G + 112 * B;
    let mut V: c_int = 112 * R - 94 * G - 18 * B;
...
#[no_mangle]
unsafe extern "C" fn adv7842_g_volatile_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn no_cp_signal(sd: *mut v4l2_subdev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn adv7842_g_input_status(sd: *mut v4l2_subdev, status: *mut u32) -> c_int {
...
pub struct stdi_readback {
    ...
    {
    struct adv7842_state *state = to_state(sd);
    let mut hfreq: u32 = (ADV7842_fsc * 8) / stdi.bl;
    u32 pix_clk;
    int i;
    ...
    adv7842_check_dv_timings, core::ptr::null_mut()))
    continue;
...
unsafe extern "C" fn read_stdi(sd: *mut v4l2_subdev, stdi: *mut stdi_readback) -> c_int {
    ...
    adv7842_get_dv_timings_cap(sd), adv7842_check_dv_timings, core::ptr::null_mut());
    }
...
// adjust for deep color mode
    ...
    freq < bt.pixelclock) {
    let mut reduced_freq: u32 = ((u32)bt.pixelclock / 1001) * 1000;
    let mut delta_freq: u32 = abs(freq - reduced_freq);
...
//
#[no_mangle]
unsafe extern "C" fn adv7842_op_ch_sel(state: *mut adv7842_state) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn adv7842_setup_format(state: *mut adv7842_state) {
...
#[no_mangle]
unsafe extern "C" fn adv7842_irq_enable(sd: *mut v4l2_subdev, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn adv7842_cec_tx_raw_status(sd: *mut v4l2_subdev, tx_raw_status: u8) {
...
#[no_mangle]
unsafe extern "C" fn adv7842_cec_isr(sd: *mut v4l2_subdev, handled: *mut bool) {
...
#[no_mangle]
unsafe extern "C" fn adv7842_cec_adap_enable(adap: *mut cec_adapter, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7842_cec_adap_log_addr(adap: *mut cec_adapter, addr: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7842_isr(sd: *mut v4l2_subdev, status: u32, handled: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7842_get_edid(sd: *mut v4l2_subdev, edid: *mut v4l2_edid) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adv7842_set_edid(sd: *mut v4l2_subdev, e: *mut v4l2_edid) -> c_int {
    static int adv7842_set_edid(struct v4l2_subdev *sd, struct v4l2_edid *e)
    {
    struct adv7842_state *state = to_state(sd);
    let mut max_blocks: c_uint = e.pad == ADV7842_EDID_PORT_VGA ? 1 : 4;
    let mut err: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adv7842_cfg_read_infoframe {
...
#[no_mangle]
unsafe extern "C" fn adv7842_log_infoframes(sd: *mut v4l2_subdev) {
...
#[no_mangle]
unsafe extern "C" fn adv7842_sdp_log_status(sd: *mut v4l2_subdev) -> c_int {
    static int adv7842_sdp_log_status(struct v4l2_subdev *sd)
    {
// SDP (Standard definition processor) block
    let mut sdp_signal_detected: u8 = sdp_read(sd, 0x5A) & 0x01;
...
#[no_mangle]
unsafe extern "C" fn adv7842_cp_log_status(sd: *mut v4l2_subdev) -> c_int {
...
// CP block
    ...
    struct v4l2_dv_timings timings;
    int temp;
    let mut reg_io_0x02: u8 = io_read(sd, 0x02);
    let mut reg_io_0x21: u8 = io_read(sd, 0x21);
    let mut reg_rep_0x77: u8 = rep_read(sd, 0x77);
    let mut reg_rep_0x7d: u8 = rep_read(sd, 0x7d);
    ...
    let mut bl: u32 = ((cp_read(sd, 0xb1) & 0x3f) << 8) | cp_read(sd, 0xb2);
    let mut lcf: u32 = ((cp_read(sd, 0xb3) & 0x7) << 8) | cp_read(sd, 0xb4);
    let mut lcvs: u32 = cp_read(sd, 0xb3) >> 3;
    let mut fcl: u32 = ((cp_read(sd, 0xb8) & 0x1f) << 8) | cp_read(sd, 0xb9);
...
#[no_mangle]
unsafe extern "C" fn adv7842_log_status(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7842_querystd(sd: *mut v4l2_subdev, std: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7842_s_sdp_io(sd: *mut v4l2_subdev, s: *mut adv7842_sdp_io_sync_adjustment) {
...
#[no_mangle]
unsafe extern "C" fn adv7842_s_std(sd: *mut v4l2_subdev, norm: v4l2_std_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_525_60: norm &) -> else {
    else if (norm & V4L2_STD_525_60)
    adv7842_s_sdp_io(sd, &pdata.sdp_io_sync_525);
    else
    adv7842_s_sdp_io(sd, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn adv7842_g_std(sd: *mut v4l2_subdev, norm: *mut v4l2_std_id) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn adv7842_core_init(sd: *mut v4l2_subdev) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn adv7842_ddr_ram_test(sd: *mut v4l2_subdev) -> c_int {
...
//
    ...
    msleep(20);
    for (i = 0; i < 10; i++) {
    let mut result: u8 = sdp_io_read(sd, 0xdb);
    if (result & 0x10) {
    complete++;
    if (result & 0x20)
    fail++;
...
#[no_mangle]
unsafe extern "C" fn adv7842_command_ram_test(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7842_ioctl(sd: *mut v4l2_subdev, cmd: c_uint, arg: *mut c_void) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn adv7842_registered(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7842_unregistered(sd: *mut v4l2_subdev) {
...
#[no_mangle]
unsafe extern "C" fn adv7842_unregister_clients(sd: *mut v4l2_subdev) {
    ...
    state.i2c_avlink = core::ptr::null_mut();
    state.i2c_cec = core::ptr::null_mut();
    state.i2c_infoframe = core::ptr::null_mut();
    state.i2c_sdp_io = core::ptr::null_mut();
    state.i2c_sdp = core::ptr::null_mut();
    state.i2c_afe = core::ptr::null_mut();
    state.i2c_repeater = core::ptr::null_mut();
    state.i2c_edid = core::ptr::null_mut();
    state.i2c_hdmi = core::ptr::null_mut();
    state.i2c_cp = core::ptr::null_mut();
    state.i2c_vdp = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn adv7842_register_clients(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7842_probe(client: *mut i2c_client) -> c_int {
...
// custom controls
    ...
    &adv7842_ctrl_analog_sampling_phase, core::ptr::null_mut());
    state.free_run_color_ctrl_manual = v4l2_ctrl_new_custom(hdl,
    &adv7842_ctrl_free_run_color_manual, core::ptr::null_mut());
    state.free_run_color_ctrl = v4l2_ctrl_new_custom(hdl,
    &adv7842_ctrl_free_run_color, core::ptr::null_mut());
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn adv7842_remove(client: *mut i2c_client) {
