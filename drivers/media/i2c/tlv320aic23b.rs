...
//! Source: drivers/media/i2c/tlv320aic23b.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tlv320aic23b_write(sd: *mut v4l2_subdev, reg: c_int, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tlv320aic23b_s_clock_freq(sd: *mut v4l2_subdev, freq: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tlv320aic23b_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tlv320aic23b_log_status(sd: *mut v4l2_subdev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tlv320aic23b_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tlv320aic23b_remove(client: *mut i2c_client) {
