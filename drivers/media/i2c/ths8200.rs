...
//! Source: drivers/media/i2c/ths8200.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ths8200_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ths8200_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ths8200_log_status(sd: *mut v4l2_subdev) -> c_int {
    static int ths8200_log_status(struct v4l2_subdev *sd)
    {
    struct ths8200_state *state = to_state(sd);
    let mut reg_03: u8 = ths8200_read(sd, THS8200_CHIP_CTL);
...
#[no_mangle]
unsafe extern "C" fn ths8200_s_power(sd: *mut v4l2_subdev, on: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ths8200_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ths8200_core_init(sd: *mut v4l2_subdev) {
...
#[no_mangle]
unsafe extern "C" fn ths8200_setup(sd: *mut v4l2_subdev, bt: *mut v4l2_bt_timings) {
    static void ths8200_setup(struct v4l2_subdev *sd, struct v4l2_bt_timings *bt)
    {
    let mut polarity: u8 = 0;
    let mut line_start_active_video: u16 = (bt.vsync + bt.vbackporch);
    let mut line_start_front_porch: u16 = (vtotal(bt) - bt.vfrontporch);
// System
...
#[no_mangle]
unsafe extern "C" fn ths8200_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ths8200_remove(client: *mut i2c_client) {
