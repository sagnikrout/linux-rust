...
//! Source: drivers/media/i2c/ov9734.c
#![no_std]
...
pub const OV9734_MCLK: c_int = 19200000;
// ov9734 only support 1-lane mipi output
pub const OV9734_DATA_LANES: c_int = 1;
pub const OV9734_RGB_DEPTH: c_int = 10;
pub const OV9734_REG_CHIP_ID: c_uint = 0x300a;
pub const OV9734_CHIP_ID: c_uint = 0x9734;
pub const OV9734_REG_MODE_SELECT: c_uint = 0x0100;
pub const OV9734_MODE_STANDBY: c_uint = 0x00;
pub const OV9734_MODE_STREAMING: c_uint = 0x01;
// vertical-timings from sensor
pub const OV9734_REG_VTS: c_uint = 0x380e;
pub const OV9734_VTS_30FPS: c_uint = 0x0322;
pub const OV9734_VTS_30FPS_MIN: c_uint = 0x0322;
pub const OV9734_VTS_MAX: c_uint = 0x7fff;
// horizontal-timings from sensor
pub const OV9734_REG_HTS: c_uint = 0x380c;
// Exposure controls from sensor
pub const OV9734_REG_EXPOSURE: c_uint = 0x3500;
pub const OV9734_EXPOSURE_MIN: c_int = 4;
pub const OV9734_EXPOSURE_MAX_MARGIN: c_int = 4;
pub const OV9734_EXPOSURE_STEP: c_int = 1;
// Analog gain controls from sensor
pub const OV9734_REG_ANALOG_GAIN: c_uint = 0x350a;
pub const OV9734_ANAL_GAIN_MIN: c_int = 16;
pub const OV9734_ANAL_GAIN_MAX: c_int = 248;
pub const OV9734_ANAL_GAIN_STEP: c_int = 1;
// Digital gain controls from sensor
pub const OV9734_REG_MWB_R_GAIN: c_uint = 0x5180;
pub const OV9734_REG_MWB_G_GAIN: c_uint = 0x5182;
pub const OV9734_REG_MWB_B_GAIN: c_uint = 0x5184;
pub const OV9734_DGTL_GAIN_MIN: c_int = 256;
pub const OV9734_DGTL_GAIN_MAX: c_int = 1023;
pub const OV9734_DGTL_GAIN_STEP: c_int = 1;
pub const OV9734_DGTL_GAIN_DEFAULT: c_int = 256;
// Test Pattern Control
pub const OV9734_REG_TEST_PATTERN: c_uint = 0x5080;

pub const OV9734_TEST_PATTERN_BAR_SHIFT: c_int = 2;
// Group Access
pub const OV9734_REG_GROUP_ACCESS: c_uint = 0x3208;
pub const OV9734_GROUP_HOLD_START: c_uint = 0x0;
pub const OV9734_GROUP_HOLD_END: c_uint = 0x10;
pub const OV9734_GROUP_HOLD_LAUNCH: c_uint = 0xa0;
    enum {
    OV9734_LINK_FREQ_180MHZ_INDEX,
    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov9734_reg {
    pub address: u16,
    pub val: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov9734_reg_list {
    pub num_of_regs: u32,
    pub regs: *const ov9734_reg,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov9734_link_freq_config {
    pub reg_list: ov9734_reg_list,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov9734_mode {
...
// Current mode
    pub cur_mode: *const ov9734_mode,
...
unsafe extern "C" fn to_pixel_rate(f_index: u32) -> u64 {
    ...
    {
    let mut pixel_rate: u64 = link_freq_menu_items[f_index] * 2 * OV9734_DATA_LANES;
...
#[no_mangle]
unsafe extern "C" fn ov9734_read_reg(ov9734: *mut ov9734, reg: u16, len: u16, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov9734_write_reg(ov9734: *mut ov9734, reg: u16, len: u16, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov9734_update_digital_gain(ov9734: *mut ov9734, d_gain: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov9734_test_pattern(ov9734: *mut ov9734, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov9734_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov9734_init_controls(ov9734: *mut ov9734) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov9734_start_streaming(ov9734: *mut ov9734) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov9734_stop_streaming(ov9734: *mut ov9734) {
...
#[no_mangle]
unsafe extern "C" fn ov9734_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov9734_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov9734_identify_module(ov9734: *mut ov9734) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov9734_check_hwcfg(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov9734_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ov9734_probe(client: *mut i2c_client) -> c_int {
    ...
    ov9734.clk = devm_v4l2_sensor_clk_get(ov9734.dev, core::ptr::null_mut());
