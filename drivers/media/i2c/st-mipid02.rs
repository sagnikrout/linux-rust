...
//! Source: drivers/media/i2c/st-mipid02.c
#![no_std]
...
pub const MIPID02_SINK_0: c_int = 0;
pub const MIPID02_SINK_1: c_int = 1;
pub const MIPID02_SOURCE: c_int = 2;
pub const MIPID02_PAD_NB: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mipid02_dev {
    pub i2c_client: *mut i2c_client,
    pub supplies: [regulator_bulk_data; MIPID02_NUM_SUPPLIES],
    pub sd: v4l2_subdev,
    pub regmap: *mut regmap,
    pub pad: [media_pad; MIPID02_PAD_NB],
    pub xclk: *mut clk,
    pub reset_gpio: *mut gpio_desc,
// endpoints info
    pub rx: v4l2_fwnode_endpoint,
    pub tx: v4l2_fwnode_endpoint,
// remote source
    pub notifier: v4l2_async_notifier,
    pub s_subdev: *mut v4l2_subdev,
    pub s_subdev_pad_id: u16,
// registers
    struct {
    pub clk_lane_reg1: u8,
    pub data_lane0_reg1: u8,
    pub data_lane1_reg1: u8,
    pub mode_reg1: u8,
    pub mode_reg2: u8,
    pub data_selection_ctrl: u8,
    pub data_id_rreg: u8,
    pub pix_width_ctrl: u8,
    pub pix_width_ctrl_emb: u8,
    pub r: },
}

#[no_mangle]
unsafe extern "C" fn bpp_from_code(code: __u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn data_type_from_code(code: __u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn get_fmt_code(code: __u32) -> __u32 {
...
#[no_mangle]
unsafe extern "C" fn serial_to_parallel_code(serial: __u32) -> __u32 {
...
#[no_mangle]
unsafe extern "C" fn mipid02_get_regulators(bridge: *mut mipid02_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipid02_apply_reset(bridge: *mut mipid02_dev) {
...
#[no_mangle]
unsafe extern "C" fn mipid02_set_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipid02_set_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipid02_detect(bridge: *mut mipid02_dev) -> c_int {
...
//
    return cci_read(bridge.regmap, MIPID02_CLK_LANE_WR_REG1, &reg, core::ptr::null_mut());
    }
//
...
#[no_mangle]
unsafe extern "C" fn mipid02_configure_clk_lane(bridge: *mut mipid02_dev) -> c_int {
...
// midid02 doesn't support clock lane remapping
    ...
    {
    let mut are_pin_swap: bool = are_lanes_swap ? polarities[2] : polarities[1];
...
//
    ...
    bool are_lanes_swap, bool *polarities)
    {
    let mut are_pin_swap: bool = are_lanes_swap ? polarities[1] : polarities[2];
    if (nb == 1 && !are_lanes_swap)
    return 0;
    if (are_pin_swap)
    ...
    {
    struct v4l2_fwnode_endpoint *ep = &bridge.rx;
    let mut are_lanes_swap: bool = ep.bus.mipi_csi2.data_lanes[0] == 2;
    bool *polarities = ep.bus.mipi_csi2.lane_polarities;
    let mut nb: c_int = ep.bus.mipi_csi2.num_data_lanes;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mipid02_configure_from_tx(bridge: *mut mipid02_dev) -> c_int {
...
// pad_fmt = fmt->format;
    ...
    {
    struct mipid02_dev *bridge = to_mipid02_dev(notifier.sd);
    bridge.s_subdev = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn mipid02_parse_rx_ep(bridge: *mut mipid02_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipid02_parse_tx_ep(bridge: *mut mipid02_dev) -> c_int {
    static int mipid02_parse_tx_ep(struct mipid02_dev *bridge)
    {
    let mut ep: v4l2_fwnode_endpoint = { .bus_type = V4L2_MBUS_PARALLEL };
    struct i2c_client *client = bridge.i2c_client;
    struct device_node *ep_node;
    int ret;
// parse tx (endpoint 2)
...
#[no_mangle]
unsafe extern "C" fn mipid02_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mipid02_remove(client: *mut i2c_client) {
    ...
    RUNTIME_PM_OPS(mipid02_set_power_off, mipid02_set_power_on, core::ptr::null_mut())
    };
