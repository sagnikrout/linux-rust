...
//! Source: drivers/media/i2c/tvp5150.c
#![no_std]
...
pub const TVP5150_MAX_CROP_LEFT: c_int = 511;
pub const TVP5150_MAX_CROP_TOP: c_int = 127;
pub const TVP5150_CROP_SHIFT: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tvp5150_connector {
    pub base: v4l2_fwnode_connector,
...
pub struct tvp5150 {
    pub sd: v4l2_subdev,
    pub pads: [media_pad; TVP5150_NUM_PADS],
    pub connectors: [tvp5150_connector; TVP5150_MAX_CONNECTORS],
    pub cur_connector: *mut tvp5150_connector,
    pub connectors_num: c_uint,
    pub hdl: v4l2_ctrl_handler,
    pub rect: v4l2_rect,
    pub regmap: *mut regmap,
    pub irq: c_int,
    pub /: *mut *mut v4l2_std_id norm; / Current set standard,
    pub detected_norm: v4l2_std_id,
    pub input: u32,
    pub output: u32,
    pub oe: u32,
    pub enable: c_int,
    ...
    pub dev_id: u16,
    pub rom_ver: u16,
    pub mbus_type: enum v4l2_mbus_type,
}
...
#[no_mangle]
unsafe extern "C" fn tvp5150_read(sd: *mut v4l2_subdev, addr: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_log_status(sd: *mut v4l2_subdev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tvp5150_selmux(sd: *mut v4l2_subdev) {
    static void tvp5150_selmux(struct v4l2_subdev *sd)
    {
    let mut opmode: c_int = 0;
    struct tvp5150 *decoder = to_tvp5150(sd);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tvp5150_vbi_type {
    pub vbi_type: c_uint,
    pub ini_line: c_uint,
    pub end_line: c_uint,
    pub :1: unsigned int by_field,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_vbi_ram_value {
    pub reg: u16,
    pub type: tvp5150_vbi_type,
    pub values: [c_uchar; 16],
}
...
#[no_mangle]
unsafe extern "C" fn tvp5150_vdp_init(sd: *mut v4l2_subdev) -> c_int {
...
//
    ...
    {
    struct tvp5150 *decoder = to_tvp5150(sd);
    let mut std: v4l2_std_id = decoder.norm;
    u8 reg;
    int i, pos = 0;
    if (std == V4L2_STD_ALL) {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_get_vbi(sd: *mut v4l2_subdev, line: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_set_std(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_PAL: std &) -> else {
    else if (std & V4L2_STD_PAL)
    fmt = VIDEO_STD_PAL_BDGHIN_BIT;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_SECAM: std &) -> else {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_g_std(sd: *mut v4l2_subdev, std: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_s_std(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_read_std(sd: *mut v4l2_subdev) -> v4l2_std_id {
    static v4l2_std_id tvp5150_read_std(struct v4l2_subdev *sd)
    {
    let mut val: c_int = tvp5150_read(sd, TVP5150_STATUS_REG_5);
    switch (val & 0x0F) {
    case 0x01:
...
#[no_mangle]
unsafe extern "C" fn query_lock(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_querystd(sd: *mut v4l2_subdev, std_id: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_reset(sd: *mut v4l2_subdev, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_enable(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_set_default(std: v4l2_std_id, crop: *mut v4l2_rect) {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_get_hmax(sd: *mut v4l2_subdev) -> c_uint {
...
// Calculate height based on current standard
    ...
    {
    struct tvp5150 *decoder = to_tvp5150(sd);
    let mut hmax: c_uint = tvp5150_get_hmax(sd);
...
#[no_mangle]
unsafe extern "C" fn tvp5150_disable_all_input_links(decoder: *mut tvp5150) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tvp5150_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_s_raw_fmt(sd: *mut v4l2_subdev, fmt: *mut v4l2_vbi_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_s_sliced_fmt(sd: *mut v4l2_subdev, svbi: *mut v4l2_sliced_vbi_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_g_sliced_fmt(sd: *mut v4l2_subdev, svbi: *mut v4l2_sliced_vbi_format) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_g_register(sd: *mut v4l2_subdev, reg: *mut v4l2_dbg_register) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_s_register(sd: *mut v4l2_subdev, reg: *const v4l2_dbg_register) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_g_tuner(sd: *mut v4l2_subdev, vt: *mut v4l2_tuner) -> c_int {
    static int tvp5150_g_tuner(struct v4l2_subdev *sd, struct v4l2_tuner *vt)
    {
    let mut status: c_int = tvp5150_read(sd, 0x88);
    vt.signal = ((status & 0x04) && (status & 0x02)) ? 0xffff : 0x0;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tvp5150_registered(sd: *mut v4l2_subdev) -> c_int {
...
//
    ...
    let mut port: c_uint = link.fwnode_link.remote_port;
    let mut flags: c_uint = i ? 0 : MEDIA_LNK_FL_ENABLED;
    let mut is_svideo: bool = v4l2c.type == V4L2_CONN_SVIDEO;
...
#[no_mangle]
unsafe extern "C" fn tvp5150_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
    static int tvp5150_open(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
    {
    return pm_runtime_resume_and_get(sd.dev);
    }
#[no_mangle]
unsafe extern "C" fn tvp5150_close(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_detect_version(core: *mut tvp5150) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_init(c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_mc_init(decoder: *mut tvp5150) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tvp5150_mc_init(decoder: *mut tvp5150) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvp5150_validate_connectors(decoder: *mut tvp5150) -> c_int {
    ...
    for (i = 0; i < decoder.connectors_num; i++) {
    struct v4l2_connector_link *link0 = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tvp5150_parse_dt(decoder: *mut tvp5150, np: *mut device_node) -> c_int {
...
//
    ...
    let mut next_connector: c_uint = decoder.connectors_num;
...
#[no_mangle]
unsafe extern "C" fn tvp5150_probe(c: *mut i2c_client) -> c_int {
...
//
    ...
    if (c.irq) {
    res = devm_request_threaded_irq(&c.dev, c.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn tvp5150_remove(c: *mut i2c_client) {
