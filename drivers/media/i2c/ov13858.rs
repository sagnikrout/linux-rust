...
//! Source: drivers/media/i2c/ov13858.c
#![no_std]
...
pub const OV13858_REG_VALUE_08BIT: c_int = 1;
pub const OV13858_REG_VALUE_16BIT: c_int = 2;
pub const OV13858_REG_VALUE_24BIT: c_int = 3;
pub const OV13858_REG_MODE_SELECT: c_uint = 0x0100;
pub const OV13858_MODE_STANDBY: c_uint = 0x00;
pub const OV13858_MODE_STREAMING: c_uint = 0x01;
pub const OV13858_REG_SOFTWARE_RST: c_uint = 0x0103;
pub const OV13858_SOFTWARE_RST: c_uint = 0x01;
// PLL1 generates PCLK and MIPI_PHY_CLK
pub const OV13858_REG_PLL1_CTRL_0: c_uint = 0x0300;
pub const OV13858_REG_PLL1_CTRL_1: c_uint = 0x0301;
pub const OV13858_REG_PLL1_CTRL_2: c_uint = 0x0302;
pub const OV13858_REG_PLL1_CTRL_3: c_uint = 0x0303;
pub const OV13858_REG_PLL1_CTRL_4: c_uint = 0x0304;
pub const OV13858_REG_PLL1_CTRL_5: c_uint = 0x0305;
// PLL2 generates DAC_CLK, SCLK and SRAM_CLK
pub const OV13858_REG_PLL2_CTRL_B: c_uint = 0x030b;
pub const OV13858_REG_PLL2_CTRL_C: c_uint = 0x030c;
pub const OV13858_REG_PLL2_CTRL_D: c_uint = 0x030d;
pub const OV13858_REG_PLL2_CTRL_E: c_uint = 0x030e;
pub const OV13858_REG_PLL2_CTRL_F: c_uint = 0x030f;
pub const OV13858_REG_PLL2_CTRL_12: c_uint = 0x0312;
pub const OV13858_REG_MIPI_SC_CTRL0: c_uint = 0x3016;
pub const OV13858_REG_MIPI_SC_CTRL1: c_uint = 0x3022;
// Chip ID
pub const OV13858_REG_CHIP_ID: c_uint = 0x300a;
pub const OV13858_CHIP_ID: c_uint = 0x00d855;
// V_TIMING internal
pub const OV13858_REG_VTS: c_uint = 0x380e;
pub const OV13858_VTS_30FPS: c_uint = 0x0c8e /* 30 fps */;
pub const OV13858_VTS_60FPS: c_uint = 0x0648 /* 60 fps */;
pub const OV13858_VTS_MAX: c_uint = 0x7fff;
// HBLANK control - read only
pub const OV13858_PPL_270MHZ: c_int = 2244;
pub const OV13858_PPL_540MHZ: c_int = 4488;
// Exposure control
pub const OV13858_REG_EXPOSURE: c_uint = 0x3500;
pub const OV13858_EXPOSURE_MIN: c_int = 4;
pub const OV13858_EXPOSURE_STEP: c_int = 1;
pub const OV13858_EXPOSURE_DEFAULT: c_uint = 0x640;
// Analog gain control
pub const OV13858_REG_ANALOG_GAIN: c_uint = 0x3508;
pub const OV13858_ANA_GAIN_MIN: c_int = 0;
pub const OV13858_ANA_GAIN_MAX: c_uint = 0x1fff;
pub const OV13858_ANA_GAIN_STEP: c_int = 1;
pub const OV13858_ANA_GAIN_DEFAULT: c_uint = 0x80;
// Digital gain control
pub const OV13858_REG_B_MWB_GAIN: c_uint = 0x5100;
pub const OV13858_REG_G_MWB_GAIN: c_uint = 0x5102;
pub const OV13858_REG_R_MWB_GAIN: c_uint = 0x5104;
pub const OV13858_DGTL_GAIN_MIN: c_int = 0;

// Test Pattern Control
pub const OV13858_REG_TEST_PATTERN: c_uint = 0x4503;

pub const OV13858_TEST_PATTERN_MASK: c_uint = 0xfc;
// Number of frames to skip
pub const OV13858_NUM_OF_SKIP_FRAMES: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov13858_reg {
    pub address: u16,
    pub val: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov13858_reg_list {
    pub num_of_regs: u32,
    pub regs: *const ov13858_reg,
}

// Link frequency config
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov13858_link_freq_config {
    pub pixels_per_line: u32,
// PLL registers for this link frequency
    pub reg_list: ov13858_reg_list,
}

// Mode : resolution and related config&values
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov13858_mode {
// Frame width
    pub width: u32,
// Frame height
    pub height: u32,
...
pub const OV13858_NUM_OF_LINK_FREQS: c_int = 2;

pub const OV13858_LINK_FREQ_INDEX_0: c_int = 0;
pub const OV13858_LINK_FREQ_INDEX_1: c_int = 1;
//
...
// Current mode
    pub cur_mode: *const ov13858_mode,
...
// Open sub-device
#[no_mangle]
unsafe extern "C" fn ov13858_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13858_update_digital_gain(ov13858: *mut ov13858, d_gain: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13858_enable_test_pattern(ov13858: *mut ov13858, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13858_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13858_get_skip_frames(sd: *mut v4l2_subdev, frames: *mut u32) -> c_int {
...
// Start streaming
#[no_mangle]
unsafe extern "C" fn ov13858_start_streaming(ov13858: *mut ov13858) -> c_int {
...
// Stop streaming
#[no_mangle]
unsafe extern "C" fn ov13858_stop_streaming(ov13858: *mut ov13858) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13858_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
// Verify chip ID
#[no_mangle]
unsafe extern "C" fn ov13858_identify_module(ov13858: *mut ov13858) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13858_init_controls(ov13858: *mut ov13858) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13858_free_controls(ov13858: *mut ov13858) {
...
#[no_mangle]
unsafe extern "C" fn ov13858_probe(client: *mut i2c_client) -> c_int {
    ...
    ov13858.clk = devm_v4l2_sensor_clk_get(ov13858.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ov13858_remove(client: *mut i2c_client) {
