...
//! Source: drivers/media/i2c/video-i2c.c
#![no_std]
...
pub const AMG88XX_REG_PCTL: c_uint = 0x00;
pub const AMG88XX_PCTL_NORMAL: c_uint = 0x00;
pub const AMG88XX_PCTL_SLEEP: c_uint = 0x10;
// Reset register
pub const AMG88XX_REG_RST: c_uint = 0x01;
pub const AMG88XX_RST_FLAG: c_uint = 0x30;
pub const AMG88XX_RST_INIT: c_uint = 0x3f;
// Frame rate register
pub const AMG88XX_REG_FPSC: c_uint = 0x02;

// Thermistor register
pub const AMG88XX_REG_TTHL: c_uint = 0x0e;
// Temperature register
pub const AMG88XX_REG_T01L: c_uint = 0x80;
// RAM
pub const MLX90640_RAM_START_ADDR: c_uint = 0x0400;
// EEPROM
pub const MLX90640_EEPROM_START_ADDR: c_uint = 0x2400;
// Control register
pub const MLX90640_REG_CTL1: c_uint = 0x800d;

pub const MLX90640_REG_CTL1_MASK_SHIFT: c_int = 7;
    struct video_i2c_chip;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct video_i2c_buffer {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct video_i2c_data {
    pub regmap: *mut regmap,
    pub chip: *const video_i2c_chip,
    pub lock: mutex,
    ...
    pub kthread_vid_cap: *mut task_struct,
    pub vid_cap_active: list_head,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct video_i2c_chip {
// video dimensions
    pub format: *const v4l2_fmtdesc,
    pub size: *const v4l2_frmsize_discrete,
// available frame intervals
    pub frame_intervals: *const v4l2_fract,
    pub num_frame_intervals: c_uint,
// pixel buffer size
    pub buffer_size: c_uint,
// pixel size in bits
    pub bpp: c_uint,
    pub regmap_config: *const regmap_config,
    pub nvmem_config: *mut nvmem_config,
// setup function
    pub data): *mut *mut int (setup)(struct video_i2c_data,
// xfer function
    pub buf): *mut *mut *mut int (xfer)(struct video_i2c_data data, char,
// power control function
    pub on): *mut *mut *mut int (set_power)(struct video_i2c_data data, bool,
// hwmon init function
    pub data): *mut *mut int (hwmon_init)(struct video_i2c_data,
}
...
#[no_mangle]
unsafe extern "C" fn amg88xx_xfer(data: *mut video_i2c_data, buf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx90640_xfer(data: *mut video_i2c_data, buf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amg88xx_setup(data: *mut video_i2c_data) -> c_int {
    static int amg88xx_setup(struct video_i2c_data *data)
    {
    let mut mask: c_uint = AMG88XX_FPSC_1FPS;
    unsigned int val;
...
#[no_mangle]
unsafe extern "C" fn mlx90640_setup(data: *mut video_i2c_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amg88xx_set_power_on(data: *mut video_i2c_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amg88xx_set_power_off(data: *mut video_i2c_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amg88xx_set_power(data: *mut video_i2c_data, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amg88xx_hwmon_init(data: *mut video_i2c_data) -> c_int {
    static int amg88xx_hwmon_init(struct video_i2c_data *data)
    {
    struct device *dev = regmap_get_device(data.regmap);
    void *hwmon = devm_hwmon_device_register_with_info(dev, "amg88xx", data,
    &amg88xx_chip_info, core::ptr::null_mut());
    ...
    let mut size: c_uint = data.chip.buffer_size;
...
#[no_mangle]
unsafe extern "C" fn video_i2c_thread_vid_cap(priv: *mut c_void) -> c_int {
    static int video_i2c_thread_vid_cap(void *priv)
    {
    struct video_i2c_data *data = priv;
    u32 delay = mult_frac(1000000UL, data.frame_interval.numerator,
    data.frame_interval.denominator);
    let mut end_us: i64 = ktime_to_us(ktime_get());
    set_freezable();
    do {
    struct video_i2c_buffer *vid_cap_buf = core::ptr::null_mut();
    s64 current_us;
    int schedule_delay;
    try_to_freeze();
    spin_lock(&data.slock);
...
#[no_mangle]
unsafe extern "C" fn video_i2c_del_list(vq: *mut vb2_queue, state: enum vb2_buffer_state) {
...
unsafe extern "C" fn start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
    ...
    if (ret) {
    data.kthread_vid_cap = core::ptr::null_mut();
    goto error_rpm_put;
    }
    return 0;
    error_rpm_put:
...
unsafe extern "C" fn stop_streaming(vq: *mut vb2_queue) {
    ...
    {
    struct video_i2c_data *data = vb2_get_drv_priv(vq);
    if (data.kthread_vid_cap == core::ptr::null_mut())
    return;
...
#[no_mangle]
unsafe extern "C" fn video_i2c_g_input(file: *mut file, fh: *mut c_void, inp: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn video_i2c_s_input(file: *mut file, fh: *mut c_void, inp: c_uint) -> c_int {
    ...
    {
    struct video_i2c_data *data = video_drvdata(file);
    let mut type: enum v4l2_buf_type = fmt.type;
    if (fmt.index > 0)
    return -EINVAL;
...
// currently only one frame size is allowed
    ...
    let mut bpp: c_uint = data.chip.bpp / 8;
...
#[no_mangle]
unsafe extern "C" fn video_i2c_release(vdev: *mut video_device) {
...
#[no_mangle]
unsafe extern "C" fn video_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn video_i2c_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn video_i2c_pm_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn video_i2c_pm_runtime_resume(dev: *mut device) -> c_int {
    ...
    video_i2c_pm_runtime_resume, core::ptr::null_mut())
    };
