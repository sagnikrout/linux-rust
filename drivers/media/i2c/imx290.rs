...
//! Source: drivers/media/i2c/imx290.c
#![no_std]
...
pub const IMX290_VMAX_MAX: c_uint = 0x3ffff;

pub const IMX290_HMAX_MAX: c_uint = 0xffff;

pub const IMX290_ADBIT1_10BIT: c_uint = 0x1d;
pub const IMX290_ADBIT1_12BIT: c_uint = 0x00;

pub const IMX290_ADBIT2_10BIT: c_uint = 0x12;
pub const IMX290_ADBIT2_12BIT: c_uint = 0x00;

pub const IMX290_ADBIT3_10BIT: c_uint = 0x37;
pub const IMX290_ADBIT3_12BIT: c_uint = 0x0e;

pub const IMX290_CSI_DT_FMT_RAW10: c_uint = 0x0a0a;
pub const IMX290_CSI_DT_FMT_RAW12: c_uint = 0x0c0c;

// Number of lines by which exposure must be less than VMAX
pub const IMX290_EXPOSURE_OFFSET: c_int = 2;
pub const IMX290_PIXEL_RATE: c_int = 148500000;
//
...
//
pub const IMX290_PIXEL_ARRAY_WIDTH: c_int = 1945;
pub const IMX290_PIXEL_ARRAY_HEIGHT: c_int = 1097;
pub const IMX290_PIXEL_ARRAY_MARGIN_LEFT: c_int = 12;
pub const IMX290_PIXEL_ARRAY_MARGIN_RIGHT: c_int = 13;
pub const IMX290_PIXEL_ARRAY_MARGIN_TOP: c_int = 8;
pub const IMX290_PIXEL_ARRAY_MARGIN_BOTTOM: c_int = 9;
pub const IMX290_PIXEL_ARRAY_RECORDING_WIDTH: c_int = 1920;
pub const IMX290_PIXEL_ARRAY_RECORDING_HEIGHT: c_int = 1080;
// Equivalent value for 16bpp
pub const IMX290_BLACK_LEVEL_DEFAULT: c_int = 3840;
pub const IMX290_NUM_SUPPLIES: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx290_model_info {
    pub colour_variant: enum imx290_colour_variant,
    pub init_regs: *const cci_reg_sequence,
    pub init_regs_num: usize,
    pub max_analog_gain: c_uint,
...
pub struct imx290_mode {
    ...
    pub ctrl_07: u8,
    pub data: *const cci_reg_sequence,
    pub data_size: u32,
    pub clk_cfg: *const imx290_clk_cfg,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx290_csi_cfg {
    pub repetition: u16,
    pub tclkpost: u16,
    pub thszero: u16,
    pub thsprepare: u16,
...
pub struct imx290 {
    ...
    pub xclk_idx: enum imx290_clk_freq,
    pub nlanes: u8,
    pub model: *const imx290_model_info,
    pub sd: v4l2_subdev,
    pub pad: media_pad,
    pub current_mode: *const imx290_mode,
    pub supplies: [regulator_bulk_data; IMX290_NUM_SUPPLIES],
...
pub const IMX290_NUM_CLK_REGS: c_int = 2;
...
pub const FREQ_INDEX_1080P: c_int = 0;
pub const FREQ_INDEX_720P: c_int = 1;
...
#[no_mangle]
pub unsafe extern "C" fn imx290_link_freqs_num(imx290: *const imx290) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn imx290_modes_num(imx290: *const imx290) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx290_format_info {
    pub code: [u32; IMX290_VARIANT_MAX],
    pub bpp: u8,
    ...
    {
    int ret;
    ret = cci_multi_reg_write(imx290.regmap, settings, num_settings, core::ptr::null_mut());
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn imx290_set_clock(imx290: *mut imx290) -> c_int {
    static int imx290_set_clock(struct imx290 *imx290)
    {
    const struct imx290_mode *mode = imx290.current_mode;
    let mut clk_idx: enum imx290_clk_freq = imx290.xclk_idx;
...
#[no_mangle]
unsafe extern "C" fn imx290_set_data_lanes(imx290: *mut imx290) -> c_int {
    ...
    {
    let mut bpp: c_uint = imx290_format_info(imx290, format.code).bpp;
    return cci_write(imx290.regmap, IMX290_BLKLEVEL,
    black_level >> (16 - bpp), err);
    }
#[no_mangle]
unsafe extern "C" fn imx290_set_csi_config(imx290: *mut imx290) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx290_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// V4L2 controls values will be applied only when power is already up
    ...
    ret = cci_write(imx290.regmap, IMX290_GAIN, ctrl.val, core::ptr::null_mut());
    break;
    case V4L2_CID_VBLANK:
    ret = cci_write(imx290.regmap, IMX290_VMAX,
    ctrl.val + imx290.current_mode.height, core::ptr::null_mut());
//
...
//
    ...
    vmax - ctrl.val - 1, core::ptr::null_mut());
    break;
    ...
    ctrl.val + imx290.current_mode.width, core::ptr::null_mut());
    break;
    case V4L2_CID_HFLIP:
    case V4L2_CID_VFLIP:
    {
    ...
    if (imx290.vflip.val)
    reg |= IMX290_VREVERSE;
    ret = cci_write(imx290.regmap, IMX290_CTRL_07, reg, core::ptr::null_mut());
    break;
    }
    default:
    ret = -EINVAL;
    ...
    const struct imx290_mode *mode)
    {
    let mut hblank_min: c_uint = mode.hmax_min - mode.width;
    let mut hblank_max: c_uint = IMX290_HMAX_MAX - mode.width;
    let mut vblank_min: c_uint = mode.vmax_min - mode.height;
    let mut vblank_max: c_uint = IMX290_VMAX_MAX - mode.height;
...
#[no_mangle]
unsafe extern "C" fn imx290_ctrl_init(imx290: *mut imx290) -> c_int {
...
// Stop streaming
#[no_mangle]
unsafe extern "C" fn imx290_stop_streaming(imx290: *mut imx290) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx290_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx290_subdev_init(imx290: *mut imx290) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx290_subdev_cleanup(imx290: *mut imx290) {
...
//
#[no_mangle]
unsafe extern "C" fn imx290_power_on(imx290: *mut imx290) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx290_power_off(imx290: *mut imx290) {
...
#[no_mangle]
unsafe extern "C" fn imx290_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx290_runtime_suspend(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(imx290_runtime_suspend, imx290_runtime_resume, core::ptr::null_mut())
    };
// ----------------------------------------------------------------------------
// Probe & remove
//
...
#[no_mangle]
unsafe extern "C" fn imx290_get_regulators(dev: *mut device, imx290: *mut imx290) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx290_init_clk(imx290: *mut imx290) -> c_int {
...
//
    ...
    let mut freqs_count: c_int = imx290_link_freqs_num(imx290);
...
#[no_mangle]
unsafe extern "C" fn imx290_parse_dt(imx290: *mut imx290) -> c_int {
...
// Only CSI2 is supported for now:
    ...
    endpoint = fwnode_graph_get_next_endpoint(dev_fwnode(imx290.dev), core::ptr::null_mut());
    if (!endpoint) {
...
#[no_mangle]
unsafe extern "C" fn imx290_probe(client: *mut i2c_client) -> c_int {
...
// Initialize the V4L2 subdev.
    ...
    imx290.model.name, core::ptr::null_mut());
//
...
#[no_mangle]
unsafe extern "C" fn imx290_remove(client: *mut i2c_client) {
