...
//! Source: drivers/media/i2c/gc08a3.c
#![no_std]
...
pub const GC08A3_TEST_PATTERN_EN: c_uint = 0x01;

pub const GC08A3_EXP_MARGIN: c_int = 16;
pub const GC08A3_EXP_MIN: c_int = 4;
pub const GC08A3_EXP_STEP: c_int = 1;

pub const GC08A3_AGAIN_MIN: c_int = 1024;

pub const GC08A3_AGAIN_STEP: c_int = 1;

pub const GC08A3_VTS_MAX: c_uint = 0xfff0;

pub const GC08A3_CHIP_ID: c_uint = 0x08a3;
pub const GC08A3_NATIVE_WIDTH: c_int = 3264;
pub const GC08A3_NATIVE_HEIGHT: c_int = 2448;

pub const GC08A3_DATA_LANES: c_int = 4;
pub const GC08A3_RGB_DEPTH: c_int = 10;
...
pub struct gc08a3 {
    ...
    pub pad: media_pad,
    pub xclk: *mut clk,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(gc08a3_supply_name)],
    ...
    pub cur_mode: *const gc08a3_mode,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gc08a3_reg_list {
    pub num_of_regs: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gc08a3_mode {
    pub width: u32,
    pub height: u32,
    pub reg_list: gc08a3_reg_list,
...
#[no_mangle]
unsafe extern "C" fn gc08a3_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gc08a3_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gc08a3_set_ctrl_hflip(gc08a3: *mut gc08a3, ctrl_val: u32) -> c_int {
    static int gc08a3_set_ctrl_hflip(struct gc08a3 *gc08a3, u32 ctrl_val)
    {
    int ret;
    u64 val;
    ret = cci_read(gc08a3.regmap, GC08A3_FLIP_REG, &val, core::ptr::null_mut());
    if (ret) {
    ...
    GC08A3_FLIP_H_MASK,
    ctrl_val ? GC08A3_FLIP_H_MASK : 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn gc08a3_set_ctrl_vflip(gc08a3: *mut gc08a3, ctrl_val: u32) -> c_int {
    ...
    return cci_update_bits(gc08a3.regmap, GC08A3_FLIP_REG,
    GC08A3_FLIP_V_MASK,
    ctrl_val ? GC08A3_FLIP_V_MASK : 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn gc08a3_test_pattern(gc08a3: *mut gc08a3, pattern_menu: u32) -> c_int {
    ...
    GC08A3_TEST_PATTERN_EN, core::ptr::null_mut());
    } else {
    return cci_write(gc08a3.regmap, GC08A3_REG_TEST_PATTERN_EN,
...
#[no_mangle]
unsafe extern "C" fn gc08a3_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
//
    ...
    gc08a3.cur_mode.height + ctrl.val, core::ptr::null_mut());
    break;
    case V4L2_CID_HFLIP:
...
#[no_mangle]
unsafe extern "C" fn gc08a3_start_streaming(gc08a3: *mut gc08a3) -> c_int {
    ...
    ret = cci_write(gc08a3.regmap, GC08A3_STREAMING_REG, 1, core::ptr::null_mut());
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn gc08a3_stop_streaming(gc08a3: *mut gc08a3) -> c_int {
    static int gc08a3_stop_streaming(struct gc08a3 *gc08a3)
    {
    int ret;
    ret = cci_write(gc08a3.regmap, GC08A3_STREAMING_REG, 0, core::ptr::null_mut());
    if (ret < 0)
...
#[no_mangle]
unsafe extern "C" fn gc08a3_s_stream(subdev: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gc08a3_get_regulators(dev: *mut device, gc08a3: *mut gc08a3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gc08a3_parse_fwnode(gc08a3: *mut gc08a3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gc08a3_to_pixel_rate(f_index: u32) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn gc08a3_init_controls(gc08a3: *mut gc08a3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gc08a3_identify_module(gc08a3: *mut gc08a3) -> c_int {
    static int gc08a3_identify_module(struct gc08a3 *gc08a3)
    {
    u64 val;
    int ret;
    ret = cci_read(gc08a3.regmap, GC08A3_REG_CHIP_ID, &val, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn gc08a3_probe(client: *mut i2c_client) -> c_int {
    ...
    "failed to init CCI\n");
    gc08a3.xclk = devm_v4l2_sensor_clk_get_legacy(dev, core::ptr::null_mut(), true,
...
#[no_mangle]
unsafe extern "C" fn gc08a3_remove(client: *mut i2c_client) {
