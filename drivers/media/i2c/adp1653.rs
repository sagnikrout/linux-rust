...
//! Source: drivers/media/i2c/adp1653.c
#![no_std]
...
pub const TIMEOUT_MAX: c_int = 820000;
pub const TIMEOUT_STEP: c_int = 54600;
...
#[no_mangle]
unsafe extern "C" fn adp1653_update_hw(flash: *mut adp1653_flash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp1653_get_fault(flash: *mut adp1653_flash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp1653_strobe(flash: *mut adp1653_flash, enable: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adp1653_get_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp1653_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp1653_init_controls(flash: *mut adp1653_flash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp1653_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
    static int adp1653_open(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
    {
    return adp1653_set_power(sd, 1);
    }
#[no_mangle]
unsafe extern "C" fn adp1653_close(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp1653_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp1653_resume(dev: *mut device) -> c_int {
    ...
    struct device_node *node_indicator = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn adp1653_probe(client: *mut i2c_client) -> c_int {
    ...
    if (ret)
    goto free_and_quit;
    ret = media_entity_pads_init(&flash.subdev.entity, 0, core::ptr::null_mut());
    if (ret < 0)
    goto free_and_quit;
...
#[no_mangle]
unsafe extern "C" fn adp1653_remove(client: *mut i2c_client) {
