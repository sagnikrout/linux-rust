...
//! Source: drivers/media/i2c/saa6752hs.c
#![no_std]
...
pub const MPEG_VIDEO_TARGET_BITRATE_MAX: c_int = 27000;
pub const MPEG_VIDEO_MAX_BITRATE_MAX: c_int = 27000;
pub const MPEG_TOTAL_TARGET_BITRATE_MAX: c_int = 27000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct saa6752hs_mpeg_params {
// transport streams
    pub ts_pid_pmt: __u16,
    pub ts_pid_audio: __u16,
    pub ts_pid_video: __u16,
    pub ts_pid_pcr: __u16,
// audio
    pub au_encoding: enum v4l2_mpeg_audio_encoding,
    pub au_l2_bitrate: enum v4l2_mpeg_audio_l2_bitrate,
    pub au_ac3_bitrate: enum v4l2_mpeg_audio_ac3_bitrate,
// video
    pub vi_aspect: enum v4l2_mpeg_video_aspect,
    pub vi_bitrate_mode: enum v4l2_mpeg_video_bitrate_mode,
    pub vi_bitrate: __u32,
    pub vi_bitrate_peak: __u32,
}
...
#[no_mangle]
pub unsafe extern "C" fn set_reg8(client: *mut i2c_client, reg: u8, val: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn set_reg16(client: *mut i2c_client, reg: u8, val: u16) {
...
#[no_mangle]
unsafe extern "C" fn saa6752hs_try_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa6752hs_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa6752hs_init(sd: *mut v4l2_subdev, leading_null_bytes: u32) -> c_int {
...
//
    ...
    h.video_format = SAA6752HS_VF_D1;
#[no_mangle]
pub unsafe extern "C" fn if(480: f->width ==) -> else {
    else if (f.width == 480)
    h.video_format = SAA6752HS_VF_2_3_D1;
#[no_mangle]
pub unsafe extern "C" fn if(576: f->height ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn saa6752hs_s_std(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa6752hs_probe(client: *mut i2c_client) -> c_int {
    static int saa6752hs_probe(struct i2c_client *client)
    {
    struct saa6752hs_state *h;
    struct v4l2_subdev *sd;
    struct v4l2_ctrl_handler *hdl;
    let mut addr: u8 = 0x13;
    u8 data[12];
...
#[no_mangle]
unsafe extern "C" fn saa6752hs_remove(client: *mut i2c_client) {
