...
//! Source: drivers/media/i2c/tvaudio.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct CHIPDESC {
    pub /: *mut *mut *mut char name; / chip name,
    pub /: *mut *mut int addr_lo, addr_hi; / i2c address range,
    pub /: *mut *mut int registers; / # of registers,
    pub insmodopt: *mut c_int,
    pub checkit: checkit,
    pub initialize: initialize,
    pub flags: c_int,
pub const CHIP_HAS_VOLUME: c_int = 1;
pub const CHIP_HAS_BASSTREBLE: c_int = 2;
pub const CHIP_HAS_INPUTSEL: c_int = 4;
pub const CHIP_NEED_CHECKMODE: c_int = 8;
// various i2c command sequences
    pub init: audiocmd,
// which register has which value
    pub bassreg: int leftreg, rightreg, treblereg,,
// initialize with (defaults to 65535/32768/32768
    pub bassinit: int volinit, trebleinit,,
// functions to convert the values (v4l -> chip)
    pub bassfunc: getvalue volfunc, treblefunc,,
// get/set mode
    pub getrxsubchans: getrxsubchans,
    pub setaudmode: setaudmode,
// input switch register + values for v4l inputs
    pub inputreg: c_int,
    pub inputmap: [c_int; 4],
    pub inputmute: c_int,
    pub inputmask: c_int,
}
...
// i2c I/O functions
#[no_mangle]
unsafe extern "C" fn chip_write(chip: *mut CHIPSTATE, subaddr: c_int, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chip_read(chip: *mut CHIPSTATE) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chip_read2(chip: *mut CHIPSTATE, subaddr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chip_cmd(chip: *mut CHIPSTATE, name: *mut c_char, cmd: *mut audiocmd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn chip_thread_wake(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn chip_thread(data: *mut c_void) -> c_int {
...
// chip detected a new audio mode - set it
    ...
    selected = V4L2_TUNER_MODE_LANG1;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_TUNER_SUB_STEREO: mode &) -> else {
...
pub const TDA9840_SW: c_uint = 0x00;
pub const TDA9840_LVADJ: c_uint = 0x02;
pub const TDA9840_STADJ: c_uint = 0x03;
pub const TDA9840_TEST: c_uint = 0x04;
pub const TDA9840_MONO: c_uint = 0x10;
pub const TDA9840_STEREO: c_uint = 0x2a;
pub const TDA9840_DUALA: c_uint = 0x12;
pub const TDA9840_DUALB: c_uint = 0x1e;
pub const TDA9840_DUALAB: c_uint = 0x1a;
pub const TDA9840_DUALBA: c_uint = 0x16;
pub const TDA9840_EXTERNAL: c_uint = 0x7a;
pub const TDA9840_DS_DUAL: c_uint = 0x20 /* Dual sound identified          */;
pub const TDA9840_ST_STEREO: c_uint = 0x40 /* Stereo sound identified        */;
pub const TDA9840_PONRES: c_uint = 0x80 /* Power-on reset detected if = 1 */;
pub const TDA9840_TEST_INT1SN: c_uint = 0x1 /* Integration time 0.5s when set */;
pub const TDA9840_TEST_INTFU: c_uint = 0x02 /* Disables integrator function */;
#[no_mangle]
unsafe extern "C" fn tda9840_getrxsubchans(chip: *mut CHIPSTATE) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda9840_setaudmode(chip: *mut CHIPSTATE, mode: c_int) {
    static void tda9840_setaudmode(struct CHIPSTATE *chip, int mode)
    {
    let mut update: c_int = 1;
    let mut t: c_int = chip.shadow.bytes[TDA9840_SW + 1] & ~0x7e;
    switch (mode) {
    case V4L2_TUNER_MODE_MONO:
    t |= TDA9840_MONO;
    break;
...
#[no_mangle]
unsafe extern "C" fn tda9840_checkit(chip: *mut CHIPSTATE) -> c_int {
...
pub const TDA9855_VR: c_uint = 0x00 /* Volume, right */;
pub const TDA9855_VL: c_uint = 0x01 /* Volume, left */;
pub const TDA9855_BA: c_uint = 0x02 /* Bass */;
pub const TDA9855_TR: c_uint = 0x03 /* Treble */;
pub const TDA9855_SW: c_uint = 0x04 /* Subwoofer - not connected on DTV2000 */;
// subaddresses for TDA9850
pub const TDA9850_C4: c_uint = 0x04 /* Control 1 for TDA9850 */;
// subaddesses for both chips
pub const TDA985x_C5: c_uint = 0x05 /* Control 2 for TDA9850, Control 1 for TDA9855 */;
pub const TDA985x_C6: c_uint = 0x06 /* Control 3 for TDA9850, Control 2 for TDA9855 */;
pub const TDA985x_C7: c_uint = 0x07 /* Control 4 for TDA9850, Control 3 for TDA9855 */;
pub const TDA985x_A1: c_uint = 0x08 /* Alignment 1 for both chips */;
pub const TDA985x_A2: c_uint = 0x09 /* Alignment 2 for both chips */;
pub const TDA985x_A3: c_uint = 0x0a /* Alignment 3 for both chips */;
...
#[no_mangle]
unsafe extern "C" fn tda985x_getrxsubchans(chip: *mut CHIPSTATE) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda985x_setaudmode(chip: *mut CHIPSTATE, mode: c_int) {
    static void tda985x_setaudmode(struct CHIPSTATE *chip, int mode)
    {
    let mut update: c_int = 1;
    let mut c6: c_int = chip.shadow.bytes[TDA985x_C6+1] & 0x3f;
    switch (mode) {
    case V4L2_TUNER_MODE_MONO:
    c6 |= TDA985x_MONO;
    break;
...
pub const TDA9873_SW: c_uint = 0x00 /* Switching                    */;
pub const TDA9873_AD: c_uint = 0x01 /* Adjust                       */;
pub const TDA9873_PT: c_uint = 0x02 /* Port                         */;
...
// 0,  1  external mono
//
pub const TDA9873_INP_MASK: c_int = 3;
pub const TDA9873_INTERNAL: c_int = 0;
pub const TDA9873_EXT_STEREO: c_int = 2;
pub const TDA9873_EXT_MONO: c_int = 1;
...
pub const TDA9873_TR_MONO: c_int = 4;

pub const TDA9873_TR_DUALAB: c_int = 0;
...
//
pub const TDA9873_STEREO_ADJ: c_uint = 0x06 /* 0dB gain */;
...
// 1,  0,  1   I
//
pub const TDA9873_BG: c_int = 0;
pub const TDA9873_M: c_int = 1;
pub const TDA9873_DK1: c_int = 2;
pub const TDA9873_DK2: c_int = 3;
pub const TDA9873_DK3: c_int = 4;
pub const TDA9873_I: c_int = 5;
// C7 controls identification response time (1=fast/0=normal)
//
pub const TDA9873_IDR_NORM: c_int = 0;
...
// E1, E0   free programmable ports P1/P2
    ...
    1,  1   both ports high
//
pub const TDA9873_PORTS: c_int = 3;
// E2: test port
...
//
pub const TDA9873_MOUT_MONO: c_int = 0;
pub const TDA9873_MOUT_FMONO: c_int = 0;
pub const TDA9873_MOUT_DUALA: c_int = 0;

// Status bits: (chip read)

#[no_mangle]
unsafe extern "C" fn tda9873_getrxsubchans(chip: *mut CHIPSTATE) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda9873_setaudmode(chip: *mut CHIPSTATE, mode: c_int) {
    static void tda9873_setaudmode(struct CHIPSTATE *chip, int mode)
    {
    struct v4l2_subdev *sd = &chip.sd;
    let mut sw_data: c_int = chip.shadow.bytes[TDA9873_SW+1] & ~ TDA9873_TR_MASK;
...
#[no_mangle]
unsafe extern "C" fn tda9873_checkit(chip: *mut CHIPSTATE) -> c_int {
...
pub const TDA9874A_AGCGR: c_uint = 0x00	/* AGC gain */;
pub const TDA9874A_GCONR: c_uint = 0x01	/* general config */;
pub const TDA9874A_MSR: c_uint = 0x02	/* monitor select */;
pub const TDA9874A_C1FRA: c_uint = 0x03	/* carrier 1 freq. */;
pub const TDA9874A_C1FRB: c_uint = 0x04	/* carrier 1 freq. */;
pub const TDA9874A_C1FRC: c_uint = 0x05	/* carrier 1 freq. */;
pub const TDA9874A_C2FRA: c_uint = 0x06	/* carrier 2 freq. */;
pub const TDA9874A_C2FRB: c_uint = 0x07	/* carrier 2 freq. */;
pub const TDA9874A_C2FRC: c_uint = 0x08	/* carrier 2 freq. */;
pub const TDA9874A_DCR: c_uint = 0x09	/* demodulator config */;
pub const TDA9874A_FMER: c_uint = 0x0a	/* FM de-emphasis */;
pub const TDA9874A_FMMR: c_uint = 0x0b	/* FM dematrix */;
pub const TDA9874A_C1OLAR: c_uint = 0x0c	/* ch.1 output level adj. */;
pub const TDA9874A_C2OLAR: c_uint = 0x0d	/* ch.2 output level adj. */;
pub const TDA9874A_NCONR: c_uint = 0x0e	/* NICAM config */;
pub const TDA9874A_NOLAR: c_uint = 0x0f	/* NICAM output level adj. */;
pub const TDA9874A_NLELR: c_uint = 0x10	/* NICAM lower error limit */;
pub const TDA9874A_NUELR: c_uint = 0x11	/* NICAM upper error limit */;
pub const TDA9874A_AMCONR: c_uint = 0x12	/* audio mute control */;
pub const TDA9874A_SDACOSR: c_uint = 0x13	/* stereo DAC output select */;
pub const TDA9874A_AOSR: c_uint = 0x14	/* analog output select */;
pub const TDA9874A_DAICONR: c_uint = 0x15	/* digital audio interface config */;
pub const TDA9874A_I2SOSR: c_uint = 0x16	/* I2S-bus output select */;
pub const TDA9874A_I2SOLAR: c_uint = 0x17	/* I2S-bus output level adj. */;
pub const TDA9874A_MDACOSR: c_uint = 0x18	/* mono DAC output select (tda9874a) */;
pub const TDA9874A_ESP: c_uint = 0xFF	/* easy standard progr. (tda9874a) */;
// Subaddresses for TDA9874H and TDA9874A (slave tx)
pub const TDA9874A_DSR: c_uint = 0x00	/* device status */;
pub const TDA9874A_NSR: c_uint = 0x01	/* NICAM status */;
pub const TDA9874A_NECR: c_uint = 0x02	/* NICAM error count */;
pub const TDA9874A_DR1: c_uint = 0x03	/* add. data LSB */;
pub const TDA9874A_DR2: c_uint = 0x04	/* add. data MSB */;
pub const TDA9874A_LLRA: c_uint = 0x05	/* monitor level read-out LSB */;
pub const TDA9874A_LLRB: c_uint = 0x06	/* monitor level read-out MSB */;
pub const TDA9874A_SIFLR: c_uint = 0x07	/* SIF level */;
...
// insmod options for tda9874a
    let mut tda9874a_SIF: static unsigned int = UNSET;
    let mut tda9874a_AMSEL: static unsigned int = UNSET;
    let mut tda9874a_STD: static unsigned int = UNSET;
...
#[no_mangle]
unsafe extern "C" fn tda9874a_setup(chip: *mut CHIPSTATE) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda9874a_getrxsubchans(chip: *mut CHIPSTATE) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda9874a_setaudmode(chip: *mut CHIPSTATE, mode: c_int) {
...
//
    if(tda9874a_dic == 0x11) {
    let mut aosr: c_int = 0x80;
    let mut mdacosr: c_int = (tda9874a_mode) ? 0x82:0x80;
    switch(mode) {
    case V4L2_TUNER_MODE_MONO:
    case V4L2_TUNER_MODE_STEREO:
    break;
...
#[no_mangle]
unsafe extern "C" fn tda9874a_checkit(chip: *mut CHIPSTATE) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda9874a_initialize(chip: *mut CHIPSTATE) -> c_int {
...
pub const TDA9875_MUT: c_uint = 0x12  /*General mute  (value --> 0b11001100*/;
pub const TDA9875_CFG: c_uint = 0x01  /* Config register (value --> 0b00000000 */;
pub const TDA9875_DACOS: c_uint = 0x13  /*DAC i/o select (ADC) 0b0000100*/;
pub const TDA9875_LOSR: c_uint = 0x16  /*Line output select regirter 0b0100 0001*/;
pub const TDA9875_CH1V: c_uint = 0x0c  /*Channel 1 volume (mute)*/;
pub const TDA9875_CH2V: c_uint = 0x0d  /*Channel 2 volume (mute)*/;
pub const TDA9875_SC1: c_uint = 0x14  /*SCART 1 in (mono)*/;
pub const TDA9875_SC2: c_uint = 0x15  /*SCART 2 in (mono)*/;
pub const TDA9875_ADCIS: c_uint = 0x17  /*ADC input select (mono) 0b0110 000*/;
pub const TDA9875_AER: c_uint = 0x19  /*Audio effect (AVL+Pseudo) 0b0000 0110*/;
pub const TDA9875_MCS: c_uint = 0x18  /*Main channel select (DAC) 0b0000100*/;
pub const TDA9875_MVL: c_uint = 0x1a  /* Main volume gauche */;
pub const TDA9875_MVR: c_uint = 0x1b  /* Main volume droite */;
pub const TDA9875_MBA: c_uint = 0x1d  /* Main Basse */;
pub const TDA9875_MTR: c_uint = 0x1e  /* Main treble */;
pub const TDA9875_ACS: c_uint = 0x1f  /* Auxiliary channel select (FM) 0b0000000*/;
pub const TDA9875_AVL: c_uint = 0x20  /* Auxiliary volume gauche */;
pub const TDA9875_AVR: c_uint = 0x21  /* Auxiliary volume droite */;
pub const TDA9875_ABA: c_uint = 0x22  /* Auxiliary Basse */;
pub const TDA9875_ATR: c_uint = 0x23  /* Auxiliary treble */;
pub const TDA9875_MSR: c_uint = 0x02  /* Monitor select register */;
pub const TDA9875_C1MSB: c_uint = 0x03  /* Carrier 1 (FM) frequency register MSB */;
pub const TDA9875_C1MIB: c_uint = 0x04  /* Carrier 1 (FM) frequency register (16-8]b */;
pub const TDA9875_C1LSB: c_uint = 0x05  /* Carrier 1 (FM) frequency register LSB */;
pub const TDA9875_C2MSB: c_uint = 0x06  /* Carrier 2 (nicam) frequency register MSB */;
pub const TDA9875_C2MIB: c_uint = 0x07  /* Carrier 2 (nicam) frequency register (16-8]b */;
pub const TDA9875_C2LSB: c_uint = 0x08  /* Carrier 2 (nicam) frequency register LSB */;
pub const TDA9875_DCR: c_uint = 0x09  /* Demodulateur configuration regirter*/;
pub const TDA9875_DEEM: c_uint = 0x0a  /* FM de-emphasis regirter*/;
pub const TDA9875_FMAT: c_uint = 0x0b  /* FM Matrix regirter*/;
// values
pub const TDA9875_MUTE_ON: c_uint = 0xff /* general mute */;
pub const TDA9875_MUTE_OFF: c_uint = 0xcc /* general no mute */;
#[no_mangle]
unsafe extern "C" fn tda9875_initialize(chip: *mut CHIPSTATE) -> c_int {
...
// ***********************
#[no_mangle]
unsafe extern "C" fn tda9875_checkit(chip: *mut CHIPSTATE) -> c_int {
...
pub const TEA6300_VL: c_uint = 0x00  /* volume left */;
pub const TEA6300_VR: c_uint = 0x01  /* volume right */;
pub const TEA6300_BA: c_uint = 0x02  /* bass */;
pub const TEA6300_TR: c_uint = 0x03  /* treble */;
pub const TEA6300_FA: c_uint = 0x04  /* fader control */;
pub const TEA6300_S: c_uint = 0x05  /* switch register */;
// values for those registers:
pub const TEA6300_S_SA: c_uint = 0x01  /* stereo A input */;
pub const TEA6300_S_SB: c_uint = 0x02  /* stereo B */;
pub const TEA6300_S_SC: c_uint = 0x04  /* stereo C */;
pub const TEA6300_S_GMU: c_uint = 0x80  /* general mute */;
pub const TEA6320_V: c_uint = 0x00  /* volume (0-5)/loudness off (6)/zero crossing mute(7) */;
pub const TEA6320_FFR: c_uint = 0x01  /* fader front right (0-5) */;
pub const TEA6320_FFL: c_uint = 0x02  /* fader front left (0-5) */;
pub const TEA6320_FRR: c_uint = 0x03  /* fader rear right (0-5) */;
pub const TEA6320_FRL: c_uint = 0x04  /* fader rear left (0-5) */;
pub const TEA6320_BA: c_uint = 0x05  /* bass (0-4) */;
pub const TEA6320_TR: c_uint = 0x06  /* treble (0-4) */;
pub const TEA6320_S: c_uint = 0x07  /* switch register */;
// values for those registers:
pub const TEA6320_S_SA: c_uint = 0x07  /* stereo A input */;
pub const TEA6320_S_SB: c_uint = 0x06  /* stereo B */;
pub const TEA6320_S_SC: c_uint = 0x05  /* stereo C */;
pub const TEA6320_S_SD: c_uint = 0x04  /* stereo D */;
pub const TEA6320_S_GMU: c_uint = 0x80  /* general mute */;
pub const TEA6420_S_SA: c_uint = 0x00  /* stereo A input */;
pub const TEA6420_S_SB: c_uint = 0x01  /* stereo B */;
pub const TEA6420_S_SC: c_uint = 0x02  /* stereo C */;
pub const TEA6420_S_SD: c_uint = 0x03  /* stereo D */;
pub const TEA6420_S_SE: c_uint = 0x04  /* stereo E */;
pub const TEA6420_S_GMU: c_uint = 0x05  /* general mute */;
...
#[no_mangle]
unsafe extern "C" fn tea6320_initialize(chip: *mut *mut CHIPSTATE) -> c_int {
...
pub const TDA8425_VL: c_uint = 0x00  /* volume left */;
pub const TDA8425_VR: c_uint = 0x01  /* volume right */;
pub const TDA8425_BA: c_uint = 0x02  /* bass */;
pub const TDA8425_TR: c_uint = 0x03  /* treble */;
pub const TDA8425_S1: c_uint = 0x08  /* switch functions */;
// values for those registers:
pub const TDA8425_S1_OFF: c_uint = 0xEE  /* audio off (mute on) */;
pub const TDA8425_S1_CH1: c_uint = 0xCE  /* audio channel 1 (mute off) - "linear stereo" mode */;
pub const TDA8425_S1_CH2: c_uint = 0xCF  /* audio channel 2 (mute off) - "linear stereo" mode */;
pub const TDA8425_S1_MU: c_uint = 0x20  /* mute bit */;
pub const TDA8425_S1_STEREO: c_uint = 0x18  /* stereo bits */;
pub const TDA8425_S1_STEREO_SPATIAL: c_uint = 0x18 /* spatial stereo */;
pub const TDA8425_S1_STEREO_LINEAR: c_uint = 0x08 /* linear stereo */;
pub const TDA8425_S1_STEREO_PSEUDO: c_uint = 0x10 /* pseudo stereo */;
pub const TDA8425_S1_STEREO_MONO: c_uint = 0x00 /* forced mono */;
pub const TDA8425_S1_ML: c_uint = 0x06        /* language selector */;
pub const TDA8425_S1_ML_SOUND_A: c_uint = 0x02     /* sound a */;
pub const TDA8425_S1_ML_SOUND_B: c_uint = 0x04     /* sound b */;
pub const TDA8425_S1_ML_STEREO: c_uint = 0x06     /* stereo */;
pub const TDA8425_S1_IS: c_uint = 0x01        /* channel selector */;
    static int tda8425_shift10(int val) { return (val >> 10) | 0xc0; }
    static int tda8425_shift12(int val) { return (val >> 12) | 0xf0; }
#[no_mangle]
unsafe extern "C" fn tda8425_setaudmode(chip: *mut CHIPSTATE, mode: c_int) {
    static void tda8425_setaudmode(struct CHIPSTATE *chip, int mode)
    {
    let mut s1: c_int = chip.shadow.bytes[TDA8425_S1+1] & 0xe1;
    switch (mode) {
    case V4L2_TUNER_MODE_LANG1:
...
pub const PIC16C54_REG_KEY_CODE: c_uint = 0x01	       /* Not use. */;
pub const PIC16C54_REG_MISC: c_uint = 0x02;
// bit definition of the RESET register, I2C data.
pub const PIC16C54_MISC_RESET_REMOTE_CTL: c_uint = 0x01 /* bit 0, Reset to receive the key */;
// code of remote controller
pub const PIC16C54_MISC_MTS_MAIN: c_uint = 0x02 /* bit 1 */;
pub const PIC16C54_MISC_MTS_SAP: c_uint = 0x04 /* bit 2 */;
pub const PIC16C54_MISC_MTS_BOTH: c_uint = 0x08 /* bit 3 */;
pub const PIC16C54_MISC_SND_MUTE: c_uint = 0x10 /* bit 4, Mute Audio(Line-in and Tuner) */;
pub const PIC16C54_MISC_SND_NOTMUTE: c_uint = 0x20 /* bit 5 */;
pub const PIC16C54_MISC_SWITCH_TUNER: c_uint = 0x40 /* bit 6	, Switch to Line-in */;
pub const PIC16C54_MISC_SWITCH_LINE: c_uint = 0x80 /* bit 7	, Switch to Tuner */;
// ----------------------------------------------------------------------
// audio chip descriptions - defines+functions for TA8874Z
// write 1st byte
pub const TA8874Z_LED_STE: c_uint = 0x80;
pub const TA8874Z_LED_BIL: c_uint = 0x40;
pub const TA8874Z_LED_EXT: c_uint = 0x20;
pub const TA8874Z_MONO_SET: c_uint = 0x10;
pub const TA8874Z_MUTE: c_uint = 0x08;
pub const TA8874Z_F_MONO: c_uint = 0x04;
pub const TA8874Z_MODE_SUB: c_uint = 0x02;
pub const TA8874Z_MODE_MAIN: c_uint = 0x01;
// write 2nd byte
// #define TA8874Z_TI	0x80  */ /* test mode
pub const TA8874Z_SEPARATION: c_uint = 0x3f;
pub const TA8874Z_SEPARATION_DEFAULT: c_uint = 0x10;
// read
pub const TA8874Z_B1: c_uint = 0x80;
pub const TA8874Z_B0: c_uint = 0x40;
pub const TA8874Z_CHAG_FLAG: c_uint = 0x20;
//
// B1 B0
// mono    L  H
// stereo  L  L
...
//
#[no_mangle]
unsafe extern "C" fn ta8874z_getrxsubchans(chip: *mut CHIPSTATE) -> c_int {
...
// v4l2_dbg(1, debug, &chip->sd,
    ...
    let mut ta8874z_stereo: static audiocmd = { 2, {0, TA8874Z_SEPARATION_DEFAULT}};
    let mut ta8874z_mono: static audiocmd = {2, { TA8874Z_MONO_SET, TA8874Z_SEPARATION_DEFAULT}};
    let mut ta8874z_main: static audiocmd = {2, { 0, TA8874Z_SEPARATION_DEFAULT}};
    let mut ta8874z_sub: static audiocmd = {2, { TA8874Z_MODE_SUB, TA8874Z_SEPARATION_DEFAULT}};
    let mut ta8874z_both: static audiocmd = {2, { TA8874Z_MODE_MAIN | TA8874Z_MODE_SUB, TA8874Z_SEPARATION_DEFAULT}};
#[no_mangle]
unsafe extern "C" fn ta8874z_setaudmode(chip: *mut CHIPSTATE, mode: c_int) {
    static void ta8874z_setaudmode(struct CHIPSTATE *chip, int mode)
    {
    struct v4l2_subdev *sd = &chip.sd;
    let mut update: c_int = 1;
    audiocmd *t = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ta8874z_checkit(chip: *mut CHIPSTATE) -> c_int {
...
// insmod options to enable/disable individual audio chips
    let mut tda8425: static int = 1;
    let mut tda9840: static int = 1;
    let mut tda9850: static int = 1;
    let mut tda9855: static int = 1;
    let mut tda9873: static int = 1;
    let mut tda9874a: static int = 1;
    let mut tda9875: static int = 1;
    static int tea6300;	/* default 0 - address clash with msp34xx */
    static int tea6320;	/* default 0 - address clash with msp34xx */
    let mut tea6420: static int = 1;
    let mut pic16c54: static int = 1;
...
// callbacks
    ...
    { .name = core::ptr::null_mut() } /* EOF */
    };
// ----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn tvaudio_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvaudio_s_radio(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvaudio_s_tuner(sd: *mut v4l2_subdev, vt: *const v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvaudio_g_tuner(sd: *mut v4l2_subdev, vt: *mut v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvaudio_s_std(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvaudio_s_frequency(sd: *mut v4l2_subdev, freq: *const v4l2_frequency) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvaudio_log_status(sd: *mut v4l2_subdev) -> c_int {
...
// i2c registration
#[no_mangle]
unsafe extern "C" fn tvaudio_probe(client: *mut i2c_client) -> c_int {
    ...
    for (desc = chiplist; desc.name != core::ptr::null_mut(); desc++)
...
// find description for the chip
    ...
    if (desc.name == core::ptr::null_mut()) {
...
// initialization
    if (desc.initialize != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn tvaudio_remove(client: *mut i2c_client) {
