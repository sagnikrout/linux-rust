...
//! Source: drivers/media/i2c/s5kjn1.c
#![no_std]
...
pub const S5KJN1_DATA_LANES: c_int = 4;
// Register map is similar to MIPI CCS compliant camera sensors

pub const S5KJN1_CHIP_ID: c_uint = 0x38e1;

pub const S5KJN1_EXPOSURE_MIN: c_int = 8;
pub const S5KJN1_EXPOSURE_STEP: c_int = 1;

pub const S5KJN1_AGAIN_MIN: c_int = 1;
pub const S5KJN1_AGAIN_MAX: c_int = 64;
pub const S5KJN1_AGAIN_STEP: c_int = 1;
pub const S5KJN1_AGAIN_DEFAULT: c_int = 6;
pub const S5KJN1_AGAIN_SHIFT: c_int = 5;

pub const S5KJN1_VTS_MAX: c_uint = 0xffff;
...
pub struct s5kjn1_mode {
    ...
    pub /: *mut *mut u32 exposure; / Default exposure value,
    pub /: *mut *mut u32 exposure_margin; / Exposure margin,
    pub /: *const *const s5kjn1_reg_list reg_list; / Sensor register setting,
}
...
pub struct s5kjn1 {
    ...
    pub /: *mut *mut *mut regulator afvdd; / Autofocus actuator power,
    pub /: *mut *mut *mut regulator vdda; / Analog power,
    pub /: *mut *mut *mut regulator vddd; / Digital core power,
    pub /: *mut *mut *mut regulator vddio; / Digital I/O power,
    pub sd: v4l2_subdev,
    pub pad: media_pad,
...
#[no_mangle]
unsafe extern "C" fn s5kjn1_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// V4L2 controls are applied, when sensor is powered up for streaming
    ...
    ctrl.val << S5KJN1_AGAIN_SHIFT, core::ptr::null_mut());
    break;
    ...
    (s5kjn1.hflip.val ? S5KJN1_HFLIP : 0), core::ptr::null_mut());
    break;
...
#[no_mangle]
pub unsafe extern "C" fn s5kjn1_freq_to_pixel_rate(freq: u64) -> u64 {
    static inline u64 s5kjn1_freq_to_pixel_rate(const u64 freq)
    {
    return div_u64(freq * 2 * S5KJN1_DATA_LANES, 10);
    }
#[no_mangle]
unsafe extern "C" fn s5kjn1_init_controls(s5kjn1: *mut s5kjn1) -> c_int {
...
// Sensor init settings
    ...
    struct s5kjn1 *s5kjn1 = to_s5kjn1(sd);
    int ret;
    ret = cci_write(s5kjn1.regmap, S5KJN1_REG_CTRL_MODE, 0x0, core::ptr::null_mut());
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn s5kjn1_get_format_code(s5kjn1: *mut s5kjn1) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn s5kjn1_identify_sensor(s5kjn1: *mut s5kjn1) -> c_int {
    static int s5kjn1_identify_sensor(struct s5kjn1 *s5kjn1)
    {
    u64 val;
    int ret;
    ret = cci_read(s5kjn1.regmap, S5KJN1_REG_CHIP_ID, &val, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn s5kjn1_check_hwcfg(s5kjn1: *mut s5kjn1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5kjn1_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5kjn1_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5kjn1_probe(client: *mut i2c_client) -> c_int {
    ...
    "failed to init CCI\n");
    s5kjn1.mclk = devm_v4l2_sensor_clk_get(s5kjn1.dev, core::ptr::null_mut());
    ...
    s5kjn1.afvdd = core::ptr::null_mut();
    }
    ...
    s5kjn1.vddio = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn s5kjn1_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(s5kjn1_power_off, s5kjn1_power_on, core::ptr::null_mut())
    };
