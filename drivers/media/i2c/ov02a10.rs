...
//! Source: drivers/media/i2c/ov02a10.c
#![no_std]
...
pub const OV02A10_ID: c_uint = 0x2509;

pub const OV02A10_REG_CHIP_ID: c_uint = 0x02;
// Bit[1] vertical upside down
// Bit[0] horizontal mirror
pub const REG_MIRROR_FLIP_CONTROL: c_uint = 0x3f;
// Orientation
pub const REG_MIRROR_FLIP_ENABLE: c_uint = 0x03;
// Bit[2:0] MIPI transmission speed select
pub const TX_SPEED_AREA_SEL: c_uint = 0xa1;
pub const OV02A10_MIPI_TX_SPEED_DEFAULT: c_uint = 0x04;
pub const REG_PAGE_SWITCH: c_uint = 0xfd;
pub const REG_GLOBAL_EFFECTIVE: c_uint = 0x01;

pub const REG_SC_CTRL_MODE: c_uint = 0xac;
pub const SC_CTRL_MODE_STANDBY: c_uint = 0x00;
pub const SC_CTRL_MODE_STREAMING: c_uint = 0x01;
// Exposure control
pub const OV02A10_EXP_SHIFT: c_int = 8;
pub const OV02A10_REG_EXPOSURE_H: c_uint = 0x03;
pub const OV02A10_REG_EXPOSURE_L: c_uint = 0x04;
pub const OV02A10_EXPOSURE_MIN: c_int = 4;
pub const OV02A10_EXPOSURE_MAX_MARGIN: c_int = 4;
pub const OV02A10_EXPOSURE_STEP: c_int = 1;
// Vblanking control
pub const OV02A10_VTS_SHIFT: c_int = 8;
pub const OV02A10_REG_VTS_H: c_uint = 0x05;
pub const OV02A10_REG_VTS_L: c_uint = 0x06;
pub const OV02A10_VTS_MAX: c_uint = 0x209f;
pub const OV02A10_BASE_LINES: c_int = 1224;
// Analog gain control
pub const OV02A10_REG_GAIN: c_uint = 0x24;
pub const OV02A10_GAIN_MIN: c_uint = 0x10;
pub const OV02A10_GAIN_MAX: c_uint = 0xf8;
pub const OV02A10_GAIN_STEP: c_uint = 0x01;
pub const OV02A10_GAIN_DEFAULT: c_uint = 0x40;
// Test pattern control
pub const OV02A10_REG_TEST_PATTERN: c_uint = 0xb6;

// Number of lanes supported by this driver
pub const OV02A10_DATA_LANES: c_int = 1;
// Bits per sample of sensor output
pub const OV02A10_BITS_PER_SAMPLE: c_int = 10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov02a10_reg_list {
    pub num_of_regs: u32,
    pub regs: *const ov02a10_reg,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov02a10_mode {
    pub width: u32,
    pub height: u32,
    pub exp_def: u32,
    pub hts_def: u32,
    pub vts_def: u32,
    pub reg_list: ov02a10_reg_list,
}
...
// Indication of MIPI transmission speed select
    pub mipi_clock_voltage: u32,
    pub eclk: *mut clk,
    pub pd_gpio: *mut gpio_desc,
    pub rst_gpio: *mut gpio_desc,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(ov02a10_supply_names)],
    pub streaming: bool,
...
//
    ...
    pub cur_mode: *const ov02a10_mode,
}
...
unsafe extern "C" fn to_pixel_rate(f_index: u32) -> u64 {
    ...
    {
    let mut pixel_rate: u64 = link_freq_menu_items[f_index] * 2 * OV02A10_DATA_LANES;
...
#[no_mangle]
unsafe extern "C" fn ov02a10_check_sensor_id(ov02a10: *mut ov02a10) -> c_int {
...
// Validate the chip ID
    ...
    if (ret < 0)
    return ret;
    chip_id = le16_to_cpu(( __le16)ret);
...
#[no_mangle]
unsafe extern "C" fn ov02a10_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov02a10_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ov02a10_start_stream(ov02a10: *mut ov02a10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ov02a10_stop_stream(ov02a10: *mut ov02a10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov02a10_s_stream(sd: *mut v4l2_subdev, on: c_int) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(ov02a10_power_off, ov02a10_power_on, core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn ov02a10_set_exposure(ov02a10: *mut ov02a10, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov02a10_set_gain(ov02a10: *mut ov02a10, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov02a10_set_vblank(ov02a10: *mut ov02a10, val: c_int) -> c_int {
    static int ov02a10_set_vblank(struct ov02a10 *ov02a10, int val)
    {
    struct i2c_client *client = v4l2_get_subdevdata(&ov02a10.subdev);
    let mut vts: u32 = val + ov02a10.cur_mode.height - OV02A10_BASE_LINES;
    int ret;
    ret = i2c_smbus_write_byte_data(client, REG_PAGE_SWITCH, REG_ENABLE);
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn ov02a10_set_test_pattern(ov02a10: *mut ov02a10, pattern: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov02a10_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov02a10_initialize_controls(ov02a10: *mut ov02a10) -> c_int {
    ...
    ctrl = v4l2_ctrl_new_int_menu(handler, core::ptr::null_mut(), V4L2_CID_LINK_FREQ, 0, 0,
    link_freq_menu_items);
    if (ctrl)
    ctrl.flags |= V4L2_CTRL_FLAG_READ_ONLY;
    pixel_rate = to_pixel_rate(0);
    v4l2_ctrl_new_std(handler, core::ptr::null_mut(), V4L2_CID_PIXEL_RATE, 0, pixel_rate, 1,
    pixel_rate);
    h_blank = mode.hts_def - mode.width;
    v4l2_ctrl_new_std(handler, core::ptr::null_mut(), V4L2_CID_HBLANK, h_blank, h_blank, 1,
    h_blank);
...
#[no_mangle]
unsafe extern "C" fn ov02a10_check_hwcfg(dev: *mut device, ov02a10: *mut ov02a10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov02a10_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov02a10_remove(client: *mut i2c_client) {
