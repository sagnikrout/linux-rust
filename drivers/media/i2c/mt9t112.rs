...
//! Source: drivers/media/i2c/mt9t112.c
#![no_std]
...
// frame size
//
pub const MAX_WIDTH: c_int = 2048;
pub const MAX_HEIGHT: c_int = 1536;
//
// macro of read/write
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt9t112_priv {
    pub subdev: v4l2_subdev,
    pub info: *mut mt9t112_platform_data,
    pub client: *mut i2c_client,
    pub frame: v4l2_rect,
    pub clk: *mut clk,
    pub standby_gpio: *mut gpio_desc,
    pub format: *const mt9t112_format,
...
#[no_mangle]
unsafe extern "C" fn __mt9t112_reg_read(client: *const i2c_client, command: u16) -> c_int {
...
//
    ...
    {
    let mut val: c_int = __mt9t112_reg_read(client, command);
    if (val < 0)
    return val;
    val &= ~mask;
    val |= set & mask;
...
// mcu access
#[no_mangle]
unsafe extern "C" fn __mt9t112_mcu_read(client: *const i2c_client, command: u16) -> c_int {
    ...
    u16  command, u16  mask, u16  set)
    {
    let mut val: c_int = __mt9t112_mcu_read(client, command);
    if (val < 0)
    return val;
    val &= ~mask;
    val |= set & mask;
...
#[no_mangle]
unsafe extern "C" fn mt9t112_reset(client: *const i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9t112_clock_info(client: *const i2c_client, ext: u32) -> c_int {
    ...
    {
    int ret;
    let mut wstart: u16 = (MAX_WIDTH - width) / 2;
    let mut hstart: u16 = (MAX_HEIGHT - height) / 2;
...
#[no_mangle]
unsafe extern "C" fn mt9t112_init_pll(client: *const i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9t112_init_setting(client: *const i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9t112_auto_focus_setting(client: *const i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9t112_auto_focus_trigger(client: *const i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9t112_init_camera(client: *const i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9t112_power_on(priv: *mut mt9t112_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9t112_power_off(priv: *mut mt9t112_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9t112_s_power(sd: *mut v4l2_subdev, on: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mt9t112_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9t112_camera_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9t112_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt9t112_remove(client: *mut i2c_client) {
