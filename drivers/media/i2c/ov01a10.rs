...
//! Source: drivers/media/i2c/ov01a10.c
#![no_std]
...
pub const OV01A10_DATA_LANES: c_int = 1;
pub const OV01A10_MCLK: c_int = 19200000;

pub const OV01A10_CHIP_ID: c_uint = 0x560141;

pub const OV01A10_MODE_STANDBY: c_uint = 0x00;
pub const OV01A10_MODE_STREAMING: c_uint = 0x01;
// pixel array
pub const OV01A10_NATIVE_WIDTH: c_int = 1296;
pub const OV01A10_NATIVE_HEIGHT: c_int = 816;
pub const OV01A10_DEFAULT_WIDTH: c_int = 1280;
pub const OV01A10_DEFAULT_HEIGHT: c_int = 800;
// vertical and horizontal timings
pub const OV01A10_VTS_DEF: c_uint = 0x0700;
pub const OV01A10_VTS_MIN: c_uint = 0x0380;
pub const OV01A10_VTS_MAX: c_uint = 0xffff;
pub const OV01A10_HTS_DEF: c_int = 1488;
// exposure controls

pub const OV01A10_EXPOSURE_MIN: c_int = 4;
pub const OV01A10_EXPOSURE_MAX_MARGIN: c_int = 8;
pub const OV01A10_EXPOSURE_STEP: c_int = 1;
// analog gain controls

pub const OV01A10_ANAL_GAIN_MIN: c_uint = 0x100;
pub const OV01A10_ANAL_GAIN_MAX: c_uint = 0x3fff;
pub const OV01A10_ANAL_GAIN_STEP: c_int = 1;
// digital gain controls

pub const OV01A10_DGTL_GAIN_MIN: c_int = 0;
pub const OV01A10_DGTL_GAIN_MAX: c_uint = 0x3fff;
pub const OV01A10_DGTL_GAIN_STEP: c_int = 1;
pub const OV01A10_DGTL_GAIN_DEFAULT: c_int = 1024;
// timing control
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov01a10_link_freq_config {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov01a10_sensor_cfg {
    pub model: *const c_char,
    pub bus_fmt: u32,
    pub pattern_size: c_int,
    pub border_size: c_int,
    pub format1_base_val: u8,
    pub invert_hflip_shift: bool,
    pub invert_vflip_shift: bool,
}
...
pub struct ov01a10 {
    ...
    pub cfg: *const ov01a10_sensor_cfg,
    pub sd: v4l2_subdev,
    pub pad: media_pad,
...
// v4l2 controls
    ...
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(ov01a10_supply_names)],
}
...
#[no_mangle]
unsafe extern "C" fn ov01a10_update_digital_gain(ov01a10: *mut ov01a10, d_gain: u32) -> c_int {
    static int ov01a10_update_digital_gain(struct ov01a10 *ov01a10, u32 d_gain)
    {
    let mut real: u32 = d_gain << 6;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ov01a10_test_pattern(ov01a10: *mut ov01a10, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov01a10_set_format1(ov01a10: *mut ov01a10, ret: *mut c_int) {
    static void ov01a10_set_format1(struct ov01a10 *ov01a10, int *ret)
    {
    let mut val: u8 = ov01a10.cfg.format1_base_val;
...
#[no_mangle]
unsafe extern "C" fn ov01a10_set_hflip(ov01a10: *mut ov01a10, hflip: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov01a10_set_vflip(ov01a10: *mut ov01a10, vflip: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov01a10_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov01a10_init_controls(ov01a10: *mut ov01a10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov01a10_set_mode(ov01a10: *mut ov01a10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov01a10_start_streaming(ov01a10: *mut ov01a10) -> c_int {
    ...
    OV01A10_MODE_STREAMING, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ov01a10_stop_streaming(ov01a10: *mut ov01a10) {
    static void ov01a10_stop_streaming(struct ov01a10 *ov01a10)
    {
    cci_write(ov01a10.regmap, OV01A10_REG_MODE_SELECT,
    OV01A10_MODE_STANDBY, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ov01a10_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
    ...
    struct ov01a10 *ov01a10 = to_ov01a10(sd);
    let mut pattern_size: c_int = ov01a10.cfg.pattern_size;
    let mut border_size: c_int = ov01a10.cfg.border_size;
...
#[no_mangle]
unsafe extern "C" fn ov01a10_get_pm_resources(ov01a10: *mut ov01a10) -> c_int {
    static int ov01a10_get_pm_resources(struct ov01a10 *ov01a10)
    {
    unsigned long freq;
    int i, ret;
    ov01a10.clk = devm_v4l2_sensor_clk_get(ov01a10.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ov01a10_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov01a10_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov01a10_identify_module(ov01a10: *mut ov01a10) -> c_int {
    static int ov01a10_identify_module(struct ov01a10 *ov01a10)
    {
    int ret;
    u64 val;
    ret = cci_read(ov01a10.regmap, OV01A10_REG_CHIP_ID, &val, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn ov01a10_check_hwcfg(ov01a10: *mut ov01a10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov01a10_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ov01a10_probe(client: *mut i2c_client) -> c_int {
...
// Override driver->name with actual sensor model
    v4l2_i2c_subdev_set_name(&ov01a10.sd, client, cfg.model, core::ptr::null_mut());
...
//
    ...
    ov01a10_power_on, core::ptr::null_mut());
