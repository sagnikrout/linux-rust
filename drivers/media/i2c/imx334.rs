...
//! Source: drivers/media/i2c/imx334.c
#![no_std]
...
pub const IMX334_MODE_STANDBY: c_uint = 0x01;
pub const IMX334_MODE_STREAMING: c_uint = 0x00;
// Lines per frame

// Chip ID

pub const IMX334_ID: c_uint = 0x1e;
// Exposure control

pub const IMX334_EXPOSURE_MIN: c_int = 1;
pub const IMX334_EXPOSURE_OFFSET: c_int = 5;
pub const IMX334_EXPOSURE_STEP: c_int = 1;
pub const IMX334_EXPOSURE_DEFAULT: c_uint = 0x0648;

pub const IMX334_CSI_4_LANE_MODE: c_int = 3;
pub const IMX334_CSI_8_LANE_MODE: c_int = 7;
...
pub const IMX334_AGAIN_MIN: c_int = 0;
pub const IMX334_AGAIN_MAX: c_int = 240;
pub const IMX334_AGAIN_STEP: c_int = 1;
pub const IMX334_AGAIN_DEFAULT: c_int = 0;
// Group hold register

// Input clock rate
pub const IMX334_INCLK_RATE: c_int = 24000000;
// INCK Setting Register

// CSI2 HW configuration
pub const IMX334_LINK_FREQ_891M: c_int = 891000000;
pub const IMX334_LINK_FREQ_445M: c_int = 445500000;
pub const IMX334_NUM_DATA_LANES: c_int = 4;
pub const IMX334_REG_MIN: c_uint = 0x00;
pub const IMX334_REG_MAX: c_uint = 0xfffff;
// Test Pattern Control

pub const IMX334_TP_COLOR_HBARS: c_uint = 0xa;
pub const IMX334_TP_COLOR_VBARS: c_uint = 0xb;
pub const IMX334_TP_BLACK: c_uint = 0x0;
pub const IMX334_TP_WHITE: c_uint = 0x1;
pub const IMX334_TP_BLACK_GREY: c_uint = 0xc;

pub const IMX334_TP_ENABLE: c_uint = 0x1;
pub const IMX334_TP_DISABLE: c_uint = 0x0;

pub const IMX334_TPG_COLORW_120P: c_uint = 0x13;

pub const IMX334_TP_CLK_EN_VAL: c_uint = 0x10;
pub const IMX334_TP_CLK_DIS_VAL: c_uint = 0x0;
...
//
#[no_mangle]
unsafe extern "C" fn imx334_update_exp_gain(imx334: *mut imx334, exposure: u32, gain: u32) -> c_int {
    ...
    ret_hold = cci_write(imx334.cci, IMX334_REG_HOLD, 0, core::ptr::null_mut());
    if (ret_hold)
    return ret_hold;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn imx334_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// Set controls only if sensor is in power on state
    ...
    IMX334_TP_CLK_EN_VAL, core::ptr::null_mut());
    cci_write(imx334.cci, IMX334_DIG_CLP_MODE, 0x0, core::ptr::null_mut());
    cci_write(imx334.cci, IMX334_TPG_COLORW,
    IMX334_TPG_COLORW_120P, core::ptr::null_mut());
    cci_write(imx334.cci, IMX334_REG_TP,
    imx334_test_pattern_val[ctrl.val], core::ptr::null_mut());
    cci_write(imx334.cci, IMX334_TPG_EN_DOUT,
    IMX334_TP_ENABLE, core::ptr::null_mut());
    } else {
    cci_write(imx334.cci, IMX334_DIG_CLP_MODE, 0x1, core::ptr::null_mut());
    cci_write(imx334.cci, IMX334_TP_CLK_EN,
    IMX334_TP_CLK_DIS_VAL, core::ptr::null_mut());
    cci_write(imx334.cci, IMX334_TPG_EN_DOUT,
    IMX334_TP_DISABLE, core::ptr::null_mut());
    }
    ret = 0;
    break;
    default:
...
#[no_mangle]
unsafe extern "C" fn imx334_get_format_code(imx334: *mut imx334, code: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx334_set_framefmt(imx334: *mut imx334) -> c_int {
    ...
    ARRAY_SIZE(raw10_framefmt_regs), core::ptr::null_mut());
    case MEDIA_BUS_FMT_SRGGB12_1X12:
    return cci_multi_reg_write(imx334.cci, raw12_framefmt_regs,
    ARRAY_SIZE(raw12_framefmt_regs), core::ptr::null_mut());
    }
    return -EINVAL;
    }
    ...
    ARRAY_SIZE(common_mode_regs), core::ptr::null_mut());
    if (ret) {
...
// Write sensor mode registers
    ...
    IMX334_CSI_4_LANE_MODE, core::ptr::null_mut());
    if (ret) {
...
// Start streaming
    ...
    IMX334_MODE_STREAMING, core::ptr::null_mut());
    if (ret) {
    ...
    int ret;
    ret = cci_write(imx334.cci, IMX334_REG_MODE_SELECT,
    IMX334_MODE_STANDBY, core::ptr::null_mut());
    if (ret)
...
//
#[no_mangle]
unsafe extern "C" fn imx334_detect(imx334: *mut imx334) -> c_int {
    static int imx334_detect(struct imx334 *imx334)
    {
    int ret;
    u64 val;
    ret = cci_read(imx334.cci, IMX334_REG_ID, &val, core::ptr::null_mut());
    if (ret)
    return ret;
    if (val != IMX334_ID) {
...
//
#[no_mangle]
unsafe extern "C" fn imx334_parse_hw_config(imx334: *mut imx334) -> c_int {
...
// Get sensor input clock
    imx334.inclk = devm_v4l2_sensor_clk_get(imx334.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn imx334_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx334_power_off(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imx334_init_controls(imx334: *mut imx334) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx334_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx334_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(imx334_power_off, imx334_power_on, core::ptr::null_mut())
    };
