...
//! Source: drivers/media/i2c/adv7343.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adv7343_state {
    pub sd: v4l2_subdev,
    pub hdl: v4l2_ctrl_handler,
    pub pdata: *const adv7343_platform_data,
    pub reg00: u8,
    pub reg01: u8,
    pub reg02: u8,
    pub reg35: u8,
...
#[no_mangle]
pub unsafe extern "C" fn adv7343_write(sd: *mut v4l2_subdev, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7343_setstd(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7343_setoutput(sd: *mut v4l2_subdev, output_type: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(ADV7343_COMPONENT_ID: output_type ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(!state->pdata->sd_config.sd_dac_out[0]: state->pdata &&) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(!state->pdata->sd_config.sd_dac_out[1]: state->pdata &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn adv7343_log_status(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7343_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7343_s_std_output(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7343_initialize(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7343_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7343_remove(client: *mut i2c_client) {
