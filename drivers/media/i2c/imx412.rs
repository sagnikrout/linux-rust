...
//! Source: drivers/media/i2c/imx412.c
#![no_std]
...
pub const IMX412_MODE_STANDBY: c_uint = 0x00;
pub const IMX412_MODE_STREAMING: c_uint = 0x01;
// Lines per frame

// Chip ID

pub const IMX412_ID: c_uint = 0x577;
// Exposure control

pub const IMX412_EXPOSURE_MIN: c_int = 8;
pub const IMX412_EXPOSURE_OFFSET: c_int = 22;
pub const IMX412_EXPOSURE_STEP: c_int = 1;
pub const IMX412_EXPOSURE_DEFAULT: c_uint = 0x0648;
// Analog gain control

pub const IMX412_AGAIN_MIN: c_int = 0;
pub const IMX412_AGAIN_MAX: c_int = 978;
pub const IMX412_AGAIN_STEP: c_int = 1;
pub const IMX412_AGAIN_DEFAULT: c_int = 0;
// Group hold register

// Input clock rate
pub const IMX412_INCLK_RATE: c_int = 24000000;
// CSI2 HW configuration
pub const IMX412_LINK_FREQ: c_int = 600000000;
pub const IMX412_NUM_DATA_LANES: c_int = 4;
pub const IMX412_REG_MIN: c_uint = 0x00;
pub const IMX412_REG_MAX: c_uint = 0xffff;
//
...
pub struct imx412 {
    ...
    pub inclk: *mut clk,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(imx412_supply_names)],
...
//
#[no_mangle]
unsafe extern "C" fn imx412_update_exp_gain(imx412: *mut imx412, exposure: u32, gain: u32) -> c_int {
    ...
    ret_hold = cci_write(imx412.cci, IMX412_REG_HOLD, 0, core::ptr::null_mut());
    if (ret_hold)
    return ret_hold;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn imx412_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// Start streaming
    ...
    IMX412_MODE_STREAMING, core::ptr::null_mut());
    if (ret) {
...
//
    ...
    int ret;
    ret = cci_write(imx412.cci, IMX412_REG_MODE_SELECT,
    IMX412_MODE_STANDBY, core::ptr::null_mut());
    if (ret)
...
//
#[no_mangle]
unsafe extern "C" fn imx412_detect(imx412: *mut imx412) -> c_int {
    static int imx412_detect(struct imx412 *imx412)
    {
    int ret;
    u64 val;
    ret = cci_read(imx412.cci, IMX412_REG_ID, &val, core::ptr::null_mut());
    if (ret)
...
//
#[no_mangle]
unsafe extern "C" fn imx412_parse_hw_config(imx412: *mut imx412) -> c_int {
...
// Get sensor input clock
    imx412.inclk = devm_v4l2_sensor_clk_get(imx412.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn imx412_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx412_power_off(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imx412_init_controls(imx412: *mut imx412) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx412_probe(client: *mut i2c_client) -> c_int {
...
// Initialize subdev
    ...
    v4l2_i2c_subdev_set_name(&imx412.sd, client, name, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn imx412_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(imx412_power_off, imx412_power_on, core::ptr::null_mut())
    };
