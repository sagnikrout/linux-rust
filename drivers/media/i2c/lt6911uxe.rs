...
//! Source: drivers/media/i2c/lt6911uxe.c
#![no_std]
...
pub const LT6911UXE_CHIP_ID: c_uint = 0x2102;

// Interrupts

pub const INT_VIDEO_DISAPPEAR: c_uint = 0x0;
pub const INT_VIDEO_READY: c_uint = 0x1;
pub const LT6911UXE_DEFAULT_LANES: c_int = 4;
pub const LT6911_PAGE_CONTROL: c_uint = 0xff;
pub const YUV422_8_BIT: c_uint = 0x7;
...
#[no_mangle]
unsafe extern "C" fn get_pixel_rate(lt6911uxe: *mut lt6911uxe) -> i64 {
...
// timings = lt6911uxe->timings;
    ...
    &lt6911uxe_timings_cap_4kp30, core::ptr::null_mut(), core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn lt6911uxe_status_update(lt6911uxe: *mut lt6911uxe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lt6911uxe_init_controls(lt6911uxe: *mut lt6911uxe) -> c_int {
    ...
    lt6911uxe.pixel_rate = v4l2_ctrl_new_std(ctrl_hdlr, core::ptr::null_mut(),
    V4L2_CID_PIXEL_RATE,
    ...
    struct i2c_client *client = v4l2_get_subdevdata(&lt6911uxe.sd);
    int ret;
    ret = cci_write(lt6911uxe.regmap, REG_MIPI_TX_CTRL, 0x0, core::ptr::null_mut());
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn lt6911uxe_threaded_irq_fn(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn lt6911uxe_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn lt6911uxe_probe(client: *mut i2c_client) -> c_int {
...
// Setting irq
    ret = request_threaded_irq(gpiod_to_irq(lt6911uxe.irq_gpio), core::ptr::null_mut(),
    lt6911uxe_threaded_irq_fn,
    IRQF_TRIGGER_RISING | IRQF_TRIGGER_FALLING |
    IRQF_ONESHOT, core::ptr::null_mut(), lt6911uxe);
    if (ret) {
