...
//! Source: drivers/media/i2c/ov64a40.c
#![no_std]
...
pub const OV64A40_XCLK_FREQ: c_int = 24000000;
pub const OV64A40_NATIVE_WIDTH: c_int = 9286;
pub const OV64A40_NATIVE_HEIGHT: c_int = 6976;
pub const OV64A40_PIXEL_ARRAY_TOP: c_int = 0;
pub const OV64A40_PIXEL_ARRAY_LEFT: c_int = 0;
pub const OV64A40_PIXEL_ARRAY_WIDTH: c_int = 9248;
pub const OV64A40_PIXEL_ARRAY_HEIGHT: c_int = 6944;
pub const OV64A40_PIXEL_RATE: c_int = 300000000;
pub const OV64A40_LINK_FREQ_360M: c_int = 360000000;
pub const OV64A40_LINK_FREQ_456M: c_int = 456000000;

// TODO: validate vblank_min, it's not characterized in the datasheet.
pub const OV64A40_VBLANK_MIN: c_int = 128;
pub const OV64A40_VTS_MAX: c_uint = 0xffffff;

pub const OV64A40_EXPOSURE_MIN: c_int = 16;
pub const OV64A40_EXPOSURE_MARGIN: c_int = 32;

pub const OV64A40_ANA_GAIN_MIN: c_uint = 0x80;
pub const OV64A40_ANA_GAIN_MAX: c_uint = 0x7ff;
pub const OV64A40_ANA_GAIN_DEFAULT: c_uint = 0x80;
...
pub const OV64A40_ODD_INC_SHIFT: c_int = 4;
...
pub const OV64A40_TEST_PATTERN_DISABLED: c_uint = 0x00;

pub const OV64A40_CHIP_ID: c_uint = 0x566441;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov64a40_reglist {
    pub num_regs: c_uint,
    pub regvals: *const cci_reg_sequence,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov64a40_subsampling {
    pub x_odd_inc: c_uint,
    pub x_even_inc: c_uint,
    pub y_odd_inc: c_uint,
    pub y_even_inc: c_uint,
    pub vbin: bool,
    pub hbin: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov64a40_timings {
    pub vts: c_uint,
    pub ppl: c_uint,
    pub timings_default: [}; OV64A40_NUM_LINK_FREQ],
    pub reglist: ov64a40_reglist,
    pub analogue_crop: v4l2_rect,
    pub digital_crop: v4l2_rect,
    pub subsampling: ov64a40_subsampling,
    } ov64a40_modes[] = {
// Full resolution
    {
    .width = 9248,
...
pub struct ov64a40 {
    ...
    pub pad: media_pad,
    pub cci: *mut regmap,
    pub mode: *mut ov64a40_mode,
    pub xclk: *mut clk,
    pub reset_gpio: *mut gpio_desc,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(ov64a40_supply_names)],
    pub link_frequencies: *mut i64,
    pub num_link_frequencies: c_uint,
    ...
    {
    let mut link_freq: i64 = ov64a40.link_frequencies[link_freq_index];
...
#[no_mangle]
unsafe extern "C" fn ov64a40_program_geometry(ov64a40: *mut ov64a40) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov64a40_program_subsampling(ov64a40: *mut ov64a40) -> c_int {
...
// Binning configuration
    ...
    ARRAY_SIZE(ov64a40_init), core::ptr::null_mut());
    if (ret)
    goto error_power_off;
    ret = cci_multi_reg_write(ov64a40.cci, reglist.regvals,
    reglist.num_regs, core::ptr::null_mut());
    if (ret)
    goto error_power_off;
    ...
    OV64A40_REG_SMIA_STREAMING, core::ptr::null_mut());
    if (ret)
    goto error_power_off;
...
// The sensor has an internal x4 multiplier on the line length.
    ...
    struct v4l2_subdev_state *state)
    {
    cci_update_bits(ov64a40.cci, OV64A40_REG_SMIA, BIT(0), 0, core::ptr::null_mut());
    pm_runtime_put_autosuspend(ov64a40.dev);
...
#[no_mangle]
unsafe extern "C" fn ov64a40_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov64a40_mbus_code(ov64a40: *mut ov64a40) -> u32 {
    static u32 ov64a40_mbus_code(struct ov64a40 *ov64a40)
    {
    let mut index: c_uint = ov64a40.hflip.val << 1 | ov64a40.vflip.val;
...
#[no_mangle]
unsafe extern "C" fn ov64a40_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov64a40_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov64a40_link_freq_config(ov64a40: *mut ov64a40, link_freq_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov64a40_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    let mut exp_val: c_int = min(ov64a40.exposure.cur.val, exp_max);
    __v4l2_ctrl_modify_range(ov64a40.exposure,
    ...
    ctrl.val << 1, core::ptr::null_mut());
    break;
    case V4L2_CID_VBLANK: {
    let mut vts: c_int = ctrl.val + ov64a40.mode.height;
    ...
    ov64a40_test_pattern_val[ctrl.val], core::ptr::null_mut());
    break;
...
#[no_mangle]
unsafe extern "C" fn ov64a40_init_controls(ov64a40: *mut ov64a40) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov64a40_identify(ov64a40: *mut ov64a40) -> c_int {
    static int ov64a40_identify(struct ov64a40 *ov64a40)
    {
    int ret;
    u64 id;
    ret = cci_read(ov64a40.cci, OV64A40_REG_CHIP_ID, &id, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn ov64a40_parse_dt(ov64a40: *mut ov64a40) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov64a40_get_regulators(ov64a40: *mut ov64a40) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov64a40_probe(client: *mut i2c_client) -> c_int {
    ...
    ov64a40.xclk = devm_v4l2_sensor_clk_get(&client.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ov64a40_remove(client: *mut i2c_client) {
    ...
    SET_RUNTIME_PM_OPS(ov64a40_power_off, ov64a40_power_on, core::ptr::null_mut())
    };
