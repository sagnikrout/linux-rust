...
//! Source: drivers/media/i2c/adv7604.c
#![no_std]
...
pub const ADV76XX_MAX_EDID_BLOCKS: c_int = 4;
    enum adv76xx_type {
    ADV7604,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adv76xx_format_info {
    pub code: u32,
    pub op_ch_sel: u8,
    pub rgb_out: bool,
    pub swap_cb_cr: bool,
    pub op_format_sel: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct adv76xx_cfg_read_infoframe {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adv76xx_chip_info {
    pub type: enum adv76xx_type,
    pub has_afe: bool,
    pub max_port: c_uint,
    pub num_dv_ports: c_uint,
    pub edid_enable_reg: c_uint,
    pub edid_status_reg: c_uint,
    pub edid_segment_reg: c_uint,
    pub edid_segment_mask: c_uint,
    pub edid_spa_loc_reg: c_uint,
    pub edid_spa_loc_msb_mask: c_uint,
    pub edid_spa_port_b_reg: c_uint,
    pub lcf_reg: c_uint,
    pub cable_det_mask: c_uint,
    pub tdms_lock_mask: c_uint,
    pub fmt_change_digital_mask: c_uint,
    pub cp_csc: c_uint,
    pub cec_irq_status: c_uint,
    pub cec_rx_enable: c_uint,
    pub cec_rx_enable_mask: c_uint,
    pub cec_irq_swap: bool,
    pub formats: *const adv76xx_format_info,
    pub nformats: c_uint,
    pub enable): *mut *mut *mut void (set_termination)(struct v4l2_subdev sd, bool,
    pub sd): *mut *mut void (setup_irqs)(struct v4l2_subdev,
    pub sd): *mut *mut unsigned int (read_hdmi_pixelclock)(struct v4l2_subdev,
    pub sd): *mut *mut unsigned int (read_cable_det)(struct v4l2_subdev,
// 0 = AFE, 1 = HDMI
    pub recommended_settings: [*const adv76xx_reg_seq; 2],
    pub num_recommended_settings: [c_uint; 2],
    pub page_mask: c_ulong,
// Masks for timings
    pub linewidth_mask: c_uint,
    pub field0_height_mask: c_uint,
    pub field1_height_mask: c_uint,
    pub hfrontporch_mask: c_uint,
    pub hsync_mask: c_uint,
    pub hbackporch_mask: c_uint,
    pub field0_vfrontporch_mask: c_uint,
    pub field1_vfrontporch_mask: c_uint,
    pub field0_vsync_mask: c_uint,
    pub field1_vsync_mask: c_uint,
    pub field0_vbackporch_mask: c_uint,
    pub field1_vbackporch_mask: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adv76xx_state {
    pub info: *const adv76xx_chip_info,
    pub pdata: adv76xx_platform_data,
    pub hpd_gpio: [*mut gpio_desc; 4],
    pub reset_gpio: *mut gpio_desc,
    pub sd: v4l2_subdev,
    pub pads: [media_pad; ADV76XX_PAD_MAX],
    pub source_pad: c_uint,
    pub hdl: v4l2_ctrl_handler,
    pub selected_input: enum adv76xx_pad,
    pub timings: v4l2_dv_timings,
    pub format: *const adv76xx_format_info,
    struct {
    pub 128]: *mut *mut u8 edid[ADV76XX_MAX_EDID_BLOCKS,
    pub present: u32,
    pub blocks: unsigned,
    pub edid: },
    pub spa_port_a: [u16; 2],
    pub aspect_ratio: v4l2_fract,
    pub rgb_quantization_range: u32,
    pub delayed_work_enable_hotplug: delayed_work,
    pub restart_stdi_once: bool,
    pub debugfs_dir: *mut dentry,
    pub infoframes: *mut v4l2_debugfs_if,
// CEC
    pub cec_adap: *mut cec_adapter,
    pub cec_addr: [u8; ADV76XX_MAX_ADDRS],
    pub cec_valid_addrs: u8,
    pub cec_enabled_adap: bool,
// i2c clients
    pub i2c_clients: [*mut i2c_client; ADV76XX_PAGE_MAX],
// Regmaps
    pub regmap: [*mut regmap; ADV76XX_PAGE_MAX],
// controls
    pub detect_tx_5v_ctrl: *mut v4l2_ctrl,
    pub analog_sampling_phase_ctrl: *mut v4l2_ctrl,
    pub free_run_color_manual_ctrl: *mut v4l2_ctrl,
    pub free_run_color_ctrl: *mut v4l2_ctrl,
    pub rgb_quantization_range_ctrl: *mut v4l2_ctrl,
}

#[no_mangle]
unsafe extern "C" fn adv76xx_has_afe(state: *mut adv76xx_state) -> bool {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_check_dv_timings(t: *const v4l2_dv_timings, hdl: *mut c_void) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adv76xx_video_standards {
    pub timings: v4l2_dv_timings,
    pub vid_std: u8,
    pub v_freq: u8,
}
...
#[no_mangle]
pub unsafe extern "C" fn htotal(t: *const v4l2_bt_timings) -> unsigned {
    static inline unsigned htotal(const struct v4l2_bt_timings *t)
    {
    return V4L2_DV_BT_FRAME_WIDTH(t);
    }
#[no_mangle]
pub unsafe extern "C" fn vtotal(t: *const v4l2_bt_timings) -> unsigned {
...
// -----------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn io_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn io_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avlink_read(sd: *mut v4l2_subdev, reg: u8) -> int __always_unused {
...
#[no_mangle]
pub unsafe extern "C" fn avlink_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> int __always_unused {
...
#[no_mangle]
pub unsafe extern "C" fn cec_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cec_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn infoframe_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn infoframe_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> int __always_unused {
...
#[no_mangle]
pub unsafe extern "C" fn afe_read(sd: *mut v4l2_subdev, reg: u8) -> int __always_unused {
...
#[no_mangle]
pub unsafe extern "C" fn afe_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rep_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rep_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rep_write_clr_set(sd: *mut v4l2_subdev, reg: u8, mask: u8, val: u8) -> c_int {
    static inline int rep_write_clr_set(struct v4l2_subdev *sd, u8 reg, u8 mask, u8 val)
    {
    return rep_write(sd, reg, (rep_read(sd, reg) & ~mask) | val);
    }
#[no_mangle]
pub unsafe extern "C" fn edid_read(sd: *mut v4l2_subdev, reg: u8) -> int __always_unused {
...
#[no_mangle]
pub unsafe extern "C" fn edid_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> int __always_unused {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_set_hpd(state: *mut adv76xx_state, hpd: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_delayed_work_enable_hotplug(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn hdmi_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmi_read16(sd: *mut v4l2_subdev, reg: u8, mask: u16) -> u16 {
    static u16 hdmi_read16(struct v4l2_subdev *sd, u8 reg, u16 mask)
    {
    return ((hdmi_read(sd, reg) << 8) | hdmi_read(sd, reg + 1)) & mask;
    }
#[no_mangle]
pub unsafe extern "C" fn hdmi_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hdmi_write_clr_set(sd: *mut v4l2_subdev, reg: u8, mask: u8, val: u8) -> c_int {
    static inline int hdmi_write_clr_set(struct v4l2_subdev *sd, u8 reg, u8 mask, u8 val)
    {
    return hdmi_write(sd, reg, (hdmi_read(sd, reg) & ~mask) | val);
    }
#[no_mangle]
pub unsafe extern "C" fn test_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> int __always_unused {
...
#[no_mangle]
pub unsafe extern "C" fn cp_read(sd: *mut v4l2_subdev, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cp_read16(sd: *mut v4l2_subdev, reg: u8, mask: u16) -> u16 {
    static u16 cp_read16(struct v4l2_subdev *sd, u8 reg, u16 mask)
    {
    return ((cp_read(sd, reg) << 8) | cp_read(sd, reg + 1)) & mask;
    }
#[no_mangle]
pub unsafe extern "C" fn cp_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cp_write_clr_set(sd: *mut v4l2_subdev, reg: u8, mask: u8, val: u8) -> c_int {
    static inline int cp_write_clr_set(struct v4l2_subdev *sd, u8 reg, u8 mask, u8 val)
    {
    return cp_write(sd, reg, (cp_read(sd, reg) & ~mask) | val);
    }
#[no_mangle]
pub unsafe extern "C" fn vdp_read(sd: *mut v4l2_subdev, reg: u8) -> int __always_unused {
...
#[no_mangle]
pub unsafe extern "C" fn vdp_write(sd: *mut v4l2_subdev, reg: u8, val: u8) -> int __always_unused {
...
pub const ADV76XX_REG_SEQ_TERM: c_uint = 0xffff;

#[no_mangle]
unsafe extern "C" fn adv76xx_read_reg(sd: *mut v4l2_subdev, reg: c_uint) -> c_int {
    static int adv76xx_read_reg(struct v4l2_subdev *sd, unsigned int reg)
    {
    struct adv76xx_state *state = to_state(sd);
    let mut page: c_uint = reg >> 8;
    unsigned int val;
    int err;
...
#[no_mangle]
unsafe extern "C" fn adv76xx_write_reg(sd: *mut v4l2_subdev, reg: c_uint, val: u8) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn is_analog_input(sd: *mut v4l2_subdev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_digital_input(sd: *mut v4l2_subdev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_inv_register(sd: *mut v4l2_subdev) {
...
#[no_mangle]
unsafe extern "C" fn adv7604_read_cable_det(sd: *mut v4l2_subdev) -> c_uint {
    static unsigned int adv7604_read_cable_det(struct v4l2_subdev *sd)
    {
    let mut value: u8 = io_read(sd, 0x6f);
    return ((value & 0x10) >> 4)
    | ((value & 0x08) >> 2)
    | ((value & 0x04) << 0)
    | ((value & 0x02) << 2);
...
#[no_mangle]
unsafe extern "C" fn adv7611_read_cable_det(sd: *mut v4l2_subdev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn adv7612_read_cable_det(sd: *mut v4l2_subdev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_s_detect_tx_5v_ctrl(sd: *mut v4l2_subdev) -> c_int {
    static int adv76xx_s_detect_tx_5v_ctrl(struct v4l2_subdev *sd)
    {
    struct adv76xx_state *state = to_state(sd);
    const struct adv76xx_chip_info *info = state.info;
    let mut cable_det: u16 = info.read_cable_det(sd);
...
// disable embedded syncs for auto graphics mode
    ...
    {
    struct adv76xx_state *state = to_state(sd);
    let mut width: u32 = htotal(bt);
    let mut height: u32 = vtotal(bt);
    let mut cp_start_sav: u16 = bt.hsync + bt.hbackporch - 4;
    let mut cp_start_eav: u16 = width - bt.hfrontporch;
    let mut cp_start_vbi: u16 = height - bt.vfrontporch;
    let mut cp_end_vbi: u16 = bt.vsync + bt.vbackporch;
...
#[no_mangle]
unsafe extern "C" fn adv76xx_set_offset(sd: *mut v4l2_subdev, auto_offset: bool, offset_a: u16, offset_b: u16, offset_c: u16) {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_set_gain(sd: *mut v4l2_subdev, auto_gain: bool, gain_a: u16, gain_b: u16, gain_c: u16) {
    static void adv76xx_set_gain(struct v4l2_subdev *sd, bool auto_gain, u16 gain_a, u16 gain_b, u16 gain_c)
    {
    struct adv76xx_state *state = to_state(sd);
    u8 gain_buf[4];
    let mut gain_man: u8 = 1;
    let mut agc_mode_man: u8 = 1;
    if (auto_gain) {
    gain_man = 0;
    agc_mode_man = 0;
    gain_a = 0x100;
...
#[no_mangle]
unsafe extern "C" fn set_rgb_quantization_range(sd: *mut v4l2_subdev) {
    static void set_rgb_quantization_range(struct v4l2_subdev *sd)
    {
    struct adv76xx_state *state = to_state(sd);
    let mut rgb_output: bool = io_read(sd, 0x02) & 0x02;
    let mut hdmi_signal: bool = hdmi_read(sd, 0x05) & 0x80;
...
#[no_mangle]
unsafe extern "C" fn adv76xx_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_g_volatile_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn no_power(sd: *mut v4l2_subdev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn no_signal_tmds(sd: *mut v4l2_subdev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn no_lock_tmds(sd: *mut v4l2_subdev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn no_lock_sspd(sd: *mut v4l2_subdev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn no_lock_stdi(sd: *mut v4l2_subdev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn no_lock_cp(sd: *mut v4l2_subdev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn in_free_run(sd: *mut v4l2_subdev) -> bool {
    static inline bool in_free_run(struct v4l2_subdev *sd)
    {
    return cp_read(sd, 0xff) & 0x10;
    }
#[no_mangle]
unsafe extern "C" fn adv76xx_g_input_status(sd: *mut v4l2_subdev, status: *mut u32) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stdi_readback {
    pub lcvs: u16 bl, lcf,,
    pub vs_pol: u8 hs_pol,,
    pub interlaced: bool,
}
    ...
    {
    struct adv76xx_state *state = to_state(sd);
    let mut hfreq: u32 = (ADV76XX_FSC * 8) / stdi.bl;
    u32 pix_clk;
    int i;
    ...
    adv76xx_check_dv_timings, core::ptr::null_mut()))
    continue;
...
#[no_mangle]
unsafe extern "C" fn read_stdi(sd: *mut v4l2_subdev, stdi: *mut stdi_readback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7604_read_hdmi_pixelclock(sd: *mut v4l2_subdev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn adv7611_read_hdmi_pixelclock(sd: *mut v4l2_subdev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_read_hdmi_pixelclock(sd: *mut v4l2_subdev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn disable_input(sd: *mut v4l2_subdev) {
...
#[no_mangle]
unsafe extern "C" fn select_input(sd: *mut v4l2_subdev) {
...
//
#[no_mangle]
unsafe extern "C" fn adv76xx_op_ch_sel(state: *mut adv76xx_state) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_setup_format(state: *mut adv76xx_state) {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_cec_tx_raw_status(sd: *mut v4l2_subdev, tx_raw_status: u8) {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_cec_isr(sd: *mut v4l2_subdev, handled: *mut bool) {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_cec_adap_enable(adap: *mut cec_adapter, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_cec_adap_log_addr(adap: *mut cec_adapter, addr: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_isr(sd: *mut v4l2_subdev, status: u32, handled: *mut bool) -> c_int {
    static int adv76xx_isr(struct v4l2_subdev *sd, u32 status, bool *handled)
    {
    struct adv76xx_state *state = to_state(sd);
    const struct adv76xx_chip_info *info = state.info;
    let mut irq_reg_0x43: u8 = io_read(sd, 0x43);
    let mut irq_reg_0x6b: u8 = io_read(sd, 0x6b);
    let mut irq_reg_0x70: u8 = io_read(sd, 0x70);
...
#[no_mangle]
unsafe extern "C" fn adv76xx_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_get_edid(sd: *mut v4l2_subdev, edid: *mut v4l2_edid) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_set_edid(sd: *mut v4l2_subdev, edid: *mut v4l2_edid) -> c_int {
...
// Fall back to a 16:9 aspect ratio
    ...
    err = v4l2_phys_addr_validate(pa, &parent_pa, core::ptr::null_mut());
    if (err)
    return err;
    if (!spa_loc) {
//
...
// Disable hotplug and I2C access to EDID RAM from DDC port
    ...
    let mut mask: u8 = info.edid_spa_loc_msb_mask;
...
#[no_mangle]
unsafe extern "C" fn adv76xx_log_infoframes(sd: *mut v4l2_subdev) {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_log_status(sd: *mut v4l2_subdev) -> c_int {
    ...
    if (is_hdmi(sd)) {
    let mut audio_pll_locked: bool = hdmi_read(sd, 0x04) & 0x01;
    let mut audio_sample_packet_detect: bool = hdmi_read(sd, 0x18) & 0x01;
    let mut audio_mute: bool = io_read(sd, 0x65) & 0x40;
...
#[no_mangle]
unsafe extern "C" fn adv76xx_registered(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_unregistered(sd: *mut v4l2_subdev) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adv76xx_register_map {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_core_init(sd: *mut v4l2_subdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv7604_setup_irqs(sd: *mut v4l2_subdev) {
    static void adv7604_setup_irqs(struct v4l2_subdev *sd)
    {
    io_write(sd, 0x41, 0xd7); /* STDI irq for any change, disable INT2 */
    }
#[no_mangle]
unsafe extern "C" fn adv7611_setup_irqs(sd: *mut v4l2_subdev) {
    static void adv7611_setup_irqs(struct v4l2_subdev *sd)
    {
    io_write(sd, 0x41, 0xd0); /* STDI irq for any change, disable INT2 */
    }
#[no_mangle]
unsafe extern "C" fn adv7612_setup_irqs(sd: *mut v4l2_subdev) {
    static void adv7612_setup_irqs(struct v4l2_subdev *sd)
    {
    io_write(sd, 0x41, 0xd0); /* disable INT2 */
    }
#[no_mangle]
unsafe extern "C" fn adv76xx_unregister_clients(state: *mut adv76xx_state) {
    ...
    struct adv76xx_state *state = to_state(sd);
    struct adv76xx_platform_data *pdata = &state.pdata;
    let mut io_reg: c_uint = 0xf2 + page;
...
#[no_mangle]
unsafe extern "C" fn adv76xx_parse_dt(state: *mut adv76xx_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn configure_regmap(state: *mut adv76xx_state, region: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn configure_regmaps(state: *mut adv76xx_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_reset(state: *mut adv76xx_state) {
...
#[no_mangle]
unsafe extern "C" fn adv76xx_probe(client: *mut i2c_client) -> c_int {
...
// control handlers
    ...
    state.detect_tx_5v_ctrl = v4l2_ctrl_new_std(hdl, core::ptr::null_mut(),
...
// custom controls
    ...
    v4l2_ctrl_new_custom(hdl, &adv7604_ctrl_analog_sampling_phase, core::ptr::null_mut());
    state.free_run_color_manual_ctrl =
    v4l2_ctrl_new_custom(hdl, &adv76xx_ctrl_free_run_color_manual, core::ptr::null_mut());
    state.free_run_color_ctrl =
    v4l2_ctrl_new_custom(hdl, &adv76xx_ctrl_free_run_color, core::ptr::null_mut());
    sd.ctrl_handler = hdl;
    if (hdl.error) {
    err = hdl.error;
    goto err_hdl;
...
// Configure regmaps
    ...
    client.irq,
    core::ptr::null_mut(), adv76xx_irq_handler,
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn adv76xx_remove(client: *mut i2c_client) {
