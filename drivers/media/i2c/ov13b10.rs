...
//! Source: drivers/media/i2c/ov13b10.c
#![no_std]
...
pub const OV13B10_REG_VALUE_08BIT: c_int = 1;
pub const OV13B10_REG_VALUE_16BIT: c_int = 2;
pub const OV13B10_REG_VALUE_24BIT: c_int = 3;
pub const OV13B10_REG_MODE_SELECT: c_uint = 0x0100;
pub const OV13B10_MODE_STANDBY: c_uint = 0x00;
pub const OV13B10_MODE_STREAMING: c_uint = 0x01;
pub const OV13B10_REG_SOFTWARE_RST: c_uint = 0x0103;
pub const OV13B10_SOFTWARE_RST: c_uint = 0x01;
// Chip ID
pub const OV13B10_REG_CHIP_ID: c_uint = 0x300a;
pub const OV13B10_CHIP_ID: c_uint = 0x560d42;
// V_TIMING internal
pub const OV13B10_REG_VTS: c_uint = 0x380e;
pub const OV13B10_VTS_30FPS: c_uint = 0x0c7c;
pub const OV13B10_VTS_60FPS: c_uint = 0x063e;
pub const OV13B10_VTS_120FPS: c_uint = 0x0320;
pub const OV13B10_VTS_MAX: c_uint = 0x7fff;
// Exposure control
pub const OV13B10_REG_EXPOSURE: c_uint = 0x3500;
pub const OV13B10_EXPOSURE_MIN: c_int = 4;
pub const OV13B10_EXPOSURE_STEP: c_int = 1;
pub const OV13B10_EXPOSURE_DEFAULT: c_uint = 0x40;
// Analog gain control
pub const OV13B10_REG_ANALOG_GAIN: c_uint = 0x3508;
pub const OV13B10_ANA_GAIN_MIN: c_uint = 0x80;
pub const OV13B10_ANA_GAIN_MAX: c_uint = 0x07c0;
pub const OV13B10_ANA_GAIN_STEP: c_int = 1;
pub const OV13B10_ANA_GAIN_DEFAULT: c_uint = 0x80;
// Digital gain control
pub const OV13B10_REG_DGTL_GAIN_H: c_uint = 0x350a;
pub const OV13B10_REG_DGTL_GAIN_M: c_uint = 0x350b;
pub const OV13B10_REG_DGTL_GAIN_L: c_uint = 0x350c;

pub const OV13B10_DGTL_GAIN_L_SHIFT: c_int = 6;
pub const OV13B10_DGTL_GAIN_L_MASK: c_uint = 0x3;
pub const OV13B10_DGTL_GAIN_M_SHIFT: c_int = 2;
pub const OV13B10_DGTL_GAIN_M_MASK: c_uint = 0xff;
pub const OV13B10_DGTL_GAIN_H_SHIFT: c_int = 10;
pub const OV13B10_DGTL_GAIN_H_MASK: c_uint = 0x3;
// Test Pattern Control
pub const OV13B10_REG_TEST_PATTERN: c_uint = 0x5080;

pub const OV13B10_TEST_PATTERN_MASK: c_uint = 0xf3;
pub const OV13B10_TEST_PATTERN_BAR_SHIFT: c_int = 2;
// Flip Control
pub const OV13B10_REG_FORMAT1: c_uint = 0x3820;
pub const OV13B10_REG_FORMAT2: c_uint = 0x3821;
// Horizontal Window Offset
pub const OV13B10_REG_H_WIN_OFFSET: c_uint = 0x3811;
// Vertical Window Offset
pub const OV13B10_REG_V_WIN_OFFSET: c_uint = 0x3813;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov13b10_reg {
    pub address: u16,
    pub val: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov13b10_reg_list {
    pub num_of_regs: u32,
    pub regs: *const ov13b10_reg,
}

// Link frequency config
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov13b10_link_freq_config {
    pub link_freq: u64,
// registers for this link frequency
    pub reg_list: ov13b10_reg_list,
}

// Mode : resolution and related config&values
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ov13b10_mode {
// Frame width
    pub width: u32,
// Frame height
    pub height: u32,
...
pub const OV13B10_LINK_FREQ_INDEX_0: c_int = 0;
pub const OV13B10_EXT_CLK: c_int = 19200000;
pub const OV13B10_4_DATA_LANES: c_int = 4;
pub const OV13B10_2_DATA_LANES: c_int = 2;
//
// pixel_rate = data_rate * nr_of_lanes / bits_per_pixel
// data_rate => link_freq * 2; number of lanes => 4 or 2; bits per pixel => 10
//
#[no_mangle]
unsafe extern "C" fn link_freq_to_pixel_rate(f: u64, lanes: u8) -> u64 {
...
pub struct ov13b10 {
    ...
    pub img_clk: *mut clk,
    pub supplies: [regulator_bulk_data; ARRAY_SIZE(ov13b10_supply_names)],
...
// Supported modes
    pub supported_modes: *const ov13b10_mode,
// Current mode
    pub cur_mode: *const ov13b10_mode,
// Mutex for serialized access
    pub mutex: mutex,
    pub supported_modes_num: u8,
// Data lanes used
    pub data_lanes: u8,
...
// Open sub-device
#[no_mangle]
unsafe extern "C" fn ov13b10_open(sd: *mut v4l2_subdev, fh: *mut v4l2_subdev_fh) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_update_digital_gain(ov13b: *mut ov13b10, d_gain: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_enable_test_pattern(ov13b: *mut ov13b10, pattern: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_set_ctrl_hflip(ov13b: *mut ov13b10, ctrl_val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_set_ctrl_vflip(ov13b: *mut ov13b10, ctrl_val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_set_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// Verify chip ID
#[no_mangle]
unsafe extern "C" fn ov13b10_identify_module(ov13b: *mut ov13b10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_power_off(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_power_on(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_start_streaming(ov13b: *mut ov13b10) -> c_int {
...
// Stop streaming
#[no_mangle]
unsafe extern "C" fn ov13b10_stop_streaming(ov13b: *mut ov13b10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_set_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_init_controls(ov13b: *mut ov13b10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_free_controls(ov13b: *mut ov13b10) {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_get_pm_resources(ov13b: *mut ov13b10) -> c_int {
    ...
    ov13b.img_clk = devm_v4l2_sensor_clk_get(ov13b.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ov13b10_check_hwcfg(ov13b: *mut ov13b10) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ov13b10_remove(client: *mut i2c_client) {
    ...
    ov13b10_resume, core::ptr::null_mut());
