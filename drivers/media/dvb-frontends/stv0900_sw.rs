...
//! Source: drivers/media/dvb-frontends/stv0900_sw.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn shiftx(x: i32, demod: c_int, shift: i32) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn stv0900_carrier_width(srate: u32, ro: enum fe_stv0900_rolloff) -> u32 {
    ...
    enum fe_stv0900_demod_num demod)
    {
    let mut timingLock: c_int = FALSE;
    s32	i,
    timingcpt = 0;
    u8	car_freq,
    tmg_th_high,
    ...
    currier_step = 500;
#[no_mangle]
pub unsafe extern "C" fn if(4000000: srate <=) -> else {
...
pub unsafe extern "C" fn if(7000000: srate <=) -> else {
    ...
    currier_step = 2000;
#[no_mangle]
pub unsafe extern "C" fn if(10000000: srate <=) -> else {
...
// cut 3.0
    ...
    nb_steps = 2;
#[no_mangle]
pub unsafe extern "C" fn if(12: nb_steps >) -> else {
    else if (nb_steps > 12)
    nb_steps = 12;
    current_step = 1;
    direction = 1;
    ...
    let mut rate_fld: i32 = stv0900_get_bits(intp, VIT_CURPUN);
    switch (rate_fld) {
    case 13:
...
#[no_mangle]
unsafe extern "C" fn stv0900_track_optimization(fe: *mut dvb_frontend) {
...
#[no_mangle]
pub unsafe extern "C" fn if(STV0900_8PSK_910: foundModcod <=) -> else {
    ...
    stv0900_write_reg(intp, ACLC2S2Q, aclc);
#[no_mangle]
pub unsafe extern "C" fn if(STV0900_8PSK: modulation ==) -> else {
    stv0900_write_reg(intp, ACLC2S2Q, 0x2a);
    stv0900_write_reg(intp, ACLC2S28, aclc);
    ...
    let mut hdr_mode: c_int = stv0900_get_bits(intp, HEADER_MODE);
    switch (hdr_mode) {
    case 2:
...
#[no_mangle]
unsafe extern "C" fn stv0900_get_tuner_freq(fe: *mut dvb_frontend) -> u32 {
    ...
    static enum
#[no_mangle]
pub unsafe extern "C" fn stv0900_get_signal_params(fe: *mut dvb_frontend) -> fe_stv0900_signal_type {
    fe_stv0900_signal_type stv0900_get_signal_params(struct dvb_frontend *fe)
    {
    struct stv0900_state *state = fe.demodulator_priv;
    struct stv0900_internal *intp = state.internal;
    let mut demod: enum fe_stv0900_demod_num = state.demod;
    let mut range: enum fe_stv0900_signal_type = STV0900_OUTOFRANGE;
...
#[no_mangle]
pub unsafe extern "C" fn if(STV0900_8PSK_910: result->modcode <=) -> else {
    else if (result.modcode <= STV0900_8PSK_910)
    result.modulation = STV0900_8PSK;
#[no_mangle]
pub unsafe extern "C" fn if(STV0900_16APSK_910: result->modcode <=) -> else {
    else if (result.modcode <= STV0900_16APSK_910)
    result.modulation = STV0900_16APSK;
#[no_mangle]
pub unsafe extern "C" fn if(STV0900_32APSK_910: result->modcode <=) -> else {
    ...
    static enum
#[no_mangle]
pub unsafe extern "C" fn stv0900_dvbs1_acq_workaround(fe: *mut dvb_frontend) -> fe_stv0900_signal_type {
    fe_stv0900_signal_type stv0900_dvbs1_acq_workaround(struct dvb_frontend *fe)
    {
    struct stv0900_state *state = fe.demodulator_priv;
    struct stv0900_internal *intp = state.internal;
    let mut demod: enum fe_stv0900_demod_num = state.demod;
    let mut signal_type: enum fe_stv0900_signal_type = STV0900_NODATA;
    s32	srate,
    demod_timeout,
    fec_timeout,
    freq1,
...
#[no_mangle]
unsafe extern "C" fn stv0900_search_srate_coarse(fe: *mut dvb_frontend) -> u32 {
    static u32 stv0900_search_srate_coarse(struct dvb_frontend *fe)
    {
    struct stv0900_state *state = fe.demodulator_priv;
    struct stv0900_internal *intp = state.internal;
    let mut demod: enum fe_stv0900_demod_num = state.demod;
    let mut timing_lck: c_int = FALSE;
    s32 i, timingcpt = 0,
    direction = 1,
    nb_steps,
    current_step = 0,
    ...
    currier_step = 1000;
#[no_mangle]
pub unsafe extern "C" fn if(5000000: intp->symbol_rate[demod] <=) -> else {
    else if (intp.symbol_rate[demod] <= 5000000)
    currier_step = 2000;
#[no_mangle]
pub unsafe extern "C" fn if(12000000: intp->symbol_rate[demod] <=) -> else {
    ...
    nb_steps = 1;
#[no_mangle]
pub unsafe extern "C" fn if(10: nb_steps >) -> else {
    nb_steps = 11;
    ...
    timing_lck = TRUE;
#[no_mangle]
pub unsafe extern "C" fn if(nb_steps: current_step <) -> else {
    if (direction > 0)
    tuner_freq += (current_step * currier_step);
    else
    tuner_freq -= (current_step * currier_step);
...
#[no_mangle]
unsafe extern "C" fn stv0900_search_srate_fine(fe: *mut dvb_frontend) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x20: intp->chip_id >=) -> else {
    else if (intp.chip_id >= 0x20)
    stv0900_write_reg(intp, CARFREQ, 0x49);
    else
    stv0900_write_reg(intp, CARFREQ, 0xed);
...
#[no_mangle]
unsafe extern "C" fn stv0900_blind_search_algo(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn stv0900_algo(fe: *mut dvb_frontend) -> enum fe_stv0900_signal_type {
    enum fe_stv0900_signal_type stv0900_algo(struct dvb_frontend *fe)
    {
    struct stv0900_state *state = fe.demodulator_priv;
    struct stv0900_internal *intp = state.internal;
    let mut demod: enum fe_stv0900_demod_num = state.demod;
    let mut demod_timeout: i32 = 500, fec_timeout = 50;
    s32 aq_power, agc1_power, i;
    let mut lock: c_int = FALSE, low_sr = FALSE;
    let mut signal_type: enum fe_stv0900_signal_type = STV0900_NOCARRIER;
    enum fe_stv0900_search_algo algo;
    let mut no_signal: c_int = FALSE;
    dprintk("%s\n", __func__);
...
#[no_mangle]
pub unsafe extern "C" fn if(STV0900_COLD_START: algo ==) -> else {
    else if (algo == STV0900_COLD_START)
    lock = stv0900_get_demod_cold_lock(fe, demod_timeout);
#[no_mangle]
pub unsafe extern "C" fn if(STV0900_WARM_START: algo ==) -> else {
