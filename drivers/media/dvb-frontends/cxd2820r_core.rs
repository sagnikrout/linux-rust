...
//! Source: drivers/media/dvb-frontends/cxd2820r_core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cxd2820r_gpio(fe: *mut dvb_frontend, gpio: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd2820r_set_frontend(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd2820r_read_status(fe: *mut dvb_frontend, status: *mut enum fe_status) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd2820r_read_ber(fe: *mut dvb_frontend, ber: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd2820r_read_signal_strength(fe: *mut dvb_frontend, strength: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd2820r_read_snr(fe: *mut dvb_frontend, snr: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd2820r_read_ucblocks(fe: *mut dvb_frontend, ucblocks: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd2820r_init(fe: *mut dvb_frontend) -> c_int {
    static int cxd2820r_init(struct dvb_frontend *fe)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn cxd2820r_sleep(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd2820r_search(fe: *mut dvb_frontend) -> enum dvbfe_search {
    ...
    struct dtv_frontend_properties *c = &fe.dtv_property_cache;
    int ret, i;
    let mut status: enum fe_status = 0;
    dev_dbg(&client.dev, "delivery_system=%d\n", c.delivery_system);
...
#[no_mangle]
unsafe extern "C" fn cxd2820r_get_frontend_algo(fe: *mut dvb_frontend) -> enum dvbfe_algo {
    static enum dvbfe_algo cxd2820r_get_frontend_algo(struct dvb_frontend *fe)
    {
    return DVBFE_ALGO_CUSTOM;
    }
#[no_mangle]
unsafe extern "C" fn cxd2820r_release(fe: *mut dvb_frontend) {
...
#[no_mangle]
unsafe extern "C" fn cxd2820r_i2c_gate_ctrl(fe: *mut dvb_frontend, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd2820r_gpio_set(chip: *mut gpio_chip, nr: c_uint, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd2820r_gpio_get(chip: *mut gpio_chip, nr: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd2820r_probe(client: *mut i2c_client) -> c_int {
...
// Create dvb frontend
    ...
    priv.fe.ops.release = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cxd2820r_remove(client: *mut i2c_client) {
