...
//! Source: drivers/media/dvb-frontends/cxd2880/cxd2880_top.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cxd2880_priv {
    pub tnrdmd: cxd2880_tnrdmd,
    pub spi: *mut spi_device,
    pub regio: cxd2880_io,
    pub spi_device: cxd2880_spi_device,
    pub cxd2880_spi: cxd2880_spi,
    pub dvbt_tune_param: cxd2880_dvbt_tune_param,
    pub dvbt2_tune_param: cxd2880_dvbt2_tune_param,
    pub /: *mut *mut *mut mutex spi_mutex; / For SPI access exclusive control,
    pub pre_ber_update: c_ulong,
    pub pre_ber_interval: c_ulong,
    pub post_ber_update: c_ulong,
    pub post_ber_interval: c_ulong,
    pub ucblock_update: c_ulong,
    pub ucblock_interval: c_ulong,
    pub s: enum fe_status,
}
...
// pre_bit_count = ((rdata[0] & 0x07) == 0) ?
    ...
    u32 *pre_bit_count)
    {
    let mut period_exp: u32 = 0;
    let mut n_ldpc: u32 = 0;
    u8 data[5];
    int ret;
    if (!tnrdmd || !pre_bit_err || !pre_bit_count)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn cxd2880_release(fe: *mut dvb_frontend) {
    static void cxd2880_release(struct dvb_frontend *fe)
    {
    struct cxd2880_priv *priv = core::ptr::null_mut();
    if (!fe) {
    pr_err("invalid arg.\n");
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn cxd2880_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd2880_sleep(fe: *mut dvb_frontend) -> c_int {
    ...
    int ret;
    struct cxd2880_priv *priv = core::ptr::null_mut();
    struct dtv_frontend_properties *c = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cxd2880_read_snr(fe: *mut dvb_frontend, snr: *mut u16) -> c_int {
    static int cxd2880_read_snr(struct dvb_frontend *fe, u16 *snr)
    {
    int ret;
    let mut snrvalue: c_int = 0;
    struct cxd2880_priv *priv = core::ptr::null_mut();
    struct dtv_frontend_properties *c = core::ptr::null_mut();
    if (!fe || !snr) {
    pr_err("invalid arg\n");
...
#[no_mangle]
unsafe extern "C" fn cxd2880_read_ucblocks(fe: *mut dvb_frontend, ucblocks: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd2880_read_ber(fe: *mut dvb_frontend, ber: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd2880_set_ber_per_period_t(fe: *mut dvb_frontend) -> c_int {
    ...
    let mut pre_ber_rate: u32 = 0;
    let mut post_ber_rate: u32 = 0;
    let mut ucblock_rate: u32 = 0;
    let mut mes_exp: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn cxd2880_set_ber_per_period_t2(fe: *mut dvb_frontend) -> c_int {
    ...
    let mut bw: enum cxd2880_dtv_bandwidth = CXD2880_DTV_BW_1_7_MHZ;
    let mut pre_ber_rate: u32 = 0;
    let mut post_ber_rate: u32 = 0;
    let mut ucblock_rate: u32 = 0;
    let mut mes_exp: u32 = 0;
    let mut term_a: u32 = 0;
    let mut term_b: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn cxd2880_set_frontend(fe: *mut dvb_frontend) -> c_int {
    ...
    struct cxd2880_priv *priv = core::ptr::null_mut();
    struct dtv_frontend_properties *c = core::ptr::null_mut();
    let mut pre_bit_err: u32 = 0, pre_bit_count = 0;
    let mut post_bit_err: u32 = 0, post_bit_count = 0;
    let mut block_err: u32 = 0, block_count = 0;
    int ret;
    if (!fe) {
    pr_err("invalid arg\n");
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn cxd2880_check_l1post_plp(fe: *mut dvb_frontend) -> c_int {
...
// delay = HZ / 5;
    ...
    int ret;
    struct cxd2880_priv *priv = core::ptr::null_mut();
    let mut mode: enum cxd2880_dvbt_mode = CXD2880_DVBT_MODE_2K;
    let mut guard: enum cxd2880_dvbt_guard = CXD2880_DVBT_GUARD_1_32;
...
#[no_mangle]
unsafe extern "C" fn cxd2880_get_frontend_algo(fe: *mut dvb_frontend) -> enum dvbfe_algo {
