...
//! Source: drivers/media/dvb-frontends/stb0899_algo.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn stb0899_do_div(n: u64, d: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_calc_srate(master_clk: u32, sfr: *mut u8) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_get_srate(state: *mut stb0899_state) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_set_srate(state: *mut stb0899_state, master_clk: u32, srate: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_calc_derot_time(srate: c_long) -> c_long {
...
//
#[no_mangle]
pub unsafe extern "C" fn stb0899_carr_width(state: *mut stb0899_state) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_first_subrange(state: *mut stb0899_state) {
    static void stb0899_first_subrange(struct stb0899_state *state)
    {
    struct stb0899_internal *internal	= &state.internal;
    struct stb0899_params *params		= &state.params;
    struct stb0899_config *config		=  state.config;
    let mut range: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_check_tmg(state: *mut stb0899_state) -> enum stb0899_status {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_search_tmg(state: *mut stb0899_state) -> enum stb0899_status {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_check_carrier(state: *mut stb0899_state) -> enum stb0899_status {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_search_carrier(state: *mut stb0899_state) -> enum stb0899_status {
    static enum stb0899_status stb0899_search_carrier(struct stb0899_state *state)
    {
    struct stb0899_internal *internal = &state.internal;
    let mut derot_freq: short int = 0, last_derot_freq = 0, derot_limit, next_loop = 3;
    let mut index: c_int = 0;
    u8 cfr[2] = {0};
    u8 reg;
    internal.status = NOCARRIER;
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_check_data(state: *mut stb0899_state) -> enum stb0899_status {
    static enum stb0899_status stb0899_check_data(struct stb0899_state *state)
    {
    struct stb0899_internal *internal = &state.internal;
    struct stb0899_params *params = &state.params;
    let mut lock: c_int = 0, index = 0, dataTime = 500, loop;
    u8 reg;
...
// RESET FEC
    ...
    dataTime = 2000;
#[no_mangle]
pub unsafe extern "C" fn if(5000000: params->srate <=) -> else {
    else if (params.srate <= 5000000)
    dataTime = 1500;
#[no_mangle]
pub unsafe extern "C" fn if(15000000: params->srate <=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_search_data(state: *mut stb0899_state) -> enum stb0899_status {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_check_range(state: *mut stb0899_state) -> enum stb0899_status {
...
//
#[no_mangle]
unsafe extern "C" fn next_sub_range(state: *mut stb0899_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn stb0899_dvbs_algo(state: *mut stb0899_state) -> enum stb0899_status {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_config_uwp(state: *mut stb0899_state) {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_config_csm_auto(state: *mut stb0899_state) {
...
#[no_mangle]
unsafe extern "C" fn Log2Int(number: c_int) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_calc_srate(state: *mut stb0899_state) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_calc_dev(state: *mut stb0899_state) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_set_srate(state: *mut stb0899_state) {
...
// (FSamp/Fsymbol *100) for integer Calculation
    ...
    anti_alias = 0;
#[no_mangle]
pub unsafe extern "C" fn if(4250: f_sym <=) -> else {
    else if (f_sym <= 4250)
    anti_alias = 1;
    else
    anti_alias = 2;
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_set_btr_loopbw(state: *mut stb0899_state) {
    static void stb0899_dvbs2_set_btr_loopbw(struct stb0899_state *state)
    {
    struct stb0899_internal *internal	= &state.internal;
    struct stb0899_config *config		= state.config;
    let mut sym_peak: u32 = 23, zeta = 707, loopbw_percent = 60;
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_set_carr_freq(state: *mut stb0899_state, carr_freq: i32, master_clk: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_init_calc(state: *mut stb0899_state) {
...
// initialize BTR
    ...
    step_size = (1 << 17) / 5;
#[no_mangle]
pub unsafe extern "C" fn if(10: internal->srate / 1000000 >=) -> else {
    else if (internal.srate / 1000000 >= 10)
    step_size = (1 << 17) / 7;
#[no_mangle]
pub unsafe extern "C" fn if(5: internal->srate / 1000000 >=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_btr_init(state: *mut stb0899_state) {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_reacquire(state: *mut stb0899_state) {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_get_dmd_status(state: *mut stb0899_state, timeout: c_int) -> enum stb0899_status {
    static enum stb0899_status stb0899_dvbs2_get_dmd_status(struct stb0899_state *state, int timeout)
    {
    let mut time: c_int = -10, lock = 0, uwp, csm;
    u32 reg;
    do {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_get_data_lock(state: *mut stb0899_state, timeout: c_int) -> c_int {
    static int stb0899_dvbs2_get_data_lock(struct stb0899_state *state, int timeout)
    {
    let mut time: c_int = 0, lock = 0;
    u8 reg;
    while ((!lock) && (time < timeout)) {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_get_fec_status(state: *mut stb0899_state, timeout: c_int) -> enum stb0899_status {
    static enum stb0899_status stb0899_dvbs2_get_fec_status(struct stb0899_state *state, int timeout)
    {
    let mut time: c_int = 0, Locked;
    do {
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_init_csm(state: *mut stb0899_state, pilots: c_int, modcod: enum stb0899_modcod) {
    static void stb0899_dvbs2_init_csm(struct stb0899_state *state, int pilots, enum stb0899_modcod modcod)
    {
    struct stb0899_internal *internal = &state.internal;
    let mut dvt_tbl: i32 = 1, two_pass = 0, agc_gain = 6, agc_shift = 0, loop_shift = 0, phs_diff_thr = 0x80;
...
//
#[no_mangle]
unsafe extern "C" fn stb0899_dvbs2_get_srate(state: *mut stb0899_state) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn stb0899_dvbs2_algo(state: *mut stb0899_state) -> enum stb0899_status {
