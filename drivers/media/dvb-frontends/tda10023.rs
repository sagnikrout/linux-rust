...
//! Source: drivers/media/dvb-frontends/tda10023.c
#![no_std]
...
pub const REG0_INIT_VAL: c_uint = 0x23;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tda10023_state {
    pub i2c: *mut *mut i2c_adapter,
// configuration settings
    pub config: *const tda10023_config,
...
// Macro flag: #define dprintk(x...)
    static int verbose;
#[no_mangle]
unsafe extern "C" fn tda10023_readreg(state: *mut *mut tda10023_state, reg: u8) -> u8 {
    ...
    if (ret != 2) {
    let mut num: c_int = state.frontend.dvb ? state.frontend.dvb.num : -1;
...
#[no_mangle]
unsafe extern "C" fn tda10023_writereg(state: *mut *mut tda10023_state, reg: u8, data: u8) -> c_int {
    static int tda10023_writereg (struct tda10023_state* state, u8 reg, u8 data)
    {
    u8 buf[] = { reg, data };
    let mut msg: i2c_msg = { .addr = state.config.demod_address, .flags = 0, .buf = buf, .len = 2 };
    int ret;
...
#[no_mangle]
unsafe extern "C" fn tda10023_writebit(state: *mut *mut tda10023_state, reg: u8, mask: u8, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda10023_writetab(state: *mut *mut tda10023_state, tab: *mut *mut u8) {
...
// get access to tuner
#[no_mangle]
unsafe extern "C" fn lock_tuner(state: *mut *mut tda10023_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unlock_tuner(state: *mut *mut tda10023_state) -> c_int {
    static int unlock_tuner(struct tda10023_state* state)
    {
    u8 buf[2] = { 0x0f, 0x40 };
    let mut msg_post: i2c_msg = {.addr=state.config.demod_address, .flags=0, .buf=buf, .len=2};
...
#[no_mangle]
unsafe extern "C" fn tda10023_setup_reg0(state: *mut *mut tda10023_state, reg0: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda10023_set_symbolrate(state: *mut *mut tda10023_state, sr: u32) -> c_int {
...
// avoid floating point operations multiplying syscloc and divider
    by 10 */
    let mut sysclk_x_10: u32 = state.sysclk * 10;
...
#[no_mangle]
unsafe extern "C" fn tda10023_init(fe: *mut dvb_frontend) -> c_int {
    static int tda10023_init (struct dvb_frontend *fe)
    {
    let mut state: *mut tda10023_state = fe.demodulator_priv;
    u8 tda10023_inittab[] = {
// reg  mask val
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qam_params {
    pub eragnyq_thd: u8 qam, lockthr, mseth, aref, agcrefnyq,,
}

#[no_mangle]
unsafe extern "C" fn tda10023_set_parameters(fe: *mut dvb_frontend) -> c_int {
    static int tda10023_set_parameters(struct dvb_frontend *fe)
    {
    struct dtv_frontend_properties *c = &fe.dtv_property_cache;
    let mut delsys: u32 = c.delivery_system;
    let mut qam: unsigned = c.modulation;
    bool is_annex_c;
    let mut state: *mut tda10023_state = fe.demodulator_priv;
...
#[no_mangle]
unsafe extern "C" fn tda10023_read_ber(fe: *mut *mut dvb_frontend, ber: *mut *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda10023_read_signal_strength(fe: *mut *mut dvb_frontend, strength: *mut *mut u16) -> c_int {
    static int tda10023_read_signal_strength(struct dvb_frontend* fe, u16* strength)
    {
    let mut state: *mut tda10023_state = fe.demodulator_priv;
    let mut ifgain: u8 = tda10023_readreg(state, 0x2f);
    let mut gain: u16 = ((255-tda10023_readreg(state, 0x17))) + (255-ifgain)/16;
...
#[no_mangle]
unsafe extern "C" fn tda10023_read_snr(fe: *mut *mut dvb_frontend, snr: *mut *mut u16) -> c_int {
    static int tda10023_read_snr(struct dvb_frontend* fe, u16* snr)
    {
    let mut state: *mut tda10023_state = fe.demodulator_priv;
    let mut quality: u8 = ~tda10023_readreg(state, 0x18);
// snr = (quality << 8) | quality;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tda10023_read_ucblocks(fe: *mut *mut dvb_frontend, ucblocks: *mut *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda10023_sleep(fe: *mut *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda10023_i2c_gate_ctrl(fe: *mut *mut dvb_frontend, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda10023_release(fe: *mut *mut dvb_frontend) {
    ...
    u8 pwm)
    {
    let mut state: *mut tda10023_state = core::ptr::null_mut();
// allocate memory for the internal state
    state = kzalloc_obj(struct tda10023_state);
    if (state == core::ptr::null_mut()) goto error;
// setup the state
    state.config = config;
    state.i2c = i2c;
