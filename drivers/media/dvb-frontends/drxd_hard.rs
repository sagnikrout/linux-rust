...
//! Source: drivers/media/dvb-frontends/drxd_hard.c
#![no_std]
...
pub const CHUNK_SIZE: c_int = 48;
pub const DRX_I2C_RMW: c_uint = 0x10;
pub const DRX_I2C_BROADCAST: c_uint = 0x20;
pub const DRX_I2C_CLEARCRC: c_uint = 0x80;
pub const DRX_I2C_SINGLE_MASTER: c_uint = 0xC0;
pub const DRX_I2C_MODEFLAGS: c_uint = 0xC0;
pub const DRX_I2C_FLAGS: c_uint = 0xF0;
pub const DEFAULT_LOCK_TIMEOUT: c_int = 1100;
pub const DRX_CHANNEL_AUTO: c_int = 0;
pub const DRX_CHANNEL_HIGH: c_int = 1;
pub const DRX_CHANNEL_LOW: c_int = 2;
pub const DRX_LOCK_MPEG: c_int = 1;
pub const DRX_LOCK_FEC: c_int = 2;
pub const DRX_LOCK_DEMOD: c_int = 4;
//
    enum CSCDState {
    CSCD_INIT = 0,
    CSCD_SET,
...
#[derive(Copy, Clone)]
pub struct SCfgAgc {
    pub ctrlMode: enum AGC_CTRL_MODE,
    pub /: *mut *mut u16 outputLevel; / range [0, ... , 1023], 1/n of fullscale range,
    pub /: *mut *mut u16 settleLevel; / range [0, ... , 1023], 1/n of fullscale range,
    pub /: *mut *mut u16 minOutputLevel; / range [0, ... , 1023], 1/n of fullscale range,
    pub /: *mut *mut u16 maxOutputLevel; / range [0, ... , 1023], 1/n of fullscale range,
    pub /: *mut *mut u16 speed; / range [0, ... , 1023], 1/n of fullscale range,
    pub R1: u16,
    pub R2: u16,
    pub R3: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct SNoiseCal {
    pub cpOpt: c_int,
    pub cpNexpOfs: c_short,
    pub tdCal2k: c_short,
    pub tdCal8k: c_short,
}
...
pub struct drxd_state {
    ...
    pub priv: *mut c_void,
    pub config: drxd_config,
    pub i2c_access: c_int,
    pub init_done: c_int,
    pub mutex: mutex,
    pub chip_adr: u8,
    pub hi_cfg_timing_div: u16,
    pub hi_cfg_bridge_delay: u16,
    pub hi_cfg_wakeup_key: u16,
    pub hi_cfg_ctrl: u16,
    pub intermediate_freq: u16,
    pub osc_clock_freq: u16,
    pub cscd_state: enum CSCDState,
    pub drxd_state: enum CDrxdState,
    pub sys_clock_freq: u16,
    pub osc_clock_deviation: i16,
    pub expected_sys_clock_freq: u16,
    pub insert_rs_byte: u16,
    pub enable_parallel: u16,
    pub operation_mode: c_int,
    pub if_agc_cfg: SCfgAgc,
    pub rf_agc_cfg: SCfgAgc,
    pub noise_cal: SNoiseCal,
    pub fe_fs_add_incr: u32,
    pub org_fe_fs_add_incr: u32,
    pub current_fe_if_incr: u16,
    pub m_FeAgRegAgPwd: u16,
    pub m_FeAgRegAgAgcSio: u16,
    pub m_EcOcRegOcModeLop: u16,
    pub m_EcOcRegSncSncLvl: u16,
    pub m_InitAtomicRead: *mut u8,
    pub m_HiI2cPatch: *mut u8,
    pub m_ResetCEFR: *mut u8,
    pub m_InitFE_1: *mut u8,
    pub m_InitFE_2: *mut u8,
    pub m_InitCP: *mut u8,
    pub m_InitCE: *mut u8,
    pub m_InitEQ: *mut u8,
    pub m_InitSC: *mut u8,
    pub m_InitEC: *mut u8,
    pub m_ResetECRAM: *mut u8,
    pub m_InitDiversityFront: *mut u8,
    pub m_InitDiversityEnd: *mut u8,
    pub m_DisableDiversity: *mut u8,
    pub m_StartDiversityFront: *mut u8,
    pub m_StartDiversityEnd: *mut u8,
    pub m_DiversityDelay8MHZ: *mut u8,
    pub m_DiversityDelay6MHZ: *mut u8,
    pub microcode: *mut u8,
    pub microcode_length: u32,
    pub type_A: c_int,
    pub PGA: c_int,
    pub diversity: c_int,
    pub tuner_mirrors: c_int,
    pub app_env_default: enum app_env,
    pub app_env_diversity: enum app_env,
}
...
//
#[no_mangle]
unsafe extern "C" fn i2c_write(adap: *mut i2c_adapter, adr: u8, data: *mut *mut u8, len: c_int) -> c_int {
    static int i2c_write(struct i2c_adapter *adap, u8 adr, u8 * data, int len)
    {
    let mut msg: i2c_msg = {.addr = adr, .flags = 0, .buf = data, .len = len };
...
#[no_mangle]
pub unsafe extern "C" fn MulDiv32(a: u32, b: u32, c: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn Read16(state: *mut drxd_state, reg: u32, data: *mut u16, flags: u8) -> c_int {
    static int Read16(struct drxd_state *state, u32 reg, u16 *data, u8 flags)
    {
    let mut adr: u8 = state.config.demod_address;
...
#[no_mangle]
unsafe extern "C" fn Read32(state: *mut drxd_state, reg: u32, data: *mut u32, flags: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn Write16(state: *mut drxd_state, reg: u32, data: u16, flags: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn Write32(state: *mut drxd_state, reg: u32, data: u32, flags: u8) -> c_int {
    ...
    {
    while (BlockSize > 0) {
    let mut Chunk: u16 = BlockSize > CHUNK_SIZE ? CHUNK_SIZE : BlockSize;
...
#[no_mangle]
unsafe extern "C" fn WriteTable(state: *mut drxd_state, pTable: *mut *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ResetCEFR(state: *mut drxd_state) -> c_int {
    static int ResetCEFR(struct drxd_state *state)
    {
    return WriteTable(state, state.m_ResetCEFR);
    }
#[no_mangle]
unsafe extern "C" fn InitCP(state: *mut drxd_state) -> c_int {
    static int InitCP(struct drxd_state *state)
    {
    return WriteTable(state, state.m_InitCP);
    }
#[no_mangle]
unsafe extern "C" fn InitCE(state: *mut drxd_state) -> c_int {
    static int InitCE(struct drxd_state *state)
    {
    int status;
    let mut AppEnv: enum app_env = state.app_env_default;
    do {
...
#[no_mangle]
unsafe extern "C" fn StopOC(state: *mut drxd_state) -> c_int {
    static int StopOC(struct drxd_state *state)
    {
    let mut status: c_int = 0;
    let mut ocSyncLvl: u16 = 0;
    let mut ocModeLop: u16 = state.m_EcOcRegOcModeLop;
    let mut dtoIncLop: u16 = 0;
    let mut dtoIncHip: u16 = 0;
    do {
...
#[no_mangle]
unsafe extern "C" fn StartOC(state: *mut drxd_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn DRX_GetLockStatus(state: *mut drxd_state, pLockStatus: *mut *mut u32) -> c_int {
    static int DRX_GetLockStatus(struct drxd_state *state, u32 * pLockStatus)
    {
    let mut ScRaRamLock: u16 = 0;
    ...
    SC_RA_RAM_LOCK_DEMOD__M);
    let mut demod_lock_mask: u16 = SC_RA_RAM_LOCK_DEMOD__M;
    int status;
// pLockStatus = 0;
...
//
#[no_mangle]
unsafe extern "C" fn SetCfgIfAgc(state: *mut drxd_state, cfg: *mut SCfgAgc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn SetCfgRfAgc(state: *mut drxd_state, cfg: *mut SCfgAgc) -> c_int {
    ...
    if (cfg.ctrlMode == AGC_CTRL_USER) {
    do {
    let mut AgModeLop: u16 = 0;
    let mut level: u16 = (cfg.outputLevel);
...
#[no_mangle]
unsafe extern "C" fn ReadIFAgc(state: *mut drxd_state, pValue: *mut *mut u32) -> c_int {
...
// 3.3V
    ...
    GND
//
    let mut R1: u32 = state.if_agc_cfg.R1;
    let mut R2: u32 = state.if_agc_cfg.R2;
    let mut R3: u32 = state.if_agc_cfg.R3;
...
#[no_mangle]
unsafe extern "C" fn load_firmware(state: *mut drxd_state, fw_name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn HI_Command(state: *mut drxd_state, cmd: u16, pResult: *mut *mut u16) -> c_int {
    static int HI_Command(struct drxd_state *state, u16 cmd, u16 * pResult)
    {
    let mut nrRetries: u32 = 0;
    int status;
    ...
    status = Read16(state, HI_RA_RAM_SRV_CMD__A, core::ptr::null_mut(), 0);
    } while (status != 0);
    if (status >= 0)
...
#[no_mangle]
unsafe extern "C" fn HI_CfgCommand(state: *mut drxd_state) -> c_int {
    ...
    status = HI_Command(state, HI_RA_RAM_SRV_CMD_CONFIG, core::ptr::null_mut());
    mutex_unlock(&state.mutex);
    return status;
    }
#[no_mangle]
unsafe extern "C" fn InitHI(state: *mut drxd_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn HI_ResetCommand(state: *mut drxd_state) -> c_int {
    ...
    if (status == 0)
    status = HI_Command(state, HI_RA_RAM_SRV_CMD_RESET, core::ptr::null_mut());
    mutex_unlock(&state.mutex);
    msleep(1);
    return status;
    }
#[no_mangle]
unsafe extern "C" fn DRX_ConfigureI2CBridge(state: *mut drxd_state, bEnableBridge: c_int) -> c_int {
...
pub const HI_TR_WRITE: c_uint = 0x9;
pub const HI_TR_READ: c_uint = 0xA;
pub const HI_TR_READ_WRITE: c_uint = 0xB;
pub const HI_TR_BROADCAST: c_uint = 0x4;
...
#[no_mangle]
unsafe extern "C" fn StopAllProcessors(state: *mut drxd_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn EnableAndResetMB(state: *mut drxd_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn InitCC(state: *mut drxd_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ResetECOD(state: *mut drxd_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn SetCfgPga(state: *mut drxd_state, pgaSwitch: c_int) -> c_int {
    static int SetCfgPga(struct drxd_state *state, int pgaSwitch)
    {
    int status;
    let mut AgModeLop: u16 = 0;
    let mut AgModeHip: u16 = 0;
    do {
    if (pgaSwitch) {
// PGA on
// fine gain
...
#[no_mangle]
unsafe extern "C" fn InitFE(state: *mut drxd_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn InitFT(state: *mut drxd_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn SC_WaitForReady(state: *mut drxd_state) -> c_int {
    static int SC_WaitForReady(struct drxd_state *state)
    {
    int i;
    for (i = 0; i < DRXD_MAX_RETRIES; i += 1) {
    let mut status: c_int = Read16(state, SC_RA_RAM_CMD__A, core::ptr::null_mut(), 0);
    if (status == 0)
    return status;
    }
    return -1;
...
#[no_mangle]
unsafe extern "C" fn SC_SendCommand(state: *mut drxd_state, cmd: u16) -> c_int {
    static int SC_SendCommand(struct drxd_state *state, u16 cmd)
    {
    let mut status: c_int = 0, ret;
    u16 errCode;
...
#[no_mangle]
unsafe extern "C" fn SC_GetOpParamCommand(state: *mut drxd_state, result: *mut *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ConfigureMPEGOutput(state: *mut drxd_state, bEnableOutput: c_int) -> c_int {
    static int ConfigureMPEGOutput(struct drxd_state *state, int bEnableOutput)
    {
    int status;
    do {
    let mut EcOcRegIprInvMpg: u16 = 0;
    let mut EcOcRegOcModeLop: u16 = 0;
    let mut EcOcRegOcModeHip: u16 = 0;
    let mut EcOcRegOcMpgSio: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn SetDeviceTypeId(state: *mut drxd_state) -> c_int {
    static int SetDeviceTypeId(struct drxd_state *state)
    {
    let mut status: c_int = 0;
    let mut deviceId: u16 = 0;
    do {
...
// Init Table selection
    ...
    state.m_ResetCEFR = core::ptr::null_mut();
    ...
    state.m_InitDiversityFront = core::ptr::null_mut();
    state.m_InitDiversityEnd = core::ptr::null_mut();
    state.m_DisableDiversity = core::ptr::null_mut();
    state.m_StartDiversityFront = core::ptr::null_mut();
    state.m_StartDiversityEnd = core::ptr::null_mut();
    state.m_DiversityDelay8MHZ = core::ptr::null_mut();
    state.m_DiversityDelay6MHZ = core::ptr::null_mut();
    }
    return status;
    }
#[no_mangle]
unsafe extern "C" fn CorrectSysClockDeviation(state: *mut drxd_state) -> c_int {
    static int CorrectSysClockDeviation(struct drxd_state *state)
    {
    int status;
    let mut incr: i32 = 0;
    let mut nomincr: i32 = 0;
    let mut bandwidth: u32 = 0;
    let mut sysClockInHz: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn DRX_Stop(state: *mut drxd_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn SetOperationMode(state: *mut drxd_state, oMode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn StartDiversity(state: *mut drxd_state) -> c_int {
...
// combining enabled
    ...
    {
    let mut negativeShift: c_int = (state.tuner_mirrors == channelMirrored);
...
#[no_mangle]
unsafe extern "C" fn DRX_Start(state: *mut drxd_state, off: i32) -> c_int {
    static int DRX_Start(struct drxd_state *state, s32 off)
    {
    struct dtv_frontend_properties *p = &state.props;
    int status;
    let mut transmissionParams: u16 = 0;
    let mut operationMode: u16 = 0;
    let mut qpskTdTpsPwr: u16 = 0;
    let mut qam16TdTpsPwr: u16 = 0;
    let mut qam64TdTpsPwr: u16 = 0;
    let mut feIfIncr: u32 = 0;
    let mut bandwidth: u32 = 0;
    int mirrorFreqSpect;
    let mut qpskSnCeGain: u16 = 0;
    let mut qam16SnCeGain: u16 = 0;
    let mut qam64SnCeGain: u16 = 0;
    let mut qpskIsGainMan: u16 = 0;
    let mut qam16IsGainMan: u16 = 0;
    let mut qam64IsGainMan: u16 = 0;
    let mut qpskIsGainExp: u16 = 0;
    let mut qam16IsGainExp: u16 = 0;
    let mut qam64IsGainExp: u16 = 0;
    let mut bandwidthParam: u16 = 0;
    if (off < 0)
    off = (off - 500) / 1000;
    else
    off = (off + 500) / 1000;
...
#[no_mangle]
unsafe extern "C" fn CDRXD(state: *mut drxd_state, IntermediateFrequency: u32) -> c_int {
    static int CDRXD(struct drxd_state *state, u32 IntermediateFrequency)
    {
    let mut ulRfAgcOutputLevel: u32 = 0xffffffff;
    ...
    let mut ulRfAgcR1: u32 = 820;
    let mut ulRfAgcR2: u32 = 2200;
    let mut ulRfAgcR3: u32 = 150;
    u32 ulIfAgcMode = 0;	/* Auto */
    let mut ulIfAgcOutputLevel: u32 = 0xffffffff;
    let mut ulIfAgcSettleLevel: u32 = 0xffffffff;
    let mut ulIfAgcMinLevel: u32 = 0xffffffff;
    let mut ulIfAgcMaxLevel: u32 = 0xffffffff;
    let mut ulIfAgcSpeed: u32 = 0xffffffff;
    let mut ulIfAgcR1: u32 = 820;
    let mut ulIfAgcR2: u32 = 2200;
    let mut ulIfAgcR3: u32 = 150;
    let mut ulClock: u32 = state.config.clock;
    let mut ulSerialMode: u32 = 0;
    u32 ulEcOcRegOcModeLop = 4;	/* Dynamic DTO source */
    let mut ulHiI2cDelay: u32 = HI_I2C_DELAY;
    let mut ulHiI2cBridgeDelay: u32 = HI_I2C_BRIDGE_DELAY;
    let mut ulHiI2cPatch: u32 = 0;
    let mut ulEnvironment: u32 = APPENV_PORTABLE;
    let mut ulEnvironmentDiversity: u32 = APPENV_MOBILE;
    let mut ulIFFilter: u32 = IFFILTER_SAW;
...
// SAW filter
    ...
    break;
    default:
    state.m_HiI2cPatch = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn DRXD_init(state: *mut drxd_state, fw: *const u8, fw_size: u32) -> c_int {
...
// deviation in kHz
    let mut deviation: i32 = (devA / (1000000L));
// rounding, signed
    if (devA > 0)
    devB = (2);
    else
...
#[no_mangle]
unsafe extern "C" fn DRXD_status(state: *mut drxd_state, pLockStatus: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn drxd_read_signal_strength(fe: *mut dvb_frontend, strength: *mut *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drxd_read_status(fe: *mut dvb_frontend, status: *mut enum fe_status) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drxd_init(fe: *mut dvb_frontend) -> c_int {
    static int drxd_init(struct dvb_frontend *fe)
    {
    struct drxd_state *state = fe.demodulator_priv;
    return DRXD_init(state, core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn drxd_config_i2c(fe: *mut dvb_frontend, onoff: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drxd_read_ber(fe: *mut dvb_frontend, ber: *mut *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drxd_read_snr(fe: *mut dvb_frontend, snr: *mut *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drxd_read_ucblocks(fe: *mut dvb_frontend, ucblocks: *mut *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drxd_sleep(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drxd_i2c_gate_ctrl(fe: *mut dvb_frontend, enable: c_int) -> c_int {
    static int drxd_i2c_gate_ctrl(struct dvb_frontend *fe, int enable)
    {
    return drxd_config_i2c(fe, enable);
    }
#[no_mangle]
unsafe extern "C" fn drxd_set_frontend(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drxd_release(fe: *mut dvb_frontend) {
    ...
    struct device *dev)
    {
    struct drxd_state *state = core::ptr::null_mut();
    ...
    if (Read16(state, 0, core::ptr::null_mut(), 0) < 0)
    goto error;
