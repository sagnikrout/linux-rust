...
//! Source: drivers/media/dvb-frontends/au8522_dig.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn au8522_set_if(fe: *mut dvb_frontend, if_freq: enum au8522_if_freq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au8522_set_frontend(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au8522_read_status(fe: *mut dvb_frontend, status: *mut enum fe_status) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au8522_led_status(state: *mut au8522_state, snr: *const u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(QAM_256: state->current_modulation ==) -> else {
    else if (state.current_modulation == QAM_256)
    strong = led_config.qam256_strong;
#[no_mangle]
pub unsafe extern "C" fn if(QAM_64: state->current_modulation ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn au8522_read_snr(fe: *mut dvb_frontend, snr: *mut u16) -> c_int {
...
//
    u16 snr;
    u32 tmp;
    let mut ret: c_int = au8522_read_snr(fe, &snr);
// signal_strength = 0;
    if (0 == ret) {
...
#[no_mangle]
unsafe extern "C" fn au8522_read_ucblocks(fe: *mut dvb_frontend, ucblocks: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au8522_read_ber(fe: *mut dvb_frontend, ber: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au8522_release(fe: *mut dvb_frontend) {
    ...
    {
    struct au8522_state *state = core::ptr::null_mut();
    int instance;
