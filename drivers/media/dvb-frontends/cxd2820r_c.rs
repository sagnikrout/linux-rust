...
//! Source: drivers/media/dvb-frontends/cxd2820r_c.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cxd2820r_set_frontend_c(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxd2820r_read_status_c(fe: *mut dvb_frontend, status: *mut enum fe_status) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxd2820r_init_c(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxd2820r_sleep_c(fe: *mut dvb_frontend) -> c_int {
