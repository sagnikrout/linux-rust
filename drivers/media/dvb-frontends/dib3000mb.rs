...
//! Source: drivers/media/dvb-frontends/dib3000mb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dib3000_read_reg(state: *mut dib3000_state, reg: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib3000_write_reg(state: *mut dib3000_state, reg: u16, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib3000_search_status(irq: u16, lock: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib3000mb_set_frontend(fe: *mut dvb_frontend, tuner: c_int) -> c_int {
    static int dib3000mb_set_frontend(struct dvb_frontend *fe, int tuner)
    {
    let mut state: *mut dib3000_state = fe.demodulator_priv;
    struct dtv_frontend_properties *c = &fe.dtv_property_cache;
    let mut fe_cr: enum fe_code_rate = FEC_NONE;
...
#[no_mangle]
unsafe extern "C" fn dib3000mb_fe_init(fe: *mut *mut dvb_frontend, mobile_mode: c_int) -> c_int {
    ...
    inv_test1 = 0;
#[no_mangle]
pub unsafe extern "C" fn if(threshold: dds_val ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn dib3000mb_read_ber(fe: *mut *mut dvb_frontend, ber: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib3000mb_read_signal_strength(fe: *mut *mut dvb_frontend, strength: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib3000mb_read_snr(fe: *mut *mut dvb_frontend, snr: *mut u16) -> c_int {
    static int dib3000mb_read_snr(struct dvb_frontend* fe, u16 *snr)
    {
    let mut state: *mut dib3000_state = fe.demodulator_priv;
    let mut sigpow: c_short = rd(DIB3000MB_REG_SIGNAL_POWER);
...
#[no_mangle]
unsafe extern "C" fn dib3000mb_read_unc_blocks(fe: *mut *mut dvb_frontend, unc: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib3000mb_sleep(fe: *mut *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib3000mb_fe_get_tune_settings(fe: *mut *mut dvb_frontend, tune: *mut dvb_frontend_tune_settings) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib3000mb_fe_init_nonmobile(fe: *mut *mut dvb_frontend) -> c_int {
    static int dib3000mb_fe_init_nonmobile(struct dvb_frontend* fe)
    {
    return dib3000mb_fe_init(fe, 0);
    }
#[no_mangle]
unsafe extern "C" fn dib3000mb_set_frontend_and_tuner(fe: *mut dvb_frontend) -> c_int {
    static int dib3000mb_set_frontend_and_tuner(struct dvb_frontend *fe)
    {
    return dib3000mb_set_frontend(fe, 1);
    }
#[no_mangle]
unsafe extern "C" fn dib3000mb_release(fe: *mut *mut dvb_frontend) {
...
#[no_mangle]
unsafe extern "C" fn dib3000mb_pid_control(fe: *mut dvb_frontend, index: c_int, pid: c_int, onoff: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib3000mb_fifo_control(fe: *mut dvb_frontend, onoff: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib3000mb_pid_parse(fe: *mut dvb_frontend, onoff: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dib3000mb_tuner_pass_ctrl(fe: *mut dvb_frontend, onoff: c_int, pll_addr: u8) -> c_int {
    ...
    {
    let mut state: *mut dib3000_state = core::ptr::null_mut();
