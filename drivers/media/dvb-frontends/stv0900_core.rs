...
//! Source: drivers/media/dvb-frontends/stv0900_core.c
#![no_std]
...
//
    ...
    let mut stvdebug: c_int = 1;
    module_param_named(debug, stvdebug, int, 0644);
// internal params node
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stv0900_inode {
// pointer for internal params, one for each pair of demods
    pub internal: *mut stv0900_internal,
    pub next_inode: *mut stv0900_inode,
}
...
// find chip by i2c adapter and i2c address
    ...
    if (temp_chip != core::ptr::null_mut()) {
//
    Search of the last stv0900 chip or
    find it by i2c adapter and i2c address */
    while ((temp_chip != core::ptr::null_mut()) &&
...
// deallocating chip
#[no_mangle]
unsafe extern "C" fn remove_inode(internal: *mut stv0900_internal) {
    ...
    internal.i2c_addr);
    if (del_node != core::ptr::null_mut()) {
    if (del_node == stv0900_first_inode) {
    stv0900_first_inode = del_node.next_inode;
    } else {
    while (prev_node.next_inode != del_node)
    prev_node = prev_node.next_inode;
    if (del_node.next_inode == core::ptr::null_mut())
    prev_node.next_inode = core::ptr::null_mut();
    else
...
// allocating new chip
    ...
    while (new_node.next_inode != core::ptr::null_mut())
    new_node = new_node.next_inode;
    new_node.next_inode = kmalloc_obj(struct stv0900_inode);
    if (new_node.next_inode != core::ptr::null_mut())
    new_node = new_node.next_inode;
    else
    ...
    new_node.next_inode = core::ptr::null_mut();
    }
    return new_node;
    }
#[no_mangle]
pub unsafe extern "C" fn ge2comp(a: i32, width: i32) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn stv0900_read_reg(intp: *mut stv0900_internal, reg: u16) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn extract_mask_pos(label: u32, mask: *mut u8, pos: *mut u8) {
    static void extract_mask_pos(u32 label, u8 *mask, u8 *pos)
    {
    let mut position: u8 = 0, i = 0;
    (*mask) = label & 0xff;
...
#[no_mangle]
pub unsafe extern "C" fn stv0900_write_bits(intp: *mut stv0900_internal, label: u32, val: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn stv0900_get_bits(intp: *mut stv0900_internal, label: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn stv0900_initialize(intp: *mut stv0900_internal) -> enum fe_stv0900_error {
    static enum fe_stv0900_error stv0900_initialize(struct stv0900_internal *intp)
    {
    s32 i;
    if (intp == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn stv0900_get_mclk_freq(intp: *mut stv0900_internal, ext_clk: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn stv0900_set_mclk(intp: *mut stv0900_internal, mclk: u32) -> enum fe_stv0900_error {
...
#[no_mangle]
unsafe extern "C" fn stv0900_i2c_gate_ctrl(fe: *mut dvb_frontend, enable: c_int) -> c_int {
    static int stv0900_i2c_gate_ctrl(struct dvb_frontend *fe, int enable)
    {
    struct stv0900_state *state = fe.demodulator_priv;
    struct stv0900_internal *intp = state.internal;
    let mut demod: enum fe_stv0900_demod_num = state.demod;
    ...
    u32 bandwidth)
    {
    struct dvb_frontend_ops *frontend_ops = core::ptr::null_mut();
    struct dvb_tuner_ops *tuner_ops = core::ptr::null_mut();
    frontend_ops = &fe.ops;
...
#[no_mangle]
pub unsafe extern "C" fn stv0900_set_bandwidth(fe: *mut dvb_frontend, bandwidth: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn stv0900_get_freq_auto(intp: *mut stv0900_internal, demod: c_int) -> u32 {
...
// Tuner Write trig
    ...
    rf_lvl = 0;
    dprintk("%s\n", __func__);
    if ((lookup == core::ptr::null_mut()) || (lookup.size <= 0))
    return 0;
    ...
    rf_lvl = 5;
#[no_mangle]
pub unsafe extern "C" fn if(lookup->table[lookup->size-1].regval: agc_gain <) -> else {
...
#[no_mangle]
unsafe extern "C" fn stv0900_read_signal_strength(fe: *mut dvb_frontend, strength: *mut u16) -> c_int {
...
// strength = rflevel;
    ...
    if ((lookup != core::ptr::null_mut()) && lookup.size) {
    regval = 0;
    msleep(5);
    for (i = 0; i < 16; i++) {
...
#[no_mangle]
unsafe extern "C" fn stv0900_read_ucblocks(fe: *mut dvb_frontend, ucblocks: *mut *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stv0900_read_snr(fe: *mut dvb_frontend, snr: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stv0900_read_ber(fe: *mut dvb_frontend, ber: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stv0900_frontend_algo(fe: *mut dvb_frontend) -> enum dvbfe_algo {
...
#[no_mangle]
pub unsafe extern "C" fn if(7000000: srate <=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(25000000: srate <=) -> else {
...
pub unsafe extern "C" fn if(25000000: srate <=) -> else {
    ...
    let mut mod_index: i32 = 0;
    let mut aclc_value: u8 = 0x0b;
    dprintk("%s\n", __func__);
...
pub unsafe extern "C" fn if(25000000: srate <=) -> else {
    ...
    {
    struct stv0900_state *state = fe.demodulator_priv;
    let mut error: enum fe_stv0900_error = STV0900_NO_ERROR;
    let mut demodError: enum fe_stv0900_error = STV0900_NO_ERROR;
    struct stv0900_internal *intp = core::ptr::null_mut();
    int selosci, i;
    struct stv0900_inode *temp_int = find_inode(state.i2c_adap,
    state.config.demod_address);
    dprintk("%s\n", __func__);
    if ((temp_int != core::ptr::null_mut()) && (p_init.demod_mode == STV0900_DUAL)) {
    ...
    if (state.internal == core::ptr::null_mut())
    return STV0900_INVALID_HANDLE;
    temp_int = append_internal(state.internal);
    if (temp_int == core::ptr::null_mut()) {
    kfree(state.internal);
    state.internal = core::ptr::null_mut();
    return STV0900_INVALID_HANDLE;
    }
    ...
    if (intp.ts_config == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn stv0900_search(fe: *mut dvb_frontend) -> enum dvbfe_search {
    ...
    let mut p_result: stv0900_signal_info = intp.result[demod];
    let mut error: enum fe_stv0900_error = STV0900_NO_ERROR;
    dprintk("%s: ", __func__);
...
#[no_mangle]
unsafe extern "C" fn stv0900_read_status(fe: *mut dvb_frontend, status: *mut enum fe_status) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stv0900_stop_ts(fe: *mut dvb_frontend, stop_ts: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stv0900_diseqc_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stv0900_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stv0900_release(fe: *mut dvb_frontend) {
...
#[no_mangle]
unsafe extern "C" fn stv0900_sleep(fe: *mut dvb_frontend) -> c_int {
    ...
    int demod)
    {
    struct stv0900_state *state = core::ptr::null_mut();
