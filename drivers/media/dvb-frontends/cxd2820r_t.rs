...
//! Source: drivers/media/dvb-frontends/cxd2820r_t.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cxd2820r_set_frontend_t(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxd2820r_read_status_t(fe: *mut dvb_frontend, status: *mut enum fe_status) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxd2820r_init_t(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxd2820r_sleep_t(fe: *mut dvb_frontend) -> c_int {
