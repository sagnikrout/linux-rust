...
//! Source: drivers/media/dvb-frontends/tda10021.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tda10021_state {
    pub i2c: *mut *mut i2c_adapter,
// configuration settings
    pub config: *const *const tda1002x_config,
...
// Macro flag: #define dprintk(x...)
    ...
    let mut tda10021_inittab_size: static int = 0x40;
...
#[no_mangle]
unsafe extern "C" fn _tda10021_writereg(state: *mut *mut tda10021_state, reg: u8, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda10021_readreg(state: *mut *mut tda10021_state, reg: u8) -> u8 {
...
// get access to tuner
#[no_mangle]
unsafe extern "C" fn lock_tuner(state: *mut *mut tda10021_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unlock_tuner(state: *mut *mut tda10021_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda10021_set_symbolrate(state: *mut *mut tda10021_state, symbolrate: u32) -> c_int {
    ...
    symbolrate = XIN / 2;
#[no_mangle]
pub unsafe extern "C" fn if(500000: symbolrate <) -> else {
...
#[no_mangle]
unsafe extern "C" fn tda10021_init(fe: *mut dvb_frontend) -> c_int {
    static int tda10021_init (struct dvb_frontend *fe)
    {
    let mut state: *mut tda10021_state = fe.demodulator_priv;
    int i;
...
pub struct qam_params {
    pub aref: u8 conf, agcref, lthr, mseth,,
}

#[no_mangle]
unsafe extern "C" fn tda10021_set_parameters(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda10021_read_ber(fe: *mut *mut dvb_frontend, ber: *mut *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda10021_read_signal_strength(fe: *mut *mut dvb_frontend, strength: *mut *mut u16) -> c_int {
    static int tda10021_read_signal_strength(struct dvb_frontend* fe, u16* strength)
    {
    let mut state: *mut tda10021_state = fe.demodulator_priv;
    let mut config: u8 = tda10021_readreg(state, 0x02);
    let mut gain: u8 = tda10021_readreg(state, 0x17);
    if (config & 0x02)
...
#[no_mangle]
unsafe extern "C" fn tda10021_read_snr(fe: *mut *mut dvb_frontend, snr: *mut *mut u16) -> c_int {
    static int tda10021_read_snr(struct dvb_frontend* fe, u16* snr)
    {
    let mut state: *mut tda10021_state = fe.demodulator_priv;
    let mut quality: u8 = ~tda10021_readreg(state, 0x18);
// snr = (quality << 8) | quality;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tda10021_read_ucblocks(fe: *mut *mut dvb_frontend, ucblocks: *mut *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda10021_i2c_gate_ctrl(fe: *mut *mut dvb_frontend, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda10021_sleep(fe: *mut *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda10021_release(fe: *mut *mut dvb_frontend) {
    ...
    u8 pwm)
    {
    let mut state: *mut tda10021_state = core::ptr::null_mut();
    u8 id;
