...
//! Source: drivers/media/dvb-frontends/au8522_decoder.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct au8522_register_config {
    pub reg_name: u16,
    pub reg_val: [u8; 8],
}
...
#[no_mangle]
unsafe extern "C" fn setup_decoder_defaults(state: *mut au8522_state, is_svideo: bool) {
...
#[no_mangle]
unsafe extern "C" fn au8522_setup_cvbs_mode(state: *mut au8522_state, input_mode: u8) {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn disable_audio_input(state: *mut au8522_state) {
...
// 0=disable, 1=SIF
#[no_mangle]
unsafe extern "C" fn set_audio_input(state: *mut au8522_state) {
    static void set_audio_input(struct au8522_state *state)
    {
    let mut aud_input: c_int = state.aud_input;
    int i;
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn au8522_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au8522_video_set(state: *mut au8522_state) {
...
#[no_mangle]
unsafe extern "C" fn au8522_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au8522_s_std(sd: *mut v4l2_subdev, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au8522_g_tuner(sd: *mut v4l2_subdev, vt: *mut v4l2_tuner) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn au8522_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au8522_remove(client: *mut i2c_client) {
