...
//! Source: drivers/media/test-drivers/vimc/vimc-scaler.c
#![no_std]
...
pub const VIMC_SCALER_FMT_WIDTH_DEFAULT: c_int = 640;
pub const VIMC_SCALER_FMT_HEIGHT_DEFAULT: c_int = 480;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vimc_scaler_device {
...
#[no_mangle]
unsafe extern "C" fn vimc_scaler_s_stream(sd: *mut v4l2_subdev, enable: c_int) -> c_int {
...
//
    ...
    vscaler.src_frame = core::ptr::null_mut();
    }
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn vimc_scaler_release(ved: *mut vimc_ent_device) {
