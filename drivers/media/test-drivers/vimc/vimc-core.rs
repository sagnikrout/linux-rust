...
//! Source: drivers/media/test-drivers/vimc/vimc-core.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vimc_ancillary_link {
    pub primary_ent: c_uint,
    pub ancillary_ent: c_uint,
}

// Structure which describes the whole topology
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vimc_pipeline_config {
    pub ents: *const vimc_ent_config,
    pub num_ents: usize,
    pub data_links: *const vimc_data_link,
    pub num_data_links: usize,
    pub ancillary_links: *const vimc_ancillary_link,
    pub num_ancillary_links: usize,
}
...
// --------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn vimc_rm_links(vimc: *mut vimc_device) {
...
#[no_mangle]
unsafe extern "C" fn vimc_create_links(vimc: *mut vimc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vimc_release_subdevs(vimc: *mut vimc_device) {
...
#[no_mangle]
unsafe extern "C" fn vimc_unregister_subdevs(vimc: *mut vimc_device) {
...
#[no_mangle]
unsafe extern "C" fn vimc_add_subdevs(vimc: *mut vimc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vimc_v4l2_dev_release(v4l2_dev: *mut v4l2_device) {
...
#[no_mangle]
unsafe extern "C" fn vimc_register_devices(vimc: *mut vimc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vimc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vimc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn vimc_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn vimc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vimc_exit() -> void __exit {
