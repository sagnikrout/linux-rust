...
//! Source: drivers/media/test-drivers/vimc/vimc-capture.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vimc_capture_device {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vimc_capture_buffer {
//
...
#[no_mangle]
unsafe extern "C" fn vimc_capture_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vimc_capture_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn vimc_capture_buf_queue(vb2_buf: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn vimc_capture_buffer_prepare(vb: *mut vb2_buffer) -> c_int {
    ...
    let mut size: c_ulong = vcapture.format.sizeimage;
...
#[no_mangle]
unsafe extern "C" fn vimc_capture_release(ved: *mut vimc_ent_device) {
...
#[no_mangle]
unsafe extern "C" fn vimc_capture_unregister(ved: *mut vimc_ent_device) {
