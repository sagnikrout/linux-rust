...
//! Source: drivers/media/test-drivers/visl/visl-core.c
#![no_std]
...
//
    let mut visl_dprintk_frame_start: c_int = -1;
    ...
    let mut bitstream_trace_frame_start: c_int = -1;
...
#[no_mangle]
pub unsafe extern "C" fn visl_control_num_elems(ctx: *mut visl_ctx, id: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn visl_device_release(vdev: *mut video_device) {
...
#[no_mangle]
unsafe extern "C" fn visl_init_ctrls(ctx: *mut visl_ctx) -> c_int {
    static int visl_init_ctrls(struct visl_ctx *ctx)
    {
    struct visl_dev *dev = ctx.dev;
    struct v4l2_ctrl_handler *hdl = &ctx.hdl;
    let mut ctrl_cnt: c_uint = 0;
    unsigned int i;
    unsigned int j;
    ...
    v4l2_ctrl_new_custom(hdl, &ctrls.ctrls[j].cfg, core::ptr::null_mut());
    }
    if (hdl.error) {
...
#[no_mangle]
unsafe extern "C" fn visl_open(file: *mut file) -> c_int {
    static int visl_open(struct file *file)
    {
    struct visl_dev *dev = video_drvdata(file);
    struct visl_ctx *ctx = core::ptr::null_mut();
    let mut rc: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn visl_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn visl_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn visl_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn visl_init() -> int __init {
