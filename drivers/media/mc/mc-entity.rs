...
//! Source: drivers/media/mc/mc-entity.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn media_entity_enum_cleanup(ent_enum: *mut media_entity_enum) {
...
//
#[no_mangle]
unsafe extern "C" fn dev_dbg_obj(event_name: *const c_char, gobj: *mut media_gobj) {
...
#[no_mangle]
pub unsafe extern "C" fn media_gobj_destroy(gobj: *mut media_gobj) {
    void media_gobj_destroy(struct media_gobj *gobj)
    {
// Do nothing if the object is not linked.
    if (gobj.mdev == core::ptr::null_mut())
    return;
    dev_dbg_obj(__func__, gobj);
    gobj.mdev.topology_version++;
// Remove the object from mdev list
    list_del(&gobj.list);
    gobj.mdev = core::ptr::null_mut();
    }
//
// TODO: Get rid of this.
//
pub const MEDIA_ENTITY_MAX_PADS: c_int = 512;
...
//
#[no_mangle]
pub unsafe extern "C" fn media_graph_walk_cleanup(graph: *mut media_graph) {
    ...
    graph.top = 0;
    graph.stack[graph.top].entity = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn media_graph_walk_iter(graph: *mut media_graph) {
...
// Push the new entity to stack and start over.
    ...
    {
    struct media_entity *entity;
    if (stack_top(graph) == core::ptr::null_mut())
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct media_pipeline_walk_entry {
    pub pad: *mut media_pad,
    pub links: *mut list_head,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct media_pipeline_walk {
    pub mdev: *mut media_device,
    struct {
    pub size: c_uint,
    pub top: c_int,
    pub entries: *mut media_pipeline_walk_entry,
    pub stack: },
}

pub const MEDIA_PIPELINE_STACK_GROW_STEP: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn media_pipeline_walk_empty(walk: *mut media_pipeline_walk) -> bool {
...
#[no_mangle]
unsafe extern "C" fn media_pipeline_walk_resize(walk: *mut media_pipeline_walk) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn media_pipeline_walk_pop(walk: *mut media_pipeline_walk) -> bool {
...
#[no_mangle]
unsafe extern "C" fn media_pipeline_walk_destroy(walk: *mut media_pipeline_walk) {
...
#[no_mangle]
unsafe extern "C" fn media_pipeline_cleanup(pipe: *mut media_pipeline) {
    ...
    struct media_pad *pad)
    {
    let mut walk: media_pipeline_walk = { };
    struct media_pipeline_pad *ppad;
    int ret;
//
...
//
    ...
    let mut has_enabled_link: bool = false;
    struct media_link *link;
...
//
    ...
    if (err_ppad == ppad)
    break;
    err_ppad.pad.pipe = core::ptr::null_mut();
    }
    media_pipeline_cleanup(pipe);
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn __media_pipeline_stop(pad: *mut media_pad) {
...
//
    ...
    return;
    list_for_each_entry(ppad, &pipe.pads, list)
    ppad.pad.pipe = core::ptr::null_mut();
    media_pipeline_cleanup(pipe);
    if (pipe.allocated)
    kfree(pipe);
    }
...
#[no_mangle]
pub unsafe extern "C" fn media_pipeline_stop(pad: *mut media_pad) {
...
#[no_mangle]
pub unsafe extern "C" fn media_pipeline_alloc_start(pad: *mut media_pad) -> __must_check int {
    __must_check int media_pipeline_alloc_start(struct media_pad *pad)
    {
    struct media_device *mdev = pad.graph_obj.mdev;
    struct media_pipeline *new_pipe = core::ptr::null_mut();
    struct media_pipeline *pipe;
    int ret;
    mutex_lock(&mdev.graph_mutex);
//
...
#[no_mangle]
pub unsafe extern "C" fn media_pipeline_entity_iter_cleanup(iter: *mut media_pipeline_entity_iter) {
...
#[no_mangle]
pub unsafe extern "C" fn __media_entity_remove_links(entity: *mut media_entity) {
...
#[no_mangle]
pub unsafe extern "C" fn media_entity_remove_links(entity: *mut media_entity) {
    void media_entity_remove_links(struct media_entity *entity)
    {
    struct media_device *mdev = entity.graph_obj.mdev;
// Do nothing if the entity is not registered.
    if (mdev == core::ptr::null_mut())
    return;
    mutex_lock(&mdev.graph_mutex);
...
#[no_mangle]
unsafe extern "C" fn __media_entity_setup_link_notify(link: *mut media_link, flags: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __media_entity_setup_link(link: *mut media_link, flags: u32) -> c_int {
    int __media_entity_setup_link(struct media_link *link, u32 flags)
    {
    let mut mask: u32 = MEDIA_LNK_FL_ENABLED;
    struct media_device *mdev;
...
#[no_mangle]
pub unsafe extern "C" fn media_entity_setup_link(link: *mut media_link, flags: u32) -> c_int {
    ...
    {
    struct media_pad *found_pad = core::ptr::null_mut();
    struct media_link *link;
    ...
    remote_pad = link.source;
#[no_mangle]
pub unsafe extern "C" fn if(pad: link->source ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn media_devnode_remove(devnode: *mut media_intf_devnode) {
...
#[no_mangle]
pub unsafe extern "C" fn __media_remove_intf_link(link: *mut media_link) {
...
#[no_mangle]
pub unsafe extern "C" fn media_remove_intf_link(link: *mut media_link) {
...
#[no_mangle]
pub unsafe extern "C" fn __media_remove_intf_links(intf: *mut media_interface) {
...
#[no_mangle]
pub unsafe extern "C" fn media_remove_intf_links(intf: *mut media_interface) {
