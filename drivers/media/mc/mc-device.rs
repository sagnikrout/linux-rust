...
//! Source: drivers/media/mc/mc-device.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn media_device_open(filp: *mut file) -> c_int {
    static int media_device_open(struct file *filp)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn media_device_close(filp: *mut file) -> c_int {
    static int media_device_close(struct file *filp)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn media_device_get_info(dev: *mut media_device, arg: *mut c_void) -> c_long {
    ...
    let mut next: c_int = id & MEDIA_ENT_ID_FLAG_NEXT;
...
#[no_mangle]
unsafe extern "C" fn media_device_enum_entities(mdev: *mut media_device, arg: *mut c_void) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn if(MEDIA_ENT_F_IO_V4L: ent->function !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn media_device_enum_links(mdev: *mut media_device, arg: *mut c_void) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn media_device_setup_link(mdev: *mut media_device, arg: *mut c_void) -> c_long {
    static long media_device_setup_link(struct media_device *mdev, void *arg)
    {
    struct media_link_desc *linkd = arg;
    struct media_link *link = core::ptr::null_mut();
...
//
    ...
    if (source == core::ptr::null_mut() || sink == core::ptr::null_mut())
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn media_device_get_topology(mdev: *mut media_device, arg: *mut c_void) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn media_device_request_alloc(mdev: *mut media_device, arg: *mut c_void) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn copy_arg_from_user(karg: *mut c_void, uarg: *mut void __user, cmd: c_uint) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn copy_arg_to_user(uarg: *mut void __user, karg: *mut c_void, cmd: c_uint) -> c_long {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct media_ioctl_info {
    pub cmd: c_uint,
    pub flags: c_ushort,
    pub arg): *mut *mut *mut long (fn)(struct media_device dev, void,
    pub cmd): *mut *mut *mut *mut long (arg_from_user)(void karg, void __user uarg, unsigned int,
    pub cmd): *mut *mut *mut *mut long (arg_to_user)(void __user uarg, void karg, unsigned int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct media_links_enum32 {
    pub entity: __u32,
    pub /: *mut *mut *mut compat_uptr_t pads; / struct media_pad_desc,
    pub /: *mut *mut *mut compat_uptr_t links; / struct media_link_desc,
...
//
#[no_mangle]
unsafe extern "C" fn media_device_release(devnode: *mut media_devnode) {
    static void media_device_release(struct media_devnode *devnode)
    {
    dev_dbg(devnode.parent, "Media device released\n");
    }
#[no_mangle]
unsafe extern "C" fn __media_device_unregister_entity(entity: *mut media_entity) {
...
// Warn if we apparently re-register an entity
    WARN_ON(entity.graph_obj.mdev != core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn media_device_unregister_entity(entity: *mut media_entity) {
...
//
#[no_mangle]
unsafe extern "C" fn media_device_requests(file: *mut seq_file, priv: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn media_device_init(mdev: *mut media_device) {
...
#[no_mangle]
pub unsafe extern "C" fn media_device_cleanup(mdev: *mut media_device) {
...
// devnode free is handled in media_devnode_*()
    mdev.devnode = core::ptr::null_mut();
    return ret;
    }
...
// devnode free is handled in media_devnode_*()
    ...
    media_debugfs_root = debugfs_create_dir("media", core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn media_device_unregister(mdev: *mut media_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: udev->product) -> else {
