...
//! Source: drivers/media/rc/ir-imon-decoder.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ir_imon_decode_scancode(dev: *mut rc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn ir_imon_decode(dev: *mut rc_dev, ev: ir_raw_event) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ev.pulse) -> else {
    else if (ev.pulse)
    goto err_out;
...
#[no_mangle]
unsafe extern "C" fn ir_imon_register(dev: *mut rc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ir_imon_decode_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ir_imon_decode_exit() -> void __exit {
