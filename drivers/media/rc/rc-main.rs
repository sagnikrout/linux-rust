...
//! Source: drivers/media/rc/rc-main.c
#![no_std]
...
pub const IR_TAB_MIN_SIZE: c_int = 256;
pub const IR_TAB_MAX_SIZE: c_int = 8192;
    static const struct {
    const char *name;
...
// Used to keep track of rc devices
    ...
    {
    struct rc_map_list *map = core::ptr::null_mut();
    ...
    if (!map) {
    let mut rc: c_int = request_module("%s", name);
    if (rc < 0) {
...
#[no_mangle]
pub unsafe extern "C" fn rc_map_register(map: *mut rc_map_list) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rc_map_unregister(map: *mut rc_map_list) {
...
//
#[no_mangle]
unsafe extern "C" fn scancode_to_u64(ke: *const input_keymap_entry, scancode: *mut u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ir_free_table(rc_map: *mut rc_map) {
...
//
    ...
    gfp_t gfp_flags)
    {
    let mut oldalloc: c_uint = rc_map.alloc;
    let mut newalloc: c_uint = oldalloc;
...
//
    ...
    {
    let mut old_keycode: c_int = rc_map.scan[index].keycode;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn ir_setkeytable(dev: *mut rc_dev, from: *const rc_map) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc_map_cmp(key: *const c_void, elt: *const c_void) -> c_int {
    ...
    return -1;
#[no_mangle]
pub unsafe extern "C" fn if(e->scancode: *mut *mut scancode >) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn rc_g_keycode_from_table(dev: *mut rc_dev, scancode: u64) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn ir_do_keyup(dev: *mut rc_dev, sync: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rc_keyup(dev: *mut rc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn ir_timer_keyup(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn ir_timer_repeat(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn repeat_period(protocol: c_int) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn rc_repeat(dev: *mut rc_dev) {
...
//
    ...
    {
    unsigned long flags;
    let mut keycode: u32 = rc_g_keycode_from_table(dev, scancode);
    spin_lock_irqsave(&dev.keylock, flags);
...
//
#[no_mangle]
pub unsafe extern "C" fn rc_validate_scancode(proto: enum rc_proto, scancode: u32) -> bool {
...
//
    ...
    let mut protocol: enum rc_proto = dev.wakeup_protocol;
    if (protocol >= ARRAY_SIZE(protocols))
    return -EINVAL;
...
#[no_mangle]
pub unsafe extern "C" fn rc_open(rdev: *mut rc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ir_open(idev: *mut input_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rc_close(rdev: *mut rc_dev) {
...
#[no_mangle]
unsafe extern "C" fn ir_close(idev: *mut input_dev) {
...
//
    ...
    { RC_PROTO_BIT_NONE,	"none",		core::ptr::null_mut()			},
    { RC_PROTO_BIT_OTHER,	"other",	core::ptr::null_mut()			},
    { RC_PROTO_BIT_UNKNOWN,	"unknown",	core::ptr::null_mut()			},
    { RC_PROTO_BIT_RC5 |
    ...
    { RC_PROTO_BIT_CEC,	"cec",		core::ptr::null_mut()			},
    { RC_PROTO_BIT_IMON,	"imon",		"ir-imon-decoder"	},
    { RC_PROTO_BIT_RCMM12 |
    RC_PROTO_BIT_RCMM24 |
    RC_PROTO_BIT_RCMM32,	"rc-mm",	"ir-rcmm-decoder"	},
    { RC_PROTO_BIT_XBOX_DVD, "xbox-dvd",	core::ptr::null_mut()			},
    };
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rc_filter_attribute {
    pub attr: device_attribute,
    pub type: enum rc_filter_type,
    pub mask: bool,
}
...
#[no_mangle]
pub unsafe extern "C" fn if(proto_names[i].type: allowed &) -> else {
...
// protocols |= mask;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: disable) -> else {
    else if (disable)
// protocols &= ~mask;
    else
// protocols = mask;
...
#[no_mangle]
pub unsafe extern "C" fn ir_raw_load_modules(protocols: *mut u64) {
...
//
    ...
    {
    struct rc_dev *dev = to_rc_dev(device);
    let mut protocol: enum rc_proto = RC_PROTO_UNKNOWN;
    ssize_t rc;
    u64 allowed;
    int i;
    mutex_lock(&dev.lock);
    ...
    let mut mask: u64 = 1ULL << protocol;
...
#[no_mangle]
unsafe extern "C" fn rc_dev_release(device: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn rc_dev_uevent(device: *const device, env: *mut kobj_uevent_env) -> c_int {
...
//
    ...
    __ATTR(protocols, 0444, show_protocols, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn rc_free_device(dev: *mut rc_dev) {
...
#[no_mangle]
unsafe extern "C" fn devm_rc_alloc_release(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rc_prepare_rx_device(dev: *mut rc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc_setup_rx_device(dev: *mut rc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc_free_rx_device(dev: *mut rc_dev) {
    ...
    dev.input_dev = core::ptr::null_mut();
    }
    ir_free_table(&dev.rc_map);
    }
#[no_mangle]
pub unsafe extern "C" fn rc_register_device(dev: *mut rc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(RC_DRIVER_IR_RAW_TX: dev->driver_type !=) -> else {
    ...
    dev.sysfs_groups[attr++] = core::ptr::null_mut();
    if (dev.driver_type == RC_DRIVER_IR_RAW) {
...
#[no_mangle]
unsafe extern "C" fn devm_rc_release(dev: *mut device, res: *mut c_void) {
    static void devm_rc_release(struct device *dev, void *res)
    {
    rc_unregister_device(*(struct rc_dev **)res);
    }
#[no_mangle]
pub unsafe extern "C" fn devm_rc_register_device(parent: *mut device, dev: *mut rc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rc_unregister_device(dev: *mut rc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn rc_core_init() -> int __init {
    static int __init rc_core_init(void)
    {
    let mut rc: c_int = class_register(&rc_class);
    if (rc) {
...
#[no_mangle]
unsafe extern "C" fn rc_core_exit() -> void __exit {
