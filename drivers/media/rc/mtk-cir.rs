...
//! Source: drivers/media/rc/mtk-cir.c
#![no_std]
...
pub const MTK_CONFIG_HIGH_REG: c_uint = 0x0c;
...
// IR threshold
pub const MTK_IRTHD: c_uint = 0x14;
...
pub const MTK_MAX_SAMPLES: c_uint = 0xff;
// Indicate the end of IR message

// Number of registers to record the pulse width
pub const MTK_CHKDATA_SZ: c_int = 17;
// Sample period in us
pub const MTK_IR_SAMPLE: c_int = 46;
    enum mtk_fields {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_ir_data {
    pub regs: *const u32,
    pub fields: *const mtk_field_type,
    pub div: u8,
    pub ok_count: u8,
    pub hw_period: u32,
}
...
pub struct mtk_ir {
    ...
    pub clk: *mut clk,
    pub bus: *mut clk,
    pub data: *const mtk_ir_data,
}

#[no_mangle]
pub unsafe extern "C" fn mtk_chkdata_reg(ir: *mut mtk_ir, i: u32) -> u32 {
    static inline u32 mtk_chkdata_reg(struct mtk_ir *ir, u32 i)
    {
    return ir.data.regs[MTK_CHKDATA_REG] + 4 * i;
    }
#[no_mangle]
pub unsafe extern "C" fn mtk_chk_period(ir: *mut mtk_ir) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mtk_w32_mask(ir: *mut mtk_ir, val: u32, mask: u32, reg: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mtk_w32(ir: *mut mtk_ir, val: u32, reg: c_uint) {
    static void mtk_w32(struct mtk_ir *ir, u32 val, unsigned int reg)
    {
    __raw_writel(val, ir.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn mtk_r32(ir: *mut mtk_ir, reg: c_uint) -> u32 {
    static u32 mtk_r32(struct mtk_ir *ir, unsigned int reg)
    {
    return __raw_readl(ir.base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn mtk_irq_disable(ir: *mut mtk_ir, mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_irq_enable(ir: *mut mtk_ir, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn mtk_ir_irq(irqno: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mtk_ir_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    map_name = of_get_property(dn, "linux,rc-map-name", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mtk_ir_remove(pdev: *mut platform_device) {
