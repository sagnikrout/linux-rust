...
//! Source: drivers/media/rc/ir-sony-decoder.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ir_sony_decode(dev: *mut rc_dev, ev: ir_raw_event) -> c_int {
    ...
    data.bits |= 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !eq_margin(ev.duration, _arg: SONY_BIT_0_PULSE, 2): SONY_UNIT /) -> else {
...
#[no_mangle]
unsafe extern "C" fn ir_sony_decode_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ir_sony_decode_exit() -> void __exit {
