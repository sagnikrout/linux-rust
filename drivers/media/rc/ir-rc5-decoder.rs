...
//! Source: drivers/media/rc/ir-rc5-decoder.c
#![no_std]
...
pub const RC5_NBITS: c_int = 14;
pub const RC5_SZ_NBITS: c_int = 15;
pub const RC5X_NBITS: c_int = 20;
pub const CHECK_RC5X_NBITS: c_int = 8;
...
//
#[no_mangle]
unsafe extern "C" fn ir_rc5_decode(dev: *mut rc_dev, ev: ir_raw_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ir_rc5_decode_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ir_rc5_decode_exit() -> void __exit {
