...
//! Source: drivers/media/rc/streamzap.c
#![no_std]
...
pub const USB_STREAMZAP_VENDOR_ID: c_uint = 0x0e9c;
pub const USB_STREAMZAP_PRODUCT_ID: c_uint = 0x0000;
...
pub const SZ_PULSE_MASK: c_uint = 0xf0;
pub const SZ_SPACE_MASK: c_uint = 0x0f;
pub const SZ_TIMEOUT: c_uint = 0xff;
pub const SZ_RESOLUTION: c_int = 256;
// number of samples buffered
pub const SZ_BUF_LEN: c_int = 128;
...
// buffer & dma
    ...
    pub buf_in_len: c_uint,
// track what state we're in
    pub decoder_state: enum StreamzapDecoderState,
    pub phys: [c_char; 64],
}
...
#[no_mangle]
unsafe extern "C" fn sz_push(sz: *mut streamzap_ir, rawir: ir_raw_event) {
...
#[no_mangle]
unsafe extern "C" fn sz_process_ir_data(sz: *mut streamzap_ir, len: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn streamzap_callback(urb: *mut urb) {
    static void streamzap_callback(struct urb *urb)
    {
...
//
    ...
    struct streamzap_ir *sz = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn streamzap_disconnect(interface: *mut usb_interface) {
    static void streamzap_disconnect(struct usb_interface *interface)
    {
...
#[no_mangle]
unsafe extern "C" fn streamzap_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
    static int streamzap_suspend(struct usb_interface *intf, pm_message_t message)
    {
...
#[no_mangle]
unsafe extern "C" fn streamzap_resume(intf: *mut usb_interface) -> c_int {
    static int streamzap_resume(struct usb_interface *intf)
    {
    struct streamzap_ir *sz = usb_get_intfdata(intf);
