...
//! Source: drivers/media/rc/keymaps/rc-avermedia-m135a.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_avermedia_m135a() -> int __init {
    static int __init init_rc_map_avermedia_m135a(void)
    {
    return rc_map_register(&avermedia_m135a_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_avermedia_m135a() -> void __exit {
