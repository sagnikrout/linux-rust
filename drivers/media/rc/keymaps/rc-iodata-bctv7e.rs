...
//! Source: drivers/media/rc/keymaps/rc-iodata-bctv7e.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_iodata_bctv7e() -> int __init {
    static int __init init_rc_map_iodata_bctv7e(void)
    {
    return rc_map_register(&iodata_bctv7e_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_iodata_bctv7e() -> void __exit {
