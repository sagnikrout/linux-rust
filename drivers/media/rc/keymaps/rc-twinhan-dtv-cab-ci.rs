...
//! Source: drivers/media/rc/keymaps/rc-twinhan-dtv-cab-ci.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_twinhan_dtv_cab_ci() -> int __init {
    static int __init init_rc_map_twinhan_dtv_cab_ci(void)
    {
    return rc_map_register(&twinhan_dtv_cab_ci_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_twinhan_dtv_cab_ci() -> void __exit {
