...
//! Source: drivers/media/rc/keymaps/rc-terratec-cinergy-xs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_terratec_cinergy_xs() -> int __init {
    static int __init init_rc_map_terratec_cinergy_xs(void)
    {
    return rc_map_register(&terratec_cinergy_xs_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_terratec_cinergy_xs() -> void __exit {
