...
//! Source: drivers/media/rc/keymaps/rc-total-media-in-hand.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_total_media_in_hand() -> int __init {
    static int __init init_rc_map_total_media_in_hand(void)
    {
    return rc_map_register(&total_media_in_hand_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_total_media_in_hand() -> void __exit {
