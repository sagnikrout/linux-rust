...
//! Source: drivers/media/rc/keymaps/rc-avermedia-rm-ks.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_avermedia_rm_ks() -> int __init {
    static int __init init_rc_map_avermedia_rm_ks(void)
    {
    return rc_map_register(&avermedia_rm_ks_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_avermedia_rm_ks() -> void __exit {
