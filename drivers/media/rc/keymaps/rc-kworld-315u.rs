...
//! Source: drivers/media/rc/keymaps/rc-kworld-315u.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_kworld_315u() -> int __init {
    static int __init init_rc_map_kworld_315u(void)
    {
    return rc_map_register(&kworld_315u_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_kworld_315u() -> void __exit {
