...
//! Source: drivers/media/rc/keymaps/rc-mygica-utv3.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_mygica_utv3() -> int __init {
    static int __init init_rc_map_mygica_utv3(void)
    {
    return rc_map_register(&mygica_utv3_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_mygica_utv3() -> void __exit {
