...
//! Source: drivers/media/rc/keymaps/rc-msi-tvanywhere.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_msi_tvanywhere() -> int __init {
    static int __init init_rc_map_msi_tvanywhere(void)
    {
    return rc_map_register(&msi_tvanywhere_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_msi_tvanywhere() -> void __exit {
