...
//! Source: drivers/media/rc/keymaps/rc-proteus-2309.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_proteus_2309() -> int __init {
    static int __init init_rc_map_proteus_2309(void)
    {
    return rc_map_register(&proteus_2309_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_proteus_2309() -> void __exit {
