...
//! Source: drivers/media/rc/keymaps/rc-avermedia-m733a-rm-k6.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_avermedia_m733a_rm_k6() -> int __init {
    static int __init init_rc_map_avermedia_m733a_rm_k6(void)
    {
    return rc_map_register(&avermedia_m733a_rm_k6_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_avermedia_m733a_rm_k6() -> void __exit {
