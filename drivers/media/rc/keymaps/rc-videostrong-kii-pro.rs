...
//! Source: drivers/media/rc/keymaps/rc-videostrong-kii-pro.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_kii_pro() -> int __init {
    static int __init init_rc_map_kii_pro(void)
    {
    return rc_map_register(&kii_pro_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_kii_pro() -> void __exit {
