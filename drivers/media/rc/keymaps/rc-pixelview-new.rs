...
//! Source: drivers/media/rc/keymaps/rc-pixelview-new.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_pixelview_new() -> int __init {
    static int __init init_rc_map_pixelview_new(void)
    {
    return rc_map_register(&pixelview_new_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_pixelview_new() -> void __exit {
