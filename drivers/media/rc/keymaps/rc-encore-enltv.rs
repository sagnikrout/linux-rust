...
//! Source: drivers/media/rc/keymaps/rc-encore-enltv.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_encore_enltv() -> int __init {
    static int __init init_rc_map_encore_enltv(void)
    {
    return rc_map_register(&encore_enltv_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_encore_enltv() -> void __exit {
