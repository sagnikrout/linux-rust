...
//! Source: drivers/media/rc/keymaps/rc-fusionhdtv-mce.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_fusionhdtv_mce() -> int __init {
    static int __init init_rc_map_fusionhdtv_mce(void)
    {
    return rc_map_register(&fusionhdtv_mce_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_fusionhdtv_mce() -> void __exit {
