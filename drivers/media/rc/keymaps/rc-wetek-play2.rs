...
//! Source: drivers/media/rc/keymaps/rc-wetek-play2.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_wetek_play2() -> int __init {
    static int __init init_rc_map_wetek_play2(void)
    {
    return rc_map_register(&wetek_play2_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_wetek_play2() -> void __exit {
