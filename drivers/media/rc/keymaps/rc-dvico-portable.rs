...
//! Source: drivers/media/rc/keymaps/rc-dvico-portable.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_dvico_portable() -> int __init {
    static int __init init_rc_map_dvico_portable(void)
    {
    return rc_map_register(&dvico_portable_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_dvico_portable() -> void __exit {
