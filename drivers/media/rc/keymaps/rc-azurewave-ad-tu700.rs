...
//! Source: drivers/media/rc/keymaps/rc-azurewave-ad-tu700.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_azurewave_ad_tu700() -> int __init {
    static int __init init_rc_map_azurewave_ad_tu700(void)
    {
    return rc_map_register(&azurewave_ad_tu700_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_azurewave_ad_tu700() -> void __exit {
