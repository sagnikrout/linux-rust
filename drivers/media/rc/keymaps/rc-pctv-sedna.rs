...
//! Source: drivers/media/rc/keymaps/rc-pctv-sedna.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_pctv_sedna() -> int __init {
    static int __init init_rc_map_pctv_sedna(void)
    {
    return rc_map_register(&pctv_sedna_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_pctv_sedna() -> void __exit {
