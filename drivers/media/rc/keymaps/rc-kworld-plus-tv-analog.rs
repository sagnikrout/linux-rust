...
//! Source: drivers/media/rc/keymaps/rc-kworld-plus-tv-analog.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_kworld_plus_tv_analog() -> int __init {
    static int __init init_rc_map_kworld_plus_tv_analog(void)
    {
    return rc_map_register(&kworld_plus_tv_analog_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_kworld_plus_tv_analog() -> void __exit {
