...
//! Source: drivers/media/rc/keymaps/rc-msi-digivox-iii.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_msi_digivox_iii() -> int __init {
    static int __init init_rc_map_msi_digivox_iii(void)
    {
    return rc_map_register(&msi_digivox_iii_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_msi_digivox_iii() -> void __exit {
