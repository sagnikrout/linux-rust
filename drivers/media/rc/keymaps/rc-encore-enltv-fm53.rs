...
//! Source: drivers/media/rc/keymaps/rc-encore-enltv-fm53.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_encore_enltv_fm53() -> int __init {
    static int __init init_rc_map_encore_enltv_fm53(void)
    {
    return rc_map_register(&encore_enltv_fm53_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_encore_enltv_fm53() -> void __exit {
