...
//! Source: drivers/media/rc/keymaps/rc-hauppauge.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_rc5_hauppauge_new() -> int __init {
    static int __init init_rc_map_rc5_hauppauge_new(void)
    {
    return rc_map_register(&rc5_hauppauge_new_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_rc5_hauppauge_new() -> void __exit {
