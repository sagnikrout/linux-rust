...
//! Source: drivers/media/rc/keymaps/rc-beelink-mxiii.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_beelink_mxiii() -> int __init {
    static int __init init_rc_map_beelink_mxiii(void)
    {
    return rc_map_register(&beelink_mxiii_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_beelink_mxiii() -> void __exit {
