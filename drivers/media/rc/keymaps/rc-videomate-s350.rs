...
//! Source: drivers/media/rc/keymaps/rc-videomate-s350.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_videomate_s350() -> int __init {
    static int __init init_rc_map_videomate_s350(void)
    {
    return rc_map_register(&videomate_s350_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_videomate_s350() -> void __exit {
