...
//! Source: drivers/media/rc/keymaps/rc-videomate-k100.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_videomate_k100() -> int __init {
    static int __init init_rc_map_videomate_k100(void)
    {
    return rc_map_register(&videomate_k100_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_videomate_k100() -> void __exit {
