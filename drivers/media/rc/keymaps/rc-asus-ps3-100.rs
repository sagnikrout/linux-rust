...
//! Source: drivers/media/rc/keymaps/rc-asus-ps3-100.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_asus_ps3_100() -> int __init {
    static int __init init_rc_map_asus_ps3_100(void)
    {
    return rc_map_register(&asus_ps3_100_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_asus_ps3_100() -> void __exit {
