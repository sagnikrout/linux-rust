...
//! Source: drivers/media/rc/keymaps/rc-mecool-kii-pro.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_mecool_kii_pro() -> int __init {
    static int __init init_rc_map_mecool_kii_pro(void)
    {
    return rc_map_register(&mecool_kii_pro_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_mecool_kii_pro() -> void __exit {
