...
//! Source: drivers/media/rc/keymaps/rc-medion-x10-or2x.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_medion_x10_or2x() -> int __init {
    static int __init init_rc_map_medion_x10_or2x(void)
    {
    return rc_map_register(&medion_x10_or2x_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_medion_x10_or2x() -> void __exit {
