...
//! Source: drivers/media/rc/keymaps/rc-medion-x10-digitainer.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_rc_map_medion_x10_digitainer() -> int __init {
    static int __init init_rc_map_medion_x10_digitainer(void)
    {
    return rc_map_register(&medion_x10_digitainer_map);
    }
#[no_mangle]
unsafe extern "C" fn exit_rc_map_medion_x10_digitainer() -> void __exit {
