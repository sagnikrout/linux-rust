...
//! Source: drivers/media/rc/ttusbir.c
#![no_std]
...
//
pub const NUM_URBS: c_int = 4;
pub const US_PER_BYTE: c_int = 62;
...
pub struct ttusbir {
    ...
    pub urb: [*mut urb; NUM_URBS],
    pub led: led_classdev,
    pub bulk_urb: *mut urb,
    pub bulk_buffer: *mut u8,
    pub iso_in_endp: int bulk_out_endp,,
    pub is_led_on: bool led_on,,
    pub led_complete: core::sync::atomic::AtomicI32,
    pub phys: [c_char; 64],
}

#[no_mangle]
unsafe extern "C" fn ttusbir_brightness_get(led_dev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn ttusbir_set_led(tt: *mut ttusbir) {
...
//
#[no_mangle]
unsafe extern "C" fn ttusbir_bulk_complete(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn ttusbir_process_ir_data(tt: *mut ttusbir, buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn ttusbir_urb_complete(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn ttusbir_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ttusbir_resume(intf: *mut usb_interface) -> c_int {
