...
//! Source: drivers/media/rc/mceusb.c
#![no_std]
...
pub const MCE_IRDATA_TRAILER: c_uint = 0x80 /* End of IR data */;

pub const MCE_DEFAULT_TX_MASK: c_uint = 0x03 /* Vals: TX1=0x01, TX2=0x02, ALL=0x03 */;
pub const MCE_PULSE_BIT: c_uint = 0x80 /* Pulse bit, MSB set == PULSE else SPACE */;
pub const MCE_PULSE_MASK: c_uint = 0x7f /* Pulse mask */;
pub const MCE_MAX_PULSE_LENGTH: c_uint = 0x7f /* Longest transmittable pulse symbol */;
//
...
//
pub const MCE_CMD: c_uint = 0x1f;
pub const MCE_PORT_IR: c_uint = 0x4	/* (0x4 << 5) | MCE_CMD = 0x9f */;
pub const MCE_PORT_SYS: c_uint = 0x7	/* (0x7 << 5) | MCE_CMD = 0xff */;
pub const MCE_PORT_SER: c_uint = 0x6	/* 0xc0 through 0xdf flush & 0x1f bytes */;
pub const MCE_PORT_MASK: c_uint = 0xe0	/* Mask out command bits */;
// Command port headers
pub const MCE_CMD_PORT_IR: c_uint = 0x9f	/* IR-related cmd/rsp */;
pub const MCE_CMD_PORT_SYS: c_uint = 0xff	/* System (non-IR) device cmd/rsp */;
// Commands that set device state  (2-4 bytes in length)
pub const MCE_CMD_RESET: c_uint = 0xfe	/* Reset device, 2 bytes */;
pub const MCE_CMD_RESUME: c_uint = 0xaa	/* Resume device after error, 2 bytes */;
pub const MCE_CMD_SETIRCFS: c_uint = 0x06	/* Set tx carrier, 4 bytes */;
pub const MCE_CMD_SETIRTIMEOUT: c_uint = 0x0c	/* Set timeout, 4 bytes */;
pub const MCE_CMD_SETIRTXPORTS: c_uint = 0x08	/* Set tx ports, 3 bytes */;
pub const MCE_CMD_SETIRRXPORTEN: c_uint = 0x14	/* Set rx ports, 3 bytes */;
pub const MCE_CMD_FLASHLED: c_uint = 0x23	/* Flash receiver LED, 2 bytes */;
// Commands that query device state (all 2 bytes, unless noted)
pub const MCE_CMD_GETIRCFS: c_uint = 0x07	/* Get carrier */;
pub const MCE_CMD_GETIRTIMEOUT: c_uint = 0x0d	/* Get timeout */;
pub const MCE_CMD_GETIRTXPORTS: c_uint = 0x13	/* Get tx ports */;
pub const MCE_CMD_GETIRRXPORTEN: c_uint = 0x15	/* Get rx ports */;
pub const MCE_CMD_GETPORTSTATUS: c_uint = 0x11	/* Get tx port status, 3 bytes */;
pub const MCE_CMD_GETIRNUMPORTS: c_uint = 0x16	/* Get number of ports */;
pub const MCE_CMD_GETWAKESOURCE: c_uint = 0x17	/* Get wake source */;
pub const MCE_CMD_GETEMVER: c_uint = 0x22	/* Get emulator interface version */;
pub const MCE_CMD_GETDEVDETAILS: c_uint = 0x21	/* Get device details (em ver2 only) */;
pub const MCE_CMD_GETWAKESUPPORT: c_uint = 0x20	/* Get wake details (em ver2 only) */;
pub const MCE_CMD_GETWAKEVERSION: c_uint = 0x18	/* Get wake pattern (em ver2 only) */;
// Misc commands
pub const MCE_CMD_NOP: c_uint = 0xff	/* No operation */;
// Responses to commands (non-error cases)
pub const MCE_RSP_EQIRCFS: c_uint = 0x06	/* tx carrier, 4 bytes */;
pub const MCE_RSP_EQIRTIMEOUT: c_uint = 0x0c	/* rx timeout, 4 bytes */;
pub const MCE_RSP_GETWAKESOURCE: c_uint = 0x17	/* wake source, 3 bytes */;
pub const MCE_RSP_EQIRTXPORTS: c_uint = 0x08	/* tx port mask, 3 bytes */;
pub const MCE_RSP_EQIRRXPORTEN: c_uint = 0x14	/* rx port mask, 3 bytes */;
pub const MCE_RSP_GETPORTSTATUS: c_uint = 0x11	/* tx port status, 7 bytes */;
pub const MCE_RSP_EQIRRXCFCNT: c_uint = 0x15	/* rx carrier count, 4 bytes */;
pub const MCE_RSP_EQIRNUMPORTS: c_uint = 0x16	/* number of ports, 4 bytes */;
pub const MCE_RSP_EQWAKESUPPORT: c_uint = 0x20	/* wake capabilities, 3 bytes */;
pub const MCE_RSP_EQWAKEVERSION: c_uint = 0x18	/* wake pattern details, 6 bytes */;
pub const MCE_RSP_EQDEVDETAILS: c_uint = 0x21	/* device capabilities, 3 bytes */;
pub const MCE_RSP_EQEMVER: c_uint = 0x22	/* emulator interface ver, 3 bytes */;
pub const MCE_RSP_FLASHLED: c_uint = 0x23	/* success flashing LED, 2 bytes */;
// Responses to error cases, must send MCE_CMD_RESUME to clear them
pub const MCE_RSP_CMD_ILLEGAL: c_uint = 0xfe	/* illegal command for port, 2 bytes */;
pub const MCE_RSP_TX_TIMEOUT: c_uint = 0x81	/* tx timed out, 2 bytes */;
// Misc commands/responses not defined in the MCE remote/transceiver spec
pub const MCE_CMD_SIG_END: c_uint = 0x01	/* End of signal */;
pub const MCE_CMD_PING: c_uint = 0x03	/* Ping device */;
pub const MCE_CMD_UNKNOWN: c_uint = 0x04	/* Unknown */;
pub const MCE_CMD_UNKNOWN2: c_uint = 0x05	/* Unknown */;
pub const MCE_CMD_UNKNOWN3: c_uint = 0x09	/* Unknown */;
pub const MCE_CMD_UNKNOWN4: c_uint = 0x0a	/* Unknown */;
pub const MCE_CMD_G_REVISION: c_uint = 0x0b	/* Get hw/sw revision */;
pub const MCE_CMD_UNKNOWN5: c_uint = 0x0e	/* Unknown */;
pub const MCE_CMD_UNKNOWN6: c_uint = 0x0f	/* Unknown */;
pub const MCE_CMD_UNKNOWN8: c_uint = 0x19	/* Unknown */;
pub const MCE_CMD_UNKNOWN9: c_uint = 0x1b	/* Unknown */;
pub const MCE_CMD_NULL: c_uint = 0x00	/* These show up various places... */;
// if buf[i] & MCE_PORT_MASK == 0x80 and buf[i] != MCE_CMD_PORT_IR,
// then we're looking at a raw IR data sample
pub const MCE_COMMAND_IRDATA: c_uint = 0x80;
pub const MCE_PACKET_LENGTH_MASK: c_uint = 0x1f /* Packet length mask */;
pub const VENDOR_PHILIPS: c_uint = 0x0471;
pub const VENDOR_SMK: c_uint = 0x0609;
pub const VENDOR_TATUNG: c_uint = 0x1460;
pub const VENDOR_GATEWAY: c_uint = 0x107b;
pub const VENDOR_SHUTTLE: c_uint = 0x1308;
pub const VENDOR_SHUTTLE2: c_uint = 0x051c;
pub const VENDOR_MITSUMI: c_uint = 0x03ee;
pub const VENDOR_TOPSEED: c_uint = 0x1784;
pub const VENDOR_RICAVISION: c_uint = 0x179d;
pub const VENDOR_ITRON: c_uint = 0x195d;
pub const VENDOR_FIC: c_uint = 0x1509;
pub const VENDOR_LG: c_uint = 0x043e;
pub const VENDOR_MICROSOFT: c_uint = 0x045e;
pub const VENDOR_FORMOSA: c_uint = 0x147a;
pub const VENDOR_FINTEK: c_uint = 0x1934;
pub const VENDOR_PINNACLE: c_uint = 0x2304;
pub const VENDOR_ECS: c_uint = 0x1019;
pub const VENDOR_WISTRON: c_uint = 0x0fb8;
pub const VENDOR_COMPRO: c_uint = 0x185b;
pub const VENDOR_NORTHSTAR: c_uint = 0x04eb;
pub const VENDOR_REALTEK: c_uint = 0x0bda;
pub const VENDOR_TIVO: c_uint = 0x105a;
pub const VENDOR_CONEXANT: c_uint = 0x0572;
pub const VENDOR_TWISTEDMELON: c_uint = 0x2596;
pub const VENDOR_HAUPPAUGE: c_uint = 0x2040;
pub const VENDOR_PCTV: c_uint = 0x2013;
pub const VENDOR_ADAPTEC: c_uint = 0x03f3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mceusb_model {
    pub mce_gen1:1: u32,
    pub mce_gen2:1: u32,
    pub mce_gen3:1: u32,
    pub tx_mask_normal:1: u32,
    pub no_tx:1: u32,
    pub broken_irtimeout:1: u32,
//
...
//
    pub rx2: u32,
    pub ir_intfnum: c_int,
    pub /: *const *const *const char rc_map; / Allow specify a per-board map,
    pub /: *const *const *const char name; / per-board name,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mceusb_dev {
// ir-core bits
    pub rc: *mut rc_dev,
// optional features we can enable
    pub carrier_report_enabled: bool,
    pub /: *mut *mut bool wideband_rx_enabled; / aka learning mode, short-range rx,
// core device bits
    pub dev: *mut device,
// usb
    pub usbdev: *mut usb_device,
    pub usbintf: *mut usb_interface,
    pub urb_in: *mut urb,
    pub pipe_in: c_uint,
    pub usb_ep_out: *mut usb_endpoint_descriptor,
    pub pipe_out: c_uint,
// buffers and dma
    pub buf_in: *mut c_uchar,
    pub len_in: c_uint,
    ...
    PARSE_IRDATA,
    pub parser_state: },
    pub /: *mut *mut u8 cmd, rem; / Remaining IR data bytes in packet,
    struct {
    pub connected:1: u32,
    pub tx_mask_normal:1: u32,
    pub microsoft_gen1:1: u32,
    pub no_tx:1: u32,
    pub rx2: u32,
    pub flags: },
// transmit support
    ...
    pub tx_mask: c_uchar,
    pub phys: [c_char; 64],
    pub model: enum mceusb_model_type,
    pub /: *mut *mut bool need_reset; / flag to issue a device resume cmd,
    pub /: *mut *mut u8 emver; / emulator interface version,
    pub /: *mut *mut u8 num_txports; / number of transmit ports,
    pub /: *mut *mut u8 num_rxports; / number of receive sensors,
    pub /: *mut *mut u8 txports_cabled; / bitmask of transmitters with cable,
    pub /: *mut *mut u8 rxports_active; / bitmask of active receive sensors,
    pub /: *mut *mut bool learning_active; / wideband rx is active,
// receiver carrier frequency detection support
    pub /: *mut *mut u32 pulse_tunit; / IR pulse "on" cumulative time units,
    pub /: *mut *mut u32 pulse_count; / pulse "on" count in measurement interval,
//
...
//
#[no_mangle]
unsafe extern "C" fn mceusb_cmd_datasize(cmd: u8, subcmd: u8) -> c_int {
    static int mceusb_cmd_datasize(u8 cmd, u8 subcmd)
    {
    let mut datasize: c_int = 0;
    switch (cmd) {
    case MCE_CMD_NULL:
...
//
#[no_mangle]
unsafe extern "C" fn mceusb_defer_kevent(ir: *mut mceusb_dev, kevent: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mce_write_callback(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn mce_write(ir: *mut mceusb_dev, data: *mut u8, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mce_command_out(ir: *mut mceusb_dev, data: *mut u8, size: c_int) {
    static void mce_command_out(struct mceusb_dev *ir, u8 *data, int size)
    {
    let mut rsize: c_int = sizeof(DEVICE_RESUME);
    if (ir.need_reset) {
    ir.need_reset = false;
...
//
#[no_mangle]
unsafe extern "C" fn mceusb_tx_ir(dev: *mut rc_dev, txbuf: *mut unsigned, count: unsigned) -> c_int {
    static int mceusb_tx_ir(struct rc_dev *dev, unsigned *txbuf, unsigned count)
    {
    struct mceusb_dev *ir = dev.priv;
    u8 cmdbuf[3] = { MCE_CMD_PORT_IR, MCE_CMD_SETIRTXPORTS, 0x00 };
    u8 irbuf[MCE_IRBUF_SIZE];
    let mut ircount: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn mceusb_set_tx_mask(dev: *mut rc_dev, mask: u32) -> c_int {
    static int mceusb_set_tx_mask(struct rc_dev *dev, u32 mask)
    {
    struct mceusb_dev *ir = dev.priv;
// return number of transmitters
    let mut emitters: c_int = ir.num_txports ? ir.num_txports : 2;
    if (mask >= (1 << emitters))
    return emitters;
...
#[no_mangle]
unsafe extern "C" fn mceusb_set_tx_carrier(dev: *mut rc_dev, carrier: u32) -> c_int {
    static int mceusb_set_tx_carrier(struct rc_dev *dev, u32 carrier)
    {
    struct mceusb_dev *ir = dev.priv;
    let mut clk: c_int = 10000000;
    let mut prescaler: c_int = 0, divisor = 0;
...
#[no_mangle]
unsafe extern "C" fn mceusb_set_timeout(dev: *mut rc_dev, timeout: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mceusb_set_rx_wideband(dev: *mut rc_dev, enable: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mceusb_set_rx_carrier_report(dev: *mut rc_dev, enable: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mceusb_handle_command(ir: *mut mceusb_dev, buf_in: *mut u8) {
    static void mceusb_handle_command(struct mceusb_dev *ir, u8 *buf_in)
    {
    let mut cmd: u8 = buf_in[0];
    let mut subcmd: u8 = buf_in[1];
...
#[no_mangle]
unsafe extern "C" fn mceusb_process_ir_data(ir: *mut mceusb_dev, buf_len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mceusb_dev_recv(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn mceusb_get_emulator_version(ir: *mut mceusb_dev) {
...
#[no_mangle]
unsafe extern "C" fn mceusb_gen1_init(ir: *mut mceusb_dev) {
...
// set feature: bit rate 38400 bps
    ...
    0xc04e, 0x0000, core::ptr::null_mut(), 0, 3000, GFP_KERNEL);
    dev_dbg(dev, "set feature - ret = %d", ret);
// bRequest 4: set char length to 8 bits
    ret = usb_control_msg_send(ir.usbdev, 0,
    4, USB_TYPE_VENDOR,
    0x0808, 0x0000, core::ptr::null_mut(), 0, 3000, GFP_KERNEL);
    dev_dbg(dev, "set char length - retB = %d", ret);
// bRequest 2: set handshaking to use DTR/DSR
    ret = usb_control_msg_send(ir.usbdev, 0,
    2, USB_TYPE_VENDOR,
    0x0000, 0x0100, core::ptr::null_mut(), 0, 3000, GFP_KERNEL);
...
#[no_mangle]
unsafe extern "C" fn mceusb_gen2_init(ir: *mut mceusb_dev) {
...
#[no_mangle]
unsafe extern "C" fn mceusb_get_parameters(ir: *mut mceusb_dev) {
...
#[no_mangle]
unsafe extern "C" fn mceusb_flash_led(ir: *mut mceusb_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn mceusb_deferred_kevent(work: *mut work_struct) {
...
//
    ...
    struct usb_endpoint_descriptor *ep = core::ptr::null_mut();
    struct usb_endpoint_descriptor *ep_in = core::ptr::null_mut();
    struct usb_endpoint_descriptor *ep_out = core::ptr::null_mut();
    struct mceusb_dev *ir = core::ptr::null_mut();
    int pipe, maxp, i, res;
    char buf[63], name[128] = "";
    let mut model: enum mceusb_model_type = id.driver_info;
    bool is_gen3;
...
// initialize device
    ...
    mceusb_gen1_init(ir);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !is_gen3) -> else {
    else if (!is_gen3)
    mceusb_gen2_init(ir);
...
#[no_mangle]
unsafe extern "C" fn mceusb_dev_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn mceusb_dev_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mceusb_dev_resume(intf: *mut usb_interface) -> c_int {
