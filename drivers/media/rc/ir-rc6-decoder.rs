...
//! Source: drivers/media/rc/ir-rc6-decoder.c
#![no_std]
...
pub const RC6_0_NBITS: c_int = 16;
pub const RC6_6A_32_NBITS: c_int = 32;

pub const RC6_MODE_MASK: c_uint = 0x07	/* for the header bits */;
pub const RC6_STARTBIT_MASK: c_uint = 0x08	/* for the header bits */;
pub const RC6_6A_MCE_TOGGLE_MASK: c_uint = 0x8000	/* for the body bits */;
pub const RC6_6A_LCC_MASK: c_uint = 0xffff0000 /* RC6-6A-32 long customer code mask */;
pub const RC6_6A_MCE_CC: c_uint = 0x800f0000 /* MCE customer code */;
pub const RC6_6A_ZOTAC_CC: c_uint = 0x80340000 /* Zotac customer code */;
pub const RC6_6A_KATHREIN_CC: c_uint = 0x80460000 /* Kathrein RCU-676 customer code */;
...
#[no_mangle]
unsafe extern "C" fn rc6_mode(data: *mut rc6_dec) -> enum rc6_mode {
...
//
#[no_mangle]
unsafe extern "C" fn ir_rc6_decode(dev: *mut rc_dev, ev: ir_raw_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ir_rc6_decode_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ir_rc6_decode_exit() -> void __exit {
