...
//! Source: drivers/media/rc/lirc_dev.c
#![no_std]
...
pub const LIRCBUF_SIZE: c_int = 1024;
...
//
#[no_mangle]
pub unsafe extern "C" fn lirc_raw_event(dev: *mut rc_dev, ev: ir_raw_event) {
...
//
#[no_mangle]
pub unsafe extern "C" fn lirc_scancode_event(dev: *mut rc_dev, lsc: *mut lirc_scancode) {
...
#[no_mangle]
unsafe extern "C" fn lirc_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lirc_close(inode: *mut inode, file: *mut file) -> c_int {
    ...
    struct rc_dev *dev = fh.rc;
    unsigned int *txbuf;
    struct ir_raw_event *raw = core::ptr::null_mut();
    ssize_t ret;
    size_t count;
    ktime_t start;
    s64 towait;
...
// drop trailing space
    ...
    if (dev.s_tx_carrier) {
    let mut carrier: c_int = ir_raw_encode_carrier(scan.rc_proto);
    if (carrier > 0)
...
#[no_mangle]
unsafe extern "C" fn lirc_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
// mode support
    ...
    ret = -ENOTTY;
#[no_mangle]
pub unsafe extern "C" fn if(LIRC_MODE_SCANCODE): !(val == LIRC_MODE_PULSE || val ==) -> else {
...
// TX settings
    ...
    ret = -ENOTTY;
#[no_mangle]
pub unsafe extern "C" fn if(100: val <= 0 || val >=) -> else {
...
// Generic timeout support
    ...
    ret = -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dev->s_timeout) -> else {
...
#[no_mangle]
unsafe extern "C" fn lirc_poll(file: *mut file, wait: *mut poll_table_struct) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn lirc_release_device(ld: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn lirc_register(dev: *mut rc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lirc_unregister(dev: *mut rc_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn lirc_dev_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn lirc_dev_exit() -> void __exit {
