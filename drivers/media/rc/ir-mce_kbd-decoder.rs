...
//! Source: drivers/media/rc/ir-mce_kbd-decoder.c
#![no_std]
...
pub const MCIR2_HEADER_NBITS: c_int = 5;
pub const MCIR2_MOUSE_NBITS: c_int = 29;
pub const MCIR2_KEYBOARD_NBITS: c_int = 32;

pub const MCIR2_MODE_MASK: c_uint = 0xf	/* for the header bits */;
pub const MCIR2_KEYBOARD_HEADER: c_uint = 0x4;
pub const MCIR2_MOUSE_HEADER: c_uint = 0x1;
pub const MCIR2_MASK_KEYS_START: c_uint = 0xe0;
    enum mce_kbd_mode {
    MCIR2_MODE_KEYBOARD,
    MCIR2_MODE_MOUSE,
    MCIR2_MODE_UNKNOWN,
...
#[no_mangle]
unsafe extern "C" fn mce_kbd_rx_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn mce_kbd_mode(data: *mut mce_kbd_dec) -> enum mce_kbd_mode {
...
#[no_mangle]
unsafe extern "C" fn ir_mce_kbd_process_keyboard_data(dev: *mut rc_dev, scancode: u32) {
    static void ir_mce_kbd_process_keyboard_data(struct rc_dev *dev, u32 scancode)
    {
    let mut keydata1: u8 = (scancode >> 8) & 0xff;
    let mut keydata2: u8 = (scancode >> 16) & 0xff;
    let mut shiftmask: u8 = scancode & 0xff;
    unsigned char maskcode;
    int i, keystate;
...
#[no_mangle]
unsafe extern "C" fn ir_mce_kbd_process_mouse_data(dev: *mut rc_dev, scancode: u32) {
    static void ir_mce_kbd_process_mouse_data(struct rc_dev *dev, u32 scancode)
    {
// raw mouse coordinates
    let mut xdata: u8 = (scancode >> 7) & 0x7f;
    let mut ydata: u8 = (scancode >> 14) & 0x7f;
    int x, y;
// mouse buttons
    let mut right: bool = scancode & 0x40;
    let mut left: bool = scancode & 0x20;
    if (xdata & 0x40)
    x = -((~xdata & 0x7f) + 1);
    else
    x = xdata;
...
//
#[no_mangle]
unsafe extern "C" fn ir_mce_kbd_decode(dev: *mut rc_dev, ev: ir_raw_event) -> c_int {
    static int ir_mce_kbd_decode(struct rc_dev *dev, struct ir_raw_event ev)
    {
    struct mce_kbd_dec *data = &dev.raw.mce_kbd;
    u32 scancode;
    unsigned long delay;
    let mut lsc: lirc_scancode = {};
...
#[no_mangle]
unsafe extern "C" fn ir_mce_kbd_register(dev: *mut rc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ir_mce_kbd_unregister(dev: *mut rc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ir_mce_kbd_decode_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ir_mce_kbd_decode_exit() -> void __exit {
