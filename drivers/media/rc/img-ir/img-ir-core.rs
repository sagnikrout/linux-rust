...
//! Source: drivers/media/rc/img-ir/img-ir-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn img_ir_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn img_ir_setup(priv: *mut img_ir_priv) {
...
#[no_mangle]
unsafe extern "C" fn img_ir_ident(priv: *mut img_ir_priv) {
    static void img_ir_ident(struct img_ir_priv *priv)
    {
    let mut core_rev: u32 = img_ir_read(priv, IMG_IR_CORE_REV);
    dev_info(priv.dev,
...
#[no_mangle]
unsafe extern "C" fn img_ir_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn img_ir_remove(pdev: *mut platform_device) {
