...
//! Source: drivers/media/rc/pwm-ir-tx.c
#![no_std]
...
pub struct pwm_ir {
    ...
    pub carrier: u32,
    pub duty_cycle: u32,
    pub txbuf: *const c_uint,
    pub txbuf_len: c_uint,
    pub txbuf_index: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn pwm_ir_set_duty_cycle(dev: *mut rc_dev, duty_cycle: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_ir_set_carrier(dev: *mut rc_dev, carrier: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_ir_timer(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn pwm_ir_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (!pwm_ir)
    return -ENOMEM;
    pwm_ir.pwm = devm_pwm_get(&pdev.dev, core::ptr::null_mut());
