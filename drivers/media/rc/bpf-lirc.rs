...
//! Source: drivers/media/rc/bpf-lirc.c
#![no_std]
...
// We have one field of u32
    let mut type: return = = BPF_READ && off == 0 && size == sizeof(u32);
    }
...
pub const BPF_MAX_PROGS: c_int = 64;
#[no_mangle]
unsafe extern "C" fn lirc_bpf_attach(rcdev: *mut rc_dev, prog: *mut bpf_prog) -> c_int {
    ...
    ret = bpf_prog_array_copy(old_array, core::ptr::null_mut(), prog, 0, &new_array);
    if (ret < 0)
    goto unlock;
...
#[no_mangle]
unsafe extern "C" fn lirc_bpf_detach(rcdev: *mut rc_dev, prog: *mut bpf_prog) -> c_int {
    ...
    old_array = lirc_rcu_dereference(raw.progs);
    ret = bpf_prog_array_copy(old_array, prog, core::ptr::null_mut(), 0, &new_array);
//
...
#[no_mangle]
pub unsafe extern "C" fn lirc_bpf_run(rcdev: *mut rc_dev, sample: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn lirc_bpf_free(rcdev: *mut rc_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn lirc_prog_attach(attr: *const union bpf_attr, prog: *mut bpf_prog) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lirc_prog_detach(attr: *const union bpf_attr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lirc_prog_query(attr: *const union bpf_attr, uattr: *mut union bpf_attr __user) -> c_int {
