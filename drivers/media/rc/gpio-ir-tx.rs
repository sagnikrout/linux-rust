...
//! Source: drivers/media/rc/gpio-ir-tx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gpio_ir_tx_set_duty_cycle(dev: *mut rc_dev, duty_cycle: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_ir_tx_set_carrier(dev: *mut rc_dev, carrier: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn delay_until(until: ktime_t) {
...
// pulse
    let mut last: ktime_t = ktime_add_us(edge, txbuf[i]);
...
#[no_mangle]
unsafe extern "C" fn gpio_ir_tx_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (!rcdev)
    return -ENOMEM;
    gpio_ir.gpio = devm_gpiod_get(&pdev.dev, core::ptr::null_mut(), GPIOD_OUT_LOW);
