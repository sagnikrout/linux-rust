...
//! Source: drivers/media/rc/ati_remote.c
#![no_std]
...
//
pub const ATI_REMOTE_VENDOR_ID: c_uint = 0x0bc7;
pub const LOLA_REMOTE_PRODUCT_ID: c_uint = 0x0002;
pub const LOLA2_REMOTE_PRODUCT_ID: c_uint = 0x0003;
pub const ATI_REMOTE_PRODUCT_ID: c_uint = 0x0004;
pub const NVIDIA_REMOTE_PRODUCT_ID: c_uint = 0x0005;
pub const MEDION_REMOTE_PRODUCT_ID: c_uint = 0x0006;
pub const FIREFLY_REMOTE_PRODUCT_ID: c_uint = 0x0008;
...
//
    ...
    let mut repeat_filter: static int = FILTER_TIME;
    module_param(repeat_filter, int, 0644);
    MODULE_PARM_DESC(repeat_filter, "Repeat filter time, default = 60 msec");
    let mut repeat_delay: static int = REPEAT_DELAY;
    module_param(repeat_delay, int, 0644);
    MODULE_PARM_DESC(repeat_delay, "Delay before sending repeats, default = 500 msec");
    let mut mouse: static bool = true;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ati_receiver_type {
// either default_keymap or get_default_keymap should be set
    pub default_keymap: *const c_char,
    pub interface): *const *const *const char (get_default_keymap)(struct usb_interface,
}
...
pub const SEND_FLAG_IN_PROGRESS: c_int = 1;
pub const SEND_FLAG_COMPLETE: c_int = 2;
// Device initialization strings
    static char init1[] = { 0x01, 0x00, 0x20, 0x14 };
    static char init2[] = { 0x01, 0x00, 0x20, 0x14, 0x20, 0x20, 0x20 };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ati_remote {
    ...
    pub irq_urb: *mut urb,
    pub out_urb: *mut urb,
    pub endpoint_in: *mut usb_endpoint_descriptor,
    pub endpoint_out: *mut usb_endpoint_descriptor,
    pub inbuf: *mut c_uchar,
    pub outbuf: *mut c_uchar,
    pub inbuf_dma: dma_addr_t,
    pub outbuf_dma: dma_addr_t,
    pub /: *mut *mut unsigned char old_data; / Detect duplicate events,
    pub old_jiffies: c_ulong,
    pub /: *mut *mut unsigned long acc_jiffies; / handle acceleration,
    pub first_jiffies: c_ulong,
    pub repeat_count: c_uint,
    pub rc_name: [c_char; NAME_BUFSIZE],
    pub rc_phys: [c_char; NAME_BUFSIZE],
    pub 6]: char mouse_name[NAME_BUFSIZE +,
    pub mouse_phys: [c_char; NAME_BUFSIZE],
    pub wait: wait_queue_head_t,
    pub send_flags: c_int,
    pub /: *mut *mut int users; / 0-2, users are rc and input,
    pub open_mutex: mutex,
}

// "Kinds" of messages sent from the hardware to the driver.
pub const KIND_END: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn ati_remote_open(ati_remote: *mut ati_remote) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ati_remote_close(ati_remote: *mut ati_remote) {
...
#[no_mangle]
unsafe extern "C" fn ati_remote_input_open(inputdev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_remote_input_close(inputdev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn ati_remote_rc_open(rdev: *mut rc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_remote_rc_close(rdev: *mut rc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn ati_remote_irq_out(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn ati_remote_compute_accel(ati_remote: *mut ati_remote) -> c_int {
    static int ati_remote_compute_accel(struct ati_remote *ati_remote)
    {
    let mut now: c_ulong = jiffies, reset_time;
    int i;
    ...
    let mut timeout: c_ulong = msecs_to_jiffies(accel[i].msecs);
...
//
#[no_mangle]
unsafe extern "C" fn ati_remote_input_report(urb: *mut urb) {
    ...
    let mut wheel_keycode: u32 = KEY_RESERVED;
    int i;
//
// data[0] = 0x14
...
//
    ...
    let mut dx: signed char = ati_remote_tbl[index].code >> 8;
    let mut dy: signed char = ati_remote_tbl[index].code & 255;
//
// Other event kinds are from the directional control pad, and
// have an acceleration factor applied to them.  Without this
// acceleration, the control pad is mostly unusable.
//
    let mut acc: c_int = ati_remote_compute_accel(ati_remote);
    if (dx)
...
//
#[no_mangle]
unsafe extern "C" fn ati_remote_irq_in(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn ati_remote_free_buffers(ati_remote: *mut ati_remote) {
...
#[no_mangle]
unsafe extern "C" fn ati_remote_input_init(ati_remote: *mut ati_remote) {
...
#[no_mangle]
unsafe extern "C" fn ati_remote_rc_init(ati_remote: *mut ati_remote) {
...
#[no_mangle]
unsafe extern "C" fn ati_remote_initialize(ati_remote: *mut ati_remote) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: type->get_default_keymap) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ati_remote_disconnect(interface: *mut usb_interface) {
