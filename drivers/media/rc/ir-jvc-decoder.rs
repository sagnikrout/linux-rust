...
//! Source: drivers/media/rc/ir-jvc-decoder.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ir_jvc_decode(dev: *mut rc_dev, ev: ir_raw_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ir_jvc_decode_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ir_jvc_decode_exit() -> void __exit {
