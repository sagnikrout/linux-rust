...
//! Source: drivers/media/rc/xbox_remote.c
#![no_std]
...
//
pub const VENDOR_GAMESTER: c_uint = 0x040b;
...
#[no_mangle]
unsafe extern "C" fn xbox_remote_rc_open(rdev: *mut rc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xbox_remote_rc_close(rdev: *mut rc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn xbox_remote_input_report(urb: *mut urb) {
...
//
#[no_mangle]
unsafe extern "C" fn xbox_remote_irq_in(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn xbox_remote_rc_init(xbox_remote: *mut xbox_remote) {
...
//
#[no_mangle]
unsafe extern "C" fn xbox_remote_disconnect(interface: *mut usb_interface) {
