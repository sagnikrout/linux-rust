...
//! Source: drivers/media/rc/rc-ir-raw.c
#![no_std]
...
// Used to handle IR raw handler extensions
    ...
    let mut available_protocols: static atomic64_t = ATOMIC64_INIT(0);
#[no_mangle]
unsafe extern "C" fn ir_raw_event_thread(data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ir_raw_event_store(dev: *mut rc_dev, ev: *mut ir_raw_event) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ir_raw_event_store_edge(dev: *mut rc_dev, pulse: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ir_raw_event_store_with_timeout(dev: *mut rc_dev, ev: *mut ir_raw_event) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ir_raw_event_store_with_filter(dev: *mut rc_dev, ev: *mut ir_raw_event) -> c_int {
...
// Ignore spaces in idle mode
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dev->idle) -> else {
    else if (dev.idle)
    ir_raw_event_set_idle(dev, false);
    if (!dev.raw.this_ev.duration)
    dev.raw.this_ev = *ev;
#[no_mangle]
pub unsafe extern "C" fn if(dev->raw->this_ev.pulse: ev->pulse ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn ir_raw_event_set_idle(dev: *mut rc_dev, idle: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ir_raw_event_handle(dev: *mut rc_dev) {
...
#[no_mangle]
unsafe extern "C" fn change_protocol(dev: *mut rc_dev, rc_proto: *mut u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(dev->max_timeout: timeout >) -> else {
...
#[no_mangle]
unsafe extern "C" fn ir_raw_disable_protocols(dev: *mut rc_dev, protocols: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !max--) -> else {
    else if (!max--)
    goto nobufs;
    else
    init_ir_raw_event_duration(++(*ev), 0,
...
//
#[no_mangle]
unsafe extern "C" fn ir_raw_edge_handle(t: *mut timer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ir_raw_encode_carrier(protocol: enum rc_proto) -> c_int {
    int ir_raw_encode_carrier(enum rc_proto protocol)
    {
    struct ir_raw_handler *handler;
    let mut ret: c_int = -EINVAL;
    let mut mask: u64 = BIT_ULL(protocol);
    mutex_lock(&ir_raw_handler_lock);
    list_for_each_entry(handler, &ir_raw_handler_list, list) {
    if (handler.protocols & mask && handler.encode) {
    ret = handler.carrier;
...
//
#[no_mangle]
pub unsafe extern "C" fn ir_raw_event_prepare(dev: *mut rc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ir_raw_event_register(dev: *mut rc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ir_raw_event_free(dev: *mut rc_dev) {
    void ir_raw_event_free(struct rc_dev *dev)
    {
    kfree(dev.raw);
    dev.raw = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn ir_raw_event_unregister(dev: *mut rc_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ir_raw_handler_register(ir_raw_handler: *mut ir_raw_handler) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ir_raw_handler_unregister(ir_raw_handler: *mut ir_raw_handler) {
    void ir_raw_handler_unregister(struct ir_raw_handler *ir_raw_handler)
    {
    struct ir_raw_event_ctrl *raw;
    let mut protocols: u64 = ir_raw_handler.protocols;
    mutex_lock(&ir_raw_handler_lock);
