...
//! Source: drivers/media/rc/serial_ir.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct serial_ir_hw {
    pub signal_pin: c_int,
    pub signal_pin_change: c_int,
    pub on: u8,
    pub off: u8,
    pub set_send_carrier:1: unsigned,
    pub set_duty_cycle:1: unsigned,
    pub edge): *mut *mut void (send_pulse)(unsigned int length, ktime_t,
    pub (*send_space)(void): *mut c_void,
    pub lock: spinlock_t,
}

pub const IR_HOMEBREW: c_int = 0;
pub const IR_IRDEO: c_int = 1;
pub const IR_IRDEO_REMOTE: c_int = 2;
pub const IR_ANIMAX: c_int = 3;
pub const IR_IGOR: c_int = 4;
// module parameters
    static int type;
    static int io;
    static int irq;
    static ulong iommap;
    static int ioshift;
    let mut softcarrier: static bool = true;
...
pub const RS_ISR_PASS_LIMIT: c_int = 256;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct serial_ir {
    pub lastkt: ktime_t,
...
#[no_mangle]
unsafe extern "C" fn sinp(offset: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn soutp(offset: c_int, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn send_pulse_irdeo(length: c_uint, target: ktime_t) {
...
#[no_mangle]
unsafe extern "C" fn send_space_irdeo() {
    static void send_space_irdeo(void)
    {
    }

#[no_mangle]
unsafe extern "C" fn send_pulse_homebrew_softcarrier(length: c_uint, edge: ktime_t) {
...
#[no_mangle]
unsafe extern "C" fn send_pulse_homebrew(length: c_uint, edge: ktime_t) {
    static void send_pulse_homebrew(unsigned int length, ktime_t edge)
    {
    if (softcarrier)
...
#[no_mangle]
unsafe extern "C" fn send_space_homebrew() {
    static void send_space_homebrew(void)
    {
    off();
    }
...
#[no_mangle]
unsafe extern "C" fn frbwrite(l: c_uint, is_pulse: bool) {
...
#[no_mangle]
unsafe extern "C" fn serial_ir_irq_handler(i: c_int, blah: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn hardware_init_port() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_ir_timeout(unused: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn serial_ir_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(-EINVAL: result ==) -> else {
...
// Reserve io region.
    ...
    KBUILD_MODNAME) == core::ptr::null_mut())) ||
...
#[no_mangle]
unsafe extern "C" fn serial_ir_open(rcdev: *mut rc_dev) -> c_int {
    static int serial_ir_open(struct rc_dev *rcdev)
    {
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn serial_ir_close(rcdev: *mut rc_dev) {
    static void serial_ir_close(struct rc_dev *rcdev)
    {
    unsigned long flags;
    spin_lock_irqsave(&hardware[type].lock, flags);
...
#[no_mangle]
unsafe extern "C" fn serial_ir_tx_duty_cycle(dev: *mut rc_dev, cycle: u32) -> c_int {
    static int serial_ir_tx_duty_cycle(struct rc_dev *dev, u32 cycle)
    {
...
#[no_mangle]
unsafe extern "C" fn serial_ir_tx_carrier(dev: *mut rc_dev, carrier: u32) -> c_int {
    static int serial_ir_tx_carrier(struct rc_dev *dev, u32 carrier)
    {
...
#[no_mangle]
unsafe extern "C" fn serial_ir_resume(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_ir_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn serial_ir_exit() {
...
#[no_mangle]
unsafe extern "C" fn serial_ir_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn serial_ir_exit_module() -> void __exit {
