...
//! Source: drivers/media/pci/saa7164/saa7164-encoder.c
#![no_std]
...
pub const ENCODER_MAX_BITRATE: c_int = 6500000;
pub const ENCODER_MIN_BITRATE: c_int = 1000000;
pub const ENCODER_DEF_BITRATE: c_int = 5000000;
//
...
//
#[no_mangle]
unsafe extern "C" fn saa7164_encoder_configure(port: *mut saa7164_port) {
...
#[no_mangle]
unsafe extern "C" fn saa7164_encoder_buffers_dealloc(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_encoder_buffers_alloc(port: *mut saa7164_port) -> c_int {
...
// Init and establish defaults
    ...
    params.pagetablelistvirt = core::ptr::null_mut();
    params.pagetablelistphys = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn saa7164_encoder_initialize(port: *mut saa7164_port) -> c_int {
...
// -- V4L2 ---------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn saa7164_s_std(port: *mut saa7164_port, id: v4l2_std_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_g_std(port: *mut saa7164_port, id: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_enum_input(file: *mut file, priv: *mut c_void, i: *mut v4l2_input) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_g_input(port: *mut saa7164_port, i: *mut c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_s_input(port: *mut saa7164_port, i: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_g_tuner(file: *mut file, priv: *mut c_void, t: *mut v4l2_tuner) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_g_frequency(port: *mut saa7164_port, f: *mut v4l2_frequency) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(SAA7164_PORT_ENC2: port->nr ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn saa7164_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_encoder_stop_port(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_encoder_acquire_port(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_encoder_pause_port(port: *mut saa7164_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn saa7164_encoder_stop_streaming(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_encoder_start_streaming(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fops_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fops_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fops_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
    static __poll_t fops_poll(struct file *file, poll_table *wait)
    {
    let mut req_events: __poll_t = poll_requested_events(wait);
    struct saa7164_encoder_fh *fh = to_saa7164_encoder_fh(file);
    struct saa7164_port *port = fh.port;
    let mut mask: __poll_t = v4l2_ctrl_poll(file, wait);
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_encoder_register(port: *mut saa7164_port) -> c_int {
...
// Disable audio standard detection, it's buggy
    ...
    port.v4l_device = core::ptr::null_mut();
    fail_hdl:
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_encoder_unregister(port: *mut saa7164_port) {
