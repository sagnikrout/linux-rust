...
//! Source: drivers/media/pci/saa7164/saa7164-vbi.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn saa7164_vbi_configure(port: *mut saa7164_port) {
...
#[no_mangle]
unsafe extern "C" fn saa7164_vbi_buffers_dealloc(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_vbi_buffers_alloc(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_vbi_initialize(port: *mut saa7164_port) -> c_int {
...
unsafe extern "C" fn vidioc_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
    ...
    {
    struct saa7164_vbi_fh *fh = to_saa7164_vbi_fh(file);
    let mut ret: c_int = saa7164_s_frequency(fh.port.enc_port, f);
    if (ret == 0)
...
#[no_mangle]
unsafe extern "C" fn saa7164_vbi_stop_port(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_vbi_acquire_port(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_vbi_pause_port(port: *mut saa7164_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn saa7164_vbi_stop_streaming(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_vbi_start_streaming(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_vbi_register(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_vbi_unregister(port: *mut saa7164_port) {
