...
//! Source: drivers/media/pci/saa7164/saa7164-api.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_get_load_info(dev: *mut saa7164_dev, i: *mut tmFwInfoStruct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_collect_debug(dev: *mut saa7164_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_set_debug(dev: *mut saa7164_dev, level: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_set_vbi_format(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_api_set_gop_size(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_set_encoder(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_get_encoder(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_set_aspect_ratio(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_set_usercontrol(port: *mut saa7164_port, ctl: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_get_usercontrol(port: *mut saa7164_port, ctl: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_set_videomux(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_audio_mute(port: *mut saa7164_port, mute: c_int) -> c_int {
...
// 0 = silence, 0xff = full
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_set_audio_volume(port: *mut saa7164_port, level: i8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_set_audio_std(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_set_audio_detection(port: *mut saa7164_port, autodetect: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_get_videomux(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_api_set_dif(port: *mut saa7164_port, reg: u8, val: u8) -> c_int {
    ...
    let mut ret: return = = SAA_OK ? 0 : -EIO;
    }
// Disable the IF block AGC controls
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_configure_dif(port: *mut saa7164_port, std: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_initialize_dif(port: *mut saa7164_port) -> c_int {
    int saa7164_api_initialize_dif(struct saa7164_port *port)
    {
    struct saa7164_dev *dev = port.dev;
    struct saa7164_port *p = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_transition_port(port: *mut saa7164_port, mode: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_get_fw_version(dev: *mut saa7164_dev, version: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_read_eeprom(dev: *mut saa7164_dev, buf: *mut u8, buflen: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_api_dump_subdevs(dev: *mut saa7164_dev, buf: *mut u8, len: c_int) -> c_int {
    static int saa7164_api_dump_subdevs(struct saa7164_dev *dev, u8 *buf, int len)
    {
    struct saa7164_port *tsport = core::ptr::null_mut();
    struct saa7164_port *encport = core::ptr::null_mut();
    struct saa7164_port *vbiport = core::ptr::null_mut();
    u32 idx, next_offset;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_api_enum_subdevs(dev: *mut saa7164_dev) -> c_int {
