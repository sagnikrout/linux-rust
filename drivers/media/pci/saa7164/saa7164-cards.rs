...
//! Source: drivers/media/pci/saa7164/saa7164-cards.c
#![no_std]
...
//
pub const REGLEN_0bit: c_int = 0;
pub const REGLEN_8bit: c_int = 1;
pub const REGLEN_16bit: c_int = 2;
...
// Required during new board bringup
    ...
    let mut saa7164_bcount: c_uint = ARRAY_SIZE(saa7164_boards);
// ------------------------------------------------------------------
// PCI subsystem IDs
...
//
    ...
    let mut saa7164_idcount: c_uint = ARRAY_SIZE(saa7164_subids);
#[no_mangle]
pub unsafe extern "C" fn saa7164_card_list(dev: *mut saa7164_dev) {
...
pub const PCIEBRIDGE_UNITID: c_int = 2;
#[no_mangle]
pub unsafe extern "C" fn saa7164_gpio_setup(dev: *mut saa7164_dev) {
...
#[no_mangle]
unsafe extern "C" fn hauppauge_eeprom(dev: *mut saa7164_dev, eeprom_data: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_card_setup(dev: *mut saa7164_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn saa7164_i2caddr_to_unitid(bus: *mut saa7164_i2c, addr: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn saa7164_i2caddr_to_reglen(bus: *mut saa7164_i2c, addr: c_int) -> c_int {
