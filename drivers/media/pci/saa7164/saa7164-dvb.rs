...
//! Source: drivers/media/pci/saa7164/saa7164-dvb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn saa7164_dvb_stop_port(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_dvb_acquire_port(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_dvb_pause_port(port: *mut saa7164_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn saa7164_dvb_stop_streaming(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_dvb_start_port(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_dvb_start_feed(feed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_dvb_stop_feed(feed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_register(port: *mut saa7164_port) -> c_int {
...
// Init and establish defaults
    ...
    port.hw_streamingparams.pagetablelistvirt = core::ptr::null_mut();
    port.hw_streamingparams.pagetablelistphys = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_dvb_unregister(port: *mut saa7164_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn saa7164_dvb_register(port: *mut saa7164_port) -> c_int {
    int saa7164_dvb_register(struct saa7164_port *port)
    {
    struct saa7164_dev *dev = port.dev;
    struct saa7164_dvb *dvb = &port.dvb;
    struct saa7164_i2c *i2c_bus = core::ptr::null_mut();
...
// init frontend
    ...
    &i2c_bus.i2c_adap);
    if (port.dvb.frontend != core::ptr::null_mut()) {
