...
//! Source: drivers/media/pci/saa7164/saa7164-buffer.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_buffer_dealloc(buf: *mut saa7164_buffer) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_buffer_zero_offsets(port: *mut saa7164_port, i: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_buffer_activate(buf: *mut saa7164_buffer, i: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_buffer_cfg_port(port: *mut saa7164_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_buffer_dealloc_user(buf: *mut saa7164_user_buffer) {
