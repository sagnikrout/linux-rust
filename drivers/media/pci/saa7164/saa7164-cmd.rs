...
//! Source: drivers/media/pci/saa7164/saa7164-cmd.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn saa7164_cmd_alloc_seqno(dev: *mut saa7164_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7164_cmd_free_seqno(dev: *mut saa7164_dev, seqno: u8) {
...
#[no_mangle]
unsafe extern "C" fn saa7164_cmd_timeout_seqno(dev: *mut saa7164_dev, seqno: u8) {
...
#[no_mangle]
unsafe extern "C" fn saa7164_cmd_timeout_get(dev: *mut saa7164_dev, seqno: u8) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn saa7164_irq_dequeue(dev: *mut saa7164_dev) -> c_int {
    int saa7164_irq_dequeue(struct saa7164_dev *dev)
    {
    let mut ret: c_int = SAA_OK, i = 0;
    u32 timeout;
    wait_queue_head_t *q = core::ptr::null_mut();
    u8 tmp[512];
    dprintk(DBGLVL_CMD, "%s()\n", __func__);
// While any outstand message on the bus exists...
    do {
// Peek the msg bus
    let mut tRsp: tmComResInfo = { 0, 0, 0, 0, 0, 0 };
    ret = saa7164_bus_get(dev, &tRsp, core::ptr::null_mut(), 1);
    if (ret != SAA_OK)
    break;
...
// -bus/c running buffer.
#[no_mangle]
unsafe extern "C" fn saa7164_cmd_dequeue(dev: *mut saa7164_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn saa7164_cmd_wait(dev: *mut saa7164_dev, seqno: u8) -> c_int {
    static int saa7164_cmd_wait(struct saa7164_dev *dev, u8 seqno)
    {
    wait_queue_head_t *q = core::ptr::null_mut();
    let mut ret: c_int = SAA_BUS_TIMEOUT;
    unsigned long stamp;
    int r;
    if (saa_debug >= 4)
...
// Peek response
    ret = saa7164_bus_get(dev, presponse_t, core::ptr::null_mut(), 1);
    if (ret == SAA_ERR_EMPTY) {
...
// Invalid
    ...
    ret = saa7164_bus_get(dev, presponse_t, core::ptr::null_mut(), 0);
    if (ret != SAA_OK) {
