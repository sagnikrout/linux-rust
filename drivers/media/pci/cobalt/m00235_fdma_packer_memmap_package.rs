...
//! Source: drivers/media/pci/cobalt/m00235_fdma_packer_memmap_package.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct m00235_fdma_packer_regmap {
    pub /: *mut *mut uint32_t control; / Reg 0x0000, Default=0x0,
}

pub const M00235_FDMA_PACKER_REG_CONTROL_OFST: c_int = 0;
//
