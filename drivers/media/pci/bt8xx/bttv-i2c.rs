...
//! Source: drivers/media/pci/bt8xx/bttv-i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bttv_bit_setscl(data: *mut c_void, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bttv_bit_setsda(data: *mut c_void, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bttv_bit_getscl(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bttv_bit_getsda(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bttv_i2c_xfer(i2c_adap: *mut i2c_adapter, msgs: *mut i2c_msg, num: c_int) -> c_int {
...
// read I2C
#[no_mangle]
pub unsafe extern "C" fn bttv_I2CRead(btv: *mut bttv, addr: c_uchar, probe_for: *mut c_char) -> c_int {
    int bttv_I2CRead(struct bttv *btv, unsigned char addr, char *probe_for)
    {
    let mut buffer: c_uchar = 0;
    if (0 != btv.i2c_rc)
    return -1;
    if (bttv_verbose && core::ptr::null_mut() != probe_for)
    pr_info("%d: i2c: checking for %s @ 0x%02x... ",
    btv.c.nr, probe_for, addr);
    btv.i2c_client.addr = addr >> 1;
    if (1 != i2c_master_recv(&btv.i2c_client, &buffer, 1)) {
    if (core::ptr::null_mut() != probe_for) {
    if (bttv_verbose)
    pr_cont("not found\n");
    } else
...
// read EEPROM content
#[no_mangle]
pub unsafe extern "C" fn bttv_readee(btv: *mut bttv, eedata: *mut c_uchar, addr: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn init_bttv_i2c(btv: *mut bttv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fini_bttv_i2c(btv: *mut bttv) -> c_int {
