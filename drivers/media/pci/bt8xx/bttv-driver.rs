...
//! Source: drivers/media/pci/bt8xx/bttv-driver.c
#![no_std]
...
//
    ...
    let mut bttv_verbose: c_uint = 1;
    unsigned int bttv_gpio;
// config variables

    let mut bigendian: static unsigned int = 1;

    static unsigned int bigendian;

    static unsigned int radio[BTTV_MAX];
    static unsigned int irq_debug;
    let mut gbuffers: static unsigned int = 8;
    let mut gbufsize: static unsigned int = 0x208000;
    let mut reset_crop: static unsigned int = 1;
...
// options
    ...
    let mut automute: static unsigned int = 1;
    static unsigned int chroma_agc;
    let mut agc_crush: static unsigned int = 1;
    let mut whitecrush_upper: static unsigned int = 0xCF;
    let mut whitecrush_lower: static unsigned int = 0x7F;
    static unsigned int vcr_hack;
    static unsigned int irq_iswitch;
    let mut uv_ratio: static unsigned int = 50;
    static unsigned int full_luma_range;
    static unsigned int coring;
// API features (turn on/off stuff for testing)
    let mut v4l2: static unsigned int = 1;
// insmod args
    ...
    module_param_array(radio,       int, core::ptr::null_mut(), 0444);
    module_param_array(video_nr,    int, core::ptr::null_mut(), 0444);
    module_param_array(radio_nr,    int, core::ptr::null_mut(), 0444);
    module_param_array(vbi_nr,      int, core::ptr::null_mut(), 0444);
...
#[no_mangle]
unsafe extern "C" fn request_module_async(work: *mut work_struct) {
    static void request_module_async(struct work_struct *work)
    {
    request_module("dvb-bt8xx");
    }
#[no_mangle]
unsafe extern "C" fn request_modules(dev: *mut bttv) {
...
#[no_mangle]
unsafe extern "C" fn flush_request_modules(dev: *mut bttv) {
    static void flush_request_modules(struct bttv *dev)
    {
    flush_work(&dev.request_module_wk);
    }

// Macro flag: #define request_modules(dev)
...
// videostart0 */ 23)
    ...
    let mut BTTV_TVNORMS: static unsigned int = ARRAY_SIZE(bttv_tvnorms);
// -----------------------------------------------------------------------
// bttv format list
    ...
    let mut FORMATS: static unsigned int = ARRAY_SIZE(formats);
// -----------------------------------------------------------------------
// resource management
//
...
#[no_mangle]
pub unsafe extern "C" fn check_alloc_btres_lock(btv: *mut bttv, bit: c_int) -> c_int {
...
// Do crop - use current, don't - use default parameters.
    let mut top: __s32 = btv.crop[!!btv.do_crop].rect.top;
    if (btv.vbi_end > top)
    goto fail;
// We cannot capture the same line as video and VBI data.
    ...
    let mut end: __s32 = btv.vbi_fmt.end;
...
// it's free, grab it
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn check_btres(btv: *mut bttv, bit: c_int) -> c_int {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn locked_btres(btv: *mut bttv, bit: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn free_btres_lock(btv: *mut bttv, bits: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn set_pll_freq(btv: *mut bttv, fin: c_uint, fout: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn set_pll(btv: *mut bttv) {
...
#[no_mangle]
unsafe extern "C" fn bt848A_set_timing(btv: *mut bttv) {
    static void bt848A_set_timing(struct bttv *btv)
    {
    int i, len;
    let mut table_idx: c_int = bttv_tvnorms[btv.tvnorm].sram;
    let mut fsc: c_int = bttv_tvnorms[btv.tvnorm].Fsc;
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn bt848_bright(btv: *mut bttv, bright: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bt848_hue(btv: *mut bttv, hue: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bt848_contrast(btv: *mut bttv, cont: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bt848_sat(btv: *mut bttv, color: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn init_irqreg(btv: *mut bttv) {
...
#[no_mangle]
unsafe extern "C" fn init_bt848(btv: *mut bttv) {
...
#[no_mangle]
unsafe extern "C" fn bttv_reinit_bt848(btv: *mut bttv) {
...
#[no_mangle]
unsafe extern "C" fn bttv_s_ctrl(c: *mut v4l2_ctrl) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn bttv_gpio_tracking(btv: *mut bttv, comment: *mut c_char) {
...
// video4linux (1) interface
    ...
    let mut size: c_uint = btv.fmt.depth * btv.width * btv.height >> 3;
    if (*num_planes)
...
#[no_mangle]
unsafe extern "C" fn buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn buf_cleanup(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn radio_enable(btv: *mut bttv) {
...
#[no_mangle]
unsafe extern "C" fn bttv_s_std(file: *mut file, priv: *mut c_void, id: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bttv_g_std(file: *mut file, priv: *mut c_void, id: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bttv_querystd(file: *mut file, priv: *mut c_void, id: *mut v4l2_std_id) -> c_int {
...
// id &= V4L2_STD_525_60;
    ...
    let mut dstatus: __u32 = btread(BT848_DSTATUS);
...
#[no_mangle]
unsafe extern "C" fn bttv_g_input(file: *mut file, priv: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bttv_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bttv_set_frequency(btv: *mut bttv, f: *const v4l2_frequency) {
    static void bttv_set_frequency(struct bttv *btv, const struct v4l2_frequency *f)
    {
    let mut new_freq: v4l2_frequency = *f;
...
#[no_mangle]
unsafe extern "C" fn bttv_log_status(file: *mut file, priv: *mut c_void) -> c_int {
...
// Given cropping boundaries b and the scaled width and height of a
    ...
    {
    let mut frame_height: __s32 = height << !V4L2_FIELD_HAS_BOTH(field);
    __s32 max_left;
    __s32 max_top;
...
#[no_mangle]
unsafe extern "C" fn bttv_switch_type(btv: *mut bttv, type: enum v4l2_buf_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bttv_g_selection(file: *mut file, priv: *mut c_void, sel: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bttv_s_selection(file: *mut file, priv: *mut c_void, sel: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(c.max_scaled_width: btv->width >) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(c.max_scaled_height: btv->height >) -> else {
...
// radio interface
#[no_mangle]
unsafe extern "C" fn radio_open(file: *mut file) -> c_int {
    static int radio_open(struct file *file)
    {
    struct video_device *vdev = video_devdata(file);
    struct bttv *btv = video_drvdata(file);
    let mut ret: c_int = v4l2_fh_open(file);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn radio_release(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn radio_g_tuner(file: *mut file, priv: *mut c_void, t: *mut v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn radio_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
    static __poll_t radio_poll(struct file *file, poll_table *wait)
    {
    struct bttv *btv = video_drvdata(file);
    struct saa6588_command cmd;
    let mut rc: __poll_t = v4l2_ctrl_poll(file, wait);
    radio_enable(btv);
    cmd.instance = file;
    cmd.event_list = wait;
    cmd.poll_mask = 0;
...
// some debug code
#[no_mangle]
unsafe extern "C" fn bttv_risc_decode(risc: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bttv_print_riscaddr(btv: *mut bttv) {
...
#[no_mangle]
unsafe extern "C" fn bttv_print_irqbits(print: u32, mark: u32) {
...
#[no_mangle]
unsafe extern "C" fn bttv_irq_debug_low_latency(btv: *mut bttv, rc: u32) {
...
//
    ...
    if (core::ptr::null_mut() != wakeup.top && curr.top != wakeup.top) {
    if (irq_debug > 1)
    ...
    if (core::ptr::null_mut() != wakeup.bottom && curr.bottom != wakeup.bottom) {
    if (irq_debug > 1)
...
#[no_mangle]
unsafe extern "C" fn bttv_irq_timeout(t: *mut timer_list) {
...
// deactivate stuff
    ...
    ovbi = btv.cvbi;
    btv.curr = new;
    btv.cvbi = core::ptr::null_mut();
    btv.loop_irq = 0;
    bttv_buffer_activate_video(btv, &new);
    bttv_buffer_activate_vbi(btv,   core::ptr::null_mut());
    bttv_set_dma(btv, 0);
// wake up
...
// cancel all outstanding capture / vbi requests
    ...
    btv.curr.top_irq = 0;
    btv.curr.top = core::ptr::null_mut();
    bttv_risc_hook(btv, RISC_SLOT_O_FIELD, core::ptr::null_mut(), 0);
    wakeup.vbuf.vb2_buf.timestamp = ktime_get_ns();
    wakeup.vbuf.sequence = btv.field_count >> 1;
...
#[no_mangle]
pub unsafe extern "C" fn is_active(risc: *mut btcx_riscmem, rc: u32) -> c_int {
...
// wake up finished buffers
    ...
    {
    struct bttv_buffer *new = core::ptr::null_mut();
    ...
    old = btv.cvbi;
    rc = btread(BT848_RISC_COUNT);
    if (core::ptr::null_mut() != old && (is_active(&old.top,    rc) ||
...
#[no_mangle]
unsafe extern "C" fn bttv_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bttv_unregister_video(btv: *mut bttv) {
...
#[no_mangle]
unsafe extern "C" fn bttv_register_video(btv: *mut bttv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_set_command(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn bttv_probe(dev: *mut pci_dev, pci_id: *const pci_device_id) -> c_int {
...
// pci stuff (init, get irq/mmio, ...
    ...
    if (core::ptr::null_mut() == btv.bt848_mmio) {
...
// fill struct bttv with some useful defaults
    ...
    v4l2_ctrl_new_custom(hdl, &bttv_ctrl_combfilter, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &bttv_ctrl_automute, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &bttv_ctrl_lumafilter, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &bttv_ctrl_agc_crush, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &bttv_ctrl_vcr_hack, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &bttv_ctrl_whitecrush_lower, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &bttv_ctrl_whitecrush_upper, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &bttv_ctrl_uv_ratio, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &bttv_ctrl_full_luma, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &bttv_ctrl_coring, core::ptr::null_mut());
// initialize hardware
    if (bttv_gpio)
...
// everything is fine
    ...
    free_mem:
    bttvs[btv.c.nr] = core::ptr::null_mut();
    kfree(btv);
    return result;
    }
#[no_mangle]
unsafe extern "C" fn bttv_remove(pci_dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn bttv_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn bttv_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn bttv_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn bttv_cleanup_module() -> void __exit {
