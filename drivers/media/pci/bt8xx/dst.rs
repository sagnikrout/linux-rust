...
//! Source: drivers/media/pci/bt8xx/dst.c
#![no_std]
...
pub const HAS_LOCK: c_int = 1;
pub const ATTEMPT_TUNE: c_int = 2;
pub const HAS_POWER: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn dst_packsize(state: *mut dst_state, psize: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dst_gpio_inb(state: *mut dst_state, result: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rdc_reset_state(state: *mut dst_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rdc_8820_reset(state: *mut dst_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_pio_enable(state: *mut dst_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dst_pio_disable(state: *mut dst_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dst_wait_dst_ready(state: *mut dst_state, delay_mode: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dst_error_recovery(state: *mut dst_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dst_error_bailout(state: *mut dst_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dst_comm_init(state: *mut dst_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn write_dst(state: *mut dst_state, data: *mut u8, len: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn read_dst(state: *mut dst_state, ret: *mut u8, len: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_set_polarization(state: *mut dst_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_set_freq(state: *mut dst_state, freq: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_set_bandwidth(state: *mut dst_state, bandwidth: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_set_fec(state: *mut dst_state, fec: enum fe_code_rate) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_get_fec(state: *mut dst_state) -> enum fe_code_rate {
    static enum fe_code_rate dst_get_fec(struct dst_state *state)
    {
    return state.fec;
    }
#[no_mangle]
unsafe extern "C" fn dst_set_symbolrate(state: *mut dst_state, srate: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(state->fw_name, _arg: "DCT-CI", _arg: 6)) -> else {
    else if (!strncmp(state.fw_name, "DCT-CI", 6))
...
#[no_mangle]
unsafe extern "C" fn dst_get_modulation(state: *mut dst_state) -> enum fe_modulation {
    static enum fe_modulation dst_get_modulation(struct dst_state *state)
    {
    return state.modulation;
    }
#[no_mangle]
pub unsafe extern "C" fn dst_check_sum(buf: *mut u8, len: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn dst_type_flags_print(state: *mut dst_state) {
    static void dst_type_flags_print(struct dst_state *state)
    {
    let mut type_flags: u32 = state.type_flags;
...
#[no_mangle]
unsafe extern "C" fn dst_type_print(state: *mut dst_state, type: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_get_mac(state: *mut dst_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_fw_ver(state: *mut dst_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_card_type(state: *mut dst_state) -> c_int {
    static int dst_card_type(struct dst_state *state)
    {
    int j;
    struct tuner_types *p_tuner_list = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dst_get_vendor(state: *mut dst_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debug_dst_buffer(state: *mut dst_state) {
    static void debug_dst_buffer(struct dst_state *state)
    {
    dprintk(3, "%s: [ %*ph ]\n", __func__, 8, state.rxbuffer);
    }
#[no_mangle]
unsafe extern "C" fn dst_check_stv0299(state: *mut dst_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_check_mb86a15(state: *mut dst_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_get_tuner_info(state: *mut dst_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_get_device_id(state: *mut dst_state) -> c_int {
    static int dst_get_device_id(struct dst_state *state)
    {
    u8 reply;
    int i, j;
    struct dst_types *p_dst_type = core::ptr::null_mut();
    struct tuner_types *p_tuner_list = core::ptr::null_mut();
    let mut use_dst_type: u8 = 0;
    let mut use_type_flags: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn dst_probe(state: *mut dst_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_command(state: *mut dst_state, data: *mut u8, len: u8) -> c_int {
    static int dst_command(struct dst_state *state, u8 *data, u8 len)
    {
    u8 reply;
...
#[no_mangle]
unsafe extern "C" fn dst_get_signal(state: *mut dst_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_tone_power_cmd(state: *mut dst_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_get_tuna(state: *mut dst_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_write_tuna(fe: *mut dvb_frontend) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dst_set_diseqc(fe: *mut dvb_frontend, cmd: *mut dvb_diseqc_master_cmd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(DST_TYPE_HAS_DISEQC5: cmd->msg_len == 5 && state->dst_hw_cap &) -> else {
...
#[no_mangle]
unsafe extern "C" fn dst_set_voltage(fe: *mut dvb_frontend, voltage: enum fe_sec_voltage) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_set_tone(fe: *mut dvb_frontend, tone: enum fe_sec_tone_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_send_burst(fe: *mut dvb_frontend, minicmd: enum fe_sec_mini_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bt8xx_dst_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(DST_TYPE_IS_TERR: state->dst_type ==) -> else {
    else if (state.dst_type == DST_TYPE_IS_TERR)
    memcpy(state.tx_tuna, ((state.type_flags & DST_TYPE_HAS_VLF) ? ter_tuna_188 : ter_tuna_204), sizeof (ter_tuna_204));
#[no_mangle]
pub unsafe extern "C" fn if(DST_TYPE_IS_CABLE: state->dst_type ==) -> else {
    else if (state.dst_type == DST_TYPE_IS_CABLE)
    memcpy(state.tx_tuna, ((state.type_flags & DST_TYPE_HAS_VLF) ? cab_tuna_188 : cab_tuna_204), sizeof (cab_tuna_204));
#[no_mangle]
pub unsafe extern "C" fn if(DST_TYPE_IS_ATSC: state->dst_type ==) -> else {
    else if (state.dst_type == DST_TYPE_IS_ATSC)
    memcpy(state.tx_tuna, atsc_tuner, sizeof (atsc_tuner));
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn dst_read_status(fe: *mut dvb_frontend, status: *mut enum fe_status) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_read_signal_strength(fe: *mut dvb_frontend, strength: *mut u16) -> c_int {
    static int dst_read_signal_strength(struct dvb_frontend *fe, u16 *strength)
    {
    struct dst_state *state = fe.demodulator_priv;
    let mut retval: c_int = dst_get_signal(state);
// strength = state->decode_strength;
    return retval;
    }
#[no_mangle]
unsafe extern "C" fn dst_read_snr(fe: *mut dvb_frontend, snr: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_set_frontend(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dst_get_tuning_algo(fe: *mut dvb_frontend) -> enum dvbfe_algo {
...
#[no_mangle]
unsafe extern "C" fn bt8xx_dst_release(fe: *mut dvb_frontend) {
