...
//! Source: drivers/media/pci/bt8xx/bttv-input.c
#![no_std]
...
//
    ...
    let mut ir_rc5_remote_gap: static int = 885;
...
// ----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ir_handle_key(btv: *mut bttv) {
...
#[no_mangle]
unsafe extern "C" fn ir_enltv_handle_key(btv: *mut bttv) {
...
#[no_mangle]
pub unsafe extern "C" fn bttv_input_irq(btv: *mut bttv) {
    ...
    bttv_rc5_irq(btv);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !ir->polling) -> else {
    else if (!ir.polling)
    ir_handle_key(btv);
    }
#[no_mangle]
unsafe extern "C" fn bttv_input_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn bttv_rc5_decode(code: c_uint) -> u32 {
    static u32 bttv_rc5_decode(unsigned int code)
    {
    let mut org_code: c_uint = code;
    unsigned int pair;
    let mut rc5: c_uint = 0;
    int i;
    for (i = 0; i < 14; ++i) {
    pair = code & 0x3;
    code >>= 2;
...
#[no_mangle]
unsafe extern "C" fn bttv_rc5_timer_end(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn bttv_rc5_irq(btv: *mut bttv) -> c_int {
    static int bttv_rc5_irq(struct bttv *btv)
    {
    struct bttv_ir *ir = btv.remote;
    ktime_t tv;
...
// ----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn bttv_ir_start(ir: *mut bttv_ir) {
...
#[no_mangle]
unsafe extern "C" fn bttv_ir_stop(btv: *mut bttv) {
...
#[no_mangle]
pub unsafe extern "C" fn init_bttv_i2c_ir(btv: *mut bttv) {
...
//
    i2c_dev = i2c_new_scanned_device(&btv.c.i2c_adap, &info, addr_list, core::ptr::null_mut());
    }
    if (IS_ERR(i2c_dev))
    return;
...
#[no_mangle]
pub unsafe extern "C" fn bttv_input_init(btv: *mut bttv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bttv_input_fini(btv: *mut bttv) {
    void bttv_input_fini(struct bttv *btv)
    {
    if (btv.remote == core::ptr::null_mut())
    return;
