...
//! Source: drivers/media/pci/bt8xx/bttv-vbi.c
#![no_std]
...
// Offset from line sync pulse leading edge (0H) to start of VBI capture,
    ...
    to be about 244.  */
pub const VBI_OFFSET: c_int = 244;
...
// vbi risc code + mm
    ...
    let mut size: c_uint = IMAGE_SIZE(&btv.vbi_fmt.fmt);
    if (*num_planes)
...
#[no_mangle]
unsafe extern "C" fn buf_queue_vbi(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn buf_prepare_vbi(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn buf_cleanup_vbi(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn start_streaming_vbi(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stop_streaming_vbi(q: *mut vb2_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn bttv_try_fmt_vbi_cap(file: *mut file, priv: *mut c_void, frt: *mut v4l2_format) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bttv_s_fmt_vbi_cap(file: *mut file, priv: *mut c_void, frt: *mut v4l2_format) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bttv_g_fmt_vbi_cap(file: *mut file, priv: *mut c_void, frt: *mut v4l2_format) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bttv_vbi_fmt_reset(f: *mut bttv_vbi_fmt, norm: c_uint) {
