...
//! Source: drivers/media/pci/pt3/pt3_dma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_dma_base(idx: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn pt3_stop_dma(adap: *mut pt3_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pt3_start_dma(adap: *mut pt3_adapter) -> c_int {
    int pt3_start_dma(struct pt3_adapter *adap)
    {
    struct pt3_board *pt3 = adap.dvb_adap.priv;
    let mut base: u32 = get_dma_base(adap.adap_idx);
    iowrite32(0x02, pt3.regs[0] + base + OFST_DMA_CTL);
...
#[no_mangle]
pub unsafe extern "C" fn pt3_proc_dma(adap: *mut pt3_adapter) -> c_int {
    ...
    adap.num_discard--;
#[no_mangle]
pub unsafe extern "C" fn if(DATA_BUF_SZ: adap->buf_ofs + PT3_ACCESS_UNIT >) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn pt3_init_dmabuf(adap: *mut pt3_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn pt3_free_dmabuf(adap: *mut pt3_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn pt3_alloc_dmabuf(adap: *mut pt3_adapter) -> c_int {
