...
//! Source: drivers/media/pci/saa7134/saa7134-dvb.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn pinnacle_antenna_pwr(dev: *mut saa7134_dev, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt352_pinnacle_init(fe: *mut *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt352_aver777_init(fe: *mut *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt352_avermedia_xc3028_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt352_pinnacle_tuner_set_params(fe: *mut dvb_frontend) -> c_int {
    static int mt352_pinnacle_tuner_set_params(struct dvb_frontend *fe)
    {
    struct dtv_frontend_properties *c = &fe.dtv_property_cache;
    u8 off[] = { 0x00, 0xf1};
    u8 on[]  = { 0x00, 0x71};
    let mut msg: i2c_msg = {.addr=0x43, .flags=0, .buf=off, .len = sizeof(off)};
...
#[no_mangle]
unsafe extern "C" fn kworld_sbtvd_gate_ctrl(fe: *mut *mut dvb_frontend, enable: c_int) -> c_int {
    ...
    let mut msg: i2c_msg = {.addr = 0x4b, .flags = 0, .buf = initmsg, .len = 2};
...
//
#[no_mangle]
unsafe extern "C" fn philips_tda6651_pll_set(fe: *mut dvb_frontend) -> c_int {
    static int philips_tda6651_pll_set(struct dvb_frontend *fe)
    {
    struct dtv_frontend_properties *c = &fe.dtv_property_cache;
    struct saa7134_dev *dev = fe.dvb.priv;
    struct tda1004x_state *state = fe.demodulator_priv;
    let mut addr: u8 = state.config.tuner_address;
    u8 tuner_buf[4];
...
#[no_mangle]
unsafe extern "C" fn philips_tu1216_init(fe: *mut dvb_frontend) -> c_int {
    ...
    let mut tuner_msg: i2c_msg = {.addr = addr,.flags = 0,.buf = tu1216_init,.len = sizeof(tu1216_init) };
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn philips_td1316_tuner_init(fe: *mut dvb_frontend) -> c_int {
    ...
    let mut init_msg: i2c_msg = {.addr = addr,.flags = 0,.buf = msg,.len = sizeof(msg) };
// setup PLL configuration
    if (fe.ops.i2c_gate_ctrl)
    fe.ops.i2c_gate_ctrl(fe, 1);
...
#[no_mangle]
unsafe extern "C" fn philips_td1316_tuner_set_params(fe: *mut dvb_frontend) -> c_int {
    static int philips_td1316_tuner_set_params(struct dvb_frontend *fe)
    {
    return philips_tda6651_pll_set(fe);
    }
#[no_mangle]
unsafe extern "C" fn philips_td1316_tuner_sleep(fe: *mut dvb_frontend) -> c_int {
    ...
    let mut analog_msg: i2c_msg = {.addr = addr,.flags = 0,.buf = msg,.len = sizeof(msg) };
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn philips_europa_tuner_init(fe: *mut dvb_frontend) -> c_int {
    static int philips_europa_tuner_init(struct dvb_frontend *fe)
    {
    struct saa7134_dev *dev = fe.dvb.priv;
    static u8 msg[] = { 0x00, 0x40};
    let mut init_msg: i2c_msg = {.addr = 0x43,.flags = 0,.buf = msg,.len = sizeof(msg) };
...
#[no_mangle]
unsafe extern "C" fn philips_europa_tuner_sleep(fe: *mut dvb_frontend) -> c_int {
    static int philips_europa_tuner_sleep(struct dvb_frontend *fe)
    {
    struct saa7134_dev *dev = fe.dvb.priv;
    static u8 msg[] = { 0x00, 0x14 };
    let mut analog_msg: i2c_msg = {.addr = 0x43,.flags = 0,.buf = msg,.len = sizeof(msg) };
...
#[no_mangle]
unsafe extern "C" fn philips_europa_demod_sleep(fe: *mut dvb_frontend) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tda8290_i2c_gate_ctrl(fe: *mut *mut dvb_frontend, enable: c_int) -> c_int {
    static int tda8290_i2c_gate_ctrl( struct dvb_frontend* fe, int enable)
    {
    struct tda1004x_state *state = fe.demodulator_priv;
    let mut addr: u8 = state.config.i2c_gate;
    static u8 tda8290_close[] = { 0x21, 0xc0};
    static u8 tda8290_open[]  = { 0x21, 0x80};
    let mut tda8290_msg: i2c_msg = {.addr = addr,.flags = 0, .len = 2};
    if (enable) {
...
#[no_mangle]
unsafe extern "C" fn philips_tda827x_tuner_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn philips_tda827x_tuner_sleep(fe: *mut dvb_frontend) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ads_duo_tuner_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads_duo_tuner_sleep(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn md8800_set_high_voltage(fe: *mut dvb_frontend, arg: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn md8800_set_high_voltage2(fe: *mut dvb_frontend, arg: c_long) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dvb_init(dev: *mut saa7134_dev) -> c_int {
    static int dvb_init(struct saa7134_dev *dev)
    {
    int ret;
    let mut attach_xc3028: c_int = 0;
    struct vb2_dvb_frontend *fe0;
    struct vb2_queue *q;
...
//
    fe0.dvb.frontend.ops.i2c_gate_ctrl = core::ptr::null_mut();
    dvb_attach(simple_tuner_attach, fe0.dvb.frontend,
    ...
    &hcw_tda10048_config,
    &dev.i2c_adap);
    if (fe0.dvb.frontend != core::ptr::null_mut()) {
    ...
    &dev.i2c_adap, 0) == core::ptr::null_mut()) {
    ...
    &dev.i2c_adap,
    0x08, 0, 0, false) == core::ptr::null_mut()) {
    ...
    let mut dev_id: u8 = dev.eedata[2];
    let mut data: u8 = 0xc4;
    let mut msg: i2c_msg = {.addr = 0x08, .flags = 0, .len = 1};
    if (dvb_attach(tda826x_attach, fe0.dvb.frontend,
    0x60, &dev.i2c_adap, 0) == core::ptr::null_mut()) {
...
// we need to open the i2c gate (we know it exists)
    ...
    &dev.i2c_adap, 0x08, 0, 0) == core::ptr::null_mut()) {
...
// fire up the 2nd section of the LNB supply since
    ...
    core::ptr::null_mut(), DVB_PLL_TDHU2);
    break;
    ...
    &dev.i2c_adap, 0, 0) == core::ptr::null_mut()) {
    ...
    &dev.i2c_adap, DVB_PLL_PHILIPS_SD1878_TDA8261) == core::ptr::null_mut()) {
...
// Zarlink ZL10313
    ...
    &avertv_a700_tuner, &dev.i2c_adap) == core::ptr::null_mut()) {
    ...
    0x60, &dev.i2c_adap) == core::ptr::null_mut())
    ...
    fe0.dvb.frontend,
    &dev.i2c_adap,
    &videomate_t750_qt1010_config) == core::ptr::null_mut())
...
// CE6313 DVB-S demod RESET# pin high
    ...
    if (core::ptr::null_mut() == fe0.dvb.frontend) {
...
#[no_mangle]
unsafe extern "C" fn dvb_fini(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt2032(_arg: TDA9887_PORT2_INACTIVE) -> the detection of {
    the detection of mt2032 (TDA9887_PORT2_INACTIVE)
//
    if (dev.board == SAA7134_BOARD_PINNACLE_300I_DVBT_PAL) {
    struct v4l2_priv_tun_config tda9887_cfg;
    let mut on: static int = TDA9887_PRESENT | TDA9887_PORT2_INACTIVE;
...
// turn off the 2nd lnb supply
    ...
    let mut msg: i2c_msg = {.addr = 0x08, .buf = &data, .flags = 0, .len = 1};
    struct dvb_frontend *fe;
    fe = fe0.dvb.frontend;
    if (fe.ops.i2c_gate_ctrl) {
    fe.ops.i2c_gate_ctrl(fe, 1);
...
#[no_mangle]
unsafe extern "C" fn dvb_register() -> int __init {
    static int __init dvb_register(void)
    {
    return saa7134_ts_register(&dvb_ops);
    }
#[no_mangle]
unsafe extern "C" fn dvb_unregister() -> void __exit {
