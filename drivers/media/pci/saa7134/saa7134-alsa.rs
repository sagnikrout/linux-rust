...
//! Source: drivers/media/pci/saa7134/saa7134-alsa.c
#![no_std]
...
pub const MIXER_ADDR_LINE1: c_int = 1;
pub const MIXER_ADDR_LINE2: c_int = 2;
pub const MIXER_ADDR_LAST: c_int = 2;
    static int index[SNDRV_CARDS] = SNDRV_DEFAULT_IDX;	/* Index 0-MAX */
    static char *id[SNDRV_CARDS] = SNDRV_DEFAULT_STR;	/* ID for this card */
    static int enable[SNDRV_CARDS] = {1, [1 ... (SNDRV_CARDS - 1)] = 1};
    module_param_array(index, int, core::ptr::null_mut(), 0444);
    module_param_array(enable, int, core::ptr::null_mut(), 0444);
...
//
#[no_mangle]
unsafe extern "C" fn saa7134_dma_stop(dev: *mut saa7134_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn saa7134_dma_start(dev: *mut saa7134_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn saa7134_alsa_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// stop dma
    ...
    if (core::ptr::null_mut() == dma.vaddr) {
    ...
    if (core::ptr::null_mut() == dma.sglist)
    goto vzalloc_err;
    ...
    vmalloc_to_page_err:
    vfree(dma.sglist);
    dma.sglist = core::ptr::null_mut();
    vzalloc_err:
    vfree(dma.vaddr);
    dma.vaddr = core::ptr::null_mut();
    return -ENOMEM;
    }
#[no_mangle]
unsafe extern "C" fn saa7134_alsa_dma_map(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_alsa_dma_unmap(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_alsa_dma_free(dma: *mut saa7134_dmasound) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dsp_buffer_init(dev: *mut saa7134_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dsp_buffer_free(dev: *mut saa7134_dev) -> c_int {
...
//
    ...
    let mut change: c_int = 0, addr = kcontrol.private_value;
    int active, old_addr;
    u32 anabar, xbarin;
    int analog_io, rate;
    struct saa7134_dev *dev;
...
//
#[no_mangle]
unsafe extern "C" fn snd_card_saa7134_capture_prepare(substream: *mut *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_card_saa7134_runtime_free(runtime: *mut snd_pcm_runtime) {
...
//
#[no_mangle]
unsafe extern "C" fn snd_card_saa7134_hw_free(substream: *mut *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_card_saa7134_capture_close(substream: *mut *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_card_saa7134_capture_open(substream: *mut *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_card_saa7134_pcm(saa7134: *mut snd_card_saa7134_t, device: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_card_saa7134_new_mixer(chip: *mut *mut snd_card_saa7134_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_saa7134_free(card: *mut *mut snd_card) {
    static void snd_saa7134_free(struct snd_card * card)
    {
    snd_card_saa7134_t *chip = card.private_data;
    if (chip.dev.dmasound.priv_data == core::ptr::null_mut())
    return;
    chip.dev.dmasound.priv_data = core::ptr::null_mut();
    }
//
// ALSA initialization
//
...
//
#[no_mangle]
unsafe extern "C" fn alsa_card_saa7134_create(dev: *mut saa7134_dev, devnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alsa_device_init(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alsa_device_exit(dev: *mut saa7134_dev) -> c_int {
    static int alsa_device_exit(struct saa7134_dev *dev)
    {
    if (!snd_saa7134_cards[dev.nr])
    return 1;
    snd_card_free(snd_saa7134_cards[dev.nr]);
    snd_saa7134_cards[dev.nr] = core::ptr::null_mut();
    return 1;
    }
//
// Module initializer
...
//
#[no_mangle]
unsafe extern "C" fn saa7134_alsa_init() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn saa7134_alsa_exit() {
    ...
    saa7134_dmasound_init = core::ptr::null_mut();
    saa7134_dmasound_exit = core::ptr::null_mut();
