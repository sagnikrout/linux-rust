...
//! Source: drivers/media/pci/saa7134/saa7134-ts.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_ts_buffer_init(vb2: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_ts_buffer_prepare(vb2: *mut vb2_buffer) -> c_int {
    ...
    struct saa7134_dev *dev = dmaq.dev;
    let mut size: c_int = TS_PACKET_SIZE * dev.ts.nr_packets;
    if (0 == *nbuffers)
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_ts_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_ts_stop_streaming(vq: *mut vb2_queue) {
...
// -----------------------------------------------------------
// exported stuff
    let mut tsbufs: static unsigned int = 8;
    module_param(tsbufs, int, 0444);
    MODULE_PARM_DESC(tsbufs, "number of ts buffers for read/write IO, range 2-32");
    let mut ts_nr_packets: static unsigned int = 64;
    module_param(ts_nr_packets, int, 0444);
    MODULE_PARM_DESC(ts_nr_packets,"size of a ts buffers (in ts packets)");
#[no_mangle]
pub unsafe extern "C" fn saa7134_ts_init_hw(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_ts_init1(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_ts_stop(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_ts_start(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_ts_fini(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_irq_ts_done(dev: *mut saa7134_dev, status: c_ulong) {
