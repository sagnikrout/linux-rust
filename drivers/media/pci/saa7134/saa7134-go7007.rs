...
//! Source: drivers/media/pci/saa7134/saa7134-go7007.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct saa7134_go7007 {
    pub sd: v4l2_subdev,
    pub dev: *mut saa7134_dev,
    pub top: *mut u8,
    pub bottom: *mut u8,
    pub top_dma: dma_addr_t,
    pub bottom_dma: dma_addr_t,
}
...
#[no_mangle]
unsafe extern "C" fn gpio_write(dev: *mut saa7134_dev, addr: u8, data: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_read(dev: *mut saa7134_dev, addr: u8, data: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_go7007_interface_reset(go: *mut go7007) -> c_int {
    static int saa7134_go7007_interface_reset(struct go7007 *go)
    {
    struct saa7134_go7007 *saa = go.hpi_context;
    struct saa7134_dev *dev = saa.dev;
    u16 intr_val, intr_data;
    let mut count: c_int = 20;
...
#[no_mangle]
unsafe extern "C" fn saa7134_go7007_write_interrupt(go: *mut go7007, addr: c_int, data: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_go7007_read_interrupt(go: *mut go7007) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_go7007_stream_start(go: *mut go7007) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_go7007_stream_stop(go: *mut go7007) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_go7007_send_firmware(go: *mut go7007, data: *mut u8, len: c_int) -> c_int {
...
// --------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn saa7134_go7007_s_std(sd: *mut v4l2_subdev, norm: v4l2_std_id) -> c_int {
    static int saa7134_go7007_s_std(struct v4l2_subdev *sd, v4l2_std_id norm)
    {

    struct saa7134_go7007 *saa = container_of(sd, struct saa7134_go7007, sd);
    struct saa7134_dev *dev = saa.dev;
    return saa7134_s_std_internal(dev, core::ptr::null_mut(), norm);
...
#[no_mangle]
unsafe extern "C" fn saa7134_go7007_init(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_go7007_fini(dev: *mut saa7134_dev) -> c_int {
    static int saa7134_go7007_fini(struct saa7134_dev *dev)
    {
    struct go7007 *go;
    struct saa7134_go7007 *saa;
    if (core::ptr::null_mut() == dev.empress_dev)
    return 0;
    ...
    dev.empress_dev = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn saa7134_go7007_mod_init() -> int __init {
    static int __init saa7134_go7007_mod_init(void)
    {
    return saa7134_ts_register(&saa7134_go7007_ops);
    }
#[no_mangle]
unsafe extern "C" fn saa7134_go7007_mod_cleanup() -> void __exit {
