...
//! Source: drivers/media/pci/saa7134/saa7134-video.c
#![no_std]
...
// ------------------------------------------------------------------
    ...
    let mut gbufsize: static unsigned int = 720*576*4;
    let mut gbufsize_max: static unsigned int = 720*576*4;
    static char secam[] = "--";
...
pub const VP_T_CODE_P_NON_INVERTED: c_uint = 0x00;
pub const VP_T_CODE_P_INVERTED: c_uint = 0x01;
// ------------------------------------------------------------------
// Defines for Video Output Port Register at address 0x195
// Bit 2: Video output clock delay control
pub const VP_CLK_CTRL2_NOT_DELAYED: c_uint = 0x00;
pub const VP_CLK_CTRL2_DELAYED: c_uint = 0x04;
// Bit 1: Video output clock invert control
pub const VP_CLK_CTRL1_NON_INVERTED: c_uint = 0x00;
pub const VP_CLK_CTRL1_INVERTED: c_uint = 0x02;
// ------------------------------------------------------------------
// Defines for Video Output Port Register at address 0x196
// Bits 2 to 0: VSYNC pin video vertical sync type
pub const VP_VS_TYPE_MASK: c_uint = 0x07;
pub const VP_VS_TYPE_OFF: c_uint = 0x00;
pub const VP_VS_TYPE_V123: c_uint = 0x01;
pub const VP_VS_TYPE_V_ITU: c_uint = 0x02;
pub const VP_VS_TYPE_VGATE_L: c_uint = 0x03;
pub const VP_VS_TYPE_RESERVED1: c_uint = 0x04;
pub const VP_VS_TYPE_RESERVED2: c_uint = 0x05;
pub const VP_VS_TYPE_F_ITU: c_uint = 0x06;
pub const VP_VS_TYPE_SC_FID: c_uint = 0x07;
// ------------------------------------------------------------------
...
#[no_mangle]
unsafe extern "C" fn format_by_fourcc(fourcc: c_uint) -> *mut saa7134_format {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn set_tvnorm(dev: *mut saa7134_dev, norm: *mut saa7134_tvnorm) {
...
#[no_mangle]
unsafe extern "C" fn video_mux(dev: *mut saa7134_dev, input: c_int) {
...
#[no_mangle]
unsafe extern "C" fn saa7134_set_decoder(dev: *mut saa7134_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_set_tvnorm_hw(dev: *mut saa7134_dev) {
...
#[no_mangle]
unsafe extern "C" fn set_h_prescale(dev: *mut saa7134_dev, task: c_int, prescale: c_int) {
...
// XPSC XACL XC2_1 XDCG VPFY
    ...
    let mut count: static int = ARRAY_SIZE(vals);
    int i;
    for (i = 0; i < count; i++)
...
#[no_mangle]
unsafe extern "C" fn set_v_scale(dev: *mut saa7134_dev, task: c_int, yscale: c_int) {
...
// ACM
    ...
    let mut div: c_int = interlace ? 2 : 1;
// setup video scaler
...
//
#[no_mangle]
unsafe extern "C" fn saa7134_enable_analog_tuner(dev: *mut saa7134_dev) -> c_int {
...
unsafe extern "C" fn buffer_prepare(vb2: *mut vb2_buffer) -> c_int {
    ...
    struct saa7134_dev *dev = dmaq.dev;
    let mut size: c_int = dev.fmt.depth * dev.width * dev.height >> 3;
    if (dev.width    < 48 ||
    dev.height   < 32 ||
...
//
#[no_mangle]
pub unsafe extern "C" fn saa7134_vb2_buffer_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_vb2_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_vb2_stop_streaming(vq: *mut vb2_queue) {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn saa7134_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn video_open(file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn video_release(file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_enum_input(file: *mut file, priv: *mut c_void, i: *mut v4l2_input) -> c_int {
    ...
    if (n == dev.ctl_input) {
    let mut v1: c_int = saa_readb(SAA7134_STATUS_VIDEO1);
    let mut v2: c_int = saa_readb(SAA7134_STATUS_VIDEO2);
    if (0 != (v1 & 0x40))
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_g_input(file: *mut file, priv: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_s_std(file: *mut file, priv: *mut c_void, id: v4l2_std_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_g_std(file: *mut file, priv: *mut c_void, id: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_read_std(dev: *mut saa7134_dev) -> v4l2_std_id {
    ...
    V4L2_STD_PAL,
    V4L2_STD_SECAM };
    let mut result: v4l2_std_id = 0;
    let mut st1: u8 = saa_readb(SAA7134_STATUS_VIDEO1);
    let mut st2: u8 = saa_readb(SAA7134_STATUS_VIDEO2);
    if (!(st2 & 0x1)) /* RDCAP == 0 */
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_querystd(file: *mut file, priv: *mut c_void, std: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_g_selection(file: *mut file, priv: *mut c_void, sel: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_s_selection(file: *mut file, priv: *mut c_void, sel: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_video_init1(dev: *mut saa7134_dev) -> c_int {
...
// sanitycheck insmod options
    ...
    v4l2_ctrl_new_custom(hdl, &saa7134_ctrl_invert, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &saa7134_ctrl_y_odd, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &saa7134_ctrl_y_even, core::ptr::null_mut());
    v4l2_ctrl_new_custom(hdl, &saa7134_ctrl_automute, core::ptr::null_mut());
    if (hdl.error)
    return hdl.error;
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_video_fini(dev: *mut saa7134_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_videoport_init(dev: *mut saa7134_dev) -> c_int {
    int saa7134_videoport_init(struct saa7134_dev *dev)
    {
// enable video output
    let mut vo: c_int = saa7134_boards[dev.board].video_out;
    int video_reg;
    let mut vid_port_opts: c_uint = saa7134_boards[dev.board].vid_port_opts;
// Configure videoport
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_video_init2(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_irq_video_signalchange(dev: *mut saa7134_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_irq_video_done(dev: *mut saa7134_dev, status: c_ulong) {
