...
//! Source: drivers/media/pci/saa7134/saa7134-i2c.c
#![no_std]
...
pub const I2C_WAIT_DELAY: c_int = 32;
pub const I2C_WAIT_RETRY: c_int = 16;
// -----------------------------------------------------------
...
#[no_mangle]
pub unsafe extern "C" fn i2c_get_status(dev: *mut saa7134_dev) -> enum i2c_status {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_set_attr(dev: *mut saa7134_dev, attr: enum i2c_attr) {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_is_error(status: enum i2c_status) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_is_idle(status: enum i2c_status) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_is_busy(status: enum i2c_status) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_is_busy_wait(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_reset(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_recv_byte(dev: *mut saa7134_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn saa7134_i2c_eeprom_md7134_gate(dev: *mut saa7134_dev) {
    static void saa7134_i2c_eeprom_md7134_gate(struct saa7134_dev *dev)
    {
    let mut subaddr: u8 = 0x7, dmdregval;
    u8 data[2];
    int ret;
    ...
    for (i = 0; i < len; i += 16) {
    let mut size: c_int = (len - i) > 16 ? 16 : len - i;
...
#[no_mangle]
unsafe extern "C" fn do_i2c_scan(c: *mut i2c_client) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_i2c_register(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_i2c_unregister(dev: *mut saa7134_dev) -> c_int {
