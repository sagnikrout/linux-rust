...
//! Source: drivers/media/pci/saa7134/saa7134-empress.c
#![no_std]
...
// ------------------------------------------------------------------
    ...
    module_param_array(empress_nr, int, core::ptr::null_mut(), 0444);
...
unsafe extern "C" fn start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
    ...
    let mut leading_null_bytes: u32 = 0;
    int err;
...
// ------------------------------------------------------------------
    ...
    saa_call_all(dev, pad, get_fmt, core::ptr::null_mut(), &fmt);
    ...
    saa_call_all(dev, pad, set_fmt, core::ptr::null_mut(), &format);
...
#[no_mangle]
unsafe extern "C" fn empress_signal_update(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn empress_signal_change(dev: *mut saa7134_dev) {
    static void empress_signal_change(struct saa7134_dev *dev)
    {
    schedule_work(&dev.empress_workqueue);
    }
#[no_mangle]
unsafe extern "C" fn empress_ctrl_filter(ctrl: *const v4l2_ctrl) -> bool {
...
#[no_mangle]
unsafe extern "C" fn empress_init(dev: *mut saa7134_dev) -> c_int {
...
// (dev->empress_dev) = saa7134_empress_template;
    ...
    if (dev.empress_sd)
    v4l2_ctrl_add_handler(hdl, dev.empress_sd.ctrl_handler, core::ptr::null_mut(), true);
    if (hdl.error) {
...
#[no_mangle]
unsafe extern "C" fn empress_fini(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn empress_register() -> int __init {
    static int __init empress_register(void)
    {
    return saa7134_ts_register(&empress_ops);
    }
#[no_mangle]
unsafe extern "C" fn empress_unregister() -> void __exit {
