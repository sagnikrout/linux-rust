...
//! Source: drivers/media/pci/saa7134/saa7134-core.c
#![no_std]
...
// ------------------------------------------------------------------
    ...
    let mut alsa: static unsigned int = 1;
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_track_gpio(dev: *mut saa7134_dev, msg: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_set_gpio(dev: *mut saa7134_dev, bit_no: c_int, value: c_int) {
...
unsafe extern "C" fn request_module_async(work: *mut work_struct) {
    let mut dev: *mut saa7134_dev = container_of(work, struct saa7134_dev, request_module_wk);
...
#[no_mangle]
unsafe extern "C" fn request_submodules(dev: *mut saa7134_dev) {
...
#[no_mangle]
unsafe extern "C" fn flush_request_submodules(dev: *mut saa7134_dev) {
    static void flush_request_submodules(struct saa7134_dev *dev)
    {
    flush_work(&dev.request_module_wk);
    }

// Macro flag: #define request_submodules(dev)
// Macro flag: #define flush_request_submodules(dev)

// ------------------------------------------------------------------
// nr of (saa7134-)pages for the given buffer size
#[no_mangle]
unsafe extern "C" fn saa7134_buffer_pages(size: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_buffer_count(size: c_uint, count: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_buffer_startpage(buf: *mut saa7134_buf) -> c_int {
    int saa7134_buffer_startpage(struct saa7134_buf *buf)
    {
#[no_mangle]
pub unsafe extern "C" fn saa7134_buffer_pages(_arg: vb2_plane_size(&buf->vb2.vb2_buf, _arg: 0)) -> return {
    return saa7134_buffer_pages(vb2_plane_size(&buf.vb2.vb2_buf, 0))
// buf->vb2.vb2_buf.index;
    }
#[no_mangle]
pub unsafe extern "C" fn saa7134_buffer_base(buf: *mut saa7134_buf) -> c_ulong {
...
// ------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn saa7134_pgtable_alloc(pci: *mut pci_dev, pt: *mut saa7134_pgtable) -> c_int {
    ...
    __le32        *ptr;
    unsigned int  i, p;
    BUG_ON(core::ptr::null_mut() == pt || core::ptr::null_mut() == pt.cpu);
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_pgtable_free(pci: *mut pci_dev, pt: *mut saa7134_pgtable) {
    void saa7134_pgtable_free(struct pci_dev *pci, struct saa7134_pgtable *pt)
    {
    if (core::ptr::null_mut() == pt.cpu)
    return;
    dma_free_coherent(&pci.dev, pt.size, pt.cpu, pt.dma);
    pt.cpu = core::ptr::null_mut();
    }
// ------------------------------------------------------------------
    ...
    {
    struct saa7134_buf *next = core::ptr::null_mut();
    unsigned long flags;
...
// finish current buffer
    ...
    struct saa7134_dmaqueue *q)
    {
    struct saa7134_buf *buf,*next = core::ptr::null_mut();
    assert_spin_locked(&dev.slock);
    BUG_ON(core::ptr::null_mut() != q.curr);
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_buffer_timeout(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_stop_streaming(dev: *mut saa7134_dev, q: *mut saa7134_dmaqueue) {
...
// ------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn saa7134_set_dmabits(dev: *mut saa7134_dev) -> c_int {
    int saa7134_set_dmabits(struct saa7134_dev *dev)
    {
    u32 split, task=0, ctrl=0, irq=0;
    let mut cap: enum v4l2_field = V4L2_FIELD_ANY;
    let mut ov: enum v4l2_field = V4L2_FIELD_ANY;
    assert_spin_locked(&dev.slock);
    if (dev.insuspend)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn saa7134_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// with it
    ...
    (dev.dmasound.priv_data != core::ptr::null_mut()) )
    {
    ...
    card_has_mpeg(dev)) {
    if (dev.mops.irq_ts_done != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn saa7134_hw_enable1(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_hwinit1(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_hw_enable2(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_hwinit2(dev: *mut saa7134_dev) -> c_int {
...
// shutdown
#[no_mangle]
unsafe extern "C" fn saa7134_hwfini(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn must_configure_manually(has_eeprom: c_int) {
...
#[no_mangle]
unsafe extern "C" fn saa7134_unregister_media_device(dev: *mut saa7134_dev) {
    ...
    kfree(dev.media_dev);
    dev.media_dev = core::ptr::null_mut();

    }
#[no_mangle]
unsafe extern "C" fn saa7134_media_release(dev: *mut saa7134_dev) {
...
#[no_mangle]
unsafe extern "C" fn saa7134_create_entities(dev: *mut saa7134_dev) {
    static void saa7134_create_entities(struct saa7134_dev *dev)
    {
    int ret, i;
    struct media_entity *entity;
    struct media_entity *decoder = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn saa7134_unregister_video(dev: *mut saa7134_dev) {
    ...
    dev.video_dev = core::ptr::null_mut();
    }
    if (dev.vbi_dev) {
    ...
    dev.radio_dev = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(dev->board: SAA7134_BOARD_NOAUTO ==) -> else {
...
// get mmio
    ...
    if (core::ptr::null_mut() == dev.lmmio) {
    err = -EIO;
...
// load i2c helpers
    ...
    "saa6752hs",
    saa7134_boards[dev.board].empress_addr, core::ptr::null_mut());
    if (dev.empress_sd)
...
#[no_mangle]
unsafe extern "C" fn saa7134_finidev(pci_dev: *mut pci_dev) {
...
// debugging ...
    if (irq_debug) {
    let mut report: u32 = saa_readl(SAA7134_IRQ_REPORT);
    let mut status: u32 = saa_readl(SAA7134_IRQ_STATUS);
...
// the DMA sound modules should be unloaded before reaching
    ...
    if (dev.dmasound.priv_data != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn saa7134_suspend(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn saa7134_resume(dev_d: *mut device) -> int __maybe_unused {
...
// -----------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn saa7134_ts_register(ops: *mut saa7134_mpeg_ops) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_ts_unregister(ops: *mut saa7134_mpeg_ops) {
...
#[no_mangle]
unsafe extern "C" fn saa7134_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn saa7134_fini() -> void __exit {
