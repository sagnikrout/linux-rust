...
//! Source: drivers/media/pci/saa7134/saa7134-cards.c
#![no_std]
...
// and another tuner (dbaryshkov@gmail.com)
    ...
    let mut saa7134_bcount: c_uint = ARRAY_SIZE(saa7134_boards);
// ------------------------------------------------------------------
...
// flyvideo tweaks
#[no_mangle]
unsafe extern "C" fn board_flyvideo(dev: *mut saa7134_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_tuner_callback(priv: *mut c_void, component: c_int, command: c_int, arg: c_int) -> c_int {
...
// -----------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn hauppauge_eeprom(dev: *mut saa7134_dev, eeprom_data: *mut u8) {
...
// -----------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn saa7134_board_init1(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7134_tuner_setup(dev: *mut saa7134_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_board_init2(dev: *mut saa7134_dev) -> c_int {
...
//
    u8 data[] = { 0x07, 0x02};
    let mut msg: i2c_msg = {.addr=0x08, .flags=0, .buf=data, .len = sizeof(data)};
...
//
    ...
    let mut msg: i2c_msg = {.addr=0x09, .flags=0, .buf=data, .len = sizeof(data)};
    i2c_transfer(&dev.i2c_adap, &msg, 1);
//
...
// Reconfigure board  as T200A
    ...
    {
    let mut msg: i2c_msg = { .addr = 0x0a, .flags = 0 };
    int i;
    static u8 buffer[][2] = {
    { 0x10, 0x12 },
    { 0x13, 0x04 },
...
// initialize tuner (don't do this when resuming)
    ...
    let mut has_demod: c_int = (dev.tda9887_conf & TDA9887_PRESENT);
// Note: radio tuner address is always filled in,
    so we do not need to probe for a radio tuner device. */
    if (dev.radio_type != UNSET)
    v4l2_i2c_new_subdev(&dev.v4l2_dev,
    &dev.i2c_adap, "tuner",
    dev.radio_addr, core::ptr::null_mut());
    if (has_demod)
    v4l2_i2c_new_subdev(&dev.v4l2_dev,
    &dev.i2c_adap, "tuner",
