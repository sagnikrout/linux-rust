...
//! Source: drivers/media/pci/saa7134/saa7134-input.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn build_key(dev: *mut saa7134_dev) -> c_int {
...
// We need this to access GPI Used by the saa_readl macro.
    ...
    ir_dbg(ir, "get_key_flydvb_trio: ir.c.adapter.algo_data is core::ptr::null_mut()!\n");
    return -EIO;
    }
...
// <dev> is needed to access GPIO. Used by the saa_readl macro.
    struct saa7134_dev *dev = ir.c.adapter.algo_data;
    if (dev == core::ptr::null_mut()) {
    ir_dbg(ir, "get_key_msi_tvanywhere_plus: ir.c.adapter.algo_data is core::ptr::null_mut()!\n");
    return -EIO;
    }
// rising SAA7134_GPIO_GPRESCAN reads the status
    saa_clearb(SAA7134_GPIO_GPMODE3, SAA7134_GPIO_GPRESCAN);
...
// <dev> is needed to access GPIO. Used by the saa_readl macro.
    struct saa7134_dev *dev = ir.c.adapter.algo_data;
    if (dev == core::ptr::null_mut()) {
    ir_dbg(ir, "get_key_kworld_pc150u: ir.c.adapter.algo_data is core::ptr::null_mut()!\n");
    return -EIO;
    }
// rising SAA7134_GPIO_GPRESCAN reads the status
    saa_clearb(SAA7134_GPIO_GPMODE3, SAA7134_GPIO_GPRESCAN);
...
//
    ...
    int rc;
    unsigned char b[4];
    let mut start: c_uint = 0,parity = 0,code = 0;
// poll IR chip
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_input_irq(dev: *mut saa7134_dev) {
...
#[no_mangle]
unsafe extern "C" fn saa7134_input_timer(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_ir_open(rc: *mut rc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_ir_close(rc: *mut rc_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_input_init1(dev: *mut saa7134_dev) -> c_int {
    int saa7134_input_init1(struct saa7134_dev *dev)
    {
    struct saa7134_card_ir *ir;
    struct rc_dev *rc;
    char *ir_codes = core::ptr::null_mut();
    let mut mask_keycode: u32 = 0;
    let mut mask_keydown: u32 = 0;
    let mut mask_keyup: u32 = 0;
    let mut polling: unsigned = 0;
    let mut raw_decode: bool = false;
    int err;
...
// init input device
    ...
    err_out_free:
    rc_free_device(rc);
    dev.remote = core::ptr::null_mut();
    kfree(ir);
    return err;
    }
#[no_mangle]
pub unsafe extern "C" fn saa7134_input_fini(dev: *mut saa7134_dev) {
    void saa7134_input_fini(struct saa7134_dev *dev)
    {
    if (core::ptr::null_mut() == dev.remote)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_probe_i2c_ir(dev: *mut saa7134_dev) {
...
#[no_mangle]
unsafe extern "C" fn saa7134_raw_decode_irq(dev: *mut saa7134_dev) -> c_int {
    static int saa7134_raw_decode_irq(struct saa7134_dev *dev)
    {
    struct saa7134_card_ir *ir = dev.remote;
    int space;
