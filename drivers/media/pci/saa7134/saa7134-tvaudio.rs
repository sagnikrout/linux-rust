...
//! Source: drivers/media/pci/saa7134/saa7134-tvaudio.c
#![no_std]
...
// ------------------------------------------------------------------
    ...
    let mut audio_clock_override: static int = UNSET;
...
// msecs
pub const SCAN_INITIAL_DELAY: c_int = 1000;
pub const SCAN_SAMPLE_DELAY: c_int = 200;
pub const SCAN_SUBCARRIER_DELAY: c_int = 2000;
// ------------------------------------------------------------------
// saa7134 code
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn tvaudio_carr2reg(carrier: u32) -> u32 {
    static u32 tvaudio_carr2reg(u32 carrier)
    {
    let mut a: u64 = carrier;
    a <<= 24;
    do_div(a,12288);
    return a;
    }
...
pub const SAA7134_MUTE_MASK: c_uint = 0xbb;
pub const SAA7134_MUTE_ANALOG: c_uint = 0x04;
pub const SAA7134_MUTE_I2S: c_uint = 0x40;
#[no_mangle]
unsafe extern "C" fn mute_input_7134(dev: *mut saa7134_dev) {
    static void mute_input_7134(struct saa7134_dev *dev)
    {
    unsigned int mute;
    struct saa7134_input *in;
    let mut ausel: c_int = 0, ics=0, ocs=0;
    int mask;
// look what is to do ...
    in   = dev.input;
    mute = (dev.ctl_mute ||
...
#[no_mangle]
unsafe extern "C" fn tvaudio_sleep(dev: *mut saa7134_dev, timeout: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvaudio_checkcarrier(dev: *mut saa7134_dev, scan: *mut mainscan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvaudio_getstereo(dev: *mut saa7134_dev, audio: *mut saa7134_tvaudio) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x05): 0x05 == (idp &) -> else {
    else if (0x05 == (idp & 0x05))
    retval = V4L2_TUNER_SUB_MONO | V4L2_TUNER_SUB_STEREO;
#[no_mangle]
pub unsafe extern "C" fn if(0x01): 0x01 == (idp &) -> else {
...
#[no_mangle]
unsafe extern "C" fn tvaudio_thread(data: *mut c_void) -> c_int {
...
// scan for the main carrier
    ...
    tvaudio_setmode(dev,&tvaudio[0],core::ptr::null_mut());
    for (i = 0; i < ARRAY_SIZE(mainscan); i++) {
...
pub const DSP_RETRY: c_int = 32;
pub const DSP_DELAY: c_int = 16;
pub const SAA7135_DSP_RWCLEAR_RERR: c_int = 1;
#[no_mangle]
pub unsafe extern "C" fn saa_dsp_reset_error_bit(dev: *mut saa7134_dev) -> c_int {
    static inline int saa_dsp_reset_error_bit(struct saa7134_dev *dev)
    {
    let mut state: c_int = saa_readb(SAA7135_DSP_RWSTATE);
...
#[no_mangle]
pub unsafe extern "C" fn saa_dsp_wait_bit(dev: *mut saa7134_dev, bit: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa_dsp_writel(dev: *mut saa7134_dev, reg: c_int, value: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn getstereo_7133(dev: *mut saa7134_dev) -> c_int {
    static int getstereo_7133(struct saa7134_dev *dev)
    {
    let mut retval: c_int = V4L2_TUNER_SUB_MONO;
    u32 value;
...
#[no_mangle]
unsafe extern "C" fn mute_input_7133(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tvaudio_thread_ddep(data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_enable_i2s(dev: *mut saa7134_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_tvaudio_rx2mode(rx: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_TUNER_SUB_LANG1: rx &) -> else {
    else if (rx & V4L2_TUNER_SUB_LANG1)
    mode = V4L2_TUNER_MODE_LANG1;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_TUNER_SUB_LANG2: rx &) -> else {
    else if (rx & V4L2_TUNER_SUB_LANG2)
    mode = V4L2_TUNER_MODE_LANG2;
    return mode;
    }
#[no_mangle]
pub unsafe extern "C" fn saa7134_tvaudio_setmute(dev: *mut saa7134_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_tvaudio_setvolume(dev: *mut saa7134_dev, level: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_tvaudio_getstereo(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_tvaudio_init(dev: *mut saa7134_dev) {
    void saa7134_tvaudio_init(struct saa7134_dev *dev)
    {
    let mut clock: c_int = saa7134_boards[dev.board].audio_clock;
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_tvaudio_init2(dev: *mut saa7134_dev) -> c_int {
    int saa7134_tvaudio_init2(struct saa7134_dev *dev)
    {
    int (*my_thread)(void *data) = core::ptr::null_mut();
    switch (dev.pci.device) {
    case PCI_DEVICE_ID_PHILIPS_SAA7134:
    ...
    dev.thread.thread = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_tvaudio_close(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_tvaudio_fini(dev: *mut saa7134_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn saa7134_tvaudio_do_scan(dev: *mut saa7134_dev) -> c_int {
