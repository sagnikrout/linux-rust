...
//! Source: drivers/media/pci/tw686x/tw686x-video.c
#![no_std]
...
pub const TW686X_INPUTS_PER_CH: c_int = 4;
pub const TW686X_VIDEO_WIDTH: c_int = 720;

pub const TW686X_MAX_SG_ENTRY_SIZE: c_int = 4096;
...
// Check device presence. Shouldn't really happen!
    ...
    {
    struct tw686x_dev *dev = vc.dev;
    let mut reg: u32 = pb ? VDMA_B_ADDR[vc.ch] : VDMA_P_ADDR[vc.ch];
    unsigned int len;
    void *virt;
    ...
    vc.curr_bufs[pb] = core::ptr::null_mut();
    }
...
// Clear the scatter-gather table
    ...
    let mut phys: dma_addr_t = sg_dma_address(sg);
    len = sg_dma_len(sg);
    while (len && buf_len) {
    ...
    vc.sg_descs[pb] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn tw686x_sg_setup(dev: *mut tw686x_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw686x_real_fps(index: c_uint, max_fps: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn tw686x_fps_idx(fps: c_uint, max_fps: c_uint) -> c_uint {
...
// Check if the difference is bigger than abs(1) and adjust
    ...
    idx++;
#[no_mangle]
pub unsafe extern "C" fn if(1: delta >) -> else {
    else if (delta > 1)
    idx--;
// Max framerate
    if (idx >= 15)
...
#[no_mangle]
unsafe extern "C" fn tw686x_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn tw686x_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw686x_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn tw686x_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw686x_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    ...
    struct tw686x_video_channel *vc = video_drvdata(file);
    struct tw686x_dev *dev = vc.dev;
    let mut video_height: c_uint = TW686X_VIDEO_HEIGHT(vc.video_standard);
...
#[no_mangle]
unsafe extern "C" fn tw686x_set_standard(vc: *mut tw686x_video_channel, id: v4l2_std_id) -> c_int {
    ...
    val = 0;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_PAL: id &) -> else {
    else if (id & V4L2_STD_PAL)
    val = 1;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_SECAM: id &) -> else {
    else if (id & V4L2_STD_SECAM)
    val = 2;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_NTSC_443: id &) -> else {
    else if (id & V4L2_STD_NTSC_443)
    val = 3;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_PAL_M: id &) -> else {
    else if (id & V4L2_STD_PAL_M)
    val = 4;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_PAL_Nc: id &) -> else {
    else if (id & V4L2_STD_PAL_Nc)
    val = 5;
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_PAL_60: id &) -> else {
...
#[no_mangle]
unsafe extern "C" fn tw686x_s_std(file: *mut file, priv: *mut c_void, id: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw686x_querystd(file: *mut file, priv: *mut c_void, std: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw686x_g_std(file: *mut file, priv: *mut c_void, id: *mut v4l2_std_id) -> c_int {
...
// id = vc->video_standard;
    ...
    {
    struct tw686x_video_channel *vc = video_drvdata(file);
    let mut max_fps: c_int = TW686X_MAX_FPS(vc.video_standard);
    let mut max_rates: c_int = DIV_ROUND_UP(max_fps, 2);
    ...
    struct tw686x_video_channel *vc = video_drvdata(file);
    struct v4l2_captureparm *cp = &sp.parm.capture;
    let mut denominator: c_uint = cp.timeperframe.denominator;
    let mut numerator: c_uint = cp.timeperframe.numerator;
    unsigned int fps;
    if (vb2_is_busy(&vc.vidq))
    return -EBUSY;
...
#[no_mangle]
unsafe extern "C" fn tw686x_set_input(vc: *mut tw686x_video_channel, i: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn tw686x_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw686x_g_input(file: *mut file, priv: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tw686x_video_free(dev: *mut tw686x_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn tw686x_video_init(dev: *mut tw686x_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(TW686X_DMA_MODE_CONTIG: dev->dma_mode ==) -> else {
    else if (dev.dma_mode == TW686X_DMA_MODE_CONTIG)
    dev.dma_ops = &contig_dma_ops;
#[no_mangle]
pub unsafe extern "C" fn if(TW686X_DMA_MODE_SG: dev->dma_mode ==) -> else {
