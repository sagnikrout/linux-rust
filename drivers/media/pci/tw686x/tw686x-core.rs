...
//! Source: drivers/media/pci/tw686x/tw686x-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tw686x_dma_mode_get(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
    static int tw686x_dma_mode_get(char *buffer, const struct kernel_param *kp)
    {
    return sprintf(buffer, "%s", dma_mode_name(dma_mode));
    }
#[no_mangle]
unsafe extern "C" fn tw686x_dma_mode_set(val: *const c_char, kp: *const kernel_param) -> c_int {
    static int tw686x_dma_mode_set(const char *val, const struct kernel_param *kp)
    {
    if (!strcasecmp(val, dma_mode_name(TW686X_DMA_MODE_MEMCPY)))
    dma_mode = TW686X_DMA_MODE_MEMCPY;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(val, _arg: dma_mode_name(TW686X_DMA_MODE_CONTIG))) -> else {
    else if (!strcasecmp(val, dma_mode_name(TW686X_DMA_MODE_CONTIG)))
    dma_mode = TW686X_DMA_MODE_CONTIG;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(val, _arg: dma_mode_name(TW686X_DMA_MODE_SG))) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn tw686x_disable_channel(dev: *mut tw686x_dev, channel: c_uint) {
    void tw686x_disable_channel(struct tw686x_dev *dev, unsigned int channel)
    {
    let mut dma_en: u32 = reg_read(dev, DMA_CHANNEL_ENABLE);
    let mut dma_cmd: u32 = reg_read(dev, DMA_CMD);
    dma_en &= ~BIT(channel);
    dma_cmd &= ~BIT(channel);
...
#[no_mangle]
pub unsafe extern "C" fn tw686x_enable_channel(dev: *mut tw686x_dev, channel: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn tw686x_dma_delay(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn tw686x_reset_channels(dev: *mut tw686x_dev, ch_mask: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn tw686x_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tw686x_dev_release(v4l2_dev: *mut v4l2_device) {
...
#[no_mangle]
unsafe extern "C" fn tw686x_remove(pci_dev: *mut pci_dev) {
