...
//! Source: drivers/media/pci/cx18/cx18-av-firmware.c
#![no_std]
...
pub const CX18_AUDIO_ENABLE: c_uint = 0xc72014;
pub const CX18_AI1_MUX_MASK: c_uint = 0x30;
pub const CX18_AI1_MUX_I2S1: c_uint = 0x00;
pub const CX18_AI1_MUX_I2S2: c_uint = 0x10;
pub const CX18_AI1_MUX_843_I2S: c_uint = 0x20;
pub const CX18_AI1_MUX_INVALID: c_uint = 0x30;

#[no_mangle]
unsafe extern "C" fn cx18_av_verifyfw(cx: *mut cx18, fw: *const firmware) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx18_av_loadfw(cx: *mut cx18) -> c_int {
...
// Put the 8051 in reset and enable firmware upload
    ...
    size = fw.size;
    for (i = 0; i < size; i++) {
    let mut dl_control: u32 = 0x0F000000 | i | ((u32)ptr[i] << 16);
    let mut value: u32 = 0;
    int retries2;
    let mut unrec_err: c_int = 0;
