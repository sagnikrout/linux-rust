...
//! Source: drivers/media/pci/cx18/cx18-av-audio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn set_audclk_freq(cx: *mut cx18, freq: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx18_av_audio_set_path(cx: *mut cx18) {
...
#[no_mangle]
unsafe extern "C" fn set_volume(cx: *mut cx18, volume: c_int) {
    static void set_volume(struct cx18 *cx, int volume)
    {
// First convert the volume to msp3400 values (0-127)
    let mut vol: c_int = volume >> 9;
...
#[no_mangle]
unsafe extern "C" fn set_bass(cx: *mut cx18, bass: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_treble(cx: *mut cx18, treble: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_balance(cx: *mut cx18, balance: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_mute(cx: *mut cx18, mute: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn cx18_av_s_clock_freq(sd: *mut v4l2_subdev, freq: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx18_av_audio_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
