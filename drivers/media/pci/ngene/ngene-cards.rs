...
//! Source: drivers/media/pci/ngene/ngene-cards.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn i2c_write(adap: *mut i2c_adapter, adr: u8, data: *mut u8, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_read(adapter: *mut i2c_adapter, adr: u8, val: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_read_reg(adapter: *mut i2c_adapter, adr: u8, reg: u8, val: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tuner_attach_stv6110(chan: *mut ngene_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tuner_attach_stv6111(chan: *mut ngene_channel) -> c_int {
    static int tuner_attach_stv6111(struct ngene_channel *chan)
    {
    struct device *pdev = &chan.dev.pci_dev.dev;
    struct i2c_adapter *i2c = i2c_adapter_from_chan(chan);
    struct dvb_frontend *fe;
    let mut adr: u8 = 4 + ((chan.number & 1) ? 0x63 : 0x60);
...
#[no_mangle]
unsafe extern "C" fn tuner_attach_tda18271(chan: *mut ngene_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tuner_attach_tda18212(chan: *mut ngene_channel, dmdtype: u32) -> c_int {
    ...
    let mut addr: u8 = (chan.number & 1) ? 0x63 : 0x60;
//
...
// perform tuner probe/init/attach
    client = dvb_module_probe("tda18212", core::ptr::null_mut(), i2c, addr, &config);
    if (!client)
    goto err;
...
#[no_mangle]
unsafe extern "C" fn tuner_attach_probe(chan: *mut ngene_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn demod_attach_stv0900(chan: *mut ngene_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cineS2_tuner_i2c_lock(fe: *mut dvb_frontend, lock: c_int) {
...
#[no_mangle]
unsafe extern "C" fn port_has_stv0900(i2c: *mut i2c_adapter, port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_has_drxk(i2c: *mut i2c_adapter, port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_has_stv0367(i2c: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ngene_port_has_cxd2099(i2c: *mut i2c_adapter, type: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_xo2(chan: *mut ngene_channel, i2c: *mut i2c_adapter) -> c_int {
    static int init_xo2(struct ngene_channel *chan, struct i2c_adapter *i2c)
    {
    struct device *pdev = &chan.dev.pci_dev.dev;
    let mut addr: u8 = 0x10;
    u8 val, data[2];
    int res;
...
#[no_mangle]
unsafe extern "C" fn port_has_xo2(i2c: *mut i2c_adapter, type: *mut u8, id: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cineS2_probe(chan: *mut ngene_channel) -> c_int {
    ...
    let mut sony_osc24: u8 = 0;
    let mut i2c_msg: i2c_msg = { .flags = 0, .buf = buf };
    int rc;
...
//
#[no_mangle]
unsafe extern "C" fn demod_attach_lg330x(chan: *mut ngene_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn demod_attach_drxd(chan: *mut ngene_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tuner_attach_dtt7520x(chan: *mut ngene_channel) -> c_int {
...
// EEPROM TAGS
//
pub const MICNG_EE_START: c_uint = 0x0100;
pub const MICNG_EE_END: c_uint = 0x0FF0;
pub const MICNG_EETAG_END0: c_uint = 0x0000;
pub const MICNG_EETAG_END1: c_uint = 0xFFFF;
// 0x0001 - 0x000F reserved for housekeeping
// 0xFFFF - 0xFFFE reserved for housekeeping
// Micronas assigned tags
    EEProm tags for hardware support */
pub const MICNG_EETAG_DRXD1_OSCDEVIATION: c_uint = 0x1000  /* 2 Bytes data */;
pub const MICNG_EETAG_DRXD2_OSCDEVIATION: c_uint = 0x1001  /* 2 Bytes data */;
pub const MICNG_EETAG_MT2060_1_1STIF: c_uint = 0x1100  /* 2 Bytes data */;
pub const MICNG_EETAG_MT2060_2_1STIF: c_uint = 0x1101  /* 2 Bytes data */;
// Tag range for OEMs
pub const MICNG_EETAG_OEM_FIRST: c_uint = 0xC000;
pub const MICNG_EETAG_OEM_LAST: c_uint = 0xFFEF;
    ...
    let mut Addr: u16 = MICNG_EE_START, Length, tag = 0;
    u8  EETag[3];
...
// pLength = EETag[2];
    ...
    struct device *pdev = adapter.dev.parent;
    let mut status: c_int = 0;
    let mut Addr: u16 = MICNG_EE_START;
    u8 EETag[3];
    let mut tag: u16 = 0;
    int retry, i;
    while (Addr + sizeof(u16) + 1 < MICNG_EE_END) {
...
#[no_mangle]
unsafe extern "C" fn eeprom_read_ushort(adapter: *mut i2c_adapter, tag: u16, data: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeprom_write_ushort(adapter: *mut i2c_adapter, tag: u16, data: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn osc_deviation(priv: *mut c_void, deviation: i16, flag: c_int) -> i16 {
...
// Channel 0 is analog, which is currently unsupported
    ...
    .demod_attach   = { core::ptr::null_mut(), demod_attach_lg330x },
// Ensure these are NULL else the frame will call them (as funcs)
    .tuner_attach   = { core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut() },
    .fe_config      = { core::ptr::null_mut(), &aver_m780 },
    .avf            = { 0 },
...
#[no_mangle]
unsafe extern "C" fn ngene_slot_reset(dev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn ngene_resume(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn module_init_ngene() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn module_exit_ngene() -> __exit void {
