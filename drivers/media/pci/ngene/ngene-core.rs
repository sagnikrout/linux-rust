...
//! Source: drivers/media/pci/ngene/ngene-core.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn event_bh_work(t: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn demux_bh_work(t: *mut work_struct) {
    ...
    let mut Flags: u32 = chan.DataFormatFlags;
...
#[no_mangle]
unsafe extern "C" fn irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t irq_handler(int irq, void *dev_id)
    {
    struct ngene *dev = (struct ngene *)dev_id;
    struct device *pdev = &dev.pci_dev.dev;
    let mut icounts: u32 = 0;
    let mut rc: irqreturn_t = IRQ_NONE;
    let mut i: u32 = MAX_STREAM;
    u8 *tmpCmdDoneByte;
    if (dev.BootFirmware) {
    ...
    dev.CmdDoneByte = core::ptr::null_mut();
    dev.cmd_done = 1;
    wake_up(&dev.cmd_wq);
    rc = IRQ_HANDLED;
    }
...
//
#[no_mangle]
unsafe extern "C" fn dump_command_io(dev: *mut ngene) {
...
#[no_mangle]
unsafe extern "C" fn ngene_command_mutex(dev: *mut ngene, com: *mut ngene_command) -> c_int {
    ...
    let mut fwio: u64 = dev.PAFWInterfaceBuffer;
...
#[no_mangle]
pub unsafe extern "C" fn ngene_command(dev: *mut ngene, com: *mut ngene_command) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ngene_command_config_buf(dev: *mut ngene, config: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ngene_command_config_free_buf(dev: *mut ngene, config: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ngene_command_gpio_set(dev: *mut ngene, select: u8, level: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn disable(controlled: fw) -> 7 {
...
#[no_mangle]
pub unsafe extern "C" fn FillTSBuffer(Buffer: *mut c_void, Length: c_int, Flags: u32) {
...
#[no_mangle]
unsafe extern "C" fn flush_buffers(chan: *mut ngene_channel) {
...
#[no_mangle]
unsafe extern "C" fn clear_buffers(chan: *mut ngene_channel) {
    ...
    struct ngene_command com;
    let mut BsUVI: u16 = ((stream & 1) ? 0x9400 : 0x9300);
    let mut BsSDI: u16 = ((stream & 1) ? 0x9600 : 0x9500);
    let mut BsSPI: u16 = ((stream & 1) ? 0x9800 : 0x9700);
    let mut BsSDO: u16 = 0x9B00;
...
#[no_mangle]
pub unsafe extern "C" fn set_transfer(chan: *mut ngene_channel, state: c_int) {
    void set_transfer(struct ngene_channel *chan, int state)
    {
    struct device *pdev = &chan.dev.pci_dev.dev;
    let mut control: u8 = 0, mode = 0, flags = 0;
...
// else dev_info(pdev, "lock=%08x\n",
    ...
    if (!state) {
    spin_lock_irq(&chan.state_lock);
    chan.pBufferExchange = core::ptr::null_mut();
    dvb_ringbuffer_flush(&dev.tsout_rbuf);
    spin_unlock_irq(&chan.state_lock);
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn free_ringbuffer(dev: *mut ngene, rb: *mut SRingBufferDescriptor) {
    ...
    Cur.Buffer2 = core::ptr::null_mut();
    Cur.scList2 = core::ptr::null_mut();
    Cur.ngeneBuffer.Address_of_first_entry_2 = 0;
    Cur.ngeneBuffer.Number_of_entries_2 = 0;
    }
    }
#[no_mangle]
unsafe extern "C" fn free_common_buffers(dev: *mut ngene) {
...
//
    ...
    u32 i;
    let mut MemSize: u32 = SIZEOF_SBufferHeader * NumBuffers;
    u64 PARingBufferHead;
    u64 PARingBufferCur;
    u64 PARingBufferNext;
    struct SBufferHeader *Cur, *Next;
    descr.Head = core::ptr::null_mut();
    descr.MemSize = 0;
    descr.PAHead = 0;
    descr.NumBuffers = 0;
    if (MemSize < 4096)
...
// sizeof(struct HW_SCATTER_GATHER_ELEMENT);
    ...
    GFP_KERNEL);
    PASCListMem = tmp;
    if (SCListMem == core::ptr::null_mut())
    return -ENOMEM;
...
//
    let mut n: u32 = pRingBuffer.NumBuffers;
...
#[no_mangle]
unsafe extern "C" fn AllocCommonBuffers(dev: *mut ngene) -> c_int {
    ...
    return -ENOMEM;
    for (i = STREAM_VIDEOIN1; i < MAX_STREAM; i++) {
    let mut type: c_int = dev.card_info.io_type[i];
...
#[no_mangle]
unsafe extern "C" fn ngene_release_buffers(dev: *mut ngene) {
...
#[no_mangle]
unsafe extern "C" fn ngene_get_buffers(dev: *mut ngene) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ngene_init(dev: *mut ngene) {
...
#[no_mangle]
unsafe extern "C" fn ngene_load_firm(dev: *mut ngene) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ngene_stop(dev: *mut ngene) {
...
#[no_mangle]
unsafe extern "C" fn ngene_buffer_config(dev: *mut ngene) -> c_int {
    ...
    let mut bconf: c_int = BUFFER_CONFIG_4422;
...
#[no_mangle]
unsafe extern "C" fn ngene_start(dev: *mut ngene) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn release_channel(chan: *mut ngene_channel) {
...
// release I2C client (tuner) if needed
    ...
    chan.i2c_client[0] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn init_channel(chan: *mut ngene_channel) -> c_int {
    static int init_channel(struct ngene_channel *chan)
    {
    let mut ret: c_int = 0, nr = chan.number;
    struct dvb_adapter *adapter = core::ptr::null_mut();
    struct dvb_demux *dvbdemux = &chan.demux;
    struct ngene *dev = chan.dev;
    struct ngene_info *ni = dev.card_info;
    let mut io: c_int = ni.io_type[nr];
    ...
    if (nr == 0 || !one_adapter || dev.first_adapter == core::ptr::null_mut()) {
    ...
    if (ret < 0)
    goto err;
    if (dev.first_adapter == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn init_channels(dev: *mut ngene) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxd_attach(dev: *mut ngene) {
    static void cxd_attach(struct ngene *dev)
    {
    struct device *pdev = &dev.pci_dev.dev;
    struct ngene_ci *ci = &dev.ci;
    let mut cxd_cfg: cxd2099_cfg = cxd_cfgtmpl;
...
// check for CXD2099AR presence before attaching
    ...
    cxd_cfg.en = &ci.en;
    client = dvb_module_probe("cxd2099", core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn cxd_detach(dev: *mut ngene) {
    static void cxd_detach(struct ngene *dev)
    {
    struct ngene_ci *ci = &dev.ci;
    dvb_ca_en50221_release(ci.en);
    dvb_module_release(dev.channel[0].i2c_client[0]);
    dev.channel[0].i2c_client[0] = core::ptr::null_mut();
    ci.en = core::ptr::null_mut();
    }
//
// workaround for shutdown failure
//
#[no_mangle]
unsafe extern "C" fn ngene_unlink(dev: *mut ngene) {
...
#[no_mangle]
pub unsafe extern "C" fn ngene_shutdown(pdev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ngene_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn ngene_probe(pci_dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
