...
//! Source: drivers/media/pci/ngene/ngene-i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ngene_i2c_set_bus(dev: *mut ngene, bus: c_int) {
    ...
    goto done;
    if (num == 1 && (msg[0].flags & I2C_M_RD))
    if (!ngene_command_i2c_read(dev, msg[0].addr, core::ptr::null_mut(), 0,
...
#[no_mangle]
unsafe extern "C" fn ngene_i2c_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ngene_i2c_init(dev: *mut ngene, dev_nr: c_int) -> c_int {
