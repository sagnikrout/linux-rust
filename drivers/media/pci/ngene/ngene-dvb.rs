...
//! Source: drivers/media/pci/ngene/ngene-dvb.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn swap_buffer(p: *mut u32, len: u32) {
...
#[no_mangle]
unsafe extern "C" fn tsin_find_offset(buf: *mut c_void, len: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tsin_copy_stripped(dev: *mut ngene, buf: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn ngene_start_feed(dvbdmxfeed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ngene_stop_feed(dvbdmxfeed: *mut dvb_demux_feed) -> c_int {
