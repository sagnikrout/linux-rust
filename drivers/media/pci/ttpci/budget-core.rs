...
//! Source: drivers/media/pci/ttpci/budget-core.c
#![no_std]
...
pub const TS_HEIGHT_MASK: c_uint = 0xf00;
pub const TS_HEIGHT_MASK_ACTIVY: c_uint = 0xc00;
pub const TS_HEIGHT_MASK_DVBC: c_uint = 0xe00;
pub const TS_MIN_BUFSIZE_K: c_int = 188;
pub const TS_MAX_BUFSIZE_K: c_int = 1410;
pub const TS_MAX_BUFSIZE_K_ACTIVY: c_int = 564;
pub const TS_MAX_BUFSIZE_K_DVBC: c_int = 1316;

    int budget_debug;
    EXPORT_SYMBOL_GPL(budget_debug);
    let mut dma_buffer_size: static int = TS_MIN_BUFSIZE_K;
...
//
#[no_mangle]
unsafe extern "C" fn stop_ts_capture(budget: *mut budget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn start_ts_capture(budget: *mut budget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vpeirq(t: *mut work_struct) {
    static void vpeirq(struct work_struct *t)
    {
    struct budget *budget = from_work(budget, t, vpe_bh_work);
    u8 *mem = (u8 *) (budget.grabbing);
    let mut olddma: u32 = budget.ttbp;
    let mut newdma: u32 = saa7146_read(budget.dev, PCI_VDP3);
    u32 count;
...
//
#[no_mangle]
unsafe extern "C" fn budget_start_feed(feed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn budget_stop_feed(feed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn budget_register(budget: *mut budget) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn budget_unregister(budget: *mut budget) {
...
#[no_mangle]
pub unsafe extern "C" fn if(max_bufsize: dma_buffer_size >) -> else {
...
//
    ...
    if (budget.grabbing == core::ptr::null_mut()) {
    ret = -ENOMEM;
    goto err_del_i2c;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ttpci_budget_init_hooks(budget: *mut budget) {
...
#[no_mangle]
pub unsafe extern "C" fn ttpci_budget_deinit(budget: *mut budget) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ttpci_budget_irq10_handler(dev: *mut saa7146_dev, isr: *mut u32) {
...
#[no_mangle]
pub unsafe extern "C" fn ttpci_budget_set_video_port(dev: *mut saa7146_dev, video_port: c_int) {
