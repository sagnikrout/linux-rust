...
//! Source: drivers/media/pci/cx88/cx88-alsa.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn _cx88_start_audio_dma(chip: *mut cx88_audio_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _cx88_stop_audio_dma(chip: *mut cx88_audio_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cx8801_aud_irq(chip: *mut cx88_audio_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn cx8801_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cx88_alsa_dma_map(dev: *mut cx88_audio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx88_alsa_dma_unmap(dev: *mut cx88_audio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx88_alsa_dma_free(buf: *mut cx88_audio_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsp_buffer_free(chip: *mut cx88_audio_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_cx88_pcm_open(substream: *mut snd_pcm_substream) -> c_int {
    ...
    let mut bpl: c_uint = cx88_sram_channels[SRAM_CH25].fifo_size / 4;
...
//
#[no_mangle]
unsafe extern "C" fn snd_cx88_close(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_cx88_hw_free(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_cx88_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_cx88_card_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_cx88_pointer(substream: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
//
    ...
    struct cx88_audio_dev *chip = snd_kcontrol_chip(kcontrol);
    struct cx88_core *core = chip.core;
    let mut left: u16 = value.value.integer.value[0];
    let mut right: u16 = value.value.integer.value[1];
    int v, b;
...
// Do we really know this will always be called with IRQs on?
    ...
    struct cx88_audio_dev *chip = snd_kcontrol_chip(kcontrol);
    struct cx88_core *core = chip.core;
    let mut bit: u32 = kcontrol.private_value;
...
//
#[no_mangle]
unsafe extern "C" fn snd_cx88_free(chip: *mut cx88_audio_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_cx88_dev_free(card: *mut snd_card) {
...
// core_ptr = core;
    ...
    struct cx88_audio_dev	*chip;
    struct cx88_core	*core = core::ptr::null_mut();
    int			err;
...
//
#[no_mangle]
unsafe extern "C" fn cx88_audio_finidev(pci: *mut pci_dev) {
