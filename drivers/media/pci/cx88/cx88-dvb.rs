...
//! Source: drivers/media/pci/cx88/cx88-dvb.c
#![no_std]
...
//
    ...
    let mut dvb_buf_tscnt: static unsigned int = 32;
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn cx88_dvb_bus_ctrl(fe: *mut dvb_frontend, acquire: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx88_dvb_gate_ctrl(core: *mut cx88_core, open: c_int) {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn dvico_fusionhdtv_demod_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvico_dual_demod_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dntv_live_dvbt_demod_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dntv_live_dvbt_pro_demod_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn or51132_set_ts_param(fe: *mut dvb_frontend, is_punctured: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lgdt330x_pll_rf_set(fe: *mut dvb_frontend, index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lgdt330x_set_ts_param(fe: *mut dvb_frontend, is_punctured: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxt200x_set_ts_param(fe: *mut dvb_frontend, is_punctured: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn attach_xc3028(addr: u8, dev: *mut cx8802_dev) -> c_int {
    static int attach_xc3028(u8 addr, struct cx8802_dev *dev)
    {
    struct dvb_frontend *fe;
    struct vb2_dvb_frontend *fe0 = core::ptr::null_mut();
...
//
    ...
    fe0.dvb.frontend = core::ptr::null_mut();
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn attach_xc4000(dev: *mut cx8802_dev, cfg: *mut xc4000_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx24116_reset_device(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx8802_alloc_frontends(dev: *mut cx8802_dev) -> c_int {
    static int cx8802_alloc_frontends(struct cx8802_dev *dev)
    {
    struct cx88_core *core = dev.core;
    struct vb2_dvb_frontend *fe = core::ptr::null_mut();
    int i;
...
#[no_mangle]
unsafe extern "C" fn samsung_smt_7020_tuner_set_params(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_register(dev: *mut cx8802_dev) -> c_int {
    static int dvb_register(struct cx8802_dev *dev)
    {
    struct cx88_core *core = dev.core;
    struct vb2_dvb_frontend *fe0, *fe1 = core::ptr::null_mut();
...
// DVB-T init
    ...
    if (fe0.dvb.frontend) {
    if (!dvb_attach(dvb_pll_attach, fe0.dvb.frontend,
    0x60, core::ptr::null_mut(), DVB_PLL_THOMSON_DTT7579))
    goto frontend_detach;
    break;
    }
...
//
    ...
    if (fe0.dvb.frontend) {
    if (!dvb_attach(dvb_pll_attach, fe0.dvb.frontend,
    0x61, core::ptr::null_mut(), DVB_PLL_THOMSON_DTT7579))
    goto frontend_detach;
    break;
    }
// ZL10353 replaces MT352 on later cards
    ...
    if (fe0.dvb.frontend) {
    if (!dvb_attach(dvb_pll_attach, fe0.dvb.frontend,
    0x61, core::ptr::null_mut(), DVB_PLL_LG_Z201))
    goto frontend_detach;
    }
    break;
    ...
    if (fe0.dvb.frontend) {
    if (!dvb_attach(dvb_pll_attach, fe0.dvb.frontend,
    0x61, core::ptr::null_mut(), DVB_PLL_UNKNOWN_1))
    goto frontend_detach;
    }
    break;
...
// DVB-T Init
    ...
    if ((core::ptr::null_mut() == fe0.dvb.frontend) || (fe1 && core::ptr::null_mut() == fe1.dvb.frontend)) {
...
// register everything
    ...
    &dev.pci.dev, core::ptr::null_mut(), adapter_nr,
    mfe_shared);
    if (res)
    goto frontend_detach;
    return res;
    frontend_detach:
    core.gate_ctrl = core::ptr::null_mut();
    vb2_dvb_dealloc_frontends(&dev.frontends);
    return res;
    }
// -----------------------------------------------------------
...
#[no_mangle]
unsafe extern "C" fn cx8802_dvb_advise_acquire(drv: *mut cx8802_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx8802_dvb_advise_release(drv: *mut cx8802_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx8802_dvb_probe(drv: *mut cx8802_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx8802_dvb_remove(drv: *mut cx8802_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dvb_fini() -> void __exit {
