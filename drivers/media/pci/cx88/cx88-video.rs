...
//! Source: drivers/media/pci/cx88/cx88-video.c
#![no_std]
...
// ------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn cx88_video_mux(core: *mut cx88_core, input: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stop_video_dma(dev: *mut cx8800_dev) -> int __maybe_unused {
...
// VIDEO CTRL IOCTLS
#[no_mangle]
unsafe extern "C" fn cx8800_s_vid_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx8800_s_aud_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// VIDEO IOCTLS
    ...
    struct cx8800_dev *dev = video_drvdata(file);
    struct cx88_core *core = dev.core;
    let mut err: c_int = vidioc_try_fmt_vid_cap(file, priv, f);
    if (err != 0)
    return err;
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_std(file: *mut file, priv: *mut c_void, tvnorms: v4l2_std_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx88_enum_input(core: *mut cx88_core, i: *mut v4l2_input) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx8800_vid_irq(dev: *mut cx8800_dev) {
...
#[no_mangle]
unsafe extern "C" fn cx8800_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// -----------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn cx8800_unregister_video(dev: *mut cx8800_dev) {
...
// get irq
    ...
    v4l2_ctrl_add_handler(&core.video_hdl, &core.audio_hdl, core::ptr::null_mut(), false);
...
#[no_mangle]
unsafe extern "C" fn cx8800_finidev(pci_dev: *mut pci_dev) {
...
// stop thread
    ...
    core.kthread = core::ptr::null_mut();
    }
    if (core.ir)
    cx88_ir_stop(core);
...
#[no_mangle]
unsafe extern "C" fn cx8800_suspend(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn cx8800_resume(dev_d: *mut device) -> int __maybe_unused {
