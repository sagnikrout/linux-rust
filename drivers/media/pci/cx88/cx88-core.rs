...
//! Source: drivers/media/pci/cx88/cx88-core.c
#![no_std]
...
// debug helper code
#[no_mangle]
unsafe extern "C" fn cx88_risc_decode(risc: u32) -> c_int {
...
// ------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn cx88_core_irq(core: *mut cx88_core, status: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx88_shutdown(core: *mut cx88_core) {
...
#[no_mangle]
pub unsafe extern "C" fn cx88_reset(core: *mut cx88_core) -> c_int {
...
// ------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn norm_swidth(norm: v4l2_std_id) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn norm_hdelay(norm: v4l2_std_id) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn norm_vdelay(norm: v4l2_std_id) -> c_uint {
    static inline unsigned int norm_vdelay(v4l2_std_id norm)
    {
    return (norm & V4L2_STD_625_50) ? 0x24 : 0x18;
    }
#[no_mangle]
pub unsafe extern "C" fn norm_fsc8(norm: v4l2_std_id) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn norm_htotal(norm: v4l2_std_id) -> c_uint {
    static inline unsigned int norm_htotal(v4l2_std_id norm)
    {
    let mut fsc4: c_uint = norm_fsc8(norm) / 2;
...
#[no_mangle]
pub unsafe extern "C" fn norm_vbipack(norm: v4l2_std_id) -> c_uint {
    ...
    {
    let mut swidth: c_uint = norm_swidth(core.tvnorm);
    let mut sheight: c_uint = norm_maxh(core.tvnorm);
    u32 value;
...
// setup filters
    ...
    let mut xtal: static u32 = 28636363;
#[no_mangle]
unsafe extern "C" fn set_pll(core: *mut cx88_core, prescale: c_int, ofreq: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx88_start_audio_dma(core: *mut cx88_core) -> c_int {
    int cx88_start_audio_dma(struct cx88_core *core)
    {
// constant 128 made buzz in analog Nicam-stereo for bigger fifo_size
    let mut bpl: c_int = cx88_sram_channels[SRAM_CH25].fifo_size / 4;
    let mut rds_bpl: c_int = cx88_sram_channels[SRAM_CH27].fifo_size / AUD_RDS_LINES;
...
#[no_mangle]
pub unsafe extern "C" fn cx88_stop_audio_dma(core: *mut cx88_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tvaudio(core: *mut cx88_core) -> c_int {
    static int set_tvaudio(struct cx88_core *core)
    {
    let mut norm: v4l2_std_id = core.tvnorm;
...
#[no_mangle]
pub unsafe extern "C" fn cx88_set_tvnorm(core: *mut cx88_core, norm: v4l2_std_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx88_core_put(core: *mut cx88_core, pci: *mut pci_dev) {
