...
//! Source: drivers/media/pci/cx88/cx88-cards.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn leadtek_eeprom(core: *mut cx88_core, eeprom_data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn hauppauge_eeprom(core: *mut cx88_core, eeprom_data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn gdi_eeprom(core: *mut cx88_core, eeprom_data: *mut u8) {
    static void gdi_eeprom(struct cx88_core *core, u8 *eeprom_data)
    {
    const char *name = (eeprom_data[0x0d] < ARRAY_SIZE(gdi_tuner))
    ? gdi_tuner[eeprom_data[0x0d]].name : core::ptr::null_mut();
    pr_info("GDI: tuner=%s\n", name ? name : "unknown");
    if (!name)
    return;
...
//
#[no_mangle]
unsafe extern "C" fn dvico_fusionhdtv_hybrid_init(core: *mut cx88_core) {
    static void dvico_fusionhdtv_hybrid_init(struct cx88_core *core)
    {
    let mut msg: i2c_msg = { .addr = 0x45, .flags = 0 };
    int i, err;
...
#[no_mangle]
pub unsafe extern "C" fn cx88_tuner_callback(priv: *mut c_void, component: c_int, command: c_int, arg: c_int) -> c_int {
...
// -----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn cx88_card_list(core: *mut cx88_core, pci: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn cx88_card_setup_pre_i2c(core: *mut cx88_core) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx88_setup_xc3028(core: *mut cx88_core, ctl: *mut xc2028_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn cx88_card_setup(core: *mut cx88_core) {
    static void cx88_card_setup(struct cx88_core *core)
    {
    static u8 eeprom[256];
    struct tuner_setup tun_setup;
    let mut mode_mask: c_uint = T_RADIO | T_ANALOG_TV;
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn cx88_pci_quirks(name: *const c_char, pci: *mut pci_dev) -> c_int {
    static int cx88_pci_quirks(const char *name, struct pci_dev *pci)
    {
    let mut lat: c_uint = UNSET;
    let mut ctrl: u8 = 0;
    u8 value;
// check pci quirks
...
#[no_mangle]
pub unsafe extern "C" fn cx88_get_resources(core: *const cx88_core, pci: *mut pci_dev) -> c_int {
...
//
    ...
    if (v4l2_device_register(core::ptr::null_mut(), &core.v4l2_dev)) {
    kfree(core);
    return core::ptr::null_mut();
    }
...
//
    ...
    let mut has_demod: c_int = (core.board.tda9887_conf & TDA9887_PRESENT);
//
