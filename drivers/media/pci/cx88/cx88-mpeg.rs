...
//! Source: drivers/media/pci/cx88/cx88-mpeg.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn request_modules(dev: *mut cx8802_dev) {
...
#[no_mangle]
unsafe extern "C" fn flush_request_modules(dev: *mut cx8802_dev) {
...
// Macro flag: #define flush_request_modules(dev)
...
#[no_mangle]
unsafe extern "C" fn cx8802_stop_dma(dev: *mut cx8802_dev) -> c_int {
...
// ------------------------------------------------------------------
    ...
    struct cx88_buffer *buf)
    {
    let mut size: c_int = dev.ts_packet_size * dev.ts_packet_count;
...
#[no_mangle]
pub unsafe extern "C" fn cx8802_buf_queue(dev: *mut cx8802_dev, buf: *mut cx88_buffer) {
...
// -----------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn do_cancel_buffers(dev: *mut cx8802_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn cx8802_cancel_buffers(dev: *mut cx8802_dev) {
    ...
    "ts_risci1", core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    "ts_risci2", core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    "ts_oflow",  core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    "ts_sync",   core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    "opc_err", "par_err", "rip_err", "pci_abort",
    "ts_err?",
    };
#[no_mangle]
unsafe extern "C" fn cx8802_mpeg_irq(dev: *mut cx8802_dev) {
...
pub const MAX_IRQ_LOOP: c_int = 10;
#[no_mangle]
unsafe extern "C" fn cx8802_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cx8802_init_common(dev: *mut cx8802_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx8802_fini_common(dev: *mut cx8802_dev) {
...
// -----------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn cx8802_suspend_common(pci_dev: *mut pci_dev, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx8802_resume_common(pci_dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx8802_request_acquire(drv: *mut cx8802_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx8802_request_release(drv: *mut cx8802_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx8802_check_driver(drv: *mut cx8802_driver) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx8802_register_driver(drv: *mut cx8802_driver) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx8802_unregister_driver(drv: *mut cx8802_driver) -> c_int {
...
// now autoload cx88-dvb or cx88-blackbird
    ...
    kfree(dev);
    fail_core:
    core.dvbdev = core::ptr::null_mut();
    cx88_core_put(core, pci_dev);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn cx8802_remove(pci_dev: *mut pci_dev) {
...
// Destroy any 8802 reference.
    dev.core.dvbdev = core::ptr::null_mut();
// common
