...
//! Source: drivers/media/pci/cx88/cx88-tvaudio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn set_audio_registers(core: *mut cx88_core, l: *const rlist) {
...
#[no_mangle]
unsafe extern "C" fn set_audio_start(core: *mut cx88_core, mode: u32) {
...
#[no_mangle]
unsafe extern "C" fn set_audio_finish(core: *mut cx88_core, ctl: u32) {
...
#[no_mangle]
unsafe extern "C" fn set_audio_standard_NICAM(core: *mut cx88_core, mode: u32) {
...
#[no_mangle]
unsafe extern "C" fn set_audio_standard_A2(core: *mut cx88_core, mode: u32) {
...
#[no_mangle]
unsafe extern "C" fn set_audio_standard_EIAJ(core: *mut cx88_core) {
...
// -----------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn cx88_detect_nicam(core: *mut cx88_core) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx88_set_tvaudio(core: *mut cx88_core) {
...
#[no_mangle]
pub unsafe extern "C" fn cx88_newstation(core: *mut cx88_core) {
...
#[no_mangle]
pub unsafe extern "C" fn cx88_get_stereo(core: *mut cx88_core, t: *mut v4l2_tuner) {
...
#[no_mangle]
pub unsafe extern "C" fn cx88_set_stereo(core: *mut cx88_core, mode: u32, manual: c_int) {
    void cx88_set_stereo(struct cx88_core *core, u32 mode, int manual)
    {
    let mut ctl: u32 = UNSET;
    let mut mask: u32 = UNSET;
    if (manual) {
...
#[no_mangle]
pub unsafe extern "C" fn cx88_audio_thread(data: *mut c_void) -> c_int {
