...
//! Source: drivers/media/pci/cx88/cx88-blackbird.c
#![no_std]
...
// ------------------------------------------------------------------
pub const BLACKBIRD_FIRM_IMAGE_SIZE: c_int = 376836;
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn host_setup(core: *mut cx88_core) {
...
// ------------------------------------------------------------------
pub const P1_MDATA0: c_uint = 0x390000;
pub const P1_MDATA1: c_uint = 0x390001;
pub const P1_MDATA2: c_uint = 0x390002;
pub const P1_MDATA3: c_uint = 0x390003;
pub const P1_MADDR2: c_uint = 0x390004;
pub const P1_MADDR1: c_uint = 0x390005;
pub const P1_MADDR0: c_uint = 0x390006;
pub const P1_RDATA0: c_uint = 0x390008;
pub const P1_RDATA1: c_uint = 0x390009;
pub const P1_RDATA2: c_uint = 0x39000A;
pub const P1_RDATA3: c_uint = 0x39000B;
pub const P1_RADDR0: c_uint = 0x39000C;
pub const P1_RADDR1: c_uint = 0x39000D;
pub const P1_RRDWR: c_uint = 0x39000E;
#[no_mangle]
unsafe extern "C" fn wait_ready_gpio0_bit1(core: *mut cx88_core, state: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn memory_write(core: *mut cx88_core, address: u32, value: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn memory_read(core: *mut cx88_core, address: u32, value: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn register_write(core: *mut cx88_core, address: u32, value: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn register_read(core: *mut cx88_core, address: u32, value: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn blackbird_find_mailbox(dev: *mut cx8802_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn blackbird_load_firmware(dev: *mut cx8802_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn blackbird_codec_settings(dev: *mut cx8802_dev) {
...
#[no_mangle]
unsafe extern "C" fn blackbird_initialize_codec(dev: *mut cx8802_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn blackbird_start_codec(dev: *mut cx8802_dev) -> c_int {
...
// start capturing to the host interface
    u32 reg;
    int i;
    let mut lastchange: c_int = -1;
    let mut lastval: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn blackbird_stop_codec(dev: *mut cx8802_dev) -> c_int {
...
unsafe extern "C" fn stop_streaming(q: *mut vb2_queue) {
    ...
    struct cx8802_dev *dev = q.drv_priv;
    struct cx88_dmaqueue *dmaq = &dev.mpegq;
    struct cx8802_driver *drv = core::ptr::null_mut();
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn vidioc_g_std(file: *mut file, priv: *mut c_void, tvnorm: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx8802_blackbird_advise_acquire(drv: *mut cx8802_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx8802_blackbird_advise_release(drv: *mut cx8802_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn blackbird_unregister_video(dev: *mut cx8802_dev) {
    static void blackbird_unregister_video(struct cx8802_dev *dev)
    {
    video_unregister_device(&dev.mpeg_dev);
    }
#[no_mangle]
unsafe extern "C" fn blackbird_register_video(dev: *mut cx8802_dev) -> c_int {
...
// -----------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn cx8802_blackbird_probe(drv: *mut cx8802_driver) -> c_int {
    ...
    if (err)
    goto fail_core;
    v4l2_ctrl_add_handler(&dev.cxhdl.hdl, &core.video_hdl, core::ptr::null_mut(), false);
// blackbird stuff
...
#[no_mangle]
unsafe extern "C" fn cx8802_blackbird_remove(drv: *mut cx8802_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn blackbird_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn blackbird_fini() -> void __exit {
