...
//! Source: drivers/media/pci/cx23885/cx23885-dvb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cx23885_dvb_gate_ctrl(port: *mut cx23885_tsport, open: c_int) {
...
// call the frontend set_voltage function
    ...
    {
// MC417
pub const SP2_DATA: c_uint = 0x000000ff;
pub const SP2_WR: c_uint = 0x00008000;
pub const SP2_RD: c_uint = 0x00004000;
pub const SP2_ACK: c_uint = 0x00001000;
pub const SP2_ADHI: c_uint = 0x00000800;
pub const SP2_ADLO: c_uint = 0x00000400;
pub const SP2_CS1: c_uint = 0x00000200;
pub const SP2_CS0: c_uint = 0x00000100;
pub const SP2_EN_ALL: c_uint = 0x00001000;
...
#[no_mangle]
unsafe extern "C" fn cx23885_dvb_set_frontend(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netup_altera_fpga_rw(device: *mut c_void, flag: c_int, data: c_int, read: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_register_ci_mac(port: *mut cx23885_tsport) -> c_int {
    static int dvb_register_ci_mac(struct cx23885_tsport *port)
    {
    struct cx23885_dev *dev = port.dev;
    struct i2c_client *client_ci = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dvb_register(port: *mut cx23885_tsport) -> c_int {
    static int dvb_register(struct cx23885_tsport *port)
    {
    struct dib7000p_ops dib7000p_ops;
    struct cx23885_dev *dev = port.dev;
    struct cx23885_i2c *i2c_bus = core::ptr::null_mut(), *i2c_bus2 = core::ptr::null_mut();
    ...
    let mut m88rs6000t_config: m88rs6000t_config = {};
    let mut a8293_pdata: a8293_platform_data = {};
    struct i2c_board_info info;
    struct i2c_adapter *adapter;
    struct i2c_client *client_demod = core::ptr::null_mut(), *client_tuner = core::ptr::null_mut();
    struct i2c_client *client_sec = core::ptr::null_mut();
    int (*p_set_voltage)(struct dvb_frontend *fe,
    enum fe_sec_voltage voltage) = core::ptr::null_mut();
...
// init frontend
    ...
    if (fe != core::ptr::null_mut() && fe.ops.tuner_ops.set_config != core::ptr::null_mut())
...
// MFE frontend 1 DVB-T
    ...
    if (fe0.dvb.frontend == core::ptr::null_mut())
    break;
    if (core::ptr::null_mut() == dvb_attach(xc5000_attach, fe0.dvb.frontend,
    &i2c_bus.i2c_adap,
...
// MFE frontend 2
    ...
    if (fe1 == core::ptr::null_mut())
    goto frontend_detach;
// DVB-C init
    fe1.dvb.frontend = dvb_attach(stv0367cab_attach,
    &netup_stv0367_config[port.nr - 1],
    &i2c_bus.i2c_adap);
    if (fe1.dvb.frontend == core::ptr::null_mut())
    break;
    fe1.dvb.frontend.id = 1;
    if (core::ptr::null_mut() == dvb_attach(xc5000_attach,
    fe1.dvb.frontend,
    &i2c_bus.i2c_adap,
    &netup_xc5000_config[port.nr - 1]))
    goto frontend_detach;
...
// port c
    ...
    let mut tda10071_pdata: tda10071_platform_data = hauppauge_tda10071_pdata;
    let mut a8293_pdata: a8293_platform_data = {};
    i2c_bus = &dev.i2c_bus[0];
    i2c_bus2 = &dev.i2c_bus[1];
    switch (port.nr) {
...
// attach tuner
    ...
    if (!try_module_get(client_tuner.dev.driver.owner)) {
    i2c_unregister_device(client_tuner);
    client_tuner = core::ptr::null_mut();
    goto frontend_detach;
    }
    port.i2c_client_tuner = client_tuner;
    dev.ts1.analog_fe.tuner_priv = client_tuner;
...
// remove I2C client for SEC
    ...
    i2c_unregister_device(client_sec);
    port.i2c_client_sec = core::ptr::null_mut();
    }
// remove I2C client for tuner
    ...
    i2c_unregister_device(client_tuner);
    port.i2c_client_tuner = core::ptr::null_mut();
    }
// remove I2C client for demodulator
    ...
    port.gate_ctrl = core::ptr::null_mut();
    vb2_dvb_dealloc_frontends(&port.frontends);
    return -EINVAL;
    }
#[no_mangle]
pub unsafe extern "C" fn cx23885_dvb_register(port: *mut cx23885_tsport) -> c_int {
...
//
    ...
    &port.frontends, i) == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_dvb_unregister(port: *mut cx23885_tsport) -> c_int {
