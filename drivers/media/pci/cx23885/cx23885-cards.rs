...
//! Source: drivers/media/pci/cx23885/cx23885-cards.c
#![no_std]
...
//
    ...
    let mut netup_card_rev: static unsigned int = 4;
...
// Ensure safe default for unknown boards
    ...
    let mut cx23885_bcount: c_uint = ARRAY_SIZE(cx23885_boards);
// ------------------------------------------------------------------
// PCI subsystem IDs
    ...
    let mut cx23885_idcount: c_uint = ARRAY_SIZE(cx23885_subids);
#[no_mangle]
pub unsafe extern "C" fn cx23885_card_list(dev: *mut cx23885_dev) {
...
#[no_mangle]
unsafe extern "C" fn viewcast_eeprom(dev: *mut cx23885_dev, eeprom_data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn hauppauge_eeprom(dev: *mut cx23885_dev, eeprom_data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn tbs_card_init(dev: *mut cx23885_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_tuner_callback(priv: *mut c_void, component: c_int, command: c_int, arg: c_int) -> c_int {
...
// we need to reset the correct gpio.
    ...
    bitmask = 0x01;
#[no_mangle]
pub unsafe extern "C" fn if(2: port->nr ==) -> else {
    else if (port.nr == 2)
    bitmask = 0x04;
    break;
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_gpio_setup(dev: *mut cx23885_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_ir_init(dev: *mut cx23885_dev) -> c_int {
    ...
    let mut ir_rxtx_pin_cfg_count: usize = ARRAY_SIZE(ir_rxtx_pin_cfg);
    ...
    let mut ir_rx_pin_cfg_count: usize = ARRAY_SIZE(ir_rx_pin_cfg);
...
//
    ...
    if (dev.sd_ir == core::ptr::null_mut()) {
    ret = -ENODEV;
    break;
    }
    v4l2_subdev_call(dev.sd_cx25840, core, s_io_pin_config,
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_ir_fini(dev: *mut cx23885_dev) {
...
#[no_mangle]
unsafe extern "C" fn netup_jtag_io(device: *mut c_void, tms: c_int, tdi: c_int, read_tdo: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_ir_pci_int_enable(dev: *mut cx23885_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_card_setup(dev: *mut cx23885_dev) {
...
// set host data for clk_freq configuration
    ...
    "cs3308", 0x82 >> 1, core::ptr::null_mut());
    break;
    case CX23885_BOARD_VIEWCAST_460E:
// This cs3308 controls the audio from the breakout cable
    v4l2_i2c_new_subdev(&dev.v4l2_dev,
    &dev.i2c_bus[0].i2c_adap,
    "cs3308", 0x80 >> 1, core::ptr::null_mut());
