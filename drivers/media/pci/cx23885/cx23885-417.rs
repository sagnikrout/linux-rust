...
//! Source: drivers/media/pci/cx23885/cx23885-417.c
#![no_std]
...
pub const CX23885_FIRM_IMAGE_SIZE: c_int = 376836;

    let mut mpegbufs: static unsigned int = 32;
    module_param(mpegbufs, int, 0644);
    MODULE_PARM_DESC(mpegbufs, "number of mpeg buffers, range 2-32");
    let mut mpeglines: static unsigned int = 32;
...
pub const MCI_MEMORY_DATA_BYTE0: c_uint = 0x000;
pub const MCI_MEMORY_DATA_BYTE1: c_uint = 0x100;
pub const MCI_MEMORY_DATA_BYTE2: c_uint = 0x200;
pub const MCI_MEMORY_DATA_BYTE3: c_uint = 0x300;
pub const MCI_MEMORY_ADDRESS_BYTE2: c_uint = 0x400;
pub const MCI_MEMORY_ADDRESS_BYTE1: c_uint = 0x500;
pub const MCI_MEMORY_ADDRESS_BYTE0: c_uint = 0x600;
pub const MCI_REGISTER_DATA_BYTE0: c_uint = 0x800;
pub const MCI_REGISTER_DATA_BYTE1: c_uint = 0x900;
pub const MCI_REGISTER_DATA_BYTE2: c_uint = 0xA00;
pub const MCI_REGISTER_DATA_BYTE3: c_uint = 0xB00;
pub const MCI_REGISTER_ADDRESS_BYTE0: c_uint = 0xC00;
pub const MCI_REGISTER_ADDRESS_BYTE1: c_uint = 0xD00;
pub const MCI_REGISTER_MODE: c_uint = 0xE00;
// Read and write modes
pub const MCI_MODE_REGISTER_READ: c_int = 0;
pub const MCI_MODE_REGISTER_WRITE: c_int = 1;
pub const MCI_MODE_MEMORY_READ: c_int = 0;
pub const MCI_MODE_MEMORY_WRITE: c_uint = 0x40;
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_mc417_init(dev: *mut cx23885_dev) {
...
#[no_mangle]
unsafe extern "C" fn mc417_wait_ready(dev: *mut cx23885_dev) -> c_int {
    static int mc417_wait_ready(struct cx23885_dev *dev)
    {
    u32 mi_ready;
    let mut timeout: c_ulong = jiffies + msecs_to_jiffies(1);
    for (;;) {
...
#[no_mangle]
pub unsafe extern "C" fn mc417_register_write(dev: *mut cx23885_dev, address: u16, value: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mc417_register_read(dev: *mut cx23885_dev, address: u16, value: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mc417_memory_write(dev: *mut cx23885_dev, address: u32, value: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mc417_memory_read(dev: *mut cx23885_dev, address: u32, value: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mc417_gpio_set(dev: *mut cx23885_dev, mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mc417_gpio_clear(dev: *mut cx23885_dev, mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mc417_gpio_enable(dev: *mut cx23885_dev, mask: u32, asoutput: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cx23885_api_func(priv: *mut c_void, cmd: u32, in: c_int, out: c_int, data[CX2341X_MBOX_MAX_DATA]: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx23885_find_mailbox(dev: *mut cx23885_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx23885_load_firmware(dev: *mut cx23885_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_417_check_encoder(dev: *mut cx23885_dev) {
...
#[no_mangle]
unsafe extern "C" fn cx23885_codec_settings(dev: *mut cx23885_dev) {
...
#[no_mangle]
unsafe extern "C" fn cx23885_initialize_codec(dev: *mut cx23885_dev, startencoder: c_int) -> c_int {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn vidioc_g_std(file: *mut file, priv: *mut c_void, id: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_417_unregister(dev: *mut cx23885_dev) {
    ...
    dev.v4l_device = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_417_register(dev: *mut cx23885_dev) -> c_int {
...
// Set default TV standard
    ...
    v4l2_ctrl_add_handler(&dev.ctrl_handler, &dev.cxhdl.hdl, core::ptr::null_mut(), false);
