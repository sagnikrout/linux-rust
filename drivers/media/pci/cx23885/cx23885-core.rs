...
//! Source: drivers/media/pci/cx23885/cx23885-core.c
#![no_std]
...
//
    let mut dma_reset_workaround: static unsigned int = 1;
...
#[no_mangle]
unsafe extern "C" fn cx23885_irq_add(dev: *mut cx23885_dev, mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_irq_add_enable(dev: *mut cx23885_dev, mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_irq_enable(dev: *mut cx23885_dev, mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_irq_enable_all(dev: *mut cx23885_dev) {
    static inline void cx23885_irq_enable_all(struct cx23885_dev *dev)
    {
    cx23885_irq_enable(dev, 0xffffffff);
    }
#[no_mangle]
pub unsafe extern "C" fn cx23885_irq_disable(dev: *mut cx23885_dev, mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_irq_disable_all(dev: *mut cx23885_dev) {
    static inline void cx23885_irq_disable_all(struct cx23885_dev *dev)
    {
    cx23885_irq_disable(dev, 0xffffffff);
    }
#[no_mangle]
pub unsafe extern "C" fn cx23885_irq_remove(dev: *mut cx23885_dev, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn cx23885_irq_get_mask(dev: *mut cx23885_dev) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cx23885_risc_decode(risc: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx23885_clear_bridge_error(dev: *mut cx23885_dev) {
...
#[no_mangle]
unsafe extern "C" fn cx23885_shutdown(dev: *mut cx23885_dev) {
...
#[no_mangle]
unsafe extern "C" fn cx23885_reset(dev: *mut cx23885_dev) {
...
#[no_mangle]
unsafe extern "C" fn cx23885_pci_quirks(dev: *mut cx23885_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_resources(dev: *mut cx23885_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx23885_dev_checkrevision(dev: *mut cx23885_dev) {
...
// Find the first v4l2_subdev member of the group id in hw
    ...
    {
    struct v4l2_subdev *result = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cx23885_dev_setup(dev: *mut cx23885_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(CX23885_BOARD_HAUPPAUGE_QUADHD_DVB: dev->board ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn cx23885_dev_unregister(dev: *mut cx23885_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_free_buffer(dev: *mut cx23885_dev, buf: *mut cx23885_buffer) {
...
#[no_mangle]
unsafe extern "C" fn cx23885_tsport_reg_dump(port: *mut cx23885_tsport) {
...
#[no_mangle]
unsafe extern "C" fn cx23885_stop_dma(port: *mut cx23885_tsport) -> c_int {
...
// ------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn cx23885_buf_prepare(buf: *mut cx23885_buffer, port: *mut cx23885_tsport) -> c_int {
    int cx23885_buf_prepare(struct cx23885_buffer *buf, struct cx23885_tsport *port)
    {
    struct cx23885_dev *dev = port.dev;
    let mut size: c_int = port.ts_packet_size * port.ts_packet_count;
...
//
#[no_mangle]
pub unsafe extern "C" fn cx23885_buf_queue(port: *mut cx23885_tsport, buf: *mut cx23885_buffer) {
...
// -----------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn do_cancel_buffers(port: *mut cx23885_tsport, reason: *mut c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_cancel_buffers(port: *mut cx23885_tsport) {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_irq_417(dev: *mut cx23885_dev, status: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx23885_irq_ts(port: *mut cx23885_tsport, status: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx23885_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    let mut vida_count: c_int = 0, ts1_count = 0, ts2_count = 0, handled = 0;
    let mut audint_count: c_int = 0;
    bool subdev_handled;
...
#[no_mangle]
unsafe extern "C" fn cx23885_v4l2_dev_notify_init(dev: *mut cx23885_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn encoder_on_portb(dev: *mut cx23885_dev) -> c_int {
    static inline int encoder_on_portb(struct cx23885_dev *dev)
    {
    return cx23885_boards[dev.board].portb == CX23885_MPEG_ENCODER;
    }
#[no_mangle]
pub unsafe extern "C" fn encoder_on_portc(dev: *mut cx23885_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cx23885_gpio_set(dev: *mut cx23885_dev, mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_gpio_clear(dev: *mut cx23885_dev, mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_gpio_get(dev: *mut cx23885_dev, mask: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn cx23885_gpio_enable(dev: *mut cx23885_dev, mask: u32, asoutput: c_int) {
    void cx23885_gpio_enable(struct cx23885_dev *dev, u32 mask, int asoutput)
    {
    if ((mask & 0x00000007) && asoutput)
    cx_set(GP0_IO, (mask & 0x7) << 16);
#[no_mangle]
pub unsafe extern "C" fn if(!asoutput: (mask & 0x00000007) &&) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(!asoutput: (mask & 0x0007fff8) &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn cx23885_does_need_dma_reset() -> bool {
    ...
    return false;
#[no_mangle]
pub unsafe extern "C" fn if(2: dma_reset_workaround ==) -> else {
    else if (dma_reset_workaround == 2)
    return true;
    for (i = 0; i < ARRAY_SIZE(broken_dev_id); i++) {
    pdev = pci_get_device(broken_dev_id[i].vendor,
    broken_dev_id[i].dev, core::ptr::null_mut());
    if (pdev) {
    pci_dev_put(pdev);
    return true;
    }
...
#[no_mangle]
unsafe extern "C" fn cx23885_finidev(pci_dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn cx23885_suspend(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn cx23885_resume(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn cx23885_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cx23885_fini() -> void __exit {
