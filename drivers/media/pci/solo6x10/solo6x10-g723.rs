...
//! Source: drivers/media/pci/solo6x10/solo6x10-g723.c
#![no_std]
...
pub const G723_FDMA_PAGES: c_int = 32;
pub const G723_PERIOD_BYTES: c_int = 48;
pub const G723_PERIOD_BLOCK: c_int = 1024;
pub const G723_FRAMES_PER_PAGE: c_int = 48;
// Sets up channels 16-19 for decoding and 0-15 for encoding
pub const OUTMODE_MASK: c_uint = 0x300;
pub const SAMPLERATE: c_int = 8000;
pub const BITRATE: c_int = 25;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct solo_snd_pcm {
    pub on: c_int,
    pub lock: spinlock_t,
    pub solo_dev: *mut solo_dev,
    pub g723_buf: *mut u8,
    pub g723_dma: dma_addr_t,
}

#[no_mangle]
unsafe extern "C" fn solo_g723_config(solo_dev: *mut solo_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn solo_g723_isr(solo_dev: *mut solo_dev) {
    ...
    for (ss = pstr.substream; ss != core::ptr::null_mut(); ss = ss.next) {
    if (snd_pcm_substream_chip(ss) == core::ptr::null_mut())
    continue;
...
#[no_mangle]
unsafe extern "C" fn snd_solo_pcm_close(ss: *mut snd_pcm_substream) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_solo_pcm_trigger(ss: *mut snd_pcm_substream, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snd_solo_pcm_prepare(ss: *mut snd_pcm_substream) -> c_int {
    static int snd_solo_pcm_prepare(struct snd_pcm_substream *ss)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn snd_solo_pcm_pointer(ss: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
    static snd_pcm_uframes_t snd_solo_pcm_pointer(struct snd_pcm_substream *ss)
    {
    struct solo_snd_pcm *solo_pcm = snd_pcm_substream_chip(ss);
    struct solo_dev *solo_dev = solo_pcm.solo_dev;
    let mut idx: snd_pcm_uframes_t = solo_reg_read(solo_dev, SOLO_AUDIO_STA) & 0x1f;
    ...
    let mut page: c_int = (pos / G723_FRAMES_PER_PAGE) + i;
    ...
    let mut ch: u8 = value.id.numid - 1;
...
#[no_mangle]
unsafe extern "C" fn solo_snd_pcm_init(solo_dev: *mut solo_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn solo_g723_init(solo_dev: *mut solo_dev) -> c_int {
    int solo_g723_init(struct solo_dev *solo_dev)
    {
    let mut ops: static struct snd_device_ops = { };
...
#[no_mangle]
pub unsafe extern "C" fn solo_g723_exit(solo_dev: *mut solo_dev) {
    ...
    solo_dev.snd_card = core::ptr::null_mut();
    }
