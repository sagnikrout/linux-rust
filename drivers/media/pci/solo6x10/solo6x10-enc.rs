...
//! Source: drivers/media/pci/solo6x10/solo6x10-enc.c
#![no_std]
...
pub const IRQ_LEVEL: c_int = 2;
#[no_mangle]
unsafe extern "C" fn solo_capture_config(solo_dev: *mut solo_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn solo_osd_print(solo_enc: *mut solo_enc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn solo_g_jpeg_qp(solo_dev: *mut solo_dev, ch: c_uint) -> c_int {
...
pub const SOLO_QP_INIT: c_uint = 0xaaaaaaaa;
#[no_mangle]
unsafe extern "C" fn solo_jpeg_config(solo_dev: *mut solo_dev) {
...
#[no_mangle]
unsafe extern "C" fn solo_mp4e_config(solo_dev: *mut solo_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn solo_enc_init(solo_dev: *mut solo_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn solo_enc_exit(solo_dev: *mut solo_dev) {
