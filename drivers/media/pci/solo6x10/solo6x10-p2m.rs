...
//! Source: drivers/media/pci/solo6x10/solo6x10-p2m.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn solo_p2m_isr(solo_dev: *mut solo_dev, id: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn solo_p2m_error_isr(solo_dev: *mut solo_dev) {
    void solo_p2m_error_isr(struct solo_dev *solo_dev)
    {
    let mut err: c_uint = solo_reg_read(solo_dev, SOLO_PCI_ERR);
    struct solo_p2m_dev *p2m_dev;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn solo_p2m_exit(solo_dev: *mut solo_dev) {
...
#[no_mangle]
unsafe extern "C" fn solo_p2m_test(solo_dev: *mut solo_dev, base: c_int, size: c_int) -> c_int {
    ...
    if (wr_buf == core::ptr::null_mut())
    return -1;
    rd_buf = (u32 *)__get_free_pages(GFP_KERNEL, order);
    if (rd_buf == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn solo_p2m_init(solo_dev: *mut solo_dev) -> c_int {
