...
//! Source: drivers/media/pci/solo6x10/solo6x10-i2c.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn solo_i2c_readbyte(solo_dev: *mut solo_dev, id: c_int, addr: u8, off: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn solo_i2c_flush(solo_dev: *mut solo_dev, wr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn solo_i2c_start(solo_dev: *mut solo_dev) {
    static void solo_i2c_start(struct solo_dev *solo_dev)
    {
    let mut addr: u32 = solo_dev.i2c_msg.addr << 1;
...
#[no_mangle]
unsafe extern "C" fn solo_i2c_stop(solo_dev: *mut solo_dev) {
...
#[no_mangle]
unsafe extern "C" fn solo_i2c_handle_read(solo_dev: *mut solo_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn solo_i2c_handle_write(solo_dev: *mut solo_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn solo_i2c_isr(solo_dev: *mut solo_dev) -> c_int {
    int solo_i2c_isr(struct solo_dev *solo_dev)
    {
    let mut status: u32 = solo_reg_read(solo_dev, SOLO_IIC_CTRL);
...
#[no_mangle]
unsafe extern "C" fn solo_i2c_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn solo_i2c_init(solo_dev: *mut solo_dev) -> c_int {
    ...
    if (ret) {
    adap.algo_data = core::ptr::null_mut();
    break;
    }
    }
    if (ret) {
    ...
    solo_dev.i2c_adap[i].algo_data = core::ptr::null_mut();
    }
    return ret;
    }
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn solo_i2c_exit(solo_dev: *mut solo_dev) {
