...
//! Source: drivers/media/pci/solo6x10/solo6x10-v4l2.c
#![no_std]
...
pub const SOLO_HW_BPL: c_int = 2048;

    solo_vlines(__solo))

pub const MIN_VID_BUFFERS: c_int = 2;
#[no_mangle]
pub unsafe extern "C" fn erase_on(solo_dev: *mut solo_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn erase_off(solo_dev: *mut solo_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn solo_video_in_isr(solo_dev: *mut solo_dev) {
...
#[no_mangle]
unsafe extern "C" fn solo_v4l2_ch_ext_4up(solo_dev: *mut solo_dev, idx: u8, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn solo_v4l2_ch_ext_16up(solo_dev: *mut solo_dev, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn solo_v4l2_ch(solo_dev: *mut solo_dev, ch: u8, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn solo_v4l2_set_ch(solo_dev: *mut solo_dev, ch: u8) -> c_int {
    ...
    let mut image_size: c_int = solo_image_size(solo_dev);
...
#[no_mangle]
unsafe extern "C" fn solo_thread_try(solo_dev: *mut solo_dev) {
...
#[no_mangle]
unsafe extern "C" fn solo_thread(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn solo_start_thread(solo_dev: *mut solo_dev) -> c_int {
    ...
    solo_dev.kthread = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn solo_stop_thread(solo_dev: *mut solo_dev) {
...
#[no_mangle]
unsafe extern "C" fn solo_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn solo_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn solo_buf_queue(vb: *mut vb2_buffer) {
    ...
    {
    let mut ext: c_int = input.index - solo_dev.nr_chans;
...
//
    ...
    let mut ret: c_int = solo_enum_ext_input(solo_dev, input);
    if (ret < 0)
    return ret;
    } else {
...
#[no_mangle]
unsafe extern "C" fn solo_set_input(file: *mut file, priv: *mut c_void, index: c_uint) -> c_int {
    static int solo_set_input(struct file *file, void *priv, unsigned int index)
    {
    struct solo_dev *solo_dev = video_drvdata(file);
    let mut ret: c_int = solo_v4l2_set_ch(solo_dev, index);
    if (!ret) {
...
#[no_mangle]
unsafe extern "C" fn solo_get_input(file: *mut file, priv: *mut c_void, index: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn solo_g_std(file: *mut file, priv: *mut c_void, i: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn solo_set_video_type(solo_dev: *mut solo_dev, is_50hz: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn solo_s_std(file: *mut file, priv: *mut c_void, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn solo_v4l2_init(solo_dev: *mut solo_dev, nr: unsigned) -> c_int {
...
// solo_dev->vfd = solo_v4l2_template;
    ...
    v4l2_ctrl_new_custom(&solo_dev.disp_hdl, &solo_motion_trace_ctrl, core::ptr::null_mut());
...
// Do nothing */;
    ...
    solo_dev.vfd = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn solo_v4l2_exit(solo_dev: *mut solo_dev) {
    void solo_v4l2_exit(struct solo_dev *solo_dev)
    {
    if (solo_dev.vfd == core::ptr::null_mut())
    return;
