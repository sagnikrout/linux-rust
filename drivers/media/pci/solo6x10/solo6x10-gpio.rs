...
//! Source: drivers/media/pci/solo6x10/solo6x10-gpio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn solo_gpio_set(solo_dev: *mut solo_dev, value: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn solo_gpio_clear(solo_dev: *mut solo_dev, value: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn solo_gpio_config(solo_dev: *mut solo_dev) {
...
//
    ...
    return 1;
#[no_mangle]
pub unsafe extern "C" fn if(1: mode ==) -> else {
    else if (mode == 1)
    return 0;
    return -1;
    }
...
#[no_mangle]
pub unsafe extern "C" fn solo_gpio_init(solo_dev: *mut solo_dev) -> c_int {
    ...
    if (ret) {
    solo_dev.gpio_dev.label = core::ptr::null_mut();
    return -1;
    }
...
#[no_mangle]
pub unsafe extern "C" fn solo_gpio_exit(solo_dev: *mut solo_dev) {
