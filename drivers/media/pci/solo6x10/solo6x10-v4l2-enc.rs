...
//! Source: drivers/media/pci/solo6x10/solo6x10-v4l2-enc.c
#![no_std]
...
pub const MIN_VID_BUFFERS: c_int = 2;

pub const MP4_QS: c_int = 16;
pub const DMA_ALIGN: c_int = 4096;
// 6010 M4V
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct solo_enc_buf {
    pub type: enum solo_enc_types,
    pub vh: *const vop_header,
    pub motion: c_int,
}

#[no_mangle]
unsafe extern "C" fn solo_is_motion_on(solo_enc: *mut solo_enc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn solo_motion_detected(solo_enc: *mut solo_enc_dev) -> c_int {
    static int solo_motion_detected(struct solo_enc_dev *solo_enc)
    {
    struct solo_dev *solo_dev = solo_enc.solo_dev;
    unsigned long flags;
    let mut ch_mask: u32 = 1 << solo_enc.ch;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn solo_motion_toggle(solo_enc: *mut solo_enc_dev, on: c_int) {
    static void solo_motion_toggle(struct solo_enc_dev *solo_enc, int on)
    {
    struct solo_dev *solo_dev = solo_enc.solo_dev;
    let mut mask: u32 = 1 << solo_enc.ch;
    unsigned long flags;
    spin_lock_irqsave(&solo_enc.motion_lock, flags);
    if (on)
...
#[no_mangle]
pub unsafe extern "C" fn solo_update_mode(solo_enc: *mut solo_enc_dev) {
...
// Some fixups for 6010/M4V
    ...
    let mut fps: u16 = solo_dev.fps * 1000;
    let mut interval: u16 = solo_enc.interval * 1000;
    vop = solo_enc.vop;
...
#[no_mangle]
unsafe extern "C" fn solo_enc_on(solo_enc: *mut solo_enc_dev) -> c_int {
    static int solo_enc_on(struct solo_enc_dev *solo_enc)
    {
    let mut ch: u8 = solo_enc.ch;
    struct solo_dev *solo_dev = solo_enc.solo_dev;
    u8 interval;
...
#[no_mangle]
unsafe extern "C" fn solo_enc_off(solo_enc: *mut solo_enc_dev) {
...
// processing.
    ...
    dma_addr_t dma;
    int len;
    let mut left: c_int = base_size - off;
...
#[no_mangle]
pub unsafe extern "C" fn solo_enc_v4l2_isr(solo_dev: *mut solo_dev) {
    void solo_enc_v4l2_isr(struct solo_dev *solo_dev)
    {
    wake_up_interruptible_all(&solo_dev.ring_thread_wait);
    }
#[no_mangle]
unsafe extern "C" fn solo_handle_ring(solo_dev: *mut solo_dev) {
...
#[no_mangle]
unsafe extern "C" fn solo_ring_thread(data: *mut c_void) -> c_int {
    ...
    for (;;) {
    let mut timeout: c_long = schedule_timeout_interruptible(HZ);
...
#[no_mangle]
unsafe extern "C" fn solo_enc_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn solo_ring_start(solo_dev: *mut solo_dev) -> c_int {
    ...
    let mut err: c_int = PTR_ERR(solo_dev.ring_thread);
    solo_dev.ring_thread = core::ptr::null_mut();
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn solo_ring_stop(solo_dev: *mut solo_dev) {
...
#[no_mangle]
unsafe extern "C" fn solo_enc_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn solo_enc_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn solo_enc_buf_finish(vb: *mut vb2_buffer) {
...
// index = 0;
    ...
    {
    struct solo_enc_dev *solo_enc = video_drvdata(file);
    let mut dev_type: c_int = solo_enc.solo_dev.type;
    switch (f.index) {
    case 0:
    switch (dev_type) {
    case SOLO_DEV_6010:
...
#[no_mangle]
pub unsafe extern "C" fn solo_valid_pixfmt(pixfmt: u32, dev_type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn solo_enc_g_std(file: *mut file, priv: *mut c_void, i: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn solo_enc_s_std(file: *mut file, priv: *mut c_void, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn calc_interval(fps: u8, n: u32, d: u32) -> c_int {
    ...
    let mut fps: u8 = solo_enc.solo_dev.fps;
...
#[no_mangle]
unsafe extern "C" fn solo_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// Motion Detection Threshold matrix
    ...
    v4l2_ctrl_new_custom(hdl, &solo_osd_text_ctrl, core::ptr::null_mut());
    solo_enc.md_thresholds =
    v4l2_ctrl_new_custom(hdl, &solo_md_thresholds, core::ptr::null_mut());
    if (hdl.error) {
    ret = hdl.error;
    goto hdl_free;
    }
...
// Initialize this per encoder
    ...
    GFP_KERNEL);
    ret = -ENOMEM;
    if (solo_enc.desc_items == core::ptr::null_mut())
    goto hdl_free;
...
#[no_mangle]
unsafe extern "C" fn solo_enc_free(solo_enc: *mut solo_enc_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn solo_enc_v4l2_init(solo_dev: *mut solo_dev, nr: unsigned) -> c_int {
    ...
    if (solo_dev.vh_buf == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
pub unsafe extern "C" fn solo_enc_v4l2_exit(solo_dev: *mut solo_dev) {
