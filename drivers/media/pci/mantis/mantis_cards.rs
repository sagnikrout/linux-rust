...
//! Source: drivers/media/pci/mantis/mantis_cards.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mantis_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mantis_pci_remove(pdev: *mut pci_dev) {
