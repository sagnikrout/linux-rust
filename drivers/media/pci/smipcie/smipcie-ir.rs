...
//! Source: drivers/media/pci/smipcie/smipcie-ir.c
#![no_std]
...
pub const SMI_SAMPLE_PERIOD: c_int = 83;

#[no_mangle]
unsafe extern "C" fn smi_ir_enableInterrupt(ir: *mut smi_rc) {
...
#[no_mangle]
unsafe extern "C" fn smi_ir_disableInterrupt(ir: *mut smi_rc) {
...
#[no_mangle]
unsafe extern "C" fn smi_ir_clearInterrupt(ir: *mut smi_rc) {
...
#[no_mangle]
unsafe extern "C" fn smi_ir_stop(ir: *mut smi_rc) {
...
#[no_mangle]
unsafe extern "C" fn smi_ir_decode(ir: *mut smi_rc) {
...
#[no_mangle]
pub unsafe extern "C" fn smi_ir_irq(ir: *mut smi_rc, int_status: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smi_ir_start(ir: *mut smi_rc) {
...
#[no_mangle]
pub unsafe extern "C" fn smi_ir_init(dev: *mut smi_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smi_ir_exit(dev: *mut smi_dev) {
