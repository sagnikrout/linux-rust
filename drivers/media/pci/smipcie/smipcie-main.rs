...
//! Source: drivers/media/pci/smipcie/smipcie-main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn smi_hw_init(dev: *mut smi_dev) -> c_int {
...
// i2c bit bus.
#[no_mangle]
unsafe extern "C" fn smi_i2c_cfg(dev: *mut smi_dev, sw_ctl: u32) {
...
#[no_mangle]
unsafe extern "C" fn smi_i2c_setsda(dev: *mut smi_dev, state: c_int, sw_ctl: u32) {
...
#[no_mangle]
unsafe extern "C" fn smi_i2c_setscl(data: *mut c_void, state: c_int, sw_ctl: u32) {
...
#[no_mangle]
unsafe extern "C" fn smi_i2c_getsda(data: *mut c_void, sw_ctl: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_i2c_getscl(data: *mut c_void, sw_ctl: u32) -> c_int {
...
// i2c 0.
#[no_mangle]
unsafe extern "C" fn smi_i2c0_setsda(data: *mut c_void, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn smi_i2c0_setscl(data: *mut c_void, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn smi_i2c0_getsda(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_i2c0_getscl(data: *mut c_void) -> c_int {
...
// i2c 1.
#[no_mangle]
unsafe extern "C" fn smi_i2c1_setsda(data: *mut c_void, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn smi_i2c1_setscl(data: *mut c_void, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn smi_i2c1_getsda(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_i2c1_getscl(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_i2c_init(dev: *mut smi_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_i2c_exit(dev: *mut smi_dev) {
...
#[no_mangle]
unsafe extern "C" fn smi_read_eeprom(i2c: *mut i2c_adapter, reg: u16, data: *mut u8, size: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_port_disableInterrupt(port: *mut smi_port) {
...
#[no_mangle]
unsafe extern "C" fn smi_port_enableInterrupt(port: *mut smi_port) {
...
#[no_mangle]
unsafe extern "C" fn smi_port_clearInterrupt(port: *mut smi_port) {
...
#[no_mangle]
unsafe extern "C" fn smi_dma_xfer(t: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn smi_port_dma_free(port: *mut smi_port) {
    ...
    port.dma_addr[0]);
    port.cpu_addr[0] = core::ptr::null_mut();
    }
    if (port.cpu_addr[1]) {
    dma_free_coherent(&port.dev.pci_dev.dev,
    SMI_TS_DMA_BUF_SIZE, port.cpu_addr[1],
    port.dma_addr[1]);
    port.cpu_addr[1] = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn smi_port_init(port: *mut smi_port, dmaChanUsed: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_port_exit(port: *mut smi_port) {
...
#[no_mangle]
unsafe extern "C" fn smi_port_irq(port: *mut smi_port, int_status: u32) -> c_int {
    static int smi_port_irq(struct smi_port *port, u32 int_status)
    {
    let mut port_req_irq: u32 = port._dmaInterruptCH0 | port._dmaInterruptCH1;
...
#[no_mangle]
unsafe extern "C" fn smi_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    let mut handled: c_int = 0;
    let mut intr_status: u32 = smi_read(MSI_INT_STATUS);
// ts0 interrupt.
    if (dev.info.ts_0)
...
#[no_mangle]
unsafe extern "C" fn smi_del_i2c_client(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn smi_dvbsky_m88ds3103_fe_attach(port: *mut smi_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_dvbsky_m88rs6000_fe_attach(port: *mut smi_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_dvbsky_sit2_fe_attach(port: *mut smi_port) -> c_int {
...
// attach tuner
    ...
    port.i2c_client_demod = core::ptr::null_mut();
    ret = -ENODEV;
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn smi_fe_init(port: *mut smi_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_fe_exit(port: *mut smi_port) {
...
// remove I2C demod and tuner
    ...
    dvbdemux.write_to_decoder = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn smi_config_DMA(port: *mut smi_port) -> u32 {
    static u32 smi_config_DMA(struct smi_port *port)
    {
    struct smi_dev *dev = port.dev;
    let mut totalLength: u32 = 0, dmaMemPtrLow, dmaMemPtrHi, dmaCtlReg;
    let mut chanLatencyTimer: u8 = 0, dmaChanEnable = 1, dmaTransStart = 1;
    let mut dmaManagement: u32 = 0, tlpTransUnit = DMA_TRANS_UNIT_188;
    let mut tlpTc: u8 = 0, tlpTd = 1, tlpEp = 0, tlpAttr = 0;
    u64 mem;
    dmaManagement = smi_read(port.DMA_MANAGEMENT);
// Setup Channel-0
    if (port._dmaInterruptCH0) {
...
#[no_mangle]
unsafe extern "C" fn smi_start_feed(dvbdmxfeed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_stop_feed(dvbdmxfeed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_dvb_init(port: *mut smi_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_dvb_exit(port: *mut smi_port) {
...
#[no_mangle]
unsafe extern "C" fn smi_port_detach(port: *mut smi_port) {
...
#[no_mangle]
unsafe extern "C" fn smi_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_remove(pdev: *mut pci_dev) {
