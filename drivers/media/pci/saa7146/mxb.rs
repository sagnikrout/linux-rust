...
//! Source: drivers/media/pci/saa7146/mxb.c
#![no_std]
...
pub const MXB_AUDIOS: c_int = 6;
pub const I2C_SAA7111A: c_uint = 0x24;
pub const I2C_TDA9840: c_uint = 0x42;
pub const I2C_TEA6415C: c_uint = 0x43;
pub const I2C_TEA6420_1: c_uint = 0x4c;
pub const I2C_TEA6420_2: c_uint = 0x4d;
pub const I2C_TUNER: c_uint = 0x60;
...
#[no_mangle]
unsafe extern "C" fn mxb_update_audmode(mxb: *mut mxb) {
...
#[no_mangle]
pub unsafe extern "C" fn tea6420_route(mxb: *mut mxb, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mxb_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxb_probe(dev: *mut saa7146_dev) -> c_int {
    static int mxb_probe(struct saa7146_dev *dev)
    {
    struct v4l2_ctrl_handler *hdl = &dev.ctrl_handler;
    struct mxb *mxb = core::ptr::null_mut();
    v4l2_ctrl_new_std(hdl, &mxb_ctrl_ops,
    V4L2_CID_AUDIO_MUTE, 0, 1, 1, 1);
    if (hdl.error)
    return hdl.error;
    mxb = kzalloc_obj(struct mxb);
    if (mxb == core::ptr::null_mut()) {
    ...
    "saa7111", I2C_SAA7111A, core::ptr::null_mut());
    mxb.tea6420_1 = v4l2_i2c_new_subdev(&dev.v4l2_dev, &mxb.i2c_adapter,
    "tea6420", I2C_TEA6420_1, core::ptr::null_mut());
    mxb.tea6420_2 = v4l2_i2c_new_subdev(&dev.v4l2_dev, &mxb.i2c_adapter,
    "tea6420", I2C_TEA6420_2, core::ptr::null_mut());
    mxb.tea6415c = v4l2_i2c_new_subdev(&dev.v4l2_dev, &mxb.i2c_adapter,
    "tea6415c", I2C_TEA6415C, core::ptr::null_mut());
    mxb.tda9840 = v4l2_i2c_new_subdev(&dev.v4l2_dev, &mxb.i2c_adapter,
    "tda9840", I2C_TDA9840, core::ptr::null_mut());
    mxb.tuner = v4l2_i2c_new_subdev(&dev.v4l2_dev, &mxb.i2c_adapter,
    "tuner", I2C_TUNER, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mxb_init_done(dev: *mut *mut saa7146_dev) -> c_int {
    static int mxb_init_done(struct saa7146_dev* dev)
    {
    let mut mxb: *mut mxb = (struct mxb*)dev.ext_priv;
    struct i2c_msg msg;
    struct tuner_setup tun_setup;
    let mut std: v4l2_std_id = V4L2_STD_PAL_BG;
    int i, err = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn mxb_irq_bh(dev: *mut *mut saa7146_dev, irq_mask: *mut *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn vidioc_g_tuner(file: *mut file, fh: *mut c_void, t: *mut v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_tuner(file: *mut file, fh: *mut c_void, t: *const v4l2_tuner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_querystd(file: *mut file, fh: *mut c_void, norm: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_g_frequency(file: *mut file, fh: *mut c_void, f: *mut v4l2_frequency) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_frequency(file: *mut file, fh: *mut c_void, f: *const v4l2_frequency) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_audio(file: *mut file, fh: *mut c_void, a: *const v4l2_audio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_g_register(file: *mut file, fh: *mut c_void, reg: *mut v4l2_dbg_register) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vidioc_s_register(file: *mut file, fh: *mut c_void, reg: *const v4l2_dbg_register) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxb_attach(dev: *mut saa7146_dev, info: *mut saa7146_pci_extension_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxb_detach(dev: *mut saa7146_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn std_callback(dev: *mut saa7146_dev, standard: *mut saa7146_standard) -> c_int {
    static int std_callback(struct saa7146_dev *dev, struct saa7146_standard *standard)
    {
    struct mxb *mxb = (struct mxb *)dev.ext_priv;
    if (V4L2_STD_PAL_I == standard.id) {
    let mut std: v4l2_std_id = V4L2_STD_PAL_I;
...
#[no_mangle]
unsafe extern "C" fn mxb_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mxb_cleanup_module() -> void __exit {
