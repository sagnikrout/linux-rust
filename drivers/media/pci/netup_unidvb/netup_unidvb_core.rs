...
//! Source: drivers/media/pci/netup_unidvb/netup_unidvb_core.c
#![no_std]
...
pub const AVL_PCIE_IENR: c_uint = 0x50;
pub const AVL_PCIE_ISR: c_uint = 0x40;
pub const AVL_IRQ_ENABLE: c_uint = 0x80;
pub const AVL_IRQ_ASSERTED: c_uint = 0x80;
// GPIO registers
pub const GPIO_REG_IO: c_uint = 0x4880;
pub const GPIO_REG_IO_TOGGLE: c_uint = 0x4882;
pub const GPIO_REG_IO_SET: c_uint = 0x4884;
pub const GPIO_REG_IO_CLEAR: c_uint = 0x4886;
// GPIO bits

// DMA base address
pub const NETUP_DMA0_ADDR: c_uint = 0x4900;
pub const NETUP_DMA1_ADDR: c_uint = 0x4940;
// 8 DMA blocks * 128 packets * 188 bytes
pub const NETUP_DMA_BLOCKS_COUNT: c_int = 8;
pub const NETUP_DMA_PACKETS_COUNT: c_int = 128;
// DMA status bits
pub const BIT_DMA_RUN: c_int = 1;
pub const BIT_DMA_ERROR: c_int = 2;
pub const BIT_DMA_IRQ: c_uint = 0x200;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct netup_dma_regs {
    pub ctrlstat_set: __le32,
    pub ctrlstat_clear: __le32,
    pub start_addr_lo: __le32,
    pub start_addr_hi: __le32,
    pub size: __le32,
    pub timeout: __le32,
    pub curr_addr_lo: __le32,
    pub curr_addr_hi: __le32,
    pub stat_pkt_received: __le32,
    pub stat_pkt_accepted: __le32,
    pub stat_pkt_overruns: __le32,
    pub stat_pkt_underruns: __le32,
    pub stat_fifo_overruns: __le32,
    pub __aligned(1): } __packed,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct netup_unidvb_buffer {
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_tuner_ctrl(priv: *mut c_void, is_dvb_tc: c_int) -> c_int {
    static int netup_unidvb_tuner_ctrl(void *priv, int is_dvb_tc)
    {
    u8 reg, mask;
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_dev_enable(ndev: *mut netup_unidvb_dev) {
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_dma_enable(dma: *mut netup_dma, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn netup_dma_interrupt(dma: *mut netup_dma) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !ndev->old_fw) -> else {
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_buf_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_stop_streaming(q: *mut vb2_queue) {
...
// Init videobuf2 queue structure
    ...
    if (fes[0].dvb.frontend == core::ptr::null_mut()) {
    dev_dbg(&ndev.pci_dev.dev,
...
// DVB-T/T2 frontend
    ...
    &demod_config, &ndev.i2c[num].adap);
    if (fes[1].dvb.frontend == core::ptr::null_mut()) {
    dev_dbg(&ndev.pci_dev.dev,
    ...
    THIS_MODULE, core::ptr::null_mut(),
    &ndev.pci_dev.dev, core::ptr::null_mut(), adapter_nr, 1)) {
    dev_dbg(&ndev.pci_dev.dev,
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_dvb_fini(ndev: *mut netup_unidvb_dev, num: c_int) {
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_dvb_setup(ndev: *mut netup_unidvb_dev) -> c_int {
    ...
    let mut buff_bytes: u32 = NETUP_DMA_PACKETS_COUNT * 188 - buf.size;
    u8 *p = vb2_plane_vaddr(&buf.vb.vb2_buf, 0);
    struct netup_unidvb_dev *ndev = dma.ndev;
    if (p == core::ptr::null_mut()) {
    dev_err(&ndev.pci_dev.dev,
    "%s(): buffer is core::ptr::null_mut()\n", __func__);
    return -EINVAL;
    }
    p += buf.size;
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_dma_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_queue_cleanup(dma: *mut netup_dma) {
    static void netup_unidvb_queue_cleanup(struct netup_dma *dma)
    {
    struct netup_unidvb_buffer *buf;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_dma_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_dma_init(ndev: *mut netup_unidvb_dev, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_dma_fini(ndev: *mut netup_unidvb_dev, num: c_int) {
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_dma_setup(ndev: *mut netup_unidvb_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_request_mmio(pci_dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_request_modules(dev: *mut device) -> c_int {
    static int netup_unidvb_request_modules(struct device *dev)
    {
    static const char * const modules[] = {
    "lnbh25", "ascot2e", "horus3a", "cxd2841er", "helene", core::ptr::null_mut()
    };
    const char * const *curr_mod = modules;
    int err;
    while (*curr_mod != core::ptr::null_mut()) {
...
// enable I2C IRQs
    ...
    pci_enable_err:
    pci_set_drvdata(pci_dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn netup_unidvb_finidev(pci_dev: *mut pci_dev) {
