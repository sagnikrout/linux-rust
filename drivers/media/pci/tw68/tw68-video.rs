...
//! Source: drivers/media/pci/tw68/tw68-video.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn set_tvnorm(dev: *mut tw68_dev, norm: *const tw68_tvnorm) {
...
// ------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn tw68_video_start_dma(dev: *mut tw68_dev, buf: *mut tw68_buf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw68_buffer_count(size: c_uint, count: c_uint) -> c_int {
...
// vb2 queue operations
    ...
    let mut tot_bufs: c_uint = q_num_bufs + *num_buffers;
    let mut size: unsigned = (dev.fmt.depth * dev.width * dev.height) >> 3;
    if (tot_bufs < 2)
    tot_bufs = 2;
...
//
#[no_mangle]
unsafe extern "C" fn tw68_buf_queue(vb: *mut vb2_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn tw68_buf_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw68_buf_finish(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn tw68_start_streaming(q: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw68_stop_streaming(q: *mut vb2_queue) {
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn tw68_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
...
// If the query is for the current input, get live data
    if (n == dev.input) {
    let mut v1: c_int = tw_readb(TW68_STATUS1);
    let mut v2: c_int = tw_readb(TW68_MVSN);
    if (0 != (v1 & (1 << 7)))
...
#[no_mangle]
unsafe extern "C" fn tw68_g_input(file: *mut file, priv: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw68_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw68_s_std(file: *mut file, priv: *mut c_void, id: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw68_g_std(file: *mut file, priv: *mut c_void, id: *mut v4l2_std_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tw68_dump_regs(dev: *mut tw68_dev) {
...
// exported stuff
#[no_mangle]
pub unsafe extern "C" fn tw68_set_tvnorm_hw(dev: *mut tw68_dev) {
    void tw68_set_tvnorm_hw(struct tw68_dev *dev)
    {
    tw_andorb(TW68_SDT, 0x07, dev.tvnorm.format);
    }
#[no_mangle]
pub unsafe extern "C" fn tw68_video_init1(dev: *mut tw68_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tw68_video_init2(dev: *mut tw68_dev, video_nr: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tw68_irq_video_done(dev: *mut tw68_dev, status: c_ulong) {
