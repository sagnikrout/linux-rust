...
//! Source: drivers/media/pci/tw68/tw68-core.c
#![no_std]
...
//
    ...
    let mut tw68_instance: static atomic_t = ATOMIC_INIT(0);
// ------------------------------------------------------------------
//
...
//
#[no_mangle]
unsafe extern "C" fn tw68_hw_init1(dev: *mut tw68_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tw68_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tw68_finidev(pci_dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn tw68_suspend(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tw68_resume(dev_d: *mut device) -> int __maybe_unused {
