...
//! Source: drivers/media/pci/tw68/tw68-risc.c
#![no_std]
...
// debug helper code
#[no_mangle]
unsafe extern "C" fn tw68_risc_decode(risc: u32, addr: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn tw68_risc_program_dump(core: *mut tw68_core, buf: *mut tw68_buf) {
