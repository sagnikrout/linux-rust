...
//! Source: drivers/media/pci/zoran/zoran_driver.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn zoran_v4l2_calc_bufsize(settings: *mut zoran_jpg_settings) -> __u32 {
    static __u32 zoran_v4l2_calc_bufsize(struct zoran_jpg_settings *settings)
    {
    let mut div: __u8 = settings.ver_dcm * settings.hor_dcm * settings.tmp_dcm;
    let mut num: __u32 = (1024 * 512) / (div);
    let mut result: __u32 = 2;
    num--;
    while (num) {
    num >>= 1;
    result <<= 1;
...
#[no_mangle]
unsafe extern "C" fn zoran_set_norm(zr: *mut zoran, norm: v4l2_std_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(V4L2_STD_NTSC: norm &) -> else {
...
#[no_mangle]
unsafe extern "C" fn zoran_set_input(zr: *mut zoran, input: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zoran_querycap(file: *mut file, fh: *mut c_void, cap: *mut v4l2_capability) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zoran_enum_fmt(zr: *mut zoran, fmt: *mut v4l2_fmtdesc, flag: c_int) -> c_int {
...
// we actually need to set 'real' parameters now
    ...
    settings.hor_dcm = 4;
#[no_mangle]
pub unsafe extern "C" fn if(2: fmt->fmt.pix.width <= zr->jpg_settings.img_width /) -> else {
...
// TODO do not return here to fix the TRY_FMT cannot handle an invalid pixelformat
    ...
    {
    struct zoran *zr = video_drvdata(file);
    let mut printformat: __le32 = __cpu_to_le32(fmt.fmt.pix.pixelformat);
    struct zoran_jpg_settings settings;
    let mut res: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn zoran_g_std(file: *mut file, fh: *mut c_void, std: *mut v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zoran_s_std(file: *mut file, fh: *mut c_void, std: v4l2_std_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zoran_g_input(file: *mut file, fh: *mut c_void, input: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zoran_s_input(file: *mut file, fh: *mut c_void, input: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zoran_g_selection(file: *mut file, fh: *mut c_void, sel: *mut v4l2_selection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zoran_s_selection(file: *mut file, fh: *mut c_void, sel: *mut v4l2_selection) -> c_int {
...
//
    ...
    let mut size: c_uint = zr.buffer_size;
...
#[no_mangle]
unsafe extern "C" fn zr_vb2_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn zr_vb2_prepare(vb: *mut vb2_buffer) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zr_set_buf(zr: *mut zoran) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zr_vb2_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zr_vb2_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn zoran_queue_init(zr: *mut zoran, vq: *mut vb2_queue, dir: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zoran_queue_exit(zr: *mut zoran) {
