...
//! Source: drivers/media/pci/mgb4/mgb4_sysfs_in.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn if(12): status & (1U <<) -> else {
    ...
    res = 0x02; // not available
#[no_mangle]
pub unsafe extern "C" fn if(13): status & (1U <<) -> else {
...
// GMSL only
    ...
    return sprintf(buf, "0\n");
#[no_mangle]
pub unsafe extern "C" fn if(0x00: (r1 & 0x03) == 0x02 && (r300 & 0x0C) == 0x08 && (r3 & 0xC0) ==) -> else {
    else if ((r1 & 0x03) == 0x02 && (r300 & 0x0C) == 0x08 && (r3 & 0xC0) == 0x00)
    return sprintf(buf, "1\n");
#[no_mangle]
pub unsafe extern "C" fn if(0x00: (r1 & 0x03) == 0x01 && (r300 & 0x0C) == 0x04 && (r3 & 0xC0) ==) -> else {
    else if ((r1 & 0x03) == 0x01 && (r300 & 0x0C) == 0x04 && (r3 & 0xC0) == 0x00)
    return sprintf(buf, "2\n");
#[no_mangle]
pub unsafe extern "C" fn if(0x00: (r1 & 0x03) == 0x00 && (r300 & 0x0C) == 0x00 && (r3 & 0xC0) ==) -> else {
...
//
    ...
    return sprintf(buf, "0\n");
#[no_mangle]
pub unsafe extern "C" fn if(0x01: (r3e0 & 0x07) == 0x07 && (r308 & 0x01) ==) -> else {
