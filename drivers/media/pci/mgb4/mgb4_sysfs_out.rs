...
//! Source: drivers/media/pci/mgb4/mgb4_sysfs_out.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn loopin_cnt(vindev: *mut mgb4_vin_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_busy(dev: *mut video_device) -> bool {
...
//
    ...
    struct mgb4_vin_dev *loopin_new = core::ptr::null_mut(), *loopin_old = core::ptr::null_mut();
    unsigned long val;
    ssize_t ret;
    u32 config;
    int i;
