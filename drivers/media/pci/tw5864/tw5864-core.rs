...
//! Source: drivers/media/pci/tw5864/tw5864-core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn tw5864_irqmask_apply(dev: *mut tw5864_dev) {
...
#[no_mangle]
unsafe extern "C" fn tw5864_interrupts_disable(dev: *mut tw5864_dev) {
...
#[no_mangle]
unsafe extern "C" fn tw5864_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tw5864_h264_isr(dev: *mut tw5864_dev) {
    static void tw5864_h264_isr(struct tw5864_dev *dev)
    {
    let mut channel: c_int = tw_readl(TW5864_DSP) & TW5864_DSP_ENC_CHN;
...
#[no_mangle]
unsafe extern "C" fn tw5864_input_deadline_update(input: *mut tw5864_input) {
    static void tw5864_input_deadline_update(struct tw5864_input *input)
    {
    input.new_frame_deadline = jiffies + msecs_to_jiffies(1000);
    }
#[no_mangle]
unsafe extern "C" fn tw5864_timer_isr(dev: *mut tw5864_dev) {
    static void tw5864_timer_isr(struct tw5864_dev *dev)
    {
    unsigned long flags;
    int i;
...
//
    ...
    let mut next_input: c_int = (i + dev.next_input) % TW5864_INPUTS;
...
#[no_mangle]
unsafe extern "C" fn tw5864_finidev(pci_dev: *mut pci_dev) {
