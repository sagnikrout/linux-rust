...
//! Source: drivers/media/pci/cx25821/cx25821-alsa.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cx25821_audio_buffer {
    pub bpl: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cx25821_audio_dev {
    pub dev: *mut cx25821_dev,
    pub q: cx25821_dmaqueue,
// pci i/o
    pub pci: *mut pci_dev,
// audio controls
    pub irq: c_int,
    ...
    pub buf: *mut cx25821_audio_buffer,
...
#[no_mangle]
unsafe extern "C" fn cx25821_alsa_dma_map(dev: *mut cx25821_audio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx25821_alsa_dma_unmap(dev: *mut cx25821_audio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx25821_alsa_dma_free(buf: *mut cx25821_audio_buffer) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _cx25821_start_audio_dma(chip: *mut cx25821_audio_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _cx25821_stop_audio_dma(chip: *mut cx25821_audio_dev) -> c_int {
...
pub const MAX_IRQ_LOOP: c_int = 50;
//
...
//
#[no_mangle]
unsafe extern "C" fn cx25821_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dsp_buffer_free(chip: *mut cx25821_audio_dev) -> c_int {
...
//
pub const DEFAULT_FIFO_SIZE: c_int = 384;
...
//
#[no_mangle]
unsafe extern "C" fn snd_cx25821_pcm_open(substream: *mut snd_pcm_substream) -> c_int {
    static int snd_cx25821_pcm_open(struct snd_pcm_substream *substream)
    {
    struct cx25821_audio_dev *chip = snd_pcm_substream_chip(substream);
    struct snd_pcm_runtime *runtime = substream.runtime;
    int err;
    let mut bpl: c_uint = 0;
    if (!chip) {
...
//
#[no_mangle]
unsafe extern "C" fn snd_cx25821_close(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_cx25821_hw_free(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snd_cx25821_prepare(substream: *mut snd_pcm_substream) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cx25821_audio_initdev(dev: *mut cx25821_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cx25821_alsa_exit_callback(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx25821_audio_fini() {
    static void cx25821_audio_fini(void)
    {
    struct device_driver *drv = driver_find("cx25821", &pci_bus_type);
    int ret;
    ret = driver_for_each_device(drv, core::ptr::null_mut(), core::ptr::null_mut(), cx25821_alsa_exit_callback);
    if (ret)
    pr_err("%s failed to find a cx25821 driver.\n", __func__);
    }
#[no_mangle]
unsafe extern "C" fn cx25821_alsa_init_callback(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cx25821_alsa_init() -> c_int {
    static int cx25821_alsa_init(void)
    {
    struct device_driver *drv = driver_find("cx25821", &pci_bus_type);
    return driver_for_each_device(drv, core::ptr::null_mut(), core::ptr::null_mut(), cx25821_alsa_init_callback);
    }
