...
//! Source: drivers/media/pci/cx25821/cx25821-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cx25821_risc_decode(risc: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx25821_registers_init(dev: *mut cx25821_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn cx25821_sram_channel_dump(dev: *mut cx25821_dev, ch: *const sram_channel) {
...
#[no_mangle]
unsafe extern "C" fn cx25821_shutdown(dev: *mut cx25821_dev) {
...
#[no_mangle]
unsafe extern "C" fn cx25821_initialize(dev: *mut cx25821_dev) {
...
#[no_mangle]
unsafe extern "C" fn cx25821_get_resources(dev: *mut cx25821_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cx25821_dev_checkrevision(dev: *mut cx25821_dev) {
...
#[no_mangle]
unsafe extern "C" fn cx25821_iounmap(dev: *mut cx25821_dev) {
    static void cx25821_iounmap(struct cx25821_dev *dev)
    {
    if (dev == core::ptr::null_mut())
    return;
// Releasing IO memory
    if (dev.lmmio != core::ptr::null_mut()) {
    iounmap(dev.lmmio);
    dev.lmmio = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn cx25821_dev_setup(dev: *mut cx25821_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cx25821_dev_unregister(dev: *mut cx25821_dev) {
...
//
    ...
    risc.cpu = core::ptr::null_mut();
    }
    if (core::ptr::null_mut() == risc.cpu) {
...
#[no_mangle]
pub unsafe extern "C" fn cx25821_free_buffer(dev: *mut cx25821_dev, buf: *mut cx25821_buffer) {
...
#[no_mangle]
unsafe extern "C" fn cx25821_finidev(pci_dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn cx25821_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cx25821_fini() -> void __exit {
