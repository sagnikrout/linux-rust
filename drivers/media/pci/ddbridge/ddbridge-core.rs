...
//! Source: drivers/media/pci/ddbridge/ddbridge-core.c
#![no_std]
...
//
pub const DDB_MAX_ADAPTER: c_int = 64;
//
    ...
    let mut ci_bitrate: static int = 70000;
    module_param(ci_bitrate, int, 0444);
    MODULE_PARM_DESC(ci_bitrate, " Bitrate in KHz for output to CI.");
    let mut ts_loop: static int = -1;
    module_param(ts_loop, int, 0444);
    MODULE_PARM_DESC(ts_loop, "TS in/out test loop on port ts_loop");
    let mut xo2_speed: static int = 2;
    module_param(xo2_speed, int, 0444);
    MODULE_PARM_DESC(xo2_speed, "default transfer speed for xo2 based duoflex, 0=55,1=75,2=90,3=104 MBit/s, default=2, use attribute to change for individual cards");

    let mut alt_dma: static int = 1;
...
#[no_mangle]
unsafe extern "C" fn ddb_set_dma_table(io: *mut ddb_io) {
...
#[no_mangle]
unsafe extern "C" fn ddb_set_dma_tables(dev: *mut ddb) {
...
#[no_mangle]
unsafe extern "C" fn ddb_unredirect(port: *mut ddb_port) -> c_int {
    static int ddb_unredirect(struct ddb_port *port)
    {
    struct ddb_input *oredi, *iredi = core::ptr::null_mut();
    struct ddb_output *iredo = core::ptr::null_mut();
...
//
    ...
    port.input[0].redo = core::ptr::null_mut();
    ddb_set_dma_table(port.input[0]);
    }
    oredi.redi = iredi;
    port.input[0].redi = core::ptr::null_mut();
    }
    oredi.redo = core::ptr::null_mut();
    port.output.redi = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ddb_redirect(i: u32, p: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dma_free(pdev: *mut pci_dev, dma: *mut ddb_dma, dir: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dma_alloc(pdev: *mut pci_dev, dma: *mut ddb_dma, dir: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ddb_buffers_alloc(dev: *mut ddb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ddb_buffers_free(dev: *mut ddb) {
...
#[no_mangle]
unsafe extern "C" fn calc_con(output: *mut ddb_output, con: *mut u32, con2: *mut u32, flags: u32) {
    static void calc_con(struct ddb_output *output, u32 *con, u32 *con2, u32 flags)
    {
    struct ddb *dev = output.port.dev;
    let mut bitrate: u32 = output.port.obr, max_bitrate = 72000;
    let mut gap: u32 = 4, nco = 0;
// con = 0x1c;
...
#[no_mangle]
unsafe extern "C" fn ddb_output_start(output: *mut ddb_output) {
    static void ddb_output_start(struct ddb_output *output)
    {
    struct ddb *dev = output.port.dev;
    let mut con: u32 = 0x11c, con2 = 0;
...
#[no_mangle]
unsafe extern "C" fn ddb_output_stop(output: *mut ddb_output) {
...
#[no_mangle]
unsafe extern "C" fn ddb_input_stop(input: *mut ddb_input) {
    static void ddb_input_stop(struct ddb_input *input)
    {
    struct ddb *dev = input.port.dev;
    let mut tag: u32 = DDB_LINK_TAG(input.port.lnr);
...
#[no_mangle]
unsafe extern "C" fn ddb_input_start(input: *mut ddb_input) {
...
#[no_mangle]
unsafe extern "C" fn ddb_input_start_all(input: *mut ddb_input) {
...
#[no_mangle]
unsafe extern "C" fn ddb_input_stop_all(input: *mut ddb_input) {
...
#[no_mangle]
unsafe extern "C" fn ddb_output_free(output: *mut ddb_output) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ddb_input_avail(input: *mut ddb_input) -> u32 {
    static u32 ddb_input_avail(struct ddb_input *input)
    {
    struct ddb *dev = input.port.dev;
    u32 idx, off, stat = input.dma.stat;
    let mut ctrl: u32 = ddbreadl(dev, DMA_BUFFER_CONTROL(input.dma));
    idx = (stat >> 11) & 0x1f;
    off = (stat & 0x7ff) << 7;
    if (ctrl & 4) {
...
#[no_mangle]
unsafe extern "C" fn ts_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn ts_release(inode: *mut inode, file: *mut file) -> c_int {
    static int ts_release(struct inode *inode, struct file *file)
    {
    struct dvb_device *dvbdev = file.private_data;
    struct ddb_output *output = core::ptr::null_mut();
    struct ddb_input *input = core::ptr::null_mut();
    if (dvbdev) {
    output = dvbdev.priv;
...
#[no_mangle]
unsafe extern "C" fn ts_open(inode: *mut inode, file: *mut file) -> c_int {
    ...
    ddb_input_start(input);
#[no_mangle]
pub unsafe extern "C" fn if(O_WRONLY: (file->f_flags & O_ACCMODE) ==) -> else {
    else if ((file.f_flags & O_ACCMODE) == O_WRONLY)
...
//
#[no_mangle]
unsafe extern "C" fn locked_gate_ctrl(fe: *mut dvb_frontend, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn demod_attach_drxk(input: *mut ddb_input) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tuner_attach_tda18271(input: *mut ddb_input) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn demod_attach_stv0367(input: *mut ddb_input) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tuner_tda18212_ping(input: *mut ddb_input, adr: c_ushort) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn demod_attach_cxd28xx(input: *mut ddb_input, par: c_int, osc24: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tuner_attach_tda18212(input: *mut ddb_input, porttype: u32) -> c_int {
    ...
    let mut addr: u8 = (input.nr & 1) ? 0x63 : 0x60;
...
// perform tuner probe/init/attach
    client = dvb_module_probe("tda18212", core::ptr::null_mut(), adapter, addr, &config);
    if (!client)
    goto err;
...
#[no_mangle]
unsafe extern "C" fn demod_attach_stv0900(input: *mut ddb_input, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tuner_attach_stv6110(input: *mut ddb_input, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn has_lnbh25(i2c: *mut i2c_adapter, adr: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn demod_attach_stv0910(input: *mut ddb_input, type: c_int, tsfast: c_int) -> c_int {
    static int demod_attach_stv0910(struct ddb_input *input, int type, int tsfast)
    {
    struct i2c_adapter *i2c = &input.port.i2c.adap;
    struct ddb_dvb *dvb = &input.port.dvb[input.nr & 1];
    struct device *dev = input.port.dev.dev;
    let mut cfg: stv0910_cfg = stv0910_p;
    let mut lnbcfg: lnbh25_config = lnbh25_cfg;
    if (stv0910_single)
    cfg.single = 1;
    if (type)
    cfg.parallel = 2;
...
#[no_mangle]
unsafe extern "C" fn tuner_attach_stv6111(input: *mut ddb_input, type: c_int) -> c_int {
    ...
    struct device *dev = input.port.dev.dev;
    struct dvb_frontend *fe;
    let mut adr: u8 = (type ? 0 : 4) + ((input.nr & 1) ? 0x63 : 0x60);
...
#[no_mangle]
unsafe extern "C" fn demod_attach_dummy(input: *mut ddb_input) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn start_feed(dvbdmxfeed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stop_feed(dvbdmxfeed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_input_detach(input: *mut ddb_input) {
    ...
    dvb.i2c_client[0] = core::ptr::null_mut();
    if (dvb.fe2)
    dvb_frontend_detach(dvb.fe2);
    if (dvb.fe)
    dvb_frontend_detach(dvb.fe);
    dvb.fe = core::ptr::null_mut();
    dvb.fe2 = core::ptr::null_mut();
    fallthrough;
    case 0x20:
...
#[no_mangle]
unsafe extern "C" fn dvb_register_adapters(dev: *mut ddb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvb_unregister_adapters(dev: *mut ddb) {
...
#[no_mangle]
unsafe extern "C" fn dvb_input_attach(input: *mut ddb_input) -> c_int {
    ...
    let mut par: c_int = 0, osc24 = 0, tsfast = 0;
//
...
#[no_mangle]
unsafe extern "C" fn port_has_encti(port: *mut ddb_port) -> c_int {
    static int port_has_encti(struct ddb_port *port)
    {
    struct device *dev = port.dev.dev;
    u8 val;
    let mut ret: c_int = i2c_read_reg(&port.i2c.adap, 0x20, 0, &val);
    if (!ret)
    dev_info(dev, "[0x20]=0x%02x\n", val);
    return ret ? 0 : 1;
    }
#[no_mangle]
unsafe extern "C" fn port_has_cxd(port: *mut ddb_port, type: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_has_xo2(port: *mut ddb_port, type: *mut u8, id: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_has_stv0900(port: *mut ddb_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_has_stv0900_aa(port: *mut ddb_port, id: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_has_drxks(port: *mut ddb_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_has_stv0367(port: *mut ddb_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_xo2(port: *mut ddb_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_xo2_ci(port: *mut ddb_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_has_cxd28xx(port: *mut ddb_port, id: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ddb_port_probe(port: *mut ddb_port) {
    static void ddb_port_probe(struct ddb_port *port)
    {
    struct ddb *dev = port.dev;
    let mut l: u32 = port.lnr;
...
//
#[no_mangle]
unsafe extern "C" fn ddb_port_attach(port: *mut ddb_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ddb_ports_attach(dev: *mut ddb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ddb_ports_detach(dev: *mut ddb) {
...
#[no_mangle]
unsafe extern "C" fn input_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn input_handler(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn output_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn output_handler(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ddb_dma_init(io: *mut ddb_io, nr: c_int, out: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ddb_input_init(port: *mut ddb_port, nr: c_int, pnr: c_int, anr: c_int) {
    ...
    let mut base: u32 = rm0.irq_base_idma;
    let mut dma_nr: u32 = nr;
    if (port.lnr)
...
#[no_mangle]
unsafe extern "C" fn ddb_output_init(port: *mut ddb_port, nr: c_int) {
    ...
    let mut base: u32 = rm0.irq_base_odma;
    ddb_irq_set(dev, 0, nr + base, &output_handler, output);
    ddb_dma_init(output, nr, 1);
    }
    }
#[no_mangle]
unsafe extern "C" fn ddb_port_match_i2c(port: *mut ddb_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ddb_port_match_link_i2c(port: *mut ddb_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ddb_ports_init(dev: *mut ddb) {
...
#[no_mangle]
pub unsafe extern "C" fn ddb_ports_release(dev: *mut ddb) {
...
#[no_mangle]
unsafe extern "C" fn irq_handle_msg(dev: *mut ddb, s: u32) {
...
#[no_mangle]
unsafe extern "C" fn irq_handle_io(dev: *mut ddb, s: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn ddb_irq_handler0(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    irqreturn_t ddb_irq_handler0(int irq, void *dev_id)
    {
    struct ddb *dev = (struct ddb *)dev_id;
    let mut mask: u32 = 0x8fffff00;
    let mut s: u32 = mask & ddbreadl(dev, INTERRUPT_STATUS);
    if (!s)
    return IRQ_NONE;
    do {
    if (s & 0x80000000)
...
#[no_mangle]
pub unsafe extern "C" fn ddb_irq_handler1(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    irqreturn_t ddb_irq_handler1(int irq, void *dev_id)
    {
    struct ddb *dev = (struct ddb *)dev_id;
    let mut mask: u32 = 0x8000000f;
    let mut s: u32 = mask & ddbreadl(dev, INTERRUPT_STATUS);
    if (!s)
    return IRQ_NONE;
    do {
...
#[no_mangle]
pub unsafe extern "C" fn ddb_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    irqreturn_t ddb_irq_handler(int irq, void *dev_id)
    {
    struct ddb *dev = (struct ddb *)dev_id;
    let mut s: u32 = ddbreadl(dev, INTERRUPT_STATUS);
...
//
#[no_mangle]
unsafe extern "C" fn reg_wait(dev: *mut ddb, reg: u32, bit: u32) -> c_int {
    ...
    {
    u32 data, shift;
    let mut tag: u32 = DDB_LINK_TAG(lnr);
...
#[no_mangle]
pub unsafe extern "C" fn ddbridge_flashread(dev: *mut ddb, link: u32, buf: *mut u8, addr: u32, len: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ddb_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ddb_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ddb_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
    ...
    {
    struct ddb *dev = dev_get_drvdata(device);
    let mut num: c_int = attr.attr.name[8] - 0x30;
    ...
    int temp;
    u8 tmp[2];
    let mut num: c_int = attr.attr.name[4] - 0x30;
    ...
    {
    struct ddb *dev = dev_get_drvdata(device);
    let mut num: c_int = attr.attr.name[3] - 0x30;
    return sprintf(buf, "%d\n", dev.leds & (1 << num) ? 1 : 0);
    }
#[no_mangle]
unsafe extern "C" fn ddb_set_led(dev: *mut ddb, num: c_int, val: c_int) {
...
// serial number at 0x100-0x11f
    ...
    struct device_attribute *attr, char *buf)
    {
    let mut num: c_int = attr.attr.name[5] - 0x30;
    struct ddb *dev = dev_get_drvdata(device);
...
#[no_mangle]
unsafe extern "C" fn ddb_class_create() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ddb_class_destroy() {
...
#[no_mangle]
unsafe extern "C" fn ddb_device_attrs_del(dev: *mut ddb) {
...
#[no_mangle]
unsafe extern "C" fn ddb_device_attrs_add(dev: *mut ddb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ddb_device_create(dev: *mut ddb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ddb_device_destroy(dev: *mut ddb) {
...
//
#[no_mangle]
unsafe extern "C" fn tempmon_setfan(link: *mut ddb_link) {
...
#[no_mangle]
unsafe extern "C" fn temp_handler(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tempmon_init(link: *mut ddb_link, first_time: c_int) -> c_int {
    static int tempmon_init(struct ddb_link *link, int first_time)
    {
    struct ddb *dev = link.dev;
    let mut status: c_int = 0;
    let mut l: u32 = link.nr;
...
#[no_mangle]
unsafe extern "C" fn ddb_init_tempmon(link: *mut ddb_link) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ddb_init_boards(dev: *mut ddb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ddb_init(dev: *mut ddb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ddb_unmap(dev: *mut ddb) {
...
#[no_mangle]
pub unsafe extern "C" fn ddb_exit_ddbridge(stage: c_int, error: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ddb_init_ddbridge() -> c_int {
