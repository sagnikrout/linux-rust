...
//! Source: drivers/media/pci/pt1/pt1.c
#![no_std]
...
pub const PT1_PAGE_SHIFT: c_int = 12;

pub const PT1_NR_UPACKETS: c_int = 1024;
pub const PT1_NR_BUFS: c_int = 511;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pt1_buffer_page {
    pub upackets: [__le32; PT1_NR_UPACKETS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pt1_table_page {
    pub next_pfn: __le32,
    pub buf_pfns: [__le32; PT1_NR_BUFS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pt1_buffer {
    pub page: *mut pt1_buffer_page,
    pub addr: dma_addr_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pt1_table {
    pub page: *mut pt1_table_page,
    pub addr: dma_addr_t,
    pub bufs: [pt1_buffer; PT1_NR_BUFS],
}
...
pub const PT1_NR_ADAPS: c_int = 4;
    struct pt1_adapter;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pt1 {
    ...
    pub i2c_running: c_int,
    pub adaps: [*mut pt1_adapter; PT1_NR_ADAPS],
    pub tables: *mut pt1_table,
    ...
    pub power: c_int,
    pub reset: c_int,
    pub fe_clk: enum pt1_fe_clk,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pt1_adapter {
    pub pt1: *mut pt1,
    pub index: c_int,
    pub buf: *mut u8,
    pub upacket_count: c_int,
    pub packet_count: c_int,
    pub st_count: c_int,
    pub adap: dvb_adapter,
    pub demux: dvb_demux,
    pub users: c_int,
    pub dmxdev: dmxdev,
    pub fe: *mut dvb_frontend,
    pub demod_i2c_client: *mut i2c_client,
    pub tuner_i2c_client: *mut i2c_client,
    int (*orig_set_voltage)(struct dvb_frontend *fe,
    pub voltage): enum fe_sec_voltage,
    pub fe): *mut *mut int (orig_sleep)(struct dvb_frontend,
    pub fe): *mut *mut int (orig_init)(struct dvb_frontend,
    pub voltage: enum fe_sec_voltage,
    pub sleep: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn config_demod(cl: *mut i2c_client, clk: enum pt1_fe_clk) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pt1_demod_block_init(pt1: *mut pt1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_write_reg(pt1: *mut pt1, reg: c_int, data: u32) {
    static void pt1_write_reg(struct pt1 *pt1, int reg, u32 data)
    {
    writel(data, pt1.regs + reg * 4);
    }
#[no_mangle]
unsafe extern "C" fn pt1_read_reg(pt1: *mut pt1, reg: c_int) -> u32 {
    static u32 pt1_read_reg(struct pt1 *pt1, int reg)
    {
    return readl(pt1.regs + reg * 4);
    }
    let mut pt1_nr_tables: static unsigned int = 8;
    module_param_named(nr_tables, pt1_nr_tables, uint, 0);
#[no_mangle]
unsafe extern "C" fn pt1_increment_table_count(pt1: *mut pt1) {
    static void pt1_increment_table_count(struct pt1 *pt1)
    {
    pt1_write_reg(pt1, 0, 0x00000020);
    }
#[no_mangle]
unsafe extern "C" fn pt1_init_table_count(pt1: *mut pt1) {
    static void pt1_init_table_count(struct pt1 *pt1)
    {
    pt1_write_reg(pt1, 0, 0x00000010);
    }
#[no_mangle]
unsafe extern "C" fn pt1_register_tables(pt1: *mut pt1, first_pfn: u32) {
...
#[no_mangle]
unsafe extern "C" fn pt1_unregister_tables(pt1: *mut pt1) {
    static void pt1_unregister_tables(struct pt1 *pt1)
    {
    pt1_write_reg(pt1, 0, 0x08080000);
    }
#[no_mangle]
unsafe extern "C" fn pt1_sync(pt1: *mut pt1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_identify(pt1: *mut pt1) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn pt1_unlock(pt1: *mut pt1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_reset_pci(pt1: *mut pt1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_reset_ram(pt1: *mut pt1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_do_enable_ram(pt1: *mut pt1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_enable_ram(pt1: *mut pt1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_filter(pt1: *mut pt1, page: *mut pt1_buffer_page) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !adap->upacket_count) -> else {
...
#[no_mangle]
unsafe extern "C" fn pt1_thread(data: *mut c_void) -> c_int {
    static int pt1_thread(void *data)
    {
    struct pt1 *pt1;
    struct pt1_buffer_page *page;
    bool was_frozen;
pub const PT1_FETCH_DELAY: c_int = 10;
pub const PT1_FETCH_DELAY_DELTA: c_int = 2;
    pt1 = data;
    set_freezable();
...
#[no_mangle]
unsafe extern "C" fn pt1_free_page(pt1: *mut pt1, page: *mut c_void, addr: dma_addr_t) {
...
#[no_mangle]
unsafe extern "C" fn pt1_cleanup_buffer(pt1: *mut pt1, buf: *mut pt1_buffer) {
...
#[no_mangle]
unsafe extern "C" fn pt1_cleanup_table(pt1: *mut pt1, table: *mut pt1_table) {
...
#[no_mangle]
unsafe extern "C" fn pt1_cleanup_tables(pt1: *mut pt1) {
...
#[no_mangle]
unsafe extern "C" fn pt1_init_tables(pt1: *mut pt1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_start_polling(pt1: *mut pt1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_start_feed(feed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_stop_polling(pt1: *mut pt1) {
...
#[no_mangle]
unsafe extern "C" fn pt1_stop_feed(feed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_set_voltage(fe: *mut dvb_frontend, voltage: enum fe_sec_voltage) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_sleep(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_wakeup(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_free_adapter(adap: *mut pt1_adapter) {
    ...
    demux.write_to_decoder = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pt1_cleanup_adapters(pt1: *mut pt1) {
...
#[no_mangle]
unsafe extern "C" fn pt1_init_adapters(pt1: *mut pt1) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_cleanup_frontend(adap: *mut pt1_adapter) {
...
#[no_mangle]
unsafe extern "C" fn pt1_init_frontend(adap: *mut pt1_adapter, fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_cleanup_frontends(pt1: *mut pt1) {
...
#[no_mangle]
unsafe extern "C" fn pt1_init_frontends(pt1: *mut pt1) -> c_int {
    ...
    dcfg.tuner_i2c = core::ptr::null_mut();
    ret = -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn pt1_i2c_write_bit(pt1: *mut pt1, addr: c_int, addrp: *mut c_int, data: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pt1_i2c_read_bit(pt1: *mut pt1, addr: c_int, addrp: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn pt1_i2c_write_byte(pt1: *mut pt1, addr: c_int, addrp: *mut c_int, data: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pt1_i2c_read_byte(pt1: *mut pt1, addr: c_int, addrp: *mut c_int, last: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pt1_i2c_prepare(pt1: *mut pt1, addr: c_int, addrp: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn pt1_i2c_end(pt1: *mut pt1, addr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_i2c_begin(pt1: *mut pt1, addrp: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn pt1_i2c_xfer(adap: *mut i2c_adapter, msgs: *mut i2c_msg, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_i2c_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pt1_i2c_wait(pt1: *mut pt1) {
...
#[no_mangle]
unsafe extern "C" fn pt1_i2c_init(pt1: *mut pt1) {
...
#[no_mangle]
unsafe extern "C" fn pt1_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pt1_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pt1_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
    ...
    i2c_adap.algo_data = core::ptr::null_mut();
