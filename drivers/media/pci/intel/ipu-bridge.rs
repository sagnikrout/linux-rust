...
//! Source: drivers/media/pci/intel/ipu-bridge.c
#![no_std]
...
//
    ...
    let mut handle: acpi_handle = acpi_device_handle(ACPI_PTR(adev));
    for_each_acpi_dev_match(ivsc_adev, acpi_id.id, core::ptr::null_mut(), -1)
...
#[no_mangle]
unsafe extern "C" fn ipu_bridge_match_ivsc_dev(dev: *mut device, adev: *const c_void) -> c_int {
...
// IVSC device on platform bus
    dev = bus_find_device(&platform_bus_type, core::ptr::null_mut(), adev,
...
#[no_mangle]
unsafe extern "C" fn ipu_bridge_parse_orientation(adev: *mut acpi_device) -> enum v4l2_fwnode_orientation {
    static enum v4l2_fwnode_orientation ipu_bridge_parse_orientation(struct acpi_device *adev)
    {
    enum v4l2_fwnode_orientation orientation;
    struct acpi_pld_info *pld = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ipu_bridge_parse_ssdb(adev: *mut acpi_device, sensor: *mut ipu_sensor) -> c_int {
    int ipu_bridge_parse_ssdb(struct acpi_device *adev, struct ipu_sensor *sensor)
    {
    let mut ssdb: ipu_sensor_ssdb = {};
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ipu_bridge_init_swnode_names(sensor: *mut ipu_sensor) {
...
#[no_mangle]
unsafe extern "C" fn ipu_bridge_init_swnode_group(sensor: *mut ipu_sensor) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ipu_bridge_instantiate_vcm_work_data {
    pub work: work_struct,
    pub sensor: *mut device,
    pub name: [c_char; 16],
    pub board_info: i2c_board_info,
}

#[no_mangle]
unsafe extern "C" fn ipu_bridge_instantiate_vcm_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn ipu_bridge_instantiate_vcm(sensor: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipu_bridge_instantiate_ivsc(sensor: *mut ipu_sensor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipu_bridge_unregister_sensors(bridge: *mut ipu_bridge) {
    ...
    int ret;
    for_each_acpi_dev_match(adev, cfg.hid, core::ptr::null_mut(), -1) {
...
#[no_mangle]
unsafe extern "C" fn ipu_bridge_connect_sensors(bridge: *mut ipu_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipu_bridge_ivsc_is_ready() -> c_int {
    ...
    const struct ipu_sensor_config *cfg =
    &ipu_supported_sensors[i];
    for_each_acpi_dev_match(sensor_adev, cfg.hid, core::ptr::null_mut(), -1) {
...
#[no_mangle]
unsafe extern "C" fn ipu_bridge_check_fwnode_graph(fwnode: *mut fwnode_handle) -> c_int {
