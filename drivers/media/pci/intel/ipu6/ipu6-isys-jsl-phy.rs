...
//! Source: drivers/media/pci/intel/ipu6/ipu6-isys-jsl-phy.c
#![no_std]
...
pub const IPU6SE_ISYS_PHY_BB_NUM: c_int = 4;
pub const IPU6SE_ISYS_PHY_0_BASE: c_uint = 0x10000;
...
#[no_mangle]
unsafe extern "C" fn ipu6_isys_csi2_rx_control(isys: *mut ipu6_isys) {
...
pub const DPHY_TIMER_INCR: c_uint = 0x28;
