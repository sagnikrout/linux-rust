...
//! Source: drivers/media/pci/intel/ipu6/ipu6-isys-mcd-phy.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ipu6_isys_mcd_phy_powerup_ack(isys: *mut ipu6_isys, id: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipu6_isys_mcd_phy_powerdown_ack(isys: *mut ipu6_isys, id: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipu6_isys_mcd_phy_reset(isys: *mut ipu6_isys, id: u8, assert: bool) {
...
#[no_mangle]
unsafe extern "C" fn ipu6_isys_mcd_phy_ready(isys: *mut ipu6_isys, id: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipu6_isys_mcd_phy_common_init(isys: *mut ipu6_isys) {
...
#[no_mangle]
unsafe extern "C" fn ipu6_isys_driver_port_to_phy_port(cfg: *mut ipu6_isys_csi2_config) -> c_int {
...
// swap port number only for A and B
    ...
    phy_port = 1;
#[no_mangle]
pub unsafe extern "C" fn if(1: phy_port ==) -> else {
    else if (phy_port == 1)
    phy_port = 0;
    ret = phy_port;
...
#[no_mangle]
unsafe extern "C" fn ipu6_isys_mcd_phy_config(isys: *mut ipu6_isys) -> c_int {
...
pub const CSI_MCD_PHY_NUM: c_int = 2;
