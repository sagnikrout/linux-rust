...
//! Source: drivers/media/pci/intel/ipu6/ipu6-isys-dwc-phy.c
#![no_std]
...
pub const IPU6_DWC_DPHY_RSTZ: c_uint = 0x00;
pub const IPU6_DWC_DPHY_SHUTDOWNZ: c_uint = 0x04;
pub const IPU6_DWC_DPHY_HSFREQRANGE: c_uint = 0x08;
pub const IPU6_DWC_DPHY_CFGCLKFREQRANGE: c_uint = 0x0c;
pub const IPU6_DWC_DPHY_TEST_IFC_ACCESS_MODE: c_uint = 0x10;
pub const IPU6_DWC_DPHY_TEST_IFC_REQ: c_uint = 0x14;
pub const IPU6_DWC_DPHY_TEST_IFC_REQ_COMPLETION: c_uint = 0x18;
pub const IPU6_DWC_DPHY_DFT_CTRL0: c_uint = 0x28;
pub const IPU6_DWC_DPHY_DFT_CTRL1: c_uint = 0x2c;
pub const IPU6_DWC_DPHY_DFT_CTRL2: c_uint = 0x30;
//
...
pub const TEST_IFC_REQ_READ: c_int = 0;
pub const TEST_IFC_REQ_WRITE: c_int = 1;
pub const TEST_IFC_REQ_RESET: c_int = 2;
pub const TEST_IFC_ACCESS_MODE_FSM: c_int = 0;
pub const TEST_IFC_ACCESS_MODE_IFC_CTL: c_int = 1;
    enum phy_fsm_state {
...
#[no_mangle]
unsafe extern "C" fn dwc_dphy_read(isys: *mut ipu6_isys, phy_id: u32, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn dwc_dphy_pwr_up(isys: *mut ipu6_isys, phy_id: u32) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dwc_dphy_freq_range {
    pub hsfreq: u8,
    pub min: u16,
    pub max: u16,
    pub default_mbps: u16,
    pub osc_freq_target: u16,
}
...
#[no_mangle]
unsafe extern "C" fn get_hsfreq_by_mbps(mbps: u32) -> u16 {
    static u16 get_hsfreq_by_mbps(u32 mbps)
    {
    let mut best: u16 = DPHY_FREQ_RANGE_INVALID_INDEX;
    unsigned int i;
...
pub const PHY_E: c_int = 4;
#[no_mangle]
unsafe extern "C" fn ipu6_isys_dwc_phy_powerup_ack(isys: *mut ipu6_isys, phy_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipu6_isys_dwc_phy_reset(isys: *mut ipu6_isys, phy_id: u32) {
