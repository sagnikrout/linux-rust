...
//! Source: drivers/media/common/b2c2/flexcop-fe-tuner.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn flexcop_sleep(fe: *mut *mut dvb_frontend) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn flexcop_set_tone(fe: *mut dvb_frontend, tone: enum fe_sec_tone_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flexcop_diseqc_send_bit(fe: *mut *mut dvb_frontend, data: c_int) {
...
#[no_mangle]
unsafe extern "C" fn flexcop_diseqc_send_byte(fe: *mut *mut dvb_frontend, data: c_int) {
    ...
    {
    return flexcop_send_diseqc_msg(fe, 0, core::ptr::null_mut(), minicmd);
    }
...
#[no_mangle]
unsafe extern "C" fn samsung_tdtc9251dh0_demod_init(fe: *mut dvb_frontend) -> c_int {
    ...
    if (!fc.fe)
    return 0;
    return !!dvb_attach(dvb_pll_attach, fc.fe, 0x61, core::ptr::null_mut(),
...
// AirStar ATSC 1st generation
    ...
    return fc.fe != core::ptr::null_mut();
    }
...
// tuner is connected to a different flexcop I2C adapter.
    ...
    fc.fe.ops.i2c_gate_ctrl = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn flexcop_frontend_init(fc: *mut flexcop_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn flexcop_frontend_exit(fc: *mut flexcop_device) {
