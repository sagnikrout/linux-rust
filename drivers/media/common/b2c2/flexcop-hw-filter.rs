...
//! Source: drivers/media/common/b2c2/flexcop-hw-filter.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn flexcop_rcv_data_ctrl(fc: *mut flexcop_device, onoff: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn flexcop_smc_ctrl(fc: *mut flexcop_device, onoff: c_int) {
    void flexcop_smc_ctrl(struct flexcop_device *fc, int onoff)
    {
    flexcop_set_ibi_value(ctrl_208, SMC_Enable_sig, onoff);
    }
#[no_mangle]
unsafe extern "C" fn flexcop_null_filter_ctrl(fc: *mut flexcop_device, onoff: c_int) {
    static void flexcop_null_filter_ctrl(struct flexcop_device *fc, int onoff)
    {
    flexcop_set_ibi_value(ctrl_208, Null_filter_sig, onoff);
    }
#[no_mangle]
pub unsafe extern "C" fn flexcop_set_mac_filter(fc: *mut flexcop_device, mac[6]: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn flexcop_mac_filter_ctrl(fc: *mut flexcop_device, onoff: c_int) {
...
#[no_mangle]
unsafe extern "C" fn flexcop_pid_group_filter_ctrl(fc: *mut flexcop_device, onoff: c_int) {
...
#[no_mangle]
unsafe extern "C" fn flexcop_toggle_fullts_streaming(fc: *mut flexcop_device, onoff: c_int) -> c_int {
    ...
    {
    let mut max_pid_filter: c_int = 6;
...
#[no_mangle]
pub unsafe extern "C" fn if(0x2000: dvbdmxfeed->pid ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn flexcop_hw_filter_init(fc: *mut flexcop_device) {
