...
//! Source: drivers/media/common/b2c2/flexcop-i2c.c
#![no_std]
...
pub const FC_MAX_I2C_RETRIES: c_int = 100000;
...
#[no_mangle]
unsafe extern "C" fn flexcop_i2c_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn flexcop_i2c_init(fc: *mut flexcop_device) -> c_int {
    ...
    fc.fc_i2c_adap[2].i2c_adap.algo_data = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn flexcop_i2c_exit(fc: *mut flexcop_device) {
