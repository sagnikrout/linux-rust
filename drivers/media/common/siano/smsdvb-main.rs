...
//! Source: drivers/media/common/siano/smsdvb-main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn smsdvb_stats_not_ready(fe: *mut dvb_frontend) {
...
#[no_mangle]
pub unsafe extern "C" fn sms_to_mode(mode: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sms_to_isdbt_mode(mode: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sms_to_isdbt_guard_interval(interval: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sms_to_status(is_demod_locked: u32, is_rf_locked: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sms_to_bw(value: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_onresponse(context: *mut c_void, cb: *mut smscore_buffer_t) -> c_int {
    ...
    struct dvb_frontend *fe = &client.frontend;
    struct dtv_frontend_properties *c = &fe.dtv_property_cache;
    let mut is_status_update: bool = false;
...
#[no_mangle]
unsafe extern "C" fn smsdvb_media_device_unregister(client: *mut smsdvb_client_t) {
    ...
    coredev.media_dev = core::ptr::null_mut();

    }
#[no_mangle]
unsafe extern "C" fn smsdvb_unregister_client(client: *mut smsdvb_client_t) {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_onremove(context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_start_feed(feed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_stop_feed(feed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_send_statistics_request(client: *mut smsdvb_client_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn led_feedback(client: *mut smsdvb_client_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_read_status(fe: *mut dvb_frontend, stat: *mut enum fe_status) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_read_ber(fe: *mut dvb_frontend, ber: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_read_signal_strength(fe: *mut dvb_frontend, strength: *mut u16) -> c_int {
    static int smsdvb_read_signal_strength(struct dvb_frontend *fe, u16 *strength)
    {
    struct dtv_frontend_properties *c = &fe.dtv_property_cache;
    int rc;
    let mut power: i32 = (s32) c.strength.stat[0].uvalue;
    struct smsdvb_client_t *client;
    client = container_of(fe, struct smsdvb_client_t, frontend);
    rc = smsdvb_send_statistics_request(client);
    if (power < -95)
// strength = 0;
#[no_mangle]
pub unsafe extern "C" fn if(-29: power >) -> else {
    else if (power > -29)
// strength = 65535;
    else
...
#[no_mangle]
unsafe extern "C" fn smsdvb_read_snr(fe: *mut dvb_frontend, snr: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_read_ucblocks(fe: *mut dvb_frontend, ucblocks: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_dvbt_set_frontend(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_isdbt_set_frontend(fe: *mut dvb_frontend) -> c_int {
    static int smsdvb_isdbt_set_frontend(struct dvb_frontend *fe)
    {
    struct dtv_frontend_properties *c = &fe.dtv_property_cache;
    struct smsdvb_client_t *client =
    container_of(fe, struct smsdvb_client_t, frontend);
    let mut board_id: c_int = smscore_get_board_id(client.coredev);
    struct sms_board *board = sms_get_board(board_id);
    let mut type: enum sms_device_type_st = board.type;
    int ret;
    struct {
    struct sms_msg_hdr	msg;
    u32		Data[4];
...
#[no_mangle]
pub unsafe extern "C" fn if(1: c->isdbt_sb_segment_count >) -> else {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_set_frontend(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_init(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_sleep(fe: *mut dvb_frontend) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_release(fe: *mut dvb_frontend) {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_module_exit() -> void __exit {
