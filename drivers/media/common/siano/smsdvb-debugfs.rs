...
//! Source: drivers/media/common/siano/smsdvb-debugfs.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct smsdvb_debugfs {
    pub refcount: kref,
    pub lock: spinlock_t,
    pub stats_data: [c_char; PAGE_SIZE],
    pub stats_count: unsigned,
    pub stats_was_read: bool,
    pub stats_queue: wait_queue_head_t,
}
...
#[no_mangle]
unsafe extern "C" fn smsdvb_stats_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_debugfs_data_release(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_stats_wait_read(debug_data: *mut smsdvb_debugfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_stats_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn smsdvb_stats_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn smsdvb_debugfs_create(client: *mut smsdvb_client_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smsdvb_debugfs_release(client: *mut smsdvb_client_t) {
    void smsdvb_debugfs_release(struct smsdvb_client_t *client)
    {
    if (!client.debugfs)
    return;
    client.prt_dvb_stats     = core::ptr::null_mut();
    client.prt_isdb_stats    = core::ptr::null_mut();
    client.prt_isdb_stats_ex = core::ptr::null_mut();
    debugfs_remove_recursive(client.debugfs);
    kref_put(&client.debug_data.refcount, smsdvb_debugfs_data_release);
    client.debug_data = core::ptr::null_mut();
    client.debugfs = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn smsdvb_debugfs_register() {
...
#[no_mangle]
pub unsafe extern "C" fn smsdvb_debugfs_unregister() {
    void smsdvb_debugfs_unregister(void)
    {
    if (!smsdvb_debugfs_usb_root)
    return;
    debugfs_remove_recursive(smsdvb_debugfs_usb_root);
    smsdvb_debugfs_usb_root = core::ptr::null_mut();
    }
