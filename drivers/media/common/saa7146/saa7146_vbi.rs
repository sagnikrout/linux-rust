...
//! Source: drivers/media/common/saa7146/saa7146_vbi.c
#![no_std]
...
// SPDX-License-Identifier: GPL-2.0
    ...
    let mut vbi_pixel_to_capture: static int = 720 * 2;
#[no_mangle]
unsafe extern "C" fn vbi_workaround(dev: *mut saa7146_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn saa7146_set_vbi_capture(dev: *mut saa7146_dev, buf: *mut saa7146_buf, next: *mut saa7146_buf) {
...
// ------------------------------------------------------------------
    ...
    {
    let mut size: c_uint = 16 * 2 * vbi_pixel_to_capture;
    if (*num_planes)
...
#[no_mangle]
unsafe extern "C" fn vbi_stop(dev: *mut saa7146_dev) {
...
#[no_mangle]
unsafe extern "C" fn vbi_read_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn vbi_begin(dev: *mut saa7146_dev) -> c_int {
    static int vbi_begin(struct saa7146_dev *dev)
    {
    struct saa7146_vv *vv = dev.vv_data;
    let mut arbtr_ctrl: u32 = saa7146_read(dev, PCI_BT_V1);
    let mut ret: c_int = 0;
    DEB_VBI("dev:%p\n", dev);
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn vbi_init(dev: *mut saa7146_dev, vv: *mut saa7146_vv) {
...
#[no_mangle]
unsafe extern "C" fn vbi_irq_done(dev: *mut saa7146_dev, status: c_ulong) {
