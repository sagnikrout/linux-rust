...
//! Source: drivers/media/common/videobuf2/videobuf2-dvb.c
#![no_std]
...
// ------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn dvb_fnc(vb: *mut vb2_buffer, priv: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vb2_dvb_start_feed(feed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vb2_dvb_stop_feed(feed: *mut dvb_demux_feed) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vb2_dvb_unregister_bus(f: *mut vb2_dvb_frontends) {
    ...
    {
    struct list_head *list, *q;
    struct vb2_dvb_frontend *fe, *ret = core::ptr::null_mut();
    mutex_lock(&f.lock);
    list_for_each_safe(list, q, &f.felist) {
    fe = list_entry(list, struct vb2_dvb_frontend, felist);
    if (fe.id == id) {
...
#[no_mangle]
pub unsafe extern "C" fn vb2_dvb_dealloc_frontends(f: *mut vb2_dvb_frontends) {
