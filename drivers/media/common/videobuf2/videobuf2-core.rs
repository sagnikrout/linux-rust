...
//! Source: drivers/media/common/videobuf2/videobuf2-core.c
#![no_std]
...
pub const PLANE_INDEX_BITS: c_int = 3;
...
//
    ...
    \
    log_memop(vb, op);						\
    ptr = _q.mem_ops.op ? _q.mem_ops.op(vb, args) : core::ptr::null_mut();	\
    ...
    ((vb).vb2_queue.mem_ops.op ?					\
    (vb).vb2_queue.mem_ops.op(vb, args) : core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn __vb2_buf_mem_alloc(vb: *mut vb2_buffer) -> c_int {
...
// Memops alloc requires size to be page aligned.
    let mut size: c_ulong = PAGE_ALIGN(vb.planes[plane].length);
// Did it wrap around?
...
// Free already allocated memory if one of the allocations failed
    ...
    vb.planes[plane - 1].mem_priv = core::ptr::null_mut();
    }
    return ret;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn __vb2_buf_mem_free(vb: *mut vb2_buffer) {
    static void __vb2_buf_mem_free(struct vb2_buffer *vb)
    {
    unsigned int plane;
    for (plane = 0; plane < vb.num_planes; ++plane) {
    call_void_memop(vb, put, vb.planes[plane].mem_priv);
    vb.planes[plane].mem_priv = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn __vb2_buf_userptr_put(vb: *mut vb2_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn __vb2_plane_dmabuf_put(vb: *mut vb2_buffer, p: *mut vb2_plane) {
    ...
    dma_buf_put(p.dbuf);
    p.mem_priv = core::ptr::null_mut();
    p.dbuf = core::ptr::null_mut();
    p.dbuf_mapped = 0;
    p.bytesused = 0;
    p.length = 0;
    p.m.fd = 0;
...
//
#[no_mangle]
unsafe extern "C" fn __vb2_buf_dmabuf_put(vb: *mut vb2_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn __vb2_buf_mem_prepare(vb: *mut vb2_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn __vb2_buf_mem_finish(vb: *mut vb2_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn __setup_offsets(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn init_buffer_cache_hints(q: *mut vb2_queue, vb: *mut vb2_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn vb2_queue_add_buffer(q: *mut vb2_queue, vb: *mut vb2_buffer, index: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn vb2_queue_remove_buffer(vb: *mut vb2_buffer) {
    static void vb2_queue_remove_buffer(struct vb2_buffer *vb)
    {
    clear_bit(vb.index, vb.vb2_queue.bufs_bitmap);
    vb.vb2_queue.bufs[vb.index] = core::ptr::null_mut();
    vb.vb2_queue = core::ptr::null_mut();
    }
//
...
//
    ...
    let mut index: c_ulong = q.max_num_buffers;
    int ret;
//
...
//
#[no_mangle]
unsafe extern "C" fn __vb2_free_mem(q: *mut vb2_queue, start: c_uint, count: c_uint) {
...
// Free MMAP buffers or release USERPTR buffers
    ...
    __vb2_buf_mem_free(vb);
#[no_mangle]
pub unsafe extern "C" fn if(VB2_MEMORY_DMABUF: q->memory ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn __vb2_queue_free(q: *mut vb2_queue, start: c_uint, count: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn vb2_buffer_in_use(q: *mut vb2_queue, vb: *mut vb2_buffer) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn __buffers_in_use(q: *mut vb2_queue) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn vb2_core_querybuf(q: *mut vb2_queue, vb: *mut vb2_buffer, pb: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn __verify_userptr_ops(q: *mut vb2_queue) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __verify_mmap_ops(q: *mut vb2_queue) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __verify_dmabuf_ops(q: *mut vb2_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_queue_coherency(q: *mut vb2_queue, non_coherent_mem: bool) {
...
#[no_mangle]
unsafe extern "C" fn verify_coherency_flags(q: *mut vb2_queue, non_coherent_mem: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vb2_core_allocated_buffers_storage(q: *mut vb2_queue) -> c_int {
    ...
    if (!q.bufs_bitmap) {
    kfree(q.bufs);
    q.bufs = core::ptr::null_mut();
    return -ENOMEM;
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn vb2_core_free_buffers_storage(q: *mut vb2_queue) {
    static void vb2_core_free_buffers_storage(struct vb2_queue *q)
    {
    kfree(q.bufs);
    q.bufs = core::ptr::null_mut();
    bitmap_free(q.bufs_bitmap);
    q.bufs_bitmap = core::ptr::null_mut();
    }
    int vb2_core_reqbufs(struct vb2_queue *q, enum vb2_memory memory,
    unsigned int flags, unsigned int *count)
    {
    unsigned int num_buffers, allocated_buffers, num_planes = 0;
    let mut q_num_bufs: c_uint = vb2_get_num_buffers(q);
    unsigned plane_sizes[VB2_MAX_PLANES] = { };
    let mut non_coherent_mem: bool = flags & V4L2_MEMORY_FLAG_NON_COHERENT;
...
// count = allocated_buffers;
    ...
    unsigned int *first_index)
    {
    let mut num_planes: c_uint = 0, num_buffers, allocated_buffers;
    unsigned plane_sizes[VB2_MAX_PLANES] = { };
    let mut non_coherent_mem: bool = flags & V4L2_MEMORY_FLAG_NON_COHERENT;
    let mut q_num_bufs: c_uint = vb2_get_num_buffers(q);
    let mut no_previous_buffers: bool = !q_num_bufs;
    let mut ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn vb2_buffer_done(vb: *mut vb2_buffer, state: enum vb2_buffer_state) {
...
#[no_mangle]
pub unsafe extern "C" fn vb2_discard_done(q: *mut vb2_queue) {
...
//
#[no_mangle]
unsafe extern "C" fn __prepare_mmap(vb: *mut vb2_buffer) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __prepare_userptr(vb: *mut vb2_buffer) -> c_int {
    ...
    unsigned int plane;
    let mut ret: c_int = 0;
    let mut reacquired: bool = vb.planes[0].mem_priv == core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn __prepare_dmabuf(vb: *mut vb2_buffer) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __enqueue_in_driver(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn __buf_prepare(vb: *mut vb2_buffer) -> c_int {
    static int __buf_prepare(struct vb2_buffer *vb)
    {
    struct vb2_queue *q = vb.vb2_queue;
    let mut orig_state: enum vb2_buffer_state = vb.state;
    int ret;
    if (q.error) {
...
#[no_mangle]
unsafe extern "C" fn vb2_req_prepare(obj: *mut media_request_object) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vb2_req_unprepare(obj: *mut media_request_object) {
...
#[no_mangle]
unsafe extern "C" fn vb2_req_queue(obj: *mut media_request_object) {
...
//
    err = vb2_core_qbuf(vb.vb2_queue, vb, core::ptr::null_mut(), core::ptr::null_mut());
    WARN_ON_ONCE(err && err != -EIO);
    mutex_unlock(vb.vb2_queue.lock);
    }
#[no_mangle]
unsafe extern "C" fn vb2_req_unbind(obj: *mut media_request_object) {
...
#[no_mangle]
unsafe extern "C" fn vb2_req_release(obj: *mut media_request_object) {
...
#[no_mangle]
pub unsafe extern "C" fn vb2_request_object_is_buffer(obj: *mut media_request_object) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn vb2_request_buffer_cnt(req: *mut media_request) -> c_uint {
    unsigned int vb2_request_buffer_cnt(struct media_request *req)
    {
    struct media_request_object *obj;
    unsigned long flags;
    let mut buffer_cnt: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn vb2_core_prepare_buf(q: *mut vb2_queue, vb: *mut vb2_buffer, pb: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vb2_core_remove_bufs(q: *mut vb2_queue, start: c_uint, count: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vb2_start_streaming(q: *mut vb2_queue) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __vb2_wait_for_done_vb(q: *mut vb2_queue, nonblocking: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vb2_wait_for_all_buffers(q: *mut vb2_queue) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __vb2_dqbuf(vb: *mut vb2_buffer) {
    static void __vb2_dqbuf(struct vb2_buffer *vb)
    {
    struct vb2_queue *q = vb.vb2_queue;
// nothing to do if the buffer is already dequeued
    ...
    bool nonblocking)
    {
    struct vb2_buffer *vb = core::ptr::null_mut();
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn __vb2_queue_cancel(q: *mut vb2_queue) {
    static void __vb2_queue_cancel(struct vb2_queue *q)
    {
    unsigned int i;
//
...
#[no_mangle]
pub unsafe extern "C" fn vb2_core_streamon(q: *mut vb2_queue, type: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vb2_queue_error(q: *mut vb2_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn vb2_core_streamoff(q: *mut vb2_queue, type: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vb2_mmap(q: *mut vb2_queue, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vb2_core_queue_init(q: *mut vb2_queue) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vb2_core_queue_release(q: *mut vb2_queue) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vb2_fileio_data {
    pub count: c_uint,
    pub type: c_uint,
    pub memory: c_uint,
    pub bufs: [vb2_fileio_buf; VB2_MAX_FRAME],
    pub cur_index: c_uint,
    pub initial_index: c_uint,
    pub q_count: c_uint,
    pub dq_count: c_uint,
    pub read_once:1: unsigned,
    pub write_immediately:1: unsigned,
}
...
//
#[no_mangle]
unsafe extern "C" fn __vb2_init_fileio(q: *mut vb2_queue, read: c_int) -> c_int {
    static int __vb2_init_fileio(struct vb2_queue *q, int read)
    {
...
// vb can never be NULL when using fileio.
    ...
    if (fileio.bufs[i].vaddr == core::ptr::null_mut()) {
    ret = -EINVAL;
    goto err_reqbufs;
    }
...
//
    ...
    if (!vb2)
    continue;
    ret = vb2_core_qbuf(q, vb2, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret)
    goto err_reqbufs;
...
//
#[no_mangle]
unsafe extern "C" fn __vb2_cleanup_fileio(q: *mut vb2_queue) -> c_int {
    static int __vb2_cleanup_fileio(struct vb2_queue *q)
    {
...
//
    ret = vb2_core_dqbuf(q, &index, core::ptr::null_mut(), nonblock);
...
//
    ...
    ret = vb2_core_qbuf(q, b, core::ptr::null_mut(), core::ptr::null_mut());
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vb2_threadio_data {
    pub thread: *mut task_struct,
    pub fnc: vb2_thread_fnc,
    pub priv: *mut c_void,
    pub stop: bool,
}

#[no_mangle]
unsafe extern "C" fn vb2_thread(data: *mut c_void) -> c_int {
    static int vb2_thread(void *data)
    {
    struct vb2_queue *q = data;
    struct vb2_threadio_data *threadio = q.threadio;
    let mut copy_timestamp: bool = false;
    let mut prequeue: unsigned = 0;
...
//
    ...
    mutex_lock(q.lock);
    if (!threadio.stop)
    ret = vb2_core_dqbuf(q, &index, core::ptr::null_mut(), 0);
    mutex_unlock(q.lock);
    ...
    if (!threadio.stop) {
    mutex_lock(q.lock);
    ret = vb2_core_qbuf(q, vb, core::ptr::null_mut(), core::ptr::null_mut());
    mutex_unlock(q.lock);
    }
    if (ret || threadio.stop)
    break;
...
//
    ...
    threadio.thread = core::ptr::null_mut();
    goto nothread;
    }
    return 0;
    nothread:
...
#[no_mangle]
pub unsafe extern "C" fn vb2_thread_stop(q: *mut vb2_queue) -> c_int {
