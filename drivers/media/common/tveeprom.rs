...
//! Source: drivers/media/common/tveeprom.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hasRadioTuner(tunerType: c_int) -> c_int {
...
//
    ...
    let mut tuner1: c_int = 0, t_format1 = 0, audioic = -1;
    const char *t_name1 = core::ptr::null_mut();
    const char *t_fmt_name1[8] = { " none", "", "", "", "", "", "", "" };
    let mut tuner2: c_int = 0, t_format2 = 0;
    const char *t_name2 = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn tveeprom_read(c: *mut i2c_client, eedata: *mut c_uchar, len: c_int) -> c_int {
