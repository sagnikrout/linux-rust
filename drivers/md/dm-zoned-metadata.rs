...
//! Source: drivers/md/dm-zoned-metadata.c
#![no_std]
...
// Metadata version.
//
pub const DMZ_META_VER: c_int = 2;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmz_super {
// Magic number
    pub /: *mut *mut __le32 magic; / 4,
// Metadata version number
    pub /: *mut *mut __le32 version; / 8,
// Generation number
    pub /: *mut *mut __le64 gen; / 16,
// This block number
    pub /: *mut *mut __le64 sb_block; / 24,
// The number of metadata blocks, including this super block
    pub /: *mut *mut __le32 nr_meta_blocks; / 28,
// The number of sequential zones reserved for reclaim
    pub /: *mut *mut __le32 nr_reserved_seq; / 32,
// The number of entries in the mapping table
    pub /: *mut *mut __le32 nr_chunks; / 36,
// The number of blocks used for the chunk mapping table
    pub /: *mut *mut __le32 nr_map_blocks; / 40,
// The number of blocks used for the block bitmaps
    pub /: *mut *mut __le32 nr_bitmap_blocks; / 44,
// Checksum
    pub /: *mut *mut __le32 crc; / 48,
// DM-Zoned label
    pub /: *mut *mut u8 dmz_label[32]; / 80,
// DM-Zoned UUID
    pub /: *mut *mut u8 dmz_uuid[16]; / 96,
// Device UUID
    pub /: *mut *mut u8 dev_uuid[16]; / 112,
// Padding to full 512B sector
    pub /: *mut *mut u8 reserved[400]; / 512,
}
...
pub struct dmz_sb {
    pub block: sector_t,
    pub dev: *mut dmz_dev,
    pub mblk: *mut dmz_mblock,
    pub sb: *mut dmz_super,
    pub zone: *mut dm_zone,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmz_metadata {
    pub dev: *mut dmz_dev,
    pub nr_devs: c_uint,
    pub devname: [c_char; BDEVNAME_SIZE],
    pub label: [c_char; BDEVNAME_SIZE],
    pub uuid: uuid_t,
    pub zone_bitmap_size: sector_t,
    pub zone_nr_bitmap_blocks: c_uint,
    pub zone_bits_per_mblk: c_uint,
    pub zone_nr_blocks: sector_t,
    pub zone_nr_blocks_shift: sector_t,
    pub zone_nr_sectors: sector_t,
    pub zone_nr_sectors_shift: sector_t,
    pub nr_bitmap_blocks: c_uint,
    pub nr_map_blocks: c_uint,
    pub nr_zones: c_uint,
    pub nr_useable_zones: c_uint,
    pub nr_meta_blocks: c_uint,
    pub nr_meta_zones: c_uint,
    pub nr_data_zones: c_uint,
    pub nr_cache_zones: c_uint,
    pub nr_rnd_zones: c_uint,
    pub nr_reserved_seq: c_uint,
    pub nr_chunks: c_uint,
// Zone information array
    pub zones: xarray,
    pub sb: [dmz_sb; 2],
    pub mblk_primary: c_uint,
    pub sb_version: c_uint,
    pub sb_gen: u64,
    pub min_nr_mblks: c_uint,
    pub max_nr_mblks: c_uint,
    pub nr_mblks: core::sync::atomic::AtomicI32,
    pub mblk_sem: rw_semaphore,
    pub mblk_flush_lock: mutex,
    pub mblk_lock: spinlock_t,
    pub mblk_rbtree: rb_root,
    pub mblk_lru_list: list_head,
    pub mblk_dirty_list: list_head,
    pub mblk_shrinker: *mut shrinker,
// Zone allocation management
    pub map_lock: mutex,
    pub map_mblk: *mut dmz_mblock,
    pub nr_cache: c_uint,
    pub unmap_nr_cache: core::sync::atomic::AtomicI32,
    pub unmap_cache_list: list_head,
    pub map_cache_list: list_head,
    pub nr_reserved_seq_zones: core::sync::atomic::AtomicI32,
    pub reserved_seq_zones_list: list_head,
    pub free_wq: wait_queue_head_t,
}
...
//
#[no_mangle]
unsafe extern "C" fn dmz_dev_zone_id(zmd: *mut dmz_metadata, zone: *mut dm_zone) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn dmz_start_sect(zmd: *mut dmz_metadata, zone: *mut dm_zone) -> sector_t {
    sector_t dmz_start_sect(struct dmz_metadata *zmd, struct dm_zone *zone)
    {
    let mut zone_id: c_uint = dmz_dev_zone_id(zmd, zone);
    return (sector_t)zone_id << zmd.zone_nr_sectors_shift;
    }
#[no_mangle]
pub unsafe extern "C" fn dmz_start_block(zmd: *mut dmz_metadata, zone: *mut dm_zone) -> sector_t {
...
#[no_mangle]
pub unsafe extern "C" fn dmz_zone_nr_blocks(zmd: *mut dmz_metadata) -> c_uint {
    unsigned int dmz_zone_nr_blocks(struct dmz_metadata *zmd)
    {
    return zmd.zone_nr_blocks;
    }
#[no_mangle]
pub unsafe extern "C" fn dmz_zone_nr_sectors(zmd: *mut dmz_metadata) -> c_uint {
    unsigned int dmz_zone_nr_sectors(struct dmz_metadata *zmd)
    {
    return zmd.zone_nr_sectors;
    }
#[no_mangle]
pub unsafe extern "C" fn dmz_zone_nr_sectors_shift(zmd: *mut dmz_metadata) -> c_uint {
    unsigned int dmz_zone_nr_sectors_shift(struct dmz_metadata *zmd)
    {
    return zmd.zone_nr_sectors_shift;
    }
#[no_mangle]
pub unsafe extern "C" fn dmz_nr_zones(zmd: *mut dmz_metadata) -> c_uint {
    unsigned int dmz_nr_zones(struct dmz_metadata *zmd)
    {
    return zmd.nr_zones;
    }
#[no_mangle]
pub unsafe extern "C" fn dmz_nr_chunks(zmd: *mut dmz_metadata) -> c_uint {
    unsigned int dmz_nr_chunks(struct dmz_metadata *zmd)
    {
    return zmd.nr_chunks;
    }
#[no_mangle]
pub unsafe extern "C" fn dmz_nr_rnd_zones(zmd: *mut dmz_metadata, idx: c_int) -> c_uint {
    unsigned int dmz_nr_rnd_zones(struct dmz_metadata *zmd, int idx)
    {
    return zmd.dev[idx].nr_rnd;
    }
#[no_mangle]
pub unsafe extern "C" fn dmz_nr_unmap_rnd_zones(zmd: *mut dmz_metadata, idx: c_int) -> c_uint {
    unsigned int dmz_nr_unmap_rnd_zones(struct dmz_metadata *zmd, int idx)
    {
    return atomic_read(&zmd.dev[idx].unmap_nr_rnd);
    }
#[no_mangle]
pub unsafe extern "C" fn dmz_nr_cache_zones(zmd: *mut dmz_metadata) -> c_uint {
    unsigned int dmz_nr_cache_zones(struct dmz_metadata *zmd)
    {
    return zmd.nr_cache;
    }
#[no_mangle]
pub unsafe extern "C" fn dmz_nr_unmap_cache_zones(zmd: *mut dmz_metadata) -> c_uint {
    unsigned int dmz_nr_unmap_cache_zones(struct dmz_metadata *zmd)
    {
    return atomic_read(&zmd.unmap_nr_cache);
    }
#[no_mangle]
pub unsafe extern "C" fn dmz_nr_seq_zones(zmd: *mut dmz_metadata, idx: c_int) -> c_uint {
    unsigned int dmz_nr_seq_zones(struct dmz_metadata *zmd, int idx)
    {
    return zmd.dev[idx].nr_seq;
    }
#[no_mangle]
pub unsafe extern "C" fn dmz_nr_unmap_seq_zones(zmd: *mut dmz_metadata, idx: c_int) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn dmz_check_dev(zmd: *mut dmz_metadata) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn dmz_dev_is_dying(zmd: *mut dmz_metadata) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_lock_map(zmd: *mut dmz_metadata) {
    void dmz_lock_map(struct dmz_metadata *zmd)
    {
    mutex_lock(&zmd.map_lock);
    }
#[no_mangle]
pub unsafe extern "C" fn dmz_unlock_map(zmd: *mut dmz_metadata) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_lock_metadata(zmd: *mut dmz_metadata) {
    void dmz_lock_metadata(struct dmz_metadata *zmd)
    {
    down_read(&zmd.mblk_sem);
    }
#[no_mangle]
pub unsafe extern "C" fn dmz_unlock_metadata(zmd: *mut dmz_metadata) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_lock_flush(zmd: *mut dmz_metadata) {
    void dmz_lock_flush(struct dmz_metadata *zmd)
    {
    mutex_lock(&zmd.mblk_flush_lock);
    }
#[no_mangle]
pub unsafe extern "C" fn dmz_unlock_flush(zmd: *mut dmz_metadata) {
...
//
    ...
    sector_t mblk_no)
    {
    struct dmz_mblock *mblk = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn dmz_free_mblock(zmd: *mut dmz_metadata, mblk: *mut dmz_mblock) {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_insert_mblock(zmd: *mut dmz_metadata, mblk: *mut dmz_mblock) {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_mblock_bio_end_io(bio: *mut bio) {
...
//
    ...
    let mut block: sector_t = zmd.sb[zmd.mblk_primary].block + mblk_no;
...
//
#[no_mangle]
unsafe extern "C" fn dmz_dirty_mblock(zmd: *mut dmz_metadata, mblk: *mut dmz_mblock) {
...
//
    ...
    let mut block: sector_t = zmd.sb[set].block + mblk.no;
    struct bio *bio;
    if (dmz_bdev_is_dying(dev))
    return -EIO;
...
//
#[no_mangle]
unsafe extern "C" fn dmz_write_sb(zmd: *mut dmz_metadata, set: c_uint) -> c_int {
    ...
    struct dmz_dev *dev = zmd.sb[set].dev;
    sector_t sb_block;
    let mut sb_gen: u64 = zmd.sb_gen + 1;
    int ret;
...
//
    ...
    let mut ret: c_int = 0, nr_mblks_submitted = 0;
// Issue writes
    blk_start_plug(&plug);
...
//
    ...
    struct list_head *write_list)
    {
    let mut log_set: c_uint = zmd.mblk_primary ^ 0x1;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_flush_metadata(zmd: *mut dmz_metadata) -> c_int {
...
//
    ...
    dmz_dev_err(dev, "core::ptr::null_mut() DM-Zoned uuid");
    return -ENXIO;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: memcmp(zmd->label, _arg: sb->dmz_label, _arg: BDEVNAME_SIZE)) -> else {
    ...
    dmz_dev_err(dev, "core::ptr::null_mut() device uuid");
    return -ENXIO;
    }
    if (tertiary) {
//
...
//
#[no_mangle]
unsafe extern "C" fn dmz_read_sb(zmd: *mut dmz_metadata, sb: *mut dmz_sb, set: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_lookup_secondary_sb(zmd: *mut dmz_metadata) -> c_int {
    static int dmz_lookup_secondary_sb(struct dmz_metadata *zmd)
    {
    let mut zone_nr_blocks: c_uint = zmd.zone_nr_blocks;
    struct dmz_mblock *mblk;
    let mut zone_id: c_uint = zmd.sb[0].zone.id;
    int i;
// Allocate a block
...
// Bad first super block: search for the second one
    ...
    dmz_free_mblock(zmd, mblk);
    zmd.sb[1].mblk = core::ptr::null_mut();
    zmd.sb[1].zone = core::ptr::null_mut();
    zmd.sb[1].dev = core::ptr::null_mut();
    return -EIO;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dmz_get_sb(zmd: *mut dmz_metadata, sb: *mut dmz_sb, set: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_recover_mblocks(zmd: *mut dmz_metadata, dst_set: c_uint) -> c_int {
    static int dmz_recover_mblocks(struct dmz_metadata *zmd, unsigned int dst_set)
    {
    let mut src_set: c_uint = dst_set ^ 0x1;
    struct page *page;
    int i, ret;
...
//
#[no_mangle]
unsafe extern "C" fn dmz_load_sb(zmd: *mut dmz_metadata) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_init_zone(blkz: *mut blk_zone, num: c_uint, data: *mut c_void) -> c_int {
    static int dmz_init_zone(struct blk_zone *blkz, unsigned int num, void *data)
    {
    struct dmz_dev *dev = data;
    struct dmz_metadata *zmd = dev.metadata;
    let mut idx: c_int = num + dev.zone_offset;
    struct dm_zone *zone;
...
//
    ...
    set_bit(DMZ_OFFLINE, &zone.flags);
#[no_mangle]
pub unsafe extern "C" fn if(BLK_ZONE_COND_READONLY: blkz->cond ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn dmz_emulate_zones(zmd: *mut dmz_metadata, dev: *mut dmz_dev) -> c_int {
    static int dmz_emulate_zones(struct dmz_metadata *zmd, struct dmz_dev *dev)
    {
    int idx;
    let mut zone_offset: sector_t = 0;
...
//
#[no_mangle]
unsafe extern "C" fn dmz_drop_zones(zmd: *mut dmz_metadata) {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_init_zones(zmd: *mut dmz_metadata) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_update_zone(zmd: *mut dmz_metadata, zone: *mut dm_zone) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_reset_zone(zmd: *mut dmz_metadata, zone: *mut dm_zone) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_load_mapping(zmd: *mut dmz_metadata) -> c_int {
    static int dmz_load_mapping(struct dmz_metadata *zmd)
    {
    struct dm_zone *dzone, *bzone;
    struct dmz_mblock *dmap_mblk = core::ptr::null_mut();
    struct dmz_map *dmap;
    let mut i: c_uint = 0, e = 0, chunk = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dmz_is_rnd(dzone)) -> else {
...
//
    ...
    let mut map_idx: c_int = chunk & DMZ_MAP_ENTRIES_MASK;
...
//
#[no_mangle]
unsafe extern "C" fn __dmz_lru_zone(zmd: *mut dmz_metadata, zone: *mut dm_zone) {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_lru_zone(zmd: *mut dmz_metadata, zone: *mut dm_zone) {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_wait_for_free_zones(zmd: *mut dmz_metadata) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_lock_zone_reclaim(zone: *mut dm_zone) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_unlock_zone_reclaim(zone: *mut dm_zone) {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_wait_for_reclaim(zmd: *mut dmz_metadata, zone: *mut dm_zone) {
...
//
    ...
    {
    struct dm_zone *dzone = core::ptr::null_mut();
    struct dm_zone *zone, *maxw_z = core::ptr::null_mut();
...
//
    ...
    {
    struct dm_zone *zone = core::ptr::null_mut();
//
...
//
    ...
    struct dmz_mblock *dmap_mblk = zmd.map_mblk[chunk >> DMZ_MAP_ENTRIES_SHIFT];
    struct dmz_map *dmap = dmap_mblk.data;
    let mut dmap_idx: c_int = chunk & DMZ_MAP_ENTRIES_MASK;
    unsigned int dzone_id;
    struct dm_zone *dzone = core::ptr::null_mut();
    let mut ret: c_int = 0;
    let mut alloc_flags: c_int = zmd.nr_cache ? DMZ_ALLOC_CACHE : DMZ_ALLOC_RND;
    dmz_lock_map(zmd);
    again:
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_put_chunk_mapping(zmd: *mut dmz_metadata, dzone: *mut dm_zone) {
...
#[no_mangle]
pub unsafe extern "C" fn if(DMZ_ALLOC_RND: flags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dmz_is_rnd(zone)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_free_zone(zmd: *mut dmz_metadata, zone: *mut dm_zone) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_unmap_zone(zmd: *mut dmz_metadata, zone: *mut dm_zone) {
    void dmz_unmap_zone(struct dmz_metadata *zmd, struct dm_zone *zone)
    {
    let mut chunk: c_uint = zone.chunk;
    unsigned int dzone_id;
...
//
    ...
    zone.bzone.bzone = core::ptr::null_mut();
    zone.bzone = core::ptr::null_mut();
    } else {
//
...
//
    ...
    {
    unsigned long *addr;
    let mut end: c_uint = bit + nr_bits;
    let mut n: c_uint = 0;
    while (bit < end) {
...
//
    ...
    let mut chunk_block: sector_t = 0;
...
//
#[no_mangle]
unsafe extern "C" fn dmz_clear_bits(bitmap: *mut c_ulong, bit: c_int, nr_bits: c_int) -> c_int {
    static int dmz_clear_bits(unsigned long *bitmap, int bit, int nr_bits)
    {
    unsigned long *addr;
    let mut end: c_int = bit + nr_bits;
    let mut n: c_int = 0;
    while (bit < end) {
    if (((bit & (BITS_PER_LONG - 1)) == 0) &&
    ((end - bit) >= BITS_PER_LONG)) {
...
//
    ...
    let mut zone_bits: c_uint = zmd.zone_bits_per_mblk;
...
//
    ...
    sector_t *chunk_block)
    {
    let mut start_block: sector_t = *chunk_block;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn dmz_count_bits(bitmap: *mut c_void, bit: c_int, nr_bits: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_get_zone_weight(zmd: *mut dmz_metadata, zone: *mut dm_zone) {
    static void dmz_get_zone_weight(struct dmz_metadata *zmd, struct dm_zone *zone)
    {
    struct dmz_mblock *mblk;
    let mut chunk_block: sector_t = 0;
    unsigned int bit, nr_bits;
    let mut nr_blocks: c_uint = zmd.zone_nr_blocks;
    void *bitmap;
    let mut n: c_int = 0;
    while (nr_blocks) {
// Get bitmap block
...
//
#[no_mangle]
unsafe extern "C" fn dmz_cleanup_metadata(zmd: *mut dmz_metadata) {
...
// Release zone mapping resources
    ...
    kfree(zmd.map_mblk);
    zmd.map_mblk = core::ptr::null_mut();
    }
// Release super blocks
    for (i = 0; i < 2; i++) {
    if (zmd.sb[i].mblk) {
    dmz_free_mblock(zmd, zmd.sb[i].mblk);
    zmd.sb[i].mblk = core::ptr::null_mut();
    }
    }
// Free cached blocks
...
#[no_mangle]
unsafe extern "C" fn dmz_print_dev(zmd: *mut dmz_metadata, num: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_dtr_metadata(zmd: *mut dmz_metadata) {
