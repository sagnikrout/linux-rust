...
//! Source: drivers/md/dm-zoned-reclaim.c
#![no_std]
...
//
pub const DMZ_RECLAIM_LOW_UNMAP_ZONES: c_int = 30;
//
// Percentage of unmapped (free) random zones above which reclaim will
// stop if the target is busy.
//
pub const DMZ_RECLAIM_HIGH_UNMAP_ZONES: c_int = 50;
//
...
//
    ...
    let mut wp_block: sector_t = zone.wp_block;
...
//
    ...
    let mut block: sector_t = 0, end_block;
    sector_t nr_blocks;
...
//
#[no_mangle]
unsafe extern "C" fn dmz_reclaim_buf(zrc: *mut dmz_reclaim, dzone: *mut dm_zone) -> c_int {
    static int dmz_reclaim_buf(struct dmz_reclaim *zrc, struct dm_zone *dzone)
    {
    struct dm_zone *bzone = dzone.bzone;
    let mut chunk_block: sector_t = dzone.wp_block;
    struct dmz_metadata *zmd = zrc.metadata;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn dmz_reclaim_seq_data(zrc: *mut dmz_reclaim, dzone: *mut dm_zone) -> c_int {
    static int dmz_reclaim_seq_data(struct dmz_reclaim *zrc, struct dm_zone *dzone)
    {
    let mut chunk: c_uint = dzone.chunk;
    struct dm_zone *bzone = dzone.bzone;
    struct dmz_metadata *zmd = zrc.metadata;
    let mut ret: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn dmz_reclaim_rnd_data(zrc: *mut dmz_reclaim, dzone: *mut dm_zone) -> c_int {
    static int dmz_reclaim_rnd_data(struct dmz_reclaim *zrc, struct dm_zone *dzone)
    {
    let mut chunk: c_uint = dzone.chunk;
    struct dm_zone *szone = core::ptr::null_mut();
    struct dmz_metadata *zmd = zrc.metadata;
    int ret;
    let mut alloc_flags: c_int = DMZ_ALLOC_SEQ;
...
//
#[no_mangle]
unsafe extern "C" fn dmz_reclaim_empty(zrc: *mut dmz_reclaim, dzone: *mut dm_zone) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_target_idle(zrc: *mut dmz_reclaim) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_do_reclaim(zrc: *mut dmz_reclaim) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmz_reclaim_percentage(zrc: *mut dmz_reclaim) -> c_uint {
    static unsigned int dmz_reclaim_percentage(struct dmz_reclaim *zrc)
    {
    struct dmz_metadata *zmd = zrc.metadata;
    let mut nr_cache: c_uint = dmz_nr_cache_zones(zmd);
...
//
#[no_mangle]
unsafe extern "C" fn dmz_should_reclaim(zrc: *mut dmz_reclaim, p_unmap: c_uint) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_reclaim_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_dtr_reclaim(zrc: *mut dmz_reclaim) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_suspend_reclaim(zrc: *mut dmz_reclaim) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_resume_reclaim(zrc: *mut dmz_reclaim) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_reclaim_bio_acc(zrc: *mut dmz_reclaim) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_schedule_reclaim(zrc: *mut dmz_reclaim) {
    void dmz_schedule_reclaim(struct dmz_reclaim *zrc)
    {
    let mut p_unmap: c_uint = dmz_reclaim_percentage(zrc);
    if (dmz_should_reclaim(zrc, p_unmap))
