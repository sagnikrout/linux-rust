...
pub const DM_IO_ERROR_THRESHOLD: c_int = 15;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stripe {
    pub dev: *mut dm_dev,
...
pub struct stripe_c {
    pub stripes: u32,
    pub stripes_shift: c_int,
// The size of this target / num. stripes
    pub stripe_width: sector_t,
    pub chunk_size: u32,
    pub chunk_size_shift: c_int,
// Needed for handling events
    pub ti: *mut dm_target,
// Work struct used for triggering events
    pub trigger_event: work_struct,
    pub __counted_by(stripes): stripe stripe[],
}
...
//
#[no_mangle]
unsafe extern "C" fn stripe_ctr(ti: *mut dm_target, argc: c_uint, argv: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stripe_dtr(ti: *mut dm_target) {
    ...
    {
    let mut chunk: sector_t = dm_target_offset(sc.ti, sector);
...
#[no_mangle]
pub unsafe extern "C" fn stripe_map(ti: *mut dm_target, bio: *mut bio) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dm_stripe_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn dm_stripe_exit() {
