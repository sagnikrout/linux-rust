...
//! Source: drivers/md/dm-zoned-target.c
#![no_std]
...
pub const DMZ_MIN_BIOS: c_int = 8192;
//
// Zone BIO context.
//
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmz_bioctx {
    pub dev: *mut dmz_dev,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_chunk_work {
    pub work: work_struct,
    pub refcount: refcount_t,
    pub target: *mut dmz_target,
    pub chunk: c_uint,
...
// For chunk work
    pub chunk_rxtree: radix_tree_root,
    pub chunk_wq: *mut workqueue_struct,
    pub chunk_lock: mutex,
// For cloned BIOs to zones
    pub bio_set: bio_set,
// For flush
    pub flush_lock: spinlock_t,
    pub flush_list: bio_list,
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_bio_endio(bio: *mut bio, status: blk_status_t) {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_clone_endio(clone: *mut bio) {
    static void dmz_clone_endio(struct bio *clone)
    {
    struct dmz_bioctx *bioctx = clone.bi_private;
    let mut status: blk_status_t = clone.bi_status;
    bio_put(clone);
...
//
    ...
    {
    let mut size: c_uint = nr_blocks << DMZ_BLOCK_SHIFT;
// Clear nr_blocks
...
//
    ...
    let mut chunk_block: sector_t = dmz_chunk_block(zmd, dmz_bio_block(bio));
    let mut nr_blocks: c_uint = dmz_bio_blocks(bio);
    let mut end_block: sector_t = chunk_block + nr_blocks;
...
//
    ...
    {
    struct dmz_metadata *zmd = dmz.metadata;
    let mut block: sector_t = dmz_bio_block(bio);
    let mut nr_blocks: c_uint = dmz_bio_blocks(bio);
    let mut chunk_block: sector_t = dmz_chunk_block(zmd, block);
    let mut ret: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_get_chunk_work(cw: *mut dm_chunk_work) {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_put_chunk_work(cw: *mut dm_chunk_work) {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_chunk_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_flush_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_queue_chunk_work(dmz: *mut dmz_target, bio: *mut bio) -> c_int {
    static int dmz_queue_chunk_work(struct dmz_target *dmz, struct bio *bio)
    {
    let mut chunk: c_uint = dmz_bio_chunk(dmz.metadata, bio);
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_bdev_is_dying(dmz_dev: *mut dmz_dev) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmz_check_bdev(dmz_dev: *mut dmz_dev) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_map(ti: *mut dm_target, bio: *mut bio) -> c_int {
...
// Initialize the BIO context
    bioctx.dev = core::ptr::null_mut();
    bioctx.zone = core::ptr::null_mut();
    bioctx.bio = bio;
...
//
#[no_mangle]
unsafe extern "C" fn dmz_put_zoned_devices(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn dmz_fixup_devices(ti: *mut dm_target) -> c_int {
    static int dmz_fixup_devices(struct dm_target *ti)
    {
    struct dmz_target *dmz = ti.private;
    struct dmz_dev *reg_dev = core::ptr::null_mut();
    let mut zone_nr_sectors: sector_t = 0;
    int i;
//
...
//
#[no_mangle]
unsafe extern "C" fn dmz_ctr(ti: *mut dm_target, argc: c_uint, argv: *mut c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_dtr(ti: *mut dm_target) {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_io_hints(ti: *mut dm_target, limits: *mut queue_limits) {
    static void dmz_io_hints(struct dm_target *ti, struct queue_limits *limits)
    {
    struct dmz_target *dmz = ti.private;
    let mut chunk_sectors: c_uint = dmz_zone_nr_sectors(dmz.metadata);
...
//
#[no_mangle]
unsafe extern "C" fn dmz_suspend(ti: *mut dm_target) {
...
//
#[no_mangle]
unsafe extern "C" fn dmz_resume(ti: *mut dm_target) {
    ...
    {
    struct dmz_target *dmz = ti.private;
    let mut zone_nr_sectors: c_uint = dmz_zone_nr_sectors(dmz.metadata);
    sector_t capacity;
    int i, r = 0;
    for (i = 0; i < dmz.nr_ddevs; i++) {
