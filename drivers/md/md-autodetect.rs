...
//! Source: drivers/md/md-autodetect.c
#![no_std]
...
//
    ...
    let mut raid_noautodetect: static int __initdata = 1;
...
//
#[no_mangle]
unsafe extern "C" fn md_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn md_setup_drive(args: *mut md_setup_args) -> void __init {
    static void __init md_setup_drive(struct md_setup_args *args)
    {
    char *devname = args.device_names;
    dev_t devices[MD_SB_DISKS + 1], mdev;
    let mut ainfo: mdu_array_info_s = { };
    struct mddev *mddev;
    ...
    for (i = 0; i < MD_SB_DISKS && devname != core::ptr::null_mut(); i++) {
    struct kstat stat;
    char *p;
    char comp_name[64];
    dev_t dev;
...
#[no_mangle]
unsafe extern "C" fn raid_setup(str: *mut c_char) -> int __init {
    ...
    __setup("md=", md_setup);
#[no_mangle]
unsafe extern "C" fn autodetect_raid() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn md_run_setup() -> void __init {
