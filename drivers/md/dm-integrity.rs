...
//! Source: drivers/md/dm-integrity.c
#![no_std]
...
pub const DEFAULT_INTERLEAVE_SECTORS: c_int = 32768;
pub const DEFAULT_JOURNAL_SIZE_FACTOR: c_int = 7;
pub const DEFAULT_SECTORS_PER_BITMAP_BIT: c_int = 32768;
pub const DEFAULT_BUFFER_SECTORS: c_int = 128;
pub const DEFAULT_JOURNAL_WATERMARK: c_int = 50;
pub const DEFAULT_SYNC_MSEC: c_int = 10000;

pub const MIN_LOG2_INTERLEAVE_SECTORS: c_int = 3;
pub const MAX_LOG2_INTERLEAVE_SECTORS: c_int = 31;
pub const METADATA_WORKQUEUE_MAX_ACTIVE: c_int = 16;

pub const RECALC_WRITE_SUPER: c_int = 16;

pub const DISCARD_FILLER: c_uint = 0xf6;
pub const SALT_SIZE: c_int = 16;
pub const RECHECK_POOL_SIZE: c_int = 256;
//
...
pub const SB_VERSION_1: c_int = 1;
pub const SB_VERSION_2: c_int = 2;
pub const SB_VERSION_3: c_int = 3;
pub const SB_VERSION_4: c_int = 4;
pub const SB_VERSION_5: c_int = 5;
pub const SB_VERSION_6: c_int = 6;
pub const SB_VERSION_7: c_int = 7;
pub const SB_SECTORS: c_int = 8;
pub const MAX_SECTORS_PER_BLOCK: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct superblock {
    pub magic: [__u8; 8],
    pub version: __u8,
    pub log2_interleave_sectors: __u8,
    pub integrity_tag_size: __le16,
    pub journal_sections: __le32,
    pub /: *mut *mut __le64 provided_data_sectors; / userspace uses this value,
    pub flags: __le32,
    pub log2_sectors_per_block: __u8,
    pub log2_blocks_per_bitmap_bit: __u8,
    pub pad: [__u8; 2],
    pub recalc_sector: __le64,
    pub pad2: [__u8; 8],
    pub salt: [__u8; SALT_SIZE],
}

pub const SB_FLAG_HAVE_JOURNAL_MAC: c_uint = 0x1;
pub const SB_FLAG_RECALCULATING: c_uint = 0x2;
pub const SB_FLAG_DIRTY_BITMAP: c_uint = 0x4;
pub const SB_FLAG_FIXED_PADDING: c_uint = 0x8;
pub const SB_FLAG_FIXED_HMAC: c_uint = 0x10;
pub const SB_FLAG_INLINE: c_uint = 0x20;
pub const SB_FLAG_DISCARD_KEYED: c_uint = 0x40;
pub const JOURNAL_ENTRY_ROUNDUP: c_int = 8;
    typedef __le64 commit_id_t;
pub const JOURNAL_MAC_PER_SECTOR: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct journal_entry {
    union {
    struct {
    pub sector_lo: __le32,
    pub sector_hi: __le32,
    pub s: },
    pub sector: __le64,
    pub u: },
    pub last_bytes: [commit_id_t; ],
// __u8 tag[0];
}

pub const JOURNAL_BLOCK_SECTORS: c_int = 8;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct journal_sector {
    struct_group(sectors,
    pub JOURNAL_MAC_PER_SECTOR]: __u8 entries[JOURNAL_SECTOR_DATA -,
    pub mac: [__u8; JOURNAL_MAC_PER_SECTOR],
    pub commit_id: commit_id_t,
}

pub const MAX_TAG_SIZE: c_int = 255;
pub const METADATA_PADDING_SECTORS: c_int = 8;
pub const N_COMMIT_IDS: c_int = 4;
#[no_mangle]
unsafe extern "C" fn prev_commit_seq(seq: c_uchar) -> c_uchar {
    static unsigned char prev_commit_seq(unsigned char seq)
    {
    return (seq + N_COMMIT_IDS - 1) % N_COMMIT_IDS;
    }
#[no_mangle]
unsafe extern "C" fn next_commit_seq(seq: c_uchar) -> c_uchar {
...
#[derive(Copy, Clone)]
pub struct alg_spec {
    pub alg_string: *mut c_char,
    pub key_string: *mut c_char,
    pub key: *mut __u8,
    pub key_size: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_integrity_c {
    pub dev: *mut dm_dev,
    pub meta_dev: *mut dm_dev,
    pub tag_size: c_uint,
    pub log2_tag_size: __s8,
    pub tuple_size: c_uint,
    pub start: sector_t,
    pub journal_io_mempool: mempool_t,
    pub io: *mut dm_io_client,
    pub bufio: *mut dm_bufio_client,
    pub metadata_wq: *mut workqueue_struct,
    pub sb: *mut superblock,
    pub journal_pages: c_uint,
    pub n_bitmap_blocks: c_uint,
    pub journal: *mut page_list,
    pub journal_io: *mut page_list,
    pub journal_xor: *mut page_list,
    pub recalc_bitmap: *mut page_list,
    pub may_write_bitmap: *mut page_list,
    pub bbs: *mut bitmap_block_status,
    pub bitmap_flush_interval: c_uint,
    pub synchronous_mode: c_int,
    pub synchronous_bios: bio_list,
    pub bitmap_flush_work: delayed_work,
    pub journal_crypt: *mut crypto_skcipher,
    pub journal_scatterlist: *mut scatterlist,
    pub journal_io_scatterlist: *mut scatterlist,
    pub sk_requests: *mut skcipher_request,
    pub journal_mac: *mut crypto_shash,
    pub journal_tree: *mut journal_node,
    pub journal_tree_root: rb_root,
    pub provided_data_sectors: sector_t,
    pub journal_entry_size: c_ushort,
    pub journal_entries_per_sector: c_uchar,
    pub journal_section_entries: c_uchar,
    pub journal_section_sectors: c_ushort,
    pub journal_sections: c_uint,
    pub journal_entries: c_uint,
    pub data_device_sectors: sector_t,
    pub meta_device_sectors: sector_t,
    pub initial_sectors: c_uint,
    pub metadata_run: c_uint,
    pub log2_metadata_run: __s8,
    pub log2_buffer_sectors: __u8,
    pub sectors_per_block: __u8,
    pub log2_blocks_per_bitmap_bit: __u8,
    pub mode: c_uchar,
    pub internal_hash: bool,
    pub failed: c_int,
    pub internal_shash: *mut crypto_shash,
    pub internal_ahash: *mut crypto_ahash,
    pub internal_hash_digestsize: c_uint,
    pub ti: *mut dm_target,
// these variables are locked with endio_wait.lock
    pub in_progress: rb_root,
    pub wait_list: list_head,
    pub endio_wait: wait_queue_head_t,
    pub wait_wq: *mut workqueue_struct,
    pub offload_wq: *mut workqueue_struct,
    pub commit_seq: c_uchar,
    pub commit_ids: [commit_id_t; N_COMMIT_IDS],
    pub committed_section: c_uint,
    pub n_committed_sections: c_uint,
    pub uncommitted_section: c_uint,
    pub n_uncommitted_sections: c_uint,
    pub free_section: c_uint,
    pub free_section_entry: c_uchar,
    pub free_sectors: c_uint,
    pub free_sectors_threshold: c_uint,
    pub commit_wq: *mut workqueue_struct,
    pub commit_work: work_struct,
    pub writer_wq: *mut workqueue_struct,
    pub writer_work: work_struct,
    pub recalc_wq: *mut workqueue_struct,
    pub recalc_work: work_struct,
    pub flush_bio_list: bio_list,
    pub autocommit_jiffies: c_ulong,
    pub autocommit_timer: timer_list,
    pub autocommit_msec: c_uint,
    pub copy_to_journal_wait: wait_queue_head_t,
    pub crypto_backoff: completion,
    pub wrote_to_journal: bool,
    pub journal_uptodate: bool,
    pub just_formatted: bool,
    pub recalculate_flag: bool,
    pub reset_recalculate_flag: bool,
    pub discard: bool,
    pub discard_keyed: bool,
    pub fix_padding: bool,
    pub fix_hmac: bool,
    pub legacy_recalculate: bool,
    pub ahash_req_pool: mempool_t,
    pub journal_ahash_req: *mut ahash_request,
    pub internal_hash_alg: alg_spec,
    pub journal_crypt_alg: alg_spec,
    pub journal_mac_alg: alg_spec,
    pub number_of_mismatches: core::sync::atomic::AtomicI64,
    pub recheck_pool: mempool_t,
    pub recheck_bios: bio_set,
    pub recalc_bios: bio_set,
    pub reboot_notifier: notifier_block,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_integrity_range {
    pub logical_sector: sector_t,
    pub n_sectors: sector_t,
    pub waiting: bool,
    union {
    pub node: rb_node,
    struct {
    pub task: *mut task_struct,
    pub wait_entry: list_head,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_integrity_io {
    pub work: work_struct,
    pub ic: *mut dm_integrity_c,
    pub op: enum req_op,
    pub fua: bool,
    pub range: dm_integrity_range,
    pub metadata_block: sector_t,
    pub metadata_offset: c_uint,
    pub in_flight: core::sync::atomic::AtomicI32,
    pub bi_status: blk_status_t,
    pub completion: *mut completion,
    pub bio_details: dm_bio_details,
    pub integrity_payload: *mut c_char,
    pub payload_len: unsigned,
    pub integrity_payload_from_mempool: bool,
    pub integrity_range_locked: bool,
    pub ahash_req: *mut ahash_request,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct journal_completion {
    pub ic: *mut dm_integrity_c,
    pub in_flight: core::sync::atomic::AtomicI32,
    pub comp: completion,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct journal_io {
    pub range: dm_integrity_range,
    pub comp: *mut journal_completion,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bitmap_block_status {
    pub work: work_struct,
    pub ic: *mut dm_integrity_c,
    pub idx: c_uint,
    pub bitmap: *mut c_ulong,
    pub bio_queue: bio_list,
    pub bio_queue_lock: spinlock_t,
}

    static struct kmem_cache *journal_io_cache;
pub const JOURNAL_IO_MEMPOOL: c_int = 32;
pub const AHASH_MEMPOOL: c_int = 32;
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_io_error(ic: *mut dm_integrity_c, msg: *const c_char, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_failed(ic: *mut dm_integrity_c) -> c_int {
    static int dm_integrity_failed(struct dm_integrity_c *ic)
    {
    return READ_ONCE(ic.failed);
    }
#[no_mangle]
unsafe extern "C" fn dm_integrity_disable_recalculate(ic: *mut dm_integrity_c) -> bool {
...
//
    ...
    {
    if (!ic.meta_dev) {
    let mut log2_interleave_sectors: __u8 = ic.sb.log2_interleave_sectors;
...
#[no_mangle]
unsafe extern "C" fn get_data_sector(ic: *mut dm_integrity_c, area: sector_t, offset: sector_t) -> sector_t {
...
#[no_mangle]
unsafe extern "C" fn wraparound_section(ic: *mut dm_integrity_c, sec_ptr: *mut c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sb_set_version(ic: *mut dm_integrity_c) {
    static void sb_set_version(struct dm_integrity_c *ic)
    {
    if (ic.sb.flags & cpu_to_le32(SB_FLAG_DISCARD_KEYED))
    ic.sb.version = SB_VERSION_7;
#[no_mangle]
pub unsafe extern "C" fn if(cpu_to_le32(SB_FLAG_INLINE): ic->sb->flags &) -> else {
    else if (ic.sb.flags & cpu_to_le32(SB_FLAG_INLINE))
    ic.sb.version = SB_VERSION_6;
#[no_mangle]
pub unsafe extern "C" fn if(cpu_to_le32(SB_FLAG_FIXED_HMAC): ic->sb->flags &) -> else {
    else if (ic.sb.flags & cpu_to_le32(SB_FLAG_FIXED_HMAC))
    ic.sb.version = SB_VERSION_5;
#[no_mangle]
pub unsafe extern "C" fn if(cpu_to_le32(SB_FLAG_FIXED_PADDING): ic->sb->flags &) -> else {
    else if (ic.sb.flags & cpu_to_le32(SB_FLAG_FIXED_PADDING))
    ic.sb.version = SB_VERSION_4;
#[no_mangle]
pub unsafe extern "C" fn if(cpu_to_le32(SB_FLAG_DIRTY_BITMAP): ic->mode == 'B' || ic->sb->flags &) -> else {
    else if (ic.mode == 'B' || ic.sb.flags & cpu_to_le32(SB_FLAG_DIRTY_BITMAP))
    ic.sb.version = SB_VERSION_3;
#[no_mangle]
pub unsafe extern "C" fn if(cpu_to_le32(SB_FLAG_RECALCULATING): ic->meta_dev || ic->sb->flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn sb_mac(ic: *mut dm_integrity_c, wr: bool) -> c_int {
    static int sb_mac(struct dm_integrity_c *ic, bool wr)
    {
    SHASH_DESC_ON_STACK(desc, ic.journal_mac);
    int r;
    let mut mac_size: c_uint = crypto_shash_digestsize(ic.journal_mac);
    __u8 *sb = (__u8 *)ic.sb;
...
#[no_mangle]
unsafe extern "C" fn sync_rw_sb(ic: *mut dm_integrity_c, opf: blk_opf_t) -> c_int {
    ...
    io_req.notify.fn = core::ptr::null_mut();
    io_req.client = ic.io;
    ...
    r = dm_io(&io_req, 1, &io_loc, core::ptr::null_mut(), core::ptr::null_mut(), IOPRIO_DEFAULT);
    if (unlikely(r))
    return r;
    if (op == REQ_OP_READ) {
...
pub const BITMAP_OP_TEST_ALL_SET: c_int = 0;
pub const BITMAP_OP_TEST_ALL_CLEAR: c_int = 1;
pub const BITMAP_OP_SET: c_int = 2;
pub const BITMAP_OP_CLEAR: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn block_bitmap_copy(ic: *mut dm_integrity_c, dst: *mut page_list, src: *mut page_list) {
    static void block_bitmap_copy(struct dm_integrity_c *ic, struct page_list *dst, struct page_list *src)
    {
    let mut n_bitmap_pages: c_uint = DIV_ROUND_UP(ic.n_bitmap_blocks, PAGE_SIZE / BITMAP_BLOCK_SIZE);
    unsigned int i;
    ...
    {
    let mut bit: c_uint = sector >> (ic.sb.log2_sectors_per_block + ic.log2_blocks_per_bitmap_bit);
    let mut bitmap_block: c_uint = bit / (BITMAP_BLOCK_SIZE * 8);
    ...
    let mut limit: c_uint = e ? ic.journal_section_entries : ic.journal_section_sectors;
...
// n_sectors = (PAGE_SIZE - pl_offset) >> SECTOR_SHIFT;
    ...
    {
    return access_page_list(ic, ic.journal, section, offset, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn section_mac(ic: *mut dm_integrity_c, section: c_uint, result[JOURNAL_MAC_SIZE]: __u8) {
...
#[no_mangle]
unsafe extern "C" fn rw_section_mac(ic: *mut dm_integrity_c, section: c_uint, wr: bool) {
...
#[no_mangle]
unsafe extern "C" fn complete_journal_op(context: *mut c_void) {
    ...
    let mut n_bytes: usize = (size_t)(n_sections * ic.journal_section_sectors) << SECTOR_SHIFT;
    ...
    init_async_submit(&submit, ASYNC_TX_XOR_ZERO_DST, core::ptr::null_mut(), complete_journal_op, comp, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn complete_journal_encrypt(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn do_crypt(encrypt: bool, req: *mut skcipher_request, comp: *mut journal_completion) -> bool {
...
#[no_mangle]
unsafe extern "C" fn complete_journal_io(error: c_ulong, unsup: c_ulong, context: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn if(0): unlikely(unsup !=) -> else {
    ...
    if (likely(comp != core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn write_journal(ic: *mut dm_integrity_c, commit_start: c_uint, commit_sections: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ranges_overlap(range1: *mut dm_integrity_range, range2: *mut dm_integrity_range) -> bool {
...
#[no_mangle]
unsafe extern "C" fn add_new_range(ic: *mut dm_integrity_c, new_range: *mut dm_integrity_range, check_waiting: bool) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(range->n_sectors: new_range->logical_sector >= range->logical_sector +) -> else {
...
#[no_mangle]
unsafe extern "C" fn remove_range_unlocked(ic: *mut dm_integrity_c, range: *mut dm_integrity_range) {
...
#[no_mangle]
unsafe extern "C" fn remove_range(ic: *mut dm_integrity_c, range: *mut dm_integrity_range) {
...
#[no_mangle]
unsafe extern "C" fn wait_and_add_new_range(ic: *mut dm_integrity_c, new_range: *mut dm_integrity_range) {
...
#[no_mangle]
unsafe extern "C" fn add_new_range_and_wait(ic: *mut dm_integrity_c, new_range: *mut dm_integrity_range) {
...
#[no_mangle]
unsafe extern "C" fn init_journal_node(node: *mut journal_node) {
...
#[no_mangle]
unsafe extern "C" fn add_journal_node(ic: *mut dm_integrity_c, node: *mut journal_node, sector: sector_t) {
...
#[no_mangle]
unsafe extern "C" fn remove_journal_node(ic: *mut dm_integrity_c, node: *mut journal_node) {
...
#[no_mangle]
unsafe extern "C" fn find_journal_node(ic: *mut dm_integrity_c, sector: sector_t, next_sector: *mut sector_t) -> c_uint {
    static unsigned int find_journal_node(struct dm_integrity_c *ic, sector_t sector, sector_t *next_sector)
    {
    struct rb_node *n = ic.journal_tree_root.rb_node;
    let mut found: c_uint = NOT_FOUND;
...
#[no_mangle]
unsafe extern "C" fn test_journal_node(ic: *mut dm_integrity_c, pos: c_uint, sector: sector_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn find_newer_committed_node(ic: *mut dm_integrity_c, node: *mut journal_node) -> bool {
...
pub const TAG_READ: c_int = 0;
pub const TAG_WRITE: c_int = 1;
pub const TAG_CMP: c_int = 2;
    static int dm_integrity_rw_tag(struct dm_integrity_c *ic, unsigned char *tag, sector_t *metadata_block,
    unsigned int *metadata_offset, unsigned int total_size, int op)
    {
    let mut hash_offset: c_uint = 0;
    let mut mismatch_hash: c_uchar = 0;
    let mut mismatch_filler: c_uchar = !ic.discard || ic.discard_keyed;
    do {
...
pub struct flush_request {
    ...
    pub io_reg: dm_io_region,
    pub ic: *mut dm_integrity_c,
    pub comp: completion,
}

#[no_mangle]
unsafe extern "C" fn flush_notify(error: c_ulong, unsup: c_ulong, fr_: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_flush_buffers(ic: *mut dm_integrity_c, flush_data: bool) {
    ...
    fr.io_req.mem.ptr.addr = core::ptr::null_mut();
    ...
    r = dm_io(&fr.io_req, 1, &fr.io_reg, core::ptr::null_mut(), core::ptr::null_mut(), IOPRIO_DEFAULT);
    BUG_ON(r);
    }
...
#[no_mangle]
unsafe extern "C" fn sleep_on_endio_wait(ic: *mut dm_integrity_c) {
...
#[no_mangle]
unsafe extern "C" fn autocommit_fn(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn schedule_autocommit(ic: *mut dm_integrity_c) {
...
#[no_mangle]
unsafe extern "C" fn submit_flush_bio(ic: *mut dm_integrity_c, dio: *mut dm_integrity_io) {
...
#[no_mangle]
unsafe extern "C" fn do_endio(ic: *mut dm_integrity_c, bio: *mut bio) {
...
#[no_mangle]
unsafe extern "C" fn do_endio_flush(ic: *mut dm_integrity_c, dio: *mut dm_integrity_io) {
...
#[no_mangle]
unsafe extern "C" fn dec_in_flight(dio: *mut dm_integrity_io) {
...
#[no_mangle]
unsafe extern "C" fn integrity_end_io(bio: *mut bio) {
    ...
    {
    let mut sector_le: __le64 = cpu_to_le64(sector);
...
// this shouldn't happen anyway, the hash functions have no reason to fail
    ...
    let mut nents: c_uint = 1 + (len ? 1 : 0);
    might_sleep();
    req = *ahash_req;
    if (unlikely(!req)) {
...
// ahash_req = req;
    ...
    let mut sec_off: c_uint = offset_in_page(&sector_le);
...
// this shouldn't happen anyway, the hash functions have no reason to fail
    ...
    {
    let mut len: c_uint = ic.sectors_per_block << SECTOR_SHIFT;
    if (likely(ic.internal_shash != core::ptr::null_mut()))
...
//
    ...
    {
    if (likely(ic.internal_shash != core::ptr::null_mut()))
    integrity_sector_checksum_shash(ic, sector, core::ptr::null_mut(), 0, 0, result);
    else
    integrity_sector_checksum_ahash(ic, ahash_req, sector, core::ptr::null_mut(), 0, 0, result);
    }
...
#[no_mangle]
unsafe extern "C" fn integrity_kunmap(ic: *mut dm_integrity_c, ptr: *const c_void) {
...
#[no_mangle]
unsafe extern "C" fn integrity_recheck(dio: *mut dm_integrity_io, checksum: *mut c_char) -> noinline void {
...
#[no_mangle]
unsafe extern "C" fn integrity_metadata(w: *mut work_struct) {
    ...
    struct bvec_iter iter;
    struct bio_vec bv;
    let mut digest_size: c_uint = ic.internal_hash_digestsize;
    struct bio *bio = dm_bio_from_per_bio_data(dio, sizeof(struct dm_integrity_io));
    char *checksums;
    let mut extra_space: c_uint = unlikely(digest_size > ic.tag_size) ? digest_size - ic.tag_size : 0;
    ...
    let mut bi_size: c_uint = dio.bio_details.bi_iter.bi_size;
    let mut max_size: c_uint = likely(checksums != checksums_onstack) ? PAGE_SIZE : sizeof(checksums_onstack);
    let mut max_blocks: c_uint = (max_size - extra_space) / ic.tag_size;
    let mut sector: sector_t = dio.range.logical_sector;
    if (!ic.discard_keyed)
    memset(checksums, DISCARD_FILLER, max_size);
    while (bi_size) {
    let mut this_step_blocks: c_uint = bi_size >> (SECTOR_SHIFT + ic.sb.log2_sectors_per_block);
    ...
    struct bio_vec biv;
    struct bvec_iter iter;
    let mut data_to_process: c_uint = dio.range.n_sectors;
...
#[no_mangle]
pub unsafe extern "C" fn dm_integrity_check_limits(ic: *mut dm_integrity_c, logical_sector: sector_t, bio: *mut bio) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_map(ti: *mut dm_target, bio: *mut bio) -> c_int {
    ...
    dio.bi_status = 0;
    dio.op = bio_op(bio);
    dio.ahash_req = core::ptr::null_mut();
    if (ic.mode == 'I') {
    bio.bi_iter.bi_sector = dm_target_offset(ic.ti, bio.bi_iter.bi_sector);
    dio.integrity_payload = core::ptr::null_mut();
    ...
    if (unlikely(dio.op == REQ_OP_DISCARD)) {
    if (ti.max_io_len) {
    let mut sec: sector_t = dm_target_offset(ti, bio.bi_iter.bi_sector);
    let mut log2_max_io_len: c_uint = __fls(ti.max_io_len);
    let mut start_boundary: sector_t = sec >> log2_max_io_len;
    let mut end_boundary: sector_t = (sec + bio_sectors(bio) - 1) >> log2_max_io_len;
    if (start_boundary < end_boundary) {
    let mut len: sector_t = ti.max_io_len - (sec & (ti.max_io_len - 1));
...
//
    ...
    if (!ic.internal_hash) {
    if (bip) {
    let mut wanted_tag_size: c_uint = bio_sectors(bio) >> ic.sb.log2_sectors_per_block;
    ...
    if (unlikely(bip != core::ptr::null_mut())) {
    ...
    do {
    let mut bv: bio_vec = bio_iovec(bio);
    char *mem;
...
// (commit_id_t *)(mem_ptr + JOURNAL_SECTOR_DATA) = je->last_bytes[s];
    ...
    let mut tag_todo: c_uint = ic.tag_size;
    char *tag_ptr = journal_entry_tag(ic, je);
    if (bip) {
    do {
    let mut biv: bio_vec = bvec_iter_bvec(bip.bip_vec, bip.bip_iter);
    let mut tag_now: c_uint = min(biv.bv_len, tag_todo);
    char *tag_addr;
    BUG_ON(PageHighMem(biv.bv_page));
    ...
    let mut js_offset: unsigned = offset_in_page(js);
    if (unlikely(digest_size > ic.tag_size)) {
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_map_continue(dio: *mut dm_integrity_io, from_map: bool) {
    static void dm_integrity_map_continue(struct dm_integrity_io *dio, bool from_map)
    {
    struct dm_integrity_c *ic = dio.ic;
    struct bio *bio = dm_bio_from_per_bio_data(dio, sizeof(struct dm_integrity_io));
    ...
    let mut discard_retried: bool = false;
    let mut need_sync_io: bool = ic.internal_hash && dio.op == REQ_OP_READ;
    ...
    unsigned int i;
    let mut jp: c_uint = journal_read_pos + 1;
...
//
    ...
    dio.completion = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_map_inline(dio: *mut dm_integrity_io, from_map: bool) -> c_int {
    static int dm_integrity_map_inline(struct dm_integrity_io *dio, bool from_map)
    {
    struct dm_integrity_c *ic = dio.ic;
    struct bio *bio = dm_bio_from_per_bio_data(dio, sizeof(struct dm_integrity_io));
    ...
    let mut x_size: unsigned = PAGE_SIZE << 1;
    if (dio.payload_len > x_size) {
    let mut sectors: unsigned = ((x_size - extra_size) / ic.tuple_size) << ic.sb.log2_sectors_per_block;
...
//
    ...
    let mut bv: bio_vec = bio_iter_iovec(bio, dio.bio_details.bi_iter);
...
#[no_mangle]
pub unsafe extern "C" fn dm_integrity_free_payload(dio: *mut dm_integrity_io) {
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_inline_recheck(w: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_integrity_check(ic: *mut dm_integrity_c, dio: *mut dm_integrity_io) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_inline_async_check(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_end_io(ti: *mut dm_target, bio: *mut bio, status: *mut blk_status_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn integrity_bio_wait(w: *mut work_struct) {
    static void integrity_bio_wait(struct work_struct *w)
    {
    struct dm_integrity_io *dio = container_of(w, struct dm_integrity_io, work);
    struct dm_integrity_c *ic = dio.ic;
    if (ic.mode == 'I') {
    struct bio *bio = dm_bio_from_per_bio_data(dio, sizeof(struct dm_integrity_io));
    let mut r: c_int = dm_integrity_map_inline(dio, false);
    switch (r) {
    case DM_MAPIO_KILL:
...
#[no_mangle]
unsafe extern "C" fn pad_uncommitted(ic: *mut dm_integrity_c) {
...
#[no_mangle]
unsafe extern "C" fn integrity_commit(w: *mut work_struct) {
    ...
    flushes.bi_next = core::ptr::null_mut();
    do_endio(ic, flushes);
    flushes = next;
    }
    }
#[no_mangle]
unsafe extern "C" fn complete_copy_from_journal(error: c_ulong, unsup: c_ulong, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn integrity_writer(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn recalc_write_super(ic: *mut dm_integrity_c) {
...
#[no_mangle]
unsafe extern "C" fn integrity_recalc(w: *mut work_struct) {
    static void integrity_recalc(struct work_struct *w)
    {
    struct dm_integrity_c *ic = container_of(w, struct dm_integrity_c, recalc_work);
    size_t recalc_tags_size;
    u8 *recalc_buffer = core::ptr::null_mut();
    u8 *recalc_tags = core::ptr::null_mut();
    struct ahash_request *ahash_req = core::ptr::null_mut();
    struct dm_integrity_range range;
    struct dm_io_request io_req;
    struct dm_io_region io_loc;
    sector_t area, offset;
    ...
    unsigned int i;
    int r;
    let mut super_counter: c_uint = 0;
    let mut recalc_sectors: unsigned = RECALC_SECTORS;
    retry:
    ...
    if (!recalc_tags) {
    kfree(recalc_buffer);
    recalc_buffer = core::ptr::null_mut();
    goto oom;
    }
    ...
    let mut ptr_offset: unsigned = offset_in_page(ptr);
...
#[no_mangle]
unsafe extern "C" fn integrity_recalc_inline(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn bitmap_block_work(w: *mut work_struct) {
    ...
    BITMAP_BLOCK_SIZE >> SECTOR_SHIFT, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn bitmap_flush_work(work: *mut work_struct) {
...
// DEBUG_print("zeroing journal\n");
    ...
    ic.n_bitmap_blocks * (BITMAP_BLOCK_SIZE >> SECTOR_SHIFT), core::ptr::null_mut());
    spin_lock_irq(&ic.endio_wait.lock);
    remove_range_unlocked(ic, &range);
    while (unlikely((bio = bio_list_pop(&ic.synchronous_bios)) != core::ptr::null_mut())) {
    bio_endio(bio);
    spin_unlock_irq(&ic.endio_wait.lock);
    spin_lock_irq(&ic.endio_wait.lock);
    }
...
#[no_mangle]
unsafe extern "C" fn find_commit_seq(ic: *mut dm_integrity_c, i: c_uint, j: c_uint, id: commit_id_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn replay_journal(ic: *mut dm_integrity_c) {
    ...
    rw_journal(ic, REQ_OP_READ, 0, ic.journal_sections, core::ptr::null_mut());
    if (ic.journal_io)
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_enter_synchronous_mode(ic: *mut dm_integrity_c) {
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_reboot(n: *mut notifier_block, code: c_ulong, x: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_postsuspend(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_resume(ti: *mut dm_target) {
    static void dm_integrity_resume(struct dm_target *ti)
    {
    struct dm_integrity_c *ic = ti.private;
    let mut old_provided_data_sectors: __u64 = le64_to_cpu(ic.sb.provided_data_sectors);
    int r;
    __le32 flags;
    DEBUG_print("resume\n");
    ...
    if (ic.sb.flags & cpu_to_le32(SB_FLAG_RECALCULATING)) {
    let mut recalc_pos: __u64 = le64_to_cpu(ic.sb.recalc_sector);
    ...
    ic.reboot_notifier.next = core::ptr::null_mut();
...
// set to 1 to stress test synchronous mode
    ...
    if (ic.mode == 'J') {
    let mut watermark_percentage: __u64 = (__u64)(ic.journal_entries - ic.free_sectors_threshold) * 100;
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_io_hints(ti: *mut dm_target, limits: *mut queue_limits) {
...
#[no_mangle]
unsafe extern "C" fn calculate_journal_section_size(ic: *mut dm_integrity_c) {
    static void calculate_journal_section_size(struct dm_integrity_c *ic)
    {
    let mut sector_space: c_uint = JOURNAL_SECTOR_DATA;
...
#[no_mangle]
unsafe extern "C" fn calculate_device_limits(ic: *mut dm_integrity_c) -> c_int {
...
// we have to maintain excessive padding for compatibility with existing volumes
    ...
    let mut meta_size: __u64 = (ic.provided_data_sectors >> ic.sb.log2_sectors_per_block) * ic.tag_size;
...
#[no_mangle]
unsafe extern "C" fn get_provided_data_sectors(ic: *mut dm_integrity_c) {
    ...
    let mut prev_data_sectors: __u64 = ic.provided_data_sectors;
    ...
    let mut prev_journal_sections: __u32 = le32_to_cpu(ic.sb.journal_sections);
    let mut test_journal_sections: __u32 = prev_journal_sections | (1U << test_bit);
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_free_page_list(pl: *mut page_list) {
    ...
    pl[i].page = core::ptr::null_mut();
    pl[i].next = core::ptr::null_mut();
    return pl;
    }
#[no_mangle]
unsafe extern "C" fn dm_integrity_free_journal_scatterlist(ic: *mut dm_integrity_c, sl: *mut scatterlist) {
    ...
    let mut start: c_uint = 0, end = PAGE_SIZE;
    if (idx == start_index)
    start = start_offset;
    if (idx == end_index)
...
#[no_mangle]
unsafe extern "C" fn free_alg(a: *mut alg_spec) {
...
#[no_mangle]
unsafe extern "C" fn get_alg_and_key(arg: *const c_char, a: *mut alg_spec, error: *mut c_char, error_inval: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_journal(ic: *mut dm_integrity_c, error: *mut c_char) -> c_int {
    static int create_journal(struct dm_integrity_c *ic, char **error)
    {
    let mut r: c_int = 0;
    unsigned int i;
    __u64 journal_pages, journal_desc_size, journal_tree_size;
    unsigned char *crypt_data = core::ptr::null_mut(), *crypt_iv = core::ptr::null_mut();
...
// error = "Invalid journal cipher";
    ...
    ic.journal_crypt = core::ptr::null_mut();
    goto bad;
    }
    ivsize = crypto_skcipher_ivsize(ic.journal_crypt);
...
// error = "Unable to encrypt journal";
    ...
    let mut crypt_len: c_uint = roundup(ivsize, blocksize);
    req = skcipher_request_alloc(ic.journal_crypt, GFP_KERNEL);
    if (!req) {
// error = "Could not allocate crypt request";
    r = -ENOMEM;
...
// error = "Unable to allocate sk requests";
    ...
    let mut section_le: __le32 = cpu_to_le32(i);
...
//
#[no_mangle]
unsafe extern "C" fn dm_integrity_ctr(ti: *mut dm_target, argc: c_uint, argv: *mut c_char) -> c_int {
    ...
    let mut log2_sectors_per_bitmap_bit: __s8 = -1;
    __s8 log2_blocks_per_bitmap_bit;
    __u64 bits_in_journal;
    __u64 n_bitmap_bits;
pub const DIRECT_ARGUMENTS: c_int = 4;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sscanf(opt_string, _arg: "interleave_sectors:%u%c", _arg: &val, 1: &dummy) ==) -> else {
    else if (sscanf(opt_string, "interleave_sectors:%u%c", &val, &dummy) == 1)
    interleave_sectors = val;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sscanf(opt_string, _arg: "buffer_sectors:%u%c", _arg: &val, 1: &dummy) ==) -> else {
    else if (sscanf(opt_string, "buffer_sectors:%u%c", &val, &dummy) == 1)
    buffer_sectors = val;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sscanf(opt_string, _arg: "journal_watermark:%u%c", _arg: &val, 100: &dummy) == 1 && val <=) -> else {
    else if (sscanf(opt_string, "journal_watermark:%u%c", &val, &dummy) == 1 && val <= 100)
    journal_watermark = val;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sscanf(opt_string, _arg: "commit_time:%u%c", _arg: &val, 1: &dummy) ==) -> else {
    else if (sscanf(opt_string, "commit_time:%u%c", &val, &dummy) == 1)
    sync_msec = val;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(opt_string, _arg: "meta_device:", _arg: strlen("meta_device:"))) -> else {
    if (ic.meta_dev) {
    dm_put_device(ti, ic.meta_dev);
    ic.meta_dev = core::ptr::null_mut();
    }
    ...
    r = get_mac(&ic.journal_mac, core::ptr::null_mut(), &ic.journal_mac_alg, &ti.error,
...
//
    ...
    1U << (SECTOR_SHIFT + ic.log2_buffer_sectors), 1, 0, core::ptr::null_mut(), core::ptr::null_mut(), 0);
    if (IS_ERR(ic.bufio)) {
    r = PTR_ERR(ic.bufio);
    ti.error = "Cannot initialize dm-bufio";
    ic.bufio = core::ptr::null_mut();
    goto bad;
    }
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_dtr(ti: *mut dm_target) {
    static void dm_integrity_dtr(struct dm_target *ti)
    {
    struct dm_integrity_c *ic = ti.private;
    BUG_ON(!RB_EMPTY_ROOT(&ic.in_progress));
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_init() -> int __init {
    static int __init dm_integrity_init(void)
    {
    int r;
    journal_io_cache = kmem_cache_create("integrity_journal_io",
    sizeof(struct journal_io), 0, 0, core::ptr::null_mut());
    if (!journal_io_cache) {
...
#[no_mangle]
unsafe extern "C" fn dm_integrity_exit() -> void __exit {
