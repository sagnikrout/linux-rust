...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct convert_context {
    pub restart: completion,
    pub bio_in: *mut bio,
    pub iter_in: bvec_iter,
    pub bio_out: *mut bio,
    pub iter_out: bvec_iter,
    pub cc_pending: core::sync::atomic::AtomicI32,
    pub tag_offset: c_uint,
    pub cc_sector: u64,
    union {
    pub req: *mut skcipher_request,
    pub req_aead: *mut aead_request,
    pub r: },
    pub aead_recheck: bool,
    pub aead_failed: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_crypt_io {
    pub cc: *mut crypt_config,
    pub base_bio: *mut bio,
    pub integrity_metadata: *mut u8,
    pub integrity_metadata_from_pool:1: bool,
    pub work: work_struct,
    pub ctx: convert_context,
    pub io_pending: core::sync::atomic::AtomicI32,
    pub error: blk_status_t,
    pub sector: sector_t,
    pub saved_bi_iter: bvec_iter,
    pub rb_node: rb_node,
    pub CRYPTO_MINALIGN_ATTR: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_crypt_request {
    pub ctx: *mut convert_context,
    pub sg_in: [scatterlist; 4],
    pub sg_out: [scatterlist; 4],
    pub iv_sector: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct crypt_iv_operations {
    int (*ctr)(struct crypt_config *cc, struct dm_target *ti,
    pub opts): *const c_char,
    pub cc): *mut *mut void (dtr)(struct crypt_config,
    pub cc): *mut *mut int (init)(struct crypt_config,
    pub cc): *mut *mut void (wipe)(struct crypt_config,
    int (*generator)(struct crypt_config *cc, u8 *iv,
    pub dmreq): *mut dm_crypt_request,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iv_benbi_private {
    pub shift: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct iv_lmk_private {
    pub seed: *mut u8,
}

pub const TCW_WHITENING_SIZE: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iv_tcw_private {
    pub iv_seed: *mut u8,
    pub whitening: *mut u8,
}

pub const ELEPHANT_MAX_KEY_SIZE: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iv_elephant_private {
    pub key: *mut aes_enckey,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct crypt_config {
    pub dev: *mut dm_dev,
    pub start: sector_t,
    pub n_allocated_pages: percpu_counter,
    pub io_queue: *mut workqueue_struct,
    pub crypt_queue: *mut workqueue_struct,
    pub write_thread_lock: spinlock_t,
    pub write_thread: *mut task_struct,
    pub write_tree: rb_root,
    pub cipher_string: *mut c_char,
    pub cipher_auth: *mut c_char,
    pub key_string: *mut c_char,
    pub iv_gen_ops: *const crypt_iv_operations,
    union {
    pub benbi: iv_benbi_private,
    pub lmk: iv_lmk_private,
    pub tcw: iv_tcw_private,
    pub elephant: iv_elephant_private,
    pub iv_gen_private: },
    pub iv_offset: u64,
    pub iv_size: c_uint,
    pub sector_size: c_ushort,
    pub sector_shift: c_uchar,
    union {
    pub tfms: *mut crypto_skcipher,
    pub tfms_aead: *mut crypto_aead,
    pub cipher_tfm: },
    pub tfms_count: c_uint,
    pub workqueue_id: c_int,
    pub cipher_flags: c_ulong,
//
...
// correctly aligned.
//
    pub dmreq_start: c_uint,
    pub per_bio_data_size: c_uint,
    pub flags: c_ulong,
    pub key_size: c_uint,
    pub /: *mut *mut unsigned int key_parts; / independent parts in key buffer,
    pub /: *mut *mut unsigned int key_extra_size; / additional keys length,
    pub /: *mut *mut unsigned int key_mac_size; / MAC key size for authenc(...),
    pub integrity_tag_size: c_uint,
    pub integrity_iv_size: c_uint,
    pub used_tag_size: c_uint,
    pub tuple_size: c_uint,
//
// pool for per bio private data, crypto requests,
// encryption requeusts/buffer pages and integrity tags
//
    pub tag_pool_max_sectors: c_uint,
    pub tag_pool: mempool_t,
    pub req_pool: mempool_t,
    pub page_pool: mempool_t,
    pub bs: bio_set,
    pub bio_alloc_lock: mutex,
    pub /: *mut *mut *mut u8 authenc_key; / space for keys in authenc() format (if used),
    pub __counted_by(key_size): u8 key[],
}

pub const MIN_IOS: c_int = 64;
pub const MAX_TAG_SIZE: c_int = 480;
pub const POOL_ENTRY_SIZE: c_int = 512;
    static DEFINE_SPINLOCK(dm_crypt_clients_lock);
    static unsigned int dm_crypt_clients_n;
    static volatile unsigned long dm_crypt_pages_per_client;
pub const DM_CRYPT_MEMORY_PERCENT: c_int = 2;

pub const DM_CRYPT_DEFAULT_MAX_READ_SIZE: c_int = 131072;
pub const DM_CRYPT_DEFAULT_MAX_WRITE_SIZE: c_int = 131072;
    let mut max_read_size: static unsigned int = 0;
    module_param(max_read_size, uint, 0644);
    MODULE_PARM_DESC(max_read_size, "Maximum size of a read request");
    let mut max_write_size: static unsigned int = 0;
    module_param(max_write_size, uint, 0644);
    MODULE_PARM_DESC(max_write_size, "Maximum size of a write request");
#[no_mangle]
unsafe extern "C" fn get_max_request_sectors(ti: *mut dm_target, bio: *mut bio, no_split: bool) -> unsigned {
    static unsigned get_max_request_sectors(struct dm_target *ti, struct bio *bio, bool no_split)
    {
    struct crypt_config *cc = ti.private;
    unsigned val, sector_align;
    let mut wrt: bool = op_is_write(bio_op(bio));
    if (no_split) {
    val = -1;
    } else if (wrt) {
...
#[no_mangle]
unsafe extern "C" fn crypt_iv_benbi_dtr(cc: *mut crypt_config) {
...
#[no_mangle]
unsafe extern "C" fn crypt_iv_lmk_dtr(cc: *mut crypt_config) {
    static void crypt_iv_lmk_dtr(struct crypt_config *cc)
    {
    struct iv_lmk_private *lmk = &cc.iv_gen_private.lmk;
    kfree_sensitive(lmk.seed);
    lmk.seed = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn crypt_iv_lmk_init(cc: *mut crypt_config) -> c_int {
    static int crypt_iv_lmk_init(struct crypt_config *cc)
    {
    struct iv_lmk_private *lmk = &cc.iv_gen_private.lmk;
    let mut subkey_size: c_int = cc.key_size / cc.key_parts;
...
#[no_mangle]
unsafe extern "C" fn crypt_iv_lmk_wipe(cc: *mut crypt_config) {
...
#[no_mangle]
unsafe extern "C" fn crypt_iv_tcw_dtr(cc: *mut crypt_config) {
    static void crypt_iv_tcw_dtr(struct crypt_config *cc)
    {
    struct iv_tcw_private *tcw = &cc.iv_gen_private.tcw;
    kfree_sensitive(tcw.iv_seed);
    tcw.iv_seed = core::ptr::null_mut();
    kfree_sensitive(tcw.whitening);
    tcw.whitening = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn crypt_iv_tcw_init(cc: *mut crypt_config) -> c_int {
    static int crypt_iv_tcw_init(struct crypt_config *cc)
    {
    struct iv_tcw_private *tcw = &cc.iv_gen_private.tcw;
    let mut key_offset: c_int = cc.key_size - cc.iv_size - TCW_WHITENING_SIZE;
...
#[no_mangle]
unsafe extern "C" fn crypt_iv_tcw_wipe(cc: *mut crypt_config) {
    ...
    {
    struct iv_tcw_private *tcw = &cc.iv_gen_private.tcw;
    let mut sector: __le64 = cpu_to_le64(dmreq.iv_sector);
...
unsafe extern "C" fn crypt_iv_elephant_dtr(cc: *mut crypt_config) {
    ...
    if (!elephant.key)
    return -ENOMEM;
    r = crypt_iv_eboiv_ctr(cc, ti, core::ptr::null_mut());
    if (r)
    crypt_iv_elephant_dtr(cc);
    return r;
    }
#[no_mangle]
unsafe extern "C" fn diffuser_disk_to_cpu(d: *mut u32, n: usize) {
...
#[no_mangle]
unsafe extern "C" fn diffuser_cpu_to_disk(d: *mut __le32, n: usize) {
...
#[no_mangle]
unsafe extern "C" fn diffuser_a_decrypt(d: *mut u32, n: usize) {
...
#[no_mangle]
unsafe extern "C" fn diffuser_a_encrypt(d: *mut u32, n: usize) {
...
#[no_mangle]
unsafe extern "C" fn diffuser_b_decrypt(d: *mut u32, n: usize) {
...
#[no_mangle]
unsafe extern "C" fn diffuser_b_encrypt(d: *mut u32, n: usize) {
...
#[no_mangle]
unsafe extern "C" fn crypt_iv_elephant_init(cc: *mut crypt_config) -> c_int {
    static int crypt_iv_elephant_init(struct crypt_config *cc)
    {
    struct iv_elephant_private *elephant = &cc.iv_gen_private.elephant;
    let mut key_offset: c_int = cc.key_size - cc.key_extra_size;
    return aes_prepareenckey(elephant.key, &cc.key[key_offset], cc.key_extra_size);
    }
#[no_mangle]
unsafe extern "C" fn crypt_iv_elephant_wipe(cc: *mut crypt_config) {
...
//
#[no_mangle]
unsafe extern "C" fn crypt_integrity_aead(cc: *mut crypt_config) -> bool {
    static bool crypt_integrity_aead(struct crypt_config *cc)
    {
    return test_bit(CRYPT_MODE_INTEGRITY_AEAD, &cc.cipher_flags);
    }
#[no_mangle]
unsafe extern "C" fn crypt_integrity_hmac(cc: *mut crypt_config) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dm_crypt_integrity_io_alloc(io: *mut dm_crypt_io, bio: *mut bio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypt_integrity_ctr(cc: *mut crypt_config, ti: *mut dm_target) -> c_int {
...
// We require an underlying device with non-PI metadata
    ...
    {
    let mut bv_in: bio_vec = bio_iter_iovec(ctx.bio_in, ctx.iter_in);
    let mut bv_out: bio_vec = bio_iter_iovec(ctx.bio_out, ctx.iter_out);
    struct dm_crypt_request *dmreq;
...
// Working copy of IV, to be modified in crypto API
    ...
    if (r == -EBADMSG) {
    let mut s: sector_t = le64_to_cpu(*sector);
...
// Working copy of IV, to be modified in crypto API
    ...
    struct convert_context *ctx)
    {
    let mut key_index: c_uint = ctx.cc_sector & (cc.tfms_count - 1);
    if (!ctx.r.req) {
...
#[no_mangle]
unsafe extern "C" fn crypt_free_req(cc: *mut crypt_config, req: *mut c_void, base_bio: *mut bio) {
...
//
    ...
    {
    let mut sector_step: c_uint = cc.sector_size >> SECTOR_SHIFT;
    int r;
//
...
//
    ...
    struct bio *clone;
    let mut nr_iovecs: c_uint = (size + PAGE_SIZE - 1) >> PAGE_SHIFT;
    let mut gfp_mask: gfp_t = GFP_NOWAIT | __GFP_HIGHMEM;
    unsigned int remaining_size;
    let mut order: c_uint = MAX_PAGE_ORDER;
    retry:
    ...
    let mut remaining_order: unsigned = __fls((remaining_size + PAGE_SIZE - 1) >> PAGE_SHIFT);
    ...
    order);
    if (likely(pages != core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn crypt_free_buffer_pages(cc: *mut crypt_config, clone: *mut bio) {
    static void crypt_free_buffer_pages(struct crypt_config *cc, struct bio *clone)
    {
    ...
    io.ctx.r.req = core::ptr::null_mut();
    io.integrity_metadata = core::ptr::null_mut();
    io.integrity_metadata_from_pool = false;
    atomic_set(&io.io_pending, 0);
    }
#[no_mangle]
unsafe extern "C" fn crypt_inc_pending(io: *mut dm_crypt_io) {
...
//
#[no_mangle]
unsafe extern "C" fn crypt_dec_pending(io: *mut dm_crypt_io) {
...
//
#[no_mangle]
unsafe extern "C" fn crypt_endio(clone: *mut bio) {
    static void crypt_endio(struct bio *clone)
    {
    struct dm_crypt_io *io = clone.bi_private;
    struct crypt_config *cc = io.cc;
    let mut rw: c_uint = bio_data_dir(clone);
    let mut error: blk_status_t = clone.bi_status;
...
#[no_mangle]
unsafe extern "C" fn kcryptd_io_read(io: *mut dm_crypt_io, gfp: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kcryptd_io_read_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn kcryptd_queue_read(io: *mut dm_crypt_io) {
    static void kcryptd_queue_read(struct dm_crypt_io *io)
    {
    struct crypt_config *cc = io.cc;
...
#[no_mangle]
unsafe extern "C" fn kcryptd_io_write(io: *mut dm_crypt_io) {
...
#[no_mangle]
unsafe extern "C" fn dmcrypt_write(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kcryptd_crypt_write_io_submit(io: *mut dm_crypt_io, async: c_int) {
...
#[no_mangle]
unsafe extern "C" fn kcryptd_crypt_write_continue(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn kcryptd_crypt_write_convert(io: *mut dm_crypt_io) {
...
//
    crypt_inc_pending(io);
    crypt_convert_init(cc, ctx, core::ptr::null_mut(), io.base_bio, io.sector);
    clone = crypt_alloc_buffer(io, io.base_bio.bi_iter.bi_size);
    if (unlikely(!clone)) {
...
#[no_mangle]
unsafe extern "C" fn kcryptd_crypt_read_done(io: *mut dm_crypt_io) {
...
#[no_mangle]
unsafe extern "C" fn kcryptd_crypt_read_continue(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn kcryptd_crypt_read_convert(io: *mut dm_crypt_io) {
...
#[no_mangle]
unsafe extern "C" fn kcryptd_async_done(data: *mut c_void, error: c_int) {
...
//
    ...
    if (error == -EBADMSG) {
    let mut s: sector_t = le64_to_cpu(*org_sector_of_dmreq(cc, dmreq));
    ctx.aead_failed = true;
    if (ctx.aead_recheck) {
    DMERR_LIMIT("%pg: INTEGRITY AEAD ERROR, sector %llu",
    ctx.bio_in.bi_bdev, s);
...
#[no_mangle]
unsafe extern "C" fn kcryptd_crypt(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn kcryptd_queue_crypt(io: *mut dm_crypt_io) {
    static void kcryptd_queue_crypt(struct dm_crypt_io *io)
    {
    struct crypt_config *cc = io.cc;
...
#[no_mangle]
unsafe extern "C" fn crypt_free_tfms_aead(cc: *mut crypt_config) {
    ...
    cc.cipher_tfm.tfms_aead[0] = core::ptr::null_mut();
    }
    kfree(cc.cipher_tfm.tfms_aead);
    cc.cipher_tfm.tfms_aead = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn crypt_free_tfms_skcipher(cc: *mut crypt_config) {
    ...
    cc.cipher_tfm.tfms[i] = core::ptr::null_mut();
    }
    kfree(cc.cipher_tfm.tfms);
    cc.cipher_tfm.tfms = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn crypt_free_tfms(cc: *mut crypt_config) {
...
#[no_mangle]
unsafe extern "C" fn crypt_alloc_tfms_skcipher(cc: *mut crypt_config, ciphermode: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypt_alloc_tfms_aead(cc: *mut crypt_config, ciphermode: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypt_alloc_tfms(cc: *mut crypt_config, ciphermode: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypt_subkey_size(cc: *mut crypt_config) -> c_uint {
    static unsigned int crypt_subkey_size(struct crypt_config *cc)
    {
    return (cc.key_size - cc.key_extra_size) >> ilog2(cc.tfms_count);
    }
#[no_mangle]
unsafe extern "C" fn crypt_authenckey_size(cc: *mut crypt_config) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn crypt_setkey(cc: *mut crypt_config) -> c_int {
    static int crypt_setkey(struct crypt_config *cc)
    {
    unsigned int subkey_size;
    let mut err: c_int = 0, i, r;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: crypt_integrity_aead(cc)) -> else {
...
#[no_mangle]
unsafe extern "C" fn contains_whitespace(str: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn set_key_user(cc: *mut crypt_config, key: *mut key) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_key_encrypted(cc: *mut crypt_config, key: *mut key) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_key_trusted(cc: *mut crypt_config, key: *mut key) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypt_set_keyring_key(cc: *mut crypt_config, key_string: *const c_char) -> c_int {
...
// look for next ':' separating key_type from key_description
    ...
    if (!new_key_string)
    return -ENOMEM;
    key = request_key(type, key_desc + 1, core::ptr::null_mut());
    if (IS_ERR(key)) {
    ret = PTR_ERR(key);
...
#[no_mangle]
unsafe extern "C" fn get_key_size(key_string: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypt_set_key(cc: *mut crypt_config, key: *mut c_char) -> c_int {
    static int crypt_set_key(struct crypt_config *cc, char *key)
    {
    let mut r: c_int = -EINVAL;
    let mut key_string_len: c_int = strlen(key);
...
// wipe references to any kernel keyring key
    kfree_sensitive(cc.key_string);
    cc.key_string = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn crypt_wipe_key(cc: *mut crypt_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypt_calculate_pages_per_client() {
    static void crypt_calculate_pages_per_client(void)
    {
    let mut pages: c_ulong = (totalram_pages() - totalhigh_pages()) * DM_CRYPT_MEMORY_PERCENT / 100;
...
//
    ...
    if (likely(page != core::ptr::null_mut()))
    percpu_counter_add(&cc.n_allocated_pages, 1);
    return page;
    }
#[no_mangle]
unsafe extern "C" fn crypt_page_free(page: *mut c_void, pool_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn crypt_dtr(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn crypt_ctr_ivmode(ti: *mut dm_target, ivmode: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ivmode) -> else {
    DMWARN("Selected cipher does not support IVs");
    ivmode = core::ptr::null_mut();
    }
// Choose ivmode, see comments at iv code.
    if (ivmode == core::ptr::null_mut())
    cc.iv_gen_ops = core::ptr::null_mut();
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(ivmode, 0: "plain") ==) -> else {
    else if (strcmp(ivmode, "plain") == 0)
    cc.iv_gen_ops = &crypt_iv_plain_ops;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(ivmode, 0: "plain64") ==) -> else {
    else if (strcmp(ivmode, "plain64") == 0)
    cc.iv_gen_ops = &crypt_iv_plain64_ops;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(ivmode, 0: "plain64be") ==) -> else {
    else if (strcmp(ivmode, "plain64be") == 0)
    cc.iv_gen_ops = &crypt_iv_plain64be_ops;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(ivmode, 0: "essiv") ==) -> else {
    else if (strcmp(ivmode, "essiv") == 0)
    cc.iv_gen_ops = &crypt_iv_essiv_ops;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(ivmode, 0: "benbi") ==) -> else {
    else if (strcmp(ivmode, "benbi") == 0)
    cc.iv_gen_ops = &crypt_iv_benbi_ops;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(ivmode, 0: "null") ==) -> else {
    else if (strcmp(ivmode, "null") == 0)
    cc.iv_gen_ops = &crypt_iv_null_ops;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(ivmode, 0: "eboiv") ==) -> else {
    else if (strcmp(ivmode, "eboiv") == 0)
    cc.iv_gen_ops = &crypt_iv_eboiv_ops;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(ivmode, 0: "elephant") ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn crypt_ctr_auth_cipher(cc: *mut crypt_config, cipher_api: *mut c_char) -> c_int {
    static int crypt_ctr_auth_cipher(struct crypt_config *cc, char *cipher_api)
    {
    char *start, *end, *mac_alg = core::ptr::null_mut();
...
// Allocate cipher
    ...
    char *cipher_api = core::ptr::null_mut();
    let mut ret: c_int = -EINVAL;
    char dummy;
...
#[no_mangle]
unsafe extern "C" fn crypt_ctr_cipher(ti: *mut dm_target, cipher_in: *mut c_char, key: *mut c_char) -> c_int {
    static int crypt_ctr_cipher(struct dm_target *ti, char *cipher_in, char *key)
    {
    struct crypt_config *cc = ti.private;
    char *ivmode = core::ptr::null_mut(), *ivopts = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn crypt_ctr_optional(ti: *mut dm_target, argc: c_uint, argv: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(opt_string, _arg: "same_cpu_crypt")) -> else {
    else if (!strcasecmp(opt_string, "same_cpu_crypt"))
    set_bit(DM_CRYPT_SAME_CPU, &cc.flags);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(opt_string, _arg: "high_priority")) -> else {
    else if (!strcasecmp(opt_string, "high_priority"))
    set_bit(DM_CRYPT_HIGH_PRIORITY, &cc.flags);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(opt_string, _arg: "submit_from_crypt_cpus")) -> else {
    else if (!strcasecmp(opt_string, "submit_from_crypt_cpus"))
    set_bit(DM_CRYPT_NO_OFFLOAD, &cc.flags);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(opt_string, _arg: "no_read_workqueue")) -> else {
    else if (!strcasecmp(opt_string, "no_read_workqueue"))
    set_bit(DM_CRYPT_NO_READ_WORKQUEUE, &cc.flags);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(opt_string, _arg: "no_write_workqueue")) -> else {
    else if (!strcasecmp(opt_string, "no_write_workqueue"))
    set_bit(DM_CRYPT_NO_WRITE_WORKQUEUE, &cc.flags);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sscanf(opt_string, _arg: "integrity:%u:", 1: &val) ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn crypt_ctr(ti: *mut dm_target, argc: c_uint, argv: *mut c_char) -> c_int {
...
//
    ...
    cc.write_thread = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn crypt_map(ti: *mut dm_target, bio: *mut bio) -> c_int {
...
//
    ...
    if (cc.tuple_size) {
    let mut tag_len: c_uint = cc.tuple_size * (bio_sectors(bio) >> cc.sector_shift);
...
#[no_mangle]
unsafe extern "C" fn hex2asc(c: c_uchar) -> c_char {
...
#[no_mangle]
unsafe extern "C" fn crypt_postsuspend(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn crypt_preresume(ti: *mut dm_target) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypt_resume(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn crypt_io_hints(ti: *mut dm_target, limits: *mut queue_limits) {
