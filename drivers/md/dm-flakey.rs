...
pub const PROBABILITY_BASE: c_int = 1000000000;
...
pub struct flakey_c {
    ...
    pub start: sector_t,
    pub up_interval: c_uint,
    pub down_interval: c_uint,
    pub flags: c_ulong,
    pub corrupt_bio_byte: c_uint,
    pub corrupt_bio_rw: c_uint,
    pub corrupt_bio_value: c_uint,
    pub corrupt_bio_flags: blk_opf_t,
    pub random_read_corrupt: c_uint,
    pub random_write_corrupt: c_uint,
}
...
#[no_mangle]
pub unsafe extern "C" fn if(!strcasecmp(arg_name: arg_name &&, _arg: "r")) -> else {
...
//
    ...
    ( unsigned int *)&fc.corrupt_bio_flags,
    &ti.error);
    if (r)
    return r;
    argc--;
...
//
#[no_mangle]
unsafe extern "C" fn flakey_ctr(ti: *mut dm_target, argc: c_uint, argv: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flakey_dtr(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn flakey_map_sector(ti: *mut dm_target, bi_sector: sector_t) -> sector_t {
...
#[no_mangle]
unsafe extern "C" fn flakey_map_bio(ti: *mut dm_target, bio: *mut bio) {
...
//
    ...
    struct bvec_iter start)
    {
    let mut corrupt_bio_byte: c_uint = fc.corrupt_bio_byte - 1;
    corrupt_bio_common(bio, corrupt_bio_byte, fc.corrupt_bio_value, start);
    }
#[no_mangle]
unsafe extern "C" fn corrupt_bio_random(bio: *mut bio, start: bvec_iter) {
...
#[no_mangle]
unsafe extern "C" fn clone_free(clone: *mut bio) {
...
#[no_mangle]
unsafe extern "C" fn clone_endio(clone: *mut bio) {
    ...
    let mut iter: bvec_iter = bio.bi_iter;
    ...
    to_copy = size_to_add;
    do {
    let mut bvec: bio_vec = bvec_iter_bvec(bio.bi_io_vec, iter);
    let mut this_step: unsigned = min(bvec.bv_len, to_copy);
...
#[no_mangle]
unsafe extern "C" fn flakey_map(ti: *mut dm_target, bio: *mut bio) -> c_int {
...
//
    ...
    if (fc.random_write_corrupt) {
    let mut rnd: u64 = get_random_u64();
    let mut rem: u32 = do_div(rnd, PROBABILITY_BASE);
...
//
    ...
    DMEMIT(" drop_writes");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: error_writes) -> else {
...
#[no_mangle]
unsafe extern "C" fn flakey_iterate_devices(ti: *mut dm_target, fn: iterate_devices_callout_fn, data: *mut c_void) -> c_int {
