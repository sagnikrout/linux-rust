...
//
pub const RT_FLAG_RS_PRERESUMED: c_int = 0;
pub const RT_FLAG_RS_RESUMED: c_int = 1;
pub const RT_FLAG_RS_BITMAP_LOADED: c_int = 2;
pub const RT_FLAG_UPDATE_SBS: c_int = 3;
pub const RT_FLAG_RESHAPE_RS: c_int = 4;
pub const RT_FLAG_RS_SUSPENDED: c_int = 5;
pub const RT_FLAG_RS_IN_SYNC: c_int = 6;
pub const RT_FLAG_RS_RESYNCING: c_int = 7;
pub const RT_FLAG_RS_GROW: c_int = 8;
pub const RT_FLAG_RS_FROZEN: c_int = 9;
...
pub struct raid_set {
    ...
    pub stripe_cache_entries: u32,
    pub ctr_flags: c_ulong,
    pub runtime_flags: c_ulong,
    pub rebuild_disks: [u64; DISKS_ARRAY_ELEMS],
    pub raid_disks: c_int,
    pub delta_disks: c_int,
    pub data_offset: c_int,
    pub raid10_copies: c_int,
    pub requested_bitmap_chunk_sectors: c_int,
    pub md: mddev,
    pub raid_type: *mut raid_type,
    pub array_sectors: sector_t,
    pub dev_sectors: sector_t,
// Optional raid4/5/6 journal device
#[repr(C)]
#[derive(Copy, Clone)]
pub struct journal_dev {
    pub dev: *mut dm_dev,
    pub rdev: md_rdev,
    pub mode: c_int,
    pub journal_dev: },
    pub __counted_by(raid_disks): raid_dev dev[],
}

#[no_mangle]
unsafe extern "C" fn rs_config_backup(rs: *mut raid_set, l: *mut rs_layout) {
...
#[no_mangle]
unsafe extern "C" fn rs_config_restore(rs: *mut raid_set, l: *mut rs_layout) {
...
pub const ALGORITHM_RAID10_DEFAULT: c_int = 0;
pub const ALGORITHM_RAID10_NEAR: c_int = 1;
pub const ALGORITHM_RAID10_OFFSET: c_int = 2;
pub const ALGORITHM_RAID10_FAR: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn __within_range(v: c_long, min: c_long, max: c_long) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dm_raid_journal_mode_to_md(mode: *const c_char) -> c_int {
    static int dm_raid_journal_mode_to_md(const char *mode)
    {
    let mut m: c_int = ARRAY_SIZE(_raid456_journal_mode);
    while (m--)
...
#[no_mangle]
unsafe extern "C" fn rs_is_raid0(rs: *mut raid_set) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rs_is_raid1(rs: *mut raid_set) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rs_is_raid10(rs: *mut raid_set) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rs_is_raid6(rs: *mut raid_set) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rs_is_raid456(rs: *mut raid_set) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rs_is_reshapable(rs: *mut raid_set) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rs_is_recovering(rs: *mut raid_set) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rs_is_reshaping(rs: *mut raid_set) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt_is_raid0(rt: *mut raid_type) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt_is_raid1(rt: *mut raid_type) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt_is_raid10(rt: *mut raid_type) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt_is_raid45(rt: *mut raid_type) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt_is_raid6(rt: *mut raid_type) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt_is_raid456(rt: *mut raid_type) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __valid_flags(rs: *mut raid_set) -> c_ulong {
    static unsigned long __valid_flags(struct raid_set *rs)
    {
    if (rt_is_raid0(rs.raid_type))
    return RAID0_VALID_FLAGS;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rt_is_raid1(rs->raid_type)) -> else {
    else if (rt_is_raid1(rs.raid_type))
    return RAID1_VALID_FLAGS;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rt_is_raid10(rs->raid_type)) -> else {
    else if (rt_is_raid10(rs.raid_type))
    return RAID10_VALID_FLAGS;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rt_is_raid45(rs->raid_type)) -> else {
    else if (rt_is_raid45(rs.raid_type))
    return RAID45_VALID_FLAGS;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rt_is_raid6(rs->raid_type)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn rs_check_for_valid_flags(rs: *mut raid_set) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __raid10_near_copies(layout: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn __raid10_far_copies(layout: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn __is_raid10_offset(layout: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __is_raid10_near(layout: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __is_raid10_far(layout: c_int) -> bool {
    static bool __is_raid10_far(int layout)
    {
...
#[no_mangle]
unsafe extern "C" fn raid10_name_to_format(name: *const c_char) -> c_int {
    static int raid10_name_to_format(const char *name)
    {
    if (!strcasecmp(name, "near"))
    return ALGORITHM_RAID10_NEAR;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(name, _arg: "offset")) -> else {
    else if (!strcasecmp(name, "offset"))
    return ALGORITHM_RAID10_OFFSET;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(name, _arg: "far")) -> else {
...
#[no_mangle]
unsafe extern "C" fn raid10_md_layout_to_copies(layout: c_int) -> c_uint {
...
//
    ...
    n = copies;
#[no_mangle]
pub unsafe extern "C" fn if(ALGORITHM_RAID10_OFFSET: algorithm ==) -> else {
    f = copies;
    r = RAID10_OFFSET;
...
#[no_mangle]
unsafe extern "C" fn __got_raid10(rtp: *mut raid_type, layout: c_int) -> bool {
...
// Adjust rdev sectors
#[no_mangle]
unsafe extern "C" fn rs_set_rdev_sectors(rs: *mut raid_set) {
...
//
#[no_mangle]
unsafe extern "C" fn rs_set_capacity(rs: *mut raid_set) {
...
//
#[no_mangle]
unsafe extern "C" fn rs_set_cur(rs: *mut raid_set) {
...
//
#[no_mangle]
unsafe extern "C" fn rs_set_new(rs: *mut raid_set) {
...
#[no_mangle]
unsafe extern "C" fn raid_set_free(rs: *mut raid_set) {
...
//
#[no_mangle]
unsafe extern "C" fn parse_dev_params(rs: *mut raid_set, as: *mut dm_arg_set) -> c_int {
    static int parse_dev_params(struct raid_set *rs, struct dm_arg_set *as)
    {
    int i;
    let mut rebuild: c_int = 0;
    let mut metadata_available: c_int = 0;
    let mut r: c_int = 0;
    const char *arg;
// Put off the number of raid devices argument to get to dev pairs
    ...
    rs.dev[i].meta_dev = core::ptr::null_mut();
    rs.dev[i].data_dev = core::ptr::null_mut();
//
...
//
#[no_mangle]
unsafe extern "C" fn validate_region_size(rs: *mut raid_set, region_size: c_ulong) -> c_int {
    static int validate_region_size(struct raid_set *rs, unsigned long region_size)
    {
    let mut min_region_size: c_ulong = rs.ti.len / (1 << 21);
    if (rs_is_raid0(rs))
    return 0;
    if (!region_size) {
//
...
//
#[no_mangle]
unsafe extern "C" fn validate_raid_redundancy(rs: *mut raid_set) -> c_int {
    static int validate_raid_redundancy(struct raid_set *rs)
    {
    unsigned int i, rebuild_cnt = 0;
    let mut rebuilds_per_group: c_uint = 0, copies, raid_disks;
...
//
    ...
    let mut raid10_copies: c_uint = 2;
    unsigned int i, write_mostly = 0;
    let mut region_size: c_uint = 0;
    sector_t max_io_len;
    const char *arg, *key;
    struct raid_dev *rd;
...
#[no_mangle]
unsafe extern "C" fn rs_set_raid456_stripe_cache(rs: *mut raid_set) -> c_int {
    static int rs_set_raid456_stripe_cache(struct raid_set *rs)
    {
    int r;
    struct r5conf *conf;
    struct mddev *mddev = &rs.md;
    let mut min_stripes: u32 = max(mddev.chunk_sectors, mddev.new_chunk_sectors) / 2;
    let mut nr_stripes: u32 = rs.stripe_cache_entries;
...
#[no_mangle]
unsafe extern "C" fn mddev_data_stripes(rs: *mut raid_set) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rs_data_stripes(rs: *mut raid_set) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn __rdev_sectors(rs: *mut raid_set) -> sector_t {
...
#[no_mangle]
unsafe extern "C" fn _check_data_dev_sectors(rs: *mut raid_set) -> c_int {
    static int _check_data_dev_sectors(struct raid_set *rs)
    {
    let mut ds: sector_t = ~0;
    struct md_rdev *rdev;
...
#[no_mangle]
unsafe extern "C" fn _get_reshape_sectors(rs: *mut raid_set) -> sector_t {
    static sector_t _get_reshape_sectors(struct raid_set *rs)
    {
    struct md_rdev *rdev;
    let mut reshape_sectors: sector_t = 0;
    rdev_for_each(rdev, &rs.md)
    if (!test_bit(Journal, &rdev.flags)) {
...
#[no_mangle]
unsafe extern "C" fn rs_set_dev_and_array_sectors(rs: *mut raid_set, sectors: sector_t, use_mddev: bool) -> c_int {
    static int rs_set_dev_and_array_sectors(struct raid_set *rs, sector_t sectors, bool use_mddev)
    {
    int delta_disks;
    unsigned int data_stripes;
    let mut array_sectors: sector_t = sectors, dev_sectors = sectors;
    struct mddev *mddev = &rs.md;
    if (use_mddev) {
...
#[no_mangle]
unsafe extern "C" fn rs_setup_recovery(rs: *mut raid_set, dev_sectors: sector_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rs_is_raid6(rs)) -> else {
...
#[no_mangle]
unsafe extern "C" fn do_table_event(ws: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn rs_check_takeover(rs: *mut raid_set) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rs_takeover_requested(rs: *mut raid_set) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rs_is_layout_change(rs: *mut raid_set, use_mddev: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rs_reshape_requested(rs: *mut raid_set) -> bool {
...
// Features
pub const FEATURE_FLAG_SUPPORTS_V190: c_uint = 0x1 /* Supports extended superblock */;
// State flags for sb->flags
pub const SB_FLAG_RESHAPE_ACTIVE: c_uint = 0x1;
pub const SB_FLAG_RESHAPE_BACKWARDS: c_uint = 0x2;
//
// This structure is never routinely used by userspace, unlike md superblocks.
// Devices with this superblock should only ever be accessed via device-mapper.
//
pub const DM_RAID_MAGIC: c_uint = 0x64526D44;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_raid_superblock {
    pub /: *mut *mut __le32 magic; / "DmRd",
    pub /: *mut *mut __le32 compat_features; / Used to indicate compatible features (like 1.9.0 ondisk metadata extension),
    pub /: *mut *mut __le32 num_devices; / Number of devices in this raid set. (Max 64),
    pub /: *mut *mut __le32 array_position; / The position of this drive in the raid set,
    pub /: *mut *mut __le64 events; / Incremented by md when superblock updated,
    pub /: *mut *mut __le64 failed_devices; / Pre 1.9.0 part of bit field of devices to,
// indicate failures (see extension below)
//
// This offset tracks the progress of the repair or replacement of
// an individual drive.
//
    pub disk_recovery_offset: __le64,
//
// This offset tracks the progress of the initial raid set
// synchronisation/parity calculation.
//
    pub array_resync_offset: __le64,
//
// raid characteristics
//
    pub level: __le32,
    pub layout: __le32,
    pub stripe_sectors: __le32,
//
// BELOW FOLLOW V1.9.0 EXTENSIONS TO THE PRISTINE SUPERBLOCK FORMAT!!!
//
// FEATURE_FLAG_SUPPORTS_V190 in the compat_features member indicates that those exist
//
    pub /: *mut *mut __le32 flags; / Flags defining array states for reshaping,
//
// This offset tracks the progress of a raid
// set reshape in order to be able to restart it
//
    pub reshape_position: __le64,
//
// These define the properties of the array in case of an interrupted reshape
//
    pub new_level: __le32,
    pub new_layout: __le32,
    pub new_stripe_sectors: __le32,
    pub delta_disks: __le32,
    pub /: *mut *mut __le64 array_sectors; / Array size in sectors,
//
...
//
    pub data_offset: __le64,
    pub new_data_offset: __le64,
    pub /: *mut *mut __le64 sectors; / Used device size in sectors,
//
// Additional Bit field of devices indicating failures to support
// up to 256 devices with the 1.9.0 on-disk metadata format
//
    pub 1]: __le64 extended_failed_devices[DISKS_ARRAY_ELEMS -,
    pub /: *mut *mut __le32 incompat_features; / Used to indicate any incompatible features,
...
//
#[no_mangle]
unsafe extern "C" fn rs_check_reshape(rs: *mut raid_set) -> c_int {
    static int rs_check_reshape(struct raid_set *rs)
    {
    pub &rs->md: *mut *mut mddev mddev =,
    if (!mddev.pers || !mddev.pers.check_reshape)
    pub supported": rs->ti->error = "Reshape not,
#[no_mangle]
pub unsafe extern "C" fn if(_arg: mddev->degraded) -> else {
    else if (mddev.degraded)
    pub set": rs->ti->error = "Can't reshape degraded raid,
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rs_is_recovering(rs)) -> else {
    else if (rs_is_recovering(rs))
    pub prohibited": rs->ti->error = "Convert request on recovering raid set,
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rs_is_reshaping(rs)) -> else {
    else if (rs_is_reshaping(rs))
    pub reshaping!": rs->ti->error = "raid set already,
#[no_mangle]
pub unsafe extern "C" fn if(rs_is_raid456(rs)): !(rs_is_raid1(rs) || rs_is_raid10(rs) ||) -> else {
    else if (!(rs_is_raid1(rs) || rs_is_raid10(rs) || rs_is_raid456(rs)))
    pub raid1/4/5/6/10": rs->ti->error = "Reshaping only supported for,
    else
    pub 0: return,
    pub -EPERM: return,
    }
#[no_mangle]
unsafe extern "C" fn read_disk_sb(rdev: *mut md_rdev, size: c_int, force_reload: bool) -> c_int {
    static int read_disk_sb(struct md_rdev *rdev, int size, bool force_reload)
    {
    if (rdev.sb_loaded && !force_reload)
    pub 0: return,
    pub 0: rdev->sb_loaded =,
    if (!sync_page_io(rdev, 0, size, rdev.sb_page, REQ_OP_READ, true)) {
    DMERR("Failed to read superblock of device at position %d",
    pub rdev): md_error(rdev->mddev,,
    pub &rdev->flags): set_bit(Faulty,,
    pub -EIO: return,
    }
    pub 1: rdev->sb_loaded =,
    pub 0: return,
    }
#[no_mangle]
unsafe extern "C" fn sb_retrieve_failed_devices(sb: *mut dm_raid_superblock, failed_devices: *mut u64) {
    static void sb_retrieve_failed_devices(struct dm_raid_superblock *sb, uint64_t *failed_devices)
    {
    pub le64_to_cpu(sb->failed_devices): failed_devices[0] =,
    pub sizeof(sb->extended_failed_devices)): memset(failed_devices + 1, 0,,
    if (le32_to_cpu(sb.compat_features) & FEATURE_FLAG_SUPPORTS_V190) {
    pub ARRAY_SIZE(sb->extended_failed_devices): int i =,
    while (i--)
    pub le64_to_cpu(sb->extended_failed_devices[i]): failed_devices[i+1] =,
    }
    }
#[no_mangle]
unsafe extern "C" fn sb_update_failed_devices(sb: *mut dm_raid_superblock, failed_devices: *mut u64) {
    static void sb_update_failed_devices(struct dm_raid_superblock *sb, uint64_t *failed_devices)
    {
    pub ARRAY_SIZE(sb->extended_failed_devices): int i =,
    pub cpu_to_le64(failed_devices[0]): sb->failed_devices =,
    while (i--)
    pub cpu_to_le64(failed_devices[i+1]): sb->extended_failed_devices[i] =,
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn super_sync(mddev: *mut mddev, rdev: *mut md_rdev) {
    static void super_sync(struct mddev *mddev, struct md_rdev *rdev)
    {
    pub false: bool update_failed_devices =,
    pub i: c_uint,
    pub failed_devices: [u64; DISKS_ARRAY_ELEMS],
    pub sb: *mut dm_raid_superblock,
    pub md): *mut *mut raid_set rs = container_of(mddev, raid_set,,
// No metadata device, no superblock
    if (!rdev.meta_bdev)
    pub page_address(rdev->sb_page): sb =,
    pub failed_devices): sb_retrieve_failed_devices(sb,,
    pub i++): for (i = 0; i < rs->raid_disks;,
    if (!rs.dev[i].data_dev || test_bit(Faulty, &rs.dev[i].rdev.flags)) {
    pub true: update_failed_devices =,
    pub failed_devices): *mut *mut set_bit(i, (void ),
    }
    if (update_failed_devices)
    pub failed_devices): sb_update_failed_devices(sb,,
    pub cpu_to_le32(DM_RAID_MAGIC): sb->magic =,
    pub cpu_to_le32(FEATURE_FLAG_SUPPORTS_V190): sb->compat_features =,
    pub cpu_to_le32(mddev->raid_disks): sb->num_devices =,
    pub cpu_to_le32(rdev->raid_disk): sb->array_position =,
    pub cpu_to_le64(mddev->events): sb->events =,
    pub cpu_to_le64(rdev->recovery_offset): sb->disk_recovery_offset =,
    pub cpu_to_le64(mddev->resync_offset): sb->array_resync_offset =,
    pub cpu_to_le32(mddev->level): sb->level =,
    pub cpu_to_le32(mddev->layout): sb->layout =,
    pub cpu_to_le32(mddev->chunk_sectors): sb->stripe_sectors =,
//
// BELOW FOLLOW V1.9.0 EXTENSIONS TO THE PRISTINE SUPERBLOCK FORMAT!!!
//
// FEATURE_FLAG_SUPPORTS_V190 in the compat_features member indicates that those exist
//
    pub cpu_to_le32(mddev->new_level): sb->new_level =,
    pub cpu_to_le32(mddev->new_layout): sb->new_layout =,
    pub cpu_to_le32(mddev->new_chunk_sectors): sb->new_stripe_sectors =,
    pub cpu_to_le32(mddev->delta_disks): sb->delta_disks =,
    pub /: *mut *mut smp_rmb(); / Make sure we access most recent reshape position,
    pub cpu_to_le64(mddev->reshape_position): sb->reshape_position =,
    if (le64_to_cpu(sb.reshape_position) != MaxSector) {
// Flag ongoing reshape
    pub cpu_to_le32(SB_FLAG_RESHAPE_ACTIVE): sb->flags |=,
    if (mddev.delta_disks < 0 || mddev.reshape_backwards)
    pub cpu_to_le32(SB_FLAG_RESHAPE_BACKWARDS): sb->flags |=,
    } else {
// Clear reshape flags
    pub ~(cpu_to_le32(SB_FLAG_RESHAPE_ACTIVE|SB_FLAG_RESHAPE_BACKWARDS)): sb->flags &=,
    }
    pub cpu_to_le64(mddev->array_sectors): sb->array_sectors =,
    pub cpu_to_le64(rdev->data_offset): sb->data_offset =,
    pub cpu_to_le64(rdev->new_data_offset): sb->new_data_offset =,
    pub cpu_to_le64(rdev->sectors): sb->sectors =,
    pub cpu_to_le32(0): sb->incompat_features =,
// Zero out the rest of the payload after the size of the superblock
    pub sizeof(*sb)): *mut memset(sb + 1, 0, rdev->sb_size -,
    }
//
// super_load
//
...
//
#[no_mangle]
unsafe extern "C" fn super_load(rdev: *mut md_rdev, refdev: *mut md_rdev) -> c_int {
    static int super_load(struct md_rdev *rdev, struct md_rdev *refdev)
    {
    pub r: c_int,
    pub sb: *mut dm_raid_superblock,
    pub refsb: *mut dm_raid_superblock,
    pub events_refsb: uint64_t events_sb,,
    pub false): r = read_disk_sb(rdev, rdev->sb_size,,
    if (r)
    pub r: return,
    pub page_address(rdev->sb_page): sb =,
//
...
//
    ...
    pub rdev): super_sync(rdev->mddev,,
    pub &rdev->flags): set_bit(FirstUse,,
    pub cpu_to_le32(FEATURE_FLAG_SUPPORTS_V190): sb->compat_features =,
// Force writing of superblocks to disk
    pub &rdev->mddev->sb_flags): set_bit(MD_SB_CHANGE_DEVS,,
// Any superblock is better than none, choose that if given
    pub 1: return refdev ? 0 :,
    }
    if (!refdev)
    pub 1: return,
    pub le64_to_cpu(sb->events): events_sb =,
    pub page_address(refdev->sb_page): refsb =,
    pub le64_to_cpu(refsb->events): events_refsb =,
    pub 0: return (events_sb > events_refsb) ? 1 :,
    }
#[no_mangle]
unsafe extern "C" fn super_init_validation(rs: *mut raid_set, rdev: *mut md_rdev) -> c_int {
    ...
    pub failed_devices: [u64; DISKS_ARRAY_ELEMS],
    pub sb: *mut dm_raid_superblock,
    pub 0: uint32_t new_devs = 0, rebuild_and_new = 0, rebuilds =,
    pub r: *mut md_rdev,
    pub sb2: *mut dm_raid_superblock,
    pub page_address(rdev->sb_page): sb =,
    pub le64_to_cpu(sb->events): events_sb =,
//
// Initialise to 1 if this is a new superblock.
//
    pub 1: mddev->events = events_sb ? :,
    pub MaxSector: mddev->reshape_position =,
    pub le32_to_cpu(sb->num_devices): mddev->raid_disks =,
    pub le32_to_cpu(sb->level): mddev->level =,
    pub le32_to_cpu(sb->layout): mddev->layout =,
    pub le32_to_cpu(sb->stripe_sectors): mddev->chunk_sectors =,
//
...
// Superblock is authoritative wrt given raid set layout!
    pub le32_to_cpu(sb->new_level): mddev->new_level =,
    pub le32_to_cpu(sb->new_layout): mddev->new_layout =,
    pub le32_to_cpu(sb->new_stripe_sectors): mddev->new_chunk_sectors =,
    pub le32_to_cpu(sb->delta_disks): mddev->delta_disks =,
    pub le64_to_cpu(sb->array_sectors): mddev->array_sectors =,
// raid was reshaping and got interrupted
    if (le32_to_cpu(sb.flags) & SB_FLAG_RESHAPE_ACTIVE) {
    if (test_bit(__CTR_FLAG_DELTA_DISKS, &rs.ctr_flags)) {
    pub reshaping"): DMERR("Reshape requested but raid set is still,
    pub -EINVAL: return,
    }
    if (mddev.delta_disks < 0 ||
    (!mddev.delta_disks && (le32_to_cpu(sb.flags) & SB_FLAG_RESHAPE_BACKWARDS)))
    pub 1: mddev->reshape_backwards =,
    else
    pub 0: mddev->reshape_backwards =,
    pub le64_to_cpu(sb->reshape_position): mddev->reshape_position =,
    pub mddev->layout): rs->raid_type = get_raid_type_by_ll(mddev->level,,
    if (!rs.raid_type)
    pub -EINVAL: return,
    }
    } else {
...
//
    pub mddev->layout): *mut *mut raid_type rt_cur = get_raid_type_by_ll(mddev->level,,
    pub mddev->new_layout): *mut *mut raid_type rt_new = get_raid_type_by_ll(mddev->new_level,,
    if (rs_takeover_requested(rs)) {
    if (rt_cur && rt_new)
    DMERR("Takeover raid sets from %s to %s not yet supported by metadata. (raid level change)",
    pub rt_new->name): rt_cur->name,,
    else
    pub change)"): DMERR("Takeover raid sets not yet supported by metadata. (raid level,
    pub -EINVAL: return,
    } else if (rs_reshape_requested(rs)) {
    pub level)"): DMERR("Reshaping raid sets not yet supported by metadata. (raid layout change keeping,
    ...
    pub mddev->new_layout): le32_to_cpu(sb->layout),,
    }
    if (mddev.chunk_sectors != mddev.new_chunk_sectors)
    DMERR("	 current stripe sectors %u vs new stripe sectors %u",
    pub mddev->new_chunk_sectors): mddev->chunk_sectors,,
    if (rs.delta_disks)
    DMERR("	 current %u disks vs new %u disks",
    pub rs->delta_disks): mddev->raid_disks, mddev->raid_disks +,
    if (rs_is_raid10(rs)) {
    ...
    pub format"): DMINFO("Discovered old metadata format; upgrading to extended metadata,
    }
    if (!test_bit(__CTR_FLAG_NOSYNC, &rs.ctr_flags))
    pub le64_to_cpu(sb->array_resync_offset): mddev->resync_offset =,
//
...
//
    ...
    pub superblock",: DMINFO("Device %d specified for rebuild; clearing,
    if (test_bit(FirstUse, &r.flags))
    }
    }
...
// Replace a broken device
    ...
    pub set"): DMINFO("Superblocks created for new raid,
    pub &mddev->flags): set_bit(MD_ARRAY_FIRST_USE,,
    } else if (new_devs != rebuilds &&
    new_devs != rs.delta_disks) {
    DMERR("New device injected into existing raid set without "
    pub specified"): "'delta_disks' or 'rebuild' parameter,
    pub -EINVAL: return,
    }
    ...
    pub mddev->resync_offset): (unsigned long long),
    pub -EINVAL: return,
    } else if (rs_is_reshaping(rs)) {
    DMERR("'rebuild' specified while raid set is being reshaped (reshape_position=%llu)",
    pub mddev->reshape_position): (unsigned long long),
    pub -EINVAL: return,
    }
    }
//
...
//
    ...
    !r.sb_page)
    pub page_address(r->sb_page): sb2 =,
    pub 0: sb2->failed_devices =,
    pub sizeof(sb2->extended_failed_devices)): memset(sb2->extended_failed_devices, 0,,
//
// Check for any device re-ordering.
//
    if (!test_bit(FirstUse, &r.flags) && (r.raid_disk >= 0)) {
    pub le32_to_cpu(sb2->array_position): role =,
    if (role < 0)
    if (role != r.raid_disk) {
    ...
    rs.ti.error =
    pub devices!": "Cannot change raid10 near set to odd # of,
    pub -EINVAL: return,
    }
    pub cpu_to_le32(r->raid_disk): sb2->array_position =,
    } else if (!(rs_is_raid10(rs) && rt_is_raid0(rs.raid_type)) &&
    !(rs_is_raid0(rs) && rt_is_raid10(rs.raid_type)) &&
    !rt_is_raid1(rs.raid_type)) {
    pub set": rs->ti->error = "Cannot change device positions in raid,
    pub -EINVAL: return,
    }
    pub r->raid_disk): DMINFO("raid device #%d now at position #%d", role,,
    }
//
...
//
    ...
    pub &r->flags): set_bit(Faulty,,
    }
    }
    pub 0: return,
    }
#[no_mangle]
unsafe extern "C" fn super_validate(rs: *mut raid_set, rdev: *mut md_rdev) -> c_int {
...
//
    ...
    pub flags": rs->ti->error = "Unable to assemble array: Unknown flag(s) in compatible feature,
    pub -EINVAL: return,
    }
    if (sb.incompat_features) {
    pub yet": rs->ti->error = "Unable to assemble array: No incompatible feature flags supported,
    pub -EINVAL: return,
    }
// Enable bitmap creation on @rs unless no metadevs or raid0 or journaled raid4/5/6 set.
    pub to_sector(4096): mddev->bitmap_info.offset = (rt_is_raid0(rs->raid_type) || rs->journal_dev.dev) ? 0 :,
    pub mddev->bitmap_info.offset: mddev->bitmap_info.default_offset =,
...
//
    if (le32_to_cpu(sb.compat_features) & FEATURE_FLAG_SUPPORTS_V190)
    pub le64_to_cpu(sb->sectors): rdev->sectors =,
    pub le64_to_cpu(sb->disk_recovery_offset): rdev->recovery_offset =,
    if (rdev.recovery_offset == MaxSector)
    pub &rdev->flags): set_bit(In_sync,,
//
...
pub unsafe extern "C" fn if(_arg: !rs_is_reshaping(rs)) -> else {
    ...
    pub /: *mut *mut clear_bit(In_sync, &rdev->flags); / Mandatory for recovery,
    }
//
// If a device comes back, set it as not In_sync and no longer faulty.
//
    if (test_and_clear_bit(Faulty, &rdev.flags)) {
    pub 0: rdev->recovery_offset =,
    pub &rdev->flags): clear_bit(In_sync,,
    pub rdev->raid_disk: rdev->saved_raid_disk =,
    }
// Reshape support -> restore respective data offsets
    pub le64_to_cpu(sb->data_offset): rdev->data_offset =,
    pub le64_to_cpu(sb->new_data_offset): rdev->new_data_offset =,
    pub 0: return,
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn analyse_superblocks(ti: *mut dm_target, rs: *mut raid_set) -> c_int {
    static int analyse_superblocks(struct dm_target *ti, struct raid_set *rs)
    {
    pub r: c_int,
    pub freshest: *mut *mut md_rdev rdev,,
    pub &rs->md: *mut *mut mddev mddev =,
...
// Set superblock offset/size for metadata device.
    pub 0: rdev->sb_start =,
    pub bdev_logical_block_size(rdev->meta_bdev): rdev->sb_size =,
    if (rdev.sb_size < sizeof(struct dm_raid_superblock) || rdev.sb_size > PAGE_SIZE) {
    pub valid"): DMERR("superblock size of a logical block is no longer,
    pub -EINVAL: return,
    }
//
...
//
    if (test_bit(__CTR_FLAG_SYNC, &rs.ctr_flags))
    pub freshest): r = super_load(rdev,,
    switch (r) {
    case 1:
    pub rdev: freshest =,
    case 0:
...
//
    pub -1: rdev->raid_disk = rdev->saved_raid_disk =,
    }
    }
    if (!freshest)
    pub 0: return,
...
//
    pub superblocks": rs->ti->error = "Unable to assemble array: Invalid,
    if (super_validate(rs, freshest))
    pub -EINVAL: return,
    if (validate_raid_redundancy(rs)) {
    pub array": rs->ti->error = "Insufficient redundancy to activate,
    pub -EINVAL: return,
    }
    rdev_for_each(rdev, mddev)
    if (!test_bit(Journal, &rdev.flags) &&
...
//
#[no_mangle]
unsafe extern "C" fn rs_adjust_data_offsets(rs: *mut raid_set) -> c_int {
    static int rs_adjust_data_offsets(struct raid_set *rs)
    {
    pub 0: sector_t data_offset = 0, new_data_offset =,
...
//
    pub 0: data_offset =,
    pub rs->data_offset: new_data_offset =,
...
//
    pub rs->data_offset: data_offset =,
    pub 0: new_data_offset =,
    } else {
//
...
//
    pub 0: data_offset = rs->data_offset ? rdev->data_offset :,
    pub rs->data_offset: new_data_offset = data_offset ? 0 :,
    pub &rs->runtime_flags): set_bit(RT_FLAG_UPDATE_SBS,,
    }
//
...
//
    ...
    pub reshape": "No space for backward,
    pub -ENOSPC: return,
    }
    out:
//
...
//
    ...
    pub rs->dev[0].rdev.data_offset: rs->md.resync_offset +=,
// Adjust data offsets on all rdevs but on any raid4/5/6 journal device
    rdev_for_each(rdev, &rs.md) {
    if (!test_bit(Journal, &rdev.flags)) {
    pub data_offset: rdev->data_offset =,
    pub new_data_offset: rdev->new_data_offset =,
    }
    }
    pub 0: return,
    }
...
#[no_mangle]
unsafe extern "C" fn __reorder_raid_disk_indexes(rs: *mut raid_set) {
    ...
    rdev_for_each(rdev, &rs.md) {
    if (!test_bit(Journal, &rdev.flags)) {
    pub i++: rdev->raid_disk =,
    pub -1: rdev->saved_raid_disk = rdev->new_raid_disk =,
    }
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn rs_setup_takeover(rs: *mut raid_set) -> c_int {
    static int rs_setup_takeover(struct raid_set *rs)
    {
    pub &rs->md: *mut *mut mddev mddev =,
    pub rdev: *mut md_rdev,
    pub rs->raid_disks: unsigned int d = mddev->raid_disks =,
    pub rs->data_offset: sector_t new_data_offset = rs->dev[0].rdev.data_offset ? 0 :,
...
// raid1 -> raid10_near layout
    ...
    pub &mddev->flags): clear_bit(MD_ARRAY_FIRST_USE,,
    pub MaxSector: mddev->resync_offset =,
    while (d--) {
    pub &rs->dev[d].rdev: rdev =,
    if (test_bit(d, (void *) rs.rebuild_disks)) {
    pub &rdev->flags): clear_bit(In_sync,,
    pub &rdev->flags): clear_bit(Faulty,,
    pub 0: mddev->resync_offset = rdev->recovery_offset =,
...
#[no_mangle]
unsafe extern "C" fn rs_prepare_reshape(rs: *mut raid_set) -> c_int {
...
//
    ...
    pub groups": rs->ti->error = "Can't reshape raid10 mirror,
    pub -EINVAL: return,
    }
// Userpace reordered disks to add/remove mirrors -> adjust raid_disk indexes
    mddev.layout = raid10_format_to_md_layout(rs, ALGORITHM_RAID10_NEAR,
    pub mddev->layout: mddev->new_layout =,
    pub false: reshape =,
    } else
    pub true: reshape =,
    ...
    pub true: reshape =,
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rs_is_raid1(rs)) -> else {
    if (rs.delta_disks) {
// Process raid1 via delta_disks
    pub rs->delta_disks: mddev->degraded = rs->delta_disks < 0 ? -rs->delta_disks :,
    pub true: reshape =,
    } else {
// Process raid1 without delta_disks
    pub rs->raid_disks: mddev->raid_disks =,
    pub false: reshape =,
    }
    } else {
    pub type": rs->ti->error = "Called with bogus raid,
    pub -EINVAL: return,
    }
    if (reshape) {
    pub &rs->runtime_flags): set_bit(RT_FLAG_RESHAPE_RS,,
    pub &rs->runtime_flags): set_bit(RT_FLAG_UPDATE_SBS,,
...
//
#[no_mangle]
unsafe extern "C" fn rs_setup_reshape(rs: *mut raid_set) -> c_int {
    static int rs_setup_reshape(struct raid_set *rs)
    {
    pub 0: int r =,
    pub d: unsigned int cur_raid_devs,,
    pub _get_reshape_sectors(rs): sector_t reshape_sectors =,
    pub &rs->md: *mut *mut mddev mddev =,
    pub rdev: *mut md_rdev,
    pub rs->delta_disks: mddev->delta_disks =,
    pub mddev->raid_disks: cur_raid_devs =,
// Ignore impossible layout change whilst adding/removing disks
    if (mddev.delta_disks &&
    mddev.layout != mddev.new_layout) {
    pub rs->delta_disks): DMINFO("Ignoring invalid layout change with delta_disks=%d",,
    pub mddev->layout: mddev->new_layout =,
    }
//
// Adjust array size:
...
// Prepare disks for check in raid4/5/6/10 {check|start}_reshape
    pub {: for (d = cur_raid_devs; d < rs->raid_disks; d++),
    pub &rs->dev[d].rdev: rdev =,
    pub &rdev->flags): clear_bit(In_sync,,
//
...
//
    pub -1: rdev->saved_raid_disk =,
    pub d: rdev->raid_disk =,
    pub mddev->dev_sectors: rdev->sectors =,
    pub MaxSector: rdev->recovery_offset = rs_is_raid1(rs) ? 0 :,
    }
    pub /: *mut *mut mddev->reshape_backwards = 0; / adding disk(s) -> forward reshape,
// Remove disk(s)
    } else if (rs.delta_disks < 0) {
    pub true): r = rs_set_dev_and_array_sectors(rs, rs->ti->len,,
    pub /: *mut *mut mddev->reshape_backwards = 1; / removing disk(s) -> backward reshape,
...
// remove disk(s)-> end
//
    pub 1: mddev->reshape_backwards = rs->dev[0].rdev.data_offset ? 0 :,
    }
//
...
//
    ...
    rdev_for_each(rdev, &rs.md)
    if (!test_bit(Journal, &rdev.flags))
    pub reshape_sectors: rdev->sectors +=,
    pub r: return,
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn rs_reset_inconclusive_reshape(rs: *mut raid_set) {
    static void rs_reset_inconclusive_reshape(struct raid_set *rs)
    {
    if (!rs_is_reshaping(rs) && rs_is_layout_change(rs, true)) {
    pub 0: rs->md.delta_disks =,
    pub 0: rs->md.reshape_backwards =,
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn configure_discard_support(rs: *mut raid_set) {
    static void configure_discard_support(struct raid_set *rs)
    {
    pub i: c_int,
    pub raid456: bool,
    pub rs->ti: *mut *mut dm_target ti =,
//
// XXX: RAID level 4,5,6 require zeroing for safety.
//
    pub rs_is_raid456(rs): raid456 =,
    pub {: for (i = 0; i < rs->raid_disks; i++),
    if (!rs.dev[i].rdev.bdev ||
    !bdev_max_discard_sectors(rs.dev[i].rdev.bdev))
    if (raid456) {
    if (!devices_handle_discard_safely) {
    pub uncertainty."): DMERR("raid456 discard support disabled due to discard_zeroes_data,
    pub override."): DMERR("Set dm-raid.devices_handle_discard_safely=Y to,
    }
    }
    }
    pub 1: ti->num_discard_bios =,
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn raid_ctr(ti: *mut dm_target, argc: c_uint, argv: *mut c_char) -> c_int {
    static int raid_ctr(struct dm_target *ti, unsigned int argc, char **argv)
    {
    pub r: c_int,
    pub false: bool resize =,
    pub rt: *mut raid_type,
    pub num_raid_devs: unsigned int num_raid_params,,
    pub reshape_sectors: sector_t sb_array_sectors, rdev_sectors,,
    pub NULL: *mut *mut raid_set rs =,
    pub arg: *const c_char,
    pub rs_layout: rs_layout,
    pub as_nrd: dm_arg_set as = { argc, argv },,
    struct dm_arg _args[] = {
...
#[no_mangle]
unsafe extern "C" fn raid_dtr(ti: *mut dm_target) {
    static void raid_dtr(struct dm_target *ti)
    {
    struct raid_set *rs = ti.private;
    mddev_lock_nointr(&rs.md);
    md_stop(&rs.md);
    rs.md.dm_gendisk = core::ptr::null_mut();
    mddev_unlock(&rs.md);
...
#[no_mangle]
unsafe extern "C" fn raid_map(ti: *mut dm_target, bio: *mut bio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn decipher_sync_action(mddev: *mut mddev, recovery: c_ulong) -> enum sync_state {
...
//
    ...
    return "-";
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(Faulty, _arg: &rdev->flags)) -> else {
    else if (test_bit(Faulty, &rdev.flags))
    return "D";
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(Journal, _arg: &rdev->flags)) -> else {
...
//
    ;
#[no_mangle]
pub unsafe extern "C" fn if(st_reshape: state == st_resync || state ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(st_repair: state == st_check || state ==) -> else {
...
//
    set_bit(RT_FLAG_RS_IN_SYNC, &rs.runtime_flags);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(MD_RECOVERY_NEEDED, _arg: &recovery)) -> else {
...
// Helper to return @dev name or "-" if !@dev
    ...
    struct raid_set *rs = ti.private;
    struct mddev *mddev = &rs.md;
    struct r5conf *conf = rs_is_raid456(rs) ? mddev.private : core::ptr::null_mut();
    int i, max_nr_stripes = conf ? conf.max_nr_stripes : 0;
    unsigned long recovery;
    unsigned int raid_param_cnt = 1; /* at least 1 for chunksize */
    let mut sz: c_uint = 0;
    let mut rebuild_writemostly_count: c_uint = 0;
...
// Access most recent mddev properties for status output
    ...
    return -EBUSY;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(argv[0], _arg: "resync")) -> else {
    else if (!strcasecmp(argv[0], "resync"))
    ; /* MD_RECOVERY_NEEDED set below */
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(argv[0], _arg: "recover")) -> else {
...
#[no_mangle]
unsafe extern "C" fn raid_io_hints(ti: *mut dm_target, limits: *mut queue_limits) {
    static void raid_io_hints(struct dm_target *ti, struct queue_limits *limits)
    {
    struct raid_set *rs = ti.private;
    let mut chunk_size_bytes: c_uint = to_bytes(rs.md.chunk_sectors);
    if (chunk_size_bytes) {
...
#[no_mangle]
unsafe extern "C" fn raid_presuspend(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn raid_presuspend_undo(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn raid_postsuspend(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn attempt_restore_of_faulty_devices(rs: *mut raid_set) {
...
#[no_mangle]
unsafe extern "C" fn __load_dirty_region_bitmap(rs: *mut raid_set) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rs_update_sbs(rs: *mut raid_set) {
    static void rs_update_sbs(struct raid_set *rs)
    {
    struct mddev *mddev = &rs.md;
    let mut ro: c_int = mddev.ro;
...
//
#[no_mangle]
unsafe extern "C" fn rs_start_reshape(rs: *mut raid_set) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raid_preresume(ti: *mut dm_target) -> c_int {
...
// Resize bitmap to adjust to changed region size (aka MD bitmap chunksize) or grown device size
    ...
    let mut chunksize: c_int = to_bytes(rs.requested_bitmap_chunk_sectors) ?: mddev.bitmap_info.chunksize;
    if (md_bitmap_enabled(mddev, false)) {
...
#[no_mangle]
unsafe extern "C" fn raid_resume(ti: *mut dm_target) {
