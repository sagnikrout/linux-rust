...
// dirty buffers.
//
pub const DM_BUFIO_MIN_BUFFERS: c_int = 8;
pub const DM_BUFIO_MEMORY_PERCENT: c_int = 2;
pub const DM_BUFIO_VMALLOC_PERCENT: c_int = 25;
pub const DM_BUFIO_WRITEBACK_RATIO: c_int = 3;
pub const DM_BUFIO_LOW_WATERMARK_RATIO: c_int = 16;
//
...
//
pub const DM_BUFIO_WRITE_ALIGN: c_int = 4096;
//
// dm_buffer->list_mode
//
pub const LIST_CLEAN: c_int = 0;
pub const LIST_DIRTY: c_int = 1;
pub const LIST_SIZE: c_int = 2;
pub const SCAN_RESCHED_CYCLE: c_int = 16;
// --------------------------------------------------------------
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lru_entry {
    pub list: list_head,
    pub referenced: core::sync::atomic::AtomicI32,
}
...
pub struct lru {
    ...
    pub count: c_ulong,
    pub iterators: list_head,
}

// --------------
#[no_mangle]
unsafe extern "C" fn lru_init(lru: *mut lru) {
    static void lru_init(struct lru *lru)
    {
    lru.cursor = core::ptr::null_mut();
    lru.count = 0;
    INIT_LIST_HEAD(&lru.iterators);
    }
#[no_mangle]
unsafe extern "C" fn lru_destroy(lru: *mut lru) {
...
//
#[no_mangle]
unsafe extern "C" fn lru_insert(lru: *mut lru, le: *mut lru_entry) {
...
//
#[no_mangle]
unsafe extern "C" fn lru_iter_begin(lru: *mut lru, it: *mut lru_iter) {
    static void lru_iter_begin(struct lru *lru, struct lru_iter *it)
    {
    it.lru = lru;
    it.stop = lru.cursor ? to_le(lru.cursor.prev) : core::ptr::null_mut();
    it.e = lru.cursor ? to_le(lru.cursor) : core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn lru_iter_end(it: *mut lru_iter) {
...
//
#[no_mangle]
unsafe extern "C" fn lru_iter_invalidate(lru: *mut lru, e: *mut lru_entry) {
...
//
#[no_mangle]
unsafe extern "C" fn lru_remove(lru: *mut lru, le: *mut lru_entry) {
...
//
#[no_mangle]
pub unsafe extern "C" fn lru_reference(le: *mut lru_entry) {
...
// Buffer state bits.
//
pub const B_READING: c_int = 0;
pub const B_WRITING: c_int = 1;
pub const B_DIRTY: c_int = 2;
//
...
// immutable, so don't need protecting
    pub block: sector_t,
    pub data: *mut c_void,
    pub /: *mut *mut *mut unsigned char data_mode; / DATA_MODE_,
//
// These two fields are used in isolation, so do not need
// a surrounding lock.
//
    pub hold_count: core::sync::atomic::AtomicI32,
    pub last_accessed: c_ulong,
//
...
//
    pub state: c_ulong,
    pub lru: lru_entry,
    pub /: *mut *mut *mut unsigned char list_mode; / LIST_,
    pub read_error: blk_status_t,
    pub write_error: blk_status_t,
    pub dirty_start: c_uint,
    pub dirty_end: c_uint,
    pub write_start: c_uint,
    pub write_end: c_uint,
    pub write_list: list_head,
    pub c: *mut dm_bufio_client,
    pub bs): *mut *mut *mut void (end_io)(struct dm_buffer b, blk_status_t,

pub const MAX_STACK: c_int = 10;
    pub stack_len: c_uint,
    pub stack_entries: [c_ulong; MAX_STACK],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct buffer_tree {
    union {
    pub lock: rw_semaphore,
    pub spinlock: rwlock_t,
    pub u: },
    pub root: rb_root,
    pub ____cacheline_aligned_in_smp: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_buffer_cache {
    pub lru: [lru; LIST_SIZE],
//
...
//
    ...
    pub no_sleep: bool,
    pub __counted_by(num_locks): buffer_tree trees[],
}

    static DEFINE_STATIC_KEY_FALSE(no_sleep_enabled);
#[no_mangle]
pub unsafe extern "C" fn cache_index(block: sector_t, num_locks: c_uint) -> c_uint {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lock_history {
    pub cache: *mut dm_buffer_cache,
    pub write: bool,
    pub previous: c_uint,
    pub no_previous: c_uint,
}

#[no_mangle]
unsafe extern "C" fn lh_init(lh: *mut lock_history, cache: *mut dm_buffer_cache, write: bool) {
...
#[no_mangle]
unsafe extern "C" fn __lh_lock(lh: *mut lock_history, index: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn __lh_unlock(lh: *mut lock_history, index: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn lh_exit(lh: *mut lock_history) {
...
//
#[no_mangle]
unsafe extern "C" fn lh_next(lh: *mut lock_history, b: sector_t) {
...
#[no_mangle]
unsafe extern "C" fn cache_init(bc: *mut dm_buffer_cache, num_locks: c_uint, no_sleep: bool) {
...
#[no_mangle]
unsafe extern "C" fn cache_destroy(bc: *mut dm_buffer_cache) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cache_count(bc: *mut dm_buffer_cache, list_mode: c_int) -> c_ulong {
    static inline unsigned long cache_count(struct dm_buffer_cache *bc, int list_mode)
    {
    return bc.lru[list_mode].count;
    }
#[no_mangle]
pub unsafe extern "C" fn cache_total(bc: *mut dm_buffer_cache) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn __cache_inc_buffer(b: *mut dm_buffer) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct evict_wrapper {
    pub lh: *mut lock_history,
    pub pred: b_predicate,
...
//
#[no_mangle]
unsafe extern "C" fn __evict_pred(le: *mut lru_entry, context: *mut c_void) -> enum evict_result {
    ...
    {
    let mut w: evict_wrapper = {.lh = lh, .pred = pred, .context = context};
    struct lru_entry *le;
    struct dm_buffer *b;
...
//
#[no_mangle]
unsafe extern "C" fn __cache_insert(root: *mut rb_root, b: *mut dm_buffer) -> bool {
...
// --------------
    ...
    struct rb_node *n = root.rb_node;
    struct dm_buffer *b;
    struct dm_buffer *best = core::ptr::null_mut();
    while (n) {
    b = container_of(n, struct dm_buffer, node);
    if (b.block == block)
    return b;
    ...
    if (atomic_read(&b.hold_count))
    continue;
    if (pred(b, core::ptr::null_mut()) == ER_EVICT) {
...
pub struct dm_bufio_client {
    ...
    pub sectors_per_block_bits: i8,
    pub no_sleep: bool,
    pub lock: mutex,
    pub spinlock: spinlock_t,
    pub async_write_error: c_int,
    pub buf): *mut *mut void (alloc_callback)(struct dm_buffer,
    pub buf): *mut *mut void (write_callback)(struct dm_buffer,
    pub slab_buffer: *mut kmem_cache,
    pub slab_cache: *mut kmem_cache,
    pub dm_io: *mut dm_io_client,
    pub reserved_buffers: list_head,
    pub need_reserved_buffers: c_uint,
    pub minimum_buffers: c_uint,
    pub start: sector_t,
    pub shrinker: *mut shrinker,
    pub shrink_work: work_struct,
    pub need_shrink: atomic_long_t,
    pub free_buffer_wait: wait_queue_head_t,
    pub client_list: list_head,
//
// Used by global_cleanup to sort the clients list.
//
    pub oldest_buffer: c_ulong,
    pub /: *mut *mut dm_buffer_cache cache; / must be last member,
}

// ----------------------------------------------------------------

#[no_mangle]
unsafe extern "C" fn dm_bufio_lock(c: *mut dm_bufio_client) {
...
#[no_mangle]
unsafe extern "C" fn dm_bufio_unlock(c: *mut dm_bufio_client) {
...
//
    ...
    let mut dm_bufio_retain_bytes: static unsigned long = DM_BUFIO_DEFAULT_RETAIN_BYTES;
...
#[no_mangle]
unsafe extern "C" fn buffer_record_stack(b: *mut dm_buffer) {
...
// ----------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn adjust_total_allocated(b: *mut dm_buffer, unlink: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn __cache_size_refresh() {
...
//
    ...
    unsigned char *data_mode)
    {
    if (unlikely(c.slab_cache != core::ptr::null_mut())) {
...
//
#[no_mangle]
unsafe extern "C" fn free_buffer(b: *mut dm_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn dmio_complete(error: c_ulong, unsup: c_ulong, context: *mut c_void) {
    ...
    r = dm_io(&io_req, 1, &region, core::ptr::null_mut(), core::ptr::null_mut(), ioprio);
    if (unlikely(r))
    b.end_io(b, errno_to_blk_status(r));
    }
#[no_mangle]
unsafe extern "C" fn bio_complete(bio: *mut bio) {
    static void bio_complete(struct bio *bio)
    {
    struct dm_buffer *b = bio.bi_private;
    let mut status: blk_status_t = bio.bi_status;
    bio_uninit(bio);
    kfree(bio);
    b.end_io(b, status);
    }
...
#[no_mangle]
pub unsafe extern "C" fn block_to_sector(c: *mut dm_bufio_client, block: sector_t) -> sector_t {
...
//
#[no_mangle]
unsafe extern "C" fn write_endio(b: *mut dm_buffer, status: blk_status_t) {
...
#[no_mangle]
unsafe extern "C" fn __flush_write_list(write_list: *mut list_head) {
...
//
#[no_mangle]
unsafe extern "C" fn __make_buffer_clean(b: *mut dm_buffer) {
...
// smp_load_acquire() pairs with read_endio()'s smp_mb__before_atomic()
    ...
    __write_dirty_buffer(b, core::ptr::null_mut());
    wait_on_bit_io(&b.state, B_WRITING, TASK_UNINTERRUPTIBLE);
    }
#[no_mangle]
unsafe extern "C" fn is_clean(b: *mut dm_buffer, context: *mut c_void) -> enum evict_result {
...
#[no_mangle]
unsafe extern "C" fn is_dirty(b: *mut dm_buffer, context: *mut c_void) -> enum evict_result {
...
// this also waits for pending reads
    ...
    if (static_branch_unlikely(&no_sleep_enabled) && c.no_sleep)
    return core::ptr::null_mut();
    b = cache_evict(&c.cache, LIST_DIRTY, is_dirty, core::ptr::null_mut());
    if (b) {
    __make_buffer_clean(b);
    return b;
    }
...
//
#[no_mangle]
unsafe extern "C" fn __wait_for_free_buffer(c: *mut dm_bufio_client) {
...
//
    ...
    {
    struct dm_buffer *b;
    let mut tried_noio_alloc: bool = false;
//
...
//
#[no_mangle]
unsafe extern "C" fn __free_buffer_wake(b: *mut dm_buffer) {
...
#[no_mangle]
unsafe extern "C" fn cleaned(b: *mut dm_buffer, context: *mut c_void) -> enum evict_result {
...
#[no_mangle]
unsafe extern "C" fn __move_clean_buffers(c: *mut dm_bufio_client) {
    static void __move_clean_buffers(struct dm_bufio_client *c)
    {
    cache_mark_many(&c.cache, LIST_DIRTY, LIST_CLEAN, cleaned, core::ptr::null_mut());
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct write_context {
    pub no_wait: c_int,
    pub write_list: *mut list_head,
}

#[no_mangle]
unsafe extern "C" fn write_one(b: *mut dm_buffer, context: *mut c_void) -> enum it_action {
    ...
    struct list_head *write_list)
    {
    let mut wc: write_context = {.no_wait = no_wait, .write_list = write_list};
...
//
    ...
    struct list_head *write_list)
    {
    struct dm_buffer *b, *new_b = core::ptr::null_mut();
// need_submit = 0;
...
//
#[no_mangle]
unsafe extern "C" fn read_endio(b: *mut dm_buffer, status: blk_status_t) {
...
//
    ...
    wait_on_bit_io(&b.state, B_READING, TASK_UNINTERRUPTIBLE);
    if (b.read_error) {
    let mut error: c_int = blk_status_to_errno(b.read_error);
    dm_bufio_release(b);
...
// already in cache
    ...
    if (unlikely(b != core::ptr::null_mut())) {
    dm_bufio_unlock(c);
    if (need_submit)
    submit_io(b, REQ_OP_READ, ioprio, read_endio);
    dm_bufio_release(b);
...
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_prefetch(c: *mut dm_bufio_client, block: sector_t, n_blocks: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_release(b: *mut dm_buffer) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_mark_buffer_dirty(b: *mut dm_buffer) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_write_dirty_buffers_async(c: *mut dm_bufio_client) {
...
//
#[no_mangle]
unsafe extern "C" fn is_writing(e: *mut lru_entry, context: *mut c_void) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_write_dirty_buffers(c: *mut dm_bufio_client) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_issue_flush(c: *mut dm_bufio_client) -> c_int {
    ...
    if (WARN_ON_ONCE(dm_bufio_in_request()))
    return -EINVAL;
    return dm_io(&io_req, 1, &io_reg, core::ptr::null_mut(), core::ptr::null_mut(), IOPRIO_DEFAULT);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_issue_discard(c: *mut dm_bufio_client, block: sector_t, count: sector_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn forget_buffer(c: *mut dm_bufio_client, block: sector_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_forget(c: *mut dm_bufio_client, block: sector_t) {
...
#[no_mangle]
unsafe extern "C" fn idle(b: *mut dm_buffer, context: *mut c_void) -> enum evict_result {
    static enum evict_result idle(struct dm_buffer *b, void *context)
    {
    return b.state ? ER_DONT_EVICT : ER_EVICT;
    }
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_forget_buffers(c: *mut dm_bufio_client, block: sector_t, n_blocks: sector_t) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_set_minimum_buffers(c: *mut dm_bufio_client, n: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_get_block_size(c: *mut dm_bufio_client) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_get_device_size(c: *mut dm_bufio_client) -> sector_t {
    sector_t dm_bufio_get_device_size(struct dm_bufio_client *c)
    {
    let mut s: sector_t = bdev_nr_sectors(c.bdev);
    if (s >= c.start)
    s -= c.start;
    else
    s = 0;
...
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_get_block_number(b: *mut dm_buffer) -> sector_t {
...
#[no_mangle]
unsafe extern "C" fn warn_leak(b: *mut dm_buffer, context: *mut c_void) -> enum it_action {
...
#[no_mangle]
unsafe extern "C" fn drop_buffers(c: *mut dm_bufio_client) {
...
#[no_mangle]
unsafe extern "C" fn get_retain_buffers(c: *mut dm_bufio_client) -> c_ulong {
    static unsigned long get_retain_buffers(struct dm_bufio_client *c)
    {
    let mut retain_bytes: c_ulong = READ_ONCE(dm_bufio_retain_bytes);
    if (likely(c.sectors_per_block_bits >= 0))
...
#[no_mangle]
unsafe extern "C" fn __scan(c: *mut dm_bufio_client) {
    static void __scan(struct dm_bufio_client *c)
    {
    int l;
    struct dm_buffer *b;
    let mut freed: c_ulong = 0;
    let mut retain_target: c_ulong = get_retain_buffers(c);
    let mut count: c_ulong = cache_total(&c.cache);
...
#[no_mangle]
unsafe extern "C" fn shrink_work(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn dm_bufio_shrink_scan(shrink: *mut shrinker, sc: *mut shrink_control) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn dm_bufio_shrink_count(shrink: *mut shrinker, sc: *mut shrink_control) -> c_ulong {
    static unsigned long dm_bufio_shrink_count(struct shrinker *shrink, struct shrink_control *sc)
    {
    struct dm_bufio_client *c = shrink.private_data;
    let mut count: c_ulong = cache_total(&c.cache);
    let mut retain_target: c_ulong = get_retain_buffers(c);
    let mut queued_for_cleanup: c_ulong = atomic_long_read(&c.need_shrink);
...
//
    ...
    let mut align: c_uint = min(1U << __ffs(block_size), (unsigned int)PAGE_SIZE);
    snprintf(slab_name, sizeof(slab_name), "dm_bufio_cache-%u-%u",
    block_size, atomic_inc_return(&seqno));
    c.slab_cache = kmem_cache_create(slab_name, block_size, align,
    SLAB_RECLAIM_ACCOUNT, core::ptr::null_mut());
    if (!c.slab_cache) {
    r = -ENOMEM;
    goto bad;
    }
    ...
    0, SLAB_RECLAIM_ACCOUNT, core::ptr::null_mut());
    if (!c.slab_buffer) {
    r = -ENOMEM;
    goto bad;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_client_destroy(c: *mut dm_bufio_client) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_client_reset(c: *mut dm_bufio_client) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_bufio_set_sector_offset(c: *mut dm_bufio_client, start: sector_t) {
...
//
#[no_mangle]
unsafe extern "C" fn __insert_client(new_client: *mut dm_bufio_client) {
...
#[no_mangle]
unsafe extern "C" fn select_for_evict(b: *mut dm_buffer, context: *mut c_void) -> enum evict_result {
...
#[no_mangle]
unsafe extern "C" fn __evict_a_few(nr_buffers: c_ulong) -> c_ulong {
    static unsigned long __evict_a_few(unsigned long nr_buffers)
    {
    struct dm_bufio_client *c;
    let mut oldest_buffer: c_ulong = jiffies;
    ...
    b = cache_evict(&c.cache, LIST_CLEAN, select_for_evict, core::ptr::null_mut());
    if (!b)
    break;
...
#[no_mangle]
unsafe extern "C" fn check_watermarks() {
...
#[no_mangle]
unsafe extern "C" fn do_global_cleanup(w: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn dm_bufio_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn dm_bufio_exit() -> void __exit {
