...
//! Source: drivers/md/dm-era-target.c
#![no_std]
...
pub const SUPERBLOCK_LOCATION: c_int = 0;
pub const SUPERBLOCK_MAGIC: c_int = 2126579579;
pub const SUPERBLOCK_CSUM_XOR: c_int = 146538381;
pub const MIN_ERA_VERSION: c_int = 1;
pub const MAX_ERA_VERSION: c_int = 1;

pub const MIN_BLOCK_SIZE: c_int = 8;
//
// --------------------------------------------------------------
// Writeset
// --------------------------------------------------------------
...
//
#[no_mangle]
unsafe extern "C" fn writeset_free(ws: *mut writeset) {
    static void writeset_free(struct writeset *ws)
    {
    vfree(ws.bits);
    ws.bits = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn bitset_size(nr_bits: c_uint) -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn writeset_alloc(ws: *mut writeset, nr_blocks: dm_block_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn writeset_marked(ws: *mut writeset, block: dm_block_t) -> bool {
...
pub const UUID_LEN: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct writeset_disk {
    pub nr_bits: __le32,
    pub root: __le64,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct superblock_disk {
    pub csum: __le32,
    pub flags: __le32,
    pub blocknr: __le64,
    pub uuid: [__u8; UUID_LEN],
    pub magic: __le64,
    pub version: __le32,
    pub metadata_space_map_root: [__u8; SPACE_MAP_ROOT_SIZE],
    pub data_block_size: __le32,
    pub metadata_block_size: __le32,
    pub nr_blocks: __le32,
    pub current_era: __le32,
    pub current_writeset: writeset_disk,
//
// Only these two fields are valid within the metadata snapshot.
//
    pub writeset_tree_root: __le64,
    pub era_array_root: __le64,
    pub metadata_snap: __le64,
    pub __packed: },
//
// --------------------------------------------------------------
...
//
    ...
    {
    pub dm_block_data(b): *mut *mut superblock_disk disk =,
    pub cpu_to_le64(dm_block_location(b)): disk->blocknr =,
    disk.csum = cpu_to_le32(dm_bm_checksum(&disk.flags,
    sb_block_size - sizeof(__le32),
    }
#[no_mangle]
unsafe extern "C" fn check_metadata_version(disk: *mut superblock_disk) -> c_int {
    static int check_metadata_version(struct superblock_disk *disk)
    {
    pub le32_to_cpu(disk->version): uint32_t metadata_version =,
    ...
    pub MAX_ERA_VERSION): metadata_version, MIN_ERA_VERSION,,
    pub -EINVAL: return,
    }
    pub 0: return,
    }
    ...
    pub le32_to_cpu(disk->csum)): __func__, le32_to_cpu(csum_le),,
    pub -EILSEQ: return,
    }
    pub check_metadata_version(disk): return,
    }
...
// --------------------------------------------------------------
//
pub const DM_ERA_METADATA_BLOCK_SIZE: c_int = 4096;
pub const ERA_MAX_CONCURRENT_LOCKS: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct era_metadata {
    pub bdev: *mut block_device,
    pub bm: *mut dm_block_manager,
    pub sm: *mut dm_space_map,
...
//
    pub writesets: [writeset; 2],
    pub current_writeset: *mut writeset,
    pub writeset_tree_root: dm_block_t,
    pub era_array_root: dm_block_t,
    pub bitset_info: dm_disk_bitset,
    pub writeset_tree_info: dm_btree_info,
    pub era_array_info: dm_array_info,
    pub metadata_snap: dm_block_t,
//
// A flag that is set whenever a writeset has been archived.
//
    pub archived_writesets: bool,
//
...
#[no_mangle]
unsafe extern "C" fn superblock_all_zeroes(bm: *mut dm_block_manager, result: *mut bool) -> c_int {
    ...
    let mut sb_block_size: c_uint = dm_bm_block_size(bm) / sizeof(__le64);
//
// We can't use a validator here - it may be all zeroes.
//
    r = dm_bm_read_lock(bm, SUPERBLOCK_LOCATION, core::ptr::null_mut(), &b);
    if (r)
    return r;
...
// ----------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ws_pack(core: *const writeset_metadata, disk: *mut writeset_disk) {
...
#[no_mangle]
unsafe extern "C" fn ws_unpack(disk: *const writeset_disk, core: *mut writeset_metadata) {
...
#[no_mangle]
unsafe extern "C" fn ws_inc(context: *mut c_void, value: *const c_void, count: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ws_dec(context: *mut c_void, value: *const c_void, count: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ws_eq(context: *mut c_void, value1: *const c_void, value2: *const c_void) -> c_int {
...
// ----------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn setup_writeset_tree_info(md: *mut era_metadata) {
...
#[no_mangle]
unsafe extern "C" fn setup_era_array_info(md: *mut era_metadata) {
    static void setup_era_array_info(struct era_metadata *md)
    {
    struct dm_btree_value_type vt;
    vt.context = core::ptr::null_mut();
    vt.size = sizeof(__le32);
    vt.inc = core::ptr::null_mut();
    vt.dec = core::ptr::null_mut();
    vt.equal = core::ptr::null_mut();
    dm_array_info_init(&md.era_array_info, md.tm, &vt);
    }
#[no_mangle]
unsafe extern "C" fn setup_infos(md: *mut era_metadata) {
...
// ----------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn create_fresh_metadata(md: *mut era_metadata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn save_sm_root(md: *mut era_metadata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_sm_root(md: *mut era_metadata, disk: *mut superblock_disk) {
...
//
#[no_mangle]
unsafe extern "C" fn prepare_superblock(md: *mut era_metadata, disk: *mut superblock_disk) {
...
#[no_mangle]
unsafe extern "C" fn write_superblock(md: *mut era_metadata) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn format_metadata(md: *mut era_metadata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn open_metadata(md: *mut era_metadata) -> c_int {
...
// Verify the data block size hasn't changed
    ...
    {
    int r;
    let mut unformatted: bool = false;
...
#[no_mangle]
unsafe extern "C" fn destroy_persistent_data_objects(md: *mut era_metadata) {
...
//
#[no_mangle]
unsafe extern "C" fn swap_writeset(md: *mut era_metadata, new_writeset: *mut writeset) {
...
pub struct digest {
    pub era: u32,
    pub current_bit: unsigned int nr_bits,,
    pub writeset: writeset_metadata,
    pub value: __le32,
    pub info: dm_disk_bitset,
    pub d): *mut *mut *mut int (step)(struct era_metadata md, struct digest,
}
...
pub const INSERTS_PER_STEP: c_int = 100;
...
#[no_mangle]
unsafe extern "C" fn metadata_digest_start(md: *mut era_metadata, d: *mut digest) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn metadata_close(md: *mut era_metadata) {
...
#[no_mangle]
unsafe extern "C" fn valid_nr_blocks(n: dm_block_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn metadata_resize(md: *mut era_metadata, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn metadata_era_archive(md: *mut era_metadata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn metadata_new_era(md: *mut era_metadata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn metadata_era_rollover(md: *mut era_metadata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn metadata_current_marked(md: *mut era_metadata, block: dm_block_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn metadata_commit(md: *mut era_metadata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn metadata_checkpoint(md: *mut era_metadata) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn metadata_take_snap(md: *mut era_metadata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn metadata_drop_snap(md: *mut era_metadata) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct metadata_stats {
    pub used: dm_block_t,
    pub total: dm_block_t,
    pub snap: dm_block_t,
    pub era: u32,
}

#[no_mangle]
unsafe extern "C" fn metadata_get_stats(md: *mut era_metadata, ptr: *mut c_void) -> c_int {
...
pub struct rpc {
    pub list: list_head,
    pub md): *mut *mut int (fn0)(struct era_metadata,
    pub ref): *mut *mut *mut int (fn1)(struct era_metadata md, void,
    pub arg: *mut c_void,
    pub result: c_int,
...
//
#[no_mangle]
unsafe extern "C" fn block_size_is_power_of_two(era: *mut era) -> bool {
    static bool block_size_is_power_of_two(struct era *era)
    {
    return era.sectors_per_block_shift >= 0;
    }
#[no_mangle]
unsafe extern "C" fn get_block(era: *mut era, bio: *mut bio) -> dm_block_t {
...
#[no_mangle]
unsafe extern "C" fn remap_to_origin(era: *mut era, bio: *mut bio) {
...
//
#[no_mangle]
unsafe extern "C" fn wake_worker(era: *mut era) {
...
#[no_mangle]
unsafe extern "C" fn process_old_eras(era: *mut era) {
    ...
    era.digest.step = core::ptr::null_mut();
    } else if (era.digest.step)
    wake_worker(era);
    }
#[no_mangle]
unsafe extern "C" fn process_deferred_bios(era: *mut era) {
...
#[no_mangle]
unsafe extern "C" fn process_rpc_calls(era: *mut era) {
    static void process_rpc_calls(struct era *era)
    {
    int r;
    let mut need_commit: bool = false;
...
#[no_mangle]
unsafe extern "C" fn kick_off_digest(era: *mut era) {
...
#[no_mangle]
unsafe extern "C" fn do_work(ws: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn defer_bio(era: *mut era, bio: *mut bio) {
...
//
#[no_mangle]
unsafe extern "C" fn perform_rpc(era: *mut era, rpc: *mut rpc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn in_worker0(era: *mut era, md): *mut *mut int (fn)(struct era_metadata) -> c_int {
    static int in_worker0(struct era *era, int (*fn)(struct era_metadata *md))
    {
    struct rpc rpc;
    rpc.fn0 = fn;
    rpc.fn1 = core::ptr::null_mut();
    ...
    {
    struct rpc rpc;
    rpc.fn0 = core::ptr::null_mut();
    rpc.fn1 = fn;
    rpc.arg = arg;
    return perform_rpc(era, &rpc);
    }
#[no_mangle]
unsafe extern "C" fn start_worker(era: *mut era) {
    static void start_worker(struct era *era)
    {
    atomic_set(&era.suspended, 0);
    }
#[no_mangle]
unsafe extern "C" fn stop_worker(era: *mut era) {
...
//
#[no_mangle]
unsafe extern "C" fn era_destroy(era: *mut era) {
...
#[no_mangle]
unsafe extern "C" fn calc_nr_blocks(era: *mut era) -> dm_block_t {
    static dm_block_t calc_nr_blocks(struct era *era)
    {
    return dm_sector_div_up(era.ti.len, era.sectors_per_block);
    }
#[no_mangle]
unsafe extern "C" fn valid_block_size(block_size: dm_block_t) -> bool {
    static bool valid_block_size(dm_block_t block_size)
    {
    let mut greater_than_zero: bool = block_size > 0;
    let mut multiple_of_min_block_size: bool = (block_size & (MIN_BLOCK_SIZE - 1)) == 0;
...
//
#[no_mangle]
unsafe extern "C" fn era_ctr(ti: *mut dm_target, argc: c_uint, argv: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn era_dtr(ti: *mut dm_target) {
    static void era_dtr(struct dm_target *ti)
    {
    era_destroy(ti.private);
    }
#[no_mangle]
unsafe extern "C" fn era_map(ti: *mut dm_target, bio: *mut bio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn era_postsuspend(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn era_preresume(ti: *mut dm_target) -> c_int {
    static int era_preresume(struct dm_target *ti)
    {
    int r;
    struct era *era = ti.private;
    let mut new_size: dm_block_t = calc_nr_blocks(era);
...
#[no_mangle]
unsafe extern "C" fn era_io_hints(ti: *mut dm_target, limits: *mut queue_limits) {
