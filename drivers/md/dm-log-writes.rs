...
//! Source: drivers/md/dm-log-writes.c
#![no_std]
...
pub const WRITE_LOG_MAGIC: c_uint = 0x6a736677736872ULL;
pub const WRITE_LOG_SUPER_SECTOR: c_int = 0;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct log_write_entry {
    pub sector: __le64,
    pub nr_sectors: __le64,
    pub flags: __le64,
    pub data_len: __le64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct log_writes_c {
    pub dev: *mut dm_dev,
    pub logdev: *mut dm_dev,
    pub logged_entries: u64,
    pub sectorsize: u32,
    pub sectorshift: u32,
    pub io_blocks: core::sync::atomic::AtomicI32,
    pub pending_blocks: core::sync::atomic::AtomicI32,
    pub next_sector: sector_t,
    pub end_sector: sector_t,
    pub logging_enabled: bool,
    pub device_supports_discard: bool,
    pub blocks_lock: spinlock_t,
    pub unflushed_blocks: list_head,
    pub logging_blocks: list_head,
    pub wait: wait_queue_head_t,
    pub log_kthread: *mut task_struct,
    pub super_done: completion,
}
...
#[no_mangle]
unsafe extern "C" fn put_pending_block(lc: *mut log_writes_c) {
...
#[no_mangle]
unsafe extern "C" fn put_io_block(lc: *mut log_writes_c) {
...
#[no_mangle]
unsafe extern "C" fn log_end_io(bio: *mut bio) {
...
#[no_mangle]
unsafe extern "C" fn log_end_super(bio: *mut bio) {
...
#[no_mangle]
unsafe extern "C" fn log_super(lc: *mut log_writes_c) -> c_int {
    ...
    if (write_metadata(lc, &super, sizeof(super), core::ptr::null_mut(), 0,
...
#[no_mangle]
pub unsafe extern "C" fn logdev_last_sector(lc: *mut log_writes_c) -> sector_t {
    static inline sector_t logdev_last_sector(struct log_writes_c *lc)
    {
    return bdev_nr_sectors(lc.logdev.bdev);
    }
#[no_mangle]
unsafe extern "C" fn log_writes_kthread(arg: *mut c_void) -> c_int {
    ...
    let mut super: bool = false;
    bool logging_enabled;
    struct pending_block *block = core::ptr::null_mut();
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn log_writes_ctr(ti: *mut dm_target, argc: c_uint, argv: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn log_mark(lc: *mut log_writes_c, data: *mut c_char) -> c_int {
    static int log_mark(struct log_writes_c *lc, char *data)
    {
    struct pending_block *block;
    let mut maxsize: usize = lc.sectorsize - sizeof(struct log_write_entry);
...
#[no_mangle]
unsafe extern "C" fn log_writes_dtr(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn normal_map_bio(ti: *mut dm_target, bio: *mut bio) {
...
#[no_mangle]
unsafe extern "C" fn log_writes_map(ti: *mut dm_target, bio: *mut bio) -> c_int {
    ...
    size_t alloc_size;
    let mut i: c_int = 0;
    let mut flush_bio: bool = (bio.bi_opf & REQ_PREFLUSH);
    let mut fua_bio: bool = (bio.bi_opf & REQ_FUA);
    let mut discard_bio: bool = (bio_op(bio) == REQ_OP_DISCARD);
    let mut meta_bio: bool = (bio.bi_opf & REQ_META);
    pb.block = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn log_writes_io_hints(ti: *mut dm_target, limits: *mut queue_limits) {
