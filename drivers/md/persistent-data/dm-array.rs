...
//! Source: drivers/md/persistent-data/dm-array.h
#![no_std]
...
//
extern "C" {
    pub fn dm_array_empty(info: *mut dm_array_info, root: *mut dm_block_t) -> c_int;
}
//
// Resizes the array.
//
...
//
extern "C" {
    pub fn int(index: *mut *mut value_fn)(uint32_t, value_le: *mut c_void, context: *mut c_void) -> typedef;
}
//
...
//
extern "C" {
    pub fn dm_array_del(info: *mut dm_array_info, root: dm_block_t) -> c_int;
}
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_array_cursor {
    pub info: *mut dm_array_info,
    pub cursor: dm_btree_cursor,
    pub block: *mut dm_block,
    pub ab: *mut array_block,
    pub index: c_uint,
}

extern "C" {
    pub fn dm_array_cursor_end(c: *mut dm_array_cursor);
}
extern "C" {
    pub fn dm_array_cursor_index(c: *mut dm_array_cursor) -> u32;
}
extern "C" {
    pub fn dm_array_cursor_next(c: *mut dm_array_cursor) -> c_int;
}
extern "C" {
    pub fn dm_array_cursor_skip(c: *mut dm_array_cursor, count: u32) -> c_int;
}
//
// value_le is only valid while the cursor points at the current value.
//
extern "C" {
    pub fn dm_array_cursor_get_value(c: *mut dm_array_cursor, value_le: *mut c_void);
}
// ----------------------------------------------------------------
