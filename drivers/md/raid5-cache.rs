...
//! Source: drivers/md/raid5-cache.c
#![no_std]
...
//
pub const R5L_POOL_SIZE: c_int = 4;
...
pub struct r5l_log {
    ...
    pub uuid_checksum: u32,
    pub to: *mut *mut sector_t device_size; / log device size, round,
// BLOCK_SECTORS
    pub at: *mut *mut sector_t max_free_space; / reclaim run if free space is,
// this size
    pub scan: *mut *mut sector_t last_checkpoint; / log tail. where recovery,
// starts from
    pub /: *mut *mut u64 last_cp_seq; / log tail sequence,
    pub /: *mut *mut sector_t log_start; / log head. where new data appends,
    pub /: *mut *mut u64 seq; / log head sequence,
    pub next_checkpoint: sector_t,
    pub io_mutex: mutex,
    pub /: *mut *mut *mut r5l_io_unit current_io; / current io_unit accepting new data,
    pub io_list_lock: spinlock_t,
    pub running,: *mut *mut list_head running_ios; / io_units which are still,
// and have not yet been completely
// written to the log
    pub completely: *mut *mut list_head io_end_ios; / io_units which have been,
// written to the log but not yet written
// to the RAID
    pub log: *mut *mut list_head flushing_ios; / io_units which are waiting for,
// cache flush
    pub /: *mut *mut list_head finished_ios; / io_units which settle down in log disk,
    pub flush_bio: bio,
    pub /: *mut *mut list_head no_mem_stripes; / pending stripes, -ENOMEM,
    pub io_kc: *mut kmem_cache,
    pub io_pool: mempool_t,
    pub bs: bio_set,
    pub meta_pool: mempool_t,
    pub reclaim_thread: *mut md_thread __rcu,
    pub be: *mut *mut unsigned long reclaim_target; / number of space that need to,
...
// state)
    pub iounit_wait: wait_queue_head_t,
    pub /: *mut *mut list_head no_space_stripes; / pending stripes, log has no space,
    pub no_space_stripes_lock: spinlock_t,
    pub need_cache_flush: bool,
// for r5c_cache
    pub r5c_journal_mode: enum r5c_journal_mode,
// all stripes in r5cache, in the order of seq at sh->log_start
    pub stripe_in_journal_list: list_head,
    pub stripe_in_journal_lock: spinlock_t,
    pub stripe_in_journal_count: core::sync::atomic::AtomicI32,
// to submit async io_units, to fulfill ordering of flush
    pub deferred_io_work: work_struct,
// to disable write back during in degraded mode
    pub disable_writeback_work: work_struct,
// to for chunk_aligned_read in writeback mode, details below
    pub tree_lock: spinlock_t,
    pub big_stripe_tree: radix_tree_root,
}
...
//
pub const R5C_RADIX_COUNT_SHIFT: c_int = 2;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct r5l_io_unit {
    pub log: *mut r5l_log,
    pub /: *mut *mut *mut page meta_page; / store meta block,
    pub /: *mut *mut int meta_offset; / current offset in meta_page,
    pub /: *mut *mut *mut bio current_bio;/ current_bio accepting new data,
    pub /: *mut *mut atomic_t pending_stripe;/ how many stripes not flushed to raid,
    pub /: *mut *mut u64 seq; / seq number of the metablock,
    pub /: *mut *mut sector_t log_start; / where the io_unit starts,
    pub /: *mut *mut sector_t log_end; / where the io_unit ends,
    pub /: *mut *mut list_head log_sibling; / log->running_ios,
    pub /: *mut *mut list_head stripe_list; / stripes added to the io_unit,
    pub state: c_int,
    pub need_split_bio: bool,
    pub split_bio: *mut bio,
    pub /: *mut *mut unsigned int has_flush:1; / include flush request,
    pub /: *mut *mut unsigned int has_fua:1; / include fua request,
    pub /: *mut *mut unsigned int has_null_flush:1; / include null flush request,
    pub /: *mut *mut unsigned int has_flush_payload:1; / include flush payload,
//
// io isn't sent yet, flush/fua request can only be submitted till it's
// the first IO in running_ios list
//
    pub io_deferred:1: c_uint,
    pub /: *mut *mut bio_list flush_barriers; / size == 0 flush bios,
}
...
#[no_mangle]
pub unsafe extern "C" fn r5c_is_writeback(log: *mut r5l_log) -> bool {
    bool r5c_is_writeback(struct r5l_log *log)
    {
    return (log != core::ptr::null_mut() &&
    log.r5c_journal_mode == R5C_JOURNAL_MODE_WRITE_BACK);
    }
#[no_mangle]
unsafe extern "C" fn r5l_ring_add(log: *mut r5l_log, start: sector_t, inc: sector_t) -> sector_t {
...
#[no_mangle]
unsafe extern "C" fn r5l_has_free_space(log: *mut r5l_log, size: sector_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn r5c_check_stripe_cache_usage(conf: *mut r5conf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn r5c_check_cached_full_stripe(conf: *mut r5conf) {
...
//
#[no_mangle]
unsafe extern "C" fn r5c_log_required_to_flush_cache(conf: *mut r5conf) -> sector_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn r5c_update_log_state(log: *mut r5l_log) {
    static inline void r5c_update_log_state(struct r5l_log *log)
    {
    struct r5conf *conf = log.rdev.mddev.private;
    sector_t free_space;
    sector_t reclaim_space;
    let mut wake_reclaim: bool = false;
    if (!r5c_is_writeback(log))
    return;
...
//
#[no_mangle]
pub unsafe extern "C" fn r5c_make_stripe_write_out(sh: *mut stripe_head) {
...
#[no_mangle]
unsafe extern "C" fn r5c_handle_data_cached(sh: *mut stripe_head) {
...
//
#[no_mangle]
unsafe extern "C" fn r5c_handle_parity_cached(sh: *mut stripe_head) {
...
//
#[no_mangle]
unsafe extern "C" fn r5c_finish_cache_stripe(sh: *mut stripe_head) {
...
#[no_mangle]
unsafe extern "C" fn r5l_io_run_stripes(io: *mut r5l_io_unit) {
...
#[no_mangle]
unsafe extern "C" fn r5l_log_run_stripes(log: *mut r5l_log) {
...
#[no_mangle]
unsafe extern "C" fn r5l_move_to_end_ios(log: *mut r5l_log) {
...
#[no_mangle]
unsafe extern "C" fn r5l_log_endio(bio: *mut bio) {
...
// finish flush only io_unit and PAYLOAD_FLUSH only io_unit
    ...
    while ((bi = bio_list_pop(&io.flush_barriers)) != core::ptr::null_mut()) {
    bio_endio(bi);
...
#[no_mangle]
unsafe extern "C" fn r5l_do_submit_io(log: *mut r5l_log, io: *mut r5l_io_unit) {
...
#[no_mangle]
unsafe extern "C" fn r5l_submit_io_async(work: *mut work_struct) {
    static void r5l_submit_io_async(struct work_struct *work)
    {
    struct r5l_log *log = container_of(work, struct r5l_log,
    deferred_io_work);
    struct r5l_io_unit *io = core::ptr::null_mut();
    unsigned long flags;
    spin_lock_irqsave(&log.io_list_lock, flags);
    if (!list_empty(&log.running_ios)) {
...
#[no_mangle]
unsafe extern "C" fn r5c_disable_writeback_async(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn r5l_submit_current_io(log: *mut r5l_log) {
    ...
    log.current_io = core::ptr::null_mut();
    spin_lock_irqsave(&log.io_list_lock, flags);
...
#[no_mangle]
unsafe extern "C" fn r5_reserve_log_entry(log: *mut r5l_log, io: *mut r5l_io_unit) {
...
#[no_mangle]
unsafe extern "C" fn r5l_get_meta(log: *mut r5l_log, payload_size: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r5l_append_payload_page(log: *mut r5l_log, page: *mut page) {
...
#[no_mangle]
unsafe extern "C" fn r5l_append_flush_payload(log: *mut r5l_log, sect: sector_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn r5l_write_stripe(log: *mut r5l_log, sh: *mut stripe_head) -> c_int {
    int r5l_write_stripe(struct r5l_log *log, struct stripe_head *sh)
    {
    struct r5conf *conf = sh.raid_conf;
    let mut write_disks: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn r5l_write_stripe_run(log: *mut r5l_log) {
...
#[no_mangle]
pub unsafe extern "C" fn r5l_handle_flush_request(log: *mut r5l_log, bio: *mut bio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r5l_run_no_space_stripes(log: *mut r5l_log) {
...
//
#[no_mangle]
unsafe extern "C" fn r5c_calculate_new_cp(conf: *mut r5conf) -> sector_t {
...
#[no_mangle]
unsafe extern "C" fn r5l_reclaimable_space(log: *mut r5l_log) -> sector_t {
...
#[no_mangle]
unsafe extern "C" fn r5l_run_no_mem_stripe(log: *mut r5l_log) {
...
#[no_mangle]
unsafe extern "C" fn r5l_complete_finished_ios(log: *mut r5l_log) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __r5l_stripe_write_finished(io: *mut r5l_io_unit) {
    static void __r5l_stripe_write_finished(struct r5l_io_unit *io)
    {
    struct r5l_log *log = io.log;
    struct r5conf *conf = log.rdev.mddev.private;
...
#[no_mangle]
pub unsafe extern "C" fn r5l_stripe_write_finished(sh: *mut stripe_head) {
    void r5l_stripe_write_finished(struct stripe_head *sh)
    {
    struct r5l_io_unit *io;
    io = sh.log_io;
    sh.log_io = core::ptr::null_mut();
    if (io && atomic_dec_and_test(&io.pending_stripe))
    __r5l_stripe_write_finished(io);
    }
#[no_mangle]
unsafe extern "C" fn r5l_log_flush_endio(bio: *mut bio) {
...
//
#[no_mangle]
pub unsafe extern "C" fn r5l_flush_stripe_to_raid(log: *mut r5l_log) {
...
// flush bio is running
    ...
    if (!do_flush)
    return;
    bio_init(&log.flush_bio, log.rdev.bdev, core::ptr::null_mut(), 0,
...
//
#[no_mangle]
unsafe extern "C" fn r5c_flush_stripe(conf: *mut r5conf, sh: *mut stripe_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn r5c_flush_cache(conf: *mut r5conf, num: c_int) {
...
#[no_mangle]
unsafe extern "C" fn r5c_do_reclaim(conf: *mut r5conf) {
...
#[no_mangle]
unsafe extern "C" fn r5l_do_reclaim(log: *mut r5l_log) {
    static void r5l_do_reclaim(struct r5l_log *log)
    {
    struct r5conf *conf = log.rdev.mddev.private;
    let mut reclaim_target: sector_t = xchg(&log.reclaim_target, 0);
...
#[no_mangle]
unsafe extern "C" fn r5l_reclaim_thread(thread: *mut md_thread) {
...
#[no_mangle]
pub unsafe extern "C" fn r5l_wake_reclaim(log: *mut r5l_log, space: sector_t) {
    void r5l_wake_reclaim(struct r5l_log *log, sector_t space)
    {
...
#[no_mangle]
pub unsafe extern "C" fn r5l_quiesce(log: *mut r5l_log, quiesce: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn r5l_log_disk_error(conf: *mut r5conf) -> bool {
...
pub const R5L_RECOVERY_PAGE_POOL_SIZE: c_int = 256;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct r5l_recovery_ctx {
    pub /: *mut *mut *mut page meta_page; / current meta,
    pub /: *mut *mut sector_t meta_total_blocks; / total size of current meta and data,
    pub /: *mut *mut sector_t pos; / recovery position,
    pub /: *mut *mut u64 seq; / recovery position seq,
    pub /: *mut *mut int data_parity_stripes; / number of data_parity stripes,
    pub /: *mut *mut int data_only_stripes; / number of data_only stripes,
    pub cached_list: list_head,
//
...
//
    pub ra_pool: [*mut page; R5L_RECOVERY_PAGE_POOL_SIZE],
    pub ra_bvec: [bio_vec; R5L_RECOVERY_PAGE_POOL_SIZE],
    pub /: *mut *mut sector_t pool_offset; / offset of first page in the pool,
    pub /: *mut *mut int total_pages; / total allocated pages,
    pub /: *mut *mut int valid_pages; / pages with valid data,
}
...
#[no_mangle]
unsafe extern "C" fn r5l_recovery_reset_stripe(sh: *mut stripe_head) {
...
// in case device is broken
    ...
    {
    struct stripe_head *sh;
    sh = raid5_get_active_stripe(conf, core::ptr::null_mut(), stripe_sect,
    noblock ? R5_GAS_NOBLOCK : 0);
    if (!sh)
    return core::ptr::null_mut();  /* no more stripe available */
    r5l_recovery_reset_stripe(sh);
    return sh;
    }
    static struct stripe_head *
...
//
    ...
    let mut mb_offset: sector_t = sizeof(struct r5l_meta_block);
    let mut log_offset: sector_t = r5l_ring_add(log, ctx.pos, BLOCK_SECTORS);
    struct page *page;
    struct r5l_payload_data_parity *payload;
...
//
    ...
    if (!sh) {
    let mut new_size: c_int = conf.min_nr_stripes * 2;
...
//
    ...
    struct mddev *mddev = log.rdev.mddev;
    struct page *page;
    let mut next_checkpoint: sector_t = MaxSector;
    page = alloc_page(GFP_KERNEL);
    if (!page) {
    ...
    struct r5conf *conf = mddev.private;
    struct stripe_head *sh, *next;
    let mut cleared_pending: bool = false;
...
#[no_mangle]
unsafe extern "C" fn r5l_recovery_log(log: *mut r5l_log) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r5l_write_super(log: *mut r5l_log, cp: sector_t) {
    static void r5l_write_super(struct r5l_log *log, sector_t cp)
    {
    struct mddev *mddev = log.rdev.mddev;
...
#[no_mangle]
unsafe extern "C" fn r5c_journal_mode_show(mddev: *mut mddev, page: *mut c_char) -> isize {
...
//
#[no_mangle]
pub unsafe extern "C" fn r5c_journal_mode_set(mddev: *mut mddev, mode: c_int) -> c_int {
    ...
    {
    let mut mode: c_int = ARRAY_SIZE(r5c_journal_mode_str);
...
//
#[no_mangle]
pub unsafe extern "C" fn r5c_release_extra_page(sh: *mut stripe_head) {
...
#[no_mangle]
pub unsafe extern "C" fn r5c_use_extra_page(sh: *mut stripe_head) {
...
// stop counting this stripe in big_stripe_tree
    ...
    pslot = radix_tree_lookup_slot(&log.big_stripe_tree,
    tree_index);
    BUG_ON(pslot == core::ptr::null_mut());
    refcount = (uintptr_t)radix_tree_deref_slot_protected(
    pslot, &log.tree_lock) >>
    R5C_RADIX_COUNT_SHIFT;
    if (refcount == 1)
...
#[no_mangle]
pub unsafe extern "C" fn r5c_cache_data(log: *mut r5l_log, sh: *mut stripe_head) -> c_int {
...
// meta + data
    ...
    r5l_add_no_space_stripe(log, sh);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !r5l_has_free_space(log, _arg: reserve)) -> else {
    if (sh.log_start == log.last_checkpoint)
    BUG();
    else
    r5l_add_no_space_stripe(log, sh);
...
#[no_mangle]
pub unsafe extern "C" fn r5c_big_stripe_cached(conf: *mut r5conf, sect: sector_t) -> bool {
    ...
    return slot != core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn r5l_load_log(log: *mut r5l_log) -> c_int {
    static int r5l_load_log(struct r5l_log *log)
    {
    struct md_rdev *rdev = log.rdev;
    struct page *page;
    struct r5l_meta_block *mb;
    let mut cp: sector_t = log.rdev.journal_tail;
    u32 stored_crc, expected_crc;
    let mut create_super: bool = false;
    let mut ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn r5l_start(log: *mut r5l_log) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn r5c_update_on_rdev_error(mddev: *mut mddev, rdev: *mut md_rdev) {
...
#[no_mangle]
pub unsafe extern "C" fn r5l_init_log(conf: *mut r5conf, rdev: *mut md_rdev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn r5l_exit_log(conf: *mut r5conf) {
...
//
    WRITE_ONCE(conf.log, core::ptr::null_mut());
