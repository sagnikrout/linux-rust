...
pub const DM_VERITY_ENV_LENGTH: c_int = 46;

pub const DM_VERITY_DEFAULT_PREFETCH_SIZE: c_int = 262144;
pub const DM_VERITY_USE_BH_DEFAULT_BYTES: c_int = 8192;
pub const DM_VERITY_MAX_CORRUPTED_ERRS: c_int = 100;

    DM_VERITY_ROOT_HASH_VERIFICATION_OPTS)
    let mut dm_verity_prefetch_cluster: static unsigned int = DM_VERITY_DEFAULT_PREFETCH_SIZE;
    ...
    module_param_array_named(use_bh_bytes, dm_verity_use_bh_bytes, uint, core::ptr::null_mut(), 0644);
    static DEFINE_STATIC_KEY_FALSE(use_bh_wq_enabled);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_verity_prefetch_work {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct buffer_aux {
    pub hash_verified: c_int,
}
...
//
#[no_mangle]
unsafe extern "C" fn dm_bufio_alloc_callback(buf: *mut dm_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn verity_map_sector(v: *mut dm_verity, bi_sector: sector_t) -> sector_t {
...
// ctx = *v->initial_hashstate.sha256;
    ...
    if (unlikely(v.initial_hashstate.shash == core::ptr::null_mut())) {
...
// Version 1: salt at beginning
    ...
    {
    let mut position: sector_t = verity_position_at_level(v, block, level);
    unsigned int idx;
...
//
    ...
    char *envp[] = { verity_env, core::ptr::null_mut() };
    const char *type_str = "";
...
//
    ...
    aux.hash_verified = 1;
#[no_mangle]
pub unsafe extern "C" fn if(io->in_bh: static_branch_unlikely(&use_bh_wq_enabled) &&) -> else {
//
...
// is_zero = false;
    ...
    let mut blkno: sector_t = block.blkno;
    u8 *data = block.data;
    if (static_branch_unlikely(&use_bh_wq_enabled) && io.in_bh) {
//
// Error handling code (FEC included) cannot be run in a
...
#[no_mangle]
unsafe extern "C" fn verity_clear_pending_blocks(io: *mut dm_verity_io) {
    ...
    io.pending_blocks[i].data = core::ptr::null_mut();
    }
    io.num_pending = 0;
    }
    ...
    struct bio *bio)
    {
    let mut block_size: c_uint = 1 << v.data_dev_block_bits;
    int i, r;
    if (io.num_pending == 2) {
...
//
#[no_mangle]
unsafe extern "C" fn verity_verify_io(io: *mut dm_verity_io) -> c_int {
    static int verity_verify_io(struct dm_verity_io *io)
    {
    struct dm_verity *v = io.v;
    let mut block_size: c_uint = 1 << v.data_dev_block_bits;
    let mut max_pending: c_int = v.use_sha256_finup_2x ? 2 : 1;
...
//
    ...
    let mut blkno: sector_t = io.block + b;
    struct pending_block *block;
    bool is_zero;
    struct bio_vec bv;
    void *data;
...
//
#[no_mangle]
pub unsafe extern "C" fn verity_is_system_shutting_down() -> bool {
...
#[no_mangle]
unsafe extern "C" fn restart_io_error(w: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn verity_finish_io(io: *mut dm_verity_io, status: blk_status_t) {
...
#[no_mangle]
unsafe extern "C" fn verity_work(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn verity_bh_work(w: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn verity_use_bh(bytes: c_uint, ioprio: c_ushort) -> bool {
...
#[no_mangle]
unsafe extern "C" fn verity_end_io(bio: *mut bio) {
    static void verity_end_io(struct bio *bio)
    {
    struct dm_verity_io *io = bio.bi_private;
    let mut ioprio: c_ushort = IOPRIO_PRIO_CLASS(bio.bi_ioprio);
    let mut bytes: c_uint = io.n_blocks << io.v.data_dev_block_bits;
    if (bio.bi_status &&
...
//
#[no_mangle]
unsafe extern "C" fn verity_prefetch_io(work: *mut work_struct) {
    ...
    verity_hash_at_level(v, pw.block, i, &hash_block_start, core::ptr::null_mut());
    verity_hash_at_level(v, pw.block + pw.n_blocks - 1, i, &hash_block_end, core::ptr::null_mut());
    if (!i) {
    let mut cluster: c_uint = READ_ONCE(dm_verity_prefetch_cluster);
    ...
    {
    let mut block: sector_t = io.block;
    let mut n_blocks: c_uint = io.n_blocks;
    struct dm_verity_prefetch_work *pw;
    if (v.validated_blocks) {
...
//
#[no_mangle]
unsafe extern "C" fn verity_map(ti: *mut dm_target, bio: *mut bio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn verity_postsuspend(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn verity_io_hints(ti: *mut dm_target, limits: *mut queue_limits) {
...
#[no_mangle]
unsafe extern "C" fn verity_free_sig(v: *mut dm_verity) {
...
#[no_mangle]
pub unsafe extern "C" fn verity_free_sig(v: *mut dm_verity) {
    static inline void verity_free_sig(struct dm_verity *v)
    {
    }

#[no_mangle]
unsafe extern "C" fn verity_dtr(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn verity_alloc_most_once(v: *mut dm_verity) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn verity_alloc_zero_digest(v: *mut dm_verity) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn verity_is_verity_mode(arg_name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn verity_parse_verity_mode(v: *mut dm_verity, arg_name: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(arg_name, _arg: DM_VERITY_OPT_RESTART)) -> else {
    else if (!strcasecmp(arg_name, DM_VERITY_OPT_RESTART))
    v.mode = DM_VERITY_MODE_RESTART;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(arg_name, _arg: DM_VERITY_OPT_PANIC)) -> else {
    else if (!strcasecmp(arg_name, DM_VERITY_OPT_PANIC))
    v.mode = DM_VERITY_MODE_PANIC;
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn verity_is_verity_error_mode(arg_name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn verity_parse_verity_error_mode(v: *mut dm_verity, arg_name: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(arg_name, _arg: DM_VERITY_OPT_ERROR_PANIC)) -> else {
...
#[no_mangle]
unsafe extern "C" fn verity_setup_hash_alg(v: *mut dm_verity, alg_name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn verity_setup_salt_and_hashstate(v: *mut dm_verity, arg: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn verity_ctr(ti: *mut dm_target, argc: c_uint, argv: *mut c_char) -> c_int {
    static int verity_ctr(struct dm_target *ti, unsigned int argc, char **argv)
    {
    struct dm_verity *v;
    let mut verify_args: dm_verity_sig_opts = {0};
...
// Root hash signature is an optional parameter
    ...
    if (IS_ERR(v.io)) {
    r = PTR_ERR(v.io);
    v.io = core::ptr::null_mut();
    ti.error = "Cannot allocate dm io";
    goto bad;
    }
    v.bufio = dm_bufio_client_create(v.hash_dev.bdev,
    1 << v.hash_dev_block_bits, 1, sizeof(struct buffer_aux),
    dm_bufio_alloc_callback, core::ptr::null_mut(),
    v.use_bh_wq ? DM_BUFIO_CLIENT_NO_SLEEP : 0);
    if (IS_ERR(v.bufio)) {
    ti.error = "Cannot initialize dm-bufio";
    r = PTR_ERR(v.bufio);
    v.bufio = core::ptr::null_mut();
    goto bad;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn dm_verity_get_mode(ti: *mut dm_target) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dm_verity_get_root_digest(ti: *mut dm_target, root_digest: *mut u8, digest_size: *mut c_uint) -> c_int {
...
// root_digest = kmemdup(v->root_digest, v->digest_size, GFP_KERNEL);
    if (*root_digest == core::ptr::null_mut())
    return -ENOMEM;
...
//
#[no_mangle]
unsafe extern "C" fn verity_preresume(ti: *mut dm_target) -> c_int {
    ...
    return 0;
    bad:
    security_bdev_setintegrity(bdev, LSM_INT_DMVERITY_ROOTHASH, core::ptr::null_mut(), 0);
    return r;
    }
...
#[no_mangle]
unsafe extern "C" fn dm_verity_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dm_verity_exit() -> void __exit {
...
//
#[no_mangle]
pub unsafe extern "C" fn dm_is_verity_target(ti: *mut dm_target) -> bool {
