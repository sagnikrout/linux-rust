...
//! Source: drivers/md/dm-unstripe.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct unstripe_c {
    pub dev: *mut dm_dev,
    pub physical_start: sector_t,
    pub stripes: u32,
    pub unstripe: u32,
    pub unstripe_width: sector_t,
    pub unstripe_offset: sector_t,
    pub chunk_size: u32,
    pub chunk_shift: u8,
}

#[no_mangle]
unsafe extern "C" fn cleanup_unstripe(uc: *mut unstripe_c, ti: *mut dm_target) {
...
//
#[no_mangle]
unsafe extern "C" fn unstripe_ctr(ti: *mut dm_target, argc: c_uint, argv: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unstripe_dtr(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn map_to_core(ti: *mut dm_target, bio: *mut bio) -> sector_t {
    static sector_t map_to_core(struct dm_target *ti, struct bio *bio)
    {
    struct unstripe_c *uc = ti.private;
    let mut sector: sector_t = dm_target_offset(ti, bio.bi_iter.bi_sector);
    let mut tmp_sector: sector_t = sector;
...
#[no_mangle]
unsafe extern "C" fn unstripe_map(ti: *mut dm_target, bio: *mut bio) -> c_int {
