...
//! Source: drivers/md/dm-writecache.c
#![no_std]
...
pub const HIGH_WATERMARK: c_int = 50;
pub const LOW_WATERMARK: c_int = 45;

pub const ENDIO_LATENCY: c_int = 16;
pub const WRITEBACK_LATENCY: c_int = 64;
pub const AUTOCOMMIT_BLOCKS_SSD: c_int = 65536;
pub const AUTOCOMMIT_BLOCKS_PMEM: c_int = 64;
pub const AUTOCOMMIT_MSEC: c_int = 1000;
pub const MAX_AGE_DIV: c_int = 16;

pub const BITMAP_GRANULARITY: c_int = 65536;

// Macro flag: #define DM_WRITECACHE_HAS_PMEM
...
// Macro flag: #define DM_WRITECACHE_HANDLE_HARDWARE_ERRORS

pub const MEMORY_SUPERBLOCK_MAGIC: c_uint = 0x23489321;
pub const MEMORY_SUPERBLOCK_VERSION: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wc_memory_entry {
    pub original_sector: __le64,
    pub seq_count: __le64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct wc_memory_superblock {
    union {
    struct {
    pub magic: __le32,
    pub version: __le32,
...
pub struct wc_entry {
    pub rb_node: rb_node,
    pub lru: list_head,
    pub wc_list_contiguous: c_ushort,

    pub 1: bool write_in_progress :,
    pub 47: unsigned long index :,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_writecache {
    pub lock: mutex,
    pub lru: list_head,
    union {
    pub freelist: list_head,
    struct {
    pub freetree: rb_root,
    pub current_free: *mut wc_entry,
}
...
pub const WB_LIST_INLINE: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct writeback_struct {
    pub endio_entry: list_head,
    pub wc: *mut dm_writecache,
    pub wc_list: *mut wc_entry,
    pub wc_list_n: c_uint,
    pub wc_list_inline: [*mut wc_entry; WB_LIST_INLINE],
    pub bio: bio,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct copy_struct {
    pub endio_entry: list_head,
    pub wc: *mut dm_writecache,
    pub e: *mut wc_entry,
...
#[no_mangle]
unsafe extern "C" fn wc_lock(wc: *mut dm_writecache) {
    static void wc_lock(struct dm_writecache *wc)
    {
    mutex_lock(&wc.lock);
    }
#[no_mangle]
unsafe extern "C" fn wc_unlock(wc: *mut dm_writecache) {
...
#[no_mangle]
unsafe extern "C" fn persistent_memory_claim(wc: *mut dm_writecache) -> c_int {
    ...
    &wc.memory_map, &pfn);
    if (da < 0) {
    wc.memory_map = core::ptr::null_mut();
    r = da;
    goto err2;
    }
    if (!pfn_valid(pfn)) {
    ...
    p - i, DAX_ACCESS, core::ptr::null_mut(), &pfn);
    if (daa <= 0) {
    r = daa ? daa : -EINVAL;
    goto err3;
    }
...
#[no_mangle]
unsafe extern "C" fn persistent_memory_release(wc: *mut dm_writecache) {
...
#[no_mangle]
unsafe extern "C" fn persistent_memory_page_offset(addr: *mut c_void) -> c_uint {
    static unsigned int persistent_memory_page_offset(void *addr)
    {
    return (unsigned long)addr & (PAGE_SIZE - 1);
    }
#[no_mangle]
unsafe extern "C" fn persistent_memory_flush_cache(ptr: *mut c_void, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn persistent_memory_invalidate_cache(ptr: *mut c_void, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn cache_sector(wc: *mut dm_writecache, e: *mut wc_entry) -> sector_t {
...
#[no_mangle]
unsafe extern "C" fn read_original_sector(wc: *mut dm_writecache, e: *mut wc_entry) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn read_seq_count(wc: *mut dm_writecache, e: *mut wc_entry) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn clear_seq_count(wc: *mut dm_writecache, e: *mut wc_entry) {
...
#[no_mangle]
unsafe extern "C" fn writecache_flush_all_metadata(wc: *mut dm_writecache) {
...
#[no_mangle]
unsafe extern "C" fn writecache_flush_region(wc: *mut dm_writecache, ptr: *mut c_void, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn writecache_notify_io(error: c_ulong, unsup: c_ulong, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn writecache_wait_for_ios(wc: *mut dm_writecache, direction: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ssd_commit_flushed(wc: *mut dm_writecache, wait_for_ios: bool) {
    ...
    let mut bitmap_bits: c_uint = wc.dirty_bitmap_size * 8;
    let mut i: c_uint = 0;
    while (1) {
    unsigned int j;
...
// writing via async dm-io (implied by notify.fn above) won't return an error
    (void) dm_io(&req, 1, &region, core::ptr::null_mut(), core::ptr::null_mut(), IOPRIO_DEFAULT);
    i = j;
    }
...
#[no_mangle]
unsafe extern "C" fn ssd_commit_superblock(wc: *mut dm_writecache) {
    ...
    req.client = wc.dm_io;
    req.notify.fn = core::ptr::null_mut();
    req.notify.context = core::ptr::null_mut();
    r = dm_io(&req, 1, &region, core::ptr::null_mut(), core::ptr::null_mut(), IOPRIO_DEFAULT);
    if (unlikely(r))
    writecache_error(wc, r, "error writing superblock");
    }
#[no_mangle]
unsafe extern "C" fn writecache_commit_flushed(wc: *mut dm_writecache, wait_for_ios: bool) {
...
#[no_mangle]
unsafe extern "C" fn writecache_disk_flush(wc: *mut dm_writecache, dev: *mut dm_dev) {
    static void writecache_disk_flush(struct dm_writecache *wc, struct dm_dev *dev)
    {
    int r;
    struct dm_io_region region;
    ...
    req.mem.ptr.addr = core::ptr::null_mut();
    req.client = wc.dm_io;
    req.notify.fn = core::ptr::null_mut();
    r = dm_io(&req, 1, &region, core::ptr::null_mut(), core::ptr::null_mut(), IOPRIO_DEFAULT);
    if (unlikely(r))
...
pub const WFE_RETURN_FOLLOWING: c_int = 1;
pub const WFE_LOWEST_SEQ: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn writecache_insert_entry(wc: *mut dm_writecache, ins: *mut wc_entry) {
    static void writecache_insert_entry(struct dm_writecache *wc, struct wc_entry *ins)
    {
    struct wc_entry *e;
    struct rb_node **node = &wc.tree.rb_node, *parent = core::ptr::null_mut();
    while (*node) {
    e = container_of(*node, struct wc_entry, rb_node);
    parent = &e.rb_node;
...
#[no_mangle]
unsafe extern "C" fn writecache_unlink(wc: *mut dm_writecache, e: *mut wc_entry) {
...
#[no_mangle]
unsafe extern "C" fn writecache_add_to_freelist(wc: *mut dm_writecache, e: *mut wc_entry) {
    static void writecache_add_to_freelist(struct dm_writecache *wc, struct wc_entry *e)
    {
    if (WC_MODE_SORT_FREELIST(wc)) {
    struct rb_node **node = &wc.freetree.rb_node, *parent = core::ptr::null_mut();
    if (unlikely(!*node))
    wc.current_free = e;
    while (*node) {
    parent = *node;
...
#[no_mangle]
pub unsafe extern "C" fn writecache_verify_watermark(wc: *mut dm_writecache) {
...
#[no_mangle]
unsafe extern "C" fn writecache_max_age_timer(t: *mut timer_list) {
    ...
    wc.current_free = next ? container_of(next, struct wc_entry, rb_node) : core::ptr::null_mut();
    } else {
...
#[no_mangle]
unsafe extern "C" fn writecache_free_entry(wc: *mut dm_writecache, e: *mut wc_entry) {
...
#[no_mangle]
unsafe extern "C" fn writecache_wait_on_freelist(wc: *mut dm_writecache) {
...
#[no_mangle]
unsafe extern "C" fn writecache_poison_lists(wc: *mut dm_writecache) {
...
#[no_mangle]
unsafe extern "C" fn writecache_flush_entry(wc: *mut dm_writecache, e: *mut wc_entry) {
...
#[no_mangle]
unsafe extern "C" fn writecache_entry_is_committed(wc: *mut dm_writecache, e: *mut wc_entry) -> bool {
...
#[no_mangle]
unsafe extern "C" fn writecache_flush(wc: *mut dm_writecache) {
...
#[no_mangle]
unsafe extern "C" fn writecache_flush_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn writecache_autocommit_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn writecache_schedule_autocommit(wc: *mut dm_writecache) {
...
#[no_mangle]
unsafe extern "C" fn writecache_discard(wc: *mut dm_writecache, start: sector_t, end: sector_t) {
    static void writecache_discard(struct dm_writecache *wc, sector_t start, sector_t end)
    {
    struct wc_entry *e;
    let mut discarded_something: bool = false;
...
#[no_mangle]
unsafe extern "C" fn writecache_wait_for_writeback(wc: *mut dm_writecache) -> bool {
...
#[no_mangle]
unsafe extern "C" fn writecache_suspend(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn writecache_alloc_entries(wc: *mut dm_writecache) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn writecache_read_metadata(wc: *mut dm_writecache, n_sectors: sector_t) -> c_int {
    ...
    req.client = wc.dm_io;
    req.notify.fn = core::ptr::null_mut();
    return dm_io(&req, 1, &region, core::ptr::null_mut(), core::ptr::null_mut(), IOPRIO_DEFAULT);
    }
#[no_mangle]
unsafe extern "C" fn writecache_resume(ti: *mut dm_target) {
    static void writecache_resume(struct dm_target *ti)
    {
    struct dm_writecache *wc = ti.private;
    size_t b;
    let mut need_flush: bool = false;
    __le64 sb_seq_count;
    int r;
    wc_lock(wc);
    ...
    if (WC_MODE_SORT_FREELIST(wc)) {
    wc.freetree = RB_ROOT;
    wc.current_free = core::ptr::null_mut();
    } else {
...
#[no_mangle]
unsafe extern "C" fn process_flush_mesg(argc: c_uint, argv: *mut c_char, wc: *mut dm_writecache) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn process_flush_on_suspend_mesg(argc: c_uint, argv: *mut c_char, wc: *mut dm_writecache) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn activate_cleaner(wc: *mut dm_writecache) {
...
#[no_mangle]
unsafe extern "C" fn process_cleaner_mesg(argc: c_uint, argv: *mut c_char, wc: *mut dm_writecache) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn process_clear_stats_mesg(argc: c_uint, argv: *mut c_char, wc: *mut dm_writecache) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(argv[0], _arg: "flush_on_suspend")) -> else {
    else if (!strcasecmp(argv[0], "flush_on_suspend"))
    r = process_flush_on_suspend_mesg(argc, argv, wc);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(argv[0], _arg: "cleaner")) -> else {
    else if (!strcasecmp(argv[0], "cleaner"))
    r = process_cleaner_mesg(argc, argv, wc);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(argv[0], _arg: "clear_stats")) -> else {
...
#[no_mangle]
unsafe extern "C" fn memcpy_flushcache_optimized(dest: *mut c_void, source: *mut c_void, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn bio_copy_block(wc: *mut dm_writecache, bio: *mut bio, data: *mut c_void) {
    static void bio_copy_block(struct dm_writecache *wc, struct bio *bio, void *data)
    {
    void *buf;
    unsigned int size;
    let mut rw: c_int = bio_data_dir(bio);
    let mut remaining_size: c_uint = wc.block_size;
    do {
    let mut bv: bio_vec = bio_iter_iovec(bio, bio.bi_iter);
...
#[no_mangle]
unsafe extern "C" fn writecache_flush_thread(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn writecache_offload_bio(wc: *mut dm_writecache, bio: *mut bio) {
...
#[no_mangle]
unsafe extern "C" fn writecache_map_read(wc: *mut dm_writecache, bio: *mut bio) -> enum wc_map_op {
    ...
    {
    let mut bio_size: c_uint = wc.block_size;
    let mut start_cache_sec: sector_t = cache_sector(wc, e);
    let mut current_cache_sec: sector_t = start_cache_sec + (bio_size >> SECTOR_SHIFT);
...
#[no_mangle]
unsafe extern "C" fn writecache_map_write(wc: *mut dm_writecache, bio: *mut bio) -> enum wc_map_op {
    static enum wc_map_op writecache_map_write(struct dm_writecache *wc, struct bio *bio)
    {
    struct wc_entry *e;
    do {
    let mut found_entry: bool = false;
    let mut search_used: bool = false;
    if (writecache_has_error(wc)) {
    wc.stats.writes += bio.bi_iter.bi_size >> wc.block_size_bits;
    return WC_MAP_ERROR;
    }
...
#[no_mangle]
unsafe extern "C" fn writecache_map_flush(wc: *mut dm_writecache, bio: *mut bio) -> enum wc_map_op {
    ...
    return WC_MAP_ERROR;
#[no_mangle]
pub unsafe extern "C" fn if(unlikely(wc->metadata_only): unlikely(wc->cleaner) ||) -> else {
...
#[no_mangle]
unsafe extern "C" fn writecache_map_discard(wc: *mut dm_writecache, bio: *mut bio) -> enum wc_map_op {
...
#[no_mangle]
unsafe extern "C" fn writecache_map(ti: *mut dm_target, bio: *mut bio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn writecache_end_io(ti: *mut dm_target, bio: *mut bio, status: *mut blk_status_t) -> c_int {
    static int writecache_end_io(struct dm_target *ti, struct bio *bio, blk_status_t *status)
    {
    struct dm_writecache *wc = ti.private;
    if (bio.bi_private == (void *)1) {
    let mut dir: c_int = bio_data_dir(bio);
...
#[no_mangle]
unsafe extern "C" fn writecache_io_hints(ti: *mut dm_target, limits: *mut queue_limits) {
...
#[no_mangle]
unsafe extern "C" fn writecache_writeback_endio(bio: *mut bio) {
...
#[no_mangle]
unsafe extern "C" fn writecache_copy_endio(read_err: c_int, write_err: c_ulong, ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __writecache_endio_pmem(wc: *mut dm_writecache, list: *mut list_head) {
    static void __writecache_endio_pmem(struct dm_writecache *wc, struct list_head *list)
    {
    unsigned int i;
    struct writeback_struct *wb;
    struct wc_entry *e;
    let mut n_walked: c_ulong = 0;
    do {
...
#[no_mangle]
unsafe extern "C" fn __writecache_endio_ssd(wc: *mut dm_writecache, list: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn writecache_endio_thread(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wc_add_block(wb: *mut writeback_struct, e: *mut wc_entry) -> bool {
    static bool wc_add_block(struct writeback_struct *wb, struct wc_entry *e)
    {
    struct dm_writecache *wc = wb.wc;
    let mut block_size: c_uint = wc.block_size;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct writeback_list {
    pub list: list_head,
    pub size: usize,
}

#[no_mangle]
unsafe extern "C" fn __writeback_throttle(wc: *mut dm_writecache, wbl: *mut writeback_list) {
...
#[no_mangle]
unsafe extern "C" fn __writecache_writeback_pmem(wc: *mut dm_writecache, wbl: *mut writeback_list) {
...
#[no_mangle]
unsafe extern "C" fn __writecache_writeback_ssd(wc: *mut dm_writecache, wbl: *mut writeback_list) {
...
#[no_mangle]
unsafe extern "C" fn writecache_writeback(work: *mut work_struct) {
    static void writecache_writeback(struct work_struct *work)
    {
    struct dm_writecache *wc = container_of(work, struct dm_writecache, writeback_work);
    struct blk_plug plug;
    struct wc_entry *f, *g, *e = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn init_memory(wc: *mut dm_writecache) -> c_int {
    static int init_memory(struct dm_writecache *wc)
    {
    size_t b;
    int r;
    r = calculate_memory_size(wc.memory_map_size, wc.block_size, &wc.n_blocks, core::ptr::null_mut());
    if (r)
    return r;
...
#[no_mangle]
unsafe extern "C" fn writecache_dtr(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn writecache_ctr(ti: *mut dm_target, argc: c_uint, argv: *mut c_char) -> c_int {
    ...
    int i, r;
    char dummy;
    let mut high_wm_percent: c_int = HIGH_WATERMARK;
    let mut low_wm_percent: c_int = LOW_WATERMARK;
    uint64_t x;
    ...
    wc.endio_thread = core::ptr::null_mut();
...
//
    ...
    wc.flush_thread = core::ptr::null_mut();
...
// this is limitation of test_bit functions
    ...
    wc.dm_kcopyd = core::ptr::null_mut();
    goto bad;
    }
