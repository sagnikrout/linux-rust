...
//! Source: drivers/md/bcache/super.c
#![no_std]
...
pub const BCACHE_MINORS: c_int = 128;
// limitation of bcache devices number on single system

// Superblock
#[no_mangle]
unsafe extern "C" fn get_bucket_size(sb: *mut cache_sb, s: *mut cache_sb_disk) -> c_uint {
    static unsigned int get_bucket_size(struct cache_sb *sb, struct cache_sb_disk *s)
    {
    let mut bucket_size: c_uint = le16_to_cpu(s.bucket_size);
...
#[no_mangle]
unsafe extern "C" fn write_bdev_super_endio(bio: *mut bio) {
...
#[no_mangle]
pub unsafe extern "C" fn CLOSURE_CALLBACK(_arg: bch_write_bdev_super_unlock) -> static {
...
#[no_mangle]
pub unsafe extern "C" fn bch_write_bdev_super(dc: *mut cached_dev, parent: *mut closure) {
...
#[no_mangle]
unsafe extern "C" fn write_super_endio(bio: *mut bio) {
...
#[no_mangle]
pub unsafe extern "C" fn CLOSURE_CALLBACK(_arg: bcache_write_super_unlock) -> static {
...
#[no_mangle]
pub unsafe extern "C" fn bcache_write_super(c: *mut cache_set) {
    void bcache_write_super(struct cache_set *c)
    {
    struct closure *cl = &c.sb_write;
    struct cache *ca = c.cache;
    struct bio *bio = &ca.sb_bio;
    let mut version: c_uint = BCACHE_SB_VERSION_CDEV_WITH_UUID;
...
// UUID io
#[no_mangle]
unsafe extern "C" fn uuid_endio(bio: *mut bio) {
...
#[no_mangle]
pub unsafe extern "C" fn CLOSURE_CALLBACK(_arg: uuid_io_unlock) -> static {
...
#[no_mangle]
unsafe extern "C" fn __uuid_write(c: *mut cache_set) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bch_uuid_write(c: *mut cache_set) -> c_int {
    int bch_uuid_write(struct cache_set *c)
    {
    let mut ret: c_int = __uuid_write(c);
    if (!ret)
    bch_journal_meta(c, core::ptr::null_mut());
    return ret;
    }
...
//
#[no_mangle]
unsafe extern "C" fn prio_endio(bio: *mut bio) {
...
#[no_mangle]
unsafe extern "C" fn prio_io(ca: *mut cache, bucket: u64, opf: blk_opf_t) {
...
#[no_mangle]
pub unsafe extern "C" fn bch_prio_write(ca: *mut cache, wait: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prio_read(ca: *mut cache, bucket: u64) -> c_int {
    static int prio_read(struct cache *ca, uint64_t bucket)
    {
    struct prio_set *p = ca.disk_buckets;
    struct bucket_disk *d = p.data + prios_per_bucket(ca), *end = d;
    struct bucket *b;
    let mut bucket_nr: c_uint = 0;
...
// Bcache device
#[no_mangle]
unsafe extern "C" fn open_dev(disk: *mut gendisk, mode: blk_mode_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn release_dev(b: *mut gendisk) {
...
#[no_mangle]
pub unsafe extern "C" fn bcache_device_stop(d: *mut bcache_device) {
...
#[no_mangle]
unsafe extern "C" fn bcache_device_unlink(d: *mut bcache_device) {
...
#[no_mangle]
unsafe extern "C" fn bcache_device_detach(d: *mut bcache_device) {
    ...
    d.c.devices[d.id] = core::ptr::null_mut();
    closure_put(&d.c.caching);
    d.c = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn first_minor_to_idx(first_minor: c_int) -> c_int {
    static inline int first_minor_to_idx(int first_minor)
    {
    return (first_minor/BCACHE_MINORS);
    }
#[no_mangle]
pub unsafe extern "C" fn idx_to_first_minor(idx: c_int) -> c_int {
    static inline int idx_to_first_minor(int idx)
    {
    return (idx * BCACHE_MINORS);
    }
#[no_mangle]
unsafe extern "C" fn bcache_device_free(d: *mut bcache_device) {
    ...
    pr_err("bcache device (core::ptr::null_mut() gendisk) stopped\n");
    if (d.c)
    ...
    d.stripe_size = 1 << 31;
#[no_mangle]
pub unsafe extern "C" fn if(BCH_MIN_STRIPE_SZ: d->stripe_size <) -> else {
...
// Cached device
#[no_mangle]
unsafe extern "C" fn calc_cached_dev_sectors(c: *mut cache_set) {
...
pub const BACKING_DEV_OFFLINE_TIMEOUT: c_int = 5;
#[no_mangle]
unsafe extern "C" fn cached_dev_status_update(arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bch_cached_dev_run(dc: *mut cached_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cancel_writeback_rate_update_dwork(dc: *mut cached_dev) {
    static void cancel_writeback_rate_update_dwork(struct cached_dev *dc)
    {
    let mut time_out: c_int = WRITEBACK_RATE_UPDATE_SECS_MAX * HZ;
    do {
...
#[no_mangle]
unsafe extern "C" fn cached_dev_detach_finish(w: *mut work_struct) {
    ...
    dc.writeback_thread = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn bch_cached_dev_detach(dc: *mut cached_dev) {
...
//
    ...
    uint8_t *set_uuid)
    {
    let mut rtime: u32 = cpu_to_le32((u32)ktime_get_real_seconds());
    struct uuid_entry *u;
...
#[no_mangle]
pub unsafe extern "C" fn bch_cached_dev_release(kobj: *mut kobject) {
...
#[no_mangle]
pub unsafe extern "C" fn CLOSURE_CALLBACK(_arg: cached_dev_free) -> static {
...
#[no_mangle]
pub unsafe extern "C" fn CLOSURE_CALLBACK(_arg: cached_dev_flush) -> static {
...
#[no_mangle]
unsafe extern "C" fn cached_dev_init(dc: *mut cached_dev, block_size: c_uint) -> c_int {
    ...
    closure_init(&dc.disk.cl, core::ptr::null_mut());
...
// attach to a matched cache set if it exists
    ...
    bch_cached_dev_attach(dc, c, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn bch_flash_dev_release(kobj: *mut kobject) {
...
#[no_mangle]
pub unsafe extern "C" fn CLOSURE_CALLBACK(_arg: flash_dev_free) -> static {
...
#[no_mangle]
pub unsafe extern "C" fn CLOSURE_CALLBACK(_arg: flash_dev_flush) -> static {
...
#[no_mangle]
unsafe extern "C" fn flash_dev_run(c: *mut cache_set, u: *mut uuid_entry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flash_devs_run(c: *mut cache_set) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bch_flash_dev_create(c: *mut cache_set, size: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bch_cached_dev_error(dc: *mut cached_dev) -> bool {
...
// Cache set
    __printf(2, 3)
#[no_mangle]
pub unsafe extern "C" fn bch_cache_set_error(c: *mut cache_set, fmt: *const c_char, ...) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn bch_cache_set_release(kobj: *mut kobject) {
...
#[no_mangle]
pub unsafe extern "C" fn CLOSURE_CALLBACK(_arg: cache_set_free) -> static {
    ...
    ca = c.cache;
    if (ca) {
    ca.set = core::ptr::null_mut();
    c.cache = core::ptr::null_mut();
    kobject_put(&ca.kobj);
    }
    if (c.moving_gc_wq)
...
#[no_mangle]
pub unsafe extern "C" fn CLOSURE_CALLBACK(_arg: cache_set_flush) -> static {
...
//
    ...
    __bch_btree_node_write(b, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn CLOSURE_CALLBACK(_arg: __cache_set_unregister) -> static {
...
#[no_mangle]
pub unsafe extern "C" fn bch_cache_set_stop(c: *mut cache_set) {
...
#[no_mangle]
pub unsafe extern "C" fn bch_cache_set_unregister(c: *mut cache_set) {
    ...
    return core::ptr::null_mut();
    __module_get(THIS_MODULE);
    closure_init(&c.cl, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn run_cache_set(c: *mut cache_set) -> c_int {
...
//
    ...
    c.root = bch_btree_node_get(c, core::ptr::null_mut(), k,
    j.btree_level,
...
//
    ...
    c.root = __bch_btree_node_alloc(c, core::ptr::null_mut(), 0, true, core::ptr::null_mut());
    if (IS_ERR(c.root))
    goto err;
...
#[no_mangle]
pub unsafe extern "C" fn bch_cache_release(kobj: *mut kobject) {
    ...
    ca.set.cache = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn cache_alloc(ca: *mut cache) -> c_int {
    ...
    struct bucket *b;
    let mut ret: c_int = -ENOMEM;
    const char *err = core::ptr::null_mut();
    __module_get(THIS_MODULE);
    kobject_init(&ca.kobj, &bch_cache_ktype);
    bio_init_inline(&ca.journal.bio, core::ptr::null_mut(), 8, 0);
//
...
//
    ...
    struct cache *ca)
    {
    const char *err = core::ptr::null_mut(); /* must be set for any error case */
    let mut ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(-EPERM: ret ==) -> else {
    else if (ret == -EPERM)
...
#[no_mangle]
unsafe extern "C" fn bch_is_open_backing(dev: dev_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bch_is_open_cache(dev: dev_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bch_is_open(dev: dev_t) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct async_reg_args {
    pub reg_work: delayed_work,
    pub path: *mut c_char,
    pub sb: *mut cache_sb,
    pub sb_disk: *mut cache_sb_disk,
    pub bdev_file: *mut file,
    pub holder: *mut c_void,
}

#[no_mangle]
unsafe extern "C" fn register_bdev_worker(work: *mut work_struct) {
    static void register_bdev_worker(struct work_struct *work)
    {
    let mut fail: c_int = false;
...
#[no_mangle]
unsafe extern "C" fn register_cache_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn register_device_async(args: *mut async_reg_args) {
...
// 10 jiffies is enough for a delay
    ...
    void *holder = core::ptr::null_mut();
    ssize_t ret;
    let mut async_registration: bool = false;
...
// For latest state of bcache_is_reboot
    ...
    bdev_file = bdev_file_open_by_path(strim(path), BLK_OPEN_READ, core::ptr::null_mut(), core::ptr::null_mut());
    if (IS_ERR(bdev_file))
    goto out_free_sb;
...
// Now reopen in exclusive mode with proper holder
    ...
    BLK_OPEN_READ | BLK_OPEN_WRITE, holder, core::ptr::null_mut());
    fput(bdev_file);
    bdev_file = bdev_file2;
    if (IS_ERR(bdev_file)) {
    ret = PTR_ERR(bdev_file);
    bdev_file = core::ptr::null_mut();
    if (ret == -EBUSY) {
    dev_t dev;
    mutex_lock(&bch_register_lock);
...
#[no_mangle]
unsafe extern "C" fn bcache_reboot(n: *mut notifier_block, code: c_ulong, x: *mut c_void) -> c_int {
...
// What's a condition variable?
    while (1) {
    let mut timeout: c_long = start + 10 * HZ - jiffies;
    mutex_lock(&bch_register_lock);
...
#[no_mangle]
unsafe extern "C" fn bcache_exit() {
...
#[no_mangle]
unsafe extern "C" fn check_module_parameters() {
    static void check_module_parameters(void)
    {
    if (bch_cutoff_writeback_sync == 0)
    bch_cutoff_writeback_sync = CUTOFF_WRITEBACK_SYNC;
#[no_mangle]
pub unsafe extern "C" fn if(CUTOFF_WRITEBACK_SYNC_MAX: bch_cutoff_writeback_sync >) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(CUTOFF_WRITEBACK_MAX: bch_cutoff_writeback >) -> else {
...
#[no_mangle]
unsafe extern "C" fn bcache_init() -> int __init {
