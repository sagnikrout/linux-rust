...
//
#[no_mangle]
unsafe extern "C" fn int_log(n: c_uint, base: c_uint) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_child(n: c_uint, k: c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn high(t: *mut dm_table, l: c_uint, n: c_uint) -> sector_t {
...
//
#[no_mangle]
unsafe extern "C" fn setup_btree_index(l: c_uint, t: *mut dm_table) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn alloc_targets(t: *mut dm_table, num: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_devices(devices: *mut list_head, md: *mut mapped_device) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_table_destroy(t: *mut dm_table) {
...
//
    ...
    let mut dev_size: sector_t = bdev_nr_sectors(bdev);
...
//
    ...
    let mut zone_sectors: c_uint = bdev_zone_sectors(bdev);
...
//
#[no_mangle]
pub unsafe extern "C" fn dm_devt_from_path(path: *const c_char, dev_p: *mut dev_t) -> int __ref {
...
//
#[no_mangle]
pub unsafe extern "C" fn dm_put_device(ti: *mut dm_target, d: *mut dm_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn adjoin(t: *mut dm_table, ti: *mut dm_target) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dm_split_args(argc: *mut c_int, argvp: *mut c_char, input: *mut c_char) -> c_int {
    int dm_split_args(int *argc, char ***argvp, char *input)
    {
    char *start, *end = input, *out, **argv = core::ptr::null_mut();
    let mut array_size: c_uint = 0;
// argc = 0;
    if (!input) {
// argvp = NULL;
    return 0;
...
#[no_mangle]
unsafe extern "C" fn dm_set_stacking_limits(limits: *mut queue_limits) {
...
//
    let mut next_target_start: c_ushort = 0;
//
// Given an aligned bio that extends beyond the end of a
// target, how many sectors must the next target handle?
//
    let mut remaining: c_ushort = 0;
    struct dm_target *ti;
...
#[no_mangle]
pub unsafe extern "C" fn dm_consume_args(as: *mut dm_arg_set, num_args: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn __table_type_bio_based(table_type: enum dm_queue_mode) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __table_type_request_based(table_type: enum dm_queue_mode) -> bool {
    static bool __table_type_request_based(enum dm_queue_mode table_type)
    {
    let mut table_type: return = = DM_TYPE_REQUEST_BASED;
    }
#[no_mangle]
pub unsafe extern "C" fn dm_table_set_type(t: *mut dm_table, type: enum dm_queue_mode) {
...
// Ensure that all targets support DAX.
    ...
    ti.type.iterate_devices(ti, iterate_fn, core::ptr::null_mut()))
    return false;
    }
    return true;
    }
...
#[no_mangle]
unsafe extern "C" fn dm_table_determine_type(t: *mut dm_table) -> c_int {
    static int dm_table_determine_type(struct dm_table *t)
    {
    let mut bio_based: c_uint = 0, request_based = 0, hybrid = 0;
    struct dm_target *ti;
    struct list_head *devices = dm_table_get_devices(t);
    let mut live_md_type: enum dm_queue_mode = dm_get_md_type(t.md);
...
// possibly upgrade to a variant of bio-based
    ...
    hybrid = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dm_target_request_based(ti)) -> else {
...
// Non-request-stackable devices can't be used for request-based dm
    if (!ti.type.iterate_devices ||
    ti.type.iterate_devices(ti, device_is_not_rq_stackable, core::ptr::null_mut())) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_table_get_type(t: *mut dm_table) -> enum dm_queue_mode {
...
#[no_mangle]
pub unsafe extern "C" fn dm_table_request_based(t: *mut dm_table) -> bool {
    bool dm_table_request_based(struct dm_table *t)
    {
    return __table_type_request_based(dm_table_get_type(t));
    }
#[no_mangle]
unsafe extern "C" fn dm_table_alloc_md_mempools(t: *mut dm_table, md: *mut mapped_device) -> c_int {
    static int dm_table_alloc_md_mempools(struct dm_table *t, struct mapped_device *md)
    {
    let mut type: enum dm_queue_mode = dm_table_get_type(t);
    let mut per_io_data_size: c_uint = 0, front_pad, io_front_pad;
    let mut min_pool_size: c_uint = 0, pool_size;
    struct dm_md_mempools *pools;
    let mut bioset_flags: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn setup_indexes(t: *mut dm_table) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dm_table_build_index(t: *mut dm_table) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_crypto_profile {
    pub profile: blk_crypto_profile,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_wrappedkey_op_args {
    pub op: enum dm_wrappedkey_op,
    pub err: c_int,
    union {
    struct {
    pub eph_key: *const u8,
    pub eph_key_size: usize,
    pub sw_secret: *mut u8,
    pub derive_sw_secret: },
    struct {
    pub raw_key: *const u8,
...
#[no_mangle]
pub unsafe extern "C" fn dm_destroy_crypto_profile(profile: *mut blk_crypto_profile) {
...
#[no_mangle]
unsafe extern "C" fn dm_table_destroy_crypto_profile(t: *mut dm_table) {
    static void dm_table_destroy_crypto_profile(struct dm_table *t)
    {
    dm_destroy_crypto_profile(t.crypto_profile);
    t.crypto_profile = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn dm_table_construct_crypto_profile(t: *mut dm_table) -> c_int {
    static int dm_table_construct_crypto_profile(struct dm_table *t)
    {
    struct dm_crypto_profile *dmcp;
    struct blk_crypto_profile *profile;
    unsigned int i;
    let mut empty_profile: bool = true;
    ...
    blk_crypto_intersect_capabilities(profile, core::ptr::null_mut());
    break;
    }
    if (!ti.type.iterate_devices)
    continue;
...
//
#[no_mangle]
pub unsafe extern "C" fn dm_table_complete(t: *mut dm_table) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dm_table_event(t: *mut dm_table) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_table_get_size(t: *mut dm_table) -> sector_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn dm_table_has_no_data_devices(t: *mut dm_table) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn dm_table_is_wildcard(t: *mut dm_table) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn dm_table_supports_zoned(t: *mut dm_table, zoned: bool) -> bool {
...
//
    if (dm_target_is_wildcard(ti.type) &&
    !ti.type.iterate_devices(ti, device_is_zoned_model, core::ptr::null_mut()))
    return false;
...
//
#[no_mangle]
unsafe extern "C" fn dm_table_supports_flush(t: *mut dm_table) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dm_table_supports_write_zeroes(t: *mut dm_table) -> bool {
    ...
    return false;
    if (!ti.type.iterate_devices ||
    ti.type.iterate_devices(ti, device_not_write_zeroes_capable, core::ptr::null_mut()))
    return false;
    }
    return true;
    }
#[no_mangle]
unsafe extern "C" fn dm_table_supports_nowait(t: *mut dm_table) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dm_table_supports_discards(t: *mut dm_table) -> bool {
...
//
    ...
    (!ti.type.iterate_devices ||
    ti.type.iterate_devices(ti, device_not_discard_capable, core::ptr::null_mut())))
    return false;
    }
    return true;
    }
...
#[no_mangle]
unsafe extern "C" fn dm_table_supports_secure_erase(t: *mut dm_table) -> bool {
    ...
    return false;
    if (!ti.type.iterate_devices ||
    ti.type.iterate_devices(ti, device_not_secure_erase_capable, core::ptr::null_mut()))
    return false;
    }
    return true;
    }
...
#[no_mangle]
unsafe extern "C" fn dm_table_supports_atomic_writes(t: *mut dm_table) -> bool {
    ...
    device_not_atomic_write_capable, core::ptr::null_mut())) {
    return false;
    }
    }
    return true;
...
//
    ...
    if (dm_table_any_dev_attr(t, device_dax_write_cache_enabled, core::ptr::null_mut()))
...
#[no_mangle]
pub unsafe extern "C" fn dm_table_get_mode(t: *mut dm_table) -> blk_mode_t {
...
#[no_mangle]
unsafe extern "C" fn suspend_targets(t: *mut dm_table, mode: enum suspend_mode) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_table_presuspend_targets(t: *mut dm_table) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_table_presuspend_undo_targets(t: *mut dm_table) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_table_postsuspend_targets(t: *mut dm_table) {
...
#[no_mangle]
pub unsafe extern "C" fn dm_table_resume_targets(t: *mut dm_table) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dm_table_run_md_queue_async(t: *mut dm_table) {
