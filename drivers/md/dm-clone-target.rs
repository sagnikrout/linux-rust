...
//! Source: drivers/md/dm-clone-target.c
#![no_std]
...
//
pub const HASH_TABLE_BITS: c_int = 15;
...
pub struct clone {
    ...
    pub dest_dev: *mut dm_dev,
    pub source_dev: *mut dm_dev,
    pub nr_regions: c_ulong,
    pub region_size: sector_t,
    pub region_shift: c_uint,
//
// A metadata commit and the actions taken in case it fails should run
// as a single atomic step.
//
    pub commit_lock: mutex,
    pub cmd: *mut dm_clone_metadata,
// Region hydration hash table
    pub ht: *mut hash_table_bucket,
    pub ios_in_flight: core::sync::atomic::AtomicI32,
    pub hydration_stopped: wait_queue_head_t,
    pub hydration_pool: mempool_t,
...
//
    ...
    pub deferred_discard_bios: bio_list,
...
// Maximum number of regions being copied during background hydration.
    pub hydration_threshold: c_uint,
// Number of regions to batch together during background hydration.
    pub hydration_batch_size: c_uint,
// Which region to hydrate next
    pub hydration_offset: c_ulong,
    pub hydrations_in_flight: core::sync::atomic::AtomicI32,
//
...
//
    ...
    pub mode: enum clone_metadata_mode,
    pub flags: c_ulong,
}
...
// dm-clone flags
//
pub const DM_CLONE_DISCARD_PASSDOWN: c_int = 0;
pub const DM_CLONE_HYDRATION_ENABLED: c_int = 1;
pub const DM_CLONE_HYDRATION_SUSPENDED: c_int = 2;
// ---------------------------------------------------------------------------
//
// Metadata failure handling.
//
#[no_mangle]
unsafe extern "C" fn get_clone_mode(clone: *mut clone) -> enum clone_metadata_mode {
...
#[no_mangle]
unsafe extern "C" fn __set_clone_mode(clone: *mut clone, new_mode: enum clone_metadata_mode) {
    ...
    let mut old_mode: enum clone_metadata_mode = get_clone_mode(clone);
...
#[no_mangle]
unsafe extern "C" fn __abort_transaction(clone: *mut clone) {
...
#[no_mangle]
unsafe extern "C" fn __reload_in_core_bitset(clone: *mut clone) {
...
#[no_mangle]
unsafe extern "C" fn __metadata_operation_failed(clone: *mut clone, op: *const c_char, r: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn wakeup_hydration_waiters(clone: *mut clone) {
    static inline void wakeup_hydration_waiters(struct clone *clone)
    {
    wake_up_all(&clone.hydration_stopped);
    }
#[no_mangle]
pub unsafe extern "C" fn wake_worker(clone: *mut clone) {
...
#[no_mangle]
pub unsafe extern "C" fn region_to_sector(clone: *mut clone, region_nr: c_ulong) -> sector_t {
...
#[no_mangle]
pub unsafe extern "C" fn bio_to_region(clone: *mut clone, bio: *mut bio) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn is_overwrite_bio(clone: *mut clone, bio: *mut bio) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fail_bios(bios: *mut bio_list, status: blk_status_t) {
...
#[no_mangle]
unsafe extern "C" fn submit_bios(bios: *mut bio_list) {
...
//
#[no_mangle]
unsafe extern "C" fn issue_bio(clone: *mut clone, bio: *mut bio) {
...
//
#[no_mangle]
unsafe extern "C" fn remap_and_issue(clone: *mut clone, bio: *mut bio) {
...
//
#[no_mangle]
unsafe extern "C" fn issue_deferred_bios(clone: *mut clone, bios: *mut bio_list) {
    static void issue_deferred_bios(struct clone *clone, struct bio_list *bios)
    {
    struct bio *bio;
    unsigned long flags;
    let mut flush_bios: bio_list = BIO_EMPTY_LIST;
    let mut normal_bios: bio_list = BIO_EMPTY_LIST;
...
#[no_mangle]
unsafe extern "C" fn complete_overwrite_bio(clone: *mut clone, bio: *mut bio) {
...
#[no_mangle]
unsafe extern "C" fn trim_bio(bio: *mut bio, sector: sector_t, len: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn complete_discard_bio(clone: *mut clone, bio: *mut bio, success: bool) {
...
#[no_mangle]
unsafe extern "C" fn process_discard_bio(clone: *mut clone, bio: *mut bio) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dm_clone_region_hydration {
    pub clone: *mut clone,
    pub region_nr: c_ulong,
    pub overwrite_bio: *mut bio,
    pub overwrite_bio_end_io: *mut bio_end_io_t,
    pub deferred_bios: bio_list,
...
#[no_mangle]
unsafe extern "C" fn hash_table_init(clone: *mut clone) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hash_table_exit(clone: *mut clone) {
...
#[no_mangle]
pub unsafe extern "C" fn free_hydration(hd: *mut dm_clone_region_hydration) {
...
#[no_mangle]
unsafe extern "C" fn hydration_init(hd: *mut dm_clone_region_hydration, region_nr: c_ulong) {
    static void hydration_init(struct dm_clone_region_hydration *hd, unsigned long region_nr)
    {
    hd.region_nr = region_nr;
    hd.overwrite_bio = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn hydration_update_metadata(hd: *mut dm_clone_region_hydration) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hydration_complete(hd: *mut dm_clone_region_hydration) {
...
#[no_mangle]
unsafe extern "C" fn hydration_kcopyd_callback(read_err: c_int, write_err: c_ulong, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hydration_copy(hd: *mut dm_clone_region_hydration, nr_regions: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn hydration_overwrite(hd: *mut dm_clone_region_hydration, bio: *mut bio) {
...
//
#[no_mangle]
unsafe extern "C" fn hydrate_bio_region(clone: *mut clone, bio: *mut bio) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct batch_info {
    pub head: *mut dm_clone_region_hydration,
    pub nr_batched_regions: c_uint,
}
    ...
    {
    struct clone *clone = hd.clone;
    let mut max_batch_size: c_uint = READ_ONCE(clone.hydration_batch_size);
    if (batch.head) {
...
// Start a new batch
    ...
    struct hash_table_bucket *bucket;
    struct dm_clone_region_hydration *hd;
    let mut nr_regions: c_ulong = clone.nr_regions;
    hd = alloc_hydration(clone);
...
//
#[no_mangle]
unsafe extern "C" fn do_hydration(clone: *mut clone) {
...
// ---------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn need_commit_due_to_time(clone: *mut clone) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn commit_metadata(clone: *mut clone, dest_dev_flushed: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn process_deferred_discards(clone: *mut clone) {
    static void process_deferred_discards(struct clone *clone)
    {
    let mut r: c_int = -EPERM;
    struct bio *bio;
    struct blk_plug plug;
    unsigned long rs, nr_regions;
    let mut discards: bio_list = BIO_EMPTY_LIST;
    spin_lock_irq(&clone.lock);
...
#[no_mangle]
unsafe extern "C" fn process_deferred_bios(clone: *mut clone) {
    static void process_deferred_bios(struct clone *clone)
    {
    let mut bios: bio_list = BIO_EMPTY_LIST;
    spin_lock_irq(&clone.lock);
...
#[no_mangle]
unsafe extern "C" fn process_deferred_flush_bios(clone: *mut clone) {
    static void process_deferred_flush_bios(struct clone *clone)
    {
    struct bio *bio;
    bool dest_dev_flushed;
    let mut bios: bio_list = BIO_EMPTY_LIST;
    let mut bio_completions: bio_list = BIO_EMPTY_LIST;
//
...
#[no_mangle]
unsafe extern "C" fn do_worker(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn do_waker(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn clone_map(ti: *mut dm_target, bio: *mut bio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clone_endio(ti: *mut dm_target, bio: *mut bio, error: *mut blk_status_t) -> c_int {
...
//
    ...
    unsigned int i;
    let mut sz: isize = 0;
    let mut nr_free_metadata_blocks: dm_block_t = 0;
    let mut nr_metadata_blocks: dm_block_t = 0;
...
// Commit to ensure statistics aren't out-of-date
    ...
    (void) commit_metadata(clone, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn parse_feature_args(as: *mut dm_arg_set, clone: *mut clone) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_core_args(as: *mut dm_arg_set, clone: *mut clone) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_region_size(clone: *mut clone, as: *mut dm_arg_set, error: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_nr_regions(n: c_ulong, error: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_metadata_dev(clone: *mut clone, as: *mut dm_arg_set, error: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_dest_dev(clone: *mut clone, as: *mut dm_arg_set, error: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_source_dev(clone: *mut clone, as: *mut dm_arg_set, error: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_ctr_args(clone: *mut clone, argc: c_int, argv: *const c_char, error: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clone_ctr(ti: *mut dm_target, argc: c_uint, argv: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clone_dtr(ti: *mut dm_target) {
...
// ---------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn clone_postsuspend(ti: *mut dm_target) {
...
#[no_mangle]
unsafe extern "C" fn clone_resume(ti: *mut dm_target) {
...
//
#[no_mangle]
unsafe extern "C" fn disable_passdown_if_not_supported(clone: *mut clone) {
...
#[no_mangle]
pub unsafe extern "C" fn if(clone->region_size: dest_limits->max_discard_sectors <) -> else {
...
#[no_mangle]
unsafe extern "C" fn set_discard_limits(clone: *mut clone, limits: *mut queue_limits) {
...
#[no_mangle]
unsafe extern "C" fn clone_io_hints(ti: *mut dm_target, limits: *mut queue_limits) {
...
//
#[no_mangle]
unsafe extern "C" fn set_hydration_threshold(clone: *mut clone, nr_regions: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn set_hydration_batch_size(clone: *mut clone, nr_regions: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn enable_hydration(clone: *mut clone) {
...
#[no_mangle]
unsafe extern "C" fn disable_hydration(clone: *mut clone) {
...
// Module functions
#[no_mangle]
unsafe extern "C" fn dm_clone_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dm_clone_exit() -> void __exit {
    static void __exit dm_clone_exit(void)
    {
    dm_unregister_target(&clone_target);
    kmem_cache_destroy(_hydration_cache);
    _hydration_cache = core::ptr::null_mut();
    }
// Module hooks
