...
//! Source: drivers/md/dm-pcache/cache_segment.c
#![no_std]
...
// SPDX-License-Identifier: GPL-2.0-or-later
    ...
    let mut seg_id: u32 = cache_seg.segment.seg_id;
    void *seg_addr;
...
#[no_mangle]
unsafe extern "C" fn cache_seg_info_write(cache_seg: *mut pcache_cache_segment) {
...
#[no_mangle]
unsafe extern "C" fn cache_seg_info_load(cache_seg: *mut pcache_cache_segment) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cache_seg_ctrl_load(cache_seg: *mut pcache_cache_segment) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cache_seg_ctrl_write(cache_seg: *mut pcache_cache_segment) {
...
#[no_mangle]
unsafe extern "C" fn cache_seg_ctrl_init(cache_seg: *mut pcache_cache_segment) {
...
#[no_mangle]
unsafe extern "C" fn cache_seg_meta_load(cache_seg: *mut pcache_cache_segment) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cache_seg_set_next_seg(cache_seg: *mut pcache_cache_segment, seg_id: u32) {
    ...
    let mut seg_options: pcache_segment_init_options = { 0 };
...
#[no_mangle]
unsafe extern "C" fn cache_seg_gen_increase(cache_seg: *mut pcache_cache_segment) {
...
#[no_mangle]
pub unsafe extern "C" fn cache_seg_get(cache_seg: *mut pcache_cache_segment) {
    void cache_seg_get(struct pcache_cache_segment *cache_seg)
    {
    atomic_inc(&cache_seg.refs);
    }
#[no_mangle]
unsafe extern "C" fn cache_seg_invalidate(cache_seg: *mut pcache_cache_segment) {
...
#[no_mangle]
pub unsafe extern "C" fn cache_seg_put(cache_seg: *mut pcache_cache_segment) {
