...
//! Source: drivers/md/dm-pcache/cache_writeback.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn writeback_ctx_end(cache: *mut pcache_cache, ret: c_int) {
...
#[no_mangle]
unsafe extern "C" fn writeback_end_req(backing_req: *mut pcache_backing_dev_req, ret: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn is_cache_clean(cache: *mut pcache_cache, dirty_tail: *mut pcache_cache_pos) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cache_writeback_exit(cache: *mut pcache_cache) {
...
#[no_mangle]
pub unsafe extern "C" fn cache_writeback_init(cache: *mut pcache_cache) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cache_key_writeback(cache: *mut pcache_cache, key: *mut pcache_cache_key) {
    ...
    let mut writeback_req_opts: pcache_backing_dev_req_opts = { 0 };
...
#[no_mangle]
unsafe extern "C" fn cache_wb_tree_writeback(cache: *mut pcache_cache, advance: u32) {
...
#[no_mangle]
unsafe extern "C" fn cache_kset_insert_tree(cache: *mut pcache_cache, kset_onmedia: *mut pcache_cache_kset_onmedia) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cache_writeback_fn(work: *mut work_struct) {
