...
//! Source: drivers/md/dm-pcache/cache_key.c
#![no_std]
...
// SPDX-License-Identifier: GPL-2.0-or-later
    ...
    let mut pcache_empty_kset: pcache_cache_kset_onmedia = { 0 };
#[no_mangle]
pub unsafe extern "C" fn cache_key_init(cache_tree: *mut pcache_cache_tree, key: *mut pcache_cache_key) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cache_key_get(key: *mut pcache_cache_key) {
...
//
#[no_mangle]
unsafe extern "C" fn cache_key_destroy(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn cache_key_put(key: *mut pcache_cache_key) {
    void cache_key_put(struct pcache_cache_key *key)
    {
    kref_put(&key.ref, cache_key_destroy);
    }
#[no_mangle]
pub unsafe extern "C" fn cache_pos_advance(pos: *mut pcache_cache_pos, len: u32) {
...
// Ensure enough space remains in the current segment
    ...
    let mut dev_bytes: u64 = (u64)cache.dev_size << SECTOR_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn append_last_kset(cache: *mut pcache_cache, next_seg: u32) {
    static void append_last_kset(struct pcache_cache *cache, u32 next_seg)
    {
    let mut kset_onmedia: pcache_cache_kset_onmedia = { 0 };
...
#[no_mangle]
pub unsafe extern "C" fn cache_kset_close(cache: *mut pcache_cache, kset: *mut pcache_cache_kset) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cache_key_append(cache: *mut pcache_cache, key: *mut pcache_cache_key, force_close: bool) -> c_int {
    int cache_key_append(struct pcache_cache *cache, struct pcache_cache_key *key, bool force_close)
    {
    struct pcache_cache_kset *kset;
    struct pcache_cache_kset_onmedia *kset_onmedia;
    struct pcache_cache_key_onmedia *key_onmedia;
    let mut kset_id: u32 = get_kset_id(cache, key.off);
    let mut ret: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn cache_subtree_walk(ctx: *mut pcache_cache_subtree_walk_ctx) -> c_int {
    int cache_subtree_walk(struct pcache_cache_subtree_walk_ctx *ctx)
    {
    struct pcache_cache_key *key_tmp, *key;
    struct rb_node *node_tmp;
    let mut ret: c_int = SUBTREE_WALK_RET_OK;
    key = ctx.key;
...
//
    ...
    struct rb_node *prev_node = core::ptr::null_mut();
...
// newp = new;
    ...
    ctx.pre_alloc_key = core::ptr::null_mut();
    return key;
    }
...
//
    ...
    let mut need_research: bool = false;
...
//
#[no_mangle]
pub unsafe extern "C" fn cache_key_insert(cache_tree: *mut pcache_cache_tree, key: *mut pcache_cache_key, fixup: bool) {
    ...
    let mut walk_ctx: pcache_cache_subtree_walk_ctx = { 0 };
    struct rb_node **new, *parent = core::ptr::null_mut();
    struct pcache_cache_subtree *cache_subtree;
    struct pcache_cache_key *key_tmp = core::ptr::null_mut(), *key_next;
    struct rb_node *prev_node = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn clean_fn(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kset_flush_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn kset_replay(cache: *mut pcache_cache, kset_onmedia: *mut pcache_cache_kset_onmedia) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cache_replay(cache: *mut pcache_cache) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cache_verify_dirty_tail(cache: *mut pcache_cache) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cache_tree_init(cache: *mut pcache_cache, cache_tree: *mut pcache_cache_tree, n_subtrees: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cache_tree_clear(cache_tree: *mut pcache_cache_tree) {
...
#[no_mangle]
pub unsafe extern "C" fn cache_tree_exit(cache_tree: *mut pcache_cache_tree) {
