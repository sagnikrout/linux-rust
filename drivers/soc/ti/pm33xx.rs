...
//! Source: drivers/soc/ti/pm33xx.c
#![no_std]
...
pub const RTC_SCRATCH_RESUME_REG: c_int = 0;
pub const RTC_SCRATCH_MAGIC_REG: c_int = 1;
pub const RTC_REG_BOOT_MAGIC: c_uint = 0x8cd0 /* RTC */;
pub const GIC_INT_SET_PENDING_BASE: c_uint = 0x200;
pub const AM43XX_GIC_DIST_BASE: c_uint = 0x48241000;
...
#[no_mangle]
unsafe extern "C" fn sram_suspend_address(addr: c_ulong) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn am33xx_push_sram_idle() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn am33xx_do_sram_idle(wfi_flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn am43xx_map_gic() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtc_wake_src() -> wkup_m3_wakeup_src {
...
#[no_mangle]
unsafe extern "C" fn am33xx_rtc_only_idle(wfi_flags: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn am33xx_pm_suspend(suspend_state: suspend_state_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn am33xx_pm_enter(suspend_state: suspend_state_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn am33xx_pm_begin(state: suspend_state_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn am33xx_pm_end() {
...
#[no_mangle]
unsafe extern "C" fn am33xx_pm_valid(state: suspend_state_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn am33xx_pm_set_ipc_ops() {
...
#[no_mangle]
unsafe extern "C" fn am33xx_pm_free_sram() {
...
//
#[no_mangle]
unsafe extern "C" fn am33xx_pm_alloc_sram() -> c_int {
    static int am33xx_pm_alloc_sram(void)
    {
    struct device_node *np __free(device_node) =
    of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "ti,omap3-mpu");
    if (!np) {
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "ti,omap4-mpu");
    if (!np)
...
#[no_mangle]
unsafe extern "C" fn am33xx_pm_rtc_setup() -> c_int {
    ...
    struct nvmem_device *nvmem;
    int error;
    np = of_find_node_by_name(core::ptr::null_mut(), "rtc");
...
#[no_mangle]
unsafe extern "C" fn am33xx_pm_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    err_free_sram:
    am33xx_pm_free_sram();
    pm33xx_dev = core::ptr::null_mut();
    err_wkup_m3_ipc_put:
    wkup_m3_ipc_put(m3_ipc);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn am33xx_pm_remove(pdev: *mut platform_device) {
    ...
    if (pm_ops.deinit)
    pm_ops.deinit();
    suspend_set_ops(core::ptr::null_mut());
    wkup_m3_ipc_put(m3_ipc);
    am33xx_pm_free_sram();
    iounmap(rtc_base_virt);
    clk_put(rtc_fck);
