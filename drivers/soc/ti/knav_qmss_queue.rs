...
//! Source: drivers/soc/ti/knav_qmss_queue.c
#![no_std]
...
pub const KNAV_QUEUE_PEEK_REG_INDEX: c_int = 0;
pub const KNAV_QUEUE_STATUS_REG_INDEX: c_int = 1;
pub const KNAV_QUEUE_CONFIG_REG_INDEX: c_int = 2;
pub const KNAV_QUEUE_REGION_REG_INDEX: c_int = 3;
pub const KNAV_QUEUE_PUSH_REG_INDEX: c_int = 4;
pub const KNAV_QUEUE_POP_REG_INDEX: c_int = 5;
...
//
pub const KNAV_L_QUEUE_CONFIG_REG_INDEX: c_int = 1;
pub const KNAV_L_QUEUE_REGION_REG_INDEX: c_int = 2;
pub const KNAV_L_QUEUE_PUSH_REG_INDEX: c_int = 3;
// PDSP register indices in DTS
pub const KNAV_QUEUE_PDSP_IRAM_REG_INDEX: c_int = 0;
pub const KNAV_QUEUE_PDSP_REGS_REG_INDEX: c_int = 1;
pub const KNAV_QUEUE_PDSP_INTD_REG_INDEX: c_int = 2;
pub const KNAV_QUEUE_PDSP_CMD_REG_INDEX: c_int = 3;
...
#[no_mangle]
pub unsafe extern "C" fn knav_qmss_device_ready() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn knav_queue_notify(inst: *mut knav_queue_inst) {
...
#[no_mangle]
unsafe extern "C" fn knav_queue_int_handler(irq: c_int, _instdata: *mut c_void) -> irqreturn_t {
    ...
    {
    let mut queue: unsigned = inst.id - range.queue_base;
...
#[no_mangle]
unsafe extern "C" fn knav_queue_free_irq(inst: *mut knav_queue_inst) {
    static void knav_queue_free_irq(struct knav_queue_inst *inst)
    {
    struct knav_range_info *range = inst.range;
    let mut queue: unsigned = inst.id - inst.range.queue_base;
    int irq;
    if (range.flags & RANGE_HAS_IRQ) {
    irq = range.irqs[queue].irq;
...
#[no_mangle]
pub unsafe extern "C" fn knav_queue_is_busy(inst: *mut knav_queue_inst) -> bool {
    static inline bool knav_queue_is_busy(struct knav_queue_inst *inst)
    {
    return !list_empty(&inst.handles);
    }
#[no_mangle]
pub unsafe extern "C" fn knav_queue_is_reserved(inst: *mut knav_queue_inst) -> bool {
    static inline bool knav_queue_is_reserved(struct knav_queue_inst *inst)
    {
    return inst.range.flags & RANGE_RESERVED;
    }
#[no_mangle]
pub unsafe extern "C" fn knav_queue_is_shared(inst: *mut knav_queue_inst) -> bool {
...
#[no_mangle]
unsafe extern "C" fn knav_queue_set_notify(inst: *mut knav_queue_inst, enabled: bool) {
...
#[no_mangle]
unsafe extern "C" fn knav_queue_enable_notifier(qh: *mut knav_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn knav_queue_disable_notifier(qh: *mut knav_queue) -> c_int {
    ...
    {
    let mut old_fn: knav_queue_notify_fn = qh.notifier_fn;
    if (!cfg)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn knav_queue_get_count(qhandle: *mut c_void) -> c_int {
    ...
    struct knav_queue *qh;
    let mut cpu: c_int = 0;
    let mut pushes: c_int = 0;
    let mut pops: c_int = 0;
    let mut push_errors: c_int = 0;
    let mut pop_errors: c_int = 0;
    let mut notifies: c_int = 0;
    if (!knav_queue_is_busy(inst))
    return;
...
#[no_mangle]
unsafe extern "C" fn knav_queue_debug_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn knav_queue_flush(qh: *mut knav_queue) -> c_int {
    static int knav_queue_flush(struct knav_queue *qh)
    {
    struct knav_queue_inst *inst = qh.inst;
    let mut id: unsigned = inst.id - inst.qmgr.start_queue;
...
//
#[no_mangle]
pub unsafe extern "C" fn knav_queue_close(qhandle: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn knav_queue_pop(qhandle: *mut c_void, size: *mut unsigned) -> dma_addr_t {
...
#[no_mangle]
unsafe extern "C" fn kdesc_fill_pool(pool: *mut knav_pool) {
    ...
    let mut index: c_int = pool.region_offset + i;
    dma_addr_t dma_addr;
    unsigned dma_size;
...
#[no_mangle]
unsafe extern "C" fn kdesc_empty_pool(pool: *mut knav_pool) {
...
#[no_mangle]
pub unsafe extern "C" fn knav_pool_desc_virt_to_dma(ph: *mut c_void, virt: *mut c_void) -> dma_addr_t {
...
//
    ...
    {
    struct knav_region *reg_itr, *region = core::ptr::null_mut();
    struct knav_pool *pool, *pi = core::ptr::null_mut(), *iter;
...
//
#[no_mangle]
pub unsafe extern "C" fn knav_pool_destroy(ph: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn knav_pool_desc_put(ph: *mut c_void, desc: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn knav_pool_count(ph: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn knav_queue_setup_link_ram(kdev: *mut knav_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn knav_free_queue_ranges(kdev: *mut knav_device) {
...
#[no_mangle]
unsafe extern "C" fn knav_queue_free_regions(kdev: *mut knav_device) {
...
#[no_mangle]
unsafe extern "C" fn knav_queue_stop_pdsps(kdev: *mut knav_device) {
...
#[no_mangle]
unsafe extern "C" fn knav_queue_start_pdsps(kdev: *mut knav_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn knav_queue_init_queues(kdev: *mut knav_device) -> c_int {
    static int knav_queue_init_queues(struct knav_device *kdev)
    {
    struct knav_range_info *range;
    int size, id, base_idx;
    let mut idx: c_int = 0, ret = 0;
...
#[no_mangle]
unsafe extern "C" fn knav_queue_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    debugfs_create_file("qmss", 0444, core::ptr::null_mut(), core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn knav_queue_remove(pdev: *mut platform_device) {
    ...
    kdev.debugfs_file = core::ptr::null_mut();
    knav_queue_stop_pdsps(kdev);
