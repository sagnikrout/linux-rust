...
//! Source: drivers/soc/ti/k3-ringacc.c
#![no_std]
...
pub const K3_RINGACC_RT_REGS_STEP: c_uint = 0x1000;
pub const K3_DMARING_RT_REGS_STEP: c_uint = 0x2000;
pub const K3_DMARING_RT_REGS_REVERSE_OFS: c_uint = 0x1000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k3_ring_fifo_regs {
    pub head_data: [u32; 128],
    pub tail_data: [u32; 128],
    pub peek_head_data: [u32; 128],
    pub peek_tail_data: [u32; 128],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k3_ringacc_proxy_gcfg_regs {
    pub revision: u32,
    pub config: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k3_ringacc_proxy_target_regs {
    pub control: u32,
    pub status: u32,
    pub resv_512: [u8; 504],
    pub data: [u32; 128],
...
pub const K3_RINGACC_PROXY_TARGET_STEP: c_uint = 0x1000;
...
pub const K3_RINGACC_FIFO_REGS_STEP: c_uint = 0x1000;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct k3_ring_ops {
    pub elm): *mut *mut *mut int (push_tail)(struct k3_ring ring, void,
    pub elm): *mut *mut *mut int (push_head)(struct k3_ring ring, void,
    pub elm): *mut *mut *mut int (pop_tail)(struct k3_ring ring, void,
    pub elm): *mut *mut *mut int (pop_head)(struct k3_ring ring, void,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k3_ring_state {
    pub free: u32,
    pub occ: u32,
    pub windex: u32,
    pub rindex: u32,
    pub tdown_complete:1: u32,
}
...
#[derive(Copy, Clone)]
pub struct k3_ring {
    pub rt: *mut k3_ring_rt_regs __iomem,
    pub fifos: *mut k3_ring_fifo_regs __iomem,
    pub proxy: *mut k3_ringacc_proxy_target_regs __iomem,
    pub ring_mem_dma: dma_addr_t,
    pub ring_mem_virt: *mut c_void,
    pub ops: *const k3_ring_ops,
    pub size: u32,
    pub elm_size: enum k3_ring_size,
    pub mode: enum k3_ring_mode,
    pub flags: u32,

    pub state: k3_ring_state,
    pub ring_id: u32,
    pub parent: *mut k3_ringacc,
    pub use_count: u32,
    pub proxy_id: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k3_ringacc_ops {
    pub ringacc): *mut *mut *mut int (init)(struct platform_device pdev, struct k3_ringacc,
}
...
pub struct k3_ringacc {
    pub dev: *mut device,
    pub proxy_gcfg: *mut k3_ringacc_proxy_gcfg_regs __iomem,
    pub proxy_target_base: *mut void __iomem,
    pub /: *mut *mut u32 num_rings; / number of rings in Ringacc module,
    pub rings_inuse: *mut c_ulong,
    pub rm_gp_range: *mut ti_sci_resource,
    pub dma_ring_reset_quirk: bool,
    pub num_proxies: u32,
    pub proxy_inuse: *mut c_ulong,
    pub rings: *mut k3_ring,
    pub list: list_head,
    pub /: *mut *mut mutex req_lock; / protect rings allocation,
    pub tisci: *const ti_sci_handle,
    pub tisci_ring_ops: *const ti_sci_rm_ringacc_ops,
    pub tisci_dev_id: u32,
    pub ops: *const k3_ringacc_ops,
    pub dma_rings: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k3_ringacc_soc_data {
    pub dma_ring_reset_quirk:1: unsigned,
}

#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_read_occ(ring: *mut k3_ring) -> c_int {
    static int k3_ringacc_ring_read_occ(struct k3_ring *ring)
    {
    return readl(&ring.rt.occ) & K3_RINGACC_RT_OCC_MASK;
    }
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_update_occ(ring: *mut k3_ring) {
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_get_fifo_pos(ring: *mut k3_ring) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_dump(ring: *mut k3_ring) {
    ...
    int id, u32 flags)
    {
    let mut proxy_id: c_int = K3_RINGACC_PROXY_NOT_USED;
...
// Request for any general purpose ring
    ...
    goto error;
#[no_mangle]
pub unsafe extern "C" fn if(K3_RING_FLAG_SHARED: ringacc->rings[id].flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_reset_sci(ring: *mut k3_ring) {
    static void k3_ringacc_ring_reset_sci(struct k3_ring *ring)
    {
    let mut ring_cfg: ti_sci_msg_rm_ring_cfg = { 0 };
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_ring_reset(ring: *mut k3_ring) {
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_ring_reset_dma(ring: *mut k3_ring, occ: u32) {
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_free_sci(ring: *mut k3_ring) {
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_ring_free(ring: *mut k3_ring) -> c_int {
...
//
    ...
    ring.flags = 0;
    ring.ops = core::ptr::null_mut();
    ring.dma_dev = core::ptr::null_mut();
    ring.asel = 0;
    if (ring.proxy_id != K3_RINGACC_PROXY_NOT_USED) {
    clear_bit(ring.proxy_id, ringacc.proxy_inuse);
    ring.proxy = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_get_ring_id(ring: *mut k3_ring) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_get_tisci_dev_id(ring: *mut k3_ring) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_get_ring_irq_num(ring: *mut k3_ring) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_cfg_sci(ring: *mut k3_ring) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k3_dmaring_cfg(ring: *mut k3_ring, cfg: *mut k3_ring_cfg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_ring_cfg(ring: *mut k3_ring, cfg: *mut k3_ring_cfg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_ring_get_size(ring: *mut k3_ring) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_ring_get_free(ring: *mut k3_ring) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_ring_get_occ(ring: *mut k3_ring) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_ring_is_full(ring: *mut k3_ring) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_push_head_proxy(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
    static int k3_ringacc_ring_push_head_proxy(struct k3_ring *ring, void *elem)
    {
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_push_tail_proxy(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
    static int k3_ringacc_ring_push_tail_proxy(struct k3_ring *ring, void *elem)
    {
    return k3_ringacc_ring_access_proxy(ring, elem,
    K3_RINGACC_ACCESS_MODE_PUSH_TAIL);
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_pop_head_proxy(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
    static int k3_ringacc_ring_pop_head_proxy(struct k3_ring *ring, void *elem)
    {
    return k3_ringacc_ring_access_proxy(ring, elem,
    K3_RINGACC_ACCESS_MODE_POP_HEAD);
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_pop_tail_proxy(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
    static int k3_ringacc_ring_pop_tail_proxy(struct k3_ring *ring, void *elem)
    {
    return k3_ringacc_ring_access_proxy(ring, elem,
    K3_RINGACC_ACCESS_MODE_POP_TAIL);
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_push_head_io(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
    static int k3_ringacc_ring_push_head_io(struct k3_ring *ring, void *elem)
    {
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_push_io(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
    static int k3_ringacc_ring_push_io(struct k3_ring *ring, void *elem)
    {
    return k3_ringacc_ring_access_io(ring, elem,
    K3_RINGACC_ACCESS_MODE_PUSH_TAIL);
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_pop_io(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
    static int k3_ringacc_ring_pop_io(struct k3_ring *ring, void *elem)
    {
    return k3_ringacc_ring_access_io(ring, elem,
    K3_RINGACC_ACCESS_MODE_POP_HEAD);
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_pop_tail_io(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
    static int k3_ringacc_ring_pop_tail_io(struct k3_ring *ring, void *elem)
    {
    return k3_ringacc_ring_access_io(ring, elem,
    K3_RINGACC_ACCESS_MODE_POP_TAIL);
...
//
#[no_mangle]
unsafe extern "C" fn k3_dmaring_remove_asel_from_elem(elem: *mut u64) {
    static void k3_dmaring_remove_asel_from_elem(u64 *elem)
    {
// elem &= GENMASK_ULL(K3_ADDRESS_ASEL_SHIFT - 1, 0);
    }
#[no_mangle]
unsafe extern "C" fn k3_dmaring_fwd_pop(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
    static int k3_dmaring_fwd_pop(struct k3_ring *ring, void *elem)
    {
    void *elem_ptr;
    u32 elem_idx;
...
#[no_mangle]
unsafe extern "C" fn k3_dmaring_reverse_pop(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
    static int k3_dmaring_reverse_pop(struct k3_ring *ring, void *elem)
    {
    void *elem_ptr;
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_push_mem(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
    static int k3_ringacc_ring_push_mem(struct k3_ring *ring, void *elem)
    {
    void *elem_ptr;
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_ring_pop_mem(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
    static int k3_ringacc_ring_pop_mem(struct k3_ring *ring, void *elem)
    {
    void *elem_ptr;
    elem_ptr = k3_ringacc_get_elm_addr(ring, ring.state.rindex);
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_ring_push(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_ring_push_head(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_ring_pop(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn k3_ringacc_ring_pop_tail(ring: *mut k3_ring, elem: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_probe_dt(ringacc: *mut k3_ringacc) -> c_int {
    ...
    ringacc.tisci = core::ptr::null_mut();
    return ret;
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ringacc_match_data {
    pub ops: k3_ringacc_ops,
}
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k3_ringacc_remove(pdev: *mut platform_device) {
