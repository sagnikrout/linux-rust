...
//! Source: drivers/soc/ti/wkup_m3_ipc.c
#![no_std]
...
pub const AM33XX_CTRL_IPC_REG_COUNT: c_uint = 0x8;

// AM33XX M3_TXEV_EOI register
pub const AM33XX_CONTROL_M3_TXEV_EOI: c_uint = 0x00;

pub const IPC_CMD_DS0: c_uint = 0x4;
pub const IPC_CMD_STANDBY: c_uint = 0xc;
pub const IPC_CMD_IDLE: c_uint = 0x10;
pub const IPC_CMD_RESET: c_uint = 0xe;
pub const DS_IPC_DEFAULT: c_uint = 0xffffffff;
pub const M3_VERSION_UNKNOWN: c_uint = 0x0000ffff;
pub const M3_BASELINE_VERSION: c_uint = 0x191;

pub const M3_FW_VERSION_MASK: c_uint = 0xffff;
pub const M3_WAKE_SRC_MASK: c_uint = 0xff;

pub const M3_STATE_UNKNOWN: c_int = 0;
pub const M3_STATE_RESET: c_int = 1;
pub const M3_STATE_INITED: c_int = 2;
pub const M3_STATE_MSG_FOR_LP: c_int = 3;
pub const M3_STATE_MSG_FOR_RESET: c_int = 4;
pub const WKUP_M3_SD_FW_MAGIC: c_uint = 0x570C;
pub const WKUP_M3_DMEM_START: c_uint = 0x80000;
pub const WKUP_M3_AUXDATA_OFFSET: c_uint = 0x1000;
pub const WKUP_M3_AUXDATA_SIZE: c_uint = 0xFF;
...
#[no_mangle]
unsafe extern "C" fn wkup_m3_scale_data_fw_cb(fw: *const firmware, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn wkup_m3_set_halt_late(enabled: bool) {
...
#[no_mangle]
unsafe extern "C" fn option_get(data: *mut c_void, val: *mut u64) -> c_int {
...
// option = val;
    ...
    "%llu\n");
#[no_mangle]
unsafe extern "C" fn wkup_m3_ipc_dbg_init(m3_ipc: *mut wkup_m3_ipc) -> c_int {
    static int wkup_m3_ipc_dbg_init(struct wkup_m3_ipc *m3_ipc)
    {
    m3_ipc.dbg_path = debugfs_create_dir("wkup_m3_ipc", core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn wkup_m3_ipc_dbg_destroy(m3_ipc: *mut wkup_m3_ipc) {
...
#[no_mangle]
pub unsafe extern "C" fn wkup_m3_ipc_dbg_init(m3_ipc: *mut wkup_m3_ipc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn am33xx_txev_eoi(m3_ipc: *mut wkup_m3_ipc) {
...
#[no_mangle]
unsafe extern "C" fn am33xx_txev_enable(m3_ipc: *mut wkup_m3_ipc) {
...
#[no_mangle]
unsafe extern "C" fn wkup_m3_fw_version_read(m3_ipc: *mut wkup_m3_ipc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wkup_m3_txev_handler(irq: c_int, ipc_data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wkup_m3_ping(m3_ipc: *mut wkup_m3_ipc) -> c_int {
...
// by the CM3.
//
    ret = mbox_send_message(m3_ipc.mbox, core::ptr::null_mut());
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn wkup_m3_ping_noirq(m3_ipc: *mut wkup_m3_ipc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wkup_m3_is_available(m3_ipc: *mut wkup_m3_ipc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wkup_m3_set_vtt_gpio(m3_ipc: *mut wkup_m3_ipc, gpio: c_int) {
...
#[no_mangle]
unsafe extern "C" fn wkup_m3_set_io_isolation(m3_ipc: *mut wkup_m3_ipc) {
...
//
#[no_mangle]
unsafe extern "C" fn wkup_m3_set_mem_type(m3_ipc: *mut wkup_m3_ipc, mem_type: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn wkup_m3_set_resume_address(m3_ipc: *mut wkup_m3_ipc, addr: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn wkup_m3_request_pm_status(m3_ipc: *mut wkup_m3_ipc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wkup_m3_prepare_low_power(m3_ipc: *mut wkup_m3_ipc, state: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wkup_m3_finish_low_power(m3_ipc: *mut wkup_m3_ipc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wkup_m3_set_rtc_only(m3_ipc: *mut wkup_m3_ipc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn wkup_m3_ipc_put(m3_ipc: *mut wkup_m3_ipc) {
...
#[no_mangle]
unsafe extern "C" fn wkup_m3_rproc_boot_thread(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wkup_m3_ipc_probe(pdev: *mut platform_device) -> c_int {
    ...
    m3_ipc.mbox_client.tx_done = core::ptr::null_mut();
    m3_ipc.mbox_client.tx_prepare = core::ptr::null_mut();
    m3_ipc.mbox_client.rx_callback = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn wkup_m3_ipc_remove(pdev: *mut platform_device) {
    ...
    m3_ipc_state = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn wkup_m3_ipc_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn wkup_m3_ipc_resume(dev: *mut device) -> int __maybe_unused {
