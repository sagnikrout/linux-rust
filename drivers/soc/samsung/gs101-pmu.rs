...
//! Source: drivers/soc/samsung/gs101-pmu.c
#![no_std]
...
pub const TENSOR_SMC_PMU_SEC_REG: c_uint = 0x82000504;
pub const TENSOR_PMUREG_READ: c_int = 0;
pub const TENSOR_PMUREG_WRITE: c_int = 1;
pub const TENSOR_PMUREG_RMW: c_int = 2;
...
#[no_mangle]
pub unsafe extern "C" fn tensor_sec_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
    int tensor_sec_reg_write(void *context, unsigned int reg, unsigned int val)
    {
    struct arm_smccc_res res;
    let mut pmu_base: c_ulong = (unsigned long)context;
...
//
#[no_mangle]
pub unsafe extern "C" fn tensor_sec_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tensor_is_atomic(reg: c_uint) -> bool {
