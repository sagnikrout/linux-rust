...
//! Source: drivers/soc/samsung/s3c-pm-check.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn s3c_pm_run_res(ptr: *mut resource, fn: run_fn_t, arg: *mut u32) {
    static void s3c_pm_run_res(struct resource *ptr, run_fn_t fn, u32 *arg)
    {
    while (ptr != core::ptr::null_mut()) {
    if (ptr.child != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn s3c_pm_run_sysram(fn: run_fn_t, arg: *mut u32) {
    ...
    {
    let mut size: u32 = (u32)resource_size(res);
...
//
#[no_mangle]
pub unsafe extern "C" fn s3c_pm_check_prepare() {
...
//
#[no_mangle]
pub unsafe extern "C" fn s3c_pm_check_store() {
...
//
#[no_mangle]
pub unsafe extern "C" fn in_region(ptr: *mut c_void, size: c_int, what: *mut c_void, whatsz: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn s3c_pm_check_restore() {
...
//
#[no_mangle]
pub unsafe extern "C" fn s3c_pm_check_cleanup() {
    void s3c_pm_check_cleanup(void)
    {
    kfree(crcs);
    crcs = core::ptr::null_mut();
    }
