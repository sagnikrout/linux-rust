...
//! Source: drivers/soc/samsung/exynos3250-pmu.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn exynos3250_powerdown_conf_extra(mode: enum sys_powerdown) {
...
#[no_mangle]
unsafe extern "C" fn exynos3250_pmu_init() {
