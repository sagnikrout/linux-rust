...
//! Source: drivers/soc/samsung/exynos-chipid.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct exynos_chipid_variant {
    pub /: *mut *mut unsigned int main_rev_reg; / main revision register offset,
    pub /: *mut *mut unsigned int sub_rev_reg; / sub revision register offset,
    pub /: *mut *mut unsigned int main_rev_shift; / main revision offset in rev_reg,
    pub /: *mut *mut unsigned int sub_rev_shift; / sub revision offset in rev_reg,
    pub efuse: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct exynos_chipid_info {
    pub product_id: u32,
    pub revision: u32,
}
...
#[no_mangle]
unsafe extern "C" fn exynos_chipid_unregister_soc(data: *mut c_void) {
    static void exynos_chipid_unregister_soc(void *data)
    {
    soc_device_unregister(data);
    }
#[no_mangle]
unsafe extern "C" fn exynos_chipid_probe(pdev: *mut platform_device) -> c_int {
