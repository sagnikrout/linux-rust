...
//! Source: drivers/soc/xilinx/zynqmp_power.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynqmp_pm_work_struct {
    pub callback_work: work_struct,
    pub args: [u32; CB_ARG_CNT],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynqmp_pm_event_info {
    pub cb_fun: event_cb_func_t,
    ...
    let mut suspend_mode: static enum pm_suspend_mode = PM_SUSPEND_MODE_STD;
#[no_mangle]
unsafe extern "C" fn zynqmp_pm_get_callback_data(buf: *mut u32) {
    static void zynqmp_pm_get_callback_data(u32 *buf)
    {
    zynqmp_pm_invoke_fn(GET_CALLBACK_DATA, buf, 0);
    }
#[no_mangle]
unsafe extern "C" fn subsystem_restart_event_callback(payload: *const u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn suspend_event_callback(payload: *const u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_pm_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ipi_receive_callback(cl: *mut mbox_client, data: *mut c_void) {
...
// Send NULL message to mbox controller to ack the message
    ret = mbox_send_message(rx_chan, core::ptr::null_mut());
    if (ret)
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_pm_subsystem_restart_work_fn(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_pm_init_suspend_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn unregister_event(dev: *mut device, res: *mut c_void) {
    ...
    event_info.event, event_info.cb_fun, core::ptr::null_mut());
    }
    ...
    event_info.event, event_info.wake, event_info.cb_fun, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_pm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(PM_VERSAL_FAMILY_CODE: pm_family_code ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_pm_remove(pdev: *mut platform_device) {
    static void zynqmp_pm_remove(struct platform_device *pdev)
    {
    sysfs_remove_file(&pdev.dev.kobj, &dev_attr_suspend_mode.attr);
    if (rx_chan) {
    mbox_free_channel(rx_chan);
    rx_chan = core::ptr::null_mut();
    }
    }
