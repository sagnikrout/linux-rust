...
//! Source: drivers/soc/mediatek/mtk-dvfsrc.c
#![no_std]
...
pub const DVFSRC_TGT_LEVEL_IDLE: c_uint = 0x00;
...
// DVFSRC_GEAR_INFO
pub const DVFSRC_V4_GEAR_INFO_REG_WIDTH: c_uint = 0x4;
pub const DVFSRC_V4_GEAR_INFO_REG_LEVELS: c_int = 64;

pub const DVFSRC_POLL_TIMEOUT_US: c_int = 1000;
pub const STARTUP_TIME_US: c_int = 1;
pub const MTK_SIP_DVFSRC_INIT: c_uint = 0x0;
pub const MTK_SIP_DVFSRC_START: c_uint = 0x1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dvfsrc_opp_desc {
    pub opps: *const dvfsrc_opp,
    pub num_opp: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_dvfsrc {
    pub dev: *mut device,
    pub clk: *mut clk,
    pub icc: *mut platform_device,
    pub regulator: *mut platform_device,
    pub dvd: *const dvfsrc_soc_data,
    pub curr_opps: *const dvfsrc_opp_desc,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dvfsrc_soc_data {
    pub regs: *const c_int,
    pub bw_units: *const u8,
    pub has_emi_ddr: bool,
    pub opps_desc: *const dvfsrc_opp_desc,
    pub bw): *mut *mut *mut u32 (calc_dram_bw)(struct mtk_dvfsrc dvfsrc, enum mtk_dvfsrc_bw_type type, u64,
    pub dvfsrc): *mut *mut u32 (get_target_level)(struct mtk_dvfsrc,
    pub dvfsrc): *mut *mut u32 (get_current_level)(struct mtk_dvfsrc,
    pub dvfsrc): *mut *mut u32 (get_vcore_level)(struct mtk_dvfsrc,
    pub dvfsrc): *mut *mut u32 (get_vscp_level)(struct mtk_dvfsrc,
    pub dvfsrc): *mut *mut u32 (get_opp_count)(struct mtk_dvfsrc,
    pub dvfsrc): *mut *mut int (get_hw_opps)(struct mtk_dvfsrc,
    pub bw): *mut *mut *mut void (set_dram_bw)(struct mtk_dvfsrc dvfsrc, u64,
    pub bw): *mut *mut *mut void (set_dram_peak_bw)(struct mtk_dvfsrc dvfsrc, u64,
    pub bw): *mut *mut *mut void (set_dram_hrt_bw)(struct mtk_dvfsrc dvfsrc, u64,
    pub level): *mut *mut *mut void (set_opp_level)(struct mtk_dvfsrc dvfsrc, u32,
    pub level): *mut *mut *mut void (set_vcore_level)(struct mtk_dvfsrc dvfsrc, u32,
    pub level): *mut *mut *mut void (set_vscp_level)(struct mtk_dvfsrc dvfsrc, u32,
    pub level): *mut *mut *mut int (wait_for_opp_level)(struct mtk_dvfsrc dvfsrc, u32,
    pub level): *mut *mut *mut int (wait_for_vcore_level)(struct mtk_dvfsrc dvfsrc, u32,
//
...
//
    pub bw_max_constraints: *const *const u32,
//
...
// hardware value for each bandwidth type.
//
    pub bw_min_constraints: *const *const u32,
}

#[no_mangle]
unsafe extern "C" fn dvfsrc_readl(dvfs: *mut mtk_dvfsrc, offset: u32) -> u32 {
    static u32 dvfsrc_readl(struct mtk_dvfsrc *dvfs, u32 offset)
    {
    return readl(dvfs.regs + dvfs.dvd.regs[offset]);
    }
#[no_mangle]
unsafe extern "C" fn dvfsrc_writel(dvfs: *mut mtk_dvfsrc, offset: u32, val: u32) {
    ...
    {
    let mut level: u32 = dvfsrc.dvd.get_current_level(dvfsrc);
    return &dvfsrc.curr_opps.opps[level];
    }
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_current_target_vcore_gear(dvfsrc: *mut mtk_dvfsrc) -> u32 {
    static u32 dvfsrc_get_current_target_vcore_gear(struct mtk_dvfsrc *dvfsrc)
    {
    let mut val: u32 = dvfsrc_readl(dvfsrc, DVFSRC_TARGET_GEAR);
    return FIELD_GET(DVFSRC_V4_GEAR_TARGET_VCORE, val);
    }
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_current_target_dram_gear(dvfsrc: *mut mtk_dvfsrc) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_is_idle(dvfsrc: *mut mtk_dvfsrc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_wait_for_vcore_level_v1(dvfsrc: *mut mtk_dvfsrc, level: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_wait_for_opp_level_v1(dvfsrc: *mut mtk_dvfsrc, level: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_wait_for_opp_level_v2(dvfsrc: *mut mtk_dvfsrc, level: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_wait_for_vcore_level_v4(dvfsrc: *mut mtk_dvfsrc, level: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_wait_for_opp_level_v4(dvfsrc: *mut mtk_dvfsrc, level: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_target_level_v1(dvfsrc: *mut mtk_dvfsrc) -> u32 {
    static u32 dvfsrc_get_target_level_v1(struct mtk_dvfsrc *dvfsrc)
    {
    let mut val: u32 = dvfsrc_readl(dvfsrc, DVFSRC_LEVEL);
    return FIELD_GET(DVFSRC_V1_LEVEL_TARGET_LEVEL, val);
    }
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_current_level_v1(dvfsrc: *mut mtk_dvfsrc) -> u32 {
    static u32 dvfsrc_get_current_level_v1(struct mtk_dvfsrc *dvfsrc)
    {
    let mut val: u32 = dvfsrc_readl(dvfsrc, DVFSRC_LEVEL);
    let mut current_level: u32 = FIELD_GET(DVFSRC_V1_LEVEL_CURRENT_LEVEL, val);
    return ffs(current_level) - 1;
    }
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_target_level_v2(dvfsrc: *mut mtk_dvfsrc) -> u32 {
    static u32 dvfsrc_get_target_level_v2(struct mtk_dvfsrc *dvfsrc)
    {
    return dvfsrc_readl(dvfsrc, DVFSRC_TARGET_LEVEL);
    }
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_current_level_v2(dvfsrc: *mut mtk_dvfsrc) -> u32 {
    static u32 dvfsrc_get_current_level_v2(struct mtk_dvfsrc *dvfsrc)
    {
    let mut val: u32 = dvfsrc_readl(dvfsrc, DVFSRC_LEVEL);
    let mut level: u32 = ffs(val);
// Valid levels
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_target_level_v4(dvfsrc: *mut mtk_dvfsrc) -> u32 {
    static u32 dvfsrc_get_target_level_v4(struct mtk_dvfsrc *dvfsrc)
    {
    let mut val: u32 = dvfsrc_readl(dvfsrc, DVFSRC_TARGET_LEVEL);
    if (val & DVFSRC_V4_LEVEL_TARGET_PRESENT)
    return FIELD_GET(DVFSRC_V4_LEVEL_TARGET_LEVEL, val) + 1;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_current_level_v4(dvfsrc: *mut mtk_dvfsrc) -> u32 {
    static u32 dvfsrc_get_current_level_v4(struct mtk_dvfsrc *dvfsrc)
    {
    let mut level: u32 = dvfsrc_readl(dvfsrc, DVFSRC_LEVEL) + 1;
// Valid levels
    if (level < dvfsrc.curr_opps.num_opp)
    return dvfsrc.curr_opps.num_opp - level;
// Zero for level 0 or invalid level
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_vcore_level_v1(dvfsrc: *mut mtk_dvfsrc) -> u32 {
    static u32 dvfsrc_get_vcore_level_v1(struct mtk_dvfsrc *dvfsrc)
    {
    let mut val: u32 = dvfsrc_readl(dvfsrc, DVFSRC_SW_REQ2);
    return FIELD_GET(DVFSRC_V1_SW_REQ2_VCORE_LEVEL, val);
    }
#[no_mangle]
unsafe extern "C" fn dvfsrc_set_vcore_level_v1(dvfsrc: *mut mtk_dvfsrc, level: u32) {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_vcore_level_v2(dvfsrc: *mut mtk_dvfsrc) -> u32 {
    static u32 dvfsrc_get_vcore_level_v2(struct mtk_dvfsrc *dvfsrc)
    {
    let mut val: u32 = dvfsrc_readl(dvfsrc, DVFSRC_SW_REQ);
    return FIELD_GET(DVFSRC_V2_SW_REQ_VCORE_LEVEL, val);
    }
#[no_mangle]
unsafe extern "C" fn dvfsrc_set_vcore_level_v2(dvfsrc: *mut mtk_dvfsrc, level: u32) {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_vscp_level_v2(dvfsrc: *mut mtk_dvfsrc) -> u32 {
    static u32 dvfsrc_get_vscp_level_v2(struct mtk_dvfsrc *dvfsrc)
    {
    let mut val: u32 = dvfsrc_readl(dvfsrc, DVFSRC_VCORE);
    return FIELD_GET(DVFSRC_V2_VCORE_REQ_VSCP_LEVEL, val);
    }
#[no_mangle]
unsafe extern "C" fn dvfsrc_set_vscp_level_v2(dvfsrc: *mut mtk_dvfsrc, level: u32) {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_opp_count_v4(dvfsrc: *mut mtk_dvfsrc) -> u32 {
    static u32 dvfsrc_get_opp_count_v4(struct mtk_dvfsrc *dvfsrc)
    {
    let mut val: u32 = dvfsrc_readl(dvfsrc, DVFSRC_BASIC_CONTROL);
...
//
    ...
    {
    let mut bw_unit: u8 = dvfsrc.dvd.bw_units[type];
    u64 bw_mbps;
    u32 bw_hw;
    ...
    {
    let mut bw_hw: u32 = dvfsrc.dvd.calc_dram_bw(dvfsrc, type, bw);
    dvfsrc_writel(dvfsrc, reg, bw_hw);
    if (type == DVFSRC_BW_AVG && dvfsrc.dvd.has_emi_ddr)
    dvfsrc_writel(dvfsrc, DVFSRC_SW_EMI_BW, bw_hw);
    }
#[no_mangle]
unsafe extern "C" fn dvfsrc_set_dram_bw_v1(dvfsrc: *mut mtk_dvfsrc, bw: u64) {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_set_dram_peak_bw_v1(dvfsrc: *mut mtk_dvfsrc, bw: u64) {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_set_dram_hrt_bw_v1(dvfsrc: *mut mtk_dvfsrc, bw: u64) {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_set_opp_level_v1(dvfsrc: *mut mtk_dvfsrc, level: u32) {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_opp_gear(dvfsrc: *mut mtk_dvfsrc, level: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_hw_opps_v4(dvfsrc: *mut mtk_dvfsrc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_set_dram_level_v4(dvfsrc: *mut mtk_dvfsrc, level: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_dvfsrc_send_request(dev: *const device, cmd: u32, data: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_dvfsrc_query_info(dev: *const device, cmd: u32, data: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_dvfsrc_probe(pdev: *mut platform_device) -> c_int {
    ...
    dvfsrc.dev = &pdev.dev;
    dvfsrc.regs = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
    if (IS_ERR(dvfsrc.regs))
    return PTR_ERR(dvfsrc.regs);
    dvfsrc.clk = devm_clk_get_enabled(&pdev.dev, core::ptr::null_mut());
