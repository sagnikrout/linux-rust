...
//! Source: drivers/soc/mediatek/mtk-svs.c
#![no_std]
...
pub const SVSB_MODE_ALL_DISABLE: c_int = 0;

// svs bank volt flags

// svs bank register fields and common configuration

pub const SVSB_DET_WINDOW: c_uint = 0xa28;
// DESCHAR
...
pub const SVSB_PTPEN_OFF: c_uint = 0x0;
// FREQPCTS

// INTSTS
pub const SVSB_INTSTS_VAL_CLEAN: c_uint = 0x00ffffff;

pub const SVSB_RUNCONFIG_DEFAULT: c_uint = 0x80000000;
// LIMITVALS

pub const SVSB_VAL_DTHI: c_uint = 0x1;
pub const SVSB_VAL_DTLO: c_uint = 0xfe;
// INTEN
...
pub const SVSB_TS_COEFF_MT8195: c_int = 250460;
pub const SVSB_TS_COEFF_MT8186: c_int = 204650;
// Algo helpers

// svs bank related setting
pub const BITS8: c_int = 8;
pub const MAX_OPP_ENTRIES: c_int = 16;
pub const REG_BYTES: c_int = 4;

pub const SVSB_TEMP_LOWER_BOUND: c_uint = 0xb2;
pub const SVSB_TEMP_UPPER_BOUND: c_uint = 0x64;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct svs_platform {
    pub base: *mut void __iomem,
    pub dev: *mut device,
    pub main_clk: *mut clk,
    pub banks: *mut svs_bank,
    pub rst: *mut reset_control,
    pub efuse_max: usize,
    pub tefuse_max: usize,
    pub regs: *const u32,
    pub efuse: *mut u32,
    pub tefuse: *mut u32,
    pub ts_coeff: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct svs_platform_data {
    pub name: *mut c_char,
    pub banks: *mut svs_bank,
    pub pdata): *const *const *const bool (efuse_parsing)(struct svs_platform svsp, struct svs_platform_data,
    pub svsp): *mut *mut int (probe)(struct svs_platform,
    pub glb_fuse_map: *const svs_fusemap,
    pub regs: *const u32,
    pub ts_coeff: u32,
    pub bank_max: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct svs_bank_pdata {
    pub dev_fuse_map: *const svs_fusemap,
    pub buck_name: *mut c_char,
    pub tzone_name: *mut c_char,
    pub age_config: u32,
    pub ctl0: u32,
    pub dc_config: u32,
    pub int_st: u32,
    pub turn_freq_base: u32,
    pub tzone_htemp: u32,
    pub tzone_ltemp: u32,
    pub volt_step: u32,
    pub volt_base: u32,
    pub tzone_htemp_voffset: u16,
    pub tzone_ltemp_voffset: u16,
    pub chk_shift: u8,
    pub cpu_id: u8,
    pub opp_count: u8,
    pub vboot: u8,
    ...
    pub type: u8,
// Callbacks
    pub svsb): *mut *mut *mut void (set_freq_pct)(struct svs_platform svsp, struct svs_bank,
    pub svsb): *mut *mut *mut void (get_volts)(struct svs_platform svsp, struct svs_bank,
}
...
#[derive(Copy, Clone)]
pub struct svs_bank {
    pub pdata: svs_bank_pdata,
    pub dev: *mut device,
    pub opp_dev: *mut device,
    pub init_completion: completion,
    pub buck: *mut regulator,
    pub tzd: *mut thermal_zone_device,
    pub lock: mutex,
    pub pm_runtime_enabled_count: c_int,
    pub volt_od: short int,
    pub name: *mut c_char,
    pub phase: enum svsb_phase,
    pub reg_data: [u32; SVSB_PHASE_MAX][SVS_REG_MAX],
    pub mode_support: u8,
    pub opp_dfreq: [u32; MAX_OPP_ENTRIES],
    pub opp_dvolt: [u32; MAX_OPP_ENTRIES],
    pub freq_pct: [u32; MAX_OPP_ENTRIES],
    pub volt: [u32; MAX_OPP_ENTRIES],
    pub volt_flags: u32,
    pub freq_base: u32,
    pub turn_pt: u32,
    pub vbin_turn_pt: u32,
    pub core_sel: u32,
    pub temp: u32,
    pub age_voffset_in: u16,
    pub dc_voffset_in: u16,
    pub dvt_fixed: u8,
    pub vmax: u8,
    pub vmin: u8,
    pub bts: u16,
...
#[no_mangle]
unsafe extern "C" fn percent(numerator: u32, denominator: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn svs_readl_relaxed(svsp: *mut svs_platform, rg_i: enum svs_reg_index) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn svs_switch_bank(svsp: *mut svs_platform, svsb: *mut svs_bank) {
...
#[no_mangle]
unsafe extern "C" fn svs_sync_bank_volts_from_opp(svsb: *mut svs_bank) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svs_adjust_pm_opp_volts(svsb: *mut svs_bank) -> c_int {
    static int svs_adjust_pm_opp_volts(struct svs_bank *svsb)
    {
    let mut ret: c_int = -EPERM, tzone_temp = 0;
    const struct svs_bank_pdata *bdata = &svsb.pdata;
...
#[no_mangle]
pub unsafe extern "C" fn if(bdata->tzone_ltemp: tzone_temp <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn svs_dump_debug_show(m: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(SVSB_PHASE_MON: i ==) -> else {
    ...
    debug_fops_ro(dump);
#[no_mangle]
unsafe extern "C" fn svs_enable_debug_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svs_status_debug_show(m: *mut seq_file, v: *mut c_void) -> c_int {
    static int svs_status_debug_show(struct seq_file *m, void *v)
    {
    struct svs_bank *svsb = (struct svs_bank *)m.private;
    struct dev_pm_opp *opp;
    let mut tzone_temp: c_int = 0, ret;
    u32 i;
    ret = thermal_zone_get_temp(svsb.tzd, &tzone_temp);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn svs_create_debug_cmds(svsp: *mut svs_platform) -> c_int {
...
pub struct svs_dentry {
    ...
    svs_dir = debugfs_create_dir("svs", core::ptr::null_mut());
    if (IS_ERR(svs_dir)) {
...
#[no_mangle]
unsafe extern "C" fn interpolate(f0: u32, f1: u32, v0: u32, v1: u32, fx: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn svs_get_bank_volts_v3(svsp: *mut svs_platform, svsb: *mut svs_bank) {
    ...
    let mut middle_index: u32 = (bdata.opp_count / 2);
...
#[no_mangle]
unsafe extern "C" fn svs_set_bank_freq_pct_v3(svsp: *mut svs_platform, svsb: *mut svs_bank) {
...
#[no_mangle]
unsafe extern "C" fn svs_get_bank_volts_v2(svsp: *mut svs_platform, svsb: *mut svs_bank) {
...
#[no_mangle]
unsafe extern "C" fn svs_set_bank_freq_pct_v2(svsp: *mut svs_platform, svsb: *mut svs_bank) {
...
#[no_mangle]
unsafe extern "C" fn svs_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t svs_isr(int irq, void *data)
    {
    struct svs_platform *svsp = data;
    const struct svs_bank_pdata *bdata;
    struct svs_bank *svsb = core::ptr::null_mut();
    unsigned long flags;
...
#[no_mangle]
pub unsafe extern "C" fn if(SVSB_INTSTS_FLD_MONVOP: int_sts &) -> else {
...
#[no_mangle]
unsafe extern "C" fn svs_mode_available(svsp: *mut svs_platform, mode: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn svs_init01(svsp: *mut svs_platform) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svs_init02(svsp: *mut svs_platform) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svs_mon_mode(svsp: *mut svs_platform) {
...
#[no_mangle]
unsafe extern "C" fn svs_start(svsp: *mut svs_platform) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svs_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svs_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svs_bank_resource_setup(svsp: *mut svs_platform) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svs_get_fuse_val(fuse_array: *mut u32, fmap: *const svs_fusemap, nbits: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn svs_is_available(svsp: *mut svs_platform) -> bool {
...
// Thermal efuse parsing
    ...
    np = of_find_node_by_name(core::ptr::null_mut(), node_name);
    if (!np) {
    ...
    if (!sup_link) {
    dev_err(svsp.dev, "sup_link is core::ptr::null_mut()\n");
...
#[no_mangle]
unsafe extern "C" fn svs_put_device(_dev: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn svs_mt8192_platform_probe(svsp: *mut svs_platform) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svs_mt8183_platform_probe(svsp: *mut svs_platform) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svs_probe(pdev: *mut platform_device) -> c_int {
    ...
    ret = devm_request_threaded_irq(svsp.dev, svsp_irq, core::ptr::null_mut(), svs_isr,
