...
//! Source: drivers/soc/mediatek/mtk-pmic-wrap.c
#![no_std]
...
pub const PWRAP_POLL_DELAY_US: c_int = 10;
pub const PWRAP_POLL_TIMEOUT_US: c_int = 10000;
pub const PWRAP_MT8135_BRIDGE_IORD_ARB_EN: c_uint = 0x4;
pub const PWRAP_MT8135_BRIDGE_WACS3_EN: c_uint = 0x10;
pub const PWRAP_MT8135_BRIDGE_INIT_DONE3: c_uint = 0x14;
pub const PWRAP_MT8135_BRIDGE_WACS4_EN: c_uint = 0x24;
pub const PWRAP_MT8135_BRIDGE_INIT_DONE4: c_uint = 0x28;
pub const PWRAP_MT8135_BRIDGE_INT_EN: c_uint = 0x38;
pub const PWRAP_MT8135_BRIDGE_TIMER_EN: c_uint = 0x48;
pub const PWRAP_MT8135_BRIDGE_WDT_UNIT: c_uint = 0x50;
pub const PWRAP_MT8135_BRIDGE_WDT_SRC_EN: c_uint = 0x54;
// macro for wrapper status

// macro for WACS FSM
pub const PWRAP_WACS_FSM_IDLE: c_uint = 0x00;
pub const PWRAP_WACS_FSM_REQ: c_uint = 0x02;
pub const PWRAP_WACS_FSM_WFDLE: c_uint = 0x04;
pub const PWRAP_WACS_FSM_WFVLDCLR: c_uint = 0x06;
pub const PWRAP_WACS_INIT_DONE: c_uint = 0x01;
pub const PWRAP_WACS_WACS_SYNC_IDLE: c_uint = 0x01;
pub const PWRAP_WACS_SYNC_BUSY: c_uint = 0x00;
// macro for device wrapper default value
pub const PWRAP_DEW_READ_TEST_VAL: c_uint = 0x5aa5;
pub const PWRAP_DEW_COMP_READ_TEST_VAL: c_uint = 0xa55a;
pub const PWRAP_DEW_WRITE_TEST_VAL: c_uint = 0xa55a;
// macro for manual command

// macro for Watch Dog Timer Source

pub const PWRAP_WDT_SRC_MASK_ALL: c_uint = 0xffffffff;
...
//
    pub rdata): *mut *mut *mut int (pwrap_read)(struct pmic_wrapper wrp, u32 adr, u32,
    pub wdata): *mut *mut *mut int (pwrap_write)(struct pmic_wrapper wrp, u32 adr, u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwrap_slv_type {
    pub dew_regs: *const u32,
    pub type: enum pmic_type,
    pub comp_dew_regs: *const u32,
    pub comp_type: enum pmic_type,
    pub regops: *const pwrap_slv_regops,
    pub caps: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmic_wrapper {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub regmap: *mut regmap,
    pub master: *const pmic_wrapper_type,
    pub slave: *const pwrap_slv_type,
    pub rstc: *mut reset_control,
    pub rstc_bridge: *mut reset_control,
    pub bridge_base: *mut void __iomem,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmic_wrapper_type {
    pub regs: *const c_int,
    pub type: enum pwrap_type,
    pub arb_en_all: u32,
    pub int_en_all: u32,
    pub int1_en_all: u32,
    pub spi_w: u32,
...
// Flags indicating the capability for the target pwrap
    pub caps: u32,
    pub wrp): *mut *mut int (init_reg_clock)(struct pmic_wrapper,
    pub wrp): *mut *mut int (init_soc_specific)(struct pmic_wrapper,
}

#[no_mangle]
unsafe extern "C" fn pwrap_readl(wrp: *mut pmic_wrapper, reg: enum pwrap_regs) -> u32 {
    static u32 pwrap_readl(struct pmic_wrapper *wrp, enum pwrap_regs reg)
    {
    return readl(wrp.base + wrp.master.regs[reg]);
    }
#[no_mangle]
unsafe extern "C" fn pwrap_writel(wrp: *mut pmic_wrapper, val: u32, reg: enum pwrap_regs) {
    static void pwrap_writel(struct pmic_wrapper *wrp, u32 val, enum pwrap_regs reg)
    {
    writel(val, wrp.base + wrp.master.regs[reg]);
    }
#[no_mangle]
unsafe extern "C" fn pwrap_get_fsm_state(wrp: *mut pmic_wrapper) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pwrap_is_fsm_idle(wrp: *mut pmic_wrapper) -> bool {
    static bool pwrap_is_fsm_idle(struct pmic_wrapper *wrp)
    {
    return pwrap_get_fsm_state(wrp) == PWRAP_WACS_FSM_IDLE;
    }
#[no_mangle]
unsafe extern "C" fn pwrap_is_fsm_vldclr(wrp: *mut pmic_wrapper) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn pwrap_leave_fsm_vldclr(wrp: *mut pmic_wrapper) {
...
#[no_mangle]
unsafe extern "C" fn pwrap_is_sync_idle(wrp: *mut pmic_wrapper) -> bool {
    static bool pwrap_is_sync_idle(struct pmic_wrapper *wrp)
    {
    return pwrap_readl(wrp, PWRAP_WACS2_RDATA) & PWRAP_STATE_SYNC_IDLE0;
    }
#[no_mangle]
unsafe extern "C" fn pwrap_is_fsm_idle_and_sync_idle(wrp: *mut pmic_wrapper) -> bool {
    static bool pwrap_is_fsm_idle_and_sync_idle(struct pmic_wrapper *wrp)
    {
    let mut val: u32 = pwrap_readl(wrp, PWRAP_WACS2_RDATA);
    return (PWRAP_GET_WACS_FSM(val) == PWRAP_WACS_FSM_IDLE) &&
    (val & PWRAP_STATE_SYNC_IDLE0);
    }
#[no_mangle]
unsafe extern "C" fn pwrap_read16(wrp: *mut pmic_wrapper, adr: u32, rdata: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_read32(wrp: *mut pmic_wrapper, adr: u32, rdata: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_read(wrp: *mut pmic_wrapper, adr: u32, rdata: *mut u32) -> c_int {
    static int pwrap_read(struct pmic_wrapper *wrp, u32 adr, u32 *rdata)
    {
    return wrp.slave.regops.pwrap_read(wrp, adr, rdata);
    }
#[no_mangle]
unsafe extern "C" fn pwrap_write16(wrp: *mut pmic_wrapper, adr: u32, wdata: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_write32(wrp: *mut pmic_wrapper, adr: u32, wdata: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_write(wrp: *mut pmic_wrapper, adr: u32, wdata: u32) -> c_int {
    static int pwrap_write(struct pmic_wrapper *wrp, u32 adr, u32 wdata)
    {
    return wrp.slave.regops.pwrap_write(wrp, adr, wdata);
    }
#[no_mangle]
unsafe extern "C" fn pwrap_regmap_read(context: *mut c_void, adr: u32, rdata: *mut u32) -> c_int {
    static int pwrap_regmap_read(void *context, u32 adr, u32 *rdata)
    {
    return pwrap_read(context, adr, rdata);
    }
#[no_mangle]
unsafe extern "C" fn pwrap_regmap_write(context: *mut c_void, adr: u32, wdata: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_reset_spislave(wrp: *mut pmic_wrapper) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pwrap_init_sidly(wrp: *mut pmic_wrapper) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_init_dual_io(wrp: *mut pmic_wrapper) -> c_int {
    static int pwrap_init_dual_io(struct pmic_wrapper *wrp)
    {
    int ret;
    bool read_ok, tmp;
    let mut comp_read_ok: bool = true;
// Enable dual IO mode
...
#[no_mangle]
unsafe extern "C" fn pwrap_common_init_reg_clock(wrp: *mut pmic_wrapper) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_mt2701_init_reg_clock(wrp: *mut pmic_wrapper) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_is_cipher_ready(wrp: *mut pmic_wrapper) -> bool {
    static bool pwrap_is_cipher_ready(struct pmic_wrapper *wrp)
    {
    return pwrap_readl(wrp, PWRAP_CIPHER_RDY) & 1;
    }
#[no_mangle]
unsafe extern "C" fn __pwrap_is_pmic_cipher_ready(wrp: *mut pmic_wrapper, dew_regs: *const u32) -> bool {
    ...
    if (ret)
    return false;
    let mut rdata: return = = 1;
    }
#[no_mangle]
unsafe extern "C" fn pwrap_is_pmic_cipher_ready(wrp: *mut pmic_wrapper) -> bool {
    static bool pwrap_is_pmic_cipher_ready(struct pmic_wrapper *wrp)
    {
    let mut ret: bool = __pwrap_is_pmic_cipher_ready(wrp, wrp.slave.dew_regs);
    if (!ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn pwrap_config_cipher(wrp: *mut pmic_wrapper, dew_regs: *const u32) {
...
#[no_mangle]
unsafe extern "C" fn pwrap_init_cipher(wrp: *mut pmic_wrapper) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_init_security(wrp: *mut pmic_wrapper) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_mt8135_init_soc_specific(wrp: *mut pmic_wrapper) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_mt8173_init_soc_specific(wrp: *mut pmic_wrapper) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_mt2701_init_soc_specific(wrp: *mut pmic_wrapper) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_mt6795_init_soc_specific(wrp: *mut pmic_wrapper) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_mt7622_init_soc_specific(wrp: *mut pmic_wrapper) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_mt8183_init_soc_specific(wrp: *mut pmic_wrapper) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_init(wrp: *mut pmic_wrapper) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrap_interrupt(irqno: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
    ...
    .init_soc_specific = core::ptr::null_mut(),
    };
...
#[no_mangle]
unsafe extern "C" fn pwrap_probe(pdev: *mut platform_device) -> c_int {
    ...
    const struct of_device_id *of_slave_id = core::ptr::null_mut();
    if (np.child)
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: HAS_CAP(wrp->master->caps, _arg: PWRAP_CAP_ARB_MT8186)) -> else {
...
//
    ...
    if (ret)
    return ret;
    wrp.regmap = devm_regmap_init(wrp.dev, core::ptr::null_mut(), wrp, wrp.slave.regops.regmap);
    if (IS_ERR(wrp.regmap))
    return PTR_ERR(wrp.regmap);
    ret = of_platform_populate(np, core::ptr::null_mut(), core::ptr::null_mut(), wrp.dev);
    if (ret) {
