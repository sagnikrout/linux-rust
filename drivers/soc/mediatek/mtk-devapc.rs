...
//! Source: drivers/soc/mediatek/mtk-devapc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_devapc_vio_dbgs {
    union {
    pub vio_dbg0: u32,
    struct {
    pub mstid:16: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_devapc_regs_ofs {
// reg offset
    pub vio_mask_offset: u32,
    pub vio_sta_offset: u32,
    pub vio_dbg0_offset: u32,
    pub vio_dbg1_offset: u32,
    pub apc_con_offset: u32,
    pub vio_shift_sta_offset: u32,
    pub vio_shift_sel_offset: u32,
    pub vio_shift_con_offset: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_devapc_data {
// numbers of violation index
    pub vio_idx_num: u32,
    pub regs_ofs: *const mtk_devapc_regs_ofs,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_devapc_context {
    pub dev: *mut device,
    pub infra_base: *mut void __iomem,
    pub infra_clk: *mut clk,
    pub data: *const mtk_devapc_data,
}

#[no_mangle]
unsafe extern "C" fn clear_vio_status(ctx: *mut mtk_devapc_context) {
...
#[no_mangle]
unsafe extern "C" fn mask_module_irq(ctx: *mut mtk_devapc_context, mask: bool) {
...
pub const PHY_DEVAPC_TIMEOUT: c_uint = 0x10000;
//
...
//
#[no_mangle]
unsafe extern "C" fn devapc_sync_vio_dbg(ctx: *mut mtk_devapc_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn devapc_extract_vio_dbg(ctx: *mut mtk_devapc_context) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: vio_dbgs.dbg0_bits.vio_r) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn devapc_violation_irq(irq_number: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn start_devapc(ctx: *mut mtk_devapc_context) {
...
//
#[no_mangle]
unsafe extern "C" fn stop_devapc(ctx: *mut mtk_devapc_context) {
...
#[no_mangle]
unsafe extern "C" fn mtk_devapc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_devapc_remove(pdev: *mut platform_device) {
