...
//! Source: drivers/soc/tegra/flowctrl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn flowctrl_update(offset: u8, value: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn flowctrl_read_cpu_csr(cpuid: c_uint) -> u32 {
    u32 flowctrl_read_cpu_csr(unsigned int cpuid)
    {
    let mut offset: u8 = flowctrl_offset_cpu_csr[cpuid];
    if (WARN_ONCE(IS_ERR_OR_NULL(tegra_flowctrl_base),
    "Tegra flowctrl not initialised!\n"))
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn flowctrl_write_cpu_csr(cpuid: c_uint, value: u32) {
    void flowctrl_write_cpu_csr(unsigned int cpuid, u32 value)
    {
    return flowctrl_update(flowctrl_offset_cpu_csr[cpuid], value);
    }
#[no_mangle]
pub unsafe extern "C" fn flowctrl_write_cpu_halt(cpuid: c_uint, value: u32) {
    void flowctrl_write_cpu_halt(unsigned int cpuid, u32 value)
    {
    return flowctrl_update(flowctrl_offset_halt_cpu[cpuid], value);
    }
#[no_mangle]
pub unsafe extern "C" fn flowctrl_cpu_suspend_enter(cpuid: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn flowctrl_cpu_suspend_exit(cpuid: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn tegra_flowctrl_probe(pdev: *mut platform_device) -> c_int {
    static int tegra_flowctrl_probe(struct platform_device *pdev)
    {
    void __iomem *base = tegra_flowctrl_base;
    tegra_flowctrl_base = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn tegra_flowctrl_init() -> int __init {
    ...
    if (!soc_is_tegra())
    return 0;
    np = of_find_matching_node(core::ptr::null_mut(), tegra_flowctrl_match);
    if (np) {
