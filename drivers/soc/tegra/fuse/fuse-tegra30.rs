...
//! Source: drivers/soc/tegra/fuse/fuse-tegra30.c
#![no_std]
...
// Tegra30 and later
pub const FUSE_VENDOR_CODE: c_uint = 0x100;
pub const FUSE_FAB_CODE: c_uint = 0x104;
pub const FUSE_LOT_CODE_0: c_uint = 0x108;
pub const FUSE_LOT_CODE_1: c_uint = 0x10c;
pub const FUSE_WAFER_ID: c_uint = 0x110;
pub const FUSE_X_COORDINATE: c_uint = 0x114;
pub const FUSE_Y_COORDINATE: c_uint = 0x118;
...
#[no_mangle]
unsafe extern "C" fn tegra30_fuse_read_early(fuse: *mut tegra_fuse, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tegra30_fuse_read(fuse: *mut tegra_fuse, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tegra30_fuse_init(fuse: *mut tegra_fuse) -> void __init {
