...
//! Source: drivers/soc/tegra/fuse/fuse-tegra.c
#![no_std]
...
//
    ...
    size_t bytes)
    {
    let mut count: c_uint = bytes / 4, i;
...
#[no_mangle]
unsafe extern "C" fn tegra_fuse_restore(base: *mut c_void) {
    static void tegra_fuse_restore(void *base)
    {
    fuse.base = (void __iomem *)base;
    fuse.clk = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn tegra_fuse_print_sku_info(tegra_sku_info: *mut tegra_sku_info) {
...
#[no_mangle]
unsafe extern "C" fn tegra_fuse_add_lookups(fuse: *mut tegra_fuse) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_fuse_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct resource *res;
    int err;
    err = devm_add_action(&pdev.dev, tegra_fuse_restore, (void  *)base);
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn tegra_fuse_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_fuse_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_fuse_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_fuse_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_fuse_read_spare(spare: c_uint) -> u32 __init {
    u32 __init tegra_fuse_read_spare(unsigned int spare)
    {
    let mut offset: c_uint = fuse.soc.info.spare + spare * 4;
    return fuse.read_early(fuse, offset) & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn tegra_fuse_read_early(offset: c_uint) -> u32 __init {
    u32 __init tegra_fuse_read_early(unsigned int offset)
    {
    return fuse.read_early(fuse, offset);
    }
#[no_mangle]
pub unsafe extern "C" fn tegra_fuse_readl(offset: c_ulong, value: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_enable_fuse_clk(base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn tegra_init_fuse() -> int __init {
    ...
    let mut err: c_int = 0;
    tegra_init_apbmisc();
    np = of_find_matching_node_and_match(core::ptr::null_mut(), tegra_fuse_match, &match);
    if (!np) {
//
...
//
    ...
    let mut chip: u8 = tegra_get_chip_id();
...
//
    ...
    np = of_find_matching_node(core::ptr::null_mut(), car_match);
    if (np) {
...
#[no_mangle]
unsafe extern "C" fn tegra_init_soc() -> int __init {
    static int __init tegra_init_soc(void)
    {
    struct device_node *np;
    struct device *soc;
// make sure we're running on Tegra
    np = of_find_matching_node(core::ptr::null_mut(), tegra_fuse_match);
    if (!np)
    return 0;
    of_node_put(np);
