...
//! Source: drivers/soc/tegra/cbb/tegra194-cbb.c
#![no_std]
...
pub const ERRLOGGER_0_ID_COREID_0: c_uint = 0x00000000;
pub const ERRLOGGER_0_ID_REVISIONID_0: c_uint = 0x00000004;
pub const ERRLOGGER_0_FAULTEN_0: c_uint = 0x00000008;
pub const ERRLOGGER_0_ERRVLD_0: c_uint = 0x0000000c;
pub const ERRLOGGER_0_ERRCLR_0: c_uint = 0x00000010;
pub const ERRLOGGER_0_ERRLOG0_0: c_uint = 0x00000014;
pub const ERRLOGGER_0_ERRLOG1_0: c_uint = 0x00000018;
pub const ERRLOGGER_0_RSVD_00_0: c_uint = 0x0000001c;
pub const ERRLOGGER_0_ERRLOG3_0: c_uint = 0x00000020;
pub const ERRLOGGER_0_ERRLOG4_0: c_uint = 0x00000024;
pub const ERRLOGGER_0_ERRLOG5_0: c_uint = 0x00000028;
pub const ERRLOGGER_0_STALLEN_0: c_uint = 0x00000038;
pub const ERRLOGGER_1_ID_COREID_0: c_uint = 0x00000080;
pub const ERRLOGGER_1_ID_REVISIONID_0: c_uint = 0x00000084;
pub const ERRLOGGER_1_FAULTEN_0: c_uint = 0x00000088;
pub const ERRLOGGER_1_ERRVLD_0: c_uint = 0x0000008c;
pub const ERRLOGGER_1_ERRCLR_0: c_uint = 0x00000090;
pub const ERRLOGGER_1_ERRLOG0_0: c_uint = 0x00000094;
pub const ERRLOGGER_1_ERRLOG1_0: c_uint = 0x00000098;
pub const ERRLOGGER_1_RSVD_00_0: c_uint = 0x0000009c;
pub const ERRLOGGER_1_ERRLOG3_0: c_uint = 0x000000a0;
pub const ERRLOGGER_1_ERRLOG4_0: c_uint = 0x000000a4;
pub const ERRLOGGER_1_ERRLOG5_0: c_uint = 0x000000a8;
pub const ERRLOGGER_1_STALLEN_0: c_uint = 0x000000b8;
pub const ERRLOGGER_2_ID_COREID_0: c_uint = 0x00000100;
pub const ERRLOGGER_2_ID_REVISIONID_0: c_uint = 0x00000104;
pub const ERRLOGGER_2_FAULTEN_0: c_uint = 0x00000108;
pub const ERRLOGGER_2_ERRVLD_0: c_uint = 0x0000010c;
pub const ERRLOGGER_2_ERRCLR_0: c_uint = 0x00000110;
pub const ERRLOGGER_2_ERRLOG0_0: c_uint = 0x00000114;
pub const ERRLOGGER_2_ERRLOG1_0: c_uint = 0x00000118;
pub const ERRLOGGER_2_RSVD_00_0: c_uint = 0x0000011c;
pub const ERRLOGGER_2_ERRLOG3_0: c_uint = 0x00000120;
pub const ERRLOGGER_2_ERRLOG4_0: c_uint = 0x00000124;
pub const ERRLOGGER_2_ERRLOG5_0: c_uint = 0x00000128;
pub const ERRLOGGER_2_STALLEN_0: c_uint = 0x00000138;

pub const DMAAPB_X_RAW_INTERRUPT_STATUS: c_uint = 0x2ec;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra194_cbb_packet_header {
    pub [0]: bool lock; //,
    pub [4:1]: u8 opc; //,
    pub URG: u8 errcode; // [10:8]= RD, RDW, RDL, RDX, WR, WRW, WRC, PRE,,
    pub [27:16]: u16 len1; //,
    pub above: bool format; // [31] = 1 -> FlexNoC versions 2.7 &,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra194_cbb_aperture {
    pub initflow: u8,
    pub targflow: u8,
    pub targ_subrange: u8,
    pub init_mapping: u8,
    pub init_localaddress: u32,
    pub targ_mapping: u8,
    pub targ_localaddress: u32,
    pub seqid: u16,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra194_cbb_userbits {
    pub axcache: u8,
    pub non_mod: u8,
    pub axprot: u8,
    pub falconsec: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra194_cbb_noc_data {
    pub name: *const c_char,
    pub erd_mask_inband_err: bool,
    pub initiator_id: *const *const c_char,
    pub max_aperture: c_uint,
    pub noc_aperture: *const tegra194_cbb_aperture,
    pub routeid_initflow: *const *const c_char,
    pub routeid_targflow: *const *const c_char,
    pub routeid): *mut *mut *mut void (parse_routeid)(struct tegra194_cbb_aperture info, u64,
    pub elog_5): *mut *mut *mut void (parse_userbits)(struct tegra194_cbb_userbits usrbits, u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra194_axi2apb_bridge {
    pub res: resource,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra194_cbb {
    pub base: tegra_cbb,
    pub noc: *const tegra194_cbb_noc_data,
    pub res: *mut resource,
    pub regs: *mut void __iomem,
    pub num_intr: c_uint,
    pub sec_irq: c_uint,
    pub nonsec_irq: c_uint,
    pub errlog0: u32,
    pub errlog1: u32,
    pub errlog2: u32,
    pub errlog3: u32,
    pub errlog4: u32,
    pub errlog5: u32,
    pub bridges: *mut tegra194_axi2apb_bridge,
...
#[no_mangle]
unsafe extern "C" fn cbbcentralnoc_parse_routeid(info: *mut tegra194_cbb_aperture, routeid: u64) {
...
#[no_mangle]
unsafe extern "C" fn bpmpnoc_parse_routeid(info: *mut tegra194_cbb_aperture, routeid: u64) {
...
#[no_mangle]
unsafe extern "C" fn aonnoc_parse_routeid(info: *mut tegra194_cbb_aperture, routeid: u64) {
...
#[no_mangle]
unsafe extern "C" fn scenoc_parse_routeid(info: *mut tegra194_cbb_aperture, routeid: u64) {
...
#[no_mangle]
unsafe extern "C" fn cbbcentralnoc_parse_userbits(usrbits: *mut tegra194_cbb_userbits, elog_5: u32) {
...
#[no_mangle]
unsafe extern "C" fn clusternoc_parse_userbits(usrbits: *mut tegra194_cbb_userbits, elog_5: u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cbb_fault_enable(cbb: *mut tegra_cbb) {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cbb_stall_enable(cbb: *mut tegra_cbb) {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cbb_error_clear(cbb: *mut tegra_cbb) {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cbb_get_status(cbb: *mut tegra_cbb) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tegra194_axi2apb_status(addr: *mut void __iomem) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tegra194_axi2apb_fatal(file: *mut seq_file, bridge: c_uint, status: u32) -> bool {
    static bool tegra194_axi2apb_fatal(struct seq_file *file, unsigned int bridge, u32 status)
    {
    let mut is_fatal: bool = true;
    size_t i;
...
#[no_mangle]
unsafe extern "C" fn print_errlog5(file: *mut seq_file, cbb: *mut tegra194_cbb) {
...
//
    ...
    {
    let mut addr: u64 = (u64)errlog4 << 32 | errlog3;
//
...
//
    ...
    {
    let mut routeid: u64 = (u64)cbb.errlog2 << 32 | cbb.errlog1;
    let mut seqid: u32 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn print_errlog0(file: *mut seq_file, cbb: *mut tegra194_cbb) -> bool {
...
//
    ...
    int errloggerX)
    {
    let mut info: tegra194_cbb_aperture = { 0, };
    let mut is_fatal: bool = true;
...
#[no_mangle]
unsafe extern "C" fn print_errlog(file: *mut seq_file, cbb: *mut tegra194_cbb, errvld: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x2: errvld &) -> else {
    else if (errvld & 0x2)
    is_fatal = print_errloggerX_info(file, cbb, 1);
#[no_mangle]
pub unsafe extern "C" fn if(0x4: errvld &) -> else {
    else if (errvld & 0x4)
...
#[no_mangle]
unsafe extern "C" fn tegra194_cbb_debugfs_show(cbb: *mut tegra_cbb, file: *mut seq_file, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tegra194_cbb_err_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t tegra194_cbb_err_isr(int irq, void *data)
    {
    let mut is_inband_err: bool = false, is_fatal = false;
// struct tegra194_cbb *cbb = data;
    struct tegra_cbb *noc;
    unsigned long flags;
    let mut mstr_id: u8 = 0;
...
// XXX only process interrupts for "cbb" instead of iterating over all NOCs?
    ...
    tegra_cbb_print_err(core::ptr::null_mut(), "CPU:%d, Error: %s@%llx, irq=%d\n",
    smp_processor_id(), priv.noc.name, priv.res.start,
    irq);
    is_fatal = print_errlog(core::ptr::null_mut(), priv, status);
//
...
//
#[no_mangle]
unsafe extern "C" fn tegra194_cbb_interrupt_enable(cbb: *mut tegra_cbb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cbb_error_enable(cbb: *mut tegra_cbb) {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cbb_get_bridges(cbb: *mut tegra194_cbb, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cbb_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cbb_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cbb_resume_noirq(dev: *mut device) -> int __maybe_unused {
    ...
    SET_NOIRQ_SYSTEM_SLEEP_PM_OPS(core::ptr::null_mut(), tegra194_cbb_resume_noirq)
    };
...
#[no_mangle]
unsafe extern "C" fn tegra194_cbb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cbb_exit() -> void __exit {
