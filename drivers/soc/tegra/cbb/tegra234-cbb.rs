...
pub const FABRIC_EN_CFG_INTERRUPT_ENABLE_0_0: c_uint = 0x0;
pub const FABRIC_EN_CFG_STATUS_0_0: c_uint = 0x40;
pub const FABRIC_EN_CFG_ADDR_INDEX_0_0: c_uint = 0x60;
pub const FABRIC_EN_CFG_ADDR_LOW_0: c_uint = 0x80;
pub const FABRIC_EN_CFG_ADDR_HI_0: c_uint = 0x84;
pub const FABRIC_EN_CFG_TARGET_NODE_ADDR_INDEX_0_0: c_uint = 0x100;
pub const FABRIC_EN_CFG_TARGET_NODE_ADDR_LOW_0: c_uint = 0x140;
pub const FABRIC_EN_CFG_TARGET_NODE_ADDR_HI_0: c_uint = 0x144;
pub const FABRIC_MN_INITIATOR_ERR_EN_0: c_uint = 0x200;
pub const FABRIC_MN_INITIATOR_ERR_FORCE_0: c_uint = 0x204;
pub const FABRIC_MN_INITIATOR_ERR_STATUS_0: c_uint = 0x208;
pub const FABRIC_MN_INITIATOR_ERR_OVERFLOW_STATUS_0: c_uint = 0x20c;
pub const FABRIC_MN_INITIATOR_LOG_ERR_STATUS_0: c_uint = 0x300;
pub const FABRIC_MN_INITIATOR_LOG_ADDR_LOW_0: c_uint = 0x304;
pub const FABRIC_MN_INITIATOR_LOG_ADDR_HIGH_0: c_uint = 0x308;
pub const FABRIC_MN_INITIATOR_LOG_ATTRIBUTES0_0: c_uint = 0x30c;
pub const FABRIC_MN_INITIATOR_LOG_ATTRIBUTES1_0: c_uint = 0x310;
pub const FABRIC_MN_INITIATOR_LOG_ATTRIBUTES2_0: c_uint = 0x314;
pub const FABRIC_MN_INITIATOR_LOG_USER_BITS0_0: c_uint = 0x318;
pub const AXI_SLV_TIMEOUT_STATUS_0_0: c_uint = 0x8;
pub const APB_BLOCK_TMO_STATUS_0: c_uint = 0xc00;
pub const APB_BLOCK_NUM_TMO_OFFSET: c_uint = 0x20;

pub const CCPLEX_MSTRID: c_uint = 0x1;
pub const FIREWALL_APERTURE_SZ: c_uint = 0x10000;
// Write firewall check enable
pub const WEN: c_uint = 0x20000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra234_target_lookup {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra234_fabric_lookup {
    pub name: *const c_char,
    pub is_lookup: bool,
    pub target_map: *const tegra234_target_lookup,
    pub max_targets: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra234_cbb_fabric {
    pub fab_id: c_int,
    pub off_mask_erd: phys_addr_t,
    pub firewall_base: phys_addr_t,
    pub firewall_ctl: c_uint,
    pub firewall_wr_ctl: c_uint,
    pub initiator_id: *const *const c_char,
    pub notifier_offset: c_uint,
    pub errors: *const tegra_cbb_error,
    pub max_errors: c_int,
    pub fab_list: *const tegra234_fabric_lookup,
    pub err_intr_enbl: u32,
    pub err_status_clr: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra234_cbb {
    pub base: tegra_cbb,
    pub fabric: *const tegra234_cbb_fabric,
    pub res: *mut resource,
    pub regs: *mut void __iomem,
    pub num_intr: c_int,
    pub sec_irq: c_int,
// record
    pub mon: *mut void __iomem,
    pub type: c_uint,
    pub mask: u32,
    pub access: u64,
    pub mn_attr0: u32,
...
#[no_mangle]
unsafe extern "C" fn tegra234_cbb_fault_enable(cbb: *mut tegra_cbb) {
...
#[no_mangle]
unsafe extern "C" fn tegra234_cbb_error_clear(cbb: *mut tegra_cbb) {
...
#[no_mangle]
unsafe extern "C" fn tegra234_cbb_get_status(cbb: *mut tegra_cbb) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tegra234_cbb_mask_serror(cbb: *mut tegra234_cbb) {
...
#[no_mangle]
unsafe extern "C" fn tegra234_cbb_get_tmo_slv(addr: *mut void __iomem) -> u32 {
    ...
    struct tegra234_cbb *target_cbb = core::ptr::null_mut();
    void __iomem *addr;
...
//
    ...
    u8 target_id, u8 fab_id)
    {
    let mut notifier: c_uint = cbb.fabric.notifier_offset;
    u32 hi, lo;
    u64 addr;
...
#[no_mangle]
unsafe extern "C" fn print_errlog_err(file: *mut seq_file, cbb: *mut tegra234_cbb) {
...
#[no_mangle]
unsafe extern "C" fn print_errmonX_info(file: *mut seq_file, cbb: *mut tegra234_cbb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_err_notifier(file: *mut seq_file, cbb: *mut tegra234_cbb, status: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra234_cbb_debugfs_show(cbb: *mut tegra_cbb, file: *mut seq_file, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tegra234_cbb_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t tegra234_cbb_isr(int irq, void *data)
    {
    let mut is_inband_err: bool = false;
    ...
    list_for_each_entry(cbb, &cbb_list, node) {
    struct tegra234_cbb *priv = to_tegra234_cbb(cbb);
    let mut status: u32 = tegra_cbb_get_status(cbb);
    if (status && (irq == priv.sec_irq)) {
    tegra_cbb_print_err(core::ptr::null_mut(), "CPU:%d, Error: %s@0x%llx, irq=%d\n",
    smp_processor_id(),
    priv.fabric.fab_list[priv.fabric.fab_id].name,
    priv.res.start, irq);
    err = print_err_notifier(core::ptr::null_mut(), priv, status);
    if (err)
    goto unlock;
//
...
//
#[no_mangle]
unsafe extern "C" fn tegra234_cbb_interrupt_enable(cbb: *mut tegra_cbb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra234_cbb_error_enable(cbb: *mut tegra_cbb) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra234_cbb_acpi_uid {
...
#[no_mangle]
unsafe extern "C" fn tegra234_cbb_probe(pdev: *mut platform_device) -> c_int {
    ...
    err = tegra_cbb_get_irq(pdev, core::ptr::null_mut(), &cbb.sec_irq);
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn tegra234_cbb_resume_noirq(dev: *mut device) -> int __maybe_unused {
...
// set ERD bit to mask SError and generate interrupt to report error
    ...
    SET_NOIRQ_SYSTEM_SLEEP_PM_OPS(core::ptr::null_mut(), tegra234_cbb_resume_noirq)
    };
...
#[no_mangle]
unsafe extern "C" fn tegra234_cbb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tegra234_cbb_exit() -> void __exit {
