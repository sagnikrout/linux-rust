...
//! Source: drivers/soc/tegra/regulators-tegra20.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_regulator_coupler {
    pub coupler: regulator_coupler,
    pub core_rdev: *mut regulator_dev,
    pub cpu_rdev: *mut regulator_dev,
    pub rtc_rdev: *mut regulator_dev,
    pub reboot_notifier: notifier_block,
    pub suspend_notifier: notifier_block,
    pub cpu_min_uV: int core_min_uV,,
    pub sys_reboot_mode_req: bool,
    pub sys_reboot_mode: bool,
    pub sys_suspend_mode_req: bool,
    pub sys_suspend_mode: bool,
}
...
#[no_mangle]
unsafe extern "C" fn tegra20_cpu_nominal_uV() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra20_core_nominal_uV() -> c_int {
...
// prepare voltage level for suspend
    ...
    struct regulator_dev *rtc_rdev)
    {
    let mut cpu_min_uV_consumers: c_int = 0;
    let mut cpu_max_uV: c_int = INT_MAX;
    let mut cpu_min_uV: c_int = 0;
    int cpu_uV;
    int err;
...
//
    ...
    tegra.core_rdev = core::ptr::null_mut();
    return 0;
    }
    if (tegra.rtc_rdev == rdev) {
    tegra.rtc_rdev = core::ptr::null_mut();
    return 0;
    }
    if (tegra.cpu_rdev == rdev) {
    tegra.cpu_rdev = core::ptr::null_mut();
    return 0;
    }
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn tegra_regulator_coupler_init() -> int __init {
