...
//! Source: drivers/soc/tegra/regulators-tegra30.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tegra30_core_cpu_limit(cpu_uV: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra30_cpu_nominal_uV() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra30_core_nominal_uV() -> c_int {
