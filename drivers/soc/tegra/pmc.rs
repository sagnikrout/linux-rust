...
//! Source: drivers/soc/tegra/pmc.c
#![no_std]
...
pub const PMC_CNTRL: c_uint = 0x0;

pub const PMC_CNTRL_BLINK_EN: c_int = 7;

pub const PMC_WAKE_MASK: c_uint = 0x0c;
pub const PMC_WAKE_LEVEL: c_uint = 0x10;
pub const PMC_WAKE_STATUS: c_uint = 0x14;
pub const PMC_SW_WAKE_STATUS: c_uint = 0x18;
pub const PMC_DPD_PADS_ORIDE: c_uint = 0x1c;
pub const PMC_DPD_PADS_ORIDE_BLINK: c_int = 20;
pub const DPD_SAMPLE: c_uint = 0x020;

pub const PWRGATE_TOGGLE: c_uint = 0x30;

pub const REMOVE_CLAMPING: c_uint = 0x34;
pub const PWRGATE_STATUS: c_uint = 0x38;
pub const PMC_BLINK_TIMER: c_uint = 0x40;
pub const PMC_IMPL_E_33V_PWR: c_uint = 0x40;
pub const PMC_PWR_DET: c_uint = 0x48;

    PMC_SCRATCH0_MODE_BOOTLOADER | \
    PMC_SCRATCH0_MODE_RCM)
pub const PMC_CPUPWRGOOD_TIMER: c_uint = 0xc8;
pub const PMC_CPUPWROFF_TIMER: c_uint = 0xcc;
pub const PMC_COREPWRGOOD_TIMER: c_uint = 0x3c;
pub const PMC_COREPWROFF_TIMER: c_uint = 0xe0;
pub const PMC_PWR_DET_VALUE: c_uint = 0xe4;
pub const PMC_USB_DEBOUNCE_DEL: c_uint = 0xec;
pub const PMC_USB_AO: c_uint = 0xf0;
pub const PMC_SCRATCH37: c_uint = 0x130;
pub const PMC_SCRATCH41: c_uint = 0x140;
pub const PMC_WAKE2_MASK: c_uint = 0x160;
pub const PMC_WAKE2_LEVEL: c_uint = 0x164;
pub const PMC_WAKE2_STATUS: c_uint = 0x168;
pub const PMC_SW_WAKE2_STATUS: c_uint = 0x16c;
pub const PMC_CLK_OUT_CNTRL: c_uint = 0x1a8;

pub const PMC_SENSOR_CTRL: c_uint = 0x1b0;

pub const PMC_RST_STATUS_POR: c_int = 0;
pub const PMC_RST_STATUS_WATCHDOG: c_int = 1;
pub const PMC_RST_STATUS_SENSOR: c_int = 2;
pub const PMC_RST_STATUS_SW_MAIN: c_int = 3;
pub const PMC_RST_STATUS_LP0: c_int = 4;
pub const PMC_RST_STATUS_AOTAG: c_int = 5;
pub const IO_DPD_REQ: c_uint = 0x1b8;

pub const IO_DPD_STATUS: c_uint = 0x1bc;
pub const IO_DPD2_REQ: c_uint = 0x1c0;
pub const IO_DPD2_STATUS: c_uint = 0x1c4;
pub const SEL_DPD_TIM: c_uint = 0x1c8;
pub const PMC_UTMIP_UHSIC_TRIGGERS: c_uint = 0x1ec;
pub const PMC_UTMIP_UHSIC_SAVED_STATE: c_uint = 0x1f0;
pub const PMC_UTMIP_TERM_PAD_CFG: c_uint = 0x1f8;
pub const PMC_UTMIP_UHSIC_SLEEP_CFG: c_uint = 0x1fc;
pub const PMC_UTMIP_UHSIC_FAKE: c_uint = 0x218;
pub const PMC_SCRATCH54: c_uint = 0x258;
pub const PMC_SCRATCH54_DATA_SHIFT: c_int = 8;
pub const PMC_SCRATCH54_ADDR_SHIFT: c_int = 0;
pub const PMC_SCRATCH55: c_uint = 0x25c;

pub const PMC_SCRATCH55_CNTRL_ID_SHIFT: c_int = 27;
pub const PMC_SCRATCH55_PINMUX_SHIFT: c_int = 24;

pub const PMC_SCRATCH55_CHECKSUM_SHIFT: c_int = 16;
pub const PMC_SCRATCH55_I2CSLV1_SHIFT: c_int = 0;
pub const PMC_UTMIP_UHSIC_LINE_WAKEUP: c_uint = 0x26c;
pub const PMC_UTMIP_BIAS_MASTER_CNTRL: c_uint = 0x270;
pub const PMC_UTMIP_MASTER_CONFIG: c_uint = 0x274;
pub const PMC_UTMIP_UHSIC2_TRIGGERS: c_uint = 0x27c;
pub const PMC_UTMIP_MASTER2_CONFIG: c_uint = 0x29c;
pub const GPU_RG_CNTRL: c_uint = 0x2d4;
pub const PMC_UTMIP_PAD_CFG0: c_uint = 0x4c0;
pub const PMC_UTMIP_UHSIC_SLEEP_CFG1: c_uint = 0x4d0;
pub const PMC_UTMIP_SLEEPWALK_P3: c_uint = 0x4e0;
// Tegra186 and later
...
// for secure PMC
pub const TEGRA_SMC_PMC: c_uint = 0xc2fffe00;
pub const TEGRA_SMC_PMC_READ: c_uint = 0xaa;
pub const TEGRA_SMC_PMC_WRITE: c_uint = 0xbb;
// Tegra264 and later
pub const PMC_IMPL_SDMMC1_HV_PADCTL_0: c_uint = 0x41004;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmc_clk {
    pub hw: clk_hw,
    ...
    pub offs: c_ulong,
    pub mux_shift: u32,
    pub force_en_shift: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmc_clk_gate {
    pub hw: clk_hw,
    pub pmc: *mut tegra_pmc,
    pub offs: c_ulong,
    pub shift: u32,
...
pub struct tegra_powergate {
    ...
    pub clks: *mut clk,
    pub num_clks: c_uint,
    pub clk_rates: *mut c_ulong,
    pub reset: *mut reset_control,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_io_pad_soc {
    pub id: enum tegra_io_pad,
    pub dpd: c_uint,
    pub request: c_uint,
    pub status: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_pmc_regs {
    pub scratch0: c_uint,
    pub rst_status: c_uint,
    pub rst_source_shift: c_uint,
    pub rst_source_mask: c_uint,
    pub rst_level_shift: c_uint,
    pub rst_level_mask: c_uint,
    pub aowake_mask_w: c_uint,
    pub aowake_status_w: c_uint,
    pub aowake_status_r: c_uint,
    pub aowake_tier2_routing: c_uint,
    pub aowake_sw_status_w: c_uint,
    pub aowake_sw_status: c_uint,
    pub aowake_latch_sw: c_uint,
    pub aowake_ctrl: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_wake_event {
    pub name: *const c_char,
    pub id: c_uint,
    pub irq: c_uint,
    struct {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_pmc_soc {
    pub num_powergates: c_uint,
    pub powergates: *const *const c_char,
    pub num_cpu_powergates: c_uint,
    pub cpu_powergates: *const u8,
    pub has_tsense_reset: bool,
    pub has_gpu_clamps: bool,
    pub needs_mbist_war: bool,
    pub has_io_pad_wren: bool,
    pub maybe_tz_only: bool,
    pub io_pads: *const tegra_io_pad_soc,
    pub num_io_pads: c_uint,
    pub io_pad_vctrls: *const tegra_io_pad_vctrl,
    pub num_io_pad_vctrls: c_uint,
    pub pin_descs: *const pinctrl_pin_desc,
    pub num_pin_descs: c_uint,
    pub regs: *const tegra_pmc_regs,
    pub pmc): *mut *mut void (init)(struct tegra_pmc,
    void (*setup_irq_polarity)(struct tegra_pmc *pmc,
    pub np): *mut device_node,
    pub pmc): *mut *mut void (set_wake_filters)(struct tegra_pmc,
    pub on): *mut *mut *mut int (irq_set_wake)(struct irq_data data, unsigned int,
    pub type): *mut *mut *mut int (irq_set_type)(struct irq_data data, unsigned int,
    int (*powergate_set)(struct tegra_pmc *pmc, unsigned int id,
    pub new_state): bool,
    pub reset_sources: *const *const c_char,
    pub num_reset_sources: c_uint,
    pub reset_levels: *const *const c_char,
    pub num_reset_levels: c_uint,
//
...
//
    pub wake_events: *const tegra_wake_event,
    pub num_wake_events: c_uint,
    pub max_wake_events: c_uint,
    pub max_wake_vectors: c_uint,
    pub pmc_clks_data: *const pmc_clk_init_data,
    pub num_pmc_clks: c_uint,
    pub has_blink_output: bool,
    pub has_usb_sleepwalk: bool,
    pub supports_core_domain: bool,
    pub has_single_mmio_aperture: bool,
}
...
pub struct tegra_pmc {
    ...
    pub wake: *mut void __iomem,
    pub aotag: *mut void __iomem,
    pub scratch: *mut void __iomem,
    pub clk: *mut clk,
    pub soc: *const tegra_pmc_soc,
    pub tz_only: bool,
    pub rate: c_ulong,
    pub suspend_mode: enum tegra_suspend_mode,
    pub cpu_good_time: u32,
    pub cpu_off_time: u32,
    pub core_osc_time: u32,
    pub core_pmu_time: u32,
    pub core_off_time: u32,
    pub corereq_high: bool,
    pub sysclkreq_high: bool,
    pub combined_req: bool,
    pub cpu_pwr_good_en: bool,
    pub lp0_vec_phys: u32,
    pub lp0_vec_size: u32,
    pub invert_irq: bool,
    pub TEGRA_POWERGATE_MAX): DECLARE_BITMAP(powergates_available,,
    pub powergates_lock: mutex,
    pub pctl_dev: *mut pinctrl_dev,
    pub domain: *mut irq_domain,
    pub irq: irq_chip,
    pub clk_nb: notifier_block,
    pub core_domain_state_synced: bool,
    pub wake_type_level_map: *mut c_ulong,
    pub wake_type_dual_edge_map: *mut c_ulong,
    pub wake_sw_status_map: *mut c_ulong,
    pub wake_cntrl_level_map: *mut c_ulong,
    pub reboot_notifier: notifier_block,
    pub syscore: syscore,
// Pending wake IRQ processing
    pub wake_work: irq_work,
    pub wake_status: *mut u32,
}
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_readl(pmc: *mut tegra_pmc, offset: c_ulong) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_scratch_readl(pmc: *mut tegra_pmc, offset: c_ulong) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_powergate_state(pmc: *mut tegra_pmc, id: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_powergate_is_valid(pmc: *mut tegra_pmc, id: c_int) -> bool {
    static inline bool tegra_powergate_is_valid(struct tegra_pmc *pmc, int id)
    {
    return (pmc.soc && pmc.soc.powergates[id]);
    }
#[no_mangle]
pub unsafe extern "C" fn tegra_powergate_is_available(pmc: *mut tegra_pmc, id: c_int) -> bool {
    static inline bool tegra_powergate_is_available(struct tegra_pmc *pmc, int id)
    {
    return test_bit(id, pmc.powergates_available);
    }
#[no_mangle]
unsafe extern "C" fn tegra_powergate_lookup(pmc: *mut tegra_pmc, name: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_powergate_toggle_ready(pmc: *mut tegra_pmc) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(TEGRA_POWERGATE_PCIE: id ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn tegra_powergate_prepare_clocks(pg: *mut tegra_powergate) -> c_int {
    static int tegra_powergate_prepare_clocks(struct tegra_powergate *pg)
    {
    let mut safe_rate: c_ulong = 100 * 1000 * 1000;
    unsigned int i;
    int err;
...
#[no_mangle]
unsafe extern "C" fn tegra_powergate_unprepare_clocks(pg: *mut tegra_powergate) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_powergate_disable_clocks(pg: *mut tegra_powergate) {
...
#[no_mangle]
unsafe extern "C" fn tegra_powergate_enable_clocks(pg: *mut tegra_powergate) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_powergate_power_down(pg: *mut tegra_powergate) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_genpd_power_on(domain: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_genpd_power_off(domain: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_put_device(data: *mut c_void) {
    ...
    while ((parent = of_get_next_parent(parent)) != core::ptr::null_mut()) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tegra_pmc_powergate_power_on(pmc: *mut tegra_pmc, id: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tegra_pmc_powergate_power_off(pmc: *mut tegra_pmc, id: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tegra_powergate_is_powered(pmc: *mut tegra_pmc, id: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tegra_pmc_powergate_remove_clamping(pmc: *mut tegra_pmc, id: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_restart(pmc: *mut tegra_pmc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_restart_handler(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_grouper_power_off_handler(data: *mut sys_off_data) -> c_int {
...
//
    ...
    let mut go_to_charger_mode: u32 = 0xa5a55a5a;
...
#[no_mangle]
unsafe extern "C" fn powergate_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_powergate_add(pmc: *mut tegra_pmc, np: *mut device_node) -> c_int {
...
//
    ...
    err = pm_genpd_init(&pg.genpd, core::ptr::null_mut(), true);
    if (err < 0) {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_core_pd_add(pmc: *mut tegra_pmc, np: *mut device_node) -> c_int {
    static int tegra_pmc_core_pd_add(struct tegra_pmc *pmc, struct device_node *np)
    {
    const char *rname[] = { "core", core::ptr::null_mut()};
    ...
    err = pm_genpd_init(&pd.genpd, core::ptr::null_mut(), false);
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn tegra_powergate_remove(genpd: *mut generic_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn tegra_powergate_remove_all(parent: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn tegra_io_pad_unprepare(pmc: *mut tegra_pmc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tegra_pmc_io_pad_power_enable(pmc: *mut tegra_pmc, id: enum tegra_io_pad) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tegra_pmc_io_pad_power_disable(pmc: *mut tegra_pmc, id: enum tegra_io_pad) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_io_pad_is_powered(pmc: *mut tegra_pmc, id: enum tegra_io_pad) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_io_pad_get_voltage(pmc: *mut tegra_pmc, id: enum tegra_io_pad) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_parse_dt(pmc: *mut tegra_pmc, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra186_pmc_wake_handler(work: *mut irq_work) {
    ...
    let mut status: c_ulong = pmc.wake_status[i];
    for_each_set_bit(wake, &status, 32) {
    let mut hwirq: irq_hw_number_t = wake + (i * 32);
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_init(pmc: *mut tegra_pmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_init_tsense_reset(pmc: *mut tegra_pmc) {
...
#[no_mangle]
unsafe extern "C" fn tegra_io_pad_pinctrl_get_groups_count(pctl_dev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_pinctrl_init(pmc: *mut tegra_pmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_reset_sysfs_init(pmc: *mut tegra_pmc) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_pmc_irq_set_wake(data: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_pmc_irq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra186_pmc_set_wake_filters(pmc: *mut tegra_pmc) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_pmc_irq_set_wake(data: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra186_pmc_irq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_irq_mask_parent(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tegra_irq_unmask_parent(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tegra_irq_eoi_parent(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_irq_init(pmc: *mut tegra_pmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmc_clk_fence_udelay(pmc: *mut tegra_pmc, offset: u32) {
...
#[no_mangle]
unsafe extern "C" fn pmc_clk_mux_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn pmc_clk_mux_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmc_clk_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmc_clk_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmc_clk_disable(hw: *mut clk_hw) {
    ...
    return clk_register(core::ptr::null_mut(), &pmc_clk.hw);
    }
#[no_mangle]
unsafe extern "C" fn pmc_clk_gate_is_enabled(hw: *mut clk_hw) -> c_int {
    static int pmc_clk_gate_is_enabled(struct clk_hw *hw)
    {
    struct pmc_clk_gate *gate = to_pmc_clk_gate(hw);
    let mut value: u32 = tegra_pmc_readl(gate.pmc, gate.offs);
    return value & BIT(gate.shift) ? 1 : 0;
    }
#[no_mangle]
unsafe extern "C" fn pmc_clk_gate_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmc_clk_gate_disable(hw: *mut clk_hw) {
    ...
    gate.offs = offset;
    gate.shift = shift;
    return clk_register(core::ptr::null_mut(), &gate.hw);
    }
    ...
    err = clk_register_clkdev(clk, data.name, core::ptr::null_mut());
    if (err) {
    dev_warn(pmc.dev,
    ...
    err = clk_register_clkdev(clk, "pmc_blink", core::ptr::null_mut());
    if (err) {
    dev_warn(pmc.dev,
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_regmap_readl(context: *mut c_void, offset: c_uint, value: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_regmap_writel(context: *mut c_void, offset: c_uint, value: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_regmap_init(pmc: *mut tegra_pmc) -> c_int {
    static int tegra_pmc_regmap_init(struct tegra_pmc *pmc)
    {
    struct regmap *regmap;
    int err;
    if (pmc.soc.has_usb_sleepwalk) {
    regmap = devm_regmap_init(pmc.dev, core::ptr::null_mut(), pmc, &usb_sleepwalk_regmap_config);
    if (IS_ERR(regmap)) {
    err = PTR_ERR(regmap);
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_detect_tz_only(pmc: *mut tegra_pmc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_init_common(pmc: *mut tegra_pmc, np: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_reset_suspend_mode(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_probe(pdev: *mut platform_device) -> c_int {
...
// Some wakes require specific filter configuration
    ...
    debugfs_create_file("powergate", 0444, core::ptr::null_mut(), pmc, &powergate_fops);
    return 0;
    cleanup_powergates:
...
//
#[no_mangle]
unsafe extern "C" fn wke_32kwritel(pmc: *mut tegra_pmc, value: u32, offset: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn wke_write_wake_level(pmc: *mut tegra_pmc, wake: c_int, level: c_int) {
    static void wke_write_wake_level(struct tegra_pmc *pmc, int wake, int level)
    {
    let mut offset: c_uint = WAKE_AOWAKE_CNTRL(wake);
    u32 value;
...
#[no_mangle]
unsafe extern "C" fn wke_write_wake_levels(pmc: *mut tegra_pmc) {
...
#[no_mangle]
unsafe extern "C" fn wke_clear_sw_wake_status(pmc: *mut tegra_pmc) {
    static void wke_clear_sw_wake_status(struct tegra_pmc *pmc)
    {
    wke_32kwritel(pmc, 1, pmc.soc.regs.aowake_sw_status_w);
    }
#[no_mangle]
unsafe extern "C" fn wke_read_sw_wake_status(pmc: *mut tegra_pmc) {
...
#[no_mangle]
unsafe extern "C" fn wke_clear_wake_status(pmc: *mut tegra_pmc) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_pmc_wake_syscore_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_pmc_wake_syscore_suspend(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra20_pmc_init(pmc: *mut tegra_pmc) {
...
// program core timings which are applicable only for suspend state
    ...
    .cpu_powergates = core::ptr::null_mut(),
    ...
    .maybe_tz_only = false,
    .num_io_pads = 0,
    .io_pads = core::ptr::null_mut(),
    .num_pin_descs = 0,
    .pin_descs = core::ptr::null_mut(),
    .regs = &tegra20_pmc_regs,
    .init = tegra20_pmc_init,
    .setup_irq_polarity = tegra20_pmc_setup_irq_polarity,
    .powergate_set = tegra20_powergate_set,
    .reset_sources = core::ptr::null_mut(),
    .num_reset_sources = 0,
    .reset_levels = core::ptr::null_mut(),
    .num_reset_levels = 0,
    .pmc_clks_data = core::ptr::null_mut(),
    .num_pmc_clks = 0,
...
#[no_mangle]
unsafe extern "C" fn tegra186_pmc_init(pmc: *mut tegra_pmc) {
    ...
    "SENSOR",
    core::ptr::null_mut(),
    core::ptr::null_mut(),			/* 10 */
    "MAINSWRST",
    "SC7",
    core::ptr::null_mut(),
    core::ptr::null_mut(),
    core::ptr::null_mut(),			/* 15 */
    core::ptr::null_mut(),
    core::ptr::null_mut(),
    "RTC_XTAL_CSDC",
    "BPMPBOOT",
    ...
    "PSC_SW",
    "CSITE_SW",
    core::ptr::null_mut(),			/* 25 */
    core::ptr::null_mut(),
    "VREFRO_POWERBAD",
    core::ptr::null_mut(),
    core::ptr::null_mut(),
    core::ptr::null_mut(),			/* 30 */
    core::ptr::null_mut(),
    core::ptr::null_mut(),
    core::ptr::null_mut(),
    core::ptr::null_mut(),
    core::ptr::null_mut(),			/* 35 */
    core::ptr::null_mut(),
    core::ptr::null_mut(),
    "TOP0WDT",
    "TOP1WDT",
...
#[no_mangle]
unsafe extern "C" fn tegra_pmc_sync_state(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tegra_pmc_cpu_is_powered(cpuid: c_uint) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tegra_pmc_cpu_power_on(cpuid: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tegra_pmc_cpu_remove_clamping(cpuid: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_pmc_core_domain_state_synced() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_pmc_get_suspend_mode() -> enum tegra_suspend_mode {
    enum tegra_suspend_mode tegra_pmc_get_suspend_mode(void)
    {
    return early_pmc.suspend_mode;
    }
#[no_mangle]
pub unsafe extern "C" fn tegra_pmc_set_suspend_mode(mode: enum tegra_suspend_mode) {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_pmc_enter_suspend_mode(mode: enum tegra_suspend_mode) {
    void tegra_pmc_enter_suspend_mode(enum tegra_suspend_mode mode)
    {
    let mut rate: c_ulonglong = 0;
    u64 ticks;
    u32 value;
    switch (mode) {
...
//
#[no_mangle]
unsafe extern "C" fn tegra_pmc_early_init() -> int __init {
    ...
    np = of_find_matching_node_and_match(core::ptr::null_mut(), tegra_pmc_match, &match);
    if (!np) {
//
