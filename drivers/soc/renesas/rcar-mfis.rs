...
//! Source: drivers/soc/renesas/rcar-mfis.c
#![no_std]
...
pub const MFISWPCNTR: c_uint = 0x0900;
pub const MFISWACNTR: c_uint = 0x0904;

pub const MFIS_UNPROTECT_KEY: c_uint = 0xACCE0000;
    struct mfis_priv;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mfis_reg {
    ...
    pub priv: *mut mfis_priv,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mfis_info {
    pub unprotect_mask: u32,
    pub mb_num_channels: c_uint,
    pub mb_reg_comes_from_dt:1: c_uint,
    pub mb_tx_uses_eicr:1: c_uint,
    pub mb_channels_are_unidir:1: c_uint,
    pub is_only_rx): *mut *mut u32 (mb_calc_reg)(u32 chan_num, bool tx_uses_eicr, bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mfis_chan_priv {
    pub reg: u32,
    pub irq: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mfis_priv {
    pub /: *mut *mut spinlock_t unprotect_lock; / guards access to the unprotection reg,
    pub dev: *mut device,
    pub common_reg: mfis_reg,
    pub mbox_reg: mfis_reg,
    pub info: *const mfis_info,
// mailbox private data
    pub mbox: mbox_controller,
    pub chan_privs: *mut mfis_chan_priv,
}

#[no_mangle]
unsafe extern "C" fn mfis_read(mreg: *mut mfis_reg, reg: c_uint) -> u32 {
    static u32 mfis_read(struct mfis_reg *mreg, unsigned int reg)
    {
    return ioread32(mreg.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn mfis_write(mreg: *mut mfis_reg, reg: u32, val: u32) {
    static void mfis_write(struct mfis_reg *mreg, u32 reg, u32 val)
    {
    struct mfis_priv *priv = mreg.priv;
    let mut unprotect_mask: u32 = priv.info.unprotect_mask;
    unsigned long flags;
    u32 unprotect_code;
//
...
#[no_mangle]
unsafe extern "C" fn mfis_mb_iicr_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mfis_mb_startup(chan: *mut mbox_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mfis_mb_shutdown(chan: *mut mbox_chan) {
...
#[no_mangle]
unsafe extern "C" fn mfis_mb_iicr_send_data(chan: *mut mbox_chan, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mfis_mb_iicr_last_tx_done(chan: *mut mbox_chan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mfis_mb_r8a779g0_calc_reg(chan_num: u32, tx_uses_eicr: bool, is_only_rx: bool) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mfis_mb_r8a78000_calc_reg(chan_num: u32, tx_uses_eicr: bool, is_only_rx: bool) -> u32 {
...
// Channel layout is described in mfis_mb_probe()
    ...
    char irqname[8];
    let mut suffix: c_char = tx_uses_eicr ? 'i' : 'e';
// "ch0i" or "ch0e"
...
#[no_mangle]
unsafe extern "C" fn mfis_mb_probe(priv: *mut mfis_priv) -> c_int {
    static int mfis_mb_probe(struct mfis_priv *priv)
    {
    let mut num_chan: c_uint = priv.info.mb_num_channels;
...
#[no_mangle]
unsafe extern "C" fn mfis_probe(pdev: *mut platform_device) -> c_int {
