...
//! Source: drivers/soc/renesas/r9a09g056-sys.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rzv2n_regmap_readable_writeable_reg(reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rzv2n_regmap_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rzv2n_regmap_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
