...
//! Source: drivers/soc/renesas/r9a08g046-sysc.c
#![no_std]
...
pub const SYS_PWRRDY_N: c_uint = 0xd70;
pub const SYS_IPCONT_SEL_CLONECH: c_uint = 0xe2c;
#[no_mangle]
unsafe extern "C" fn rzg3l_regmap_readable_writeable_reg(reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rzg3l_regmap_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rzg3l_regmap_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
