...
//! Source: drivers/soc/renesas/r9a06g032-smp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn r9a06g032_smp_prepare_cpus(max_cpus: c_uint) -> void __init {
    static void __init r9a06g032_smp_prepare_cpus(unsigned int max_cpus)
    {
    struct device_node *dn;
    let mut ret: c_int = -EINVAL, dns;
    u32 bootaddr;
    dn = of_get_cpu_node(1, core::ptr::null_mut());
    if (!dn) {
