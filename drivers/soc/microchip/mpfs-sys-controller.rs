...
//! Source: drivers/soc/microchip/mpfs-sys-controller.c
#![no_std]
...
//
pub const MPFS_SYS_CTRL_TIMEOUT_MS: c_int = 30000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpfs_syscon_config {
    pub nb_subdevs: c_uint,
    pub subdevs: *mut platform_device,
}

#[no_mangle]
pub unsafe extern "C" fn mpfs_blocking_transaction(sys_controller: *mut mpfs_sys_controller, msg: *mut mpfs_mss_msg) -> c_int {
    int mpfs_blocking_transaction(struct mpfs_sys_controller *sys_controller, struct mpfs_mss_msg *msg)
    {
    let mut timeout: c_ulong = msecs_to_jiffies(MPFS_SYS_CTRL_TIMEOUT_MS);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mpfs_sys_controller_rx_callback(client: *mut mbox_client, msg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mpfs_sys_controller_delete(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn mpfs_sys_controller_put(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mpfs_sys_controller_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpfs_sys_controller_remove(pdev: *mut platform_device) {
