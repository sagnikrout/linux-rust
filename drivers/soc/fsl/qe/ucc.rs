...
//! Source: drivers/soc/fsl/qe/ucc.c
#![no_std]
...
pub const UCC_TDM_NUM: c_int = 8;
pub const RX_SYNC_SHIFT_BASE: c_int = 30;
pub const TX_SYNC_SHIFT_BASE: c_int = 14;
pub const RX_CLK_SHIFT_BASE: c_int = 28;
pub const TX_CLK_SHIFT_BASE: c_int = 12;
#[no_mangle]
pub unsafe extern "C" fn ucc_set_qe_mux_mii_mng(ucc_num: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ucc_set_type(ucc_num: c_uint, speed: enum ucc_speed_type) -> c_int {
...
// The GUEMR register is at the same location for both slow and fast
    ...
    {
    let mut cmx: c_uint = ((ucc_num & 1) << 1) + (ucc_num > 3);
// reg_num = cmx + 1;
// cmxucr = &qe_immr->qmx.cmxucr[cmx];
// shift = 16 - 8 * (ucc_num & 2);
    }
#[no_mangle]
pub unsafe extern "C" fn ucc_mux_set_grant_tsa_bkpt(ucc_num: c_uint, set: c_int, mask: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ucc_get_tdm_common_clk(tdm_num: u32, clock: enum qe_clock) -> c_int {
    static int ucc_get_tdm_common_clk(u32 tdm_num, enum qe_clock clock)
    {
    let mut clock_bits: c_int = -EINVAL;
//
...
#[no_mangle]
unsafe extern "C" fn ucc_get_tdm_rx_clk(tdm_num: u32, clock: enum qe_clock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ucc_get_tdm_tx_clk(tdm_num: u32, clock: enum qe_clock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ucc_get_tdm_clk_shift(mode: enum comm_dir, tdm_num: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ucc_get_tdm_sync_shift(mode: enum comm_dir, tdm_num: u32) -> u32 {
