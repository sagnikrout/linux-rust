...
//! Source: drivers/soc/fsl/qe/qe_common.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cpm_muram_init() -> c_int {
    ...
    if (muram_pbase)
    return 0;
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,cpm-muram-data");
    if (!np) {
// try legacy bindings
    np = of_find_node_by_name(core::ptr::null_mut(), "data-only");
    if (!np) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpm_muram_alloc(size: c_ulong, align: c_ulong) -> i32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpm_muram_free(offset: i32) {
...
#[no_mangle]
unsafe extern "C" fn devm_cpm_muram_release(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpm_muram_alloc_fixed(offset: c_ulong, size: c_ulong) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn cpm_muram_offset(addr: *const void __iomem) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpm_muram_dma(addr: *mut void __iomem) -> dma_addr_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpm_muram_free_addr(addr: *const void __iomem) {
