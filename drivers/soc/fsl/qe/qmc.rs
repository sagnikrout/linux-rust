...
//! Source: drivers/soc/fsl/qe/qmc.c
#![no_std]
...
pub const QMC_NB_TXBDS: c_int = 8;
pub const QMC_NB_RXBDS: c_int = 8;
pub const QMC_NB_INTS: c_int = 128;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmc_xfer_desc {
    union {
    pub context): *mut *mut void (tx_complete)(void,
    pub flags): *mut *mut *mut void (rx_complete)(void context, size_t length, unsigned int,
}
...
pub struct qmc_chan {
    ...
    pub id: c_uint,
    pub qmc: *mut qmc,
    pub s_param: *mut void __iomem,
    pub mode: enum qmc_mode,
    pub /: *mut *mut spinlock_t ts_lock; / Protect timeslots,
    pub tx_ts_mask_avail: u64,
    pub tx_ts_mask: u64,
    pub rx_ts_mask_avail: u64,
    pub rx_ts_mask: u64,
    pub is_reverse_data: bool,
    pub /: *mut *mut spinlock_t tx_lock; / Protect Tx related data,
    pub txbds: *mut cbd_t __iomem,
    pub txbd_free: *mut cbd_t __iomem,
    pub txbd_done: *mut cbd_t __iomem,
    pub tx_desc: [qmc_xfer_desc; QMC_NB_TXBDS],
    pub nb_tx_underrun: u64,
    pub is_tx_stopped: bool,
    pub /: *mut *mut spinlock_t rx_lock; / Protect Rx related data,
    pub rxbds: *mut cbd_t __iomem,
    pub rxbd_free: *mut cbd_t __iomem,
    pub rxbd_done: *mut cbd_t __iomem,
    pub rx_desc: [qmc_xfer_desc; QMC_NB_RXBDS],
    pub nb_rx_busy: u64,
    pub rx_pending: c_int,
    pub is_rx_halted: bool,
    pub is_rx_stopped: bool,
}
...
#[derive(Copy, Clone)]
pub struct qmc_data {
    pub version: enum qmc_version,
    pub /: *mut *mut u32 tstate; / Initial TSTATE value,
    pub /: *mut *mut u32 rstate; / Initial RSTATE value,
    pub /: *mut *mut u32 zistate; / Initial ZISTATE value,
    pub /: *mut *mut u32 zdstate_hdlc; / Initial ZDSTATE value (HDLC mode),
    pub /: *mut *mut u32 zdstate_transp; / Initial ZDSTATE value (Transparent mode),
    pub /: *mut *mut u32 rpack; / Initial RPACK value,
}
...
pub struct qmc {
    pub dev: *mut device,
    pub data: *const qmc_data,
    pub tsa_serial: *mut tsa_serial,
    pub scc_regs: *mut void __iomem,
    pub scc_pram: *mut void __iomem,
    pub dpram: *mut void __iomem,
    pub scc_pram_offset: u16,
    pub dpram_offset: u32,
    pub qe_subblock: u32,
    pub bd_table: *mut cbd_t __iomem,
    pub bd_dma_addr: dma_addr_t,
    pub bd_size: usize,
    pub int_table: *mut u16 __iomem,
    pub int_curr: *mut u16 __iomem,
    pub int_dma_addr: dma_addr_t,
    pub int_size: usize,
    pub is_tsa_64rxtx: bool,
    pub chan_head: list_head,
    pub chans: [*mut qmc_chan; 64],
}

#[no_mangle]
unsafe extern "C" fn qmc_write8(addr: *mut void __iomem, val: u8) {
    static void qmc_write8(void __iomem *addr, u8 val)
    {
    iowrite8(val, addr);
    }
#[no_mangle]
unsafe extern "C" fn qmc_write16(addr: *mut void __iomem, val: u16) {
    static void qmc_write16(void __iomem *addr, u16 val)
    {
    iowrite16be(val, addr);
    }
#[no_mangle]
unsafe extern "C" fn qmc_read16(addr: *mut void __iomem) -> u16 {
    static u16 qmc_read16(void __iomem *addr)
    {
    return ioread16be(addr);
    }
#[no_mangle]
unsafe extern "C" fn qmc_setbits16(addr: *mut void __iomem, set: u16) {
    static void qmc_setbits16(void __iomem *addr, u16 set)
    {
    qmc_write16(addr, qmc_read16(addr) | set);
    }
#[no_mangle]
unsafe extern "C" fn qmc_clrbits16(addr: *mut void __iomem, clr: u16) {
    static void qmc_clrbits16(void __iomem *addr, u16 clr)
    {
    qmc_write16(addr, qmc_read16(addr) & ~clr);
    }
#[no_mangle]
unsafe extern "C" fn qmc_clrsetbits16(addr: *mut void __iomem, clr: u16, set: u16) {
    static void qmc_clrsetbits16(void __iomem *addr, u16 clr, u16 set)
    {
    qmc_write16(addr, (qmc_read16(addr) & ~clr) | set);
    }
#[no_mangle]
unsafe extern "C" fn qmc_write32(addr: *mut void __iomem, val: u32) {
    static void qmc_write32(void __iomem *addr, u32 val)
    {
    iowrite32be(val, addr);
    }
#[no_mangle]
unsafe extern "C" fn qmc_read32(addr: *mut void __iomem) -> u32 {
    static u32 qmc_read32(void __iomem *addr)
    {
    return ioread32be(addr);
    }
#[no_mangle]
unsafe extern "C" fn qmc_setbits32(addr: *mut void __iomem, set: u32) {
    static void qmc_setbits32(void __iomem *addr, u32 set)
    {
    qmc_write32(addr, qmc_read32(addr) | set);
    }
#[no_mangle]
unsafe extern "C" fn qmc_is_qe(qmc: *const qmc) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn qmc_chan_get_info(chan: *mut qmc_chan, info: *mut qmc_chan_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qmc_chan_get_ts_info(chan: *mut qmc_chan, ts_info: *mut qmc_chan_ts_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qmc_chan_set_ts_info(chan: *mut qmc_chan, ts_info: *const qmc_chan_ts_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qmc_chan_set_param(chan: *mut qmc_chan, param: *const qmc_chan_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_chan_write_done(chan: *mut qmc_chan) {
...
//
    ...
    xfer_desc.tx_complete = core::ptr::null_mut();
    xfer_desc.context = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qmc_chan_read_done(chan: *mut qmc_chan) {
...
//
    ...
    context = xfer_desc.context;
    xfer_desc.rx_complete = core::ptr::null_mut();
    xfer_desc.context = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qmc_chan_setup_tsa_tx(chan: *mut qmc_chan, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_chan_setup_tsa_rx(chan: *mut qmc_chan, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_chan_cpm1_command(chan: *mut qmc_chan, qmc_opcode: u8) -> c_int {
    static int qmc_chan_cpm1_command(struct qmc_chan *chan, u8 qmc_opcode)
    {
    return cpm_command(chan.id << 2, (qmc_opcode << 4) | 0x0E);
    }
#[no_mangle]
unsafe extern "C" fn qmc_chan_qe_command(chan: *mut qmc_chan, cmd: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_chan_stop_rx(chan: *mut qmc_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_chan_stop_tx(chan: *mut qmc_chan) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qmc_chan_stop(chan: *mut qmc_chan, direction: c_int) -> c_int {
    int qmc_chan_stop(struct qmc_chan *chan, int direction)
    {
    let mut is_rx_rollback_needed: bool = false;
    unsigned long flags;
    let mut ret: c_int = 0;
    spin_lock_irqsave(&chan.ts_lock, flags);
...
#[no_mangle]
unsafe extern "C" fn qmc_setup_chan_trnsync(qmc: *mut qmc, chan: *mut qmc_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_chan_start_rx(chan: *mut qmc_chan) -> c_int {
    static int qmc_chan_start_rx(struct qmc_chan *chan)
    {
    unsigned long flags;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn qmc_chan_start_tx(chan: *mut qmc_chan) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qmc_chan_start(chan: *mut qmc_chan, direction: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_chan_reset_rx(chan: *mut qmc_chan) {
...
#[no_mangle]
unsafe extern "C" fn qmc_chan_reset_tx(chan: *mut qmc_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn qmc_chan_reset(chan: *mut qmc_chan, direction: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_check_chans(qmc: *mut qmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_nb_chans(qmc: *mut qmc) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn qmc_of_parse_chans(qmc: *mut qmc, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_init_tsa_64rxtx(qmc: *mut qmc, info: *const tsa_serial_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_init_tsa_32rx_32tx(qmc: *mut qmc, info: *const tsa_serial_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_init_tsa(qmc: *mut qmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_setup_chan(qmc: *mut qmc, chan: *mut qmc_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_setup_chans(qmc: *mut qmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_finalize_chans(qmc: *mut qmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_setup_ints(qmc: *mut qmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_irq_gint(qmc: *mut qmc) {
...
#[no_mangle]
unsafe extern "C" fn qmc_irq_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qmc_qe_soft_qmc_init(qmc: *mut qmc, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_cpm1_init_resources(qmc: *mut qmc, pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_qe_init_resources(qmc: *mut qmc, pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_init_resources(qmc: *mut qmc, pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_cpm1_init_scc(qmc: *mut qmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_qe_init_ucc(qmc: *mut qmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_init_xcc(qmc: *mut qmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_exit_xcc(qmc: *mut qmc) {
...
#[no_mangle]
unsafe extern "C" fn qmc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
pub unsafe extern "C" fn qmc_chan_count_phandles(np: *mut device_node, phandles_name: *const c_char) -> c_int {
    int qmc_chan_count_phandles(struct device_node *np, const char *phandles_name)
    {
    int count;
// phandles are fixed args phandles with one arg
    count = of_count_phandle_with_args(np, phandles_name, core::ptr::null_mut());
    if (count < 0)
    return count;
    return count / 2;
    }
...
#[no_mangle]
pub unsafe extern "C" fn qmc_chan_put(chan: *mut qmc_chan) {
...
#[no_mangle]
unsafe extern "C" fn devm_qmc_chan_release(dev: *mut device, res: *mut c_void) {
