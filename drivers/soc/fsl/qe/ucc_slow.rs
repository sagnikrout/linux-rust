...
//! Source: drivers/soc/fsl/qe/ucc_slow.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ucc_slow_get_qe_cr_subblock(uccs_num: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ucc_slow_graceful_stop_tx(uccs: *mut *mut ucc_slow_private) {
...
#[no_mangle]
pub unsafe extern "C" fn ucc_slow_stop_tx(uccs: *mut *mut ucc_slow_private) {
...
#[no_mangle]
pub unsafe extern "C" fn ucc_slow_restart_tx(uccs: *mut *mut ucc_slow_private) {
...
#[no_mangle]
pub unsafe extern "C" fn ucc_slow_enable(uccs: *mut *mut ucc_slow_private, mode: enum comm_dir) {
...
#[no_mangle]
pub unsafe extern "C" fn ucc_slow_disable(uccs: *mut *mut ucc_slow_private, mode: enum comm_dir) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ucc_slow_init(us_info: *mut *mut ucc_slow_info, uccs_ret: *mut *mut *mut ucc_slow_private) -> c_int {
...
// Set the PHY base address
    ...
    if (uccs.us_regs == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: us_info->init_tx) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ucc_slow_free(uccs: *mut *mut ucc_slow_private) {
