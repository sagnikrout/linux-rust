...
//! Source: drivers/soc/fsl/qe/ucc_fast.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ucc_fast_dump_regs(uccf: *mut *mut ucc_fast_private) {
...
#[no_mangle]
pub unsafe extern "C" fn ucc_fast_get_qe_cr_subblock(uccf_num: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ucc_fast_transmit_on_demand(uccf: *mut *mut ucc_fast_private) {
...
#[no_mangle]
pub unsafe extern "C" fn ucc_fast_enable(uccf: *mut *mut ucc_fast_private, mode: enum comm_dir) {
...
#[no_mangle]
pub unsafe extern "C" fn ucc_fast_disable(uccf: *mut *mut ucc_fast_private, mode: enum comm_dir) {
...
#[no_mangle]
pub unsafe extern "C" fn ucc_fast_init(uf_info: *mut *mut ucc_fast_info, uccf_ret: *mut *mut *mut ucc_fast_private) -> c_int {
...
// Set the PHY base address
    ...
    if (uccf.uf_regs == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn ucc_fast_free(uccf: *mut *mut ucc_fast_private) {
