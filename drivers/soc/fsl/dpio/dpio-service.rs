...
//! Source: drivers/soc/fsl/dpio/dpio-service.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct dpaa2_io {
    pub dpio_desc: dpaa2_io_desc,
    pub swp_desc: qbman_swp_desc,
    pub swp: *mut qbman_swp,
    pub node: list_head,
// protect against multiple management commands
    pub lock_mgmt_cmd: spinlock_t,
// protect notifications list
    pub lock_notifications: spinlock_t,
...
pub struct dpaa2_io_store {
    ...
    pub vaddr: *mut dpaa2_dq,
    pub /: *mut *mut *mut void alloced_addr; / unaligned value from kmalloc(),
    pub /: *mut *mut unsigned int idx; / position of the next-to-be-returned entry,
    pub /: *mut *mut *mut qbman_swp swp; / portal used to issue VDQCR,
    pub /: *mut *mut *mut device dev; / device used for DMA mapping,
}

// keep a per cpu array of DPIOs for fast access
    static struct dpaa2_io *dpio_by_cpu[NR_CPUS];
    let mut dpio_list: static struct list_head = LIST_HEAD_INIT(dpio_list);
...
//
    ...
    return service_select(core::ptr::null_mut());
    return service_select_by_cpu(core::ptr::null_mut(), cpu);
    }
    EXPORT_SYMBOL_GPL(dpaa2_io_service_select);
#[no_mangle]
unsafe extern "C" fn dpaa2_io_dim_work(w: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dpaa2_io_down(d: *mut dpaa2_io) {
    void dpaa2_io_down(struct dpaa2_io *d)
    {
    spin_lock(&dpio_list_lock);
    dpio_by_cpu[d.dpio_desc.cpu] = core::ptr::null_mut();
    list_del(&d.node);
    spin_unlock(&dpio_list_lock);
    kfree(d);
    }
pub const DPAA_POLL_MAX: c_int = 32;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn dpaa2_io_irq(obj: *mut dpaa2_io) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn dpaa2_io_get_cpu(d: *mut dpaa2_io) -> c_int {
...
//
    ...
    qbman_eq_desc_set_no_orp(&ed, 0);
    qbman_eq_desc_set_fq(&ed, fqid);
    return qbman_swp_enqueue_multiple(d.swp, &ed, fd, core::ptr::null_mut(), nb);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn dpaa2_io_store_destroy(s: *mut dpaa2_io_store) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dpaa2_io_query_bp_count(d: *mut dpaa2_io, bpid: u16, num: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dpaa2_io_set_irq_coalescing(d: *mut dpaa2_io, irq_holdoff: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dpaa2_io_get_irq_coalescing(d: *mut dpaa2_io, irq_holdoff: *mut u32) {
    void dpaa2_io_get_irq_coalescing(struct dpaa2_io *d, u32 *irq_holdoff)
    {
    struct qbman_swp *swp = d.swp;
    qbman_swp_get_irq_coalescing(swp, core::ptr::null_mut(), irq_holdoff);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn dpaa2_io_get_adaptive_coalescing(d: *mut dpaa2_io) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dpaa2_io_update_net_dim(d: *mut dpaa2_io, frames: __u64, bytes: __u64) {
