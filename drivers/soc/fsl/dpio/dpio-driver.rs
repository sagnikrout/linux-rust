...
//! Source: drivers/soc/fsl/dpio/dpio-driver.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dpaa2_dpio_get_cluster_sdest(dpio_dev: *mut fsl_mc_device, cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpio_irq_handler(irq_num: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn unregister_dpio_irq_handlers(dpio_dev: *mut fsl_mc_device) {
    static void unregister_dpio_irq_handlers(struct fsl_mc_device *dpio_dev)
    {
    struct fsl_mc_device_irq *irq;
    irq = dpio_dev.irqs[0];
// clear the affinity hint
    irq_set_affinity_hint(irq.virq, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn register_dpio_irq_handlers(dpio_dev: *mut fsl_mc_device, cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpaa2_dpio_probe(dpio_dev: *mut fsl_mc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpio_teardown_irqs(dpio_dev: *mut fsl_mc_device) {
...
#[no_mangle]
unsafe extern "C" fn dpaa2_dpio_remove(dpio_dev: *mut fsl_mc_device) {
    static void dpaa2_dpio_remove(struct fsl_mc_device *dpio_dev)
    {
    struct device *dev;
    struct dpio_priv *priv;
    let mut err: c_int = 0, cpu;
    dev = &dpio_dev.dev;
...
#[no_mangle]
unsafe extern "C" fn dpio_driver_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpio_driver_exit() {
