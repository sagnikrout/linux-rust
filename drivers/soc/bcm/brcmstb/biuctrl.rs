...
//! Source: drivers/soc/bcm/brcmstb/biuctrl.c
#![no_std]
...
pub const RACENPREF_MASK: c_uint = 0x3;
pub const RACPREFINST_SHIFT: c_int = 0;
pub const RACENINST_SHIFT: c_int = 2;
pub const RACPREFDATA_SHIFT: c_int = 4;
pub const RACENDATA_SHIFT: c_int = 6;
pub const RAC_CPU_SHIFT: c_int = 8;
pub const RACCFG_MASK: c_uint = 0xff;
pub const DPREF_LINE_2_SHIFT: c_int = 24;
pub const DPREF_LINE_2_MASK: c_uint = 0xff;
// Bitmask to enable instruction and data prefetching with a 256-bytes stride

    RACENPREF_MASK << RACENINST_SHIFT | \
    1 << RACPREFDATA_SHIFT | \
    RACENPREF_MASK << RACENDATA_SHIFT)
pub const CPU_CREDIT_REG_MCPx_WR_PAIRING_EN_MASK: c_uint = 0x70000000;
pub const CPU_CREDIT_REG_MCPx_READ_CRED_MASK: c_uint = 0xf;
pub const CPU_CREDIT_REG_MCPx_WRITE_CRED_MASK: c_uint = 0xf;

pub const CPU_MCP_FLOW_REG_MCPx_RDBUFF_CRED_MASK: c_uint = 0xff;
pub const CPU_WRITEBACK_CTRL_REG_WB_THROTTLE_THRESHOLD_MASK: c_uint = 0xf;
pub const CPU_WRITEBACK_CTRL_REG_WB_THROTTLE_TIMEOUT_MASK: c_uint = 0xf;
pub const CPU_WRITEBACK_CTRL_REG_WB_THROTTLE_TIMEOUT_SHIFT: c_int = 4;
...
#[no_mangle]
pub unsafe extern "C" fn cbc_readl(reg: c_int) -> u32 {
    static inline u32 cbc_readl(int reg)
    {
    let mut offset: c_int = cpubiuctrl_regs[reg];
    if (offset == -1 ||
...
#[no_mangle]
pub unsafe extern "C" fn cbc_writel(val: u32, reg: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mcp_write_pairing_set() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn a72_b53_rac_enable_all(np: *mut device_node) -> void __init {
    static void __init a72_b53_rac_enable_all(struct device_node *np)
    {
    unsigned int cpu;
    let mut enable: u32 = 0, pref_dist, shift;
...
#[no_mangle]
unsafe extern "C" fn mcp_a72_b53_set() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn setup_hifcpubiuctrl_regs(np: *mut device_node) -> int __init {
    ...
    cpu_dn = of_get_cpu_node(0, core::ptr::null_mut());
    if (!cpu_dn) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(cpu_dn, _arg: "brcm, _arg: brahma-b53")) -> else {
    else if (of_device_is_compatible(cpu_dn, "brcm,brahma-b53"))
    cpubiuctrl_regs = b53_cpubiuctrl_regs;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(cpu_dn, _arg: "arm, _arg: cortex-a72")) -> else {
    ...
    cpubiuctrl_base = core::ptr::null_mut();
    }
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn brcmstb_cpu_credit_reg_suspend(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_cpu_credit_reg_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_biuctrl_init() -> int __init {
...
//
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "brcm,brcmstb-cpu-biu-ctrl");
    if (!np)
    return 0;
