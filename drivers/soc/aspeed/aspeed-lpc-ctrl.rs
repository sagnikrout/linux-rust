...
//! Source: drivers/soc/aspeed/aspeed-lpc-ctrl.c
#![no_std]
...
pub const HICR7: c_uint = 0x88;
pub const HICR8: c_uint = 0x8c;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_lpc_ctrl {
...
#[no_mangle]
unsafe extern "C" fn aspeed_lpc_ctrl_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
    static int aspeed_lpc_ctrl_mmap(struct file *file, struct vm_area_struct *vma)
    {
    struct aspeed_lpc_ctrl *lpc_ctrl = file_aspeed_lpc_ctrl(file);
    let mut vsize: c_ulong = vma.vm_end - vma.vm_start;
    let mut prot: pgprot_t = vma.vm_page_prot;
...
#[no_mangle]
unsafe extern "C" fn aspeed_lpc_ctrl_probe(pdev: *mut platform_device) -> c_int {
...
// If memory-region is described in device tree then store
    ...
    lpc_ctrl.clk = devm_clk_get(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn aspeed_lpc_ctrl_remove(pdev: *mut platform_device) {
