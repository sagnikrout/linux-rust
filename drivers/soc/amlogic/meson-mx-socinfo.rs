...
//! Source: drivers/soc/amlogic/meson-mx-socinfo.c
#![no_std]
...
pub const MESON_SOCINFO_MAJOR_VER_MESON6: c_uint = 0x16;
pub const MESON_SOCINFO_MAJOR_VER_MESON8: c_uint = 0x19;
pub const MESON_SOCINFO_MAJOR_VER_MESON8B: c_uint = 0x1b;
pub const MESON_MX_ASSIST_HW_REV: c_uint = 0x14c;
pub const MESON_MX_ANALOG_TOP_METAL_REVISION: c_uint = 0x0;
pub const MESON_MX_BOOTROM_MISC_VER: c_uint = 0x4;
    ...
    minor_ver = 0xa;
#[no_mangle]
pub unsafe extern "C" fn if(0x11111113: metal_rev ==) -> else {
    else if (metal_rev == 0x11111113)
    minor_ver = 0xb;
#[no_mangle]
pub unsafe extern "C" fn if(0x11111133: metal_rev ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_socinfo_init() -> int __init {
    ...
    np = of_find_matching_node(core::ptr::null_mut(), meson_mx_socinfo_analog_top_ids);
    if (np) {
