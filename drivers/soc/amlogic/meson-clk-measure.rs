...
//! Source: drivers/soc/amlogic/meson-clk-measure.c
#![no_std]
...
pub const DIV_MIN: c_int = 32;
pub const DIV_STEP: c_int = 32;
pub const DIV_MAX: c_int = 640;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_msr_id {
    pub priv: *mut meson_msr,
    pub id: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct msr_reg_offset {
    pub duty_val: c_uint,
    pub freq_ctrl: c_uint,
    pub duty_ctrl: c_uint,
    pub freq_val: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_msr_data {
    pub msr_table: *mut meson_msr_id,
    pub msr_count: c_uint,
    pub reg: *const msr_reg_offset,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_msr {
    pub regmap: *mut regmap,
    pub data: meson_msr_data,
...
// Get the value in multiple of gate time counts
    ...
    {
    let mut duration: c_uint = DIV_MAX;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn clk_msr_show(s: *mut seq_file, data: *mut c_void) -> c_int {
    static int clk_msr_show(struct seq_file *s, void *data)
    {
    struct meson_msr_id *clk_msr_id = s.private;
    let mut precision: c_uint = 0;
    int val;
...
#[no_mangle]
unsafe extern "C" fn clk_msr_summary_show(s: *mut seq_file, data: *mut c_void) -> c_int {
    static int clk_msr_summary_show(struct seq_file *s, void *data)
    {
    struct meson_msr_id *msr_table = s.private;
    let mut msr_count: c_uint = msr_table.priv.data.msr_count;
    let mut precision: c_uint = 0;
    int val, i;
...
#[no_mangle]
unsafe extern "C" fn meson_msr_probe(pdev: *mut platform_device) -> c_int {
    ...
    root = debugfs_create_dir("meson-clk-msr", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn meson_msr_remove(pdev: *mut platform_device) {
