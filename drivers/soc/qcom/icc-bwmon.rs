...
//! Source: drivers/soc/qcom/icc-bwmon.c
#![no_std]
...
pub const HW_TIMER_HZ: c_int = 19200000;
pub const BWMON_V4_GLOBAL_IRQ_CLEAR: c_uint = 0x108;
pub const BWMON_V4_GLOBAL_IRQ_ENABLE: c_uint = 0x10c;
//
...
//
pub const BWMON_V4_845_OFFSET: c_uint = 0x100;

pub const BWMON_V4_IRQ_STATUS: c_uint = 0x100;
pub const BWMON_V4_IRQ_CLEAR: c_uint = 0x108;
pub const BWMON_V4_IRQ_ENABLE: c_uint = 0x10c;

pub const BWMON_V5_IRQ_STATUS: c_uint = 0x000;
pub const BWMON_V5_IRQ_CLEAR: c_uint = 0x008;
pub const BWMON_V5_IRQ_ENABLE: c_uint = 0x00c;
pub const BWMON_V4_ENABLE: c_uint = 0x2a0;
pub const BWMON_V5_ENABLE: c_uint = 0x010;

pub const BWMON_V4_CLEAR: c_uint = 0x2a4;
pub const BWMON_V5_CLEAR: c_uint = 0x014;

pub const BWMON_V4_SAMPLE_WINDOW: c_uint = 0x2a8;
pub const BWMON_V5_SAMPLE_WINDOW: c_uint = 0x020;
pub const BWMON_V4_THRESHOLD_HIGH: c_uint = 0x2ac;
pub const BWMON_V4_THRESHOLD_MED: c_uint = 0x2b0;
pub const BWMON_V4_THRESHOLD_LOW: c_uint = 0x2b4;
pub const BWMON_V5_THRESHOLD_HIGH: c_uint = 0x024;
pub const BWMON_V5_THRESHOLD_MED: c_uint = 0x028;
pub const BWMON_V5_THRESHOLD_LOW: c_uint = 0x02c;
pub const BWMON_V4_ZONE_ACTIONS: c_uint = 0x2b8;
pub const BWMON_V5_ZONE_ACTIONS: c_uint = 0x030;
//
...
//
pub const BWMON_V4_THRESHOLD_COUNT: c_uint = 0x2bc;
pub const BWMON_V5_THRESHOLD_COUNT: c_uint = 0x034;
pub const BWMON_THRESHOLD_COUNT_ZONE0_DEFAULT: c_uint = 0xff;
pub const BWMON_THRESHOLD_COUNT_ZONE2_DEFAULT: c_uint = 0xff;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct icc_bwmon_data {
    pub sample_ms: c_uint,
    pub /: *mut *mut unsigned int count_unit_kb; / kbytes,
    pub zone1_thres_count: u8,
    pub zone3_thres_count: u8,
    pub quirks: c_uint,
    pub regmap_cfg: *const regmap_config,
    pub regmap_fields: *const reg_field,
    pub global_regmap_cfg: *const regmap_config,
    pub global_regmap_fields: *const reg_field,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct icc_bwmon {
    pub dev: *mut device,
    pub data: *const icc_bwmon_data,
    pub irq: c_int,
    pub regs: [*mut regmap_field; F_NUM_FIELDS],
    pub global_regs: [*mut regmap_field; F_NUM_GLOBAL_FIELDS],
    pub max_bw_kbps: c_uint,
    pub min_bw_kbps: c_uint,
    pub target_kbps: c_uint,
    pub current_kbps: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn bwmon_clear_counters(bwmon: *mut icc_bwmon, clear_all: bool) {
    static void bwmon_clear_counters(struct icc_bwmon *bwmon, bool clear_all)
    {
    let mut val: c_uint = BWMON_CLEAR_CLEAR;
    if (clear_all)
...
#[no_mangle]
unsafe extern "C" fn bwmon_clear_irq(bwmon: *mut icc_bwmon) {
...
#[no_mangle]
unsafe extern "C" fn bwmon_disable(bwmon: *mut icc_bwmon) {
...
#[no_mangle]
unsafe extern "C" fn bwmon_enable(bwmon: *mut icc_bwmon, irq_enable: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn bwmon_start(bwmon: *mut icc_bwmon) {
    static void bwmon_start(struct icc_bwmon *bwmon)
    {
    const struct icc_bwmon_data *data = bwmon.data;
    let mut bw_low: u32 = 0;
    int window;
...
#[no_mangle]
unsafe extern "C" fn bwmon_intr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bwmon_intr_thread(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t bwmon_intr_thread(int irq, void *dev_id)
    {
    struct icc_bwmon *bwmon = dev_id;
    let mut irq_enable: c_uint = 0;
    ...
    irq_enable = BIT(1);
#[no_mangle]
pub unsafe extern "C" fn if(bwmon->min_bw_kbps: bwmon->target_kbps <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn bwmon_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bwmon_remove(pdev: *mut platform_device) {
