...
//! Source: drivers/soc/qcom/rpmh.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct batch_cache_req {
    pub list: list_head,
    pub count: c_int,
    pub rpm_msgs: [rpmh_request; ],
}
...
#[no_mangle]
pub unsafe extern "C" fn rpmh_tx_done(msg: *const tcs_request) {
    void rpmh_tx_done(const struct tcs_request *msg)
    {
    struct rpmh_request *rpm_msg = container_of(msg, struct rpmh_request,
    msg);
    struct completion *compl = rpm_msg.completion;
    let mut free: bool = rpm_msg.needs_free;
    if (!compl)
    goto exit;
// Signal the blocking thread we are done
    ...
    {
    struct cache_req *p, *req = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn rpmh_read(dev: *const device, cmd: *mut tcs_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cache_batch(ctrlr: *mut rpmh_ctrlr, req: *mut batch_cache_req) {
...
#[no_mangle]
unsafe extern "C" fn flush_batch(ctrlr: *mut rpmh_ctrlr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_req_valid(req: *mut cache_req) -> c_int {
    ...
    u32 addr, u32 data)
    {
    DEFINE_RPMH_MSG_ONSTACK(core::ptr::null_mut(), state, core::ptr::null_mut(), rpm_msg);
...
//
#[no_mangle]
pub unsafe extern "C" fn rpmh_flush(ctrlr: *mut rpmh_ctrlr) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpmh_invalidate(dev: *const device) {
