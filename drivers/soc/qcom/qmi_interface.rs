...
//! Source: drivers/soc/qcom/qmi_interface.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qmi_send_new_lookup(qmi: *mut qmi_handle, svc: *mut qmi_service) {
    static void qmi_send_new_lookup(struct qmi_handle *qmi, struct qmi_service *svc)
    {
    struct qrtr_ctrl_pkt pkt;
    struct sockaddr_qrtr sq;
    let mut msg: msghdr = { };
    let mut iv: kvec = { &pkt, sizeof(pkt) };
    int ret;
...
#[no_mangle]
unsafe extern "C" fn qmi_send_new_server(qmi: *mut qmi_handle, svc: *mut qmi_service) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qmi_txn_wait(txn: *mut qmi_txn, timeout: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qmi_txn_cancel(txn: *mut qmi_txn) {
...
//
#[no_mangle]
unsafe extern "C" fn qmi_handle_net_reset(qmi: *mut qmi_handle) {
    ...
    struct qmi_txn *txn = core::ptr::null_mut();
    int ret;
    if (len < sizeof(*hdr)) {
...
#[no_mangle]
unsafe extern "C" fn qmi_data_ready(sk: *mut sock) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qmi_handle_release(qmi: *mut qmi_handle) {
