...
//! Source: drivers/soc/qcom/smem_state.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qcom_smem_state_release(ref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qcom_smem_state_put(state: *mut qcom_smem_state) {
...
#[no_mangle]
unsafe extern "C" fn devm_qcom_smem_state_release(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qcom_smem_state_unregister(state: *mut qcom_smem_state) {
