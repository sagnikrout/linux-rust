...
//! Source: drivers/soc/qcom/socinfo.c
#![no_std]
...
pub const SMEM_IMAGE_VERSION_BLOCKS_COUNT: c_int = 32;
pub const SMEM_IMAGE_VERSION_SIZE: c_int = 4096;
pub const SMEM_IMAGE_VERSION_NAME_SIZE: c_int = 75;
pub const SMEM_IMAGE_VERSION_VARIANT_SIZE: c_int = 20;
pub const SMEM_IMAGE_VERSION_OEM_SIZE: c_int = 32;
//
// SMEM Image table indices
//
pub const SMEM_IMAGE_TABLE_BOOT_INDEX: c_int = 0;
pub const SMEM_IMAGE_TABLE_TZ_INDEX: c_int = 1;
pub const SMEM_IMAGE_TABLE_TZSECAPP_INDEX: c_int = 2;
pub const SMEM_IMAGE_TABLE_RPM_INDEX: c_int = 3;
pub const SMEM_IMAGE_TABLE_SDI_INDEX: c_int = 4;
pub const SMEM_IMAGE_TABLE_HYP_INDEX: c_int = 5;
pub const SMEM_IMAGE_TABLE_ADSP1_INDEX: c_int = 6;
pub const SMEM_IMAGE_TABLE_ADSP2_INDEX: c_int = 7;
pub const SMEM_IMAGE_TABLE_CDSP2_INDEX: c_int = 8;
pub const SMEM_IMAGE_TABLE_APPSBL_INDEX: c_int = 9;
pub const SMEM_IMAGE_TABLE_APPS_INDEX: c_int = 10;
pub const SMEM_IMAGE_TABLE_MPSS_INDEX: c_int = 11;
pub const SMEM_IMAGE_TABLE_ADSP_INDEX: c_int = 12;
pub const SMEM_IMAGE_TABLE_CNSS_INDEX: c_int = 13;
pub const SMEM_IMAGE_TABLE_VIDEO_INDEX: c_int = 14;
pub const SMEM_IMAGE_TABLE_DSPS_INDEX: c_int = 15;
pub const SMEM_IMAGE_TABLE_CDSP_INDEX: c_int = 16;
pub const SMEM_IMAGE_TABLE_NPU_INDEX: c_int = 17;
pub const SMEM_IMAGE_TABLE_WPSS_INDEX: c_int = 18;
pub const SMEM_IMAGE_TABLE_CDSP1_INDEX: c_int = 19;
pub const SMEM_IMAGE_TABLE_GPDSP_INDEX: c_int = 20;
pub const SMEM_IMAGE_TABLE_GPDSP1_INDEX: c_int = 21;
pub const SMEM_IMAGE_TABLE_SENSORPD_INDEX: c_int = 22;
pub const SMEM_IMAGE_TABLE_AUDIOPD_INDEX: c_int = 23;
pub const SMEM_IMAGE_TABLE_OEMPD_INDEX: c_int = 24;
pub const SMEM_IMAGE_TABLE_CHARGERPD_INDEX: c_int = 25;
pub const SMEM_IMAGE_TABLE_OISPD_INDEX: c_int = 26;
pub const SMEM_IMAGE_TABLE_SOCCP_INDEX: c_int = 27;
pub const SMEM_IMAGE_TABLE_TME_INDEX: c_int = 28;
pub const SMEM_IMAGE_TABLE_GEARVM_INDEX: c_int = 29;
pub const SMEM_IMAGE_TABLE_UEFI_INDEX: c_int = 30;
pub const SMEM_IMAGE_TABLE_CDSP3_INDEX: c_int = 31;
pub const SMEM_IMAGE_TABLE_AUDIOPD_ADSP1_INDEX: c_int = 32;
pub const SMEM_IMAGE_TABLE_AUDIOPD_ADSP2_INDEX: c_int = 33;
pub const SMEM_IMAGE_TABLE_DCP_INDEX: c_int = 34;
pub const SMEM_IMAGE_TABLE_OOBS_INDEX: c_int = 35;
pub const SMEM_IMAGE_TABLE_OOBNS_INDEX: c_int = 36;
pub const SMEM_IMAGE_TABLE_DEVCFG_INDEX: c_int = 37;
pub const SMEM_IMAGE_TABLE_BTPD_INDEX: c_int = 38;
pub const SMEM_IMAGE_TABLE_QECP_INDEX: c_int = 39;
pub const SMEM_IMAGE_VERSION_TABLE: c_int = 469;
pub const SMEM_IMAGE_VERSION_TABLE_2: c_int = 667;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct socinfo_params {
    pub raw_device_family: u32,
    pub hw_plat_subtype: u32,
    pub accessory_chip: u32,
    pub raw_device_num: u32,
    pub chip_family: u32,
    pub foundry_id: u32,
    pub plat_ver: u32,
    pub raw_ver: u32,
    ...
    pub ncluster_array_offset: u32,
    pub num_subset_parts: u32,
    pub nsubset_parts_array_offset: u32,
    pub nmodem_supported: u32,
    pub feature_code: u32,
    pub pcode: u32,
    pub oem_variant: u32,
    pub num_func_clusters: u32,
    pub boot_cluster: u32,
    pub boot_core: u32,
    pub raw_package_type: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct smem_image_version {
    pub name: [c_char; SMEM_IMAGE_VERSION_NAME_SIZE],
    pub variant: [c_char; SMEM_IMAGE_VERSION_VARIANT_SIZE],
    pub pad: c_char,
    pub oem: [c_char; SMEM_IMAGE_VERSION_OEM_SIZE],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_socinfo {
    pub soc_dev: *mut soc_device,
    pub attr: soc_device_attribute,

    pub dbg_root: *mut dentry,
    pub info: socinfo_params,
...
#[no_mangle]
unsafe extern "C" fn qcom_show_build_id(seq: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_show_pmic_model(seq: *mut seq_file, p: *mut c_void) -> c_int {
    static int qcom_show_pmic_model(struct seq_file *seq, void *p)
    {
    struct socinfo *socinfo = seq.private;
    let mut model: c_int = SOCINFO_MINOR(le32_to_cpu(socinfo.pmic_model));
    if (model < 0)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn qcom_show_pmic_model_array(seq: *mut seq_file, p: *mut c_void) -> c_int {
    static int qcom_show_pmic_model_array(struct seq_file *seq, void *p)
    {
    struct socinfo *socinfo = seq.private;
    let mut num_pmics: c_uint = le32_to_cpu(socinfo.num_pmics);
    let mut pmic_array_offset: c_uint = le32_to_cpu(socinfo.pmic_array_offset);
    int i;
    void *ptr = socinfo;
    ptr += pmic_array_offset;
// No need for bounds checking, it happened at socinfo_debugfs_init
    for (i = 0; i < num_pmics; i++) {
    let mut model: c_uint = SOCINFO_MINOR(get_unaligned_le32(ptr + 2 * i * sizeof(u32)));
    let mut die_rev: c_uint = get_unaligned_le32(ptr + (2 * i + 1) * sizeof(u32));
    if (model < ARRAY_SIZE(pmic_models) && pmic_models[model])
...
#[no_mangle]
unsafe extern "C" fn qcom_show_pmic_die_revision(seq: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_show_chip_id(seq: *mut seq_file, p: *mut c_void) -> c_int {
    ...
    qcom_socinfo.dbg_root = debugfs_create_dir("qcom_socinfo", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn socinfo_debugfs_exit(qcom_socinfo: *mut qcom_socinfo) {
...
#[no_mangle]
unsafe extern "C" fn qcom_socinfo_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_socinfo_remove(pdev: *mut platform_device) {
