...
//! Source: drivers/soc/qcom/smp2p.c
#![no_std]
...
//
pub const SMP2P_MAX_ENTRY: c_int = 16;
pub const SMP2P_MAX_ENTRY_NAME: c_int = 16;
pub const SMP2P_FEATURE_SSR_ACK: c_uint = 0x1;
pub const SMP2P_FLAGS_RESTART_DONE_BIT: c_int = 0;
pub const SMP2P_FLAGS_RESTART_ACK_BIT: c_int = 1;
pub const SMP2P_MAGIC: c_uint = 0x504d5324;

pub const MAX_VERSION: c_int = 2;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct smp2p_smem_item {
    pub magic: u32,
    pub version: u8,
    pub features:24: unsigned,
    pub local_pid: u16,
    pub remote_pid: u16,
    ...
    pub flags: u32,
    struct {
    pub name: [u8; SMP2P_MAX_ENTRY_NAME],
    pub value: u32,
    pub entries: [}; SMP2P_MAX_ENTRY],
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct smp2p_entry {
    pub node: list_head,
    pub smp2p: *mut qcom_smp2p,
    pub name: *const c_char,
    pub value: *mut u32,
    pub last_value: u32,
    pub domain: *mut irq_domain,
    pub 32): DECLARE_BITMAP(irq_enabled,,
    pub 32): DECLARE_BITMAP(irq_rising,,
    pub 32): DECLARE_BITMAP(irq_falling,,
    pub state: *mut qcom_smem_state,
    pub lock: spinlock_t,
}

pub const SMP2P_INBOUND: c_int = 0;
pub const SMP2P_OUTBOUND: c_int = 1;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_smp2p {
    pub dev: *mut device,
    pub in: *mut smp2p_smem_item,
    pub out: *mut smp2p_smem_item,
    pub 1]: unsigned smem_items[SMP2P_OUTBOUND +,
    pub valid_entries: unsigned,
    pub ssr_ack_enabled: bool,
    pub ssr_ack: bool,
    pub negotiation_done: bool,
    pub local_pid: unsigned,
    ...
    pub inbound: list_head,
    pub outbound: list_head,
}

// Macro flag: #define CREATE_TRACE_POINTS

#[no_mangle]
unsafe extern "C" fn qcom_smp2p_kick(smp2p: *mut qcom_smp2p) {
    static void qcom_smp2p_kick(struct qcom_smp2p *smp2p)
    {
// Make sure any updated data is written before the kick
    wmb();
    if (smp2p.mbox_chan) {
    mbox_send_message(smp2p.mbox_chan, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn qcom_smp2p_check_ssr(smp2p: *mut qcom_smp2p) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qcom_smp2p_do_ssr_ack(smp2p: *mut qcom_smp2p) {
...
#[no_mangle]
unsafe extern "C" fn qcom_smp2p_negotiate(smp2p: *mut qcom_smp2p) {
...
#[no_mangle]
unsafe extern "C" fn qcom_smp2p_in_version(smp2p: *mut qcom_smp2p) -> c_int {
    static int qcom_smp2p_in_version(struct qcom_smp2p *smp2p)
    {
    let mut smem_id: c_uint = smp2p.smem_items[SMP2P_INBOUND];
    let mut pid: c_uint = smp2p.remote_pid;
...
#[no_mangle]
unsafe extern "C" fn qcom_smp2p_start_in(smp2p: *mut qcom_smp2p) {
...
#[no_mangle]
unsafe extern "C" fn qcom_smp2p_notify_in(smp2p: *mut qcom_smp2p) {
...
//
#[no_mangle]
unsafe extern "C" fn qcom_smp2p_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn smp2p_mask_irq(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn smp2p_unmask_irq(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn smp2p_set_irq_type(irqd: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smp2p_irq_print_chip(irqd: *mut irq_data, p: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn smp2p_update_bits(data: *mut c_void, mask: u32, value: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_smp2p_alloc_outbound_item(smp2p: *mut qcom_smp2p) -> c_int {
    static int qcom_smp2p_alloc_outbound_item(struct qcom_smp2p *smp2p)
    {
    struct smp2p_smem_item *out;
    let mut smem_id: unsigned = smp2p.smem_items[SMP2P_OUTBOUND];
    let mut pid: unsigned = smp2p.remote_pid;
    u8 in_version;
    int ret;
    ...
    out = qcom_smem_get(pid, smem_id, core::ptr::null_mut());
    if (IS_ERR(out)) {
...
#[no_mangle]
unsafe extern "C" fn smp2p_parse_ipc(smp2p: *mut qcom_smp2p) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_smp2p_probe(pdev: *mut platform_device) -> c_int {
    ...
    smp2p.mbox_chan = core::ptr::null_mut();
...
// Kick the outgoing edge after allocating entries
    ...
    core::ptr::null_mut(), qcom_smp2p_intr,
    IRQF_ONESHOT,
    core::ptr::null_mut(), (void *)smp2p);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn qcom_smp2p_remove(pdev: *mut platform_device) {
