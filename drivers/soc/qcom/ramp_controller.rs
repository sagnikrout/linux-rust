...
//! Source: drivers/soc/qcom/ramp_controller.c
#![no_std]
...
pub const RC_REG_CFG_UPDATE: c_uint = 0x60;

pub const RC_DCVS_CFG_SID: c_int = 2;
pub const RC_LINK_SID: c_int = 3;
pub const RC_LMH_SID: c_int = 6;
pub const RC_DFS_SID: c_int = 14;
pub const RC_UPDATE_TIMEOUT_US: c_int = 500;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_ramp_controller_desc {
    pub cfg_dfs_sid: *const reg_sequence,
    pub cfg_link_sid: *const reg_sequence,
    pub cfg_lmh_sid: *const reg_sequence,
    pub cfg_ramp_en: *const reg_sequence,
    pub cfg_ramp_dis: *const reg_sequence,
    pub cmd_reg: u8,
    pub num_dfs_sids: u8,
    pub num_link_sids: u8,
    pub num_lmh_sids: u8,
    pub num_ramp_en: u8,
    pub num_ramp_dis: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_ramp_controller {
    pub regmap: *mut regmap,
    pub desc: *const qcom_ramp_controller_desc,
}
...
//
#[no_mangle]
unsafe extern "C" fn rc_wait_for_update(qrc: *mut qcom_ramp_controller) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rc_set_cfg_update(qrc: *mut qcom_ramp_controller, ce: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rc_ramp_ctrl_enable(qrc: *mut qcom_ramp_controller) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qcom_ramp_controller_start(qrc: *mut qcom_ramp_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ramp_controller_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ramp_controller_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn qcom_ramp_controller_init() -> int __init {
