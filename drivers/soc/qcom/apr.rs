...
pub const GPR_DYNAMIC_PORT_START: c_uint = 0x10000000;
pub const GPR_DYNAMIC_PORT_END: c_uint = 0x20000000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct packet_router {
    pub ch: *mut rpmsg_endpoint,
    pub dev: *mut device,
    pub svcs_lock: spinlock_t,
    pub rx_lock: spinlock_t,
    pub svcs_idr: idr,
    pub dest_domain_id: c_int,
    pub type: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apr_rx_buf {
    pub node: list_head,
    pub len: c_int,
    pub __counted_by(len): uint8_t buf[],
}
...
//
#[no_mangle]
pub unsafe extern "C" fn apr_send_pkt(adev: *mut apr_device, pkt: *mut apr_pkt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gpr_free_port(port: *mut gpr_port_t) {
...
#[no_mangle]
unsafe extern "C" fn pkt_router_send_svc_pkt(svc: *mut pkt_router_svc, pkt: *const gpr_pkt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gpr_send_pkt(gdev: *mut apr_device, pkt: *const gpr_pkt) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gpr_send_port_pkt(port: *mut gpr_port_t, pkt: *const gpr_pkt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apr_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn apr_do_rx_callback(apr: *mut packet_router, abuf: *mut apr_rx_buf) -> c_int {
    static int apr_do_rx_callback(struct packet_router *apr, struct apr_rx_buf *abuf)
    {
    uint16_t hdr_size, msg_type, ver, svc_id;
    struct pkt_router_svc *svc;
    struct apr_device *adev;
    struct apr_driver *adrv = core::ptr::null_mut();
    struct apr_resp_pkt resp;
    struct apr_hdr *hdr;
    unsigned long flags;
    void *buf = abuf.buf;
    let mut len: c_int = abuf.len;
    hdr = buf;
...
#[no_mangle]
unsafe extern "C" fn gpr_do_rx_callback(gpr: *mut packet_router, abuf: *mut apr_rx_buf) -> c_int {
    static int gpr_do_rx_callback(struct packet_router *gpr, struct apr_rx_buf *abuf)
    {
    uint16_t hdr_size, ver;
    struct pkt_router_svc *svc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn apr_rxwq(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn apr_device_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apr_device_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apr_device_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn apr_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
    ...
    struct apr_device *adev = core::ptr::null_mut();
    struct pkt_router_svc *svc;
    int ret;
    ...
    adev.dev.driver = core::ptr::null_mut();
    spin_lock(&apr.svcs_lock);
...
#[no_mangle]
unsafe extern "C" fn of_apr_add_pd_lookups(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_register_apr_devices(dev: *mut device, svc_path: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn apr_remove_device(dev: *mut device, svc_path: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apr_pd_status(state: c_int, svc_path: *mut c_char, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn apr_probe(rpdev: *mut rpmsg_device) -> c_int {
    ...
    if (ret)
    goto handle_release;
    of_register_apr_devices(dev, core::ptr::null_mut());
    return 0;
    handle_release:
...
#[no_mangle]
unsafe extern "C" fn apr_remove(rpdev: *mut rpmsg_device) {
    static void apr_remove(struct rpmsg_device *rpdev)
    {
    struct packet_router *apr = dev_get_drvdata(&rpdev.dev);
    pdr_handle_release(apr.pdr);
    device_for_each_child(&rpdev.dev, core::ptr::null_mut(), apr_remove_device);
    destroy_workqueue(apr.rxwq);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn __apr_driver_register(drv: *mut apr_driver, owner: *mut module) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn apr_driver_unregister(drv: *mut apr_driver) {
...
#[no_mangle]
unsafe extern "C" fn apr_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn apr_exit() -> void __exit {
