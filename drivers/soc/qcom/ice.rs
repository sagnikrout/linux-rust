...
// QCOM ICE registers
pub const QCOM_ICE_REG_CONTROL: c_uint = 0x0000;

pub const QCOM_ICE_REG_VERSION: c_uint = 0x0008;
pub const QCOM_ICE_REG_FUSE_SETTING: c_uint = 0x0010;

pub const QCOM_ICE_REG_BIST_STATUS: c_uint = 0x0070;

pub const QCOM_ICE_REG_ADVANCED_CONTROL: c_uint = 0x1000;
pub const QCOM_ICE_REG_CRYPTOCFG_BASE: c_uint = 0x4040;
pub const QCOM_ICE_REG_CRYPTOCFG_SIZE: c_uint = 0x80;
...
pub const HWKM_OFFSET: c_uint = 0x8000;
...
#[no_mangle]
unsafe extern "C" fn qcom_ice_check_supported(ice: *mut qcom_ice) -> bool {
    static bool qcom_ice_check_supported(struct qcom_ice *ice)
    {
    let mut regval: u32 = qcom_ice_readl(ice, QCOM_ICE_REG_VERSION);
    struct device *dev = ice.dev;
    let mut major: c_int = FIELD_GET(GENMASK(31, 24), regval);
    let mut minor: c_int = FIELD_GET(GENMASK(23, 16), regval);
    let mut step: c_int = FIELD_GET(GENMASK(15, 0), regval);
...
#[no_mangle]
unsafe extern "C" fn qcom_ice_low_power_mode_enable(ice: *mut qcom_ice) {
...
#[no_mangle]
unsafe extern "C" fn qcom_ice_optimization_enable(ice: *mut qcom_ice) {
...
//
#[no_mangle]
unsafe extern "C" fn qcom_ice_wait_bist_status(ice: *mut qcom_ice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ice_hwkm_init(ice: *mut qcom_ice) {
...
#[no_mangle]
pub unsafe extern "C" fn qcom_ice_enable(ice: *mut qcom_ice) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qcom_ice_resume(ice: *mut qcom_ice) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qcom_ice_suspend(ice: *mut qcom_ice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn translate_hwkm_slot(ice: *mut qcom_ice, slot: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn qcom_ice_evict_key(ice: *mut qcom_ice, slot: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qcom_ice_get_supported_key_type(ice: *mut qcom_ice) -> enum blk_crypto_key_type {
...
//
    ...
    if (!engine.core_clk)
    engine.core_clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn qcom_ice_put(ice: *const qcom_ice) {
...
#[no_mangle]
unsafe extern "C" fn devm_of_qcom_ice_put(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qcom_ice_probe(pdev: *mut platform_device) -> c_int {
    static int qcom_ice_probe(struct platform_device *pdev)
    {
    let mut phandle: c_ulong = pdev.dev.of_node.phandle;
    struct qcom_ice *engine;
    void __iomem *base;
    guard(mutex)(&ice_mutex);
...
// Store the error pointer for devm_of_qcom_ice_get()
    xa_store(&ice_handles, phandle, ( void *)base, GFP_KERNEL);
    return PTR_ERR(base);
    }
...
#[no_mangle]
unsafe extern "C" fn qcom_ice_remove(pdev: *mut platform_device) {
    static void qcom_ice_remove(struct platform_device *pdev)
    {
    let mut phandle: c_ulong = pdev.dev.of_node.phandle;
    guard(mutex)(&ice_mutex);
    xa_store(&ice_handles, phandle, core::ptr::null_mut(), GFP_KERNEL);
    }
