...
//! Source: drivers/soc/qcom/mdt_loader.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mdt_header_valid(fw: *const firmware) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mdt_phdr_loadable(phdr: *const elf32_phdr) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn qcom_mdt_get_size(fw: *const firmware) -> isize {
...
#[no_mangle]
unsafe extern "C" fn qcom_mdt_bins_are_split(fw: *const firmware) -> bool {
...
//
    ...
    {
    int ret;
    ret = __qcom_mdt_pas_init(dev, fw, fw_name, pas_id, mem_phys, core::ptr::null_mut());
    if (ret)
    return ret;
...
//
    ...
    if (!mem_region)
    return -ENOMEM;
    ret = qcom_mdt_load_no_init(ctx.dev, fw, firmware, ( void *)mem_region,
