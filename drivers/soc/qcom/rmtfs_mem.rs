...
//! Source: drivers/soc/qcom/rmtfs_mem.c
#![no_std]
...
pub const NUM_MAX_VMIDS: c_int = 2;
    static dev_t qcom_rmtfs_mem_major;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_rmtfs_mem {
    pub dev: device,
    pub cdev: cdev,
    pub base: *mut c_void,
    ...
    char *buf);
    static DEVICE_ATTR(phys_addr, 0444, qcom_rmtfs_mem_show, core::ptr::null_mut());
    static DEVICE_ATTR(size, 0444, qcom_rmtfs_mem_show, core::ptr::null_mut());
    static DEVICE_ATTR(client_id, 0444, qcom_rmtfs_mem_show, core::ptr::null_mut());
    static ssize_t qcom_rmtfs_mem_show(struct device *dev,
    struct device_attribute *attr,
    char *buf)
    {
...
#[no_mangle]
unsafe extern "C" fn qcom_rmtfs_mem_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_rmtfs_mem_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_rmtfs_mem_mmap(filep: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_rmtfs_mem_release_device(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn qcom_rmtfs_mem_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_rmtfs_mem_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn qcom_rmtfs_mem_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn qcom_rmtfs_mem_exit() -> void __exit {
