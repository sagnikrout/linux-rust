...
//! Source: drivers/soc/qcom/pdr_interface.c
#![no_std]
...
pub struct pdr_service {
    ...
    pub addr: sockaddr_qrtr,
    pub instance: c_uint,
    pub service: c_uint,
    pub service_data_valid: u8,
    pub service_data: u32,
    pub state: c_int,
    pub need_notifier_register: bool,
    pub need_notifier_remove: bool,
    pub need_locator_lookup: bool,
...
pub struct pdr_handle {
    pub locator_hdl: qmi_handle,
    pub notifier_hdl: qmi_handle,
    pub locator_addr: sockaddr_qrtr,
    pub lookups: list_head,
    pub indack_list: list_head,
...
// control access to the locator state
    pub lock: mutex,
    pub locator_init_complete: bool,
    pub locator_work: work_struct,
    pub notifier_work: work_struct,
    pub indack_work: work_struct,
    pub notifier_wq: *mut workqueue_struct,
    pub indack_wq: *mut workqueue_struct,
    pub priv): *mut *mut *mut void (status)(int state, char service_path, void,
    pub priv: *mut c_void,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pdr_list_node {
    pub curr_state: enum servreg_service_state,
    pub transaction_id: u16,
    pub pds: *mut pdr_service,
    pub node: list_head,
}
...
#[no_mangle]
unsafe extern "C" fn pdr_notifier_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pdr_indack_work(work: *mut work_struct) {
...
// Ack the indication after clients release the PD resources
    ...
    struct pdr_service *pds = core::ptr::null_mut(), *iter;
...
#[no_mangle]
unsafe extern "C" fn pdr_locate_service(pdr: *mut pdr_handle, pds: *mut pdr_service) -> c_int {
    static int pdr_locate_service(struct pdr_handle *pdr, struct pdr_service *pds)
    {
    struct servreg_get_domain_list_req req;
    struct servreg_location_entry *entry;
    let mut domains_read: c_int = 0;
    int ret, i;
...
#[no_mangle]
unsafe extern "C" fn pdr_locator_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pdr_restart_pd(pdr: *mut pdr_handle, pds: *mut pdr_service) -> c_int {
    int pdr_restart_pd(struct pdr_handle *pdr, struct pdr_service *pds)
    {
    struct servreg_restart_pd_resp resp;
    let mut req: servreg_restart_pd_req = { 0 };
...
//
    ...
    &pdr_locator_ops, core::ptr::null_mut());
    if (ret < 0)
    goto destroy_indack;
...
//
#[no_mangle]
pub unsafe extern "C" fn pdr_handle_release(pdr: *mut pdr_handle) {
