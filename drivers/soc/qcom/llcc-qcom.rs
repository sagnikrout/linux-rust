...
//! Source: drivers/soc/qcom/llcc-qcom.c
#![no_std]
...
pub const ACT_CTRL_OPCODE_SHIFT: c_int = 1;
pub const ATTR1_PROBE_TARGET_WAYS_SHIFT: c_int = 2;
pub const ATTR1_FIXED_SIZE_SHIFT: c_int = 3;
pub const ATTR1_PRIORITY_SHIFT: c_int = 4;
pub const ATTR1_MAX_CAP_SHIFT: c_int = 16;

pub const ATTR0_BONUS_WAYS_SHIFT: c_int = 16;

pub const LLCC_STATUS_READ_DELAY: c_int = 100;
pub const CACHE_LINE_SIZE_SHIFT: c_int = 6;

pub const LLCC_LB_CNT_SHIFT: c_int = 28;

pub const LLCC_TRP_SCID_DIS_CAP_ALLOC: c_uint = 0x21f00;
pub const LLCC_TRP_PCB_ACT: c_uint = 0x21f04;
pub const LLCC_TRP_ALGO_CFG1: c_uint = 0x21f0c;
pub const LLCC_TRP_ALGO_CFG2: c_uint = 0x21f10;
pub const LLCC_TRP_ALGO_CFG3: c_uint = 0x21f14;
pub const LLCC_TRP_ALGO_CFG4: c_uint = 0x21f18;
pub const LLCC_TRP_ALGO_CFG5: c_uint = 0x21f1c;
pub const LLCC_TRP_WRSC_EN: c_uint = 0x21f20;
pub const LLCC_TRP_ALGO_CFG6: c_uint = 0x21f24;
pub const LLCC_TRP_ALGO_CFG7: c_uint = 0x21f28;
pub const LLCC_TRP_WRSC_CACHEABLE_EN: c_uint = 0x21f2c;
pub const LLCC_TRP_ALGO_CFG8: c_uint = 0x21f30;
pub const LLCC_VERSION_2_0_0_0: c_uint = 0x02000000;
pub const LLCC_VERSION_2_1_0_0: c_uint = 0x02010000;
pub const LLCC_VERSION_4_1_0_0: c_uint = 0x04010000;

pub const SLC_SCT_DONE: c_uint = 0x00534354444f4e45 /* SCT programming OK */;
pub const SLC_SCT_FAIL: c_uint = 0x005343544641494c /* SCT programming failed */;
pub const SLC_SCT_NAME_LEN: c_int = 15;
...
pub struct llcc_slice_config {
    ...
    pub res_ways: u32,
    pub cache_mode: u32,
    pub probe_target_ways: u32,
    pub dis_cap_alloc: bool,
    pub retain_on_pc: bool,
    pub activate_on_init: bool,
    pub write_scid_en: bool,
    pub write_scid_cacheable_en: bool,
    pub stale_en: bool,
    pub stale_cap_en: bool,
    pub mru_uncap_en: bool,
    pub mru_rollover: bool,
    pub alloc_oneway_en: bool,
    pub ovcap_en: bool,
    pub ovcap_prio: bool,
    pub vict_prio: bool,
    pub parent_slice_id: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct slc_sct_status {
    pub program_status: __le64,
// Use the lower 8 bits
    pub version: __le64,
    pub error: slc_sct_error,
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct slc_sct_details {
    pub revision: u8,
    pub name: [c_char; SLC_SCT_NAME_LEN],
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct slc_tcm_mem_info {
    pub is_present: __le32,
    pub offset: __le32,
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct slc_sct_slice_desc {
    pub slice_id: __le16,
    pub usecase_id: __le16,
    pub slice_properties: __le32,
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct slc_sct_mem {
    pub sct_status: slc_sct_status,
    pub sct_details: slc_sct_details,
    pub tcm_mem_info: slc_tcm_mem_info,
    pub slice_descs_count: __le32,
    pub scid_max: __le32,
    pub __counted_by_le(slice_descs_count): slc_sct_slice_desc slice_descs[],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_llcc_config {
    pub sct_data: *const llcc_slice_config,
    pub reg_offset: *const u32,
    pub edac_reg_offset: *const llcc_edac_reg_offset,
    pub /: *mut *mut u32 max_cap_shift; / instead of ATTR1_MAX_CAP_SHIFT,
    pub num_banks: u32,
    pub size: c_int,
    pub skip_llcc_cfg: bool,
    pub no_edac: bool,
    pub irq_configured: bool,
    pub no_broadcast_register: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_sct_config {
    pub llcc_config: *const qcom_llcc_config,
    pub num_config: c_int,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn llcc_slice_putd(desc: *mut llcc_slice_desc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn llcc_slice_activate(desc: *mut llcc_slice_desc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn llcc_slice_deactivate(desc: *mut llcc_slice_desc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn llcc_get_slice_id(desc: *mut llcc_slice_desc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn llcc_get_slice_size(desc: *mut llcc_slice_desc) -> usize {
...
#[no_mangle]
unsafe extern "C" fn qcom_llcc_get_cfg_index(pdev: *mut platform_device, cfg_index: *mut u8, num_config: c_int) -> c_int {
...
// cfg_index = 0;
    ...
    let mut desc_count: u32 = le32_to_cpu(slc_mem.slice_descs_count);
    let mut scid_max: u32 = le32_to_cpu(slc_mem.scid_max);
    if (desc_count > scid_max) {
    dev_err(dev, "Descriptor count above max limit (%u > %u)\n",
    desc_count, scid_max);
    return -EINVAL;
    }
    let mut revision: u8 = slc_mem.sct_details.revision;
    ...
    let mut version: u8 = (u8)(le64_to_cpu(slc_mem.sct_status.version));
    let mut code: u64 = le64_to_cpu(slc_mem.sct_status.error.code);
    let mut param: u64 = le64_to_cpu(slc_mem.sct_status.error.param);
...
#[no_mangle]
unsafe extern "C" fn qcom_llcc_get_fw_config(pdev: *mut platform_device) -> c_int {
    static int qcom_llcc_get_fw_config(struct platform_device *pdev)
    {
    const struct slc_sct_mem *slc_mem = core::ptr::null_mut();
...
// Set refcount to 1 if FW already activated this descriptor
    ...
    drv_data.cfg = core::ptr::null_mut();
    drv_data.cfg_size = sz;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn qcom_llcc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn qcom_llcc_probe(pdev: *mut platform_device) -> c_int {
...
// Applicable only when drv_data->version >= 4.1
    ...
    if (ret == -EINVAL)
    drv_data.bcast_and_regmap = core::ptr::null_mut();
    else
    goto err;
    }
    }
