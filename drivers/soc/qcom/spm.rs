...
pub const SPM_CTL_INDEX: c_uint = 0x7f;
pub const SPM_CTL_INDEX_SHIFT: c_int = 4;
...
pub const MAX_PMIC_DATA: c_int = 2;
pub const MAX_SEQ_DATA: c_int = 64;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spm_reg_data {
    pub reg_offset: *const u16,
    pub spm_cfg: u32,
    pub spm_dly: u32,
    pub pmic_dly: u32,
    pub pmic_data: [u32; MAX_PMIC_DATA],
    pub avs_ctl: u32,
    pub avs_limit: u32,
    pub seq: [u8; MAX_SEQ_DATA],
    pub start_index: [u8; PM_SLEEP_MODE_NR],
    pub set_vdd: smp_call_func_t,
// for now we support only a single range
    pub range: *mut linear_range,
...
pub struct spm_driver_data {
    ...
    pub reg_data: *const spm_reg_data,
    pub dev: *mut device,
    pub volt_sel: c_uint,
    pub reg_cpu: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn spm_set_voltage_sel(rdev: *mut regulator_dev, selector: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spm_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smp_set_vdd_v1_1(data: *mut c_void) {
    static void smp_set_vdd_v1_1(void *data)
    {
...
// Kick the state machine back to idle
    ...
    if (avs_enabled) {
    let mut max_avs: c_uint = volt_sel;
    let mut min_avs: c_uint = max(max_avs, 4U) - 4;
...
#[no_mangle]
unsafe extern "C" fn spm_get_cpu(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spm_register_regulator(dev: *mut device, drv: *mut spm_driver_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spm_dev_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_spm_init() -> int __init {
