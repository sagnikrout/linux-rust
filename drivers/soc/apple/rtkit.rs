...
//! Source: drivers/soc/apple/rtkit.c
#![no_std]
...
pub const APPLE_RTKIT_CRASHLOG_CRASH: c_int = 1;
pub const APPLE_RTKIT_BUFFER_REQUEST: c_int = 1;

pub const APPLE_RTKIT_SYSLOG_LOG: c_int = 5;
pub const APPLE_RTKIT_SYSLOG_INIT: c_int = 8;

pub const APPLE_RTKIT_OSLOG_BUFFER_REQUEST: c_int = 1;

pub const APPLE_RTKIT_MIN_SUPPORTED_VERSION: c_int = 11;
pub const APPLE_RTKIT_MAX_SUPPORTED_VERSION: c_int = 12;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_rtkit_rx_work {
...
#[no_mangle]
pub unsafe extern "C" fn apple_rtkit_is_running(rtk: *mut apple_rtkit) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn apple_rtkit_is_crashed(rtk: *mut apple_rtkit) -> bool {
    ...
    ret = apple_rtkit_send_message(rtk, APPLE_RTKIT_EP_MGMT, msg, core::ptr::null_mut(), false);
    if (ret)
    dev_err(rtk.dev, "RTKit: Failed to send management message: %d\n", ret);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn apple_rtkit_management_rx_hello(rtk: *mut apple_rtkit, msg: u64) {
    static void apple_rtkit_management_rx_hello(struct apple_rtkit *rtk, u64 msg)
    {
    u64 reply;
    let mut min_ver: c_int = FIELD_GET(APPLE_RTKIT_MGMT_HELLO_MINVER, msg);
    let mut max_ver: c_int = FIELD_GET(APPLE_RTKIT_MGMT_HELLO_MAXVER, msg);
    let mut want_ver: c_int = min(APPLE_RTKIT_MAX_SUPPORTED_VERSION, max_ver);
...
#[no_mangle]
unsafe extern "C" fn apple_rtkit_management_rx_epmap(rtk: *mut apple_rtkit, msg: u64) {
    static void apple_rtkit_management_rx_epmap(struct apple_rtkit *rtk, u64 msg)
    {
    int i, ep;
    u64 reply;
    let mut bitmap: c_ulong = FIELD_GET(APPLE_RTKIT_MGMT_EPMAP_BITMAP, msg);
    let mut base: u32 = FIELD_GET(APPLE_RTKIT_MGMT_EPMAP_BASE, msg);
    dev_dbg(rtk.dev,
...
// without starting these RTKit refuses to boot
    ...
    u64 msg)
    {
    let mut new_state: c_uint = FIELD_GET(APPLE_RTKIT_MGMT_PWR_STATE, msg);
...
#[no_mangle]
unsafe extern "C" fn apple_rtkit_management_rx(rtk: *mut apple_rtkit, msg: u64) {
    static void apple_rtkit_management_rx(struct apple_rtkit *rtk, u64 msg)
    {
    let mut type: u8 = FIELD_GET(APPLE_RTKIT_MGMT_TYPE, msg);
    switch (type) {
...
// The different size vs. IOVA shifts look odd but are indeed correct this way
    ...
    buffer.buffer = core::ptr::null_mut();
    buffer.iomem = core::ptr::null_mut();
...
// oslog uses different fields and needs a shifted IOVA instead of size
    ...
    apple_rtkit_send_message(rtk, ep, reply, core::ptr::null_mut(), false);
    }
    return 0;
    error:
...
#[no_mangle]
unsafe extern "C" fn apple_rtkit_crashlog_rx(rtk: *mut apple_rtkit, msg: u64) {
    static void apple_rtkit_crashlog_rx(struct apple_rtkit *rtk, u64 msg)
    {
    let mut type: u8 = FIELD_GET(APPLE_RTKIT_SYSLOG_TYPE, msg);
    u8 *bfr;
...
#[no_mangle]
unsafe extern "C" fn apple_rtkit_ioreport_rx(rtk: *mut apple_rtkit, msg: u64) {
...
#[no_mangle]
unsafe extern "C" fn apple_rtkit_syslog_rx_init(rtk: *mut apple_rtkit, msg: u64) {
...
#[no_mangle]
unsafe extern "C" fn should_crop_syslog_char(c: c_char) -> bool {
    static bool should_crop_syslog_char(char c)
    {
    let mut c: return = = '\n' || c == '\r' || c == ' ' || c == '\0';
    }
#[no_mangle]
unsafe extern "C" fn apple_rtkit_syslog_rx_log(rtk: *mut apple_rtkit, msg: u64) {
    static void apple_rtkit_syslog_rx_log(struct apple_rtkit *rtk, u64 msg)
    {
    let mut idx: u8 = msg & 0xff;
    char log_context[24];
    let mut entry_size: usize = 0x20 + rtk.syslog_msg_size;
    int msglen;
    ...
    apple_rtkit_send_message(rtk, APPLE_RTKIT_EP_SYSLOG, msg, core::ptr::null_mut(), false);
    }
#[no_mangle]
unsafe extern "C" fn apple_rtkit_syslog_rx(rtk: *mut apple_rtkit, msg: u64) {
...
#[no_mangle]
unsafe extern "C" fn apple_rtkit_oslog_rx(rtk: *mut apple_rtkit, msg: u64) {
    static void apple_rtkit_oslog_rx(struct apple_rtkit *rtk, u64 msg)
    {
    let mut type: u8 = FIELD_GET(APPLE_RTKIT_OSLOG_TYPE, msg);
    switch (type) {
...
#[no_mangle]
unsafe extern "C" fn apple_rtkit_rx_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn apple_rtkit_poll(rtk: *mut apple_rtkit) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn apple_rtkit_start_ep(rtk: *mut apple_rtkit, endpoint: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_rtkit_wait_for_completion(c: *mut completion) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn apple_rtkit_reinit(rtk: *mut apple_rtkit) -> c_int {
...
// make sure we don't handle any messages while reinitializing
    ...
    rtk.syslog_msg_buffer = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn apple_rtkit_boot(rtk: *mut apple_rtkit) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn apple_rtkit_shutdown(rtk: *mut apple_rtkit) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn apple_rtkit_poweroff(rtk: *mut apple_rtkit) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn apple_rtkit_idle(rtk: *mut apple_rtkit) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn apple_rtkit_quiesce(rtk: *mut apple_rtkit) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn apple_rtkit_wake(rtk: *mut apple_rtkit) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn apple_rtkit_free(rtk: *mut apple_rtkit) {
...
#[no_mangle]
unsafe extern "C" fn apple_rtkit_free_wrapper(data: *mut c_void) {
