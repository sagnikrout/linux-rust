...
//! Source: drivers/soc/versatile/soc-integrator.c
#![no_std]
...
pub const INTEGRATOR_HDR_ID_OFFSET: c_uint = 0x00;
...
#[no_mangle]
unsafe extern "C" fn integrator_soc_init() -> int __init {
    ...
    u32 val;
    int ret;
    np = of_find_matching_node(core::ptr::null_mut(), integrator_cm_match);
    if (!np)
    return -ENODEV;
