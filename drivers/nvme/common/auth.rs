...
//! Source: drivers/nvme/common/auth.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn nvme_auth_get_seqnum() -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_auth_dhgroup_id(dhgroup_name: *const c_char) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_auth_hmac_id(hmac_name: *const c_char) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_auth_hmac_hash_len(hmac_id: u8) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_auth_key_struct_size(key_len: u32) -> u32 {
    ...
    u32 crc;
    int ret, key_len;
    let mut allocated_len: usize = strlen(secret);
...
//
    ...
    {
    let mut num_bytes: u32 = nvme_auth_key_struct_size(len);
...
#[no_mangle]
pub unsafe extern "C" fn nvme_auth_free_key(key: *mut nvme_dhchap_key) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_auth_hmac_final(hmac: *mut nvme_auth_hmac_ctx, out: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn nvme_auth_hash(hmac_id: u8, data: *const u8, data_len: usize, out: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_auth_gen_privkey(dh_tfm: *mut crypto_kpp, dh_gid: u8) -> c_int {
    int nvme_auth_gen_privkey(struct crypto_kpp *dh_tfm, u8 dh_gid)
    {
    int ret;
    ret = crypto_kpp_set_secret(dh_tfm, core::ptr::null_mut(), 0);
    if (ret)
...
#[no_mangle]
pub unsafe extern "C" fn nvme_auth_parse_key(secret: *const c_char, ret_key: *mut nvme_dhchap_key) -> c_int {
...
//
    ...
    {
    let mut psk_len: usize = nvme_auth_hmac_hash_len(hmac_id);
    struct nvme_auth_hmac_ctx hmac;
    u8 *psk;
    int ret;
    if (!c1 || !c2)
...
//
    ...
    let mut hash_len: usize = nvme_auth_hmac_hash_len(hmac_id);
    char *enc;
    size_t enc_len;
    int ret;
...
//
    ...
    u8 *hmac_data = core::ptr::null_mut(), *tls_key;
    size_t i;
    int ret;
