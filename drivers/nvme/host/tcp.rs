...
//! Source: drivers/nvme/host/tcp.c
#![no_std]
...
//
    let mut tls_handshake_timeout: static int = 10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvme_tcp_request {
    pub req: nvme_request,
    pub pdu: *mut c_void,
    pub queue: *mut nvme_tcp_queue,
    pub data_len: u32,
    pub pdu_len: u32,
    pub pdu_sent: u32,
    pub h2cdata_left: u32,
    pub h2cdata_offset: u32,
    pub ttag: u16,
    pub status: __le16,
    pub entry: list_head,
    pub lentry: llist_node,
    pub ddgst: __le32,
    pub curr_bio: *mut bio,
    pub iter: iov_iter,
    pub data_recvd: u32,
// send state
    pub offset: usize,
    pub data_sent: usize,
    pub state: enum nvme_tcp_send_state,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvme_tcp_queue {
    pub sock: *mut socket,
    pub io_work: work_struct,
    pub io_cpu: c_int,
    pub queue_lock: mutex,
    pub send_mutex: mutex,
    pub pf_cache_lock: mutex,
    pub req_list: llist_head,
    pub send_list: list_head,
// recv state
    pub pdu: *mut c_void,
    pub pdu_remaining: c_int,
    pub pdu_offset: c_int,
    pub data_remaining: usize,
    pub ddgst_remaining: usize,
    pub nr_cqe: c_uint,
// send state
    pub request: *mut nvme_tcp_request,
    pub maxh2cdata: u32,
    pub cmnd_capsule_len: usize,
    pub ctrl: *mut nvme_tcp_ctrl,
    pub flags: c_ulong,
    pub rd_enabled: bool,
    pub hdr_digest: bool,
    ...
    pub rcv_crc: u32,
    pub snd_crc: u32,
    pub exp_ddgst: __le32,
    pub recv_ddgst: __le32,
    pub tls_complete: completion,
    pub tls_err: c_int,
    pub pf_cache: page_frag_cache,
    pub ): *mut *mut void (state_change)(struct sock,
    pub ): *mut *mut void (data_ready)(struct sock,
    pub ): *mut *mut void (write_space)(struct sock,

    pub nvme_tcp_sk_key: lock_class_key,
    pub nvme_tcp_slock_key: lock_class_key,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvme_tcp_ctrl {
// read only in the hot path
    pub queues: *mut nvme_tcp_queue,
    pub tag_set: blk_mq_tag_set,
// other member variables
    struct list_head	list
    pub admin_tag_set: blk_mq_tag_set,
    pub addr: sockaddr_storage,
    pub src_addr: sockaddr_storage,
    pub ctrl: nvme_ctrl,
    pub err_work: work_struct,
    pub connect_work: delayed_work,
    pub async_req: nvme_tcp_request,
    pub io_queues: [u32; HCTX_MAX_TYPES],
}
...
//
#[no_mangle]
unsafe extern "C" fn nvme_tcp_reclassify_socket(queue: *mut nvme_tcp_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_queue_id(queue: *mut nvme_tcp_queue) -> c_int {
    static inline int nvme_tcp_queue_id(struct nvme_tcp_queue *queue)
    {
    return queue - queue.ctrl.queues;
    }
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_recv_pdu_supported(type: enum nvme_tcp_pdu_type) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_queue_tls(queue: *mut nvme_tcp_queue) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_tls_configured(ctrl: *mut nvme_ctrl) -> bool {
    ...
    {
    let mut queue_idx: u32 = nvme_tcp_queue_id(queue);
    if (queue_idx == 0)
    return queue.ctrl.admin_tag_set.tags[queue_idx];
    return queue.ctrl.tag_set.tags[queue_idx - 1];
    }
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_hdgst_len(queue: *mut nvme_tcp_queue) -> u8 {
    static inline u8 nvme_tcp_hdgst_len(struct nvme_tcp_queue *queue)
    {
    return queue.hdr_digest ? NVME_TCP_DIGEST_LENGTH : 0;
    }
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_ddgst_len(queue: *mut nvme_tcp_queue) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_inline_data_size(req: *mut nvme_tcp_request) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_async_req(req: *mut nvme_tcp_request) -> bool {
    static inline bool nvme_tcp_async_req(struct nvme_tcp_request *req)
    {
    let mut req: return = = &req.queue.ctrl.async_req;
    }
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_has_inline_data(req: *mut nvme_tcp_request) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_req_cur_offset(req: *mut nvme_tcp_request) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_req_cur_length(req: *mut nvme_tcp_request) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_pdu_data_left(req: *mut nvme_tcp_request) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_send_all(queue: *mut nvme_tcp_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_queue_has_pending(queue: *mut nvme_tcp_queue) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_queue_more(queue: *mut nvme_tcp_queue) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_process_req_list(queue: *mut nvme_tcp_queue) {
    ...
    let mut n: usize = min(len, (size_t)PAGE_SIZE - off);
...
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_ddgst_final(crc: u32) -> __le32 {
    static inline __le32 nvme_tcp_ddgst_final(u32 crc)
    {
    return cpu_to_le32(~crc);
    }
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_hdgst(pdu: *const c_void, len: usize) -> __le32 {
    static inline __le32 nvme_tcp_hdgst(const void *pdu, size_t len)
    {
    return cpu_to_le32(~crc32c(NVME_TCP_CRC_SEED, pdu, len));
    }
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_set_hdgst(pdu: *mut c_void, len: usize) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_check_ddgst(queue: *mut nvme_tcp_queue, pdu: *mut c_void) -> c_int {
    static int nvme_tcp_check_ddgst(struct nvme_tcp_queue *queue, void *pdu)
    {
    struct nvme_tcp_hdr *hdr = pdu;
    let mut digest_len: u8 = nvme_tcp_hdgst_len(queue);
    u32 len;
    ...
    let mut queue_idx: c_int = (set == &ctrl.tag_set) ? hctx_idx + 1 : 0;
    struct nvme_tcp_queue *queue = &ctrl.queues[queue_idx];
    let mut hdgst: u8 = nvme_tcp_hdgst_len(queue);
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_init_recv_ctx(queue: *mut nvme_tcp_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_error_recovery(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_setup_h2c_data_pdu(req: *mut nvme_tcp_request) {
    static void nvme_tcp_setup_h2c_data_pdu(struct nvme_tcp_request *req)
    {
    struct nvme_tcp_data_pdu *data = nvme_tcp_req_data_pdu(req);
    struct nvme_tcp_queue *queue = req.queue;
    struct request *rq = blk_mq_rq_from_pdu(req);
    let mut h2cdata_sent: u32 = req.pdu_len;
    let mut hdgst: u8 = nvme_tcp_hdgst_len(queue);
    let mut ddgst: u8 = nvme_tcp_ddgst_len(queue);
    ...
    struct nvme_tcp_request *req;
    struct request *rq;
    let mut r2t_length: u32 = le32_to_cpu(pdu.r2t_length);
    let mut r2t_offset: u32 = le32_to_cpu(pdu.r2t_offset);
    rq = nvme_find_rq(nvme_tcp_tagset(queue), pdu.command_id);
    if (!rq) {
    dev_err(queue.ctrl.ctrl.device,
    ...
    u16 fes;
    const char *msg;
    let mut plen: u32 = le32_to_cpu(pdu.hdr.plen);
    ...
    char *pdu = queue.pdu;
    let mut rcv_len: usize = min_t(size_t, *len, queue.pdu_remaining);
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_end_request(rq: *mut request, status: u16) {
    static inline void nvme_tcp_end_request(struct request *rq, u16 status)
    {
    let mut res: union nvme_result = {};
...
// offset += recv_len;
    ...
    let mut recv_len: usize = min_t(size_t, *len, queue.ddgst_remaining);
    let mut off: off_t = NVME_TCP_DIGEST_LENGTH - queue.ddgst_remaining;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_data_ready(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_write_space(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_state_change(sk: *mut sock) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_tcp_done_send_req(queue: *mut nvme_tcp_queue) {
    static inline void nvme_tcp_done_send_req(struct nvme_tcp_queue *queue)
    {
    queue.request = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn nvme_tcp_fail_request(req: *mut nvme_tcp_request) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_try_send_data(req: *mut nvme_tcp_request) -> c_int {
    static int nvme_tcp_try_send_data(struct nvme_tcp_request *req)
    {
    struct nvme_tcp_queue *queue = req.queue;
    let mut req_data_len: c_int = req.data_len;
    let mut h2cdata_left: u32 = req.h2cdata_left;
    while (true) {
    struct bio_vec bvec;
    struct msghdr msg = {
    ...
    let mut offset: usize = nvme_tcp_req_cur_offset(req);
    let mut len: usize = nvme_tcp_req_cur_length(req);
    let mut last: bool = nvme_tcp_pdu_last_send(req, len);
    let mut req_data_sent: c_int = req.data_sent;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_try_send_cmd_pdu(req: *mut nvme_tcp_request) -> c_int {
    static int nvme_tcp_try_send_cmd_pdu(struct nvme_tcp_request *req)
    {
    struct nvme_tcp_queue *queue = req.queue;
    struct nvme_tcp_cmd_pdu *pdu = nvme_tcp_req_cmd_pdu(req);
    struct bio_vec bvec;
    let mut msg: msghdr = { .msg_flags = MSG_DONTWAIT | MSG_SPLICE_PAGES, };
    let mut inline_data: bool = nvme_tcp_has_inline_data(req);
    let mut hdgst: u8 = nvme_tcp_hdgst_len(queue);
    let mut len: c_int = sizeof(*pdu) + hdgst - req.offset;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_try_send_data_pdu(req: *mut nvme_tcp_request) -> c_int {
    static int nvme_tcp_try_send_data_pdu(struct nvme_tcp_request *req)
    {
    struct nvme_tcp_queue *queue = req.queue;
    struct nvme_tcp_data_pdu *pdu = nvme_tcp_req_data_pdu(req);
    struct bio_vec bvec;
    let mut msg: msghdr = { .msg_flags = MSG_DONTWAIT | MSG_MORE, };
    let mut hdgst: u8 = nvme_tcp_hdgst_len(queue);
    let mut len: c_int = sizeof(*pdu) - req.offset + hdgst;
    int ret;
    if (queue.hdr_digest && !req.offset)
    nvme_tcp_set_hdgst(pdu, sizeof(*pdu));
    if (!req.h2cdata_left)
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_try_send_ddgst(req: *mut nvme_tcp_request) -> c_int {
    static int nvme_tcp_try_send_ddgst(struct nvme_tcp_request *req)
    {
    struct nvme_tcp_queue *queue = req.queue;
    let mut offset: usize = req.offset;
    let mut h2cdata_left: u32 = req.h2cdata_left;
    int ret;
    let mut msg: msghdr = { .msg_flags = MSG_DONTWAIT };
    struct kvec iov = {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_try_send(queue: *mut nvme_tcp_queue) -> c_int {
    static int nvme_tcp_try_send(struct nvme_tcp_queue *queue)
    {
    struct nvme_tcp_request *req;
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_try_recv(queue: *mut nvme_tcp_queue) -> c_int {
    ...
    release_sock(sk);
    let mut consumed: return = = -EAGAIN ? 0 : consumed;
    }
#[no_mangle]
unsafe extern "C" fn nvme_tcp_io_work(w: *mut work_struct) {
    static void nvme_tcp_io_work(struct work_struct *w)
    {
    struct nvme_tcp_queue *queue =
    container_of(w, struct nvme_tcp_queue, io_work);
    let mut deadline: c_ulong = jiffies + msecs_to_jiffies(1);
    do {
    ...
    pending = true;
#[no_mangle]
pub unsafe extern "C" fn if(0): unlikely(result <) -> else {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_free_async_req(ctrl: *mut nvme_tcp_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_alloc_async_req(ctrl: *mut nvme_tcp_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_free_queue(nctrl: *mut nvme_ctrl, qid: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_init_connection(queue: *mut nvme_tcp_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_admin_queue(queue: *mut nvme_tcp_queue) -> bool {
    static bool nvme_tcp_admin_queue(struct nvme_tcp_queue *queue)
    {
    return nvme_tcp_queue_id(queue) == 0;
    }
#[no_mangle]
unsafe extern "C" fn nvme_tcp_default_queue(queue: *mut nvme_tcp_queue) -> bool {
    static bool nvme_tcp_default_queue(struct nvme_tcp_queue *queue)
    {
    struct nvme_tcp_ctrl *ctrl = queue.ctrl;
    let mut qid: c_int = nvme_tcp_queue_id(queue);
    return !nvme_tcp_admin_queue(queue) &&
    qid < 1 + ctrl.io_queues[HCTX_TYPE_DEFAULT];
    }
#[no_mangle]
unsafe extern "C" fn nvme_tcp_read_queue(queue: *mut nvme_tcp_queue) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_poll_queue(queue: *mut nvme_tcp_queue) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn nvme_tcp_set_queue_io_cpu(queue: *mut nvme_tcp_queue) {
    static void nvme_tcp_set_queue_io_cpu(struct nvme_tcp_queue *queue)
    {
    struct nvme_tcp_ctrl *ctrl = queue.ctrl;
    struct blk_mq_tag_set *set = &ctrl.tag_set;
    let mut qid: c_int = nvme_tcp_queue_id(queue) - 1;
    unsigned int *mq_map = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: nvme_tcp_read_queue(queue)) -> else {
    else if (nvme_tcp_read_queue(queue))
    mq_map = set.map[HCTX_TYPE_READ].mq_map;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: nvme_tcp_poll_queue(queue)) -> else {
...
// Search for the least used cpu from the mq_map
    ...
    let mut num_queues: c_int = atomic_read(&nvme_tcp_cpu_queues[cpu]);
    if (mq_map[cpu] != qid)
    continue;
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_tls_done(data: *mut c_void, status: c_int, pskid: key_serial_t) {
    ...
    let mut tmo: c_ulong = tls_handshake_timeout * HZ;
    let mut keyring: key_serial_t = nvme_keyring_id();
    ...
    sock_file = sock_alloc_file(queue.sock, O_CLOEXEC, core::ptr::null_mut());
    if (IS_ERR(sock_file)) {
...
// Set 10 seconds timeout for icresp recvmsg
    ...
    let mut optval: sockptr_t = KERNEL_SOCKPTR(iface);
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_restore_sock_ops(queue: *mut nvme_tcp_queue) {
...
#[no_mangle]
unsafe extern "C" fn __nvme_tcp_stop_queue(queue: *mut nvme_tcp_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_stop_queue_nowait(nctrl: *mut nvme_ctrl, qid: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_wait_queue(nctrl: *mut nvme_ctrl, qid: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_stop_queue(nctrl: *mut nvme_ctrl, qid: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_setup_sock_ops(queue: *mut nvme_tcp_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_start_queue(nctrl: *mut nvme_ctrl, idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_free_admin_queue(ctrl: *mut nvme_ctrl) {
    static void nvme_tcp_free_admin_queue(struct nvme_ctrl *ctrl)
    {
    if (to_tcp_ctrl(ctrl).async_req.pdu) {
    cancel_work_sync(&ctrl.async_event_work);
    nvme_tcp_free_async_req(to_tcp_ctrl(ctrl));
    to_tcp_ctrl(ctrl).async_req.pdu = core::ptr::null_mut();
    }
    nvme_tcp_free_queue(ctrl, 0);
    }
#[no_mangle]
unsafe extern "C" fn nvme_tcp_free_io_queues(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_stop_io_queues(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_alloc_admin_queue(ctrl: *mut nvme_ctrl) -> c_int {
    static int nvme_tcp_alloc_admin_queue(struct nvme_ctrl *ctrl)
    {
    int ret;
    let mut pskid: key_serial_t = 0;
    if (nvme_tcp_tls_configured(ctrl)) {
    if (ctrl.opts.tls_key)
    pskid = key_serial(ctrl.opts.tls_key);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ctrl->opts->tls) -> else {
...
#[no_mangle]
unsafe extern "C" fn __nvme_tcp_alloc_io_queues(ctrl: *mut nvme_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_alloc_io_queues(ctrl: *mut nvme_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_configure_io_queues(ctrl: *mut nvme_ctrl, new: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_configure_admin_queue(ctrl: *mut nvme_ctrl, new: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nvme_tcp_key_revoke_needed(ctrl: *mut nvme_ctrl) -> bool {
    static bool nvme_tcp_key_revoke_needed(struct nvme_ctrl *ctrl)
    {
    return ctrl.opts.concat && ctrl.opts.tls_key && ctrl.tls_pskid;
    }
#[no_mangle]
unsafe extern "C" fn nvme_tcp_setup_ctrl(ctrl: *mut nvme_ctrl, new: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_reconnect_ctrl_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_error_recovery_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_teardown_ctrl(ctrl: *mut nvme_ctrl, shutdown: bool) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_delete_ctrl(ctrl: *mut nvme_ctrl) {
    static void nvme_tcp_delete_ctrl(struct nvme_ctrl *ctrl)
    {
    nvme_tcp_teardown_ctrl(ctrl, true);
    }
#[no_mangle]
unsafe extern "C" fn nvme_reset_ctrl_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_stop_ctrl(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_free_ctrl(nctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_set_sg_null(c: *mut nvme_command) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_submit_async_event(arg: *mut nvme_ctrl) {
    ...
    ctrl.async_req.curr_bio = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_complete_timed_out(rq: *mut request) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_timeout(rq: *mut request) -> enum blk_eh_timer_return {
    ...
    struct nvme_tcp_cmd_pdu *pdu = nvme_tcp_req_cmd_pdu(req);
    struct nvme_command *cmd = &pdu.cmd;
    let mut qid: c_int = nvme_tcp_queue_id(req.queue);
    dev_warn(ctrl.device,
...
//
    ...
    struct nvme_tcp_cmd_pdu *pdu = nvme_tcp_req_cmd_pdu(req);
    struct nvme_tcp_queue *queue = req.queue;
    let mut hdgst: u8 = nvme_tcp_hdgst_len(queue), ddgst = 0;
    blk_status_t ret;
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_commit_rqs(hctx: *mut blk_mq_hw_ctx) {
    ...
    struct nvme_tcp_request *req = blk_mq_rq_to_pdu(rq);
    let mut queue_ready: bool = test_bit(NVME_TCP_Q_LIVE, &queue.flags);
    blk_status_t ret;
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_map_queues(set: *mut blk_mq_tag_set) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_poll(hctx: *mut blk_mq_hw_ctx, iob: *mut io_comp_batch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_get_address(ctrl: *mut nvme_ctrl, buf: *mut c_char, size: c_int) -> c_int {
...
//
    ...
    ret = inet_pton_with_scope(&init_net, AF_UNSPEC,
    opts.host_traddr, core::ptr::null_mut(), &ctrl.src_addr);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_init_module() -> int __init {
    static int __init nvme_tcp_init_module(void)
    {
    let mut wq_flags: c_uint = WQ_MEM_RECLAIM | WQ_HIGHPRI | WQ_SYSFS;
    int cpu;
...
#[no_mangle]
unsafe extern "C" fn nvme_tcp_cleanup_module() -> void __exit {
