...
//! Source: drivers/nvme/host/pci.c
#![no_std]
...
pub const NVME_SMALL_POOL_SIZE: c_int = 256;
//
// Arbitrary upper bound.
//

pub const NVME_MAX_NR_DESCRIPTORS: c_int = 5;
//
...
pub struct quirk_entry {
    pub vendor_id: u16,
    pub dev_id: u16,
    pub enabled_quirks: u32,
    pub disabled_quirks: u32,
}

    static int use_threaded_interrupts;
    module_param(use_threaded_interrupts, int, 0444);
    let mut use_cmb_sqes: static bool = true;
    module_param(use_cmb_sqes, bool, 0444);
    MODULE_PARM_DESC(use_cmb_sqes, "use controller's memory buffer for I/O SQes");
    let mut max_host_mem_size_mb: static unsigned int = 128;
    module_param(max_host_mem_size_mb, uint, 0444);
    MODULE_PARM_DESC(max_host_mem_size_mb,
    "Maximum Host Memory Buffer (HMB) size per controller (in MiB)");
    let mut sgl_threshold: static unsigned int = SZ_32K;
    module_param(sgl_threshold, uint, 0644);
    MODULE_PARM_DESC(sgl_threshold,
    "Use SGLs when average request segment size is larger or equal to "
    "this size. Use 0 to disable SGLs.");
pub const NVME_PCI_MIN_QUEUE_SIZE: c_int = 2;
pub const NVME_PCI_MAX_QUEUE_SIZE: c_int = 4095;
    static int io_queue_depth_set(const char *val, const struct kernel_param *kp);
    static const struct kernel_param_ops io_queue_depth_ops = {
    .set = io_queue_depth_set,
    .get = param_get_uint,
    };
    let mut io_queue_depth: static unsigned int = 1024;
...
#[no_mangle]
unsafe extern "C" fn nvme_parse_quirk_names(quirk_str: *mut c_char, entry: *mut quirk_entry) -> c_int {
...
// Skip the '^' character
    ...
    for (i = 0; i < 32; i++) {
    let mut bit: c_uint = 1U << i;
    char *q_name = nvme_quirk_name(bit);
    let mut q_len: usize = strlen(q_name);
...
#[no_mangle]
unsafe extern "C" fn nvme_parse_quirk_entry(s: *mut c_char, entry: *mut quirk_entry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quirks_param_set(value: *const c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn io_queue_count_set(val: *const c_char, kp: *const kernel_param) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvme_descriptor_pools {
    pub large: *mut dma_pool,
    pub small: *mut dma_pool,
}
...
#[derive(Copy, Clone)]
pub struct nvme_dev {
    pub queues: *mut nvme_queue,
    pub tagset: blk_mq_tag_set,
    pub admin_tagset: blk_mq_tag_set,
    pub dbs: *mut u32 __iomem,
    pub dev: *mut device,
    pub online_queues: unsigned,
    pub max_qid: unsigned,
    pub io_queues: [unsigned; HCTX_MAX_TYPES],
    pub num_vecs: c_uint,
    pub q_depth: u32,
    pub io_sqes: c_int,
    pub db_stride: u32,
    pub bar: *mut void __iomem,
    pub bar_mapped_size: c_ulong,
    pub shutdown_lock: mutex,
    pub subsystem: bool,
    pub cmb_size: u64,
    pub cmb_use_sqes: bool,
    pub cmbsz: u32,
    pub cmbloc: u32,
    pub ctrl: nvme_ctrl,
    pub last_ps: u32,
    pub hmb: bool,
    pub hmb_sgt: *mut sg_table,
    pub dmavec_mempool: *mut mempool_t,
// shadow doorbell buffer support:
    pub dbbuf_dbs: *mut __le32,
    pub dbbuf_dbs_dma_addr: dma_addr_t,
    pub dbbuf_eis: *mut __le32,
    pub dbbuf_eis_dma_addr: dma_addr_t,
// host memory buffer support:
    pub host_mem_size: u64,
    pub nr_host_mem_descs: u32,
    pub host_mem_descs_size: u32,
    pub host_mem_descs_dma: dma_addr_t,
    pub host_mem_descs: *mut nvme_host_mem_buf_desc,
    pub host_mem_desc_bufs: *mut c_void,
    pub nr_allocated_queues: c_uint,
    pub nr_write_queues: c_uint,
    pub nr_poll_queues: c_uint,
    pub descriptor_pools: [nvme_descriptor_pools; ],
}

#[no_mangle]
unsafe extern "C" fn io_queue_depth_set(val: *const c_char, kp: *const kernel_param) -> c_int {
    static int io_queue_depth_set(const char *val, const struct kernel_param *kp)
    {
...
#[no_mangle]
pub unsafe extern "C" fn sq_idx(qid: c_uint, stride: u32) -> c_uint {
    static inline unsigned int sq_idx(unsigned int qid, u32 stride)
    {
    return qid * 2 * stride;
    }
#[no_mangle]
pub unsafe extern "C" fn cq_idx(qid: c_uint, stride: u32) -> c_uint {
...
// only used for poll queues:
    pub ____cacheline_aligned_in_smp: spinlock_t cq_poll_lock,
    pub cqes: *mut nvme_completion,
    pub sq_dma_addr: dma_addr_t,
    pub cq_dma_addr: dma_addr_t,
    pub q_db: *mut u32 __iomem,
    pub q_depth: u32,
    pub cq_vector: u16,
    pub cq_head: u16,
    u16 sq_tail
    ...
    pub sqes: u8,
    pub flags: c_ulong,
pub const NVMEQ_ENABLED: c_int = 0;
pub const NVMEQ_SQ_CMB: c_int = 1;
pub const NVMEQ_DELETE_ERROR: c_int = 2;
pub const NVMEQ_POLLED: c_int = 3;
    pub dbbuf_sq_db: *mut __le32,
    pub dbbuf_cq_db: *mut __le32,
    pub dbbuf_sq_ei: *mut __le32,
    pub dbbuf_cq_ei: *mut __le32,
    pub delete_done: completion,
}
...
#[derive(Copy, Clone)]
pub struct nvme_iod {
    pub req: nvme_request,
    pub cmd: nvme_command,
    pub flags: u8,
    pub nr_descriptors: u8,
    pub total_len: usize,
    pub dma_state: dma_iova_state,
    pub descriptors: [*mut c_void; NVME_MAX_NR_DESCRIPTORS],
    pub dma_vecs: *mut nvme_dma_vec,
    pub nr_dma_vecs: c_uint,
    pub meta_dma: dma_addr_t,
    pub meta_total_len: usize,
    pub meta_dma_state: dma_iova_state,
    pub meta_descriptor: *mut nvme_sgl_desc,
}

#[no_mangle]
pub unsafe extern "C" fn nvme_dbbuf_size(dev: *mut nvme_dev) -> c_uint {
    static inline unsigned int nvme_dbbuf_size(struct nvme_dev *dev)
    {
    return dev.nr_allocated_queues * 8 * dev.db_stride;
    }
#[no_mangle]
unsafe extern "C" fn nvme_dbbuf_dma_alloc(dev: *mut nvme_dev) {
    static void nvme_dbbuf_dma_alloc(struct nvme_dev *dev)
    {
    let mut mem_size: c_uint = nvme_dbbuf_size(dev);
...
//
    ...
    dev.dbbuf_dbs_dma_addr);
    dev.dbbuf_dbs = core::ptr::null_mut();
    fail:
    dev_warn(dev.dev, "unable to allocate dma for dbbuf\n");
    }
#[no_mangle]
unsafe extern "C" fn nvme_dbbuf_dma_free(dev: *mut nvme_dev) {
    ...
    dev.dbbuf_eis = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn nvme_dbbuf_free(nvmeq: *mut nvme_queue) {
    static void nvme_dbbuf_free(struct nvme_queue *nvmeq)
    {
    if (!nvmeq.qid)
    return;
    nvmeq.dbbuf_sq_db = core::ptr::null_mut();
    nvmeq.dbbuf_cq_db = core::ptr::null_mut();
    nvmeq.dbbuf_sq_ei = core::ptr::null_mut();
    nvmeq.dbbuf_cq_ei = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn nvme_dbbuf_set(dev: *mut nvme_dev) {
    ...
    if (nvme_submit_sync_cmd(dev.ctrl.admin_q, &c, core::ptr::null_mut(), 0)) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_dbbuf_need_event(event_idx: u16, new_idx: u16, old: u16) -> c_int {
...
//
    ...
    let mut small_align: usize = NVME_SMALL_POOL_SIZE;
    ...
    pools.large = core::ptr::null_mut();
    return ERR_PTR(-ENOMEM);
    }
    return pools;
    }
#[no_mangle]
unsafe extern "C" fn nvme_release_descriptor_pools(dev: *mut nvme_dev) {
...
#[no_mangle]
unsafe extern "C" fn queue_irq_offset(dev: *mut nvme_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_map_queues(set: *mut blk_mq_tag_set) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nvme_write_sq_db(nvmeq: *mut nvme_queue, write_sq: bool) {
    static inline void nvme_write_sq_db(struct nvme_queue *nvmeq, bool write_sq)
    __must_hold(&nvmeq.sq_lock)
    {
    if (!write_sq) {
    let mut next_tail: u16 = nvmeq.sq_tail + 1;
...
#[no_mangle]
unsafe extern "C" fn nvme_commit_rqs(hctx: *mut blk_mq_hw_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_pci_metadata_use_sgls(req: *mut request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_avg_seg_size(req: *mut request) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_pci_cmd_use_meta_sgl(cmd: *mut nvme_command) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_pci_cmd_use_sgl(cmd: *mut nvme_command) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_pci_first_desc_dma_addr(cmd: *mut nvme_command) -> dma_addr_t {
...
#[no_mangle]
unsafe extern "C" fn nvme_free_descriptors(req: *mut request) {
    static void nvme_free_descriptors(struct request *req)
    {
    struct nvme_queue *nvmeq = req.mq_hctx.driver_data;
    let mut last_prp: c_int = NVME_CTRL_PAGE_SIZE / sizeof(__le64) - 1;
    struct nvme_iod *iod = blk_mq_rq_to_pdu(req);
    let mut dma_addr: dma_addr_t = nvme_pci_first_desc_dma_addr(&iod.cmd);
    int i;
    ...
    let mut next_dma_addr: dma_addr_t = le64_to_cpu(prp_list[last_prp]);
...
#[no_mangle]
unsafe extern "C" fn nvme_free_prps(req: *mut request, attrs: c_uint) {
    ...
    let mut len: c_uint = le32_to_cpu(sge.length);
...
#[no_mangle]
unsafe extern "C" fn nvme_unmap_metadata(req: *mut request) {
    static void nvme_unmap_metadata(struct request *req)
    {
    struct nvme_queue *nvmeq = req.mq_hctx.driver_data;
    let mut map: enum pci_p2pdma_map_type = PCI_P2PDMA_MAP_NONE;
    let mut dir: enum dma_data_direction = rq_dma_dir(req);
    struct nvme_iod *iod = blk_mq_rq_to_pdu(req);
    struct device *dma_dev = nvmeq.dev.dev;
...
#[no_mangle]
pub unsafe extern "C" fn if(IOD_META_MMIO: iod->flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn nvme_unmap_data(req: *mut request) {
    ...
    map = PCI_P2PDMA_MAP_BUS_ADDR;
#[no_mangle]
pub unsafe extern "C" fn if(IOD_DATA_MMIO: iod->flags &) -> else {
    map = PCI_P2PDMA_MAP_THRU_HOST_BRIDGE;
    attrs |= DMA_ATTR_MMIO;
    }
    ...
    struct nvme_iod *iod = blk_mq_rq_to_pdu(req);
    struct nvme_queue *nvmeq = req.mq_hctx.driver_data;
    let mut length: c_uint = blk_rq_payload_bytes(req);
...
//
    ...
    struct nvme_iod *iod = blk_mq_rq_to_pdu(req);
    struct nvme_queue *nvmeq = req.mq_hctx.driver_data;
    let mut entries: c_uint = blk_rq_nr_phys_segments(req);
...
// set the transfer type as SGL
    ...
    struct nvme_iod *iod = blk_mq_rq_to_pdu(req);
    struct nvme_queue *nvmeq = req.mq_hctx.driver_data;
    let mut bv: bio_vec = req_bvec(req);
    let mut prp1_offset: c_uint = bv.bv_offset & (NVME_CTRL_PAGE_SIZE - 1);
    let mut prp_possible: bool = prp1_offset + bv.bv_len <= NVME_CTRL_PAGE_SIZE * 2;
    dma_addr_t dma_addr;
    ...
    let mut first_prp_len: c_uint = NVME_CTRL_PAGE_SIZE - prp1_offset;
...
#[no_mangle]
unsafe extern "C" fn nvme_map_data(req: *mut request) -> blk_status_t {
    static blk_status_t nvme_map_data(struct request *req)
    {
    struct nvme_iod *iod = blk_mq_rq_to_pdu(req);
    struct nvme_queue *nvmeq = req.mq_hctx.driver_data;
    struct nvme_dev *dev = nvmeq.dev;
    let mut use_sgl: enum nvme_use_sgl = nvme_pci_use_sgls(dev, req);
    struct blk_dma_iter iter;
    blk_status_t ret;
//
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_setup_meta_iter(req: *mut request) -> blk_status_t {
    static blk_status_t nvme_pci_setup_meta_iter(struct request *req)
    {
    struct nvme_queue *nvmeq = req.mq_hctx.driver_data;
    let mut entries: c_uint = req.nr_integrity_segments;
    struct nvme_iod *iod = blk_mq_rq_to_pdu(req);
    struct nvme_dev *dev = nvmeq.dev;
    struct nvme_sgl_desc *sg_list;
    struct blk_dma_iter iter;
...
//
    ...
    iod.meta_descriptor = core::ptr::null_mut();
    return BLK_STS_OK;
    }
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_setup_meta_mptr(req: *mut request) -> blk_status_t {
    static blk_status_t nvme_pci_setup_meta_mptr(struct request *req)
    {
    struct nvme_iod *iod = blk_mq_rq_to_pdu(req);
    struct nvme_queue *nvmeq = req.mq_hctx.driver_data;
    let mut bv: bio_vec = rq_integrity_vec(req);
    if (is_pci_p2pdma_page(bv.bv_page))
...
#[no_mangle]
unsafe extern "C" fn nvme_map_metadata(req: *mut request) -> blk_status_t {
...
#[no_mangle]
unsafe extern "C" fn nvme_prep_rq(req: *mut request) -> blk_status_t {
...
#[no_mangle]
unsafe extern "C" fn nvme_submit_cmds(nvmeq: *mut nvme_queue, rqlist: *mut rq_list) {
...
#[no_mangle]
unsafe extern "C" fn nvme_prep_rq_batch(nvmeq: *mut nvme_queue, req: *mut request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvme_queue_rqs(rqlist: *mut rq_list) {
    static void nvme_queue_rqs(struct rq_list *rqlist)
    {
    let mut submit_list: rq_list = { };
    let mut requeue_list: rq_list = { };
    struct nvme_queue *nvmeq = core::ptr::null_mut();
    struct request *req;
    while ((req = rq_list_pop(rqlist))) {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_unmap_rq(req: *mut request) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_complete_rq(req: *mut request) {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_complete_batch(iob: *mut io_comp_batch) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_cqe_pending(nvmeq: *mut nvme_queue) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_ring_cq_doorbell(nvmeq: *mut nvme_queue) {
    static inline void nvme_ring_cq_doorbell(struct nvme_queue *nvmeq)
    {
    let mut head: u16 = nvmeq.cq_head;
    ...
    let mut command_id: __u16 = READ_ONCE(cqe.command_id);
    struct request *req;
//
...
#[no_mangle]
pub unsafe extern "C" fn nvme_update_cq_head(nvmeq: *mut nvme_queue) {
    static inline void nvme_update_cq_head(struct nvme_queue *nvmeq)
    {
    let mut tmp: u32 = nvmeq.cq_head + 1;
...
#[no_mangle]
unsafe extern "C" fn nvme_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nvme_irq_check(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn nvme_poll_irqdisable(nvmeq: *mut nvme_queue) {
    ...
    nvme_poll_cq(nvmeq, core::ptr::null_mut());
    spin_unlock(&nvmeq.cq_poll_lock);
    enable_irq(irq);
    }
#[no_mangle]
unsafe extern "C" fn nvme_poll(hctx: *mut blk_mq_hw_ctx, iob: *mut io_comp_batch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_submit_async_event(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_subsystem_reset(ctrl: *mut nvme_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adapter_delete_queue(dev: *mut nvme_dev, opcode: u8, id: u16) -> c_int {
    static int adapter_delete_queue(struct nvme_dev *dev, u8 opcode, u16 id)
    {
    let mut c: nvme_command = { };
    c.delete_queue.opcode = opcode;
    c.delete_queue.qid = cpu_to_le16(id);
    return nvme_submit_sync_cmd(dev.ctrl.admin_q, &c, core::ptr::null_mut(), 0);
    }
    static int adapter_alloc_cq(struct nvme_dev *dev, u16 qid,
    struct nvme_queue *nvmeq, s16 vector)
    {
    let mut c: nvme_command = { };
    let mut flags: c_int = NVME_QUEUE_PHYS_CONTIG;
    if (!test_bit(NVMEQ_POLLED, &nvmeq.flags))
...
#[no_mangle]
unsafe extern "C" fn adapter_delete_cq(dev: *mut nvme_dev, cqid: u16) -> c_int {
    static int adapter_delete_cq(struct nvme_dev *dev, u16 cqid)
    {
    return adapter_delete_queue(dev, nvme_admin_delete_cq, cqid);
    }
#[no_mangle]
unsafe extern "C" fn adapter_delete_sq(dev: *mut nvme_dev, sqid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_should_reset(dev: *mut nvme_dev, csts: u32) -> bool {
    static bool nvme_should_reset(struct nvme_dev *dev, u32 csts)
    {
// If true, indicates loss of adapter communication, possibly by a
// NVMe Subsystem reset.
//
    let mut nssro: bool = dev.subsystem && (csts & NVME_CSTS_NSSRO);
...
#[no_mangle]
unsafe extern "C" fn nvme_warn_reset(dev: *mut nvme_dev, csts: u32) {
...
#[no_mangle]
unsafe extern "C" fn nvme_timeout(req: *mut request) -> enum blk_eh_timer_return {
    ...
    let mut csts: u32 = readl(dev.bar + NVME_REG_CSTS);
    u8 opcode;
//
...
//
    if (test_bit(NVMEQ_POLLED, &nvmeq.flags))
    nvme_poll(req.mq_hctx, core::ptr::null_mut());
    else
...
//
    ...
    abort_req.end_io_data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn nvme_free_queue(nvmeq: *mut nvme_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvme_free_queues(dev: *mut nvme_dev, lowest: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nvme_suspend_queue(dev: *mut nvme_dev, qid: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn nvme_suspend_io_queues(dev: *mut nvme_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn nvme_reap_pending_cqes(dev: *mut nvme_dev) {
    static void nvme_reap_pending_cqes(struct nvme_dev *dev)
    {
    int i;
    for (i = dev.ctrl.queue_count - 1; i > 0; i--) {
    spin_lock(&dev.queues[i].cq_poll_lock);
    nvme_poll_cq(&dev.queues[i], core::ptr::null_mut());
    ...
    int entry_size)
    {
    let mut q_depth: c_int = dev.q_depth;
    unsigned q_size_aligned = roundup(q_depth * entry_size,
    NVME_CTRL_PAGE_SIZE);
    if (q_size_aligned * nr_io_queues > dev.cmb_size) {
    let mut mem_per_q: u64 = div_u64(dev.cmb_size, nr_io_queues);
...
#[no_mangle]
unsafe extern "C" fn nvme_alloc_queue(dev: *mut nvme_dev, qid: c_int, depth: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn queue_request_irq(nvmeq: *mut nvme_queue) -> c_int {
    static int queue_request_irq(struct nvme_queue *nvmeq)
    {
    struct pci_dev *pdev = to_pci_dev(nvmeq.dev.dev);
    let mut nr: c_int = nvmeq.dev.ctrl.instance;
    if (use_threaded_interrupts) {
    return pci_request_irq(pdev, nvmeq.cq_vector, nvme_irq_check,
    nvme_irq, nvmeq, "nvme%dq%d", nr, nvmeq.qid);
    } else {
    return pci_request_irq(pdev, nvmeq.cq_vector, nvme_irq,
    core::ptr::null_mut(), nvmeq, "nvme%dq%d", nr, nvmeq.qid);
    }
    }
#[no_mangle]
unsafe extern "C" fn nvme_init_queue(nvmeq: *mut nvme_queue, qid: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn nvme_setup_io_queues_trylock(dev: *mut nvme_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_create_queue(nvmeq: *mut nvme_queue, qid: c_int, polled: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_dev_remove_admin(dev: *mut nvme_dev) {
...
#[no_mangle]
unsafe extern "C" fn db_bar_size(dev: *mut nvme_dev, nr_io_queues: unsigned) -> c_ulong {
    static unsigned long db_bar_size(struct nvme_dev *dev, unsigned nr_io_queues)
    {
    return NVME_REG_DBS + ((nr_io_queues + 1) * 8 * dev.db_stride);
    }
#[no_mangle]
unsafe extern "C" fn nvme_remap_bar(dev: *mut nvme_dev, size: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_configure_admin_queue(dev: *mut nvme_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_create_io_queues(dev: *mut nvme_dev) -> c_int {
    ...
    let mut polled: bool = i > rw_queues;
...
#[no_mangle]
unsafe extern "C" fn nvme_cmb_size_unit(dev: *mut nvme_dev) -> u64 {
    static u64 nvme_cmb_size_unit(struct nvme_dev *dev)
    {
    let mut szu: u8 = (dev.cmbsz >> NVME_CMBSZ_SZU_SHIFT) & NVME_CMBSZ_SZU_MASK;
    return 1ULL << (12 + 4 * szu);
    }
#[no_mangle]
unsafe extern "C" fn nvme_cmb_size(dev: *mut nvme_dev) -> u32 {
    static u32 nvme_cmb_size(struct nvme_dev *dev)
    {
    return (dev.cmbsz >> NVME_CMBSZ_SZ_SHIFT) & NVME_CMBSZ_SZ_MASK;
    }
#[no_mangle]
unsafe extern "C" fn nvme_map_cmb(dev: *mut nvme_dev) {
...
#[no_mangle]
unsafe extern "C" fn nvme_set_host_mem(dev: *mut nvme_dev, bits: u32) -> c_int {
    static int nvme_set_host_mem(struct nvme_dev *dev, u32 bits)
    {
    let mut host_mem_size: u32 = dev.host_mem_size >> NVME_CTRL_PAGE_SHIFT;
    let mut dma_addr: u64 = dev.host_mem_descs_dma;
    let mut c: nvme_command = { };
    int ret;
    ...
    ret = nvme_submit_sync_cmd(dev.ctrl.admin_q, &c, core::ptr::null_mut(), 0);
    if (ret) {
    dev_warn(dev.ctrl.device,
...
#[no_mangle]
unsafe extern "C" fn nvme_free_host_mem_multi(dev: *mut nvme_dev) {
    static void nvme_free_host_mem_multi(struct nvme_dev *dev)
    {
    int i;
    for (i = 0; i < dev.nr_host_mem_descs; i++) {
    struct nvme_host_mem_buf_desc *desc = &dev.host_mem_descs[i];
    let mut size: usize = le32_to_cpu(desc.size) * NVME_CTRL_PAGE_SIZE;
    dma_free_attrs(dev.dev, size, dev.host_mem_desc_bufs[i],
    le64_to_cpu(desc.addr),
    DMA_ATTR_NO_KERNEL_MAPPING | DMA_ATTR_NO_WARN);
    }
    kfree(dev.host_mem_desc_bufs);
    dev.host_mem_desc_bufs = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn nvme_free_host_mem(dev: *mut nvme_dev) {
    static void nvme_free_host_mem(struct nvme_dev *dev)
    {
    if (dev.hmb_sgt) {
    dma_free_noncontiguous(dev.dev, dev.host_mem_size,
    dev.hmb_sgt, DMA_BIDIRECTIONAL);
    dev.hmb_sgt = core::ptr::null_mut();
    } else {
    nvme_free_host_mem_multi(dev);
    }
    dma_free_coherent(dev.dev, dev.host_mem_descs_size,
    dev.host_mem_descs, dev.host_mem_descs_dma);
    dev.host_mem_descs = core::ptr::null_mut();
    dev.host_mem_descs_size = 0;
    dev.nr_host_mem_descs = 0;
    }
#[no_mangle]
unsafe extern "C" fn nvme_alloc_host_mem_single(dev: *mut nvme_dev, size: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_alloc_host_mem(dev: *mut nvme_dev, min: u64, preferred: u64) -> c_int {
    static int nvme_alloc_host_mem(struct nvme_dev *dev, u64 min, u64 preferred)
    {
    let mut dma_merge_boundary: c_ulong = dma_get_merge_boundary(dev.dev);
    let mut min_chunk: u64 = min_t(u64, preferred, PAGE_SIZE * MAX_ORDER_NR_PAGES);
    let mut hmminds: u64 = max_t(u32, dev.ctrl.hmminds * 4096, PAGE_SIZE * 2);
    u64 chunk_size;
//
...
#[no_mangle]
unsafe extern "C" fn nvme_setup_host_mem(dev: *mut nvme_dev) -> c_int {
    static int nvme_setup_host_mem(struct nvme_dev *dev)
    {
    let mut max: u64 = (u64)max_host_mem_size_mb * SZ_1M;
    let mut preferred: u64 = (u64)dev.ctrl.hmpre * 4096;
    let mut min: u64 = (u64)dev.ctrl.hmmin * 4096;
    let mut enable_bits: u32 = NVME_HOST_MEM_ENABLE;
    int ret;
    if (!dev.ctrl.hmpre)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn nvme_update_attrs(dev: *mut nvme_dev) {
    static void nvme_update_attrs(struct nvme_dev *dev)
    {
...
//
#[no_mangle]
unsafe extern "C" fn nvme_calc_irq_sets(affd: *mut irq_affinity, nrirqs: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn nvme_setup_irqs(dev: *mut nvme_dev, nr_io_queues: c_uint) -> c_int {
    ...
    let mut flags: c_uint = PCI_IRQ_ALL_TYPES | PCI_IRQ_AFFINITY;
//
...
#[no_mangle]
unsafe extern "C" fn nvme_max_io_queues(dev: *mut nvme_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nvme_setup_io_queues(dev: *mut nvme_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_delete_queue(nvmeq: *mut nvme_queue, opcode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __nvme_delete_io_queues(dev: *mut nvme_dev, opcode: u8) -> bool {
    static bool __nvme_delete_io_queues(struct nvme_dev *dev, u8 opcode)
    {
    let mut nr_queues: c_int = dev.online_queues - 1, sent = 0;
...
#[no_mangle]
unsafe extern "C" fn nvme_delete_io_queues(dev: *mut nvme_dev) {
    static void nvme_delete_io_queues(struct nvme_dev *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_nr_maps(dev: *mut nvme_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_update_nr_queues(dev: *mut nvme_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_enable(dev: *mut nvme_dev) -> c_int {
    static int nvme_pci_enable(struct nvme_dev *dev)
    {
    let mut result: c_int = -ENOMEM;
    struct pci_dev *pdev = to_pci_dev(dev.dev);
    let mut flags: c_uint = PCI_IRQ_ALL_TYPES;
...
#[no_mangle]
unsafe extern "C" fn nvme_dev_unmap(dev: *mut nvme_dev) {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_ctrl_is_dead(dev: *mut nvme_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvme_dev_disable(dev: *mut nvme_dev, shutdown: bool) {
    static void nvme_dev_disable(struct nvme_dev *dev, bool shutdown)
    {
    let mut state: enum nvme_ctrl_state = nvme_ctrl_state(&dev.ctrl);
    struct pci_dev *pdev = to_pci_dev(dev.dev);
    bool dead;
    mutex_lock(&dev.shutdown_lock);
...
#[no_mangle]
unsafe extern "C" fn nvme_disable_prepare_reset(dev: *mut nvme_dev, shutdown: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_alloc_iod_mempool(dev: *mut nvme_dev) -> c_int {
    static int nvme_pci_alloc_iod_mempool(struct nvme_dev *dev)
    {
    let mut alloc_size: usize = sizeof(struct nvme_dma_vec) * NVME_MAX_SEGS;
...
#[no_mangle]
unsafe extern "C" fn nvme_free_tagset(dev: *mut nvme_dev) {
    static void nvme_free_tagset(struct nvme_dev *dev)
    {
    if (dev.tagset.tags)
    nvme_remove_io_tag_set(&dev.ctrl);
    dev.ctrl.tagset = core::ptr::null_mut();
    }
// pairs with nvme_pci_alloc_dev
#[no_mangle]
unsafe extern "C" fn nvme_pci_free_ctrl(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_reset_work(work: *mut work_struct) {
    static void nvme_reset_work(struct work_struct *work)
    {
    struct nvme_dev *dev =
    container_of(work, struct nvme_dev, ctrl.reset_work);
    let mut was_suspend: bool = !!(dev.ctrl.ctrl_config & NVME_CC_SHN_NORMAL);
    int result;
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_reg_read32(ctrl: *mut nvme_ctrl, off: u32, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_reg_write32(ctrl: *mut nvme_ctrl, off: u32, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_reg_read64(ctrl: *mut nvme_ctrl, off: u32, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_get_address(ctrl: *mut nvme_ctrl, buf: *mut c_char, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_print_device_info(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_pci_supports_pci_p2pdma(ctrl: *mut nvme_ctrl) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvme_dev_map(dev: *mut nvme_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_vendor_combination_bug(pdev: *mut pci_dev) -> c_ulong {
...
//
    ...
    let mut node: c_int = dev_to_node(&pdev.dev);
    struct nvme_dev *dev;
...
#[no_mangle]
unsafe extern "C" fn nvme_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_reset_prepare(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn nvme_reset_done(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn nvme_shutdown(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn nvme_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn nvme_get_power_state(ctrl: *mut nvme_ctrl, ps: *mut u32) -> c_int {
    static int nvme_get_power_state(struct nvme_ctrl *ctrl, u32 *ps)
    {
    return nvme_get_features(ctrl, NVME_FEAT_POWER_MGMT, 0, core::ptr::null_mut(), 0, ps);
    }
#[no_mangle]
unsafe extern "C" fn nvme_set_power_state(ctrl: *mut nvme_ctrl, ps: u32) -> c_int {
    static int nvme_set_power_state(struct nvme_ctrl *ctrl, u32 ps)
    {
    return nvme_set_features(ctrl, NVME_FEAT_POWER_MGMT, ps, core::ptr::null_mut(), 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn nvme_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_suspend(dev: *mut device) -> c_int {
...
// discard the saved state
    pci_load_saved_state(pdev, core::ptr::null_mut());
//
...
#[no_mangle]
unsafe extern "C" fn nvme_simple_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_simple_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn nvme_error_resume(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn nvme_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nvme_exit() -> void __exit {
