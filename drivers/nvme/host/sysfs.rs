...
//! Source: drivers/nvme/host/sysfs.c
#![no_std]
...
//
    ...
    static DEVICE_ATTR(reset_controller, S_IWUSR, core::ptr::null_mut(), nvme_sysfs_reset);
    ...
    static DEVICE_ATTR(rescan_controller, S_IWUSR, core::ptr::null_mut(), nvme_sysfs_rescan);
    ...
    let mut serial_len: c_int = sizeof(subsys.serial);
    let mut model_len: c_int = sizeof(subsys.model);
...
#[no_mangle]
unsafe extern "C" fn ns_head_update_nuse(head: *mut nvme_ns_head) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns_update_nuse(ns: *mut nvme_ns) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn multipath_sysfs_group_visible(kobj: *mut kobject) -> bool {
    ...
    static DEVICE_ATTR(field, S_IRUGO, field##_show, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(delete_controller, S_IWUSR, core::ptr::null_mut(), nvme_sysfs_delete);
    ...
    static DEVICE_ATTR(transport, S_IRUGO, nvme_sysfs_show_transport, core::ptr::null_mut());
    static ssize_t nvme_sysfs_show_state(struct device *dev,
    struct device_attribute *attr,
    char *buf)
    {
    struct nvme_ctrl *ctrl = dev_get_drvdata(dev);
    let mut state: unsigned = (unsigned)nvme_ctrl_state(ctrl);
    ...
    static DEVICE_ATTR(state, S_IRUGO, nvme_sysfs_show_state, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(subsysnqn, S_IRUGO, nvme_sysfs_show_subsysnqn, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(hostnqn, S_IRUGO, nvme_sysfs_show_hostnqn, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(hostid, S_IRUGO, nvme_sysfs_show_hostid, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(address, S_IRUGO, nvme_sysfs_show_address, core::ptr::null_mut());
    ...
    struct nvme_ctrl *ctrl = dev_get_drvdata(dev);
    let mut quirks: c_ulong = ctrl.quirks;
    if (!quirks)
...
//
    ...
    __ATTR(_name, _mode, _show, core::ptr::null_mut())
