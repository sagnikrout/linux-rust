...
//! Source: drivers/nvme/host/core.c
#![no_std]
...
pub struct nvme_ns_info {
    ...
    let mut admin_timeout: c_uint = 60;
    module_param(admin_timeout, uint, 0644);
    MODULE_PARM_DESC(admin_timeout, "timeout in seconds for admin commands");
    EXPORT_SYMBOL_GPL(admin_timeout);
    let mut nvme_io_timeout: c_uint = 30;
    module_param_named(io_timeout, nvme_io_timeout, uint, 0644);
    MODULE_PARM_DESC(io_timeout, "timeout in seconds for I/O");
    EXPORT_SYMBOL_GPL(nvme_io_timeout);
    let mut shutdown_timeout: static unsigned char = 5;
    module_param(shutdown_timeout, byte, 0644);
    MODULE_PARM_DESC(shutdown_timeout, "timeout in seconds for controller shutdown");
    let mut nvme_max_retries: static u8 = 5;
    module_param_named(max_retries, nvme_max_retries, byte, 0644);
    MODULE_PARM_DESC(max_retries, "max number of retries a command may have");
    let mut default_ps_max_latency_us: static unsigned long = 100000;
...
// checksum.
//
    let mut disable_pi_offsets: static bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn nvme_queue_scan(ctrl: *mut nvme_ctrl) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nvme_try_sched_reset(ctrl: *mut nvme_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_failfast_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_start_failfast_work(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_stop_failfast_work(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_reset_ctrl(ctrl: *mut nvme_ctrl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_reset_ctrl_sync(ctrl: *mut nvme_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_do_delete_ctrl(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_delete_ctrl_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_delete_ctrl(ctrl: *mut nvme_ctrl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_delete_ctrl_sync(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_error_status(status: u16) -> blk_status_t {
...
#[no_mangle]
unsafe extern "C" fn nvme_retry_req(req: *mut request) {
...
#[no_mangle]
unsafe extern "C" fn nvme_log_error(req: *mut request) {
...
#[no_mangle]
unsafe extern "C" fn nvme_log_err_passthru(req: *mut request) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_decide_disposition(req: *mut request) -> enum nvme_disposition {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_end_req_zoned(req: *mut request) {
...
#[no_mangle]
pub unsafe extern "C" fn __nvme_end_req(req: *mut request) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_end_req(req: *mut request) {
    void nvme_end_req(struct request *req)
    {
    let mut status: blk_status_t = nvme_error_status(nvme_req(req).status);
    __nvme_end_req(req);
    blk_mq_end_request(req, status);
    }
#[no_mangle]
unsafe extern "C" fn __nvme_complete_rq(req: *mut request) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_complete_rq(req: *mut request) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_complete_batch_req(req: *mut request) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nvme_host_path_error(req: *mut request) -> blk_status_t {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_cancel_request(req: *mut request, data: *mut c_void) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_cancel_tagset(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_cancel_admin_tagset(ctrl: *mut nvme_ctrl) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nvme_wait_reset(ctrl: *mut nvme_ctrl) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvme_free_ns_head(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_get_ns_head(head: *mut nvme_ns_head) {
    void nvme_get_ns_head(struct nvme_ns_head *head)
    {
    kref_get(&head.ref);
    }
#[no_mangle]
pub unsafe extern "C" fn nvme_tryget_ns_head(head: *mut nvme_ns_head) -> bool {
    bool nvme_tryget_ns_head(struct nvme_ns_head *head)
    {
    return kref_get_unless_zero(&head.ref);
    }
#[no_mangle]
pub unsafe extern "C" fn nvme_put_ns_head(head: *mut nvme_ns_head) {
    void nvme_put_ns_head(struct nvme_ns_head *head)
    {
    kref_put(&head.ref, nvme_free_ns_head);
    }
#[no_mangle]
unsafe extern "C" fn nvme_free_ns(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_get_ns(ns: *mut nvme_ns) -> bool {
    bool nvme_get_ns(struct nvme_ns *ns)
    {
    return kref_get_unless_zero(&ns.kref);
    }
#[no_mangle]
pub unsafe extern "C" fn nvme_put_ns(ns: *mut nvme_ns) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_clear_nvme_request(req: *mut request) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_init_request(req: *mut request, cmd: *mut nvme_command) {
...
//
    ...
    struct request *rq)
    {
    let mut state: enum nvme_ctrl_state = nvme_ctrl_state(ctrl);
...
//
    ...
    struct nvme_command *cmnd)
    {
    let mut segments: c_ushort = blk_rq_nr_discard_segments(req), n = 0;
...
//
    let mut alloc_size: static size_t = sizeof(*range) * NVME_DSM_MAX_RANGES;
...
//
    ...
    let mut slba: u64 = nvme_sect_to_lba(ns.head, blk_rq_pos(req));
    let mut nlb: u32 = blk_rq_sectors(req) >> (ns.head.lba_shift - 9);
    ...
    let mut nlb: u32 = bio.bi_iter.bi_size >> ns.head.lba_shift;
    if (n < segments) {
...
#[no_mangle]
unsafe extern "C" fn nvme_set_app_tag(req: *mut request, cmnd: *mut nvme_command) {
...
//
#[no_mangle]
unsafe extern "C" fn nvme_valid_atomic_write(req: *mut request) -> bool {
    static bool nvme_valid_atomic_write(struct request *req)
    {
    struct request_queue *q = req.q;
    let mut boundary_bytes: u32 = queue_atomic_write_boundary_bytes(q);
    if (blk_rq_bytes(req) > queue_atomic_write_unit_max_bytes(q))
    return false;
    if (boundary_bytes) {
    let mut mask: u64 = boundary_bytes - 1, imask = ~mask;
    let mut start: u64 = blk_rq_pos(req) << SECTOR_SHIFT;
    let mut end: u64 = start + blk_rq_bytes(req) - 1;
// If greater then must be crossing a boundary
    ...
    let mut write_stream: u16 = req.bio.bi_write_stream;
...
#[no_mangle]
pub unsafe extern "C" fn nvme_cleanup_cmd(req: *mut request) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_setup_cmd(ns: *mut nvme_ns, req: *mut request) -> blk_status_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn nvme_execute_rq(rq: *mut request, at_head: bool) -> c_int {
...
// result = nvme_req(req)->result;
    ...
    {
    return __nvme_submit_sync_cmd(q, cmd, core::ptr::null_mut(), buffer, bufflen,
    NVME_QID_ANY, 0);
    }
    EXPORT_SYMBOL_GPL(nvme_submit_sync_cmd);
#[no_mangle]
pub unsafe extern "C" fn nvme_command_effects(ctrl: *mut nvme_ctrl, ns: *mut nvme_ns, opcode: u8) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_passthru_start(ctrl: *mut nvme_ctrl, ns: *mut nvme_ns, opcode: u8) -> u32 {
    u32 nvme_passthru_start(struct nvme_ctrl *ctrl, struct nvme_ns *ns, u8 opcode)
    {
    let mut effects: u32 = nvme_command_effects(ctrl, ns, opcode);
//
...
//
#[no_mangle]
unsafe extern "C" fn nvme_keep_alive_work_period(ctrl: *mut nvme_ctrl) -> c_ulong {
    static unsigned long nvme_keep_alive_work_period(struct nvme_ctrl *ctrl)
    {
    let mut delay: c_ulong = ctrl.kato * HZ / 2;
//
...
#[no_mangle]
unsafe extern "C" fn nvme_queue_keep_alive_work(ctrl: *mut nvme_ctrl) {
    static void nvme_queue_keep_alive_work(struct nvme_ctrl *ctrl)
    {
    let mut now: c_ulong = jiffies;
    let mut delay: c_ulong = nvme_keep_alive_work_period(ctrl);
    let mut ka_next_check_tm: c_ulong = ctrl.ka_last_check_time + delay;
    ...
    let mut rtt: c_ulong = jiffies - (rq.deadline - rq.timeout);
    let mut delay: c_ulong = nvme_keep_alive_work_period(ctrl);
    let mut state: enum nvme_ctrl_state = nvme_ctrl_state(ctrl);
//
...
#[no_mangle]
unsafe extern "C" fn nvme_keep_alive_work(work: *mut work_struct) {
    static void nvme_keep_alive_work(struct work_struct *work)
    {
    struct nvme_ctrl *ctrl = container_of(to_delayed_work(work),
    struct nvme_ctrl, ka_work);
    let mut comp_seen: bool = ctrl.comp_seen;
    struct request *rq;
    ctrl.ka_last_check_time = jiffies;
...
#[no_mangle]
unsafe extern "C" fn nvme_start_keep_alive(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_stop_keep_alive(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_id_cns_ok(ctrl: *mut nvme_ctrl, cns: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvme_identify_ctrl(dev: *mut nvme_ctrl, id: *mut nvme_id_ctrl) -> c_int {
    static int nvme_identify_ctrl(struct nvme_ctrl *dev, struct nvme_id_ctrl **id)
    {
    let mut c: nvme_command = { };
    int error;
...
// namespace not allocated or attached
    ...
    {
    let mut res: union nvme_result = { 0 };
    let mut c: nvme_command = { };
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn nvme_set_queue_count(ctrl: *mut nvme_ctrl, count: *mut c_int) -> c_int {
    int nvme_set_queue_count(struct nvme_ctrl *ctrl, int *count)
    {
    let mut q_count: u32 = (*count - 1) | ((*count - 1) << 16);
    u32 result;
    int status, nr_io_queues;
    status = nvme_set_features(ctrl, NVME_FEAT_NUM_QUEUES, q_count, core::ptr::null_mut(), 0,
    &result);
//
...
#[no_mangle]
unsafe extern "C" fn nvme_enable_aen(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_ns_open(ns: *mut nvme_ns) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_ns_release(ns: *mut nvme_ns) {
...
#[no_mangle]
unsafe extern "C" fn nvme_open(disk: *mut gendisk, mode: blk_mode_t) -> c_int {
    static int nvme_open(struct gendisk *disk, blk_mode_t mode)
    {
    return nvme_ns_open(disk.private_data);
    }
#[no_mangle]
unsafe extern "C" fn nvme_release(disk: *mut gendisk) {
    static void nvme_release(struct gendisk *disk)
    {
    nvme_ns_release(disk.private_data);
    }
#[no_mangle]
pub unsafe extern "C" fn nvme_getgeo(disk: *mut gendisk, geo: *mut hd_geometry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_ns_ids_equal(a: *mut nvme_ns_ids, b: *mut nvme_ns_ids) -> bool {
...
// nvmp = nvm;
    ...
    {
    let mut elbaf: u32 = le32_to_cpu(nvm.elbaf[nvme_lbaf_index(id.flbas)]);
    u8 guard_type;
...
#[no_mangle]
unsafe extern "C" fn nvme_max_drv_segments(ctrl: *mut nvme_ctrl) -> u32 {
    ...
    let mut bs: u32 = 1U << head.lba_shift;
    u32 atomic_bs, phys_bs, io_opt = 0;
    let mut npdg: u32 = 1, npda = 1;
...
#[no_mangle]
pub unsafe extern "C" fn if(NVME_CTRL_ONCS_DSM: ctrl->oncs &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x1: optperf &) -> else {
    else if (optperf & 0x1)
    npdg = from0based(id.npdg);
    if (optperf & 0x2 && nvm && nvm.npdal)
    npda = le32_to_cpu(nvm.npdal);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: optperf) -> else {
    else if (optperf)
...
#[no_mangle]
unsafe extern "C" fn nvme_ns_is_readonly(ns: *mut nvme_ns, info: *mut nvme_ns_info) -> bool {
    static bool nvme_ns_is_readonly(struct nvme_ns *ns, struct nvme_ns_info *info)
    {
    return info.is_readonly || test_bit(NVME_NS_FORCE_RO, &ns.flags);
    }
#[no_mangle]
pub unsafe extern "C" fn nvme_first_scan(disk: *mut gendisk) -> bool {
...
// Proceed without registering FDP streams
    ...
    for (i = 0; i < fdp_idx; i++) {
    let mut dsze: u16 = le16_to_cpu(desc.dsze);
...
#[no_mangle]
unsafe extern "C" fn nvme_query_fdp_info(ns: *mut nvme_ns, info: *mut nvme_ns_info) -> c_int {
    ...
    size_t size;
    int i, ret;
    ret = nvme_get_features(ctrl, NVME_FEAT_FDP, info.endgid, core::ptr::null_mut(), 0,
    &fdp);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn nvme_invalid_lba_sz(nsze: u64, shift: signed int, capacity: *mut sector_t) -> bool {
    ...
    {
    struct queue_limits lim;
    struct nvme_id_ns_nvm *nvm = core::ptr::null_mut();
    let mut zi: nvme_zone_info = {};
    struct nvme_id_ns *id;
    unsigned int memflags;
    sector_t capacity;
    unsigned lbaf;
...
#[no_mangle]
unsafe extern "C" fn nvme_update_ns_info(ns: *mut nvme_ns, info: *mut nvme_ns_info) -> c_int {
...
//
    ...
    return __nvme_submit_sync_cmd(ctrl.admin_q, &cmd, core::ptr::null_mut(), buffer, len,
    NVME_QID_ANY, NVME_SUBMIT_AT_HEAD);
    }
#[no_mangle]
unsafe extern "C" fn nvme_configure_opal(ctrl: *mut nvme_ctrl, was_suspended: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: was_suspended) -> else {
    else if (was_suspended)
    opal_unlock_from_suspend(ctrl.opal_dev);
    } else {
    free_opal_dev(ctrl.opal_dev);
    ctrl.opal_dev = core::ptr::null_mut();
    }
    }
...
unsafe extern "C" fn nvme_configure_opal(ctrl: *mut nvme_ctrl, was_suspended: bool) {
    ...
    {
    let mut timeout_jiffies: c_ulong = jiffies + timeout * HZ;
    u32 csts;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn nvme_disable_ctrl(ctrl: *mut nvme_ctrl, shutdown: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_enable_ctrl(ctrl: *mut nvme_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_configure_timestamp(ctrl: *mut nvme_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_configure_host_options(ctrl: *mut nvme_ctrl) -> c_int {
    static int nvme_configure_host_options(struct nvme_ctrl *ctrl)
    {
    struct nvme_feat_host_behavior *host;
    let mut acre: u8 = 0, lbafee = 0;
    int ret;
// Don't bother enabling the feature if retry delay is not reported
    ...
    host, sizeof(*host), core::ptr::null_mut());
    kfree(host);
    return ret;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn nvme_configure_apst(ctrl: *mut nvme_ctrl) -> c_int {
    static int nvme_configure_apst(struct nvme_ctrl *ctrl)
    {
    struct nvme_feat_auto_pst *table;
    let mut apste: unsigned = 0;
    let mut max_lat_us: u64 = 0;
    let mut target: __le64 = 0;
    let mut max_ps: c_int = -1;
    int state;
    int ret;
    let mut last_lt_index: unsigned = UINT_MAX;
//
...
//
    ...
    table, sizeof(*table), core::ptr::null_mut());
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn nvme_set_latency_tolerance(dev: *mut device, val: i32) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvme_core_quirk_entry {
//
...
#[no_mangle]
unsafe extern "C" fn string_matches(idstr: *const c_char, match: *const c_char, len: usize) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvme_release_subsystem(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn nvme_destroy_subsystem(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn nvme_put_subsystem(subsys: *mut nvme_subsystem) {
    static void nvme_put_subsystem(struct nvme_subsystem *subsys)
    {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_discovery_ctrl(ctrl: *mut nvme_ctrl) -> bool {
    static inline bool nvme_discovery_ctrl(struct nvme_ctrl *ctrl)
    {
    return ctrl.opts && ctrl.opts.discovery_nqn;
    }
#[no_mangle]
pub unsafe extern "C" fn nvme_admin_ctrl(ctrl: *mut nvme_ctrl) -> bool {
    static inline bool nvme_admin_ctrl(struct nvme_ctrl *ctrl)
    {
    return ctrl.cntrltype == NVME_CTRL_ADMIN;
    }
#[no_mangle]
pub unsafe extern "C" fn nvme_is_io_ctrl(ctrl: *mut nvme_ctrl) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvme_init_subsystem(ctrl: *mut nvme_ctrl, id: *mut nvme_id_ctrl) -> c_int {
...
// Versions prior to 1.4 don't necessarily report a valid type
    ...
    {
    let mut c: nvme_command = { };
    let mut dwlen: u32 = nvme_bytes_to_numd(size);
...
#[no_mangle]
pub unsafe extern "C" fn nvme_mps_to_sectors(ctrl: *mut nvme_ctrl, units: u32) -> u32 {
    static inline u32 nvme_mps_to_sectors(struct nvme_ctrl *ctrl, u32 units)
    {
    let mut page_shift: u32 = NVME_CAP_MPSMIN(ctrl.cap) + 12, val;
    if (check_shl_overflow(1U, units + page_shift - 9, &val))
    return UINT_MAX;
    return val;
    }
#[no_mangle]
unsafe extern "C" fn nvme_init_non_mdts_limits(ctrl: *mut nvme_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_init_known_nvm_effects(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_init_effects(ctrl: *mut nvme_ctrl, id: *mut nvme_id_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_check_ctrl_fabric_info(ctrl: *mut nvme_ctrl, id: *mut nvme_id_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_init_identify(ctrl: *mut nvme_ctrl) -> c_int {
...
//
    ...
    if (id.rtd3e) {
// us -> s
    let mut transition_time: u32 = le32_to_cpu(id.rtd3e) / USEC_PER_SEC;
...
#[no_mangle]
pub unsafe extern "C" fn if(prev_apst_enabled: !ctrl->apst_enabled &&) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn nvme_init_ctrl_finish(ctrl: *mut nvme_ctrl, was_suspended: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_dev_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_dev_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
    ...
    {
    let mut has_uuid: bool = !uuid_is_null(&ids.uuid);
    let mut has_nguid: bool = memchr_inv(ids.nguid, 0, sizeof(ids.nguid));
    let mut has_eui64: bool = memchr_inv(ids.eui64, 0, sizeof(ids.eui64));
    struct nvme_ns_head *h;
...
#[no_mangle]
unsafe extern "C" fn nvme_cdev_rel(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_cdev_del(cdev: *mut cdev, cdev_device: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn nvme_ns_chr_open(inode: *mut inode, file: *mut file) -> c_int {
    static int nvme_ns_chr_open(struct inode *inode, struct file *file)
    {
    return nvme_ns_open(container_of(inode.i_cdev, struct nvme_ns, cdev));
    }
#[no_mangle]
unsafe extern "C" fn nvme_ns_chr_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_add_ns_cdev(ns: *mut nvme_ns) {
    ...
    struct nvme_ctrl *ctrl = ns.ctrl;
    struct nvme_ns_head *head;
    let mut size: usize = sizeof(*head);
...
#[no_mangle]
unsafe extern "C" fn nvme_init_ns_head(ns: *mut nvme_ns, info: *mut nvme_ns_info) -> c_int {
    static int nvme_init_ns_head(struct nvme_ns *ns, struct nvme_ns_info *info)
    {
    struct nvme_ctrl *ctrl = ns.ctrl;
    struct nvme_ns_head *head = core::ptr::null_mut();
    int ret;
...
//
    ...
    {
    struct nvme_ns *ns, *ret = core::ptr::null_mut();
    int srcu_idx;
...
//
#[no_mangle]
unsafe extern "C" fn nvme_ns_add_to_ctrl_list(ns: *mut nvme_ns) {
...
#[no_mangle]
unsafe extern "C" fn nvme_alloc_ns(ctrl: *mut nvme_ctrl, info: *mut nvme_ns_info) {
    static void nvme_alloc_ns(struct nvme_ctrl *ctrl, struct nvme_ns_info *info)
    {
    let mut lim: queue_limits = { };
    struct nvme_ns *ns;
    struct gendisk *disk;
    let mut node: c_int = ctrl.numa_node;
    let mut last_path: bool = false;
...
#[no_mangle]
unsafe extern "C" fn nvme_ns_remove(ns: *mut nvme_ns) {
...
#[no_mangle]
unsafe extern "C" fn nvme_ns_remove_by_nsid(ctrl: *mut nvme_ctrl, nsid: u32) {
...
#[no_mangle]
unsafe extern "C" fn nvme_validate_ns(ns: *mut nvme_ns, info: *mut nvme_ns_info) {
    static void nvme_validate_ns(struct nvme_ns *ns, struct nvme_ns_info *info)
    {
    let mut ret: c_int = NVME_SC_INVALID_NS | NVME_STATUS_DNR;
...
#[no_mangle]
unsafe extern "C" fn nvme_scan_ns(ctrl: *mut nvme_ctrl, nsid: unsigned) {
    static void nvme_scan_ns(struct nvme_ctrl *ctrl, unsigned nsid)
    {
    let mut info: nvme_ns_info = { .nsid = nsid };
    struct nvme_ns *ns;
    let mut ret: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct async_scan_info {
    pub ctrl: *mut nvme_ctrl,
    pub next_nsid: core::sync::atomic::AtomicI32,
    pub ns_list: *mut __le32,
}

#[no_mangle]
unsafe extern "C" fn nvme_scan_ns_async(data: *mut c_void, cookie: async_cookie_t) {
...
#[no_mangle]
unsafe extern "C" fn nvme_remove_nsid_range(ctrl: *mut nvme_ctrl, start: u32, end: u32) {
...
#[no_mangle]
unsafe extern "C" fn nvme_scan_ns_list(ctrl: *mut nvme_ctrl) -> c_int {
    static int nvme_scan_ns_list(struct nvme_ctrl *ctrl)
    {
    let mut nr_entries: c_int = NVME_IDENTIFY_DATA_SIZE / sizeof(__le32);
    __le32 *ns_list;
    let mut prev: u32 = 0;
    ...
    let mut nsid: u32 = le32_to_cpu(ns_list[i]);
...
#[no_mangle]
unsafe extern "C" fn nvme_scan_ns_sequential(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_clear_changed_ns_log(ctrl: *mut nvme_ctrl) {
    static void nvme_clear_changed_ns_log(struct nvme_ctrl *ctrl)
    {
    let mut log_size: usize = NVME_MAX_CHANGED_NAMESPACES * sizeof(__le32);
    __le32 *log;
    int error;
...
#[no_mangle]
unsafe extern "C" fn nvme_scan_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ctrl->ana_log_buf) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn nvme_remove_namespaces(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_class_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
    static int nvme_class_uevent(const struct device *dev, struct kobj_uevent_env *env)
    {
...
#[no_mangle]
unsafe extern "C" fn nvme_change_uevent(ctrl: *mut nvme_ctrl, envdata: *mut c_char) {
    static void nvme_change_uevent(struct nvme_ctrl *ctrl, char *envdata)
    {
    char *envp[2] = { envdata, core::ptr::null_mut() };
    kobject_uevent_env(&ctrl.device.kobj, KOBJ_CHANGE, envp);
    }
#[no_mangle]
unsafe extern "C" fn nvme_aen_uevent(ctrl: *mut nvme_ctrl) {
    static void nvme_aen_uevent(struct nvme_ctrl *ctrl)
    {
    char *envp[2] = { core::ptr::null_mut(), core::ptr::null_mut() };
    let mut aen_result: u32 = ctrl.aen_result;
    ctrl.aen_result = 0;
    if (!aen_result)
    return;
...
#[no_mangle]
unsafe extern "C" fn nvme_async_event_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvme_ctrl_pp_status(ctrl: *mut nvme_ctrl) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvme_get_fw_slot_info(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_fw_act_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvme_aer_type(result: u32) -> u32 {
    static u32 nvme_aer_type(u32 result)
    {
    return result & 0x7;
    }
#[no_mangle]
unsafe extern "C" fn nvme_aer_subtype(result: u32) -> u32 {
    static u32 nvme_aer_subtype(u32 result)
    {
    return (result & 0xff00) >> 8;
    }
#[no_mangle]
unsafe extern "C" fn nvme_handle_aen_notice(ctrl: *mut nvme_ctrl, result: u32) -> bool {
    static bool nvme_handle_aen_notice(struct nvme_ctrl *ctrl, u32 result)
    {
    let mut aer_notice_type: u32 = nvme_aer_subtype(result);
...
#[no_mangle]
unsafe extern "C" fn nvme_handle_aer_persistent_error(ctrl: *mut nvme_ctrl) {
    ...
    {
    let mut result: u32 = le32_to_cpu(res.u32);
    let mut aer_type: u32 = nvme_aer_type(result);
    let mut aer_subtype: u32 = nvme_aer_subtype(result);
    let mut requeue: bool = true;
...
// Reserved for fabric connect and keep alive
    ...
    ctrl.admin_q = blk_mq_alloc_queue(set, core::ptr::null_mut(), core::ptr::null_mut());
    if (IS_ERR(ctrl.admin_q)) {
    ret = PTR_ERR(ctrl.admin_q);
    goto out_free_tagset;
    }
    if (ctrl.ops.flags & NVME_F_FABRICS) {
    ctrl.fabrics_q = blk_mq_alloc_queue(set, core::ptr::null_mut(), core::ptr::null_mut());
    ...
    ctrl.admin_q = core::ptr::null_mut();
    ctrl.fabrics_q = core::ptr::null_mut();
    return ret;
    }
    EXPORT_SYMBOL_GPL(nvme_alloc_admin_tag_set);
#[no_mangle]
pub unsafe extern "C" fn nvme_remove_admin_tag_set(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn if(NVME_F_FABRICS: ctrl->ops->flags &) -> else {
...
// Reserved for fabric connect
    ...
    ctrl.connect_q = blk_mq_alloc_queue(set, &lim, core::ptr::null_mut());
    ...
    out_free_tag_set:
    blk_mq_free_tag_set(set);
    ctrl.connect_q = core::ptr::null_mut();
    return ret;
    }
    EXPORT_SYMBOL_GPL(nvme_alloc_io_tag_set);
#[no_mangle]
pub unsafe extern "C" fn nvme_remove_io_tag_set(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_stop_ctrl(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_start_ctrl(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_uninit_ctrl(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_free_cels(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_free_ctrl(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nvme_add_ctrl(ctrl: *mut nvme_ctrl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_mark_namespaces_dead(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_unfreeze(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_wait_freeze_timeout(ctrl: *mut nvme_ctrl) -> c_int {
    int nvme_wait_freeze_timeout(struct nvme_ctrl *ctrl)
    {
    let mut timeout: c_long = ctrl.io_timeout;
    struct nvme_ns *ns;
    int srcu_idx;
    srcu_idx = srcu_read_lock(&ctrl.srcu);
    list_for_each_entry_srcu(ns, &ctrl.namespaces, list,
...
#[no_mangle]
pub unsafe extern "C" fn nvme_wait_freeze(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_start_freeze(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_quiesce_io_queues(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_unquiesce_io_queues(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_quiesce_admin_queue(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_unquiesce_admin_queue(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_sync_io_queues(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_sync_queues(ctrl: *mut nvme_ctrl) {
...
//
#[no_mangle]
pub unsafe extern "C" fn _nvme_check_size() {
...
#[no_mangle]
unsafe extern "C" fn nvme_core_init() -> int __init {
    static int __init nvme_core_init(void)
    {
    let mut wq_flags: c_uint = WQ_UNBOUND | WQ_MEM_RECLAIM | WQ_SYSFS;
...
#[no_mangle]
unsafe extern "C" fn nvme_core_exit() -> void __exit {
