...
//! Source: drivers/nvme/host/apple.c
#![no_std]
...
pub const APPLE_ANS_COPROC_CPU_CONTROL: c_uint = 0x44;

pub const APPLE_ANS_ACQ_DB: c_uint = 0x1004;
pub const APPLE_ANS_IOCQ_DB: c_uint = 0x100c;
pub const APPLE_ANS_MAX_PEND_CMDS_CTRL: c_uint = 0x1210;
pub const APPLE_ANS_BOOT_STATUS: c_uint = 0x1300;
pub const APPLE_ANS_BOOT_STATUS_OK: c_uint = 0xde71ce55;
pub const APPLE_ANS_LINEAR_SQ_CTRL: c_uint = 0x24908;

pub const APPLE_ANS_LINEAR_ASQ_DB: c_uint = 0x2490c;
pub const APPLE_ANS_LINEAR_IOSQ_DB: c_uint = 0x24910;
pub const APPLE_NVMMU_NUM_TCBS: c_uint = 0x28100;
pub const APPLE_NVMMU_ASQ_TCB_BASE: c_uint = 0x28108;
pub const APPLE_NVMMU_IOSQ_TCB_BASE: c_uint = 0x28110;
pub const APPLE_NVMMU_TCB_INVAL: c_uint = 0x28118;
pub const APPLE_NVMMU_TCB_STAT: c_uint = 0x28120;
//
...
//
pub const APPLE_NVME_AQ_DEPTH: c_int = 2;

pub const APPLE_NVME_IOSQES: c_int = 7;
//
// These can be higher, but we need to ensure that any command doesn't
// require an sg allocation that needs more than a page of data.
//
pub const NVME_MAX_KB_SZ: c_int = 4096;
pub const NVME_MAX_SEGS: c_int = 127;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_nvme_queue {
    pub sqes: *mut nvme_command,
    pub cqes: *mut nvme_completion,
    pub tcbs: *mut apple_nvmmu_tcb,
    pub sq_dma_addr: dma_addr_t,
    pub cq_dma_addr: dma_addr_t,
    pub tcb_dma_addr: dma_addr_t,
...
#[no_mangle]
pub unsafe extern "C" fn apple_nvme_queue_enabled(q: *mut apple_nvme_queue) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn apple_nvme_enable_queue(q: *mut apple_nvme_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn apple_nvme_disable_queue(q: *mut apple_nvme_queue) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_nvme_iod {
    pub req: nvme_request,
    pub cmd: nvme_command,
    pub q: *mut apple_nvme_queue,
    pub /: *mut *mut int npages; / In the PRP list. 0 means small pool in use,
    pub /: *mut *mut int nents; / Used in scatterlist,
    pub first_dma: dma_addr_t,
    pub /: *mut *mut unsigned int dma_len; / length of single DMA segment mapping,
    pub sg: *mut scatterlist,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_nvme_hw {
    pub has_lsq_nvmmu: bool,
    pub max_queue_depth: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_nvme {
    pub dev: *mut device,
    pub mmio_coproc: *mut void __iomem,
    pub mmio_nvme: *mut void __iomem,
    pub hw: *const apple_nvme_hw,
    pub pd_dev: *mut device,
    pub pd_link: *mut device_link,
    pub pd_count: c_int,
    pub sart: *mut apple_sart,
    pub rtk: *mut apple_rtkit,
    pub reset: *mut reset_control,
    pub prp_page_pool: *mut dma_pool,
    pub prp_small_pool: *mut dma_pool,
    pub iod_mempool: *mut mempool_t,
    pub ctrl: nvme_ctrl,
    pub remove_work: work_struct,
    pub adminq: apple_nvme_queue,
    pub ioq: apple_nvme_queue,
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_queue_depth(q: *mut apple_nvme_queue) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_rtkit_crashed(cookie: *mut c_void, crashlog: *const c_void, crashlog_size: usize) {
...
#[no_mangle]
unsafe extern "C" fn apple_nvmmu_inval(q: *mut apple_nvme_queue, tag: c_uint) {
    ...
    {
    struct apple_nvme *anv = queue_to_apple_nvme(q);
    let mut tag: u32 = nvme_tag_from_cid(cmd.common.command_id);
    ...
    tcb.dma_flags = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: nvme_is_write(cmd)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn apple_nvme_iod_alloc_size() -> usize {
    ...
    let mut npages: c_int = DIV_ROUND_UP(8 * nprps, PAGE_SIZE - 8);
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_free_prps(anv: *mut apple_nvme, req: *mut request) {
    ...
    struct apple_nvme_iod *iod = blk_mq_rq_to_pdu(req);
    let mut dma_addr: dma_addr_t = iod.first_dma;
    int i;
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_unmap_data(anv: *mut apple_nvme, req: *mut request) {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_print_sgl(sgl: *mut scatterlist, nents: c_int) {
    static void apple_nvme_print_sgl(struct scatterlist *sgl, int nents)
    {
    int i;
    struct scatterlist *sg;
    for_each_sg(sgl, sg, nents, i) {
    let mut phys: dma_addr_t = sg_phys(sg);
    ...
    let mut length: c_int = blk_rq_payload_bytes(req);
    struct scatterlist *sg = iod.sg;
    let mut dma_len: c_int = sg_dma_len(sg);
    let mut dma_addr: u64 = sg_dma_address(sg);
    let mut offset: c_int = dma_addr & (NVME_CTRL_PAGE_SIZE - 1);
    __le64 *prp_list;
    ...
    {
    struct apple_nvme_iod *iod = blk_mq_rq_to_pdu(req);
    let mut offset: c_uint = bv.bv_offset & (NVME_CTRL_PAGE_SIZE - 1);
    let mut first_prp_len: c_uint = NVME_CTRL_PAGE_SIZE - offset;
    ...
    {
    struct apple_nvme_iod *iod = blk_mq_rq_to_pdu(req);
    let mut ret: blk_status_t = BLK_STS_RESOURCE;
    int nr_mapped;
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_unmap_rq(req: *mut request) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_complete_rq(req: *mut request) {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_complete_batch(iob: *mut io_comp_batch) {
    static void apple_nvme_complete_batch(struct io_comp_batch *iob)
    {
    nvme_complete_batch(iob, apple_nvme_unmap_rq);
    }
#[no_mangle]
pub unsafe extern "C" fn apple_nvme_cqe_pending(q: *mut apple_nvme_queue) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn apple_nvme_update_cq_head(q: *mut apple_nvme_queue) {
    static inline void apple_nvme_update_cq_head(struct apple_nvme_queue *q)
    {
    let mut tmp: u32 = q.cq_head + 1;
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_handle_cq(q: *mut apple_nvme_queue, force: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_create_cq(anv: *mut apple_nvme) -> c_int {
...
//
    ...
    return nvme_submit_sync_cmd(anv.ctrl.admin_q, &c, core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn apple_nvme_remove_cq(anv: *mut apple_nvme) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_create_sq(anv: *mut apple_nvme) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_remove_sq(anv: *mut apple_nvme) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_disable(anv: *mut apple_nvme, shutdown: bool) {
    static void apple_nvme_disable(struct apple_nvme *anv, bool shutdown)
    {
    let mut state: enum nvme_ctrl_state = nvme_ctrl_state(&anv.ctrl);
    let mut csts: u32 = readl(anv.mmio_nvme + NVME_REG_CSTS);
    let mut dead: bool = false, freeze = false;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_timeout(req: *mut request) -> enum blk_eh_timer_return {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_init_queue(q: *mut apple_nvme_queue) {
    static void apple_nvme_init_queue(struct apple_nvme_queue *q)
    {
    let mut depth: c_uint = apple_nvme_queue_depth(q);
    struct apple_nvme *anv = queue_to_apple_nvme(q);
    q.sq_tail = 0;
    q.cq_head = 0;
    q.cq_phase = 1;
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_reset_work(work: *mut work_struct) {
    static void apple_nvme_reset_work(struct work_struct *work)
    {
    let mut nr_io_queues: c_uint = 1;
    int ret;
    u32 boot_status, aqa;
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_remove_dead_ctrl_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_reg_read32(ctrl: *mut nvme_ctrl, off: u32, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_reg_write32(ctrl: *mut nvme_ctrl, off: u32, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_reg_read64(ctrl: *mut nvme_ctrl, off: u32, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_get_address(ctrl: *mut nvme_ctrl, buf: *mut c_char, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_free_ctrl(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_async_probe(data: *mut c_void, cookie: async_cookie_t) {
...
#[no_mangle]
unsafe extern "C" fn devm_apple_nvme_put_tag_set(data: *mut c_void) {
    static void devm_apple_nvme_put_tag_set(void *data)
    {
    blk_mq_free_tag_set(data);
    }
#[no_mangle]
unsafe extern "C" fn apple_nvme_alloc_tagsets(anv: *mut apple_nvme) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_detach_genpd(anv: *mut apple_nvme) {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_attach_genpd(anv: *mut apple_nvme) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_apple_nvme_mempool_destroy(data: *mut c_void) {
    ...
    goto put_dev;
    anv.rtk =
    devm_apple_rtkit_init(dev, anv, core::ptr::null_mut(), 0, &apple_nvme_rtkit_ops);
    if (IS_ERR(anv.rtk)) {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (ret)
    goto out_put_ctrl;
    anv.ctrl.admin_q = blk_mq_alloc_queue(&anv.admin_tagset, core::ptr::null_mut(), core::ptr::null_mut());
    if (IS_ERR(anv.ctrl.admin_q)) {
    ret = -ENOMEM;
    anv.ctrl.admin_q = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_nvme_suspend(dev: *mut device) -> c_int {
