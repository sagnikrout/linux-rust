...
//! Source: drivers/nvme/host/rdma.c
#![no_std]
...
pub const NVME_RDMA_MAX_SEGMENTS: c_int = 256;
pub const NVME_RDMA_MAX_INLINE_SEGMENTS: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvme_rdma_device {
    pub dev: *mut ib_device,
    pub pd: *mut ib_pd,
    pub ref: kref,
    struct list_head	entry
    pub num_inline_segments: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvme_rdma_qe {
    pub cqe: ib_cqe,
    pub data: *mut c_void,
    pub dma: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvme_rdma_sgl {
    pub nents: c_int,
    pub sg_table: sg_table,
}

    struct nvme_rdma_queue;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvme_rdma_request {
    pub req: nvme_request,
    pub mr: *mut ib_mr,
    pub sqe: nvme_rdma_qe,
    pub result: union nvme_result,
    pub status: __le16,
    pub ref: refcount_t,
    pub NVME_RDMA_MAX_INLINE_SEGMENTS]: ib_sge sge[1 +,
    pub num_sge: u32,
    pub reg_wr: ib_reg_wr,
    pub reg_cqe: ib_cqe,
    pub queue: *mut nvme_rdma_queue,
    pub data_sgl: nvme_rdma_sgl,
    pub metadata_sgl: *mut nvme_rdma_sgl,
    pub use_sig_mr: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvme_rdma_queue {
    pub rsp_ring: *mut nvme_rdma_qe,
    pub queue_size: c_int,
    pub cmnd_capsule_len: usize,
    pub ctrl: *mut nvme_rdma_ctrl,
    pub device: *mut nvme_rdma_device,
    pub ib_cq: *mut ib_cq,
    pub qp: *mut ib_qp,
    pub flags: c_ulong,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvme_rdma_setup_ctx {
    pub queue: *mut nvme_rdma_queue,
    pub err: *mut c_int,
}
...
//
    let mut register_always: static bool = true;
...
#[no_mangle]
pub unsafe extern "C" fn nvme_rdma_queue_idx(queue: *mut nvme_rdma_queue) -> c_int {
    static inline int nvme_rdma_queue_idx(struct nvme_rdma_queue *queue)
    {
    return queue - queue.ctrl.queues;
    }
#[no_mangle]
unsafe extern "C" fn nvme_rdma_poll_queue(queue: *mut nvme_rdma_queue) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvme_rdma_inline_data_size(queue: *mut nvme_rdma_queue) -> usize {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_qp_event(event: *mut ib_event, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_wait_for_cm(queue: *mut nvme_rdma_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_create_qp(queue: *mut nvme_rdma_queue, factor: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_free_dev(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_dev_put(dev: *mut nvme_rdma_device) {
    static void nvme_rdma_dev_put(struct nvme_rdma_device *dev)
    {
    kref_put(&dev.ref, nvme_rdma_free_dev);
    }
#[no_mangle]
unsafe extern "C" fn nvme_rdma_dev_get(dev: *mut nvme_rdma_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_free_cq(queue: *mut nvme_rdma_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_destroy_queue_ib(queue: *mut nvme_rdma_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_get_max_fr_pages(ibdev: *mut ib_device, pi_support: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_create_queue_ib(queue: *mut nvme_rdma_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_alloc_queue(queue: *mut nvme_rdma_queue) -> c_int {
    static int nvme_rdma_alloc_queue(struct nvme_rdma_queue *queue)
    {
    struct nvme_rdma_ctrl *ctrl = queue.ctrl;
    let mut idx: c_int = nvme_rdma_queue_idx(queue);
    struct sockaddr *src_addr = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn __nvme_rdma_stop_queue(queue: *mut nvme_rdma_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_stop_queue(queue: *mut nvme_rdma_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_free_queue(queue: *mut nvme_rdma_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_free_io_queues(ctrl: *mut nvme_rdma_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_stop_io_queues(ctrl: *mut nvme_rdma_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_start_queue(ctrl: *mut nvme_rdma_ctrl, idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_setup_queue_async(data: *mut c_void, cookie: async_cookie_t) {
    ...
    let mut nr_queues: c_int = last - first;
    let mut err: c_int = 0, i, ret;
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_alloc_tag_set(ctrl: *mut nvme_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_destroy_admin_queue(ctrl: *mut nvme_rdma_ctrl) {
    ...
    ctrl.async_event_sqe.data = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_configure_io_queues(ctrl: *mut nvme_rdma_ctrl, new: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_stop_ctrl(nctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_free_ctrl(nctrl: *mut nvme_ctrl) {
    ...
    int status)
    {
    let mut state: enum nvme_ctrl_state = nvme_ctrl_state(&ctrl.ctrl);
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_setup_ctrl(ctrl: *mut nvme_rdma_ctrl, new: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_reconnect_ctrl_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_error_recovery_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_error_recovery(ctrl: *mut nvme_rdma_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_end_request(req: *mut nvme_rdma_request) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_memreg_done(cq: *mut ib_cq, wc: *mut ib_wc) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_inv_rkey_done(cq: *mut ib_cq, wc: *mut ib_wc) {
    ...
    return ib_post_send(queue.qp, &wr, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn nvme_rdma_dma_unmap_req(ibdev: *mut ib_device, rq: *mut request) {
    ...
    req.mr = core::ptr::null_mut();
    }
    nvme_rdma_dma_unmap_req(ibdev, rq);
    }
#[no_mangle]
unsafe extern "C" fn nvme_rdma_set_sg_null(c: *mut nvme_command) -> c_int {
...
//
    nr = ib_map_mr_sg(req.mr, req.data_sgl.sg_table.sgl, count, core::ptr::null_mut(),
    SZ_4K);
    ...
    u8 pi_type)
    {
    let mut control: u16 = le16_to_cpu(cmd.rw.control);
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_set_prot_checks(cmd: *mut nvme_command, mask: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_sig_done(cq: *mut ib_cq, wc: *mut ib_wc) {
    ...
    if (WARN_ON_ONCE(!req.mr))
    return -EAGAIN;
    nr = ib_map_mr_sg_pi(req.mr, sgl.sg_table.sgl, count, core::ptr::null_mut(),
    req.metadata_sgl.sg_table.sgl, pi_count, core::ptr::null_mut(),
    SZ_4K);
    if (unlikely(nr))
    goto mr_put;
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_send_done(cq: *mut ib_cq, wc: *mut ib_wc) {
    ...
    first = &wr;
    ret = ib_post_send(queue.qp, first, core::ptr::null_mut());
    if (unlikely(ret)) {
    dev_err(queue.ctrl.ctrl.device,
    ...
    wr.sg_list  = &list;
    wr.num_sge  = 1;
    ret = ib_post_recv(queue.qp, &wr, core::ptr::null_mut());
    if (unlikely(ret)) {
    dev_err(queue.ctrl.ctrl.device,
    "%s failed with error code %d\n", __func__, ret);
    }
    ...
    {
    let mut queue_idx: u32 = nvme_rdma_queue_idx(queue);
    if (queue_idx == 0)
    return queue.ctrl.admin_tag_set.tags[queue_idx];
    return queue.ctrl.tag_set.tags[queue_idx - 1];
    }
#[no_mangle]
unsafe extern "C" fn nvme_rdma_async_done(cq: *mut ib_cq, wc: *mut ib_wc) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_submit_async_event(arg: *mut nvme_ctrl) {
    ...
    DMA_TO_DEVICE);
    ret = nvme_rdma_post_send(queue, sqe, &sge, 1, core::ptr::null_mut());
    WARN_ON_ONCE(ret);
    }
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_recv_done(cq: *mut ib_cq, wc: *mut ib_wc) {
    static void nvme_rdma_recv_done(struct ib_cq *cq, struct ib_wc *wc)
    {
    struct nvme_rdma_qe *qe =
    container_of(wc.wr_cqe, struct nvme_rdma_qe, cqe);
    ...
    let mut len: usize = sizeof(struct nvme_completion);
    if (unlikely(wc.status != IB_WC_SUCCESS)) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_conn_established(queue: *mut nvme_rdma_queue) -> c_int {
    ...
    let mut status: c_int = ev.status;
    const char *rej_msg;
    ...
    let mut sts: u16 = le16_to_cpu(rej_data.sts);
    dev_err(queue.ctrl.ctrl.device,
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_addr_resolved(queue: *mut nvme_rdma_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_route_resolved(queue: *mut nvme_rdma_queue) -> c_int {
    static int nvme_rdma_route_resolved(struct nvme_rdma_queue *queue)
    {
    struct nvme_rdma_ctrl *ctrl = queue.ctrl;
    let mut param: rdma_conn_param = { };
    let mut priv: nvme_rdma_cm_req = { };
    int ret;
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_complete_timed_out(rq: *mut request) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_timeout(rq: *mut request) -> enum blk_eh_timer_return {
    ...
    let mut qid: c_int = nvme_rdma_queue_idx(queue);
    dev_warn(ctrl.ctrl.device,
...
//
    ...
    let mut queue_ready: bool = test_bit(NVME_RDMA_Q_LIVE, &queue.flags);
    blk_status_t ret;
    let mut err: c_int = 0;
    ...
    req.mr ? &req.reg_wr.wr : core::ptr::null_mut());
    if (unlikely(err))
    goto err_unmap;
    return BLK_STS_OK;
    err_unmap:
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_poll(hctx: *mut blk_mq_hw_ctx, iob: *mut io_comp_batch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_check_pi_status(req: *mut nvme_rdma_request) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_complete_rq(rq: *mut request) {
    static void nvme_rdma_complete_rq(struct request *rq)
    {
    struct nvme_rdma_request *req = blk_mq_rq_to_pdu(rq);
    struct nvme_rdma_queue *queue = req.queue;
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_map_queues(set: *mut blk_mq_tag_set) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_shutdown_ctrl(ctrl: *mut nvme_rdma_ctrl, shutdown: bool) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_delete_ctrl(ctrl: *mut nvme_ctrl) {
    static void nvme_rdma_delete_ctrl(struct nvme_ctrl *ctrl)
    {
    nvme_rdma_shutdown_ctrl(to_rdma_ctrl(ctrl), true);
    }
#[no_mangle]
unsafe extern "C" fn nvme_rdma_reset_ctrl_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_supports_pci_p2pdma(ctrl: *mut nvme_ctrl) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_remove_one(ib_device: *mut ib_device, client_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nvme_rdma_cleanup_module() -> void __exit {
