...
//! Source: drivers/nvme/target/pci-epf.c
#![no_std]
...
//
pub const NVMET_PCI_EPF_MAX_SEGS: c_int = 128;
...
//
pub const NVMET_PCI_EPF_IV_THRESHOLD: c_int = 8;
//
...
//
pub const NVMET_PCI_EPF_SQ_AB: c_int = 8;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_pci_epf_irq_vector {
    pub vector: c_uint,
    pub ref: c_uint,
    pub cd: bool,
    pub nr_irqs: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_pci_epf_queue {
    union {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_pci_epf_segment {
    pub buf: *mut c_void,
    pub pci_addr: u64,
    pub length: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_pci_epf_iod {
    pub link: list_head,
    pub req: nvmet_req,
    pub cmd: nvme_command,
    pub cqe: nvme_completion,
    pub status: c_uint,
    pub ctrl: *mut nvmet_pci_epf_ctrl,
    pub sq: *mut nvmet_pci_epf_queue,
    pub cq: *mut nvmet_pci_epf_queue,
...
// target core.
//
    pub nr_data_segs: c_uint,
    pub data_seg: nvmet_pci_epf_segment,
    pub data_segs: *mut nvmet_pci_epf_segment,
    pub data_sgl: scatterlist,
    pub data_sgt: sg_table,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_pci_epf_ctrl {
    pub nvme_epf: *mut nvmet_pci_epf,
    pub port: *mut nvmet_port,
    pub tctrl: *mut nvmet_ctrl,
    pub dev: *mut device,
    pub nr_queues: c_uint,
    pub sq: *mut nvmet_pci_epf_queue,
    pub cq: *mut nvmet_pci_epf_queue,
    pub sq_ab: c_uint,
    pub iod_pool: mempool_t,
    pub bar: *mut c_void,
    pub cap: u64,
    pub cc: u32,
    pub csts: u32,
    ...
    pub mps_mask: usize,
    pub mdts: c_uint,
    pub poll_cc: delayed_work,
    pub poll_sqs: delayed_work,
    pub irq_lock: mutex,
    pub irq_vectors: *mut nvmet_pci_epf_irq_vector,
    pub irq_vector_threshold: c_uint,
    pub link_up: bool,
    pub enabled: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_pci_epf {
    pub epf: *mut pci_epf,
    pub epc_features: *const pci_epc_features,
    pub reg_bar: *mut c_void,
    pub msix_table_offset: usize,
    pub irq_type: c_uint,
    pub nr_vectors: c_uint,
    pub ctrl: nvmet_pci_epf_ctrl,
...
// PCI endpoint function configfs attributes.
    ...
    pub portid: __le16,
    pub subsysnqn: [c_char; NVMF_NQN_SIZE],
    pub mdts_kb: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_pci_epf_dma_filter {
    pub dev: *mut device,
    pub dma_mask: u32,
}

#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_dma_filter(chan: *mut dma_chan, arg: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_init_dma(nvme_epf: *mut nvmet_pci_epf) {
    ...
    nvme_epf.dma_rx_chan = core::ptr::null_mut();
    out_dma_no_rx:
    nvme_epf.dma_enabled = false;
    dev_info(&epf.dev, "DMA not supported, falling back to MMIO\n");
    }
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_deinit_dma(nvme_epf: *mut nvmet_pci_epf) {
    ...
    nvme_epf.dma_tx_chan = core::ptr::null_mut();
    dma_release_channel(nvme_epf.dma_rx_chan);
    nvme_epf.dma_rx_chan = core::ptr::null_mut();
    nvme_epf.dma_enabled = false;
    }
    ...
    let mut sconf: dma_slave_config = {};
    struct device *dev = &epf.dev;
    ...
    struct nvmet_pci_epf_segment *seg, enum dma_data_direction dir)
    {
    let mut pci_addr: u64 = seg.pci_addr;
    let mut length: u32 = seg.length;
    void *buf = seg.buf;
    struct pci_epc_map map;
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_alloc_irq_vectors(ctrl: *mut nvmet_pci_epf_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_free_irq_vectors(ctrl: *mut nvmet_pci_epf_ctrl) {
    ...
    ctrl.irq_vectors = core::ptr::null_mut();
    }
    }
...
//
    ...
    let mut nr_segs: c_int = iod.nr_data_segs + nsegs;
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_free_iod(iod: *mut nvmet_pci_epf_iod) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_transfer_iod_data(iod: *mut nvmet_pci_epf_iod) -> c_int {
...
//
    ...
    {
    let mut nr_prps: usize = (xfer_len + ctrl.mps_mask) >> ctrl.mps_shift;
    u32 length;
    int ret;
//
...
//
    ...
    struct nvmet_pci_epf_segment *seg;
    let mut size: usize = 0, ofst, prp_size, xfer_len;
    let mut transfer_len: usize = iod.data_len;
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_iod_parse_prps(iod: *mut nvmet_pci_epf_iod) -> c_int {
    static int nvmet_pci_epf_iod_parse_prps(struct nvmet_pci_epf_iod *iod)
    {
    struct nvmet_pci_epf_ctrl *ctrl = iod.ctrl;
    let mut prp1: u64 = le64_to_cpu(iod.cmd.common.dptr.prp1);
    size_t ofst;
...
//
    ...
    let mut length: u32 = le32_to_cpu(desc.length);
    int nr_descs, ret;
    void *buf;
...
// nr_sgls = nr_descs;
    ...
    {
    struct nvme_command *cmd = &iod.cmd;
    let mut seg: nvme_sgl_desc = cmd.common.dptr.sgl;
    struct nvme_sgl_desc *sgls = core::ptr::null_mut();
    let mut n: c_int = 0, i, nr_sgls;
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_iod_parse_sgls(iod: *mut nvmet_pci_epf_iod) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_alloc_iod_data_buf(iod: *mut nvmet_pci_epf_iod) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_complete_iod(iod: *mut nvmet_pci_epf_iod) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_drain_queue(queue: *mut nvmet_pci_epf_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_add_port(port: *mut nvmet_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_remove_port(port: *mut nvmet_port) {
    ...
    {
    struct nvmet_port *p, *port = core::ptr::null_mut();
    mutex_lock(&nvmet_pci_epf_ports_mutex);
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_queue_response(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_get_mdts(tctrl: *const nvmet_ctrl) -> u8 {
    static u8 nvmet_pci_epf_get_mdts(const struct nvmet_ctrl *tctrl)
    {
    struct nvmet_pci_epf_ctrl *ctrl = tctrl.drvdata;
    let mut page_shift: c_int = NVME_CAP_MPSMIN(tctrl.cap) + 12;
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_delete_cq(tctrl: *mut nvmet_ctrl, cqid: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_delete_sq(tctrl: *mut nvmet_ctrl, sqid: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_alloc_queues(ctrl: *mut nvmet_pci_epf_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_free_queues(ctrl: *mut nvmet_pci_epf_ctrl) {
    static void nvmet_pci_epf_free_queues(struct nvmet_pci_epf_ctrl *ctrl)
    {
    kfree(ctrl.sq);
    ctrl.sq = core::ptr::null_mut();
    kfree(ctrl.cq);
    ctrl.cq = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_exec_iod_work(work: *mut work_struct) {
    static void nvmet_pci_epf_exec_iod_work(struct work_struct *work)
    {
    struct nvmet_pci_epf_iod *iod =
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_cq_work(work: *mut work_struct) {
    static void nvmet_pci_epf_cq_work(struct work_struct *work)
    {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_clear_ctrl_config(ctrl: *mut nvmet_pci_epf_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_enable_ctrl(ctrl: *mut nvmet_pci_epf_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_poll_cc_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_init_bar(ctrl: *mut nvmet_pci_epf_ctrl) {
...
// Clear Controller Memory Buffer Supported (CMBS).
    ...
    let mut args: nvmet_alloc_ctrl_args = {};
...
// Initialize BAR 0 using the target controller CAP.
    ...
    ctrl.tctrl = core::ptr::null_mut();
    out_mempool_exit:
    mempool_exit(&ctrl.iod_pool);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_start_ctrl(ctrl: *mut nvmet_pci_epf_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_stop_ctrl(ctrl: *mut nvmet_pci_epf_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_destroy_ctrl(ctrl: *mut nvmet_pci_epf_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_configure_bar(nvme_epf: *mut nvmet_pci_epf) -> c_int {
    ...
    let mut msix_table_size: usize = 0;
//
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_free_bar(nvme_epf: *mut nvmet_pci_epf) {
    ...
    nvme_epf.reg_bar = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_clear_bar(nvme_epf: *mut nvmet_pci_epf) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_init_irq(nvme_epf: *mut nvmet_pci_epf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_epc_init(epf: *mut pci_epf) -> c_int {
    static int nvmet_pci_epf_epc_init(struct pci_epf *epf)
    {
    struct nvmet_pci_epf *nvme_epf = epf_get_drvdata(epf);
    const struct pci_epc_features *epc_features = nvme_epf.epc_features;
    struct nvmet_pci_epf_ctrl *ctrl = &nvme_epf.ctrl;
    let mut max_nr_queues: c_uint = NVMET_NR_QUEUES;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_epc_deinit(epf: *mut pci_epf) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_link_up(epf: *mut pci_epf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_link_down(epf: *mut pci_epf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_bind(epf: *mut pci_epf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_unbind(epf: *mut pci_epf) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_portid_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_mdts_kb_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn if(NVMET_PCI_EPF_MAX_MDTS_KB: mdts_kb >) -> else {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pci_epf_cleanup_module() -> void __exit {
