...
//! Source: drivers/nvme/target/zns.c
#![no_std]
...
//
pub const NVMET_MPSMIN_SHIFT: c_int = 12;
#[no_mangle]
pub unsafe extern "C" fn nvmet_zasl(zone_append_sects: c_uint) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_bdev_zns_enable(ns: *mut nvmet_ns) -> bool {
    bool nvmet_bdev_zns_enable(struct nvmet_ns *ns)
    {
    let mut zasl: u8 = nvmet_zasl(bdev_max_zone_append_sectors(ns.bdev));
...
//
    ...
    validate_conv_zones_cb, core::ptr::null_mut());
    if (ret < 0)
    return false;
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_execute_identify_ctrl_zns(req: *mut nvmet_req) {
    void nvmet_execute_identify_ctrl_zns(struct nvmet_req *req)
    {
    let mut zasl: u8 = req.sq.ctrl.subsys.zasl;
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_execute_identify_ns_zns(req: *mut nvmet_req) {
    void nvmet_execute_identify_ns_zns(struct nvmet_req *req)
    {
    struct nvme_id_ns_zns *id_zns = core::ptr::null_mut();
    u64 zsze;
    u16 status;
    u32 mar, mor;
...
#[no_mangle]
unsafe extern "C" fn nvmet_bdev_validate_zone_mgmt_recv(req: *mut nvmet_req) -> u16 {
    static u16 nvmet_bdev_validate_zone_mgmt_recv(struct nvmet_req *req)
    {
    let mut sect: sector_t = nvmet_lba_to_sect(req.ns, req.cmd.zmr.slba);
    let mut out_bufsize: u32 = (le32_to_cpu(req.cmd.zmr.numd) + 1) << 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_report_zone_data {
    pub req: *mut nvmet_req,
    pub out_buf_offset: u64,
    pub out_nr_zones: u64,
    pub nr_zones: u64,
    pub zrasf: u8,
}

#[no_mangle]
unsafe extern "C" fn nvmet_bdev_report_zone_cb(z: *mut blk_zone, i: unsigned, d: *mut c_void) -> c_int {
    ...
    let mut zdesc: nvme_zone_descriptor = { };
    u16 status;
...
#[no_mangle]
unsafe extern "C" fn nvmet_req_nr_zones_from_slba(req: *mut nvmet_req) -> c_ulong {
    static unsigned long nvmet_req_nr_zones_from_slba(struct nvmet_req *req)
    {
    let mut sect: c_uint = nvmet_lba_to_sect(req.ns, req.cmd.zmr.slba);
    return bdev_nr_zones(req.ns.bdev) - bdev_zone_no(req.ns.bdev, sect);
    }
#[no_mangle]
unsafe extern "C" fn get_nr_zones_from_buf(req: *mut nvmet_req, bufsize: u32) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn nvmet_bdev_zone_zmgmt_recv_work(w: *mut work_struct) {
    ...
    let mut start_sect: sector_t = nvmet_lba_to_sect(req.ns, req.cmd.zmr.slba);
    let mut req_slba_nr_zones: c_ulong = nvmet_req_nr_zones_from_slba(req);
    let mut out_bufsize: u32 = (le32_to_cpu(req.cmd.zmr.numd) + 1) << 2;
    __le64 nr_zones;
    u16 status;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_bdev_execute_zone_mgmt_recv(req: *mut nvmet_req) {
...
#[no_mangle]
pub unsafe extern "C" fn zsa_req_op(zsa: u8) -> enum req_op {
...
#[no_mangle]
unsafe extern "C" fn blkdev_zone_mgmt_errno_to_nvme_status(ret: c_int) -> u16 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_zone_mgmt_send_all_data {
    pub zbitmap: *mut c_ulong,
    pub req: *mut nvmet_req,
}

#[no_mangle]
unsafe extern "C" fn zmgmt_send_scan_cb(z: *mut blk_zone, i: unsigned, d: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_bdev_zone_mgmt_emulate_all(req: *mut nvmet_req) -> u16 {
    static u16 nvmet_bdev_zone_mgmt_emulate_all(struct nvmet_req *req)
    {
    struct block_device *bdev = req.ns.bdev;
    let mut nr_zones: c_uint = bdev_nr_zones(bdev);
...
#[no_mangle]
unsafe extern "C" fn nvmet_bdev_execute_zmgmt_send_all(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_bdev_zmgmt_send_work(w: *mut work_struct) {
    static void nvmet_bdev_zmgmt_send_work(struct work_struct *w)
    {
    struct nvmet_req *req = container_of(w, struct nvmet_req, z.zmgmt_work);
    let mut sect: sector_t = nvmet_lba_to_sect(req.ns, req.cmd.zms.slba);
    let mut op: enum req_op = zsa_req_op(req.cmd.zms.zsa);
    struct block_device *bdev = req.ns.bdev;
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_bdev_execute_zone_mgmt_send(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_bdev_zone_append_bio_done(bio: *mut bio) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_bdev_execute_zone_append(req: *mut nvmet_req) {
    void nvmet_bdev_execute_zone_append(struct nvmet_req *req)
    {
    let mut sect: sector_t = nvmet_lba_to_sect(req.ns, req.cmd.rw.slba);
    let mut opf: blk_opf_t = REQ_OP_ZONE_APPEND | REQ_SYNC | REQ_IDLE;
    let mut status: u16 = NVME_SC_SUCCESS;
    let mut total_len: c_uint = 0;
    struct scatterlist *sg;
    let mut data_len: u32 = nvmet_rw_data_len(req);
    struct bio *bio;
    int sg_cnt;
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_bdev_zns_parse_io_cmd(req: *mut nvmet_req) -> u16 {
