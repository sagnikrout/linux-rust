...
//! Source: drivers/nvme/target/configfs.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_type_name_map {
    pub type: u8,
...
#[no_mangle]
unsafe extern "C" fn nvmet_is_port_enabled(p: *mut nvmet_port, caller: *const c_char) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn nvmet_addr_adrfam_show(item: *mut config_item, page: *mut c_char) -> isize {
    static ssize_t nvmet_addr_adrfam_show(struct config_item *item, char *page)
    {
    let mut adrfam: u8 = to_nvmet_port(item).disc_addr.adrfam;
    int i;
    ...
    char *page)
    {
    let mut portid: __le16 = to_nvmet_port(item).disc_addr.portid;
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_port_disc_addr_treq_mask(port: *mut nvmet_port) -> u8 {
    static inline u8 nvmet_port_disc_addr_treq_mask(struct nvmet_port *port)
    {
    return (port.disc_addr.treq & ~NVME_TREQ_SECURE_CHANNEL_MASK);
    }
#[no_mangle]
unsafe extern "C" fn nvmet_addr_treq_show(item: *mut config_item, page: *mut c_char) -> isize {
    static ssize_t nvmet_addr_treq_show(struct config_item *item, char *page)
    {
    let mut treq: u8 = nvmet_port_disc_addr_treq_secure_channel(to_nvmet_port(item));
    int i;
    ...
    {
    struct nvmet_port *port = to_nvmet_port(item);
    let mut treq: u8 = nvmet_port_disc_addr_treq_mask(port);
    int i;
    if (nvmet_is_port_enabled(port, __func__))
    return -EACCES;
    for (i = 0; i < ARRAY_SIZE(nvmet_addr_treq); i++) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_param_mdts_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn nvmet_port_init_tsas_rdma(port: *mut nvmet_port) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_port_init_tsas_tcp(port: *mut nvmet_port, sectype: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(NVMF_TRTYPE_TCP: port->disc_addr.trtype ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn nvmet_addr_tsas_rdma_store(page: *const c_char) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_addr_tsas_tcp_store(page: *const c_char) -> u8 {
...
//
    if (sectype == NVMF_TCP_SECTYPE_TLS13) {
    let mut sc: u8 = nvmet_port_disc_addr_treq_secure_channel(port);
...
//
#[no_mangle]
unsafe extern "C" fn nvmet_ns_device_path_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn nvmet_ns_p2pmem_show(item: *mut config_item, page: *mut c_char) -> isize {
    ...
    {
    struct nvmet_ns *ns = to_nvmet_ns(item);
    struct pci_dev *p2p_dev = core::ptr::null_mut();
    bool use_p2pmem;
...
#[no_mangle]
unsafe extern "C" fn nvmet_ns_device_uuid_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn nvmet_ns_device_nguid_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn nvmet_ns_ana_grpid_show(item: *mut config_item, page: *mut c_char) -> isize {
    ...
    nvmet_send_ana_event(ns.subsys, core::ptr::null_mut());
    return count;
    }
    CONFIGFS_ATTR(nvmet_ns_, ana_grpid);
#[no_mangle]
unsafe extern "C" fn nvmet_ns_enable_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn nvmet_ns_buffered_io_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn nvmet_ns_resv_enable_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn nvmet_ns_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_add_passthru_group(subsys: *mut nvmet_subsys) {
...
unsafe extern "C" fn nvmet_add_passthru_group(subsys: *mut nvmet_subsys) {
    ...
    nvmet_subsys_disc_changed(subsys, core::ptr::null_mut());
    }
    out_unlock:
    up_write(&nvmet_config_sem);
    return ret ? ret : count;
...
#[no_mangle]
unsafe extern "C" fn nvmet_is_ascii(c: c_char) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn nvmet_subsys_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_referral_release(item: *mut config_item) {
    ...
    let mut state: enum nvme_ana_state = grp.port.ana_state[grp.grpid];
    int i;
...
#[no_mangle]
unsafe extern "C" fn nvmet_ana_group_release(item: *mut config_item) {
...
//
#[no_mangle]
unsafe extern "C" fn nvmet_port_release(item: *mut config_item) {
...
// Let inflight controllers teardown complete
    ...
    port.keyring = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn nvmet_host_release(item: *mut config_item) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_init_configfs() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_exit_configfs() -> void __exit {
