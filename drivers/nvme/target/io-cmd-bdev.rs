...
//! Source: drivers/nvme/target/io-cmd-bdev.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_bdev_set_limits(bdev: *mut block_device, id: *mut nvme_id_ns) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_bdev_ns_disable(ns: *mut nvmet_ns) {
    void nvmet_bdev_ns_disable(struct nvmet_ns *ns)
    {
    if (ns.bdev_file) {
    fput(ns.bdev_file);
    ns.bdev = core::ptr::null_mut();
    ns.bdev_file = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn nvmet_bdev_ns_enable_integrity(ns: *mut nvmet_ns) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_bdev_ns_enable(ns: *mut nvmet_ns) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_bdev_ns_revalidate(ns: *mut nvmet_ns) {
    void nvmet_bdev_ns_revalidate(struct nvmet_ns *ns)
    {
    ns.size = bdev_nr_bytes(ns.bdev);
    }
#[no_mangle]
pub unsafe extern "C" fn blk_to_nvme_status(req: *mut nvmet_req, blk_sts: blk_status_t) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_bio_done(bio: *mut bio) {
    static void nvmet_bio_done(struct bio *bio)
    {
    struct nvmet_req *req = bio.bi_private;
    let mut blk_status: blk_status_t = bio.bi_status;
...
#[no_mangle]
unsafe extern "C" fn nvmet_bdev_execute_rw(req: *mut nvmet_req) {
    static void nvmet_bdev_execute_rw(struct nvmet_req *req)
    {
    let mut sg_cnt: c_uint = req.sg_cnt;
    struct bio *bio;
    ...
    let mut total_len: c_uint = nvmet_rw_data_len(req) + req.metadata_len;
...
#[no_mangle]
unsafe extern "C" fn nvmet_bdev_execute_flush(req: *mut nvmet_req) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_bdev_flush(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_bdev_execute_discard(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_bdev_execute_dsm(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_bdev_execute_write_zeroes(req: *mut nvmet_req) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_bdev_parse_io_cmd(req: *mut nvmet_req) -> u16 {
