...
//! Source: drivers/nvme/target/rdma.c
#![no_std]
...
pub const NVMET_RDMA_MAX_INLINE_SGE: c_int = 4;

// Assume mpsmin == device_page_size == 4KB
pub const NVMET_RDMA_MAX_MDTS: c_int = 8;
pub const NVMET_RDMA_MAX_METADATA_MDTS: c_int = 5;
pub const NVMET_RDMA_BACKLOG: c_int = 128;

    struct nvmet_rdma_srq;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_rdma_cmd {
    pub 1]: ib_sge sge[NVMET_RDMA_MAX_INLINE_SGE +,
    pub cqe: ib_cqe,
    pub wr: ib_recv_wr,
    pub inline_sg: [scatterlist; NVMET_RDMA_MAX_INLINE_SGE],
    pub nvme_cmd: *mut nvme_command,
    pub queue: *mut nvmet_rdma_queue,
    pub nsrq: *mut nvmet_rdma_srq,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_rdma_rsp {
    pub send_sge: ib_sge,
    pub send_cqe: ib_cqe,
    pub send_wr: ib_send_wr,
    pub cmd: *mut nvmet_rdma_cmd,
    pub queue: *mut nvmet_rdma_queue,
    pub read_cqe: ib_cqe,
    pub write_cqe: ib_cqe,
    pub rw: rdma_rw_ctx,
    pub req: nvmet_req,
    pub allocated: bool,
    pub n_rdma: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_rdma_queue {
    pub cm_id: *mut rdma_cm_id,
    pub qp: *mut ib_qp,
    pub port: *mut nvmet_port,
    pub cq: *mut ib_cq,
    pub sq_wr_avail: core::sync::atomic::AtomicI32,
    pub dev: *mut nvmet_rdma_device,
    pub nsrq: *mut nvmet_rdma_srq,
    pub state_lock: spinlock_t,
    pub state: enum nvmet_rdma_queue_state,
    pub nvme_cq: nvmet_cq,
    pub nvme_sq: nvmet_sq,
    pub rsps: *mut nvmet_rdma_rsp,
    pub rsp_tags: sbitmap,
    pub cmds: *mut nvmet_rdma_cmd,
    pub release_work: work_struct,
    pub rsp_wait_list: list_head,
    pub rsp_wr_wait_list: list_head,
    pub rsp_wr_wait_lock: spinlock_t,
    pub idx: c_int,
    pub host_qid: c_int,
    pub comp_vector: c_int,
    pub recv_queue_size: c_int,
    pub send_queue_size: c_int,
    pub queue_list: list_head,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_rdma_port {
    pub nport: *mut nvmet_port,
    pub addr: sockaddr_storage,
    pub cm_id: *mut rdma_cm_id,
    pub repair_work: delayed_work,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_rdma_srq {
    pub srq: *mut ib_srq,
    pub cmds: *mut nvmet_rdma_cmd,
    pub ndev: *mut nvmet_rdma_device,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_rdma_device {
    pub device: *mut ib_device,
    pub pd: *mut ib_pd,
    pub srqs: *mut nvmet_rdma_srq,
    pub srq_count: c_int,
    pub srq_size: usize,
    pub ref: kref,
    pub entry: list_head,
    pub inline_data_size: c_int,
    pub inline_page_count: c_int,
}
    ...
    let mut nvmet_rdma_srq_size: static unsigned int = 1024;
...
#[no_mangle]
unsafe extern "C" fn srq_size_set(val: *const c_char, kp: *const kernel_param) -> c_int {
    static int srq_size_set(const char *val, const struct kernel_param *kp)
    {
    unsigned int n;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn num_pages(len: c_int) -> c_int {
    static int num_pages(int len)
    {
    return 1 + (((len - 1) & PAGE_MASK) >> PAGE_SHIFT);
    }
#[no_mangle]
pub unsafe extern "C" fn nvmet_rdma_need_data_in(rsp: *mut nvmet_rdma_rsp) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_rdma_need_data_out(rsp: *mut nvmet_rdma_rsp) -> bool {
    ...
    {
    struct nvmet_rdma_rsp *rsp = core::ptr::null_mut();
    int tag;
...
// Data Out / RDMA WRITE
    ...
    let mut nr_rsps: c_int = queue.recv_queue_size * 2;
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_free_rsps(queue: *mut nvmet_rdma_queue) {
    ...
    DMA_FROM_DEVICE);
    if (cmd.nsrq)
    ret = ib_post_srq_recv(cmd.nsrq.srq, &cmd.wr, core::ptr::null_mut());
    else
    ret = ib_post_recv(cmd.queue.qp, &cmd.wr, core::ptr::null_mut());
    if (unlikely(ret))
    pr_err("post_recv cmd failed\n");
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_process_wr_wait_list(queue: *mut nvmet_rdma_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_check_pi_status(sig_mr: *mut ib_mr) -> u16 {
    ...
    let mut pi_type: u8 = req.ns.pi_type;
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_rw_ctx_destroy(rsp: *mut nvmet_rdma_rsp) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_free_rsp_resources(rsp: *mut nvmet_rdma_rsp) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_release_rsp(rsp: *mut nvmet_rdma_rsp) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_error_comp(queue: *mut nvmet_rdma_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_send_done(cq: *mut ib_cq, wc: *mut ib_wc) {
    static void nvmet_rdma_send_done(struct ib_cq *cq, struct ib_wc *wc)
    {
    struct nvmet_rdma_rsp *rsp =
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_queue_response(req: *mut nvmet_req) {
    ...
    cm_id.port_num, &rsp.write_cqe, core::ptr::null_mut());
    else
    first_wr = rdma_rw_ctx_wrs(&rsp.rw, cm_id.qp,
    cm_id.port_num, core::ptr::null_mut(), &rsp.send_wr);
    } else {
    ...
    DMA_TO_DEVICE);
    if (unlikely(ib_post_send(cm_id.qp, first_wr, core::ptr::null_mut()))) {
    pr_err("sending cmd response failed\n");
    nvmet_rdma_release_rsp(rsp);
    }
    }
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_read_data_done(cq: *mut ib_cq, wc: *mut ib_wc) {
    static void nvmet_rdma_read_data_done(struct ib_cq *cq, struct ib_wc *wc)
    {
    struct nvmet_rdma_rsp *rsp =
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_write_data_done(cq: *mut ib_cq, wc: *mut ib_wc) {
    static void nvmet_rdma_write_data_done(struct ib_cq *cq, struct ib_wc *wc)
    {
    struct nvmet_rdma_rsp *rsp =
...
//
    ...
    nvmet_rdma_rw_ctx_destroy(rsp);
    if (unlikely(ib_post_send(cm_id.qp, &rsp.send_wr, core::ptr::null_mut()))) {
    pr_err("sending cmd response failed\n");
    nvmet_rdma_release_rsp(rsp);
    }
    }
    ...
    u64 off)
    {
    let mut page_off: u64 = off % PAGE_SIZE;
    let mut page_idx: u64 = off / PAGE_SIZE;
    let mut sg_count: c_int = num_pages(page_off + len);
    struct scatterlist *sg;
    int i;
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_map_sgl_inline(rsp: *mut nvmet_rdma_rsp) -> u16 {
    static u16 nvmet_rdma_map_sgl_inline(struct nvmet_rdma_rsp *rsp)
    {
    struct nvme_sgl_desc *sgl = &rsp.req.cmd.common.dptr.sgl;
    let mut off: u64 = le64_to_cpu(sgl.addr);
...
// no data command?
    ...
    {
    let mut addr: u64 = le64_to_cpu(sgl.addr);
    let mut key: u32 = get_unaligned_le32(sgl.key);
    struct ib_sig_attrs sig_attrs;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_map_sgl(rsp: *mut nvmet_rdma_rsp) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_execute_command(rsp: *mut nvmet_rdma_rsp) -> bool {
    static bool nvmet_rdma_execute_command(struct nvmet_rdma_rsp *rsp)
    {
    struct nvmet_rdma_queue *queue = rsp.queue;
    ...
    queue.cm_id.port_num, &rsp.read_cqe, core::ptr::null_mut()))
...
//
    ...
    ret = false;
#[no_mangle]
pub unsafe extern "C" fn if(NVMET_RDMA_Q_CONNECTING: queue->state ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_recv_done(cq: *mut ib_cq, wc: *mut ib_wc) {
    static void nvmet_rdma_recv_done(struct ib_cq *cq, struct ib_wc *wc)
    {
    struct nvmet_rdma_cmd *cmd =
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_destroy_srq(nsrq: *mut nvmet_rdma_srq) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_destroy_srqs(ndev: *mut nvmet_rdma_device) {
    ...
    {
    let mut srq_attr: ib_srq_init_attr = { core::ptr::null_mut(), };
    let mut srq_size: usize = ndev.srq_size;
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_init_srqs(ndev: *mut nvmet_rdma_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_free_dev(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_create_queue_ib(queue: *mut nvmet_rdma_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_destroy_queue_ib(queue: *mut nvmet_rdma_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_free_queue(queue: *mut nvmet_rdma_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_release_queue_work(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_qp_event(event: *mut ib_event, priv: *mut c_void) {
    static void nvmet_rdma_qp_event(struct ib_event *event, void *priv)
    {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_queue_established(queue: *mut nvmet_rdma_queue) {
...
#[no_mangle]
unsafe extern "C" fn __nvmet_rdma_queue_disconnect(queue: *mut nvmet_rdma_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_queue_disconnect(queue: *mut nvmet_rdma_queue) {
    static void nvmet_rdma_queue_disconnect(struct nvmet_rdma_queue *queue)
    {
    let mut disconnect: bool = false;
    mutex_lock(&nvmet_rdma_queue_mutex);
...
//
    if (xchg(&port.cm_id, core::ptr::null_mut()) != cm_id)
    return 0;
//
...
//
    ...
    struct rdma_cm_event *event)
    {
    struct nvmet_rdma_queue *queue = core::ptr::null_mut();
    let mut ret: c_int = 0;
    if (cm_id.qp)
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_delete_ctrl(ctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_destroy_port_queues(port: *mut nvmet_rdma_port) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_disable_port(port: *mut nvmet_rdma_port) {
    static void nvmet_rdma_disable_port(struct nvmet_rdma_port *port)
    {
    struct rdma_cm_id *cm_id = xchg(&port.cm_id, core::ptr::null_mut());
    if (cm_id)
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_enable_port(port: *mut nvmet_rdma_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_repair_port_work(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_add_port(nport: *mut nvmet_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_remove_port(nport: *mut nvmet_port) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_get_mdts(ctrl: *const nvmet_ctrl) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_get_max_queue_size(ctrl: *const nvmet_ctrl) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_remove_one(ib_device: *mut ib_device, client_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nvmet_rdma_exit() -> void __exit {
