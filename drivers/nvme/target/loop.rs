...
//! Source: drivers/nvme/target/loop.c
#![no_std]
...
pub const NVME_LOOP_MAX_SEGMENTS: c_int = 256;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvme_loop_iod {
    pub nvme_req: nvme_request,
    pub cmd: nvme_command,
    pub cqe: nvme_completion,
    pub req: nvmet_req,
    pub queue: *mut nvme_loop_queue,
    pub work: work_struct,
    pub sg_table: sg_table,
    pub first_sgl: [scatterlist; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvme_loop_ctrl {
    pub queues: *mut nvme_loop_queue,
...
// Must be last --ends in a flexible-array member.
    pub async_event_iod: nvme_loop_iod,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvme_loop_queue {
    pub nvme_cq: nvmet_cq,
    pub nvme_sq: nvmet_sq,
    pub ctrl: *mut nvme_loop_ctrl,
    pub flags: c_ulong,
}
...
#[no_mangle]
pub unsafe extern "C" fn nvme_loop_queue_idx(queue: *mut nvme_loop_queue) -> c_int {
    static inline int nvme_loop_queue_idx(struct nvme_loop_queue *queue)
    {
    return queue - queue.ctrl.queues;
    }
#[no_mangle]
unsafe extern "C" fn nvme_loop_complete_rq(req: *mut request) {
    ...
    {
    let mut queue_idx: u32 = nvme_loop_queue_idx(queue);
    if (queue_idx == 0)
    return queue.ctrl.admin_tag_set.tags[queue_idx];
    return queue.ctrl.tag_set.tags[queue_idx - 1];
    }
#[no_mangle]
unsafe extern "C" fn nvme_loop_queue_response(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_execute_work(work: *mut work_struct) {
    ...
    struct nvme_loop_iod *iod = blk_mq_rq_to_pdu(req);
    let mut queue_ready: bool = test_bit(NVME_LOOP_Q_LIVE, &queue.flags);
    blk_status_t ret;
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_submit_async_event(arg: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_destroy_admin_queue(ctrl: *mut nvme_loop_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_free_ctrl(nctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_destroy_io_queues(ctrl: *mut nvme_loop_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_init_io_queues(ctrl: *mut nvme_loop_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_connect_io_queues(ctrl: *mut nvme_loop_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_configure_admin_queue(ctrl: *mut nvme_loop_ctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_shutdown_ctrl(ctrl: *mut nvme_loop_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_delete_ctrl_host(ctrl: *mut nvme_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_delete_ctrl(nctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_reset_ctrl_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_create_io_queues(ctrl: *mut nvme_loop_ctrl) -> c_int {
    ...
    {
    struct nvmet_port *p, *found = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_add_port(port: *mut nvmet_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_remove_port(port: *mut nvmet_port) {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nvme_loop_cleanup_module() -> void __exit {
