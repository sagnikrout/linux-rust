...
//! Source: drivers/nvme/target/admin-cmd.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_delete_sq(req: *mut nvmet_req) {
    static void nvmet_execute_delete_sq(struct nvmet_req *req)
    {
    struct nvmet_ctrl *ctrl = req.sq.ctrl;
    let mut sqid: u16 = le16_to_cpu(req.cmd.delete_queue.qid);
    u16 status;
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_create_sq(req: *mut nvmet_req) {
    static void nvmet_execute_create_sq(struct nvmet_req *req)
    {
    struct nvmet_ctrl *ctrl = req.sq.ctrl;
    struct nvme_command *cmd = req.cmd;
    let mut sqid: u16 = le16_to_cpu(cmd.create_sq.sqid);
    let mut cqid: u16 = le16_to_cpu(cmd.create_sq.cqid);
    let mut sq_flags: u16 = le16_to_cpu(cmd.create_sq.sq_flags);
    let mut qsize: u16 = le16_to_cpu(cmd.create_sq.qsize);
    let mut prp1: u64 = le64_to_cpu(cmd.create_sq.prp1);
    u16 status;
    if (!nvmet_is_pci_ctrl(ctrl)) {
    status = nvmet_report_invalid_opcode(req);
    goto complete;
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_delete_cq(req: *mut nvmet_req) {
    static void nvmet_execute_delete_cq(struct nvmet_req *req)
    {
    struct nvmet_ctrl *ctrl = req.sq.ctrl;
    let mut cqid: u16 = le16_to_cpu(req.cmd.delete_queue.qid);
    u16 status;
    if (!nvmet_is_pci_ctrl(ctrl)) {
    status = nvmet_report_invalid_opcode(req);
    goto complete;
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_create_cq(req: *mut nvmet_req) {
    static void nvmet_execute_create_cq(struct nvmet_req *req)
    {
    struct nvmet_ctrl *ctrl = req.sq.ctrl;
    struct nvme_command *cmd = req.cmd;
    let mut cqid: u16 = le16_to_cpu(cmd.create_cq.cqid);
    let mut cq_flags: u16 = le16_to_cpu(cmd.create_cq.cq_flags);
    let mut qsize: u16 = le16_to_cpu(cmd.create_cq.qsize);
    let mut irq_vector: u16 = le16_to_cpu(cmd.create_cq.irq_vector);
    let mut prp1: u64 = le64_to_cpu(cmd.create_cq.prp1);
    u16 status;
    if (!nvmet_is_pci_ctrl(ctrl)) {
    status = nvmet_report_invalid_opcode(req);
    goto complete;
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_get_log_page_len(cmd: *mut nvme_command) -> u32 {
    u32 nvmet_get_log_page_len(struct nvme_command *cmd)
    {
    let mut len: u32 = le16_to_cpu(cmd.get_log_page.numdu);
    len <<= 16;
...
#[no_mangle]
unsafe extern "C" fn nvmet_feat_data_len(req: *mut nvmet_req, cdw10: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_get_log_page_offset(cmd: *mut nvme_command) -> u64 {
    u64 nvmet_get_log_page_offset(struct nvme_command *cmd)
    {
    return le64_to_cpu(cmd.get_log_page.lpo);
    }
#[no_mangle]
unsafe extern "C" fn nvmet_execute_get_log_page_noop(req: *mut nvmet_req) {
    static void nvmet_execute_get_log_page_noop(struct nvmet_req *req)
    {
    nvmet_req_complete(req, nvmet_zero_sgl(req, 0, req.transfer_len));
    }
#[no_mangle]
unsafe extern "C" fn nvmet_execute_get_log_page_error(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_get_supported_log_pages(req: *mut nvmet_req) {
...
// we don't have the right data for file backed ns
    ...
    struct nvme_smart_log *slog)
    {
    let mut host_reads: u64 = 0, host_writes = 0;
    let mut data_units_read: u64 = 0, data_units_written = 0;
    struct nvmet_ns *ns;
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_get_log_page_rmi(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_get_log_page_smart(req: *mut nvmet_req) {
    static void nvmet_execute_get_log_page_smart(struct nvmet_req *req)
    {
    struct nvme_smart_log *log;
    let mut status: u16 = NVME_SC_INTERNAL;
    unsigned long flags;
    if (req.transfer_len != sizeof(*log))
    goto out;
    log = kzalloc_obj(*log);
...
#[no_mangle]
unsafe extern "C" fn nvmet_get_cmd_effects_nvm(log: *mut nvme_effects_log) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_get_cmd_effects_zns(log: *mut nvme_effects_log) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_get_log_cmd_effects_ns(req: *mut nvmet_req) {
    static void nvmet_execute_get_log_cmd_effects_ns(struct nvmet_req *req)
    {
    struct nvmet_ctrl *ctrl = req.sq.ctrl;
    struct nvme_effects_log *log;
    let mut status: u16 = NVME_SC_SUCCESS;
    log = kzalloc_obj(*log);
    if (!log) {
    status = NVME_SC_INTERNAL;
    goto out;
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_get_log_changed_ns(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_get_log_page_endgrp(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_get_log_page_ana(req: *mut nvmet_req) {
    static void nvmet_execute_get_log_page_ana(struct nvmet_req *req)
    {
    let mut hdr: nvme_ana_rsp_hdr = { 0, };
    struct nvme_ana_group_desc *desc;
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_get_log_page_features(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_get_log_page(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_identify_ctrl(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_identify_ns(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_identify_endgrp_list(req: *mut nvmet_req) {
    static void nvmet_execute_identify_endgrp_list(struct nvmet_req *req)
    {
    let mut min_endgid: u16 = le16_to_cpu(req.cmd.identify.cnssid);
    let mut buf_size: static int = NVME_IDENTIFY_DATA_SIZE;
    struct nvmet_ctrl *ctrl = req.sq.ctrl;
    struct nvmet_ns *ns;
    unsigned long idx;
    __le16 *list;
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_identify_nslist(req: *mut nvmet_req, match_css: bool) {
    ...
    struct nvmet_ns *ns;
    unsigned long idx;
    let mut min_nsid: u32 = le32_to_cpu(req.cmd.identify.nsid);
    __le32 *list;
    let mut status: u16 = 0;
    let mut i: c_int = 0;
//
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_identify_desclist(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_identify_ctrl_nvm(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvme_execute_identify_ns_nvm(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_id_cs_indep(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_identify(req: *mut nvmet_req) {
...
//
#[no_mangle]
unsafe extern "C" fn nvmet_execute_abort(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_write_protect_flush_sync(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_set_feat_write_protect(req: *mut nvmet_req) -> u16 {
    static u16 nvmet_set_feat_write_protect(struct nvmet_req *req)
    {
    let mut write_protect: u32 = le32_to_cpu(req.cmd.common.cdw11);
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_set_feat_kato(req: *mut nvmet_req) -> u16 {
    u16 nvmet_set_feat_kato(struct nvmet_req *req)
    {
    let mut val32: u32 = le32_to_cpu(req.cmd.common.cdw11);
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_set_feat_async_event(req: *mut nvmet_req, mask: u32) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_set_feat_host_id(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_set_feat_irq_coalesce(req: *mut nvmet_req) -> u16 {
    static u16 nvmet_set_feat_irq_coalesce(struct nvmet_req *req)
    {
    struct nvmet_ctrl *ctrl = req.sq.ctrl;
    let mut cdw11: u32 = le32_to_cpu(req.cmd.common.cdw11);
...
#[no_mangle]
unsafe extern "C" fn nvmet_set_feat_irq_config(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_set_feat_arbitration(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_execute_set_features(req: *mut nvmet_req) {
    void nvmet_execute_set_features(struct nvmet_req *req)
    {
    struct nvmet_ctrl *ctrl = nvmet_req_ctrl(req);
    let mut cdw10: u32 = le32_to_cpu(req.cmd.common.cdw10);
    let mut cdw11: u32 = le32_to_cpu(req.cmd.common.cdw11);
    let mut status: u16 = 0;
    u16 nsqr;
    u16 ncqr;
...
#[no_mangle]
unsafe extern "C" fn nvmet_get_feat_write_protect(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_get_feat_irq_coalesce(req: *mut nvmet_req) -> u16 {
    static u16 nvmet_get_feat_irq_coalesce(struct nvmet_req *req)
    {
    struct nvmet_ctrl *ctrl = req.sq.ctrl;
    let mut irqc: nvmet_feat_irq_coalesce = { };
    u16 status;
//
// This feature is not supported for fabrics controllers and mandatory
// for PCI controllers.
...
#[no_mangle]
unsafe extern "C" fn nvmet_get_feat_irq_config(req: *mut nvmet_req) -> u16 {
    static u16 nvmet_get_feat_irq_config(struct nvmet_req *req)
    {
    struct nvmet_ctrl *ctrl = req.sq.ctrl;
    let mut iv: u32 = le32_to_cpu(req.cmd.common.cdw11) & 0xffff;
    let mut irqcfg: nvmet_feat_irq_config = { .iv = iv };
    u16 status;
//
// This feature is not supported for fabrics controllers and mandatory
// for PCI controllers.
...
#[no_mangle]
unsafe extern "C" fn nvmet_get_feat_arbitration(req: *mut nvmet_req) -> u16 {
    static u16 nvmet_get_feat_arbitration(struct nvmet_req *req)
    {
    struct nvmet_ctrl *ctrl = req.sq.ctrl;
    let mut arb: nvmet_feat_arbitration = { };
    u16 status;
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_get_feat_kato(req: *mut nvmet_req) {
    void nvmet_get_feat_kato(struct nvmet_req *req)
    {
    nvmet_set_result(req, req.sq.ctrl.kato * 1000);
    }
#[no_mangle]
pub unsafe extern "C" fn nvmet_get_feat_async_event(req: *mut nvmet_req) {
    void nvmet_get_feat_async_event(struct nvmet_req *req)
    {
    nvmet_set_result(req, READ_ONCE(req.sq.ctrl.aen_enabled));
    }
#[no_mangle]
pub unsafe extern "C" fn nvmet_execute_get_features(req: *mut nvmet_req) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_execute_async_event(req: *mut nvmet_req) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_execute_keep_alive(req: *mut nvmet_req) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_admin_cmd_data_len(req: *mut nvmet_req) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_parse_admin_cmd(req: *mut nvmet_req) -> u16 {
