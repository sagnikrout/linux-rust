...
//! Source: drivers/nvme/target/fc.c
#![no_std]
...
pub const NVMET_LS_CTX_COUNT: c_int = 256;
    struct nvmet_fc_tgtport;
    struct nvmet_fc_tgt_assoc;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_fc_ls_iod {
    pub lsrsp: *mut nvmefc_ls_rsp,
    pub /: *mut *mut *mut nvmefc_tgt_fcp_req fcpreq; / only if RS,
    pub /: *mut *mut list_head ls_rcv_list; / tgtport->ls_rcv_list,
    pub tgtport: *mut nvmet_fc_tgtport,
    pub assoc: *mut nvmet_fc_tgt_assoc,
    pub hosthandle: *mut c_void,
    pub rqstbuf: *mut union nvmefc_ls_requests,
    pub rspbuf: *mut union nvmefc_ls_responses,
    pub rqstdatalen: u16,
    pub rspdma: dma_addr_t,
    pub sg: [scatterlist; 2],
    pub work: work_struct,
    pub long)): } __aligned(sizeof(unsigned long,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_fc_ls_req_op {
    pub ls_req: nvmefc_ls_req,
    pub tgtport: *mut nvmet_fc_tgtport,
    pub hosthandle: *mut c_void,
    pub ls_error: c_int,
    pub /: *mut *mut list_head lsreq_list; / tgtport->ls_req_list,
    pub req_queued: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_fc_fcp_iod {
    pub fcpreq: *mut nvmefc_tgt_fcp_req,
    pub cmdiubuf: nvme_fc_cmd_iu,
    pub rspiubuf: nvme_fc_ersp_iu,
    pub rspdma: dma_addr_t,
    pub next_sg: *mut scatterlist,
    pub data_sg: *mut scatterlist,
    pub data_sg_cnt: c_int,
    pub offset: u32,
    pub io_dir: enum nvmet_fcp_datadir,
    pub active: bool,
    pub abort: bool,
    pub aborted: bool,
    pub writedataactive: bool,
    pub flock: spinlock_t,
    pub req: nvmet_req,
    pub defer_work: work_struct,
    pub tgtport: *mut nvmet_fc_tgtport,
    pub queue: *mut nvmet_fc_tgt_queue,
    pub /: *mut *mut list_head fcp_list; / tgtport->fcp_list,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_fc_tgtport {
    pub fc_target_port: nvmet_fc_target_port,
    pub /: *mut *mut list_head tgt_list; / nvmet_fc_target_list,
    pub /: *mut *mut *mut device dev; / dev for dma mapping,
    pub ops: *mut nvmet_fc_target_template,
    pub iod: *mut nvmet_fc_ls_iod,
    pub lock: spinlock_t,
    pub ls_rcv_list: list_head,
    pub ls_req_list: list_head,
    pub ls_busylist: list_head,
    pub assoc_list: list_head,
    pub host_list: list_head,
    pub assoc_cnt: ida,
    pub pe: *mut nvmet_fc_port_entry,
    pub ref: kref,
    pub max_sg_cnt: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_fc_port_entry {
    pub tgtport: *mut nvmet_fc_tgtport,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_fc_defer_fcp_req {
    pub req_list: list_head,
    pub fcp_req: *mut nvmefc_tgt_fcp_req,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_fc_tgt_queue {
    pub ninetypercent: bool,
    pub qid: u16,
    pub sqsize: u16,
    pub ersp_ratio: u16,
    pub sqhd: __le16,
    pub connected: core::sync::atomic::AtomicI32,
    pub sqtail: core::sync::atomic::AtomicI32,
    pub zrspcnt: core::sync::atomic::AtomicI32,
    pub rsn: core::sync::atomic::AtomicI32,
    pub qlock: spinlock_t,
    pub nvme_cq: nvmet_cq,
    pub nvme_sq: nvmet_sq,
    pub assoc: *mut nvmet_fc_tgt_assoc,
    pub fod_list: list_head,
    pub pending_cmd_list: list_head,
    pub avail_defer_list: list_head,
    pub work_q: *mut workqueue_struct,
    pub ref: kref,
// array of fcp_iods
    pub /: *mut *mut nvmet_fc_fcp_iod fod[] / __counted_by(sqsize),
    pub long)): } __aligned(sizeof(unsigned long,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_fc_hostport {
    pub tgtport: *mut nvmet_fc_tgtport,
    pub hosthandle: *mut c_void,
    pub host_list: list_head,
    pub ref: kref,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_fc_tgt_assoc {
    pub association_id: u64,
    pub a_id: u32,
    pub terminating: core::sync::atomic::AtomicI32,
    pub tgtport: *mut nvmet_fc_tgtport,
    pub hostport: *mut nvmet_fc_hostport,
    pub rcv_disconn: *mut nvmet_fc_ls_iod,
    pub a_list: list_head,
    pub 1]: *mut *mut nvmet_fc_tgt_queue queues[NVMET_NR_QUEUES +,
    pub ref: kref,
...
#[no_mangle]
unsafe extern "C" fn nvmet_fc_put_lsop_work(work: *mut work_struct) {
...
//
    ...
    lsreq.private = core::ptr::null_mut();
...
// Submit deferred IO for processing
    ...
    sizeof(fod.rspiubuf), DMA_TO_DEVICE);
    fcpreq.nvmet_fc_private = core::ptr::null_mut();
    fod.active = false;
    fod.abort = false;
    fod.aborted = false;
...
// Setup new fcpreq to be processed
    fcpreq.rspaddr = core::ptr::null_mut();
    fcpreq.rsplen  = 0;
...
// release the queue lookup reference
    ...
    struct nvmet_fc_tgt_queue *queue;
    let mut association_id: u64 = nvmet_fc_getassociationid(connection_id);
    let mut qid: u16 = nvmet_fc_getqueueid(connection_id);
    if (qid > NVMET_NR_QUEUES)
    return core::ptr::null_mut();
    rcu_read_lock();
    ...
    {
    struct nvmet_fc_hostport *newhost, *match = core::ptr::null_mut();
    unsigned long flags;
//
...
// ensure all in-flight I/Os have been processed
    ...
    {
    struct nvmet_fc_tgt_assoc *assoc;
    struct nvmet_fc_tgt_assoc *ret = core::ptr::null_mut();
    rcu_read_lock();
    list_for_each_entry_rcu(assoc, &tgtport.assoc_list, a_list) {
    if (association_id == assoc.association_id) {
    ret = assoc;
    ...
    pe.tgtport.pe = core::ptr::null_mut();
    }
    list_del(&pe.pe_list);
...
//
    ...
    if (pe) {
    nvmet_fc_tgtport_put(pe.tgtport);
    pe.tgtport = core::ptr::null_mut();
    }
    tgtport.pe = core::ptr::null_mut();
    spin_unlock_irqrestore(&nvmet_fc_tgtlock, flags);
    }
//
...
//
    ...
    newrec.fc_target_port.private = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(cpu_to_be32(FCNVME_LSDESC_ASSOC_ID): rqst->associd.desc_tag !=) -> else {
...
//
    ...
    struct nvmet_fc_tgt_assoc *assoc = core::ptr::null_mut();
    struct nvmet_fc_ls_iod *oldls = core::ptr::null_mut();
    unsigned long flags;
    let mut ret: c_int = 0;
    memset(acc, 0, sizeof(*acc));
...
// no need to take lock - lock was taken earlier to get here
    ...
    unsigned long flags;
    let mut remaininglen: u32 = fod.req.transfer_len - fod.offset;
    let mut tlen: u32 = 0;
    int ret;
    fcpreq.op = op;
...
//
    ...
    let mut xfrlen: u32 = be32_to_cpu(cmdiu.data_len);
    int ret;
//
...
//
    ...
    let mut wwn: substring_t = { name, &name[sizeof(name)-1] };
...
// validate if string is one of the 2 allowed formats
    ...
    struct nvmet_fc_tgtport *tgtport;
    struct nvmet_fc_port_entry *pe;
    let mut traddr: nvmet_fc_traddr = { 0L, 0L };
    unsigned long flags;
    int ret;
...
// a FC port can only be 1 nvmet port id
    ...
    struct nvmet_fc_tgtport *tgtport = core::ptr::null_mut();
    unsigned long flags;
    spin_lock_irqsave(&nvmet_fc_tgtlock, flags);
...
// terminate any outstanding associations
    ...
    struct nvmet_fc_tgtport *tgtport = queue.assoc ? queue.assoc.tgtport : core::ptr::null_mut();
    struct nvmet_fc_hostport *hostport = queue.assoc ? queue.assoc.hostport : core::ptr::null_mut();
    u64 wwnn, wwpn;
    let mut ret: isize = 0;
...
#[no_mangle]
unsafe extern "C" fn nvmet_fc_init_module() -> int __init {
    static int __init nvmet_fc_init_module(void)
    {
    return nvmet_register_transport(&nvmet_fc_tgt_fcp_ops);
    }
#[no_mangle]
unsafe extern "C" fn nvmet_fc_exit_module() -> void __exit {
