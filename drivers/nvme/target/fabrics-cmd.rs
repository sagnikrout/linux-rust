...
//! Source: drivers/nvme/target/fabrics-cmd.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_prop_set(req: *mut nvmet_req) {
    static void nvmet_execute_prop_set(struct nvmet_req *req)
    {
    let mut val: u64 = le64_to_cpu(req.cmd.prop_set.value);
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_prop_get(req: *mut nvmet_req) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_fabrics_admin_cmd_data_len(req: *mut nvmet_req) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_parse_fabrics_admin_cmd(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_fabrics_io_cmd_data_len(req: *mut nvmet_req) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_parse_fabrics_io_cmd(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_install_queue(ctrl: *mut nvmet_ctrl, req: *mut nvmet_req) -> u16 {
    static u16 nvmet_install_queue(struct nvmet_ctrl *ctrl, struct nvmet_req *req)
    {
    struct nvmf_connect_command *c = &req.cmd.connect;
    let mut qid: u16 = le16_to_cpu(c.qid);
    let mut sqsize: u16 = le16_to_cpu(c.sqsize);
    struct nvmet_ctrl *old;
    let mut mqes: u16 = NVME_CAP_MQES(ctrl.cap);
    u16 ret;
    if (!sqsize) {
    ...
    if (ctrl.sqs[qid] != core::ptr::null_mut()) {
...
// for fabrics, this value applies to only the I/O Submission Queues
    ...
    old = cmpxchg(&req.sq.ctrl, core::ptr::null_mut(), ctrl);
    if (old) {
    ...
    kref_get(&ctrl.ref);
    old = cmpxchg(&req.cq.ctrl, core::ptr::null_mut(), ctrl);
    if (old) {
    pr_warn("queue already connected!\n");
    req.error_loc = offsetof(struct nvmf_connect_command, opcode);
    return NVME_SC_CONNECT_CTRL_BUSY | NVME_STATUS_DNR;
...
// note: convert queue size from 0's-based value to 1's-based value
    ...
    qid, ctrl.cntlid, ret);
    ctrl.sqs[qid] = core::ptr::null_mut();
    goto err;
    }
    }
    return 0;
    err:
    req.sq.ctrl = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn nvmet_connect_result(ctrl: *mut nvmet_ctrl, sq: *mut nvmet_sq) -> u32 {
    static u32 nvmet_connect_result(struct nvmet_ctrl *ctrl, struct nvmet_sq *sq)
    {
    let mut needs_auth: bool = nvmet_has_auth(ctrl, sq);
    let mut keyid: key_serial_t = nvmet_queue_tls_keyid(sq);
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_admin_connect(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_io_connect(req: *mut nvmet_req) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_connect_cmd_data_len(req: *mut nvmet_req) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_parse_connect_cmd(req: *mut nvmet_req) -> u16 {
