...
//! Source: drivers/nvme/target/auth.c
#![no_std]
...
//
    ...
    host.dhchap_ctrl_secret = core::ptr::null_mut();
    host.dhchap_ctrl_key_hash = 0;
    } else {
    kfree(host.dhchap_secret);
    host.dhchap_secret = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_setup_dhgroup(ctrl: *mut nvmet_ctrl, dhgroup_id: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_setup_auth(ctrl: *mut nvmet_ctrl, sq: *mut nvmet_sq, reset: bool) -> u8 {
    u8 nvmet_setup_auth(struct nvmet_ctrl *ctrl, struct nvmet_sq *sq, bool reset)
    {
    let mut ret: c_int = 0;
    struct nvmet_host_link *p;
    struct nvmet_host *host = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_auth_sq_free(sq: *mut nvmet_sq) {
    void nvmet_auth_sq_free(struct nvmet_sq *sq)
    {
    cancel_delayed_work(&sq.auth_expired_work);
    kfree(sq.dhchap_c1);
    sq.dhchap_c1 = core::ptr::null_mut();
    kfree(sq.dhchap_c2);
    sq.dhchap_c2 = core::ptr::null_mut();
    kfree(sq.dhchap_skey);
    sq.dhchap_skey = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn nvmet_auth_sq_destroy(sq: *mut nvmet_sq) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_destroy_auth(ctrl: *mut nvmet_ctrl) {
    ...
    ctrl.tls_key = core::ptr::null_mut();
    }

    }
#[no_mangle]
pub unsafe extern "C" fn nvmet_check_auth_status(req: *mut nvmet_req) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_auth_insert_psk(sq: *mut nvmet_sq) {
    void nvmet_auth_insert_psk(struct nvmet_sq *sq)
    {
    let mut hash_len: c_int = nvme_auth_hmac_hash_len(sq.ctrl.shash_id);
    u8 *psk, *tls_psk;
    char *digest;
    size_t psk_len;
    int ret;

    struct key *tls_key = core::ptr::null_mut();
    ...
    tls_key = nvme_tls_psk_refresh(core::ptr::null_mut(), sq.ctrl.hostnqn,
    sq.ctrl.subsys.subsysnqn,
