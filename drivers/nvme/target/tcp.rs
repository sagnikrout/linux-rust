...
//! Source: drivers/nvme/target/tcp.c
#![no_std]
...
pub const NVMET_TCP_MAXH2CDATA: c_uint = 0x400000 /* 16M arbitrary limit */;
pub const NVMET_TCP_BACKLOG: c_int = 128;
#[no_mangle]
unsafe extern "C" fn param_store_val(str: *const c_char, val: *mut c_int, min: c_int, max: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_params(str: *const c_char, kp: *const kernel_param) -> c_int {
...
pub const NVMET_TCP_RECV_BUDGET: c_int = 8;
pub const NVMET_TCP_SEND_BUDGET: c_int = 8;
pub const NVMET_TCP_IO_WORK_BUDGET: c_int = 64;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_tcp_cmd {
    pub queue: *mut nvmet_tcp_queue,
    pub req: nvmet_req,
    pub cmd_pdu: *mut nvme_tcp_cmd_pdu,
    pub rsp_pdu: *mut nvme_tcp_rsp_pdu,
    pub data_pdu: *mut nvme_tcp_data_pdu,
    pub r2t_pdu: *mut nvme_tcp_r2t_pdu,
    pub rbytes_done: u32,
    pub wbytes_done: u32,
    pub pdu_len: u32,
    pub pdu_recv: u32,
    pub sg_idx: c_int,
    pub recv_cbuf: [c_char; CMSG_LEN(sizeof(char))],
    pub recv_msg: msghdr,
    pub iov: *mut bio_vec,
    pub flags: u32,
    pub entry: list_head,
...
// send state
    ...
    pub state: enum nvmet_tcp_send_state,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_tcp_queue {
    pub sock: *mut socket,
    pub port: *mut nvmet_tcp_port,
    pub io_work: work_struct,
    pub nvme_cq: nvmet_cq,
    pub nvme_sq: nvmet_sq,
    pub kref: kref,
// send state
    pub cmds: *mut nvmet_tcp_cmd,
    pub nr_cmds: c_uint,
    pub free_list: list_head,
    pub resp_list: llist_head,
    pub resp_send_list: list_head,
    pub send_list_len: c_int,
    pub snd_cmd: *mut nvmet_tcp_cmd,
// recv state
    pub offset: c_int,
    pub left: c_int,
    pub rcv_state: enum nvmet_tcp_recv_state,
    pub cmd: *mut nvmet_tcp_cmd,
    pub pdu: union nvme_tcp_pdu,
// digest state
    pub hdr_digest: bool,
    pub data_digest: bool,
// TLS state
    pub tls_pskid: key_serial_t,
    pub tls_handshake_tmo_work: delayed_work,
    pub poll_end: c_ulong,
    pub state_lock: spinlock_t,
    pub state: enum nvmet_tcp_queue_state,
    pub sockaddr: sockaddr_storage,
    pub sockaddr_peer: sockaddr_storage,
    pub release_work: work_struct,
    pub idx: c_int,
    pub queue_list: list_head,
    pub connect: nvmet_tcp_cmd,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvmet_tcp_port {
    pub sock: *mut socket,
    pub accept_work: work_struct,
    pub nport: *mut nvmet_port,
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_tcp_has_data_in(cmd: *mut nvmet_tcp_cmd) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_tcp_need_data_in(cmd: *mut nvmet_tcp_cmd) -> bool {
    static inline bool nvmet_tcp_need_data_in(struct nvmet_tcp_cmd *cmd)
    {
    return nvmet_tcp_has_data_in(cmd) && !cmd.req.cqe.status;
    }
#[no_mangle]
pub unsafe extern "C" fn nvmet_tcp_need_data_out(cmd: *mut nvmet_tcp_cmd) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_tcp_has_inline_data(cmd: *mut nvmet_tcp_cmd) -> bool {
    ...
    cmd.pdu_len = 0;
    cmd.pdu_recv = 0;
    cmd.iov = core::ptr::null_mut();
    cmd.flags = 0;
    return cmd;
    }
#[no_mangle]
pub unsafe extern "C" fn nvmet_tcp_put_cmd(cmd: *mut nvmet_tcp_cmd) {
...
#[no_mangle]
pub unsafe extern "C" fn queue_cpu(queue: *mut nvmet_tcp_queue) -> c_int {
    static inline int queue_cpu(struct nvmet_tcp_queue *queue)
    {
    return queue.sock.sk.sk_incoming_cpu;
    }
#[no_mangle]
pub unsafe extern "C" fn nvmet_tcp_hdgst_len(queue: *mut nvmet_tcp_queue) -> u8 {
    static inline u8 nvmet_tcp_hdgst_len(struct nvmet_tcp_queue *queue)
    {
    return queue.hdr_digest ? NVME_TCP_DIGEST_LENGTH : 0;
    }
#[no_mangle]
pub unsafe extern "C" fn nvmet_tcp_ddgst_len(queue: *mut nvmet_tcp_queue) -> u8 {
    static inline u8 nvmet_tcp_ddgst_len(struct nvmet_tcp_queue *queue)
    {
    return queue.data_digest ? NVME_TCP_DIGEST_LENGTH : 0;
    }
#[no_mangle]
pub unsafe extern "C" fn nvmet_tcp_hdgst(pdu: *mut c_void, len: usize) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_check_ddgst(queue: *mut nvmet_tcp_queue, pdu: *mut c_void) -> c_int {
    static int nvmet_tcp_check_ddgst(struct nvmet_tcp_queue *queue, void *pdu)
    {
    struct nvme_tcp_hdr *hdr = pdu;
    let mut digest_len: u8 = nvmet_tcp_hdgst_len(queue);
    u32 len;
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_free_cmd_buffers(cmd: *mut nvmet_tcp_cmd) {
    static void nvmet_tcp_free_cmd_buffers(struct nvmet_tcp_cmd *cmd)
    {
    kfree(cmd.iov);
    sgl_free(cmd.req.sg);
    cmd.iov = core::ptr::null_mut();
    cmd.req.sg = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_build_pdu_iovec(cmd: *mut nvmet_tcp_cmd) -> c_int {
    ...
    return -EPROTO;
    let mut iov_len: u32 = min_t(u32, length, sg.length - sg_offset);
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_socket_error(queue: *mut nvmet_tcp_queue, status: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_map_data(cmd: *mut nvmet_tcp_cmd) -> c_int {
    static int nvmet_tcp_map_data(struct nvmet_tcp_cmd *cmd)
    {
    struct nvme_sgl_desc *sgl = &cmd.req.cmd.common.dptr.sgl;
    let mut len: u32 = le32_to_cpu(sgl.length);
    if (!len)
    return 0;
//
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_calc_ddgst(cmd: *mut nvmet_tcp_cmd) {
    static void nvmet_tcp_calc_ddgst(struct nvmet_tcp_cmd *cmd)
    {
    let mut total_len: usize = cmd.req.transfer_len;
    struct scatterlist *sg = cmd.req.sg;
    let mut crc: u32 = ~0;
    while (total_len) {
    let mut len: usize = min_t(size_t, total_len, sg.length);
//
...
#[no_mangle]
unsafe extern "C" fn nvmet_setup_c2h_data_pdu(cmd: *mut nvmet_tcp_cmd) {
    static void nvmet_setup_c2h_data_pdu(struct nvmet_tcp_cmd *cmd)
    {
    struct nvme_tcp_data_pdu *pdu = cmd.data_pdu;
    struct nvmet_tcp_queue *queue = cmd.queue;
    let mut hdgst: u8 = nvmet_tcp_hdgst_len(cmd.queue);
    let mut ddgst: u8 = nvmet_tcp_ddgst_len(cmd.queue);
    cmd.offset = 0;
...
#[no_mangle]
unsafe extern "C" fn nvmet_setup_r2t_pdu(cmd: *mut nvmet_tcp_cmd) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_setup_response_pdu(cmd: *mut nvmet_tcp_cmd) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_process_resp_list(queue: *mut nvmet_tcp_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: nvmet_tcp_need_data_in(queue->snd_cmd)) -> else {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_queue_response(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_execute_request(cmd: *mut nvmet_tcp_cmd) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_try_send_data_pdu(cmd: *mut nvmet_tcp_cmd) -> c_int {
    ...
    struct bio_vec bvec;
    let mut hdgst: u8 = nvmet_tcp_hdgst_len(cmd.queue);
    let mut left: c_int = sizeof(*cmd.data_pdu) - cmd.offset + hdgst;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn nvmet_try_send_data(cmd: *mut nvmet_tcp_cmd, last_in_batch: bool) -> c_int {
    ...
    struct bio_vec bvec;
    let mut left: u32 = cmd.cur_sg.length - cmd.offset;
...
// Done with sg?
    ...
    cmd.queue.snd_cmd = core::ptr::null_mut();
    ...
    struct bio_vec bvec;
    let mut hdgst: u8 = nvmet_tcp_hdgst_len(cmd.queue);
    let mut left: c_int = sizeof(*cmd.rsp_pdu) - cmd.offset + hdgst;
    int ret;
    if (!last_in_batch && cmd.queue.send_list_len)
    msg.msg_flags |= MSG_MORE;
    else
...
#[no_mangle]
unsafe extern "C" fn nvmet_try_send_r2t(cmd: *mut nvmet_tcp_cmd, last_in_batch: bool) -> c_int {
    static int nvmet_try_send_r2t(struct nvmet_tcp_cmd *cmd, bool last_in_batch)
    {
    let mut msg: msghdr = { .msg_flags = MSG_DONTWAIT | MSG_SPLICE_PAGES, };
    struct bio_vec bvec;
    let mut hdgst: u8 = nvmet_tcp_hdgst_len(cmd.queue);
    let mut left: c_int = sizeof(*cmd.r2t_pdu) - cmd.offset + hdgst;
    int ret;
    if (!last_in_batch && cmd.queue.send_list_len)
    msg.msg_flags |= MSG_MORE;
    else
...
#[no_mangle]
unsafe extern "C" fn nvmet_try_send_ddgst(cmd: *mut nvmet_tcp_cmd, last_in_batch: bool) -> c_int {
    static int nvmet_try_send_ddgst(struct nvmet_tcp_cmd *cmd, bool last_in_batch)
    {
    struct nvmet_tcp_queue *queue = cmd.queue;
    let mut left: c_int = NVME_TCP_DIGEST_LENGTH - cmd.offset;
...
#[no_mangle]
unsafe extern "C" fn nvmet_prepare_receive_pdu(queue: *mut nvmet_tcp_queue) {
    static void nvmet_prepare_receive_pdu(struct nvmet_tcp_queue *queue)
    {
    queue.offset = 0;
    queue.left = sizeof(struct nvme_tcp_hdr);
    WRITE_ONCE(queue.cmd, core::ptr::null_mut());
// Ensure rcv_state is visible only after queue->cmd is set
    smp_store_release(&queue.rcv_state, NVMET_TCP_RECV_PDU);
    }
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_handle_icreq(queue: *mut nvmet_tcp_queue) -> c_int {
...
// Tell nvmet_tcp_socket_error() teardown is in progress.
    ...
    {
    let mut data_len: usize = le32_to_cpu(req.cmd.common.dptr.sgl.length);
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_handle_h2c_data_pdu(queue: *mut nvmet_tcp_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_done_recv_pdu(queue: *mut nvmet_tcp_queue) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_tcp_pdu_size(type: u8) -> u8 {
    static inline u8 nvmet_tcp_pdu_size(u8 type)
    {
    let mut idx: usize = type;
    return (idx < ARRAY_SIZE(nvme_tcp_pdu_sizes) &&
    nvme_tcp_pdu_sizes[idx]) ?
    nvme_tcp_pdu_sizes[idx] : 0;
    }
#[no_mangle]
pub unsafe extern "C" fn nvmet_tcp_pdu_valid(type: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_try_recv_pdu(queue: *mut nvmet_tcp_queue) -> c_int {
    ...
    let mut hdgst: u8 = nvmet_tcp_hdgst_len(queue);
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_prep_recv_ddgst(cmd: *mut nvmet_tcp_cmd) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_try_recv_data(queue: *mut nvmet_tcp_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_try_recv_ddgst(queue: *mut nvmet_tcp_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_try_recv_one(queue: *mut nvmet_tcp_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_release_queue(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_schedule_release_queue(queue: *mut nvmet_tcp_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_tcp_arm_queue_deadline(queue: *mut nvmet_tcp_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_io_work(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_free_cmd(c: *mut nvmet_tcp_cmd) {
    static void nvmet_tcp_free_cmd(struct nvmet_tcp_cmd *c)
    {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_alloc_cmds(queue: *mut nvmet_tcp_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_free_cmds(queue: *mut nvmet_tcp_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_restore_socket_callbacks(queue: *mut nvmet_tcp_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_uninit_data_in_cmds(queue: *mut nvmet_tcp_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_free_cmd_data_in_buffers(queue: *mut nvmet_tcp_queue) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_release_queue_work(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_data_ready(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_write_space(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_state_change(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_set_queue_sock(queue: *mut nvmet_tcp_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_try_peek_pdu(queue: *mut nvmet_tcp_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_tls_handshake_timeout(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_tls_handshake(queue: *mut nvmet_tcp_queue) -> c_int {
    ...
    {
    struct nvmet_tcp_queue *queue;
    struct file *sock_file = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_accept_work(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_listen_data_ready(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_add_port(nport: *mut nvmet_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_destroy_port_queues(port: *mut nvmet_tcp_port) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_remove_port(nport: *mut nvmet_port) {
    static void nvmet_tcp_remove_port(struct nvmet_port *nport)
    {
    struct nvmet_tcp_port *port = nport.priv;
    write_lock_bh(&port.sock.sk.sk_callback_lock);
    port.sock.sk.sk_data_ready = port.data_ready;
    port.sock.sk.sk_user_data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_delete_ctrl(ctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_install_queue(sq: *mut nvmet_sq) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nvmet_tcp_exit() -> void __exit {
