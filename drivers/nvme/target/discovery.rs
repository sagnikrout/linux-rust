...
//! Source: drivers/nvme/target/discovery.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_referral_enable(parent: *mut nvmet_port, port: *mut nvmet_port) {
    ...
    port.enabled = true;
    nvmet_port_disc_changed(parent, core::ptr::null_mut());
    }
    up_write(&nvmet_config_sem);
    }
#[no_mangle]
pub unsafe extern "C" fn nvmet_referral_disable(parent: *mut nvmet_port, port: *mut nvmet_port) {
...
#[no_mangle]
unsafe extern "C" fn discovery_log_entries(req: *mut nvmet_req) -> usize {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_disc_get_log_page(req: *mut nvmet_req) {
    static void nvmet_execute_disc_get_log_page(struct nvmet_req *req)
    {
    let mut entry_size: c_int = sizeof(struct nvmf_disc_rsp_page_entry);
    struct nvmet_ctrl *ctrl = req.sq.ctrl;
    struct nvmf_disc_rsp_page_hdr *hdr;
    let mut offset: u64 = nvmet_get_log_page_offset(req.cmd);
    let mut data_len: usize = nvmet_get_log_page_len(req.cmd);
    size_t alloc_len;
    size_t copy_len;
    struct nvmet_subsys_link *p;
    struct nvmet_port *r;
    let mut numrec: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_disc_identify(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_disc_set_features(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_disc_get_features(req: *mut nvmet_req) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_discovery_cmd_data_len(req: *mut nvmet_req) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_parse_discovery_cmd(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_init_discovery() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_exit_discovery() {
