...
//! Source: drivers/nvme/target/pr.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_pr_parse_ignore_key(cdw10: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_set_feat_resv_notif_mask(req: *mut nvmet_req, mask: u32) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_get_feat_resv_notif_mask(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_execute_get_log_page_resv(req: *mut nvmet_req) {
    void nvmet_execute_get_log_page_resv(struct nvmet_req *req)
    {
    struct nvmet_pr_log_mgr *log_mgr = &req.sq.ctrl.pr_log_mgr;
    let mut next_log: nvme_pr_log = {0};
    let mut log: nvme_pr_log = {0};
...
#[no_mangle]
unsafe extern "C" fn nvmet_pr_resv_released(pr: *mut nvmet_pr, hostid: *mut uuid_t) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pr_resv_preempted(pr: *mut nvmet_pr, hostid: *mut uuid_t) {
    ...
    let mut status: u16 = NVME_SC_SUCCESS;
    let mut nrkey: u64 = le64_to_cpu(d.nrkey);
    new = kmalloc_obj(*new);
    if (!new)
    ...
    rcu_assign_pointer(pr.holder, core::ptr::null_mut());
    ...
    bool ignore_key)
    {
    let mut status: u16 = NVME_SC_RESERVATION_CONFLICT | NVME_STATUS_DNR;
    struct nvmet_ctrl *ctrl = req.sq.ctrl;
    struct nvmet_pr *pr = &req.ns.pr;
    struct nvmet_pr_registrant *reg;
    down(&pr.pr_sem);
    ...
    struct nvmet_ctrl *ctrl = req.sq.ctrl;
    struct nvmet_pr *pr = &req.ns.pr;
    struct nvmet_pr_registrant *reg, *new = core::ptr::null_mut();
    let mut nrkey: u64 = le64_to_cpu(d.nrkey);
    if (ignore_key && nrkey) {
    new = kzalloc_obj(*new);
    if (!new)
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_pr_register(req: *mut nvmet_req) {
    static void nvmet_execute_pr_register(struct nvmet_req *req)
    {
    let mut cdw10: u32 = le32_to_cpu(req.cmd.common.cdw10);
    let mut ignore_key: bool = nvmet_pr_parse_ignore_key(cdw10);
    struct nvmet_pr_register_data *d;
...
#[no_mangle]
unsafe extern "C" fn nvmet_pr_confirm_ns_pc_ref(ref: *mut percpu_ref) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pr_set_ctrl_to_abort(req: *mut nvmet_req, hostid: *mut uuid_t) {
    ...
    let mut prkey: u64 = le64_to_cpu(d.prkey);
    u16 status;
    holder = rcu_dereference_protected(pr.holder, 1);
    if (!holder)
...
#[no_mangle]
unsafe extern "C" fn nvmet_pr_do_abort(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_pr_acquire(req: *mut nvmet_req) {
    static void nvmet_execute_pr_acquire(struct nvmet_req *req)
    {
    let mut cdw10: u32 = le32_to_cpu(req.cmd.common.cdw10);
    let mut ignore_key: bool = nvmet_pr_parse_ignore_key(cdw10);
// Reservation type, bit 15:08
    let mut rtype: u8 = (u8)((cdw10 >> 8) & 0xff);
// Reservation acquire action, bit 02:00
    let mut acquire_act: u8 = cdw10 & 0x07;
    struct nvmet_ctrl *ctrl = req.sq.ctrl;
    struct nvmet_pr_acquire_data *d = core::ptr::null_mut();
    struct nvmet_pr *pr = &req.ns.pr;
    struct nvmet_pr_registrant *reg;
    let mut status: u16 = NVME_SC_SUCCESS;
    if (ignore_key ||
...
#[no_mangle]
unsafe extern "C" fn nvmet_pr_clear(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_pr_release(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_execute_pr_report(req: *mut nvmet_req) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_parse_pr_cmd(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_is_req_write_cmd_group(req: *mut nvmet_req) -> bool {
    static bool nvmet_is_req_write_cmd_group(struct nvmet_req *req)
    {
    let mut opcode: u8 = req.cmd.common.opcode;
    if (req.sq.qid) {
    switch (opcode) {
    case nvme_cmd_flush:
    case nvme_cmd_write:
...
#[no_mangle]
unsafe extern "C" fn nvmet_is_req_read_cmd_group(req: *mut nvmet_req) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_pr_check_cmd_access(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_pr_get_ns_pc_ref(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_pr_ctrl_ns_all_cmds_done(ref: *mut percpu_ref) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_ctrl_init_pr(ctrl: *mut nvmet_ctrl) -> c_int {
    int nvmet_ctrl_init_pr(struct nvmet_ctrl *ctrl)
    {
    struct nvmet_subsys *subsys = ctrl.subsys;
    struct nvmet_pr_per_ctrl_ref *pc_ref;
    struct nvmet_ns *ns = core::ptr::null_mut();
    unsigned long idx;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_ctrl_destroy_pr(ctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_pr_init_ns(ns: *mut nvmet_ns) -> c_int {
    ...
    unsigned long idx;
    int ret;
    ns.pr.holder = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_pr_exit_ns(ns: *mut nvmet_ns) {
