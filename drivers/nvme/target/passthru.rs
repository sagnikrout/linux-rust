...
//! Source: drivers/nvme/target/passthru.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_passthrough_override_cap(ctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_passthru_override_id_descs(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_passthru_override_id_ctrl(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_passthru_override_id_ns(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_passthru_execute_cmd_work(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_passthru_map_sg(req: *mut nvmet_req, rq: *mut request) -> c_int {
    ...
    bio_init(bio, core::ptr::null_mut(), req.inline_bvec,
    ARRAY_SIZE(req.inline_bvec), req_op(rq));
    } else {
    bio = bio_alloc(core::ptr::null_mut(), bio_max_segs(req.sg_cnt), req_op(rq),
    GFP_KERNEL);
...
#[no_mangle]
unsafe extern "C" fn nvmet_passthru_execute_cmd(req: *mut nvmet_req) {
    static void nvmet_passthru_execute_cmd(struct nvmet_req *req)
    {
    struct nvme_ctrl *ctrl = nvmet_req_subsys(req).passthru_ctrl;
    struct request_queue *q = ctrl.admin_q;
    struct nvme_ns *ns = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn nvmet_passthru_set_host_behaviour(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_setup_passthru_command(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_parse_passthru_io_cmd(req: *mut nvmet_req) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn nvmet_passthru_get_set_features(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_parse_passthru_admin_cmd(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_passthru_ctrl_enable(subsys: *mut nvmet_subsys) -> c_int {
    ...
    old = xa_cmpxchg(&passthru_subsystems, ctrl.instance, core::ptr::null_mut(),
    subsys, GFP_KERNEL);
    if (xa_is_err(old)) {
    ret = xa_err(old);
    goto out_put_file;
    ...
    ret = 0;
    out_put_file:
    filp_close(file, core::ptr::null_mut());
    out_unlock:
    mutex_unlock(&subsys.lock);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn __nvmet_passthru_ctrl_disable(subsys: *mut nvmet_subsys) {
    ...
    subsys.passthru_ctrl = core::ptr::null_mut();
    subsys.ver = NVMET_DEFAULT_VS;
    }
#[no_mangle]
pub unsafe extern "C" fn nvmet_passthru_ctrl_disable(subsys: *mut nvmet_subsys) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_passthru_subsys_free(subsys: *mut nvmet_subsys) {
