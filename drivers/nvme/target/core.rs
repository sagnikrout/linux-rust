...
//! Source: drivers/nvme/target/core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn errno_to_nvme_status(req: *mut nvmet_req, errno: c_int) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_report_invalid_opcode(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_copy_from_sgl(req: *mut nvmet_req, off: off_t, buf: *mut c_void, len: usize) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_zero_sgl(req: *mut nvmet_req, off: off_t, len: usize) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_max_nsid(subsys: *mut nvmet_subsys) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_async_event_result(aen: *mut nvmet_async_event) -> u32 {
    static u32 nvmet_async_event_result(struct nvmet_async_event *aen)
    {
    return aen.event_type | (aen.event_info << 8) | (aen.log_page << 16);
    }
#[no_mangle]
unsafe extern "C" fn nvmet_async_events_failall(ctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_async_events_process(ctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_async_events_free(ctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_async_event_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_add_to_changed_ns_log(ctrl: *mut nvmet_ctrl, nsid: __le32) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_ns_changed(subsys: *mut nvmet_subsys, nsid: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_port_send_ana_event(port: *mut nvmet_port) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_register_transport(ops: *const nvmet_fabrics_ops) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_unregister_transport(ops: *const nvmet_fabrics_ops) {
    void nvmet_unregister_transport(const struct nvmet_fabrics_ops *ops)
    {
    down_write(&nvmet_config_sem);
    nvmet_transports[ops.type] = core::ptr::null_mut();
    up_write(&nvmet_config_sem);
    }
    EXPORT_SYMBOL_GPL(nvmet_unregister_transport);
#[no_mangle]
pub unsafe extern "C" fn nvmet_port_del_ctrls(port: *mut nvmet_port, subsys: *mut nvmet_subsys) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_enable_port(port: *mut nvmet_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_disable_port(port: *mut nvmet_port) {
    void nvmet_disable_port(struct nvmet_port *port)
    {
    const struct nvmet_fabrics_ops *ops;
    lockdep_assert_held(&nvmet_config_sem);
    port.enabled = false;
    port.tr_ops = core::ptr::null_mut();
    ops = nvmet_transports[port.disc_addr.trtype];
    ops.remove_port(port);
    module_put(ops.owner);
    }
#[no_mangle]
unsafe extern "C" fn nvmet_keep_alive_timer(work: *mut work_struct) {
    static void nvmet_keep_alive_timer(struct work_struct *work)
    {
    struct nvmet_ctrl *ctrl = container_of(to_delayed_work(work),
    struct nvmet_ctrl, ka_work);
    let mut reset_tbkas: bool = ctrl.reset_tbkas;
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_start_keep_alive_timer(ctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_stop_keep_alive_timer(ctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_req_find_ns(req: *mut nvmet_req) -> u16 {
    u16 nvmet_req_find_ns(struct nvmet_req *req)
    {
    let mut nsid: u32 = le32_to_cpu(req.cmd.common.nsid);
...
#[no_mangle]
unsafe extern "C" fn nvmet_destroy_namespace(ref: *mut percpu_ref) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_put_namespace(ns: *mut nvmet_ns) {
    void nvmet_put_namespace(struct nvmet_ns *ns)
    {
    percpu_ref_put(&ns.ref);
    }
#[no_mangle]
unsafe extern "C" fn nvmet_ns_dev_disable(ns: *mut nvmet_ns) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_p2pmem_ns_enable(ns: *mut nvmet_ns) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_ns_revalidate(ns: *mut nvmet_ns) -> bool {
    bool nvmet_ns_revalidate(struct nvmet_ns *ns)
    {
    let mut oldsize: loff_t = ns.size;
    if (ns.bdev)
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_ns_enable(ns: *mut nvmet_ns) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_ns_disable(ns: *mut nvmet_ns) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_ns_free(ns: *mut nvmet_ns) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_update_sq_head(req: *mut nvmet_req) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_set_error(req: *mut nvmet_req, status: u16) {
...
#[no_mangle]
unsafe extern "C" fn __nvmet_req_complete(req: *mut nvmet_req, status: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_req_complete(req: *mut nvmet_req, status: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_cq_init(cq: *mut nvmet_cq) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_cq_get(cq: *mut nvmet_cq) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_cq_put(cq: *mut nvmet_cq) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_cq_destroy(cq: *mut nvmet_cq) {
    void nvmet_cq_destroy(struct nvmet_cq *cq)
    {
    struct nvmet_ctrl *ctrl = cq.ctrl;
    if (ctrl) {
    ctrl.cqs[cq.qid] = core::ptr::null_mut();
    nvmet_ctrl_put(cq.ctrl);
    cq.ctrl = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn nvmet_confirm_sq(ref: *mut percpu_ref) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_check_cqid(ctrl: *mut nvmet_ctrl, cqid: u16, create: bool) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_check_io_cqid(ctrl: *mut nvmet_ctrl, cqid: u16, create: bool) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_cq_in_use(cq: *mut nvmet_cq) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_sq_destroy(sq: *mut nvmet_sq) {
...
//
    ...
    sq.ctrl.sqs[sq.qid] = core::ptr::null_mut();
    nvmet_ctrl_put(ctrl);
    sq.ctrl = core::ptr::null_mut(); /* allows reusing the queue later */
    }
    }
    EXPORT_SYMBOL_GPL(nvmet_sq_destroy);
#[no_mangle]
unsafe extern "C" fn nvmet_sq_free(ref: *mut percpu_ref) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_sq_init(sq: *mut nvmet_sq, cq: *mut nvmet_cq) -> c_int {
    ...
    struct nvmet_ns *ns)
    {
    let mut state: enum nvme_ana_state = port.ana_state[ns.anagrpid];
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_io_cmd_check_access(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn nvmet_io_cmd_transfer_len(req: *mut nvmet_req) -> u32 {
    static u32 nvmet_io_cmd_transfer_len(struct nvmet_req *req)
    {
    struct nvme_command *cmd = req.cmd;
    let mut metadata_len: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn nvmet_parse_io_cmd(req: *mut nvmet_req) -> u16 {
    ...
    const struct nvmet_fabrics_ops *ops)
    {
    let mut flags: u8 = req.cmd.common.flags;
    u16 status;
    req.cq = sq.cq;
    req.sq = sq;
    req.ops = ops;
    req.sg = core::ptr::null_mut();
    req.metadata_sg = core::ptr::null_mut();
    req.sg_cnt = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(0): likely(req->sq->qid !=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_req_uninit(req: *mut nvmet_req) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_req_transfer_len(req: *mut nvmet_req) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_check_transfer_len(req: *mut nvmet_req, len: usize) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_check_data_len_lte(req: *mut nvmet_req, data_len: usize) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvmet_data_transfer_len(req: *mut nvmet_req) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_req_alloc_sgls(req: *mut nvmet_req) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_req_free_sgls(req: *mut nvmet_req) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_css_supported(cc_css: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvmet_start_ctrl(ctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_clear_ctrl(ctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_update_cc(ctrl: *mut nvmet_ctrl, new: u32) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_init_cap(ctrl: *mut nvmet_ctrl) {
...
// maximum queue entries supported:
    ...
    struct nvmet_req *req)
    {
    struct nvmet_ctrl *ctrl = core::ptr::null_mut();
...
// ctrl found
    ...
    ctrl = core::ptr::null_mut(); /* ctrl not found */
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_check_ctrl_status(req: *mut nvmet_req) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_host_allowed(subsys: *mut nvmet_subsys, hostnqn: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvmet_release_p2p_ns_map(ctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_fatal_error_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_ctrl_free(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_ctrl_put(ctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_ctrl_fatal_error(ctrl: *mut nvmet_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn nvmet_subsys_free(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_subsys_del_ctrls(subsys: *mut nvmet_subsys) {
...
#[no_mangle]
pub unsafe extern "C" fn nvmet_subsys_put(subsys: *mut nvmet_subsys) {
    void nvmet_subsys_put(struct nvmet_subsys *subsys)
    {
    kref_put(&subsys.ref, nvmet_subsys_free);
    }
#[no_mangle]
unsafe extern "C" fn nvmet_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nvmet_exit() -> void __exit {
