...
//! Source: drivers/ptp/ptp_sysfs.c
#![no_std]
...
//
    ...
    static DEVICE_ATTR(name, 0444, var##_show, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(extts_enable, 0220, core::ptr::null_mut(), extts_enable_store);
...
// Paired with READ_ONCE() in queue_cnt()
    ...
    static DEVICE_ATTR(fifo, 0444, extts_fifo_show, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(period, 0220, core::ptr::null_mut(), period_store);
    ...
    static DEVICE_ATTR(pps_enable, 0220, core::ptr::null_mut(), pps_enable_store);
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn ptp_pin_name2index(ptp: *mut ptp_clock, name: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ptp_populate_pin_groups(ptp: *mut ptp_clock) -> c_int {
    int ptp_populate_pin_groups(struct ptp_clock *ptp)
    {
    struct ptp_clock_info *info = ptp.info;
    let mut err: c_int = -ENOMEM, i, n_pins = info.n_pins;
    if (!n_pins)
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn ptp_cleanup_pin_groups(ptp: *mut ptp_clock) {
