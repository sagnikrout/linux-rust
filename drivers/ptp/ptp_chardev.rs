...
//! Source: drivers/ptp/ptp_chardev.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ptp_disable_all_events(ptp: *mut ptp_clock) {
...
// Disable the PPS event if the driver has PPS support
    if (info.pps) {
    let mut req: ptp_clock_request = { .type = PTP_CLK_REQ_PPS };
    ...
    {
    struct ptp_clock_info *info = ptp.info;
    struct ptp_pin_desc *pin1 = core::ptr::null_mut(), *pin2 = &info.pin_config[pin];
    unsigned int i;
...
#[no_mangle]
pub unsafe extern "C" fn ptp_open(pccontext: *mut posix_clock_context, fmode: fmode_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ptp_release(pccontext: *mut posix_clock_context) -> c_int {
    ...
    pccontext.private_clkdata = core::ptr::null_mut();
    scoped_guard(spinlock_irq, &ptp.tsevqs_lock)
...
#[no_mangle]
unsafe extern "C" fn ptp_clock_getcaps(ptp: *mut ptp_clock, arg: *mut void __user) -> c_long {
    ...
    .cross_timestamping	= ptp.info.getcrosststamp != core::ptr::null_mut(),
    .adjust_phase		= ptp.info.adjphase != core::ptr::null_mut() &&
    ptp.info.getmaxphase != core::ptr::null_mut(),
    };
...
#[no_mangle]
unsafe extern "C" fn ptp_extts_request(ptp: *mut ptp_clock, cmd: c_uint, arg: *mut void __user) -> c_long {
    static long ptp_extts_request(struct ptp_clock *ptp, unsigned int cmd, void __user *arg)
    {
    let mut req: ptp_clock_request = { .type = PTP_CLK_REQ_EXTTS };
...
#[no_mangle]
unsafe extern "C" fn ptp_perout_request(ptp: *mut ptp_clock, cmd: c_uint, arg: *mut void __user) -> c_long {
    static long ptp_perout_request(struct ptp_clock *ptp, unsigned int cmd, void __user *arg)
    {
    let mut req: ptp_clock_request = { .type = PTP_CLK_REQ_PEROUT };
...
#[no_mangle]
unsafe extern "C" fn ptp_enable_pps(ptp: *mut ptp_clock, enable: bool) -> c_long {
    ...
    {
    struct ptp_sys_offset_extended *extoff __free(kfree) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ptp_sys_offset(ptp: *mut ptp_clock, arg: *mut void __user) -> c_long {
    static long ptp_sys_offset(struct ptp_clock *ptp, void __user *arg)
    {
    struct ptp_sys_offset *sysoff __free(kfree) = core::ptr::null_mut();
    ...
    pct++;
    if (ops.gettimex64)
    err = ops.gettimex64(ops, &ts, core::ptr::null_mut());
    else
...
#[no_mangle]
unsafe extern "C" fn ptp_pin_getfunc(ptp: *mut ptp_clock, cmd: c_uint, arg: *mut void __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn ptp_pin_setfunc(ptp: *mut ptp_clock, cmd: c_uint, arg: *mut void __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn ptp_mask_clear_all(tsevq: *mut timestamp_event_queue) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn ptp_mask_en_single(tsevq: *mut timestamp_event_queue, arg: *mut void __user) -> c_long {
    ...
    let mut qcnt: usize = min((size_t)queue_cnt(queue), cnt / sizeof(*event));
