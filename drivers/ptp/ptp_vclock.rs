...
//! Source: drivers/ptp/ptp_vclock.c
#![no_std]
...
pub const PTP_VCLOCK_CC_SHIFT: c_int = 31;

pub const PTP_VCLOCK_FADJ_SHIFT: c_int = 9;
...
#[no_mangle]
unsafe extern "C" fn ptp_vclock_hash_add(vclock: *mut ptp_vclock) {
...
#[no_mangle]
unsafe extern "C" fn ptp_vclock_hash_del(vclock: *mut ptp_vclock) {
...
#[no_mangle]
unsafe extern "C" fn ptp_vclock_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ptp_vclock_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ptp_vclock_refresh(ptp: *mut ptp_clock_info) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn ptp_vclock_set_subclass(ptp: *mut ptp_clock) {
...
#[no_mangle]
unsafe extern "C" fn ptp_vclock_read(cc: *mut cyclecounter) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn ptp_vclock_unregister(vclock: *mut ptp_vclock) {
...
#[no_mangle]
pub unsafe extern "C" fn ptp_get_vclocks_index(pclock_index: c_int, vclock_index: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ptp_convert_timestamp(hwtstamp: *const ktime_t, vclock_index: c_int) -> ktime_t {
    ktime_t ptp_convert_timestamp(const ktime_t *hwtstamp, int vclock_index)
    {
    let mut hash: c_uint = vclock_index % HASH_SIZE(vclock_hash);
    struct ptp_vclock *vclock;
