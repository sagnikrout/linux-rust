...
#[no_mangle]
unsafe extern "C" fn tmr_cnt_read(ptp_qoriq: *mut ptp_qoriq) -> u64 {
...
// Caller must hold ptp_qoriq->lock.
#[no_mangle]
unsafe extern "C" fn tmr_cnt_write(ptp_qoriq: *mut ptp_qoriq, ns: u64) {
    static void tmr_cnt_write(struct ptp_qoriq *ptp_qoriq, u64 ns)
    {
    struct ptp_qoriq_registers *regs = &ptp_qoriq.regs;
    let mut hi: u32 = ns >> 32;
    let mut lo: u32 = ns & 0xffffffff;
    ptp_qoriq.write(&regs.ctrl_regs.tmr_cnt_l, lo);
    ptp_qoriq.write(&regs.ctrl_regs.tmr_cnt_h, hi);
    }
#[no_mangle]
unsafe extern "C" fn tmr_offset_read(ptp_qoriq: *mut ptp_qoriq) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn tmr_offset_write(ptp_qoriq: *mut ptp_qoriq, delta_ns: u64) {
    static void tmr_offset_write(struct ptp_qoriq *ptp_qoriq, u64 delta_ns)
    {
    struct ptp_qoriq_registers *regs = &ptp_qoriq.regs;
    let mut lo: u32 = delta_ns & 0xffffffff;
    let mut hi: u32 = delta_ns >> 32;
    ptp_qoriq.write(&regs.ctrl_regs.tmroff_l, lo);
    ptp_qoriq.write(&regs.ctrl_regs.tmroff_h, hi);
    }
// Caller must hold ptp_qoriq->lock.
#[no_mangle]
unsafe extern "C" fn set_alarm(ptp_qoriq: *mut ptp_qoriq) {
...
// Caller must hold ptp_qoriq->lock.
#[no_mangle]
unsafe extern "C" fn set_fipers(ptp_qoriq: *mut ptp_qoriq) {
...
#[no_mangle]
pub unsafe extern "C" fn extts_clean_up(ptp_qoriq: *mut ptp_qoriq, index: c_int, update_event: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ptp_qoriq_isr(irq: c_int, priv: *mut c_void) -> irqreturn_t {
    irqreturn_t ptp_qoriq_isr(int irq, void *priv)
    {
    struct ptp_qoriq *ptp_qoriq = priv;
    struct ptp_qoriq_registers *regs = &ptp_qoriq.regs;
    struct ptp_clock_event event;
    let mut ack: u32 = 0, mask, val, irqs;
...
//
#[no_mangle]
pub unsafe extern "C" fn ptp_qoriq_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ptp_qoriq_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ptp_qoriq_gettime(ptp: *mut ptp_clock_info, ts: *mut timespec64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ptp_qoriq_nominal_freq(clk_src: u32) -> u32 {
...
//
    ...
    struct ptp_qoriq *ptp_qoriq = container_of(ptp, struct ptp_qoriq, caps);
    struct ptp_qoriq_registers *regs = &ptp_qoriq.regs;
    let mut loopback_bit: u32 = index ? PP2L : PP1L;
    u32 tmr_ctrl;
...
#[no_mangle]
pub unsafe extern "C" fn ptp_qoriq_free(ptp_qoriq: *mut ptp_qoriq) {
...
#[no_mangle]
unsafe extern "C" fn ptp_qoriq_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ptp_qoriq_remove(dev: *mut platform_device) {
