...
//! Source: drivers/video/vgastate.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct regstate {
    pub vga_font0: *mut __u8,
    pub vga_font1: *mut __u8,
    pub vga_text: *mut __u8,
    pub vga_cmap: *mut __u8,
    pub attr: *mut __u8,
    pub crtc: *mut __u8,
    pub gfx: *mut __u8,
    pub seq: *mut __u8,
...
#[no_mangle]
unsafe extern "C" fn save_vga_text(state: *mut vgastate, fbbase: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn restore_vga_text(state: *mut vgastate, fbbase: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn save_vga_mode(state: *mut vgastate) {
...
#[no_mangle]
unsafe extern "C" fn restore_vga_mode(state: *mut vgastate) {
...
#[no_mangle]
unsafe extern "C" fn save_vga_cmap(state: *mut vgastate) {
...
#[no_mangle]
unsafe extern "C" fn restore_vga_cmap(state: *mut vgastate) {
...
#[no_mangle]
unsafe extern "C" fn vga_cleanup(state: *mut vgastate) {
    static void vga_cleanup(struct vgastate *state)
    {
    if (state.vidstate != core::ptr::null_mut()) {
    struct regstate *saved = (struct regstate *) state.vidstate;
    ...
    vfree(saved.attr);
    kfree(saved);
    state.vidstate = core::ptr::null_mut();
    }
    }
#[no_mangle]
pub unsafe extern "C" fn save_vga(state: *mut vgastate) -> c_int {
    int save_vga(struct vgastate *state)
    {
    struct regstate *saved;
    saved = kzalloc_obj(struct regstate);
    if (saved == core::ptr::null_mut())
    return 1;
...
#[no_mangle]
pub unsafe extern "C" fn restore_vga(state: *mut vgastate) -> c_int {
