...
//! Source: drivers/video/console/sticon.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sticon_cursor(conp: *mut vc_data, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn sticon_set_def_font(unit: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sticon_init(c: *mut vc_data, init: bool) {
...
#[no_mangle]
unsafe extern "C" fn sticon_deinit(c: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn sticon_switch(conp: *mut vc_data) -> bool {
    ...
    bool italic)
    {
    let mut fg: u8 = color & 7;
    let mut bg: u8 = (color & 0x70) >> 4;
    if (reverse)
    return (fg << 3) | bg;
    else
    return (bg << 3) | fg;
...
#[no_mangle]
unsafe extern "C" fn sticon_invert_region(conp: *mut vc_data, p: *mut u16, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sticonsole_init() -> int __init {
