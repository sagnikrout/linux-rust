...
//! Source: drivers/video/fbdev/sm712fb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct smtcfb_info {
    pub pdev: *mut pci_dev,
    pub fb: *mut fb_info,
    pub chip_id: u16,
    pub chip_rev_id: u8,
    pub /: *mut *mut *mut void __iomem lfb; / linear frame buffer,
    pub /: *mut *mut *mut void __iomem dp_regs; / drawing processor control regs,
    pub /: *mut *mut *mut void __iomem vp_regs; / video processor control regs,
    pub /: *mut *mut *mut void __iomem cp_regs; / capture processor control regs,
    pub /: *mut *mut *mut void __iomem mmio; / memory map IO port,
    pub width: u_int,
    pub height: u_int,
    pub hz: u_int,
    pub colreg: [u32; 17],
...
#[no_mangle]
unsafe extern "C" fn sm7xx_vga_setup(options: *mut c_char) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn smtc_blank(blank_mode: c_int, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm7xx_set_timing(sfb: *mut smtcfb_info) {
...
#[no_mangle]
unsafe extern "C" fn smtc_set_timing(sfb: *mut smtcfb_info) {
...
#[no_mangle]
unsafe extern "C" fn smtcfb_setmode(sfb: *mut smtcfb_info) {
...
#[no_mangle]
unsafe extern "C" fn smtc_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smtc_set_par(info: *mut fb_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smtc_unmap_mmio(sfb: *mut smtcfb_info) {
    static void smtc_unmap_mmio(struct smtcfb_info *sfb)
    {
    if (sfb && smtc_regbaseaddress)
    smtc_regbaseaddress = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn smtc_unmap_smem(sfb: *mut smtcfb_info) {
    ...
    sfb.fb.screen_base = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn sm7xx_init_hw() {
...
#[no_mangle]
unsafe extern "C" fn sm7xx_vram_probe(sfb: *mut smtcfb_info) -> u_long {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x01: vram ==) -> else {
    else if (vram == 0x01)
    return 0x01000000;  /* 16 MB */
#[no_mangle]
pub unsafe extern "C" fn if(0x02: vram ==) -> else {
    else if (vram == 0x02)
    return 0x00400000;  /* illegal, fallback to 4 MB */
#[no_mangle]
pub unsafe extern "C" fn if(0x03: vram ==) -> else {
    else if (vram == 0x03)
...
#[no_mangle]
unsafe extern "C" fn sm7xx_resolution_probe(sfb: *mut smtcfb_info) {
...
#[no_mangle]
unsafe extern "C" fn smtcfb_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn smtcfb_pci_suspend(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn smtcfb_pci_resume(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn sm712fb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sm712fb_exit() -> void __exit {
