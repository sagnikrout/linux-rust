...
//! Source: drivers/video/fbdev/i810/i810_dvt.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn round_off_xres(xres: *mut u32) {
    void round_off_xres(u32 *xres)
    {
    if (*xres <= 640)
// xres = 640;
#[no_mangle]
pub unsafe extern "C" fn if(800: *mut *mut xres <=) -> else {
    else if (*xres <= 800)
// xres = 800;
#[no_mangle]
pub unsafe extern "C" fn if(1024: *mut *mut xres <=) -> else {
    else if (*xres <= 1024)
// xres = 1024;
#[no_mangle]
pub unsafe extern "C" fn if(1152: *mut *mut xres <=) -> else {
    else if (*xres <= 1152)
// xres = 1152;
#[no_mangle]
pub unsafe extern "C" fn if(1280: *mut *mut xres <=) -> else {
    else if (*xres <= 1280)
// xres = 1280;
    else
// xres = 1600;
...
#[no_mangle]
pub unsafe extern "C" fn round_off_yres(xres: *mut u32, yres: *mut u32) {
    inline void round_off_yres(u32 *xres, u32 *yres)
    {
// yres = (*xres * 3) >> 2;
    }
#[no_mangle]
unsafe extern "C" fn i810fb_find_best_mode(xres: u32, yres: u32, pixclock: u32) -> c_int {
    static int i810fb_find_best_mode(u32 xres, u32 yres, u32 pixclock)
    {
    let mut diff: u32 = 0, diff_best = 0xFFFFFFFF, i = 0, i_best = 0;
    let mut hfl: u8 = (u8) ((xres >> 3) - 1);
    ...
    {
    let mut i_best: u32 = i810fb_find_best_mode(xres, yres, par.regs.pixclock);
...
#[no_mangle]
pub unsafe extern "C" fn i810fb_fill_var_timings(var: *mut fb_var_screeninfo) {
