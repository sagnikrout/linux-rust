...
//! Source: drivers/video/fbdev/uvesafb.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn uvesafb_cn_callback(msg: *mut cn_msg, nsp: *mut netlink_skb_parms) {
...
// Sanity checks for the buffer length.
    ...
    uvfb_tasks[msg.seq] = core::ptr::null_mut();
    mutex_unlock(&uvfb_lock);
...
#[no_mangle]
unsafe extern "C" fn uvesafb_helper_start() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uvesafb_exec(task: *mut uvesafb_ktask) -> c_int {
    static int uvesafb_exec(struct uvesafb_ktask *task)
    {
    static int seq;
    struct cn_msg *m;
    int err;
    let mut len: c_int = sizeof(task.t) + task.t.buf_len;
//
...
//
    ...
    mutex_lock(&uvfb_lock);
    uvfb_tasks[seq] = core::ptr::null_mut();
    mutex_unlock(&uvfb_lock);
    seq++;
...
//
#[no_mangle]
unsafe extern "C" fn uvesafb_free(task: *mut uvesafb_ktask) {
...
//
#[no_mangle]
unsafe extern "C" fn uvesafb_reset(task: *mut uvesafb_ktask) {
...
#[no_mangle]
unsafe extern "C" fn uvesafb_vbe_state_restore(par: *mut uvesafb_par, state_buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn uvesafb_vbe_getedid(task: *mut uvesafb_ktask, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uvesafb_vbe_init(info: *mut fb_info) -> c_int {
    static int uvesafb_vbe_init(struct fb_info *info)
    {
    struct uvesafb_ktask *task = core::ptr::null_mut();
    struct uvesafb_par *par = info.par;
    int err;
    task = uvesafb_prep();
    if (!task)
...
#[no_mangle]
unsafe extern "C" fn uvesafb_vbe_init_mode(info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: par->pmi_setpal) -> else {
    ...
    let mut shift: c_int = 16 - dac_width;
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn uvesafb_setcmap(cmap: *mut fb_cmap, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uvesafb_blank(blank: c_int, info: *mut fb_info) -> c_int {
    ...
    let mut loop: c_int = 10000;
    let mut seq: u8 = 0, crtc17 = 0;
    ...
    vga_wseq(core::ptr::null_mut(), 0x00, 0x01);
    seq |= vga_rseq(core::ptr::null_mut(), 0x01) & ~0x20;
    vga_wseq(core::ptr::null_mut(), 0x00, seq);
    crtc17 |= vga_rcrt(core::ptr::null_mut(), 0x17) & ~0x80;
    while (loop--);
    vga_wcrt(core::ptr::null_mut(), 0x17, crtc17);
    vga_wseq(core::ptr::null_mut(), 0x00, 0x03);
    } else
...
#[no_mangle]
unsafe extern "C" fn uvesafb_open(info: *mut fb_info, user: c_int) -> c_int {
    static int uvesafb_open(struct fb_info *info, int user)
    {
    struct uvesafb_par *par = info.par;
    let mut cnt: c_int = atomic_read(&par.ref_count);
...
#[no_mangle]
unsafe extern "C" fn uvesafb_release(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uvesafb_set_par(info: *mut fb_info) -> c_int {
    static int uvesafb_set_par(struct fb_info *info)
    {
    struct uvesafb_par *par = info.par;
    struct uvesafb_ktask *task = core::ptr::null_mut();
    struct vbe_crtc_ib *crtc = core::ptr::null_mut();
    struct vbe_mode_ib *mode = core::ptr::null_mut();
...
// Use default refresh rate
    ...
    let mut depth: c_int = var.red.length + var.green.length + var.blue.length;
//
...
#[no_mangle]
unsafe extern "C" fn uvesafb_init_info(info: *mut fb_info, mode: *mut vbe_mode_ib) {
...
// Disable blanking if the user requested so.
    if (!blank)
    uvesafb_ops.fb_blank = core::ptr::null_mut();
//
...
//
    ...
    if (!par.ypan)
    uvesafb_ops.fb_pan_display = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn uvesafb_init_mtrr(info: *mut fb_info) {
    static void uvesafb_init_mtrr(struct fb_info *info)
    {
    struct uvesafb_par *par = info.par;
    if (mtrr && !(info.fix.smem_start & (PAGE_SIZE - 1))) {
    let mut temp_size: c_int = info.fix.smem_len;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn uvesafb_ioremap(info: *mut fb_info) {
    ...
    static DEVICE_ATTR(vbe_version, S_IRUGO, uvesafb_show_vbe_ver, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(vbe_modes, S_IRUGO, uvesafb_show_vbe_modes, core::ptr::null_mut());
...
pub unsafe extern "C" fn sysfs_emit(_arg: buf, _arg: "%s\n", : *mut (char) -> return {
    ...
    static DEVICE_ATTR(oem_vendor, S_IRUGO, uvesafb_show_vendor, core::ptr::null_mut());
...
pub unsafe extern "C" fn sysfs_emit(_arg: buf, _arg: "%s\n", : *mut (char) -> return {
    ...
    static DEVICE_ATTR(oem_product_name, S_IRUGO, uvesafb_show_product_name, core::ptr::null_mut());
...
pub unsafe extern "C" fn sysfs_emit(_arg: buf, _arg: "%s\n", : *mut (char) -> return {
    ...
    static DEVICE_ATTR(oem_product_rev, S_IRUGO, uvesafb_show_product_rev, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(oem_string, S_IRUGO, uvesafb_show_oem_string, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn uvesafb_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uvesafb_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn uvesafb_setup(options: *mut c_char) -> c_int {
    ...
    ypan = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(this_opt, _arg: "ypan")) -> else {
    else if (!strcmp(this_opt, "ypan"))
    ypan = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(this_opt, _arg: "ywrap")) -> else {
    else if (!strcmp(this_opt, "ywrap"))
    ypan = 2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(this_opt, _arg: "vgapal")) -> else {
    else if (!strcmp(this_opt, "vgapal"))
    pmi_setpal = false;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(this_opt, _arg: "pmipal")) -> else {
    else if (!strcmp(this_opt, "pmipal"))
    pmi_setpal = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "mtrr:", _arg: 5)) -> else {
    else if (!strncmp(this_opt, "mtrr:", 5))
    mtrr = simple_strtoul(this_opt+5, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(this_opt, _arg: "nomtrr")) -> else {
    else if (!strcmp(this_opt, "nomtrr"))
    mtrr = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(this_opt, _arg: "nocrtc")) -> else {
    else if (!strcmp(this_opt, "nocrtc"))
    nocrtc = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(this_opt, _arg: "noedid")) -> else {
    else if (!strcmp(this_opt, "noedid"))
    noedid = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(this_opt, _arg: "noblank")) -> else {
    else if (!strcmp(this_opt, "noblank"))
    blank = false;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "vtotal:", _arg: 7)) -> else {
    else if (!strncmp(this_opt, "vtotal:", 7))
    vram_total = simple_strtoul(this_opt + 7, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "vremap:", _arg: 7)) -> else {
    else if (!strncmp(this_opt, "vremap:", 7))
    vram_remap = simple_strtoul(this_opt + 7, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "maxhf:", _arg: 6)) -> else {
    else if (!strncmp(this_opt, "maxhf:", 6))
    maxhf = simple_strtoul(this_opt + 6, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "maxvf:", _arg: 6)) -> else {
    else if (!strncmp(this_opt, "maxvf:", 6))
    maxvf = simple_strtoul(this_opt + 6, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "maxclk:", _arg: 7)) -> else {
    else if (!strncmp(this_opt, "maxclk:", 7))
    maxclk = simple_strtoul(this_opt + 7, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "vbemode:", _arg: 8)) -> else {
    else if (!strncmp(this_opt, "vbemode:", 8))
    vbemode = simple_strtoul(this_opt + 8, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if('9': this_opt[0] >= '0' && this_opt[0] <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn v86d_show(dev: *mut device_driver, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn uvesafb_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uvesafb_exit() {
...
#[no_mangle]
unsafe extern "C" fn param_set_scroll(val: *const c_char, kp: *const kernel_param) -> c_int {
    ...
    ypan = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(val, _arg: "ypan")) -> else {
    else if (!strcmp(val, "ypan"))
    ypan = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(val, _arg: "ywrap")) -> else {
