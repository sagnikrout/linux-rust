...
//! Source: drivers/video/fbdev/nvidia/nv_setup.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn NVWriteCrtc(par: *mut nvidia_par, index: u8, value: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn NVReadCrtc(par: *mut nvidia_par, index: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn NVWriteGr(par: *mut nvidia_par, index: u8, value: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn NVReadGr(par: *mut nvidia_par, index: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn NVWriteSeq(par: *mut nvidia_par, index: u8, value: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn NVReadSeq(par: *mut nvidia_par, index: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn NVWriteAttr(par: *mut nvidia_par, index: u8, value: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn NVReadAttr(par: *mut nvidia_par, index: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn NVWriteMiscOut(par: *mut nvidia_par, value: u8) {
    void NVWriteMiscOut(struct nvidia_par *par, u8 value)
    {
    VGA_WR08(par.PVIO, VGA_MIS_W, value);
    }
#[no_mangle]
pub unsafe extern "C" fn NVReadMiscOut(par: *mut nvidia_par) -> u8 {
    u8 NVReadMiscOut(struct nvidia_par *par)
    {
    return (VGA_RD08(par.PVIO, VGA_MIS_R));
    }
#[no_mangle]
pub unsafe extern "C" fn NVWriteDacMask(par: *mut nvidia_par, value: u8) {
    void NVWriteDacMask(struct nvidia_par *par, u8 value)
    {
    VGA_WR08(par.PDIO, VGA_PEL_MSK, value);
    }
#[no_mangle]
pub unsafe extern "C" fn NVWriteDacReadAddr(par: *mut nvidia_par, value: u8) {
    void NVWriteDacReadAddr(struct nvidia_par *par, u8 value)
    {
    VGA_WR08(par.PDIO, VGA_PEL_IR, value);
    }
#[no_mangle]
pub unsafe extern "C" fn NVWriteDacWriteAddr(par: *mut nvidia_par, value: u8) {
    void NVWriteDacWriteAddr(struct nvidia_par *par, u8 value)
    {
    VGA_WR08(par.PDIO, VGA_PEL_IW, value);
    }
#[no_mangle]
pub unsafe extern "C" fn NVWriteDacData(par: *mut nvidia_par, value: u8) {
    void NVWriteDacData(struct nvidia_par *par, u8 value)
    {
    VGA_WR08(par.PDIO, VGA_PEL_D, value);
    }
#[no_mangle]
pub unsafe extern "C" fn NVReadDacData(par: *mut nvidia_par) -> u8 {
    u8 NVReadDacData(struct nvidia_par *par)
    {
    return (VGA_RD08(par.PDIO, VGA_PEL_D));
    }
#[no_mangle]
unsafe extern "C" fn NVIsConnected(par: *mut nvidia_par, output: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn NVSelectHeadRegisters(par: *mut nvidia_par, head: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nv4GetConfig(par: *mut nvidia_par) {
...
#[no_mangle]
unsafe extern "C" fn nv10GetConfig(par: *mut nvidia_par) {
    static void nv10GetConfig(struct nvidia_par *par)
    {
    struct pci_dev *dev;
    let mut implementation: u32 = par.Chipset & 0x0ff0;
...
// turn on big endian register access
    ...
    par.CURSOR = core::ptr::null_mut();	/* can't set this here */
    par.MinVClockFreqKHz = 12000;
    par.MaxVClockFreqKHz = par.twoStagePLL ? 400000 : 350000;
    }
#[no_mangle]
pub unsafe extern "C" fn NVCommonSetup(info: *mut fb_info) -> c_int {
    int NVCommonSetup(struct fb_info *info)
    {
    struct nvidia_par *par = info.par;
    struct fb_var_screeninfo *var;
    let mut implementation: u16 = par.Chipset & 0x0ff0;
    u8 *edidA = core::ptr::null_mut(), *edidB = core::ptr::null_mut();
    struct fb_monspecs *monitorA, *monitorB;
    struct fb_monspecs *monA = core::ptr::null_mut(), *monB = core::ptr::null_mut();
    let mut mobile: c_int = 0;
    let mut tvA: c_int = 0;
    let mut tvB: c_int = 0;
    int FlatPanel = -1;	/* really means the CRTC is slaved */
    let mut Television: c_int = 0;
    let mut err: c_int = 0;
...
// NV4 doesn't support FlatPanels
    ...
    monB = core::ptr::null_mut();
    }
    } else {
    fb_destroy_modedb(monA.modedb);
    monA = core::ptr::null_mut();
    }
    }
    if (monB) {
