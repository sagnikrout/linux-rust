...
//! Source: drivers/video/fbdev/nvidia/nv_accel.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn nvidiafb_safe_mode(info: *mut fb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn NVFlush(info: *mut fb_info) {
    static inline void NVFlush(struct fb_info *info)
    {
    struct nvidia_par *par = info.par;
    let mut count: c_int = 1000000000;
...
#[no_mangle]
pub unsafe extern "C" fn NVSync(info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn NVDmaKickoff(par: *mut nvidia_par) {
...
#[no_mangle]
unsafe extern "C" fn NVDmaWait(info: *mut fb_info, size: c_int) {
    static void NVDmaWait(struct fb_info *info, int size)
    {
    struct nvidia_par *par = info.par;
    int dmaGet;
    let mut count: c_int = 1000000000, cnt;
    size++;
...
#[no_mangle]
unsafe extern "C" fn NVSetRopSolid(info: *mut fb_info, rop: u32, planemask: u32) {
    ...
    {
    struct nvidia_par *par = info.par;
    let mut h: c_int = y2 - y1 + 1;
    let mut w: c_int = x2 - x1 + 1;
    NVDmaStart(info, par, CLIP_POINT, 2);
    NVDmaNext(par, (y1 << 16) | x1);
    NVDmaNext(par, (h << 16) | w);
    }
#[no_mangle]
pub unsafe extern "C" fn NVResetGraphics(info: *mut fb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn nvidiafb_sync(info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvidiafb_copyarea(info: *mut fb_info, region: *const fb_copyarea) {
...
#[no_mangle]
pub unsafe extern "C" fn nvidiafb_fillrect(info: *mut fb_info, rect: *const fb_fillrect) {
...
#[no_mangle]
pub unsafe extern "C" fn nvidiafb_imageblit(info: *mut fb_info, image: *const fb_image) {
