...
//! Source: drivers/video/fbdev/i740fb.c
#![no_std]
...
pub struct i740fb_par {
    ...
    pub atc: [u8; VGA_ATT_C],
    pub gdc: [u8; VGA_GFX_C],
    pub seq: [u8; VGA_SEQ_C],
    pub misc: u8,
    pub vss: u8,
// i740 specific registers
    pub display_cntl: u8,
    pub pixelpipe_cfg0: u8,
    pub pixelpipe_cfg1: u8,
    pub pixelpipe_cfg2: u8,
    pub video_clk2_m: u8,
    pub video_clk2_n: u8,
    pub video_clk2_mn_msbs: u8,
    pub video_clk2_div_sel: u8,
    pub pll_cntl: u8,
    pub address_mapping: u8,
    pub io_cntl: u8,
    pub bitblt_cntl: u8,
    pub ext_vert_total: u8,
    pub ext_vert_disp_end: u8,
    pub ext_vert_sync_start: u8,
    pub ext_vert_blank_start: u8,
    pub ext_horiz_total: u8,
    pub ext_horiz_blank: u8,
    pub ext_offset: u8,
    pub interlace_cntl: u8,
    pub lmi_fifo_watermark: u32,
    pub ext_start_addr: u8,
    pub ext_start_addr_hi: u8,
}

pub const DACSPEED8: c_int = 203;
pub const DACSPEED16: c_int = 163;
pub const DACSPEED24_SG: c_int = 136;
pub const DACSPEED24_SD: c_int = 128;
pub const DACSPEED32: c_int = 86;
...
pub const REG_DDC_DRIVE: c_uint = 0x62;
pub const REG_DDC_STATE: c_uint = 0x63;

#[no_mangle]
unsafe extern "C" fn i740fb_ddc_setscl(data: *mut c_void, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn i740fb_ddc_setsda(data: *mut c_void, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn i740fb_ddc_getscl(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i740fb_ddc_getsda(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i740fb_setup_ddc_bus(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i740fb_open(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i740fb_release(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i740_calc_fifo(par: *mut i740fb_par, freq: u32, bpp: c_int) -> u32 {
...
//
    ...
    wm = 0x18120000;
#[no_mangle]
pub unsafe extern "C" fn if(175: freq >) -> else {
    else if (freq > 175)
    wm = 0x16110000;
#[no_mangle]
pub unsafe extern "C" fn if(135: freq >) -> else {
    else if (freq > 135)
    wm = 0x120E0000;
    else
    wm = 0x100D0000;
    ...
    wm = 0x2C1D0000;
#[no_mangle]
pub unsafe extern "C" fn if(120: freq >) -> else {
    else if (freq > 120)
    wm = 0x2C180000;
#[no_mangle]
pub unsafe extern "C" fn if(100: freq >) -> else {
    else if (freq > 100)
    wm = 0x24160000;
#[no_mangle]
pub unsafe extern "C" fn if(90: freq >) -> else {
    else if (freq >  90)
    wm = 0x18120000;
#[no_mangle]
pub unsafe extern "C" fn if(50: freq >) -> else {
    else if (freq >  50)
    wm = 0x16110000;
#[no_mangle]
pub unsafe extern "C" fn if(32: freq >) -> else {
    else if (freq >  32)
    wm = 0x13100000;
    else
    wm = 0x120E0000;
    ...
    wm = 0x28200000;
#[no_mangle]
pub unsafe extern "C" fn if(140: freq >) -> else {
    else if (freq > 140)
    wm = 0x2A1E0000;
#[no_mangle]
pub unsafe extern "C" fn if(130: freq >) -> else {
    else if (freq > 130)
    wm = 0x2B1A0000;
#[no_mangle]
pub unsafe extern "C" fn if(120: freq >) -> else {
...
pub unsafe extern "C" fn if(100: freq >) -> else {
    ...
    wm = 0x2C1D0000;
#[no_mangle]
pub unsafe extern "C" fn if(80: freq >) -> else {
    else if (freq >  80)
    wm = 0x25180000;
#[no_mangle]
pub unsafe extern "C" fn if(64: freq >) -> else {
    else if (freq >  64)
    wm = 0x24160000;
#[no_mangle]
pub unsafe extern "C" fn if(49: freq >) -> else {
    else if (freq >  49)
    wm = 0x18120000;
#[no_mangle]
pub unsafe extern "C" fn if(32: freq >) -> else {
...
pub unsafe extern "C" fn if(32: freq >) -> else {
    ...
    wm = 0x2A200000;
#[no_mangle]
pub unsafe extern "C" fn if(60: freq >) -> else {
    else if (freq >  60)
    wm = 0x281A0000;
#[no_mangle]
pub unsafe extern "C" fn if(49: freq >) -> else {
...
pub const I740_RFREQ: c_int = 1000000;
pub const TARGET_MAX_N: c_int = 30;

#[no_mangle]
unsafe extern "C" fn i740_calc_vclk(freq: u32, par: *mut i740fb_par) {
    static void i740_calc_vclk(u32 freq, struct i740fb_par *par)
    {
    let mut err_max: u32 = freq / (200  * I740_RFREQ / I740_FFIX);
    let mut err_target: u32 = freq / (1000 * I740_RFREQ / I740_FFIX);
    let mut err_best: u32 = 512 * I740_FFIX;
    u32 f_err, f_vco;
    let mut m_best: c_int = 0, n_best = 0, p_best = 0;
    int m, n;
...
#[no_mangle]
unsafe extern "C" fn i740fb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vga_protect(par: *mut i740fb_par) {
...
#[no_mangle]
unsafe extern "C" fn vga_unprotect(par: *mut i740fb_par) {
...
#[no_mangle]
unsafe extern "C" fn i740fb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i740fb_blank(blank_mode: c_int, info: *mut fb_info) -> c_int {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn i740fb_probe(dev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i740fb_remove(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn i740fb_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn i740fb_resume(dev: *mut device) -> int __maybe_unused {
...
pub const I740_ID_PCI: c_uint = 0x00d1;
pub const I740_ID_AGP: c_uint = 0x7800;
...
#[no_mangle]
unsafe extern "C" fn i740fb_setup(options: *mut c_char) -> int  __init {
...
#[no_mangle]
unsafe extern "C" fn i740fb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn i740fb_exit() -> void __exit {
