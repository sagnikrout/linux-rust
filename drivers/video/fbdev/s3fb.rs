...
//! Source: drivers/video/fbdev/s3fb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s3fb_info {
    pub mclk_freq: int chip, rev,,
    pub wc_cookie: c_int,
    pub state: vgastate,
    pub open_lock: mutex,
...
pub const CHIP_UNKNOWN: c_uint = 0x00;
pub const CHIP_732_TRIO32: c_uint = 0x01;
pub const CHIP_764_TRIO64: c_uint = 0x02;
pub const CHIP_765_TRIO64VP: c_uint = 0x03;
pub const CHIP_767_TRIO64UVP: c_uint = 0x04;
pub const CHIP_775_TRIO64V2_DX: c_uint = 0x05;
pub const CHIP_785_TRIO64V2_GX: c_uint = 0x06;
pub const CHIP_551_PLATO_PX: c_uint = 0x07;
pub const CHIP_M65_AURORA64VP: c_uint = 0x08;
pub const CHIP_325_VIRGE: c_uint = 0x09;
pub const CHIP_988_VIRGE_VX: c_uint = 0x0A;
pub const CHIP_375_VIRGE_DX: c_uint = 0x0B;
pub const CHIP_385_VIRGE_GX: c_uint = 0x0C;
pub const CHIP_357_VIRGE_GX2: c_uint = 0x0D;
pub const CHIP_359_VIRGE_GX2P: c_uint = 0x0E;
pub const CHIP_360_TRIO3D_1X: c_uint = 0x10;
pub const CHIP_362_TRIO3D_2X: c_uint = 0x11;
pub const CHIP_368_TRIO3D_2X: c_uint = 0x12;
pub const CHIP_365_TRIO3D: c_uint = 0x13;
pub const CHIP_260_VIRGE_MX: c_uint = 0x14;
pub const CHIP_XXX_TRIO: c_uint = 0x80;
pub const CHIP_XXX_TRIO64V2_DXGX: c_uint = 0x81;
pub const CHIP_XXX_VIRGE_DXGX: c_uint = 0x82;
pub const CHIP_36X_TRIO3D_1X_2X: c_uint = 0x83;
pub const CHIP_UNDECIDED_FLAG: c_uint = 0x80;
pub const CHIP_MASK: c_uint = 0xFF;
pub const MMIO_OFFSET: c_uint = 0x1000000;
pub const MMIO_SIZE: c_uint = 0x10000;
...
// Module parameters
    ...
    let mut mtrr: static int = 1;
    let mut fasttext: static int = 1;
...
pub const DDC_REG: c_uint = 0xaa		/* Trio 3D/1X/2X */;
pub const DDC_MMIO_REG: c_uint = 0xff20		/* all other chips */;

#[no_mangle]
unsafe extern "C" fn s3fb_ddc_needs_mmio(chip: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn s3fb_ddc_read(par: *mut s3fb_info) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn s3fb_ddc_write(par: *mut s3fb_info, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn s3fb_ddc_setscl(data: *mut c_void, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn s3fb_ddc_setsda(data: *mut c_void, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn s3fb_ddc_getscl(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3fb_ddc_getsda(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3fb_setup_ddc_bus(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3fb_settile_fast(info: *mut fb_info, map: *mut fb_tilemap) {
...
#[no_mangle]
unsafe extern "C" fn s3fb_tilecursor(info: *mut fb_info, cursor: *mut fb_tilecursor) {
...
#[no_mangle]
pub unsafe extern "C" fn expand_color(c: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn s3fb_iplan_imageblit(info: *mut fb_info, image: *const fb_image) {
    static void s3fb_iplan_imageblit(struct fb_info *info, const struct fb_image *image)
    {
    let mut fg: u32 = expand_color(image.fg_color);
    let mut bg: u32 = expand_color(image.bg_color);
    const u8 *src1, *src;
    u8 __iomem *dst1;
    u32 __iomem *dst;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn s3fb_iplan_fillrect(info: *mut fb_info, rect: *const fb_fillrect) {
    static void s3fb_iplan_fillrect(struct fb_info *info, const struct fb_fillrect *rect)
    {
    let mut fg: u32 = expand_color(rect.color);
    u8 __iomem *dst1;
    u32 __iomem *dst;
    int x, y;
...
#[no_mangle]
pub unsafe extern "C" fn expand_pixel(c: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn s3fb_cfb4_imageblit(info: *mut fb_info, image: *const fb_image) {
    static void s3fb_cfb4_imageblit(struct fb_info *info, const struct fb_image *image)
    {
    let mut fg: u32 = image.fg_color * 0x11111111;
    let mut bg: u32 = image.bg_color * 0x11111111;
    const u8 *src1, *src;
    u8 __iomem *dst1;
    u32 __iomem *dst;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn s3fb_imageblit(info: *mut fb_info, image: *const fb_image) {
...
#[no_mangle]
unsafe extern "C" fn s3fb_fillrect(info: *mut fb_info, rect: *const fb_fillrect) {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn s3_set_pixclock(info: *mut fb_info, pixclock: u32) {
...
// Open framebuffer
#[no_mangle]
unsafe extern "C" fn s3fb_open(info: *mut fb_info, user: c_int) -> c_int {
...
// Close framebuffer
#[no_mangle]
unsafe extern "C" fn s3fb_release(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3fb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
// Find appropriate format
    rv = svga_match_format (s3fb_formats, var, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn s3fb_set_par(info: *mut fb_info) -> c_int {
    ...
    info.tileops = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(6: fb->var.green.length ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn s3fb_blank(blank_mode: c_int, info: *mut fb_info) -> c_int {
...
// Pan the display
#[no_mangle]
unsafe extern "C" fn s3fb_pan_display(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn s3_identification(par: *mut s3fb_info) -> c_int {
    static int s3_identification(struct s3fb_info *par)
    {
    let mut chip: c_int = par.chip;
    if (chip == CHIP_XXX_TRIO) {
    let mut cr30: u8 = vga_rcrt(par.state.vgabase, 0x30);
    let mut cr2e: u8 = vga_rcrt(par.state.vgabase, 0x2e);
    let mut cr2f: u8 = vga_rcrt(par.state.vgabase, 0x2f);
    ...
    let mut cr6f: u8 = vga_rcrt(par.state.vgabase, 0x6f);
    if (! (cr6f & 0x01))
...
// PCI probe
#[no_mangle]
unsafe extern "C" fn s3_pci_probe(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
// PCI remove
#[no_mangle]
unsafe extern "C" fn s3_pci_remove(dev: *mut pci_dev) {
...
// PCI suspend
#[no_mangle]
unsafe extern "C" fn s3_pci_suspend(dev: *mut device) -> int __maybe_unused {
...
// PCI resume
#[no_mangle]
unsafe extern "C" fn s3_pci_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn s3fb_setup(options: *mut c_char) -> int  __init {
    ...
    continue;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(opt, _arg: "mtrr:", _arg: 5)) -> else {
    else if (!strncmp(opt, "mtrr:", 5))
    mtrr = simple_strtoul(opt + 5, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(opt, _arg: "fasttext:", _arg: 9)) -> else {
    else if (!strncmp(opt, "fasttext:", 9))
    fasttext = simple_strtoul(opt + 9, core::ptr::null_mut(), 0);
    else
    mode_option = opt;
    }
    return 0;
...
// Cleanup
#[no_mangle]
unsafe extern "C" fn s3fb_cleanup() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn s3fb_init() -> int __init {
