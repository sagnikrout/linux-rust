...
//! Source: drivers/video/fbdev/goldfishfb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct goldfish_fb {
    pub reg_base: *mut void __iomem,
    pub irq: c_int,
    pub lock: spinlock_t,
    pub wait: wait_queue_head_t,
    pub base_update_count: c_int,
    pub rotation: c_int,
    pub fb: fb_info,
    pub cmap: [u32; 16],
}
...
#[no_mangle]
unsafe extern "C" fn goldfish_fb_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn convert_bitfield(val: c_int, bf: *mut fb_bitfield) -> u32 {
    static inline u32 convert_bitfield(int val, struct fb_bitfield *bf)
    {
    let mut mask: c_uint = (1 << bf.length) - 1;
...
#[no_mangle]
unsafe extern "C" fn goldfish_fb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goldfish_fb_blank(blank: c_int, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goldfish_fb_probe(pdev: *mut platform_device) -> c_int {
    ...
    fb.fb.screen_base = (char  __iomem *)dma_alloc_coherent(
    &pdev.dev, framesize,
    &fbpaddr, GFP_KERNEL);
    pr_debug("allocating frame buffer %d * %d, got %p\n",
    width, height, fb.fb.screen_base);
    if (fb.fb.screen_base == core::ptr::null_mut()) {
    ret = -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn goldfish_fb_remove(pdev: *mut platform_device) {
