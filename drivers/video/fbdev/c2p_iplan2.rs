...
//! Source: drivers/video/fbdev/c2p_iplan2.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn c2p_16x8(d[4]: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn store_iplan2(dst: *mut c_void, bpp: u32, d[4]: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn store_iplan2_masked(dst: *mut c_void, bpp: u32, d[4]: u32, mask: u32) {
