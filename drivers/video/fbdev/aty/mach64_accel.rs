...
//! Source: drivers/video/fbdev/aty/mach64_accel.c
#![no_std]
...
pub const SYSTEM_TO_FRAME_BUFFER: c_int = 0;
#[no_mangle]
unsafe extern "C" fn rotation24bpp(dx: u32, direction: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn aty_reset_engine(par: *mut atyfb_par) {
...
#[no_mangle]
unsafe extern "C" fn reset_GTC_3D_engine(par: *const atyfb_par) {
...
#[no_mangle]
pub unsafe extern "C" fn aty_init_engine(par: *mut atyfb_par, info: *mut fb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn atyfb_copyarea(info: *mut fb_info, area: *const fb_copyarea) {
    void atyfb_copyarea(struct fb_info *info, const struct fb_copyarea *area)
    {
    struct atyfb_par *par = (struct atyfb_par *) info.par;
    let mut dy: u32 = area.dy, sy = area.sy, direction = DST_LAST_PEL;
    let mut sx: u32 = area.sx, dx = area.dx, width = area.width, rotation = 0;
    if (par.asleep)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn atyfb_fillrect(info: *mut fb_info, rect: *const fb_fillrect) {
...
#[no_mangle]
pub unsafe extern "C" fn atyfb_imageblit(info: *mut fb_info, image: *const fb_image) {
