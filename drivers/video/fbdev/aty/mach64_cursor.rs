...
//! Source: drivers/video/fbdev/aty/mach64_cursor.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn comp(set: c_ulong, unset: c_ulong, mask: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn atyfb_cursor(info: *mut fb_info, cursor: *mut fb_cursor) -> c_int {
...
// Set color map
    ...
    let mut width: c_uint = (cursor.image.width + 7) >> 3;
    let mut height: c_uint = cursor.image.height;
    let mut align: c_uint = info.sprite.scan_align;
...
#[no_mangle]
pub unsafe extern "C" fn aty_init_cursor(info: *mut fb_info, atyfb_ops: *mut fb_ops) -> c_int {
