...
//! Source: drivers/video/fbdev/aty/mach64_ct.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn aty_ld_pll_ct(offset: c_int, par: *const atyfb_par) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn aty_st_pll_ct(offset: c_int, val: u8, par: *const atyfb_par) {
...
//
pub const Maximum_DSP_PRECISION: c_int = 7;
    const u8 aty_postdividers[8] = {1,2,4,8,3,5,6,12};
#[no_mangle]
unsafe extern "C" fn aty_dsp_gt(info: *const fb_info, bpp: u32, pll: *mut pll_ct) -> c_int {
    static int aty_dsp_gt(const struct fb_info *info, u32 bpp, struct pll_ct *pll)
    {
...
// Determine DSP precision first
    ...
    dsp_precision = 0;
#[no_mangle]
pub unsafe extern "C" fn if(Maximum_DSP_PRECISION: dsp_precision >) -> else {
...
#[no_mangle]
unsafe extern "C" fn aty_valid_pll_ct(info: *const fb_info, vclk_per: u32, pll: *mut pll_ct) -> c_int {
    static int aty_valid_pll_ct(const struct fb_info *info, u32 vclk_per, struct pll_ct *pll)
    {
    u32 q;
    struct atyfb_par *par = (struct atyfb_par *) info.par;
...
// Set ECP (scaler/overlay clock) divider
    ...
    let mut ecp: c_int = pllvclk / pll.vclk_post_div_real;
    let mut ecp_div: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn aty_var_to_pll_ct(info: *const fb_info, vclk_per: u32, bpp: u32, pll: *mut union aty_pll) -> c_int {
    static int aty_var_to_pll_ct(const struct fb_info *info, u32 vclk_per, u32 bpp, union aty_pll *pll)
    {
    struct atyfb_par *par = (struct atyfb_par *) info.par;
    int err;
...
#[no_mangle]
unsafe extern "C" fn aty_pll_to_var_ct(info: *const fb_info, pll: *const union aty_pll) -> u32 {
    static u32 aty_pll_to_var_ct(const struct fb_info *info, const union aty_pll *pll)
    {
    struct atyfb_par *par = (struct atyfb_par *) info.par;
    u32 ret;
...
#[no_mangle]
pub unsafe extern "C" fn aty_set_pll_ct(info: *const fb_info, pll: *const union aty_pll) {
...
// Restore mode register
    ...
    dll_cntl = 0x80;
#[no_mangle]
pub unsafe extern "C" fn if(SDRAM: par->ram_type >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn aty_get_pll_ct(info: *const fb_info, pll: *mut union aty_pll) {
...
#[no_mangle]
unsafe extern "C" fn aty_init_pll_ct(info: *const fb_info, pll: *mut union aty_pll) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dummy() -> c_int {
