...
//! Source: drivers/video/fbdev/aty/radeon_monitor.c
#![no_std]
...
//
    ...
    "EDID1", "EDID2",  core::ptr::null_mut() };
    const u8 *pedid = core::ptr::null_mut();
    const u8 *pmt = core::ptr::null_mut();
    u8 *tmp;
    int i, mt = MT_NONE;
    pr_debug("analyzing OF properties...\n");
    pmt = of_get_property(dp, "display-type", core::ptr::null_mut());
    if (!pmt)
    return MT_NONE;
...
//
    ...
    mt = MT_DFP;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(pmt, _arg: "CRT")) -> else {
...
//
    if (pedid == core::ptr::null_mut() && dp.parent && (hdno != -1))
    pedid = of_get_property(dp.parent,
    (hdno == 0) ? "EDID1" : "EDID2", core::ptr::null_mut());
    if (pedid == core::ptr::null_mut() && dp.parent && (hdno == 0))
    pedid = of_get_property(dp.parent, "EDID", core::ptr::null_mut());
    if (pedid == core::ptr::null_mut())
    return mt;
...
// out_EDID = tmp;
    ...
    let mut mt: c_int = radeon_parse_montype_prop(dp, out_EDID, 0);
...
#[no_mangle]
unsafe extern "C" fn radeon_get_panel_info_BIOS(rinfo: *mut radeonfb_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn radeon_parse_connector_info(rinfo: *mut radeonfb_info) {
...
//
#[no_mangle]
unsafe extern "C" fn radeon_crt_is_connected(rinfo: *mut radeonfb_info, is_crt_dac: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(s1, 0: "TMDS") ==) -> else {
    else if (strcmp(s1, "TMDS") == 0)
    rinfo.mon1_type = MT_DFP;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(s1, 0: "LVDS") ==) -> else {
    else if (strcmp(s1, "LVDS") == 0)
    rinfo.mon1_type = MT_LCD;
    if (strcmp(s2, "CRT") == 0)
    rinfo.mon2_type = MT_CRT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(s2, 0: "TMDS") ==) -> else {
    else if (strcmp(s2, "TMDS") == 0)
    rinfo.mon2_type = MT_DFP;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(s2, 0: "LVDS") ==) -> else {
...
//
    ...
    rinfo.mon2_EDID = core::ptr::null_mut();
    }
    } else {
//
...
//
    ...
    {
    u8 *EDIDs[4] = { core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut() };
    int i;
    for (i = 0; i < 4; i++)
...
// Always keep internal TMDS as primary head
    ...
    let mut tmp_type: c_int = rinfo.mon1_type;
    ...
    rinfo.mon1_EDID = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn radeon_fixup_panel_info(rinfo: *mut radeonfb_info) {
...
//
#[no_mangle]
unsafe extern "C" fn radeon_var_to_panel_info(rinfo: *mut radeonfb_info, var: *mut fb_var_screeninfo) {
...
#[no_mangle]
unsafe extern "C" fn is_powerblade(model: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn radeon_check_modes(rinfo: *mut radeonfb_info, mode_option: *const c_char) {
    void radeon_check_modes(struct radeonfb_info *rinfo, const char *mode_option)
    {
    let mut info: *mut fb_info = rinfo.info;
    let mut has_default_mode: c_int = 0;
//
...
//
    ...
    let mut tmp: u32 = INREG(FP_HORZ_STRETCH) & HORZ_PANEL_SIZE;
    ...
    modedb, dbsize, core::ptr::null_mut(), 8) == 0) {
...
//
    ...
    info.monspecs.modedb_len, core::ptr::null_mut(), 8) != 0)
    has_default_mode = 1;
    }
...
//
    if (!has_default_mode && info.monspecs.modedb != core::ptr::null_mut()) {
    struct fb_monspecs *specs = &info.monspecs;
    struct fb_videomode *modedb = core::ptr::null_mut();
...
//
    ...
    let mut distance: c_int = INT_MAX;
    const struct fb_videomode	*candidate = core::ptr::null_mut();
...
// If we have found a match, return it
    if (candidate != core::ptr::null_mut()) {
