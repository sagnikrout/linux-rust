...
//! Source: drivers/video/fbdev/aty/mach64_gx.c
#![no_std]
...
pub const N_ADJ_2595: c_int = 257;
pub const STOP_BITS_2595: c_uint = 0x1800;
pub const MIN_N_408: c_int = 2;
pub const MIN_N_1703: c_int = 6;
pub const MIN_M: c_int = 2;
pub const MAX_M: c_int = 30;
pub const MIN_N: c_int = 35;

//
// Support Functions
//
#[no_mangle]
unsafe extern "C" fn aty_dac_waste4(par: *const atyfb_par) {
...
#[no_mangle]
unsafe extern "C" fn aty_StrobeClock(par: *const atyfb_par) {
...
//
#[no_mangle]
unsafe extern "C" fn aty_st_514(offset: c_int, val: u8, par: *const atyfb_par) {
...
//
    ...
    mask = 0x04;
#[no_mangle]
pub unsafe extern "C" fn if(ONE_MB: info->fix.smem_len ==) -> else {
...
//
pub const A860_DELAY_L: c_uint = 0x80;
...
//
    ...
    struct atyfb_par *par = (struct atyfb_par *) info.par;
    u32 dotClock;
    let mut muxmode: c_int = 0;
    let mut DACMask: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn aty_ICS2595_put1bit(data: u8, par: *const atyfb_par) {
...
// u32 post_divider;
    ...
    let mut divider: c_short = 0, tempA;
// Calculate the programming word
    mhz100 = 100000000 / vclk_per;
