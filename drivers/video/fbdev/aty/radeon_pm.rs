...
//! Source: drivers/video/fbdev/aty/radeon_pm.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct radeon_device_id {
    pub /: *const *const *const char ident; / (arbitrary) Name,
    pub /: *const *const unsigned short subsystem_vendor; / Subsystem Vendor ID,
    pub /: *const *const unsigned short subsystem_device; / Subsystem Device ID,
    pub /: *const *const enum radeon_pm_mode pm_mode_modifier; / modify pm_mode,
    pub /: *const *const reinit_function_ptr new_reinit_func; / changed reinit_func,
}
    ...
    radeon_pm_d2, core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn radeon_apply_workarounds(rinfo: *mut radeonfb_info) -> c_int {
    static int radeon_apply_workarounds(struct radeonfb_info *rinfo)
    {
    struct radeon_device_id *id;
    for (id = radeon_workaround_list; id.ident != core::ptr::null_mut(); id++ )
...
// we found a device that requires workaround
    ...
    if (id.new_reinit_func != core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn radeon_apply_workarounds(rinfo: *mut radeonfb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_disable_dynamic_mode(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rinfo->is_mobility) -> else {
    tmp = INPLL(pllMCLK_CNTL);
    tmp |= (MCLK_CNTL__FORCE_MCLKA |
    MCLK_CNTL__FORCE_MCLKB |
    MCLK_CNTL__FORCE_YCLKA |
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_enable_dynamic_mode(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn OUTMC(rinfo: *mut radeonfb_info, indx: u8, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn INMC(rinfo: *mut radeonfb_info, indx: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_save_regs(rinfo: *mut radeonfb_info, saving_for_d3: c_int) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_restore_regs(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_disable_iopad(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_program_v2clk(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_low_current(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_setup_for_suspend(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_yclk_mclk_sync(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_yclk_mclk_sync_m10(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_m10_program_mode_wait(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_enable_dll(rinfo: *mut radeonfb_info) {
    static void radeon_pm_enable_dll(struct radeonfb_info *rinfo)
    {
pub const DLL_RESET_DELAY: c_int = 5;
pub const DLL_SLEEP_DELAY: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_enable_dll_m10(rinfo: *mut radeonfb_info) {
    static void radeon_pm_enable_dll_m10(struct radeonfb_info *rinfo)
    {
    u32 dll_value;
    let mut dll_sleep_mask: u32 = 0;
    let mut dll_reset_mask: u32 = 0;
    u32 mc;
pub const DLL_RESET_DELAY: c_int = 5;
pub const DLL_SLEEP_DELAY: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_full_reset_sdram(rinfo: *mut radeonfb_info) {
...
// This is the code for the Aluminium PowerBooks M10 / iBooks M11
    if (rinfo.family == CHIP_FAMILY_RV350) {
    let mut sdram_mode_reg: u32 = rinfo.save_regs[35];
...
// Configure and enable M & SPLLs
    ...
    if (rinfo.of_node != core::ptr::null_mut()) {
    int size;
...
#[no_mangle]
pub unsafe extern "C" fn if(CHIP_FAMILY_RV200: !rinfo->is_mobility && rinfo->family ==) -> else {
// Disable refresh
    memRefreshCntl 	= INREG( MEM_REFRESH_CNTL)
    & ~MEM_REFRESH_CNTL__MEM_REFRESH_DIS;
    OUTREG(MEM_REFRESH_CNTL, memRefreshCntl
...
// The M6
#[no_mangle]
pub unsafe extern "C" fn if(CHIP_FAMILY_RV100: rinfo->is_mobility && rinfo->family ==) -> else {
// Disable refresh
...
// M9+ (iBook G4)
#[no_mangle]
pub unsafe extern "C" fn if(CHIP_FAMILY_RV280: rinfo->family ==) -> else {
    radeon_pm_program_mode_reg(rinfo, 0x2000, 1);
    radeon_pm_program_mode_reg(rinfo, 0x0132, 1);
    radeon_pm_program_mode_reg(rinfo, 0x0032, 1);
    }
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_reset_pad_ctlr_strength(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_all_ppls_off(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_start_mclk_sclk(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_m10_disable_spread_spectrum(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_m10_enable_lvds_spread_spectrum(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_restore_pixel_pll(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_m10_reconfigure_mc(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_reinitialize_M10(rinfo: *mut radeonfb_info) {
    static void radeon_reinitialize_M10(struct radeonfb_info *rinfo)
    {
    u32 tmp, i;
...
#[no_mangle]
unsafe extern "C" fn radeon_pm_m9p_reconfigure_mc(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_reinitialize_M9P(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeon_reinitialize_QW(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
unsafe extern "C" fn radeonfb_whack_power_state(rinfo: *mut radeonfb_info, state: pci_power_t) {
...
#[no_mangle]
unsafe extern "C" fn radeon_set_suspend(rinfo: *mut radeonfb_info, suspend: c_int) {
...
#[no_mangle]
unsafe extern "C" fn radeonfb_pci_suspend_late(dev: *mut device, mesg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn radeonfb_pci_resume(dev: *mut device) -> c_int {
...
// Wakeup chip
    ...
    if (rinfo.reinit_func != core::ptr::null_mut())
...
//
#[no_mangle]
pub unsafe extern "C" fn if(radeon_pm_d2: rinfo->pm_mode &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: rinfo->dynclk ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn radeonfb_early_resume(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn radeonfb_pm_init(rinfo: *mut radeonfb_info, dynclk: c_int, ignore_devlist: c_int, force_sleep: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn radeonfb_pm_exit(rinfo: *mut radeonfb_info) {
    void radeonfb_pm_exit(struct radeonfb_info *rinfo)
    {

    if (rinfo.pm_mode != radeon_pm_none)
    pmac_set_early_video_resume(core::ptr::null_mut(), core::ptr::null_mut());
