...
//! Source: drivers/video/fbdev/aty/radeon_accel.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn radeon_fixup_offset(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn radeonfb_fillrect(info: *mut fb_info, region: *const fb_fillrect) {
...
#[no_mangle]
pub unsafe extern "C" fn radeonfb_copyarea(info: *mut fb_info, area: *const fb_copyarea) {
...
#[no_mangle]
pub unsafe extern "C" fn radeonfb_imageblit(info: *mut fb_info, image: *const fb_image) {
...
#[no_mangle]
pub unsafe extern "C" fn radeonfb_sync(info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn radeonfb_engine_reset(rinfo: *mut radeonfb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn radeonfb_engine_init(rinfo: *mut radeonfb_info) {
