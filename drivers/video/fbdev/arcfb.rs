...
//! Source: drivers/video/fbdev/arcfb.c
#![no_std]
...
pub const KS_SET_DPY_START_LINE: c_uint = 0xC0;
pub const KS_SET_PAGE_NUM: c_uint = 0xB8;
pub const KS_SET_X: c_uint = 0x40;
pub const KS_CEHI: c_uint = 0x01;
pub const KS_CELO: c_uint = 0x00;
pub const KS_SEL_CMD: c_uint = 0x08;
pub const KS_SEL_DATA: c_uint = 0x00;
pub const KS_DPY_ON: c_uint = 0x3F;
pub const KS_DPY_OFF: c_uint = 0x3E;
pub const KS_INTACK: c_uint = 0x40;
pub const KS_CLRINT: c_uint = 0x02;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct arcfb_par {
    pub dio_addr: c_ulong,
    pub cio_addr: c_ulong,
    pub c2io_addr: c_ulong,
    ...
    {
    let mut chipselval: c_uchar = par.cslut[chipindex];
...
#[no_mangle]
unsafe extern "C" fn ks108_writeb_mainctl(par: *mut arcfb_par, value: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn ks108_readb_ctl2(par: *mut arcfb_par) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn ks108_clear_lcd(par: *mut arcfb_par, chipindex: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn arcfb_open(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arcfb_release(info: *mut fb_info, user: c_int) -> c_int {
    static int arcfb_release(struct fb_info *info, int user)
    {
    struct arcfb_par *par = info.par;
    let mut count: c_int = atomic_read(&par.ref_count);
    if (!count)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn arcfb_interrupt(vec: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn arcfb_damage_range(info: *mut fb_info, off: off_t, len: usize) {
    static void arcfb_damage_range(struct fb_info *info, off_t off, size_t len)
    {
    struct arcfb_par *par = info.par;
    let mut xres: c_uint = info.var.xres;
...
#[no_mangle]
unsafe extern "C" fn arcfb_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arcfb_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn arcfb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn arcfb_exit() -> void __exit {
