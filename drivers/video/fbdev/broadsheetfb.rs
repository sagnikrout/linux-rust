...
//! Source: drivers/video/fbdev/broadsheetfb.c
#![no_std]
...
pub const DPY_W: c_int = 800;
pub const DPY_H: c_int = 600;
...
#[no_mangle]
unsafe extern "C" fn broadsheet_gpio_issue_data(par: *mut broadsheetfb_par, data: u16) {
...
#[no_mangle]
unsafe extern "C" fn broadsheet_gpio_issue_cmd(par: *mut broadsheetfb_par, data: u16) {
...
#[no_mangle]
unsafe extern "C" fn broadsheet_gpio_send_command(par: *mut broadsheetfb_par, data: u16) {
...
#[no_mangle]
unsafe extern "C" fn broadsheet_send_command(par: *mut broadsheetfb_par, data: u16) {
...
#[no_mangle]
unsafe extern "C" fn broadsheet_gpio_get_data(par: *mut broadsheetfb_par) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn broadsheet_get_data(par: *mut broadsheetfb_par) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn broadsheet_read_reg(par: *mut broadsheetfb_par, reg: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn is_broadsheet_pll_locked(par: *mut broadsheetfb_par) -> c_int {
    static int is_broadsheet_pll_locked(struct broadsheetfb_par *par)
    {
    return broadsheet_read_reg(par, 0x000A) & 0x0001;
    }
#[no_mangle]
unsafe extern "C" fn broadsheet_setup_plls(par: *mut broadsheetfb_par) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn broadsheet_setup_spi(par: *mut broadsheetfb_par) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn broadsheet_spiflash_write_byte(par: *mut broadsheetfb_par, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn broadsheet_spiflash_read_byte(par: *mut broadsheetfb_par, data: *mut u8) -> c_int {
...
pub const BS_SPIFLASH_PAGE_SIZE: c_int = 256;
...
// now write it
    ...
    {
    let mut err: c_int = 0;
    let mut initial_sfmcd: u16 = 0;
    let mut flash_type: c_int = 0;
...
// try to enforce reasonable min max on waveform
    ...
    static DEVICE_ATTR(loadstore_waveform, S_IWUSR, core::ptr::null_mut(),
    broadsheet_loadstore_waveform);
// upper level functions that manipulate the display and other stuff
#[no_mangle]
unsafe extern "C" fn broadsheet_init_display(par: *mut broadsheetfb_par) {
    static void broadsheet_init_display(struct broadsheetfb_par *par)
    {
    u16 args[5];
    let mut xres: c_int = par.info.var.xres;
    let mut yres: c_int = par.info.var.yres;
...
#[no_mangle]
unsafe extern "C" fn broadsheet_identify(par: *mut broadsheetfb_par) {
...
#[no_mangle]
unsafe extern "C" fn broadsheet_init(par: *mut broadsheetfb_par) {
...
#[no_mangle]
unsafe extern "C" fn broadsheetfb_dpy_update(par: *mut broadsheetfb_par) {
...
#[no_mangle]
unsafe extern "C" fn broadsheetfb_dpy_deferred_io(info: *mut fb_info, pagereflist: *mut list_head) {
    static void broadsheetfb_dpy_deferred_io(struct fb_info *info, struct list_head *pagereflist)
    {
    let mut y1: u16 = 0, h = 0;
    let mut prev_offset: c_ulong = ULONG_MAX;
    struct fb_deferred_io_pageref *pageref;
    int h_inc;
    let mut yres: u16 = info.var.yres;
    let mut xres: u16 = info.var.xres;
...
#[no_mangle]
unsafe extern "C" fn broadsheetfb_defio_damage_range(info: *mut fb_info, off: off_t, len: usize) {
...
#[no_mangle]
unsafe extern "C" fn broadsheetfb_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn broadsheetfb_remove(dev: *mut platform_device) {
