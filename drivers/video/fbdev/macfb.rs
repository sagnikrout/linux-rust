...
//! Source: drivers/video/fbdev/macfb.c
#![no_std]
...
pub const DAC_BASE: c_uint = 0x50f24000;
// Some addresses for the DAFB
pub const DAFB_BASE: c_uint = 0xf9800200;
// Address for the built-in Civic framebuffer in Quadra AVs
pub const CIVIC_BASE: c_uint = 0x50f30800;
// GSC (Gray Scale Controller) base address
pub const GSC_BASE: c_uint = 0x50F20000;
// CSC (Color Screen Controller) base address
pub const CSC_BASE: c_uint = 0x50F20000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mdc_cmap_regs {
    pub pad1: [c_char; 0x200200],
    pub addr: c_uchar,
    pub pad2: [c_char; 6],
    pub lut: c_uchar,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct toby_cmap_regs {
    pub pad1: [c_char; 0x90018],
    pub /: *mut *mut unsigned char lut; / TFBClutWDataReg, offset 0x90018,
    pub pad2: [c_char; 3],
    pub /: *mut *mut unsigned char addr; / TFBClutAddrReg, offset 0x9001C,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct jet_cmap_regs {
    pub pad1: [c_char; 0xe0e000],
    pub addr: c_uchar,
    pub lut: c_uchar,
}
...
// V8 and Brazil seem to use the same DAC.  Sonora does as well.
    ...
    struct fb_info *info)
    {
    let mut bpp: c_uint = info.var.bits_per_pixel;
    unsigned long flags;
    local_irq_save(flags);
...
#[no_mangle]
unsafe extern "C" fn macfb_setup(options: *mut c_char) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn iounmap_macfb() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn macfb_init() -> int __init {
    static int __init macfb_init(void)
    {
    int video_cmap_len, video_is_nubus = 0;
    struct nubus_rsrc *ndev = core::ptr::null_mut();
...
//
    ...
    let mut base: c_ulong = ndev.board.slot_addr;
