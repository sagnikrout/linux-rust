...
//! Source: drivers/video/fbdev/mmp/panel/tpo_tj032md01bw.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpohvga_plat_data {
    pub status): *mut *mut void (plat_onoff)(int,
    pub spi: *mut spi_device,
}

#[no_mangle]
unsafe extern "C" fn tpohvga_onoff(panel: *mut mmp_panel, status: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tpohvga_probe(spi: *mut spi_device) -> c_int {
...
// setup spi related info
    ...
    if (plat_data == core::ptr::null_mut())
    return -ENOMEM;
    plat_data.spi = spi;
