...
//! Source: drivers/video/fbdev/mmp/core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn path_check_status(path: *mut mmp_path) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mmp_register_panel(panel: *mut mmp_panel) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mmp_unregister_panel(panel: *mut mmp_panel) {
...
//
    ...
    {
    struct mmp_path *path = core::ptr::null_mut(), *iter;
    mutex_lock(&disp_lock);
...
//
    ...
    {
    int i;
    struct mmp_path *path = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn mmp_unregister_path(path: *mut mmp_path) {
