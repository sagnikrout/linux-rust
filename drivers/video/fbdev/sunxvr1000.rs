...
//! Source: drivers/video/fbdev/sunxvr1000.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gfb_get_props(gp: *mut gfb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gfb_set_fbinfo(gp: *mut gfb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gfb_probe(op: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gfb_init() -> int __init {
    static int __init gfb_init(void)
    {
    if (fb_get_options("gfb", core::ptr::null_mut()))
    return -ENODEV;
