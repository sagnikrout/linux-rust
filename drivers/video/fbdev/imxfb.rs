...
//! Source: drivers/video/fbdev/imxfb.c
#![no_std]
...
//
pub const DEBUG_VAR: c_int = 1;

pub const LCDC_SSA: c_uint = 0x00;
pub const LCDC_SIZE: c_uint = 0x04;

pub const LCDC_VPW: c_uint = 0x08;

pub const LCDC_CPOS: c_uint = 0x0C;

pub const LCDC_LCWHB: c_uint = 0x10;

pub const LCDC_LCHCC: c_uint = 0x14;
pub const LCDC_PCR: c_uint = 0x18;

pub const PCR_BPIX_8: c_int = 3;
pub const PCR_BPIX_12: c_int = 4;
pub const PCR_BPIX_16: c_int = 5;
pub const PCR_BPIX_18: c_int = 6;

pub const LCDC_HCR: c_uint = 0x1C;

pub const LCDC_VCR: c_uint = 0x20;

pub const LCDC_POS: c_uint = 0x24;

pub const LCDC_LSCR1: c_uint = 0x28;
// bit fields in imxfb.h
pub const LCDC_PWMR: c_uint = 0x2C;
// bit fields in imxfb.h
pub const LCDC_DMACR: c_uint = 0x30;
// bit fields in imxfb.h
pub const LCDC_RMCR: c_uint = 0x34;

pub const LCDC_LCDICR: c_uint = 0x38;

pub const LCDC_LCDISR: c_uint = 0x40;

pub const IMXFB_LSCR1_DEFAULT: c_uint = 0x00120300;
pub const LCDC_LAUSCR: c_uint = 0x80;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imxfb_info {
    pub pdev: *mut platform_device,
    pub regs: *mut void __iomem,
    pub clk_ipg: *mut clk,
    pub clk_ahb: *mut clk,
    pub clk_per: *mut clk,
    pub devtype: enum imxfb_type,
    pub panel_type: enum imxfb_panel_type,
    pub enabled: bool,
//
...
//
    ...
    pub lscr1: u_int,
    pub dmacr: u_int,
    pub cmap_inverse: bool,
    pub cmap_static: bool,
    pub mode: *mut imx_fb_videomode,
    pub num_modes: c_int,
    pub lcd_pwr: *mut regulator,
    pub lcd_pwr_enabled: c_int,
}
...
#[no_mangle]
pub unsafe extern "C" fn is_imx1_fb(fbi: *mut imxfb_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imxfb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCR_COLOR: imxfb_mode->pcr &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn imxfb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !fbi->cmap_static) -> else {
...
#[no_mangle]
unsafe extern "C" fn imxfb_enable_controller(fbi: *mut imxfb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imxfb_disable_controller(fbi: *mut imxfb_info) {
...
#[no_mangle]
unsafe extern "C" fn imxfb_blank(blank: c_int, info: *mut fb_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn imxfb_activate_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
    static int imxfb_activate_var(struct fb_var_screeninfo *var, struct fb_info *info)
    {
    struct imxfb_info *fbi = info.par;
    let mut ymax_mask: u32 = is_imx1_fb(fbi) ? YMAX_MASK_IMX1 : YMAX_MASK_IMX21;
    u8 left_margin_low;
    ...
    left_margin_low = 3;
#[no_mangle]
pub unsafe extern "C" fn if(PANEL_TYPE_CSTN: fbi->panel_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn imxfb_init_fbinfo(pdev: *mut platform_device) -> c_int {
    ...
    if (ret)
    of_mode.name = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn imxfb_lcd_get_contrast(lcddev: *mut lcd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imxfb_lcd_set_contrast(lcddev: *mut lcd_device, contrast: c_int) -> c_int {
    ...
    contrast = 255;
#[no_mangle]
pub unsafe extern "C" fn if(0: contrast <) -> else {
    else if (contrast < 0)
    contrast = 0;
    fbi.pwmr &= ~0xff;
    fbi.pwmr |= contrast;
...
#[no_mangle]
unsafe extern "C" fn imxfb_lcd_get_power(lcddev: *mut lcd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imxfb_regulator_set(fbi: *mut imxfb_info, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imxfb_lcd_set_power(lcddev: *mut lcd_device, power: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imxfb_setup() -> c_int {
    static int imxfb_setup(void)
    {
    char *opt, *options = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn imxfb_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imxfb_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn imxfb_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imxfb_resume(dev: *mut device) -> c_int {
