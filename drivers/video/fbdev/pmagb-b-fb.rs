...
//! Source: drivers/video/fbdev/pmagb-b-fb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmagbbfb_par {
    pub mmio: *mut volatile void __iomem,
    pub smem: *mut volatile void __iomem,
    pub sfb: *mut volatile u32 __iomem,
    pub dac: *mut volatile u32 __iomem,
    pub osc0: c_uint,
    pub osc1: c_uint,
    pub slot: c_int,
}
...
//
#[no_mangle]
unsafe extern "C" fn pmagbbfb_erase_cursor(info: *mut fb_info) {
...
//
#[no_mangle]
unsafe extern "C" fn pmagbbfb_screen_setup(info: *mut fb_info) {
...
//
#[no_mangle]
unsafe extern "C" fn pmagbbfb_osc_setup(info: *mut fb_info) {
    ...
    let mut count0: u32 = 8, count1 = 8, counttc = 16 * 256 + 8;
...
#[no_mangle]
unsafe extern "C" fn pmagbbfb_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmagbbfb_remove(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmagbbfb_init() -> int __init {
    static int __init pmagbbfb_init(void)
    {

    if (fb_get_options("pmagbbfb", core::ptr::null_mut()))
    return -ENXIO;

    return tc_register_driver(&pmagbbfb_driver);
    }
#[no_mangle]
unsafe extern "C" fn pmagbbfb_exit() -> void __exit {
