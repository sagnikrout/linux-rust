...
//! Source: drivers/video/fbdev/wm8505fb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wm8505fb_init_hw(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8505fb_set_timing(info: *mut fb_info) -> c_int {
    static int wm8505fb_set_timing(struct fb_info *info)
    {
    struct wm8505fb_info *fbi = to_wm8505fb_info(info);
    let mut h_start: c_int = info.var.left_margin;
    let mut h_end: c_int = h_start + info.var.xres;
    let mut h_all: c_int = h_end + info.var.right_margin;
    let mut h_sync: c_int = info.var.hsync_len;
    let mut v_start: c_int = info.var.upper_margin;
    let mut v_end: c_int = v_start + info.var.yres;
    let mut v_all: c_int = v_end + info.var.lower_margin;
    let mut v_sync: c_int = info.var.vsync_len;
...
#[no_mangle]
unsafe extern "C" fn wm8505fb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8505fb_blank(blank: c_int, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8505fb_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8505fb_remove(pdev: *mut platform_device) {
