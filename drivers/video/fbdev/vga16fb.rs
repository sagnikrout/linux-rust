...
//! Source: drivers/video/fbdev/vga16fb.c
#![no_std]
...
pub const MODE_SKIP4: c_int = 1;
pub const MODE_8BPP: c_int = 2;
pub const MODE_CFB: c_int = 4;
pub const MODE_TEXT: c_int = 8;
// ---------------------------------------------------------------------
//
// card parameters
//
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vga16fb_par {
// structure holding original VGA register settings when the
    screen is blanked */
    struct {
    pub /: *mut *mut unsigned char SeqCtrlIndex; / Sequencer Index reg.,
    pub /: *mut *mut unsigned char CrtCtrlIndex; / CRT-Contr. Index reg.,
    pub /: *mut *mut unsigned char CrtMiscIO; / Miscellaneous register,
    pub /: *mut *mut unsigned char HorizontalTotal; / CRT-Controller:00h,
    pub /: *mut *mut unsigned char HorizDisplayEnd; / CRT-Controller:01h,
    pub /: *mut *mut unsigned char StartHorizRetrace;/ CRT-Controller:04h,
    pub /: *mut *mut unsigned char EndHorizRetrace; / CRT-Controller:05h,
    pub /: *mut *mut unsigned char Overflow; / CRT-Controller:07h,
    pub /: *mut *mut unsigned char StartVertRetrace; / CRT-Controller:10h,
    pub /: *mut *mut unsigned char EndVertRetrace; / CRT-Controller:11h,
    pub /: *mut *mut unsigned char ModeControl; / CRT-Controller:17h,
    pub /: *mut *mut unsigned char ClockingMode; / Seq-Controller:01h,
    pub vga_state: },
    pub state: vgastate,
    pub ref_count: c_uint,
    pub isVGA: int palette_blanked, vesa_blanked, mode,,
    pub clkdiv: u8 misc, pel_msk, vss,,
    pub crtc: [u8; VGA_CRT_C],
}
...
// The VGA's weird architecture often requires that we read a byte and
    ...
    OR. */
#[no_mangle]
pub unsafe extern "C" fn rmw(p: *mut volatile char __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn setmode(mode: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn selectmask() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn setmask(mask: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn setop(op: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn setsr(sr: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn setcolor(color: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn getindex() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn setindex(index: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn check_mode_supported(si: *const screen_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vga16fb_update_fix(info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn vga16fb_open(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vga16fb_release(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vga16fb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MODE_SKIP4: par->mode &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(MODE_8BPP: par->mode &) -> else {
...
#[no_mangle]
unsafe extern "C" fn ega16_setpalette(regno: c_int, red: unsigned, green: unsigned, blue: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn vga16_setpalette(regno: c_int, red: unsigned, green: unsigned, blue: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn vga_vesa_blank(par: *mut vga16fb_par, mode: c_int) {
    static void vga_vesa_blank(struct vga16fb_par *par, int mode)
    {
    let mut SeqCtrlIndex: c_uchar = vga_io_r(VGA_SEQ_I);
    let mut CrtCtrlIndex: c_uchar = vga_io_r(VGA_CRT_IC);
...
#[no_mangle]
unsafe extern "C" fn vga_vesa_unblank(par: *mut vga16fb_par) {
...
#[no_mangle]
unsafe extern "C" fn vga_pal_blank() {
...
#[no_mangle]
unsafe extern "C" fn vga16fb_blank(blank: c_int, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vga_8planes_fillrect(info: *mut fb_info, rect: *const fb_fillrect) {
    static void vga_8planes_fillrect(struct fb_info *info, const struct fb_fillrect *rect)
    {
    let mut dx: u32 = rect.dx, width = rect.width;
    let mut oldindex: c_char = getindex();
    let mut oldmode: c_char = setmode(0x40);
    let mut oldmask: c_char = selectmask();
    int line_ofs, height;
    char oldop, oldsr;
    char __iomem *where;
    dx /= 4;
...
// we can do memset...
    ...
    let mut oldcolor: c_char = setcolor(0xf);
    int y;
    oldop = setop(0x18);
    oldsr = setsr(0xf);
    setmask(0x0F);
...
#[no_mangle]
unsafe extern "C" fn vga16fb_fillrect(info: *mut fb_info, rect: *const fb_fillrect) {
...
#[no_mangle]
unsafe extern "C" fn vga_8planes_copyarea(info: *mut fb_info, area: *const fb_copyarea) {
    static void vga_8planes_copyarea(struct fb_info *info, const struct fb_copyarea *area)
    {
    let mut oldindex: c_char = getindex();
    let mut oldmode: c_char = setmode(0x41);
    let mut oldop: c_char = setop(0);
    let mut oldsr: c_char = setsr(0xf);
...
#[no_mangle]
unsafe extern "C" fn vga16fb_copyarea(info: *mut fb_info, area: *const fb_copyarea) {
    static void vga16fb_copyarea(struct fb_info *info, const struct fb_copyarea *area)
    {
    let mut dx: u32 = area.dx, dy = area.dy, sx = area.sx, sy = area.sy;
    int x, x2, y2, old_dx, old_dy, vxres, vyres;
    int height, width, line_ofs;
    char __iomem *dst = core::ptr::null_mut();
    char __iomem *src = core::ptr::null_mut();
    vxres = info.var.xres_virtual;
    vyres = info.var.yres_virtual;
...
#[no_mangle]
unsafe extern "C" fn vga_8planes_imageblit(info: *mut fb_info, image: *const fb_image) {
    static void vga_8planes_imageblit(struct fb_info *info, const struct fb_image *image)
    {
    let mut oldindex: c_char = getindex();
    let mut oldmode: c_char = setmode(0x40);
    let mut oldop: c_char = setop(0);
    let mut oldsr: c_char = setsr(0);
    let mut oldmask: c_char = selectmask();
    const unsigned char *cdat = image.data;
    let mut dx: u32 = image.dx;
    char __iomem *where;
    int y;
    dx /= 4;
...
#[no_mangle]
unsafe extern "C" fn vga_imageblit_expand(info: *mut fb_info, image: *const fb_image) {
...
#[no_mangle]
unsafe extern "C" fn vga_imageblit_color(info: *mut fb_info, image: *const fb_image) {
...
#[no_mangle]
unsafe extern "C" fn vga16fb_imageblit(info: *mut fb_info, image: *const fb_image) {
...
#[no_mangle]
unsafe extern "C" fn vga16fb_destroy(info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn vga16fb_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vga16fb_remove(dev: *mut platform_device) {
