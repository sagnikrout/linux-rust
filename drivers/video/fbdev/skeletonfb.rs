...
//! Source: drivers/video/fbdev/skeletonfb.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn xxxfb_open(info: *mut fb_info, user: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xxxfb_release(info: *mut fb_info, user: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xxxfb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xxxfb_set_par(info: *mut fb_info) -> c_int {
    static int xxxfb_set_par(struct fb_info *info)
    {
...
//
#[no_mangle]
unsafe extern "C" fn xxxfb_blank(blank_mode: c_int, info: *mut fb_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn xxxfb_fillrect(p: *mut fb_info, region: *const fb_fillrect) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xxxfb_copyarea(p: *mut fb_info, area: *const fb_copyarea) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xxxfb_imageblit(p: *mut fb_info, image: *const fb_image) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xxxfb_cursor(info: *mut fb_info, cursor: *mut fb_cursor) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn xxxfb_sync(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xxxfb_probe(dev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xxxfb_remove(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn xxxfb_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xxxfb_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xxxfb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn xxxfb_exit() -> void __exit {
...
//
#[no_mangle]
unsafe extern "C" fn xxxfb_suspend(dev: *mut platform_device, msg: pm_message_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xxxfb_resume(dev: *mut platform_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xxxfb_setup(options: *mut c_char) -> int __init {
