...
//! Source: drivers/video/fbdev/68328fb.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn mc68x328fb_set_par(info: *mut fb_info) -> c_int {
    static int mc68x328fb_set_par(struct fb_info *info)
    {
...
//
#[no_mangle]
unsafe extern "C" fn mc68x328fb_mmap(info: *mut fb_info, vma: *mut vm_area_struct) -> c_int {
    static int mc68x328fb_mmap(struct fb_info *info, struct vm_area_struct *vma)
    {
...
#[no_mangle]
unsafe extern "C" fn mc68x328fb_setup(options: *mut c_char) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn mc68x328fb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mc68x328fb_cleanup() -> void __exit {
