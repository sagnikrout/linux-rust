...
//! Source: drivers/video/fbdev/omap2/omapfb/omapfb-ioctl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_mem_idx(ofbi: *mut omapfb_info) -> u8 {
...
// ck = omapfb_color_keys[mgr->id];
    ...
    {
    let mut ovl_idx: c_int = mode.overlay_idx;
    let mut mode_idx: c_int = mode.mode_idx;
    struct omap_overlay *ovl;
...
#[no_mangle]
unsafe extern "C" fn omapfb_wait_for_go(fbi: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn omapfb_ioctl(fbi: *mut fb_info, cmd: c_uint, arg: c_ulong) -> c_int {
