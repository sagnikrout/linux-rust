...
//! Source: drivers/video/fbdev/omap2/omapfb/omapfb-sysfs.c
#![no_std]
...
// FIXME error handling?
    ...
    __ATTR(phys_addr, S_IRUGO, show_phys, core::ptr::null_mut()),
    __ATTR(virt_addr, S_IRUGO, show_virt, core::ptr::null_mut()),
    __ATTR(update_mode, S_IRUGO | S_IWUSR, show_upd_mode, store_upd_mode),
    };
#[no_mangle]
pub unsafe extern "C" fn omapfb_create_sysfs(fbdev: *mut omapfb2_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn omapfb_remove_sysfs(fbdev: *mut omapfb2_device) {
