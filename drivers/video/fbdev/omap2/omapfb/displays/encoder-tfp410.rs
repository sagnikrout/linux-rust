...
//! Source: drivers/video/fbdev/omap2/omapfb/displays/encoder-tfp410.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tfp410_enable(dssdev: *mut omap_dss_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tfp410_disable(dssdev: *mut omap_dss_device) {
...
#[no_mangle]
unsafe extern "C" fn tfp410_fix_timings(timings: *mut omap_video_timings) {
