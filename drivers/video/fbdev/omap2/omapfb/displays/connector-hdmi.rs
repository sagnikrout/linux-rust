...
//! Source: drivers/video/fbdev/omap2/omapfb/displays/connector-hdmi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hdmic_connect(dssdev: *mut omap_dss_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmic_disconnect(dssdev: *mut omap_dss_device) {
...
#[no_mangle]
unsafe extern "C" fn hdmic_enable(dssdev: *mut omap_dss_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmic_disable(dssdev: *mut omap_dss_device) {
...
#[no_mangle]
unsafe extern "C" fn hdmic_detect(dssdev: *mut omap_dss_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hdmic_set_hdmi_mode(dssdev: *mut omap_dss_device, hdmi_mode: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmic_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hdmic_remove(pdev: *mut platform_device) {
