...
//! Source: drivers/video/fbdev/omap2/omapfb/displays/panel-nec-nl8048hl11.c
#![no_std]
...
pub struct panel_drv_data {
    ...
    pub res_gpio: *mut gpio_desc,
    pub spi: *mut spi_device,
}

pub const LCD_XRES: c_int = 800;
pub const LCD_YRES: c_int = 480;
//
// NEC PIX Clock Ratings
// MIN:21.8MHz TYP:23.8MHz MAX:25.7MHz
//
pub const LCD_PIXEL_CLOCK: c_int = 23800000;
    static const struct {
    unsigned char addr;
    unsigned char dat;
    } nec_8048_init_seq[] = {
...
#[no_mangle]
unsafe extern "C" fn init_nec_8048_wvga_lcd(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nec_8048_connect(dssdev: *mut omap_dss_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nec_8048_disconnect(dssdev: *mut omap_dss_device) {
...
#[no_mangle]
unsafe extern "C" fn nec_8048_enable(dssdev: *mut omap_dss_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nec_8048_disable(dssdev: *mut omap_dss_device) {
...
#[no_mangle]
unsafe extern "C" fn nec_8048_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nec_8048_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn nec_8048_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nec_8048_resume(dev: *mut device) -> c_int {
