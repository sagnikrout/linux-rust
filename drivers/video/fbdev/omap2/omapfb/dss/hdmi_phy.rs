...
//! Source: drivers/video/fbdev/omap2/omapfb/dss/hdmi_phy.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hdmi_phy_features {
    pub bist_ctrl: bool,
    pub ldo_voltage: bool,
    pub max_phy: c_ulong,
}
...
//
    ...
    freqout = 0;
#[no_mangle]
pub unsafe extern "C" fn if(phy_feat->max_phy: hfbitclk / 10 <) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn hdmi_phy_init(pdev: *mut platform_device, phy: *mut hdmi_phy_data) -> c_int {
