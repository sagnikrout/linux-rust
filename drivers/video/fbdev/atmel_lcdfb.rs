...
//! Source: drivers/video/fbdev/atmel_lcdfb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_lcdfb_config {
    pub have_alt_pixclock: bool,
    pub have_hozval: bool,
    pub have_intensity_bit: bool,
}

// LCD Controller info data structure, stored in device platform_data
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_lcdfb_info {
    pub lock: spinlock_t,
    ...
    pub bus_clk: *mut clk,
    pub lcdc_clk: *mut clk,
    pub backlight: *mut backlight_device,
    pub saved_lcdcon: u8,
    pub pseudo_palette: [u32; 16],
    pub have_intensity_bit: bool,
    pub pdata: atmel_lcdfb_pdata,
    pub config: *const atmel_lcdfb_config,
    pub reg_lcd: *mut regulator,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_lcdfb_power_ctrl_gpio {
    pub gpiod: *mut gpio_desc,
    pub list: list_head,
}

// configurable parameters
pub const ATMEL_LCDC_CVAL_DEFAULT: c_uint = 0xc8;
...
#[no_mangle]
unsafe extern "C" fn atmel_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_bl_get_brightness(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_backlight(sinfo: *mut atmel_lcdfb_info) {
...
#[no_mangle]
unsafe extern "C" fn exit_backlight(sinfo: *mut atmel_lcdfb_info) {
...
#[no_mangle]
unsafe extern "C" fn init_contrast(sinfo: *mut atmel_lcdfb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn atmel_lcdfb_power_control(sinfo: *mut atmel_lcdfb_info, on: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sinfo->reg_lcd) -> else {
    if (on) {
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_stop_nowait(sinfo: *mut atmel_lcdfb_info) {
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_stop(sinfo: *mut atmel_lcdfb_info) {
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_start(sinfo: *mut atmel_lcdfb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn atmel_lcdfb_free_video_memory(sinfo: *mut atmel_lcdfb_info) {
...
//
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_alloc_video_memory(sinfo: *mut atmel_lcdfb_info) -> c_int {
...
// ((var->bits_per_pixel + 7) / 8));
    ...
    const struct fb_videomode *fbmode = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_reset(sinfo: *mut atmel_lcdfb_info) {
...
//
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(8: info->var.bits_per_pixel <=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn chan_to_field(chan: c_uint, bf: *const fb_bitfield) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_blank(blank_mode: c_int, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_init_fbinfo(sinfo: *mut atmel_lcdfb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_start_clock(sinfo: *mut atmel_lcdfb_info) {
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_stop_clock(sinfo: *mut atmel_lcdfb_info) {
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_get_of_wiring_modes(np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_power_control_gpio(pdata: *mut atmel_lcdfb_pdata, on: c_int) {
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_of_init(sinfo: *mut atmel_lcdfb_info) -> c_int {
    ...
    struct atmel_lcdfb_power_ctrl_gpio *og;
    let mut is_gpio_power: bool = false;
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_probe(pdev: *mut platform_device) -> c_int {
    static int atmel_lcdfb_probe(struct platform_device *pdev)
    {
    struct device *dev = &pdev.dev;
    struct fb_info *info;
    struct atmel_lcdfb_info *sinfo;
    struct resource *regs = core::ptr::null_mut();
    struct resource *map = core::ptr::null_mut();
    ...
    sinfo.reg_lcd = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_suspend(pdev: *mut platform_device, mesg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_lcdfb_resume(pdev: *mut platform_device) -> c_int {
