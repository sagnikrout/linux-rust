...
//! Source: drivers/video/fbdev/pm3fb.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct pm3_par {
    pub /: *mut *mut *mut unsigned char __iomem v_regs;/ virtual address of p_regs,
    pub /: *mut *mut u32 video; / video flags before blanking,
    pub /: *mut *mut u32 base; / screen base in 128 bits unit,
    pub palette: [u32; 16],
    pub wc_cookie: c_int,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn PM3_READ_REG(par: *mut pm3_par, off: i32) -> u32 {
    static inline u32 PM3_READ_REG(struct pm3_par *par, s32 off)
    {
    return fb_readl(par.v_regs + off);
    }
#[no_mangle]
pub unsafe extern "C" fn PM3_WRITE_REG(par: *mut pm3_par, off: i32, v: u32) {
    static inline void PM3_WRITE_REG(struct pm3_par *par, s32 off, u32 v)
    {
    fb_writel(v, par.v_regs + off);
    }
#[no_mangle]
pub unsafe extern "C" fn PM3_WAIT(par: *mut pm3_par, n: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn PM3_WRITE_DAC_REG(par: *mut pm3_par, r: unsigned, v: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn pm3fb_depth(var: *const fb_var_screeninfo) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pm3fb_shift_bpp(bpp: unsigned, v: c_int) -> c_int {
...
// acceleration
#[no_mangle]
unsafe extern "C" fn pm3fb_sync(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm3fb_init_engine(info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn pm3fb_imageblit(info: *mut fb_info, image: *const fb_image) {
...
// ROP Ox3 is GXcopy
    ...
    let mut i: c_int = PM3_FIFO_SIZE - 1;
...
#[no_mangle]
unsafe extern "C" fn pm3fb_cursor(info: *mut fb_info, cursor: *mut fb_cursor) -> c_int {
...
// the X11 driver says one should use these color registers
    ...
    int i;
    let mut pos: c_int = PM3RD_CursorPattern(0);
...
#[no_mangle]
unsafe extern "C" fn pm3fb_write_mode(info: *mut fb_info) {
    static void pm3fb_write_mode(struct fb_info *info)
    {
    struct pm3_par *par = info.par;
    let mut tempsync: c_char = 0x00;
    let mut tempmisc: c_char = 0x00;
    let mut hsstart: u32 = info.var.right_margin;
    let mut hsend: u32 = hsstart + info.var.hsync_len;
    let mut hbend: u32 = hsend + info.var.left_margin;
    let mut xres: u32 = (info.var.xres + 31) & ~31;
    let mut htotal: u32 = xres + hbend;
    let mut vsstart: u32 = info.var.lower_margin;
    let mut vsend: u32 = vsstart + info.var.vsync_len;
    let mut vbend: u32 = vsend + info.var.upper_margin;
    let mut vtotal: u32 = info.var.yres + vbend;
    let mut width: u32 = (info.var.xres_virtual + 7) & ~7;
    let mut bpp: unsigned = info.var.bits_per_pixel;
    PM3_WAIT(par, 20);
...
//
    {
    let mut video: c_uint = par.video;
    ...
    let mut pixclock: c_ulong = PICOS2KHZ(info.var.pixclock);
...
//
#[no_mangle]
unsafe extern "C" fn pm3fb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm3fb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm3fb_blank(blank_mode: c_int, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm3fb_size_memory(par: *mut pm3_par) -> c_ulong {
    static unsigned long pm3fb_size_memory(struct pm3_par *par)
    {
    let mut memsize: c_ulong = 0;
...
#[no_mangle]
unsafe extern "C" fn pm3fb_probe(dev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
//
    ...
    retval = fb_find_mode(&info.var, info, mode_option, core::ptr::null_mut(), 0, core::ptr::null_mut(), 8);
    if (!retval || retval == 4) {
    retval = -EINVAL;
    goto err_exit_both;
    }
...
//
#[no_mangle]
unsafe extern "C" fn pm3fb_remove(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pm3fb_setup(options: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pm3fb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pm3fb_exit() -> void __exit {
