...
//! Source: drivers/video/fbdev/vt8623fb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vt8623fb_info {
    pub mmio_base: *mut char __iomem,
    pub wc_cookie: c_int,
    pub state: vgastate,
    pub open_lock: mutex,
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn vt8623fb_tilecursor(info: *mut fb_info, cursor: *mut fb_tilecursor) {
...
#[no_mangle]
unsafe extern "C" fn vt8623fb_iplan_imageblit(info: *mut fb_info, image: *const fb_image) {
...
#[no_mangle]
unsafe extern "C" fn vt8623fb_iplan_fillrect(info: *mut fb_info, rect: *const fb_fillrect) {
...
#[no_mangle]
unsafe extern "C" fn vt8623fb_cfb4_imageblit(info: *mut fb_info, image: *const fb_image) {
...
#[no_mangle]
unsafe extern "C" fn vt8623fb_imageblit(info: *mut fb_info, image: *const fb_image) {
...
#[no_mangle]
unsafe extern "C" fn vt8623fb_fillrect(info: *mut fb_info, rect: *const fb_fillrect) {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn vt8623_set_pixclock(info: *mut fb_info, pixclock: u32) {
...
#[no_mangle]
unsafe extern "C" fn vt8623fb_open(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vt8623fb_release(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vt8623fb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
// Find appropriate format
    rv = svga_match_format (vt8623fb_formats, var, core::ptr::null_mut());
    if (rv < 0)
    {
...
#[no_mangle]
unsafe extern "C" fn vt8623fb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vt8623fb_blank(blank_mode: c_int, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vt8623fb_pan_display(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
// PCI probe
#[no_mangle]
unsafe extern "C" fn vt8623_pci_probe(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
// PCI remove
#[no_mangle]
unsafe extern "C" fn vt8623_pci_remove(dev: *mut pci_dev) {
...
// PCI suspend
#[no_mangle]
unsafe extern "C" fn vt8623_pci_suspend(dev: *mut device) -> int __maybe_unused {
...
// PCI resume
#[no_mangle]
unsafe extern "C" fn vt8623_pci_resume(dev: *mut device) -> int __maybe_unused {
...
// Cleanup
#[no_mangle]
unsafe extern "C" fn vt8623fb_cleanup() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn vt8623fb_init() -> int __init {
