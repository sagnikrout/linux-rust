...
//! Source: drivers/video/fbdev/sstfb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sst_dbg_print_read_reg(reg: u32, val: u32) {
    const char *regname;
    switch (reg) {
    ...
    default:	regname = core::ptr::null_mut();       break;
    }
...
#[no_mangle]
unsafe extern "C" fn sst_dbg_print_write_reg(reg: u32, val: u32) {
    const char *regname;
    switch (reg) {
    case FBIINIT0:	regname = "FbiInit0"; break;
    case FBIINIT1:	regname = "FbiInit1"; break;
...
#[no_mangle]
pub unsafe extern "C" fn __sst_read(vbase: *mut u8 __iomem, reg: u32) -> u32 {
    static inline u32 __sst_read(u8 __iomem *vbase, u32 reg)
    {
    let mut ret: u32 = readl(vbase + reg);
    sst_dbg_print_read_reg(reg, ret);
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn __sst_write(vbase: *mut u8 __iomem, reg: u32, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn __sst_set_bits(vbase: *mut u8 __iomem, reg: u32, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn __sst_unset_bits(vbase: *mut u8 __iomem, reg: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn __sst_wait_idle(vbase: *mut u8 __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __sst_dac_read(vbase: *mut u8 __iomem, reg: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn __sst_dac_write(vbase: *mut u8 __iomem, reg: u8, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn __dac_i_read(vbase: *mut u8 __iomem, reg: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __dac_i_write(vbase: *mut u8 __iomem, reg: u8, val: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn sst_calc_pll(freq: c_int, freq_out: *mut c_int, t: *mut pll_timing) -> c_int {
    static int sst_calc_pll(const int freq, int *freq_out, struct pll_timing *t)
    {
    int m, m2, n, p, best_err, fout;
    let mut best_n: c_int = -1;
    let mut best_m: c_int = -1;
    best_err = freq;
    p = 3;
...
//
#[no_mangle]
unsafe extern "C" fn sstfb_clear_screen(info: *mut fb_info) {
...
//
    ...
    let mut hSyncOff: c_int = var.xres + var.right_margin + var.left_margin;
    let mut vSyncOff: c_int = var.yres + var.lower_margin + var.upper_margin;
    let mut vBackPorch: c_int = var.left_margin, yDim = var.yres;
    let mut vSyncOn: c_int = var.vsync_len;
...
//
#[no_mangle]
unsafe extern "C" fn sstfb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sstfb_setvgapass(info: *mut fb_info, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sstfb_copyarea(info: *mut fb_info, area: *const fb_copyarea) {
    static void sstfb_copyarea(struct fb_info *info, const struct fb_copyarea *area)
    {
    struct sstfb_par *par = info.par;
    let mut stride: u32 = info.fix.line_length;
    if (!IS_VOODOO2(par))
    return;
...
#[no_mangle]
unsafe extern "C" fn sstfb_fillrect(info: *mut fb_info, rect: *const fb_fillrect) {
...
//
#[no_mangle]
unsafe extern "C" fn sst_get_memsize(info: *mut fb_info, memsize: *mut __u32) -> c_int {
...
// memsize = 0x400000;
#[no_mangle]
pub unsafe extern "C" fn if(0xdeadbeef: readl(fbbase_virt + 0x100000) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn sst_detect_att(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sst_detect_ti(info: *mut fb_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sst_detect_ics(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sst_set_vidmod_att_ti(info: *mut fb_info, bpp: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sst_set_vidmod_ics(info: *mut fb_info, bpp: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sst_detect_dactype(info: *mut fb_info, par: *mut sstfb_par) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sst_init(info: *mut fb_info, par: *mut sstfb_par) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sst_shutdown(info: *mut fb_info) {
...
//
#[no_mangle]
unsafe extern "C" fn sstfb_setup(options: *mut c_char) -> c_int {
    ...
    vgapass = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(this_opt, _arg: "vgapass")) -> else {
    else if (!strcmp(this_opt, "vgapass"))
    vgapass = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(this_opt, _arg: "clipping")) -> else {
    else if (!strcmp(this_opt, "clipping"))
    clipping = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(this_opt, _arg: "noclipping")) -> else {
    else if (!strcmp(this_opt, "noclipping"))
    clipping = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(this_opt, _arg: "fastpci")) -> else {
    else if (!strcmp(this_opt, "fastpci"))
    slowpci = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(this_opt, _arg: "slowpci")) -> else {
    else if (!strcmp(this_opt, "slowpci"))
    slowpci = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "mem:", _arg: 4)) -> else {
    else if (!strncmp(this_opt, "mem:",4))
    mem = simple_strtoul (this_opt+4, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "gfxclk:", _arg: 7)) -> else {
    else if (!strncmp(this_opt, "gfxclk:",7))
    gfxclk = simple_strtoul (this_opt+7, core::ptr::null_mut(), 0);
    else
...
#[no_mangle]
unsafe extern "C" fn sstfb_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
//
    ...
    fb_find_mode(&info.var, info, mode_option, core::ptr::null_mut(), 0, core::ptr::null_mut(), 16);
...
#[no_mangle]
unsafe extern "C" fn sstfb_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn sstfb_init() -> c_int {
