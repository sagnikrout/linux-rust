...
//! Source: drivers/video/fbdev/neofb.c
#![no_std]
...
// ---------------------------------------------------------------------
    ...
    static char *mode_option = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn write_le32(regindex: c_int, val: u32, par: *const neofb_par) {
...
#[no_mangle]
unsafe extern "C" fn neoFindMode(xres: c_int, yres: c_int, depth: c_int) -> c_int {
...
//
pub const MAX_N: c_int = 127;
pub const MAX_D: c_int = 31;
pub const MAX_F: c_int = 1;
    static void neoCalcVCLK(const struct fb_info *info,
    struct neofb_par *par, long freq)
    {
    int n, d, f;
    let mut n_best: c_int = 0, d_best = 0, f_best = 0;
    let mut f_best_diff: c_long = 0x7ffff;
    for (f = 0; f <= MAX_F; f++)
    for (d = 0; d <= MAX_D; d++)
    for (n = 0; n <= MAX_N; n++) {
    long f_out;
...
//
    ...
    {
    let mut hsync_end: c_int = var.xres + var.right_margin + var.hsync_len;
    let mut htotal: c_int = (hsync_end + var.left_margin) >> 3;
    let mut vsync_start: c_int = var.yres + var.lower_margin;
    let mut vsync_end: c_int = vsync_start + var.vsync_len;
    let mut vtotal: c_int = vsync_end + var.upper_margin;
    par.MiscOutReg = 0x23;
...
#[no_mangle]
unsafe extern "C" fn vgaHWLock(state: *mut vgastate) {
...
#[no_mangle]
unsafe extern "C" fn vgaHWUnlock() {
    static void vgaHWUnlock(void)
    {
// Unprotect CRTC[0-7]
    vga_wcrt(core::ptr::null_mut(), 0x11, vga_rcrt(core::ptr::null_mut(), 0x11) & ~0x80);
    }
#[no_mangle]
unsafe extern "C" fn neoLock(state: *mut vgastate) {
...
#[no_mangle]
unsafe extern "C" fn neoUnlock() {
    static void neoUnlock(void)
    {
    vgaHWUnlock();
    vga_wgfx(core::ptr::null_mut(), 0x09, 0x26);
    }
//
// VGA Palette management
//
    let mut paletteEnabled: static int = 0;
#[no_mangle]
pub unsafe extern "C" fn VGAenablePalette() {
    static inline void VGAenablePalette(void)
    {
    vga_r(core::ptr::null_mut(), VGA_IS1_RC);
    vga_w(core::ptr::null_mut(), VGA_ATT_W, 0x00);
    paletteEnabled = 1;
    }
#[no_mangle]
pub unsafe extern "C" fn VGAdisablePalette() {
    static inline void VGAdisablePalette(void)
    {
    vga_r(core::ptr::null_mut(), VGA_IS1_RC);
    vga_w(core::ptr::null_mut(), VGA_ATT_W, 0x20);
    paletteEnabled = 0;
    }
#[no_mangle]
pub unsafe extern "C" fn VGAwATTR(index: u8, value: u8) {
    ...
    index |= 0x20;
    vga_r(core::ptr::null_mut(), VGA_IS1_RC);
    vga_wattr(core::ptr::null_mut(), index, value);
    }
#[no_mangle]
unsafe extern "C" fn vgaHWProtect(on: c_int) {
    static void vgaHWProtect(int on)
    {
    unsigned char tmp;
    tmp = vga_rseq(core::ptr::null_mut(), 0x01);
    if (on) {
//
// Turn off screen and disable sequencer.
//
    vga_wseq(core::ptr::null_mut(), 0x00, 0x01);		/* Synchronous Reset */
    vga_wseq(core::ptr::null_mut(), 0x01, tmp | 0x20);	/* disable the display */
    VGAenablePalette();
    } else {
//
// Reenable sequencer, then turn on screen.
//
    vga_wseq(core::ptr::null_mut(), 0x01, tmp & ~0x20);	/* reenable display */
    vga_wseq(core::ptr::null_mut(), 0x00, 0x03);		/* clear synchronousreset */
    VGAdisablePalette();
    }
    }
    ...
    {
    int i;
    vga_w(core::ptr::null_mut(), VGA_MIS_W, par.MiscOutReg);
    for (i = 1; i < 5; i++)
    vga_wseq(core::ptr::null_mut(), i, par.Sequencer[i]);
// Ensure CRTC registers 0-7 are unlocked by clearing bit 7 or CRTC[17]
    vga_wcrt(core::ptr::null_mut(), 17, par.CRTC[17] & ~0x80);
    for (i = 0; i < 25; i++)
    vga_wcrt(core::ptr::null_mut(), i, par.CRTC[i]);
    for (i = 0; i < 9; i++)
    vga_wgfx(core::ptr::null_mut(), i, par.Graphics[i]);
    VGAenablePalette();
    for (i = 0; i < 21; i++)
...
//
#[no_mangle]
pub unsafe extern "C" fn neo2200_sync(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn neofb_set_par(info: *mut fb_info) -> c_int {
...
// Default to internal (i.e., LCD) only.
    par.PanelDispCntlReg1 = vga_rgfx(core::ptr::null_mut(), 0x20) & 0x03;
    }
...
// don't know what this is, but it's 0 from bootup anyway
    vga_wgfx(core::ptr::null_mut(), 0x15, 0x00);
// was set to 0x01 by my bios in text and vesa modes
    vga_wgfx(core::ptr::null_mut(), 0x0A, par.GeneralLockReg);
//
...
// any reserved bits.
//
    temp = vga_rgfx(core::ptr::null_mut(), 0x90);
    ...
    vga_wgfx(core::ptr::null_mut(), 0x90, temp);
//
...
//
    temp = vga_rgfx(core::ptr::null_mut(), 0x25);
    temp &= 0x39;
    vga_wgfx(core::ptr::null_mut(), 0x25, temp);
//
...
// TrueColor, 16m
    ...
    vga_wgfx(core::ptr::null_mut(), 0x0E, par.ExtCRTDispAddr);
    vga_wgfx(core::ptr::null_mut(), 0x0F, par.ExtCRTOffset);
    temp = vga_rgfx(core::ptr::null_mut(), 0x10);
    temp &= 0x0F;		/* Save bits 3:0 */
    temp |= (par.SysIfaceCntl1 & ~0x0F);	/* VESA Bios sets bit 1! */
    vga_wgfx(core::ptr::null_mut(), 0x10, temp);
    vga_wgfx(core::ptr::null_mut(), 0x11, par.SysIfaceCntl2);
    vga_wgfx(core::ptr::null_mut(), 0x15, 0 /*par.SingleAddrPage */ );
    vga_wgfx(core::ptr::null_mut(), 0x16, 0 /*par.DualAddrPage */ );
    temp = vga_rgfx(core::ptr::null_mut(), 0x20);
    switch (info.fix.accel) {
    case FB_ACCEL_NEOMAGIC_NM2070:
    ...
    vga_wgfx(core::ptr::null_mut(), 0x20, temp);
    temp = vga_rgfx(core::ptr::null_mut(), 0x25);
    temp &= 0x38;		/* Save bits 5:3 */
    temp |= (par.PanelDispCntlReg2 & ~0x38);
    vga_wgfx(core::ptr::null_mut(), 0x25, temp);
    if (info.fix.accel != FB_ACCEL_NEOMAGIC_NM2070) {
    temp = vga_rgfx(core::ptr::null_mut(), 0x30);
    temp &= 0xEF;	/* Save bits 7:5 and bits 3:0 */
    temp |= (par.PanelDispCntlReg3 & ~0xEF);
    vga_wgfx(core::ptr::null_mut(), 0x30, temp);
    }
    vga_wgfx(core::ptr::null_mut(), 0x28, par.PanelVertCenterReg1);
    vga_wgfx(core::ptr::null_mut(), 0x29, par.PanelVertCenterReg2);
    vga_wgfx(core::ptr::null_mut(), 0x2a, par.PanelVertCenterReg3);
    if (info.fix.accel != FB_ACCEL_NEOMAGIC_NM2070) {
    vga_wgfx(core::ptr::null_mut(), 0x32, par.PanelVertCenterReg4);
    vga_wgfx(core::ptr::null_mut(), 0x33, par.PanelHorizCenterReg1);
    vga_wgfx(core::ptr::null_mut(), 0x34, par.PanelHorizCenterReg2);
    vga_wgfx(core::ptr::null_mut(), 0x35, par.PanelHorizCenterReg3);
    }
    if (info.fix.accel == FB_ACCEL_NEOMAGIC_NM2160)
    vga_wgfx(core::ptr::null_mut(), 0x36, par.PanelHorizCenterReg4);
    if (info.fix.accel == FB_ACCEL_NEOMAGIC_NM2200 ||
    info.fix.accel == FB_ACCEL_NEOMAGIC_NM2230 ||
    info.fix.accel == FB_ACCEL_NEOMAGIC_NM2360 ||
    info.fix.accel == FB_ACCEL_NEOMAGIC_NM2380) {
    vga_wgfx(core::ptr::null_mut(), 0x36, par.PanelHorizCenterReg4);
    vga_wgfx(core::ptr::null_mut(), 0x37, par.PanelVertCenterReg5);
    vga_wgfx(core::ptr::null_mut(), 0x38, par.PanelHorizCenterReg5);
    clock_hi = 1;
    }
// Program VCLK3 if needed.
    if (par.ProgramVCLK && ((vga_rgfx(core::ptr::null_mut(), 0x9B) != par.VCLK3NumeratorLow)
    || (vga_rgfx(core::ptr::null_mut(), 0x9F) != par.VCLK3Denominator)
    || (clock_hi && ((vga_rgfx(core::ptr::null_mut(), 0x8F) & ~0x0f)
    != (par.VCLK3NumeratorHigh &
    ~0x0F))))) {
    vga_wgfx(core::ptr::null_mut(), 0x9B, par.VCLK3NumeratorLow);
    if (clock_hi) {
    temp = vga_rgfx(core::ptr::null_mut(), 0x8F);
    temp &= 0x0F;	/* Save bits 3:0 */
    temp |= (par.VCLK3NumeratorHigh & ~0x0F);
    vga_wgfx(core::ptr::null_mut(), 0x8F, temp);
    }
    vga_wgfx(core::ptr::null_mut(), 0x9F, par.VCLK3Denominator);
    }
    if (par.biosMode)
    vga_wcrt(core::ptr::null_mut(), 0x23, par.biosMode);
    vga_wgfx(core::ptr::null_mut(), 0x93, 0xc0);	/* Gives 5x faster framebuffer writes !!! */
// Program vertical extension register
    if (info.fix.accel == FB_ACCEL_NEOMAGIC_NM2200 ||
    info.fix.accel == FB_ACCEL_NEOMAGIC_NM2230 ||
    info.fix.accel == FB_ACCEL_NEOMAGIC_NM2360 ||
    info.fix.accel == FB_ACCEL_NEOMAGIC_NM2380) {
    vga_wcrt(core::ptr::null_mut(), 0x70, par.VerticalExt);
    }
...
// be needed.
//
    oldExtCRTDispAddr = vga_rgfx(core::ptr::null_mut(), 0x0E);
...
//
#[no_mangle]
unsafe extern "C" fn neofb_blank(blank_mode: c_int, info: *mut fb_info) -> c_int {
...
//
    neoUnlock();
    tmpdisp = vga_rgfx(core::ptr::null_mut(), 0x20) & 0x03;
    neoLock(&par.state);
...
// fb_blank we didn't aactually do anything
    ...
    neoUnlock();
    reg = (vga_rseq(core::ptr::null_mut(), 0x01) & ~0x20) | seqflags;
    vga_wseq(core::ptr::null_mut(), 0x01, reg);
    reg = (vga_rgfx(core::ptr::null_mut(), 0x20) & ~0x02) | lcdflags;
    vga_wgfx(core::ptr::null_mut(), 0x20, reg);
    reg = (vga_rgfx(core::ptr::null_mut(), 0x01) & ~0xF0) | 0x80 | dpmsflags;
    vga_wgfx(core::ptr::null_mut(), 0x01, reg);
    neoLock(&par.state);
    return 0;
    }
    static void
...
// NEO_BC3_SRC_XY_ADDR  |
    ...
    {
    let mut sx: u32 = area.sx, sy = area.sy, dx = area.dx, dy = area.dy;
    struct neofb_par *par = info.par;
...
// set blt control
    ...
    {
    struct neofb_par *par = info.par;
    let mut s_pitch: c_int = (image.width * image.depth + 7) >> 3;
    let mut scan_align: c_int = info.pixmap.scan_align - 1;
    let mut buf_align: c_int = info.pixmap.buf_align - 1;
...
// Disable cursor
    ...
    let mut x: u32 = cursor.image.dx;
    let mut y: u32 = cursor.image.dy;
    ...
    let mut fg: u32 = cursor.image.fg_color;
    let mut bg: u32 = cursor.image.bg_color;
...
#[no_mangle]
unsafe extern "C" fn neo_map_mmio(info: *mut fb_info, dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn neo_unmap_mmio(info: *mut fb_info) {
    static void neo_unmap_mmio(struct fb_info *info)
    {
    struct neofb_par *par = info.par;
    DBG("neo_unmap_mmio");
    iounmap(par.mmio_vbase);
    par.mmio_vbase = core::ptr::null_mut();
    release_mem_region(info.fix.mmio_start,
    info.fix.mmio_len);
    }
...
#[no_mangle]
unsafe extern "C" fn neo_unmap_video(info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn neo_scan_monitor(info: *mut fb_info) -> c_int {
...
// Determine the panel type
    vga_wgfx(core::ptr::null_mut(), 0x09, 0x26);
    type = vga_rgfx(core::ptr::null_mut(), 0x21);
    display = vga_rgfx(core::ptr::null_mut(), 0x20);
...
// Determine panel width -- used in NeoValidMode.
    w = vga_rgfx(core::ptr::null_mut(), 0x20);
    vga_wgfx(core::ptr::null_mut(), 0x09, 0x00);
    switch ((w & 0x18) >> 3) {
    case 0x00:
// 640x480@60
...
#[no_mangle]
unsafe extern "C" fn neo_init_hw(info: *mut fb_info) -> c_int {
    static int neo_init_hw(struct fb_info *info)
    {
    struct neofb_par *par = info.par;
    let mut videoRam: c_int = 896;
    let mut maxClock: c_int = 65000;
    let mut CursorOff: c_int = 0x100;
    DBG("neo_init_hw");
    neoUnlock();
    ...
    (void *) vga_rcrt(core::ptr::null_mut(), w));
    for (int w = 0; w < 0xC7; w++)
    printk(KERN_DEBUG "GR %p: %p\n", (void *) w,
    (void *) vga_rgfx(core::ptr::null_mut(), w));
...
#[no_mangle]
unsafe extern "C" fn neo_free_fb_info(info: *mut fb_info) {
...
// ---------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn neofb_probe(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    ...
    if (err)
    goto err_init_hw;
    if (!fb_find_mode(&info.var, info, mode_option, core::ptr::null_mut(), 0,
...
#[no_mangle]
unsafe extern "C" fn neofb_remove(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn neofb_setup(options: *mut c_char) -> int __init {
    ...
    internal = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "external", _arg: 8)) -> else {
    else if (!strncmp(this_opt, "external", 8))
    external = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "nostretch", _arg: 9)) -> else {
    else if (!strncmp(this_opt, "nostretch", 9))
    nostretch = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "nopciburst", _arg: 10)) -> else {
    else if (!strncmp(this_opt, "nopciburst", 10))
    nopciburst = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "libretto", _arg: 8)) -> else {
...
#[no_mangle]
unsafe extern "C" fn neofb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn neofb_exit() -> void __exit {
