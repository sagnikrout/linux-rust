...
//! Source: drivers/video/fbdev/gbefb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbefb_par {
    pub var: fb_var_screeninfo,
    pub timing: gbe_timing_info,
    pub wc_cookie: c_int,
    pub valid: c_int,
}

pub const GBE_BASE: c_uint = 0x16000000 /* SGI O2 */;
...
pub const TILE_SHIFT: c_int = 16;

    let mut gbe_mem_size: static unsigned int = CONFIG_FB_GBE_MEM * 1024*1024;
    static void *gbe_mem;
...
// 1600x1024, 8 bpp
    ...
    let mut flat_panel_enabled: static int = 0;
#[no_mangle]
unsafe extern "C" fn gbe_reset() {
...
//
#[no_mangle]
unsafe extern "C" fn gbe_turn_off() {
...
#[no_mangle]
unsafe extern "C" fn gbe_turn_on() {
...
#[no_mangle]
unsafe extern "C" fn gbe_loadcmap() {
...
//
#[no_mangle]
unsafe extern "C" fn gbefb_blank(blank: c_int, info: *mut fb_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gbefb_setup_flatpanel(timing: *mut gbe_timing_info) {
    static void gbefb_setup_flatpanel(struct gbe_timing_info *timing)
    {
    int fp_wid, fp_hgt, fp_vbs, fp_vbe;
    let mut outputVal: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn gbe_set_timing_info(timing: *mut gbe_timing_info) {
...
//
#[no_mangle]
unsafe extern "C" fn gbefb_set_par(info: *mut fb_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gbefb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gbefb_show_memsize(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    static ssize_t gbefb_show_memsize(struct device *dev, struct device_attribute *attr, char *buf)
    {
    return sysfs_emit(buf, "%u\n", gbe_mem_size);
    }
    static DEVICE_ATTR(size, S_IRUGO, gbefb_show_memsize, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn gbefb_show_rev(device: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    static ssize_t gbefb_show_rev(struct device *device, struct device_attribute *attr, char *buf)
    {
    return sysfs_emit(buf, "%d\n", gbe_revision);
    }
    static DEVICE_ATTR(revision, S_IRUGO, gbefb_show_rev, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn gbefb_setup(options: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gbefb_probe(p_dev: *mut platform_device) -> c_int {
    ...
    char *options = core::ptr::null_mut();
...
// turn on default video mode
    if (fb_find_mode(&par.var, info, mode_option, core::ptr::null_mut(), 0,
    default_mode, 8) == 0)
    par.var = *default_var;
    info.var = par.var;
...
#[no_mangle]
unsafe extern "C" fn gbefb_remove(p_dev: *mut *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn gbefb_init() -> int __init {
    static int __init gbefb_init(void)
    {
    let mut ret: c_int = platform_driver_register(&gbefb_driver);
...
#[no_mangle]
unsafe extern "C" fn gbefb_exit() -> void __exit {
