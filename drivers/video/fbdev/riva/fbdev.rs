...
//! Source: drivers/video/fbdev/riva/fbdev.c
#![no_std]
...
// command line data, set in rivafb_setup()
    ...
    let mut forceCRTC: static int = -1;
    ...
    let mut strictmode: static bool = 0;
...
#[no_mangle]
unsafe extern "C" fn riva_bl_update_status(bd: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riva_bl_init(par: *mut riva_par) {
...
#[no_mangle]
unsafe extern "C" fn riva_bl_exit(info: *mut fb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn MISCout(par: *mut riva_par, val: c_uchar) {
    static inline void MISCout(struct riva_par *par, unsigned char val)
    {
    VGA_WR08(par.riva.PVIO, 0x3c2, val);
    }
#[no_mangle]
pub unsafe extern "C" fn MISCin(par: *mut riva_par) -> c_uchar {
    static inline unsigned char MISCin(struct riva_par *par)
    {
    return (VGA_RD08(par.riva.PVIO, 0x3cc));
    }
#[no_mangle]
pub unsafe extern "C" fn reverse_order(l: *mut u32) {
...
// from GGI
#[no_mangle]
unsafe extern "C" fn riva_save_state(par: *mut riva_par, regs: *mut riva_regs) {
...
// from GGI
#[no_mangle]
unsafe extern "C" fn riva_load_state(par: *mut riva_par, regs: *mut riva_regs) {
...
//
#[no_mangle]
unsafe extern "C" fn riva_load_video_mode(info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wait_for_idle(par: *mut riva_par) {
...
#[no_mangle]
unsafe extern "C" fn riva_setup_accel(info: *mut fb_info) {
...
//
#[no_mangle]
unsafe extern "C" fn riva_get_cmap_len(var: *const fb_var_screeninfo) -> c_int {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn rivafb_open(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rivafb_release(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rivafb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
    static int rivafb_check_var(struct fb_var_screeninfo *var, struct fb_info *info)
    {
    const struct fb_videomode *mode;
    struct riva_par *par = info.par;
    int nom, den;		/* translating from pixels.bytes */
    let mut mode_valid: c_int = 0;
    NVTRACE_ENTER();
    if (!var.pixclock)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn rivafb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rivafb_blank(blank: c_int, info: *mut fb_info) -> c_int {
    static int rivafb_blank(int blank, struct fb_info *info)
    {
    struct riva_par *par= info.par;
...
//
#[no_mangle]
unsafe extern "C" fn rivafb_fillrect(info: *mut fb_info, rect: *const fb_fillrect) {
...
//
#[no_mangle]
unsafe extern "C" fn rivafb_copyarea(info: *mut fb_info, region: *const fb_copyarea) {
...
#[no_mangle]
pub unsafe extern "C" fn convert_bgcolor_16(col: *mut u32) {
...
//
    ...
    {
    struct riva_par *par = info.par;
    let mut fgx: u32 = 0, bgx = 0, width, tmp;
...
//
#[no_mangle]
unsafe extern "C" fn rivafb_cursor(info: *mut fb_info, cursor: *mut fb_cursor) -> c_int {
    ...
    let mut bg_idx: u32 = cursor.image.bg_color;
    let mut fg_idx: u32 = cursor.image.fg_color;
    let mut s_pitch: u32 = (cursor.image.width+7) >> 3;
    let mut d_pitch: u32 = MAX_CURS/8;
...
#[no_mangle]
unsafe extern "C" fn rivafb_sync(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riva_set_fbinfo(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riva_get_EDID_OF(info: *mut fb_info, pd: *mut pci_dev) -> c_int {
    static int riva_get_EDID_OF(struct fb_info *info, struct pci_dev *pd)
    {
    struct riva_par *par = info.par;
    struct device_node *dp;
    const unsigned char *pedid = core::ptr::null_mut();
    const unsigned char *disptype = core::ptr::null_mut();
    static char *propnames[] = {
    "DFP,EDID", "LCD,EDID", "EDID", "EDID1", "EDID,B", "EDID,A", core::ptr::null_mut() };
    int i;
    NVTRACE_ENTER();
    dp = pci_device_to_OF_node(pd);
    for (; dp != core::ptr::null_mut(); dp = dp.child) {
    disptype = of_get_property(dp, "display-type", core::ptr::null_mut());
    if (disptype == core::ptr::null_mut())
    continue;
    if (strncmp(disptype, "LCD", 3) != 0)
    continue;
    for (i = 0; propnames[i] != core::ptr::null_mut(); ++i) {
    pedid = of_get_property(dp, propnames[i], core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn riva_get_EDID_i2c(info: *mut fb_info) -> c_int {
...
// respect mode options
    ...
    core::ptr::null_mut(), 8);
    } else if (specs.modedb != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn riva_get_EDID(info: *mut fb_info, pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn riva_get_edidinfo(info: *mut fb_info) {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn riva_get_arch(pd: *mut pci_dev) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rivafb_probe(pd: *mut pci_dev, ent: *const pci_device_id) -> c_int {
    ...
    if (info.pixmap.addr == core::ptr::null_mut()) {
    ret = -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn rivafb_remove(pd: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn rivafb_setup(options: *mut c_char) -> c_int {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn rivafb_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rivafb_exit() -> void __exit {
