...
//! Source: drivers/video/fbdev/amifb.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn dma(displays: useful for OCS/ECS overscan) -> moved to optimize use of {
...
//
    let mut min_fstrt: static u_long = 192;
...
//
    ...
    let mut currentcop: static u_short = 0;
//
// Hardware Cursor API Definitions
// These used to be in linux/fb.h, but were preliminary and used by
// amifb only anyway
//
pub const FBIOGET_FCURSORINFO: c_uint = 0x4607;
pub const FBIOGET_VCURSORINFO: c_uint = 0x4608;
pub const FBIOPUT_VCURSORINFO: c_uint = 0x4609;
pub const FBIOGET_CURSORSTATE: c_uint = 0x460A;
pub const FBIOPUT_CURSORSTATE: c_uint = 0x460B;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fb_fix_cursorinfo {
    pub /: *mut *mut __u16 crsr_width; / width and height of the cursor in,
    pub /: *mut *mut __u16 crsr_height; / pixels (zero if no cursor),
    pub /: *mut *mut __u16 crsr_xsize; / cursor size in display pixels,
    pub crsr_ysize: __u16,
    pub /: *mut *mut __u16 crsr_color1; / colormap entry for cursor color1,
    pub /: *mut *mut __u16 crsr_color2; / colormap entry for cursor color2,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fb_var_cursorinfo {
    pub width: __u16,
    pub height: __u16,
    pub xspot: __u16,
    pub yspot: __u16,
    pub /: *mut *mut DECLARE_FLEX_ARRAY(__u8, data); / field with [height][width],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fb_cursorstate {
    pub xoffset: __s16,
    pub yoffset: __s16,
    pub mode: __u16,
}

pub const FB_CURSOR_OFF: c_int = 0;
pub const FB_CURSOR_ON: c_int = 1;
pub const FB_CURSOR_FLASH: c_int = 2;
//
// Hardware Cursor
//
    static int cursorrate = 20;	/* Number of frames/flash toggle */
    let mut cursorstate: static u_short = -1;
    let mut cursormode: static u_short = FB_CURSOR_OFF;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct amifb_par {
// General Values
    pub /: *mut *mut int xres; / vmode,
    pub /: *mut *mut int yres; / vmode,
    pub /: *mut *mut int vxres; / vmode,
    pub /: *mut *mut int vyres; / vmode,
    pub /: *mut *mut int xoffset; / vmode,
    pub /: *mut *mut int yoffset; / vmode,
    pub /: *mut *mut u_short bpp; / vmode,
    pub /: *mut *mut u_short clk_shift; / vmode,
    pub /: *mut *mut u_short line_shift; / vmode,
    pub /: *mut *mut int vmode; / vmode,
    pub /: *mut *mut u_short diwstrt_h; / vmode,
    pub /: *mut *mut u_short diwstop_h; / vmode,
    pub /: *mut *mut u_short diwstrt_v; / vmode,
    pub /: *mut *mut u_short diwstop_v; / vmode,
    pub /: *mut *mut u_long next_line; / modulo for next line,
    pub /: *mut *mut u_long next_plane; / modulo for next plane,
// Cursor Values
    struct {
    pub /: *mut *mut short crsr_x; / movecursor,
    pub /: *mut *mut short crsr_y; / movecursor,
    pub spot_x: c_short,
    pub spot_y: c_short,
    pub height: u_short,
    pub width: u_short,
...
// OCS Hardware Registers
    pub /: *mut *mut u_long bplpt0; / vmode, pan (Note: physical address),
    pub /: *mut *mut u_long bplpt0wrap; / vmode, pan (Note: physical address),
    pub ddfstrt: u_short,
    pub ddfstop: u_short,
    pub bpl1mod: u_short,
    pub bpl2mod: u_short,
    pub /: *mut *mut u_short bplcon0; / vmode,
    pub /: *mut *mut u_short bplcon1; / vmode,
    pub /: *mut *mut u_short htotal; / vmode,
    pub /: *mut *mut u_short vtotal; / vmode,
// Additional ECS Hardware Registers
    pub /: *mut *mut u_short bplcon3; / vmode,
    pub /: *mut *mut u_short beamcon0; / vmode,
    pub /: *mut *mut u_short hsstrt; / vmode,
    pub /: *mut *mut u_short hsstop; / vmode,
    pub /: *mut *mut u_short hbstrt; / vmode,
    pub /: *mut *mut u_short hbstop; / vmode,
    pub /: *mut *mut u_short vsstrt; / vmode,
    pub /: *mut *mut u_short vsstop; / vmode,
    pub /: *mut *mut u_short vbstrt; / vmode,
    pub /: *mut *mut u_short vbstop; / vmode,
    pub /: *mut *mut u_short hcenter; / vmode,
// Additional AGA Hardware Registers
    pub /: *mut *mut u_short fmode; / vmode,
}
...
// 1024x800, 15 Hz
    ...
    let mut __initdata: *mut static char mode_option = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(BPC0_LACE: par->bplcon0 &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ami_update_par(info: *mut fb_info) {
...
//
#[no_mangle]
unsafe extern "C" fn ami_pan_var(var: *mut fb_var_screeninfo, info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn ami_update_display(par: *const amifb_par) {
...
//
#[no_mangle]
unsafe extern "C" fn ami_init_display(par: *const amifb_par) {
...
//
#[no_mangle]
unsafe extern "C" fn ami_do_blank(par: *const amifb_par) {
    static void ami_do_blank(const struct amifb_par *par)
    {

    let mut bplcon3: u_short = par.bplcon3;
...
// FIXME: check the return value + test the change
    ...
    return -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(16: var->width <=) -> else {
    else if (var.width <= 16)
    fmode = TAG_FMODE_1;
#[no_mangle]
pub unsafe extern "C" fn if(32: var->width <=) -> else {
    else if (var.width <= 32)
    fmode = TAG_FMODE_2;
#[no_mangle]
pub unsafe extern "C" fn if(64: var->width <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn ami_set_sprite(par: *const amifb_par) {
...
//
#[no_mangle]
unsafe extern "C" fn ami_init_copper() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn ami_reinit_copper(par: *const amifb_par) {
...
//
#[no_mangle]
unsafe extern "C" fn ami_rebuild_copper(par: *const amifb_par) {
...
//
#[no_mangle]
unsafe extern "C" fn ami_build_copper(info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn amifb_setup_mcap(spec: *mut c_char) -> void __init {
...
//
    if (!(p = strsep(&spec, ";")) || !*p)
    return;
    vmin = simple_strtoul(p, core::ptr::null_mut(), 10);
    if (vmin <= 0)
    return;
    if (!(p = strsep(&spec, ";")) || !*p)
    return;
    vmax = simple_strtoul(p, core::ptr::null_mut(), 10);
    if (vmax <= 0 || vmax <= vmin)
    return;
    if (!(p = strsep(&spec, ";")) || !*p)
    return;
    hmin = 1000 * simple_strtoul(p, core::ptr::null_mut(), 10);
    if (hmin <= 0)
    return;
    if (!(p = strsep(&spec, "")) || !*p)
    return;
    hmax = 1000 * simple_strtoul(p, core::ptr::null_mut(), 10);
    if (hmax <= 0 || hmax <= hmin)
    return;
    amifb_hfmin = hmin;
    amifb_hfmax = hmax;
...
#[no_mangle]
unsafe extern "C" fn amifb_setup(options: *mut c_char) -> int __init {
    ...
    amifb_ilbm = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "monitorcap:", _arg: 11)) -> else {
    else if (!strncmp(this_opt, "monitorcap:", 11))
    amifb_setup_mcap(this_opt + 11);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "fstart:", _arg: 7)) -> else {
    else if (!strncmp(this_opt, "fstart:", 7))
    min_fstrt = simple_strtoul(this_opt + 7, core::ptr::null_mut(), 0);
    else
...
#[no_mangle]
unsafe extern "C" fn amifb_set_par(info: *mut fb_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn amifb_blank(blank: c_int, info: *mut fb_info) -> c_int {
...
pub const BYTES_PER_LONG: c_int = 4;
pub const SHIFT_PER_LONG: c_int = 5;

pub const BYTES_PER_LONG: c_int = 8;
pub const SHIFT_PER_LONG: c_int = 6;
...
//
    ...
    let mut shift: c_int = dst_idx - src_idx, left, right;
    unsigned long d0, d1;
    int m;
    if (!n)
    return;
...
//
#[no_mangle]
unsafe extern "C" fn bitfill32(dst: *mut c_ulong, dst_idx: c_int, pat: u32, n: u32) {
    static void bitfill32(unsigned long *dst, int dst_idx, u32 pat, u32 n)
    {
    let mut val: c_ulong = pat;
    unsigned long first, last;
    if (!n)
    return;
...
//
#[no_mangle]
unsafe extern "C" fn bitxor32(dst: *mut c_ulong, dst_idx: c_int, pat: u32, n: u32) {
...
#[no_mangle]
unsafe extern "C" fn amifb_imageblit(info: *mut fb_info, image: *const fb_image) {
...
//
#[no_mangle]
unsafe extern "C" fn flash_cursor() -> c_int {
    static int flash_cursor(void)
    {
    let mut cursorcount: static int = 1;
...
//
#[no_mangle]
unsafe extern "C" fn amifb_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn chipalloc(size: u_long) -> u_long __init {
...
#[no_mangle]
pub unsafe extern "C" fn chipfree() {
...
//
#[no_mangle]
unsafe extern "C" fn amifb_probe(pdev: *mut platform_device) -> int __init {
...
//
    {
    let mut tmp: u_long = DIVUL(200000000000ULL, amiga_eclock);
...
#[no_mangle]
unsafe extern "C" fn amifb_remove(pdev: *mut platform_device) -> void __exit {
