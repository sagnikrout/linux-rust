...
//! Source: drivers/video/fbdev/vesafb.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn if(16: regno <) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn vesafb_destroy(info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn vesafb_setup(options: *mut c_char) -> c_int {
    ...
    inverse=1;
#[no_mangle]
pub unsafe extern "C" fn if(strcmp(this_opt: !, _arg: "redraw")) -> else {
    else if (! strcmp(this_opt, "redraw"))
    ypan=0;
#[no_mangle]
pub unsafe extern "C" fn if(strcmp(this_opt: !, _arg: "ypan")) -> else {
    else if (! strcmp(this_opt, "ypan"))
    ypan=1;
#[no_mangle]
pub unsafe extern "C" fn if(strcmp(this_opt: !, _arg: "ywrap")) -> else {
    else if (! strcmp(this_opt, "ywrap"))
    ypan=2;
#[no_mangle]
pub unsafe extern "C" fn if(strcmp(this_opt: !, _arg: "vgapal")) -> else {
    else if (! strcmp(this_opt, "vgapal"))
    pmi_setpal=0;
#[no_mangle]
pub unsafe extern "C" fn if(strcmp(this_opt: !, _arg: "pmipal")) -> else {
    else if (! strcmp(this_opt, "pmipal"))
    pmi_setpal=1;
#[no_mangle]
pub unsafe extern "C" fn if(strncmp(this_opt: !, _arg: "mtrr:", _arg: 5)) -> else {
    else if (! strncmp(this_opt, "mtrr:", 5))
    mtrr = simple_strtoul(this_opt+5, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(strcmp(this_opt: !, _arg: "nomtrr")) -> else {
    else if (! strcmp(this_opt, "nomtrr"))
    mtrr=0;
#[no_mangle]
pub unsafe extern "C" fn if(strncmp(this_opt: !, _arg: "vtotal:", _arg: 7)) -> else {
    else if (! strncmp(this_opt, "vtotal:", 7))
    vram_total = simple_strtoul(this_opt+7, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(strncmp(this_opt: !, _arg: "vremap:", _arg: 7)) -> else {
...
#[no_mangle]
unsafe extern "C" fn vesafb_probe(dev: *mut platform_device) -> c_int {
...
// region already (FIXME)
    ...
    if (mtrr == 3) {
    let mut temp_size: c_uint = size_total;
...
// Try and find a power of two to add
    ...
    if (!ypan)
    vesafb_ops.fb_pan_display = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn vesafb_remove(pdev: *mut platform_device) {
