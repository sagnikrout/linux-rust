...
//! Source: drivers/video/fbdev/q40fb.c
#![no_std]
...
pub const Q40_PHYS_SCREEN_ADDR: c_uint = 0xFE800000;
...
#[no_mangle]
unsafe extern "C" fn q40fb_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn q40fb_init() -> int __init {
    static int __init q40fb_init(void)
    {
    let mut ret: c_int = 0;
    if (fb_get_options("q40fb", core::ptr::null_mut()))
    return -ENODEV;
