...
//! Source: drivers/video/fbdev/omap/hwa742.c
#![no_std]
...
pub const HWA742_REV_CODE_REG: c_uint = 0x0;
pub const HWA742_CONFIG_REG: c_uint = 0x2;
pub const HWA742_PLL_DIV_REG: c_uint = 0x4;
pub const HWA742_PLL_0_REG: c_uint = 0x6;
pub const HWA742_PLL_1_REG: c_uint = 0x8;
pub const HWA742_PLL_2_REG: c_uint = 0xa;
pub const HWA742_PLL_3_REG: c_uint = 0xc;
pub const HWA742_PLL_4_REG: c_uint = 0xe;
pub const HWA742_CLK_SRC_REG: c_uint = 0x12;
pub const HWA742_PANEL_TYPE_REG: c_uint = 0x14;
pub const HWA742_H_DISP_REG: c_uint = 0x16;
pub const HWA742_H_NDP_REG: c_uint = 0x18;
pub const HWA742_V_DISP_1_REG: c_uint = 0x1a;
pub const HWA742_V_DISP_2_REG: c_uint = 0x1c;
pub const HWA742_V_NDP_REG: c_uint = 0x1e;
pub const HWA742_HS_W_REG: c_uint = 0x20;
pub const HWA742_HP_S_REG: c_uint = 0x22;
pub const HWA742_VS_W_REG: c_uint = 0x24;
pub const HWA742_VP_S_REG: c_uint = 0x26;
pub const HWA742_PCLK_POL_REG: c_uint = 0x28;
pub const HWA742_INPUT_MODE_REG: c_uint = 0x2a;
pub const HWA742_TRANSL_MODE_REG1: c_uint = 0x2e;
pub const HWA742_DISP_MODE_REG: c_uint = 0x34;
pub const HWA742_WINDOW_TYPE: c_uint = 0x36;
pub const HWA742_WINDOW_X_START_0: c_uint = 0x38;
pub const HWA742_WINDOW_X_START_1: c_uint = 0x3a;
pub const HWA742_WINDOW_Y_START_0: c_uint = 0x3c;
pub const HWA742_WINDOW_Y_START_1: c_uint = 0x3e;
pub const HWA742_WINDOW_X_END_0: c_uint = 0x40;
pub const HWA742_WINDOW_X_END_1: c_uint = 0x42;
pub const HWA742_WINDOW_Y_END_0: c_uint = 0x44;
pub const HWA742_WINDOW_Y_END_1: c_uint = 0x46;
pub const HWA742_MEMORY_WRITE_LSB: c_uint = 0x48;
pub const HWA742_MEMORY_WRITE_MSB: c_uint = 0x49;
pub const HWA742_MEMORY_READ_0: c_uint = 0x4a;
pub const HWA742_MEMORY_READ_1: c_uint = 0x4c;
pub const HWA742_MEMORY_READ_2: c_uint = 0x4e;
pub const HWA742_POWER_SAVE: c_uint = 0x56;
pub const HWA742_NDP_CTRL: c_uint = 0x58;

// Reserve 4 request slots for requests in irq context
pub const REQ_POOL_SIZE: c_int = 24;
pub const IRQ_REQ_POOL_SIZE: c_int = 4;
pub const REQ_FROM_IRQ_POOL: c_uint = 0x01;
pub const REQ_COMPLETE: c_int = 0;
pub const REQ_PENDING: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct update_param {
    pub height: int x, y, width,,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hwa742_request {
    pub entry: list_head,
    pub flags: c_uint,
    pub req): *mut *mut int (handler)(struct hwa742_request,
    pub data): *mut *mut void (complete)(void,
    pub complete_data: *mut c_void,
    union {
    pub update: update_param,
    pub sync: *mut completion,
    pub par: },
}
...
#[no_mangle]
unsafe extern "C" fn hwa742_read_reg(reg: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn hwa742_write_reg(reg: u8, data: u8) {
...
#[no_mangle]
unsafe extern "C" fn set_window_regs(x_start: c_int, y_start: c_int, x_end: c_int, y_end: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_format_regs(conv: c_int, transl: c_int, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn disable_tearsync() {
...
#[no_mangle]
pub unsafe extern "C" fn free_req(req: *mut hwa742_request) {
...
#[no_mangle]
unsafe extern "C" fn process_pending_requests() {
...
#[no_mangle]
unsafe extern "C" fn submit_req_list(head: *mut list_head) {
    static void submit_req_list(struct list_head *head)
    {
    unsigned long flags;
    let mut process: c_int = 1;
    spin_lock_irqsave(&hwa742.req_lock, flags);
...
#[no_mangle]
unsafe extern "C" fn request_complete(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn send_frame_handler(req: *mut hwa742_request) -> c_int {
    static int send_frame_handler(struct hwa742_request *req)
    {
    struct update_param *par = &req.par.update;
    let mut x: c_int = par.x;
    let mut y: c_int = par.y;
    let mut w: c_int = par.width;
    let mut h: c_int = par.height;
    int bpp;
    int conv, transl;
    unsigned long offset;
    let mut color_mode: c_int = par.color_mode;
    let mut flags: c_int = par.flags;
    let mut scr_width: c_int = hwa742.fbdev.panel.x_res;
    let mut scr_height: c_int = hwa742.fbdev.panel.y_res;
...
#[no_mangle]
unsafe extern "C" fn send_frame_complete(data: *mut c_void) {
    ...
    {
    struct hwa742_request *req;
    let mut x: c_int = win.x;
    let mut y: c_int = win.y;
    let mut width: c_int = win.width;
    let mut height: c_int = win.height;
    int color_mode;
    int flags;
    ...
    if (width & ~1) {
    let mut xspan: c_uint = width & ~1;
    let mut ystart: c_uint = y;
    let mut yspan: c_uint = height;
...
#[no_mangle]
unsafe extern "C" fn auto_update_complete(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __hwa742_update_window_auto(can_sleep: bool) {
    ...
    last.complete_data = core::ptr::null_mut();
    submit_req_list(&req_list);
    }
#[no_mangle]
unsafe extern "C" fn hwa742_update_window_auto(unused: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn hwa742_enable_plane(plane: c_int, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sync_handler(req: *mut hwa742_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwa742_sync() {
...
#[no_mangle]
unsafe extern "C" fn hwa742_bind_client(nb: *mut omapfb_notifier_block) {
...
#[no_mangle]
unsafe extern "C" fn hwa742_set_update_mode(mode: enum omapfb_update_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwa742_get_update_mode() -> enum omapfb_update_mode {
    static enum omapfb_update_mode hwa742_get_update_mode(void)
    {
    return hwa742.update_mode;
    }
#[no_mangle]
unsafe extern "C" fn round_to_extif_ticks(ps: c_ulong, div: c_int) -> c_ulong {
    static unsigned long round_to_extif_ticks(unsigned long ps, int div)
    {
    let mut bus_tick: c_int = hwa742.extif_clk_period * div;
    return (ps + bus_tick - 1) / bus_tick * bus_tick;
    }
#[no_mangle]
unsafe extern "C" fn calc_reg_timing(sysclk: c_ulong, div: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn calc_lut_timing(sysclk: c_ulong, div: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn calc_extif_timings(sysclk: c_ulong, extif_mem_div: *mut c_int) -> c_int {
...
// extif_mem_div = div;
    ...
    {
    int pix_clk_src;
    let mut sys_div: c_int = 0, sys_mul = 0;
    int pix_div;
...
#[no_mangle]
unsafe extern "C" fn setup_tearsync(pix_clk: c_ulong, extif_div: c_int) -> c_int {
...
// time to transfer one pixel (16bpp) in ps
    ...
    if (hwa742.extif.get_max_tx_rate != core::ptr::null_mut()) {
//
// The external interface might have a rate limitation,
// if so, we have to maximize our transfer rate.
//
    unsigned long min_tx_time;
    let mut max_tx_rate: c_ulong = hwa742.extif.get_max_tx_rate();
...
#[no_mangle]
unsafe extern "C" fn hwa742_get_caps(plane: c_int, caps: *mut omapfb_caps) {
...
#[no_mangle]
unsafe extern "C" fn hwa742_suspend() {
...
#[no_mangle]
unsafe extern "C" fn hwa742_resume() {
...
// Loop until PLL output is stabilized
    ...
    hwa742.sys_ck = clk_get(core::ptr::null_mut(), "hwa_sys_ck");
...
#[no_mangle]
unsafe extern "C" fn hwa742_cleanup() {
