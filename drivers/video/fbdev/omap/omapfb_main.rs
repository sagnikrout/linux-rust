...
//! Source: drivers/video/fbdev/omap/omapfb_main.c
#![no_std]
...
//
    ...
    let mut manual_update: static bool = IS_BUILTIN(CONFIG_FB_OMAP_MANUAL_UPDATE);
    static struct platform_device	*fbdev_pdev;
    static struct lcd_panel		*fbdev_panel;
    static struct omapfb_device	*omapfb_dev;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct caps_table_struct {
    pub flag: c_ulong,
...
#[no_mangle]
unsafe extern "C" fn omapdss_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn omapfb_rqueue_lock(fbdev: *mut omapfb_device) {
    static void omapfb_rqueue_lock(struct omapfb_device *fbdev)
    {
    mutex_lock(&fbdev.rqueue_mutex);
    }
#[no_mangle]
unsafe extern "C" fn omapfb_rqueue_unlock(fbdev: *mut omapfb_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ctrl_init(fbdev: *mut omapfb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ctrl_cleanup(fbdev: *mut omapfb_device) {
...
#[no_mangle]
unsafe extern "C" fn ctrl_change_mode(fbi: *mut fb_info) -> c_int {
    ...
    if (r < 0)
    return r;
    if (fbdev.ctrl.set_rotate != core::ptr::null_mut()) {
    r = fbdev.ctrl.set_rotate(var.rotate);
    if (r < 0)
    return r;
    }
    if (fbdev.ctrl.set_scale != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn omapfb_open(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omapfb_release(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omapfb_setcmap(cmap: *mut fb_cmap, info: *mut fb_info) -> c_int {
    static int omapfb_setcmap(struct fb_cmap *cmap, struct fb_info *info)
    {
    int count, index, r;
    u16 *red, *green, *blue, *transp;
    let mut trans: u16 = 0xffff;
    red     = cmap.red;
    green   = cmap.green;
    blue    = cmap.blue;
    transp  = cmap.transp;
...
#[no_mangle]
unsafe extern "C" fn omapfb_blank(blank: c_int, fbi: *mut fb_info) -> c_int {
    static int omapfb_blank(int blank, struct fb_info *fbi)
    {
    struct omapfb_plane_struct *plane = fbi.par;
    struct omapfb_device *fbdev = plane.fbdev;
    let mut do_update: c_int = 0;
    let mut r: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn omapfb_sync(fbi: *mut fb_info) {
...
//
#[no_mangle]
unsafe extern "C" fn set_fb_fix(fbi: *mut fb_info, from_init: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn switch(_arg: var->bits_per_pixel) -> else {
    case 16:
    case 12:
...
#[no_mangle]
unsafe extern "C" fn omapfb_mirror(fbi: *mut fb_info, mirror: c_int) -> c_int {
    ...
    r = -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(plane->info.mirror: mirror !=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn omapfb_check_var(var: *mut fb_var_screeninfo, fbi: *mut fb_info) -> c_int {
    ...
    int r;
    omapfb_rqueue_lock(fbdev);
    if (fbdev.ctrl.sync != core::ptr::null_mut())
    fbdev.ctrl.sync();
...
//
#[no_mangle]
unsafe extern "C" fn omapfb_set_par(fbi: *mut fb_info) -> c_int {
    ...
    ret = omapfb_update_window_async(fbi, win, core::ptr::null_mut(), core::ptr::null_mut());
    omapfb_rqueue_unlock(plane.fbdev);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn omapfb_update_full_screen(fbi: *mut fb_info) -> c_int {
    static int omapfb_update_full_screen(struct fb_info *fbi)
    {
    struct omapfb_plane_struct *plane = fbi.par;
    struct omapfb_device *fbdev = plane.fbdev;
    ...
    win.format = 0;
    omapfb_rqueue_lock(fbdev);
    r = fbdev.ctrl.update_window(fbi, &win, core::ptr::null_mut(), core::ptr::null_mut());
    omapfb_rqueue_unlock(fbdev);
    return r;
    }
#[no_mangle]
unsafe extern "C" fn omapfb_setup_plane(fbi: *mut fb_info, pi: *mut omapfb_plane_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omapfb_query_plane(fbi: *mut fb_info, pi: *mut omapfb_plane_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omapfb_setup_mem(fbi: *mut fb_info, mi: *mut omapfb_mem_info) -> c_int {
    ...
    size_t size;
    let mut r: c_int = 0;
    if (fbdev.ctrl.setup_mem == core::ptr::null_mut())
    return -ENODEV;
    ...
    struct fb_var_screeninfo *new_var = &fbdev.new_var;
    let mut old_size: c_ulong = rg.size;
    let mut old_type: u8 = rg.type;
    unsigned long paddr;
    rg.size = size;
    rg.type = mi.type;
//
...
#[no_mangle]
unsafe extern "C" fn omapfb_query_mem(fbi: *mut fb_info, mi: *mut omapfb_mem_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omapfb_init_notifier() {
    ...
    if (r)
    return r;
    if (omapfb_dev != core::ptr::null_mut() &&
...
#[no_mangle]
pub unsafe extern "C" fn omapfb_unregister_client(omapfb_nb: *mut omapfb_notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn omapfb_notify_clients(fbdev: *mut omapfb_device, event: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn omapfb_get_update_mode(fbdev: *mut omapfb_device) -> enum omapfb_update_mode {
...
// For lcd testing
#[no_mangle]
pub unsafe extern "C" fn omapfb_write_first_pixel(fbdev: *mut omapfb_device, pixval: u16) {
...
// (u16 *)fbdev->mem_desc.region[0].vaddr = pixval;
    ...
    win.out_width = 2;
    win.out_height = 2;
    fbdev.ctrl.update_window(fbdev.fb_info[0], &win, core::ptr::null_mut(), core::ptr::null_mut());
    }
    omapfb_rqueue_unlock(fbdev);
    }
...
#[no_mangle]
unsafe extern "C" fn omapfb_mmap(info: *mut fb_info, vma: *mut vm_area_struct) -> c_int {
...
// omapfbX sysfs entries
    ...
    static DEVICE_ATTR(caps_num, 0444, omapfb_show_caps_num, core::ptr::null_mut());
    static DEVICE_ATTR(caps_text, 0444, omapfb_show_caps_text, core::ptr::null_mut());
// panel sysfs entries
    ...
    __ATTR(name, 0444, omapfb_show_panel_name, core::ptr::null_mut());
    static DEVICE_ATTR(backlight_level, 0664,
    omapfb_show_bklight_level, omapfb_store_bklight_level);
    static DEVICE_ATTR(backlight_max, 0444, omapfb_show_bklight_max, core::ptr::null_mut());
...
// ctrl sysfs entries
    ...
    __ATTR(name, 0444, omapfb_show_ctrl_name, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn omapfb_register_sysfs(fbdev: *mut omapfb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omapfb_unregister_sysfs(fbdev: *mut omapfb_device) {
...
//
#[no_mangle]
unsafe extern "C" fn fbinfo_init(fbdev: *mut omapfb_device, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fbinfo_cleanup(fbdev: *mut omapfb_device, fbi: *mut fb_info) {
    static void fbinfo_cleanup(struct omapfb_device *fbdev, struct fb_info *fbi)
    {
    fb_dealloc_cmap(&fbi.cmap);
    }
#[no_mangle]
unsafe extern "C" fn planes_cleanup(fbdev: *mut omapfb_device) {
    static void planes_cleanup(struct omapfb_device *fbdev)
    {
    int i;
    for (i = 0; i < fbdev.mem_desc.region_cnt; i++) {
    if (fbdev.fb_info[i] == core::ptr::null_mut())
    break;
...
#[no_mangle]
unsafe extern "C" fn planes_init(fbdev: *mut omapfb_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn omapfb_free_resources(fbdev: *mut omapfb_device, state: c_int) {
    ...
    fallthrough;
    case 1:
    dev_set_drvdata(fbdev.dev, core::ptr::null_mut());
    kfree(fbdev);
    break;
    case 0:
// nothing to free
...
#[no_mangle]
unsafe extern "C" fn omapfb_find_ctrl(fbdev: *mut omapfb_device) -> c_int {
    ...
    if (fbdev.ctrl == core::ptr::null_mut()) {
...
//
    ...
    {
    struct omapfb_device	*fbdev = core::ptr::null_mut();
    int			init_state;
    ...
    if (r)
    goto cleanup;
    if (fbdev.ctrl.mmap != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn omapfb_probe(pdev: *mut platform_device) -> c_int {
    static int omapfb_probe(struct platform_device *pdev)
    {
    int r;
    BUG_ON(fbdev_pdev != core::ptr::null_mut());
...
// Delay actual initialization until the LCD is registered
    fbdev_pdev = pdev;
    if (fbdev_panel != core::ptr::null_mut())
    omapfb_do_probe(fbdev_pdev, fbdev_panel);
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn omapfb_register_panel(panel: *mut lcd_panel) {
    void omapfb_register_panel(struct lcd_panel *panel)
    {
    BUG_ON(fbdev_panel != core::ptr::null_mut());
    fbdev_panel = panel;
    if (fbdev_pdev != core::ptr::null_mut())
    omapfb_do_probe(fbdev_pdev, fbdev_panel);
    }
    EXPORT_SYMBOL_GPL(omapfb_register_panel);
// Called when the device is being detached from the driver
#[no_mangle]
unsafe extern "C" fn omapfb_remove(pdev: *mut platform_device) {
    static void omapfb_remove(struct platform_device *pdev)
    {
    struct omapfb_device *fbdev = platform_get_drvdata(pdev);
    let mut saved_state: enum omapfb_state = fbdev.state;
// FIXME: wait till completion of pending events
    fbdev.state = OMAPFB_DISABLED;
    omapfb_free_resources(fbdev, saved_state);
    platform_device_unregister(&omapdss_device);
    fbdev.dssdev = core::ptr::null_mut();
    }
// PM suspend
#[no_mangle]
unsafe extern "C" fn omapfb_suspend(pdev: *mut platform_device, mesg: pm_message_t) -> c_int {
...
// PM resume
#[no_mangle]
unsafe extern "C" fn omapfb_resume(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omapfb_setup(options: *mut c_char) -> int __init {
    static int __init omapfb_setup(char *options)
    {
    char *this_opt = core::ptr::null_mut();
    let mut r: c_int = 0;
    pr_debug("omapfb: options %s\n", options);
    if (!options || !*options)
    return 0;
    while (!r && (this_opt = strsep(&options, ",")) != core::ptr::null_mut()) {
    if (!strncmp(this_opt, "accel", 5))
    def_accel = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "vram:", _arg: 5)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "vxres:", _arg: 6)) -> else {
    else if (!strncmp(this_opt, "vxres:", 6))
    def_vxres = simple_strtoul(this_opt + 6, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "vyres:", _arg: 6)) -> else {
    else if (!strncmp(this_opt, "vyres:", 6))
    def_vyres = simple_strtoul(this_opt + 6, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "rotate:", _arg: 7)) -> else {
    else if (!strncmp(this_opt, "rotate:", 7))
    def_rotate = (simple_strtoul(this_opt + 7, core::ptr::null_mut(), 0));
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "mirror:", _arg: 7)) -> else {
    else if (!strncmp(this_opt, "mirror:", 7))
    def_mirror = (simple_strtoul(this_opt + 7, core::ptr::null_mut(), 0));
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "manual_update", _arg: 13)) -> else {
...
#[no_mangle]
unsafe extern "C" fn omapfb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn omapfb_cleanup() -> void __exit {
