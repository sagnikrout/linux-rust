...
//! Source: drivers/video/fbdev/omap/sossi.c
#![no_std]
...
pub const OMAP_SOSSI_BASE: c_uint = 0xfffbac00;
pub const SOSSI_ID_REG: c_uint = 0x00;
pub const SOSSI_INIT1_REG: c_uint = 0x04;
pub const SOSSI_INIT2_REG: c_uint = 0x08;
pub const SOSSI_INIT3_REG: c_uint = 0x0c;
pub const SOSSI_FIFO_REG: c_uint = 0x10;
pub const SOSSI_REOTABLE_REG: c_uint = 0x14;
pub const SOSSI_TEARING_REG: c_uint = 0x18;
pub const SOSSI_INIT1B_REG: c_uint = 0x1c;
pub const SOSSI_FIFOB_REG: c_uint = 0x20;
pub const DMA_GSCR: c_uint = 0xfffedc04;
pub const DMA_LCD_CCR: c_uint = 0xfffee3c2;
pub const DMA_LCD_CTRL: c_uint = 0xfffee3c4;
pub const DMA_LCD_LCH_CTRL: c_uint = 0xfffee3ea;

pub const RD_ACCESS: c_int = 0;
pub const WR_ACCESS: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn ps_to_sossi_ticks(ps: u32, div: c_int) -> u32 {
    static u32 ps_to_sossi_ticks(u32 ps, int div)
    {
    let mut clk_period: u32 = HZ_TO_PS(sossi.fck_hz) * div;
    return (clk_period + ps - 1) / clk_period;
    }
#[no_mangle]
unsafe extern "C" fn calc_rd_timings(t: *mut extif_timings) -> c_int {
    static int calc_rd_timings(struct extif_timings *t)
    {
    u32 tw0, tw1;
    int reon, reoff, recyc, actim;
    let mut div: c_int = t.clk_div;
//
...
#[no_mangle]
unsafe extern "C" fn calc_wr_timings(t: *mut extif_timings) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _set_timing(div: c_int, tw0: c_int, tw1: c_int) {
...
#[no_mangle]
unsafe extern "C" fn _set_bits_per_cycle(bus_pick_count: c_int, bus_pick_width: c_int) {
...
#[no_mangle]
unsafe extern "C" fn _set_tearsync_mode(mode: c_int, line: unsigned) {
...
#[no_mangle]
pub unsafe extern "C" fn set_timing(access: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sossi_start_transfer() {
...
#[no_mangle]
unsafe extern "C" fn sossi_stop_transfer() {
...
#[no_mangle]
unsafe extern "C" fn wait_end_of_write() {
...
#[no_mangle]
unsafe extern "C" fn send_data(data: *const c_void, len: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn set_cycles(len: c_uint) {
    static void set_cycles(unsigned int len)
    {
    let mut nr_cycles: c_ulong = len / (sossi.bus_pick_width / 8);
    BUG_ON((nr_cycles - 1) & ~0x3ffff);
    sossi_clear_bits(SOSSI_INIT1_REG, 0x3ffff);
    sossi_set_bits(SOSSI_INIT1_REG, (nr_cycles - 1) & 0x3ffff);
    }
#[no_mangle]
unsafe extern "C" fn sossi_convert_timings(t: *mut extif_timings) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sossi_set_timings(t: *const extif_timings) {
...
#[no_mangle]
unsafe extern "C" fn sossi_get_clk_info(clk_period: *mut u32, max_clk_div: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn sossi_set_bits_per_cycle(bpc: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sossi_enable_tearsync(enable: c_int, line: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sossi_write_command(data: *const c_void, len: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sossi_write_data(data: *const c_void, len: c_uint) {
...
// CMD#/DATA
    ...
    {
    BUG_ON(callback == core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sossi_dma_callback(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sossi_read_data(data: *mut c_void, len: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sossi_match_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sossi_init(fbdev: *mut omapfb_device) -> c_int {
...
// Take SoSSI out of reset
    ...
    if ((r = omap_lcdc_set_dma_callback(sossi_dma_callback, core::ptr::null_mut())) < 0) {
...
#[no_mangle]
unsafe extern "C" fn sossi_cleanup() {
