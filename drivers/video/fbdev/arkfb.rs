...
//! Source: drivers/video/fbdev/arkfb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct arkfb_info {
    pub mclk_freq: c_int,
    pub wc_cookie: c_int,
    pub dac: *mut dac_info,
    pub state: vgastate,
    pub open_lock: mutex,
...
// Module parameters
    ...
    let mut threshold: static int = 4;
    module_param(threshold, int, 0644);
    MODULE_PARM_DESC(threshold, "FIFO threshold");
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn arkfb_settile(info: *mut fb_info, map: *mut fb_tilemap) {
...
#[no_mangle]
unsafe extern "C" fn arkfb_tilecursor(info: *mut fb_info, cursor: *mut fb_tilecursor) {
...
#[no_mangle]
unsafe extern "C" fn arkfb_iplan_imageblit(info: *mut fb_info, image: *const fb_image) {
...
#[no_mangle]
unsafe extern "C" fn arkfb_iplan_fillrect(info: *mut fb_info, rect: *const fb_fillrect) {
...
#[no_mangle]
unsafe extern "C" fn arkfb_cfb4_imageblit(info: *mut fb_info, image: *const fb_image) {
...
#[no_mangle]
unsafe extern "C" fn arkfb_imageblit(info: *mut fb_info, image: *const fb_image) {
...
#[no_mangle]
unsafe extern "C" fn arkfb_fillrect(info: *mut fb_info, rect: *const fb_fillrect) {
...
#[derive(Copy, Clone)]
pub struct dac_ops {
    pub info): *mut *mut int (dac_get_mode)(struct dac_info,
    pub mode): *mut *mut *mut int (dac_set_mode)(struct dac_info info, int,
    pub channel): *mut *mut *mut int (dac_get_freq)(struct dac_info info, int,
    pub freq): *mut *mut *mut int (dac_set_freq)(struct dac_info info, int channel, u32,
    pub info): *mut *mut void (dac_release)(struct dac_info,
}
...
#[no_mangle]
pub unsafe extern "C" fn dac_read_regs(info: *mut dac_info, code: *mut u8, count: c_int) {
    static inline void dac_read_regs(struct dac_info *info, u8 *code, int count)
    {
    info.dac_read_regs(info.data, code, count);
    }
#[no_mangle]
pub unsafe extern "C" fn dac_write_reg(info: *mut dac_info, reg: u8, val: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn dac_write_regs(info: *mut dac_info, code: *mut u8, count: c_int) {
    static inline void dac_write_regs(struct dac_info *info, u8 *code, int count)
    {
    info.dac_write_regs(info.data, code, count);
    }
#[no_mangle]
pub unsafe extern "C" fn dac_set_mode(info: *mut dac_info, mode: c_int) -> c_int {
    static inline int dac_set_mode(struct dac_info *info, int mode)
    {
    return info.dacops.dac_set_mode(info, mode);
    }
#[no_mangle]
pub unsafe extern "C" fn dac_set_freq(info: *mut dac_info, channel: c_int, freq: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dac_release(info: *mut dac_info) {
...
#[no_mangle]
unsafe extern "C" fn ics5342_set_mode(info: *mut dac_info, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ics5342_set_freq(info: *mut dac_info, channel: c_int, freq: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ics5342_release(info: *mut dac_info) {
...
#[no_mangle]
unsafe extern "C" fn ics5342_init(drr: dac_read_regs_t, dwr: dac_write_regs_t, data: *mut c_void) -> *mut dac_info {
...
#[no_mangle]
unsafe extern "C" fn ark_dac_read_regs(data: *mut c_void, code: *mut u8, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ark_dac_write_regs(data: *mut c_void, code: *mut u8, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ark_set_pixclock(info: *mut fb_info, pixclock: u32) {
    static void ark_set_pixclock(struct fb_info *info, u32 pixclock)
    {
    struct arkfb_info *par = info.par;
    u8 regval;
    let mut rv: c_int = dac_set_freq(par.dac, 0, 1000000000 / pixclock);
    if (rv < 0) {
...
// Open framebuffer
#[no_mangle]
unsafe extern "C" fn arkfb_open(info: *mut fb_info, user: c_int) -> c_int {
...
// Close framebuffer
#[no_mangle]
unsafe extern "C" fn arkfb_release(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arkfb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
// Find appropriate format
    rv = svga_match_format (arkfb_formats, var, core::ptr::null_mut());
    if (rv < 0)
    {
...
#[no_mangle]
unsafe extern "C" fn arkfb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arkfb_blank(blank_mode: c_int, info: *mut fb_info) -> c_int {
...
// Pan the display
#[no_mangle]
unsafe extern "C" fn arkfb_pan_display(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
// PCI probe
#[no_mangle]
unsafe extern "C" fn ark_pci_probe(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
// Prepare startup mode
    rc = fb_find_mode(&(info.var), info, mode_option, core::ptr::null_mut(), 0, core::ptr::null_mut(), 8);
    if (! ((rc == 1) || (rc == 2))) {
    rc = -EINVAL;
...
// PCI remove
#[no_mangle]
unsafe extern "C" fn ark_pci_remove(dev: *mut pci_dev) {
...
// PCI suspend
#[no_mangle]
unsafe extern "C" fn ark_pci_suspend(dev: *mut device) -> int __maybe_unused {
...
// PCI resume
#[no_mangle]
unsafe extern "C" fn ark_pci_resume(dev: *mut device) -> int __maybe_unused {
...
// Cleanup
#[no_mangle]
unsafe extern "C" fn arkfb_cleanup() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn arkfb_init() -> int __init {
