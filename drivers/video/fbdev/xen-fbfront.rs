...
//! Source: drivers/video/fbdev/xen-fbfront.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xenfb_info {
    pub fb: *mut c_uchar,
    pub fb_info: *mut fb_info,
    pub rectangle,: *mut *mut int x1, y1, x2, y2; / dirty,
    protected by dirty_lock */
    pub dirty_lock: spinlock_t,
    pub nr_pages: c_int,
    pub irq: c_int,
    pub page: *mut xenfb_page,
    pub gfns: *mut c_ulong,
    pub /: *mut *mut int update_wanted; / XENFB_TYPE_UPDATE wanted,
    pub /: *mut *mut int feature_resize; / XENFB_TYPE_RESIZE ok,
    pub /: *mut *mut xenfb_resize resize; / protected by resize_lock,
    pub /: *mut *mut int resize_dpy; / ditto,
    pub resize_lock: spinlock_t,
    pub xbdev: *mut xenbus_device,
}

    enum { KPARAM_MEM, KPARAM_WIDTH, KPARAM_HEIGHT, KPARAM_CNT };
    static int video[KPARAM_CNT] = { 2, XENFB_WIDTH, XENFB_HEIGHT };
    module_param_array(video, int, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn xenfb_do_resize(info: *mut xenfb_info) {
...
#[no_mangle]
unsafe extern "C" fn xenfb_queue_full(info: *mut xenfb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xenfb_handle_resize_dpy(info: *mut xenfb_info) {
    ...
    {
    unsigned long flags;
    let mut x2: c_int = x1 + w - 1;
    let mut y2: c_int = y1 + h - 1;
...
#[no_mangle]
unsafe extern "C" fn xenfb_deferred_io(fb_info: *mut fb_info, pagereflist: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn xenfb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xenfb_defio_damage_range(info: *mut fb_info, off: off_t, len: usize) {
...
#[no_mangle]
unsafe extern "C" fn xenfb_event_handler(rq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// abusing framebuffer_alloc() to allocate pseudo_palette
    fb_info = framebuffer_alloc(sizeof(u32) * 256, core::ptr::null_mut());
    if (fb_info == core::ptr::null_mut())
    goto error_nomem;
// complete the abuse:
...
#[no_mangle]
unsafe extern "C" fn xenfb_make_preferred_console() {
    static void xenfb_make_preferred_console(void)
    {
    struct console *c;
...
#[no_mangle]
unsafe extern "C" fn xenfb_resume(dev: *mut xenbus_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xenfb_remove(dev: *mut xenbus_device) {
...
#[no_mangle]
unsafe extern "C" fn vmalloc_to_gfn(address: *mut c_void) -> c_ulong {
    ...
    {
    int i;
    let mut epd: c_int = PAGE_SIZE / sizeof(info.gfns[0]);
...
#[no_mangle]
unsafe extern "C" fn xenfb_disconnect_backend(info: *mut xenfb_info) {
...
#[no_mangle]
unsafe extern "C" fn xenfb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn xenfb_cleanup() -> void __exit {
