...
//! Source: drivers/video/fbdev/pvr2fb.c
#![no_std]
...
pub const TV_CLK: c_int = 74239;
pub const VGA_CLK: c_int = 37119;
// This is for 60Hz - the VTOTAL is doubled for interlaced modes
pub const PAL_HTOTAL: c_int = 863;
pub const PAL_VTOTAL: c_int = 312;
pub const NTSC_HTOTAL: c_int = 857;
pub const NTSC_VTOTAL: c_int = 262;
...
//
    ...
    let mut cable_type: static int = CT_VGA;
    let mut video_output: static int = VO_VGA;
...
//
    ...
    let mut shdma: static unsigned int = PVR2_CASCADE_CHAN;
    let mut pvr2dma: static unsigned int = CONFIG_NR_ONCHIP_DMA_CHANNELS;
...
pub const DEFMODE_NTSC: c_int = 0;
pub const DEFMODE_PAL: c_int = 0;
pub const DEFMODE_VGA: c_int = 2;
    let mut defmode: static int = DEFMODE_NTSC;
    static char *mode_option = core::ptr::null_mut();
#[no_mangle]
pub unsafe extern "C" fn pvr2fb_set_pal_type(type: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pvr2fb_blank(blank: c_int, info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_line_length(xres_virtual: c_int, bpp: c_int) -> c_ulong {
    static inline unsigned long get_line_length(int xres_virtual, int bpp)
    {
    return (unsigned long)((((xres_virtual*bpp)+31)&~31) >> 3);
    }
#[no_mangle]
unsafe extern "C" fn set_color_bitfields(var: *mut fb_var_screeninfo) {
...
#[no_mangle]
unsafe extern "C" fn pvr2_init_cable() -> c_int {
...
// XXX: Save the previous val first, as this reg is also AICA
    ...
    fb_writel(3 << 8, VOUTC);
#[no_mangle]
pub unsafe extern "C" fn if(CT_RGB: cable_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn pvr2fb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pvr2fb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pvr2_update_display(info: *mut fb_info) {
...
//
#[no_mangle]
unsafe extern "C" fn pvr2_init_display(info: *mut fb_info) {
    static void pvr2_init_display(struct fb_info *info)
    {
    struct pvr2fb_par *par = (struct pvr2fb_par *) info.par;
    struct fb_var_screeninfo *var = &info.var;
    unsigned int diw_height, diw_width, diw_modulo = 1;
    let mut bytesperpixel: c_uint = var.bits_per_pixel >> 3;
...
#[no_mangle]
unsafe extern "C" fn pvr2_do_blank() {
...
#[no_mangle]
unsafe extern "C" fn pvr2fb_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn pvr2fb_common_init() -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn pvr2fb_dc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pvr2fb_dc_exit() {
    static void pvr2fb_dc_exit(void)
    {
    if (fb_info.screen_base) {
    iounmap(fb_info.screen_base);
    fb_info.screen_base = core::ptr::null_mut();
    }
    if (currentpar.mmio_base) {
    iounmap(currentpar.mmio_base);
    currentpar.mmio_base = core::ptr::null_mut();
    }
    free_irq(HW_EVENT_VSYNC, fb_info);
...
#[no_mangle]
unsafe extern "C" fn pvr2fb_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pvr2fb_pci_init() -> int __init {
    static int __init pvr2fb_pci_init(void)
    {
    return pci_register_driver(&pvr2fb_pci_driver);
    }
#[no_mangle]
unsafe extern "C" fn pvr2fb_pci_exit() {
...
#[no_mangle]
unsafe extern "C" fn pvr2fb_setup(options: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pvr2fb_init() -> int __init {
    ...
    fb_info = framebuffer_alloc(sizeof(struct pvr2fb_par), core::ptr::null_mut());
    if (!fb_info)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn pvr2fb_exit() -> void __exit {
