...
//! Source: drivers/video/fbdev/mb862xx/mb862xxfbdrv.c
#![no_std]
...
pub const MB862XX_MEM_SIZE: c_uint = 0x1000000;
pub const CORALP_MEM_SIZE: c_uint = 0x2000000;
pub const CARMINE_MEM_SIZE: c_uint = 0x8000000;
...
#[no_mangle]
pub unsafe extern "C" fn hsp(var: *mut fb_var_screeninfo) -> c_int {
    static inline int hsp(struct fb_var_screeninfo *var)
    {
    return var.xres + var.right_margin - 1;
    }
#[no_mangle]
pub unsafe extern "C" fn vsp(var: *mut fb_var_screeninfo) -> c_int {
    static inline int vsp(struct fb_var_screeninfo *var)
    {
    return var.yres + var.lower_margin - 1;
    }
#[no_mangle]
pub unsafe extern "C" fn d_pitch(var: *mut fb_var_screeninfo) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mb862xxfb_set_par(fbi: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mb862xxfb_blank(mode: c_int, fbi: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mb862xxfb_init_fbinfo(fbi: *mut fb_info) -> int __maybe_unused {
...
// get the disp mode from active display cfg
    let mut sc: c_ulong = ((reg & GC_DCM01_SC) >> 8) + 1;
...
#[no_mangle]
unsafe extern "C" fn mb862xx_intr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn mb862xx_gdc_init(par: *mut mb862xxfb_par) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_platform_mb862xx_probe(ofdev: *mut platform_device) -> c_int {
    ...
    if (par.fb_base == core::ptr::null_mut()) {
    dev_err(dev, "Cannot map framebuffer\n");
    goto rel_reg;
    }
    par.mmio_base = ioremap(par.mmio_base_phys, par.mmio_len);
    if (par.mmio_base == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn of_platform_mb862xx_remove(ofdev: *mut platform_device) {
    static void of_platform_mb862xx_remove(struct platform_device *ofdev)
    {
    struct fb_info *fbi = dev_get_drvdata(&ofdev.dev);
    struct mb862xxfb_par *par = fbi.par;
    let mut res_size: resource_size_t = resource_size(par.res);
    unsigned long reg;
...
#[no_mangle]
unsafe extern "C" fn coralp_init(par: *mut mb862xxfb_par) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_dram_ctrl(par: *mut mb862xxfb_par) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn carmine_init(par: *mut mb862xxfb_par) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mb862xx_pci_gdc_init(par: *mut mb862xxfb_par) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mb862xx_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mb862xxfb_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mb862xxfb_exit() -> void __exit {
