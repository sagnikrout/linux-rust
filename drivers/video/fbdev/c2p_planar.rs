...
//! Source: drivers/video/fbdev/c2p_planar.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn c2p_32x8(d[8]: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn store_planar(dst: *mut c_void, dst_inc: u32, bpp: u32, d[8]: u32) {
