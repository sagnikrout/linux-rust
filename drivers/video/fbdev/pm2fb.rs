...
//! Source: drivers/video/fbdev/pm2fb.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn pm2_RD(p: *mut pm2fb_par, off: i32) -> u32 {
    static inline u32 pm2_RD(struct pm2fb_par *p, s32 off)
    {
    return fb_readl(p.v_regs + off);
    }
#[no_mangle]
pub unsafe extern "C" fn pm2_WR(p: *mut pm2fb_par, off: i32, v: u32) {
    static inline void pm2_WR(struct pm2fb_par *p, s32 off, u32 v)
    {
    fb_writel(v, p.v_regs + off);
    }
#[no_mangle]
pub unsafe extern "C" fn pm2_RDAC_RD(p: *mut pm2fb_par, idx: i32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn pm2v_RDAC_RD(p: *mut pm2fb_par, idx: i32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn pm2_RDAC_WR(p: *mut pm2fb_par, idx: i32, v: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn pm2v_RDAC_WR(p: *mut pm2fb_par, idx: i32, v: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn WAIT_FIFO(p: *mut pm2fb_par, a: u32) {
...
//
    ...
    { 0,	0 } };
#[no_mangle]
unsafe extern "C" fn partprod(xres: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn to3264(timing: u32, bpp: c_int, is64: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn clear_palette(p: *mut pm2fb_par) {
...
#[no_mangle]
unsafe extern "C" fn reset_card(p: *mut pm2fb_par) {
...
#[no_mangle]
unsafe extern "C" fn reset_config(p: *mut pm2fb_par) {
...
#[no_mangle]
unsafe extern "C" fn set_aperture(p: *mut pm2fb_par, depth: u32) {
...
#[no_mangle]
unsafe extern "C" fn set_memclock(par: *mut pm2fb_par, clk: u32) {
...
#[no_mangle]
unsafe extern "C" fn set_pixclock(par: *mut pm2fb_par, clk: u32) {
...
#[no_mangle]
unsafe extern "C" fn set_video(p: *mut pm2fb_par, video: u32) {
    static void set_video(struct pm2fb_par *p, u32 video)
    {
    u32 tmp;
    let mut vsync: u32 = video;
    DPRINTK("video = 0x%x\n", video);
//
...
//
#[no_mangle]
unsafe extern "C" fn pm2fb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pm2fb_set_par(info: *mut fb_info) -> c_int {
    static int pm2fb_set_par(struct fb_info *info)
    {
    struct pm2fb_par *par = info.par;
    u32 pixclock;
    let mut width: u32 = (info.var.xres_virtual + 7) & ~7;
    let mut height: u32 = info.var.yres_virtual;
    let mut depth: u32 = (info.var.bits_per_pixel + 7) & ~7;
    u32 hsstart, hsend, hbend, htotal;
    u32 vsstart, vsend, vbend, vtotal;
    u32 stride;
    u32 base;
    let mut video: u32 = 0;
    let mut clrmode: u32 = PM2F_RD_COLOR_MODE_RGB | PM2F_RD_GUI_ACTIVE;
    let mut txtmap: u32 = 0;
    let mut pixsize: u32 = 0;
    let mut clrformat: u32 = 0;
    u32 misc = 1; /* 8-bit DAC */
    let mut xres: u32 = (info.var.xres + 31) & ~31;
    int data64;
    reset_card(par);
    reset_config(par);
    clear_palette(par);
...
//
#[no_mangle]
unsafe extern "C" fn pm2fb_blank(blank_mode: c_int, info: *mut fb_info) -> c_int {
    static int pm2fb_blank(int blank_mode, struct fb_info *info)
    {
    struct pm2fb_par *par = info.par;
    let mut video: u32 = par.video;
...
#[no_mangle]
unsafe extern "C" fn pm2fb_sync(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm2fb_imageblit(info: *mut fb_info, image: *const fb_image) {
...
#[no_mangle]
unsafe extern "C" fn pm2vfb_cursor(info: *mut fb_info, cursor: *mut fb_cursor) -> c_int {
    static int pm2vfb_cursor(struct fb_info *info, struct fb_cursor *cursor)
    {
    struct pm2fb_par *par = info.par;
    let mut mode: u8 = PM2F_CURSORMODE_TYPE_X;
    let mut x: c_int = cursor.image.dx - info.var.xoffset;
    let mut y: c_int = cursor.image.dy - info.var.yoffset;
    if (cursor.enable)
...
//
    ...
    let mut cmap: fb_cmap = info.cmap;
// the X11 driver says one should use these color registers
    ...
    int i;
    let mut pos: c_int = PM2VI_RD_CURSOR_PATTERN;
    for (i = 0; i < cursor.image.height; i++) {
    let mut j: c_int = (cursor.image.width + 7) >> 3;
    let mut k: c_int = 8 - j;
    pm2_WR(par, PM2VR_RD_INDEX_HIGH, pos >> 8);
    for (; j > 0; j--) {
    let mut data: u8 = *bitmap ^ *mask;
...
#[no_mangle]
unsafe extern "C" fn pm2fb_cursor(info: *mut fb_info, cursor: *mut fb_cursor) -> c_int {
...
//
    ...
    let mut x: c_int = cursor.image.dx - info.var.xoffset + 63;
    let mut y: c_int = cursor.image.dy - info.var.yoffset + 63;
    WAIT_FIFO(par, 4);
...
//
#[no_mangle]
unsafe extern "C" fn pm2fb_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pm2fb_remove(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pm2fb_setup(options: *mut c_char) -> int __init {
    ...
    lowhsync = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(this_opt, _arg: "lowvsync")) -> else {
    else if (!strcmp(this_opt, "lowvsync"))
    lowvsync = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "hwcursor=", _arg: 9)) -> else {
    else if (!strncmp(this_opt, "hwcursor=", 9))
    hwcursor = simple_strtoul(this_opt + 9, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "nomtrr", _arg: 6)) -> else {
    else if (!strncmp(this_opt, "nomtrr", 6))
    nomtrr = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "noaccel", _arg: 7)) -> else {
...
#[no_mangle]
unsafe extern "C" fn pm2fb_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn pm2fb_exit() -> void __exit {
