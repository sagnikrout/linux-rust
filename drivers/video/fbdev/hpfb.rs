...
//! Source: drivers/video/fbdev/hpfb.c
#![no_std]
...
pub const TC_NBLANK: c_uint = 0x4080;
pub const TC_WEN: c_uint = 0x4088;
pub const TC_REN: c_uint = 0x408c;
pub const TC_FBEN: c_uint = 0x4090;
pub const TC_PRR: c_uint = 0x40ea;
// These defines match the X window system
pub const RR_CLEAR: c_uint = 0x0;
pub const RR_COPY: c_uint = 0x3;
pub const RR_NOOP: c_uint = 0x5;
pub const RR_XOR: c_uint = 0x6;
pub const RR_INVERT: c_uint = 0xa;
pub const RR_COPYINVERTED: c_uint = 0xc;
pub const RR_SET: c_uint = 0xf;
// blitter regs
pub const BUSY: c_uint = 0x4044;
pub const WMRR: c_uint = 0x40ef;
pub const SOURCE_X: c_uint = 0x40f2;
pub const SOURCE_Y: c_uint = 0x40f6;
pub const DEST_X: c_uint = 0x40fa;
pub const DEST_Y: c_uint = 0x40fe;
pub const WHEIGHT: c_uint = 0x4106;
pub const WWIDTH: c_uint = 0x4102;
pub const WMOVE: c_uint = 0x409c;
    ...
    {
// use MSBs
    let mut _red: c_uchar = red>>8;
    let mut _green: c_uchar = green>>8;
    let mut _blue: c_uchar = blue>>8;
    let mut _regno: c_uchar = regno;
//
...
#[no_mangle]
unsafe extern "C" fn hpfb_blank(blank: c_int, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn topcat_blit(x0: c_int, y0: c_int, x1: c_int, y1: c_int, w: c_int, h: c_int, rr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hpfb_copyarea(info: *mut fb_info, area: *const fb_copyarea) {
    static void hpfb_copyarea(struct fb_info *info, const struct fb_copyarea *area)
    {
    topcat_blit(area.sx, area.sy, area.dx, area.dy, area.width, area.height, RR_COPY);
    }
#[no_mangle]
unsafe extern "C" fn hpfb_fillrect(p: *mut fb_info, region: *const fb_fillrect) {
...
#[no_mangle]
unsafe extern "C" fn hpfb_sync(info: *mut fb_info) -> c_int {
...
pub const HPFB_FBWMSB: c_uint = 0x05	/* Frame buffer width 		*/;
pub const HPFB_FBWLSB: c_uint = 0x07;
pub const HPFB_FBHMSB: c_uint = 0x09	/* Frame buffer height		*/;
pub const HPFB_FBHLSB: c_uint = 0x0b;
pub const HPFB_DWMSB: c_uint = 0x0d	/* Display width		*/;
pub const HPFB_DWLSB: c_uint = 0x0f;
pub const HPFB_DHMSB: c_uint = 0x11	/* Display height		*/;
pub const HPFB_DHLSB: c_uint = 0x13;
pub const HPFB_NUMPLANES: c_uint = 0x5b	/* Number of colour planes	*/;
pub const HPFB_FBOMSB: c_uint = 0x5d	/* Frame buffer offset		*/;
pub const HPFB_FBOLSB: c_uint = 0x5f;
#[no_mangle]
unsafe extern "C" fn hpfb_init_one(phys_base: c_ulong, virt_base: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hpfb_dio_probe(d: *mut dio_dev, ent: *const dio_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpfb_remove_one(d: *mut dio_dev) {
...
#[no_mangle]
unsafe extern "C" fn hpfb_init() -> int __init {
...
//
pub const INTFBVADDR: c_uint = 0xf0560000;
pub const INTFBPADDR: c_uint = 0x560000;
    if (!MACH_IS_HP300)
    return -ENODEV;
    if (fb_get_options("hpfb", core::ptr::null_mut()))
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn hpfb_cleanup_module() -> void __exit {
