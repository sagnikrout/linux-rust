...
//! Source: drivers/video/fbdev/core/fbmon.c
#![no_std]
...
pub const FBMON_FIX_HEADER: c_int = 1;
pub const FBMON_FIX_INPUT: c_int = 2;
pub const FBMON_FIX_TIMINGS: c_int = 3;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct broken_edid {
...
#[no_mangle]
unsafe extern "C" fn copy_string(c: *mut c_uchar, s: *mut c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn edid_is_serial_block(block: *mut c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edid_is_ascii_block(block: *mut c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edid_is_limits_block(block: *mut c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edid_is_monitor_block(block: *mut c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edid_is_timing_block(block: *mut c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_edid(edid: *mut c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fix_edid(edid: *mut c_uchar, fix: c_int) {
...
#[no_mangle]
unsafe extern "C" fn edid_checksum(edid: *mut c_uchar) -> c_int {
    static int edid_checksum(unsigned char *edid)
    {
    let mut csum: c_uchar = 0, all_null = 0;
...
#[no_mangle]
unsafe extern "C" fn edid_check_header(edid: *mut c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_vendor_block(block: *mut c_uchar, specs: *mut fb_monspecs) {
...
#[no_mangle]
unsafe extern "C" fn get_chroma(block: *mut c_uchar, specs: *mut fb_monspecs) {
...
#[no_mangle]
unsafe extern "C" fn get_est_timing(block: *mut c_uchar, mode: *mut fb_videomode) -> c_int {
    ...
    let mut std_2byte_code: u32 = block[0] << 8 | block[1];
...
//
    ...
    unsigned char *block;
    let mut num: c_int = 0, i, first = 1;
    int ver, rev;
    mode = kzalloc_objs(struct fb_videomode, 50);
    if (mode == core::ptr::null_mut())
    return core::ptr::null_mut();
    if (edid == core::ptr::null_mut() || !edid_checksum(edid) ||
...
//
#[no_mangle]
pub unsafe extern "C" fn fb_destroy_modedb(modedb: *mut fb_videomode) {
    void fb_destroy_modedb(struct fb_videomode *modedb)
    {
    kfree(modedb);
    }
#[no_mangle]
unsafe extern "C" fn fb_get_monitor_limits(edid: *mut c_uchar, specs: *mut fb_monspecs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_monspecs(edid: *mut c_uchar, specs: *mut fb_monspecs) {
...
#[no_mangle]
pub unsafe extern "C" fn fb_parse_edid(edid: *mut c_uchar, var: *mut fb_var_screeninfo) -> c_int {
    int fb_parse_edid(unsigned char *edid, struct fb_var_screeninfo *var)
    {
    int i;
    unsigned char *block;
    if (edid == core::ptr::null_mut() || var == core::ptr::null_mut())
    return 1;
...
#[no_mangle]
pub unsafe extern "C" fn fb_edid_to_monspecs(edid: *mut c_uchar, specs: *mut fb_monspecs) {
...
//
pub const FLYBACK: c_int = 550;
pub const V_FRONTPORCH: c_int = 1;
pub const H_OFFSET: c_int = 40;
pub const H_SCALEFACTOR: c_int = 20;
pub const H_BLANKSCALE: c_int = 128;
pub const H_GRADIENT: c_int = 600;
pub const C_VAL: c_int = 30;
pub const M_VAL: c_int = 300;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct __fb_timings {
    pub dclk: u32,
    pub hfreq: u32,
    pub vfreq: u32,
    pub hactive: u32,
...
//
#[no_mangle]
unsafe extern "C" fn fb_get_vblank(hfreq: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn fb_get_hblank_by_hfreq(hfreq: u32, xres: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn fb_get_hblank_by_dclk(dclk: u32, xres: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn fb_get_hfreq(vfreq: u32, yres: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fb_timings_vfreq(timings: *mut __fb_timings) {
...
#[no_mangle]
unsafe extern "C" fn fb_timings_hfreq(timings: *mut __fb_timings) {
...
#[no_mangle]
unsafe extern "C" fn fb_timings_dclk(timings: *mut __fb_timings) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fb_get_mode(flags: c_int, val: u32, var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
    int fb_get_mode(int flags, u32 val, struct fb_var_screeninfo *var, struct fb_info *info)
    {
    struct __fb_timings *timings;
    let mut interlace: u32 = 1, dscan = 1;
...
#[no_mangle]
pub unsafe extern "C" fn dump_fb_videomode(m: *const fb_videomode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fb_validate_mode(var: *const fb_var_screeninfo, info: *mut fb_info) -> c_int {
