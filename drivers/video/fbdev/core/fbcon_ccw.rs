...
//! Source: drivers/video/fbdev/core/fbcon_ccw.c
#![no_std]
...
//
    ...
    let mut mod: c_int = vc.vc_font.height % 8;
...
// buf is always NULL except when in monochrome mode, so in this case
    ...
    let mut bs: c_uint = vc.vc_rows*ch;
    struct fb_fillrect region;
    region.color = color;
    region.rop = ROP_COPY;
...
#[no_mangle]
unsafe extern "C" fn ccw_update_start(info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fbcon_set_bitops_ccw(par: *mut fbcon_par) {
