...
//! Source: drivers/video/fbdev/core/fbcmap.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn fb_alloc_cmap_gfp(cmap: *mut fb_cmap, len: c_int, transp: c_int, flags: gfp_t) -> c_int {
    int fb_alloc_cmap_gfp(struct fb_cmap *cmap, int len, int transp, gfp_t flags)
    {
    let mut size: c_int = len * sizeof(u16);
...
#[no_mangle]
pub unsafe extern "C" fn fb_alloc_cmap(cmap: *mut fb_cmap, len: c_int, transp: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fb_dealloc_cmap(cmap: *mut fb_cmap) {
    ...
    kfree(cmap.blue);
    kfree(cmap.transp);
    cmap.red = cmap.green = cmap.blue = cmap.transp = core::ptr::null_mut();
    cmap.len = 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn fb_copy_cmap(from: *const fb_cmap, to: *mut fb_cmap) -> c_int {
    int fb_copy_cmap(const struct fb_cmap *from, struct fb_cmap *to)
    {
    let mut tooff: c_uint = 0, fromoff = 0;
    size_t size;
...
#[no_mangle]
pub unsafe extern "C" fn fb_cmap_to_user(from: *const fb_cmap, to: *mut fb_cmap_user) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fb_set_cmap(cmap: *mut fb_cmap, info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fb_set_user_cmap(cmap: *mut fb_cmap_user, info: *mut fb_info) -> c_int {
    ...
    rc = fb_alloc_cmap_gfp(&umap, cmap.len, cmap.transp != core::ptr::null_mut(),
    GFP_KERNEL);
    if (rc)
    return rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn fb_invert_cmaps() {
