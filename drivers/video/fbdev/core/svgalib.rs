...
//! Source: drivers/video/fbdev/core/svgalib.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn svga_wcrt_multi(regbase: *mut void __iomem, regset: *const vga_regset, value: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn svga_wseq_multi(regbase: *mut void __iomem, regset: *const vga_regset, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn svga_regset_size(regset: *const vga_regset) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn svga_set_default_gfx_regs(regbase: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn svga_set_default_atc_regs(regbase: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn svga_set_default_seq_regs(regbase: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn svga_set_default_crt_regs(regbase: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn svga_set_textmode_vga_regs(regbase: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn svga_dump_var(var: *mut fb_var_screeninfo, node: c_int) {
...
// -------------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn svga_settile(info: *mut fb_info, map: *mut fb_tilemap) {
...
#[no_mangle]
pub unsafe extern "C" fn svga_tilecopy(info: *mut fb_info, area: *mut fb_tilearea) {
    void svga_tilecopy(struct fb_info *info, struct fb_tilearea *area)
    {
    int dx, dy;
// colstride is halved in this function because u16 are used
    let mut colstride: c_int = 1 << (info.fix.type_aux & FB_AUX_TEXT_SVGA_MASK);
    let mut rowstride: c_int = colstride * (info.var.xres_virtual / 8);
...
#[no_mangle]
pub unsafe extern "C" fn svga_tilefill(info: *mut fb_info, rect: *mut fb_tilerect) {
    void svga_tilefill(struct fb_info *info, struct fb_tilerect *rect)
    {
    int dx, dy;
    let mut colstride: c_int = 2 << (info.fix.type_aux & FB_AUX_TEXT_SVGA_MASK);
    let mut rowstride: c_int = colstride * (info.var.xres_virtual / 8);
    let mut attr: c_int = (0x0F & rect.bg) << 4 | (0x0F & rect.fg);
    u8 __iomem *fb = (u8 __iomem *)info.screen_base;
...
#[no_mangle]
pub unsafe extern "C" fn svga_tileblit(info: *mut fb_info, blit: *mut fb_tileblit) {
    void svga_tileblit(struct fb_info *info, struct fb_tileblit *blit)
    {
    int dx, dy, i;
    let mut colstride: c_int = 2 << (info.fix.type_aux & FB_AUX_TEXT_SVGA_MASK);
    let mut rowstride: c_int = colstride * (info.var.xres_virtual / 8);
    let mut attr: c_int = (0x0F & blit.bg) << 4 | (0x0F & blit.fg);
    u8 __iomem *fb = (u8 __iomem *)info.screen_base;
...
#[no_mangle]
pub unsafe extern "C" fn svga_tilecursor(regbase: *mut void __iomem, info: *mut fb_info, cursor: *mut fb_tilecursor) {
...
#[no_mangle]
pub unsafe extern "C" fn svga_get_tilemax(info: *mut fb_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn svga_compute_pll(pll: *const svga_pll, f_wanted: u32, m: *mut u16, n: *mut u16, r: *mut u16, node: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn svga_check_timings(tm: *const svga_timing_regs, var: *mut fb_var_screeninfo, node: c_int) -> c_int {
...
// -------------------------------------------------------------------------
    ...
    {
    let mut i: c_int = match_format(frm, var);
    if (i >= 0) {
