...
//! Source: drivers/video/fbdev/sunxvr500.c
#![no_std]
...
pub struct e3d_info {
    ...
    pub fb8_buf_diff: c_ulong,
    pub regs_base_phys: c_ulong,
    pub ramdac: *mut void __iomem,
...
#[no_mangle]
unsafe extern "C" fn e3d_get_props(ep: *mut e3d_info) -> c_int {
...
pub const RAMDAC_VID_WH: c_uint = 0x00000070UL /* (height-1)<<16 | (width-1) */;
pub const RAMDAC_VID_CFG: c_uint = 0x00000074UL /* 0x1a000088|(linesz_log2<<16) */;
pub const RAMDAC_VID_32FB_0: c_uint = 0x00000078UL /* PCI base 32bpp FB buffer 0 */;
pub const RAMDAC_VID_32FB_1: c_uint = 0x0000007cUL /* PCI base 32bpp FB buffer 1 */;
pub const RAMDAC_VID_8FB_0: c_uint = 0x00000080UL /* PCI base 8bpp FB buffer 0 */;
pub const RAMDAC_VID_8FB_1: c_uint = 0x00000084UL /* PCI base 8bpp FB buffer 1 */;
pub const RAMDAC_VID_XXXFB: c_uint = 0x00000088UL /* PCI base of XXX FB */;
pub const RAMDAC_VID_YYYFB: c_uint = 0x0000008cUL /* PCI base of YYY FB */;
pub const RAMDAC_VID_ZZZFB: c_uint = 0x00000090UL /* PCI base of ZZZ FB */;
// CLUT registers
pub const RAMDAC_INDEX: c_uint = 0x000000bcUL;
pub const RAMDAC_DATA: c_uint = 0x000000c0UL;
#[no_mangle]
unsafe extern "C" fn e3d_clut_write(ep: *mut e3d_info, index: c_int, val: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn e3d_imageblit(info: *mut fb_info, image: *const fb_image) {
...
#[no_mangle]
unsafe extern "C" fn e3d_fillrect(info: *mut fb_info, rect: *const fb_fillrect) {
...
#[no_mangle]
unsafe extern "C" fn e3d_copyarea(info: *mut fb_info, area: *const fb_copyarea) {
...
#[no_mangle]
unsafe extern "C" fn e3d_set_fbinfo(ep: *mut e3d_info) -> c_int {
...
// Fill fix common fields
    ...
    device_type = of_get_property(of_node, "device_type", core::ptr::null_mut());
    if (!device_type) {
...
#[no_mangle]
unsafe extern "C" fn e3d_init() -> int __init {
    static int __init e3d_init(void)
    {
    if (fb_modesetting_disabled("e3d"))
    return -ENODEV;
    if (fb_get_options("e3d", core::ptr::null_mut()))
    return -ENODEV;
