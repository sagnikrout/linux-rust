...
//! Source: drivers/video/fbdev/geode/display_gx.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn gx_frame_buffer_size() -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn gx_line_delta(xres: c_int, bpp: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gx_set_mode(info: *mut fb_info) {
