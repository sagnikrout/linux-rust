...
//! Source: drivers/video/fbdev/geode/video_gx.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gx_pll_entry {
    pub /: *mut *mut long pixclock; / ps,
    pub sys_rstpll_bits: u32,
    pub dotpll_value: u32,
}
...
#[no_mangle]
pub unsafe extern "C" fn gx_set_dclk_frequency(info: *mut fb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn gx_configure_display(info: *mut fb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn gx_blank_display(info: *mut fb_info, blank_mode: c_int) -> c_int {
