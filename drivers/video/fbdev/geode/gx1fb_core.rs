...
//! Source: drivers/video/fbdev/geode/gx1fb_core.c
#![no_std]
...
//
    ...
    let mut crt_option: static int = 1;
...
#[no_mangle]
unsafe extern "C" fn gx1_line_delta(xres: c_int, bpp: c_int) -> c_int {
    static int gx1_line_delta(int xres, int bpp)
    {
    let mut line_delta: c_int = xres * (bpp >> 3);
    if (line_delta > 2048)
    line_delta = 4096;
#[no_mangle]
pub unsafe extern "C" fn if(1024: line_delta >) -> else {
...
#[no_mangle]
unsafe extern "C" fn gx1fb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gx1fb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gx1fb_blank(blank_mode: c_int, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gx1fb_map_video_memory(info: *mut fb_info, dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_panel_option(info: *mut fb_info) -> c_int {
    ...
    if (!x)
    return -EINVAL;
    y = simple_strtol(s + 1, core::ptr::null_mut(), 10);
    if (!y)
    return -EINVAL;
    par.panel_x = x;
    par.panel_y = y;
...
#[no_mangle]
unsafe extern "C" fn gx1fb_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
// GX1 display controller and CS5530 video device
    ...
    gx1_modedb, ARRAY_SIZE(gx1_modedb), core::ptr::null_mut(), 16);
    if (ret == 0 || ret == 4) {
...
#[no_mangle]
unsafe extern "C" fn gx1fb_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn gx1fb_setup(options: *mut c_char) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "crt:", _arg: 4)) -> else {
    else if (!strncmp(this_opt, "crt:", 4))
    crt_option = !!simple_strtoul(this_opt + 4, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(this_opt, _arg: "panel:", _arg: 6)) -> else {
...
#[no_mangle]
unsafe extern "C" fn gx1fb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gx1fb_cleanup() {
