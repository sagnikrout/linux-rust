...
//! Source: drivers/video/fbdev/geode/lxfb_ops.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lx_set_dotpll(pllval: u32) {
...
#[no_mangle]
unsafe extern "C" fn lx_set_clock(info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn lx_graphics_disable(info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn lx_graphics_enable(info: *mut fb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn lx_framebuffer_size() -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn lx_set_mode(info: *mut fb_info) {
...
#[no_mangle]
pub unsafe extern "C" fn if(2048: info->fix.line_length >) -> else {
    else if (info.fix.line_length > 2048)
    dv = DC_DV_CTL_DV_LINE_SIZE_4K;
#[no_mangle]
pub unsafe extern "C" fn if(1024: info->fix.line_length >) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn lx_blank_display(info: *mut fb_info, blank_mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lx_save_regs(par: *mut lxfb_par) {
...
#[no_mangle]
unsafe extern "C" fn lx_restore_gfx_proc(par: *mut lxfb_par) {
...
#[no_mangle]
unsafe extern "C" fn lx_restore_display_ctlr(par: *mut lxfb_par) {
...
#[no_mangle]
unsafe extern "C" fn lx_restore_video_proc(par: *mut lxfb_par) {
...
#[no_mangle]
unsafe extern "C" fn lx_restore_regs(par: *mut lxfb_par) {
...
#[no_mangle]
pub unsafe extern "C" fn lx_powerdown(info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lx_powerup(info: *mut fb_info) -> c_int {
