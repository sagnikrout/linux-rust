...
//! Source: drivers/video/fbdev/geode/suspend_gx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gx_save_regs(par: *mut gxfb_par) {
...
#[no_mangle]
unsafe extern "C" fn gx_set_dotpll(dotpll_hi: u32) {
...
#[no_mangle]
unsafe extern "C" fn gx_restore_gfx_proc(par: *mut gxfb_par) {
...
#[no_mangle]
unsafe extern "C" fn gx_restore_display_ctlr(par: *mut gxfb_par) {
...
#[no_mangle]
unsafe extern "C" fn gx_restore_video_proc(par: *mut gxfb_par) {
...
#[no_mangle]
unsafe extern "C" fn gx_restore_regs(par: *mut gxfb_par) {
...
#[no_mangle]
unsafe extern "C" fn gx_disable_graphics(par: *mut gxfb_par) {
...
#[no_mangle]
unsafe extern "C" fn gx_enable_graphics(par: *mut gxfb_par) {
...
#[no_mangle]
pub unsafe extern "C" fn gx_powerdown(info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gx_powerup(info: *mut fb_info) -> c_int {
