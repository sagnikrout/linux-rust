...
//! Source: drivers/video/fbdev/hecubafb.c
#![no_std]
...
pub const DPY_W: c_int = 600;
pub const DPY_H: c_int = 800;
...
#[no_mangle]
unsafe extern "C" fn apollo_send_data(par: *mut hecubafb_par, data: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn apollo_send_command(par: *mut hecubafb_par, data: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn hecubafb_dpy_update(par: *mut hecubafb_par) {
...
#[no_mangle]
unsafe extern "C" fn hecubafb_dpy_deferred_io(info: *mut fb_info, pagereflist: *mut list_head) {
    static void hecubafb_dpy_deferred_io(struct fb_info *info, struct list_head *pagereflist)
    {
    hecubafb_dpy_update(info.par);
    }
#[no_mangle]
unsafe extern "C" fn hecubafb_defio_damage_range(info: *mut fb_info, off: off_t, len: usize) {
...
#[no_mangle]
unsafe extern "C" fn hecubafb_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hecubafb_remove(dev: *mut platform_device) {
