...
//! Source: drivers/video/fbdev/hitfb.c
#![no_std]
...
pub const WIDTH: c_int = 640;
    ...
    {
    return ( volatile void __iomem *)(uintptr_t)offset;
    }
#[no_mangle]
unsafe extern "C" fn hitfb_readw(offset: c_uint) -> u16 {
    static u16 hitfb_readw(unsigned int offset)
    {
    return fb_readw(hitfb_offset_to_addr(offset));
    }
#[no_mangle]
unsafe extern "C" fn hitfb_writew(value: u16, offset: c_uint) {
    static void hitfb_writew(u16 value, unsigned int offset)
    {
    fb_writew(value, hitfb_offset_to_addr(offset));
    }
#[no_mangle]
pub unsafe extern "C" fn hitfb_accel_wait() {
...
#[no_mangle]
pub unsafe extern "C" fn hitfb_accel_start(truecolor: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hitfb_fillrect(p: *mut fb_info, rect: *const fb_fillrect) {
...
#[no_mangle]
unsafe extern "C" fn hitfb_copyarea(p: *mut fb_info, area: *const fb_copyarea) {
    ...
    struct fb_info *info)
    {
    let mut xoffset: c_int = var.xoffset;
    let mut yoffset: c_int = var.yoffset;
    if (xoffset != 0)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn hitfb_blank(blank_mode: c_int, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hitfb_sync(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hitfb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hitfb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hitfb_probe(dev: *mut platform_device) -> c_int {
    static int hitfb_probe(struct platform_device *dev)
    {
    unsigned short lcdclor, ldr3, ldvndr;
    struct fb_info *info;
    int ret;
    if (fb_get_options("hitfb", core::ptr::null_mut()))
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn hitfb_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn hitfb_suspend(dev: *mut device) -> c_int {
    static int hitfb_suspend(struct device *dev)
    {
    u16 v;
    hitfb_blank(1, core::ptr::null_mut());
    v = hitfb_readw(HD64461_STBCR);
...
#[no_mangle]
unsafe extern "C" fn hitfb_resume(dev: *mut device) -> c_int {
    ...
    v &= ~HD64461_STBCR_SLCKE_IST;
    hitfb_writew(v, HD64461_STBCR);
    hitfb_blank(0, core::ptr::null_mut());
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn hitfb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hitfb_exit() -> void __exit {
