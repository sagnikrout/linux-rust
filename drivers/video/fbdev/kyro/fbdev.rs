...
//! Source: drivers/video/fbdev/kyro/fbdev.c
#![no_std]
...
// PCI Definitions
//
pub const PCI_VENDOR_ID_ST: c_uint = 0x104a;
pub const PCI_DEVICE_ID_STG4000: c_uint = 0x0010;
...
// global graphics card info structure (one per card)
    ...
    let mut nopan: static int = 0;
    let mut nowrap: static int = 1;
    let mut nomtrr: static int = 0;
// PCI driver prototypes
    ...
    {
// 640x350 @ 85Hz
    core::ptr::null_mut(), 85, 640, 350, KHZ2PICOS(31500),
    96, 32, 60, 32, 64, 3,
    FB_SYNC_HOR_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 640x400 @ 85Hz
    core::ptr::null_mut(), 85, 640, 400, KHZ2PICOS(31500),
    96, 32, 41, 1, 64, 3,
    FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 720x400 @ 85Hz
    core::ptr::null_mut(), 85, 720, 400, KHZ2PICOS(35500),
    108, 36, 42, 1, 72, 3,
    FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 640x480 @ 60Hz
    core::ptr::null_mut(), 60, 640, 480, KHZ2PICOS(25175),
    48, 16, 33, 10, 96, 2,
    0, FB_VMODE_NONINTERLACED
    }, {
// 640x480 @ 72Hz
    core::ptr::null_mut(), 72, 640, 480, KHZ2PICOS(31500),
    128, 24, 28, 9, 40, 3,
    0, FB_VMODE_NONINTERLACED
    }, {
// 640x480 @ 75Hz
    core::ptr::null_mut(), 75, 640, 480, KHZ2PICOS(31500),
    120, 16, 16, 1, 64, 3,
    0, FB_VMODE_NONINTERLACED
    }, {
// 640x480 @ 85Hz
    core::ptr::null_mut(), 85, 640, 480, KHZ2PICOS(36000),
    80, 56, 25, 1, 56, 3,
    0, FB_VMODE_NONINTERLACED
    }, {
// 800x600 @ 56Hz
    core::ptr::null_mut(), 56, 800, 600, KHZ2PICOS(36000),
    128, 24, 22, 1, 72, 2,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 800x600 @ 60Hz
    core::ptr::null_mut(), 60, 800, 600, KHZ2PICOS(40000),
    88, 40, 23, 1, 128, 4,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 800x600 @ 72Hz
    core::ptr::null_mut(), 72, 800, 600, KHZ2PICOS(50000),
    64, 56, 23, 37, 120, 6,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 800x600 @ 75Hz
    core::ptr::null_mut(), 75, 800, 600, KHZ2PICOS(49500),
    160, 16, 21, 1, 80, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 800x600 @ 85Hz
    core::ptr::null_mut(), 85, 800, 600, KHZ2PICOS(56250),
    152, 32, 27, 1, 64, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1024x768 @ 60Hz
    core::ptr::null_mut(), 60, 1024, 768, KHZ2PICOS(65000),
    160, 24, 29, 3, 136, 6,
    0, FB_VMODE_NONINTERLACED
    }, {
// 1024x768 @ 70Hz
    core::ptr::null_mut(), 70, 1024, 768, KHZ2PICOS(75000),
    144, 24, 29, 3, 136, 6,
    0, FB_VMODE_NONINTERLACED
    }, {
// 1024x768 @ 75Hz
    core::ptr::null_mut(), 75, 1024, 768, KHZ2PICOS(78750),
    176, 16, 28, 1, 96, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1024x768 @ 85Hz
    core::ptr::null_mut(), 85, 1024, 768, KHZ2PICOS(94500),
    208, 48, 36, 1, 96, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1152x864 @ 75Hz
    core::ptr::null_mut(), 75, 1152, 864, KHZ2PICOS(108000),
    256, 64, 32, 1, 128, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1280x960 @ 60Hz
    core::ptr::null_mut(), 60, 1280, 960, KHZ2PICOS(108000),
    312, 96, 36, 1, 112, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1280x960 @ 85Hz
    core::ptr::null_mut(), 85, 1280, 960, KHZ2PICOS(148500),
    224, 64, 47, 1, 160, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1280x1024 @ 60Hz
    core::ptr::null_mut(), 60, 1280, 1024, KHZ2PICOS(108000),
    248, 48, 38, 1, 112, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1280x1024 @ 75Hz
    core::ptr::null_mut(), 75, 1280, 1024, KHZ2PICOS(135000),
    248, 16, 38, 1, 144, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1280x1024 @ 85Hz
    core::ptr::null_mut(), 85, 1280, 1024, KHZ2PICOS(157500),
    224, 64, 44, 1, 160, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1600x1200 @ 60Hz
    core::ptr::null_mut(), 60, 1600, 1200, KHZ2PICOS(162000),
    304, 64, 46, 1, 192, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1600x1200 @ 65Hz
    core::ptr::null_mut(), 65, 1600, 1200, KHZ2PICOS(175500),
    304, 64, 46, 1, 192, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1600x1200 @ 70Hz
    core::ptr::null_mut(), 70, 1600, 1200, KHZ2PICOS(189000),
    304, 64, 46, 1, 192, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1600x1200 @ 75Hz
    core::ptr::null_mut(), 75, 1600, 1200, KHZ2PICOS(202500),
    304, 64, 46, 1, 192, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1600x1200 @ 85Hz
    core::ptr::null_mut(), 85, 1600, 1200, KHZ2PICOS(229500),
    304, 64, 46, 1, 192, 3,
    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1792x1344 @ 60Hz
    core::ptr::null_mut(), 60, 1792, 1344, KHZ2PICOS(204750),
    328, 128, 46, 1, 200, 3,
    FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1792x1344 @ 75Hz
    core::ptr::null_mut(), 75, 1792, 1344, KHZ2PICOS(261000),
    352, 96, 69, 1, 216, 3,
    FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1856x1392 @ 60Hz
    core::ptr::null_mut(), 60, 1856, 1392, KHZ2PICOS(218250),
    352, 96, 43, 1, 224, 3,
    FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1856x1392 @ 75Hz
    core::ptr::null_mut(), 75, 1856, 1392, KHZ2PICOS(288000),
    352, 128, 104, 1, 224, 3,
    FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1920x1440 @ 60Hz
    core::ptr::null_mut(), 60, 1920, 1440, KHZ2PICOS(234000),
    344, 128, 56, 1, 208, 3,
    FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    }, {
// 1920x1440 @ 75Hz
    core::ptr::null_mut(), 75, 1920, 1440, KHZ2PICOS(297000),
    352, 144, 56, 1, 224, 3,
    FB_SYNC_VERT_HIGH_ACT, FB_VMODE_NONINTERLACED
    },
    };
...
// Accessors
#[no_mangle]
unsafe extern "C" fn kyro_dev_video_mode_set(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kyro_dev_overlay_viewport_set(x: u32, y: u32, ulWidth: u32, ulHeight: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_line_length(x: c_int, bpp: c_int) -> c_ulong {
    static inline unsigned long get_line_length(int x, int bpp)
    {
    return (unsigned long)((((x*bpp)+31)&~31) >> 3);
    }
#[no_mangle]
unsafe extern "C" fn kyrofb_check_var(var: *mut fb_var_screeninfo, info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kyrofb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kyrofb_setup(options: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn kyrofb_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
    static int kyrofb_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
    {
    struct fb_info *info;
...
#[no_mangle]
unsafe extern "C" fn kyrofb_remove(pdev: *mut pci_dev) {
    static void kyrofb_remove(struct pci_dev *pdev)
    {
...
#[no_mangle]
unsafe extern "C" fn kyrofb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn kyrofb_exit() -> void __exit {
