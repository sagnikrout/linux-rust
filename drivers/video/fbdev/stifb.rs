...
//! Source: drivers/video/fbdev/stifb.c
#![no_std]
...
pub const NGLEDEVDEPROM_CRT_REGION: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stifb_info {
    pub info: *mut fb_info,
    pub id: c_uint,
    pub ngle_rom: ngle_rom_t,
    pub sti: *mut sti_struct,
    pub deviceSpecificConfig: c_int,
...
pub const REG_1: c_uint = 0x000118;
pub const REG_2: c_uint = 0x000480;
pub const REG_3: c_uint = 0x0004a0;
pub const REG_4: c_uint = 0x000600;
pub const REG_6: c_uint = 0x000800;
pub const REG_7: c_uint = 0x000804;
pub const REG_8: c_uint = 0x000820;
pub const REG_9: c_uint = 0x000a04;
pub const REG_10: c_uint = 0x018000;
pub const REG_11: c_uint = 0x018004;
pub const REG_12: c_uint = 0x01800c;
pub const REG_13: c_uint = 0x018018;
pub const REG_14: c_uint = 0x01801c;
pub const REG_15: c_uint = 0x200000;
pub const REG_15b0: c_uint = 0x200000;
pub const REG_16b1: c_uint = 0x200005;
pub const REG_16b3: c_uint = 0x200007;
pub const REG_21: c_uint = 0x200218;
pub const REG_22: c_uint = 0x0005a0;
pub const REG_23: c_uint = 0x0005c0;
pub const REG_24: c_uint = 0x000808;
pub const REG_25: c_uint = 0x000b00;
pub const REG_26: c_uint = 0x200118;
pub const REG_27: c_uint = 0x200308;
pub const REG_32: c_uint = 0x21003c;
pub const REG_33: c_uint = 0x210040;
pub const REG_34: c_uint = 0x200008;
pub const REG_35: c_uint = 0x018010;
pub const REG_38: c_uint = 0x210020;
pub const REG_39: c_uint = 0x210120;
pub const REG_40: c_uint = 0x210130;
pub const REG_42: c_uint = 0x210028;
pub const REG_43: c_uint = 0x21002c;
pub const REG_44: c_uint = 0x210030;
pub const REG_45: c_uint = 0x210034;

    let mut debug_on: static int = 1;
...
pub const DISABLE: c_int = 0;
    ...
    {
    let mut value: c_uint = enable ? 0x43000000 : 0x03000000;
    SETUP_HW(fb);
    ...
    {
    let mut value: c_uint = enable ? 0x10000000 : 0x30000000;
    SETUP_HW(fb);
    ...
    {
    let mut DregsMiscVideo: u32 = REG_21;
    let mut DregsMiscCtl: u32 = REG_27;
    SETUP_HW(fb);
    if (enable) {
...
pub const HYPER_CONFIG_PLANES_24: c_uint = 0x00000100;
...
pub const BINovly: c_uint = 0x2	/* 8 bit overlay */;
pub const BINapp0I: c_uint = 0x0	/* Application Buffer 0, Indexed */;
pub const BINapp1I: c_uint = 0x1	/* Application Buffer 1, Indexed */;
pub const BINapp0F8: c_uint = 0xa	/* Application Buffer 0, Fractional 8-8-8 */;
pub const BINattr: c_uint = 0xd	/* Attribute Bitmap */;
pub const RopSrc: c_uint = 0x3;
    ...
    {
    let mut DregsHypMiscVideo: u32 = REG_33;
    unsigned int value;
    SETUP_HW(fb);
...
pub const BUFF0_CMAP0: c_uint = 0x00001e02;
pub const BUFF1_CMAP0: c_uint = 0x02001e02;
pub const BUFF1_CMAP3: c_uint = 0x0c001e02;
pub const ARTIST_CMAP0: c_uint = 0x00000102;
pub const HYPER_CMAP8: c_uint = 0x00000100;
pub const HYPER_CMAP24: c_uint = 0x00000800;
    static void
...
pub const HYPER_CMAP_TYPE: c_int = 0;
pub const NGLE_CMAP_INDEXED0_TYPE: c_int = 0;
pub const NGLE_CMAP_OVERLAY_TYPE: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn hyperUndoITE(fb: *mut stifb_info) {
    static void hyperUndoITE(struct stifb_info *fb)
    {
    let mut nFreeFifoSlots: c_int = 0;
    u32 fbAddr;
    NGLE_LOCK(fb);
...
// Return pointer to in-memory structure holding ELK device-dependent ROM values.
    ...
    let mut sizePackedDevRomData: c_int = sizeof(*pPackedDevRomData);
    char	*pCard8;
    int	i;
    char	*mapOrigin = core::ptr::null_mut();
    int romTableIdx;
...
pub const HYPERBOWL_MODE_FOR_8_OVER_88_LUT0_NO_TRANSPARENCIES: c_int = 4;
pub const HYPERBOWL_MODE01_8_24_LUT0_TRANSPARENT_LUT1_OPAQUE: c_int = 8;
pub const HYPERBOWL_MODE01_8_24_LUT0_OPAQUE_LUT1_OPAQUE: c_int = 10;
pub const HYPERBOWL_MODE2_8_24: c_int = 15;
...
// cleanup colormap hardware
    ...
    {
    struct stifb_info *fb = info.par;
    let mut enable: c_int = (blank_mode == 0) ? ENABLE : DISABLE;
    switch (fb.id) {
    case S9000_ID_A1439A:
...
pub const ARTIST_VRAM_SIZE: c_uint = 0x000804;
pub const ARTIST_VRAM_SRC: c_uint = 0x000808;
pub const ARTIST_VRAM_SIZE_TRIGGER_WINFILL: c_uint = 0x000a04;
pub const ARTIST_VRAM_DEST_TRIGGER_BLOCKMOVE: c_uint = 0x000b00;
pub const ARTIST_SRC_BM_ACCESS: c_uint = 0x018008;
pub const ARTIST_FGCOLOR: c_uint = 0x018010;
pub const ARTIST_BGCOLOR: c_uint = 0x018014;
pub const ARTIST_BITMAP_OP: c_uint = 0x01801c;
    static void
...
//
#[no_mangle]
unsafe extern "C" fn stifb_init_fb(sti: *mut sti_struct, bpp_pref: c_int) -> int __init {
...
// limit fbsize to max visible screen size
    ...
    fb_find_mode(&info.var, info, modestr, core::ptr::null_mut(), 0, core::ptr::null_mut(), bpp);
// This has to be done !!!
...
#[no_mangle]
unsafe extern "C" fn stifb_init() -> int __init {
...
//
    ...
    fb_dealloc_cmap(&info.cmap);
    framebuffer_release(info);
    dev_set_drvdata(sti.dev, core::ptr::null_mut());
    }
    }
    }
    int __init
