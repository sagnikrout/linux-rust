...
//! Source: drivers/video/fbdev/pmag-ba-fb.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn dac_write(par: *mut pmagbafb_par, reg: c_uint, v: u8) {
    static inline void dac_write(struct pmagbafb_par *par, unsigned int reg, u8 v)
    {
    writeb(v, par.dac + reg / 4);
    }
#[no_mangle]
pub unsafe extern "C" fn dac_read(par: *mut pmagbafb_par, reg: c_uint) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn pmagbafb_erase_cursor(info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn pmagbafb_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmagbafb_remove(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmagbafb_init() -> int __init {
    static int __init pmagbafb_init(void)
    {

    if (fb_get_options("pmagbafb", core::ptr::null_mut()))
    return -ENXIO;

    return tc_register_driver(&pmagbafb_driver);
    }
#[no_mangle]
unsafe extern "C" fn pmagbafb_exit() -> void __exit {
