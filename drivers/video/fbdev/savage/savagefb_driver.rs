...
//! Source: drivers/video/fbdev/savage/savagefb_driver.c
#![no_std]
...
// ---------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn vgaHWSeqReset(par: *mut savagefb_par, start: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vgaHWProtect(par: *mut savagefb_par, on: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vgaHWRestore(par: *mut savagefb_par, reg: *mut savage_reg) {
...
// Wait for fifo space
    ...
    {
    let mut slots: c_int = MAXFIFO - space;
...
#[no_mangle]
unsafe extern "C" fn savagefb_set_clip(info: *mut fb_info) {
...
// mdiv = best_m - 2;
    ...
    unsigned int m;
    unsigned char n1, n2;
    let mut best_n1: c_uchar = 16+2, best_n2 = 2, best_m = 125+2;
    best_diff = freq;
    for (n2 = min_n2; n2 <= max_n2; n2++) {
    for (n1 = min_n1+2; n1 <= max_n1+2; n1++) {
    m = (freq * n1 * (1 << n2) + HALF_BASE_FREQ) /
...
#[no_mangle]
unsafe extern "C" fn SavagePrintRegs(par: *mut savagefb_par) {
    static void SavagePrintRegs(struct savagefb_par *par)
    {
    unsigned char i;
    let mut vgaCRIndex: c_int = 0x3d4;
    let mut vgaCRReg: c_int = 0x3d5;
...
// ---------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn savage_get_default_par(par: *mut savagefb_par, reg: *mut savage_reg) {
...
// we must round yres/xres down, we already rounded y/xres_virtual up
    ...
    let mut pixclock: c_uint = var.pixclock;
...
pub unsafe extern "C" fn if(16: var->bits_per_pixel <=) -> else {
    ...
    reg.CR50 |= 0x40;
#[no_mangle]
pub unsafe extern "C" fn if(800: var->xres_virtual ==) -> else {
    else if (var.xres_virtual == 800)
    reg.CR50 |= 0x80;
#[no_mangle]
pub unsafe extern "C" fn if(1024: var->xres_virtual ==) -> else {
    else if (var.xres_virtual == 1024)
    reg.CR50 |= 0x00;
#[no_mangle]
pub unsafe extern "C" fn if(1152: var->xres_virtual ==) -> else {
    else if (var.xres_virtual == 1152)
    reg.CR50 |= 0x01;
#[no_mangle]
pub unsafe extern "C" fn if(1280: var->xres_virtual ==) -> else {
    else if (var.xres_virtual == 1280)
    reg.CR50 |= 0xc0;
#[no_mangle]
pub unsafe extern "C" fn if(1600: var->xres_virtual ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn savagefb_set_par_int(par: *mut savagefb_par, reg: *mut savage_reg) {
...
#[no_mangle]
unsafe extern "C" fn savagefb_update_start(par: *mut savagefb_par, base: c_int) {
...
#[no_mangle]
unsafe extern "C" fn savagefb_set_fix(info: *mut fb_info) {
...
#[no_mangle]
unsafe extern "C" fn savagefb_set_par(info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(24): (var->bits_per_pixel > 8) && (var->bits_per_pixel <) -> else {
...
#[no_mangle]
unsafe extern "C" fn savagefb_blank(blank: c_int, info: *mut fb_info) -> c_int {
    static int savagefb_blank(int blank, struct fb_info *info)
    {
    struct savagefb_par *par = info.par;
    let mut sr8: u8 = 0, srd = 0;
...
#[no_mangle]
unsafe extern "C" fn savagefb_open(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn savagefb_release(info: *mut fb_info, user: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn savage_enable_mmio(par: *mut savagefb_par) {
...
#[no_mangle]
unsafe extern "C" fn savage_disable_mmio(par: *mut savagefb_par) {
...
#[no_mangle]
unsafe extern "C" fn savage_map_mmio(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn savage_unmap_mmio(info: *mut fb_info) {
    ...
    if (par.mmio.vbase) {
    par.mmio.vbase = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn savage_map_video(info: *mut fb_info, video_len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn savage_unmap_video(info: *mut fb_info) {
    ...
    par.video.vbase = core::ptr::null_mut();
    info.screen_base = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn savage_init_hw(par: *mut savagefb_par) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(par->dvi): dvi || (par->chip == S3_SAVAGE4 &&) -> else {
...
// ---------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn savagefb_probe(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
// we can enable reduced blanking as well
    ...
    else if (fb_find_mode(&info.var, info, core::ptr::null_mut(), core::ptr::null_mut(), 0,
    &cvt_mode, 0) != 3)
    info.var = savagefb_var800x600x8;
    }
    if (mode_option) {
    ...
    core::ptr::null_mut(), 8);
    } else if (info.monspecs.modedb != core::ptr::null_mut()) {
    const struct fb_videomode *mode;
...
#[no_mangle]
unsafe extern "C" fn savagefb_remove(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn savagefb_suspend_late(dev: *mut device, mesg: pm_message_t) -> c_int {
...
// **************************** exit-time only ****************************
#[no_mangle]
unsafe extern "C" fn savage_done() -> void __exit {
...
// ************************* init in-kernel code **************************
#[no_mangle]
unsafe extern "C" fn savagefb_setup(options: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn savagefb_init() -> int __init {
