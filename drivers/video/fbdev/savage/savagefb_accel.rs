...
//! Source: drivers/video/fbdev/savage/savagefb_accel.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn savagefb_sync(info: *mut fb_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn savagefb_copyarea(info: *mut fb_info, region: *const fb_copyarea) {
    void savagefb_copyarea(struct fb_info *info, const struct fb_copyarea *region)
    {
    struct savagefb_par *par = info.par;
    let mut sx: c_int = region.sx, dx = region.dx;
    let mut sy: c_int = region.sy, dy = region.dy;
    int cmd;
...
#[no_mangle]
pub unsafe extern "C" fn savagefb_fillrect(info: *mut fb_info, rect: *const fb_fillrect) {
...
#[no_mangle]
pub unsafe extern "C" fn savagefb_imageblit(info: *mut fb_info, image: *const fb_image) {
