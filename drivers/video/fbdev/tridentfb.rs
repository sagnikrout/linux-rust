...
//! Source: drivers/video/fbdev/tridentfb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tridentfb_par {
    pub /: *mut *mut *mut void __iomem io_virt; / iospace virtual memory address,
    pub pseudo_pal: [u32; 16],
    pub chip_id: c_int,
    pub flatpanel: c_int,
    pub int): *mut *mut *mut void (init_accel) (struct tridentfb_par , int,,
    pub ): *mut *mut void (wait_engine) (struct tridentfb_par,
    void (*fill_rect)
    pub u32): *mut *mut (struct tridentfb_par par, u32, u32, u32, u32, u32,,
    void (*copy_rect)
    pub u32): *mut *mut (struct tridentfb_par par, u32, u32, u32, u32, u32,,
    void (*image_blit)
    (struct tridentfb_par *par, const char*,
    pub u32): u32, u32, u32, u32, u32,,
    pub /: *mut *mut unsigned char eng_oper; / engine operation...,
    pub ddc_registered: bool,
    pub ddc_adapter: i2c_adapter,
    pub ddc_algo: i2c_algo_bit_data,
}
...
#[no_mangle]
pub unsafe extern "C" fn is_oldclock(id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_oldprotect(id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_blade(id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_xp(id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is3Dchip(id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iscyber(id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tridentfb_ddc_setscl_tgui(data: *mut c_void, val: c_int) {
    static void tridentfb_ddc_setscl_tgui(void *data, int val)
    {
    struct tridentfb_par *par = data;
    let mut reg: u8 = vga_mm_rcrt(par.io_virt, I2C) & DDC_MASK_TGUI;
    if (val)
...
#[no_mangle]
unsafe extern "C" fn tridentfb_ddc_setsda_tgui(data: *mut c_void, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tridentfb_ddc_getsda_tgui(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tridentfb_ddc_setscl(data: *mut c_void, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tridentfb_ddc_setsda(data: *mut c_void, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tridentfb_ddc_getscl(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tridentfb_ddc_getsda(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tridentfb_setup_ddc_bus(info: *mut fb_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn blade_init_accel(par: *mut tridentfb_par, pitch: c_int, bpp: c_int) {
    static void blade_init_accel(struct tridentfb_par *par, int pitch, int bpp)
    {
    let mut v1: c_int = (pitch >> 3) << 20;
    let mut tmp: c_int = bpp == 24 ? 2 : (bpp >> 4);
    let mut v2: c_int = v1 | (tmp << 29);
...
#[no_mangle]
unsafe extern "C" fn blade_wait_engine(par: *mut tridentfb_par) {
    ...
    {
    let mut size: unsigned = ((w + 31) >> 5) * h;
    writemmr(par, COLOR, c);
    ...
    {
    let mut direction: c_int = 2;
    let mut s1: u32 = point(x1, y1);
    let mut s2: u32 = point(x1 + w - 1, y1 + h - 1);
    let mut d1: u32 = point(x2, y2);
    let mut d2: u32 = point(x2 + w - 1, y2 + h - 1);
...
//
#[no_mangle]
unsafe extern "C" fn xp_init_accel(par: *mut tridentfb_par, pitch: c_int, bpp: c_int) {
    static void xp_init_accel(struct tridentfb_par *par, int pitch, int bpp)
    {
    let mut x: c_uchar = bpp == 24 ? 3 : (bpp >> 4);
    let mut v1: c_int = pitch << (bpp == 24 ? 20 : (18 + x));
    switch (pitch << (bpp >> 3)) {
    case 8192:
    case 512:
    x |= 0x00;
...
#[no_mangle]
unsafe extern "C" fn xp_wait_engine(par: *mut tridentfb_par) {
...
// Reset engine
    ...
    let mut direction: c_int = 0x0004;
    if ((x1 < x2) && (y1 == y2)) {
    direction |= 0x0200;
    x1_tmp = x1 + w - 1;
    x2_tmp = x2 + w - 1;
...
//
#[no_mangle]
unsafe extern "C" fn image_init_accel(par: *mut tridentfb_par, pitch: c_int, bpp: c_int) {
...
#[no_mangle]
unsafe extern "C" fn image_wait_engine(par: *mut tridentfb_par) {
...
//
#[no_mangle]
unsafe extern "C" fn tgui_init_accel(par: *mut tridentfb_par, pitch: c_int, bpp: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tridentfb_sync(info: *mut fb_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn read3X4(par: *mut tridentfb_par, reg: c_int) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn enable_mmio(par: *mut tridentfb_par) {
...
#[no_mangle]
unsafe extern "C" fn disable_mmio(par: *mut tridentfb_par) {
...
#[no_mangle]
pub unsafe extern "C" fn crtc_unlock(par: *mut tridentfb_par) {
...
#[no_mangle]
unsafe extern "C" fn get_nativex(par: *mut tridentfb_par) -> c_int {
...
// Set pitch
#[no_mangle]
pub unsafe extern "C" fn set_lwidth(par: *mut tridentfb_par, width: c_int) {
...
#[no_mangle]
unsafe extern "C" fn screen_stretch(par: *mut tridentfb_par) {
...
#[no_mangle]
pub unsafe extern "C" fn screen_center(par: *mut tridentfb_par) {
...
#[no_mangle]
unsafe extern "C" fn set_screen_start(par: *mut tridentfb_par, base: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_vclk(par: *mut tridentfb_par, freq: c_ulong) {
    static void set_vclk(struct tridentfb_par *par, unsigned long freq)
    {
    int m, n, k;
    unsigned long fi, d, di;
    let mut best_m: c_uchar = 0, best_n = 0, best_k = 0;
    unsigned char hi, lo;
    let mut shift: c_uchar = !is_oldclock(par.chip_id) ? 2 : 1;
    d = 20000;
    for (k = shift; k >= 0; k--)
    for (m = 1; m < 32; m++) {
    n = ((m + 2) << shift) - 8;
...
#[no_mangle]
unsafe extern "C" fn set_number_of_lines(par: *mut tridentfb_par, lines: c_int) {
    static void set_number_of_lines(struct tridentfb_par *par, int lines)
    {
    let mut tmp: c_int = read3CE(par, CyberEnhance) & 0x8F;
    if (lines > 1024)
    tmp |= 0x50;
#[no_mangle]
pub unsafe extern "C" fn if(768: lines >) -> else {
    else if (lines > 768)
    tmp |= 0x30;
#[no_mangle]
pub unsafe extern "C" fn if(600: lines >) -> else {
    else if (lines > 600)
    tmp |= 0x20;
#[no_mangle]
pub unsafe extern "C" fn if(480: lines >) -> else {
    else if (lines > 480)
    tmp |= 0x10;
...
//
#[no_mangle]
unsafe extern "C" fn is_flatpanel(par: *mut tridentfb_par) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_memsize(par: *mut tridentfb_par) -> c_uint {
...
// See if we can handle the video mode described in var
    ...
    {
    struct tridentfb_par *par = info.par;
    let mut bpp: c_int = var.bits_per_pixel;
    int line_length;
...
#[no_mangle]
pub unsafe extern "C" fn if(1024: line_length <=) -> else {
    else if (line_length <= 1024)
    var.xres_virtual = 1024 * 8 / bpp;
#[no_mangle]
pub unsafe extern "C" fn if(2048: line_length <=) -> else {
    else if (line_length <= 2048)
    var.xres_virtual = 2048 * 8 / bpp;
#[no_mangle]
pub unsafe extern "C" fn if(4096: line_length <=) -> else {
    else if (line_length <= 4096)
    var.xres_virtual = 4096 * 8 / bpp;
#[no_mangle]
pub unsafe extern "C" fn if(8192: line_length <=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn shadowmode_on(par: *mut tridentfb_par) {
...
#[no_mangle]
unsafe extern "C" fn tridentfb_set_par(info: *mut fb_info) -> c_int {
...
//
    ...
    screen_center(par);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: stretch) -> else {
    else if (stretch)
    screen_stretch(par);
    } else {
...
// Set one color register
    ...
    struct fb_info *info)
    {
    let mut bpp: c_int = info.var.bits_per_pixel;
    struct tridentfb_par *par = info.par;
...
#[no_mangle]
unsafe extern "C" fn tridentfb_blank(blank_mode: c_int, info: *mut fb_info) -> c_int {
...
// Prepare startup mode
    ...
    info.monspecs.modedb = core::ptr::null_mut();
    goto out_unmap2;
    }
    }
    fb_destroy_modedb(info.monspecs.modedb);
...
#[no_mangle]
unsafe extern "C" fn trident_pci_remove(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn tridentfb_setup(options: *mut c_char) -> int __init {
    static int __init tridentfb_setup(char *options)
    {
    char *opt;
    if (!options || !*options)
    return 0;
    while ((opt = strsep(&options, ",")) != core::ptr::null_mut()) {
    if (!*opt)
    continue;
    if (!strncmp(opt, "noaccel", 7))
    noaccel = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(opt, _arg: "fp", _arg: 2)) -> else {
    else if (!strncmp(opt, "fp", 2))
    fp = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(opt, _arg: "crt", _arg: 3)) -> else {
    else if (!strncmp(opt, "crt", 3))
    fp = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(opt, _arg: "bpp=", _arg: 4)) -> else {
    else if (!strncmp(opt, "bpp=", 4))
    bpp = simple_strtoul(opt + 4, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(opt, _arg: "center", _arg: 6)) -> else {
    else if (!strncmp(opt, "center", 6))
    center = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(opt, _arg: "stretch", _arg: 7)) -> else {
    else if (!strncmp(opt, "stretch", 7))
    stretch = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(opt, _arg: "memsize=", _arg: 8)) -> else {
    else if (!strncmp(opt, "memsize=", 8))
    memsize = simple_strtoul(opt + 8, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(opt, _arg: "memdiff=", _arg: 8)) -> else {
    else if (!strncmp(opt, "memdiff=", 8))
    memdiff = simple_strtoul(opt + 8, core::ptr::null_mut(), 0);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(opt, _arg: "nativex=", _arg: 8)) -> else {
    else if (!strncmp(opt, "nativex=", 8))
    nativex = simple_strtoul(opt + 8, core::ptr::null_mut(), 0);
    else
    mode_option = opt;
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn tridentfb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tridentfb_exit() -> void __exit {
