...
//! Source: drivers/video/screen_info_pci.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __screen_info_relocation_is_valid(si: *const screen_info, pr: *mut resource) -> bool {
    static bool __screen_info_relocation_is_valid(const struct screen_info *si, struct resource *pr)
    {
    let mut size: u64 = __screen_info_lfb_size(si, screen_info_video_type(si));
...
#[no_mangle]
pub unsafe extern "C" fn screen_info_apply_fixups() {
...
#[no_mangle]
unsafe extern "C" fn screen_info_fixup_lfb(pdev: *mut pci_dev) {
