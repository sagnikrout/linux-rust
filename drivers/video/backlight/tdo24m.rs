...
//! Source: drivers/video/backlight/tdo24m.c
#![no_std]
...
pub const MODE_QVGA: c_int = 0;
pub const MODE_VGA: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tdo24m {
    ...
    pub buf: *mut u8,
    pub mode): *mut *mut *mut int (adj_mode)(struct tdo24m lcd, int,
    pub color_invert: c_int,
    pub power: c_int,
    pub mode: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn tdo24m_writes(lcd: *mut tdo24m, array: *const u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdo24m_adj_mode(lcd: *mut tdo24m, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdo35s_adj_mode(lcd: *mut tdo24m, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdo24m_power_on(lcd: *mut tdo24m) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdo24m_power_off(lcd: *mut tdo24m) -> c_int {
    static int tdo24m_power_off(struct tdo24m *lcd)
    {
    return tdo24m_writes(lcd, lcd_panel_off);
    }
#[no_mangle]
unsafe extern "C" fn tdo24m_power(lcd: *mut tdo24m, power: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdo24m_set_power(ld: *mut lcd_device, power: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdo24m_get_power(ld: *mut lcd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdo24m_set_mode(ld: *mut lcd_device, xres: u32, yres: u32) -> c_int {
    static int tdo24m_set_mode(struct lcd_device *ld, u32 xres, u32 yres)
    {
    struct tdo24m *lcd = lcd_get_data(ld);
    let mut mode: c_int = MODE_QVGA;
...
#[no_mangle]
unsafe extern "C" fn tdo24m_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdo24m_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn tdo24m_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdo24m_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdo24m_shutdown(spi: *mut spi_device) {
