...
//! Source: drivers/video/backlight/mp3309c.c
#![no_std]
...
pub const REG_I2C_0: c_uint = 0x00;
pub const REG_I2C_1: c_uint = 0x01;
pub const REG_I2C_0_EN: c_uint = 0x80;
pub const REG_I2C_0_D0: c_uint = 0x40;
pub const REG_I2C_0_D1: c_uint = 0x20;
pub const REG_I2C_0_D2: c_uint = 0x10;
pub const REG_I2C_0_D3: c_uint = 0x08;
pub const REG_I2C_0_D4: c_uint = 0x04;
pub const REG_I2C_0_RSRV1: c_uint = 0x02;
pub const REG_I2C_0_RSRV2: c_uint = 0x01;
pub const REG_I2C_1_RSRV1: c_uint = 0x80;
pub const REG_I2C_1_DIMS: c_uint = 0x40;
pub const REG_I2C_1_SYNC: c_uint = 0x20;
pub const REG_I2C_1_OVP0: c_uint = 0x10;
pub const REG_I2C_1_OVP1: c_uint = 0x08;
pub const REG_I2C_1_VOS: c_uint = 0x04;
pub const REG_I2C_1_LEDO: c_uint = 0x02;
pub const REG_I2C_1_OTP: c_uint = 0x01;

pub const ANALOG_I2C_REG_MASK: c_uint = 0x7c;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mp3309c_chip {
    pub dev: *mut device,
    pub pdata: *mut mp3309c_platform_data,
...
#[no_mangle]
unsafe extern "C" fn mp3309c_enable_device(chip: *mut mp3309c_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp3309c_bl_update_status(bl: *mut backlight_device) -> c_int {
...
//
    ...
    chip.pwmd = devm_pwm_get(dev, core::ptr::null_mut());
    if (IS_ERR(chip.pwmd))
...
#[no_mangle]
unsafe extern "C" fn mp3309c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp3309c_remove(client: *mut i2c_client) {
