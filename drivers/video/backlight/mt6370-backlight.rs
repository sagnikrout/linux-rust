...
//! Source: drivers/video/backlight/mt6370-backlight.c
#![no_std]
...
pub const MT6370_REG_BL_EN: c_uint = 0x1A0;
pub const MT6370_REG_BL_BSTCTRL: c_uint = 0x1A1;
pub const MT6370_REG_BL_PWM: c_uint = 0x1A2;
pub const MT6370_REG_BL_DIM2: c_uint = 0x1A4;

pub const MT6370_BL_CH_SHIFT: c_int = 2;

pub const MT6370_BL_DIM2_COMMON_SHIFT: c_int = 3;

pub const MT6370_BL_DIM2_6372_SHIFT: c_int = 6;

pub const MT6370_BL_OVP_SEL_SHIFT: c_int = 5;

pub const MT6370_BL_OC_SEL_SHIFT: c_int = 1;
pub const MT6370_BL_PWM_HYS_TH_MIN_STEP: c_int = 1;
pub const MT6370_BL_PWM_HYS_TH_MAX_STEP: c_int = 64;
pub const MT6370_BL_OVP_MIN_UV: c_int = 17000000;
pub const MT6370_BL_OVP_MAX_UV: c_int = 29000000;
pub const MT6370_BL_OVP_STEP_UV: c_int = 4000000;
pub const MT6370_BL_OCP_MIN_UA: c_int = 900000;
pub const MT6370_BL_OCP_MAX_UA: c_int = 1800000;
pub const MT6370_BL_OCP_STEP_UA: c_int = 300000;
pub const MT6370_BL_MAX_COMMON_BRIGHTNESS: c_int = 2048;
pub const MT6370_BL_MAX_6372_BRIGHTNESS: c_int = 16384;
pub const MT6370_BL_MAX_CH: c_int = 15;
    enum {
    MT6370_VID_COMMON = 1,
    MT6370_VID_6372,
    };
...
#[no_mangle]
unsafe extern "C" fn mt6370_bl_update_status(bl_dev: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6370_bl_get_brightness(bl_dev: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6370_bl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6370_bl_remove(pdev: *mut platform_device) {
