...
//! Source: drivers/video/backlight/as3711_bl.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct as3711_bl_data {
    pub powered: bool,
    pub type: enum as3711_bl_type,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct as3711_bl_supply {
    pub su1: as3711_bl_data,
    pub su2: as3711_bl_data,
    pub pdata: *const as3711_bl_pdata,
    pub as3711: *mut as3711,
}
...
#[no_mangle]
unsafe extern "C" fn as3711_bl_su2_reset(supply: *mut as3711_bl_supply) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn as3711_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as3711_bl_get_brightness(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as3711_bl_init_su2(supply: *mut as3711_bl_supply) -> c_int {
...
// Turn SU2 off
    ...
    {
    let mut props: backlight_properties = {.type = BACKLIGHT_RAW,};
...
#[no_mangle]
unsafe extern "C" fn as3711_backlight_parse_dt(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as3711_backlight_probe(pdev: *mut platform_device) -> c_int {
