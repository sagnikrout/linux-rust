...
//! Source: drivers/video/backlight/adp5520_bl.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adp5520_bl {
    pub master: *mut device,
    pub pdata: *mut adp5520_backlight_platform_data,
    pub lock: mutex,
...
#[no_mangle]
unsafe extern "C" fn adp5520_bl_set(bl: *mut backlight_device, brightness: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5520_bl_update_status(bl: *mut backlight_device) -> c_int {
    static int adp5520_bl_update_status(struct backlight_device *bl)
    {
    return adp5520_bl_set(bl, backlight_get_brightness(bl));
    }
#[no_mangle]
unsafe extern "C" fn adp5520_bl_get_brightness(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5520_bl_setup(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5520_show(dev: *mut device, buf: *mut c_char, reg: c_int) -> isize {
...
#[no_mangle]
unsafe extern "C" fn adp5520_bl_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (data.pdata  == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn adp5520_bl_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn adp5520_bl_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5520_bl_resume(dev: *mut device) -> c_int {
