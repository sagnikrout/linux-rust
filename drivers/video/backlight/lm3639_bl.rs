...
//! Source: drivers/video/backlight/lm3639_bl.c
#![no_std]
...
pub const REG_DEV_ID: c_uint = 0x00;
pub const REG_CHECKSUM: c_uint = 0x01;
pub const REG_BL_CONF_1: c_uint = 0x02;
pub const REG_BL_CONF_2: c_uint = 0x03;
pub const REG_BL_CONF_3: c_uint = 0x04;
pub const REG_BL_CONF_4: c_uint = 0x05;
pub const REG_FL_CONF_1: c_uint = 0x06;
pub const REG_FL_CONF_2: c_uint = 0x07;
pub const REG_FL_CONF_3: c_uint = 0x08;
pub const REG_IO_CTRL: c_uint = 0x09;
pub const REG_ENABLE: c_uint = 0x0A;
pub const REG_FLAG: c_uint = 0x0B;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm3639_chip_data {
    pub dev: *mut device,
    pub pdata: *mut lm3639_platform_data,
    pub bled: *mut backlight_device,
    pub cdev_flash: led_classdev,
    pub cdev_torch: led_classdev,
    pub regmap: *mut regmap,
    pub bled_mode: c_uint,
    pub bled_map: c_uint,
...
// initialize chip
#[no_mangle]
unsafe extern "C" fn lm3639_chip_init(pchip: *mut lm3639_chip_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3639_bled_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3639_bled_get_brightness(bl: *mut backlight_device) -> c_int {
...
// backlight mapping mode
    ...
    static DEVICE_ATTR(bled_mode, S_IWUSR, core::ptr::null_mut(), lm3639_bled_mode_store);
// torch
...
#[no_mangle]
unsafe extern "C" fn lm3639_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3639_remove(client: *mut i2c_client) {
