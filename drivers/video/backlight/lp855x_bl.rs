...
//! Source: drivers/video/backlight/lp855x_bl.c
#![no_std]
...
pub const LP855X_BRIGHTNESS_CTRL: c_uint = 0x00;
pub const LP855X_DEVICE_CTRL: c_uint = 0x01;
pub const LP855X_EEPROM_START: c_uint = 0xA0;
pub const LP855X_EEPROM_END: c_uint = 0xA7;
pub const LP8556_EPROM_START: c_uint = 0x98;
pub const LP8556_EPROM_END: c_uint = 0xAF;
// LP8555/7 Registers
pub const LP8557_BL_CMD: c_uint = 0x00;
pub const LP8557_BL_MASK: c_uint = 0x01;
pub const LP8557_BL_ON: c_uint = 0x01;
pub const LP8557_BL_OFF: c_uint = 0x00;
pub const LP8557_BRIGHTNESS_CTRL: c_uint = 0x04;
pub const LP8557_CONFIG: c_uint = 0x10;
pub const LP8555_EPROM_START: c_uint = 0x10;
pub const LP8555_EPROM_END: c_uint = 0x7A;
pub const LP8557_EPROM_START: c_uint = 0x10;
pub const LP8557_EPROM_END: c_uint = 0x1E;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lp855x_device_config {
    pub ): *mut *mut int (pre_init_device)(struct lp855x,
    pub reg_brightness: u8,
    pub reg_devicectrl: u8,
    pub ): *mut *mut int (post_init_device)(struct lp855x,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lp855x {
    pub chipname: *const c_char,
    pub chip_id: enum lp855x_chip_id,
    pub mode: enum lp855x_brightness_ctrl_mode,
    pub cfg: *mut lp855x_device_config,
    pub client: *mut i2c_client,
    pub bl: *mut backlight_device,
    pub dev: *mut device,
    pub pdata: *mut lp855x_platform_data,
    pub pwm: *mut pwm_device,
    pub needs_pwm_init: bool,
    pub /: *mut *mut *mut regulator supply; / regulator for VDD input,
    pub /: *mut *mut *mut regulator enable; / regulator for EN/VDDIO input,
}

#[no_mangle]
unsafe extern "C" fn lp855x_write_byte(lp: *mut lp855x, reg: u8, data: u8) -> c_int {
    static int lp855x_write_byte(struct lp855x *lp, u8 reg, u8 data)
    {
    return i2c_smbus_write_byte_data(lp.client, reg, data);
    }
#[no_mangle]
unsafe extern "C" fn lp855x_update_bit(lp: *mut lp855x, reg: u8, mask: u8, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp855x_is_valid_rom_area(lp: *mut lp855x, addr: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lp8557_bl_off(lp: *mut lp855x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp8557_bl_on(lp: *mut lp855x) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lp855x_configure(lp: *mut lp855x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp855x_pwm_ctrl(lp: *mut lp855x, br: c_int, max_br: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp855x_bl_update_status(bl: *mut backlight_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(REGISTER_BASED: lp->mode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn lp855x_backlight_register(lp: *mut lp855x) -> c_int {
    ...
    {
    struct lp855x *lp = dev_get_drvdata(dev);
    char *strmode = core::ptr::null_mut();
    if (lp.mode == PWM_BASED)
    strmode = "pwm based";
#[no_mangle]
pub unsafe extern "C" fn if(REGISTER_BASED: lp->mode ==) -> else {
    ...
    static DEVICE_ATTR(chip_id, S_IRUGO, lp855x_get_chip_id, core::ptr::null_mut());
    static DEVICE_ATTR(bl_ctl_mode, S_IRUGO, lp855x_get_bl_ctl_mode, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn lp855x_parse_dt(lp: *mut lp855x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp855x_parse_acpi(lp: *mut lp855x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp855x_probe(cl: *mut i2c_client) -> c_int {
    ...
    return -EPROBE_DEFER;
    lp.supply = core::ptr::null_mut();
    }
    lp.enable = devm_regulator_get_optional(dev, "enable");
    if (IS_ERR(lp.enable)) {
    ret = PTR_ERR(lp.enable);
    if (ret == -ENODEV)
    lp.enable = core::ptr::null_mut();
    else
...
#[no_mangle]
unsafe extern "C" fn lp855x_remove(cl: *mut i2c_client) {
