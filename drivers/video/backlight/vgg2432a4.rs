...
//! Source: drivers/video/backlight/vgg2432a4.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vgg2432a4_suspend(dev: *mut device) -> c_int {
    static int vgg2432a4_suspend(struct device *dev)
    {
    return ili9320_suspend(dev_get_drvdata(dev));
    }
#[no_mangle]
unsafe extern "C" fn vgg2432a4_resume(dev: *mut device) -> c_int {
...
// Device probe
#[no_mangle]
unsafe extern "C" fn vgg2432a4_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgg2432a4_remove(spi: *mut spi_device) {
    static void vgg2432a4_remove(struct spi_device *spi)
    {
    ili9320_remove(spi_get_drvdata(spi));
    }
#[no_mangle]
unsafe extern "C" fn vgg2432a4_shutdown(spi: *mut spi_device) {
