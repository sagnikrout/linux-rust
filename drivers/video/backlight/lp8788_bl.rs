...
//! Source: drivers/video/backlight/lp8788_bl.c
#![no_std]
...
// Register address
pub const LP8788_BL_CONFIG: c_uint = 0x96;

pub const LP8788_BL_FULLSCALE_SHIFT: c_int = 2;
pub const LP8788_BL_DIM_MODE_SHIFT: c_int = 1;
pub const LP8788_BL_PWM_POLARITY_SHIFT: c_int = 6;
pub const LP8788_BL_BRIGHTNESS: c_uint = 0x97;
pub const LP8788_BL_RAMP: c_uint = 0x98;
pub const LP8788_BL_RAMP_RISE_SHIFT: c_int = 4;
pub const MAX_BRIGHTNESS: c_int = 127;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lp8788_bl {
    pub lp: *mut lp8788,
    pub bl_dev: *mut backlight_device,
}

#[no_mangle]
unsafe extern "C" fn lp8788_backlight_configure(bl: *mut lp8788_bl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp8788_bl_update_status(bl_dev: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp8788_backlight_register(bl: *mut lp8788_bl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp8788_backlight_unregister(bl: *mut lp8788_bl) {
    ...
    static DEVICE_ATTR(bl_ctl_mode, S_IRUGO, lp8788_get_bl_ctl_mode, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn lp8788_backlight_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp8788_backlight_remove(pdev: *mut platform_device) {
