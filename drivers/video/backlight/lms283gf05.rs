...
//! Source: drivers/video/backlight/lms283gf05.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lms283gf05_reset(gpiod: *mut gpio_desc) {
...
#[no_mangle]
unsafe extern "C" fn lms283gf05_power_set(ld: *mut lcd_device, power: c_int) -> c_int {
    ...
    .get_power	= core::ptr::null_mut(),
    };
#[no_mangle]
unsafe extern "C" fn lms283gf05_probe(spi: *mut spi_device) -> c_int {
