...
//! Source: drivers/video/backlight/lcd.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn lcd_notify_blank_all(display_dev: *mut device, power: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lcd_device_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn lcd_device_unregister(ld: *mut lcd_device) {
    ...
    list_del(&ld.entry);
    mutex_lock(&ld.ops_lock);
    ld.ops = core::ptr::null_mut();
    mutex_unlock(&ld.ops_lock);
    device_unregister(&ld.dev);
    }
    EXPORT_SYMBOL(lcd_device_unregister);
#[no_mangle]
unsafe extern "C" fn devm_lcd_device_release(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn devm_lcd_device_match(dev: *mut device, res: *mut c_void, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_lcd_device_unregister(dev: *mut device, ld: *mut lcd_device) {
...
#[no_mangle]
unsafe extern "C" fn lcd_class_exit() -> void __exit {
    static void __exit lcd_class_exit(void)
    {
    class_unregister(&lcd_class);
    }
#[no_mangle]
unsafe extern "C" fn lcd_class_init() -> int __init {
