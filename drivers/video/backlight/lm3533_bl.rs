...
//! Source: drivers/video/backlight/lm3533_bl.c
#![no_std]
...
pub const LM3533_HVCTRLBANK_COUNT: c_int = 2;
pub const LM3533_BL_MAX_BRIGHTNESS: c_int = 255;
pub const LM3533_REG_CTRLBANK_AB_BCONF: c_uint = 0x1a;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm3533_bl {
...
#[no_mangle]
pub unsafe extern "C" fn lm3533_bl_get_ctrlbank_id(bl: *mut lm3533_bl) -> c_int {
    static inline int lm3533_bl_get_ctrlbank_id(struct lm3533_bl *bl)
    {
    return bl.id;
    }
#[no_mangle]
unsafe extern "C" fn lm3533_bl_update_status(bd: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3533_bl_get_brightness(bd: *mut backlight_device) -> c_int {
    ...
    {
    struct lm3533_bl *bl = dev_get_drvdata(dev);
    let mut channel: unsigned = lm3533_bl_get_ctrlbank_id(bl);
    ...
    {
    struct lm3533_bl *bl = dev_get_drvdata(dev);
    let mut ctrlbank: c_int = lm3533_bl_get_ctrlbank_id(bl);
    u8 val;
    u8 mask;
    bool enable;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn lm3533_bl_probe(pdev: *mut platform_device) -> c_int {
    ...
    bl.cb.dev = core::ptr::null_mut();			/* until registered */
...
#[no_mangle]
unsafe extern "C" fn lm3533_bl_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn lm3533_bl_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3533_bl_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3533_bl_shutdown(pdev: *mut platform_device) {
