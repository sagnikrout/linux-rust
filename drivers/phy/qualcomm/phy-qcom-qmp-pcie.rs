...
//! Source: drivers/phy/qualcomm/phy-qcom-qmp-pcie.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmp_phy_cfg_tbls {
    pub serdes: *const qmp_phy_init_tbl,
    pub serdes_num: c_int,
    pub tx: *const qmp_phy_init_tbl,
    pub tx_num: c_int,
    pub rx: *const qmp_phy_init_tbl,
    pub rx_num: c_int,
    pub txz: *const qmp_phy_init_tbl,
    pub txz_num: c_int,
    pub rxz: *const qmp_phy_init_tbl,
    pub rxz_num: c_int,
    pub pcs: *const qmp_phy_init_tbl,
    pub pcs_num: c_int,
    pub pcs_misc: *const qmp_phy_init_tbl,
    pub pcs_misc_num: c_int,
    pub pcs_lane1: *const qmp_phy_init_tbl,
    pub pcs_lane1_num: c_int,
    pub ln_shrd: *const qmp_phy_init_tbl,
    pub ln_shrd_num: c_int,
}
...
//
    pub tbls_rc: *const qmp_phy_cfg_tbls,
    pub tbls_ep: *const qmp_phy_cfg_tbls,
    pub serdes_4ln_tbl: *const qmp_phy_init_tbl,
    pub serdes_4ln_num: c_int,
...
// array of registers with different offsets
    ...
    pub pwrdn_ctrl: c_uint,
// bit offset of PHYSTATUS in QPHY_PCS_STATUS register
    pub phy_status: c_uint,
    pub skip_start_delay: bool,
// QMP PHY pipe clock interface rate
    pub pipe_clock_rate: c_ulong,
// QMP PHY AUX clock interface rate
    pub aux_clock_rate: c_ulong,
}
...
pub struct qmp_pcie {
    ...
    pub tcsr_4ln_config: bool,
    pub skip_init: bool,
    pub serdes: *mut void __iomem,
    pub pcs: *mut void __iomem,
    pub pcs_misc: *mut void __iomem,
    pub pcs_lane1: *mut void __iomem,
    pub tx: *mut void __iomem,
    pub rx: *mut void __iomem,
    pub tx2: *mut void __iomem,
    pub rx2: *mut void __iomem,
    pub txz: *mut void __iomem,
    pub rxz: *mut void __iomem,
    pub ln_shrd: *mut void __iomem,
    pub port_b: *mut void __iomem,
    pub clks: *mut clk_bulk_data,
    pub pipe_clks: [clk_bulk_data; 2],
    pub num_pipe_clks: c_int,
    pub resets: *mut reset_control_bulk_data,
    pub nocsr_reset: *mut reset_control,
    pub vregs: *mut regulator_bulk_data,
    pub phy: *mut phy,
    pub mode: c_int,
    pub pipe_clk_fixed: clk_fixed_rate,
    pub aux_clk_fixed: clk_fixed_rate,
}

#[no_mangle]
unsafe extern "C" fn qphy_checkbits(base: *const void __iomem, offset: u32, val: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_init_port_b(qmp: *mut qmp_pcie, tbls: *const qmp_phy_cfg_tbls) {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_init_registers(qmp: *mut qmp_pcie, tbls: *const qmp_phy_cfg_tbls) {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
unsafe extern "C" fn qmp_pcie_clk_init(qmp: *mut qmp_pcie) -> c_int {
    ...
    {
    struct device *dev = qmp.dev;
    let mut num: c_int = ARRAY_SIZE(qmp_pciephy_clk_l);
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn phy_pipe_clk_register(qmp: *mut qmp_pcie, np: *mut device_node) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn phy_aux_clk_register(qmp: *mut qmp_pcie, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_register_clocks(qmp: *mut qmp_pcie, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_parse_dt_legacy(qmp: *mut qmp_pcie, np: *mut device_node) -> c_int {
...
//
    ...
    qmp.pcs_misc = devm_of_iomap(dev, np, 3, core::ptr::null_mut());
    }
...
//
    ...
    clk = devm_get_clk_from_child(dev, np, core::ptr::null_mut());
    if (IS_ERR(clk)) {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_get_4ln_config(qmp: *mut qmp_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_parse_dt(qmp: *mut qmp_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_probe(pdev: *mut platform_device) -> c_int {
