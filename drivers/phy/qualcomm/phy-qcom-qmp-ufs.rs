...
//! Source: drivers/phy/qualcomm/phy-qcom-qmp-ufs.c
#![no_std]
...
pub struct qmp_phy_cfg {
    pub lanes: c_int,
    pub offsets: *const qmp_ufs_offsets,
// Maximum supported Gear of this config
    pub max_supported_gear: u32,
// Main init sequence for PHY blocks - serdes, tx, rx, pcs
    pub tbls: qmp_phy_cfg_tbls,
// Additional sequence for HS Series B
    pub tbls_hs_b: qmp_phy_cfg_tbls,
// Additional sequence for different HS Gears
    pub tbls_hs_overlay: [qmp_phy_cfg_tbls; NUM_OVERLAY],
...
pub struct qmp_ufs {
    ...
    pub ufs_reset: *mut reset_control,
    pub phy: *mut phy,
    pub mode: u32,
    pub submode: u32,
}
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_serdes_init(qmp: *mut qmp_ufs, tbls: *const qmp_phy_cfg_tbls) {
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_lanes_init(qmp: *mut qmp_ufs, tbls: *const qmp_phy_cfg_tbls) {
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_pcs_init(qmp: *mut qmp_ufs, tbls: *const qmp_phy_cfg_tbls) {
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_get_gear_overlay(qmp: *mut qmp_ufs, cfg: *const qmp_phy_cfg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_init_all(qmp: *mut qmp_ufs, tbls: *const qmp_phy_cfg_tbls) {
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_init_registers(qmp: *mut qmp_ufs, cfg: *const qmp_phy_cfg) {
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_phy_calibrate(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_phy_init(phy: *mut phy) -> c_int {
...
//
    ...
    qmp.ufs_reset = core::ptr::null_mut();
    return ret;
    }
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_clk_init(qmp: *mut qmp_ufs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_clk_release_provider(res: *mut c_void) {
    static void qmp_ufs_clk_release_provider(void *res)
    {
    of_clk_del_provider(res);
    }
pub const UFS_SYMBOL_CLOCKS: c_int = 3;
#[no_mangle]
unsafe extern "C" fn qmp_ufs_register_clocks(qmp: *mut qmp_ufs, np: *mut device_node) -> c_int {
    ...
    hw = devm_clk_hw_register_fixed_rate(qmp.dev, name, core::ptr::null_mut(), 0, 0);
    if (IS_ERR(hw))
    return PTR_ERR(hw);
    clk_data.hws[0] = hw;
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_parse_dt_legacy(qmp: *mut qmp_ufs, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_parse_dt(qmp: *mut qmp_ufs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_ufs_probe(pdev: *mut platform_device) -> c_int {
