...
//! Source: drivers/phy/qualcomm/phy-qcom-qmp-combo.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmp_combo_lane_mapping {
    pub lanes_count: c_uint,
...
pub struct qmp_combo_offsets {
    ...
    pub rxb: u16,
    pub usb3_serdes: u16,
    pub usb3_pcs_misc: u16,
    pub usb3_pcs: u16,
    pub usb3_pcs_aon: u16,
    pub usb3_pcs_usb: u16,
    pub dp_serdes: u16,
    pub dp_txa: u16,
    pub dp_txb: u16,
    pub dp_dp_phy: u16,
...
pub struct qmp_phy_cfg {
    pub offsets: *const qmp_combo_offsets,
// Init sequence for PHY blocks - serdes, tx, rx, pcs
    ...
    pub pcs_misc_tbl: *const qmp_phy_init_tbl,
    pub pcs_misc_tbl_num: c_int,
...
// Init sequence for DP PHY block link rates
    ...
    pub serdes_tbl_hbr3: *const qmp_phy_init_tbl,
    pub serdes_tbl_hbr3_num: c_int,
...
// DP PHY callbacks
    pub qmp): *mut *mut int (configure_dp_clocks)(struct qmp_combo,
    pub qmp): *mut *mut int (configure_dp_phy)(struct qmp_combo,
    pub qmp): *mut *mut void (configure_dp_tx)(struct qmp_combo,
    pub qmp): *mut *mut int (calibrate_dp_phy)(struct qmp_combo,
    pub qmp): *mut *mut void (dp_aux_init)(struct qmp_combo,
...
// true, if PHY needs delay after POWER_DOWN
    pub has_pwrdn_delay: bool,
// Offset from PCS to PCS_USB region
    pub pcs_usb_offset: c_uint,
    pub invert_cc_polarity: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmp_combo {
    pub dev: *mut device,
    pub cfg: *const qmp_phy_cfg,
    pub com: *mut void __iomem,
    pub aon_toggle: *mut void __iomem,
    ...
    pub qmpphy_mode: enum qmpphy_mode,
    pub usb_phy: *mut phy,
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_dp_serdes_init(qmp: *mut qmp_combo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_v3_dp_aux_init(qmp: *mut qmp_combo) {
    static void qmp_v3_dp_aux_init(struct qmp_combo *qmp)
    {
    const struct qmp_phy_cfg *cfg = qmp.cfg;
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_configure_dp_swing(qmp: *mut qmp_combo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_v3_configure_dp_tx(qmp: *mut qmp_combo) {
    static void qmp_v3_configure_dp_tx(struct qmp_combo *qmp)
    {
    const struct phy_configure_opts_dp *dp_opts = &qmp.dp_opts;
    u32 bias_en, drvr_en;
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_configure_dp_mode(qmp: *mut qmp_combo) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qmp_v3_configure_dp_clocks(qmp: *mut qmp_combo) -> c_int {
    static int qmp_v3_configure_dp_clocks(struct qmp_combo *qmp)
    {
    const struct phy_configure_opts_dp *dp_opts = &qmp.dp_opts;
    u32 phy_vco_div;
...
#[no_mangle]
unsafe extern "C" fn qmp_v3_configure_dp_phy(qmp: *mut qmp_combo) -> c_int {
    static int qmp_v3_configure_dp_phy(struct qmp_combo *qmp)
    {
    const struct qmp_phy_cfg *cfg = qmp.cfg;
    u32 status;
...
//
#[no_mangle]
unsafe extern "C" fn qmp_v3_calibrate_dp_phy(qmp: *mut qmp_combo) -> c_int {
    static int qmp_v3_calibrate_dp_phy(struct qmp_combo *qmp)
    {
...
#[no_mangle]
unsafe extern "C" fn qmp_v4_dp_aux_init(qmp: *mut qmp_combo) {
    static void qmp_v4_dp_aux_init(struct qmp_combo *qmp)
    {
    const struct qmp_phy_cfg *cfg = qmp.cfg;
...
#[no_mangle]
unsafe extern "C" fn qmp_v8_dp_aux_init(qmp: *mut qmp_combo) {
    static void qmp_v8_dp_aux_init(struct qmp_combo *qmp)
    {
    const struct qmp_phy_cfg *cfg = qmp.cfg;
    writel(DP_PHY_PD_CTL_PWRDN | DP_PHY_PD_CTL_PSR_PWRDN | DP_PHY_PD_CTL_AUX_PWRDN |
...
#[no_mangle]
unsafe extern "C" fn qmp_v4_configure_dp_tx(qmp: *mut qmp_combo) {
    static void qmp_v4_configure_dp_tx(struct qmp_combo *qmp)
    {
    const struct qmp_phy_cfg *cfg = qmp.cfg;
...
#[no_mangle]
unsafe extern "C" fn qmp_v8_configure_dp_clocks(qmp: *mut qmp_combo) -> c_int {
    static int qmp_v8_configure_dp_clocks(struct qmp_combo *qmp)
    {
    const struct phy_configure_opts_dp *dp_opts = &qmp.dp_opts;
    u32 phy_vco_div;
...
#[no_mangle]
unsafe extern "C" fn qmp_v456_configure_dp_phy(qmp: *mut qmp_combo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_v4_configure_dp_phy(qmp: *mut qmp_combo) -> c_int {
    static int qmp_v4_configure_dp_phy(struct qmp_combo *qmp)
    {
    const struct qmp_phy_cfg *cfg = qmp.cfg;
    let mut reverse: bool = (qmp.orientation == TYPEC_ORIENTATION_REVERSE);
...
#[no_mangle]
unsafe extern "C" fn qmp_v8_configure_dp_phy(qmp: *mut qmp_combo) -> c_int {
    static int qmp_v8_configure_dp_phy(struct qmp_combo *qmp)
    {
    const struct qmp_phy_cfg *cfg = qmp.cfg;
    let mut reverse: bool = (qmp.orientation == TYPEC_ORIENTATION_REVERSE);
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_dp_configure(phy: *mut phy, opts: *mut union phy_configure_opts) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_dp_calibrate(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_com_init(qmp: *mut qmp_combo, force: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_com_exit(qmp: *mut qmp_combo, force: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_dp_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_dp_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_dp_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_dp_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_usb_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_usb_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_usb_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_usb_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_usb_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_enable_autonomous_mode(qmp: *mut qmp_combo) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pcs_misc) -> else {
    else if (pcs_misc)
    qphy_clrbits(pcs_misc, cfg.regs[QPHY_PCS_CLAMP_ENABLE], CLAMP_EN);
    }
#[no_mangle]
unsafe extern "C" fn qmp_combo_disable_autonomous_mode(qmp: *mut qmp_combo) {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    qmp_combo_runtime_resume, core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn qmp_combo_reset_init(qmp: *mut qmp_combo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_clk_init(qmp: *mut qmp_combo) -> c_int {
    static int qmp_combo_clk_init(struct qmp_combo *qmp)
    {
    struct device *dev = qmp.dev;
    let mut num: c_int = ARRAY_SIZE(qmp_combo_phy_clk_l);
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn phy_pipe_clk_register(qmp: *mut qmp_combo, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_dp_clks_register(qmp: *mut qmp_combo, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_typec_mux_set(mux: *mut typec_mux_dev, state: *mut typec_mux_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_typec_switch_unregister(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_typec_mux_unregister(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_typec_register(qmp: *mut qmp_combo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_parse_dt_legacy_dp(qmp: *mut qmp_combo, np: *mut device_node) -> c_int {
...
// implementation.
//
    qmp.dp_tx = devm_of_iomap(dev, np, 0, core::ptr::null_mut());
    if (IS_ERR(qmp.dp_tx))
    return PTR_ERR(qmp.dp_tx);
    qmp.dp_dp_phy = devm_of_iomap(dev, np, 2, core::ptr::null_mut());
    if (IS_ERR(qmp.dp_dp_phy))
    return PTR_ERR(qmp.dp_dp_phy);
    qmp.dp_tx2 = devm_of_iomap(dev, np, 3, core::ptr::null_mut());
    if (IS_ERR(qmp.dp_tx2))
    return PTR_ERR(qmp.dp_tx2);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn qmp_combo_parse_dt_legacy_usb(qmp: *mut qmp_combo, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_parse_dt(qmp: *mut qmp_combo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_combo_probe(pdev: *mut platform_device) -> c_int {
...
// Check for legacy binding with child nodes.
    ...
    let mut dp_orientation: enum typec_orientation = TYPEC_ORIENTATION_NONE;
    let mut usb3_orientation: enum typec_orientation = TYPEC_ORIENTATION_NONE;
