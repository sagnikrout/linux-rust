...
//! Source: drivers/phy/qualcomm/phy-qcom-qusb2.c
#![no_std]
...
pub const QUSB2PHY_PLL: c_uint = 0x0;
pub const QUSB2PHY_PLL_TEST: c_uint = 0x04;

pub const QUSB2PHY_PLL_TUNE: c_uint = 0x08;
pub const QUSB2PHY_PLL_USER_CTL1: c_uint = 0x0c;
pub const QUSB2PHY_PLL_USER_CTL2: c_uint = 0x10;
pub const QUSB2PHY_PLL_AUTOPGM_CTL1: c_uint = 0x1c;
pub const QUSB2PHY_PLL_PWR_CTRL: c_uint = 0x18;
...
pub const IMP_RES_OFFSET_SHIFT: c_uint = 0x0;
// QUSB2PHY_PLL_BIAS_CONTROL_2 register bits

pub const BIAS_CTRL2_RES_OFFSET_SHIFT: c_uint = 0x0;
// QUSB2PHY_CHG_CONTROL_2 register bits

pub const CHG_CTRL2_OFFSET_SHIFT: c_uint = 0x4;
// QUSB2PHY_PORT_TUNE1 register bits

pub const HSTX_TRIM_SHIFT: c_uint = 0x4;

pub const PREEMPHASIS_EN_SHIFT: c_uint = 0x0;
// QUSB2PHY_PORT_TUNE2 register bits

pub const HSDISC_TRIM_SHIFT: c_uint = 0x0;
pub const QUSB2PHY_PLL_ANALOG_CONTROLS_TWO: c_uint = 0x04;
pub const QUSB2PHY_PLL_CLOCK_INVERTERS: c_uint = 0x18c;
pub const QUSB2PHY_PLL_CMODE: c_uint = 0x2c;
pub const QUSB2PHY_PLL_LOCK_DELAY: c_uint = 0x184;
pub const QUSB2PHY_PLL_DIGITAL_TIMERS_TWO: c_uint = 0xb4;
pub const QUSB2PHY_PLL_BIAS_CONTROL_1: c_uint = 0x194;
pub const QUSB2PHY_PLL_BIAS_CONTROL_2: c_uint = 0x198;
pub const QUSB2PHY_PWR_CTRL2: c_uint = 0x214;
pub const QUSB2PHY_IMP_CTRL1: c_uint = 0x220;
pub const QUSB2PHY_IMP_CTRL2: c_uint = 0x224;
pub const QUSB2PHY_CHG_CTRL2: c_uint = 0x23c;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qusb2_phy_init_tbl {
    pub offset: c_uint,
    pub val: c_uint,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qusb2_phy_cfg {
    pub tbl: *const qusb2_phy_init_tbl,
// number of entries in the table
    pub tbl_num: c_uint,
// offset to PHY_CLK_SCHEME register in TCSR map
    pub clk_scheme_offset: c_uint,
// array of registers with different offsets
    pub regs: *const c_uint,
    pub mask_core_ready: c_uint,
    pub disable_ctrl: c_uint,
    pub autoresume_en: c_uint,
// true if PHY has PLL_TEST register to select clk_scheme
    pub has_pll_test: bool,
// true if TUNE1 register must be updated by fused value, else TUNE2
    pub update_tune1_with_efuse: bool,
// true if PHY has PLL_CORE_INPUT_OVERRIDE register to reset PLL
    pub has_pll_override: bool,
// true if PHY default clk scheme is single-ended
    pub se_clk_scheme_default: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct override_params {
    pub imp_res_offset: override_param,
    pub hstx_trim: override_param,
    pub preemphasis: override_param,
    pub preemphasis_width: override_param,
    pub bias_ctrl: override_param,
    pub charge_ctrl: override_param,
    pub hsdisc_trim: override_param,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qusb2_phy {
    pub phy: *mut phy,
    pub base: *mut void __iomem,
    pub cfg_ahb_clk: *mut clk,
    pub ref_clk: *mut clk,
    pub iface_clk: *mut clk,
    pub phy_reset: *mut reset_control,
    pub vregs: [regulator_bulk_data; QUSB2_NUM_VREGS],
    pub tcsr: *mut regmap,
    pub cell: *mut nvmem_cell,
    pub overrides: override_params,
    pub cfg: *const qusb2_phy_cfg,
    pub has_se_clk_scheme: bool,
...
#[no_mangle]
pub unsafe extern "C" fn qusb2_setbits(base: *mut void __iomem, offset: u32, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn qusb2_clrbits(base: *mut void __iomem, offset: u32, val: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn qusb2_phy_override_phy_params(qphy: *mut qusb2_phy) {
...
//
#[no_mangle]
unsafe extern "C" fn qusb2_phy_set_tune2_param(qphy: *mut qusb2_phy) {
...
//
    val = nvmem_cell_read(qphy.cell, core::ptr::null_mut());
    if (IS_ERR(val)) {
...
#[no_mangle]
unsafe extern "C" fn qusb2_phy_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn qusb2_phy_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn qusb2_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qusb2_phy_exit(phy: *mut phy) -> c_int {
...
//
    ...
    qusb2_phy_runtime_resume, core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn qusb2_phy_probe(pdev: *mut platform_device) -> c_int {
...
// Get the specific init parameters of QMP phy
    ...
    qphy.tcsr = core::ptr::null_mut();
    }
    qphy.cell = devm_nvmem_cell_get(dev, core::ptr::null_mut());
    if (IS_ERR(qphy.cell)) {
    if (PTR_ERR(qphy.cell) == -EPROBE_DEFER)
    return -EPROBE_DEFER;
    qphy.cell = core::ptr::null_mut();
...
//
    ...
    if (ret)
    return ret;
    generic_phy = devm_phy_create(dev, core::ptr::null_mut(), &qusb2_phy_gen_ops);
