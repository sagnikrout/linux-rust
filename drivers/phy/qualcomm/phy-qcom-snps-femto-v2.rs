...
//! Source: drivers/phy/qualcomm/phy-qcom-snps-femto-v2.c
#![no_std]
...
pub const PARAM_OVRD_MASK: c_uint = 0xFF;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct override_param_map {
    pub prop_name: *const c_char,
    pub param_table: *const override_param,
    pub table_size: u8,
    pub reg_offset: u8,
    pub param_mask: u8,
}
...
pub struct qcom_snps_hsphy {
    ...
    pub vregs: [regulator_bulk_data; SNPS_HS_NUM_VREGS],
    pub phy_initialized: bool,
    pub mode: enum phy_mode,
    pub update_seq_cfg: [phy_override_seq; NUM_HSPHY_TUNING_PARAMS],
}

#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_clk_init(hsphy: *mut qcom_snps_hsphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_suspend(hsphy: *mut qcom_snps_hsphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_resume(hsphy: *mut qcom_snps_hsphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
unsafe extern "C" fn qcom_snps_hsphy_exit(phy: *mut phy) -> c_int {
    ...
    qcom_snps_hsphy_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_read_override_param_seq(dev: *mut device) {
    ...
    for (i = 0; cfg[i].prop_name != core::ptr::null_mut(); i++) {
...
unsafe extern "C" fn qcom_snps_hsphy_probe(pdev: *mut platform_device) -> c_int {
    ...
    hsphy.phy_reset = devm_reset_control_get_exclusive(&pdev.dev, core::ptr::null_mut());
...
//
    ...
    generic_phy = devm_phy_create(dev, core::ptr::null_mut(), &qcom_snps_hsphy_gen_ops);
