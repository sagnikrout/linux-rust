...
//! Source: drivers/phy/qualcomm/phy-qcom-usb-hs-28nm.c
#![no_std]
...
pub const PHY_CTRL_COMMON0: c_uint = 0x078;

pub const PHY_IRQ_CMD: c_uint = 0x0d0;
pub const PHY_INTR_MASK0: c_uint = 0x0d4;
pub const PHY_INTR_CLEAR0: c_uint = 0x0dc;
pub const DPDM_MASK: c_uint = 0x1e;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hsphy_data {
    pub init_seq: *const hsphy_init_seq,
    pub init_seq_num: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hsphy_priv {
    pub base: *mut void __iomem,
    pub clks: *mut clk_bulk_data,
    pub num_clks: c_int,
    pub phy_reset: *mut reset_control,
    pub por_reset: *mut reset_control,
    pub vregs: [regulator_bulk_data; VREG_NUM],
    pub data: *const hsphy_data,
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_enable_hv_interrupts(priv: *mut hsphy_priv) {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_disable_hv_interrupts(priv: *mut hsphy_priv) {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_enter_retention(priv: *mut hsphy_priv) {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_exit_retention(priv: *mut hsphy_priv) {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_reset(priv: *mut hsphy_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_init_sequence(priv: *mut hsphy_priv) {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_por_reset(priv: *mut hsphy_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_snps_hsphy_probe(pdev: *mut platform_device) -> c_int {
