...
//! Source: drivers/phy/qualcomm/phy-qcom-qmp-usb-legacy.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qmp_usb_legacy_offsets {
    pub serdes: u16,
    pub pcs: u16,
    pub pcs_usb: u16,
    pub tx: u16,
...
pub struct qmp_phy_cfg {
    pub offsets: *const qmp_usb_legacy_offsets,
// Init sequence for PHY blocks - serdes, tx, rx, pcs
    ...
    pub pcs_usb_tbl: *const qmp_phy_init_tbl,
    pub pcs_usb_tbl_num: c_int,
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_serdes_init(qmp: *mut qmp_usb) -> c_int {
    static int qmp_usb_legacy_serdes_init(struct qmp_usb *qmp)
    {
    const struct qmp_phy_cfg *cfg = qmp.cfg;
    void __iomem *serdes = qmp.serdes;
    const struct qmp_phy_init_tbl *serdes_tbl = cfg.serdes_tbl;
    let mut serdes_tbl_num: c_int = cfg.serdes_tbl_num;
    qmp_usb_legacy_configure(serdes, serdes_tbl, serdes_tbl_num);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_init_dp_com(phy: *mut phy) {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_enable(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_disable(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_enable_autonomous_mode(qmp: *mut qmp_usb) {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_disable_autonomous_mode(qmp: *mut qmp_usb) {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    qmp_usb_legacy_runtime_resume, core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_vreg_init(qmp: *mut qmp_usb) -> c_int {
    static int qmp_usb_legacy_vreg_init(struct qmp_usb *qmp)
    {
    const struct qmp_phy_cfg *cfg = qmp.cfg;
    struct device *dev = qmp.dev;
    let mut num: c_int = cfg.num_vregs;
    int i;
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_reset_init(qmp: *mut qmp_usb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_clk_init(qmp: *mut qmp_usb) -> c_int {
    static int qmp_usb_legacy_clk_init(struct qmp_usb *qmp)
    {
    const struct qmp_phy_cfg *cfg = qmp.cfg;
    struct device *dev = qmp.dev;
    let mut num: c_int = cfg.num_clks;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn phy_pipe_clk_register(qmp: *mut qmp_usb, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_parse_dt_legacy(qmp: *mut qmp_usb, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_parse_dt(qmp: *mut qmp_usb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_legacy_probe(pdev: *mut platform_device) -> c_int {
...
// Check for legacy binding with child node.
    np = of_get_next_available_child(dev.of_node, core::ptr::null_mut());
    if (np) {
