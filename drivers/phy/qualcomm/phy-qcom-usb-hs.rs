...
//! Source: drivers/phy/qualcomm/phy-qcom-usb-hs.c
#![no_std]
...
pub const ULPI_PWR_CLK_MNG_REG: c_uint = 0x88;

pub const ULPI_MISC_A: c_uint = 0x96;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_usb_hs_phy {
    pub ulpi: *mut ulpi,
    pub phy: *mut phy,
    pub ref_clk: *mut clk,
    pub sleep_clk: *mut clk,
    pub v1p8: *mut regulator,
    pub v3p3: *mut regulator,
    pub reset: *mut reset_control,
    pub vbus_edev: *mut extcon_dev,
    pub vbus_notify: notifier_block,
    pub init_seq: [ulpi_seq; ],
}
...
#[no_mangle]
unsafe extern "C" fn qcom_usb_hs_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_usb_hs_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_usb_hs_phy_probe(ulpi: *mut ulpi) -> c_int {
...
// NUL terminate
    ...
    uphy.vbus_edev = core::ptr::null_mut();
    }
