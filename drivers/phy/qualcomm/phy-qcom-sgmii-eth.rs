...
//! Source: drivers/phy/qualcomm/phy-qcom-sgmii-eth.c
#![no_std]
...
pub const QSERDES_QMP_PLL: c_uint = 0x0;
pub const QSERDES_RX: c_uint = 0x600;
pub const QSERDES_TX: c_uint = 0x400;
pub const QSERDES_PCS: c_uint = 0xc00;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_dwmac_sgmii_phy_data {
...
#[no_mangle]
unsafe extern "C" fn qcom_dwmac_sgmii_phy_init_1g(regmap: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn qcom_dwmac_sgmii_phy_init_2p5g(regmap: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn qcom_dwmac_sgmii_phy_calibrate(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_dwmac_sgmii_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_dwmac_sgmii_phy_power_off(phy: *mut phy) -> c_int {
    ...
    struct qcom_dwmac_sgmii_phy_data *data = phy_get_drvdata(phy);
    int ret;
    ret = qcom_dwmac_sgmii_phy_validate(phy, mode, submode, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn qcom_dwmac_sgmii_phy_probe(pdev: *mut platform_device) -> c_int {
    ...
    phy = devm_phy_create(dev, core::ptr::null_mut(), &qcom_dwmac_sgmii_phy_ops);
    if (IS_ERR(phy))
    return PTR_ERR(phy);
