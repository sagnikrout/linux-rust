...
//! Source: drivers/phy/qualcomm/phy-qcom-qmp-usb.c
#![no_std]
...
pub struct qmp_phy_cfg {
    pub offsets: *const qmp_usb_offsets,
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_serdes_init(qmp: *mut qmp_usb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_enable(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_disable(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_enable_autonomous_mode(qmp: *mut qmp_usb) {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_disable_autonomous_mode(qmp: *mut qmp_usb) {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    qmp_usb_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_clk_init(qmp: *mut qmp_usb) -> c_int {
    static int qmp_usb_clk_init(struct qmp_usb *qmp)
    {
    struct device *dev = qmp.dev;
    let mut num: c_int = ARRAY_SIZE(qmp_usb_phy_clk_l);
    int i;
...
//
    ...
    return devm_of_iomap(dev, np, index, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn qmp_usb_parse_dt_legacy(qmp: *mut qmp_usb, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_parse_dt(qmp: *mut qmp_usb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usb_probe(pdev: *mut platform_device) -> c_int {
