...
//! Source: drivers/phy/qualcomm/phy-qcom-edp.c
#![no_std]
...
// EDP_PHY registers
pub const DP_PHY_CFG: c_uint = 0x0010;
pub const DP_PHY_CFG_1: c_uint = 0x0014;
pub const DP_PHY_PD_CTL: c_uint = 0x001c;
pub const DP_PHY_MODE: c_uint = 0x0020;
pub const DP_AUX_CFG_SIZE: c_int = 13;

pub const DP_PHY_AUX_INTERRUPT_MASK: c_uint = 0x0058;
pub const DP_PHY_VCO_DIV: c_uint = 0x0074;
pub const DP_PHY_TX0_TX1_LANE_CTL: c_uint = 0x007c;
pub const DP_PHY_TX2_TX3_LANE_CTL: c_uint = 0x00a0;
pub const DP_PHY_STATUS: c_uint = 0x00e0;
// LANE_TXn registers
pub const TXn_CLKBUF_ENABLE: c_uint = 0x0000;
pub const TXn_TX_EMP_POST1_LVL: c_uint = 0x0004;
pub const TXn_TX_DRV_LVL: c_uint = 0x0014;
pub const TXn_TX_DRV_LVL_OFFSET: c_uint = 0x0018;
pub const TXn_RESET_TSYNC_EN: c_uint = 0x001c;
pub const TXn_LDO_CONFIG: c_uint = 0x0084;
pub const TXn_TX_BAND: c_uint = 0x0028;
pub const TXn_RES_CODE_LANE_OFFSET_TX0: c_uint = 0x0044;
pub const TXn_RES_CODE_LANE_OFFSET_TX1: c_uint = 0x0048;
pub const TXn_TRANSCEIVER_BIAS_EN: c_uint = 0x0054;
pub const TXn_HIGHZ_DRVR_EN: c_uint = 0x0058;
pub const TXn_TX_POL_INV: c_uint = 0x005c;
pub const TXn_LANE_MODE_1: c_uint = 0x0064;
pub const TXn_TRAN_DRVR_EMP_EN: c_uint = 0x0078;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_edp_swing_pre_emph_cfg {
    pub (*swing_hbr_rbr)[4][4]: *const u8,
    pub (*swing_hbr3_hbr2)[4][4]: *const u8,
    pub (*pre_emphasis_hbr_rbr)[4][4]: *const u8,
    pub (*pre_emphasis_hbr3_hbr2)[4][4]: *const u8,
}

    struct qcom_edp;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct phy_ver_ops {
    pub edp): *const *const int (com_power_on)(struct qcom_edp,
    pub edp): *const *const int (com_resetsm_cntrl)(struct qcom_edp,
    pub edp): *const *const int (com_bias_en_clkbuflr)(struct qcom_edp,
    pub edp): *const *const int (com_clk_fwd_cfg)(struct qcom_edp,
    pub edp): *const *const int (com_configure_pll)(struct qcom_edp,
    pub edp): *const *const int (com_configure_ssc)(struct qcom_edp,
    pub edp): *const *const int (com_ldo_config)(struct qcom_edp,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_edp_phy_cfg {
    pub is_edp: bool,
    pub aux_cfg: *const u8,
    pub vco_div_cfg: *const u8,
    pub dp_swing_pre_emph_cfg: *const qcom_edp_swing_pre_emph_cfg,
    pub edp_swing_pre_emph_cfg: *const qcom_edp_swing_pre_emph_cfg,
    pub ver_ops: *const phy_ver_ops,
}
...
pub struct qcom_edp {
    pub dev: *mut device,
    pub cfg: *const qcom_edp_phy_cfg,
    pub phy: *mut phy,
    pub edp: *mut void __iomem,
    pub tx0: *mut void __iomem,
    pub tx1: *mut void __iomem,
    pub pll: *mut void __iomem,
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_set_voltages(edp: *mut qcom_edp, dp_opts: *const phy_configure_opts_dp) -> c_int {
    static int qcom_edp_set_voltages(struct qcom_edp *edp, const struct phy_configure_opts_dp *dp_opts)
    {
    const struct qcom_edp_swing_pre_emph_cfg *cfg;
    let mut v_level: c_uint = 0;
    let mut p_level: c_uint = 0;
    int ret;
    u8 swing;
    u8 emph;
    int i;
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_phy_configure(phy: *mut phy, opts: *mut union phy_configure_opts) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_configure_ssc(edp: *const qcom_edp) -> c_int {
    static int qcom_edp_configure_ssc(const struct qcom_edp *edp)
    {
    return edp.cfg.ver_ops.com_configure_ssc(edp);
    }
#[no_mangle]
unsafe extern "C" fn qcom_edp_configure_pll(edp: *const qcom_edp) -> c_int {
    static int qcom_edp_configure_pll(const struct qcom_edp *edp)
    {
    return edp.cfg.ver_ops.com_configure_pll(edp);
    }
#[no_mangle]
unsafe extern "C" fn qcom_edp_set_vco_div(edp: *const qcom_edp, pixel_freq: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_phy_power_on_v4(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_phy_com_resetsm_cntrl_v4(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_com_clk_fwd_cfg_v4(edp: *const qcom_edp) -> c_int {
    static int qcom_edp_com_clk_fwd_cfg_v4(const struct qcom_edp *edp)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn qcom_edp_com_bias_en_clkbuflr_v4(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_com_configure_ssc_v4(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_com_configure_pll_v4(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_ldo_config_v3(edp: *const qcom_edp) -> c_int {
    ...
    ldo_config = 0x0;
#[no_mangle]
pub unsafe extern "C" fn if(2700: dp_opts->link_rate <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_ldo_config_v4(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_phy_power_on_v6(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_phy_com_resetsm_cntrl_v6(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_com_bias_en_clkbuflr_v6(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_com_configure_ssc_v6(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_com_configure_pll_v6(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_ldo_config_v6(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_com_configure_ssc_v8(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_com_configure_pll_v8(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_phy_com_resetsm_cntrl_v8(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_com_clk_fwd_cfg_v8(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_com_bias_en_clkbuflr_v8(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_phy_power_on_v8(edp: *const qcom_edp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_phy_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_phy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_clks_register(edp: *mut qcom_edp, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_edp_phy_probe(pdev: *mut platform_device) -> c_int {
