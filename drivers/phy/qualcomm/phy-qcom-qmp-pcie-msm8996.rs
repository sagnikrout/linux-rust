...
//! Source: drivers/phy/qualcomm/phy-qcom-qmp-pcie-msm8996.c
#![no_std]
...
pub const POWER_DOWN_DELAY_US_MIN: c_int = 10;
pub const POWER_DOWN_DELAY_US_MAX: c_int = 20;
...
pub struct qmp_phy {
    ...
    pub index: c_uint,
    pub qmp: *mut qcom_qmp,
    pub lane_rst: *mut reset_control,
}
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_msm8996_serdes_init(qphy: *mut qmp_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_msm8996_com_init(qphy: *mut qmp_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_msm8996_com_exit(qphy: *mut qmp_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_msm8996_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_msm8996_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_msm8996_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_msm8996_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_msm8996_enable(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_msm8996_disable(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_msm8996_vreg_init(dev: *mut device, cfg: *const qmp_phy_cfg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_msm8996_reset_init(dev: *mut device, cfg: *const qmp_phy_cfg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_msm8996_clk_init(dev: *mut device, cfg: *const qmp_phy_cfg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn phy_pipe_clk_register(qmp: *mut qcom_qmp, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_qmp_reset_control_put(data: *mut c_void) {
...
//
    qphy.tx = devm_of_iomap(dev, np, 0, core::ptr::null_mut());
    if (IS_ERR(qphy.tx))
    return PTR_ERR(qphy.tx);
    qphy.rx = devm_of_iomap(dev, np, 1, core::ptr::null_mut());
    if (IS_ERR(qphy.rx))
    return PTR_ERR(qphy.rx);
    qphy.pcs = devm_of_iomap(dev, np, 2, core::ptr::null_mut());
    if (IS_ERR(qphy.pcs))
    return PTR_ERR(qphy.pcs);
    qphy.pipe_clk = devm_get_clk_from_child(dev, np, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn qmp_pcie_msm8996_probe(pdev: *mut platform_device) -> c_int {
    ...
    void __iomem *serdes;
    const struct qmp_phy_cfg *cfg = core::ptr::null_mut();
