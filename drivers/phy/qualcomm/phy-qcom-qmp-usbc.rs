...
//! Source: drivers/phy/qualcomm/phy-qcom-qmp-usbc.c
#![no_std]
...
pub const PHY_INIT_COMPLETE_TIMEOUT: c_int = 10000;
...
pub struct qmp_phy_cfg {
    pub offsets: *const qmp_usbc_offsets,
// Init sequence for USB PHY blocks - serdes, tx, rx, pcs
    pub serdes_tbl: *const qmp_phy_init_tbl,
    pub serdes_tbl_num: c_int,
    pub tx_tbl: *const qmp_phy_init_tbl,
    pub tx_tbl_num: c_int,
    pub rx_tbl: *const qmp_phy_init_tbl,
    pub rx_tbl_num: c_int,
    pub pcs_tbl: *const qmp_phy_init_tbl,
    pub pcs_tbl_num: c_int,
// Init sequence for DP PHY blocks - serdes, tx, rbr, hbr, hbr2
    pub dp_serdes_tbl: *const qmp_phy_init_tbl,
    pub dp_serdes_tbl_num: c_int,
    pub dp_tx_tbl: *const qmp_phy_init_tbl,
    pub dp_tx_tbl_num: c_int,
    pub serdes_tbl_rbr: *const qmp_phy_init_tbl,
    pub serdes_tbl_rbr_num: c_int,
    pub serdes_tbl_hbr: *const qmp_phy_init_tbl,
    pub serdes_tbl_hbr_num: c_int,
    pub serdes_tbl_hbr2: *const qmp_phy_init_tbl,
    pub serdes_tbl_hbr2_num: c_int,
    pub (*swing_tbl)[4][4]: *const u8,
    pub (*pre_emphasis_tbl)[4][4]: *const u8,
// DP PHY callbacks
    pub qmp): *mut *mut void (dp_aux_init)(struct qmp_usbc,
    pub qmp): *mut *mut void (configure_dp_tx)(struct qmp_usbc,
    pub qmp): *mut *mut int (configure_dp_phy)(struct qmp_usbc,
    pub qmp): *mut *mut int (calibrate_dp_phy)(struct qmp_usbc,
    pub reset_list: *const *const c_char,
    pub num_resets: c_int,
    pub vreg_list: *const regulator_bulk_data,
    pub num_vregs: c_int,
...
pub struct qmp_usbc {
    ...
    pub serdes: *mut void __iomem,
    pub pcs: *mut void __iomem,
    pub pcs_misc: *mut void __iomem,
    pub tx: *mut void __iomem,
    pub rx: *mut void __iomem,
    pub tx2: *mut void __iomem,
    pub rx2: *mut void __iomem,
    pub dp_dp_phy: *mut void __iomem,
    pub dp_tx: *mut void __iomem,
    pub dp_tx2: *mut void __iomem,
    pub dp_serdes: *mut void __iomem,
    pub pipe_clk: *mut clk,
    pub pipe_clk_fixed: clk_fixed_rate,
    pub dp_link_hw: clk_hw,
    pub dp_pixel_hw: clk_hw,
    pub clks: *mut clk_bulk_data,
    pub num_clks: c_int,
    pub num_resets: c_int,
    pub resets: *mut reset_control_bulk_data,
    pub vregs: *mut regulator_bulk_data,
    pub tcsr_map: *mut regmap,
    pub vls_clamp_reg: u32,
    pub dp_phy_mode_reg: u32,
    pub phy_mutex: mutex,
    pub usb_phy: *mut phy,
    pub mode: enum phy_mode,
    pub usb_init_count: c_uint,
    pub dp_phy: *mut phy,
    pub dp_aux_cfg: c_uint,
    pub dp_opts: phy_configure_opts_dp,
    pub dp_init_count: c_uint,
    pub sw: *mut typec_switch_dev,
    pub orientation: enum typec_orientation,
}

#[no_mangle]
pub unsafe extern "C" fn qphy_setbits(base: *mut void __iomem, offset: u32, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn qphy_clrbits(base: *mut void __iomem, offset: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_set_phy_mode(qmp: *mut qmp_usbc, is_dp: bool) {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_com_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_com_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcs615_qmp_dp_aux_init(qmp: *mut qmp_usbc) {
    static void qcs615_qmp_dp_aux_init(struct qmp_usbc *qmp)
    {
...
#[no_mangle]
unsafe extern "C" fn qcs615_qmp_configure_dp_swing(qmp: *mut qmp_usbc) -> c_int {
    ...
    let mut v_level: c_uint = 0, p_level = 0;
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_configure_dp_mode(qmp: *mut qmp_usbc) {
    static void qmp_usbc_configure_dp_mode(struct qmp_usbc *qmp)
    {
    let mut reverse: bool = (qmp.orientation == TYPEC_ORIENTATION_REVERSE);
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_configure_dp_clocks(qmp: *mut qmp_usbc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcs615_qmp_configure_dp_tx(qmp: *mut qmp_usbc) {
    static void qcs615_qmp_configure_dp_tx(struct qmp_usbc *qmp)
    {
    const struct phy_configure_opts_dp *dp_opts = &qmp.dp_opts;
    void __iomem *tx = qmp.dp_tx;
...
#[no_mangle]
unsafe extern "C" fn qcs615_qmp_configure_dp_phy(qmp: *mut qmp_usbc) -> c_int {
    static int qcs615_qmp_configure_dp_phy(struct qmp_usbc *qmp)
    {
    u32 status;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn qcs615_qmp_calibrate_dp_phy(qmp: *mut qmp_usbc) -> c_int {
    static int qcs615_qmp_calibrate_dp_phy(struct qmp_usbc *qmp)
    {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_usb_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_usb_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_check_phy_status(qmp: *mut qmp_usbc, is_dp: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_usb_enable(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_usb_disable(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_usb_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_dp_enable(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_dp_disable(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_dp_configure(phy: *mut phy, opts: *mut union phy_configure_opts) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_dp_calibrate(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_dp_serdes_init(qmp: *mut qmp_usbc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_dp_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_dp_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_enable_autonomous_mode(qmp: *mut qmp_usbc) {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_disable_autonomous_mode(qmp: *mut qmp_usbc) {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    qmp_usbc_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_clk_init(qmp: *mut qmp_usbc) -> c_int {
    static int qmp_usbc_clk_init(struct qmp_usbc *qmp)
    {
    struct device *dev = qmp.dev;
    let mut num: c_int = ARRAY_SIZE(qmp_usbc_phy_clk_l);
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn phy_pipe_clk_register(qmp: *mut qmp_usbc, np: *mut device_node) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qmp_dp_pixel_clk_determine_rate(hw: *mut clk_hw, req: *mut clk_rate_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_dp_pixel_clk_recalc_rate(hw: *mut clk_hw, parent_rate: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn qmp_dp_link_clk_determine_rate(hw: *mut clk_hw, req: *mut clk_rate_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_dp_link_clk_recalc_rate(hw: *mut clk_hw, parent_rate: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn phy_dp_clks_register(qmp: *mut qmp_usbc, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_clk_release_provider(res: *mut c_void) {
    static void phy_clk_release_provider(void *res)
    {
    of_clk_del_provider(res);
    }
#[no_mangle]
unsafe extern "C" fn qmp_usbc_register_clocks(qmp: *mut qmp_usbc, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_typec_unregister(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_typec_switch_register(qmp: *mut qmp_usbc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_parse_dt_legacy(qmp: *mut qmp_usbc, np: *mut device_node) -> c_int {
...
//
    qmp.tx = devm_of_iomap(dev, np, 0, core::ptr::null_mut());
    if (IS_ERR(qmp.tx))
    return PTR_ERR(qmp.tx);
    qmp.rx = devm_of_iomap(dev, np, 1, core::ptr::null_mut());
    if (IS_ERR(qmp.rx))
    return PTR_ERR(qmp.rx);
    qmp.pcs = devm_of_iomap(dev, np, 2, core::ptr::null_mut());
    if (IS_ERR(qmp.pcs))
    return PTR_ERR(qmp.pcs);
    qmp.tx2 = devm_of_iomap(dev, np, 3, core::ptr::null_mut());
    if (IS_ERR(qmp.tx2))
    return PTR_ERR(qmp.tx2);
    qmp.rx2 = devm_of_iomap(dev, np, 4, core::ptr::null_mut());
    if (IS_ERR(qmp.rx2))
    return PTR_ERR(qmp.rx2);
    qmp.pcs_misc = devm_of_iomap(dev, np, 5, core::ptr::null_mut());
    if (IS_ERR(qmp.pcs_misc)) {
    dev_vdbg(dev, "PHY pcs_misc-reg not used\n");
    qmp.pcs_misc = core::ptr::null_mut();
    }
    qmp.pipe_clk = devm_get_clk_from_child(dev, np, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_parse_dt(qmp: *mut qmp_usbc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_parse_tcsr(qmp: *mut qmp_usbc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qmp_usbc_probe(pdev: *mut platform_device) -> c_int {
