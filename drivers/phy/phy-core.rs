...
#[no_mangle]
unsafe extern "C" fn devm_phy_release(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn devm_phy_provider_release(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn devm_phy_consume(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn devm_phy_match(dev: *mut device, res: *mut c_void, match_data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_create_lookup(phy: *mut phy, con_id: *const c_char, dev_id: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_remove_lookup(phy: *mut phy, con_id: *const c_char, dev_id: *const c_char) {
    ...
    struct phy_lookup *p, *pl = core::ptr::null_mut();
    mutex_lock(&phy_provider_mutex);
...
#[no_mangle]
pub unsafe extern "C" fn phy_pm_runtime_get(phy: *mut phy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn phy_pm_runtime_get_sync(phy: *mut phy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn phy_pm_runtime_put(phy: *mut phy) {
...
#[no_mangle]
pub unsafe extern "C" fn phy_pm_runtime_put_sync(phy: *mut phy) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_init(phy: *mut phy) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_exit(phy: *mut phy) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_power_on(phy: *mut phy) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn phy_set_mode_ext(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn phy_set_media(phy: *mut phy, media: enum phy_media) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn phy_set_speed(phy: *mut phy, speed: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn phy_reset(phy: *mut phy) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_calibrate(phy: *mut phy) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_notify_connect(phy: *mut phy, port: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_notify_disconnect(phy: *mut phy, port: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_notify_state(phy: *mut phy, state: union phy_notify) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_configure(phy: *mut phy, opts: *mut union phy_configure_opts) -> c_int {
...
//
    ...
    int ret;
    struct phy_provider *phy_provider;
    struct phy *phy = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn of_phy_put(phy: *mut phy) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_put(dev: *mut device, phy: *mut phy) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_phy_put(dev: *mut device, phy: *mut phy) {
...
//
#[no_mangle]
pub unsafe extern "C" fn phy_destroy(phy: *mut phy) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_phy_destroy(dev: *mut device, phy: *mut phy) {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_phy_provider_unregister(phy_provider: *mut phy_provider) {
...
//
#[no_mangle]
unsafe extern "C" fn phy_release(dev: *mut device) {
    static void phy_release(struct device *dev)
    {
    struct phy *phy;
    phy = to_phy(dev);
...
#[no_mangle]
unsafe extern "C" fn phy_core_init() -> int __init {
    ...
    phy_debugfs_root = debugfs_create_dir("phy", core::ptr::null_mut());
    return 0;
    }
    device_initcall(phy_core_init);
#[no_mangle]
unsafe extern "C" fn phy_core_exit() -> void __exit {
