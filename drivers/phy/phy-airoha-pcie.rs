...
//! Source: drivers/phy/phy-airoha-pcie.c
#![no_std]
...
pub const LEQ_LEN_CTRL_MAX_VAL: c_int = 7;
pub const FREQ_LOCK_MAX_ATTEMPT: c_int = 10;
// PCIe-PHY initialization time in ms needed by the hw to complete
pub const PHY_HW_INIT_TIME_MS: c_int = 30;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct airoha_pcie_phy {
    pub dev: *mut device,
    pub phy: *mut phy,
    pub csr_2l: *mut void __iomem,
    pub pma0: *mut void __iomem,
    pub pma1: *mut void __iomem,
    pub p0_xr_dtime: *mut void __iomem,
    pub p1_xr_dtime: *mut void __iomem,
    pub rx_aeq: *mut void __iomem,
}

#[no_mangle]
unsafe extern "C" fn airoha_phy_clear_bits(reg: *mut void __iomem, mask: u32) {
    static void airoha_phy_clear_bits(void __iomem *reg, u32 mask)
    {
    let mut val: u32 = readl(reg) & ~mask;
    writel(val, reg);
    }
#[no_mangle]
unsafe extern "C" fn airoha_phy_set_bits(reg: *mut void __iomem, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn airoha_phy_update_bits(reg: *mut void __iomem, mask: u32, val: u32) {
    static void airoha_phy_update_bits(void __iomem *reg, u32 mask, u32 val)
    {
    let mut tmp: u32 = readl(reg);
    tmp &= ~mask;
    tmp |= val & mask;
    writel(tmp, reg);
    }
    ...
    {
    let mut fl_out_target: u32 = gen == PCIE_PORT_GEN3 ? 41600 : 41941;
    let mut lock_cyclecnt: u32 = gen == PCIE_PORT_GEN3 ? 26000 : 32767;
...
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_init_default(pcie_phy: *mut airoha_pcie_phy) {
...
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_init_clk_out(pcie_phy: *mut airoha_pcie_phy) {
...
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_init_csr_2l(pcie_phy: *mut airoha_pcie_phy) {
...
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_init_rx(pcie_phy: *mut airoha_pcie_phy) {
...
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_init_jcpll(pcie_phy: *mut airoha_pcie_phy) {
...
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_txpll(pcie_phy: *mut airoha_pcie_phy) {
...
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_init_ssc_jcpll(pcie_phy: *mut airoha_pcie_phy) {
...
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_set_rxflow(pcie_phy: *mut airoha_pcie_phy) {
...
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_set_pr(pcie_phy: *mut airoha_pcie_phy) {
...
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_set_txflow(pcie_phy: *mut airoha_pcie_phy) {
...
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_set_rx_mode(pcie_phy: *mut airoha_pcie_phy) {
...
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_load_kflow(pcie_phy: *mut airoha_pcie_phy) {
...
//
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airoha_pcie_phy_probe(pdev: *mut platform_device) -> c_int {
