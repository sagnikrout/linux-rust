...
//! Source: drivers/phy/samsung/phy-exynosautov920-ufs.c
#![no_std]
...
pub const EXYNOSAUTOV920_EMBEDDED_COMBO_PHY_CTRL: c_uint = 0x708;
pub const EXYNOSAUTOV920_EMBEDDED_COMBO_PHY_CTRL_MASK: c_uint = 0x1;

pub const EXYNOSAUTOV920_EMBEDDED_COMBO_PHY_CDR_LOCK_STATUS: c_uint = 0x5e;
pub const EXYNOSAUTOV920_CDR_LOCK_OFFSET: c_uint = 0xce4;
pub const PHY_EXYNOSAUTOV920_LANE_OFFSET: c_uint = 0x200;
...
pub const EXYNOSAUTOV920_CDR_LOCK_MASK: c_uint = 0x8;
#[no_mangle]
pub unsafe extern "C" fn exynosautov920_ufs_phy_wait_cdr_lock(phy: *mut phy, lane: u8) -> c_int {
