...
//! Source: drivers/phy/samsung/phy-exynos7-ufs.c
#![no_std]
...
pub const EXYNOS7_EMBEDDED_COMBO_PHY_CTRL: c_uint = 0x720;
pub const EXYNOS7_EMBEDDED_COMBO_PHY_CTRL_MASK: c_uint = 0x1;

pub const EXYNOS7_EMBEDDED_COMBO_PHY_CDR_LOCK_STATUS: c_uint = 0x5e;
