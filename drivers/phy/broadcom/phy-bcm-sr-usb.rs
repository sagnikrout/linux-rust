...
//! Source: drivers/phy/broadcom/phy-bcm-sr-usb.c
#![no_std]
...
pub const HSPLL_PDIV_MASK: c_uint = 0xF;
pub const HSPLL_PDIV_VAL: c_uint = 0x1;
...
pub const PHY_PCTL_MASK: c_uint = 0xffff;
pub const SSPHY_PCTL_VAL: c_uint = 0x0006;
...
pub const PLL_LOCK_RETRY_COUNT: c_int = 1000;
    enum bcm_usb_phy_type {
    USB_HS_PHY,
    USB_SS_PHY,
    };
pub const NUM_BCM_SR_USB_COMBO_PHYS: c_int = 2;
#[no_mangle]
pub unsafe extern "C" fn bcm_usb_reg32_clrbits(addr: *mut void __iomem, clear: u32) {
    static inline void bcm_usb_reg32_clrbits(void __iomem *addr, uint32_t clear)
    {
    writel(readl(addr) & ~clear, addr);
    }
#[no_mangle]
pub unsafe extern "C" fn bcm_usb_reg32_setbits(addr: *mut void __iomem, set: u32) {
    static inline void bcm_usb_reg32_setbits(void __iomem *addr, uint32_t set)
    {
    writel(readl(addr) | set, addr);
    }
#[no_mangle]
unsafe extern "C" fn bcm_usb_pll_lock_check(addr: *mut void __iomem, bit: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_usb_ss_phy_init(phy_cfg: *mut bcm_usb_phy_cfg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_usb_hs_phy_init(phy_cfg: *mut bcm_usb_phy_cfg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_usb_phy_reset(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_usb_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(USB_HS_PHY: phy_cfg->type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn bcm_usb_phy_probe(pdev: *mut platform_device) -> c_int {
