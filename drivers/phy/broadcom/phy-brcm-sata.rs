...
//! Source: drivers/phy/broadcom/phy-brcm-sata.c
#![no_std]
...
pub const SATA_PCB_BANK_OFFSET: c_uint = 0x23c;

pub const MAX_PORTS: c_int = 2;
// Register offset between PHYs in PCB space
pub const SATA_PCB_REG_28NM_SPACE_SIZE: c_uint = 0x1000;
// The older SATA PHY registers duplicated per port registers within the map,
// rather than having a separate map per port.
//
pub const SATA_PCB_REG_40NM_SPACE_SIZE: c_uint = 0x10;
// Register offset between PHYs in PHY control space
pub const SATA_PHY_CTRL_REG_28NM_SPACE_SIZE: c_uint = 0x8;
...
#[no_mangle]
unsafe extern "C" fn rxaeq_to_val(m: *const c_char) -> enum brcm_sata_phy_rxaeq_mode {
    static enum brcm_sata_phy_rxaeq_mode rxaeq_to_val(const char *m)
    {
    if (!strcmp(m, "auto"))
    return RXAEQ_MODE_AUTO;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(m, _arg: "manual")) -> else {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcm_sata_port {
    pub portnum: c_int,
    pub phy: *mut phy,
    pub phy_priv: *mut brcm_sata_phy,
    pub ssc_en: bool,
    pub rxaeq_mode: enum brcm_sata_phy_rxaeq_mode,
    pub rxaeq_val: u32,
    pub tx_amplitude_val: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcm_sata_phy {
    pub dev: *mut device,
    pub phy_base: *mut void __iomem,
    pub ctrl_base: *mut void __iomem,
    pub version: enum brcm_sata_phy_version,
    pub phys: [brcm_sata_port; MAX_PORTS],
}
...
#[no_mangle]
unsafe extern "C" fn brcm_sata_phy_rd(port: *mut brcm_sata_port, bank: u32, ofs: u32) -> u32 {
...
pub const STB_FMIN_VAL_DEFAULT: c_uint = 0x3df;
pub const STB_FMAX_VAL_DEFAULT: c_uint = 0x3df;
pub const STB_FMAX_VAL_SSC: c_uint = 0x83;
#[no_mangle]
unsafe extern "C" fn brcm_stb_sata_ssc_init(port: *mut brcm_sata_port) {
...
pub const AEQ_FRC_EQ_VAL_SHIFT: c_int = 2;
pub const AEQ_FRC_EQ_VAL_MASK: c_uint = 0x3f;
#[no_mangle]
unsafe extern "C" fn brcm_stb_sata_rxaeq_init(port: *mut brcm_sata_port) -> c_int {
    static int brcm_stb_sata_rxaeq_init(struct brcm_sata_port *port)
    {
    let mut tmp: u32 = 0, reg = 0;
...
#[no_mangle]
unsafe extern "C" fn brcm_stb_sata_init(port: *mut brcm_sata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_stb_sata_16nm_ssc_init(port: *mut brcm_sata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_stb_sata_16nm_init(port: *mut brcm_sata_port) -> c_int {
    static int brcm_stb_sata_16nm_init(struct brcm_sata_port *port)
    {
    return brcm_stb_sata_16nm_ssc_init(port);
    }
// NS2 SATA PLL1 defaults were characterized by H/W group
pub const NS2_PLL1_ACTRL2_MAGIC: c_uint = 0x1df8;
pub const NS2_PLL1_ACTRL3_MAGIC: c_uint = 0x2b00;
pub const NS2_PLL1_ACTRL4_MAGIC: c_uint = 0x8824;
#[no_mangle]
unsafe extern "C" fn brcm_ns2_sata_init(port: *mut brcm_sata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_nsp_sata_init(port: *mut brcm_sata_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: port->portnum ==) -> else {
...
pub const SR_PLL0_ACTRL6_MAGIC: c_uint = 0xa;
// SR PHY PLL1 registers
pub const SR_PLL1_ACTRL2_MAGIC: c_uint = 0x32;
pub const SR_PLL1_ACTRL3_MAGIC: c_uint = 0x2;
pub const SR_PLL1_ACTRL4_MAGIC: c_uint = 0x3e8;
#[no_mangle]
unsafe extern "C" fn brcm_sr_sata_init(port: *mut brcm_sata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_dsl_sata_init(port: *mut brcm_sata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_sata_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_stb_sata_calibrate(port: *mut brcm_sata_port) {
    static void brcm_stb_sata_calibrate(struct brcm_sata_port *port)
    {
    let mut tmp: u32 = BIT(8);
    brcm_sata_phy_wr(port, RXPMD_REG_BANK, RXPMD_RX_FREQ_MON_CONTROL1,
    ~tmp, tmp);
    }
#[no_mangle]
unsafe extern "C" fn brcm_sata_phy_calibrate(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_sata_phy_probe(pdev: *mut platform_device) -> c_int {
