...
//! Source: drivers/phy/broadcom/phy-bcm-sr-pcie.c
#![no_std]
...
pub const SR_NR_PCIE_PHYS: c_int = 9;

pub const PCIE_PIPEMUX_CFG_OFFSET: c_uint = 0x10c;
pub const PCIE_PIPEMUX_SELECT_STRAP: c_uint = 0xf;
pub const CDRU_STRAP_DATA_LSW_OFFSET: c_uint = 0x5c;
pub const PCIE_PIPEMUX_SHIFT: c_int = 19;
pub const PCIE_PIPEMUX_MASK: c_uint = 0xf;
pub const MHB_MEM_PW_PAXC_OFFSET: c_uint = 0x1c0;
pub const MHB_PWR_ARR_POWERON: c_uint = 0x8;
pub const MHB_PWR_ARR_POWEROK: c_uint = 0x4;
pub const MHB_PWR_POWERON: c_uint = 0x2;
pub const MHB_PWR_POWEROK: c_uint = 0x1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sr_pcie_phy {
    pub core: *mut sr_pcie_phy_core,
    pub index: c_uint,
    pub phy: *mut phy,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sr_pcie_phy_core {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub cdru: *mut regmap,
    pub mhb: *mut regmap,
    pub pipemux: u32,
    pub phys: [sr_pcie_phy; SR_NR_PCIE_PHYS],
}
...
//
#[no_mangle]
unsafe extern "C" fn pipemux_strap_is_valid(pipemux: u32) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn pipemux_strap_read(core: *mut sr_pcie_phy_core) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn pcie_core_is_for_rc(phy: *mut sr_pcie_phy) -> bool {
    static bool pcie_core_is_for_rc(struct sr_pcie_phy *phy)
    {
    struct sr_pcie_phy_core *core = phy.core;
    let mut core_idx: c_uint = phy.index;
    return !!((pipemux_table[core.pipemux] >> core_idx) & 0x1);
    }
#[no_mangle]
unsafe extern "C" fn sr_pcie_phy_init(p: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sr_paxc_phy_init(p: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sr_pcie_phy_probe(pdev: *mut platform_device) -> c_int {
...
// read the PCIe PIPEMUX strap setting
    ...
    ops = &sr_pcie_phy_ops;
    p.phy = devm_phy_create(dev, core::ptr::null_mut(), ops);
    if (IS_ERR(p.phy)) {
