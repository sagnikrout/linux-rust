...
//! Source: drivers/phy/renesas/phy-rcar-gen3-usb2.c
#![no_std]
...
pub const USB2_INT_ENABLE: c_uint = 0x000;
pub const USB2_AHB_BUS_CTR: c_uint = 0x008;
pub const USB2_USBCTR: c_uint = 0x00c;
pub const USB2_REGEN_CG_CTRL: c_uint = 0x104	/* RZ/V2H(P) only */;
pub const USB2_SPD_RSM_TIMSET: c_uint = 0x10c;
pub const USB2_OC_TIMSET: c_uint = 0x110;
pub const USB2_UTMI_CTRL: c_uint = 0x118	/* RZ/V2H(P) only */;
pub const USB2_COMMCTRL: c_uint = 0x600;
pub const USB2_OBINTSTA: c_uint = 0x604;
pub const USB2_OBINTEN: c_uint = 0x608;
pub const USB2_VBCTRL: c_uint = 0x60c;
pub const USB2_LINECTRL1: c_uint = 0x610;
pub const USB2_ADPCTRL: c_uint = 0x630;
// INT_ENABLE

// AHB_BUS_CTR

pub const USB2_AHB_BUS_CTR_MBL_INCR4: c_int = 2;
// USBCTR

// REGEN_CG_CTRL

// SPD_RSM_TIMSET
pub const USB2_SPD_RSM_TIMSET_INIT: c_uint = 0x014e029b;
// OC_TIMSET
pub const USB2_OC_TIMSET_INIT: c_uint = 0x000209ab;
// UTMI_CTRL
pub const USB2_UTMI_CTRL_INIT: c_uint = 0x8000018f;
// COMMCTRL
...
pub const USB2_VBCTRL_VBSTA_DEFAULT: c_int = 2;
...
pub struct rcar_gen3_phy {
    pub phy: *mut phy,
    pub ch: *mut rcar_gen3_chan,
    pub int_enable_bits: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_gen3_chan {
    pub base: *mut void __iomem,
    pub /: *mut *mut *mut device dev; / platform_device's device,
    pub phy_data: *const rcar_gen3_phy_drv_data,
    pub extcon: *mut extcon_dev,
    pub rstc: *mut reset_control,
    pub rphys: [rcar_gen3_phy; NUM_OF_PHYS],
    pub vbus: *mut regulator,
    pub work: work_struct,
    pub /: *mut *mut spinlock_t lock; / protects access to hardware and driver data structure.,
    pub dr_mode: enum usb_dr_mode,
    pub extcon_host: bool,
    pub is_otg_channel: bool,
    pub uses_otg_pins: bool,
    pub otg_internal_reg: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_gen3_phy_drv_data {
    pub phy_usb2_ops: *const phy_ops,
    pub no_adp_ctrl: bool,
    pub init_bus: bool,
    pub utmi_ctrl: bool,
    pub vblvl_ctrl: bool,
    pub obint_enable_bits: u32,
}
...
//
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_set_host_mode(ch: *mut rcar_gen3_chan, host: c_int) {
    static void rcar_gen3_set_host_mode(struct rcar_gen3_chan *ch, int host)
    {
    void __iomem *usb2_base = ch.base;
    let mut val: u32 = readl(usb2_base + USB2_COMMCTRL);
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_set_linectrl(ch: *mut rcar_gen3_chan, dp: c_int, dm: c_int) {
    static void rcar_gen3_set_linectrl(struct rcar_gen3_chan *ch, int dp, int dm)
    {
    void __iomem *usb2_base = ch.base;
    let mut val: u32 = readl(usb2_base + USB2_LINECTRL1);
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_enable_vbus_ctrl(ch: *mut rcar_gen3_chan, vbus: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_control_otg_irq(ch: *mut rcar_gen3_chan, enable: c_int) {
    static void rcar_gen3_control_otg_irq(struct rcar_gen3_chan *ch, int enable)
    {
    void __iomem *usb2_base = ch.base;
    let mut val: u32 = readl(usb2_base + USB2_OBINTEN);
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_init_for_host(ch: *mut rcar_gen3_chan) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_init_for_peri(ch: *mut rcar_gen3_chan) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_init_for_b_host(ch: *mut rcar_gen3_chan) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_init_for_a_peri(ch: *mut rcar_gen3_chan) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_init_from_a_peri_to_a_host(ch: *mut rcar_gen3_chan) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_check_id(ch: *mut rcar_gen3_chan) -> bool {
    static bool rcar_gen3_check_id(struct rcar_gen3_chan *ch)
    {
    if (ch.phy_data.vblvl_ctrl) {
    let mut val: u32 = readl(ch.base + USB2_ADPCTRL);
    let mut vbus_valid: bool = val & USB2_ADPCTRL_VBUSVALID;
    let mut device: bool = val & USB2_ADPCTRL_IDDIG;
    let mut device: return = = vbus_valid;
    }
    if (!ch.uses_otg_pins)
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_device_recognition(ch: *mut rcar_gen3_chan) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_is_host(ch: *mut rcar_gen3_chan) -> bool {
    static bool rcar_gen3_is_host(struct rcar_gen3_chan *ch)
    {
    return !(readl(ch.base + USB2_COMMCTRL) & USB2_COMMCTRL_OTG_PERI);
    }
#[no_mangle]
unsafe extern "C" fn rcar_gen3_get_phy_mode(ch: *mut rcar_gen3_chan) -> enum phy_mode {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_is_any_rphy_initialized(ch: *mut rcar_gen3_chan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_is_any_otg_rphy_initialized(ch: *mut rcar_gen3_chan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_are_all_rphys_power_off(ch: *mut rcar_gen3_chan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_init_otg(ch: *mut rcar_gen3_chan) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_configure_vblvl_ctrl(ch: *mut rcar_gen3_chan) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_irq(irq: c_int, _ch: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_init(p: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_exit(p: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_power_on(p: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_power_off(p: *mut phy) -> c_int {
    ...
    rphy.powered = false;
    if (rcar_gen3_are_all_rphys_power_off(channel)) {
    let mut val: u32 = readl(channel.base + USB2_USBCTR);
    val |= USB2_USBCTR_PLL_RST;
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_get_dr_mode(np: *mut device_node) -> enum usb_dr_mode {
    static enum usb_dr_mode rcar_gen3_get_dr_mode(struct device_node *np)
    {
    let mut candidate: enum usb_dr_mode = USB_DR_MODE_UNKNOWN;
    int i;
//
...
//
    for (i = 0; i < NUM_OF_PHYS; i++) {
    let mut mode: enum usb_dr_mode = of_usb_get_dr_mode_by_phy(np, i);
    if (mode != USB_DR_MODE_UNKNOWN) {
    if (candidate == USB_DR_MODE_UNKNOWN)
    candidate = mode;
#[no_mangle]
pub unsafe extern "C" fn if(mode: candidate !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_reset_assert(data: *mut c_void) {
    static void rcar_gen3_reset_assert(void *data)
    {
    reset_control_assert(data);
    }
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_init_bus(channel: *mut rcar_gen3_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_regulator_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_regulator_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_regulator_is_enabled(rdev: *mut regulator_dev) -> c_int {
    static int rcar_gen3_phy_usb2_regulator_is_enabled(struct regulator_dev *rdev)
    {
    struct rcar_gen3_chan *channel = rdev_get_drvdata(rdev);
    void __iomem *usb2_base = channel.base;
    struct device *dev = channel.dev;
    let mut vbus_ctrl_reg: u32 = USB2_VBCTRL;
    u32 val;
    int ret;
    ret = pm_runtime_resume_and_get(dev);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_vbus_disable_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_vbus_regulator_register(channel: *mut rcar_gen3_chan) -> c_int {
    static int rcar_gen3_phy_usb2_vbus_regulator_register(struct rcar_gen3_chan *channel)
    {
    struct device *dev = channel.dev;
    let mut rcfg: regulator_config = { .dev = dev, };
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    for (i = 0; i < NUM_OF_PHYS; i++) {
    channel.rphys[i].phy = devm_phy_create(dev, core::ptr::null_mut(),
    ...
    mux_state = devm_mux_state_get_optional_selected(dev, core::ptr::null_mut());
    if (IS_ERR(mux_state))
    ...
    channel.vbus = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen3_phy_usb2_resume(dev: *mut device) -> c_int {
