...
//! Source: drivers/phy/amlogic/phy-meson-axg-mipi-dphy.c
#![no_std]
...
//
pub const MIPI_DSI_PHY_CTRL: c_uint = 0x0;
...
// [0]  chan0 power down.
//
pub const MIPI_DSI_CHAN_CTRL: c_uint = 0x4;
...
//
pub const MIPI_DSI_CHAN_STS: c_uint = 0x8;
// [31:24] TCLK_PREPARE.
// [23:16] TCLK_ZERO.
// [15:8]  TCLK_POST.
// [7:0]   TCLK_TRAIL.
//
pub const MIPI_DSI_CLK_TIM: c_uint = 0xc;
// [31:24] THS_PREPARE.
// [23:16] THS_ZERO.
// [15:8]  THS_TRAIL.
// [7:0]   THS_EXIT.
//
pub const MIPI_DSI_HS_TIM: c_uint = 0x10;
// [31:24] tTA_GET.
// [23:16] tTA_GO.
// [15:8]  tTA_SURE.
// [7:0]   tLPX.
//
pub const MIPI_DSI_LP_TIM: c_uint = 0x14;
// wait time to  MIPI DIS analog ready.
pub const MIPI_DSI_ANA_UP_TIM: c_uint = 0x18;
// TINIT.
pub const MIPI_DSI_INIT_TIM: c_uint = 0x1c;
// TWAKEUP.
pub const MIPI_DSI_WAKEUP_TIM: c_uint = 0x20;
// when in RxULPS check state, after the logic enable the analog,
// how long we should wait to check the lP state .
//
pub const MIPI_DSI_LPOK_TIM: c_uint = 0x24;
// Watchdog for RX low power state no finished.
pub const MIPI_DSI_LP_WCHDOG: c_uint = 0x28;
// tMBIAS,  after send power up signals to analog,
// how long we should wait for analog powered up.
//
pub const MIPI_DSI_ANA_CTRL: c_uint = 0x2c;
// [31:8]  reserved for future.
// [7:0]   tCLK_PRE.
//
pub const MIPI_DSI_CLK_TIM1: c_uint = 0x30;
// watchdog for turn around waiting time.
pub const MIPI_DSI_TURN_WCHDOG: c_uint = 0x34;
// When in RxULPS state, how frequency we should to check
// if the TX side out of ULPS state.
//
pub const MIPI_DSI_ULPS_CHECK: c_uint = 0x38;
pub const MIPI_DSI_TEST_CTRL0: c_uint = 0x3c;
pub const MIPI_DSI_TEST_CTRL1: c_uint = 0x40;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct phy_meson_axg_mipi_dphy_priv {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn phy_meson_axg_mipi_dphy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_meson_axg_mipi_dphy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_meson_axg_mipi_dphy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_meson_axg_mipi_dphy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_meson_axg_mipi_dphy_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (ret)
    return ret;
    phy = devm_phy_create(dev, core::ptr::null_mut(), &phy_meson_axg_mipi_dphy_ops);
    if (IS_ERR(phy))
