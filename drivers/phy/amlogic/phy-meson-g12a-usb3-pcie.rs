...
//! Source: drivers/phy/amlogic/phy-meson-g12a-usb3-pcie.c
#![no_std]
...
pub const PHY_R0: c_uint = 0x00;

pub const PHY_R1: c_uint = 0x04;

pub const PHY_R2: c_uint = 0x08;

pub const PHY_R4: c_uint = 0x10;

pub const PHY_R5: c_uint = 0x14;

pub const PCIE_RESET_DELAY: c_int = 500;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct phy_g12a_usb3_pcie_priv {
    pub regmap: *mut regmap,
    pub regmap_cr: *mut regmap,
    pub clk_ref: *mut clk,
...
#[no_mangle]
unsafe extern "C" fn phy_g12a_usb3_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_g12a_usb3_pcie_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_g12a_usb3_pcie_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_g12a_usb3_pcie_reset(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_g12a_usb3_pcie_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_g12a_usb3_pcie_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_g12a_usb3_pcie_probe(pdev: *mut platform_device) -> c_int {
    ...
    priv.regmap_cr = devm_regmap_init(dev, core::ptr::null_mut(), priv,
