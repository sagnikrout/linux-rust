...
//! Source: drivers/phy/st/phy-stm32-usbphyc.c
#![no_std]
...
pub const STM32_USBPHYC_PLL: c_uint = 0x0;
pub const STM32_USBPHYC_MISC: c_uint = 0x8;

pub const STM32_USBPHYC_VERSION: c_uint = 0x3F4;
...
pub const STM32_USBPHYC_MON_SEL_LOCKP: c_uint = 0x1F;
...
pub const PLL_FVCO_MHZ: c_int = 2880;
pub const PLL_INFF_MIN_RATE_HZ: c_int = 19200000;
pub const PLL_INFF_MAX_RATE_HZ: c_int = 38400000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pll_params {
    pub ndiv: u8,
    pub frac: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_usbphyc_phy {
    pub phy: *mut phy,
    pub usbphyc: *mut stm32_usbphyc,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_usbphyc {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub rst: *mut reset_control,
    pub phys: *mut stm32_usbphyc_phy,
    pub nphys: c_int,
    pub vdda1v1: *mut regulator,
    pub vdda1v8: *mut regulator,
    pub n_pll_cons: core::sync::atomic::AtomicI32,
    pub clk48_hw: clk_hw,
    pub switch_setup: c_int,
}

#[no_mangle]
pub unsafe extern "C" fn stm32_usbphyc_set_bits(reg: *mut void __iomem, bits: u32) {
    static inline void stm32_usbphyc_set_bits(void __iomem *reg, u32 bits)
    {
    writel_relaxed(readl_relaxed(reg) | bits, reg);
    }
#[no_mangle]
pub unsafe extern "C" fn stm32_usbphyc_clr_bits(reg: *mut void __iomem, bits: u32) {
    static inline void stm32_usbphyc_clr_bits(void __iomem *reg, u32 bits)
    {
    writel_relaxed(readl_relaxed(reg) & ~bits, reg);
    }
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_regulators_enable(usbphyc: *mut stm32_usbphyc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_regulators_disable(usbphyc: *mut stm32_usbphyc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_pll_init(usbphyc: *mut stm32_usbphyc) -> c_int {
    static int stm32_usbphyc_pll_init(struct stm32_usbphyc *usbphyc)
    {
    struct pll_params pll_params;
    let mut clk_rate: u32 = clk_get_rate(usbphyc.clk);
    u32 ndiv, frac;
    u32 usbphyc_pll;
...
#[no_mangle]
unsafe extern "C" fn __stm32_usbphyc_pll_disable(usbphyc: *mut stm32_usbphyc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_pll_disable(usbphyc: *mut stm32_usbphyc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_pll_enable(usbphyc: *mut stm32_usbphyc) -> c_int {
    static int stm32_usbphyc_pll_enable(struct stm32_usbphyc *usbphyc)
    {
    void __iomem *pll_reg = usbphyc.base + STM32_USBPHYC_PLL;
    let mut pllen: bool = readl_relaxed(pll_reg) & PLLEN;
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_phy_init(phy: *mut phy) -> c_int {
    static int stm32_usbphyc_phy_init(struct phy *phy)
    {
    struct stm32_usbphyc_phy *usbphyc_phy = phy_get_drvdata(phy);
    struct stm32_usbphyc *usbphyc = usbphyc_phy.usbphyc;
    let mut reg_mon: u32 = STM32_USBPHYC_MONITOR(usbphyc_phy.index);
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_phy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_clk48_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_clk48_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_clk48_recalc_rate(hw: *mut clk_hw, parent_rate: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_clk48_unregister(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_clk48_register(usbphyc: *mut stm32_usbphyc) -> c_int {
    ...
    let mut reg: u32 = STM32_USBPHYC_TUNE(index);
    u32 otpcomp, val;
    int ret;
...
//
    ...
    struct stm32_usbphyc_phy *usbphyc_phy = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_probe(pdev: *mut platform_device) -> c_int {
    ...
    usbphyc.clk = devm_clk_get(dev, core::ptr::null_mut());
    ...
    usbphyc.rst = devm_reset_control_get(dev, core::ptr::null_mut());
...
//
    ...
    if (ret == -EPROBE_DEFER)
    goto put_child;
    usbphyc.phys[port].vbus = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn stm32_usbphyc_resume(dev: *mut device) -> int __maybe_unused {
    ...
    static SIMPLE_DEV_PM_OPS(stm32_usbphyc_pm_ops, core::ptr::null_mut(), stm32_usbphyc_resume);
