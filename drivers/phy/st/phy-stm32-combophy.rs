...
//! Source: drivers/phy/st/phy-stm32-combophy.c
#![no_std]
...
pub const SYSCFG_COMBOPHY_CR1: c_uint = 0x4c00;
pub const SYSCFG_COMBOPHY_CR2: c_uint = 0x4c04;
pub const SYSCFG_COMBOPHY_CR4: c_uint = 0x4c0c;
pub const SYSCFG_COMBOPHY_CR5: c_uint = 0x4c10;
pub const SYSCFG_COMBOPHY_SR: c_uint = 0x4c14;
pub const SYSCFG_PCIEPRGCR: c_uint = 0x6080;
// SYSCFG PCIEPRGCR
...
pub const REFCLKSEL_0: c_int = 0;

pub const REFCLDIV_0: c_int = 0;
// SYSCFG CR2

pub const COMBOPHY_MODESEL_PCIE: c_int = 0;
pub const COMBOPHY_MODESEL_USB: c_int = 3;
// SYSCFG CR5

pub const COMBOPHY_SUP_ANA_MPLL_LOOP_CTL: c_uint = 0xc0;

// Required apb/ker clocks first, optional pad last.
    static const char * const combophy_clks[] = {"apb", "ker", "pad"};
pub const APB_CLK: c_int = 0;
pub const KER_CLK: c_int = 1;
pub const PAD_CLK: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_combophy {
    pub phy: *mut phy,
    pub regmap: *mut regmap,
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub phy_reset: *mut reset_control,
    pub clks: [clk_bulk_data; ARRAY_SIZE(combophy_clks)],
    pub num_clks: c_int,
    pub have_pad_clk: bool,
    pub type: c_uint,
    pub is_init: bool,
...
#[no_mangle]
unsafe extern "C" fn stm32_impedance_tune(combophy: *mut stm32_combophy) -> c_int {
    static int stm32_impedance_tune(struct stm32_combophy *combophy)
    {
    let mut imp_size: u8 = ARRAY_SIZE(imp_lookup);
    let mut vswing_size: u8 = ARRAY_SIZE(imp_lookup[0].vswing);
    u8 imp_of, vswing_of;
    let mut max_imp: u32 = imp_lookup[0].microohm;
    let mut min_imp: u32 = imp_lookup[imp_size - 1].microohm;
    u32 max_vswing;
    let mut min_vswing: u32 = imp_lookup[0].vswing[0];
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn stm32_combophy_pll_init(combophy: *mut stm32_combophy) -> c_int {
    ...
    u32 clk_rate;
    struct clk *clk;
    let mut cr1_val: u32 = 0, cr1_mask = 0;
...
#[no_mangle]
unsafe extern "C" fn stm32_combophy_set_mode(combophy: *mut stm32_combophy) -> c_int {
    static int stm32_combophy_set_mode(struct stm32_combophy *combophy)
    {
    let mut type: c_int = combophy.type;
    u32 val;
    switch (type) {
    case PHY_TYPE_PCIE:
...
#[no_mangle]
unsafe extern "C" fn stm32_combophy_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_combophy_resume_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_combophy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_combophy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_combophy_irq_wakeup_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t stm32_combophy_irq_wakeup_handler(int irq, void *dev_id)
    {
    return IRQ_HANDLED;
    }
#[no_mangle]
unsafe extern "C" fn stm32_combophy_get_clocks(combophy: *mut stm32_combophy) -> c_int {
    ...
    if (ret)
    return ret;
    if (combophy.clks[combophy.num_clks].clk != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn stm32_combophy_probe(pdev: *mut platform_device) -> c_int {
    ...
    "No syscfg specified\n");
    combophy.phy = devm_phy_create(dev, core::ptr::null_mut(), &stm32_combophy_phy_data);
    ...
    ret = devm_request_threaded_irq(dev, combophy.irq_wakeup, core::ptr::null_mut(),
