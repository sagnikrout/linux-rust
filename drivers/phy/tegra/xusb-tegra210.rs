...
//! Source: drivers/phy/tegra/xusb-tegra210.c
#![no_std]
...
//
    ...
    ((x) ? (11 + ((x) - 1) * 6) : 0)
pub const FUSE_SKU_CALIB_HS_CURR_LEVEL_PAD_MASK: c_uint = 0x3f;
pub const FUSE_SKU_CALIB_HS_TERM_RANGE_ADJ_SHIFT: c_int = 7;
pub const FUSE_SKU_CALIB_HS_TERM_RANGE_ADJ_MASK: c_uint = 0xf;
pub const FUSE_USB_CALIB_EXT_RPD_CTRL_SHIFT: c_int = 0;
pub const FUSE_USB_CALIB_EXT_RPD_CTRL_MASK: c_uint = 0x1f;
pub const XUSB_PADCTL_USB2_PAD_MUX: c_uint = 0x004;
pub const XUSB_PADCTL_USB2_PAD_MUX_HSIC_PAD_TRK_SHIFT: c_int = 16;
pub const XUSB_PADCTL_USB2_PAD_MUX_HSIC_PAD_TRK_MASK: c_uint = 0x3;
pub const XUSB_PADCTL_USB2_PAD_MUX_HSIC_PAD_TRK_XUSB: c_uint = 0x1;
pub const XUSB_PADCTL_USB2_PAD_MUX_USB2_BIAS_PAD_SHIFT: c_int = 18;
pub const XUSB_PADCTL_USB2_PAD_MUX_USB2_BIAS_PAD_MASK: c_uint = 0x3;
pub const XUSB_PADCTL_USB2_PAD_MUX_USB2_BIAS_PAD_XUSB: c_uint = 0x1;
pub const XUSB_PADCTL_USB2_PORT_CAP: c_uint = 0x008;

pub const XUSB_PADCTL_SS_PORT_MAP: c_uint = 0x014;

pub const XUSB_PADCTL_SS_PORT_MAP_PORT_DISABLED: c_uint = 0x7;
pub const XUSB_PADCTL_ELPG_PROGRAM_0: c_uint = 0x20;
...
pub const XUSB_PADCTL_ELPG_PROGRAM1: c_uint = 0x024;

    (1 << (1 + (x) * 3))

pub const XUSB_PADCTL_USB3_PAD_MUX: c_uint = 0x028;

pub const XUSB_PADCTL_USB2_BATTERY_CHRG_OTGPAD_CTL1_VREG_LEV_SHIFT: c_int = 7;
pub const XUSB_PADCTL_USB2_BATTERY_CHRG_OTGPAD_CTL1_VREG_LEV_MASK: c_uint = 0x3;
pub const XUSB_PADCTL_USB2_BATTERY_CHRG_OTGPAD_CTL1_VREG_LEV_VAL: c_uint = 0x1;

pub const XUSB_PADCTL_USB2_OTG_PAD_CTL0_HS_CURR_LEVEL_SHIFT: c_int = 0;
pub const XUSB_PADCTL_USB2_OTG_PAD_CTL0_HS_CURR_LEVEL_MASK: c_uint = 0x3f;

pub const XUSB_PADCTL_USB2_OTG_PAD_CTL1_RPD_CTRL_SHIFT: c_int = 26;
pub const XUSB_PADCTL_USB2_OTG_PAD_CTL1_RPD_CTRL_MASK: c_uint = 0x1f;
pub const XUSB_PADCTL_USB2_OTG_PAD_CTL1_TERM_RANGE_ADJ_SHIFT: c_int = 3;
pub const XUSB_PADCTL_USB2_OTG_PAD_CTL1_TERM_RANGE_ADJ_MASK: c_uint = 0xf;

pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL0: c_uint = 0x284;

pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL0_HS_DISCON_LEVEL_SHIFT: c_int = 3;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL0_HS_DISCON_LEVEL_MASK: c_uint = 0x7;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL0_HS_DISCON_LEVEL_VAL: c_uint = 0x7;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL0_HS_SQUELCH_LEVEL_SHIFT: c_int = 0;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL0_HS_SQUELCH_LEVEL_MASK: c_uint = 0x7;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL0_HS_SQUELCH_LEVEL_VAL: c_uint = 0x2;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL1: c_uint = 0x288;

pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL1_TRK_DONE_RESET_TIMER_SHIFT: c_int = 19;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL1_TRK_DONE_RESET_TIMER_MASK: c_uint = 0x7f;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL1_TRK_DONE_RESET_TIMER_VAL: c_uint = 0x0a;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL1_TRK_START_TIMER_SHIFT: c_int = 12;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL1_TRK_START_TIMER_MASK: c_uint = 0x7f;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL1_TRK_START_TIMER_VAL: c_uint = 0x1e;

pub const XUSB_PADCTL_HSIC_PAD_CTL1_TX_RTUNEP_SHIFT: c_int = 0;
pub const XUSB_PADCTL_HSIC_PAD_CTL1_TX_RTUNEP_MASK: c_uint = 0xf;

pub const XUSB_PADCTL_HSIC_PAD_CTL2_RX_STROBE_TRIM_SHIFT: c_int = 8;
pub const XUSB_PADCTL_HSIC_PAD_CTL2_RX_STROBE_TRIM_MASK: c_uint = 0xf;
pub const XUSB_PADCTL_HSIC_PAD_CTL2_RX_DATA_TRIM_SHIFT: c_int = 0;
pub const XUSB_PADCTL_HSIC_PAD_CTL2_RX_DATA_TRIM_MASK: c_uint = 0xff;
pub const XUSB_PADCTL_HSIC_PAD_TRK_CTL: c_uint = 0x340;

pub const XUSB_PADCTL_HSIC_PAD_TRK_CTL_TRK_DONE_RESET_TIMER_SHIFT: c_int = 12;
pub const XUSB_PADCTL_HSIC_PAD_TRK_CTL_TRK_DONE_RESET_TIMER_MASK: c_uint = 0x7f;
pub const XUSB_PADCTL_HSIC_PAD_TRK_CTL_TRK_DONE_RESET_TIMER_VAL: c_uint = 0x0a;
pub const XUSB_PADCTL_HSIC_PAD_TRK_CTL_TRK_START_TIMER_SHIFT: c_int = 5;
pub const XUSB_PADCTL_HSIC_PAD_TRK_CTL_TRK_START_TIMER_MASK: c_uint = 0x7f;
pub const XUSB_PADCTL_HSIC_PAD_TRK_CTL_TRK_START_TIMER_VAL: c_uint = 0x1e;
pub const XUSB_PADCTL_HSIC_STRB_TRIM_CONTROL: c_uint = 0x344;
pub const XUSB_PADCTL_UPHY_PLL_P0_CTL1: c_uint = 0x360;
pub const XUSB_PADCTL_UPHY_PLL_CTL1_FREQ_NDIV_SHIFT: c_int = 20;
pub const XUSB_PADCTL_UPHY_PLL_CTL1_FREQ_NDIV_MASK: c_uint = 0xff;
pub const XUSB_PADCTL_UPHY_PLL_CTL1_FREQ_NDIV_USB_VAL: c_uint = 0x19;
pub const XUSB_PADCTL_UPHY_PLL_CTL1_FREQ_NDIV_SATA_VAL: c_uint = 0x1e;
pub const XUSB_PADCTL_UPHY_PLL_CTL1_FREQ_MDIV_SHIFT: c_int = 16;
pub const XUSB_PADCTL_UPHY_PLL_CTL1_FREQ_MDIV_MASK: c_uint = 0x3;

pub const XUSB_PADCTL_UPHY_PLL_CTL1_SLEEP_SHIFT: c_int = 1;
pub const XUSB_PADCTL_UPHY_PLL_CTL1_SLEEP_MASK: c_uint = 0x3;

pub const XUSB_PADCTL_UPHY_PLL_P0_CTL2: c_uint = 0x364;
pub const XUSB_PADCTL_UPHY_PLL_CTL2_CAL_CTRL_SHIFT: c_int = 4;
pub const XUSB_PADCTL_UPHY_PLL_CTL2_CAL_CTRL_MASK: c_uint = 0xffffff;
pub const XUSB_PADCTL_UPHY_PLL_CTL2_CAL_CTRL_VAL: c_uint = 0x136;

pub const XUSB_PADCTL_UPHY_PLL_P0_CTL4: c_uint = 0x36c;

pub const XUSB_PADCTL_UPHY_PLL_CTL4_TXCLKREF_SEL_SHIFT: c_int = 12;
pub const XUSB_PADCTL_UPHY_PLL_CTL4_TXCLKREF_SEL_MASK: c_uint = 0x3;
pub const XUSB_PADCTL_UPHY_PLL_CTL4_TXCLKREF_SEL_USB_VAL: c_uint = 0x2;
pub const XUSB_PADCTL_UPHY_PLL_CTL4_TXCLKREF_SEL_SATA_VAL: c_uint = 0x0;

pub const XUSB_PADCTL_UPHY_PLL_CTL4_REFCLK_SEL_SHIFT: c_int = 4;
pub const XUSB_PADCTL_UPHY_PLL_CTL4_REFCLK_SEL_MASK: c_uint = 0xf;
pub const XUSB_PADCTL_UPHY_PLL_P0_CTL5: c_uint = 0x370;
pub const XUSB_PADCTL_UPHY_PLL_CTL5_DCO_CTRL_SHIFT: c_int = 16;
pub const XUSB_PADCTL_UPHY_PLL_CTL5_DCO_CTRL_MASK: c_uint = 0xff;
pub const XUSB_PADCTL_UPHY_PLL_CTL5_DCO_CTRL_VAL: c_uint = 0x2a;
pub const XUSB_PADCTL_UPHY_PLL_P0_CTL8: c_uint = 0x37c;

pub const XUSB_PADCTL_UPHY_MISC_PAD_CTL1_AUX_RX_IDLE_MODE_SHIFT: c_int = 20;
pub const XUSB_PADCTL_UPHY_MISC_PAD_CTL1_AUX_RX_IDLE_MODE_MASK: c_uint = 0x3;
pub const XUSB_PADCTL_UPHY_MISC_PAD_CTL1_AUX_RX_IDLE_MODE_VAL: c_uint = 0x1;

pub const XUSB_PADCTL_UPHY_PLL_S0_CTL1: c_uint = 0x860;
pub const XUSB_PADCTL_UPHY_PLL_S0_CTL2: c_uint = 0x864;
pub const XUSB_PADCTL_UPHY_PLL_S0_CTL4: c_uint = 0x86c;
pub const XUSB_PADCTL_UPHY_PLL_S0_CTL5: c_uint = 0x870;
pub const XUSB_PADCTL_UPHY_PLL_S0_CTL8: c_uint = 0x87c;
pub const XUSB_PADCTL_UPHY_MISC_PAD_S0_CTL1: c_uint = 0x960;
pub const XUSB_PADCTL_UPHY_MISC_PAD_S0_CTL2: c_uint = 0x964;

pub const XUSB_PADCTL_UPHY_USB3_PAD_ECTL1_TX_TERM_CTRL_SHIFT: c_int = 16;
pub const XUSB_PADCTL_UPHY_USB3_PAD_ECTL1_TX_TERM_CTRL_MASK: c_uint = 0x3;
pub const XUSB_PADCTL_UPHY_USB3_PAD_ECTL1_TX_TERM_CTRL_VAL: c_uint = 0x2;

pub const XUSB_PADCTL_UPHY_USB3_PAD_ECTL2_RX_CTLE_SHIFT: c_int = 0;
pub const XUSB_PADCTL_UPHY_USB3_PAD_ECTL2_RX_CTLE_MASK: c_uint = 0xffff;
pub const XUSB_PADCTL_UPHY_USB3_PAD_ECTL2_RX_CTLE_VAL: c_uint = 0x00fc;

pub const XUSB_PADCTL_UPHY_USB3_PAD_ECTL3_RX_DFE_VAL: c_uint = 0xc0077f1f;

pub const XUSB_PADCTL_UPHY_USB3_PAD_ECTL4_RX_CDR_CTRL_SHIFT: c_int = 16;
pub const XUSB_PADCTL_UPHY_USB3_PAD_ECTL4_RX_CDR_CTRL_MASK: c_uint = 0xffff;
pub const XUSB_PADCTL_UPHY_USB3_PAD_ECTL4_RX_CDR_CTRL_VAL: c_uint = 0x01c7;

pub const XUSB_PADCTL_UPHY_USB3_PAD_ECTL6_RX_EQ_CTRL_H_VAL: c_uint = 0xfcf01368;
pub const XUSB_PADCTL_USB2_VBUS_ID: c_uint = 0xc60;

pub const XUSB_PADCTL_USB2_VBUS_ID_OVERRIDE_SHIFT: c_int = 18;
pub const XUSB_PADCTL_USB2_VBUS_ID_OVERRIDE_MASK: c_uint = 0xf;
pub const XUSB_PADCTL_USB2_VBUS_ID_OVERRIDE_FLOATING: c_int = 8;
pub const XUSB_PADCTL_USB2_VBUS_ID_OVERRIDE_GROUNDED: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra210_xusb_fuse_calibration {
    pub hs_curr_level: [u32; 4],
    pub hs_term_range_adj: u32,
    pub rpd_ctrl: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra210_xusb_padctl_context {
    pub usb2_pad_mux: u32,
    pub usb2_port_cap: u32,
    pub ss_port_map: u32,
    pub usb3_pad_mux: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra210_xusb_padctl {
    pub base: tegra_xusb_padctl,
    pub regmap: *mut regmap,
    pub fuse: tegra210_xusb_fuse_calibration,
    pub context: tegra210_xusb_padctl_context,
}
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb3_lane_map(lane: *mut tegra_xusb_lane) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_pex_uphy_enable(padctl: *mut tegra_xusb_padctl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_pex_uphy_disable(padctl: *mut tegra_xusb_padctl) {
...
// must be called under padctl->lock
#[no_mangle]
unsafe extern "C" fn tegra210_sata_uphy_enable(padctl: *mut tegra_xusb_padctl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_sata_uphy_disable(padctl: *mut tegra_xusb_padctl) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_aux_mux_lp0_clamp_disable(padctl: *mut tegra_xusb_padctl) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_aux_mux_lp0_clamp_enable(padctl: *mut tegra_xusb_padctl) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_uphy_init(padctl: *mut tegra_xusb_padctl) -> c_int {
    ...
    let mut port: c_int = tegra210_usb3_lane_map(lane);
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb3_disable_phy_sleepwalk(lane: *mut tegra_xusb_lane) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb3_enable_phy_wake(lane: *mut tegra_xusb_lane) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb3_disable_phy_wake(lane: *mut tegra_xusb_lane) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb3_phy_remote_wake_detected(lane: *mut tegra_xusb_lane) -> bool {
    static bool tegra210_usb3_phy_remote_wake_detected(struct tegra_xusb_lane *lane)
    {
    struct tegra_xusb_padctl *padctl = lane.pad.padctl;
    let mut index: c_int = tegra210_usb3_lane_map(lane);
    u32 value;
    if (index < 0)
    return false;
    value = padctl_readl(padctl, XUSB_PADCTL_ELPG_PROGRAM_0);
...
#[no_mangle]
unsafe extern "C" fn tegra210_utmi_enable_phy_wake(lane: *mut tegra_xusb_lane) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_utmi_disable_phy_wake(lane: *mut tegra_xusb_lane) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_utmi_phy_remote_wake_detected(lane: *mut tegra_xusb_lane) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra210_hsic_enable_phy_wake(lane: *mut tegra_xusb_lane) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_hsic_disable_phy_wake(lane: *mut tegra_xusb_lane) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_hsic_phy_remote_wake_detected(lane: *mut tegra_xusb_lane) -> bool {
    ...
    let mut port: c_uint = lane.index;
...
#[no_mangle]
unsafe extern "C" fn tegra210_pmc_utmi_disable_phy_sleepwalk(lane: *mut tegra_xusb_lane) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_pmc_hsic_disable_phy_sleepwalk(lane: *mut tegra_xusb_lane) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb2_lane_remove(lane: *mut tegra_xusb_lane) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb2_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb2_phy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb2_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb2_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb2_pad_remove(pad: *mut tegra_xusb_pad) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_hsic_lane_remove(lane: *mut tegra_xusb_lane) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_hsic_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_hsic_phy_exit(phy: *mut phy) -> c_int {
    static int tegra210_hsic_phy_exit(struct phy *phy)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tegra210_hsic_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_hsic_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_hsic_pad_remove(pad: *mut tegra_xusb_pad) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_uphy_lane_iddq_enable(lane: *mut tegra_xusb_lane) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_uphy_lane_iddq_disable(lane: *mut tegra_xusb_lane) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb3_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb3_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_pcie_lane_remove(lane: *mut tegra_xusb_lane) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_pcie_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_pcie_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_pcie_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_pcie_pad_remove(pad: *mut tegra_xusb_pad) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_sata_lane_remove(lane: *mut tegra_xusb_lane) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_sata_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_sata_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_sata_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_sata_pad_remove(pad: *mut tegra_xusb_pad) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb2_port_enable(port: *mut tegra_xusb_port) -> c_int {
    static int tegra210_usb2_port_enable(struct tegra_xusb_port *port)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tegra210_usb2_port_disable(port: *mut tegra_xusb_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_hsic_port_enable(port: *mut tegra_xusb_port) -> c_int {
    static int tegra210_hsic_port_enable(struct tegra_xusb_port *port)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tegra210_hsic_port_disable(port: *mut tegra_xusb_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_usb3_port_enable(port: *mut tegra_xusb_port) -> c_int {
    static int tegra210_usb3_port_enable(struct tegra_xusb_port *port)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tegra210_usb3_port_disable(port: *mut tegra_xusb_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_utmi_port_reset(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_xusb_padctl_remove(padctl: *mut tegra_xusb_padctl) {
    static void tegra210_xusb_padctl_remove(struct tegra_xusb_padctl *padctl)
    {
    }
#[no_mangle]
unsafe extern "C" fn tegra210_xusb_padctl_save(padctl: *mut tegra_xusb_padctl) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_xusb_padctl_restore(padctl: *mut tegra_xusb_padctl) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_xusb_padctl_suspend_noirq(padctl: *mut tegra_xusb_padctl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_xusb_padctl_resume_noirq(padctl: *mut tegra_xusb_padctl) -> c_int {
