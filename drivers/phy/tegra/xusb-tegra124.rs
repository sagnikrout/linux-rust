...
//! Source: drivers/phy/tegra/xusb-tegra124.c
#![no_std]
...
pub const FUSE_SKU_CALIB_HS_IREF_CAP_SHIFT: c_int = 13;
pub const FUSE_SKU_CALIB_HS_IREF_CAP_MASK: c_uint = 0x3;
pub const FUSE_SKU_CALIB_HS_SQUELCH_LEVEL_SHIFT: c_int = 11;
pub const FUSE_SKU_CALIB_HS_SQUELCH_LEVEL_MASK: c_uint = 0x3;
...
pub const XUSB_PADCTL_USB2_PORT_CAP_PORT_CAP_MASK: c_uint = 0x3;
pub const XUSB_PADCTL_USB2_PORT_CAP_DISABLED: c_uint = 0x0;
pub const XUSB_PADCTL_USB2_PORT_CAP_HOST: c_uint = 0x1;
pub const XUSB_PADCTL_USB2_PORT_CAP_DEVICE: c_uint = 0x2;
pub const XUSB_PADCTL_USB2_PORT_CAP_OTG: c_uint = 0x3;
pub const XUSB_PADCTL_SS_PORT_MAP: c_uint = 0x014;

pub const XUSB_PADCTL_SS_PORT_MAP_PORT_MAP_MASK: c_uint = 0x7;
...
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL2_CDR_CNTL_SHIFT: c_int = 24;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL2_CDR_CNTL_MASK: c_uint = 0xff;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL2_CDR_CNTL_VAL: c_uint = 0x24;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL2_RX_EQ_Z_SHIFT: c_int = 16;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL2_RX_EQ_Z_MASK: c_uint = 0x3f;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL2_RX_EQ_G_SHIFT: c_int = 8;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL2_RX_EQ_G_MASK: c_uint = 0x3f;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL2_RX_EQ_SHIFT: c_int = 8;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL2_RX_EQ_MASK: c_uint = 0xffff;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL2_RX_EQ_VAL: c_uint = 0xf070;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL2_RX_WANDER_SHIFT: c_int = 4;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL2_RX_WANDER_MASK: c_uint = 0xf;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL2_RX_WANDER_VAL: c_uint = 0xf;

pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL4_DFE_CNTL_TAP_SHIFT: c_int = 24;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL4_DFE_CNTL_TAP_MASK: c_uint = 0x1f;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL4_DFE_CNTL_AMP_SHIFT: c_int = 16;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL4_DFE_CNTL_AMP_MASK: c_uint = 0x7f;
pub const XUSB_PADCTL_IOPHY_USB3_PAD_CTL4_DFE_CNTL_VAL: c_uint = 0x002008ee;

    0x0f8 + (x) * 4)
pub const XUSB_PADCTL_IOPHY_MISC_PAD_CTL2_SPARE_IN_SHIFT: c_int = 28;
pub const XUSB_PADCTL_IOPHY_MISC_PAD_CTL2_SPARE_IN_MASK: c_uint = 0x3;
pub const XUSB_PADCTL_IOPHY_MISC_PAD_CTL2_SPARE_IN_VAL: c_uint = 0x1;

    0x11c + (x) * 4)

    0x128 + (x) * 4)
pub const XUSB_PADCTL_IOPHY_MISC_PAD_CTL6_MISC_OUT_SHIFT: c_int = 24;
pub const XUSB_PADCTL_IOPHY_MISC_PAD_CTL6_MISC_OUT_G_Z_MASK: c_uint = 0x3f;
pub const XUSB_PADCTL_IOPHY_MISC_PAD_CTL6_MISC_OUT_TAP_MASK: c_uint = 0x1f;
pub const XUSB_PADCTL_IOPHY_MISC_PAD_CTL6_MISC_OUT_AMP_MASK: c_uint = 0x7f;
pub const XUSB_PADCTL_IOPHY_MISC_PAD_CTL6_MISC_OUT_SEL_SHIFT: c_int = 16;
pub const XUSB_PADCTL_IOPHY_MISC_PAD_CTL6_MISC_OUT_SEL_MASK: c_uint = 0xff;
pub const XUSB_PADCTL_IOPHY_MISC_PAD_CTL6_MISC_OUT_SEL_G_Z: c_uint = 0x21;
pub const XUSB_PADCTL_IOPHY_MISC_PAD_CTL6_MISC_OUT_SEL_TAP: c_uint = 0x32;
pub const XUSB_PADCTL_IOPHY_MISC_PAD_CTL6_MISC_OUT_SEL_AMP: c_uint = 0x33;
pub const XUSB_PADCTL_IOPHY_MISC_PAD_CTL6_MISC_OUT_SEL_CTLE_Z: c_uint = 0x48;
pub const XUSB_PADCTL_IOPHY_MISC_PAD_CTL6_MISC_OUT_SEL_LATCH_G_Z: c_uint = 0xa1;

pub const XUSB_PADCTL_USB2_OTG_PAD_CTL0_LS_RSLEW_SHIFT: c_int = 14;
pub const XUSB_PADCTL_USB2_OTG_PAD_CTL0_LS_RSLEW_MASK: c_uint = 0x3;

pub const XUSB_PADCTL_USB2_OTG_PAD_CTL0_HS_SLEW_SHIFT: c_int = 6;
pub const XUSB_PADCTL_USB2_OTG_PAD_CTL0_HS_SLEW_MASK: c_uint = 0x3f;
pub const XUSB_PADCTL_USB2_OTG_PAD_CTL0_HS_SLEW_VAL: c_uint = 0x0e;
...
pub const XUSB_PADCTL_USB2_OTG_PAD_CTL1_HS_IREF_CAP_SHIFT: c_int = 9;
pub const XUSB_PADCTL_USB2_OTG_PAD_CTL1_HS_IREF_CAP_MASK: c_uint = 0x3;
pub const XUSB_PADCTL_USB2_OTG_PAD_CTL1_TERM_RANGE_ADJ_SHIFT: c_int = 3;
pub const XUSB_PADCTL_USB2_OTG_PAD_CTL1_TERM_RANGE_ADJ_MASK: c_uint = 0x7;

pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL0: c_uint = 0x0b8;

pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL0_HS_DISCON_LEVEL_SHIFT: c_int = 2;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL0_HS_DISCON_LEVEL_MASK: c_uint = 0x7;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL0_HS_DISCON_LEVEL_VAL: c_uint = 0x5;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL0_HS_SQUELCH_LEVEL_SHIFT: c_int = 0;
pub const XUSB_PADCTL_USB2_BIAS_PAD_CTL0_HS_SQUELCH_LEVEL_MASK: c_uint = 0x3;

pub const XUSB_PADCTL_HSIC_PAD_CTL0_TX_RSLEWN_SHIFT: c_int = 12;
pub const XUSB_PADCTL_HSIC_PAD_CTL0_TX_RSLEWN_MASK: c_uint = 0x7;
pub const XUSB_PADCTL_HSIC_PAD_CTL0_TX_RSLEWP_SHIFT: c_int = 8;
pub const XUSB_PADCTL_HSIC_PAD_CTL0_TX_RSLEWP_MASK: c_uint = 0x7;
pub const XUSB_PADCTL_HSIC_PAD_CTL0_TX_RTUNEN_SHIFT: c_int = 4;
pub const XUSB_PADCTL_HSIC_PAD_CTL0_TX_RTUNEN_MASK: c_uint = 0x7;
pub const XUSB_PADCTL_HSIC_PAD_CTL0_TX_RTUNEP_SHIFT: c_int = 0;
pub const XUSB_PADCTL_HSIC_PAD_CTL0_TX_RTUNEP_MASK: c_uint = 0x7;

pub const XUSB_PADCTL_HSIC_PAD_CTL2_RX_STROBE_TRIM_SHIFT: c_int = 4;
pub const XUSB_PADCTL_HSIC_PAD_CTL2_RX_STROBE_TRIM_MASK: c_uint = 0x7;
pub const XUSB_PADCTL_HSIC_PAD_CTL2_RX_DATA_TRIM_SHIFT: c_int = 0;
pub const XUSB_PADCTL_HSIC_PAD_CTL2_RX_DATA_TRIM_MASK: c_uint = 0x7;
pub const XUSB_PADCTL_HSIC_STRB_TRIM_CONTROL: c_uint = 0x0e0;
pub const XUSB_PADCTL_HSIC_STRB_TRIM_CONTROL_STRB_TRIM_MASK: c_uint = 0x1f;
pub const XUSB_PADCTL_USB3_PAD_MUX: c_uint = 0x134;

pub const XUSB_PADCTL_IOPHY_PLL_S0_CTL1: c_uint = 0x138;

pub const XUSB_PADCTL_IOPHY_PLL_S0_CTL1_PLL0_REFCLK_NDIV_SHIFT: c_int = 20;
pub const XUSB_PADCTL_IOPHY_PLL_S0_CTL1_PLL0_REFCLK_NDIV_MASK: c_uint = 0x3;

pub const XUSB_PADCTL_IOPHY_PLL_S0_CTL2: c_uint = 0x13c;
pub const XUSB_PADCTL_IOPHY_PLL_S0_CTL2_PLL1_CP_CNTL_SHIFT: c_int = 20;
pub const XUSB_PADCTL_IOPHY_PLL_S0_CTL2_PLL1_CP_CNTL_MASK: c_uint = 0xf;
pub const XUSB_PADCTL_IOPHY_PLL_S0_CTL2_PLL0_CP_CNTL_SHIFT: c_int = 16;
pub const XUSB_PADCTL_IOPHY_PLL_S0_CTL2_PLL0_CP_CNTL_MASK: c_uint = 0xf;

pub const XUSB_PADCTL_IOPHY_PLL_S0_CTL2_XDIGCLK_SEL_SHIFT: c_int = 0;
pub const XUSB_PADCTL_IOPHY_PLL_S0_CTL2_XDIGCLK_SEL_MASK: c_uint = 0x7;
pub const XUSB_PADCTL_IOPHY_PLL_S0_CTL3: c_uint = 0x140;

pub const XUSB_PADCTL_IOPHY_MISC_PAD_S0_CTL1: c_uint = 0x148;

pub const XUSB_PADCTL_IOPHY_MISC_PAD_S0_CTL2: c_uint = 0x14c;
pub const XUSB_PADCTL_IOPHY_MISC_PAD_S0_CTL5: c_uint = 0x158;
pub const XUSB_PADCTL_IOPHY_MISC_PAD_S0_CTL6: c_uint = 0x15c;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra124_xusb_fuse_calibration {
    pub hs_curr_level: [u32; 3],
    pub hs_iref_cap: u32,
    pub hs_term_range_adj: u32,
    pub hs_squelch_level: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra124_xusb_padctl {
    pub base: tegra_xusb_padctl,
    pub fuse: tegra124_xusb_fuse_calibration,
}
...
#[no_mangle]
unsafe extern "C" fn tegra124_xusb_padctl_enable(padctl: *mut tegra_xusb_padctl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_xusb_padctl_disable(padctl: *mut tegra_xusb_padctl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_usb2_lane_remove(lane: *mut tegra_xusb_lane) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_usb2_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_usb2_phy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_usb2_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_usb2_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_usb2_pad_remove(pad: *mut tegra_xusb_pad) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_ulpi_lane_remove(lane: *mut tegra_xusb_lane) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_ulpi_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_ulpi_phy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_ulpi_phy_power_on(phy: *mut phy) -> c_int {
    static int tegra124_ulpi_phy_power_on(struct phy *phy)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tegra124_ulpi_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_ulpi_pad_remove(pad: *mut tegra_xusb_pad) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_hsic_lane_remove(lane: *mut tegra_xusb_lane) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_hsic_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_hsic_phy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_hsic_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_hsic_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_hsic_pad_remove(pad: *mut tegra_xusb_pad) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_pcie_lane_remove(lane: *mut tegra_xusb_lane) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_pcie_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_pcie_phy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_pcie_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_pcie_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_pcie_pad_remove(pad: *mut tegra_xusb_pad) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_sata_lane_remove(lane: *mut tegra_xusb_lane) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_sata_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_sata_phy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_sata_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_sata_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_sata_pad_remove(pad: *mut tegra_xusb_pad) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_usb2_port_enable(port: *mut tegra_xusb_port) -> c_int {
    static int tegra124_usb2_port_enable(struct tegra_xusb_port *port)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tegra124_usb2_port_disable(port: *mut tegra_xusb_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_ulpi_port_enable(port: *mut tegra_xusb_port) -> c_int {
    static int tegra124_ulpi_port_enable(struct tegra_xusb_port *port)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tegra124_ulpi_port_disable(port: *mut tegra_xusb_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_hsic_port_enable(port: *mut tegra_xusb_port) -> c_int {
    static int tegra124_hsic_port_enable(struct tegra_xusb_port *port)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tegra124_hsic_port_disable(port: *mut tegra_xusb_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_usb3_port_enable(port: *mut tegra_xusb_port) -> c_int {
    static int tegra124_usb3_port_enable(struct tegra_xusb_port *port)
    {
    struct tegra_xusb_usb3_port *usb3 = to_usb3_port(port);
    struct tegra_xusb_padctl *padctl = port.padctl;
    struct tegra_xusb_lane *lane = usb3.base.lane;
    let mut index: c_uint = port.index, offset;
    u32 value;
...
#[no_mangle]
unsafe extern "C" fn tegra124_usb3_port_disable(port: *mut tegra_xusb_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_xusb_padctl_remove(padctl: *mut tegra_xusb_padctl) {
