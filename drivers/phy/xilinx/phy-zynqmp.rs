...
//! Source: drivers/phy/xilinx/phy-zynqmp.c
#![no_std]
...
pub const L0_TX_ANA_TM_18: c_uint = 0x0048;
pub const L0_TX_ANA_TM_118: c_uint = 0x01d8;

// DN Resistor calibration code parameters
pub const L0_TXPMA_ST_3: c_uint = 0x0b0c;
pub const L0_DN_CALIB_CODE: c_uint = 0x3f;
// PMA control parameters
pub const L0_TXPMD_TM_45: c_uint = 0x0cb4;
pub const L0_TXPMD_TM_48: c_uint = 0x0cc0;

// PCS control parameters
pub const L0_TM_DIG_6: c_uint = 0x106c;
pub const L0_TM_DIS_DESCRAMBLE_DECODER: c_uint = 0x0f;
pub const L0_TX_DIG_61: c_uint = 0x00f4;

// PLL Test Mode register parameters
pub const L0_TM_PLL_DIG_37: c_uint = 0x2094;
pub const L0_TM_COARSE_CODE_LIMIT: c_uint = 0x10;
// PLL SSC step size offsets
pub const L0_PLL_SS_STEPS_0_LSB: c_uint = 0x2368;
pub const L0_PLL_SS_STEPS_1_MSB: c_uint = 0x236c;
pub const L0_PLL_SS_STEP_SIZE_0_LSB: c_uint = 0x2370;
pub const L0_PLL_SS_STEP_SIZE_1: c_uint = 0x2374;
pub const L0_PLL_SS_STEP_SIZE_2: c_uint = 0x2378;
pub const L0_PLL_SS_STEP_SIZE_3_MSB: c_uint = 0x237c;
pub const L0_PLL_STATUS_READ_1: c_uint = 0x23e4;
// SSC step size parameters
pub const STEP_SIZE_0_MASK: c_uint = 0xff;
pub const STEP_SIZE_1_MASK: c_uint = 0xff;
pub const STEP_SIZE_2_MASK: c_uint = 0xff;
pub const STEP_SIZE_3_MASK: c_uint = 0x3;
pub const STEP_SIZE_SHIFT: c_int = 8;
pub const FORCE_STEP_SIZE: c_uint = 0x10;
pub const FORCE_STEPS: c_uint = 0x20;
pub const STEPS_0_MASK: c_uint = 0xff;
pub const STEPS_1_MASK: c_uint = 0x07;
// Reference clock selection parameters

pub const L0_REF_CLK_SEL_MASK: c_uint = 0x9f;
// Calibration digital logic parameters
pub const L3_TM_CALIB_DIG19: c_uint = 0xec4c;
pub const L3_CALIB_DONE_STATUS: c_uint = 0xef14;
pub const L3_TM_CALIB_DIG18: c_uint = 0xec48;
pub const L3_TM_CALIB_DIG19_NSW: c_uint = 0x07;
pub const L3_TM_CALIB_DIG18_NSW: c_uint = 0xe0;
pub const L3_TM_OVERRIDE_NSW_CODE: c_uint = 0x20;
pub const L3_CALIB_DONE: c_uint = 0x02;
pub const L3_NSW_SHIFT: c_int = 5;
pub const L3_NSW_PIPE_SHIFT: c_int = 4;
pub const L3_NSW_CALIB_SHIFT: c_int = 3;
pub const PHY_REG_OFFSET: c_uint = 0x4000;
//
// Global Registers
//
// Refclk selection parameters

pub const PLL_FREQ_MASK: c_uint = 0x1f;
pub const PLL_STATUS_LOCKED: c_uint = 0x10;
// Inter Connect Matrix parameters
pub const ICM_CFG0: c_uint = 0x10010;
pub const ICM_CFG1: c_uint = 0x10014;
pub const ICM_CFG0_L0_MASK: c_uint = 0x07;
pub const ICM_CFG0_L1_MASK: c_uint = 0x70;
pub const ICM_CFG1_L2_MASK: c_uint = 0x07;
pub const ICM_CFG2_L3_MASK: c_uint = 0x70;
pub const ICM_CFG_SHIFT: c_int = 4;
// Inter Connect Matrix allowed protocols
pub const ICM_PROTOCOL_PD: c_uint = 0x0;
pub const ICM_PROTOCOL_PCIE: c_uint = 0x1;
pub const ICM_PROTOCOL_SATA: c_uint = 0x2;
pub const ICM_PROTOCOL_USB: c_uint = 0x3;
pub const ICM_PROTOCOL_DP: c_uint = 0x4;
pub const ICM_PROTOCOL_SGMII: c_uint = 0x5;
...
pub const TM_CMN_RST: c_uint = 0x10018;
pub const TM_CMN_RST_EN: c_uint = 0x1;
pub const TM_CMN_RST_SET: c_uint = 0x2;
pub const TM_CMN_RST_MASK: c_uint = 0x3;
// Bus width parameters
pub const TX_PROT_BUS_WIDTH: c_uint = 0x10040;
pub const RX_PROT_BUS_WIDTH: c_uint = 0x10044;
pub const PROT_BUS_WIDTH_10: c_uint = 0x0;
pub const PROT_BUS_WIDTH_20: c_uint = 0x1;
pub const PROT_BUS_WIDTH_40: c_uint = 0x2;

// Number of GT lanes
pub const NUM_LANES: c_int = 4;
// SIOU SATA control register
pub const SATA_CONTROL_OFFSET: c_uint = 0x0100;
// Total number of controllers
pub const CONTROLLERS_PER_LANE: c_int = 5;
// Timeout values
pub const TIMEOUT_US: c_int = 1000;
// Lane 0/1/2/3 offset
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xpsgtr_phy {
    pub phy: *mut phy,
    pub instance: u8,
    pub lane: u8,
    pub protocol: u8,
    pub skip_phy_init: bool,
    pub dev: *mut xpsgtr_dev,
    pub refclk: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xpsgtr_dev {
    pub dev: *mut device,
    pub serdes: *mut void __iomem,
    pub siou: *mut void __iomem,
    pub /: *mut *mut mutex gtr_mutex; / mutex for locking,
    pub phys: [xpsgtr_phy; NUM_LANES],
    pub clk: [*mut clk; NUM_LANES],
    pub tx_term_fix: bool,
    pub saved_icm_cfg0: c_uint,
    pub saved_icm_cfg1: c_uint,
...
//
#[no_mangle]
pub unsafe extern "C" fn xpsgtr_read(gtr_dev: *mut xpsgtr_dev, reg: u32) -> u32 {
    static inline u32 xpsgtr_read(struct xpsgtr_dev *gtr_dev, u32 reg)
    {
    return readl(gtr_dev.serdes + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn xpsgtr_write(gtr_dev: *mut xpsgtr_dev, reg: u32, value: u32) {
    ...
    u32 clr, u32 set)
    {
    let mut value: u32 = xpsgtr_read(gtr_dev, reg);
    value &= ~clr;
    value |= set;
    xpsgtr_write(gtr_dev, reg, value);
    }
#[no_mangle]
pub unsafe extern "C" fn xpsgtr_read_phy(gtr_phy: *mut xpsgtr_phy, reg: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn xpsgtr_save_lane_regs(gtr_dev: *mut xpsgtr_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn xpsgtr_restore_lane_regs(gtr_dev: *mut xpsgtr_dev) {
...
#[no_mangle]
unsafe extern "C" fn xpsgtr_wait_pll_lock(phy: *mut phy) -> c_int {
    static int xpsgtr_wait_pll_lock(struct phy *phy)
    {
    struct xpsgtr_phy *gtr_phy = phy_get_drvdata(phy);
    struct xpsgtr_dev *gtr_dev = gtr_phy.dev;
    let mut timeout: c_uint = TIMEOUT_US;
    let mut protocol: u8 = gtr_phy.protocol;
    int ret;
...
//
    ...
    got_phy:
    while (1) {
    let mut reg: u32 = xpsgtr_read_phy(gtr_phy, L0_PLL_STATUS_READ_1);
...
// Allow an error of 100 ppm
    let mut error: c_ulong = ssc_lookup[i].refclk_rate / 10000;
...
#[no_mangle]
unsafe extern "C" fn xpsgtr_configure_pll(gtr_phy: *mut xpsgtr_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xpsgtr_lane_set_protocol(gtr_phy: *mut xpsgtr_phy) {
...
#[no_mangle]
unsafe extern "C" fn xpsgtr_phy_init_dp(gtr_phy: *mut xpsgtr_phy) {
...
#[no_mangle]
unsafe extern "C" fn xpsgtr_phy_init_sata(gtr_phy: *mut xpsgtr_phy) {
...
#[no_mangle]
unsafe extern "C" fn xpsgtr_phy_init_sgmii(gtr_phy: *mut xpsgtr_phy) {
    static void xpsgtr_phy_init_sgmii(struct xpsgtr_phy *gtr_phy)
    {
    struct xpsgtr_dev *gtr_dev = gtr_phy.dev;
    let mut mask: u32 = PROT_BUS_WIDTH_MASK(gtr_phy.lane);
    let mut val: u32 = PROT_BUS_WIDTH_10 << PROT_BUS_WIDTH_SHIFT(gtr_phy.lane);
...
//
#[no_mangle]
unsafe extern "C" fn xpsgtr_phy_init_required(gtr_phy: *mut xpsgtr_phy) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn xpsgtr_phy_tx_term_fix(gtr_phy: *mut xpsgtr_phy) -> c_int {
    static int xpsgtr_phy_tx_term_fix(struct xpsgtr_phy *gtr_phy)
    {
    struct xpsgtr_dev *gtr_dev = gtr_phy.dev;
    let mut timeout: u32 = TIMEOUT_US;
    u32 nsw;
...
// Clear Test Mode reset
    ...
    do {
    let mut reg: u32 = xpsgtr_read(gtr_dev, L3_CALIB_DONE_STATUS);
...
#[no_mangle]
unsafe extern "C" fn xpsgtr_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xpsgtr_phy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xpsgtr_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xpsgtr_phy_configure(phy: *mut phy, opts: *mut union phy_configure_opts) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xpsgtr_status_read(seq: *mut seq_file, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xpsgtr_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xpsgtr_runtime_resume(dev: *mut device) -> c_int {
...
// Update the skip_phy_init for all gtr_phy instances.
    ...
    xpsgtr_runtime_resume, core::ptr::null_mut());
//
// Probe & Platform Driver
//
#[no_mangle]
unsafe extern "C" fn xpsgtr_get_ref_clocks(gtr_dev: *mut xpsgtr_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xpsgtr_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xpsgtr_remove(pdev: *mut platform_device) {
