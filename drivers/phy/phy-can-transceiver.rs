...
//! Source: drivers/phy/phy-can-transceiver.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct can_transceiver_data {
    pub flags: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct can_transceiver_phy {
    pub generic_phy: *mut phy,
    pub silent_gpio: *mut gpio_desc,
    pub standby_gpio: *mut gpio_desc,
    pub enable_gpio: *mut gpio_desc,
    pub priv: *mut can_transceiver_priv,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct can_transceiver_priv {
    pub mux_state: *mut mux_state,
    pub num_ch: c_int,
    pub __counted_by(num_ch): can_transceiver_phy can_transceiver_phy[],
}

// Power on function
#[no_mangle]
unsafe extern "C" fn can_transceiver_phy_power_on(phy: *mut phy) -> c_int {
...
// Power off function
#[no_mangle]
unsafe extern "C" fn can_transceiver_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn can_transceiver_phy_probe(pdev: *mut platform_device) -> c_int {
    ...
    mux_state = devm_mux_state_get_optional(dev, core::ptr::null_mut());
    if (IS_ERR(mux_state))
    ...
    phy = devm_phy_create(dev, core::ptr::null_mut(), &can_transceiver_phy_ops);
    if (IS_ERR(phy)) {
