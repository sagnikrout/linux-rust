...
//! Source: drivers/phy/rockchip/phy-rockchip-inno-csidphy.c
#![no_std]
...
// GRF
pub const RK1808_GRF_PD_VI_CON_OFFSET: c_uint = 0x0430;
pub const RK3326_GRF_PD_VI_CON_OFFSET: c_uint = 0x0430;
pub const RK3368_GRF_SOC_CON6_OFFSET: c_uint = 0x0418;
pub const RK3568_GRF_VI_CON0: c_uint = 0x0340;
pub const RK3568_GRF_VI_CON1: c_uint = 0x0344;
pub const RK3588_CSIDPHY_GRF_CON0: c_uint = 0x0000;
// PHY
pub const CSIDPHY_CTRL_LANE_ENABLE: c_uint = 0x00;

// not present on all variants
pub const CSIDPHY_CTRL_PWRCTL: c_uint = 0x04;

pub const CSIDPHY_CTRL_DIG_RST: c_uint = 0x80;
pub const CSIDPHY_CTRL_DIG_RST_UNDEFINED: c_uint = 0x1e;

// offset after ths_settle_offset
pub const CSIDPHY_CLK_THS_SETTLE: c_int = 0;

// offset after calib_offset
pub const CSIDPHY_CLK_CALIB_EN: c_int = 0;

// Configure the count time of the THS-SETTLE by protocol.
pub const RK1808_CSIDPHY_CLK_WR_THS_SETTLE: c_uint = 0x160;
pub const RK3326_CSIDPHY_CLK_WR_THS_SETTLE: c_uint = 0x100;
pub const RK3368_CSIDPHY_CLK_WR_THS_SETTLE: c_uint = 0x100;
pub const RK3568_CSIDPHY_CLK_WR_THS_SETTLE: c_uint = 0x160;
// Calibration reception enable
pub const RK1808_CSIDPHY_CLK_CALIB_EN: c_uint = 0x168;
pub const RK3568_CSIDPHY_CLK_CALIB_EN: c_uint = 0x168;
pub const CSIDPHY_LANE_CLK_3_PHASE: c_uint = 0x38;

pub const CSIDPHY_CLK_PHASE_DEFAULT: c_int = 3;
pub const RESETS_MAX: c_int = 2;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dphy_drv_data {
    pub pwrctl_offset: c_int,
    pub ths_settle_offset: c_int,
    pub calib_offset: c_int,
    pub hsfreq_ranges: *const hsfreq_range,
    pub num_hsfreq_ranges: c_int,
    pub grf_regs: *const dphy_reg,
    pub resets: *const *const c_char,
    pub resets_num: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_inno_csidphy {
    pub dev: *mut device,
    pub phy_base: *mut void __iomem,
    pub pclk: *mut clk,
    pub grf: *mut regmap,
    pub resets: [reset_control_bulk_data; RESETS_MAX],
    pub resets_num: c_uint,
    pub drv_data: *const dphy_drv_data,
...
#[no_mangle]
unsafe extern "C" fn rockchip_inno_csidphy_power_on(phy: *mut phy) -> c_int {
    static int rockchip_inno_csidphy_power_on(struct phy *phy)
    {
    struct rockchip_inno_csidphy *priv = phy_get_drvdata(phy);
    const struct dphy_drv_data *drv_data = priv.drv_data;
    let mut data_rate_mbps: u64 = HZ_TO_MHZ(priv.config.hs_clk_rate);
    u32 val;
    int ret, i;
...
#[no_mangle]
unsafe extern "C" fn rockchip_inno_csidphy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_inno_csidphy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_inno_csidphy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_inno_csidphy_probe(pdev: *mut platform_device) -> c_int {
    ...
    phy = devm_phy_create(dev, core::ptr::null_mut(), &rockchip_inno_csidphy_ops);
    if (IS_ERR(phy)) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_inno_csidphy_remove(pdev: *mut platform_device) {
