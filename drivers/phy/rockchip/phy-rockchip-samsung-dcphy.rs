...
//! Source: drivers/phy/rockchip/phy-rockchip-samsung-dcphy.c
#![no_std]
...
pub const BIAS_CON0: c_uint = 0x0000;

pub const BIAS_CON1: c_uint = 0x0004;
...
//
pub const BIAS_CON2: c_uint = 0x0008;

pub const BIAS_CON4: c_uint = 0x0010;

pub const PLL_CON0: c_uint = 0x0100;

pub const PLL_CON1: c_uint = 0x0104;
pub const PLL_CON2: c_uint = 0x0108;

pub const PLL_CON3: c_uint = 0x010c;

pub const PLL_CON4: c_uint = 0x0110;

pub const PLL_CON5: c_uint = 0x0114;

pub const PLL_CON6: c_uint = 0x0118;
pub const PLL_CON7: c_uint = 0x011c;

pub const PLL_CON8: c_uint = 0x0120;

pub const PLL_STAT0: c_uint = 0x0140;

pub const DPHY_MC_GNR_CON0: c_uint = 0x0300;

pub const DPHY_MC_GNR_CON1: c_uint = 0x0304;

pub const DPHY_MC_ANA_CON0: c_uint = 0x0308;

pub const DPHY_MC_ANA_CON1: c_uint = 0x030c;
pub const DPHY_MC_ANA_CON2: c_uint = 0x0310;

pub const DPHY_MC_TIME_CON0: c_uint = 0x0330;

pub const DPHY_MC_TIME_CON1: c_uint = 0x0334;

pub const DPHY_MC_TIME_CON2: c_uint = 0x0338;

pub const DPHY_MC_TIME_CON3: c_uint = 0x033c;

pub const DPHY_MC_TIME_CON4: c_uint = 0x0340;

pub const DPHY_MC_DESKEW_CON0: c_uint = 0x0350;

pub const COMBO_MD0_GNR_CON0: c_uint = 0x0400;
pub const COMBO_MD0_GNR_CON1: c_uint = 0x0404;
pub const COMBO_MD0_ANA_CON0: c_uint = 0x0408;
pub const COMBO_MD0_ANA_CON1: c_uint = 0x040c;
pub const COMBO_MD0_ANA_CON2: c_uint = 0x0410;
pub const COMBO_MD0_TIME_CON0: c_uint = 0x0430;
pub const COMBO_MD0_TIME_CON1: c_uint = 0x0434;
pub const COMBO_MD0_TIME_CON2: c_uint = 0x0438;
pub const COMBO_MD0_TIME_CON3: c_uint = 0x043c;
pub const COMBO_MD0_TIME_CON4: c_uint = 0x0440;
pub const COMBO_MD0_DATA_CON0: c_uint = 0x0444;
pub const COMBO_MD1_GNR_CON0: c_uint = 0x0500;
pub const COMBO_MD1_GNR_CON1: c_uint = 0x0504;
pub const COMBO_MD1_ANA_CON0: c_uint = 0x0508;
pub const COMBO_MD1_ANA_CON1: c_uint = 0x050c;
pub const COMBO_MD1_ANA_CON2: c_uint = 0x0510;
pub const COMBO_MD1_TIME_CON0: c_uint = 0x0530;
pub const COMBO_MD1_TIME_CON1: c_uint = 0x0534;
pub const COMBO_MD1_TIME_CON2: c_uint = 0x0538;
pub const COMBO_MD1_TIME_CON3: c_uint = 0x053c;
pub const COMBO_MD1_TIME_CON4: c_uint = 0x0540;
pub const COMBO_MD1_DATA_CON0: c_uint = 0x0544;
pub const COMBO_MD2_GNR_CON0: c_uint = 0x0600;
pub const COMBO_MD2_GNR_CON1: c_uint = 0x0604;

pub const COMBO_MD2_TIME_CON0: c_uint = 0x0630;
pub const COMBO_MD2_TIME_CON1: c_uint = 0x0634;
pub const COMBO_MD2_TIME_CON2: c_uint = 0x0638;
pub const COMBO_MD2_TIME_CON3: c_uint = 0x063c;
pub const COMBO_MD2_TIME_CON4: c_uint = 0x0640;
pub const COMBO_MD2_DATA_CON0: c_uint = 0x0644;
pub const DPHY_MD3_GNR_CON0: c_uint = 0x0700;
pub const DPHY_MD3_GNR_CON1: c_uint = 0x0704;

pub const DPHY_MD3_TIME_CON0: c_uint = 0x0730;
pub const DPHY_MD3_TIME_CON1: c_uint = 0x0734;
pub const DPHY_MD3_TIME_CON2: c_uint = 0x0738;
pub const DPHY_MD3_TIME_CON3: c_uint = 0x073c;
pub const DPHY_MD3_TIME_CON4: c_uint = 0x0740;
pub const DPHY_MD3_DATA_CON0: c_uint = 0x0744;

// MIPI_CDPHY_GRF registers
pub const MIPI_DCPHY_GRF_CON0: c_uint = 0x0000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hs_drv_res_cfg {
    pub clk_hs_drv_up_ohm: enum hs_drv_res_ohm,
    pub clk_hs_drv_down_ohm: enum hs_drv_res_ohm,
    pub data_hs_drv_up_ohm: enum hs_drv_res_ohm,
    pub data_hs_drv_down_ohm: enum hs_drv_res_ohm,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct samsung_mipi_dcphy_plat_data {
    pub dphy_hs_drv_res_cfg: *const hs_drv_res_cfg,
    pub dphy_tx_max_lane_kbps: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct samsung_mipi_dcphy {
    pub dev: *mut device,
    pub ref_clk: *mut clk,
    pub pclk: *mut clk,
    pub regmap: *mut regmap,
    pub grf_regmap: *mut regmap,
    pub m_phy_rst: *mut reset_control,
    pub s_phy_rst: *mut reset_control,
    pub apb_rst: *mut reset_control,
    pub grf_apb_rst: *mut reset_control,
    pub lanes: c_uint,
    pub phy: *mut phy,
    pub type: u8,
    pub pdata: *const samsung_mipi_dcphy_plat_data,
    struct {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct samsung_mipi_dphy_timing {
    pub max_lane_mbps: c_uint,
    pub clk_prepare: u8,
    pub clk_zero: u8,
    pub clk_post: u8,
    pub clk_trail_eot: u8,
    pub hs_prepare: u8,
    pub hs_zero: u8,
    pub hs_trail_eot: u8,
    pub lpx: u8,
...
#[no_mangle]
unsafe extern "C" fn samsung_mipi_dcphy_bias_block_enable(samsung: *mut samsung_mipi_dcphy) {
...
#[no_mangle]
unsafe extern "C" fn samsung_mipi_dphy_lane_enable(samsung: *mut samsung_mipi_dcphy) {
...
#[no_mangle]
unsafe extern "C" fn samsung_mipi_dphy_lane_disable(samsung: *mut samsung_mipi_dcphy) {
...
#[no_mangle]
unsafe extern "C" fn samsung_mipi_dcphy_pll_configure(samsung: *mut samsung_mipi_dcphy) {
...
#[no_mangle]
unsafe extern "C" fn samsung_mipi_dcphy_pll_enable(samsung: *mut samsung_mipi_dcphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn samsung_mipi_dcphy_pll_disable(samsung: *mut samsung_mipi_dcphy) {
    ...
    let mut lane_mbps: c_uint = div64_ul(samsung.pll.rate, USEC_PER_SEC);
    unsigned int i;
    ...
    {
    let mut max_fout: u32 = samsung.pdata.dphy_tx_max_lane_kbps;
...
// scaler = best_scaler;
    ...
    let mut lane_hs_rate: c_uint = div64_ul(samsung.pll.rate, USEC_PER_SEC);
...
#[no_mangle]
unsafe extern "C" fn samsung_mipi_dphy_power_on(samsung: *mut samsung_mipi_dcphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn samsung_mipi_dcphy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn samsung_mipi_dcphy_power_off(phy: *mut phy) -> c_int {
...
// CPHY part to be implemented later
    ...
    u8 *mfr, u8 *mrr)
    {
    let mut fin: c_ulong = div64_ul(clk_get_rate(samsung.ref_clk), MSEC_PER_SEC);
    let mut prediv: u16 = samsung.pll.prediv;
    let mut fbdiv: u16 = samsung.pll.fbdiv;
    u16 min_mfr, max_mfr;
    u16 _mfr, best_mfr = 0;
...
// mrr = best_mrr & 0x3f;
    ...
    {
    let mut prate: c_ulong = clk_get_rate(samsung.ref_clk);
    unsigned long fout;
    let mut scaler: u8 = 0, mfr = 0, mrr = 0;
    let mut fbdiv: u16 = 0;
    let mut prediv: u8 = 1;
    let mut dsm: c_int = 0;
    int ret;
...
//
    ...
    {
    struct samsung_mipi_dcphy *samsung = phy_get_drvdata(phy);
    let mut target_rate: c_ulonglong = opts.mipi_dphy.hs_clk_rate;
...
#[no_mangle]
unsafe extern "C" fn samsung_mipi_dcphy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn samsung_mipi_dcphy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn samsung_mipi_dcphy_probe(pdev: *mut platform_device) -> c_int {
    ...
    samsung.phy = devm_phy_create(dev, core::ptr::null_mut(), &samsung_mipi_dcphy_ops);
...
#[no_mangle]
unsafe extern "C" fn samsung_mipi_dcphy_runtime_suspend(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn samsung_mipi_dcphy_runtime_resume(dev: *mut device) -> __maybe_unused int {
    ...
    samsung_mipi_dcphy_runtime_resume, core::ptr::null_mut())
    };
