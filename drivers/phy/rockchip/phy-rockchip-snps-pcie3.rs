...
//! Source: drivers/phy/rockchip/phy-rockchip-snps-pcie3.c
#![no_std]
...
// Register for RK3568
pub const GRF_PCIE30PHY_CON1: c_uint = 0x4;
pub const GRF_PCIE30PHY_CON6: c_uint = 0x18;
pub const GRF_PCIE30PHY_CON9: c_uint = 0x24;

pub const GRF_PCIE30PHY_STATUS0: c_uint = 0x80;

// Register for RK3588
pub const PHP_GRF_PCIESEL_CON: c_uint = 0x100;
pub const RK3588_PCIE3PHY_GRF_CMN_CON0: c_uint = 0x0;
pub const RK3588_PCIE3PHY_GRF_PHY0_STATUS1: c_uint = 0x904;
pub const RK3588_PCIE3PHY_GRF_PHY1_STATUS1: c_uint = 0xa04;
pub const RK3588_PCIE3PHY_GRF_PHY0_LN0_CON1: c_uint = 0x1004;
pub const RK3588_PCIE3PHY_GRF_PHY0_LN1_CON1: c_uint = 0x1104;
pub const RK3588_PCIE3PHY_GRF_PHY1_LN0_CON1: c_uint = 0x2004;
pub const RK3588_PCIE3PHY_GRF_PHY1_LN1_CON1: c_uint = 0x2104;

    struct rockchip_p3phy_ops;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_p3phy_priv {
    pub ops: *const rockchip_p3phy_ops,
    pub mmio: *mut void __iomem,
// mode: RC, EP
    pub mode: c_int,
// pcie30_phymode: Aggregation, Bifurcation
    pub pcie30_phymode: c_int,
    pub phy_grf: *mut regmap,
    pub pipe_grf: *mut regmap,
    pub p30phy: *mut reset_control,
    pub phy: *mut phy,
    pub clks: *mut clk_bulk_data,
    pub num_clks: c_int,
    pub num_lanes: c_int,
    pub lanes: [u32; 4],
    pub rx_cmn_refclk_mode: [u32; 4],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_p3phy_ops {
    pub priv): *mut *mut int (phy_init)(struct rockchip_p3phy_priv,
}

#[no_mangle]
unsafe extern "C" fn rockchip_p3phy_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_p3phy_rk3568_init(priv: *mut rockchip_p3phy_priv) -> c_int {
    static int rockchip_p3phy_rk3568_init(struct rockchip_p3phy_priv *priv)
    {
    struct phy *phy = priv.phy;
    let mut bifurcation: bool = false;
    int ret;
    u32 reg;
...
#[no_mangle]
unsafe extern "C" fn rockchip_p3phy_rk3588_init(priv: *mut rockchip_p3phy_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_p3phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_p3phy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_p3phy_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (!priv)
    return -ENOMEM;
    priv.mmio = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
    if (IS_ERR(priv.mmio)) {
    ...
    priv.pipe_grf = core::ptr::null_mut();
    }
...
//
    ...
    priv.phy = devm_phy_create(dev, core::ptr::null_mut(), &rockchip_p3phy_ops);
    if (IS_ERR(priv.phy)) {
