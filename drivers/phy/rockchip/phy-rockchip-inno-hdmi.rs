...
//! Source: drivers/phy/rockchip/phy-rockchip-inno-hdmi.c
#![no_std]
...
pub const RK3228_PRE_PLL_PCLK_DIV_B_SHIFT: c_int = 5;
...
// REG: 0xa5
pub const RK3328_PRE_PLL_PCLK_DIV_B_SHIFT: c_int = 5;

// REG: 0xa6
pub const RK3328_PRE_PLL_PCLK_DIV_C_SHIFT: c_int = 5;
...
pub const RK3328_POST_PLL_POST_DIV_2: c_uint = 0x0;
pub const RK3328_POST_PLL_POST_DIV_4: c_uint = 0x1;
pub const RK3328_POST_PLL_POST_DIV_8: c_uint = 0x3;
// REG: 0xaf
...
pub struct inno_hdmi_phy {
    ...
    pub refpclk: *mut clk,
// platform data
    pub plat_data: *const inno_hdmi_phy_drv_data,
    pub chip_version: c_int,
// clk provider
    pub hw: clk_hw,
    pub phyclk: *mut clk,
    pub pixclock: c_ulong,
    pub tmdsclock: c_ulong,
    pub opts_tmds_char_rate: c_ulong,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pre_pll_config {
    pub pixclock: c_ulong,
    pub tmdsclock: c_ulong,
    pub prediv: u8,
    pub fbdiv: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct inno_hdmi_phy_ops {
    pub inno): *mut *mut int (init)(struct inno_hdmi_phy,
    int (*power_on)(struct inno_hdmi_phy *inno,
    const struct post_pll_config *cfg,
    pub phy_cfg): *const phy_config,
    pub inno): *mut *mut void (power_off)(struct inno_hdmi_phy,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct inno_hdmi_phy_drv_data {
    pub ops: *const inno_hdmi_phy_ops,
    pub clk_ops: *const clk_ops,
    pub phy_cfg_table: *const phy_config,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn inno_write(inno: *mut inno_hdmi_phy, reg: u32, val: u8) {
    static inline void inno_write(struct inno_hdmi_phy *inno, u32 reg, u8 val)
    {
    regmap_write(inno.regmap, reg * 4, val);
    }
#[no_mangle]
pub unsafe extern "C" fn inno_read(inno: *mut inno_hdmi_phy, reg: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_rk3328_hardirq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_rk3328_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_power_off(phy: *mut phy) -> c_int {
    ...
    {
    const struct pre_pll_config *cfg = pre_pll_cfg_table;
    let mut tmdsclock: c_ulong = inno_hdmi_phy_get_tmdsclk(inno, rate);
    for (; cfg.pixclock != 0; cfg++)
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_rk3228_clk_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_rk3228_clk_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_rk3228_clk_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_rk3328_clk_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_rk3328_clk_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_rk3328_clk_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_clk_register(inno: *mut inno_hdmi_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_rk3228_init(inno: *mut inno_hdmi_phy) -> c_int {
...
// Post-PLL update
    ...
    let mut div: c_int = cfg.postdiv / 2 - 1;
    inno_update_bits(inno, 0xe9, RK3228_POST_PLL_POST_DIV_ENABLE,
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_rk3228_power_off(inno: *mut inno_hdmi_phy) {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_rk3328_init(inno: *mut inno_hdmi_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_rk3328_power_off(inno: *mut inno_hdmi_phy) {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_probe(pdev: *mut platform_device) -> c_int {
...
// only the newer rk3328 hdmiphy has an interrupt
    ...
    inno.phy = devm_phy_create(inno.dev, core::ptr::null_mut(), &inno_hdmi_phy_ops);
    if (IS_ERR(inno.phy)) {
...
#[no_mangle]
unsafe extern "C" fn inno_hdmi_phy_remove(pdev: *mut platform_device) {
