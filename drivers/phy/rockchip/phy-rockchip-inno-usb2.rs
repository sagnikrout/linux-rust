...
//! Source: drivers/phy/rockchip/phy-rockchip-inno-usb2.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_chg_det_reg {
    pub cp_det: usb2phy_reg,
    pub dcp_det: usb2phy_reg,
    pub dp_det: usb2phy_reg,
    pub idm_sink_en: usb2phy_reg,
    pub idp_sink_en: usb2phy_reg,
    pub idp_src_en: usb2phy_reg,
    pub rdm_pdwn_en: usb2phy_reg,
    pub vdm_src_en: usb2phy_reg,
    pub vdp_src_en: usb2phy_reg,
    pub opmode: usb2phy_reg,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_usb2phy_port_cfg {
    pub phy_sus: usb2phy_reg,
    pub bvalid_det_en: usb2phy_reg,
    pub bvalid_det_st: usb2phy_reg,
    pub bvalid_det_clr: usb2phy_reg,
    pub disfall_en: usb2phy_reg,
    pub disfall_st: usb2phy_reg,
    pub disfall_clr: usb2phy_reg,
    pub disrise_en: usb2phy_reg,
    pub disrise_st: usb2phy_reg,
    pub disrise_clr: usb2phy_reg,
    pub idfall_det_en: usb2phy_reg,
    pub idfall_det_st: usb2phy_reg,
    pub idfall_det_clr: usb2phy_reg,
    pub idrise_det_en: usb2phy_reg,
    pub idrise_det_st: usb2phy_reg,
    pub idrise_det_clr: usb2phy_reg,
    pub ls_det_en: usb2phy_reg,
    pub ls_det_st: usb2phy_reg,
    pub ls_det_clr: usb2phy_reg,
    pub utmi_avalid: usb2phy_reg,
    pub utmi_bvalid: usb2phy_reg,
    pub utmi_id: usb2phy_reg,
    pub utmi_ls: usb2phy_reg,
    pub utmi_hstdet: usb2phy_reg,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_usb2phy_cfg {
    pub reg: c_uint,
    pub num_ports: c_uint,
    pub rphy): *mut *mut int (phy_tuning)(struct rockchip_usb2phy,
    pub clkout_ctl: usb2phy_reg,
    pub clkout_ctl_phy: usb2phy_reg,
    pub port_cfgs: [rockchip_usb2phy_port_cfg; USB2PHY_NUM_PORTS],
    pub chg_det: rockchip_chg_det_reg,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_usb2phy_port {
    pub phy: *mut phy,
    pub port_id: c_uint,
    pub suspended: bool,
    pub vbus_attached: bool,
    pub host_disconnect: bool,
    pub bvalid_irq: c_int,
    pub id_irq: c_int,
    pub ls_irq: c_int,
    pub otg_mux_irq: c_int,
    pub mutex: mutex,
    pub chg_work: delayed_work,
    pub otg_sm_work: delayed_work,
    pub sm_work: delayed_work,
    pub port_cfg: *const rockchip_usb2phy_port_cfg,
    pub event_nb: notifier_block,
    pub state: enum usb_otg_state,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_usb2phy {
    pub dev: *mut device,
    pub grf: *mut regmap,
    pub phy_base: *mut regmap,
    pub clks: *mut clk_bulk_data,
    pub clk480m: *mut clk,
    pub clk480m_hw: clk_hw,
    pub num_clks: c_int,
    pub phy_reset: *mut reset_control,
    pub chg_state: enum usb_chg_state,
    pub chg_type: enum power_supply_type,
    pub dcd_retries: u8,
    pub edev: *mut extcon_dev,
    pub irq: c_int,
    pub phy_cfg: *const rockchip_usb2phy_cfg,
    pub ports: [rockchip_usb2phy_port; USB2PHY_NUM_PORTS],
}
    ...
    let mut mask: c_uint = GENMASK(reg.bitend, reg.bitstart);
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_reset(rphy: *mut rockchip_usb2phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_clk_bulk_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_clk480m_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_clk480m_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_clk480m_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_clk480m_unregister(data: *mut c_void) {
    ...
    struct clk *refclk = core::ptr::null_mut();
    const char *clk_name;
    int i;
    let mut ret: c_int = 0;
    init.flags = 0;
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_extcon_register(rphy: *mut rockchip_usb2phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_otg_sm_work(work: *mut work_struct) {
...
pub const CHG_DCD_MAX_RETRIES: c_int = 6;

#[no_mangle]
unsafe extern "C" fn rockchip_chg_detect_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_sm_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_linestate_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_bvalid_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_id_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_otg_mux_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_host_disc_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
    ...
    ret = devm_request_threaded_irq(rphy.dev, rport.ls_irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn rockchip_usb2phy_probe(pdev: *mut platform_device) -> c_int {
...
// to prevent out of boundary
    ...
    if (rphy.irq > 0) {
    ret = devm_request_threaded_irq(rphy.dev, rphy.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn rk3128_usb2phy_tuning(rphy: *mut rockchip_usb2phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3528_usb2phy_tuning(rphy: *mut rockchip_usb2phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3576_usb2phy_tuning(rphy: *mut rockchip_usb2phy) -> c_int {
    static int rk3576_usb2phy_tuning(struct rockchip_usb2phy *rphy)
    {
    int ret;
    let mut reg: u32 = rphy.phy_cfg.reg;
...
#[no_mangle]
unsafe extern "C" fn rk3588_usb2phy_tuning(rphy: *mut rockchip_usb2phy) -> c_int {
    static int rk3588_usb2phy_tuning(struct rockchip_usb2phy *rphy)
    {
    int ret;
    let mut usb3otg: bool = false;
//
// utmi_termselect = 1'b1 (en FS terminations)
// utmi_xcvrselect = 2'b01 (FS transceiver)
//
    let mut suspend_cfg: c_int = 0x14;
