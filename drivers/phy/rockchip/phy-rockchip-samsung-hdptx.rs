...
//! Source: drivers/phy/rockchip/phy-rockchip-samsung-hdptx.c
#![no_std]
...
pub const GRF_HDPTX_CON0: c_uint = 0x00;

pub const GRF_HDPTX_STATUS: c_uint = 0x80;
...
pub const LINK_SYMBOL_CLOCK1_2: c_int = 0;
// SB_REG(0102)
...
// LNTOP_REG(0207)
pub const LANE_EN_MASK: c_uint = 0xf;
pub const ALL_LANE_EN: c_uint = 0xf;
// LANE_REG(0301)
...
pub const HDMI14_MAX_RATE: c_int = 340000000;
pub const HDMI20_MAX_RATE: c_int = 600000000;
pub const FRL_3G3L_RATE: c_int = 900000000;
pub const FRL_6G3L_RATE: c_int = 1800000000;
pub const FRL_8G4L_RATE: c_int = 3200000000;
    enum dp_link_rate {
    DP_BW_RBR,
    DP_BW_HBR,
    DP_BW_HBR2,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lcpll_config {
    pub rate: c_ulonglong,
    pub lcvco_mode_en: u8,
    pub pi_en: u8,
    pub clk_en_100m: u8,
    pub pms_mdiv: u8,
    pub pms_mdiv_afc: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tx_drv_ctrl {
    pub tx_drv_lvl_ctrl: u8,
    pub tx_drv_post_lvl_ctrl: u8,
    pub ana_tx_drv_idrv_idn_ctrl: u8,
    pub ana_tx_drv_idrv_iup_ctrl: u8,
    pub ana_tx_drv_accdrv_en: u8,
    pub ana_tx_drv_accdrv_ctrl: u8,
    pub tx_drv_pre_lvl_ctrl: u8,
    pub ana_tx_jeq_en: u8,
    pub tx_jeq_even_ctrl: u8,
    pub tx_jeq_odd_ctrl: u8,
}
...
pub const MAX_HDPTX_PHY_NUM: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rk_hdptx_phy_cfg {
    pub num_phys: c_uint,
    pub phy_ids: [c_uint; MAX_HDPTX_PHY_NUM],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rk_hdptx_hdmi_cfg {
    pub mode: enum phy_hdmi_mode,
    pub rate: c_ulonglong,
    pub bpc: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rk_hdptx_phy {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub grf: *mut regmap,
    pub phy_id: c_int,
    pub phy: *mut phy,
    pub hdmi_cfg: rk_hdptx_hdmi_cfg,
    pub clks: *mut clk_bulk_data,
    pub nr_clks: c_int,
    pub rsts: [reset_control_bulk_data; RST_MAX],
// clk provider
    pub hw: clk_hw,
    pub pll_config_dirty: bool,
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_is_rw_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_pre_power_up(hdptx: *mut rk_hdptx_phy) {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_post_enable_lane(hdptx: *mut rk_hdptx_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_post_enable_pll(hdptx: *mut rk_hdptx_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_disable(hdptx: *mut rk_hdptx_phy) {
    ...
    {
    let mut fout: c_uint = div_u64(rate, 200), fref = 24000;
    let mut k: c_ulong = 0, lc, k_sub, lc_sub;
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_frl_lcpll_cmn_config(hdptx: *mut rk_hdptx_phy) -> c_int {
    static int rk_hdptx_frl_lcpll_cmn_config(struct rk_hdptx_phy *hdptx)
    {
    const struct lcpll_config *cfg = core::ptr::null_mut();
    int i;
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_frl_lcpll_ropll_cmn_config(hdptx: *mut rk_hdptx_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_tmds_ropll_cmn_config(hdptx: *mut rk_hdptx_phy) -> c_int {
    static int rk_hdptx_tmds_ropll_cmn_config(struct rk_hdptx_phy *hdptx)
    {
    const struct ropll_config *cfg = core::ptr::null_mut();
    let mut rc: ropll_config = {0};
    int i;
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_pll_cmn_config(hdptx: *mut rk_hdptx_phy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(FRL_8G4L_RATE: hdptx->hdmi_cfg.rate ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_frl_lcpll_mode_config(hdptx: *mut rk_hdptx_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_tmds_ropll_mode_config(hdptx: *mut rk_hdptx_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_dp_reset(hdptx: *mut rk_hdptx_phy) {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_consumer_get(hdptx: *mut rk_hdptx_phy) -> c_int {
    static int rk_hdptx_phy_consumer_get(struct rk_hdptx_phy *hdptx)
    {
    let mut mode: enum phy_mode = phy_get_mode(hdptx.phy);
    u32 status;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_consumer_put(hdptx: *mut rk_hdptx_phy, force: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_dp_pll_init(hdptx: *mut rk_hdptx_phy) {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_dp_aux_init(hdptx: *mut rk_hdptx_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_power_on(phy: *mut phy) -> c_int {
    static int rk_hdptx_phy_power_on(struct phy *phy)
    {
    struct rk_hdptx_phy *hdptx = phy_get_drvdata(phy);
    let mut mode: enum phy_mode = phy_get_mode(phy);
    int ret, lane;
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_power_off(phy: *mut phy) -> c_int {
    ...
    !rk_hdptx_phy_clk_pll_calc(hdmi_in.tmds_char_rate, core::ptr::null_mut()))
    return -EINVAL;
    if (hdmi_out)
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_configure(phy: *mut phy, opts: *mut union phy_configure_opts) -> c_int {
    ...
    struct rk_hdptx_phy *hdptx = phy_get_drvdata(phy);
    if (mode != PHY_MODE_DP)
    return rk_hdptx_phy_verify_hdmi_config(hdptx, &opts.hdmi, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_clk_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_clk_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_clk_calc_rate_from_pll_cfg(hdptx: *mut rk_hdptx_phy) -> u64 {
...
//
    ...
    req.rate = 0;
#[no_mangle]
pub unsafe extern "C" fn if(PHY_HDMI_MODE_FRL: hdptx->hdmi_cfg.mode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_clk_register(hdptx: *mut rk_hdptx_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hdptx_phy_probe(pdev: *mut platform_device) -> c_int {
...
// find the phy-id from the io address
    ...
    hdptx.phy = devm_phy_create(dev, core::ptr::null_mut(), &rk_hdptx_phy_ops);
    if (IS_ERR(hdptx.phy))
    ...
    rk_hdptx_phy_runtime_resume, core::ptr::null_mut())
    };
