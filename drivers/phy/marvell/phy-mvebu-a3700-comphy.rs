...
//! Source: drivers/phy/marvell/phy-mvebu-a3700-comphy.c
#![no_std]
...
pub const PLL_SET_DELAY_US: c_int = 600;
pub const COMPHY_PLL_SLEEP: c_int = 1000;
pub const COMPHY_PLL_TIMEOUT: c_int = 150000;
// Comphy lane2 indirect access register offset
pub const COMPHY_LANE2_INDIR_ADDR: c_uint = 0x0;
pub const COMPHY_LANE2_INDIR_DATA: c_uint = 0x4;
// SATA and USB3 PHY offset compared to SATA PHY
pub const COMPHY_LANE2_REGS_BASE: c_uint = 0x200;
//
...
// COMPHY registers
pub const COMPHY_POWER_PLL_CTRL: c_uint = 0x01;

pub const COMPHY_KVCO_CAL_CTRL: c_uint = 0x02;

pub const COMPHY_DIG_LOOPBACK_EN: c_uint = 0x23;

pub const COMPHY_SYNC_PATTERN: c_uint = 0x24;

pub const COMPHY_SYNC_MASK_GEN: c_uint = 0x25;

pub const COMPHY_ISOLATION_CTRL: c_uint = 0x26;

pub const COMPHY_GEN2_SET2: c_uint = 0x3e;
...
pub const COMPHY_GEN3_SET2: c_uint = 0x3f;
pub const COMPHY_IDLE_SYNC_EN: c_uint = 0x48;

pub const COMPHY_MISC_CTRL0: c_uint = 0x4F;

pub const COMPHY_SFT_RESET: c_uint = 0x52;

pub const COMPHY_MISC_CTRL1: c_uint = 0x73;

pub const COMPHY_GEN2_SET3: c_uint = 0x112;

// PIPE registers
pub const COMPHY_PIPE_LANE_CFG0: c_uint = 0x180;

pub const COMPHY_PIPE_LANE_CFG1: c_uint = 0x181;

pub const COMPHY_PIPE_LANE_STAT1: c_uint = 0x183;

pub const COMPHY_PIPE_LANE_CFG4: c_uint = 0x188;

pub const COMPHY_PIPE_RST_CLK_CTRL: c_uint = 0x1C1;

pub const COMPHY_PIPE_TEST_MODE_CTRL: c_uint = 0x1C2;

pub const COMPHY_PIPE_CLK_SRC_LO: c_uint = 0x1C3;

pub const COMPHY_PIPE_PWR_MGM_TIM1: c_uint = 0x1D0;
...
//
pub const COMPHY_RESERVED_REG: c_uint = 0x0E;
...
//
pub const COMPHY_PHY_CFG1: c_uint = 0x0;

pub const SERDES_SPEED_1_25_G: c_uint = 0x6;
pub const SERDES_SPEED_3_125_G: c_uint = 0x8;
...
// (used only by SGMII code)
//
pub const COMPHY_PHY_STAT1: c_uint = 0x18;

// PHY Selector
pub const COMPHY_SELECTOR_PHY_REG: c_uint = 0xFC;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvebu_a3700_comphy_conf {
    pub lane: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvebu_a3700_comphy_priv {
    pub comphy_regs: *mut void __iomem,
    pub /: *mut *mut *mut void __iomem lane0_phy_regs; / USB3 and GbE1,
    pub /: *mut *mut *mut void __iomem lane1_phy_regs; / PCIe and GbE0,
    pub /: *mut *mut *mut void __iomem lane2_phy_indirect; / SATA and USB3,
    pub /: *mut *mut spinlock_t lock; / for PHY selector access,
    pub xtal_is_40m: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvebu_a3700_comphy_lane {
    pub priv: *mut mvebu_a3700_comphy_priv,
    pub dev: *mut device,
    pub id: c_uint,
    pub mode: enum phy_mode,
    pub submode: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gbe_phy_init_data_fix {
    pub addr: u16,
    pub value: u16,
}
...
#[no_mangle]
pub unsafe extern "C" fn comphy_reg_set(addr: *mut void __iomem, data: u32, mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn comphy_reg_set16(addr: *mut void __iomem, data: u16, mask: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: lane->id ==) -> else {
    else if (lane.id == 1)
...
#[no_mangle]
pub unsafe extern "C" fn if(0: lane->id ==) -> else {
    else if (lane.id == 0)
...
#[no_mangle]
unsafe extern "C" fn mvebu_a3700_comphy_usb3_power_off(lane: *mut mvebu_a3700_comphy_lane) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_a3700_comphy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_a3700_comphy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_a3700_comphy_probe(pdev: *mut platform_device) -> c_int {
