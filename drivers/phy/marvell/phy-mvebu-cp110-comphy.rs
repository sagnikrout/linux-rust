...
//! Source: drivers/phy/marvell/phy-mvebu-cp110-comphy.c
#![no_std]
...
pub const MVEBU_COMPHY_SELECTOR: c_uint = 0x1140;

pub const MVEBU_COMPHY_PIPE_SELECTOR: c_uint = 0x1144;

pub const MVEBU_COMPHY_SD1_CTRL1: c_uint = 0x1148;

pub const MVEBU_COMPHY_LANES: c_int = 6;
pub const MVEBU_COMPHY_PORTS: c_int = 3;
pub const COMPHY_SIP_POWER_ON: c_uint = 0x82000001;
pub const COMPHY_SIP_POWER_OFF: c_uint = 0x82000002;
//
...
//
pub const COMPHY_FW_POL_OFFSET: c_int = 0;

pub const COMPHY_FW_SPEED_OFFSET: c_int = 2;

pub const COMPHY_FW_SPEED_1250: c_int = 0;
pub const COMPHY_FW_SPEED_3125: c_int = 2;
pub const COMPHY_FW_SPEED_5000: c_int = 3;
pub const COMPHY_FW_SPEED_515625: c_int = 4;
pub const COMPHY_FW_SPEED_103125: c_int = 6;
pub const COMPHY_FW_PORT_OFFSET: c_int = 8;

pub const COMPHY_FW_MODE_OFFSET: c_int = 12;

pub const COMPHY_FW_WIDTH_OFFSET: c_int = 18;
...
pub const COMPHY_FW_MODE_SATA: c_uint = 0x1;
pub const COMPHY_FW_MODE_SGMII: c_uint = 0x2 /* SGMII 1G */;
pub const COMPHY_FW_MODE_2500BASEX: c_uint = 0x3 /* 2500BASE-X */;
pub const COMPHY_FW_MODE_USB3H: c_uint = 0x4;
pub const COMPHY_FW_MODE_USB3D: c_uint = 0x5;
pub const COMPHY_FW_MODE_PCIE: c_uint = 0x6;
pub const COMPHY_FW_MODE_RXAUI: c_uint = 0x7;
pub const COMPHY_FW_MODE_XFI: c_uint = 0x8 /* SFI: 0x9 (is treated like XFI) */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvebu_comphy_conf {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvebu_comphy_priv {
    pub base: *mut void __iomem,
    pub regmap: *mut regmap,
    pub dev: *mut device,
    pub mg_domain_clk: *mut clk,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvebu_comphy_lane {
    pub priv: *mut mvebu_comphy_priv,
    pub id: unsigned,
    pub mode: enum phy_mode,
    pub submode: c_int,
    pub port: c_int,
...
// Ignore PCIe submode: it represents the width
    let mut ignore_submode: bool = (mode == PHY_MODE_PCIE);
...
#[no_mangle]
unsafe extern "C" fn mvebu_comphy_ethernet_init_reset(lane: *mut mvebu_comphy_lane) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_comphy_init_plls(lane: *mut mvebu_comphy_lane) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_comphy_set_mode_sgmii(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_comphy_set_mode_rxaui(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_comphy_set_mode_10gbaser(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_comphy_power_on_legacy(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_comphy_power_on(phy: *mut phy) -> c_int {
    static int mvebu_comphy_power_on(struct phy *phy)
    {
    struct mvebu_comphy_lane *lane = phy_get_drvdata(phy);
    struct mvebu_comphy_priv *priv = lane.priv;
    int fw_mode, fw_speed;
    let mut fw_param: u32 = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mvebu_comphy_power_off_legacy(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_comphy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_comphy_init_clks(priv: *mut mvebu_comphy_priv) -> c_int {
    ...
    priv.mg_domain_clk = core::ptr::null_mut();
    priv.mg_core_clk = core::ptr::null_mut();
    priv.axi_clk = core::ptr::null_mut();
    return ret;
    };
#[no_mangle]
unsafe extern "C" fn mvebu_comphy_disable_unprepare_clks(priv: *mut mvebu_comphy_priv) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_comphy_probe(pdev: *mut platform_device) -> c_int {
