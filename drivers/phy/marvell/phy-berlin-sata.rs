...
//! Source: drivers/phy/marvell/phy-berlin-sata.c
#![no_std]
...
pub const HOST_VSA_ADDR: c_uint = 0x0;
pub const HOST_VSA_DATA: c_uint = 0x4;
pub const PORT_SCR_CTL: c_uint = 0x2c;
pub const PORT_VSR_ADDR: c_uint = 0x78;
pub const PORT_VSR_DATA: c_uint = 0x7c;
pub const CONTROL_REGISTER: c_uint = 0x0;
pub const MBUS_SIZE_CONTROL: c_uint = 0x4;

pub const BG2_PHY_BASE: c_uint = 0x080;
pub const BG2Q_PHY_BASE: c_uint = 0x200;
// register 0x01
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct phy_berlin_priv {
    pub base: *mut void __iomem,
    pub lock: spinlock_t,
    pub clk: *mut clk,
    pub phys: *mut phy_berlin_desc,
    pub nphys: unsigned,
    pub phy_base: u32,
}
...
#[no_mangle]
unsafe extern "C" fn phy_berlin_sata_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_berlin_sata_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_berlin_sata_probe(pdev: *mut platform_device) -> c_int {
    ...
    phy = devm_phy_create(dev, core::ptr::null_mut(), &phy_berlin_sata_ops);
    if (IS_ERR(phy)) {
