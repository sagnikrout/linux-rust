...
//! Source: drivers/phy/marvell/phy-mmp3-usb.c
#![no_std]
...
pub const USB2_PLL_REG0: c_uint = 0x4;
pub const USB2_PLL_REG1: c_uint = 0x8;
pub const USB2_TX_REG0: c_uint = 0x10;
pub const USB2_TX_REG1: c_uint = 0x14;
pub const USB2_TX_REG2: c_uint = 0x18;
pub const USB2_RX_REG0: c_uint = 0x20;
pub const USB2_RX_REG1: c_uint = 0x24;
pub const USB2_RX_REG2: c_uint = 0x28;
pub const USB2_ANA_REG0: c_uint = 0x30;
pub const USB2_ANA_REG1: c_uint = 0x34;
pub const USB2_ANA_REG2: c_uint = 0x38;
pub const USB2_DIG_REG0: c_uint = 0x3C;
pub const USB2_DIG_REG1: c_uint = 0x40;
pub const USB2_DIG_REG2: c_uint = 0x44;
pub const USB2_DIG_REG3: c_uint = 0x48;
pub const USB2_TEST_REG0: c_uint = 0x4C;
pub const USB2_TEST_REG1: c_uint = 0x50;
pub const USB2_TEST_REG2: c_uint = 0x54;
pub const USB2_CHARGER_REG0: c_uint = 0x58;
pub const USB2_OTG_REG0: c_uint = 0x5C;
pub const USB2_PHY_MON0: c_uint = 0x60;
pub const USB2_RESETVE_REG0: c_uint = 0x64;
pub const USB2_ICID_REG0: c_uint = 0x78;
pub const USB2_ICID_REG1: c_uint = 0x7C;
// USB2_PLL_REG0
// This is for Ax stepping
pub const USB2_PLL_FBDIV_SHIFT_MMP3: c_int = 0;

pub const USB2_PLL_REFDIV_SHIFT_MMP3: c_int = 8;

pub const USB2_PLL_VDD12_SHIFT_MMP3: c_int = 12;
pub const USB2_PLL_VDD18_SHIFT_MMP3: c_int = 14;
// This is for B0 stepping
pub const USB2_PLL_FBDIV_SHIFT_MMP3_B0: c_int = 0;
pub const USB2_PLL_REFDIV_SHIFT_MMP3_B0: c_int = 9;
pub const USB2_PLL_VDD18_SHIFT_MMP3_B0: c_int = 14;
pub const USB2_PLL_FBDIV_MASK_MMP3_B0: c_uint = 0x01FF;
pub const USB2_PLL_REFDIV_MASK_MMP3_B0: c_uint = 0x3E00;
pub const USB2_PLL_CAL12_SHIFT_MMP3: c_int = 0;

pub const USB2_PLL_VCOCAL_START_SHIFT_MMP3: c_int = 2;
pub const USB2_PLL_KVCO_SHIFT_MMP3: c_int = 4;

pub const USB2_PLL_ICP_SHIFT_MMP3: c_int = 8;

pub const USB2_PLL_LOCK_BYPASS_SHIFT_MMP3: c_int = 12;
pub const USB2_PLL_PU_PLL_SHIFT_MMP3: c_int = 13;

// USB2_TX_REG0
pub const USB2_TX_IMPCAL_VTH_SHIFT_MMP3: c_int = 8;

pub const USB2_TX_RCAL_START_SHIFT_MMP3: c_int = 13;
// USB2_TX_REG1
pub const USB2_TX_CK60_PHSEL_SHIFT_MMP3: c_int = 0;

pub const USB2_TX_AMP_SHIFT_MMP3: c_int = 4;

pub const USB2_TX_VDD12_SHIFT_MMP3: c_int = 8;

// USB2_TX_REG2
pub const USB2_TX_DRV_SLEWRATE_SHIFT: c_int = 10;
// USB2_RX_REG0
pub const USB2_RX_SQ_THRESH_SHIFT_MMP3: c_int = 4;

pub const USB2_RX_SQ_LENGTH_SHIFT_MMP3: c_int = 10;

// USB2_ANA_REG1
pub const USB2_ANA_PU_ANA_SHIFT_MMP3: c_int = 14;
// USB2_OTG_REG0
pub const USB2_OTG_PU_OTG_SHIFT_MMP3: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mmp3_usb_phy {
    pub phy: *mut phy,
...
#[no_mangle]
unsafe extern "C" fn mmp3_usb_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmp3_usb_phy_calibrate(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmp3_usb_phy_probe(pdev: *mut platform_device) -> c_int {
    ...
    mmp3_usb_phy.phy = devm_phy_create(dev, core::ptr::null_mut(), &mmp3_usb_phy_ops);
