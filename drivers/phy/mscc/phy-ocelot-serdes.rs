...
//! Source: drivers/phy/mscc/phy-ocelot-serdes.c
#![no_std]
...
pub const MCB_S6G_CFG_TIMEOUT: c_int = 50;
#[no_mangle]
unsafe extern "C" fn __serdes_write_mcb_s6g(regmap: *mut regmap, macro: u8, op: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serdes_commit_mcb_s6g(regmap: *mut regmap, macro: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serdes_update_mcb_s6g(regmap: *mut regmap, macro: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serdes_init_s6g(regmap: *mut regmap, serdes: u8, mode: c_int) -> c_int {
...
pub const MCB_S1G_CFG_TIMEOUT: c_int = 50;
#[no_mangle]
unsafe extern "C" fn __serdes_write_mcb_s1g(regmap: *mut regmap, macro: u8, op: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serdes_commit_mcb_s1g(regmap: *mut regmap, macro: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serdes_update_mcb_s1g(regmap: *mut regmap, macro: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serdes_init_s1g(regmap: *mut regmap, serdes: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(SERDES6G_MAX: macro->idx <=) -> else {
