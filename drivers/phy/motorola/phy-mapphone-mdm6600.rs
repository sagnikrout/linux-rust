...
//! Source: drivers/phy/motorola/phy-mapphone-mdm6600.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct phy_mdm6600 {
    pub dev: *mut device,
    pub generic_phy: *mut phy,
    pub phy_provider: *mut phy_provider,
    pub ctrl_gpios: [*mut gpio_desc; PHY_MDM6600_NR_CTRL_LINES],
    pub mode_gpios: *mut gpio_descs,
    pub status_gpios: *mut gpio_descs,
    pub cmd_gpios: *mut gpio_descs,
    pub bootup_work: delayed_work,
    pub status_work: delayed_work,
    pub modem_wake_work: delayed_work,
    pub ack: completion,
    pub /: *mut *mut bool enabled; / mdm6600 phy enabled,
    pub /: *mut *mut bool running; / mdm6600 boot done,
    pub /: *mut *mut bool awake; / mdm6600 respnds on n_gsm,
    pub status: c_int,
}

#[no_mangle]
unsafe extern "C" fn phy_mdm6600_init(x: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_power_on(x: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_power_off(x: *mut phy) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_cmd(ddata: *mut phy_mdm6600, val: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_status(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_irq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_wakeirq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_init_irq(ddata: *mut phy_mdm6600) {
    ...
    if (irq <= 0)
    continue;
    error = devm_request_threaded_irq(dev, irq, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_init_lines(ddata: *mut phy_mdm6600) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_device_power_on(ddata: *mut phy_mdm6600) -> c_int {
...
// Reconfigure mode1 GPIO as input for OOB wake
    ...
    if (wakeirq <= 0)
    return wakeirq;
    error = devm_request_threaded_irq(ddata.dev, wakeirq, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_device_power_off(ddata: *mut phy_mdm6600) {
...
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_deferred_power_on(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_wake_modem(ddata: *mut phy_mdm6600) {
...
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_modem_wake(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    phy_mdm6600_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    ddata.generic_phy = devm_phy_create(ddata.dev, core::ptr::null_mut(), &gpio_usb_ops);
...
#[no_mangle]
unsafe extern "C" fn phy_mdm6600_remove(pdev: *mut platform_device) {
