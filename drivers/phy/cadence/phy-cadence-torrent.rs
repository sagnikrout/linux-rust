...
//! Source: drivers/phy/cadence/phy-cadence-torrent.c
#![no_std]
...
pub const REF_CLK_19_2MHZ: c_int = 19200000;
pub const REF_CLK_25MHZ: c_int = 25000000;
pub const REF_CLK_100MHZ: c_int = 100000000;
pub const REF_CLK_156_25MHZ: c_int = 156250000;
pub const MAX_NUM_LANES: c_int = 4;

pub const POLL_TIMEOUT_US: c_int = 5000;
pub const PLL_LOCK_TIMEOUT: c_int = 100000;

pub const TORRENT_COMMON_CDB_OFFSET: c_uint = 0x0;
    ...
    (0xE000 << (block_offset))
pub const TORRENT_DPTX_PHY_OFFSET: c_uint = 0x0;
//
// register offsets from DPTX PHY register block base (i.e MHDP
// register base + 0x30a00)
//
pub const PHY_AUX_CTRL: c_uint = 0x04;
pub const PHY_RESET: c_uint = 0x20;
pub const PMA_TX_ELEC_IDLE_SHIFT: c_int = 4;
pub const PHY_PMA_XCVR_PLLCLK_EN: c_uint = 0x24;
pub const PHY_PMA_XCVR_PLLCLK_EN_ACK: c_uint = 0x28;
pub const PHY_PMA_XCVR_POWER_STATE_REQ: c_uint = 0x2c;

pub const PMA_XCVR_POWER_STATE_REQ_LN_MASK: c_uint = 0x3FU;
pub const PHY_PMA_XCVR_POWER_STATE_ACK: c_uint = 0x30;
pub const PHY_PMA_CMN_READY: c_uint = 0x34;
//
// register offsets from SD0801 PHY register block base (i.e MHDP
// register base + 0x500000)
//
pub const CMN_SSM_BANDGAP_TMR: c_uint = 0x0021U;
pub const CMN_SSM_BIAS_TMR: c_uint = 0x0022U;
pub const CMN_PLLSM0_PLLPRE_TMR: c_uint = 0x002AU;
pub const CMN_PLLSM0_PLLLOCK_TMR: c_uint = 0x002CU;
pub const CMN_PLLSM1_PLLPRE_TMR: c_uint = 0x0032U;
pub const CMN_PLLSM1_PLLLOCK_TMR: c_uint = 0x0034U;
pub const CMN_CDIAG_CDB_PWRI_OVRD: c_uint = 0x0041U;
pub const CMN_CDIAG_XCVRC_PWRI_OVRD: c_uint = 0x0047U;
pub const CMN_CDIAG_REFCLK_OVRD: c_uint = 0x004CU;
pub const CMN_CDIAG_REFCLK_DRV0_CTRL: c_uint = 0x0050U;
pub const CMN_BGCAL_INIT_TMR: c_uint = 0x0064U;
pub const CMN_BGCAL_ITER_TMR: c_uint = 0x0065U;
pub const CMN_IBCAL_INIT_TMR: c_uint = 0x0074U;
pub const CMN_PLL0_VCOCAL_TCTRL: c_uint = 0x0082U;
pub const CMN_PLL0_VCOCAL_INIT_TMR: c_uint = 0x0084U;
pub const CMN_PLL0_VCOCAL_ITER_TMR: c_uint = 0x0085U;
pub const CMN_PLL0_VCOCAL_REFTIM_START: c_uint = 0x0086U;
pub const CMN_PLL0_VCOCAL_PLLCNT_START: c_uint = 0x0088U;
pub const CMN_PLL0_INTDIV_M0: c_uint = 0x0090U;
pub const CMN_PLL0_FRACDIVL_M0: c_uint = 0x0091U;
pub const CMN_PLL0_FRACDIVH_M0: c_uint = 0x0092U;
pub const CMN_PLL0_HIGH_THR_M0: c_uint = 0x0093U;
pub const CMN_PLL0_DSM_DIAG_M0: c_uint = 0x0094U;
pub const CMN_PLL0_DSM_FBH_OVRD_M0: c_uint = 0x0095U;
pub const CMN_PLL0_DSM_FBL_OVRD_M0: c_uint = 0x0096U;
pub const CMN_PLL0_SS_CTRL1_M0: c_uint = 0x0098U;
pub const CMN_PLL0_SS_CTRL2_M0: c_uint = 0x0099U;
pub const CMN_PLL0_SS_CTRL3_M0: c_uint = 0x009AU;
pub const CMN_PLL0_SS_CTRL4_M0: c_uint = 0x009BU;
pub const CMN_PLL0_LOCK_REFCNT_START: c_uint = 0x009CU;
pub const CMN_PLL0_LOCK_PLLCNT_START: c_uint = 0x009EU;
pub const CMN_PLL0_LOCK_PLLCNT_THR: c_uint = 0x009FU;
pub const CMN_PLL0_INTDIV_M1: c_uint = 0x00A0U;
pub const CMN_PLL0_FRACDIVH_M1: c_uint = 0x00A2U;
pub const CMN_PLL0_HIGH_THR_M1: c_uint = 0x00A3U;
pub const CMN_PLL0_DSM_DIAG_M1: c_uint = 0x00A4U;
pub const CMN_PLL0_SS_CTRL1_M1: c_uint = 0x00A8U;
pub const CMN_PLL0_SS_CTRL2_M1: c_uint = 0x00A9U;
pub const CMN_PLL0_SS_CTRL3_M1: c_uint = 0x00AAU;
pub const CMN_PLL0_SS_CTRL4_M1: c_uint = 0x00ABU;
pub const CMN_PLL1_VCOCAL_TCTRL: c_uint = 0x00C2U;
pub const CMN_PLL1_VCOCAL_INIT_TMR: c_uint = 0x00C4U;
pub const CMN_PLL1_VCOCAL_ITER_TMR: c_uint = 0x00C5U;
pub const CMN_PLL1_VCOCAL_REFTIM_START: c_uint = 0x00C6U;
pub const CMN_PLL1_VCOCAL_PLLCNT_START: c_uint = 0x00C8U;
pub const CMN_PLL1_INTDIV_M0: c_uint = 0x00D0U;
pub const CMN_PLL1_FRACDIVL_M0: c_uint = 0x00D1U;
pub const CMN_PLL1_FRACDIVH_M0: c_uint = 0x00D2U;
pub const CMN_PLL1_HIGH_THR_M0: c_uint = 0x00D3U;
pub const CMN_PLL1_DSM_DIAG_M0: c_uint = 0x00D4U;
pub const CMN_PLL1_DSM_FBH_OVRD_M0: c_uint = 0x00D5U;
pub const CMN_PLL1_DSM_FBL_OVRD_M0: c_uint = 0x00D6U;
pub const CMN_PLL1_SS_CTRL1_M0: c_uint = 0x00D8U;
pub const CMN_PLL1_SS_CTRL2_M0: c_uint = 0x00D9U;
pub const CMN_PLL1_SS_CTRL3_M0: c_uint = 0x00DAU;
pub const CMN_PLL1_SS_CTRL4_M0: c_uint = 0x00DBU;
pub const CMN_PLL1_LOCK_REFCNT_START: c_uint = 0x00DCU;
pub const CMN_PLL1_LOCK_PLLCNT_START: c_uint = 0x00DEU;
pub const CMN_PLL1_LOCK_PLLCNT_THR: c_uint = 0x00DFU;
pub const CMN_TXPUCAL_TUNE: c_uint = 0x0103U;
pub const CMN_TXPUCAL_INIT_TMR: c_uint = 0x0104U;
pub const CMN_TXPUCAL_ITER_TMR: c_uint = 0x0105U;
pub const CMN_TXPDCAL_TUNE: c_uint = 0x010BU;
pub const CMN_TXPDCAL_INIT_TMR: c_uint = 0x010CU;
pub const CMN_TXPDCAL_ITER_TMR: c_uint = 0x010DU;
pub const CMN_RXCAL_INIT_TMR: c_uint = 0x0114U;
pub const CMN_RXCAL_ITER_TMR: c_uint = 0x0115U;
pub const CMN_SD_CAL_INIT_TMR: c_uint = 0x0124U;
pub const CMN_SD_CAL_ITER_TMR: c_uint = 0x0125U;
pub const CMN_SD_CAL_REFTIM_START: c_uint = 0x0126U;
pub const CMN_SD_CAL_PLLCNT_START: c_uint = 0x0128U;
pub const CMN_PDIAG_PLL0_CTRL_M0: c_uint = 0x01A0U;
pub const CMN_PDIAG_PLL0_CLK_SEL_M0: c_uint = 0x01A1U;
pub const CMN_PDIAG_PLL0_CP_PADJ_M0: c_uint = 0x01A4U;
pub const CMN_PDIAG_PLL0_CP_IADJ_M0: c_uint = 0x01A5U;
pub const CMN_PDIAG_PLL0_FILT_PADJ_M0: c_uint = 0x01A6U;
pub const CMN_PDIAG_PLL0_CTRL_M1: c_uint = 0x01B0U;
pub const CMN_PDIAG_PLL0_CLK_SEL_M1: c_uint = 0x01B1U;
pub const CMN_PDIAG_PLL0_CP_PADJ_M1: c_uint = 0x01B4U;
pub const CMN_PDIAG_PLL0_CP_IADJ_M1: c_uint = 0x01B5U;
pub const CMN_PDIAG_PLL0_FILT_PADJ_M1: c_uint = 0x01B6U;
pub const CMN_PDIAG_PLL1_CTRL_M0: c_uint = 0x01C0U;
pub const CMN_PDIAG_PLL1_CLK_SEL_M0: c_uint = 0x01C1U;
pub const CMN_PDIAG_PLL1_CP_PADJ_M0: c_uint = 0x01C4U;
pub const CMN_PDIAG_PLL1_CP_IADJ_M0: c_uint = 0x01C5U;
pub const CMN_PDIAG_PLL1_FILT_PADJ_M0: c_uint = 0x01C6U;
pub const CMN_DIAG_BIAS_OVRD1: c_uint = 0x01E1U;
// PMA TX Lane registers
pub const TX_TXCC_CTRL: c_uint = 0x0040U;
pub const TX_TXCC_CPOST_MULT_00: c_uint = 0x004CU;
pub const TX_TXCC_CPOST_MULT_01: c_uint = 0x004DU;
pub const TX_TXCC_MGNFS_MULT_000: c_uint = 0x0050U;
pub const TX_TXCC_MGNFS_MULT_100: c_uint = 0x0054U;
pub const DRV_DIAG_TX_DRV: c_uint = 0x00C6U;
pub const XCVR_DIAG_PLLDRC_CTRL: c_uint = 0x00E5U;
pub const XCVR_DIAG_HSCLK_SEL: c_uint = 0x00E6U;
pub const XCVR_DIAG_HSCLK_DIV: c_uint = 0x00E7U;
pub const XCVR_DIAG_RXCLK_CTRL: c_uint = 0x00E9U;
pub const XCVR_DIAG_BIDI_CTRL: c_uint = 0x00EAU;
pub const XCVR_DIAG_PSC_OVRD: c_uint = 0x00EBU;
pub const TX_PSC_A0: c_uint = 0x0100U;
pub const TX_PSC_A1: c_uint = 0x0101U;
pub const TX_PSC_A2: c_uint = 0x0102U;
pub const TX_PSC_A3: c_uint = 0x0103U;
pub const TX_RCVDET_ST_TMR: c_uint = 0x0123U;
pub const TX_DIAG_ACYA: c_uint = 0x01E7U;
pub const TX_DIAG_ACYA_HBDC_MASK: c_uint = 0x0001U;
// PMA RX Lane registers
pub const RX_PSC_A0: c_uint = 0x0000U;
pub const RX_PSC_A1: c_uint = 0x0001U;
pub const RX_PSC_A2: c_uint = 0x0002U;
pub const RX_PSC_A3: c_uint = 0x0003U;
pub const RX_PSC_CAL: c_uint = 0x0006U;
pub const RX_SDCAL0_INIT_TMR: c_uint = 0x0044U;
pub const RX_SDCAL0_ITER_TMR: c_uint = 0x0045U;
pub const RX_SDCAL1_INIT_TMR: c_uint = 0x004CU;
pub const RX_SDCAL1_ITER_TMR: c_uint = 0x004DU;
pub const RX_CDRLF_CNFG: c_uint = 0x0080U;
pub const RX_CDRLF_CNFG2: c_uint = 0x0081U;
pub const RX_CDRLF_CNFG3: c_uint = 0x0082U;
pub const RX_SIGDET_HL_FILT_TMR: c_uint = 0x0090U;
pub const RX_REE_GCSM1_CTRL: c_uint = 0x0108U;
pub const RX_REE_GCSM1_EQENM_PH1: c_uint = 0x0109U;
pub const RX_REE_GCSM1_EQENM_PH2: c_uint = 0x010AU;
pub const RX_REE_GCSM2_CTRL: c_uint = 0x0110U;
pub const RX_REE_PERGCSM_CTRL: c_uint = 0x0118U;
pub const RX_REE_PEAK_UTHR: c_uint = 0x0142U;
pub const RX_REE_PEAK_LTHR: c_uint = 0x0143U;
pub const RX_REE_ATTEN_THR: c_uint = 0x0149U;
pub const RX_REE_TAP1_CLIP: c_uint = 0x0171U;
pub const RX_REE_TAP2TON_CLIP: c_uint = 0x0172U;
pub const RX_REE_SMGM_CTRL1: c_uint = 0x0177U;
pub const RX_REE_SMGM_CTRL2: c_uint = 0x0178U;
pub const RX_DIAG_DFE_CTRL: c_uint = 0x01E0U;
pub const RX_DIAG_DFE_AMP_TUNE_2: c_uint = 0x01E2U;
pub const RX_DIAG_DFE_AMP_TUNE_3: c_uint = 0x01E3U;
pub const RX_DIAG_REE_DAC_CTRL: c_uint = 0x01E4U;
pub const RX_DIAG_NQST_CTRL: c_uint = 0x01E5U;
pub const RX_DIAG_SIGDET_TUNE: c_uint = 0x01E8U;
pub const RX_DIAG_PI_RATE: c_uint = 0x01F4U;
pub const RX_DIAG_PI_CAP: c_uint = 0x01F5U;
pub const RX_DIAG_ACYA: c_uint = 0x01FFU;
// PHY PCS common registers
pub const PHY_PIPE_CMN_CTRL1: c_uint = 0x0000U;
pub const PHY_PLL_CFG: c_uint = 0x000EU;
pub const PHY_PIPE_USB3_GEN2_PRE_CFG0: c_uint = 0x0020U;
pub const PHY_PIPE_USB3_GEN2_POST_CFG0: c_uint = 0x0022U;
pub const PHY_PIPE_USB3_GEN2_POST_CFG1: c_uint = 0x0023U;
// PHY PCS lane registers
pub const PHY_PCS_ISO_LINK_CTRL: c_uint = 0x000BU;
// PHY PMA common registers
pub const PHY_PMA_CMN_CTRL1: c_uint = 0x0000U;
pub const PHY_PMA_CMN_CTRL2: c_uint = 0x0001U;
pub const PHY_PMA_PLL_RAW_CTRL: c_uint = 0x0003U;
pub const CDNS_TORRENT_OUTPUT_CLOCKS: c_int = 3;
    ...
    let mut phy_pipe_cmn_ctrl1_0: static struct reg_field = REG_FIELD(PHY_PIPE_CMN_CTRL1, 0, 0);
    static const struct reg_field cmn_cdiag_refclk_ovrd_4 =
    REG_FIELD(CMN_CDIAG_REFCLK_OVRD, 4, 4);
pub const REFCLK_OUT_NUM_CMN_CONFIG: c_int = 4;
...
//
pub const REFCLK0_SHIFT: c_int = 15;

pub const REFCLK1_SHIFT: c_int = 11;

pub const LINK0_SHIFT: c_int = 7;

pub const LINK1_SHIFT: c_int = 3;

pub const SSC_SHIFT: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_torrent_inst {
    pub phy: *mut phy,
    pub mlane: u32,
    pub phy_type: enum cdns_torrent_phy_type,
    pub num_lanes: u32,
    pub lnk_rst: *mut reset_control,
    pub ssc_mode: enum cdns_torrent_ssc_mode,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_torrent_phy {
    pub /: *mut *mut *mut void __iomem base; / DPTX registers base,
    pub /: *mut *mut *mut void __iomem sd_base; / SD0801 registers base,
    pub /: *mut *mut u32 max_bit_rate; / Maximum link bit rate to use (in Mbps),
    pub dp_pll: u32,
    pub protocol_bitmask: u32,
    pub phy_rst: *mut reset_control,
    pub apb_rst: *mut reset_control,
    pub dev: *mut device,
    pub clk: *mut clk,
    pub clk1: *mut clk,
    pub ref_clk_rate: enum cdns_torrent_ref_clk,
    pub ref_clk1_rate: enum cdns_torrent_ref_clk,
    pub phys: [cdns_torrent_inst; MAX_NUM_LANES],
    pub nsubnodes: c_int,
    pub already_configured: c_int,
    pub init_data: *const cdns_torrent_data,
    pub regmap_common_cdb: *mut regmap,
    pub regmap_phy_pcs_common_cdb: *mut regmap,
    pub regmap_phy_pma_common_cdb: *mut regmap,
    pub regmap_tx_lane_cdb: [*mut regmap; MAX_NUM_LANES],
    pub regmap_rx_lane_cdb: [*mut regmap; MAX_NUM_LANES],
    pub regmap_phy_pcs_lane_cdb: [*mut regmap; MAX_NUM_LANES],
    pub regmap_dptx_phy_reg: *mut regmap,
    pub phy_pll_cfg: *mut regmap_field,
    pub phy_pipe_cmn_ctrl1_0: *mut regmap_field,
    pub cmn_cdiag_refclk_ovrd_4: *mut regmap_field,
    pub phy_pma_cmn_ctrl_1: *mut regmap_field,
    pub phy_pma_cmn_ctrl_2: *mut regmap_field,
    pub phy_pma_pll_raw_ctrl: *mut regmap_field,
    pub phy_reset_ctrl: *mut regmap_field,
    pub phy_pcs_iso_link_ctrl_1: [*mut regmap_field; MAX_NUM_LANES],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_torrent_refclk_driver {
    pub hw: clk_hw,
    pub cmn_fields: [*mut regmap_field; REFCLK_OUT_NUM_CMN_CONFIG],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_torrent_derived_refclk {
    pub hw: clk_hw,
    pub phy_pipe_cmn_ctrl1_0: *mut regmap_field,
    pub cmn_cdiag_refclk_ovrd_4: *mut regmap_field,
    pub clk_data: clk_init_data,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_torrent_received_refclk {
    pub hw: clk_hw,
    pub phy_pipe_cmn_ctrl1_0: *mut regmap_field,
    pub cmn_cdiag_refclk_ovrd_4: *mut regmap_field,
    pub clk_data: clk_init_data,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_torrent_vals {
    pub reg_pairs: *const cdns_reg_pairs,
    pub num_regs: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_torrent_vals_entry {
    pub key: u32,
    pub vals: *const cdns_torrent_vals,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_torrent_vals_table {
    pub entries: *const cdns_torrent_vals_entry,
    pub num_entries: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_torrent_data {
    pub block_offset_shift: u8,
    pub reg_offset_shift: u8,
    pub link_cmn_vals_tbl: cdns_torrent_vals_table,
    pub xcvr_diag_vals_tbl: cdns_torrent_vals_table,
    pub pcs_cmn_vals_tbl: cdns_torrent_vals_table,
    pub phy_pma_cmn_vals_tbl: cdns_torrent_vals_table,
    pub cmn_vals_tbl: cdns_torrent_vals_table,
    pub tx_ln_vals_tbl: cdns_torrent_vals_table,
    pub rx_ln_vals_tbl: cdns_torrent_vals_table,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_regmap_cdb_context {
    pub dev: *mut device,
    ...
    {
    int i;
    let mut key: u32 = CDNS_TORRENT_KEY(refclk0, refclk1, link0, link1, ssc);
...
#[no_mangle]
unsafe extern "C" fn cdns_regmap_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
    static int cdns_regmap_write(void *context, unsigned int reg, unsigned int val)
    {
    struct cdns_regmap_cdb_context *ctx = context;
    let mut offset: u32 = reg << ctx.reg_offset_shift;
    writew(val, ctx.base + offset);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn cdns_regmap_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_phy_write(regmap: *mut regmap, offset: u32, val: u32) {
    static void cdns_torrent_phy_write(struct regmap *regmap, u32 offset, u32 val)
    {
    regmap_write(regmap, offset, val);
    }
#[no_mangle]
unsafe extern "C" fn cdns_torrent_phy_read(regmap: *mut regmap, offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_dp_write(regmap: *mut regmap, offset: u32, val: u32) {
    static void cdns_torrent_dp_write(struct regmap *regmap, u32 offset, u32 val)
    {
    regmap_write(regmap, offset, val);
    }
#[no_mangle]
unsafe extern "C" fn cdns_torrent_dp_read(regmap: *mut regmap, offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_dp_wait_pma_cmn_ready(cdns_phy: *mut cdns_torrent_phy) -> c_int {
    ...
    {
    let mut clk_sel_val: c_uint = 0;
    let mut hsclk_div_val: c_uint = 0;
    unsigned int i;
    switch (rate) {
    case 1620:
    clk_sel_val = 0x0f01;
...
#[no_mangle]
pub unsafe extern "C" fn if(CLK_25_MHZ: cdns_phy->ref_clk_rate ==) -> else {
    else if (cdns_phy.ref_clk_rate == CLK_25_MHZ)
// PMA common configuration 25MHz
    cdns_torrent_dp_pma_cmn_vco_cfg_25mhz(cdns_phy, dp.link_rate, dp.ssc);
#[no_mangle]
pub unsafe extern "C" fn if(CLK_100_MHZ: cdns_phy->ref_clk_rate ==) -> else {
...
// Configure lane count as required.
    ...
    int ret;
    struct regmap *regmap = cdns_phy.regmap_dptx_phy_reg;
    let mut lane_mask: u8 = (1 << dp.lanes) - 1;
    let mut pma_tx_elec_idle_mask: u8 = 0;
    let mut clane: u32 = inst.mlane;
    lane_mask <<= clane;
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_phy_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_phy_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_dp_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_derived_refclk_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_derived_refclk_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_derived_refclk_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_derived_refclk_register(cdns_phy: *mut cdns_torrent_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_received_refclk_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_received_refclk_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_received_refclk_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_received_refclk_register(cdns_phy: *mut cdns_torrent_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_refclk_driver_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_refclk_driver_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_refclk_driver_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_refclk_driver_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_refclk_driver_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_refclk_driver_register(cdns_phy: *mut cdns_torrent_phy) -> c_int {
...
// Enable Derived reference clock as default
    ...
    return devm_regmap_init(dev, core::ptr::null_mut(), ctx, config);
    }
#[no_mangle]
unsafe extern "C" fn cdns_torrent_dp_regfield_init(cdns_phy: *mut cdns_torrent_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_regfield_init(cdns_phy: *mut cdns_torrent_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_dp_regmap_init(cdns_phy: *mut cdns_torrent_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_regmap_init(cdns_phy: *mut cdns_torrent_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_phy_init(phy: *mut phy) -> c_int {
    ...
    let mut ref_clk: enum cdns_torrent_ref_clk = cdns_phy.ref_clk_rate;
    struct cdns_torrent_inst *inst = phy_get_drvdata(phy);
    let mut phy_type: enum cdns_torrent_phy_type = inst.phy_type;
    const struct cdns_torrent_vals *phy_pma_cmn_vals;
    let mut ssc: enum cdns_torrent_ssc_mode = inst.ssc_mode;
...
// PMA RX lane registers configurations
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn cdns_torrent_phy_configure_multilink(cdns_phy: *mut cdns_torrent_phy) -> c_int {
    int cdns_torrent_phy_configure_multilink(struct cdns_torrent_phy *cdns_phy)
    {
    const struct cdns_torrent_vals *cmn_vals, *tx_ln_vals, *rx_ln_vals;
    const struct cdns_torrent_data *init_data = cdns_phy.init_data;
    const struct cdns_torrent_vals *link_cmn_vals, *xcvr_diag_vals;
    let mut ref_clk1: enum cdns_torrent_ref_clk = cdns_phy.ref_clk1_rate;
    let mut ref_clk: enum cdns_torrent_ref_clk = cdns_phy.ref_clk_rate;
    const struct cdns_torrent_vals *phy_pma_cmn_vals;
    const struct cdns_torrent_vals *pcs_cmn_vals;
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_clk_cleanup(cdns_phy: *mut cdns_torrent_phy) {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_clk_register(cdns_phy: *mut cdns_torrent_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_of_get_reset(cdns_phy: *mut cdns_torrent_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_of_get_clk(cdns_phy: *mut cdns_torrent_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_clk(cdns_phy: *mut cdns_torrent_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_phy_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut total_num_lanes: u32 = 0;
    let mut init_dp_regmap: u8 = 0;
    u32 phy_type;
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_phy_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_refclk_driver_suspend(cdns_phy: *mut cdns_torrent_phy) {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_refclk_driver_resume(cdns_phy: *mut cdns_torrent_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_phy_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_torrent_phy_resume_noirq(dev: *mut device) -> c_int {
    static int cdns_torrent_phy_resume_noirq(struct device *dev)
    {
    struct cdns_torrent_phy *cdns_phy = dev_get_drvdata(dev);
    let mut node: c_int = cdns_phy.nsubnodes;
    int ret, i;
...
// PCIe, 100 MHz Ref clk, no SSC & external SSC
    ...
    {CDNS_TORRENT_KEY_ANYCLK(TYPE_PCIE, TYPE_NONE), core::ptr::null_mut()},
    ...
    {CDNS_TORRENT_KEY_ANYCLK(TYPE_PCIE, TYPE_XAUI), core::ptr::null_mut()},
    ...
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_NONE, NO_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_NONE, EXTERNAL_SSC), core::ptr::null_mut()},
    ...
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_DP, NO_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_XAUI, NO_SSC), core::ptr::null_mut()},
...
// Dual refclk
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_156_25_MHZ, TYPE_PCIE, TYPE_USXGMII, NO_SSC), core::ptr::null_mut()},
    ...
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_NONE, NO_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_NONE, EXTERNAL_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_NONE, INTERNAL_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_PCIE, NO_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_PCIE, EXTERNAL_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_PCIE, INTERNAL_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_SGMII, NO_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_SGMII, EXTERNAL_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_SGMII, INTERNAL_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_QSGMII, NO_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_QSGMII, EXTERNAL_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_QSGMII, INTERNAL_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_USB, NO_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_USB, EXTERNAL_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_USB, INTERNAL_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_DP, NO_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE, TYPE_XAUI, NO_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE_ML, TYPE_USB, NO_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE_ML, TYPE_USB, EXTERNAL_SSC), core::ptr::null_mut()},
    {CDNS_TORRENT_KEY(CLK_100_MHZ, CLK_100_MHZ, TYPE_PCIE_ML, TYPE_USB, INTERNAL_SSC), core::ptr::null_mut()},
