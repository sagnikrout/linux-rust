...
//! Source: drivers/phy/cadence/phy-cadence-sierra.c
#![no_std]
...
pub const NUM_SSC_MODE: c_int = 3;
pub const NUM_PHY_TYPE: c_int = 5;
// PHY register offsets
pub const SIERRA_COMMON_CDB_OFFSET: c_uint = 0x0;
pub const SIERRA_MACRO_ID_REG: c_uint = 0x0;
pub const SIERRA_CMN_PLLLC_GEN_PREG: c_uint = 0x42;
pub const SIERRA_CMN_PLLLC_FBDIV_INT_MODE0_PREG: c_uint = 0x43;
pub const SIERRA_CMN_PLLLC_DCOCAL_CTRL_PREG: c_uint = 0x45;
pub const SIERRA_CMN_PLLLC_INIT_PREG: c_uint = 0x46;
pub const SIERRA_CMN_PLLLC_ITERTMR_PREG: c_uint = 0x47;
pub const SIERRA_CMN_PLLLC_MODE_PREG: c_uint = 0x48;
pub const SIERRA_CMN_PLLLC_LF_COEFF_MODE1_PREG: c_uint = 0x49;
pub const SIERRA_CMN_PLLLC_LF_COEFF_MODE0_PREG: c_uint = 0x4A;
pub const SIERRA_CMN_PLLLC_LOCK_CNTSTART_PREG: c_uint = 0x4B;
pub const SIERRA_CMN_PLLLC_LOCKSEARCH_PREG: c_uint = 0x4C;
pub const SIERRA_CMN_PLLLC_CLK1_PREG: c_uint = 0x4D;
pub const SIERRA_CMN_PLLLC_CLK0_PREG: c_uint = 0x4E;
pub const SIERRA_CMN_PLLLC_BWCAL_MODE1_PREG: c_uint = 0x4F;
pub const SIERRA_CMN_PLLLC_BWCAL_MODE0_PREG: c_uint = 0x50;
pub const SIERRA_CMN_PLLLC_DSMCORR_PREG: c_uint = 0x51;
pub const SIERRA_CMN_PLLLC_SS_PREG: c_uint = 0x52;
pub const SIERRA_CMN_PLLLC_SS_AMP_STEP_SIZE_PREG: c_uint = 0x53;
pub const SIERRA_CMN_PLLLC_SSTWOPT_PREG: c_uint = 0x54;
pub const SIERRA_CMN_PLLCSM_PLLEN_TMR_PREG: c_uint = 0x5D;
pub const SIERRA_CMN_PLLCSM_PLLPRE_TMR_PREG: c_uint = 0x5E;
pub const SIERRA_CMN_PLLLC_SS_TIME_STEPSIZE_MODE_PREG: c_uint = 0x62;
pub const SIERRA_CMN_PLLLC_LOCK_DELAY_CTRL_PREG: c_uint = 0x63;
pub const SIERRA_SDOSCCAL_CLK_CNT_PREG: c_uint = 0x6E;
pub const SIERRA_CMN_REFRCV_PREG: c_uint = 0x98;
pub const SIERRA_CMN_RESCAL_CTRLA_PREG: c_uint = 0xA0;
pub const SIERRA_CMN_REFRCV1_PREG: c_uint = 0xB8;
pub const SIERRA_CMN_PLLLC1_GEN_PREG: c_uint = 0xC2;
pub const SIERRA_CMN_PLLLC1_FBDIV_INT_PREG: c_uint = 0xC3;
pub const SIERRA_CMN_PLLLC1_DCOCAL_CTRL_PREG: c_uint = 0xC5;
pub const SIERRA_CMN_PLLLC1_MODE_PREG: c_uint = 0xC8;
pub const SIERRA_CMN_PLLLC1_LF_COEFF_MODE1_PREG: c_uint = 0xC9;
pub const SIERRA_CMN_PLLLC1_LF_COEFF_MODE0_PREG: c_uint = 0xCA;
pub const SIERRA_CMN_PLLLC1_CLK0_PREG: c_uint = 0xCE;
pub const SIERRA_CMN_PLLLC1_BWCAL_MODE1_PREG: c_uint = 0xCF;
pub const SIERRA_CMN_PLLLC1_BWCAL_MODE0_PREG: c_uint = 0xD0;
pub const SIERRA_CMN_PLLLC1_SS_TIME_STEPSIZE_MODE_PREG: c_uint = 0xE2;

    ((0x4000 << (block_offset)) + \
    (((ln) << 9) << (reg_offset)))
pub const SIERRA_DET_STANDEC_A_PREG: c_uint = 0x000;
pub const SIERRA_DET_STANDEC_B_PREG: c_uint = 0x001;
pub const SIERRA_DET_STANDEC_C_PREG: c_uint = 0x002;
pub const SIERRA_DET_STANDEC_D_PREG: c_uint = 0x003;
pub const SIERRA_DET_STANDEC_E_PREG: c_uint = 0x004;
pub const SIERRA_PSM_LANECAL_DLY_A1_RESETS_PREG: c_uint = 0x008;
pub const SIERRA_PSM_A0IN_TMR_PREG: c_uint = 0x009;
pub const SIERRA_PSM_A3IN_TMR_PREG: c_uint = 0x00C;
pub const SIERRA_PSM_DIAG_PREG: c_uint = 0x015;
pub const SIERRA_PSC_LN_A3_PREG: c_uint = 0x023;
pub const SIERRA_PSC_LN_A4_PREG: c_uint = 0x024;
pub const SIERRA_PSC_LN_IDLE_PREG: c_uint = 0x026;
pub const SIERRA_PSC_TX_A0_PREG: c_uint = 0x028;
pub const SIERRA_PSC_TX_A1_PREG: c_uint = 0x029;
pub const SIERRA_PSC_TX_A2_PREG: c_uint = 0x02A;
pub const SIERRA_PSC_TX_A3_PREG: c_uint = 0x02B;
pub const SIERRA_PSC_RX_A0_PREG: c_uint = 0x030;
pub const SIERRA_PSC_RX_A1_PREG: c_uint = 0x031;
pub const SIERRA_PSC_RX_A2_PREG: c_uint = 0x032;
pub const SIERRA_PSC_RX_A3_PREG: c_uint = 0x033;
pub const SIERRA_PLLCTRL_FBDIV_MODE01_PREG: c_uint = 0x039;
pub const SIERRA_PLLCTRL_SUBRATE_PREG: c_uint = 0x03A;
pub const SIERRA_PLLCTRL_GEN_A_PREG: c_uint = 0x03B;
pub const SIERRA_PLLCTRL_GEN_D_PREG: c_uint = 0x03E;
pub const SIERRA_PLLCTRL_CPGAIN_MODE_PREG: c_uint = 0x03F;
pub const SIERRA_PLLCTRL_STATUS_PREG: c_uint = 0x044;
pub const SIERRA_CLKPATH_BIASTRIM_PREG: c_uint = 0x04B;
pub const SIERRA_DFE_BIASTRIM_PREG: c_uint = 0x04C;
pub const SIERRA_DRVCTRL_ATTEN_PREG: c_uint = 0x06A;
pub const SIERRA_DRVCTRL_BOOST_PREG: c_uint = 0x06F;
pub const SIERRA_LANE_TX_RECEIVER_DETECT_PREG: c_uint = 0x071;
pub const SIERRA_TX_RCVDET_OVRD_PREG: c_uint = 0x072;
pub const SIERRA_CLKPATHCTRL_TMR_PREG: c_uint = 0x081;
pub const SIERRA_RX_CREQ_FLTR_A_MODE3_PREG: c_uint = 0x085;
pub const SIERRA_RX_CREQ_FLTR_A_MODE2_PREG: c_uint = 0x086;
pub const SIERRA_RX_CREQ_FLTR_A_MODE1_PREG: c_uint = 0x087;
pub const SIERRA_RX_CREQ_FLTR_A_MODE0_PREG: c_uint = 0x088;
pub const SIERRA_CREQ_DCBIASATTEN_OVR_PREG: c_uint = 0x08C;
pub const SIERRA_CREQ_CCLKDET_MODE01_PREG: c_uint = 0x08E;
pub const SIERRA_RX_CTLE_CAL_PREG: c_uint = 0x08F;
pub const SIERRA_RX_CTLE_MAINTENANCE_PREG: c_uint = 0x091;
pub const SIERRA_CREQ_FSMCLK_SEL_PREG: c_uint = 0x092;
pub const SIERRA_CREQ_EQ_CTRL_PREG: c_uint = 0x093;
pub const SIERRA_CREQ_SPARE_PREG: c_uint = 0x096;
pub const SIERRA_CREQ_EQ_OPEN_EYE_THRESH_PREG: c_uint = 0x097;
pub const SIERRA_CTLELUT_CTRL_PREG: c_uint = 0x098;
pub const SIERRA_DEQ_BLK_TAU_CTRL1_PREG: c_uint = 0x0AC;
pub const SIERRA_DEQ_BLK_TAU_CTRL4_PREG: c_uint = 0x0AF;
pub const SIERRA_DFE_ECMP_RATESEL_PREG: c_uint = 0x0C0;
pub const SIERRA_DFE_SMP_RATESEL_PREG: c_uint = 0x0C1;
pub const SIERRA_DEQ_PHALIGN_CTRL: c_uint = 0x0C4;
pub const SIERRA_DEQ_CONCUR_CTRL1_PREG: c_uint = 0x0C8;
pub const SIERRA_DEQ_CONCUR_CTRL2_PREG: c_uint = 0x0C9;
pub const SIERRA_DEQ_EPIPWR_CTRL2_PREG: c_uint = 0x0CD;
pub const SIERRA_DEQ_FAST_MAINT_CYCLES_PREG: c_uint = 0x0CE;
pub const SIERRA_DEQ_ERRCMP_CTRL_PREG: c_uint = 0x0D0;
pub const SIERRA_DEQ_OFFSET_CTRL_PREG: c_uint = 0x0D8;
pub const SIERRA_DEQ_GAIN_CTRL_PREG: c_uint = 0x0E0;
pub const SIERRA_DEQ_VGATUNE_CTRL_PREG: c_uint = 0x0E1;
pub const SIERRA_DEQ_GLUT0: c_uint = 0x0E8;
pub const SIERRA_DEQ_GLUT1: c_uint = 0x0E9;
pub const SIERRA_DEQ_GLUT2: c_uint = 0x0EA;
pub const SIERRA_DEQ_GLUT3: c_uint = 0x0EB;
pub const SIERRA_DEQ_GLUT4: c_uint = 0x0EC;
pub const SIERRA_DEQ_GLUT5: c_uint = 0x0ED;
pub const SIERRA_DEQ_GLUT6: c_uint = 0x0EE;
pub const SIERRA_DEQ_GLUT7: c_uint = 0x0EF;
pub const SIERRA_DEQ_GLUT8: c_uint = 0x0F0;
pub const SIERRA_DEQ_GLUT9: c_uint = 0x0F1;
pub const SIERRA_DEQ_GLUT10: c_uint = 0x0F2;
pub const SIERRA_DEQ_GLUT11: c_uint = 0x0F3;
pub const SIERRA_DEQ_GLUT12: c_uint = 0x0F4;
pub const SIERRA_DEQ_GLUT13: c_uint = 0x0F5;
pub const SIERRA_DEQ_GLUT14: c_uint = 0x0F6;
pub const SIERRA_DEQ_GLUT15: c_uint = 0x0F7;
pub const SIERRA_DEQ_GLUT16: c_uint = 0x0F8;
pub const SIERRA_POSTPRECUR_EN_CEPH_CTRL_PREG: c_uint = 0x0F9;
pub const SIERRA_TAU_EN_CEPH2TO0_PREG: c_uint = 0x0FB;
pub const SIERRA_TAU_EN_CEPH5TO3_PREG: c_uint = 0x0FC;
pub const SIERRA_DEQ_ALUT0: c_uint = 0x108;
pub const SIERRA_DEQ_ALUT1: c_uint = 0x109;
pub const SIERRA_DEQ_ALUT2: c_uint = 0x10A;
pub const SIERRA_DEQ_ALUT3: c_uint = 0x10B;
pub const SIERRA_DEQ_ALUT4: c_uint = 0x10C;
pub const SIERRA_DEQ_ALUT5: c_uint = 0x10D;
pub const SIERRA_DEQ_ALUT6: c_uint = 0x10E;
pub const SIERRA_DEQ_ALUT7: c_uint = 0x10F;
pub const SIERRA_DEQ_ALUT8: c_uint = 0x110;
pub const SIERRA_DEQ_ALUT9: c_uint = 0x111;
pub const SIERRA_DEQ_ALUT10: c_uint = 0x112;
pub const SIERRA_DEQ_ALUT11: c_uint = 0x113;
pub const SIERRA_DEQ_ALUT12: c_uint = 0x114;
pub const SIERRA_DEQ_ALUT13: c_uint = 0x115;
pub const SIERRA_OEPH_EN_CTRL_PREG: c_uint = 0x124;
pub const SIERRA_DEQ_DFETAP_CTRL_PREG: c_uint = 0x128;
pub const SIERRA_DEQ_DFETAP0: c_uint = 0x129;
pub const SIERRA_DEQ_DFETAP1: c_uint = 0x12B;
pub const SIERRA_DEQ_DFETAP2: c_uint = 0x12D;
pub const SIERRA_DEQ_DFETAP3: c_uint = 0x12F;
pub const SIERRA_DEQ_DFETAP4: c_uint = 0x131;
pub const SIERRA_DFE_EN_1010_IGNORE_PREG: c_uint = 0x134;
pub const SIERRA_DEQ_PRECUR_PREG: c_uint = 0x138;
pub const SIERRA_DEQ_POSTCUR_PREG: c_uint = 0x140;
pub const SIERRA_DEQ_POSTCUR_DECR_PREG: c_uint = 0x142;
pub const SIERRA_DEQ_TAU_CTRL1_SLOW_MAINT_PREG: c_uint = 0x150;
pub const SIERRA_DEQ_TAU_CTRL2_PREG: c_uint = 0x151;
pub const SIERRA_DEQ_TAU_CTRL3_PREG: c_uint = 0x152;
pub const SIERRA_DEQ_TAU_EPIOFFSET_MODE_PREG: c_uint = 0x158;
pub const SIERRA_DEQ_CONCUR_EPIOFFSET_MODE_PREG: c_uint = 0x159;
pub const SIERRA_DEQ_OPENEYE_CTRL_PREG: c_uint = 0x15C;
pub const SIERRA_DEQ_PICTRL_PREG: c_uint = 0x161;
pub const SIERRA_CPICAL_TMRVAL_MODE1_PREG: c_uint = 0x170;
pub const SIERRA_CPICAL_TMRVAL_MODE0_PREG: c_uint = 0x171;
pub const SIERRA_CPICAL_PICNT_MODE1_PREG: c_uint = 0x174;
pub const SIERRA_CPI_OUTBUF_RATESEL_PREG: c_uint = 0x17C;
pub const SIERRA_CPI_RESBIAS_BIN_PREG: c_uint = 0x17E;
pub const SIERRA_CPI_TRIM_PREG: c_uint = 0x17F;
pub const SIERRA_CPICAL_RES_STARTCODE_MODE23_PREG: c_uint = 0x183;
pub const SIERRA_CPICAL_RES_STARTCODE_MODE01_PREG: c_uint = 0x184;
pub const SIERRA_EPI_CTRL_PREG: c_uint = 0x187;
pub const SIERRA_LFPSDET_SUPPORT_PREG: c_uint = 0x188;
pub const SIERRA_LFPSFILT_NS_PREG: c_uint = 0x18A;
pub const SIERRA_LFPSFILT_RD_PREG: c_uint = 0x18B;
pub const SIERRA_LFPSFILT_MP_PREG: c_uint = 0x18C;
pub const SIERRA_SIGDET_SUPPORT_PREG: c_uint = 0x190;
pub const SIERRA_SDFILT_H2L_A_PREG: c_uint = 0x191;
pub const SIERRA_SDFILT_L2H_PREG: c_uint = 0x193;
pub const SIERRA_RXBUFFER_CTLECTRL_PREG: c_uint = 0x19E;
pub const SIERRA_RXBUFFER_RCDFECTRL_PREG: c_uint = 0x19F;
pub const SIERRA_RXBUFFER_DFECTRL_PREG: c_uint = 0x1A0;
pub const SIERRA_LN_SPARE_REG_PREG: c_uint = 0x1B0;
pub const SIERRA_DEQ_TAU_CTRL1_FAST_MAINT_PREG: c_uint = 0x14F;
pub const SIERRA_DEQ_TAU_CTRL1_SLOW_MAINT_PREG: c_uint = 0x150;
// PHY PCS common registers

    (0xc000 << (block_offset))
pub const SIERRA_PHY_PIPE_CMN_CTRL1: c_uint = 0x0;
pub const SIERRA_PHY_PLL_CFG: c_uint = 0xe;
// PHY PCS lane registers

    ((0xD000 << (block_offset)) +	\
    (((ln) << 8) << (reg_offset)))
pub const SIERRA_PHY_ISO_LINK_CTRL: c_uint = 0xB;
// PHY PMA common registers

    (0xE000 << (block_offset))
pub const SIERRA_PHY_PMA_CMN_CTRL: c_uint = 0x000;
// PHY PMA lane registers

    ((0xF000 << (block_offset)) +	\
    (((ln) << 8) << (reg_offset)))
pub const SIERRA_PHY_PMA_XCVR_CTRL: c_uint = 0x000;
pub const SIERRA_MACRO_ID: c_uint = 0x00007364;
pub const SIERRA_MAX_LANES: c_int = 16;
pub const PLL_LOCK_TIME: c_int = 100000;
pub const CDNS_SIERRA_OUTPUT_CLOCKS: c_int = 3;
pub const CDNS_SIERRA_INPUT_CLOCKS: c_int = 3;
    enum cdns_sierra_clock_input {
    PHY_CLK,
    CMN_REFCLK_DIG_DIV,
    CMN_REFCLK1_DIG_DIV,
    };
pub const SIERRA_NUM_CMN_PLLC: c_int = 2;
pub const SIERRA_NUM_CMN_PLLC_PARENTS: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_sierra_pll_mux_reg_fields {
    pub pfdclk_sel_preg: reg_field,
    pub plllc1en_field: reg_field,
    pub termen_field: reg_field,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_sierra_pll_mux {
    pub hw: clk_hw,
    pub pfdclk_sel_preg: *mut regmap_field,
    pub plllc1en_field: *mut regmap_field,
    pub termen_field: *mut regmap_field,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_sierra_derived_refclk {
    pub hw: clk_hw,
    pub cmn_plllc_clk1outdiv_preg: *mut regmap_field,
    pub cmn_plllc_clk1_en_preg: *mut regmap_field,
    pub clk_data: clk_init_data,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_sierra_inst {
    pub phy: *mut phy,
    pub phy_type: enum cdns_sierra_phy_type,
    pub num_lanes: u32,
    pub mlane: u32,
    pub lnk_rst: *mut reset_control,
    pub ssc_mode: enum cdns_sierra_ssc_mode,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_sierra_phy {
    pub dev: *mut device,
    pub init_data: *const cdns_sierra_data,
    pub phys: [cdns_sierra_inst; SIERRA_MAX_LANES],
    pub phy_rst: *mut reset_control,
    pub apb_rst: *mut reset_control,
    pub regmap_lane_cdb: [*mut regmap; SIERRA_MAX_LANES],
    pub regmap_phy_pcs_common_cdb: *mut regmap,
    pub regmap_phy_pcs_lane_cdb: [*mut regmap; SIERRA_MAX_LANES],
    pub regmap_phy_pma_common_cdb: *mut regmap,
    pub regmap_phy_pma_lane_cdb: [*mut regmap; SIERRA_MAX_LANES],
    pub regmap_common_cdb: *mut regmap,
    pub macro_id_type: *mut regmap_field,
    pub phy_pll_cfg_1: *mut regmap_field,
    pub pma_cmn_ready: *mut regmap_field,
    pub pllctrl_lock: [*mut regmap_field; SIERRA_MAX_LANES],
    pub phy_iso_link_ctrl_1: [*mut regmap_field; SIERRA_MAX_LANES],
    pub cmn_refrcv_refclk_plllc1en_preg: [*mut regmap_field; SIERRA_NUM_CMN_PLLC],
    pub cmn_refrcv_refclk_termen_preg: [*mut regmap_field; SIERRA_NUM_CMN_PLLC],
    pub cmn_plllc_pfdclk1_sel_preg: [*mut regmap_field; SIERRA_NUM_CMN_PLLC],
    pub input_clks: [*mut clk; CDNS_SIERRA_INPUT_CLOCKS],
    pub nsubnodes: c_int,
    pub num_lanes: u32,
    pub autoconf: bool,
    pub already_configured: c_int,
    pub pll_clks: [*mut clk; SIERRA_NUM_CMN_PLLC],
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_phy_init(gphy: *mut phy) -> c_int {
    ...
    let mut phy_type: enum cdns_sierra_phy_type = ins.phy_type;
    const struct cdns_sierra_vals *phy_pma_ln_vals;
    let mut ssc: enum cdns_sierra_ssc_mode = ins.ssc_mode;
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_phy_on(gphy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_phy_off(gphy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_phy_reset(gphy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_noop_phy_on(gphy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_pll_mux_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_pll_mux_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_phy_register_pll_mux(sp: *mut cdns_sierra_phy) -> c_int {
    ...
    struct regmap_field *termen_field;
    struct device *dev = sp.dev;
    let mut ret: c_int = 0, i, clk_index;
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_derived_refclk_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_derived_refclk_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_derived_refclk_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_derived_refclk_register(sp: *mut cdns_sierra_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_clk_unregister(sp: *mut cdns_sierra_phy) {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_clk_register(sp: *mut cdns_sierra_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_regfield_init(sp: *mut cdns_sierra_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_phy_clk(sp: *mut cdns_sierra_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_phy_enable_clocks(sp: *mut cdns_sierra_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_phy_disable_clocks(sp: *mut cdns_sierra_phy) {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_phy_configure_multilink(sp: *mut cdns_sierra_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_phy_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_sierra_phy_remove(pdev: *mut platform_device) {
