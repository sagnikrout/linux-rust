...
//! Source: drivers/phy/spacemit/phy-k3-combo.c
#![no_std]
...
//
pub const PMUA_PCIE_SUBSYS_MGMT: c_uint = 0x1d8;

pub const COMBPHY_MAX_SUBPHYS: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k3_combo_phy {
    pub dev: *mut device,
    pub groups: [k3_lane_group; COMBPHY_MAX_SUBPHYS],
    pub base: *mut void __iomem,
    pub apb_spare: *mut regmap,
}
...
#[no_mangle]
unsafe extern "C" fn k3_combo_phy_init_lanes(phy: *mut k3_combo_phy, config: c_uint) -> c_int {
    ...
    lg.phy = devm_phy_create(phy.dev, core::ptr::null_mut(), ops);
    if (IS_ERR(lg.phy))
...
#[no_mangle]
unsafe extern "C" fn k3_combo_phy_update_config(apmu: *mut regmap, config: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k3_combo_phy_probe(pdev: *mut platform_device) -> c_int {
