...
//! Source: drivers/phy/microchip/lan966x_serdes.c
#![no_std]
...
pub const PLL_CONF_25MHZ: c_int = 0;
pub const PLL_CONF_125MHZ: c_int = 1;
pub const PLL_CONF_SERDES_125MHZ: c_int = 2;
pub const PLL_CONF_BYPASS: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn lan_rmw_(val: u32, mask: u32, mem: *mut void __iomem, offset: u32) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct serdes_ctrl {
    pub regs: *mut void __iomem,
    pub dev: *mut device,
    pub phys: [*mut phy; SERDES_MAX],
    pub ref125: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct serdes_macro {
    pub idx: u8,
    pub port: c_int,
    pub ctrl: *mut serdes_ctrl,
    pub speed: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lan966x_sd6g40_setup_args {
    pub mode: enum lan966x_sd6g40_mode,
    pub tx2rx_loop: enum lan966x_sd6g40_ltx2rx,
    pub txinvert: bool,
    pub rxinvert: bool,
    pub refclk125M: bool,
    pub mute: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lan966x_sd6g40_mode_args {
    pub mode: enum lan966x_sd6g40_mode,
    pub lane_10bit_sel: u8,
    pub mpll_multiplier: u8,
    pub ref_clkdiv2: u8,
    pub tx_rate: u8,
    pub rx_rate: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lan966x_sd6g40_setup {
    pub rx_term_en: u8,
    pub lane_10bit_sel: u8,
    pub tx_invert: u8,
    pub rx_invert: u8,
    pub mpll_multiplier: u8,
    pub lane_loopbk_en: u8,
    pub ref_clkdiv2: u8,
    pub tx_rate: u8,
    pub rx_rate: u8,
}
...
// Waiting for serdes 0 tx operational...
    ...
    u32 idx)
    {
    let mut calc_results: lan966x_sd6g40_setup = {};
    int ret;
...
#[no_mangle]
unsafe extern "C" fn lan966x_sd6g40_setup(macro: *mut serdes_macro, idx: u32, mode: c_int) -> c_int {
    static int lan966x_sd6g40_setup(struct serdes_macro *macro, u32 idx, int mode)
    {
    let mut conf: lan966x_sd6g40_setup_args = {};
...
#[no_mangle]
unsafe extern "C" fn lan966x_rgmii_setup(macro: *mut serdes_macro, idx: u32, mode: c_int) -> c_int {
    static int lan966x_rgmii_setup(struct serdes_macro *macro, u32 idx, int mode)
    {
    let mut tx_delay: bool = false;
    let mut rx_delay: bool = false;
// Configure RGMII
...
#[no_mangle]
unsafe extern "C" fn serdes_set_speed(phy: *mut phy, speed: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serdes_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serdes_phy_create(ctrl: *mut serdes_ctrl, idx: u8, phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serdes_probe(pdev: *mut platform_device) -> c_int {
    ...
    return -ENOMEM;
    ctrl.dev = &pdev.dev;
    ctrl.regs = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
    if (IS_ERR(ctrl.regs))
    return PTR_ERR(ctrl.regs);
    hw_stat = devm_platform_get_and_ioremap_resource(pdev, 1, core::ptr::null_mut());
    if (IS_ERR(hw_stat))
