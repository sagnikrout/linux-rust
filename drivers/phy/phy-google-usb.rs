...
//! Source: drivers/phy/phy-google-usb.c
#![no_std]
...
pub const USBCS_USB2PHY_CFG19_OFFSET: c_uint = 0x0;

pub const USBCS_USB2PHY_CFG21_OFFSET: c_uint = 0x8;

pub const USBCS_PHY_CFG1_OFFSET: c_uint = 0x28;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct google_usb_phy_instance {
    pub parent: *mut google_usb_phy,
    pub index: c_uint,
    pub phy: *mut phy,
    pub num_clks: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct google_usb_phy {
    pub dev: *mut device,
    pub usb_cfg_regmap: *mut regmap,
    pub usb2_cfg_offset: c_uint,
    pub usbdp_top_base: *mut void __iomem,
    pub insts: *mut google_usb_phy_instance,
//
...
#[no_mangle]
unsafe extern "C" fn set_vbus_valid(gphy: *mut google_usb_phy) {
...
#[no_mangle]
unsafe extern "C" fn google_usb2_phy_init(_phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn google_usb2_phy_exit(_phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn google_usb_phy_probe(pdev: *mut platform_device) -> c_int {
    ...
    phy = devm_phy_create(dev, core::ptr::null_mut(), &google_usb2_phy_ops);
    if (IS_ERR(phy))
...
#[no_mangle]
unsafe extern "C" fn google_usb_phy_remove(pdev: *mut platform_device) {
