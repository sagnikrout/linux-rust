...
//! Source: drivers/phy/intel/phy-intel-lgm-combo.c
#![no_std]
...
pub const PCIE_PHY_GEN_CTRL: c_uint = 0x00;

pub const PAD_DIS_CFG: c_uint = 0x174;
pub const PCS_XF_ATE_OVRD_IN_2: c_uint = 0x3008;

pub const PCS_XF_RX_ADAPT_ACK: c_uint = 0x3010;

pub const CLK_100MHZ: c_int = 100000000;
pub const CLK_156_25MHZ: c_int = 156250000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct intel_cbphy_iphy {
    pub phy: *mut phy,
    pub parent: *mut intel_combo_phy,
    pub app_rst: *mut reset_control,
    pub id: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct intel_combo_phy {
    pub dev: *mut device,
    pub core_clk: *mut clk,
    pub clk_rate: c_ulong,
    pub app_base: *mut void __iomem,
    pub cr_base: *mut void __iomem,
    pub syscfg: *mut regmap,
    pub hsiocfg: *mut regmap,
    pub id: u32,
    pub bid: u32,
    pub phy_rst: *mut reset_control,
    pub core_rst: *mut reset_control,
    pub iphy: [intel_cbphy_iphy; PHY_MAX_NUM],
    pub phy_mode: enum intel_phy_mode,
    pub aggr_mode: enum aggregated_mode,
    pub init_cnt: u32,
    pub lock: mutex,
}

#[no_mangle]
unsafe extern "C" fn intel_cbphy_iphy_enable(iphy: *mut intel_cbphy_iphy, set: bool) -> c_int {
    static int intel_cbphy_iphy_enable(struct intel_cbphy_iphy *iphy, bool set)
    {
    struct intel_combo_phy *cbphy = iphy.parent;
    let mut mask: u32 = BIT(cbphy.phy_mode * 2 + iphy.id);
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_pcie_refclk_cfg(iphy: *mut intel_cbphy_iphy, set: bool) -> c_int {
    static int intel_cbphy_pcie_refclk_cfg(struct intel_cbphy_iphy *iphy, bool set)
    {
    struct intel_combo_phy *cbphy = iphy.parent;
    let mut mask: u32 = BIT(cbphy.id * 2 + iphy.id);
    u32 val;
// Register: 0 is enable, 1 is disable
    val = set ? 0 : mask;
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_pcie_en_pad_refclk(iphy: *mut intel_cbphy_iphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_pcie_dis_pad_refclk(iphy: *mut intel_cbphy_iphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_set_mode(cbphy: *mut intel_combo_phy) -> c_int {
    static int intel_cbphy_set_mode(struct intel_combo_phy *cbphy)
    {
    enum intel_combo_mode cb_mode;
    let mut aggr: enum aggregated_mode = cbphy.aggr_mode;
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_rst_assert(cbphy: *mut intel_combo_phy) {
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_rst_deassert(cbphy: *mut intel_combo_phy) {
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_iphy_power_on(iphy: *mut intel_cbphy_iphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_iphy_power_off(iphy: *mut intel_cbphy_iphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_calibrate(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_fwnode_parse(cbphy: *mut intel_combo_phy) -> c_int {
    ...
    int ret;
    u32 val;
    cbphy.core_clk = devm_clk_get(dev, core::ptr::null_mut());
...
//
    ret = fwnode_property_get_reference_args(fwnode, "intel,syscfg", core::ptr::null_mut(),
    1, 0, &ref);
    if (ret < 0)
    return ret;
    cbphy.id = ref.args[0];
    ...
    ret = fwnode_property_get_reference_args(fwnode, "intel,hsio", core::ptr::null_mut(), 1,
    0, &ref);
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_create(cbphy: *mut intel_combo_phy) -> c_int {
...
// In dual lane mode skip phy creation for the second phy
    ...
    continue;
    iphy.phy = devm_phy_create(dev, core::ptr::null_mut(), &intel_cbphy_ops);
    if (IS_ERR(iphy.phy)) {
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_cbphy_remove(pdev: *mut platform_device) {
