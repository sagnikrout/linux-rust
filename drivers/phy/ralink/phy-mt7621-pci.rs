...
//! Source: drivers/phy/ralink/phy-mt7621-pci.c
#![no_std]
...
pub const RG_PE1_PIPE_REG: c_uint = 0x02c;

pub const RG_P0_TO_P1_WIDTH: c_uint = 0x100;
pub const RG_PE1_H_LCDDS_REG: c_uint = 0x49c;

pub const RG_PE1_FRC_H_XTAL_REG: c_uint = 0x400;

pub const RG_PE1_FRC_PHY_REG: c_uint = 0x000;

pub const RG_PE1_H_PLL_REG: c_uint = 0x490;

pub const RG_PE1_H_PLL_FBKSEL_REG: c_uint = 0x4bc;

pub const RG_PE1_H_LCDDS_SSC_PRD_REG: c_uint = 0x4a4;

pub const RG_PE1_H_LCDDS_SSC_DELTA_REG: c_uint = 0x4a8;

pub const RG_PE1_LCDDS_CLK_PH_INV_REG: c_uint = 0x4a0;

pub const RG_PE1_H_PLL_BR_REG: c_uint = 0x4ac;

pub const RG_PE1_MSTCKDIV_REG: c_uint = 0x414;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt7621_pci_phy {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub phy: *mut phy,
    pub sys_clk: *mut clk,
    pub port_base: *mut void __iomem,
    pub has_dual_port: bool,
    pub bypass_pipe_rst: bool,
}
...
#[no_mangle]
unsafe extern "C" fn mt7621_bypass_pipe_rst(phy: *mut mt7621_pci_phy) {
...
#[no_mangle]
unsafe extern "C" fn mt7621_set_phy_for_ssc(phy: *mut mt7621_pci_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7621_pci_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7621_pci_phy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7621_pci_phy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7621_pci_phy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7621_pci_phy_probe(pdev: *mut platform_device) -> c_int {
    ...
    phy.sys_clk = devm_clk_get(dev, core::ptr::null_mut());
