...
//! Source: drivers/phy/mediatek/phy-mtk-tphy.c
#![no_std]
...
pub const SSUSB_SIFSLV_V1_SPLLC: c_uint = 0x000	/* shared by u3 phys */;
pub const SSUSB_SIFSLV_V1_U2FREQ: c_uint = 0x100	/* shared by u2 phys */;
pub const SSUSB_SIFSLV_V1_CHIP: c_uint = 0x300	/* shared by u3 phys */;
// u2 phy bank
pub const SSUSB_SIFSLV_V1_U2PHY_COM: c_uint = 0x000;
// u3/pcie/sata phy banks
pub const SSUSB_SIFSLV_V1_U3PHYD: c_uint = 0x000;
pub const SSUSB_SIFSLV_V1_U3PHYA: c_uint = 0x200;
// version V2/V3 sub-banks offset base address
// V3: U2FREQ is not used anymore, but reserved
// u2 phy banks
pub const SSUSB_SIFSLV_V2_MISC: c_uint = 0x000;
pub const SSUSB_SIFSLV_V2_U2FREQ: c_uint = 0x100;
pub const SSUSB_SIFSLV_V2_U2PHY_COM: c_uint = 0x300;
// u3/pcie/sata phy banks
pub const SSUSB_SIFSLV_V2_SPLLC: c_uint = 0x000;
pub const SSUSB_SIFSLV_V2_CHIP: c_uint = 0x100;
pub const SSUSB_SIFSLV_V2_U3PHYD: c_uint = 0x200;
pub const SSUSB_SIFSLV_V2_U3PHYA: c_uint = 0x400;
pub const U3P_MISC_REG1: c_uint = 0x04;

pub const U3P_USBPHYACR0: c_uint = 0x000;

pub const U3P_USBPHYACR1: c_uint = 0x004;

pub const U3P_USBPHYACR2: c_uint = 0x008;

pub const U3P_USBPHYACR5: c_uint = 0x014;

pub const U3P_USBPHYACR6: c_uint = 0x018;

pub const U3P_U2PHYACR4: c_uint = 0x020;

pub const U3P_U2PHYA_RESV: c_uint = 0x030;
pub const P2R_RG_U2PLL_FBDIV_26M: c_uint = 0x1bb13b;
pub const P2R_RG_U2PLL_FBDIV_48M: c_uint = 0x3c0000;
pub const U3P_U2PHYA_RESV1: c_uint = 0x044;

pub const U3D_U2PHYDCR0: c_uint = 0x060;

pub const U3P_U2PHYDTM0: c_uint = 0x068;

    (P2C_FORCE_DATAIN | P2C_FORCE_DM_PULLDOWN | \
    P2C_FORCE_DP_PULLDOWN | P2C_FORCE_XCVRSEL | \
    P2C_FORCE_TERMSEL | P2C_RG_DMPULLDOWN | \
    P2C_RG_DPPULLDOWN | P2C_RG_TERMSEL)
pub const U3P_U2PHYDTM1: c_uint = 0x06C;

pub const U3P_U2PHYBC12C: c_uint = 0x080;

pub const U3P_U3_CHIP_GPIO_CTLD: c_uint = 0x0c;

pub const U3P_U3_CHIP_GPIO_CTLE: c_uint = 0x10;

pub const U3P_U3_PHYA_REG0: c_uint = 0x000;

pub const U3P_U3_PHYA_REG1: c_uint = 0x004;

pub const U3P_U3_PHYA_REG6: c_uint = 0x018;

pub const U3P_U3_PHYA_REG9: c_uint = 0x024;

pub const U3P_U3_PHYA_DA_REG0: c_uint = 0x100;

pub const U3P_U3_PHYA_DA_REG4: c_uint = 0x108;

pub const U3P_U3_PHYA_DA_REG5: c_uint = 0x10c;

pub const U3P_U3_PHYA_DA_REG6: c_uint = 0x110;

pub const U3P_U3_PHYA_DA_REG7: c_uint = 0x114;

pub const U3P_U3_PHYA_DA_REG20: c_uint = 0x13c;

pub const U3P_U3_PHYA_DA_REG25: c_uint = 0x148;

pub const U3P_U3_PHYD_LFPS1: c_uint = 0x00c;

pub const U3P_U3_PHYD_IMPCAL0: c_uint = 0x010;

pub const U3P_U3_PHYD_IMPCAL1: c_uint = 0x014;

pub const U3P_U3_PHYD_RSV: c_uint = 0x054;

pub const U3P_U3_PHYD_CDR1: c_uint = 0x05c;

pub const U3P_U3_PHYD_TOP1: c_uint = 0x100;

pub const U3P_U3_PHYD_RXDET1: c_uint = 0x128;

pub const U3P_U3_PHYD_RXDET2: c_uint = 0x12c;

pub const U3P_SPLLC_XTALCTL3: c_uint = 0x018;

pub const U3P_U2FREQ_FMCR0: c_uint = 0x00;

pub const U3P_U2FREQ_VALUE: c_uint = 0x0c;
pub const U3P_U2FREQ_FMMONR1: c_uint = 0x10;

pub const U3P_SR_COEF_DIVISOR: c_int = 1000;
pub const U3P_FM_DET_CYCLE_CNT: c_int = 1024;
// SATA register setting
pub const PHYD_CTRL_SIGNAL_MODE4: c_uint = 0x1c;
// CDR Charge Pump P-path current adjustment

pub const PHYD_DESIGN_OPTION2: c_uint = 0x24;
// Symbol lock count selection

pub const PHYD_DESIGN_OPTION9: c_uint = 0x40;
...
pub const ANA_RG_CTRL_SIGNAL1: c_uint = 0x4c;
// TX driver tail current control for 0dB de-empahsis mdoe for Gen1 speed

pub const ANA_RG_CTRL_SIGNAL4: c_uint = 0x58;

// Loop filter R1 resistance adjustment for Gen1 speed

pub const ANA_RG_CTRL_SIGNAL6: c_uint = 0x60;
// I-path capacitance adjustment for Gen1

pub const ANA_EQ_EYE_CTRL_SIGNAL1: c_uint = 0x6c;
// RX Gen1 LEQ tuning step

pub const ANA_EQ_EYE_CTRL_SIGNAL4: c_uint = 0xd8;

pub const ANA_EQ_EYE_CTRL_SIGNAL5: c_uint = 0xdc;
...
pub const RG_PHY_SW_SATA: c_uint = 0x3;
pub const TPHY_CLKS_CNT: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_phy_pdata {
    pub avoid_rx_sen_degradation: bool,
    pub sw_pll_48m_to_26m: bool,
    pub sw_efuse_supported: bool,
    pub slew_ref_clock_mhz: u8,
    pub slew_rate_coefficient: u8,
    pub version: enum mtk_phy_version,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct u2phy_banks {
    pub misc: *mut void __iomem,
    pub fmreg: *mut void __iomem,
    pub com: *mut void __iomem,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct u3phy_banks {
    pub spllc: *mut void __iomem,
    pub chip: *mut void __iomem,
    pub /: *mut *mut *mut void __iomem phyd; / include u3phyd_bank2,
    pub /: *mut *mut *mut void __iomem phya; / include u3phya_da,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_phy_instance {
    pub phy: *mut phy,
    pub port_base: *mut void __iomem,
    union {
    pub u2_banks: u2phy_banks,
    pub u3_banks: u3phy_banks,
}
...
pub struct mtk_tphy {
    pub dev: *mut device,
    pub /: *mut *mut *mut void __iomem sif_base; / only shared sif,
    pub pdata: *const mtk_phy_pdata,
    pub phys: *mut mtk_phy_instance,
    pub nphys: c_int,
...
#[no_mangle]
unsafe extern "C" fn u2_phy_params_show(sf: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    let mut tmp: u32 = 0;
    let mut val: u32 = 0;
    let mut ret: c_int = debugfs_get_aux_num(sf.file);
    switch (ret) {
    case U2P_EYE_VRT:
...
#[no_mangle]
unsafe extern "C" fn u2_phy_params_open(inode: *mut inode, file: *mut file) -> c_int {
    ...
    ssize_t rc;
    u32 val;
    let mut ret: c_int = debugfs_get_aux_num(file);
...
#[no_mangle]
unsafe extern "C" fn u2_phy_dbgfs_files_create(inst: *mut mtk_phy_instance) {
    static void u2_phy_dbgfs_files_create(struct mtk_phy_instance *inst)
    {
    let mut count: u32 = ARRAY_SIZE(u2_phy_files);
    int i;
    for (i = 0; i < count; i++)
...
#[no_mangle]
unsafe extern "C" fn u3_phy_params_show(sf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn u3_phy_params_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn u3_phy_dbgfs_files_create(inst: *mut mtk_phy_instance) {
    static void u3_phy_dbgfs_files_create(struct mtk_phy_instance *inst)
    {
    let mut count: u32 = ARRAY_SIZE(u3_phy_files);
    int i;
    for (i = 0; i < count; i++)
...
#[no_mangle]
unsafe extern "C" fn phy_type_show(sf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_debugfs_init(inst: *mut mtk_phy_instance) {
...
// gating XSQ
    ...
    struct u2phy_banks *u2_banks = &instance.u2_banks;
    void __iomem *com = u2_banks.com;
    let mut index: u32 = instance.index;
...
// charge current adjustment
    ...
    case PHY_TYPE_USB2:
    u2_banks.misc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn phy_type_set(instance: *mut mtk_phy_instance) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_efuse_get(tphy: *mut mtk_tphy, instance: *mut mtk_phy_instance) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_efuse_set(instance: *mut mtk_phy_instance) {
...
#[no_mangle]
pub unsafe extern "C" fn if(PHY_TYPE_PCIE: instance->type ==) -> else {
    else if (instance.type == PHY_TYPE_PCIE)
...
unsafe extern "C" fn mtk_phy_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
    ...
    struct mtk_phy_instance *instance = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mtk_tphy_probe(pdev: *mut platform_device) -> c_int {
