...
//! Source: drivers/phy/mediatek/phy-mtk-pcie.c
#![no_std]
...
pub const PEXTP_ANA_GLB_00_REG: c_uint = 0x9000;
// Internal Resistor Selection of TX Bias Current

pub const PEXTP_ANA_LN0_TRX_REG: c_uint = 0xa000;
pub const PEXTP_ANA_TX_REG: c_uint = 0x04;
// TX PMOS impedance selection

// TX NMOS impedance selection

pub const PEXTP_ANA_RX_REG: c_uint = 0x3c;
// RX impedance selection

pub const PEXTP_ANA_LANE_OFFSET: c_uint = 0x100;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_pcie_lane_efuse {
    pub tx_pmos: u32,
    pub tx_nmos: u32,
    pub rx_data: u32,
    pub lane_efuse_supported: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_pcie_phy {
    pub dev: *mut device,
    pub phy: *mut phy,
    pub sif_base: *mut void __iomem,
    pub data: *const mtk_pcie_phy_data,
    pub sw_efuse_en: bool,
    pub efuse_glb_intr: u32,
    pub efuse: *mut mtk_pcie_lane_efuse,
}
...
//
#[no_mangle]
unsafe extern "C" fn mtk_pcie_phy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_read_efuse(pcie_phy: *mut mtk_pcie_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_phy_probe(pdev: *mut platform_device) -> c_int {
