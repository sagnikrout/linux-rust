...
//! Source: drivers/phy/socionext/phy-uniphier-usb3hs.c
#![no_std]
...
pub const HSPHY_CFG0: c_uint = 0x0;

    | HSPHY_CFG0_SEL_T_MASK \
    | HSPHY_CFG0_RTERM_MASK)
pub const HSPHY_CFG1: c_uint = 0x4;

pub const MAX_PHY_PARAMS: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uniphier_u3hsphy_param {
    struct {
    pub reg_no: c_int,
    pub msb: c_int,
    pub lsb: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uniphier_u3hsphy_trim_param {
    pub rterm: c_uint,
    pub sel_t: c_uint,
    pub hs_i: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uniphier_u3hsphy_priv {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub clk_parent_gio: *mut *mut *mut *mut clk clk, clk_parent, clk_ext,,
    pub rst_parent_gio: *mut *mut *mut reset_control rst, rst_parent,,
    pub vbus: *mut regulator,
    pub data: *const uniphier_u3hsphy_soc_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct uniphier_u3hsphy_soc_data {
    pub is_legacy: bool,
    pub nparams: c_int,
    pub param: [uniphier_u3hsphy_param; MAX_PHY_PARAMS],
    pub config0: u32,
    pub config1: u32,
    void (*trim_func)(struct uniphier_u3hsphy_priv *priv, u32 *pconfig,
    pub pt): *mut uniphier_u3hsphy_trim_param,
}
...
// pconfig |= FIELD_PREP(HSPHY_CFG0_HSDISC_MASK, 3);
    ...
    {
    u32 val;
    let mut field_mask: u32 = GENMASK(p.field.msb, p.field.lsb);
    u8 data;
...
#[no_mangle]
unsafe extern "C" fn uniphier_u3hsphy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_u3hsphy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_u3hsphy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_u3hsphy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_u3hsphy_probe(pdev: *mut platform_device) -> c_int {
