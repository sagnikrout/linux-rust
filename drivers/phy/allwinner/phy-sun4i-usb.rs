...
//! Source: drivers/phy/allwinner/phy-sun4i-usb.c
#![no_std]
...
pub const REG_ISCR: c_uint = 0x00;
pub const REG_PHYCTL_A10: c_uint = 0x04;
pub const REG_PHYBIST: c_uint = 0x08;
pub const REG_PHYTUNE: c_uint = 0x0c;
pub const REG_PHYCTL_A33: c_uint = 0x10;
pub const REG_PHY_OTGCTL: c_uint = 0x20;
pub const REG_HCI_PHY_CTL: c_uint = 0x10;
...
pub const PHY_PLL_BW: c_uint = 0x03;
pub const PHY_RES45_CAL_EN: c_uint = 0x0c;
// Private Control Bits for Each PHY
pub const PHY_TX_AMPLITUDE_TUNE: c_uint = 0x20;
pub const PHY_TX_SLEWRATE_TUNE: c_uint = 0x22;
pub const PHY_VBUSVALID_TH_SEL: c_uint = 0x25;
pub const PHY_PULLUP_RES_SEL: c_uint = 0x27;
pub const PHY_OTG_FUNC_EN: c_uint = 0x28;
pub const PHY_VBUS_DET_EN: c_uint = 0x29;
pub const PHY_DISCON_TH_SEL: c_uint = 0x2a;
pub const PHY_SQUELCH_DETECT: c_uint = 0x3c;
// A83T specific control bits for PHY0

// A83T specific control bits for PHY2 HSIC

pub const MAX_PHYS: c_int = 4;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun4i_usb_phy_cfg {
    pub hsic_index: c_int,
    pub disc_thresh: u32,
    pub hci_phy_ctl_clear: u32,
    pub phyctl_offset: u8,
    pub dedicated_clocks: bool,
    pub phy0_dual_route: bool,
    pub needs_phy2_siddq: bool,
    pub siddq_in_base: bool,
    pub poll_vbusen: bool,
    pub missing_phys: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun4i_usb_phy_data {
    pub base: *mut void __iomem,
    pub cfg: *const sun4i_usb_phy_cfg,
    pub dr_mode: enum usb_dr_mode,
    pub /: *mut *mut spinlock_t reg_lock; / guard access to phyctl reg,
    pub num_phys: c_int,
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun4i_usb_phy {
    pub phy: *mut phy,
...
// phy0 / otg related variables
    ...
    pub phy0_init: bool,
    pub id_det_gpio: *mut gpio_desc,
    pub vbus_det_gpio: *mut gpio_desc,
    pub vbus_power_supply: *mut power_supply,
    pub vbus_power_nb: notifier_block,
    pub vbus_power_nb_registered: bool,
    pub force_session_end: bool,
    pub id_det_irq: c_int,
    pub vbus_det_irq: c_int,
    pub id_det: c_int,
    pub vbus_det: c_int,
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy0_update_iscr(_phy: *mut phy, clr: u32, set: u32) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy0_set_id_detect(phy: *mut phy, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy0_set_vbus_detect(phy: *mut phy, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy_passby(phy: *mut sun4i_usb_phy, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy_init(_phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy_exit(_phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy0_get_id_det(data: *mut sun4i_usb_phy_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy0_get_vbus_det(data: *mut sun4i_usb_phy_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy0_have_vbus_det(data: *mut sun4i_usb_phy_data) -> bool {
    static bool sun4i_usb_phy0_have_vbus_det(struct sun4i_usb_phy_data *data)
    {
    return data.vbus_det_gpio || data.vbus_power_supply;
    }
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy0_poll(data: *mut sun4i_usb_phy_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy_power_on(_phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy_power_off(_phy: *mut phy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_usb_phy_set_squelch_detect(_phy: *mut phy, enabled: bool) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy0_reroute(data: *mut sun4i_usb_phy_data, id_det: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy0_id_vbus_det_scan(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy0_id_vbus_det_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_usb_phy_probe(pdev: *mut platform_device) -> c_int {
...
// HSIC needs secondary clock
    ...
    phy.phy = devm_phy_create(dev, core::ptr::null_mut(), &sun4i_usb_phy_ops);
    if (IS_ERR(phy.phy)) {
