...
//! Source: drivers/phy/freescale/phy-fsl-imx8-mipi-dphy.c
#![no_std]
...
pub const PHY_CTRL: c_uint = 0x00;

pub const CCM_1_2V: c_uint = 0x5;

pub const CA_3_51MA: c_uint = 0x4;

// DPHY registers
pub const DPHY_PD_DPHY: c_uint = 0x00;
pub const DPHY_M_PRG_HS_PREPARE: c_uint = 0x04;
pub const DPHY_MC_PRG_HS_PREPARE: c_uint = 0x08;
pub const DPHY_M_PRG_HS_ZERO: c_uint = 0x0c;
pub const DPHY_MC_PRG_HS_ZERO: c_uint = 0x10;
pub const DPHY_M_PRG_HS_TRAIL: c_uint = 0x14;
pub const DPHY_MC_PRG_HS_TRAIL: c_uint = 0x18;
pub const DPHY_PD_PLL: c_uint = 0x1c;
pub const DPHY_TST: c_uint = 0x20;
pub const DPHY_CN: c_uint = 0x24;
pub const DPHY_CM: c_uint = 0x28;
pub const DPHY_CO: c_uint = 0x2c;
pub const DPHY_LOCK: c_uint = 0x30;
pub const DPHY_LOCK_BYP: c_uint = 0x34;
pub const DPHY_REG_BYPASS_PLL: c_uint = 0x4C;

pub const PLL_LOCK_SLEEP: c_int = 10;
pub const PLL_LOCK_TIMEOUT: c_int = 1000;
pub const CN_BUF: c_uint = 0xcb7a89c0;
pub const CO_BUF: c_uint = 0x63;
...
pub const PWR_ON: c_int = 0;
pub const PWR_OFF: c_int = 1;
pub const MIN_VCO_FREQ: c_int = 640000000;
pub const MAX_VCO_FREQ: c_int = 1500000000;
pub const MIN_LVDS_REFCLK_FREQ: c_int = 24000000;
pub const MAX_LVDS_REFCLK_FREQ: c_int = 150000000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mixel_dphy_devdata {
    pub reg_tx_rcal: u8,
    pub reg_auto_pd_en: u8,
    pub reg_rxlprp: u8,
    pub reg_rxcdrp: u8,
    pub reg_rxhs_settle: u8,
    pub /: *mut *mut bool is_combo; / MIPI DPHY and LVDS PHY combo,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mixel_dphy_cfg {
// DPHY PLL parameters
    pub cm: u32,
    pub cn: u32,
    pub co: u32,
// DPHY register values
    pub mc_prg_hs_prepare: u8,
    pub m_prg_hs_prepare: u8,
    pub mc_prg_hs_zero: u8,
    pub m_prg_hs_zero: u8,
    pub mc_prg_hs_trail: u8,
    pub m_prg_hs_trail: u8,
    pub rxhs_settle: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mixel_dphy_priv {
    pub cfg: mixel_dphy_cfg,
    pub regmap: *mut regmap,
    pub lvds_regmap: *mut regmap,
    pub phy_ref_clk: *mut clk,
    pub devdata: *const mixel_dphy_devdata,
...
#[no_mangle]
unsafe extern "C" fn phy_write(phy: *mut phy, value: u32, reg: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_best_ratio(pnum: *mut u32, pdenom: *mut u32, max_n: u32, max_d: u32) {
    static void get_best_ratio(u32 *pnum, u32 *pdenom, u32 max_n, u32 max_d)
    {
    let mut a: u32 = *pnum;
    let mut b: u32 = *pdenom;
    u32 c;
    u32 n[] = {0, 1};
    u32 d[] = {1, 0};
    u32 whole;
...
// pdenom = d[i];
    ...
    let mut ref_clk: c_ulong = clk_get_rate(priv.phy_ref_clk);
...
#[no_mangle]
pub unsafe extern "C" fn if(MBPS(90): dphy_opts->hs_clk_rate <) -> else {
    else if (dphy_opts.hs_clk_rate < MBPS(90))
    cfg.rxhs_settle = 0x0c;
#[no_mangle]
pub unsafe extern "C" fn if(MBPS(125): dphy_opts->hs_clk_rate <) -> else {
    else if (dphy_opts.hs_clk_rate < MBPS(125))
    cfg.rxhs_settle = 0x0b;
#[no_mangle]
pub unsafe extern "C" fn if(MBPS(150): dphy_opts->hs_clk_rate <) -> else {
    else if (dphy_opts.hs_clk_rate < MBPS(150))
    cfg.rxhs_settle = 0x0a;
#[no_mangle]
pub unsafe extern "C" fn if(MBPS(225): dphy_opts->hs_clk_rate <) -> else {
    else if (dphy_opts.hs_clk_rate < MBPS(225))
    cfg.rxhs_settle = 0x09;
#[no_mangle]
pub unsafe extern "C" fn if(MBPS(500): dphy_opts->hs_clk_rate <) -> else {
...
#[no_mangle]
unsafe extern "C" fn mixel_phy_set_hs_timings(phy: *mut phy) {
...
#[no_mangle]
unsafe extern "C" fn mixel_dphy_set_pll_params(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mixel_dphy_configure(phy: *mut phy, opts: *mut union phy_configure_opts) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(PHY_MODE_LVDS: phy->attrs.mode ==) -> else {
    ...
    let mut mipi_dphy_cfg: mixel_dphy_cfg = { 0 };
...
#[no_mangle]
unsafe extern "C" fn mixel_dphy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mixel_dphy_exit(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mixel_dphy_power_on_mipi_dphy(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mixel_dphy_power_on_lvds_phy(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mixel_dphy_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mixel_dphy_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mixel_dphy_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
    ...
    let mut rsc: u32 = priv.id ? IMX_SC_R_MIPI_1 : IMX_SC_R_MIPI_0;
...
#[no_mangle]
unsafe extern "C" fn mixel_dphy_probe(pdev: *mut platform_device) -> c_int {
