...
//! Source: drivers/phy/freescale/phy-fsl-samsung-hdmi.c
#![no_std]
...
pub const PHY_PLL_DIV_REGS_NUM: c_int = 7;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct phy_config {
    pub pixclk: u32,
    pub pll_div_regs: [u8; PHY_PLL_DIV_REGS_NUM],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_samsung_hdmi_phy {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn fsl_samsung_hdmi_phy_find_pms(fout: c_ulong, p: *mut u8, m: *mut u16, s: *mut u8) -> c_ulong {
...
// Calculate the absolute value of the differences and return whichever is closest
    ...
    req.rate);
    if (target_settings == core::ptr::null_mut())
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn phy_clk_register(phy: *mut fsl_samsung_hdmi_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_samsung_hdmi_phy_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_samsung_hdmi_phy_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn fsl_samsung_hdmi_phy_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn fsl_samsung_hdmi_phy_resume(dev: *mut device) -> int __maybe_unused {
    ...
    fsl_samsung_hdmi_phy_resume, core::ptr::null_mut());
