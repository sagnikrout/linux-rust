...
//! Source: drivers/phy/starfive/phy-jh7110-dphy-tx.c
#![no_std]
...
pub const STF_DPHY_AON_POWER_READY_N_ACTIVE: c_int = 0;

pub const STF_DPHY_REFCLK_12M: c_int = 1;
pub const STF_DPHY_BITRATE_ALIGN: c_int = 10000000;
pub const STF_MAP_LANES_NUM: c_int = 5;

pub const STF_DPHY_HW_DELAY_US: c_int = 200;
pub const STF_DPHY_HW_TIMEOUT_US: c_int = 5000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stf_dphy_config {
    pub bitrate: c_ulong,
    pub pll_fbk_int: u32,
    pub pll_fbk_fra_val: u32,
    pub extd_cycle_sel: u32,
    pub dlane_hs_pre_time: u32,
    pub dlane_hs_zero_time: u32,
    pub dlane_hs_trail_time: u32,
    pub clane_hs_pre_time: u32,
    pub clane_hs_zero_time: u32,
    pub clane_hs_trail_time: u32,
    pub clane_hs_clk_pre_time: u32,
    pub clane_hs_clk_post_time: u32,
}
...
pub struct stf_dphy {
    pub dev: *mut device,
    pub topsys: *mut void __iomem,
    pub txesc_clk: *mut clk,
...
#[no_mangle]
unsafe extern "C" fn stf_dphy_get_config_index(bitrate: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn stf_dphy_hw_reset(dphy: *mut stf_dphy, assert: c_int) {
...
unsafe extern "C" fn stf_dphy_configure(phy: *mut phy, opts: *mut union phy_configure_opts) -> c_int {
    ...
    let mut alignment: c_ulong = STF_DPHY_BITRATE_ALIGN;
    let mut bitrate: u32 = opts.mipi_dphy.hs_clk_rate;
    u32 tmp;
    u32 i;
...
#[no_mangle]
unsafe extern "C" fn stf_dphy_init(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stf_dphy_exit(phy: *mut phy) -> c_int {
