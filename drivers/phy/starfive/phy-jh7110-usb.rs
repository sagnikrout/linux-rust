...
//! Source: drivers/phy/starfive/phy-jh7110-usb.c
#![no_std]
...
pub const USB_125M_CLK_RATE: c_int = 125000000;
pub const USB_CLK_MODE_OFF: c_uint = 0x0;

pub const USB_LS_KEEPALIVE_OFF: c_uint = 0x4;

pub const SYSCON_USB_SPLIT_OFFSET: c_uint = 0x18;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct jh7110_usb2_phy {
    pub phy: *mut phy,
    pub regs: *mut void __iomem,
    pub sys_syscon: *mut regmap,
    pub usb_125m_clk: *mut clk,
    pub app_125m: *mut clk,
    pub mode: enum phy_mode,
}

#[no_mangle]
unsafe extern "C" fn usb2_set_ls_keepalive(phy: *mut jh7110_usb2_phy, set: bool) {
...
#[no_mangle]
unsafe extern "C" fn jh7110_usb2_phy_init(_phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jh7110_usb2_phy_exit(_phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jh7110_usb_phy_probe(pdev: *mut platform_device) -> c_int {
    ...
    phy.phy = devm_phy_create(dev, core::ptr::null_mut(), &jh7110_usb2_phy_ops);
    if (IS_ERR(phy.phy))
