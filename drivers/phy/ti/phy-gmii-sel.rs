...
//! Source: drivers/phy/ti/phy-gmii-sel.c
#![no_std]
...
pub const J72XX_GMII_SEL_MODE_SGMII: c_int = 3;
pub const J72XX_GMII_SEL_MODE_QSGMII: c_int = 4;
pub const J72XX_GMII_SEL_MODE_USXGMII: c_int = 5;
pub const J72XX_GMII_SEL_MODE_QSGMII_SUB: c_int = 6;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct phy_gmii_sel_phy_priv {
    pub priv: *mut phy_gmii_sel_priv,
    pub id: u32,
    pub if_phy: *mut phy,
    pub rmii_clock_external: c_int,
    pub phy_if_mode: c_int,
    pub fields: [*mut regmap_field; PHY_GMII_SEL_LAST],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct phy_gmii_sel_soc_data {
    pub num_ports: u32,
    pub features: u32,
    pub (*regfields)[PHY_GMII_SEL_LAST]: *const reg_field,
    pub use_of_data: bool,
    pub extra_modes: u64,
    pub num_qsgmii_main_ports: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct phy_gmii_sel_priv {
    pub dev: *mut device,
    pub soc_data: *const phy_gmii_sel_soc_data,
    pub regmap: *mut regmap,
    pub phy_provider: *mut phy_provider,
    pub if_phys: *mut phy_gmii_sel_phy_priv,
    pub num_ports: u32,
    pub reg_offset: u32,
    pub qsgmii_main_ports: u32,
    pub no_offset: bool,
}

#[no_mangle]
unsafe extern "C" fn phy_gmii_sel_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
// With a fixed delay, some modes are not supported at all.
    ...
    let mut phy_id: c_int = args.args[0];
...
#[no_mangle]
unsafe extern "C" fn phy_gmii_sel_init_ports(priv: *mut phy_gmii_sel_priv) -> c_int {
    ...
    const __be32 *offset;
    u64 size;
    offset = of_get_address(dev.of_node, 0, &size, core::ptr::null_mut());
    if (!offset)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn phy_gmii_sel_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_gmii_sel_resume_noirq(dev: *mut device) -> c_int {
    ...
    static DEFINE_NOIRQ_DEV_PM_OPS(phy_gmii_sel_pm_ops, core::ptr::null_mut(), phy_gmii_sel_resume_noirq);
