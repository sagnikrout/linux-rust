...
//! Source: drivers/phy/ti/phy-tusb1210.c
#![no_std]
...
pub const TI_DEVICE_TUSB1210: c_uint = 0x1507;
pub const TI_DEVICE_TUSB1211: c_uint = 0x1508;
pub const TUSB1211_POWER_CONTROL: c_uint = 0x3d;
pub const TUSB1211_POWER_CONTROL_SET: c_uint = 0x3e;
pub const TUSB1211_POWER_CONTROL_CLEAR: c_uint = 0x3f;

pub const TUSB1210_VENDOR_SPECIFIC2: c_uint = 0x80;

pub const TUSB1211_VENDOR_SPECIFIC3: c_uint = 0x85;
pub const TUSB1211_VENDOR_SPECIFIC3_SET: c_uint = 0x86;
pub const TUSB1211_VENDOR_SPECIFIC3_CLEAR: c_uint = 0x87;

pub const TUSB1210_RESET_TIME_MS: c_int = 50;
pub const TUSB1210_CHG_DET_MAX_RETRIES: c_int = 5;
...
pub struct tusb1210 {
    ...
    pub otg_ctrl: u8,
    pub vendor_specific2: u8,

    pub chg_type: enum power_supply_usb_type,
    pub chg_det_state: enum tusb1210_chg_det_state,
    pub chg_det_retries: c_int,
    pub chg_det_work: delayed_work,
...
#[no_mangle]
unsafe extern "C" fn tusb1210_ulpi_write(tusb: *mut tusb1210, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tusb1210_ulpi_read(tusb: *mut tusb1210, reg: u8, val: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tusb1210_power_on(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tusb1210_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tusb1210_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tusb1210_reset(tusb: *mut tusb1210) {
...
#[no_mangle]
unsafe extern "C" fn tusb1210_chg_det_handle_ulpi_error(tusb: *mut tusb1210) {
...
#[no_mangle]
unsafe extern "C" fn tusb1210_get_online(tusb: *mut tusb1210) -> bool {
    static bool tusb1210_get_online(struct tusb1210 *tusb)
    {
    struct power_supply *charger = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tusb1210_chg_det_work(work: *mut work_struct) {
    static void tusb1210_chg_det_work(struct work_struct *work)
    {
    struct tusb1210 *tusb = container_of(work, struct tusb1210, chg_det_work.work);
    let mut vbus_present: bool = tusb1210_get_online(tusb);
    int ret;
    u8 val;
...
#[no_mangle]
unsafe extern "C" fn tusb1210_probe_charger_detect(tusb: *mut tusb1210) {
    static void tusb1210_probe_charger_detect(struct tusb1210 *tusb)
    {
    let mut psy_cfg: power_supply_config = { .drv_data = tusb };
    struct device *dev = tusb.dev;
...
#[no_mangle]
unsafe extern "C" fn tusb1210_remove_charger_detect(tusb: *mut tusb1210) {
...
#[no_mangle]
unsafe extern "C" fn tusb1210_probe(ulpi: *mut ulpi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tusb1210_remove(ulpi: *mut ulpi) {
