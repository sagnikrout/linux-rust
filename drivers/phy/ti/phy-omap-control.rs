...
//! Source: drivers/phy/ti/phy-omap-control.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn omap_control_pcie_pcs(dev: *mut device, delay: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap_control_phy_power(dev: *mut device, on: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn omap_control_usb_host_mode(ctrl_phy: *mut omap_control_phy) {
...
//
#[no_mangle]
unsafe extern "C" fn omap_control_usb_device_mode(ctrl_phy: *mut omap_control_phy) {
...
//
#[no_mangle]
unsafe extern "C" fn omap_control_usb_set_sessionend(ctrl_phy: *mut omap_control_phy) {
...
//
    ...
    let mut otghs_data: static enum omap_control_phy_type = OMAP_CTRL_TYPE_OTGHS;
    let mut usb2_data: static enum omap_control_phy_type = OMAP_CTRL_TYPE_USB2;
    let mut pipe3_data: static enum omap_control_phy_type = OMAP_CTRL_TYPE_PIPE3;
    let mut pcie_data: static enum omap_control_phy_type = OMAP_CTRL_TYPE_PCIE;
    let mut dra7usb2_data: static enum omap_control_phy_type = OMAP_CTRL_TYPE_DRA7USB2;
    let mut am437usb2_data: static enum omap_control_phy_type = OMAP_CTRL_TYPE_AM437USB2;
...
#[no_mangle]
unsafe extern "C" fn omap_control_phy_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_control_phy_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn omap_control_phy_exit() -> void __exit {
