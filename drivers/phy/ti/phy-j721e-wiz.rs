...
//! Source: drivers/phy/ti/phy-j721e-wiz.c
#![no_std]
...
// SCM offsets
pub const SERDES_SUP_CTRL: c_uint = 0x4400;
// SERDES offsets
pub const WIZ_SERDES_CTRL: c_uint = 0x404;
pub const WIZ_SERDES_TOP_CTRL: c_uint = 0x408;
pub const WIZ_SERDES_RST: c_uint = 0x40c;
pub const WIZ_SERDES_TYPEC: c_uint = 0x410;

pub const WIZ_MAX_INPUT_CLOCKS: c_int = 4;
// To include mux clocks, divider clocks and gate clocks
pub const WIZ_MAX_OUTPUT_CLOCKS: c_int = 32;
pub const WIZ_MAX_LANES: c_int = 4;
pub const WIZ_MUX_NUM_CLOCKS: c_int = 3;
pub const WIZ_DIV_NUM_CLOCKS_16G: c_int = 2;
pub const WIZ_DIV_NUM_CLOCKS_10G: c_int = 1;
...
//
    ...
    let mut por_en: static struct reg_field = REG_FIELD(WIZ_SERDES_CTRL, 31, 31);
    let mut phy_reset_n: static struct reg_field = REG_FIELD(WIZ_SERDES_RST, 31, 31);
    let mut phy_en_refclk: static struct reg_field = REG_FIELD(WIZ_SERDES_RST, 30, 30);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wiz_clk_mux_sel {
    pub table: [u32; WIZ_MAX_INPUT_CLOCKS],
    pub node_name: *const c_char,
    pub num_parents: u32,
    pub parents: [u32; WIZ_MAX_INPUT_CLOCKS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct wiz_clk_div_sel {
    pub table: *const clk_div_table,
    pub node_name: *const c_char,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wiz_phy_en_refclk {
    pub hw: clk_hw,
    pub phy_en_refclk: *mut regmap_field,
    pub clk_data: clk_init_data,
}
...
#[derive(Copy, Clone)]
pub struct wiz_data {
    pub type: enum wiz_type,
    pub pll0_refclk_mux_sel: *const reg_field,
    pub pll1_refclk_mux_sel: *const reg_field,
    pub refclk_dig_sel: *const reg_field,
    pub pma_cmn_refclk1_dig_div: *const reg_field,
    pub pma_cmn_refclk1_int_mode: *const reg_field,
    pub clk_mux_sel: *const wiz_clk_mux_sel,
    pub clk_div_sel_num: c_uint,
}

pub const WIZ_TYPEC_DIR_DEBOUNCE_MAX: c_int = 1000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wiz {
    pub regmap: *mut regmap,
    pub scm_regmap: *mut regmap,
    pub type: enum wiz_type,
    pub clk_mux_sel: *const wiz_clk_mux_sel,
    pub clk_div_sel: *const wiz_clk_div_sel,
    pub clk_div_sel_num: c_uint,
    pub por_en: *mut regmap_field,
    pub phy_reset_n: *mut regmap_field,
    pub phy_en_refclk: *mut regmap_field,
    pub p_enable: [*mut regmap_field; WIZ_MAX_LANES],
    pub p_align: [*mut regmap_field; WIZ_MAX_LANES],
    pub p_raw_auto_start: [*mut regmap_field; WIZ_MAX_LANES],
    pub p_standard_mode: [*mut regmap_field; WIZ_MAX_LANES],
    pub p_mac_div_sel0: [*mut regmap_field; WIZ_MAX_LANES],
    pub p_mac_div_sel1: [*mut regmap_field; WIZ_MAX_LANES],
    pub p0_fullrt_div: [*mut regmap_field; WIZ_MAX_LANES],
    pub p0_mac_src_sel: [*mut regmap_field; WIZ_MAX_LANES],
    pub p0_rxfclk_sel: [*mut regmap_field; WIZ_MAX_LANES],
    pub p0_refclk_sel: [*mut regmap_field; WIZ_MAX_LANES],
    pub pma_cmn_refclk_int_mode: *mut regmap_field,
    pub pma_cmn_refclk1_int_mode: *mut regmap_field,
    pub pma_cmn_refclk_mode: *mut regmap_field,
    pub pma_cmn_refclk_dig_div: *mut regmap_field,
    pub pma_cmn_refclk1_dig_div: *mut regmap_field,
    pub mux_sel_field: [*mut regmap_field; WIZ_MUX_NUM_CLOCKS],
    pub div_sel_field: [*mut regmap_field; WIZ_DIV_NUM_CLOCKS_16G],
    pub typec_ln10_swap: *mut regmap_field,
    pub typec_ln23_swap: *mut regmap_field,
    pub sup_legacy_clk_override: *mut regmap_field,
    pub dev: *mut device,
    pub num_lanes: u32,
    pub serdes_pdev: *mut platform_device,
    pub wiz_phy_reset_dev: reset_controller_dev,
    pub gpio_typec_dir: *mut gpio_desc,
    pub typec_dir_delay: c_int,
    pub lane_phy_type: [u32; WIZ_MAX_LANES],
    pub master_lane_num: [u32; WIZ_MAX_LANES],
    pub input_clks: [*mut clk; WIZ_MAX_INPUT_CLOCKS],
    pub output_clks: [*mut clk; WIZ_MAX_OUTPUT_CLOCKS],
    pub clk_data: clk_onecell_data,
    pub data: *const wiz_data,
    pub mux_sel_status: [c_int; WIZ_MUX_NUM_CLOCKS],
}

#[no_mangle]
unsafe extern "C" fn wiz_reset(wiz: *mut wiz) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiz_p_mac_div_sel(wiz: *mut wiz) -> c_int {
    static int wiz_p_mac_div_sel(struct wiz *wiz)
    {
    let mut num_lanes: u32 = wiz.num_lanes;
    int ret;
    int i;
...
#[no_mangle]
unsafe extern "C" fn wiz_mode_select(wiz: *mut wiz) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiz_init_raw_interface(wiz: *mut wiz, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiz_init(wiz: *mut wiz) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiz_regfield_init(wiz: *mut wiz) -> c_int {
    static int wiz_regfield_init(struct wiz *wiz)
    {
    struct regmap *regmap = wiz.regmap;
    struct regmap *scm_regmap = wiz.regmap; /* updated later to scm_regmap if applicable */
    let mut num_lanes: c_int = wiz.num_lanes;
    struct device *dev = wiz.dev;
...
#[no_mangle]
unsafe extern "C" fn wiz_phy_en_refclk_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiz_phy_en_refclk_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn wiz_phy_en_refclk_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiz_phy_en_refclk_register(wiz: *mut wiz) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiz_clk_mux_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn wiz_clk_mux_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiz_clock_cleanup(wiz: *mut wiz, node: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn wiz_clock_register(wiz: *mut wiz) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiz_clock_init(wiz: *mut wiz) {
...
#[no_mangle]
unsafe extern "C" fn wiz_clock_probe(wiz: *mut wiz, node: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiz_phy_fullrt_div(wiz: *mut wiz, lane: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiz_get_lane_phy_types(dev: *mut device, wiz: *mut wiz) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiz_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut already_configured: bool = false;
    ...
    if (!data) {
    dev_err(dev, "core::ptr::null_mut() device data\n");
    return -EINVAL;
    }
    wiz.data = data;
    wiz.type = data.type;
    ...
    wiz.scm_regmap = core::ptr::null_mut();
    }
...
// Reset for each of the lane and one for the entire SERDES
    ...
    serdes_pdev = of_platform_device_create(child_node, core::ptr::null_mut(), dev);
    if (!serdes_pdev) {
...
#[no_mangle]
unsafe extern "C" fn wiz_remove(pdev: *mut platform_device) {
    ...
    of_platform_device_destroy(&serdes_pdev.dev, core::ptr::null_mut());
    wiz_clock_cleanup(wiz, node);
    pm_runtime_put(dev);
    pm_runtime_disable(dev);
    }
#[no_mangle]
unsafe extern "C" fn wiz_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wiz_resume_noirq(dev: *mut device) -> c_int {
