...
//! Source: drivers/phy/ti/phy-ti-pipe3.c
#![no_std]
...
pub const PLL_STATUS: c_uint = 0x00000004;
pub const PLL_GO: c_uint = 0x00000008;
pub const PLL_CONFIGURATION1: c_uint = 0x0000000C;
pub const PLL_CONFIGURATION2: c_uint = 0x00000010;
pub const PLL_CONFIGURATION3: c_uint = 0x00000014;
pub const PLL_CONFIGURATION4: c_uint = 0x00000020;
pub const PLL_REGM_MASK: c_uint = 0x001FFE00;
pub const PLL_REGM_SHIFT: c_uint = 0x9;
pub const PLL_REGM_F_MASK: c_uint = 0x0003FFFF;
pub const PLL_REGM_F_SHIFT: c_uint = 0x0;
pub const PLL_REGN_MASK: c_uint = 0x000001FE;
pub const PLL_REGN_SHIFT: c_uint = 0x1;
pub const PLL_SELFREQDCO_MASK: c_uint = 0x0000000E;
pub const PLL_SELFREQDCO_SHIFT: c_uint = 0x1;
pub const PLL_SD_MASK: c_uint = 0x0003FC00;
pub const PLL_SD_SHIFT: c_int = 10;
pub const SET_PLL_GO: c_uint = 0x1;

pub const PLL_LOCK: c_uint = 0x2;
pub const PLL_IDLE: c_uint = 0x1;

pub const PIPE3_PHY_PWRCTL_CLK_CMD_SHIFT: c_int = 14;

pub const PIPE3_PHY_PWRCTL_CLK_FREQ_SHIFT: c_int = 22;

pub const PCIE_PCS_MASK: c_uint = 0xFF0000;
pub const PCIE_PCS_DELAY_COUNT_SHIFT: c_uint = 0x10;
pub const PIPE3_PHY_RX_ANA_PROGRAMMABILITY: c_uint = 0x0000000C;

pub const INTERFACE_SHIFT: c_int = 27;

pub const LOSD_SHIFT: c_int = 14;

pub const PIPE3_PHY_RX_TRIM: c_uint = 0x0000001C;

pub const MEM_DLL_TRIM_SHIFT: c_int = 30;
pub const PIPE3_PHY_RX_DLL: c_uint = 0x00000024;

pub const MEM_DLL_PHINT_RATE_SHIFT: c_int = 30;
pub const PIPE3_PHY_RX_DIGITAL_MODES: c_uint = 0x00000028;

pub const MEM_HS_RATE_SHIFT: c_int = 27;

pub const MEM_OVRD_HS_RATE_SHIFT: c_int = 26;

pub const MEM_CDR_FASTLOCK_SHIFT: c_int = 23;

pub const MEM_CDR_LBW_SHIFT: c_int = 21;

pub const MEM_CDR_STEPCNT_SHIFT: c_int = 19;

pub const MEM_CDR_STL_SHIFT: c_int = 16;

pub const MEM_CDR_THR_SHIFT: c_int = 13;

pub const MEM_CDR_THR_MODE_SHIFT: c_int = 12;

pub const MEM_CDR_2NDO_SDM_MODE_SHIFT: c_int = 11;
pub const PIPE3_PHY_RX_EQUALIZER: c_uint = 0x00000038;

pub const MEM_EQLEV_SHIFT: c_int = 16;

pub const MEM_EQFTC_SHIFT: c_int = 11;

pub const MEM_EQCTL_SHIFT: c_int = 7;

pub const MEM_OVRD_EQLEV_SHIFT: c_int = 2;

pub const MEM_OVRD_EQFTC_SHIFT: c_int = 1;
pub const SATA_PHY_RX_IO_AND_A2D_OVERRIDES: c_uint = 0x44;

pub const MEM_CDR_LOS_SOURCE_SHIFT: c_int = 9;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pipe3_dpll_map {
    pub rate: c_ulong,
    pub params: pipe3_dpll_params,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pipe3_settings {
    pub ana_interface: u8,
    pub ana_losd: u8,
    pub dig_fastlock: u8,
    pub dig_lbw: u8,
    pub dig_stepcnt: u8,
    ...
    pub dig_thr: u8,
    pub dig_thr_mode: u8,
    pub dig_2ndo_sdm_mode: u8,
    pub dig_hs_rate: u8,
    pub dig_ovrd_hs_rate: u8,
    pub dll_trim_sel: u8,
    pub dll_phint_rate: u8,
    pub eq_lev: u8,
    pub eq_ftc: u8,
    pub eq_ctl: u8,
    pub eq_ovrd_lev: u8,
...
pub struct ti_pipe3 {
    ...
    pub phy_rx: *mut void __iomem,
    pub phy_tx: *mut void __iomem,
    pub dev: *mut device,
    ...
    pub refclk: *mut clk,
    pub div_clk: *mut clk,
    pub dpll_map: *mut pipe3_dpll_map,
    pub /: *mut *mut *mut regmap phy_power_syscon; / ctrl. reg. acces,
    pub /: *mut *mut *mut regmap pcs_syscon; / ctrl. reg. acces,
    pub /: *mut *mut *mut regmap dpll_reset_syscon; / ctrl. reg. acces,
    pub /: *mut *mut unsigned int dpll_reset_reg; / reg. index within syscon,
    pub /: *mut *mut unsigned int power_reg; / power reg. index within syscon,
    pub /: *mut *mut unsigned int pcie_pcs_reg; / pcs reg. index in syscon,
    pub sata_refclk_enabled: bool,
    pub mode: enum pipe3_mode,
    pub settings: pipe3_settings,
}
...
#[no_mangle]
pub unsafe extern "C" fn ti_pipe3_readl(addr: *mut void __iomem, offset: unsigned) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_power_off(x: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_power_on(x: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_dpll_wait_lock(phy: *mut ti_pipe3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_dpll_program(phy: *mut ti_pipe3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_calibrate(phy: *mut ti_pipe3) {
    static void ti_pipe3_calibrate(struct ti_pipe3 *phy)
    {
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_init(x: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_exit(x: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_get_clk(phy: *mut ti_pipe3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_put_device(_dev: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_get_sysctrl(phy: *mut ti_pipe3) -> c_int {
    ...
    phy.phy_power_syscon = core::ptr::null_mut();
    } else {
    ...
    phy.pcs_syscon = core::ptr::null_mut();
    } else {
    if (of_property_read_u32_index(node,
    "syscon-pcs", 1,
    &phy.pcie_pcs_reg)) {
    ...
    phy.dpll_reset_syscon = core::ptr::null_mut();
    } else {
    if (of_property_read_u32_index(node,
    "syscon-pllreset", 1,
    &phy.dpll_reset_reg)) {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_get_tx_rx_base(phy: *mut ti_pipe3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_get_pll_base(phy: *mut ti_pipe3) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_enable_clocks(phy: *mut ti_pipe3) -> c_int {
    static int ti_pipe3_enable_clocks(struct ti_pipe3 *phy)
    {
    let mut ret: c_int = 0;
    if (!IS_ERR(phy.refclk)) {
...
#[no_mangle]
unsafe extern "C" fn ti_pipe3_disable_clocks(phy: *mut ti_pipe3) {
    static void ti_pipe3_disable_clocks(struct ti_pipe3 *phy)
    {
    if (!IS_ERR(phy.wkupclk))
    clk_disable_unprepare(phy.wkupclk);
