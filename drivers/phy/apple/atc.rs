...
//! Source: drivers/phy/apple/atc.c
#![no_std]
...
pub const AUSPLL_FSM_CTRL: c_uint = 0x1014;
pub const AUSPLL_APB_CMD_OVERRIDE: c_uint = 0x2000;

pub const AUSPLL_FREQ_DESC_A: c_uint = 0x2080;

pub const AUSPLL_FREQ_DESC_B: c_uint = 0x2084;

pub const AUSPLL_FREQ_DESC_C: c_uint = 0x2088;

pub const AUSPLL_DCO_EFUSE_SPARE: c_uint = 0x222c;

pub const AUSPLL_FRACN_CAN: c_uint = 0x22a4;

pub const AUSPLL_CLKOUT_MASTER: c_uint = 0x2200;

pub const AUSPLL_CLKOUT_DIV: c_uint = 0x2208;

pub const AUSPLL_BGR: c_uint = 0x2214;

pub const AUSPLL_CLKOUT_DTC_VREG: c_uint = 0x2220;

pub const AUSPLL_FREQ_CFG: c_uint = 0x2224;

pub const AUS_COMMON_SHIM_BLK_VREG: c_uint = 0x0a04;

pub const AUS_UNK_A20: c_uint = 0x0a20;

pub const ACIOPHY_CMN_SHM_STS_REG0: c_uint = 0x0a74;

pub const CIO3PLL_CLK_CTRL: c_uint = 0x2a00;

pub const CIO3PLL_DCO_NCTRL: c_uint = 0x2a38;

pub const CIO3PLL_FRACN_CAN: c_uint = 0x2aa4;

pub const CIO3PLL_DTC_VREG: c_uint = 0x2a20;

pub const ACIOPHY_CFG0: c_uint = 0x08;

pub const ACIOPHY_CROSSBAR: c_uint = 0x4c;

pub const ACIOPHY_CROSSBAR_PROTOCOL_USB4: c_uint = 0x0;
pub const ACIOPHY_CROSSBAR_PROTOCOL_USB4_SWAPPED: c_uint = 0x1;
pub const ACIOPHY_CROSSBAR_PROTOCOL_USB3: c_uint = 0xa;
pub const ACIOPHY_CROSSBAR_PROTOCOL_USB3_SWAPPED: c_uint = 0xb;
pub const ACIOPHY_CROSSBAR_PROTOCOL_USB3_DP: c_uint = 0x10;
pub const ACIOPHY_CROSSBAR_PROTOCOL_USB3_DP_SWAPPED: c_uint = 0x11;
pub const ACIOPHY_CROSSBAR_PROTOCOL_DP: c_uint = 0x14;

pub const ACIOPHY_CROSSBAR_DP_SINGLE_PMA_NONE: c_uint = 0x0000;
pub const ACIOPHY_CROSSBAR_DP_SINGLE_PMA_UNK100: c_uint = 0x100;
pub const ACIOPHY_CROSSBAR_DP_SINGLE_PMA_UNK008: c_uint = 0x008;

pub const ACIOPHY_LANE_MODE: c_uint = 0x48;
...
pub const ACIOPHY_TOP_BIST_CIOPHY_CFG1: c_uint = 0x84;

pub const ACIOPHY_TOP_BIST_OV_CFG: c_uint = 0x8c;

pub const ACIOPHY_TOP_BIST_READ_CTRL: c_uint = 0x90;

pub const ACIOPHY_TOP_PHY_STAT: c_uint = 0x9c;

pub const ACIOPHY_TOP_BIST_PHY_CFG0: c_uint = 0xa8;

pub const ACIOPHY_TOP_BIST_PHY_CFG1: c_uint = 0xac;

pub const ACIOPHY_SLEEP_CTRL: c_uint = 0x1b0;

pub const ACIOPHY_PLL_PCTL_FSM_CTRL1: c_uint = 0x1014;

pub const ACIOPHY_PLL_COMMON_CTRL: c_uint = 0x1028;

pub const ATCPHY_POWER_CTRL: c_uint = 0x20000;
pub const ATCPHY_POWER_STAT: c_uint = 0x20004;

pub const ATCPHY_MISC: c_uint = 0x20008;

pub const ACIOPHY_LANE_DP_CFG_BLK_TX_DP_CTRL0: c_uint = 0x7000;

pub const ACIOPHY_DP_PCLK_STAT: c_uint = 0x7044;

pub const LN0_AUSPMA_RX_TOP: c_uint = 0x9000;
pub const LN0_AUSPMA_RX_EQ: c_uint = 0xA000;
pub const LN0_AUSPMA_RX_SHM: c_uint = 0xB000;
pub const LN0_AUSPMA_TX_TOP: c_uint = 0xC000;
pub const LN0_AUSPMA_TX_SHM: c_uint = 0xD000;
pub const LN1_AUSPMA_RX_TOP: c_uint = 0x10000;
pub const LN1_AUSPMA_RX_EQ: c_uint = 0x11000;
pub const LN1_AUSPMA_RX_SHM: c_uint = 0x12000;
pub const LN1_AUSPMA_TX_TOP: c_uint = 0x13000;
pub const LN1_AUSPMA_TX_SHM: c_uint = 0x14000;
pub const LN_AUSPMA_RX_TOP_PMAFSM: c_uint = 0x0010;

pub const LN_AUSPMA_RX_TOP_TJ_CFG_RX_TXMODE: c_uint = 0x00F0;

pub const LN_AUSPMA_RX_SHM_TJ_RXA_CTLE_CTRL0: c_uint = 0x00;

pub const LN_AUSPMA_RX_SHM_TJ_RXA_AFE_CTRL1: c_uint = 0x04;

pub const LN_AUSPMA_RX_SHM_TJ_RXA_UNK_CTRL2: c_uint = 0x08;
pub const LN_AUSPMA_RX_SHM_TJ_RXA_UNK_CTRL3: c_uint = 0x0C;
pub const LN_AUSPMA_RX_SHM_TJ_RXA_UNK_CTRL4: c_uint = 0x10;
pub const LN_AUSPMA_RX_SHM_TJ_RXA_UNK_CTRL5: c_uint = 0x14;
pub const LN_AUSPMA_RX_SHM_TJ_RXA_UNK_CTRL6: c_uint = 0x18;
pub const LN_AUSPMA_RX_SHM_TJ_RXA_UNK_CTRL7: c_uint = 0x1C;
pub const LN_AUSPMA_RX_SHM_TJ_RXA_UNK_CTRL8: c_uint = 0x20;
pub const LN_AUSPMA_RX_SHM_TJ_RXA_UNK_CTRL9: c_uint = 0x24;
pub const LN_AUSPMA_RX_SHM_TJ_RXA_DFE_CTRL10: c_uint = 0x28;

pub const LN_AUSPMA_RX_SHM_TJ_RXA_DFE_CTRL11: c_uint = 0x2C;

pub const LN_AUSPMA_RX_SHM_TJ_RXA_DFE_CTRL12: c_uint = 0x30;

pub const LN_AUSPMA_RX_SHM_TJ_RXA_DFE_CTRL13: c_uint = 0x34;

pub const LN_AUSPMA_RX_SHM_TJ_UNK_CTRL14A: c_uint = 0x38;
pub const LN_AUSPMA_RX_SHM_TJ_UNK_CTRL14B: c_uint = 0x3C;
pub const LN_AUSPMA_RX_SHM_TJ_UNK_CTRL15A: c_uint = 0x40;
pub const LN_AUSPMA_RX_SHM_TJ_UNK_CTRL15B: c_uint = 0x44;
pub const LN_AUSPMA_RX_SHM_TJ_RXA_SAVOS_CTRL16: c_uint = 0x48;

pub const LN_AUSPMA_RX_SHM_TJ_RXA_TX_CTRL17: c_uint = 0x4C;

pub const LN_AUSPMA_RX_SHM_TJ_RXA_TX_CTRL18: c_uint = 0x50;

pub const LN_AUSPMA_RX_SHM_TJ_RXA_TERM_CTRL19: c_uint = 0x54;

pub const LN_AUSPMA_RX_SHM_TJ_RXA_UNK_CTRL20: c_uint = 0x58;
pub const LN_AUSPMA_RX_SHM_TJ_RXA_UNK_CTRL21: c_uint = 0x5C;
pub const LN_AUSPMA_RX_SHM_TJ_RXA_VREF_CTRL22: c_uint = 0x60;

pub const LN_AUSPMA_TX_SHM_TXA_CFG_MAIN_REG0: c_uint = 0x00;

pub const LN_AUSPMA_TX_SHM_TXA_CFG_MAIN_REG1: c_uint = 0x04;

pub const LN_AUSPMA_TX_SHM_TXA_IMP_REG0: c_uint = 0x08;

pub const LN_AUSPMA_TX_SHM_TXA_IMP_REG1: c_uint = 0x0C;
pub const LN_AUSPMA_TX_SHM_TXA_IMP_REG2: c_uint = 0x10;

pub const LN_AUSPMA_TX_SHM_TXA_IMP_REG3: c_uint = 0x14;

pub const LN_AUSPMA_TX_SHM_TXA_UNK_REG0: c_uint = 0x18;
pub const LN_AUSPMA_TX_SHM_TXA_UNK_REG1: c_uint = 0x1C;
pub const LN_AUSPMA_TX_SHM_TXA_UNK_REG2: c_uint = 0x20;
pub const LN_AUSPMA_TX_SHM_TXA_LDOCLK: c_uint = 0x24;

// LPDPTX registers
pub const LPDPTX_AUX_CFG_BLK_AUX_CTRL: c_uint = 0x0000;

pub const LPDPTX_AUX_CFG_BLK_AUX_LDO_CTRL: c_uint = 0x0008;
pub const LPDPTX_AUX_CFG_BLK_AUX_MARGIN: c_uint = 0x000c;

pub const LPDPTX_AUX_SHM_CFG_BLK_AUX_CTRL_REG0: c_uint = 0x0204;

pub const LPDPTX_AUX_SHM_CFG_BLK_AUX_CTRL_REG1: c_uint = 0x0208;

pub const LPDPTX_AUX_CONTROL: c_uint = 0x4000;
pub const LPDPTX_AUX_PWN_DOWN: c_uint = 0x10;
pub const LPDPTX_AUX_CLAMP_EN: c_uint = 0x04;
pub const LPDPTX_SLEEP_B_BIG_IN: c_uint = 0x02;
pub const LPDPTX_SLEEP_B_SML_IN: c_uint = 0x01;
pub const LPDPTX_TXTERM_CODEMSB: c_uint = 0x400;

// pipehandler registers
pub const PIPEHANDLER_OVERRIDE: c_uint = 0x00;

pub const PIPEHANDLER_OVERRIDE_VALUES: c_uint = 0x04;

pub const PIPEHANDLER_MUX_CTRL: c_uint = 0x0c;

pub const PIPEHANDLER_MUX_CTRL_CLK_OFF: c_int = 0;
pub const PIPEHANDLER_MUX_CTRL_CLK_USB3: c_int = 1;
pub const PIPEHANDLER_MUX_CTRL_CLK_USB4: c_int = 2;
pub const PIPEHANDLER_MUX_CTRL_CLK_DUMMY: c_int = 4;
pub const PIPEHANDLER_MUX_CTRL_DATA_USB3: c_int = 0;
pub const PIPEHANDLER_MUX_CTRL_DATA_USB4: c_int = 1;
pub const PIPEHANDLER_MUX_CTRL_DATA_DUMMY: c_int = 2;
pub const PIPEHANDLER_LOCK_REQ: c_uint = 0x10;
pub const PIPEHANDLER_LOCK_ACK: c_uint = 0x14;

pub const PIPEHANDLER_AON_GEN: c_uint = 0x1C;

pub const PIPEHANDLER_NONSELECTED_OVERRIDE: c_uint = 0x20;

pub const PIPEHANDLER_LOCK_ACK_TIMEOUT_US: c_int = 1000;
// USB2 PHY regs
pub const USB2PHY_USBCTL: c_uint = 0x00;
pub const USB2PHY_USBCTL_RUN: c_int = 2;
pub const USB2PHY_USBCTL_ISOLATION: c_int = 4;
pub const USB2PHY_CTL: c_uint = 0x04;

pub const USB2PHY_SIG: c_uint = 0x08;

pub const USB2PHY_MISCTUNE: c_uint = 0x1c;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atcphy_dp_link_rate_configuration {
    pub freqinit_count_target: u16,
    pub fbdivn_frac_den: u16,
    pub fbdivn_frac_num: u16,
    pub pclk_div_sel: u16,
    pub lfclk_ctrl: u8,
    pub vclk_op_divn: u8,
    pub plla_clkout_vreg_bypass: bool,
    pub txa_ldoclk_bypass: bool,
    pub txa_div2_en: bool,
}

// Crossbar and lane configuration
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atcphy_mode_configuration {
    pub crossbar: u32,
    pub crossbar_dp_single_pma: u32,
    pub crossbar_dp_both_pma: bool,
    pub lane_mode: [enum atcphy_lane_mode; 2],
    pub dp_lane: [bool; 2],
    pub set_swap: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_atcphy {
    pub np: *mut device_node,
    pub dev: *mut device,
    struct {
    pub axi2af: *mut apple_tunable,
    pub common: [*mut apple_tunable; 2],
    pub lane_usb3: [*mut apple_tunable; 2],
    pub lane_dp: [*mut apple_tunable; 2],
    pub lane_usb4: [*mut apple_tunable; 2],
    pub tunables: },
    pub mode: enum atcphy_mode,
    pub swap_lanes: bool,
    pub dp_link_rate: c_int,
    pub pipehandler_up: bool,
    struct {
    pub core: *mut void __iomem,
    pub axi2af: *mut void __iomem,
    pub usb2phy: *mut void __iomem,
    pub pipehandler: *mut void __iomem,
    pub lpdptx: *mut void __iomem,
    pub regs: },
    struct {
    pub core: *mut resource,
    pub axi2af: *mut resource,
    pub res: },
    struct {
    pub usb2: *mut phy,
    pub usb3: *mut phy,
...
#[no_mangle]
pub unsafe extern "C" fn mask32(reg: *mut void __iomem, mask: u32, set: u32) {
    static inline void mask32(void __iomem *reg, u32 mask, u32 set)
    {
    let mut value: u32 = readl(reg);
    value &= ~mask;
    value |= set;
    writel(value, reg);
    }
#[no_mangle]
pub unsafe extern "C" fn core_mask32(atcphy: *mut apple_atcphy, reg: u32, mask: u32, set: u32) {
    static inline void core_mask32(struct apple_atcphy *atcphy, u32 reg, u32 mask, u32 set)
    {
    mask32(atcphy.regs.core + reg, mask, set);
    }
#[no_mangle]
pub unsafe extern "C" fn set32(reg: *mut void __iomem, set: u32) {
    static inline void set32(void __iomem *reg, u32 set)
    {
    mask32(reg, 0, set);
    }
#[no_mangle]
pub unsafe extern "C" fn core_set32(atcphy: *mut apple_atcphy, reg: u32, set: u32) {
    static inline void core_set32(struct apple_atcphy *atcphy, u32 reg, u32 set)
    {
    core_mask32(atcphy, reg, 0, set);
    }
#[no_mangle]
pub unsafe extern "C" fn clear32(reg: *mut void __iomem, clear: u32) {
    static inline void clear32(void __iomem *reg, u32 clear)
    {
    mask32(reg, clear, 0);
    }
#[no_mangle]
pub unsafe extern "C" fn core_clear32(atcphy: *mut apple_atcphy, reg: u32, clear: u32) {
...
#[no_mangle]
unsafe extern "C" fn atcphy_apply_tunables(atcphy: *mut apple_atcphy, mode: enum atcphy_mode) {
    static void atcphy_apply_tunables(struct apple_atcphy *atcphy, enum atcphy_mode mode)
    {
    let mut lane0: c_int = atcphy.swap_lanes ? 1 : 0;
    let mut lane1: c_int = atcphy.swap_lanes ? 0 : 1;
...
#[no_mangle]
unsafe extern "C" fn atcphy_pipehandler_lock(atcphy: *mut apple_atcphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_pipehandler_unlock(atcphy: *mut apple_atcphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_pipehandler_check(atcphy: *mut apple_atcphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_configure_pipehandler_usb3(atcphy: *mut apple_atcphy, host: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_configure_pipehandler_dummy(atcphy: *mut apple_atcphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_configure_pipehandler(atcphy: *mut apple_atcphy, host: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_setup_pipehandler(atcphy: *mut apple_atcphy) {
...
#[no_mangle]
unsafe extern "C" fn atcphy_configure_lanes(atcphy: *mut apple_atcphy, mode: enum atcphy_mode) {
...
#[no_mangle]
unsafe extern "C" fn atcphy_enable_dp_aux(atcphy: *mut apple_atcphy) {
...
#[no_mangle]
unsafe extern "C" fn atcphy_disable_dp_aux(atcphy: *mut apple_atcphy) {
...
#[no_mangle]
unsafe extern "C" fn atcphy_auspll_apb_command(atcphy: *mut apple_atcphy, command: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_dp_configure(atcphy: *mut apple_atcphy, lr: enum atcphy_dp_link_rate) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_usb2_power_off(atcphy: *mut apple_atcphy) {
...
#[no_mangle]
unsafe extern "C" fn atcphy_power_off(atcphy: *mut apple_atcphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_usb2_power_on(atcphy: *mut apple_atcphy) {
...
#[no_mangle]
unsafe extern "C" fn atcphy_power_on(atcphy: *mut apple_atcphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_configure(atcphy: *mut apple_atcphy, mode: enum atcphy_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_usb2_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_usb3_power_off(phy: *mut phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_usb3_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_dpphy_set_mode(phy: *mut phy, mode: enum phy_mode, submode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_dpphy_configure(phy: *mut phy, opts_: *mut union phy_configure_opts) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_probe_phy(atcphy: *mut apple_atcphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _atcphy_dwc3_reset_assert(atcphy: *mut apple_atcphy) {
...
#[no_mangle]
unsafe extern "C" fn atcphy_dwc3_reset_assert(rcdev: *mut reset_controller_dev, id: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_dwc3_reset_deassert(rcdev: *mut reset_controller_dev, id: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_probe_rcdev(atcphy: *mut apple_atcphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_sw_set(sw: *mut typec_switch_dev, orientation: enum typec_orientation) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_typec_switch_unregister(data: *mut c_void) {
    static void atcphy_typec_switch_unregister(void *data)
    {
    typec_switch_unregister(data);
    }
#[no_mangle]
unsafe extern "C" fn atcphy_probe_switch(atcphy: *mut apple_atcphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_mux_set(mux: *mut typec_mux_dev, state: *mut typec_mux_state) -> c_int {
    ...
    let mut eudo_usb_mode: u32 = FIELD_GET(EUDO_USB_MODE_MASK, data.eudo);
...
#[no_mangle]
unsafe extern "C" fn atcphy_typec_mux_unregister(data: *mut c_void) {
    static void atcphy_typec_mux_unregister(void *data)
    {
    typec_mux_unregister(data);
    }
#[no_mangle]
unsafe extern "C" fn atcphy_probe_mux(atcphy: *mut apple_atcphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_load_tunables(atcphy: *mut apple_atcphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_map_resources(pdev: *mut platform_device, atcphy: *mut apple_atcphy) -> c_int {
    ...
    { "lpdptx", &atcphy.regs.lpdptx, core::ptr::null_mut() },
    { "axi2af", &atcphy.regs.axi2af, &atcphy.res.axi2af },
    { "usb2phy", &atcphy.regs.usb2phy, core::ptr::null_mut() },
    { "pipehandler", &atcphy.regs.pipehandler, core::ptr::null_mut() },
    };
    struct resource *res;
    void __iomem *addr;
...
#[no_mangle]
unsafe extern "C" fn atcphy_probe_finalize(atcphy: *mut apple_atcphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atcphy_probe(pdev: *mut platform_device) -> c_int {
