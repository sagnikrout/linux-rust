...
// intel_idle.max_cstate=0 disables driver
    let mut max_cstate: static int = CPUIDLE_STATE_MAX - 1;
    static unsigned int disabled_states_mask __read_mostly;
    static bool force_irq_on __read_mostly;
    static bool ibrs_off __read_mostly;
// The maximum allowed length for the 'table' module parameter
pub const MAX_CMDLINE_TABLE_LEN: c_int = 256;
...
pub const SKX_PKG_CST_LIMIT_PC6: c_int = 2;
...
#[derive(Copy, Clone)]
pub struct idle_cpu {
    pub state_table: *mut cpuidle_state,
//
// Hardware C-state auto-demotion may not always be optimal.
// Indicate which enable bits to clear here.
//
    pub auto_demotion_disable_flags: c_ulong,
    pub disable_promotion_to_c1e: bool,
    pub c1_demotion_supported: bool,
    pub use_acpi: bool,
}
...
//
    ...
    let mut eax: c_uint = flg2MWAIT(state.flags);
...
//
    ...
    struct cpuidle_driver *drv, int index)
    {
    let mut smt_active: bool = sched_smt_active();
    let mut spec_ctrl: u64 = spec_ctrl_current();
    int ret;
    if (smt_active)
...
#[no_mangle]
unsafe extern "C" fn intel_idle_enter_dead(dev: *mut cpuidle_device, index: c_int) {
    static void intel_idle_enter_dead(struct cpuidle_device *dev, int index)
    {
    struct cpuidle_driver *drv = cpuidle_get_cpu_driver(dev);
    struct cpuidle_state *state = &drv.states[index];
    let mut eax: c_ulong = flg2MWAIT(state.flags);
    mwait_play_dead(eax);
    }
//
...
//
    ...
    X86_MATCH_VENDOR_FAM_FEATURE(INTEL, X86_FAMILY_ANY, X86_FEATURE_MWAIT, core::ptr::null_mut()),
    {}
    };
#[no_mangle]
unsafe extern "C" fn intel_idle_max_cstate_reached(cstate: c_int) -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn intel_idle_state_needs_timer_stop(state: *mut cpuidle_state) -> bool __init {
...
//
#[no_mangle]
unsafe extern "C" fn intel_idle_cst_usable() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn intel_idle_acpi_extract_lpi_cstates() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn intel_idle_acpi_extract_cst_cstates() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn intel_idle_acpi_extract_cstates() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn intel_idle_acpi_probe() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn intel_idle_complete_state_init(state: *mut cpuidle_state) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn intel_idle_init_cstates_acpi_lpi(drv: *mut cpuidle_driver) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn intel_idle_init_cstates_acpi_cst(drv: *mut cpuidle_driver) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn intel_idle_init_cstates_acpi(drv: *mut cpuidle_driver) -> void __init {
    ...
    let mut acpi_hint: return = = table_hint;
    }
#[no_mangle]
unsafe extern "C" fn intel_idle_off_by_default_lpi(flags: c_uint, mwait_hint: u32) -> bool __init {
    static bool __init intel_idle_off_by_default_lpi(unsigned int flags, u32 mwait_hint)
    {
    int index;
    for (index = 0; index < acpi_state_table.count; index++) {
    let mut acpi_hint: u32 = acpi_state_table.lpi_states[index].address;
...
#[no_mangle]
unsafe extern "C" fn intel_idle_off_by_default_cst(flags: c_uint, mwait_hint: u32) -> bool __init {
...
//
    for (cstate = 1; cstate < limit; cstate++) {
    let mut acpi_hint: u32 = acpi_state_table.states[cstate].address;
    if (intel_idle_acpi_hint_match(flags, acpi_hint, mwait_hint))
    return false;
    }
    return true;
...
#[no_mangle]
unsafe extern "C" fn intel_idle_off_by_default(flags: c_uint, mwait_hint: u32) -> bool __init {
...
#[no_mangle]
pub unsafe extern "C" fn ignore_native() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn intel_idle_off_by_default(flags: c_uint, mwait_hint: u32) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ivt_idle_state_table_update() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn irtl_2_usec(irtl: c_ulonglong) -> unsigned long long __init {
...
//
#[no_mangle]
unsafe extern "C" fn bxt_idle_state_table_update() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn sklh_idle_state_table_update() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn skx_is_pc6_disabled() -> bool __init {
...
//
#[no_mangle]
unsafe extern "C" fn skx_idle_state_table_update() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn spr_idle_state_table_update() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn drop_pc6_redundant_cstates(states: *mut cpuidle_state) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn byt_cht_auto_demotion_disable() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn intel_idle_verify_cstate(mwait_hint: c_uint) -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn state_update_enter_method(state: *mut cpuidle_state, cstate: c_int) {
...
#[no_mangle]
unsafe extern "C" fn intel_idle_init_cstates_icpu(drv: *mut cpuidle_driver) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn intel_idle_cpuidle_driver_init(drv: *mut cpuidle_driver) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn auto_demotion_disable() {
...
#[no_mangle]
unsafe extern "C" fn c1e_promotion_enable() {
...
#[no_mangle]
unsafe extern "C" fn c1e_promotion_disable() {
...
//
#[no_mangle]
unsafe extern "C" fn intel_idle_cpu_init(cpu: c_uint) -> c_int {
    ...
    c1e_promotion_enable();
#[no_mangle]
pub unsafe extern "C" fn if(C1E_PROMOTION_DISABLE: c1e_promotion ==) -> else {
    else if (c1e_promotion == C1E_PROMOTION_DISABLE)
    c1e_promotion_disable();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn intel_idle_cpu_online(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn intel_idle_cpuidle_devices_uninit() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn intel_c1_demotion_toggle(enable: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn intel_idle_sysfs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn intel_idle_sysfs_uninit() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn cmdline_table_adjust(drv: *mut cpuidle_driver) -> void __init {
...
pub const INTEL_IDLE_INIT_QOS: c_int = 20;
    static struct pm_qos_request qos_req __initdata;
#[no_mangle]
unsafe extern "C" fn intel_idle_init() -> int __init {
...
// Do not load intel_idle at all for now if idle= is passed
    ...
    icpu = core::ptr::null_mut();
    }
    if (icpu) {
    if (icpu.state_table)
    cpuidle_state_table = icpu.state_table;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !intel_idle_acpi_probe()) -> else {
...
//
    ...
    intel_idle_cpu_online, core::ptr::null_mut());
    if (retval < 0)
    goto hp_setup_fail;
...
#[no_mangle]
unsafe extern "C" fn intel_idle_init_complete() -> int __init {
