...
//! Source: drivers/target/target_core_fabric_lib.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sas_parse_pr_out_transport_id(buf: *mut c_char, i_str: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn srp_parse_pr_out_transport_id(buf: *mut c_char, i_str: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn fcp_parse_pr_out_transport_id(buf: *mut c_char, i_str: *mut c_char) {
    static void fcp_parse_pr_out_transport_id(char *buf, char *i_str)
    {
    snprintf(i_str, TRANSPORT_IQN_LEN, "%8phC", buf + 8);
    }
#[no_mangle]
unsafe extern "C" fn sbp_parse_pr_out_transport_id(buf: *mut c_char, i_str: *mut c_char) {
