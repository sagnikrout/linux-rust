...
//! Source: drivers/target/target_core_device.c
#![no_std]
...
// not static, needed by tpg.c
    ...
    {
    struct se_lun *se_lun = core::ptr::null_mut();
    ...
    se_cmd.data_length);
#[no_mangle]
pub unsafe extern "C" fn if(DMA_FROM_DEVICE: se_cmd->data_direction ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn transport_lookup_tmr_lun(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn target_lun_is_rdonly(cmd: *mut se_cmd) -> bool {
...
//
    ...
    " core::ptr::null_mut(), but Initiator has access.\n",
...
#[no_mangle]
pub unsafe extern "C" fn target_pr_kref_release(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn target_dev_ua_allocate(dev: *mut se_device, asc: u8, ascq: u8) {
    ...
    if (orig.se_lun_acl != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn target_free_dev_entry(head: *mut rcu_head) {
...
//
    ...
    target_luns_data_has_changed(nacl, core::ptr::null_mut(), false);
    }
// core_clear_lun_from_tpg():
//
#[no_mangle]
pub unsafe extern "C" fn core_clear_lun_from_tpg(lun: *mut se_lun, tpg: *mut se_portal_group) {
...
#[no_mangle]
unsafe extern "C" fn se_release_vpd_for_dev(dev: *mut se_device) {
...
#[no_mangle]
unsafe extern "C" fn se_dev_align_max_sectors(max_sectors: u32, block_size: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn scsi_dump_inquiry(dev: *mut se_device) {
    static void scsi_dump_inquiry(struct se_device *dev)
    {
    struct t10_wwn *wwn = &dev.t10_wwn;
    let mut device_type: c_int = dev.transport.get_device_type(dev);
//
...
#[no_mangle]
unsafe extern "C" fn target_non_ordered_release(ref: *mut percpu_ref) {
...
// Preload the default INQUIRY const values
    ...
    let mut block_size: c_int = bdev_logical_block_size(bdev);
...
//
#[no_mangle]
pub unsafe extern "C" fn target_to_linux_sector(dev: *mut se_device, lb: sector_t) -> sector_t {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct devices_idr_iter {
    pub data): *mut *mut *mut int (fn)(struct se_device dev, void,
    pub data: *mut c_void,
}

#[no_mangle]
unsafe extern "C" fn target_devices_idr_iter(id: c_int, p: *mut c_void, data: *mut c_void) -> c_int {
...
//
    ...
    void *data)
    {
    let mut iter: devices_idr_iter = { .fn = fn, .data = data };
    int ret;
    mutex_lock(&device_mutex);
...
#[no_mangle]
pub unsafe extern "C" fn target_configure_device(dev: *mut se_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn target_free_device(dev: *mut se_device) {
    ...
    core_alua_set_lba_map(dev, core::ptr::null_mut(), 0, 0);
...
#[no_mangle]
pub unsafe extern "C" fn core_dev_setup_virtual_lun0() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn core_dev_release_virtual_lun0() {
