...
//! Source: drivers/target/target_core_transport.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn init_se_kmem_caches() -> c_int {
    ...
    __alignof__(struct t10_pr_registration), 0, core::ptr::null_mut());
    if (!t10_pr_reg_cache) {
    ...
    __alignof__(struct t10_alua_lu_gp_member), 0, core::ptr::null_mut());
    ...
    __alignof__(struct t10_alua_tg_pt_gp), 0, core::ptr::null_mut());
    ...
    __alignof__(struct t10_alua_lba_map), 0, core::ptr::null_mut());
    ...
    __alignof__(struct t10_alua_lba_map_member), 0, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn release_se_kmem_caches() {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_get_new_index(type: scsi_index_t) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn transport_subsystem_check_init() {
...
#[no_mangle]
unsafe extern "C" fn target_release_cmd_refcnt(ref: *mut percpu_ref) {
...
#[no_mangle]
pub unsafe extern "C" fn target_free_cmd_counter(cmd_cnt: *mut target_cmd_counter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn transport_init_session(se_sess: *mut se_session) {
...
//
    ...
    se_sess.sess_cmd_map = core::ptr::null_mut();
    return -ENOMEM;
    }
    return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tfo->tpg_check_prot_fabric_only) -> else {
...
//
    if (se_tpg.se_tpg_tfo.sess_get_initiator_sid != core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn target_show_dynamic_sessions(se_tpg: *mut se_portal_group, page: *mut c_char) -> isize {
    ...
    len += 1; /* Include core::ptr::null_mut() terminator */
    }
...
#[no_mangle]
unsafe extern "C" fn target_complete_nacl(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn target_put_nacl(nacl: *mut se_node_acl) {
...
#[no_mangle]
pub unsafe extern "C" fn transport_deregister_session_configfs(se_sess: *mut se_session) {
...
//
    ...
    se_nacl.nacl_sess = core::ptr::null_mut();
    else {
...
#[no_mangle]
pub unsafe extern "C" fn transport_free_session(se_sess: *mut se_session) {
...
//
    ...
    unsigned long flags;
    se_sess.se_node_acl = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn target_release_res(dev: *mut se_device, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn transport_deregister_session(se_sess: *mut se_session) {
    ...
    se_sess.se_tpg = core::ptr::null_mut();
    se_sess.fabric_sess_ptr = core::ptr::null_mut();
    spin_unlock_irqrestore(&se_tpg.session_lock, flags);
//
...
#[no_mangle]
pub unsafe extern "C" fn target_remove_session(se_sess: *mut se_session) {
...
#[no_mangle]
unsafe extern "C" fn target_remove_from_state_list(cmd: *mut se_cmd) {
...
#[no_mangle]
unsafe extern "C" fn target_remove_from_tmr_list(cmd: *mut se_cmd) {
    static void target_remove_from_tmr_list(struct se_cmd *cmd)
    {
    struct se_device *dev = core::ptr::null_mut();
    unsigned long flags;
...
//
#[no_mangle]
unsafe extern "C" fn transport_cmd_check_stop_to_fabric(cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn transport_lun_remove_cmd(cmd: *mut se_cmd) {
...
//
    cmd.se_lun = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn target_complete_failure_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn transport_copy_sense_to_cmd(cmd: *mut se_cmd, sense: *mut c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn target_handle_abort(cmd: *mut se_cmd) {
    static void target_handle_abort(struct se_cmd *cmd)
    {
    let mut tas: bool = cmd.transport_state & CMD_T_TAS;
    let mut ack_kref: bool = cmd.se_cmd_flags & SCF_ACK_KREF;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn target_abort_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn target_cmd_interrupted(cmd: *mut se_cmd) -> bool {
...
#[no_mangle]
unsafe extern "C" fn target_complete(cmd: *mut se_cmd, success: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn target_complete_cmd(cmd: *mut se_cmd, scsi_status: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn target_set_cmd_data_length(cmd: *mut se_cmd, length: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn target_complete_cmd_with_length(cmd: *mut se_cmd, scsi_status: u8, length: c_int) {
...
#[no_mangle]
unsafe extern "C" fn target_add_to_state_list(cmd: *mut se_cmd) {
...
#[no_mangle]
pub unsafe extern "C" fn target_qf_do_work(work: *mut work_struct) {
...
//
    ...
    transport_dump_vpd_proto_id(vpd, core::ptr::null_mut(), 0);
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn transport_set_vpd_assoc(vpd: *mut t10_vpd, page_83: *mut c_uchar) -> c_int {
...
//
    ...
    return transport_dump_vpd_assoc(vpd, core::ptr::null_mut(), 0);
    }
...
#[no_mangle]
pub unsafe extern "C" fn transport_set_vpd_ident_type(vpd: *mut t10_vpd, page_83: *mut c_uchar) -> c_int {
...
//
    ...
    return transport_dump_vpd_ident_type(vpd, core::ptr::null_mut(), 0);
    }
...
//
    ...
    return transport_dump_vpd_ident(vpd, core::ptr::null_mut(), 0);
    }
...
//
    ...
    let mut orig_dl: u32 = size + cmd.residual_count;
...
//
    if (cmd.prot_length) {
    let mut sectors: u32 = (mtl / dev.dev_attrib.block_size);
...
//
    ...
    cmd.free_compl = core::ptr::null_mut();
    cmd.abrt_compl = core::ptr::null_mut();
    spin_lock_init(&cmd.t_state_lock);
    INIT_WORK(&cmd.work, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn __target_submit(cmd: *mut se_cmd) -> c_int {
...
//
    ...
    if (!cmd.se_lun) {
    dump_stack();
    pr_err("cmd.se_lun is core::ptr::null_mut()\n");
    return -EINVAL;
    }
//
...
//
    ...
    if (ret)
    se_cmd.cmd_cnt = core::ptr::null_mut();
    return ret;
    }
...
//
    ...
    if (rc)
    return;
    if (target_submit_prep(se_cmd, cdb, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0,
    GFP_KERNEL))
    return;
...
#[no_mangle]
unsafe extern "C" fn target_unplug_device(se_plug: *mut se_dev_plug) {
...
#[no_mangle]
pub unsafe extern "C" fn target_queued_submit_work(work: *mut work_struct) {
    void target_queued_submit_work(struct work_struct *work)
    {
    struct se_cmd_queue *sq = container_of(work, struct se_cmd_queue, work);
    struct se_cmd *se_cmd, *next_cmd;
    struct se_dev_plug *se_plug = core::ptr::null_mut();
    struct se_device *se_dev = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn target_queue_submission(se_cmd: *mut se_cmd) {
    static void target_queue_submission(struct se_cmd *se_cmd)
    {
    struct se_device *se_dev = se_cmd.se_dev;
    let mut cpu: c_int = se_cmd.cpuid;
...
//
#[no_mangle]
pub unsafe extern "C" fn target_submit(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn target_complete_tmr_failure(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn __target_execute_cmd(cmd: *mut se_cmd, do_checks: bool) {
...
#[no_mangle]
unsafe extern "C" fn target_write_prot_action(cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn target_handle_task_attr(cmd: *mut se_cmd) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn target_execute_cmd(cmd: *mut se_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn target_do_delayed_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn transport_complete_ordered_sync(cmd: *mut se_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn transport_complete_task_attr(cmd: *mut se_cmd) {
    static void transport_complete_task_attr(struct se_cmd *cmd)
    {
    struct se_device *dev = cmd.se_dev;
    if (dev.transport_flags & TRANSPORT_FLAG_PASSTHROUGH)
...
#[no_mangle]
unsafe extern "C" fn transport_complete_qf(cmd: *mut se_cmd) {
    static void transport_complete_qf(struct se_cmd *cmd)
    {
    let mut ret: c_int = 0;
    transport_complete_task_attr(cmd);
...
#[no_mangle]
unsafe extern "C" fn target_read_prot_action(cmd: *mut se_cmd) -> bool {
...
#[no_mangle]
unsafe extern "C" fn target_complete_ok_work(work: *mut work_struct) {
    static void target_complete_ok_work(struct work_struct *work)
    {
    struct se_cmd *cmd = container_of(work, struct se_cmd, work);
    int ret;
...
//
    if (cmd.transport_complete_callback) {
    sense_reason_t rc;
    let mut caw: bool = (cmd.se_cmd_flags & SCF_COMPARE_AND_WRITE);
    let mut zero_dl: bool = !(cmd.data_length);
    let mut post_ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn target_free_sgl(sgl: *mut scatterlist, nents: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn transport_reset_sgl_orig(cmd: *mut se_cmd) {
...
//
    ...
    cmd.t_data_sg_orig = core::ptr::null_mut();
    cmd.t_data_nents = cmd.t_data_nents_orig;
    cmd.t_data_nents_orig = 0;
    }
#[no_mangle]
pub unsafe extern "C" fn transport_free_pages(cmd: *mut se_cmd) {
    static inline void transport_free_pages(struct se_cmd *cmd)
    {
    if (!(cmd.se_cmd_flags & SCF_PASSTHROUGH_PROT_SG_TO_MEM_NOALLOC)) {
    target_free_sgl(cmd.t_prot_sg, cmd.t_prot_nents);
    cmd.t_prot_sg = core::ptr::null_mut();
    cmd.t_prot_nents = 0;
    }
...
//
    ...
    cmd.t_bidi_data_sg = core::ptr::null_mut();
    ...
    cmd.t_data_sg = core::ptr::null_mut();
    cmd.t_data_nents = 0;
...
#[no_mangle]
pub unsafe extern "C" fn transport_kunmap_data_sg(cmd: *mut se_cmd) {
    ...
    cmd.t_data_vmap = core::ptr::null_mut();
    }
    ...
    {
    let mut gfp: gfp_t = GFP_KERNEL | (zero_page ? __GFP_ZERO : 0);
...
//
    ...
    unsigned long flags;
    let mut ret: c_int = 0;
    let mut zero_flag: bool = !(cmd.se_cmd_flags & SCF_SCSI_DATA_CDB);
...
#[no_mangle]
unsafe extern "C" fn transport_write_pending_qf(cmd: *mut se_cmd) {
    static void transport_write_pending_qf(struct se_cmd *cmd)
    {
    unsigned long flags;
    int ret;
    ...
    unsigned long *flags);
#[no_mangle]
unsafe extern "C" fn target_wait_free_cmd(cmd: *mut se_cmd, aborted: *mut bool, tas: *mut bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn target_put_cmd_and_wait(cmd: *mut se_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn transport_generic_free_cmd(cmd: *mut se_cmd, wait_for_tasks: c_int) -> c_int {
    int transport_generic_free_cmd(struct se_cmd *cmd, int wait_for_tasks)
    {
    DECLARE_COMPLETION_ONSTACK(compl);
    let mut ret: c_int = 0;
    let mut aborted: bool = false, tas = false;
    if (wait_for_tasks)
...
//
#[no_mangle]
pub unsafe extern "C" fn target_get_sess_cmd(se_cmd: *mut se_cmd, ack_kref: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn target_free_cmd_mem(cmd: *mut se_cmd) {
...
#[no_mangle]
unsafe extern "C" fn target_release_cmd_kref(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn target_put_sess_cmd(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn target_append_str(str: *mut c_char, txt: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn target_show_cmd(pfx: *const c_char, cmd: *mut se_cmd) {
...
#[no_mangle]
unsafe extern "C" fn target_stop_cmd_counter_confirm(ref: *mut percpu_ref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn target_stop_cmd_counter(cmd_cnt: *mut target_cmd_counter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn target_stop_session(se_sess: *mut se_session) {
...
//
#[no_mangle]
pub unsafe extern "C" fn target_wait_for_cmds(cmd_cnt: *mut target_cmd_counter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn target_wait_for_sess_cmds(se_sess: *mut se_session) {
...
//
#[no_mangle]
pub unsafe extern "C" fn transport_clear_lun_ref(lun: *mut se_lun) {
...
//
#[no_mangle]
pub unsafe extern "C" fn transport_wait_for_tasks(cmd: *mut se_cmd) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sense_detail {
    pub key: u8,
    pub asc: u8,
    pub ascq: u8,
    pub add_sense_info: bool,
}
...
//
#[no_mangle]
unsafe extern "C" fn translate_sense_reason(cmd: *mut se_cmd, reason: sense_reason_t) {
    static void translate_sense_reason(struct se_cmd *cmd, sense_reason_t reason)
    {
    const struct sense_detail *sd;
    u8 *buffer = cmd.sense_buffer;
    let mut r: c_int = ( int)reason;
    u8 key, asc, ascq;
    let mut desc_format: bool = target_sense_desc_format(cmd.se_dev);
    if (r < ARRAY_SIZE(sense_detail_table) && sense_detail_table[r].key)
    sd = &sense_detail_table[r];
    else
    sd = &sense_detail_table[( int)
    TCM_LOGICAL_UNIT_COMMUNICATION_FAILURE];
    key = sd.key;
...
//
#[no_mangle]
pub unsafe extern "C" fn target_send_busy(cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn target_tmr_work(work: *mut work_struct) {
    ...
    break;
    case TMR_LUN_RESET:
    ret = core_tmr_lun_reset(dev, tmr, core::ptr::null_mut(), core::ptr::null_mut());
    ...
    {
    let mut wce: bool = false;
    if (dev.transport.get_write_cache)
    wce = dev.transport.get_write_cache(dev);
#[no_mangle]
pub unsafe extern "C" fn if(0: dev->dev_attrib.emulate_write_cache >) -> else {
