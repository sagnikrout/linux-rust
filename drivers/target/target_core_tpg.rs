...
//! Source: drivers/target/target_core_tpg.c
#![no_std]
...
//
    ...
    {
    let mut lun_access_ro: bool = true;
    struct se_lun *lun;
...
//
    ...
    core_enable_device_list_for_node(lun, core::ptr::null_mut(), lun.unpacked_lun,
...
#[no_mangle]
unsafe extern "C" fn target_add_node_acl(acl: *mut se_node_acl) {
...
//
    if ((tpg.se_tpg_tfo.tpg_check_demo_mode_login_only == core::ptr::null_mut()) ||
    (tpg.se_tpg_tfo.tpg_check_demo_mode_login_only(tpg) != 1))
    core_tpg_add_node_to_devs(acl, tpg, core::ptr::null_mut());
    target_add_node_acl(acl);
    return acl;
    }
    EXPORT_SYMBOL(core_tpg_check_initiator_node_acl);
#[no_mangle]
pub unsafe extern "C" fn core_tpg_wait_for_nacl_pr_ref(nacl: *mut se_node_acl) {
...
#[no_mangle]
unsafe extern "C" fn target_shutdown_sessions(acl: *mut se_node_acl) {
...
#[no_mangle]
pub unsafe extern "C" fn core_tpg_del_initiator_node_acl(acl: *mut se_node_acl) {
...
//
    ...
    return -EINVAL;
    if (!strncmp("core::ptr::null_mut()", new_tag, 4)) {
    acl.acl_tag[0] = '\0';
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn core_tpg_lun_ref_release(ref: *mut percpu_ref) {
...
#[no_mangle]
unsafe extern "C" fn target_tpg_register_rtpi(se_tpg: *mut se_portal_group) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn target_tpg_deregister_rtpi(se_tpg: *mut se_portal_group) {
...
#[no_mangle]
pub unsafe extern "C" fn target_tpg_enable(se_tpg: *mut se_portal_group) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn target_tpg_disable(se_tpg: *mut se_portal_group) -> c_int {
...
//
    ...
    se_tpg.se_tpg_tfo.tpg_get_wwn(se_tpg) : core::ptr::null_mut(),
    se_tpg.proto_id, se_tpg.se_tpg_tfo.tpg_get_tag(se_tpg));
    return 0;
    }
    EXPORT_SYMBOL(core_tpg_register);
#[no_mangle]
pub unsafe extern "C" fn core_tpg_deregister(se_tpg: *mut se_portal_group) -> c_int {
    ...
    "Proto: %d, Portal Tag: %u\n", tfo.fabric_name,
    tfo.tpg_get_wwn(se_tpg) ? tfo.tpg_get_wwn(se_tpg) : core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn target_tpg_free_lun(head: *mut rcu_head) {
...
//
    ...
    dev.export_count--;
    rcu_assign_pointer(lun.lun_se_dev, core::ptr::null_mut());
    spin_unlock(&dev.se_port_lock);
    }
    if (!(dev.se_hba.hba_flags & HBA_FLAGS_INTERNAL_USE))
