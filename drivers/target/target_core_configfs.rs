...
//! Source: drivers/target/target_core_configfs.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn target_depend_item(item: *mut config_item) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn target_undepend_item(item: *mut config_item) {
...
// ############################################################################
#[no_mangle]
unsafe extern "C" fn target_disable_feature(se_tpg: *mut se_portal_group) -> c_int {
    static int target_disable_feature(struct se_portal_group *se_tpg)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn target_default_get_inst_index(se_tpg: *mut se_portal_group) -> u32 {
    static u32 target_default_get_inst_index(struct se_portal_group *se_tpg)
    {
    return 1;
    }
#[no_mangle]
unsafe extern "C" fn target_default_sess_get_index(se_sess: *mut se_session) -> u32 {
    static u32 target_default_sess_get_index(struct se_session *se_sess)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn target_set_default_node_attributes(se_acl: *mut se_node_acl) {
    static void target_set_default_node_attributes(struct se_node_acl *se_acl)
    {
    }
#[no_mangle]
unsafe extern "C" fn target_default_get_cmd_state(se_cmd: *mut se_cmd) -> c_int {
    static int target_default_get_cmd_state(struct se_cmd *se_cmd)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn target_fabric_tf_ops_check(tfo: *const target_core_fabric_ops) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn target_set_default_ops(tfo: *mut target_core_fabric_ops) {
...
#[no_mangle]
pub unsafe extern "C" fn target_register_template(fo: *const target_core_fabric_ops) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn target_unregister_template(fo: *const target_core_fabric_ops) {
...
#[no_mangle]
unsafe extern "C" fn dev_set_t10_wwn_model_alias(dev: *mut se_device) {
...
//
    ...
    {
    struct se_dev_attrib *da = to_attrib(item);
    let mut old_prot: c_int = da.pi_prot_type, ret;
    struct se_device *dev = da.da_dev;
    u32 flag;
...
#[no_mangle]
unsafe extern "C" fn pi_prot_format_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn alua_support_show(item: *mut config_item, page: *mut c_char) -> isize {
    static ssize_t alua_support_show(struct config_item *item, char *page)
    {
    struct se_dev_attrib *da = to_attrib(item);
    let mut flags: u8 = da.da_dev.transport_flags;
...
#[no_mangle]
unsafe extern "C" fn pgr_support_show(item: *mut config_item, page: *mut c_char) -> isize {
...
//
    ...
    TB_CIT_SETUP_DRV(dev_attrib, core::ptr::null_mut(), core::ptr::null_mut());
    TB_CIT_SETUP_DRV(dev_action, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn target_check_inquiry_data(buf: *mut c_char) -> isize {
...
// +2 to allow for a trailing (stripped) '\n' and null-terminator
    ...
    char *stripped = core::ptr::null_mut();
    ssize_t len;
    ssize_t ret;
...
// VPD page 0x83 Association: SCSI Target Device
    ...
    TB_CIT_SETUP(dev_wwn, core::ptr::null_mut(), core::ptr::null_mut(), target_core_dev_wwn_attrs);
...
#[no_mangle]
unsafe extern "C" fn target_pr_res_holder_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_pr_res_pr_type_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_pr_res_type_show(item: *mut config_item, page: *mut c_char) -> isize {
    ...
    {
    struct se_device *dev = pr_to_dev(item);
    unsigned char *i_fabric = core::ptr::null_mut(), *i_port = core::ptr::null_mut(), *isid = core::ptr::null_mut();
    unsigned char *t_fabric = core::ptr::null_mut(), *t_port = core::ptr::null_mut();
    char *orig, *ptr, *opts;
    substring_t args[MAX_OPT_ARGS];
    unsigned long long tmp_ll;
    let mut sa_res_key: u64 = 0;
    let mut mapped_lun: u64 = 0, target_lun = 0;
    let mut ret: c_int = -1, res_holder = 0, all_tg_pt = 0, arg, token;
    let mut tpgt: u16 = 0;
    let mut type: u8 = 0;
    if (!dev.dev_attrib.emulate_pr ||
    (dev.transport_flags & TRANSPORT_FLAG_PASSTHROUGH_PGR))
...
//
    ...
    TB_CIT_SETUP(dev_pr, core::ptr::null_mut(), core::ptr::null_mut(), target_core_dev_pr_attrs);
...
#[no_mangle]
unsafe extern "C" fn target_dev_info_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_dev_alias_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_dev_udev_path_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_dev_enable_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_dev_alua_lu_gp_show(item: *mut config_item, page: *mut c_char) -> isize {
    ...
    struct se_device *dev = to_device(item);
    struct se_hba *hba = dev.se_hba;
    struct t10_alua_lu_gp *lu_gp = core::ptr::null_mut(), *lu_gp_new = core::ptr::null_mut();
    struct t10_alua_lu_gp_member *lu_gp_mem;
    unsigned char buf[LU_GROUP_NAME_BUF] = { };
    let mut move: c_int = 0;
    lu_gp_mem = dev.dev_alua_lu_gp_mem;
    if (!lu_gp_mem)
    return count;
...
//
    if (strcmp(strstrip(buf), "core::ptr::null_mut()")) {
//
...
#[no_mangle]
unsafe extern "C" fn target_dev_lba_map_show(item: *mut config_item, page: *mut c_char) -> isize {
    ...
    {
    struct se_device *dev = to_device(item);
    struct t10_alua_lba_map *lba_map = core::ptr::null_mut();
    struct list_head lba_list;
    char *map_entries, *orig, *ptr;
    char state;
    let mut pg_num: c_int = -1, pg;
    let mut ret: c_int = 0, num = 0, pg_id, alua_state;
    let mut start_lba: c_ulong = -1, end_lba = -1;
    let mut segment_size: c_ulong = -1, segment_mult = -1;
    ...
    pg_num = pg;
#[no_mangle]
pub unsafe extern "C" fn if(pg_num: pg !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn target_core_dev_release(item: *mut config_item) {
...
//
    ...
    TB_CIT_SETUP(dev, &target_core_dev_item_ops, core::ptr::null_mut(), target_core_dev_attrs);
...
#[no_mangle]
unsafe extern "C" fn target_lu_gp_lu_gp_id_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_lu_gp_members_show(item: *mut config_item, page: *mut c_char) -> isize {
    static ssize_t target_lu_gp_members_show(struct config_item *item, char *page)
    {
    struct t10_alua_lu_gp *lu_gp = to_lu_gp(item);
    struct t10_alua_lu_gp_member *lu_gp_mem;
    let mut end: *const char const = page + PAGE_SIZE;
    char *cur = page;
...
#[no_mangle]
unsafe extern "C" fn target_core_alua_lu_gp_release(item: *mut config_item) {
...
// Start functions for struct config_item_type target_core_alua_lu_gps_cit
    ...
    {
    struct t10_alua_lu_gp *lu_gp;
    struct config_group *alua_lu_gp_cg = core::ptr::null_mut();
    struct config_item *alua_lu_gp_ci = core::ptr::null_mut();
...
// LBA DEPENDENT is only allowed with implicit ALUA
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), new_state, 0);
    ...
    cur_len++; /* Extra byte for core::ptr::null_mut() terminator */
...
#[no_mangle]
unsafe extern "C" fn target_core_alua_tg_pt_gp_release(item: *mut config_item) {
...
// Start functions for struct config_item_type tb_alua_tg_pt_gps_cit
    ...
    struct config_group *alua_tg_pt_gp_cg = core::ptr::null_mut();
    struct config_item *alua_tg_pt_gp_ci = core::ptr::null_mut();
...
//
    ...
    TB_CIT_SETUP(dev_alua_tg_pt_gps, core::ptr::null_mut(), &target_core_alua_tg_pt_gps_group_ops, core::ptr::null_mut());
...
// Start functions for struct config_item_type tb_dev_stat_cit
    ...
    TB_CIT_SETUP(dev_stat, core::ptr::null_mut(), &target_core_stat_group_ops, core::ptr::null_mut());
...
// Start functions for struct config_item_type target_core_hba_cit
    ...
    struct se_device *dev;
    let mut errno: c_int = -ENOMEM, ret;
...
//
    dev.t10_alua.default_tg_pt_gp = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn target_hba_info_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_hba_mode_show(item: *mut config_item, page: *mut c_char) -> isize {
    static ssize_t target_hba_mode_show(struct config_item *item, char *page)
    {
    struct se_hba *hba = to_hba(item);
    let mut hba_mode: c_int = 0;
    ...
    int ret;
    if (hba.backend.ops.pmode_enable_hba == core::ptr::null_mut())
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn target_core_hba_release(item: *mut config_item) {
    ...
    let mut plugin_dep_id: c_ulong = 0;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn target_setup_backend_cits(tb: *mut target_backend) {
...
#[no_mangle]
unsafe extern "C" fn target_init_dbroot() {
    ...
    filp_close(fp, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn target_core_init_configfs() -> int __init {
...
//
    ...
    default_lu_gp = core::ptr::null_mut();
    }
    release_se_kmem_caches();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn target_core_exit_configfs() -> void __exit {
