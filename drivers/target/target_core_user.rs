...
//! Source: drivers/target/target_core_user.c
#![no_std]
...
//
pub const DATA_PAGES_PER_BLK_DEF: c_int = 1;
...
pub const TCMU_CONFIG_LEN: c_int = 256;
    static DEFINE_MUTEX(tcmu_nl_cmd_mutex);
    static LIST_HEAD(tcmu_nl_cmd_list);
    struct tcmu_dev;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tcmu_nl_cmd {
// wake up thread waiting for reply
    pub complete: completion,
    pub nl_list: list_head,
    pub udev: *mut tcmu_dev,
    pub cmd: c_int,
    pub status: c_int,
}
...
pub struct tcmu_dev {
    pub node: list_head,
    pub kref: kref,
    pub se_dev: se_device,
    pub se_plug: se_dev_plug,
    pub name: *mut c_char,
    pub hba: *mut se_hba,
pub const TCMU_DEV_BIT_OPEN: c_int = 0;
pub const TCMU_DEV_BIT_BROKEN: c_int = 1;
pub const TCMU_DEV_BIT_BLOCKED: c_int = 2;
pub const TCMU_DEV_BIT_TMR_NOTIFY: c_int = 3;
pub const TCMU_DEV_BIT_PLUGGED: c_int = 4;
    pub flags: c_ulong,
    pub uio_info: uio_info,
    pub inode: *mut inode,
    pub dev_size: u64,
    pub mb_addr: *mut tcmu_mailbox,
    pub cmdr: *mut c_void,
    pub cmdr_size: u32,
    pub cmdr_last_cleaned: u32,
// Offset of data area from start of mb
// Must add data_off and mb_addr to get the address
    pub data_off: usize,
    pub data_area_mb: c_int,
    pub max_blocks: u32,
    pub mmap_pages: usize,
    pub cmdr_lock: mutex,
    pub qfull_queue: list_head,
    pub tmr_queue: list_head,
    pub dbi_max: u32,
    pub dbi_thresh: u32,
    pub data_bitmap: *mut c_ulong,
    pub data_pages: xarray,
    pub data_pages_per_blk: u32,
    pub data_blk_size: u32,
    pub commands: xarray,
    pub cmd_timer: timer_list,
    pub cmd_time_out: c_uint,
    pub inflight_queue: list_head,
    pub qfull_timer: timer_list,
    pub qfull_time_out: c_int,
    pub timedout_entry: list_head,
    pub curr_nl_cmd: tcmu_nl_cmd,
    pub dev_config: [c_char; TCMU_CONFIG_LEN],
    pub nl_reply_supported: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tcmu_cmd {
    pub se_cmd: *mut se_cmd,
    pub tcmu_dev: *mut tcmu_dev,
    pub queue_entry: list_head,
    pub cmd_id: u16,
// Can't use se_cmd when cleaning up expired cmds, because if
    cmd has been completed then accessing se_cmd is off limits */
    pub dbi_cnt: u32,
    pub dbi_bidi_cnt: u32,
    pub dbi_cur: u32,
    pub dbi: *mut u32,
    pub data_len_bidi: u32,
    pub deadline: c_ulong,
pub const TCMU_CMD_BIT_EXPIRED: c_int = 0;
pub const TCMU_CMD_BIT_KEEP_BUF: c_int = 1;
    pub flags: c_ulong,
}
...
pub struct tcmu_tmr {
    ...
    pub tmr_type: u8,
    pub tmr_cmd_cnt: u32,
    pub __counted_by(tmr_cmd_cnt): int16_t tmr_cmd_ids[],
}
...
//
    ...
    let mut global_page_count: static atomic_t = ATOMIC_INIT(0);
    static struct delayed_work tcmu_unmap_work;
    let mut tcmu_global_max_pages: static int = TCMU_GLOBAL_MAX_PAGES_DEF;
    ...
    module_param_cb(global_max_data_area_mb, &tcmu_global_max_data_area_op, core::ptr::null_mut(),
    S_IWUSR | S_IRUGO);
    ...
    module_param_cb(block_netlink, &tcmu_block_netlink_op, core::ptr::null_mut(), S_IWUSR | S_IRUGO);
    MODULE_PARM_DESC(block_netlink, "Block new netlink commands.");
#[no_mangle]
unsafe extern "C" fn tcmu_fail_netlink_cmd(nl_cmd: *mut tcmu_nl_cmd) -> c_int {
    ...
    module_param_cb(reset_netlink, &tcmu_reset_netlink_op, core::ptr::null_mut(), S_IWUSR);
...
#[no_mangle]
unsafe extern "C" fn tcmu_genl_cmd_done(info: *mut genl_info, completed_cmd: c_int) -> c_int {
    static int tcmu_genl_cmd_done(struct genl_info *info, int completed_cmd)
    {
    struct tcmu_dev *udev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tcmu_genl_rm_dev_done(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_genl_add_dev_done(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_genl_set_features(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_cmd_free_data(tcmu_cmd: *mut tcmu_cmd, len: u32) {
    ...
    struct page *page;
    int i, cnt, dbi, dpi;
    let mut page_cnt: c_int = DIV_ROUND_UP(length, PAGE_SIZE);
...
// try to get new zeroed page from the mm
    ...
    if (dbi != prev_dbi + 1)
// iov_cnt += 1;
    let mut i: return = = page_cnt ? dbi : -1;
    }
...
// start value of dbi + 1 must not be a valid dbi
    ...
    let mut blk_size: u32 = udev.data_blk_size;
...
#[no_mangle]
pub unsafe extern "C" fn tcmu_free_cmd(tcmu_cmd: *mut tcmu_cmd) {
...
#[no_mangle]
pub unsafe extern "C" fn tcmu_cmd_set_block_cnts(cmd: *mut tcmu_cmd) {
    static inline void tcmu_cmd_set_block_cnts(struct tcmu_cmd *cmd)
    {
    int i, len;
    struct se_cmd *se_cmd = cmd.se_cmd;
    let mut blk_size: u32 = cmd.tcmu_dev.data_blk_size;
    ...
    {
// Get the next dbi
    let mut dbi: c_int = tcmu_cmd_get_dbi(cmd);
...
#[no_mangle]
pub unsafe extern "C" fn tcmu_flush_dcache_range(vaddr: *mut c_void, size: usize) {
    static inline void tcmu_flush_dcache_range(void *vaddr, size_t size)
    {
    let mut offset: c_ulong = offset_in_page(vaddr);
...
//
#[no_mangle]
pub unsafe extern "C" fn spc_used(head: usize, tail: usize, size: usize) -> usize {
    static inline size_t spc_used(size_t head, size_t tail, size_t size)
    {
    let mut diff: c_int = head - tail;
    if (diff >= 0)
    return diff;
    else
    return size + diff;
...
#[no_mangle]
pub unsafe extern "C" fn spc_free(head: usize, tail: usize, size: usize) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn head_to_end(head: usize, size: usize) -> usize {
    static inline size_t head_to_end(size_t head, size_t size)
    {
    return size - head;
    }

pub const TCMU_SG_TO_DATA_AREA: c_int = 1;
pub const TCMU_DATA_AREA_TO_SG: c_int = 2;
...
//
    ...
    data_nents, core::ptr::null_mut(), read_len);
    }
#[no_mangle]
pub unsafe extern "C" fn spc_bitmap_free(bitmap: *mut c_ulong, thresh: u32) -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn is_ring_space_avail(udev: *mut tcmu_dev, cmd_size: usize) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn tcmu_cmd_get_base_cmd_size(iov_cnt: usize) -> usize {
...
#[no_mangle]
unsafe extern "C" fn add_to_qfull_queue(tcmu_cmd: *mut tcmu_cmd) -> c_int {
...
//
    ...
    return -ETIMEDOUT;
#[no_mangle]
pub unsafe extern "C" fn if(0: udev->qfull_time_out >) -> else {
    else if (udev.qfull_time_out > 0)
    tmo = udev.qfull_time_out;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: udev->cmd_time_out) -> else {
...
#[no_mangle]
unsafe extern "C" fn ring_insert_padding(udev: *mut tcmu_dev, cmd_size: usize) -> u32 {
...
// Insert a PAD if end-of-ring space is too small
    if (head_to_end(cmd_head, udev.cmdr_size) < cmd_size) {
    let mut pad_size: usize = head_to_end(cmd_head, udev.cmdr_size);
...
#[no_mangle]
unsafe extern "C" fn tcmu_unplug_device(se_plug: *mut se_dev_plug) {
...
//
#[no_mangle]
unsafe extern "C" fn queue_cmd_ring(tcmu_cmd: *mut tcmu_cmd, scsi_err: *mut sense_reason_t) -> c_int {
...
// size of data buffer needed
    let mut data_length: usize = (size_t)tcmu_cmd.dbi_cnt * blk_size;
...
//
    ...
    struct tcmu_dev *udev = TCMU_DEV(se_dev);
    struct tcmu_cmd *tcmu_cmd;
    let mut scsi_ret: sense_reason_t = TCM_CHECK_CONDITION_ABORT_CMD;
    let mut ret: c_int = -1;
    ...
    {
    let mut i: c_int = 0, cmd_cnt = 0;
    let mut unqueued: bool = false;
    struct tcmu_cmd *cmd;
...
// Commands on qfull queue have no id yet
    ...
    let mut read_len_valid: bool = false;
...
#[no_mangle]
unsafe extern "C" fn tcmu_run_tmr_queue(udev: *mut tcmu_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_handle_completions(udev: *mut tcmu_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tcmu_check_expired_ring_cmd(cmd: *mut tcmu_cmd) {
    ...
    se_cmd = cmd.se_cmd;
    se_cmd.priv = core::ptr::null_mut();
    cmd.se_cmd = core::ptr::null_mut();
    pr_debug("Timing out inflight cmd %u on dev %s.\n",
    cmd.cmd_id, cmd.tcmu_dev.name);
    target_complete_cmd(se_cmd, SAM_STAT_CHECK_CONDITION);
    }
#[no_mangle]
unsafe extern "C" fn tcmu_check_expired_queue_cmd(cmd: *mut tcmu_cmd) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_device_timedout(udev: *mut tcmu_dev) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_cmd_timedout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_qfull_timedout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_attach_hba(hba: *mut se_hba, host_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_detach_hba(hba: *mut se_hba) {
    static void tcmu_detach_hba(struct se_hba *hba)
    {
    kfree(hba.hba_ptr);
    hba.hba_ptr = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn tcmu_dev_call_rcu(p: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_check_and_free_pending_cmd(cmd: *mut tcmu_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_remove_all_queued_tmr(udev: *mut tcmu_dev) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_dev_kref_release(kref: *mut kref) {
    static void tcmu_dev_kref_release(struct kref *kref)
    {
    struct tcmu_dev *udev = container_of(kref, struct tcmu_dev, kref);
    struct se_device *dev = &udev.se_dev;
    struct tcmu_cmd *cmd;
    let mut all_expired: bool = true;
    unsigned long i;
    vfree(udev.mb_addr);
    udev.mb_addr = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn run_qfull_queue(udev: *mut tcmu_dev, fail: bool) {
...
// fail the retry.
//
    tcmu_cmd.se_cmd.priv = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tcmu_irqcontrol(info: *mut uio_info, irq_on: i32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tcmu_find_mem_index(vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_vma_open(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_vma_close(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_vma_fault(vmf: *mut vm_fault) -> vm_fault_t {
    ...
    let mut mi: c_int = tcmu_find_mem_index(vmf.vma);
    if (mi < 0)
...
#[no_mangle]
unsafe extern "C" fn tcmu_mmap_prepare(info: *mut uio_info, desc: *mut vm_area_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_open(info: *mut uio_info, inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_release(info: *mut uio_info, inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_init_genl_cmd_reply(udev: *mut tcmu_dev, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_destroy_genl_cmd_reply(udev: *mut tcmu_dev) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_wait_genl_cmd_reply(udev: *mut tcmu_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_send_dev_add_event(udev: *mut tcmu_dev) -> c_int {
    static int tcmu_send_dev_add_event(struct tcmu_dev *udev)
    {
    struct sk_buff *skb = core::ptr::null_mut();
    void *msg_header = core::ptr::null_mut();
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn tcmu_send_dev_remove_event(udev: *mut tcmu_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_update_uio_info(udev: *mut tcmu_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_configure_device(dev: *mut se_device) -> c_int {
...
//
    ...
    err_vzalloc:
    bitmap_free(udev.data_bitmap);
    udev.data_bitmap = core::ptr::null_mut();
    err_bitmap_alloc:
    kfree(info.name);
    info.name = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn tcmu_free_device(dev: *mut se_device) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_destroy_device(dev: *mut se_device) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_unblock_dev(udev: *mut tcmu_dev) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_block_dev(udev: *mut tcmu_dev) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_reset_ring(udev: *mut tcmu_dev, err_level: u8) {
    ...
    WARN_ON(!cmd.se_cmd);
    list_del_init(&cmd.queue_entry);
    cmd.se_cmd.priv = core::ptr::null_mut();
    if (err_level == 1) {
//
...
#[no_mangle]
unsafe extern "C" fn tcmu_set_dev_attrib(arg: *mut substring_t, dev_attrib: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_set_max_blocks_param(udev: *mut tcmu_dev, arg: *mut substring_t) -> c_int {
    static int tcmu_set_max_blocks_param(struct tcmu_dev *udev, substring_t *arg)
    {
    int val, ret;
    let mut pages_per_blk: u32 = udev.data_pages_per_blk;
    ret = match_int(arg, &val);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_set_data_pages_per_blk(udev: *mut tcmu_dev, arg: *mut substring_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_set_cmd_ring_size(udev: *mut tcmu_dev, arg: *mut substring_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_show_configfs_dev_params(dev: *mut se_device, b: *mut c_char) -> isize {
    static ssize_t tcmu_show_configfs_dev_params(struct se_device *dev, char *b)
    {
    struct tcmu_dev *udev = TCMU_DEV(dev);
    let mut bl: isize = 0;
    bl = sprintf(b + bl, "Config: %s ",
    udev.dev_config[0] ? udev.dev_config : "core::ptr::null_mut()");
...
#[no_mangle]
unsafe extern "C" fn tcmu_get_blocks(dev: *mut se_device) -> sector_t {
...
#[no_mangle]
unsafe extern "C" fn tcmu_cmd_time_out_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tcmu_qfull_time_out_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tcmu_max_data_area_mb_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tcmu_cmd_ring_size_mb_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tcmu_dev_config_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tcmu_dev_size_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tcmu_send_dev_size_event(udev: *mut tcmu_dev, size: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_send_emulate_write_cache(udev: *mut tcmu_dev, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcmu_tmr_notification_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tcmu_block_dev_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn find_free_blocks() {
...
#[no_mangle]
unsafe extern "C" fn check_timedout_devices() {
...
#[no_mangle]
unsafe extern "C" fn tcmu_unmap_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tcmu_module_init() -> int __init {
    ...
    for (i = 0; passthrough_attrib_attrs[i] != core::ptr::null_mut(); i++)
    len += sizeof(struct configfs_attribute *);
    for (i = 0; passthrough_pr_attrib_attrs[i] != core::ptr::null_mut(); i++)
    len += sizeof(struct configfs_attribute *);
    for (i = 0; tcmu_attrib_attrs[i] != core::ptr::null_mut(); i++)
    len += sizeof(struct configfs_attribute *);
    len += sizeof(struct configfs_attribute *);
    ...
    for (k = 0; passthrough_pr_attrib_attrs[k] != core::ptr::null_mut(); k++)
    tcmu_attrs[i++] = passthrough_pr_attrib_attrs[k];
    for (k = 0; tcmu_attrib_attrs[k] != core::ptr::null_mut(); k++)
...
#[no_mangle]
unsafe extern "C" fn tcmu_module_exit() -> void __exit {
