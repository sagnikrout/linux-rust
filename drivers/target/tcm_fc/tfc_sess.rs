...
//! Source: drivers/target/tcm_fc/tfc_sess.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ft_tport_delete(tport: *mut ft_tport) {
    ...
    RCU_INIT_POINTER(lport.prov[FC_TYPE_FCP], core::ptr::null_mut());
    tpg = tport.tpg;
    if (tpg) {
    tpg.tport = core::ptr::null_mut();
    tport.tpg = core::ptr::null_mut();
    }
    kfree_rcu(tport, rcu);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ft_lport_add(lport: *mut fc_lport, arg: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ft_lport_del(lport: *mut fc_lport, arg: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ft_lport_notify(nb: *mut notifier_block, event: c_ulong, arg: *mut c_void) -> c_int {
    int ft_lport_notify(struct notifier_block *nb, unsigned long event, void *arg)
    {
    struct fc_lport *lport = arg;
    switch (event) {
    case FC_LPORT_EV_ADD:
    ft_lport_add(lport, core::ptr::null_mut());
    break;
    case FC_LPORT_EV_DEL:
    ft_lport_del(lport, core::ptr::null_mut());
    break;
    }
    return NOTIFY_DONE;
    }
...
//
#[no_mangle]
unsafe extern "C" fn ft_sess_hash(port_id: u32) -> u32 {
...
//
    ...
    let mut rc: c_int = PTR_ERR(sess.se_sess);
    kfree(sess);
    sess = ERR_PTR(rc);
    }
    return sess;
...
//
#[no_mangle]
unsafe extern "C" fn ft_sess_unhash(sess: *mut ft_sess) {
...
#[no_mangle]
unsafe extern "C" fn ft_close_sess(sess: *mut ft_sess) {
...
//
#[no_mangle]
unsafe extern "C" fn ft_sess_delete_all(tport: *mut ft_tport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ft_sess_close(se_sess: *mut se_session) {
...
#[no_mangle]
pub unsafe extern "C" fn ft_sess_get_index(se_sess: *mut se_session) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ft_sess_free(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn ft_sess_put(sess: *mut ft_sess) {
    void ft_sess_put(struct ft_sess *sess)
    {
    let mut sess_held: c_int = kref_read(&sess.kref);
    BUG_ON(!sess_held);
    kref_put(&sess.kref, ft_sess_free);
    }
#[no_mangle]
unsafe extern "C" fn ft_prlo(rdata: *mut fc_rport_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn ft_recv(lport: *mut fc_lport, fp: *mut fc_frame) {
    static void ft_recv(struct fc_lport *lport, struct fc_frame *fp)
    {
    struct ft_sess *sess;
    let mut sid: u32 = fc_frame_sid(fp);
