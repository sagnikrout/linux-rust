...
//! Source: drivers/target/tcm_fc/tfc_cmd.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn _ft_dump_cmd(cmd: *mut ft_cmd, caller: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn ft_dump_cmd(cmd: *mut ft_cmd, caller: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn ft_free_cmd(cmd: *mut ft_cmd) {
...
#[no_mangle]
pub unsafe extern "C" fn ft_release_cmd(se_cmd: *mut se_cmd) {
...
#[no_mangle]
pub unsafe extern "C" fn ft_check_stop_free(se_cmd: *mut se_cmd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ft_queue_status(se_cmd: *mut se_cmd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ft_write_pending(se_cmd: *mut se_cmd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ft_recv_seq(sp: *mut fc_seq, fp: *mut fc_frame, arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn ft_send_tm(cmd: *mut ft_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ft_queue_tm_resp(se_cmd: *mut se_cmd) {
...
#[no_mangle]
pub unsafe extern "C" fn ft_aborted_task(se_cmd: *mut se_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn ft_recv_cmd(sess: *mut ft_sess, fp: *mut fc_frame) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ft_recv_req(sess: *mut ft_sess, fp: *mut fc_frame) {
...
//
#[no_mangle]
unsafe extern "C" fn ft_send_work(work: *mut work_struct) {
    static void ft_send_work(struct work_struct *work)
    {
    struct ft_cmd *cmd = container_of(work, struct ft_cmd, work);
    struct fc_frame_header *fh = fc_frame_header_get(cmd.req_frame);
    struct fcp_cmnd *fcp;
    let mut data_dir: c_int = 0;
    int task_attr;
    fcp = fc_frame_payload_get(cmd.req_frame, sizeof(*fcp));
    if (!fcp)
    goto err;
...
//
    ...
    goto err;
    if (target_submit_prep(&cmd.se_cmd, fcp.fc_cdb, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0,
    core::ptr::null_mut(), 0, GFP_KERNEL))
    return;
