...
//! Source: drivers/target/tcm_fc/tfc_io.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn ft_queue_data_in(se_cmd: *mut se_cmd) -> c_int {
    ...
    size_t remaining;
    let mut f_ctl: u32 = FC_FC_EX_CTX | FC_FC_REL_OFF;
    let mut mem_off: u32 = 0;
    let mut fh_off: u32 = 0;
    let mut frame_off: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn ft_execute_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ft_recv_write_data(cmd: *mut ft_cmd, fp: *mut fc_frame) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ft_invl_hw_context(cmd: *mut ft_cmd) {
