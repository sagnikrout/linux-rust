...
//! Source: drivers/target/target_core_hba.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn transport_backend_register(ops: *const target_backend_ops) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn target_backend_unregister(ops: *const target_backend_ops) {
...
#[no_mangle]
pub unsafe extern "C" fn target_sense_desc_format(dev: *mut se_device) -> bool {
