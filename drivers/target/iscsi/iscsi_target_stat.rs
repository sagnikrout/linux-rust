...
//! Source: drivers/target/iscsi/iscsi_target_stat.c
#![no_std]
...
pub const ISCSI_INST_NUM_NODES: c_int = 1;

pub const ISCSI_DISCONTINUITY_TIME: c_int = 0;
pub const ISCSI_NODE_INDEX: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn iscsi_stat_login_inst_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn iscsi_stat_logout_inst_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn iscsi_stat_logout_indx_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn iscsi_stat_sess_inst_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn iscsi_stat_sess_node_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn iscsi_stat_sess_indx_show(item: *mut config_item, page: *mut c_char) -> isize {
