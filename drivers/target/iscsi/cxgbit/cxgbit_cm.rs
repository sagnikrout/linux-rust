...
//! Source: drivers/target/iscsi/cxgbit/cxgbit_cm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cxgbit_init_wr_wait(wr_waitp: *mut cxgbit_wr_wait) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_np_hashfn(cnp: *const cxgbit_np) -> c_int {
    ...
    if (p) {
    let mut bucket: c_int = cxgbit_np_hashfn(cnp);
    p.cnp = cnp;
    p.stid = stid;
    ...
    {
    let mut stid: c_int = -1, bucket = cxgbit_np_hashfn(cnp);
    struct np_info *p;
    spin_lock(&cdev.np_lock);
...
#[no_mangle]
unsafe extern "C" fn cxgbit_np_hash_del(cdev: *mut cxgbit_device, cnp: *mut cxgbit_np) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn _cxgbit_free_cnp(kref: *mut kref) {
...
// port_id = i;
    ...
    let mut ss_family: c_int = sockaddr.ss_family;
    struct net_device *ndev = core::ptr::null_mut();
    struct cxgbit_device *cdev = core::ptr::null_mut();
    rcu_read_lock();
    ...
    if (!ndev)
    goto out;
    cdev = cxgbit_find_device(ndev, core::ptr::null_mut());
    out:
    rcu_read_unlock();
    return cdev;
    }
#[no_mangle]
unsafe extern "C" fn cxgbit_inaddr_any(cnp: *mut cxgbit_np) -> bool {
    ...
    {
    int stid, ret;
    let mut ss_family: c_int = cnp.com.local_addr.ss_family;
    if (!test_bit(CDEV_STATE_UP, &cdev.flags))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn cxgbit_setup_cdev_np(cnp: *mut cxgbit_np) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_setup_all_np(cnp: *mut cxgbit_np) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxgbit_setup_np(np: *mut iscsi_np, ksockaddr: *mut sockaddr_storage) -> c_int {
    ...
    cnp.np = np;
    cnp.com.cdev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn cxgbit_accept_np(np: *mut iscsi_np, conn: *mut iscsit_conn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_free_all_np(cnp: *mut cxgbit_np) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_free_cdev_np(cnp: *mut cxgbit_np) {
...
#[no_mangle]
pub unsafe extern "C" fn cxgbit_free_np(np: *mut iscsi_np) {
    ...
    spin_unlock_bh(&cnp.np_accept_lock);
    np.np_context = core::ptr::null_mut();
    cxgbit_put_cnp(cnp);
    }
#[no_mangle]
unsafe extern "C" fn cxgbit_send_halfclose(csk: *mut cxgbit_sock) {
    static void cxgbit_send_halfclose(struct cxgbit_sock *csk)
    {
    struct sk_buff *skb;
    let mut len: u32 = roundup(sizeof(struct cpl_close_con_req), 16);
...
#[no_mangle]
unsafe extern "C" fn cxgbit_arp_failure_discard(handle: *mut c_void, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_abort_arp_failure(handle: *mut c_void, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_send_abort_req(csk: *mut cxgbit_sock) -> c_int {
    static int cxgbit_send_abort_req(struct cxgbit_sock *csk)
    {
    struct sk_buff *skb;
    let mut len: u32 = roundup(sizeof(struct cpl_abort_req), 16);
...
#[no_mangle]
pub unsafe extern "C" fn cxgbit_abort_conn(csk: *mut cxgbit_sock) {
...
#[no_mangle]
unsafe extern "C" fn __cxgbit_free_conn(csk: *mut cxgbit_sock) {
    static void __cxgbit_free_conn(struct cxgbit_sock *csk)
    {
...
#[no_mangle]
pub unsafe extern "C" fn cxgbit_free_conn(conn: *mut iscsit_conn) {
    void cxgbit_free_conn(struct iscsit_conn *conn)
    {
    __cxgbit_free_conn(conn.context);
    }
#[no_mangle]
unsafe extern "C" fn cxgbit_set_emss(csk: *mut cxgbit_sock, opt: u16) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_free_skb(csk: *mut cxgbit_sock) {
...
#[no_mangle]
pub unsafe extern "C" fn _cxgbit_free_csk(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_set_tcp_window(csk: *mut cxgbit_sock, pi: *mut port_info) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_get_iscsi_dcb_state(ndev: *mut net_device) -> u8 {
    static u8 cxgbit_get_iscsi_dcb_state(struct net_device *ndev)
    {
    return ndev.dcbnl_ops.getstate(ndev);
    }
#[no_mangle]
unsafe extern "C" fn cxgbit_select_priority(pri_mask: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_get_iscsi_dcb_priority(ndev: *mut net_device, local_port: u16) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn cxgbit_ofld_send(cdev: *mut cxgbit_device, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_release_tid(cdev: *mut cxgbit_device, tid: u32) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_send_rx_credits(csk: *mut cxgbit_sock, skb: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cxgbit_rx_data_ack(csk: *mut cxgbit_sock) -> c_int {
    int cxgbit_rx_data_ack(struct cxgbit_sock *csk)
    {
    struct sk_buff *skb;
    let mut len: u32 = roundup(sizeof(struct cpl_rx_data_ack), 16);
    u32 credit_dack;
...
pub const FLOWC_WR_NPARAMS_MIN: c_int = 9;
pub const FLOWC_WR_NPARAMS_MAX: c_int = 11;
#[no_mangle]
unsafe extern "C" fn cxgbit_alloc_csk_skb(csk: *mut cxgbit_sock) -> c_int {
    ...
    let mut len: c_uint = roundup(sizeof(*rpl5), 16);
...
//
    ...
    {
    struct cxgbit_sock *csk = core::ptr::null_mut();
    struct cxgbit_np *cnp;
...
#[no_mangle]
pub unsafe extern "C" fn cxgbit_send_tx_flowc_wr(csk: *mut cxgbit_sock) -> u32 {
    ...
    let mut vlan: u16 = ((struct l2t_entry *)csk.l2t).vlan;
...
#[no_mangle]
pub unsafe extern "C" fn cxgbit_setup_conn_digest(csk: *mut cxgbit_sock) -> c_int {
    int cxgbit_setup_conn_digest(struct cxgbit_sock *csk)
    {
    struct sk_buff *skb;
    struct cpl_set_tcb_field *req;
    let mut hcrc: u8 = csk.submode & CXGBIT_SUBMODE_HCRC;
    let mut dcrc: u8 = csk.submode & CXGBIT_SUBMODE_DCRC;
    let mut len: c_uint = roundup(sizeof(*req), 16);
    int ret;
    skb = alloc_skb(len, GFP_KERNEL);
    if (!skb)
    return -ENOMEM;
...
#[no_mangle]
pub unsafe extern "C" fn cxgbit_setup_conn_pgidx(csk: *mut cxgbit_sock, pg_idx: u32) -> c_int {
    ...
    struct cxgbit_sock *csk;
    struct cxgbit_np *cnp;
    let mut tcp_opt: u16 = be16_to_cpu(req.tcp_opt);
    let mut snd_isn: u32 = be32_to_cpu(req.snd_isn);
    let mut rcv_isn: u32 = be32_to_cpu(req.rcv_isn);
    csk = lookup_tid(t, tid);
    if (unlikely(!csk)) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_queue_rx_skb(csk: *mut cxgbit_sock, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_peer_close(csk: *mut cxgbit_sock, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_close_con_rpl(csk: *mut cxgbit_sock, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_abort_req_rss(csk: *mut cxgbit_sock, skb: *mut sk_buff) {
    ...
    let mut release: bool = false;
    let mut wakeup_thread: bool = false;
...
#[no_mangle]
unsafe extern "C" fn cxgbit_abort_rpl_rss(csk: *mut cxgbit_sock, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_credit_err(csk: *const cxgbit_sock) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_fw4_ack(csk: *mut cxgbit_sock, skb: *mut sk_buff) {
    static void cxgbit_fw4_ack(struct cxgbit_sock *csk, struct sk_buff *skb)
    {
    struct cpl_fw4_ack *rpl = (struct cpl_fw4_ack *)cplhdr(skb);
    let mut credits: u32 = rpl.credits;
    let mut snd_una: u32 = ntohl(rpl.snd_una);
    csk.wr_cred += credits;
...
#[no_mangle]
unsafe extern "C" fn cxgbit_set_tcb_rpl(cdev: *mut cxgbit_device, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_process_rx_cpl(csk: *mut cxgbit_sock, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn cxgbit_rx_cpl(cdev: *mut cxgbit_device, skb: *mut sk_buff) {
    ...
    struct tid_info *t = lldi.tids;
    let mut tid: c_uint = GET_TID(cpl);
    let mut opcode: u8 = cxgbit_skcb_rx_opcode(skb);
    let mut ref: bool = true;
    switch (opcode) {
    case CPL_FW4_ACK:
