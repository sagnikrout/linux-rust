...
//! Source: drivers/target/iscsi/iscsi_target_configfs.c
#![no_std]
...
// Start items for lio_target_portal_cit
    ...
    struct iscsi_tpg_np *tpg_np_new = core::ptr::null_mut();
    u32 op;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn lio_target_np_iser_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn lio_target_np_cxgbit_show(item: *mut config_item, page: *mut c_char) -> isize {
...
pub const MAX_PORTAL_LEN: c_int = 256;
    ...
    let mut sockaddr: sockaddr_storage = { };
    int ret;
...
//
    tpg_np = iscsit_tpg_add_network_portal(tpg, &sockaddr, core::ptr::null_mut(),
    ISCSI_TCP);
    if (IS_ERR(tpg_np)) {
    iscsit_put_tpg(tpg);
...
// Start items for lio_target_nacl_auth_cit
    ...
    if (!strncmp("core::ptr::null_mut()", auth.name, 4))				\
...
#[no_mangle]
unsafe extern "C" fn lio_target_nacl_info_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn lio_target_nacl_tag_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn lio_target_tiqn_deltpg(se_tpg: *mut se_portal_group) {
...
#[no_mangle]
unsafe extern "C" fn lio_target_add_wwn_groups(wwn: *mut se_wwn) {
...
// Start lio_target_discovery_auth_cit
    ...
    if (!discovery_tpg) {
    pr_err("iscsit_global.discovery_tpg is core::ptr::null_mut()\n");
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn iscsi_get_cmd_state(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lio_sess_get_index(se_sess: *mut se_session) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lio_queue_data_in(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lio_write_pending(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lio_queue_status(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lio_queue_tm_rsp(se_cmd: *mut se_cmd) {
...
#[no_mangle]
unsafe extern "C" fn lio_aborted_task(se_cmd: *mut se_cmd) {
...
#[no_mangle]
unsafe extern "C" fn lio_tpg_get_tag(se_tpg: *mut se_portal_group) -> u16 {
    static u16 lio_tpg_get_tag(struct se_portal_group *se_tpg)
    {
    return to_iscsi_tpg(se_tpg).tpgt;
    }
#[no_mangle]
unsafe extern "C" fn lio_tpg_get_default_depth(se_tpg: *mut se_portal_group) -> u32 {
    static u32 lio_tpg_get_default_depth(struct se_portal_group *se_tpg)
    {
    return to_iscsi_tpg(se_tpg).tpg_attrib.default_cmdsn_depth;
    }
#[no_mangle]
unsafe extern "C" fn lio_tpg_check_demo_mode(se_tpg: *mut se_portal_group) -> c_int {
    static int lio_tpg_check_demo_mode(struct se_portal_group *se_tpg)
    {
    return to_iscsi_tpg(se_tpg).tpg_attrib.generate_node_acls;
    }
#[no_mangle]
unsafe extern "C" fn lio_tpg_check_demo_mode_cache(se_tpg: *mut se_portal_group) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lio_tpg_close_session(se_sess: *mut se_session) {
...
#[no_mangle]
unsafe extern "C" fn lio_tpg_get_inst_index(se_tpg: *mut se_portal_group) -> u32 {
    static u32 lio_tpg_get_inst_index(struct se_portal_group *se_tpg)
    {
    return to_iscsi_tpg(se_tpg).tpg_tiqn.tiqn_index;
    }
#[no_mangle]
unsafe extern "C" fn lio_set_default_node_attributes(se_acl: *mut se_node_acl) {
...
#[no_mangle]
unsafe extern "C" fn lio_check_stop_free(se_cmd: *mut se_cmd) -> c_int {
    static int lio_check_stop_free(struct se_cmd *se_cmd)
    {
    return target_put_sess_cmd(se_cmd);
    }
#[no_mangle]
unsafe extern "C" fn lio_release_cmd(se_cmd: *mut se_cmd) {
