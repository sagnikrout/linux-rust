...
//! Source: drivers/target/target_core_stat.c
#![no_std]
...
pub const SCSI_LU_INDEX: c_int = 1;
pub const LU_COUNT: c_int = 1;
//
// SCSI Device Table
//
...
#[no_mangle]
unsafe extern "C" fn target_stat_inst_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_stat_indx_show(item: *mut config_item, page: *mut c_char) -> isize {
    static ssize_t target_stat_indx_show(struct config_item *item, char *page)
    {
    return snprintf(page, PAGE_SIZE, "%u\n", to_stat_dev(item).dev_index);
    }
#[no_mangle]
unsafe extern "C" fn target_stat_role_show(item: *mut config_item, page: *mut c_char) -> isize {
    static ssize_t target_stat_role_show(struct config_item *item, char *page)
    {
    return snprintf(page, PAGE_SIZE, "Target\n");
    }
#[no_mangle]
unsafe extern "C" fn target_stat_ports_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_stat_tgt_inst_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_stat_tgt_indx_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_stat_lu_inst_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_stat_lu_dev_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_stat_lu_indx_show(item: *mut config_item, page: *mut c_char) -> isize {
    static ssize_t target_stat_lu_indx_show(struct config_item *item, char *page)
    {
    return snprintf(page, PAGE_SIZE, "%u\n", SCSI_LU_INDEX);
    }
#[no_mangle]
unsafe extern "C" fn target_stat_lu_lun_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_stat_lu_lu_name_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_stat_lu_vend_show(item: *mut config_item, page: *mut c_char) -> isize {
    static ssize_t target_stat_lu_vend_show(struct config_item *item, char *page)
    {
    struct se_device *dev = to_stat_lu_dev(item);
#[no_mangle]
pub unsafe extern "C" fn snprintf(_arg: page, _arg: PAGE_SIZE, __stringify(INQUIRY_VENDOR_LEN: "%-") -> return {
    return snprintf(page, PAGE_SIZE, "%-" __stringify(INQUIRY_VENDOR_LEN)
    "s\n", dev.t10_wwn.vendor);
    }
#[no_mangle]
unsafe extern "C" fn target_stat_lu_prod_show(item: *mut config_item, page: *mut c_char) -> isize {
    static ssize_t target_stat_lu_prod_show(struct config_item *item, char *page)
    {
    struct se_device *dev = to_stat_lu_dev(item);
#[no_mangle]
pub unsafe extern "C" fn snprintf(_arg: page, _arg: PAGE_SIZE, __stringify(INQUIRY_MODEL_LEN: "%-") -> return {
    return snprintf(page, PAGE_SIZE, "%-" __stringify(INQUIRY_MODEL_LEN)
    "s\n", dev.t10_wwn.model);
    }
#[no_mangle]
unsafe extern "C" fn target_stat_lu_rev_show(item: *mut config_item, page: *mut c_char) -> isize {
    static ssize_t target_stat_lu_rev_show(struct config_item *item, char *page)
    {
    struct se_device *dev = to_stat_lu_dev(item);
#[no_mangle]
pub unsafe extern "C" fn snprintf(_arg: page, _arg: PAGE_SIZE, __stringify(INQUIRY_REVISION_LEN: "%-") -> return {
    return snprintf(page, PAGE_SIZE, "%-" __stringify(INQUIRY_REVISION_LEN)
    "s\n", dev.t10_wwn.revision);
    }
#[no_mangle]
unsafe extern "C" fn target_stat_lu_dev_type_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_stat_lu_status_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_stat_lu_resets_show(item: *mut config_item, page: *mut c_char) -> isize {
...
//
#[no_mangle]
pub unsafe extern "C" fn target_stat_setup_dev_default_groups(dev: *mut se_device) {
...
#[no_mangle]
unsafe extern "C" fn target_stat_port_dev_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_stat_port_indx_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_stat_port_role_show(item: *mut config_item, page: *mut c_char) -> isize {
...
//
#[no_mangle]
pub unsafe extern "C" fn target_stat_setup_port_default_groups(lun: *mut se_lun) {
...
// scsiAttIntrPortName+scsiAttIntrPortIdentifier
    memset(buf, 0, 64);
    if (tpg.se_tpg_tfo.sess_get_initiator_sid != core::ptr::null_mut())
...
//
#[no_mangle]
pub unsafe extern "C" fn target_stat_setup_mappedlun_default_groups(lacl: *mut se_lun_acl) {
