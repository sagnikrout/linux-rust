...
//! Source: drivers/target/target_core_tmr.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn core_tmr_release_req(tmr: *mut se_tmr_req) {
...
//
    ...
    tmr_p.tmr_dev = core::ptr::null_mut();
    }
...
//
    ...
    struct se_cmd *prout_cmd)
    {
    struct se_node_acl *tmr_nacl = core::ptr::null_mut();
    struct se_portal_group *tmr_tpg = core::ptr::null_mut();
    struct se_session *tmr_sess = core::ptr::null_mut();
    bool tas;
//
...
//
    ...
    dev.reservation_holder = core::ptr::null_mut();
    dev.dev_reservation_flags &= ~DRF_SPC2_RESERVATIONS;
