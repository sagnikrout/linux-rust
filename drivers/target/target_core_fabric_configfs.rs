...
//! Source: drivers/target/target_core_fabric_configfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn target_fabric_mappedlun_release(item: *mut config_item) {
    ...
    TF_CIT_SETUP(tpg_mappedlun, &target_fabric_mappedlun_item_ops, core::ptr::null_mut(),
...
// Start of tfc_tpg_mappedlun_port_cit
    ...
    TF_CIT_SETUP(tpg_mappedlun_stat, core::ptr::null_mut(), &target_fabric_mappedlun_stat_group_ops,
    core::ptr::null_mut());
// End of tfc_tpg_mappedlun_port_cit
    TF_CIT_SETUP_DRV(tpg_nacl_attrib, core::ptr::null_mut(), core::ptr::null_mut());
    TF_CIT_SETUP_DRV(tpg_nacl_auth, core::ptr::null_mut(), core::ptr::null_mut());
    TF_CIT_SETUP_DRV(tpg_nacl_param, core::ptr::null_mut(), core::ptr::null_mut());
// Start of tfc_tpg_nacl_base_cit
    ...
    struct se_lun_acl *lacl = core::ptr::null_mut();
    char *buf;
...
#[no_mangle]
unsafe extern "C" fn target_fabric_nacl_base_release(item: *mut config_item) {
...
//
    TF_CIT_SETUP(tpg_nacl_stat, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
...
// Start of tfc_tpg_nacl_cit
    ...
    let mut ret: c_int = tf.tf_ops.fabric_init_nodeacl(se_nacl, name);
    if (ret) {
    configfs_remove_default_groups(&se_nacl.acl_fabric_stat_group);
    core_tpg_del_initiator_node_acl(se_nacl);
    return ERR_PTR(ret);
...
//
    ...
    TF_CIT_SETUP(tpg_nacl, core::ptr::null_mut(), &target_fabric_nacl_group_ops, core::ptr::null_mut());
// End of tfc_tpg_nacl_cit
// Start of tfc_tpg_np_base_cit
#[no_mangle]
unsafe extern "C" fn target_fabric_np_base_release(item: *mut config_item) {
    ...
    TF_CIT_SETUP_DRV(tpg_np_base, &target_fabric_np_base_item_ops, core::ptr::null_mut());
...
// Start of tfc_tpg_np_cit
    ...
    pr_err("tf.tf_ops.fabric_make_np is core::ptr::null_mut()\n");
    return ERR_PTR(-ENOSYS);
    }
...
//
    ...
    TF_CIT_SETUP(tpg_np, core::ptr::null_mut(), &target_fabric_np_group_ops, core::ptr::null_mut());
...
// Start of tfc_tpg_port_cit
    ...
    if (lun.lun_se_dev !=  core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn target_fabric_port_release(item: *mut config_item) {
    ...
    TF_CIT_SETUP(tpg_port, &target_fabric_port_item_ops, core::ptr::null_mut(), target_fabric_port_attrs);
...
// Start of tfc_tpg_port_stat_cit
    ...
    TF_CIT_SETUP(tpg_port_stat, core::ptr::null_mut(), &target_fabric_port_stat_group_ops, core::ptr::null_mut());
...
// Start of tfc_tpg_lun_cit
    ...
    TF_CIT_SETUP(tpg_lun, core::ptr::null_mut(), &target_fabric_lun_group_ops, core::ptr::null_mut());
// End of tfc_tpg_lun_cit
    TF_CIT_SETUP_DRV(tpg_attrib, core::ptr::null_mut(), core::ptr::null_mut());
    TF_CIT_SETUP_DRV(tpg_auth, core::ptr::null_mut(), core::ptr::null_mut());
    TF_CIT_SETUP_DRV(tpg_param, core::ptr::null_mut(), core::ptr::null_mut());
// Start of tfc_tpg_base_cit
#[no_mangle]
unsafe extern "C" fn target_fabric_tpg_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn target_fabric_tpg_base_rtpi_show(item: *mut config_item, page: *mut c_char) -> isize {
    ...
    struct configfs_attribute **attrs = core::ptr::null_mut();
    let mut nr_attrs: usize = 0;
    let mut i: c_int = 0;
    if (tf.tf_ops.tfc_tpg_base_attrs)
    while (tf.tf_ops.tfc_tpg_base_attrs[nr_attrs] != core::ptr::null_mut())
    nr_attrs++;
...
// + 1 for final NULL in the array
    ...
    return -ENOMEM;
    if (tf.tf_ops.tfc_tpg_base_attrs)
    for (; tf.tf_ops.tfc_tpg_base_attrs[i] != core::ptr::null_mut(); i++)
...
// Start of tfc_tpg_cit
    ...
    pr_err("tf.tf_ops.fabric_make_tpg is core::ptr::null_mut()\n");
    return ERR_PTR(-ENOSYS);
    }
...
#[no_mangle]
unsafe extern "C" fn target_fabric_release_wwn(item: *mut config_item) {
...
//
    TF_CIT_SETUP(wwn_fabric_stats, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
// End of tfc_wwn_fabric_stats_cit
    static ssize_t
    ...
    TF_CIT_SETUP(wwn_param, core::ptr::null_mut(), core::ptr::null_mut(), target_fabric_wwn_param_attrs);
// Start of tfc_wwn_cit
    ...
    pr_err("tf.tf_ops.fabric_make_wwn is core::ptr::null_mut()\n");
    return ERR_PTR(-ENOSYS);
    }
    ...
    TF_CIT_SETUP_DRV(wwn, core::ptr::null_mut(), &target_fabric_wwn_group_ops);
    TF_CIT_SETUP_DRV(discovery, core::ptr::null_mut(), core::ptr::null_mut());
#[no_mangle]
pub unsafe extern "C" fn target_fabric_setup_cits(tf: *mut target_fabric_configfs) -> c_int {
