...
//! Source: drivers/mailbox/riscv-sbi-mpxy-mbox.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sbi_mpxy_channel_attrs {
// Message protocol ID
    pub msg_proto_id: u32,
// Message protocol version
    pub msg_proto_version: u32,
// Message protocol maximum message length
    pub msg_max_len: u32,
// Message protocol message send timeout in microseconds
    pub msg_send_timeout: u32,
// Message protocol message completion timeout in microseconds
    pub msg_completion_timeout: u32,
// Bit array for channel capabilities
    pub capability: u32,
// SSE event ID
    pub sse_event_id: u32,
// MSI enable/disable control knob
    pub msi_control: u32,
// Channel MSI info
    pub msi_info: sbi_mpxy_msi_info,
// Events state control
    pub events_state_ctrl: u32,
}
...
#[no_mangle]
unsafe extern "C" fn mpxy_get_channel_count(channel_count: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpxy_get_channel_ids(channel_count: u32, channel_ids: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpxy_get_shmem_size(shmem_size: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpxy_setup_shmem(cpu: c_uint) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpxy_mbox_channel {
    pub mbox: *mut mpxy_mbox,
    pub channel_id: u32,
    pub attrs: sbi_mpxy_channel_attrs,
    pub rpmi_attrs: sbi_mpxy_rpmi_channel_attrs,
    pub notif: *mut sbi_mpxy_notification_data,
    pub max_xfer_len: u32,
    pub have_events_state: bool,
    pub msi_index: u32,
    pub msi_irq: u32,
    pub started: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpxy_mbox {
    pub dev: *mut device,
    pub channel_count: u32,
    pub channels: *mut mpxy_mbox_channel,
    pub msi_count: u32,
    pub msi_index_to_channel: *mut mpxy_mbox_channel,
...
#[no_mangle]
unsafe extern "C" fn mpxy_mbox_read_rpmi_attrs(mchan: *mut mpxy_mbox_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpxy_mbox_send_data(chan: *mut mbox_chan, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpxy_mbox_irq_thread(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// Request channel MSI handler
    rc = request_threaded_irq(mchan.msi_irq, core::ptr::null_mut(), mpxy_mbox_irq_thread,
    0, dev_name(dev), chan);
    if (rc) {
...
#[no_mangle]
unsafe extern "C" fn mpxy_mbox_setup_events(mchan: *mut mpxy_mbox_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpxy_mbox_cleanup_events(mchan: *mut mpxy_mbox_channel) {
...
#[no_mangle]
unsafe extern "C" fn mpxy_mbox_startup(chan: *mut mbox_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpxy_mbox_shutdown(chan: *mut mbox_chan) {
...
#[no_mangle]
unsafe extern "C" fn mpxy_mbox_msi_write(desc: *mut msi_desc, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn mpxy_mbox_populate_channels(mbox: *mut mpxy_mbox) -> c_int {
    static int mpxy_mbox_populate_channels(struct mpxy_mbox *mbox)
    {
    u32 i, *channel_ids __free(kfree) = core::ptr::null_mut();
    struct mpxy_mbox_channel *mchan;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn mpxy_mbox_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    mpxy_setup_shmem, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mpxy_mbox_remove(pdev: *mut platform_device) {
