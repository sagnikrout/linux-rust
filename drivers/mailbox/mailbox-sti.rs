...
//! Source: drivers/mailbox/mailbox-sti.c
#![no_std]
...
pub const STI_IRQ_VAL_OFFSET: c_uint = 0x04   /* Read interrupt status	              */;
pub const STI_IRQ_SET_OFFSET: c_uint = 0x24   /* Generate a Tx channel interrupt     */;
pub const STI_IRQ_CLR_OFFSET: c_uint = 0x44   /* Clear pending Rx interrupts	      */;
pub const STI_ENA_VAL_OFFSET: c_uint = 0x64   /* Read enable status		      */;
pub const STI_ENA_SET_OFFSET: c_uint = 0x84   /* Enable a channel		      */;
pub const STI_ENA_CLR_OFFSET: c_uint = 0xa4   /* Disable a channel		      */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sti_mbox_device {
    pub dev: *mut device,
    pub mbox: *mut mbox_controller,
    pub base: *mut void __iomem,
    pub name: *const c_char,
    pub enabled: [u32; STI_MBOX_INST_MAX],
    pub lock: spinlock_t,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sti_channel {
    pub mdev: *mut sti_mbox_device,
    pub instance: c_uint,
    pub channel: c_uint,
}

#[no_mangle]
pub unsafe extern "C" fn sti_mbox_channel_is_enabled(chan: *mut mbox_chan) -> bool {
    static inline bool sti_mbox_channel_is_enabled(struct mbox_chan *chan)
    {
    struct sti_channel *chan_info = chan.con_priv;
    struct sti_mbox_device *mdev = chan_info.mdev;
    let mut instance: c_uint = chan_info.instance;
    let mut channel: c_uint = chan_info.channel;
...
#[no_mangle]
unsafe extern "C" fn sti_mbox_enable_channel(chan: *mut mbox_chan) {
...
#[no_mangle]
unsafe extern "C" fn sti_mbox_disable_channel(chan: *mut mbox_chan) {
...
#[no_mangle]
unsafe extern "C" fn sti_mbox_clear_irq(chan: *mut mbox_chan) {
...
#[no_mangle]
unsafe extern "C" fn sti_mbox_thread_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sti_mbox_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sti_mbox_tx_is_ready(chan: *mut mbox_chan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sti_mbox_send_data(chan: *mut mbox_chan, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sti_mbox_startup_chan(chan: *mut mbox_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sti_mbox_shutdown_chan(chan: *mut mbox_chan) {
...
// Reset channel
    ...
    struct sti_channel *chan_info;
    struct mbox_chan *chan = core::ptr::null_mut();
    let mut instance: c_uint = spec.args[0];
    let mut channel: c_uint = spec.args[1];
    int i;
// Bounds checking
...
#[no_mangle]
unsafe extern "C" fn sti_mbox_probe(pdev: *mut platform_device) -> c_int {
