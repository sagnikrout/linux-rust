...
//! Source: drivers/mailbox/mailbox.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn add_to_rbuf(chan: *mut mbox_chan, mssg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msg_submit(chan: *mut mbox_chan) {
...
#[no_mangle]
unsafe extern "C" fn tx_tick(chan: *mut mbox_chan, r: c_int) {
...
#[no_mangle]
unsafe extern "C" fn txdone_hrtimer(hrtimer: *mut hrtimer) -> enum hrtimer_restart {
...
//
#[no_mangle]
pub unsafe extern "C" fn mbox_chan_received_data(chan: *mut mbox_chan, mssg: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mbox_chan_txdone(chan: *mut mbox_chan, r: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mbox_client_txdone(chan: *mut mbox_chan, r: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mbox_client_peek_data(chan: *mut mbox_chan) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mbox_chan_tx_slots_available(chan: *mut mbox_chan) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn mbox_send_message(chan: *mut mbox_chan, mssg: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mbox_flush(chan: *mut mbox_chan, timeout: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbox_clean_and_put_channel(chan: *mut mbox_chan) {
    static void mbox_clean_and_put_channel(struct mbox_chan *chan)
    {
// The queued TX requests are simply aborted, no callbacks are made
    scoped_guard(spinlock_irqsave, &chan.lock) {
    chan.cl = core::ptr::null_mut();
    chan.active_req = MBOX_NO_MSG;
...
#[no_mangle]
unsafe extern "C" fn __mbox_bind_client(chan: *mut mbox_chan, cl: *mut mbox_client) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mbox_bind_client(chan: *mut mbox_chan, cl: *mut mbox_client) -> c_int {
...
//
    ...
    const char *name)
    {
    let mut index: c_int = device_property_match_string(cl.dev, "mbox-names", name);
    if (index < 0) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mbox_free_channel(chan: *mut mbox_chan) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mbox_controller_register(mbox: *mut mbox_controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: mbox->txdone_poll) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn mbox_controller_unregister(mbox: *mut mbox_controller) {
...
#[no_mangle]
unsafe extern "C" fn __devm_mbox_controller_unregister(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mbox_seq_stop(s: *mut seq_file, v: *mut c_void) {
    static void mbox_seq_stop(struct seq_file *s, void *v)
    {
    mutex_unlock(&con_mutex);
    }
#[no_mangle]
unsafe extern "C" fn mbox_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
    ...
    seq_printf(seq, " %3u: %s\n", i,
    cl_dev ? dev_name(cl_dev) : "core::ptr::null_mut() device");
    }
    }
    }
    return 0;
...
//
#[no_mangle]
unsafe extern "C" fn mbox_init() -> int __init {
    static int __init mbox_init(void)
    {
    struct dentry *mbox_debugfs = debugfs_create_dir("mailbox", core::ptr::null_mut());
    debugfs_create_file("mailbox_summary", 0444, mbox_debugfs, core::ptr::null_mut(), &mbox_fops);
    return 0;
    }
