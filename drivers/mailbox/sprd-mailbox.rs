...
//! Source: drivers/mailbox/sprd-mailbox.c
#![no_std]
...
pub const SPRD_MBOX_ID: c_uint = 0x0;
pub const SPRD_MBOX_MSG_LOW: c_uint = 0x4;
pub const SPRD_MBOX_MSG_HIGH: c_uint = 0x8;
pub const SPRD_MBOX_TRIGGER: c_uint = 0xc;
pub const SPRD_MBOX_FIFO_RST: c_uint = 0x10;
pub const SPRD_MBOX_FIFO_STS: c_uint = 0x14;
pub const SPRD_MBOX_IRQ_STS: c_uint = 0x18;
pub const SPRD_MBOX_IRQ_MSK: c_uint = 0x1c;
pub const SPRD_MBOX_LOCK: c_uint = 0x20;
pub const SPRD_MBOX_FIFO_DEPTH: c_uint = 0x24 /* outbox only */;
pub const SPRD_MBOX_IN_FIFO_STS2: c_uint = 0x24 /* inbox only, revision 2 */;
// Bit and mask definition for inbox's SPRD_MBOX_FIFO_STS register

pub const SPRD_INBOX_FIFO_DELIVER_SHIFT: c_int = 16;
...
pub const SPRD_OUTBOX_FIFO_WR_SHIFT: c_int = 16;
pub const SPRD_OUTBOX_FIFO_RD_SHIFT: c_int = 24;
...
pub const SPRD_OUTBOX_BASE_SPAN: c_uint = 0x1000;
pub const SPRD_MBOX_R1_CHAN_MAX: c_int = 8;
pub const SPRD_MBOX_R2_CHAN_MAX: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sprd_mbox_info {
    pub version: enum sprd_mbox_version,
    pub supp_id: c_ulong,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sprd_mbox_priv {
    pub mbox: mbox_controller,
    pub dev: *mut device,
    pub inbox_base: *mut void __iomem,
    pub outbox_base: *mut void __iomem,
// Base register address for supplementary outbox
    pub supp_base: *mut void __iomem,
    pub outbox_fifo_depth: u32,
    pub info: *const sprd_mbox_info,
    pub lock: mutex,
    pub refcnt: u32,
    pub chan: [mbox_chan; SPRD_MBOX_R2_CHAN_MAX],
}
...
#[no_mangle]
unsafe extern "C" fn sprd_mbox_get_fifo_len(priv: *mut sprd_mbox_priv, fifo_sts: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn do_outbox_isr(base: *mut void __iomem, priv: *mut sprd_mbox_priv) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sprd_mbox_outbox_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sprd_mbox_supp_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sprd_mbox_inbox_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sprd_mbox_send_data(chan: *mut mbox_chan, msg: *mut c_void) -> c_int {
    static int sprd_mbox_send_data(struct mbox_chan *chan, void *msg)
    {
    struct sprd_mbox_priv *priv = to_sprd_mbox_priv(chan.mbox);
    let mut id: c_ulong = (unsigned long)chan.con_priv;
    u32 *data = msg;
...
#[no_mangle]
unsafe extern "C" fn sprd_mbox_flush(chan: *mut mbox_chan, timeout: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_mbox_startup(chan: *mut mbox_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_mbox_shutdown(chan: *mut mbox_chan) {
...
#[no_mangle]
unsafe extern "C" fn sprd_mbox_probe(pdev: *mut platform_device) -> c_int {
