...
//! Source: drivers/mailbox/qcom-ipcc.c
#![no_std]
...
pub const IPCC_REG_CONFIG: c_uint = 0x08;
pub const IPCC_REG_SEND_ID: c_uint = 0x0c;
pub const IPCC_REG_RECV_ID: c_uint = 0x10;
pub const IPCC_REG_RECV_SIGNAL_ENABLE: c_uint = 0x14;
pub const IPCC_REG_RECV_SIGNAL_DISABLE: c_uint = 0x18;
pub const IPCC_REG_RECV_SIGNAL_CLEAR: c_uint = 0x1c;
pub const IPCC_REG_CLIENT_CLEAR: c_uint = 0x38;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_ipcc_chan_info {
    pub client_id: u16,
    pub signal_id: u16,
}
...
#[no_mangle]
pub unsafe extern "C" fn qcom_ipcc_get_hwirq(client_id: u16, signal_id: u16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn qcom_ipcc_irq_fn(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qcom_ipcc_mask_irq(irqd: *mut irq_data) {
    static void qcom_ipcc_mask_irq(struct irq_data *irqd)
    {
    struct qcom_ipcc *ipcc = irq_data_get_irq_chip_data(irqd);
    let mut hwirq: irq_hw_number_t = irqd_to_hwirq(irqd);
    writel(hwirq, ipcc.base + IPCC_REG_RECV_SIGNAL_DISABLE);
    }
#[no_mangle]
unsafe extern "C" fn qcom_ipcc_unmask_irq(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn qcom_ipcc_mbox_send_data(chan: *mut mbox_chan, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ipcc_mbox_shutdown(chan: *mut mbox_chan) {
    ...
    struct mbox_chan *chan, *free_chan = core::ptr::null_mut();
    struct device *dev;
    int chan_id;
    dev = ipcc.dev;
    if (ph.args_count != 2)
...
#[no_mangle]
unsafe extern "C" fn qcom_ipcc_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ipcc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ipcc_remove(pdev: *mut platform_device) {
    ...
    NOIRQ_SYSTEM_SLEEP_PM_OPS(core::ptr::null_mut(), qcom_ipcc_pm_resume)
    };
...
#[no_mangle]
unsafe extern "C" fn qcom_ipcc_init() -> int __init {
