...
//! Source: drivers/mailbox/bcm74110-mailbox.c
#![no_std]
...
pub const BCM_MBOX_CFGA: c_uint = 0x0;
pub const BCM_MBOX_CFGB: c_uint = 0x4;
pub const BCM_MBOX_CFGC: c_uint = 0x8;
pub const BCM_MBOX_CFGD: c_uint = 0xc;
pub const BCM_MBOX_CTRL: c_uint = 0x10;

pub const BCM_MBOX_STATUS0: c_uint = 0x14;

pub const BCM_MBOX_STATUS1: c_uint = 0x18;
pub const BCM_MBOX_STATUS2: c_uint = 0x1c;
pub const BCM_MBOX_WDATA: c_uint = 0x20;
pub const BCM_MBOX_RDATA: c_uint = 0x28;
pub const BCM_MBOX_IRQ_STATUS: c_uint = 0x0;
pub const BCM_MBOX_IRQ_SET: c_uint = 0x4;
pub const BCM_MBOX_IRQ_CLEAR: c_uint = 0x8;
pub const BCM_MBOX_IRQ_MASK_STATUS: c_uint = 0xc;
pub const BCM_MBOX_IRQ_MASK_SET: c_uint = 0x10;
pub const BCM_MBOX_IRQ_MASK_CLEAR: c_uint = 0x14;

pub const BCM_LINK_CODE0: c_uint = 0xbe0;
pub const BCM_LINK_CODE1: c_uint = 0xbe1;
pub const BCM_LINK_CODE2: c_uint = 0xbe2;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm74110_mbox_msg {
    pub list_entry: list_head,

pub const BCM_MSG_VERSION: c_uint = 0x1;

    do {							\
    pub \: hdr &= ~BCM_MSG_##field##_MASK;,
    pub \: hdr |= FIELD_PREP(BCM_MSG_##field##_MASK, val);,
    } while (0)
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm74110_mbox_chan {
    pub mbox: *mut bcm74110_mbox,
    pub en: bool,
    pub slot: c_int,
    pub type: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm74110_mbox {
    pub pdev: *mut platform_device,
    pub base: *mut void __iomem,
    pub tx_chan: c_int,
    pub rx_chan: c_int,
    pub rx_irq: c_int,
    pub rx_svc_init_list: list_head,
    pub rx_svc_list_lock: spinlock_t,
    pub controller: mbox_controller,
    pub mbox_chan: *mut bcm74110_mbox_chan,
}
...
#[no_mangle]
unsafe extern "C" fn bcm74110_rx_push_init_msg(mbox: *mut bcm74110_mbox, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn bcm74110_rx_process_msg(mbox: *mut bcm74110_mbox) {
...
#[no_mangle]
unsafe extern "C" fn bcm74110_mbox_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bcm74110_mbox_mask_and_clear(mbox: *mut bcm74110_mbox) {
...
#[no_mangle]
unsafe extern "C" fn bcm74110_rx_flush_msg(mbox: *mut bcm74110_mbox) {
...
pub const BCM_DEQUEUE_TIMEOUT_MS: c_int = 30;
...
#[no_mangle]
unsafe extern "C" fn bcm74110_mbox_tx_msg(mbox: *mut bcm74110_mbox, msg: u32) -> c_int {
...
pub const BCM_MBOX_LINK_TRAINING_RETRIES: c_int = 5;
#[no_mangle]
unsafe extern "C" fn bcm74110_mbox_link_training(mbox: *mut bcm74110_mbox) -> c_int {
    static int bcm74110_mbox_link_training(struct bcm74110_mbox *mbox)
    {
    int ret, retries = 0;
    let mut msg: u32 = 0, orig_len = 0, len = BCM_LINK_CODE0;
    do {
    switch (len) {
    case 0:
    retries++;
...
#[no_mangle]
unsafe extern "C" fn bcm74110_mbox_tx_msg_and_wait_ack(mbox: *mut bcm74110_mbox, msg: u32) -> c_int {
...
pub const BCM_MBOX_HAB_MEM_IDX_START: c_uint = 0x30;
pub const BCM_MBOX_HAB_MEM_IDX_SIZE: c_uint = 0x0;
#[no_mangle]
unsafe extern "C" fn bcm74110_mbox_shmem_init(mbox: *mut bcm74110_mbox) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm74110_mbox_init(mbox: *mut bcm74110_mbox) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm74110_mbox_send_data(chan: *mut mbox_chan, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm74110_mbox_chan_startup(chan: *mut mbox_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm74110_mbox_chan_shutdown(chan: *mut mbox_chan) {
...
#[no_mangle]
unsafe extern "C" fn bcm74110_mbox_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn bcm74110_mbox_probe(pdev: *mut platform_device) -> c_int {
