...
//! Source: drivers/mailbox/ti-msgmgr.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_msgmgr_valid_queue_desc {
    pub queue_id: u8,
    pub proxy_id: u8,
    pub is_tx: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_msgmgr_desc {
    pub queue_count: u8,
    pub max_message_size: u8,
    pub max_messages: u8,
    pub data_first_reg: u8,
    pub data_last_reg: u8,
    pub status_cnt_mask: u32,
    pub status_err_mask: u32,
    pub tx_polled: bool,
    pub tx_poll_timeout_ms: c_int,
    pub valid_queues: *const ti_msgmgr_valid_queue_desc,
    pub data_region_name: *const c_char,
    pub status_region_name: *const c_char,
    pub ctrl_region_name: *const c_char,
    pub num_valid_queues: c_int,
    pub is_sproxy: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_queue_inst {
    pub name: [c_char; 30],
    pub queue_id: u8,
    pub proxy_id: u8,
    pub irq: c_int,
    pub is_tx: bool,
    pub queue_buff_start: *mut void __iomem,
    pub queue_buff_end: *mut void __iomem,
    pub queue_state: *mut void __iomem,
    pub queue_ctrl: *mut void __iomem,
    pub chan: *mut mbox_chan,
    pub rx_buff: *mut u32,
    pub polled_rx_mode: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_msgmgr_inst {
    pub dev: *mut device,
    pub desc: *const ti_msgmgr_desc,
    pub queue_proxy_region: *mut void __iomem,
    pub queue_state_debug_region: *mut void __iomem,
    pub queue_ctrl_region: *mut void __iomem,
    pub num_valid_queues: u8,
    pub qinsts: *mut ti_queue_inst,
...
//
    ...
    {
    u32 val;
    let mut status_cnt_mask: u32 = d.status_cnt_mask;
//
...
#[no_mangle]
unsafe extern "C" fn ti_msgmgr_queue_rx_poll_timeout(chan: *mut mbox_chan, timeout_us: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ti_msgmgr_queue_rx_interrupt(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ti_msgmgr_queue_peek_data(chan: *mut mbox_chan) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ti_msgmgr_last_tx_done(chan: *mut mbox_chan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ti_msgmgr_chan_has_polled_queue_rx(chan: *mut mbox_chan) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ti_msgmgr_send_data(chan: *mut mbox_chan, data: *mut c_void) -> c_int {
...
// NOTE: Constraints similar to rx path exists here as well
    ...
    if (trail_bytes) {
    let mut data_trail: u32 = *word_data;
...
//
#[no_mangle]
unsafe extern "C" fn ti_msgmgr_queue_startup(chan: *mut mbox_chan) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ti_msgmgr_queue_shutdown(chan: *mut mbox_chan) {
...
#[no_mangle]
unsafe extern "C" fn ti_msgmgr_queue_rx_set_polled_mode(qinst: *mut ti_queue_inst, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_msgmgr_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_msgmgr_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_msgmgr_probe(pdev: *mut platform_device) -> c_int {
