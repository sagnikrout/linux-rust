...
//! Source: drivers/mailbox/imx-mailbox.c
#![no_std]
...
pub const IMX_MU_CHANS: c_int = 24;
// TX0/RX0/RXDB[0-3]
pub const IMX_MU_SCU_CHANS: c_int = 6;
// TX0/RX0
pub const IMX_MU_S4_CHANS: c_int = 2;
pub const IMX_MU_CHAN_NAME_SIZE: c_int = 32;
pub const IMX_MU_V2_PAR_OFF: c_uint = 0x4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_s4_rpc_msg_max {
    pub hdr: imx_s4_rpc_msg,
    pub data: [u32; 254],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_mu_con_priv {
    pub idx: c_uint,
    pub irq_desc: [c_char; IMX_MU_CHAN_NAME_SIZE],
    pub type: enum imx_mu_chan_type,
    pub chan: *mut mbox_chan,
    pub txdb_work: work_struct,
    pub shutdown: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_mu_priv {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub msg: *mut c_void,
    pub /: *mut *mut raw_spinlock_t xcr_lock; / control register lock,
    pub mbox: mbox_controller,
    pub mbox_chans: [mbox_chan; IMX_MU_CHANS],
    pub con_priv: [imx_mu_con_priv; IMX_MU_CHANS],
    pub dcfg: *const imx_mu_dcfg,
    pub clk: *mut clk,
    pub irq: [c_int; IMX_MU_CHANS],
    pub suspend: bool,
    pub side_b: bool,
    pub xcr: [u32; IMX_MU_xCR_MAX],
    pub num_tr: u32,
    pub num_rr: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_mu_dcfg {
    pub data): *mut *mut *mut *mut int (tx)(struct imx_mu_priv priv, struct imx_mu_con_priv cp, void,
    pub cp): *mut *mut *mut int (rx)(struct imx_mu_priv priv, struct imx_mu_con_priv,
    pub cp): *mut *mut *mut int (rxdb)(struct imx_mu_priv priv, struct imx_mu_con_priv,
    pub priv): *mut *mut int (init)(struct imx_mu_priv,
    pub type: enum imx_mu_type,
    pub /: *mut *mut u32 xTR; / Transmit Register0,
    pub /: *mut *mut u32 xRR; / Receive Register0,
    pub /: *mut *mut u32 xSR[IMX_MU_xSR_MAX]; / Status Registers,
    pub /: *mut *mut u32 xCR[IMX_MU_xCR_MAX]; / Control Registers,
    pub skip_suspend_flag: bool,
}
...
#[no_mangle]
unsafe extern "C" fn imx_mu_write(priv: *mut imx_mu_priv, val: u32, offs: u32) {
    static void imx_mu_write(struct imx_mu_priv *priv, u32 val, u32 offs)
    {
    iowrite32(val, priv.base + offs);
    }
#[no_mangle]
unsafe extern "C" fn imx_mu_read(priv: *mut imx_mu_priv, offs: u32) -> u32 {
    static u32 imx_mu_read(struct imx_mu_priv *priv, u32 offs)
    {
    return ioread32(priv.base + offs);
    }
#[no_mangle]
unsafe extern "C" fn imx_mu_tx_waiting_write(priv: *mut imx_mu_priv, val: u32, idx: u32) -> c_int {
    static int imx_mu_tx_waiting_write(struct imx_mu_priv *priv, u32 val, u32 idx)
    {
    let mut timeout_time: u64 = get_jiffies_64() + IMX_MU_SECO_TX_TOUT;
    u32 status;
    u32 can_write;
...
#[no_mangle]
unsafe extern "C" fn imx_mu_rx_waiting_read(priv: *mut imx_mu_priv, val: *mut u32, idx: u32) -> c_int {
    static int imx_mu_rx_waiting_read(struct imx_mu_priv *priv, u32 *val, u32 idx)
    {
    let mut timeout_time: u64 = get_jiffies_64() + IMX_MU_SECO_RX_TOUT;
    u32 status;
    u32 can_read;
...
#[no_mangle]
unsafe extern "C" fn imx_mu_xcr_rmw(priv: *mut imx_mu_priv, type: enum imx_mu_xcr, set: u32, clr: u32) -> u32 {
    ...
    mbox_chan_received_data(cp.chan, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn imx_mu_specific_tx(priv: *mut imx_mu_priv, cp: *mut imx_mu_con_priv, data: *mut c_void) -> c_int {
    static int imx_mu_specific_tx(struct imx_mu_priv *priv, struct imx_mu_con_priv *cp, void *data)
    {
    u32 *arg = data;
    let mut num_tr: u32 = priv.num_tr;
    int i, ret;
    u32 xsr;
    u32 size, max_size;
...
#[no_mangle]
unsafe extern "C" fn imx_mu_specific_rx(priv: *mut imx_mu_priv, cp: *mut imx_mu_con_priv) -> c_int {
    ...
    u32 xsr;
    u32 size, max_size;
    let mut num_rr: u32 = priv.num_rr;
    data = (u32 *)priv.msg;
...
#[no_mangle]
unsafe extern "C" fn imx_mu_seco_rxdb(priv: *mut imx_mu_priv, cp: *mut imx_mu_con_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_mu_txdb_work(t: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn imx_mu_isr_th(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn imx_mu_isr(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn imx_mu_send_data(chan: *mut mbox_chan, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_mu_startup(chan: *mut mbox_chan) -> c_int {
    static int imx_mu_startup(struct mbox_chan *chan)
    {
    struct imx_mu_priv *priv = to_imx_mu_priv(chan.mbox);
    struct imx_mu_con_priv *cp = chan.con_priv;
    let mut irq_flag: c_ulong = IRQF_NO_THREAD;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn imx_mu_shutdown(chan: *mut mbox_chan) {
...
#[no_mangle]
unsafe extern "C" fn imx_mu_get_tr_rr(priv: *mut imx_mu_priv) {
...
#[no_mangle]
unsafe extern "C" fn imx_mu_init_generic(priv: *mut imx_mu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_mu_init_specific(priv: *mut imx_mu_priv) -> c_int {
    static int imx_mu_init_specific(struct imx_mu_priv *priv)
    {
    unsigned int i;
    let mut num_chans: c_int = priv.dcfg.type & IMX_MU_V2_S4 ? IMX_MU_S4_CHANS : IMX_MU_SCU_CHANS;
...
#[no_mangle]
unsafe extern "C" fn imx_mu_init_seco(priv: *mut imx_mu_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_mu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_mu_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn imx_mu_suspend_noirq(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn imx_mu_resume_noirq(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn imx_mu_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn imx_mu_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    imx_mu_runtime_resume, core::ptr::null_mut())
    };
