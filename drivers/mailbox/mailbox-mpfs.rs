...
//! Source: drivers/mailbox/mailbox-mpfs.c
#![no_std]
...
pub const MESSAGE_INT_OFFSET: c_uint = 0x18cu;
pub const SERVICES_CR_OFFSET: c_uint = 0x50u;
pub const SERVICES_SR_OFFSET: c_uint = 0x54u;
pub const MAILBOX_REG_OFFSET: c_uint = 0x800u;
...
pub struct mpfs_mbox {
    ...
    pub chans: [mbox_chan; 1],
    pub response: *mut mpfs_mss_response,
    pub control_scb: *mut *mut regmap sysreg_scb,,
    pub resp_offset: u16,
}

#[no_mangle]
unsafe extern "C" fn mpfs_mbox_busy(mbox: *mut mpfs_mbox) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mpfs_mbox_last_tx_done(chan: *mut mbox_chan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mpfs_mbox_send_data(chan: *mut mbox_chan, data: *mut c_void) -> c_int {
    ...
    u32 index;
    let mut extra_bits: u8 = msg.cmd_data_size & 3;
    ...
    if (extra_bits) {
    u8 i;
    let mut byte_off: u8 = ALIGN_DOWN(msg.cmd_data_size, 4);
...
#[no_mangle]
unsafe extern "C" fn mpfs_mbox_rx_data(chan: *mut mbox_chan) {
    static void mpfs_mbox_rx_data(struct mbox_chan *chan)
    {
    struct mpfs_mbox *mbox = (struct mpfs_mbox *)chan.con_priv;
    struct mpfs_mss_response *response = mbox.response;
    let mut num_words: u16 = ALIGN((response.resp_size), (4)) / 4U;
    u32 i;
...
#[no_mangle]
unsafe extern "C" fn mpfs_mbox_inbox_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mpfs_mbox_startup(chan: *mut mbox_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpfs_mbox_shutdown(chan: *mut mbox_chan) {
...
#[no_mangle]
pub unsafe extern "C" fn mpfs_mbox_syscon_probe(mbox: *mut mpfs_mbox, pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mpfs_mbox_old_format_probe(mbox: *mut mpfs_mbox, pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpfs_mbox_probe(pdev: *mut platform_device) -> c_int {
...
//
    mbox.control_scb = core::ptr::null_mut();
