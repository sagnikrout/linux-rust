...
//! Source: drivers/mailbox/zynqmp-ipi-mailbox.c
#![no_std]
...
// IPI agent ID any
pub const IPI_ID_ANY: c_uint = 0xFFUL;
// indicate if ZynqMP IPI mailbox driver uses SMC calls or HVC calls
pub const USE_SMC: c_int = 0;
pub const USE_HVC: c_int = 1;
// Default IPI SMC function IDs
pub const SMC_IPI_MAILBOX_OPEN: c_uint = 0x82001000U;
pub const SMC_IPI_MAILBOX_RELEASE: c_uint = 0x82001001U;
pub const SMC_IPI_MAILBOX_STATUS_ENQUIRY: c_uint = 0x82001002U;
pub const SMC_IPI_MAILBOX_NOTIFY: c_uint = 0x82001003U;
pub const SMC_IPI_MAILBOX_ACK: c_uint = 0x82001004U;
pub const SMC_IPI_MAILBOX_ENABLE_IRQ: c_uint = 0x82001005U;
pub const SMC_IPI_MAILBOX_DISABLE_IRQ: c_uint = 0x82001006U;
// IPI SMC Macros
pub const IPI_SMC_ENQUIRY_DIRQ_MASK: c_uint = 0x00000001UL /* Flag to indicate if;
// notification interrupt
// to be disabled.
//
pub const IPI_SMC_ACK_EIRQ_MASK: c_uint = 0x00000001UL /* Flag to indicate if;
// notification interrupt
// to be enabled.
//
// IPI mailbox status
pub const IPI_MB_STATUS_IDLE: c_int = 0;
pub const IPI_MB_STATUS_SEND_PENDING: c_int = 1;
pub const IPI_MB_STATUS_RECV_PENDING: c_int = 2;

// IPI Message Buffer Information
pub const RESP_OFFSET: c_uint = 0x20U;
pub const DEST_OFFSET: c_uint = 0x40U;
pub const IPI_BUF_SIZE: c_uint = 0x20U;

// Macro to represent SGI type for IPI IRQs
pub const IPI_IRQ_TYPE_SGI: c_int = 2;
//
// Module parameters
//
    let mut tx_poll_period: static int = 5;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynqmp_ipi_mchan {
    pub is_opened: c_int,
    pub req_buf: *mut void __iomem,
    pub resp_buf: *mut void __iomem,
    pub rx_buf: *mut c_void,
    pub req_buf_size: usize,
    pub resp_buf_size: usize,
    pub chan_type: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynqmp_ipi_mbox {
    pub pdata: *mut zynqmp_ipi_pdata,
    pub dev: device,
    pub remote_id: u32,
    pub mbox: mbox_controller,
    pub mchans: [zynqmp_ipi_mchan; 2],
    pub setup_ipi_fn: setup_ipi_fn,
}
...
pub struct zynqmp_ipi_pdata {
    ...
    pub local_id: u32,
    pub virq_sgi: c_int,
    pub num_mboxes: c_int,
    pub __counted_by(num_mboxes): zynqmp_ipi_mbox ipi_mboxes[],
}
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_ipi_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_sgi_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_ipi_peek_data(chan: *mut mbox_chan) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_ipi_last_tx_done(chan: *mut mbox_chan) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_ipi_send_data(chan: *mut mbox_chan, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_ipi_startup(chan: *mut mbox_chan) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_ipi_shutdown(chan: *mut mbox_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_ipi_mbox_dev_release(dev: *mut device) {
...
// Initialize dev for IPI mailbox
    ...
    ipi_mbox.dev.release = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn xlnx_mbox_cpuhp_start(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlnx_mbox_cpuhp_down(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xlnx_disable_percpu_irq(data: *mut c_void) {
...
//
    ...
    struct device_node *interrupt_parent = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn xlnx_mbox_cleanup_sgi(pdata: *mut zynqmp_ipi_pdata) {
    static void xlnx_mbox_cleanup_sgi(struct zynqmp_ipi_pdata *pdata)
    {
    cpuhp_remove_state(CPUHP_AP_ONLINE_DYN);
    on_each_cpu(xlnx_disable_percpu_irq, core::ptr::null_mut(), 1);
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_ipi_free_mboxes(pdata: *mut zynqmp_ipi_pdata) {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_ipi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_ipi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_ipi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_ipi_exit() -> void __exit {
