...
//! Source: drivers/mailbox/arm_mhuv2.c
#![no_std]
...
pub const MHUV2_CH_WN_MAX: c_int = 124;
// Number of combined interrupt status registers
pub const MHUV2_CMB_INT_ST_REG_CNT: c_int = 4;

// Register Message Handling Unit Configuration fields
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mhu_cfg_t {
    pub 7: u32 num_ch :,
    pub 25: u32 pad :,
    pub __packed: },
...
#[derive(Copy, Clone)]
pub struct iidr_t {
    pub 12: u32 implementer :,
    pub 4: u32 revision :,
    pub 4: u32 variant :,
    pub 12: u32 product_id :,
    pub __packed: },
// Register Architecture Identification Register fields
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aidr_t {
    pub 4: u32 arch_minor_rev :,
    pub 4: u32 arch_major_rev :,
    pub 24: u32 pad :,
    pub __packed: },
// Sender Channel Window fields
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mhu2_send_ch_wn_reg {
    pub stat: u32,
    pub 0x04]: u8 pad1[0x0C -,
    pub stat_set: u32,
    pub int_st: u32,
    pub int_clr: u32,
    pub int_en: u32,
    pub 0x1C]: u8 pad2[0x20 -,
    pub __packed: },
// Sender frame register fields
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mhu2_send_frame_reg {
    pub ch_wn: [mhu2_send_ch_wn_reg; MHUV2_CH_WN_MAX],
    pub mhu_cfg: mhu_cfg_t,
    pub resp_cfg: u32,
    pub access_request: u32,
    pub access_ready: u32,
    pub int_st: int_st_t,
    pub int_clr: int_clr_t,
    pub int_en: int_en_t,
    pub reserved0: u32,
    pub chcomb_int_st: [u32; MHUV2_CMB_INT_ST_REG_CNT],
    pub 0xFB0]: u8 pad[0xFC8 -,
    pub iidr: iidr_t,
    pub aidr: aidr_t,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mhu2_recv_ch_wn_reg {
    pub stat: u32,
    pub stat_masked: u32,
    pub stat_clear: u32,
    pub 0x0C]: u8 reserved0[0x10 -,
    pub mask: u32,
    pub mask_set: u32,
    pub mask_clear: u32,
    pub 0x1C]: u8 pad[0x20 -,
    pub __packed: },
// Receiver frame register fields
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mhu2_recv_frame_reg {
    pub ch_wn: [mhu2_recv_ch_wn_reg; MHUV2_CH_WN_MAX],
    pub mhu_cfg: mhu_cfg_t,
    pub 0xF84]: u8 reserved0[0xF90 -,
    pub int_st: int_st_t,
    pub int_clr: int_clr_t,
    pub int_en: int_en_t,
    pub pad: u32,
    pub chcomb_int_st: [u32; MHUV2_CMB_INT_ST_REG_CNT],
    pub 0xFB0]: u8 reserved2[0xFC8 -,
    pub iidr: iidr_t,
    pub aidr: aidr_t,
    pub __packed: },
...
pub struct mhuv2 {
    ...
    union {
    pub send: *mut mhu2_send_frame_reg __iomem,
    pub recv: *mut mhu2_recv_frame_reg __iomem,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mhuv2_protocol_ops {
    pub chan): *mut *mut *mut int (rx_startup)(struct mhuv2 mhu, struct mbox_chan,
    pub chan): *mut *mut *mut void (rx_shutdown)(struct mhuv2 mhu, struct mbox_chan,
    pub chan): *mut *mut *mut *mut void (read_data)(struct mhuv2 mhu, struct mbox_chan,
    pub chan): *mut *mut *mut void (tx_startup)(struct mhuv2 mhu, struct mbox_chan,
    pub chan): *mut *mut *mut void (tx_shutdown)(struct mhuv2 mhu, struct mbox_chan,
    pub chan): *mut *mut *mut int (last_tx_done)(struct mhuv2 mhu, struct mbox_chan,
    pub arg): *mut *mut *mut *mut int (send_data)(struct mhuv2 mhu, struct mbox_chan chan, void,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mhuv2_mbox_chan_priv {
    pub ops: *const mhuv2_protocol_ops,
    pub ch_wn_idx: u32,
    union {
    pub windows: u32,
    struct {
...
#[no_mangle]
unsafe extern "C" fn mhuv2_doorbell_rx_startup(mhu: *mut mhuv2, chan: *mut mbox_chan) -> c_int {
...
// ============= Data transfer transport protocol operations ================
    ...
    {
    struct mhuv2_mbox_chan_priv *priv = chan.con_priv;
    let mut i: c_int = priv.ch_wn_idx + priv.windows - 1;
//
...
//
    ...
    {
    struct mhuv2_mbox_chan_priv *priv = chan.con_priv;
    let mut windows: c_int = priv.windows;
...
//
    ...
    let mut bytes_left: c_int = msg.len, bytes_to_send, bytes_in_round, i;
    struct mhuv2_mbox_chan_priv *priv = chan.con_priv;
    let mut windows: c_int = priv.windows;
...
// Interrupt handlers
    ...
    let mut channel: c_int = 0, i, j, offset = 0, windows, protocol, ch_wn;
    u32 stat;
...
#[no_mangle]
unsafe extern "C" fn mhuv2_sender_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mhuv2_receiver_interrupt(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mhuv2_sender_last_tx_done(chan: *mut mbox_chan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mhuv2_sender_send_data(chan: *mut mbox_chan, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhuv2_sender_startup(chan: *mut mbox_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhuv2_sender_shutdown(chan: *mut mbox_chan) {
...
#[no_mangle]
unsafe extern "C" fn mhuv2_receiver_startup(chan: *mut mbox_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhuv2_receiver_shutdown(chan: *mut mbox_chan) {
...
#[no_mangle]
unsafe extern "C" fn mhuv2_receiver_send_data(chan: *mut mbox_chan, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhuv2_receiver_last_tx_done(chan: *mut mbox_chan) -> bool {
    ...
    let mut channel: c_int = 0, i, offset, doorbell, protocol, windows;
    if (pa.nargs != 2)
...
#[no_mangle]
unsafe extern "C" fn mhuv2_verify_protocol(mhu: *mut mhuv2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhuv2_allocate_channels(mhu: *mut mhuv2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhuv2_parse_channels(mhu: *mut mhuv2) -> c_int {
...
//
    ...
    ret = devm_request_threaded_irq(dev, adev.irq[0], core::ptr::null_mut(),
...
// Wait for receiver to be ready
    ...
    ret = devm_request_threaded_irq(dev, mhu.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn mhuv2_probe(adev: *mut amba_device, id: *const amba_id) -> c_int {
    ...
    reg = devm_of_iomap(dev, dev.of_node, 0, core::ptr::null_mut());
    if (IS_ERR(reg))
    return PTR_ERR(reg);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(np, _arg: "arm, _arg: mhuv2-rx")) -> else {
...
#[no_mangle]
unsafe extern "C" fn mhuv2_remove(adev: *mut amba_device) {
