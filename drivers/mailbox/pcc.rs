...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcc_chan_reg {
    pub vaddr: *mut void __iomem,
    pub gas: *mut acpi_generic_address,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcc_chan_info {
    pub chan: pcc_mbox_chan,
    pub db: pcc_chan_reg,
    pub plat_irq_ack: pcc_chan_reg,
    pub cmd_complete: pcc_chan_reg,
    pub cmd_update: pcc_chan_reg,
    pub error: pcc_chan_reg,
    pub plat_irq: c_int,
    pub type: u8,
    pub plat_irq_flags: c_uint,
    pub chan_in_use: bool,
}
...
//
#[no_mangle]
unsafe extern "C" fn read_register(vaddr: *mut void __iomem, val: *mut u64, bit_width: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn write_register(vaddr: *mut void __iomem, val: u64, bit_width: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pcc_chan_reg_read(reg: *mut pcc_chan_reg, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcc_chan_reg_write(reg: *mut pcc_chan_reg, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcc_chan_reg_read_modify_write(reg: *mut pcc_chan_reg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcc_map_interrupt(interrupt: u32, flags: u32) -> c_int {
    ...
    : ACPI_ACTIVE_HIGH;
    return acpi_register_gsi(core::ptr::null_mut(), interrupt, trigger, polarity);
    }
#[no_mangle]
unsafe extern "C" fn pcc_chan_plat_irq_can_be_shared(pchan: *mut pcc_chan_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pcc_mbox_cmd_complete_check(pchan: *mut pcc_chan_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pcc_mbox_error_check_and_clear(pchan: *mut pcc_chan_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcc_chan_acknowledge(pchan: *mut pcc_chan_info) {
...
//
#[no_mangle]
unsafe extern "C" fn pcc_mbox_irq(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
//
    ...
    int subspace_id)
    {
    let mut expected_signature: u32 = PCC_SIGNATURE | subspace_id;
    u32 signature;
...
//
    ...
    pcc_mchan.shmem = core::ptr::null_mut();
    return ERR_PTR(rc);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn pcc_mbox_free_channel(pchan: *mut pcc_mbox_chan) {
    ...
    pcc_mbox_chan.shmem = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn pcc_send_data(chan: *mut mbox_chan, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcc_last_tx_done(chan: *mut mbox_chan) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn pcc_startup(chan: *mut mbox_chan) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcc_shutdown(chan: *mut mbox_chan) {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_pcc_probe() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn pcc_mbox_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcc_init() -> int __init {
...
// Check if PCC support is available.
    ...
    pcc_mbox_probe, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0);
    if (IS_ERR(pcc_pdev)) {
