...
//! Source: drivers/mailbox/mailbox-mchp-ipc-sbi.c
#![no_std]
...
pub const IRQ_STATUS_BITS: c_int = 12;
pub const NUM_CHANS_PER_CLUSTER: c_int = 5;
pub const IPC_DMA_BIT_MASK: c_int = 32;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mchp_ipc_mbox_info {
    pub hw_type: enum ipc_hw,
    pub num_channels: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mchp_ipc_cluster_cfg {
    pub buf_base: *mut c_void,
    pub buf_base_addr: phys_addr_t,
    pub irq: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mchp_ipc_sbi_mbox {
    pub dev: *mut device,
    pub chans: *mut mbox_chan,
    pub cluster_cfg: *mut mchp_ipc_cluster_cfg,
    pub buf_base: *mut c_void,
    pub buf_base_addr: c_ulong,
    pub controller: mbox_controller,
    pub hw_type: enum ipc_hw,
}

#[no_mangle]
unsafe extern "C" fn mchp_ipc_sbi_chan_send(command: u32, channel: u32, address: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp_ipc_sbi_send(command: u32, address: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mchp_ipc_prepare_receive_req(chan: *mut mbox_chan) {
...
#[no_mangle]
unsafe extern "C" fn mchp_ipc_cluster_aggr_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mchp_ipc_send_data(chan: *mut mbox_chan, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp_ipc_startup(chan: *mut mbox_chan) -> c_int {
...
//
    let mut max_size: usize = max(sizeof(struct mchp_ipc_init), sizeof(struct mchp_ipc_sbi_msg));
...
#[no_mangle]
unsafe extern "C" fn mchp_ipc_shutdown(chan: *mut mbox_chan) {
    ...
    let mut chan_id: c_uint = spec.args[0];
...
#[no_mangle]
unsafe extern "C" fn mchp_ipc_get_cluster_aggr_irq(ipc: *mut mchp_ipc_sbi_mbox) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp_ipc_probe(pdev: *mut platform_device) -> c_int {
