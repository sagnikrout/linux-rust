...
//! Source: drivers/xen/xen-pciback/conf_space_capability.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xen_pcibk_config_capability {
    pub cap_list: list_head,
    pub capability: c_int,
// If the device has the capability found above, add these fields
    pub fields: *const config_field,
}
    ...
    .u.w.write = core::ptr::null_mut(),
    },
    {}
    };
#[no_mangle]
pub unsafe extern "C" fn register_capability(cap: *mut xen_pcibk_config_capability) {
    static inline void register_capability(struct xen_pcibk_config_capability *cap)
    {
    list_add_tail(&cap.cap_list, &capabilities);
    }
#[no_mangle]
pub unsafe extern "C" fn xen_pcibk_config_capability_add_fields(dev: *mut pci_dev) -> c_int {
...
//
    let mut int_type: c_int = xen_pcibk_get_interrupt_type(dev);
...
#[no_mangle]
pub unsafe extern "C" fn xen_pcibk_config_capability_init() -> c_int {
