...
//! Source: drivers/xen/xen-pciback/pciback_ops.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn xen_pcibk_control_isr(dev: *mut pci_dev, reset: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xen_pcibk_reset_device(dev: *mut pci_dev) {
...
// disabling MSI/MSI-X interrupts.
    ...
    status = -EALREADY;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dev->msix_enabled) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn xen_pcibk_test_op_pending(pdev: *mut xen_pcibk_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn xen_pcibk_test_and_schedule_op(pdev: *mut xen_pcibk_device) {
    static void xen_pcibk_test_and_schedule_op(struct xen_pcibk_device *pdev)
    {
    let mut eoi: bool = true;
...
#[no_mangle]
unsafe extern "C" fn xen_pcibk_do_one_op(pdev: *mut xen_pcibk_device) {
    static void xen_pcibk_do_one_op(struct xen_pcibk_device *pdev)
    {
    struct pci_dev *dev;
    struct xen_pcibk_dev_data *dev_data = core::ptr::null_mut();
    struct xen_pci_op *op = &pdev.op;
    let mut test_intx: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn xen_pcibk_do_op(data: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn xen_pcibk_handle_event(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xen_pcibk_guest_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t xen_pcibk_guest_interrupt(int irq, void *dev_id)
    {
