...
//! Source: drivers/xen/xen-pciback/xenbus.c
#![no_std]
...
//
    ...
    pdev.sh_info = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn xen_pcibk_disconnect(pdev: *mut xen_pcibk_device) {
...
// before releasing the shared memory
    ...
    if (pdev.sh_info != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn free_pdev(pdev: *mut xen_pcibk_device) {
...
#[no_mangle]
unsafe extern "C" fn xen_pcibk_attach(pdev: *mut xen_pcibk_device) -> c_int {
    static int xen_pcibk_attach(struct xen_pcibk_device *pdev)
    {
    let mut err: c_int = 0;
    int gnt_ref;
    evtchn_port_t remote_evtchn;
    char *magic = core::ptr::null_mut();
    mutex_lock(&pdev.dev_lock);
...
// Wait for frontend to state that it has published the configuration
    ...
    "magic", core::ptr::null_mut(), &magic, core::ptr::null_mut());
    if (err) {
// If configuration didn't get read correctly, wait longer
    ...
    if (magic == core::ptr::null_mut() || strcmp(magic, XEN_PCI_MAGIC) != 0) {
...
#[no_mangle]
unsafe extern "C" fn xen_pcibk_setup_backend(pdev: *mut xen_pcibk_device) -> c_int {
...
//
    ...
    for (i = 0; i < num_devs; i++) {
    let mut l: c_int = snprintf(dev_str, sizeof(dev_str), "dev-%d", i);
...
// watch the backend node for backend configuration information
    ...
    core::ptr::null_mut(), xen_pcibk_be_watch);
    if (err)
    goto out;
    pdev.be_watching = 1;
...
//
    xen_pcibk_be_watch(&pdev.be_watch, core::ptr::null_mut(), core::ptr::null_mut());
    out:
    return err;
    }
#[no_mangle]
unsafe extern "C" fn xen_pcibk_xenbus_remove(dev: *mut xenbus_device) {
...
#[no_mangle]
pub unsafe extern "C" fn xen_pcibk_xenbus_register() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn xen_pcibk_xenbus_unregister() -> void __exit {
