...
//! Source: drivers/xen/pvcalls-back.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pvcalls_fedata {
    pub list: list_head,
    pub dev: *mut xenbus_device,
    pub sring: *mut xen_pvcalls_sring,
    pub ring: xen_pvcalls_back_ring,
    pub irq: c_int,
    pub socket_mappings: list_head,
    pub socketpass_mappings: radix_tree_root,
    pub socket_lock: semaphore,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pvcalls_ioworker {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sock_mapping {
    pub list: list_head,
    pub fedata: *mut pvcalls_fedata,
    pub sockpass: *mut sockpass_mapping,
    pub sock: *mut socket,
    pub id: u64,
    pub ref: grant_ref_t,
    pub ring: *mut pvcalls_data_intf,
    pub bytes: *mut c_void,
    pub data: pvcalls_data,
    pub ring_order: u32,
    pub irq: c_int,
    pub read: core::sync::atomic::AtomicI32,
    pub write: core::sync::atomic::AtomicI32,
    pub io: core::sync::atomic::AtomicI32,
    pub release: core::sync::atomic::AtomicI32,
    pub eoi: core::sync::atomic::AtomicI32,
    pub sk): *mut *mut void (saved_data_ready)(struct sock,
    pub ioworker: pvcalls_ioworker,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sockpass_mapping {
    pub list: list_head,
    pub fedata: *mut pvcalls_fedata,
    pub sock: *mut socket,
    pub id: u64,
    pub reqcopy: xen_pvcalls_request,
    pub copy_lock: spinlock_t,
    pub wq: *mut workqueue_struct,
    pub register_work: work_struct,
    pub sk): *mut *mut void (saved_data_ready)(struct sock,
}
...
#[no_mangle]
unsafe extern "C" fn pvcalls_conn_back_read(opaque: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pvcalls_conn_back_write(map: *mut sock_mapping) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pvcalls_back_ioworker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pvcalls_sk_state_change(sock: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn pvcalls_sk_data_ready(sock: *mut sock) {
...
// first read the order, then map the data ring
    ...
    {
    disable_irq(map.irq);
    if (map.sock.sk != core::ptr::null_mut()) {
    write_lock_bh(&map.sock.sk.sk_callback_lock);
    map.sock.sk.sk_user_data = core::ptr::null_mut();
    ...
    {
    if (mappass.sock.sk != core::ptr::null_mut()) {
    write_lock_bh(&mappass.sock.sk.sk_callback_lock);
    mappass.sock.sk.sk_user_data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn __pvcalls_back_accept(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pvcalls_pass_sk_data_ready(sock: *mut sock) {
...
//
    ...
    data = READ_ONCE(queue.rskq_accept_head) != core::ptr::null_mut();
    if (data) {
    mappass.reqcopy.cmd = 0;
    ret = 0;
    goto out;
...
#[no_mangle]
unsafe extern "C" fn pvcalls_back_work(fedata: *mut pvcalls_fedata) {
...
#[no_mangle]
unsafe extern "C" fn pvcalls_back_event(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t pvcalls_back_event(int irq, void *dev_id)
    {
    struct xenbus_device *dev = dev_id;
    struct pvcalls_fedata *fedata = core::ptr::null_mut();
    let mut eoi_flags: c_uint = XEN_EOI_FLAG_SPURIOUS;
    if (dev) {
    fedata = dev_get_drvdata(&dev.dev);
    if (fedata) {
...
#[no_mangle]
unsafe extern "C" fn pvcalls_back_conn_event(irq: c_int, sock_map: *mut c_void) -> irqreturn_t {
    static irqreturn_t pvcalls_back_conn_event(int irq, void *sock_map)
    {
    struct sock_mapping *map = sock_map;
    struct pvcalls_ioworker *iow;
    if (map == core::ptr::null_mut() || map.sock == core::ptr::null_mut() || map.sock.sk == core::ptr::null_mut() ||
    map.sock.sk.sk_user_data != map) {
...
#[no_mangle]
unsafe extern "C" fn backend_connect(dev: *mut xenbus_device) -> c_int {
    ...
    goto error;
    fedata.irq = err;
    err = request_threaded_irq(fedata.irq, core::ptr::null_mut(), pvcalls_back_event,
    ...
    if (fedata.sring != core::ptr::null_mut())
    xenbus_unmap_ring_vfree(dev, fedata.sring);
    kfree(fedata);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn backend_disconnect(dev: *mut xenbus_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pvcalls_back_remove(dev: *mut xenbus_device) {
...
#[no_mangle]
unsafe extern "C" fn pvcalls_back_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pvcalls_back_fin() -> void __exit {
