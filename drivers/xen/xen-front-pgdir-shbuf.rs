...
//! Source: drivers/xen/xen-front-pgdir-shbuf.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xen_page_directory {
    pub gref_dir_next_page: grant_ref_t,
pub const XEN_GREF_LIST_END: c_int = 0;
    pub /: *mut *mut grant_ref_t gref[]; / Variable length,
}
...
// pages as well.
//
    pub buf): *mut *mut void (calc_num_grefs)(struct xen_front_pgdir_shbuf,
// Fill page directory according to para-virtual display protocol.
    pub buf): *mut *mut void (fill_page_dir)(struct xen_front_pgdir_shbuf,
// Claim grant references for the pages of the buffer.
    int (*grant_refs_for_buffer)(struct xen_front_pgdir_shbuf *buf,
    pub gref_idx): *mut *mut grant_ref_t priv_gref_head, int,
// Map grant references of the buffer.
    pub buf): *mut *mut int (map)(struct xen_front_pgdir_shbuf,
// Unmap grant references of the buffer.
    pub buf): *mut *mut int (unmap)(struct xen_front_pgdir_shbuf,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn xen_front_pgdir_shbuf_map(buf: *mut xen_front_pgdir_shbuf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn xen_front_pgdir_shbuf_unmap(buf: *mut xen_front_pgdir_shbuf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn xen_front_pgdir_shbuf_free(buf: *mut xen_front_pgdir_shbuf) {
    ...
    gnttab_end_foreign_access(buf.grefs[i], core::ptr::null_mut());
    }
    kfree(buf.grefs);
    kfree(buf.directory);
    }
...
//
#[no_mangle]
unsafe extern "C" fn get_num_pages_dir(buf: *mut xen_front_pgdir_shbuf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn backend_calc_num_grefs(buf: *mut xen_front_pgdir_shbuf) {
...
//
#[no_mangle]
unsafe extern "C" fn guest_calc_num_grefs(buf: *mut xen_front_pgdir_shbuf) {
...
//
#[no_mangle]
unsafe extern "C" fn backend_unmap(buf: *mut xen_front_pgdir_shbuf) -> c_int {
    ...
    ret = gnttab_unmap_refs(unmap_ops, core::ptr::null_mut(), buf.pages,
    buf.num_pages);
    for (i = 0; i < buf.num_pages; i++) {
    ...
    buf.backend_map_handles = core::ptr::null_mut();
    return ret;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn backend_map(buf: *mut xen_front_pgdir_shbuf) -> c_int {
    static int backend_map(struct xen_front_pgdir_shbuf *buf)
    {
    struct gnttab_map_grant_ref *map_ops = core::ptr::null_mut();
    unsigned char *ptr;
...
//
    ...
    let mut to_copy: c_int = XEN_NUM_GREFS_PER_PAGE;
    ...
    ret = gnttab_map_refs(map_ops, core::ptr::null_mut(), buf.pages, buf.num_pages);
...
//
#[no_mangle]
unsafe extern "C" fn backend_fill_page_dir(buf: *mut xen_front_pgdir_shbuf) {
...
//
#[no_mangle]
unsafe extern "C" fn guest_fill_page_dir(buf: *mut xen_front_pgdir_shbuf) {
...
//
#[no_mangle]
unsafe extern "C" fn grant_references(buf: *mut xen_front_pgdir_shbuf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn alloc_storage(buf: *mut xen_front_pgdir_shbuf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn xen_front_pgdir_shbuf_alloc(cfg: *mut xen_front_pgdir_shbuf_cfg) -> c_int {
