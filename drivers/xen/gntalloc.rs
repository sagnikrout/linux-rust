...
//
    ...
    let mut limit: static unsigned int = 1024;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct notify_info {
    pub /: *mut *mut uint16_t pgoff:12; / Bits 0-11: Offset of the byte to clear,
    pub /: *mut *mut uint16_t flags:2; / Bits 12-13: Unmap notification flags,
    pub /: *mut *mut int event; / Port (event channel) to notify,
}

// Metadata on a grant reference.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gntalloc_gref {
    pub /: *mut *mut list_head next_gref; / list entry gref_list,
    pub /: *mut *mut list_head next_file; / list entry file->list, if open,
    pub /: *mut *mut *mut page page; / The shared page,
    pub /: *mut *mut uint64_t file_index; / File offset for mmap(),
    pub /: *mut *mut unsigned int users; / Use count - when zero, waiting on Xen,
    pub /: *mut *mut grant_ref_t gref_id; / The grant reference number,
    pub /: *mut *mut notify_info notify; / Unmap notification,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gntalloc_file_private_data {
    pub list: list_head,
    pub index: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gntalloc_vma_private_data {
    pub gref: *mut gntalloc_gref,
    pub users: c_int,
    pub count: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn __del_gref(gref: *mut gntalloc_gref) {
    static void __del_gref(struct gntalloc_gref *gref)
    {
...
// finds contiguous grant references in a file, returns the first
    ...
    {
    struct gntalloc_gref *rv = core::ptr::null_mut(), *gref;
...
//
#[no_mangle]
unsafe extern "C" fn gntalloc_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gntalloc_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gntalloc_vma_open(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn gntalloc_vma_close(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn gntalloc_mmap(filp: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gntalloc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gntalloc_exit() -> void __exit {
