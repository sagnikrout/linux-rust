...
//! Source: drivers/counter/ti-ecap-capture.c
#![no_std]
...
// ECAP event IDs
pub const ECAP_CEVT1: c_int = 0;
pub const ECAP_CEVT2: c_int = 1;
pub const ECAP_CEVT3: c_int = 2;
pub const ECAP_CEVT4: c_int = 3;
pub const ECAP_CNTOVF: c_int = 4;

// Registers
pub const ECAP_TSCNT_REG: c_uint = 0x00;

pub const ECAP_ECCTL_REG: c_uint = 0x28;

    | ECAP_ECCTL_EN_MASK | ECAP_CAP_APWM_BIT	\
    | ECAP_CONT_ONESHT_BIT)
pub const ECAP_ECINT_EN_FLG_REG: c_uint = 0x2c;

pub const ECAP_ECINT_CLR_FRC_REG: c_uint = 0x30;

pub const ECAP_PID_REG: c_uint = 0x5c;
// ECAP signals
pub const ECAP_CLOCK_SIG: c_int = 0;
pub const ECAP_INPUT_SIG: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ecap_cnt_dev {
    pub enabled: bool,
    pub lock: mutex,
    pub clk: *mut clk,
    pub regmap: *mut regmap,
    pub nb_ovf: core::sync::atomic::AtomicI32,
    struct {
    pub ev_mode: u8,
    pub time_cntr: u32,
    pub pm_ctx: },
...
#[no_mangle]
unsafe extern "C" fn ecap_cnt_capture_get_evmode(counter: *mut counter_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ecap_cnt_capture_set_evmode(counter: *mut counter_device, ev_mode: u8) {
...
#[no_mangle]
unsafe extern "C" fn ecap_cnt_capture_enable(counter: *mut counter_device) {
...
#[no_mangle]
unsafe extern "C" fn ecap_cnt_capture_disable(counter: *mut counter_device) {
...
#[no_mangle]
unsafe extern "C" fn ecap_cnt_count_get_val(counter: *mut counter_device, reg: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ecap_cnt_count_set_val(counter: *mut counter_device, reg: c_uint, val: u32) {
...
// enable = ecap_dev->enabled;
    ...
    COUNTER_COMP_CEILING(ecap_cnt_ceiling_read, core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn ecap_cnt_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ecap_cnt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecap_cnt_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ecap_cnt_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecap_cnt_resume(dev: *mut device) -> c_int {
