...
//! Source: drivers/counter/i8254.c
#![no_std]
...
pub const I8254_CONTROL_REG: c_uint = 0x3;

    (u8_encode_bits(_sc, I8254_SC) | u8_encode_bits(_rw, I8254_RW) | \
    u8_encode_bits(_m, I8254_M))
pub const I8254_RW_TWO_BYTE: c_uint = 0x3;
pub const I8254_MODE_INTERRUPT_ON_TERMINAL_COUNT: c_int = 0;
pub const I8254_MODE_HARDWARE_RETRIGGERABLE_ONESHOT: c_int = 1;
pub const I8254_MODE_RATE_GENERATOR: c_int = 2;
pub const I8254_MODE_SQUARE_WAVE_MODE: c_int = 3;
pub const I8254_MODE_SOFTWARE_TRIGGERED_STROBE: c_int = 4;
pub const I8254_MODE_HARDWARE_TRIGGERED_STROBE: c_int = 5;

pub const I8254_NUM_COUNTERS: c_int = 3;
//
...
pub struct i8254 {
    pub lock: mutex,
    pub preset: [u16; I8254_NUM_COUNTERS],
    pub out_mode: [u8; I8254_NUM_COUNTERS],
    pub map: *mut regmap,
}
    ...
    u64 *const val)
    {
    let mut priv: *mut i8254 const = counter_priv(counter);
    int ret;
    u8 value[2];
...
pub const I8254_SYNAPSES_PER_COUNT: c_int = 2;
pub const I8254_SIGNAL_ID_CLK: c_int = 0;
pub const I8254_SIGNAL_ID_GATE: c_int = 1;
...
#[no_mangle]
pub unsafe extern "C" fn if(0: priv->preset[count->id] ==) -> else {
...
// ceiling = U16_MAX;
    ...
    {
    let mut priv: *const i8254 const = counter_priv(counter);
    switch (priv.out_mode[count.id]) {
...
#[no_mangle]
unsafe extern "C" fn i8254_init_hw(map: *const *const regmap) -> c_int {
...
// Initialize each counter to Mode 0
    ...
    COUNTER_COMP_CEILING(i8254_count_ceiling_read, core::ptr::null_mut()),
    COUNTER_COMP_COUNT_MODE(i8254_count_mode_read, i8254_count_mode_write,
    i8254_count_modes_available),
    COUNTER_COMP_FLOOR(i8254_count_floor_read, core::ptr::null_mut()),
