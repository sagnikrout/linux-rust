...
//! Source: drivers/counter/stm32-lptimer-cnt.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_lptim_cnt {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub clk: *mut clk,
    pub ceiling: u32,
    pub polarity: u32,
    pub quadrature_mode: u32,
    pub enabled: bool,
}

#[no_mangle]
unsafe extern "C" fn stm32_lptim_is_enabled(priv: *mut stm32_lptim_cnt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_lptim_setup(priv: *mut stm32_lptim_cnt, enable: c_int) -> c_int {
...
//
    ...
    {
    let mut priv: *mut stm32_lptim_cnt const = counter_priv(counter);
    u32 cnt;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn stm32_lptim_cnt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_lptim_cnt_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_lptim_cnt_resume(dev: *mut device) -> c_int {
