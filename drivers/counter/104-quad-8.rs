...
//! Source: drivers/counter/104-quad-8.c
#![no_std]
...
pub const QUAD8_EXTENT: c_int = 32;
...
pub const QUAD8_NUM_COUNTERS: c_int = 8;

pub const QUAD8_INTERRUPT_STATUS: c_uint = 0x10;
pub const QUAD8_CHANNEL_OPERATION: c_uint = 0x11;
pub const QUAD8_INDEX_INTERRUPT: c_uint = 0x12;
pub const QUAD8_INDEX_INPUT_LEVELS: c_uint = 0x16;
pub const QUAD8_CABLE_STATUS: c_uint = 0x17;
//
...
pub struct quad8 {
    ...
    pub fck_prescaler: [c_uint; QUAD8_NUM_COUNTERS],
    pub preset: [c_uint; QUAD8_NUM_COUNTERS],
    pub cable_fault_enable: c_uint,
    pub map: *mut regmap,
}
...
// Normal count
pub const NORMAL_COUNT: c_uint = 0x0;
// Range Limit
pub const RANGE_LIMIT: c_uint = 0x1;
// Non-recycle count
pub const NON_RECYCLE_COUNT: c_uint = 0x2;
// Modulo-N
pub const MODULO_N: c_uint = 0x3;
// Non-quadrature
pub const NON_QUADRATURE: c_uint = 0x0;
// Quadrature X1
pub const QUADRATURE_X1: c_uint = 0x1;
// Quadrature X2
pub const QUADRATURE_X2: c_uint = 0x2;
// Quadrature X4
pub const QUADRATURE_X4: c_uint = 0x3;
//
// Input/Output Control Register
//
...
// Load Counter input
pub const LOAD_CNTR: c_uint = 0x0;
// FLG1 = CARRY(active low); FLG2 = BORROW(active low)
pub const FLG1_CARRY_FLG2_BORROW: c_uint = 0x0;
// FLG1 = COMPARE(active low); FLG2 = BORROW(active low)
pub const FLG1_COMPARE_FLG2_BORROW: c_uint = 0x1;
// FLG1 = Carry(active low)/Borrow(active low); FLG2 = U/D(active low) flag
pub const FLG1_CARRYBORROW_FLG2_UD: c_uint = 0x2;
// FLG1 = INDX (low pulse at INDEX pin active level); FLG2 = E flag
pub const FLG1_INDX_FLG2_E: c_uint = 0x3;
//
// INDEX CONTROL REGISTERS
//

// Disable Index mode
pub const DISABLE_INDEX_MODE: c_uint = 0x0;
// Enable Index mode
pub const ENABLE_INDEX_MODE: c_uint = 0x1;
// Negative Index Polarity
pub const NEGATIVE_INDEX_POLARITY: c_uint = 0x0;
// Positive Index Polarity
pub const POSITIVE_INDEX_POLARITY: c_uint = 0x1;
//
...
// Each Counter is 24 bits wide
    ...
    {
    let mut priv: *const quad8 const = counter_priv(counter);
    int ret;
...
// level = (ret) ? COUNTER_SIGNAL_LEVEL_HIGH : COUNTER_SIGNAL_LEVEL_LOW;
    ...
    {
    let mut priv: *mut quad8 const = counter_priv(counter);
...
#[no_mangle]
unsafe extern "C" fn quad8_flag_register_reset(priv: *const *const quad8, id: usize) -> c_int {
...
// direction = (u8_get_bits(flag, FLAG_UD) == UP) ? COUNTER_COUNT_DIRECTION_FORWARD :
    ...
    int err;
    enum counter_function function;
    let mut signal_a_id: usize = count.synapses[0].signal.id;
    enum counter_count_direction direction;
// Default action mode
...
#[no_mangle]
unsafe extern "C" fn quad8_events_configure(counter: *mut counter_device) -> c_int {
    static int quad8_events_configure(struct counter_device *counter)
    {
    let mut priv: *mut quad8 const = counter_priv(counter);
    let mut irq_enabled: c_ulong = 0;
    unsigned long irqflags;
...
// Save new IRQ function configuration
    ...
    {
    let mut priv: *const quad8 const = counter_priv(counter);
    let mut channel_id: usize = signal.id - 16;
...
// Preset enable is active low in Input/Output Control register
    ...
    {
    let mut priv: *mut quad8 const = counter_priv(counter);
    let mut channel_id: usize = signal.id / 2;
    unsigned long irqflags;
    bool disabled;
    int ret;
    spin_lock_irqsave(&priv.lock, irqflags);
...
// prescaler = priv->fck_prescaler[signal->id / 2];
    ...
    COUNTER_COMP_FLOOR(quad8_count_floor_read, core::ptr::null_mut()),
    ...
    COUNTER_COMP_COUNT_ENUM("error_noise", quad8_error_noise_get, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn quad8_irq_handler(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn quad8_init_counter(priv: *const *const quad8, channel: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quad8_probe(dev: *mut device, id: c_uint) -> c_int {
