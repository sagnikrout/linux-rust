...
//! Source: drivers/counter/ftm-quaddec.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ftm_quaddec {
    pub pdev: *mut platform_device,
    pub ftm_base: *mut void __iomem,
    pub big_endian: bool,
    pub ftm_quaddec_mutex: mutex,
}

#[no_mangle]
unsafe extern "C" fn ftm_read(ftm: *mut ftm_quaddec, offset: u32, data: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn ftm_write(ftm: *mut ftm_quaddec, offset: u32, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn ftm_clear_write_protection(ftm: *mut ftm_quaddec) {
...
#[no_mangle]
unsafe extern "C" fn ftm_set_write_protection(ftm: *mut ftm_quaddec) {
    static void ftm_set_write_protection(struct ftm_quaddec *ftm)
    {
    FTM_FIELD_UPDATE(ftm, FTM_FMS, FTM_FMS_WPEN, 1);
    }
#[no_mangle]
unsafe extern "C" fn ftm_reset_counter(ftm: *mut ftm_quaddec) {
...
#[no_mangle]
unsafe extern "C" fn ftm_quaddec_init(ftm: *mut ftm_quaddec) {
...
#[no_mangle]
unsafe extern "C" fn ftm_quaddec_disable(ftm: *mut c_void) {
...
// Also resets the counter as it is undefined anyway now
    ...
    u64 *val)
    {
    let mut ftm: *mut ftm_quaddec const = counter_priv(counter);
    uint32_t cntval;
...
#[no_mangle]
unsafe extern "C" fn ftm_quaddec_probe(pdev: *mut platform_device) -> c_int {
