...
//! Source: drivers/hwmon/acpi_power_meter.c
#![no_std]
...
pub const NUM_SENSORS: c_int = 17;

pub const UNKNOWN_HYSTERESIS: c_uint = 0xFFFFFFFF;
pub const UNKNOWN_POWER: c_uint = 0xFFFFFFFF;
pub const METER_NOTIFY_CONFIG: c_uint = 0x80;
pub const METER_NOTIFY_TRIP: c_uint = 0x81;
pub const METER_NOTIFY_CAP: c_uint = 0x82;
pub const METER_NOTIFY_CAPPING: c_uint = 0x83;
pub const METER_NOTIFY_INTERVAL: c_uint = 0x84;

    static int cap_in_hardware;
    static bool force_cap_on;
    static DEFINE_MUTEX(acpi_notify_lock);
#[no_mangle]
unsafe extern "C" fn can_cap_in_hardware() -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_power_meter_capabilities {
    pub flags: u64,
    pub units: u64,
    pub type: u64,
    pub accuracy: u64,
    pub sampling_time: u64,
    pub min_avg_interval: u64,
    pub max_avg_interval: u64,
    pub hysteresis: u64,
    pub configurable_cap: u64,
    pub min_cap: u64,
    pub max_cap: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_power_meter_resource {
    pub acpi_dev: *mut acpi_device,
    pub name: acpi_bus_id,
    pub lock: mutex,
    pub hwmon_dev: *mut device,
    pub caps: acpi_power_meter_capabilities,
    pub model_number: acpi_string,
    pub serial_number: acpi_string,
    pub oem_info: acpi_string,
    pub power: u64,
    pub cap: u64,
    pub avg_interval: u64,
    pub power_alarm: bool,
    pub sensors_valid: c_int,
    pub sensors_last_updated: c_ulong,
pub const POWER_METER_TRIP_AVERAGE_MIN_IDX: c_int = 0;
pub const POWER_METER_TRIP_AVERAGE_MAX_IDX: c_int = 1;
    pub trip: [i64; 2],
    pub num_domain_devices: c_int,
    pub domain_devices: *mut acpi_device,
    pub holders_dir: *mut kobject,
}

// Averaging interval
#[no_mangle]
unsafe extern "C" fn update_avg_interval(resource: *mut acpi_power_meter_resource) -> c_int {
...
// Cap functions
#[no_mangle]
unsafe extern "C" fn update_cap(resource: *mut acpi_power_meter_resource) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_acpi_trip(resource: *mut acpi_power_meter_resource) -> c_int {
    ...
    let mut args: acpi_object_list = { 2, arg_objs };
    unsigned long long data;
    acpi_status status;
...
// Power meter
#[no_mangle]
unsafe extern "C" fn update_meter(resource: *mut acpi_power_meter_resource) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_domain_devices(resource: *mut acpi_power_meter_resource) {
...
#[no_mangle]
unsafe extern "C" fn read_domain_devices(resource: *mut acpi_power_meter_resource) -> c_int {
    ...
    acpi_status status;
    status = acpi_evaluate_object(resource.acpi_dev.handle, "_PMD", core::ptr::null_mut(),
    &buffer);
    if (ACPI_FAILURE(status)) {
...
// Create a symlink to domain objects
    ...
    if (res) {
    acpi_dev_put(obj);
    resource.domain_devices[i] = core::ptr::null_mut();
    }
    }
    res = 0;
    goto end;
...
// val = res->cap * 1000;
    ...
    {
    struct acpi_power_meter_resource *res = dev_get_drvdata(dev);
    let mut acc: c_uint = res.caps.accuracy;
...
#[no_mangle]
unsafe extern "C" fn free_capabilities(resource: *mut acpi_power_meter_resource) {
...
#[no_mangle]
unsafe extern "C" fn read_capabilities(resource: *mut acpi_power_meter_resource) -> c_int {
    ...
    let mut format: acpi_buffer = { sizeof("NNNNNNNNNNN"), "NNNNNNNNNNN" };
    union acpi_object *pss;
    acpi_string *str;
    acpi_status status;
    status = acpi_evaluate_object(resource.acpi_dev.handle, "_PMC", core::ptr::null_mut(),
    &buffer);
    if (ACPI_FAILURE(status)) {
...
#[no_mangle]
unsafe extern "C" fn acpi_power_meter_notify(handle: acpi_handle, event: u32, data: *mut c_void) {
    ...
    sysfs_notify(&dev.kobj, core::ptr::null_mut(), POWER_AVERAGE_NAME);
    break;
    ...
    mutex_unlock(&resource.lock);
    sysfs_notify(&dev.kobj, core::ptr::null_mut(), POWER_CAP_NAME);
    break;
    case METER_NOTIFY_INTERVAL:
    sysfs_notify(&dev.kobj, core::ptr::null_mut(), POWER_AVG_INTERVAL_NAME);
    break;
    case METER_NOTIFY_CAPPING:
    mutex_lock(&resource.lock);
    resource.power_alarm = true;
    mutex_unlock(&resource.lock);
    sysfs_notify(&dev.kobj, core::ptr::null_mut(), POWER_ALARM_NAME);
...
#[no_mangle]
unsafe extern "C" fn acpi_power_meter_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    struct acpi_device *ipi_device = acpi_dev_get_first_match_dev("IPI0001", core::ptr::null_mut(), -1);
...
#[no_mangle]
unsafe extern "C" fn acpi_power_meter_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn acpi_power_meter_resume(dev: *mut device) -> c_int {
    ...
    static DEFINE_SIMPLE_DEV_PM_OPS(acpi_power_meter_pm, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn enable_cap_knobs(d: *const dmi_system_id) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_power_meter_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_power_meter_exit() -> void __exit {
