...
//! Source: drivers/hwmon/emc1403.c
#![no_std]
...
pub const THERMAL_PID_REG: c_uint = 0xfd;
pub const THERMAL_SMSC_ID_REG: c_uint = 0xfe;
pub const THERMAL_REVISION_REG: c_uint = 0xff;
    enum emc1403_chip { emc1402, emc1403, emc1404, emc1428 };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct thermal_data {
    pub chip: enum emc1403_chip,
    pub regmap: *mut regmap,
}

#[no_mangle]
unsafe extern "C" fn power_state_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn emc1403_regmap_is_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn emc1403_temp_read(data: *mut thermal_data, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc1403_get_convrate(data: *mut thermal_data, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc1403_chip_read(data: *mut thermal_data, attr: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc1403_set_hyst(data: *mut thermal_data, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc1403_temp_write(data: *mut thermal_data, attr: u32, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc1403_set_convrate(data: *mut thermal_data, interval: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc1403_chip_write(data: *mut thermal_data, attr: u32, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc1403_temp_is_visible(_data: *const c_void, attr: u32, channel: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn emc1403_chip_is_visible(_data: *const c_void, attr: u32) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn emc1403_probe(client: *mut i2c_client) -> c_int {
