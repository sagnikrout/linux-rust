...
//! Source: drivers/hwmon/smsc47b397.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn superio_outb(reg: c_int, val: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn superio_select(ld: c_int) {
...
pub const SUPERIO_REG_BASE_MSB: c_uint = 0x60;
pub const SUPERIO_REG_BASE_LSB: c_uint = 0x61;
pub const SUPERIO_REG_LD8: c_uint = 0x08;
pub const SMSC_EXTENT: c_uint = 0x02;
// 0 <= nr <= 3
...
#[no_mangle]
unsafe extern "C" fn smsc47b397_read_value(data: *mut smsc47b397_data, reg: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fan_from_reg(reg: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smsc47b397_probe(pdev: *mut platform_device) -> c_int {
    static int smsc47b397_probe(struct platform_device *pdev)
    {
...
#[no_mangle]
unsafe extern "C" fn smsc47b397_device_add(address: c_ushort) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn smsc47b397_find() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn smsc47b397_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn smsc47b397_exit() -> void __exit {
