...
//! Source: drivers/hwmon/abituguru3.c
#![no_std]
...
pub const ABIT_UGURU3_SETTINGS_BANK: c_uint = 0x01;
pub const ABIT_UGURU3_SENSORS_BANK: c_uint = 0x08;
pub const ABIT_UGURU3_MISC_BANK: c_uint = 0x09;
pub const ABIT_UGURU3_ALARMS_START: c_uint = 0x1E;
pub const ABIT_UGURU3_SETTINGS_START: c_uint = 0x24;
pub const ABIT_UGURU3_VALUES_START: c_uint = 0x80;
pub const ABIT_UGURU3_BOARD_ID: c_uint = 0x0A;
// uGuru3 sensor bank flags */			     /* Alarm if:
pub const ABIT_UGURU3_TEMP_HIGH_ALARM_ENABLE: c_uint = 0x01 /*  temp over warn */;
pub const ABIT_UGURU3_VOLT_HIGH_ALARM_ENABLE: c_uint = 0x02 /*  volt over max */;
pub const ABIT_UGURU3_VOLT_LOW_ALARM_ENABLE: c_uint = 0x04 /*  volt under min */;
pub const ABIT_UGURU3_TEMP_HIGH_ALARM_FLAG: c_uint = 0x10 /* temp is over warn */;
pub const ABIT_UGURU3_VOLT_HIGH_ALARM_FLAG: c_uint = 0x20 /* volt is over max */;
pub const ABIT_UGURU3_VOLT_LOW_ALARM_FLAG: c_uint = 0x40 /* volt is under min */;
pub const ABIT_UGURU3_FAN_LOW_ALARM_ENABLE: c_uint = 0x01 /*   fan under min */;
pub const ABIT_UGURU3_BEEP_ENABLE: c_uint = 0x08 /* beep if alarm */;
pub const ABIT_UGURU3_SHUTDOWN_ENABLE: c_uint = 0x80 /* shutdown if alarm */;
// sensor types
pub const ABIT_UGURU3_IN_SENSOR: c_int = 0;
pub const ABIT_UGURU3_TEMP_SENSOR: c_int = 1;
pub const ABIT_UGURU3_FAN_SENSOR: c_int = 2;
//
...
// bottleneck.
//
pub const ABIT_UGURU3_WAIT_TIMEOUT: c_int = 250;
//
// Normally the 0xAC at the end of synchronize() is reported after the
// first read, but sometimes not and we need to poll
//
pub const ABIT_UGURU3_SYNCHRONIZE_TIMEOUT: c_int = 5;
// utility macros
...
pub const ABIT_UGURU3_MAX_NO_SENSORS: c_int = 26;
//
...
pub const ABIT_UGURU3_BASE: c_uint = 0x00E0;
pub const ABIT_UGURU3_CMD: c_uint = 0x00;
pub const ABIT_UGURU3_DATA: c_uint = 0x04;
pub const ABIT_UGURU3_REGION_LENGTH: c_int = 5;
//
...
// uGuru status flags
pub const ABIT_UGURU3_STATUS_READY_FOR_READ: c_uint = 0x01;
pub const ABIT_UGURU3_STATUS_BUSY: c_uint = 0x02;
// Structures
#[repr(C)]
#[derive(Copy, Clone)]
pub struct abituguru3_sensor_info {
...
pub const ABIT_UGURU3_MAX_DMI_NAMES: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct abituguru3_motherboard_info {
    pub id: u16,
    pub 1]: *const *const char dmi_name[ABIT_UGURU3_MAX_DMI_NAMES +,
// + 1 -> end of sensors indicated by a sensor with name == NULL
    pub 1]: abituguru3_sensor_info sensors[ABIT_UGURU3_MAX_NO_SENSORS +,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct abituguru3_data {
    pub /: *mut *mut *mut device hwmon_dev; / hwmon registered device,
    pub /: *mut *mut mutex update_lock; / protect access to data and uGuru,
    pub /: *mut *mut unsigned short addr; / uguru base address,
...
// Buffer to store the dynamically generated sysfs names
    pub sysfs_names: [c_char; ABIT_UGURU3_SYSFS_NAMES_LENGTH],
// Pointer to the sensors info for the detected motherboard
    pub sensors: *const abituguru3_sensor_info,
//
...
//
    pub settings: [u8; 48][3],
}

// Constants
    static const struct abituguru3_motherboard_info abituguru3_motherboards[] = {
    { 0x000C, { core::ptr::null_mut() } /* Unknown, need DMI string */, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR",		 1, 0, 10, 1, 0 },
    { "DDR VTT",		 2, 0, 10, 1, 0 },
    ...
    { core::ptr::null_mut(), 0, 0, 0, 0, 0 } }
    },
    { 0x000D, { core::ptr::null_mut() } /* Abit AW8, need DMI string */, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR",		 1, 0, 10, 1, 0 },
    { "DDR VTT",		 2, 0, 10, 1, 0 },
    { "CPU VTT 1.2V",	 3, 0, 10, 1, 0 },
    ...
    { 0x000E, { core::ptr::null_mut() } /* AL-8, need DMI string */, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR",		 1, 0, 10, 1, 0 },
    { "DDR VTT",		 2, 0, 10, 1, 0 },
    { "CPU VTT 1.2V",	 3, 0, 10, 1, 0 },
    ...
    { 0x000F, { core::ptr::null_mut() } /* Unknown, need DMI string */, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR",		 1, 0, 10, 1, 0 },
    { "DDR VTT",		 2, 0, 10, 1, 0 },
    { "CPU VTT 1.2V",	 3, 0, 10, 1, 0 },
    ...
    { 0x0010, { core::ptr::null_mut() } /* Abit NI8 SLI GR, need DMI string */, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR",		 1, 0, 10, 1, 0 },
    { "DDR VTT",		 2, 0, 10, 1, 0 },
    { "CPU VTT 1.2V",	 3, 0, 10, 1, 0 },
    ...
    { 0x0011, { "AT8 32X", core::ptr::null_mut() }, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR",		 1, 0, 20, 1, 0 },
    { "DDR VTT",		 2, 0, 10, 1, 0 },
    ...
    { 0x0012, { core::ptr::null_mut() } /* Abit AN8 32X, need DMI string */, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR",		 1, 0, 20, 1, 0 },
    { "DDR VTT",		 2, 0, 10, 1, 0 },
    ...
    { 0x0013, { core::ptr::null_mut() } /* Abit AW8D, need DMI string */, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR",		 1, 0, 10, 1, 0 },
    { "DDR VTT",		 2, 0, 10, 1, 0 },
    { "CPU VTT 1.2V",	 3, 0, 10, 1, 0 },
    ...
    { 0x0014, { "AB9", "AB9 Pro", core::ptr::null_mut() }, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR",		 1, 0, 10, 1, 0 },
    { "DDR VTT",		 2, 0, 10, 1, 0 },
    { "CPU VTT 1.2V",	 3, 0, 10, 1, 0 },
    ...
    { 0x0015, { core::ptr::null_mut() } /* Unknown, need DMI string */, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR",		 1, 0, 20, 1, 0 },
    { "DDR VTT",		 2, 0, 10, 1, 0 },
    { "HyperTransport",	 3, 0, 10, 1, 0 },
    ...
    { 0x0016, { "AW9D-MAX", core::ptr::null_mut() }, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR2",		 1, 0, 20, 1, 0 },
    { "DDR2 VTT",		 2, 0, 10, 1, 0 },
    { "CPU VTT 1.2V",	 3, 0, 10, 1, 0 },
    ...
    { 0x0017, { core::ptr::null_mut() } /* Unknown, need DMI string */, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR2",		 1, 0, 20, 1, 0 },
    { "DDR2 VTT",		 2, 0, 10, 1, 0 },
    { "HyperTransport",	 3, 0, 10, 1, 0 },
    ...
    { 0x0018, { "AB9 QuadGT", core::ptr::null_mut() }, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR2",		 1, 0, 20, 1, 0 },
    { "DDR2 VTT",		 2, 0, 10, 1, 0 },
    { "CPU VTT",		 3, 0, 10, 1, 0 },
    ...
    { 0x0019, { "IN9 32X MAX", core::ptr::null_mut() }, {
    { "CPU Core",		 7, 0, 10, 1, 0 },
    { "DDR2",		13, 0, 20, 1, 0 },
    ...
    { 0x001A, { "IP35 Pro", "IP35 Pro XE", core::ptr::null_mut() }, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR2",		 1, 0, 20, 1, 0 },
    { "DDR2 VTT",		 2, 0, 10, 1, 0 },
    { "CPU VTT 1.2V",	 3, 0, 10, 1, 0 },
    ...
    { 0x001B, { core::ptr::null_mut() } /* Unknown, need DMI string */, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR3",		 1, 0, 20, 1, 0 },
    { "DDR3 VTT",		 2, 0, 10, 1, 0 },
    { "CPU VTT",		 3, 0, 10, 1, 0 },
    ...
    { 0x001C, { "IX38 QuadGT", core::ptr::null_mut() }, {
    { "CPU Core",		 0, 0, 10, 1, 0 },
    { "DDR2",		 1, 0, 20, 1, 0 },
    { "DDR2 VTT",		 2, 0, 10, 1, 0 },
    { "CPU VTT",		 3, 0, 10, 1, 0 },
    ...
    { 0x0000, { core::ptr::null_mut() }, { { core::ptr::null_mut(), 0, 0, 0, 0, 0 } } }
    };
// Insmod parameters
    static bool force;
...
#[no_mangle]
unsafe extern "C" fn abituguru3_wait_while_busy(data: *mut abituguru3_data) -> c_int {
    static int abituguru3_wait_while_busy(struct abituguru3_data *data)
    {
    u8 x;
    let mut timeout: c_int = ABIT_UGURU3_WAIT_TIMEOUT;
...
#[no_mangle]
unsafe extern "C" fn abituguru3_wait_for_read(data: *mut abituguru3_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn abituguru3_synchronize(data: *mut abituguru3_data) -> c_int {
...
// Sysfs attr templates, the real entries are generated automatically.
    ...
    SENSOR_ATTR_2(in%d_input, 0444, show_value, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(in%d_min, 0444, show_value, core::ptr::null_mut(), 1, 0),
    SENSOR_ATTR_2(in%d_max, 0444, show_value, core::ptr::null_mut(), 2, 0),
    SENSOR_ATTR_2(in%d_min_alarm, 0444, show_alarm, core::ptr::null_mut(),
    ABIT_UGURU3_VOLT_LOW_ALARM_FLAG, 0),
    SENSOR_ATTR_2(in%d_max_alarm, 0444, show_alarm, core::ptr::null_mut(),
    ABIT_UGURU3_VOLT_HIGH_ALARM_FLAG, 0),
    SENSOR_ATTR_2(in%d_beep, 0444, show_mask, core::ptr::null_mut(),
    ABIT_UGURU3_BEEP_ENABLE, 0),
    SENSOR_ATTR_2(in%d_shutdown, 0444, show_mask, core::ptr::null_mut(),
    ABIT_UGURU3_SHUTDOWN_ENABLE, 0),
    SENSOR_ATTR_2(in%d_min_alarm_enable, 0444, show_mask, core::ptr::null_mut(),
    ABIT_UGURU3_VOLT_LOW_ALARM_ENABLE, 0),
    SENSOR_ATTR_2(in%d_max_alarm_enable, 0444, show_mask, core::ptr::null_mut(),
    ABIT_UGURU3_VOLT_HIGH_ALARM_ENABLE, 0),
    SENSOR_ATTR_2(in%d_label, 0444, show_label, core::ptr::null_mut(), 0, 0)
    }, {
    SENSOR_ATTR_2(temp%d_input, 0444, show_value, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(temp%d_max, 0444, show_value, core::ptr::null_mut(), 1, 0),
    SENSOR_ATTR_2(temp%d_crit, 0444, show_value, core::ptr::null_mut(), 2, 0),
    SENSOR_ATTR_2(temp%d_alarm, 0444, show_alarm, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(temp%d_beep, 0444, show_mask, core::ptr::null_mut(),
    ABIT_UGURU3_BEEP_ENABLE, 0),
    SENSOR_ATTR_2(temp%d_shutdown, 0444, show_mask, core::ptr::null_mut(),
    ABIT_UGURU3_SHUTDOWN_ENABLE, 0),
    SENSOR_ATTR_2(temp%d_alarm_enable, 0444, show_mask, core::ptr::null_mut(),
    ABIT_UGURU3_TEMP_HIGH_ALARM_ENABLE, 0),
    SENSOR_ATTR_2(temp%d_label, 0444, show_label, core::ptr::null_mut(), 0, 0)
    }, {
    SENSOR_ATTR_2(fan%d_input, 0444, show_value, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(fan%d_min, 0444, show_value, core::ptr::null_mut(), 1, 0),
    SENSOR_ATTR_2(fan%d_alarm, 0444, show_alarm, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(fan%d_beep, 0444, show_mask, core::ptr::null_mut(),
    ABIT_UGURU3_BEEP_ENABLE, 0),
    SENSOR_ATTR_2(fan%d_shutdown, 0444, show_mask, core::ptr::null_mut(),
    ABIT_UGURU3_SHUTDOWN_ENABLE, 0),
    SENSOR_ATTR_2(fan%d_alarm_enable, 0444, show_mask, core::ptr::null_mut(),
    ABIT_UGURU3_FAN_LOW_ALARM_ENABLE, 0),
    SENSOR_ATTR_2(fan%d_label, 0444, show_label, core::ptr::null_mut(), 0, 0)
    } };
    static struct sensor_device_attribute_2 abituguru3_sysfs_attr[] = {
    SENSOR_ATTR_2(name, 0444, show_name, core::ptr::null_mut(), 0, 0),
    };
#[no_mangle]
unsafe extern "C" fn abituguru3_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abituguru3_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn abituguru3_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abituguru3_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abituguru3_dmi_detect() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn abituguru3_detect() -> int __init {
...
//
    let mut data_val: u8 = inb_p(ABIT_UGURU3_BASE + ABIT_UGURU3_DATA);
    let mut cmd_val: u8 = inb_p(ABIT_UGURU3_BASE + ABIT_UGURU3_CMD);
...
#[no_mangle]
unsafe extern "C" fn abituguru3_init() -> int __init {
    static int __init abituguru3_init(void)
    {
    let mut res: resource = { .flags = IORESOURCE_IO };
    int err;
...
#[no_mangle]
unsafe extern "C" fn abituguru3_exit() -> void __exit {
