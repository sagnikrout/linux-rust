...
//! Source: drivers/hwmon/w83781d.c
#![no_std]
...
pub const W83781D_EXTENT: c_int = 8;
// Where are the ISA address/data registers relative to the base address
pub const W83781D_ADDR_REG_OFFSET: c_int = 5;
pub const W83781D_DATA_REG_OFFSET: c_int = 6;
...
pub const W83781D_REG_TEMP2_CONFIG: c_uint = 0x152;
pub const W83781D_REG_TEMP3_CONFIG: c_uint = 0x252;
// temp nr from 1 to 3
...
pub const W83781D_REG_ALARM1: c_uint = 0x41;
pub const W83781D_REG_ALARM2: c_uint = 0x42;
// Real-time status (W83782D, W83783S)
pub const W83782D_REG_ALARM1: c_uint = 0x459;
pub const W83782D_REG_ALARM2: c_uint = 0x45A;
pub const W83782D_REG_ALARM3: c_uint = 0x45B;
...
pub const W83781D_REG_BEEP_INTS3: c_uint = 0x453	/* not on W83781D */;
...
pub const W83781D_REG_PWMCLK12: c_uint = 0x5C;
pub const W83781D_REG_PWMCLK34: c_uint = 0x45C;
...
// For ISA device only
    ...
    pub /: *mut *mut *mut i2c_client lm75[2]; / for secondary I2C addresses,
// array of 2 pointers to subclients
    pub /: *mut *mut u8 in[9]; / Register value - 8 & 9 for 782D only,
    pub /: *mut *mut u8 in_max[9]; / Register value - 8 & 9 for 782D only,
    pub /: *mut *mut u8 in_min[9]; / Register value - 8 & 9 for 782D only,
    pub /: *mut *mut u8 fan[3]; / Register value,
    pub /: *mut *mut u8 fan_min[3]; / Register value,
    pub /: *mut *mut s8 temp; / Register value,
    pub /: *mut *mut s8 temp_max; / Register value,
    pub /: *mut *mut s8 temp_max_hyst; / Register value,
    pub /: *mut *mut u16 temp_add[2]; / Register value,
    pub /: *mut *mut u16 temp_max_add[2]; / Register value,
    pub /: *mut *mut u16 temp_max_hyst_add[2]; / Register value,
    ...
    pub /: *mut *mut u8 pwm[4]; / Register value,
    pub /: *mut *mut u8 pwm2_enable; / Boolean,
    pub /*: *mut u16 sens[3];,
// 782D/783S only.
...
// da, const char *buf, size_t count) \
    ...
    show_temp, core::ptr::null_mut(), offset); \
...
// The W83781D has a single alarm bit for temp2 and temp3
    ...
    {
    struct w83781d_data *data = w83781d_update_device(dev);
    let mut bitnr: c_int = (data.type == w83781d) ? 5 : 13;
    return sprintf(buf, "%u\n", (data.alarms >> bitnr) & 1);
    }
    ...
    static SENSOR_DEVICE_ATTR(in5_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 9);
    static SENSOR_DEVICE_ATTR(in6_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 10);
    static SENSOR_DEVICE_ATTR(in7_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 16);
    static SENSOR_DEVICE_ATTR(in8_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 17);
    ...
    static SENSOR_DEVICE_ATTR(temp3_alarm, S_IRUGO, show_temp3_alarm, core::ptr::null_mut(), 0);
...
//
    ...
    let mut kind: enum chips = data.type;
    let mut num_sc: c_int = 1;
...
// Get the vendor ID
    ...
    vendid = winbond;
#[no_mangle]
pub unsafe extern "C" fn if(0x12: val2 ==) -> else {
    else if (val2 == 0x12)
    vendid = asus;
    else {
    dev_dbg(&adapter.dev,
...
// Determine the chip type.
    ...
    client_name = "w83781d";
#[no_mangle]
pub unsafe extern "C" fn if(winbond: val1 == 0x30 && vendid ==) -> else {
    else if (val1 == 0x30 && vendid == winbond)
    client_name = "w83782d";
#[no_mangle]
pub unsafe extern "C" fn if(0x2d: val1 == 0x40 && vendid == winbond && address ==) -> else {
    else if (val1 == 0x40 && vendid == winbond && address == 0x2d)
    client_name = "w83783s";
#[no_mangle]
pub unsafe extern "C" fn if(0x31: val1 ==) -> else {
    else if (val1 == 0x31)
...
#[no_mangle]
unsafe extern "C" fn w83781d_remove_files(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn w83781d_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w83781d_alias_detect(client: *mut i2c_client, chipid: u8) -> c_int {
    static int w83781d_alias_detect(struct i2c_client *client, u8 chipid)
    {
...
#[no_mangle]
unsafe extern "C" fn w83781d_isa_remove(pdev: *mut platform_device) {
