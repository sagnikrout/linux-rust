...
//! Source: drivers/hwmon/lenovo-ec-sensors.c
#![no_std]
...
pub const MCHP_SING_IDX: c_uint = 0x0000;
pub const MCHP_EMI0_APPLICATION_ID: c_uint = 0x090C;
pub const MCHP_EMI0_EC_ADDRESS: c_uint = 0x0902;
pub const MCHP_EMI0_EC_DATA_BYTE0: c_uint = 0x0904;
pub const MCHP_EMI0_EC_DATA_BYTE1: c_uint = 0x0905;
pub const MCHP_EMI0_EC_DATA_BYTE2: c_uint = 0x0906;
pub const MCHP_EMI0_EC_DATA_BYTE3: c_uint = 0x0907;
pub const IO_REGION_START: c_uint = 0x0900;
pub const IO_REGION_LENGTH: c_uint = 0xD;
    static inline u8
    get_ec_reg(unsigned char page, unsigned char index)
    {
    u8 onebyte;
    unsigned short m_index;
    let mut phy_index: c_ushort = page * 256 + index;
...
pub struct ec_sensors_data {
    pub /: *mut *mut mutex mec_mutex; / lock for sensor data access,
    pub fan_labels: *const *const c_char,
    pub temp_labels: *const *const c_char,
    pub fan_map: *const c_int,
    pub temp_map: *const c_int,
}
...
#[no_mangle]
unsafe extern "C" fn lenovo_ec_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lenovo_ec_init() -> int __init {
    ...
    lenovo_ec_probe, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn lenovo_ec_exit() -> void __exit {
