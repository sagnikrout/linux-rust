...
//
pub const SHTC3_ID: c_uint = 0x0807;
pub const SHTC3_ID_MASK: c_uint = 0x083f;
pub const SHTC1_ID: c_uint = 0x0007;
pub const SHTC1_ID_MASK: c_uint = 0x003f;
// delays for non-blocking i2c commands, both in us
pub const SHTC1_NONBLOCKING_WAIT_TIME_HPM: c_int = 14400;
pub const SHTC1_NONBLOCKING_WAIT_TIME_LPM: c_int = 1000;
pub const SHTC3_NONBLOCKING_WAIT_TIME_HPM: c_int = 12100;
pub const SHTC3_NONBLOCKING_WAIT_TIME_LPM: c_int = 800;
pub const SHTC1_CMD_LENGTH: c_int = 2;
pub const SHTC1_RESPONSE_LENGTH: c_int = 6;
    enum shtcx_chips {
    shtc1,
    shtc3,
    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct shtc1_data {
    pub client: *mut i2c_client,
    pub update_lock: mutex,
    pub valid: bool,
    pub /: *mut *mut unsigned long last_updated; / in jiffies,
    pub command: *const c_uchar,
    pub /: *mut *mut unsigned int nonblocking_wait_time; / in us,
    pub setup: shtc1_platform_data,
    pub chip: enum shtcx_chips,
    pub /: *mut *mut *mut int temperature; / 1000  temperature in dgr C,
    pub /: *mut *mut *mut int humidity; / 1000  relative humidity in %RH,
}
    ...
    {
    let mut ret: c_int = i2c_master_send(client, data.command, SHTC1_CMD_LENGTH);
...
//
    ...
    let mut ret: return = = 0 ? data : ERR_PTR(ret);
    }
...
#[no_mangle]
unsafe extern "C" fn shtc1_select_command(data: *mut shtc1_data) {
...
#[no_mangle]
unsafe extern "C" fn shtc1_probe(client: *mut i2c_client) -> c_int {
    ...
    let mut chip: enum shtcx_chips = (uintptr_t)i2c_get_match_data(client);
