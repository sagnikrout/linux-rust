...
//! Source: drivers/hwmon/ina3221.c
#![no_std]
...
pub const INA3221_CONFIG: c_uint = 0x00;
pub const INA3221_SHUNT1: c_uint = 0x01;
pub const INA3221_BUS1: c_uint = 0x02;
pub const INA3221_SHUNT2: c_uint = 0x03;
pub const INA3221_BUS2: c_uint = 0x04;
pub const INA3221_SHUNT3: c_uint = 0x05;
pub const INA3221_BUS3: c_uint = 0x06;
pub const INA3221_CRIT1: c_uint = 0x07;
pub const INA3221_WARN1: c_uint = 0x08;
pub const INA3221_CRIT2: c_uint = 0x09;
pub const INA3221_WARN2: c_uint = 0x0a;
pub const INA3221_CRIT3: c_uint = 0x0b;
pub const INA3221_WARN3: c_uint = 0x0c;
pub const INA3221_SHUNT_SUM: c_uint = 0x0d;
pub const INA3221_CRIT_SUM: c_uint = 0x0e;
pub const INA3221_MASK_ENABLE: c_uint = 0x0f;

pub const INA3221_CONFIG_MODE_POWERDOWN: c_int = 0;

pub const INA3221_CONFIG_VSH_CT_SHIFT: c_int = 3;

pub const INA3221_CONFIG_VBUS_CT_SHIFT: c_int = 6;

pub const INA3221_CONFIG_AVG_SHIFT: c_int = 9;

pub const INA3221_CONFIG_DEFAULT: c_uint = 0x7127;
pub const INA3221_RSHUNT_DEFAULT: c_int = 10000;
    enum ina3221_fields {
// Configuration
    F_RST,
// Status Flags
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ina3221_input {
    pub label: *const c_char,
    pub shunt_resistor: c_int,
    pub disconnected: bool,
    pub summation_disable: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ina3221_data {
    pub pm_dev: *mut device,
    pub regmap: *mut regmap,
    pub fields: [*mut regmap_field; F_MAX_FIELDS],
    pub inputs: [ina3221_input; INA3221_NUM_CHANNELS],
    pub reg_config: u32,
    pub summation_shunt_resistor: c_int,
    pub summation_channel_control: u32,
    pub single_shot: bool,
}

#[no_mangle]
pub unsafe extern "C" fn ina3221_is_enabled(ina: *mut ina3221_data, channel: c_int) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ina3221_summation_shunt_resistor(ina: *mut ina3221_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ina3221_interval_ms_to_conv_time(config: u16, interval: c_int) -> u32 {
    static inline u32 ina3221_interval_ms_to_conv_time(u16 config, int interval)
    {
    let mut channels: u32 = hweight16(config & INA3221_CONFIG_CHs_EN_MASK);
    let mut samples_idx: u32 = INA3221_CONFIG_AVG(config);
    let mut samples: u32 = ina3221_avg_samples[samples_idx];
// Bisect the result to Bus and Shunt conversion times
    return DIV_ROUND_CLOSEST(interval * 1000 / 2, channels * samples);
    }
// Converting CONFIG register value to update_interval in usec
#[no_mangle]
pub unsafe extern "C" fn ina3221_reg_to_interval_us(config: u16) -> u32 {
    static inline u32 ina3221_reg_to_interval_us(u16 config)
    {
    let mut channels: u32 = hweight16(config & INA3221_CONFIG_CHs_EN_MASK);
    let mut vbus_ct_idx: u32 = INA3221_CONFIG_VBUS_CT(config);
    let mut vsh_ct_idx: u32 = INA3221_CONFIG_VSH_CT(config);
    let mut vbus_ct: u32 = ina3221_conv_time[vbus_ct_idx];
    let mut vsh_ct: u32 = ina3221_conv_time[vsh_ct_idx];
// Calculate total conversion time
    return channels * (vbus_ct + vsh_ct);
    }
#[no_mangle]
pub unsafe extern "C" fn ina3221_wait_for_data(ina: *mut ina3221_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina3221_read_chip(dev: *mut device, attr: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina3221_read_in(dev: *mut device, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
    static int ina3221_read_in(struct device *dev, u32 attr, int channel, long *val)
    {
    let mut is_shunt: bool = channel > INA3221_CHANNEL3;
    struct ina3221_data *ina = dev_get_drvdata(dev);
    let mut reg: u8 = ina3221_in_reg[channel];
    int regval, ret;
//
...
// val = ina3221_is_enabled(ina, channel);
    ...
    struct ina3221_data *ina = dev_get_drvdata(dev);
    struct ina3221_input *input = ina.inputs;
    let mut reg: u8 = ina3221_curr_reg[attr][channel];
...
#[no_mangle]
unsafe extern "C" fn ina3221_write_chip(dev: *mut device, attr: u32, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina3221_write_enable(dev: *mut device, channel: c_int, enable: bool) -> c_int {
    static int ina3221_write_enable(struct device *dev, int channel, bool enable)
    {
    struct ina3221_data *ina = dev_get_drvdata(dev);
    u16 config, mask = INA3221_CONFIG_CHx_EN(channel);
    let mut config_old: u16 = ina.reg_config & mask;
    u32 tmp;
    int ret;
...
// str = ina->inputs[index].label;
    ...
    const struct ina3221_input *input = core::ptr::null_mut();
    switch (type) {
    case hwmon_chip:
    switch (attr) {
    case hwmon_chip_samples:
...
#[no_mangle]
pub unsafe extern "C" fn if(7: channel ==) -> else {
    else if (channel == 7)
    return 0444;
...
// Extra attribute groups
    ...
    struct ina3221_data *ina = dev_get_drvdata(dev);
    let mut channel: c_uint = sd_attr.index;
...
#[no_mangle]
unsafe extern "C" fn ina3221_probe_from_dt(dev: *mut device, ina: *mut ina3221_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina3221_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina3221_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ina3221_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina3221_resume(dev: *mut device) -> c_int {
