...
pub const INA2XX_CONFIG: c_uint = 0x00;
pub const INA2XX_SHUNT_VOLTAGE: c_uint = 0x01 /* readonly */;
pub const INA2XX_BUS_VOLTAGE: c_uint = 0x02 /* readonly */;
pub const INA2XX_POWER: c_uint = 0x03 /* readonly */;
pub const INA2XX_CURRENT: c_uint = 0x04 /* readonly */;
pub const INA2XX_CALIBRATION: c_uint = 0x05;
// INA226 register definitions
pub const INA226_MASK_ENABLE: c_uint = 0x06;
pub const INA226_ALERT_LIMIT: c_uint = 0x07;
// SY24655 register definitions
pub const SY24655_EIN: c_uint = 0x0A;
pub const SY24655_ACCUM_CONFIG: c_uint = 0x0D;
pub const INA2XX_MAX_REGISTERS: c_uint = 0x0D;
// settings - depend on use case
pub const INA219_CONFIG_DEFAULT: c_uint = 0x399F	/* PGA=8 */;
pub const INA226_CONFIG_DEFAULT: c_uint = 0x4527	/* averages=16 */;
pub const INA260_CONFIG_DEFAULT: c_uint = 0x6527	/* averages=16 */;
pub const SY24655_CONFIG_DEFAULT: c_uint = 0x4527	/* averages=16 */;
// (only for sy24655)
pub const SY24655_ACCUM_CONFIG_DEFAULT: c_uint = 0x044C	/* continuous mode, clear after read*/;
// worst case is 68.10 ms (~14.6Hz, ina219)
pub const INA2XX_CONVERSION_RATE: c_int = 15;

pub const INA2XX_RSHUNT_DEFAULT: c_int = 10000;
pub const INA260_RSHUNT: c_int = 2000;
...
//
pub const INA226_TOTAL_CONV_TIME_DEFAULT: c_int = 2200;
#[no_mangle]
unsafe extern "C" fn ina2xx_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ina2xx_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ina2xx_config {
    pub config_default: u16,
    pub /: *mut *mut bool has_alerts; / chip supports alerts and limits,
    pub /: *mut *mut bool has_ishunt; / chip has internal shunt resistor,
    pub /: *mut *mut bool has_power_average; / chip supports average power,
    pub has_update_interval: bool,
    pub calibration_value: c_int,
    pub shunt_div: c_int,
    pub shunt_voltage_shift: c_int,
    pub bus_voltage_shift: c_int,
    pub /: *mut *mut int bus_voltage_lsb; / uV,
    pub power_lsb_factor: c_int,
    pub current_shift: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ina2xx_data {
    pub config: *const ina2xx_config,
    pub chip: enum ina2xx_ids,
    pub rshunt: c_long,
    pub current_lsb_uA: c_long,
    pub power_lsb_uW: c_long,
...
#[no_mangle]
unsafe extern "C" fn ina226_reg_to_interval(config: u16) -> c_int {
    static int ina226_reg_to_interval(u16 config)
    {
    let mut avg: c_int = ina226_avg_tab[INA226_READ_AVG(config)];
//
...
//
#[no_mangle]
unsafe extern "C" fn ina226_interval_to_reg(interval: c_long) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn ina2xx_read_init(dev: *mut device, reg: c_int, val: *mut c_long) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ina226_alert_to_reg(data: *mut ina2xx_data, reg: c_int, val: c_long) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn ina226_alert_limit_read(data: *mut ina2xx_data, mask: u32, reg: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina226_alert_limit_write(data: *mut ina2xx_data, mask: u32, reg: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina2xx_chip_read(dev: *mut device, attr: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina226_alert_read(regmap: *mut regmap, mask: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina2xx_in_read(dev: *mut device, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
    static int ina2xx_in_read(struct device *dev, u32 attr, int channel, long *val)
    {
    let mut voltage_reg: c_int = channel ? INA2XX_BUS_VOLTAGE : INA2XX_SHUNT_VOLTAGE;
...
//
#[no_mangle]
unsafe extern "C" fn sy24655_average_power_read(data: *mut ina2xx_data, reg: u8, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina2xx_power_read(dev: *mut device, attr: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina2xx_curr_read(dev: *mut device, attr: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina2xx_chip_write(dev: *mut device, attr: u32, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina2xx_in_write(dev: *mut device, attr: u32, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina2xx_power_write(dev: *mut device, attr: u32, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina2xx_curr_write(dev: *mut device, attr: u32, val: c_long) -> c_int {
    ...
    let mut has_alerts: bool = data.config.has_alerts;
    let mut has_power_average: bool = data.config.has_power_average;
    let mut has_update_interval: bool = data.config.has_update_interval;
    switch (type) {
    case hwmon_in:
    switch (attr) {
    case hwmon_in_input:
...
//
#[no_mangle]
unsafe extern "C" fn ina2xx_set_shunt(data: *mut ina2xx_data, val: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ina2xx_init(dev: *mut device, data: *mut ina2xx_data) -> c_int {
    ...
    shunt = INA260_RSHUNT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: device_property_read_u32(dev, _arg: "shunt-resistor", 0: &shunt) <) -> else {
    ...
    let mut active_high: bool = device_property_read_bool(dev, "ti,alert-polarity-active-high");
...
#[no_mangle]
unsafe extern "C" fn ina2xx_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    core::ptr::null_mut() : ina2xx_groups);
    if (IS_ERR(hwmon_dev))
