...
//! Source: drivers/hwmon/gpd-fan.c
#![no_std]
...
pub const GPD_PWM_CTR_OFFSET: c_uint = 0x1841;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpd_fan_data {
    pub pwm_enable: enum FAN_PWM_ENABLE,
    pub pwm_value: u8,
    pub drvdata: *const gpd_fan_drvdata,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpd_fan_drvdata {
    pub comparison: *const *const char board_name; // Board name for module param,
    pub board: enum gpd_board,
    pub addr_port: u8,
    pub data_port: u8,
    pub manual_control_enable: u16,
    pub rpm_read: u16,
    pub pwm_write: u16,
    pub pwm_max: u16,
}
...
// GPD Micro PC 2
    ...
    &gpd_win_mini_drvdata, &gpd_win4_drvdata, &gpd_wm2_drvdata, &gpd_mpc2_drvdata, core::ptr::null_mut()
    };
// Helper functions to handle EC read/write
#[no_mangle]
unsafe extern "C" fn gpd_ecram_read(drvdata: *const gpd_fan_drvdata, offset: u16, val: *mut u8) {
    static void gpd_ecram_read(const struct gpd_fan_drvdata *drvdata, u16 offset, u8 *val)
    {
    let mut addr_port: u16 = drvdata.addr_port;
    let mut data_port: u16 = drvdata.data_port;
    outb(0x2E, addr_port);
    outb(0x11, data_port);
    outb(0x2F, addr_port);
...
#[no_mangle]
unsafe extern "C" fn gpd_ecram_write(drvdata: *const gpd_fan_drvdata, offset: u16, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn gpd_generic_read_rpm(data: *mut gpd_fan_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpd_wm2_read_rpm(data: *mut gpd_fan_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpd_read_rpm(data: *mut gpd_fan_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpd_wm2_read_pwm(data: *mut gpd_fan_data) -> c_int {
...
// Read value for pwm1
#[no_mangle]
unsafe extern "C" fn gpd_read_pwm(data: *mut gpd_fan_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gpd_cast_pwm_range(drvdata: *const gpd_fan_drvdata, val: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn gpd_generic_write_pwm(data: *mut gpd_fan_data, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn gpd_duo_write_pwm(data: *mut gpd_fan_data, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn gpd_write_pwm(data: *mut gpd_fan_data, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpd_win_mini_set_pwm_enable(data: *mut gpd_fan_data, pwm_enable: enum FAN_PWM_ENABLE) {
...
#[no_mangle]
unsafe extern "C" fn gpd_duo_set_pwm_enable(data: *mut gpd_fan_data, pwm_enable: enum FAN_PWM_ENABLE) {
...
#[no_mangle]
unsafe extern "C" fn gpd_wm2_set_pwm_enable(data: *mut gpd_fan_data, enable: enum FAN_PWM_ENABLE) {
...
#[no_mangle]
unsafe extern "C" fn gpd_set_pwm_enable(data: *mut gpd_fan_data, enable: enum FAN_PWM_ENABLE) {
...
#[no_mangle]
unsafe extern "C" fn gpd_win4_init_ec(data: *mut gpd_fan_data) {
...
#[no_mangle]
unsafe extern "C" fn gpd_init_ec(data: *mut gpd_fan_data) {
...
#[no_mangle]
unsafe extern "C" fn gpd_fan_reset_hardware(pdata: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gpd_fan_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpd_fan_init() -> int __init {
    static int __init gpd_fan_init(void)
    {
    const struct gpd_fan_drvdata *match = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn gpd_fan_exit() -> void __exit {
