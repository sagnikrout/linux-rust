...
//! Source: drivers/hwmon/sis5595.c
#![no_std]
...
pub const SIS5595_EXTENT: c_int = 8;
// PCI Config Registers
pub const SIS5595_BASE_REG: c_uint = 0x68;
pub const SIS5595_PIN_REG: c_uint = 0x7A;
pub const SIS5595_ENABLE_REG: c_uint = 0x7B;
// Where are the ISA address/data registers relative to the base address
pub const SIS5595_ADDR_REG_OFFSET: c_int = 5;
pub const SIS5595_DATA_REG_OFFSET: c_int = 6;
...
pub const SIS5595_REG_CONFIG: c_uint = 0x40;
pub const SIS5595_REG_ALARM1: c_uint = 0x41;
pub const SIS5595_REG_ALARM2: c_uint = 0x42;
pub const SIS5595_REG_FANDIV: c_uint = 0x47;
//
...
pub unsafe extern "C" fn TEMP_TO_REG(val: c_long) -> i8 {
    ...
    {
    let mut nval: c_int = clamp_val(val, -54120, 157530) ;
...
pub struct sis5595_data {
    ...
    pub /: *mut *mut char maxins; / == 3 if temp enabled, otherwise == 4,
    pub /: *mut *mut u8 revision; / Reg. value,
...
#[no_mangle]
unsafe extern "C" fn sis5595_read_value(data: *mut sis5595_data, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sis5595_write_value(data: *mut sis5595_data, reg: u8, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn sis5595_init_device(data: *mut sis5595_data) {
    static void sis5595_init_device(struct sis5595_data *data)
    {
    let mut config: u8 = sis5595_read_value(data, SIS5595_REG_CONFIG);
    if (!(config & 0x01))
...
#[no_mangle]
unsafe extern "C" fn sis5595_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sis5595_remove(pdev: *mut platform_device) {
...
//
    ...
    0 };
#[no_mangle]
unsafe extern "C" fn sis5595_device_add(address: c_ushort) -> c_int {
    ...
    struct pci_dev *d;
    d = pci_get_device(PCI_VENDOR_ID_SI, *i, core::ptr::null_mut());
    if (d) {
    dev_err(&d.dev,
...
#[no_mangle]
unsafe extern "C" fn sm_sis5595_init() -> int __init {
    static int __init sm_sis5595_init(void)
    {
    return pci_register_driver(&sis5595_pci_driver);
    }
#[no_mangle]
unsafe extern "C" fn sm_sis5595_exit() -> void __exit {
