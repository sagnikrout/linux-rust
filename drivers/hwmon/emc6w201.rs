...
//! Source: drivers/hwmon/emc6w201.c
#![no_std]
...
pub const EMC6W201_REG_COMPANY: c_uint = 0x3E;
pub const EMC6W201_REG_VERSTEP: c_uint = 0x3F;
pub const EMC6W201_REG_CONFIG: c_uint = 0x40;
...
//
#[no_mangle]
unsafe extern "C" fn emc6w201_read16(client: *mut i2c_client, reg: u8) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn emc6w201_write16(client: *mut i2c_client, reg: u8, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emc6w201_read8(client: *mut i2c_client, reg: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn emc6w201_write8(client: *mut i2c_client, reg: u8, val: u8) -> c_int {
...
//
    ...
    let mut sf: c_int = to_sensor_dev_attr_2(devattr).index;
...
#[no_mangle]
unsafe extern "C" fn emc6w201_probe(client: *mut i2c_client) -> c_int {
