...
//! Source: drivers/hwmon/w83l786ng.c
#![no_std]
...
pub const W83L786NG_REG_CONFIG: c_uint = 0x40;
pub const W83L786NG_REG_ALARM1: c_uint = 0x41;
pub const W83L786NG_REG_ALARM2: c_uint = 0x42;
pub const W83L786NG_REG_GPIO_EN: c_uint = 0x47;
pub const W83L786NG_REG_MAN_ID2: c_uint = 0x4C;
pub const W83L786NG_REG_MAN_ID1: c_uint = 0x4D;
pub const W83L786NG_REG_CHIP_ID: c_uint = 0x4E;
pub const W83L786NG_REG_DIODE: c_uint = 0x53;
pub const W83L786NG_REG_FAN_DIV: c_uint = 0x54;
pub const W83L786NG_REG_FAN_CFG: c_uint = 0x80;
pub const W83L786NG_REG_TOLERANCE: c_uint = 0x8D;
...
// for temp
    ...
    : (val)) / 1000, 0, 0xff))
#[no_mangle]
unsafe extern "C" fn temp_from_reg(val: c_int) -> c_int {
...
// nonvolatile registers
    ...
    pub temp: [u8; 2][3],
    pub pwm: [u8; 2],
    pub voltage: *mut *mut u8 pwm_mode[2]; / 0->DC variable,
// 1->PWM variable duty cycle
    pub 1->manual: *mut *mut u8 pwm_enable[2]; /,
...
// read/write the temperature, includes measured value and limits
    ...
    SENSOR_ATTR_2(temp2_input, S_IRUGO, show_temp, core::ptr::null_mut(), 1, 0),
    };
...
#[no_mangle]
unsafe extern "C" fn w83l786ng_init_client(client: *mut i2c_client) {
