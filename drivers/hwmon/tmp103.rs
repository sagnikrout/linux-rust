...
pub const TMP103_TEMP_REG: c_uint = 0x00;
pub const TMP103_CONF_REG: c_uint = 0x01;
pub const TMP103_TLOW_REG: c_uint = 0x02;
pub const TMP103_THIGH_REG: c_uint = 0x03;
pub const TMP103_CONF_M0: c_uint = 0x01;
pub const TMP103_CONF_M1: c_uint = 0x02;
pub const TMP103_CONF_LC: c_uint = 0x04;
pub const TMP103_CONF_FL: c_uint = 0x08;
pub const TMP103_CONF_FH: c_uint = 0x10;
pub const TMP103_CONF_CR0: c_uint = 0x20;
pub const TMP103_CONF_CR1: c_uint = 0x40;
pub const TMP103_CONF_ID: c_uint = 0x80;

    TMP103_CONF_M0 | TMP103_CONF_M1)
#[no_mangle]
pub unsafe extern "C" fn tmp103_reg_to_mc(val: i8) -> c_int {
    static inline int tmp103_reg_to_mc(s8 val)
    {
    return val * 1000;
    }
#[no_mangle]
pub unsafe extern "C" fn tmp103_mc_to_reg(val: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn tmp103_regmap_is_volatile(dev: *mut device, reg: c_uint) -> bool {
    static bool tmp103_regmap_is_volatile(struct device *dev, unsigned int reg)
    {
    let mut reg: return = = TMP103_TEMP_REG;
    }
...
#[no_mangle]
unsafe extern "C" fn tmp103_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmp103_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmp103_resume(dev: *mut device) -> c_int {
