...
pub const VT8231_EXTENT: c_uint = 0x80;
pub const VT8231_BASE_REG: c_uint = 0x70;
pub const VT8231_ENABLE_REG: c_uint = 0x74;
...
//
pub const VT8231_REG_TEMP_LOW01: c_uint = 0x49;
pub const VT8231_REG_TEMP_LOW25: c_uint = 0x4d;
...
pub const VT8231_REG_CONFIG: c_uint = 0x40;
pub const VT8231_REG_ALARM1: c_uint = 0x41;
pub const VT8231_REG_ALARM2: c_uint = 0x42;
pub const VT8231_REG_FANDIV: c_uint = 0x47;
pub const VT8231_REG_UCH_CONFIG: c_uint = 0x4a;
pub const VT8231_REG_TEMP1_CONFIG: c_uint = 0x4b;
pub const VT8231_REG_TEMP2_CONFIG: c_uint = 0x4c;
//
...
pub struct vt8231_data {
    ...
    pub /: *mut *mut u8 in[6]; / Register value,
    pub /: *mut *mut u8 in_max[6]; / Register value,
    pub /: *mut *mut u8 in_min[6]; / Register value,
    pub /: *mut *mut u16 temp[6]; / Register value 10 bit, right aligned,
    pub /: *mut *mut u8 temp_max[6]; / Register value,
    pub /: *mut *mut u8 temp_min[6]; / Register value,
    ...
    pub /: *mut *mut u16 alarms; / Register encoding,
    pub uch_config: u8,
}

    static struct pci_dev *s_bridge;
#[no_mangle]
pub unsafe extern "C" fn vt8231_read_value(data: *mut vt8231_data, reg: u8) -> c_int {
...
// Set alarm flags correctly
    ...
    data.alarms |= 0x40;
#[no_mangle]
pub unsafe extern "C" fn if(!data->fan_min[0]: data->fan[0] &&) -> else {
    else if (data.fan[0] && !data.fan_min[0])
    data.alarms &= ~0x40;
    if (!data.fan[1] && data.fan_min[1])
    data.alarms |= 0x80;
#[no_mangle]
pub unsafe extern "C" fn if(!data->fan_min[1]: data->fan[1] &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn vt8231_init_device(data: *mut vt8231_data) {
...
#[no_mangle]
unsafe extern "C" fn vt8231_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vt8231_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn vt8231_device_add(address: c_ushort) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm_vt8231_init() -> int __init {
    static int __init sm_vt8231_init(void)
    {
    return pci_register_driver(&vt8231_pci_driver);
    }
#[no_mangle]
unsafe extern "C" fn sm_vt8231_exit() -> void __exit {
