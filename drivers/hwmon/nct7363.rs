...
//! Source: drivers/hwmon/nct7363.c
#![no_std]
...
pub const NCT7363_PWM_COUNT: c_int = 16;
#[no_mangle]
pub unsafe extern "C" fn fan_from_reg(val: u16) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nct7363_fan_is_visible(_data: *const c_void, attr: u32, channel: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn nct7363_pwm_is_visible(_data: *const c_void, attr: u32, channel: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn nct7363_init_chip(data: *mut nct7363_data) -> c_int {
    static int nct7363_init_chip(struct nct7363_data *data)
    {
    let mut func_config: u32 = 0;
    int i, ret;
...
#[no_mangle]
unsafe extern "C" fn nct7363_regmap_is_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nct7363_probe(client: *mut i2c_client) -> c_int {
...
// Initialize the chip
    ...
    &nct7363_chip_info, core::ptr::null_mut());
