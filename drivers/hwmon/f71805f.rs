...
//! Source: drivers/hwmon/f71805f.c
#![no_std]
...
//
pub const F71805F_LD_HWM: c_uint = 0x04;
...
pub const SIO_REG_FNSEL1: c_uint = 0x29	/* Multi Function Select 1 (F71872F) */;
...
pub const SIO_FINTEK_ID: c_uint = 0x1934;
pub const SIO_F71805F_ID: c_uint = 0x0406;
pub const SIO_F71872F_ID: c_uint = 0x0341;
    static inline int
...
pub const F71805F_REG_TEMP_MODE: c_uint = 0x01;
...
// map Fintek numbers to our numbers as follows: 9->0, 5->1, 1->2
    ...
    (0xA4 + 0x10 * (pwmnr) + \
    2 * (2 - (apnr)))
pub const F71805F_REG_START: c_uint = 0x00;
// status nr from 0 to 2

// individual register bits
pub const FAN_CTRL_DC_MODE: c_uint = 0x10;
pub const FAN_CTRL_LATCH_FULL: c_uint = 0x08;
pub const FAN_CTRL_MODE_MASK: c_uint = 0x03;
pub const FAN_CTRL_MODE_SPEED: c_uint = 0x00;
pub const FAN_CTRL_MODE_TEMPERATURE: c_uint = 0x01;
pub const FAN_CTRL_MODE_MANUAL: c_uint = 0x02;
//
// Data structures and manipulation thereof
//
#[repr(C)]
#[derive(Copy, Clone)]
pub struct f71805f_auto_point {
    pub temp: [u8; 3],
    pub fan: [u16; 3],
}
...
// Register values
    ...
    pub temp_mode: u8,
    pub alarms: c_ulong,
    pub auto_points: [f71805f_auto_point; 3],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct f71805f_sio_data {
    pub kind: enum kinds,
    pub fnsel1: u8,
}

#[no_mangle]
pub unsafe extern "C" fn in_from_reg(reg: u8) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn in_to_reg(val: c_long) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn in0_from_reg(reg: u8) -> c_long {
    static inline long in0_from_reg(u8 reg)
    {
    return reg * 16;
    }
#[no_mangle]
pub unsafe extern "C" fn in0_to_reg(val: c_long) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn fan_from_reg(reg: u16) -> c_long {
...
pub unsafe extern "C" fn pwm_freq_from_reg(reg: u8) -> c_ulong {
    ...
    {
    let mut clock: c_ulong = (reg & 0x80) ? 48000000UL : 1000000UL;
    reg &= 0x7f;
    if (reg == 0)
    reg++;
    return clock / (reg << 8);
...
#[no_mangle]
pub unsafe extern "C" fn pwm_mode_from_reg(reg: u8) -> c_int {
    static inline int pwm_mode_from_reg(u8 reg)
    {
    return !(reg & FAN_CTRL_DC_MODE);
    }
#[no_mangle]
pub unsafe extern "C" fn temp_from_reg(reg: u8) -> c_long {
    static inline long temp_from_reg(u8 reg)
    {
    return reg * 1000;
    }
#[no_mangle]
pub unsafe extern "C" fn temp_to_reg(val: c_long) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn f71805f_read8(data: *mut f71805f_data, reg: u8) -> u8 {
...
// Must be called with data->update_lock held, except during initialization
#[no_mangle]
unsafe extern "C" fn f71805f_write8(data: *mut f71805f_data, reg: u8, val: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn f71805f_read16(data: *mut f71805f_data, reg: u8) -> u16 {
...
// Must be called with data->update_lock held, except during initialization
#[no_mangle]
unsafe extern "C" fn f71805f_write16(data: *mut f71805f_data, reg: u8, val: u16) {
...
// devattr, const char *buf, size_t count)
    ...
    let mut pwmnr: c_int = attr.nr;
    let mut apnr: c_int = attr.index;
    return sprintf(buf, "%ld\n",
...
// devattr, char *buf)
    ...
    static SENSOR_DEVICE_ATTR(in0_input, S_IRUGO, show_in0, core::ptr::null_mut(), 0);
    ...
    static SENSOR_DEVICE_ATTR(in9_input, S_IRUGO, show_in0, core::ptr::null_mut(), 9);
    ...
    static SENSOR_DEVICE_ATTR(in10_input, S_IRUGO, show_in0, core::ptr::null_mut(), 10);
    ...
    static SENSOR_DEVICE_ATTR(fan3_input, S_IRUGO, show_fan, core::ptr::null_mut(), 2);
    static SENSOR_DEVICE_ATTR(fan3_min, S_IRUGO | S_IWUSR,
    show_fan_min, set_fan_min, 2);
    static SENSOR_DEVICE_ATTR(fan3_target, S_IRUGO | S_IWUSR,
    show_fan_target, set_fan_target, 2);
    static SENSOR_DEVICE_ATTR(temp1_input, S_IRUGO, show_temp, core::ptr::null_mut(), 0);
    static SENSOR_DEVICE_ATTR(temp1_max, S_IRUGO | S_IWUSR,
    show_temp_max, set_temp_max, 0);
    static SENSOR_DEVICE_ATTR(temp1_max_hyst, S_IRUGO | S_IWUSR,
    show_temp_hyst, set_temp_hyst, 0);
    static SENSOR_DEVICE_ATTR(temp1_type, S_IRUGO, show_temp_type, core::ptr::null_mut(), 0);
    static SENSOR_DEVICE_ATTR(temp2_input, S_IRUGO, show_temp, core::ptr::null_mut(), 1);
    static SENSOR_DEVICE_ATTR(temp2_max, S_IRUGO | S_IWUSR,
    show_temp_max, set_temp_max, 1);
    static SENSOR_DEVICE_ATTR(temp2_max_hyst, S_IRUGO | S_IWUSR,
    show_temp_hyst, set_temp_hyst, 1);
    static SENSOR_DEVICE_ATTR(temp2_type, S_IRUGO, show_temp_type, core::ptr::null_mut(), 1);
    static SENSOR_DEVICE_ATTR(temp3_input, S_IRUGO, show_temp, core::ptr::null_mut(), 2);
    static SENSOR_DEVICE_ATTR(temp3_max, S_IRUGO | S_IWUSR,
    show_temp_max, set_temp_max, 2);
    static SENSOR_DEVICE_ATTR(temp3_max_hyst, S_IRUGO | S_IWUSR,
    show_temp_hyst, set_temp_hyst, 2);
    static SENSOR_DEVICE_ATTR(temp3_type, S_IRUGO, show_temp_type, core::ptr::null_mut(), 2);
//
...
//
    ...
    static SENSOR_DEVICE_ATTR(pwm1_mode, S_IRUGO, show_pwm_mode, core::ptr::null_mut(), 0);
    static SENSOR_DEVICE_ATTR(pwm2, S_IRUGO, show_pwm, set_pwm, 1);
    static SENSOR_DEVICE_ATTR(pwm2_enable, S_IRUGO | S_IWUSR,
    show_pwm_enable, set_pwm_enable, 1);
    static SENSOR_DEVICE_ATTR(pwm2_freq, S_IRUGO | S_IWUSR,
    show_pwm_freq, set_pwm_freq, 1);
    static SENSOR_DEVICE_ATTR(pwm2_mode, S_IRUGO, show_pwm_mode, core::ptr::null_mut(), 1);
    static SENSOR_DEVICE_ATTR(pwm3, S_IRUGO, show_pwm, set_pwm, 2);
    static SENSOR_DEVICE_ATTR(pwm3_enable, S_IRUGO | S_IWUSR,
    show_pwm_enable, set_pwm_enable, 2);
    static SENSOR_DEVICE_ATTR(pwm3_freq, S_IRUGO | S_IWUSR,
    show_pwm_freq, set_pwm_freq, 2);
    static SENSOR_DEVICE_ATTR(pwm3_mode, S_IRUGO, show_pwm_mode, core::ptr::null_mut(), 2);
    ...
    static SENSOR_DEVICE_ATTR(in4_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 4);
    static SENSOR_DEVICE_ATTR(in5_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 5);
    static SENSOR_DEVICE_ATTR(in6_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 6);
    static SENSOR_DEVICE_ATTR(in7_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 7);
    static SENSOR_DEVICE_ATTR(in8_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 8);
    static SENSOR_DEVICE_ATTR(in9_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 9);
    static SENSOR_DEVICE_ATTR(in10_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 10);
    static SENSOR_DEVICE_ATTR(temp1_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 11);
    static SENSOR_DEVICE_ATTR(temp2_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 12);
    static SENSOR_DEVICE_ATTR(temp3_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 13);
    static SENSOR_DEVICE_ATTR(fan1_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 16);
    static SENSOR_DEVICE_ATTR(fan2_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 17);
    static SENSOR_DEVICE_ATTR(fan3_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 18);
...
//
#[no_mangle]
unsafe extern "C" fn f71805f_init_device(data: *mut f71805f_data) {
...
#[no_mangle]
unsafe extern "C" fn f71805f_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f71805f_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn f71805f_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn f71805f_exit() -> void __exit {
