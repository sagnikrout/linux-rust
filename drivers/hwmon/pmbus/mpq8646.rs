...
//! Source: drivers/hwmon/pmbus/mpq8646.c
#![no_std]
...
pub const MPQ8646_ALARM_POLL_MS_DEFAULT: c_int = 1000;
// MPS vendor-extended command codes (NOT in PMBus 1.3 Part II)
pub const MPS_CLEAR_LAST_FAULT: c_uint = 0x08;
pub const MPS_MFR_CFG_EXT: c_uint = 0xF5;

pub const MPS_PROTECTION_LAST: c_uint = 0xFB;
//
// PMBus 1.3 NVM commit / revert commands. MPS equivalent of
// STORE_ALL (15h) and RESTORE_ALL (16h).
//
pub const PMBUS_STORE_USER_ALL: c_uint = 0x15;
pub const PMBUS_RESTORE_USER_ALL: c_uint = 0x16;
// PMBus 1.3 timing / UVLO command codes
pub const PMBUS_VIN_ON: c_uint = 0x35;
pub const PMBUS_VIN_OFF: c_uint = 0x36;
pub const PMBUS_TON_DELAY: c_uint = 0x60;
pub const PMBUS_TON_RISE: c_uint = 0x61;
pub const PMBUS_TOFF_DELAY: c_uint = 0x64;
pub const PMBUS_TOFF_FALL: c_uint = 0x65;
// MPS vendor-extended observability / identity registers
pub const MPS_MFR_CONFIG_ID: c_uint = 0xC0;
pub const MPS_MFR_CONFIG_CODE_REV: c_uint = 0xC1;
pub const MPS_MFR_PRODUCT_REV_USER: c_uint = 0xC2;
pub const MPS_MFR_SILICON_REV: c_uint = 0xC3;
pub const MPS_MFR_RETRY_TIMES: c_uint = 0xF4;
pub const MPS_MFR_VBOOT_CFG: c_uint = 0xFC;
//
...
//
pub const MPS_MFR_PMBUS_LOCK: c_uint = 0xEE;
//
...
//
pub const MPQ8646_NVM_RETRY_MAX: c_int = 5;
pub const MPQ8646_NVM_RETRY_DELAY_US_MIN: c_int = 2000;
pub const MPQ8646_NVM_RETRY_DELAY_US_MAX: c_int = 4000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpq8646_priv {
    pub /: *mut *mut pmbus_driver_info info; / must be first, container_of target,
    pub client: *mut i2c_client,
// Serialises CLEAR_LAST_FAULT sequences and PROTECTION_LAST reads
    pub mps_lock: mutex,
// Set alarm_poll_interval_ms = 0 to disable.
    pub alarm_poll_work: delayed_work,
    pub alarm_poll_interval_ms: u32,

// the only debugfs file that can re-arm the poll worker
    pub dbg_poll: *mut dentry,
    pub dbg_reg_ctx: *mut mpq8646_dbg_reg_ctx,
...
// 1.5625 mV per LSB.
//
pub const MPQ8646_VID_M: c_int = 64;
pub const MPQ8646_VID_B: c_int = 0;
pub const MPQ8646_VID_R: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn mpq8646_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
//
pub const MPQ8646_NVMEM_SIZE: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpq8646_nvmem_entry {
    pub off: c_uint,
    pub reg: u8,
    pub is_word: bool,
}
    ...
    let mut e_start: c_uint = e.off;
    let mut e_end: c_uint = e_start + (e.is_word ? 2 : 1);
    u8 raw[2];
    int rc;
    unsigned int j;
...
#[no_mangle]
unsafe extern "C" fn mpq8646_dbg_status_decoded_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpq8646_dbg_protection_last_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpq8646_dbg_reg_ctx {
    pub priv: *mut mpq8646_priv,
    pub desc: *const mpq8646_dbg_reg,
}

#[no_mangle]
unsafe extern "C" fn mpq8646_dbg_reg_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mpq8646_unsafe_banner(priv: *mut mpq8646_priv) {
...
#[no_mangle]
unsafe extern "C" fn mpq8646_dbg_clear_protection_last(data: *mut c_void, val: u64) -> c_int {
    ...
    core::ptr::null_mut(), mpq8646_dbg_clear_protection_last, "%llu\n");
#[no_mangle]
unsafe extern "C" fn mpq8646_dbg_clear_protection_last_force(data: *mut c_void, val: u64) -> c_int {
    ...
    core::ptr::null_mut(), mpq8646_dbg_clear_protection_last_force, "%llu\n");
#[no_mangle]
unsafe extern "C" fn mpq8646_dbg_store_all(data: *mut c_void, val: u64) -> c_int {
    ...
    core::ptr::null_mut(), mpq8646_dbg_store_all, "%llu\n");
#[no_mangle]
unsafe extern "C" fn mpq8646_dbg_restore_all(data: *mut c_void, val: u64) -> c_int {
    ...
    core::ptr::null_mut(), mpq8646_dbg_restore_all, "%llu\n");
...
#[no_mangle]
unsafe extern "C" fn mpq8646_dbg_reg_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpq8646_dbg_reg_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpq8646_dbg_poll_interval_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpq8646_dbg_poll_interval_set(data: *mut c_void, val: u64) -> c_int {
    static int mpq8646_dbg_poll_interval_set(void *data, u64 val)
    {
    struct mpq8646_priv *priv = data;
    let mut was_off: bool = !priv.alarm_poll_interval_ms;
...
#[no_mangle]
unsafe extern "C" fn mpq8646_debugfs_register(priv: *mut mpq8646_priv) {
...
#[no_mangle]
unsafe extern "C" fn mpq8646_debugfs_unregister(priv: *mut mpq8646_priv) {
...
#[no_mangle]
unsafe extern "C" fn mpq8646_alarm_poll_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mpq8646_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpq8646_remove(client: *mut i2c_client) {
