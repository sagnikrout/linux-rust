...
//! Source: drivers/hwmon/pmbus/tps53679.c
#![no_std]
...
pub const TPS53647_PAGE_NUM: c_int = 1;
pub const TPS53676_USER_DATA_03: c_uint = 0xb3;
pub const TPS53676_MAX_PHASES: c_int = 7;
pub const TPS53679_PROT_VR12_5MV: c_uint = 0x01 /* VR12.0 mode, 5-mV DAC */;
pub const TPS53679_PROT_VR12_5_10MV: c_uint = 0x02 /* VR12.5 mode, 10-mV DAC */;
pub const TPS53679_PROT_VR13_10MV: c_uint = 0x04 /* VR13.0 mode, 10-mV DAC */;
pub const TPS53679_PROT_IMVP8_5MV: c_uint = 0x05 /* IMVP8 mode, 5-mV DAC */;
pub const TPS53679_PROT_VR13_5MV: c_uint = 0x07 /* VR13.0 mode, 5-mV DAC */;
pub const TPS53679_PAGE_NUM: c_int = 2;

pub const TPS53681_PMBUS_REVISION: c_uint = 0x33;
pub const TPS53681_MFR_SPECIFIC_20: c_uint = 0xe4	/* Number of phases, per page */;
...
//
    ...
    {
    u8 buf[I2C_SMBUS_BLOCK_MAX];
    let mut phases_a: c_int = 0, phases_b = 0;
    int i, ret;
    ret = i2c_smbus_read_block_data(client, PMBUS_IC_DEVICE_ID, buf);
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn tps53679_probe(client: *mut i2c_client) -> c_int {
