...
//! Source: drivers/hwmon/pmbus/lm25066.c
#![no_std]
...
pub const LM25066_READ_VAUX: c_uint = 0xd0;
pub const LM25066_MFR_READ_IIN: c_uint = 0xd1;
pub const LM25066_MFR_READ_PIN: c_uint = 0xd2;
pub const LM25066_MFR_IIN_OC_WARN_LIMIT: c_uint = 0xd3;
pub const LM25066_MFR_PIN_OP_WARN_LIMIT: c_uint = 0xd4;
pub const LM25066_READ_PIN_PEAK: c_uint = 0xd5;
pub const LM25066_CLEAR_PIN_PEAK: c_uint = 0xd6;
pub const LM25066_DEVICE_SETUP: c_uint = 0xd9;
pub const LM25066_READ_AVG_VIN: c_uint = 0xdc;
pub const LM25066_SAMPLES_FOR_AVG: c_uint = 0xdb;
pub const LM25066_READ_AVG_VOUT: c_uint = 0xdd;
pub const LM25066_READ_AVG_IIN: c_uint = 0xde;
pub const LM25066_READ_AVG_PIN: c_uint = 0xdf;

pub const LM25066_SAMPLES_FOR_AVG_MAX: c_int = 4096;
// LM25056 only
pub const LM25056_VAUX_OV_WARN_LIMIT: c_uint = 0xe3;
pub const LM25056_VAUX_UV_WARN_LIMIT: c_uint = 0xe4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm25066_data {
    pub id: c_int,
    pub /: *mut *mut u16 rlimit; / Maximum register value,
...
#[no_mangle]
unsafe extern "C" fn lm25056_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm25066_probe(client: *mut i2c_client) -> c_int {
    ...
    if (data.id != lm25056) {
    let mut config_new: c_int = config;
