...
//! Source: drivers/hwmon/pmbus/tda38640.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn tda38640_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svid_mode(client: *mut i2c_client, data: *mut tda38640_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tda38640_probe(client: *mut i2c_client) -> c_int {
