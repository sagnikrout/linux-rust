...
//! Source: drivers/hwmon/pmbus/delta-ahe50dc-fan.c
#![no_std]
...
pub const AHE50DC_PMBUS_READ_TEMP4: c_uint = 0xd0;
#[no_mangle]
unsafe extern "C" fn ahe50dc_fan_write_byte(client: *mut i2c_client, page: c_int, value: u8) -> c_int {
...
//
    let mut value: return = = PMBUS_CLEAR_FAULTS ? -EOPNOTSUPP : -ENODATA;
    }
#[no_mangle]
unsafe extern "C" fn ahe50dc_fan_read_word_data(client: *mut i2c_client, page: c_int, phase: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ahe50dc_fan_probe(client: *mut i2c_client) -> c_int {
