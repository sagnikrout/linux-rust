...
//! Source: drivers/hwmon/pmbus/ibm-cffps.c
#![no_std]
...
pub const CFFPS_CCIN_CMD: c_uint = 0xBD;
pub const CFFPS_FW_CMD: c_uint = 0xFA;
pub const CFFPS1_FW_NUM_BYTES: c_int = 4;
pub const CFFPS2_FW_NUM_WORDS: c_int = 3;
pub const CFFPS_SYS_CONFIG_CMD: c_uint = 0xDA;
pub const CFFPS_12VCS_VOUT_CMD: c_uint = 0xDE;
pub const CFFPS_INPUT_HISTORY_CMD: c_uint = 0xD6;
pub const CFFPS_INPUT_HISTORY_SIZE: c_int = 101;

pub const CFFPS_CCIN_REVISION_LEGACY: c_uint = 0xde;

pub const CFFPS_CCIN_VERSION_1: c_uint = 0x2b;
pub const CFFPS_CCIN_VERSION_2: c_uint = 0x2e;
pub const CFFPS_CCIN_VERSION_3: c_uint = 0x51;
// STATUS_MFR_SPECIFIC bits

pub const CFFPS_BLINK_RATE_MS: c_int = 250;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ibm_cffps {
    pub version: enum versions,
    pub client: *mut i2c_client,
    pub input_history: [u8; CFFPS_INPUT_HISTORY_SIZE],
    pub debugfs_entries: [c_int; CFFPS_DEBUGFS_NUM_ENTRIES],
    ...
    {
    int rc;
    let mut cmd: u8 = CFFPS_INPUT_HISTORY_CMD;
...
#[no_mangle]
unsafe extern "C" fn ibm_cffps_create_led_class(psu: *mut ibm_cffps) {
...
#[no_mangle]
unsafe extern "C" fn ibm_cffps_probe(client: *mut i2c_client) -> c_int {
    static int ibm_cffps_probe(struct i2c_client *client)
    {
    int i, rc;
    let mut vs: enum versions = (uintptr_t)i2c_get_match_data(client);
    struct dentry *debugfs;
    struct ibm_cffps *psu;
    if (vs == cffps_unknown) {
    let mut ccin_revision: u16 = 0;
    let mut ccin_version: u16 = CFFPS_CCIN_VERSION_1;
    let mut ccin: c_int = i2c_smbus_read_word_swapped(client, CFFPS_CCIN_CMD);
