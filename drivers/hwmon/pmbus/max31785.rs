...
//! Source: drivers/hwmon/pmbus/max31785.c
#![no_std]
...
pub const MAX31785: c_uint = 0x3030;
pub const MAX31785A: c_uint = 0x3040;
pub const MAX31785B: c_uint = 0x3061;

pub const MAX31785_NR_PAGES: c_int = 23;
pub const MAX31785_NR_FAN_PAGES: c_int = 6;
pub const MAX31785_WAIT_DELAY_US: c_int = 250;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max31785_data {
    pub /: *mut *mut ktime_t access; / Chip access time,
...
//
#[no_mangle]
pub unsafe extern "C" fn max31785_wait(data: *const max31785_data) {
    static inline void max31785_wait(const struct max31785_data *data)
    {
    let mut delta: i64 = ktime_us_delta(ktime_get(), data.access);
...
#[no_mangle]
unsafe extern "C" fn max31785_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max31785_write_byte(client: *mut i2c_client, page: c_int, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max31785_get_pwm(client: *mut i2c_client, page: c_int) -> c_int {
    ...
    return rv;
#[no_mangle]
pub unsafe extern "C" fn if(0x8000: rv >=) -> else {
    else if (rv >= 0x8000)
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(0x2711: rv >=) -> else {
    else if (rv >= 0x2711)
    return 0x2710;
    return rv;
    }
#[no_mangle]
unsafe extern "C" fn max31785_get_pwm_mode(client: *mut i2c_client, page: c_int) -> c_int {
    ...
    return 3;
#[no_mangle]
pub unsafe extern "C" fn if(0x2711: command >=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn max31785_scale_pwm(sensor_val: u32) -> u32 {
...
// PWM
    ...
    let mut vpage: c_int = MAX31785_NR_PAGES + i;
    info.pages = vpage + 1;
...
#[no_mangle]
unsafe extern "C" fn max31785_probe(client: *mut i2c_client) -> c_int {
    static int max31785_probe(struct i2c_client *client)
    {
    struct device *dev = &client.dev;
    struct pmbus_driver_info *info;
    struct max31785_data *data;
    let mut dual_tach: bool = false;
    int ret;
