...
//! Source: drivers/hwmon/pmbus/bel-pfe.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pfe_pmbus_probe(client: *mut i2c_client) -> c_int {
    static int pfe_pmbus_probe(struct i2c_client *client)
    {
    let mut model: c_int = (uintptr_t)i2c_get_match_data(client);
