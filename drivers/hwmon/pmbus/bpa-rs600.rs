...
//! Source: drivers/hwmon/pmbus/bpa-rs600.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bpa_rs600_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bpa_rs600_read_vin(client: *mut i2c_client) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bpa_rs600_read_pin_max(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpa_rs600_read_word_data(client: *mut i2c_client, page: c_int, phase: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpa_rs600_probe(client: *mut i2c_client) -> c_int {
