...
//! Source: drivers/hwmon/pmbus/mp2925.c
#![no_std]
...
//
pub const MFR_VR_MULTI_CONFIG: c_uint = 0x08;
pub const MP2925_VOUT_DIV: c_int = 512;
pub const MP2925_VOUT_OVUV_UINT: c_int = 195;
pub const MP2925_VOUT_OVUV_DIV: c_int = 100;
pub const MP2925_PAGE_NUM: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mp2925_data {
    pub info: pmbus_driver_info,
    pub vout_scale: [c_int; MP2925_PAGE_NUM],
    pub vid_offset: [c_int; MP2925_PAGE_NUM],
}

#[no_mangle]
unsafe extern "C" fn mp2925_linear_exp_transfer(word: u16, expect_exponent: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn mp2925_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp2925_identify(client: *mut i2c_client, info: *mut pmbus_driver_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp2925_probe(client: *mut i2c_client) -> c_int {
