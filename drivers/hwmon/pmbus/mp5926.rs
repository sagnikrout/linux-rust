...
//! Source: drivers/hwmon/pmbus/mp5926.c
#![no_std]
...
pub const PAGE: c_uint = 0x01;
pub const EFUSE_CFG: c_uint = 0xCF;
pub const I_SCALE_SEL: c_uint = 0xC6;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mp5926_data {
    pub info: pmbus_driver_info,
    pub vout_mode: u8,
    pub vout_linear_exponent: u8,
}
...
#[no_mangle]
unsafe extern "C" fn mp5926_probe(client: *mut i2c_client) -> c_int {
