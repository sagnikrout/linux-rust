...
//! Source: drivers/hwmon/pmbus/pmbus_core.c
#![no_std]
...
//
pub const PMBUS_ATTR_ALLOC_SIZE: c_int = 32;
pub const PMBUS_NAME_SIZE: c_int = 24;
//
...
// PMBUS_OP_WRITE and PMBUS_OP_PAGE_CHANGE are defined in pmbus.h
    let mut wp: static int = -1;
    module_param(wp, int, 0444);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmbus_sensor {
    pub next: *mut pmbus_sensor,
    pub /: *mut *mut char name[PMBUS_NAME_SIZE]; / sysfs sensor name,
    pub attribute: sensor_device_attribute,
    pub /: *mut *mut u8 page; / page number,
    pub /: *mut *mut u8 phase; / phase number, 0xff for all phases,
    pub /: *mut *mut u16 reg; / register,
    pub /: *mut *mut enum pmbus_sensor_classes class; / sensor class,
    pub /: *mut *mut bool update; / runtime sensor update needed,
    pub /: *mut *mut bool convert; / Whether or not to apply linear/vid/direct,
    pub /: *mut *mut int data; / Sensor data; negative if there was a read error,
}

    container_of(_attr, struct pmbus_sensor, attribute)
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmbus_boolean {
    pub /: *mut *mut char name[PMBUS_NAME_SIZE]; / sysfs boolean name,
    pub attribute: sensor_device_attribute,
    pub s1: *mut pmbus_sensor,
    pub s2: *mut pmbus_sensor,
}

    container_of(_attr, struct pmbus_boolean, attribute)
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmbus_label {
    pub /: *mut *mut char name[PMBUS_NAME_SIZE]; / sysfs label name,
    pub attribute: sensor_device_attribute,
    pub /: *mut *mut char label[PMBUS_NAME_SIZE]; / label,
}

    container_of(_attr, struct pmbus_label, attribute)
// Macros for converting between sensor index and register/page/status mask
pub const PB_STATUS_MASK: c_uint = 0xffff;
pub const PB_REG_SHIFT: c_int = 16;
pub const PB_REG_MASK: c_uint = 0x3ff;
pub const PB_PAGE_SHIFT: c_int = 26;
pub const PB_PAGE_MASK: c_uint = 0x3f;

    ((reg) << PB_REG_SHIFT) | (mask))

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmbus_data {
    pub dev: *mut device,
    pub hwmon_dev: *mut device,
    pub rdevs: *mut regulator_dev,
    pub /: *mut *mut u32 flags; / from platform data,
    pub have_pmbus_revision: bool,
    pub /: *mut *mut u8 revision; / The PMBus revision the device is compliant with,
    pub exponent: [c_int; PMBUS_PAGES],
// linear mode: exponent for output voltages
    pub info: *const pmbus_driver_info,
    pub max_attributes: c_int,
    pub num_attributes: c_int,
    pub group: attribute_group,
    pub groups: *const attribute_group,
    pub sensors: *mut pmbus_sensor,
    pub update_lock: mutex,
    pub regulator_events: [core::sync::atomic::AtomicI32; PMBUS_PAGES],
    pub regulator_notify_work: work_struct,

    pub /: *mut *mut bool has_status_word; / device uses STATUS_WORD register,
    pub page): *mut *mut *mut int (read_status)(struct i2c_client client, int,
    pub /: *mut *mut s16 currpage; / current page, -1 for unknown/unset,
    pub /: *mut *mut s16 currphase; / current phase, 0xff for all, -1 for unknown/unset,
    pub /: *mut *mut int vout_low[PMBUS_PAGES]; / voltage low margin,
    pub /: *mut *mut int vout_high[PMBUS_PAGES]; / voltage high margin,
    pub /: *mut *mut ktime_t next_access_backoff; / Wait until at least this time,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmbus_debugfs_entry {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_clear_cache(client: *mut i2c_client) {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_set_update(client: *mut i2c_client, reg: u8, update: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_wait(client: *mut i2c_client) {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_update_ts(client: *mut i2c_client, op: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_set_page(client: *mut i2c_client, page: c_int, phase: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_write_byte(client: *mut i2c_client, page: c_int, value: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _pmbus_write_byte(client: *mut i2c_client, page: c_int, value: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _pmbus_write_byte_data(client: *mut i2c_client, page: c_int, reg: c_int, value: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _pmbus_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_read_word_data(client: *mut i2c_client, page: c_int, phase: c_int, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmbus_read_virt_reg(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __pmbus_read_word_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_read_byte_data(client: *mut i2c_client, page: c_int, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_write_byte_data(client: *mut i2c_client, page: c_int, reg: u8, value: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pmbus_read_smbus_i2c_block_data(client: *mut i2c_client, reg: u8, data_buf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmbus_clear_fault_page(client: *mut i2c_client, page: c_int) {
    static void pmbus_clear_fault_page(struct i2c_client *client, int page)
    {
    _pmbus_write_byte(client, page, PMBUS_CLEAR_FAULTS);
    }
#[no_mangle]
pub unsafe extern "C" fn pmbus_clear_faults(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn pmbus_check_status_cml(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmbus_check_status_register(client: *mut i2c_client, page: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_check_byte_register(client: *mut i2c_client, page: c_int, reg: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_check_word_register(client: *mut i2c_client, page: c_int, reg: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pmbus_get_status(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmbus_update_sensor_data(client: *mut i2c_client, sensor: *mut pmbus_sensor) {
...
//
    ...
    struct pmbus_sensor *sensor)
    {
    let mut val: c_long = sensor.data;
    let mut rv: c_long = 0;
...
#[no_mangle]
unsafe extern "C" fn pmbus_reg2data(data: *mut pmbus_data, sensor: *mut pmbus_sensor) -> i64 {
...
//
    ...
    mantissa = 0x7ff;
#[no_mangle]
pub unsafe extern "C" fn if(0x400: mantissa <) -> else {
...
//
    ...
    let mut mask: u16 = pb_index_to_mask(index);
    let mut page: u8 = pb_index_to_page(index);
    let mut reg: u16 = pb_index_to_reg(index);
    int ret, status;
    u16 regval;
...
#[no_mangle]
unsafe extern "C" fn pmbus_add_attribute(data: *mut pmbus_data, attr: *mut attribute) -> c_int {
    static int pmbus_add_attribute(struct pmbus_data *data, struct attribute *attr)
    {
    if (data.num_attributes >= data.max_attributes - 1) {
    let mut new_max_attrs: c_int = data.max_attributes + PMBUS_ATTR_ALLOC_SIZE;
    ...
    data.group.attrs[data.num_attributes] = core::ptr::null_mut();
    return 0;
    }
    ...
    boolean.s1 = s1;
    boolean.s2 = s2;
    pmbus_attr_init(a, boolean.name, 0444, pmbus_show_boolean, core::ptr::null_mut(),
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmbus_thermal_data {
    pub pmbus_data: *mut pmbus_data,
    pub sensor: *mut pmbus_sensor,
}

#[no_mangle]
unsafe extern "C" fn pmbus_thermal_get_temp(tz: *mut thermal_zone_device, temp: *mut c_int) -> c_int {
...
// temperature sensors with _input values are registered with thermal
    ...
    pmbus_attr_init(a, label.name, 0444, pmbus_show_label, core::ptr::null_mut(), -1);
    return pmbus_add_attribute(data, &a.dev_attr.attr);
    }
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmbus_limit_attr {
    pub /: *mut *mut u16 reg; / Limit register,
    pub /: *mut *mut u16 sbit; / Alarm attribute status bit,
    pub /: *mut *mut bool readonly:1; / True if the attribute is read-only,
    pub /: *mut *mut bool writeonly:1; / True if the attribute is write-only,
    pub /: *mut *mut bool update:1; / True if register needs updates,
    pub /: *mut *mut bool low:1; / True if low limit; for limits with compare functions only,
    pub /: *const *const *const char attr; / Attribute name,
    pub /: *const *const *const char alarm; / Alarm attribute name,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmbus_sensor_attr {
    pub /: *mut *mut u16 reg; / sensor register,
    pub /: *mut *mut u16 gbit; / generic status bit,
    pub /: *mut *mut u8 nlimit; / # of limit registers,
    pub /: *mut *mut enum pmbus_sensor_classes class;/ sensor class,
    pub /: *const *const *const char label; / sensor label,
    pub /: *mut *mut bool paged:1; / true if paged sensor,
    pub /: *mut *mut bool update:1; / true if update needed,
    pub /: *mut *mut bool compare:1; / true if compare function needed,
    pub /: *mut *mut u32 func; / sensor mask,
    pub /: *mut *mut u32 sfunc; / sensor status mask,
    pub /: *mut *mut int sreg; / status register,
    pub /: *const *const *const pmbus_limit_attr limit;/ limit registers,
}
...
//
    ...
    let mut nlimit: c_int = attr.nlimit;
    let mut have_alarm: c_int = 0;
    int i, ret;
...
//
    ...
    for (i = 0; i < nattrs; i++) {
    int page, pages;
    let mut paged: bool = pmbus_sensor_is_paged(info, attrs);
...
// Precondition: FAN_CONFIG_x_y and FAN_COMMAND_x must exist for the fan ID
    ...
    return 0;
    sensor = pmbus_add_sensor(data, "pwm", core::ptr::null_mut(), index, page,
...
//
    ...
    PSC_FAN, true, true, false, true) == core::ptr::null_mut())
    return -ENOMEM;
// Fan control
    if (pmbus_check_word_register(client, page,
...
//
    ...
    "alarm", index, core::ptr::null_mut(), core::ptr::null_mut(), page, reg,
    PB_FAN_FAN1_WARNING >> (f & 1));
    if (ret)
    return ret;
    ret = pmbus_add_boolean(data, "fan",
    "fault", index, core::ptr::null_mut(), core::ptr::null_mut(), page, reg,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmbus_samples_reg {
    pub page: c_int,
    pub attr: *mut pmbus_samples_attr,
    pub attribute: sensor_device_attribute,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmbus_class_attr_map {
    pub class: enum pmbus_sensor_classes,
    pub nattr: c_int,
    pub attr: *const pmbus_sensor_attr,
}
...
//
    ...
    let mut class: enum pmbus_sensor_classes = attr.class;
    s8 R;
    s16 m, b;
    data.block[0] = 2;
...
#[no_mangle]
unsafe extern "C" fn pmbus_read_status_byte(client: *mut i2c_client, page: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmbus_read_status_word(client: *mut i2c_client, page: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmbus_remove_pec(dev: *mut c_void) {
    static void pmbus_remove_pec(void *dev)
    {
    device_remove_file(dev, &dev_attr_pec);
    }
#[no_mangle]
unsafe extern "C" fn pmbus_init_wp(client: *mut i2c_client, data: *mut pmbus_data) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmbus_status_assoc {
    pub eflag: int pflag, rflag,,
}

// PMBus->regulator bit mappings for a PMBus status register
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmbus_status_category {
    pub func: c_int,
    pub reg: c_int,
    pub /: *const *const *const pmbus_status_assoc bits; / zero-terminated,
}
...
#[no_mangle]
unsafe extern "C" fn _pmbus_is_enabled(client: *mut i2c_client, page: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmbus_is_enabled(client: *mut i2c_client, page: u8) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn pmbus_notify(data: *mut pmbus_data, page: c_int, reg: c_int, flags: c_int) {
    ...
    struct sensor_device_attribute *attr = to_sensor_dev_attr(da);
    let mut index: c_int = attr.index;
    u16 smask, sreg;
    u8 spage;
    if (index == -1)
    continue;
    ...
    sysfs_notify(&data.hwmon_dev.kobj, core::ptr::null_mut(),
    da.attr.name);
    ...
    let mut func: c_int = data.info.func[page];
// flags = 0;
// event = 0;
...
#[no_mangle]
unsafe extern "C" fn pmbus_regulator_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _pmbus_regulator_on_off(rdev: *mut regulator_dev, enable: bool) -> c_int {
    static int _pmbus_regulator_on_off(struct regulator_dev *rdev, bool enable)
    {
    struct device *dev = rdev_get_dev(rdev);
    struct i2c_client *client = to_i2c_client(dev.parent);
    let mut page: u8 = rdev_get_id(rdev);
    guard(pmbus_lock)(client);
...
#[no_mangle]
unsafe extern "C" fn pmbus_regulator_enable(rdev: *mut regulator_dev) -> c_int {
    static int pmbus_regulator_enable(struct regulator_dev *rdev)
    {
    return _pmbus_regulator_on_off(rdev, 1);
    }
#[no_mangle]
unsafe extern "C" fn pmbus_regulator_disable(rdev: *mut regulator_dev) -> c_int {
    static int pmbus_regulator_disable(struct regulator_dev *rdev)
    {
    return _pmbus_regulator_on_off(rdev, 0);
    }
#[no_mangle]
unsafe extern "C" fn pmbus_regulator_get_error_flags(rdev: *mut regulator_dev, flags: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmbus_regulator_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmbus_regulator_get_low_margin(client: *mut i2c_client, page: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmbus_regulator_get_high_margin(client: *mut i2c_client, page: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmbus_regulator_get_voltage(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmbus_regulator_notify_work_cancel(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pmbus_regulator_notify_worker(work: *mut work_struct) {
    ...
    continue;
    while (event) {
    let mut _event: c_uint = BIT(__ffs(event));
    regulator_notifier_call_chain(data.rdevs[j],
    _event, core::ptr::null_mut());
    event &= ~_event;
    }
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn pmbus_regulator_register(data: *mut pmbus_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmbus_regulator_notify(data: *mut pmbus_data, page: c_int, event: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pmbus_write_smbalert_mask(client: *mut i2c_client, page: u8, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_check_and_notify_faults(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn pmbus_fault_handler(irq: c_int, pdata: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pmbus_irq_setup(client: *mut i2c_client, data: *mut pmbus_data) -> c_int {
...
// Register notifiers
    err = devm_request_threaded_irq(dev, client.irq, core::ptr::null_mut(), pmbus_fault_handler,
...
#[no_mangle]
unsafe extern "C" fn pmbus_debugfs_get(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = rc;
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(pmbus_debugfs_ops, pmbus_debugfs_get, core::ptr::null_mut(),
    "0x%02llx\n");
#[no_mangle]
unsafe extern "C" fn pmbus_debugfs_get_revision(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = pdata->revision;
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(pmbus_debugfs_revision_ops, pmbus_debugfs_get_revision, core::ptr::null_mut(),
    "0x%02llx\n");
#[no_mangle]
unsafe extern "C" fn pmbus_debugfs_get_status(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmbus_remove_symlink(symlink: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_do_probe(client: *mut i2c_client, info: *mut pmbus_driver_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_lock(client: *mut i2c_client) {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_lock_interruptible(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pmbus_unlock(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn pmbus_core_init() -> int __init {
    static int __init pmbus_core_init(void)
    {
    pmbus_debugfs_dir = debugfs_create_dir("pmbus", core::ptr::null_mut());
    if (IS_ERR(pmbus_debugfs_dir))
    pmbus_debugfs_dir = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn pmbus_core_exit() -> void __exit {
