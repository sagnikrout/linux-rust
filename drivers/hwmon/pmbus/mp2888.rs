...
//! Source: drivers/hwmon/pmbus/mp2888.c
#![no_std]
...
pub const MP2888_MFR_SYS_CONFIG: c_uint = 0x44;
pub const MP2888_MFR_READ_CS1_2: c_uint = 0x73;
pub const MP2888_MFR_READ_CS3_4: c_uint = 0x74;
pub const MP2888_MFR_READ_CS5_6: c_uint = 0x75;
pub const MP2888_MFR_READ_CS7_8: c_uint = 0x76;
pub const MP2888_MFR_READ_CS9_10: c_uint = 0x77;
pub const MP2888_MFR_VR_CONFIG1: c_uint = 0xe1;

pub const MP2888_TEMP_UNIT: c_int = 10;
pub const MP2888_MAX_PHASE: c_int = 10;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mp2888_data {
    pub info: pmbus_driver_info,
    pub total_curr_resolution: c_int,
    pub phase_curr_resolution: c_int,
    pub curr_sense_gain: c_int,
}

#[no_mangle]
unsafe extern "C" fn mp2888_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp2888_read_word_data(client: *mut i2c_client, page: c_int, phase: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp2888_write_word_data(client: *mut i2c_client, page: c_int, reg: c_int, word: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp2888_probe(client: *mut i2c_client) -> c_int {
