...
//! Source: drivers/hwmon/pmbus/q54sj108a2.c
#![no_std]
...
pub const STORE_DEFAULT_ALL: c_uint = 0x11;
pub const ERASE_BLACKBOX_DATA: c_uint = 0xD1;
pub const READ_HISTORY_EVENT_NUMBER: c_uint = 0xD2;
pub const READ_HISTORY_EVENTS: c_uint = 0xE0;
pub const SET_HISTORY_EVENT_OFFSET: c_uint = 0xE1;
pub const PMBUS_FLASH_KEY_WRITE: c_uint = 0xEC;
    enum chips {
    q54sj108a2
    };
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct q54sj108a2_data {
    pub chip: enum chips,
    pub client: *mut i2c_client,
    pub debugfs_entries: [c_int; Q54SJ108A2_DEBUGFS_NUM_ENTRIES],
}
...
#[no_mangle]
unsafe extern "C" fn q54sj108a2_probe(client: *mut i2c_client) -> c_int {
