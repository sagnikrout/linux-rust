...
//! Source: drivers/hwmon/pmbus/mp2993.c
#![no_std]
...
pub const MP2993_VOUT_OVUV_UINT: c_int = 125;
pub const MP2993_VOUT_OVUV_DIV: c_int = 64;
pub const MP2993_VIN_LIMIT_UINT: c_int = 1;
pub const MP2993_VIN_LIMIT_DIV: c_int = 8;
pub const MP2993_READ_VIN_UINT: c_int = 1;
pub const MP2993_READ_VIN_DIV: c_int = 32;
pub const MP2993_PAGE_NUM: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn mp2993_linear11_exponent_transfer(word: u16, expect_exponent: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn mp2993_identify(client: *mut i2c_client, info: *mut pmbus_driver_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp2993_probe(client: *mut i2c_client) -> c_int {
