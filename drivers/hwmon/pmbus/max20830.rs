...
//! Source: drivers/hwmon/pmbus/max20830.c
#![no_std]
...
pub const MAX20830_IC_DEVICE_ID_LENGTH: c_int = 9;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max20830_data {
...
#[no_mangle]
unsafe extern "C" fn max20830_probe(client: *mut i2c_client) -> c_int {
