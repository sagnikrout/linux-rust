...
//! Source: drivers/hwmon/pmbus/mp2975.c
#![no_std]
...
pub const MP2975_MFR_APS_HYS_R2: c_uint = 0x0d;
pub const MP2975_MFR_SLOPE_TRIM3: c_uint = 0x1d;
pub const MP2975_MFR_VR_MULTI_CONFIG_R1: c_uint = 0x0d;
pub const MP2975_MFR_VR_MULTI_CONFIG_R2: c_uint = 0x1d;
pub const MP2975_MFR_APS_DECAY_ADV: c_uint = 0x56;
pub const MP2975_MFR_DC_LOOP_CTRL: c_uint = 0x59;
pub const MP2975_MFR_OCP_UCP_PHASE_SET: c_uint = 0x65;
pub const MP2975_MFR_VR_CONFIG1: c_uint = 0x68;
pub const MP2975_MFR_READ_CS1_2: c_uint = 0x82;
pub const MP2975_MFR_READ_CS3_4: c_uint = 0x83;
pub const MP2975_MFR_READ_CS5_6: c_uint = 0x84;
pub const MP2975_MFR_READ_CS7_8: c_uint = 0x85;
pub const MP2975_MFR_READ_CS9_10: c_uint = 0x86;
pub const MP2975_MFR_READ_CS11_12: c_uint = 0x87;
pub const MP2975_MFR_READ_IOUT_PK: c_uint = 0x90;
pub const MP2975_MFR_READ_POUT_PK: c_uint = 0x91;
pub const MP2975_MFR_READ_VREF_R1: c_uint = 0xa1;
pub const MP2975_MFR_READ_VREF_R2: c_uint = 0xa3;
pub const MP2975_MFR_OVP_TH_SET: c_uint = 0xe5;
pub const MP2975_MFR_UVP_SET: c_uint = 0xe6;
pub const MP2973_MFR_RESO_SET: c_uint = 0xc7;

pub const MP2975_PROT_DEV_OV_OFF: c_int = 10;
pub const MP2975_PROT_DEV_OV_ON: c_int = 5;

pub const MP2975_SENSE_AMPL_UNIT: c_int = 1;
pub const MP2975_SENSE_AMPL_HALF: c_int = 2;
pub const MP2975_VIN_UV_LIMIT_UNIT: c_int = 8;

pub const MP2973_MFR_VR_MULTI_CONFIG_R1: c_uint = 0x0d;
pub const MP2973_MFR_VR_MULTI_CONFIG_R2: c_uint = 0x1d;

pub const MP2973_MFR_OCP_TOTAL_SET: c_uint = 0x5f;

pub const MP2973_MFR_READ_IOUT_PK: c_uint = 0x90;
pub const MP2973_MFR_READ_POUT_PK: c_uint = 0x91;
pub const MP2975_MAX_PHASE_RAIL1: c_int = 8;
pub const MP2975_MAX_PHASE_RAIL2: c_int = 4;
pub const MP2973_MAX_PHASE_RAIL1: c_int = 14;
pub const MP2973_MAX_PHASE_RAIL2: c_int = 6;
pub const MP2971_MAX_PHASE_RAIL1: c_int = 8;
pub const MP2971_MAX_PHASE_RAIL2: c_int = 3;
pub const MP2975_PAGE_NUM: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mp2975_driver_info {
    pub info: *const pmbus_driver_info,
    pub chip_id: enum chips,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mp2975_data {
    pub info: pmbus_driver_info,
    pub chip_id: enum chips,
    pub vout_scale: c_int,
    pub max_phases: [c_int; MP2975_PAGE_NUM],
    pub vid_step: [c_int; MP2975_PAGE_NUM],
    pub vref: [c_int; MP2975_PAGE_NUM],
    pub vref_off: [c_int; MP2975_PAGE_NUM],
    pub vout_max: [c_int; MP2975_PAGE_NUM],
    pub vout_ov_fixed: [c_int; MP2975_PAGE_NUM],
    pub curr_sense_gain: [c_int; MP2975_PAGE_NUM],
}
...
#[no_mangle]
unsafe extern "C" fn mp2975_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
//
    ...
    u16 mask)
    {
    let mut ret: c_int = pmbus_read_word_data(client, page, phase, reg);
...
#[no_mangle]
unsafe extern "C" fn mp2975_data2reg_linear11(val: i64) -> u16 {
...
//
pub const MP2973_TEMP_OT: c_int = 0;
pub const MP2973_VIN_UVLO: c_int = 1;
pub const MP2973_VIN_OVP: c_int = 3;
pub const MP2973_MTP_FAULT: c_int = 4;
pub const MP2973_OTHER_COMM: c_int = 5;
pub const MP2973_MTP_BLK_TRIG: c_int = 6;
pub const MP2973_PACKET_ERROR: c_int = 7;
pub const MP2973_INVALID_DATA: c_int = 8;
pub const MP2973_INVALID_COMMAND: c_int = 9;
pub const MP2973_IOUT_OC_LV: c_int = 10;
pub const MP2973_IOUT_OC: c_int = 11;
pub const MP2973_VOUT_MAX_MIN_WARNING: c_int = 12;
pub const MP2973_VOLTAGE_UV: c_int = 13;
pub const MP2973_VOLTAGE_OV: c_int = 14;
    switch (target) {
...
#[no_mangle]
unsafe extern "C" fn mp2975_set_phase_rail1(info: *mut pmbus_driver_info) {
...
#[no_mangle]
unsafe extern "C" fn mp2975_probe(client: *mut i2c_client) -> c_int {
