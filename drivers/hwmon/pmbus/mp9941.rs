...
//! Source: drivers/hwmon/pmbus/mp9941.c
#![no_std]
...
//
pub const MFR_ICC_MAX: c_uint = 0x02;
pub const MFR_RESO_SET: c_uint = 0xC7;
pub const MFR_VR_MULTI_CONFIG_R1: c_uint = 0x0D;
pub const MP9941_VIN_LIMIT_UINT: c_int = 1;
pub const MP9941_VIN_LIMIT_DIV: c_int = 8;
pub const MP9941_READ_VIN_UINT: c_int = 1;
pub const MP9941_READ_VIN_DIV: c_int = 32;
pub const MP9941_PAGE_NUM: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mp9941_data {
    pub info: pmbus_driver_info,
    pub vid_resolution: c_int,
}

#[no_mangle]
unsafe extern "C" fn mp9941_set_vout_format(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp9941_identify_iin_scale(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp9941_identify(client: *mut i2c_client, info: *mut pmbus_driver_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp9941_probe(client: *mut i2c_client) -> c_int {
