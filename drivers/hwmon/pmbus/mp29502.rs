...
//! Source: drivers/hwmon/pmbus/mp29502.c
#![no_std]
...
pub const MFR_VOUT_SCALE_LOOP: c_uint = 0x29;
pub const MFR_SVI3_IOUT_PRT: c_uint = 0x67;
pub const MFR_READ_PIN_EST: c_uint = 0x94;
pub const MFR_READ_IIN_EST: c_uint = 0x95;
pub const MFR_VOUT_PROT1: c_uint = 0x3D;
pub const MFR_VOUT_PROT2: c_uint = 0x51;
pub const MFR_SLOPE_CNT_SET: c_uint = 0xA8;
pub const MFR_TSNS_FLT_SET: c_uint = 0xBB;
pub const MP29502_VIN_OV_GAIN: c_int = 4;
pub const MP29502_TEMP_LIMIT_OFFSET: c_int = 40;
pub const MP29502_READ_VOUT_DIV: c_int = 1024;
pub const MP29502_READ_IOUT_DIV: c_int = 32;
pub const MP29502_IOUT_LIMIT_UINT: c_int = 8;
pub const MP29502_OVUV_LIMIT_SCALE: c_int = 10;
pub const MP28502_VOUT_OV_GAIN: c_int = 512;
pub const MP28502_VOUT_OV_SCALE: c_int = 40;
pub const MP29502_VOUT_UV_OFFSET: c_int = 36;
pub const MP29502_PIN_GAIN: c_int = 2;
pub const MP29502_IIN_DIV: c_int = 2;
pub const MP29502_PAGE_NUM: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mp29502_data {
    pub info: pmbus_driver_info,
    pub vout_scale: c_int,
    pub vout_bottom_div: c_int,
    pub vout_top_div: c_int,
    pub ovp_div: c_int,
    pub iout_scale: c_int,
}

#[no_mangle]
unsafe extern "C" fn mp29502_reg2data_linear11(word: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn mp29502_read_vout_ov_limit(client: *mut i2c_client, data: *mut mp29502_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp29502_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp29502_identify(client: *mut i2c_client, info: *mut pmbus_driver_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp29502_probe(client: *mut i2c_client) -> c_int {
