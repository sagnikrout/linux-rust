...
//! Source: drivers/hwmon/pmbus/mp2856.c
#![no_std]
...
pub const MP2856_MFR_VR_MULTI_CONFIG_R1: c_uint = 0x0d;
pub const MP2856_MFR_VR_MULTI_CONFIG_R2: c_uint = 0x1d;
pub const MP2856_MUL1_BOOT_SR_R2: c_uint = 0x10;

pub const MP2856_MFR_VR_CONFIG2: c_uint = 0x5e;

pub const MP2856_MFR_VR_CONFIG1: c_uint = 0x68;

pub const MP2856_MFR_READ_CS1_2_R1: c_uint = 0x82;
pub const MP2856_MFR_READ_CS3_4_R1: c_uint = 0x83;
pub const MP2856_MFR_READ_CS5_6_R1: c_uint = 0x84;
pub const MP2856_MFR_READ_CS7_8_R1: c_uint = 0x85;
pub const MP2856_MFR_READ_CS9_10_R1: c_uint = 0x86;
pub const MP2856_MFR_READ_CS11_12_R1: c_uint = 0x87;
pub const MP2856_MFR_READ_CS1_2_R2: c_uint = 0x85;
pub const MP2856_MFR_READ_CS3_4_R2: c_uint = 0x86;
pub const MP2856_MFR_READ_CS5_6_R2: c_uint = 0x87;
pub const MP2856_MAX_PHASE_RAIL1: c_int = 8;
pub const MP2856_MAX_PHASE_RAIL2: c_int = 4;
pub const MP2857_MAX_PHASE_RAIL1: c_int = 12;
pub const MP2857_MAX_PHASE_RAIL2: c_int = 4;
pub const MP2856_PAGE_NUM: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mp2856_data {
    pub info: pmbus_driver_info,
    pub vout_format: [c_int; MP2856_PAGE_NUM],
    pub curr_sense_gain: [c_int; MP2856_PAGE_NUM],
    pub max_phases: [c_int; MP2856_PAGE_NUM],
}

#[no_mangle]
unsafe extern "C" fn val2linear11(val: i64) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn mp2856_probe(client: *mut i2c_client) -> c_int {
