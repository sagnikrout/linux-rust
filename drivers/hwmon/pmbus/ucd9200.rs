...
//! Source: drivers/hwmon/pmbus/ucd9200.c
#![no_std]
...
pub const UCD9200_PHASE_INFO: c_uint = 0xd2;
pub const UCD9200_DEVICE_ID: c_uint = 0xfd;
...
#[no_mangle]
unsafe extern "C" fn ucd9200_probe(client: *mut i2c_client) -> c_int {
