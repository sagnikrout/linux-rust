...
//! Source: drivers/hwmon/pmbus/mpq8785.c
#![no_std]
...
pub const MPM82504_READ_TEMPERATURE_1_SIGN_POS: c_int = 9;
...
#[no_mangle]
unsafe extern "C" fn mpq8785_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpq8785_probe(client: *mut i2c_client) -> c_int {
