...
//! Source: drivers/hwmon/pmbus/mp2985.c
#![no_std]
...
//
pub const READ_PIN_EST: c_uint = 0x93;
pub const READ_IIN_EST: c_uint = 0x8E;
pub const MFR_VR_MULTI_CONFIG_R1: c_uint = 0x0D;
pub const MFR_VR_MULTI_CONFIG_R2: c_uint = 0x1D;
pub const MP2985_VOUT_DIV: c_int = 64;
pub const MP2985_VOUT_OVUV_UINT: c_int = 125;
pub const MP2985_VOUT_OVUV_DIV: c_int = 64;
pub const MP2985_PAGE_NUM: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mp2985_data {
    pub info: pmbus_driver_info,
    pub vout_scale: [c_int; MP2985_PAGE_NUM],
    pub vid_offset: [c_int; MP2985_PAGE_NUM],
}

#[no_mangle]
unsafe extern "C" fn mp2985_linear_exp_transfer(word: u16, expect_exponent: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn mp2985_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp2985_identify(client: *mut i2c_client, info: *mut pmbus_driver_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp2985_probe(client: *mut i2c_client) -> c_int {
