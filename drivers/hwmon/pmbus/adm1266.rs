...
//! Source: drivers/hwmon/pmbus/adm1266.c
#![no_std]
...
pub const ADM1266_IC_DEVICE_REV: c_uint = 0xAE;
pub const ADM1266_BLACKBOX_CONFIG: c_uint = 0xD3;
pub const ADM1266_PDIO_CONFIG: c_uint = 0xD4;
pub const ADM1266_READ_STATE: c_uint = 0xD9;
pub const ADM1266_READ_BLACKBOX: c_uint = 0xDE;
pub const ADM1266_SET_RTC: c_uint = 0xDF;
pub const ADM1266_GPIO_CONFIG: c_uint = 0xE1;
pub const ADM1266_POWERUP_COUNTER: c_uint = 0xE4;
pub const ADM1266_BLACKBOX_INFO: c_uint = 0xE6;
pub const ADM1266_PDIO_STATUS: c_uint = 0xE9;
pub const ADM1266_GPIO_STATUS: c_uint = 0xEA;
// ADM1266 GPIO defines
pub const ADM1266_GPIO_NR: c_int = 9;

// ADM1266 PDIO defines
pub const ADM1266_PDIO_NR: c_int = 16;

pub const ADM1266_BLACKBOX_OFFSET: c_int = 0;
pub const ADM1266_BLACKBOX_SIZE: c_int = 64;
pub const ADM1266_BLACKBOX_MAX_RECORDS: c_int = 32;
pub const ADM1266_PMBUS_BLOCK_MAX: c_int = 255;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adm1266_data {
    pub info: pmbus_driver_info,
    pub gc: gpio_chip,
    pub ADM1266_PDIO_NR]: *const *const char gpio_names[ADM1266_GPIO_NR +,
    ...
    pub dev_mem: *mut u8,
    pub buf_mutex: mutex,
    pub ____cacheline_aligned: u8 write_buf[ADM1266_PMBUS_BLOCK_MAX + 1],
    pub ____cacheline_aligned: u8 read_buf[ADM1266_PMBUS_BLOCK_MAX + 2],
}
...
#[no_mangle]
unsafe extern "C" fn adm1266_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm1266_gpio_dbg_show(s: *mut seq_file, chip: *mut gpio_chip) {
...
#[no_mangle]
unsafe extern "C" fn adm1266_config_gpio(data: *mut adm1266_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm1266_state_read(s: *mut seq_file, pdata: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adm1266_firmware_revision_read(s: *mut seq_file, pdata: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adm1266_powerup_counter_read(s: *mut seq_file, pdata: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adm1266_rtc_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm1266_rtc_set(data: *mut c_void, val: u64) -> c_int {
    static int adm1266_rtc_set(void *data, u64 val)
    {
    struct i2c_client *client = data;
    let mut kt: time64_t = ktime_get_real_seconds();
    u8 write_buf[6] = { 0 };
    int i;
...
#[no_mangle]
unsafe extern "C" fn adm1266_init_debugfs(data: *mut adm1266_data) {
...
#[no_mangle]
unsafe extern "C" fn adm1266_nvmem_read_blackbox(data: *mut adm1266_data, read_buff: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm1266_nvmem_read(priv: *mut c_void, offset: c_uint, val: *mut c_void, bytes: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm1266_config_nvmem(data: *mut adm1266_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adm1266_probe(client: *mut i2c_client) -> c_int {
