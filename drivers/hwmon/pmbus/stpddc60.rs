...
//! Source: drivers/hwmon/pmbus/stpddc60.c
#![no_std]
...
pub const STPDDC60_MFR_READ_VOUT: c_uint = 0xd2;
pub const STPDDC60_MFR_OV_LIMIT_OFFSET: c_uint = 0xe5;
pub const STPDDC60_MFR_UV_LIMIT_OFFSET: c_uint = 0xe6;
...
//
#[no_mangle]
unsafe extern "C" fn stpddc60_get_offset(vout: c_int, limit: u16, over: bool) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn stpddc60_adjust_linear(word: u16, fixed: i16) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn stpddc60_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stpddc60_probe(client: *mut i2c_client) -> c_int {
