...
//! Source: drivers/hwmon/pmbus/acbel-fsg032.c
#![no_std]
...
pub const ACBEL_MFR_FW_REVISION: c_uint = 0xd9;
...
#[no_mangle]
unsafe extern "C" fn acbel_fsg032_init_debugfs(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn acbel_fsg032_probe(client: *mut i2c_client) -> c_int {
