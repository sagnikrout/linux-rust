...
//! Source: drivers/hwmon/pmbus/isl68137.c
#![no_std]
...
pub const ISL68137_VOUT_AVS: c_uint = 0x30;
pub const RAA_DMPVR2_READ_VMON: c_uint = 0xc8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct isl68137_channel {
    pub vout_voltage_divider: [u32; 2],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct isl68137_data {
    pub info: pmbus_driver_info,
    pub channel: [isl68137_channel; MAX_CHANNELS],
}
...
#[no_mangle]
unsafe extern "C" fn isl68137_probe(client: *mut i2c_client) -> c_int {
