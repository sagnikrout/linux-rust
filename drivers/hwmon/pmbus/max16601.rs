...
//! Source: drivers/hwmon/pmbus/max16601.c
#![no_std]
...
pub const REG_DEFAULT_NUM_POP: c_uint = 0xc4;
pub const REG_SETPT_DVID: c_uint = 0xd1;

pub const REG_IOUT_AVG_PK: c_uint = 0xee;
pub const REG_IIN_SENSOR: c_uint = 0xf1;
pub const REG_TOTAL_INPUT_POWER: c_uint = 0xf2;
pub const REG_PHASE_ID: c_uint = 0xf3;

pub const REG_PHASE_REPORTING: c_uint = 0xf4;
pub const MAX16601_NUM_PHASES: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max16601_data {
    pub id: enum chips,
    pub info: pmbus_driver_info,
    pub vsa: *mut i2c_client,
    pub iout_avg_pkg: c_int,
}

#[no_mangle]
unsafe extern "C" fn max16601_read_byte(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max16601_write_byte(client: *mut i2c_client, page: c_int, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max16601_remove(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn max16601_get_id(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max16601_probe(client: *mut i2c_client) -> c_int {
