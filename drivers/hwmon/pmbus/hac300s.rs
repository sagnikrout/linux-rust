...
//! Source: drivers/hwmon/pmbus/hac300s.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hac300s_data {
    pub info: pmbus_driver_info,
    pub exponent: i8,
}

#[no_mangle]
unsafe extern "C" fn hac300s_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hac300s_probe(client: *mut i2c_client) -> c_int {
