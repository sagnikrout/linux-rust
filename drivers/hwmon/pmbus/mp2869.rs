...
//! Source: drivers/hwmon/pmbus/mp2869.c
#![no_std]
...
pub const MP2869_VIN_OV_FAULT_GAIN: c_int = 4;
pub const MP2869_READ_VOUT_DIV: c_int = 1024;
pub const MP2869_READ_IOUT_DIV: c_int = 32;
pub const MP2869_OVUV_LIMIT_SCALE: c_int = 10;
pub const MP2869_OVUV_DELTA_SCALE: c_int = 50;
pub const MP2869_TEMP_LIMIT_OFFSET: c_int = 40;
pub const MP2869_IOUT_LIMIT_UINT: c_int = 8;
pub const MP2869_POUT_OP_GAIN: c_int = 2;
pub const MP2869_PAGE_NUM: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mp2869_data {
    pub info: pmbus_driver_info,
    pub mfr_thwn_flt_en: bool,
    pub vout_scale: [c_int; MP2869_PAGE_NUM],
    pub iout_scale: [c_int; MP2869_PAGE_NUM],
}
...
#[no_mangle]
unsafe extern "C" fn mp2869_reg2data_linear11(word: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn mp2869_read_byte_data(client: *mut i2c_client, page: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp2869_identify(client: *mut i2c_client, info: *mut pmbus_driver_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp2869_probe(client: *mut i2c_client) -> c_int {
