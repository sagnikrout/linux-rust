...
//! Source: drivers/hwmon/hih6130.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn hih6130_temp_ticks_to_millicelsius(ticks: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hih6130_rh_ticks_to_per_cent_mille(ticks: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hih6130_update_measurements(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hih6130_probe(client: *mut i2c_client) -> c_int {
