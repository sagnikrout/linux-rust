...
//! Source: drivers/hwmon/max6650.c
#![no_std]
...
// clock: The clock frequency of the chip (max6651 can be clocked externally)
    let mut clock: static int = 254000;
...
//
pub const MAX6650_REG_SPEED: c_uint = 0x00;
pub const MAX6650_REG_CONFIG: c_uint = 0x02;
pub const MAX6650_REG_GPIO_DEF: c_uint = 0x04;
pub const MAX6650_REG_DAC: c_uint = 0x06;
pub const MAX6650_REG_ALARM_EN: c_uint = 0x08;
pub const MAX6650_REG_ALARM: c_uint = 0x0A;
pub const MAX6650_REG_TACH0: c_uint = 0x0C;
pub const MAX6650_REG_TACH1: c_uint = 0x0E;
pub const MAX6650_REG_TACH2: c_uint = 0x10;
pub const MAX6650_REG_TACH3: c_uint = 0x12;
pub const MAX6650_REG_GPIO_STAT: c_uint = 0x14;
pub const MAX6650_REG_COUNT: c_uint = 0x16;
//
// Config register bits
//
pub const MAX6650_CFG_V12: c_uint = 0x08;
pub const MAX6650_CFG_PRESCALER_MASK: c_uint = 0x07;
pub const MAX6650_CFG_PRESCALER_2: c_uint = 0x01;
pub const MAX6650_CFG_PRESCALER_4: c_uint = 0x02;
pub const MAX6650_CFG_PRESCALER_8: c_uint = 0x03;
pub const MAX6650_CFG_PRESCALER_16: c_uint = 0x04;
pub const MAX6650_CFG_MODE_MASK: c_uint = 0x30;
pub const MAX6650_CFG_MODE_ON: c_uint = 0x00;
pub const MAX6650_CFG_MODE_OFF: c_uint = 0x10;
pub const MAX6650_CFG_MODE_CLOSED_LOOP: c_uint = 0x20;
pub const MAX6650_CFG_MODE_OPEN_LOOP: c_uint = 0x30;
pub const MAX6650_COUNT_MASK: c_uint = 0x03;
//
// Alarm status register bits
//
pub const MAX6650_ALRM_MAX: c_uint = 0x01;
pub const MAX6650_ALRM_MIN: c_uint = 0x02;
pub const MAX6650_ALRM_TACH: c_uint = 0x04;
pub const MAX6650_ALRM_GPIO1: c_uint = 0x08;
pub const MAX6650_ALRM_GPIO2: c_uint = 0x10;
// Minimum and maximum values of the FAN-RPM
pub const FAN_RPM_MIN: c_int = 240;
pub const FAN_RPM_MAX: c_int = 30000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max6650_data {
    pub client: *mut i2c_client,
    pub /: *mut *mut mutex update_lock; / protect alarm register updates,
    pub nr_fans: c_int,
...
#[no_mangle]
unsafe extern "C" fn dac_to_pwm(dac: c_int, v12: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_to_dac(pwm: c_uint, v12: bool) -> u8 {
    static u8 pwm_to_dac(unsigned int pwm, bool v12)
    {
    let mut limit: c_int = DAC_LIMIT(v12);
...
//
#[no_mangle]
unsafe extern "C" fn max6650_set_operating_mode(data: *mut max6650_data, mode: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn max6650_set_target(data: *mut max6650_data, rpm: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6650_probe(client: *mut i2c_client) -> c_int {
