...
//! Source: drivers/hwmon/sch5627.c
#![no_std]
...
pub const SCH5627_HWMON_ID: c_uint = 0xa5;
pub const SCH5627_COMPANY_ID: c_uint = 0x5c;
pub const SCH5627_PRIMARY_ID: c_uint = 0xa0;
pub const SCH5627_REG_BUILD_CODE: c_uint = 0x39;
pub const SCH5627_REG_BUILD_ID: c_uint = 0x3a;
pub const SCH5627_REG_HWMON_ID: c_uint = 0x3c;
pub const SCH5627_REG_HWMON_REV: c_uint = 0x3d;
pub const SCH5627_REG_COMPANY_ID: c_uint = 0x3e;
pub const SCH5627_REG_PRIMARY_ID: c_uint = 0x3f;
pub const SCH5627_REG_CTRL: c_uint = 0x40;

pub const SCH5627_NO_TEMPS: c_int = 8;
pub const SCH5627_NO_FANS: c_int = 4;
pub const SCH5627_NO_IN: c_int = 5;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sch5627_data {
    pub regmap: *mut regmap,
    pub addr: c_ushort,
    pub control: u8,
    pub update_lock: mutex,
    pub /: *mut *mut unsigned long last_battery; / In jiffies,
    pub /: *mut *mut char temp_valid; / !=0 if following fields are valid,
    pub fan_valid: c_char,
    pub in_valid: c_char,
    pub /: *mut *mut unsigned long temp_last_updated; / In jiffies,
    pub fan_last_updated: c_ulong,
    pub in_last_updated: c_ulong,
    pub temp: [u16; SCH5627_NO_TEMPS],
    pub fan: [u16; SCH5627_NO_FANS],
    pub in: [u16; SCH5627_NO_IN],
}
...
#[no_mangle]
unsafe extern "C" fn sch5627_update_temp(data: *mut sch5627_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sch5627_update_fan(data: *mut sch5627_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sch5627_update_in(data: *mut sch5627_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reg_to_temp(reg: u16) -> c_int {
    static int reg_to_temp(u16 reg)
    {
    return (reg * 625) / 10 - 64000;
    }
#[no_mangle]
unsafe extern "C" fn reg_to_temp_limit(reg: u8) -> c_int {
    static int reg_to_temp_limit(u8 reg)
    {
    return (reg - 64) * 1000;
    }
#[no_mangle]
unsafe extern "C" fn reg_to_rpm(reg: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sch5627_temp_limit_to_reg(value: c_long) -> u8 {
    static u8 sch5627_temp_limit_to_reg(long value)
    {
    let mut limit: c_long = (value / 1000) + 64;
    return clamp_val(limit, 0, U8_MAX);
    }
#[no_mangle]
unsafe extern "C" fn sch5627_rpm_to_reg(value: c_long) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn sch5627_probe(pdev: *mut platform_device) -> c_int {
...
// Trigger a Vbat voltage measurement, so that we get a valid reading
    ...
    &sch5627_chip_info, core::ptr::null_mut());
    if (IS_ERR(hwmon_dev))
...
#[no_mangle]
unsafe extern "C" fn sch5627_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sch5627_resume(dev: *mut device) -> c_int {
