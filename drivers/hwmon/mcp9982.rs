...
//! Source: drivers/hwmon/mcp9982.c
#![no_std]
...
pub const MCP9982_ONE_SHOT_ADDR: c_uint = 0x0A;
pub const MCP9982_INTERNAL_HIGH_LIMIT_ADDR: c_uint = 0x0B;
pub const MCP9982_INTERNAL_LOW_LIMIT_ADDR: c_uint = 0x0C;

pub const MCP9982_CFG_ADDR: c_uint = 0x22;
pub const MCP9982_CONV_ADDR: c_uint = 0x24;
pub const MCP9982_HYS_ADDR: c_uint = 0x25;
pub const MCP9982_CONSEC_ALRT_ADDR: c_uint = 0x26;
pub const MCP9982_ALRT_CFG_ADDR: c_uint = 0x27;
pub const MCP9982_RUNNING_AVG_ADDR: c_uint = 0x28;
pub const MCP9982_HOTTEST_CFG_ADDR: c_uint = 0x29;
pub const MCP9982_STATUS_ADDR: c_uint = 0x2A;
pub const MCP9982_EXT_FAULT_STATUS_ADDR: c_uint = 0x2B;
pub const MCP9982_HIGH_LIMIT_STATUS_ADDR: c_uint = 0x2C;
pub const MCP9982_LOW_LIMIT_STATUS_ADDR: c_uint = 0x2D;
pub const MCP9982_THERM_LIMIT_STATUS_ADDR: c_uint = 0x2E;
pub const MCP9982_HOTTEST_HIGH_BYTE_ADDR: c_uint = 0x2F;
pub const MCP9982_HOTTEST_LOW_BYTE_ADDR: c_uint = 0x30;
pub const MCP9982_HOTTEST_STATUS_ADDR: c_uint = 0x31;
pub const MCP9982_THERM_SHTDWN_CFG_ADDR: c_uint = 0x32;
pub const MCP9982_HRDW_THERM_SHTDWN_LIMIT_ADDR: c_uint = 0x33;

// MCP9982 Bits

// Constants and default values
pub const MCP9982_MAX_NUM_CHANNELS: c_int = 5;
pub const MCP9982_BETA_AUTODETECT: c_int = 16;
pub const MCP9982_IDEALITY_DEFAULT: c_int = 18;
pub const MCP9982_OFFSET: c_int = 64;
pub const MCP9982_DEFAULT_CONSEC_ALRT_VAL: c_int = 112;
pub const MCP9982_DEFAULT_HYS_VAL: c_int = 10;
pub const MCP9982_DEFAULT_CONV_VAL: c_int = 6;
pub const MCP9982_WAKE_UP_TIME_US: c_int = 125000;
pub const MCP9982_WAKE_UP_TIME_MAX_US: c_int = 130000;
pub const MCP9982_HIGH_LIMIT_DEFAULT: c_int = 85000;
pub const MCP9982_LOW_LIMIT_DEFAULT: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp9982_features {
    pub name: *const c_char,
    pub phys_channels: u8,
    pub hw_thermal_shutdown: bool,
    pub allow_apdd: bool,
    pub has_recd34: bool,
}
...
#[no_mangle]
unsafe extern "C" fn mcp9982_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp9982_priv {
    pub regmap: *mut regmap,
    pub chip: *const mcp9982_features,
    pub labels: [*const c_char; MCP9982_MAX_NUM_CHANNELS],
    pub interval_idx: c_uint,
    pub enabled_channel_mask: c_ulong,
    pub num_channels: u8,
    pub recd34_enable: bool,
    pub recd12_enable: bool,
    pub apdd_enable: bool,
    pub run_state: bool,
}

#[no_mangle]
unsafe extern "C" fn mcp9982_read_limit(priv: *mut mcp9982_priv, address: u8, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp9982_write_limit(priv: *mut mcp9982_priv, address: u8, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp9982_write_hyst(priv: *mut mcp9982_priv, channel: c_int, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp9982_init(dev: *mut device, priv: *mut mcp9982_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp9982_parse_fw_config(dev: *mut device, device_nr_channels: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp9982_probe(client: *mut i2c_client) -> c_int {
    ...
    &mcp998x_chip_info, core::ptr::null_mut());
