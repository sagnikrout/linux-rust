...
//! Source: drivers/hwmon/corsair-psu.c
#![no_std]
...
pub const CMD_BUFFER_SIZE: c_int = 64;
pub const CMD_TIMEOUT_MS: c_int = 250;

pub const TEMP_COUNT: c_int = 2;
pub const OCP_MULTI_RAIL: c_uint = 0x02;
pub const PSU_CMD_SELECT_RAIL: c_uint = 0x00 /* expects length 2 */;
pub const PSU_CMD_FAN_PWM: c_uint = 0x3B /* the rest of the commands expect length 3 */;
pub const PSU_CMD_RAIL_VOLTS_HCRIT: c_uint = 0x40;
pub const PSU_CMD_RAIL_VOLTS_LCRIT: c_uint = 0x44;
pub const PSU_CMD_RAIL_AMPS_HCRIT: c_uint = 0x46;
pub const PSU_CMD_TEMP_HCRIT: c_uint = 0x4F;
pub const PSU_CMD_IN_VOLTS: c_uint = 0x88;
pub const PSU_CMD_IN_AMPS: c_uint = 0x89;
pub const PSU_CMD_RAIL_VOLTS: c_uint = 0x8B;
pub const PSU_CMD_RAIL_AMPS: c_uint = 0x8C;
pub const PSU_CMD_TEMP0: c_uint = 0x8D;
pub const PSU_CMD_TEMP1: c_uint = 0x8E;
pub const PSU_CMD_FAN: c_uint = 0x90;
pub const PSU_CMD_RAIL_WATTS: c_uint = 0x96;
pub const PSU_CMD_VEND_STR: c_uint = 0x99;
pub const PSU_CMD_PROD_STR: c_uint = 0x9A;
pub const PSU_CMD_TOTAL_UPTIME: c_uint = 0xD1;
pub const PSU_CMD_UPTIME: c_uint = 0xD2;
pub const PSU_CMD_OCPMODE: c_uint = 0xD8;
pub const PSU_CMD_TOTAL_WATTS: c_uint = 0xEE;
pub const PSU_CMD_FAN_PWM_ENABLE: c_uint = 0xF0;
pub const PSU_CMD_INIT: c_uint = 0xFE;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct corsairpsu_data {
    pub hdev: *mut hid_device,
    pub hwmon_dev: *mut device,
    pub debugfs: *mut dentry,
    pub wait_completion: completion,
    pub cmd_buffer: *mut u8,
    pub vendor: [c_char; REPLY_SIZE],
    pub product: [c_char; REPLY_SIZE],
    pub temp_crit: [c_long; TEMP_COUNT],
    pub in_crit: [c_long; RAIL_COUNT],
    pub in_lcrit: [c_long; RAIL_COUNT],
    pub curr_crit: [c_long; RAIL_COUNT],
    pub temp_crit_support: u8,
    pub in_crit_support: u8,
    pub in_lcrit_support: u8,
    pub curr_crit_support: u8,
    pub /: *mut *mut bool in_curr_cmd_support; / not all commands are supported on every PSU,
}

// some values are SMBus LINEAR11 data which need a conversion
#[no_mangle]
unsafe extern "C" fn corsairpsu_linear11_to_long(val: u16, scale: c_int) -> c_long {
    static long corsairpsu_linear11_to_long(const u16 val, const int scale)
    {
    let mut exp: c_int = ((s16)val) >> 11;
    let mut mant: c_int = ((s16)((val & 0x7ff) << 5)) >> 5;
    let mut result: i64 = mant * scale;
    if (exp >= 0)
    result *= (int)(1UL << exp);
    else
    result >>= -exp;
...
#[no_mangle]
unsafe extern "C" fn corsairpsu_dutycycle_to_pwm(dutycycle: c_long) -> c_int {
    static int corsairpsu_dutycycle_to_pwm(const long dutycycle)
    {
    let mut result: c_int = (256 << 16) / 100;
    return (result * dutycycle) >> 16;
    }
#[no_mangle]
unsafe extern "C" fn corsairpsu_usb_cmd(priv: *mut corsairpsu_data, p0: u8, p1: u8, p2: u8, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn corsairpsu_init(priv: *mut corsairpsu_data) -> c_int {
...
//
    return corsairpsu_usb_cmd(priv, PSU_CMD_INIT, 3, 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn corsairpsu_fwinfo(priv: *mut corsairpsu_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn corsairpsu_request(priv: *mut corsairpsu_data, cmd: u8, rail: u8, data: *mut c_void) -> c_int {
    ...
    ret = corsairpsu_usb_cmd(priv, 2, PSU_CMD_SELECT_RAIL, rail, core::ptr::null_mut());
    if (ret < 0)
    return ret;
    break;
    default:
...
#[no_mangle]
unsafe extern "C" fn corsairpsu_get_value(priv: *mut corsairpsu_data, cmd: u8, rail: u8, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn corsairpsu_get_criticals(priv: *mut corsairpsu_data) {
...
#[no_mangle]
unsafe extern "C" fn corsairpsu_check_cmd_support(priv: *mut corsairpsu_data) {
...
#[no_mangle]
unsafe extern "C" fn corsairpsu_hwmon_pwm_read(priv: *mut corsairpsu_data, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn corsairpsu_hwmon_in_read(priv: *mut corsairpsu_data, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_uptime(seqf: *mut seq_file, cmd: u8) {
...
#[no_mangle]
unsafe extern "C" fn uptime_show(seqf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uptime_total_show(seqf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vendor_show(seqf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn product_show(seqf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocpmode_show(seqf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn corsairpsu_debugfs_init(priv: *mut corsairpsu_data) {
...
#[no_mangle]
unsafe extern "C" fn corsairpsu_probe(hdev: *mut hid_device, id: *const hid_device_id) -> c_int {
    ...
    &corsairpsu_chip_info, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn corsairpsu_remove(hdev: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn corsairpsu_resume(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn corsair_init() -> int __init {
    static int __init corsair_init(void)
    {
    return hid_register_driver(&corsairpsu_driver);
    }
#[no_mangle]
unsafe extern "C" fn corsair_exit() -> void __exit {
