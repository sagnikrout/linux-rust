...
//! Source: drivers/hwmon/qnap-mcu-hwmon.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qnap_mcu_hwmon {
    pub mcu: *mut qnap_mcu,
    pub dev: *mut device,
    pub pwm_min: c_uint,
    pub pwm_max: c_uint,
    pub fan_node: *mut fwnode_handle,
    pub fan_state: c_uint,
    pub fan_max_state: c_uint,
...
#[no_mangle]
unsafe extern "C" fn qnap_mcu_hwmon_get_rpm(hwm: *mut qnap_mcu_hwmon) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qnap_mcu_hwmon_get_pwm(hwm: *mut qnap_mcu_hwmon) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qnap_mcu_hwmon_set_pwm(hwm: *mut qnap_mcu_hwmon, pwm: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qnap_mcu_hwmon_get_temp(hwm: *mut qnap_mcu_hwmon) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_fan_node_release(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qnap_mcu_hwmon_get_cooling_data(dev: *mut device, hwm: *mut qnap_mcu_hwmon) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qnap_mcu_hwmon_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    hwm, &hwm.info, core::ptr::null_mut());
    if (IS_ERR(hwmon))
