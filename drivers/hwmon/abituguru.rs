...
//! Source: drivers/hwmon/abituguru.c
#![no_std]
...
// Banks
pub const ABIT_UGURU_ALARM_BANK: c_uint = 0x20 /* 1x 3 bytes */;
pub const ABIT_UGURU_SENSOR_BANK1: c_uint = 0x21 /* 16x volt and temp */;
pub const ABIT_UGURU_FAN_PWM: c_uint = 0x24 /* 3x 5 bytes */;
pub const ABIT_UGURU_SENSOR_BANK2: c_uint = 0x26 /* fans */;
// max nr of sensors in bank1, a bank1 sensor can be in, temp or nc
pub const ABIT_UGURU_MAX_BANK1_SENSORS: c_int = 16;
//
// Warning if you increase one of the 2 MAX defines below to 10 or higher you
// should adjust the belonging _NAMES_LENGTH macro for the 2 digit number!
//
// max nr of sensors in bank2, currently mb's with max 6 fans are known
pub const ABIT_UGURU_MAX_BANK2_SENSORS: c_int = 6;
// max nr of pwm outputs, currently mb's with max 5 pwm outputs are known
pub const ABIT_UGURU_MAX_PWMS: c_int = 5;
// uGuru sensor bank 1 flags */			     /* Alarm if:
pub const ABIT_UGURU_TEMP_HIGH_ALARM_ENABLE: c_uint = 0x01 /*  temp over warn */;
pub const ABIT_UGURU_VOLT_HIGH_ALARM_ENABLE: c_uint = 0x02 /*  volt over max */;
pub const ABIT_UGURU_VOLT_LOW_ALARM_ENABLE: c_uint = 0x04 /*  volt under min */;
pub const ABIT_UGURU_TEMP_HIGH_ALARM_FLAG: c_uint = 0x10 /* temp is over warn */;
pub const ABIT_UGURU_VOLT_HIGH_ALARM_FLAG: c_uint = 0x20 /* volt is over max */;
pub const ABIT_UGURU_VOLT_LOW_ALARM_FLAG: c_uint = 0x40 /* volt is under min */;
// uGuru sensor bank 2 flags */			     /* Alarm if:
pub const ABIT_UGURU_FAN_LOW_ALARM_ENABLE: c_uint = 0x01 /*   fan under min */;
// uGuru sensor bank common flags
pub const ABIT_UGURU_BEEP_ENABLE: c_uint = 0x08 /* beep if alarm */;
pub const ABIT_UGURU_SHUTDOWN_ENABLE: c_uint = 0x80 /* shutdown if alarm */;
// uGuru fan PWM (speed control) flags
pub const ABIT_UGURU_FAN_PWM_ENABLE: c_uint = 0x80 /* enable speed control */;
// Values used for conversion

// Bank1 sensor types
pub const ABIT_UGURU_IN_SENSOR: c_int = 0;
pub const ABIT_UGURU_TEMP_SENSOR: c_int = 1;
pub const ABIT_UGURU_NC: c_int = 2;
//
// In many cases we need to wait for the uGuru to reach a certain status, most
// of the time it will reach this status within 30 - 90 ISA reads, and thus we
// can best busy wait. This define gives the total amount of reads to try.
//
pub const ABIT_UGURU_WAIT_TIMEOUT: c_int = 125;
//
// However sometimes older versions of the uGuru seem to be distracted and they
// do not respond for a long time. To handle this we sleep before each of the
// last ABIT_UGURU_WAIT_TIMEOUT_SLEEP tries.
//
pub const ABIT_UGURU_WAIT_TIMEOUT_SLEEP: c_int = 5;
//
// Normally all expected status in abituguru_ready, are reported after the
// first read, but sometimes not and we need to poll.
//
pub const ABIT_UGURU_READY_TIMEOUT: c_int = 5;
// Maximum 3 retries on timedout reads/writes, delay 200 ms before retrying
pub const ABIT_UGURU_MAX_RETRIES: c_int = 3;

// Maximum 2 timeouts in abituguru_update_device, iow 3 in a row is an error
pub const ABIT_UGURU_MAX_TIMEOUTS: c_int = 2;
// utility macros
...
pub const ABIT_UGURU_BASE: c_uint = 0x00E0;
// Used to tell uGuru what to read and to read the actual data
pub const ABIT_UGURU_CMD: c_uint = 0x00;
// Mostly used to check if uGuru is busy
pub const ABIT_UGURU_DATA: c_uint = 0x04;
pub const ABIT_UGURU_REGION_LENGTH: c_int = 5;
// uGuru status'
pub const ABIT_UGURU_STATUS_WRITE: c_uint = 0x00 /* Ready to be written */;
pub const ABIT_UGURU_STATUS_READ: c_uint = 0x01 /* Ready to be read */;
pub const ABIT_UGURU_STATUS_INPUT: c_uint = 0x08 /* More input */;
pub const ABIT_UGURU_STATUS_READY: c_uint = 0x09 /* Ready to be written */;
// Constants
...
//
    let mut abituguru_bank2_min_threshold: static u8 = 5;
    let mut abituguru_bank2_max_threshold: static u8 = 50;
//
...
// Insmod parameters
    ...
    module_param_array(bank1_types, int, core::ptr::null_mut(), 0);
...
pub struct abituguru_data {
    ...
    pub /: *mut *mut char uguru_ready; / is the uguru in ready state?,
    pub /*: *mut unsigned char update_timeouts;,
...
//
    ...
    pub 6]: *mut *mut *mut ABIT_UGURU_MAX_BANK2_SENSORS  6 + ABIT_UGURU_MAX_PWMS,
// Buffer to store the dynamically generated sysfs names
    pub sysfs_names: [c_char; ABITUGURU_SYSFS_NAMES_LENGTH],
// Bank 1 data
// number of and addresses of [0] in, [1] temp sensors
    pub bank1_sensors: [u8; 2],
    pub bank1_address: [u8; 2][ABIT_UGURU_MAX_BANK1_SENSORS],
    pub bank1_value: [u8; ABIT_UGURU_MAX_BANK1_SENSORS],
//
// This array holds 3 entries per sensor for the bank 1 sensor settings
// (flags, min, max for voltage / flags, warn, shutdown for temp).
//
    pub bank1_settings: [u8; ABIT_UGURU_MAX_BANK1_SENSORS][3],
//
// Maximum value for each sensor used for scaling in mV/millidegrees
// Celsius.
//
    pub bank1_max_value: [c_int; ABIT_UGURU_MAX_BANK1_SENSORS],
// Bank 2 data, ABIT_UGURU_MAX_BANK2_SENSORS entries for bank2
    pub /: *mut *mut u8 bank2_sensors; / actual number of bank2 sensors found,
    pub bank2_value: [u8; ABIT_UGURU_MAX_BANK2_SENSORS],
    pub /: *mut *mut u8 bank2_settings[ABIT_UGURU_MAX_BANK2_SENSORS][2]; / flags, min,
// Alarms 2 bytes for bank1, 1 byte for bank2
    pub alarms: [u8; 3],
// Fan PWM (speed control) 5 bytes per PWM
    pub /: *mut *mut u8 pwms; / actual number of pwms found,
    pub pwm_settings: [u8; ABIT_UGURU_MAX_PWMS][5],
}
...
#[no_mangle]
unsafe extern "C" fn abituguru_wait(data: *mut abituguru_data, state: u8) -> c_int {
    static int abituguru_wait(struct abituguru_data *data, u8 state)
    {
    let mut timeout: c_int = ABIT_UGURU_WAIT_TIMEOUT;
...
#[no_mangle]
unsafe extern "C" fn abituguru_ready(data: *mut abituguru_data) -> c_int {
    static int abituguru_ready(struct abituguru_data *data)
    {
    let mut timeout: c_int = ABIT_UGURU_READY_TIMEOUT;
    if (data.uguru_ready)
    return 0;
...
//
    let mut report_errors: c_int = retries;
    for (;;) {
//
...
// devattr, const char *buf, size_t count)
    ...
    let mut orig_val: u8 = data.bank1_settings[attr.index][attr.nr];
...
// this check can be done before taking the lock
    ...
    let mut orig_val: u8 = data.bank2_settings[attr.index][attr.nr];
...
// this check needs to be done after taking the lock
    ...
    ret = -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(val: data->pwm_settings[attr->index][attr->nr] !=) -> else {
    let mut orig_val: u8 = data.pwm_settings[attr.index][attr.nr];
...
// Sysfs attr templates, the real entries are generated automatically.
    ...
    {
    SENSOR_ATTR_2(in%d_input, 0444, show_bank1_value, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(in%d_min, 0644, show_bank1_setting,
    store_bank1_setting, 1, 0),
    SENSOR_ATTR_2(in%d_min_alarm, 0444, show_bank1_alarm, core::ptr::null_mut(),
    ABIT_UGURU_VOLT_LOW_ALARM_FLAG, 0),
    SENSOR_ATTR_2(in%d_max, 0644, show_bank1_setting,
    store_bank1_setting, 2, 0),
    SENSOR_ATTR_2(in%d_max_alarm, 0444, show_bank1_alarm, core::ptr::null_mut(),
    ...
    SENSOR_ATTR_2(temp%d_input, 0444, show_bank1_value, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(temp%d_alarm, 0444, show_bank1_alarm, core::ptr::null_mut(),
    ...
    SENSOR_ATTR_2(fan%d_input, 0444, show_bank2_value, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(fan%d_alarm, 0444, show_bank2_alarm, core::ptr::null_mut(), 0, 0),
...
#[no_mangle]
unsafe extern "C" fn abituguru_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abituguru_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn abituguru_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abituguru_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abituguru_detect() -> int __init {
...
//
    let mut cmd_val: u8 = inb_p(ABIT_UGURU_BASE + ABIT_UGURU_CMD);
    let mut data_val: u8 = inb_p(ABIT_UGURU_BASE + ABIT_UGURU_DATA);
...
#[no_mangle]
unsafe extern "C" fn abituguru_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn abituguru_exit() -> void __exit {
