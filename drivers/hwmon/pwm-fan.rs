...
//! Source: drivers/hwmon/pwm-fan.c
#![no_std]
...
pub const MAX_PWM: c_int = 255;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwm_fan_tach {
    pub irq: c_int,
    pub pulses: core::sync::atomic::AtomicI32,
    pub rpm: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwm_fan_ctx {
    pub dev: *mut device,
    pub lock: mutex,
    pub pwm: *mut pwm_device,
    pub pwm_state: pwm_state,
    pub reg_en: *mut regulator,
    pub enable_mode: enum pwm_fan_enable_mode,
    pub regulator_enabled: bool,
    pub enabled: bool,
    pub tach_count: c_int,
    pub tachs: *mut pwm_fan_tach,
    pub pulses_per_revolution: *mut u32,
    pub sample_start: ktime_t,
    pub rpm_timer: timer_list,
    pub pwm_value: c_uint,
    pub pwm_fan_state: c_uint,
    pub pwm_fan_max_state: c_uint,
    pub pwm_fan_cooling_levels: *mut c_uint,
    pub cdev: *mut thermal_cooling_device,
    pub info: hwmon_chip_info,
    pub fan_channel: hwmon_channel_info,
    pub pwm_duty_cycle_from_stopped: u64,
    pub pwm_usec_from_stopped: u32,
    pub pwm_shutdown: u8,
}

// This handler assumes self resetting edge triggered interrupt.
#[no_mangle]
unsafe extern "C" fn pulse_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sample_timer(t: *mut timer_list) {
    static void sample_timer(struct timer_list *t)
    {
    struct pwm_fan_ctx *ctx = timer_container_of(ctx, t, rpm_timer);
    let mut delta: c_uint = ktime_ms_delta(ktime_get(), ctx.sample_start);
    int i;
    if (delta) {
...
#[no_mangle]
unsafe extern "C" fn pwm_fan_switch_power(ctx: *mut pwm_fan_ctx, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_fan_power_on(ctx: *mut pwm_fan_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_fan_power_off(ctx: *mut pwm_fan_ctx, force_disable: bool) -> c_int {
    static int pwm_fan_power_off(struct pwm_fan_ctx *ctx, bool force_disable)
    {
    struct pwm_state *state = &ctx.pwm_state;
    let mut enable_regulator: bool = false;
    int ret;
    if (!ctx.enabled)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn __set_pwm(ctx: *mut pwm_fan_ctx, pwm: c_ulong) -> c_int {
    static int  __set_pwm(struct pwm_fan_ctx *ctx, unsigned long pwm)
    {
    struct pwm_state *state = &ctx.pwm_state;
    let mut final_pwm: c_ulong = pwm;
...
#[no_mangle]
unsafe extern "C" fn set_pwm(ctx: *mut pwm_fan_ctx, pwm: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_fan_update_state(ctx: *mut pwm_fan_ctx, pwm: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn pwm_fan_update_enable(ctx: *mut pwm_fan_ctx, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_fan_get_cooling_data(dev: *mut device, ctx: *mut pwm_fan_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_fan_cleanup(__ctx: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pwm_fan_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut pwm_shutdown_percent: u32 = 0;
    ...
    mutex_init(&ctx.lock);
    ctx.dev = &pdev.dev;
    ctx.pwm = devm_pwm_get(dev, core::ptr::null_mut());
    if (IS_ERR(ctx.pwm))
...
// Setup default pulses per revolution
    ...
    ctx, &ctx.info, core::ptr::null_mut());
    if (IS_ERR(hwmon)) {
...
#[no_mangle]
unsafe extern "C" fn pwm_fan_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn pwm_fan_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_fan_resume(dev: *mut device) -> c_int {
