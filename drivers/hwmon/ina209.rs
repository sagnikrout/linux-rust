...
pub const INA209_CONFIGURATION: c_uint = 0x00;
pub const INA209_STATUS: c_uint = 0x01;
pub const INA209_STATUS_MASK: c_uint = 0x02;
pub const INA209_SHUNT_VOLTAGE: c_uint = 0x03;
pub const INA209_BUS_VOLTAGE: c_uint = 0x04;
pub const INA209_POWER: c_uint = 0x05;
pub const INA209_CURRENT: c_uint = 0x06;
pub const INA209_SHUNT_VOLTAGE_POS_PEAK: c_uint = 0x07;
pub const INA209_SHUNT_VOLTAGE_NEG_PEAK: c_uint = 0x08;
pub const INA209_BUS_VOLTAGE_MAX_PEAK: c_uint = 0x09;
pub const INA209_BUS_VOLTAGE_MIN_PEAK: c_uint = 0x0a;
pub const INA209_POWER_PEAK: c_uint = 0x0b;
pub const INA209_SHUNT_VOLTAGE_POS_WARN: c_uint = 0x0c;
pub const INA209_SHUNT_VOLTAGE_NEG_WARN: c_uint = 0x0d;
pub const INA209_POWER_WARN: c_uint = 0x0e;
pub const INA209_BUS_VOLTAGE_OVER_WARN: c_uint = 0x0f;
pub const INA209_BUS_VOLTAGE_UNDER_WARN: c_uint = 0x10;
pub const INA209_POWER_OVER_LIMIT: c_uint = 0x11;
pub const INA209_BUS_VOLTAGE_OVER_LIMIT: c_uint = 0x12;
pub const INA209_BUS_VOLTAGE_UNDER_LIMIT: c_uint = 0x13;
pub const INA209_CRITICAL_DAC_POS: c_uint = 0x14;
pub const INA209_CRITICAL_DAC_NEG: c_uint = 0x15;
pub const INA209_CALIBRATION: c_uint = 0x16;
pub const INA209_REGISTERS: c_uint = 0x17;
pub const INA209_CONFIG_DEFAULT: c_uint = 0x3c47	/* PGA=8, full range */;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ina209_data {
    pub client: *mut i2c_client,
    pub update_lock: mutex,
    pub valid: bool,
    pub /: *mut *mut unsigned long last_updated; / in jiffies,
    pub /: *mut *mut u16 regs[INA209_REGISTERS]; / All chip registers,
    pub /: *mut *mut u16 config_orig; / Original configuration,
    pub /: *mut *mut u16 calibration_orig; / Original calibration,
...
//
#[no_mangle]
unsafe extern "C" fn ina209_from_reg(reg: u8, val: u16) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn ina209_to_reg(reg: u8, old: u16, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina209_interval_from_reg(reg: u16) -> c_int {
    static int ina209_interval_from_reg(u16 reg)
    {
    return 68 >> (15 - ((reg >> 3) & 0x0f));
    }
#[no_mangle]
unsafe extern "C" fn ina209_reg_from_interval(config: u16, interval: c_long) -> u16 {
...
//
    ...
    struct sensor_device_attribute *attr = to_sensor_dev_attr(da);
    struct ina209_data *data = ina209_update_device(dev);
    let mut mask: c_uint = attr.index;
    u16 status;
    if (IS_ERR(data))
    return PTR_ERR(data);
...
#[no_mangle]
unsafe extern "C" fn ina209_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ina209_remove(client: *mut i2c_client) {
