...
//! Source: drivers/hwmon/ltc4283.c
#![no_std]
...
pub const LTC4283_SYSTEM_STATUS: c_uint = 0x00;
pub const LTC4283_FAULT_STATUS: c_uint = 0x03;

pub const LTC4283_FAULT_LOG: c_uint = 0x04;

pub const LTC4283_ADC_ALM_LOG_1: c_uint = 0x05;

pub const LTC4283_ADC_ALM_LOG_2: c_uint = 0x06;
pub const LTC4283_ADC_ALM_LOG_3: c_uint = 0x07;
pub const LTC4283_ADC_ALM_LOG_4: c_uint = 0x08;
pub const LTC4283_ADC_ALM_LOG_5: c_uint = 0x09;
pub const LTC4283_CONTROL_1: c_uint = 0x0a;

pub const LTC4283_CONTROL_2: c_uint = 0x0b;

pub const LTC4283_RESERVED_OC: c_uint = 0x0c;
pub const LTC4283_CONFIG_1: c_uint = 0x0d;

pub const LTC4283_CONFIG_2: c_uint = 0x0e;

pub const LTC4283_CONFIG_3: c_uint = 0x0f;

pub const LTC4283_PGIO_CONFIG: c_uint = 0x10;

pub const LTC4283_PGIO_CONFIG_2: c_uint = 0x11;

pub const LTC4283_SENSE_MIN_TH: c_uint = 0x1b;
pub const LTC4283_SENSE_MAX_TH: c_uint = 0x1c;
pub const LTC4283_VPWR_MIN_TH: c_uint = 0x1d;
pub const LTC4283_VPWR_MAX_TH: c_uint = 0x1e;
pub const LTC4283_POWER_MIN_TH: c_uint = 0x1f;
pub const LTC4283_POWER_MAX_TH: c_uint = 0x20;

pub const LTC4283_SENSE: c_uint = 0x41;
pub const LTC4283_SENSE_MIN: c_uint = 0x42;
pub const LTC4283_SENSE_MAX: c_uint = 0x43;
pub const LTC4283_VPWR: c_uint = 0x44;
pub const LTC4283_VPWR_MIN: c_uint = 0x45;
pub const LTC4283_VPWR_MAX: c_uint = 0x46;
pub const LTC4283_POWER: c_uint = 0x47;
pub const LTC4283_POWER_MIN: c_uint = 0x48;
pub const LTC4283_POWER_MAX: c_uint = 0x49;
pub const LTC4283_RESERVED_68: c_uint = 0x68;
pub const LTC4283_RESERVED_6D: c_uint = 0x6D;
// get channels from ADC 2

pub const LTC4283_ENERGY: c_uint = 0x7a;
pub const LTC4283_METER_CONTROL: c_uint = 0x84;

pub const LTC4283_RESERVED_86: c_uint = 0x86;
pub const LTC4283_RESERVED_8F: c_uint = 0x8F;
pub const LTC4283_FAULT_LOG_CTRL: c_uint = 0x90;

pub const LTC4283_RESERVED_91: c_uint = 0x91;
pub const LTC4283_RESERVED_A1: c_uint = 0xA1;
pub const LTC4283_RESERVED_A3: c_uint = 0xA3;
pub const LTC4283_RESERVED_AC: c_uint = 0xAC;
pub const LTC4283_POWER_PLAY_MSB: c_uint = 0xE7;
pub const LTC4283_POWER_PLAY_LSB: c_uint = 0xE8;
pub const LTC4283_RESERVED_F1: c_uint = 0xF1;
pub const LTC4283_RESERVED_FF: c_uint = 0xFF;
// also applies for differential channels
pub const LTC4283_ADC1_FS_uV: c_int = 32768;
pub const LTC4283_ADC2_FS_mV: c_int = 2048;
pub const LTC4283_TCONV_uS: c_int = 64103;
pub const LTC4283_VILIM_MIN_uV: c_int = 15000;
pub const LTC4283_VILIM_MAX_uV: c_int = 30000;

    (LTC4283_VILIM_MAX_uV - LTC4283_VILIM_MIN_uV + 1)
pub const LTC4283_PGIO_FUNC_GPIO: c_int = 2;
pub const LTC4283_PGIO2_FUNC_ACLB: c_int = 3;
//
...
//
pub const LTC4283_MAX_RSENSE: c_int = 1677721599;
pub const LTC4283_MIN_RSENSE: c_int = 50000;
// voltage channels
    enum {
    LTC4283_CHAN_VIN,
    LTC4283_CHAN_VPWR,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltc4283_hwmon {
    pub map: *mut regmap,
    pub client: *mut i2c_client,
    pub gpio_mask: c_ulong,
    pub ch_enable_mask: c_ulong,
// in microwatt
    pub power_max: c_ulong,
// in millivolt
    pub vsense_max: u32,
...
#[no_mangle]
unsafe extern "C" fn ltc4283_in_reg(attr: u32, channel: u32) -> u32 {
    ...
    {
    let mut reg: u32 = ltc4283_in_reg(attr, channel);
    int ret;
...
// If not status/fault logs, clear the alarm after reading it.
    ...
    let mut bit: u32 = (channel - LTC4283_CHAN_ADI_1) * 2;
//
...
//
    ...
    let mut bit: u32 = (channel - LTC4283_CHAN_ADIO_1) * 2;
    return ltc4283_read_alarm(st, LTC4283_ADC_ALM_LOG_3,
    BIT(7 - bit - !max_alm), val);
    }
    if (channel >= LTC4283_CHAN_ADIN12 && channel <= LTC4283_CHAN_ADIO34) {
    let mut bit: u32 = (channel - LTC4283_CHAN_ADIN12) * 2;
...
// val = test_bit(channel, &st->ch_enable_mask);
    ...
    long *val)
    {
    let mut temp: u64 = (u64)LTC4283_ADC1_FS_uV * DECA * MILLI;
    unsigned int __raw;
    int ret;
    ret = regmap_read(st.map, reg, &__raw);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn ltc4283_read_curr(st: *mut ltc4283_hwmon, attr: u32, val: *mut c_long) -> c_int {
    ...
    u32 reg, long *val)
    {
    let mut temp: u64 = (u64)LTC4283_ADC1_FS_uV * LTC4283_ADC2_FS_mV * DECA * MILLI;
    unsigned int __raw;
    int ret;
    ret = regmap_read(st.map, reg, &__raw);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn ltc4283_read_power(st: *mut ltc4283_hwmon, attr: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_read_energy(st: *mut ltc4283_hwmon, attr: u32, val: *mut i64) -> c_int {
    static int ltc4283_read_energy(struct ltc4283_hwmon *st, u32 attr, s64 *val)
    {
    let mut temp: u64 = LTC4283_ADC1_FS_uV * LTC4283_ADC2_FS_mV, energy;
    u8 raw[8] = {};
    int ret;
    if (!st.energy_en)
    return -ENODATA;
...
// val = st->energy_en;
    ...
    {
    let mut divisor: u64 = (u64)LTC4283_ADC1_FS_uV * LTC4283_ADC2_FS_mV * DECA * MILLI;
    u16 __raw;
    __raw = mul_u64_u64_div_u64(val, st.rsense * BIT_ULL(16), divisor);
    return regmap_write(st.map, reg, __raw);
    }
#[no_mangle]
unsafe extern "C" fn ltc4283_reset_power_hist(st: *mut ltc4283_hwmon) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_write_power(st: *mut ltc4283_hwmon, attr: u32, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_reset_in_hist(st: *mut ltc4283_hwmon, channel: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_write_in_en(st: *mut ltc4283_hwmon, channel: u32, en: bool) -> c_int {
    ...
    let mut reg: c_uint = LTC4283_ADC_SELECT(adc_idx);
    int ret;
...
// Clamp before multiplying to avoid overflow on any arch.
    ...
    u32 reg, long val)
    {
    let mut temp: u32 = LTC4283_ADC1_FS_uV * DECA * MILLI;
...
#[no_mangle]
unsafe extern "C" fn ltc4283_write_curr_history(st: *mut ltc4283_hwmon) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_write_curr(st: *mut ltc4283_hwmon, attr: u32, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_energy_enable_set(st: *mut ltc4283_hwmon, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_curr_is_visible(attr: u32) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_power_is_visible(attr: u32) -> umode_t {
...
//
#[no_mangle]
unsafe extern "C" fn ltc4283_set_max_limits(st: *mut ltc4283_hwmon, dev: *mut device) -> c_int {
    static int ltc4283_set_max_limits(struct ltc4283_hwmon *st, struct device *dev)
    {
    let mut temp: u32 = st.vsense_max * DECA * MICRO;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ltc4283_get_defaults(st: *mut ltc4283_hwmon) -> c_int {
...
// VPWR and VIN are always enabled
    ...
    let mut chan: u32 = c - LTC4283_CHAN_ADI_1, bit;
...
#[no_mangle]
unsafe extern "C" fn ltc4283_pgio_config(st: *mut ltc4283_hwmon, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_pin_config(st: *mut ltc4283_hwmon, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_setup(st: *mut ltc4283_hwmon, dev: *mut device) -> c_int {
...
// We still want to catch when an invalid string is given.
    ...
    let mut chan: u32 = LTC4283_CHAN_DRNS - LTC4283_CHAN_ADI_1;
...
#[no_mangle]
unsafe extern "C" fn ltc4283_show_fault_log(arg: *mut c_void, val: *mut u64, mask: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_show_in0_lcrit_fault_log(arg: *mut c_void, val: *mut u64) -> c_int {
    ...
    ltc4283_show_in0_lcrit_fault_log, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn ltc4283_show_in0_crit_fault_log(arg: *mut c_void, val: *mut u64) -> c_int {
    ...
    ltc4283_show_in0_crit_fault_log, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn ltc4283_show_fet_bad_fault_log(arg: *mut c_void, val: *mut u64) -> c_int {
    ...
    ltc4283_show_fet_bad_fault_log, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn ltc4283_show_fet_short_fault_log(arg: *mut c_void, val: *mut u64) -> c_int {
    ...
    ltc4283_show_fet_short_fault_log, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn ltc4283_show_curr1_crit_fault_log(arg: *mut c_void, val: *mut u64) -> c_int {
    ...
    ltc4283_show_curr1_crit_fault_log, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn ltc4283_show_power1_failed_fault_log(arg: *mut c_void, val: *mut u64) -> c_int {
    ...
    ltc4283_show_power1_failed_fault_log, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn ltc4283_show_power1_good_input_fault_log(arg: *mut c_void, val: *mut u64) -> c_int {
    ...
    ltc4283_show_power1_good_input_fault_log, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn ltc4283_debugfs_init(st: *mut ltc4283_hwmon, i2c: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_is_word_reg(reg: c_uint) -> bool {
    static bool ltc4283_is_word_reg(unsigned int reg)
    {
    return reg >= LTC4283_SENSE && reg <= LTC4283_ADIO34_MAX;
    }
#[no_mangle]
unsafe extern "C" fn ltc4283_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_writable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ltc4283_probe(client: *mut i2c_client) -> c_int {
    ...
    &ltc4283_chip_info, core::ptr::null_mut());
    if (IS_ERR(hwmon))
