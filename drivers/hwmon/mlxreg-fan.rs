...
//! Source: drivers/hwmon/mlxreg-fan.c
#![no_std]
...
pub const MLXREG_FAN_MAX_TACHO: c_int = 24;
pub const MLXREG_FAN_MAX_PWM: c_int = 4;
pub const MLXREG_FAN_PWM_NOT_CONNECTED: c_uint = 0xff;
pub const MLXREG_FAN_MAX_STATE: c_int = 10;

pub const MLXREG_FAN_TACHO_SAMPLES_PER_PULSE_DEF: c_int = 44;
pub const MLXREG_FAN_TACHO_DIV_MIN: c_int = 283;

pub const MLXREG_FAN_TACHO_DIV_SCALE_MAX: c_int = 64;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxreg_fan_pwm {
    pub fan: *mut mlxreg_fan,
    pub connected: bool,
    pub reg: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxreg_fan {
    pub dev: *mut device,
    pub regmap: *mut c_void,
    pub pdata: *mut mlxreg_core_platform_data,
    pub tacho: [mlxreg_fan_tacho; MLXREG_FAN_MAX_TACHO],
    pub pwm: [mlxreg_fan_pwm; MLXREG_FAN_MAX_PWM],
    pub tachos_per_drwr: c_int,
    pub samples: c_int,
    pub divider: c_int,
}
...
//
    ...
    {
    let mut tacho_num: c_int = 0, tacho_avail = 0, pwm_num = 0, i;
...
#[no_mangle]
unsafe extern "C" fn mlxreg_fan_cooling_config(dev: *mut device, fan: *mut mlxreg_fan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxreg_fan_probe(pdev: *mut platform_device) -> c_int {
