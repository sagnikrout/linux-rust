...
//! Source: drivers/hwmon/nct6694-hwmon.c
#![no_std]
...
//
pub const NCT6694_RPT_MOD: c_uint = 0xFF;
// Report channel
//
...
//
pub const NCT6694_HWMON_MOD: c_uint = 0x00;
// Command 00h - Hardware Monitor Control
pub const NCT6694_HWMON_CONTROL: c_uint = 0x00;
pub const NCT6694_HWMON_CONTROL_SEL: c_uint = 0x00;
// Command 02h - Alarm Control
pub const NCT6694_HWMON_ALARM: c_uint = 0x02;
pub const NCT6694_HWMON_ALARM_SEL: c_uint = 0x00;
//
// USB command module type for NCT6694 PWM controller.
// This defines the module type used for communication with the NCT6694
// PWM controller over the USB interface.
//
pub const NCT6694_PWM_MOD: c_uint = 0x01;
// PWM Command - Manual Control
pub const NCT6694_PWM_CONTROL: c_uint = 0x01;
pub const NCT6694_PWM_CONTROL_SEL: c_uint = 0x00;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nct6694_hwmon_data {
    pub nct6694: *mut nct6694,
    pub lock: mutex,
    pub hwmon_en: nct6694_hwmon_control,
    pub rpt: *mut union nct6694_hwmon_rpt,
    pub msg: *mut union nct6694_hwmon_msg,
}
...
#[no_mangle]
unsafe extern "C" fn nct6694_hwmon_init(data: *mut nct6694_hwmon_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6694_hwmon_probe(pdev: *mut platform_device) -> c_int {
