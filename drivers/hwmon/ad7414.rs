...
// AD7414 registers
pub const AD7414_REG_TEMP: c_uint = 0x00;
pub const AD7414_REG_CONF: c_uint = 0x01;
pub const AD7414_REG_T_HIGH: c_uint = 0x02;
pub const AD7414_REG_T_LOW: c_uint = 0x03;
    static u8 AD7414_REG_LIMIT[] = { AD7414_REG_T_HIGH, AD7414_REG_T_LOW };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ad7414_data {
    ...
    pub /: *mut *mut s16 temp_input; / Register values,
    pub temps: [i8; ARRAY_SIZE(AD7414_REG_LIMIT)],
}

// REG: (0.25C/bit, two's complement) << 6
#[no_mangle]
pub unsafe extern "C" fn ad7414_temp_from_reg(reg: i16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ad7414_read(client: *mut i2c_client, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ad7414_write(client: *mut i2c_client, reg: u8, value: u8) -> c_int {
    ...
    struct i2c_client *client = data.client;
    let mut index: c_int = to_sensor_dev_attr(attr).index;
    let mut reg: u8 = AD7414_REG_LIMIT[index];
    long temp;
    ...
    struct ad7414_data *data = ad7414_update_device(dev);
    let mut value: c_int = (data.temp_input >> bitnr) & 1;
    return sprintf(buf, "%d\n", value);
    }
...
#[no_mangle]
unsafe extern "C" fn ad7414_probe(client: *mut i2c_client) -> c_int {
