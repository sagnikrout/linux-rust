...
//! Source: drivers/hwmon/ltc2990.c
#![no_std]
...
pub const LTC2990_STATUS: c_uint = 0x00;
pub const LTC2990_CONTROL: c_uint = 0x01;
pub const LTC2990_TRIGGER: c_uint = 0x02;
pub const LTC2990_TINT_MSB: c_uint = 0x04;
pub const LTC2990_V1_MSB: c_uint = 0x06;
pub const LTC2990_V2_MSB: c_uint = 0x08;
pub const LTC2990_V3_MSB: c_uint = 0x0A;
pub const LTC2990_V4_MSB: c_uint = 0x0C;
pub const LTC2990_VCC_MSB: c_uint = 0x0E;

pub const LTC2990_NONE: c_int = 0;

pub const LTC2990_MODE0_SHIFT: c_int = 0;

pub const LTC2990_MODE1_SHIFT: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn ltc2990_get_value(i2c: *mut i2c_client, index: c_int, result: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2990_i2c_probe(i2c: *mut i2c_client) -> c_int {
