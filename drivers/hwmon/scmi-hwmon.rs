...
//! Source: drivers/hwmon/scmi-hwmon.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_sensors {
    pub ph: *const scmi_protocol_handle,
    pub info: [*const scmi_sensor_info; hwmon_max],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_thermal_sensor {
    pub ph: *const scmi_protocol_handle,
    pub info: *const scmi_sensor_info,
}

#[no_mangle]
pub unsafe extern "C" fn __pow10(x: u8) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn scmi_hwmon_scale(sensor: *const scmi_sensor_info, value: *mut u64) -> c_int {
    static int scmi_hwmon_scale(const struct scmi_sensor_info *sensor, u64 *value)
    {
    let mut scale: c_int = sensor.scale;
    u64 f;
    switch (sensor.type) {
    case TEMPERATURE_C:
    case VOLTAGE:
...
#[no_mangle]
unsafe extern "C" fn scmi_hwmon_probe(sdev: *mut scmi_device) -> c_int {
