...
//! Source: drivers/hwmon/w83791d.c
#![no_std]
...
pub const NUMBER_OF_VIN: c_int = 10;
pub const NUMBER_OF_FANIN: c_int = 5;
pub const NUMBER_OF_TEMPIN: c_int = 3;
pub const NUMBER_OF_PWM: c_int = 5;
// Addresses to scan
...
pub const W83791D_REG_BANK: c_uint = 0x4E;
pub const W83791D_REG_TEMP2_CONFIG: c_uint = 0xC2;
pub const W83791D_REG_TEMP3_CONFIG: c_uint = 0xCA;
...
pub const W83791D_REG_BEEP_CONFIG: c_uint = 0x4D;
...
pub const W83791D_REG_GPIO: c_uint = 0x15;
pub const W83791D_REG_CONFIG: c_uint = 0x40;
pub const W83791D_REG_VID_FANDIV: c_uint = 0x47;
pub const W83791D_REG_DID_VID4: c_uint = 0x49;
pub const W83791D_REG_WCHIPID: c_uint = 0x58;
pub const W83791D_REG_CHIPMAN: c_uint = 0x4F;
pub const W83791D_REG_PIN: c_uint = 0x4B;
pub const W83791D_REG_I2C_SUBADDR: c_uint = 0x4A;
pub const W83791D_REG_ALARM1: c_uint = 0xA9	/* realtime status register1 */;
pub const W83791D_REG_ALARM2: c_uint = 0xAA	/* realtime status register2 */;
pub const W83791D_REG_ALARM3: c_uint = 0xAB	/* realtime status register3 */;
pub const W83791D_REG_VBAT: c_uint = 0x5D;
pub const W83791D_REG_I2C_ADDR: c_uint = 0x48;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn w83791d_read(client: *mut i2c_client, reg: u8) -> c_int {
    static inline int w83791d_read(struct i2c_client *client, u8 reg)
    {
    return i2c_smbus_read_byte_data(client, reg);
    }
#[no_mangle]
pub unsafe extern "C" fn w83791d_write(client: *mut i2c_client, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan_from_reg(val: c_int, div: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn div_to_reg(nr: c_int, val: c_long) -> u8 {
...
// volts
    pub /: *mut *mut u8 in[NUMBER_OF_VIN]; / Register value,
    pub /: *mut *mut u8 in_max[NUMBER_OF_VIN]; / Register value,
    pub /: *mut *mut u8 in_min[NUMBER_OF_VIN]; / Register value,
// fans
    pub /: *mut *mut u8 fan[NUMBER_OF_FANIN]; / Register value,
    pub /: *mut *mut u8 fan_min[NUMBER_OF_FANIN]; / Register value,
    pub /: *mut *mut u8 fan_div[NUMBER_OF_FANIN]; / Register encoding, shifted right,
// Temperature sensors
    pub /: *mut *mut s8 temp1[3]; / current, over, thyst,
    pub the: *mut *mut s16 temp_add[2][3]; / fixed point value. Top 8 bits are,
...
//
// PWMs
    pub /: *mut *mut u8 pwm[5]; / pwm duty cycle,
    pub 1-3: *mut *mut u8 pwm_enable[3]; / pwm enable status for fan,
// (fan 4-5 only support manual mode)
//
    pub /: *mut *mut u8 temp_target[3]; / pwm 1-3 target temperature,
    pub /: *mut *mut u8 temp_tolerance[3]; / pwm 1-3 temperature tolerance,
// Misc
    pub /: *mut *mut u32 alarms; / realtime status register encoding,combined,
    pub /: *mut *mut u8 beep_enable; / Global beep enable,
    pub /: *mut *mut u32 beep_mask; / Mask off specific beeps,
    pub /: *mut *mut u8 vid; / Register encoding, combined,
    pub /: *mut *mut u8 vrm; / hwmon-vid,
}
...
// following are the sysfs callback functions
    ...
    SENSOR_ATTR(in0_input, S_IRUGO, show_in, core::ptr::null_mut(), 0),
    SENSOR_ATTR(in1_input, S_IRUGO, show_in, core::ptr::null_mut(), 1),
    SENSOR_ATTR(in2_input, S_IRUGO, show_in, core::ptr::null_mut(), 2),
    SENSOR_ATTR(in3_input, S_IRUGO, show_in, core::ptr::null_mut(), 3),
    SENSOR_ATTR(in4_input, S_IRUGO, show_in, core::ptr::null_mut(), 4),
    SENSOR_ATTR(in5_input, S_IRUGO, show_in, core::ptr::null_mut(), 5),
    SENSOR_ATTR(in6_input, S_IRUGO, show_in, core::ptr::null_mut(), 6),
    SENSOR_ATTR(in7_input, S_IRUGO, show_in, core::ptr::null_mut(), 7),
    SENSOR_ATTR(in8_input, S_IRUGO, show_in, core::ptr::null_mut(), 8),
    SENSOR_ATTR(in9_input, S_IRUGO, show_in, core::ptr::null_mut(), 9),
    };
    ...
    to_sensor_dev_attr(attr);
    struct w83791d_data *data = w83791d_update_device(dev);
    let mut bitnr: c_int = sensor_attr.index;
...
//
    ...
    SENSOR_ATTR(in0_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 0),
    SENSOR_ATTR(in1_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 1),
    SENSOR_ATTR(in2_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 2),
    SENSOR_ATTR(in3_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 3),
    SENSOR_ATTR(in4_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 8),
    SENSOR_ATTR(in5_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 9),
    SENSOR_ATTR(in6_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 10),
    SENSOR_ATTR(in7_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 19),
    SENSOR_ATTR(in8_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 20),
    SENSOR_ATTR(in9_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 14),
    };
...
//
    ...
    let mut keep_mask: u8 = 0;
    let mut new_shift: u8 = 0;
    unsigned long val;
    int err;
    err = kstrtoul(buf, 10, &val);
    if (err)
...
// Restore fan_min
    ...
    SENSOR_ATTR(fan1_input, S_IRUGO, show_fan, core::ptr::null_mut(), 0),
    SENSOR_ATTR(fan2_input, S_IRUGO, show_fan, core::ptr::null_mut(), 1),
    SENSOR_ATTR(fan3_input, S_IRUGO, show_fan, core::ptr::null_mut(), 2),
    SENSOR_ATTR(fan4_input, S_IRUGO, show_fan, core::ptr::null_mut(), 3),
    SENSOR_ATTR(fan5_input, S_IRUGO, show_fan, core::ptr::null_mut(), 4),
    };
    ...
    SENSOR_ATTR(fan1_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 6),
    SENSOR_ATTR(fan2_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 7),
    SENSOR_ATTR(fan3_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 11),
    SENSOR_ATTR(fan4_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 21),
    SENSOR_ATTR(fan5_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 22),
    };
// read/write PWMs
    ...
    unsigned long val;
    u8 reg_cfg_tmp;
    let mut reg_idx: u8 = 0;
    let mut val_shift: u8 = 0;
    let mut keep_mask: u8 = 0;
    let mut ret: c_int = kstrtoul(buf, 10, &val);
    if (ret || val < 1 || val > 3)
    return -EINVAL;
    mutex_lock(&data.update_lock);
...
// read/write temperature2-3, includes measured value and limits
    ...
    SENSOR_ATTR_2(temp1_input, S_IRUGO, show_temp1, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(temp2_input, S_IRUGO, show_temp23, core::ptr::null_mut(), 0, 0),
    SENSOR_ATTR_2(temp3_input, S_IRUGO, show_temp23, core::ptr::null_mut(), 1, 0),
    };
...
//
    ...
    SENSOR_ATTR(temp1_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 4),
    SENSOR_ATTR(temp2_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 5),
    SENSOR_ATTR(temp3_alarm, S_IRUGO, show_alarm, core::ptr::null_mut(), 13),
    };
...
// Beep control
pub const GLOBAL_BEEP_ENABLE_SHIFT: c_int = 15;
...
#[no_mangle]
unsafe extern "C" fn w83791d_detect_subclients(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w83791d_probe(client: *mut i2c_client) -> c_int {
    static int w83791d_probe(struct i2c_client *client)
    {
...
#[no_mangle]
unsafe extern "C" fn w83791d_remove(client: *mut i2c_client) {
    static void w83791d_remove(struct i2c_client *client)
    {
    struct w83791d_data *data = i2c_get_clientdata(client);
...
#[no_mangle]
unsafe extern "C" fn w83791d_init_client(client: *mut i2c_client) {
    static void w83791d_init_client(struct i2c_client *client)
    {
    struct w83791d_data *data = i2c_get_clientdata(client);
    u8 tmp;
...
#[no_mangle]
unsafe extern "C" fn w83791d_print_debug(data: *mut w83791d_data, dev: *mut device) {
    static void w83791d_print_debug(struct w83791d_data *data, struct device *dev)
    {
