...
//! Source: drivers/hwmon/dell-smm-hwmon.c
#![no_std]
...
pub const I8K_SMM_FN_STATUS: c_uint = 0x0025;
pub const I8K_SMM_POWER_STATUS: c_uint = 0x0069;
pub const I8K_SMM_SET_FAN: c_uint = 0x01a3;
pub const I8K_SMM_GET_FAN: c_uint = 0x00a3;
pub const I8K_SMM_GET_SPEED: c_uint = 0x02a3;
pub const I8K_SMM_GET_FAN_TYPE: c_uint = 0x03a3;
pub const I8K_SMM_GET_NOM_SPEED: c_uint = 0x04a3;
pub const I8K_SMM_GET_TEMP: c_uint = 0x10a3;
pub const I8K_SMM_GET_TEMP_TYPE: c_uint = 0x11a3;
pub const I8K_SMM_GET_DELL_SIG1: c_uint = 0xfea3;
pub const I8K_SMM_GET_DELL_SIG2: c_uint = 0xffa3;
// in usecs
pub const DELL_SMM_MAX_DURATION: c_int = 250000;
pub const I8K_FAN_MULT: c_int = 30;
pub const I8K_FAN_RPM_THRESHOLD: c_int = 1000;
pub const I8K_MAX_TEMP: c_int = 127;
pub const I8K_FN_NONE: c_uint = 0x00;
pub const I8K_FN_UP: c_uint = 0x01;
pub const I8K_FN_DOWN: c_uint = 0x02;
pub const I8K_FN_MUTE: c_uint = 0x04;
pub const I8K_FN_MASK: c_uint = 0x07;
pub const I8K_FN_SHIFT: c_int = 8;
pub const I8K_POWER_AC: c_uint = 0x05;
pub const I8K_POWER_BATTERY: c_uint = 0x01;

pub const DELL_SMM_LEGACY_EXECUTE: c_uint = 0x1;
pub const DELL_SMM_NO_TEMP: c_int = 10;
pub const DELL_SMM_NO_FANS: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dell_smm_ops {
    pub smm_dev: *mut device,
    pub regs): *mut *mut *mut int (smm_call)(struct device smm_dev, struct smm_regs,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dell_smm_data {
    pub /: *mut *mut mutex i8k_mutex; / lock for sensors writes,
    pub bios_version: [c_char; 4],
    pub bios_machineid: [c_char; 16],
    pub i8k_fan_mult: c_uint,
    pub i8k_pwm_mult: c_uint,
    pub i8k_fan_max: c_uint,
    pub temp_type: [c_int; DELL_SMM_NO_TEMP],
    pub fan: [bool; DELL_SMM_NO_FANS],
    pub fan_type: [c_int; DELL_SMM_NO_FANS],
    pub fan_nominal_speed: [*mut c_int; DELL_SMM_NO_FANS],
    pub ops: *const dell_smm_ops,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dell_smm_cooling_data {
    pub fan_num: u8,
    pub data: *mut dell_smm_data,
}
    ...
    let mut restricted: static bool = true;
...
//
#[no_mangle]
unsafe extern "C" fn i8k_smm_func(par: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i8k_smm_call(dummy: *mut device, regs: *mut smm_regs) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wmi_parse_register(buffer: *mut u8, length: usize, reg: *mut c_uint) -> isize {
...
#[no_mangle]
unsafe extern "C" fn wmi_parse_response(buffer: *mut u8, length: usize, regs: *mut smm_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wmi_smm_call(dev: *mut device, regs: *mut smm_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_smm_call(ops: *const dell_smm_ops, regs: *mut smm_regs) -> c_int {
    static int dell_smm_call(const struct dell_smm_ops *ops, struct smm_regs *regs)
    {
    let mut eax: c_uint = regs.eax;
    let mut ebx: c_uint = regs.ebx;
    long long duration;
    ktime_t calltime;
    int ret;
    calltime = ktime_get();
...
//
#[no_mangle]
unsafe extern "C" fn i8k_get_fan_status(data: *const dell_smm_data, fan: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i8k_get_fan_speed(data: *const dell_smm_data, fan: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _i8k_get_fan_type(data: *const dell_smm_data, fan: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i8k_get_fan_type(data: *mut dell_smm_data, fan: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i8k_get_fan_nominal_speed(data: *const dell_smm_data, fan: u8, speed: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i8k_enable_fan_auto_mode(data: *const dell_smm_data, enable: bool) -> c_int {
    static int i8k_enable_fan_auto_mode(const struct dell_smm_data *data, bool enable)
    {
    let mut regs: smm_regs = { };
    if (disallow_fan_support)
    return -EINVAL;
...
//
#[no_mangle]
unsafe extern "C" fn i8k_set_fan(data: *const dell_smm_data, fan: u8, speed: c_int) -> c_int {
    static int i8k_set_fan(const struct dell_smm_data *data, u8 fan, int speed)
    {
    let mut regs: smm_regs = { .eax = I8K_SMM_SET_FAN, };
    if (disallow_fan_support)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn i8k_get_temp_type(data: *const dell_smm_data, sensor: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _i8k_get_temp(data: *const dell_smm_data, sensor: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i8k_get_temp(data: *const dell_smm_data, sensor: u8) -> c_int {
    static int i8k_get_temp(const struct dell_smm_data *data, u8 sensor)
    {
    let mut temp: c_int = _i8k_get_temp(data, sensor);
//
...
#[no_mangle]
unsafe extern "C" fn dell_smm_get_signature(ops: *const dell_smm_ops, req_fn: c_int) -> c_int {
    static int dell_smm_get_signature(const struct dell_smm_ops *ops, int req_fn)
    {
    let mut regs: smm_regs = { .eax = req_fn, };
    int rc;
...
//
#[no_mangle]
unsafe extern "C" fn i8k_get_fn_status(data: *const dell_smm_data) -> c_int {
    static int i8k_get_fn_status(const struct dell_smm_data *data)
    {
    let mut regs: smm_regs = { .eax = I8K_SMM_FN_STATUS, };
    int rc;
...
//
#[no_mangle]
unsafe extern "C" fn i8k_get_power_status(data: *const dell_smm_data) -> c_int {
    static int i8k_get_power_status(const struct dell_smm_data *data)
    {
    let mut regs: smm_regs = { .eax = I8K_SMM_POWER_STATUS, };
    int rc;
    rc = dell_smm_call(data.ops, &regs);
    if (rc < 0)
    return rc;
...
//
#[no_mangle]
unsafe extern "C" fn i8k_ioctl(fp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn i8k_proc_show(seq: *mut seq_file, offset: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i8k_open_fs(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i8k_exit_procfs(param: *mut c_void) {
    static void i8k_exit_procfs(void *param)
    {
    remove_proc_entry("i8k", core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn i8k_init_procfs(dev: *mut device) -> void __init {
...
// Only register exit function if creation was successful
    if (proc_create_data("i8k", 0, core::ptr::null_mut(), &i8k_proc_ops, data))
    devm_add_action_or_reset(dev, i8k_exit_procfs, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn dell_smm_get_max_state(dev: *mut thermal_cooling_device, state: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_smm_get_cur_state(dev: *mut thermal_cooling_device, state: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_smm_set_cur_state(dev: *mut thermal_cooling_device, state: c_ulong) -> c_int {
...
//
    ...
    {
    struct dell_smm_data *data = dev_get_drvdata(dev);
    let mut mult: c_int = data.i8k_fan_mult;
    int ret;
    switch (type) {
    case hwmon_temp:
    switch (attr) {
...
// val = 1;
    ...
    let mut type: c_int = i8k_get_fan_type(data, channel);
    if (type < 0)
    return ERR_PTR(type);
    if (type & 0x10) {
    dock = true;
...
#[no_mangle]
unsafe extern "C" fn dell_smm_init_cdev(dev: *mut device, fan_num: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dell_smm_init_hwmon(dev: *mut device) -> c_int {
...
// Mark nominal speed table as invalid in case of error
    ...
    data.fan_nominal_speed[i] = core::ptr::null_mut();
    break;
    }
...
//
    ...
    &dell_smm_chip_info, core::ptr::null_mut());
    return PTR_ERR_OR_ZERO(dell_smm_hwmon_dev);
    }
#[no_mangle]
unsafe extern "C" fn dell_smm_init_data(dev: *mut device, ops: *const dell_smm_ops) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i8k_fan_control_data {
    pub manual_fan: c_uint,
    pub auto_fan: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn dell_smm_probe(pdev: *mut platform_device) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn dell_smm_wmi_probe(wdev: *mut wmi_device, context: *const c_void) -> c_int {
    ...
    { DELL_SMM_WMI_GUID, core::ptr::null_mut() },
    { }
    };
...
//
#[no_mangle]
unsafe extern "C" fn dell_smm_init_dmi() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn dell_smm_legacy_check() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn i8k_init() -> int __init {
...
//
    ...
    dell_smm_device = platform_create_bundle(&dell_smm_driver, dell_smm_probe, core::ptr::null_mut(), 0, core::ptr::null_mut(),
    0);
    return PTR_ERR_OR_ZERO(dell_smm_device);
    }
#[no_mangle]
unsafe extern "C" fn i8k_exit() -> void __exit {
