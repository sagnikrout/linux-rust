...
//! Source: drivers/hwmon/lattepanda-sigma-ec.c
#![no_std]
...
pub const EC_DATA_PORT: c_uint = 0x62;
pub const EC_CMD_PORT: c_uint = 0x66	/* also status port */;
// EC commands
pub const EC_CMD_READ: c_uint = 0x80;
// EC status register bits
pub const EC_STATUS_OBF: c_uint = 0x01	/* Output Buffer Full */;
pub const EC_STATUS_IBF: c_uint = 0x02	/* Input Buffer Full */;
// EC register offsets for LattePanda Sigma (BIOS 5.27)
pub const EC_REG_FAN_RPM_HI: c_uint = 0x2E;
pub const EC_REG_FAN_RPM_LO: c_uint = 0x2F;
pub const EC_REG_TEMP_BOARD: c_uint = 0x60;
pub const EC_REG_TEMP_CPU: c_uint = 0x70;
pub const EC_REG_FAN_DUTY: c_uint = 0x93;
//
...
//
pub const EC_TIMEOUT_US: c_int = 25000;
pub const EC_POLL_US: c_int = 1;
    static bool force;
...
#[no_mangle]
unsafe extern "C" fn ec_wait_ibf_clear() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ec_wait_obf_set() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ec_read_reg(reg: u8, val: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ec_read_reg16(reg_hi: u8, reg_lo: u8, val: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lps_ec_probe(pdev: *mut platform_device) -> c_int {
...
// Sanity check: verify EC is responsive
    ...
    hwmon = devm_hwmon_device_register_with_info(dev, DRIVER_NAME, core::ptr::null_mut(),
    &lps_ec_chip_info, core::ptr::null_mut());
    if (IS_ERR(hwmon))
...
#[no_mangle]
unsafe extern "C" fn lps_ec_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn lps_ec_exit() -> void __exit {
