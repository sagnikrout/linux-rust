...
// miscellaneous
pub const LM93_REG_MFR_ID: c_uint = 0x3e;
pub const LM93_REG_VER: c_uint = 0x3f;
pub const LM93_REG_STATUS_CONTROL: c_uint = 0xe2;
pub const LM93_REG_CONFIG: c_uint = 0xe3;
pub const LM93_REG_SLEEP_CONTROL: c_uint = 0xe4;
// alarm values start here
pub const LM93_REG_HOST_ERROR_1: c_uint = 0x48;
...
pub const LM93_PWM_CTL1: c_uint = 0x0;
pub const LM93_PWM_CTL2: c_uint = 0x1;
pub const LM93_PWM_CTL3: c_uint = 0x2;
pub const LM93_PWM_CTL4: c_uint = 0x3;
// GPIO input state
pub const LM93_REG_GPI: c_uint = 0x6b;
// vid inputs: vid1-vid2 (nr => 0-1)

// vccp1 & vccp2: VID relative inputs (nr => 0-1)

// temp[1-4]_auto_boost_hyst
pub const LM93_REG_BOOST_HYST_12: c_uint = 0xc0;
pub const LM93_REG_BOOST_HYST_34: c_uint = 0xc1;

// temp[1-4]_auto_pwm_[min|hyst]
pub const LM93_REG_PWM_MIN_HYST_12: c_uint = 0xc3;
pub const LM93_REG_PWM_MIN_HYST_34: c_uint = 0xc4;

// prochot_override & prochot_interval
pub const LM93_REG_PROCHOT_OVERRIDE: c_uint = 0xc6;
pub const LM93_REG_PROCHOT_INTERVAL: c_uint = 0xc7;
// temp[1-4]_auto_base (nr => 0-3)

// temp[1-4]_auto_offsets (step => 0-11)

// #PROCHOT & #VRDHOT PWM ramp control
pub const LM93_REG_PWM_RAMP_CTL: c_uint = 0xbf;
// miscellaneous
pub const LM93_REG_SFC1: c_uint = 0xbc;
pub const LM93_REG_SFC2: c_uint = 0xbd;
pub const LM93_REG_GPI_VID_CTL: c_uint = 0xbe;
pub const LM93_REG_SF_TACH_TO_PWM: c_uint = 0xe0;
// error masks
pub const LM93_REG_GPI_ERR_MASK: c_uint = 0xec;
pub const LM93_REG_MISC_ERR_MASK: c_uint = 0xed;
// LM93 REGISTER VALUES
pub const LM93_MFR_ID: c_uint = 0x73;
pub const LM93_MFR_ID_PROTOTYPE: c_uint = 0x72;
// LM94 REGISTER VALUES
pub const LM94_MFR_ID_2: c_uint = 0x7a;
pub const LM94_MFR_ID: c_uint = 0x79;
pub const LM94_MFR_ID_PROTOTYPE: c_uint = 0x78;
// SMBus capabilities
...
// Insmod parameters
    ...
    module_param_array(vccp_limit_type, int, core::ptr::null_mut(), 0);
...
#[derive(Copy, Clone)]
pub struct block1_t {
    pub host_status_1: u8,
    pub host_status_2: u8,
    pub host_status_3: u8,
    pub host_status_4: u8,
    pub p1_prochot_status: u8,
    pub p2_prochot_status: u8,
    pub gpi_status: u8,
    pub fan_status: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm93_data {
    pub client: *mut i2c_client,
    pub update_lock: mutex,
    pub /: *mut *mut unsigned long last_updated; / In jiffies,
// client update function
    pub ): *mut *mut *mut void (update)(struct lm93_data , struct i2c_client,
...
// Temperature Zone Min. PWM & Hysteresis (register format)
    pub auto_pwm_min_hyst: [u8; 2],
// #PROCHOT & #VRDHOT PWM Ramp Control
    pub pwm_ramp_ctl: u8,
// miscellaneous setup regs
    pub sfc1: u8,
    pub sfc2: u8,
    pub sf_tach_to_pwm: u8,
//
...
//
#[no_mangle]
unsafe extern "C" fn LM93_VID_FROM_REG(reg: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn LM93_IN_FROM_REG(nr: c_int, reg: u8) -> unsigned {
    static unsigned LM93_IN_FROM_REG(int nr, u8 reg)
    {
    let mut uv_max: c_long = lm93_vin_val_max[nr] * 1000;
    let mut uv_min: c_long = lm93_vin_val_min[nr] * 1000;
    const long slope = (uv_max - uv_min) /
    (lm93_vin_reg_max[nr] - lm93_vin_reg_min[nr]);
    let mut intercept: c_long = uv_min - slope * lm93_vin_reg_min[nr];
...
//
#[no_mangle]
unsafe extern "C" fn LM93_IN_TO_REG(nr: c_int, val: unsigned) -> u8 {
...
// convert
    ...
    (lm93_vin_reg_max[nr] - lm93_vin_reg_min[nr]);
    let mut intercept: c_long = uv_min - slope * lm93_vin_reg_min[nr];
    let mut result: u8 = ((uv - intercept + (slope/2)) / slope);
...
#[no_mangle]
unsafe extern "C" fn LM93_IN_REL_FROM_REG(reg: u8, upper: c_int, vid: c_int) -> unsigned {
    static unsigned LM93_IN_REL_FROM_REG(u8 reg, int upper, int vid)
    {
    const long uv_offset = upper ? (((reg >> 4 & 0x0f) + 1) * 12500) :
    (((reg >> 0 & 0x0f) + 1) * -25000);
    let mut uv_vid: c_long = vid * 1000;
...
//
#[no_mangle]
unsafe extern "C" fn LM93_IN_REL_TO_REG(val: unsigned, upper: c_int, vid: c_int) -> u8 {
    static u8 LM93_IN_REL_TO_REG(unsigned val, int upper, int vid)
    {
    let mut uv_offset: c_long = vid * 1000 - val * 10000;
    if (upper) {
...
//
#[no_mangle]
unsafe extern "C" fn LM93_TEMP_FROM_REG(reg: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn LM93_TEMP_TO_REG(temp: c_long) -> u8 {
    static u8 LM93_TEMP_TO_REG(long temp)
    {
    let mut ntemp: c_int = clamp_val(temp, LM93_TEMP_MIN, LM93_TEMP_MAX);
    ntemp += (ntemp < 0 ? -500 : 500);
    return (u8)(ntemp / 1000);
    }
// Determine 4-bit temperature offset resolution
#[no_mangle]
unsafe extern "C" fn LM93_TEMP_OFFSET_MODE_FROM_REG(sfc2: u8, nr: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn LM93_TEMP_OFFSET_FROM_REG(reg: u8, mode: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn LM93_TEMP_OFFSET_TO_REG(off: c_int, mode: c_int) -> u8 {
    static u8 LM93_TEMP_OFFSET_TO_REG(int off, int mode)
    {
    let mut factor: c_int = mode ? 5 : 10;
...
// 0 <= nr <= 3
#[no_mangle]
unsafe extern "C" fn LM93_TEMP_AUTO_OFFSET_FROM_REG(reg: u8, nr: c_int, mode: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn LM93_TEMP_AUTO_OFFSET_TO_REG(old: u8, off: c_int, nr: c_int, mode: c_int) -> u8 {
    static u8 LM93_TEMP_AUTO_OFFSET_TO_REG(u8 old, int off, int nr, int mode)
    {
    let mut new: u8 = LM93_TEMP_OFFSET_TO_REG(off, mode);
// temp1-temp2 (nr=0,1) use lower nibble
    if (nr < 2)
...
#[no_mangle]
unsafe extern "C" fn LM93_PWM_FROM_REG(reg: u8, freq: enum pwm_freq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn LM93_PWM_TO_REG(pwm: c_int, freq: enum pwm_freq) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn LM93_FAN_FROM_REG(regs: u16) -> c_int {
    static int LM93_FAN_FROM_REG(u16 regs)
    {
    let mut count: u16 = le16_to_cpu(regs) >> 2;
    let mut count: return = = 0 ? -1 : count == 0x3fff ? 0 : 1350000 / count;
    }
//
// RPM: (82.5 to 1350000)
...
//
#[no_mangle]
unsafe extern "C" fn LM93_FAN_TO_REG(rpm: c_long) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn LM93_PWM_FREQ_FROM_REG(reg: u8) -> c_int {
...
// round up to nearest match
#[no_mangle]
unsafe extern "C" fn LM93_PWM_FREQ_TO_REG(freq: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn LM93_SPINUP_TIME_FROM_REG(reg: u8) -> c_int {
...
// round up to nearest match
#[no_mangle]
unsafe extern "C" fn LM93_SPINUP_TIME_TO_REG(time: c_int) -> u8 {
...
pub const LM93_RAMP_MIN: c_int = 0;
pub const LM93_RAMP_MAX: c_int = 75;
#[no_mangle]
unsafe extern "C" fn LM93_RAMP_FROM_REG(reg: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn LM93_RAMP_TO_REG(ramp: c_int) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn LM93_PROCHOT_TO_REG(prochot: c_long) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn LM93_INTERVAL_FROM_REG(reg: u8) -> c_int {
...
// round up to nearest match
#[no_mangle]
unsafe extern "C" fn LM93_INTERVAL_TO_REG(interval: c_long) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn LM93_GPI_FROM_REG(reg: u8) -> unsigned {
...
//
pub const LM93_ALARM_IN1: c_uint = 0x00000001;
pub const LM93_ALARM_IN2: c_uint = 0x00000002;
pub const LM93_ALARM_IN3: c_uint = 0x00000004;
pub const LM93_ALARM_IN4: c_uint = 0x00000008;
pub const LM93_ALARM_IN5: c_uint = 0x00000010;
pub const LM93_ALARM_IN6: c_uint = 0x00000020;
pub const LM93_ALARM_IN7: c_uint = 0x00000040;
pub const LM93_ALARM_IN8: c_uint = 0x00000080;
pub const LM93_ALARM_IN9: c_uint = 0x00000100;
pub const LM93_ALARM_IN10: c_uint = 0x00000200;
pub const LM93_ALARM_IN11: c_uint = 0x00000400;
pub const LM93_ALARM_IN12: c_uint = 0x00000800;
pub const LM93_ALARM_IN13: c_uint = 0x00001000;
pub const LM93_ALARM_IN14: c_uint = 0x00002000;
pub const LM93_ALARM_IN15: c_uint = 0x00004000;
pub const LM93_ALARM_IN16: c_uint = 0x00008000;
pub const LM93_ALARM_FAN1: c_uint = 0x00010000;
pub const LM93_ALARM_FAN2: c_uint = 0x00020000;
pub const LM93_ALARM_FAN3: c_uint = 0x00040000;
pub const LM93_ALARM_FAN4: c_uint = 0x00080000;
pub const LM93_ALARM_PH1_ERR: c_uint = 0x00100000;
pub const LM93_ALARM_PH2_ERR: c_uint = 0x00200000;
pub const LM93_ALARM_SCSI1_ERR: c_uint = 0x00400000;
pub const LM93_ALARM_SCSI2_ERR: c_uint = 0x00800000;
pub const LM93_ALARM_DVDDP1_ERR: c_uint = 0x01000000;
pub const LM93_ALARM_DVDDP2_ERR: c_uint = 0x02000000;
pub const LM93_ALARM_D1_ERR: c_uint = 0x04000000;
pub const LM93_ALARM_D2_ERR: c_uint = 0x08000000;
pub const LM93_ALARM_TEMP1: c_uint = 0x10000000;
pub const LM93_ALARM_TEMP2: c_uint = 0x20000000;
pub const LM93_ALARM_TEMP3: c_uint = 0x40000000;
#[no_mangle]
unsafe extern "C" fn LM93_ALARMS_FROM_REG(b1: block1_t) -> unsigned {
...
pub const MAX_RETRIES: c_int = 5;
#[no_mangle]
unsafe extern "C" fn lm93_read_byte(client: *mut i2c_client, reg: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn lm93_write_byte(client: *mut i2c_client, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm93_read_word(client: *mut i2c_client, reg: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn lm93_write_word(client: *mut i2c_client, reg: u8, value: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lm93_read_block(client: *mut i2c_client, fbn: u8, values: *mut u8) {
...
// <TODO> what to do in case of error?
    ...
    let mut interval: c_ulong = HZ + (HZ / 2);
...
// following are the sysfs callback functions
    ...
    let mut nr: c_int = (to_sensor_dev_attr(attr)).index;
    struct lm93_data *data = lm93_update_device(dev);
    let mut mode: c_int = LM93_TEMP_OFFSET_MODE_FROM_REG(data.sfc2, nr);
    return sprintf(buf, "%d\n",
...
// force 0.5C/bit mode
    ...
    let mut nr: c_int = s_attr.index;
    let mut ofs: c_int = s_attr.nr;
    struct lm93_data *data = lm93_update_device(dev);
    let mut mode: c_int = LM93_TEMP_OFFSET_MODE_FROM_REG(data.sfc2, nr);
    return sprintf(buf, "%d\n",
...
//
    ...
    {
    let mut mapping: c_int = lm93_read_byte(client, LM93_REG_SF_TACH_TO_PWM);
    int mask;
...
#[no_mangle]
unsafe extern "C" fn lm93_init_client(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn lm93_detect(client: *mut i2c_client, info: *mut i2c_board_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm93_probe(client: *mut i2c_client) -> c_int {
