...
//! Source: drivers/hwmon/iio_hwmon.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn iio_hwmon_probe(pdev: *mut platform_device) -> c_int {
    ...
    int ret, i, attr = 0;
    let mut in_i: c_int = 1, temp_i = 1, curr_i = 1, humidity_i = 1, power_i = 1;
    enum iio_chan_type type;
...
// count how many channels we have
    ...
    "%s%d_input",
    prefix, n);
    if (a.dev_attr.attr.name == core::ptr::null_mut())
    return -ENOMEM;
