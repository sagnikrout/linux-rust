...
//! Source: drivers/hwmon/ltc4260.c
#![no_std]
...
// chip registers
pub const LTC4260_CONTROL: c_uint = 0x00;
pub const LTC4260_ALERT: c_uint = 0x01;
pub const LTC4260_STATUS: c_uint = 0x02;
pub const LTC4260_FAULT: c_uint = 0x03;
pub const LTC4260_SENSE: c_uint = 0x04;
pub const LTC4260_SOURCE: c_uint = 0x05;
pub const LTC4260_ADIN: c_uint = 0x06;
//
// Fault register bits
//
...
#[no_mangle]
unsafe extern "C" fn ltc4260_get_value(dev: *mut device, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4260_probe(client: *mut i2c_client) -> c_int {
