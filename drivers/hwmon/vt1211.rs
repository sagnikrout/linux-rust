...
pub const VT1211_REG_FAN_DIV: c_uint = 0x47;
// PWMs numbered 0-1 (ix)
// Auto points numbered 0-3 (ap)

pub const VT1211_REG_PWM_CLK: c_uint = 0x50;
pub const VT1211_REG_PWM_CTL: c_uint = 0x51;

// Miscellaneous registers
pub const VT1211_REG_CONFIG: c_uint = 0x40;
pub const VT1211_REG_ALARM1: c_uint = 0x41;
pub const VT1211_REG_ALARM2: c_uint = 0x42;
pub const VT1211_REG_VID: c_uint = 0x45;
pub const VT1211_REG_UCH_CONFIG: c_uint = 0x4a;
pub const VT1211_REG_TEMP1_CONFIG: c_uint = 0x4b;
pub const VT1211_REG_TEMP2_CONFIG: c_uint = 0x4c;
...
// Register values
    ...
    pub pwm_ctl: [u8; 2],
    pub pwm_clk: u8,
    pub pwm_auto_temp: [u8; 4],
    pub pwm_auto_pwm: [u8; 2][4],
    pub /: *mut *mut u8 vid; / Read once at init time,
    pub vrm: u8,
    pub /: *mut *mut u8 uch_config; / Read once at init time,
    pub alarms: u16,
}
...
//
#[no_mangle]
unsafe extern "C" fn in_from_reg(ix: c_int, reg: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn temp_from_reg(ix: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpm_from_reg(reg: c_int, div: c_int) -> c_int {
...
//
pub const SIO_REG_CIP1: c_uint = 0x2e;
pub const SIO_REG_CIP2: c_uint = 0x4e;
// Configuration registers
pub const SIO_VT1211_LDN: c_uint = 0x07	/* logical device number */;
pub const SIO_VT1211_DEVID: c_uint = 0x20	/* device ID */;
pub const SIO_VT1211_DEVREV: c_uint = 0x21	/* device revision */;
pub const SIO_VT1211_ACTIVE: c_uint = 0x30	/* HW monitor active */;
pub const SIO_VT1211_BADDR: c_uint = 0x60	/* base I/O address */;
pub const SIO_VT1211_ID: c_uint = 0x3c	/* VT1211 device ID */;
// VT1211 logical device numbers
pub const SIO_VT1211_LDN_HWMON: c_uint = 0x0b	/* HW monitor */;
#[no_mangle]
pub unsafe extern "C" fn superio_inb(sio_cip: c_int, reg: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn superio_select(sio_cip: c_int, ldn: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn superio_enter(sio_cip: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn superio_exit(sio_cip: c_int) {
...
// ---------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn vt1211_read8(data: *mut vt1211_data, reg: u8) -> u8 {
    static inline u8 vt1211_read8(struct vt1211_data *data, u8 reg)
    {
    return inb(data.addr + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn vt1211_write8(data: *mut vt1211_data, reg: u8, val: u8) {
...
// ix = [0-5]
// ---------------------------------------------------------------------
pub const SHOW_IN_INPUT: c_int = 0;
pub const SHOW_SET_IN_MIN: c_int = 1;
pub const SHOW_SET_IN_MAX: c_int = 2;
pub const SHOW_IN_ALARM: c_int = 3;
...
// ix = [0-6]
// ---------------------------------------------------------------------
pub const SHOW_TEMP_INPUT: c_int = 0;
pub const SHOW_SET_TEMP_MAX: c_int = 1;
pub const SHOW_SET_TEMP_MAX_HYST: c_int = 2;
pub const SHOW_TEMP_ALARM: c_int = 3;
...
// ix = [0-1]
// ---------------------------------------------------------------------
pub const SHOW_FAN_INPUT: c_int = 0;
pub const SHOW_SET_FAN_MIN: c_int = 1;
pub const SHOW_SET_FAN_DIV: c_int = 2;
pub const SHOW_FAN_ALARM: c_int = 3;
...
// ix = [0-1]
// ---------------------------------------------------------------------
pub const SHOW_PWM: c_int = 0;
pub const SHOW_SET_PWM_ENABLE: c_int = 1;
pub const SHOW_SET_PWM_FREQ: c_int = 2;
pub const SHOW_SET_PWM_AUTO_CHANNELS_TEMP: c_int = 3;
...
//
    ...
    to_sensor_dev_attr_2(attr);
    let mut ix: c_int = sensor_attr_2.index;
    let mut ap: c_int = sensor_attr_2.nr;
...
// ---------------------------------------------------------------------
    ...
    show_in, core::ptr::null_mut(), SHOW_IN_INPUT, ix), \
    ...
    show_in, core::ptr::null_mut(), SHOW_IN_ALARM, ix) \
    }
    ...
    show_temp, core::ptr::null_mut(), SHOW_TEMP_INPUT, ix-1), \
    ...
    show_temp, core::ptr::null_mut(), SHOW_TEMP_ALARM, ix-1) \
    }
    ...
    show_fan, core::ptr::null_mut(), SHOW_FAN_INPUT, ix-1), \
    ...
    show_fan, core::ptr::null_mut(), SHOW_FAN_ALARM, ix-1)

    SENSOR_ATTR_2(pwm##ix, S_IRUGO, \
    show_pwm, core::ptr::null_mut(), SHOW_PWM, ix-1), \
    ...
    show_pwm, core::ptr::null_mut(), SHOW_SET_PWM_FREQ, ix-1)
    ...
    show_pwm_auto_point_temp, core::ptr::null_mut(), \
    ap-1, ix-1)
    ...
    show_pwm_auto_point_pwm, core::ptr::null_mut(), \
    ap-1, ix-1)
    ...
    __ATTR(cpu0_vid, S_IRUGO, show_vid, core::ptr::null_mut()),
    __ATTR(name, S_IRUGO, show_name, core::ptr::null_mut()),
    __ATTR(alarms, S_IRUGO, show_alarms, core::ptr::null_mut()),
    };
// ---------------------------------------------------------------------
// Device registration and initialization
// ---------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn vt1211_init_device(data: *mut vt1211_data) {
...
#[no_mangle]
unsafe extern "C" fn vt1211_remove_sysfs(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn vt1211_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vt1211_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn vt1211_device_add(address: c_ushort) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vt1211_find(sio_cip: c_int, address: *mut c_ushort) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vt1211_init() -> int __init {
    static int __init vt1211_init(void)
    {
    int err;
    let mut address: c_ushort = 0;
...
#[no_mangle]
unsafe extern "C" fn vt1211_exit() -> void __exit {
