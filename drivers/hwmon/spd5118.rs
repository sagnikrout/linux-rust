...
//! Source: drivers/hwmon/spd5118.c
#![no_std]
...
// SPD5118 registers.
pub const SPD5118_REG_TYPE: c_uint = 0x00	/* MR0:MR1 */;
pub const SPD5118_REG_REVISION: c_uint = 0x02	/* MR2 */;
pub const SPD5118_REG_VENDOR: c_uint = 0x03	/* MR3:MR4 */;
pub const SPD5118_REG_CAPABILITY: c_uint = 0x05	/* MR5 */;
pub const SPD5118_REG_I2C_LEGACY_MODE: c_uint = 0x0B	/* MR11 */;
pub const SPD5118_REG_TEMP_CLR: c_uint = 0x13	/* MR19 */;
pub const SPD5118_REG_ERROR_CLR: c_uint = 0x14	/* MR20 */;
pub const SPD5118_REG_TEMP_CONFIG: c_uint = 0x1A	/* MR26 */;
pub const SPD5118_REG_TEMP_MAX: c_uint = 0x1c	/* MR28:MR29 */;
pub const SPD5118_REG_TEMP_MIN: c_uint = 0x1e	/* MR30:MR31 */;
pub const SPD5118_REG_TEMP_CRIT: c_uint = 0x20	/* MR32:MR33 */;
pub const SPD5118_REG_TEMP_LCRIT: c_uint = 0x22	/* MR34:MR35 */;
pub const SPD5118_REG_TEMP: c_uint = 0x31	/* MR49:MR50 */;
pub const SPD5118_REG_TEMP_STATUS: c_uint = 0x33	/* MR51 */;

pub const SPD5118_NUM_PAGES: c_int = 8;
pub const SPD5118_PAGE_SIZE: c_int = 128;
pub const SPD5118_PAGE_SHIFT: c_int = 7;

pub const SPD5118_EEPROM_BASE: c_uint = 0x80;

// Temperature unit in millicelsius

// Representable temperature range in millicelsius

pub const SPD5118_TEMP_RANGE_MAX: c_int = 255750;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spd5118_data {
    pub regmap: *mut regmap,
    pub nvmem_lock: mutex,
}

// hwmon
#[no_mangle]
unsafe extern "C" fn spd5118_temp_from_reg(reg: u16) -> c_int {
    static int spd5118_temp_from_reg(u16 reg)
    {
    let mut temp: c_int = sign_extend32(reg >> 2, 10);
    return temp * SPD5118_TEMP_UNIT;
    }
#[no_mangle]
unsafe extern "C" fn spd5118_temp_to_reg(temp: c_long) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn spd5118_read_temp(regmap: *mut regmap, attr: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spd5118_read_alarm(regmap: *mut regmap, attr: u32, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spd5118_read_enable(regmap: *mut regmap, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spd5118_write_temp(regmap: *mut regmap, attr: u32, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spd5118_write_enable(regmap: *mut regmap, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spd5118_temp_write(regmap: *mut regmap, attr: u32, val: c_long) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn spd5118_vendor_valid(bank: u8, id: u8) -> bool {
...
// nvmem
    ...
    {
    let mut page: c_int = offset >> SPD5118_PAGE_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn spd5118_nvmem_read(priv: *mut c_void, off: c_uint, val: *mut c_void, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spd5118_nvmem_init(dev: *mut device, data: *mut spd5118_data) -> c_int {
...
// regmap
#[no_mangle]
unsafe extern "C" fn spd5118_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn spd5118_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn spd5118_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spd5118_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spd5118_common_probe(dev: *mut device, regmap: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spd5118_detect(client: *mut i2c_client, info: *mut i2c_board_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spd5118_i2c_init(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spd5118_i2c_probe(client: *mut i2c_client) -> c_int {
    ...
    .detect		= IS_ENABLED(CONFIG_SENSORS_SPD5118_DETECT) ? spd5118_detect : core::ptr::null_mut(),
    .address_list	= IS_ENABLED(CONFIG_SENSORS_SPD5118_DETECT) ? normal_i2c : core::ptr::null_mut(),
    };
// I3C
#[no_mangle]
unsafe extern "C" fn spd5118_i3c_probe(i3cdev: *mut i3c_device) -> c_int {
