...
//! Source: drivers/hwmon/pc87360.c
#![no_std]
...
pub const CHAN_CNVRTD: c_uint = 0x80	/* new data ready */;
pub const CHAN_ENA: c_uint = 0x01	/* enabled channel (temp or vin) */;
pub const CHAN_ALM_ENA: c_uint = 0x10	/* propagate to alarms-reg ?? (chk val!) */;

pub const TEMP_OTS_OE: c_uint = 0x20	/* OTS Output Enable */;

    static u8 devid;
    static struct platform_device *pdev;
    static unsigned short extra_isa[3];
    static u8 confreg[4];
    let mut init: static int = 1;
...
pub const ACT: c_uint = 0x30	/* Register: Device activation */;
pub const BASE: c_uint = 0x60	/* Register: Base address */;
pub const FSCM: c_uint = 0x09	/* Logical device: fans */;
pub const VLM: c_uint = 0x0d	/* Logical device: voltages */;
pub const TMS: c_uint = 0x0e	/* Logical device: temperatures */;
pub const LDNI_MAX: c_int = 3;
    static const u8 logdev[LDNI_MAX] = { FSCM, VLM, TMS };
pub const LD_FAN: c_int = 0;
pub const LD_IN: c_int = 1;
pub const LD_TEMP: c_int = 2;
#[no_mangle]
...
// Logical devices
//
pub const PC87360_EXTENT: c_uint = 0x10;
pub const PC87365_REG_BANK: c_uint = 0x09;
pub const NO_BANK: c_uint = 0xff;
//
...
#[no_mangle]
pub unsafe extern "C" fn PWM_TO_REG(val: c_int, inv: c_int) -> u8 {
...
//
pub const PC87365_REG_IN_CONVRATE: c_uint = 0x07;
pub const PC87365_REG_IN_CONFIG: c_uint = 0x08;
pub const PC87365_REG_IN: c_uint = 0x0B;
pub const PC87365_REG_IN_MIN: c_uint = 0x0D;
pub const PC87365_REG_IN_MAX: c_uint = 0x0C;
pub const PC87365_REG_IN_STATUS: c_uint = 0x0A;
pub const PC87365_REG_IN_ALARMS1: c_uint = 0x00;
pub const PC87365_REG_IN_ALARMS2: c_uint = 0x01;
pub const PC87365_REG_VID: c_uint = 0x06;
...
//
pub const PC87365_REG_TEMP_CONFIG: c_uint = 0x08;
pub const PC87365_REG_TEMP: c_uint = 0x0B;
pub const PC87365_REG_TEMP_MIN: c_uint = 0x0D;
pub const PC87365_REG_TEMP_MAX: c_uint = 0x0C;
pub const PC87365_REG_TEMP_CRIT: c_uint = 0x0E;
pub const PC87365_REG_TEMP_STATUS: c_uint = 0x0A;
pub const PC87365_REG_TEMP_ALARMS: c_uint = 0x00;
...
pub struct pc87360_data {
    ...
    pub address: [c_int; 3],
    pub tempnr: u8 fannr, innr,,
    pub /: *mut *mut u8 fan[3]; / Register value,
    pub /: *mut *mut u8 fan_min[3]; / Register value,
    pub /: *mut *mut u8 fan_status[3]; / Register value,
    pub /: *mut *mut u8 pwm[3]; / Register value,
    pub /: *mut *mut u16 fan_conf; / Configuration register values, combined,
    pub /: *mut *mut u16 in_vref; / 1 mV/bit,
    pub /: *mut *mut u8 in[14]; / Register value,
    pub /: *mut *mut u8 in_min[14]; / Register value,
    pub /: *mut *mut u8 in_max[14]; / Register value,
    pub /: *mut *mut u8 in_crit[3]; / Register value,
    pub /: *mut *mut u8 in_status[14]; / Register value,
    pub /: *mut *mut u16 in_alarms; / Register values, combined, masked,
    pub /: *mut *mut u8 vid_conf; / Configuration register value,
    pub vrm: u8,
    ...
    pub /: *mut *mut u8 temp_status[3]; / Register value,
    pub /: *mut *mut u8 temp_alarms; / Register value, masked,
}
...
#[no_mangle]
unsafe extern "C" fn pc87360_autodiv(dev: *mut device, nr: c_int) {
    static void pc87360_autodiv(struct device *dev, int nr)
    {
    struct pc87360_data *data = dev_get_drvdata(dev);
    let mut old_min: u8 = data.fan_min[nr];
...
pub const CHAN_ALM_MIN: c_uint = 0x02	/* min limit crossed */;
pub const CHAN_ALM_MAX: c_uint = 0x04	/* max limit exceeded */;
pub const TEMP_ALM_CRIT: c_uint = 0x08	/* temp crit exceeded (temp only) */;
//
...
//
    ...
    {
    struct pc87360_data *data = pc87360_update_device(dev);
    let mut nr: unsigned = to_sensor_dev_attr(devattr).index;
...
pub const TEMP_FAULT: c_uint = 0x40	/* open diode */;
...
#[no_mangle]
unsafe extern "C" fn pc87360_remove_files(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn pc87360_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut err: c_int = 0;
    const char *name;
    let mut use_thermistors: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn pc87360_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn pc87360_device_add(address: c_ushort) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pc87360_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pc87360_exit() -> void __exit {
