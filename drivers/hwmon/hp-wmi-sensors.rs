...
//! Source: drivers/hwmon/hp-wmi-sensors.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hp_wmi_numeric_sensor {
    pub name: *const c_char,
    pub description: *const c_char,
    pub sensor_type: u32,
    pub /: *const *const *const char other_sensor_type; / Explains "Other" SensorType.,
    pub operational_status: u32,
    pub /: *mut *mut u8 size; / Count of PossibleStates[].,
    pub possible_states: *const c_char,
    pub current_state: *const c_char,
    pub base_units: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hp_wmi_platform_events {
    pub name: *const c_char,
    pub description: *const c_char,
    pub source_namespace: *const c_char,
    pub source_class: *const c_char,
    pub category: u32,
    pub possible_severity: u32,
    pub possible_status: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hp_wmi_info {
    pub nsensor: hp_wmi_numeric_sensor,
    pub instance: u8,
    pub /: *mut *mut *mut *mut void state; / void : Avoid forward declaration.,
    pub has_alarm: bool,
    pub alarm: bool,
    pub type: enum hwmon_sensor_types,
    pub cached_val: c_long,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hp_wmi_sensors {
    pub wdev: *mut wmi_device,
    pub info_map: [*mut hp_wmi_info; hwmon_max],
    pub channel_count: [u8; hwmon_max],
    pub has_intrusion: bool,
    pub intrusion: bool,
    pub /: *mut *mut mutex lock; / Lock polling WMI and driver state changes.,
}

#[no_mangle]
unsafe extern "C" fn is_raw_wmi_string(pointer: *const u8, length: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hp_wmi_wobj_instance_count(guid: *const c_char) -> u8 {
    ...
    {
    let mut type: acpi_object_type = wobj.type;
...
//
    ...
    {
    let mut type: acpi_object_type = wobj.type;
    let mut prop: c_int = HP_WMI_PROPERTY_NAME;
    acpi_object_type valid_type;
    union acpi_object *elements;
    u32 elem_count;
    int last_prop;
...
// out_is_new = is_new;
    ...
    {
    let mut operational_status: u32 = nsensor.operational_status;
    return operational_status != HP_WMI_STATUS_NO_CONTACT;
    }
#[no_mangle]
unsafe extern "C" fn numeric_sensor_has_fault(nsensor: *const hp_wmi_numeric_sensor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scale_numeric_sensor(nsensor: *const hp_wmi_numeric_sensor) -> c_long {
    static long scale_numeric_sensor(const struct hp_wmi_numeric_sensor *nsensor)
    {
    let mut current_reading: u32 = nsensor.current_reading;
    let mut unit_modifier: i32 = nsensor.unit_modifier;
    let mut sensor_type: u32 = nsensor.sensor_type;
    let mut base_units: u32 = nsensor.base_units;
    s32 target_modifier;
    long val;
...
//
#[no_mangle]
unsafe extern "C" fn classify_numeric_sensor(nsensor: *const hp_wmi_numeric_sensor) -> c_int {
...
//
    ...
    {
    let mut last_prop: c_int = HP_WMI_PROPERTY_RATE_UNITS;
    let mut prop: c_int = HP_WMI_PROPERTY_NAME;
...
//
#[no_mangle]
unsafe extern "C" fn check_platform_events_wobj(wobj: *const union acpi_object) -> c_int {
    ...
    {
    let mut last_prop: c_int = HP_WMI_PLATFORM_EVENTS_PROPERTY_POSSIBLE_STATUS;
    let mut prop: c_int = HP_WMI_PLATFORM_EVENTS_PROPERTY_NAME;
    union acpi_object *element;
    acpi_object_type type;
    char *string;
    u32 value;
...
//
#[no_mangle]
unsafe extern "C" fn check_event_wobj(wobj: *const union acpi_object) -> c_int {
    ...
    union acpi_object *wobj)
    {
    let mut prop: c_int = HP_WMI_EVENT_PROPERTY_NAME;
    union acpi_object *element;
    acpi_object_type type;
    char *string;
    u32 value;
...
//
#[no_mangle]
unsafe extern "C" fn classify_event(event_name: *const c_char, category: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn interpret_info(info: *mut hp_wmi_info) {
...
//
    ...
    const union acpi_object *wobj;
    let mut instance: u8 = info.instance;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn basic_string_show(seqf: *mut seq_file, ignored: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fungible_show(seqf: *mut seq_file, prop: enum hp_wmi_property) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn operational_status_show(seqf: *mut seq_file, ignored: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn current_state_show(seqf: *mut seq_file, ignored: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn possible_states_show(seqf: *mut seq_file, ignored: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unit_modifier_show(seqf: *mut seq_file, ignored: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn current_reading_show(seqf: *mut seq_file, ignored: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hp_wmi_devm_debugfs_remove(res: *mut c_void) {
...
// dev_name() gives a not-very-friendly GUID for WMI devices.
    ...
    debugfs = debugfs_create_dir(buf, core::ptr::null_mut());
    if (IS_ERR(debugfs))
    return;
...
// out_str = info->nsensor.name;
    ...
    let mut fan_count: u8 = state.channel_count[hwmon_fan];
    struct hp_wmi_info *info;
    const char *name;
    u8 i;
// Fan event has Description "X Speed". Sensor has Name "X[ Speed]".
    ...
    let mut temp_count: u8 = state.channel_count[hwmon_temp];
    struct hp_wmi_info *info;
    const char *name;
    let mut count: u8 = 0;
    bool is_cpu;
...
#[no_mangle]
unsafe extern "C" fn hp_wmi_devm_notify_remove(ignored: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn make_chip_info(state: *mut hp_wmi_sensors, has_events: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_event_handler(state: *mut hp_wmi_sensors) -> bool {
    ...
    err = devm_add_action_or_reset(dev, hp_wmi_devm_notify_remove, core::ptr::null_mut());
    if (err)
    return false;
    return true;
    }
#[no_mangle]
unsafe extern "C" fn hp_wmi_sensors_init(state: *mut hp_wmi_sensors) -> c_int {
    static int hp_wmi_sensors_init(struct hp_wmi_sensors *state)
    {
    struct hp_wmi_info *connected[HP_WMI_MAX_INSTANCES];
    struct hp_wmi_platform_events *pevents = core::ptr::null_mut();
    struct device *dev = &state.wdev.dev;
    struct hp_wmi_info *info;
    struct device *hwdev;
    bool has_events;
...
#[no_mangle]
unsafe extern "C" fn hp_wmi_sensors_probe(wdev: *mut wmi_device, context: *const c_void) -> c_int {
    ...
    { HP_WMI_NUMERIC_SENSOR_GUID, core::ptr::null_mut() },
    {},
    };
