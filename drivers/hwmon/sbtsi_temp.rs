...
//! Source: drivers/hwmon/sbtsi_temp.c
#![no_std]
...
//
pub const SBTSI_REG_TEMP_INT: c_uint = 0x01 /* RO */;
pub const SBTSI_REG_STATUS: c_uint = 0x02 /* RO */;
pub const SBTSI_REG_TEMP_HIGH_INT: c_uint = 0x07 /* RW */;
pub const SBTSI_REG_TEMP_LOW_INT: c_uint = 0x08 /* RW */;
pub const SBTSI_REG_TEMP_DEC: c_uint = 0x10 /* RW */;
pub const SBTSI_REG_TEMP_HIGH_DEC: c_uint = 0x13 /* RW */;
pub const SBTSI_REG_TEMP_LOW_DEC: c_uint = 0x14 /* RW */;
pub const SBTSI_TEMP_EXT_RANGE_ADJ: c_int = 49000;
pub const SBTSI_TEMP_MIN: c_int = 0;
pub const SBTSI_TEMP_MAX: c_int = 255875;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn sbtsi_reg_to_mc(integer: i32, decimal: i32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sbtsi_mc_to_reg(temp: i32, integer: *mut u8, decimal: *mut u8) {
...
// val -= SBTSI_TEMP_EXT_RANGE_ADJ;
    ...
    &sbtsi_chip_info, core::ptr::null_mut());
