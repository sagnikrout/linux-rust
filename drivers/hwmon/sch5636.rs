...
//! Source: drivers/hwmon/sch5636.c
#![no_std]
...
pub const SCH5636_REG_FUJITSU_ID: c_uint = 0x780;
pub const SCH5636_REG_FUJITSU_REV: c_uint = 0x783;
pub const SCH5636_NO_INS: c_int = 5;
pub const SCH5636_NO_TEMPS: c_int = 16;
pub const SCH5636_NO_FANS: c_int = 8;
...
pub const SCH5636_TEMP_WORKING: c_uint = 0x01;
pub const SCH5636_TEMP_ALARM: c_uint = 0x02;
pub const SCH5636_TEMP_DEACTIVATED: c_uint = 0x80;
...
pub const SCH5636_FAN_ALARM: c_uint = 0x04;
pub const SCH5636_FAN_NOT_PRESENT: c_uint = 0x08;
pub const SCH5636_FAN_DEACTIVATED: c_uint = 0x80;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sch5636_data {
    pub addr: c_ushort,
    ...
    pub in: [u8; SCH5636_NO_INS],
    pub temp_val: [u8; SCH5636_NO_TEMPS],
    pub temp_ctrl: [u8; SCH5636_NO_TEMPS],
    pub fan_val: [u16; SCH5636_NO_FANS],
    pub fan_ctrl: [u8; SCH5636_NO_FANS],
}
...
#[no_mangle]
unsafe extern "C" fn sch5636_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sch5636_probe(pdev: *mut platform_device) -> c_int {
