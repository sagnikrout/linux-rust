...
//! Source: drivers/hwmon/adt7475.c
#![no_std]
...
pub const REG_DEVREV2: c_uint = 0x12	/* ADT7490 only */;
pub const REG_IMON: c_uint = 0x1D	/* ADT7490 only */;
pub const REG_VTT: c_uint = 0x1E	/* ADT7490 only */;
pub const REG_EXTEND3: c_uint = 0x1F	/* ADT7490 only */;
pub const REG_VOLTAGE_BASE: c_uint = 0x20;
pub const REG_TEMP_BASE: c_uint = 0x25;
pub const REG_TACH_BASE: c_uint = 0x28;
pub const REG_PWM_BASE: c_uint = 0x30;
pub const REG_PWM_MAX_BASE: c_uint = 0x38;
pub const REG_DEVID: c_uint = 0x3D;
pub const REG_VENDID: c_uint = 0x3E;
pub const REG_DEVID2: c_uint = 0x3F;
pub const REG_CONFIG1: c_uint = 0x40;
pub const REG_STATUS1: c_uint = 0x41;
pub const REG_STATUS2: c_uint = 0x42;
pub const REG_VID: c_uint = 0x43	/* ADT7476 only */;
pub const REG_VOLTAGE_MIN_BASE: c_uint = 0x44;
pub const REG_VOLTAGE_MAX_BASE: c_uint = 0x45;
pub const REG_TEMP_MIN_BASE: c_uint = 0x4E;
pub const REG_TEMP_MAX_BASE: c_uint = 0x4F;
pub const REG_TACH_MIN_BASE: c_uint = 0x54;
pub const REG_PWM_CONFIG_BASE: c_uint = 0x5C;
pub const REG_TEMP_TRANGE_BASE: c_uint = 0x5F;
pub const REG_ENHANCE_ACOUSTICS1: c_uint = 0x62;
pub const REG_ENHANCE_ACOUSTICS2: c_uint = 0x63;
pub const REG_PWM_MIN_BASE: c_uint = 0x64;
pub const REG_TEMP_TMIN_BASE: c_uint = 0x67;
pub const REG_TEMP_THERM_BASE: c_uint = 0x6A;
pub const REG_REMOTE1_HYSTERSIS: c_uint = 0x6D;
pub const REG_REMOTE2_HYSTERSIS: c_uint = 0x6E;
pub const REG_TEMP_OFFSET_BASE: c_uint = 0x70;
pub const REG_CONFIG2: c_uint = 0x73;
pub const REG_EXTEND1: c_uint = 0x76;
pub const REG_EXTEND2: c_uint = 0x77;
pub const REG_CONFIG3: c_uint = 0x78;
pub const REG_CONFIG5: c_uint = 0x7C;
pub const REG_CONFIG4: c_uint = 0x7D;
pub const REG_STATUS4: c_uint = 0x81	/* ADT7490 only */;
pub const REG_VTT_MIN: c_uint = 0x84	/* ADT7490 only */;
pub const REG_VTT_MAX: c_uint = 0x86	/* ADT7490 only */;
pub const REG_IMON_MIN: c_uint = 0x85	/* ADT7490 only */;
pub const REG_IMON_MAX: c_uint = 0x87	/* ADT7490 only */;
pub const VID_VIDSEL: c_uint = 0x80	/* ADT7476 only */;
pub const CONFIG2_ATTN: c_uint = 0x20;
pub const CONFIG3_SMBALERT: c_uint = 0x01;
pub const CONFIG3_THERM: c_uint = 0x02;
pub const CONFIG4_PINFUNC: c_uint = 0x03;
pub const CONFIG4_THERM: c_uint = 0x01;
pub const CONFIG4_SMBALERT: c_uint = 0x02;
pub const CONFIG4_MAXDUTY: c_uint = 0x08;
pub const CONFIG4_ATTN_IN10: c_uint = 0x30;
pub const CONFIG4_ATTN_IN43: c_uint = 0xC0;
pub const CONFIG5_TWOSCOMP: c_uint = 0x01;
pub const CONFIG5_TEMPOFFSET: c_uint = 0x02;
pub const CONFIG5_VIDGPIO: c_uint = 0x10	/* ADT7476 only */;
// ADT7475 Settings

pub const ADT7475_TEMP_COUNT: c_int = 3;
pub const ADT7475_TACH_COUNT: c_int = 4;
pub const ADT7475_PWM_COUNT: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adt7475_data {
    pub client: *mut i2c_client,
    pub lock: mutex,
    pub measure_updated: c_ulong,
    pub valid: bool,
    pub config2: u8,
    pub config4: u8,
    pub config5: u8,
    pub has_voltage: u8,
    pub /: *mut *mut u8 bypass_attn; / Bypass voltage attenuator,
    pub has_pwm2:1: u8,
    pub has_fan4:1: u8,
    pub has_vid:1: u8,
    pub alarms: u32,
    ...
    pub pwmctl: [u8; 3],
    pub pwmchan: [u8; 3],
    pub enh_acoustics: [u8; 2],
    pub vid: u8,
    pub vrm: u8,
    pub groups: [*const attribute_group; 10],
}
...
#[no_mangle]
pub unsafe extern "C" fn temp2reg(data: *mut adt7475_data, val: c_long) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn reg2temp(data: *mut adt7475_data, reg: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tach2rpm(tach: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rpm2tach(rpm: c_ulong) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn reg2volt(channel: c_int, reg: u16, bypass_attn: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn volt2reg(channel: c_int, volt: c_long, bypass_attn: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn adt7475_read_word(client: *mut i2c_client, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adt7475_write_word(client: *mut i2c_client, reg: c_int, val: u16) {
...
//
    ...
    struct sensor_device_attribute_2 *sattr = to_sensor_dev_attr_2(attr);
    struct adt7475_data *data = dev_get_drvdata(dev);
    let mut mask: u8 = BIT(5 + sattr.index);
...
// Non-standard name, might need revisiting
    ...
    let mut adt7475_attr_group: static struct attribute_group = { .attrs = adt7475_attrs };
    let mut fan4_attr_group: static struct attribute_group = { .attrs = fan4_attrs };
    let mut pwm2_attr_group: static struct attribute_group = { .attrs = pwm2_attrs };
    let mut in0_attr_group: static struct attribute_group = { .attrs = in0_attrs };
    let mut in3_attr_group: static struct attribute_group = { .attrs = in3_attrs };
    let mut in4_attr_group: static struct attribute_group = { .attrs = in4_attrs };
    let mut in5_attr_group: static struct attribute_group = { .attrs = in5_attrs };
    let mut in6_attr_group: static struct attribute_group = { .attrs = in6_attrs };
    let mut vid_attr_group: static struct attribute_group = { .attrs = vid_attrs };
    ...
    name = "adt7473";
#[no_mangle]
pub unsafe extern "C" fn if(0x2e: devid == 0x75 && client->addr ==) -> else {
    else if (devid == 0x75 && client.addr == 0x2e)
    name = "adt7475";
#[no_mangle]
pub unsafe extern "C" fn if(0x76: devid ==) -> else {
    else if (devid == 0x76)
    name = "adt7476";
#[no_mangle]
pub unsafe extern "C" fn if(0x6c: (devid2 & 0xfc) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn adt7475_update_limits(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn load_config3(client: *const i2c_client, propname: *const c_char) -> c_int {
    ...
    ;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp("smbalert#", _arg: function)) -> else {
...
#[no_mangle]
unsafe extern "C" fn load_config4(client: *const i2c_client, propname: *const c_char) -> c_int {
    ...
    ;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp("therm#", _arg: function)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp("gpio", _arg: function)) -> else {
...
#[no_mangle]
unsafe extern "C" fn load_config(client: *const i2c_client, chip: enum chips) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adt7475_set_pwm_polarity(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _adt7475_pwm_properties_parse_args(args[4]: u32, cfg: *mut adt7475_pwm_config) -> c_int {
    ...
    {
    int ret, i;
    let mut rargs: fwnode_reference_args = {};
    u32 args[4] = {};
...
// Let duty_cycle default to period
    ...
    int ret;
    u32 args[4] = {};
    let mut n_vals: usize = fwnode_property_count_u32(fwnode, "pwms");
...
#[no_mangle]
unsafe extern "C" fn adt7475_fan_pwm_config(client: *mut i2c_client) -> c_int {
    static int adt7475_fan_pwm_config(struct i2c_client *client)
    {
    struct adt7475_data *data = i2c_get_clientdata(client);
    let mut cfg: adt7475_pwm_config = {};
    int ret;
...
#[no_mangle]
unsafe extern "C" fn adt7475_probe(client: *mut i2c_client) -> c_int {
...
//
    if (chip == adt7476) {
    let mut vid: u8 = adt7475_read(REG_VID);
    if (!(vid & VID_VIDSEL))
...
#[no_mangle]
unsafe extern "C" fn adt7475_read_hystersis(client: *mut i2c_client) {
    static void adt7475_read_hystersis(struct i2c_client *client)
    {
    struct adt7475_data *data = i2c_get_clientdata(client);
...
#[no_mangle]
unsafe extern "C" fn adt7475_read_pwm(client: *mut i2c_client, index: c_int) {
    static void adt7475_read_pwm(struct i2c_client *client, int index)
    {
    struct adt7475_data *data = i2c_get_clientdata(client);
    unsigned int v;
...
//
    ...
    data.pwmctl[index] = 0;
#[no_mangle]
pub unsafe extern "C" fn if(7: v ==) -> else {
    else if (v == 7)
    data.pwmctl[index] = 1;
#[no_mangle]
pub unsafe extern "C" fn if(4: v ==) -> else {
//
...
#[no_mangle]
unsafe extern "C" fn adt7475_update_measure(dev: *mut device) -> c_int {
