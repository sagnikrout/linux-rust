...
//! Source: drivers/hwmon/ltc4282.c
#![no_std]
...
pub const LTC4282_CTRL_LSB: c_uint = 0x00;

pub const LTC4282_CTRL_MSB: c_uint = 0x01;

pub const LTC4282_FAULT_LOG: c_uint = 0x04;

    (LTC4282_OV_FAULT_MASK | LTC4282_UV_FAULT_MASK)

    (LTC4282_FET_SHORT_FAULT_MASK | LTC4282_FET_BAD_FAULT_MASK)
pub const LTC4282_ADC_ALERT_LOG: c_uint = 0x05;

pub const LTC4282_FET_BAD_FAULT_TIMEOUT: c_uint = 0x06;
pub const LTC4282_FET_BAD_MAX_TIMEOUT: c_int = 255;
pub const LTC4282_GPIO_CONFIG: c_uint = 0x07;

pub const LTC4282_VGPIO_MIN: c_uint = 0x08;
pub const LTC4282_VGPIO_MAX: c_uint = 0x09;
pub const LTC4282_VSOURCE_MIN: c_uint = 0x0a;
pub const LTC4282_VSOURCE_MAX: c_uint = 0x0b;
pub const LTC4282_VSENSE_MIN: c_uint = 0x0c;
pub const LTC4282_VSENSE_MAX: c_uint = 0x0d;
pub const LTC4282_POWER_MIN: c_uint = 0x0e;
pub const LTC4282_POWER_MAX: c_uint = 0x0f;
pub const LTC4282_CLK_DIV: c_uint = 0x10;

pub const LTC4282_ILIM_ADJUST: c_uint = 0x11;

pub const LTC4282_ENERGY: c_uint = 0x12;
pub const LTC4282_TIME_COUNTER: c_uint = 0x18;
pub const LTC4282_ALERT_CTRL: c_uint = 0x1c;

pub const LTC4282_ADC_CTRL: c_uint = 0x1d;

pub const LTC4282_STATUS_LSB: c_uint = 0x1e;

    (LTC4282_OV_STATUS_MASK | LTC4282_UV_STATUS_MASK)

pub const LTC4282_STATUS_MSB: c_uint = 0x1f;
pub const LTC4282_RESERVED_1: c_uint = 0x32;
pub const LTC4282_RESERVED_2: c_uint = 0x33;
pub const LTC4282_VGPIO: c_uint = 0x34;
pub const LTC4282_VGPIO_LOWEST: c_uint = 0x36;
pub const LTC4282_VGPIO_HIGHEST: c_uint = 0x38;
pub const LTC4282_VSOURCE: c_uint = 0x3a;
pub const LTC4282_VSOURCE_LOWEST: c_uint = 0x3c;
pub const LTC4282_VSOURCE_HIGHEST: c_uint = 0x3e;
pub const LTC4282_VSENSE: c_uint = 0x40;
pub const LTC4282_VSENSE_LOWEST: c_uint = 0x42;
pub const LTC4282_VSENSE_HIGHEST: c_uint = 0x44;
pub const LTC4282_POWER: c_uint = 0x46;
pub const LTC4282_POWER_LOWEST: c_uint = 0x48;
pub const LTC4282_POWER_HIGHEST: c_uint = 0x4a;
pub const LTC4282_RESERVED_3: c_uint = 0x50;

pub const LTC4282_CLKOUT_CNV: c_int = 15;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltc4282_cache {
    pub in_max_raw: u32,
    pub in_min_raw: u32,
    pub in_highest: c_long,
    pub in_lowest: c_long,
    pub en: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltc4282_state {
    pub map: *mut regmap,
    pub clk_hw: clk_hw,
//
...
// the same registers.
//
    pub in0_1_cache: [ltc4282_cache; LTC4282_CHAN_VGPIO],
    pub vsense_max: u32,
    pub power_max: i64,
    pub rsense: u32,
    pub vdd: u16,
    ...
    clk_hw);
    let mut val: u32 = LTC4282_CLKOUT_INT;
...
#[no_mangle]
unsafe extern "C" fn ltc4282_disable(clk_hw: *mut clk_hw) {
...
// val = DIV_ROUND_CLOSEST(in * fs, U8_MAX);
    ...
    u32 fs, long *val)
    {
    return ltc4282_read_voltage_byte_cached(st, reg, fs, val, core::ptr::null_mut());
    }
...
// val = DIV_ROUND_CLOSEST(in * MILLI, st->rsense);
    ...
    long *val)
    {
    let mut temp: u64 = DECA * 40ULL * st.vfs_out * BIT(16), temp_2;
    __be16 raw;
    u16 power;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ltc4282_read_energy(st: *const ltc4282_state, val: *mut i64) -> c_int {
...
// val = st->energy_en;
    ...
    u64 val)
    {
    let mut temp: u64 = int_pow(U16_MAX, 2) * st.rsense, temp_2;
    __be16 __raw;
    u16 code;
...
#[no_mangle]
unsafe extern "C" fn ltc4282_power_reset_hist(st: *mut ltc4282_state) -> c_int {
...
// cache_raw = in;
    ...
    u32 fs, long val)
    {
    return ltc4282_write_voltage_byte_cached(st, reg, fs, val, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ltc4282_cache_history(st: *mut ltc4282_state, channel: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4282_cache_sync(st: *mut ltc4282_state, channel: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4282_vdd_source_reset_hist(st: *mut ltc4282_state, channel: c_int) -> c_int {
    static int ltc4282_vdd_source_reset_hist(struct ltc4282_state *st, int channel)
    {
    let mut lowest: c_long = st.vfs_out;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ltc4282_curr_reset_hist(st: *mut ltc4282_state) -> c_int {
...
// now, let's also clear possible overcurrent fault logs
    ...
    let mut val64: u64 = clamp(val, 0, ulimit);
// need to pass it in millivolt
    let mut in: u32 = DIV_ROUND_CLOSEST_ULL(val64 * st.rsense, DECA * MICRO);
    switch (attr) {
    case hwmon_curr_max:
...
#[no_mangle]
unsafe extern "C" fn ltc4282_energy_enable_set(st: *mut ltc4282_state, val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4282_in_is_visible(st: *const ltc4282_state, attr: u32) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn ltc4282_curr_is_visible(attr: u32) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn ltc4282_power_is_visible(attr: u32) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn ltc428_clks_setup(st: *mut ltc4282_state, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4282_get_defaults(st: *mut ltc4282_state, vin_mode: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ltc4282_set_max_limits(st: *mut ltc4282_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4282_gpio_setup(st: *mut ltc4282_state, dev: *mut device) -> c_int {
    static int ltc4282_gpio_setup(struct ltc4282_state *st, struct device *dev)
    {
    const char *func = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ltc4282_setup(st: *mut ltc4282_state, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4282_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ltc4282_writable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ltc4282_show_fault_log(arg: *mut c_void, val: *mut u64, mask: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4282_show_curr1_crit_fault_log(arg: *mut c_void, val: *mut u64) -> c_int {
    ...
    ltc4282_show_curr1_crit_fault_log, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn ltc4282_show_in1_lcrit_fault_log(arg: *mut c_void, val: *mut u64) -> c_int {
    ...
    ltc4282_show_in1_lcrit_fault_log, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn ltc4282_show_in1_crit_fault_log(arg: *mut c_void, val: *mut u64) -> c_int {
    ...
    ltc4282_show_in1_crit_fault_log, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn ltc4282_show_fet_bad_fault_log(arg: *mut c_void, val: *mut u64) -> c_int {
    ...
    ltc4282_show_fet_bad_fault_log, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn ltc4282_show_fet_short_fault_log(arg: *mut c_void, val: *mut u64) -> c_int {
    ...
    ltc4282_show_fet_short_fault_log, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn ltc4282_show_power1_bad_fault_log(arg: *mut c_void, val: *mut u64) -> c_int {
    ...
    ltc4282_show_power1_bad_fault_log, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn ltc4282_debugfs_init(st: *mut ltc4282_state, i2c: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ltc4282_probe(i2c: *mut i2c_client) -> c_int {
...
// Yes, it's big but it is as specified in the datasheet
    ...
    &ltc4282_chip_info, core::ptr::null_mut());
    if (IS_ERR(hwmon))
