...
//! Source: drivers/hwmon/ltc4245.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ltc4245_update_gpios(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ltc4245_get_voltage(dev: *mut device, reg: u8) -> c_int {
    static int ltc4245_get_voltage(struct device *dev, u8 reg)
    {
    struct ltc4245_data *data = ltc4245_update_device(dev);
    let mut regval: u8 = data.vregs[reg - 0x10];
...
#[no_mangle]
unsafe extern "C" fn ltc4245_get_current(dev: *mut device, reg: u8) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ltc4245_read_in(dev: *mut device, attr: u32, channel: c_int, val: *mut c_long) -> c_int {
...
// val = ltc4245_get_voltage(dev,
    ...
    let mut regval: c_int = data.gpios[channel - 8];
    if (regval < 0)
    return regval;
// val = regval * 10;
    }
...
#[no_mangle]
unsafe extern "C" fn ltc4245_use_extra_gpios(client: *mut i2c_client) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ltc4245_probe(client: *mut i2c_client) -> c_int {
