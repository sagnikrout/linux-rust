...
pub const G762_REG_FAN_CMD1_DET_FAN_FAIL: c_uint = 0x80 /* enable fan_fail signal */;
pub const G762_REG_FAN_CMD1_DET_FAN_OOC: c_uint = 0x40 /* enable fan_out_of_control */;
pub const G762_REG_FAN_CMD1_OUT_MODE: c_uint = 0x20 /* out mode: PWM or DC */;
pub const G762_REG_FAN_CMD1_FAN_MODE: c_uint = 0x10 /* fan mode: closed/open-loop */;
pub const G762_REG_FAN_CMD1_CLK_DIV_ID1: c_uint = 0x08 /* clock divisor value */;
pub const G762_REG_FAN_CMD1_CLK_DIV_ID0: c_uint = 0x04;
pub const G762_REG_FAN_CMD1_PWM_POLARITY: c_uint = 0x02 /* PWM polarity */;
pub const G762_REG_FAN_CMD1_PULSE_PER_REV: c_uint = 0x01 /* pulse per fan revolution */;
pub const G761_REG_FAN_CMD2_FAN_CLOCK: c_uint = 0x20 /* choose internal clock*/;
pub const G762_REG_FAN_CMD2_GEAR_MODE_1: c_uint = 0x08 /* fan gear mode */;
pub const G762_REG_FAN_CMD2_GEAR_MODE_0: c_uint = 0x04;
pub const G762_REG_FAN_CMD2_FAN_STARTV_1: c_uint = 0x02 /* fan startup voltage */;
pub const G762_REG_FAN_CMD2_FAN_STARTV_0: c_uint = 0x01;
pub const G762_REG_FAN_STA_FAIL: c_uint = 0x02 /* fan fail */;
pub const G762_REG_FAN_STA_OOC: c_uint = 0x01 /* fan out of control */;
// Config register values
pub const G762_OUT_MODE_PWM: c_int = 1;
pub const G762_OUT_MODE_DC: c_int = 0;
pub const G762_FAN_MODE_CLOSED_LOOP: c_int = 2;
pub const G762_FAN_MODE_OPEN_LOOP: c_int = 1;
pub const G762_PWM_POLARITY_NEGATIVE: c_int = 1;
pub const G762_PWM_POLARITY_POSITIVE: c_int = 0;
...
// g762 register cache
    ...
    pub /: *mut *mut u8 set_cnt; / controls fan rotation speed in closed-loop mode,
    pub /: *mut *mut u8 act_cnt; / provides access to current fan RPM value,
    pub than: *mut *mut u8 fan_sta; / bit 0: set when actual fan speed is more,
// 25% outside requested fan speed
// bit 1: set when no transition occurs on fan
// pin for 0.7s
//
    pub /: *mut *mut u8 set_out; / controls fan rotation speed in open-loop mode,
    pub revolution: *mut *mut u8 fan_cmd1; / 0: FG_PLS_ID0 FG pulses count per,
...
//
    pub dac_code: *mut *mut u8 fan_cmd2; / 0,1: FAN_STARTV 0,1,2,3 -> 0,32,64,96,
// 2,3: FG_GEAR_MODE
// 00: multiplier = 1
// 01: multiplier = 2
// 10: multiplier = 4
...
//
    ...
    u8 clk_div, u8 gear_mult)
    {
    let mut f1: c_ulong = clk_freq * 30 * gear_mult;
    let mut f2: c_ulong = p * clk_div;
...
//
#[no_mangle]
unsafe extern "C" fn do_set_clk_freq(dev: *mut device, val: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_set_pwm_mode(dev: *mut device, val: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_set_fan_div(dev: *mut device, val: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_set_fan_gear_mode(dev: *mut device, val: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_set_fan_pulses(dev: *mut device, val: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_set_pwm_enable(dev: *mut device, val: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_set_pwm_polarity(dev: *mut device, val: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn do_set_pwm(dev: *mut device, val: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn do_set_fan_target(dev: *mut device, val: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_set_fan_startv(dev: *mut device, val: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn g762_of_clock_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn g762_of_clock_enable(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn g762_of_prop_import(client: *mut i2c_client) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn g762_pdata_prop_import(client: *mut i2c_client) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn g762_fan_init(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn g762_probe(client: *mut i2c_client) -> c_int {
