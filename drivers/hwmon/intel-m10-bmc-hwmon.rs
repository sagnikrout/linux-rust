...
//! Source: drivers/hwmon/intel-m10-bmc-hwmon.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct m10bmc_sdata {
    pub reg_input: c_uint,
    pub reg_max: c_uint,
    pub reg_crit: c_uint,
    pub reg_hyst: c_uint,
    pub reg_min: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct m10bmc_hwmon_board_data {
    pub tables: [*const m10bmc_sdata; hwmon_max],
    pub hinfo: *const *const hwmon_channel_info,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct m10bmc_hwmon {
    pub dev: *mut device,
    pub chip: hwmon_chip_info,
    pub hw_name: *mut c_char,
    pub m10bmc: *mut intel_m10bmc,
    pub bdata: *const m10bmc_hwmon_board_data,
}
...
// val = regval * data->multiplier;
    ...
    let mut reg: c_uint = 0, reg_hyst = 0;
    const struct m10bmc_sdata *data;
    long hyst, value;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn m10bmc_hwmon_probe(pdev: *mut platform_device) -> c_int {
